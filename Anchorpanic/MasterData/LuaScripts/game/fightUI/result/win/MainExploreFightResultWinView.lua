--[[ 
-----------------------------------------------------
@filename       : MainExploreFightResultWinView
@Description    : 主探索战斗结算胜利界面
@date           : 2021-07-07 10:49:46
@Author         : Zzz
@copyright      : (LY) 2021 雷焰网络
-----------------------------------------------------
]]
module('fightUI.MainExploreFightResultWinView', Class.impl(fightUI.FightResultWinView))
    ...
    if #self.resultData.award > 0 then
        ShowAwardPanel:showPropsAwardMsg(self.resultData.award, function()
            role.RoleController:onShowPlayerLvlUp(function()
                mainExplore.MainExploreController:onShowSelectGoods(function()
