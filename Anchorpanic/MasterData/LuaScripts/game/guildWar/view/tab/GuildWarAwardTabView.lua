...
module("guildWar.GuildWarAwardTabView", Class.impl(TabSubView))

UIRes = UrlManager:getUIPrefabPath("guildWar/tab/GuildWarAwardTabView.prefab")
...
function configUI(self)
    ...
    self.mScrollReward:SetItemRender(guildWar.GuildWarAwardItem)
...
function updateRewardView(self)
    ...
    local rewardList = guildWar.GuildWarManager:getGuildWarAwardData()
