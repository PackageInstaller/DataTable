module('dup.DupEquipLowPanel', Class.impl(dup.DupChipInfoView))

function ctor(self)
    super.ctor(self)
    self:setUICode(LinkCode.DupEquipLow)
end

-- 副本类型
function getDupType(self)
    return DupType.DUP_EQUIP_LOW
end
--获取当前打开页签
function getCurPageIndex(self)
    return dup.DupChipConst.LOWLEVEL
end
--刪除临时预制体
