module("manual.ManualFashionTabSubView", Class.impl(TabSubView))
UIRes = UrlManager:getUIPrefabPath("manual/ManualFashionTabSubView.prefab")
...
function configUI(self)
    ...
    self.mScroller:SetItemRender(manual.ManualFashionItem)
...
function updateView(self)
    local equipList = manual.ManualFashionManager:getFahionList(self.colorType)
    local hasTarget = 0 
