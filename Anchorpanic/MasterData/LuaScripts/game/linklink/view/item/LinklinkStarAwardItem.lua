...
module('game.linklink.view.LinklinkStarAwardItem', Class.impl('lib.component.BaseItemRender'))
...
function onGetAward(self)
    GameDispatcher:dispatchEvent(EventName.ONREQ_LINKLINK_GET_AWARD, {self.data.config.id})
end
