--[[ 
-----------------------------------------------------
@filename       : ReturnedTaskDailyView
@Description    : 常驻活动——每日任务
@date           : 2023-10-31 17:27:16
@Author         : Jacob
@copyright      : (LY) 2023 雷焰网络
-----------------------------------------------------
]]
module('game.returned.view.ReturnedTaskDailyView', Class.impl(TabSubView))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("returned/ReturnedTaskView.prefab")
...
function updateView(self)
    local list = returned.ReturnedManager:getReturnedTaskList(ReturnedTaskType.TASK_DAILY)
