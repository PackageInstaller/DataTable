module('equipBuild.EquipStrengthenShowltem', Class.impl('lib.component.BaseItemRender'))
...
function onClickGridHandler(self, args)
    ...
    GameDispatcher:dispatchEvent(EventName.OPEN_EQUIP_STRENGTHEN_MATERIAL_VIEW, targetEquipVo)
end
