module('equipBuild.EquipStrengthenSelectItem', Class.impl('lib.component.BaseItemRender'))
...
function setData(self, param)
    ...
    if (propsVo) then
        if propsVo._NAME == equip.EquipVo._NAME then
            ...
            self:getChildGO("mImgBg"):SetActive(true)
        ...
        self:getChildGO("mTxtSelectCount"):SetActive(propsVo.type == PropsType.NORMAL)
