module('maze.MazeRankHallPanel', Class.impl(TabView))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("maze/MazeRankHallPanel.prefab")
...
function getTabClass(self)
    self.tabClassDic[arena.RankHallTabType.RANK_LIST] = maze.MazeRankPanel
    self.tabClassDic[arena.RankHallTabType.RANK_AWARD] = maze.MazeRankAwardPanel
