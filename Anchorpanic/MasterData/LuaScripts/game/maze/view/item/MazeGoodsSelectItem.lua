...
module('maze.MazeGoodsSelectItem', Class.impl(BaseReuseItem))
...
function setData(self, cusParent, cusBuffData)
    self:setParentTrans(cusParent)
    self:setSelect(false)

    self.buffId = cusBuffData.buff_id
    ...
    self.mTxtImprove.text = _TT(63013, cusBuffData.improve_efficiency / 10)
