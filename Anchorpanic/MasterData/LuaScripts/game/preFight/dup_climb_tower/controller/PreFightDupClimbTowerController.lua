module('preFight.PreFightDupClimbTowerController', Class.impl(preFight.BaseController))
...
function getPanelClass(self)
    return preFight.PreFightDupClimbTowerPanel
end

function getManager(self)
    return preFight.PreFightDupClimbTowerManager
end
