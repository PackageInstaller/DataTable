local ItemCtrl = require("UI.Ctrl.Activity.DailyGoals.DailyGoalsTaskItemCtrl")
local ActivityDailyGoalsList = BaseClass("ActivityDailyGoalsList")
local M = ActivityDailyGoalsList
