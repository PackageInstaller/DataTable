local DailyActivityItemCtrl = BaseClass("DailyActivityItemCtrl")
local M = DailyActivityItemCtrl
...
function M:OnActivityClick()
    ...
    elseif self._data.uiState == TaskConst.TaskUIState.Unlock then
        TaskDataMgr:RequestActivityAward(self._data.id - 1, protocol.EACTType.EACT_Daily)
