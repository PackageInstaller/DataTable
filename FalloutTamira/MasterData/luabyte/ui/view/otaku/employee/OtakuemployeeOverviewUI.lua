...
--declare
  ...
  self.detailLabel = UIUtil.FindComponent( trans , typeof(CS.UnityEngine.UI.Text) , "detail/TextBg/detailLabel" )
  self.skillArea = UIUtil.FindComponent( trans , typeof(CS.CircularScrollView.UICircularScrollView) , "detail/sillArea" )
end
