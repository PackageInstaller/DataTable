...
-- 创建
local function OnCreate(self, unity_canvas)
	base.OnCreate(self)
	-- Unity侧原生组件
	self.unity_canvas = unity_canvas
	...
	-- order
	self.relative_order = self.unity_canvas.sortingOrder or 0
...
local function SetOrder(self, relative_order)
	...
	self.unity_canvas.sortingOrder = relative_order
end
