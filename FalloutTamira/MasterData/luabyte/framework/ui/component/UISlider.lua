...
local function GetSliderValue(self)
    if not IsNull(self.unity_uislider) then
        return self.unity_uislider.value
    end
end
...
UISlider.GetSliderValue = GetSliderValue
...
UISlider.SetDoValue = SetDoValue
UISlider.onLongPress = onLongPress
UISlider.onUp = onUp
UISlider.onDown = onDown
UISlider.SetLongPressTimes = SetLongPressTimes
UISlider.onClickPointer = onClickPointer
UISlider.onClickPointerDown = onClickPointerDown
UISlider.onClickPointerUp = onClickPointerUp
UISlider.OnDestroy = OnDestroy
UISlider.SetInteractive = SetInteractive
UISlider.OnSliderChanged = OnSliderChanged
UISlider.RemoveSliderListener = RemoveSliderListener
UISlider.RemoveSliderAllListeners = RemoveSliderAllListeners
UISlider.SetNormalLizedValue = SetNormalLizedValue
