...
local UINewToggle = BaseClass("UINewToggle", UIBaseComponent)
...
UINewToggle.OnCreate = OnCreate
UINewToggle.OnDestroy = OnDestroy
UINewToggle.OnToggleClick = OnToggleClick
UINewToggle.RemoveToggleAllClicks = RemoveToggleAllClicks
UINewToggle.GetInteractable = GetInteractable
UINewToggle.SetInteractable = SetInteractable
UINewToggle.GetIsOn = GetIsOn
UINewToggle.SetIsOn = SetIsOn
UINewToggle.GetIsOn = GetIsOn
UINewToggle.onClick = onClick
UINewToggle._OnToggleClick = _OnToggleClick
