...
function LoginActivationCodeUI:OnInit()
	...
	UGUIUtil.SetText(self.TitleText, LoginActivationCodeUIApi:GetTitleText())
	UGUIUtil.SetText(self.TipText, LoginActivationCodeUIApi:GetTipText())
	UGUIUtil.SetTextInChildren(self.ConfirmBtn, LoginActivationCodeUIApi:GetConfirmBtnText())
	UGUIUtil.SetTextInChildren(self.CancelBtn, LoginActivationCodeUIApi:GetCancelBtnText())
	UGUIUtil.SetText(self.InputField:GetComponent("IQIGame.Onigao.Game.UI.InputField").placeholder.gameObject, LoginActivationCodeUIApi:GetInputPlaceHolderText())
end
