-- chunkname: @IQIGame\\UI\\ActiveActivityList\\GhostActivity\\GhostActivityMainView.lua
...
function m:OnClickJumpBtn(selectChapterId)
	UIModule.Open(Constant.UIControllerName.GhostActivityStageUI, Constant.UILayer.UI, {
