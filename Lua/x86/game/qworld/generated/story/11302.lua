...
function var_0_0.DialogueNode_2(arg_10_0)
	...
	arg_10_0:PlayActorAnimationAction(9073, "9073_idle01", 0.05, 3.333333, function()
		return
	end)
...
function var_0_0.BlackFadeDialogueNode_3(arg_15_0)
	...
	arg_15_0:OnBlackFade(true, 11302003, 6, 0.5, 0.5, function()
		...
		arg_15_0:SetCharToTagAction(9073, "2", function()
			return
		end)
		arg_15_0:PlayActorAnimationAction(9073, "eniliyi_stand", 0, 2.333333, function()
			return
		end)
