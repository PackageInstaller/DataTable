...
function var_0_0.DialogueNode_2(arg_11_0)
	...
	arg_11_0:SetTalkContent(11170001, "", 0)
...
function var_0_0.DialogueNode_3(arg_16_0)
	arg_16_0:PlayActorAnimationAction(9073, "action3_1", 0.05, 2.266667, function()
		return
	end)
	arg_16_0:ShowTalkView()
	arg_16_0:SetTalkContent(11170002, "", 0)
...
function var_0_0.DialogueNode_7(arg_27_0)
	arg_27_0:PlayActorAnimationAction(9073, "conversation_2", 0.05, 3.166667, function()
		return
	end)
...
function var_0_0.DialogueNode_9(arg_37_0)
	arg_37_0:PlayActorAnimationAction(9073, "summer_shock", 0.05, 1.166667, function()
		return
	end)
...
function var_0_0.DialogueNode_12(arg_52_0)
	arg_52_0:PlayActorAnimationAction(9073, "summer_shock", 0.05, 1.166667, function()
		return
	end)
...
function var_0_0.BlackFadeDialogueNode_13(arg_57_0)
	...
	arg_57_0:OnBlackFade(false, 0, 0.2, 0.5, 0.5, function()
		...
		arg_57_0:DestroyCharAction(9073)
