local var_0_0 = class("BattleAffixSelectTemplate", BattleBaseStageTemplate)
...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.cfg = BattleActivityAffixSelectCfg[arg_1_1]
...
function var_0_0.GetStageAffix(arg_11_0)
	...
	local var_11_1 = {}
	local var_11_2 = {}
	local var_11_3 = ActivityAffixSelectData:GetAffix(arg_11_0.activityID_)
