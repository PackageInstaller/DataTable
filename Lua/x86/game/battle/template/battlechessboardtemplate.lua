local var_0_0 = class("BattleChessBoardTemplate", BattleBaseStageTemplate)

function var_0_0.Ctor(arg_1_0, arg_1_1)
	var_0_0.super.Ctor(arg_1_0, arg_1_1)

	arg_1_0.id = arg_1_1
	arg_1_0.cfg = BattleChessBoardCfg[arg_1_1]
end
...
function var_0_0.GetRevive(arg_10_0)
	if type(arg_10_0.cfg.is_revive) ~= "table" then
		return false, 0, 0, 0
	end

	local var_10_0 = arg_10_0.cfg.is_revive
	local var_10_1 = var_10_0[1] and true or false
	local var_10_2 = var_10_0[1] or 0
	local var_10_3 = var_10_0[1] and ItemTools.getItemNum(var_10_0[1]) or 0
	local var_10_4 = var_10_0[2] or 0

	return var_10_1, var_10_2, var_10_3, var_10_4
end
