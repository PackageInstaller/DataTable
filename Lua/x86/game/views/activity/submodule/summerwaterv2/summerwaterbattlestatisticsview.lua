local var_0_0 = class("SummerWaterBattleStatisticsView", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	for iter_4_0 = 1, 3 do
		local var_4_0 = arg_4_0["hero" .. iter_4_0]
		local var_4_1 = SummerWaterBattleStatisticsHeroItem.New(var_4_0)
...
function var_0_0.OnEnter(arg_10_0)
	...
	for iter_10_0, iter_10_1 in ipairs(var_10_4) do
		for iter_10_2, iter_10_3 in ipairs(iter_10_1.heroList) do
			local var_10_6 = arg_10_0.staticHeroItemList[var_10_5]

			var_10_6:SetIsCooperation(var_10_3)

			local var_10_7 = ActivitySummerWaterData:GetSettlePlayer(ActivitySummerWaterData:GetMainActivityID(), iter_10_1.playerID)

			arg_10_0.staticHeroItemList[var_10_5]:SetCustomStaticData(var_10_7)
			var_10_6:SetData(iter_10_1, iter_10_3, var_10_0[var_10_5], var_10_2)

			var_10_5 = var_10_5 + 1
		end
	end

	arg_10_0.staticHeroItemList[1]:SetCaptain(not var_10_3)

	arg_10_0.battleTimeText_.text = GetTips("BATTLE_TOTAL_TIME") .. ":" .. arg_10_0.params_.battleTime
end
