local var_0_0 = class("RogueCardGameRankView", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	arg_4_0.list = LuaList.New(handler(arg_4_0, arg_4_0.SetListItem), arg_4_0.list_, RogueCardGameRankItem)
...
function var_0_0.OnEnter(arg_8_0)
	...
	local var_8_0 = ActivityConst.ACTIVITY_ROGUECARD_5_0
