local var_0_0 = class("CoreVerificationCommonStageViewMode3", ReduxView)
...
function var_0_0.UpdateCoreVerification(arg_12_0)
	arg_12_0.cfg = arg_12_0.params_.cfg
	arg_12_0.index = arg_12_0.params_.index
	arg_12_0.stage_id = arg_12_0.cfg.stage_id
	arg_12_0.heroList = arg_12_0.params_.heroList
	arg_12_0.params_.heroList = nil
...
function var_0_0.RefreshEnvAffix(arg_14_0)
	...
	local var_14_4 = ActivityAffixPoolCfg[var_14_0.type_affix[1]].affix
	local var_14_5 = var_14_0.type_affix

	if var_14_5 and #var_14_5 > 0 then
		SetActive(arg_14_0.recAgo_, true)
	else
		SetActive(arg_14_0.recAgo_, false)
	end

	arg_14_0.stageAffixDesc_.text = getAffixDesc(var_14_4)
	...
	local var_14_6 = var_14_0.recommend

	for iter_14_0, iter_14_1 in ipairs(var_14_6) do
		if not arg_14_0.recommondAttributeItems[iter_14_0] then
			local var_14_7 = Object.Instantiate(arg_14_0.attributeGo_, arg_14_0.tagContent_)

			arg_14_0.recommondAttributeItems[iter_14_0] = CoreVerificationChallengeRecommendAttributeItem.New(var_14_7, iter_14_0)
		end
	...
	for iter_14_2 = #var_14_6 + 1, #arg_14_0.recommondAttributeItems do
		SetActive(arg_14_0.recommondAttributeItems[iter_14_2].gameObject_, false)
	end

	local var_14_8 = var_14_0.recommend_team

	for iter_14_3, iter_14_4 in ipairs(var_14_8) do
		if not arg_14_0.recommondHeroItems[iter_14_3] then
			local var_14_9 = Object.Instantiate(arg_14_0.recommendGo_, arg_14_0.roleTrs_)

			arg_14_0.recommondHeroItems[iter_14_3] = CoreVerificationChallengeHeroHeadItem.New(var_14_9, iter_14_3)
		end

		SetActive(arg_14_0.recommondHeroItems[iter_14_3].gameObject_, true)

		local var_14_10 = iter_14_4 and iter_14_4 or 0

		arg_14_0.recommondHeroItems[iter_14_3]:RefreshUI(var_14_10)
	end

	for iter_14_5 = #var_14_8 + 1, #arg_14_0.recommondHeroItems do
...
function var_0_0.RefreshTitle(arg_16_0)
	...
	local var_16_2 = CoreVerificationChallengeMode3Data:GetCommonStageByIndex(arg_16_0.stage_id)

	if var_16_2 and var_16_2.max_value and var_16_2.max_value > 0 then
		arg_16_0.timeController_:SetSelectedIndex(1)
		arg_16_0.pointsController_:SetSelectedIndex(1)

		arg_16_0.scoreText_.text = var_16_2.reset_normal_value or 0
	...
	local var_16_4 = var_16_2 and var_16_2.common_lock_id or {}
