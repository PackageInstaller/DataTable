local var_0_0 = class("GuildActivitySPAffixRaceItem", ReduxView)
...
function var_0_0.BindRedPoint(arg_11_0, arg_11_1)
	if arg_11_0.raceID_ ~= nil then
		manager.redPoint:bindUIandKey(arg_11_0.transform_, string.format("%s_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, arg_11_1, arg_11_0.raceID_))
	end
end

function var_0_0.UnBindRedPoint(arg_12_0, arg_12_1)
	if arg_12_0.raceID_ ~= nil then
		manager.redPoint:unbindUIandKey(arg_12_0.transform_, string.format("%s_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, arg_12_1, arg_12_0.raceID_))
	end
end
