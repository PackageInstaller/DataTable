local var_0_0 = class("CoreVerificationDoubleChallengeResultViewMode2", ReduxView)
...
function var_0_0.RefreshChallegeUI(arg_14_0)
	...
	arg_14_0.buff_list = CoreVerificationChallengeMode2Data:GetSelectAffixs()
	...
	local var_14_2 = CoreVerificationChallengeMode2Data:GetEfficiencyNum()

	arg_14_0.efficiencyScoreText_.text = var_14_2
	arg_14_0.scoreText_.text = var_14_0.max_challenge_value or 0
	arg_14_0.stageNameText_.text = GetI18NText(CoreVerificationClMode2Cfg[arg_14_0.stageId].stage_name)

	arg_14_0.scrollHelper_:StartScroll(#arg_14_0.buff_list)

	local var_14_3, var_14_4 = CoreVerificationChallengeMode2Data:GetPostNum()

	arg_14_0.limitText_.text = var_14_3 .. "/" .. var_14_4

	local var_14_5 = CoreVerificationChallengeTools.GetMaxIllustrated()

	arg_14_0.affixIcon_.sprite = pureGetSpriteWithoutAtlas(string.format("%s%s", "TextureConfig/Core_verification_new/Emblem/", var_14_5))
end
