local var_0_0 = class("SummerPubPartnerShowView", ReduxView)
...
function var_0_0.OnEnter(arg_13_0)
	...
	cfg = SummerPubHeroCfg[arg_13_0.params_.id]
	arg_13_0.portriatImg_.spriteSync = pureGetSpriteWithoutAtlas(SWIM_PATH .. cfg.profile_icon_body)
	arg_13_0.slider_.value = 0

	arg_13_0:OnImageScaled(0.69)
end
