local var_0_0 = class("AdvanceTest4AffixSelectView", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	arg_4_0.buffList = LuaList.New(handler(arg_4_0, arg_4_0.IndexBuffItem), arg_4_0.bufflList_, AdvanceTest4AffixSelectItem)
	arg_4_0.deBuffList = LuaList.New(handler(arg_4_0, arg_4_0.IndexDeBuffItem), arg_4_0.debuffList_, AdvanceTest4AffixSelectItem)
	arg_4_0.selectList = LuaList.New(handler(arg_4_0, arg_4_0.IndexSelectItem), arg_4_0.uiListGo_, AdvanceTest4AffixCurSelectItem)
...
function var_0_0.OnEnter(arg_9_0)
	...
	arg_9_0.maxSelect = GameSetting.test_challenge_core_mode1_affix_num.value[1]
...
function var_0_0.RefreshUI(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in pairs(arg_14_0.select_affix) do
		local var_14_1 = math.floor(iter_14_1 / 100)
		local var_14_2 = iter_14_1 % 100
		local var_14_3 = (var_14_1 == 0 and arg_14_0.affix_buff or arg_14_0.affix_debuff)[var_14_2]
		local var_14_4 = var_14_3[1]

		var_14_0 = var_14_0 + var_14_3[2]
	end

	arg_14_0.affixNum_.text = #arg_14_0.select_affix .. "/" .. arg_14_0.maxSelect
	...
	arg_14_0.selectList:StartScroll(#arg_14_0.select_affix)
end
...
function var_0_0.ShowTipsView(arg_15_0, arg_15_1)
	...
	arg_15_0.tipsLvText_.text = string.format(GetTips("PINBALL_HERO_LEVEL"), var_15_0[2])
	arg_15_0.tipsSubText_.text = ""
...
function var_0_0.SelectAffix(arg_20_0, arg_20_1, arg_20_2)
	...
	if var_20_1 then
		...
		if #arg_20_0.select_affix >= arg_20_0.maxSelect then
