local var_0_0 = class("LimitTimeTaskBaseScheduleItem", ReduxView)
...
function var_0_0.RefreshSlider(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	arg_7_0.slider_.value = arg_7_1 / arg_7_2

	if arg_7_2 <= arg_7_1 then
		SetActive(arg_7_0.pointGo_, true)

		if arg_7_0.animGo_ then
			if arg_7_3 then
				SetActive(arg_7_0.animGo_.gameObject, false)
			else
				SetActive(arg_7_0.animGo_.gameObject, true)
				arg_7_0.animGo_:Play("UI_rot_loop", 0, 0)
				arg_7_0.animGo_:Update(0)
			end
		end
	else
