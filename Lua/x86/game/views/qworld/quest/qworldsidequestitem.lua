local var_0_0 = class("QWorldSideQuestItem", ReduxView)
...
function var_0_0.InitUI(arg_3_0)
	...
	if arg_3_0.conEx_ then
		arg_3_0.finishController_ = arg_3_0.conEx_:GetController("complete")
	end
end
...
function var_0_0.RefreshUI(arg_6_0)
	...
	if arg_6_0.finishController_ then
