local var_0_0 = class("DormIlluDanceItem", ReduxView)
...
function var_0_0.AddUIListener(arg_3_0)
	arg_3_0:AddBtnListener(arg_3_0.mainBtn_, nil, function()
		arg_3_0.clickFunc_(arg_3_0.danceID_, arg_3_0.index_)
	end)
end

function var_0_0.SetData(arg_5_0, arg_5_1, arg_5_2)
	arg_5_0.index_ = arg_5_1
	arg_5_0.danceID_ = arg_5_2
	arg_5_0.isUnlock_ = IdolTraineeData:DanceDIYActionAvailable(arg_5_0.danceID_)
...
function var_0_0.RefreshUI(arg_6_0)
	...
	arg_6_0.bgImg_.sprite = getSpriteViaConfig("IdolDanceRoleIcon", arg_6_0.danceID_)
