...
local var_0_1 = class("AutoChessRefreshNode", var_0_0)

function var_0_1.OnEnter(arg_1_0)
	AutoChessData:UpdateChessTeamDataList(arg_1_0.blackboard:GetGameType(), arg_1_0.actionData.refreshChessList)
