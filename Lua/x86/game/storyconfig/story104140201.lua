return {
	Play414021001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 414021001
		arg_1_1.duration_ = 7
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_2 + arg_4_0 then
				...
				local var_4_5 = arg_1_1.bgs_.H09f
			...
			local var_4_22 = 2.03333333333333
			local var_4_23 = 0.0666666666666669

			if var_4_22 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				local var_4_24 = "play"
				local var_4_25 = "effect"

				arg_1_1:AudioAction(var_4_24, var_4_25, "se_story_133", "se_story_133_gaga", "")
			end
			...
			if var_4_26 < arg_1_1.time_ and arg_1_1.time_ <= var_4_26 + arg_4_0 then
				...
				local var_4_29 = arg_1_1:FormatText(StoryNameCfg[945].name)
				...
				local var_4_30 = arg_1_1:GetWordFromCfg(414021001)
	...
	Play414021002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 414021002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_2 = arg_7_1:GetWordFromCfg(414021002)
	...
	Play414021003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 414021003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play414021004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_0 + arg_14_0 then
				...
				arg_11_1:AudioAction(var_14_2, var_14_3, "se_story_133", "se_story_133_gaga2", "")
			end
			...
			if var_14_4 < arg_11_1.time_ and arg_11_1.time_ <= var_14_4 + arg_14_0 then
				...
				local var_14_6 = arg_11_1:FormatText(StoryNameCfg[945].name)
				...
				local var_14_7 = arg_11_1:GetWordFromCfg(414021003)
	...
	Play414021004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 414021004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play414021005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_0 + arg_18_0 then
				...
				local var_18_2 = arg_15_1:GetWordFromCfg(414021004)
	...
	Play414021005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 414021005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play414021006(arg_19_1)
			end
		end

		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			local var_22_0 = "1049ui_story"

			if arg_19_1.actors_[var_22_0] == nil then
				local var_22_1 = Asset.Load("Char/" .. "1049ui_story")

				if not isNil(var_22_1) then
					local var_22_2 = Object.Instantiate(Asset.Load("Char/" .. "1049ui_story"), arg_19_1.stage_.transform)
			...
			local var_22_5 = arg_19_1.actors_["1049ui_story"].transform
			local var_22_6 = 0

			if var_22_6 < arg_19_1.time_ and arg_19_1.time_ <= var_22_6 + arg_22_0 then
				arg_19_1.var_.moveOldPos1049ui_story = var_22_5.localPosition
			end
			...
			if var_22_6 <= arg_19_1.time_ and arg_19_1.time_ < var_22_6 + var_22_7 then
				...
				var_22_5.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos1049ui_story, var_22_9, var_22_8)
			...
			local var_22_14 = arg_19_1.actors_["1049ui_story"]
			local var_22_15 = 0

			if var_22_15 < arg_19_1.time_ and arg_19_1.time_ <= var_22_15 + arg_22_0 and not isNil(var_22_14) and arg_19_1.var_.characterEffect1049ui_story == nil then
				arg_19_1.var_.characterEffect1049ui_story = var_22_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_22_15 <= arg_19_1.time_ and arg_19_1.time_ < var_22_15 + var_22_16 and not isNil(var_22_14) then
				...
				if arg_19_1.var_.characterEffect1049ui_story and not isNil(var_22_14) then
					arg_19_1.var_.characterEffect1049ui_story.fillFlat = false
				end
			end

			if arg_19_1.time_ >= var_22_15 + var_22_16 and arg_19_1.time_ < var_22_15 + var_22_16 + arg_22_0 and not isNil(var_22_14) and arg_19_1.var_.characterEffect1049ui_story then
				arg_19_1.var_.characterEffect1049ui_story.fillFlat = false
			end
			...
			if var_22_18 < arg_19_1.time_ and arg_19_1.time_ <= var_22_18 + arg_22_0 then
				arg_19_1:PlayTimeline("1049ui_story", "StoryTimeline/CharAction/story1049/story1049action/1049action5_1")
			end
			...
			if var_22_20 < arg_19_1.time_ and arg_19_1.time_ <= var_22_20 + arg_22_0 then
				...
				local var_22_23 = arg_19_1:GetWordFromCfg(414021005)
	...
	Play414021006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 414021006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play414021007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_1 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 and not isNil(var_26_0) and arg_23_1.var_.characterEffect1049ui_story == nil then
			...
			if var_26_1 <= arg_23_1.time_ and arg_23_1.time_ < var_26_1 + var_26_2 and not isNil(var_26_0) then
				...
				if arg_23_1.var_.characterEffect1049ui_story and not isNil(var_26_0) then
					local var_26_4 = Mathf.Lerp(0, 0.5, var_26_3)

					arg_23_1.var_.characterEffect1049ui_story.fillFlat = true
					arg_23_1.var_.characterEffect1049ui_story.fillRatio = var_26_4
				end
			end

			if arg_23_1.time_ >= var_26_1 + var_26_2 and arg_23_1.time_ < var_26_1 + var_26_2 + arg_26_0 and not isNil(var_26_0) and arg_23_1.var_.characterEffect1049ui_story then
				local var_26_5 = 0.5

				arg_23_1.var_.characterEffect1049ui_story.fillFlat = true
				arg_23_1.var_.characterEffect1049ui_story.fillRatio = var_26_5
			end

			local var_26_6 = arg_23_1.actors_["1049ui_story"].transform
			local var_26_7 = 0

			if var_26_7 < arg_23_1.time_ and arg_23_1.time_ <= var_26_7 + arg_26_0 then
				arg_23_1.var_.moveOldPos1049ui_story = var_26_6.localPosition
			end
			...
			if var_26_7 <= arg_23_1.time_ and arg_23_1.time_ < var_26_7 + var_26_8 then
				...
				var_26_6.localPosition = Vector3.Lerp(arg_23_1.var_.moveOldPos1049ui_story, var_26_10, var_26_9)
			...
			if var_26_15 < arg_23_1.time_ and arg_23_1.time_ <= var_26_15 + arg_26_0 then
				...
				local var_26_18 = arg_23_1:GetWordFromCfg(414021006)
	...
	Play414021007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 414021007
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			local var_30_0 = arg_27_1.bgs_.H09f.transform
			local var_30_1 = 0

			if var_30_1 < arg_27_1.time_ and arg_27_1.time_ <= var_30_1 + arg_30_0 then
				arg_27_1.var_.moveOldPosH09f = var_30_0.localPosition
			end
			...
			if var_30_1 <= arg_27_1.time_ and arg_27_1.time_ < var_30_1 + var_30_2 then
				...
				local var_30_4 = Vector3.New(0, 1, 10)

				var_30_0.localPosition = Vector3.Lerp(arg_27_1.var_.moveOldPosH09f, var_30_4, var_30_3)
			end

			if arg_27_1.time_ >= var_30_1 + var_30_2 and arg_27_1.time_ < var_30_1 + var_30_2 + arg_30_0 then
				var_30_0.localPosition = Vector3.New(0, 1, 10)
			end

			local var_30_5 = arg_27_1.bgs_.H09f.transform
			local var_30_6 = 0.1

			if var_30_6 < arg_27_1.time_ and arg_27_1.time_ <= var_30_6 + arg_30_0 then
				arg_27_1.var_.moveOldPosH09f = var_30_5.localPosition
			end
			...
			if var_30_6 <= arg_27_1.time_ and arg_27_1.time_ < var_30_6 + var_30_7 then
				...
				local var_30_9 = Vector3.New(0, 1, 4)

				var_30_5.localPosition = Vector3.Lerp(arg_27_1.var_.moveOldPosH09f, var_30_9, var_30_8)
			end

			if arg_27_1.time_ >= var_30_6 + var_30_7 and arg_27_1.time_ < var_30_6 + var_30_7 + arg_30_0 then
				var_30_5.localPosition = Vector3.New(0, 1, 4)
			end
			...
			if var_30_12 <= arg_27_1.time_ and arg_27_1.time_ < var_30_12 + var_30_13 then
				...
				local var_30_15 = Color.New(1, 1, 1)

				var_30_15.a = Mathf.Lerp(1, 0, var_30_14)
				arg_27_1.mask_.color = var_30_15
			end

			if arg_27_1.time_ >= var_30_12 + var_30_13 and arg_27_1.time_ < var_30_12 + var_30_13 + arg_30_0 then
				local var_30_16 = Color.New(1, 1, 1)
				local var_30_17 = 0

				arg_27_1.mask_.enabled = false
				var_30_16.a = var_30_17
				arg_27_1.mask_.color = var_30_16
			end
			...
			if var_30_19 < arg_27_1.time_ and arg_27_1.time_ <= var_30_19 + arg_30_0 then
				arg_27_1.var_.shakeOldPos = var_30_18.localPosition
			end

			local var_30_20 = 0.7

			if var_30_19 <= arg_27_1.time_ and arg_27_1.time_ < var_30_19 + var_30_20 then
				local var_30_21 = (arg_27_1.time_ - var_30_19) / 0.066
				local var_30_22, var_30_23 = math.modf(var_30_21)

				var_30_18.localPosition = Vector3.New(var_30_23 * 0.13, var_30_23 * 0.13, var_30_23 * 0.13) + arg_27_1.var_.shakeOldPos
			end

			if arg_27_1.time_ >= var_30_19 + var_30_20 and arg_27_1.time_ < var_30_19 + var_30_20 + arg_30_0 then
				var_30_18.localPosition = arg_27_1.var_.shakeOldPos
			end
			...
			if var_30_24 < arg_27_1.time_ and arg_27_1.time_ <= var_30_24 + arg_30_0 then
				...
				local var_30_27 = arg_27_1:GetWordFromCfg(414021007)
