return {
	Play414181001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_34 = 1.93093719705939
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				local var_4_38 = arg_1_1:GetWordFromCfg(414181001)
	...
	Play414181002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				...
				arg_9_1:AudioAction(var_12_2, var_12_3, "se_story_133", "se_story_133_gaga", "")
			end
			...
			if var_12_4 < arg_9_1.time_ and arg_9_1.time_ <= var_12_4 + arg_12_0 then
				...
				local var_12_6 = arg_9_1:FormatText(StoryNameCfg[945].name)
				...
				local var_12_7 = arg_9_1:GetWordFromCfg(414181002)
	...
	Play414181003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_0 + arg_16_0 then
				...
				local var_16_2 = arg_13_1:FormatText(StoryNameCfg[975].name)
				...
				local var_16_3 = arg_13_1:GetWordFromCfg(414181003)
	...
	Play414181004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_20 < arg_17_1.time_ and arg_17_1.time_ <= var_20_20 + arg_20_0 then
				...
				local var_20_23 = arg_17_1:GetWordFromCfg(414181004)
	...
	Play414181005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_15 < arg_21_1.time_ and arg_21_1.time_ <= var_24_15 + arg_24_0 then
				...
				local var_24_17 = arg_21_1:GetWordFromCfg(414181005)
	...
	Play414181006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:GetWordFromCfg(414181006)
	...
	Play414181007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_0 + arg_32_0 then
				...
				local var_32_2 = arg_29_1:FormatText(StoryNameCfg[975].name)
				...
				local var_32_3 = arg_29_1:GetWordFromCfg(414181007)
	...
	Play414181008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_0 + arg_36_0 then
				...
				local var_36_3 = arg_33_1:GetWordFromCfg(414181008)
	...
	Play414181009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_1 <= arg_37_1.time_ and arg_37_1.time_ < var_40_1 + var_40_2 then
				...
				local var_40_4 = Vector3.New(0, -1.2, -6)
			...
			if var_40_10 < arg_37_1.time_ and arg_37_1.time_ <= var_40_10 + arg_40_0 and not isNil(var_40_9) and arg_37_1.var_.characterEffect104902ui_story == nil then
			...
			if var_40_10 <= arg_37_1.time_ and arg_37_1.time_ < var_40_10 + var_40_11 and not isNil(var_40_9) then
				...
				if arg_37_1.var_.characterEffect104902ui_story and not isNil(var_40_9) then
					arg_37_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_37_1.time_ >= var_40_10 + var_40_11 and arg_37_1.time_ < var_40_10 + var_40_11 + arg_40_0 and not isNil(var_40_9) and arg_37_1.var_.characterEffect104902ui_story then
				arg_37_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if var_40_15 < arg_37_1.time_ and arg_37_1.time_ <= var_40_15 + arg_40_0 then
				...
				local var_40_17 = arg_37_1:FormatText(StoryNameCfg[562].name)
				...
				local var_40_18 = arg_37_1:GetWordFromCfg(414181009)
	...
	Play414181010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			local var_44_0 = arg_41_1.actors_["104902ui_story"].transform
			local var_44_1 = 0

			if var_44_1 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				arg_41_1.var_.moveOldPos104902ui_story = var_44_0.localPosition
			end
			...
			if var_44_1 <= arg_41_1.time_ and arg_41_1.time_ < var_44_1 + var_44_2 then
				...
				var_44_0.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos104902ui_story, var_44_4, var_44_3)
			...
			if var_44_9 < arg_41_1.time_ and arg_41_1.time_ <= var_44_9 + arg_44_0 then
				...
				local var_44_11 = arg_41_1:GetWordFromCfg(414181010)
	...
	Play414181011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_0 + arg_48_0 then
				...
				local var_48_3 = arg_45_1:GetWordFromCfg(414181011)
	...
	Play414181012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_10 < arg_49_1.time_ and arg_49_1.time_ <= var_52_10 + arg_52_0 and not isNil(var_52_9) and arg_49_1.var_.characterEffect104902ui_story == nil then
			...
			if var_52_10 <= arg_49_1.time_ and arg_49_1.time_ < var_52_10 + var_52_11 and not isNil(var_52_9) then
				...
				if arg_49_1.var_.characterEffect104902ui_story and not isNil(var_52_9) then
					arg_49_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_49_1.time_ >= var_52_10 + var_52_11 and arg_49_1.time_ < var_52_10 + var_52_11 + arg_52_0 and not isNil(var_52_9) and arg_49_1.var_.characterEffect104902ui_story then
				arg_49_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if var_52_13 < arg_49_1.time_ and arg_49_1.time_ <= var_52_13 + arg_52_0 then
				...
				local var_52_15 = arg_49_1:FormatText(StoryNameCfg[562].name)
				...
				local var_52_16 = arg_49_1:GetWordFromCfg(414181012)
	...
	Play414181013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_1 < arg_53_1.time_ and arg_53_1.time_ <= var_56_1 + arg_56_0 and not isNil(var_56_0) and arg_53_1.var_.characterEffect104902ui_story == nil then
			...
			if var_56_1 <= arg_53_1.time_ and arg_53_1.time_ < var_56_1 + var_56_2 and not isNil(var_56_0) then
				...
				if arg_53_1.var_.characterEffect104902ui_story and not isNil(var_56_0) then
			...
			if arg_53_1.time_ >= var_56_1 + var_56_2 and arg_53_1.time_ < var_56_1 + var_56_2 + arg_56_0 and not isNil(var_56_0) and arg_53_1.var_.characterEffect104902ui_story then
				local var_56_5 = 0.5
	...
	Play414181014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_1 < arg_57_1.time_ and arg_57_1.time_ <= var_60_1 + arg_60_0 and not isNil(var_60_0) and arg_57_1.var_.characterEffect104902ui_story == nil then
			...
			if var_60_1 <= arg_57_1.time_ and arg_57_1.time_ < var_60_1 + var_60_2 and not isNil(var_60_0) then
				...
				if arg_57_1.var_.characterEffect104902ui_story and not isNil(var_60_0) then
					arg_57_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_57_1.time_ >= var_60_1 + var_60_2 and arg_57_1.time_ < var_60_1 + var_60_2 + arg_60_0 and not isNil(var_60_0) and arg_57_1.var_.characterEffect104902ui_story then
				arg_57_1.var_.characterEffect104902ui_story.fillFlat = false
			end

			local var_60_4 = "104902ui_story"

			if arg_57_1.actors_[var_60_4] == nil then
				local var_60_5 = Asset.Load("Char/" .. "104902ui_story")

				if not isNil(var_60_5) then
					local var_60_6 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_57_1.stage_.transform)
			...
			local var_60_10 = "104902ui_story"

			if arg_57_1.actors_[var_60_10] == nil then
				local var_60_11 = Asset.Load("Char/" .. "104902ui_story")

				if not isNil(var_60_11) then
					local var_60_12 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_57_1.stage_.transform)
			...
			if var_60_16 < arg_57_1.time_ and arg_57_1.time_ <= var_60_16 + arg_60_0 then
				...
				local var_60_18 = arg_57_1:FormatText(StoryNameCfg[562].name)
				...
				local var_60_19 = arg_57_1:GetWordFromCfg(414181014)
