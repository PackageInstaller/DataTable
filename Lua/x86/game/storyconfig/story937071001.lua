return {
	Play937071001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_56 < arg_1_1.time_ and arg_1_1.time_ <= var_4_56 + arg_4_0 then
				...
				local var_4_60 = arg_1_1:GetWordFromCfg(937071001)
	...
	Play937071002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_6 < arg_9_1.time_ and arg_9_1.time_ <= var_12_6 + arg_12_0 then
				...
				local var_12_9 = arg_9_1:GetWordFromCfg(937071002)
	...
	Play937071003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_15 < arg_13_1.time_ and arg_13_1.time_ <= var_16_15 + arg_16_0 then
				...
				local var_16_18 = arg_13_1:GetWordFromCfg(937071003)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_10 <= arg_17_1.time_ and arg_17_1.time_ < var_20_10 + var_20_11 and not isNil(var_20_9) then
				...
				if arg_17_1.var_.characterEffect1066ui_story and not isNil(var_20_9) then
					...
					arg_17_1.var_.characterEffect1066ui_story.fillRatio = var_20_13
				end
			end
			...
			if arg_17_1.time_ >= var_20_10 + var_20_11 and arg_17_1.time_ < var_20_10 + var_20_11 + arg_20_0 and not isNil(var_20_9) and arg_17_1.var_.characterEffect1066ui_story then
				...
				arg_17_1.var_.characterEffect1066ui_story.fillFlat = true
				arg_17_1.var_.characterEffect1066ui_story.fillRatio = var_20_14
			end

			local var_20_15 = 0
			local var_20_16 = 1.65
			...
			if var_20_15 < arg_17_1.time_ and arg_17_1.time_ <= var_20_15 + arg_20_0 then
				...
				local var_20_17 = arg_17_1:GetWordFromCfg(937071004)
	...
	Play937071005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:GetWordFromCfg(937071005)
	...
	Play937071006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_2 = arg_25_1:GetWordFromCfg(937071006)
	...
	Play937071007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_0 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:GetWordFromCfg(937071007)
	...
	Play937071008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_15 < arg_33_1.time_ and arg_33_1.time_ <= var_36_15 + arg_36_0 then
				...
				local var_36_18 = arg_33_1:GetWordFromCfg(937071008)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_10 <= arg_37_1.time_ and arg_37_1.time_ < var_40_10 + var_40_11 and not isNil(var_40_9) then
				...
				if arg_37_1.var_.characterEffect1066ui_story and not isNil(var_40_9) then
					...
					arg_37_1.var_.characterEffect1066ui_story.fillRatio = var_40_13
				end
			end
			...
			if arg_37_1.time_ >= var_40_10 + var_40_11 and arg_37_1.time_ < var_40_10 + var_40_11 + arg_40_0 and not isNil(var_40_9) and arg_37_1.var_.characterEffect1066ui_story then
				...
				arg_37_1.var_.characterEffect1066ui_story.fillFlat = true
				arg_37_1.var_.characterEffect1066ui_story.fillRatio = var_40_14
			end

			local var_40_15 = 0
			local var_40_16 = 1.625
			...
			if var_40_15 < arg_37_1.time_ and arg_37_1.time_ <= var_40_15 + arg_40_0 then
				...
				local var_40_17 = arg_37_1:GetWordFromCfg(937071009)
	...
	Play937071010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_0 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:GetWordFromCfg(937071010)
	...
	Play937071011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_10 < arg_45_1.time_ and arg_45_1.time_ <= var_48_10 + arg_48_0 and not isNil(var_48_9) and arg_45_1.var_.characterEffect1066ui_story == nil then
			...
			if var_48_10 <= arg_45_1.time_ and arg_45_1.time_ < var_48_10 + var_48_11 and not isNil(var_48_9) then
				...
				if arg_45_1.var_.characterEffect1066ui_story and not isNil(var_48_9) then
					arg_45_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_45_1.time_ >= var_48_10 + var_48_11 and arg_45_1.time_ < var_48_10 + var_48_11 + arg_48_0 and not isNil(var_48_9) and arg_45_1.var_.characterEffect1066ui_story then
				arg_45_1.var_.characterEffect1066ui_story.fillFlat = false
			end
			...
			if var_48_15 < arg_45_1.time_ and arg_45_1.time_ <= var_48_15 + arg_48_0 then
				...
				local var_48_18 = arg_45_1:GetWordFromCfg(937071011)
	...
	Play937071012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_6 < arg_49_1.time_ and arg_49_1.time_ <= var_52_6 + arg_52_0 then
				...
				local var_52_9 = arg_49_1:GetWordFromCfg(937071012)
	...
	Play937071013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_9 < arg_53_1.time_ and arg_53_1.time_ <= var_56_9 + arg_56_0 then
				...
				local var_56_11 = arg_53_1:GetWordFromCfg(937071013)
	...
	Play937071014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_0 + arg_60_0 then
				...
				local var_60_3 = arg_57_1:GetWordFromCfg(937071014)
	...
	Play937071015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_15 < arg_61_1.time_ and arg_61_1.time_ <= var_64_15 + arg_64_0 then
				...
				local var_64_18 = arg_61_1:GetWordFromCfg(937071015)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_10 <= arg_65_1.time_ and arg_65_1.time_ < var_68_10 + var_68_11 and not isNil(var_68_9) then
				...
				if arg_65_1.var_.characterEffect1066ui_story and not isNil(var_68_9) then
					...
					arg_65_1.var_.characterEffect1066ui_story.fillRatio = var_68_13
				end
			end
			...
			if arg_65_1.time_ >= var_68_10 + var_68_11 and arg_65_1.time_ < var_68_10 + var_68_11 + arg_68_0 and not isNil(var_68_9) and arg_65_1.var_.characterEffect1066ui_story then
				...
				arg_65_1.var_.characterEffect1066ui_story.fillFlat = true
				arg_65_1.var_.characterEffect1066ui_story.fillRatio = var_68_14
			end
			...
			if var_68_15 < arg_65_1.time_ and arg_65_1.time_ <= var_68_15 + arg_68_0 then
				...
				local var_68_17 = arg_65_1:GetWordFromCfg(937071016)
	...
	Play937071017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_0 + arg_72_0 then
				...
				local var_72_3 = arg_69_1:GetWordFromCfg(937071017)
	...
	Play937071018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if var_76_0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_0 + arg_76_0 then
				...
				local var_76_2 = arg_73_1:GetWordFromCfg(937071018)
	...
	Play937071019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			local var_80_9 = arg_77_1.actors_["1066ui_story"]
			local var_80_10 = 0

			if var_80_10 < arg_77_1.time_ and arg_77_1.time_ <= var_80_10 + arg_80_0 and not isNil(var_80_9) and arg_77_1.var_.characterEffect1066ui_story == nil then
				arg_77_1.var_.characterEffect1066ui_story = var_80_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_80_10 <= arg_77_1.time_ and arg_77_1.time_ < var_80_10 + var_80_11 and not isNil(var_80_9) then
				...
				if arg_77_1.var_.characterEffect1066ui_story and not isNil(var_80_9) then
					arg_77_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_77_1.time_ >= var_80_10 + var_80_11 and arg_77_1.time_ < var_80_10 + var_80_11 + arg_80_0 and not isNil(var_80_9) and arg_77_1.var_.characterEffect1066ui_story then
				arg_77_1.var_.characterEffect1066ui_story.fillFlat = false
			end
			...
			if var_80_15 < arg_77_1.time_ and arg_77_1.time_ <= var_80_15 + arg_80_0 then
				...
				local var_80_17 = arg_77_1:FormatText(StoryNameCfg[32].name)
				...
				local var_80_18 = arg_77_1:GetWordFromCfg(937071019)
