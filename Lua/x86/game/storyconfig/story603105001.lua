	...
	Play603105001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_4 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				...
				var_4_3.localScale = Vector3.New(0.7, 0.7, 0.7)
			end
			...
			if var_4_19 < arg_1_1.time_ and arg_1_1.time_ <= var_4_19 + arg_4_0 then
				...
				local var_4_23 = arg_1_1:GetWordFromCfg(603105001)
	...
	Play603105003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_0 + arg_14_0 then
				...
				local var_14_2 = arg_11_1:FormatText(StoryNameCfg[177].name)
