return {
	Play910828001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_45 < arg_1_1.time_ and arg_1_1.time_ <= var_4_45 + arg_4_0 then
				...
				local var_4_49 = arg_1_1:GetWordFromCfg(910828001)
	...
	Play910828002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_1 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 and not isNil(var_10_0) and arg_7_1.var_.actorSpriteComps1084 == nil then
			...
			if arg_7_1.time_ >= var_10_1 + var_10_2 and arg_7_1.time_ < var_10_1 + var_10_2 + arg_10_0 and not isNil(var_10_0) and arg_7_1.var_.actorSpriteComps1084 then
			...
			if var_10_8 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 then
				...
				local var_10_10 = arg_7_1:FormatText(StoryNameCfg[7].name)
				...
				local var_10_11 = arg_7_1:GetWordFromCfg(910828002)
	...
	Play910828003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				local var_14_17 = arg_11_1:FormatText(StoryNameCfg[6].name)
				...
				local var_14_18 = arg_11_1:GetWordFromCfg(910828003)
	...
	Play910828004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_1 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 and not isNil(var_18_0) and arg_15_1.var_.actorSpriteComps1084 == nil then
			...
			if arg_15_1.time_ >= var_18_1 + var_18_2 and arg_15_1.time_ < var_18_1 + var_18_2 + arg_18_0 and not isNil(var_18_0) and arg_15_1.var_.actorSpriteComps1084 then
			...
			if var_18_8 < arg_15_1.time_ and arg_15_1.time_ <= var_18_8 + arg_18_0 then
				...
				local var_18_11 = arg_15_1:GetWordFromCfg(910828004)
	...
	Play910828005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_15 < arg_19_1.time_ and arg_19_1.time_ <= var_22_15 + arg_22_0 then
				...
				local var_22_18 = arg_19_1:GetWordFromCfg(910828005)
	...
	Play910828006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_1 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 and not isNil(var_26_0) and arg_23_1.var_.actorSpriteComps1084 == nil then
			...
			if arg_23_1.time_ >= var_26_1 + var_26_2 and arg_23_1.time_ < var_26_1 + var_26_2 + arg_26_0 and not isNil(var_26_0) and arg_23_1.var_.actorSpriteComps1084 then
			...
			local var_26_8 = arg_23_1.actors_["1084"].transform
			local var_26_9 = 0

			if var_26_9 < arg_23_1.time_ and arg_23_1.time_ <= var_26_9 + arg_26_0 then
				arg_23_1.var_.moveOldPos1084 = var_26_8.localPosition
				...
				for iter_26_4 = 0, var_26_10 - 1 do
					...
					if var_26_11.name == "split_4" or not string.find(var_26_11.name, "split") then
			...
			if var_26_9 <= arg_23_1.time_ and arg_23_1.time_ < var_26_9 + var_26_12 then
				...
				local var_26_14 = Vector3.New(0, -350, -180)

				var_26_8.localPosition = Vector3.Lerp(arg_23_1.var_.moveOldPos1084, var_26_14, var_26_13)
			end

			if arg_23_1.time_ >= var_26_9 + var_26_12 and arg_23_1.time_ < var_26_9 + var_26_12 + arg_26_0 then
				var_26_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_26_15 < arg_23_1.time_ and arg_23_1.time_ <= var_26_15 + arg_26_0 then
				...
				local var_26_18 = arg_23_1:GetWordFromCfg(910828006)
	...
	Play910828007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_15 < arg_27_1.time_ and arg_27_1.time_ <= var_30_15 + arg_30_0 then
				...
				local var_30_18 = arg_27_1:GetWordFromCfg(910828007)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_9 < arg_31_1.time_ and arg_31_1.time_ <= var_34_9 + arg_34_0 then
				...
				for iter_34_4 = 0, var_34_10 - 1 do
					...
					if var_34_11.name == "split_1_1" or not string.find(var_34_11.name, "split") then
			...
			if var_34_9 <= arg_31_1.time_ and arg_31_1.time_ < var_34_9 + var_34_12 then
				...
				local var_34_14 = Vector3.New(0, -350, -180)
			...
			if arg_31_1.time_ >= var_34_9 + var_34_12 and arg_31_1.time_ < var_34_9 + var_34_12 + arg_34_0 then
				var_34_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_34_15 < arg_31_1.time_ and arg_31_1.time_ <= var_34_15 + arg_34_0 then
				...
				local var_34_18 = arg_31_1:GetWordFromCfg(910828008)
	...
	Play910828009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			local var_38_8 = arg_35_1.actors_["1084"].transform
			local var_38_9 = 0

			if var_38_9 < arg_35_1.time_ and arg_35_1.time_ <= var_38_9 + arg_38_0 then
				arg_35_1.var_.moveOldPos1084 = var_38_8.localPosition
				...
				for iter_38_4 = 0, var_38_10 - 1 do
					...
					if var_38_11.name == "split_1_1" or not string.find(var_38_11.name, "split") then
			...
			if var_38_9 <= arg_35_1.time_ and arg_35_1.time_ < var_38_9 + var_38_12 then
				...
				local var_38_14 = Vector3.New(0, -350, -180)

				var_38_8.localPosition = Vector3.Lerp(arg_35_1.var_.moveOldPos1084, var_38_14, var_38_13)
			end

			if arg_35_1.time_ >= var_38_9 + var_38_12 and arg_35_1.time_ < var_38_9 + var_38_12 + arg_38_0 then
				var_38_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_38_15 < arg_35_1.time_ and arg_35_1.time_ <= var_38_15 + arg_38_0 then
				...
				local var_38_17 = arg_35_1:GetWordFromCfg(910828009)
	...
	Play910828010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_15 < arg_39_1.time_ and arg_39_1.time_ <= var_42_15 + arg_42_0 then
				...
				local var_42_18 = arg_39_1:GetWordFromCfg(910828010)
	...
	Play910828011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_15 < arg_43_1.time_ and arg_43_1.time_ <= var_46_15 + arg_46_0 then
				...
				local var_46_18 = arg_43_1:GetWordFromCfg(910828011)
	...
	Play910828012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_15 < arg_47_1.time_ and arg_47_1.time_ <= var_50_15 + arg_50_0 then
				...
				local var_50_18 = arg_47_1:GetWordFromCfg(910828012)
	...
	Play910828013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			local var_54_8 = arg_51_1.actors_["1084"].transform
			local var_54_9 = 0

			if var_54_9 < arg_51_1.time_ and arg_51_1.time_ <= var_54_9 + arg_54_0 then
				arg_51_1.var_.moveOldPos1084 = var_54_8.localPosition
			...
			if var_54_9 <= arg_51_1.time_ and arg_51_1.time_ < var_54_9 + var_54_12 then
				...
				var_54_8.localPosition = Vector3.Lerp(arg_51_1.var_.moveOldPos1084, var_54_14, var_54_13)
			end
			...
			if var_54_15 < arg_51_1.time_ and arg_51_1.time_ <= var_54_15 + arg_54_0 then
				...
				local var_54_17 = arg_51_1:FormatText(StoryNameCfg[623].name)
				...
				local var_54_18 = arg_51_1:GetWordFromCfg(910828013)
	...
	Play910828014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if var_58_9 <= arg_55_1.time_ and arg_55_1.time_ < var_58_9 + var_58_12 then
				...
				local var_58_14 = Vector3.New(0, -350, -180)
			...
			if arg_55_1.time_ >= var_58_9 + var_58_12 and arg_55_1.time_ < var_58_9 + var_58_12 + arg_58_0 then
				var_58_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_58_15 < arg_55_1.time_ and arg_55_1.time_ <= var_58_15 + arg_58_0 then
				...
				local var_58_18 = arg_55_1:GetWordFromCfg(910828014)
	...
	Play910828015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if var_62_15 < arg_59_1.time_ and arg_59_1.time_ <= var_62_15 + arg_62_0 then
				...
				local var_62_18 = arg_59_1:GetWordFromCfg(910828015)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if var_66_9 < arg_63_1.time_ and arg_63_1.time_ <= var_66_9 + arg_66_0 then
				...
				for iter_66_4 = 0, var_66_10 - 1 do
					...
					if var_66_11.name == "split_1_1" or not string.find(var_66_11.name, "split") then
			...
			if var_66_9 <= arg_63_1.time_ and arg_63_1.time_ < var_66_9 + var_66_12 then
				...
				local var_66_14 = Vector3.New(0, -350, -180)
			...
			if arg_63_1.time_ >= var_66_9 + var_66_12 and arg_63_1.time_ < var_66_9 + var_66_12 + arg_66_0 then
				var_66_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_66_15 < arg_63_1.time_ and arg_63_1.time_ <= var_66_15 + arg_66_0 then
				...
				local var_66_18 = arg_63_1:GetWordFromCfg(910828016)
	...
	Play910828017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if var_70_15 < arg_67_1.time_ and arg_67_1.time_ <= var_70_15 + arg_70_0 then
				...
				arg_67_1:AudioAction(var_70_17, var_70_18, "ui_skip", "ui_bgm_lower_back", "")
			end
			...
			if var_70_19 < arg_67_1.time_ and arg_67_1.time_ <= var_70_19 + arg_70_0 then
				...
				local var_70_22 = arg_67_1:GetWordFromCfg(910828017)
