return {
	Play910105001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 910105001
		arg_1_1.duration_ = 6
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_25 = arg_1_1.actors_["1039"].transform
			local var_4_26 = 1

			if var_4_26 < arg_1_1.time_ and arg_1_1.time_ <= var_4_26 + arg_4_0 then
				arg_1_1.var_.moveOldPos1039 = var_4_25.localPosition
			...
			if var_4_26 <= arg_1_1.time_ and arg_1_1.time_ < var_4_26 + var_4_27 then
				...
				var_4_25.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1039, var_4_29, var_4_28)
			end
			...
			local var_4_30 = arg_1_1.actors_["1039"]
			local var_4_31 = 1
			...
			if var_4_31 < arg_1_1.time_ and arg_1_1.time_ <= var_4_31 + arg_4_0 then
				...
				if var_4_32 then
					arg_1_1.var_.alphaMatValue1039 = var_4_32
					arg_1_1.var_.alphaOldValue1039 = var_4_32.color.a
				end
			...
			if var_4_31 <= arg_1_1.time_ and arg_1_1.time_ < var_4_31 + var_4_33 then
				...
				local var_4_35 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1039, 1, var_4_34)

				if arg_1_1.var_.alphaMatValue1039 then
					local var_4_36 = arg_1_1.var_.alphaMatValue1039.color

					var_4_36.a = var_4_35
					arg_1_1.var_.alphaMatValue1039.color = var_4_36
				end
			end

			if arg_1_1.time_ >= var_4_31 + var_4_33 and arg_1_1.time_ < var_4_31 + var_4_33 + arg_4_0 and arg_1_1.var_.alphaMatValue1039 then
				local var_4_37 = arg_1_1.var_.alphaMatValue1039
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				local var_4_42 = arg_1_1:FormatText(StoryNameCfg[9].name)
				...
				local var_4_43 = arg_1_1:GetWordFromCfg(910105001)
	...
	Play910105002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 910105002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_2 = arg_7_1:FormatText(StoryNameCfg[9].name)
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(910105002)
	...
	Play910105003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 910105003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play910105004(arg_11_1)
			end
		end

		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			local var_14_0 = arg_11_1.actors_["1039"].transform
			local var_14_1 = 0.0333333333333333
			...
			if var_14_7 < arg_11_1.time_ and arg_11_1.time_ <= var_14_7 + arg_14_0 then
				...
				local var_14_10 = arg_11_1:GetWordFromCfg(910105003)
	...
	Play910105004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 910105004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play910105005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_0 + arg_18_0 then
				...
				local var_18_2 = arg_15_1:FormatText(StoryNameCfg[9].name)
				...
				local var_18_3 = arg_15_1:GetWordFromCfg(910105004)
	...
	Play910105005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 910105005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play910105006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_0 + arg_22_0 then
				...
				local var_22_2 = arg_19_1:FormatText(StoryNameCfg[9].name)
				...
				local var_22_3 = arg_19_1:GetWordFromCfg(910105005)
	...
	Play910105006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 910105006
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_0 + arg_26_0 then
				...
				local var_26_3 = arg_23_1:GetWordFromCfg(910105006)
