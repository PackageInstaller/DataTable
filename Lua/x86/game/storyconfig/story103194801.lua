	...
	Play319481036 = function(arg_145_0, arg_145_1)
		...
		function arg_145_1.onSingleLineUpdate_(arg_148_0)
			...
			if var_148_34 < arg_145_1.time_ and arg_145_1.time_ <= var_148_34 + arg_148_0 then
				...
				local var_148_36 = arg_145_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_148_37 = var_148_35:GetComponent("Text")
				local var_148_38 = var_148_35:GetComponent("RectTransform")

				var_148_37.alignment = UnityEngine.TextAnchor.LowerCenter
				var_148_38.offsetMin = Vector2.New(0, 0)
				var_148_38.offsetMax = Vector2.New(0, 0)
			end
			...
			if var_148_39 < arg_145_1.time_ and arg_145_1.time_ <= var_148_39 + arg_148_0 then
				...
				local var_148_40 = arg_145_1:GetWordFromCfg(319481036)
				local var_148_41 = arg_145_1:FormatText(var_148_40.content)

				arg_145_1.fswt_.text = var_148_41
			...
			local var_148_42 = 0.666666666666667
			...
			local var_148_43 = 28
			local var_148_44 = 1.86666666666667
			local var_148_45 = arg_145_1:GetWordFromCfg(319481036)
			local var_148_46 = arg_145_1:FormatText(var_148_45.content)
			local var_148_47, var_148_48 = arg_145_1:GetPercentByPara(var_148_46, 1)

			if var_148_42 < arg_145_1.time_ and arg_145_1.time_ <= var_148_42 + arg_148_0 then
				arg_145_1.talkMaxDuration = 0

				local var_148_49 = var_148_43 <= 0 and var_148_44 or var_148_44 * ((var_148_48 - arg_145_1.typewritterCharCountI18N) / var_148_43)

				if var_148_49 > 0 and var_148_44 < var_148_49 then
			...
			local var_148_50 = 1.86666666666667
			local var_148_51 = math.max(var_148_50, arg_145_1.talkMaxDuration)

			if var_148_42 <= arg_145_1.time_ and arg_145_1.time_ < var_148_42 + var_148_51 then
				local var_148_52 = (arg_145_1.time_ - var_148_42) / var_148_51

				arg_145_1.fswtw_.percent = Mathf.Lerp(arg_145_1.var_.oldValueTypewriter, var_148_47, var_148_52)
				arg_145_1.fswt_:GetComponent("Text").color = Color(1, 1, 1)

				arg_145_1.fswtw_:SetDirty()
			end

			if arg_145_1.time_ >= var_148_42 + var_148_51 and arg_145_1.time_ < var_148_42 + var_148_51 + arg_148_0 then
				arg_145_1.fswtw_.percent = var_148_47

				arg_145_1.fswtw_:SetDirty()
				arg_145_1:ShowNextGo(true)

				arg_145_1.typewritterCharCountI18N = var_148_48
			end

			local var_148_53 = 0

			if var_148_53 < arg_145_1.time_ and arg_145_1.time_ <= var_148_53 + arg_148_0 then
				arg_145_1.cswbg_:SetActive(true)

				local var_148_54 = arg_145_1.cswt_:GetComponent("RectTransform")

				arg_145_1.cswt_.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_148_54.offsetMin = Vector2.New(410, 330)
				var_148_54.offsetMax = Vector2.New(-400, -175)

				local var_148_55 = arg_145_1:GetWordFromCfg(419024)
				local var_148_56 = arg_145_1:FormatText(var_148_55.content)

				arg_145_1.cswt_.text = var_148_56
			...
			local var_148_57 = 0.666666666666667
			local var_148_58 = 5.1
			local var_148_59 = manager.audio:GetVoiceLength("story_v_out_319481", "319481036", "story_v_out_319481.awb") / 1000

			if var_148_59 > 0 and var_148_58 < var_148_59 and var_148_59 + var_148_57 > arg_145_1.duration_ then
				local var_148_60 = var_148_59

				arg_145_1.duration_ = var_148_59 + var_148_57
			end

			if var_148_57 < arg_145_1.time_ and arg_145_1.time_ <= var_148_57 + arg_148_0 then
				local var_148_61 = "play"
				local var_148_62 = "voice"

				arg_145_1:AudioAction(var_148_61, var_148_62, "story_v_out_319481", "319481036", "story_v_out_319481.awb")
			end
		end
