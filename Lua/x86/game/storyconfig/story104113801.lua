return {
	Play411381001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_54 < arg_1_1.time_ and arg_1_1.time_ <= var_4_54 + arg_4_0 then
				...
				local var_4_58 = arg_1_1:GetWordFromCfg(411381001)
	...
	Play411381002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_35 < arg_9_1.time_ and arg_9_1.time_ <= var_12_35 + arg_12_0 then
				...
				local var_12_38 = arg_9_1:GetWordFromCfg(411381002)
	...
	Play411381003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_6 < arg_13_1.time_ and arg_13_1.time_ <= var_16_6 + arg_16_0 then
				...
				local var_16_8 = arg_13_1:GetWordFromCfg(411381003)
	...
	Play411381004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_1 <= arg_17_1.time_ and arg_17_1.time_ < var_20_1 + var_20_2 then
				...
				local var_20_4 = Vector3.New(0.7, -0.98, -6.1)
			...
			if arg_17_1.time_ >= var_20_1 + var_20_2 and arg_17_1.time_ < var_20_1 + var_20_2 + arg_20_0 then
				var_20_0.localPosition = Vector3.New(0.7, -0.98, -6.1)
			...
			if var_20_15 < arg_17_1.time_ and arg_17_1.time_ <= var_20_15 + arg_20_0 then
				...
				local var_20_18 = arg_17_1:GetWordFromCfg(411381004)
	...
	Play411381005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			local var_24_15 = arg_21_1.actors_["1095ui_story"]
			local var_24_16 = 0

			if var_24_16 < arg_21_1.time_ and arg_21_1.time_ <= var_24_16 + arg_24_0 and not isNil(var_24_15) and arg_21_1.var_.characterEffect1095ui_story == nil then
				arg_21_1.var_.characterEffect1095ui_story = var_24_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_24_16 <= arg_21_1.time_ and arg_21_1.time_ < var_24_16 + var_24_17 and not isNil(var_24_15) then
				...
				if arg_21_1.var_.characterEffect1095ui_story and not isNil(var_24_15) then
					local var_24_19 = Mathf.Lerp(0, 0.5, var_24_18)

					arg_21_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_21_1.var_.characterEffect1095ui_story.fillRatio = var_24_19
				end
			end

			if arg_21_1.time_ >= var_24_16 + var_24_17 and arg_21_1.time_ < var_24_16 + var_24_17 + arg_24_0 and not isNil(var_24_15) and arg_21_1.var_.characterEffect1095ui_story then
				local var_24_20 = 0.5

				arg_21_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_21_1.var_.characterEffect1095ui_story.fillRatio = var_24_20
			end
			...
			if var_24_21 < arg_21_1.time_ and arg_21_1.time_ <= var_24_21 + arg_24_0 then
				...
				local var_24_24 = arg_21_1:GetWordFromCfg(411381005)
	...
	Play411381006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:GetWordFromCfg(411381006)
	...
	Play411381007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_21 < arg_29_1.time_ and arg_29_1.time_ <= var_32_21 + arg_32_0 then
				...
				local var_32_24 = arg_29_1:GetWordFromCfg(411381007)
	...
	Play411381008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_20 < arg_33_1.time_ and arg_33_1.time_ <= var_36_20 + arg_36_0 then
				...
				local var_36_23 = arg_33_1:GetWordFromCfg(411381008)
	...
	Play411381009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_0 + arg_40_0 then
				...
				local var_40_3 = arg_37_1:GetWordFromCfg(411381009)
	...
	Play411381010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			local var_44_15 = arg_41_1.actors_["10079ui_story"]
			local var_44_16 = 0

			if var_44_16 < arg_41_1.time_ and arg_41_1.time_ <= var_44_16 + arg_44_0 and not isNil(var_44_15) and arg_41_1.var_.characterEffect10079ui_story == nil then
				arg_41_1.var_.characterEffect10079ui_story = var_44_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_44_16 <= arg_41_1.time_ and arg_41_1.time_ < var_44_16 + var_44_17 and not isNil(var_44_15) then
				...
				if arg_41_1.var_.characterEffect10079ui_story and not isNil(var_44_15) then
					local var_44_19 = Mathf.Lerp(0, 0.5, var_44_18)

					arg_41_1.var_.characterEffect10079ui_story.fillFlat = true
					arg_41_1.var_.characterEffect10079ui_story.fillRatio = var_44_19
				end
			end

			if arg_41_1.time_ >= var_44_16 + var_44_17 and arg_41_1.time_ < var_44_16 + var_44_17 + arg_44_0 and not isNil(var_44_15) and arg_41_1.var_.characterEffect10079ui_story then
				local var_44_20 = 0.5

				arg_41_1.var_.characterEffect10079ui_story.fillFlat = true
				arg_41_1.var_.characterEffect10079ui_story.fillRatio = var_44_20
			end

			local var_44_21 = 0
			local var_44_22 = 0.425
			...
			if var_44_21 < arg_41_1.time_ and arg_41_1.time_ <= var_44_21 + arg_44_0 then
				...
				local var_44_24 = arg_41_1:GetWordFromCfg(411381010)
	...
	Play411381011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_1 <= arg_45_1.time_ and arg_45_1.time_ < var_48_1 + var_48_2 then
				...
				local var_48_4 = Vector3.New(-0.7, -0.95, -6.05)
			...
			if arg_45_1.time_ >= var_48_1 + var_48_2 and arg_45_1.time_ < var_48_1 + var_48_2 + arg_48_0 then
				var_48_0.localPosition = Vector3.New(-0.7, -0.95, -6.05)
			...
			local var_48_9 = arg_45_1.actors_["10079ui_story"]
			local var_48_10 = 0

			if var_48_10 < arg_45_1.time_ and arg_45_1.time_ <= var_48_10 + arg_48_0 and not isNil(var_48_9) and arg_45_1.var_.characterEffect10079ui_story == nil then
				arg_45_1.var_.characterEffect10079ui_story = var_48_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_48_10 <= arg_45_1.time_ and arg_45_1.time_ < var_48_10 + var_48_11 and not isNil(var_48_9) then
				...
				if arg_45_1.var_.characterEffect10079ui_story and not isNil(var_48_9) then
					arg_45_1.var_.characterEffect10079ui_story.fillFlat = false
				end
			end

			if arg_45_1.time_ >= var_48_10 + var_48_11 and arg_45_1.time_ < var_48_10 + var_48_11 + arg_48_0 and not isNil(var_48_9) and arg_45_1.var_.characterEffect10079ui_story then
				arg_45_1.var_.characterEffect10079ui_story.fillFlat = false
			end
			...
			local var_48_15 = arg_45_1.actors_["1095ui_story"]
			local var_48_16 = 0

			if var_48_16 < arg_45_1.time_ and arg_45_1.time_ <= var_48_16 + arg_48_0 and not isNil(var_48_15) and arg_45_1.var_.characterEffect1095ui_story == nil then
				arg_45_1.var_.characterEffect1095ui_story = var_48_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_48_16 <= arg_45_1.time_ and arg_45_1.time_ < var_48_16 + var_48_17 and not isNil(var_48_15) then
				...
				if arg_45_1.var_.characterEffect1095ui_story and not isNil(var_48_15) then
					local var_48_19 = Mathf.Lerp(0, 0.5, var_48_18)

					arg_45_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_45_1.var_.characterEffect1095ui_story.fillRatio = var_48_19
				end
			end

			if arg_45_1.time_ >= var_48_16 + var_48_17 and arg_45_1.time_ < var_48_16 + var_48_17 + arg_48_0 and not isNil(var_48_15) and arg_45_1.var_.characterEffect1095ui_story then
				local var_48_20 = 0.5

				arg_45_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_45_1.var_.characterEffect1095ui_story.fillRatio = var_48_20
			end
			...
			if var_48_21 < arg_45_1.time_ and arg_45_1.time_ <= var_48_21 + arg_48_0 then
				...
				local var_48_24 = arg_45_1:GetWordFromCfg(411381011)
	...
	Play411381012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_1 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:FormatText(StoryNameCfg[6].name)
				...
				local var_52_4 = arg_49_1:GetWordFromCfg(411381012)
	...
	Play411381013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_10 < arg_53_1.time_ and arg_53_1.time_ <= var_56_10 + arg_56_0 then
				...
				local var_56_13 = arg_53_1:GetWordFromCfg(411381013)
	...
	Play411381014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_6 < arg_57_1.time_ and arg_57_1.time_ <= var_60_6 + arg_60_0 then
				...
				local var_60_8 = arg_57_1:GetWordFromCfg(411381014)
	...
	Play411381015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_15 < arg_61_1.time_ and arg_61_1.time_ <= var_64_15 + arg_64_0 then
				...
				local var_64_18 = arg_61_1:GetWordFromCfg(411381015)
	...
	Play411381016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_21 < arg_65_1.time_ and arg_65_1.time_ <= var_68_21 + arg_68_0 then
				...
				local var_68_24 = arg_65_1:GetWordFromCfg(411381016)
	...
	Play411381017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_6 < arg_69_1.time_ and arg_69_1.time_ <= var_72_6 + arg_72_0 then
				...
				local var_72_8 = arg_69_1:GetWordFromCfg(411381017)
	...
	Play411381018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if var_76_0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_0 + arg_76_0 then
				...
				local var_76_2 = arg_73_1:GetWordFromCfg(411381018)
	...
	Play411381019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if var_80_15 < arg_77_1.time_ and arg_77_1.time_ <= var_80_15 + arg_80_0 then
				...
				local var_80_18 = arg_77_1:GetWordFromCfg(411381019)
	...
	Play411381020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if var_84_10 < arg_81_1.time_ and arg_81_1.time_ <= var_84_10 + arg_84_0 then
				...
				local var_84_13 = arg_81_1:GetWordFromCfg(411381020)
	...
	Play411381021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if var_88_11 < arg_85_1.time_ and arg_85_1.time_ <= var_88_11 + arg_88_0 then
				...
				local var_88_14 = arg_85_1:GetWordFromCfg(411381021)
	...
	Play411381022 = function(arg_89_0, arg_89_1)
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			...
			if var_92_10 < arg_89_1.time_ and arg_89_1.time_ <= var_92_10 + arg_92_0 then
				...
				local var_92_13 = arg_89_1:GetWordFromCfg(411381022)
	...
	Play411381023 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if var_96_20 < arg_93_1.time_ and arg_93_1.time_ <= var_96_20 + arg_96_0 then
				...
				local var_96_22 = arg_93_1:FormatText(StoryNameCfg[6].name)
				...
				local var_96_23 = arg_93_1:GetWordFromCfg(411381023)
			...
			local var_96_28 = math.max(var_96_21, arg_93_1.talkMaxDuration)

			if var_96_20 <= arg_93_1.time_ and arg_93_1.time_ < var_96_20 + var_96_28 then
				arg_93_1.typewritter.percent = (arg_93_1.time_ - var_96_20) / var_96_28

				arg_93_1.typewritter:SetDirty()
			end

			if arg_93_1.time_ >= var_96_20 + var_96_28 and arg_93_1.time_ < var_96_20 + var_96_28 + arg_96_0 then
	...
	Play411381024 = function(arg_97_0, arg_97_1)
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			...
			if var_100_21 < arg_97_1.time_ and arg_97_1.time_ <= var_100_21 + arg_100_0 then
				...
				local var_100_24 = arg_97_1:GetWordFromCfg(411381024)
