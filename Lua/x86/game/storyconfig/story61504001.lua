	...
	Play61504001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_0] == nil then
				...
				var_4_2.sprite = getSpriteWithoutAtlas("TextureConfig/WeaponServant/Portrait/" .. "2530007")
			...
			local var_4_3 = arg_1_1.actors_["2530007"].transform
			local var_4_4 = 0.333333333333333

			if var_4_4 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				arg_1_1.var_.moveOldPos2530007 = var_4_3.localPosition
			...
			if var_4_4 <= arg_1_1.time_ and arg_1_1.time_ < var_4_4 + var_4_5 then
				...
				local var_4_7 = Vector3.New(0, 25, -135)

				var_4_3.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2530007, var_4_7, var_4_6)
			end

			if arg_1_1.time_ >= var_4_4 + var_4_5 and arg_1_1.time_ < var_4_4 + var_4_5 + arg_4_0 then
				var_4_3.localPosition = Vector3.New(0, 25, -135)
			end

			local var_4_8 = arg_1_1.actors_["2530007"]
			...
			if var_4_9 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 and not isNil(var_4_8) then
				...
				if var_4_10 then
					arg_1_1.var_.highlightMatValue2530007 = var_4_10
				end
			end
			...
			if var_4_9 <= arg_1_1.time_ and arg_1_1.time_ < var_4_9 + var_4_11 and not isNil(var_4_8) then
				...
				if arg_1_1.var_.highlightMatValue2530007 then
					...
					local var_4_14 = arg_1_1.var_.highlightMatValue2530007
			...
			if arg_1_1.time_ >= var_4_9 + var_4_11 and arg_1_1.time_ < var_4_9 + var_4_11 + arg_4_0 and not isNil(var_4_8) and arg_1_1.var_.highlightMatValue2530007 then
				local var_4_16 = 1

				var_4_8.transform:SetSiblingIndex(1)

				local var_4_17 = arg_1_1.var_.highlightMatValue2530007
			...
			if var_4_19 < arg_1_1.time_ and arg_1_1.time_ <= var_4_19 + arg_4_0 then
				...
				local var_4_22 = arg_1_1:FormatText(StoryNameCfg[164].name)
				...
				local var_4_23 = arg_1_1:GetWordFromCfg(61504001)
