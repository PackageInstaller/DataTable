return {
	Play910502020 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_24] == nil then
				local var_4_25 = Asset.Load("Char/" .. "3044ui_story")

				if not isNil(var_4_25) then
					local var_4_26 = Object.Instantiate(Asset.Load("Char/" .. "3044ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_29 = arg_1_1.actors_["3044ui_story"].transform
			local var_4_30 = 1.8

			if var_4_30 < arg_1_1.time_ and arg_1_1.time_ <= var_4_30 + arg_4_0 then
				arg_1_1.var_.moveOldPos3044ui_story = var_4_29.localPosition
			end
			...
			if var_4_30 <= arg_1_1.time_ and arg_1_1.time_ < var_4_30 + var_4_31 then
				...
				local var_4_33 = Vector3.New(0, -2.22, -2.4)

				var_4_29.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos3044ui_story, var_4_33, var_4_32)
			...
			if arg_1_1.time_ >= var_4_30 + var_4_31 and arg_1_1.time_ < var_4_30 + var_4_31 + arg_4_0 then
				var_4_29.localPosition = Vector3.New(0, -2.22, -2.4)
			...
			local var_4_38 = arg_1_1.actors_["3044ui_story"]
			local var_4_39 = 1.8

			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 and not isNil(var_4_38) and arg_1_1.var_.characterEffect3044ui_story == nil then
				arg_1_1.var_.characterEffect3044ui_story = var_4_38:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_4_39 <= arg_1_1.time_ and arg_1_1.time_ < var_4_39 + var_4_40 and not isNil(var_4_38) then
				...
				if arg_1_1.var_.characterEffect3044ui_story and not isNil(var_4_38) then
					arg_1_1.var_.characterEffect3044ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= var_4_39 + var_4_40 and arg_1_1.time_ < var_4_39 + var_4_40 + arg_4_0 and not isNil(var_4_38) and arg_1_1.var_.characterEffect3044ui_story then
				arg_1_1.var_.characterEffect3044ui_story.fillFlat = false
			end
			...
			if var_4_44 < arg_1_1.time_ and arg_1_1.time_ <= var_4_44 + arg_4_0 then
				...
				local var_4_47 = arg_1_1:FormatText(StoryNameCfg[493].name)
				...
				local var_4_48 = arg_1_1:GetWordFromCfg(910502020)
	...
	Play910502022 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_10 < arg_11_1.time_ and arg_11_1.time_ <= var_14_10 + arg_14_0 and not isNil(var_14_9) and arg_11_1.var_.characterEffect3044ui_story == nil then
			...
			if var_14_10 <= arg_11_1.time_ and arg_11_1.time_ < var_14_10 + var_14_11 and not isNil(var_14_9) then
				...
				if arg_11_1.var_.characterEffect3044ui_story and not isNil(var_14_9) then
			...
			if arg_11_1.time_ >= var_14_10 + var_14_11 and arg_11_1.time_ < var_14_10 + var_14_11 + arg_14_0 and not isNil(var_14_9) and arg_11_1.var_.characterEffect3044ui_story then
				local var_14_14 = 0.5
	...
	Play910502023 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_6 <= arg_15_1.time_ and arg_15_1.time_ < var_18_6 + var_18_7 then
				...
				local var_18_9 = Vector3.New(0, -1.155, -6.13)
			...
			if arg_15_1.time_ >= var_18_6 + var_18_7 and arg_15_1.time_ < var_18_6 + var_18_7 + arg_18_0 then
				var_18_5.localPosition = Vector3.New(0, -1.155, -6.13)
			...
			if var_18_20 < arg_15_1.time_ and arg_15_1.time_ <= var_18_20 + arg_18_0 then
				...
				local var_18_22 = arg_15_1:FormatText(StoryNameCfg[476].name)
				...
				local var_18_23 = arg_15_1:GetWordFromCfg(910502023)
