return {
	Play62101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_16 < arg_1_1.time_ and arg_1_1.time_ <= var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1111ui_story == nil then
			...
			if arg_1_1.time_ >= var_4_16 + var_4_17 and arg_1_1.time_ < var_4_16 + var_4_17 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1111ui_story then
				arg_1_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if var_4_21 < arg_1_1.time_ and arg_1_1.time_ <= var_4_21 + arg_4_0 then
				...
				local var_4_24 = arg_1_1.bgs_.B06
			...
			local var_4_48 = 0.5
			local var_4_49 = 2.45666666666667
			...
			if var_4_54 < arg_1_1.time_ and arg_1_1.time_ <= var_4_54 + arg_4_0 then
				...
				local var_4_58 = arg_1_1:GetWordFromCfg(62101001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101001", "story_v_chess_62101.awb") ~= 0 then
					local var_4_63 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101001", "story_v_chess_62101.awb") / 1000
					...
					if var_4_58.prefab_name ~= "" and arg_1_1.actors_[var_4_58.prefab_name] ~= nil then
						local var_4_64 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_58.prefab_name].transform, "story_v_chess_62101", "62101001", "story_v_chess_62101.awb")

						arg_1_1:RecordAudio("62101001", var_4_64)
						arg_1_1:RecordAudio("62101001", var_4_64)
					else
	...
	Play62101002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_2 < arg_9_1.time_ and arg_9_1.time_ <= var_12_2 + arg_12_0 then
				...
				local var_12_5 = arg_9_1:GetWordFromCfg(62101002)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101002", "story_v_chess_62101.awb") ~= 0 then
					local var_12_10 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101002", "story_v_chess_62101.awb") / 1000
					...
					if var_12_5.prefab_name ~= "" and arg_9_1.actors_[var_12_5.prefab_name] ~= nil then
						local var_12_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_5.prefab_name].transform, "story_v_chess_62101", "62101002", "story_v_chess_62101.awb")

						arg_9_1:RecordAudio("62101002", var_12_11)
						arg_9_1:RecordAudio("62101002", var_12_11)
					else
	...
	Play62101003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_6 < arg_13_1.time_ and arg_13_1.time_ <= var_16_6 + arg_16_0 then
				...
				local var_16_8 = arg_13_1:GetWordFromCfg(62101003)
	...
	Play62101004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_6 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_9 = arg_17_1:GetWordFromCfg(62101004)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101004", "story_v_chess_62101.awb") ~= 0 then
					local var_20_14 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101004", "story_v_chess_62101.awb") / 1000
					...
					if var_20_9.prefab_name ~= "" and arg_17_1.actors_[var_20_9.prefab_name] ~= nil then
						local var_20_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_9.prefab_name].transform, "story_v_chess_62101", "62101004", "story_v_chess_62101.awb")

						arg_17_1:RecordAudio("62101004", var_20_15)
						arg_17_1:RecordAudio("62101004", var_20_15)
					else
	...
	Play62101005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_6 < arg_21_1.time_ and arg_21_1.time_ <= var_24_6 + arg_24_0 then
				...
				local var_24_9 = arg_21_1:GetWordFromCfg(62101005)
	...
	Play62101006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_6 < arg_25_1.time_ and arg_25_1.time_ <= var_28_6 + arg_28_0 then
				...
				local var_28_9 = arg_25_1:GetWordFromCfg(62101006)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101006", "story_v_chess_62101.awb") ~= 0 then
					local var_28_14 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101006", "story_v_chess_62101.awb") / 1000
					...
					if var_28_9.prefab_name ~= "" and arg_25_1.actors_[var_28_9.prefab_name] ~= nil then
						local var_28_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_9.prefab_name].transform, "story_v_chess_62101", "62101006", "story_v_chess_62101.awb")

						arg_25_1:RecordAudio("62101006", var_28_15)
						arg_25_1:RecordAudio("62101006", var_28_15)
					else
	...
	Play62101007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_6 < arg_29_1.time_ and arg_29_1.time_ <= var_32_6 + arg_32_0 then
				...
				local var_32_9 = arg_29_1:GetWordFromCfg(62101007)
	...
	Play62101008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_5 < arg_33_1.time_ and arg_33_1.time_ <= var_36_5 + arg_36_0 then
				...
				local var_36_8 = arg_33_1:GetWordFromCfg(62101008)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101008", "story_v_chess_62101.awb") ~= 0 then
					local var_36_13 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101008", "story_v_chess_62101.awb") / 1000
					...
					if var_36_8.prefab_name ~= "" and arg_33_1.actors_[var_36_8.prefab_name] ~= nil then
						local var_36_14 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_8.prefab_name].transform, "story_v_chess_62101", "62101008", "story_v_chess_62101.awb")

						arg_33_1:RecordAudio("62101008", var_36_14)
						arg_33_1:RecordAudio("62101008", var_36_14)
					else
	...
	Play62101009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_2 < arg_37_1.time_ and arg_37_1.time_ <= var_40_2 + arg_40_0 then
				...
				local var_40_4 = arg_37_1:FormatText(StoryNameCfg[67].name)
				...
				local var_40_5 = arg_37_1:GetWordFromCfg(62101009)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101009", "story_v_chess_62101.awb") ~= 0 then
					local var_40_10 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101009", "story_v_chess_62101.awb") / 1000
					...
					if var_40_5.prefab_name ~= "" and arg_37_1.actors_[var_40_5.prefab_name] ~= nil then
						local var_40_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_5.prefab_name].transform, "story_v_chess_62101", "62101009", "story_v_chess_62101.awb")

						arg_37_1:RecordAudio("62101009", var_40_11)
						arg_37_1:RecordAudio("62101009", var_40_11)
					else
