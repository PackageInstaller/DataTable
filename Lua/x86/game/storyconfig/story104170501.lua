		...
		function arg_186_1.onSingleLineUpdate_(arg_189_0)
			...
			if var_189_1 < arg_186_1.time_ and arg_186_1.time_ <= var_189_1 + arg_189_0 then
				...
				if not var_189_2 then
					var_189_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_heibaishan"), var_189_4)
					var_189_2.name = "089"
				...
				local var_189_5 = manager.ui.mainCameraCom_
				local var_189_6 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_189_5.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_189_7 = var_189_2.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_189_8 = 15
				local var_189_9 = 2 * var_189_8 * Mathf.Tan(var_189_5.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_189_5.aspect
				local var_189_10 = 1
				local var_189_11 = 1.7777777777777777

				if var_189_11 < var_189_5.aspect then
					var_189_10 = var_189_9 / (2 * var_189_8 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_189_11)
				end

				for iter_189_0, iter_189_1 in ipairs(var_189_7) do
					local var_189_12 = iter_189_1.transform.localScale

					iter_189_1.transform.localScale = Vector3.New(var_189_12.x / var_189_6 * var_189_10, var_189_12.y / var_189_6, var_189_12.z)
				end
			end
			...
			local var_189_15 = 0.0333333333333333
			local var_189_16 = 1
			...
			if var_189_15 < arg_186_1.time_ and arg_186_1.time_ <= var_189_15 + arg_189_0 then
				...
				arg_186_1:AudioAction(var_189_17, var_189_18, "se_story_134_01", "se_story_134_01_flash", "")
			end
			...
			local var_189_19 = 1.6
			local var_189_20 = 1.375
			...
			if var_189_19 < arg_186_1.time_ and arg_186_1.time_ <= var_189_19 + arg_189_0 then
				...
				local var_189_22 = arg_186_1:GetWordFromCfg(417051045)
				local var_189_23 = arg_186_1:FormatText(var_189_22.content)

				arg_186_1.text_.text = var_189_23

				LuaForUtil.ClearLinePrefixSymbol(arg_186_1.text_)

				local var_189_24 = 55
				local var_189_25 = utf8.len(var_189_23)
				local var_189_26 = var_189_24 <= 0 and var_189_20 or var_189_20 * (var_189_25 / var_189_24)

				if var_189_26 > 0 and var_189_20 < var_189_26 then
					arg_186_1.talkMaxDuration = var_189_26
					var_189_19 = var_189_19 + 0.3

					if var_189_26 + var_189_19 > arg_186_1.duration_ then
						arg_186_1.duration_ = var_189_26 + var_189_19
					end
				end
			...
			local var_189_27 = var_189_19 + 0.3
			local var_189_28 = math.max(var_189_20, arg_186_1.talkMaxDuration)

			if var_189_27 <= arg_186_1.time_ and arg_186_1.time_ < var_189_27 + var_189_28 then
				arg_186_1.typewritter.percent = (arg_186_1.time_ - var_189_27) / var_189_28

				arg_186_1.typewritter:SetDirty()
			end

			if arg_186_1.time_ >= var_189_27 + var_189_28 and arg_186_1.time_ < var_189_27 + var_189_28 + arg_189_0 then
