		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_1 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				if not var_32_2 then
					var_32_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_slash_01"), var_32_4)
					var_32_2.name = "2333"
					arg_29_1.var_.effect2333 = var_32_2
				else
					var_32_2.transform:SetParent(var_32_4)
				end
			...
			local var_32_7 = 0.533333333333333

			if var_32_6 <= arg_29_1.time_ and arg_29_1.time_ < var_32_6 + var_32_7 then
				local var_32_8 = (arg_29_1.time_ - var_32_6) / 0.066
				local var_32_9, var_32_10 = math.modf(var_32_8)

				var_32_5.localPosition = Vector3.New(var_32_10 * 0.13, var_32_10 * 0.13, var_32_10 * 0.13) + arg_29_1.var_.shakeOldPos
			end
			...
			if var_32_11 < arg_29_1.time_ and arg_29_1.time_ <= var_32_11 + arg_32_0 then
				local var_32_13 = "play"
				local var_32_14 = "effect"

				arg_29_1:AudioAction(var_32_13, var_32_14, "se_story_activity_1_4_3", "se_story_activity_1_4_3_sword", "")
			end
			...
			if var_32_15 < arg_29_1.time_ and arg_29_1.time_ <= var_32_15 + arg_32_0 then
				...
				local var_32_18 = arg_29_1:GetWordFromCfg(415031007)
			...
			local var_32_23 = var_32_15 + 0.3
			local var_32_24 = math.max(var_32_16, arg_29_1.talkMaxDuration)
			...
			if var_86_41 <= arg_83_1.time_ and arg_83_1.time_ < var_86_41 + var_86_42 and not isNil(var_86_40) then
				...
				if arg_83_1.var_.actorSpriteComps1061 then
					for iter_86_5, iter_86_6 in pairs(arg_83_1.var_.actorSpriteComps1061:ToTable()) do
						if iter_86_6 then
							if arg_83_1.isInRecall_ then
								local var_86_44 = Mathf.Lerp(iter_86_6.color.r, arg_83_1.hightColor1.r, var_86_43)
								local var_86_45 = Mathf.Lerp(iter_86_6.color.g, arg_83_1.hightColor1.g, var_86_43)
								local var_86_46 = Mathf.Lerp(iter_86_6.color.b, arg_83_1.hightColor1.b, var_86_43)
