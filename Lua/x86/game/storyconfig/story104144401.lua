	...
	Play414441001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_22 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				...
				local var_4_25 = arg_1_1:FormatText(StoryNameCfg[562].name)
				...
				local var_4_26 = arg_1_1:GetWordFromCfg(414441001)
	...
	Play414441003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_0 + arg_14_0 then
				...
				local var_14_3 = arg_11_1:GetWordFromCfg(414441003)
	...
	Play414441004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_0 + arg_18_0 then
				...
				local var_18_3 = arg_15_1:GetWordFromCfg(414441004)
