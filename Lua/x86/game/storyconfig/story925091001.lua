return {
	Play925091001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_2 + arg_4_0 then
				...
				local var_4_5 = arg_1_1.bgs_.I06f
			...
			if var_4_61 < arg_1_1.time_ and arg_1_1.time_ <= var_4_61 + arg_4_0 then
				...
				local var_4_65 = arg_1_1:GetWordFromCfg(925091001)
	...
	Play925091002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_8 < arg_9_1.time_ and arg_9_1.time_ <= var_12_8 + arg_12_0 then
				...
				local var_12_11 = arg_9_1:GetWordFromCfg(925091002)
	...
	Play925091003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_8 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:FormatText(StoryNameCfg[381].name)
				...
				local var_16_11 = arg_13_1:GetWordFromCfg(925091003)
	...
	Play925091004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_8 < arg_17_1.time_ and arg_17_1.time_ <= var_20_8 + arg_20_0 then
				...
				local var_20_11 = arg_17_1:GetWordFromCfg(925091004)
	...
	Play925091005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:GetWordFromCfg(925091005)
	...
	Play925091006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_15 < arg_25_1.time_ and arg_25_1.time_ <= var_28_15 + arg_28_0 then
				...
				local var_28_18 = arg_25_1:GetWordFromCfg(925091006)
	...
	Play925091007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_8 < arg_29_1.time_ and arg_29_1.time_ <= var_32_8 + arg_32_0 then
				...
				local var_32_11 = arg_29_1:GetWordFromCfg(925091007)
	...
	Play925091008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			local var_36_0 = arg_33_1.actors_["1075"]
			local var_36_1 = 0

			if var_36_1 < arg_33_1.time_ and arg_33_1.time_ <= var_36_1 + arg_36_0 and not isNil(var_36_0) and arg_33_1.var_.actorSpriteComps1075 == nil then
				arg_33_1.var_.actorSpriteComps1075 = var_36_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_33_1.time_ >= var_36_1 + var_36_2 and arg_33_1.time_ < var_36_1 + var_36_2 + arg_36_0 and not isNil(var_36_0) and arg_33_1.var_.actorSpriteComps1075 then
			...
			if var_36_8 < arg_33_1.time_ and arg_33_1.time_ <= var_36_8 + arg_36_0 then
				...
				local var_36_10 = arg_33_1:FormatText(StoryNameCfg[381].name)
				...
				local var_36_11 = arg_33_1:GetWordFromCfg(925091008)
	...
	Play925091009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			local var_40_0 = arg_37_1.actors_["1075"].transform
			local var_40_1 = 0

			if var_40_1 < arg_37_1.time_ and arg_37_1.time_ <= var_40_1 + arg_40_0 then
				arg_37_1.var_.moveOldPos1075 = var_40_0.localPosition
			...
			if var_40_1 <= arg_37_1.time_ and arg_37_1.time_ < var_40_1 + var_40_4 then
				...
				local var_40_6 = Vector3.New(-43, -310.5, -413.5)

				var_40_0.localPosition = Vector3.Lerp(arg_37_1.var_.moveOldPos1075, var_40_6, var_40_5)
			end

			if arg_37_1.time_ >= var_40_1 + var_40_4 and arg_37_1.time_ < var_40_1 + var_40_4 + arg_40_0 then
				var_40_0.localPosition = Vector3.New(-43, -310.5, -413.5)
			end

			local var_40_7 = 0
			local var_40_8 = 0.625
			...
			if var_40_7 < arg_37_1.time_ and arg_37_1.time_ <= var_40_7 + arg_40_0 then
				...
				local var_40_9 = arg_37_1:FormatText(StoryNameCfg[381].name)
				...
				local var_40_10 = arg_37_1:GetWordFromCfg(925091009)
	...
	Play925091010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			local var_44_0 = arg_41_1.actors_["1075"].transform
			local var_44_1 = 0

			if var_44_1 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				arg_41_1.var_.moveOldPos1075 = var_44_0.localPosition
			...
			if var_44_1 <= arg_41_1.time_ and arg_41_1.time_ < var_44_1 + var_44_4 then
				...
				local var_44_6 = Vector3.New(-43, -310.5, -413.5)

				var_44_0.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1075, var_44_6, var_44_5)
			end

			if arg_41_1.time_ >= var_44_1 + var_44_4 and arg_41_1.time_ < var_44_1 + var_44_4 + arg_44_0 then
				var_44_0.localPosition = Vector3.New(-43, -310.5, -413.5)
			end
			...
			if var_44_7 < arg_41_1.time_ and arg_41_1.time_ <= var_44_7 + arg_44_0 then
				...
				local var_44_9 = arg_41_1:FormatText(StoryNameCfg[381].name)
				...
				local var_44_10 = arg_41_1:GetWordFromCfg(925091010)
	...
	Play925091011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			local var_48_0 = arg_45_1.actors_["1075"]
			local var_48_1 = 0

			if var_48_1 < arg_45_1.time_ and arg_45_1.time_ <= var_48_1 + arg_48_0 and not isNil(var_48_0) and arg_45_1.var_.actorSpriteComps1075 == nil then
				arg_45_1.var_.actorSpriteComps1075 = var_48_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_45_1.time_ >= var_48_1 + var_48_2 and arg_45_1.time_ < var_48_1 + var_48_2 + arg_48_0 and not isNil(var_48_0) and arg_45_1.var_.actorSpriteComps1075 then
			...
			if var_48_8 < arg_45_1.time_ and arg_45_1.time_ <= var_48_8 + arg_48_0 then
				...
				local var_48_11 = arg_45_1:GetWordFromCfg(925091011)
	...
	Play925091012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			local var_52_0 = arg_49_1.actors_["1075"]
			local var_52_1 = 0

			if var_52_1 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 and not isNil(var_52_0) and arg_49_1.var_.actorSpriteComps1075 == nil then
				arg_49_1.var_.actorSpriteComps1075 = var_52_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_49_1.time_ >= var_52_1 + var_52_2 and arg_49_1.time_ < var_52_1 + var_52_2 + arg_52_0 and not isNil(var_52_0) and arg_49_1.var_.actorSpriteComps1075 then
			...
			local var_52_8 = arg_49_1.actors_["1075"].transform
			local var_52_9 = 0

			if var_52_9 < arg_49_1.time_ and arg_49_1.time_ <= var_52_9 + arg_52_0 then
				arg_49_1.var_.moveOldPos1075 = var_52_8.localPosition
			...
			if var_52_9 <= arg_49_1.time_ and arg_49_1.time_ < var_52_9 + var_52_12 then
				...
				local var_52_14 = Vector3.New(-43, -310.5, -413.5)

				var_52_8.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos1075, var_52_14, var_52_13)
			end

			if arg_49_1.time_ >= var_52_9 + var_52_12 and arg_49_1.time_ < var_52_9 + var_52_12 + arg_52_0 then
				var_52_8.localPosition = Vector3.New(-43, -310.5, -413.5)
			end
			...
			if var_52_15 < arg_49_1.time_ and arg_49_1.time_ <= var_52_15 + arg_52_0 then
				...
				local var_52_18 = arg_49_1:GetWordFromCfg(925091012)
	...
	Play925091013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			local var_56_0 = arg_53_1.actors_["1075"]
			local var_56_1 = 0

			if var_56_1 < arg_53_1.time_ and arg_53_1.time_ <= var_56_1 + arg_56_0 and not isNil(var_56_0) and arg_53_1.var_.actorSpriteComps1075 == nil then
				arg_53_1.var_.actorSpriteComps1075 = var_56_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_53_1.time_ >= var_56_1 + var_56_2 and arg_53_1.time_ < var_56_1 + var_56_2 + arg_56_0 and not isNil(var_56_0) and arg_53_1.var_.actorSpriteComps1075 then
			...
			if var_56_8 < arg_53_1.time_ and arg_53_1.time_ <= var_56_8 + arg_56_0 then
				...
				local var_56_11 = arg_53_1:GetWordFromCfg(925091013)
	...
	Play925091014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			local var_60_0 = arg_57_1.actors_["1075"]
			local var_60_1 = 0

			if var_60_1 < arg_57_1.time_ and arg_57_1.time_ <= var_60_1 + arg_60_0 and not isNil(var_60_0) and arg_57_1.var_.actorSpriteComps1075 == nil then
				arg_57_1.var_.actorSpriteComps1075 = var_60_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_57_1.time_ >= var_60_1 + var_60_2 and arg_57_1.time_ < var_60_1 + var_60_2 + arg_60_0 and not isNil(var_60_0) and arg_57_1.var_.actorSpriteComps1075 then
			...
			if var_60_8 < arg_57_1.time_ and arg_57_1.time_ <= var_60_8 + arg_60_0 then
				...
				local var_60_10 = arg_57_1:FormatText(StoryNameCfg[381].name)
				...
				local var_60_11 = arg_57_1:GetWordFromCfg(925091014)
	...
	Play925091015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_8 < arg_61_1.time_ and arg_61_1.time_ <= var_64_8 + arg_64_0 then
				...
				local var_64_11 = arg_61_1:GetWordFromCfg(925091015)
