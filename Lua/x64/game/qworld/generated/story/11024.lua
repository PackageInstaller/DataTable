...
function var_0_0.BlackFadeDialogueNode_1(arg_5_0)
	...
	arg_5_0:OnBlackFade(true, 11024001, 3, 0.5, 0.5, function()
...
function var_0_0.DialogueNode_2(arg_11_0)
	arg_11_0:PlayActorAnimationAction(9073, "proud", 0.05, 2.333333, function()
		return
	end)
	arg_11_0:PlayActorEmoteAction(9073, "happy01", 0, 1, function()
		return
	end, true, false)
	arg_11_0:ShowTalkView()
	arg_11_0:SetTalkContent(11024002, "", 9073)
...
function var_0_0.DialogueNode_3(arg_17_0)
	arg_17_0:PlayActorAnimationAction(9072, "conversation_1", 0.05, 3, function()
		return
	end)
	arg_17_0:ShowTalkView()
	arg_17_0:SetTalkContent(11024003, "", 9072)
...
function var_0_0.DialogueNode_4(arg_22_0)
	...
	arg_22_0:SetTalkContent(11024004, "", 9073)
...
function var_0_0.BlackFadeDialogueNode_5(arg_27_0)
	...
	arg_27_0:OnBlackFade(true, 0, 0.2, 0.2, 0.2, function()
		arg_27_0:DestroyCharAction(9072)
