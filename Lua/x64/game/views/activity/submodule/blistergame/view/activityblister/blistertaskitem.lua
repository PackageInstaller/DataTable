local var_0_0 = class("BlisterTaskItem", ReduxView)
...
function var_0_0.InitUI(arg_3_0)
	...
	arg_3_0.stausController_ = arg_3_0.allBtnController_:GetController("all")
end
...
function var_0_0.InitRewardItem(arg_4_0)
	...
	for iter_4_0 = 1, 3 do
		arg_4_0.rewardItemList_[iter_4_0] = CommonItemView.New(arg_4_0["awardItem" .. iter_4_0 .. "Obj_"])
	end
end
...
function var_0_0.UpdateView(arg_8_0)
	...
	if arg_8_0.taskStatus_.progress >= arg_8_0.taskCfg_.need then
		var_8_0 = arg_8_0.taskStatus_.complete_flag < 1 and 1 or 2
	end

	arg_8_0.stausController_:SetSelectedIndex(var_8_0)

	arg_8_0.titleText_.text = arg_8_0.taskCfg_.desc

	local var_8_1 = math.min(arg_8_0.taskStatus_.progress, arg_8_0.taskCfg_.need)

	arg_8_0.progressBar_.value = var_8_1 / arg_8_0.taskCfg_.need
	arg_8_0.progressText_.text = string.format("%s/%s", var_8_1, arg_8_0.taskCfg_.need)
