local var_0_0 = class("BlisterTaskView", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	arg_4_0.uiList_ = LuaList.New(handler(arg_4_0, arg_4_0.indexItem), arg_4_0.listGo_, BlisterTaskItem)
	arg_4_0.btnController_ = arg_4_0.controller_:GetController("oneclick")
...
function var_0_0.OnEnter(arg_10_0)
	...
	arg_10_0.taskActivityIdList_ = ActivityCfg[arg_10_0.params_.taskActivityID].sub_activity_list
...
function var_0_0.UpdateList(arg_11_0)
	...
	arg_11_0.taskList_ = BlisterGameData:GetTaskList()

	arg_11_0.uiList_:StartScroll(#arg_11_0.taskList_)

	arg_11_0.allRewards_ = BlisterGameData:GetRewardTaskList()

	arg_11_0.btnController_:SetSelectedState(tostring(#arg_11_0.allRewards_ > 0))
end
