...
function var_0_0.RefreshReward(arg_11_0)
	...
	for iter_11_0, iter_11_1 in ipairs(var_11_0) do
		...
		if var_11_5 == ItemConst.ITEM_TYPE.HERO_SKIN or ActivitySkinDrawTools.GetIsSkinGift(var_11_3) then
	...
	local var_11_8 = ActivitySkinDrawTools.GetEnterDrawEffect()

	if var_11_8 then
		manager.audio:PlayEffect("ui_system_search", var_11_8[arg_11_0.maxRare_], "")
	end
end
...
function var_0_0.OnExit(arg_16_0)
	if arg_16_0.animator_ then
		arg_16_0.animator_:Rebind()
		AnimatorTools.Stop(arg_16_0.animator_)
	end
end
