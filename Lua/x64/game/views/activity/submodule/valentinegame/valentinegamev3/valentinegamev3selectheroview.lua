local var_0_0 = class("ValentineGameV3SelectHeroView", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	arg_4_0.heroList_ = LuaList.New(handler(arg_4_0, arg_4_0.IndexItem), arg_4_0.listGo_, ValentineGameV3SelectHeroItem)
end

function var_0_0.IndexItem(arg_5_0, arg_5_1, arg_5_2)
	arg_5_2:SetData(arg_5_0.activityID_, arg_5_0.subActivityID_[arg_5_1])
end

function var_0_0.OnEnter(arg_6_0)
	arg_6_0.selectHeroText_.text = GetTips("ACTIVITY_VALENTINE_V3_SELECT_HERO")
