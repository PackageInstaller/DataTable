...
function var_0_0.SetData(arg_7_0, arg_7_1, arg_7_2)
	...
	if RogueCardGameTools.IsUnlockJokerCard(arg_7_0.id) then
		local var_7_0 = RogueCardItemCfg[arg_7_1]

		arg_7_0.qualityCon_:SetSelectedIndex(var_7_0.rare - 1)

		arg_7_0.icon_.sprite = pureGetSpriteWithoutAtlas("TextureConfig/Activity_JokerCard/item/" .. var_7_0.icon)
