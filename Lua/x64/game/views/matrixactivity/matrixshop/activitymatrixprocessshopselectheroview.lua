local var_0_0 = class("ActivityMatrixProcessShopSelectHeroView", MatrixProcessSelectHeroView)
		...
		if arg_2_0:GetHeroEquipMaxCount() <= #var_2_5 then
			JumpTools.OpenPageByJump("activityMatrixProcessEquipReplace", {
				...
				callback = function(arg_3_0)
					ActivityMatrixAction.BuyShopItem(arg_2_0.matrix_activity_id, arg_2_0.shopIndex, var_2_4:GetStandardId(), arg_3_0)
				end
			})
		else
			ActivityMatrixAction.BuyShopItem(arg_2_0.matrix_activity_id, arg_2_0.shopIndex, var_2_4:GetStandardId(), 0)
		end
	elseif MatrixConst.ITEM_TYPE.WEAPON_SERVANT == var_2_3 then
		...
		if var_2_7 ~= 0 then
			JumpTools.OpenPageByJump("activityMatrixProcessWeaponReplace", {
				...
				weaponId = var_2_0,
				callback = function()
					ActivityMatrixAction.BuyShopItem(arg_2_0.matrix_activity_id, arg_2_0.shopIndex, var_2_6:GetStandardId(), var_2_7)
				end
			})
		else
			ActivityMatrixAction.BuyShopItem(arg_2_0.matrix_activity_id, arg_2_0.shopIndex, var_2_6:GetStandardId(), 0)
		end
	else
		local var_2_8 = arg_2_0:GetHeroData(var_2_1)

		ActivityMatrixAction.BuyShopItem(arg_2_0.matrix_activity_id, arg_2_0.shopIndex, var_2_8:GetStandardId(), 0)
	end
end
...
function var_0_0.GetHeroEquipMaxCount(arg_6_0)
	return ActivityMatrixData:GetHeroEquipMaxCount(arg_6_0.matrix_activity_id)
end

function var_0_0.GetMatrixHeroTeam(arg_7_0)
	return ActivityMatrixData:GetMatrixHeroTeam(arg_7_0.matrix_activity_id)
end
