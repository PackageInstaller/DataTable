local var_0_0 = class("GuildActivitySPElitePopView", ReduxView)
...
function var_0_0.UpdateView(arg_21_0)
	...
	arg_21_0.nodeRewardImg.sprite = ItemTools.getItemSprite(GuildActivitySpTools.GetCurCurrencyID(var_21_1, 2))
	...
	local var_21_5 = GetTips("ACTIVITY_CLUB_SP_DISPATCH_INFO_TIP")

	arg_21_0.informationLabel_.text = string.format(var_21_5, var_21_0.dispatch_num, 10)
	...
	if GuildActivitySPData:IsMyOccupiedNode(arg_21_0.params_.nodeId) then
		if GuildActivitySPData:IsDispatched(arg_21_0.params_.nodeId) then
			...
			local var_21_6 = GuildActivitySPData:GetSelfNodeData(arg_21_0.params_.nodeId)
		...
		arg_21_0.isBeginController_:SetSelectedState("false")
	else
		local var_21_7 = GuildActivitySPData:GetSelfNodeData(arg_21_0.params_.nodeId)

		if GuildActivitySPData:IsNodeCanReach(arg_21_0.params_.nodeId) then
		...
		if var_21_7 then
			arg_21_0.isBeginController_:SetSelectedState("true")

			local var_21_8 = math.floor(100 - var_21_7.elite_health_rate)

			arg_21_0.attackingProgressLabel_.text = tostring(var_21_8) .. "%"
			arg_21_0.progressImage_.fillAmount = var_21_8 / 100
			arg_21_0.slider_.value = var_21_8 / 100
		else
			arg_21_0.isBeginController_:SetSelectedState("false")

			arg_21_0.attackingProgressLabel_.text = "0%"
			arg_21_0.progressImage_.fillAmount = 0
			arg_21_0.slider_.value = 0
		end
	end
end
