local var_0_0 = class("AshILLWeaponPage", ReduxView)

function var_0_0.Ctor(arg_1_0, arg_1_1)
	arg_1_0.gameObject_ = arg_1_1
	arg_1_0.transform_ = arg_1_1.transform
	arg_1_0.canvasGroup = arg_1_1:GetComponent(typeof(CanvasGroup))
	arg_1_0.weaponConatiner = arg_1_0.transform_:Find("Viewport/WeaponList")
...
function var_0_0.Init(arg_2_0)
	...
	local var_2_0 = AshSystemData:GetWeaponList()

	for iter_2_0, iter_2_1 in ipairs(var_2_0) do
		table.insert(arg_2_0.modules, AshILLWeaponModule.New(arg_2_0.weaponConatiner, nil, "WEAPON"))
	end
end
...
function var_0_0.EnterPanel(arg_3_0, arg_3_1)
	...
	local var_3_0 = AshSystemData:GetWeaponList()
