local var_0_0 = class("CoreVerificationEnterStageViewMode3", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	for iter_4_0 = 1, 3 do
		local var_4_0 = CoreVerificationChallengeTools.GetModeStageActivityId(ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE3)
		local var_4_1 = CoreVerificationClMode3Cfg.get_id_list_by_activity_id[var_4_0]
		local var_4_2 = CoreVerificationClMode3Cfg[var_4_1[iter_4_0]]

		arg_4_0.commonItems[iter_4_0] = CoreVerificationCommonStageItemMode3.New(arg_4_0["selectionGo_" .. iter_4_0], var_4_2, iter_4_0)
	end
...
function var_0_0.UpdateCoreVerification(arg_16_0)
	arg_16_0.common_stage = CoreVerificationChallengeMode3Data:GetCommonStage()
	arg_16_0.challenge_stage = CoreVerificationChallengeMode3Data:GetChallengeStage()
	arg_16_0.isTips = CoreVerificationChallengeMode3Data:GetSeasonIsTips()
...
function var_0_0.RefreshChallengeStage(arg_17_0)
	...
	if CoreVerificationChallengeMode3Data:GetMaxPoint() and var_17_0.recently_challenge_value > 0 then
		...
		arg_17_0.challengeScoreText_.text = var_17_0.recently_challenge_value
	else
		arg_17_0.stateChallengeController_:SetSelectedIndex(0)
	end

	local var_17_1 = CoreVerificationChallengeMode3Data:GetChallengeStageCfg()
...
function var_0_0.RefreshCommonStage(arg_18_0)
	local var_18_0 = CoreVerificationChallengeMode3Data:GetActivityId()
	local var_18_1 = ActivityCfg[var_18_0].sub_activity_list[2]
	local var_18_2 = CoreVerificationClMode3Cfg.get_id_list_by_activity_id[var_18_1]
...
function var_0_0.RefreshTitle(arg_20_0)
	local var_20_0 = CoreVerificationChallengeTools.GetModeStageActivityId(ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE3)
	local var_20_1 = CoreVerificationClMode3Cfg.get_id_list_by_activity_id[var_20_0]
	local var_20_2 = CoreVerificationClMode3Cfg[var_20_1[3]].stage_com_affix[1]
	...
	local var_20_4 = ActivityData:GetActivityData(CoreVerificationChallengeTools.GetActivityId())

	arg_20_0.refreshTime_.text = manager.time:GetLostTimeStrWith2Unit(var_20_4.stopTime)

	local var_20_5 = CoreVerificationChallengeMode3Data:GetChallengeStageCfg()

	arg_20_0.bossIcon_.sprite = pureGetSpriteWithoutAtlas(string.format("%s%s", "TextureConfig/Core_verification_new/BossAttribute/", var_20_5.stage_img))
	arg_20_0.allscoreText_1.text = CoreVerificationChallengeMode3Data:GetMaxPoint()
	arg_20_0.allscoreText_2.text = CoreVerificationChallengeMode3Data:GetCurPoint()

	local var_20_6 = CoreVerificationChallengeTools.GetIllustrated()

	if var_20_6 and #var_20_6 > 0 then
		local var_20_7 = CoreVerificationChallengeTools.GetMaxIllustrated()
		...
		if var_20_7 == 0 then
			...
			arg_20_0.illustratedIcon_.sprite = pureGetSpriteWithoutAtlas(string.format("%s%s", "TextureConfig/Core_verification_new/Emblem/", var_20_7))
		end
	else
		arg_20_0.lockController_:SetSelectedIndex(1)
	end
