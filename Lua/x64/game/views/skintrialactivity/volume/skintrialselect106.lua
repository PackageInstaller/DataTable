local var_0_0 = class("SkinTrialSelect106", SkinTrialActivitySelectView)
...
function var_0_0.OnEnter(arg_3_0)
	if arg_3_0.params_.canPlayAnim == true and arg_3_0.animator_ ~= nil then
		...
		arg_3_0.animator_:Play("VolumeSkinTrialUI_106_02", -1, 0)
	else
		arg_3_0.animator_:Play("VolumeSkinTrialUI_106_01", -1, 0)
	end
