	...
	Play121021004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_42 < arg_17_1.time_ and arg_17_1.time_ <= var_20_42 + arg_20_0 then
				...
				local var_20_44 = arg_17_1:FormatText(StoryNameCfg[389].name)

				arg_17_1.leftNameTxt_.text = var_20_44
				...
				local var_20_45 = arg_17_1:GetWordFromCfg(121021004)
				local var_20_46 = arg_17_1:FormatText(var_20_45.content)

				arg_17_1.text_.text = var_20_46

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_47 = 16
				local var_20_48 = utf8.len(var_20_46)
				local var_20_49 = var_20_47 <= 0 and var_20_43 or var_20_43 * (var_20_48 / var_20_47)

				if var_20_49 > 0 and var_20_43 < var_20_49 then
					arg_17_1.talkMaxDuration = var_20_49

					if var_20_49 + var_20_42 > arg_17_1.duration_ then
						arg_17_1.duration_ = var_20_49 + var_20_42
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_121021", "121021004", "story_v_out_121021.awb") ~= 0 then
					local var_20_50 = manager.audio:GetVoiceLength("story_v_out_121021", "121021004", "story_v_out_121021.awb") / 1000

					if var_20_50 + var_20_42 > arg_17_1.duration_ then
						arg_17_1.duration_ = var_20_50 + var_20_42
					end

					if var_20_45.prefab_name ~= "" and arg_17_1.actors_[var_20_45.prefab_name] ~= nil then
						local var_20_51 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_45.prefab_name].transform, "story_v_out_121021", "121021004", "story_v_out_121021.awb")

						arg_17_1:RecordAudio("121021004", var_20_51)
						arg_17_1:RecordAudio("121021004", var_20_51)
					else
			...
			local var_20_52 = math.max(var_20_43, arg_17_1.talkMaxDuration)

			if var_20_42 <= arg_17_1.time_ and arg_17_1.time_ < var_20_42 + var_20_52 then
				arg_17_1.typewritter.percent = (arg_17_1.time_ - var_20_42) / var_20_52

				arg_17_1.typewritter:SetDirty()
			end

			if arg_17_1.time_ >= var_20_42 + var_20_52 and arg_17_1.time_ < var_20_42 + var_20_52 + arg_20_0 then
