	...
	Play60001001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_31 < arg_1_1.time_ and arg_1_1.time_ <= var_4_31 + arg_4_0 then
				...
				local var_4_32 = "1019ui_story"

				arg_1_1:ShowWeapon(arg_1_1.var_[var_4_32 .. "Animator"].transform, false)
			end
			...
			if var_4_31 <= arg_1_1.time_ and arg_1_1.time_ < var_4_31 + var_4_33 then
				...
				local var_4_35 = Vector3.New(-0.2, -1.08, -5.9)

				var_4_30.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1019ui_story, var_4_35, var_4_34)
			...
			local var_4_40 = arg_1_1.actors_["1019ui_story"]
			local var_4_41 = 1.7

			if var_4_41 < arg_1_1.time_ and arg_1_1.time_ <= var_4_41 + arg_4_0 and not isNil(var_4_40) and arg_1_1.var_.characterEffect1019ui_story == nil then
				arg_1_1.var_.characterEffect1019ui_story = var_4_40:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_4_41 <= arg_1_1.time_ and arg_1_1.time_ < var_4_41 + var_4_42 and not isNil(var_4_40) then
				...
				if arg_1_1.var_.characterEffect1019ui_story and not isNil(var_4_40) then
					arg_1_1.var_.characterEffect1019ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= var_4_41 + var_4_42 and arg_1_1.time_ < var_4_41 + var_4_42 + arg_4_0 and not isNil(var_4_40) and arg_1_1.var_.characterEffect1019ui_story then
				arg_1_1.var_.characterEffect1019ui_story.fillFlat = false
			end
			...
			if var_4_46 < arg_1_1.time_ and arg_1_1.time_ <= var_4_46 + arg_4_0 then
				...
				local var_4_48 = arg_1_1:FormatText(StoryNameCfg[13].name)
				...
				local var_4_49 = arg_1_1:GetWordFromCfg(60001001)
