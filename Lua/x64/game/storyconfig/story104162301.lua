	...
	Play416231015 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if var_66_26 < arg_63_1.time_ and arg_63_1.time_ <= var_66_26 + arg_66_0 then
				...
				local var_66_28
				local var_66_29 = var_66_25

				if not var_66_27 then
					var_66_27 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_dust_1"), var_66_29)
					var_66_27.name = "777"
					arg_63_1.var_.effect777777 = var_66_27
				else
					var_66_27.transform:SetParent(var_66_29)
				end

				var_66_27.transform.localPosition = Vector3.New(0, 0, 0)
				var_66_27.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_66_30 = manager.ui.mainCameraCom_
				local var_66_31 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_66_30.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_66_32 = var_66_27.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_66_33 = 15
				local var_66_34 = 2 * var_66_33 * Mathf.Tan(var_66_30.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_66_30.aspect
				local var_66_35 = 1
				local var_66_36 = 1.7777777777777777

				if var_66_36 < var_66_30.aspect then
					var_66_35 = var_66_34 / (2 * var_66_33 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_66_36)
				end

				for iter_66_3, iter_66_4 in ipairs(var_66_32) do
					local var_66_37 = iter_66_4.transform.localScale

					iter_66_4.transform.localScale = Vector3.New(var_66_37.x / var_66_31 * var_66_35, var_66_37.y / var_66_31, var_66_37.z)
				end
			end

			local var_66_38 = 0.366666666666667
			local var_66_39 = 1

			if var_66_38 < arg_63_1.time_ and arg_63_1.time_ <= var_66_38 + arg_66_0 then
				local var_66_40 = "play"
				local var_66_41 = "effect"

				arg_63_1:AudioAction(var_66_40, var_66_41, "se_story_123_01", "se_story_123_01_explosion", "")
			end
			...
			if var_66_42 < arg_63_1.time_ and arg_63_1.time_ <= var_66_42 + arg_66_0 then
				...
				local var_66_44 = LeanTween.value(arg_63_1.dialog_, 0, 1, 0.3)

				var_66_44:setOnUpdate(LuaHelper.FloatAction(function(arg_67_0)
					arg_63_1.dialogCg_.alpha = arg_67_0
				end))
				var_66_44:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_63_1.dialog_)
					var_66_44:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_66_45 = arg_63_1:GetWordFromCfg(416231015)
			...
			local var_66_50 = var_66_42 + 0.3
			local var_66_51 = math.max(var_66_43, arg_63_1.talkMaxDuration)

			if var_66_50 <= arg_63_1.time_ and arg_63_1.time_ < var_66_50 + var_66_51 then
				arg_63_1.typewritter.percent = (arg_63_1.time_ - var_66_50) / var_66_51
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			...
			if var_100_23 < arg_97_1.time_ and arg_97_1.time_ <= var_100_23 + arg_100_0 then
				...
				if not var_100_24 then
					var_100_24 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"), var_100_26)
					var_100_24.name = "665"
				...
				local var_100_27 = manager.ui.mainCameraCom_
				local var_100_28 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_100_27.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_100_29 = var_100_24.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_100_30 = 15
				local var_100_31 = 2 * var_100_30 * Mathf.Tan(var_100_27.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_100_27.aspect
				local var_100_32 = 1
				local var_100_33 = 1.7777777777777777

				if var_100_33 < var_100_27.aspect then
					var_100_32 = var_100_31 / (2 * var_100_30 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_100_33)
				end

				for iter_100_6, iter_100_7 in ipairs(var_100_29) do
					local var_100_34 = iter_100_7.transform.localScale

					iter_100_7.transform.localScale = Vector3.New(var_100_34.x / var_100_28 * var_100_32, var_100_34.y / var_100_28, var_100_34.z)
				end
			end

			local var_100_35 = manager.ui.mainCamera.transform
			local var_100_36 = 0.766666666666667

			if var_100_36 < arg_97_1.time_ and arg_97_1.time_ <= var_100_36 + arg_100_0 then
				local var_100_37 = arg_97_1.var_.effect665

				if var_100_37 then
					Object.Destroy(var_100_37)
			...
			local var_100_40 = 0.05
			local var_100_41 = 1

			if var_100_40 < arg_97_1.time_ and arg_97_1.time_ <= var_100_40 + arg_100_0 then
				local var_100_42 = "play"
				local var_100_43 = "effect"

				arg_97_1:AudioAction(var_100_42, var_100_43, "se_story_135_01", "se_story_135_01_chushou01", "")
			end
			...
			local var_100_44 = 0.6
			local var_100_45 = 1.275
			...
			if var_100_44 < arg_97_1.time_ and arg_97_1.time_ <= var_100_44 + arg_100_0 then
				...
				var_100_46:setOnUpdate(LuaHelper.FloatAction(function(arg_101_0)
				...
				local var_100_47 = arg_97_1:GetWordFromCfg(416231023)
