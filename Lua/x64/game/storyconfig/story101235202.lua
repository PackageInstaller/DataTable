	...
	Play123522063 = function(arg_251_0, arg_251_1)
		...
		function arg_251_1.onSingleLineUpdate_(arg_254_0)
			...
			if var_254_71 < arg_251_1.time_ and arg_251_1.time_ <= var_254_71 + arg_254_0 then
				...
				local var_254_73
				local var_254_74 = var_254_70

				if not var_254_72 then
					var_254_72 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ripple"), var_254_74)
					var_254_72.name = "lushen1"
					arg_251_1.var_.effectlushen1 = var_254_72
				else
					var_254_72.transform:SetParent(var_254_74)
				end
			...
			if var_254_75 < arg_251_1.time_ and arg_251_1.time_ <= var_254_75 + arg_254_0 then
				local var_254_77 = "play"
				local var_254_78 = "effect"

				arg_251_1:AudioAction(var_254_77, var_254_78, "se_story_123_02", "se_story_123_02_deer", "")
			end
			...
			local var_254_79 = 2
			local var_254_80 = 0.275

			if var_254_79 < arg_251_1.time_ and arg_251_1.time_ <= var_254_79 + arg_254_0 then
				...
				local var_254_81 = LeanTween.value(arg_251_1.dialog_, 0, 1, 0.3)

				var_254_81:setOnUpdate(LuaHelper.FloatAction(function(arg_255_0)
					arg_251_1.dialogCg_.alpha = arg_255_0
				end))
				var_254_81:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_251_1.dialog_)
					var_254_81:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_254_82 = arg_251_1:GetWordFromCfg(123522063)
				local var_254_83 = arg_251_1:FormatText(var_254_82.content)

				arg_251_1.text_.text = var_254_83

				LuaForUtil.ClearLinePrefixSymbol(arg_251_1.text_)

				local var_254_84 = 11
				local var_254_85 = utf8.len(var_254_83)
				local var_254_86 = var_254_84 <= 0 and var_254_80 or var_254_80 * (var_254_85 / var_254_84)

				if var_254_86 > 0 and var_254_80 < var_254_86 then
					arg_251_1.talkMaxDuration = var_254_86
					var_254_79 = var_254_79 + 0.3

					if var_254_86 + var_254_79 > arg_251_1.duration_ then
						arg_251_1.duration_ = var_254_86 + var_254_79
					end
				end
			...
			local var_254_87 = var_254_79 + 0.3
			local var_254_88 = math.max(var_254_80, arg_251_1.talkMaxDuration)

			if var_254_87 <= arg_251_1.time_ and arg_251_1.time_ < var_254_87 + var_254_88 then
				arg_251_1.typewritter.percent = (arg_251_1.time_ - var_254_87) / var_254_88

				arg_251_1.typewritter:SetDirty()
			end

			if arg_251_1.time_ >= var_254_87 + var_254_88 and arg_251_1.time_ < var_254_87 + var_254_88 + arg_254_0 then
	...
	Play123522077 = function(arg_309_0, arg_309_1)
		...
		function arg_309_1.onSingleLineUpdate_(arg_312_0)
			...
			if var_312_10 < arg_309_1.time_ and arg_309_1.time_ <= var_312_10 + arg_312_0 then
				...
				local var_312_12
				local var_312_13 = var_312_9

				if not var_312_11 then
					var_312_11 = Object.Instantiate(Asset.Load("Effect/Scene/fx_scence_pingmu_niuqu"), var_312_13)
					var_312_11.name = "lushen2"
					arg_309_1.var_.effectlushen2 = var_312_11
				else
					var_312_11.transform:SetParent(var_312_13)
				end
			...
			local var_312_14 = manager.ui.mainCamera.transform
			local var_312_15 = 1.2

			if var_312_15 < arg_309_1.time_ and arg_309_1.time_ <= var_312_15 + arg_312_0 then
				local var_312_16 = arg_309_1.var_.effectlushen2

				if var_312_16 then
					Object.Destroy(var_312_16)

					arg_309_1.var_.effectlushen2 = nil
				end
			end

			local var_312_17 = 0.133333333333333
			local var_312_18 = 1

			if var_312_17 < arg_309_1.time_ and arg_309_1.time_ <= var_312_17 + arg_312_0 then
				local var_312_19 = "play"
				local var_312_20 = "effect"

				arg_309_1:AudioAction(var_312_19, var_312_20, "se_story_123_01", "se_story_123_01_animal", "")
			end

			local var_312_21 = 0
			local var_312_22 = 0.875
			...
			if var_312_21 < arg_309_1.time_ and arg_309_1.time_ <= var_312_21 + arg_312_0 then
				...
				local var_312_23 = arg_309_1:GetWordFromCfg(123522077)
				...
				local var_312_27 = var_312_25 <= 0 and var_312_22 or var_312_22 * (var_312_26 / var_312_25)

				if var_312_27 > 0 and var_312_22 < var_312_27 then
					arg_309_1.talkMaxDuration = var_312_27

					if var_312_27 + var_312_21 > arg_309_1.duration_ then
						arg_309_1.duration_ = var_312_27 + var_312_21
					end
				end
			...
			local var_312_28 = math.max(var_312_22, arg_309_1.talkMaxDuration)

			if var_312_21 <= arg_309_1.time_ and arg_309_1.time_ < var_312_21 + var_312_28 then
				arg_309_1.typewritter.percent = (arg_309_1.time_ - var_312_21) / var_312_28

				arg_309_1.typewritter:SetDirty()
			end

			if arg_309_1.time_ >= var_312_21 + var_312_28 and arg_309_1.time_ < var_312_21 + var_312_28 + arg_312_0 then
