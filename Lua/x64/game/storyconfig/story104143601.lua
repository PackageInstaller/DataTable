return {
	Play414361001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 414361001
		arg_1_1.duration_ = 7
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_24 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				local var_4_27 = arg_1_1:FormatText(StoryNameCfg[1017].name)
				...
				local var_4_28 = arg_1_1:GetWordFromCfg(414361001)
	...
	Play414361002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 414361002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_2 = arg_7_1:FormatText(StoryNameCfg[1018].name)
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(414361002)
	...
	Play414361003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 414361003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play414361004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_0 + arg_14_0 then
				...
				local var_14_2 = arg_11_1:GetWordFromCfg(414361003)
	...
	Play414361004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 414361004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play414361005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_0 + arg_18_0 then
				...
				local var_18_3 = arg_15_1:GetWordFromCfg(414361004)
	...
	Play414361005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 414361005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play414361006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_0 + arg_22_0 then
				...
				local var_22_2 = arg_19_1:FormatText(StoryNameCfg[943].name)
				...
				arg_19_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_officeladyb")
				...
				local var_22_3 = arg_19_1:GetWordFromCfg(414361005)
	...
	Play414361006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 414361006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play414361007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_0 + arg_26_0 then
				...
				local var_26_2 = arg_23_1:GetWordFromCfg(414361006)
	...
	Play414361007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 414361007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play414361008(arg_27_1)
			end
		end

		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			local var_30_0 = 0
			local var_30_1 = 1.425
			...
			if var_30_0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_0 + arg_30_0 then
				...
				local var_30_2 = arg_27_1:FormatText(StoryNameCfg[943].name)
				...
				local var_30_3 = arg_27_1:GetWordFromCfg(414361007)
	...
	Play414361008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 414361008
		...
		function arg_31_1.playNext_(arg_33_0)
			if arg_33_0 == 1 then
				arg_31_0:Play414361009(arg_31_1)
			end
		end
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_0 + arg_34_0 then
				...
				local var_34_2 = arg_31_1:FormatText(StoryNameCfg[943].name)
				...
				local var_34_3 = arg_31_1:GetWordFromCfg(414361008)
	...
	Play414361009 = function(arg_35_0, arg_35_1)
		arg_35_1.time_ = 0
		arg_35_1.frameCnt_ = 0
		arg_35_1.state_ = "playing"
		arg_35_1.curTalkId_ = 414361009
		...
		function arg_35_1.playNext_(arg_37_0)
			if arg_37_0 == 1 then
				arg_35_0:Play414361010(arg_35_1)
			end
		end
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_0 + arg_38_0 then
				...
				local var_38_2 = arg_35_1:GetWordFromCfg(414361009)
	...
	Play414361010 = function(arg_39_0, arg_39_1)
		arg_39_1.time_ = 0
		arg_39_1.frameCnt_ = 0
		arg_39_1.state_ = "playing"
		arg_39_1.curTalkId_ = 414361010
		arg_39_1.duration_ = 5.63
		...
		function arg_39_1.playNext_(arg_41_0)
			if arg_41_0 == 1 then
				arg_39_0:Play414361011(arg_39_1)
			end
		end
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			local var_42_0 = 0.633333333333333
			local var_42_1 = 0.2
			...
			if var_42_0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_0 + arg_42_0 then
				...
				local var_42_3 = arg_39_1:FormatText(StoryNameCfg[7].name)
				...
				local var_42_4 = arg_39_1:GetWordFromCfg(414361010)
			...
			local var_42_9 = var_42_0 + 0.3
			local var_42_10 = math.max(var_42_1, arg_39_1.talkMaxDuration)

			if var_42_9 <= arg_39_1.time_ and arg_39_1.time_ < var_42_9 + var_42_10 then
				arg_39_1.typewritter.percent = (arg_39_1.time_ - var_42_9) / var_42_10
	...
	Play414361011 = function(arg_45_0, arg_45_1)
		arg_45_1.time_ = 0
		arg_45_1.frameCnt_ = 0
		arg_45_1.state_ = "playing"
		arg_45_1.curTalkId_ = 414361011
		...
		function arg_45_1.playNext_(arg_47_0)
			if arg_47_0 == 1 then
				arg_45_0:Play414361012(arg_45_1)
			end
		end

		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			local var_48_0 = "104902ui_story"

			if arg_45_1.actors_[var_48_0] == nil then
				local var_48_1 = Asset.Load("Char/" .. "104902ui_story")

				if not isNil(var_48_1) then
					local var_48_2 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_45_1.stage_.transform)
			...
			local var_48_5 = arg_45_1.actors_["104902ui_story"].transform
			local var_48_6 = 0

			if var_48_6 < arg_45_1.time_ and arg_45_1.time_ <= var_48_6 + arg_48_0 then
				arg_45_1.var_.moveOldPos104902ui_story = var_48_5.localPosition
			end
			...
			if var_48_6 <= arg_45_1.time_ and arg_45_1.time_ < var_48_6 + var_48_7 then
				...
				local var_48_9 = Vector3.New(0, -1.2, -6)

				var_48_5.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos104902ui_story, var_48_9, var_48_8)
			...
			if arg_45_1.time_ >= var_48_6 + var_48_7 and arg_45_1.time_ < var_48_6 + var_48_7 + arg_48_0 then
				var_48_5.localPosition = Vector3.New(0, -1.2, -6)
			...
			local var_48_14 = arg_45_1.actors_["104902ui_story"]
			local var_48_15 = 0

			if var_48_15 < arg_45_1.time_ and arg_45_1.time_ <= var_48_15 + arg_48_0 and not isNil(var_48_14) and arg_45_1.var_.characterEffect104902ui_story == nil then
				arg_45_1.var_.characterEffect104902ui_story = var_48_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_48_15 <= arg_45_1.time_ and arg_45_1.time_ < var_48_15 + var_48_16 and not isNil(var_48_14) then
				...
				if arg_45_1.var_.characterEffect104902ui_story and not isNil(var_48_14) then
					arg_45_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_45_1.time_ >= var_48_15 + var_48_16 and arg_45_1.time_ < var_48_15 + var_48_16 + arg_48_0 and not isNil(var_48_14) and arg_45_1.var_.characterEffect104902ui_story then
				arg_45_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if var_48_18 < arg_45_1.time_ and arg_45_1.time_ <= var_48_18 + arg_48_0 then
				arg_45_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0102cva")
			end

			local var_48_19 = 0

			if var_48_19 < arg_45_1.time_ and arg_45_1.time_ <= var_48_19 + arg_48_0 then
				arg_45_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action1_1")
			end

			local var_48_20 = 0
			local var_48_21 = 0.25
			...
			if var_48_20 < arg_45_1.time_ and arg_45_1.time_ <= var_48_20 + arg_48_0 then
				...
				local var_48_22 = arg_45_1:FormatText(StoryNameCfg[562].name)
				...
				local var_48_23 = arg_45_1:GetWordFromCfg(414361011)
	...
	Play414361012 = function(arg_49_0, arg_49_1)
		arg_49_1.time_ = 0
		arg_49_1.frameCnt_ = 0
		arg_49_1.state_ = "playing"
		arg_49_1.curTalkId_ = 414361012
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			local var_52_0 = arg_49_1.actors_["104902ui_story"]
			local var_52_1 = 0

			if var_52_1 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 and not isNil(var_52_0) and arg_49_1.var_.characterEffect104902ui_story == nil then
				arg_49_1.var_.characterEffect104902ui_story = var_52_0:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_52_1 <= arg_49_1.time_ and arg_49_1.time_ < var_52_1 + var_52_2 and not isNil(var_52_0) then
				...
				if arg_49_1.var_.characterEffect104902ui_story and not isNil(var_52_0) then
					local var_52_4 = Mathf.Lerp(0, 0.5, var_52_3)

					arg_49_1.var_.characterEffect104902ui_story.fillFlat = true
					arg_49_1.var_.characterEffect104902ui_story.fillRatio = var_52_4
				end
			end

			if arg_49_1.time_ >= var_52_1 + var_52_2 and arg_49_1.time_ < var_52_1 + var_52_2 + arg_52_0 and not isNil(var_52_0) and arg_49_1.var_.characterEffect104902ui_story then
				local var_52_5 = 0.5

				arg_49_1.var_.characterEffect104902ui_story.fillFlat = true
				arg_49_1.var_.characterEffect104902ui_story.fillRatio = var_52_5
			end
			...
			if var_52_6 < arg_49_1.time_ and arg_49_1.time_ <= var_52_6 + arg_52_0 then
				...
				local var_52_9 = arg_49_1:GetWordFromCfg(414361012)
