return {
	Play925021001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_35 = 0.233333333333333
			local var_4_36 = 1
			...
			if var_4_35 < arg_1_1.time_ and arg_1_1.time_ <= var_4_35 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_37, var_4_38, "bgm_side_daily05", "bgm_side_daily05", "bgm_side_daily05.awb")

				local var_4_39 = ""
				local var_4_40 = manager.audio:GetAudioName("bgm_side_daily05", "bgm_side_daily05")
			...
			if var_4_41 < arg_1_1.time_ and arg_1_1.time_ <= var_4_41 + arg_4_0 then
				...
				local var_4_44 = arg_1_1:FormatText(StoryNameCfg[672].name)
				...
				local var_4_45 = arg_1_1:GetWordFromCfg(925021001)
