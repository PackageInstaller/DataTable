	...
	Play116312027 = function(arg_108_0, arg_108_1)
		...
		function arg_108_1.onSingleLineUpdate_(arg_111_0)
			...
			if var_111_47 < arg_108_1.time_ and arg_108_1.time_ <= var_111_47 + arg_111_0 then
				...
				local var_111_49 = arg_108_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_111_50 = var_111_48:GetComponent("Text")
				local var_111_51 = var_111_48:GetComponent("RectTransform")

				var_111_50.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_111_51.offsetMin = Vector2.New(0, 0)
				var_111_51.offsetMax = Vector2.New(0, 0)
			end

			local var_111_52 = 3.01666666666667

			if var_111_52 < arg_108_1.time_ and arg_108_1.time_ <= var_111_52 + arg_111_0 then
				arg_108_1.allBtn_.enabled = false
			end

			local var_111_53 = 2.13333333333333
	...
	Play116312028 = function(arg_112_0, arg_112_1)
		...
		function arg_112_1.onSingleLineUpdate_(arg_115_0)
			...
			if var_115_16 < arg_112_1.time_ and arg_112_1.time_ <= var_115_16 + arg_115_0 then
				...
				local var_115_18 = arg_112_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_115_19 = var_115_17:GetComponent("Text")
				local var_115_20 = var_115_17:GetComponent("RectTransform")

				var_115_19.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_115_20.offsetMin = Vector2.New(0, 0)
				var_115_20.offsetMax = Vector2.New(0, 0)
			end
	...
	Play116312029 = function(arg_116_0, arg_116_1)
		...
		function arg_116_1.onSingleLineUpdate_(arg_119_0)
			...
			if var_119_16 < arg_116_1.time_ and arg_116_1.time_ <= var_119_16 + arg_119_0 then
				...
				local var_119_18 = arg_116_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_119_19 = var_119_17:GetComponent("Text")
				local var_119_20 = var_119_17:GetComponent("RectTransform")

				var_119_19.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_119_20.offsetMin = Vector2.New(0, 0)
				var_119_20.offsetMax = Vector2.New(0, 0)
			end
	...
	Play116312030 = function(arg_120_0, arg_120_1)
		...
		function arg_120_1.onSingleLineUpdate_(arg_123_0)
			...
			if var_123_16 < arg_120_1.time_ and arg_120_1.time_ <= var_123_16 + arg_123_0 then
				...
				local var_123_18 = arg_120_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_123_19 = var_123_17:GetComponent("Text")
				local var_123_20 = var_123_17:GetComponent("RectTransform")

				var_123_19.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_123_20.offsetMin = Vector2.New(0, 0)
				var_123_20.offsetMax = Vector2.New(0, 0)
			end

			local var_123_21 = 0
			local var_123_22 = 0.266666666666667

			if var_123_21 < arg_120_1.time_ and arg_120_1.time_ <= var_123_21 + arg_123_0 then
				local var_123_23 = "play"
				local var_123_24 = "music"

				arg_120_1:AudioAction(var_123_23, var_123_24, "ui_battle", "ui_battle_stopbgm", "")

				local var_123_25 = ""
				local var_123_26 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if var_123_26 ~= "" then
					if arg_120_1.bgmTxt_.text ~= var_123_26 and arg_120_1.bgmTxt_.text ~= "" then
						if arg_120_1.bgmTxt2_.text ~= "" then
							arg_120_1.bgmTxt_.text = arg_120_1.bgmTxt2_.text
						end

						arg_120_1.bgmTxt2_.text = var_123_26

						arg_120_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_120_1.bgmTxt_.text = var_123_26
						arg_120_1.bgmTxt2_.text = var_123_26
					end
			...
			local var_123_28 = 2.01666666666667
	...
	Play116312070 = function(arg_289_0, arg_289_1)
		...
		function arg_289_1.onSingleLineUpdate_(arg_292_0)
			...
			if var_292_41 < arg_289_1.time_ and arg_289_1.time_ <= var_292_41 + arg_292_0 then
				...
				local var_292_43 = arg_289_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_292_44 = var_292_42:GetComponent("Text")
				local var_292_45 = var_292_42:GetComponent("RectTransform")

				var_292_44.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_292_45.offsetMin = Vector2.New(0, 0)
				var_292_45.offsetMax = Vector2.New(0, 0)
			end
			...
			local var_292_47 = 6.599999999999
