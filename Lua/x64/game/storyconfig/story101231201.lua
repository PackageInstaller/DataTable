	...
	Play123121089 = function(arg_363_0, arg_363_1)
		...
		function arg_363_1.onSingleLineUpdate_(arg_366_0)
			...
			if var_366_45 < arg_363_1.time_ and arg_363_1.time_ <= var_366_45 + arg_366_0 then
				...
				local var_366_47 = arg_363_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_366_48 = var_366_46:GetComponent("Text")
				local var_366_49 = var_366_46:GetComponent("RectTransform")

				var_366_48.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_366_49.offsetMin = Vector2.New(0, 0)
				var_366_49.offsetMax = Vector2.New(0, 0)
			end
			...
			local var_366_51 = 2.01666666666667
			local var_366_52 = 1

			if var_366_51 < arg_363_1.time_ and arg_363_1.time_ <= var_366_51 + arg_366_0 then
				local var_366_53 = "play"
				local var_366_54 = "effect"

				arg_363_1:AudioAction(var_366_53, var_366_54, "se_story_123_01", "se_story_123_01_wind", "")
			end
		end
