return {
	Play62201001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 62201001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_28 <= arg_1_1.time_ and arg_1_1.time_ < var_4_28 + var_4_29 then
				...
				local var_4_31 = Vector3.New(0, -0.87, -5.7)
			...
			if arg_1_1.time_ >= var_4_28 + var_4_29 and arg_1_1.time_ < var_4_28 + var_4_29 + arg_4_0 then
				var_4_27.localPosition = Vector3.New(0, -0.87, -5.7)
			...
			if var_4_54 < arg_1_1.time_ and arg_1_1.time_ <= var_4_54 + arg_4_0 then
				...
				local var_4_58 = arg_1_1:GetWordFromCfg(62201001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201001", "story_v_chess_62201.awb") ~= 0 then
					local var_4_63 = manager.audio:GetVoiceLength("story_v_chess_62201", "62201001", "story_v_chess_62201.awb") / 1000
					...
					if var_4_58.prefab_name ~= "" and arg_1_1.actors_[var_4_58.prefab_name] ~= nil then
						local var_4_64 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_58.prefab_name].transform, "story_v_chess_62201", "62201001", "story_v_chess_62201.awb")

						arg_1_1:RecordAudio("62201001", var_4_64)
						arg_1_1:RecordAudio("62201001", var_4_64)
					else
						arg_1_1:AudioAction("play", "voice", "story_v_chess_62201", "62201001", "story_v_chess_62201.awb")
					end

					arg_1_1:RecordHistoryTalkVoice("story_v_chess_62201", "62201001", "story_v_chess_62201.awb")
				end
	...
	Play62201002 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 62201002
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				arg_9_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/story1111/story1111action/1111action4_1")
			end
			...
			if var_12_2 < arg_9_1.time_ and arg_9_1.time_ <= var_12_2 + arg_12_0 then
				...
				local var_12_4 = arg_9_1:FormatText(StoryNameCfg[67].name)
				...
				local var_12_5 = arg_9_1:GetWordFromCfg(62201002)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201002", "story_v_chess_62201.awb") ~= 0 then
					local var_12_10 = manager.audio:GetVoiceLength("story_v_chess_62201", "62201002", "story_v_chess_62201.awb") / 1000
					...
					if var_12_5.prefab_name ~= "" and arg_9_1.actors_[var_12_5.prefab_name] ~= nil then
						local var_12_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_5.prefab_name].transform, "story_v_chess_62201", "62201002", "story_v_chess_62201.awb")

						arg_9_1:RecordAudio("62201002", var_12_11)
						arg_9_1:RecordAudio("62201002", var_12_11)
					else
						arg_9_1:AudioAction("play", "voice", "story_v_chess_62201", "62201002", "story_v_chess_62201.awb")
					end

					arg_9_1:RecordHistoryTalkVoice("story_v_chess_62201", "62201002", "story_v_chess_62201.awb")
				end
	...
	Play62201003 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 62201003
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play62201004(arg_13_1)
			end
		end
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_6 < arg_13_1.time_ and arg_13_1.time_ <= var_16_6 + arg_16_0 then
				...
				local var_16_9 = arg_13_1:GetWordFromCfg(62201003)
	...
	Play62201004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 62201004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play62201005(arg_17_1)
			end
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_1 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				arg_17_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3101cva")
			end
			...
			if var_20_6 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_8 = arg_17_1:FormatText(StoryNameCfg[67].name)
				...
				local var_20_9 = arg_17_1:GetWordFromCfg(62201004)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201004", "story_v_chess_62201.awb") ~= 0 then
					local var_20_14 = manager.audio:GetVoiceLength("story_v_chess_62201", "62201004", "story_v_chess_62201.awb") / 1000
					...
					if var_20_9.prefab_name ~= "" and arg_17_1.actors_[var_20_9.prefab_name] ~= nil then
						local var_20_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_9.prefab_name].transform, "story_v_chess_62201", "62201004", "story_v_chess_62201.awb")

						arg_17_1:RecordAudio("62201004", var_20_15)
						arg_17_1:RecordAudio("62201004", var_20_15)
					else
						arg_17_1:AudioAction("play", "voice", "story_v_chess_62201", "62201004", "story_v_chess_62201.awb")
					end

					arg_17_1:RecordHistoryTalkVoice("story_v_chess_62201", "62201004", "story_v_chess_62201.awb")
				end
	...
	Play62201005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 62201005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play62201006(arg_21_1)
			end
		end
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_6 < arg_21_1.time_ and arg_21_1.time_ <= var_24_6 + arg_24_0 then
				...
				local var_24_9 = arg_21_1:GetWordFromCfg(62201005)
	...
	Play62201006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 62201006
		arg_25_1.duration_ = 8.17
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				arg_25_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/story1111/story1111action/1111action2_2")
			end

			local var_28_1 = 0

			if var_28_1 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				arg_25_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1303cva")
			end
			...
			if var_28_6 < arg_25_1.time_ and arg_25_1.time_ <= var_28_6 + arg_28_0 then
				...
				local var_28_9 = arg_25_1:GetWordFromCfg(62201006)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201006", "story_v_chess_62201.awb") ~= 0 then
					local var_28_14 = manager.audio:GetVoiceLength("story_v_chess_62201", "62201006", "story_v_chess_62201.awb") / 1000
					...
					if var_28_9.prefab_name ~= "" and arg_25_1.actors_[var_28_9.prefab_name] ~= nil then
						local var_28_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_9.prefab_name].transform, "story_v_chess_62201", "62201006", "story_v_chess_62201.awb")

						arg_25_1:RecordAudio("62201006", var_28_15)
						arg_25_1:RecordAudio("62201006", var_28_15)
					else
						arg_25_1:AudioAction("play", "voice", "story_v_chess_62201", "62201006", "story_v_chess_62201.awb")
					end

					arg_25_1:RecordHistoryTalkVoice("story_v_chess_62201", "62201006", "story_v_chess_62201.awb")
				end
