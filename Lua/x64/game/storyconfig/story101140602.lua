return {
	Play114062001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_22 = arg_1_1.bgs_.E05a.transform
			local var_4_23 = 0

			if var_4_23 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				arg_1_1.var_.moveOldPosE05a = var_4_22.localPosition
			end
			...
			if var_4_23 <= arg_1_1.time_ and arg_1_1.time_ < var_4_23 + var_4_24 then
				...
				local var_4_26 = Vector3.New(0, 1, 9.2)

				var_4_22.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPosE05a, var_4_26, var_4_25)
			end

			if arg_1_1.time_ >= var_4_23 + var_4_24 and arg_1_1.time_ < var_4_23 + var_4_24 + arg_4_0 then
				var_4_22.localPosition = Vector3.New(0, 1, 9.2)
			end

			local var_4_27 = arg_1_1.bgs_.E05a.transform
			local var_4_28 = 0.034

			if var_4_28 < arg_1_1.time_ and arg_1_1.time_ <= var_4_28 + arg_4_0 then
				arg_1_1.var_.moveOldPosE05a = var_4_27.localPosition
			end

			local var_4_29 = 3.266

			if var_4_28 <= arg_1_1.time_ and arg_1_1.time_ < var_4_28 + var_4_29 then
				local var_4_30 = (arg_1_1.time_ - var_4_28) / var_4_29
				local var_4_31 = Vector3.New(0, 1, 10)

				var_4_27.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPosE05a, var_4_31, var_4_30)
			end
			...
			if var_4_53 < arg_1_1.time_ and arg_1_1.time_ <= var_4_53 + arg_4_0 then
				arg_1_1.var_.shakeOldPos = var_4_52.localPosition
			end

			local var_4_54 = 1

			if var_4_53 <= arg_1_1.time_ and arg_1_1.time_ < var_4_53 + var_4_54 then
				local var_4_55 = (arg_1_1.time_ - var_4_53) / 0.066
				local var_4_56, var_4_57 = math.modf(var_4_55)

				var_4_52.localPosition = Vector3.New(var_4_57 * 0.13, var_4_57 * 0.13, var_4_57 * 0.13) + arg_1_1.var_.shakeOldPos
			end

			if arg_1_1.time_ >= var_4_53 + var_4_54 and arg_1_1.time_ < var_4_53 + var_4_54 + arg_4_0 then
				var_4_52.localPosition = arg_1_1.var_.shakeOldPos
			end
			...
			if var_4_64 < arg_1_1.time_ and arg_1_1.time_ <= var_4_64 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_66, var_4_67, "bgm_story_v1_battleground_1", "bgm_story_v1_battleground_1", "bgm_story_v1_battleground_1.awb")

				local var_4_68 = ""
				local var_4_69 = manager.audio:GetAudioName("bgm_story_v1_battleground_1", "bgm_story_v1_battleground_1")
			...
			if var_4_70 < arg_1_1.time_ and arg_1_1.time_ <= var_4_70 + arg_4_0 then
				...
				local var_4_73 = arg_1_1:GetWordFromCfg(114062001)
				...
				local var_4_77 = var_4_75 <= 0 and var_4_71 or var_4_71 * (var_4_76 / var_4_75)

				if var_4_77 > 0 and var_4_71 < var_4_77 then
					arg_1_1.talkMaxDuration = var_4_77
					var_4_70 = var_4_70 + 0.3

					if var_4_77 + var_4_70 > arg_1_1.duration_ then
						arg_1_1.duration_ = var_4_77 + var_4_70
					end
				end
			...
			local var_4_78 = var_4_70 + 0.3
			local var_4_79 = math.max(var_4_71, arg_1_1.talkMaxDuration)
	...
	Play114062002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				...
				local var_12_2 = arg_9_1:FormatText(StoryNameCfg[212].name)
				...
				local var_12_3 = arg_9_1:GetWordFromCfg(114062002)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062002", "story_v_out_114062.awb") ~= 0 then
					local var_12_8 = manager.audio:GetVoiceLength("story_v_out_114062", "114062002", "story_v_out_114062.awb") / 1000
					...
					if var_12_3.prefab_name ~= "" and arg_9_1.actors_[var_12_3.prefab_name] ~= nil then
						local var_12_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_3.prefab_name].transform, "story_v_out_114062", "114062002", "story_v_out_114062.awb")

						arg_9_1:RecordAudio("114062002", var_12_9)
						arg_9_1:RecordAudio("114062002", var_12_9)
					else
	...
	Play114062003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_0 + arg_16_0 then
				...
				local var_16_2 = arg_13_1:FormatText(StoryNameCfg[212].name)
				...
				local var_16_3 = arg_13_1:GetWordFromCfg(114062003)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062003", "story_v_out_114062.awb") ~= 0 then
					local var_16_8 = manager.audio:GetVoiceLength("story_v_out_114062", "114062003", "story_v_out_114062.awb") / 1000
					...
					if var_16_3.prefab_name ~= "" and arg_13_1.actors_[var_16_3.prefab_name] ~= nil then
						local var_16_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_3.prefab_name].transform, "story_v_out_114062", "114062003", "story_v_out_114062.awb")

						arg_13_1:RecordAudio("114062003", var_16_9)
						arg_13_1:RecordAudio("114062003", var_16_9)
					else
	...
	Play114062004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_0 + arg_20_0 then
				...
				local var_20_2 = arg_17_1:GetWordFromCfg(114062004)
	...
	Play114062005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			local var_24_0 = "10006ui_story"

			if arg_21_1.actors_[var_24_0] == nil then
				local var_24_1 = Asset.Load("Char/" .. "10006ui_story")

				if not isNil(var_24_1) then
					local var_24_2 = Object.Instantiate(Asset.Load("Char/" .. "10006ui_story"), arg_21_1.stage_.transform)
			...
			local var_24_5 = arg_21_1.actors_["10006ui_story"].transform
			local var_24_6 = 0

			if var_24_6 < arg_21_1.time_ and arg_21_1.time_ <= var_24_6 + arg_24_0 then
				arg_21_1.var_.moveOldPos10006ui_story = var_24_5.localPosition
			end
			...
			if var_24_6 <= arg_21_1.time_ and arg_21_1.time_ < var_24_6 + var_24_7 then
				...
				local var_24_9 = Vector3.New(0, -0.98, -5.65)

				var_24_5.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos10006ui_story, var_24_9, var_24_8)
			...
			if arg_21_1.time_ >= var_24_6 + var_24_7 and arg_21_1.time_ < var_24_6 + var_24_7 + arg_24_0 then
				var_24_5.localPosition = Vector3.New(0, -0.98, -5.65)
			...
			local var_24_16 = arg_21_1.actors_["10006ui_story"]
			local var_24_17 = 0

			if var_24_17 < arg_21_1.time_ and arg_21_1.time_ <= var_24_17 + arg_24_0 and not isNil(var_24_16) and arg_21_1.var_.characterEffect10006ui_story == nil then
				arg_21_1.var_.characterEffect10006ui_story = var_24_16:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_24_17 <= arg_21_1.time_ and arg_21_1.time_ < var_24_17 + var_24_18 and not isNil(var_24_16) then
				...
				if arg_21_1.var_.characterEffect10006ui_story and not isNil(var_24_16) then
					arg_21_1.var_.characterEffect10006ui_story.fillFlat = false
				end
			end

			if arg_21_1.time_ >= var_24_17 + var_24_18 and arg_21_1.time_ < var_24_17 + var_24_18 + arg_24_0 and not isNil(var_24_16) and arg_21_1.var_.characterEffect10006ui_story then
				arg_21_1.var_.characterEffect10006ui_story.fillFlat = false
			end
			...
			if var_24_20 < arg_21_1.time_ and arg_21_1.time_ <= var_24_20 + arg_24_0 then
				...
				local var_24_22 = arg_21_1:FormatText(StoryNameCfg[212].name)
				...
				local var_24_23 = arg_21_1:GetWordFromCfg(114062005)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062005", "story_v_out_114062.awb") ~= 0 then
					local var_24_28 = manager.audio:GetVoiceLength("story_v_out_114062", "114062005", "story_v_out_114062.awb") / 1000
					...
					if var_24_23.prefab_name ~= "" and arg_21_1.actors_[var_24_23.prefab_name] ~= nil then
						local var_24_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_23.prefab_name].transform, "story_v_out_114062", "114062005", "story_v_out_114062.awb")

						arg_21_1:RecordAudio("114062005", var_24_29)
						arg_21_1:RecordAudio("114062005", var_24_29)
					else
	...
	Play114062006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			local var_28_0 = arg_25_1.actors_["10006ui_story"].transform
			local var_28_1 = 0

			if var_28_1 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				arg_25_1.var_.moveOldPos10006ui_story = var_28_0.localPosition
			end
			...
			if var_28_1 <= arg_25_1.time_ and arg_25_1.time_ < var_28_1 + var_28_2 then
				...
				var_28_0.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos10006ui_story, var_28_4, var_28_3)
			...
			if var_28_9 < arg_25_1.time_ and arg_25_1.time_ <= var_28_9 + arg_28_0 then
				...
				local var_28_11 = arg_25_1:GetWordFromCfg(114062006)
	...
	Play114062007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			local var_32_0 = arg_29_1.actors_["10006ui_story"].transform
			local var_32_1 = 0

			if var_32_1 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				arg_29_1.var_.moveOldPos10006ui_story = var_32_0.localPosition
			end
			...
			if var_32_1 <= arg_29_1.time_ and arg_29_1.time_ < var_32_1 + var_32_2 then
				...
				local var_32_4 = Vector3.New(0, -0.98, -5.65)

				var_32_0.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos10006ui_story, var_32_4, var_32_3)
			...
			if arg_29_1.time_ >= var_32_1 + var_32_2 and arg_29_1.time_ < var_32_1 + var_32_2 + arg_32_0 then
				var_32_0.localPosition = Vector3.New(0, -0.98, -5.65)
			...
			local var_32_11 = arg_29_1.actors_["10006ui_story"]
			local var_32_12 = 0

			if var_32_12 < arg_29_1.time_ and arg_29_1.time_ <= var_32_12 + arg_32_0 and not isNil(var_32_11) and arg_29_1.var_.characterEffect10006ui_story == nil then
				arg_29_1.var_.characterEffect10006ui_story = var_32_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_32_12 <= arg_29_1.time_ and arg_29_1.time_ < var_32_12 + var_32_13 and not isNil(var_32_11) then
				...
				if arg_29_1.var_.characterEffect10006ui_story and not isNil(var_32_11) then
					arg_29_1.var_.characterEffect10006ui_story.fillFlat = false
				end
			end

			if arg_29_1.time_ >= var_32_12 + var_32_13 and arg_29_1.time_ < var_32_12 + var_32_13 + arg_32_0 and not isNil(var_32_11) and arg_29_1.var_.characterEffect10006ui_story then
				arg_29_1.var_.characterEffect10006ui_story.fillFlat = false
			end
			...
			if var_32_15 < arg_29_1.time_ and arg_29_1.time_ <= var_32_15 + arg_32_0 then
				...
				local var_32_17 = arg_29_1:FormatText(StoryNameCfg[212].name)
				...
				local var_32_18 = arg_29_1:GetWordFromCfg(114062007)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062007", "story_v_out_114062.awb") ~= 0 then
					local var_32_23 = manager.audio:GetVoiceLength("story_v_out_114062", "114062007", "story_v_out_114062.awb") / 1000
					...
					if var_32_18.prefab_name ~= "" and arg_29_1.actors_[var_32_18.prefab_name] ~= nil then
						local var_32_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_18.prefab_name].transform, "story_v_out_114062", "114062007", "story_v_out_114062.awb")

						arg_29_1:RecordAudio("114062007", var_32_24)
						arg_29_1:RecordAudio("114062007", var_32_24)
					else
	...
	Play114062008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_6 < arg_33_1.time_ and arg_33_1.time_ <= var_36_6 + arg_36_0 then
				...
				local var_36_8 = arg_33_1:GetWordFromCfg(114062008)
	...
	Play114062009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			local var_40_2 = arg_37_1.actors_["10006ui_story"]
			local var_40_3 = 0

			if var_40_3 < arg_37_1.time_ and arg_37_1.time_ <= var_40_3 + arg_40_0 and not isNil(var_40_2) and arg_37_1.var_.characterEffect10006ui_story == nil then
				arg_37_1.var_.characterEffect10006ui_story = var_40_2:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_40_3 <= arg_37_1.time_ and arg_37_1.time_ < var_40_3 + var_40_4 and not isNil(var_40_2) then
				...
				if arg_37_1.var_.characterEffect10006ui_story and not isNil(var_40_2) then
					arg_37_1.var_.characterEffect10006ui_story.fillFlat = false
				end
			end

			if arg_37_1.time_ >= var_40_3 + var_40_4 and arg_37_1.time_ < var_40_3 + var_40_4 + arg_40_0 and not isNil(var_40_2) and arg_37_1.var_.characterEffect10006ui_story then
				arg_37_1.var_.characterEffect10006ui_story.fillFlat = false
			end
			...
			if var_40_6 < arg_37_1.time_ and arg_37_1.time_ <= var_40_6 + arg_40_0 then
				...
				local var_40_8 = arg_37_1:FormatText(StoryNameCfg[212].name)
				...
				local var_40_9 = arg_37_1:GetWordFromCfg(114062009)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062009", "story_v_out_114062.awb") ~= 0 then
					local var_40_14 = manager.audio:GetVoiceLength("story_v_out_114062", "114062009", "story_v_out_114062.awb") / 1000
					...
					if var_40_9.prefab_name ~= "" and arg_37_1.actors_[var_40_9.prefab_name] ~= nil then
						local var_40_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_9.prefab_name].transform, "story_v_out_114062", "114062009", "story_v_out_114062.awb")

						arg_37_1:RecordAudio("114062009", var_40_15)
						arg_37_1:RecordAudio("114062009", var_40_15)
					else
	...
	Play114062010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_9 < arg_41_1.time_ and arg_41_1.time_ <= var_44_9 + arg_44_0 then
				...
				local var_44_11 = arg_41_1:GetWordFromCfg(114062010)
	...
	Play114062011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_8 < arg_45_1.time_ and arg_45_1.time_ <= var_48_8 + arg_48_0 then
				...
				local var_48_10 = arg_45_1:FormatText(StoryNameCfg[36].name)
				...
				local var_48_11 = arg_45_1:GetWordFromCfg(114062011)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062011", "story_v_out_114062.awb") ~= 0 then
					local var_48_16 = manager.audio:GetVoiceLength("story_v_out_114062", "114062011", "story_v_out_114062.awb") / 1000
					...
					if var_48_11.prefab_name ~= "" and arg_45_1.actors_[var_48_11.prefab_name] ~= nil then
						local var_48_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_11.prefab_name].transform, "story_v_out_114062", "114062011", "story_v_out_114062.awb")

						arg_45_1:RecordAudio("114062011", var_48_17)
						arg_45_1:RecordAudio("114062011", var_48_17)
					else
	...
	Play114062012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			local var_52_0 = arg_49_1.actors_["10006ui_story"].transform
			local var_52_1 = 0

			if var_52_1 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				arg_49_1.var_.moveOldPos10006ui_story = var_52_0.localPosition
			end
			...
			if var_52_1 <= arg_49_1.time_ and arg_49_1.time_ < var_52_1 + var_52_2 then
				...
				local var_52_4 = Vector3.New(0, -0.98, -5.65)

				var_52_0.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos10006ui_story, var_52_4, var_52_3)
			...
			if arg_49_1.time_ >= var_52_1 + var_52_2 and arg_49_1.time_ < var_52_1 + var_52_2 + arg_52_0 then
				var_52_0.localPosition = Vector3.New(0, -0.98, -5.65)
			...
			local var_52_11 = arg_49_1.actors_["10006ui_story"]
			local var_52_12 = 0

			if var_52_12 < arg_49_1.time_ and arg_49_1.time_ <= var_52_12 + arg_52_0 and not isNil(var_52_11) and arg_49_1.var_.characterEffect10006ui_story == nil then
				arg_49_1.var_.characterEffect10006ui_story = var_52_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_52_12 <= arg_49_1.time_ and arg_49_1.time_ < var_52_12 + var_52_13 and not isNil(var_52_11) then
				...
				if arg_49_1.var_.characterEffect10006ui_story and not isNil(var_52_11) then
					arg_49_1.var_.characterEffect10006ui_story.fillFlat = false
				end
			end

			if arg_49_1.time_ >= var_52_12 + var_52_13 and arg_49_1.time_ < var_52_12 + var_52_13 + arg_52_0 and not isNil(var_52_11) and arg_49_1.var_.characterEffect10006ui_story then
				arg_49_1.var_.characterEffect10006ui_story.fillFlat = false
			end
			...
			if var_52_15 < arg_49_1.time_ and arg_49_1.time_ <= var_52_15 + arg_52_0 then
				...
				local var_52_17 = arg_49_1:FormatText(StoryNameCfg[212].name)
				...
				local var_52_18 = arg_49_1:GetWordFromCfg(114062012)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062012", "story_v_out_114062.awb") ~= 0 then
					local var_52_23 = manager.audio:GetVoiceLength("story_v_out_114062", "114062012", "story_v_out_114062.awb") / 1000
					...
					if var_52_18.prefab_name ~= "" and arg_49_1.actors_[var_52_18.prefab_name] ~= nil then
						local var_52_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_18.prefab_name].transform, "story_v_out_114062", "114062012", "story_v_out_114062.awb")

						arg_49_1:RecordAudio("114062012", var_52_24)
						arg_49_1:RecordAudio("114062012", var_52_24)
					else
	...
	Play114062013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_9 < arg_53_1.time_ and arg_53_1.time_ <= var_56_9 + arg_56_0 then
				...
				local var_56_11 = arg_53_1:FormatText(StoryNameCfg[68].name)
				...
				local var_56_12 = arg_53_1:GetWordFromCfg(114062013)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062013", "story_v_out_114062.awb") ~= 0 then
					local var_56_17 = manager.audio:GetVoiceLength("story_v_out_114062", "114062013", "story_v_out_114062.awb") / 1000
					...
					if var_56_12.prefab_name ~= "" and arg_53_1.actors_[var_56_12.prefab_name] ~= nil then
						local var_56_18 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_12.prefab_name].transform, "story_v_out_114062", "114062013", "story_v_out_114062.awb")

						arg_53_1:RecordAudio("114062013", var_56_18)
						arg_53_1:RecordAudio("114062013", var_56_18)
					else
	...
	Play114062014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			local var_60_2 = arg_57_1.actors_["10006ui_story"]
			local var_60_3 = 0

			if var_60_3 < arg_57_1.time_ and arg_57_1.time_ <= var_60_3 + arg_60_0 and not isNil(var_60_2) and arg_57_1.var_.characterEffect10006ui_story == nil then
				arg_57_1.var_.characterEffect10006ui_story = var_60_2:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_60_3 <= arg_57_1.time_ and arg_57_1.time_ < var_60_3 + var_60_4 and not isNil(var_60_2) then
				...
				if arg_57_1.var_.characterEffect10006ui_story and not isNil(var_60_2) then
					arg_57_1.var_.characterEffect10006ui_story.fillFlat = false
				end
			end

			if arg_57_1.time_ >= var_60_3 + var_60_4 and arg_57_1.time_ < var_60_3 + var_60_4 + arg_60_0 and not isNil(var_60_2) and arg_57_1.var_.characterEffect10006ui_story then
				arg_57_1.var_.characterEffect10006ui_story.fillFlat = false
			end

			local var_60_6 = arg_57_1.actors_["10006ui_story"].transform
			local var_60_7 = 0

			if var_60_7 < arg_57_1.time_ and arg_57_1.time_ <= var_60_7 + arg_60_0 then
				arg_57_1.var_.moveOldPos10006ui_story = var_60_6.localPosition
			end
			...
			if var_60_7 <= arg_57_1.time_ and arg_57_1.time_ < var_60_7 + var_60_8 then
				...
				local var_60_10 = Vector3.New(0, -0.98, -5.65)

				var_60_6.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos10006ui_story, var_60_10, var_60_9)
			...
			if arg_57_1.time_ >= var_60_7 + var_60_8 and arg_57_1.time_ < var_60_7 + var_60_8 + arg_60_0 then
				var_60_6.localPosition = Vector3.New(0, -0.98, -5.65)
			...
			if var_60_15 < arg_57_1.time_ and arg_57_1.time_ <= var_60_15 + arg_60_0 then
				...
				local var_60_17 = arg_57_1:FormatText(StoryNameCfg[212].name)
				...
				local var_60_18 = arg_57_1:GetWordFromCfg(114062014)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062014", "story_v_out_114062.awb") ~= 0 then
					local var_60_23 = manager.audio:GetVoiceLength("story_v_out_114062", "114062014", "story_v_out_114062.awb") / 1000
					...
					if var_60_18.prefab_name ~= "" and arg_57_1.actors_[var_60_18.prefab_name] ~= nil then
						local var_60_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_57_1.actors_[var_60_18.prefab_name].transform, "story_v_out_114062", "114062014", "story_v_out_114062.awb")

						arg_57_1:RecordAudio("114062014", var_60_24)
						arg_57_1:RecordAudio("114062014", var_60_24)
					else
	...
	Play114062015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_10 < arg_61_1.time_ and arg_61_1.time_ <= var_64_10 + arg_64_0 then
				arg_61_1.var_.shakeOldPos = var_64_9.localPosition
			end

			local var_64_11 = 0.6

			if var_64_10 <= arg_61_1.time_ and arg_61_1.time_ < var_64_10 + var_64_11 then
				local var_64_12 = (arg_61_1.time_ - var_64_10) / 0.066
				local var_64_13, var_64_14 = math.modf(var_64_12)

				var_64_9.localPosition = Vector3.New(var_64_14 * 0.13, var_64_14 * 0.13, var_64_14 * 0.13) + arg_61_1.var_.shakeOldPos
			end

			if arg_61_1.time_ >= var_64_10 + var_64_11 and arg_61_1.time_ < var_64_10 + var_64_11 + arg_64_0 then
				var_64_9.localPosition = arg_61_1.var_.shakeOldPos
			end
			...
			if var_64_17 < arg_61_1.time_ and arg_61_1.time_ <= var_64_17 + arg_64_0 then
				...
				local var_64_19 = arg_61_1:FormatText(StoryNameCfg[68].name)
				...
				local var_64_20 = arg_61_1:GetWordFromCfg(114062015)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062015", "story_v_out_114062.awb") ~= 0 then
					local var_64_25 = manager.audio:GetVoiceLength("story_v_out_114062", "114062015", "story_v_out_114062.awb") / 1000
					...
					if var_64_20.prefab_name ~= "" and arg_61_1.actors_[var_64_20.prefab_name] ~= nil then
						local var_64_26 = LuaForUtil.PlayVoiceWithCriLipsync(arg_61_1.actors_[var_64_20.prefab_name].transform, "story_v_out_114062", "114062015", "story_v_out_114062.awb")

						arg_61_1:RecordAudio("114062015", var_64_26)
						arg_61_1:RecordAudio("114062015", var_64_26)
					else
	...
	Play114062016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_8 < arg_65_1.time_ and arg_65_1.time_ <= var_68_8 + arg_68_0 then
				...
				local var_68_10 = arg_65_1:FormatText(StoryNameCfg[212].name)
				...
				local var_68_11 = arg_65_1:GetWordFromCfg(114062016)
				...
				if manager.audio:GetVoiceLength("story_v_out_114062", "114062016", "story_v_out_114062.awb") ~= 0 then
					local var_68_16 = manager.audio:GetVoiceLength("story_v_out_114062", "114062016", "story_v_out_114062.awb") / 1000
					...
					if var_68_11.prefab_name ~= "" and arg_65_1.actors_[var_68_11.prefab_name] ~= nil then
						local var_68_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_65_1.actors_[var_68_11.prefab_name].transform, "story_v_out_114062", "114062016", "story_v_out_114062.awb")

						arg_65_1:RecordAudio("114062016", var_68_17)
						arg_65_1:RecordAudio("114062016", var_68_17)
					else
