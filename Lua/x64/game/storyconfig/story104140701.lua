return {
	Play414071001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_22 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				...
				local var_4_25 = arg_1_1:GetWordFromCfg(414071001)
	...
	Play414071002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(414071002)
	...
	Play414071003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_6 <= arg_11_1.time_ and arg_11_1.time_ < var_14_6 + var_14_7 then
				...
				var_14_5.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1049ui_story, var_14_9, var_14_8)
			...
			local var_14_14 = arg_11_1.actors_["1049ui_story"]
			local var_14_15 = 0

			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 and not isNil(var_14_14) and arg_11_1.var_.characterEffect1049ui_story == nil then
				arg_11_1.var_.characterEffect1049ui_story = var_14_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_14_15 <= arg_11_1.time_ and arg_11_1.time_ < var_14_15 + var_14_16 and not isNil(var_14_14) then
				...
				if arg_11_1.var_.characterEffect1049ui_story and not isNil(var_14_14) then
					arg_11_1.var_.characterEffect1049ui_story.fillFlat = false
				end
			end

			if arg_11_1.time_ >= var_14_15 + var_14_16 and arg_11_1.time_ < var_14_15 + var_14_16 + arg_14_0 and not isNil(var_14_14) and arg_11_1.var_.characterEffect1049ui_story then
				arg_11_1.var_.characterEffect1049ui_story.fillFlat = false
			end
			...
			if var_14_20 < arg_11_1.time_ and arg_11_1.time_ <= var_14_20 + arg_14_0 then
				...
				local var_14_23 = arg_11_1:GetWordFromCfg(414071003)
	...
	Play414071004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_6 < arg_15_1.time_ and arg_15_1.time_ <= var_18_6 + arg_18_0 then
				...
				local var_18_9 = arg_15_1:GetWordFromCfg(414071004)
	...
	Play414071005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_0 + arg_22_0 then
				...
				local var_22_3 = arg_19_1:GetWordFromCfg(414071005)
	...
	Play414071006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_0 + arg_26_0 then
				...
				local var_26_3 = arg_23_1:GetWordFromCfg(414071006)
	...
	Play414071007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_1 < arg_27_1.time_ and arg_27_1.time_ <= var_30_1 + arg_30_0 and not isNil(var_30_0) and arg_27_1.var_.characterEffect1049ui_story == nil then
			...
			if var_30_1 <= arg_27_1.time_ and arg_27_1.time_ < var_30_1 + var_30_2 and not isNil(var_30_0) then
				...
				if arg_27_1.var_.characterEffect1049ui_story and not isNil(var_30_0) then
					arg_27_1.var_.characterEffect1049ui_story.fillFlat = false
				end
			end

			if arg_27_1.time_ >= var_30_1 + var_30_2 and arg_27_1.time_ < var_30_1 + var_30_2 + arg_30_0 and not isNil(var_30_0) and arg_27_1.var_.characterEffect1049ui_story then
				arg_27_1.var_.characterEffect1049ui_story.fillFlat = false
			end
			...
			if var_30_6 < arg_27_1.time_ and arg_27_1.time_ <= var_30_6 + arg_30_0 then
				...
				local var_30_9 = arg_27_1:GetWordFromCfg(414071007)
	...
	Play414071008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_6 < arg_31_1.time_ and arg_31_1.time_ <= var_34_6 + arg_34_0 then
				...
				local var_34_9 = arg_31_1:GetWordFromCfg(414071008)
	...
	Play414071009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_6 < arg_35_1.time_ and arg_35_1.time_ <= var_38_6 + arg_38_0 then
				...
				local var_38_9 = arg_35_1:GetWordFromCfg(414071009)
