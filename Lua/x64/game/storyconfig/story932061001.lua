return {
	Play932061001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 932061001
		arg_1_1.duration_ = 5
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_28 = arg_1_1.actors_["1194"].transform
			local var_4_29 = 0

			if var_4_29 < arg_1_1.time_ and arg_1_1.time_ <= var_4_29 + arg_4_0 then
				arg_1_1.var_.moveOldPos1194 = var_4_28.localPosition
			...
			if var_4_29 <= arg_1_1.time_ and arg_1_1.time_ < var_4_29 + var_4_32 then
				...
				local var_4_34 = Vector3.New(-60, -360, -240)

				var_4_28.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1194, var_4_34, var_4_33)
			end

			if arg_1_1.time_ >= var_4_29 + var_4_32 and arg_1_1.time_ < var_4_29 + var_4_32 + arg_4_0 then
				var_4_28.localPosition = Vector3.New(-60, -360, -240)
			end

			local var_4_35 = arg_1_1.actors_["1194"]
			local var_4_36 = 0

			if var_4_36 < arg_1_1.time_ and arg_1_1.time_ <= var_4_36 + arg_4_0 and not isNil(var_4_35) and arg_1_1.var_.actorSpriteComps1194 == nil then
				arg_1_1.var_.actorSpriteComps1194 = var_4_35:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if var_4_36 <= arg_1_1.time_ and arg_1_1.time_ < var_4_36 + var_4_37 and not isNil(var_4_35) then
				...
				if arg_1_1.var_.actorSpriteComps1194 then
					for iter_4_5, iter_4_6 in pairs(arg_1_1.var_.actorSpriteComps1194:ToTable()) do
						if iter_4_6 then
							if arg_1_1.isInRecall_ then
			...
			if arg_1_1.time_ >= var_4_36 + var_4_37 and arg_1_1.time_ < var_4_36 + var_4_37 + arg_4_0 and not isNil(var_4_35) and arg_1_1.var_.actorSpriteComps1194 then
				for iter_4_7, iter_4_8 in pairs(arg_1_1.var_.actorSpriteComps1194:ToTable()) do
					if iter_4_8 then
						if arg_1_1.isInRecall_ then
			...
			if var_4_59 < arg_1_1.time_ and arg_1_1.time_ <= var_4_59 + arg_4_0 then
				...
				local var_4_63 = arg_1_1:GetWordFromCfg(932061001)
	...
	Play932061002 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 932061002
		arg_9_1.duration_ = 5
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_15 < arg_9_1.time_ and arg_9_1.time_ <= var_12_15 + arg_12_0 then
				...
				local var_12_18 = arg_9_1:GetWordFromCfg(932061002)
	...
	Play932061003 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 932061003
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play932061004(arg_13_1)
			end
		end
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_9 < arg_13_1.time_ and arg_13_1.time_ <= var_16_9 + arg_16_0 then
				...
				arg_13_1:CheckSpriteTmpPos("1194", 3)
			...
			if var_16_9 <= arg_13_1.time_ and arg_13_1.time_ < var_16_9 + var_16_12 then
				...
				local var_16_14 = Vector3.New(-60, -360, -240)
			...
			if arg_13_1.time_ >= var_16_9 + var_16_12 and arg_13_1.time_ < var_16_9 + var_16_12 + arg_16_0 then
				var_16_8.localPosition = Vector3.New(-60, -360, -240)
			end

			local var_16_15 = 0
			local var_16_16 = 1.375
			...
			if var_16_15 < arg_13_1.time_ and arg_13_1.time_ <= var_16_15 + arg_16_0 then
				...
				local var_16_17 = arg_13_1:FormatText(StoryNameCfg[177].name)
				...
				arg_13_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_ganglati")
				...
				local var_16_18 = arg_13_1:GetWordFromCfg(932061003)
	...
	Play932061004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 932061004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play932061005(arg_17_1)
			end
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_7 < arg_17_1.time_ and arg_17_1.time_ <= var_20_7 + arg_20_0 then
				...
				local var_20_9 = arg_17_1:GetWordFromCfg(932061004)
	...
	Play932061005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 932061005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play932061006(arg_21_1)
			end
		end
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_7 < arg_21_1.time_ and arg_21_1.time_ <= var_24_7 + arg_24_0 then
				...
				local var_24_9 = arg_21_1:FormatText(StoryNameCfg[177].name)
				...
				local var_24_10 = arg_21_1:GetWordFromCfg(932061005)
	...
	Play932061006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 932061006
		...
		function arg_25_1.playNext_(arg_27_0)
			if arg_27_0 == 1 then
				arg_25_0:Play932061007(arg_25_1)
			end
		end
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_9 < arg_25_1.time_ and arg_25_1.time_ <= var_28_9 + arg_28_0 then
				...
				for iter_28_4 = 0, var_28_10 - 1 do
					...
					if var_28_11.name == "split_3" or not string.find(var_28_11.name, "split") then
			...
			if var_28_15 < arg_25_1.time_ and arg_25_1.time_ <= var_28_15 + arg_28_0 then
				...
				local var_28_18 = arg_25_1:GetWordFromCfg(932061006)
	...
	Play932061007 = function(arg_29_0, arg_29_1)
		arg_29_1.time_ = 0
		arg_29_1.frameCnt_ = 0
		arg_29_1.state_ = "playing"
		arg_29_1.curTalkId_ = 932061007
		...
		function arg_29_1.playNext_(arg_31_0)
			if arg_31_0 == 1 then
				arg_29_0:Play932061008(arg_29_1)
			end
		end
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_7 < arg_29_1.time_ and arg_29_1.time_ <= var_32_7 + arg_32_0 then
				...
				local var_32_9 = arg_29_1:FormatText(StoryNameCfg[181].name)
				...
				local var_32_10 = arg_29_1:GetWordFromCfg(932061007)
	...
	Play932061008 = function(arg_33_0, arg_33_1)
		arg_33_1.time_ = 0
		arg_33_1.frameCnt_ = 0
		arg_33_1.state_ = "playing"
		arg_33_1.curTalkId_ = 932061008
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_9 < arg_33_1.time_ and arg_33_1.time_ <= var_36_9 + arg_36_0 then
				...
				for iter_36_4 = 0, var_36_10 - 1 do
					...
					if var_36_11.name == "split_3" or not string.find(var_36_11.name, "split") then
			...
			if var_36_15 < arg_33_1.time_ and arg_33_1.time_ <= var_36_15 + arg_36_0 then
				...
				local var_36_17 = arg_33_1:FormatText(StoryNameCfg[177].name)
				...
				local var_36_18 = arg_33_1:GetWordFromCfg(932061008)
