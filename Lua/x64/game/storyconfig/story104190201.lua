return {
	...
	Play419021042 = function(arg_169_0, arg_169_1)
		...
		function arg_169_1.onSingleLineUpdate_(arg_172_0)
			...
			local var_172_15 = 0.05
			local var_172_16 = 1

			if var_172_15 < arg_169_1.time_ and arg_169_1.time_ <= var_172_15 + arg_172_0 then
				local var_172_17 = "play"
				local var_172_18 = "effect"

				arg_169_1:AudioAction(var_172_17, var_172_18, "se_story_141", "se_story_141_sword_aim", "")
			end

			local var_172_19 = 0
			local var_172_20 = 1.125
			...
			if var_172_19 < arg_169_1.time_ and arg_169_1.time_ <= var_172_19 + arg_172_0 then
				...
				local var_172_21 = arg_169_1:GetWordFromCfg(419021042)
				local var_172_22 = arg_169_1:FormatText(var_172_21.content)

				arg_169_1.text_.text = var_172_22

				LuaForUtil.ClearLinePrefixSymbol(arg_169_1.text_)

				local var_172_23 = 45
				local var_172_24 = utf8.len(var_172_22)
				local var_172_25 = var_172_23 <= 0 and var_172_20 or var_172_20 * (var_172_24 / var_172_23)

				if var_172_25 > 0 and var_172_20 < var_172_25 then
			...
			local var_172_26 = math.max(var_172_20, arg_169_1.talkMaxDuration)

			if var_172_19 <= arg_169_1.time_ and arg_169_1.time_ < var_172_19 + var_172_26 then
				arg_169_1.typewritter.percent = (arg_169_1.time_ - var_172_19) / var_172_26

				arg_169_1.typewritter:SetDirty()
			end

			if arg_169_1.time_ >= var_172_19 + var_172_26 and arg_169_1.time_ < var_172_19 + var_172_26 + arg_172_0 then
	...
	Play419021048 = function(arg_193_0, arg_193_1)
		...
		function arg_193_1.onSingleLineUpdate_(arg_196_0)
			...
			if var_196_0 < arg_193_1.time_ and arg_193_1.time_ <= var_196_0 + arg_196_0 then
				...
				arg_193_1:AudioAction(var_196_2, var_196_3, "se_story_140", "se_story_140_safety belt", "")
			end

			local var_196_4 = 0.05
			local var_196_5 = 1

			if var_196_4 < arg_193_1.time_ and arg_193_1.time_ <= var_196_4 + arg_196_0 then
				local var_196_6 = "play"
				local var_196_7 = "effect"

				arg_193_1:AudioAction(var_196_6, var_196_7, "se_story_1310", "se_story_1310_car01", "")
			end

			local var_196_8 = 0
			local var_196_9 = 0.925
			...
			if var_196_8 < arg_193_1.time_ and arg_193_1.time_ <= var_196_8 + arg_196_0 then
				...
				local var_196_10 = arg_193_1:GetWordFromCfg(419021048)
	...
	Play419021053 = function(arg_215_0, arg_215_1)
		...
		function arg_215_1.onSingleLineUpdate_(arg_218_0)
			...
			if var_218_15 < arg_215_1.time_ and arg_215_1.time_ <= var_218_15 + arg_218_0 then
				...
				arg_215_1:AudioAction(var_218_17, var_218_18, "se_story_1310", "se_story_1310_footstep05", "")
			end

			local var_218_19 = 0
			local var_218_20 = 1.325
			...
			if var_218_19 < arg_215_1.time_ and arg_215_1.time_ <= var_218_19 + arg_218_0 then
				...
				local var_218_21 = arg_215_1:GetWordFromCfg(419021053)
