		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_25 < arg_1_1.time_ and arg_1_1.time_ <= var_4_25 + arg_4_0 then
				...
				if not var_4_26 then
					var_4_26 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_dust"), var_4_28)
					var_4_26.name = "987"
			...
			if var_4_43 < arg_1_1.time_ and arg_1_1.time_ <= var_4_43 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_45, var_4_46, "bgm_activity_4_0_story_quake_daily", "bgm_activity_4_0_story_quake_daily", "bgm_activity_4_0_story_quake_daily.awb")

				local var_4_47 = ""
				local var_4_48 = manager.audio:GetAudioName("bgm_activity_4_0_story_quake_daily", "bgm_activity_4_0_story_quake_daily")
			...
			if var_4_49 < arg_1_1.time_ and arg_1_1.time_ <= var_4_49 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_51, var_4_52, "se_story_141", "se_story_141_jet", "")
			end
			...
			if var_4_53 < arg_1_1.time_ and arg_1_1.time_ <= var_4_53 + arg_4_0 then
				...
				local var_4_57 = arg_1_1:GetWordFromCfg(321382001)
				...
				if manager.audio:GetVoiceLength("story_v_out_321382", "321382001", "story_v_out_321382.awb") ~= 0 then
					local var_4_62 = manager.audio:GetVoiceLength("story_v_out_321382", "321382001", "story_v_out_321382.awb") / 1000
					...
					if var_4_57.prefab_name ~= "" and arg_1_1.actors_[var_4_57.prefab_name] ~= nil then
						local var_4_63 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_57.prefab_name].transform, "story_v_out_321382", "321382001", "story_v_out_321382.awb")

						arg_1_1:RecordAudio("321382001", var_4_63)
						arg_1_1:RecordAudio("321382001", var_4_63)
					else
