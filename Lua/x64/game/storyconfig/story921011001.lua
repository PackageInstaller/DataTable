	...
	Play921011001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_30 < arg_1_1.time_ and arg_1_1.time_ <= var_4_30 + arg_4_0 then
				...
				var_4_34.offsetMin = Vector2.New(0, -27.17)
				var_4_34.offsetMax = Vector2.New(0, -39.2)
			end
			...
			local var_4_36 = 1.36666666666667
			...
			if var_4_37 < arg_1_1.time_ and arg_1_1.time_ <= var_4_37 + arg_4_0 then
				...
				local var_4_38 = arg_1_1:GetWordFromCfg(921011001)
				local var_4_39 = arg_1_1:FormatText(var_4_38.content)

				arg_1_1.fswt_.text = var_4_39
			...
			local var_4_41 = 40
			local var_4_42 = 2
			local var_4_43 = arg_1_1:GetWordFromCfg(921011001)
			local var_4_44 = arg_1_1:FormatText(var_4_43.content)
			local var_4_45, var_4_46 = arg_1_1:GetPercentByPara(var_4_44, 1)

			if var_4_40 < arg_1_1.time_ and arg_1_1.time_ <= var_4_40 + arg_4_0 then
				arg_1_1.talkMaxDuration = 0

				local var_4_47 = var_4_41 <= 0 and var_4_42 or var_4_42 * ((var_4_46 - arg_1_1.typewritterCharCountI18N) / var_4_41)

				if var_4_47 > 0 and var_4_42 < var_4_47 then
			...
			local var_4_48 = 2
			local var_4_49 = math.max(var_4_48, arg_1_1.talkMaxDuration)

			if var_4_40 <= arg_1_1.time_ and arg_1_1.time_ < var_4_40 + var_4_49 then
				local var_4_50 = (arg_1_1.time_ - var_4_40) / var_4_49

				arg_1_1.fswtw_.percent = Mathf.Lerp(arg_1_1.var_.oldValueTypewriter, var_4_45, var_4_50)
				arg_1_1.fswt_:GetComponent("Text").color = Color(1, 1, 1)

				arg_1_1.fswtw_:SetDirty()
			end

			if arg_1_1.time_ >= var_4_40 + var_4_49 and arg_1_1.time_ < var_4_40 + var_4_49 + arg_4_0 then
				arg_1_1.fswtw_.percent = var_4_45

				arg_1_1.fswtw_:SetDirty()
				arg_1_1:ShowNextGo(true)

				arg_1_1.typewritterCharCountI18N = var_4_46
			end

			local var_4_51 = 0.466666666666667
			local var_4_52 = 1
			...
			if var_4_51 < arg_1_1.time_ and arg_1_1.time_ <= var_4_51 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_53, var_4_54, "se_story_137", "se_story_137_city", "")
			end
		end
