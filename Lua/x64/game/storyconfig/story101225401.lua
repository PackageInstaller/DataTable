	...
	Play122541126 = function(arg_517_0, arg_517_1)
		...
		function arg_517_1.onSingleLineUpdate_(arg_520_0)
			...
			if var_520_14 < arg_517_1.time_ and arg_517_1.time_ <= var_520_14 + arg_520_0 then
				...
				local var_520_16 = arg_517_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_520_17 = var_520_15:GetComponent("Text")
				local var_520_18 = var_520_15:GetComponent("RectTransform")

				var_520_17.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_520_18.offsetMin = Vector2.New(0, 0)
				var_520_18.offsetMax = Vector2.New(0, 0)
			end
			...
			if var_520_19 <= arg_517_1.time_ and arg_517_1.time_ < var_520_19 + var_520_20 then
				local var_520_21 = (arg_517_1.time_ - var_520_19) / var_520_20
				local var_520_22 = Color.New(1, 1, 1)

				var_520_22.a = Mathf.Lerp(1, 0, var_520_21)
				arg_517_1.mask_.color = var_520_22
			end

			if arg_517_1.time_ >= var_520_19 + var_520_20 and arg_517_1.time_ < var_520_19 + var_520_20 + arg_520_0 then
				local var_520_23 = Color.New(1, 1, 1)
				local var_520_24 = 0

				arg_517_1.mask_.enabled = false
				var_520_23.a = var_520_24
				arg_517_1.mask_.color = var_520_23
			end

			local var_520_25 = "XH0505"

			if arg_517_1.bgs_[var_520_25] == nil then
				local var_520_26 = Object.Instantiate(arg_517_1.paintGo_)

				var_520_26:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. var_520_25)
				var_520_26.name = var_520_25
				var_520_26.transform.parent = arg_517_1.stage_.transform
				var_520_26.transform.localPosition = Vector3.New(0, 100, 0)
				arg_517_1.bgs_[var_520_25] = var_520_26
			end

			local var_520_27 = 0

			if var_520_27 < arg_517_1.time_ and arg_517_1.time_ <= var_520_27 + arg_520_0 then
				local var_520_28 = manager.ui.mainCamera.transform.localPosition
				local var_520_29 = Vector3.New(0, 0, 10) + Vector3.New(var_520_28.x, var_520_28.y, 0)
				local var_520_30 = arg_517_1.bgs_.XH0505

				var_520_30.transform.localPosition = var_520_29
				var_520_30.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_520_31 = var_520_30:GetComponent("SpriteRenderer")

				if var_520_31 and var_520_31.sprite then
					local var_520_32 = (var_520_30.transform.localPosition - var_520_28).z
					local var_520_33 = manager.ui.mainCameraCom_
					local var_520_34 = 2 * var_520_32 * Mathf.Tan(var_520_33.fieldOfView * 0.5 * Mathf.Deg2Rad)
					local var_520_35 = var_520_34 * var_520_33.aspect
					local var_520_36 = var_520_31.sprite.bounds.size.x
					local var_520_37 = var_520_31.sprite.bounds.size.y
					local var_520_38 = var_520_35 / var_520_36
					local var_520_39 = var_520_34 / var_520_37
					local var_520_40 = var_520_39 < var_520_38 and var_520_38 or var_520_39

					var_520_30.transform.localScale = Vector3.New(var_520_40, var_520_40, 0)
				end
	...
	Play122541133 = function(arg_547_0, arg_547_1)
		...
		function arg_547_1.onSingleLineUpdate_(arg_550_0)
			...
			if var_550_39 < arg_547_1.time_ and arg_547_1.time_ <= var_550_39 + arg_550_0 then
				...
				if var_550_40 then
					arg_547_1.var_.alphaOldValueXH0607 = var_550_40.color.a
					arg_547_1.var_.alphaMatValueXH0607 = var_550_40
				end
			...
			if var_550_39 <= arg_547_1.time_ and arg_547_1.time_ < var_550_39 + var_550_41 then
				local var_550_42 = (arg_547_1.time_ - var_550_39) / var_550_41
				local var_550_43 = Mathf.Lerp(arg_547_1.var_.alphaOldValueXH0607, 0, var_550_42)

				if arg_547_1.var_.alphaMatValueXH0607 then
					local var_550_44 = arg_547_1.var_.alphaMatValueXH0607.color

					var_550_44.a = var_550_43
					arg_547_1.var_.alphaMatValueXH0607.color = var_550_44
				end
			end

			if arg_547_1.time_ >= var_550_39 + var_550_41 and arg_547_1.time_ < var_550_39 + var_550_41 + arg_550_0 and arg_547_1.var_.alphaMatValueXH0607 then
				local var_550_45 = arg_547_1.var_.alphaMatValueXH0607
				local var_550_46 = var_550_45.color

				var_550_46.a = 0
				var_550_45.color = var_550_46
			end
			...
			if var_550_47 < arg_547_1.time_ and arg_547_1.time_ <= var_550_47 + arg_550_0 then
				local var_550_49 = "play"
				local var_550_50 = "effect"

				arg_547_1:AudioAction(var_550_49, var_550_50, "se_story_122_03", "se_story_122_03_bubble", "")
			end
			...
			if var_550_51 < arg_547_1.time_ and arg_547_1.time_ <= var_550_51 + arg_550_0 then
				local var_550_53 = "play"
				local var_550_54 = "music"

				arg_547_1:AudioAction(var_550_53, var_550_54, "ui_battle", "ui_battle_stopbgm", "")

				local var_550_55 = ""
				local var_550_56 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if var_550_56 ~= "" then
					if arg_547_1.bgmTxt_.text ~= var_550_56 and arg_547_1.bgmTxt_.text ~= "" then
						if arg_547_1.bgmTxt2_.text ~= "" then
							arg_547_1.bgmTxt_.text = arg_547_1.bgmTxt2_.text
						end

						arg_547_1.bgmTxt2_.text = var_550_56

						arg_547_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_547_1.bgmTxt_.text = var_550_56
						arg_547_1.bgmTxt2_.text = var_550_56
					end
