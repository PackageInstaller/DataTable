return {
	Play910103001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 910103001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_22] == nil then
				local var_4_23 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1029")
			...
			local var_4_26 = arg_1_1.actors_["1029"].transform
			local var_4_27 = 0.7

			if var_4_27 < arg_1_1.time_ and arg_1_1.time_ <= var_4_27 + arg_4_0 then
				arg_1_1.var_.moveOldPos1029 = var_4_26.localPosition
				var_4_26.localScale = Vector3.New(1, 1, 1)

				arg_1_1:CheckSpriteTmpPos("1029", 3)
			...
			if var_4_27 <= arg_1_1.time_ and arg_1_1.time_ < var_4_27 + var_4_30 then
				...
				var_4_26.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1029, var_4_32, var_4_31)
			end
			...
			local var_4_33 = arg_1_1.actors_["1029"]
			local var_4_34 = 0.7
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				if var_4_35 then
					arg_1_1.var_.alphaOldValue1029 = var_4_35.alpha
					arg_1_1.var_.characterEffect1029 = var_4_35
				end

				arg_1_1.var_.alphaOldValue1029 = 0
			end
			...
			if var_4_34 <= arg_1_1.time_ and arg_1_1.time_ < var_4_34 + var_4_36 then
				...
				local var_4_38 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1029, 1, var_4_37)

				if arg_1_1.var_.characterEffect1029 then
					arg_1_1.var_.characterEffect1029.alpha = var_4_38
				end
			end

			if arg_1_1.time_ >= var_4_34 + var_4_36 and arg_1_1.time_ < var_4_34 + var_4_36 + arg_4_0 and arg_1_1.var_.characterEffect1029 then
				arg_1_1.var_.characterEffect1029.alpha = 1
			end
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				local var_4_42 = arg_1_1:FormatText(StoryNameCfg[319].name)
				...
				local var_4_43 = arg_1_1:GetWordFromCfg(910103001)
	...
	Play910103002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 910103002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_2 = arg_7_1:FormatText(StoryNameCfg[319].name)
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(910103002)
	...
	Play910103003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 910103003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play910103004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_0 + arg_14_0 then
				...
				local var_14_3 = arg_11_1:GetWordFromCfg(910103003)
	...
	Play910103004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 910103004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play910103005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_1 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 then
				...
				arg_15_1:CheckSpriteTmpPos("1029", 3)
			...
			if var_18_7 < arg_15_1.time_ and arg_15_1.time_ <= var_18_7 + arg_18_0 then
				...
				local var_18_9 = arg_15_1:FormatText(StoryNameCfg[319].name)
				...
				local var_18_10 = arg_15_1:GetWordFromCfg(910103004)
	...
	Play910103005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 910103005
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_0 + arg_22_0 then
				...
				local var_22_3 = arg_19_1:GetWordFromCfg(910103005)
