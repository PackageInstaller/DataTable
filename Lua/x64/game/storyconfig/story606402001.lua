	...
	Play606402001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_0] == nil then
				...
				var_4_2.sprite = getSpriteWithoutAtlas("TextureConfig/WeaponServant/Portrait/" .. "2390001")
			...
			local var_4_8 = 0
			local var_4_9 = 0.466666666666667
			...
			if var_4_8 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:GetWordFromCfg(606402001)
	...
	Play606402002 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if var_8_0 < arg_5_1.time_ and arg_5_1.time_ <= var_8_0 + arg_8_0 then
				...
				local var_8_3 = arg_5_1:GetWordFromCfg(606402002)
	...
	Play606402003 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				...
				local var_12_2 = arg_9_1:FormatText(StoryNameCfg[418].name)
				...
				local var_12_3 = arg_9_1:GetWordFromCfg(606402003)
