	...
	Play111101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_17 < arg_1_1.time_ and arg_1_1.time_ <= var_4_17 + arg_4_0 then
				...
				if var_4_18 then
					arg_1_1.var_.alphaOldValueS0404 = var_4_18.color.a
					arg_1_1.var_.alphaMatValueS0404 = var_4_18
				end
			...
			if var_4_17 <= arg_1_1.time_ and arg_1_1.time_ < var_4_17 + var_4_19 then
				...
				local var_4_21 = Mathf.Lerp(arg_1_1.var_.alphaOldValueS0404, 1, var_4_20)

				if arg_1_1.var_.alphaMatValueS0404 then
					local var_4_22 = arg_1_1.var_.alphaMatValueS0404.color

					var_4_22.a = var_4_21
					arg_1_1.var_.alphaMatValueS0404.color = var_4_22
				end
			end

			if arg_1_1.time_ >= var_4_17 + var_4_19 and arg_1_1.time_ < var_4_17 + var_4_19 + arg_4_0 and arg_1_1.var_.alphaMatValueS0404 then
				local var_4_23 = arg_1_1.var_.alphaMatValueS0404
			...
			if var_4_43 < arg_1_1.time_ and arg_1_1.time_ <= var_4_43 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_45, var_4_46, "se_story_activity_1_1", "se_story_activity_1_1_firecrowdloop", "")
			end
			...
			if var_4_47 < arg_1_1.time_ and arg_1_1.time_ <= var_4_47 + arg_4_0 then
				...
				local var_4_50 = arg_1_1:GetWordFromCfg(111101001)
	...
	Play111101004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_7 < arg_17_1.time_ and arg_17_1.time_ <= var_20_7 + arg_20_0 then
				...
				local var_20_9
				local var_20_10 = var_20_6

				if not var_20_8 then
					var_20_8 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_slash_01"), var_20_10)
					var_20_8.name = "555"
					arg_17_1.var_.effect555 = var_20_8
				else
					var_20_8.transform:SetParent(var_20_10)
				end
			...
			if var_20_11 < arg_17_1.time_ and arg_17_1.time_ <= var_20_11 + arg_20_0 then
				local var_20_13 = "play"
				local var_20_14 = "effect"

				arg_17_1:AudioAction(var_20_13, var_20_14, "se_story", "se_story_fight_metal", "")
			end
			...
			if var_20_15 < arg_17_1.time_ and arg_17_1.time_ <= var_20_15 + arg_20_0 then
				...
				local var_20_17 = arg_17_1:GetWordFromCfg(111101004)
	...
	Play111101005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_37 < arg_21_1.time_ and arg_21_1.time_ <= var_24_37 + arg_24_0 then
				...
				if var_24_38 then
					arg_21_1.var_.alphaOldValueS0404 = var_24_38.color.a
					arg_21_1.var_.alphaMatValueS0404 = var_24_38
				end
			...
			if var_24_37 <= arg_21_1.time_ and arg_21_1.time_ < var_24_37 + var_24_39 then
				local var_24_40 = (arg_21_1.time_ - var_24_37) / var_24_39
				local var_24_41 = Mathf.Lerp(arg_21_1.var_.alphaOldValueS0404, 0, var_24_40)

				if arg_21_1.var_.alphaMatValueS0404 then
					local var_24_42 = arg_21_1.var_.alphaMatValueS0404.color

					var_24_42.a = var_24_41
					arg_21_1.var_.alphaMatValueS0404.color = var_24_42
				end
			end

			if arg_21_1.time_ >= var_24_37 + var_24_39 and arg_21_1.time_ < var_24_37 + var_24_39 + arg_24_0 and arg_21_1.var_.alphaMatValueS0404 then
				local var_24_43 = arg_21_1.var_.alphaMatValueS0404
				local var_24_44 = var_24_43.color

				var_24_44.a = 0
				var_24_43.color = var_24_44
			end

			local var_24_45 = arg_21_1.bgs_.D06a
			local var_24_46 = 1

			if var_24_46 < arg_21_1.time_ and arg_21_1.time_ <= var_24_46 + arg_24_0 then
				local var_24_47 = var_24_45:GetComponent("SpriteRenderer")

				if var_24_47 then
					arg_21_1.var_.alphaOldValueD06a = var_24_47.color.a
					arg_21_1.var_.alphaMatValueD06a = var_24_47
				end
			...
			if var_24_46 <= arg_21_1.time_ and arg_21_1.time_ < var_24_46 + var_24_48 then
				local var_24_49 = (arg_21_1.time_ - var_24_46) / var_24_48
				local var_24_50 = Mathf.Lerp(arg_21_1.var_.alphaOldValueD06a, 1, var_24_49)

				if arg_21_1.var_.alphaMatValueD06a then
					local var_24_51 = arg_21_1.var_.alphaMatValueD06a.color

					var_24_51.a = var_24_50
					arg_21_1.var_.alphaMatValueD06a.color = var_24_51
				end
			end

			if arg_21_1.time_ >= var_24_46 + var_24_48 and arg_21_1.time_ < var_24_46 + var_24_48 + arg_24_0 and arg_21_1.var_.alphaMatValueD06a then
				local var_24_52 = arg_21_1.var_.alphaMatValueD06a
				local var_24_53 = var_24_52.color

				var_24_53.a = 1
				var_24_52.color = var_24_53
			end

			local var_24_54 = 2
			local var_24_55 = 0.875
			...
			if var_24_54 < arg_21_1.time_ and arg_21_1.time_ <= var_24_54 + arg_24_0 then
				...
				local var_24_56 = arg_21_1:FormatText(StoryNameCfg[6].name)

				arg_21_1.leftNameTxt_.text = var_24_56
				...
				local var_24_57 = arg_21_1:GetWordFromCfg(111101005)
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101005", "story_v_out_111101.awb") ~= 0 then
					local var_24_62 = manager.audio:GetVoiceLength("story_v_out_111101", "111101005", "story_v_out_111101.awb") / 1000

					if var_24_62 + var_24_54 > arg_21_1.duration_ then
						arg_21_1.duration_ = var_24_62 + var_24_54
					end

					if var_24_57.prefab_name ~= "" and arg_21_1.actors_[var_24_57.prefab_name] ~= nil then
						local var_24_63 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_57.prefab_name].transform, "story_v_out_111101", "111101005", "story_v_out_111101.awb")

						arg_21_1:RecordAudio("111101005", var_24_63)
						arg_21_1:RecordAudio("111101005", var_24_63)
					else
			...
			if var_24_54 <= arg_21_1.time_ and arg_21_1.time_ < var_24_54 + var_24_64 then
				arg_21_1.typewritter.percent = (arg_21_1.time_ - var_24_54) / var_24_64

				arg_21_1.typewritter:SetDirty()
			end

			if arg_21_1.time_ >= var_24_54 + var_24_64 and arg_21_1.time_ < var_24_54 + var_24_64 + arg_24_0 then
