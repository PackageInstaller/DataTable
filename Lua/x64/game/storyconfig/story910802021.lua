return {
	Play910811001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_22] == nil then
				local var_4_23 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1070")
			...
			local var_4_26 = arg_1_1.actors_["1070"].transform
			local var_4_27 = 1.8

			if var_4_27 < arg_1_1.time_ and arg_1_1.time_ <= var_4_27 + arg_4_0 then
				arg_1_1.var_.moveOldPos1070 = var_4_26.localPosition
			...
			if var_4_27 <= arg_1_1.time_ and arg_1_1.time_ < var_4_27 + var_4_30 then
				...
				var_4_26.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1070, var_4_32, var_4_31)
			end
			...
			local var_4_33 = arg_1_1.actors_["1070"]
			local var_4_34 = 1.8

			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 and not isNil(var_4_33) and arg_1_1.var_.actorSpriteComps1070 == nil then
				arg_1_1.var_.actorSpriteComps1070 = var_4_33:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_1_1.time_ >= var_4_34 + var_4_35 and arg_1_1.time_ < var_4_34 + var_4_35 + arg_4_0 and not isNil(var_4_33) and arg_1_1.var_.actorSpriteComps1070 then
			...
			if var_4_45 < arg_1_1.time_ and arg_1_1.time_ <= var_4_45 + arg_4_0 then
				...
				local var_4_49 = arg_1_1:GetWordFromCfg(910811001)
	...
	Play910811002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			local var_10_0 = arg_7_1.actors_["1070"].transform
			local var_10_1 = 0

			if var_10_1 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				arg_7_1.var_.moveOldPos1070 = var_10_0.localPosition
			...
			if var_10_1 <= arg_7_1.time_ and arg_7_1.time_ < var_10_1 + var_10_4 then
				...
				var_10_0.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos1070, var_10_6, var_10_5)
			end
			...
			local var_10_7 = arg_7_1.actors_["1070"]
			local var_10_8 = 0

			if var_10_8 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 and not isNil(var_10_7) and arg_7_1.var_.actorSpriteComps1070 == nil then
				arg_7_1.var_.actorSpriteComps1070 = var_10_7:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_7_1.time_ >= var_10_8 + var_10_9 and arg_7_1.time_ < var_10_8 + var_10_9 + arg_10_0 and not isNil(var_10_7) and arg_7_1.var_.actorSpriteComps1070 then
			...
			if var_10_15 < arg_7_1.time_ and arg_7_1.time_ <= var_10_15 + arg_10_0 then
				...
				local var_10_17 = arg_7_1:FormatText(StoryNameCfg[318].name)
				...
				local var_10_18 = arg_7_1:GetWordFromCfg(910811002)
	...
	Play910811003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				local var_14_17 = arg_11_1:FormatText(StoryNameCfg[623].name)
				...
				local var_14_18 = arg_11_1:GetWordFromCfg(910811003)
	...
	Play910811004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_15 < arg_15_1.time_ and arg_15_1.time_ <= var_18_15 + arg_18_0 then
				...
				local var_18_18 = arg_15_1:GetWordFromCfg(910811004)
	...
	Play910811005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_15 < arg_19_1.time_ and arg_19_1.time_ <= var_22_15 + arg_22_0 then
				...
				local var_22_17 = arg_19_1:FormatText(StoryNameCfg[318].name)
				...
				local var_22_18 = arg_19_1:GetWordFromCfg(910811005)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_1 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				...
				for iter_26_0 = 0, var_26_2 - 1 do
					...
					if var_26_3.name == "split_1_1" or not string.find(var_26_3.name, "split") then
					...
					for iter_26_1, iter_26_2 in pairs(arg_23_1.var_.actorSpriteComps1070:ToTable()) do
						if iter_26_2 then
							if arg_23_1.isInRecall_ then
								local var_26_11 = Mathf.Lerp(iter_26_2.color.r, arg_23_1.hightColor2.r, var_26_10)
								local var_26_12 = Mathf.Lerp(iter_26_2.color.g, arg_23_1.hightColor2.g, var_26_10)
								local var_26_13 = Mathf.Lerp(iter_26_2.color.b, arg_23_1.hightColor2.b, var_26_10)

								iter_26_2.color = Color.New(var_26_11, var_26_12, var_26_13)
							else
								local var_26_14 = Mathf.Lerp(iter_26_2.color.r, 0.5, var_26_10)
			...
			if arg_23_1.time_ >= var_26_8 + var_26_9 and arg_23_1.time_ < var_26_8 + var_26_9 + arg_26_0 and not isNil(var_26_7) and arg_23_1.var_.actorSpriteComps1070 then
				for iter_26_3, iter_26_4 in pairs(arg_23_1.var_.actorSpriteComps1070:ToTable()) do
					if iter_26_4 then
						if arg_23_1.isInRecall_ then
							iter_26_4.color = arg_23_1.hightColor2 or Color.New(0.46, 0.43, 0.35)
						else
							iter_26_4.color = Color.New(0.5, 0.5, 0.5)
						end
					end
				end
			...
			if var_26_15 < arg_23_1.time_ and arg_23_1.time_ <= var_26_15 + arg_26_0 then
				...
				local var_26_18 = arg_23_1:GetWordFromCfg(910811006)
	...
	Play910811007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_15 < arg_27_1.time_ and arg_27_1.time_ <= var_30_15 + arg_30_0 then
				...
				local var_30_18 = arg_27_1:GetWordFromCfg(910811007)
	...
	Play910811008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_15 < arg_31_1.time_ and arg_31_1.time_ <= var_34_15 + arg_34_0 then
				...
				local var_34_18 = arg_31_1:GetWordFromCfg(910811008)
	...
	Play910811009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_15 < arg_35_1.time_ and arg_35_1.time_ <= var_38_15 + arg_38_0 then
				...
				local var_38_17 = arg_35_1:FormatText(StoryNameCfg[318].name)
				...
				local var_38_18 = arg_35_1:GetWordFromCfg(910811009)
	...
	Play910811010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_15 < arg_39_1.time_ and arg_39_1.time_ <= var_42_15 + arg_42_0 then
				...
				local var_42_17 = arg_39_1:GetWordFromCfg(910811010)
	...
	Play910811011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_15 < arg_43_1.time_ and arg_43_1.time_ <= var_46_15 + arg_46_0 then
				...
				local var_46_17 = arg_43_1:FormatText(StoryNameCfg[318].name)
				...
				local var_46_18 = arg_43_1:GetWordFromCfg(910811011)
	...
	Play910811012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_15 < arg_47_1.time_ and arg_47_1.time_ <= var_50_15 + arg_50_0 then
				...
				local var_50_17 = arg_47_1:GetWordFromCfg(910811012)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if var_54_1 < arg_51_1.time_ and arg_51_1.time_ <= var_54_1 + arg_54_0 then
				...
				for iter_54_0 = 0, var_54_2 - 1 do
					...
					if var_54_3.name == "split_7" or not string.find(var_54_3.name, "split") then
			...
			if var_54_15 < arg_51_1.time_ and arg_51_1.time_ <= var_54_15 + arg_54_0 then
				...
				local var_54_18 = arg_51_1:GetWordFromCfg(910811013)
	...
	Play910811014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if var_58_15 < arg_55_1.time_ and arg_55_1.time_ <= var_58_15 + arg_58_0 then
				...
				local var_58_17 = arg_55_1:FormatText(StoryNameCfg[318].name)
				...
				local var_58_18 = arg_55_1:GetWordFromCfg(910811014)
	...
	Play910811015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if var_62_15 < arg_59_1.time_ and arg_59_1.time_ <= var_62_15 + arg_62_0 then
				...
				local var_62_18 = arg_59_1:GetWordFromCfg(910811015)
	...
	Play910811016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if var_66_15 < arg_63_1.time_ and arg_63_1.time_ <= var_66_15 + arg_66_0 then
				...
				local var_66_17 = arg_63_1:FormatText(StoryNameCfg[318].name)
				...
				local var_66_18 = arg_63_1:GetWordFromCfg(910811016)
	...
	Play910811017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if var_70_15 < arg_67_1.time_ and arg_67_1.time_ <= var_70_15 + arg_70_0 then
				...
				local var_70_18 = arg_67_1:GetWordFromCfg(910811017)
	...
	Play910811018 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if var_74_15 < arg_71_1.time_ and arg_71_1.time_ <= var_74_15 + arg_74_0 then
				...
				local var_74_18 = arg_71_1:GetWordFromCfg(910811018)
	...
	Play910811019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			...
			if var_78_15 < arg_75_1.time_ and arg_75_1.time_ <= var_78_15 + arg_78_0 then
				...
				local var_78_18 = arg_75_1:GetWordFromCfg(910811019)
	...
	Play910811020 = function(arg_79_0, arg_79_1)
		...
		function arg_79_1.onSingleLineUpdate_(arg_82_0)
			...
			if var_82_1 < arg_79_1.time_ and arg_79_1.time_ <= var_82_1 + arg_82_0 and not isNil(var_82_0) and arg_79_1.var_.actorSpriteComps1070 == nil then
			...
			if arg_79_1.time_ >= var_82_1 + var_82_2 and arg_79_1.time_ < var_82_1 + var_82_2 + arg_82_0 and not isNil(var_82_0) and arg_79_1.var_.actorSpriteComps1070 then
			...
			if var_82_8 < arg_79_1.time_ and arg_79_1.time_ <= var_82_8 + arg_82_0 then
				...
				local var_82_10 = arg_79_1:GetWordFromCfg(910811020)
	...
	Play910811021 = function(arg_83_0, arg_83_1)
		...
		function arg_83_1.onSingleLineUpdate_(arg_86_0)
			...
			if var_86_1 < arg_83_1.time_ and arg_83_1.time_ <= var_86_1 + arg_86_0 and not isNil(var_86_0) and arg_83_1.var_.actorSpriteComps1070 == nil then
			...
			if arg_83_1.time_ >= var_86_1 + var_86_2 and arg_83_1.time_ < var_86_1 + var_86_2 + arg_86_0 and not isNil(var_86_0) and arg_83_1.var_.actorSpriteComps1070 then
			...
			if var_86_8 < arg_83_1.time_ and arg_83_1.time_ <= var_86_8 + arg_86_0 then
				local var_86_10 = "play"
				local var_86_11 = "effect"

				arg_83_1:AudioAction(var_86_10, var_86_11, "ui_skip", "ui_bgm_lower_back", "")
			end

			local var_86_12 = 0
			local var_86_13 = 0.55
			...
			if var_86_12 < arg_83_1.time_ and arg_83_1.time_ <= var_86_12 + arg_86_0 then
				...
				local var_86_15 = arg_83_1:GetWordFromCfg(910811021)
