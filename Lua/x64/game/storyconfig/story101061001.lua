	...
	Play106101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_33 < arg_1_1.time_ and arg_1_1.time_ <= var_4_33 + arg_4_0 then
				...
				local var_4_36 = arg_1_1:FormatText(StoryNameCfg[90].name)
				...
				local var_4_37 = arg_1_1:GetWordFromCfg(106101001)
				...
				if manager.audio:GetVoiceLength("story_v_out_106101", "106101001", "story_v_out_106101.awb") ~= 0 then
					local var_4_42 = manager.audio:GetVoiceLength("story_v_out_106101", "106101001", "story_v_out_106101.awb") / 1000
					...
					if var_4_37.prefab_name ~= "" and arg_1_1.actors_[var_4_37.prefab_name] ~= nil then
						local var_4_43 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_37.prefab_name].transform, "story_v_out_106101", "106101001", "story_v_out_106101.awb")

						arg_1_1:RecordAudio("106101001", var_4_43)
						arg_1_1:RecordAudio("106101001", var_4_43)
					else
