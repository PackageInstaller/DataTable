	...
	Play711480101 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_23 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				...
				local var_4_26 = arg_1_1:GetWordFromCfg(711480101)
	...
	Play711480102 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if var_8_0 < arg_5_1.time_ and arg_5_1.time_ <= var_8_0 + arg_8_0 then
				...
				local var_8_3 = arg_5_1:GetWordFromCfg(711480102)
	...
	Play711480103 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:GetWordFromCfg(711480103)
	...
	Play711480104 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_0 + arg_16_0 then
				...
				local var_16_3 = arg_13_1:GetWordFromCfg(711480104)
	...
	Play711480105 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_0 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:GetWordFromCfg(711480105)
	...
	Play711480106 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:GetWordFromCfg(711480106)
	...
	Play711480107 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_7 = arg_25_1:GetWordFromCfg(711480107)
	...
	Play711480108 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_0 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:GetWordFromCfg(711480108)
	...
	Play711480109 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_0 + arg_36_0 then
				...
				local var_36_3 = arg_33_0.narr_item_head

				SetActive(var_36_3.transform.parent.gameObject, false)

				local var_36_4 = var_36_1.transform:Find("container/a")
				local var_36_5 = var_36_1.transform:Find("container/b")
				local var_36_6 = var_36_1.transform:Find("container/text")

				if var_36_4 and var_36_5 and var_36_6 then
					SetActive(var_36_4.gameObject, false)
					SetActive(var_36_5.gameObject, false)
					SetActive(var_36_6.gameObject, false)
				end

				local var_36_7 = arg_33_1:GetWordFromCfg(711480109)
				local var_36_8 = arg_33_1:FormatText(var_36_7.content)

				arg_33_0.narr_item_content.text = var_36_8
			...
			if var_36_0 <= arg_33_1.time_ and arg_33_1.time_ < var_36_0 + var_36_9 and arg_33_1.narrativeListGo_.verticalNormalizedPosition >= 0.001 then
	...
	Play711480110 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_0 + arg_40_0 then
				...
				local var_40_3 = arg_37_1:GetWordFromCfg(711480110)
	...
	Play711480111 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_0 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:GetWordFromCfg(711480111)
	...
	Play711480112 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_0 + arg_48_0 then
				...
				local var_48_3 = arg_45_1:GetWordFromCfg(711480112)
	...
	Play711480113 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_0 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:GetWordFromCfg(711480113)
	...
	Play711480114 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_0 + arg_56_0 then
				...
				local var_56_3 = arg_53_1:GetWordFromCfg(711480114)
	...
	Play711480115 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_0 + arg_60_0 then
				...
				local var_60_3 = arg_57_1:GetWordFromCfg(711480115)
	...
	Play711480116 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_0 + arg_64_0 then
				...
				local var_64_3 = arg_61_1:GetWordFromCfg(711480116)
	...
	Play711480117 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_0 + arg_68_0 then
				...
				local var_68_3 = arg_65_1:GetWordFromCfg(711480117)
	...
	Play711480118 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_0 + arg_72_0 then
				...
				local var_72_3 = arg_69_1:GetWordFromCfg(711480118)
	...
	Play711480119 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if var_76_0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_0 + arg_76_0 then
				...
				local var_76_3 = arg_73_1:GetWordFromCfg(711480119)
	...
	Play711480120 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if var_80_0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_0 + arg_80_0 then
				...
				local var_80_3 = arg_77_1:GetWordFromCfg(711480120)
	...
	Play711480121 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if var_84_0 < arg_81_1.time_ and arg_81_1.time_ <= var_84_0 + arg_84_0 then
				...
				local var_84_3 = arg_81_1:GetWordFromCfg(711480121)
			...
			local var_84_7 = 0.0334

			if var_84_6 <= arg_81_1.time_ and arg_81_1.time_ < var_84_6 + var_84_7 and arg_81_1.narrativeListGo_.verticalNormalizedPosition >= 0.001 then
				arg_81_1.narrativeListGo_.verticalNormalizedPosition = 0
			end
			...
			if arg_81_1.time_ >= var_84_6 + var_84_7 and arg_81_1.time_ < var_84_6 + var_84_7 + arg_84_0 then
				...
				local var_84_8 = arg_81_1.narrativeListGo_:GetComponent(typeof(Image))

				if var_84_8 then
					var_84_8.raycastTarget = true
				end
