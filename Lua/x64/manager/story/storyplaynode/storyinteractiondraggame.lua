...
local var_0_1 = class("StoryInteractionDragGame", var_0_0)

function var_0_1.NewWithGameObject(arg_1_0, arg_1_1)
	local var_1_0 = StoryInteractionDragGame.New(arg_1_0)
...
function var_0_1.Ctor(arg_2_0, arg_2_1, arg_2_2)
	...
	if arg_2_2 ~= nil then
		...
		arg_2_0.gameObject_.name = "drag_panel"
	...
	function arg_2_0.onSliderValueChanged()
		arg_2_0:OnSliderValueChanged()
	end
end
...
function var_0_1.AddListener(arg_7_0)
	if arg_7_0.params_.isNeedInteraction then
		arg_7_0[arg_7_0.params_.uiSliderName].onValueChanged:RemoveListener(arg_7_0.onSliderValueChanged)
		arg_7_0[arg_7_0.params_.uiSliderName].onValueChanged:AddListener(arg_7_0.onSliderValueChanged)
	end
end

function var_0_1.OnSliderValueChanged(arg_8_0)
	if arg_8_0.gameStatus_ ~= "play" then
		return
	end

	if math.floor(arg_8_0[arg_8_0.params_.uiSliderName].value + 1e-05) >= 0.96 then
		arg_8_0:EndGame()
	end
end
...
function var_0_1.StartGame(arg_9_0)
	...
	arg_9_0[arg_9_0.params_.uiSliderName].value = 0
