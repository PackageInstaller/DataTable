...
SFX_EXPLOSIVE_SKIN = "event:/ui/baoyi1"
SFX_ANTI_EXPLOSIVE_SKIN = "event:/ui/baoyi2"
PIXEL_PER_UNIT = 100
WHITE_DOT_SIZE = 4
ITEM_ID_CUBE = 20001
...
DROP_TYPE_DORM3D_FURNITURE = 26
DROP_TYPE_DORM3D_GIFT = 27
DROP_TYPE_DORM3D_SKIN = 28
DROP_TYPE_LIVINGAREA_COVER = 29
DROP_TYPE_COMBAT_UI_STYLE = 31
DROP_TYPE_ACTIVITY_MEDAL = 33
DROP_TYPE_ISLAND_ITEM = 41
DROP_TYPE_ISLAND_OVERFLOWITEM = 42
DROP_TYPE_ISLAND_ABILITY = 43
DROP_TYPE_ISLAND_INVITATION = 44
DROP_TYPE_ISLAND_FURNITURE = 45
DROP_TYPE_ISLAND_DRESS = 46
DROP_TYPE_ISLAND_SKIN = 47
DROP_TYPE_ISLAND_COLLECTION_FRAMENT = 48
DROP_TYPE_ISLAND_COLLECTION = 49
DROP_TYPE_ISLAND_SPEEDUP_TICKET = 50
DROP_TYPE_ISLAND_ACTION = 51
DROP_TYPE_ISLAND_CARD_DIY = 52
DROP_TYPE_TIMESTAMP = 99
DROP_TYPE_TRANS_ITEM = 100
DROP_TYPE_ISLAND_TRANS_ITEM = 101
DROP_TYPE_USE_ACTIVITY_DROP = 1000
DROP_TYPE_RYZA_DROP = 1001
DROP_TYPE_WORKBENCH_DROP = 1002
DROP_TYPE_FEAST_DROP = 1003
DROP_TYPE_HOLIDAY_VILLA = 1005
...
TASK_SUB_STROY = 1005
TASK_SUB_TYPE_VITEM = 1006
TASK_SUB_TYPE_VITEMS = 1007
...
TASK_SUB_TYPE_JOIN_GUILD = 403
TASK_SUB_TYPE_COLLAB_BOSS_RUSH_DEFEAT = 426
TASK_SUB_TYPE_REPEATABLE = 3007
TASK_SUB_TYPE_COMPLETE_ALL_DAILY_TASKS = 2030
TASK_SUB_TYPE_CLIENT_TRIGGER = 2027
SYSTEM_SCENARIO = 1
SYSTEM_ROUTINE = 2
SYSTEM_DUEL = 3
SYSTEM_SHAM = 4
...
SYSTEM_ACT_BOSS_SP = 15
SYSTEM_BOSS_SINGLE = 16
SYSTEM_BOSS_SINGLE_VARIABLE = 17
SYSTEM_BOSS_RUSH_COLLABRATE = 18
SYSTEM_SCENARIO_SUB_STRIKE = 19
SYSTEM_CARDPUZZLE = 30
SYSTEM_WORLD_BOSS = 50
SYSTEM_WORLD = 51
SYSTEM_WORLD_BOSS_SIMULATE = 5000
SYSTEM_PROLOGUE = 0
SYSTEM_DODGEM = 98
...
SINGLE_MAIL_REQUIRE_SIZE = 100
MAIL_COUNT_LIMIT = 100
SLIP_TYPE_HRZ = 1
SLIP_TYPE_VERT = 2
REFRESH_BILLBOARD_TIME = 0
PLATFORM_BILIBILI = "bilibili"
PLATFORM_TXWY = "txwykr"
PLATFORM_YOSTARJP = "yostarjp"
PLATFORM_YOSTARUS = "yostarus"
MAX_FRIEND_COUNT = 50
...
LIVE2D_STATUS_SAVE = "LIVE2D_STATUS_SAVE"
MAINUI_NEVER_SLEEP = "MAINUI_NEVER_SLEEP"
MAINUI_RESET_L2D = "MAINUI_RESET_L2D"
ISLAND_NOTIFYCATION = "ISLAND_NOTIFYCATION"
REMOVE_LOW_MOOD = "REMOVE_LOW_MOOD"
...
LOCK_WORLDBOSS_ARCHIVES = false
LOCK_CRYPTOLALIA = false
LOCK_ANDROID_EXACT_ALARM = false
...
GAMEUI_BANNER_15 = 15
GAMEUI_BANNER_16 = 16
FlAG_SHIP_DISPLAY_ONLY_SHIP = 1
FlAG_SHIP_DISPLAY_ONLY_EDUCATECHAR = 2
FlAG_SHIP_DISPLAY_ALL = 3
...
L2D_RANDOM_PARAM = 60
LOCK_QUOTA_SHOP = false
LOCK_MINIGAME_HALL = false
LOCK_META_SKILL_QUICK = false
LOCK_EDUCATE_SYSTEM = false
LOCK_NEW_EDUCATE_SYSTEM = false
USE_OLD_MAIN_LIVE_AREA_UI = false
LOCK_EQUIP_REVERT = false
OPEN_EXCEPTION_TEST = true
LOCK_NAMED = false
MailWaterSelect = false
LOCK_DORM3D_SYSTEM = false
LOCK_DORM3D_AR = false
BLOCK_DORM3D_ROOMS = {}
OPEN_EXCEPTION_TEST = false
DORM_LOCK_NAMED = false
DORM_LOCK_INS_PHONE = false
DORM_LOCK_INS = false
DORM_LOCK_SELECT_NEW = false
DORM_LOCK_GUIDE = false
LOCK_3DDORM_RES_DOWNLOAD_BTN = false
LOCK_ALBUM = false
LOCK_SKIN_SHOP_ENTER = false
LOCK_SKIN_SHOP_ENTER_LEVEL = 15
LOCK_NATION_HNLMS = false
LOCK_SKIN_US = false
LOADING_HX = false
LOGIN_HX = false
ISLAND_PLAYER_TESTING = false
LOCK_ISLAND_GUIDE = false
LOCK_ISLAND_DISPLAY = false
LOCK_ISLAND_ENTER_TIP_WINDOW = true
LOCK_SHOP_BANNER_US = false
LOCK_SHIP_GIFT = false
