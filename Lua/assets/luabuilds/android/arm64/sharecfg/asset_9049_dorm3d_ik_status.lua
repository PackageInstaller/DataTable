...
;(function()
	...
	pg.base.dorm3d_ik_status[120810] = {
		...
		enter_extra_item = {
			{
				"furniture/Item/Cafe_Pillow/pre_db_cafe_pillow",
				"",
				{
					0,
					0,
	...
	pg.base.dorm3d_ik_status[200310] = {
		...
		enter_extra_item = {
			{
				"furniture/prefabs/Pay_Noshirohostel/pre_db_nh_sushi01",
				"Bip001 R Hand",
				{
					-0.079,
					0.0442,
	...
	pg.base.dorm3d_ik_status[215110] = {
		...
		enter_extra_item = {
			{
				"furniture/prefabs/Pay_Noshirohostel/pre_db_nh_watergun01",
				"Bip001 R Hand",
				{
					-0.092,
					0.0157,
	...
	pg.base.dorm3d_ik_status[299991] = {
		...
		enter_extra_item = {
			{
				"furniture/Item/Book_01/pre_db_book_01_ik299991",
				"",
				{
					0,
					0,
	...
	pg.base.dorm3d_ik_status[299992] = {
		...
		enter_extra_item = {
			{
				"furniture/Item/Book_01/pre_db_book_01_ik299992",
				"Bip001 R Hand",
				{
					-0.056,
					0.077,
			...
			{
				"furniture/Item/ND_Shoes01/pre_db_nd_shoes_01_ik299992",
				"Bip001 R Foot",
				{
					-0.117,
					0.076,
	...
	pg.base.dorm3d_ik_status[300610] = {
		...
		cloth_colliders = {
			...
			{
				"Magica Capsule Collider (Bip001 Spine)_1",
				1,
				0.091,
				0.091
			},
			{
				"Magica Capsule Collider (Bip001 Spine)",
				1,
				0.136,
				0.136
			}
...
;(function()
	...
	pg.base.dorm3d_ik_status[510920] = {
		...
		enter_extra_item = {
			{
				"furniture/Item/Glasscup_01/pre_db_glasscup_dafengIK",
				"",
				{
					0,
					0,
	...
	pg.base.dorm3d_ik_status[600610] = {
		...
		enter_scene_anim = {
			...
			{
				2025,
				"IK_living02_idle01_SF_2"
			},
			{
				2026,
				"IK_living02_idle01_SF_3"
			}
		},
		enter_extra_item = {
			{
	...
	pg.base.dorm3d_ik_status[6] = {
		...
		enter_extra_item = {
			{
				"furniture/Item/Aje_Cup_01/pre_db_aje_cup_02",
				"",
				{
					0,
					0,
	...
	pg.base.dorm3d_ik_status[600740] = {
		ik_camera = "Cam600740",
		character_action = "IK_sp01_idle03_fb02-loop",
		base = 600740,
		camera_group = 60071,
		skin_id = 499051,
		character_position = "Pos600740",
		id = 600740,
		character_id = 49905,
		ik_id = {
			{
		...
		enter_scene_anim = {
			{
				2027,
				"IK_sp01_idle03_fb02_YG-loop"
			},
			{
				2028,
				"IK_sp01_idle03_fb02-loop_vfx"
			}
		},
		enter_extra_item = {
			{
	...
	pg.base.dorm3d_ik_status[610910] = {
		...
		enter_extra_item = {
			{
				"furniture/Item/Glasscup_01/pre_db_glasscup_01a",
				"",
				{
					0,
					0,
	...
	pg.base.dorm3d_ik_status[610720] = {
		ik_camera = "Cam600720",
		character_action = "IK_sp01_idle02",
		base = 600720,
		camera_group = 61070,
	...
	pg.base.dorm3d_ik_status[610730] = {
		ik_camera = "Cam610730",
		character_action = "IK_sp01_idle03",
		base = 600730,
		camera_group = 61070,
	...
	pg.base.dorm3d_ik_status[610740] = {
		ik_camera = "Cam610740",
		character_action = "IK_sp01_idle03_fb02-loop",
		base = 600740,
		camera_group = 60071,
...
;(function()
	pg.base.dorm3d_ik_status[700411] = {
		...
		enter_scene_anim = {
			{
				3004,
				"IK_desk02_idle01_fb01-1_MFJC-loop"
			},
			{
				3005,
				"vfx_desk02_idle01_fb01-1-loop"
			}
		},
		enter_extra_item = {},
		hide_scene_item = {}
	...
	pg.base.dorm3d_ik_status[700412] = {
		...
		enter_scene_anim = {
			{
				3004,
				"IK_desk02_idle01_fb01-2_MFJC-loop"
			},
			{
				3005,
				"vfx_desk02_idle01_fb01_2-loop"
			}
		},
		enter_extra_item = {},
		hide_scene_item = {}
	...
	pg.base.dorm3d_ik_status[5] = {
		...
		enter_scene_anim = {
			{
				3004,
				"IK_desk02_idle02_fb01-2_MFJC"
			},
			{
				3005,
				"vfx_desk02_idle02_fb01-2-loop"
			}
		},
		enter_extra_item = {},
		hide_scene_item = {}
