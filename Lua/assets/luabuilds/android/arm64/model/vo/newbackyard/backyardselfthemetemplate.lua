...
function var_0_0.GetAllFurniture(arg_2_0)
	arg_2_0.furnitruesByIds = arg_2_0.furnitruesByIds or arg_2_0:InitFurnitures({
		mapSize = arg_2_0:GetMapSize(),
		floor = arg_2_0.floor,
		furniture_put_list = arg_2_0:GetRawPutList()
	})
...
function var_0_0.AddFurniture(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_0 = BackyardThemeFurniture.New({
		isNewStyle = true,
		id = arg_3_1.id,
	...
	arg_3_0:GetAllFurniture()[arg_3_1.id] = var_3_0
...
function var_0_0.IsUsing(arg_13_0, arg_13_1)
	...
	for iter_13_2, iter_13_3 in pairs(var_13_0) do
		...
		if not arg_13_1[iter_13_3.id]:isPaper() then
			...
			local var_13_7 = var_13_5[iter_13_3.id] or {}
...
function var_0_0.GetMissFurnitures(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in pairs({}) do
		if not ({})[iter_14_0] then
			var_14_1[iter_14_0] = (function(arg_16_0)
				return {
					count = 1,
					name = pg.furniture_data_template[arg_16_0].name
				}
			end)(iter_14_0)
		elseif ({})[iter_14_0] and iter_14_1 > ({})[iter_14_0] then
			var_14_1[iter_14_0] = var_14_1[iter_14_0] or (function(arg_16_0)
				return {
					count = 1,
					name = pg.furniture_data_template[arg_16_0].name
				}
			end)(iter_14_0)
			var_14_1[iter_14_0].count = iter_14_1 - ({})[iter_14_0]
		end
	end
