local MonthlyShop = class("MonthlyShop", import(".BaseShop"))

function MonthlyShop:Ctor()
	self.goods = {}

	return
end

MonthlyShop.GoodsType = nil

function MonthlyShop:IsSameKind(arg_2_1)
	return isa(arg_2_1, MonthlyShop)
end

function MonthlyShop:GetCommodityById(arg_3_1)
	return self:getGoodsById(arg_3_1)
end

function MonthlyShop:GetCommodities()
	return self:getSortGoods()
end

function MonthlyShop:isOpen()
	if not self.id then
		return false
	end
	...
	if self:bindConfigTable()[self.id] then
		local var_5_1 = pg.TimeMgr.GetInstance()

		var_5_0 = var_5_1:STimeDescS(var_5_1:GetServerTime(), "*t").month == self.id
	end

	return var_5_0
end

function MonthlyShop:getRestDays()
	if not self.id then
		return 0
	end
...
function MonthlyShop:GetRestTime()
	if not self.id then
		return 0
	end
...
function MonthlyShop:getSortGoods()
	local var_8_0 = {}
	...
	table.sort(var_8_0, function(arg_10_0, arg_10_1)
		...
		local function var_10_3(arg_11_0)
			return arg_11_0:isSham() and arg_11_0:checkCommodityType(DROP_TYPE_SHIP) and var_10_2:getShipGroup(var_8_1((arg_11_0:getConfig("commodity_id"))))
		end
		...
		var_10_0 = var_10_3(arg_10_0) and not var_10_4(arg_10_0) and var_10_0 + 100 or var_10_0
		var_10_1 = var_10_3(arg_10_1) and not var_10_4(arg_10_1) and var_10_1 + 100 or var_10_1
		var_10_0 = var_10_4(arg_10_0) and var_10_0 + 1000 or var_10_0
		var_10_1 = var_10_4(arg_10_1) and var_10_1 + 1000 or var_10_1
...
function MonthlyShop:getGoodsCfg(arg_13_1)
	return pg.activity_shop_template[arg_13_1]
end

function MonthlyShop:getGoodsById(arg_14_1)
	return self.goods[arg_14_1]
end

function MonthlyShop:bindConfigTable()
