...
function OnApplicationExit()
	...
	local var_4_9 = var_4_5:retrieveMediator(var_4_7:retriveLastChild().mediator.__cname)

	if not var_4_9 or not var_4_9.viewComponent then
		return
	end

	local var_4_10 = var_4_9.viewComponent
	local var_4_11 = -1
	local var_4_12

	if var_4_3 and var_4_3.activeSelf then
		var_4_12 = var_4_3.transform.parent
		var_4_11 = var_4_3.transform:GetSiblingIndex()
	end
	...
	if var_4_9.viewComponent._tf.parent == var_4_12 and var_4_11 < var_4_9.viewComponent._tf:GetSiblingIndex() then
		var_4_10:onBackPressed()
	...
	local var_4_13 = checkExist(pg.NewStyleMsgboxMgr.GetInstance(), {
		"_tf"
	})

	if var_4_13 and isActive(var_4_13) then
		pg.NewStyleMsgboxMgr.GetInstance():Hide()

		return
	end

	local var_4_14 = nowWorld()

	if var_4_14 and var_4_14.staminaMgr:IsShowing() then
		var_4_14.staminaMgr:Hide()
