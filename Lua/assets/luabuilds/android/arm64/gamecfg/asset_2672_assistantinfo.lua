...
function var_0_1.GetShipTouchEvents(arg_1_0, arg_1_1)
...
function var_0_1.GetShipMainEvents(arg_2_0, arg_2_1)
	if not arg_2_0 then
		return {}
	end
	...
	for iter_2_0 = 1, var_0_0.ship_skin_template[arg_2_0].skin_type == ShipSkin.SKIN_TYPE_TB and EducateCharWordHelper.GetMainSceneWordCnt(NewEducateHelper.GetSecIdBySkinId(arg_2_0)) or ShipWordHelper.GetMainSceneWordCnt(arg_2_0, arg_2_1) do
...
function var_0_1:GetAssistantEvents()
	local var_3_0 = self:find("main_", 1, true)

	if self:find("main_", 1, true) == 1 then
		return {
			action = self,
			dialog = self
		}
	...
	return var_0_1.assistantEvents[self]
end

function var_0_1:GetAssistantEventsByDialog()
	local var_4_0 = self:find("main_", 1, true)
...
function var_0_1.getAssistantTouchEvents(arg_6_0, arg_6_1)
...
function var_0_1.getPaintingTouchEvents(arg_7_0)
...
function var_0_1.isDisableSpecialClick(arg_8_0)
...
function var_0_1.filterAssistantEvents(arg_9_0, arg_9_1, arg_9_2)
	local var_9_0 = {}

	arg_9_2 = arg_9_2 or 0

	local var_9_1 = ShipWordHelper.GetMainSceneWordCnt(arg_9_1, arg_9_2)

	for iter_9_0, iter_9_1 in ipairs(arg_9_0) do
		local var_9_2 = string.split(var_0_1.GetAssistantEvents(iter_9_1).dialog, "_")

		if var_9_2[1] == "main" then
			if var_9_1 >= tonumber(var_9_2[2]) then
...
function var_0_1.GetCvList()
	...
	for iter_10_0, iter_10_1 in ipairs(var_0_1.action2Words) do
		if var_0_0.character_voice[iter_10_1] and not var_0_0.AssistantInfo.isDisableSpecialClick(iter_10_1) and var_0_0.character_voice[iter_10_1].unlock_condition[1] >= 0 then
			table.insert(var_10_0, var_0_0.character_voice[iter_10_1])
		end
	end
...
function var_0_1.GetCVListForProfile(arg_11_0, arg_11_1)
	local var_11_0 = {}
		...
		if not var_0_0.AssistantInfo.isDisableSpecialClick(iter_11_1) and var_0_0.character_voice[iter_11_1].unlock_condition[1] >= 0 and var_0_0.character_voice[iter_11_1].l2d_action ~= "" then
			if var_0_0.character_voice[iter_11_1].l2d_action == "get" then
				if PaintingShowScene.GetSkinShowAble(arg_11_1) then
					table.insert(var_11_0, var_0_0.character_voice[iter_11_1])
				end
