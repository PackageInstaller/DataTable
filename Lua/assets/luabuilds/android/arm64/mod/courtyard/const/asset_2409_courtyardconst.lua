local CourtYardConst = class("CourtYardConst")

CourtYardConst.SYSTEM_DEFAULT = 1
CourtYardConst.SYSTEM_VISIT = 2
...
CourtYardConst.BELONG_FLOOR = 1
CourtYardConst.BELONG_WALL = 2
CourtYardConst.MAX_STOREY_LEVEL = 3
CourtYardConst.OPEN_AREA_PRE_LEVEL = 4
CourtYardConst.BACKYARD_RED = Color.New(1, 0.294, 0.08)
CourtYardConst.BACKYARD_GREEN = Color.New(0.48, 1, 0.03)
CourtYardConst.BACKYARD_BLUE = Color.New(0.3, 0.63, 0.95)
CourtYardConst.OBJ_TYPE_SHIP = 1
CourtYardConst.OBJ_TYPE_COMMOM = 2
CourtYardConst.OBJ_TYPE_SPINE = 3
CourtYardConst.SHIP_SCALE = 0.5
