local WSCommand = class("WSCommand", import(".WSBaseCommand"))
local var_0_1

function WSCommand:Bind()
	var_0_1 = self

	return
end

function WSCommand.Unbind()
	var_0_1 = nil

	return
end

function WSCommand:OpCall(arg_3_1)
	arg_3_1(function()
		self:OpDone()
...
function WSCommand:OpSwitchMap(arg_5_1, arg_5_2)
...
function WSCommand:OpOpenLayer(arg_15_1)
	self:OpDone()
...
function WSCommand:OpOpenScene(arg_16_1, ...)
	self:OpDone()
...
function WSCommand:OpChangeScene(arg_17_1, ...)
	self:OpDone()
...
function WSCommand:OpInteractive(arg_18_1)
	...
	table.insert(var_18_2, function(arg_21_0)
		...
		if var_21_0 then
			self:OpAutoSubmitTask(var_21_0)
		else
			arg_21_0()
		end
	...
	table.insert(var_18_2, function(arg_22_0)
		if var_0_1:CheckEventForMsg() then
			...
			if pg.collection_template[var_22_1] then
				var_22_2 = pg.collection_template[var_22_1].title or ""
	...
	table.insert(var_18_2, function(arg_26_0)
		...
		if var_18_1.isLoss then
			if WorldConst.IsRookieMap(var_18_1.id) then
				self:OpStory(WorldConst.GetRookieBattleLoseStory(), true, false, false, function()
					self:OpKillWorld()
		...
		if not var_31_0:ShouldTipProgress() then
			...
			if WorldGuider.GetInstance():PlayGuide("WorldG190") then
				...
				pg.MsgboxMgr.GetInstance():ShowMsgBox({
					...
					onYes = function()
						self:OpOpenScene(SCENE.WORLDBOSS)
		...
		if var_34_0 then
			...
			if var_34_0.type == WorldMapAttachment.TypeEvent then
				if var_34_0:RemainOpEffect() then
					self:OpEventOp(var_34_0)
				else
					self:OpEvent(var_34_1, var_34_0)
				end
			elseif WorldMapAttachment.IsEnemyType(var_34_0.type) then
				if var_18_0.isAutoFight or arg_18_1 then
					...
					if var_18_0:CheckSkipBattle() then
						self:OpReqSkipBattle(var_34_1.id)
					elseif var_18_0.isAutoFight or PlayerPrefs.GetInt("world_skip_precombat", 0) == 1 then
						...
						self:OpOpenLayer(Context.New(var_34_5))
					end
				else
					arg_34_0()
				end
			elseif var_34_0.type == WorldMapAttachment.TypeBox then
				self:OpReqBox(var_34_1, var_34_0)
			else
...
function WSCommand:OpReqDiscover()
	...
	if #var_38_1 > 0 then
		...
		self:OpDone("OpReqDiscoverDone")
	end

	return
end

function WSCommand:OpReqDiscoverDone(arg_41_1)
	...
	if arg_41_1 and #arg_41_1.hiddenAttachments > 0 then
		table.insert(var_41_2, function(arg_42_0)
			self:OpAnim(WorldConst.AnimRadar, arg_42_0)
...
function WSCommand:OpAnim(arg_44_1, arg_44_2)
...
function WSCommand:OpReadyToMove()
	self:OpDone()
	...
	if #var_46_0:GetBuffsByTrap(WorldBuff.TrapDisturbance) > 0 then
		...
		if var_46_1[var_46_2] then
			...
			self:OpReqMoveFleet(var_46_0, var_46_1[var_46_2].row, var_46_1[var_46_2].column)
...
function WSCommand:OpLongMoveFleet(arg_47_1, arg_47_2, arg_47_3)
	self:OpDone()
	...
	if var_47_0:CheckFleetMovable() then
		...
		if not _.any(var_47_3, function(arg_48_0)
			...
			local function var_47_8(arg_49_0, arg_49_1)
				if arg_49_0.last[arg_49_1] then
					var_47_8(arg_49_0.last[arg_49_1][1], arg_49_0.last[arg_49_1][2])
			...
			;(nil)(var_47_4[var_47_2.row][var_47_2.column], 0)
...
function WSCommand:OpReqMoveFleet(arg_50_1, arg_50_2, arg_50_3)
	...
	if var_50_0:CheckFleetMovable() then
		...
		if _.detect(var_50_1:GetMoveRange(arg_50_1), function(arg_51_0)
			...
			local var_50_7
			local var_50_8 = arg_50_1:GetBuffsByTrap(WorldBuff.TrapVortex)

			if #var_50_8 > 0 then
				local var_50_9 = math.random() * 100

				if underscore.all(var_50_8, function(arg_52_0)
					return var_50_9 < arg_52_0:GetTrapParams()[1]
				end) then
					var_50_3.row, var_50_3.column = arg_50_1.row, arg_50_1.column
					var_50_7 = WorldBuff.TrapVortex
				end
			end

			local var_50_10, var_50_11 = var_50_1:FindPath(var_50_2, var_50_3)

			if var_50_10 < PathFinding.PrioObstacle then
				var_0_1:emit(WorldMediator.OnMapOp, var_0_1:NewMapOp({
				...
				return
			elseif var_50_10 < PathFinding.PrioForbidden then
...
function WSCommand:OpReqMoveFleetDone(arg_53_1)
	local var_53_0 = {}
	local var_53_1 = var_0_1.wsMap
	local var_53_2 = var_0_1.wsMap.map
	local var_53_3 = var_0_1.wsMap.map:GetFleet()
	...
	table.insert(var_53_0, function(arg_54_0)
		...
		self:OpActions(arg_53_1.childOps, arg_54_0)
	...
	if arg_53_1.sign then
		table.insert(var_53_0, function(arg_56_0)
			...
			if var_53_3.row == arg_53_1.arg1 and var_53_3.column == arg_53_1.arg2 then
				self:OpTriggerSign(var_53_3, var_53_2:GetCell(arg_53_1.sign.row, arg_53_1.sign.column):GetEventAttachment(), arg_56_0)
			else
				arg_56_0()
			end
...
function WSCommand:OpMoveFleet(arg_58_1, arg_58_2)
	...
	local var_58_3 = var_0_1.wsMap:MovePath(var_58_1, arg_58_1.path, arg_58_1.pos, WorldConst.DirType2, var_0_1.wsMap.map:GetCell(var_58_1.fleet.row, var_58_1.fleet.column):GetTerrain() == WorldMapCell.TerrainWind)
		...
		if #arg_58_1.stepOps[arg_59_0].hiddenAttachments > 0 then
			table.insert(var_59_1, function(arg_60_0)
				if arg_59_0 < #arg_58_1.stepOps then
					var_58_3:UpdatePaused(true)
				end

				var_0_1:DoAnim(WorldConst.AnimRadar, function()
					if arg_59_0 < #arg_58_1.stepOps then
						var_58_3:UpdatePaused(false)
					end
	...
	local function var_58_5(arg_63_0)
	...
	local function var_58_7(arg_64_0, arg_64_1)
		var_58_6 = var_58_6 + 1

		var_58_5(var_58_6)
		var_0_1.wsMapRight:UpdateCompassRotation(arg_58_1.path[var_58_6 + 1])
		var_58_4(var_58_6)

		return
	end

	local function var_58_9()
		var_58_3:RemoveListener(WSMapPath.EventArrivedStep, var_58_7)
		var_58_3:RemoveListener(WSMapPath.EventArrived, var_58_9)

		var_58_6 = var_58_6 + 1

		var_58_4(var_58_6, function()
	...
	var_58_3:AddListener(WSMapPath.EventArrivedStep, var_58_7)
	var_58_3:AddListener(WSMapPath.EventArrived, var_58_9)
...
function WSCommand:OpMoveAttachment(arg_68_1, arg_68_2)
	...
	local function var_68_5(arg_69_0, arg_69_1)
		var_68_3 = var_68_3 + 1
	...
	local function var_68_7()
		var_68_4:RemoveListener(WSMapPath.EventArrivedStep, var_68_5)
		var_68_4:RemoveListener(WSMapPath.EventArrived, var_68_7)
		self:OpDone()
		arg_68_2()
	...
	var_68_4:AddListener(WSMapPath.EventArrivedStep, var_68_5)
	var_68_4:AddListener(WSMapPath.EventArrived, var_68_7)

	return
end

function WSCommand:OpReqRound()
	var_0_1:emit(WorldMediator.OnMapOp, var_0_1:NewMapOp({
...
function WSCommand:OpReqRoundDone(arg_72_1)
	self:OpActions(arg_72_1.childOps, function()
		arg_72_1:Apply()
		self:OpInteractive(true)
...
function WSCommand:OpActions(arg_74_1, arg_74_2)
	self:OpDone()
	seriesAsync(_.map(arg_74_1 or {}, function(arg_75_0)
		return function(arg_76_0)
			self:OpAction(arg_75_0, arg_76_0)
...
function WSCommand:OpAction(arg_77_1, arg_77_2)
	self:OpDone()
	...
	if arg_77_1.childOps then
		table.insert(var_77_0, function(arg_78_0)
			self:OpActions(arg_77_1.childOps, arg_78_0)
	...
	elseif arg_77_1.op == WorldConst.OpActionFleetMove then
		table.insert(var_77_0, function(arg_80_0)
			self:OpMoveFleet(arg_77_1, function()
				arg_77_1:Apply()
				arg_80_0()
	...
	elseif arg_77_1.op == WorldConst.OpActionAttachmentMove then
		table.insert(var_77_0, function(arg_82_0)
			self:OpMoveAttachment(arg_77_1, function()
				arg_77_1:Apply()
				arg_82_0()
	...
	elseif arg_77_1.op == WorldConst.OpActionAttachmentAnim then
		table.insert(var_77_0, function(arg_84_0)
			self:OpAttachmentAnim(arg_77_1, function()
				arg_77_1:Apply()
				arg_84_0()
	...
	elseif arg_77_1.op == WorldConst.OpActionFleetAnim then
		table.insert(var_77_0, function(arg_86_0)
			self:OpFleetAnim(arg_77_1, function()
				arg_77_1:Apply()
				arg_86_0()
	...
	elseif arg_77_1.op == WorldConst.OpActionEventEffect then
		table.insert(var_77_0, function(arg_88_0)
			self:OpTriggerEvent(arg_77_1, arg_88_0)

			return
		end)
	elseif arg_77_1.op == WorldConst.OpActionCameraMove then
		table.insert(var_77_0, function(arg_89_0)
			self:OpMoveCameraTarget(arg_77_1.attachment, 0.1, function()
				arg_77_1:Apply()
				arg_89_0()
	...
	elseif arg_77_1.op == WorldConst.OpActionTrapGravityAnim then
		table.insert(var_77_0, function(arg_91_0)
			self:OpTrapGravityAnim(arg_77_1.attachment, function()
				arg_77_1:Apply()
				arg_91_0()
...
function WSCommand:OpEvent(arg_93_1, arg_93_2)
	self:OpDone()
	...
	if var_93_3.effect_type == WorldMapAttachment.EffectEventStoryOption then
		...
		local var_93_7 = var_93_3.autoflag[1]
		...
		if var_93_3.autoflag[1] and WorldConst.CheckWorldStorySkip(var_93_3.effect_paramater[1]) then
			...
			table.insert(var_93_5, function(arg_95_0)
				self:OpStory(var_93_6, true, true, var_93_0.isAutoFight and var_93_7 and {
					var_93_7
				} or false, arg_95_0)
	...
	elseif var_93_3.effect_type == WorldMapAttachment.EffectEventConsumeItem then
		...
		table.insert(var_93_5, function(arg_100_0)
			if var_93_0:GetInventoryProxy():GetItemCount(var_93_4[1]) < var_93_4[2] then
				...
				self:OpStory(var_93_4[3], true, false, false, function()
					self:OpInteractive()
	...
	elseif var_93_3.effect_type == WorldMapAttachment.EffectEventGuide then
		table.insert(var_93_5, function(arg_102_0)
			if arg_93_2:IsAttachmentFinish() then
				...
				self:OpGuide(var_93_4[1], var_93_4[2], function()
	...
	elseif var_93_3.effect_type == WorldMapAttachment.EffectEventConsumeCarry then
		if _.any(var_93_3.effect_paramater[1] or {}, function(arg_104_0)
			...
			local var_93_9 = var_93_3.effect_paramater[2]

			if var_93_3.effect_paramater[2] then
				table.insert(var_93_5, function(arg_105_0)
					self:OpStory(var_93_9, true, false, false, arg_105_0)
		...
		if arg_93_1:GetDisplayCommander() and not arg_93_1:IsCatSalvage() then
			if not var_93_0.isAutoFight then
				table.insert(var_93_5, function(arg_107_0)
					self:OpStory(var_93_4[1], true, true, false, function(arg_108_0)
			...
			if not var_93_0.isAutoFight then
				local var_93_10 = pg.gameset.world_catsearch_failure.description[1]

				table.insert(var_93_5, function(arg_109_0)
					self:OpStory(var_93_10, true, false, false, arg_109_0)
	...
	seriesAsync(var_93_5, function()
		self:OpReqEvent((var_0_1:NewMapOp({
...
function WSCommand:OpReqEvent(arg_116_1)
	var_0_1:emit(WorldMediator.OnMapOp, arg_116_1)

	return
end

function WSCommand:OpReqEventDone(arg_117_1)
	self:OpTriggerEvent(arg_117_1, function()
		self:OpInteractive(true)
...
function WSCommand:OpEventOp(arg_119_1)
	self:OpDone()
	self:OpTriggerEvent(var_0_1:NewMapOp({
...
function WSCommand:OpTriggerEvent(arg_121_1, arg_121_2)
	self:OpDone()
	...
	switch(arg_121_1.effect.effect_type, {
		[WorldMapAttachment.EffectEventStory] = function()
			...
			if WorldConst.CheckWorldStorySkip(var_121_2[1]) then
				...
				table.insert(var_121_1, function(arg_124_0)
					self:OpStory(var_122_1, true, false, var_121_0.isAutoFight and {} or false, arg_124_0)
		...
		[WorldMapAttachment.EffectEventTeleport] = function()
			...
			if var_0_1:GetInMap() and arg_121_1.attachment.config.icon == "chuansong01" then
				table.insert(var_121_1, function(arg_128_0)
					self:OpAttachmentAnim(var_0_1:NewMapOp({
						anim = "chuansong_open",
			...
			table.insert(var_121_1, function(arg_129_0)
				self:OpSwitchMap(arg_121_1, arg_129_0)
		...
		[WorldMapAttachment.EffectEventCameraMove] = function()
			table.insert(var_121_1, function(arg_134_0)
				self:OpMoveCamera(var_121_2[1], var_121_2[2], function()
					arg_121_1:Apply()
					arg_134_0()
		...
		[WorldMapAttachment.EffectEventShakePlane] = function()
			table.insert(var_121_1, function(arg_137_0)
				self:OpShakePlane(var_121_2[1], var_121_2[2], var_121_2[3], var_121_2[4], function()
					arg_121_1:Apply()
					arg_137_0()
		...
		[WorldMapAttachment.EffectEventBlink1] = function()
			table.insert(var_121_1, function(arg_140_0)
				...
				self:OpActions(arg_121_1.childOps, function()
					arg_121_1:Apply()
					arg_140_0()
		...
		[WorldMapAttachment.EffectEventFlash] = function()
			table.insert(var_121_1, function(arg_143_0)
				self:OpFlash(var_121_2[1], var_121_2[2], var_121_2[3], Color.New(var_121_2[4][1] / 255, var_121_2[4][2] / 255, var_121_2[4][3] / 255, var_121_2[4][4] / 255), function()
					arg_121_1:Apply()
					arg_143_0()
		...
		[WorldMapAttachment.EffectEventReturn2World] = function()
			table.insert(var_121_1, function(arg_154_0)
				var_121_0:TriggerAutoFight(false)
				self:OpSetInMap(false, function()
					arg_121_1:Apply()
					arg_154_0()
		...
		[WorldMapAttachment.EffectEventGlobalBuff] = function()
			...
			var_158_0.before = var_121_0:GetGlobalBuff(var_121_2[1]):GetFloor()
		...
		[WorldMapAttachment.EffectEventSound] = function()
			table.insert(var_121_1, function(arg_162_0)
				self:OpPlaySound(var_121_2[1], function()
					arg_121_1:Apply()
					arg_162_0()
		...
		[WorldMapAttachment.EffectEventFleetShipHP] = function()
			table.insert(var_121_1, function(arg_167_0)
				...
				if var_121_2[1] > 0 then
					self:OpShowAllFleetHealth(arg_167_0)
				else
					arg_167_0()
				end
...
function WSCommand:OpReqRetreat(arg_176_1)
...
function WSCommand:OpReqRetreatDone(arg_177_1)
	local var_177_0 = {}

	table.insert(var_177_0, function(arg_178_0)
		self:OpActions(arg_177_1.childOps, arg_178_0)
...
function WSCommand:OpTransport(arg_180_1, arg_180_2)
	self:OpDone()
	...
	elseif not arg_180_2:IsMapOpen() then
		...
		self:OpReqTransport(var_180_0:GetActiveMap():GetFleet(), arg_180_1, arg_180_2)
	end

	return
end

function WSCommand:OpReqTransport(arg_181_1, arg_181_2, arg_181_3)
	local var_181_0 = {
	...
	var_181_1[1] = arg_181_3:CalcTransportPos(nowWorld():GetActiveEntrance(), arg_181_2)
	var_181_0.locations = var_181_1

	var_0_1:emit(WorldMediator.OnMapOp, var_0_1:NewMapOp(var_181_0))

	return
end

function WSCommand:OpReqTransportDone(arg_182_1)
	seriesAsync({}, function()
		self:OpSwitchMap(arg_182_1)
...
function WSCommand:OpReqSub(arg_184_1)
	...
	var_184_0.id = nowWorld():GetSubmarineFleet().id

	var_0_1:emit(WorldMediator.OnMapOp, var_0_1:NewMapOp(var_184_0))

	return
end

function WSCommand:OpReqSubDone(arg_185_1)
...
function WSCommand:OpReqJumpOut(arg_187_1, arg_187_2)
	local var_187_0 = {}
...
function WSCommand:OpReqJumpOutDone(arg_191_1)
	local var_191_0 = {}
...
function WSCommand:OpReqSwitchFleet(arg_194_1)
	var_0_1:emit(WorldMediator.OnMapOp, var_0_1:NewMapOp({
...
function WSCommand:OpReqSwitchFleetDone(arg_195_1)
...
function WSCommand:OpStory(arg_196_1, arg_196_2, arg_196_3, arg_196_4, arg_196_5)
...
function WSCommand:OpTriggerSign(arg_198_1, arg_198_2, arg_198_3)
	...
	_.each(arg_198_2:GetEventEffects(), function(arg_199_0)
		...
		if arg_199_0.effect_type == WorldMapAttachment.EffectEventStoryOptionClient then
			...
			local var_199_2 = arg_199_0.autoflag[1]
			...
			if arg_199_0.autoflag[1] and WorldConst.CheckWorldStorySkip(arg_199_0.effect_paramater[1]) then
				...
				table.insert(var_198_4, function(arg_201_0)
					self:OpStory(var_199_1, true, true, nowWorld().isAutoFight and var_199_2 and {
						var_199_2
					} or false, arg_201_0)
...
function WSCommand:OpShowMarkOverview(arg_205_1, arg_205_2)
...
function WSCommand:OpFocusTargetEntrance(arg_207_1)
	self:OpDone()
...
function WSCommand:OpShowOrderPanel()
	self:OpDone()
...
function WSCommand:OpShowScannerPanel(arg_211_1, arg_211_2)
	self:OpDone()
...
function WSCommand:OpMoveCamera(arg_212_1, arg_212_2, arg_212_3)
...
function WSCommand:OpMoveCameraTarget(arg_219_1, arg_219_2, arg_219_3)
...
function WSCommand:OpShakePlane(arg_224_1, arg_224_2, arg_224_3, arg_224_4, arg_224_5)
...
function WSCommand:OpAttachmentAnim(arg_226_1, arg_226_2)
...
function WSCommand:OpFleetAnim(arg_229_1, arg_229_2)
...
function WSCommand:OpFlash(arg_232_1, arg_232_2, arg_232_3, arg_232_4, arg_232_5)
...
function WSCommand:OpReqBox(arg_234_1, arg_234_2)
...
function WSCommand:OpReqBoxDone(arg_235_1)
	arg_235_1:Apply()
	self:OpInteractive()
...
function WSCommand:OpSetInMap(arg_236_1, arg_236_2)
	self:OpDone()
...
function WSCommand:OpSwitchInMap(arg_237_1)
	local var_237_0 = {}
...
function WSCommand:OpSwitchOutMap(arg_241_1)
	local var_241_0 = {}
...
function WSCommand:OpSwitchInWorld(arg_245_1)
	local var_245_0 = {}
...
function WSCommand:OpSwitchOutWorld(arg_249_1)
	local var_249_0 = {}
...
function WSCommand:OpRedeploy()
	...
	if var_253_1:CheckFleetSalvage(true) then
		...
		self:OpOpenScene(SCENE.WORLD_FLEET_SELECT, {
			type = var_253_2,
			fleets = var_253_3
		})
	end
...
function WSCommand:OpKillWorld()
...
function WSCommand:OpReqMaintenance(arg_259_1)
	var_0_1:emit(WorldMediator.OnMapOp, var_0_1:NewMapOp({
...
function WSCommand:OpReqMaintenanceDone(arg_260_1)
	arg_260_1:Apply()
	...
	var_0_1.wsMap:UpdateRangeVisible(false)
	self:OpShowAllFleetHealth(function()
		self:OpInteractive()
...
function WSCommand:OpReqVision()
	var_0_1:emit(WorldMediator.OnMapOp, var_0_1:NewMapOp({
...
function WSCommand:OpReqVisionDone(arg_264_1)
	arg_264_1:Apply()
...
function WSCommand:OpReqPressingMap()
...
function WSCommand:OpReqPressingMapDone(arg_266_1, arg_266_2)
	...
	if var_266_1 and var_266_1.flag then
		...
		if #pg.world_event_complete[var_266_1.id].event_reward_slgbuff > 1 then
			...
			var_266_3.before = var_266_0:GetGlobalBuff(pg.world_event_complete[var_266_1.id].event_reward_slgbuff[1]):GetFloor()

			if var_266_0.isAutoFight then
				var_266_0:AddAutoInfo("buffs", var_266_3)
			else
...
function WSCommand:OpReqEnterPort()
...
function WSCommand:OpReqEnterPortDone(arg_272_1)
	arg_272_1:Apply()
	var_0_1:OpenPortLayer()
...
function WSCommand:OpReqCatSalvage(arg_273_1)
...
function WSCommand:OpReqCatSalvageDone(arg_274_1, arg_274_2)
	local var_274_0 = nowWorld()

	if var_274_0.isAutoFight then
		-- block empty
	else
		table.insert(arg_274_2, 1, function(arg_275_0)
			pg.NewStoryMgr.GetInstance():Play(pg.gameset.world_catsearch_completed.description[var_274_0:GetFleet(arg_274_1.id):GetRarityState() > 0 and 2 or 1], arg_275_0, true)
...
function WSCommand:OpReqSkipBattle(arg_277_1)
	var_0_1:emit(WorldMediator.OnMapOp, var_0_1:NewMapOp({
...
function WSCommand:OpReqSkipBattleDone(arg_278_1)
	arg_278_1:Apply()
	self:OpInteractive()
...
function WSCommand:OpPlaySound(arg_279_1, arg_279_2)
	var_0_1:PlaySound(arg_279_1, arg_279_2)

	return
end

function WSCommand:OpGuide(arg_280_1, arg_280_2, arg_280_3)
	self:OpDone()
...
function WSCommand:OpTaskGoto(arg_281_1)
	self:OpDone()
	...
	elseif var_281_0:GetActiveEntrance().id ~= var_281_1:GetFollowingEntrance() then
		...
		var_0_1:QueryTransport(function()
			...
			var_282_0.mapTypes = var_281_3[var_281_2] and {
				"task_chapter"
			} or {
				"complete_chapter",
				"base_chapter"
			...
			var_0_1:EnterTransportWorld(var_282_0)
		...
		elseif var_281_4[1] == 1 then
			...
			for iter_281_0, iter_281_1 in ipairs(var_281_4[2]) do
				...
				table.insert(var_281_6, function(arg_284_0)
					self:OpTriggerEvent(var_0_1:NewMapOp({
			...
			seriesAsync(var_281_6, function()
				self:OpInteractive()

				return
			end)
		elseif var_281_4[1] == 2 then
			local var_281_7 = checkExist(var_281_0:GetActiveMap(), {
				"GetPort"
			})
			local var_281_8 = var_281_0:GetRealm()

			if var_281_8 == checkExist(var_281_7, {
				"GetRealm"
			}) and checkExist(var_281_7, {
				"IsOpen",
				{
					var_281_8,
...
function WSCommand:OpShowAllFleetHealth(arg_286_1)
	self:OpDone()
...
function WSCommand:OpAutoSubmitTask(arg_287_1)
	var_0_1:emit(WorldMediator.OnAutoSubmitTask, arg_287_1)

	return
end

function WSCommand:OpAutoSubmitTaskDone(arg_288_1)
	self:OpInteractive()

	return
end

function WSCommand:OpTrapGravityAnim(arg_289_1, arg_289_2)
	var_0_1:ClearMoveQueue()
...
function WSCommand:OpAutoFightSeach()
	self:OpDone()
	...
	if var_291_4 then
		self:OpLongMoveFleet(var_291_2, var_291_4.row, var_291_4.column)
	elseif var_291_2:IsCatSalvage() then
		self:OpLongMoveFleet(var_291_2, var_291_3[1].row, var_291_3[1].column)
	else
		local var_291_8 = {}
		...
		if var_291_0.isAutoSwitch then
			...
			switch(PlayerPrefs.GetInt("auto_switch_mode", 0), {
				...
				[WorldSwitchPlanningLayer.MODE_SAFE] = function()
					if var_291_1.isPressing then
						var_291_9 = PlayerPrefs.GetString("auto_switch_difficult_safe", "only") == "only" and World.ReplacementMapType(var_291_0:GetActiveEntrance(), var_291_1) == "base_chapter" or not underscore.any({
							"event_1",
							"event_2"
						}, function(arg_297_0)
...
function WSCommand:OpAutoSwitchMap(arg_302_1)
	self:OpDone()
	...
	switch(PlayerPrefs.GetInt("auto_switch_mode", 0), {
		...
		[WorldSwitchPlanningLayer.MODE_TREASURE] = function()
			...
			local var_309_0 = underscore.map(underscore.filter(underscore.map(var_302_0:GetInventoryProxy():GetItemsByType(WorldItem.UsageWorldMap), function(arg_310_0)
				return arg_310_0.id
			end), function(arg_311_0)
			...
			table.sort(var_309_0, CompareFuncs({
				function(arg_313_0)
			...
			local var_309_1 = PlayerPrefs.GetString("auto_switch_difficult_treasure", "all")

			for iter_309_0, iter_309_1 in ipairs(var_309_0) do
				local var_309_2, var_309_3 = unpack(iter_309_1)

				if var_302_1.transportDic[var_309_3.id] and var_309_2:IsMapOpen() and WorldSwitchPlanningLayer.checkDifficultValid(var_309_1, var_309_2:GetDanger()) and not var_302_5 then
					var_302_5, var_302_6 = var_309_2, var_309_3
	...
	if false then
		self:OpReqJumpOut(var_302_3.gid, true)
	elseif not nil then
	...
	elseif not (nil).isCost and var_302_0.staminaMgr:GetTotalStamina() < (nil).config.enter_cost then
		...
		if (nil).active then
			...
			self:OpSetInMap(true)
		else
			self:OpTransport(var_302_6, nil)
		end
	end
