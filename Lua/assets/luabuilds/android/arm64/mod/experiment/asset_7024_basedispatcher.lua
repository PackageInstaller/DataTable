local BaseDispatcher = class("BaseDispatcher")

function BaseDispatcher:Ctor()
	self.__callbacks = {}
	self.__list = {}
...
function BaseDispatcher:AddListener(arg_2_1, arg_2_2)
...
function BaseDispatcher:RemoveListener(arg_3_1, arg_3_2)
...
function BaseDispatcher:ClearListener(arg_4_1)
...
function BaseDispatcher:DispatchEvent(arg_5_1, ...)
	...
	if self.__callbacks[arg_5_1] then
		...
		for iter_5_1 = 1, #self.__callbacks[arg_5_1] do
			self.__list[iter_5_1](arg_5_1, self, ...)
		end
	end
...
function BaseDispatcher:ClearListeners()
