local ExitIslandCommand = class("ExitIslandCommand", pm.SimpleCommand)

function ExitIslandCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21204, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.ISLAND_EXIT_DONE)
