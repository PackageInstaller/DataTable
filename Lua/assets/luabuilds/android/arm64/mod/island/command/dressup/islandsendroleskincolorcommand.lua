local var_0_0 = class("IslandSendRoleSkinColorCommand", pm.SimpleCommand)

function var_0_0.execute(arg_1_0, arg_1_1)
	local var_1_0 = arg_1_1:getBody()
	local var_1_1 = var_1_0.skin_id
	...
	pg.ConnectionMgr.GetInstance():Send(21619, {
		...
		if arg_2_0.result == 0 then
			pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildIslandUnlockColor(var_0, var_0))

			local var_2_0 = getProxy(IslandProxy):GetIsland()

			var_2_0:GetCharacterAgency():AddSkinColor(var_0, var_1_1, var_0)
			...
			for iter_2_0, iter_2_1 in ipairs(pg.island_skin_colordiff_template[var_0].cost) do
				var_2_1:RemoveItem(iter_2_1[1], iter_2_1[2])
			end

			pg.TipsMgr.GetInstance():ShowTips(i18n("common_buy_success"))
			arg_1_0:sendNotification(GAME.ISLAND_BUY_ROLE_SKIN_COLOR_DONE)
		else
