local IslandFollowerOpCommand = class("IslandFollowerOpCommand", pm.SimpleCommand)

function IslandFollowerOpCommand:execute(arg_1_1)
	local var_1_0 = arg_1_1:getBody()
	local var_1_1 = var_1_0.shipId
	local var_1_2 = var_1_0.op
	local var_1_3 = getProxy(IslandProxy)
	local var_1_4 = var_1_3:GetIsland()
	...
	if var_1_0.op == IslandConst.FOLLOWER_OP_ADD and var_1_5:ReachMaxCnt() then
	...
	pg.ConnectionMgr.GetInstance():Send(21630, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.ISLAND_FOLLOWER_OP_DONE, var_1_1)
...
return IslandFollowerOpCommand
