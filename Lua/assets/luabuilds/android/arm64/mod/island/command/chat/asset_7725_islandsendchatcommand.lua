local IslandSendChatCommand = class("IslandSendChatCommand", pm.SimpleCommand)

function IslandSendChatCommand:execute(arg_1_1)
...
function IslandSendChatCommand:Send(arg_2_1, arg_2_2, arg_2_3)
