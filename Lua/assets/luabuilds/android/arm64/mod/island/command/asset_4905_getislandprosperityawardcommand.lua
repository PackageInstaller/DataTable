local GetIslandProsperityAwardCommand = class("GetIslandProsperityAwardCommand", pm.SimpleCommand)

function GetIslandProsperityAwardCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21010, {
		...
		if arg_2_0.ret == 0 then
			...
			self:sendNotification(GAME.ISLAND_PROSPERITY_AWARD_DONE, {
...
return GetIslandProsperityAwardCommand
