local IslandResetSeasonCommand = class("IslandResetSeasonCommand", pm.SimpleCommand)

function IslandResetSeasonCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21024, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_5 = var_2_4:OnSeasonReset()
			...
			if var_2_3 then
				var_2_8.seasonId = var_2_3.id or 0
			end

			var_2_8.rank = var_2_7

			IslandSeasonAgency.AddResetData(var_2_8)
		else
...
return IslandResetSeasonCommand
