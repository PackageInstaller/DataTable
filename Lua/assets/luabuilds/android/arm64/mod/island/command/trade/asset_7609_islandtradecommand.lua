local IslandTradeCommand = class("IslandTradeCommand", pm.SimpleCommand)

function IslandTradeCommand:execute(arg_1_1)
	...
	elseif var_1_2 == IslandConst.TRADE_SELL and var_1_3 > var_1_7:GetCanSellCnt(var_1_1) then
	...
	pg.ConnectionMgr.GetInstance():Send(21240, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.ISLAND_TRADE_DONE, {
				dropData = var_2_0
			})
		else
