local IslandInviteTradeCommand = class("IslandInviteTradeCommand", pm.SimpleCommand)

function IslandInviteTradeCommand:execute(arg_1_1)
...
return IslandInviteTradeCommand
