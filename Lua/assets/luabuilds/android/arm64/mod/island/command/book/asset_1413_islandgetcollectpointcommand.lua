local IslandGetCollectPointCommand = class("IslandGetCollectPointCommand", pm.SimpleCommand)

function IslandGetCollectPointCommand:execute(arg_1_1)
	pg.ConnectionMgr.GetInstance():Send(21345, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.ISLAND_GET_COLLECT_POINT_DONE)
		else
...
return IslandGetCollectPointCommand
