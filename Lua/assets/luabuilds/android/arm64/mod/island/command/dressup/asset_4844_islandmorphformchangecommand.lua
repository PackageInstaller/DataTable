local IslandMorphFormChangeCommand = class("IslandMorphFormChangeCommand", pm.SimpleCommand)

function IslandMorphFormChangeCommand:execute(arg_1_1)
	...
	local var_1_7 = var_1_5:GetBodyHatIsOn(var_1_2) and ((pg.island_dress_template.get_id_list_by_related_dress[var_1_2] or {})[1] or 0) or 0

	var_1_4:DispatchEvent(IslandDressUpAgency.MORPH_PLAYER_DRESS, var_1_1, var_1_2, var_1_7, var_1_6, function()
		self:sendNotification(GAME.ISLAND_CHANGE_COMMANDER_DRESS, {
			hideTip = true,
			dress_List = {
				{
...
return IslandMorphFormChangeCommand
