local IslandRecordLastPositionCommmand = class("IslandRecordLastPositionCommmand", pm.SimpleCommand)

function IslandRecordLastPositionCommmand:execute(arg_1_1)
...
return IslandRecordLastPositionCommmand
