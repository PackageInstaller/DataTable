local IslandSubmitTaskOneStepCommand = class("IslandSubmitTaskOneStepCommand", pm.SimpleCommand)

function IslandSubmitTaskOneStepCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21041, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.ISLAND_SUBMIT_TASK_ONE_STEP_DONE, {
...
return IslandSubmitTaskOneStepCommand
