local SetIslandNameCommand = class("SetIslandNameCommand", pm.SimpleCommand)

function SetIslandNameCommand:execute(arg_1_1)
...
function SetIslandNameCommand:Send(arg_4_1, arg_4_2)
	pg.ConnectionMgr.GetInstance():Send(21004, {
		...
		if arg_5_0.ret == 0 then
			...
			self:sendNotification(GAME.ISLAND_SET_NAME_DONE, {
				name = arg_4_1
			})
		else
