local IslandCheaterTavernPlayerBuilder = class("IslandCheaterTavernPlayerBuilder", import(".IslandCharUnitBuilder"))

function IslandCheaterTavernPlayerBuilder:GetModule(arg_1_1, arg_1_2)
	return IslandCheaterTavernPlayerUnit.New(arg_1_1, arg_1_2)
end

function IslandCheaterTavernPlayerBuilder:SetTag(arg_2_1)
	arg_2_1.tag = IslandConst.TAG_NPC

	return
end

function IslandCheaterTavernPlayerBuilder:AddComponents(arg_3_1, arg_3_2)
	IslandCheaterTavernPlayerBuilder.super.AddComponents(self, arg_3_1, arg_3_2)
...
return IslandCheaterTavernPlayerBuilder
