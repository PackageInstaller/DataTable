local var_0_0 = class("IslandSetCardLabelBox", import("view.base.BaseSubView"))
...
function var_0_0.OnLoaded(arg_2_0)
	setText(arg_2_0._tf:Find("frame/title"), i18n("island_card_choose_label", 1, 1))
	setActive(arg_2_0._tf:Find("empty"), false)
...
function var_0_0.OnInit(arg_5_0)
	...
	onButton(arg_5_0, arg_5_0.confirmBtn, function()
		arg_5_0:emit(IslandOtherCardMediator.GIVE_CARD_LABEL, arg_5_0.userId, arg_5_0.selectedId)
...
function var_0_0.OnInitItem(arg_9_0, arg_9_1)
	arg_9_0.cards[arg_9_1] = IslandCardSetLabelCard.New(arg_9_1)
...
function var_0_0.OnUpdateItem(arg_10_0, arg_10_1, arg_10_2)
	...
	if arg_10_0.ids[arg_10_1 + 1] then
		...
		if arg_10_0.labelData[var_10_1] then
			local var_10_5 = arg_10_0.labelData[var_10_1].num or 0

			var_10_3(var_10_2, var_10_4, var_10_5, arg_10_0.selectedId)
...
function var_0_0.Show(arg_12_0, arg_12_1, arg_12_2)
	...
	arg_12_0.ids = pg.island_card_label.all
