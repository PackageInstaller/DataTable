local var_0_0 = class("IslandFriendList4GuildPage", import(".IslandFriendListPage"))

function var_0_0.GetData(arg_1_0, arg_1_1)
	...
	arg_1_0:emit(IslandMediator.GET_GIFT_TAG, var_1_2, function()
		arg_1_1(var_1_1)
