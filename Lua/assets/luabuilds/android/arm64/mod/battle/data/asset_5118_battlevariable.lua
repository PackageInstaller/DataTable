...
function ys.Battle.BattleVariable:CameraPosToUICameraByRef()
	self.y, self.x = (self.y * 0.866 + self.z * 0.5 - var_0_5) * var_0_7 + var_0_6, (self.x - var_0_2) * var_0_4 + var_0_3
	self.z = 0

	return
end

function ys.Battle.BattleVariable:UIPosToScenePos(arg_6_1)
	local var_6_0 = pg.CameraFixMgr.GetInstance()

	self = Vector2(var_6_0:GetCurrentWidth() / 0 * self.x, var_6_0:GetCurrentHeight() / 1080 * self.y)

	local var_6_1 = var_0_0._uiCamera:ScreenToWorldPoint(self)
