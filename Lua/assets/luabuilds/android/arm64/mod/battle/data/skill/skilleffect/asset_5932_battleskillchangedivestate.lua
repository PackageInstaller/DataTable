...
function ys.Battle.BattleSkillChangeDiveState:Ctor(arg_1_1, arg_1_2)
...
function ys.Battle.BattleSkillChangeDiveState:DoDataEffect(arg_2_1, arg_2_2)
	if arg_2_2:IsAlive() then
		local var_2_0 = arg_2_2:GetOxyState() or arg_2_2:InitOxygen()

		arg_2_2:ChangeOxygenState(self._state)
		var_2_0:SetForceExpose(self._expose)
	end
