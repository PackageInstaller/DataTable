...
function ys.Battle.BattleBuffSmokeAimBias.onUpdate(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	for iter_4_0, iter_4_1 in pairs((var_0_0.Battle.BattleDataProxy.GetInstance():GetUnitList())) do
		local var_4_2 = iter_4_1:GetIFF()
		local var_4_3 = var_0_3.GetCurrent(iter_4_1, "aimBiasExtraACC")

		var_4_0[var_4_2] = math.max(var_4_0[var_4_2], (var_0_3.GetCurrent(iter_4_1, "attackRating")))
		var_4_1[var_4_2] = var_4_1[var_4_2] + var_4_3
	end

	local var_4_4 = arg_4_1:GetAimBias()

	var_4_4:SetDecayFactor(var_4_0[var_0_2.FRIENDLY_CODE], var_4_1[var_0_2.FRIENDLY_CODE])
	var_4_4:Update(arg_4_3.timeStamp)
