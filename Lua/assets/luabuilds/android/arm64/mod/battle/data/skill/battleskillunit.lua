...
function ys.Battle.BattleSkillUnit.Interrupt(arg_7_0)
...
function ys.Battle.BattleSkillUnit.Clear(arg_8_0)
...
function ys.Battle.BattleSkillUnit.callbackCount(arg_9_0, arg_9_1)
...
function ys.Battle.BattleSkillUnit.GetDamageSum(arg_10_0)
	local var_10_0 = 0
