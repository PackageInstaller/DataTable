...
function ys.Battle.BattleBuffActionKeyOffset.SetArgs(arg_2_0, arg_2_1, arg_2_2)
	arg_2_0._actionKey = arg_2_0._tempData.arg_list.key

	return
end

function ys.Battle.BattleBuffActionKeyOffset.onAttach(arg_3_0, arg_3_1, arg_3_2)
