			...
			if not iter_1_3.id then
				...
				if var_1_1 and iter_1_2 > var_1_1 then
					if #var_0_33.GetWeaponDataFromID(iter_1_3.id).weapon_id then
						...
						var_1_4.equipment = var_0_33.GetWeaponDataFromID(iter_1_3.id)
						var_1_4.skin = iter_1_3.skin
						var_1_4.torpedoAmmo = var_1_3
						var_1_2[#var_1_2 + 1] = var_1_4
...
function ys.Battle.BattleDataFunction:InitUnitSkill(arg_2_1, arg_2_2)
	for iter_2_0, iter_2_1 in pairs(self.skills or {}) do
...
function ys.Battle.BattleDataFunction:AttachWeather(arg_4_1)
	if table.contains(arg_4_1, var_0_1.WEATHER.NIGHT) then
		local var_4_0 = self:GetTemplate().type

		if self:GetFleetVO() then
			local var_4_1 = self:GetFleetVO()
			...
			elseif table.contains(ShipType.SubShipType, var_4_0) then
				...
				var_4_3:AppendCrew(self)
				var_4_3:Active(var_4_3.STATE_ACTIVITING)
			end
		elseif self:GetUnitType() == var_0_1.UnitType.ENEMY_UNIT or self:GetUnitType() == var_0_1.UnitType.MINION_UNIT or self:GetUnitType() == var_0_1.UnitType.BOSS_UNIT then
...
function ys.Battle.BattleDataFunction:AttachSmoke()
	local var_5_0 = self:GetUnitType()

	if var_5_0 == var_0_1.UnitType.ENEMY_UNIT or var_5_0 == var_0_1.UnitType.BOSS_UNIT then
		if self:GetAimBias() then
			local var_5_1 = self:GetAimBias()
...
function ys.Battle.BattleDataFunction:CreateAllInStrike()
	local var_10_1 = {}

	for iter_10_0, iter_10_1 in ipairs(var_0_33.GetPlayerShipModelFromID((self:GetTemplateID())).airassist_time) do
		local var_10_2 = var_0_0.Battle.BattleAllInStrike.New(iter_10_1)

		var_10_2:SetHost(self)
...
function ys.Battle.BattleDataFunction:ExpandAllinStrike()
	local var_11_0 = var_0_33.GetPlayerShipModelFromID((self:GetTemplateID())).airassist_time

	if #var_11_0 > 0 then
		local var_11_1 = var_0_0.Battle.BattleAllInStrike.New(var_11_0[#var_11_0])

		var_11_1:SetHost(self)
		self:GetFleetVO():GetAirAssistVO():AppendWeapon(var_11_1)
		var_11_1:OverHeat()
		self:GetAirAssistQueue():AppendWeapon(var_11_1)

		local var_11_2 = self:GetAirAssistList()
...
function ys.Battle.BattleDataFunction.GetSpecificGuildBossEnemyList(arg_35_0, arg_35_1)
	return (var_0_29[arg_35_0].expedition_id[1] == arg_35_1 or nil) and var_0_29[arg_35_0].expedition_id[2]
end
...
function ys.Battle.BattleDataFunction.GenerateHiddenBuff(arg_44_0)
	...
	for iter_44_0, iter_44_1 in ipairs(var_0_33.GetPlayerShipModelFromID(arg_44_0).hide_buff_list) do
		...
		var_44_1.level = 1
		var_44_1.id = iter_44_1
		var_44_0[iter_44_1] = var_44_1
	end
...
function ys.Battle.BattleDataFunction:AttachUltimateBonus()
	local var_48_0 = self:GetTemplateID()
	...
	for iter_48_0, iter_48_1 in ipairs(var_0_33.GetPlayerShipModelFromID(var_48_0).specific_type) do
		if iter_48_1 == ShipType.SpecificTypeTable.gunner then
			var_0_3.SetCurrent(self, "barrageCounterMod", var_0_1.UltimateBonus.GunnerCountMod)
		elseif iter_48_1 == ShipType.SpecificTypeTable.torpedo then
			self:AddBuff((var_0_0.Battle.BattleBuffUnit.New(var_0_1.UltimateBonus.TorpedoBarrageBuff)))
		elseif iter_48_1 == ShipType.SpecificTypeTable.auxiliary then
			var_0_33.AuxBoost(self)
		end
	end
...
function ys.Battle.BattleDataFunction:AuxBoost()
	for iter_49_0, iter_49_1 in ipairs((self:GetEquipment())) do
		if iter_49_1 and iter_49_1.equipment and table.contains(EquipType.DeviceEquipTypes, iter_49_1.equipment.type) then
			for iter_49_2 = 1, 3 do
				if iter_49_1.equipment["attribute_" .. iter_49_2] then
					...
					var_0_3.SetCurrent(self, var_49_0, var_0_3.GetBase(self, var_49_0) + iter_49_1.equipment["value_" .. iter_49_2] * var_0_1.UltimateBonus.AuxBoostValue)
					var_0_3.SetBaseAttr(self)
				end
			end
		end
	end
