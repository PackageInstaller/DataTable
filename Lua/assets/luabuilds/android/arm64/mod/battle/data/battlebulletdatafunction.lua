...
function ys.Battle.BattleDataFunction.GenerateTransBarrage(arg_5_0, arg_5_1, arg_5_2)
	local var_5_0 = var_0_4.GetBarrageTmpDataFromID(arg_5_0)

	while var_5_0.trans_ID ~= -1 do
		var_5_0 = var_0_4.GetBarrageTmpDataFromID(var_5_0.trans_ID)

		local var_5_1 = {
			transStartDelay = var_5_0.first_delay + var_5_0.delay * arg_5_2 + var_5_0.delta_delay * arg_5_2
		}

		if var_5_0.offset_prioritise then
			var_5_1.transAimPosX = var_5_0.offset_x + var_5_0.delta_offset_x * arg_5_2
			var_5_1.transAimPosZ = var_5_0.offset_z + var_5_0.delta_offset_z * arg_5_2
		else
			var_5_1.transAimAngle = var_5_0.angle + var_5_0.delta_angle * arg_5_2

			if arg_5_1 == -1 then
				var_5_1.transAimAngle = var_5_1.transAimAngle + 180
			end
		end
...
function ys.Battle.BattleDataFunction.barrageInteration(arg_23_0, arg_23_1)
	for iter_23_0 = 0, arg_23_0.primal_repeat do
		table.insert({}, {
			OffsetX = arg_23_0.offset_x * arg_23_1,
			OffsetZ = arg_23_0.offset_z,
			Angle = arg_23_0.angle,
			Delay = arg_23_0.delay
		})
	end
