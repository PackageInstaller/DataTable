...
function ys.Battle.BattleDataFunction.GetSkillTemplate(arg_3_0, arg_3_1)
	...
	local var_3_0 = pg.ConvertedSkill["skill_" .. arg_3_0][arg_3_1] or pg.ConvertedSkill["skill_" .. arg_3_0][0]

	var_3_0.name = getSkillName(arg_3_0)
		...
		__index = function(arg_5_0, arg_5_1)
			if pg.skillCfg[arg_5_1] then
				...
				for iter_5_0, iter_5_1 in pairs(pg.skillCfg[arg_5_1]) do
					var_5_1[iter_5_0] = Clone(iter_5_1)
				end

				var_5_0[0] = var_5_1

				for iter_5_2, iter_5_3 in ipairs(pg.skillCfg[arg_5_1]) do
					local var_5_2 = Clone(var_5_1)

					for iter_5_4, iter_5_5 in pairs(iter_5_3) do
						var_5_2[iter_5_4] = iter_5_5
					end

					var_5_0[iter_5_2] = var_5_2
				end

				pg.ConvertedSkill[arg_5_1] = var_5_0
...
function ys.Battle.BattleDataFunction.GetBuffTemplate(arg_6_0, arg_6_1)
	...
	return pg.ConvertedBuff["buff_" .. arg_6_0][arg_6_1] or pg.ConvertedBuff["buff_" .. arg_6_0][0]
end
...
function ys.Battle.BattleDataFunction.GetBuffBulletRes(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	if var_9_6 and var_9_6.skill_id ~= 0 and pg.transform_data_template[var_9_6.skill_id].skill_id ~= 0 then
		...
		for iter_9_6, iter_9_7 in ipairs((var_0_3.GetResFromBuff(var_9_7, arg_9_1[pg.transform_data_template[var_9_6.skill_id].skill_id] and arg_9_1[var_9_7].level or 1, var_9_1, arg_9_3))) do
...
function ys.Battle.BattleDataFunction.GetResFromBuff(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_1 = var_0_3.GetBuffTemplate(arg_13_0, arg_13_1)

	if var_13_1.init_effect and var_13_1.init_effect ~= "" then
		local var_13_2 = var_13_1.init_effect

		if var_13_1.skin_adapt then
			var_13_2 = var_0_3.SkinAdaptFXID(var_13_2, arg_13_3)
		end

		var_13_0[#var_13_0 + 1] = var_0_0.Battle.BattleResourceManager.GetFXPath(var_13_2)
	end

	if var_13_1.last_effect and var_13_1.last_effect ~= "" then
		for iter_13_0, iter_13_1 in ipairs((type(var_13_1.last_effect) == "table" or nil) and (var_13_1.last_effect or {
			var_13_1.last_effect
		})) do
			var_13_0[#var_13_0 + 1] = var_0_0.Battle.BattleResourceManager.GetFXPath(iter_13_1)
		end
	end

	if var_13_1.last_effect_stack_list then
		for iter_13_2, iter_13_3 in pairs(var_13_1.last_effect_stack_list) do
			var_13_0[#var_13_0 + 1] = var_0_0.Battle.BattleResourceManager.GetFXPath(iter_13_3)
		end
	end

	for iter_13_4, iter_13_5 in ipairs(var_13_1.effect_list) do
		...
		if iter_13_5.arg_list.skill_id_list ~= nil then
			for iter_13_8, iter_13_9 in ipairs(iter_13_5.arg_list.skill_id_list) do
		...
		if iter_13_5.arg_list.damage_attr_list ~= nil then
			for iter_13_12, iter_13_13 in pairs(iter_13_5.arg_list.damage_attr_list) do
		...
		if iter_13_5.arg_list.bullet_id then
			for iter_13_16, iter_13_17 in ipairs((var_0_0.Battle.BattleResourceManager.GetBulletResource(iter_13_5.arg_list.bullet_id))) do
				var_13_0[#var_13_0 + 1] = iter_13_17
			end
		end

		if iter_13_5.arg_list.weapon_id then
			var_0_3.getWeaponResource(iter_13_5.arg_list.weapon_id, var_13_0)
		end

		if iter_13_5.arg_list.aircraft_id_list then
			for iter_13_18, iter_13_19 in ipairs(iter_13_5.arg_list.aircraft_id_list) do
				var_0_3.getWeaponResource(iter_13_19, var_13_0)
			end
		end

		if iter_13_5.arg_list.skin_id then
			for iter_13_20, iter_13_21 in ipairs((var_0_0.Battle.BattleResourceManager.GetEquipSkinBulletRes(iter_13_5.arg_list.skin_id))) do
				var_13_0[#var_13_0 + 1] = iter_13_21
			end
		end

		if iter_13_5.arg_list.ship_skin_id then
			var_13_0[#var_13_0 + 1] = var_0_0.Battle.BattleResourceManager.GetCharacterPath(var_0_3.GetPlayerShipSkinDataFromID(iter_13_5.arg_list.ship_skin_id).prefab)
		end

		if iter_13_5.arg_list.buff_id then
			for iter_13_22, iter_13_23 in ipairs((var_0_3.GetResFromBuff(iter_13_5.arg_list.buff_id, arg_13_1, arg_13_2, arg_13_3))) do
		...
		if iter_13_5.arg_list.buff_skin_id then
			for iter_13_26, iter_13_27 in ipairs((var_0_3.GetResFromBuff(iter_13_5.arg_list.buff_skin_id, arg_13_1, arg_13_2, arg_13_3))) do
		...
		if iter_13_5.arg_list.effect then
			var_13_0[#var_13_0 + 1] = var_0_0.Battle.BattleResourceManager.GetFXPath(iter_13_5.arg_list.effect)
		end
	end
...
function ys.Battle.BattleDataFunction.GetBuffListRes(arg_14_0, arg_14_1, arg_14_2)
	...
	for iter_14_0, iter_14_1 in ipairs(arg_14_0) do
		for iter_14_2, iter_14_3 in ipairs(var_0_3.GetResFromBuff(iter_14_1.id, iter_14_1.level, var_14_1, arg_14_2)) do
	...
	local function var_15_2(arg_16_0)
		for iter_16_0, iter_16_1 in ipairs(arg_16_0) do
			...
			if iter_16_1.arg_list.weapon_id ~= nil then
				var_0_3.getWeaponResource(iter_16_1.arg_list.weapon_id, var_15_0)
			end

			if iter_16_1.arg_list.buff_id then
				for iter_16_10, iter_16_11 in ipairs((var_0_3.GetResFromBuff(iter_16_1.arg_list.buff_id, arg_15_1, arg_15_2))) do
					var_15_0[#var_15_0 + 1] = iter_16_11
				end
			end

			if iter_16_1.arg_list.damage_buff_id then
				for iter_16_12, iter_16_13 in ipairs((var_0_3.GetResFromBuff(iter_16_1.arg_list.damage_buff_id, iter_16_1.arg_list.damage_buff_lv or 1, arg_15_2))) do
					var_15_0[#var_15_0 + 1] = iter_16_13
				end
			end

			if iter_16_1.arg_list.effect then
				var_15_0[#var_15_0 + 1] = var_0_0.Battle.BattleResourceManager.GetFXPath(iter_16_1.arg_list.effect)
			end

			if iter_16_1.arg_list.finale_effect then
				var_15_0[#var_15_0 + 1] = var_0_0.Battle.BattleResourceManager.GetFXPath(iter_16_1.arg_list.finale_effect)
			end

			if iter_16_1.arg_list.spawnData then
				for iter_16_14, iter_16_15 in ipairs((var_0_0.Battle.BattleResourceManager.GetMonsterRes(iter_16_1.arg_list.spawnData))) do
...
function ys.Battle.BattleDataFunction:GetShipSkillTriggerCount(arg_17_1)
	...
	local var_17_1 = 0 + var_17_0(self.skills or {})
	local var_17_2 = {}

	for iter_17_0, iter_17_1 in ipairs((var_0_3.GetEquipSkill(self.equipment))) do
		table.insert(var_17_2, {
			id = iter_17_1.buffID
		})
	end

	return var_17_1 + var_17_0(var_17_2)
end
...
function ys.Battle.BattleDataFunction.NeedSkillPainting(arg_22_0)
	return not not var_0_3.GetSkillTemplate(arg_22_0).focus_duration
end
