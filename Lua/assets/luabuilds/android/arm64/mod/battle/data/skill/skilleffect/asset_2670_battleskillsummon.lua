...
function ys.Battle.BattleSkillSummon:Ctor(arg_1_1)
	var_0_3.super.Ctor(self, arg_1_1, lv)
...
function ys.Battle.BattleSkillSummon:DoDataEffectWithoutTarget(arg_2_1, arg_2_2)
	self:DoSummon(arg_2_1, arg_2_2)

	return
end

function ys.Battle.BattleSkillSummon:DoDataEffect(arg_3_1, arg_3_2, arg_3_3)
	self:DoSummon(arg_3_1, arg_3_3)

	return
end

function ys.Battle.BattleSkillSummon:DoSummon(arg_4_1, arg_4_2)
	local var_4_0 = var_0_0.Battle.BattleDataProxy.GetInstance()
	local var_4_1

	if arg_4_1:GetUnitType() == var_0_1.UnitType.PLAYER_UNIT then
		var_4_1 = var_4_0:SpawnNPC(self._spawnData, arg_4_1)
	else
		var_4_1 = var_4_0:SpawnMonster(self._spawnData, arg_4_1:GetWaveIndex(), var_0_1.UnitType.ENEMY_UNIT, (arg_4_1:GetIFF()))

		var_4_1:SetMaster(arg_4_1)

		if self._spawnData.relativeCorrdinate then
			local var_4_2 = arg_4_1:GetPosition()
			local var_4_3 = var_0_2.RandomPos(self._spawnData.relativeCorrdinate)
