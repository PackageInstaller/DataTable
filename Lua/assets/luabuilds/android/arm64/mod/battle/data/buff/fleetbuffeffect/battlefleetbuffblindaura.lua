...
function ys.Battle.BattleFleetBuffBlindAura.SetArgs(arg_2_0, arg_2_1, arg_2_2)
	local var_2_0 = arg_2_0._tempData.arg_list.target

	arg_2_0._aura = var_0_0.Battle.BattleDataProxy.GetInstance():SpawnLastingCubeArea(var_0_1.AOEField.SURFACE, arg_2_1:GetIFF(), Vector3(-55, 0, 55), 180, 70, 0, function(arg_3_0)
		...
		if arg_4_0.Active then
			for iter_4_0, iter_4_1 in ipairs((arg_2_0:getTargetList(arg_2_1, var_2_0, arg_2_0._tempData.arg_list))) do
...
function ys.Battle.BattleFleetBuffBlindAura.Clear(arg_5_0)
