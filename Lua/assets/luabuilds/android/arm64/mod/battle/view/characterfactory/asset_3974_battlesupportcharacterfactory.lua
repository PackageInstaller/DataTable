...
local var_0_0 = ys
local var_0_1 = singletonClass("BattleSupportCharacterFactory", ys.Battle.BattleCharacterFactory)

ys.Battle.BattleSupportCharacterFactory = var_0_1
...
function var_0_1.MakeCharacter(arg_2_0)
	return var_0_0.Battle.BattleSupportCharacter.New()
end
