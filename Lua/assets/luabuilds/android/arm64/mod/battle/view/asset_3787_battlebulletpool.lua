...
function var_0_0:InstantiateBullet(arg_3_1, arg_3_2)
	if self._bulletResCache[arg_3_1] ~= nil then
		arg_3_2(self._bulletResCache[arg_3_1])
	else
		ResourceMgr.Inst:getAssetAsync("Item/" .. arg_3_1, "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_4_0)
			...
			self._bulletResCache[arg_3_1] = arg_4_0
