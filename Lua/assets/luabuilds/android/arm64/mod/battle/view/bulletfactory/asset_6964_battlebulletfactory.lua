...
function ys.Battle.BattleBulletFactory:RecyleTempModel(arg_2_1)
	self._tempGOPool:Recycle(arg_2_1)

	return
end

function ys.Battle.BattleBulletFactory:Clear()
...
function ys.Battle.BattleBulletFactory:CreateBullet(arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5)
	arg_4_2:SetOutRangeCallback(self.OutRangeFunc)

	local var_4_0 = self:MakeBullet()

	var_4_0:SetFactory(self)
	var_4_0:SetBulletData(arg_4_2)
	self:MakeModel(var_4_0, arg_4_3, arg_4_4, arg_4_5)

	if arg_4_4 and arg_4_4 ~= "" then
		self:PlayFireFX(arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5, nil)
	end
...
function ys.Battle.BattleBulletFactory:OutRangeFunc()
	var_0_2.GetDataProxy():RemoveBulletUnit(self:GetUniqueID())

	return
end

function ys.Battle.BattleBulletFactory:GetTempGOPool()
	if self._tempGOPool == nil then
		local var_10_0 = GameObject("temp_bullet_OBJ")

		SetActive(var_10_0, false)

		local var_10_1 = self:GetSceneMediator():GetBulletRoot().transform

		LuaHelper.SetGOParentTF(var_10_0, var_10_1, false)

		self._tempGOPool = pg.Pool.New(var_10_1, var_10_0, 1, 15, false, false):InitSize()
	end

	return self._tempGOPool
end

function ys.Battle.BattleBulletFactory:PlayFireFX(arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5, arg_11_6)
	...
	if arg_11_4 == "" or arg_11_4 == nil then
		...
		if var_11_0 then
			var_11_1, var_11_2 = self:GetFXPool():GetFX(arg_11_4, arg_11_1)
		else
			var_11_1, var_11_2 = self:GetFXPool():GetFX(arg_11_4)
...
function ys.Battle.BattleBulletFactory:MakeBombPreCastAlter(arg_14_1, arg_14_2)
	return self:MakeModel(arg_14_1, arg_14_2)
end
...
function ys.Battle.BattleBulletFactory:GetRandomBone()
	return self[math.floor(math.Random(0, #self)) + 1]
end
