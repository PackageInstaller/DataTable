...
local var_0_2 = class("BattleGuildBossCommand", ys.Battle.BattleSingleDungeonCommand)

ys.Battle.BattleGuildBossCommand = var_0_2
var_0_2.__name = "BattleGuildBossCommand"
...
function var_0_2.onInitBattle(arg_7_0)
	...
	arg_7_0._specificEnemyList = var_0.Battle.BattleDataFunction.GetSpecificGuildBossEnemyList(var_7_0.ActID, var_7_0.StageTmpId)
...
function var_0_2.calcDamageData(arg_11_0)
	arg_11_0._dataProxy:CalcGuildBossEnemyInfo(arg_11_0._dataProxy:GetInitData().ActID)
