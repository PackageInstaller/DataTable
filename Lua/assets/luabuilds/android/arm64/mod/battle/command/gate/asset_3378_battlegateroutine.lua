...
function BattleGateRoutine:Entrance(arg_1_1)
	...
	local var_1_2 = pg.battle_cost_template[SYSTEM_ROUTINE]
	local var_1_3 = pg.battle_cost_template[SYSTEM_ROUTINE].oil_cost > 0
	local var_1_4 = {}
	local var_1_9 = getProxy(FleetProxy):getFleetById(self.mainFleetId)
	local var_1_10 = var_1_1:getSortShipsByFleet(var_1_9)
	...
	arg_1_1.ShipVertify()
	BeginStageCommand.SendRequest(SYSTEM_ROUTINE, var_1_4, {
		self.stageId
	}, function(arg_2_0)
		if var_1_3 then
			var_1_12:consume({
...
function BattleGateRoutine:Exit(arg_4_1)
	...
	arg_4_1:SendRequest(arg_4_1.GeneralPackage(self, (getProxy(BayProxy):getSortShipsByFleet(var_4_4))), function(arg_5_0)
		...
		arg_4_1.GeneralPlayerCosume(SYSTEM_ROUTINE, var_4_1 > ys.Battle.BattleConst.BattleScore.C, var_4_5, arg_5_0.player_exp, exFlag)
