local GetBackYardVisitorCommand = class("GetBackYardVisitorCommand", pm.SimpleCommand)

function GetBackYardVisitorCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(19024, {
		...
		self:sendNotification(GAME.BACKYARD_GET_VISITOR_SHIP_DONE)
...
return GetBackYardVisitorCommand
