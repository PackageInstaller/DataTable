local BackYardDeleteThemeCommand = class("BackYardDeleteThemeCommand", pm.SimpleCommand)

function BackYardDeleteThemeCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(19022, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.DELETE_BACKYARD_THEME_DONE)
...
return BackYardDeleteThemeCommand
