local BackYardRequestPopEventCommand = class("BackYardRequestPopEventCommand", pm.SimpleCommand)

function BackYardRequestPopEventCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(19009, {
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.pop_list) do
			...
			self:sendNotification(DormProxy.INIMACY_AND_MONEY_ADD, {
				id = iter_2_1.id,
...
return BackYardRequestPopEventCommand
