local BackYardSeachThemeTemplateCommand = class("BackYardSeachThemeTemplateCommand", pm.SimpleCommand)

function BackYardSeachThemeTemplateCommand:execute(arg_1_1)
	local var_1_0 = arg_1_1:getBody().str

	if not var_1_0 or var_1_0 == "" then
		self:sendNotification(GAME.BACKYARD_SEARCH_THEME_TEMPLATE_ERRO)

		return
	end

	local function var_1_1(arg_2_0)
		self:sendNotification(GAME.BACKYARD_SEARCH_THEME_TEMPLATE_DONE, {
...
return BackYardSeachThemeTemplateCommand
