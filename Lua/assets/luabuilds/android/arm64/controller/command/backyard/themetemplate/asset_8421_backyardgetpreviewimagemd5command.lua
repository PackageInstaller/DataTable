local BackYardGetPreviewImageMd5Command = class("BackYardGetPreviewImageMd5Command", pm.SimpleCommand)

function BackYardGetPreviewImageMd5Command:execute(arg_1_1)
	local var_1_0 = arg_1_1:getBody()
	local var_1_1 = var_1_0.type
	local var_1_2 = var_1_0.callback
	local var_1_3 = getProxy(DormProxy)
	local var_1_4 = self:GetListByType(var_1_0.type)
	...
	pg.ConnectionMgr.GetInstance():Send(19131, {
		...
		for iter_2_2, iter_2_3 in pairs(var_1_4) do
			if not var_2_0[iter_2_3.id] then
				self:DeleteByType(var_1_1, iter_2_3.id)
			else
				self:UpdateMd5ByType(var_1_1, iter_2_3.id, var_2_0[iter_2_3.id])
			end
		end
...
function BackYardGetPreviewImageMd5Command:GetListByType(arg_3_1)
...
function BackYardGetPreviewImageMd5Command:DeleteByType(arg_4_1, arg_4_2)
...
function BackYardGetPreviewImageMd5Command:UpdateMd5ByType(arg_5_1, arg_5_2, arg_5_3)
...
return BackYardGetPreviewImageMd5Command
