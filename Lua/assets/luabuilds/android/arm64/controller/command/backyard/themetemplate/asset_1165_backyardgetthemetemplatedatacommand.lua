local BackYardGetThemeTemplateDataCommand = class("BackYardGetThemeTemplateDataCommand", pm.SimpleCommand)

function BackYardGetThemeTemplateDataCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(19113, {
		...
		if arg_2_0.result == 0 then
			...
			if var_2_1:GetShopThemeTemplateById(var_1_1) then
				var_2_1:UpdateShopThemeTemplate(var_2_0)
			end

			if var_2_1:GetCollectionThemeTemplateById(var_1_1) then
			...
			self:sendNotification(GAME.BACKYARD_GET_THEME_TEMPLATE_DATA_DONE, {
				template = var_2_0
			})
		elseif arg_2_0.result == 20 then
			local var_2_2 = getProxy(DormProxy)

			if var_2_2:GetShopThemeTemplateById(var_1_1) then
				var_2_2:DeleteShopThemeTemplate(var_1_1)
			end

			if var_2_2:GetCollectionThemeTemplateById(var_1_1) then
				var_2_2:DeleteCollectionThemeTemplate(var_1_1)
			end
...
return BackYardGetThemeTemplateDataCommand
