local PutFurnitureCommand = class("PutFurnitureCommand", pm.SimpleCommand)

function PutFurnitureCommand:execute(arg_1_1)
	...
	local var_1_5, var_1_6 = CourtYardRawDataChecker.Check(var_1_0.furnsPos, var_1_1:getRawData():GetMapSize())
	...
	self:sendNotification(GAME.PUT_FURNITURE_DONE)
