local BackYardUploadThemeTemplateCommand = class("BackYardUploadThemeTemplateCommand", pm.SimpleCommand)

function BackYardUploadThemeTemplateCommand:execute(arg_1_1)
	...
	local function var_1_2(arg_8_0)
		...
		self:sendNotification(GAME.BACKYARD_UPLOAD_THEME_TEMPLATE_DONE)
...
return BackYardUploadThemeTemplateCommand
