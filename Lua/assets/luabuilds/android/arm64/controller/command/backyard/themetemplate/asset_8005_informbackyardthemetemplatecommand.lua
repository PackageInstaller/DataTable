local InformBackYardThemeTemplateCommand = class("InformBackYardThemeTemplateCommand", pm.SimpleCommand)

function InformBackYardThemeTemplateCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(19129, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.INFORM_THEME_TEMPLATE_DONE)
...
return InformBackYardThemeTemplateCommand
