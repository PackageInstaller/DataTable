local BackYardUnloadThemeTemplateCommand = class("BackYardUnloadThemeTemplateCommand", pm.SimpleCommand)

function BackYardUnloadThemeTemplateCommand:execute(arg_1_1)
	local var_1_0 = getProxy(DormProxy)
	local var_1_1 = var_1_0:GetCustomThemeTemplateById(arg_1_1:getBody().templateId)
	...
	local function var_1_3(arg_8_0)
		...
		self:sendNotification(GAME.BACKYARD_UNLOAD_THEME_TEMPLATE_DONE)
...
return BackYardUnloadThemeTemplateCommand
