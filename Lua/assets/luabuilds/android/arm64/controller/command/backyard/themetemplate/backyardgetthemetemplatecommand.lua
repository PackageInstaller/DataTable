...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	local function var_1_4(arg_2_0, arg_2_1)
		if var_1_1 == BackYardConst.THEME_TEMPLATE_TYPE_SHOP then
			local var_2_0 = arg_2_0.theme_id_list or {}
			...
			var_1_3:SetShopThemeTemplates({})
		elseif var_1_1 == BackYardConst.THEME_TEMPLATE_TYPE_CUSTOM then
			local var_2_3 = arg_2_0.theme_list or {}

			for iter_2_2, iter_2_3 in ipairs(var_2_3) do
				({})[(nil).id] = BackYardSelfThemeTemplate.New(iter_2_3)
			end

			var_1_3:SetCustomThemeTemplates({})
		elseif var_1_1 == BackYardConst.THEME_TEMPLATE_TYPE_COLLECTION then
			local var_2_5 = arg_2_0.theme_profile_list or {}

			for iter_2_4, iter_2_5 in ipairs(var_2_5) do
				({})[(nil).id] = BackYardThemeTemplate.New({
					id = iter_2_5.id,
					upload_time = iter_2_5.upload_time
				})
			end

			var_1_3:SetCollectionThemeTemplates({})
		end
