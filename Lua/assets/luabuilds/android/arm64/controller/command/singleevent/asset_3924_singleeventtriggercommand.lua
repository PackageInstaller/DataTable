local SingleEventTriggerCommand = class("SingleEventTriggerCommand", pm.SimpleCommand)

function SingleEventTriggerCommand:execute(arg_1_1)
...
return SingleEventTriggerCommand
