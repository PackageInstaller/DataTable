local ApartmentRoomInviteUnlockCommand = class("ApartmentRoomInviteUnlockCommand", pm.SimpleCommand)

function ApartmentRoomInviteUnlockCommand:execute(arg_1_1)
	local var_1_0 = arg_1_1:getBody()
	local var_1_1 = var_1_0.roomId
	local var_1_2 = var_1_0.groupId
	local var_1_3 = getProxy(ApartmentProxy)
	local var_1_4 = var_1_3:getRoom(var_1_0.roomId)
	...
	if not var_1_4 or var_1_4.unlockCharacter[var_1_2] then
		pg.TipsMgr.GetInstance():ShowTips("unlock error:%d, %d", var_1_4 and var_1_0.roomId or 0, (var_1_4 or nil) and (var_1_4.unlockCharacter[var_1_2] or 0))
	...
	pg.ConnectionMgr.GetInstance():Send(28019, {
		...
		if arg_4_0.result == 0 then
			...
			self:sendNotification(GAME.APARTMENT_ROOM_INVITE_UNLOCK_DONE, {
				roomId = var_1_1,
				groupId = var_1_2
			})
		else
...
return ApartmentRoomInviteUnlockCommand
