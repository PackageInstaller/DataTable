...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_4:getRoom(var_1_0.roomId).collectItemDic[var_1_0.itemId] then
	...
	pg.ConnectionMgr.GetInstance():Send(28011, {
		...
		if arg_2_0.result == 0 then
			var_1_4:ModifyRoom(var_1_1, function(arg_3_0)
				arg_3_0.collectItemDic[var_1_3] = true

				return
			end)

			if var_0.award > 0 then
				local var_2_0, var_2_1 = var_1_4:triggerFavor(var_1_2, var_0.award)

				arg_1_0:sendNotification(GAME.APARTMENT_TRIGGER_FAVOR_DONE, {
					triggerId = var_0.award,
					cost = var_2_1,
					delta = var_2_0,
					apartment = var_1_5
				})
