local Dorm3dChatCommand = class("Dorm3dChatCommand", pm.SimpleCommand)

function Dorm3dChatCommand:execute(arg_1_1)
		...
		pg.ConnectionMgr.GetInstance():Send(28028, {
			...
			if arg_2_0.result == 0 then
				...
				if var_1_0.isRedPacket then
					self:sendNotification(GAME.APARTMENT_CHAT_OP_DONE, {
