local UserLoginCommand = class("UserLoginCommand", pm.SimpleCommand)

function UserLoginCommand:execute(arg_1_1)
	...
	if var_1_0.arg4 == "0" then
		var_1_2 = var_1_0.arg3 or var_1_0.arg4
	end
	...
	pg.ConnectionMgr.GetInstance():Connect(NetConst.GATEWAY_HOST, NetConst.GATEWAY_PORT, function()
		pg.ConnectionMgr.GetInstance():Send(10020, {
			...
			if arg_3_0.result == 0 then
				...
				self.facade:sendNotification(GAME.USER_LOGIN_SUCCESS, var_1_0)
				...
				elseif arg_3_0.result == 6 then
					...
					self.facade:sendNotification(GAME.USER_LOGIN_FAILED, arg_3_0.result)
				end
			end
