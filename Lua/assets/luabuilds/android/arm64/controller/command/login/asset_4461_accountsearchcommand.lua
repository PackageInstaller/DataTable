local AccountSearchCommand = class("AccountSearchCommand", pm.SimpleCommand)

function AccountSearchCommand:execute(arg_1_1)
	...
	for iter_1_0, iter_1_1 in pairs(getProxy(ServerProxy).data) do
		table.insert(var_1_4, function(arg_2_0)
			local var_2_0
