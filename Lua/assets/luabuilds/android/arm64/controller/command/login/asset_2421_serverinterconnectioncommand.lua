local ServerInterconnectionCommand = class("ServerInterconnectionCommand", pm.SimpleCommand)

function ServerInterconnectionCommand:execute(arg_1_1)
	...
	if var_1_2:ShouldSwitchGateway(var_1_0.platform or PLATFORM, var_1_0.user.arg2) then
		...
		if not var_1_5 then
			self:GetGateWayByServer(var_1_4, function(arg_3_0)
...
function ServerInterconnectionCommand:GetGateWayByServer(arg_4_1, arg_4_2)
...
return ServerInterconnectionCommand
