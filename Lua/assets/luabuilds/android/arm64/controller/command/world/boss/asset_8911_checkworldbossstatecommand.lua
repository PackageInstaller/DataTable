local CheckWorldBossStateCommand = class("CheckWorldBossStateCommand", pm.SimpleCommand)

function CheckWorldBossStateCommand:execute(arg_1_1)
	...
	local function var_1_5()
		...
		for iter_2_0, iter_2_1 in ipairs((var_2_0:GetMessagesByUniqueId(var_1_1 .. "_" .. var_1_3))) do
		...
		for iter_2_2, iter_2_3 in ipairs((var_2_1:GetMessagesByUniqueId(var_1_1 .. "_" .. var_1_3))) do
	...
	print("boss id", var_1_0.bossId, " time:", var_1_3)
...
return CheckWorldBossStateCommand
