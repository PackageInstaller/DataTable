...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_0.isSimulate then
		local var_1_8 = WorldBossConst.GetCurrBossID() == var_1_1 and pg.world_joint_boss_template[var_1_1].boss_level_id + var_1_5.currentBossLV - 1 or pg.world_joint_boss_template[var_1_1].boss_level_id + 14

		var_1_7 = pg.world_boss_level[var_1_8].expedition_id
	else
		if not var_1_6 then
