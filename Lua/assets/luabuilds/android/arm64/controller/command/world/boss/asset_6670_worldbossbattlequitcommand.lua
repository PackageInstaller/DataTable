local WorldBossBattleQuitCommand = class("WorldBossBattleQuitCommand", pm.SimpleCommand)

function WorldBossBattleQuitCommand:execute(arg_1_1)
...
return WorldBossBattleQuitCommand
