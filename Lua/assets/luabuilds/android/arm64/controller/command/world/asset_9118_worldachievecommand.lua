local WorldAchieveCommand = class("WorldAchieveCommand", pm.SimpleCommand)

function WorldAchieveCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(33602, var_1_0, 33603, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.WORLD_ACHIEVE_DONE, {
				list = var_1_0.list,
