local WorldFleetRedeployCommand = class("WorldFleetRedeployCommand", pm.SimpleCommand)

function WorldFleetRedeployCommand:execute(arg_1_1)
	pg.ConnectionMgr.GetInstance():Send(1, arg_1_1:getBody(), 2, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.WORLD_FLEET_REDEPLOY_DONE)
		else
...
return WorldFleetRedeployCommand
