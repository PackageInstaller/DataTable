local WorldBossSupportCommand = class("WorldBossSupportCommand", pm.SimpleCommand)

function WorldBossSupportCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(34509, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.WORLD_BOSS_SUPPORT_DONE)
		else
...
return WorldBossSupportCommand
