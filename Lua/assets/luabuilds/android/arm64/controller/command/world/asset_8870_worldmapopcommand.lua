local WorldMapOpCommand = class("WorldMapOpCommand", pm.SimpleCommand)

function WorldMapOpCommand:execute(arg_1_1)
	...
	var_1_1.group_id = var_1_0.id or 0
	var_1_1.act_arg_1 = var_1_0.arg1
	var_1_1.act_arg_2 = var_1_0.arg2
	var_1_1.pos_list = var_1_0.locations or {}

	pg.ConnectionMgr.GetInstance():Send(33103, var_1_1, 33104, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			if var_1_0.op == WorldConst.OpReqMoveFleet then
				self:BuildFleetMove(arg_2_0.move_path, var_1_0)
			elseif var_1_0.op == WorldConst.OpReqRetreat then
				var_1_0.childOps = self:BuildAIAction(arg_2_0)
			elseif var_1_0.op == WorldConst.OpReqEvent then
				if var_1_0.effect.effect_type == WorldMapAttachment.EffectEventTeleport or var_1_0.effect.effect_type == WorldMapAttachment.EffectEventTeleportBack then
					self:BuildTransfer(arg_2_0, var_1_0)
				elseif var_1_0.effect.effect_type == WorldMapAttachment.EffectEventProgress then
					var_1_0.childOps = self:BuildProgressAction(var_1_0.effect.effect_paramater[1])
				elseif var_1_0.effect.effect_type == WorldMapAttachment.EffectEventBlink1 or var_1_0.effect.effect_type == WorldMapAttachment.EffectEventBlink2 then
					var_1_0.childOps = self:BuildBlinkAction(var_1_0.attachment, var_1_0.updateAttachmentCells)
				end
		...
		self:sendNotification(GAME.WORLD_MAP_OP_DONE, {
...
function WorldMapOpCommand:BuildAIAction(arg_3_1)
	local var_3_0 = {}
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_1.ai_act_list) do
		...
		var_3_2 = iter_3_1.type == WorldMapAttachment.TypeFleet and self:BuildFleetAction(iter_3_1) or iter_3_1.type == WorldMapAttachment.TypeTrap and self:BuildTrapAction(iter_3_1) or self:BuildAttachmentAction(iter_3_1)
...
function WorldMapOpCommand:BuildTransfer(arg_4_1, arg_4_2)
...
function WorldMapOpCommand:BuildFleetMove(arg_5_1, arg_5_2)
	local var_5_0 = {}
	...
	if #arg_5_1 > 0 then
		...
		var_5_0 = table.mergeArray(var_5_0, self:BuildFleetMoveAction(arg_5_1, var_5_1, var_5_2.id, var_5_2.row, var_5_2.column, arg_5_2.updateAttachmentCells, true))
...
function WorldMapOpCommand:BuildFleetPath(arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	_.each(arg_6_1, function(arg_9_0)
		...
		if #var_6_5 > 0 then
			...
			for iter_9_0, iter_9_1 in ipairs(var_6_5) do
				...
				var_9_1:UpdateOffset(var_6_6[#var_9_0.updateCarryItems + 1][#var_6_2 + 1].row - arg_9_0.row, var_6_6[#var_9_0.updateCarryItems + 1][#var_6_2 + 1].column - arg_9_0.column)
...
function WorldMapOpCommand:BuildFleetAction(arg_12_1)
	...
	if #arg_12_1.move_path > 0 then
		var_12_3 = self:BuildFleetMoveAction(arg_12_1.move_path, var_12_0, var_12_1.id, var_12_1.row, var_12_1.column, var_12_2)
	else
...
function WorldMapOpCommand:BuildFleetMoveAction(arg_13_1, arg_13_2, arg_13_3, arg_13_4, arg_13_5, arg_13_6, arg_13_7)
	local var_13_0 = {}
	local var_13_1

	if arg_13_7 then
		var_13_1 = WorldMapCell.TerrainNone or arg_13_2:GetCell(arg_13_4, arg_13_5):GetTerrain()
	end
	...
	for iter_13_0, iter_13_1 in ipairs(arg_13_1) do
		...
		if iter_13_0 == #arg_13_1 or var_13_9 then
			...
			self:BuildFleetPath(var_13_5, var_13_3, var_13_11, arg_13_6)
...
function WorldMapOpCommand:BuildAttachmentAction(arg_14_1)
	...
	if #arg_14_1.move_path > 0 then
		...
		self:BuildAttachmentActionPath(arg_14_1.move_path, var_14_3)
	else
...
function WorldMapOpCommand:BuildAttachmentActionPath(arg_15_1, arg_15_2)
	assert(nowWorld():GetActiveMap(), "active map not exist.")
...
function WorldMapOpCommand:BuildTrapAction(arg_17_1)
	...
	var_17_2.op = WorldConst.OpActionCameraMove
	var_17_2.attachment = var_17_0

	table.insert(var_17_1, var_17_2)

	local var_17_3 = WBank:Fetch(WorldMapOp)

	var_17_3.op = WorldConst.OpActionTrapGravityAnim
	var_17_3.attachment = var_17_0
...
function WorldMapOpCommand:BuildBlinkAction(arg_18_1, arg_18_2)
	local var_18_0 = {}
	...
	elseif var_18_1 == WorldMapAttachment.SpEventFufen then
		...
		if var_18_6 < PathFinding.PrioObstacle then
			...
			self:BuildAttachmentActionPath(var_18_7, var_18_8)
...
function WorldMapOpCommand:BuildProgressAction(arg_21_1)
	local var_21_0 = {}
