local WorldTriggerDailyTaskCommand = class("WorldTriggerDailyTaskCommand", pm.SimpleCommand)

function WorldTriggerDailyTaskCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(7, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.WORLD_TRIGGER_DAILY_TASK_DONE)
...
return WorldTriggerDailyTaskCommand
