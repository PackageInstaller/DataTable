local WorldTriggerTaskCommand = class("WorldTriggerTaskCommand", pm.SimpleCommand)

function WorldTriggerTaskCommand:execute(arg_1_1)
...
return WorldTriggerTaskCommand
