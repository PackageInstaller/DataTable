local DealMailOperationCommand = class("DealMailOperationCommand", pm.SimpleCommand)

function DealMailOperationCommand:execute(arg_1_1)
		...
		table.insert(var_1_8, function(arg_8_0, arg_8_1)
			...
			if not var_8_1 then
				...
				if var_8_0 then
					...
					self:sendNotification(GAME.MAIL_DOUBLE_CONFIREMATION_MSGBOX, {
	...
	seriesAsync(var_1_7, function(arg_25_0)
		self:sendNotification(GAME.DEAL_MAIL_OPERATION_DONE, {
			cmd = var_1_1,
...
return DealMailOperationCommand
