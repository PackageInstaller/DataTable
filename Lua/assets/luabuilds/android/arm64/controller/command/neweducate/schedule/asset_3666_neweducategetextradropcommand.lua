local NewEducateGetExtraDropCommand = class("NewEducateGetExtraDropCommand", pm.SimpleCommand)

function NewEducateGetExtraDropCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29048, {
		...
		if arg_2_0.result == 0 then
			self:sendNotification(GAME.NEW_EDUCATE_GET_EXTRA_DROP_DONE, {
...
return NewEducateGetExtraDropCommand
