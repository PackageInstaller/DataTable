local NewEducateGetTalentsCommand = class("NewEducateGetTalentsCommand", pm.SimpleCommand)

function NewEducateGetTalentsCommand:execute(arg_1_1)
...
return NewEducateGetTalentsCommand
