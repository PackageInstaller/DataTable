local NewEducateGiveUpChoiceCommand = class("NewEducateGiveUpChoiceCommand", pm.SimpleCommand)

function NewEducateGiveUpChoiceCommand:execute(arg_1_1)
	pg.ConnectionMgr.GetInstance():Send(29101, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.NEW_EDUCATE_GIVE_UP_CHOICE_DONE, {
...
return NewEducateGiveUpChoiceCommand
