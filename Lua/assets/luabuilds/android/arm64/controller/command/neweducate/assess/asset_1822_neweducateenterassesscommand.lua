local NewEducateEnterAssessCommand = class("NewEducateEnterAssessCommand", pm.SimpleCommand)

function NewEducateEnterAssessCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29050, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.NEW_EDUCATE_ENTER_ASSESS_DONE, {
...
return NewEducateEnterAssessCommand
