local NewEducateMapEventCommand = class("NewEducateMapEventCommand", pm.SimpleCommand)

function NewEducateMapEventCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29064, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.NEW_EDUCATE_MAP_EVENT_DONE, {
...
return NewEducateMapEventCommand
