local NewEducateSelMindCommand = class("NewEducateSelMindCommand", pm.SimpleCommand)

function NewEducateSelMindCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29090, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.NEW_EDUCATE_SEL_MIND_DONE, {
...
return NewEducateSelMindCommand
