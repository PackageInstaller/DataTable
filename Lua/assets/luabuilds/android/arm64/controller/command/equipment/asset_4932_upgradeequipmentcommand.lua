local UpGradeEquipmentCommands = class("UpGradeEquipmentCommands", pm.SimpleCommand)

function UpGradeEquipmentCommands:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(var_1_1 and 14002 or 14004, var_1_9, var_1_8, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.UPGRADE_EQUIPMENTS_DONE, {
				ship = var_2_4,
				equip = var_2_5,
				newEquip = var_1_4
			})
...
return UpGradeEquipmentCommands
