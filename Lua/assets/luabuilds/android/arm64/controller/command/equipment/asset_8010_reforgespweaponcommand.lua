local ReforgeSpWeaponCommand = class("ReforgeSpWeaponCommand", pm.SimpleCommand)

function ReforgeSpWeaponCommand:execute(arg_1_1)
	...
	if not (function()
		...
		if not _.all(var_2_0:GetUpgradeConfig().reset_use_item, function(arg_4_0)
			return arg_4_0[2] <= ((var_2_2[arg_4_0[1]] or nil) and (var_2_2[arg_4_0[1]].count or 0))
		end) then
	...
	pg.ConnectionMgr.GetInstance():Send(14205, {
		...
		if arg_5_0.result == 0 then
			...
			self:sendNotification(GAME.REFORGE_SPWEAPON_DONE, var_5_0)
		else
