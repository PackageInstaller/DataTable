local NewServerShopShoppingCommand = class("NewServerShopShoppingCommand", pm.SimpleCommand)

function NewServerShopShoppingCommand:execute(arg_1_1)
	...
	local var_1_15 = var_1_10:getConfig("type")
	local var_1_16 = var_1_10:getConfig("goods")[1]
	local var_1_17 = var_1_10:getConfig("num")

	if var_1_15 == 1 then
		if var_1_16 == 1 and var_1_9:GoldMax(var_1_17 * var_1_7) then
			pg.TipsMgr.GetInstance():ShowTips(i18n("gold_max_tip_title") .. i18n("resource_max_tip_shop"))

			return
		end

		if var_1_16 == 2 and var_1_9:OilMax(var_1_17 * var_1_7) then
	...
	if DROP_TYPE_ITEM == var_1_15 and var_1_18.type == Item.EXP_BOOK_TYPE then
		if getProxy(BagProxy):getItemCountById(var_1_16) + var_1_17 * var_1_7 > var_1_18.max_num then
	...
	pg.ConnectionMgr.GetInstance():Send(26043, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_0:consume({
				[id2res((var_1_10:getConfig("resource_type")))] = var_1_12 * var_1_7
			})
			var_1_8:updatePlayer(var_2_0)
			self:sendNotification(GAME.NEW_SERVER_SHOP_SHOPPING_DONE, {
...
return NewServerShopShoppingCommand
