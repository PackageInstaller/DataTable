local QuotaShoppingCommand = class("QuotaShoppingCommand", pm.SimpleCommand)

QuotaShoppingCommand.QUOTA_SHOP = 4

function QuotaShoppingCommand:execute(arg_1_1)
	local var_1_0 = arg_1_1:getBody()
	local var_1_1 = var_1_0.id
	local var_1_2 = var_1_0.count
	local var_1_4 = getProxy(ShopsProxy)
	local var_1_5 = var_1_4:getQuotaShop():getGoodsCfg(var_1_0.id)
	...
	pg.ConnectionMgr.GetInstance():Send(16201, {
		id = var_1_0.id,
		type = QuotaShoppingCommand.QUOTA_SHOP,
		count = var_1_0.count
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.QUOTA_SHOPPING_DONE, {
