...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_3.type == DROP_TYPE_RESOURCE then
		...
		if var_1_3.effect_args[1] == 2 then
			local var_1_6 = var_1_3.num

			if var_1_3.num == -1 and var_1_3.genre == ShopArgs.BuyOil then
				var_1_6 = ShopArgs.getOilByLevel(var_1_5.level)
			end

			if var_1_5:OilMax(var_1_6 * var_1_0.count) then
				pg.TipsMgr.GetInstance():ShowTips(i18n("oil_max_tip_title") .. i18n("resource_max_tip_shop"))
	...
	table.insert({}, function(arg_5_0)
		if var_1_3.genre ~= ShopArgs.GiftPackage then
			if var_1_3.genre == ShopArgs.NewServerShop then
				...
				local var_5_0 = GetItemsOverflowDic({})
				local var_5_1, var_5_2 = CheckOverflow(var_5_0)
				...
				if not CheckShipExpOverflow(var_5_0) then
		...
		pg.ConnectionMgr.GetInstance():Send(16001, {
			...
			if arg_11_0.result == 0 then
						...
						if type(iter_11_1) == "table" and (var_1_3.type == DROP_TYPE_DORM3D_FURNITURE or var_1_3.type == DROP_TYPE_DORM3D_GIFT) then
							if iter_11_1[1] == "dailycount" then
								if var_1_3.type == DROP_TYPE_DORM3D_FURNITURE then
									local var_11_3 = getProxy(ApartmentProxy)
									local var_11_5 = var_1_3.effect_args[2] or 1

									var_11_3:AddDailyFurnitureShopCount(var_1_3.effect_args[1], var_11_5)
								elseif var_1_3.type == DROP_TYPE_DORM3D_GIFT then
									local var_11_6 = getProxy(ApartmentProxy)
									local var_11_8 = var_1_3.effect_args[2] or 1

									var_11_6:AddDailyGiftShopCount(var_1_3.effect_args[1], var_11_8)
								end
							elseif iter_11_1[1] == "count" then
								if var_1_3.type == DROP_TYPE_DORM3D_FURNITURE then
									local var_11_9 = getProxy(ApartmentProxy)
									local var_11_11 = var_1_3.effect_args[2] or 1

									var_11_9:AddPermanentFurnitureShopCount(var_1_3.effect_args[1], var_11_11)
								elseif var_1_3.type == DROP_TYPE_DORM3D_GIFT then
									local var_11_12 = getProxy(ApartmentProxy)
									local var_11_14 = var_1_3.effect_args[2] or 1

									var_11_12:AddPermanentGiftShopCount(var_1_3.effect_args[1], var_11_14)
								end
							end
						end
					end
				...
				if var_1_3.group_limit > 0 and (var_1_3.type == DROP_TYPE_DORM3D_FURNITURE or var_1_3.type == DROP_TYPE_DORM3D_GIFT) then
					if var_1_3.type == DROP_TYPE_DORM3D_FURNITURE then
						local var_11_15 = var_1_3.effect_args[2] or 1

						getProxy(ApartmentProxy):AddDailyFurnitureShopCount(var_1_3.effect_args[1], var_11_15)
					elseif var_1_3.type == DROP_TYPE_DORM3D_GIFT then
						local var_11_16 = var_1_3.effect_args[2] or 1

						getProxy(ApartmentProxy):AddDailyGiftShopCount(var_1_3.effect_args[1], var_11_16)
					end
				end
				...
				if var_1_3.type == 0 then
					...
					var_11_17 = PlayerConst.addTranDrop(arg_11_0.drop_list)
