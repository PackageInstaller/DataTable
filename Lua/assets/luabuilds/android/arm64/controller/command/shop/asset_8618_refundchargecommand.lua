local RefundChargeCommand = class("RefundChargeCommand", pm.SimpleCommand)

function RefundChargeCommand:execute(arg_1_1)
		...
		if arg_2_0.result == 0 then
			if var_1_1.tradeNoPrev ~= arg_2_0.pay_id then
				...
				do
					...
					pg.SdkMgr.GetInstance():SdkPay(var_1_4:getConfig("id_str"), var_1_4:getConfig("money") * 100, var_1_4:getConfig("name"), var_2_1 and var_1_4:getConfig("gem") * 2 or var_1_4:getConfig("gem") + var_1_4:getConfig("extra_gem"), arg_2_0.pay_id, var_1_4:getConfig("subject"), "-" .. var_2_2.id .. "-" .. arg_2_0.pay_id, var_2_2.name, arg_2_0.url or "", arg_2_0.order_sign or "")
				end
