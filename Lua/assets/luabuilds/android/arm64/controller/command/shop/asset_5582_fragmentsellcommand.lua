local FragmentSellCommand = class("FragmentSellCommand", pm.SimpleCommand)

function FragmentSellCommand:execute(arg_1_1)
	...
	for iter_1_0, iter_1_1 in pairs(var_1_0) do
		...
		var_1_4[var_1_5[1]] = (var_1_4[var_1_5[1]] or 0) + var_1_5[2] * iter_1_1.count
	...
	pg.ConnectionMgr.GetInstance():Send(15008, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.FRAG_SELL_DONE, {
				awards = var_2_0
			})
		else
