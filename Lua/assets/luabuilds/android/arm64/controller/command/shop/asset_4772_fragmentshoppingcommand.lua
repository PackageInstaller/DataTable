local FragmentShoppingCommand = class("FragmentShoppingCommand", pm.SimpleCommand)

FragmentShoppingCommand.FRAG_SHOP = 2
FragmentShoppingCommand.FRAG_NORMAL_SHOP = 3

function FragmentShoppingCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(16201, {
		id = var_1_0.id,
		type = (var_1_6:GetCommodityById(var_1_0.id).type == Goods.TYPE_FRAGMENT_NORMAL or nil) and FragmentShoppingCommand.FRAG_NORMAL_SHOP,
		count = var_1_0.count
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.FRAG_SHOPPING_DONE, {
...
return FragmentShoppingCommand
