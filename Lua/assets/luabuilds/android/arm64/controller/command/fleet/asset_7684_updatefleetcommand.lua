local UpdateFleetCommand = class("UpdateFleetCommand", pm.SimpleCommand)

function UpdateFleetCommand:execute(arg_1_1)
	...
	local var_1_5 = var_1_4:getFleetById(var_1_0.fleet.id)
	...
	pg.ConnectionMgr.GetInstance():Send(12102, {
		...
		if arg_5_0.result == 0 then
			...
			self:sendNotification(GAME.UPDATE_FLEET_DONE, var_1_1.id)
		else
