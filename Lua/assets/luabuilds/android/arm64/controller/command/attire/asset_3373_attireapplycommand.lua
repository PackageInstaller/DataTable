local AttireApplyCommand = class("AttireApplyCommand", pm.SimpleCommand)

function AttireApplyCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(11005, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.ATTIRE_APPLY_DONE)
		else
