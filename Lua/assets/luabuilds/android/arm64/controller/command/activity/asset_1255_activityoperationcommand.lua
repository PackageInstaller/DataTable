local ActivityOperationCommand = class("ActivityOperationCommand", pm.SimpleCommand)

function ActivityOperationCommand:execute(arg_1_1)
	...
	var_1_3.arg_list = var_1_0.arg_list or {}
	var_1_3.kvargs1 = var_1_0.kvargs1

	pg.ConnectionMgr.GetInstance():Send(11202, var_1_3, 11203, function(arg_7_0)
		if arg_7_0.result == 0 then
			...
			self:performance(var_1_0, arg_7_0, self:updateActivityData(var_1_0, arg_7_0, var_1_1, var_7_0), var_7_0)
		else
...
function ActivityOperationCommand:updateActivityData(arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	...
	switch(var_8_0, {
		...
		[ActivityConst.ACTIVITY_TYPE_MONTHSIGN] = function()
			if arg_8_3:getSpecialData("reMonthSignDay") ~= nil then
				...
				if arg_8_3.data3 then
					arg_8_3.data3 = arg_8_3.data3 + 1 or 1
				end
			else
			...
			if var_14_0 and not var_14_0:isEnd() then
				var_14_0.data1 = var_14_0.data1 + 1
				var_14_0.data2 = var_14_0.data2 + 1
				var_14_0.data3 = math.max(var_14_0.data3, var_14_0.data2)

				for iter_14_0, iter_14_1 in ipairs(MonthSignPage.MONTH_SIGN_SP_DAYS) do
					if iter_14_1 == var_14_0.data1 then
						arg_8_3:setSpecialData(MonthSignPage.MILESTONE_SPECIAL_DATA, iter_14_1)
					end
				end

				getProxy(ActivityProxy):updateActivity(var_14_0)
			end
		...
		[ActivityConst.ACTIVITY_TYPE_BUILDSHIP_1] = function()
			...
			self:sendNotification(GAME.BUILD_SHIP_DONE)
		...
		[ActivityConst.ACTIVITY_TYPE_LOTTERY] = function()
			if arg_8_1.cmd == 1 then
				...
				if var_22_1.type == DROP_TYPE_RESOURCE then
					local var_22_2 = var_8_1:getData()

					var_22_2:consume({
						[id2res(var_22_1.id)] = arg_8_1.arg1 * var_22_1.count
					})
					var_8_1:updatePlayer(var_22_2)
		...
		[ActivityConst.ACTIVITY_TYPE_DODGEM] = function()
			if arg_8_1.cmd == 1 then
				self:sendNotification(GAME.FINISH_STAGE_DONE, {
			...
			if arg_8_1.cmd == 1 then
				...
				if var_33_0 < #pg.activity_event_building[arg_8_1.arg1].buff then
					_.each(pg.activity_event_building[arg_8_1.arg1].material[var_33_0], function(arg_34_0)
						...
						var_34_2.data1KeyValueList[1][var_34_0] = math.max(0, (var_34_2.data1KeyValueList[1][var_34_0] or 0) - var_34_1)
		...
		[ActivityConst.ACTIVITY_TYPE_HOLIDAY_VILLA] = function()
			if arg_8_1.cmd == 1 then
				...
				getProxy(ActivityProxy):updateActivity(arg_8_3)
				self:sendNotification(ActivityProxy.ACTIVITY_EXCHANGE_RESOURCES, arg_8_1.activity_id)
			elseif arg_8_1.cmd == 2 then
			...
			if arg_8_1.cmd == 1 then
				...
				for iter_49_0, iter_49_1 in ipairs(arg_8_1.consumes) do
					if iter_49_1[2] == 6 then
						local var_49_1 = var_8_1:getData()

						var_49_1:consume({
							[id2res(iter_49_1[2])] = iter_49_1[3]
						})
						var_8_1:updatePlayer(var_49_1)
					else
...
function ActivityOperationCommand:performance(arg_53_1, arg_53_2, arg_53_3, arg_53_4)
	...
	var_53_1 = coroutine.create(function()
		switch(var_53_0, {
			...
			[ActivityConst.ACTIVITY_TYPE_BB] = function()
				if pg.gameset.bobing_memory.description[arg_53_3.data1] and #pg.gameset.bobing_memory.description[arg_53_3.data1] > 0 then
					pg.NewStoryMgr.GetInstance():Play(pg.gameset.bobing_memory.description[arg_53_3.data1], var_53_2)
					coroutine.yield()
				end

				self:sendNotification(ActivityProxy.ACTIVITY_SHOW_BB_RESULT, {
			...
			[ActivityConst.ACTIVITY_TYPE_LOTTERY_AWARD] = function()
				if arg_53_1.cmd == 1 then
					...
					self:sendNotification(ActivityProxy.ACTIVITY_SHOW_LOTTERY_AWARD_RESULT, {
			...
			[ActivityConst.ACTIVITY_TYPE_SHAKE_BEADS] = function()
				if arg_53_1.cmd == 1 then
					self:sendNotification(ActivityProxy.ACTIVITY_SHOW_SHAKE_BEADS_RESULT, {
						number = arg_53_2.number[1],
						callback = var_53_2,
						awards = arg_53_4
					})
			...
			[ActivityConst.ACTIVITY_TYPE_SKIN_FAKE_PACKAGE] = function()
				...
				self:sendNotification(NewShopMainMediator.NOTI_UPDATE_CURRENT)
		...
		if #arg_53_4 > 0 then
			self:sendNotification(arg_53_3:getNotificationMsg(), {
		...
		getProxy(ActivityProxy):updateActivity(arg_53_3)
		self:sendNotification(ActivityProxy.ACTIVITY_OPERATION_DONE, arg_53_1.activity_id)
...
return ActivityOperationCommand
