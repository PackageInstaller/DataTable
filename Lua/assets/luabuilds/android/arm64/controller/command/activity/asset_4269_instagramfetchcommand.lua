local InstagramFetchCommand = class("InstagramFetchCommand", pm.SimpleCommand)

function InstagramFetchCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(11202, {
		...
		if arg_2_0.result == 0 then
			for iter_2_0 = 1, math.floor(#arg_2_0.number) do
