local ActivityPermanentStartCommand = class("ActivityPermanentStartCommand", pm.SimpleCommand)

function ActivityPermanentStartCommand:execute(arg_1_1)
	...
	local function var_1_4()
		if var_1_3 == var_1_0 then
			self:sendNotification(GAME.ACTIVITY_PERMANENT_START_DONE, {
				id = var_1_0
			})
	...
	if var_1_3 and var_1_3 ~= var_1_0 then
		(function(arg_4_0, arg_4_1)
			self:sendNotification(GAME.ACTIVITY_PERMANENT_STOP, {
				activity_id = arg_4_0,
				callback = arg_4_1
			})
...
return ActivityPermanentStartCommand
