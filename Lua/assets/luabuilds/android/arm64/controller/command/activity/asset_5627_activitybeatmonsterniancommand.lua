local ActivityBeatMonsterNianCommand = class("ActivityBeatMonsterNianCommand", pm.SimpleCommand)

function ActivityBeatMonsterNianCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(11202, {
		...
		if arg_2_0.result == 0 then
			...
			if var_1_1 then
				var_1_1((PlayerConst.addTranDrop(arg_2_0.award_list)))
			end
		else
...
return ActivityBeatMonsterNianCommand
