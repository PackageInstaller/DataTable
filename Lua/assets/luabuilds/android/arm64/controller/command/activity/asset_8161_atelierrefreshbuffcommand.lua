local AtelierRefreshBuffCommand = class("AtelierRefreshBuffCommand", pm.SimpleCommand)

function AtelierRefreshBuffCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(26055, {
		...
		if arg_3_0.result == 0 then
			...
			self:sendNotification(GAME.UPDATE_ATELIER_BUFF_DONE, var_1_0)
		else
...
return AtelierRefreshBuffCommand
