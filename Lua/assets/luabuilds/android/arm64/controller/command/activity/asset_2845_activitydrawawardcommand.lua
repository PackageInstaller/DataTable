local ActivityDrawAwardCommand = class("ActivityDrawAwardCommand", pm.SimpleCommand)

function ActivityDrawAwardCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(11202, var_1_2, 11203, function(arg_6_0)
		if arg_6_0.result == 0 then
			...
			self:sendNotification(GAME.ACTIVITY_DRAW_AWARD_OPERATION_DONE, {
				op = var_1_0.op,
...
return ActivityDrawAwardCommand
