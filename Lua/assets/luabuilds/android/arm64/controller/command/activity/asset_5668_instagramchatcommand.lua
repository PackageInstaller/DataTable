local InstagramChatCommand = class("InstagramChatCommand", pm.SimpleCommand)

function InstagramChatCommand:execute(arg_1_1)
	...
	if var_1_0.operation == ActivityConst.INSTAGRAM_CHAT_GET_DATA then
		pg.ConnectionMgr.GetInstance():Send(11710, {
			...
			for iter_2_0, iter_2_1 in ipairs(arg_2_0.groups) do
				table.insert(var_2_0, (InstagramChat.New(iter_2_1)))
			end

			var_1_1:SetChatList(var_2_0)
			self:sendNotification(GAME.ACT_INSTAGRAM_CHAT_DONE, {
