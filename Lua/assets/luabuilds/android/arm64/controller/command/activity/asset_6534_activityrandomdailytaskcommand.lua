local ActivityRandomDailyTaskCommand = class("ActivityRandomDailyTaskCommand", pm.SimpleCommand)

function ActivityRandomDailyTaskCommand:execute(arg_1_1)
...
return ActivityRandomDailyTaskCommand
