local ActivityCrusingOPCommand = class("ActivityCrusingOPCommand", pm.SimpleCommand)

function ActivityCrusingOPCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(11202, var_1_4, 11203, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.CRUSING_CMD_DONE, {
				awards = var_2_0,
				callback = var_1_1
			})
		else
...
return ActivityCrusingOPCommand
