local InstagramActivityCommand = class("InstagramActivityCommand", pm.SimpleCommand)

function InstagramActivityCommand:execute(arg_1_1)
	...
	if ActivityConst.INSTAGRAM_OP_ACTIVE == var_1_0.cmd then
		pg.ConnectionMgr.GetInstance():Send(11701, {
			...
			if arg_2_0.result == 0 then
				...
				self:sendNotification(GAME.ACT_INSTAGRAM_OP_DONE, {
					cmd = var_1_0.cmd,
					id = var_1_0.arg1
				})
...
return InstagramActivityCommand
