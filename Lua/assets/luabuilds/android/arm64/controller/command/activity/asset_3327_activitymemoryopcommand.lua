local ActivityMemoryOPCommand = class("ActivityMemoryOPCommand", pm.SimpleCommand)

function ActivityMemoryOPCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(11202, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.MEMORYBOOK_UNLOCK_DONE, var_1_1)

			if arg_2_0.award_list then
				if var_1_4 then
					var_1_4(PlayerConst.addTranDrop(arg_2_0.award_list))
				else
					self:sendNotification(GAME.MEMORYBOOK_UNLOCK_AWARD_DONE, {
...
return ActivityMemoryOPCommand
