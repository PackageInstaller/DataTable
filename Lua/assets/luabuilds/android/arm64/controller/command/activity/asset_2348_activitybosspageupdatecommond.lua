local ActivityBossPageUpdateCommond = class("ActivityBossPageUpdateCommond", pm.SimpleCommand)

function ActivityBossPageUpdateCommond:execute(arg_1_1)
...
return ActivityBossPageUpdateCommond
