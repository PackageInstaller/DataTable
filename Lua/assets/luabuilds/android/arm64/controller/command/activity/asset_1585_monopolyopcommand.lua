local MonopolyOPCommand = class("MonopolyOPCommand", pm.SimpleCommand)

function MonopolyOPCommand:execute(arg_1_1)
	...
	if var_1_0.cmd == ActivityConst.MONOPOLY_OP_DIALOGUE and self:IsReadDialogue(var_1_4, var_1_0.arg1) then
		return
	end
	...
	pg.ConnectionMgr.GetInstance():Send(11202, {
		...
		if arg_2_0.result == 0 then
			...
			if var_1_0.cmd == ActivityConst.MONOPOLY_OP_AWARD then
				...
				self:sendNotification(GAME.MONOPOLY_AWARD_DONE, {
					awards = var_2_1,
					autoFlag = var_1_1
				})
			else
				...
				if #var_2_3 > 0 then
					var_2_7 = var_2_3[#var_2_3] or var_2_0.data2
				end
				...
				if var_2_2 == ActivityConst.MONOPOLY_OP_THROW then
					...
					var_2_0.data2_list[1] = var_2_9 > 0 and math.floor((var_2_10 ~= 0 and math.min(var_2_0.data1_list[2], var_2_10) or var_2_0.data1_list[2]) / var_2_9) or 0
...
function MonopolyOPCommand:IsReadDialogue(arg_8_1, arg_8_2)
	return table.contains(arg_8_1.data4_list, arg_8_2)
end

return MonopolyOPCommand
