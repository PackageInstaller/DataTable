local CancelLearnTacticsCommand = class("CancelLearnTacticsCommand", pm.SimpleCommand)

function CancelLearnTacticsCommand:execute(arg_1_1)
...
return CancelLearnTacticsCommand
