local UpgradeStarCommand = class("UpgradeStarCommand", pm.SimpleCommand)

function UpgradeStarCommand:execute(arg_1_1)
	...
	local var_1_7 = getProxy(CollectionProxy):getShipGroup(var_1_4.groupId)
	...
	pg.ConnectionMgr.GetInstance():Send(12027, {
		...
		if arg_3_0.result == 0 then
			...
			self:sendNotification(GAME.UPGRADE_STAR_DONE, {
				newShip = var_1_2,
				oldShip = var_1_4
			})
		else
