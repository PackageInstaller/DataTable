local EquipCodeImpeachCommand = class("EquipCodeImpeachCommand", pm.SimpleCommand)

function EquipCodeImpeachCommand:execute(arg_1_1)
...
return EquipCodeImpeachCommand
