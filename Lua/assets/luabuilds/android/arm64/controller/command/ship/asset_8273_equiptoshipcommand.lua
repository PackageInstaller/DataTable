local EquipToShipCommand = class("EquipToShipCommand", pm.SimpleCommand)

function EquipToShipCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(12006, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.EQUIP_TO_SHIP_DONE, var_1_5)
