...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_1 and var_1_1 ~= 0 then
		var_1_6 = getProxy(EquipmentProxy):GetSpWeaponByUid(var_1_1)
	...
	local var_1_7 = getProxy(BayProxy):getShipById(var_1_2)
	...
	if not var_1_6 then
		...
		local var_1_10 = getProxy(EquipmentProxy)

		if var_1_10:GetSpWeaponCapacity() <= getProxy(EquipmentProxy):GetSpWeaponCount() then
	...
	if var_1_6 then
		local var_1_11, var_1_12 = var_1_7:CanEquipSpWeapon(var_1_6)
	...
	pg.ConnectionMgr.GetInstance():Send(14201, {
		...
		if arg_2_0.result == 0 then
			...
			var_1_7:UpdateSpWeapon(var_1_6)
			var_1_4:updateShip(var_1_7)

			if var_1_1 and var_1_1 ~= 0 then
				var_1_5:RemoveSpWeapon(var_1_6)
			end

			arg_1_0:sendNotification(GAME.EQUIP_SPWEAPON_TO_SHIP_DONE, var_1_7)

			if var_1_1 and var_1_1 ~= 0 then
				pg.TipsMgr.GetInstance():ShowTips(i18n("ship_equipToShip_ok", var_1_6:GetName()), "green")
			end
