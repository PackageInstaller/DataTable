...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_0.count > var_1_4:getItemById(var_1_0.id).count then
	...
	pg.ConnectionMgr.GetInstance():Send(15002, {
		...
		if arg_2_0.result == 0 then
			...
			assert(var_0:getConfig("usage") == ItemUsage.DROP or var_0:getConfig("usage") == ItemUsage.DROP_TEMPLATE or var_0:getConfig("usage") == ItemUsage.RANDOM_SKIN, "未处理类型")
