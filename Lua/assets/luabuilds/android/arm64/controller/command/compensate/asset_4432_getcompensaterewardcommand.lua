local GetCompensateRewardCommand = class("GetCompensateRewardCommand", pm.SimpleCommand)

function GetCompensateRewardCommand:execute(arg_1_1)
	...
	seriesAsync(var_1_5, function(arg_14_0)
		self:sendNotification(GAME.DEAL_COMPENSATE_REWARD_DONE, {
...
return GetCompensateRewardCommand
