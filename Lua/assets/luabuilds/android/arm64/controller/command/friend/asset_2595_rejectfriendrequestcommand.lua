local RejectFriendRequestCommand = class("RejectFriendRequestCommand", pm.SimpleCommand)

function RejectFriendRequestCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(50009, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.FRIEND_REJECT_REQUEST_DONE, var_1_0)
		else
