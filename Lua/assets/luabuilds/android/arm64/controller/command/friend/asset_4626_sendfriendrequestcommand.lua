local SendFriendRequestCommand = class("SendFriendRequestCommand", pm.SimpleCommand)

function SendFriendRequestCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(50003, {
		...
		if arg_2_0.result == 0 then
			self:sendNotification(GAME.FRIEND_SEND_REQUEST_DONE, var_1_1)
