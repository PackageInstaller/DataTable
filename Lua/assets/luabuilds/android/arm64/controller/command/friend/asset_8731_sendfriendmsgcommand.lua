local SendFriendMsgCommand = class("SendFriendMsgCommand", pm.SimpleCommand)

function SendFriendMsgCommand:execute(arg_1_1)
	local var_1_0 = arg_1_1:getBody()
	local var_1_1 = var_1_0.playerId
	local var_1_2 = var_1_0.msg
	local var_1_3 = getProxy(FriendProxy)

	if not var_1_3:isFriend(var_1_0.playerId) then
	...
	pg.ConnectionMgr.GetInstance():Send(50105, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.FRIEND_SEND_MSG_DONE)
