local EducateGetEventsCommand = class("EducateGetEventsCommand", pm.SimpleCommand)

function EducateGetEventsCommand:execute(arg_1_1)
...
return EducateGetEventsCommand
