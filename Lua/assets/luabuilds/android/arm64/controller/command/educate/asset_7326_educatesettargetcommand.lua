local EducateSetTargetCommand = class("EducateSetTargetCommand", pm.SimpleCommand)

function EducateSetTargetCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(27019, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.EDUCATE_SET_TARGET_DONE, {
				autoOpen = var_1_2
			})
...
return EducateSetTargetCommand
