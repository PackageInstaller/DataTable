local EducateSubmitTaskCommand = class("EducateSubmitTaskCommand", pm.SimpleCommand)

function EducateSubmitTaskCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(27023, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.EDUCATE_SUBMIT_TASK_DONE, {
...
return EducateSubmitTaskCommand
