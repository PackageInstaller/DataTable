local UpdateLowPriorityTaskProgressCommand = class("UpdateLowPriorityTaskProgressCommand", pm.SimpleCommand)

function UpdateLowPriorityTaskProgressCommand:execute(arg_1_1)
	local var_1_0 = arg_1_1:getBody()
	local var_1_1 = var_1_0.taskId
	local var_1_2
	local var_1_3
	local var_1_4 = getProxy(TaskProxy)
	local var_1_5 = var_1_4:getTaskById(var_1_0.taskId)
	...
	var_1_11.progressinfo = var_1_12

	pg.ConnectionMgr.GetInstance():Send(20209, var_1_11, 20210, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.SHARE_TASK_FINISHED)
		end
...
return UpdateLowPriorityTaskProgressCommand
