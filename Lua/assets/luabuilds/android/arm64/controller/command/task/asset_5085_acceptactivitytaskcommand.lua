local AcceptActivityTaskCommand = class("AcceptActivityTaskCommand", pm.SimpleCommand)

function AcceptActivityTaskCommand:execute(arg_1_1)
...
return AcceptActivityTaskCommand
