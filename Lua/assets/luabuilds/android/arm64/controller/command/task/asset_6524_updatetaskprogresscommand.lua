local UpdateTaskProgressCommand = class("UpdateTaskProgressCommand", pm.SimpleCommand)

function UpdateTaskProgressCommand:execute(arg_1_1)
	...
	var_1_10.progressinfo = var_1_11

	pg.ConnectionMgr.GetInstance():Send(20009, var_1_10, 20010, function(arg_2_0)
...
return UpdateTaskProgressCommand
