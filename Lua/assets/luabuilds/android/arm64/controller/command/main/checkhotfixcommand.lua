...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = BundleWizard.Inst:GetGroupMgr("DEFAULT_RES").CurrentVersion.Major

	if var_1_2 > 0 and (not var_1_1.lastRequestVersionTime or Time.realtimeSinceStartup - var_1_1.lastRequestVersionTime > 1800) then
