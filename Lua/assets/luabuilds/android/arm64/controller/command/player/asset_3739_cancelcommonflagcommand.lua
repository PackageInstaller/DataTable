local CancelCommonFlagCommand = class("CancelCommonFlagCommand", pm.SimpleCommand)

function CancelCommonFlagCommand:execute(arg_1_1)
...
return CancelCommonFlagCommand
