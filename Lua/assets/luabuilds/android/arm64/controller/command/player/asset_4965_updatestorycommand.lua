local UpdateStoryCommand = class("UpdateStoryCommand", pm.SimpleCommand)

function UpdateStoryCommand:execute(arg_1_1)
	...
	seriesAsync(var_1_8, function()
		existCall(var_1_2)
		self:sendNotification(GAME.STORY_UPDATE_DONE, {
			storyName = var_1_1,
			awards = var_1_4
		})
