local MusicUnlockCommand = class("MusicUnlockCommand", pm.SimpleCommand)

function MusicUnlockCommand:execute(arg_1_1)
	...
	for iter_1_0, iter_1_1 in pairs((var_1_3:getMusicUnlockMaterialByID(var_1_0.musicID))) do
	...
	pg.ConnectionMgr.GetInstance():Send(17503, {
		...
		if arg_2_0.result == 0 then
			...
			for iter_2_0, iter_2_1 in pairs((var_1_3:getMusicUnlockMaterialByID(var_1_1))) do
