local var_0_0 = class("GalleryUnlockCommand", pm.SimpleCommand)
...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in pairs((getProxy(AppreciateProxy):getPicUnlockMaterialByID(var_1_0.picID))) do
