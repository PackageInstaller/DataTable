local PlayRoomSendChatCommand = class("PlayRoomSendChatCommand", pm.SimpleCommand)

function PlayRoomSendChatCommand:execute(arg_1_1)
	...
	elseif var_1_8 - var_1_5 < 10 then
		...
		self:Send(var_1_1, var_1_2, var_1_3)
	end

	return
end

function PlayRoomSendChatCommand:Send(arg_2_1, arg_2_2, arg_2_3)
	...
	elseif arg_2_1 == PlayRoomChatConst.CHANNEL_WORLD then
		self:sendNotification(GAME.SEND_MSG, var_2_1)
	elseif arg_2_1 == PlayRoomChatConst.CHANNEL_GUILD then
		self:sendNotification(GAME.GUILD_SEND_MSG, var_2_1)
	end

	return
end

return PlayRoomSendChatCommand
