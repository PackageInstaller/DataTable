local PlayRoomCreateRoomCommand = class("PlayRoomCreateRoomCommand", pm.SimpleCommand)

function PlayRoomCreateRoomCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(23005, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.PLAY_ROOM_CREATE_ROOM_DONE)
...
return PlayRoomCreateRoomCommand
