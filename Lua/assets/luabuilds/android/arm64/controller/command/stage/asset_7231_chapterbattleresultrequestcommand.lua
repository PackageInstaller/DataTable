local ChapterBattleResultRequestCommand = class("ChapterBattleResultRequestCommand", pm.SimpleCommand)

function ChapterBattleResultRequestCommand:execute(arg_1_1)
...
return ChapterBattleResultRequestCommand
