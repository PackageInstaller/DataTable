local UpdateCustomFleetCommand = class("UpdateCustomFleetCommand", pm.SimpleCommand)

function UpdateCustomFleetCommand:execute(arg_1_1)
...
return UpdateCustomFleetCommand
