local RemasterInfoRequestCommand = class("RemasterInfoRequestCommand", pm.SimpleCommand)

function RemasterInfoRequestCommand:execute(arg_1_1)
	pg.ConnectionMgr.GetInstance():Send(13505, {
		...
		self:sendNotification(GAME.CHAPTER_REMASTER_INFO_REQUEST_DONE)
...
return RemasterInfoRequestCommand
