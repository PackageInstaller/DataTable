local RemasterAwardReceiveCommand = class("RemasterAwardReceiveCommand", pm.SimpleCommand)

function RemasterAwardReceiveCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(13507, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.CHAPTER_REMASTER_AWARD_RECEIVE_DONE, (PlayerConst.addTranDrop(arg_2_0.drop_list)))
		else
...
return RemasterAwardReceiveCommand
