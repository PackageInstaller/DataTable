local EmojiInfoRequestCommand = class("EmojiInfoRequestCommand", pm.SimpleCommand)

function EmojiInfoRequestCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(11601, {
		...
		if arg_2_0.emoji_list then
			...
			self:sendNotification(GAME.REQUEST_EMOJI_INFO_FROM_SERVER_DONE)
		end
...
return EmojiInfoRequestCommand
