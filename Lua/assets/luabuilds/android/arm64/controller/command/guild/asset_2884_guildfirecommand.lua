local GuildFireCommand = class("GuildFireCommand", pm.SimpleCommand)

function GuildFireCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(60014, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.GUILD_FIRE_DONE)
