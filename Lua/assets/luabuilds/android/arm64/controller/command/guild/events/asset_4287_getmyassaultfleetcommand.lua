local GetMyAssaultFleetCommand = class("GetMyAssaultFleetCommand", import(".GuildEventBaseCommand"))

function GetMyAssaultFleetCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(61009, {
		...
		if arg_2_0.result == 0 then
			...
			_.each(arg_2_0.person_ships, function(arg_3_0)
				var_2_5[arg_3_0.pos] = Ship.New(arg_3_0.ship)
			...
			self:sendNotification(GAME.GUILD_GET_MY_ASSAULT_FLEET_DONE)
...
return GetMyAssaultFleetCommand
