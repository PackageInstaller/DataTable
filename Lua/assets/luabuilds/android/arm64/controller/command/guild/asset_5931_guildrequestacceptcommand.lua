local GuildRequestAcceptCommand = class("GuildRequestAcceptCommand", pm.SimpleCommand)

function GuildRequestAcceptCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(60020, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.GUIDL_REQUEST_ACCEPT_DONE)
		...
		elseif arg_2_0.result == 1 then
			...
			self:sendNotification(GAME.GUIDL_REQUEST_REJECT, var_1_0, true)
...
return GuildRequestAcceptCommand
