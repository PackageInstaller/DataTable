local GetGuildBossInfoCommand = class("GetGuildBossInfoCommand", import(".GuildEventBaseCommand"))

function GetGuildBossInfoCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(61027, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.GUILD_GET_BOSS_INFO_DONE)
		elseif arg_2_0.result == 20 then
			...
			self:sendNotification(GAME.GUILD_END_BATTLE)
		else
...
return GetGuildBossInfoCommand
