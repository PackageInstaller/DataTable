local MetaPTAwardGetCommand = class("MetaPTAwardGetCommand", pm.SimpleCommand)

function MetaPTAwardGetCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(34003, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.GET_META_PT_AWARD_DONE, {
