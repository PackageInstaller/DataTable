local MetaCharacterTacticsInfoRequestCommand = class("MetaCharacterTacticsInfoRequestCommand", pm.SimpleCommand)

function MetaCharacterTacticsInfoRequestCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(63317, {
		...
		if arg_2_0.info_list then
			for iter_2_0, iter_2_1 in ipairs(arg_2_0.info_list) do
...
return MetaCharacterTacticsInfoRequestCommand
