local FinishTechnologyCommand = class("FinishTechnologyCommand", pm.SimpleCommand)

function FinishTechnologyCommand:execute(arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(27, {
		...
		if arg_2_0.result == 0 then
			...
			self:sendNotification(GAME.FINISH_TECHNOLOGY_DONE, {
...
return FinishTechnologyCommand
