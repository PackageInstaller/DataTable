local GetAllLoveLetterLevelDataCommand = class("GetAllLoveLetterLevelDataCommand", pm.SimpleCommand)

function GetAllLoveLetterLevelDataCommand:execute(arg_1_1)
...
return GetAllLoveLetterLevelDataCommand
