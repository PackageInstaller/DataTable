...
local function var_0_4(arg_5_0, arg_5_1)
	...
	local var_5_0 = arg_5_1.noText or var_0_1.TEXT_CANCEL

	arg_5_0:updateButton(arg_5_0._inputCancelBtn, var_5_0)

	local var_5_1 = arg_5_1.yesText or var_0_1.TEXT_CONFIRM

	arg_5_0:updateButton(arg_5_0._inputConfirmBtn, var_5_1)
...
local function var_0_6(arg_10_0, arg_10_1)
	...
	local var_10_0 = arg_10_1.itemFunc
	...
	UIItemList.StaticAlign(arg_10_0._itemListItemContainer, arg_10_0._itemListItemTpl, #arg_10_1.items, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == UIItemList.EventUpdate then
			updateDrop(arg_11_2:Find("IconTpl"), var_0[arg_11_1], {
				anonymous = var_0[arg_11_1].anonymous,
				hideName = var_0[arg_11_1].hideName
			})

			local var_11_0 = arg_11_2:Find("IconTpl/name")

			setText(var_11_0, shortenString(getText(var_11_0), 6))
			onButton(arg_10_0, arg_11_2, function()
				if var_0.anonymous then
					return
...
local function var_0_7(arg_13_0, arg_13_1)
	...
	local var_13_0 = arg_13_1.itemFunc
	...
	UIItemList.StaticAlign(arg_13_0._eskinListItemContainer, arg_13_0._eskinListItemTpl, #arg_13_1.items, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == UIItemList.EventUpdate then
			local var_14_0 = var_0[arg_14_1]

			updateDrop(arg_14_2:Find("IconTpl"), var_0[arg_14_1], {
				anonymous = var_0[arg_14_1].anonymous,
				hideName = var_0[arg_14_1].hideName
			})
			setText(arg_14_2:Find("own/Text"), i18n("equip_skin_detail_count") .. var_0[arg_14_1]:getOwnedCount())
...
local function var_0_8(arg_16_0, arg_16_1)
	...
	local var_16_1 = arg_16_1.content or ""

	setText(arg_16_0.singleItemIntro, var_16_1)
	...
	local var_16_3 = arg_16_1.frame or 1

	setFrame(var_16_2:Find("icon_bg/frame"), var_16_3)

	local var_16_4 = arg_16_1.frame or 1
	local var_16_5 = "bg" .. var_16_4

	GetImageSpriteFromAtlasAsync("weaponframes", var_16_5, var_16_2:Find("icon_bg"))

	local var_16_6 = arg_16_1.iconPath[2] or ""

	GetImageSpriteFromAtlasAsync(arg_16_1.iconPath[1], var_16_6, var_16_2:Find("icon_bg/icon"))

	local var_16_7 = arg_16_1.name or ""

	setText(arg_16_0._sigleItemPanel:Find("display_panel/name_container/name/Text"), var_16_7)
...
local function var_0_9(arg_17_0, arg_17_1)
	...
	if var_17_0.type == DROP_TYPE_ITEM then
		...
		if var_17_3 then
			do
				...
				if false then
					if var_17_0.type == DROP_TYPE_COMBAT_UI_STYLE then
						var_17_2.sizeDelta = Vector2(var_17_2.sizeDelta.x, -170.5)
			...
			if arg_17_1.windowSize then
				local var_17_10 = arg_17_1.windowSize.x or arg_17_0._defaultSize.x
				local var_17_11 = arg_17_1.windowSize.y or arg_17_0._defaultSize.y

				arg_17_0._window.sizeDelta = Vector2(var_17_10, var_17_11)
			end

			local var_17_12 = arg_17_0.singleItemIntro
			local var_17_13 = arg_17_0._singleItemSubIntroTF
			local var_17_14 = arg_17_0.settings.numUpdate

			setActive(arg_17_0._countDescTxt, arg_17_0.settings.numUpdate ~= nil)
			SetActive(var_17_12, var_17_14 == nil)

			local var_17_15 = arg_17_1.name

			if not arg_17_1.name then
				var_17_15 = var_17_0:getConfig("name")
				var_17_15 = var_17_15 or ""
			end

			setText(arg_17_0._sigleItemPanel:Find("display_panel/name_container/name/Text"), var_17_15)
			...
			if arg_17_1.content and arg_17_1.content ~= "" then
				setText(var_17_12, arg_17_1.content)
			elseif var_17_0.type == DROP_TYPE_WORLD_COLLECTION then
				var_17_0:MsgboxIntroSet(arg_17_1, var_17_12, arg_17_0._sigleItemPanel:Find("name_mode/name_mask/name"))
			else
				var_17_0:MsgboxIntroSet(arg_17_1, var_17_12)
			end

			if arg_17_1.intro then
				setText(var_17_12, arg_17_1.intro)
			end

			local var_17_17 = arg_17_1.subIntro or arg_17_1.extendDesc or ""

			var_17_16(var_17_13, var_17_17)
...
local function var_0_10(arg_23_0, arg_23_1)
	...
	if arg_23_1.helps.helpSize then
		local var_23_0 = arg_23_1.helps.helpSize.x or arg_23_0._defaultHelpSize.x
		local var_23_1 = arg_23_1.helps.helpSize.y or arg_23_0._defaultHelpSize.y

		arg_23_0._helpPanel.sizeDelta = Vector2(var_23_0, var_23_1)
	end
	...
	if arg_23_1.helps.windowSize then
		local var_23_2 = arg_23_1.helps.windowSize.x or arg_23_0._defaultSize.x
		local var_23_3 = arg_23_1.helps.windowSize.y or arg_23_0._defaultSize.y

		arg_23_0._window.sizeDelta = Vector2(var_23_2, var_23_3)
	end

	if arg_23_1.helps.windowPos then
		local var_23_4 = arg_23_1.helps.windowSize.x or arg_23_0._defaultSize.x
		local var_23_5 = arg_23_1.helps.windowSize.y or arg_23_0._defaultSize.y

		arg_23_0._window.sizeDelta = Vector2(var_23_4, var_23_5)
	...
	local var_23_6 = arg_23_0.settings.helps

	for iter_23_0 = #arg_23_0.settings.helps, arg_23_0._helpList.childCount - 1 do
		Destroy(arg_23_0._helpList:GetChild(iter_23_0))
	end

	for iter_23_1 = arg_23_0._helpList.childCount, #var_23_6 - 1 do
		cloneTplTo(arg_23_0._helpTpl, arg_23_0._helpList)
	end

	for iter_23_2, iter_23_3 in ipairs(var_23_6) do
		local var_23_7 = arg_23_0._helpList:GetChild(iter_23_2 - 1)

		setActive(var_23_7, true)

		local var_23_8 = var_23_7:Find("icon")

		setActive(var_23_8, iter_23_3.icon)
		setActive(findTF(var_23_7, "line"), iter_23_3.line)
		...
		if iter_23_3.icon then
			...
			local var_23_10 = var_23_8.transform
			local var_23_11 = iter_23_3.icon.scale or var_23_9
			local var_23_12 = iter_23_3.icon.scale or var_23_9

			var_23_10.localScale = Vector2(var_23_11, var_23_12)

			if iter_23_3.icon.posX then
				local var_23_14 = iter_23_3.icon.posX or -20

				if iter_23_3.icon.posY then
					local var_23_15 = iter_23_3.icon.posY
					local var_23_16

					if not iter_23_3.icon.posY then
						var_23_15 = 0
						var_23_16 = var_23_8:GetComponent(typeof(Image))
					end

					setImageSprite(var_23_16, LoadSprite(iter_23_3.icon.atlas, iter_23_3.icon.path), true)
					setAnchoredPosition(var_23_8, {
						x = var_23_14,
						y = var_23_15
					})
					setActive(var_23_8:Find("corner"), arg_23_1.helps.pageMode)

					local var_23_17 = var_23_7:Find("richText"):GetComponent("RichText")
					local var_23_20

					if iter_23_3.rawIcon then
						var_23_17:AddSprite(iter_23_3.rawIcon.name, GetSpriteFromAtlas(iter_23_3.rawIcon.atlas, iter_23_3.rawIcon.name))

						local var_23_18 = iter_23_3.info or ""
						local var_23_19 = HXSet.hxLan(var_23_18)

						setText(var_23_7, "")

						var_23_17.text = string.format("<icon name=%s w=0.7 h=0.7/>%s", iter_23_3.rawIcon.name, var_23_19)

						goto label_23_0

						var_23_20 = iter_23_3.info and SwitchSpecialChar(iter_23_3.info, true) or ""
					end

					setText(var_23_7, HXSet.hxLan(var_23_20))

					::label_23_0::

					setActive(var_23_17.gameObject, iter_23_3.rawIcon)
				end
			end
		end
	end
	...
	if arg_25_1.mode == "showresttime" then
		...
		local function var_25_5()
			...
			if var_25_1.fail_cd then
				local var_26_1 = var_25_1.fail_cd - var_26_0 or 0

				var_26_1 = var_26_1 < 0 and 0 or var_26_1

				local var_26_2 = math.floor(var_26_1 / 0)

				if var_26_2 > 0 then
					var_25_4.text = string.format(i18n("tips_fail_secondarypwd_much_times"), var_26_2 .. i18n("word_date"))
				else
					local var_26_3 = math.floor(var_26_1 / 16)

					if var_26_3 > 0 then
						var_25_4.text = string.format(i18n("tips_fail_secondarypwd_much_times"), var_26_3 .. i18n("word_hour"))
					else
						local var_26_4 = ""
						...
						var_25_4.text = string.format(i18n("tips_fail_secondarypwd_much_times"), var_26_4 .. math.max(var_26_1 - var_26_5 * 60, 0) .. i18n("word_second"))
					end
				end
...
local function var_0_13(arg_32_0)
	...
	for iter_32_0, iter_32_1 in ipairs(arg_32_0) do
		local var_32_0 = iter_32_1[2] and iter_32_1[2][1] == "SHOP"
		local var_32_1 = iter_32_1[2][2] and iter_32_1[2][2].warp == "meta"
...
local function var_0_15(arg_34_0)
	if Ship.isMetaShipByConfigID(arg_34_0.shipId) then
		...
		local var_34_1 = var_34_0 and (var_34_0:isInAct() or var_34_0:isInArchive())
		local var_34_2 = var_0_13(arg_34_0.list)

		return var_34_1 or var_34_2 or var_0_14(arg_34_0.list)
	end
...
local function var_0_16(arg_35_0, arg_35_1)
	...
	arg_35_0.obtainSkipList:make(function(arg_36_0, arg_36_1, arg_36_2)
		if arg_36_0 == UIItemList.EventUpdate then
			...
			local var_36_2 = var_35_0 and arg_35_1.list[arg_36_1 + 1][2][1] ~= "" and arg_35_1.list[arg_36_1 + 1][2][1] ~= "COLLECTSHIP"

			setActive(arg_36_2:Find("skip_btn"), var_36_2)
...
function var_0_1.nextPage(arg_39_0)
...
function var_0_1.prePage(arg_40_0)
...
function var_0_1.switchHelpPage(arg_41_0, arg_41_1)
	for iter_41_0 = 1, arg_41_0._helpList.childCount do
		local var_41_0 = arg_41_0._helpList:GetChild(iter_41_0 - 1)
...
function var_0_1.commonSetting(arg_42_0, arg_42_1)
	rtf(arg_42_0._window).sizeDelta = arg_42_0._defaultSize
	rtf(arg_42_0._helpPanel).sizeDelta = arg_42_0._defaultHelpSize
	arg_42_0.enable = true

	var_0_0.DelegateInfo.New(arg_42_0)
	setActive(arg_42_0._msgPanel, false)
	setActive(arg_42_0._exchangeShipPanel, false)
	setActive(arg_42_0._itemPanel, false)
	setActive(arg_42_0._eskinPanel, false)
	setActive(arg_42_0._sigleItemPanel, false)
	setActive(arg_42_0._inputPanel, false)
	setActive(arg_42_0._obtainPanel, false)
	setActive(arg_42_0._otherPanel, false)
	setActive(arg_42_0._worldResetPanel, false)
	setActive(arg_42_0._worldShopBtn, false)
	setActive(arg_42_0._helpBgTF, false)
	setActive(arg_42_0._helpPanel, arg_42_1.helps)

	for iter_42_0, iter_42_1 in pairs(arg_42_0.panelDict) do
		iter_42_1.buffer:Hide()
	end

	setActive(arg_42_0._btnContainer, true)

	arg_42_0.stopRemindToggle.isOn = arg_42_1.toggleStatus or false

	setActive(go(arg_42_0.stopRemindToggle), arg_42_1.showStopRemind)

	arg_42_0.stopRemindText.text = arg_42_1.stopRamindContent or i18n("dont_remind_today")

	removeAllChildren(arg_42_0._btnContainer)

	arg_42_0.settings = arg_42_1

	SetActive(arg_42_0._go, true)

	local var_42_0 = arg_42_0.settings.needCounter or false

	setActive(arg_42_0._countSelect, var_42_0)

	local var_42_1 = arg_42_0.settings.numUpdate
	local var_42_2 = arg_42_0.settings.addNum or 1
	local var_42_3 = arg_42_0.settings.maxNum or -1
	local var_42_4 = arg_42_0.settings.defaultNum or 1

	arg_42_0._pageUtil:setNumUpdate(function(arg_43_0)
		if var_42_1 ~= nil then
			var_42_1(arg_42_0._countDescTxt, arg_43_0)
		end

		return
	end)
	arg_42_0._pageUtil:setAddNum(var_42_2)
	arg_42_0._pageUtil:setMaxNum(var_42_3)
	arg_42_0._pageUtil:setDefaultNum(var_42_4)
	setActive(arg_42_0._sliders, arg_42_0.settings.discount)

	if arg_42_0.settings.discount then
		arg_42_0._discount:GetComponent(typeof(Text)).text = arg_42_0.settings.discount.discount .. "%OFF"
		arg_42_0._discountDate:GetComponent(typeof(Text)).text = arg_42_0.settings.discount.date
	end

	setActive(arg_42_0._remasterPanel, arg_42_0.settings.remaster)

	if arg_42_0.settings.remaster then
		local var_42_5 = arg_42_0.settings.remaster

		setText(arg_42_0._remasterPanel:Find("content/Text"), arg_42_0.settings.remaster.word)

		local var_42_6 = arg_42_0.settings.remaster.number or ""

		setText(arg_42_0._remasterPanel:Find("content/count"), var_42_6)
		setText(arg_42_0._remasterPanel:Find("btn/pic"), arg_42_0.settings.remaster.btn_text)
		onButton(arg_42_0, arg_42_0._remasterPanel:Find("btn"), function()
			if var_42_5.btn_call then
				var_42_5.btn_call()
			end
	...
	local var_42_7 = arg_42_0.settings.hideNo or false
	local var_42_8 = arg_42_0.settings.hideYes or false
	local var_42_9 = arg_42_0.settings.modal or false
	local var_42_10 = arg_42_0.settings.onYes or function()
		return
	end
	local var_42_11 = arg_42_0.settings.onNo or function()
		return
	end

	onButton(arg_42_0, tf(arg_42_0._go):Find("bg"), function()
	...
	SetCompomentEnabled(tf(arg_42_0._go):Find("bg"), typeof(Button), not var_42_9)

	local var_42_13

	if not var_42_7 then
		({}).text = arg_42_0.settings.noText or var_0_1.TEXT_CANCEL
		;({}).btnType = arg_42_0.settings.noBtnType or var_0_1.BUTTON_GRAY
		;({}).onCallback = var_42_11
		;({}).sound = arg_42_1.noSound or SFX_CANCEL

		local var_42_14 = arg_42_0:createBtn({})
	end

	if not var_42_8 then
		({}).text = arg_42_0.settings.yesText or var_0_1.TEXT_CONFIRM
		;({}).btnType = arg_42_0.settings.yesBtnType or var_0_1.BUTTON_BLUE
		;({}).onCallback = var_42_10
		;({}).sound = arg_42_1.yesSound or SFX_CONFIRM
		;({}).alignment = arg_42_0.settings.yesSize and TextAnchor.MiddleCenter
		;({}).gray = arg_42_0.settings.yesGray
		;({}).delayButton = arg_42_0.settings.delayConfirm
		var_42_13 = arg_42_0:createBtn({})

		if arg_42_0.settings.yesSize then
			var_42_13.sizeDelta = arg_42_0.settings.yesSize
		end
	end

	if arg_42_0.settings.yseBtnLetf then
		var_42_13:SetAsFirstSibling()
	end

	local var_42_15

	if arg_42_0.settings.type == MSGBOX_TYPE_HELP and arg_42_0.settings.helps.pageMode and #arg_42_0.settings.helps > 1 then
		arg_42_0:createBtn({
			noQuit = true,
		...
		var_42_15 = #arg_42_0.settings.helps
	end

	if arg_42_0.settings.custom ~= nil then
		for iter_42_2, iter_42_3 in ipairs(arg_42_0.settings.custom) do
	...
	setActive(arg_42_0._closeBtn, not arg_42_1.hideClose)
	onButton(arg_42_0, arg_42_0._closeBtn, function()
		if arg_42_0.settings and arg_42_0.settings.hideClose and not arg_42_0.settings.onClose and arg_42_0.settings.onYes then
	...
	local var_42_16 = arg_42_0.settings.title or var_0_1.TITLE_INFORMATION
	local var_42_17 = 0

	while var_42_17 < arg_42_0._titleList.transform.childCount do
		local var_42_18 = arg_42_0._titleList.transform:GetChild(var_42_17)
	...
	local var_42_19 = arg_42_0._go.transform.localPosition.y
	local var_42_20 = arg_42_0.settings.zIndex or 0

	arg_42_0._go.transform.localPosition = Vector3(arg_42_0._go.transform.localPosition.x, var_42_19, var_42_20)
	arg_42_0.locked = arg_42_0.settings.locked or false

	return
end

function var_0_1.createBtn(arg_51_0, arg_51_1)
	local var_51_0 = arg_51_1.btnType or var_0_1.BUTTON_BLUE
	local var_51_1 = arg_51_1.noQuit
	local var_51_2 = cloneTplTo(arg_51_0._go.transform:Find("custom_btn_list/custom_button_" .. var_51_0), arg_51_0._btnContainer)
	...
	if arg_51_1.scale then
		local var_51_3 = arg_51_1.scale.x or 1
		local var_51_4 = arg_51_1.scale.y or 1

		var_51_2.localScale = Vector2(var_51_3, var_51_4)
	end
	...
	if var_51_0 == var_0_1.BUTTON_MEDAL then
		...
		var_51_5 = var_51_2:Find("text")
	elseif var_51_0 ~= var_0_1.BUTTON_RETREAT and var_51_0 ~= var_0_1.BUTTON_PREPAGE and var_51_0 ~= var_0_1.BUTTON_NEXTPAGE then
		arg_51_0:updateButton(var_51_2, arg_51_1.text, arg_51_1.alignment)

		var_51_5 = var_51_2:Find("pic")
	end
	...
	if arg_51_1.delayButton then
		local var_51_7 = arg_51_1.delayButton
		local var_51_8 = getText(var_51_5)

		var_51_6 = Timer.New(function()
			var_51_7 = var_51_7 - 1

			if var_51_7 > 0 then
				setText(var_51_5, var_51_8 .. string.format("(%d)", var_51_7))
			else
				setText(var_51_5, var_51_8)
		...
		arg_51_0.timers[var_51_2] = var_51_6

		var_51_6:Start()
		setText(var_51_5, getText(var_51_5) .. string.format("(%d)", arg_51_1.delayButton))
	...
	if not arg_51_1.hideEvent then
		local var_51_9 = arg_51_1.sound or SFX_CONFIRM

		onButton(arg_51_0, var_51_2, function()
			if var_51_6 then
				return
			end
...
function var_0_1.updateButton(arg_54_0, arg_54_1, arg_54_2, arg_54_3)
	...
	if var_0_2[arg_54_2] then
		setText(var_54_0, i18n(var_0_2[arg_54_2]))
	else
...
function var_0_1.Loaded(arg_55_0, arg_55_1)
	var_0_0.UIMgr.GetInstance():BlurPanel(arg_55_0._tf, {
...
function var_0_1.Clear(arg_56_0)
	for iter_56_0, iter_56_1 in pairs(arg_56_0.panelDict) do
		iter_56_1:Destroy()
	end

	table.clear(arg_56_0.panelDict)

	rtf(arg_56_0._window).sizeDelta = arg_56_0._defaultSize
	rtf(arg_56_0._helpPanel).sizeDelta = arg_56_0._defaultHelpSize

	setAnchoredPosition(arg_56_0._window, {
		x = 0,
		y = 0
	})
	setAnchoredPosition(arg_56_0._btnContainer, {
		y = 15
	})
	setAnchoredPosition(arg_56_0._helpPanel, {
		x = arg_56_0._defaultHelpPos.x,
		y = arg_56_0._defaultHelpPos.y
	})
	SetCompomentEnabled(arg_56_0._helpPanel:Find("list"), typeof(ScrollRect), true)
	setActive(arg_56_0._top, true)
	setActive(findTF(arg_56_0._window, "bg"), true)
	setActive(arg_56_0._sigleItemPanel:Find("left/own"), false)

	local var_56_0 = arg_56_0._sigleItemPanel:Find("left/IconTpl")
	...
	setActive(arg_56_0.singleItemIntro, false)
	setText(arg_56_0._singleItemSubIntroTF, "")

	for iter_56_2 = 0, arg_56_0._helpList.childCount - 1 do
		local var_56_1 = arg_56_0._helpList:GetChild(iter_56_2):Find("icon")

		var_56_1:GetComponent(typeof(Image)).sprite = nil
	end

	for iter_56_3, iter_56_4 in pairs(arg_56_0.pools) do
		if iter_56_4 then
	...
	for iter_56_5, iter_56_6 in pairs(arg_56_0.timers) do
		iter_56_6:Stop()
	end

	arg_56_0.timers = {}

	var_0_0.DelegateInfo.Dispose(arg_56_0)
	removeAllChildren(arg_56_0._btnContainer)
	var_0_0.UIMgr.GetInstance():UnOverlayPanel(arg_56_0._tf, var_0_0.UIMgr.GetInstance().OverlayMain)
	arg_56_0.contentText:RemoveAllListeners()
...
function var_0_1.ShowMsgBox(arg_57_0, arg_57_1)
	if arg_57_0.locked then
		return
	end

	local var_57_0 = arg_57_1.type or MSGBOX_TYPE_NORMAL

	switch(var_57_0, {
		[MSGBOX_TYPE_NORMAL] = function()
			var_0_3(arg_57_0, arg_57_1)

			return
		end,
		[MSGBOX_TYPE_INPUT] = function()
			var_0_4(arg_57_0, arg_57_1)

			return
		end,
		[MSGBOX_TYPE_SINGLE_ITEM] = function()
			var_0_9(arg_57_0, arg_57_1)

			return
		end,
		[MSGBOX_TYPE_EXCHANGE] = function()
			var_0_5(arg_57_0, arg_57_1)

			return
		end,
		[MSGBOX_TYPE_DROP_ITEM] = function()
			var_0_8(arg_57_0, arg_57_1)

			return
		end,
		[MSGBOX_TYPE_ITEM_BOX] = function()
			var_0_6(arg_57_0, arg_57_1)

			return
		end,
		[MSGBOX_TYPE_DROP_ITEM_ESKIN] = function()
			var_0_7(arg_57_0, arg_57_1)
		...
		[MSGBOX_TYPE_SECONDPWD] = function()
			PoolMgr.GetInstance():GetUI("Msgbox4SECPWD", true, function(arg_67_0)
				...
				SetParent(arg_67_0, arg_57_0._otherPanel, false)
				var_0_11(arg_57_0, arg_57_1)
		...
		[MSGBOX_TYPE_OBTAIN] = function()
			...
			var_0_16(arg_57_0, arg_57_1)

			return
		end,
		[MSGBOX_TYPE_ITEMTIP] = function()
			arg_57_0:GetPanel(ItemTipPanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_JUST_FOR_SHOW] = function()
			arg_57_0:GetPanel(ItemShowPanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_MONTH_CARD_TIP] = function()
			arg_57_0:GetPanel(MonthCardOutDateTipPanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_STORY_CANCEL_TIP] = function()
			arg_57_0:GetPanel(StoryCancelTipPanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_META_SKILL_UNLOCK] = function()
			arg_57_0:GetPanel(MetaSkillUnlockPanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_ACCOUNTDELETE] = function()
			arg_57_0:GetPanel(AccountDeletePanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_STRENGTHEN_BACK] = function()
			arg_57_0:GetPanel(StrengthenBackPanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_CONTENT_ITEMS] = function()
			arg_57_0:GetPanel(Msgbox4ContentItems).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_BLUEPRINT_UNLOCK_ITEM] = function()
			arg_57_0:GetPanel(Msgbox4BlueprintUnlockItem).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_CONFIRM_DELETE] = function()
			arg_57_0:GetPanel(ConfirmEquipmentDeletePanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_CONFIRM_REFORGE_SPWEAPON] = function()
			arg_57_0:GetPanel(Msgbox4SpweaponConfirm).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_SUBPATTERN] = function()
			arg_57_0:GetPanel(arg_57_1.patternClass).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_FILE_DOWNLOAD] = function()
			arg_57_0:GetPanel(FileDownloadPanel).buffer:UpdateView(arg_57_1)

			return
		end,
		[MSGBOX_TYPE_LIKN_COLLECT_GUIDE] = function()
			arg_57_0:GetPanel(Msgbox4LinkCollectGuide).buffer:UpdateView(arg_57_1)
...
function var_0_1.GetPanel(arg_84_0, arg_84_1)
	if not arg_84_0.panelDict[arg_84_1] then
		arg_84_0.panelDict[arg_84_1] = arg_84_1.New(arg_84_0)

		arg_84_0.panelDict[arg_84_1]:Load()
		arg_84_0.panelDict[arg_84_1].buffer:SetParent(arg_84_0._window)
	end

	return arg_84_0.panelDict[arg_84_1]
end

function var_0_1.CloseAndHide(arg_85_0)
	if not arg_85_0.enable then
		return
	end

	local var_85_0 = arg_85_0.settings
	local var_85_1 = arg_85_0.settings.onClose

	if not arg_85_0.settings.onClose then
...
function var_0_1.hide(arg_86_0)
	if not arg_86_0.enable then
		return
	end

	arg_86_0._go:SetActive(false)
	arg_86_0:Clear()
...
function var_0_1.emit(arg_87_0, arg_87_1, ...)
	arg_87_0.analogyMediator = arg_87_0.analogyMediator or {
	...
	return ContextMediator.CommonBindDic[arg_87_1](arg_87_0.analogyMediator, arg_87_1, ...)
end

function var_0_1.closeView(arg_90_0)
	arg_90_0:hide()
