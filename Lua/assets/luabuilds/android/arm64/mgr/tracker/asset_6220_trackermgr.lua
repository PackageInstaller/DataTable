...
function pg.TrackerMgr.Ctor(arg_1_0)
	local BiliTracker

	if PLATFORM_CODE == PLATFORM_CH then
		BiliTracker = require("Mgr.Tracker.BiliTracker")
	elseif PLATFORM_CODE == PLATFORM_JP then
		BiliTracker = require("Mgr.Tracker.YoStarJPTracker")
	elseif PLATFORM_CODE == PLATFORM_US then
		BiliTracker = require("Mgr.Tracker.AiriUSTracker")
	elseif PLATFORM_CODE == PLATFORM_KR then
		BiliTracker = require("Mgr.Tracker.KwxyKrTracker")
	elseif PLATFORM_CODE == PLATFORM_CHT then
		BiliTracker = require("Mgr.Tracker.YongshiTracker")
	end

	if BiliTracker then
		arg_1_0.instance = BiliTracker.New()
	end

	return
end

function pg.TrackerMgr:Call(arg_2_1, ...)
	if self.instance and self.instance[arg_2_1] then
		self.instance[arg_2_1](self.instance, ...)
	end

	return
end

function pg.TrackerMgr:Tracking(arg_3_1, arg_3_2, arg_3_3)
	local var_3_0 = getProxy(UserProxy)
	local var_3_1 = var_3_0 ~= nil and var_3_0:getData() or nil
	local var_3_2

	if var_3_1 ~= nil then
		var_3_2 = var_3_1.uid or nil
