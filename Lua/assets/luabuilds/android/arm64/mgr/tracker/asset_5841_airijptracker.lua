local AiriJPTracker = class("AiriJPTracker")

function AiriJPTracker:Ctor()
	self.mapping = {
...
function AiriJPTracker:Tracking(arg_2_1, arg_2_2, arg_2_3)
	...
	if arg_2_1 == TRACKING_USER_LEVELUP then
		...
		local var_2_0 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_PURCHASE_CLICK then
		local var_2_1 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_PURCHASE_FIRST then
		...
		local var_2_2 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_SHIP_INTENSIFY then
		local var_2_5 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_SHIP_LEVEL_UP then
		local var_2_6 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_SHIP_HIGHEST_LEVEL then
		local var_2_7 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_CUBE_ADD then
		local var_2_8 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_CUBE_CONSUME then
		local var_2_9 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_PROPOSE_SHIP then
		local var_2_10 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_REMOULD_SHIP then
		local var_2_11 = AiriUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_HARD_CHAPTER then
		local var_2_12 = AiriUserEvent.New(self.mapping[arg_2_1])
