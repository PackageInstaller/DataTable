...
function this:Tracking(arg_2_1, arg_2_2, arg_2_3)
	...
	elseif arg_2_1 == TRACKING_SHIP_INTENSIFY then
		local var_2_5 = YoStarUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_SHIP_LEVEL_UP then
		local var_2_6 = YoStarUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_SHIP_HIGHEST_LEVEL then
		local var_2_7 = YoStarUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_CUBE_ADD then
		local var_2_8 = YoStarUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_CUBE_CONSUME then
		local var_2_9 = YoStarUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_PROPOSE_SHIP then
		local var_2_10 = YoStarUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_REMOULD_SHIP then
		local var_2_11 = YoStarUserEvent.New(self.mapping[arg_2_1])
	...
	elseif arg_2_1 == TRACKING_HARD_CHAPTER then
		local var_2_12 = YoStarUserEvent.New(self.mapping[arg_2_1])
