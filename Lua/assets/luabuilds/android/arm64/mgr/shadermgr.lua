...
function pg.ShaderMgr.GetBlurMaterialSync(arg_14_0)
	if arg_14_0.blurMaterial ~= nil then
		return arg_14_0.blurMaterial
	else
		arg_14_0.blurMaterial = Material.New((arg_14_0:GetShader("Hidden/MobileBlur")))
...
function pg.ShaderMgr.BlurTexture(arg_15_0, arg_15_1)
...
function pg.ShaderMgr.SetSpineUIOutline(arg_16_0, arg_16_1, arg_16_2)
	local var_16_0 = Material.New((arg_16_0:GetShader("M02/Unlit Colored_Alpha_UI_Outline")))
