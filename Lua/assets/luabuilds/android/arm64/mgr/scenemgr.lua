...
function pg.SceneMgr.prepare(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	local var_2_0 = arg_2_2.mediator
	local var_2_1
	local var_2_2

	if arg_2_0._cacheUI[arg_2_2.mediator.__cname] ~= nil then
		var_2_2 = arg_2_0._cacheUI[arg_2_2.mediator.__cname]
		arg_2_0._cacheUI[arg_2_2.mediator.__cname] = nil
		...
		if var_2_2:isLoaded() then
			...
			var_2_2.event:connect(BaseUI.LOADED, function()
				var_2_2.event:disconnect(BaseUI.LOADED, var_2_4)
...
function pg.SceneMgr.prepareLayer(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	if arg_4_2 ~= nil then
		...
		table.insertto({}, arg_4_3.children)
	end

	local var_4_1 = {}

	while #{} > 0 do
		local var_4_2 = table.remove({}, 1)

		table.insert(var_4_1, function(arg_5_0)
			local var_5_0 = arg_4_1:retrieveMediator(var_4_2.parent.mediator.__cname):getViewComponent()

			arg_4_0:prepare(arg_4_1, var_4_2, function(arg_6_0)
		...
		table.insertto({}, var_4_2.children)
	end
...
function pg.SceneMgr.enter(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0, iter_8_1 in ipairs(arg_8_1) do
		...
		iter_8_1.viewComponent.event:connect(BaseUI.AVALIBLE, function()
			var_8_1.event:disconnect(BaseUI.AVALIBLE, var_0)
...
function pg.SceneMgr.removeLayer(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	while #{
		...
		local var_10_1 = table.remove({
			arg_10_2
		}, 1)

		if var_10_1.mediator then
	...
	for iter_10_0 = #var_10_0, 1, -1 do
		local var_10_3 = arg_10_1:removeMediator(var_10_0[iter_10_0].mediator.__cname)

		table.insert(var_10_2, function(arg_11_0)
			if var_10_3 then
				arg_10_0:remove(var_10_3, function()
					var_0:onContextRemoved()
					arg_11_0()
...
function pg.SceneMgr.removeLayerMediator(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	while #{
		...
		local var_13_1 = table.remove({
			arg_13_2
		}, 1)

		if var_13_1.mediator then
	...
	for iter_13_0 = #{}, 1, -1 do
		local var_13_3 = arg_13_1:removeMediator(({})[iter_13_0].mediator.__cname)

		if var_13_3 then
			local var_13_4 = var_13_3:getViewComponent()

			if var_13_4:CheckTempCache() then
				PoolMgr.GetInstance():KeepUICache(var_13_4:getUIName(), false)
			end
...
function pg.SceneMgr.remove(arg_14_0, arg_14_1, arg_14_2)
...
function pg.SceneMgr.clearCacheUI(arg_17_0)
...
function pg.SceneMgr.gc(arg_21_0, arg_21_1)
	...
	if arg_21_1:forceGC() or arg_21_0._gcCounter >= arg_21_0._gcLimit then
