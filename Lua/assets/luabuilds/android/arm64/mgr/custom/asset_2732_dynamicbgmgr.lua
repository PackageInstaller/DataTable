...
function pg.DynamicBgMgr:ClearBg(arg_5_1)
	if not self.cache[arg_5_1] then
		return
	end

	local var_5_0 = self.cache[arg_5_1]

	if self.cache[arg_5_1].dyBg then
