...
function pg.SystemOpenMgr:notification(arg_7_1)
	if not var_0_0 then
		return
	end
	...
	if var_7_0 and not pg.MsgboxMgr.GetInstance()._go.activeSelf and var_7_0.story_id and var_7_0.story_id ~= "" and not self.active then
