...
function pg.SecondaryPWDMgr:LimitedOperation(arg_3_1, arg_3_2, arg_3_3)
...
function pg.SecondaryPWDMgr:ChangeSetting(arg_4_1, arg_4_2)
	...
	if #arg_4_1 == 0 then
		var_4_4.type = var_0_1.CLOSE_PASSWORD or var_0_1.CHANGE_SETTING
	end

	var_4_4.settings = arg_4_1
	var_4_4.callback = arg_4_2
	var_4_3.data = var_4_4

	self:LoadLayer((Context.New(var_4_3)))

	return
end

function pg.SecondaryPWDMgr:SetPassword(arg_5_1)
