...
function pg.NodeCanvasMgr:Ctor()
	self:Clear()
...
function pg.NodeCanvasMgr:Active(arg_3_1)
	assert(not self.functionDic)

	self.functionDic = {}

	if arg_3_1 then
		self:SetOwner(arg_3_1)
	end
...
function pg.NodeCanvasMgr:SetBlackboradValue(arg_5_1, arg_5_2, arg_5_3)
	arg_5_3 = arg_5_3 or self.mainBlackboard
...
function pg.NodeCanvasMgr:GetBlackboradValue(arg_6_1, arg_6_2)
	arg_6_2 = arg_6_2 or self.mainBlackboard

	return arg_6_2:GetVariable(arg_6_1).value
end

function pg.NodeCanvasMgr:CopyAllBlackBoardValue(arg_7_1, arg_7_2)
	...
	while var_7_0:MoveNext() do
		if type(var_7_0.Current.Value.value) == "number" then
			...
			self:SetBlackboradValue(var_7_0.Current.Key, var_7_0.Current.Value.value, arg_7_2)
		end
	end
...
function pg.NodeCanvasMgr:SendEvent(arg_8_1, arg_8_2, arg_8_3)
	arg_8_3 = arg_8_3 or self.mainOwner
...
function pg.NodeCanvasMgr:SendGlobalEvent(arg_9_1, arg_9_2)
	self.mainOwner.graph:SendGlobalEvent(arg_9_1, arg_9_2, nil)

	return
end

function pg.NodeCanvasMgr:RegisterFunc(arg_10_1, arg_10_2)
	self.functionDic[arg_10_1] = arg_10_2

	return
end

function pg.NodeCanvasMgr:UnregisterFunc(arg_11_1)
	if self.functionDic[arg_11_1] then
		self.functionDic[arg_11_1] = nil
	else
...
function pg.NodeCanvasMgr:CallFunc(arg_12_1, ...)
	assert(self.functionDic[arg_12_1], "with out register call:" .. arg_12_1)
	self.functionDic[arg_12_1](...)
