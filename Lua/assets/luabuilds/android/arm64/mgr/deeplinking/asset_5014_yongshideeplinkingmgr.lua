...
function pg.YongshiDeepLinkingMgr:SetData(arg_2_1)
	var_0_2("SetData......")

	self.deepLinking = arg_2_1
...
function pg.YongshiDeepLinkingMgr:ShouldSwitchScene()
	if self.deepLinking == nil or self.deepLinking:IsEmpty() then
...
function pg.YongshiDeepLinkingMgr:SwitchScene()
	var_0_2("SwitchScene......")

	if self:ShouldSwitchScene() then
		var_0_3(self.deepLinking.page, self.deepLinking.arg)
		self:Clear()
	end
...
function pg.YongshiDeepLinkingMgr:Clear()
	var_0_2("Clear......")
	self.deepLinking:Clear()

	self.deepLinking = nil
