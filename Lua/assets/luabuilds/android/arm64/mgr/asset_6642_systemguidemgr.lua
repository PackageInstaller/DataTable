...
function pg.SystemGuideMgr.Play(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_1 = _.detect(var_6_0, function(arg_7_0)
		return not var_0_1(arg_7_0.id) and arg_7_0.condition(arg_6_1)
	end)
...
function pg.SystemGuideMgr:PlayChapter(arg_8_1, arg_8_2)
	if arg_8_1.id == 1160002 then
		self:PlayByGuideId("NG0011", nil, arg_8_2)
	elseif arg_8_1:isTypeDefence() then
		self:PlayByGuideId("NG0016", nil, arg_8_2)
	else
		existCall(arg_8_2)
	end
...
function pg.SystemGuideMgr.PlayCommander(arg_12_0)
	...
	for iter_12_0, iter_12_1 in ipairs((_.select(var_12_0, function(arg_13_0)
	...
	seriesAsync(var_12_1)

	return
end

function pg.SystemGuideMgr:PlayGuildAssaultFleet(arg_15_1)
	self:PlayByGuideId("GNG001", {}, arg_15_1)
