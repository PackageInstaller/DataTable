...
function pg.PushNotificationMgr:Push(arg_7_1, arg_7_2, arg_7_3)
	local var_7_0 = arg_7_3 - var_0_0.TimeMgr.GetInstance():GetServerTime()

	self:log(arg_7_1, arg_7_2, os.time() + var_7_0)
...
function pg.PushNotificationMgr:PushAll()
	...
	if var_10_0 and var_10_0:getInited() then
		...
		if var_0_2[var_0_1.PUSH_TYPE_GUILD_MISSION_FORMATION] then
			self:PushGuildMissionFormation()
		end
...
function pg.PushNotificationMgr:PushEvent()
	for iter_11_0, iter_11_1 in ipairs((getProxy(EventProxy):getActiveEvents())) do
		self:Push(var_0_0.push_data_template[self.PUSH_TYPE_EVENT].title, string.gsub(var_0_0.push_data_template[self.PUSH_TYPE_EVENT].content, "$1", iter_11_1.template.title), iter_11_1.finishTime)
	end

	return
end

function pg.PushNotificationMgr:PushGold()
	local var_12_0 = getProxy(NavalAcademyProxy)
	local var_12_1 = var_12_0:GetGoldVO()
	...
	if var_12_5.goldField < var_12_2[var_12_0].store then
		if var_12_5.resUpdateTm + (var_12_2[var_12_0].store - var_12_5.goldField) / var_12_2[var_12_3].production * 60 * 60 / 3 > var_0_0.TimeMgr.GetInstance():GetServerTime() then
			self:Push(var_0_0.push_data_template[self.PUSH_TYPE_GOLD].title, var_0_0.push_data_template[self.PUSH_TYPE_GOLD].content, var_12_5.resUpdateTm + (var_12_2[var_12_0].store - var_12_5.goldField) / var_12_2[var_12_3].production * 60 * 60 / 3)
		end
	end
...
function pg.PushNotificationMgr:PushOil()
	local var_13_0 = getProxy(NavalAcademyProxy)
	local var_13_1 = var_13_0:GetOilVO()
	...
	if var_13_5.oilField < var_13_2[var_13_0].store then
		if var_13_5.resUpdateTm + (var_13_2[var_13_0].store - var_13_5.oilField) / var_13_2[var_13_3].production * 60 * 60 / 3 > var_0_0.TimeMgr.GetInstance():GetServerTime() then
			self:Push(var_0_0.push_data_template[self.PUSH_TYPE_OIL].title, var_0_0.push_data_template[self.PUSH_TYPE_OIL].content, var_13_5.resUpdateTm + (var_13_2[var_13_0].store - var_13_5.oilField) / var_13_2[var_13_3].production * 60 * 60 / 3)
		end
	end
...
function pg.PushNotificationMgr:PushBackyard()
	local var_14_0 = getProxy(DormProxy)
	local var_14_1 = var_14_0:getRawData():getFoodLeftTime()

	if var_14_1 > var_0_0.TimeMgr.GetInstance().GetServerTime(var_14_0) then
		self:Push(var_0_0.push_data_template[self.PUSH_TYPE_BACKYARD].title, var_0_0.push_data_template[self.PUSH_TYPE_BACKYARD].content, var_14_1)
	end

	return
end

function pg.PushNotificationMgr:PushSchool()
	local var_15_0 = getProxy(NavalAcademyProxy)
	local var_15_1 = getProxy(BayProxy).getData(var_15_0)

	for iter_15_0, iter_15_1 in ipairs((var_15_0:getStudents())) do
		if iter_15_1.finishTime > var_0_0.TimeMgr.GetInstance():GetServerTime() then
			local var_15_2 = var_15_1[iter_15_1.shipId].skills[iter_15_1:getSkillId(var_15_1[iter_15_1.shipId])]

			self:Push(var_0_0.push_data_template[self.PUSH_TYPE_SCHOOL].title, string.gsub(string.gsub(var_0_0.push_data_template[self.PUSH_TYPE_SCHOOL].content, "$1", (var_15_1[iter_15_1.shipId]:getName())), "$2", (getSkillName(iter_15_1:getSkillId(var_15_1[iter_15_1.shipId])))), iter_15_1.finishTime)
		end
	end
...
function pg.PushNotificationMgr:PushTechnlogy()
	...
	if var_0_0.push_data_template[var_0_1.PUSH_TYPE_TECHNOLOGY] and var_16_0 then
		...
		if #var_16_1 > 0 and not var_16_1[#var_16_1]:isFinish() then
			self:Push(var_0_0.push_data_template[var_0_1.PUSH_TYPE_TECHNOLOGY].title, var_0_0.push_data_template[var_0_1.PUSH_TYPE_TECHNOLOGY].content, var_16_1[#var_16_1].time)
		end
	end
...
function pg.PushNotificationMgr:PushBluePrint()
	...
	if var_0_0.push_data_template[var_0_1.PUSH_TYPE_BLUEPRINT] and var_17_0 and var_17_1 then
		...
		if var_17_2 then
			for iter_17_0, iter_17_1 in ipairs((var_17_2:getTaskIds())) do
				...
				if var_17_3 > var_0_0.TimeMgr.GetInstance():GetServerTime() then
					if not (var_17_1:getTaskById(iter_17_1) or var_17_1:getFinishTaskById(iter_17_1)) and var_17_1:isFinishPrevTasks(iter_17_1) then
						self:Push(var_0_0.push_data_template[var_0_1.PUSH_TYPE_BLUEPRINT].title, string.gsub(var_0_0.push_data_template[var_0_1.PUSH_TYPE_BLUEPRINT].content, "$1", var_17_2:getShipVO():getConfig("name")), var_17_3)
					end
				end
			end
		end
...
function pg.PushNotificationMgr:PushCommander()
	...
	if var_0_0.push_data_template[var_0_1.PUSH_TYPE_COMMANDER] and var_18_0 then
		for iter_18_0, iter_18_1 in pairs((var_18_0:getBoxes())) do
			if iter_18_1:getState() == CommanderBox.STATE_STARTING then
				self:Push(var_0_0.push_data_template[var_0_1.PUSH_TYPE_COMMANDER].title, var_0_0.push_data_template[var_0_1.PUSH_TYPE_COMMANDER].content, iter_18_1.finishTime)
...
function pg.PushNotificationMgr:PushGuildMissionFormation()
	...
	self:Push(var_0_0.push_data_template[var_0_1.PUSH_TYPE_GUILD_MISSION_FORMATION].title, var_0_0.push_data_template[var_0_1.PUSH_TYPE_GUILD_MISSION_FORMATION].content, var_19_3)
