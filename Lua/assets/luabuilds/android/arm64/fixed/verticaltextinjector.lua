...
local function var_0_2(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	if arg_3_3 < arg_3_2 then
		...
		elseif arg_3_0[arg_3_3] == 1 then
			arg_3_1[arg_3_3] = var_0_2(arg_3_0, arg_3_1, arg_3_2, arg_3_3 + 1)
...
;({}).ModifyMesh = function()
	return function(arg_5_0, arg_5_1)
		...
		for iter_5_0 = 0, var_5_1.Count - 1 do
			local var_5_3 = var_5_1.Count > iter_5_0 + 1 and var_0_0(var_5_1[iter_5_0 + 1]) or utf8_len(var_5_0.text)
			local var_5_4 = 0

			for iter_5_1 = var_0_0(var_5_1[iter_5_0]), var_5_3 - 1 do
