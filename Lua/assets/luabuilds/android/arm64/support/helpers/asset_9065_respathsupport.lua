...
function ResPathSupport.GetShipSkinEffectList(arg_45_0)
	...
	if pg.ship_skin_template[arg_45_0].special_effects and #pg.ship_skin_template[arg_45_0].special_effects > 0 then
		table.insert(var_45_0, var_0_0.CombinePath(var_0_0.ConstPath.UI.Base, pg.ship_skin_template[arg_45_0].special_effects[1]))
	end
...
function ResPathSupport.GetShipSkinSoundList(arg_46_0)
	return (pg.ship_skin_template[arg_46_0].bgm and #pg.ship_skin_template[arg_46_0].bgm > 0 or nil) and var_0_0.GetSoundResList(pg.ship_skin_template[arg_46_0].bgm)
end

function ResPathSupport:GetShipAllRes()
	local var_47_0 = self:getSkinId()
