function table:indexof(arg_1_1, arg_1_2)
	for iter_1_0 = arg_1_2 or 1, #self do
		if self[iter_1_0] == arg_1_1 then
			return iter_1_0
		end
	end
...
function table:removebyvalue(arg_3_1, arg_3_2)
	local var_3_0 = 0

	for iter_3_0 = #self, 1, -1 do
		if self[iter_3_0] == arg_3_1 then
			table.remove(self, iter_3_0)
...
function table:removebykey(arg_4_1)
	self[arg_4_1] = nil
...
function table:equal(arg_9_1)
	if type(self) ~= type(arg_9_1) then
		return false
	end
	...
	if self == arg_9_1 then
		return true
	end

	for iter_9_0, iter_9_1 in pairs(self) do
...
function table:lastof()
	return self[#self]
end

function table:dichotomyInsert(arg_30_1, arg_30_2)
	...
	while var_30_1 < #self do
		local var_30_4 = math.floor((var_30_1 + #self) / 2)
		local var_30_5

		if var_30_3(self[var_30_4]) < var_30_3(arg_30_1) then
			var_30_1 = var_30_4 + 1
		else
			var_30_5 = var_30_4
		end
	...
	table.insert(self, var_30_1, arg_30_1)
...
function table.Diff(arg_34_0, arg_34_1, arg_34_2)
	...
	for iter_34_4, iter_34_5 in pairs(var_34_1) do
		if var_34_0[iter_34_4] then
			table.insert(var_34_2, iter_34_5)
		else
			table.insert(var_34_3, iter_34_5)
		end
	end

	for iter_34_6, iter_34_7 in pairs(var_34_0) do
		if not var_34_1[iter_34_6] then
			table.insert(var_34_4, iter_34_7)
		end
	end
