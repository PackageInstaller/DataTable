...
function unicode_to_utf8(arg_24_0)
	...
	while true do
		...
		if var_24_3 <= 127 then
			var_24_0 = var_24_0 .. string.char(bit.band(var_24_3, 127))
		elseif var_24_3 >= 128 and var_24_3 <= 2047 then
			var_24_0 = var_24_0 .. string.char(bit.bor(192, bit.band(bit.rshift(var_24_3, 6), 31)))
			var_24_0 = var_24_0 .. string.char(bit.bor(128, bit.band(var_24_3, 63)))
		elseif var_24_3 >= 2048 and var_24_3 <= 65535 then
			var_24_0 = var_24_0 .. string.char(bit.bor(224, bit.band(bit.rshift(var_24_3, 12), 15)))
			var_24_0 = var_24_0 .. string.char(bit.bor(128, bit.band(bit.rshift(var_24_3, 6), 63)))
			var_24_0 = var_24_0 .. string.char(bit.bor(128, bit.band(var_24_3, 63)))
		end
	end
...
function utf8_to_unicode(arg_25_0)
	...
	while var_25_2 ~= nil do
		...
		if var_25_2 >= 0 and var_25_2 <= 127 then
			var_25_4 = var_25_2
			var_25_5 = 0
		elseif bit.band(var_25_2, 224) == 192 then
			var_25_1 = var_25_1 + 1
			var_25_2 = string.byte(arg_25_0, var_25_1)
			var_25_4 = bit.bor(bit.band(var_25_2, bit.rshift(255, 2)), bit.lshift(bit.band(0, bit.rshift(255, 6)), 6))
			var_25_5 = bit.rshift(bit.band(var_25_2, bit.rshift(255, 3)), 2)
		elseif bit.band(var_25_2, 240) == 224 then
			var_25_1 = var_25_1 + 1
			var_25_2 = string.byte(arg_25_0, var_25_1)
			var_25_1 = var_25_1 + 1
			var_25_2 = string.byte(arg_25_0, var_25_1)
			var_25_4 = bit.bor(bit.lshift(bit.band(0, bit.rshift(255, 6)), 6), (bit.band(var_25_2, bit.rshift(255, 2))))
			var_25_5 = bit.bor(bit.lshift(bit.band(var_25_2, bit.rshift(255, 3)), 4), bit.rshift(bit.band(var_25_2, bit.rshift(255, 2)), 2))
		end
