...
function pg.CldArea.AddNode(arg_2_0, arg_2_1)
...
function pg.CldArea.InArea(arg_3_0, arg_3_1, arg_3_2)
...
function pg.CldArea.GetAreaIndex(arg_4_0, arg_4_1, arg_4_2)
	local var_4_0 = arg_4_1.x >= arg_4_0.center.x and 0 or 2
	local var_4_1 = arg_4_2.x >= arg_4_0.center.x and 0 or 2

	if (arg_4_1.x >= arg_4_0.center.x and 0 or 2) ~= (arg_4_2.x >= arg_4_0.center.x and 0 or 2) then
		return 0
	end

	local var_4_2 = var_4_0 + (arg_4_1.z >= arg_4_0.center.z and 1 or 2)

	return var_4_0 + (arg_4_1.z >= arg_4_0.center.z and 1 or 2) == var_4_1 + (arg_4_2.z >= arg_4_0.center.z and 1 or 2) and var_4_2 or 0
end

local var_0_5 = class("ColliderTree")

pg.ColliderTree = var_0_5
var_0_5.MaxLayer = 3
...
function var_0_5.Update(arg_9_0, arg_9_1)
	...
	local var_9_2 = arg_9_0:_findParent(arg_9_1, var_9_0)

	if var_9_2 ~= arg_9_1.area then
		var_0_4.removebyvalue(arg_9_1.area.nodes, arg_9_1)
		arg_9_0:_insert(arg_9_1, var_9_2)
	end
...
function var_0_5.CylinderCheck(arg_12_0, arg_12_1)
	...
	if arg_12_0.cylinder and arg_12_1.cylinder then
		...
		var_12_3 = (arg_12_0.cylinder and arg_12_0 or arg_12_1).range
		var_12_4 = (arg_12_0.cylinder and arg_12_0 or arg_12_1).center.x
	end

	local var_12_5 = (arg_12_0.cylinder and arg_12_0 or arg_12_1).center.z
	local var_12_6 = arg_12_0.cylinder and arg_12_1 or arg_12_0

	if var_12_4 >= (arg_12_0.cylinder and arg_12_1 or arg_12_0).min.x and var_12_4 <= var_12_6.max.x then
...
function var_0_5.GetCldList(arg_14_0, arg_14_1, arg_14_2)
	local var_14_1 = arg_14_0.root

	while not var_14_1.isLeaf do
		local var_14_2 = var_14_1:GetAreaIndex(arg_14_1.min, arg_14_1.max)
		...
		for iter_14_0, iter_14_1 in ipairs(var_14_1.nodes) do
			if var_0_5.Intersect(iter_14_1.min, iter_14_1.max, arg_14_1.min, arg_14_1.max) and var_0_5.CylinderCheck(arg_14_1, iter_14_1) then
				var_0_4.insert({}, iter_14_1)
			end
		end

		var_14_1 = var_14_1.childs[var_14_2]
	end

	local var_14_3 = arg_14_0.cldStack

	var_0_4.insert(arg_14_0.cldStack, var_14_1)

	while #var_14_3 > 0 do
		local var_14_4 = var_0_4.remove(var_14_3)

		for iter_14_2, iter_14_3 in ipairs(var_14_4.nodes) do
			if var_0_5.Intersect(iter_14_3.min, iter_14_3.max, arg_14_1.min, arg_14_1.max) and var_0_5.CylinderCheck(arg_14_1, iter_14_3) then
				var_0_4.insert({}, iter_14_3)
			end
		end

		for iter_14_4, iter_14_5 in pairs(var_14_4.childs) do
			if iter_14_5 ~= null and var_0_5.Intersect(iter_14_5.min, iter_14_5.max, arg_14_1.min, arg_14_1.max) then
				var_0_4.insert(var_14_3, iter_14_5)
			end
		end
	end
...
function var_0_5.GetCldListGradient(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	local var_15_4 = arg_15_0:GetCldList(var_15_3, nil)
...
function var_0_5.pointInEllipse(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4, arg_17_5)
	...
	return (arg_17_0 - arg_17_2) * (arg_17_0 - arg_17_2) / (arg_17_4 * arg_17_4) + var_17_0 * var_17_0 / (arg_17_5 * arg_17_5) <= 1
end
...
function var_0_5.lineIntersectsEllipse(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4, arg_18_5, arg_18_6, arg_18_7)
	...
	arg_18_0 = arg_18_0 - arg_18_4
	arg_18_3 = arg_18_3 - arg_18_5
	arg_18_2 = arg_18_2 - arg_18_4

	local var_18_0 = (arg_18_2 - arg_18_0) * (arg_18_2 - arg_18_0) / (arg_18_6 * arg_18_6) + (arg_18_3 - arg_18_1) * (arg_18_3 - arg_18_1) / (arg_18_7 * arg_18_7)
	local var_18_1 = 2 * (arg_18_0 * (arg_18_2 - arg_18_0) / (arg_18_6 * arg_18_6) + arg_18_1 * (arg_18_3 - arg_18_1) / (arg_18_7 * arg_18_7))

	if var_18_1 * var_18_1 - 4 * ((arg_18_2 - arg_18_0) * (arg_18_2 - arg_18_0) / (arg_18_6 * arg_18_6) + (arg_18_3 - arg_18_1) * (arg_18_3 - arg_18_1) / (arg_18_7 * arg_18_7)) * (arg_18_0 * arg_18_0 / (arg_18_6 * arg_18_6) + arg_18_1 * arg_18_1 / (arg_18_7 * arg_18_7) - 1) < 0 then
		return false
	end

	local var_18_2 = math.sqrt(var_18_1 * var_18_1 - 4 * ((arg_18_2 - arg_18_0) * (arg_18_2 - arg_18_0) / (arg_18_6 * arg_18_6) + (arg_18_3 - arg_18_1) * (arg_18_3 - arg_18_1) / (arg_18_7 * arg_18_7)) * (arg_18_0 * arg_18_0 / (arg_18_6 * arg_18_6) + arg_18_1 * arg_18_1 / (arg_18_7 * arg_18_7) - 1))
	local var_18_3 = (-var_18_1 - var_18_2) / (2 * var_18_0)
	local var_18_4 = (-var_18_1 + var_18_2) / (2 * var_18_0)

	return (-var_18_1 - var_18_2) / (2 * var_18_0) >= 0 and var_18_3 <= 1 or var_18_4 >= 0 and var_18_4 <= 1
end

function var_0_5.ellipseIntersectsRect(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4, arg_19_5)
	if arg_19_0 - arg_19_2 > arg_19_5.x or arg_19_0 + arg_19_2 < arg_19_4.x or arg_19_1 - arg_19_3 > arg_19_5.z or arg_19_1 + arg_19_3 < arg_19_4.z then
		return false
	end
	...
	for iter_19_2 = 1, 4 do
		if var_0_5.lineIntersectsEllipse(var_19_0[iter_19_2][1], var_19_0[iter_19_2][2], var_19_0[iter_19_2 % 4 + 1][1], var_19_0[iter_19_2 % 4 + 1][2], arg_19_0, arg_19_1, arg_19_2, arg_19_3) then
			return true
		end
	end
