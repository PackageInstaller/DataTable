...
function pg.Tool.Swap(arg_2_0, arg_2_1, arg_2_2)
...
function pg.Tool.RandomMN(arg_3_0, arg_3_1)
	local var_3_0 = var_0_0.Tool.Seq(arg_3_0)

	for iter_3_0 = 1, arg_3_1 do
		local var_3_1 = math.random(#var_3_0)

		;({})[iter_3_0] = var_3_0[var_3_1]

		var_0_0.Tool.Swap(var_3_0, var_3_1, #var_3_0)
	end

	return {}
end

function pg.Tool.FilterY(arg_4_0)
	return Vector3(arg_4_0.x, 0, arg_4_0.z)
end

function pg.Tool.FilterZ(arg_5_0)
