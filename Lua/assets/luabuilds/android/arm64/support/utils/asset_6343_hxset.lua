...
function var_0_0.calcLocalizationUse()
	if PLATFORM_CODE == PLATFORM_CH then
		...
		if var_0_0.antiSkinMode and not var_2_0:IsSameDay(PlayerPrefs.GetInt("localization_time_2_" .. var_2_1, 0), var_2_0:GetServerTime()) then
			...
			PlayerPrefs.SetInt("localization_time_2_" .. var_2_1, var_2_0:GetServerTime())
		end
	end
...
function var_0_0.update()
	...
	pg.ship_data_statistics = setmetatable({}, {
		__index = function(self, arg_6_1)
			if var_5_3[arg_6_1] == nil then
				return var_5_3[arg_6_1]
			elseif var_5_3[arg_6_1].name == nil then
				self[arg_6_1] = var_5_3[arg_6_1]
			...
			if var_0_0.isHXNation(var_5_3[arg_6_1].nationality) and var_5_0[var_5_3[arg_6_1].name] then
				self[arg_6_1].name = var_5_0[var_5_3[arg_6_1].name]
			end

			if var_5_3[arg_6_1].english_name and #var_5_3[arg_6_1].english_name > 0 then
				self[arg_6_1].english_name = var_5_3[arg_6_1].english_name

				for iter_6_0, iter_6_1 in pairs(var_5_2) do
					self[arg_6_1].english_name = string.gsub(self[arg_6_1].english_name or "", iter_6_0, iter_6_1)
				end
			end

			setmetatable(self[arg_6_1], {
				__index = var_5_3[arg_6_1]
			})
	...
	pg.fleet_tech_ship_class = setmetatable({}, {
		__index = function(self, arg_7_1)
			...
			self[arg_7_1] = var_0_0.isHXNation(var_7_0.nation) and var_5_0[var_7_1] and setmetatable({
	...
	pg.enemy_data_statistics = setmetatable({}, {
		__index = function(self, arg_8_1)
			if var_5_5[arg_8_1] == nil then
				return var_5_5[arg_8_1]
			elseif var_5_5[arg_8_1].name == nil then
				self[arg_8_1] = var_5_5[arg_8_1]

				return self[arg_8_1]
			end

			self[arg_8_1] = var_0_0.isHXNation(var_5_5[arg_8_1].nationality) and var_5_0[var_5_5[arg_8_1].name] and setmetatable({
				name = var_5_0[var_5_5[arg_8_1].name]
			}, {
				__index = var_5_5[arg_8_1]
			}) or var_5_5[arg_8_1]
	...
	pg.equip_data_statistics = setmetatable({}, {
		__index = function(self, arg_9_1)
			if var_5_6[arg_9_1] == nil then
				return var_5_6[arg_9_1]
			elseif var_5_6[arg_9_1].name == nil then
				self[arg_9_1] = var_5_6[arg_9_1]

				return self[arg_9_1]
			end

			self[arg_9_1] = var_5_1[var_5_6[arg_9_1].name] and setmetatable({
				name = var_5_1[var_5_6[arg_9_1].name]
			}, {
				__index = var_5_6[arg_9_1]
			}) or var_5_6[arg_9_1]
	...
	pg.island_unit_character = setmetatable({}, {
		__index = function(self, arg_10_1)
			if var_5_7[arg_10_1] == nil then
				return var_5_7[arg_10_1]
			elseif var_5_7[arg_10_1].name == nil then
				self[arg_10_1] = var_5_7[arg_10_1]
			...
			if var_5_0[var_5_7[arg_10_1].name] then
				self[arg_10_1].name = var_5_0[var_5_7[arg_10_1].name]
			end

			setmetatable(self[arg_10_1], {
				__index = var_5_7[arg_10_1]
			})
	...
	return string.gsub(arg_11_0 or "", "{namecode:(%d+).-}", function(arg_12_0)
		...
		if var_12_0 then
			...
			if var_0_0.codeMode or arg_11_1 then
				var_12_1 = var_12_0.name or var_12_0.code
			end
		end
...
function var_0_0.HxPath(arg_16_0)
	if PLATFORM_CODE == PLATFORM_CH and HXSet.isHx() then
		return checkABExist(arg_16_0 .. "_hx_ch" .. pg.SdkMgr.GetInstance():GetChannelUIDIncludeHarmony()) and arg_16_0 .. "_hx_ch" .. pg.SdkMgr.GetInstance():GetChannelUIDIncludeHarmony() or arg_16_0
	else
		return arg_16_0
	end
