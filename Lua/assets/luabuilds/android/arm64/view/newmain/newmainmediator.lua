...
function var_0_0.register(arg_1_0)
	...
	arg_1_0:bind(var_0_0.SKIP_ESCORT, function(arg_4_0)
		...
		local var_4_3 = pg.m02
		local var_4_5 = GAME.GO_SCENE
		local var_4_6 = SCENE.LEVEL
		local var_4_7 = {}

		if var_4_2 and var_4_2:getConfig("map") == var_4_1.id then
			var_4_7.chapterId = var_4_2.id or nil
			var_4_7.mapIdx = var_4_1.id
	...
	arg_1_0:bind(var_0_0.GO_SNAPSHOT, function(arg_12_0)
		local var_12_0 = arg_1_0.viewComponent.paintingView:IsLive2DState()
		local var_12_1

		if isa(arg_1_0.viewComponent.bgView.ship, VirtualEducateCharShip) then
			var_12_1 = arg_1_0.viewComponent.bgView.ship.educateCharId
			var_12_0 = false
		end

		arg_1_0:sendNotification(GAME.GO_SCENE, SCENE.SNAPSHOT, {
			skinId = arg_1_0.viewComponent.bgView.ship:getSkinId(),
			live2d = var_12_0,
			tbId = var_12_1,
			propose = arg_1_0.viewComponent.bgView.ship.propose
		})
