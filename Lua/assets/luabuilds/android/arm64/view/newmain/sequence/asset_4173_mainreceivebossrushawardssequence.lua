local MainReceiveBossRushAwardsSequence = class("MainReceiveBossRushAwardsSequence")

function MainReceiveBossRushAwardsSequence:Execute(arg_1_1)
	seriesAsync({
		function(arg_2_0)
...
return MainReceiveBossRushAwardsSequence
