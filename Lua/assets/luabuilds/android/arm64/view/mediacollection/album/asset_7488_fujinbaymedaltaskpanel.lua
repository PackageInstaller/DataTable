local FujinBayMedalTaskPanel = class("FujinBayMedalTaskPanel", import(".MedalTaskPanel"))

function FujinBayMedalTaskPanel:UpdateList(arg_1_1)
	self.UIlist:make(function(arg_2_0, arg_2_1, arg_2_2)
		if arg_2_0 == UIItemList.EventUpdate then
			...
			local var_2_7, var_2_8 = self:getTaskProgress(var_2_0)
			local var_2_9, var_2_10 = self:getTaskTarget(var_2_0)
			...
			self:updateAwards(var_2_0:getConfig("award_display"), var_2_3, (var_2_3:GetChild(0)))
			...
			onButton(self, var_2_6, function()
				self._parent:emit(MedalAlbumTemplateMediator.ON_TASK_GO, var_2_0)

				return
			end, SFX_PANEL)
			onButton(self, var_2_4, function()
				self._parent:emit(MedalAlbumTemplateMediator.ON_TASK_SUBMIT, var_2_0)
	...
	if self._parent.TASK_ANIM and self._parent.TASK_ENTER_ANIM_Time and self._parent.TASK_Time then
		local var_1_0 = findTF(self._tf, "panel/list").transform.childCount

		onDelayTick(function()
			for iter_5_0 = 0, var_1_0 - 1 do
				local var_5_0 = findTF(self._tf, "panel/list"):GetChild(iter_5_0)
				...
				onDelayTick(function()
					...
					quickPlayAnimation(var_5_0, self._parent.TASK_ANIM)

					return
				end, self._parent.TASK_Time * (iter_5_0 + 1))
			end
