local DreamTourMedalAlbumView = class("DreamTourMedalAlbumView", import("view.mediaCollection.album.FujinBayMedalAlbumView"))

DreamTourMedalAlbumView.GROUP_ID = 50659
DreamTourMedalAlbumView.MEDAL_COUNT = 8
DreamTourMedalAlbumView.HELP_TIPS = "help_starLightAlbum"

function DreamTourMedalAlbumView:getUIName()
	return "MedalAlbumDreamTourPage"
end

function DreamTourMedalAlbumView:FindUI()
...
return DreamTourMedalAlbumView
