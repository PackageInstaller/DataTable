local FujinBayMedalAlbumView = class("FujinBayMedalAlbumView", import(".MedalAlbumTemplateView"))

FujinBayMedalAlbumView.GROUP_ID = 50616
FujinBayMedalAlbumView.MEDAL_COUNT = 7
FujinBayMedalAlbumView.HELP_TIPS = "help_starLightAlbum"

function FujinBayMedalAlbumView:getUIName()
	return "MedalAlbumFujinBayPage"
end

function FujinBayMedalAlbumView:FindUI()
