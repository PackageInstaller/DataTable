local MedalTaskPanel = class("MedalTaskPanel")

function MedalTaskPanel:Ctor(arg_1_1, arg_1_2)
	self._go = arg_1_1
...
function MedalTaskPanel:SetMedalGroup(arg_6_1)
...
function MedalTaskPanel:ShowMedalTask()
...
function MedalTaskPanel:UpdateList(arg_10_1)
	self.UIlist:make(function(arg_11_0, arg_11_1, arg_11_2)
		if arg_11_0 == UIItemList.EventUpdate then
			...
			local var_11_5, var_11_6 = self:getTaskProgress(var_11_0)
			local var_11_7, var_11_8 = self:getTaskTarget(var_11_0)
			...
			self:updateAwards(var_11_0:getConfig("award_display"), var_11_1, (var_11_1:GetChild(0)))
...
function MedalTaskPanel:updateAwards(arg_16_1, arg_16_2, arg_16_3)
	...
	for iter_16_1 = 1, arg_16_2.childCount do
		...
		if var_16_2 then
			...
			updateDrop(findTF(var_16_1, "mask"), var_16_4)

			if var_16_4.type == DROP_TYPE_EQUIPMENT_SKIN then
			...
			onButton(self, var_16_1, function()
				self._parent:emit(BaseUI.ON_DROP, var_16_4)
...
function MedalTaskPanel:sort(arg_18_1)
	local var_18_0 = {}
...
function MedalTaskPanel:SetActive(arg_19_1)
...
function MedalTaskPanel:IsActive()
	return self._active
end

function MedalTaskPanel:Dispose()
	pg.DelegateInfo.Dispose(self)

	return
end

return MedalTaskPanel
