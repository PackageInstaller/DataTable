local RapidSeasideMedalAlbumView = class("RapidSeasideMedalAlbumView", import(".MedalAlbumTemplateView"))

RapidSeasideMedalAlbumView.GROUP_ID = 51113
RapidSeasideMedalAlbumView.MEDAL_COUNT = 7
RapidSeasideMedalAlbumView.ICON_SCALE = 1
RapidSeasideMedalAlbumView.HELP_TIPS = "help_starLightAlbum"

function RapidSeasideMedalAlbumView:getUIName()
	return "MedalAlbumRapidSeasidePage"
end

function RapidSeasideMedalAlbumView:FindUI()
	...
	self.medalDetailView = DreamTourMedalDetailPanel.New(self._tf:Find("DetailView"), self)
...
function RapidSeasideMedalAlbumView:OwnTrophy()
	return getProxy(DormProxy):getData():GetOwnFurnitureCount(344) > 0
end

return RapidSeasideMedalAlbumView
