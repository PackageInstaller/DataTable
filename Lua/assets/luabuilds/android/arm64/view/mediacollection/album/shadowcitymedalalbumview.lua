local ShadowCityMedalAlbumView = class("ShadowCityMedalAlbumView", import(".MedalAlbumTemplateView"))

ShadowCityMedalAlbumView.GROUP_ID = 51143
ShadowCityMedalAlbumView.HELP_TIPS = "help_starLightAlbum"

function ShadowCityMedalAlbumView:getUIName()
	return "MedalAlbumShadowCityPage"
end

function ShadowCityMedalAlbumView:FindUI()
	...
	self.medalDetailView = ShadowCityMedalDetailPanel.New(self._tf:Find("DetailView"), self)
...
return ShadowCityMedalAlbumView
