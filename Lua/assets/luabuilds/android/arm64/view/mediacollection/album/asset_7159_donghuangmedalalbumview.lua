local DonghuangMedalAlbumView = class("DonghuangMedalAlbumView", import(".MedalAlbumTemplateView"))

DonghuangMedalAlbumView.GROUP_ID = 50405
DonghuangMedalAlbumView.MEDAL_COUNT = 8
DonghuangMedalAlbumView.HELP_TIPS = "help_starLightAlbum"
DonghuangMedalAlbumView.setColorstateText = "#b1b1b1"
DonghuangMedalAlbumView.setColorstate = "#b1b1b1"

function DonghuangMedalAlbumView:getUIName()
	return "MedalAlbumMDonghuang"
end

function DonghuangMedalAlbumView:FindUI()
...
return DonghuangMedalAlbumView
