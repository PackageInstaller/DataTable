local ShiningMagicMedalAlbumView = class("ShiningMagicMedalAlbumView", import(".MedalAlbumTemplateView"))

ShiningMagicMedalAlbumView.GROUP_ID = 51154
ShiningMagicMedalAlbumView.ICON_SCALE = 1
ShiningMagicMedalAlbumView.MEDAL_COUNT = 7
ShiningMagicMedalAlbumView.HELP_TIPS = "help_starLightAlbum"

function ShiningMagicMedalAlbumView:getUIName()
	return "MedalAlbumShiningMagicPage"
end

function ShiningMagicMedalAlbumView:FindUI()
...
return ShiningMagicMedalAlbumView
