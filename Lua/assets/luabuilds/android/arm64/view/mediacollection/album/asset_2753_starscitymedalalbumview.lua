local StarsCityMedalAlbumView = class("StarsCityMedalAlbumView", import(".MedalAlbumTemplateView"))

StarsCityMedalAlbumView.GROUP_ID = 51110
StarsCityMedalAlbumView.HELP_TIPS = "help_starLightAlbum"

function StarsCityMedalAlbumView:getUIName()
	return "MedalAlbumStarsCityPage"
end

function StarsCityMedalAlbumView:FindUI()
...
return StarsCityMedalAlbumView
