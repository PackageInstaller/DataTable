...
function var_0_0.flush(arg_3_0)
	...
	setScrollText(arg_3_0.nameTxt, arg_3_0.shipVO:GetColorName())
	arg_3_0:updateProps({})
	...
	setProposeMarkIcon(arg_3_0.proposeMark, arg_3_0.shipVO)
...
function var_0_0.clear(arg_6_0)
	if arg_6_0.shipVO then
		retPaintingPrefab(arg_6_0.paintingTr, arg_6_0.shipVO:getPainting())
	end
