local ChangeSkinLink = class("ChangeSkinLink")

ChangeSkinLink.L2D_SAVE_TEMPLATE_DISPOSE = {
	705022,
	705023,
	107102,
	107103
}
ChangeSkinLink.L2D_PARAMETER_DIC = {}
ChangeSkinLink.L2D_TYPE = 1
ChangeSkinLink.SPINE_TYPE = 2
ChangeSkinLink.change_parameter_link_skin = 1
ChangeSkinLink.change_parameter_link_slot = 2

function ChangeSkinLink:GetSaveL2dData(arg_1_1)
	local var_1_0 = {}

	for iter_1_0, iter_1_1 in ipairs((pg.ship_skin_template[arg_1_1].ship_l2d_id and #pg.ship_skin_template[arg_1_1].ship_l2d_id > 0 or nil) and pg.ship_skin_template[arg_1_1].ship_l2d_id) do
		if pg.ship_l2d[iter_1_1] then
			if pg.ship_l2d[iter_1_1].parameter and #pg.ship_l2d[iter_1_1].parameter > 0 then
				var_1_0[pg.ship_l2d[iter_1_1].parameter] = Live2dConst.GetDragData(iter_1_1, arg_1_1, self)
			end
		else
...
ChangeSkinLink.CHANGE_SKIN_LINK_DATA = {
	[499024] = {
		link_id = 499023,
		type = ChangeSkinLink.SPINE_TYPE,
		link_type = ChangeSkinLink.L2D_TYPE,
		relations = {
			{
				skeleton_skin = "1",
				type = ChangeSkinLink.change_parameter_link_skin,
				link_parameter = {
					{
						num = 0,
						name = "touch_drag1",
	...
	[705023] = {
		...
		relations = {
			{
				type = ChangeSkinLink.change_parameter_link_slot,
				link_parameter = {
					{
						num = 0,
						name = "touch_drag7",
