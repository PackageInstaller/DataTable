local ShopSingleWindow = class("ShopSingleWindow", import("...base.BaseSubView"))

function ShopSingleWindow:getUIName()
	return "ShopsUISinglebox"
end

function ShopSingleWindow:OnLoaded()
...
function ShopSingleWindow:OnInit()
...
function ShopSingleWindow:Open(arg_7_1, arg_7_2)
	self.opening = true
...
function ShopSingleWindow:Close()
...
function ShopSingleWindow:OnDestroy()
	if self.opening then
		self:Close()
	end
