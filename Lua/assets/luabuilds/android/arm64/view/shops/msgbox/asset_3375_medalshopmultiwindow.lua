local MedalShopMultiWindow = class("MedalShopMultiWindow", import("...base.BaseSubView"))

function MedalShopMultiWindow:getUIName()
	return "ShopsUIMsgbox"
end

function MedalShopMultiWindow:OnLoaded()
...
function MedalShopMultiWindow:OnInit()
...
function MedalShopMultiWindow:Show(arg_6_1, arg_6_2)
	self:InitWindow(arg_6_1, arg_6_2)
	pg.UIMgr.GetInstance():BlurPanel(self._tf)
	MedalShopMultiWindow.super.Show(self)

	return
end

function MedalShopMultiWindow:Hide()
	pg.UIMgr.GetInstance():UnOverlayPanel(self._tf, self._parentTf)
	MedalShopMultiWindow.super.Hide(self)
...
function MedalShopMultiWindow:OnDestroy()
