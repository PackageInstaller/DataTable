local ChapterExpelAIAction = class("ChapterExpelAIAction")

function ChapterExpelAIAction:Ctor(arg_1_1)
...
function ChapterExpelAIAction:SetTargetLine(arg_6_1, arg_6_2)
	self.sourceLine = arg_6_1
	self.targetLine = arg_6_2

	return
end

function ChapterExpelAIAction:applyTo(arg_7_1, arg_7_2)
	if not arg_7_2 then
		local var_7_0 = 0
		local var_7_1 = 0
		...
		if #self.cellUpdates > 0 then
			_.each(self.cellUpdates, function(arg_9_0)
				if isa(arg_9_0, ChapterChampionPackage) then
					var_7_0 = bit.bor(var_7_0, (arg_7_1:mergeChampion(arg_9_0, true) or nil) and (ChapterConst.DirtyChampionPosition or ChapterConst.DirtyChampion))
				else
			...
			arg_7_1:clearChapterCell(self.sourceLine.row, self.sourceLine.column)

			local var_7_2 = arg_7_1:getChampion(self.sourceLine.row, self.sourceLine.column)
...
function ChapterExpelAIAction:PlayAIAction(arg_11_1, arg_11_2, arg_11_3)
	seriesAsync({
		function(arg_12_0)
