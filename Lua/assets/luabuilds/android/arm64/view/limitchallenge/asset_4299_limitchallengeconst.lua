...
function LimitChallengeConst.IsOpen()
	...
	return pg.SystemOpenMgr.GetInstance():isOpenSystem(var_8_0, "LimitChallengeMediator") and pg.SystemOpenMgr.GetInstance():isOpenSystem(var_8_0, "ChallengeMainMediator")
end
...
function LimitChallengeConst.IsInAct()
	...
	return LOCK_LIMIT_CHALLENGE and checkExist(getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_CHALLENGE), {
		"isEnd"
	}) == false or (false or nil) and true
end
