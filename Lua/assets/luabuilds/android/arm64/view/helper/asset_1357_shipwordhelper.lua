local ShipWordHelper = class("ShipWordHelper")
...
ShipWordHelper.WORD_TYPE_MAIN = "main"
ShipWordHelper.WORD_TYPE_SKILL = "skill"
ShipWordHelper.WORD_TYPE_UNLOCK = "unlock"
ShipWordHelper.WORD_TYPE_PROFILE = "profile"
ShipWordHelper.WORD_TYPE_DROP = "drop_descrip"
ShipWordHelper.WORD_TYPE_MVP = "win_mvp"
ShipWordHelper.WORD_TYPE_LOSE = "lose"
ShipWordHelper.WORD_TYPE_UPGRADE = "upgrade"
ShipWordHelper.CV_KEY_REPALCE = 0
ShipWordHelper.CV_KEY_BAN = -1
ShipWordHelper.CV_KEY_BAN_NEW = -2
ShipWordHelper.CVBattleKey = {
	hp = "hp",
	link2 = "link2",
	link4 = "link4",
	link5 = "link5",
...
function ShipWordHelper:GetLanguageSetting()
	return var_0_16(self)
end
...
local function var_0_18(arg_14_0, arg_14_1)
	...
	local function var_14_0(arg_15_0)
		return (arg_14_0 == 2 and arg_15_0.voice_key_2 >= 0 or nil) and (arg_15_0.voice_key_2 or arg_15_0.voice_key)
	end

	local var_14_1 = var_14_0(var_0_2[arg_14_1])
...
local function var_0_19(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4)
	if arg_16_0 then
		...
		if var_16_2 == 2 then
			var_16_3 = arg_16_0.voice_key_2 or arg_16_0.voice_key
		end

		local var_16_4 = var_0_4[(arg_16_2 == ShipWordHelper.WORD_TYPE_MAIN or nil) and (arg_16_2 .. arg_16_3[1] or arg_16_2)] and var_0_4[(arg_16_2 == ShipWordHelper.WORD_TYPE_MAIN or nil) and (arg_16_2 .. arg_16_3[1] or arg_16_2)].resource_key

		if not (var_0_4[(arg_16_2 == ShipWordHelper.WORD_TYPE_MAIN or nil) and (arg_16_2 .. arg_16_3[1] or arg_16_2)] and var_0_4[(arg_16_2 == ShipWordHelper.WORD_TYPE_MAIN or nil) and (arg_16_2 .. arg_16_3[1] or arg_16_2)].resource_key) and arg_16_2 == ShipWordHelper.WORD_TYPE_MAIN then
			var_16_4 = arg_16_2 .. "_" .. arg_16_3[1]
		end

		if var_16_3 ~= ShipWordHelper.CV_KEY_BAN and var_16_4 then
			var_16_0 = var_0_18(var_16_2, arg_16_1)

			local var_16_5

			if arg_16_4 and var_16_3 == ShipWordHelper.CV_KEY_REPALCE then
				if var_0_1[arg_16_1].group_index ~= 0 then
					var_16_5 = var_0_1[arg_16_1].group_index
				end
			end
...
local function var_0_20(arg_17_0, arg_17_1, arg_17_2)
	return ShipWordHelper.ExistDifferentWord(arg_17_0, arg_17_1, arg_17_2) and var_0_2[arg_17_0].voice_key == ShipWordHelper.CV_KEY_BAN_NEW
end
...
function ShipWordHelper:GetWordAndCV(arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	local var_19_0
	local var_19_1
	local var_19_2
	local var_19_3 = {
	...
	local var_19_5, var_19_6 = var_0_15(self, arg_19_1, var_19_4, arg_19_4, var_19_3)

	if not var_0_8(var_19_5) then
		var_19_0 = var_19_5
		var_19_1 = var_0_13(self, arg_19_1, var_19_4)
	else
		var_19_4 = {
			arg_19_2
		}
		...
		var_19_1 = var_0_13(self, arg_19_1, var_19_4, var_19_3)

		if ShipWordHelper.WORD_TYPE_MAIN == arg_19_1 then
			local var_19_9, var_19_10 = var_0_21(self, arg_19_4)
	...
	if not var_0_20(self, arg_19_1, arg_19_2) then
		var_19_12, var_19_13 = var_0_19(var_19_1, self, arg_19_1, var_19_4, not var_19_3[1])
...
function ShipWordHelper:RawGetWord(arg_20_1)
	return var_0_2[self][arg_20_1]
end

function ShipWordHelper:RawGetCVKey()
	return var_0_18(var_0_16(self), self)
end

function ShipWordHelper:GetDefaultSkin()
	return var_0_11(self)
end

function ShipWordHelper:GetMainSceneWordCnt(arg_23_1)
	local var_23_0 = var_0_2[self]

	if not var_0_2[self] or not var_23_0[ShipWordHelper.WORD_TYPE_MAIN] or var_23_0[ShipWordHelper.WORD_TYPE_MAIN] == "" then
		var_23_0 = var_0_2[var_0_11(self)]
	end

	local var_23_1 = 0

	if var_23_0 and var_23_0[ShipWordHelper.WORD_TYPE_MAIN] and var_23_0[ShipWordHelper.WORD_TYPE_MAIN] ~= "" then
		var_23_1 = #string.split(var_23_0[ShipWordHelper.WORD_TYPE_MAIN], "|")
	end

	local var_23_2, var_23_3 = var_0_21(self, arg_23_1)
...
function ShipWordHelper:GetL2dCvCalibrate(arg_24_1, arg_24_2)
	if not var_0_1[self] then
		return 0
	end

	if type(var_0_1[self].l2d_voice_calibrate) == "table" and var_0_1[self].l2d_voice_calibrate.use_event then
		return -1
	end

	if arg_24_1 == ShipWordHelper.WORD_TYPE_MAIN then
		arg_24_1 = arg_24_1 .. "_" .. arg_24_2
	end

	return var_0_1[self].l2d_voice_calibrate[arg_24_1]
end

function ShipWordHelper:GetL2dSoundEffect(arg_25_1, arg_25_2)
	if not var_0_1[self] then
		return 0
	end

	if arg_25_1 == ShipWordHelper.WORD_TYPE_MAIN then
		arg_25_1 = arg_25_1 .. "_" .. arg_25_2
	end

	return var_0_1[self].l2d_se[arg_25_1]
end

function ShipWordHelper:ExistVoiceKey()
	return var_0_2[self] and var_0_2[self].voice_key ~= ShipWordHelper.CV_KEY_BAN
end

function ShipWordHelper:GetCVAuthor()
	local var_27_0

	if var_0_16(self) == 2 then
		var_27_0 = var_0_1[self].voice_actor_2 or var_0_1[self].voice_actor
	end

	return var_27_0 == ShipWordHelper.CV_KEY_BAN and "-" or var_0_5[var_27_0].actor_name
end

function ShipWordHelper.GetCVList()
	local var_28_0 = {}
...
function ShipWordHelper:ExistDifferentWord(arg_29_1, arg_29_2)
	if var_0_11(self) == self then
		return false
	end

	local var_29_0 = var_0_2[self]
	local var_29_1 = string.find(arg_29_1, "main") and string.split(var_29_0[ShipWordHelper.WORD_TYPE_MAIN], "|")[arg_29_2] or var_29_0[arg_29_1]

	return not not var_29_1 and var_29_1 ~= "" and var_29_1 ~= "nil"
end

function ShipWordHelper:ExistDifferentExWord(arg_30_1, arg_30_2, arg_30_3)
	local var_30_0 = var_0_11(self)

	if self == var_30_0 then
		return false
	end
	...
	if string.find(arg_30_1, "main") then
		var_30_1 = ShipWordHelper.WORD_TYPE_MAIN
	end

	local var_30_2 = var_0_15(self, var_30_1, {
		arg_30_2
	}, arg_30_3)

	return not var_0_8(var_30_2) and var_30_2 ~= var_0_15(var_30_0, var_30_1, {
		arg_30_2
	}, arg_30_3)
end

function ShipWordHelper:ExistDifferentMainExWord(arg_31_1, arg_31_2, arg_31_3)
	local var_31_0 = var_0_11(self)

	if self == var_31_0 then
		return false
	end

	local var_31_1, var_31_2, var_31_3 = ShipWordHelper.GetWordAndCV(self, arg_31_1, arg_31_2, nil, arg_31_3)
	local var_31_4, var_31_5, var_31_6 = ShipWordHelper.GetWordAndCV(var_31_0, arg_31_1, arg_31_2, nil, arg_31_3)

	return not var_0_8(var_31_3) and var_31_3 ~= var_31_6
end

function ShipWordHelper:ExistExCv(arg_32_1, arg_32_2, arg_32_3)
	local var_32_0, var_32_1 = var_0_15(self, arg_32_1, {
		arg_32_2
	}, arg_32_3)
...
function ShipWordHelper:GetCvDataForShip(arg_33_1)
	if arg_33_1 == "" then
		return nil
	end

	local var_33_0 = self:getSkinId()
	local var_33_1 = self:getCVIntimacy()
