local CutFruitGameMenuUI = class("CutFruitGameMenuUI")

function CutFruitGameMenuUI:Ctor(arg_1_1, arg_1_2, arg_1_3)
	self._tf = arg_1_1
	self._event = arg_1_2
...
function CutFruitGameMenuUI:initUI()
...
function CutFruitGameMenuUI:Show(arg_11_1)
	setActive(self.menuUI, arg_11_1)

	return
end

function CutFruitGameMenuUI:SetGameRoomUI(arg_12_1)
	if arg_12_1 then
...
function CutFruitGameMenuUI:Update()
	...
	setText(self.highScore, i18n("pac_game_high_score_tip", (var_13_5 and #var_13_5 > 0 or nil) and (var_13_5[1] or 0)))

	return
end

function CutFruitGameMenuUI:CheckGet()
