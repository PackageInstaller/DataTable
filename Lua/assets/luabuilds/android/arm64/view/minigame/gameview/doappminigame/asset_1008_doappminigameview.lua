local DOAPPMiniGameView = class("DOAPPMiniGameView", import("view.miniGame.MiniGameTemplateView"))

DOAPPMiniGameView.canSelectStage = false

function DOAPPMiniGameView:getUIName()
	return "DOAPPMiniGameUI"
end

function DOAPPMiniGameView:getGameController()
	return DOAPPMiniGameController
end

function DOAPPMiniGameView:initPageUI()
	DOAPPMiniGameView.super.initPageUI(self)
...
function DOAPPMiniGameView:initOpenUISwich()
	DOAPPMiniGameView.super.initOpenUISwich(self)
	...
	function self.openSwitchDic.result()
		...
		if self.stageIndex == var_17_0.usedtime + 1 and var_17_0.count > 0 then
			self:SendSuccess(0)
		end
...
function DOAPPMiniGameView:initBackPressSwitch()
	DOAPPMiniGameView.super.initBackPressSwitch(self)
...
function DOAPPMiniGameView:willExit()
	self.gameController:willExit()

	return
end

return DOAPPMiniGameView
