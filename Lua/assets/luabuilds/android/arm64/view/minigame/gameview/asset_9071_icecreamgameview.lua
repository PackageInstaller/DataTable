local IceCreamGameView = class("IceCreamGameView", import("..BaseMiniGameView"))
...
function IceCreamGameView:getUIName()
	return "IceCreamGameUI"
end

function IceCreamGameView:initTimer()
...
function IceCreamGameView:didEnter()
	self:initTimer()
	self:initUI()
	self:initGameUI()
	self:openMainUI()
...
function IceCreamGameView:initUI()
	...
	onButton(self, self.mainUI:Find("btn_back"), function()
		self:emit(IceCreamGameView.ON_BACK_PRESSED)
	...
	self.itemList:make(function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == UIItemList.EventUpdate then
			...
			onButton(self, var_13_0, function()
				self:emit(IceCreamGameView.ON_DROP, var_13_1)
...
function IceCreamGameView:Update()
	return
end

function IceCreamGameView:initGameUI()
...
function IceCreamGameView:updateMainUI()
...
function IceCreamGameView:checkGet()
...
function IceCreamGameView:openMainUI()
...
function IceCreamGameView:readyStart()
...
function IceCreamGameView:resetGame()
...
function IceCreamGameView:CreateTarget(arg_42_1)
...
function IceCreamGameView:RemoveTarget()
...
function IceCreamGameView:ResultTarget(arg_44_1, arg_44_2, ...)
	assert(#self.targetList > 0)
...
function IceCreamGameView:TriggerSpecialEffect(arg_46_1, arg_46_2)
	if arg_46_1 == 3 then
...
function IceCreamGameView:DoIceCream()
...
function IceCreamGameView:startGame()
...
function IceCreamGameView:RandomBG()
...
function IceCreamGameView:getIntervalTime()
	if self.effectTrigger.bullet_time.doingTime > 0 then
...
function IceCreamGameView:onTimer()
...
function IceCreamGameView:updateWalker()
...
function IceCreamGameView:setAnimatorSpeed(arg_74_1, arg_74_2)
...
function IceCreamGameView:timerStart()
...
function IceCreamGameView:timerStop()
...
function IceCreamGameView:addScore(arg_77_1, arg_77_2)
...
function IceCreamGameView:pauseGame()
	self.gamePause = true
...
function IceCreamGameView:resumeGame()
	self.gamePause = false
...
function IceCreamGameView:endGame()
...
function IceCreamGameView:showEndUI()
	...
	setActive(self.endUI:Find("panel/now/Text/new"), var_82_2 < var_82_1)
	...
	setText(self.endUI:Find("panel/max/Text"), var_82_2)
	setText(self.endUI:Find("panel/now/Text"), var_82_1)
...
function IceCreamGameView:getGameTimes()
	return self:GetMGHubData().count
end

function IceCreamGameView:getGameUsedTimes()
	return self:GetMGHubData().usedtime
end

function IceCreamGameView:getUltimate()
	return self:GetMGHubData().ultimate
end

function IceCreamGameView:getGameTotalTime()
	return (self:GetMGHubData():getConfig("reward_need"))
end

function IceCreamGameView:OnApplicationPaused(arg_87_1)
...
function IceCreamGameView:onBackPressed()
	if self.gameEndFlag then
		return
	end
...
function IceCreamGameView:willExit()
	if self.handle then
