local GameRoomRollingView = class("GameRoomRollingView", import("..BaseMiniGameView"))
...
function GameRoomRollingView:getUIName()
	return "GameRoomRollingUI"
end

function GameRoomRollingView:init()
...
function GameRoomRollingView:getGameTimes()
	return self:GetMGHubData().count
end

function GameRoomRollingView:showScoreUI(arg_11_1)
	...
	setText(self.labelHigh, var_11_0)
	self:StoreDataToServer({
		var_11_0
	})
	self:SendSuccess(arg_11_1)

	return
end

function GameRoomRollingView:showCountStart(arg_12_1)
...
function GameRoomRollingView:gameStart()
	self.startFlag = true
...
function GameRoomRollingView:gameStop()
	self:timerStop()
...
function GameRoomRollingView:timerStart()
...
function GameRoomRollingView:timerStop()
...
function GameRoomRollingView:fallingGridDic()
...
function GameRoomRollingView:firstInitGrid()
...
function GameRoomRollingView:fillEmptyGrid()
...
function GameRoomRollingView:setFillGridPosition(arg_32_1, arg_32_2, arg_32_3)
...
function GameRoomRollingView:onTimer()
...
function GameRoomRollingView:moveGridsByChangeDic()
	self.moveDatas = {}
...
function GameRoomRollingView:moveGridsBySelfPos(arg_37_1, arg_37_2)
	self.moveDatas = {}
...
function GameRoomRollingView:moveGridToPos(arg_38_1, arg_38_2, arg_38_3)
...
function GameRoomRollingView:updateMoveGridDic()
...
function GameRoomRollingView:sortGridDic()
	local var_40_0 = {}
...
function GameRoomRollingView:checkSuccessGrid()
	local var_42_0
	...
	seriesAsync({
		...
		function(arg_44_0)
			if var_42_0 then
				LeanTween.delayedCall(go(self.rollingUI), 0.2, System.Action(function()
					arg_44_0()
...
function GameRoomRollingView:updateCombo()
...
function GameRoomRollingView:updateScore(arg_50_1)
	...
	LeanTween.delayedCall(go(self.labelGameScore), 0.2, System.Action(function()
...
function GameRoomRollingView:updateRemoveFlag()
...
function GameRoomRollingView:checkGridRemove(arg_55_1, arg_55_2, arg_55_3)
...
function GameRoomRollingView:onGridDown(arg_56_1)
...
function GameRoomRollingView:onGridUp(arg_57_1)
	self.selectGrid = nil
...
function GameRoomRollingView:checkChangePos(arg_58_1)
...
function GameRoomRollingView:onGridBeginDrag(arg_59_1, arg_59_2, arg_59_3)
...
function GameRoomRollingView:onGridDrag(arg_60_1, arg_60_2, arg_60_3)
...
function GameRoomRollingView:updateMove(arg_61_1, arg_61_2)
...
function GameRoomRollingView:getGridByPosition(arg_62_1)
...
function GameRoomRollingView:updateEnterGrid(arg_63_1, arg_63_2)
...
function GameRoomRollingView:changeDragGrid(arg_64_1, arg_64_2)
...
function GameRoomRollingView:createGrid(arg_65_1, arg_65_2, arg_65_3)
	local var_65_0
...
function GameRoomRollingView:setDragAlpha(arg_70_1, arg_70_2, arg_70_3)
...
function GameRoomRollingView:clearDragAlpha()
	setActive(self.dragAlphaGrid:getTf(), false)

	return
end

function GameRoomRollingView:returnGrid(arg_72_1)
...
function GameRoomRollingView:removeGrid(arg_73_1)
...
function GameRoomRollingView:getRandomType(arg_74_1)
	if arg_74_1 then
		local var_74_0 = {}
...
function GameRoomRollingView:addGridScoreTip(arg_75_1, arg_75_2)
...
function GameRoomRollingView:addRemoveEffect(arg_77_1)
...
function GameRoomRollingView:getRemoveEffect()
...
function GameRoomRollingView:returnRemoveEffect(arg_80_1)
...
function GameRoomRollingView:getScoreTip()
...
function GameRoomRollingView:returnScoreTip(arg_82_1)
...
function GameRoomRollingView:addEffect(arg_83_1)
...
function GameRoomRollingView:clearUI()
	self.moveDatas = {}
	self.startFlag = false
	self.stopFlag = false
...
function GameRoomRollingView:getEffect()
...
function GameRoomRollingView:returnEffect(arg_86_1)
...
function GameRoomRollingView:getGridRemoveId()
...
function GameRoomRollingView:onBackPressed()
	if not self.startFlag then
		self:emit(GameRoomRollingView.ON_BACK_PRESSED)
	end

	return
end

function GameRoomRollingView:willExit()
