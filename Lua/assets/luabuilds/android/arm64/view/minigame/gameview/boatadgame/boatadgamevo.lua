...
function var_0_0.PointInRect1(arg_20_0, arg_20_1, arg_20_2, arg_20_3, arg_20_4)
	local var_20_2 = var_0_0.Sign(arg_20_0, arg_20_2, arg_20_3)
	local var_20_3 = var_0_0.Sign(arg_20_0, arg_20_3, arg_20_4)
	local var_20_4 = var_0_0.Sign(arg_20_0, arg_20_4, arg_20_1)
	local var_20_5 = var_0_0.Sign(arg_20_0, arg_20_1, arg_20_2) > 0 or nil > 0 or nil > 0 or nil > 0
...
function var_0_0.CheckRectCollider(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	if arg_27_1.x <= arg_27_0.x and arg_27_0.x >= arg_27_1.x + arg_27_3.width then
		return false
	elseif arg_27_0.x <= arg_27_1.x and arg_27_1.x >= arg_27_0.x + arg_27_2.width then
		return false
	elseif arg_27_1.y <= arg_27_0.y and arg_27_0.y >= arg_27_1.y + arg_27_3.height then
		return false
	elseif arg_27_0.y <= arg_27_1.y and arg_27_1.y >= arg_27_0.y + arg_27_2.height then
		return false
	else
		return true
	end
