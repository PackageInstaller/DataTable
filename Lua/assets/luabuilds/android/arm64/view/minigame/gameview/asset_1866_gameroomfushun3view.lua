local GameRoomFushun3View = class("GameRoomFushun3View", import("..BaseMiniGameView"))
local var_0_1 = "event:/ui/ddldaoshu2"
local var_0_6 = "event:/ui/break_out_full"

function GameRoomFushun3View:getUIName()
	return "GameRoomFuShun3UI"
end

function GameRoomFushun3View:didEnter()
	self:initEvent()
	self:initData()
	self:initUI()
	self:initGameUI()
...
function GameRoomFushun3View:initEvent()
...
function GameRoomFushun3View:onEventHandle(arg_22_1)
	return
end

function GameRoomFushun3View:initData()
...
function GameRoomFushun3View:initController()
...
function GameRoomFushun3View:initUI()
...
function GameRoomFushun3View:initGameUI()
...
function GameRoomFushun3View:Update()
	self:AddDebugInput()

	return
end

function GameRoomFushun3View:AddDebugInput()
...
function GameRoomFushun3View:updateMenuUI()
...
function GameRoomFushun3View:CheckGet()
...
function GameRoomFushun3View:openMenuUI()
...
function GameRoomFushun3View:clearUI()
...
function GameRoomFushun3View:readyStart()
...
function GameRoomFushun3View:gameStart()
...
function GameRoomFushun3View:getGameTimes()
	return self:GetMGHubData().count
end

function GameRoomFushun3View:getGameUsedTimes()
	return self:GetMGHubData().usedtime
end

function GameRoomFushun3View:getUltimate()
	return self:GetMGHubData().ultimate
end

function GameRoomFushun3View:getGameTotalTime()
	return (self:GetMGHubData():getConfig("reward_need"))
end

function GameRoomFushun3View:updateDayNightUI()
	self.dayTimeFlag = Fushun3GameVo.GetTimeFlag()
...
function GameRoomFushun3View:onTimer()
	self:gameStep()

	return
end

function GameRoomFushun3View:gameStep()
...
function GameRoomFushun3View:timerStart()
...
function GameRoomFushun3View:timerStop()
...
function GameRoomFushun3View:updateGameUI()
...
function GameRoomFushun3View:addScore(arg_63_1)
...
function GameRoomFushun3View:onControllerCallback(arg_64_1, arg_64_2)
...
function GameRoomFushun3View:onGameOver()
...
function GameRoomFushun3View:showSettlement()
	setActive(self.settlementUI, true)
	GetComponent(findTF(self.settlementUI, "ad"), typeof(Animator)):Play("settlement", -1, 0)

	local var_67_0 = self.scoreNum
	local var_67_1 = getProxy(GameRoomProxy):getRoomScore(self:getGameRoomData().id)

	setActive(findTF(self.settlementUI, "ad/new"), var_67_1 < self.scoreNum)
	...
	setText(findTF(self.settlementUI, "ad/highText"), var_67_1)
	setText(findTF(self.settlementUI, "ad/currentText"), var_67_0)
	self:SendSuccess(var_67_0 or 0)

	return
end

function GameRoomFushun3View:resumeGame()
	self.gameStop = false
...
function GameRoomFushun3View:stopGame()
	self.gameStop = true
...
function GameRoomFushun3View:onBackPressed()
	if not self.gameStartFlag then
		self:emit(GameRoomFushun3View.ON_BACK_PRESSED)
	else
		if self.settlementFlag then
			return
		end
...
function GameRoomFushun3View:willExit()
	if self.charController then
