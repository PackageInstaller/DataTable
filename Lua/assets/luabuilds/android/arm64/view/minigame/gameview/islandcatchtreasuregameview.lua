...
function var_0_0.initUI(arg_70_0)
	...
	arg_70_0.itemConfig = Item.getConfigData(pg.activity_template[ActivityConst.ISLAND_GAME_ID].config_client.item_id)

	LoadImageSpriteAsync(arg_70_0.itemConfig.icon, findTF(arg_70_0.menuUI, "item/img"), true)

	arg_70_0.hub_id = pg.activity_template[ActivityConst.ISLAND_GAME_ID].config_id

	onButton(arg_70_0, findTF(arg_70_0.menuUI, "item"), function()
		arg_70_0:emit(BaseMiniGameMediator.OPEN_SUB_LAYER, {
...
function var_0_0.initGameUI(arg_81_0)
	...
	arg_81_0.boatController = var_0_47(arg_81_0.sceneTf, arg_81_0)
	arg_81_0.itemController = var_0_48(arg_81_0.sceneTf, arg_81_0.backSceneTf, arg_81_0:getGameUsedTimes(), arg_81_0)
	arg_81_0.catchController = var_0_49(arg_81_0.boatController, arg_81_0.itemController)
	arg_81_0.charController = var_0_50(arg_81_0.backSceneTf, arg_81_0)
...
function var_0_0.updateMenuUI(arg_87_0)
	local var_87_0 = getProxy(MiniGameProxy):GetHubByHubId(arg_87_0.hub_id).count

	var_87_0 = var_87_0 or 0
	arg_87_0.itemNums = var_87_0
...
function var_0_0.addScore(arg_96_0, arg_96_1, arg_96_2)
	...
	if arg_96_1 then
		...
		for iter_96_0 = 1, #var_0_38 do
			if arg_96_1 and arg_96_1 >= var_0_38[iter_96_0].score then
				var_96_2 = var_0_38[iter_96_0].color
				var_96_3 = var_0_38[iter_96_0].font
	...
	elseif arg_96_2 then
		...
		setTextColor(var_96_0, (arg_96_0:transformColor("66f2fb")))
...
function var_0_0.showSettlement(arg_104_0)
	...
	if var_104_0 and #var_104_0 > 0 then
		local var_104_2 = var_104_0[1] or 0
		...
		setText(findTF(arg_104_0.settlementUI, "ad/highText"), var_104_2)
		setText(findTF(arg_104_0.settlementUI, "ad/currentText"), var_104_1)
