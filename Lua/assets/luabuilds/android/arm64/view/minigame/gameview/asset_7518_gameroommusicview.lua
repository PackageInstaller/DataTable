local GameRoomMusicView = class("GameRoomMusicView", import("..BaseMiniGameView"))
local var_0_1 = true
local var_0_2 = 0.95
local var_0_3 = 0
local var_0_4 = 1
...
function GameRoomMusicView:getUIName()
	return "GameRoomMusicUI"
end

function GameRoomMusicView:MyGetRuntimeData()
...
function GameRoomMusicView:MyStoreDataToServer()
	local var_3_0 = {
		self.achieve_times,
		1
	}
...
function GameRoomMusicView:init()
...
function GameRoomMusicView:didEnter()
	local var_7_0 = 0
...
function GameRoomMusicView:updateBg()
...
function GameRoomMusicView:dynamicBgHandler(arg_27_1, arg_27_2)
...
function GameRoomMusicView:onBackPressed()
	if not self.countingfive_flag and not self.firstview_timerRunflag then
		...
		elseif isActive(self.selectview) and var_0_3 == 0 then
			self:emit(GameRoomMusicView.ON_BACK)
		end
	end
...
function GameRoomMusicView:OnApplicationPaused(arg_29_1)
...
function GameRoomMusicView:willExit()
	self.isLoading = false
...
function GameRoomMusicView:clearSDModel()
...
function GameRoomMusicView:list_push(arg_32_1, arg_32_2)
...
function GameRoomMusicView:list_pop(arg_33_1)
...
function GameRoomMusicView:game_start()
	self:game_before()
	self:effect_play("prepare")
...
function GameRoomMusicView:game_before()
	self:effect_play("nothing")
...
function GameRoomMusicView:stopTimer()
	if self.timer.running then
		self.timer:Stop()
	end
...
function GameRoomMusicView:startTimer()
...
function GameRoomMusicView:loadSDModel(arg_43_1)
...
function GameRoomMusicView:SDmodeljump_btnup()
...
function GameRoomMusicView:setActionSDmodel(arg_47_1, arg_47_2)
...
function GameRoomMusicView:loadAndPlayMusic(arg_48_1, arg_48_2)
...
function GameRoomMusicView:getStampTime()
...
function GameRoomMusicView:pauseBgm()
	if self.criInfo then
...
function GameRoomMusicView:resumeBgm()
	if not self.timer.running then
		self.timer:Start()
	end
...
function GameRoomMusicView:rec_scorce()
	self.score_number = 0
	self.combo_link = 0
	self.combo_number = 0
	self.perfect_number = 0
...
function GameRoomMusicView:effect_play(arg_55_1, arg_55_2)
...
function GameRoomMusicView:scoresliderAcombo_update()
	local var_56_0 = 0
...
function GameRoomMusicView:score_update(arg_57_1)
...
function GameRoomMusicView:count_five(arg_58_1)
	if self.countingfive_flag then
		return
	end
...
function GameRoomMusicView:showSelevtView()
	if self.isFirstgame == 0 then
		self:Firstshow(self.firstview, function()
			return
		end, 1)
...
function GameRoomMusicView:updateMusic(arg_73_1)
...
function GameRoomMusicView:setTfChildVisible(arg_74_1, arg_74_2)
...
function GameRoomMusicView:updateEffectTf()
...
function GameRoomMusicView:getBeatGameMusicData(arg_76_1)
...
function GameRoomMusicView:clickSongBtns(arg_77_1, arg_77_2)
	if var_0_3 > 0 then
		return
	end
...
function GameRoomMusicView:changeLocalpos(arg_78_1)
...
function GameRoomMusicView:addRingDragListenter()
...
function GameRoomMusicView:getNextPreSelectId()
	local var_84_0
	local var_84_1
...
function GameRoomMusicView:Firstshow(arg_85_1, arg_85_2, arg_85_3)
	self.count = 0
...
function GameRoomMusicView:updatSelectview()
...
function GameRoomMusicView:setSelectview_pj(arg_91_1, arg_91_2)
	if arg_91_1 == "e" then
...
function GameRoomMusicView:updateScoreUIContent()
...
function GameRoomMusicView:locadScoreView()
	...
	seriesAsync({
		...
		function(arg_105_0)
			local var_105_0 = self.score_number < self.score_blist[var_93_1] and function()
				...
				self:emit(BaseMiniGameMediator.MINI_GAME_SUCCESS, self.score_number)
...
function GameRoomMusicView:setScoceview_pj(arg_114_1)
...
function GameRoomMusicView:Scoceview_ani()
	local var_115_0 = 0
...
function GameRoomMusicView:gameStart()
...
function GameRoomMusicView:getMusicBgm(arg_122_1)
...
function GameRoomMusicView:getMusicNote(arg_123_1, arg_123_2)
	return "view/miniGame/gameView/musicGame/bgm_song" .. "0" .. arg_123_1.note .. "_" .. arg_123_2
end

function GameRoomMusicView:gameStepNew()
...
function GameRoomMusicView:onStateCallback(arg_130_1)
	self:score_update(arg_130_1)

	return
end

function GameRoomMusicView:onLongTimeCallback(arg_131_1)
