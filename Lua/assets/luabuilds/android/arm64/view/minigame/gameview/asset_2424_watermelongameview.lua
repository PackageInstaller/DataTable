local WatermelonGameView = class("WatermelonGameView", import("..BaseMiniGameView"))
local var_0_1
local var_0_2 = 76

function WatermelonGameView:Ctor()
	WatermelonGameView.super.Ctor(self)

	self._gameVo = WatermelonGameVo.New(var_0_2)
	var_0_1 = self._gameVo

	return
end

function WatermelonGameView:getUIName()
	return WatermelonGameConst.game_ui
end

function WatermelonGameView:getBGM()
	return WatermelonGameConst.menu_bgm
end

function WatermelonGameView:didEnter()
	self:initEvent()
	self:initUI()
...
function WatermelonGameView:initEvent()
...
function WatermelonGameView:initUI()
...
function WatermelonGameView:changeBgm(arg_23_1)
	local var_23_0
...
function WatermelonGameView:OnUpdate()
	self:gameStep()

	return
end

function WatermelonGameView:readyStart()
...
function WatermelonGameView:gameStart()
...
function WatermelonGameView:changeSpeed(arg_27_1)
	return
end

function WatermelonGameView:gameStep()
...
function WatermelonGameView:timerStart()
	self.gamestop = false

	return
end

function WatermelonGameView:timerResume()
	self.gamestop = false
...
function WatermelonGameView:timerStop()
	self.gamestop = true
...
function WatermelonGameView:getRankData()
...
function WatermelonGameView:stepRunTimeData()
...
function WatermelonGameView:addScore(arg_36_1)
	var_0_1.scoreNum = var_0_1.scoreNum + arg_36_1

	return
end

function WatermelonGameView:onGameOver(arg_37_1)
...
function WatermelonGameView:OnApplicationPaused()
...
function WatermelonGameView:clearController()
	self.gameScene:clear()

	return
end

function WatermelonGameView:pauseGame()
	self.gameStop = true
...
function WatermelonGameView:resumeGame()
	self.gameStop = false
...
function WatermelonGameView:onBackPressed()
	if self.readyStartFlag then
		return
	end
...
function WatermelonGameView:OnSendMiniGameOPDone(arg_44_1)
	return
end

function WatermelonGameView:willExit()
	if self.handle then
