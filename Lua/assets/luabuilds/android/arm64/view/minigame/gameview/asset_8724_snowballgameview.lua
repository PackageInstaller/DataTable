local SnowballGameView = class("SnowballGameView", import("..BaseMiniGameView"))
local var_0_1 = {
	-1920,
	-1080,
	1920,
...
function SnowballGameView:getUIName()
	return "SnowballGameUI"
end

function SnowballGameView:getBGM()
	return "backyard"
end

function SnowballGameView:didEnter()
	self:initData()
	self:initUI()
...
function SnowballGameView:initData()
...
function SnowballGameView:initUI()
...
function SnowballGameView:Update()
	self:AddDebugInput()

	return
end

function SnowballGameView:AddDebugInput()
...
function SnowballGameView:getCurrentDiff()
...
function SnowballGameView:updateMenuUI()
...
function SnowballGameView:CheckGet()
...
function SnowballGameView:openMenuUI()
...
function SnowballGameView:clearUI()
...
function SnowballGameView:OnSendMiniGameOPDone(arg_150_1)
...
function SnowballGameView:readyStart()
...
function SnowballGameView:gameStart()
...
function SnowballGameView:onPlayerDamage()
	self:updateGameUI()

	return
end

function SnowballGameView:getGameTimes()
	return self:GetMGHubData().count
end

function SnowballGameView:getGameUsedTimes()
	return self:GetMGHubData().usedtime
end

function SnowballGameView:getUltimate()
	return self:GetMGHubData().ultimate
end

function SnowballGameView:getGameTotalTime()
	return (self:GetMGHubData():getConfig("reward_need"))
end

function SnowballGameView:changeSpeed(arg_158_1)
...
function SnowballGameView:onTimer()
	self.player:step()
...
function SnowballGameView:gameStep()
	self.gameStepTime = self.gameStepTime + Time.deltaTime
...
function SnowballGameView:timerStart()
...
function SnowballGameView:timerStop()
...
function SnowballGameView:movePlayerTo(arg_163_1)
	self.player:move(self.playerMoveVecs[arg_163_1])

	return
end

function SnowballGameView:updateGameUI()
...
function SnowballGameView:throwSnowballTo(arg_165_1, arg_165_2, arg_165_3)
...
function SnowballGameView:onPlayerThrowSnowball(arg_166_1)
...
function SnowballGameView:onEnemyThrowSnowball(arg_167_1, arg_167_2, arg_167_3)
...
function SnowballGameView:usePlayerSkill()
	Time.timeScale = 0.05
...
function SnowballGameView:specialComplete()
	Time.timeScale = 1
...
function SnowballGameView:dropSpeedUp()
	return
end

function SnowballGameView:onHitEnemy(arg_172_1, arg_172_2)
...
function SnowballGameView:addScore(arg_173_1, arg_173_2)
...
function SnowballGameView:onGameOver()
	self:timerStop()
...
function SnowballGameView:showSettlement()
	setActive(self.settlementUI, true)
	GetComponent(findTF(self.settlementUI, "ad"), typeof(Animator)):Play("settlement", -1, 0)

	local var_177_0 = self:GetMGData():GetRuntimeData("elements")
	local var_177_1 = self.scoreNum
	local var_177_2

	if var_177_0 and #var_177_0 > 0 then
		var_177_2 = var_177_0[1] or 0
	...
	setText(findTF(self.settlementUI, "ad/highText"), var_177_2)
	setText(findTF(self.settlementUI, "ad/currentText"), var_177_1)
...
function SnowballGameView:resumeGame()
	self.gameStop = false
...
function SnowballGameView:stopGame()
	self.gameStop = true
...
function SnowballGameView:onBackPressed()
	if not self.gameStartFlag then
		self:emit(SnowballGameView.ON_BACK_PRESSED)
	else
...
function SnowballGameView:willExit()
	if self.handle then
