local MusicGameConst = class("MusicGameConst")

MusicGameConst.music_game_data = {
	{
		light = 2,
		music_id = 1,
		comboEffect = 1,
...
MusicGameConst.music_all_painting = {
	"chicheng_idolns",
	"xiefeierde_idolns",
	"jiasikenie_idolns",
	"kelifulan_idolns",
