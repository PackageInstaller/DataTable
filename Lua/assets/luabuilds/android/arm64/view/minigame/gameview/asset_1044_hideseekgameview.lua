local HideSeekGameView = class("HideSeekGameView", import("..BaseMiniGameView"))
...
local var_0_14 = 2
local var_0_15 = 3
local var_0_17 = "ui/minigameui/hideseek"
local var_0_18 = 3
local var_0_19 = {
	0,
	1,
...
local var_0_29 = "hideseektv.prefab"
local var_0_30 = {}
...
function HideSeekGameView:getUIName()
	return "HideSeekGameUI"
end

function HideSeekGameView:getBGM()
	return var_0_1
end

function HideSeekGameView:didEnter()
	self:initEvent()
	self:initData()
	self:initUI()
	self:initGameUI()
...
function HideSeekGameView:initEvent()
...
function HideSeekGameView:showScore(arg_52_1)
	local var_52_0
...
function HideSeekGameView:onEventHandle(arg_54_1)
	return
end

function HideSeekGameView:initData()
...
function HideSeekGameView:initUI()
...
function HideSeekGameView:initGameUI()
...
function HideSeekGameView:initController()
...
function HideSeekGameView:Update()
	self:AddDebugInput()

	return
end

function HideSeekGameView:AddDebugInput()
...
function HideSeekGameView:updateMenuUI()
...
function HideSeekGameView:CheckGet()
...
function HideSeekGameView:openMenuUI()
...
function HideSeekGameView:clearUI()
...
function HideSeekGameView:readyStart()
...
function HideSeekGameView:gameStart()
...
function HideSeekGameView:controllerStart()
...
function HideSeekGameView:getGameTimes()
	return self:GetMGHubData().count
end

function HideSeekGameView:getGameUsedTimes()
	return self:GetMGHubData().usedtime
end

function HideSeekGameView:getUltimate()
	return self:GetMGHubData().ultimate
end

function HideSeekGameView:getGameTotalTime()
	return (self:GetMGHubData():getConfig("reward_need"))
end

function HideSeekGameView:changeSpeed(arg_90_1)
	return
end

function HideSeekGameView:onTimer()
	self:gameStep()

	return
end

function HideSeekGameView:gameStep()
...
function HideSeekGameView:controllerStep()
	if self.furnitureCtrl then
...
function HideSeekGameView:timerStart()
...
function HideSeekGameView:timerStop()
...
function HideSeekGameView:updateGameUI()
...
function HideSeekGameView:addScore(arg_97_1)
...
function HideSeekGameView:onGameOver()
...
function HideSeekGameView:showSettlement()
	setActive(self.settlementUI, true)
	GetComponent(findTF(self.settlementUI, "ad"), typeof(Animator)):Play("settlement", -1, 0)

	local var_100_0 = self:GetMGData():GetRuntimeData("elements")
	local var_100_1 = self.scoreNum
	local var_100_2

	if var_100_0 and #var_100_0 > 0 then
		var_100_2 = var_100_0[1] or 0
	end

	setActive(findTF(self.settlementUI, "ad/new"), var_100_2 < var_100_1)
	...
	setText(findTF(self.settlementUI, "ad/highText"), var_100_2)
	setText(findTF(self.settlementUI, "ad/currentText"), var_100_1)
...
function HideSeekGameView:resumeGame()
	self.gameStop = false
...
function HideSeekGameView:stopGame()
	self.gameStop = true
...
function HideSeekGameView:onBackPressed()
	if not self.gameStartFlag then
		self:emit(HideSeekGameView.ON_BACK_PRESSED)
	else
		if self.settlementFlag then
			return
		end
...
function HideSeekGameView:willExit()
	if self.handle then
...
function HideSeekGameView:destroyController()
	if self.furnitureCtrl then
