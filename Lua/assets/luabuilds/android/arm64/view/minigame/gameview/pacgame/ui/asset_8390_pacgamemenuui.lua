local PacGameMenuUI = class("PacGameMenuUI")

function PacGameMenuUI:Ctor(arg_1_1, arg_1_2, arg_1_3)
	self._tf = arg_1_1
	self._event = arg_1_2
...
function PacGameMenuUI:initUI()
	...
	setActive(findTF(self.menuUI, "editor"), PacGameConst.editor_mode and true or false)

	if PacGameConst.editor_mode then
		onButton(self._event, findTF(self.menuUI, "editor"), function()
			self._event:emit(SimpleMGEvent.READY_START, {
				editor = true
			})
...
function PacGameMenuUI:Show(arg_12_1)
	setActive(self.menuUI, arg_12_1)

	return
end

function PacGameMenuUI:SetGameRoomUI(arg_13_1)
	if arg_13_1 then
...
function PacGameMenuUI:Update()
	local var_14_0 = self._gameVo:GetGameUseTimes()
	local var_14_1 = self._gameVo:GetGameTimes()

	for iter_14_0 = 1, 7 do
		local var_14_2 = findTF(self.battleItems[iter_14_0], "ad/lock")
		local var_14_3 = findTF(self.battleItems[iter_14_0], "ad/got")
	...
	local var_14_5 = getProxy(MiniGameProxy):GetHighScore(self._gameVo:GetGameId())

	setText(self.highScore, i18n("pac_game_high_score_tip", (var_14_5 and #var_14_5 > 0 or nil) and (var_14_5[1] or 0)))

	return
end

function PacGameMenuUI:CheckGet()
	setActive(findTF(self.menuUI, "got"), false)

	local var_15_0 = self._gameVo:GetUltimate()
