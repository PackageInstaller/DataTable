local GameRoomQTEView = class("GameRoomQTEView", import("..BaseMiniGameView"))

function GameRoomQTEView:getUIName()
	return "GameRoomQTEUI"
end

function GameRoomQTEView:init()
	self.STATE_BEGIN = 1
	self.STATE_COUNT = 2
	self.STATE_CLICK = 3
	self.STATE_SHOW = 4
...
function GameRoomQTEView:didEnter()
	self:initGame()
	...
	onButton(self, self.qBtn, function()
		self:emit(GameRoomQTEView.ON_BACK)
...
function GameRoomQTEView:initGame()
...
function GameRoomQTEView:resetGame()
...
function GameRoomQTEView:setGameState(arg_27_1)
...
function GameRoomQTEView:fireBlocks()
...
function GameRoomQTEView:getRandomList()
...
function GameRoomQTEView:hideRandomList()
...
function GameRoomQTEView:countScore(arg_39_1)
	if arg_39_1 then
		local var_39_0
...
function GameRoomQTEView:getUserResult()
	local var_40_0 = {}
...
function GameRoomQTEView:playArchiveAnim(arg_41_1, arg_41_2)
...
function GameRoomQTEView:checkPlayFinished()
...
function GameRoomQTEView:checkEnd(arg_43_1)
...
function GameRoomQTEView:parabolaMove(arg_44_1, arg_44_2, arg_44_3, arg_44_4)
...
function GameRoomQTEView:parabolaMove_center(arg_46_1, arg_46_2, arg_46_3, arg_46_4)
...
function GameRoomQTEView:hitFly(arg_48_1, arg_48_2, arg_48_3, arg_48_4)
...
function GameRoomQTEView:loadXGM(arg_50_1)
	if self.xgm then
		arg_50_1()
	else
		self.autoLoader:LoadPrefab("ui/minigameui/qtegameuiasync_atlas", "xiongguimaoTpl", function(arg_51_0)
...
function GameRoomQTEView:initXGM()
...
function GameRoomQTEView:loadGuinu(arg_54_1)
...
function GameRoomQTEView:initGuinu()
...
function GameRoomQTEView:setXgmAction(arg_58_1)
...
function GameRoomQTEView:setGuinuAction(arg_59_1)
...
function GameRoomQTEView:setBucketAAction(arg_60_1)
...
function GameRoomQTEView:setBucketBAction(arg_61_1)
...
function GameRoomQTEView:showBucketAEffect()
...
function GameRoomQTEView:recycleBucketAEffect(arg_66_1)
...
function GameRoomQTEView:getBlock(arg_67_1, arg_67_2)
...
function GameRoomQTEView:recycleBlock(arg_68_1)
...
function GameRoomQTEView:msHoldBlock(arg_69_1)
...
function GameRoomQTEView:msClearHold()
...
function GameRoomQTEView:addUsingBlock(arg_71_1)
	self.usingBlockList[#self.usingBlockList + 1] = arg_71_1

	return
end

function GameRoomQTEView:removeUsingBlock(arg_72_1)
...
function GameRoomQTEView:clearUsingBlock()
...
function GameRoomQTEView:getShowBlock(arg_74_1, arg_74_2)
...
function GameRoomQTEView:startGameTimer()
	self.remainTime = self:GetMGData():GetSimpleValue("gameTime")
...
function GameRoomQTEView:startRoundTimer()
	self.roundTime = self:GetMGData():GetSimpleValue("roundTime")
...
function GameRoomQTEView:clearTimer()
	if self.remainTimer then
		self.remainTimer:Stop()
...
function GameRoomQTEView:OnSendMiniGameOPDone(arg_84_1)
...
function GameRoomQTEView:checkHelp()
...
function GameRoomQTEView:willExit()
	self:clearTimer()
	pg.UIMgr.GetInstance():UnOverlayPanel(self.endUI, self._tf)
