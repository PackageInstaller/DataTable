local GameRoomPokeView = class("GameRoomPokeView", import("..BaseMiniGameView"))
local var_0_1 = 1
local var_0_2 = 2
local var_0_3 = 3
...
function GameRoomPokeView:getUIName()
	return "GameRoomPokeUI"
end

function GameRoomPokeView:getBGM()
	return var_0_6
end

function GameRoomPokeView:didEnter()
	self:initData()
	self:initUI()
...
function GameRoomPokeView:initData()
...
function GameRoomPokeView:initUI()
...
function GameRoomPokeView:updateMenuUI()
...
function GameRoomPokeView:openMenuUI()
...
function GameRoomPokeView:showSettlement()
	...
	self:SendSuccess(var_114_1)

	return
end

function GameRoomPokeView:Update()
	self:AddDebugInput()

	return
end

function GameRoomPokeView:AddDebugInput()
...
function GameRoomPokeView:CheckGet()
...
function GameRoomPokeView:clearUI()
	return
end

function GameRoomPokeView:readyStart()
...
function GameRoomPokeView:gameStart()
...
function GameRoomPokeView:onTimer()
	self:gameStep()

	return
end

function GameRoomPokeView:gameStep()
...
function GameRoomPokeView:gameUIUpdate()
...
function GameRoomPokeView:resumeGame()
	self.gameStop = false
...
function GameRoomPokeView:stopGame()
	self.gameStop = true
...
function GameRoomPokeView:onGameOver()
	if self.settlementFlag then
		return
	end
...
function GameRoomPokeView:timerStop()
...
function GameRoomPokeView:timerStart()
...
function GameRoomPokeView:getGameTimes()
	return self:GetMGHubData().count
end

function GameRoomPokeView:getGameUsedTimes()
	return self:GetMGHubData().usedtime
end

function GameRoomPokeView:getUltimate()
	return self:GetMGHubData().ultimate
end

function GameRoomPokeView:getGameTotalTime()
	return (self:GetMGHubData():getConfig("reward_need"))
end

function GameRoomPokeView:onBackPressed()
	return
end

function GameRoomPokeView:willExit()
	if self.handle then
