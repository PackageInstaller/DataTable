local GameRoomMatch3View = class("GameRoomMatch3View", import("..BaseMiniGameView"))
local var_0_1 = 6
local var_0_2 = 7
local var_0_3 = -405
local var_0_4 = -275
...
function GameRoomMatch3View:getUIName()
	return "GameRoomMatch3UI"
end

function GameRoomMatch3View:getBGM()
	return "backyard"
end

function GameRoomMatch3View:init()
...
function GameRoomMatch3View:onBackPressed()
	if isActive(self.mainPage) then
		self:emit(GameRoomMatch3View.ON_BACK)
...
function GameRoomMatch3View:didEnter()
...
function GameRoomMatch3View:updateData()
	self.infinite = self:GetMGHubData().count == 0

	local var_20_0 = self:GetMGData():GetRuntimeData("elements")

	self.best = getProxy(GameRoomProxy):getRoomScore(self:getGameRoomData().id)

	return
end

function GameRoomMatch3View:index2pos(arg_21_1, arg_21_2)
	return Vector3.New(var_0_3 + (arg_21_2 - 1) * var_0_5, var_0_4 + (arg_21_1 - 1) * var_0_6)
end

function GameRoomMatch3View:pos2index(arg_22_1)
...
function GameRoomMatch3View:dropTime()
	return math.max(self * var_0_8, var_0_9)
end

function GameRoomMatch3View:cancelHint()
	if self.hint then
		Destroy(self.hint)
...
function GameRoomMatch3View:unselect()
...
function GameRoomMatch3View:select(arg_26_1, arg_26_2)
	self:unselect()
...
function GameRoomMatch3View:animate(arg_27_1, arg_27_2, arg_27_3)
...
function GameRoomMatch3View:tryMoveTo(arg_28_1)
...
function GameRoomMatch3View:isConnected(arg_31_1)
...
function GameRoomMatch3View:moveValid(arg_32_1, arg_32_2)
...
function GameRoomMatch3View:moveTile(arg_33_1, arg_33_2, arg_33_3)
...
function GameRoomMatch3View:swap(arg_34_1, arg_34_2)
...
function GameRoomMatch3View:formatTime(arg_35_1)
...
function GameRoomMatch3View:startGame()
	self:updateData()
...
function GameRoomMatch3View:pauseGame()
	if self.timer then
		self.timer:Pause()
	end
...
function GameRoomMatch3View:pause()
...
function GameRoomMatch3View:resumeGame()
	if self.timer then
		self.timer:Resume()
	end
...
function GameRoomMatch3View:fillTileIndicies()
	local var_46_0 = {}
...
function GameRoomMatch3View:reorderTiles()
...
function GameRoomMatch3View:fillTiles(arg_48_1)
	local var_48_0 = 0
...
function GameRoomMatch3View:findMove()
...
function GameRoomMatch3View:stopGame()
	self.inGame = false
...
function GameRoomMatch3View:formatScore(arg_55_1, arg_55_2)
	local var_55_0 = {}
...
function GameRoomMatch3View:update()
	self.hintTimer:Stop()
...
function GameRoomMatch3View:tryMatch()
	local var_64_0 = {}
...
function GameRoomMatch3View:bfs(arg_65_1)
	local var_65_0 = {}
