...
}).GetStageConfig = function(arg_1_0)
	local var_1_0 = var_0_0.STAGE_CONFIG[arg_1_0] or {}

	return setmetatable(var_1_0, {
...
}).GetCreateConfig = function(arg_2_0)
	local var_2_0 = {}
...
}).GetSkillParam = function(arg_68_0, arg_68_1)
...
}).ParsingElements = function(arg_69_0)
	({}).high = arg_69_0[1] or 0
	;({}).count = arg_69_0[2] or 0

	if arg_69_0[3] then
		({}).item = var_0_0.ITEM_LIST[arg_69_0[3]] or nil

		for iter_69_0 = 1, 7 do
			({})["stage_" .. iter_69_0] = arg_69_0[iter_69_0 + 3] or 0
		end
		...
		for iter_69_1, iter_69_2 in ipairs({
			...
			({}).level[iter_69_2] = arg_69_0[iter_69_1 + 10] or var_0_0.SKILL_LEVEL_CONFIG[iter_69_2].level
		end
