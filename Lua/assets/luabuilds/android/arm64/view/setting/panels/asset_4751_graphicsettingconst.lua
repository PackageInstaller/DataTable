...
function GraphicSettingConst.SettingQuality(arg_4_0)
	local var_4_0 = PlayerPrefs.GetInt((arg_4_0 or nil) and (var_0_0.PlayerGraphicLevelIsland or var_0_0.PlayerGraphicLevelDorm), 4)

	if var_4_0 ~= 4 then
		for iter_4_0, iter_4_1 in ipairs(var_0_0.settings) do
			GraphicsInterface.Instance:SetQualitySettings(iter_4_1.parameterId, iter_4_1.defaultValues[var_4_0])
		end
	...
	for iter_4_2, iter_4_3 in ipairs(var_0_0.settings) do
		local var_4_1 = iter_4_3.parameterId
		local var_4_2 = PlayerPrefs.GetInt((arg_4_0 or nil) and (iter_4_3.playerPrefsname .. "island" or iter_4_3.playerPrefsname), -1)

		GraphicsInterface.Instance:SetQualitySettings(var_4_1, (var_4_2 ~= -1 or nil) and var_4_2)
	end
