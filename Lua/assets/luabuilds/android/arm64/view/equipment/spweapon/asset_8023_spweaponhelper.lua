...
local function var_0_6(arg_1_0, arg_1_1)
	...
	elseif arg_1_1.descTrigger ~= nil then
		local var_1_2 = arg_1_0:Find("desc")

		onToggle(nil, var_1_0, function(arg_3_0)
			setActive(var_1_2, arg_3_0)

			return
		end, SFX_PANEL)
		onButton(nil, var_1_2, function()
...
function updateSpWeaponInfo(arg_9_0, arg_9_1, arg_9_2)
	...
	UIItemList.StaticAlign(var_9_5, var_9_6, #var_9_9, function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == UIItemList.EventUpdate then
			...
			GetImageSpriteFromAtlasAsync("shiptype", ShipType.Type2CNLabel(var_9_9[arg_12_1]), arg_12_2)
...
function var_0_0:AlignAttrs(arg_13_1)
	for iter_13_0 = 1, #self do
		if not arg_13_1[iter_13_0] or self[iter_13_0].type ~= arg_13_1[iter_13_0].type then
	...
	for iter_13_2 = #self + 1, #arg_13_1 do
		table.insert(self, {
			type = arg_13_1[iter_13_2].type
		})

		self[iter_13_2].empty = true
	end

	return
end

function var_0_0:CompareInfo(arg_14_1)
	arg_14_1.compare = (arg_14_1.empty and 0 or arg_14_1.configAttr + arg_14_1.baseAttr) - (self.empty and 0 or self.configAttr + self.baseAttr)

	return
end

function var_0_0:InsertAttrsCompare(arg_15_1)
	var_0_0.AlignAttrs(self, arg_15_1)

	for iter_15_0 = 1, #self do
		var_0_0.CompareInfo(self[iter_15_0], arg_15_1[iter_15_0])
	end
...
local function var_0_11(arg_17_0, arg_17_1)
	...
	for iter_17_0 = 1, #arg_17_0 do
		...
		local var_17_2 = AttributeType.Type2Name(arg_17_0[iter_17_0].type)
		local var_17_3
...
function var_0_0:TransformCompositeInfo()
	local var_20_0 = {}
	local var_20_1 = {
		self:getConfig("attribute_1"),
		self:getConfig("attribute_2")
	}
	local var_20_2 = self:GetConfigAttributes()
	local var_20_3 = self:GetAttributesRange()

	for iter_20_0 = 1, 2 do
		table.insert(var_20_0, {
			name = AttributeType.Type2Name(var_20_1[iter_20_0]),
			value = var_20_2[iter_20_0] .. " + 0~" .. var_20_3[iter_20_0]
		})
	end
...
function var_0_0:TransformUpgradeInfo(arg_21_1)
	local var_21_0 = {}
	local var_21_1 = {
		self:getConfig("attribute_1"),
		self:getConfig("attribute_2")
	}
	local var_21_2 = self:GetConfigAttributes()
	local var_21_3 = arg_21_1:GetConfigAttributes()
	local var_21_4 = self:GetBaseAttributes()
