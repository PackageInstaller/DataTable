local ActivityBossBuffSelectLayerTemplate = class("ActivityBossBuffSelectLayerTemplate", import("view.base.BaseUI"))

function ActivityBossBuffSelectLayerTemplate:getUIName()
	error("Need Complete")

	return
end

function ActivityBossBuffSelectLayerTemplate:init()
...
function ActivityBossBuffSelectLayerTemplate:didEnter()
	self.buffDatas = {}
...
function ActivityBossBuffSelectLayerTemplate:UpdateView()
...
function ActivityBossBuffSelectLayerTemplate:UpdateBuffItem(arg_14_1, arg_14_2)
...
function ActivityBossBuffSelectLayerTemplate:UpdateActiveBuffs()
...
function ActivityBossBuffSelectLayerTemplate:UpdateActiveBuffItem(arg_19_1, arg_19_2)
...
function ActivityBossBuffSelectLayerTemplate:willExit()
	pg.UIMgr.GetInstance():UnOverlayPanel(self._tf)

	return
end

return ActivityBossBuffSelectLayerTemplate
