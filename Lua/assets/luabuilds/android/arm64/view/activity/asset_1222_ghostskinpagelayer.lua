local GhostSkinPageLayer = class("GhostSkinPageLayer", import("view.base.BaseUI"))
local var_0_1

function GhostSkinPageLayer:getUIName()
	return "GhostSkinPageUI"
end

function GhostSkinPageLayer:init()
	...
	self.storyStateDic = {}
	self.item = self.bg:Find("task/item")
	self.items = self.bg:Find("task/items")
...
function GhostSkinPageLayer:OnUpdateFlush()
	self:UpdataTaskData()
...
function GhostSkinPageLayer:UpdataTaskData()
	self.taskGroup = {}
...
function GhostSkinPageLayer:UpdateTask(arg_7_1, arg_7_2)
	...
	onButton(self, var_7_9, function()
		self:emit(ActivityMediator.ON_TASK_GO, var_7_1)
	...
	onButton(self, var_7_10, function()
		...
		seriesAsync(var_10_0, function()
			self:emit(GhostSkinMediator.ON_TASK_SUBMIT, var_7_1)
...
function GhostSkinPageLayer:DisplayBigTask()
...
function GhostSkinPageLayer:GetProgressColor()
	return nil
end

function GhostSkinPageLayer:InitStoryState()
...
function GhostSkinPageLayer:UpdateStoryView()
...
function GhostSkinPageLayer:UpdateItemView(arg_20_1)
	setText(self._tf:Find("des/count"), tostring(arg_20_1.data1))

	return
end

function GhostSkinPageLayer:UpdataStoryState(arg_21_1)
...
function GhostSkinPageLayer:ShouldRewardAll(arg_25_1)
	if (function()
		...
		seriesAsync(var_25_0, function()
			self:emit(GhostSkinMediator.ON_TASK_SUBMIT, var_25_2)
...
function GhostSkinPageLayer:didEnter()
...
function GhostSkinPageLayer:ShowMask(arg_32_1)
	GetOrAddComponent(self._tf:Find("mask"), typeof(CanvasGroup)).blocksRaycasts = arg_32_1

	return
end

function GhostSkinPageLayer:onBackPressed()
...
function GhostSkinPageLayer.IsShowRed()
