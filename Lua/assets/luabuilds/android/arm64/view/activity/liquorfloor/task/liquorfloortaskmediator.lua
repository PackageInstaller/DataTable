local var_0_0 = class("LiquorFloorTaskMediator", import("view.base.ContextMediator"))

var_0_0.ON_TASK_GO = "LiquorFloorTaskMediator::ON_TASK_GO"
var_0_0.ON_TASK_SUBMIT = "LiquorFloorTaskMediator::ON_TASK_SUBMIT"
