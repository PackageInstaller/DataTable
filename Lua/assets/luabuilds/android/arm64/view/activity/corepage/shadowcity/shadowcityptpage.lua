local ShadowCityPtPage = class("ShadowCityPtPage", import("view.activity.CorePage.CorePageNewPtTemplatePage"))

function ShadowCityPtPage:UpdateAward(arg_1_1, arg_1_2)
	local var_1_0 = self.awardList[arg_1_1 + 1].drop

	updateDrop(arg_1_2:Find("mask/IconTpl"), self.awardList[arg_1_1 + 1].drop)
