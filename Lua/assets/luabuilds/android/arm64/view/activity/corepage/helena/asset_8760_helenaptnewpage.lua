local HelenaPtNewPage = class("HelenaPtNewPage", import("view.activity.CorePage.CorePageNewPtTemplatePage"))

function HelenaPtNewPage:UpdateAward(arg_1_1, arg_1_2)
	...
	setActive(arg_1_2:Find("lock"), not var_1_2)
