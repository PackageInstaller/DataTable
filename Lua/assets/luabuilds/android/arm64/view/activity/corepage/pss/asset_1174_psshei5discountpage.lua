local PSSHei5DiscountPage = class("PSSHei5DiscountPage", import("view.activity.CorePage.CoreActivityPage"))

function PSSHei5DiscountPage:OnInit()
...
function PSSHei5DiscountPage:OnDataSetting()
...
function PSSHei5DiscountPage:GetPageLink()
	return {
		self.activity:getConfig("config_client").sub_act_id
	}
end

function PSSHei5DiscountPage:OnFirstFlush()
...
function PSSHei5DiscountPage:OnUpdateFlush()
...
function PSSHei5DiscountPage:GetTips()
	return pg.gametip.SkinDiscountHelp_BlackFriday.tip
end

function PSSHei5DiscountPage:GetCouponCountText()
	return self.couponCount
end

function PSSHei5DiscountPage:GetGiftShopType()
	return ChargeScene.TYPE_GIFT
end

return PSSHei5DiscountPage
