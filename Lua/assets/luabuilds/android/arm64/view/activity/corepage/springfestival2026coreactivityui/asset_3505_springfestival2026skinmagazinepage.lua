local SpringFestival2026SkinMagazinePage = class("SpringFestival2026SkinMagazinePage", import("view.activity.CorePage.CoreActivityPage"))

function SpringFestival2026SkinMagazinePage:OnInit()
...
function SpringFestival2026SkinMagazinePage:OnDataSetting()
...
function SpringFestival2026SkinMagazinePage:RefreshData()
...
function SpringFestival2026SkinMagazinePage:OnFirstFlush()
...
function SpringFestival2026SkinMagazinePage:OnUpdateFlush()
	local var_8_0 = 0
	local var_8_1 = {}
...
function SpringFestival2026SkinMagazinePage:SelectPage(arg_9_1)
...
function SpringFestival2026SkinMagazinePage:OnDestroy()
...
return SpringFestival2026SkinMagazinePage
