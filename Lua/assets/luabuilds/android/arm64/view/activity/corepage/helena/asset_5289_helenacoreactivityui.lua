local HelenaCoreActivityUI = class("HelenaCoreActivityUI", import("view.activity.CorePage.CoreActivityMainScene"))

function HelenaCoreActivityUI:getUIName()
	return "HelenaCoreActivityUI"
end

HelenaCoreActivityUI.optionsPath = {
	"adapt/TopPage/top/btn_home"
}

function HelenaCoreActivityUI:init(...)
	HelenaCoreActivityUI.super.init(self, ...)
	...
	onButton(self, self._tf:Find("adapt/TopPage/top/btn_back"), function()
		self:emit(HelenaCoreActivityUI.ON_BACK)
...
function HelenaCoreActivityUI:ActiveScenarioLayer(arg_7_1)
	self.contextData.activeScenario = arg_7_1

	return
end

function HelenaCoreActivityUI:verifyTabs(arg_8_1)
...
function HelenaCoreActivityUI:OnToggleName(arg_9_1, arg_9_2)
	setText(arg_9_1:Find("on/name"), i18n(arg_9_2:getConfig("title_res_tag")))
	setText(arg_9_1:Find("name"), i18n(arg_9_2:getConfig("title_res_tag")))

	return
end

function HelenaCoreActivityUI:OnAnimations(arg_10_1, arg_10_2)
	SetActive(self._tf:Find("adapt/decorate"), id == 50261 or id == 0)

	return
end

function HelenaCoreActivityUI:willExit()
	HelenaCoreActivityUI.super.willExit(self)
