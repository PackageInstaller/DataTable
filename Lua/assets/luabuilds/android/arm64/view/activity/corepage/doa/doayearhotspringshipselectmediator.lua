local var_0_0 = class("DOAYearHotSpringShipSelectMediator", import("view.base.ContextMediator"))

var_0_0.EXTEND = "DOAYearHotSpringShipSelectMediator:EXTEND"
var_0_0.OPEN_CHUANWU = "DOAYearHotSpringShipSelectMediator:OPEN_CHUANWU"
var_0_0.LOOG_PRESS_SHIP = "DOAYearHotSpringShipSelectMediator:LOOG_PRESS_SHIP"

function var_0_0.register(arg_1_0)
	arg_1_0:bind(var_0_0.EXTEND, function(arg_2_0)
		arg_1_0:sendNotification(DOAYearHotSpringMediator.UNLOCK_SLOT, arg_1_0.contextData.actId)
	...
	arg_1_0:bind(var_0_0.OPEN_CHUANWU, function(arg_4_0, arg_4_1, arg_4_2)
		arg_1_0:sendNotification(DOAYearHotSpringMediator.OPEN_CHUANWU, {
			arg_4_1,
			arg_4_2
		})
