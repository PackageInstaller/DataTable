local var_0_0 = class("WillOfDeathPage", import("..CoreActivityPage"))

function var_0_0.OnInit(arg_1_0)
	arg_1_0.bg = arg_1_0._tf:Find("AD")
	arg_1_0.rtTask = arg_1_0.bg:Find("task")
	arg_1_0.slider = arg_1_0.rtTask:Find("slider")
	arg_1_0.step = arg_1_0.rtTask:Find("step")
	arg_1_0.progress = arg_1_0.rtTask:Find("progress")
	arg_1_0.displayBtn = arg_1_0.rtTask:Find("display_btn")
	arg_1_0.awardTF = arg_1_0.rtTask:Find("award")
	arg_1_0.battleBtn = arg_1_0.rtTask:Find("battle_btn")
	arg_1_0.getBtn = arg_1_0.rtTask:Find("get_btn")
	arg_1_0.gotBtn = arg_1_0.rtTask:Find("got_btn")
...
function var_0_0.OnFirstFlush(arg_3_0)
	setText(arg_3_0.rtTask:Find("taskDesc"), i18n("brs_dmact_tip"))
...
function var_0_0.OnUpdateFlush(arg_9_0)
	...
	if arg_9_0.step then
		...
		setText(arg_9_0.step, string.format("<size=52>%s</size><size=32><color=#ffffff33>/%s</color></size>", var_9_2, var_9_3))
	end
	...
	setText(arg_9_0.progress, string.format("%s<color=#ffffff33>/%s</color>", var_9_8, var_9_6))
