...
function CoreAwardTemplatePage:AddTogglesListener()
	...
	for iter_10_0, iter_10_1 in ipairs(var_10_0) do
		...
		if type(iter_10_1) == "table" then
			var_10_1 = iter_10_1[1] or iter_10_1
		end

		local var_10_2 = self.togglesTF:Find(CoreAwardTemplatePage.DropType2Name[var_10_1])

		onToggle(self, var_10_2, function(arg_11_0)
			if arg_11_0 then
		...
		self.toggles[var_10_1] = var_10_2
	end
...
function CoreAwardTemplatePage:UpdatePage(arg_20_1)
	...
	self.curPage = var_20_0[1]
	self.showDataList = {}

	for iter_20_0, iter_20_1 in ipairs(self.dataList) do
		if table.contains(var_20_0, self.guideConfig[iter_20_1.id].type) then
