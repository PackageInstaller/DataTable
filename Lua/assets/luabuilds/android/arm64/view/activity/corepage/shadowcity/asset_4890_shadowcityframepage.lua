local ShadowCityFramePage = class("ShadowCityFramePage", import("view.activity.CorePage.CoreNewFrameTemplatePage"))

function ShadowCityFramePage:OnInit()
	...
	self.animClip1 = "anim_ShadowCityFramePage_switcher"
	self.animClip2 = "anim_ShadowCityFramePage_switcher2"

	return
end

function ShadowCityFramePage:OnFirstFlush()
	...
	ShadowCityFramePage.super.OnFirstFlush(self)

	return
end

function ShadowCityFramePage:OnUpdateFlush()
	ShadowCityFramePage.super.OnUpdateFlush(self)
...
function ShadowCityFramePage:Switch(arg_4_1)
