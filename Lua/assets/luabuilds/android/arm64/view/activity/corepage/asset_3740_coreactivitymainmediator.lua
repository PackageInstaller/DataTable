local CoreActivityMainMediator = class("CoreActivityMainMediator", import("view.activity.ActivityMediator"))

CoreActivityMainMediator.OPEN_CHUANWU = "CoreActivityMainMediator:Open chuanwu"

function CoreActivityMainMediator:getDisplayActivity()
	return getProxy(ActivityProxy):getCorePanelActivities(self.contextData.coreName)
end

function CoreActivityMainMediator:register()
	CoreActivityMainMediator.super.register(self)
	self:bind(CoreActivityMainMediator.OPEN_CHUANWU, function(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
		self:OnSelShips(arg_3_1, arg_3_2, arg_3_3, arg_3_4)
...
function CoreActivityMainMediator:initNotificationHandleDic()
	CoreActivityMainMediator.super.initNotificationHandleDic(self)

	self.handleDic[ActivityProxy.ACTIVITY_SHOW_RED_PACKET_AWARDS] = function(arg_5_0, arg_5_1)
	...
	self.handleDic[GAME.ACT_NEW_PT_DONE] = function(arg_6_0, arg_6_1)
...
function CoreActivityMainMediator:tryColoringAchieve()
...
function CoreActivityMainMediator:OnSelShips(arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	local var_9_0 = getProxy(ActivityProxy):getActivityById(arg_9_1)
	local var_9_1 = self:GetSelectedShipIds(arg_9_1, arg_9_3)
	local var_9_2 = {
		callbackQuit = true,
		selectedMax = arg_9_4,
	...
	var_9_2.preView = self.viewComponent.__cname
	...
	function var_9_2.onShip(arg_10_0, arg_10_1, arg_10_2)
		return self:OnShip(arg_10_0, arg_10_1, arg_10_2)
	end

	function var_9_2.onSelected(arg_11_0, arg_11_1)
		self:OnSelected(arg_9_1, arg_9_2, arg_11_0, arg_11_1)
...
function CoreActivityMainMediator:GetSelectedShipIds(arg_13_1, arg_13_2)
	local var_13_0

	if arg_13_2 then
		var_13_0 = arg_13_2.id or -1
	end

	local var_13_1 = {}

	for iter_13_0, iter_13_1 in ipairs(getProxy(ActivityProxy):getActivityById(arg_13_1):GetShipIds()) do
		local var_13_2 = iter_13_1 > 0 and getProxy(BayProxy):RawGetShipById(iter_13_1)

		if var_13_2 and var_13_2.id ~= var_13_0 then
			table.insert(var_13_1, var_13_2.id)
		end
	end
...
function CoreActivityMainMediator:OnShip(arg_14_1, arg_14_2, arg_14_3)
...
function CoreActivityMainMediator:OnSelected(arg_16_1, arg_16_2, arg_16_3, arg_16_4)
	...
	table.Foreach(var_16_1, function(arg_21_0, arg_21_1)
		if (var_16_5[arg_21_0] or 0) ~= arg_21_1 then
...
return CoreActivityMainMediator
