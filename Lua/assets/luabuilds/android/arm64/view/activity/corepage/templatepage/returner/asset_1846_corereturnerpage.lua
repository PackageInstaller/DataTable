local CoreReturnerPage = class("CoreReturnerPage")

function CoreReturnerPage:Ctor(arg_1_1, arg_1_2)
...
function CoreReturnerPage:Init()
...
function CoreReturnerPage:Update(arg_7_1)
...
function CoreReturnerPage:ShouldAcceptTasks()
	if self.code == 0 then
		return false
	end
...
function CoreReturnerPage:AcceptTasks()
	self._event:emit(ActivityMediator.RETURN_AWARD_OP, {
		activity_id = self.activity.id,
...
function CoreReturnerPage:UpdateData()
...
function CoreReturnerPage:UpdateTasks()
...
function CoreReturnerPage:Dispose()
