local CoreNewFrameTemplatePage = class("CoreNewFrameTemplatePage", import("view.activity.CorePage.CoreActivityPage"))

function CoreNewFrameTemplatePage:OnInit()
...
function CoreNewFrameTemplatePage:OnDataSetting()
...
function CoreNewFrameTemplatePage:OnFirstFlush()
...
function CoreNewFrameTemplatePage:OnUpdateFlush()
...
function CoreNewFrameTemplatePage:Switch(arg_8_1)
...
return CoreNewFrameTemplatePage
