local CoreLoginTemplatePage = class("CoreLoginTemplatePage", import("view.activity.CorePage.CoreActivityPage"))

function CoreLoginTemplatePage:OnInit()
...
function CoreLoginTemplatePage:OnDataSetting()
	self.nday = 0
...
function CoreLoginTemplatePage:OnFirstFlush()
...
function CoreLoginTemplatePage:UpdateTask(arg_5_1, arg_5_2)
...
function CoreLoginTemplatePage:OnUpdateFlush()
...
function CoreLoginTemplatePage:PlayStory()
	local var_12_0 = self.activity:getConfig("config_client").story
	...
	if checkExist(var_12_0, {
		...
		pg.NewStoryMgr.GetInstance():Play(var_12_0[self.nday][1])
	end

	return
end

function CoreLoginTemplatePage:OnDestroy()
...
function CoreLoginTemplatePage:GetProgressColor()
	return nil
end

function CoreLoginTemplatePage:SetBtnLocal(arg_16_1)
	return nil
end

return CoreLoginTemplatePage
