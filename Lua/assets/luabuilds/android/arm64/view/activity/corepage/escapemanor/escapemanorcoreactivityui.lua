...
function var_0_0.verifyTabs(arg_7_0, arg_7_1)
	local var_7_0 = arg_7_0:getActivityIndex(arg_7_1) or arg_7_0:getActivityIndex(arg_7_0:GetActiveActivity()) or 1

	if arg_7_0.activities[var_7_0] == nil then
		return
	end

	triggerToggle(arg_7_0.tabs:Find(tostring((arg_7_0.activities[var_7_0]:getConfig("is_show")))), true)
