local var_0_0 = class("CoreAdaptActivityMainScene", import("view.activity.CorePage.CoreActivityMainScene"))
...
function var_0_0.init(arg_2_0, ...)
	...
	arg_2_0.btnBack = arg_2_0._tf:Find("adapt/TopPage/top/btn_back")
...
function var_0_0.CustomInit(arg_10_0)
	return
end

function var_0_0.GetButtonNameText(arg_11_0, arg_11_1)
	return
end

function var_0_0.OnClickBtn(arg_12_0, arg_12_1, arg_12_2)
	return
end
