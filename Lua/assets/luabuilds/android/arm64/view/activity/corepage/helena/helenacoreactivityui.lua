local var_0_0 = class("HelenaCoreActivityUI", import("view.activity.CorePage.CoreActivityMainScene"))
...
function var_0_0.OnAnimations(arg_10_0, arg_10_1, arg_10_2)
	SetActive(arg_10_0._tf:Find("adapt/decorate"), id == 50261 or id == 0)
