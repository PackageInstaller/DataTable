local SecretsAbyssMGPage = class("SecretsAbyssMGPage", import("view.activity.CorePage.CoreActivityPage"))
local var_0_1 = 78

function SecretsAbyssMGPage:OnInit()
...
function SecretsAbyssMGPage:OnFirstFlush()
...
function SecretsAbyssMGPage:willExit()
	return
end

return SecretsAbyssMGPage
