local WinterFestival2025SkinReSellPage = class("WinterFestival2025SkinReSellPage", import("view.activity.CorePage.CoreActivityPage"))

function WinterFestival2025SkinReSellPage:OnInit()
...
function WinterFestival2025SkinReSellPage:OnDataSetting()
...
function WinterFestival2025SkinReSellPage:GetPageLink()
	return {
		self.activity:getConfig("config_client").sub_act_id
	}
end

function WinterFestival2025SkinReSellPage:OnFirstFlush()
...
function WinterFestival2025SkinReSellPage:OnUpdateFlush()
	...
	setText(self.rtSkinCoupon:Find("count"), self:GetCouponCountText())
	setActive(self.rtSkinCoupon:Find("icon/get"), self.couponGet > 0)

	return
end

function WinterFestival2025SkinReSellPage:GetTips()
	return pg.gametip.SkinDiscountHelp_Winter.tip
end

function WinterFestival2025SkinReSellPage:GetCouponCountText()
	return self.couponCount
end

function WinterFestival2025SkinReSellPage:GetGiftShopType()
	return ChargeScene.TYPE_PICK
end

return WinterFestival2025SkinReSellPage
