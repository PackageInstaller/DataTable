local HolidayVillaHotSpringMediator = class("HolidayVillaHotSpringMediator", import("view.activity.BackHills.NewYearFestival.NewYearHotSpringMediator"))

function HolidayVillaHotSpringMediator:register()
	self:bind(HolidayVillaHotSpringMediator.UNLOCK_SLOT, function(arg_2_0, arg_2_1)
	...
	self:bind(HolidayVillaHotSpringMediator.OPEN_CHUANWU, function(arg_4_0, arg_4_1, arg_4_2)
	...
	self:bind(HolidayVillaHotSpringMediator.OPEN_INFO, function()
...
return HolidayVillaHotSpringMediator
