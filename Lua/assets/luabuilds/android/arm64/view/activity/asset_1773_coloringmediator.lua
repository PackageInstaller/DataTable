local ColoringMediator = class("ColoringMediator", import("..base.ContextMediator"))

ColoringMediator.EVENT_GO_SCENE = "event go scene"
ColoringMediator.EVENT_COLORING_CELL = "event coloring cell"
ColoringMediator.EVENT_COLORING_CLEAR = "event coloring clear"

function ColoringMediator:register()
	self:bind(ColoringMediator.EVENT_GO_SCENE, function(arg_2_0, arg_2_1, arg_2_2)
		self:sendNotification(GAME.GO_SCENE, arg_2_1, arg_2_2)

		return
	end)
	self:bind(ColoringMediator.EVENT_COLORING_CELL, function(arg_3_0, arg_3_1)
		self:sendNotification(GAME.COLORING_CELL, arg_3_1)

		return
	end)
	self:bind(ColoringMediator.EVENT_COLORING_CLEAR, function(arg_4_0, arg_4_1)
...
function ColoringMediator:listNotificationInterests()
	return {
...
function ColoringMediator:handleNotification(arg_6_1)
...
function ColoringMediator:tryColoringAchieve()
