...
function var_0_0.didEnter(arg_36_0)
	...
	local var_36_1 = var_36_0.getActivityById(var_36_9000, arg_36_0.contextData.actId)
	local var_36_2 = var_36_0 and var_36_1:HasPassStage(arg_36_0.contextData.stageId)

	setActive(arg_36_0._continuousBtn, (var_36_1:GetEnemyDataByStageId(arg_36_0.contextData.stageId):IsContinuousType()))
	setActive(arg_36_0._continuousBtn:Find("lock"), not var_36_2)

	if var_36_2 then
		local var_36_3 = Color.white or Color.New(0.2980392156862745, 0.2980392156862745, 0.2980392156862745)
...
function var_0_0.displayFleetInfo(arg_55_0)
	...
	local var_55_4 = arg_55_0.contextData.system
	local var_55_5 = pg.battle_cost_template[arg_55_0.contextData.system].oil_cost == 0 and 0 or arg_55_0._currentFleetVO:GetCostSum().oil

	setActive(arg_55_0._costContainer, true)
	var_0_1.tweenNumText(arg_55_0._costText, var_55_5)
	...
	if getProxy(ActivityProxy):getActivityById(arg_55_0.contextData.actId):getConfig("type") == ActivityConst.ACTIVITY_TYPE_BOSSSINGLE_VARIABLE then
		local var_55_6 = Fleet.DEFAULT_NAME_BOSS_SINGLE_VARIABLE_ACT or Fleet.DEFAULT_NAME_BOSS_SINGLE_ACT

		setText(arg_55_0._fleetNameText, var_55_6[arg_55_0._currentFleetVO.id])
		setText(arg_55_0._fleetNumText, arg_55_0._currentFleetVO.id)

		local var_55_8 = pg.battle_cost_template[var_55_4].oil_cost > 0
		local var_55_9 = 0
		local var_55_10 = 0
		local var_55_11 = false

		for iter_55_0, iter_55_1 in ipairs({
			arg_55_0.contextData.fleets[1]
		}) do
			local var_55_12 = iter_55_1:GetCostSum().oil

			if not var_55_8 then
				var_55_12 = 0
			end

			var_55_10 = 0 + var_55_12

			local var_55_13 = arg_55_0.contextData.costLimit[iter_55_0 == 1 and 1 or 2]

			if arg_55_0.contextData.costLimit[iter_55_0 == 1 and 1 or 2] > 0 then
				var_55_11 = var_55_11 or var_55_13 < var_55_12
				var_55_12 = math.min(var_55_12, var_55_13)
			end

			var_55_9 = var_55_9 + var_55_12
		end

		local var_55_14 = var_55_11 and Color(0.9803921568627451, 0.39215686274509803, 0.39215686274509803) or Color.white

		setTextColor(arg_55_0._costText, var_55_14)
		var_0_1.tweenNumText(arg_55_0._costText, var_55_9)
		setActive(arg_55_0._costTip, var_55_11)

		if var_55_11 then
			onButton(arg_55_0, arg_55_0._costTip, function()
				pg.MsgboxMgr.GetInstance():ShowMsgBox({
					hideNo = true,
					content = i18n("use_oil_limit_help", var_55_10, var_55_9)
				})
