local BossRushSardiniaEXBattleResultLayer = class("BossRushSardiniaEXBattleResultLayer", import("view.base.BaseUI"))

function BossRushSardiniaEXBattleResultLayer:getUIName()
	return "BattleResultBossRushSardiniaEXUI"
end

function BossRushSardiniaEXBattleResultLayer:init()
	setText(self._tf:Find("TotalScore/Desc"), i18n("series_enemy_total_score"))

	return
end

function BossRushSardiniaEXBattleResultLayer:didEnter()
...
function BossRushSardiniaEXBattleResultLayer:setPainting(arg_8_1, arg_8_2, arg_8_3)
	setPaintingPrefabAsync(arg_8_1, arg_8_2, "biandui", arg_8_3)

	return
end

function BossRushSardiniaEXBattleResultLayer:retPainting(arg_9_1, arg_9_2)
	retPaintingPrefab(arg_9_1, arg_9_2)

	return
end

function BossRushSardiniaEXBattleResultLayer:onBackPressed()
	triggerButton(self._tf:Find("Confirm"))

	return
end

function BossRushSardiniaEXBattleResultLayer:willExit()
...
function BossRushSardiniaEXBattleResultLayer:loadUI()
...
return BossRushSardiniaEXBattleResultLayer
