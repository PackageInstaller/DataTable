local BossRushEscapeManorBattleResultLayer = class("BossRushEscapeManorBattleResultLayer", import("view.base.BaseUI"))

function BossRushEscapeManorBattleResultLayer:getUIName()
	return "BattleResultBossRushEscapeManorEXUI"
end

function BossRushEscapeManorBattleResultLayer:init()
	setText(self._tf:Find("TotalScore/Desc"), i18n("series_enemy_total_score"))

	return
end

function BossRushEscapeManorBattleResultLayer:didEnter()
...
function BossRushEscapeManorBattleResultLayer:setPainting(arg_8_1, arg_8_2, arg_8_3)
	setPaintingPrefabAsync(arg_8_1, arg_8_2, "biandui", arg_8_3)

	return
end

function BossRushEscapeManorBattleResultLayer:retPainting(arg_9_1, arg_9_2)
	retPaintingPrefab(arg_9_1, arg_9_2)

	return
end

function BossRushEscapeManorBattleResultLayer:onBackPressed()
	triggerButton(self._tf:Find("Confirm"))

	return
end

function BossRushEscapeManorBattleResultLayer:willExit()
...
function BossRushEscapeManorBattleResultLayer:loadUI()
