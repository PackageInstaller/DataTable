local BossRushSardiniaPassedLayer = class("BossRushSardiniaPassedLayer", import("view.base.BaseUI"))

function BossRushSardiniaPassedLayer:getUIName()
	return "BossRushSardiniaPassedUI"
end

function BossRushSardiniaPassedLayer:didEnter()
...
function BossRushSardiniaPassedLayer:combatPreload(arg_12_1)
...
function BossRushSardiniaPassedLayer:willExit()
