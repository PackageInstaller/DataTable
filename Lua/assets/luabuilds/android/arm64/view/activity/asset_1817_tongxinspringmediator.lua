local TongXinSpringMediator = class("TongXinSpringMediator", import("..base.ContextMediator"))

TongXinSpringMediator.UNLOCK_SLOT = "TongXinSpringMediator:UNLOCK_SLOT"
TongXinSpringMediator.OPEN_CHUANWU = "TongXinSpringMediator:Open chuanwu"

function TongXinSpringMediator:register()
	self:bind(TongXinSpringMediator.UNLOCK_SLOT, function(arg_2_0, arg_2_1)
	...
	self:bind(TongXinSpringMediator.OPEN_CHUANWU, function(arg_4_0, arg_4_1, arg_4_2)
		self:OnSelShips(arg_4_1, arg_4_2)

		return
	end)
	self.viewComponent:InitActivity((getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_HOTSPRING)))

	return
end

function TongXinSpringMediator:OnSelShips(arg_5_1, arg_5_2)
	local var_5_0 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_HOTSPRING)
	local var_5_1 = self:GetSelectedShipIds(arg_5_2)
	local var_5_2 = {
		callbackQuit = true,
	...
	var_5_2.preView = self.viewComponent.__cname
	...
	function var_5_2.onShip(arg_6_0, arg_6_1, arg_6_2)
		return self:OnShip(arg_6_0, arg_6_1, arg_6_2)
	end

	function var_5_2.onSelected(arg_7_0, arg_7_1)
		self:OnSelected(arg_5_1, arg_7_0, arg_7_1)
...
function TongXinSpringMediator:OnSelected(arg_9_1, arg_9_2, arg_9_3)
...
function TongXinSpringMediator:GetSelectedShipIds(arg_15_1)
	local var_15_0
	...
	for iter_15_0, iter_15_1 in ipairs(getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_HOTSPRING):GetShipIds()) do
...
function TongXinSpringMediator:OnShip(arg_16_1, arg_16_2, arg_16_3)
...
function TongXinSpringMediator:listNotificationInterests()
	return {
		ActivityProxy.ACTIVITY_OPERATION_DONE,
		ActivityProxy.ACTIVITY_UPDATED,
		ActivityProxy.ACTIVITY_SHOW_AWARDS,
		TongXinSpringMediator.OPEN_CHUANWU,
		TongXinSpringMediator.UNLOCK_SLOT
	}
end

function TongXinSpringMediator:handleNotification(arg_19_1)
	...
	elseif var_19_0 == ActivityProxy.ACTIVITY_OPERATION_DONE then
		...
		if var_19_2:getConfig("type") == ActivityConst.ACTIVITY_TYPE_HOTSPRING then
			self.viewComponent:UpdateActivity(var_19_2)
		end
	elseif var_19_0 == TongXinSpringMediator.OPEN_CHUANWU then
		self.viewComponent:emit(TongXinSpringMediator.OPEN_CHUANWU, unpack(var_19_1))
	elseif var_19_0 == TongXinSpringMediator.UNLOCK_SLOT then
		self.viewComponent:emit(TongXinSpringMediator.UNLOCK_SLOT, var_19_1)
	end

	return
end

return TongXinSpringMediator
