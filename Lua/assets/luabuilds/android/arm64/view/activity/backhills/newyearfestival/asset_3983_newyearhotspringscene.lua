local NewYearHotSpringScene = class("NewYearHotSpringScene", import("view.base.BaseUI"))

function NewYearHotSpringScene:getUIName()
	return "NewYearHotSpringUI"
end

local var_0_1 = 0.85

function NewYearHotSpringScene:init()
...
function NewYearHotSpringScene:SetActivity(arg_8_1)
...
function NewYearHotSpringScene:didEnter()
	...
	onButton(self, self._tf:Find("Top/Manage"), function()
		self:emit(NewYearHotSpringMediator.OPEN_INFO)
...
function NewYearHotSpringScene:UpdateScrollContent(arg_23_1, arg_23_2, arg_23_3, arg_23_4)
...
function NewYearHotSpringScene:InitSlots()
	self:CleanSpines()
	table.Foreach(self.slotTFs, function(arg_25_0, arg_25_1)
		onButton(self, arg_25_1:Find("Usable"), function()
			self:emit(NewYearHotSpringMediator.UNLOCK_SLOT, self.activity.id)
		...
		local function var_25_0()
			...
			self:emit(NewYearHotSpringMediator.OPEN_CHUANWU, arg_25_0, var_27_0 > 0 and getProxy(BayProxy):RawGetShipById(var_27_0))
...
function NewYearHotSpringScene:UpdateView()
	self:UpdateSlots()
...
function NewYearHotSpringScene:UpdateSlots()
	self:CleanSpines()
...
function NewYearHotSpringScene:RectContainsRect(arg_36_1)
	return self:Contains(arg_36_1.min) and self:Contains(arg_36_1.max)
end

function NewYearHotSpringScene:UpdateSlot(arg_37_1, arg_37_2)
...
function NewYearHotSpringScene:SetSpineWash(arg_39_1)
...
function NewYearHotSpringScene:CleanSpines()
	self:ForceDropChar()
...
function NewYearHotSpringScene:ForceDropChar()
...
function NewYearHotSpringScene:GetRecordPos()
...
function NewYearHotSpringScene:RecordPos(arg_45_1)
...
function NewYearHotSpringScene:LoadingOn()
...
function NewYearHotSpringScene:LoadingOff()
...
function NewYearHotSpringScene:willExit()
