local NewYearHotSpringMediator = class("NewYearHotSpringMediator", import("view.base.ContextMediator"))

NewYearHotSpringMediator.UNLOCK_SLOT = "UNLOCK_SLOT"
NewYearHotSpringMediator.OPEN_INFO = "OPEN_INFO"
NewYearHotSpringMediator.OPEN_CHUANWU = "NewYearHotSpringMediator:Open chuanwu"

function NewYearHotSpringMediator:register()
	self:bind(NewYearHotSpringMediator.UNLOCK_SLOT, function(arg_2_0, arg_2_1)
	...
	self:bind(NewYearHotSpringMediator.OPEN_CHUANWU, function(arg_4_0, arg_4_1, arg_4_2)
	...
	self:bind(NewYearHotSpringMediator.OPEN_INFO, function()
...
function NewYearHotSpringMediator:GetGetSlotCount()
	return self.activity:GetSlotCount()
end

function NewYearHotSpringMediator:OnSelShips(arg_7_1, arg_7_2)
...
function NewYearHotSpringMediator:GetSelectedShipIds(arg_11_1)
	local var_11_0
...
function NewYearHotSpringMediator:OnShip(arg_12_1, arg_12_2, arg_12_3)
...
function NewYearHotSpringMediator:OnSelected(arg_14_1, arg_14_2, arg_14_3)
...
function NewYearHotSpringMediator:listNotificationInterests()
	return {
		PlayerProxy.UPDATED,
		ActivityProxy.ACTIVITY_UPDATED,
		ActivityProxy.ACTIVITY_SHOW_AWARDS,
		NewYearHotSpringMediator.OPEN_CHUANWU,
		NewYearHotSpringMediator.UNLOCK_SLOT
	}
end

function NewYearHotSpringMediator:handleNotification(arg_21_1)
	...
	elseif var_21_0 == NewYearHotSpringMediator.OPEN_CHUANWU then
		self.viewComponent:emit(NewYearHotSpringMediator.OPEN_CHUANWU, unpack(var_21_1))
	elseif var_21_0 == NewYearHotSpringMediator.UNLOCK_SLOT then
		self.viewComponent:emit(NewYearHotSpringMediator.UNLOCK_SLOT, var_21_1)
	end

	return
end

function NewYearHotSpringMediator:remove()
	return
end

return NewYearHotSpringMediator
