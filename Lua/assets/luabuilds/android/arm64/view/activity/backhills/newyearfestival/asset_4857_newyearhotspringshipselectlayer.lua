local NewYearHotSpringShipSelectLayer = class("NewYearHotSpringShipSelectLayer", import("view.base.BaseUI"))
local NewYearHotSpringFormationCard = import(".NewYearHotSpringFormationCard")

function NewYearHotSpringShipSelectLayer:getUIName()
	return "NewYearHotSpringShipSelectUI"
end

function NewYearHotSpringShipSelectLayer:init()
...
function NewYearHotSpringShipSelectLayer:SetActivity(arg_3_1)
	self.activity = arg_3_1

	return
end

function NewYearHotSpringShipSelectLayer:didEnter()
	self._tf:Find("BG"):SetSiblingIndex(0)
	onButton(self, self._tf:Find("BG"), function()
		self:emit(NewYearHotSpringShipSelectLayer.ON_CLOSE)
...
function NewYearHotSpringShipSelectLayer:UpdateSlots()
...
function NewYearHotSpringShipSelectLayer:AddCard(arg_9_1, arg_9_2, arg_9_3)
	local var_9_0
	...
	if arg_9_2 == 0 and arg_9_3 then
		...
		onButton(self, var_9_1, function()
			self:emit(NewYearHotSpringShipSelectMediator.OPEN_CHUANWU, arg_9_1, arg_9_3)
		...
		var_9_3.onLongPressed:AddListener(function()
			...
			self:emit(NewYearHotSpringShipSelectMediator.LOOG_PRESS_SHIP, arg_9_1, arg_9_3)
		...
		var_9_9[2] = setColorStr(10 * var_9_4, COLOR_GREEN) .. (var_9_5 > 0 and setColorStr("+" .. 10 * var_9_5, COLOR_GREEN) or "") .. "/h"
		var_9_8[3] = var_9_9

		var_9_2:updateProps1(var_9_8)
		...
		local var_9_10 = var_9_0:Find("content")

		setActive(var_9_10:Find("label/add"), arg_9_2 == 0)
		setActive(var_9_10:Find("label/unlock"), arg_9_2 == 1)
		setActive(var_9_10:Find("label/lock"), arg_9_2 == 2)
		setActive(var_9_10:Find("mask"), arg_9_2 == 2)

		if arg_9_2 == 0 then
			onButton(self, var_9_10, function()
				self:emit(NewYearHotSpringShipSelectMediator.OPEN_CHUANWU, arg_9_1)

				return
			end, SFX_PANEL)
		elseif arg_9_2 == 1 then
			onButton(self, var_9_10, function()
				self:emit(NewYearHotSpringShipSelectMediator.EXTEND, arg_9_1)
...
function NewYearHotSpringShipSelectLayer:CleanCards()
...
function NewYearHotSpringShipSelectLayer:willExit()
...
return NewYearHotSpringShipSelectLayer
