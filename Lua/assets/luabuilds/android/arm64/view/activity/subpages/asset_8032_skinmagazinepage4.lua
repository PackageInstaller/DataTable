local SkinMagazinePage4 = class("SkinMagazinePage4", import("...base.BaseActivityPage"))

SkinMagazinePage4.TIP_KEY = "SkinMagazinePage2_tip"

function SkinMagazinePage4:OnInit()
...
function SkinMagazinePage4:OnDataSetting()
...
function SkinMagazinePage4:RefreshData()
...
function SkinMagazinePage4:OnFirstFlush()
	...
	setText(self.rtAward:Find("get/click/desc"), i18n(SkinMagazinePage4.TIP_KEY))
...
function SkinMagazinePage4:OnUpdateFlush()
	local var_8_0 = 0
	local var_8_1 = {}
...
function SkinMagazinePage4:SelectPage(arg_9_1)
...
function SkinMagazinePage4:OnDestroy()
