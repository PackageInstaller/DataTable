local LittleMusashiPage = class("LittleMusashiPage", import(".TemplatePage.PtTemplatePage"))

function LittleMusashiPage:OnInit()
	LittleMusashiPage.super.OnInit(self)
...
function LittleMusashiPage:GetHelpTip()
	return pg.gametip.littleMusashi_npc.tip
end

function LittleMusashiPage:OnUpdateFlush()
	LittleMusashiPage.super.OnUpdateFlush(self)
	...
	setText(self.step, setColorStr(var_4_0, "#838fff") .. " / " .. setColorStr(var_4_1, "#666176"))
	setText(self.progress, (var_4_5 >= 1 and setColorStr(var_4_3, COLOR_GREEN) or setColorStr(var_4_3, "#7780d3")) .. "/" .. setColorStr(var_4_4, "#666176"))
...
function LittleMusashiPage:updataTask()
...
function LittleMusashiPage:OnFirstFlush()
	LittleMusashiPage.super.OnFirstFlush(self)
...
function LittleMusashiPage:initTask()
...
function LittleMusashiPage:updateTaskUI()
...
function LittleMusashiPage:updateTaskList(arg_12_1, arg_12_2, arg_12_3, arg_12_4)
...
function LittleMusashiPage:changeGroupOpening(arg_18_1)
...
function LittleMusashiPage:getTaskTfFromPool()
...
function LittleMusashiPage:getTaskGroup(arg_20_1, arg_20_2)
...
function LittleMusashiPage:insertTaskToGroup(arg_21_1, arg_21_2, arg_21_3)
...
function LittleMusashiPage:sortTaskGroups()
...
function LittleMusashiPage:OnDestroy()
	if LeanTween.isTweening(go(self.slider)) then
		LeanTween.cancel(go(self.slider))
	end
