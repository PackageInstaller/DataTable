local XiaoQiYePtPage = class("XiaoQiYePtPage", import(".TemplatePage.PtTemplatePage"))

function XiaoQiYePtPage:OnInit()
	XiaoQiYePtPage.super.OnInit(self)
...
function XiaoQiYePtPage:OnFirstFlush()
	XiaoQiYePtPage.super.OnFirstFlush(self)
...
function XiaoQiYePtPage:OnUpdateFlush()
	XiaoQiYePtPage.super.OnUpdateFlush(self)
