local For2022DaysLoginPage = class("For2022DaysLoginPage", import(".TemplatePage.LoginTemplatePage"))

function For2022DaysLoginPage:OnFirstFlush()
...
function For2022DaysLoginPage:OnUpdateFlush()
	For2022DaysLoginPage.super.OnUpdateFlush(self)
	setText(self.bg:Find("Text"), self.nday .. "/" .. self.Day)

	return
end

return For2022DaysLoginPage
