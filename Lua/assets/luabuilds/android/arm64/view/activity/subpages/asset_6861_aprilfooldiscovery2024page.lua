local AprilFoolDiscovery2024Page = class("AprilFoolDiscovery2024Page", import(".AprilFoolDiscoveryRePage"))
local var_0_1 = "goldenawake"

function AprilFoolDiscovery2024Page:OnInit()
	self.bg = self._tf:Find("AD")
	self.items = CustomIndexLayer.Clone2Full(self._tf:Find("AD/List"), 11)
	self.selectIndex = 0
	...
	for iter_1_0 = 1, #var_0_1 do
		self.loader:GetSprite("ui/activityuipage/AprilFoolDiscovery2024Page_atlas", string.sub(var_0_1, iter_1_0, iter_1_0), self.items[iter_1_0]:Find("Character"))
	end
...
function AprilFoolDiscovery2024Page:OnDataSetting()
	local var_2_0 = AprilFoolDiscovery2024Page.super.OnDataSetting(self)
...
function AprilFoolDiscovery2024Page:OnFirstFlush()
...
function AprilFoolDiscovery2024Page:OnUpdateFlush()
	...
	setActive(self.btnBattle:Find("Lock"), not var_8_1)
	self:UpdateSelection()
...
function AprilFoolDiscovery2024Page:UpdateSelection()
...
return AprilFoolDiscovery2024Page
