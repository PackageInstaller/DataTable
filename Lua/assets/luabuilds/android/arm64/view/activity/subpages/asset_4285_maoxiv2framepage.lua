local MaoxiV2framePage = class("MaoxiV2framePage", import(".TemplatePage.PtTemplatePage"))

function MaoxiV2framePage:OnFirstFlush()
	MaoxiV2framePage.super.OnFirstFlush(self)
...
function MaoxiV2framePage:Switch(arg_4_1)
...
function MaoxiV2framePage:UpdateAwardGot()
	setActive(self.bg:Find("switcher/phase2/got"), not self.ptData:CanGetNextAward() and self.inPhase2)

	return
end

function MaoxiV2framePage:OnUpdateFlush()
	MaoxiV2framePage.super.OnUpdateFlush(self)
	...
	setText(self.step, var_8_2 >= 1 and setColorStr(var_8_0, "#74b9ff") or var_8_0)
