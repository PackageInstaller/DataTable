local RoyalPtPage = class("RoyalPtPage", import(".TemplatePage.PtTemplatePage"))

function RoyalPtPage:OnInit()
	RoyalPtPage.super.OnInit(self)
...
function RoyalPtPage:OnUpdateFlush()
