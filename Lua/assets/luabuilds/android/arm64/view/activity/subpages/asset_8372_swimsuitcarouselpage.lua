local SwimsuitCarouselPage = class("SwimsuitCarouselPage", import("...base.BaseActivityPage"))

function SwimsuitCarouselPage:OnInit()
...
function SwimsuitCarouselPage:OnDataSetting()
...
function SwimsuitCarouselPage:RefreshData()
...
function SwimsuitCarouselPage:OnFirstFlush()
...
function SwimsuitCarouselPage:OnUpdateFlush()
	local var_8_0 = 0
	local var_8_1 = {}
...
function SwimsuitCarouselPage:SelectPage(arg_9_1)
...
function SwimsuitCarouselPage:OnDestroy()
