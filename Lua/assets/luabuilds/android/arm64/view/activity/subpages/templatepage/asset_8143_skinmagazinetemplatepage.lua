local SkinMagazineTemplatePage = class("SkinMagazineTemplatePage", import("view.base.BaseActivityPage"))
...
function SkinMagazineTemplatePage:UpdateDrop()
	...
	setActive(self.awardTf:Find("got"), var_9_2)
	setActive(self.awardTf:Find("get"), self.remainCnt > 0 and not var_9_2)
