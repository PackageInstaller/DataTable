local NeptuneTecCatchupPage = class("NeptuneTecCatchupPage", import("...base.BaseActivityPage"))

function NeptuneTecCatchupPage:OnInit()
...
function NeptuneTecCatchupPage:OnDataSetting()
...
function NeptuneTecCatchupPage:OnFirstFlush()
	local var_3_0 = {
		type = DROP_TYPE_ITEM,
		id = self.itemID
	}
...
function NeptuneTecCatchupPage:OnUpdateFlush()
...
function NeptuneTecCatchupPage:OnDestroy()
	return
end

return NeptuneTecCatchupPage
