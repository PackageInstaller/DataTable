local NewSkinMagazinePage4 = class("NewSkinMagazinePage4", import("...base.BaseActivityPage"))

function NewSkinMagazinePage4:OnInit()
...
function NewSkinMagazinePage4:OnDataSetting()
...
function NewSkinMagazinePage4:RefreshData()
...
function NewSkinMagazinePage4:OnFirstFlush()
...
function NewSkinMagazinePage4:OnUpdateFlush()
	local var_8_0 = 0
	local var_8_1 = {}
...
function NewSkinMagazinePage4:SelectPage(arg_9_1)
...
function NewSkinMagazinePage4:OnDestroy()
