...
function var_0_0.updateUI(arg_7_0)
	...
	if var_7_1 then
		var_7_2 = var_0_0:skinCommdityTimeStamps((arg_7_0.timeMgr:Table2ServerTime(var_7_1)))
	end

	setActive(arg_7_0.shop_bgtime, var_7_2 and var_7_2 ~= 0)
	setText(arg_7_0.shop_time, var_7_2)

	local var_7_3, var_7_4 = arg_7_0.timeMgr:inTime(pg.activity_template[var_0_3].time)
	local var_7_5

	if var_7_4 then
		var_7_5 = var_0_0:skinCommdityTimeStamps((arg_7_0.timeMgr:Table2ServerTime(var_7_4)))
	end

	setActive(arg_7_0.build_bgtime, var_7_5 and var_7_5 ~= 0)
	setText(arg_7_0.build_time, i18n("tolovemainpage_build_countdown"))

	local var_7_6 = arg_7_0.activity:getConfig("config_client")
