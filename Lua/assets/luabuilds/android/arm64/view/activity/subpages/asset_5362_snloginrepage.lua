local SNLoginRePage = class("SNLoginRePage", import(".TemplatePage.LoginTemplatePage"))

function SNLoginRePage:OnInit()
	SNLoginRePage.super.OnInit(self)
...
function SNLoginRePage:OnFirstFlush()
...
function SNLoginRePage:OnUpdateFlush()
	SNLoginRePage.super.OnUpdateFlush(self)
	setFillAmount(self.bar, self.nday / self.Day)

	return
end

function SNLoginRePage:OnDestroy()
	return
end

return SNLoginRePage
