local WorldInPicturePage = class("WorldInPicturePage", import(".TemplatePage.SkinTemplatePage"))

function WorldInPicturePage:OnInit()
...
function WorldInPicturePage:OnFirstFlush()
	WorldInPicturePage.super.OnFirstFlush(self)
...
function WorldInPicturePage:UpdateTask(arg_5_1, arg_5_2)
...
function WorldInPicturePage:OnUpdateFlush()
	WorldInPicturePage.super.OnUpdateFlush(self)
	setActive(self.tip, self.miniGameAct and not self.miniGameAct:isEnd() and self.miniGameAct:readyToAchieve())

	return
end

return WorldInPicturePage
