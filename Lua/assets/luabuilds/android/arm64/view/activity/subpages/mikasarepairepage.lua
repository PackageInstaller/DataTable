...
function var_0_0.update_task_list_mikasa_museum(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	onButton(arg_4_0, var_4_4:Find("helpBtn"), function()
	...
	for iter_4_0 = 1, 4 do
		...
		for iter_4_1 = 1, 4 do
			...
			arg_4_0:set_mikasa_btn(var_4_1[(iter_4_0 - 1) * 4 + iter_4_1], var_4_11:Find("repair" .. iter_4_1), iter_4_1 == 1 and 0 or var_4_1[(iter_4_0 - 1) * 4 + iter_4_1 - 1], iter_4_1 >= 4)
		...
		local var_4_18 = var_4_17:isFinish() and not var_4_17:isReceive()

		setActive(var_4_12:Find("get"), var_4_18)
		setActive(var_4_12:Find("got"), var_4_17:isReceive())
		onButton(arg_4_0, var_4_12, function()
			arg_4_0:emit(ActivityMediator.ON_TASK_SUBMIT, var_4_0:getTaskById(var_4_8[iter_4_0]))
		...
		if not var_4_17:isFinish() then
			local var_4_19 = var_4_0:getTaskById(var_4_8[iter_4_0])

			setText(var_4_11:Find("gear/test_bg/Text"), var_4_2:getVirtualItemNumber(tonumber(var_4_19:getConfig("target_id"))) .. "/" .. var_4_19:getConfig("target_num"))
		end

		local var_4_20 = var_4_8[iter_4_0]
		local var_4_21 = var_4_8[iter_4_0] and (var_4_0:getTaskById(var_4_20) or var_4_0:getFinishTaskById(var_4_20)) or nil

		setButtonEnabled(var_4_12, var_4_21 and var_4_21:isFinish())
		setActive(var_4_12:Find("mask"), var_4_21 and var_4_21:isFinish())
	end

	local var_4_22 = var_4_4:Find("btn_main")
	local var_4_23 = var_4_0:getTaskById(var_4_1[#var_4_1]) or var_4_0:getFinishTaskById(var_4_1[#var_4_1])

	var_4_22:GetComponent(typeof(Image)).enabled = not var_4_23:isFinish()

	local var_4_24 = var_4_23:isFinish() and not var_4_23:isReceive()

	setActive(var_4_22:Find("get"), var_4_24)
	setActive(var_4_22:Find("got"), var_4_23:isReceive())
	onButton(arg_4_0, var_4_22, function()
		if not var_4_23:isFinish() then
			...
			arg_4_0:emit(ActivityMediator.ON_TASK_SUBMIT, var_4_23)
		end

		return
	end, SFX_PANEL)
	setButtonEnabled(var_4_22, not var_4_23:isReceive())
	arg_4_0:set_mikasa_btn(var_4_1[#var_4_1], var_4_4:Find("repair_main"), 0, true, arg_4_1:getConfig("config_client").story)

	for iter_4_2 = 1, 4 do
		setActive(var_4_4:Find("repair_phase/point" .. iter_4_2), iter_4_2 <= var_4_23:getProgress())

		if iter_4_2 > 1 then
			setActive(var_4_4:Find("repair_phase/line" .. iter_4_2 - 1), iter_4_2 <= var_4_23:getProgress())
		end
	end

	setText(var_4_4:Find("repair_phase/Text"), var_4_23:getProgress() .. "/4")
	...
	if var_9_1:getConfig("sub_type") == 90 and arg_9_5 then
		for iter_9_0, iter_9_1 in ipairs(arg_9_5) do
			if iter_9_1[1] == arg_9_1 and iter_9_1[2] == var_9_1:getProgress() then
				...
				if not var_9_5:IsPlayed(iter_9_1[3]) then
