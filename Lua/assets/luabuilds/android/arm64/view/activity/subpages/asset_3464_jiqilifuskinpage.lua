local JiqilifuSkinPage = class("JiqilifuSkinPage", import(".DachaolifuSkinPage"))

function JiqilifuSkinPage:OnInit()
	JiqilifuSkinPage.super.OnInit(self)
...
function JiqilifuSkinPage:OnFirstFlush()
...
function JiqilifuSkinPage:OnUpdateFlush()
	JiqilifuSkinPage.super.OnUpdateFlush(self)
	setText(self.step_txt, setColorStr(self.nday, "#6CF7C1FF") .. "/" .. #self.taskGroup)

	return
end

return JiqilifuSkinPage
