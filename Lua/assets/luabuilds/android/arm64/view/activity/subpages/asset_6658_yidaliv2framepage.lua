local YidaliV2framePage = class("YidaliV2framePage", import(".TemplatePage.PtTemplatePage"))

function YidaliV2framePage:OnFirstFlush()
	YidaliV2framePage.super.OnFirstFlush(self)
...
function YidaliV2framePage:Switch(arg_4_1)
...
function YidaliV2framePage:UpdateAwardGot()
	local var_7_0 = not self.ptData:CanGetNextAward() and self.inPhase2

	setActive(self.bg:Find("switcher/phase2/got"), var_7_0)
	setActive(self.step, not var_7_0)
	setActive(self.progress, not var_7_0)

	return
end

function YidaliV2framePage:OnUpdateFlush()
	YidaliV2framePage.super.OnUpdateFlush(self)
	...
	setText(self.step, var_8_2 >= 1 and setColorStr(var_8_0, COLOR_GREEN) or var_8_0)
