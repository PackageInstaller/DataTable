local PassChaptersTemplatePage = class("PassChaptersTemplatePage", import("view.base.BaseActivityPage"))

function PassChaptersTemplatePage:OnInit()
...
function PassChaptersTemplatePage:OnDataSetting()
...
function PassChaptersTemplatePage:OnFirstFlush()
...
function PassChaptersTemplatePage:OnUpdateFlush()
...
function PassChaptersTemplatePage:OnDestroy()
	return
end

return PassChaptersTemplatePage
