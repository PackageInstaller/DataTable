local LoginTemplatePage = class("LoginTemplatePage", import("view.base.BaseActivityPage"))

function LoginTemplatePage:OnInit()
...
function LoginTemplatePage:OnDataSetting()
...
function LoginTemplatePage:OnFirstFlush()
...
function LoginTemplatePage:OnUpdateFlush()
...
function LoginTemplatePage:OnDestroy()
