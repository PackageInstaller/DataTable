...
function var_0_0.findUI(arg_2_0)
	...
	for iter_2_0 = 0, arg_2_0.btnContainer.childCount / var_0_1 - 1 do
		arg_2_0.btnList1[iter_2_0 + 1] = arg_2_0.btnContainer:GetChild(iter_2_0)
	end

	arg_2_0.btnList2 = {}

	for iter_2_1 = arg_2_0.btnContainer.childCount / var_0_1, 2 * (arg_2_0.btnContainer.childCount / var_0_1) - 1 do
		arg_2_0.btnList2[#arg_2_0.btnList2 + 1] = arg_2_0.btnContainer:GetChild(iter_2_1)
	end

	arg_2_0.btnList3 = {}

	for iter_2_2 = arg_2_0.btnContainer.childCount / var_0_1 * 2, 3 * (arg_2_0.btnContainer.childCount / var_0_1) - 1 do
		arg_2_0.btnList3[#arg_2_0.btnList3 + 1] = arg_2_0.btnContainer:GetChild(iter_2_2)
	end

	for iter_2_3 = 1, arg_2_0.btnContainer.childCount / var_0_1 * var_0_1 do
...
function var_0_0.initPaint(arg_9_0)
	setImageSprite(arg_9_0.paintFrontTF, LoadSprite(arg_9_0.paintPathPrefix .. arg_9_0.paintNamePrefix .. arg_9_0.curPaintIndex, arg_9_0.paintNamePrefix .. arg_9_0.curPaintIndex))
	setImageSprite(arg_9_0.paintBackTF, LoadSprite(arg_9_0.paintPathPrefix .. arg_9_0.paintNamePrefix .. (arg_9_0.curPaintIndex - 1) % arg_9_0.paintCount + 1, arg_9_0.paintNamePrefix .. (arg_9_0.curPaintIndex - 1) % arg_9_0.paintCount + 1))
