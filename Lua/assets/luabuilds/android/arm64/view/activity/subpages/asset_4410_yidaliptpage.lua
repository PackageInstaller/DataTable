local YidaliPTPage = class("YidaliPTPage", import(".TemplatePage.PtTemplatePage"))

function YidaliPTPage:OnInit()
	YidaliPTPage.super.OnInit(self)
...
function YidaliPTPage:OnUpdateFlush()
