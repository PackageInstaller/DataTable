local XiaoKeWeiPtPage = class("XiaoKeWeiPtPage", import(".TemplatePage.PtTemplatePage"))

function XiaoKeWeiPtPage:OnInit()
	XiaoKeWeiPtPage.super.OnInit(self)
...
function XiaoKeWeiPtPage:OnFirstFlush()
	XiaoKeWeiPtPage.super.OnFirstFlush(self)
...
function XiaoKeWeiPtPage:OnUpdateFlush()
	XiaoKeWeiPtPage.super.OnUpdateFlush(self)
