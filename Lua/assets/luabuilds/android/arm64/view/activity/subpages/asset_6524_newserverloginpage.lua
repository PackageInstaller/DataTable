local NewServerLoginPage = class("NewServerLoginPage", import("...base.BaseActivityPage"))

function NewServerLoginPage:OnInit()
...
function NewServerLoginPage:OnDataSetting()
...
function NewServerLoginPage:OnFirstFlush()
...
function NewServerLoginPage:OnUpdateFlush()
...
function NewServerLoginPage:OnDestroy()
