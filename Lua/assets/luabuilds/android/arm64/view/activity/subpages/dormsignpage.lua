...
function var_0_0.OnFirstFlush(arg_7_0)
	arg_7_0.uilist:make(function(arg_8_0, arg_8_1, arg_8_2)
		...
		elseif arg_8_0 == UIItemList.EventUpdate then
			...
			setActive(arg_8_2:Find("tip"), arg_7_0.taskDic[arg_7_0.taskGroup[arg_8_1 + 1]] and arg_7_0.taskDic[arg_7_0.taskGroup[arg_8_1 + 1]]:getTaskStatus() == 1 and not arg_7_0.taskDic[arg_7_0.taskGroup[arg_8_1 + 1]]:isOver())
		end
