local MarseillaiseSpPage = class("MarseillaiseSpPage", import(".TemplatePage.SpTemplatePage"))
local var_0_1 = Vector2(225, -270)
local var_0_2 = Vector2(515, -270)

function MarseillaiseSpPage:OnFirstFlush()
	MarseillaiseSpPage.super.OnFirstFlush(self)
