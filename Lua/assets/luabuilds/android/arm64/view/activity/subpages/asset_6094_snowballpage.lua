local SnowballPage = class("SnowballPage", import("...base.BaseActivityPage"))
local var_0_1 = 14
local var_0_2 = 18
...
function SnowballPage:OnFirstFlush()
	self:SetData()
...
function SnowballPage:UpdateSigned()
...
function SnowballPage:CheckGet()
