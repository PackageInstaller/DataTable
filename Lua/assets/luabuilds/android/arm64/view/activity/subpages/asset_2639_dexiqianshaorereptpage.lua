local DeXiQianShaoReRePtPage = class("DeXiQianShaoReRePtPage", import(".TemplatePage.NewFrameTemplatePage"))

function DeXiQianShaoReRePtPage:OnInit()
	...
	self.bar = self._tf:Find("AD/item/bar")
	self.cur = self._tf:Find("AD/item/step")
	self.target = self._tf:Find("AD/item/progress")
	self.gotTag = self._tf:Find("AD/item/got")

	return
end

function DeXiQianShaoReRePtPage:OnFirstFlush()
