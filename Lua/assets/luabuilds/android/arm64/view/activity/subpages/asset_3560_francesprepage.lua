local FranceSpRePage = class("FranceSpRePage", import("...base.BaseActivityPage"))

function FranceSpRePage:OnInit()
...
function FranceSpRePage:OnDataSetting()
...
function FranceSpRePage:OnFirstFlush()
...
function FranceSpRePage:OnUpdateFlush()
...
function FranceSpRePage:OnDestroy()
	return
end

return FranceSpRePage
