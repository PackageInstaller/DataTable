local MeixiT2FramePage = class("MeixiT2FramePage", import(".TemplatePage.NewFrameTemplatePage"))

function MeixiT2FramePage:OnFirstFlush()
	...
	MeixiT2FramePage.super.OnFirstFlush(self)

	return
end

function MeixiT2FramePage:Switch(arg_2_1)
