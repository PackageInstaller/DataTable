local TecCatchupTemplatePage = class("TecCatchupTemplatePage", import("view.base.BaseActivityPage"))

function TecCatchupTemplatePage:OnInit()
...
function TecCatchupTemplatePage:OnDataSetting()
...
function TecCatchupTemplatePage:OnFirstFlush()
	local var_3_0 = {
		type = DROP_TYPE_ITEM,
		id = self.itemID
	}
...
function TecCatchupTemplatePage:OnUpdateFlush()
