local TowerClimbingSignPage = class("TowerClimbingSignPage", import("...base.BaseActivityPage"))

function TowerClimbingSignPage:OnInit()
	self.icons = {
...
function TowerClimbingSignPage:SetData()
...
function TowerClimbingSignPage:OnFirstFlush()
	self:SetData()
...
function TowerClimbingSignPage:UpdateSigned()
...
function TowerClimbingSignPage:CheckGet()
