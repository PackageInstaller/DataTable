local XiaoAnKeLeiPtPage = class("XiaoAnKeLeiPtPage", import(".TemplatePage.PtTemplatePage"))

function XiaoAnKeLeiPtPage:OnInit()
	XiaoAnKeLeiPtPage.super.OnInit(self)
...
function XiaoAnKeLeiPtPage:OnFirstFlush()
	XiaoAnKeLeiPtPage.super.OnFirstFlush(self)
...
function XiaoAnKeLeiPtPage:OnUpdateFlush()
	XiaoAnKeLeiPtPage.super.OnUpdateFlush(self)
