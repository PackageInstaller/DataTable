local FourthAnniversaryPage = class("FourthAnniversaryPage", import("...base.BaseActivityPage"))

function FourthAnniversaryPage:OnInit()
	self.hideIndex = {}
...
function FourthAnniversaryPage:findUI()
	...
	for iter_2_3 = 1, self.btnContainer.childCount / 3 * 3 do
		if table.contains(self.hideIndex, iter_2_3 % 6) or not self.scrollAble and iter_2_3 > 6 then
...
function FourthAnniversaryPage:initData()
	self.paintCount = 9
...
function FourthAnniversaryPage:switchNextPaint()
...
function FourthAnniversaryPage:OnFirstFlush()
...
function FourthAnniversaryPage:initPaint()
...
function FourthAnniversaryPage:initBtnList(arg_10_1)
	...
	onButton(self, arg_10_1[3], function()
		self:emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.ACTIVITY_TYPE_RETURN_AWARD_ID4)
	...
	onButton(self, arg_10_1[5], function()
		self:emit(ActivityMediator.EVENT_GO_SCENE, SCENE.AMUSEMENT_PARK)

		return
	end, SFX_PANEL)
	onButton(self, arg_10_1[6], function()
		self:emit(ActivityMediator.GO_MINI_GAME, 23)
...
function FourthAnniversaryPage:initTimer()
...
function FourthAnniversaryPage:OnDestroy()
