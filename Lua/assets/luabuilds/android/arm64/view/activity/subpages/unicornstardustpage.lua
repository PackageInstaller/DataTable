local var_0_0 = class("UnicornStardustPage", import("view.base.BaseActivityPage"))

function var_0_0.OnInit(arg_1_0)
	arg_1_0.bg = arg_1_0._tf:Find("AD")
	arg_1_0.textProgress = arg_1_0.bg:Find("progress_text")
	arg_1_0.btnGo = arg_1_0.bg:Find("btn_go")
	arg_1_0.got = arg_1_0.bg:Find("got")
...
function var_0_0.OnUpdateFlush(arg_5_0)
	...
	setButtonEnabled(arg_5_0.btnGo, arg_5_0.taskIndex < #arg_5_0.taskList)
	setActive(arg_5_0.got, arg_5_0.taskIndex == #arg_5_0.taskList)
