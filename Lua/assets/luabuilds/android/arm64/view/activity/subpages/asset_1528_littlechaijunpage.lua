local LittleChaijunPage = class("LittleChaijunPage", import(".TemplatePage.PtTemplatePage"))

function LittleChaijunPage:OnInit()
	LittleChaijunPage.super.OnInit(self)
...
function LittleChaijunPage:OnUpdateFlush()
	LittleChaijunPage.super.OnUpdateFlush(self)
...
function LittleChaijunPage:updataTask()
...
function LittleChaijunPage:OnFirstFlush()
	LittleChaijunPage.super.OnFirstFlush(self)
...
function LittleChaijunPage:initTask()
	...
	local var_9_0 = pg.activity_template[self.activity:getConfig("config_client").task_act_id].config_data
...
function LittleChaijunPage:updateTaskUI()
...
function LittleChaijunPage:updateTaskList(arg_11_1, arg_11_2, arg_11_3, arg_11_4)
...
function LittleChaijunPage:changeGroupOpening(arg_16_1)
...
function LittleChaijunPage:getTaskTfFromPool()
...
function LittleChaijunPage:getTaskGroup(arg_18_1, arg_18_2)
...
function LittleChaijunPage:insertTaskToGroup(arg_19_1, arg_19_2, arg_19_3)
...
function LittleChaijunPage:sortTaskGroups()
...
function LittleChaijunPage:OnDestroy()
	if LeanTween.isTweening(go(self.slider)) then
		LeanTween.cancel(go(self.slider))
	end
