local StarSeaFramePage = class("StarSeaFramePage", import(".TemplatePage.NewFrameTemplatePage"))

function StarSeaFramePage:OnFirstFlush()
	...
	StarSeaFramePage.super.OnFirstFlush(self)
	GetComponent(self._tf:Find("AD/switcher/phase2/Image"), typeof(Image)):SetNativeSize()
	GetComponent(self._tf:Find("AD/switcher/phase1/Image"), typeof(Image)):SetNativeSize()

	return
end

function StarSeaFramePage:Switch(arg_2_1)
