local ExpeditionSkinPage = class("ExpeditionSkinPage", import(".TemplatePage.SkinTemplatePage"))

function ExpeditionSkinPage:OnDataSetting()
	self.nday = 0
...
function ExpeditionSkinPage:OnUpdateFlush()
...
function ExpeditionSkinPage:PlayStory()
...
function ExpeditionSkinPage:GetProgressColor()
	return "#b9b49c"
end

return ExpeditionSkinPage
