local AnniversarySevenLoginPage = class("AnniversarySevenLoginPage", import(".TemplatePage.LoginTemplatePage"))

function AnniversarySevenLoginPage:OnFirstFlush()
...
function AnniversarySevenLoginPage:OnUpdateFlush()
	AnniversarySevenLoginPage.super.OnUpdateFlush(self)
	setText(self.bg:Find("Text"), self.nday .. "/" .. self.Day)

	return
end

return AnniversarySevenLoginPage
