local EighthHotSpringMediator = class("EighthHotSpringMediator", import("view.activity.BackHills.NewYearFestival.NewYearHotSpringMediator"))

function EighthHotSpringMediator:register()
	self:bind(EighthHotSpringMediator.UNLOCK_SLOT, function(arg_2_0, arg_2_1)
	...
	self:bind(EighthHotSpringMediator.OPEN_CHUANWU, function(arg_4_0, arg_4_1, arg_4_2)
	...
	self:bind(EighthHotSpringMediator.OPEN_INFO, function()
...
return EighthHotSpringMediator
