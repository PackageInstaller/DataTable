local SkinGuide2Page = class("SkinGuide2Page", import("...base.BaseActivityPage"))

function SkinGuide2Page:OnInit()
...
function SkinGuide2Page:OnDataSetting()
...
function SkinGuide2Page:RefreshData()
...
function SkinGuide2Page:OnFirstFlush()
...
function SkinGuide2Page:OnUpdateFlush()
	local var_8_0 = 0
	local var_8_1 = {}
...
function SkinGuide2Page:SelectPage(arg_9_1)
...
function SkinGuide2Page:OnDestroy()
