local LaFeiUrExchangeTemplatePage = class("LaFeiUrExchangeTemplatePage", import(".TemplatePage.UrExchangeTemplatePage"))

LaFeiUrExchangeTemplatePage.SP_FIRST = 1
LaFeiUrExchangeTemplatePage.SP_DAILY = 2
LaFeiUrExchangeTemplatePage.RANDOM_DAILY = 3
LaFeiUrExchangeTemplatePage.CHALLANGE = 4
LaFeiUrExchangeTemplatePage.MINI_GAME = 5
LaFeiUrExchangeTemplatePage.SHOP_BUY = 6

local function var_0_1(...)
	return
end

function LaFeiUrExchangeTemplatePage:OnInit()
...
function LaFeiUrExchangeTemplatePage:OnDataSetting()
...
function LaFeiUrExchangeTemplatePage:OnFirstFlush()
...
function LaFeiUrExchangeTemplatePage:CheckSingleTask()
...
LaFeiUrExchangeTemplatePage.taskTypeDic = {
	[LaFeiUrExchangeTemplatePage.SP_FIRST] = function(arg_14_0, arg_14_1)
		local var_14_0 = LaFeiUrExchangeTemplatePage.CheckSingleTask(arg_14_1[1]) == 2 and 1 or 0
	...
	[LaFeiUrExchangeTemplatePage.SP_DAILY] = function(arg_16_0, arg_16_1)
	...
	[LaFeiUrExchangeTemplatePage.RANDOM_DAILY] = function(arg_18_0, arg_18_1)
		local var_18_0
		...
		for iter_18_0, iter_18_1 in pairs(arg_18_1) do
			local var_18_4 = LaFeiUrExchangeTemplatePage.CheckSingleTask(iter_18_1)
	...
	[LaFeiUrExchangeTemplatePage.CHALLANGE] = function(arg_20_0, arg_20_1)
		local var_20_0 = 0
		local var_20_1

		for iter_20_0, iter_20_1 in pairs(arg_20_1) do
			local var_20_2 = LaFeiUrExchangeTemplatePage.CheckSingleTask(iter_20_1) == 2 and 1 or 0
	...
	[LaFeiUrExchangeTemplatePage.MINI_GAME] = function(arg_22_0, arg_22_1)
	...
	[LaFeiUrExchangeTemplatePage.SHOP_BUY] = function(arg_24_0, arg_24_1)
...
function LaFeiUrExchangeTemplatePage:UpdateTask(arg_26_1, arg_26_2)
	...
	local var_26_1, var_26_2 = LaFeiUrExchangeTemplatePage.taskTypeDic[self.taskConfig[arg_26_1 + 1][1]](self, self.taskConfig[arg_26_1 + 1][3])
...
function LaFeiUrExchangeTemplatePage:OnUpdateFlush()
	var_0_1("updateFlush")
...
function LaFeiUrExchangeTemplatePage:GetGoodsResCnt(arg_29_1)
	return self.actShop:GetCommodityById(arg_29_1):GetPurchasableCnt()
end

function LaFeiUrExchangeTemplatePage:UpdateExchangeStatus()
...
function LaFeiUrExchangeTemplatePage:UpdatePtCount()
...
function LaFeiUrExchangeTemplatePage:OnDestroy()
...
return LaFeiUrExchangeTemplatePage
