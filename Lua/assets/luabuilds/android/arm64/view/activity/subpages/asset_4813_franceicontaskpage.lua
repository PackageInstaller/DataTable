local FranceIconTaskPage = class("FranceIconTaskPage", import(".TemplatePage.PtTemplatePage"))

function FranceIconTaskPage:OnFirstFlush()
	FranceIconTaskPage.super.OnFirstFlush(self)
...
function FranceIconTaskPage:Switch(arg_4_1)
...
function FranceIconTaskPage:UpdateAwardGot()
	setActive(self.bg:Find("switcher/phase2/got"), not self.ptData:CanGetNextAward() and self.inPhase2)

	return
end

function FranceIconTaskPage:OnUpdateFlush()
	FranceIconTaskPage.super.OnUpdateFlush(self)
	...
	setText(self.step, var_10_2 >= 1 and setColorStr(var_10_0, "#487CFFFF") or var_10_0)
