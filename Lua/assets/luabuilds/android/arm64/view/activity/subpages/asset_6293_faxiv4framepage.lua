local FaxiV4FramePage = class("FaxiV4FramePage", import(".TemplatePage.NewFrameTemplatePage"))

function FaxiV4FramePage:OnInit()
	FaxiV4FramePage.super.OnInit(self)
...
function FaxiV4FramePage:OnUpdateFlush()
...
function FaxiV4FramePage:Switch(arg_3_1)
