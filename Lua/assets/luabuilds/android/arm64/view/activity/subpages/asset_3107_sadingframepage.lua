local SaDingFramePage = class("SaDingFramePage", import(".TemplatePage.NewFrameTemplatePage"))

function SaDingFramePage:OnInit()
	SaDingFramePage.super.OnInit(self)
...
function SaDingFramePage:OnUpdateFlush()
...
function SaDingFramePage:Switch(arg_3_1)
