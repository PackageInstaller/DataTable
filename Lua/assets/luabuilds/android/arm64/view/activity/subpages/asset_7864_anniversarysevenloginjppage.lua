local AnniversarySevenLoginJPPage = class("AnniversarySevenLoginJPPage", import(".TemplatePage.LoginTemplatePage"))

function AnniversarySevenLoginJPPage:OnFirstFlush()
...
function AnniversarySevenLoginJPPage:OnUpdateFlush()
	AnniversarySevenLoginJPPage.super.OnUpdateFlush(self)
	setText(self.bg:Find("Text"), self.nday .. "/" .. self.Day)

	return
end

return AnniversarySevenLoginJPPage
