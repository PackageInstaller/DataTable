local MeixiV5FramePage = class("MeixiV5FramePage", import(".TemplatePage.NewFrameTemplatePage"))

function MeixiV5FramePage:OnInit()
	MeixiV5FramePage.super.OnInit(self)
...
function MeixiV5FramePage:OnUpdateFlush()
...
function MeixiV5FramePage:Switch(arg_3_1)
