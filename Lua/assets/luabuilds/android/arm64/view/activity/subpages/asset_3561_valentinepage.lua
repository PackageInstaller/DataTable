local ValentinePage = class("ValentinePage", import(".TemplatePage.LoginTemplatePage"))

function ValentinePage:OnInit()
	ValentinePage.super.OnInit(self)
...
function ValentinePage:OnFirstFlush()
...
function ValentinePage:OnUpdateFlush()
