local Spring23SkinGuidePage = class("Spring23SkinGuidePage", import("...base.BaseActivityPage"))
local var_0_1 = "ui/activityuipage/spring23skinguidepage_atlas"

function Spring23SkinGuidePage:OnInit()
...
function Spring23SkinGuidePage:OnDataSetting()
...
function Spring23SkinGuidePage:OnFirstFlush()
...
function Spring23SkinGuidePage:OnUpdateFlush()
	local var_7_0 = 0
	...
	setImageSprite(self.countImg, GetSpriteFromAtlas(var_0_1, tostring(self.remainCnt)), true)
...
function Spring23SkinGuidePage:OnShowFlush()
...
function Spring23SkinGuidePage:OnDestroy()
	return
end

return Spring23SkinGuidePage
