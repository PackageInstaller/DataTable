local RyzaPtPage = class("RyzaPtPage", import(".TemplatePage.PtTemplatePage"))
local var_0_1 = 9

function RyzaPtPage:OnInit()
	RyzaPtPage.super.OnInit(self)
...
function RyzaPtPage:OnFirstFlush()
	RyzaPtPage.super.OnFirstFlush(self)
	self:InitAnimData()
...
function RyzaPtPage:OnUpdateFlush()
	RyzaPtPage.super.OnUpdateFlush(self)
...
function RyzaPtPage:UpdateSpineIdle(arg_8_1)
...
function RyzaPtPage:PlayIdleFeedAnim(arg_9_1, arg_9_2)
	self:PlayKalaAnim()
...
function RyzaPtPage:PlayFeedAnim(arg_11_1)
...
function RyzaPtPage:PlayKalaAnim(arg_13_1)
...
function RyzaPtPage:PlayPuniChangeAnim(arg_15_1)
...
function RyzaPtPage:InitAnimData()
...
function RyzaPtPage:GetAnimName(arg_18_1)
...
function RyzaPtPage:OnShowFlush()
