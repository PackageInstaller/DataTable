local SleeplessCityRePage = class("SleeplessCityRePage", import(".TemplatePage.PtTemplatePage"))

SleeplessCityRePage.COLOR = "#BD3F40"

function SleeplessCityRePage:OnFirstFlush()
	SleeplessCityRePage.super.OnFirstFlush(self)
...
function SleeplessCityRePage:OnUpdateFlush()
	...
	setText(self.progress, (var_6_6 >= 1 and setColorStr(var_6_4, COLOR_GREEN) or setColorStr(var_6_4, SleeplessCityRePage.COLOR)) .. "/" .. var_6_5)
