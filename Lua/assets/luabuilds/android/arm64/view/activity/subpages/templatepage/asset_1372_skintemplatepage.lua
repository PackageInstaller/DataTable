local SkinTemplatePage = class("SkinTemplatePage", import("view.base.BaseActivityPage"))

function SkinTemplatePage:OnInit()
...
function SkinTemplatePage:OnDataSetting()
	self.nday = 0
...
function SkinTemplatePage:OnFirstFlush()
...
function SkinTemplatePage:UpdateTask(arg_5_1, arg_5_2)
...
function SkinTemplatePage:OnUpdateFlush()
...
function SkinTemplatePage:PlayStory()
...
function SkinTemplatePage:OnDestroy()
...
function SkinTemplatePage:GetProgressColor()
	return nil
end

return SkinTemplatePage
