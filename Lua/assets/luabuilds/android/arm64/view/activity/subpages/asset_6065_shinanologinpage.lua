local ShinanoLoginPage = class("ShinanoLoginPage", import(".TemplatePage.LoginTemplatePage"))

function ShinanoLoginPage:OnInit()
	ShinanoLoginPage.super.OnInit(self)
...
function ShinanoLoginPage:OnFirstFlush()
...
function ShinanoLoginPage:OnUpdateFlush()
	ShinanoLoginPage.super.OnUpdateFlush(self)
	setFillAmount(self.bar, self.nday / self.Day)

	return
end

function ShinanoLoginPage:OnDestroy()
	return
end

return ShinanoLoginPage
