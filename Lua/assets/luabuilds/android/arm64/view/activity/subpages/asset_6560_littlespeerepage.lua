local LittleSpeeRePage = class("LittleSpeeRePage", import(".TemplatePage.PtTemplatePage"))

LittleSpeeRePage.FILL_ANI_TIME = 0.5
LittleSpeeRePage.IMAGE_ANI_TIME = 0.5
LittleSpeeRePage.IMAGE_MAX_SCALE = Vector3(2, 2, 2)
LittleSpeeRePage.TEXT_ANI_TIME = 0.3
LittleSpeeRePage.TEXT_MAX_SCALE = Vector3(3, 3, 3)

function LittleSpeeRePage:OnInit()
	LittleSpeeRePage.super.OnInit(self)
...
function LittleSpeeRePage:OnFirstFlush()
	LittleSpeeRePage.super.OnFirstFlush(self)
...
function LittleSpeeRePage:OnUpdateFlush()
	LittleSpeeRePage.super.OnUpdateFlush(self)
	...
	if var_10_0 == var_10_1 then
		...
		if not var_10_4 and var_10_2 then
			...
			self:managedTween(LeanTween.scale, nil, self.performImage, LittleSpeeRePage.IMAGE_MAX_SCALE, LittleSpeeRePage.IMAGE_ANI_TIME)
			self:managedTween(LeanTween.alphaCanvas, nil, GetOrAddComponent(self.performImage, typeof(CanvasGroup)), 1, LittleSpeeRePage.IMAGE_ANI_TIME / 2):setFrom(0)
			self:managedTween(LeanTween.delayedCall, function()
				self:managedTween(LeanTween.alphaCanvas, nil, GetOrAddComponent(self.performImage, typeof(CanvasGroup)), 0, LittleSpeeRePage.IMAGE_ANI_TIME / 2)

				return
			end, LittleSpeeRePage.IMAGE_ANI_TIME / 2, nil)
			setLocalScale(self.performText, LittleSpeeRePage.TEXT_MAX_SCALE)
			self:managedTween(LeanTween.scale, nil, self.performText, Vector3.one, LittleSpeeRePage.TEXT_ANI_TIME)
			self:managedTween(LeanTween.alphaCanvas, nil, GetOrAddComponent(self.performText, typeof(CanvasGroup)), 1, LittleSpeeRePage.TEXT_ANI_TIME):setFrom(0)
		else
			setActive(self.performBtn, false)
		end
	end
...
function LittleSpeeRePage:OnGetBtnClick()
	...
	table.insert(var_12_0, function(arg_14_0)
		...
		self:managedTween(LeanTween.value, nil, go(var_14_0), 0, 1, LittleSpeeRePage.FILL_ANI_TIME):setOnUpdate(System.Action_float(function(arg_15_0)
