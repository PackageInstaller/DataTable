local YidaliV4FramePage = class("YidaliV4FramePage", import(".TemplatePage.NewFrameTemplatePage"))

function YidaliV4FramePage:OnFirstFlush()
	...
	YidaliV4FramePage.super.OnFirstFlush(self)

	return
end

function YidaliV4FramePage:Switch(arg_2_1)
