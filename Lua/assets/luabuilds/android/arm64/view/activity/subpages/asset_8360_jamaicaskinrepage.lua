local JamaicaSkinRePage = class("JamaicaSkinRePage", import("...base.BaseActivityPage"))

function JamaicaSkinRePage:OnInit()
...
function JamaicaSkinRePage:OnDataSetting()
...
function JamaicaSkinRePage:OnFirstFlush()
...
function JamaicaSkinRePage:OnUpdateFlush()
...
function JamaicaSkinRePage:OnDestroy()
	return
end

return JamaicaSkinRePage
