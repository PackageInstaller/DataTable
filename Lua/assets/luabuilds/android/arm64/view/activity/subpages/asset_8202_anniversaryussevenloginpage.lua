local AnniversaryUSSevenLoginPage = class("AnniversaryUSSevenLoginPage", import(".TemplatePage.LoginTemplatePage"))

function AnniversaryUSSevenLoginPage:OnFirstFlush()
	...
	setActive(self.bg:Find("btn_more"), false)
...
function AnniversaryUSSevenLoginPage:OnUpdateFlush()
	AnniversaryUSSevenLoginPage.super.OnUpdateFlush(self)
	setText(self.bg:Find("Text"), self.nday .. "/" .. self.Day)

	return
end

return AnniversaryUSSevenLoginPage
