local LittleDaihoRePage = class("LittleDaihoRePage", import(".TemplatePage.PtTemplatePage"))

function LittleDaihoRePage:OnInit()
	LittleDaihoRePage.super.OnInit(self)
...
function LittleDaihoRePage:OnFirstFlush()
	LittleDaihoRePage.super.OnFirstFlush(self)
...
function LittleDaihoRePage:OnUpdateFlush()
	LittleDaihoRePage.super.OnUpdateFlush(self)
	self.itemList:align(self.ptData:GetLevel())

	local var_10_0, var_10_1, var_10_2 = self.ptData:GetResProgress()

	setText(self.progress, (var_10_2 >= 1 and setColorStr(var_10_0, "#9F413AFF") or var_10_0) .. "/" .. var_10_1)

	return
end

return LittleDaihoRePage
