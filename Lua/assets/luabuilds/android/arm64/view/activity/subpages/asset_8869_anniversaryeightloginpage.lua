local AnniversaryEightLoginPage = class("AnniversaryEightLoginPage", import(".TemplatePage.LoginTemplatePage"))

function AnniversaryEightLoginPage:OnFirstFlush()
...
function AnniversaryEightLoginPage:OnUpdateFlush()
	AnniversaryEightLoginPage.super.OnUpdateFlush(self)
	setText(self.bg:Find("Text"), self.nday .. "/" .. self.Day)

	return
end

return AnniversaryEightLoginPage
