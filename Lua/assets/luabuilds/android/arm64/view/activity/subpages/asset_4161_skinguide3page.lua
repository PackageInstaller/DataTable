local SkinGuide3Page = class("SkinGuide3Page", import("...base.BaseActivityPage"))
local var_0_2 = {
	{
		50,
		-50
...
function SkinGuide3Page:OnInit()
...
function SkinGuide3Page:OnDataSetting()
...
function SkinGuide3Page:OnFirstFlush()
...
function SkinGuide3Page:OnUpdateFlush()
	local var_7_0 = 0
...
function SkinGuide3Page:OnShowFlush()
...
function SkinGuide3Page:OnDestroy()
	return
end

return SkinGuide3Page
