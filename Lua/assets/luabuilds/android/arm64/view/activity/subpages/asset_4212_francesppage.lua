local FranceSpPage = class("FranceSpPage", import("...base.BaseActivityPage"))

function FranceSpPage:OnInit()
...
function FranceSpPage:OnDataSetting()
...
function FranceSpPage:OnFirstFlush()
...
function FranceSpPage:OnUpdateFlush()
...
function FranceSpPage:OnDestroy()
	return
end
