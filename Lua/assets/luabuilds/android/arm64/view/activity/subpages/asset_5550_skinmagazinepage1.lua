local SkinMagazinePage1 = class("SkinMagazinePage1", import("...base.BaseActivityPage"))

function SkinMagazinePage1:OnInit()
...
function SkinMagazinePage1:OnDataSetting()
...
function SkinMagazinePage1:RefreshData()
...
function SkinMagazinePage1:OnFirstFlush()
...
function SkinMagazinePage1:OnUpdateFlush()
	local var_8_0 = 0
	local var_8_1 = {}
...
function SkinMagazinePage1:SelectPage(arg_9_1)
...
function SkinMagazinePage1:OnDestroy()
