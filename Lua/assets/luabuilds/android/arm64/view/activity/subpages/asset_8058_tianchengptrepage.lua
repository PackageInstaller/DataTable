local TianChengPTRePage = class("TianChengPTRePage", import(".TemplatePage.PtTemplatePage"))

function TianChengPTRePage:OnInit()
	TianChengPTRePage.super.OnInit(self)
...
function TianChengPTRePage:OnUpdateFlush()
