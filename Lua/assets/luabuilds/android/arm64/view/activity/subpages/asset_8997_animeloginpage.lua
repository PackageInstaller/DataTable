local AnimeLoginPage = class("AnimeLoginPage", import(".TemplatePage.LoginTemplatePage"))

function AnimeLoginPage:OnInit()
...
function AnimeLoginPage:OnDataSetting()
...
function AnimeLoginPage:OnFirstFlush()
	return
end

function AnimeLoginPage:OnUpdateFlush()
	self.nday = self.activity.data1
	self.curShowDay = self.nday
...
function AnimeLoginPage:OnDestroy()
	return
end

function AnimeLoginPage:updateAwardInfo(arg_11_1)
	setImageSprite(self.dayProgressImg, GetSpriteFromAtlas("ui/activityuipage/animelogin_atlas", "tianshu_" .. arg_11_1), true)
	setImageSprite(self.awardImg, GetSpriteFromAtlas("ui/activityuipage/animelogin_atlas", "icon_" .. arg_11_1), true)
