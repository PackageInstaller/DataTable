local JapanFifthLoginPage = class("JapanFifthLoginPage", import(".TemplatePage.LoginTemplatePage"))

function JapanFifthLoginPage:OnFirstFlush()
...
function JapanFifthLoginPage:OnUpdateFlush()
	JapanFifthLoginPage.super.OnUpdateFlush(self)
	setText(self.bg:Find("Text"), self.nday .. "/" .. self.Day)

	return
end

return JapanFifthLoginPage
