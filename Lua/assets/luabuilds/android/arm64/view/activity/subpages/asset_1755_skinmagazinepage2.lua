local SkinMagazinePage2 = class("SkinMagazinePage2", import("...base.BaseActivityPage"))

SkinMagazinePage2.EXPAND_WIDTH = 973
SkinMagazinePage2.CLOSE_WIDTH = 216
SkinMagazinePage2.DURATION_PARAMETER = 2500
SkinMagazinePage2.TIP_KEY = "SkinMagazinePage2_tip"

function SkinMagazinePage2:OnInit()
...
function SkinMagazinePage2:OnDataSetting()
...
function SkinMagazinePage2:RefreshData()
...
function SkinMagazinePage2:OnFirstFlush()
	self.usedCnt = self.activity:getData1()

	self:RefreshData()
	setText(self.awardTf:Find("get/tip/Text"), i18n(SkinMagazinePage2.TIP_KEY))
	...
	for iter_4_1 = 1, self.items.childCount do
		...
		if iter_4_1 == self.index then
			var_4_0:GetComponent(typeof(LayoutElement)).preferredWidth = SkinMagazinePage2.EXPAND_WIDTH or SkinMagazinePage2.CLOSE_WIDTH
		end
...
function SkinMagazinePage2:OnUpdateFlush()
	local var_6_0 = 0
	local var_6_1 = {}
...
function SkinMagazinePage2:SelectItem(arg_7_1)
	...
	for iter_7_2 = 1, self.items.childCount do
		...
		if iter_7_2 == arg_7_1 then
			local var_7_3 = SkinMagazinePage2.EXPAND_WIDTH or SkinMagazinePage2.CLOSE_WIDTH

			if var_7_2 ~= var_7_3 then
				local var_7_4 = math.abs(var_7_3 - var_7_2) / SkinMagazinePage2.DURATION_PARAMETER
...
function SkinMagazinePage2:UpdateDrop()
...
function SkinMagazinePage2:OnDestroy()
