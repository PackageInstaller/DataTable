local EskiPtPage = class("EskiPtPage", import(".TemplatePage.PtTemplatePage"))

function EskiPtPage:OnInit()
	EskiPtPage.super.OnInit(self)
...
function EskiPtPage:OnUpdateFlush()
	...
	setText(self.progress_r, (var_2_7 >= 1 and setColorStr(var_2_5, COLOR_GREEN) or var_2_5) .. "/" .. var_2_6)
