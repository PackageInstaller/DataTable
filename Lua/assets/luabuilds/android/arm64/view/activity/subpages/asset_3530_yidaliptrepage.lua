local YidaliPTRePage = class("YidaliPTRePage", import(".TemplatePage.PtTemplatePage"))

function YidaliPTRePage:OnInit()
	YidaliPTRePage.super.OnInit(self)
...
function YidaliPTRePage:OnUpdateFlush()
	...
	setText(self.progress_l, var_2_7 >= 1 and setColorStr(var_2_5, COLOR_GREEN) or var_2_5)
	setText(self.progress_r, "/" .. var_2_6)
