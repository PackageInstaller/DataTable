local SkinGuide4Page = class("SkinGuide4Page", import("...base.BaseActivityPage"))
local var_0_2 = {
	{
		50,
		-50
...
function SkinGuide4Page:OnInit()
...
function SkinGuide4Page:OnDataSetting()
...
function SkinGuide4Page:OnFirstFlush()
...
function SkinGuide4Page:OnUpdateFlush()
	local var_7_0 = 0
...
function SkinGuide4Page:OnShowFlush()
	self.itemList:each(function(arg_9_0, arg_9_1)
...
function SkinGuide4Page:OnDestroy()
	return
end

return SkinGuide4Page
