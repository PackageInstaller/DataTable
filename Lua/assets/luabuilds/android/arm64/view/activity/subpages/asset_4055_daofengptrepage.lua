local DaofengPTRePage = class("DaofengPTRePage", import(".TemplatePage.PtTemplatePage"))

function DaofengPTRePage:OnUpdateFlush()
	DaofengPTRePage.super.OnUpdateFlush(self)
