local SkinMagazinePage3 = class("SkinMagazinePage3", import("...base.BaseActivityPage"))

SkinMagazinePage3.EXPAND_WIDTH = 839
SkinMagazinePage3.CLOSE_WIDTH = 146
SkinMagazinePage3.DURATION_PARAMETER = 1500
SkinMagazinePage3.TIP_KEY = "SkinMagazinePage2_tip"

function SkinMagazinePage3:OnInit()
...
function SkinMagazinePage3:OnDataSetting()
...
function SkinMagazinePage3:RefreshData()
...
function SkinMagazinePage3:OnFirstFlush()
	self.usedCnt = self.activity:getData1()

	self:RefreshData()
	setText(self.awardTf:Find("get/tip/Text"), i18n(SkinMagazinePage3.TIP_KEY))
	...
	for iter_4_1 = 1, self.items.childCount do
		...
		if iter_4_1 == self.index then
			var_4_0:GetComponent(typeof(LayoutElement)).preferredWidth = SkinMagazinePage3.EXPAND_WIDTH or SkinMagazinePage3.CLOSE_WIDTH
		end
...
function SkinMagazinePage3:OnUpdateFlush()
	local var_6_0 = 0
	local var_6_1 = {}
...
function SkinMagazinePage3:SelectItem(arg_7_1)
	...
	for iter_7_2 = 1, self.items.childCount do
		...
		if iter_7_2 == arg_7_1 then
			local var_7_3 = SkinMagazinePage3.EXPAND_WIDTH or SkinMagazinePage3.CLOSE_WIDTH

			if var_7_2 ~= var_7_3 then
				local var_7_4 = math.abs(var_7_3 - var_7_2) / SkinMagazinePage3.DURATION_PARAMETER
...
function SkinMagazinePage3:UpdateDrop()
...
function SkinMagazinePage3:OnDestroy()
