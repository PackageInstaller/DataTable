local LuyijiushiTecCatchupPage = class("LuyijiushiTecCatchupPage", import("...base.BaseActivityPage"))

function LuyijiushiTecCatchupPage:OnInit()
...
function LuyijiushiTecCatchupPage:OnDataSetting()
...
function LuyijiushiTecCatchupPage:OnFirstFlush()
	local var_3_0 = {
		type = DROP_TYPE_ITEM,
		id = self.itemID
	}
...
function LuyijiushiTecCatchupPage:OnUpdateFlush()
...
function LuyijiushiTecCatchupPage:OnDestroy()
	return
end

return LuyijiushiTecCatchupPage
