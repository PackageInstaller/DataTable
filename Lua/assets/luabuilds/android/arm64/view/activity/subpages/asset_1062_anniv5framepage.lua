local AnniV5FramePage = class("AnniV5FramePage", import(".TemplatePage.NewFrameTemplatePage"))

function AnniV5FramePage:OnInit()
	AnniV5FramePage.super.OnInit(self)
...
function AnniV5FramePage:OnUpdateFlush()
...
function AnniV5FramePage:Switch(arg_3_1)
