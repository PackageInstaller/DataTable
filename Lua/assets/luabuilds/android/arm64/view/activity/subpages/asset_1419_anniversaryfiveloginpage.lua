local AnniversaryFiveLoginPage = class("AnniversaryFiveLoginPage", import(".TemplatePage.LoginTemplatePage"))

function AnniversaryFiveLoginPage:OnFirstFlush()
...
function AnniversaryFiveLoginPage:OnUpdateFlush()
	AnniversaryFiveLoginPage.super.OnUpdateFlush(self)
	setText(self.bg:Find("Text"), self.nday .. "/" .. self.Day)

	return
end

return AnniversaryFiveLoginPage
