local JunZhuTecCatchupPage = class("JunZhuTecCatchupPage", import("...base.BaseActivityPage"))

function JunZhuTecCatchupPage:OnInit()
...
function JunZhuTecCatchupPage:OnDataSetting()
...
function JunZhuTecCatchupPage:OnFirstFlush()
	local var_3_0 = {
		count = 1,
		type = DROP_TYPE_ITEM,
		id = self.itemID
...
function JunZhuTecCatchupPage:OnUpdateFlush()
...
function JunZhuTecCatchupPage:OnDestroy()
	return
end

return JunZhuTecCatchupPage
