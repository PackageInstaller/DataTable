local EducateNewCharLayer = class("EducateNewCharLayer", import(".base.EducateBaseUI"))

function EducateNewCharLayer:getUIName()
	return "EducateNewCharUI"
end

function EducateNewCharLayer:init()
	self:initData()
	self:findUI()
	self:addListener()
...
function EducateNewCharLayer:initData()
...
function EducateNewCharLayer:findUI()
...
function EducateNewCharLayer:addListener()
	onButton(self, self.sureBtn, function()
		...
		self:emit(EducateNewCharMediator.ON_SET_CALL, var_6_0)
...
function EducateNewCharLayer:didEnter()
...
function EducateNewCharLayer:onBackPressed()
	return
end

function EducateNewCharLayer:willExit()
