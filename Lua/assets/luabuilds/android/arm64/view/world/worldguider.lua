...
function var_0_0.SetTempGridPos(arg_2_0, arg_2_1, arg_2_2)
	...
	arg_2_0.tempGridPos[arg_2_2] = pg.NewGuideMgr.GetInstance()._tf:InverseTransformPoint(arg_2_1)
...
function var_0_0.SetTempGridPos2(arg_3_0, arg_3_1, arg_3_2)
	...
	arg_3_0:SetTempGridPos(GameObject.Find("OverlayCamera").GetComponent(var_3_0, typeof(Camera)):ScreenToWorldPoint((var_3_0.GetComponent(var_3_9000, typeof(Camera)):WorldToScreenPoint(arg_3_1))), arg_3_2)
...
local var_0_1 = {
	...
	[var_0_0.WORLD_GET_SCANNER_POS] = function(arg_17_0, arg_17_1, arg_17_2)
		if arg_17_1 then
			local var_17_1 = arg_17_1.cachedIndex or 1

			var_17_0(arg_17_2, var_17_1)
