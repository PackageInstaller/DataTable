local SelectDorm3DMediator = class("SelectDorm3DMediator", import("view.base.ContextMediator"))

SelectDorm3DMediator.ON_DORM = "SelectDorm3DMediator.ON_DORM"
SelectDorm3DMediator.ON_UNLOCK_DORM_ROOM = "SelectDorm3DMediator.ON_UNLOCK_DORM_ROOM"
SelectDorm3DMediator.ON_SUBMIT_TASK = "SelectDorm3DMediator.ON_SUBMIT_TASK"
SelectDorm3DMediator.OPEN_INVITE_LAYER = "SelectDorm3DMediator.OPEN_INVITE_LAYER"
SelectDorm3DMediator.OPEN_ROOM_UNLOCK_WINDOW = "SelectDorm3DMediator.OPEN_ROOM_UNLOCK_WINDOW"
SelectDorm3DMediator.OPEN_INS_LAYER = "SelectDorm3DMediator.OPEN_INS_LAYER"
SelectDorm3DMediator.OPEN_SHOP_LAYER = "SelectDorm3DMediator.OPEN_SHOP_LAYER"
SelectDorm3DMediator.OPEN_SETTING_LAYER = "SelectDorm3DMediator.OPEN_SETTING_LAYER"

function SelectDorm3DMediator:register()
	self:bind(SelectDorm3DMediator.ON_DORM, function(arg_2_0, arg_2_1)
		self:sendNotification(GAME.GO_SCENE, SCENE.DORM3D_ROOM, arg_2_1)

		return
	end)
	self:bind(SelectDorm3DMediator.ON_UNLOCK_DORM_ROOM, function(arg_3_0, arg_3_1)
	...
	self:bind(SelectDorm3DMediator.ON_SUBMIT_TASK, function(arg_4_0, arg_4_1)
		self:sendNotification(GAME.SUBMIT_TASK, arg_4_1)

		return
	end)
	self:bind(SelectDorm3DMediator.OPEN_ROOM_UNLOCK_WINDOW, function(arg_5_0, arg_5_1)
	...
	self:bind(SelectDorm3DMediator.OPEN_INVITE_LAYER, function(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		self:addSubLayers(Context.New({
	...
	self:bind(SelectDorm3DMediator.OPEN_INS_LAYER, function(arg_7_0, arg_7_1)
		self:addSubLayers(Context.New({
			...
			onRemoved = function()
				self.viewComponent:FlushInsBtn()
	...
	self:bind(SelectDorm3DMediator.OPEN_SHOP_LAYER, function(arg_9_0, arg_9_1)
		self:addSubLayers(Context.New({
	...
	self:bind(SelectDorm3DMediator.OPEN_SETTING_LAYER, function(arg_10_0)
		self:addSubLayers(Context.New({
	...
	if not self.contextData.hasEnterCheck then
		self.contextData.hasEnterCheck = true

		self:sendNotification(GAME.SELECT_DORM_ENTER)
	end

	return
end

function SelectDorm3DMediator:initNotificationHandleDic()
	self.handleDic = {
