local DormConst = class("DormConst")
...
function DormConst.GetDefaultSystemClasses()
	return {
		SlideExtraSystem,
		Dorm3dStockingMgr,
		TeleportSystem,
...
DormConst.DEFAULT_ANIM_FADE_IN_TIME = 0.25
DormConst.LADY_MOVE_SPEED = 0.85
DormConst.LADY_ROTATE_SPEED = 10
DormConst.TRANSPARENCY_MIN_DISTANCE = 0.6
DormConst.TRANSPARENCY_MAX_DISTANCE = 1.2
DormConst.CHARACTER_CONTROLLER = {
	stepOffset = 0.2,
	radius = 0.08,
	height = 1.49,
