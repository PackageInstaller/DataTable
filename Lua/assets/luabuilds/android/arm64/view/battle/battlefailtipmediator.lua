...
function var_0_0.bindEvent(arg_3_0)
	arg_3_0:bind(var_0_0.CHAPTER_RETREAT, function(arg_4_0, arg_4_1)
		...
		local var_4_1 = var_4_0 and var_4_0:getShips() or arg_3_0.mainShips
		local var_4_2 = {}
...
function var_0_0.removeContextBeforeGO(arg_15_0)
	...
	if arg_15_0.battleSystem == SYSTEM_SCENARIO then
	...
	elseif arg_15_0.battleSystem == SYSTEM_ROUTINE or arg_15_0.battleSystem == SYSTEM_SUB_ROUTINE then
	...
	elseif arg_15_0.battleSystem == SYSTEM_DUEL then
	...
	elseif arg_15_0.battleSystem == SYSTEM_HP_SHARE_ACT_BOSS then
