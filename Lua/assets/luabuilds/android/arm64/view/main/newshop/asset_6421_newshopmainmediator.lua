local NewShopMainMediator = class("NewShopMainMediator", import("...base.ContextMediator"))

NewShopMainMediator.OPEN_LAYER = "NewShopMainMediator.OPEN_LAYER"
NewShopMainMediator.SWITCH_TO_SHOP = "NewShopMainMediator.SWITCH_TO_SHOP"
NewShopMainMediator.CHARGE = "NewShopMainMediator.CHARGE"
NewShopMainMediator.BUY_ITEM = "NewShopMainMediator.BUY_ITEM"
NewShopMainMediator.CLICK_MING_SHI = "NewShopMainMediator.CLICK_MING_SHI"
NewShopMainMediator.GET_CHARGE_LIST = "NewShopMainMediator.GET_CHARGE_LIST"
NewShopMainMediator.OPEN_CHARGE_ITEM_PANEL = "NewShopMainMediator.OPEN_CHARGE_ITEM_PANEL"
NewShopMainMediator.OPEN_CHARGE_ITEM_BOX = "NewShopMainMediator.OPEN_CHARGE_ITEM_BOX"
NewShopMainMediator.OPEN_CHARGE_BIRTHDAY = "NewShopMainMediator.OPEN_CHARGE_BIRTHDAY"
NewShopMainMediator.OPEN_USER_AGREE = "NewShopMainMediator.OPEN_USER_AGREE"
NewShopMainMediator.VIEW_SKIN_PROBABILITY = "NewShopMainMediator.VIEW_SKIN_PROBABILITY"
NewShopMainMediator.OPEN_TEC_SHIP_GIFT_SELL_LAYER = "NewShopMainMediator.OPEN_TEC_SHIP_GIFT_SELL_LAYER"
NewShopMainMediator.OPEN_BATTLE_UI_SELL_LAYER = "NewShopMainMediator.OPEN_BATTLE_UI_SELL_LAYER"
NewShopMainMediator.FAST_BUILD_ITEM_ID = 61004
NewShopMainMediator.REFRESH_STREET_SHOP = "NewShopMainMediator.REFRESH_STREET_SHOP"
NewShopMainMediator.REFRESH_MILITARY_SHOP = "NewShopMainMediator.REFRESH_MILITARY_SHOP"
NewShopMainMediator.ON_SHAM_SHOPPING = "NewShopMainMediator.ON_SHAM_SHOPPING"
NewShopMainMediator.ON_FRAGMENT_SHOPPING = "NewShopMainMediator.ON_FRAGMENT_SHOPPING"
NewShopMainMediator.ON_ACT_SHOPPING = "NewShopMainMediator.ON_ACT_SHOPPING"
NewShopMainMediator.SELL_BLUEPRINT = "NewShopMainMediator.SELL_BLUEPRINT"
NewShopMainMediator.SET_PLAYER_FLAG = "NewShopMainMediator.SET_PLAYER_FLAG"
NewShopMainMediator.ON_GUILD_SHOPPING = "NewShopMainMediator.ON_GUILD_SHOPPING"
NewShopMainMediator.ON_MEDAL_SHOPPING = "NewShopMainMediator.ON_MEDAL_SHOPPING"
NewShopMainMediator.REFRESH_GUILD_SHOP = "NewShopMainMediator.REFRESH_GUILD_SHOP"
NewShopMainMediator.REFRESH_MEDAL_SHOP = "NewShopMainMediator.REFRESH_MEDAL_SHOP"
NewShopMainMediator.ON_META_SHOP = "NewShopMainMediator.ON_META_SHOP"
NewShopMainMediator.ON_ESKIN_PREVIEW = "NewShopMainMediator.ON_ESKIN_PREVIEW"
NewShopMainMediator.ON_QUOTA_SHOPPING = "NewShopMainMediator.ON_QUOTA_SHOPPING"
NewShopMainMediator.ON_MINI_GAME_SHOP_BUY = "NewShopMainMediator.ON_MINI_GAME_SHOP_BUY"
NewShopMainMediator.ON_MINI_GAME_SHOP_FLUSH = "NewShopMainMediator.ON_MINI_GAME_SHOP_FLUSH"
NewShopMainMediator.UR_EXCHANGE_TRACKING = "NewShopMainMediator.UR_EXCHANGE_TRACKING"
NewShopMainMediator.ON_ACT_OPERATION = "NewShopMainMediator.ON_ACT_OPERATION"
NewShopMainMediator.NOTI_UPDATE_CURRENT = "NewShopMainMediator.NOTI_UPDATE_CURRENT"
NewShopMainMediator.OPEN_GIFT_ACT_LAYER = "NewShopMainMediator.OPEN_GIFT_ACT_LAYER"
NewShopMainMediator.ON_SUBLAYER_EVENT = "NewShopMainMediator.ON_SUBLAYER_EVENT"

function NewShopMainMediator:register()
	self:bind(NewShopMainMediator.OPEN_LAYER, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	self.viewComponent:SetSupplyShopList(self.contextData.supplyShopList)
	self.viewComponent:OnInitItems(getProxy(BagProxy):getRawData())
	self:bind(NewShopMainMediator.VIEW_SKIN_PROBABILITY, function(arg_3_0, arg_3_1, arg_3_2)
		self.contextData.warp = arg_3_2
	...
	self:bind(NewShopMainMediator.GET_CHARGE_LIST, function(arg_4_0)
		self:sendNotification(GAME.GET_CHARGE_LIST)

		return
	end)
	self:bind(NewShopMainMediator.SWITCH_TO_SHOP, function(arg_5_0, arg_5_1)
		self:sendNotification(GAME.GO_SCENE, SCENE.SHOP, arg_5_1)

		return
	end)
	self:bind(NewShopMainMediator.CHARGE, function(arg_6_0, arg_6_1)
	...
	self:bind(NewShopMainMediator.BUY_ITEM, function(arg_7_0, arg_7_1, arg_7_2)
	...
	self:bind(NewShopMainMediator.CLICK_MING_SHI, function(arg_8_0)
		self:sendNotification(GAME.CLICK_MING_SHI)

		return
	end)
	self:bind(NewShopMainMediator.OPEN_CHARGE_ITEM_PANEL, function(arg_9_0, arg_9_1)
		self:addSubLayers(Context.New({
	...
	self:bind(NewShopMainMediator.OPEN_CHARGE_ITEM_BOX, function(arg_10_0, arg_10_1)
		self:addSubLayers(Context.New({
	...
	self:bind(NewShopMainMediator.OPEN_CHARGE_BIRTHDAY, function(arg_11_0, arg_11_1)
		self:addSubLayers(Context.New({
	...
	self:bind(NewShopMainMediator.OPEN_USER_AGREE, function(arg_12_0, arg_12_1)
		self:addSubLayers(Context.New({
	...
	self:bind(NewShopMainMediator.OPEN_TEC_SHIP_GIFT_SELL_LAYER, function(arg_13_0, arg_13_1, arg_13_2)
		self:addSubLayers(Context.New({
	...
	self:bind(NewShopMainMediator.OPEN_BATTLE_UI_SELL_LAYER, function(arg_14_0, arg_14_1, arg_14_2)
		self:addSubLayers(Context.New({
	...
	self:bind(NewShopMainMediator.REFRESH_STREET_SHOP, function(arg_15_0, arg_15_1)
	...
	self:bind(NewShopMainMediator.REFRESH_MILITARY_SHOP, function(arg_16_0, arg_16_1)
	...
	self:bind(NewShopMainMediator.ON_SHAM_SHOPPING, function(arg_17_0, arg_17_1, arg_17_2)
	...
	self:bind(NewShopMainMediator.ON_FRAGMENT_SHOPPING, function(arg_18_0, arg_18_1, arg_18_2)
	...
	self:bind(NewShopMainMediator.ON_ACT_SHOPPING, function(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	...
	self:bind(NewShopMainMediator.ON_ACT_OPERATION, function(arg_20_0, arg_20_1, arg_20_2)
		self:sendNotification(GAME.ACTIVITY_OPERATION, setmetatable({
	...
	self:bind(NewShopMainMediator.SELL_BLUEPRINT, function(arg_21_0, arg_21_1)
		self:sendNotification(GAME.FRAG_SELL, arg_21_1)

		return
	end)
	self:bind(NewShopMainMediator.SET_PLAYER_FLAG, function(arg_22_0, arg_22_1, arg_22_2)
		if arg_22_2 then
	...
	self:bind(NewShopMainMediator.ON_GUILD_SHOPPING, function(arg_23_0, arg_23_1, arg_23_2)
	...
	self:bind(NewShopMainMediator.ON_MEDAL_SHOPPING, function(arg_24_0, arg_24_1, arg_24_2)
	...
	self:bind(NewShopMainMediator.REFRESH_GUILD_SHOP, function(arg_25_0, arg_25_1)
		self:sendNotification(GAME.GET_GUILD_SHOP, {
			type = (arg_25_1 or nil) and (GuildConst.MANUAL_REFRESH or GuildConst.AUTO_REFRESH)
		})

		return
	end)
	self:bind(NewShopMainMediator.REFRESH_MEDAL_SHOP, function(arg_26_0)
		self:sendNotification(GAME.GET_MEDALSHOP, {})

		return
	end)
	self:bind(NewShopMainMediator.ON_META_SHOP, function(arg_27_0, arg_27_1, arg_27_2, arg_27_3, arg_27_4, arg_27_5)
	...
	self:bind(NewShopMainMediator.ON_ESKIN_PREVIEW, function(arg_28_0, arg_28_1)
	...
	self:bind(NewShopMainMediator.ON_QUOTA_SHOPPING, function(arg_29_0, arg_29_1, arg_29_2)
	...
	self:bind(NewShopMainMediator.ON_MINI_GAME_SHOP_BUY, function(arg_30_0, arg_30_1, arg_30_2)
		self:sendNotification(GAME.MINI_GAME_SHOP_BUY, arg_30_1)

		return
	end)
	self:bind(NewShopMainMediator.ON_MINI_GAME_SHOP_FLUSH, function(arg_31_0, arg_31_1, arg_31_2)
		self:sendNotification(GAME.MINI_GAME_SHOP_FLUSH, arg_31_1)

		return
	end)
	self:bind(NewShopMainMediator.UR_EXCHANGE_TRACKING, function(arg_32_0, arg_32_1)
	...
	self:bind(NewShopMainMediator.OPEN_GIFT_ACT_LAYER, function(arg_33_0, arg_33_1)
		self:OpenGiftActLayer(arg_33_1)
...
function NewShopMainMediator:OpenGiftActLayer(arg_34_1)
	...
	switch(var_34_0:getConfig("type"), {
		[ActivityConst.ACTIVITY_TYPE_SKIN_FAKE_PACKAGE] = function()
			self.viewComponent:emit(NewShopMainMediator.OPEN_LAYER, ChargeActGiftLayer, ChargeActGiftMediator, {
				actId = var_34_0.id
			})
		...
		[ActivityConst.ACTIVITY_TYPE_TIMES_FAKE_PACKAGE] = function()
			...
			self.viewComponent:emit(NewShopMainMediator.OPEN_CHARGE_ITEM_PANEL, {
				isLocalPrice = false,
				isChargeType = false,
				isMonthCard = false,
				commodity = var_36_1,
				...
				onYes = function()
					pg.MsgboxMgr.GetInstance():ShowMsgBox({
						...
						onYes = function()
							self.viewComponent:emit(NewShopMainMediator.ON_ACT_OPERATION, var_34_0.id, {
								cmd = 1,
								costDrop = Drop.New({
...
function NewShopMainMediator:initNotificationHandleDic()
	self.handleDic = {
		...
		[GAME.SHOPPING_DONE] = function(arg_50_0, arg_50_1)
			...
			elseif var_50_0.shopType == ShopArgs.MilitaryShop then
				arg_50_0.viewComponent:OnUpdateCommodity(NewShopsScene.TYPE_MILITARY_SHOP, getProxy(ShopsProxy):getMeritorousShop(), var_50_0.id)
			end
			...
			if var_50_0.normalList then
				arg_50_0.viewComponent:setNormalList(var_50_0.normalList)
			end
		...
		[PlayerResUI.GO_MALL] = function(arg_54_0, arg_54_1)
			...
			arg_54_0.viewComponent:switchSubViewByTogger((var_54_0 or nil) and (var_54_0.type or ChargeScene.TYPE_DIAMOND))
			arg_54_0.viewComponent:updateNoRes((var_54_0 or nil) and (var_54_0.noRes or nil))
		...
		[GAME.MINI_GAME_SHOP_BUY_DONE] = function(arg_76_0, arg_76_1)
			...
			arg_76_0.viewComponent:OnUpdateShop(NewShopsScene.TYPE_MINI_GAME, (getProxy(ShopsProxy):getMiniShop()))

			return
		end,
		[NewShopMainMediator.NOTI_UPDATE_CURRENT] = function(arg_77_0, arg_77_1)
			arg_77_0.viewComponent:updateCurSubView()
			pg.EasyRedDotMgr.GetInstance():TriggerMarks("specialShop")

			return
		end,
		[NewShopMainMediator.ON_SUBLAYER_EVENT] = function(arg_78_0, arg_78_1)
