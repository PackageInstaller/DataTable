...
function tracebackex()
	...
	while true do
		...
		var_15_1 = var_15_2.what == "C" and var_15_1 .. tostring(var_15_0) .. "\tC function\n" or var_15_1 .. string.format("\t[%s]:%d in function `%s`\n", var_15_2.short_src, var_15_2.currentline, (not var_15_2.name or nil) and "")

		local var_15_4 = 1

		while true do
			local var_15_5, var_15_6 = debug.getlocal(var_15_0, var_15_4)

			if not var_15_5 then
				break
			end

			var_15_1 = var_15_1 .. "\t\t" .. var_15_5 .. " =\t" .. tostringex(var_15_6, 3) .. "\n"
			var_15_4 = var_15_4 + 1
		end
