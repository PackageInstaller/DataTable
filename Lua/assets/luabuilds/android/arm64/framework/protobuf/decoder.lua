...
local var_0_7 = require("encoder")
local var_0_8 = require("wire_format")
		...
		elseif arg_2_1 then
			...
			return function(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
				...
				while true do
					...
					if var_2_2(arg_4_0, var_4_2 + 1, var_4_2 + var_2_1) ~= var_0 or arg_4_2 <= var_4_2 then
...
Int32Decoder = (function(arg_1_0, arg_1_1)
	return function(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
		if arg_2_2 then
			local var_2_0 = var_0_9
...
end)(var_0_8.WIRETYPE_VARINT, var_0_6.signed_varint_decoder)
EnumDecoder = Int32Decoder
Int64Decoder = (function(arg_1_0, arg_1_1)
	return function(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
		if arg_2_2 then
			local var_2_0 = var_0_9
...
end)(var_0_8.WIRETYPE_VARINT, var_0_6.signed_varint_decoder64)
UInt32Decoder = (function(arg_1_0, arg_1_1)
	return function(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
		if arg_2_2 then
			local var_2_0 = var_0_9
...
end)(var_0_8.WIRETYPE_VARINT, var_0_6.varint_decoder)
UInt64Decoder = (function(arg_1_0, arg_1_1)
	return function(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
		if arg_2_2 then
			local var_2_0 = var_0_9
...
end)(var_0_8.WIRETYPE_VARINT, var_0_6.varint_decoder64)
SInt32Decoder = (function(arg_6_0, arg_6_1, arg_6_2)
...
end)(var_0_8.WIRETYPE_VARINT, var_0_6.varint_decoder, var_0_8.ZigZagDecode32)
SInt64Decoder = (function(arg_6_0, arg_6_1, arg_6_2)
	return var_0_11(arg_6_0, function(arg_7_0, arg_7_1)
		local var_7_0, var_7_1 = arg_6_1(arg_7_0, arg_7_1)

		return arg_6_2(var_7_0), var_7_1
	end)
end)(var_0_8.WIRETYPE_VARINT, var_0_6.varint_decoder64, var_0_8.ZigZagDecode64)
Fixed32Decoder = (function(arg_8_0, arg_8_1, arg_8_2)
...
end)(var_0_8.WIRETYPE_FIXED32, 4, string.byte("I"))
Fixed64Decoder = (function(arg_8_0, arg_8_1, arg_8_2)
	local var_8_0 = var_0_6.struct_unpack
	...
	return var_0_11(arg_8_0, InnerDecode)
end)(var_0_8.WIRETYPE_FIXED64, 8, string.byte("Q"))
SFixed32Decoder = (function(arg_8_0, arg_8_1, arg_8_2)
	local var_8_0 = var_0_6.struct_unpack
...
SFixed64Decoder = (function(arg_8_0, arg_8_1, arg_8_2)
	local var_8_0 = var_0_6.struct_unpack
...
FloatDecoder = (function(arg_8_0, arg_8_1, arg_8_2)
	local var_8_0 = var_0_6.struct_unpack
	...
	return var_0_11(arg_8_0, InnerDecode)
end)(var_0_8.WIRETYPE_FIXED32, 4, string.byte("f"))
DoubleDecoder = (function(arg_8_0, arg_8_1, arg_8_2)
	local var_8_0 = var_0_6.struct_unpack
	...
	return var_0_11(arg_8_0, InnerDecode)
end)(var_0_8.WIRETYPE_FIXED64, 8, string.byte("d"))
BoolDecoder = (function(arg_6_0, arg_6_1, arg_6_2)
	return var_0_11(arg_6_0, function(arg_7_0, arg_7_1)
		local var_7_0, var_7_1 = arg_6_1(arg_7_0, arg_7_1)

		return arg_6_2(var_7_0), var_7_1
	end)
end)(var_0_8.WIRETYPE_VARINT, var_0_6.varint_decoder, function(arg_10_0)
	return arg_10_0 ~= 0
end)
	...
	if arg_11_1 then
		...
		return function(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
			...
			while true do
				...
				arg_12_1 = var_12_4 + var_12_3 + var_11_2

				if var_11_1(arg_12_0, var_12_4 + var_12_3 + 1, var_12_4 + var_12_3 + var_11_2) ~= var_0 or var_12_4 + var_12_3 == arg_12_2 then
	...
	if arg_14_1 then
		...
		return function(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
			...
			while true do
				...
				arg_15_1 = var_15_4 + var_15_3 + var_14_2

				if var_14_1(arg_15_0, var_15_4 + var_15_3 + 1, var_15_4 + var_15_3 + var_14_2) ~= var_0 or var_15_4 + var_15_3 == arg_15_2 then
	...
	if arg_17_1 then
		...
		return function(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4)
			...
			while true do
				...
				local var_18_6 = var_18_0:add()

				if var_18_6:_InternalParse(arg_18_0, arg_18_1, var_18_5) ~= var_18_5 then
					var_0_4("Unexpected end-group tag.")
				end

				arg_18_1 = var_18_5 + var_17_2

				if var_17_1(arg_18_0, var_18_5 + 1, var_18_5 + var_17_2) ~= var_0 or var_18_5 == arg_18_2 then
					return var_18_5
				end
			end
