...
function _TagSize(arg_5_0)
	return _VarintSize(wire_format.PackTag(arg_5_0, 0))
end
...
SInt32Sizer = _ModifiedSizer(_VarintSize, wire_format.ZigZagEncode32)
SInt64Sizer = _ModifiedSizer(_VarintSize64, wire_format.ZigZagEncode32)
...
local var_0_7 = pb.varint_encoder
local var_0_8 = pb.signed_varint_encoder
...
function _VarintBytes(arg_30_0)
	...
	return var_0_0.concat(var_30_0)
end

function TagBytes(arg_32_0, arg_32_1)
	return _VarintBytes(wire_format.PackTag(arg_32_0, arg_32_1))
end

function _SimpleEncoder(arg_33_0, arg_33_1, arg_33_2)
	return function(arg_34_0, arg_34_1, arg_34_2)
		if arg_34_2 then
			local var_34_0 = TagBytes(arg_34_0, wire_format.WIRETYPE_LENGTH_DELIMITED)
...
function _ModifiedEncoder(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	return function(arg_39_0, arg_39_1, arg_39_2)
		if arg_39_2 then
			local var_39_0 = TagBytes(arg_39_0, wire_format.WIRETYPE_LENGTH_DELIMITED)
...
function _StructPackEncoder(arg_43_0, arg_43_1, arg_43_2)
	return function(arg_44_0, arg_44_1, arg_44_2)
		local var_44_0 = pb.struct_pack

		if arg_44_2 then
			local var_44_1 = TagBytes(arg_44_0, wire_format.WIRETYPE_LENGTH_DELIMITED)
...
Int32Encoder = _SimpleEncoder(wire_format.WIRETYPE_VARINT, pb.signed_varint_encoder, _SignedVarintSize)
Int64Encoder = _SimpleEncoder(wire_format.WIRETYPE_VARINT, pb.signed_varint_encoder64, _SignedVarintSize64)
EnumEncoder = Int32Encoder
UInt32Encoder = _SimpleEncoder(wire_format.WIRETYPE_VARINT, pb.varint_encoder, _VarintSize)
UInt64Encoder = _SimpleEncoder(wire_format.WIRETYPE_VARINT, pb.varint_encoder64, _VarintSize64)
SInt32Encoder = _ModifiedEncoder(wire_format.WIRETYPE_VARINT, pb.varint_encoder, _VarintSize, wire_format.ZigZagEncode32)
SInt64Encoder = _ModifiedEncoder(wire_format.WIRETYPE_VARINT, pb.varint_encoder64, _VarintSize64, wire_format.ZigZagEncode64)
...
function BoolEncoder(arg_48_0, arg_48_1, arg_48_2)
	...
	if arg_48_2 then
		local var_48_2 = TagBytes(arg_48_0, wire_format.WIRETYPE_LENGTH_DELIMITED)
	...
	elseif arg_48_1 then
		local var_48_4 = TagBytes(arg_48_0, wire_format.WIRETYPE_VARINT)
		...
		local var_48_5 = TagBytes(arg_48_0, wire_format.WIRETYPE_VARINT)
...
function StringEncoder(arg_52_0, arg_52_1, arg_52_2)
	local var_52_0 = TagBytes(arg_52_0, wire_format.WIRETYPE_LENGTH_DELIMITED)
...
function BytesEncoder(arg_55_0, arg_55_1, arg_55_2)
	local var_55_0 = TagBytes(arg_55_0, wire_format.WIRETYPE_LENGTH_DELIMITED)
...
function MessageEncoder(arg_58_0, arg_58_1, arg_58_2)
	local var_58_0 = TagBytes(arg_58_0, wire_format.WIRETYPE_LENGTH_DELIMITED)
