...
function UnpackTag(arg_3_0)
	return (arg_3_0 - arg_3_0 % 8) / 8, arg_3_0 % 8
end
...
function MessageSetItemByteSize(arg_22_0, arg_22_1)
	local var_22_0 = arg_22_1.ByteSize()

	return 2 * TagByteSize(1) + TagByteSize(2) + TagByteSize(3) + var_0_1(arg_22_0) + var_0_1(var_22_0) + var_22_0
end
