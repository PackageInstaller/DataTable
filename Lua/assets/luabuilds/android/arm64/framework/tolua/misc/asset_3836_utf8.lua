local var_0_0 = {
	next_raw = function(self, arg_1_1)
		if not arg_1_1 then
			if #self == 0 then
				return nil
			end
		...
		if arg_1_1 > #self then
			return
		end

		local var_1_0 = self:byte(arg_1_1)
...
function var_0_0:sub(arg_9_1, arg_9_2)
	assert(arg_9_1 >= 1)
	...
	for iter_9_0 in var_0_0.byte_indices(self) do
		var_9_0 = var_9_0 + 1
	...
	return self:sub(var_9_1, var_9_2 and var_9_2 - 1)
end

function var_0_0:contains(arg_10_1, arg_10_2)
	if arg_10_1 < 1 or arg_10_1 > #self then
		return nil
	end

	for iter_10_0 = 1, #arg_10_2 do
		if self:byte(arg_10_1 + iter_10_0 - 1) ~= arg_10_2:byte(iter_10_0) then
			return false
		end
	end
...
function var_0_0:isvalid(arg_12_1)
	local var_12_0 = self:byte(arg_12_1)
	...
	elseif var_12_0 >= 194 and var_12_0 <= 223 then
		local var_12_1 = self:byte(arg_12_1 + 1)

		return var_12_1 and var_12_1 >= 128 and var_12_1 <= 191
	elseif var_12_0 >= 224 and var_12_0 <= 239 then
		local var_12_2 = self:byte(arg_12_1 + 1)
		local var_12_3 = self:byte(arg_12_1 + 2)
	...
	elseif var_12_0 >= 240 and var_12_0 <= 244 then
		local var_12_4 = self:byte(arg_12_1 + 1)
		local var_12_5 = self:byte(arg_12_1 + 2)
		local var_12_6 = self:byte(arg_12_1 + 3)
...
function var_0_0:replace(arg_17_1, ...)
	if type(arg_17_1) == "table" then
		return var_0_0.replace(self, var_0_1, arg_17_1)
	end
	...
	for iter_17_0 in var_0_0.byte_indices(self) do
		local var_17_2 = var_0_0.next(self, iter_17_0) or #self + 1
		local var_17_3 = arg_17_1(self, iter_17_0, var_17_2 - 1, ...)

		if var_17_3 then
			table.insert(var_17_0, self:sub(var_17_1, iter_17_0 - 1))
	...
	table.insert(var_17_0, self:sub(var_17_1))
