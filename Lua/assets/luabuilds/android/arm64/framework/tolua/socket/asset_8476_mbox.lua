...
function var_0_0.parse_headers(arg_8_0)
	...
	for iter_8_0 = 1, #var_8_0 do
		...
		if var_8_2 then
			...
			var_8_1[var_8_4] = var_8_1[var_8_4] and var_8_1[var_8_4] .. ", " .. var_8_3 or var_8_3
		end
	end
...
function var_0_0.split_mbox(arg_10_0)
	...
	while true do
		local var_10_3, var_10_4 = string.find(arg_10_0, "\n\nFrom .-\n", 1)

		if not var_10_3 then
			break
		end

		table.insert(var_10_0, (string.sub(arg_10_0, 1, var_10_3 - 1)))
	end
