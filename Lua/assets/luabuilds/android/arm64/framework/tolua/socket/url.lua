...
var_0_3.url._VERSION = "URL 1.0.3"

function var_0_3.url.escape(arg_1_0)
...
function var_0_3.url.unescape(arg_6_0)
...
local function var_0_7(arg_8_0, arg_8_1)
	...
	local var_8_0 = var_0_0.gsub(var_0_0.gsub(var_0_0.gsub(arg_8_0, "[^/]*$", "") .. arg_8_1, "([^/]*%./)", function(arg_9_0)
		if arg_9_0 ~= "./" then
			return arg_9_0
		else
			return ""
	...
	while var_8_1 ~= var_8_0 do
		var_8_1 = var_8_0
		var_8_0 = var_0_0.gsub(var_8_0, "([^/]*/%.%./)", function(arg_10_0)
			if arg_10_0 ~= "../../" then
				return ""
			else
				return arg_10_0
	...
	return (var_0_0.gsub(var_8_1, "([^/]*/%.%.)$", function(arg_11_0)
		if arg_11_0 ~= "../.." then
			return ""
		else
			return arg_11_0
...
function var_0_3.url.parse(arg_12_0, arg_12_1)
	local var_12_0 = {}

	for iter_12_0, iter_12_1 in var_0_1.pairs(arg_12_1 or {}) do
		({})[iter_12_0] = iter_12_1
	end
	...
	local var_12_1 = ({}).authority

	if not ({}).authority then
		return {}
	end

	local var_12_2 = var_0_0.gsub(var_0_0.gsub(var_12_1, "^([^@]*)@", function(arg_18_0)
	...
	if var_12_2 ~= "" then
		({}).host = var_0_0.match(var_12_2, "^%[(.+)%]$") or var_12_2
	end

	local var_12_3 = ({}).userinfo

	if not ({}).userinfo then
		return {}
	end

	;({}).user = var_0_0.gsub(var_12_3, ":([^:]*)$", function(arg_20_0)
...
function var_0_3.url.build(arg_21_0)
	local var_21_0 = arg_21_0.path or ""
	local var_21_1 = var_0_4.build_path((var_0_4.parse_path(var_21_0)))
	...
	if arg_21_0.host then
		...
		if var_0_0.find(arg_21_0.host, ":") then
			var_21_2 = "[" .. var_21_2 .. "]"
		end
...
function var_0_3.url.absolute(arg_22_0, arg_22_1)
	local var_22_0
	...
	elseif var_22_1.scheme then
		...
		if not var_22_1.authority then
			...
			if not var_22_1.path then
				...
				local var_22_3 = var_22_0.path or ""
...
function var_0_3.url.parse_path(arg_23_0)
	local var_23_0 = {}
	...
	for iter_23_0 = 1, #{} do
		({})[iter_23_0] = var_0_4.unescape(({})[iter_23_0])
	end
...
function var_0_3.url.build_path(arg_25_0, arg_25_1)
	local var_25_0 = ""
	...
	if arg_25_1 then
		...
		if #arg_25_0 > 0 then
			var_25_0 = var_25_0 .. arg_25_0[#arg_25_0]
		...
		for iter_25_1 = 1, #arg_25_0 - 1 do
			var_25_0 = var_25_0 .. var_0_6(arg_25_0[iter_25_1])
			var_25_0 = var_25_0 .. "/"
		end

		if #arg_25_0 > 0 then
			var_25_0 = var_25_0 .. var_0_6(arg_25_0[#arg_25_0])
