...
;({
	__index = {}
}).__index.getsockname = function(arg_3_0)
	return arg_3_0.c:getpeername()
end
;({
	__index = {}
}).__index.check = function(arg_4_0, arg_4_1)
...
;({
	__index = {}
}).__index.command = function(arg_5_0, arg_5_1, arg_5_2)
...
;({
	__index = {}
}).__index.sink = function(arg_6_0, arg_6_1, arg_6_2)
...
;({
	__index = {}
}).__index.send = function(arg_7_0, arg_7_1)
	return arg_7_0.c:send(arg_7_1)
end
;({
	__index = {}
}).__index.receive = function(arg_8_0, arg_8_1)
	return arg_8_0.c:receive(arg_8_1)
end
;({
	__index = {}
}).__index.getfd = function(arg_9_0)
	return arg_9_0.c:getfd()
end
;({
	__index = {}
}).__index.dirty = function(arg_10_0)
	return arg_10_0.c:dirty()
end
;({
	__index = {}
}).__index.getcontrol = function(arg_11_0)
	return arg_11_0.c
end
;({
	__index = {}
}).__index.source = function(arg_12_0, arg_12_1, arg_12_2)
	local var_12_0, var_12_1 = var_0_3.pump.all(arg_12_1, var_0_2.sink("keep-open", arg_12_0.c), arg_12_2 or var_0_3.pump.step)

	return var_12_0, var_12_1
end
;({
	__index = {}
}).__index.close = function(arg_13_0)
	arg_13_0.c:close()

	return 1
end

function var_0_2.tp.connect(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
