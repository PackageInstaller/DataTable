...
local var_0_8 = bit.bor
local var_0_9 = bit.tohex
local var_0_10 = bit.lshift
local var_0_11 = bit.rshift
local var_0_12 = bit.arshift
local var_0_13 = {
	[0] = {
		[0] = "sllvDTS",
		false,
	...
	for iter_5_0 in var_0_4(var_5_5, ".") do
		...
		elseif iter_5_0 == "0" then
			if var_5_2 == "r0" or var_5_2 == 0 then
				var_5_1[#var_5_1] = nil
				var_5_2 = var_5_1[#var_5_1 - 1]

				if var_5_6 then
					local var_5_9, var_5_10 = var_0_3(var_5_6, "([^|]*)|(.*)")
...
local function var_0_20(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_2 then
		var_6_0 = arg_6_1 + arg_6_2 or #arg_6_0.code
	end

	arg_6_0.pos = arg_6_1 - arg_6_1 % 4
	arg_6_0.rel = nil

	while var_6_0 - var_6_0 % 4 > arg_6_0.pos do
		var_0_19(arg_6_0)
	end
...
local function var_0_21(arg_7_0, arg_7_1, arg_7_2)
	...
	var_7_0.hexdump = 8
	var_7_0.get = var_0_17

	return var_7_0
end

local function var_0_22(arg_8_0, arg_8_1, arg_8_2)
	local var_8_0 = var_0_21(arg_8_0, arg_8_1, arg_8_2)
...
return {
	...
	disass = function(arg_9_0, arg_9_1, arg_9_2)
		var_0_21(arg_9_0, arg_9_1, arg_9_2):disass()

		return
	end,
	disass_el = function(arg_10_0, arg_10_1, arg_10_2)
		var_0_22(arg_10_0, arg_10_1, arg_10_2):disass()
