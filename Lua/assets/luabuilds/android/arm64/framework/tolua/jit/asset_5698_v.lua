...
local function var_0_13(arg_1_0, arg_1_1)
	...
	elseif var_1_0.ffid then
		return vmdef.ffnames[var_1_0.ffid]
...
local function var_0_14(arg_2_0, arg_2_1)
	if var_0_5(arg_2_0) == "number" then
		...
		arg_2_0 = var_0_6(vmdef.traceerr[arg_2_0], arg_2_1)
	end
...
local function var_0_15(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
	if arg_3_0 == "start" then
		...
		if arg_3_4 then
			var_0_12 = "(" .. arg_3_4 .. "/" .. (arg_3_5 == -1 and "stitch" or arg_3_5) .. ") " or ""
		end
	else
		...
		elseif arg_3_0 == "stop" then
			...
			elseif var_3_1.linktype == "stitch" then
				print(var_0_6("[TRACE %3s %s%s %s %s]\n", arg_3_1, var_0_12, var_0_11, var_3_1.linktype, var_0_13(arg_3_2, arg_3_3)))
			elseif var_3_1.link == arg_3_1 or var_3_1.link == 0 then
				print(var_0_6("[TRACE %3s %s%s %s]\n", arg_3_1, var_0_12, var_0_11, var_3_1.linktype))
			elseif var_3_1.linktype == "root" then
				print(var_0_6("[TRACE %3s %s%s -> %d]\n", arg_3_1, var_0_12, var_0_11, var_3_1.link))
			else
				print(var_0_6("[TRACE %3s %s%s -> %d %s]\n", arg_3_1, var_0_12, var_0_11, var_3_1.link, var_3_1.linktype))
			end
		else
...
local function var_0_17(arg_5_0)
	...
	if arg_5_0 then
		if arg_5_0 == "-" then
			var_0_10 = var_0_7 or assert(io.open(arg_5_0, "w"))
		end
	else
		var_0_10 = var_0_8
	end

	jit.attach(var_0_15, "trace")
