...
local var_0_3 = util.funcinfo
local var_0_4 = util.funcbc
local var_0_5 = util.traceinfo
local var_0_6 = util.traceir
local var_0_7 = util.tracek
local var_0_8 = util.tracemc
local var_0_9 = util.tracesnap
local var_0_10 = util.traceexitstub
local var_0_11 = util.ircalladdr
local bit = require("bit")
local var_0_13 = bit.band
local var_0_14 = bit.rshift
local var_0_15 = bit.tohex
...
local function var_0_34(arg_2_0, arg_2_1)
	if var_0_32 == 0 then
		for iter_2_0 = 0, #vmdef.ircall do
			local var_2_0 = var_0_11(iter_2_0)
			...
			if var_2_0 ~= 0 then
				...
				var_0_31[var_2_0] = vmdef.ircall[iter_2_0]
			end
		end
	end
	...
	elseif arg_2_1 > var_0_32 then
		for iter_2_1 = var_0_32, arg_2_1 - 1 do
			local var_2_1 = var_0_10(iter_2_1)
			...
			var_0_31[var_2_1] = var_0_22(iter_2_1)
		end
...
local function var_0_36(arg_4_0)
	...
	var_0_26 = var_0_26 or require("jit.dis_" .. jit.arch)
...
local var_0_48 = {
	...
	["CONV  "] = setmetatable({}, {
		__index = function(arg_11_0, arg_11_1)
			local var_11_0 = var_0_47[var_0_13(var_0_14(arg_11_1, 5), 31)] .. "." .. var_0_47[var_0_13(arg_11_1, 31)]

			if var_0_13(arg_11_1, 2048) ~= 0 then
				var_11_0 = var_11_0 .. " sext"
			end

			local var_11_1 = var_0_14(arg_11_1, 14)
...
local function var_0_50(arg_13_0, arg_13_1)
	...
	elseif var_13_0.ffid then
		return vmdef.ffnames[var_13_0.ffid]
...
local function var_0_51(arg_14_0, arg_14_1, arg_14_2)
	...
	if var_14_3 == "number" then
		var_14_4 = var_0_13(arg_14_2 or 0, 0) ~= 0 and (var_0_13(arg_14_2, 0) ~= 0 and "contpc" or "ftsz") or var_14_0 == 6755399441055744 and "bias" or var_0_18(var_14_0 > 0 and var_14_0 < 0x0.1000000000000p-1022 and "%+a" or "%+.14g", var_14_0)
...
local function var_0_52(arg_15_0, arg_15_1)
	for iter_15_0 = 0, arg_15_1[1] - 1 do
		...
		if var_0_14(arg_15_1[2], 24) == iter_15_0 then
			var_15_1 = 2 + 1

			local var_15_2 = var_0_13(var_15_0, 65535) - 0

			if var_15_2 < 0 then
				var_0_28:write(var_0_51(arg_15_0, var_15_2, var_15_0))
			elseif var_0_13(var_15_0, 0) ~= 0 then
			...
			var_0_28:write(var_0_13(var_15_0, 0) == 0 and " " or "|")
		else
			var_0_28:write("---- ")
		end
	end
...
local function var_0_56(arg_19_0, arg_19_1)
	if arg_19_1 < 0 then
		...
		if var_0_16(vmdef.irnames, var_19_4 + 1, var_19_4 + 6) == "CARG  " then
...
local function var_0_57(arg_20_0, arg_20_1, arg_20_2)
	...
	for iter_20_0 = 1, var_20_1 do
		if var_20_2 <= iter_20_0 then
			if arg_20_2 then
				var_0_28:write(var_0_18("....              SNAP   #%-3d [ ", var_20_4))
			else
				var_0_28:write(var_0_18("....        SNAP   #%-3d [ ", var_20_4))
			end

			var_0_52(arg_20_0, var_20_3)

			var_20_4 = var_20_4 + 1
			var_20_3 = var_0_9(arg_20_0, var_20_4)
			var_20_2 = var_20_3 and var_20_3[0] or 0
		end

		local var_20_5, var_20_6, var_20_7, var_20_8, var_20_9 = var_0_6(arg_20_0, iter_20_0)
		local var_20_10 = 6 * var_0_14(var_20_6, 8)
		local var_20_11 = var_0_13(var_20_6, 31)
		local var_20_12 = var_0_16(vmdef.irnames, var_20_10 + 1, var_20_10 + 6)
		...
		elseif var_20_12 ~= "NOP   " and var_20_12 ~= "CARG  " and (arg_20_2 or var_20_12 ~= "RENAME") then
			local var_20_13 = var_0_13(var_20_9, 255)

			if arg_20_2 then
				var_0_28:write(var_0_18("%04d %-6s", iter_20_0, var_0_54(var_20_9, iter_20_0)))
			else
				var_0_28:write(var_0_18("%04d ", iter_20_0))
			end

			var_0_28:write(var_0_18("%s%s %s %s ", (var_20_13 == 254 or var_20_13 == 253) and "}" or var_0_13(var_20_6, 128) == 0 and " " or ">", var_0_13(var_20_6, 64) == 0 and " " or "+", var_0_47[var_20_11], var_20_12))

			local var_20_14 = var_0_13(var_20_5, 3)
			local var_20_15 = var_0_13(var_20_5, 12)

			if var_0_16(var_20_12, 1, 4) == "CALL" then
				local var_20_16

				if var_20_15 == 4 then
					var_0_28:write(var_0_18("%-10s  (", vmdef.ircall[var_20_8]))
				else
					var_20_16 = var_0_55(arg_20_0, var_20_8)
				end

				if var_20_7 ~= -1 then
					var_0_56(arg_20_0, var_20_7)
				end

				var_0_28:write(")")

				if var_20_16 then
					var_0_28:write(" ctype ", var_20_16)
				end
			elseif var_20_12 == "CNEW  " and var_20_8 == -1 then
				var_0_28:write(var_0_51(arg_20_0, var_20_7))
			elseif var_20_14 ~= 3 then
				if var_20_7 < 0 then
					var_0_28:write(var_0_51(arg_20_0, var_20_7))
				else
					var_0_28:write(var_0_18(var_20_14 == 0 and "%04d" or "#%-3d", var_20_7))
				end

				if var_20_15 ~= 12 then
					if var_20_15 == 4 then
						if var_0_48[var_20_12] and var_0_48[var_20_12][var_20_8] then
							var_0_28:write("  ", var_0_48[var_20_12][var_20_8])
						elseif var_20_12 == "UREFO " or var_20_12 == "UREFC " then
							var_0_28:write(var_0_18("  #%-3d", var_0_14(var_20_8, 8)))
						else
							var_0_28:write(var_0_18("  #%-3d", var_20_8))
						end
					elseif var_20_8 < 0 then
						var_0_28:write("  ", var_0_51(arg_20_0, var_20_8))
					else
						var_0_28:write(var_0_18("  %04d", var_20_8))
					end
				end
			end
...
local function var_0_60(arg_21_0, arg_21_1)
	if var_0_21(arg_21_0) == "number" then
		...
		arg_21_0 = var_0_18(vmdef.traceerr[arg_21_0], arg_21_1)
	end
...
local function var_0_61(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4, arg_22_5)
	...
	elseif arg_22_0 == "stop" or arg_22_0 == "abort" then
		...
		if arg_22_0 == "abort" then
			...
			local var_22_1 = var_0_5(arg_22_1)

			if var_22_1.link == arg_22_1 or var_22_1.link == 0 then
				var_0_28:write(" -> ", var_22_1.linktype, "\n")
			elseif var_22_1.linktype == "root" then
				var_0_28:write(" -> ", var_22_1.link, "\n")
			else
				var_0_28:write(" -> ", var_22_1.link, " ", var_22_1.linktype, "\n")
			end
		end
...
local function var_0_65(arg_26_0, arg_26_1)
	...
	if var_26_2.t or var_26_2.b or var_26_2.i or var_26_2.s or var_26_2.m then
		jit.attach(var_0_61, "trace")
	end

	if var_26_2.b then
		jit.attach(var_0_62, "record")

		var_0_25 = var_0_25 or require("jit.bc").line
	end

	if var_26_2.x or var_26_2.X then
		jit.attach(var_0_63, "texit")
	end
	...
	if arg_26_1 then
		if arg_26_1 == "-" then
			var_0_28 = var_0_23 or assert(io.open(arg_26_1, "w"))
		end
	else
		var_0_28 = var_0_23
	end
