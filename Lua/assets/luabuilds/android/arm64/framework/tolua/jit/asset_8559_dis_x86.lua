...
local function var_0_21(arg_1_0, arg_1_1, arg_1_2)
	...
	if arg_1_0.imm then
		if arg_1_0.symtab[arg_1_0.imm] then
			arg_1_1 = arg_1_1 .. "\t->" .. arg_1_0.symtab[arg_1_0.imm]
		end
	end
...
local function var_0_26(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0 in var_0_5(arg_6_2, ".") do
		...
		elseif iter_6_0 == "s" then
			local var_6_12 = var_0_25(arg_6_0, var_6_9, 1)
		...
		elseif iter_6_0 == "u" then
			local var_6_13 = var_0_25(arg_6_0, var_6_9, 1)
			...
			var_6_9 = var_6_9 + 1
		elseif iter_6_0 == "b" then
			local var_6_14 = var_0_25(arg_6_0, var_6_9, 1)
		...
		elseif iter_6_0 == "w" then
			local var_6_15 = var_0_25(arg_6_0, var_6_9, 2)
		...
		elseif iter_6_0 == "o" then
			if arg_6_0.x64 then
				local var_6_16 = var_0_25(arg_6_0, var_6_9, 4)

				if not var_6_16 then
					return
				end

				local var_6_17 = var_0_25(arg_6_0, var_6_9 + 4, 4)
				...
				local var_6_18 = var_0_25(arg_6_0, var_6_9, 4)
		...
		elseif iter_6_0 == "i" or iter_6_0 == "I" then
			local var_6_19 = var_0_19[var_6_2]

			if var_0_19[var_6_2] == 8 and arg_6_0.x64 and iter_6_0 == "I" then
				local var_6_20 = var_0_25(arg_6_0, var_6_9, 4)

				if not var_6_20 then
					return
				end

				local var_6_21 = var_0_25(arg_6_0, var_6_9 + 4, 4)
				...
				local var_6_22 = var_0_25(arg_6_0, var_6_9, var_6_19)
		...
		elseif iter_6_0 == "j" then
			local var_6_23 = var_0_19[var_6_2]

			if var_0_19[var_6_2] == 8 then
				var_6_23 = 4
			end

			local var_6_24 = var_0_25(arg_6_0, var_6_9, var_6_23)
		...
		elseif iter_6_0 == "1" then
			...
			if not var_6_3 then
				...
				if var_6_3 < 3 then
					...
					if var_6_3 > 0 or var_6_5 == 5 then
						...
						local var_6_28 = var_0_25(arg_6_0, var_6_9, var_6_27)
			...
			if iter_6_0 == "m" then
				if var_6_3 == 3 then
					...
					if arg_6_0.a32 then
						var_6_29 = var_0_17.D or arg_6_0.aregs
					end
				...
				if var_6_3 < 3 and (not var_0_4(arg_6_2, "[aRrgp]") or var_0_4(arg_6_2, "t")) then
					var_6_11 = var_0_20[var_6_2] .. " " .. var_6_11
				end
			elseif iter_6_0 == "r" then
				var_6_11 = var_6_1[var_6_4 + 1]
			elseif iter_6_0 == "g" then
				var_6_11 = var_0_18[var_6_4 + 1]
			elseif iter_6_0 == "p" then
				-- block empty
...
local function var_0_30(arg_9_0, arg_9_1)
	...
	return var_0_29(arg_9_0, arg_9_1[var_0_2(arg_9_0.code, arg_9_0.pos, arg_9_0.pos)])
end
...
var_0_27 = {
	...
	sz = function(self, arg_14_1, arg_14_2)
		if self.o16 then
			self.o16 = false
		else
	...
	vm = function(self, arg_17_1, arg_17_2)
		return var_0_29(self, var_0_14[self.mrm])
	end,
	fp = function(arg_18_0, arg_18_1, arg_18_2)
		...
		local var_18_1 = arg_18_2 * 8 + (var_18_0 - var_18_0 % 8) / 8 % 8

		if var_18_0 >= 192 then
			var_18_1 = var_18_1 + 64
		end

		local var_18_2 = var_0_15[var_18_1]

		if var_0_0(var_0_15[var_18_1]) == "table" then
			var_18_2 = var_18_2[var_18_0 % 8 + 1]
		end

		return var_0_29(arg_18_0, var_18_2)
	end,
	rex = function(self, arg_19_1, arg_19_2)
		if self.rex then
			return var_0_24(self)
		end

		for iter_19_0 in var_0_5(arg_19_2, ".") do
			self["rex" .. iter_19_0] = true
		end
	...
	vex = function(self, arg_20_1, arg_20_2)
		if self.rex then
			return var_0_24(self)
		end
		...
		local var_20_1 = var_0_2(self.code, var_20_0, var_20_0)

		if not var_20_1 then
			return var_0_23(self)
		end
		...
		if arg_20_2 == "3" then
			...
			var_20_1 = var_0_2(self.code, var_20_2, var_20_2)
		...
		elseif var_20_3 == 2 then
			var_20_4 = var_0_13["38"]
		elseif var_20_3 == 3 then
			var_20_4 = var_0_13["3a"]
		else
			return var_0_24(self)
		end
		...
		self.vexv = (-1 - (var_20_6 - var_20_6 % 2) / 2) % 16

		return var_0_30(self, var_20_4)
	end,
	nop = function(self, arg_21_1, arg_21_2)
		return var_0_29(self, self.rex and arg_21_2 or "nop")
	end,
	emms = function(self, arg_22_1, arg_22_2)
		if self.rex ~= "vex" then
			return var_0_21(self, "emms")
		elseif self.vexl then
			self.vexl = false

			return var_0_21(self, "zeroall")
		else
			return var_0_21(self, "zeroupper")
		end
...
local function var_0_31(arg_23_0, arg_23_1, arg_23_2)
	...
	if arg_23_2 then
		var_23_0 = arg_23_1 + arg_23_2 or #arg_23_0.code
	end
