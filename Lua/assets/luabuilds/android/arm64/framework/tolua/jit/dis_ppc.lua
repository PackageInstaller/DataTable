...
local function var_0_20(arg_6_0)
	...
	for iter_6_0 in var_0_4(var_6_10, ".") do
		...
		elseif iter_6_0 >= "2" and iter_6_0 <= "8" then
			local var_6_15 = var_0_8(var_0_12(var_6_4, var_6_7), 31) * iter_6_0

			if var_6_6 == "r0" then
				var_6_6 = "0"
			end

			var_6_5[#var_6_5] = var_0_2("%d(%s)", var_6_15, var_6_6)
		...
		elseif iter_6_0 == "B" then
			local var_6_16 = var_0_12(var_6_4, 21)
			local var_6_17 = var_0_8(var_0_12(var_6_4, 16), 31)
			local var_6_18 = ""

			var_6_7 = var_6_7 - 10

			if var_0_8(var_6_16, 4) == 0 then
				var_6_18 = var_0_8(var_6_16, 2) == 0 and "dnz" or "dz"

				if var_0_8(var_6_16, 16) == 0 then
					var_6_18 = var_6_18 .. (var_0_8(var_6_16, 8) == 0 and "f" or "t")
				end

				if var_0_8(var_6_16, 16) == 0 then
					var_6_13 = var_0_17(var_6_17)
				end

				var_6_9 = var_6_9 .. (var_0_8(var_6_16, 1) == var_0_8(var_0_12(var_6_4, 15), 1) and "-" or "+")
			elseif var_0_8(var_6_16, 16) == 0 then
				var_6_18 = var_0_16[var_0_8(var_6_17, 3) + (var_0_8(var_6_16, 8) == 0 and 4 or 0)]

				if var_6_17 > 3 then
					var_6_13 = "cr" .. var_0_12(var_6_17, 2)
				end

				var_6_9 = var_6_9 .. (var_0_8(var_6_16, 1) == var_0_8(var_0_12(var_6_4, 15), 1) and "-" or "+")
			end

			var_6_9 = var_0_5(var_6_9, "_", var_6_18)
...
local function var_0_21(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_2 then
		local var_7_0 = arg_7_1 + arg_7_2 or #arg_7_0.code
...
return {
	create = function(arg_8_0, arg_8_1, arg_8_2)
		({
			code = arg_8_0,
			addr = arg_8_1 or 0,
