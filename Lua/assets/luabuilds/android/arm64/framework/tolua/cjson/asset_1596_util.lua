...
local function var_0_4(arg_6_0, arg_6_1)
	...
	for iter_6_2, iter_6_3 in pairs(arg_6_1) do
		...
		if not var_0_4(arg_6_0[iter_6_2], arg_6_1[iter_6_2]) then
			return false
		end
...
local function var_0_7(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	...
	if var_8_2 == arg_8_3 and var_0_4(var_8_1, arg_8_4) then
		var_8_3 = true
		var_0_5 = var_0_5 + 1
	end
	...
	print(("==> Test [%d] %s: %s"):format(var_0_6, arg_8_0, ({
		[true] = "PASS",
		[false] = "FAIL"
	})[var_8_3]))
...
var_0_8.serialise_value = nil

function var_0_8.file_load(arg_4_0)
	local var_4_0
...
function var_0_8.file_save(arg_5_0, arg_5_1)
	local var_5_0
...
var_0_8.compare_values = var_0_4

function var_0_8.run_test_summary()
	return var_0_5, var_0_6
end

var_0_8.run_test = var_0_7

function var_0_8.run_test_group(arg_10_0)
...
function var_0_8.run_script(arg_12_0, arg_12_1)
