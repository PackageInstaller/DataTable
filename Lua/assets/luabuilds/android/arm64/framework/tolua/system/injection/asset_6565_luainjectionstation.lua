...
local var_0_8
local InjectionBridgeInfo = require("Framework.tolua.System.Injection.InjectionBridgeInfo")
...
function InjectByModule(arg_5_0, arg_5_1)
	...
	InjectByName(var_5_0[".name"], arg_5_1)
...
function InjectByName(arg_6_0, arg_6_1)
	...
	local var_6_0 = var_0_4(InjectionBridgeInfo, arg_6_0)
