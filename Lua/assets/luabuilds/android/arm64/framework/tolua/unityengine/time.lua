...
;({}).SetDeltaTime = function(arg_8_0, arg_8_1, arg_8_2)
	var_0_3.deltaTime = arg_8_1
	var_0_3.unscaledDeltaTime = arg_8_2
	var_0_5 = var_0_5 - 1

	if var_0_5 == 0 and var_0_1 then
...
;({}).SetFixedDelta = function(arg_9_0, arg_9_1)
