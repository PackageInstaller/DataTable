-- chunkname: @E:/AntMan/AntMan_Android_pub1/Assets/Code/.LuaCode/ToLua\\UnityEngine\\Vector4.lua
...
function Vector4:__tostring()
	if self.x == nil or self.y == nil or self.z == nil or self.w == nil then
		return "[Class Vector4]"
	end
