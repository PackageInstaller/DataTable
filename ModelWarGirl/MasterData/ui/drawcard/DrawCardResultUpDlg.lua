-- chunkname: @E:/AntMan/AntMan_Android_pub1/Assets/Code/.LuaCode/UI\\DrawCard\\DrawCardResultUpDlg.lua
...
local strClassName = "DrawCardResultUpDlg"
local DrawCardResultUpDlg = Class(strClassName, UIControls.Window)
local EffectItemCardPanel = Class("DrawCardResultUpDlg_EffectItemCardPanel", UIControls.Panel)
...
function DrawCardResultUpDlg:ctor(...)
	self:initUI()
end

local MAX_NUM = 10

function DrawCardResultUpDlg:initUI(...)
	local ui = UIManager.getUI("drawCardOptUpDlg", nil, false)
...
function DrawCardResultUpDlg:_startClose(...)
...
function DrawCardResultUpDlg:showDrawCardResult(items)
...
function DrawCardResultUpDlg:_refreshButtons()
	self.confirmBtn:setVisible(false)
...
function DrawCardResultUpDlg:_sortData(items, newHeroDic)
	local rv, tempItems = {}, {}
...
function DrawCardResultUpDlg:_hasHeros(items)
	local heroCount = 0
...
function DrawCardResultUpDlg:_onClickClose(...)
	local optDlg = UIManager.getUI("drawCardOptUpDlg", nil, false)
	...
	if self.needShare then
		CurAvatar:tryOpenGameEvaluateDlg("DrawCardResultUpDlg")
	end
end

function DrawCardResultUpDlg:onJumpRecharge()
	self:setVisible(false)
end

function DrawCardResultUpDlg:_onClickAgain(...)
...
function DrawCardResultUpDlg:_onClickConfirm(...)
	self:_onClickClose()
end

function DrawCardResultUpDlg:onClose()
	if self.lackItem then
		UIManager.tryHideUI("drawCardOptUpDlg")
	end

	DrawCardResultUpDlg.super.onClose(self)
end

return DrawCardResultUpDlg
