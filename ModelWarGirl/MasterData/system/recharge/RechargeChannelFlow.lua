-- chunkname: @E:/AntMan/AntMan_Android_pub1/Assets/Code/.LuaCode/System\\Recharge\\RechargeChannelFlow.lua

local RechargeChannelBase = require("System/Recharge/RechargeChannelBase")
local RechargeChannelFlow = Class("RechargeChannelFlow", RechargeChannelBase, true)
...
function RechargeChannelFlow:ctor()
	self._receiptUrlTail = nil
end

function RechargeChannelFlow:_getVerifyIndexAndData(data, openOrderId)
	return nil, nil
end

function RechargeChannelFlow:genSDKDataFromOrder(product_id, orderid, channel_account, svr_nodeid, extendInfo, gift_type)
	local sdkOrder = RechargeChannelFlow.super.genSDKDataFromOrder(self, product_id, orderid, channel_account, svr_nodeid, extendInfo, gift_type)
	...
	sdkOrder.recharge_id = RechargeManager.tempRechrageId

	return sdkOrder
end

return RechargeChannelFlow
