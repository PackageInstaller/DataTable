-- chunkname: @E:/AntMan/AntMan_Android_pub1/Assets/Code/.LuaCode/System\\Recharge\\rechargeChannelBiliKorea.lua
...
local RechargeChannelBiliKorea = Class("RechargeChannelBiliKorea", RechargeChannelBase, true)
local AttName = SDKConst.AttName

function RechargeChannelBiliKorea:ctor()
	return
end

function RechargeChannelBiliKorea:isFinishedButNotVerified(productId)
	return
end

function RechargeChannelBiliKorea:genSDKDataFromOrder(product_id, orderid, channel_account, svr_nodeid, extendInfo, gift_type)
	local sdkOrder = RechargeChannelBiliKorea.super.genSDKDataFromOrder(self, product_id, orderid, channel_account, svr_nodeid, extendInfo, gift_type)
...
return RechargeChannelBiliKorea
