return {
	Play910102001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 910102001
		arg_1_1.duration_ = 6
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				if var_4_35 then
					arg_1_1.var_.alphaOldValue1084 = var_4_35.alpha
					arg_1_1.var_.characterEffect1084 = var_4_35
				end
			...
			if var_4_34 <= arg_1_1.time_ and arg_1_1.time_ < var_4_34 + var_4_36 then
				...
				local var_4_38 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1084, 1, var_4_37)

				if arg_1_1.var_.characterEffect1084 then
					arg_1_1.var_.characterEffect1084.alpha = var_4_38
				end
			end

			if arg_1_1.time_ >= var_4_34 + var_4_36 and arg_1_1.time_ < var_4_34 + var_4_36 + arg_4_0 and arg_1_1.var_.characterEffect1084 then
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				local var_4_42 = arg_1_1:FormatText(StoryNameCfg[6].name)
				...
				local var_4_43 = arg_1_1:GetWordFromCfg(910102001)
	...
	Play910102002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 910102002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_7 < arg_7_1.time_ and arg_7_1.time_ <= var_10_7 + arg_10_0 then
				...
				local var_10_9 = arg_7_1:FormatText(StoryNameCfg[6].name)
				...
				local var_10_10 = arg_7_1:GetWordFromCfg(910102002)
	...
	Play910102003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 910102003
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_7 < arg_11_1.time_ and arg_11_1.time_ <= var_14_7 + arg_14_0 then
				...
				local var_14_9 = arg_11_1:FormatText(StoryNameCfg[6].name)
				...
				local var_14_10 = arg_11_1:GetWordFromCfg(910102003)
