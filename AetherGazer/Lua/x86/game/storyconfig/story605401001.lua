return {
	Play605401001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_3 = arg_1_1.actors_["2310002"].transform
			local var_4_4 = 0.333333333333333

			if var_4_4 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				arg_1_1.var_.moveOldPos2310002 = var_4_3.localPosition
			...
			if var_4_4 <= arg_1_1.time_ and arg_1_1.time_ < var_4_4 + var_4_5 then
				...
				local var_4_7 = Vector3.New(0, -65, -260)

				var_4_3.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2310002, var_4_7, var_4_6)
			end

			if arg_1_1.time_ >= var_4_4 + var_4_5 and arg_1_1.time_ < var_4_4 + var_4_5 + arg_4_0 then
				var_4_3.localPosition = Vector3.New(0, -65, -260)
			end
			...
			if var_4_9 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 and not isNil(var_4_8) then
				...
				if var_4_10 then
					arg_1_1.var_.highlightMatValue2310002 = var_4_10
				end
			end
			...
			if var_4_9 <= arg_1_1.time_ and arg_1_1.time_ < var_4_9 + var_4_11 and not isNil(var_4_8) then
				...
				if arg_1_1.var_.highlightMatValue2310002 then
					...
					local var_4_14 = arg_1_1.var_.highlightMatValue2310002
			...
			if arg_1_1.time_ >= var_4_9 + var_4_11 and arg_1_1.time_ < var_4_9 + var_4_11 + arg_4_0 and not isNil(var_4_8) and arg_1_1.var_.highlightMatValue2310002 then
				...
				local var_4_17 = arg_1_1.var_.highlightMatValue2310002
			...
			if var_4_19 < arg_1_1.time_ and arg_1_1.time_ <= var_4_19 + arg_4_0 then
				...
				local var_4_22 = arg_1_1:FormatText(StoryNameCfg[244].name)
				...
				local var_4_23 = arg_1_1:GetWordFromCfg(605401001)
	...
	Play605401002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_2 = arg_7_1:FormatText(StoryNameCfg[244].name)
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(605401002)
