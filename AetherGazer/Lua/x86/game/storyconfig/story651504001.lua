return {
	Play651504001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 651504001
		arg_1_1.duration_ = 5
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_0 + arg_4_0 then
				...
				local var_4_3 = arg_1_1:GetWordFromCfg(651504001)
	...
	Play651504002 = function(arg_5_0, arg_5_1)
		arg_5_1.time_ = 0
		arg_5_1.frameCnt_ = 0
		arg_5_1.state_ = "playing"
		arg_5_1.curTalkId_ = 651504002
		arg_5_1.duration_ = 5
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if var_8_0 < arg_5_1.time_ and arg_5_1.time_ <= var_8_0 + arg_8_0 then
				...
				local var_8_3 = arg_5_1:GetWordFromCfg(651504002)
