return {
	Play937081001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_56 < arg_1_1.time_ and arg_1_1.time_ <= var_4_56 + arg_4_0 then
				...
				local var_4_60 = arg_1_1:GetWordFromCfg(937081001)
	...
	Play937081002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_6 < arg_9_1.time_ and arg_9_1.time_ <= var_12_6 + arg_12_0 then
				...
				local var_12_9 = arg_9_1:GetWordFromCfg(937081002)
	...
	Play937081003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_15 < arg_13_1.time_ and arg_13_1.time_ <= var_16_15 + arg_16_0 then
				...
				local var_16_18 = arg_13_1:GetWordFromCfg(937081003)
	...
	Play937081004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_6 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_9 = arg_17_1:GetWordFromCfg(937081004)
	...
	Play937081005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_15 < arg_21_1.time_ and arg_21_1.time_ <= var_24_15 + arg_24_0 then
				...
				local var_24_18 = arg_21_1:GetWordFromCfg(937081005)
	...
	Play937081006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_6 < arg_25_1.time_ and arg_25_1.time_ <= var_28_6 + arg_28_0 then
				...
				local var_28_9 = arg_25_1:GetWordFromCfg(937081006)
	...
	Play937081007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_1 <= arg_29_1.time_ and arg_29_1.time_ < var_32_1 + var_32_2 then
				...
				local var_32_4 = Vector3.New(0, -0.77, -6.1)
			...
			if arg_29_1.time_ >= var_32_1 + var_32_2 and arg_29_1.time_ < var_32_1 + var_32_2 + arg_32_0 then
				var_32_0.localPosition = Vector3.New(0, -0.77, -6.1)
			...
			local var_32_9 = arg_29_1.actors_["1066ui_story"]
			local var_32_10 = 0

			if var_32_10 < arg_29_1.time_ and arg_29_1.time_ <= var_32_10 + arg_32_0 and not isNil(var_32_9) and arg_29_1.var_.characterEffect1066ui_story == nil then
				arg_29_1.var_.characterEffect1066ui_story = var_32_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_32_10 <= arg_29_1.time_ and arg_29_1.time_ < var_32_10 + var_32_11 and not isNil(var_32_9) then
				...
				if arg_29_1.var_.characterEffect1066ui_story and not isNil(var_32_9) then
					arg_29_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_29_1.time_ >= var_32_10 + var_32_11 and arg_29_1.time_ < var_32_10 + var_32_11 + arg_32_0 and not isNil(var_32_9) and arg_29_1.var_.characterEffect1066ui_story then
				arg_29_1.var_.characterEffect1066ui_story.fillFlat = false
			end
			...
			if var_32_15 < arg_29_1.time_ and arg_29_1.time_ <= var_32_15 + arg_32_0 then
				...
				local var_32_17 = arg_29_1:FormatText(StoryNameCfg[32].name)
				...
				local var_32_18 = arg_29_1:GetWordFromCfg(937081007)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_10 <= arg_33_1.time_ and arg_33_1.time_ < var_36_10 + var_36_11 and not isNil(var_36_9) then
				...
				if arg_33_1.var_.characterEffect1066ui_story and not isNil(var_36_9) then
					...
					arg_33_1.var_.characterEffect1066ui_story.fillRatio = var_36_13
				end
			end
			...
			if arg_33_1.time_ >= var_36_10 + var_36_11 and arg_33_1.time_ < var_36_10 + var_36_11 + arg_36_0 and not isNil(var_36_9) and arg_33_1.var_.characterEffect1066ui_story then
				...
				arg_33_1.var_.characterEffect1066ui_story.fillFlat = true
				arg_33_1.var_.characterEffect1066ui_story.fillRatio = var_36_14
			end

			local var_36_15 = 0
			local var_36_16 = 1.175
			...
			if var_36_15 < arg_33_1.time_ and arg_33_1.time_ <= var_36_15 + arg_36_0 then
				...
				local var_36_17 = arg_33_1:GetWordFromCfg(937081008)
	...
	Play937081009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_15 < arg_37_1.time_ and arg_37_1.time_ <= var_40_15 + arg_40_0 then
				...
				local var_40_18 = arg_37_1:GetWordFromCfg(937081009)
	...
	Play937081010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_6 < arg_41_1.time_ and arg_41_1.time_ <= var_44_6 + arg_44_0 then
				...
				local var_44_9 = arg_41_1:GetWordFromCfg(937081010)
	...
	Play937081011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_9 < arg_45_1.time_ and arg_45_1.time_ <= var_48_9 + arg_48_0 then
				...
				local var_48_11 = arg_45_1:GetWordFromCfg(937081011)
	...
	Play937081012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_0 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:GetWordFromCfg(937081012)
	...
	Play937081013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			local var_56_13 = 0.034000001847744
			...
			if var_56_15 < arg_53_1.time_ and arg_53_1.time_ <= var_56_15 + arg_56_0 then
				...
				local var_56_18 = arg_53_1:GetWordFromCfg(937081013)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_10 <= arg_57_1.time_ and arg_57_1.time_ < var_60_10 + var_60_11 and not isNil(var_60_9) then
				...
				if arg_57_1.var_.characterEffect1066ui_story and not isNil(var_60_9) then
					...
					arg_57_1.var_.characterEffect1066ui_story.fillRatio = var_60_13
				end
			end
			...
			if arg_57_1.time_ >= var_60_10 + var_60_11 and arg_57_1.time_ < var_60_10 + var_60_11 + arg_60_0 and not isNil(var_60_9) and arg_57_1.var_.characterEffect1066ui_story then
				...
				arg_57_1.var_.characterEffect1066ui_story.fillFlat = true
				arg_57_1.var_.characterEffect1066ui_story.fillRatio = var_60_14
			end
			...
			if var_60_15 < arg_57_1.time_ and arg_57_1.time_ <= var_60_15 + arg_60_0 then
				...
				local var_60_17 = arg_57_1:GetWordFromCfg(937081014)
	...
	Play937081015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_15 < arg_61_1.time_ and arg_61_1.time_ <= var_64_15 + arg_64_0 then
				...
				local var_64_18 = arg_61_1:GetWordFromCfg(937081015)
	...
	Play937081016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_6 < arg_65_1.time_ and arg_65_1.time_ <= var_68_6 + arg_68_0 then
				...
				local var_68_9 = arg_65_1:GetWordFromCfg(937081016)
	...
	Play937081017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_1 <= arg_69_1.time_ and arg_69_1.time_ < var_72_1 + var_72_2 then
				...
				local var_72_4 = Vector3.New(0, -0.77, -6.1)
			...
			if arg_69_1.time_ >= var_72_1 + var_72_2 and arg_69_1.time_ < var_72_1 + var_72_2 + arg_72_0 then
				var_72_0.localPosition = Vector3.New(0, -0.77, -6.1)
			...
			if var_72_15 < arg_69_1.time_ and arg_69_1.time_ <= var_72_15 + arg_72_0 then
				...
				local var_72_17 = arg_69_1:FormatText(StoryNameCfg[32].name)
				...
				local var_72_18 = arg_69_1:GetWordFromCfg(937081017)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if var_76_10 <= arg_73_1.time_ and arg_73_1.time_ < var_76_10 + var_76_11 and not isNil(var_76_9) then
				...
				if arg_73_1.var_.characterEffect1066ui_story and not isNil(var_76_9) then
					...
					arg_73_1.var_.characterEffect1066ui_story.fillRatio = var_76_13
				end
			end
			...
			if arg_73_1.time_ >= var_76_10 + var_76_11 and arg_73_1.time_ < var_76_10 + var_76_11 + arg_76_0 and not isNil(var_76_9) and arg_73_1.var_.characterEffect1066ui_story then
				...
				arg_73_1.var_.characterEffect1066ui_story.fillFlat = true
				arg_73_1.var_.characterEffect1066ui_story.fillRatio = var_76_14
			end
			...
			if var_76_15 < arg_73_1.time_ and arg_73_1.time_ <= var_76_15 + arg_76_0 then
				...
				local var_76_17 = arg_73_1:GetWordFromCfg(937081018)
	...
	Play937081019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if var_80_15 < arg_77_1.time_ and arg_77_1.time_ <= var_80_15 + arg_80_0 then
				...
				local var_80_18 = arg_77_1:GetWordFromCfg(937081019)
