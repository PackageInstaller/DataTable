local var_0_0 = {
	Play711190201 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_2 + arg_4_0 then
				local var_4_3 = Vector3.New(0, 1, -10)
			...
			if var_4_23 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				...
				local var_4_26 = arg_1_1:GetWordFromCfg(711190201)
	...
	Play711190202 = function(arg_5_0, arg_5_1)
		arg_5_1.time_ = 0
		arg_5_1.frameCnt_ = 0
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if var_8_0 < arg_5_1.time_ and arg_5_1.time_ <= var_8_0 + arg_8_0 then
				local var_8_1 = Vector3.New(0, 1, -10)

				manager.ui.mainCamera.transform.localPosition = var_8_1

				local var_8_2 = Vector3.New(0, 0, 10) + Vector3.New(var_8_1.x, var_8_1.y, 0)
				local var_8_3 = arg_5_1.bgs_.D999
			...
			if var_8_14 < arg_5_1.time_ and arg_5_1.time_ <= var_8_14 + arg_8_0 then
				local var_8_15 = Object.Instantiate(arg_5_1.narrativeItemGo_)
				local var_8_16 = var_8_15:GetComponent("ComponentCfger")

				ComponentBinder.GetInstance():BindCfgUI(arg_5_0, var_8_15)

				arg_5_0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1119")

				local var_8_17 = arg_5_1:GetWordFromCfg(711190202)
				local var_8_18 = arg_5_1:FormatText(var_8_17.content)

				arg_5_0.narr_item_content.text = var_8_18

				var_8_15.transform:SetParent(arg_5_1.narrativeItemGo_.transform.parent)

				var_8_15.transform.localPosition = Vector3(0, 0, 0)
				var_8_15.transform.localScale = Vector3(1, 1, 1)
			...
			if var_8_14 <= arg_5_1.time_ and arg_5_1.time_ < var_8_14 + var_8_19 and arg_5_1.narrativeListGo_.verticalNormalizedPosition >= 0.001 then
				arg_5_1.narrativeListGo_.verticalNormalizedPosition = 0
			end

			if arg_5_1.time_ >= var_8_14 + var_8_19 and arg_5_1.time_ < var_8_14 + var_8_19 + arg_8_0 then
				-- block empty
			end
		end
	...
	Play711190203 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:GetWordFromCfg(711190203)
	...
	Play711190204 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play711190205(arg_13_1)
			end
		end
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_0 + arg_16_0 then
				...
				local var_16_3 = arg_13_1:GetWordFromCfg(711190204)
	...
	Play711190205 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play711190206(arg_17_1)
			end
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_0 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:GetWordFromCfg(711190205)
	...
	Play711190206 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play711190207(arg_21_1)
			end
		end
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:GetWordFromCfg(711190206)
	...
	Play711190207 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		...
		function arg_25_1.playNext_(arg_27_0)
			if arg_27_0 == 1 then
				arg_25_0:Play711190208(arg_25_1)
			end
		end
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:GetWordFromCfg(711190207)
	...
	Play711190208 = function(arg_29_0, arg_29_1)
		arg_29_1.time_ = 0
		...
		function arg_29_1.playNext_(arg_31_0)
			if arg_31_0 == 1 then
				arg_29_0:Play711190209(arg_29_1)
			end
		end
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_0 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:GetWordFromCfg(711190208)
	...
	Play711190209 = function(arg_33_0, arg_33_1)
		arg_33_1.time_ = 0
		...
		function arg_33_1.playNext_(arg_35_0)
			if arg_35_0 == 1 then
				arg_33_0:Play711190210(arg_33_1)
			end
		end
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_0 + arg_36_0 then
				...
				local var_36_3 = arg_33_1:GetWordFromCfg(711190209)
	...
	Play711190210 = function(arg_37_0, arg_37_1)
		arg_37_1.time_ = 0
		...
		function arg_37_1.playNext_(arg_39_0)
			if arg_39_0 == 1 then
				arg_37_0:Play711190211(arg_37_1)
			end
		end
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_0 + arg_40_0 then
				...
				arg_37_0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1119")

				local var_40_3 = arg_37_1:GetWordFromCfg(711190210)
	...
	Play711190211 = function(arg_41_0, arg_41_1)
		arg_41_1.time_ = 0
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_0 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:GetWordFromCfg(711190211)
