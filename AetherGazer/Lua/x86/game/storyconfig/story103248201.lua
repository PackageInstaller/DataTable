	...
	Play324821001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_38 < arg_1_1.time_ and arg_1_1.time_ <= var_4_38 + arg_4_0 then
				...
				local var_4_41 = arg_1_1:GetWordFromCfg(324821001)
	...
	Play324821002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if var_11_0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_0 + arg_11_0 then
				...
				local var_11_3 = arg_8_1:GetWordFromCfg(324821002)
	...
	Play324821003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if var_15_22 < arg_12_1.time_ and arg_12_1.time_ <= var_15_22 + arg_15_0 then
				...
				local var_15_25 = arg_12_1:GetWordFromCfg(324821003)
				...
				if manager.audio:GetVoiceLength("story_v_out_324821", "324821003", "story_v_out_324821.awb") ~= 0 then
					local var_15_30 = manager.audio:GetVoiceLength("story_v_out_324821", "324821003", "story_v_out_324821.awb") / 1000
					...
					if var_15_25.prefab_name ~= "" and arg_12_1.actors_[var_15_25.prefab_name] ~= nil then
						local var_15_31 = LuaForUtil.PlayVoiceWithCriLipsync(arg_12_1.actors_[var_15_25.prefab_name].transform, "story_v_out_324821", "324821003", "story_v_out_324821.awb")

						arg_12_1:RecordAudio("324821003", var_15_31)
						arg_12_1:RecordAudio("324821003", var_15_31)
					else
	...
	Play324821004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if var_19_6 < arg_16_1.time_ and arg_16_1.time_ <= var_19_6 + arg_19_0 then
				...
				local var_19_9 = arg_16_1:GetWordFromCfg(324821004)
	...
	Play324821005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			if var_23_0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_0 + arg_23_0 then
				...
				local var_23_2 = arg_20_1:GetWordFromCfg(324821005)
	...
	Play324821006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if var_27_0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_0 + arg_27_0 then
				...
				local var_27_3 = arg_24_1:GetWordFromCfg(324821006)
	...
	Play324821007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			if var_31_6 < arg_28_1.time_ and arg_28_1.time_ <= var_31_6 + arg_31_0 then
				...
				local var_31_9 = arg_28_1:GetWordFromCfg(324821007)
				...
				if manager.audio:GetVoiceLength("story_v_out_324821", "324821007", "story_v_out_324821.awb") ~= 0 then
					local var_31_14 = manager.audio:GetVoiceLength("story_v_out_324821", "324821007", "story_v_out_324821.awb") / 1000
					...
					if var_31_9.prefab_name ~= "" and arg_28_1.actors_[var_31_9.prefab_name] ~= nil then
						local var_31_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_9.prefab_name].transform, "story_v_out_324821", "324821007", "story_v_out_324821.awb")

						arg_28_1:RecordAudio("324821007", var_31_15)
						arg_28_1:RecordAudio("324821007", var_31_15)
					else
	...
	Play324821008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if var_35_6 < arg_32_1.time_ and arg_32_1.time_ <= var_35_6 + arg_35_0 then
				...
				local var_35_9 = arg_32_1:GetWordFromCfg(324821008)
	...
	Play324821009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if var_39_4 < arg_36_1.time_ and arg_36_1.time_ <= var_39_4 + arg_39_0 then
				...
				local var_39_7 = arg_36_1:GetWordFromCfg(324821009)
				...
				if manager.audio:GetVoiceLength("story_v_out_324821", "324821009", "story_v_out_324821.awb") ~= 0 then
					local var_39_12 = manager.audio:GetVoiceLength("story_v_out_324821", "324821009", "story_v_out_324821.awb") / 1000
					...
					if var_39_7.prefab_name ~= "" and arg_36_1.actors_[var_39_7.prefab_name] ~= nil then
						local var_39_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_36_1.actors_[var_39_7.prefab_name].transform, "story_v_out_324821", "324821009", "story_v_out_324821.awb")

						arg_36_1:RecordAudio("324821009", var_39_13)
						arg_36_1:RecordAudio("324821009", var_39_13)
					else
	...
	Play324821010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if var_43_6 < arg_40_1.time_ and arg_40_1.time_ <= var_43_6 + arg_43_0 then
				...
				local var_43_9 = arg_40_1:GetWordFromCfg(324821010)
	...
	Play324821011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if var_47_6 < arg_44_1.time_ and arg_44_1.time_ <= var_47_6 + arg_47_0 then
				...
				local var_47_8 = arg_44_1:FormatText(StoryNameCfg[1450].name)
				...
				local var_47_9 = arg_44_1:GetWordFromCfg(324821011)
				...
				if manager.audio:GetVoiceLength("story_v_out_324821", "324821011", "story_v_out_324821.awb") ~= 0 then
					local var_47_14 = manager.audio:GetVoiceLength("story_v_out_324821", "324821011", "story_v_out_324821.awb") / 1000
					...
					if var_47_9.prefab_name ~= "" and arg_44_1.actors_[var_47_9.prefab_name] ~= nil then
						local var_47_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_44_1.actors_[var_47_9.prefab_name].transform, "story_v_out_324821", "324821011", "story_v_out_324821.awb")

						arg_44_1:RecordAudio("324821011", var_47_15)
						arg_44_1:RecordAudio("324821011", var_47_15)
					else
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if var_51_12 <= arg_48_1.time_ and arg_48_1.time_ < var_51_12 + var_51_13 and not isNil(var_51_11) then
				...
				if arg_48_1.var_.characterEffect10170ui_story and not isNil(var_51_11) then
					...
					arg_48_1.var_.characterEffect10170ui_story.fillRatio = var_51_15
				end
			end
			...
			if arg_48_1.time_ >= var_51_12 + var_51_13 and arg_48_1.time_ < var_51_12 + var_51_13 + arg_51_0 and not isNil(var_51_11) and arg_48_1.var_.characterEffect10170ui_story then
				...
				arg_48_1.var_.characterEffect10170ui_story.fillFlat = true
				arg_48_1.var_.characterEffect10170ui_story.fillRatio = var_51_16
			end

			local var_51_17 = 0
			local var_51_18 = 0.575
			...
			if var_51_17 < arg_48_1.time_ and arg_48_1.time_ <= var_51_17 + arg_51_0 then
				...
				local var_51_19 = arg_48_1:GetWordFromCfg(324821012)
	...
	Play324821013 = function(arg_52_0, arg_52_1)
		...
		function arg_52_1.onSingleLineUpdate_(arg_55_0)
			...
			if var_55_1 <= arg_52_1.time_ and arg_52_1.time_ < var_55_1 + var_55_3 then
				...
				local var_55_5 = Vector3.New(0, -1.03, -6.05)
			...
			if arg_52_1.time_ >= var_55_1 + var_55_3 and arg_52_1.time_ < var_55_1 + var_55_3 + arg_55_0 then
				var_55_0.localPosition = Vector3.New(0, -1.03, -6.05)
			...
			local var_55_11 = arg_52_1.actors_["10170ui_story"]
			local var_55_12 = 0

			if var_55_12 < arg_52_1.time_ and arg_52_1.time_ <= var_55_12 + arg_55_0 and not isNil(var_55_11) and arg_52_1.var_.characterEffect10170ui_story == nil then
				arg_52_1.var_.characterEffect10170ui_story = var_55_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_55_12 <= arg_52_1.time_ and arg_52_1.time_ < var_55_12 + var_55_13 and not isNil(var_55_11) then
				...
				if arg_52_1.var_.characterEffect10170ui_story and not isNil(var_55_11) then
					arg_52_1.var_.characterEffect10170ui_story.fillFlat = false
				end
			end

			if arg_52_1.time_ >= var_55_12 + var_55_13 and arg_52_1.time_ < var_55_12 + var_55_13 + arg_55_0 and not isNil(var_55_11) and arg_52_1.var_.characterEffect10170ui_story then
				arg_52_1.var_.characterEffect10170ui_story.fillFlat = false
			end
			...
			if var_55_17 < arg_52_1.time_ and arg_52_1.time_ <= var_55_17 + arg_55_0 then
				...
				local var_55_19 = arg_52_1:FormatText(StoryNameCfg[1450].name)
				...
				local var_55_20 = arg_52_1:GetWordFromCfg(324821013)
				...
				if manager.audio:GetVoiceLength("story_v_out_324821", "324821013", "story_v_out_324821.awb") ~= 0 then
					local var_55_25 = manager.audio:GetVoiceLength("story_v_out_324821", "324821013", "story_v_out_324821.awb") / 1000
					...
					if var_55_20.prefab_name ~= "" and arg_52_1.actors_[var_55_20.prefab_name] ~= nil then
						local var_55_26 = LuaForUtil.PlayVoiceWithCriLipsync(arg_52_1.actors_[var_55_20.prefab_name].transform, "story_v_out_324821", "324821013", "story_v_out_324821.awb")

						arg_52_1:RecordAudio("324821013", var_55_26)
						arg_52_1:RecordAudio("324821013", var_55_26)
					else
	...
	Play324821014 = function(arg_56_0, arg_56_1)
		...
		function arg_56_1.onSingleLineUpdate_(arg_59_0)
			...
			if var_59_6 < arg_56_1.time_ and arg_56_1.time_ <= var_59_6 + arg_59_0 then
				...
				local var_59_9 = arg_56_1:GetWordFromCfg(324821014)
	...
	Play324821015 = function(arg_60_0, arg_60_1)
		...
		function arg_60_1.onSingleLineUpdate_(arg_63_0)
			...
			if var_63_6 < arg_60_1.time_ and arg_60_1.time_ <= var_63_6 + arg_63_0 then
				...
				local var_63_9 = arg_60_1:GetWordFromCfg(324821015)
				...
				if manager.audio:GetVoiceLength("story_v_out_324821", "324821015", "story_v_out_324821.awb") ~= 0 then
					local var_63_14 = manager.audio:GetVoiceLength("story_v_out_324821", "324821015", "story_v_out_324821.awb") / 1000
					...
					if var_63_9.prefab_name ~= "" and arg_60_1.actors_[var_63_9.prefab_name] ~= nil then
						local var_63_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_60_1.actors_[var_63_9.prefab_name].transform, "story_v_out_324821", "324821015", "story_v_out_324821.awb")

						arg_60_1:RecordAudio("324821015", var_63_15)
						arg_60_1:RecordAudio("324821015", var_63_15)
					else
	...
	Play324821016 = function(arg_64_0, arg_64_1)
		...
		function arg_64_1.onSingleLineUpdate_(arg_67_0)
			...
			if var_67_6 < arg_64_1.time_ and arg_64_1.time_ <= var_67_6 + arg_67_0 then
				...
				arg_64_1:AudioAction(var_67_8, var_67_9, "se_story_121_04", "se_story_121_04_walk", "")
			end

			local var_67_10 = 0
			local var_67_11 = 1.425
			...
			if var_67_10 < arg_64_1.time_ and arg_64_1.time_ <= var_67_10 + arg_67_0 then
				...
				local var_67_12 = arg_64_1:GetWordFromCfg(324821016)
	...
	Play324821017 = function(arg_68_0, arg_68_1)
		...
		function arg_68_1.onSingleLineUpdate_(arg_71_0)
			...
			if var_71_6 < arg_68_1.time_ and arg_68_1.time_ <= var_71_6 + arg_71_0 then
				...
				local var_71_9 = arg_68_1:GetWordFromCfg(324821017)
				...
				if manager.audio:GetVoiceLength("story_v_out_324821", "324821017", "story_v_out_324821.awb") ~= 0 then
					local var_71_14 = manager.audio:GetVoiceLength("story_v_out_324821", "324821017", "story_v_out_324821.awb") / 1000
					...
					if var_71_9.prefab_name ~= "" and arg_68_1.actors_[var_71_9.prefab_name] ~= nil then
						local var_71_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_68_1.actors_[var_71_9.prefab_name].transform, "story_v_out_324821", "324821017", "story_v_out_324821.awb")

						arg_68_1:RecordAudio("324821017", var_71_15)
						arg_68_1:RecordAudio("324821017", var_71_15)
					else
