return {
	Play910106001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 910106001
		arg_1_1.duration_ = 6
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_22] == nil then
				local var_4_23 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1094")
			...
			local var_4_26 = arg_1_1.actors_["1094"].transform
			local var_4_27 = 1

			if var_4_27 < arg_1_1.time_ and arg_1_1.time_ <= var_4_27 + arg_4_0 then
				arg_1_1.var_.moveOldPos1094 = var_4_26.localPosition
				var_4_26.localScale = Vector3.New(1, 1, 1)

				arg_1_1:CheckSpriteTmpPos("1094", 3)
			...
			if var_4_27 <= arg_1_1.time_ and arg_1_1.time_ < var_4_27 + var_4_30 then
				...
				var_4_26.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1094, var_4_32, var_4_31)
			end
			...
			local var_4_33 = arg_1_1.actors_["1094"]
			local var_4_34 = 1
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				if var_4_35 then
					arg_1_1.var_.alphaOldValue1094 = var_4_35.alpha
					arg_1_1.var_.characterEffect1094 = var_4_35
				end

				arg_1_1.var_.alphaOldValue1094 = 0
			end
			...
			if var_4_34 <= arg_1_1.time_ and arg_1_1.time_ < var_4_34 + var_4_36 then
				...
				local var_4_38 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1094, 1, var_4_37)

				if arg_1_1.var_.characterEffect1094 then
					arg_1_1.var_.characterEffect1094.alpha = var_4_38
				end
			end

			if arg_1_1.time_ >= var_4_34 + var_4_36 and arg_1_1.time_ < var_4_34 + var_4_36 + arg_4_0 and arg_1_1.var_.characterEffect1094 then
				arg_1_1.var_.characterEffect1094.alpha = 1
			end
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				local var_4_42 = arg_1_1:FormatText(StoryNameCfg[181].name)
				...
				local var_4_43 = arg_1_1:GetWordFromCfg(910106001)
	...
	Play910106002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 910106002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_2 = arg_7_1:FormatText(StoryNameCfg[181].name)
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(910106002)
	...
	Play910106003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 910106003
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			local var_14_0 = arg_11_1.actors_["1094"].transform
			local var_14_1 = 0.0666666666666667

			if var_14_1 < arg_11_1.time_ and arg_11_1.time_ <= var_14_1 + arg_14_0 then
				arg_11_1.var_.moveOldPos1094 = var_14_0.localPosition
				var_14_0.localScale = Vector3.New(1, 1, 1)

				arg_11_1:CheckSpriteTmpPos("1094", 3)
			...
			if var_14_1 <= arg_11_1.time_ and arg_11_1.time_ < var_14_1 + var_14_4 then
				...
				var_14_0.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1094, var_14_6, var_14_5)
			end
			...
			if var_14_7 < arg_11_1.time_ and arg_11_1.time_ <= var_14_7 + arg_14_0 then
				...
				local var_14_9 = arg_11_1:FormatText(StoryNameCfg[181].name)
				...
				local var_14_10 = arg_11_1:GetWordFromCfg(910106003)
