	...
	Play100012001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_3 < arg_1_1.time_ and arg_1_1.time_ <= var_4_3 + arg_4_0 then
				...
				if var_4_4 then
					arg_1_1.var_.alphaOldValueA01b = var_4_4.color.a
					arg_1_1.var_.alphaMatValueA01b = var_4_4
				end
			...
			if var_4_3 <= arg_1_1.time_ and arg_1_1.time_ < var_4_3 + var_4_5 then
				...
				local var_4_7 = Mathf.Lerp(arg_1_1.var_.alphaOldValueA01b, 1, var_4_6)

				if arg_1_1.var_.alphaMatValueA01b then
					local var_4_8 = arg_1_1.var_.alphaMatValueA01b.color

					var_4_8.a = var_4_7
					arg_1_1.var_.alphaMatValueA01b.color = var_4_8
				end
			end

			if arg_1_1.time_ >= var_4_3 + var_4_5 and arg_1_1.time_ < var_4_3 + var_4_5 + arg_4_0 and arg_1_1.var_.alphaMatValueA01b then
				local var_4_9 = arg_1_1.var_.alphaMatValueA01b
			...
			if var_4_11 < arg_1_1.time_ and arg_1_1.time_ <= var_4_11 + arg_4_0 then
				...
				local var_4_14 = arg_1_1.bgs_.A01b
			...
			if var_4_33 < arg_1_1.time_ and arg_1_1.time_ <= var_4_33 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_35, var_4_36, "bgm_story_v0_battleground", "bgm_story_v0_battleground", "bgm_story_v0_battleground")
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				local var_4_42 = arg_1_1:FormatText(StoryNameCfg[5].name)
				...
				local var_4_43 = arg_1_1:GetWordFromCfg(100012001)
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012001", "story_v_out_100012.awb") ~= 0 then
					local var_4_48 = manager.audio:GetVoiceLength("story_v_out_100012", "100012001", "story_v_out_100012.awb") / 1000
					...
					if var_4_43.prefab_name ~= "" and arg_1_1.actors_[var_4_43.prefab_name] ~= nil then
						local var_4_49 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_43.prefab_name].transform, "story_v_out_100012", "100012001", "story_v_out_100012.awb")

						arg_1_1:RecordAudio("100012001", var_4_49)
						arg_1_1:RecordAudio("100012001", var_4_49)
					else
	...
	Play100012007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_1 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				if var_32_2 then
					arg_29_1.var_.alphaOldValueA01b = var_32_2.color.a
					arg_29_1.var_.alphaMatValueA01b = var_32_2
				end
			...
			if var_32_1 <= arg_29_1.time_ and arg_29_1.time_ < var_32_1 + var_32_3 then
				...
				local var_32_5 = Mathf.Lerp(arg_29_1.var_.alphaOldValueA01b, 0, var_32_4)

				if arg_29_1.var_.alphaMatValueA01b then
					local var_32_6 = arg_29_1.var_.alphaMatValueA01b.color

					var_32_6.a = var_32_5
					arg_29_1.var_.alphaMatValueA01b.color = var_32_6
				end
			end

			if arg_29_1.time_ >= var_32_1 + var_32_3 and arg_29_1.time_ < var_32_1 + var_32_3 + arg_32_0 and arg_29_1.var_.alphaMatValueA01b then
				local var_32_7 = arg_29_1.var_.alphaMatValueA01b
				local var_32_8 = var_32_7.color

				var_32_8.a = 0
				var_32_7.color = var_32_8
			end

			local var_32_9 = arg_29_1.bgs_.A01b.transform
			local var_32_10 = 1.5

			if var_32_10 < arg_29_1.time_ and arg_29_1.time_ <= var_32_10 + arg_32_0 then
				arg_29_1.var_.moveOldPosA01b = var_32_9.localPosition
			end
			...
			if var_32_10 <= arg_29_1.time_ and arg_29_1.time_ < var_32_10 + var_32_11 then
				...
				local var_32_13 = Vector3.New(0, -100, 10)

				var_32_9.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPosA01b, var_32_13, var_32_12)
			end

			if arg_29_1.time_ >= var_32_10 + var_32_11 and arg_29_1.time_ < var_32_10 + var_32_11 + arg_32_0 then
				var_32_9.localPosition = Vector3.New(0, -100, 10)
			end

			local var_32_14 = "S0003"

			if arg_29_1.bgs_[var_32_14] == nil then
				local var_32_15 = Object.Instantiate(arg_29_1.paintGo_)

				var_32_15:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. var_32_14)
				var_32_15.name = var_32_14
				var_32_15.transform.parent = arg_29_1.stage_.transform
				var_32_15.transform.localPosition = Vector3.New(0, 100, 0)
				arg_29_1.bgs_[var_32_14] = var_32_15
			end

			local var_32_16 = arg_29_1.bgs_.S0003
			local var_32_17 = 1.5
			...
			if var_32_17 < arg_29_1.time_ and arg_29_1.time_ <= var_32_17 + arg_32_0 then
				...
				if var_32_18 then
					arg_29_1.var_.alphaOldValueS0003 = var_32_18.color.a
					arg_29_1.var_.alphaMatValueS0003 = var_32_18
				end
			...
			if var_32_17 <= arg_29_1.time_ and arg_29_1.time_ < var_32_17 + var_32_19 then
				...
				local var_32_21 = Mathf.Lerp(arg_29_1.var_.alphaOldValueS0003, 1, var_32_20)

				if arg_29_1.var_.alphaMatValueS0003 then
					local var_32_22 = arg_29_1.var_.alphaMatValueS0003.color

					var_32_22.a = var_32_21
					arg_29_1.var_.alphaMatValueS0003.color = var_32_22
				end
			end

			if arg_29_1.time_ >= var_32_17 + var_32_19 and arg_29_1.time_ < var_32_17 + var_32_19 + arg_32_0 and arg_29_1.var_.alphaMatValueS0003 then
				local var_32_23 = arg_29_1.var_.alphaMatValueS0003
			...
			if var_32_25 < arg_29_1.time_ and arg_29_1.time_ <= var_32_25 + arg_32_0 then
				local var_32_26 = manager.ui.mainCamera.transform.localPosition
				local var_32_27 = Vector3.New(0, 0, 10) + Vector3.New(var_32_26.x, var_32_26.y, 0)
				local var_32_28 = arg_29_1.bgs_.S0003

				var_32_28.transform.localPosition = var_32_27
				var_32_28.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_32_29 = var_32_28:GetComponent("SpriteRenderer")

				if var_32_29 and var_32_29.sprite then
					local var_32_30 = (var_32_28.transform.localPosition - var_32_26).z
					local var_32_31 = manager.ui.mainCameraCom_
					local var_32_32 = 2 * var_32_30 * Mathf.Tan(var_32_31.fieldOfView * 0.5 * Mathf.Deg2Rad)
					local var_32_33 = var_32_32 * var_32_31.aspect
					local var_32_34 = var_32_29.sprite.bounds.size.x
					local var_32_35 = var_32_29.sprite.bounds.size.y
					local var_32_36 = var_32_33 / var_32_34
					local var_32_37 = var_32_32 / var_32_35
					local var_32_38 = var_32_37 < var_32_36 and var_32_36 or var_32_37

					var_32_28.transform.localScale = Vector3.New(var_32_38, var_32_38, 0)
				end
			...
			if var_32_39 < arg_29_1.time_ and arg_29_1.time_ <= var_32_39 + arg_32_0 then
				arg_29_1.allBtn_.enabled = false
			end

			local var_32_40 = 1.5

			if arg_29_1.time_ >= var_32_39 + var_32_40 and arg_29_1.time_ < var_32_39 + var_32_40 + arg_32_0 then
			...
			if var_32_41 < arg_29_1.time_ and arg_29_1.time_ <= var_32_41 + arg_32_0 then
				...
				local var_32_43 = LeanTween.value(arg_29_1.dialog_, 0, 1, 0.3)

				var_32_43:setOnUpdate(LuaHelper.FloatAction(function(arg_33_0)
					arg_29_1.dialogCg_.alpha = arg_33_0
				end))
				var_32_43:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_29_1.dialog_)
					var_32_43:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_32_44 = arg_29_1:FormatText(StoryNameCfg[6].name)
				...
				local var_32_45 = arg_29_1:GetWordFromCfg(100012007)
				...
				local var_32_49 = var_32_47 <= 0 and var_32_42 or var_32_42 * (var_32_48 / var_32_47)

				if var_32_49 > 0 and var_32_42 < var_32_49 then
					arg_29_1.talkMaxDuration = var_32_49
					var_32_41 = var_32_41 + 0.3
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012007", "story_v_out_100012.awb") ~= 0 then
					local var_32_50 = manager.audio:GetVoiceLength("story_v_out_100012", "100012007", "story_v_out_100012.awb") / 1000

					if var_32_50 + var_32_41 > arg_29_1.duration_ then
						arg_29_1.duration_ = var_32_50 + var_32_41
					end

					if var_32_45.prefab_name ~= "" and arg_29_1.actors_[var_32_45.prefab_name] ~= nil then
						local var_32_51 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_45.prefab_name].transform, "story_v_out_100012", "100012007", "story_v_out_100012.awb")

						arg_29_1:RecordAudio("100012007", var_32_51)
						arg_29_1:RecordAudio("100012007", var_32_51)
					else
			...
			local var_32_52 = var_32_41 + 0.3
			local var_32_53 = math.max(var_32_42, arg_29_1.talkMaxDuration)

			if var_32_52 <= arg_29_1.time_ and arg_29_1.time_ < var_32_52 + var_32_53 then
				arg_29_1.typewritter.percent = (arg_29_1.time_ - var_32_52) / var_32_53

				arg_29_1.typewritter:SetDirty()
			end

			if arg_29_1.time_ >= var_32_52 + var_32_53 and arg_29_1.time_ < var_32_52 + var_32_53 + arg_32_0 then
