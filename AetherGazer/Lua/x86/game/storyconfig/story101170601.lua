		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_23 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				...
				if not var_4_24 then
					var_4_24 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_red"), var_4_26)
					var_4_24.name = "huo"
			...
			if var_4_27 < arg_1_1.time_ and arg_1_1.time_ <= var_4_27 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_29, var_4_30, "se_story_17", "se_story_17_fire_loop", "")
			end
			...
			if var_4_43 < arg_1_1.time_ and arg_1_1.time_ <= var_4_43 + arg_4_0 then
				...
				local var_4_46 = arg_1_1:GetWordFromCfg(117061001)
