	...
	Play111122001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_17 < arg_1_1.time_ and arg_1_1.time_ <= var_4_17 + arg_4_0 then
				...
				if var_4_18 then
					arg_1_1.var_.alphaOldValueD10 = var_4_18.color.a
					arg_1_1.var_.alphaMatValueD10 = var_4_18
				end
			...
			if var_4_17 <= arg_1_1.time_ and arg_1_1.time_ < var_4_17 + var_4_19 then
				...
				local var_4_21 = Mathf.Lerp(arg_1_1.var_.alphaOldValueD10, 1, var_4_20)

				if arg_1_1.var_.alphaMatValueD10 then
					local var_4_22 = arg_1_1.var_.alphaMatValueD10.color

					var_4_22.a = var_4_21
					arg_1_1.var_.alphaMatValueD10.color = var_4_22
				end
			end

			if arg_1_1.time_ >= var_4_17 + var_4_19 and arg_1_1.time_ < var_4_17 + var_4_19 + arg_4_0 and arg_1_1.var_.alphaMatValueD10 then
				local var_4_23 = arg_1_1.var_.alphaMatValueD10
			...
			if var_4_33 < arg_1_1.time_ and arg_1_1.time_ <= var_4_33 + arg_4_0 then
				...
				local var_4_36 = arg_1_1:GetWordFromCfg(111122001)
