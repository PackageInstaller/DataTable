	...
	Play319471002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_32 < arg_9_1.time_ and arg_9_1.time_ <= var_12_32 + arg_12_0 then
				...
				local var_12_34 = arg_9_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_12_35 = var_12_33:GetComponent("Text")
				local var_12_36 = var_12_33:GetComponent("RectTransform")

				var_12_35.alignment = UnityEngine.TextAnchor.LowerCenter
				var_12_36.offsetMin = Vector2.New(0, 0)
				var_12_36.offsetMax = Vector2.New(0, 0)
			end

			local var_12_37 = 0.433999999999
			local var_12_38 = 2.066
			local var_12_39 = manager.audio:GetVoiceLength("story_v_out_319471", "319471002", "story_v_out_319471.awb") / 1000

			if var_12_39 > 0 and var_12_38 < var_12_39 and var_12_39 + var_12_37 > arg_9_1.duration_ then
				local var_12_40 = var_12_39

				arg_9_1.duration_ = var_12_39 + var_12_37
			end

			if var_12_37 < arg_9_1.time_ and arg_9_1.time_ <= var_12_37 + arg_12_0 then
				local var_12_41 = "play"
				local var_12_42 = "voice"

				arg_9_1:AudioAction(var_12_41, var_12_42, "story_v_out_319471", "319471002", "story_v_out_319471.awb")
			end
		end
