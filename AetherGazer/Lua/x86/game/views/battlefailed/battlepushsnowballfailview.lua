local var_0_0 = class("BattlePushSnowBallFailView", ReduxView)
...
function var_0_0.OnEnter(arg_12_0)
	...
	SetActive(arg_12_0.btnBattleCount_.gameObject, false)

	for iter_12_0 = 1, 3 do
		SetActive(arg_12_0["text" .. iter_12_0 .. "Go_"], false)
	end
