local var_0_0 = class("T0ChatOptionsContent", ReduxView)
...
function var_0_0.AddOptionsBubble(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5)
	local var_4_0 = arg_4_0:GetBubbleItem()

	SetActive(var_4_0, true)

	arg_4_0.bubbleList[arg_4_1] = T0OptionsBubbleItem.New(var_4_0)
