local var_0_0 = class("GuildActivitySPRewardView", ReduxView)
...
function var_0_0.InitUI(arg_6_0)
	...
	arg_6_0.scrollHelper_ = LuaList.New(handler(arg_6_0, arg_6_0.IndexItem), arg_6_0.listGo_, GuildActivitySPRewardItem)
end
...
function var_0_0.OnEnter(arg_7_0)
	...
	arg_7_0.rateIDList_ = GuildActivitySPData:GetSortedRateIDList(arg_7_0.activityID_)
...
function var_0_0.OnGuildActivityReceiveRateReward(arg_10_0)
	arg_10_0.rateIDList_ = GuildActivitySPData:GetSortedRateIDList(arg_10_0.activityID_)

	GuildActivitySPAction.UpdataHadAwardRedPoint(arg_10_0.activityID_)
