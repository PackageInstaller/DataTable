local var_0_0 = class("ChapterV2MapTestLocation", ReduxView)
...
function var_0_0.RefreshUI(arg_5_0)
	...
	local var_5_1 = ChapterV2MapTools.GetLocationEvents(arg_5_0.locationId_) or {}

	arg_5_0.text_.text = arg_5_0.text_.text .. " " .. var_5_0.id .. " > " .. #var_5_1
...
function var_0_0.BindRedPoint(arg_7_0)
	manager.redPoint:bindUIandKey(arg_7_0.transform_, string.format("%s_%s", RedPointConst.CHAPTER_MAP_V2_LOCATION, arg_7_0.locationId_))
end
