local var_0_0 = class("CoreVerificationCommonStageItem", ReduxView)
...
function var_0_0.RefreshUI(arg_6_0, arg_6_1)
	if arg_6_1 then
		...
		for iter_6_1 = 1, 3 do
			local var_6_1 = var_6_0[iter_6_1] and var_6_0[iter_6_1] or 0

			arg_6_0.challengeHeadItems[iter_6_1]:RefreshUI(var_6_1)
		end
	else
		arg_6_0.stateController_:SetSelectedIndex(0)
