local var_0_0 = class("CoreVerificationEnterStageView", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	for iter_4_0 = 1, 2 do
		local var_4_0 = CoreVerificationChallengeTools.GetModeStageActivityId(ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE1)
		local var_4_1 = CoreVerificationClMode1Cfg.get_id_list_by_activity_id[var_4_0]
		local var_4_2 = CoreVerificationClMode1Cfg[var_4_1[iter_4_0]]

		arg_4_0.commonItems[iter_4_0] = CoreVerificationCommonStageItem.New(arg_4_0["selectionGo_" .. iter_4_0], var_4_2, iter_4_0)
	end
...
function var_0_0.UpdateCoreVerification(arg_16_0)
	arg_16_0.common_stage = CoreVerificationChallengeData:GetCommonStage()
	arg_16_0.challenge_stage = CoreVerificationChallengeData:GetChallengeStage()
	arg_16_0.isTips = CoreVerificationChallengeData:GetSeasonIsTips()
...
function var_0_0.RefreshChallengeStage(arg_17_0)
	...
	arg_17_0.challengeStageName_.text = GetI18NText(var_17_1.stage_name)
end

function var_0_0.RefreshCommonStage(arg_18_0)
	local var_18_0 = CoreVerificationChallengeData.GetActivityId()
	local var_18_1 = ActivityCfg[var_18_0].sub_activity_list[2]
	local var_18_2 = CoreVerificationClMode1Cfg.get_id_list_by_activity_id[var_18_1]
...
function var_0_0.RefreshTitle(arg_20_0)
	local var_20_0 = CoreVerificationChallengeTools.GetModeStageActivityId(ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE1)
	local var_20_1 = CoreVerificationClMode1Cfg.get_id_list_by_activity_id[var_20_0]
	local var_20_2 = CoreVerificationClMode1Cfg[var_20_1[3]].stage_com_affix[1]
	local var_20_3 = ActivityAffixPoolCfg[var_20_2].affix

	arg_20_0.comAffixName_.text = getAffixName(var_20_3)
	arg_20_0.comAffixDesc_.text = getAffixDesc(var_20_3)
	...
	local var_20_5 = CoreVerificationChallengeData:GetChallengeStageCfg()
