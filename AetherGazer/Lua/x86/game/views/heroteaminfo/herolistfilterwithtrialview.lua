local var_0_0 = class("HeroListFilterWithTrialView", ReduxView)
...
function var_0_0.SortListByType(arg_10_0, arg_10_1)
	arg_10_0.curSortType_ = arg_10_1
...
function var_0_0.SetHeroDataList(arg_11_0, arg_11_1)
	arg_11_0.heroList_ = arg_11_1

	arg_11_0:RefreshSort(arg_11_0.isAll_, arg_11_0.curSortType_, arg_11_0.curSortRace_, arg_11_0.curAttackType_, arg_11_0.curEnergyType_)
end
	...
	if arg_12_0.isAll_ then
		...
		for iter_12_2, iter_12_3 in ipairs(arg_12_0.heroList_) do
			...
			if var_12_2 and var_12_3 and var_12_4 then
				table.insert(arg_12_0.displayHeroList_, iter_12_3)
			end
		end
	end
...
function var_0_0.UpdateList(arg_14_0)
	...
	table.sort(arg_14_0.displayHeroList_, function(arg_15_0, arg_15_1)
		...
		if arg_14_0.curSortType_ == 0 then
			local var_15_15, var_15_16 = arg_14_0:FightPowerSorter(var_15_7, var_15_8)
			...
			local var_15_18, var_15_19 = arg_14_0:StarSorter(var_15_7, var_15_8)
			...
			local var_15_21, var_15_22 = arg_14_0:RareSorter(var_15_7, var_15_8)
			...
			local var_15_24, var_15_25 = arg_14_0:LevelSorter(var_15_7, var_15_8)
			...
			local var_15_27, var_15_28 = arg_14_0:StarSorter(var_15_7, var_15_8)
			...
			local var_15_30, var_15_31 = arg_14_0:RareSorter(var_15_7, var_15_8)
			...
			local var_15_33, var_15_34 = arg_14_0:FightPowerSorter(var_15_7, var_15_8)
			...
			local var_15_36, var_15_37 = arg_14_0:LevelSorter(var_15_7, var_15_8)
...
function var_0_0.FightPowerSorter(arg_21_0, arg_21_1, arg_21_2)
	local var_21_0 = arg_21_0.heroSorter_:GetHeroPower(arg_21_1)
	local var_21_1 = arg_21_0.heroSorter_:GetHeroPower(arg_21_2)
...
function var_0_0.StarSorter(arg_22_0, arg_22_1, arg_22_2)
...
function var_0_0.RareSorter(arg_23_0, arg_23_1, arg_23_2)
	local var_23_0 = HeroCfg[arg_23_1.id]
	local var_23_1 = HeroCfg[arg_23_2.id]

	if var_23_0.rare ~= var_23_1.rare then
...
function var_0_0.LevelSorter(arg_24_0, arg_24_1, arg_24_2)
...
function var_0_0.ShowDropDown(arg_26_0, arg_26_1)
	SetActive(arg_26_0.panel_, arg_26_1)
end

function var_0_0.Dispose(arg_27_0)
	if arg_27_0.heroSorter_ then
		arg_27_0.heroSorter_:Reset()

		arg_27_0.heroSorter_ = nil
	end
