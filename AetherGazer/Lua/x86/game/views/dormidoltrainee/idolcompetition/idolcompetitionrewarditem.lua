local var_0_0 = class("IdolCompetitionRewardItem", ReduxView)
...
function var_0_0.InitUI(arg_3_0)
	...
	arg_3_0.typeController = arg_3_0.allBtnController_:GetController("type")
...
function var_0_0.RefreshUI(arg_7_0, arg_7_1)
	...
	if var_7_0.type == TaskConst.TASK_TYPE.ACTIVITY_RANDOM_DAILY then
		arg_7_0.typeController:SetSelectedState("daily")
	elseif var_7_0.type == TaskConst.TASK_TYPE.OSIRIS_TASK_CHALLENGE then
		arg_7_0.typeController:SetSelectedState("challenge")
	end

	arg_7_0.rewards = var_7_0.reward or {}
