local var_0_0 = class("AshILLPropPage", ReduxView)
...
function var_0_0.Init(arg_2_0)
	...
	local var_2_0 = AshSystemData:GetPropList()

	for iter_2_0, iter_2_1 in ipairs(var_2_0) do
		table.insert(arg_2_0.modules, AshILLPropModule.New(arg_2_0.transform_, nil, "PROP"))
	end
end
...
function var_0_0.EnterPanel(arg_3_0, arg_3_1)
	...
	local var_3_0 = AshSystemData:GetPropList()
