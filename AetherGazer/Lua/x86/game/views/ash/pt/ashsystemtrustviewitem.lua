local var_0_0 = class("AshSystemTrustViewItem", ReduxView)
...
function var_0_0.RefreshUI(arg_5_0)
	...
	arg_5_0.indexText_.text = arg_5_0.index or 1
	arg_5_0.desc_.text = string.format(GetTips("ASH_PERMANENT_MISSION_DESC"), var_5_1)

	if var_5_1 <= var_5_0 then
		arg_5_0.progressText_.text = var_5_1 .. "/" .. var_5_1
		arg_5_0.progressBar_.value = 1

		if AshSystemData:GetPointRewardIsGet(arg_5_0.rewardID_) then
...
function var_0_0.AddUIListener(arg_7_0)
	arg_7_0:AddBtnListener(arg_7_0.receiveBtn_, nil, function()
		if ItemTools.getItemNum(CurrencyIdMapCfg.CURRENCY_ASH_COIN_4_4.item_id) >= arg_7_0.cfg_.need then
			if AshSystemData:GetPointRewardIsGet(arg_7_0.rewardID_) then
				-- block empty
			else
