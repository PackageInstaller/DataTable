...
local var_0_1 = class("AutoChessDamageNode", var_0_0)

function var_0_1.OnEnter(arg_1_0)
	for iter_1_0, iter_1_1 in ipairs(arg_1_0.actionData.targetHpChangeData) do
		local var_1_0 = iter_1_1.chessUid
		local var_1_1 = AutoChessData:GetChessData(var_1_0)

		if var_1_1 then
			var_1_1.attributeData:AddHp(iter_1_1.hpChange)
		else
			Debug.Log("AutoChessDamageNode: 目标不存在, chessUid = " .. var_1_0)
		end
	end
