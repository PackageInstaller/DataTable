...
local var_0_1 = class("AutoChessLimitTaskView", var_0_0)
...
function var_0_1.BindRedPoint(arg_2_0)
	for iter_2_0 = 1, #arg_2_0.subActivityIDList_ do
		...
		local var_2_1 = RedPointConst.AUTO_CHESS_LIMIT_TASK_TAG .. var_2_0
...
function var_0_1.UnBindRedPoint(arg_3_0)
	for iter_3_0 = 1, #arg_3_0.subActivityIDList_ do
		...
		local var_3_1 = RedPointConst.AUTO_CHESS_LIMIT_TASK_TAG .. var_3_0
