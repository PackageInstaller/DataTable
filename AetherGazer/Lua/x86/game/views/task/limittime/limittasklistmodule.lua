...
function var_0_0.OnCtor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.itemClassModule = arg_1_2
...
function var_0_0.InitContext(arg_2_0)
	arg_2_0.constVar = {
		taskList = {},
		scrollHelper = LuaList.New(handler(arg_2_0, arg_2_0.OnRenderTask), arg_2_0.taskList_ or arg_2_0.m_list, arg_2_0.itemClassModule or LimitTaskItem)
	}
end
