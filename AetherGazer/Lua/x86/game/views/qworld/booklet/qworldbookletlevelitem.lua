local var_0_0 = class("QWorldBookletLevelItem", ReduxView)
...
function var_0_0.SetData(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	arg_6_0.ID_ = arg_6_1
	arg_6_0.titleText.text = arg_6_2 > 9 and arg_6_2 or "0" .. arg_6_2
	arg_6_0.titleText_.text = arg_6_2 > 9 and arg_6_2 or "0" .. arg_6_2

	arg_6_0.controller_:SetSelectedState(arg_6_3)

	arg_6_0.descText_.text = GetTipsF("QWORLD_BOOKLET_POINTREWARD_TASKTIPS", arg_6_2)
	...
	for iter_6_0 = 1, 3 do
		if var_6_0.reward_item_list[iter_6_0] then
			...
			arg_6_0.commonItemList_[iter_6_0]:SetData(var_6_1)
		end
	end
end
