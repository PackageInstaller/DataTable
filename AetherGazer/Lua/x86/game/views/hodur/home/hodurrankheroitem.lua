local var_0_0 = class("HodurRankHeroItem", ReduxView)
...
function var_0_0.initUI(arg_2_0)
	...
	arg_2_0.typeController_ = arg_2_0.controller_:GetController("state01")
end
...
function var_0_0.SetData(arg_3_0, arg_3_1, arg_3_2)
	...
	arg_3_0.typeController_:SetSelectedIndex(arg_3_2 and 0 or 1)
