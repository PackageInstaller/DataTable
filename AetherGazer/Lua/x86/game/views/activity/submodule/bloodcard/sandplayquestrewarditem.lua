local var_0_0 = class("SandPlayQuestRewardItem", ReduxView)
...
function var_0_0.Init(arg_2_0)
	...
	arg_2_0.tagController_ = arg_2_0.controllers_:GetController("type")
	arg_2_0.timeController_ = arg_2_0.controllers_:GetController("time")
end
...
function var_0_0.UpdateView(arg_9_0)
	...
	if arg_9_0.cfg_.type == TaskConst.TASK_TYPE.OSIRIS_TASK_DAILY then
		arg_9_0.tagController_:SetSelectedState("normal")
...
function var_0_0.AddTimer(arg_10_0)
	...
	arg_10_0.timeController_:SetSelectedState("false")
	...
	if var_10_0 then
		if var_10_0 == 0 then
			...
			arg_10_0.timeController_:SetSelectedState("true")
