local var_0_0 = class("RogueCardGameRankItem", BaseView)
...
function var_0_0.SetData(arg_7_0, arg_7_1)
	...
	if #arg_7_1.extraInfo > 0 then
		arg_7_0.viewController:SetSelectedState("normal")
	else
		arg_7_0.viewController:SetSelectedState("lock")
	end
end
