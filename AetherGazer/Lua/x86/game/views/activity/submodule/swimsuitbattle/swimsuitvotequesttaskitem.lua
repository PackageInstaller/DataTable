local var_0_0 = class("SwimsuitVoteQuestTaskItem", ReduxView)
...
function var_0_0.SetData(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_0 = SwimsuitBattleData:GetCurVoteRound()

	arg_8_0:UpdateView(arg_8_2 < var_8_0)
	arg_8_0:AddTimer()
end
...
function var_0_0.UpdateView(arg_9_0, arg_9_1)
	...
	if arg_9_1 then
		if var_9_0 then
			...
			arg_9_0.greyController_:SetSelectedState("false")
		elseif var_9_1 then
			arg_9_0.btnController_:SetSelectedState("receive")
			arg_9_0.greyController_:SetSelectedState("true")
		else
			arg_9_0.btnController_:SetSelectedState("over")
			arg_9_0.greyController_:SetSelectedState("false")
		end
	elseif var_9_0 then
		arg_9_0.btnController_:SetSelectedState("complete")
