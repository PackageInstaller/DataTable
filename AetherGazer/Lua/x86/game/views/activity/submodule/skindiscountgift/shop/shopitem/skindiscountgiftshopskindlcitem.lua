...
local var_0_0 = class("SkinDiscountGiftShopSkinDLCItem", LoopScrollViewBaseItem)
...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.skinItemView_ = SkinDiscountGiftShopSkinItem.New(arg_1_0.skinGo_)
	arg_1_0.dlcItemView_ = SkinDiscountGiftShopDLCItem.New(arg_1_0.dlcGo_)
end
...
function var_0_0.SetData(arg_3_0, arg_3_1, arg_3_2)
	...
	arg_3_0.dlcItemView_:SetData(arg_3_1)
