local var_0_0 = class("DormMypraiseModule", ReduxView)
...
function var_0_0.indexTemplate(arg_16_0, arg_16_1, arg_16_2)
	arg_16_2:RefreshUI(arg_16_0.visitList[arg_16_1], 3)
end
...
function var_0_0.OnRefreshBtnClick(arg_21_0)
	arg_21_0:RefreshList(true)
end

function var_0_0.OnDanceBtnClick(arg_22_0)
	arg_22_0:SwitchMode("dance")
end
