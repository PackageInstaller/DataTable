local var_0_0 = class("BattleActivityWaterGunnerTemplate", BattleBaseStageTemplate)

function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	arg_1_0.cfg = BattleActivityWaterGunnerCfg[arg_1_1]
...
function var_0_0.GetIsCooperation(arg_16_0)
	return false, {
		arg_16_0.serverTeamPlayer
	}
end
