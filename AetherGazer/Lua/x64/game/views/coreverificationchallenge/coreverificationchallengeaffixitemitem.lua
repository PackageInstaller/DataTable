local var_0_0 = class("CoreVerificationChallengeAffixItemItem", ReduxView)
...
function var_0_0.RefreshUI(arg_6_0, arg_6_1)
	arg_6_0.categoryController_:SetSelectedIndex(arg_6_1.type - 1)

	local var_6_0 = ActivityAffixPoolCfg[arg_6_1.buff_id].affix
