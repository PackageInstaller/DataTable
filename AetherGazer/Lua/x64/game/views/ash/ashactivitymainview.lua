...
local var_0_0 = class("AshActivityMainView", ActivityMainBasePanel)
...
function var_0_0.AddUIListeners(arg_4_0)
	arg_4_0:AddBtnListener(arg_4_0.infoBtn_, nil, function()
		local var_5_0 = "ASH_ENTRANCE_TIP"
...
function var_0_0.OnEnter(arg_8_0)
	...
	manager.redPoint:bindUIandKey(arg_8_0.goBtn_.transform, RedPointConst.ASH_ACTIVITY_MAIN .. ActivityConst.ACTIVITY_ASH_MAIN)
	manager.redPoint:bindUIandKey(arg_8_0.rewardRedRoot_.transform, RedPointConst.ASH_ACTIVITY_LIMIT_TASK .. ActivityConst.ACTIVITY_ASH_LIMITED_TASK)
end
