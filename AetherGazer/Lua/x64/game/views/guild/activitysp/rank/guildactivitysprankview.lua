local var_0_0 = class("GuildActivitySPRankView", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	arg_4_0.scrollHelper_ = LuaList.New(handler(arg_4_0, arg_4_0.IndexItem), arg_4_0.listGo_, GuildActivitySPRaceRankItem)
end
...
function var_0_0.RefreshUI(arg_9_0)
	arg_9_0.rankList_ = GuildActivitySPData:GetRankList()
