local var_0_0 = class("GuildActivitySPRecordView", ReduxView)
...
function var_0_0.InitUI(arg_5_0)
	...
	arg_5_0.recordList_ = LuaList.New(handler(arg_5_0, arg_5_0.indexItem), arg_5_0.uiListGo_, GuildActivitySPRecordItemView)
end
