local var_0_0 = class("GodEaterDrawServantSelectView", ReduxView)
...
function var_0_0.RefreshTitle(arg_13_0, arg_13_1)
	...
	if var_13_1 and var_13_0.optional_detail[var_13_1] then
		...
		arg_13_0.titleText_.text = string.format(GetTips("CHOOSE_SERVANT_COMBINATION"), ItemTools.getItemName(var_13_3))
	end
end
