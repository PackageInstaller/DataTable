local var_0_0 = class("SummerRaceSkinPopView_5_2", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	local var_4_0 = ActivityConst.ACTIVITY_NYA_SUMMER_RACE_SKIN_DLC
...
function var_0_0.RefreshUI(arg_8_0)
	arg_8_0.descText_.text = string.format(GetTips("CHAPTER_REMAKE_SKIN_POP_DESC"))
	arg_8_0.heroImage_.sprite = pureGetSpriteWithoutAtlas(GameSetting.chapter_remake_skin_dlc_hero_image.value[1])
