...
function var_0_0.RefreshReplace(arg_9_0)
	...
	for iter_9_0, iter_9_1 in ipairs(arg_9_0.replaceList_) do
		...
		elseif var_9_1.type == ItemConst.ITEM_TYPE.HERO_SKIN or ActivitySkinDrawTools.GetIsSkinGift(var_9_0) then
...
function var_0_0.NextCode(arg_11_0)
	...
	if arg_11_0.index_ < #arg_11_0.showList_ then
		...
		local var_11_1 = ActivityLimitedDrawPoolCfg[var_11_0].reward[1][1]
		local var_11_2 = ItemCfg[var_11_1]
		local var_11_3 = 1

		if var_11_2.rare >= 5 then
			var_11_3 = 3
		...
		if ActivitySkinDrawTools.GetIsSkinGift(var_11_1) then
			...
			var_11_2 = ItemCfg[var_11_1]
		end

		if var_11_2.type == ItemConst.ITEM_TYPE.FRAME then
			arg_11_0:ShowReward(var_11_3, var_11_0, arg_11_0.isReplaceFrame_)
		elseif var_11_2.type == ItemConst.ITEM_TYPE.HERO_SKIN then
			var_11_3 = 4

			manager.audio:StopEffect()
			manager.audio:PlayEffect("ui_system_search", arg_11_0.soundEffect_[var_11_3], "")
			arg_11_0:ShowAni(var_11_3, var_11_0, arg_11_0.isReplaceSkin_)
		elseif var_11_2.type == ItemConst.ITEM_TYPE.SCENE then
			arg_11_0.isScene_ = not arg_11_0.isReplaceScene_
			arg_11_0.sceneId_ = var_11_1
			var_11_3 = 4

			arg_11_0:ShowReward(var_11_3, var_11_0, arg_11_0.isReplaceScene_)
		elseif var_11_2.type == ItemConst.ITEM_TYPE.DYNAMIC_STICKER then
			arg_11_0:ShowReward(var_11_3, var_11_0, arg_11_0.isReplaceSticker_)
		else
			arg_11_0:ShowReward(var_11_3, var_11_0)
		end
	else
		arg_11_0:GotoResult()
	end
