local var_0_0 = class("RogueCardGameCardBuffItem", ReduxView)
...
function var_0_0.SetData(arg_7_0, arg_7_1, arg_7_2)
	...
	if RogueCardGameTools.IsUnlockCardBuff(arg_7_0.id) then
		...
		if var_7_0.type == 2 then
			arg_7_0.sealCon_:SetSelectedIndex(1)
			SetActive(arg_7_0.icon_.gameObject, false)

			arg_7_0.sealIcon_.sprite = pureGetSpriteWithoutAtlas("TextureConfig/Activity_JokerCard/itembg/" .. var_7_0.pic)
		else
			arg_7_0.sealCon_:SetSelectedIndex(0)
			SetActive(arg_7_0.icon_.gameObject, true)
