local var_0_0 = class("RogueCardGameSkinDLCPopView", ReduxView)
...
function var_0_0.InitUI(arg_4_0)
	...
	for iter_4_0 = 1, 2 do
		...
		arg_4_0.taskList[iter_4_0] = RogueCardGameCommonActivityTaskItem.New(arg_4_0[var_4_0])
	end
end
...
function var_0_0.OnEnter(arg_7_0)
	arg_7_0.activityID_ = ActivityConst.ACTIVITY_ROGUECARD_SKIN
	arg_7_0.descText_.text = GetTips("ROGUE_CARD_SKIN_POP_DESC")
