local var_0_0 = class("ActivityOathGiftItem", ReduxView)
...
function var_0_0.SetData(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5)
	arg_4_0.dropID = arg_4_1

	local var_4_0 = ActivityLimitedDrawPoolCfg[arg_4_1].reward
	local var_4_1 = var_4_0[1][1]
	local var_4_2 = var_4_0[1][2]
	local var_4_3 = ItemCfg[var_4_1].param
	...
	if ActivityOathDrawData:GetDrawInfo(arg_4_2, arg_4_1).num <= 0 and not arg_4_5 then
		arg_4_0.getController_:SetSelectedState("get")
	else
		arg_4_0.getController_:SetSelectedState("normal")
	end
end
