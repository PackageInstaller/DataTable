...
function var_0_0.DialogueNode_2(arg_11_0)
	...
	arg_11_0:SetTalkContent(11121001, "", 9516)
...
function var_0_0.DialogueNode_3(arg_16_0)
	arg_16_0:PlayActorAnimationAction(907301, "summer_doubt", 0.05, 2, function()
		return
	end)
	arg_16_0:ShowTalkView()
	arg_16_0:SetTalkContent(11121002, "", 9073)
...
function var_0_0.DialogueNode_4(arg_21_0)
	...
	arg_21_0:SetTalkContent(11121003, "", 9516)
...
function var_0_0.DialogueNode_5(arg_27_0)
	arg_27_0:PlayActorAnimationAction(907301, "think_start", 0.05, 1.333333, function()
		return
	end)
	arg_27_0:ShowTalkView()
	arg_27_0:SetTalkContent(11121004, "", 9073)
...
function var_0_0.DialogueNode_6(arg_32_0)
	...
	arg_32_0:SetTalkContent(11121005, "", 9516)
...
function var_0_0.DialogueNode_7(arg_37_0)
	...
	arg_37_0:SetTalkContent(11121006, "", 9073)
...
function var_0_0.DialogueNode_8(arg_41_0)
	...
	arg_41_0:SetTalkContent(11121007, "", 9516)
...
function var_0_0.DialogueNode_9(arg_46_0)
	arg_46_0:PlayActorAnimationAction(907301, "think_end", 0.05, 1.666667, function()
		return
	end)
	arg_46_0:ShowTalkView()
	arg_46_0:SetTalkContent(11121008, "", 9073)
...
function var_0_0.BlackFadeDialogueNode_10(arg_51_0)
	...
	arg_51_0:OnBlackFade(false, 0, 0.2, 0.5, 0.5, function()
		...
		arg_51_0:DestroyCharAction(907301)
