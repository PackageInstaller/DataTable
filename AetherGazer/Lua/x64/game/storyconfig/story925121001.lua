return {
	Play925121001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_36 = 1.84166666666667
			...
			if var_4_36 < arg_1_1.time_ and arg_1_1.time_ <= var_4_36 + arg_4_0 then
				...
				local var_4_40 = arg_1_1:GetWordFromCfg(925121001)
	...
	Play925121002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_5 < arg_9_1.time_ and arg_9_1.time_ <= var_12_5 + arg_12_0 and not isNil(var_12_4) and arg_9_1.var_.actorSpriteComps10022 == nil then
			...
			if arg_9_1.time_ >= var_12_5 + var_12_6 and arg_9_1.time_ < var_12_5 + var_12_6 + arg_12_0 and not isNil(var_12_4) and arg_9_1.var_.actorSpriteComps10022 then
			...
			local var_12_12 = arg_9_1.actors_["10022"].transform
			local var_12_13 = 0

			if var_12_13 < arg_9_1.time_ and arg_9_1.time_ <= var_12_13 + arg_12_0 then
				arg_9_1.var_.moveOldPos10022 = var_12_12.localPosition
				...
				for iter_12_6 = 0, var_12_14 - 1 do
					...
					if var_12_15.name == "split_8" or not string.find(var_12_15.name, "split") then
			...
			if var_12_13 <= arg_9_1.time_ and arg_9_1.time_ < var_12_13 + var_12_16 then
				...
				local var_12_18 = Vector3.New(0, -340, -365)

				var_12_12.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos10022, var_12_18, var_12_17)
			end

			if arg_9_1.time_ >= var_12_13 + var_12_16 and arg_9_1.time_ < var_12_13 + var_12_16 + arg_12_0 then
				var_12_12.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if var_12_19 < arg_9_1.time_ and arg_9_1.time_ <= var_12_19 + arg_12_0 then
				...
				local var_12_22 = arg_9_1:GetWordFromCfg(925121002)
	...
	Play925121003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_8 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_11 = arg_13_1:GetWordFromCfg(925121003)
	...
	Play925121004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_8 < arg_17_1.time_ and arg_17_1.time_ <= var_20_8 + arg_20_0 then
				...
				local var_20_11 = arg_17_1:GetWordFromCfg(925121004)
	...
	Play925121005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_8 < arg_21_1.time_ and arg_21_1.time_ <= var_24_8 + arg_24_0 then
				...
				local var_24_11 = arg_21_1:GetWordFromCfg(925121005)
	...
	Play925121006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			local var_28_8 = arg_25_1.actors_["10022"].transform
			local var_28_9 = 0

			if var_28_9 < arg_25_1.time_ and arg_25_1.time_ <= var_28_9 + arg_28_0 then
				arg_25_1.var_.moveOldPos10022 = var_28_8.localPosition
				...
				for iter_28_4 = 0, var_28_10 - 1 do
					...
					if var_28_11.name == "split_1" or not string.find(var_28_11.name, "split") then
			...
			if var_28_9 <= arg_25_1.time_ and arg_25_1.time_ < var_28_9 + var_28_12 then
				...
				local var_28_14 = Vector3.New(0, -340, -365)

				var_28_8.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos10022, var_28_14, var_28_13)
			end

			if arg_25_1.time_ >= var_28_9 + var_28_12 and arg_25_1.time_ < var_28_9 + var_28_12 + arg_28_0 then
				var_28_8.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if var_28_15 < arg_25_1.time_ and arg_25_1.time_ <= var_28_15 + arg_28_0 then
				...
				local var_28_18 = arg_25_1:GetWordFromCfg(925121006)
	...
	Play925121007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_8 < arg_29_1.time_ and arg_29_1.time_ <= var_32_8 + arg_32_0 then
				...
				local var_32_11 = arg_29_1:GetWordFromCfg(925121007)
	...
	Play925121008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			local var_36_8 = arg_33_1.actors_["10022"].transform
			local var_36_9 = 0

			if var_36_9 < arg_33_1.time_ and arg_33_1.time_ <= var_36_9 + arg_36_0 then
				arg_33_1.var_.moveOldPos10022 = var_36_8.localPosition
				...
				for iter_36_4 = 0, var_36_10 - 1 do
					...
					if var_36_11.name == "split_8" or not string.find(var_36_11.name, "split") then
			...
			if var_36_9 <= arg_33_1.time_ and arg_33_1.time_ < var_36_9 + var_36_12 then
				...
				local var_36_14 = Vector3.New(0, -340, -365)

				var_36_8.localPosition = Vector3.Lerp(arg_33_1.var_.moveOldPos10022, var_36_14, var_36_13)
			end

			if arg_33_1.time_ >= var_36_9 + var_36_12 and arg_33_1.time_ < var_36_9 + var_36_12 + arg_36_0 then
				var_36_8.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if var_36_15 < arg_33_1.time_ and arg_33_1.time_ <= var_36_15 + arg_36_0 then
				...
				local var_36_17 = arg_33_1:FormatText(StoryNameCfg[614].name)
				...
				local var_36_18 = arg_33_1:GetWordFromCfg(925121008)
	...
	Play925121009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_8 < arg_37_1.time_ and arg_37_1.time_ <= var_40_8 + arg_40_0 then
				...
				local var_40_11 = arg_37_1:GetWordFromCfg(925121009)
	...
	Play925121010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_15 < arg_41_1.time_ and arg_41_1.time_ <= var_44_15 + arg_44_0 then
				...
				local var_44_18 = arg_41_1:GetWordFromCfg(925121010)
	...
	Play925121011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_8 < arg_45_1.time_ and arg_45_1.time_ <= var_48_8 + arg_48_0 then
				...
				local var_48_11 = arg_45_1:GetWordFromCfg(925121011)
	...
	Play925121012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_8 < arg_49_1.time_ and arg_49_1.time_ <= var_52_8 + arg_52_0 then
				...
				local var_52_10 = arg_49_1:FormatText(StoryNameCfg[614].name)
				...
				local var_52_11 = arg_49_1:GetWordFromCfg(925121012)
	...
	Play925121013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_7 < arg_53_1.time_ and arg_53_1.time_ <= var_56_7 + arg_56_0 then
				...
				local var_56_10 = arg_53_1:GetWordFromCfg(925121013)
	...
	Play925121014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_0 + arg_60_0 then
				...
				local var_60_2 = arg_57_1:FormatText(StoryNameCfg[614].name)
				...
				local var_60_3 = arg_57_1:GetWordFromCfg(925121014)
	...
	Play925121015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_8 < arg_61_1.time_ and arg_61_1.time_ <= var_64_8 + arg_64_0 then
				...
				local var_64_11 = arg_61_1:GetWordFromCfg(925121015)
	...
	Play925121016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			local var_68_8 = arg_65_1.actors_["10022"].transform
			local var_68_9 = 0

			if var_68_9 < arg_65_1.time_ and arg_65_1.time_ <= var_68_9 + arg_68_0 then
				arg_65_1.var_.moveOldPos10022 = var_68_8.localPosition
			...
			if var_68_9 <= arg_65_1.time_ and arg_65_1.time_ < var_68_9 + var_68_12 then
				...
				local var_68_14 = Vector3.New(0, -340, -365)

				var_68_8.localPosition = Vector3.Lerp(arg_65_1.var_.moveOldPos10022, var_68_14, var_68_13)
			end

			if arg_65_1.time_ >= var_68_9 + var_68_12 and arg_65_1.time_ < var_68_9 + var_68_12 + arg_68_0 then
				var_68_8.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if var_68_15 < arg_65_1.time_ and arg_65_1.time_ <= var_68_15 + arg_68_0 then
				...
				local var_68_17 = arg_65_1:FormatText(StoryNameCfg[614].name)
				...
				local var_68_18 = arg_65_1:GetWordFromCfg(925121016)
	...
	Play925121017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_8 < arg_69_1.time_ and arg_69_1.time_ <= var_72_8 + arg_72_0 then
				...
				local var_72_11 = arg_69_1:GetWordFromCfg(925121017)
	...
	Play925121018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			local var_76_8 = arg_73_1.actors_["10022"].transform
			local var_76_9 = 0

			if var_76_9 < arg_73_1.time_ and arg_73_1.time_ <= var_76_9 + arg_76_0 then
				arg_73_1.var_.moveOldPos10022 = var_76_8.localPosition
			...
			if var_76_9 <= arg_73_1.time_ and arg_73_1.time_ < var_76_9 + var_76_12 then
				...
				local var_76_14 = Vector3.New(0, -340, -365)

				var_76_8.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPos10022, var_76_14, var_76_13)
			end

			if arg_73_1.time_ >= var_76_9 + var_76_12 and arg_73_1.time_ < var_76_9 + var_76_12 + arg_76_0 then
				var_76_8.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if var_76_15 < arg_73_1.time_ and arg_73_1.time_ <= var_76_15 + arg_76_0 then
				...
				local var_76_17 = arg_73_1:FormatText(StoryNameCfg[614].name)
				...
				local var_76_18 = arg_73_1:GetWordFromCfg(925121018)
