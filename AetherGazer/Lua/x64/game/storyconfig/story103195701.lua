	...
	Play319571014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_30 < arg_57_1.time_ and arg_57_1.time_ <= var_60_30 + arg_60_0 then
				...
				local var_60_32 = arg_57_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_60_33 = var_60_31:GetComponent("Text")
				local var_60_34 = var_60_31:GetComponent("RectTransform")

				var_60_33.alignment = UnityEngine.TextAnchor.LowerCenter
				var_60_34.offsetMin = Vector2.New(0, 0)
				var_60_34.offsetMax = Vector2.New(0, 0)
			end
			...
			if var_60_35 < arg_57_1.time_ and arg_57_1.time_ <= var_60_35 + arg_60_0 then
				...
				local var_60_36 = arg_57_1.cswt_:GetComponent("RectTransform")

				arg_57_1.cswt_.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_60_36.offsetMin = Vector2.New(410, 330)
				var_60_36.offsetMax = Vector2.New(-400, -175)

				local var_60_37 = arg_57_1:GetWordFromCfg(419030)
				local var_60_38 = arg_57_1:FormatText(var_60_37.content)

				arg_57_1.cswt_.text = var_60_38
			...
			local var_60_39 = arg_57_1.actors_["10066ui_story"].transform
			local var_60_40 = 0

			if var_60_40 < arg_57_1.time_ and arg_57_1.time_ <= var_60_40 + arg_60_0 then
				arg_57_1.var_.moveOldPos10066ui_story = var_60_39.localPosition
			end

			local var_60_41 = 0.001
			...
			if var_60_40 <= arg_57_1.time_ and arg_57_1.time_ < var_60_40 + var_60_41 then
				...
				local var_60_43 = Vector3.New(0, 100, 0)

				var_60_39.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos10066ui_story, var_60_43, var_60_42)

				local var_60_44 = manager.ui.mainCamera.transform.position - var_60_39.position

				var_60_39.forward = Vector3.New(var_60_44.x, var_60_44.y, var_60_44.z)

				local var_60_45 = var_60_39.localEulerAngles

				var_60_45.z = 0
				var_60_45.x = 0
				var_60_39.localEulerAngles = var_60_45
			end

			if arg_57_1.time_ >= var_60_40 + var_60_41 and arg_57_1.time_ < var_60_40 + var_60_41 + arg_60_0 then
				var_60_39.localPosition = Vector3.New(0, 100, 0)

				local var_60_46 = manager.ui.mainCamera.transform.position - var_60_39.position

				var_60_39.forward = Vector3.New(var_60_46.x, var_60_46.y, var_60_46.z)

				local var_60_47 = var_60_39.localEulerAngles

				var_60_47.z = 0
				var_60_47.x = 0
				var_60_39.localEulerAngles = var_60_47
			end

			local var_60_48 = arg_57_1.actors_["10079ui_story"].transform
			local var_60_49 = 0

			if var_60_49 < arg_57_1.time_ and arg_57_1.time_ <= var_60_49 + arg_60_0 then
				arg_57_1.var_.moveOldPos10079ui_story = var_60_48.localPosition
			end
			...
			if var_60_49 <= arg_57_1.time_ and arg_57_1.time_ < var_60_49 + var_60_50 then
				...
				var_60_48.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos10079ui_story, var_60_52, var_60_51)
			...
			local var_60_57 = 0.333333333333333
			local var_60_58 = 6.1
			local var_60_59 = manager.audio:GetVoiceLength("story_v_out_319571", "319571014", "story_v_out_319571.awb") / 1000

			if var_60_59 > 0 and var_60_58 < var_60_59 and var_60_59 + var_60_57 > arg_57_1.duration_ then
				local var_60_60 = var_60_59

				arg_57_1.duration_ = var_60_59 + var_60_57
			end

			if var_60_57 < arg_57_1.time_ and arg_57_1.time_ <= var_60_57 + arg_60_0 then
				local var_60_61 = "play"
				local var_60_62 = "voice"

				arg_57_1:AudioAction(var_60_61, var_60_62, "story_v_out_319571", "319571014", "story_v_out_319571.awb")
			end
		end
