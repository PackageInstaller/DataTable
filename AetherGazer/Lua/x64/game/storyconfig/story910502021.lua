return {
	Play910502008 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 910502008
		arg_1_1.duration_ = 7
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_24 = "10048ui_story"

			if arg_1_1.actors_[var_4_24] == nil then
				local var_4_25 = Asset.Load("Char/" .. "10048ui_story")

				if not isNil(var_4_25) then
					local var_4_26 = Object.Instantiate(Asset.Load("Char/" .. "10048ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_29 = arg_1_1.actors_["10048ui_story"].transform
			local var_4_30 = 1.8

			if var_4_30 < arg_1_1.time_ and arg_1_1.time_ <= var_4_30 + arg_4_0 then
				arg_1_1.var_.moveOldPos10048ui_story = var_4_29.localPosition
			end
			...
			if var_4_30 <= arg_1_1.time_ and arg_1_1.time_ < var_4_30 + var_4_31 then
				...
				local var_4_33 = Vector3.New(0, -1.155, -6.13)

				var_4_29.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos10048ui_story, var_4_33, var_4_32)
			...
			if arg_1_1.time_ >= var_4_30 + var_4_31 and arg_1_1.time_ < var_4_30 + var_4_31 + arg_4_0 then
				var_4_29.localPosition = Vector3.New(0, -1.155, -6.13)
			...
			local var_4_38 = arg_1_1.actors_["10048ui_story"]
			local var_4_39 = 1.8

			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 and not isNil(var_4_38) and arg_1_1.var_.characterEffect10048ui_story == nil then
				arg_1_1.var_.characterEffect10048ui_story = var_4_38:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_4_39 <= arg_1_1.time_ and arg_1_1.time_ < var_4_39 + var_4_40 and not isNil(var_4_38) then
				...
				if arg_1_1.var_.characterEffect10048ui_story and not isNil(var_4_38) then
					arg_1_1.var_.characterEffect10048ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= var_4_39 + var_4_40 and arg_1_1.time_ < var_4_39 + var_4_40 + arg_4_0 and not isNil(var_4_38) and arg_1_1.var_.characterEffect10048ui_story then
				arg_1_1.var_.characterEffect10048ui_story.fillFlat = false
			end
			...
			if var_4_42 < arg_1_1.time_ and arg_1_1.time_ <= var_4_42 + arg_4_0 then
				arg_1_1:PlayTimeline("10048ui_story", "StoryTimeline/CharAction/story10048/story10048action/10048action7_1")
			end

			local var_4_43 = 1.8

			if var_4_43 < arg_1_1.time_ and arg_1_1.time_ <= var_4_43 + arg_4_0 then
				arg_1_1:PlayTimeline("10048ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3101cva")
			end
			...
			if var_4_44 < arg_1_1.time_ and arg_1_1.time_ <= var_4_44 + arg_4_0 then
				...
				local var_4_47 = arg_1_1:FormatText(StoryNameCfg[476].name)
				...
				local var_4_48 = arg_1_1:GetWordFromCfg(910502008)
	...
	Play910502009 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 910502009
		arg_7_1.duration_ = 5
		...
		function arg_7_1.playNext_(arg_9_0)
			if arg_9_0 == 1 then
				arg_7_0:Play910502010(arg_7_1)
			end
		end

		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			local var_10_0 = arg_7_1.actors_["10048ui_story"].transform
			local var_10_1 = 0

			if var_10_1 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				arg_7_1.var_.moveOldPos10048ui_story = var_10_0.localPosition
			end
			...
			if var_10_1 <= arg_7_1.time_ and arg_7_1.time_ < var_10_1 + var_10_2 then
				...
				var_10_0.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos10048ui_story, var_10_4, var_10_3)
			...
			if var_10_10 < arg_7_1.time_ and arg_7_1.time_ <= var_10_10 + arg_10_0 and not isNil(var_10_9) and arg_7_1.var_.characterEffect10048ui_story == nil then
			...
			if var_10_10 <= arg_7_1.time_ and arg_7_1.time_ < var_10_10 + var_10_11 and not isNil(var_10_9) then
				...
				if arg_7_1.var_.characterEffect10048ui_story and not isNil(var_10_9) then
					...
					arg_7_1.var_.characterEffect10048ui_story.fillFlat = true
					arg_7_1.var_.characterEffect10048ui_story.fillRatio = var_10_13
				end
			end

			if arg_7_1.time_ >= var_10_10 + var_10_11 and arg_7_1.time_ < var_10_10 + var_10_11 + arg_10_0 and not isNil(var_10_9) and arg_7_1.var_.characterEffect10048ui_story then
				local var_10_14 = 0.5

				arg_7_1.var_.characterEffect10048ui_story.fillFlat = true
				arg_7_1.var_.characterEffect10048ui_story.fillRatio = var_10_14
			end
			...
			if var_10_15 < arg_7_1.time_ and arg_7_1.time_ <= var_10_15 + arg_10_0 then
				...
				local var_10_18 = arg_7_1:GetWordFromCfg(910502009)
	...
	Play910502010 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 910502010
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play910502011(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_6 <= arg_11_1.time_ and arg_11_1.time_ < var_14_6 + var_14_7 then
				...
				local var_14_9 = Vector3.New(-0.7, -0.965, -6.2)
			...
			if arg_11_1.time_ >= var_14_6 + var_14_7 and arg_11_1.time_ < var_14_6 + var_14_7 + arg_14_0 then
				var_14_5.localPosition = Vector3.New(-0.7, -0.965, -6.2)
			...
			if var_14_20 < arg_11_1.time_ and arg_11_1.time_ <= var_14_20 + arg_14_0 then
				...
				local var_14_23 = arg_11_1:GetWordFromCfg(910502010)
	...
	Play910502011 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 910502011
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_1 <= arg_15_1.time_ and arg_15_1.time_ < var_18_1 + var_18_2 then
				...
				local var_18_4 = Vector3.New(0.7, -1.155, -6.13)
			...
			if arg_15_1.time_ >= var_18_1 + var_18_2 and arg_15_1.time_ < var_18_1 + var_18_2 + arg_18_0 then
				var_18_0.localPosition = Vector3.New(0.7, -1.155, -6.13)
			...
			if var_18_14 < arg_15_1.time_ and arg_15_1.time_ <= var_18_14 + arg_18_0 then
				arg_15_1:PlayTimeline("10048ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0102cva")
			end

			local var_18_15 = arg_15_1.actors_["1055ui_story"]
			local var_18_16 = 0

			if var_18_16 < arg_15_1.time_ and arg_15_1.time_ <= var_18_16 + arg_18_0 and not isNil(var_18_15) and arg_15_1.var_.characterEffect1055ui_story == nil then
				arg_15_1.var_.characterEffect1055ui_story = var_18_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_18_16 <= arg_15_1.time_ and arg_15_1.time_ < var_18_16 + var_18_17 and not isNil(var_18_15) then
				...
				if arg_15_1.var_.characterEffect1055ui_story and not isNil(var_18_15) then
					local var_18_19 = Mathf.Lerp(0, 0.5, var_18_18)

					arg_15_1.var_.characterEffect1055ui_story.fillFlat = true
					arg_15_1.var_.characterEffect1055ui_story.fillRatio = var_18_19
				end
			end

			if arg_15_1.time_ >= var_18_16 + var_18_17 and arg_15_1.time_ < var_18_16 + var_18_17 + arg_18_0 and not isNil(var_18_15) and arg_15_1.var_.characterEffect1055ui_story then
				local var_18_20 = 0.5

				arg_15_1.var_.characterEffect1055ui_story.fillFlat = true
				arg_15_1.var_.characterEffect1055ui_story.fillRatio = var_18_20
			end
			...
			if var_18_21 < arg_15_1.time_ and arg_15_1.time_ <= var_18_21 + arg_18_0 then
				...
				local var_18_23 = arg_15_1:FormatText(StoryNameCfg[476].name)
				...
				local var_18_24 = arg_15_1:GetWordFromCfg(910502011)
