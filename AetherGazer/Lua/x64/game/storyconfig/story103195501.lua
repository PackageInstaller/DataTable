	...
	Play319551056 = function(arg_225_0, arg_225_1)
		...
		function arg_225_1.onSingleLineUpdate_(arg_228_0)
			...
			if var_228_16 < arg_225_1.time_ and arg_225_1.time_ <= var_228_16 + arg_228_0 then
				...
				local var_228_18 = arg_225_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_228_19 = var_228_17:GetComponent("Text")
				local var_228_20 = var_228_17:GetComponent("RectTransform")

				var_228_19.alignment = UnityEngine.TextAnchor.LowerCenter
			...
			if var_228_21 < arg_225_1.time_ and arg_225_1.time_ <= var_228_21 + arg_228_0 then
				...
				local var_228_22 = arg_225_1:GetWordFromCfg(319551056)
				local var_228_23 = arg_225_1:FormatText(var_228_22.content)

				arg_225_1.fswt_.text = var_228_23
			...
			local var_228_24 = 0.433333333333334
			...
			local var_228_25 = 16
			local var_228_26 = 1.06666666666667
			local var_228_27 = arg_225_1:GetWordFromCfg(319551056)
			local var_228_28 = arg_225_1:FormatText(var_228_27.content)
			local var_228_29, var_228_30 = arg_225_1:GetPercentByPara(var_228_28, 1)

			if var_228_24 < arg_225_1.time_ and arg_225_1.time_ <= var_228_24 + arg_228_0 then
				arg_225_1.talkMaxDuration = 0

				local var_228_31 = var_228_25 <= 0 and var_228_26 or var_228_26 * ((var_228_30 - arg_225_1.typewritterCharCountI18N) / var_228_25)

				if var_228_31 > 0 and var_228_26 < var_228_31 then
			...
			local var_228_32 = 1.06666666666667
			local var_228_33 = math.max(var_228_32, arg_225_1.talkMaxDuration)

			if var_228_24 <= arg_225_1.time_ and arg_225_1.time_ < var_228_24 + var_228_33 then
				local var_228_34 = (arg_225_1.time_ - var_228_24) / var_228_33

				arg_225_1.fswtw_.percent = Mathf.Lerp(arg_225_1.var_.oldValueTypewriter, var_228_29, var_228_34)
				arg_225_1.fswt_:GetComponent("Text").color = Color(1, 1, 1)

				arg_225_1.fswtw_:SetDirty()
			end

			if arg_225_1.time_ >= var_228_24 + var_228_33 and arg_225_1.time_ < var_228_24 + var_228_33 + arg_228_0 then
				arg_225_1.fswtw_.percent = var_228_29

				arg_225_1.fswtw_:SetDirty()
				arg_225_1:ShowNextGo(true)

				arg_225_1.typewritterCharCountI18N = var_228_30
			end

			local var_228_35 = 4.44089209850063e-16

			if var_228_35 < arg_225_1.time_ and arg_225_1.time_ <= var_228_35 + arg_228_0 then
				arg_225_1.cswbg_:SetActive(true)

				local var_228_36 = arg_225_1.cswt_:GetComponent("RectTransform")

				arg_225_1.cswt_.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_228_36.offsetMin = Vector2.New(410, 330)
				var_228_36.offsetMax = Vector2.New(-400, -175)

				local var_228_37 = arg_225_1:GetWordFromCfg(419029)
				local var_228_38 = arg_225_1:FormatText(var_228_37.content)

				arg_225_1.cswt_.text = var_228_38
			...
			local var_228_39 = arg_225_1.actors_["1084ui_story"].transform
			local var_228_40 = 0

			if var_228_40 < arg_225_1.time_ and arg_225_1.time_ <= var_228_40 + arg_228_0 then
				arg_225_1.var_.moveOldPos1084ui_story = var_228_39.localPosition
			end

			local var_228_41 = 0.001
			...
			if var_228_40 <= arg_225_1.time_ and arg_225_1.time_ < var_228_40 + var_228_41 then
				...
				local var_228_43 = Vector3.New(0, 100, 0)

				var_228_39.localPosition = Vector3.Lerp(arg_225_1.var_.moveOldPos1084ui_story, var_228_43, var_228_42)

				local var_228_44 = manager.ui.mainCamera.transform.position - var_228_39.position

				var_228_39.forward = Vector3.New(var_228_44.x, var_228_44.y, var_228_44.z)

				local var_228_45 = var_228_39.localEulerAngles

				var_228_45.z = 0
				var_228_45.x = 0
				var_228_39.localEulerAngles = var_228_45
			end

			if arg_225_1.time_ >= var_228_40 + var_228_41 and arg_225_1.time_ < var_228_40 + var_228_41 + arg_228_0 then
				var_228_39.localPosition = Vector3.New(0, 100, 0)

				local var_228_46 = manager.ui.mainCamera.transform.position - var_228_39.position

				var_228_39.forward = Vector3.New(var_228_46.x, var_228_46.y, var_228_46.z)

				local var_228_47 = var_228_39.localEulerAngles

				var_228_47.z = 0
				var_228_47.x = 0
				var_228_39.localEulerAngles = var_228_47
			end

			local var_228_48 = arg_225_1.actors_["10058ui_story"].transform
			local var_228_49 = 0

			if var_228_49 < arg_225_1.time_ and arg_225_1.time_ <= var_228_49 + arg_228_0 then
				arg_225_1.var_.moveOldPos10058ui_story = var_228_48.localPosition
			end

			local var_228_50 = 0.001

			if var_228_49 <= arg_225_1.time_ and arg_225_1.time_ < var_228_49 + var_228_50 then
				local var_228_51 = (arg_225_1.time_ - var_228_49) / var_228_50
				local var_228_52 = Vector3.New(0, 100, 0)

				var_228_48.localPosition = Vector3.Lerp(arg_225_1.var_.moveOldPos10058ui_story, var_228_52, var_228_51)

				local var_228_53 = manager.ui.mainCamera.transform.position - var_228_48.position

				var_228_48.forward = Vector3.New(var_228_53.x, var_228_53.y, var_228_53.z)

				local var_228_54 = var_228_48.localEulerAngles

				var_228_54.z = 0
				var_228_54.x = 0
				var_228_48.localEulerAngles = var_228_54
			end

			if arg_225_1.time_ >= var_228_49 + var_228_50 and arg_225_1.time_ < var_228_49 + var_228_50 + arg_228_0 then
				var_228_48.localPosition = Vector3.New(0, 100, 0)

				local var_228_55 = manager.ui.mainCamera.transform.position - var_228_48.position

				var_228_48.forward = Vector3.New(var_228_55.x, var_228_55.y, var_228_55.z)

				local var_228_56 = var_228_48.localEulerAngles

				var_228_56.z = 0
				var_228_56.x = 0
				var_228_48.localEulerAngles = var_228_56
			end

			local var_228_57 = 0.433333333333334
			local var_228_58 = 4.066
			local var_228_59 = manager.audio:GetVoiceLength("story_v_out_319551", "319551056", "story_v_out_319551.awb") / 1000

			if var_228_59 > 0 and var_228_58 < var_228_59 and var_228_59 + var_228_57 > arg_225_1.duration_ then
				local var_228_60 = var_228_59

				arg_225_1.duration_ = var_228_59 + var_228_57
			end

			if var_228_57 < arg_225_1.time_ and arg_225_1.time_ <= var_228_57 + arg_228_0 then
				local var_228_61 = "play"
				local var_228_62 = "voice"

				arg_225_1:AudioAction(var_228_61, var_228_62, "story_v_out_319551", "319551056", "story_v_out_319551.awb")
			end
		end
