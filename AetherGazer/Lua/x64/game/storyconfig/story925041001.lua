return {
	Play925041001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_22] == nil then
				local var_4_23 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1034")
			...
			local var_4_26 = arg_1_1.actors_["1034"]
			local var_4_27 = 1.675

			if var_4_27 < arg_1_1.time_ and arg_1_1.time_ <= var_4_27 + arg_4_0 and not isNil(var_4_26) and arg_1_1.var_.actorSpriteComps1034 == nil then
				arg_1_1.var_.actorSpriteComps1034 = var_4_26:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_1_1.time_ >= var_4_27 + var_4_28 and arg_1_1.time_ < var_4_27 + var_4_28 + arg_4_0 and not isNil(var_4_26) and arg_1_1.var_.actorSpriteComps1034 then
			...
			local var_4_34 = arg_1_1.actors_["1034"].transform
			local var_4_35 = 1.675

			if var_4_35 < arg_1_1.time_ and arg_1_1.time_ <= var_4_35 + arg_4_0 then
				arg_1_1.var_.moveOldPos1034 = var_4_34.localPosition
			...
			if var_4_35 <= arg_1_1.time_ and arg_1_1.time_ < var_4_35 + var_4_38 then
				...
				local var_4_40 = Vector3.New(0, -350, -180)

				var_4_34.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1034, var_4_40, var_4_39)
			end

			if arg_1_1.time_ >= var_4_35 + var_4_38 and arg_1_1.time_ < var_4_35 + var_4_38 + arg_4_0 then
				var_4_34.localPosition = Vector3.New(0, -350, -180)
			end

			local var_4_41 = arg_1_1.actors_["1034"]
			local var_4_42 = 1.675

			if var_4_42 < arg_1_1.time_ and arg_1_1.time_ <= var_4_42 + arg_4_0 then
				local var_4_43 = var_4_41:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_43 then
					arg_1_1.var_.alphaOldValue1034 = var_4_43.alpha
					arg_1_1.var_.characterEffect1034 = var_4_43
				end

				arg_1_1.var_.alphaOldValue1034 = 0
			end

			local var_4_44 = 0.325

			if var_4_42 <= arg_1_1.time_ and arg_1_1.time_ < var_4_42 + var_4_44 then
				local var_4_45 = (arg_1_1.time_ - var_4_42) / var_4_44
				local var_4_46 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1034, 1, var_4_45)

				if arg_1_1.var_.characterEffect1034 then
					arg_1_1.var_.characterEffect1034.alpha = var_4_46
				end
			end

			if arg_1_1.time_ >= var_4_42 + var_4_44 and arg_1_1.time_ < var_4_42 + var_4_44 + arg_4_0 and arg_1_1.var_.characterEffect1034 then
			...
			if var_4_53 < arg_1_1.time_ and arg_1_1.time_ <= var_4_53 + arg_4_0 then
				...
				local var_4_57 = ""
				local var_4_58 = manager.audio:GetAudioName("bgm_side_daily03", "bgm_side_daily03")
			...
			if var_4_59 < arg_1_1.time_ and arg_1_1.time_ <= var_4_59 + arg_4_0 then
				...
				local var_4_62 = arg_1_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_4_63 = arg_1_1:GetWordFromCfg(925041001)
	...
	Play925041002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			local var_12_0 = arg_9_1.actors_["1034"]
			local var_12_1 = 0

			if var_12_1 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 and not isNil(var_12_0) and arg_9_1.var_.actorSpriteComps1034 == nil then
				arg_9_1.var_.actorSpriteComps1034 = var_12_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_9_1.time_ >= var_12_1 + var_12_2 and arg_9_1.time_ < var_12_1 + var_12_2 + arg_12_0 and not isNil(var_12_0) and arg_9_1.var_.actorSpriteComps1034 then
			...
			if var_12_8 < arg_9_1.time_ and arg_9_1.time_ <= var_12_8 + arg_12_0 then
				...
				local var_12_11 = arg_9_1:GetWordFromCfg(925041002)
	...
	Play925041003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			local var_16_0 = arg_13_1.actors_["1034"]
			local var_16_1 = 0

			if var_16_1 < arg_13_1.time_ and arg_13_1.time_ <= var_16_1 + arg_16_0 and not isNil(var_16_0) and arg_13_1.var_.actorSpriteComps1034 == nil then
				arg_13_1.var_.actorSpriteComps1034 = var_16_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_13_1.time_ >= var_16_1 + var_16_2 and arg_13_1.time_ < var_16_1 + var_16_2 + arg_16_0 and not isNil(var_16_0) and arg_13_1.var_.actorSpriteComps1034 then
			...
			if var_16_8 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_16_11 = arg_13_1:GetWordFromCfg(925041003)
	...
	Play925041004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			local var_20_0 = arg_17_1.actors_["1034"]
			local var_20_1 = 0

			if var_20_1 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 and not isNil(var_20_0) and arg_17_1.var_.actorSpriteComps1034 == nil then
				arg_17_1.var_.actorSpriteComps1034 = var_20_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_17_1.time_ >= var_20_1 + var_20_2 and arg_17_1.time_ < var_20_1 + var_20_2 + arg_20_0 and not isNil(var_20_0) and arg_17_1.var_.actorSpriteComps1034 then
			...
			if var_20_8 < arg_17_1.time_ and arg_17_1.time_ <= var_20_8 + arg_20_0 then
				...
				local var_20_11 = arg_17_1:GetWordFromCfg(925041004)
	...
	Play925041005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			local var_24_8 = arg_21_1.actors_["1034"].transform
			local var_24_9 = 0

			if var_24_9 < arg_21_1.time_ and arg_21_1.time_ <= var_24_9 + arg_24_0 then
				arg_21_1.var_.moveOldPos1034 = var_24_8.localPosition
			...
			if var_24_9 <= arg_21_1.time_ and arg_21_1.time_ < var_24_9 + var_24_12 then
				...
				local var_24_14 = Vector3.New(0, -350, -180)

				var_24_8.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1034, var_24_14, var_24_13)
			end

			if arg_21_1.time_ >= var_24_9 + var_24_12 and arg_21_1.time_ < var_24_9 + var_24_12 + arg_24_0 then
				var_24_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_24_15 < arg_21_1.time_ and arg_21_1.time_ <= var_24_15 + arg_24_0 then
				...
				local var_24_17 = arg_21_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_24_18 = arg_21_1:GetWordFromCfg(925041005)
	...
	Play925041006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_8 < arg_25_1.time_ and arg_25_1.time_ <= var_28_8 + arg_28_0 then
				...
				local var_28_11 = arg_25_1:GetWordFromCfg(925041006)
	...
	Play925041007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_9 <= arg_29_1.time_ and arg_29_1.time_ < var_32_9 + var_32_12 then
				...
				local var_32_14 = Vector3.New(0, -350, -180)
			...
			if arg_29_1.time_ >= var_32_9 + var_32_12 and arg_29_1.time_ < var_32_9 + var_32_12 + arg_32_0 then
				var_32_8.localPosition = Vector3.New(0, -350, -180)
			end

			local var_32_15 = 0
			local var_32_16 = 0.825
			...
			if var_32_15 < arg_29_1.time_ and arg_29_1.time_ <= var_32_15 + arg_32_0 then
				...
				local var_32_18 = arg_29_1:GetWordFromCfg(925041007)
	...
	Play925041008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_0 + arg_36_0 then
				...
				local var_36_2 = arg_33_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_36_3 = arg_33_1:GetWordFromCfg(925041008)
	...
	Play925041009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_8 < arg_37_1.time_ and arg_37_1.time_ <= var_40_8 + arg_40_0 then
				...
				local var_40_11 = arg_37_1:GetWordFromCfg(925041009)
	...
	Play925041010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			local var_44_0 = arg_41_1.actors_["1034"]
			local var_44_1 = 0

			if var_44_1 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 and not isNil(var_44_0) and arg_41_1.var_.actorSpriteComps1034 == nil then
				arg_41_1.var_.actorSpriteComps1034 = var_44_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_41_1.time_ >= var_44_1 + var_44_2 and arg_41_1.time_ < var_44_1 + var_44_2 + arg_44_0 and not isNil(var_44_0) and arg_41_1.var_.actorSpriteComps1034 then
			...
			local var_44_8 = arg_41_1.actors_["1034"].transform
			local var_44_9 = 0

			if var_44_9 < arg_41_1.time_ and arg_41_1.time_ <= var_44_9 + arg_44_0 then
				arg_41_1.var_.moveOldPos1034 = var_44_8.localPosition
			...
			if var_44_9 <= arg_41_1.time_ and arg_41_1.time_ < var_44_9 + var_44_12 then
				...
				local var_44_14 = Vector3.New(0, -350, -180)

				var_44_8.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1034, var_44_14, var_44_13)
			end

			if arg_41_1.time_ >= var_44_9 + var_44_12 and arg_41_1.time_ < var_44_9 + var_44_12 + arg_44_0 then
				var_44_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_44_15 < arg_41_1.time_ and arg_41_1.time_ <= var_44_15 + arg_44_0 then
				...
				local var_44_17 = arg_41_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_44_18 = arg_41_1:GetWordFromCfg(925041010)
	...
	Play925041011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			local var_48_0 = arg_45_1.actors_["1034"].transform
			local var_48_1 = 0

			if var_48_1 < arg_45_1.time_ and arg_45_1.time_ <= var_48_1 + arg_48_0 then
				arg_45_1.var_.moveOldPos1034 = var_48_0.localPosition
			...
			if var_48_1 <= arg_45_1.time_ and arg_45_1.time_ < var_48_1 + var_48_4 then
				...
				var_48_0.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1034, var_48_6, var_48_5)
			end
			...
			if var_48_7 < arg_45_1.time_ and arg_45_1.time_ <= var_48_7 + arg_48_0 then
				...
				local var_48_9 = arg_45_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_48_10 = arg_45_1:GetWordFromCfg(925041011)
	...
	Play925041012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			local var_52_0 = arg_49_1.actors_["1034"]
			local var_52_1 = 0

			if var_52_1 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 and not isNil(var_52_0) and arg_49_1.var_.actorSpriteComps1034 == nil then
				arg_49_1.var_.actorSpriteComps1034 = var_52_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_49_1.time_ >= var_52_1 + var_52_2 and arg_49_1.time_ < var_52_1 + var_52_2 + arg_52_0 and not isNil(var_52_0) and arg_49_1.var_.actorSpriteComps1034 then
			...
			if var_52_8 < arg_49_1.time_ and arg_49_1.time_ <= var_52_8 + arg_52_0 then
				...
				local var_52_11 = arg_49_1:GetWordFromCfg(925041012)
	...
	Play925041013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_9 <= arg_53_1.time_ and arg_53_1.time_ < var_56_9 + var_56_12 then
				...
				local var_56_14 = Vector3.New(0, -350, -180)
			...
			if arg_53_1.time_ >= var_56_9 + var_56_12 and arg_53_1.time_ < var_56_9 + var_56_12 + arg_56_0 then
				var_56_8.localPosition = Vector3.New(0, -350, -180)
			end

			local var_56_15 = 0
			local var_56_16 = 0.675
			...
			if var_56_15 < arg_53_1.time_ and arg_53_1.time_ <= var_56_15 + arg_56_0 then
				...
				local var_56_18 = arg_53_1:GetWordFromCfg(925041013)
	...
	Play925041014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			local var_60_0 = arg_57_1.actors_["1034"]
			local var_60_1 = 0

			if var_60_1 < arg_57_1.time_ and arg_57_1.time_ <= var_60_1 + arg_60_0 and not isNil(var_60_0) and arg_57_1.var_.actorSpriteComps1034 == nil then
				arg_57_1.var_.actorSpriteComps1034 = var_60_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_57_1.time_ >= var_60_1 + var_60_2 and arg_57_1.time_ < var_60_1 + var_60_2 + arg_60_0 and not isNil(var_60_0) and arg_57_1.var_.actorSpriteComps1034 then
			...
			if var_60_8 < arg_57_1.time_ and arg_57_1.time_ <= var_60_8 + arg_60_0 then
				...
				local var_60_11 = arg_57_1:GetWordFromCfg(925041014)
	...
	Play925041015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			local var_64_8 = arg_61_1.actors_["1034"].transform
			local var_64_9 = 0

			if var_64_9 < arg_61_1.time_ and arg_61_1.time_ <= var_64_9 + arg_64_0 then
				arg_61_1.var_.moveOldPos1034 = var_64_8.localPosition
			...
			if var_64_9 <= arg_61_1.time_ and arg_61_1.time_ < var_64_9 + var_64_12 then
				...
				local var_64_14 = Vector3.New(0, -350, -180)

				var_64_8.localPosition = Vector3.Lerp(arg_61_1.var_.moveOldPos1034, var_64_14, var_64_13)
			end

			if arg_61_1.time_ >= var_64_9 + var_64_12 and arg_61_1.time_ < var_64_9 + var_64_12 + arg_64_0 then
				var_64_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_64_15 < arg_61_1.time_ and arg_61_1.time_ <= var_64_15 + arg_64_0 then
				...
				local var_64_17 = arg_61_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_64_18 = arg_61_1:GetWordFromCfg(925041015)
	...
	Play925041016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_8 < arg_65_1.time_ and arg_65_1.time_ <= var_68_8 + arg_68_0 then
				...
				local var_68_11 = arg_65_1:GetWordFromCfg(925041016)
	...
	Play925041017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			local var_72_8 = arg_69_1.actors_["1034"].transform
			local var_72_9 = 0

			if var_72_9 < arg_69_1.time_ and arg_69_1.time_ <= var_72_9 + arg_72_0 then
				arg_69_1.var_.moveOldPos1034 = var_72_8.localPosition
				...
				for iter_72_4 = 0, var_72_10 - 1 do
					...
					if var_72_11.name == "split_5" or not string.find(var_72_11.name, "split") then
			...
			if var_72_9 <= arg_69_1.time_ and arg_69_1.time_ < var_72_9 + var_72_12 then
				...
				local var_72_14 = Vector3.New(0, -350, -180)

				var_72_8.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos1034, var_72_14, var_72_13)
			end

			if arg_69_1.time_ >= var_72_9 + var_72_12 and arg_69_1.time_ < var_72_9 + var_72_12 + arg_72_0 then
				var_72_8.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_72_15 < arg_69_1.time_ and arg_69_1.time_ <= var_72_15 + arg_72_0 then
				...
				local var_72_17 = arg_69_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_72_18 = arg_69_1:GetWordFromCfg(925041017)
