return {
	Play320671001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_56 = 2
			local var_4_57 = 0.366666666666667
			...
			if var_4_56 < arg_1_1.time_ and arg_1_1.time_ <= var_4_56 + arg_4_0 then
				...
				local var_4_60 = arg_1_1:GetWordFromCfg(320671001)
	...
	Play320671002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_6 < arg_9_1.time_ and arg_9_1.time_ <= var_12_6 + arg_12_0 then
				...
				local var_12_9 = arg_9_1:GetWordFromCfg(320671002)
	...
	Play320671003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_15 < arg_13_1.time_ and arg_13_1.time_ <= var_16_15 + arg_16_0 then
				...
				local var_16_18 = arg_13_1:GetWordFromCfg(320671003)
	...
	Play320671004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			local var_20_0 = arg_17_1.actors_["10102ui_story"]
			local var_20_1 = 0

			if var_20_1 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 and not isNil(var_20_0) and arg_17_1.var_.characterEffect10102ui_story == nil then
				arg_17_1.var_.characterEffect10102ui_story = var_20_0:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_20_1 <= arg_17_1.time_ and arg_17_1.time_ < var_20_1 + var_20_2 and not isNil(var_20_0) then
				...
				if arg_17_1.var_.characterEffect10102ui_story and not isNil(var_20_0) then
					local var_20_4 = Mathf.Lerp(0, 0.5, var_20_3)

					arg_17_1.var_.characterEffect10102ui_story.fillFlat = true
					arg_17_1.var_.characterEffect10102ui_story.fillRatio = var_20_4
				end
			end

			if arg_17_1.time_ >= var_20_1 + var_20_2 and arg_17_1.time_ < var_20_1 + var_20_2 + arg_20_0 and not isNil(var_20_0) and arg_17_1.var_.characterEffect10102ui_story then
				local var_20_5 = 0.5

				arg_17_1.var_.characterEffect10102ui_story.fillFlat = true
				arg_17_1.var_.characterEffect10102ui_story.fillRatio = var_20_5
			end
			...
			if var_20_6 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_9 = arg_17_1:GetWordFromCfg(320671004)
	...
	Play320671005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_5 < arg_21_1.time_ and arg_21_1.time_ <= var_24_5 + arg_24_0 then
				...
				local var_24_8 = arg_21_1:GetWordFromCfg(320671005)
	...
	Play320671006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_6 < arg_25_1.time_ and arg_25_1.time_ <= var_28_6 + arg_28_0 then
				...
				local var_28_8 = arg_25_1:GetWordFromCfg(320671006)
	...
	Play320671007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_0 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:GetWordFromCfg(320671007)
	...
	Play320671008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_14 < arg_33_1.time_ and arg_33_1.time_ <= var_36_14 + arg_36_0 then
				...
				local var_36_17 = arg_33_1:GetWordFromCfg(320671008)
	...
	Play320671009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_6 < arg_37_1.time_ and arg_37_1.time_ <= var_40_6 + arg_40_0 then
				...
				local var_40_9 = arg_37_1:GetWordFromCfg(320671009)
	...
	Play320671010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_4 < arg_41_1.time_ and arg_41_1.time_ <= var_44_4 + arg_44_0 then
				...
				local var_44_6 = arg_41_1:FormatText(StoryNameCfg[6].name)
				...
				local var_44_7 = arg_41_1:GetWordFromCfg(320671010)
	...
	Play320671011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_6 < arg_45_1.time_ and arg_45_1.time_ <= var_48_6 + arg_48_0 then
				...
				local var_48_9 = arg_45_1:GetWordFromCfg(320671011)
	...
	Play320671012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_15 < arg_49_1.time_ and arg_49_1.time_ <= var_52_15 + arg_52_0 then
				...
				local var_52_18 = arg_49_1:GetWordFromCfg(320671012)
	...
	Play320671013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_0 + arg_56_0 then
				...
				local var_56_3 = arg_53_1:GetWordFromCfg(320671013)
	...
	Play320671014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_1 < arg_57_1.time_ and arg_57_1.time_ <= var_60_1 + arg_60_0 then
				...
				local var_60_3 = arg_57_1:FormatText(StoryNameCfg[6].name)
				...
				local var_60_4 = arg_57_1:GetWordFromCfg(320671014)
	...
	Play320671015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_6 < arg_61_1.time_ and arg_61_1.time_ <= var_64_6 + arg_64_0 then
				...
				local var_64_9 = arg_61_1:GetWordFromCfg(320671015)
	...
	Play320671016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_6 < arg_65_1.time_ and arg_65_1.time_ <= var_68_6 + arg_68_0 then
				...
				local var_68_9 = arg_65_1:GetWordFromCfg(320671016)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_10 <= arg_69_1.time_ and arg_69_1.time_ < var_72_10 + var_72_11 and not isNil(var_72_9) then
				...
				if arg_69_1.var_.characterEffect10102ui_story and not isNil(var_72_9) then
					...
					arg_69_1.var_.characterEffect10102ui_story.fillRatio = var_72_13
				end
			end
			...
			if arg_69_1.time_ >= var_72_10 + var_72_11 and arg_69_1.time_ < var_72_10 + var_72_11 + arg_72_0 and not isNil(var_72_9) and arg_69_1.var_.characterEffect10102ui_story then
				...
				arg_69_1.var_.characterEffect10102ui_story.fillFlat = true
				arg_69_1.var_.characterEffect10102ui_story.fillRatio = var_72_14
			end
			...
			if var_72_15 < arg_69_1.time_ and arg_69_1.time_ <= var_72_15 + arg_72_0 then
				...
				local var_72_17 = arg_69_1:GetWordFromCfg(320671017)
	...
	Play320671018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if var_76_0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_0 + arg_76_0 then
				...
				local var_76_2 = arg_73_1:GetWordFromCfg(320671018)
	...
	Play320671019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if var_80_0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_0 + arg_80_0 then
				...
				local var_80_3 = arg_77_1:GetWordFromCfg(320671019)
	...
	Play320671020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if var_84_15 < arg_81_1.time_ and arg_81_1.time_ <= var_84_15 + arg_84_0 then
				...
				local var_84_18 = arg_81_1:GetWordFromCfg(320671020)
	...
	Play320671021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if var_88_6 < arg_85_1.time_ and arg_85_1.time_ <= var_88_6 + arg_88_0 then
				...
				local var_88_8 = arg_85_1:GetWordFromCfg(320671021)
	...
	Play320671022 = function(arg_89_0, arg_89_1)
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			...
			if var_92_0 < arg_89_1.time_ and arg_89_1.time_ <= var_92_0 + arg_92_0 then
				...
				local var_92_3 = arg_89_1:GetWordFromCfg(320671022)
	...
	Play320671023 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if var_96_14 < arg_93_1.time_ and arg_93_1.time_ <= var_96_14 + arg_96_0 then
				...
				local var_96_16 = arg_93_1:FormatText(StoryNameCfg[6].name)
				...
				local var_96_17 = arg_93_1:GetWordFromCfg(320671023)
	...
	Play320671024 = function(arg_97_0, arg_97_1)
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			...
			if var_100_2 < arg_97_1.time_ and arg_97_1.time_ <= var_100_2 + arg_100_0 then
				...
				local var_100_5 = arg_97_1:GetWordFromCfg(320671024)
	...
	Play320671025 = function(arg_101_0, arg_101_1)
		...
		function arg_101_1.onSingleLineUpdate_(arg_104_0)
			...
			if var_104_6 < arg_101_1.time_ and arg_101_1.time_ <= var_104_6 + arg_104_0 then
				...
				local var_104_9 = arg_101_1:GetWordFromCfg(320671025)
