return {
	Play111141001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_17 < arg_1_1.time_ and arg_1_1.time_ <= var_4_17 + arg_4_0 then
				...
				if var_4_18 then
					arg_1_1.var_.alphaOldValueD999 = var_4_18.color.a
					arg_1_1.var_.alphaMatValueD999 = var_4_18
				end
			...
			if var_4_17 <= arg_1_1.time_ and arg_1_1.time_ < var_4_17 + var_4_19 then
				...
				local var_4_21 = Mathf.Lerp(arg_1_1.var_.alphaOldValueD999, 1, var_4_20)

				if arg_1_1.var_.alphaMatValueD999 then
					local var_4_22 = arg_1_1.var_.alphaMatValueD999.color

					var_4_22.a = var_4_21
					arg_1_1.var_.alphaMatValueD999.color = var_4_22
				end
			end

			if arg_1_1.time_ >= var_4_17 + var_4_19 and arg_1_1.time_ < var_4_17 + var_4_19 + arg_4_0 and arg_1_1.var_.alphaMatValueD999 then
				local var_4_23 = arg_1_1.var_.alphaMatValueD999
			...
			local var_4_25 = "1094ui_story"

			if arg_1_1.actors_[var_4_25] == nil then
				local var_4_26 = Asset.Load("Char/" .. "1094ui_story")

				if not isNil(var_4_26) then
					local var_4_27 = Object.Instantiate(Asset.Load("Char/" .. "1094ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_30 = arg_1_1.actors_["1094ui_story"].transform
			local var_4_31 = 1.8

			if var_4_31 < arg_1_1.time_ and arg_1_1.time_ <= var_4_31 + arg_4_0 then
				arg_1_1.var_.moveOldPos1094ui_story = var_4_30.localPosition
			end
			...
			if var_4_31 <= arg_1_1.time_ and arg_1_1.time_ < var_4_31 + var_4_32 then
				...
				local var_4_34 = Vector3.New(0, -0.84, -6.1)

				var_4_30.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1094ui_story, var_4_34, var_4_33)
			...
			if arg_1_1.time_ >= var_4_31 + var_4_32 and arg_1_1.time_ < var_4_31 + var_4_32 + arg_4_0 then
				var_4_30.localPosition = Vector3.New(0, -0.84, -6.1)
			...
			local var_4_40 = 1.80833333333333
			...
			local var_4_41 = arg_1_1.actors_["1094ui_story"]
			local var_4_42 = 1.8

			if var_4_42 < arg_1_1.time_ and arg_1_1.time_ <= var_4_42 + arg_4_0 and not isNil(var_4_41) and arg_1_1.var_.characterEffect1094ui_story == nil then
				arg_1_1.var_.characterEffect1094ui_story = var_4_41:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_4_42 <= arg_1_1.time_ and arg_1_1.time_ < var_4_42 + var_4_43 and not isNil(var_4_41) then
				...
				if arg_1_1.var_.characterEffect1094ui_story and not isNil(var_4_41) then
					arg_1_1.var_.characterEffect1094ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= var_4_42 + var_4_43 and arg_1_1.time_ < var_4_42 + var_4_43 + arg_4_0 and not isNil(var_4_41) and arg_1_1.var_.characterEffect1094ui_story then
				arg_1_1.var_.characterEffect1094ui_story.fillFlat = false
			end
			...
			if var_4_59 < arg_1_1.time_ and arg_1_1.time_ <= var_4_59 + arg_4_0 then
				...
				local var_4_62 = arg_1_1:FormatText(StoryNameCfg[181].name)
				...
				local var_4_63 = arg_1_1:GetWordFromCfg(111141001)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141001", "story_v_out_111141.awb") ~= 0 then
					local var_4_68 = manager.audio:GetVoiceLength("story_v_out_111141", "111141001", "story_v_out_111141.awb") / 1000
					...
					if var_4_63.prefab_name ~= "" and arg_1_1.actors_[var_4_63.prefab_name] ~= nil then
						local var_4_69 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_63.prefab_name].transform, "story_v_out_111141", "111141001", "story_v_out_111141.awb")

						arg_1_1:RecordAudio("111141001", var_4_69)
						arg_1_1:RecordAudio("111141001", var_4_69)
					else
	...
	Play111141002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_1 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 and not isNil(var_12_0) and arg_9_1.var_.characterEffect1094ui_story == nil then
			...
			if var_12_1 <= arg_9_1.time_ and arg_9_1.time_ < var_12_1 + var_12_2 and not isNil(var_12_0) then
				...
				if arg_9_1.var_.characterEffect1094ui_story and not isNil(var_12_0) then
			...
			if arg_9_1.time_ >= var_12_1 + var_12_2 and arg_9_1.time_ < var_12_1 + var_12_2 + arg_12_0 and not isNil(var_12_0) and arg_9_1.var_.characterEffect1094ui_story then
				local var_12_5 = 0.5
	...
	Play111141004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_2 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 and not isNil(var_20_1) and arg_17_1.var_.characterEffect1094ui_story == nil then
			...
			if var_20_2 <= arg_17_1.time_ and arg_17_1.time_ < var_20_2 + var_20_3 and not isNil(var_20_1) then
				...
				if arg_17_1.var_.characterEffect1094ui_story and not isNil(var_20_1) then
					arg_17_1.var_.characterEffect1094ui_story.fillFlat = false
				end
			end

			if arg_17_1.time_ >= var_20_2 + var_20_3 and arg_17_1.time_ < var_20_2 + var_20_3 + arg_20_0 and not isNil(var_20_1) and arg_17_1.var_.characterEffect1094ui_story then
				arg_17_1.var_.characterEffect1094ui_story.fillFlat = false
			end
	...
	Play111141006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_1 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 and not isNil(var_28_0) and arg_25_1.var_.characterEffect1094ui_story == nil then
			...
			if var_28_1 <= arg_25_1.time_ and arg_25_1.time_ < var_28_1 + var_28_2 and not isNil(var_28_0) then
				...
				if arg_25_1.var_.characterEffect1094ui_story and not isNil(var_28_0) then
			...
			if arg_25_1.time_ >= var_28_1 + var_28_2 and arg_25_1.time_ < var_28_1 + var_28_2 + arg_28_0 and not isNil(var_28_0) and arg_25_1.var_.characterEffect1094ui_story then
				local var_28_5 = 0.5
	...
	Play111141011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_2 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 and not isNil(var_48_1) and arg_45_1.var_.characterEffect1094ui_story == nil then
			...
			if arg_45_1.time_ >= var_48_2 + var_48_3 and arg_45_1.time_ < var_48_2 + var_48_3 + arg_48_0 and not isNil(var_48_1) and arg_45_1.var_.characterEffect1094ui_story then
				arg_45_1.var_.characterEffect1094ui_story.fillFlat = false
			end
	...
	Play111141014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_2 < arg_57_1.time_ and arg_57_1.time_ <= var_60_2 + arg_60_0 and not isNil(var_60_1) and arg_57_1.var_.characterEffect1094ui_story == nil then
			...
			if var_60_2 <= arg_57_1.time_ and arg_57_1.time_ < var_60_2 + var_60_3 and not isNil(var_60_1) then
				...
				if arg_57_1.var_.characterEffect1094ui_story and not isNil(var_60_1) then
					arg_57_1.var_.characterEffect1094ui_story.fillFlat = false
				end
			end

			if arg_57_1.time_ >= var_60_2 + var_60_3 and arg_57_1.time_ < var_60_2 + var_60_3 + arg_60_0 and not isNil(var_60_1) and arg_57_1.var_.characterEffect1094ui_story then
				arg_57_1.var_.characterEffect1094ui_story.fillFlat = false
			end
	...
	Play111141015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_1 < arg_61_1.time_ and arg_61_1.time_ <= var_64_1 + arg_64_0 and not isNil(var_64_0) and arg_61_1.var_.characterEffect1094ui_story == nil then
			...
			if arg_61_1.time_ >= var_64_1 + var_64_2 and arg_61_1.time_ < var_64_1 + var_64_2 + arg_64_0 and not isNil(var_64_0) and arg_61_1.var_.characterEffect1094ui_story then
				local var_64_5 = 0.5
