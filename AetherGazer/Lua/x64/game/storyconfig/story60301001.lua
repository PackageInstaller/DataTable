	...
	Play60301001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_0] == nil then
				...
				var_4_2.sprite = getSpriteWithoutAtlas("TextureConfig/WeaponServant/Portrait/" .. "2540004")
			...
			local var_4_3 = arg_1_1.actors_["2540004"].transform
			local var_4_4 = 0

			if var_4_4 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				arg_1_1.var_.moveOldPos2540004 = var_4_3.localPosition
			...
			if var_4_4 <= arg_1_1.time_ and arg_1_1.time_ < var_4_4 + var_4_5 then
				...
				local var_4_7 = Vector3.New(0, -200, -900)

				var_4_3.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2540004, var_4_7, var_4_6)
			end

			if arg_1_1.time_ >= var_4_4 + var_4_5 and arg_1_1.time_ < var_4_4 + var_4_5 + arg_4_0 then
				var_4_3.localPosition = Vector3.New(0, -200, -900)
			end
			...
			if var_4_8 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:FormatText(StoryNameCfg[124].name)
				...
				local var_4_12 = arg_1_1:GetWordFromCfg(60301001)
