	...
	Play103011001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_22 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				...
				if var_4_23 then
					arg_1_1.var_.alphaOldValueB03b = var_4_23.color.a
			...
			if var_4_22 <= arg_1_1.time_ and arg_1_1.time_ < var_4_22 + var_4_24 then
				...
				local var_4_26 = Mathf.Lerp(arg_1_1.var_.alphaOldValueB03b, 1, var_4_25)

				if arg_1_1.var_.alphaMatValueB03b then
					local var_4_27 = arg_1_1.var_.alphaMatValueB03b.color

					var_4_27.a = var_4_26
					arg_1_1.var_.alphaMatValueB03b.color = var_4_27
				end
			end

			if arg_1_1.time_ >= var_4_22 + var_4_24 and arg_1_1.time_ < var_4_22 + var_4_24 + arg_4_0 and arg_1_1.var_.alphaMatValueB03b then
