	...
	Play102602001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_33 < arg_1_1.time_ and arg_1_1.time_ <= var_4_33 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_35, var_4_36, "bgm_side_daily02", "bgm_side_daily02", "bgm_side_daily02.awb")

				local var_4_37 = ""
				local var_4_38 = manager.audio:GetAudioName("bgm_side_daily02", "bgm_side_daily02")
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				local var_4_43 = arg_1_1:GetWordFromCfg(102602001)
	...
	Play102602023 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if var_96_1 <= arg_93_1.time_ and arg_93_1.time_ < var_96_1 + var_96_3 then
				...
				local var_96_5 = Mathf.Lerp(arg_93_1.var_.alphaOldValueST13, 0, var_96_4)

				if arg_93_1.var_.alphaMatValueST13 then
					local var_96_6 = arg_93_1.var_.alphaMatValueST13.color

					var_96_6.a = var_96_5
					arg_93_1.var_.alphaMatValueST13.color = var_96_6
				end
			end

			if arg_93_1.time_ >= var_96_1 + var_96_3 and arg_93_1.time_ < var_96_1 + var_96_3 + arg_96_0 and arg_93_1.var_.alphaMatValueST13 then
				local var_96_7 = arg_93_1.var_.alphaMatValueST13
				local var_96_8 = var_96_7.color

				var_96_8.a = 0
				var_96_7.color = var_96_8
			end

			local var_96_9 = arg_93_1.bgs_.ST13
			local var_96_10 = 1.5

			if var_96_10 < arg_93_1.time_ and arg_93_1.time_ <= var_96_10 + arg_96_0 then
				local var_96_11 = var_96_9:GetComponent("SpriteRenderer")

				if var_96_11 then
					arg_93_1.var_.alphaOldValueST13 = var_96_11.color.a
					arg_93_1.var_.alphaMatValueST13 = var_96_11
				end
			...
			if var_96_10 <= arg_93_1.time_ and arg_93_1.time_ < var_96_10 + var_96_12 then
				...
				local var_96_14 = Mathf.Lerp(arg_93_1.var_.alphaOldValueST13, 1, var_96_13)

				if arg_93_1.var_.alphaMatValueST13 then
					local var_96_15 = arg_93_1.var_.alphaMatValueST13.color

					var_96_15.a = var_96_14
					arg_93_1.var_.alphaMatValueST13.color = var_96_15
				end
			end

			if arg_93_1.time_ >= var_96_10 + var_96_12 and arg_93_1.time_ < var_96_10 + var_96_12 + arg_96_0 and arg_93_1.var_.alphaMatValueST13 then
				local var_96_16 = arg_93_1.var_.alphaMatValueST13
				local var_96_17 = var_96_16.color

				var_96_17.a = 1
				var_96_16.color = var_96_17
			end
			...
			local var_96_20 = 2.35
			local var_96_21 = 0.65
			...
			if var_96_20 < arg_93_1.time_ and arg_93_1.time_ <= var_96_20 + arg_96_0 then
				...
				local var_96_23 = arg_93_1:GetWordFromCfg(102602023)
	...
	Play102602051 = function(arg_207_0, arg_207_1)
		...
		function arg_207_1.onSingleLineUpdate_(arg_210_0)
			...
			if var_210_17 < arg_207_1.time_ and arg_207_1.time_ <= var_210_17 + arg_210_0 then
				...
				if var_210_18 then
					arg_207_1.var_.alphaOldValueST13 = var_210_18.color.a
					arg_207_1.var_.alphaMatValueST13 = var_210_18
				end

				arg_207_1.var_.alphaOldValueST13 = 1
			end

			local var_210_19 = 1.5

			if var_210_17 <= arg_207_1.time_ and arg_207_1.time_ < var_210_17 + var_210_19 then
				local var_210_20 = (arg_207_1.time_ - var_210_17) / var_210_19
				local var_210_21 = Mathf.Lerp(arg_207_1.var_.alphaOldValueST13, 0, var_210_20)

				if arg_207_1.var_.alphaMatValueST13 then
					local var_210_22 = arg_207_1.var_.alphaMatValueST13.color

					var_210_22.a = var_210_21
					arg_207_1.var_.alphaMatValueST13.color = var_210_22
				end
			end

			if arg_207_1.time_ >= var_210_17 + var_210_19 and arg_207_1.time_ < var_210_17 + var_210_19 + arg_210_0 and arg_207_1.var_.alphaMatValueST13 then
				local var_210_23 = arg_207_1.var_.alphaMatValueST13
				local var_210_24 = var_210_23.color

				var_210_24.a = 0
				var_210_23.color = var_210_24
			end

			local var_210_25 = arg_207_1.bgs_.ST03
			local var_210_26 = 1.5

			if var_210_26 < arg_207_1.time_ and arg_207_1.time_ <= var_210_26 + arg_210_0 then
				local var_210_27 = var_210_25:GetComponent("SpriteRenderer")

				if var_210_27 then
					arg_207_1.var_.alphaOldValueST03 = var_210_27.color.a
					arg_207_1.var_.alphaMatValueST03 = var_210_27
				end

				arg_207_1.var_.alphaOldValueST03 = 0
			end

			local var_210_28 = 1.5

			if var_210_26 <= arg_207_1.time_ and arg_207_1.time_ < var_210_26 + var_210_28 then
				local var_210_29 = (arg_207_1.time_ - var_210_26) / var_210_28
				local var_210_30 = Mathf.Lerp(arg_207_1.var_.alphaOldValueST03, 1, var_210_29)

				if arg_207_1.var_.alphaMatValueST03 then
					local var_210_31 = arg_207_1.var_.alphaMatValueST03.color

					var_210_31.a = var_210_30
					arg_207_1.var_.alphaMatValueST03.color = var_210_31
				end
			end

			if arg_207_1.time_ >= var_210_26 + var_210_28 and arg_207_1.time_ < var_210_26 + var_210_28 + arg_210_0 and arg_207_1.var_.alphaMatValueST03 then
				local var_210_32 = arg_207_1.var_.alphaMatValueST03
				local var_210_33 = var_210_32.color

				var_210_33.a = 1
				var_210_32.color = var_210_33
			end
			...
			local var_210_35 = 2.725

			if arg_207_1.time_ >= var_210_34 + var_210_35 and arg_207_1.time_ < var_210_34 + var_210_35 + arg_210_0 then
				arg_207_1.allBtn_.enabled = true
			end

			local var_210_36 = arg_207_1.actors_["1026ui_story"].transform
			local var_210_37 = 0

			if var_210_37 < arg_207_1.time_ and arg_207_1.time_ <= var_210_37 + arg_210_0 then
				arg_207_1.var_.moveOldPos1026ui_story = var_210_36.localPosition
			end

			local var_210_38 = 0.001
			...
			if var_210_37 <= arg_207_1.time_ and arg_207_1.time_ < var_210_37 + var_210_38 then
				...
				local var_210_40 = Vector3.New(0, 100, 0)

				var_210_36.localPosition = Vector3.Lerp(arg_207_1.var_.moveOldPos1026ui_story, var_210_40, var_210_39)

				local var_210_41 = manager.ui.mainCamera.transform.position - var_210_36.position

				var_210_36.forward = Vector3.New(var_210_41.x, var_210_41.y, var_210_41.z)

				local var_210_42 = var_210_36.localEulerAngles

				var_210_42.z = 0
				var_210_42.x = 0
				var_210_36.localEulerAngles = var_210_42
			end

			if arg_207_1.time_ >= var_210_37 + var_210_38 and arg_207_1.time_ < var_210_37 + var_210_38 + arg_210_0 then
				var_210_36.localPosition = Vector3.New(0, 100, 0)

				local var_210_43 = manager.ui.mainCamera.transform.position - var_210_36.position

				var_210_36.forward = Vector3.New(var_210_43.x, var_210_43.y, var_210_43.z)

				local var_210_44 = var_210_36.localEulerAngles

				var_210_44.z = 0
				var_210_44.x = 0
				var_210_36.localEulerAngles = var_210_44
			end
			...
			local var_210_45 = 2.725
			local var_210_46 = 0.275
			...
			if var_210_45 < arg_207_1.time_ and arg_207_1.time_ <= var_210_45 + arg_210_0 then
				...
				local var_210_48 = arg_207_1:GetWordFromCfg(102602051)
				local var_210_49 = arg_207_1:FormatText(var_210_48.content)

				arg_207_1.text_.text = var_210_49

				LuaForUtil.ClearLinePrefixSymbol(arg_207_1.text_)

				local var_210_50 = 11
				local var_210_51 = utf8.len(var_210_49)
				local var_210_52 = var_210_50 <= 0 and var_210_46 or var_210_46 * (var_210_51 / var_210_50)

				if var_210_52 > 0 and var_210_46 < var_210_52 then
					arg_207_1.talkMaxDuration = var_210_52
					var_210_45 = var_210_45 + 0.3

					if var_210_52 + var_210_45 > arg_207_1.duration_ then
						arg_207_1.duration_ = var_210_52 + var_210_45
					end
				end
			...
			local var_210_53 = var_210_45 + 0.3
			local var_210_54 = math.max(var_210_46, arg_207_1.talkMaxDuration)

			if var_210_53 <= arg_207_1.time_ and arg_207_1.time_ < var_210_53 + var_210_54 then
				arg_207_1.typewritter.percent = (arg_207_1.time_ - var_210_53) / var_210_54

				arg_207_1.typewritter:SetDirty()
			end

			if arg_207_1.time_ >= var_210_53 + var_210_54 and arg_207_1.time_ < var_210_53 + var_210_54 + arg_210_0 then
	...
	Play102602088 = function(arg_359_0, arg_359_1)
		...
		function arg_359_1.onSingleLineUpdate_(arg_362_0)
			...
			if var_362_17 < arg_359_1.time_ and arg_359_1.time_ <= var_362_17 + arg_362_0 then
				...
				if var_362_18 then
					arg_359_1.var_.alphaOldValueST03 = var_362_18.color.a
					arg_359_1.var_.alphaMatValueST03 = var_362_18
				end

				arg_359_1.var_.alphaOldValueST03 = 1
			end

			local var_362_19 = 1.5

			if var_362_17 <= arg_359_1.time_ and arg_359_1.time_ < var_362_17 + var_362_19 then
				local var_362_20 = (arg_359_1.time_ - var_362_17) / var_362_19
				local var_362_21 = Mathf.Lerp(arg_359_1.var_.alphaOldValueST03, 0, var_362_20)

				if arg_359_1.var_.alphaMatValueST03 then
					local var_362_22 = arg_359_1.var_.alphaMatValueST03.color

					var_362_22.a = var_362_21
					arg_359_1.var_.alphaMatValueST03.color = var_362_22
				end
			end

			if arg_359_1.time_ >= var_362_17 + var_362_19 and arg_359_1.time_ < var_362_17 + var_362_19 + arg_362_0 and arg_359_1.var_.alphaMatValueST03 then
				local var_362_23 = arg_359_1.var_.alphaMatValueST03
				local var_362_24 = var_362_23.color

				var_362_24.a = 0
				var_362_23.color = var_362_24
			end

			local var_362_25 = arg_359_1.bgs_.ST17
			local var_362_26 = 1.5

			if var_362_26 < arg_359_1.time_ and arg_359_1.time_ <= var_362_26 + arg_362_0 then
				local var_362_27 = var_362_25:GetComponent("SpriteRenderer")

				if var_362_27 then
					arg_359_1.var_.alphaOldValueST17 = var_362_27.color.a
					arg_359_1.var_.alphaMatValueST17 = var_362_27
				end

				arg_359_1.var_.alphaOldValueST17 = 0
			end

			local var_362_28 = 1.5

			if var_362_26 <= arg_359_1.time_ and arg_359_1.time_ < var_362_26 + var_362_28 then
				local var_362_29 = (arg_359_1.time_ - var_362_26) / var_362_28
				local var_362_30 = Mathf.Lerp(arg_359_1.var_.alphaOldValueST17, 1, var_362_29)

				if arg_359_1.var_.alphaMatValueST17 then
					local var_362_31 = arg_359_1.var_.alphaMatValueST17.color

					var_362_31.a = var_362_30
					arg_359_1.var_.alphaMatValueST17.color = var_362_31
				end
			end

			if arg_359_1.time_ >= var_362_26 + var_362_28 and arg_359_1.time_ < var_362_26 + var_362_28 + arg_362_0 and arg_359_1.var_.alphaMatValueST17 then
				local var_362_32 = arg_359_1.var_.alphaMatValueST17
				local var_362_33 = var_362_32.color

				var_362_33.a = 1
				var_362_32.color = var_362_33
			end
			...
			local var_362_36 = 1.85
			local var_362_37 = 1.15
			...
			if var_362_36 < arg_359_1.time_ and arg_359_1.time_ <= var_362_36 + arg_362_0 then
				...
				local var_362_38 = LeanTween.value(arg_359_1.dialog_, 0, 1, 0.3)

				var_362_38:setOnUpdate(LuaHelper.FloatAction(function(arg_363_0)
					arg_359_1.dialogCg_.alpha = arg_363_0
				end))
				var_362_38:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_359_1.dialog_)
					var_362_38:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_362_39 = arg_359_1:GetWordFromCfg(102602088)
				local var_362_40 = arg_359_1:FormatText(var_362_39.content)

				arg_359_1.text_.text = var_362_40

				LuaForUtil.ClearLinePrefixSymbol(arg_359_1.text_)

				local var_362_41 = 46
				local var_362_42 = utf8.len(var_362_40)
				local var_362_43 = var_362_41 <= 0 and var_362_37 or var_362_37 * (var_362_42 / var_362_41)

				if var_362_43 > 0 and var_362_37 < var_362_43 then
					arg_359_1.talkMaxDuration = var_362_43
					var_362_36 = var_362_36 + 0.3

					if var_362_43 + var_362_36 > arg_359_1.duration_ then
						arg_359_1.duration_ = var_362_43 + var_362_36
					end
				end
			...
			local var_362_44 = var_362_36 + 0.3
			local var_362_45 = math.max(var_362_37, arg_359_1.talkMaxDuration)

			if var_362_44 <= arg_359_1.time_ and arg_359_1.time_ < var_362_44 + var_362_45 then
				arg_359_1.typewritter.percent = (arg_359_1.time_ - var_362_44) / var_362_45

				arg_359_1.typewritter:SetDirty()
			end

			if arg_359_1.time_ >= var_362_44 + var_362_45 and arg_359_1.time_ < var_362_44 + var_362_45 + arg_362_0 then
