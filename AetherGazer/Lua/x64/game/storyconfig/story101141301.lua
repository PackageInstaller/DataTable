return {
	...
	Play114131024 = function(arg_99_0, arg_99_1)
		...
		function arg_99_1.onSingleLineUpdate_(arg_102_0)
			...
			if var_102_16 < arg_99_1.time_ and arg_99_1.time_ <= var_102_16 + arg_102_0 then
				...
				local var_102_17 = GameObjectTools.GetOrAddComponent(var_102_15.gameObject, typeof(DynamicBoneHelper))

				if var_102_17 then
					var_102_17:EnableDynamicBone(false)
				end
			end
			...
			if var_102_16 <= arg_99_1.time_ and arg_99_1.time_ < var_102_16 + var_102_18 then
				...
				local var_102_20 = Vector3.New(-0.7, -0.5, -6.3)

				var_102_15.localPosition = Vector3.Lerp(arg_99_1.var_.moveOldPos6046_story, var_102_20, var_102_19)

				local var_102_21 = manager.ui.mainCamera.transform.position - var_102_15.position

				var_102_15.forward = Vector3.New(var_102_21.x, var_102_21.y, var_102_21.z)

				local var_102_22 = var_102_15.localEulerAngles

				var_102_22.z = 0
				var_102_22.x = 0
				var_102_15.localEulerAngles = var_102_22
			end

			if arg_99_1.time_ >= var_102_16 + var_102_18 and arg_99_1.time_ < var_102_16 + var_102_18 + arg_102_0 then
				var_102_15.localPosition = Vector3.New(-0.7, -0.5, -6.3)

				local var_102_23 = manager.ui.mainCamera.transform.position - var_102_15.position

				var_102_15.forward = Vector3.New(var_102_23.x, var_102_23.y, var_102_23.z)

				local var_102_24 = var_102_15.localEulerAngles

				var_102_24.z = 0
				var_102_24.x = 0
				var_102_15.localEulerAngles = var_102_24

				local var_102_25 = GameObjectTools.GetOrAddComponent(var_102_15.gameObject, typeof(DynamicBoneHelper))

				if var_102_25 then
					var_102_25:EnableDynamicBone(true)
				end
			end
			...
			local var_102_27 = arg_99_1.actors_["6046_story"]
			local var_102_28 = 0

			if var_102_28 < arg_99_1.time_ and arg_99_1.time_ <= var_102_28 + arg_102_0 and not isNil(var_102_27) and arg_99_1.var_.characterEffect6046_story == nil then
				arg_99_1.var_.characterEffect6046_story = var_102_27:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_102_29 = 0.2
			...
			if var_102_28 <= arg_99_1.time_ and arg_99_1.time_ < var_102_28 + var_102_29 and not isNil(var_102_27) then
				...
				if arg_99_1.var_.characterEffect6046_story and not isNil(var_102_27) then
					arg_99_1.var_.characterEffect6046_story.fillFlat = false
				end
			end

			if arg_99_1.time_ >= var_102_28 + var_102_29 and arg_99_1.time_ < var_102_28 + var_102_29 + arg_102_0 and not isNil(var_102_27) and arg_99_1.var_.characterEffect6046_story then
				arg_99_1.var_.characterEffect6046_story.fillFlat = false
			end

			local var_102_31 = 0
			local var_102_32 = 0.25
			...
			if var_102_31 < arg_99_1.time_ and arg_99_1.time_ <= var_102_31 + arg_102_0 then
				...
				local var_102_33 = arg_99_1:FormatText(StoryNameCfg[214].name)

				arg_99_1.leftNameTxt_.text = var_102_33
				...
				local var_102_34 = arg_99_1:GetWordFromCfg(114131024)
				...
				if manager.audio:GetVoiceLength("story_v_out_114131", "114131024", "story_v_out_114131.awb") ~= 0 then
					local var_102_39 = manager.audio:GetVoiceLength("story_v_out_114131", "114131024", "story_v_out_114131.awb") / 1000

					if var_102_39 + var_102_31 > arg_99_1.duration_ then
						arg_99_1.duration_ = var_102_39 + var_102_31
					end

					if var_102_34.prefab_name ~= "" and arg_99_1.actors_[var_102_34.prefab_name] ~= nil then
						local var_102_40 = LuaForUtil.PlayVoiceWithCriLipsync(arg_99_1.actors_[var_102_34.prefab_name].transform, "story_v_out_114131", "114131024", "story_v_out_114131.awb")

						arg_99_1:RecordAudio("114131024", var_102_40)
						arg_99_1:RecordAudio("114131024", var_102_40)
					else
			...
			local var_102_41 = math.max(var_102_32, arg_99_1.talkMaxDuration)

			if var_102_31 <= arg_99_1.time_ and arg_99_1.time_ < var_102_31 + var_102_41 then
				arg_99_1.typewritter.percent = (arg_99_1.time_ - var_102_31) / var_102_41

				arg_99_1.typewritter:SetDirty()
			end

			if arg_99_1.time_ >= var_102_31 + var_102_41 and arg_99_1.time_ < var_102_31 + var_102_41 + arg_102_0 then
	...
	Play114131025 = function(arg_103_0, arg_103_1)
		...
		function arg_103_1.onSingleLineUpdate_(arg_106_0)
			...
			if var_106_6 < arg_103_1.time_ and arg_103_1.time_ <= var_106_6 + arg_106_0 then
				...
				local var_106_7 = GameObjectTools.GetOrAddComponent(var_106_5.gameObject, typeof(DynamicBoneHelper))
			...
			if var_106_6 <= arg_103_1.time_ and arg_103_1.time_ < var_106_6 + var_106_8 then
				local var_106_9 = (arg_103_1.time_ - var_106_6) / var_106_8
				local var_106_10 = Vector3.New(0.7, -0.5, -6.3)

				var_106_5.localPosition = Vector3.Lerp(arg_103_1.var_.moveOldPos6045_story, var_106_10, var_106_9)

				local var_106_11 = manager.ui.mainCamera.transform.position - var_106_5.position

				var_106_5.forward = Vector3.New(var_106_11.x, var_106_11.y, var_106_11.z)

				local var_106_12 = var_106_5.localEulerAngles

				var_106_12.z = 0
				var_106_12.x = 0
				var_106_5.localEulerAngles = var_106_12
			end

			if arg_103_1.time_ >= var_106_6 + var_106_8 and arg_103_1.time_ < var_106_6 + var_106_8 + arg_106_0 then
				var_106_5.localPosition = Vector3.New(0.7, -0.5, -6.3)

				local var_106_13 = manager.ui.mainCamera.transform.position - var_106_5.position

				var_106_5.forward = Vector3.New(var_106_13.x, var_106_13.y, var_106_13.z)

				local var_106_14 = var_106_5.localEulerAngles

				var_106_14.z = 0
				var_106_14.x = 0
				var_106_5.localEulerAngles = var_106_14

				local var_106_15 = GameObjectTools.GetOrAddComponent(var_106_5.gameObject, typeof(DynamicBoneHelper))

				if var_106_15 then
					var_106_15:EnableDynamicBone(true)
				end
			end
			...
			local var_106_17 = arg_103_1.actors_["6045_story"]
			local var_106_18 = 0

			if var_106_18 < arg_103_1.time_ and arg_103_1.time_ <= var_106_18 + arg_106_0 and not isNil(var_106_17) and arg_103_1.var_.characterEffect6045_story == nil then
				arg_103_1.var_.characterEffect6045_story = var_106_17:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_106_19 = 0.2

			if var_106_18 <= arg_103_1.time_ and arg_103_1.time_ < var_106_18 + var_106_19 and not isNil(var_106_17) then
				local var_106_20 = (arg_103_1.time_ - var_106_18) / var_106_19

				if arg_103_1.var_.characterEffect6045_story and not isNil(var_106_17) then
					arg_103_1.var_.characterEffect6045_story.fillFlat = false
				end
			end

			if arg_103_1.time_ >= var_106_18 + var_106_19 and arg_103_1.time_ < var_106_18 + var_106_19 + arg_106_0 and not isNil(var_106_17) and arg_103_1.var_.characterEffect6045_story then
				arg_103_1.var_.characterEffect6045_story.fillFlat = false
			end
			...
			local var_106_22 = arg_103_1.actors_["6046_story"]
			local var_106_23 = 0

			if var_106_23 < arg_103_1.time_ and arg_103_1.time_ <= var_106_23 + arg_106_0 and not isNil(var_106_22) and arg_103_1.var_.characterEffect6046_story == nil then
				arg_103_1.var_.characterEffect6046_story = var_106_22:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_106_24 = 0.2
			...
			if var_106_23 <= arg_103_1.time_ and arg_103_1.time_ < var_106_23 + var_106_24 and not isNil(var_106_22) then
				...
				if arg_103_1.var_.characterEffect6046_story and not isNil(var_106_22) then
					local var_106_26 = Mathf.Lerp(0, 0.5, var_106_25)

					arg_103_1.var_.characterEffect6046_story.fillFlat = true
					arg_103_1.var_.characterEffect6046_story.fillRatio = var_106_26
				end
			end

			if arg_103_1.time_ >= var_106_23 + var_106_24 and arg_103_1.time_ < var_106_23 + var_106_24 + arg_106_0 and not isNil(var_106_22) and arg_103_1.var_.characterEffect6046_story then
				local var_106_27 = 0.5

				arg_103_1.var_.characterEffect6046_story.fillFlat = true
				arg_103_1.var_.characterEffect6046_story.fillRatio = var_106_27
			end

			local var_106_28 = 0
			local var_106_29 = 0.175
			...
			if var_106_28 < arg_103_1.time_ and arg_103_1.time_ <= var_106_28 + arg_106_0 then
				...
				local var_106_30 = arg_103_1:FormatText(StoryNameCfg[215].name)
				...
				local var_106_31 = arg_103_1:GetWordFromCfg(114131025)
				...
				if manager.audio:GetVoiceLength("story_v_out_114131", "114131025", "story_v_out_114131.awb") ~= 0 then
					local var_106_36 = manager.audio:GetVoiceLength("story_v_out_114131", "114131025", "story_v_out_114131.awb") / 1000
					...
					if var_106_31.prefab_name ~= "" and arg_103_1.actors_[var_106_31.prefab_name] ~= nil then
						local var_106_37 = LuaForUtil.PlayVoiceWithCriLipsync(arg_103_1.actors_[var_106_31.prefab_name].transform, "story_v_out_114131", "114131025", "story_v_out_114131.awb")

						arg_103_1:RecordAudio("114131025", var_106_37)
						arg_103_1:RecordAudio("114131025", var_106_37)
					else
	...
	Play114131027 = function(arg_111_0, arg_111_1)
		...
		function arg_111_1.onSingleLineUpdate_(arg_114_0)
			...
			local var_114_11 = arg_111_1.actors_["6045_story"].transform
			local var_114_12 = 0

			if var_114_12 < arg_111_1.time_ and arg_111_1.time_ <= var_114_12 + arg_114_0 then
				arg_111_1.var_.moveOldPos6045_story = var_114_11.localPosition
			...
			if var_114_12 <= arg_111_1.time_ and arg_111_1.time_ < var_114_12 + var_114_14 then
				...
				var_114_11.localPosition = Vector3.Lerp(arg_111_1.var_.moveOldPos6045_story, var_114_16, var_114_15)
			...
			if var_114_22 < arg_111_1.time_ and arg_111_1.time_ <= var_114_22 + arg_114_0 then
				...
				local var_114_24 = arg_111_1:GetWordFromCfg(114131027)
