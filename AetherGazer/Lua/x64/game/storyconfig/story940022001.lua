	...
	Play940022001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_56 < arg_1_1.time_ and arg_1_1.time_ <= var_4_56 + arg_4_0 then
				...
				local var_4_60 = arg_1_1:GetWordFromCfg(940022001)
	...
	Play940022002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if var_11_2 < arg_8_1.time_ and arg_8_1.time_ <= var_11_2 + arg_11_0 then
				...
				local var_11_4 = arg_8_1:FormatText(StoryNameCfg[1467].name)
				...
				local var_11_5 = arg_8_1:GetWordFromCfg(940022002)
			...
			local var_11_10 = math.max(var_11_3, arg_8_1.talkMaxDuration)

			if var_11_2 <= arg_8_1.time_ and arg_8_1.time_ < var_11_2 + var_11_10 then
				arg_8_1.typewritter.percent = (arg_8_1.time_ - var_11_2) / var_11_10

				arg_8_1.typewritter:SetDirty()
			end

			if arg_8_1.time_ >= var_11_2 + var_11_10 and arg_8_1.time_ < var_11_2 + var_11_10 + arg_11_0 then
	...
	Play940022003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if var_15_6 < arg_12_1.time_ and arg_12_1.time_ <= var_15_6 + arg_15_0 then
				...
				local var_15_9 = arg_12_1:GetWordFromCfg(940022003)
	...
	Play940022004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if var_19_6 < arg_16_1.time_ and arg_16_1.time_ <= var_19_6 + arg_19_0 then
				...
				local var_19_9 = arg_16_1:GetWordFromCfg(940022004)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			if var_23_12 <= arg_20_1.time_ and arg_20_1.time_ < var_23_12 + var_23_13 and not isNil(var_23_11) then
				...
				if arg_20_1.var_.characterEffect1077ui_story and not isNil(var_23_11) then
					...
					arg_20_1.var_.characterEffect1077ui_story.fillRatio = var_23_15
				end
			end
			...
			if arg_20_1.time_ >= var_23_12 + var_23_13 and arg_20_1.time_ < var_23_12 + var_23_13 + arg_23_0 and not isNil(var_23_11) and arg_20_1.var_.characterEffect1077ui_story then
				...
				arg_20_1.var_.characterEffect1077ui_story.fillFlat = true
				arg_20_1.var_.characterEffect1077ui_story.fillRatio = var_23_16
			end
			...
			if var_23_17 < arg_20_1.time_ and arg_20_1.time_ <= var_23_17 + arg_23_0 then
				...
				local var_23_19 = arg_20_1:GetWordFromCfg(940022005)
	...
	Play940022006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if var_27_0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_0 + arg_27_0 then
				...
				local var_27_3 = arg_24_1:GetWordFromCfg(940022006)
	...
	Play940022007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			if var_31_17 < arg_28_1.time_ and arg_28_1.time_ <= var_31_17 + arg_31_0 then
				...
				local var_31_20 = arg_28_1:GetWordFromCfg(940022007)
	...
	Play940022008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if var_35_6 < arg_32_1.time_ and arg_32_1.time_ <= var_35_6 + arg_35_0 then
				...
				local var_35_9 = arg_32_1:GetWordFromCfg(940022008)
	...
	Play940022009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if var_39_6 < arg_36_1.time_ and arg_36_1.time_ <= var_39_6 + arg_39_0 then
				...
				local var_39_9 = arg_36_1:GetWordFromCfg(940022009)
	...
	Play940022010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if var_43_6 < arg_40_1.time_ and arg_40_1.time_ <= var_43_6 + arg_43_0 then
				...
				local var_43_9 = arg_40_1:GetWordFromCfg(940022010)
	...
	Play940022011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if var_47_2 < arg_44_1.time_ and arg_44_1.time_ <= var_47_2 + arg_47_0 then
				...
				local var_47_5 = arg_44_1.bgs_.ST2014a
			...
			local var_47_29 = arg_44_1.actors_["1077ui_story"].transform
			local var_47_30 = 1.96599999815226

			if var_47_30 < arg_44_1.time_ and arg_44_1.time_ <= var_47_30 + arg_47_0 then
				arg_44_1.var_.moveOldPos1077ui_story = var_47_29.localPosition
			...
			if var_47_30 <= arg_44_1.time_ and arg_44_1.time_ < var_47_30 + var_47_32 then
				...
				var_47_29.localPosition = Vector3.Lerp(arg_44_1.var_.moveOldPos1077ui_story, var_47_34, var_47_33)
			...
			if var_47_40 < arg_44_1.time_ and arg_44_1.time_ <= var_47_40 + arg_47_0 then
				...
				local var_47_42 = LeanTween.value(arg_44_1.dialog_, 0, 1, 0.3)

				var_47_42:setOnUpdate(LuaHelper.FloatAction(function(arg_48_0)
					arg_44_1.dialogCg_.alpha = arg_48_0
				end))
				var_47_42:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_44_1.dialog_)
					var_47_42:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_47_43 = arg_44_1:GetWordFromCfg(940022011)
				local var_47_44 = arg_44_1:FormatText(var_47_43.content)

				arg_44_1.text_.text = var_47_44

				LuaForUtil.ClearLinePrefixSymbol(arg_44_1.text_)

				local var_47_45 = 59
				local var_47_46 = utf8.len(var_47_44)
				local var_47_47 = var_47_45 <= 0 and var_47_41 or var_47_41 * (var_47_46 / var_47_45)

				if var_47_47 > 0 and var_47_41 < var_47_47 then
					arg_44_1.talkMaxDuration = var_47_47
					var_47_40 = var_47_40 + 0.3

					if var_47_47 + var_47_40 > arg_44_1.duration_ then
						arg_44_1.duration_ = var_47_47 + var_47_40
					end
				end
			...
			local var_47_48 = var_47_40 + 0.3
			local var_47_49 = math.max(var_47_41, arg_44_1.talkMaxDuration)

			if var_47_48 <= arg_44_1.time_ and arg_44_1.time_ < var_47_48 + var_47_49 then
				arg_44_1.typewritter.percent = (arg_44_1.time_ - var_47_48) / var_47_49

				arg_44_1.typewritter:SetDirty()
			end

			if arg_44_1.time_ >= var_47_48 + var_47_49 and arg_44_1.time_ < var_47_48 + var_47_49 + arg_47_0 then
	...
	Play940022012 = function(arg_50_0, arg_50_1)
		...
		function arg_50_1.onSingleLineUpdate_(arg_53_0)
			...
			if var_53_17 < arg_50_1.time_ and arg_50_1.time_ <= var_53_17 + arg_53_0 then
				...
				local var_53_20 = arg_50_1:GetWordFromCfg(940022012)
			...
			local var_53_25 = math.max(var_53_18, arg_50_1.talkMaxDuration)

			if var_53_17 <= arg_50_1.time_ and arg_50_1.time_ < var_53_17 + var_53_25 then
				arg_50_1.typewritter.percent = (arg_50_1.time_ - var_53_17) / var_53_25

				arg_50_1.typewritter:SetDirty()
			end

			if arg_50_1.time_ >= var_53_17 + var_53_25 and arg_50_1.time_ < var_53_17 + var_53_25 + arg_53_0 then
	...
	Play940022013 = function(arg_54_0, arg_54_1)
		...
		function arg_54_1.onSingleLineUpdate_(arg_57_0)
			...
			if var_57_6 < arg_54_1.time_ and arg_54_1.time_ <= var_57_6 + arg_57_0 then
				...
				local var_57_9 = arg_54_1:GetWordFromCfg(940022013)
	...
	Play940022014 = function(arg_58_0, arg_58_1)
		...
		function arg_58_1.onSingleLineUpdate_(arg_61_0)
			...
			if var_61_6 < arg_58_1.time_ and arg_58_1.time_ <= var_61_6 + arg_61_0 then
				...
				local var_61_8 = arg_58_1:FormatText(StoryNameCfg[1467].name)
				...
				local var_61_9 = arg_58_1:GetWordFromCfg(940022014)
	...
	Play940022015 = function(arg_62_0, arg_62_1)
		...
		function arg_62_1.onSingleLineUpdate_(arg_65_0)
			...
			if var_65_17 < arg_62_1.time_ and arg_62_1.time_ <= var_65_17 + arg_65_0 then
				...
				local var_65_19 = arg_62_1:GetWordFromCfg(940022015)
	...
	Play940022016 = function(arg_66_0, arg_66_1)
		...
		function arg_66_1.onSingleLineUpdate_(arg_69_0)
			...
			if var_69_17 < arg_66_1.time_ and arg_66_1.time_ <= var_69_17 + arg_69_0 then
				...
				local var_69_20 = arg_66_1:GetWordFromCfg(940022016)
			...
			local var_69_25 = math.max(var_69_18, arg_66_1.talkMaxDuration)

			if var_69_17 <= arg_66_1.time_ and arg_66_1.time_ < var_69_17 + var_69_25 then
				arg_66_1.typewritter.percent = (arg_66_1.time_ - var_69_17) / var_69_25

				arg_66_1.typewritter:SetDirty()
			end

			if arg_66_1.time_ >= var_69_17 + var_69_25 and arg_66_1.time_ < var_69_17 + var_69_25 + arg_69_0 then
	...
	Play940022017 = function(arg_70_0, arg_70_1)
		...
		function arg_70_1.onSingleLineUpdate_(arg_73_0)
			...
			if var_73_6 < arg_70_1.time_ and arg_70_1.time_ <= var_73_6 + arg_73_0 then
				...
				local var_73_9 = arg_70_1:GetWordFromCfg(940022017)
	...
	Play940022018 = function(arg_74_0, arg_74_1)
		...
		function arg_74_1.onSingleLineUpdate_(arg_77_0)
			...
			if var_77_11 < arg_74_1.time_ and arg_74_1.time_ <= var_77_11 + arg_77_0 then
				...
				local var_77_13 = arg_74_1:GetWordFromCfg(940022018)
				...
				local var_77_17 = var_77_15 <= 0 and var_77_12 or var_77_12 * (var_77_16 / var_77_15)

				if var_77_17 > 0 and var_77_12 < var_77_17 then
			...
			local var_77_18 = math.max(var_77_12, arg_74_1.talkMaxDuration)

			if var_77_11 <= arg_74_1.time_ and arg_74_1.time_ < var_77_11 + var_77_18 then
				arg_74_1.typewritter.percent = (arg_74_1.time_ - var_77_11) / var_77_18

				arg_74_1.typewritter:SetDirty()
			end

			if arg_74_1.time_ >= var_77_11 + var_77_18 and arg_74_1.time_ < var_77_11 + var_77_18 + arg_77_0 then
	...
	Play940022019 = function(arg_78_0, arg_78_1)
		...
		function arg_78_1.onSingleLineUpdate_(arg_81_0)
			...
			if var_81_4 < arg_78_1.time_ and arg_78_1.time_ <= var_81_4 + arg_81_0 then
				...
				local var_81_6 = arg_78_1:FormatText(StoryNameCfg[7].name)
				...
				local var_81_7 = arg_78_1:GetWordFromCfg(940022019)
