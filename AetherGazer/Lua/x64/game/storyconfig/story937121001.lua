return {
	Play937121001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_36 < arg_1_1.time_ and arg_1_1.time_ <= var_4_36 + arg_4_0 then
				...
				local var_4_40 = arg_1_1:GetWordFromCfg(937121001)
	...
	Play937121002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			local var_12_0 = "1044ui_story"

			if arg_9_1.actors_[var_12_0] == nil then
				local var_12_1 = Asset.Load("Char/" .. "1044ui_story")

				if not isNil(var_12_1) then
					local var_12_2 = Object.Instantiate(Asset.Load("Char/" .. "1044ui_story"), arg_9_1.stage_.transform)
			...
			local var_12_5 = arg_9_1.actors_["1044ui_story"].transform
			local var_12_6 = 0

			if var_12_6 < arg_9_1.time_ and arg_9_1.time_ <= var_12_6 + arg_12_0 then
				arg_9_1.var_.moveOldPos1044ui_story = var_12_5.localPosition
			end
			...
			if var_12_6 <= arg_9_1.time_ and arg_9_1.time_ < var_12_6 + var_12_7 then
				...
				local var_12_9 = Vector3.New(0, -1, -5.93)

				var_12_5.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1044ui_story, var_12_9, var_12_8)
			...
			if arg_9_1.time_ >= var_12_6 + var_12_7 and arg_9_1.time_ < var_12_6 + var_12_7 + arg_12_0 then
				var_12_5.localPosition = Vector3.New(0, -1, -5.93)
			...
			local var_12_14 = arg_9_1.actors_["1044ui_story"]
			local var_12_15 = 0

			if var_12_15 < arg_9_1.time_ and arg_9_1.time_ <= var_12_15 + arg_12_0 and not isNil(var_12_14) and arg_9_1.var_.characterEffect1044ui_story == nil then
				arg_9_1.var_.characterEffect1044ui_story = var_12_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_12_15 <= arg_9_1.time_ and arg_9_1.time_ < var_12_15 + var_12_16 and not isNil(var_12_14) then
				...
				if arg_9_1.var_.characterEffect1044ui_story and not isNil(var_12_14) then
					arg_9_1.var_.characterEffect1044ui_story.fillFlat = false
				end
			end

			if arg_9_1.time_ >= var_12_15 + var_12_16 and arg_9_1.time_ < var_12_15 + var_12_16 + arg_12_0 and not isNil(var_12_14) and arg_9_1.var_.characterEffect1044ui_story then
				arg_9_1.var_.characterEffect1044ui_story.fillFlat = false
			end
			...
			if var_12_20 < arg_9_1.time_ and arg_9_1.time_ <= var_12_20 + arg_12_0 then
				...
				local var_12_22 = arg_9_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_12_23 = arg_9_1:GetWordFromCfg(937121002)
	...
	Play937121003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_6 < arg_13_1.time_ and arg_13_1.time_ <= var_16_6 + arg_16_0 then
				...
				local var_16_9 = arg_13_1:GetWordFromCfg(937121003)
	...
	Play937121004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			local var_20_0 = arg_17_1.actors_["1044ui_story"].transform
			local var_20_1 = 0

			if var_20_1 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				arg_17_1.var_.moveOldPos1044ui_story = var_20_0.localPosition
			end
			...
			if var_20_1 <= arg_17_1.time_ and arg_17_1.time_ < var_20_1 + var_20_2 then
				...
				local var_20_4 = Vector3.New(0, -1, -5.93)

				var_20_0.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos1044ui_story, var_20_4, var_20_3)
			...
			if arg_17_1.time_ >= var_20_1 + var_20_2 and arg_17_1.time_ < var_20_1 + var_20_2 + arg_20_0 then
				var_20_0.localPosition = Vector3.New(0, -1, -5.93)
			...
			local var_20_9 = arg_17_1.actors_["1044ui_story"]
			local var_20_10 = 0

			if var_20_10 < arg_17_1.time_ and arg_17_1.time_ <= var_20_10 + arg_20_0 and not isNil(var_20_9) and arg_17_1.var_.characterEffect1044ui_story == nil then
				arg_17_1.var_.characterEffect1044ui_story = var_20_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_20_10 <= arg_17_1.time_ and arg_17_1.time_ < var_20_10 + var_20_11 and not isNil(var_20_9) then
				...
				if arg_17_1.var_.characterEffect1044ui_story and not isNil(var_20_9) then
					arg_17_1.var_.characterEffect1044ui_story.fillFlat = false
				end
			end

			if arg_17_1.time_ >= var_20_10 + var_20_11 and arg_17_1.time_ < var_20_10 + var_20_11 + arg_20_0 and not isNil(var_20_9) and arg_17_1.var_.characterEffect1044ui_story then
				arg_17_1.var_.characterEffect1044ui_story.fillFlat = false
			end
			...
			if var_20_15 < arg_17_1.time_ and arg_17_1.time_ <= var_20_15 + arg_20_0 then
				...
				local var_20_17 = arg_17_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_20_18 = arg_17_1:GetWordFromCfg(937121004)
	...
	Play937121005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_6 < arg_21_1.time_ and arg_21_1.time_ <= var_24_6 + arg_24_0 then
				...
				local var_24_9 = arg_21_1:GetWordFromCfg(937121005)
	...
	Play937121006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:GetWordFromCfg(937121006)
	...
	Play937121007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_15 < arg_29_1.time_ and arg_29_1.time_ <= var_32_15 + arg_32_0 then
				...
				local var_32_18 = arg_29_1:GetWordFromCfg(937121007)
	...
	Play937121008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_6 < arg_33_1.time_ and arg_33_1.time_ <= var_36_6 + arg_36_0 then
				...
				local var_36_9 = arg_33_1:GetWordFromCfg(937121008)
	...
	Play937121009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_6 < arg_37_1.time_ and arg_37_1.time_ <= var_40_6 + arg_40_0 then
				...
				local var_40_8 = arg_37_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_40_9 = arg_37_1:GetWordFromCfg(937121009)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_10 <= arg_41_1.time_ and arg_41_1.time_ < var_44_10 + var_44_11 and not isNil(var_44_9) then
				...
				if arg_41_1.var_.characterEffect1044ui_story and not isNil(var_44_9) then
					...
					arg_41_1.var_.characterEffect1044ui_story.fillRatio = var_44_13
				end
			end
			...
			if arg_41_1.time_ >= var_44_10 + var_44_11 and arg_41_1.time_ < var_44_10 + var_44_11 + arg_44_0 and not isNil(var_44_9) and arg_41_1.var_.characterEffect1044ui_story then
				...
				arg_41_1.var_.characterEffect1044ui_story.fillFlat = true
				arg_41_1.var_.characterEffect1044ui_story.fillRatio = var_44_14
			end
			...
			if var_44_15 < arg_41_1.time_ and arg_41_1.time_ <= var_44_15 + arg_44_0 then
				...
				local var_44_17 = arg_41_1:GetWordFromCfg(937121010)
	...
	Play937121011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_0 + arg_48_0 then
				...
				local var_48_3 = arg_45_1:GetWordFromCfg(937121011)
	...
	Play937121012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			local var_52_0 = arg_49_1.actors_["1044ui_story"].transform
			local var_52_1 = 0

			if var_52_1 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				arg_49_1.var_.moveOldPos1044ui_story = var_52_0.localPosition
			end
			...
			if var_52_1 <= arg_49_1.time_ and arg_49_1.time_ < var_52_1 + var_52_2 then
				...
				local var_52_4 = Vector3.New(0, -1, -5.93)

				var_52_0.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos1044ui_story, var_52_4, var_52_3)
			...
			if arg_49_1.time_ >= var_52_1 + var_52_2 and arg_49_1.time_ < var_52_1 + var_52_2 + arg_52_0 then
				var_52_0.localPosition = Vector3.New(0, -1, -5.93)
			...
			local var_52_9 = arg_49_1.actors_["1044ui_story"]
			local var_52_10 = 0

			if var_52_10 < arg_49_1.time_ and arg_49_1.time_ <= var_52_10 + arg_52_0 and not isNil(var_52_9) and arg_49_1.var_.characterEffect1044ui_story == nil then
				arg_49_1.var_.characterEffect1044ui_story = var_52_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_52_10 <= arg_49_1.time_ and arg_49_1.time_ < var_52_10 + var_52_11 and not isNil(var_52_9) then
				...
				if arg_49_1.var_.characterEffect1044ui_story and not isNil(var_52_9) then
					arg_49_1.var_.characterEffect1044ui_story.fillFlat = false
				end
			end

			if arg_49_1.time_ >= var_52_10 + var_52_11 and arg_49_1.time_ < var_52_10 + var_52_11 + arg_52_0 and not isNil(var_52_9) and arg_49_1.var_.characterEffect1044ui_story then
				arg_49_1.var_.characterEffect1044ui_story.fillFlat = false
			end
			...
			if var_52_15 < arg_49_1.time_ and arg_49_1.time_ <= var_52_15 + arg_52_0 then
				...
				local var_52_17 = arg_49_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_52_18 = arg_49_1:GetWordFromCfg(937121012)
	...
	Play937121013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_11 < arg_53_1.time_ and arg_53_1.time_ <= var_56_11 + arg_56_0 then
				...
				local var_56_13 = arg_53_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_56_14 = arg_53_1:GetWordFromCfg(937121013)
	...
	Play937121014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_6 < arg_57_1.time_ and arg_57_1.time_ <= var_60_6 + arg_60_0 then
				...
				local var_60_9 = arg_57_1:GetWordFromCfg(937121014)
	...
	Play937121015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_15 < arg_61_1.time_ and arg_61_1.time_ <= var_64_15 + arg_64_0 then
				...
				local var_64_18 = arg_61_1:GetWordFromCfg(937121015)
	...
	Play937121016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_6 < arg_65_1.time_ and arg_65_1.time_ <= var_68_6 + arg_68_0 then
				...
				local var_68_8 = arg_65_1:GetWordFromCfg(937121016)
	...
	Play937121017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			local var_72_0 = arg_69_1.actors_["1044ui_story"].transform
			local var_72_1 = 0

			if var_72_1 < arg_69_1.time_ and arg_69_1.time_ <= var_72_1 + arg_72_0 then
				arg_69_1.var_.moveOldPos1044ui_story = var_72_0.localPosition
			end
			...
			if var_72_1 <= arg_69_1.time_ and arg_69_1.time_ < var_72_1 + var_72_2 then
				...
				local var_72_4 = Vector3.New(0, -1, -5.93)

				var_72_0.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos1044ui_story, var_72_4, var_72_3)
			...
			if arg_69_1.time_ >= var_72_1 + var_72_2 and arg_69_1.time_ < var_72_1 + var_72_2 + arg_72_0 then
				var_72_0.localPosition = Vector3.New(0, -1, -5.93)
			...
			local var_72_9 = arg_69_1.actors_["1044ui_story"]
			local var_72_10 = 0

			if var_72_10 < arg_69_1.time_ and arg_69_1.time_ <= var_72_10 + arg_72_0 and not isNil(var_72_9) and arg_69_1.var_.characterEffect1044ui_story == nil then
				arg_69_1.var_.characterEffect1044ui_story = var_72_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_72_10 <= arg_69_1.time_ and arg_69_1.time_ < var_72_10 + var_72_11 and not isNil(var_72_9) then
				...
				if arg_69_1.var_.characterEffect1044ui_story and not isNil(var_72_9) then
					arg_69_1.var_.characterEffect1044ui_story.fillFlat = false
				end
			end

			if arg_69_1.time_ >= var_72_10 + var_72_11 and arg_69_1.time_ < var_72_10 + var_72_11 + arg_72_0 and not isNil(var_72_9) and arg_69_1.var_.characterEffect1044ui_story then
				arg_69_1.var_.characterEffect1044ui_story.fillFlat = false
			end
			...
			if var_72_14 < arg_69_1.time_ and arg_69_1.time_ <= var_72_14 + arg_72_0 then
				...
				local var_72_16 = arg_69_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_72_17 = arg_69_1:GetWordFromCfg(937121017)
	...
	Play937121018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if var_76_10 < arg_73_1.time_ and arg_73_1.time_ <= var_76_10 + arg_76_0 then
				...
				local var_76_12 = arg_73_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_76_13 = arg_73_1:GetWordFromCfg(937121018)
