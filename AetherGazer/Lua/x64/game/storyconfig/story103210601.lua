	...
	Play321061016 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if var_70_21 < arg_67_1.time_ and arg_67_1.time_ <= var_70_21 + arg_70_0 then
				...
				local var_70_23
				local var_70_24 = var_70_20

				if not var_70_22 then
					var_70_22 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_xishan"), var_70_24)
					var_70_22.name = "9954"
					arg_67_1.var_.effect9954 = var_70_22
				else
					var_70_22.transform:SetParent(var_70_24)
				end
			...
			if var_70_25 < arg_67_1.time_ and arg_67_1.time_ <= var_70_25 + arg_70_0 then
				...
				local var_70_28 = arg_67_1:GetWordFromCfg(321061016)
