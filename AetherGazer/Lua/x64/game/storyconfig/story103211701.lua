		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_1 < arg_13_1.time_ and arg_13_1.time_ <= var_16_1 + arg_16_0 then
				...
				if not var_16_2 then
					var_16_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_ripple"), var_16_4)
			...
			if var_16_7 < arg_13_1.time_ and arg_13_1.time_ <= var_16_7 + arg_16_0 then
				local var_16_9 = "play"
				local var_16_10 = "effect"

				arg_13_1:AudioAction(var_16_9, var_16_10, "se_story_140", "se_story_140_attack_2", "")
			end
			...
			local var_16_11 = 1.56666666666667
			local var_16_12 = 1.5
			...
			if var_16_11 < arg_13_1.time_ and arg_13_1.time_ <= var_16_11 + arg_16_0 then
				...
				local var_16_14 = arg_13_1:GetWordFromCfg(321171003)
	...
	Play321171006 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_1 < arg_27_1.time_ and arg_27_1.time_ <= var_30_1 + arg_30_0 then
				...
				local var_30_3
				local var_30_4 = var_30_0

				if not var_30_2 then
					var_30_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_ripple"), var_30_4)
					var_30_2.name = "wanqu1"
					arg_27_1.var_.effectwanqu1 = var_30_2
				else
					var_30_2.transform:SetParent(var_30_4)
				end
			...
			local var_30_6 = 5.83333333333333
			...
			if var_30_8 < arg_27_1.time_ and arg_27_1.time_ <= var_30_8 + arg_30_0 then
				local var_30_9 = arg_27_1.var_.effectqiangxiang1
				local var_30_10
				local var_30_11 = var_30_7

				if not var_30_9 then
					var_30_9 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), var_30_11)
					var_30_9.name = "qiangxiang1"
					arg_27_1.var_.effectqiangxiang1 = var_30_9
				else
					var_30_9.transform:SetParent(var_30_11)
				end
			...
			if var_30_13 < arg_27_1.time_ and arg_27_1.time_ <= var_30_13 + arg_30_0 then
				local var_30_14 = arg_27_1.var_.effectqiangxiang2
				local var_30_15
				local var_30_16 = var_30_12

				if not var_30_14 then
					var_30_14 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), var_30_16)
					var_30_14.name = "qiangxiang2"
					arg_27_1.var_.effectqiangxiang2 = var_30_14
				else
					var_30_14.transform:SetParent(var_30_16)
				end

				var_30_14.transform.localPosition = Vector3.New(0, 0, 0)
				var_30_14.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			if var_30_18 < arg_27_1.time_ and arg_27_1.time_ <= var_30_18 + arg_30_0 then
				local var_30_19 = arg_27_1.var_.effectqiangxiang3
				local var_30_20
				local var_30_21 = var_30_17

				if not var_30_19 then
					var_30_19 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), var_30_21)
					var_30_19.name = "qiangxiang3"
					arg_27_1.var_.effectqiangxiang3 = var_30_19
				else
					var_30_19.transform:SetParent(var_30_21)
				end
			...
			if var_30_23 < arg_27_1.time_ and arg_27_1.time_ <= var_30_23 + arg_30_0 then
				local var_30_24 = arg_27_1.var_.effectwanqu2
				local var_30_25
				local var_30_26 = var_30_22

				if not var_30_24 then
					var_30_24 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_ripple"), var_30_26)
					var_30_24.name = "wanqu2"
					arg_27_1.var_.effectwanqu2 = var_30_24
				else
					var_30_24.transform:SetParent(var_30_26)
				end
			...
			local var_30_27 = manager.ui.mainCamera.transform
			local var_30_28 = 4

			if var_30_28 < arg_27_1.time_ and arg_27_1.time_ <= var_30_28 + arg_30_0 then
				local var_30_29 = arg_27_1.var_.effectwanqu3
				local var_30_30
				local var_30_31 = var_30_27

				if not var_30_29 then
					var_30_29 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_ripple"), var_30_31)
					var_30_29.name = "wanqu3"
					arg_27_1.var_.effectwanqu3 = var_30_29
				else
					var_30_29.transform:SetParent(var_30_31)
				end

				var_30_29.transform.localPosition = Vector3.New(0, 0, 0)
				var_30_29.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_30_32 = manager.ui.mainCamera.transform
			local var_30_33 = 2

			if var_30_33 < arg_27_1.time_ and arg_27_1.time_ <= var_30_33 + arg_30_0 then
				local var_30_34 = arg_27_1.var_.effectqiangxiang1

				if var_30_34 then
					Object.Destroy(var_30_34)

					arg_27_1.var_.effectqiangxiang1 = nil
				end
			end

			local var_30_35 = manager.ui.mainCamera.transform
			local var_30_36 = 2.1

			if var_30_36 < arg_27_1.time_ and arg_27_1.time_ <= var_30_36 + arg_30_0 then
				local var_30_37 = arg_27_1.var_.effectwanqu1

				if var_30_37 then
					Object.Destroy(var_30_37)
			...
			if var_30_38 < arg_27_1.time_ and arg_27_1.time_ <= var_30_38 + arg_30_0 then
				local var_30_40 = "play"
				local var_30_41 = "effect"

				arg_27_1:AudioAction(var_30_40, var_30_41, "se_story_140", "se_story_140_gun02", "")
			end
			...
			local var_30_42 = 5.43333333333333
			local var_30_43 = 1.5
			...
			if var_30_42 < arg_27_1.time_ and arg_27_1.time_ <= var_30_42 + arg_30_0 then
				...
				local var_30_45 = arg_27_1:GetWordFromCfg(321171006)
