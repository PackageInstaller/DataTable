	...
	Play121551051 = function(arg_215_0, arg_215_1)
		...
		function arg_215_1.onSingleLineUpdate_(arg_218_0)
			...
			if var_218_41 < arg_215_1.time_ and arg_215_1.time_ <= var_218_41 + arg_218_0 then
				...
				local var_218_43 = arg_215_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_218_44 = var_218_42:GetComponent("Text")
				local var_218_45 = var_218_42:GetComponent("RectTransform")

				var_218_44.alignment = UnityEngine.TextAnchor.MiddleCenter
				var_218_45.offsetMin = Vector2.New(0, 0)
				var_218_45.offsetMax = Vector2.New(0, 0)
			end
		end
