	...
	Play104012001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_13 < arg_1_1.time_ and arg_1_1.time_ <= var_4_13 + arg_4_0 then
				...
				if var_4_14 then
					arg_1_1.var_.alphaOldValueS0401 = var_4_14.color.a
					arg_1_1.var_.alphaMatValueS0401 = var_4_14
				end
			...
			if var_4_13 <= arg_1_1.time_ and arg_1_1.time_ < var_4_13 + var_4_15 then
				...
				if arg_1_1.var_.alphaMatValueS0401 then
					local var_4_18 = arg_1_1.var_.alphaMatValueS0401.color

					var_4_18.a = var_4_17
					arg_1_1.var_.alphaMatValueS0401.color = var_4_18
				end
			end

			if arg_1_1.time_ >= var_4_13 + var_4_15 and arg_1_1.time_ < var_4_13 + var_4_15 + arg_4_0 and arg_1_1.var_.alphaMatValueS0401 then
				local var_4_19 = arg_1_1.var_.alphaMatValueS0401
			...
			if var_4_21 < arg_1_1.time_ and arg_1_1.time_ <= var_4_21 + arg_4_0 then
				...
				local var_4_24 = arg_1_1.bgs_.S0401
			...
			if var_4_37 < arg_1_1.time_ and arg_1_1.time_ <= var_4_37 + arg_4_0 then
				...
				local var_4_40 = arg_1_1:FormatText(StoryNameCfg[49].name)
				...
				local var_4_41 = arg_1_1:GetWordFromCfg(104012001)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012001", "story_v_out_104012.awb") ~= 0 then
					local var_4_46 = manager.audio:GetVoiceLength("story_v_out_104012", "104012001", "story_v_out_104012.awb") / 1000
					...
					if var_4_41.prefab_name ~= "" and arg_1_1.actors_[var_4_41.prefab_name] ~= nil then
						local var_4_47 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_41.prefab_name].transform, "story_v_out_104012", "104012001", "story_v_out_104012.awb")

						arg_1_1:RecordAudio("104012001", var_4_47)
						arg_1_1:RecordAudio("104012001", var_4_47)
					else
