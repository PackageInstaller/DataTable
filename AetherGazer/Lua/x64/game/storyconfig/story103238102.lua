return {
	Play323812001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 323812001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_29 = arg_1_1.actors_["10170ui_story"].transform
			local var_4_30 = 3.26666666666667

			if var_4_30 < arg_1_1.time_ and arg_1_1.time_ <= var_4_30 + arg_4_0 then
				arg_1_1.var_.moveOldPos10170ui_story = var_4_29.localPosition
			...
			if var_4_30 <= arg_1_1.time_ and arg_1_1.time_ < var_4_30 + var_4_32 then
				...
				local var_4_34 = Vector3.New(0, -1.03, -6.05)

				var_4_29.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos10170ui_story, var_4_34, var_4_33)
			...
			if arg_1_1.time_ >= var_4_30 + var_4_32 and arg_1_1.time_ < var_4_30 + var_4_32 + arg_4_0 then
				var_4_29.localPosition = Vector3.New(0, -1.03, -6.05)
			...
			local var_4_40 = arg_1_1.actors_["10170ui_story"]
			local var_4_41 = 3.26666666666667

			if var_4_41 < arg_1_1.time_ and arg_1_1.time_ <= var_4_41 + arg_4_0 and not isNil(var_4_40) and arg_1_1.var_.characterEffect10170ui_story == nil then
				arg_1_1.var_.characterEffect10170ui_story = var_4_40:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_4_41 <= arg_1_1.time_ and arg_1_1.time_ < var_4_41 + var_4_42 and not isNil(var_4_40) then
				...
				if arg_1_1.var_.characterEffect10170ui_story and not isNil(var_4_40) then
					arg_1_1.var_.characterEffect10170ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= var_4_41 + var_4_42 and arg_1_1.time_ < var_4_41 + var_4_42 + arg_4_0 and not isNil(var_4_40) and arg_1_1.var_.characterEffect10170ui_story then
				arg_1_1.var_.characterEffect10170ui_story.fillFlat = false
			end

			local var_4_44 = 3.26666666666667

			if var_4_44 < arg_1_1.time_ and arg_1_1.time_ <= var_4_44 + arg_4_0 then
				arg_1_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/public_expression/expr_wubiaoqing", "EmotionTimelineAnimator")
			end

			local var_4_45 = manager.ui.mainCamera.transform
			local var_4_46 = 0.466666666666667

			if var_4_46 < arg_1_1.time_ and arg_1_1.time_ <= var_4_46 + arg_4_0 then
				local var_4_47 = arg_1_1.var_.effect4dd
				local var_4_48
				local var_4_49 = var_4_45

				if not var_4_47 then
					var_4_47 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_scan_in_out"), var_4_49)
					var_4_47.name = "4dd"
					arg_1_1.var_.effect4dd = var_4_47
				else
					var_4_47.transform:SetParent(var_4_49)
				end

				var_4_47.transform.localPosition = Vector3.New(0, 0, 0)
				var_4_47.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_4_50 = manager.ui.mainCamera.transform
			local var_4_51 = 4.46666666666667

			if var_4_51 < arg_1_1.time_ and arg_1_1.time_ <= var_4_51 + arg_4_0 then
				local var_4_52 = arg_1_1.var_.effect4dd

				if var_4_52 then
					Object.Destroy(var_4_52)

					arg_1_1.var_.effect4dd = nil
				end
			end

			local var_4_53 = 1.76666666666667

			if var_4_53 < arg_1_1.time_ and arg_1_1.time_ <= var_4_53 + arg_4_0 then
				arg_1_1.allBtn_.enabled = false
			end

			local var_4_54 = 1.8666666696469
			...
			if var_4_61 < arg_1_1.time_ and arg_1_1.time_ <= var_4_61 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_63, var_4_64, "bgm_activity_4_8_story_mountain", "bgm_activity_4_8_story_mountain", "bgm_activity_4_8_story_mountain.awb")

				local var_4_65 = ""
				local var_4_66 = manager.audio:GetAudioName("bgm_activity_4_8_story_mountain", "bgm_activity_4_8_story_mountain")
			...
			local var_4_67 = 0.533333333333333
			local var_4_68 = 1
			...
			if var_4_67 < arg_1_1.time_ and arg_1_1.time_ <= var_4_67 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_69, var_4_70, "se_story_148", "se_story_148_scan", "")
			end
			...
			if var_4_71 < arg_1_1.time_ and arg_1_1.time_ <= var_4_71 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_73, var_4_74, "se_story_148", "se_story_148_scan", "")
			end

			local var_4_75 = 0.166666666666667
			local var_4_76 = 1

			if var_4_75 < arg_1_1.time_ and arg_1_1.time_ <= var_4_75 + arg_4_0 then
				local var_4_77 = "play"
				local var_4_78 = "effect"

				arg_1_1:AudioAction(var_4_77, var_4_78, "se_story_side_1070", "se_story_1070_wind01_loop", "")
			end

			local var_4_79 = 3.26666666666667

			if var_4_79 < arg_1_1.time_ and arg_1_1.time_ <= var_4_79 + arg_4_0 then
				arg_1_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/story10170/story10170action/10170action1_1")
			end
			...
			local var_4_80 = 3.63333333631357
			local var_4_81 = 0.125
			...
			if var_4_80 < arg_1_1.time_ and arg_1_1.time_ <= var_4_80 + arg_4_0 then
				...
				local var_4_82 = LeanTween.value(arg_1_1.dialog_, 0, 1, 0.3)

				var_4_82:setOnUpdate(LuaHelper.FloatAction(function(arg_7_0)
					arg_1_1.dialogCg_.alpha = arg_7_0
				end))
				var_4_82:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_1_1.dialog_)
					var_4_82:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_4_83 = arg_1_1:FormatText(StoryNameCfg[1450].name)

				arg_1_1.leftNameTxt_.text = var_4_83
				...
				local var_4_84 = arg_1_1:GetWordFromCfg(323812001)
				...
				local var_4_88 = var_4_86 <= 0 and var_4_81 or var_4_81 * (var_4_87 / var_4_86)

				if var_4_88 > 0 and var_4_81 < var_4_88 then
					arg_1_1.talkMaxDuration = var_4_88
					var_4_80 = var_4_80 + 0.3

					if var_4_88 + var_4_80 > arg_1_1.duration_ then
						arg_1_1.duration_ = var_4_88 + var_4_80
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_323812", "323812001", "story_v_out_323812.awb") ~= 0 then
					local var_4_89 = manager.audio:GetVoiceLength("story_v_out_323812", "323812001", "story_v_out_323812.awb") / 1000

					if var_4_89 + var_4_80 > arg_1_1.duration_ then
						arg_1_1.duration_ = var_4_89 + var_4_80
					end

					if var_4_84.prefab_name ~= "" and arg_1_1.actors_[var_4_84.prefab_name] ~= nil then
						local var_4_90 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_84.prefab_name].transform, "story_v_out_323812", "323812001", "story_v_out_323812.awb")

						arg_1_1:RecordAudio("323812001", var_4_90)
						arg_1_1:RecordAudio("323812001", var_4_90)
					else
						arg_1_1:AudioAction("play", "voice", "story_v_out_323812", "323812001", "story_v_out_323812.awb")
					end

					arg_1_1:RecordHistoryTalkVoice("story_v_out_323812", "323812001", "story_v_out_323812.awb")
				end

				arg_1_1:RecordContent(arg_1_1.text_.text)
			end

			local var_4_91 = var_4_80 + 0.3
			local var_4_92 = math.max(var_4_81, arg_1_1.talkMaxDuration)

			if var_4_91 <= arg_1_1.time_ and arg_1_1.time_ < var_4_91 + var_4_92 then
				arg_1_1.typewritter.percent = (arg_1_1.time_ - var_4_91) / var_4_92

				arg_1_1.typewritter:SetDirty()
			end

			if arg_1_1.time_ >= var_4_91 + var_4_92 and arg_1_1.time_ < var_4_91 + var_4_92 + arg_4_0 then
	...
	Play323812002 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 323812002
		arg_9_1.duration_ = 5
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_6 < arg_9_1.time_ and arg_9_1.time_ <= var_12_6 + arg_12_0 then
				...
				local var_12_8 = arg_9_1:GetWordFromCfg(323812002)
	...
	Play323812003 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 323812003
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play323812004(arg_13_1)
			end
		end
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_0 + arg_16_0 then
				...
				local var_16_3 = arg_13_1:GetWordFromCfg(323812003)
	...
	Play323812004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 323812004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play323812005(arg_17_1)
			end
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_4 < arg_17_1.time_ and arg_17_1.time_ <= var_20_4 + arg_20_0 then
				arg_17_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/public_expression/expr_wubiaoqing", "EmotionTimelineAnimator")
			end

			local var_20_5 = 0

			if var_20_5 < arg_17_1.time_ and arg_17_1.time_ <= var_20_5 + arg_20_0 then
				arg_17_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/story10170/story10170action/10170action30_1")
			end
			...
			if var_20_6 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_8 = arg_17_1:FormatText(StoryNameCfg[1450].name)
				...
				local var_20_9 = arg_17_1:GetWordFromCfg(323812004)
				...
				if manager.audio:GetVoiceLength("story_v_out_323812", "323812004", "story_v_out_323812.awb") ~= 0 then
					local var_20_14 = manager.audio:GetVoiceLength("story_v_out_323812", "323812004", "story_v_out_323812.awb") / 1000
					...
					if var_20_9.prefab_name ~= "" and arg_17_1.actors_[var_20_9.prefab_name] ~= nil then
						local var_20_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_9.prefab_name].transform, "story_v_out_323812", "323812004", "story_v_out_323812.awb")

						arg_17_1:RecordAudio("323812004", var_20_15)
						arg_17_1:RecordAudio("323812004", var_20_15)
					else
						arg_17_1:AudioAction("play", "voice", "story_v_out_323812", "323812004", "story_v_out_323812.awb")
					end

					arg_17_1:RecordHistoryTalkVoice("story_v_out_323812", "323812004", "story_v_out_323812.awb")
				end
	...
	Play323812005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 323812005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play323812006(arg_21_1)
			end
		end
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_6 < arg_21_1.time_ and arg_21_1.time_ <= var_24_6 + arg_24_0 then
				...
				local var_24_9 = arg_21_1:GetWordFromCfg(323812005)
	...
	Play323812006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 323812006
		...
		function arg_25_1.playNext_(arg_27_0)
			if arg_27_0 == 1 then
				arg_25_0:Play323812007(arg_25_1)
			end
		end
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_4 < arg_25_1.time_ and arg_25_1.time_ <= var_28_4 + arg_28_0 then
				...
				local var_28_6 = arg_25_1:FormatText(StoryNameCfg[1450].name)
				...
				local var_28_7 = arg_25_1:GetWordFromCfg(323812006)
				...
				if manager.audio:GetVoiceLength("story_v_out_323812", "323812006", "story_v_out_323812.awb") ~= 0 then
					local var_28_12 = manager.audio:GetVoiceLength("story_v_out_323812", "323812006", "story_v_out_323812.awb") / 1000
					...
					if var_28_7.prefab_name ~= "" and arg_25_1.actors_[var_28_7.prefab_name] ~= nil then
						local var_28_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_7.prefab_name].transform, "story_v_out_323812", "323812006", "story_v_out_323812.awb")

						arg_25_1:RecordAudio("323812006", var_28_13)
						arg_25_1:RecordAudio("323812006", var_28_13)
					else
						arg_25_1:AudioAction("play", "voice", "story_v_out_323812", "323812006", "story_v_out_323812.awb")
					end

					arg_25_1:RecordHistoryTalkVoice("story_v_out_323812", "323812006", "story_v_out_323812.awb")
				end
	...
	Play323812007 = function(arg_29_0, arg_29_1)
		arg_29_1.time_ = 0
		arg_29_1.frameCnt_ = 0
		arg_29_1.state_ = "playing"
		arg_29_1.curTalkId_ = 323812007
		...
		function arg_29_1.playNext_(arg_31_0)
			if arg_31_0 == 1 then
				arg_29_0:Play323812008(arg_29_1)
			end
		end
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_6 < arg_29_1.time_ and arg_29_1.time_ <= var_32_6 + arg_32_0 then
				...
				local var_32_9 = arg_29_1:GetWordFromCfg(323812007)
	...
	Play323812008 = function(arg_33_0, arg_33_1)
		arg_33_1.time_ = 0
		arg_33_1.frameCnt_ = 0
		arg_33_1.state_ = "playing"
		arg_33_1.curTalkId_ = 323812008
		...
		function arg_33_1.playNext_(arg_35_0)
			if arg_35_0 == 1 then
				arg_33_0:Play323812009(arg_33_1)
			end
		end
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_0 + arg_36_0 then
				...
				local var_36_3 = arg_33_1:GetWordFromCfg(323812008)
	...
	Play323812009 = function(arg_37_0, arg_37_1)
		arg_37_1.time_ = 0
		arg_37_1.frameCnt_ = 0
		arg_37_1.state_ = "playing"
		arg_37_1.curTalkId_ = 323812009
		...
		function arg_37_1.playNext_(arg_39_0)
			if arg_39_0 == 1 then
				arg_37_0:Play323812010(arg_37_1)
			end
		end
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_5 < arg_37_1.time_ and arg_37_1.time_ <= var_40_5 + arg_40_0 then
				arg_37_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/story10170/story10170actionlink/10170action4302")
			end
			...
			if var_40_6 < arg_37_1.time_ and arg_37_1.time_ <= var_40_6 + arg_40_0 then
				...
				local var_40_9 = arg_37_1:GetWordFromCfg(323812009)
				...
				if manager.audio:GetVoiceLength("story_v_out_323812", "323812009", "story_v_out_323812.awb") ~= 0 then
					local var_40_14 = manager.audio:GetVoiceLength("story_v_out_323812", "323812009", "story_v_out_323812.awb") / 1000
					...
					if var_40_9.prefab_name ~= "" and arg_37_1.actors_[var_40_9.prefab_name] ~= nil then
						local var_40_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_9.prefab_name].transform, "story_v_out_323812", "323812009", "story_v_out_323812.awb")

						arg_37_1:RecordAudio("323812009", var_40_15)
						arg_37_1:RecordAudio("323812009", var_40_15)
					else
						arg_37_1:AudioAction("play", "voice", "story_v_out_323812", "323812009", "story_v_out_323812.awb")
					end

					arg_37_1:RecordHistoryTalkVoice("story_v_out_323812", "323812009", "story_v_out_323812.awb")
				end
	...
	Play323812010 = function(arg_41_0, arg_41_1)
		arg_41_1.time_ = 0
		arg_41_1.frameCnt_ = 0
		arg_41_1.state_ = "playing"
		arg_41_1.curTalkId_ = 323812010
		...
		function arg_41_1.playNext_(arg_43_0)
			if arg_43_0 == 1 then
				arg_41_0:Play323812011(arg_41_1)
			end
		end
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_6 < arg_41_1.time_ and arg_41_1.time_ <= var_44_6 + arg_44_0 then
				...
				local var_44_9 = arg_41_1:GetWordFromCfg(323812010)
	...
	Play323812011 = function(arg_45_0, arg_45_1)
		arg_45_1.time_ = 0
		arg_45_1.frameCnt_ = 0
		arg_45_1.state_ = "playing"
		arg_45_1.curTalkId_ = 323812011
		...
		function arg_45_1.playNext_(arg_47_0)
			if arg_47_0 == 1 then
				arg_45_0:Play323812012(arg_45_1)
			end
		end
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_11 < arg_45_1.time_ and arg_45_1.time_ <= var_48_11 + arg_48_0 then
				...
				local var_48_13 = arg_45_1:GetWordFromCfg(323812011)
	...
	Play323812012 = function(arg_49_0, arg_49_1)
		arg_49_1.time_ = 0
		arg_49_1.frameCnt_ = 0
		arg_49_1.state_ = "playing"
		arg_49_1.curTalkId_ = 323812012
		...
		function arg_49_1.playNext_(arg_51_0)
			if arg_51_0 == 1 then
				arg_49_0:Play323812013(arg_49_1)
			end
		end

		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			local var_52_0 = arg_49_1.actors_["10170ui_story"].transform
			local var_52_1 = 0

			if var_52_1 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				arg_49_1.var_.moveOldPos10170ui_story = var_52_0.localPosition
			...
			if var_52_1 <= arg_49_1.time_ and arg_49_1.time_ < var_52_1 + var_52_3 then
				...
				local var_52_5 = Vector3.New(0, -1.03, -6.05)

				var_52_0.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos10170ui_story, var_52_5, var_52_4)
			...
			if arg_49_1.time_ >= var_52_1 + var_52_3 and arg_49_1.time_ < var_52_1 + var_52_3 + arg_52_0 then
				var_52_0.localPosition = Vector3.New(0, -1.03, -6.05)
			...
			local var_52_11 = arg_49_1.actors_["10170ui_story"]
			local var_52_12 = 0

			if var_52_12 < arg_49_1.time_ and arg_49_1.time_ <= var_52_12 + arg_52_0 and not isNil(var_52_11) and arg_49_1.var_.characterEffect10170ui_story == nil then
				arg_49_1.var_.characterEffect10170ui_story = var_52_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_52_12 <= arg_49_1.time_ and arg_49_1.time_ < var_52_12 + var_52_13 and not isNil(var_52_11) then
				...
				if arg_49_1.var_.characterEffect10170ui_story and not isNil(var_52_11) then
					arg_49_1.var_.characterEffect10170ui_story.fillFlat = false
				end
			end

			if arg_49_1.time_ >= var_52_12 + var_52_13 and arg_49_1.time_ < var_52_12 + var_52_13 + arg_52_0 and not isNil(var_52_11) and arg_49_1.var_.characterEffect10170ui_story then
				arg_49_1.var_.characterEffect10170ui_story.fillFlat = false
			end
			...
			if var_52_16 < arg_49_1.time_ and arg_49_1.time_ <= var_52_16 + arg_52_0 then
				arg_49_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/story10170/story10170action/10170action2_2")
			end
			...
			if var_52_17 < arg_49_1.time_ and arg_49_1.time_ <= var_52_17 + arg_52_0 then
				...
				local var_52_19 = arg_49_1:FormatText(StoryNameCfg[1450].name)
				...
				local var_52_20 = arg_49_1:GetWordFromCfg(323812012)
				...
				if manager.audio:GetVoiceLength("story_v_out_323812", "323812012", "story_v_out_323812.awb") ~= 0 then
					local var_52_25 = manager.audio:GetVoiceLength("story_v_out_323812", "323812012", "story_v_out_323812.awb") / 1000
					...
					if var_52_20.prefab_name ~= "" and arg_49_1.actors_[var_52_20.prefab_name] ~= nil then
						local var_52_26 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_20.prefab_name].transform, "story_v_out_323812", "323812012", "story_v_out_323812.awb")

						arg_49_1:RecordAudio("323812012", var_52_26)
						arg_49_1:RecordAudio("323812012", var_52_26)
					else
						arg_49_1:AudioAction("play", "voice", "story_v_out_323812", "323812012", "story_v_out_323812.awb")
					end

					arg_49_1:RecordHistoryTalkVoice("story_v_out_323812", "323812012", "story_v_out_323812.awb")
				end
	...
	Play323812013 = function(arg_53_0, arg_53_1)
		arg_53_1.time_ = 0
		arg_53_1.frameCnt_ = 0
		arg_53_1.state_ = "playing"
		arg_53_1.curTalkId_ = 323812013
		...
		function arg_53_1.playNext_(arg_55_0)
			if arg_55_0 == 1 then
				arg_53_0:Play323812014(arg_53_1)
			end
		end
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_6 < arg_53_1.time_ and arg_53_1.time_ <= var_56_6 + arg_56_0 then
				...
				local var_56_9 = arg_53_1:GetWordFromCfg(323812013)
	...
	Play323812014 = function(arg_57_0, arg_57_1)
		arg_57_1.time_ = 0
		arg_57_1.frameCnt_ = 0
		arg_57_1.state_ = "playing"
		arg_57_1.curTalkId_ = 323812014
		...
		function arg_57_1.playNext_(arg_59_0)
			if arg_59_0 == 1 then
				arg_57_0:Play323812015(arg_57_1)
			end
		end
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_4 < arg_57_1.time_ and arg_57_1.time_ <= var_60_4 + arg_60_0 then
				...
				local var_60_6 = arg_57_1:FormatText(StoryNameCfg[1450].name)
				...
				local var_60_7 = arg_57_1:GetWordFromCfg(323812014)
				...
				if manager.audio:GetVoiceLength("story_v_out_323812", "323812014", "story_v_out_323812.awb") ~= 0 then
					local var_60_12 = manager.audio:GetVoiceLength("story_v_out_323812", "323812014", "story_v_out_323812.awb") / 1000
					...
					if var_60_7.prefab_name ~= "" and arg_57_1.actors_[var_60_7.prefab_name] ~= nil then
						local var_60_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_57_1.actors_[var_60_7.prefab_name].transform, "story_v_out_323812", "323812014", "story_v_out_323812.awb")

						arg_57_1:RecordAudio("323812014", var_60_13)
						arg_57_1:RecordAudio("323812014", var_60_13)
					else
						arg_57_1:AudioAction("play", "voice", "story_v_out_323812", "323812014", "story_v_out_323812.awb")
					end

					arg_57_1:RecordHistoryTalkVoice("story_v_out_323812", "323812014", "story_v_out_323812.awb")
				end
	...
	Play323812015 = function(arg_61_0, arg_61_1)
		arg_61_1.time_ = 0
		arg_61_1.frameCnt_ = 0
		arg_61_1.state_ = "playing"
		arg_61_1.curTalkId_ = 323812015
		...
		function arg_61_1.playNext_(arg_63_0)
			if arg_63_0 == 1 then
				arg_61_0:Play323812016(arg_61_1)
			end
		end
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_6 < arg_61_1.time_ and arg_61_1.time_ <= var_64_6 + arg_64_0 then
				...
				local var_64_8 = arg_61_1:GetWordFromCfg(323812015)
	...
	Play323812016 = function(arg_65_0, arg_65_1)
		arg_65_1.time_ = 0
		arg_65_1.frameCnt_ = 0
		arg_65_1.state_ = "playing"
		arg_65_1.curTalkId_ = 323812016
		...
		function arg_65_1.playNext_(arg_67_0)
			if arg_67_0 == 1 then
				arg_65_0:Play323812017(arg_65_1)
			end
		end
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_0 + arg_68_0 then
				...
				local var_68_3 = arg_65_1:GetWordFromCfg(323812016)
	...
	Play323812017 = function(arg_69_0, arg_69_1)
		arg_69_1.time_ = 0
		arg_69_1.frameCnt_ = 0
		arg_69_1.state_ = "playing"
		arg_69_1.curTalkId_ = 323812017
		...
		function arg_69_1.playNext_(arg_71_0)
			if arg_71_0 == 1 then
				arg_69_0:Play323812018(arg_69_1)
			end
		end
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_11 < arg_69_1.time_ and arg_69_1.time_ <= var_72_11 + arg_72_0 then
				...
				local var_72_13 = arg_69_1:GetWordFromCfg(323812017)
	...
	Play323812018 = function(arg_73_0, arg_73_1)
		arg_73_1.time_ = 0
		arg_73_1.frameCnt_ = 0
		arg_73_1.state_ = "playing"
		arg_73_1.curTalkId_ = 323812018
		arg_73_1.duration_ = 2.87
		...
		function arg_73_1.playNext_(arg_75_0)
			if arg_75_0 == 1 then
				arg_73_0:Play323812019(arg_73_1)
			end
		end
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if var_76_1 <= arg_73_1.time_ and arg_73_1.time_ < var_76_1 + var_76_3 then
				...
				local var_76_5 = Vector3.New(0, -1.03, -6.05)
			...
			if arg_73_1.time_ >= var_76_1 + var_76_3 and arg_73_1.time_ < var_76_1 + var_76_3 + arg_76_0 then
				var_76_0.localPosition = Vector3.New(0, -1.03, -6.05)
			...
			local var_76_11 = arg_73_1.actors_["10170ui_story"]
			local var_76_12 = 0

			if var_76_12 < arg_73_1.time_ and arg_73_1.time_ <= var_76_12 + arg_76_0 and not isNil(var_76_11) and arg_73_1.var_.characterEffect10170ui_story == nil then
				arg_73_1.var_.characterEffect10170ui_story = var_76_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_76_12 <= arg_73_1.time_ and arg_73_1.time_ < var_76_12 + var_76_13 and not isNil(var_76_11) then
				...
				if arg_73_1.var_.characterEffect10170ui_story and not isNil(var_76_11) then
					arg_73_1.var_.characterEffect10170ui_story.fillFlat = false
				end
			end

			if arg_73_1.time_ >= var_76_12 + var_76_13 and arg_73_1.time_ < var_76_12 + var_76_13 + arg_76_0 and not isNil(var_76_11) and arg_73_1.var_.characterEffect10170ui_story then
				arg_73_1.var_.characterEffect10170ui_story.fillFlat = false
			end
			...
			if var_76_15 < arg_73_1.time_ and arg_73_1.time_ <= var_76_15 + arg_76_0 then
				arg_73_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/public_expression/expr_wubiaoqing", "EmotionTimelineAnimator")
			end

			local var_76_16 = 0

			if var_76_16 < arg_73_1.time_ and arg_73_1.time_ <= var_76_16 + arg_76_0 then
				arg_73_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/story10170/story10170action/10170action1_1")
			end
			...
			if var_76_17 < arg_73_1.time_ and arg_73_1.time_ <= var_76_17 + arg_76_0 then
				...
				local var_76_19 = arg_73_1:FormatText(StoryNameCfg[1450].name)

				arg_73_1.leftNameTxt_.text = var_76_19
				...
				local var_76_20 = arg_73_1:GetWordFromCfg(323812018)
				...
				local var_76_24 = var_76_22 <= 0 and var_76_18 or var_76_18 * (var_76_23 / var_76_22)

				if var_76_24 > 0 and var_76_18 < var_76_24 then
				...
				if manager.audio:GetVoiceLength("story_v_out_323812", "323812018", "story_v_out_323812.awb") ~= 0 then
					local var_76_25 = manager.audio:GetVoiceLength("story_v_out_323812", "323812018", "story_v_out_323812.awb") / 1000

					if var_76_25 + var_76_17 > arg_73_1.duration_ then
						arg_73_1.duration_ = var_76_25 + var_76_17
					end

					if var_76_20.prefab_name ~= "" and arg_73_1.actors_[var_76_20.prefab_name] ~= nil then
						local var_76_26 = LuaForUtil.PlayVoiceWithCriLipsync(arg_73_1.actors_[var_76_20.prefab_name].transform, "story_v_out_323812", "323812018", "story_v_out_323812.awb")

						arg_73_1:RecordAudio("323812018", var_76_26)
						arg_73_1:RecordAudio("323812018", var_76_26)
					else
						arg_73_1:AudioAction("play", "voice", "story_v_out_323812", "323812018", "story_v_out_323812.awb")
					end

					arg_73_1:RecordHistoryTalkVoice("story_v_out_323812", "323812018", "story_v_out_323812.awb")
				end
			...
			if var_76_17 <= arg_73_1.time_ and arg_73_1.time_ < var_76_17 + var_76_27 then
				arg_73_1.typewritter.percent = (arg_73_1.time_ - var_76_17) / var_76_27

				arg_73_1.typewritter:SetDirty()
			end

			if arg_73_1.time_ >= var_76_17 + var_76_27 and arg_73_1.time_ < var_76_17 + var_76_27 + arg_76_0 then
	...
	Play323812019 = function(arg_77_0, arg_77_1)
		arg_77_1.time_ = 0
		arg_77_1.frameCnt_ = 0
		arg_77_1.state_ = "playing"
		arg_77_1.curTalkId_ = 323812019
		...
		function arg_77_1.playNext_(arg_79_0)
			if arg_79_0 == 1 then
				arg_77_0:Play323812020(arg_77_1)
			end
		end
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if var_80_6 < arg_77_1.time_ and arg_77_1.time_ <= var_80_6 + arg_80_0 then
				...
				local var_80_9 = arg_77_1:GetWordFromCfg(323812019)
	...
	Play323812020 = function(arg_81_0, arg_81_1)
		arg_81_1.time_ = 0
		arg_81_1.frameCnt_ = 0
		arg_81_1.state_ = "playing"
		arg_81_1.curTalkId_ = 323812020
		arg_81_1.duration_ = 3.23
		...
		function arg_81_1.playNext_(arg_83_0)
			if arg_83_0 == 1 then
				arg_81_0:Play323812021(arg_81_1)
			end
		end
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if var_84_5 < arg_81_1.time_ and arg_81_1.time_ <= var_84_5 + arg_84_0 then
				arg_81_1:PlayTimeline("10170ui_story", "StoryTimeline/CharAction/story10170/story10170action/10170action15_1")
			end
			...
			if var_84_6 < arg_81_1.time_ and arg_81_1.time_ <= var_84_6 + arg_84_0 then
				...
				local var_84_9 = arg_81_1:GetWordFromCfg(323812020)
				...
				if manager.audio:GetVoiceLength("story_v_out_323812", "323812020", "story_v_out_323812.awb") ~= 0 then
					local var_84_14 = manager.audio:GetVoiceLength("story_v_out_323812", "323812020", "story_v_out_323812.awb") / 1000
					...
					if var_84_9.prefab_name ~= "" and arg_81_1.actors_[var_84_9.prefab_name] ~= nil then
						local var_84_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_81_1.actors_[var_84_9.prefab_name].transform, "story_v_out_323812", "323812020", "story_v_out_323812.awb")

						arg_81_1:RecordAudio("323812020", var_84_15)
						arg_81_1:RecordAudio("323812020", var_84_15)
					else
						arg_81_1:AudioAction("play", "voice", "story_v_out_323812", "323812020", "story_v_out_323812.awb")
					end

					arg_81_1:RecordHistoryTalkVoice("story_v_out_323812", "323812020", "story_v_out_323812.awb")
				end
	...
	Play323812021 = function(arg_85_0, arg_85_1)
		arg_85_1.time_ = 0
		arg_85_1.frameCnt_ = 0
		arg_85_1.state_ = "playing"
		arg_85_1.curTalkId_ = 323812021
		...
		function arg_85_1.playNext_(arg_87_0)
			if arg_87_0 == 1 then
				arg_85_0:Play323812022(arg_85_1)
			end
		end
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if var_88_6 < arg_85_1.time_ and arg_85_1.time_ <= var_88_6 + arg_88_0 then
				...
				local var_88_9 = arg_85_1:GetWordFromCfg(323812021)
	...
	Play323812022 = function(arg_89_0, arg_89_1)
		arg_89_1.time_ = 0
		arg_89_1.frameCnt_ = 0
		arg_89_1.state_ = "playing"
		arg_89_1.curTalkId_ = 323812022
		...
		function arg_89_1.playNext_(arg_91_0)
			if arg_91_0 == 1 then
				arg_89_0:Play323812023(arg_89_1)
			end
		end
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			...
			if var_92_11 < arg_89_1.time_ and arg_89_1.time_ <= var_92_11 + arg_92_0 then
				...
				local var_92_13 = arg_89_1:GetWordFromCfg(323812022)
	...
	Play323812023 = function(arg_93_0, arg_93_1)
		arg_93_1.time_ = 0
		arg_93_1.frameCnt_ = 0
		arg_93_1.state_ = "playing"
		arg_93_1.curTalkId_ = 323812023
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if var_96_0 < arg_93_1.time_ and arg_93_1.time_ <= var_96_0 + arg_96_0 then
				...
				local var_96_2 = arg_93_1:GetWordFromCfg(323812023)
