return {
	Play910810001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 910810001
		arg_1_1.duration_ = 7
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_45 < arg_1_1.time_ and arg_1_1.time_ <= var_4_45 + arg_4_0 then
				...
				local var_4_49 = arg_1_1:GetWordFromCfg(910810001)
	...
	Play910810002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 910810002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
					...
					for iter_10_1, iter_10_2 in pairs(arg_7_1.var_.actorSpriteComps1070:ToTable()) do
						if iter_10_2 then
							if arg_7_1.isInRecall_ then
								local var_10_11 = Mathf.Lerp(iter_10_2.color.r, arg_7_1.hightColor2.r, var_10_10)
								local var_10_12 = Mathf.Lerp(iter_10_2.color.g, arg_7_1.hightColor2.g, var_10_10)
								local var_10_13 = Mathf.Lerp(iter_10_2.color.b, arg_7_1.hightColor2.b, var_10_10)

								iter_10_2.color = Color.New(var_10_11, var_10_12, var_10_13)
							else
								local var_10_14 = Mathf.Lerp(iter_10_2.color.r, 0.5, var_10_10)
			...
			if arg_7_1.time_ >= var_10_8 + var_10_9 and arg_7_1.time_ < var_10_8 + var_10_9 + arg_10_0 and not isNil(var_10_7) and arg_7_1.var_.actorSpriteComps1070 then
				for iter_10_3, iter_10_4 in pairs(arg_7_1.var_.actorSpriteComps1070:ToTable()) do
					if iter_10_4 then
						if arg_7_1.isInRecall_ then
							iter_10_4.color = arg_7_1.hightColor2 or Color.New(0.46, 0.43, 0.35)
						else
							iter_10_4.color = Color.New(0.5, 0.5, 0.5)
						end
					end
				end
			...
			if var_10_15 < arg_7_1.time_ and arg_7_1.time_ <= var_10_15 + arg_10_0 then
				...
				local var_10_18 = arg_7_1:GetWordFromCfg(910810002)
	...
	Play910810003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 910810003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play910810004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				local var_14_18 = arg_11_1:GetWordFromCfg(910810003)
	...
	Play910810004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 910810004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play910810005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_15 < arg_15_1.time_ and arg_15_1.time_ <= var_18_15 + arg_18_0 then
				...
				local var_18_17 = arg_15_1:FormatText(StoryNameCfg[623].name)
				...
				local var_18_18 = arg_15_1:GetWordFromCfg(910810004)
	...
	Play910810005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 910810005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play910810006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_15 < arg_19_1.time_ and arg_19_1.time_ <= var_22_15 + arg_22_0 then
				...
				local var_22_18 = arg_19_1:GetWordFromCfg(910810005)
	...
	Play910810006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 910810006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play910810007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_15 < arg_23_1.time_ and arg_23_1.time_ <= var_26_15 + arg_26_0 then
				...
				local var_26_18 = arg_23_1:GetWordFromCfg(910810006)
	...
	Play910810007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 910810007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play910810008(arg_27_1)
			end
		end
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_15 < arg_27_1.time_ and arg_27_1.time_ <= var_30_15 + arg_30_0 then
				...
				local var_30_18 = arg_27_1:GetWordFromCfg(910810007)
	...
	Play910810008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 910810008
		...
		function arg_31_1.playNext_(arg_33_0)
			if arg_33_0 == 1 then
				arg_31_0:Play910810009(arg_31_1)
			end
		end
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_15 < arg_31_1.time_ and arg_31_1.time_ <= var_34_15 + arg_34_0 then
				...
				local var_34_18 = arg_31_1:GetWordFromCfg(910810008)
	...
	Play910810009 = function(arg_35_0, arg_35_1)
		arg_35_1.time_ = 0
		arg_35_1.frameCnt_ = 0
		arg_35_1.state_ = "playing"
		arg_35_1.curTalkId_ = 910810009
		...
		function arg_35_1.playNext_(arg_37_0)
			if arg_37_0 == 1 then
				arg_35_0:Play910810010(arg_35_1)
			end
		end
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_15 < arg_35_1.time_ and arg_35_1.time_ <= var_38_15 + arg_38_0 then
				...
				local var_38_18 = arg_35_1:GetWordFromCfg(910810009)
	...
	Play910810010 = function(arg_39_0, arg_39_1)
		arg_39_1.time_ = 0
		arg_39_1.frameCnt_ = 0
		arg_39_1.state_ = "playing"
		arg_39_1.curTalkId_ = 910810010
		...
		function arg_39_1.playNext_(arg_41_0)
			if arg_41_0 == 1 then
				arg_39_0:Play910810011(arg_39_1)
			end
		end
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_1 < arg_39_1.time_ and arg_39_1.time_ <= var_42_1 + arg_42_0 then
				...
				for iter_42_0 = 0, var_42_2 - 1 do
					...
					if var_42_3.name == "split_6" or not string.find(var_42_3.name, "split") then
			...
			if var_42_15 < arg_39_1.time_ and arg_39_1.time_ <= var_42_15 + arg_42_0 then
				...
				local var_42_18 = arg_39_1:GetWordFromCfg(910810010)
	...
	Play910810011 = function(arg_43_0, arg_43_1)
		arg_43_1.time_ = 0
		arg_43_1.frameCnt_ = 0
		arg_43_1.state_ = "playing"
		arg_43_1.curTalkId_ = 910810011
		...
		function arg_43_1.playNext_(arg_45_0)
			if arg_45_0 == 1 then
				arg_43_0:Play910810012(arg_43_1)
			end
		end
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_15 < arg_43_1.time_ and arg_43_1.time_ <= var_46_15 + arg_46_0 then
				...
				local var_46_18 = arg_43_1:GetWordFromCfg(910810011)
	...
	Play910810012 = function(arg_47_0, arg_47_1)
		arg_47_1.time_ = 0
		arg_47_1.frameCnt_ = 0
		arg_47_1.state_ = "playing"
		arg_47_1.curTalkId_ = 910810012
		...
		function arg_47_1.playNext_(arg_49_0)
			if arg_49_0 == 1 then
				arg_47_0:Play910810013(arg_47_1)
			end
		end
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_15 < arg_47_1.time_ and arg_47_1.time_ <= var_50_15 + arg_50_0 then
				...
				local var_50_18 = arg_47_1:GetWordFromCfg(910810012)
	...
	Play910810013 = function(arg_51_0, arg_51_1)
		arg_51_1.time_ = 0
		arg_51_1.frameCnt_ = 0
		arg_51_1.state_ = "playing"
		arg_51_1.curTalkId_ = 910810013
		...
		function arg_51_1.playNext_(arg_53_0)
			if arg_53_0 == 1 then
				arg_51_0:Play910810014(arg_51_1)
			end
		end
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if var_54_1 < arg_51_1.time_ and arg_51_1.time_ <= var_54_1 + arg_54_0 then
				...
				for iter_54_0 = 0, var_54_2 - 1 do
					...
					if var_54_3.name == "split_9" or not string.find(var_54_3.name, "split") then
			...
			if var_54_15 < arg_51_1.time_ and arg_51_1.time_ <= var_54_15 + arg_54_0 then
				...
				local var_54_17 = arg_51_1:GetWordFromCfg(910810013)
	...
	Play910810014 = function(arg_55_0, arg_55_1)
		arg_55_1.time_ = 0
		arg_55_1.frameCnt_ = 0
		arg_55_1.state_ = "playing"
		arg_55_1.curTalkId_ = 910810014
		...
		function arg_55_1.playNext_(arg_57_0)
			if arg_57_0 == 1 then
				arg_55_0:Play910810015(arg_55_1)
			end
		end
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if var_58_1 < arg_55_1.time_ and arg_55_1.time_ <= var_58_1 + arg_58_0 then
				...
				for iter_58_0 = 0, var_58_2 - 1 do
					...
					if var_58_3.name == "split_9" or not string.find(var_58_3.name, "split") then
			...
			if var_58_15 < arg_55_1.time_ and arg_55_1.time_ <= var_58_15 + arg_58_0 then
				...
				local var_58_18 = arg_55_1:GetWordFromCfg(910810014)
	...
	Play910810015 = function(arg_59_0, arg_59_1)
		arg_59_1.time_ = 0
		arg_59_1.frameCnt_ = 0
		arg_59_1.state_ = "playing"
		arg_59_1.curTalkId_ = 910810015
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if var_62_19 < arg_59_1.time_ and arg_59_1.time_ <= var_62_19 + arg_62_0 then
				...
				local var_62_21 = arg_59_1:FormatText(StoryNameCfg[318].name)
				...
				local var_62_22 = arg_59_1:GetWordFromCfg(910810015)
