	...
	Play321181038 = function(arg_155_0, arg_155_1)
		...
		function arg_155_1.onSingleLineUpdate_(arg_158_0)
			...
			if var_158_30 < arg_155_1.time_ and arg_155_1.time_ <= var_158_30 + arg_158_0 then
				...
				local var_158_32
				local var_158_33 = var_158_29

				if not var_158_31 then
					var_158_31 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_xishan"), var_158_33)
					var_158_31.name = "798"
					arg_155_1.var_.effect798 = var_158_31
				else
					var_158_31.transform:SetParent(var_158_33)
				end

				var_158_31.transform.localPosition = Vector3.New(0, 0, 0)
				var_158_31.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_158_34 = manager.ui.mainCameraCom_
				local var_158_35 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_158_34.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_158_36 = var_158_31.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_158_37 = 15
				local var_158_38 = 2 * var_158_37 * Mathf.Tan(var_158_34.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_158_34.aspect
				local var_158_39 = 1
				local var_158_40 = 1.7777777777777777

				if var_158_40 < var_158_34.aspect then
					var_158_39 = var_158_38 / (2 * var_158_37 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_158_40)
				end

				for iter_158_2, iter_158_3 in ipairs(var_158_36) do
					local var_158_41 = iter_158_3.transform.localScale

					iter_158_3.transform.localScale = Vector3.New(var_158_41.x / var_158_35 * var_158_39, var_158_41.y / var_158_35, var_158_41.z)
				end
			end
			...
			if var_158_42 < arg_155_1.time_ and arg_155_1.time_ <= var_158_42 + arg_158_0 then
				...
				local var_158_44 = LeanTween.value(arg_155_1.dialog_, 0, 1, 0.3)

				var_158_44:setOnUpdate(LuaHelper.FloatAction(function(arg_159_0)
					arg_155_1.dialogCg_.alpha = arg_159_0
				end))
				var_158_44:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_155_1.dialog_)
					var_158_44:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_158_45 = arg_155_1:GetWordFromCfg(321181038)
			...
			local var_158_50 = var_158_42 + 0.3
			local var_158_51 = math.max(var_158_43, arg_155_1.talkMaxDuration)

			if var_158_50 <= arg_155_1.time_ and arg_155_1.time_ < var_158_50 + var_158_51 then
				arg_155_1.typewritter.percent = (arg_155_1.time_ - var_158_50) / var_158_51
	...
	Play321181051 = function(arg_209_0, arg_209_1)
		...
		function arg_209_1.onSingleLineUpdate_(arg_212_0)
			...
			if var_212_1 < arg_209_1.time_ and arg_209_1.time_ <= var_212_1 + arg_212_0 then
				...
				local var_212_3
				local var_212_4 = var_212_0

				if not var_212_2 then
					var_212_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"), var_212_4)
					var_212_2.name = "103211801niuqu"
					arg_209_1.var_.effect103211801niuqu = var_212_2
				else
					var_212_2.transform:SetParent(var_212_4)
				end
			...
			local var_212_6 = 0.566666666666667
			...
			if var_212_7 < arg_209_1.time_ and arg_209_1.time_ <= var_212_7 + arg_212_0 then
				local var_212_9 = "play"
				local var_212_10 = "effect"

				arg_209_1:AudioAction(var_212_9, var_212_10, "se_story_126_01", "se_story_126_01_monster", "")
			end
			...
			local var_212_11 = 0.566666666666667
			local var_212_12 = 0.775
			...
			if var_212_11 < arg_209_1.time_ and arg_209_1.time_ <= var_212_11 + arg_212_0 then
				...
				local var_212_14 = arg_209_1:FormatText(StoryNameCfg[36].name)
				...
				local var_212_15 = arg_209_1:GetWordFromCfg(321181051)
				...
				local var_212_19 = var_212_17 <= 0 and var_212_12 or var_212_12 * (var_212_18 / var_212_17)

				if var_212_19 > 0 and var_212_12 < var_212_19 then
				...
				if manager.audio:GetVoiceLength("story_v_out_321181", "321181051", "story_v_out_321181.awb") ~= 0 then
					local var_212_20 = manager.audio:GetVoiceLength("story_v_out_321181", "321181051", "story_v_out_321181.awb") / 1000

					if var_212_20 + var_212_11 > arg_209_1.duration_ then
						arg_209_1.duration_ = var_212_20 + var_212_11
					end

					if var_212_15.prefab_name ~= "" and arg_209_1.actors_[var_212_15.prefab_name] ~= nil then
						local var_212_21 = LuaForUtil.PlayVoiceWithCriLipsync(arg_209_1.actors_[var_212_15.prefab_name].transform, "story_v_out_321181", "321181051", "story_v_out_321181.awb")

						arg_209_1:RecordAudio("321181051", var_212_21)
						arg_209_1:RecordAudio("321181051", var_212_21)
					else
			...
			local var_212_22 = var_212_11 + 0.3
			local var_212_23 = math.max(var_212_12, arg_209_1.talkMaxDuration)

			if var_212_22 <= arg_209_1.time_ and arg_209_1.time_ < var_212_22 + var_212_23 then
				arg_209_1.typewritter.percent = (arg_209_1.time_ - var_212_22) / var_212_23
