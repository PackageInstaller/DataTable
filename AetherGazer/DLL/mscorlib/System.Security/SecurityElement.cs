...
public sealed class SecurityElement
{
	...
	private static readonly char[] invalid_tag_chars = new char[3] { '\uea45', '頎', '﹝' };

	private static readonly char[] invalid_text_chars = new char[2] { '<', '>' };

	private static readonly char[] invalid_attr_name_chars = new char[3] { '\uea45', '頎', '﹝' };

	private static readonly char[] invalid_attr_value_chars = new char[3] { '᛭', '\0', 'ᛷ' };

	private static readonly char[] invalid_chars = new char[5] { 'ǉ', 'ǌ', 'Ǘ', 'ǚ', 'ǜ' };
