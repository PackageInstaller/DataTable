...
public class Transparent : MonoBehaviour, IMaterialModifier
{
	private class ShaderID
	{
		...
		public static readonly int _Transparent = Shader.PropertyToID("_Transparent");
	...
	internal void UpdateMaterial()
	{
		if (!(_material == null))
		{
			...
			_material.SetFloat(ShaderID._Transparent, _Transparent);
