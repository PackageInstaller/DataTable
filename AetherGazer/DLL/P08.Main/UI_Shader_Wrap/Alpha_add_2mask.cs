...
public class Alpha_add_2mask : MonoBehaviour, IMaterialModifier
{
	private class ShaderID
	{
		...
		public static readonly int _SecPannerX = Shader.PropertyToID("_SecPannerX");

		public static readonly int _SecPannerY = Shader.PropertyToID("_SecPannerY");

		public static readonly int _SecPanner2X = Shader.PropertyToID("_SecPanner2X");

		public static readonly int _SecPanner2Y = Shader.PropertyToID("_SecPanner2Y");
	...
	public float _SecPannerX;

	public float _SecPannerY;

	public float _SecPanner2X;

	public float _SecPanner2Y;
	...
	internal void UpdateMaterial()
	{
		if (!(_material == null))
		{
			...
			_material.SetFloat(ShaderID._SecPannerX, _SecPannerX);
			_material.SetFloat(ShaderID._SecPannerY, _SecPannerY);
			_material.SetFloat(ShaderID._SecPanner2X, _SecPanner2X);
			_material.SetFloat(ShaderID._SecPanner2Y, _SecPanner2Y);
