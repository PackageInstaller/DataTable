...
public class Dynamatic_uveffect_blend : MonoBehaviour, IMaterialModifier
{
	private class ShaderID
	{
		...
		public static readonly int _AlphaR = Shader.PropertyToID("_AlphaR");
	...
	internal void UpdateMaterial()
	{
		if (!(_material == null))
		{
			...
			_material.SetFloat(ShaderID._AlphaR, _AlphaR);
