...
public class Alpha_blend_mask : MonoBehaviour, IMaterialModifier
{
	private class ShaderID
	{
		...
		public static readonly int _MaskAngle = Shader.PropertyToID("_MaskAngle");
	...
	internal void UpdateMaterial()
	{
		if (!(_material == null))
		{
			...
			_material.SetFloat(ShaderID._MaskAngle, _MaskAngle);
