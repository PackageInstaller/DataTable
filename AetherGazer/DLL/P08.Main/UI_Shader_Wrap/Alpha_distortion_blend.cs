...
public class Alpha_distortion_blend : MonoBehaviour, IMaterialModifier
{
	private class ShaderID
	{
		...
		public static readonly int _TurbulenceTex_ST = Shader.PropertyToID("_TurbulenceTex_ST");

		public static readonly int _MaskTex_ST = Shader.PropertyToID("_MaskTex_ST");

		public static readonly int _DistortPower = Shader.PropertyToID("_DistortPower");

		public static readonly int _ForceX = Shader.PropertyToID("_ForceX");

		public static readonly int _ForceY = Shader.PropertyToID("_ForceY");

		public static readonly int _SpherizeFactor = Shader.PropertyToID("_SpherizeFactor");
	...
	public Vector4 _TurbulenceTex_ST = new Vector4(1f, 1f, 0f, 0f);

	public Vector4 _MaskTex_ST = new Vector4(1f, 1f, 0f, 0f);

	public float _DistortPower;
	...
	[Range(0f, 1f)]
	public float _SpherizeFactor;

	[Range(-1f, 1f)]
	public float _Dissolution;
	...
	internal void UpdateMaterial()
	{
		if (!(_material == null))
		{
			...
			_material.SetVector(ShaderID._TurbulenceTex_ST, _TurbulenceTex_ST);
			_material.SetVector(ShaderID._MaskTex_ST, _MaskTex_ST);
			_material.SetFloat(ShaderID._DistortPower, _DistortPower);
			_material.SetFloat(ShaderID._ForceX, _ForceX);
			_material.SetFloat(ShaderID._ForceY, _ForceY);
			_material.SetFloat(ShaderID._SpherizeFactor, _SpherizeFactor);
