...
public class TMPro_TextMeshProUGUIWrap
{
	...
	{
		L.BeginClass(typeof(TextMeshProUGUI), typeof(TMP_Text));
	...
	private static int get_font(IntPtr L)
	{
		...
		try
		{
			...
			TMP_FontAsset font = ((TextMeshProUGUI)obj).font;
	...
	private static int get_text(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			string text = ((TextMeshProUGUI)obj).text;
	...
	private static int set_font(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			TextMeshProUGUI obj2 = (TextMeshProUGUI)obj;
