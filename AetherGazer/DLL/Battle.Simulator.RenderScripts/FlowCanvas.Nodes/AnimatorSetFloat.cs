...
[Name("[动画机]AnimatorSetFloat", 0)]
[Category("Render/Anime")]
[Description("设置Animator变量")]
public class AnimatorSetFloat : FlowControlNodeOfRender
{
	protected override void RegisterPorts()
	{
		...
		ValueInput<float> intValueInput = AddValueInput<float>("值", "value");
		...
		AddFlowInput("In", "input", delegate(Flow f)
		{
			...
			{
				componentInChildren.SetFloat(nameInput.value, intValueInput.value);
				output.Call(f);
			}
		});
	}
