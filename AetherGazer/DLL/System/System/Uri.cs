...
public class Uri : ISerializable
{
	...
	private enum Flags : ulong
	{
		...
		IndexMask = CannotDisplayCanonical | E_CannotDisplayCanonical | ShouldBeCompressed | FirstSlashAbsent | BackslashInPath,
	...
	{
		//IL_000c: Field data (rva=0x908) could not be found in any section!
		//IL_000c: Field data (rva=0x908) could not be found in any section!
	...
	static Uri()
	{
		//IL_012e: Field data (rva=0x5e0) could not be found in any section!
		//IL_012e: Field data (rva=0x5e0) could not be found in any section!
		//IL_0118: Field data (rva=0x590) could not be found in any section!
		//IL_0118: Field data (rva=0x590) could not be found in any section!
		UriSchemeFile = UriParser.FileUri.SchemeName;
		UriSchemeFtp = UriParser.FtpUri.SchemeName;
		UriSchemeGopher = UriParser.GopherUri.SchemeName;
		UriSchemeHttp = UriParser.HttpUri.SchemeName;
		UriSchemeHttps = UriParser.HttpsUri.SchemeName;
		UriSchemeWs = UriParser.WsUri.SchemeName;
		UriSchemeWss = UriParser.WssUri.SchemeName;
		UriSchemeMailto = UriParser.MailToUri.SchemeName;
		UriSchemeNews = UriParser.NewsUri.SchemeName;
		UriSchemeNntp = UriParser.NntpUri.SchemeName;
		UriSchemeNetTcp = UriParser.NetTcpUri.SchemeName;
		UriSchemeNetPipe = UriParser.NetPipeUri.SchemeName;
		SchemeDelimiter = "://";
		s_IdnScope = UriIdnScope.None;
		s_IriParsing = !(Environment.GetEnvironmentVariable("MONO_URI_IRIPARSING") == "false");
		useDotNetRelativeOrAbsolute = Environment.GetEnvironmentVariable("MONO_URI_DOTNETRELATIVEORABSOLUTE") == "true";
		IsWindowsFileSystem = Path.DirectorySeparatorChar == '\\';
