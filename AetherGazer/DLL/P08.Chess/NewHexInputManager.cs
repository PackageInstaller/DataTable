...
public class NewHexInputManager : MonoBehaviour
{
	...
	public static NewHexInputManager _instance;
	...
	public static NewHexInputManager Instance => _instance;
	...
	private void Update()
	{
		...
		if (Input.touchCount == 2)
		{
			...
			if (num2 != 0f)
			{
				NewHexCameraManager.Instance.AddYAxis(num2);
			}
			if (uIPassEvent != null)
			{
