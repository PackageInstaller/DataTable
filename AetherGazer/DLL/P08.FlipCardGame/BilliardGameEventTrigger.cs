...
public class BilliardGameEventTrigger : EventTrigger
{
	private Action<Vector3> clickCallback;

	private Action<Vector3> dragBeginCallback;

	private Action<Vector3, bool> dragCallback;

	private Action<Vector3, bool> dragEndCallback;
	...
	public void SetDragCallBack(Action<Vector3, bool> callback)
	{
		dragCallback = callback;
	}

	public void SetDragEndCallBack(Action<Vector3, bool> callback)
	{
	...
	public void SetDragEnterCallBack()
	{
	}
	...
	public override void OnDrag(PointerEventData eventData)
	{
		...
		{
			bool arg = false;
			if (eventData.hovered.Contains(eventData.pointerDrag) || eventData.hovered.Contains(base.gameObject))
			{
				arg = true;
			}
			dragCallback(eventData.pointerCurrentRaycast.worldPosition, arg);
		}
	}
	...
	public override void OnEndDrag(PointerEventData eventData)
	{
		...
		{
			dragEndCallback(eventData.pointerCurrentRaycast.worldPosition, arg);
		}
	}
