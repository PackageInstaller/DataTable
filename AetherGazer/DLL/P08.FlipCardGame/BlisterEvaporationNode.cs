...
public class BlisterEvaporationNode : BlisterNode
{
	public BlisterNodeType blisterNodeType = BlisterNodeType.evaporation;
	...
	public override void BlisterBoom()
	{
		...
		BlisterController.Instance.AddSortedList(posX * BlisterController.Instance.ColumnCount + posY, isAdd: false);
	}
	...
	public override void RefreshNodeState()
	{
		...
		bgSprite.sprite = AtlasManager.GetSprite("Atlas/Alone_Summer2024_BlisterGameAtlas", "Alone_Summer2024_BlisterGame_000" + (blisterData.blisterNodeState + 46));
