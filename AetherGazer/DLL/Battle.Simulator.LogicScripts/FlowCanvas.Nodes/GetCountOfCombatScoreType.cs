...
public class GetCountOfCombatScoreType : FlowControlNode
{
	...
	protected override void RegisterPorts()
	{
		...
		{
			if (!GetCountOfCombatScoreTypeBase.GetCountOfCombatScoreType(base.mSimContext, m_entityIDInput.GetValue(), out m_count, (int)m_typeInput.GetValue()))
			{
				m_error.Call(f);
			}
			else
