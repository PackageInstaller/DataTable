...
[Name("实体初始化完成事件(实体类型ID)", 0)]
[Category("Logic/事件")]
[Description("实体初始化完成事件, 会在实体创建之后的一帧触发")]
public class EntityInitFinishedEventWith : EventNode
{
	...
	private void OnEntityInitFinishedEventHandler(int id)
	{
		...
		if (entityWithEntityID != null && entityWithEntityID.hasEntityConfig && entityWithEntityID.ENTITY_CONFIG_ID == roleIDInput.value)
		{
			entityID = id;
			Flow f = new Flow
			{
