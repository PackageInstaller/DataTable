...
[Name("实体销毁事件(实体类型ID)", 0)]
[Category("Logic/事件")]
[Description("销毁实体事件")]
public class DespawnEntityEventWithRoleID : EventNode
{
	...
	protected override void RegisterPorts()
	{
		...
		mID = AddValueInput<int>("实体类型ID", "角色ID");
	}
	...
	{
		SimEntity entityWithEntityID = base.mSimContext.GetEntityWithEntityID(triggerEvent.DestroyedEntity);
		if (entityWithEntityID != null && entityWithEntityID.hasEntityConfig && mID.value == entityWithEntityID.entityConfig.mId)
		{
