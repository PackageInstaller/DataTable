...
public class AddBuffWithOutParam : FlowNode
{
	...
	protected override void RegisterPorts()
	{
		...
		AddFlowInput("", delegate(Flow f)
		{
			...
			if (flag)
			{
				if (AddBuff.AddBuffWithConfigID(base.mSimContext, casterIDInput.GetValue(), targetIDInput.GetValue(), buffIDInput.GetValue(), levelInput.GetValue(), param1Input.GetValue(), param2Input.GetValue(), param3Input.GetValue(), param4Input.GetValue()))
				{
					output.Call(f);
				}
				else
