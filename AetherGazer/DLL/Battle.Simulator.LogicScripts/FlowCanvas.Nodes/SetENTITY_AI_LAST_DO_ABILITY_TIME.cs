...
[Name("设置上一次执行技能的时间(毫秒)(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置上一次执行技能的时间(毫秒)")]
public class SetENTITY_AI_LAST_DO_ABILITY_TIME : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2207, value, 0L, 0L);
		}
	}
}
