...
[Name("设置定身标记计数(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置定身标记计数")]
public class SetENTITY_ATTR_LOCK_MOVEMENT : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2016, value, 0L, 0L);
		}
	}
}
