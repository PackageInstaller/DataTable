--[[ 
-----------------------------------------------------
@filename       : SpineInteract_4524_2
@Description    : 珂芙尼尔皮肤互动
@date           : 2025-04-14 19:32:58
@Author         : Jacob
@copyright      : (LY) 2025 雷焰网络
-----------------------------------------------------
]]
module('game.spineInteract.SpineInteract_4524_2', Class.impl("game.spineInteract.SpineInteract_3108_3"))

function ctor(self)
    super.ctor(self)
    self.baseModelId = "4524"
end
