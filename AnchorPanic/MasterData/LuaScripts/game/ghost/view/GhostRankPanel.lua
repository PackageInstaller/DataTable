--[[ 
-----------------------------------------------------
@filename       : GhostRankPanel
@Description    : 2048积分排行榜
@copyright      : (LY) 2023 雷焰网络
-----------------------------------------------------
]]
module("game.ghost.view.GhostRankPanel", Class.impl(View))

UIRes = UrlManager:getUIPrefabPath("ghost/GhostRankPanel.prefab")
...
function configUI(self)
    ...
    self.mScroller:SetItemRender(ghost.GhostRankItem)
...
function active(self)
    super.active(self)
    GameDispatcher:dispatchEvent(EventName.REQ_RANK_DATA, { type = rank.RankConst.GHOST })
...
function updateView(self)
    local rankData = rank.RankManager:getRankInfoVo(rank.RankConst.GHOST)
