--[[ 
-----------------------------------------------------
@filename       : BlockRankPanel
@Description    : 2048积分排行榜
@copyright      : (LY) 2023 雷焰网络
-----------------------------------------------------
]]
module("game.block.view.BlockRankPanel", Class.impl(View))

UIRes = UrlManager:getUIPrefabPath("block/BlockRankPanel.prefab")
...
function configUI(self)
    ...
    self.mScroller:SetItemRender(block.BlockRankItem)
...
function active(self)
    super.active(self)
    GameDispatcher:dispatchEvent(EventName.REQ_RANK_DATA, { type = rank.RankConst.BLOCK })
...
function updateView(self)
    local rankData = rank.RankManager:getRankInfoVo(rank.RankConst.BLOCK)
