-- @FileName:   BigHostel_Model_4530_2_h.lua
-- @Description:   大宿舍红叶模型
-- @Author: ZDH
-- @Date:   2025-04-21 18:17:45
-- @Copyright:   (LY) 2025 锚点降临

module('game.bigHostel.model.BigHostel_Model_4530_2_h', Class.impl(bigHostel.BigHostelBaseModel))
...
Idle_StateTrigger = {
    ...
    [gs.Animator.StringToHash("SZT_enter01")] = "idle_3",
    [gs.Animator.StringToHash("SZT_enter02")] = "idle_3",
    [gs.Animator.StringToHash("SZT_enter03")] = "idle_3",
    [gs.Animator.StringToHash("SZT_idle01")] = "idle_3",
    [gs.Animator.StringToHash("SZT_idle02")] = "idle_3",
    [gs.Animator.StringToHash("SZT_show01")] = "idle_3",
    [gs.Animator.StringToHash("SZT_show02")] = "idle_3",
    [gs.Animator.StringToHash("SZT_twist01")] = "idle_3",
    [gs.Animator.StringToHash("SZT_twist02")] = "idle_3",
    [gs.Animator.StringToHash("SZT_twist03")] = "idle_3",
    [gs.Animator.StringToHash("SZT_twist04")] = "idle_3",

    [gs.Animator.StringToHash("SZT_leave01")] = "idle_4",
    [gs.Animator.StringToHash("SZT_leave02")] = "idle_4",
    [gs.Animator.StringToHash("SZT_leave03")] = "idle_4",
    [gs.Animator.StringToHash("XQS_enter01")] = "idle_4",
    [gs.Animator.StringToHash("XQS_enter02")] = "idle_4",
    [gs.Animator.StringToHash("XQS_idle01")] = "idle_4",
    [gs.Animator.StringToHash("XQS_idle02")] = "idle_4",
    [gs.Animator.StringToHash("XQS_idle03")] = "idle_4",
    [gs.Animator.StringToHash("XQS_show")] = "idle_4",
    [gs.Animator.StringToHash("XQS_twist01")] = "idle_4",
    [gs.Animator.StringToHash("XQS_twist02")] = "idle_4",
    [gs.Animator.StringToHash("XQS_twist02_01")] = "idle_4",
    [gs.Animator.StringToHash("XQS_twist03")] = "idle_4",
    [gs.Animator.StringToHash("XQS_twist04")] = "idle_4",
    [gs.Animator.StringToHash("XQS_twist04_01")] = "idle_4",
    [gs.Animator.StringToHash("XQS_twist05")] = "idle_4",
    [gs.Animator.StringToHash("XQS_twist06")] = "idle_4",
...
function onAnimaBodyStateSwitch(self, stateHash)
    ...
    if stateHash == gs.Animator.StringToHash("WT_idle01") then
        ...
        self:addCapsuleColliderEventByName("Bip001 Spine1", 0.15, 0.5, gs.Vector3(-0.05, 0, 0), BigHostelConst.CapsuleColliderDic.x, onPointDown)
...
function checkSpineCollider(self)
    ...
    elseif self.m_curBodyShortHash == gs.Animator.StringToHash("SZT_idle02") then
        local efx_time, no_cursor = nil, nil
        if self.m_propState ~= nil then
            local function onPointDown_01()
                self:setInt("twist", 1)
