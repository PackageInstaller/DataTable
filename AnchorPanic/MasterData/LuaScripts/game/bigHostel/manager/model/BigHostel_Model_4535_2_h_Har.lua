-- @FileName:   BigHostel_Model_4535_2_h_Har.lua
-- @Description:   大宿舍红叶模型
-- @Author: ZDH
...
function createShowHeroGo(self)
    ...
    self.mShowHeroGo = gs.GOPoolMgr:Get("arts/character/scene_module_3Dhostel/4535_2_h_har/model4535_2_h_s_har.prefab")
...
function clearShowHeroGo(self)
    if self.mShowHeroGo ~= nil then
        ...
        gs.GOPoolMgr:Recover(self.mShowHeroGo, "arts/character/scene_module_3Dhostel/4535_2_h_har/model4535_2_h_s_har.prefab")
...
function checkCZProp(self, index)
    ...
    if isPerfect then
        ...
        if self.mCZPerfectCount == 5 then
            ...
            local perfectVoiceIndexes = 2
            local perfectVoiceIndex = perfectVoiceIndexes
            self:playCZAudioSound(perfectVoiceIndex)
        end
    else
        self.mCZPerfectCount = 0
        local goodVoiceIndexes = 1
        local goodVoiceIndex = goodVoiceIndexes
