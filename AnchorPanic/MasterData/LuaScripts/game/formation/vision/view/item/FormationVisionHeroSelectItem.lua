--[[ 
-----------------------------------------------------
@filename       : FormationVisionHeroSelectItem
@Description    : 异象残境战员选择item（多队伍，战员不可跨队重复）
@copyright      : (LY) 2023 雷焰网络
-----------------------------------------------------
]]
module('formation.FormationVisionHeroSelectItem', Class.impl(formation.FormationHeroSelectItem))
