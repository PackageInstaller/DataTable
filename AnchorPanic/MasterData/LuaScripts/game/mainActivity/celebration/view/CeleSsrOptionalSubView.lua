...
module('Celebration.CeleSsrOptionalSubView', Class.impl(TabSubView))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("activity/CeleSsrOptionalSubView.prefab")
...
function updateView(self)
    ...
    self.mTxtMoney.gameObject:SetActive(Celebration.CelebrationManager:getSSROptionalState()==Celebration.CelebrationConst.AwardState.Nomal)
    self.mTxtNomal.gameObject:SetActive(Celebration.CelebrationManager:getSSROptionalState()==Celebration.CelebrationConst.AwardState.Recive)
    self.mTxtMoneyDes.gameObject:SetActive(self.mTxtMoney.gameObject.activeSelf)
    self.mBtnRecive:SetActive(Celebration.CelebrationManager:getSSROptionalState()~=Celebration.CelebrationConst.AwardState.Recived)
    self.mImgRecived:SetActive(Celebration.CelebrationManager:getSSROptionalState()==Celebration.CelebrationConst.AwardState.Recived)
    ...
    self.mAwardItem:setHasRec(Celebration.CelebrationManager:getSSROptionalState()==Celebration.CelebrationConst.AwardState.Recived)
    self.mAwardItem:setIsShowCanRec(Celebration.CelebrationManager:getSSROptionalState()==Celebration.CelebrationConst.AwardState.Recive)
    self.mTxtAwardName.text=propsVo.name

    local curActivityOverTime = activity.ActivityManager:getActivityVoById(activity.ActivityId.SsrOptional):getOverTime()
