...
MainActivityConst.bottomBtns =
{
    ...
    activity.ActivityId.Bird,
    activity.ActivityId.Split,
    activity.ActivityId.Dessert,
    activity.ActivityId.Build,
    activity.ActivityId.Drop,
}
...
MainActivityConst.getActivityRedState = function(activity_id)
    ...
    local activityRedState = {
        ...
        [activity.ActivityId.Bird] = bird.BirdManager:getIsShowRed(),
        [activity.ActivityId.Split] = split.SplitManager:getIsShowRed(),
        [activity.ActivityId.Dessert] = dessert.DessertManager:getIsShowRed(),
        [activity.ActivityId.Build] = build.BuildManager:getIsShowRed(),
        [activity.ActivityId.Drop] = drop.DropManager:getIsShowRed(),
    }
