...
module('dessert.DessertDupPanel', Class.impl(View))

-- 对应的ui文件
UIRes = UrlManager:getUIPrefabPath("dessert/DessertDupPanel.prefab")
...
function updateView(self, args, noShow)
    ...
    local his = dessert.DessertManager:getDupPassStar(self.m_DupConfigVo.id)
...
function onFight(self)
    local activity_id = activity.ActivityId.Dessert
