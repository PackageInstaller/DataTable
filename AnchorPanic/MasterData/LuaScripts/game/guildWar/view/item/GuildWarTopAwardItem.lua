module("guildWar.GuildWarTopAwardItem", Class.impl("lib.component.BaseItemRender"))
...
function setData(self, param)
    ...
    local isTop = true -- self.data.rank <= 3
    self.mTop1:SetActive(self.data.id == 1)
    self.mTop2:SetActive(self.data.id == 2)
    self.mTop3:SetActive(self.data.id == 3)
    self.mTop4:SetActive(self.data.id == 4)
    ...
    --     local color
        ...
        --self.mImgColor.gameObject:SetActive(self.data.id <= 3)
    -- else
