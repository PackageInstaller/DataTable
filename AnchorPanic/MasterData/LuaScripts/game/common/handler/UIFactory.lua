...
function UIFactory:alertMessge(msg, isShowConfirm, confirmCallBack, confirmLabel, confirmParam, isShowCancel, cancelCallBack, cancelLabel, title, isShowClose, notRemindType, tipsLitleDes, cancelTime)
    ...
    if not isNotRemind then
        ...
        local data = {msg = msg, isShowConfirm = isShowConfirm, confirmCallBack = confirmCallBack, confirmLabel = confirmLabel, confirmParam = confirmParam, isShowCancel = isShowCancel, cancelCallBack = cancelCallBack, cancelLabel = cancelLabel, title = title, isShowClose = isShowClose, notRemindType = notRemindType, tipsLitleDes = tipsLitleDes, cancelTime = cancelTime}
