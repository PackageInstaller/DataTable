-- @FileName:   WatermelonStarAwardView.lua
-- @Description:   大西瓜奖励界面
-- @Copyright:   (LY) 2024 锚点降临

module('watermelon.WatermelonStarAwardView', Class.impl(View))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("watermelon/WatermelonStarAwardView.prefab")
