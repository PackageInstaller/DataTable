-- @FileName:   DropDupPanel.lua
-- @Description:   大西瓜关卡
-- @Copyright:   (LY) 2023 雷焰网络
-- 关卡详情弹窗，展示关卡名称、历史分数、首通奖励，并负责进入玩法界面
module('drop.DropDupPanel', Class.impl(View))

-- 对应的ui文件
UIRes = UrlManager:getUIPrefabPath("drop/DropDupPanel.prefab")
...
function updateView(self, args, noShow)
    ...
    local his = drop.DropManager:getDupPassStar(self.m_DupConfigVo.id)
...
function onFight(self)
    local activity_id = activity.ActivityId.Drop
