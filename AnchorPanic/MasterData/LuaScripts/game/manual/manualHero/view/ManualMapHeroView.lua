...
module("manual.ManualMapHeroView", Class.impl(View))
UIRes = UrlManager:getUIPrefabPath("manual/ManualMapHeroView.prefab")
...
function updateView(self)
    ...
    self.mImgCamp:SetImg(UrlManager:getIconPath( self.data.url), false)
