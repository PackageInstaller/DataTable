-- @FileName:   BirdDupPanel.lua
-- @Description:   大西瓜关卡
-- @Copyright:   (LY) 2023 雷焰网络
module('bird.BirdDupPanel', Class.impl(View))

-- 对应的ui文件
UIRes = UrlManager:getUIPrefabPath("bird/BirdDupPanel.prefab")
...
function updateView(self, args, noShow)
    ...
    local his = bird.BirdManager:getDupPassStar(self.m_DupConfigVo.id)
...
function onFight(self)
    local activity_id = activity.ActivityId.Bird
