--[[ 
-----------------------------------------------------
@filename       : BirdRankPanel
@Description    : 大西瓜积分排行榜
@copyright      : (LY) 2023 雷焰网络
-----------------------------------------------------
]]
module("bird.BirdRankPanel", Class.impl(View))

UIRes = UrlManager:getUIPrefabPath("bird/BirdRankPanel.prefab")
...
function configUI(self)
    ...
    self.mScroller:SetItemRender(bird.BirdRankItem)
...
function active(self)
    super.active(self)
    GameDispatcher:dispatchEvent(EventName.REQ_RANK_DATA, { type = rank.RankConst.BIRD })
...
function updateView(self)
    local rankData = rank.RankManager:getRankInfoVo(rank.RankConst.BIRD)
