activity = {}
activity.ActivityBindDataVo = require("game/activity/manager/vo/ActivityBindDataVo")
activity.ActivityBindTaskItem = require("game/activity/view/item/ActivityBindTaskItem")
activity.ActivityBindTabTipsView = require("game/activity/view/ActivityBindTabTipsView")
activity.ActivityBindTabView = require("game/activity/view/ActivityBindTabView")

activity.ActivityBindApplyListView = require("game/activity/view/ActivityBindApplyListView")
...
activity.ActivityPromoView5 = require("game/activity/view/ActivityPromoView5")
