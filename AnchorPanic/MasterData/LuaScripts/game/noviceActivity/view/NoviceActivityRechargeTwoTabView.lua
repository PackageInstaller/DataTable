...
module('noviceActivity.NoviceActivityRechargeTwoTabView', Class.impl(TabSubView))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("noviceActivity/NoviceActivityRechargeTwoTabView.prefab")
...
function configUI(self)
    ...
    self.mLyScroller:SetItemRender(noviceActivity.NoviceActivityAccRechargeTwoItem)
end
...
function active(self)
    ...
    GameDispatcher:addEventListener(EventName.UPDATE_CELEBRATION_ACC_RECHARGE_LIST_TWO,self.updateList,self)
    self:updateView()
end
...
function deActive(self)
    ...
    GameDispatcher:removeEventListener(EventName.UPDATE_CELEBRATION_ACC_RECHARGE_LIST_TWO,self.updateList,self)
...
function updateView(self)
    ...
    local curActivityOverTime = activity.ActivityManager:getActivityVoById(activity.ActivityId.RechargeTwo):getOverTime()
...
function updateList(self,isInit)
    ...
    local list = Celebration.CelebrationManager:getRechargeTwoList()
    ...
    self.mTxtRechargeDes.text = _TT(121014,Celebration.CelebrationManager:getRechargeNumTwo())
end
