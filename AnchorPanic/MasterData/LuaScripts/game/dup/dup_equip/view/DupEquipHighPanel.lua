module('dup.DupEquipHighPanel', Class.impl(dup.DupChipInfoView))

function ctor(self)
    super.ctor(self)
    self:setUICode(LinkCode.DupEquipHigh)
end

-- 副本类型
function getDupType(self)
    return DupType.DUP_EQUIP_HIGH
end
--获取当前打开页签
function getCurPageIndex(self)
    return dup.DupChipConst.HIGHLEVEL
end
--刪除临时预制体
