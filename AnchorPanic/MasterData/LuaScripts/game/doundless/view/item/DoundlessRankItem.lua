module("doundless.DoundlessRankItem", Class.impl("lib.component.BaseItemRender"))
...
function __onClickHeadHandler(self, args)
    if (not self.data.isRobot and self.data.player_id ~= role.RoleManager:getRoleVo().playerId) then
