module('build.BuildStartView', Class.impl('lib.component.BaseNode'))

-- 建造小游戏开场表现节点，播放开始音效并在延时后回调进入正式玩法
...
function start(self, finishCall)
    ...
    -- 	return
    -- end
    AudioManager:playSoundEffect("arts/audio/UI/minigames/mng_common_2.prefab")
