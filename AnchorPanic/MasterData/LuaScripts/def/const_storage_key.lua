...
gstor.FIGHT_CLOSE_AUDIO = "FIGHT_CLOSE_AUDIO" --关闭声音
gstor.FIGHT_AUTO_DECOMPOSING = "FIGHT_AUTO_DECOMPOSING" --战斗自动分解
...
gstor.RANKING_DUPNEWOPENSTR = "RANKING_DUPNEWOPENSTR"
gstor.RANKING_TEACHINGSTATE = "RANKING_TEACHINGSTATE"

gstor.BLOCK_DUPNEWOPENSTR = "BLOCK_DUPNEWOPENSTR"

gstor.PICKGOLD_DUPNEWOPENSTR = "PICKGOLD_DUPNEWOPENSTR"
...
gstor.MOLE_DUPNEWOPENSTR = "MOLE_DUPNEWOPENSTR"

gstor.WATERMELON_DUPNEWOPENSTR= "WATERMELON_DUPNEWOPENSTR"
gstor.GHOST_DUPNEWOPENSTR= "GHOST_DUPNEWOPENSTR"
gstor.BULLE_DUPNEWOPENSTR= "BULLE_DUPNEWOPENSTR"
gstor.BUILD_DUPNEWOPENSTR= "BUILD_DUPNEWOPENSTR"
gstor.DROP_DUPNEWOPENSTR= "DROP_DUPNEWOPENSTR"
gstor.BIRD_DUPNEWOPENSTR= "BIRD_DUPNEWOPENSTR"

gstor.SPLIT_DUPNEWOPENSTR = "SPLIT_DUPNEWOPENSTR"

gstor.DESSERT_DUPNEWOPENSTR = "DESSERT_DUPNEWOPENSTR"

--STORY_AUTO_BTN BEGIN--------------------------------------------------------------------
gstor.STORY_AUTO = "STORY_AUTO" -- 自动剧情

gstor.RANDOM_FIGHT_SKIN = "RANDOM_FIGHT_SKIN"--随机战斗皮肤
--STORY_AUTO_BTN END--------------------------------------------------------------------

gstor.ARENA_HELL_SKIP = "ARENA_HELL_SKIP" -- 不进入3v3战斗
gstor.GUILD_WAR_SKIP = "GUILD_WAR_SKIP" -- 不进入公会战战斗
...
gstor.MAINUI_DYNAMIC_GURAD_TYPE_ID = "MAINUI_DYNAMIC_GURAD_TYPE_ID" -- 看板娘动态立绘类型和id

gstor.BGHOSTEL_MAINSCENESTATE = "BGHOSTEL_MAINSCENESTATE" --大宿舍主界面设置状态
gstor.BGHOSTEL_MAINSCENEINFO = "BGHOSTEL_MAINSCENEINFO" --大宿舍主界面信息数据


gstor.CV_TYPE = "CV_TYPE" --声音设置cv国家选项

gstor.MAIN_UI_SIMPLE = "MAIN_UI_SIMPLE" --主界面简化

gstor.RECOVERY_PANEL_REDPOINT = "RECOVERY_PANEL_REDPOINT" -- 恢复面板红点
