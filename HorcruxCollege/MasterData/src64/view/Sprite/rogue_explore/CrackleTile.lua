...
local crackleTile = class("crackleTile", function(arg_1_0)
...
function crackleTile:create(arg_2_1)
	local var_2_0 = crackleTile.new(arg_2_1)
...
function crackleTile:createCrackle()
	return (BrokenNode:create(self.icon.path))
end

function crackleTile:checkTriggerPrecondition()
	local var_4_0
...
function crackleTile:runTileEvent(arg_18_1, arg_18_2)
	local function var_18_0()
		...
		local function var_19_6(arg_20_0)
			local function var_20_0()
				print("8888888888888888888888888888888888888skill1")
			...
			self:runAction(cc.Sequence:create(cc.DelayTime:create(0.2), cc.CallFunc:create(function()
				...
				self.parent:playAni("skill1", var_20_0)

				local var_23_0 = self:createCrackle()

				if var_23_0 then
					var_23_0:setPosition(cc.p(self.icon:getContentSize().width / 2, self.icon:getContentSize().height / 2))
					self.icon:addChild(var_23_0, 99)
					var_23_0:runBreak()
				end
		...
		explore_manager:trigger_event(var_19_5, function(arg_24_0)
			if arg_24_0.result > 0 then
				if not self:checkResultEvent() then
					...
					local var_24_0 = self.finishCallback
					local var_24_1 = {
						tileInfo = self.tileInfo,
						msg = arg_24_0,
						eventconfig = var_19_5
