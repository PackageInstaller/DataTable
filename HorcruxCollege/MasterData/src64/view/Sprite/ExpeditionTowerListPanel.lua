local ExpeditionTowerListPanel = class("ExpeditionTowerListPanel", function()
...
local var_0_10 = "TowerDefenceListPanel/"
local var_0_11 = cc.c4b(100, 100, 100, 90)
local var_0_12 = {
	{
		x = 4,
		y = 4
...
function ExpeditionTowerListPanel:create()
	local var_2_0 = ExpeditionTowerListPanel.new()
...
function ExpeditionTowerListPanel:init()
	self:initData()
	self:initBasicUI()
	self:initListUI()
...
function ExpeditionTowerListPanel:initData()
	self.listData = {}

	for iter_4_0, iter_4_1 in pairs((expedition_manager:getExpeditionTeamListInfo())) do
		table.insert(self.listData, iter_4_1.servantid)
	end

	self.listData = expedition_manager:sortRoleListTbl(self.listData)
	self.xpWaitingList = {}
	self.selectList = {}
	self.roleFalseLevelCache = {}
end

function ExpeditionTowerListPanel:initBasicUI()
	self.limitLabel = cc.Label:createWithTTF("", FONT_NAME, 24)

	self.limitLabel:setPosition(570, 360)
	self.limitLabel:enableShadow(var_0_11, cc.size(3, -3))
	...
	var_5_0:enableShadow(var_0_11, cc.size(0, -4))
	...
	self.costNumLabel:enableShadow(var_0_11, cc.size(0, -4))
	self.costNumLabel:setVisible(false)
	self:addChild(self.costNumLabel)
	var_5_0:setVisible(false)
	self.costNumLabel:setVisible(false)

	self.reflagBtn = ccui.Button:create("TowerDefenceListPanel/reflag_btn.png", nil, "TowerDefenceListPanel/reflag_btn.png", var_0_9)
	...
	self.reflagBtn:addTouchEventListener(function(arg_6_0, arg_6_1)
		...
		if expedition_manager:getReflagFreeCount() + expedition_manager:getReflagItemNum2() <= 0 then
	...
	self.xpBtn = ccui.Button:create("TowerDefenceListPanel/xp_btn.png", nil, "TowerDefenceListPanel/xp_btn.png", var_0_9)
...
function ExpeditionTowerListPanel:updateUI()
	self.limitLabel:setString(TOWER_ROLE_LIMIT .. expedition_manager:getCurRoleNum() .. "/" .. expedition_manager:getRoleTotalLimitNum())
	self.limitLabel:setColor(expedition_manager:getCurRoleNum() >= expedition_manager:getRoleTotalLimitNum() and cc.c3b(255, 85, 85) or cc.c3b(255, 255, 255))
	self.costNumLabel:setString(expedition_manager:getCurTotalCost())
	self.reflagBtn:getChildByName("label"):setString(expedition_manager:getReflagItemNum() .. "+" .. expedition_manager:getReflagFreeCount())
	self.xpBtn:getChildByName("label"):setString(expedition_manager:getXPItemNum() .. "+" .. expedition_manager:getXPFreeCount())
end
...
function ExpeditionTowerListPanel:createSp(arg_9_1)
	local var_9_0 = self.listData[arg_9_1]
	local var_9_1 = ccui.Button:create(var_0_10 .. "role_bg1.png", var_0_10 .. "role_bg1.png", var_0_10 .. "role_bg1.png", var_0_9)
	...
	local var_9_3 = cc.ProgressTimer:create((config._DEBUG or nil) and (cc.Sprite:create(var_0_10 .. "unused_mask.png") or cc.Sprite:createWithSpriteFrameName(var_0_10 .. "unused_mask.png")))
	...
	local var_9_4 = ccui.ImageView:create(var_0_10 .. "cost_bg.png", var_0_9)

	var_9_4:setAnchorPoint(cc.p(0, 0))
	var_9_4:setPosition(5, 0)
	var_9_1:addChild(var_9_4, 3)

	local var_9_5 = cc.Label:createWithTTF("1", FONT_W5, 26)
	...
	local var_9_7 = ccui.ImageView:create(var_0_10 .. "dead_mask.png", var_0_9)
	...
	local var_9_9 = ccui.ImageView:create(var_0_10 .. "bar_bg.png", var_0_9)

	var_9_9:setPosition(var_9_1:getContentSize().width / 2, var_9_1:getContentSize().height / 2)
	var_9_7:addChild(var_9_9, 4)

	local var_9_10 = cc.ProgressTimer:create((config._DEBUG or nil) and (cc.Sprite:create(var_0_10 .. "bar.png") or cc.Sprite:createWithSpriteFrameName(var_0_10 .. "bar.png")))
	...
	local var_9_11 = ccui.ImageView:create(var_0_10 .. "selected_frame.png", var_0_9)
	...
	var_9_1:addTouchEventListener(function(arg_10_0, arg_10_1)
		...
		if not isContainPosOfConvexPolygon(var_0_12, (arg_10_0:convertToNodeSpace(var_10_0))) then
			return
		end
		...
		if expedition_manager:addRoleByManual(arg_10_0.id) then
...
function ExpeditionTowerListPanel:updateSp(arg_11_1)
	local var_11_0 = arg_11_1.servantid
	local var_11_1 = expedition_manager:isRoleFighting(arg_11_1.servantid)

	arg_11_1.unusedMask:setVisible(not var_11_1)
	arg_11_1.deadMask:setVisible(expedition_manager:isRoleDead(var_11_0) or not expedition_manager:isServantCanSelect(var_11_0))
	arg_11_1.selectedLogo:setVisible(var_11_1)

	if self.roleFalseLevelCache[var_11_0] == nil then
		local var_11_2 = role_false_level_manager:isRoleFalseLevelMember(var_11_0, FightManager.getFightType())

		self.roleFalseLevelCache[var_11_0] = not not var_11_2

		if var_11_2 then
			local var_11_3, var_11_4, var_11_5, var_11_6 = role_false_level_manager:getRoleFalseAttrInfoByAllRole(var_11_0)

			if var_11_3 == core_manager:getServantCoreRank(var_11_0) and playermodel.cores[var_11_0].level == var_11_4 then
				-- block empty
			elseif not arg_11_1.roleLv.action_playing then
				arg_11_1.roleLv:setColor(cc.c3b(206, 255, 167))
				arg_11_1.roleLv:setString(L_ITEMPANEL_SORT_STR.level2 .. var_11_4 + var_11_6)
			...
			arg_11_1.roleLv:setString(L_ITEMPANEL_SORT_STR.level2 .. core_manager:getCoreLv(var_11_0))
		end
	end

	if self.special_type == "xp" then
		local var_11_8 = "players@" .. arg_11_1.id + #expedition_manager:getCurLevelInfo().baseConfig[1]
		local var_11_9 = FightManager.getCharacter(var_11_8)

		var_11_9 = var_11_9 and FightManager.getCharacter(var_11_8):checkXPStatusOnTower("xp")

		arg_11_1:setOpacity(var_11_1 and var_11_9 and 255 or 80)
	elseif self.special_type == "reflag" then
		arg_11_1:setOpacity(expedition_manager:isRoleDead(var_11_0) and 255 or 80)
	elseif self.special_type == "select" then
		arg_11_1:setOpacity((var_11_1 or expedition_manager:isRoleDead(var_11_0)) and 80 or 255)
...
function ExpeditionTowerListPanel:initListUI()
	self.scrollView = ccui.ScrollView:create()

	self.scrollView:setContentSize(cc.size(var_0_15, var_0_16))
...
function ExpeditionTowerListPanel:resetListUI()
	self.scrollView:removeAllChildren()
	self.scrollView:setInnerContainerSize(cc.size(math.ceil(#self.listData / 2) * var_0_13 + 20, var_0_16))

	for iter_14_0, iter_14_1 in ipairs(self.listData) do
		local var_14_0 = self:createSp(iter_14_0)

		var_14_0:setPosition((math.ceil(iter_14_0 / 2) - 1) * var_0_13, iter_14_0 % 2 == 0 and 10 or var_14_0:getContentSize().height + 20)
...
function ExpeditionTowerListPanel:updatePanelSp(arg_15_1)
...
function ExpeditionTowerListPanel:updatePanel()
	self.costNumLabel:setString(expedition_manager:getCurTotalCost())
...
function ExpeditionTowerListPanel:resetPanel()
	self:initData()
	self:updateUI()
	self:resetListUI()
end

function ExpeditionTowerListPanel:switchSpecialPanel(arg_18_1)
...
function ExpeditionTowerListPanel:initSpecialPanel()
	...
	;(function()
		...
		local var_21_1 = ccui.Button:create(var_0_10 .. "select_sure_btn.png", nil, var_0_10 .. "select_sure_btn.png", var_0_9)
	...
	;(function()
		...
		local var_24_1 = ccui.ImageView:create("public/currency/888888.png", var_0_9)
		...
		local var_24_4 = cc.Label:createWithTTF("×" .. item_manager:getItemNumber(19900001) + expedition_manager:getReflagFreeCount(), FONT_NAME, 24)

		var_24_4:setAnchorPoint(cc.p(0, 0.5))
		var_24_4:setPosition(520 + 4, 540)
		var_24_0:addChild(var_24_4)

		local var_24_5 = cc.Label:createWithTTF(L_TOWER_DEFENCE_FREE_XP_STR .. expedition_manager:getXPFreeCount(), FONT_NAME, 24)
		...
		function var_24_0.updateChildPanel()
			...
			var_24_4:setString("×" .. item_manager:getItemNumber(19900001) + expedition_manager:getReflagFreeCount())
			var_24_5:setString(L_TOWER_DEFENCE_FREE_XP_STR .. expedition_manager:getXPFreeCount())
		end
	end)()
end

function ExpeditionTowerListPanel:updateSpecialPanel()
...
function ExpeditionTowerListPanel:exitSpecial()
...
function ExpeditionTowerListPanel:playerSpecialTouchEvent(arg_28_1, arg_28_2)
	if self.special_lock then
		return
	end

	local var_28_0 = "players@" .. arg_28_1 + #expedition_manager:getCurLevelInfo().baseConfig[1]

	if self.special_type == "xp" then
		(function()
			if not expedition_manager:isRoleFighting(arg_28_2) then
			...
			if FightManager.getCharacter(var_28_0) then
				if FightManager.getCharacter(var_28_0):checkXPStatusOnTower("xp") then
					self.special_lock = true

					expedition_manager:costSpecialItem(self.special_type, function(arg_30_0)
						if arg_30_0.result == 1 then
							...
							self.xpBtn:getChildByName("label"):setString(expedition_manager:getXPItemNum() .. "+" .. expedition_manager:getXPFreeCount())
							self.reflagBtn:getChildByName("label"):setString("×" .. item_manager:getItemNumber(19900001) + expedition_manager:getReflagFreeCount())
	...
	elseif self.special_type == "reflag" then
		(function()
			if not expedition_manager:isRoleDead(arg_28_2) and expedition_manager:isServantCanSelect(arg_28_2) then
			...
			expedition_manager:costSpecialItem(self.special_type, function(arg_33_0)
				if arg_33_0.result == 1 then
					expedition_manager._dead[arg_28_2] = nil

					for iter_33_0, iter_33_1 in pairs(expedition_manager.expeditionInfo.teamList) do
						if arg_28_2 == iter_33_1.servantid then
							iter_33_1.bloodpercent = 100
						end
					end

					expedition_manager.expeditionInfo.canFightServantList = expedition_manager:getCanFightServantList()

					expedition_manager:addRoleByManualWithServantid(arg_28_2)
					self:exitSpecial()

					self.special_lock = false

					self.reflagBtn:getChildByName("label"):setString(expedition_manager:getReflagItemNum())
	...
	elseif self.special_type == "select" then
		(function()
			...
			self.limitLabel:setString(TOWER_ROLE_LIMIT .. self:getSelectRoleNum() .. "/" .. expedition_manager:getRoleTotalLimitNum())
			self.limitLabel:setColor(self:getSelectRoleNum() >= expedition_manager:getRoleTotalLimitNum() and cc.c3b(255, 85, 85) or cc.c3b(255, 255, 255))
			self.costNumLabel:setString(self:getSelectTotalCost())
		end)()
	end
end

function ExpeditionTowerListPanel:updateXpCountUI()
	self.xpBtn:getChildByName("label"):setString(expedition_manager:getXPItemNum() .. "+" .. expedition_manager:getXPFreeCount())
end

function ExpeditionTowerListPanel:updateTotalCostUI()
	self.costNumLabel:setString(expedition_manager:getCurTotalCost())
end

function ExpeditionTowerListPanel:batchAddRoles()
	...
	for iter_37_0, iter_37_1 in pairs(self.selectList) do
		expedition_manager:addRoleByManual(iter_37_1)
	end

	self:exitSpecial()
end

function ExpeditionTowerListPanel:getSelectTotalCost(arg_38_1)
	local var_38_0 = expedition_manager:getCurTotalCost()

	for iter_38_0, iter_38_1 in pairs(self.selectList) do
		var_38_0 = var_38_0 - expedition_manager:get_servant_cost(iter_38_0)
	end

	if arg_38_1 then
		var_38_0 = var_38_0 - expedition_manager:get_servant_cost(arg_38_1)
	end

	return var_38_0
end

function ExpeditionTowerListPanel:getSelectRoleNum()
	return expedition_manager:getCurRoleNum() + table.nums(self.selectList)
end

function ExpeditionTowerListPanel:checkSelectCost(arg_40_1)
	return self:getSelectTotalCost(arg_40_1) >= 0
end

function ExpeditionTowerListPanel:checkSelectRoleLimit()
	return self:getSelectRoleNum() <= expedition_manager:getRoleTotalLimitNum()
end

function ExpeditionTowerListPanel:showMonsterDropSp(arg_42_1)
	local var_42_0
	local var_42_1
	local var_42_2
...
function ExpeditionTowerListPanel:setGlobalTouchLock(arg_43_1)
	self.globalTouchLock = arg_43_1
end

function ExpeditionTowerListPanel:addInitFightRoles()
	self:setGlobalTouchLock(true)

	self.initFightServantList = expedition_manager:getInitFightRoles()

	local var_44_0 = 1
	local var_44_1 = cc.RepeatForever:create(cc.Sequence:create(cc.DelayTime:create(0.1), cc.CallFunc:create(function()
		if self.initFightServantList[var_44_0] and var_44_0 <= expedition_manager:getRoleTotalLimitNum() then
			expedition_manager:addRoleByManualWithServantid(self.initFightServantList[var_44_0])
		else
...
return ExpeditionTowerListPanel
