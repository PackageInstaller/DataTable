ActivityFlopLayer_186 = class("ActivityFlopLayer_186", function()
...
function ActivityFlopLayer_186.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_186.new()
...
function ActivityFlopLayer_186:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_186:initDrawBg()
...
function ActivityFlopLayer_186:updateChampionTipLabel()
	if not self.itemShade:getChildByName("tip") then
		...
		var_5_0:setColor(cc.c3b(7, 5, 84))
		var_5_0:setName("tip")
		var_5_0:setPosition(cc.p(5, self.itemShade:getContentSize().height / 2 - 8))
		self.itemShade:addChild(var_5_0)
	end
end

function ActivityFlopLayer_186:fullScreen()
...
function ActivityFlopLayer_186:initOther()
