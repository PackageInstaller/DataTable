...
local ActivityMainLayer_286 = class("ActivityMainLayer_286", function(...)
...
function ActivityMainLayer_286:create(arg_2_1)
	local var_2_0 = ActivityMainLayer_286.new(arg_2_1)
...
function ActivityMainLayer_286:init(arg_3_1)
	self.rootLayer = ccui.Layout:create()

	self:addChild(self.rootLayer)
end

function ActivityMainLayer_286:initOther(arg_4_1)
	return
end

function ActivityMainLayer_286:playInEffect()
	return
end

return ActivityMainLayer_286
