ActivityFlopLayer_405 = class("ActivityFlopLayer_405", function()
...
function ActivityFlopLayer_405.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_405.new()
...
function ActivityFlopLayer_405:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_405:updateChampionTipLabel()
...
function ActivityFlopLayer_405:fullScreen()
...
function ActivityFlopLayer_405:initOther()
	local var_6_0 = ccui.ImageView:create(self.rolebg .. "role_bg_0.png")

	var_6_0:setAnchorPoint(cc.p(0.5, 1))
	var_6_0:setPosition(cc.p(320, self.rootLayer:getContentSize().height * 0.58))
	...
	self.rootLayer:getChildByName("awardListbtn"):setPositionY(self.rootLayer:getContentSize().height * 0.7)
...
function ActivityFlopLayer_405.updateSkin(arg_8_0, arg_8_1, arg_8_2)
	return
end
