ActivityBossFightRankLayer = class("ActivityBossFightRankLayer", function()
...
function ActivityBossFightRankLayer.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityBossFightRankLayer.new()
...
function ActivityBossFightRankLayer:init(arg_3_1)
...
function ActivityBossFightRankLayer:initBottomList()
...
function ActivityBossFightRankLayer:DisplayRankList()
	network:rpc("get_activity_infinity_bossfight_rank_data", {
		start = 1,
		count = 100,
...
function ActivityBossFightRankLayer:initTableView()
...
function ActivityBossFightRankLayer:createNode(arg_13_1)
...
function ActivityBossFightRankLayer.updateNode(arg_16_0, arg_16_1, arg_16_2)
...
function ActivityBossFightRankLayer:MyRankNoShow(arg_19_1)
...
function ActivityBossFightRankLayer:fullScreen(arg_20_1)
