ActivityFlopLayer_154 = class("ActivityFlopLayer_154", function()
...
function ActivityFlopLayer_154.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_154.new()
...
function ActivityFlopLayer_154:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_154:updateChampionTipLabel()
	if not self.itemShade:getChildByName("tip") then
		local var_5_0 = cc.Label:createWithTTF(L_FLOP_CHAMPION_TIP, FONT_BUTTON, 18)

		var_5_0:setAnchorPoint(cc.p(0, 0.5))
		var_5_0:setName("tip")
		var_5_0:setPosition(cc.p(45, self.itemShade:getContentSize().height / 2 - 3))
		self.itemShade:addChild(var_5_0)
	end
end

function ActivityFlopLayer_154:fullScreen()
...
function ActivityFlopLayer_154:initOther()
