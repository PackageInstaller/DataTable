ActivityFlopLayer_210 = class("ActivityFlopLayer_210", function()
...
function ActivityFlopLayer_210.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_210.new()
...
function ActivityFlopLayer_210:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_210:initDrawBg()
...
function ActivityFlopLayer_210:updateChampionTipLabel()
...
function ActivityFlopLayer_210:fullScreen()
...
function ActivityFlopLayer_210:initOther()
...
function ActivityFlopLayer_210.updateSkin(arg_9_0, arg_9_1, arg_9_2)
	return
end
