ActivityLevel_195 = class("ActivityLevel_195", function()
...
function ActivityLevel_195.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityLevel_195.new()
...
function ActivityLevel_195:init(arg_3_1)
	self.rootLayer = ccs.GUIReader:getInstance():widgetFromJsonFile(config._DEBUG and "ActivityLevel_195.json" or "ActivityLevel_195.ExportJson")
	...
	self:registerScriptHandler(function(arg_4_0)
		if arg_4_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivityLevel_195")
		end
	end)
end

function ActivityLevel_195.registerActivityEventListener(arg_5_0)
	activity_manager:registerEventListener("ActivityLevel_195", activity_manager.activityEventId.ACTIVITY_LEVEL_INFO_UPDATE, function(arg_6_0)
		arg_5_0:upDateUI(arg_6_0)
	end)
end

function ActivityLevel_195:initUI()
	self:initBtnReturn()
	self:initTitle()
	self:initPanelBook()
	self:initPanelBuff()
...
function ActivityLevel_195:initBtnReturn()
...
function ActivityLevel_195:initTitle()
	...
	self.btnDetail:addTouchEventListener(function(arg_13_0, arg_13_1)
		...
		LayerManager:pushInLayer("PopActivityDetail", {
			key = "ActivityLevel_195"
		})
	end)
end

function ActivityLevel_195:initPanelBook()
...
function ActivityLevel_195:initPanelBuff()
...
function ActivityLevel_195:upDateUI(arg_18_1)
	...
	for iter_18_0 = 1, 7 do
		...
		if iter_18_0 > arg_18_1.cur_level then
			var_18_3:loadTextures("ActivityLevel_195/level_lock.png", nil, "ActivityLevel_195/level_lock.png", var_0_4)
		else
			var_18_3:loadTextures("ActivityLevel_195/level.png", nil, "ActivityLevel_195/level.png", var_0_4)
		end
