ActivityLevel_182 = class("ActivityLevel_182", function()
...
function ActivityLevel_182.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityLevel_182.new()
...
function ActivityLevel_182:init(arg_3_1)
	...
	activity_manager:get_activity_level_info(182)
	self:registerScriptHandler(function(arg_4_0)
		if arg_4_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivityLevel_182")
		end
	end)
end

function ActivityLevel_182.registerActivityEventListener(arg_5_0)
	activity_manager:registerEventListener("ActivityLevel_182", activity_manager.activityEventId.ACTIVITY_LEVEL_INFO_UPDATE, function(arg_6_0)
		arg_5_0:upDateUI(arg_6_0)
	end)
end

function ActivityLevel_182:initUI()
	self:initBtnReturn()
	self:initTitle()
	self:initPanelBook()
	self:initPanelBuff()
...
function ActivityLevel_182:initBtnReturn()
	...
	var_8_0:addTouchEventListener(function(arg_10_0, arg_10_1)
		...
		if arg_10_1 ~= ccui.TouchEventType.ended then
			...
			var_10_0 = {
				surecallback = function()
					activity_manager:add_activity_level_time(182)
				end
			}
			var_10_1 = {
		...
		var_10_1.des = string.format(L_ACTIVITY_ADV_2, (activity_manager:get_activity_level_buy_time_cost(182)))
		var_10_0.labels = var_10_1

		LayerManager:pushInLayer("PopDoLayer", var_10_0)
	end)
	ccui.Helper:seekWidgetByName(self.rootLayer, "role"):loadTexture("ActivityLevel_182/role.png", var_0_4)
end

function ActivityLevel_182:initTitle()
	...
	self.btnDetail:addTouchEventListener(function(arg_13_0, arg_13_1)
		...
		LayerManager:pushInLayer("PopActivityDetail", {
			key = "ActivityLevel_182"
		})
	end)
end

function ActivityLevel_182:initPanelBook()
	...
	var_14_0:loadTexture("ActivityLevel_182/btn_book.png", var_0_4)
	var_14_0:addTouchEventListener(function(arg_15_0, arg_15_1)
		...
		assert(activity_main_conf[182], "activityMainConf 没填 " .. 182)
...
function ActivityLevel_182:upDateUI(arg_18_1)
	self.lblFightNum:setString(L_ACTIVITY_LEVEL_NUM .. arg_18_1.less_fight .. "/6")
	self.lblFightNum:setFontSize(26)

	local var_18_0, var_18_1, var_18_2 = activity_manager:get_cur_activity_technology(182)

	self.lblCurnum:setString(item_manager:getItemNumber(18202001))
	...
	for iter_18_0 = 1, 7 do
		...
		if iter_18_0 > arg_18_1.cur_level then
			var_18_3:loadTextures("ActivityLevel_182/level_lock.png", nil, "ActivityLevel_182/level_lock.png", var_0_4)
		else
			var_18_3:loadTextures("ActivityLevel_182/level.png", nil, "ActivityLevel_182/level.png", var_0_4)
		end
		...
		var_18_3:addTouchEventListener(function(arg_19_0, arg_19_1)
			...
			RoleDefault:getInstance():setIntegerForKey("AdventureEnterIndex", 1820)
