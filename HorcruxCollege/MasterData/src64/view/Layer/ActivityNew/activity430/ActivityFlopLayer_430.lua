ActivityFlopLayer_430 = class("ActivityFlopLayer_430", function()
...
function ActivityFlopLayer_430.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_430.new()
...
function ActivityFlopLayer_430:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_430:updateChampionTipLabel()
...
function ActivityFlopLayer_430:fullScreen()
...
function ActivityFlopLayer_430:initOther()
	...
	self.Title:getChildByName("time"):setVisible(false)
end

function ActivityFlopLayer_430.updateSkin(arg_8_0, arg_8_1, arg_8_2)
	return
end
