StarRankListLayer = class("StarRankListLayer", function()
...
function StarRankListLayer.create(arg_2_0, arg_2_1)
	local var_2_0 = StarRankListLayer.new()
...
function StarRankListLayer:init(arg_3_1)
...
function StarRankListLayer:initBottomList()
...
function StarRankListLayer.DisplayRankList(arg_7_0)
	souls_manager:get_breakout_star_rank(function(arg_8_0)
		if not var_0_7 then
			return
		end

		arg_7_0.data = arg_8_0.data
		arg_7_0.score11 = souls_manager:get_total_contract_attr()

		for iter_8_0, iter_8_1 in pairs(arg_7_0.data) do
			if playermodel.playerid == iter_8_1.playerid then
				arg_7_0.rank11 = iter_8_0
				arg_7_0.data[iter_8_0].score = arg_7_0.score11
				arg_7_0.data[iter_8_0].star = arg_7_0.score11
			end
		end

		for iter_8_2, iter_8_3 in pairs(arg_7_0.data) do
			iter_8_3.rank = iter_8_2
		end

		arg_7_0:initTableView()
		arg_7_0:MyRankNoShow()
	end)
end

function StarRankListLayer:initTableView()
	...
	self.roleTableView:registerScriptHandler(function(arg_10_0, arg_10_1)
		...
		if not var_10_0 then
			...
			if arg_10_1 <= math.floor(self.tableviewhight / var_0_9) then
...
function StarRankListLayer:createNode(arg_13_1)
...
function StarRankListLayer.updateNode(arg_16_0, arg_16_1, arg_16_2)
	...
	for iter_16_1 = 1, 3 do
		if var_16_2[iter_16_1] == 0 then
			...
			var_16_3:loadTexture((var_16_5.bg or nil) and ("equipment/" .. var_16_5.bg .. ".png" or var_0_13[var_16_5.equip_quality]))
			var_16_3:getChildByName("medalname"):setString(var_16_5.name)
			var_16_3:getChildByName("medalname"):enableOutline(var_0_14[var_16_5.equip_quality], 1)
			var_16_3:getChildByName("medalname"):enableShadow(var_0_14[var_16_5.equip_quality], cc.size(0, 0))
			var_16_3:getChildByName("medalname"):setVisible(var_16_5.only_bg ~= 1)
		end
	end
end

function StarRankListLayer:MyRankNoShow(arg_19_1)
	...
	for iter_19_0 = 1, 3 do
		if var_19_5[iter_19_0] == 0 then
			...
			var_19_6:loadTexture((var_19_8.bg or nil) and ("equipment/" .. var_19_8.bg .. ".png" or var_0_13[var_19_8.equip_quality]))
			var_19_6:getChildByName("medalname"):setString(var_19_8.name)
			var_19_6:getChildByName("medalname"):enableOutline(var_0_14[var_19_8.equip_quality], 1)
			var_19_6:getChildByName("medalname"):enableShadow(var_0_14[var_19_8.equip_quality], cc.size(0, 0))
...
function StarRankListLayer:fullScreen(arg_20_1)
