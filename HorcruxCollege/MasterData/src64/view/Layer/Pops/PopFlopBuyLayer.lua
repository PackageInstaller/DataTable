PopFlopBuyLayer = class("PopFlopBuyLayer", function()
...
function PopFlopBuyLayer.create(arg_2_0, arg_2_1)
	local var_2_0 = PopFlopBuyLayer.new()
...
function PopFlopBuyLayer:init(arg_3_1)
	var_0_7 = self
...
function PopFlopBuyLayer:initUI(arg_8_1)
	...
	while ccui.Helper:seekWidgetByName(self.rootLayer, "buy_type" .. var_8_0) do
		...
		if self.limitData[var_8_0].limitNum == self.limitData[var_8_0].boughtNum then
			var_8_2:loadTextures("ActivityPreSummer/btn_buy_out.png", "ActivityPreSummer/btn_buy_out.png", "ActivityPreSummer/btn_buy_out.png", var_0_6)
			var_8_4:setVisible(false)
		else
			var_8_4:setString("X" .. self.currencyData[var_8_0].price)

			local var_8_5 = ccui.ImageView:create(var_0_8[self.currencyData[var_8_0].currency])

			var_8_5:setName("currency_icon")
			var_8_5:setAnchorPoint(cc.p(0.5, 0.5))
			var_8_5:setScale(0.3)
			var_8_5:setPositionX(var_8_4:getPositionX() - var_8_4:getContentSize().width - 20)
...
function PopFlopBuyLayer.updateUI(arg_11_0)
	return
end

function PopFlopBuyLayer:updateBtn(arg_12_1, arg_12_2)
	...
	if self.limitData[arg_12_2].limitNum == self.limitData[arg_12_2].boughtNum then
		var_12_0:loadTextures("ActivityPreSummer/btn_buy_out.png", "ActivityPreSummer/btn_buy_out.png", "ActivityPreSummer/btn_buy_out.png", var_0_6)
...
function PopFlopBuyLayer:popGetKeyItem(arg_13_1, arg_13_2)
	self:shopPop({
		have_bought = 0,
...
function PopFlopBuyLayer.showBuyPop(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
...
function PopFlopBuyLayer.shopPop(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	local var_15_0 = 1
	local var_15_1 = 2
	local var_15_2 = 3
	local var_15_4 = {
