ActivitySignLayer_110_1 = class("ActivitySignLayer_110_1", function()
...
function ActivitySignLayer_110_1.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivitySignLayer_110_1.new()

	require("controller.texture_manager"):loadPopLayerTextures({
		"Activity_LaborSign"
	})
	var_2_0:init(arg_2_1)
	var_2_0:setName("ActivitySignLayer_110_1")

	return var_2_0
end

function ActivitySignLayer_110_1:init(arg_3_1)
	...
	self.rootLayer = ccs.GUIReader:getInstance():widgetFromJsonFile(config._DEBUG and "Activity_Labor_Sign.json" or "Activity_Labor_Sign.ExportJson")
	...
	self:registerScriptHandler(function(arg_7_0)
		if arg_7_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivitySignLayer_110_1")
...
function ActivitySignLayer_110_1:isCheckSignIn()
	local var_8_0 = false
...
local function var_0_7(arg_9_0)
	...
	if config._DEBUG then
		var_9_0 = cc.Sprite:create("Activity_LaborSign/item_bg.png") or cc.Sprite:createWithSpriteFrameName("Activity_LaborSign/item_bg.png")
	end

	var_9_0:setAnchorPoint(cc.p(0.5, 0.5))
	var_9_0:setScale(arg_9_0:getContentSize().width * 0.95 / var_9_0:getContentSize().width)
	var_9_0:setPosition(cc.p(arg_9_0:getContentSize().width / 2, arg_9_0:getContentSize().height / 2 + 16))
	arg_9_0:addChild(var_9_0)
end

function ActivitySignLayer_110_1:createSignBg()
	self.sign_bg:loadTexture("mainScenebg/activity/" .. self.otherData.path .. "/sign_bg.png")
	self.sign_bg:setPosition(cc.p(280, 521))
end

function ActivitySignLayer_110_1:createLimitTime()
...
function ActivitySignLayer_110_1.registerActivityEventListener(arg_12_0)
	activity_manager:registerEventListener("ActivitySignLayer_110_1", activity_manager.activityEventId.EXIT_FORM_PURCHASE_LAYER, function(arg_13_0)
...
function ActivitySignLayer_110_1:createAwards()
	...
	while self.otherData.drops[var_15_2] do
		...
		var_15_6:setPosition(cc.p(var_15_3:getContentSize().width / 2, var_15_3:getContentSize().height / 2 + 16))
...
function ActivitySignLayer_110_1:getAwards()
...
function ActivitySignLayer_110_1:activitySign()
...
function ActivitySignLayer_110_1:exitCallback()
	LayerManager:removePopLayer(self.__queueindex)
end

function ActivitySignLayer_110_1:showAwardsDetails(arg_25_1, arg_25_2)
...
function ActivitySignLayer_110_1.fullScreen(arg_26_0, arg_26_1)
...
function ActivitySignLayer_110_1:exit()
	self:exitCallback()
end
