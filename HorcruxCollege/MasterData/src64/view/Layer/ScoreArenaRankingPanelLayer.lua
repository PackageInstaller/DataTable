ScoreArenaRankingPanelLayer = class("ScoreArenaRankingPanelLayer", function()
...
function ScoreArenaRankingPanelLayer.create(arg_2_0, arg_2_1)
	local var_2_0 = ScoreArenaRankingPanelLayer.new()
...
function ScoreArenaRankingPanelLayer:init(arg_3_1)
	...
	if not self.rank11 then
		scorearena_manager:get_player_scorearena_data(function(arg_4_0)
...
function ScoreArenaRankingPanelLayer:initBottomList()
	local var_5_0 = BottomBtnList:create(function(arg_6_0, arg_6_1)
		if arg_6_1 ~= ccui.TouchEventType.ended then
			return
		end

		LayerManager:switchReturnLayer("ScoreArenaLayer")
	end)
...
function ScoreArenaRankingPanelLayer:createNode()
...
function ScoreArenaRankingPanelLayer.updateNode(arg_8_0, arg_8_1, arg_8_2)
	...
	arg_8_1:getChildByName("star"):setString(arg_8_2.star or "300")
	arg_8_1:getChildByName("title_label"):setString(L_ARENA_CREDITS)
	ccui.Helper:seekWidgetByName(arg_8_1, "label_No_0"):setString(global_trans_number(arg_8_2.score))
...
function ScoreArenaRankingPanelLayer:initTableView()
	...
	self.roleTableView:registerScriptHandler(function(arg_12_0, arg_12_1)
		...
		if not var_12_0 then
			...
			if arg_12_1 <= math.floor(self.tableviewhight / var_0_8) then
...
function ScoreArenaRankingPanelLayer.DisplayRankList(arg_15_0)
	scorearena_manager:get_scorearena_rank(1, 100, function(arg_16_0)
		if tolua.isnull(arg_15_0) then
			return
		end

		arg_15_0.data = arg_16_0

		arg_15_0:initTableView()
	end)
end

function ScoreArenaRankingPanelLayer:MyRankNoShow(arg_17_1)
	...
	var_17_3:setString(self.score11)
	...
	for iter_17_0 = 1, 3 do
		if var_17_5[iter_17_0] == 0 then
			...
			var_17_6:loadTexture((var_17_8.bg or nil) and ("equipment/" .. var_17_8.bg .. ".png" or var_0_12[var_17_8.equip_quality]))
			var_17_6:getChildByName("medalname"):setString(var_17_8.name)
			var_17_6:getChildByName("medalname"):enableOutline(var_0_13[var_17_8.equip_quality], 1)
			var_17_6:getChildByName("medalname"):enableShadow(var_0_13[var_17_8.equip_quality], cc.size(0, 0))
...
function ScoreArenaRankingPanelLayer:fullScreen(arg_18_1)
