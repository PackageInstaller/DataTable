...
function var_0_0.doPayment(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
	...
	print("PayInfo: ", arg_3_2, arg_3_5, arg_3_3, tostring(var_3_0.rmb * 100), var_3_0.name, var_3_0.name, arg_3_4)
	SDKManager.pay(arg_3_2, arg_3_5, arg_3_3, tostring(var_3_0.rmb * 100), var_3_0.name, var_3_0.name, arg_3_4)
end

function var_0_0.reportOrderComplete(arg_5_0, arg_5_1)
	vivoSdkBridge.reportOrderComplete(arg_5_1.transNo)
end
