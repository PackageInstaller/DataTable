local var_0_0 = cc.Sprite.create
local var_0_1 = cc.Sprite.setTexture
...
local function var_0_4(arg_2_0)
	download_node_utils:addDownloadInterface(arg_2_0, "Sprite")
...
function cc.Sprite.create(arg_3_0, arg_3_1, arg_3_2)
	if arg_3_2 then
		local var_3_0 = var_0_0(arg_3_0, arg_3_1)
...
function cc.Sprite:setTexture(arg_4_1)
	if not self:isDownloadEnabled() then
		var_0_1(self, arg_4_1)
