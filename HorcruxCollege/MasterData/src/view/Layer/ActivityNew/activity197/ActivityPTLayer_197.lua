...
ActivityPTLayer_197 = class("ActivityPTLayer_197", function()
...
function ActivityPTLayer_197.create(arg_2_0)
	local var_2_0 = ActivityPTLayer_197.new()
...
function ActivityPTLayer_197:initDynamicConfig()
	self.layerName = "ActivityPTLayer_197"
	self.activityId = 197
	self.addPosY = 30
...
function ActivityPTLayer_197.resetValues(arg_4_0)
	arg_4_0.LEVEL_CELL_HEIGHT = 128
	arg_4_0.TASK_CELL_HEIGHT = 130
end

function ActivityPTLayer_197:setUIPosition()
...
function ActivityPTLayer_197:createLevelSprite(arg_6_1)
...
function ActivityPTLayer_197:updateLevelSprite(arg_9_1, arg_9_2)
