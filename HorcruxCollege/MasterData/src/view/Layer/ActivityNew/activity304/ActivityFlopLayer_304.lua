ActivityFlopLayer_304 = class("ActivityFlopLayer_304", function()
...
function ActivityFlopLayer_304.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_304.new()
...
function ActivityFlopLayer_304:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_304:updateChampionTipLabel()
...
function ActivityFlopLayer_304:fullScreen()
...
function ActivityFlopLayer_304:initOther()
...
function ActivityFlopLayer_304.updateSkin(arg_8_0, arg_8_1, arg_8_2)
	return
end
