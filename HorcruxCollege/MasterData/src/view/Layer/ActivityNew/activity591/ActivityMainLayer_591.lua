...
local ActivityMainLayer_591 = class("ActivityMainLayer_591", function(...)
...
function ActivityMainLayer_591:create(arg_2_1)
	local var_2_0 = ActivityMainLayer_591.new(arg_2_1)
...
function ActivityMainLayer_591:init(arg_3_1)
	self.rootLayer = ccui.Layout:create()

	self:addChild(self.rootLayer)
end

function ActivityMainLayer_591:playInEffect()
	return
end

function ActivityMainLayer_591:initOther(arg_5_1)
...
function ActivityMainLayer_591:initTwistChosee()
	...
	self.bg = ccui.ImageView:create("activitiesRes/activity591/main/twistChoseeBg_1.png")

	self.bg:setTouchEnabled(true)
	self.bg:setPosition(cc.p(320, 520 + GameDisplay.fix_y))
	self.twistChoseeLayer:addChild(self.bg)

	self.btn1 = ccui.Button:create("activitiesRes/activity591/main/twistChoseebtn1_1.png", nil, "activitiesRes/activity591/main/twistChoseebtn1_1.png")
	...
	self.btn2 = ccui.Button:create("activitiesRes/activity591/main/twistChoseebtn1_2.png", nil, "activitiesRes/activity591/main/twistChoseebtn1_2.png")
	...
	self.btn3 = ccui.Button:create("activitiesRes/activity591/main/twistChoseebtn1_3.png", nil, "activitiesRes/activity591/main/twistChoseebtn1_3.png")
	...
	self.btn3:addTouchEventListener(function(arg_12_0, arg_12_1)
		...
		var_12_1.jump_to_system = self.selectType == var_0_14 and 1800748 or 1800748

		var_12_0(var_12_1)
	end)
end

function ActivityMainLayer_591:updateTwistChosee()
	self.bg:loadTexture("activitiesRes/activity591/main/twistChoseeBg_" .. self.selectType .. ".png")
	self.btn1:loadTextures("activitiesRes/activity591/main/twistChoseebtn" .. self.selectType .. "_1.png", nil, "activitiesRes/activity591/main/twistChoseebtn" .. self.selectType .. "_1.png")
	self.btn2:loadTextures("activitiesRes/activity591/main/twistChoseebtn" .. self.selectType .. "_2.png", nil, "activitiesRes/activity591/main/twistChoseebtn" .. self.selectType .. "_2.png")
