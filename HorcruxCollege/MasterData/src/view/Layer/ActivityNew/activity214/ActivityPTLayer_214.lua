...
function ActivityPTLayer_214:initDynamicConfig()
	...
	self.activityId = 214
	self.addPosY = 30
	self.pointitemid = var_0_8[self.activityId].item1 or 2149301
...
function ActivityPTLayer_214:setUIPosition()
	...
	var_5_0:getChildByName("upup"):setPosition(70, 118)
	...
	var_5_3:setPosition(265, 154)
	var_5_3:setFontSize(16)
	var_5_3:setColor(cc.c3b(0, 0, 0))

	local var_5_4 = var_5_2:getChildByName("cur_level")

	var_5_4:setPositionX(50)
	var_5_4:setColor(cc.c3b(255, 255, 255))

	self.pointLabelPosX = 75
end
...
function ActivityPTLayer_214:createLevelSprite(arg_6_1)
	...
	var_6_2:setColor(self:checkPointEnough(arg_6_1) and cc.c3b(249, 174, 87) or cc.c3b(255, 255, 255))
...
function ActivityPTLayer_214:updateLevelSprite(arg_9_1, arg_9_2)
	...
	var_9_1:setColor(self:checkPointEnough(arg_9_2) and cc.c3b(249, 174, 87) or cc.c3b(255, 255, 255))
