ActivityFlopLayer_333 = class("ActivityFlopLayer_333", function()
...
function ActivityFlopLayer_333.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_333.new()
...
function ActivityFlopLayer_333:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_333:updateChampionTipLabel()
...
function ActivityFlopLayer_333:fullScreen()
...
function ActivityFlopLayer_333:initOther()
...
function ActivityFlopLayer_333.updateSkin(arg_8_0, arg_8_1, arg_8_2)
	return
end
