ActivityFlopLayer_312 = class("ActivityFlopLayer_312", function()
...
function ActivityFlopLayer_312.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_312.new()
...
function ActivityFlopLayer_312:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_312:updateChampionTipLabel()
...
function ActivityFlopLayer_312:fullScreen()
...
function ActivityFlopLayer_312:initOther()
...
function ActivityFlopLayer_312.updateSkin(arg_8_0, arg_8_1, arg_8_2)
	return
end
