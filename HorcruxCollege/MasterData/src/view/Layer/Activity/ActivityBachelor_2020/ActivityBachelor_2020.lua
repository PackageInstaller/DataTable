ActivityBachelor_2020 = class("ActivityBachelor_2020", function()
...
function ActivityBachelor_2020.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityBachelor_2020.new()
...
function ActivityBachelor_2020:init(arg_3_1)
	...
	self.activityid = BACHELOR_ACTIVITTID
	...
	self:registerScriptHandler(function(arg_4_0)
		if arg_4_0 == "exit" then
			...
			activity_manager:releaseEventListenerByName("ActivityBachelor_2020")
		end
	end)
end

function ActivityBachelor_2020:registerActivityEventListener()
	activity_manager:registerEventListener("ActivityBachelor_2020", activity_manager.activityEventId.EXIT_FORM_PURCHASE_LAYER, function(arg_6_0)
		self:updateRoutleAlert()
	end)
	activity_manager:registerEventListener("ActivityBachelor_2020", activity_manager.activityEventId.GET_ACTIVITY_SHOP_ITEM, function(arg_7_0)
		self:updateRoutleAlert()
...
function ActivityBachelor_2020:initUI()
	self:initPanelUp()
...
function ActivityBachelor_2020:initPanelUp()
	...
	local var_10_0 = ccui.ImageView:create("ActivityBachelor_2020/img1.png", var_0_0)

	var_10_0:setPosition(cc.p(480, 756))
	var_10_0:setLocalZOrder(1001)
	self.ipad:addChild(var_10_0)

	local var_10_1 = ccui.ImageView:create("ActivityBachelor_2020/img2.png", var_0_0)
...
function ActivityBachelor_2020:initBottomPanel()
	...
	self.btnRoulette:addTouchEventListener(function(arg_19_0, arg_19_1)
		...
		goto_complete_system({
			jump_to_system = tonumber(2000 .. BACHELOR_ACTIVITTID)
		})
	end)
end

function ActivityBachelor_2020:updateShopItem(arg_20_1)
...
function ActivityBachelor_2020:createShopitemPanel(arg_21_1)
	...
	for iter_21_0, iter_21_1 in pairs(arg_21_1.shopitem) do
		...
		local var_21_2 = ccui.ImageView:create("ActivityBachelor_2020/delete.png", var_0_0)
		...
		local var_21_5 = ccui.Button:create("ActivityBachelor_2020/btn_buy.png", nil, "ActivityBachelor_2020/btn_buy.png", var_0_0)

		if iter_21_1.have_bought > 0 then
			var_21_5:loadTextures("ActivityBachelor_2020/btn_bought.png", nil, "ActivityBachelor_2020/btn_bought.png", var_0_0)
		end
		...
		for iter_21_2, iter_21_3 in ipairs(iter_21_1.items) do
			...
			local var_21_8 = ccui.ImageView:create("ActivityBachelor_2020/price_bg.png", var_0_0)
		...
		var_21_14:loadBarTexture("ActivityBachelor_2020/progressBar_bg.png", var_0_0)

		if iter_21_1.limit_sever_num > 40 then
			var_21_14:loadProgressBarTexture("ActivityBachelor_2020/progressBar_full.png", var_0_0)
		else
			var_21_14:loadProgressBarTexture("ActivityBachelor_2020/progressBar_nil.png", var_0_0)
		end
		...
		local var_21_15 = ccui.ImageView:create("ActivityBachelor_2020/progressBar_pg.png", var_0_0)
...
function ActivityBachelor_2020:updateShopitemPanel(arg_24_1)
	for iter_24_0, iter_24_1 in pairs(arg_24_1.shopitem) do
		self.shopitemPanel:getChildByName("lbl_value_" .. iter_24_0):setString(iter_24_1.value .. "%OFF")
		...
		if iter_24_1.have_bought > 0 then
			var_24_1:loadTextures("ActivityBachelor_2020/btn_bought.png", nil, "ActivityBachelor_2020/btn_bought.png", var_0_0)
		end
		...
		if iter_24_1.limit_sever_num > 40 then
			var_24_5:loadProgressBarTexture("ActivityBachelor_2020/progressBar_full.png", var_0_0)
		else
			var_24_5:loadProgressBarTexture("ActivityBachelor_2020/progressBar_nil.png", var_0_0)
		end
...
function ActivityBachelor_2020:playJoinEffect()
...
function ActivityBachelor_2020:playOutEffect(arg_29_1)
	self.isShowEffect = true
...
function ActivityBachelor_2020:fullScreen()
	self.btnRoulette:setPositionY(143 - (GameDisplay.height - 1136) * 0.33)
	self.btnTwist:setPosition(504, 90 - (GameDisplay.height - 1136) * 0.33)
...
function ActivityBachelor_2020.add_alert_tag(arg_32_0, arg_32_1, arg_32_2, arg_32_3, arg_32_4)
	...
	local var_32_2 = ccui.ImageView:create("ActivityBachelor_2020/redDot.png", var_0_0)
...
function ActivityBachelor_2020.updateAlert(arg_33_0)
	return
end

function ActivityBachelor_2020:updateRoutleAlert()
	if activity_manager:getAlertStatus(self.activityid, "sign") then
		self:add_alert_tag(self.btnRoulette, {
			x = 140,
			y = 180
		}, nil, true)
	else
		self:add_alert_tag(self.btnRoulette, pos, nil, false)
	end
end
