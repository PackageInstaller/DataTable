...
ActivityPTLayer_169 = class("ActivityPTLayer_169", function()
...
function ActivityPTLayer_169.create(arg_2_0)
	local var_2_0 = ActivityPTLayer_169.new()
...
function ActivityPTLayer_169:initDynamicConfig()
	self.layerName = "ActivityPTLayer_169"
	self.activityId = 169
	self.addPosY = 30
	self.pointitemid = var_0_8[self.activityId].item1 or 123010001
	self.pointmaxnum = var_0_8[self.activityId].item_limit1 or 1000000
end

function ActivityPTLayer_169.resetValues(arg_4_0)
	arg_4_0.LEVEL_CELL_HEIGHT = 128
	arg_4_0.TASK_CELL_HEIGHT = 130
end

function ActivityPTLayer_169:setUIPosition()
	...
	var_5_4:setColor(cc.c3b(255, 82, 82))

	self.pointLabelPosX = 30
end

function ActivityPTLayer_169:createLevelSprite(arg_6_1)
...
function ActivityPTBaseLayer:updateLevelSprite(arg_9_1, arg_9_2)
