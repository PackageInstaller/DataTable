ActivitySignLayer_118_1 = class("ActivitySignLayer_118_1", function()
...
function ActivitySignLayer_118_1.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivitySignLayer_118_1.new()

	require("controller.texture_manager"):loadPopLayerTextures({
		"Activity_Marry"
	})
	var_2_0:init(arg_2_1)
	var_2_0:setName("ActivitySignLayer_118_1")

	return var_2_0
end

function ActivitySignLayer_118_1:init(arg_3_1)
	var_0_5 = true
	...
	for iter_3_0, iter_3_1 in pairs((require("data.activity_sign_data"))) do
		if iter_3_1.sign_id == "118-1" then
			var_3_0 = var_3_0 + 1
		end
	end
	...
	self:registerScriptHandler(function(arg_7_0)
		if arg_7_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivitySignLayer_118_1")
...
function ActivitySignLayer_118_1:isCheckSignIn()
	local var_8_0 = false
...
function ActivitySignLayer_118_1.registerActivityEventListener(arg_12_0)
	activity_manager:registerEventListener("ActivitySignLayer_118_1", activity_manager.activityEventId.EXIT_FORM_PURCHASE_LAYER, function(arg_13_0)
...
function ActivitySignLayer_118_1:createAwards()
...
function ActivitySignLayer_118_1:getAwards()
	local function var_19_0(arg_20_0)
		if config._DEBUG then
			success = cc.Sprite:create("public/panelbg/fragment_tic_new.png") or cc.Sprite:createWithSpriteFrameName("public/panelbg/fragment_tic_new.png")
		end

		success:setScale(0.7)
		success:setAnchorPoint(cc.p(0.5, 0.5))
		success:setPosition(cc.p(arg_20_0:getContentSize().width * 3 / 4 - 10, arg_20_0:getContentSize().height / 4))
		arg_20_0:addChild(success, 10)
		var_0_7(arg_20_0)
	end
...
function ActivitySignLayer_118_1:activitySign()
...
function ActivitySignLayer_118_1:exitCallback()
	LayerManager:removePopLayer(self.__queueindex)
end

function ActivitySignLayer_118_1:showAwardsDetails(arg_25_1, arg_25_2)
...
function ActivitySignLayer_118_1.fullScreen(arg_26_0, arg_26_1)
...
function ActivitySignLayer_118_1:exit()
	self:exitCallback()
end
