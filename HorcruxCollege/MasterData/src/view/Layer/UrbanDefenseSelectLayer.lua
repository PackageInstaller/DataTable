UrbanDefenseSelectLayer = class("UrbanDefenseSelectLayer", function()
...
local var_0_10 = require("controller/urban_defense_manager"):getInstance()
...
function UrbanDefenseSelectLayer:createLoadIngAni(arg_2_1)
...
function UrbanDefenseSelectLayer.create(arg_4_0, arg_4_1)
	local var_4_0 = UrbanDefenseSelectLayer.new()
...
function UrbanDefenseSelectLayer:init(arg_5_1)
...
function UrbanDefenseSelectLayer:initData()
	self._defendGirls = var_0_10:getDefendGirls()

	;(function()
		var_0_24 = chapter_data[self.mode .. "-" .. self.chapter].select_max_role or 10
		self.selectedList = {}
		self.skeletonList = {}
		self.skeletonDataList = {}
		self.spinePosIdx = {}

		for iter_8_0 in (""):gmatch("([^,]+)") do
...
function UrbanDefenseSelectLayer:updateRoleListData()
	self.curRoleList = {}

	local var_16_0 = {}

	for iter_16_0, iter_16_1 in pairs(self.allRoleDatas) do
		local var_16_1 = global_get_model_attr((global_get_servant_skin(iter_16_1, -1)))

		if self.curSelectType == "all" or self.curSelectType == var_16_1 or self.curSelectType == "special" and self.special_attrs[var_16_1] then
			if not self._defendGirls[iter_16_1] then
	...
	for iter_16_2 = 1, #var_16_0 do
		self.curRoleList[#self.curRoleList + 1] = var_16_0[iter_16_2]
	end
end

function UrbanDefenseSelectLayer:initBg(arg_17_1)
	...
	local var_17_0 = ccui.ImageView:create("TowerDefenceListPanel/select_mark_bg.png", var_0_27)

	var_17_0:setAnchorPoint(cc.p(0.5, 0))
	var_17_0:setPosition(320, var_0_18)
	...
	for iter_17_0 = 1, 3 do
		...
		self.background[iter_17_0]:setPosition(cc.p(-100, var_0_17))
		self.map:addChild(self.background[iter_17_0], -iter_17_0)
	end
end

function UrbanDefenseSelectLayer:initUI()
	self:initHead()
	self:initBaseUI()
...
function UrbanDefenseSelectLayer:initHead()
	local var_19_0 = cc.Node:create()
	local var_19_1 = GameDisplay.height - (GameDisplay.height * (ORIGIN_FIGHT_HEIGHT + var_0_13) / GameDisplay.origin_design_y - GameDisplay.fix_y) - GameDisplay.fix_y - 80

	var_19_0:setPosition(cc.p(0, GameDisplay.height - (GameDisplay.height * (ORIGIN_FIGHT_HEIGHT + var_0_13) / GameDisplay.origin_design_y - GameDisplay.fix_y) - GameDisplay.fix_y - 80 + 300))
...
function UrbanDefenseSelectLayer:initBaseUI()
	...
	local var_20_0 = ccui.ImageView:create("TowerDefenceListPanel/arrow.png", var_0_27)
	...
	local var_20_1 = ccui.ImageView:create("TowerDefenceListPanel/arrow.png", var_0_27)
...
function UrbanDefenseSelectLayer:updatelimitLabel()
	self.limitLabel:setString(TOWER_ROLE_LIMIT .. table.nums(self.selectedList) .. "/" .. var_0_24)
	self.limitLabel:setColor(table.nums(self.selectedList) >= var_0_24 and cc.c3b(255, 85, 85) or cc.c3b(255, 255, 255))
end

function UrbanDefenseSelectLayer:initBattleFieldStatusInfoPanel()
	...
	local var_24_6 = 0.5
	local var_24_7 = 3
	local var_24_8 = ccui.Button:create("FightLayer/btn_show_info.png", nil, "FightLayer/btn_show_info.png", var_0_27)
	...
	local var_24_10 = (function(arg_29_0)
		...
		local var_29_1 = ccui.ImageView:create(var_24_0, var_0_27)
		...
		for iter_29_0 = 1, #arg_29_0 do
			...
			local var_29_7 = ccui.ImageView:create(arg_29_0[iter_29_0].icon, var_0_27)
...
function UrbanDefenseSelectLayer:initList()
...
function UrbanDefenseSelectLayer:updateList()
	...
	for iter_32_0, iter_32_1 in ipairs(self.curRoleList) do
		...
		var_32_0:setPosition((math.ceil(iter_32_0 / 2) - 1) * var_0_19, iter_32_0 % 2 == 0 and 10 or var_32_0:getContentSize().height + 20)
...
function UrbanDefenseSelectLayer:initBottom()
	local var_33_0 = ccui.ImageView:create("TowerDefenceListPanel/tips.png", var_0_27)
	...
	for iter_33_0, iter_33_1 in ipairs(self.attrList) do
		...
		local var_33_2 = ccui.Button:create(var_33_1, nil, var_33_1, var_0_27)
...
function UrbanDefenseSelectLayer:createSp(arg_35_1)
	...
	if self._defendGirls[self.curRoleList[arg_35_1]] then
		l2utils:shaderNode(var_35_2:getVirtualRenderer(), true)
	end

	local var_35_3 = ccui.ImageView:create("TowerDefenceListPanel/cost_bg.png", var_0_27)
	...
	local var_35_6 = ccui.ImageView:create("TowerDefenceListPanel/selected_frame.png", var_0_27)
	...
	var_35_1:_addSuperEvent(function(arg_36_0, arg_36_1, arg_36_2)
		if arg_36_0 == TempWidget.Click then
			...
			if not isContainPosOfConvexPolygon(var_0_25, (arg_36_1:convertToNodeSpace((arg_36_1:getTouchEndPosition())))) then
				return
			end
...
function UrbanDefenseSelectLayer:updateSp(arg_38_1)
	local var_38_1 = arg_38_1.servantid
	local var_38_2 = not not self.selectedList[arg_38_1.servantid]

	arg_38_1:loadTextures("TowerDefenceListPanel/" .. ((self.selectedList[arg_38_1.servantid] and true or false) and "role_bg2.png" or "role_bg1.png"), "TowerDefenceListPanel/" .. ((self.selectedList[arg_38_1.servantid] and true or false) and "role_bg2.png" or "role_bg1.png"), "TowerDefenceListPanel/" .. ((self.selectedList[arg_38_1.servantid] and true or false) and "role_bg2.png" or "role_bg1.png"), var_0_27)
	arg_38_1.selectedLogo:setVisible(var_38_2)
	arg_38_1.costNum:setString(tower_defence_manager:get_servant_cost(var_38_1))
	arg_38_1.roleLv:setString("等级" .. core_manager:getCoreLv(var_38_1))
	arg_38_1.roleLv:setOpacity(255)
	arg_38_1.roleLv:stopAllActions()
	arg_38_1.roleLv:setColor(cc.c3b(255, 255, 255))

	if role_false_level_manager:isRoleFalseLevelMember(var_38_1, FIGHTTYPE_TOWER, self.mode) then
		local var_38_3, var_38_4, var_38_5, var_38_6 = role_false_level_manager:getRoleFalseAttrInfoByAllRole(var_38_1, FIGHTTYPE_TOWER, self.mode)

		arg_38_1.roleLv:setString("等级" .. var_38_4)

		if var_38_3 == core_manager:getServantCoreRank(var_38_1) and playermodel.cores[var_38_1].level == var_38_4 then
			-- block empty
		else
			...
			arg_38_1.roleLv:runAction(cc.RepeatForever:create(cc.Sequence:create(cc.FadeOut:create(2), cc.CallFunc:create(function(...)
				if var_38_7 then
					...
					arg_38_1.roleLv:setString("等级" .. var_38_4 + var_38_6)
				end

				var_38_7 = not var_38_7
			end), cc.FadeIn:create(2))))
		end
	end
end

function UrbanDefenseSelectLayer:roleSpEventFunc(arg_40_1)
	if self.roleSpTouchLock then
		return
	end

	if self._defendGirls[arg_40_1] then
...
function UrbanDefenseSelectLayer:switchSelect(arg_41_1)
	if self.roleSpTouchLock then
		return
	end
	...
	for iter_41_0, iter_41_1 in pairs(self.attrView:getChildren()) do
		...
		if var_41_0 == self.curSelectType then
			iter_41_1:loadTextures("TowerDefenceListPanel/" .. var_41_0 .. "_on.png", nil, "TowerDefenceListPanel/" .. var_41_0 .. "_on.png", var_0_27)
		else
			iter_41_1:loadTextures("TowerDefenceListPanel/" .. var_41_0 .. "_off.png", nil, "TowerDefenceListPanel/" .. var_41_0 .. "_off.png", var_0_27)
		end
	end
...
function UrbanDefenseSelectLayer:sureEventFunc()
	if self.roleSpTouchLock then
		return
	end
...
function UrbanDefenseSelectLayer:initEnemySpine()
	local var_43_0 = {
		[4] = cc.p(560, -50 + 80 * 3),
	...
	for iter_43_0, iter_43_1 in ipairs(self.enemyList) do
		if iter_43_0 <= #var_43_0 then
			self:runAction(cc.Sequence:create(cc.DelayTime:create((iter_43_0 - 1) * 0.01), cc.CallFunc:create(function()
				...
				var_45_2:setScale(var_0_23 * -1 * var_45_3 * (model_data[iter_43_1].modelflip or 1) * 0.8, var_0_23 * var_45_3 * 0.8)
				var_45_2:play("idle")
...
function UrbanDefenseSelectLayer:getAddRolePosIndex(arg_46_1)
...
function UrbanDefenseSelectLayer:addRoleSpine(arg_47_1)
	local var_47_0 = {
		[4] = cc.p(80 + 100, 240),
		cc.p(80, 240 - 60),
	...
	var_47_7:setScale(var_0_23 * var_47_8 * (model_data[var_47_2].modelflip or 1), var_0_23 * var_47_8)
...
function UrbanDefenseSelectLayer:removeRoleSpine(arg_50_1)
...
function UrbanDefenseSelectLayer.saveRoleList(arg_51_0, arg_51_1)
	local var_51_0 = ""
	...
	RoleDefault:getInstance():setStringForKey("UrbanDefenseLastRoles", var_51_0)
end

function UrbanDefenseSelectLayer:batchCreatePlayer()
...
local var_0_29 = "default/default.json"
local var_0_30 = "default/default.atlas"

function UrbanDefenseSelectLayer.addSkeletonDownloadInterface(arg_57_0, arg_57_1)
