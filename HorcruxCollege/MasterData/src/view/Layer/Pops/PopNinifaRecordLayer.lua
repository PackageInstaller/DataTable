PopNinifaRecordLayer = class("PopNinifaRecordLayer", function(arg_1_0)
...
function PopNinifaRecordLayer.create(arg_2_0)
	local var_2_0 = PopNinifaRecordLayer.new()
...
function PopNinifaRecordLayer:init()
	...
	activity_ninifa_manager:getCompoundRecordFromSever()
	self:registerScriptHandler(function(arg_4_0)
		if arg_4_0 == "exit" then
			activity_manager:releaseEventListenerByName("PopNinifaRecordLayer")
		end
	end)
end

function PopNinifaRecordLayer.registerActivityEventListener(arg_5_0)
	activity_manager:registerEventListener("PopNinifaRecordLayer", activity_manager.activityEventId.ACTIVITY_RECORD_UPDATE, function(arg_6_0)
		arg_5_0:initViewWithData()
	end)
end

function PopNinifaRecordLayer:initUI()
	...
	ccui.Helper:seekWidgetByName(self.rootLayer, "title_bg"):getChildByName("title_lbl"):setString(L_ACTIVITY_NINIFA.RECORD_TITLE)
	self:initBottomList()
end

function PopNinifaRecordLayer:initBottomList()
...
function PopNinifaRecordLayer:initViewWithData()
	local var_10_0, var_10_1 = activity_ninifa_manager:getRecordData()

	if not next(var_10_0) then
		ccui.Helper:seekWidgetByName(self.rootLayer, "nothing_bg"):setVisible(true)

		return
	end

	self.viewPanel = ccui.Helper:seekWidgetByName(self.rootLayer, "view_bg")
	self.tableView = cc.TableView:create(cc.size(var_0_2, var_0_1))

	self.tableView:setDelegate()
	self.tableView:setVerticalFillOrder(cc.TABLEVIEW_FILL_TOPDOWN)
	self.tableView:setDirection(cc.SCROLLVIEW_DIRECTION_VERTICAL)
	self.viewPanel:addChild(self.tableView)
	self.tableView:setPositionY(var_0_0)
	...
	self.tableView:registerScriptHandler(function(arg_11_0, arg_11_1)
		...
		if not var_11_0 then
			...
			local var_11_2 = self:createRecordSprite(var_10_0[arg_11_1 + 1])

			var_11_2:setAnchorPoint(cc.p(0.5, 0.5))
			var_11_2:setPosition(cc.p(260, var_0_5 / 2))
			...
			self:updateRecordSprite(var_11_0:getChildByTag(100), var_10_0[arg_11_1 + 1])
		end
...
function PopNinifaRecordLayer.createRecordSprite(arg_14_0, arg_14_1)
	local var_14_0 = ccui.Button:create("ActivityNinifaCompositeLayer/count_bg.png", nil, "ActivityNinifaCompositeLayer/count_bg.png", var_0_6)

	var_14_0:setScale9Enabled(true)
	var_14_0:setTag(100)
	var_14_0:setCapInsets(cc.rect(10, 10, 10, 10))
	var_14_0:setContentSize(cc.size(var_0_4, 136))

	for iter_14_0 = 1, 3 do
		local var_14_1 = ItemPurchaseSprite:createPurchaseItem(arg_14_1["need_item" .. iter_14_0])
	...
	local var_14_2 = ItemPurchaseSprite:createPurchaseItem(arg_14_1.result_item)
	...
	for iter_14_1 = 1, 2 do
		local var_14_3 = ccui.ImageView:create("ActivityNinifaCompositeLayer/add_small.png", var_0_6)

		var_14_3:setPosition(cc.p(115 + (iter_14_1 - 1) * 110, 67))
		var_14_0:addChild(var_14_3)
	end

	local var_14_4 = ccui.ImageView:create("ActivityNinifaCompositeLayer/goto.png", var_0_6)

	var_14_4:setPosition(cc.p(335, 67))
	var_14_0:addChild(var_14_4)

	local var_14_5 = ccui.ImageView:create("ActivityNinifaCompositeLayer/fail.png", var_0_6)

	var_14_5:setVisible(arg_14_1.result_item == var_0_3)
	var_14_5:setName("fail_img")
	var_14_5:setPosition(cc.p(25, 120))
...
function PopNinifaRecordLayer.updateRecordSprite(arg_18_0, arg_18_1, arg_18_2)
	arg_18_1:setTag(100)

	for iter_18_0 = 1, 3 do
		local var_18_0 = arg_18_1:getChildByName("need_item" .. iter_18_0)

		var_18_0:updatePurchaseItemByItemid(arg_18_2["need_item" .. iter_18_0])
	...
	var_18_1:updatePurchaseItemByItemid(arg_18_2.result_item)
	...
	arg_18_1:getChildByName("fail_img"):setVisible(arg_18_2.result_item == var_0_3)
