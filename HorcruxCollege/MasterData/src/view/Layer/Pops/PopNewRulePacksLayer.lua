PopNewRulePacksLayer = class("PopNewRulePacksLayer", function()
...
function PopNewRulePacksLayer.create(arg_2_0, arg_2_1)
	local var_2_0 = PopNewRulePacksLayer.new()
...
local function var_0_23(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	local var_4_0
	local var_4_1
...
local function var_0_24(arg_6_0, arg_6_1)
...
function PopNewRulePacksLayer:init(arg_16_1)
...
function PopNewRulePacksLayer:initPurchaseEventListener()
...
function PopNewRulePacksLayer.initData(arg_24_0, arg_24_1)
	...
	network:rpc("get_recharge_info", {
		...
		if arg_25_0.result == 1 then
			for iter_25_0, iter_25_1 in ipairs(arg_25_0.products) do
				if iter_25_1.shop_type == arg_24_0.shop_type then
...
function PopNewRulePacksLayer:initUI()
	local var_27_0 = ccui.ImageView:create("PopReturnBackPacksLayer/bg_" .. self.shop_type .. ".png", var_0_14)
	...
	self.dont_click:setContentSize(640, var_27_0:getPositionY() - var_27_0:getContentSize().height / 2 + 10 + GameDisplay.fix_y)
	self.dont_click:setPositionY(20 - GameDisplay.fix_y)
...
function PopNewRulePacksLayer.createSp(arg_33_0)
	...
	for iter_33_0 = 1, 2 do
		...
		local var_33_5 = ccui.ImageView:create("PopReturnBackPacksLayer/sell_out_mask.png", var_0_14)

		var_33_5:setName("sell_out_mask")
		var_33_5:setPosition(cc.p(0, 0))
		var_33_1:addChild(var_33_5, 2)
		var_33_5:setAnchorPoint(0, 0)
		var_33_5:setVisible(false)

		if iter_33_0 == 1 then
			local var_33_6 = ccui.ImageView:create("PopReturnBackPacksLayer/item_bg.png", var_0_14)

			var_33_6:setName("itembg1")
			var_33_6:setPosition(cc.p(113, 90))
			var_33_1:addChild(var_33_6)

			local var_33_7 = ccui.ImageView:create("PopReturnBackPacksLayer/label_bg.png", var_0_14)

			var_33_7:setPosition(34, 49)
			var_33_6:addChild(var_33_7)

			local var_33_8 = cc.Label:createWithTTF("20", FONT_NAME, 18)

			var_33_8:setPosition(cc.p(50, 10))
			var_33_7:addChild(var_33_8)
		else
			local var_33_9 = ccui.ImageView:create("PopReturnBackPacksLayer/item_bg.png", var_0_14)

			var_33_9:setName("itembg1")
			var_33_9:setPosition(cc.p(68, 90))
			var_33_1:addChild(var_33_9)

			local var_33_10 = ccui.ImageView:create("PopReturnBackPacksLayer/item_bg.png", var_0_14)

			var_33_10:setName("itembg2")
			var_33_10:setPosition(cc.p(160, 90))
	...
	function var_33_0.update(arg_34_0)
		for iter_34_0 = 1, 2 do
			...
			if arg_33_0.rechargeList[((arg_34_0 + 1) % 2 == 0 or nil) and arg_34_0 * 2 + (3 - iter_34_0)] then
				...
				local var_34_6 = var_34_2:getChildByName("sell_out_mask")
				...
				local var_34_8 = drop_manager:getDropMsg(recharge_data[var_34_1.id].dropid or item_data[recharge_data[var_34_1.id].dropitem].mode_id)

				if var_34_8.diamond > 0 then
					table.insert(var_34_8.equips, {
						dropid = "diamond",
						dropNum = var_34_8.diamond
					})
				end

				if var_34_8.gold > 0 then
					table.insert(var_34_8.equips, {
						dropid = "gold",
						dropNum = var_34_8.gold
					})
				end

				local var_34_9 = #var_34_8.equips == 1 and {
					113
				} or {
					68,
					160
				...
				for iter_34_1, iter_34_2 in ipairs(var_34_8.equips) do
					local var_34_10 = ccui.ImageView:create("PopReturnBackPacksLayer/item_bg.png", var_0_14)

					var_34_10:setName("itembg" .. iter_34_1)
					var_34_10:setPosition(cc.p(var_34_9[iter_34_1] or var_34_9[1] + 92 * (iter_34_1 - 1), 90))
					var_34_2:addChild(var_34_10)

					local var_34_11 = ccui.ImageView:create("PopReturnBackPacksLayer/label_bg.png", var_0_14)

					var_34_11:setPosition(34, 49)
					var_34_10:addChild(var_34_11)

					local var_34_12 = cc.Label:createWithTTF("", FONT_NAME, 18)

					var_34_12:setPosition(cc.p(45, 10))
					var_34_11:addChild(var_34_12)

					local var_34_13, var_34_14 = var_0_23(nil, true, iter_34_2.dropid, iter_34_2.dropNum)

					var_34_13:setScale(var_34_13:getScale() * 0.65)
					var_34_13:setPosition(35, 50)
					var_34_10:addChild(var_34_13)
					var_34_12:setString("x" .. global_trans_number(var_34_14))
					var_34_12:setScale((40 / var_34_12:getContentSize().width < 1 and 50 / var_34_12:getContentSize().width or 1) * var_34_12:getScale())
				end

				var_34_2:removeChildByName("pre_icon")

				if var_34_1.pre_rechargeid then
					local var_34_15 = ccui.ImageView:create("PopReturnBackPacksLayer/next_icon.png", var_0_14)

					var_34_2:addChild(var_34_15)
					var_34_15:setName("pre_icon")
					var_34_15:setPosition(var_0_15[(arg_34_0 * 2 + iter_34_0) % 4])
					var_34_15:setRotation(var_0_16[(arg_34_0 * 2 + iter_34_0) % 4])
				end
			else
...
function PopNewRulePacksLayer:initBg(arg_36_1)
	self.shop_type = arg_36_1.shop_type
...
function PopNewRulePacksLayer.updateShowingCells(arg_38_0, arg_38_1, arg_38_2)
...
function PopNewRulePacksLayer:buyRecharge(arg_39_1, arg_39_2)
	...
	var_0_24(var_39_0, function(arg_40_0)
		if arg_40_0.result == 1 then
			if arg_39_1.rmb == 0 then
				var_0_28(var_39_0, function(arg_41_0)
		...
		if arg_40_0.products then
			for iter_40_0, iter_40_1 in ipairs(arg_40_0.products) do
				if iter_40_1.shop_type == self.shop_type then
...
function PopNewRulePacksLayer.no_pre_recharge(arg_42_0, arg_42_1)
