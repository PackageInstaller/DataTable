local var_0_0 = {}
local var_0_1 = {
	"data.furnituresuit_basic_data",
	"data.furnituresuit_birthday_data",
	"data.furnituresuit_lantern_data",
	"data.furnituresuit_spine_data"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("furnituresuit_data id is nil: " .. arg_1_1)
		end
