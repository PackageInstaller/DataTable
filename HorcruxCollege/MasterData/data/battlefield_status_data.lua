local var_0_0 = {}
local var_0_1 = {
	"data.battlefield_status_basic_data",
	"data.battlefield_status_data_Bossshilian",
	"data.hundredtower_battlefield_status_data",
	"data.speed_battlefield_status_data"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("battlefield_status_data id is nil: " .. arg_1_1)
		end
