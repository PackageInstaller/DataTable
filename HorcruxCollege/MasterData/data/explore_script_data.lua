local var_0_0 = {}
local var_0_1 = {
	"data.explore_script_146_data",
	"data.explore_script_2020christmas_data",
	"data.explore_script_anniversary_data",
	"data.explore_script_basic_data",
	"data.explore_script_stable_data",
	"data.explore_script_summer2021_data",
	"data.explore_script_umaru_data"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("explore_script_data id is nil: " .. arg_1_1)
		end
