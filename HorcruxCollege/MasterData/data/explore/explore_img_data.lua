local var_0_0 = {}
local var_0_1 = {
	"data.explore.explore_img_2020christmas_data",
	"data.explore.explore_img_2020spring_data",
	"data.explore.explore_img_anniversary_data",
	"data.explore.explore_img_basic_data"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("explore_img_data id is nil: " .. arg_1_1)
		end
