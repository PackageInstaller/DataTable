local var_0_0 = {}
local var_0_1 = {
	"data.activity_flychess_boss_755_data",
	"data.activity_flychess_boss_786_data",
	"data.activity_flychess_boss_837_data",
	"data.activity_flychess_boss_855_data",
	"data.activity_flychess_boss_892_data"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("activity_flychess_boss_data id is nil: " .. arg_1_1)
		end
