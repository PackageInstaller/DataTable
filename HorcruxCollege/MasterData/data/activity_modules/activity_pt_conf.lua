local var_0_0 = {}
local var_0_1 = {
	"data.activity_pt.activityconf.activity_pt_142_conf",
	"data.activity_pt.activityconf.activity_pt_21qixi_conf",
	"data.activity_pt.activityconf.activity_pt_marry_conf",
	"data.activity_pt.activityconf.activity_pt_pre_21summer_conf"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("activity_pt_conf id is nil: " .. arg_1_1)
		end
