local var_0_0 = {}
local var_0_1 = {
	"data.activity_roulette.activity_roulette_giftbag_data",
	"data.activity_roulette.activityconf.activity_roulette_142_conf",
	"data.activity_roulette.activityconf.activity_roulette_174_conf"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("activity_roulette_conf id is nil: " .. arg_1_1)
		end
