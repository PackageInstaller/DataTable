...
function M:on_enter()
  ...
  elseif not self:is_pass_room() then
    ...
    self:lookat_position(Global.hero, x, y, true)
    self:actvie_obstacle("AW1", "wall", true)
    self.monster1 = self:add_npc_by_pos_key(1, 201015, "M1", 0, 0, "bornpoint", 0, 0, 4, self.normal_level)
    self.monster2 = self:add_npc_by_pos_key(1, 201015, "M2", 0, 0, "bornpoint", 0, 0, 4, self.normal_level)
    self.monster3 = self:add_npc_by_pos_key(1, 201015, "M3", 0, 0, "bornpoint", 0, 0, 4, self.normal_level)
    self.monster4 = self:add_npc_by_pos_key(1, 201015, "M4", 0, 0, "bornpoint", 0, 0, 4, self.normal_level)
    self.monster5 = self:add_npc_by_pos_key(1, 201014, "M5", 0, 0, "bornpoint", 0, 0, 4, self.normal_level)
  end
end
