...
function M:on_npc_show_end(id, type)
  ...
  self.monster = {}
  self.monster[1] = self:add_npc_by_pos_key(1, 201019, "center", 2, 2, "center", 0, 0, 4, self.challenge_level)
  self.monster[2] = self:add_npc_by_pos_key(1, 201019, "center", 2, -2, "center", 0, 0, 4, self.challenge_level)
  self.monster[3] = self:add_npc_by_pos_key(1, 201019, "center", -2, 2, "center", 0, 0, 4, self.challenge_level)
  self.monster[4] = self:add_npc_by_pos_key(1, 201019, "center", -2, -2, "center", 0, 0, 4, self.challenge_level)
end
