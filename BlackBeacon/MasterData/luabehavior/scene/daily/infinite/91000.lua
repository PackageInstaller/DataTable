...
function M:on_enter()
  ...
  if not self.is_add_npc then
    self:add_functional_npc(4, "center", "tp3", {npc_id = 50004})
    self:add_functional_npc(2, "tp2", "tp3", {npc_id = 20201})
    self:accept_task_group(21101)
    self:accept_task_group(21102)
    self:accept_task_group(21103)
    self.is_add_npc = true
  end
  if true == self.hide_npc then
    self:fight_end(true)
