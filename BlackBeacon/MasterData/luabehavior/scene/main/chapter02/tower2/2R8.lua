...
function M:on_enter()
  self:set_route_status(12, 19, true)
  self:set_route_status(12, 5, false)
  self:set_scene_tips(1021017, 1, {})
  self:timer_call_out(nil, function()
    self:set_scene_tips(1021018, 1, {})
  end, 4.1)
  if self:is_pass_room() then
    ...
    self:set_scene_camera(102)
    self:add_monster()
    self:set_scene_tips(1021031, true, 2)
    self:timer_call_out("1", function()
      self:set_scene_tips(1021032, 1, {})
    end, 4.1)
  end
end
