...
function M:on_enter()
  self:set_route_status(39, 30, true)
  self:set_route_status(38, 39, false)
  if self:is_pass_room() then
    ...
    self:set_scene_camera(102)
    self:add_monster()
    self:set_scene_tips(1021003, 1, {})
    self:timer_call_out("1", function()
      self:set_scene_tips(1021004, 1, {})
    end, 3.1)
    self:timer_call_out("2", function()
      self:set_scene_tips(1021005, 1, {})
    end, 6.1)
    self:timer_call_out("3", function()
      self:set_scene_tips(1021006, 1, {})
    end, 8.1)
    self:timer_call_out("4", function()
      self:set_scene_tips(1021007, 1, {})
    end, 10.1)
    self:timer_call_out("5", function()
      self:set_scene_tips(1021008, 1, {})
    end, 12.1)
  end
end
