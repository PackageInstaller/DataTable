...
function M:on_enter()
  self:play_timeline("03-0101", 0, 0)
  self:play_timeline("03-0102")
  self:set_route_status(1, 4, false)
  self.car = self:add_npc_by_pos_key(2, 300103801, "C2", 0, 0, "C1", 0, 0, 4, 1)
...
function M:on_enter_area(npc, area)
  if area.Key == "C1" and npc == self.car then
    self:play_story(100102052)
  end
