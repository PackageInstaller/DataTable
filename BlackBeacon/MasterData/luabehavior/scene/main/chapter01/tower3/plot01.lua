...
function M:on_enter()
  ...
  if 0 == self.first_enter then
    self.book = self:add_functional_npc(4, "center", "center", {npc_id = 101303})
    self:add_functional_npc(2, "book1", "center", {npc_id = 101305})
    self:add_functional_npc(2, "book2", "center", {npc_id = 101306})
    self:add_functional_npc(2, "book3", "center", {npc_id = 101307})
  end
  self:set_scene_tips(100115, true)
...
function M:on_func_npc_interact_end(func_npc_id)
  if func_npc_id == self.book then
    self:play_story(1013003)
  end
  self:remove_functional_npc(func_npc_id)
end
