...
function M:on_enter()
  ...
  if 0 == self.first_enter then
    self.book = self:add_functional_npc(4, "center", "center", {npc_id = 101302})
    self:add_functional_npc(2, "M1", "center", {npc_id = 101305})
    self:add_functional_npc(2, "M3", "center", {npc_id = 101306})
    self.first_enter = 1
  end
