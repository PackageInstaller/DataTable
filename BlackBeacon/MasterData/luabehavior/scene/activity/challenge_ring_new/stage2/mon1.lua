...
function M:on_enter()
  ...
  if self:is_pass_room() then
    ...
    self:actvie_obstacle("wall1", "wallblock", true)
    self:actvie_obstacle("wall2", "wallblock", true)
    self:actvie_obstacle("wall3", "wallblock", true)
    self:actvie_obstacle("wall4", "wallblock", true)
    self:set_scene_camera(102)
    self:add_monster()
