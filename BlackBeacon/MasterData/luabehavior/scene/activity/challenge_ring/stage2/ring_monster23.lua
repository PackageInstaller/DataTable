...
function M:add_monster()
  ...
  if 1 == self.random_id then
    ...
    self:set_scene_tips(102001, true)
  end
  if 2 == self.random_id then
    self:cast_magic(self.mm3, self.mm3, cast_magic_id[2], 1)
    self:cast_magic(self.mm4, self.mm4, cast_magic_id[2], 1)
    self:set_scene_tips(102002, true)
  end
  if 3 == self.random_id then
    self:cast_magic(self.mm3, self.mm3, cast_magic_id[3], 1)
    self:cast_magic(self.mm4, self.mm4, cast_magic_id[3], 1)
    self:set_scene_tips(102003, true)
  end
end
