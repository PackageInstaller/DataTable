...
function M:creat_magic()
  ...
  if is_pass_room() then
    ...
    cast_magic(npc1, npc1, 60720501, 1)
    cast_magic(npc1, npc1, 60720502, 1)
    if get_scene_hero_by_poskey(21) then
      local npc2 = get_scene_hero_by_poskey(21)
      cast_magic(npc2, npc2, 60720501, 1)
      cast_magic(npc2, npc2, 60720502, 1)
    end
    if get_scene_hero_by_poskey(22) then
      local npc3 = get_scene_hero_by_poskey(22)
      cast_magic(npc3, npc3, 60720501, 1)
      cast_magic(npc3, npc3, 60720502, 1)
    end
    self.room = 0
  end
end
