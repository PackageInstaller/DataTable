...
function M:on_frame()
  if self.npc == get_come_on_hero() then
    ...
    if shield_hp1 > 0 then
      if not check_magic(self.npc, 61700011) then
        cast_magic(self.npc, self.npc, 61700011, level)
      end
    elseif check_magic(self.npc, 61700011) then
      abort_magic_by_id(self.npc, 61700011)
    end
  end
end
