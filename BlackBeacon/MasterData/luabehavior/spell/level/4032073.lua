...
function M:on_frame()
  ...
  if self.combo_guide and 0 == self.combo_guide and 1 == get_sync_var("combo_guide") then
    start_skill_teach(100704)
    set_scene_tips(60731, true, {})
  ...
  if self.combo_guide and 91 == self.combo_guide and get_npc_time(self.npc) > self.teahctime1 + 1 then
...
function M:on_touch_up(output_id, iscancel)
  if 20 == output_id and 1 == self.combo_guide then
