...
function M:teach_guide1()
  ...
  g:add_step(function(back_form)
    if back_form then
      ...
      restart_skill_teach(101801)
    else
      cast_magic(self.npc, self.npc, 4032165, 1)
      start_skill_teach(101801)
      set_scene_tips(61801, true, {})
    end
  ...
  local function func_skill_begin(npc, skill_id, skill_type)
    local target_skill_id = 100101800 + g:step_index() - 2
...
function M:teach_guide4()
  ...
  g:add_step(function(back_form)
    if back_form then
      cast_magic(self.npc, self.npc, 4032165, 1)
      restart_skill_teach(101803)
    else
      cast_magic(self.npc, self.npc, 4032165, 1)
      start_skill_teach(101803)
      set_scene_tips(61804, true, {})
      set_ui_object_visible("fight", "Btn_skill1", true)
  ...
  g:add_step(function()
    set_scene_tips(61804, false, {})
    remove_missile_by_id(10010181123, self.npc, false)
    self.god1 = add_npc_by_pos_key(1, 3001024, "end", 0, 0, "end", 0, 0, 2, 1)
    self.pos1 = get_npc_pos(self.god1)
    self:to_next_step(2)
  end)
  g:add_step(function()
    show_skill_teach_tips(101801, true)
