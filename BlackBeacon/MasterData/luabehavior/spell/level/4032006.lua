...
function M:teach_guide1()
  ...
  g:add_step(function()
    self.monster1 = add_npc_by_pos_key(1, 20101502, "M4", 0, 0, "tp3", 0, 0, 4, 99)
    self.monster2 = add_npc_by_pos_key(1, 20101502, "M4", 2, 0, "tp3", 1, 0, 4, 99)
    self.monster3 = add_npc_by_pos_key(1, 20101502, "M4", -2, 0, "tp3", 0, 1, 4, 99)
    self.monster4 = add_npc_by_pos_key(1, 20101502, "M4", 0, 2, "tp3", 1, 1, 4, 99)
  ...
  g:add_step(function(back_form)
    if back_form then
      ...
      restart_skill_teach(100110)
    else
      cast_magic(self.npc, self.npc, 4032175, 1)
      cast_magic(self.npc, self.npc, 4032176, 1)
      start_skill_teach(100110)
    end
    set_scene_tips(60113, true, {})
  ...
  g:add_step(function()
    show_skill_teach_tips(100104, true)
