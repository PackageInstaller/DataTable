...
function M:teach_guide1()
  ...
  g:add_step(function(back_form)
    if back_form then
      cast_magic(self.npc, self.npc, 4032145, 1)
      cast_magic(self.npc, self.npc, 4032146, 1)
...
function M:teach_guide2()
  ...
  g:add_step(function(back_form)
    if back_form then
      ...
      cast_magic(self.npc, self.npc, 4032146, 1)
      cast_magic(self.npc, self.npc, 4032147, 1)
      restart_skill_teach(101402)
    else
      cast_magic(self.npc, self.npc, 4032145, 1)
      cast_magic(self.npc, self.npc, 4032146, 1)
      cast_magic(self.npc, self.npc, 4032147, 1)
      start_skill_teach(101402)
