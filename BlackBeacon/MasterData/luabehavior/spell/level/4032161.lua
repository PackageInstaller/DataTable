...
function M:teach_guide1()
  ...
  g:add_step(function(back_form)
    if back_form then
      ...
      restart_skill_teach(101601)
    else
      cast_magic(self.npc, self.npc, 4032165, 1)
      start_skill_teach(101601)
      set_scene_tips(61601, true, {})
    end
  ...
  local function func_skill_begin(npc, skill_id, skill_type)
    local target_skill_id = 100101600 + g:step_index() - 2
...
function M:teach_guide2()
  ...
  g:add_step(function(back_form)
    if back_form then
      cast_magic(self.npc, self.npc, 4032165, 1)
      restart_skill_teach(101603)
    else
      cast_magic(self.npc, self.npc, 4032165, 1)
      start_skill_teach(101603)
      set_scene_tips(61602, true, {})
    end
    set_ui_object_visible("fight", "Btn_skill1", true)
...
function M:teach_guide3()
  ...
  g:add_step(function()
    self.monster3 = add_npc_by_pos_key(1, 20102802, "center", -3, 4, "tp3", 0, 0, 4, 99)
    self.monster4 = add_npc_by_pos_key(1, 20102802, "center", 3, 4, "tp3", 0, 0, 4, 99)
  ...
  g:add_step(function(back_form)
    if back_form then
      cast_magic(self.npc, self.npc, 4032165, 1)
      restart_skill_teach(101611)
    else
      cast_magic(self.npc, self.npc, 4032165, 1)
      start_skill_teach(101611)
      set_scene_tips(61602, true, {})
    end
    self:to_next_step()
  end)
  g:add_step():listen("on_input", function(input_id)
    ...
    print("input_time", input_time)
    if 15 == output_id and input_time >= 0.5 and true ~= iscancel then
      set_skill_state(1, true)
      self:to_next_step()
    else
      set_skill_state(1, false)
...
function M:teach_guide4()
  ...
  g:add_step(function(back_form)
    if back_form then
      cast_magic(self.npc, self.npc, 4032165, 1)
      restart_skill_teach(101602)
    else
      cast_magic(self.npc, self.npc, 4032165, 1)
      start_skill_teach(101602)
      set_scene_tips(61603, true, {})
      set_ui_object_visible("fight", "Btn_skill1", true)
