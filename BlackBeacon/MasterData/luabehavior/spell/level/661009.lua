...
function M:on_before_npc_hp_zero(npc)
  ...
  if npc_kind >= 2 and npc_kind <= 4 or 7 == npc_kind then
    ...
    if random <= 30 then
      ...
      cast_missile(npc, nil, pos.x, pos.z, 10018010101, 1, pos.x, pos.z, hero_pos.y, hero_pos.y, pos.x, pos.z, hero_pos.y)
      cast_missile(npc, nil, pos.x, pos.z, 10018010102, 1, pos.x, pos.z, hero_pos.y, hero_pos.y, pos.x, pos.z, hero_pos.y)
      cast_missile(npc, nil, pos.x, pos.z, 10018010103, 1, pos.x, pos.z, hero_pos.y, hero_pos.y, pos.x, pos.z, hero_pos.y)
    end
  end
end
