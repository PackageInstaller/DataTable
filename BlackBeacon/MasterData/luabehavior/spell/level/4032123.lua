...
function M:teach_guide1()
  ...
  g:add_step(function(back_form)
    if back_form then
      ...
      restart_skill_teach(101208)
    else
      cast_magic(self.npc, self.npc, 4032175, 1)
      cast_magic(self.npc, self.npc, 4032176, 1)
      start_skill_teach(101208)
    end
    set_scene_tips(61234, true, {})
  ...
  g:add_step(function()
    show_skill_teach_tips(101204, true)
...
function M:on_frame()
  ...
  if self.init_guide and not self.quit_scene and get_npc_attr(self.npc, 108) < get_npc_attr(self.npc, 109) and not is_cast_skill_time(self.npc, 100101233) then
    cast_magic(self.npc, self.npc, 4032992, 0)
  end
