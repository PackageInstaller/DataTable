...
function M:teach_guide1()
  ...
  g:add_step(function(back_form)
    if back_form then
      restart_skill_teach(101408)
    else
      start_skill_teach(101408)
      set_scene_tips(61411, true, {})
    end
  ...
  g:add_step(function()
    show_skill_teach_tips(101403, true)
