...
function M:on_start()
  if not check_magic(self.npc, 4031033) then
    cast_magic(self.npc, self.npc, 4031033, 1)
  end
end
...
function M:on_frame()
  ...
  if self.god and 0 == self.magic_set and self.strength < self.strengthMax and get_npc_time(self.npc) > self.strengthTime + 0.3 then
    cast_magic(self.npc, self.god, 4031030, 1)
  ...
  if self.god and 1 == self.magic_set and self.strength > 0 and get_npc_time(self.npc) > self.strengthTime + 0.3 then
    cast_magic(self.npc, self.god, 4031029, 1)
    self.strengthTime = get_npc_time(self.npc)
  end
...
function M:cast_skill1()
  ...
  cast_magic(self.npc, self.npc, 4031031, 1)
  set_sync_var("move_plat", 1)
...
function M:on_room_change(npc)
  if check_magic(npc, 4031027) then
    cast_magic(self.npc, self.npc, 4031028, 1)
  end
end

function M:on_npc_hp_zero(npc)
  if npc == self.npc and check_magic(npc, 4031027) then
    cast_magic(self.npc, self.npc, 4031027, 1)
  end
end
