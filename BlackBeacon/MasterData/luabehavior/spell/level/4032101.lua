...
function M:teach_guide1()
  ...
  local function func_skill_begin(npc, skill_id, skill_type)
    local target_skill_id = 100101010 + g:step_index() - 2
...
function M:teach_guide2()
  ...
  g:add_step(function(back_form)
    if back_form then
      restart_skill_teach(101005)
    else
      start_skill_teach(101005)
      set_scene_tips(61011, true, {})
    end
    set_ui_object_visible("fight", "Btn_skill1", true)
    self:to_next_step()
  end)
...
function M:teach_guide4()
  ...
  g:add_step(function(back_form)
    if back_form then
      restart_skill_teach(101002)
    else
      start_skill_teach(101002)
      set_scene_tips(61013, true, {})
      set_ui_object_visible("fight", "Btn_skill1", true)
