...
function monster._init(monster, npc)
  ...
  function states.atk.start(atk)
    atk.base.start(atk)
    remove_missile_by_id(30010890102, npc, true)
    remove_missile_by_id(30010890103, npc, true)
    remove_missile_by_id(30010890301, npc, false)
    local param = {
      npc = monster.npc,
      posx = monster.knife1posX,
      posz = monster.knife1posZ,
      missile_id = 30010890302,
      missile_level = 1,
...
function monster.on_self_missile_begin_pos(monster, pos_x, pos_z, missile_cfg, missile)
  if missile_cfg.Id == 30010890102 then
  ...
  if missile_cfg.Id == 30010890103 then
  ...
  if missile_cfg.Id == 30010890301 then
