...
function M:_init()
  self.skill01 = {
    ...
    0,
    10,
    get_skill_cfg(300102301).CastTime,
    get_skill_cfg(300102301).AfterTime,
    0
  }
  self.control = nil
  self.target = nil
...
function M:cast_skill(skill_instant_ID)
  if 300102301 == skill_instant_ID[1] and self.target then
...
function M:search_target()
  if check_magic(self.npc, 4010172) then
