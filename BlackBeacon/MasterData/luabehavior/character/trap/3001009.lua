...
function M:_init()
  self.skill02 = {
    ...
    0,
    0,
    get_skill_cfg(300100902).CastTime,
    get_skill_cfg(300100902).AfterTime
  }
  self.skill01 = {
    300100901,
    5,
    ...
    0,
    0,
    get_skill_cfg(300100901).CastTime,
    get_skill_cfg(300100901).AfterTime
  }
  self.control = nil
  self.boom_timer = nil
  self.used_hp = 0
