...
function monster._init(monster, npc)
  ...
  monster.missile_move = 30020400201
  ...
  do
    ...
    _ENV.atk(_ENV.atkMove, _ENV.atkBoom)
    _ENV.atkBoom(_ENV.boomWarning, _ENV.boom)
  end
  ...
  states.atkMove.atkBoom = states.atkBoom
  
  function states.atkMove.finTrans(atkMove)
    return atkMove.atkBoom
  end
  
  function states.boomWarning.isReady(boomWarning)
    if not boomWarning.base.isReady(boomWarning) then
      return false
    end
  ...
  states.boomWarning.boom = states.boom
  
  function states.boomWarning.finTrans(boomWarning)
    return boomWarning.base.finTrans(boomWarning) or boomWarning.boom
  end
