...
function monster._init(monster, npc)
  ...
  do
    ...
    _ENV.specialATK(_ENV.skill1, _ENV.skill2)
  ...
  do
    ...
    function skill1.isReady(skill)
      if check_magic(skill.monster.npc, 2010460101) then
        return false
      end
      return skill.base.isReady(skill1)
    end
    ...
    function monster.states.dashOut.finTrans(dashOut)
      ...
      if Trans > 0.5 then
        dashOut.monster.skills.skill1.timer = 0
  ...
  do
    ...
    function drink.isReady(drink)
      if check_magic(drink.monster.npc, 2010460101) then
        return false
      end
