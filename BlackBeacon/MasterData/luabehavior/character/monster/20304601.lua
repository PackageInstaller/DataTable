...
function monster._init(monster, npc)
  ...
  do
    local dashIn = monster.states.dashIn
    
    function dashIn.start(dashIn)
      local npc = dashIn.monster.npc
      if check_magic(npc, 2030460293) then
        cast_magic(npc, npc, 2030460291, 1)
      else
        cast_magic(npc, npc, 2010460106, 1)
      end
      dashIn.base.start(dashIn)
    end
  end
