...
function M:_init()
  ...
  self.skill02 = {
    ...
    0,
    4,
    get_skill_cfg(20101502).CastTime,
    get_skill_cfg(20101502).AfterTime,
    0
  }
  self.skill01 = {
    20101501,
    ...
    0,
    15,
    get_skill_cfg(20101501).CastTime,
    get_skill_cfg(20101501).AfterTime,
    0
  }
  self.monster_type = 2
  self.wander = {1.7, 0.5}
...
function M:check_wall_dis()
  ...
  if get_npc_distance(self.npc, 3, 3) <= 1 or get_npc_distance(self.npc, 3, 1) <= 1 then
    self.hitwall = true
    self.control = 2
  end
end
...
function M:on_frame()
  ...
  elseif 2 == self.skill_set and self.now_time >= self.skill02[3] then
    if check_npc_distance(self.npc, self.target, 4, false) then
