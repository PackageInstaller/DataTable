  ...
  Steps = {
    ...
    },
    {
      ...
      Background = {
        ...
        IsUseSpine = true,
        BgScale = 0.7,
        BgLoopAnimName = "final",
        InsertAnimList = empty,
        FadeTime = 1.0,
        LocationName = "",
        LocationNameLanguageId = "1001060101_134",
        ExtraBgScale = 1.0
      },
      Talking = {
        Level = 2,
