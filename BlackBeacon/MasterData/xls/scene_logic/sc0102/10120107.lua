      ...
      ConditionActions = {
        {
          ...
          Actions = {
            ...
            },
            {
              ...
              TimelineName = "timeline_sound_10110701",
              IsPlay = true,
              Type = 110,
              Timeout = 0.0
            },
      ...
      Actions = {
        {
          ...
          CustomEventName = "GBOX10103check",
          Type = 19,
          Timeout = 0.0
        },
        {

          CustomEventName = "GBOX10110check",
          Type = 19,
          Timeout = 0.0
        }
      },
