...
local MUSIC_GAME_NODE_ITEM_TEMP_KEY = "MUSIC_GAME_NODE_ITEM_TEMP_KEY"
local MUSIC_GAME_NODE_BASE_ITEM_TEMP_KEY = "MUSIC_GAME_NODE_BASE_ITEM_TEMP_KEY"
local NodeItem = require("uimodule.activity.music_game.music_game_node_item")
...
function ui:ui_finish_load()
  ...
  self:register_exist_auto_template(MUSIC_GAME_NODE_ITEM_TEMP_KEY, self.v_uiobjects.NodeTem, self.v_uiobjects.NodeContent)
...
function ui:init_node_pool()
  self:give_back_auto_cache(MUSIC_GAME_NODE_ITEM_TEMP_KEY)
  self.v_free_node = {}
  self.v_node_pool = {}
  for i = 1, 10 do
    local obj = self:get_auto_cache(MUSIC_GAME_NODE_ITEM_TEMP_KEY)
    local item = NodeItem:ui_wrap_ex(self, obj, false)
    item:set_idx(i)
