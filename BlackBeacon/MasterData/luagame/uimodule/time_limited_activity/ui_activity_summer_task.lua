...
local TASK_ITEM_KEY = "ACTIVITY_SUMMER_TASK_ITEM_KEY"
local TASK_AWARD_ITEM_KEY = "ACTIVITY_SUMMER_TASK_AWARD_ITEM_KEY"
local _insert = table.insert
local CHAPTER_CONFIG = require("uimodule.chapter.chapter_config")
local TASK_TYPE = CHAPTER_CONFIG.SHOW_TASK_TYPE
...
function ui:refresh_weekly_pvp_task()
end
