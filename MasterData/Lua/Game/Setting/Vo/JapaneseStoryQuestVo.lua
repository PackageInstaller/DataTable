...
---@class JapaneseStoryQuestVo
local JapaneseStoryQuestVo = Class("JapaneseStoryQuestVo", SettingRefBase)

---__int
function JapaneseStoryQuestVo:__init()
    self.id = nil              --关卡id
    ...
    self.name = nil              --名称
    self.desc = nil              --描述
    self.type = nil              --剧情类型（ 2剧情+战斗，1纯剧情，3战牌）
    self.battleCardNpcId = nil              --对应战牌关卡id
    self.pic = nil              --插图
...
function JapaneseStoryQuestVo:FillVo(row)
    ...
    self.battleCardNpcId = parse_number(row, "battleCardNpcId")
...
function JapaneseStoryQuestVo:__delete()
    self.id = nil
    self.activityId = nil
    self.placeId = nil
    self.levelName = nil
