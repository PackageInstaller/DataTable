...
---@class Live3dGoodsVo
local Live3dGoodsVo = Class("Live3dGoodsVo", SettingRefBase)

function Live3dGoodsVo:__init()
    self.id = nil           --道具编号
    self.type = nil         --道具类型:
...
function Live3dGoodsVo:FillVo(row)
...
function Live3dGoodsVo:__delete()
    self.id = nil           --道具编号
    self.type = nil         --道具类型:
    self.showType = nil     --显示类型
    self.name = nil         --名字
