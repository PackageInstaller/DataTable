...
---@class DreamAdventuresQuestPlotVo
local DreamAdventuresQuestPlotVo = Class("DreamAdventuresQuestPlotVo", SettingRefBase)

---__int
function DreamAdventuresQuestPlotVo:__init()
    self.id = nil              --关卡id
    self.activityId = nil              --活动id
    self.placeId = nil              --地点id
    self.unlockBossQuestId = nil              --解锁协力战关卡
    self.name = nil              --名称
    self.desc = nil              --描述
...
function DreamAdventuresQuestPlotVo:__delete()
    self.id = nil
    self.activityId = nil
    self.placeId = nil
    self.unlockBossQuestId = nil
    self.name = nil
    self.desc = nil
    self.type = nil
...
return DreamAdventuresQuestPlotVo
