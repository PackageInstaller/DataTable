...
---@class ActivityCakeBossRankVo
local ActivityCakeBossRankVo = Class("ActivityCakeBossRankVo", SettingRefBase)

---__int
function ActivityCakeBossRankVo:__init()
    self.id = nil              --编号
...
function ActivityCakeBossRankVo:FillVo(row)
...
function ActivityCakeBossRankVo:__delete()
    self.id = nil
    self.activityId = nil
    self.upperLimit = nil
    self.lowerLimit = nil
