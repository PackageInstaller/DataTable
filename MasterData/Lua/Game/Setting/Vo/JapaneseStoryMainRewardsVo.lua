...
---@class JapaneseStoryMainRewardsVo
local JapaneseStoryMainRewardsVo = Class("JapaneseStoryMainRewardsVo", SettingRefBase)

---__int
function JapaneseStoryMainRewardsVo:__init()
    self.id = nil              --关卡ID
...
function JapaneseStoryMainRewardsVo:FillVo(row)
...
function JapaneseStoryMainRewardsVo:__delete()
    self.id = nil
...
return JapaneseStoryMainRewardsVo
