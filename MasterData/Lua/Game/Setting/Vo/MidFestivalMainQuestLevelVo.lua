...
---@class MidFestivalMainQuestLevelVo
local MidFestivalMainQuestLevelVo = Class("MidFestivalMainQuestLevelVo", SettingRefBase)

function MidFestivalMainQuestLevelVo:__init()
    self.id                 = nil   --- 关卡id
...
function MidFestivalMainQuestLevelVo:FillVo(row)
...
function MidFestivalMainQuestLevelVo:__delete()
    self.id = nil
    self.placeId = nil
    self.name = nil
    self.desc = nil
...
return MidFestivalMainQuestLevelVo
