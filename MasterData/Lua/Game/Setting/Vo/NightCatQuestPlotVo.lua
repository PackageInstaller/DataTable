...
---@class NightCatQuestPlotVo
local NightCatQuestPlotVo = Class("NightCatQuestPlotVo", SettingRefBase)

---__int
function NightCatQuestPlotVo:__init()
    self.id = nil              --关卡ID
...
function NightCatQuestPlotVo:FillVo(row)
...
function NightCatQuestPlotVo:__delete()
    self.id = nil
    self.chapterId = nil
    self.label = nil
    self.name = nil
