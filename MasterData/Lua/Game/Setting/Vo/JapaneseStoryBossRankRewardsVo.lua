...
---@class JapaneseStoryBossRankRewardsVo
local JapaneseStoryBossRankRewardsVo = Class("JapaneseStoryBossRankRewardsVo", SettingRefBase)

---__int
function JapaneseStoryBossRankRewardsVo:__init()
    self.id = nil              --编号
...
function JapaneseStoryBossRankRewardsVo:FillVo(row)
...
function JapaneseStoryBossRankRewardsVo:__delete()
    self.id = nil
    self.activityId = nil
    self.upperLimit = nil
    self.lowerLimit = nil
...
return JapaneseStoryBossRankRewardsVo
