...
---@class ActivityCakeTaskVo
local ActivityCakeTaskVo = Class("ActivityCakeTaskVo", SettingRefBase)

---__int
function ActivityCakeTaskVo:__init()
    self.id = nil              --任务的ID（20001~29999）
    self.desc = nil              --任务描述
...
function ActivityCakeTaskVo:FillVo(row)
...
function ActivityCakeTaskVo:__delete()
    self.id = nil
    self.desc = nil
    self.unlockId = nil
