...
---@class MidFestivalBossRankRewardVo
local MidFestivalBossRankRewardVo = Class("MidFestivalBossRankRewardVo", SettingRefBase)

---__int
function MidFestivalBossRankRewardVo:__init()
    self.id = nil              --编号
...
function MidFestivalBossRankRewardVo:FillVo(row)
...
function MidFestivalBossRankRewardVo:__delete()
    self.id = nil
    self.activityId = nil
    self.upperLimit = nil
    self.lowerLimit = nil
...
return MidFestivalBossRankRewardVo
