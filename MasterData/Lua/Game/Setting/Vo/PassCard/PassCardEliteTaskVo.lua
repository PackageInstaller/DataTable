...
-- 
-- Create: 2023-11-30 10:54:44
-------------------------------------------------------------------------------


local SettingRefBase = require('Game.Setting.SettingRefBase')
---@class PassCardEliteTaskVo : SettingRefBase @see AutoIds.IdSetting4053
local PassCardEliteTaskVo = Class('PassCardEliteTaskVo', SettingRefBase)


function PassCardEliteTaskVo:__init()
    ---@type integer @ 任务ID
    self.taskId = nil
...
function PassCardEliteTaskVo:__delete()
    self.taskId          = nil
    self.scheduleId      = nil
    self.taskDescr       = nil
    self.unlockType      = nil
...
function PassCardEliteTaskVo:FillVo(row)
