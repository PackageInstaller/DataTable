...
---@class ContractRecallPassCardHomeProductDojo : BaseDojo
---@field New fun():ContractRecallPassCardHomeProductDojo
local ContractRecallPassCardHomeProductDojo = Class('ContractRecallPassCardHomeProductDojo', BaseDojo)


function ContractRecallPassCardHomeProductDojo:__init()
    ---@type integer @ 商品id
    self.productId = 0
...
function ContractRecallPassCardHomeProductDojo:__delete()
    self.productId        = nil
...
function ContractRecallPassCardHomeProductDojo:Fill(jsonData)
