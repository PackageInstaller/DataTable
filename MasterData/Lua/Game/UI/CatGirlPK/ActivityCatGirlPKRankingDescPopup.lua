...
--- from: Assets/BundleResources/Prefabs/ActivityCatGirlPK12003201/ActivityCatGirlPKRankingDescPopup.prefab > name: ActivityCatGirlPKRankingDescPopup

---@class ActivityCatGirlPKRankingDescPopup
---@field Env                           	ActivityCatGirlPKRankingDescPopup 
...
local ActivityCatGirlPKRankingDescPopup = Class('ActivityCatGirlPKRankingDescPopup')
...
function ActivityCatGirlPKRankingDescPopup:__init()
    self.listData = {nodeDataList = {}}
end


function ActivityCatGirlPKRankingDescPopup:__delete()
end


function ActivityCatGirlPKRankingDescPopup:Awake()
...
function ActivityCatGirlPKRankingDescPopup:OnInitialize()
    return CoWaitDo(function()
        ...
        for i, v in ipairs(levelScore) do
            nodeDataList[#nodeDataList+1] = {name = v.name , value = v.voteNum }    
        end
...
function ActivityCatGirlPKRankingDescPopup:OnGetItemByIndex(listView, listIndex)
...
function ActivityCatGirlPKRankingDescPopup:OnFinalize()
    return CoWaitDo(function()
...
return ActivityCatGirlPKRankingDescPopup
