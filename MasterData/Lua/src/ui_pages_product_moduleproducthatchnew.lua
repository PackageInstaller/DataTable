local this = class("moduleProductHatchNew", G_UIModuleBase)
local columnNum = 4
local minLineNum = L_DeviceTpl:getIsPc() and 8 or 7
...
function this:refreshList()
  ...
  if #petEggsList <= 0 then
    self.bind.active_gridEmpty = true
