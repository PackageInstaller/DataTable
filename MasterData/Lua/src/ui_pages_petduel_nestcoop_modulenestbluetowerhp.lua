local this = class("moduleNestBlueTowerHp", G_UIModuleBase)
...
function this:toBind(uiBinding)
  ...
  local addModule = addModuleGeneric(CS.Lens.Gameplay.UI.Nest.Inside.ModuleNestBlueTowerHp, CS.UnityEngine.GameObject)
