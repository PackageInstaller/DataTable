local this = class("moduleKiboArenaScore", G_UIModuleBase)
...
function this:toBind(uiBinding)
  ...
  local addModule = addModuleGeneric(CS.Lens.Gameplay.UI.PetDuelArena.ModuleKiboArenaScore, CS.UnityEngine.GameObject)
