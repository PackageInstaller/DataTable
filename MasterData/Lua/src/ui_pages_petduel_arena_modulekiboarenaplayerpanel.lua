local this = class("moduleKiboArenaPlayerPanel", G_UIModuleBase)
...
function this:toBind(uiBinding)
  ...
  local addModule = addModuleGeneric(CS.Lens.Gameplay.UI.PetDuelArena.moduleKiboArenaPlayerPanel, CS.UnityEngine.GameObject)
