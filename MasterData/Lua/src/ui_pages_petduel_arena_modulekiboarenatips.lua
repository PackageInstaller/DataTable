local this = class("moduleKiboArenaTips", G_UIModuleBase)
...
function this:toBind(uiBinding)
  ...
  local addModule = addModuleGeneric(CS.Lens.Gameplay.UI.PetDuelArena.moduleKiboArenaTips, CS.UnityEngine.GameObject)
