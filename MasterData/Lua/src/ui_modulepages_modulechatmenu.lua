local this = class("moduleChatMenu", G_UIModuleBase)
...
function this.bind()
  return {
    scrollList_type = {
      moduleName = "modulePages/cellChatTypeMenu"
    }
  }
end
...
function this:setType(type)
  if type ~= self.data.selectType then
    L_AudioUtil.playSound("Play_SFX_System_UI_Friends_LeftSwitch_Show")
  end
