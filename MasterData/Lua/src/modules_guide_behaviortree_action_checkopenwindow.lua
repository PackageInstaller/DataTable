local this = L_BevTree:registClass("guide.checkOpenWindow", L_BevTree.action)
...
function this:onPageShowed(pageName)
...
function this:execute()
  if not self.isReverse and L_GuideManager:checkPageOpen(self.windowName) then
    self.result = L_BevTree.taskResult.Success
  end
