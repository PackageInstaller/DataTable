local this = class("moduleMapCommonInfo", G_UIModuleBase)
...
function this:initModule(node)
  ...
  self.bind.show_trace = node.type ~= L_MapConst.mapSievingType.transfer and node.type ~= L_MapConst.mapSievingType.dungeon and node.type ~= L_MapConst.mapSievingType.kiboDuelPvp
  self.bind.show_teleport = node.type == L_MapConst.mapSievingType.transfer or node.type == L_MapConst.mapSievingType.dungeon or node.type == L_MapConst.mapSievingType.kiboDuelPvp
