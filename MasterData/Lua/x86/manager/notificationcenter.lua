...
function var_0_0.RegistListener(arg_1_0, arg_1_1, arg_1_2)
	var_0_0.AllListener[arg_1_1] = var_0_0.AllListener[arg_1_1] or {}
...
function var_0_0.CallUpdateFunc(arg_5_0, arg_5_1, ...)
	for iter_5_0, iter_5_1 in pairs((gameContext:GetAllOpenPage())) do
...
function var_0_0.CallFirstUpdateFunc(arg_6_0, arg_6_1, ...)
	...
	for iter_6_0 = #var_6_0, 1, -1 do
		if var_6_0[iter_6_0][arg_6_1] then
			return var_6_0[iter_6_0][arg_6_1](var_6_0[iter_6_0], ...)
		end
	end
end
