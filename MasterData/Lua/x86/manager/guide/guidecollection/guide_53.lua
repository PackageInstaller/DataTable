...
function Guide_53:CheckGuide()
	...
	local var_1_0 = #CanteenFoodData:GetChooseFoodList()

	var_1_0 = var_1_0 or 0

	if var_1_0 >= DormSkillData:GetCanSignFoodNum() then
		return false
	end
	...
	CommonTools.UniversalSortEx(var_1_1, {
	...
	if #var_1_1 > 0 then
		if CanteenFoodData:CheckIsSignFood(var_1_1[1]) then
			return false
		end

		for iter_1_2, iter_1_3 in ipairs(BackHomeCanteenFoodCfg[var_1_1[1]].ingredient_list) do
