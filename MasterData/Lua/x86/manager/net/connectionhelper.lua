...
function var_0_0:OnTimeOut(arg_1_1)
	print("connection", self, arg_1_1)
...
function var_0_0:OnErrorHandling(arg_3_1, arg_3_2, arg_3_3)
	print("OnErrorHandling", self, arg_3_1, arg_3_2, arg_3_3)

	if arg_3_1 ~= "game" then
		return
	end

	if arg_3_3 ~= nil and (arg_3_3 == "ConnectionReset" or arg_3_3 == "DisconnectByServer" or arg_3_3 == "ConnectionAborted") and var_0_0.DealWithNetError(self, arg_3_1, arg_3_2, arg_3_3) then
		return
	end

	if arg_3_2 < var_0_1 then
		if whereami ~= "battle" and whereami ~= "battleResult" then
			self:ResetReconnectTime()
...
function var_0_0:DealWithNetError(arg_6_1, arg_6_2, arg_6_3)
	if arg_6_3 == "ConnectionReset" or arg_6_3 == "DisconnectByServer" or arg_6_3 == "ConnectionAborted" then
		print("connection:GetSendingPacketNum()", self:GetSendingPacketNum())

		if self:GetSendingPacketNum() > 0 then
			var_0_0.ShowReturnToLoginTip()
...
function var_0_0.ShowReturnToLoginTip(arg_11_0)
	...
	var_11_0.content = GetTips(LoginConst.KICK_REASON[arg_11_0] or "CANNOT_CONNECT_QUIT")

	function var_11_0.OkCallback()
