local CowboyController = class("CowboyController", CustomTrackSceneControllerBase)
...
function CowboyController:OnInit()
	...
	local var_1_0 = math.max(1, Screen.width / Screen.height / 1.77) * var_0_13

	var_0_9.transform.localScale = Vector3.New(var_1_0, var_1_0, var_1_0)
	...
	local var_1_1 = var_0_2.gameObject:GetComponent("ControllerExCollection")

	var_0_21 = var_1_1:GetController("bg")
	var_0_22 = var_1_1:GetController("bgSwitch")
end

function CowboyController:Enter()
	return
end

function CowboyController:Exit()
	return
end

function CowboyController:SwitchBgState(arg_4_1)
	if var_0_21 then
		var_0_21:SetSelectedIndex(arg_4_1)
	end
end

function CowboyController:SwitchBgStageIndex(arg_5_1)
	if var_0_22 then
		var_0_22:SetSelectedIndex(arg_5_1 - 1)
	end
end

function CowboyController:GetPlayableLength()
	return var_0_14:GetDirectorLength()
end

function CowboyController:PlayHeroAnim(arg_7_1, arg_7_2, arg_7_3)
	var_0_14:PlayAnimation(arg_7_1, arg_7_2, arg_7_3)
end

function CowboyController:Restart()
	manager.ui:AddMainCameraCom(typeof(CinemachineBrain))
	manager.ui:SetMainCameraCom("CinemachineBrain", false)
...
function CowboyController:SetPlayerToShowPoint(arg_9_1, arg_9_2)
	if arg_9_2 == 1 then
...
function CowboyController:SwitchToShow(arg_10_1)
	...
	self:SetPlayerToShowPoint("1083ui_dynamic", arg_10_1)
	manager.ui:SetMainCameraCom("CinemachineBrain", true)
end

function CowboyController:ReleaseHero(arg_11_1)
...
function CowboyController:ShowCutScene(arg_12_1)
...
function CowboyController:CloseCutScene()
	if var_0_20 then
		var_0_17:Play("out")
		self:StopCutSceneTimer()
...
function CowboyController:StopCutSceneTimer()
...
function CowboyController:Dispose()
	var_0_23 = false
