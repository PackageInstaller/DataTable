...
function var_0_6:MoveTowards(arg_17_1, arg_17_2)
	if (arg_17_1.x - self.x) * (arg_17_1.x - self.x) + (arg_17_1.y - self.y) * (arg_17_1.y - self.y) > arg_17_2 * arg_17_2 and (arg_17_1.x - self.x) * (arg_17_1.x - self.x) + (arg_17_1.y - self.y) * (arg_17_1.y - self.y) ~= 0 then
		local var_17_0 = arg_17_2 / var_0_0((arg_17_1.x - self.x) * (arg_17_1.x - self.x) + (arg_17_1.y - self.y) * (arg_17_1.y - self.y))

		return var_0_1({
			x = self.x + (arg_17_1.x - self.x) * var_17_0,
			y = self.y + (arg_17_1.y - self.y) * var_17_0
		}, var_0_6)
	end
