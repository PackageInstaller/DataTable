...
function LuaList:Ctor(arg_1_1, arg_1_2, arg_1_3)
	self.uiListGo_ = arg_1_2.gameObject
...
function LuaList:InitUI()
	self.uiList_ = self.uiListGo_:GetComponent("UIList")
...
function LuaList:ItemRenderer(arg_6_1, arg_6_2)
	...
	if self.itemOfInstanceID_[var_6_0] then
		...
		var_6_1 = self.itemClass_.New(arg_6_2)
...
function LuaList:StartScrollWithoutAnimator(arg_19_1, arg_19_2)
	...
	if self.emptyController_ ~= nil then
		self.emptyController_:SetSelectedState(arg_19_1 == 0 and "true" or "false")
	end
...
function LuaList:UpdateUIList(arg_24_1)
	...
	if self.emptyController_ ~= nil then
		self.emptyController_:SetSelectedState(arg_24_1 == 0 and "true" or "false")
	end
end
...
function LuaList:SetLimitMaxDragCount(arg_30_1)
	self.uiList_:SetLimitMaxDragCount(arg_30_1)
end
