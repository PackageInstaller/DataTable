...
function showRewardUI(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_0) do
		...
		if ItemWillConvert(iter_11_1) then
			var_11_4 = iter_11_1.convert_from.id or iter_11_1.id
		end
	...
	if #var_11_1 > 0 then
		gameContext:Go("obtainView", {
			...
			itemList = sortReward4Obtain((formatRewardCfgList(var_11_1))),
...
function rewardSortFunc(arg_15_0, arg_15_1)
	...
	if ItemCfg[arg_15_0.id].rare ~= ItemCfg[arg_15_1.id].rare then
		return ItemCfg[arg_15_1.id].rare < ItemCfg[arg_15_0.id].rare
	end

	if ItemCfg[arg_15_0.id].display_rare ~= ItemCfg[arg_15_1.id].display_rare then
		return ItemCfg[arg_15_1.id].display_rare < ItemCfg[arg_15_0.id].display_rare
	end

	local var_15_1 = ItemCfg[arg_15_0.id].type

	if ItemCfg[arg_15_0.id].type ~= ItemCfg[arg_15_1.id].type then
		return ItemCfg[arg_15_1.id].type < var_15_1
	elseif var_15_1 == ItemConst.ITEM_TYPE.EQUIP then
		local var_15_4 = EquipCfg[arg_15_0.id].starlevel
		local var_15_5 = EquipCfg[var_15_0].starlevel

		if EquipCfg[arg_15_0.id].starlevel == EquipCfg[var_15_0].starlevel then
			return var_15_0 < arg_15_0.id
		else
...
local ItemConst = require("game.const.ItemConst")
local var_0_4 = {
	[ItemConst.ITEM_TYPE.HERO] = 3,
	[ItemConst.ITEM_TYPE.SCENE] = 2,
	[ItemConst.ITEM_TYPE.HERO_SKIN] = 1
}
...
function sortReward4Obtain(arg_17_0)
	...
	for iter_17_0, iter_17_1 in ipairs(arg_17_0) do
		...
		if ItemWillConvert(iter_17_1) then
			var_17_2 = iter_17_1.convert_from.id or iter_17_1.id
		end

		local var_17_3 = ItemCfg[var_17_2]
		local var_17_4

		if ItemCfg[var_17_2].type == ItemConst.ITEM_TYPE.SCENE then
			var_17_4 = SkinCfg[CustomCenterTools.GetMatchSkinByScene((var_17_3.sub_type == ItemConst.ITEM_SUB_TYPE.SCENE_LIMITED or nil) and var_17_3.param[1])].hero
		elseif ItemCfg[var_17_2].type == ItemConst.ITEM_TYPE.HERO_SKIN then
			var_17_4 = SkinCfg[var_17_3.sub_type == ItemConst.ITEM_SUB_TYPE.LIMIT_SKIN and var_17_3.param[1] or var_17_2].hero
		elseif ItemCfg[var_17_2].type == ItemConst.ITEM_TYPE.HERO then
			var_17_4 = var_17_2
		end

		if var_17_4 then
			local var_17_7 = var_17_0[var_17_4] or {}

			table.insert(var_17_7, iter_17_1)

			var_17_0[var_17_4] = var_17_7
		else
	...
	for iter_17_2, iter_17_3 in pairs(var_17_0) do
		table.insert(var_17_8, iter_17_2)
		CommonTools.UniversalSortEx(iter_17_3, {
			map = function(self)
				local var_18_0 = nullable(var_0_4, ItemCfg[(ItemWillConvert(self) or nil) and (self.convert_from.id or self.id)].type)

				var_18_0 = var_18_0 or 0
	...
	for iter_17_4, iter_17_5 in ipairs(var_17_8) do
		for iter_17_6, iter_17_7 in ipairs(var_17_0[iter_17_5]) do
			table.insert(var_17_9, iter_17_7)
		end
	end
...
function getItemStar(arg_19_0)
	...
	if ItemCfg[arg_19_0].type == ItemConst.ITEM_TYPE.EQUIP then
		var_19_0 = EquipCfg[arg_19_0].starlevel
	end
...
local function var_0_5(arg_21_0, arg_21_1)
	if ItemCfg[arg_21_1.id].type == ItemConst.ITEM_TYPE.EQUIP or ItemCfg[arg_21_1.id].type == ItemConst.ITEM_TYPE.WEAPON_SERVANT then
		return false
	elseif arg_21_1.id ~= arg_21_0.id then
		return false
	elseif arg_21_1.time_valid ~= arg_21_0.time_valid then
		return false
...
function IsConditionAchieved(arg_25_0, arg_25_1)
	...
	if ConditionCfg[arg_25_0] == nil then
		return true, 0, 0
	end
	...
	elseif var_25_0.type == 1001 then
		...
		var_25_1 = var_25_0.params[1] <= var_25_2
	...
	elseif var_25_0.type == 1008 then
		...
		if BattleTeachData:GetHeroTeachInfo(arg_25_1.heroId, HeroCfg[arg_25_1.heroId].study_stage[1]) > 0 then
			var_25_2 = 1
			var_25_1 = true
		end
	elseif var_25_0.type == 1009 then
		local var_25_6 = HeroTools.GetExSkillId(arg_25_1.heroId)

		var_25_2 = HeroTools.GetSkillLv(arg_25_1.heroId, var_25_6) + HeroTools.GetHeroSkillAddLevel(HeroData:GetHeroData(arg_25_1.heroId), var_25_6)
		var_25_3 = var_25_0.params[1]
		var_25_1 = var_25_0.params[1] <= var_25_2
	...
	elseif var_25_0.type == 1011 or var_25_0.type == 5002 then
		var_25_2 = BattleStageData:GetStageData()[var_25_0.params[1]] and BattleStageData:GetStageData()[var_25_0.params[1]].clear_times > 0 and 1 or 0
		var_25_3 = 1
		var_25_1 = 1 <= var_25_2
	elseif var_25_0.type == 1012 then
		local var_25_7 = ArchiveData:GetArchive((HeroTools.GetHeroOntologyID(arg_25_1.heroId))).lv

		var_25_1 = var_25_3 <= var_25_7
		var_25_2 = var_25_7
	elseif var_25_0.type == 1013 then
		local var_25_8 = HeroTools.GetHeroOntologyID(arg_25_1.heroId)

		var_25_2 = ArchiveData:GetArchive(var_25_8).gift_list[HeroRecordCfg[var_25_8].gift_like_id1[1]] or 0
	...
	elseif var_25_0.type == 1015 then
		local var_25_9 = HeroData:GetHeroData(var_25_0.params[1])

		var_25_2 = var_25_9 and var_25_9.level or 0
		var_25_3 = var_25_0.params[2]
		var_25_1 = var_25_0.params[2] <= var_25_2
	elseif var_25_0.type == 1016 then
		local var_25_10 = ArchiveData:GetArchive((HeroTools.GetHeroOntologyID(arg_25_1.heroId))).lv

		var_25_1 = var_25_3 <= var_25_10
		var_25_2 = var_25_10
	elseif var_25_0.type == 1017 then
		var_25_3 = 1

		if HeroTools.IsSkinUnlock(var_25_0.params[1]) and HomeSceneSettingData:IsHaveScene(var_25_0.params[2]) then
			var_25_2 = 1
			var_25_1 = true
		end
	elseif var_25_0.type == 1018 then
		...
		if HeroTools.IsSkinUnlock(var_25_0.params[1]) then
			var_25_2 = 1
			var_25_1 = true
		end
	elseif var_25_0.type == 1019 then
		local var_25_11 = ArchiveData:GetTrustLevel(arg_25_1.heroId)

		var_25_1 = var_25_3 <= var_25_11
		var_25_2 = var_25_11
	elseif var_25_0.type == 1023 then
		var_25_1 = OathTools.IsOath(var_25_0.params[1]) and HeroTools.GetHasOwnedSkin(var_25_0.params[2]) and ShopTools.CheckDlcPurchased(var_25_0.params[3])
		var_25_3 = 1
	...
	elseif var_25_0.type == 1027 then
		var_25_2 = ArchiveData:GetArchive((HeroTools.GetHeroOntologyID(var_25_0.params[1]))).lv
		var_25_3 = var_25_0.params[2]
		var_25_1 = var_25_0.params[2] <= var_25_2
	elseif var_25_0.type == 1028 then
		local var_25_12 = HeroTools.GetHeroOntologyID(var_25_0.params[1])

		var_25_2 = ArchiveData:GetTrustLevel(var_25_0.params[1])
		var_25_3 = var_25_0.params[2]
		var_25_1 = var_25_0.params[2] <= var_25_2
	elseif var_25_0.type == 1101 then
		var_25_2 = nullable(ShopData.GetGoodInfo(var_25_0.params[1], var_25_0.params[2]), "buy_times") or 0

		return var_25_2 >= var_25_0.params[3], var_25_2, var_25_0.params[3]
	elseif var_25_0.type == 1102 then
		return TowerData:CheckIsOverStage(var_25_0.params[1], var_25_0.params[2])
	...
	elseif var_25_0.type == 5001 then
		local var_25_13 = HeroTools.GetHeroOntologyID(var_25_0.params[1])

		for iter_25_2, iter_25_3 in ipairs(HeroRecordCfg[var_25_13].plot_id) do
			if not ArchiveData:IsStoryRead(var_25_13, iter_25_3) then
				return false
			end
		end
	...
	elseif var_25_0.type == 8021 then
		var_25_2 = DormRoomTools:GetGiftNumByRoomID((DormRoomTools:GetDormIDViaArchive((HeroTools.GetHeroOntologyID(arg_25_1.heroId))))) or 0
		var_25_1 = var_25_3 <= var_25_2
	elseif var_25_0.type == 8022 then
		var_25_2 = DormHeroTools:GetDormLevelByHeroID((HeroTools.GetHeroOntologyID(arg_25_1.heroId)))
		var_25_1 = var_25_3 <= var_25_2
	elseif var_25_0.type == 8023 then
		local var_25_14 = DormData:GetHeroTemplateInfo(arg_25_1.heroId)

		var_25_2 = var_25_14 and (var_25_14:GetHeroTotalFeedTime() or 0) or 0
		var_25_1 = var_25_3 <= var_25_2
	...
	elseif var_25_0.type == 11502 then
		...
		for iter_25_6, iter_25_7 in pairs((MonsterCosplayData:GetDataByPara("monsterData"))) do
			if iter_25_7.finishedStage[var_25_0.params[1]] then
				var_25_16 = true
			end
		end

		return var_25_16, var_25_2, 1
	elseif var_25_0.type == 11802 then
		local var_25_17 = QWorldQuestData:GetMainQuestData(var_25_0.params[1])

		if var_25_17 and var_25_17.status == QWorldQuestConst.MAIN_QUEST_STATUS.FINISH then
			return true, 1, 1
		else
			return false, 0, 1
		end
	elseif var_25_0.type == 11901 then
		if TetrisGameTools:CheckIsFinishChapter(var_25_0.params[2][1]) then
			return true
		else
			return false
		end
	elseif var_25_0.type == 11902 then
		local var_25_18 = TetrisGameData:GetStageInfoByStageID(var_25_0.params[2][1][1])

		if var_25_18 and var_25_18.isClear == true and var_25_0.params[2][1][2] <= var_25_18.topScore then
			return true
		else
			return false
		end
	elseif var_25_0.type == 11903 then
		local var_25_19 = TetrisGameData:GetStageInfoByStageID(var_25_0.params[2])

		if var_25_19 and var_25_19.isClear == true and TetrisGameTools:IsUseSkillClear(var_25_0.params[2], var_25_0.params[3]) then
			return true
		else
			return false
		end
	elseif var_25_0.type == 12001 then
		var_25_2 = ChallengeRogueTeamData:GetHistoryDifficultyClearCnt(var_25_0.params[1], var_25_0.params[2])
	...
	elseif var_25_0.type == 12003 then
		local var_25_20 = var_25_0.params[2]
		local var_25_21 = 0

		for iter_25_8, iter_25_9 in ipairs((ChallengeRogueTeamData:GetHeroTeamProxy():GetHeroIDList())) do
			if iter_25_9 ~= 0 then
				if HeroCfg[iter_25_9].ATK_attribute[1] == var_25_0.params[1] or HeroCfg[iter_25_9].ATK_attribute[1] == HeroConst.HERO_ATTACK_TYPE.RANDOM then
					var_25_21 = var_25_21 + 1
				end
			end
		end

		return var_25_20 <= var_25_21
	...
	elseif var_25_0.type == 12201 then
		local var_25_23 = var_25_0.params[2] or nil

		if HeroTools.GetHasOwnedSkin(var_25_0.params[1]) then
			var_25_2 = 1
			var_25_1 = true
		end

		if var_25_1 == false and var_25_23 then
			local var_25_24 = ItemTools.getItemNum(var_25_23)

			if var_25_24 and var_25_24 > 0 then
				var_25_2 = 1
				var_25_1 = true
			end
		end
	...
	elseif var_25_0.type == 12601 then
		local var_25_25 = ChapterV2MapTools.GetMapTimestamp(var_25_0.params[1])

		var_25_2 = (var_25_0.params[2] <= var_25_25 or var_25_25 <= var_25_0.params[3]) and 1 or 0
		var_25_3 = 1
		var_25_1 = 1 <= var_25_2
	elseif var_25_0.type == 12602 then
		var_25_2 = 0

		for iter_25_10, iter_25_11 in ipairs(var_25_0.params) do
			if ChapterV2MapTools.IsEventCompleted(iter_25_11) then
				var_25_2 = var_25_2 + 1
			end
		end

		var_25_3 = #var_25_0.params
		var_25_1 = #var_25_0.params <= var_25_2
	elseif var_25_0.type == 12604 then
		var_25_2 = 0

		for iter_25_12, iter_25_13 in ipairs(var_25_0.params) do
	...
	elseif var_25_0.type == 12605 then
		local var_25_26 = ChapterV2MapTools.GetMapTimestamp(var_25_0.params[1])

		var_25_2 = (var_25_0.params[2] <= var_25_26 or var_25_26 <= var_25_0.params[3]) and 1 or 0
		var_25_3 = 1
		var_25_1 = 1 <= var_25_2
	elseif var_25_0.type == 12606 then
		var_25_2 = 0

		for iter_25_14, iter_25_15 in ipairs(var_25_0.params) do
	...
	elseif var_25_0.type == 330000 then
		var_25_3 = 1
		var_25_1 = OathTools.IsOath(var_25_0.params[1])
		var_25_2 = var_25_1 and 1 or 0
	elseif var_25_0.type == 330001 then
		local var_25_27 = var_25_0.params[2] or 1

		var_25_2 = ItemTools.getItemNum(var_25_0.params[1])
		var_25_3 = var_25_27
		var_25_1 = var_25_27 <= var_25_2
	elseif var_25_0.type == 330002 then
		local var_25_28 = var_25_0.params[2] or 0

		var_25_2 = OathCollectionContentData:GetOathLevel(var_25_0.params[1])
		var_25_3 = var_25_28
		var_25_1 = var_25_28 <= var_25_2
	elseif var_25_0.type == 330003 then
		local var_25_29 = HeroTools.GetHeroIsUnlock(var_25_0.params[1])

		var_25_2 = var_25_29 and 1 or 0
		var_25_3 = 1
		var_25_1 = var_25_29 or var_25_1
	end
...
function isMeetCondition(arg_28_0)
	...
	elseif arg_28_0[1] == 102 then
		return ChapterTools.IsClearChapter(arg_28_0[2])
	else
		return false
	end
end
...
function getConditionText(arg_29_0)
	if arg_29_0[1] == 101 then
		return string.format(GetTips("NOTE_TASK_UNLOCK"), GetI18NText(BattleStageTools.GetStageCfg(ChapterCfg[getChapterIDByStageID(arg_29_0[2])].type, arg_29_0[2]).name))
...
function isBagFull(arg_31_0)
	for iter_31_0, iter_31_1 in pairs(arg_31_0) do
		if ItemCfg[iter_31_1[1]].type == ItemConst.ITEM_TYPE.EQUIP and EquipTools.GetEquipNum() >= GameSetting.max_equip.value[1] then
			return true
		end
	end
...
function isOpenMission(arg_42_0)
	...
	if ChapterTools.IsFinishPreChapter((getChapterIDByStageID(arg_42_0))) and var_42_0[arg_42_0] then
...
function getMaxOpenSection(arg_43_0)
	...
	for iter_43_0 = ChapterCfg[var_43_0].difficulty, 1, -1 do
		...
		for iter_43_1 = table.keyof(var_43_1, var_43_0), 1, -1 do
			for iter_43_2 = table.keyof(ChapterCfg[var_43_1[iter_43_1]].section_id_list, arg_43_0) or #ChapterCfg[var_43_1[iter_43_1]].section_id_list, 1, -1 do
				if isOpenMission(ChapterCfg[var_43_1[iter_43_1]].section_id_list[iter_43_2]) then
					return ChapterCfg[var_43_1[iter_43_1]].section_id_list[iter_43_2], var_43_1[iter_43_1]
				end
			end
		end
	end
...
function getAffixName(arg_46_0)
	if arg_46_0[1] == nil then
		return ""
	end

	if AffixTypeCfg[arg_46_0[1]] == nil then
		-- block empty
	end

	return GetI18NText(AffixTypeCfg[arg_46_0[1]].name)
end

function getAffixDesc(arg_47_0)
	if arg_47_0[1] == nil then
		return ""
	end

	if AffixTypeCfg[arg_47_0[1]] == nil then
		-- block empty
	end

	return GetI18NText((GetCfgDescription(AffixTypeCfg[arg_47_0[1]].description[1], arg_47_0[2])))
end

function getAffixSprite(arg_48_0)
	if arg_48_0[1] == nil then
		return ""
	end

	local var_48_0 = AffixTypeCfg[arg_48_0[1]]

	if AffixTypeCfg[arg_48_0[1]] == nil then
		-- block empty
	end

	local var_48_1 = PublicBuffCfg[var_48_0.affix_buff_id].icon

	if PublicBuffCfg[var_48_0.affix_buff_id].icon == "" then
		Debug.Log(string.format("PublicBuffCfg[%s].icon没有值", var_48_0.affix_buff_id))
	end

	return getSpriteWithoutAtlas(SpritePathCfg.AffixIcon.path .. var_48_1)
end
...
function getEquipSkillSprite(arg_49_0)
	...
	if EquipSkillCfg[arg_49_0] == nil then
		-- block empty
	end

	return getSpriteWithoutAtlas("TextureConfig/Equip/EquipSkillIcon/" .. EquipSkillCfg[arg_49_0].icon)
end

function getAttributeAffix(arg_50_0, arg_50_1)
	local var_50_0 = clone(EquipBreakThroughMaterialItemCfg[arg_50_0].params)

	var_50_0[2] = arg_50_1 > PublicBuffCfg[AffixTypeCfg[var_50_0[1]].buffid[1]].max_level and PublicBuffCfg[AffixTypeCfg[var_50_0[1]].buffid[1]].max_level or arg_50_1

	return var_50_0
end

function getAttributeAffixValue(arg_51_0, arg_51_1)
	local var_51_0 = PublicBuffCfg[AffixTypeCfg[clone(EquipBreakThroughMaterialItemCfg[arg_51_0].params)[1]].buffid[1]]

	if arg_51_1 > var_51_0.max_level then
		arg_51_1 = var_51_0.max_level
	end

	return var_51_0.buffparam_base[2] + var_51_0.buffparam_factor[2] * (arg_51_1 - 1)
end

function MergeActivityID(arg_52_0, arg_52_1)
	if arg_52_0 then
		if ActivityCfg[arg_52_0] and ActivityCfg[arg_52_0].activity_template == ActivityTemplateConst.STORY_STAGE then
		...
		elseif ActivityCfg[arg_52_0] and ActivityCfg[arg_52_0].activity_template == ActivityTemplateConst.ACTIVITY_AFFIX_SELECT_SUBMODULE then
...
function GetTrialHeroList(arg_53_0, arg_53_1, arg_53_2)
	if arg_53_0 == BattleConst.STAGE_TYPE_NEW.STAGE_TYPE_PLOT or arg_53_0 == BattleConst.STAGE_TYPE_NEW.STAGE_TYPE_SUB_PLOT then
		local var_53_0 = ChapterCfg[getChapterIDByStageID(arg_53_1)]

		if var_53_0.activity_id ~= 0 and ActivityTools.GetActivityStatus(var_53_0.activity_id) ~= 1 then
			return {}
		end

		return (type(var_53_0.trial_list) == "table" or nil) and (var_53_0.trial_list or {})
	end

	if arg_53_0 == BattleConst.STAGE_TYPE_NEW.STAGE_TYPE_CHESS then
		if GetChessLevelIDByStageID(arg_53_1) then
			local var_53_1 = WarchessLevelCfg[GetChessLevelIDByStageID(arg_53_1)]

			return (type(var_53_1.trial_list) == "table" or nil) and (var_53_1.trial_list or {})
		else
			return {}
		end
	end
	...
	if arg_53_0 == BattleConst.STAGE_TYPE_NEW.STAGE_TYPE_NEWWARCHESS then
		...
		for iter_53_0, iter_53_1 in pairs((NewWarChessData:GetHeroInfoList())) do
			if iter_53_1[2] > 0 then
				table.insert(var_53_2, NewWarChessHeroCfg[iter_53_1[1]].temp_id)
			end
		end
	...
	if arg_53_0 == BattleConst.STAGE_TYPE_NEW.DESTROY_BOX_GAME then
		return DestroyBoxGameCfg[DestroyBoxGameData:GetSelectID(DestroyBoxGameCfg[DestroyBoxGameCfg.get_id_list_by_activity_id[arg_53_2][1]].main_activity_id)].trial_hero
	end
	...
	if arg_53_0 == BattleConst.STAGE_TYPE_NEW.HODUR_BATTLE then
		if HodurTools.CheckSpecialAffix() then
			...
			local var_53_3 = BattleTeamData:GetHeroTrial((GetHeroTeamActivityID(arg_53_0, arg_53_2, true)))

			var_53_3 = var_53_3 or {}
	...
	local var_53_4 = BattleTeamData:GetHeroTrial((GetHeroTeamActivityID(arg_53_0, arg_53_2, true)))

	var_53_4 = var_53_4 or {}

	return var_53_4
end

function SetHeroTeam(arg_54_0, arg_54_1, arg_54_2, arg_54_3, arg_54_4, arg_54_5, arg_54_6, arg_54_7, arg_54_8, arg_54_9)
	ReserveTools.SetTeam(ReserveParams.New(nil, arg_54_7, arg_54_8, {
		stageType = arg_54_0,
		stageID = arg_54_1,
		activityID = arg_54_2
	}), arg_54_3, arg_54_4, arg_54_5, arg_54_6.mimir_id or 0, arg_54_6.chip_list or {}, arg_54_9 or 0)
end
...
function GetLocalHeroTeam(arg_56_0, arg_56_1, arg_56_2, arg_56_3, arg_56_4)
	...
	elseif BattleConst.STAGE_TYPE_NEW.STRATEGY_MATRIX == arg_56_0 then
		...
		return ReserveTools.GetHeroList((ReserveParams.New(nil, arg_56_3, arg_56_4, {
			stageType = arg_56_0,
			stageID = arg_56_1,
			activityID = arg_56_2
		})))
...
function TableTo2DArray(arg_84_0, arg_84_1)
	...
	for iter_84_0 = 1, #arg_84_0 do
		local var_84_2 = System.Array.CreateInstance(var_84_0, #arg_84_0[iter_84_0])

		for iter_84_1 = 1, #arg_84_0[iter_84_0] do
			var_84_2[iter_84_1 - 1] = arg_84_0[iter_84_0][iter_84_1]
		end

		var_84_1[iter_84_0 - 1] = var_84_2
	end
...
function StartGuildActivity(arg_91_0)
	...
	local var_91_0 = arg_91_0 ~= nil and arg_91_0 > 0 and table.indexof(ActivityClubMapCfg.all, ActivityClubCfg[arg_91_0].map_id) or 1
...
function StartGuildActivitySP(arg_97_0)
	...
	local var_97_0 = arg_97_0 ~= nil and arg_97_0 > 0 and table.indexof(ActivityClubSPMapCfg.get_id_list_by_activity[GuildActivitySPData:GetCurRunActivityID()], ActivityClubSPCfg[arg_97_0].map_id) or 1
...
function getRewardFromDropCfg(arg_103_0, arg_103_1)
	...
	return (sortReward((mergeReward(var_103_1))))
end
...
function checkGold(arg_104_0, arg_104_1)
	...
	if arg_104_0 > ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_GOLD) then
		if arg_104_1 then
			...
			for iter_104_0, iter_104_1 in ipairs(ItemCfg.get_id_list_by_sub_type[ItemConst.ITEM_SUB_TYPE.PROPS_BOND] or {}) do
...
function checkMaterial(arg_105_0, arg_105_1)
	...
	for iter_105_0, iter_105_1 in ipairs(arg_105_0) do
		if iter_105_1[2] > ItemTools.getItemNum(iter_105_1[1]) then
			if arg_105_1 then
...
function setTextColor(arg_108_0, arg_108_1, arg_108_2, arg_108_3, arg_108_4)
	...
	return arg_108_4(arg_108_2, arg_108_3) and string.format("<color=#%s>" .. arg_108_2 .. "</color>", arg_108_0) or string.format("<color=#%s>" .. arg_108_2 .. "</color>", arg_108_1)
end
...
function GetMonsterName(arg_113_0)
	...
	for iter_113_0, iter_113_1 in pairs(arg_113_0) do
		var_113_0 = var_113_0 == nil and GetI18NText(CharactorParamCfg[iter_113_1].Name) or var_113_0 .. "&" .. string.match(GetI18NText(CharactorParamCfg[iter_113_1].Name), "<.*>")
	end
...
function SetFile(arg_115_0, arg_115_1, arg_115_2, arg_115_3)
	...
	for iter_115_0 in string.gmatch(arg_115_2, "[^/]+$") do
		var_115_1 = iter_115_0
	end

	if PlayerPrefs.GetString("naive_angle_mode_key", "naive") ~= "" and VideoTrackCfg[var_115_1] and VideoTrackCfg[var_115_1].has_non_native == 1 then
