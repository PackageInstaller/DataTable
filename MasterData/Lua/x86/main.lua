...
function PrepareAdaptData()
	ReduxView.NEED_ADAPT = _G.SCREEN_WIDTH / _G.SCREEN_HEIGHT > ReduxView.ADAPT_RAITO
end

function DeploySetting(arg_5_0)
	if GameToSDK.PLATFORM_ID == 3 then
		Screen.SetResolution(arg_5_0.pic.pc_resolution[1], arg_5_0.pic.pc_resolution[2], Screen.fullScreenMode)
	else
		local var_5_2, var_5_3 = SettingTools.GetSettingScreenSize((tonumber(arg_5_0.pic.resolution)))

		Screen.SetResolution(var_5_2, var_5_3, true)
	end
	...
	UnityEngine.Pipelines.SimPipeline.SimPipelineSettings.AliasingEnable = PlayerPrefs.GetInt("allowMSAA") ~= 0
	Application.targetFrameRate = nullable(SettingConst.TARGET_FRAME_RATE, arg_5_0.pic.frame) or 60
...
function EnterGame()
	...
	_G.gameContext = GameContext.New(RoutesConfig, {
		"home"
	})
	...
	_G.AnalyticsPresetProperties = cjson.decode(_G.AnalyticsPresetProperties)
...
function GetHomeMusicID()
	...
	if SettingData:GetHomeSceneSettingData().home_scene_scene_bgm == 1 then
		local var_10_1 = HomeSceneSettingCfg[manager.loadScene:GetTimeSceneID(HomeSceneSettingData:GetCurScene())]

		if var_10_1.default_music ~= 0 and table.indexof(var_10_1.scene_setting, HomeSceneSettingConst.SETTING.SCENE_BGM) then
			var_10_0 = var_10_1.default_music
		end
	end
...
function PlayGameSetBGM()
	return PlayGameBGMID((GetHomeMusicID()))
end
...
function PlayGameBGMID(arg_12_0)
	...
	if not MusicRecordCfg[arg_12_0] then
		return nil
	end

	for iter_12_0, iter_12_1 in pairs((MusicData:GetAisacSet(arg_12_0))) do
...
function LateInitData()
	...
	local var_20_1 = manager.time:GetNextTime(GameSetting.refresh_time1.value[1][1], 0, 0)
	local var_20_2 = TimeMgr.GetInstance():GetNextWeekTime(1, GameSetting.refresh_time1.value[1][1], 0, 0)
...
function GetTips(arg_23_0)
	...
	if var_23_0 and TipsCfg[var_23_0] then
		var_23_1 = TipsCfg[var_23_0] and GetI18NText(TipsCfg[var_23_0].desc) or GetTips("ERROR_CODE") .. var_23_0
...
function GetTipsF(arg_24_0, ...)
	...
	return string.format(var_24_0, unpack({
		...
	})), var_24_1
end
...
function ShowPopItem(arg_41_0, arg_41_1, arg_41_2, arg_41_3)
	...
	local var_41_1 = deepClone(arg_41_1)

	var_41_1.grayFlag = false

	if ItemCfg[arg_41_1.id].type == ItemConst.ITEM_TYPE.EQUIP then
		local var_41_2

		if arg_41_2 then
			var_41_2 = arg_41_2.page or 1

			local var_41_3

			if var_41_1.equip_id and var_41_1.equip_id ~= 0 then
				var_41_3 = var_41_1.equip_id or nil
			end
		end
	...
	elseif ItemCfg[arg_41_1.id].type == ItemConst.ITEM_TYPE.WEAPON_SERVANT then
		...
		elseif whereami ~= "home" then
			...
			ShowPopItemOnly(arg_41_0, var_41_1, arg_41_2)
		end
	elseif ItemCfg[arg_41_1.id].type == ItemConst.ITEM_TYPE.DORM_FURNITURE then
...
function ShowPopItemSource(arg_43_0, arg_43_1, arg_43_2)
	...
	var_43_1.equip_info = EquipStruct.New(0, arg_43_0)
	var_43_1.suitID = arg_43_2

	JumpTools.OpenPageByJump("popEquipSourceView", var_43_1)
end
...
function OnAppFocusPauseStateChange(arg_57_0, arg_57_1)
	local var_57_0 = var_0_6

	var_0_5 = arg_57_0
	var_0_6 = arg_57_1

	if (var_57_0 == false and arg_57_1 == true or var_0_5 == true and arg_57_0 == false) and var_57_0 == false and arg_57_1 == true then
		GameToSDK.UpUserEvent("{\"eventType\" : \"End\"}")
		FatigueReminder()
	...
	if var_57_0 == true and arg_57_1 == false then
...
function CanteenFullReminder()
	...
	if var_58_0 ~= nil then
		if (var_58_0.canteen_full_reminder or 0) == 1 then
...
function CanteenDispatchReminder()
	...
	if var_59_0 ~= nil then
		if (var_59_0.canteen_dispatch_reminder or 0) == 1 then
...
function CatExploreReminder()
	...
	if var_60_0 ~= nil then
		if (var_60_0.cat_explore_reminder or 0) == 1 then
...
function DailyFatigueReminder()
	...
	if var_61_0 ~= nil then
		if (var_61_0.daily_fatigue_reminder or 0) == 1 then
...
function FatigueReminder()
	...
	if var_62_0 ~= nil then
		if (var_62_0.fatigue_full_reminder or 0) == 1 and CurrencyData:GetFatigueCallFlag() == 1 then
...
function SpliceI18NText(arg_72_0)
	...
	local var_72_0 = arg_72_0[1]

	for iter_72_0 = 2, #arg_72_0 do
		var_72_0 = string.format("%s%s%s", var_72_0, (SettingData:GetCurrentLanguage() == "en" or nil) and " ", arg_72_0[iter_72_0])
	end
