...
function var_0_0:GetRenderController(arg_2_1)
	local var_2_0 = self:GetRenderControllerByClassName(AutoChessConst.ACTION_RENDER_CONTROLLER_CONFIG[arg_2_1].controllerClassName)

	var_2_0:Init(AutoChessBattleRenderer.GetInstance():GetSpeed())

	return var_2_0
end

function var_0_0:GetRenderControllerByClassName(arg_3_1)
...
function var_0_0:RetureRenderController(arg_4_1)
