local DormMypraiseModule = class("DormMypraiseModule", ReduxView)

function DormMypraiseModule:OnCtor(arg_1_1)
...
function DormMypraiseModule:InitBtnController(arg_2_1, arg_2_2)
...
function DormMypraiseModule:Refresh(arg_5_1)
	if arg_5_1 then
...
function DormMypraiseModule:SwitchMode(arg_6_1, arg_6_2)
	self.mode = arg_6_1

	DormVisitTools:SetListIndex(3, arg_6_1)
	self:SwitchBtnController(arg_6_1)
	self:RefreshList(arg_6_2)
end

function DormMypraiseModule:AddListener()
...
function DormMypraiseModule:RefreshList(arg_13_1)
	if self.mode == "dance" then
		self.listController:SetSelectedState("dance")
		IdolTraineeTools.FetchSharedDIY(arg_13_1, IdolTraineeConst.shareCategory.History, function(arg_14_0)
		...
		if arg_13_1 then
			...
			local var_13_0 = DormVisitTools:GetTemplateExhibitList(3)
...
function DormMypraiseModule:RefreshDanceList(arg_15_1)
...
function DormMypraiseModule:indexTemplate(arg_16_1, arg_16_2)
	arg_16_2:RefreshUI(self.visitList[arg_16_1], 3)
end

function DormMypraiseModule:RenderDanceDIYDataItem(arg_17_1, arg_17_2)
...
function DormMypraiseModule:OnAllBtnClick()
	self:SwitchMode("all")
end

function DormMypraiseModule:OnPublicBtnClick()
	self:SwitchMode("public")
end

function DormMypraiseModule:OnPrivateBtnClick()
	self:SwitchMode("private")
end

function DormMypraiseModule:OnRefreshBtnClick()
	self:RefreshList(true)
end

function DormMypraiseModule:OnDanceBtnClick()
	self:SwitchMode("dance")
end

function DormMypraiseModule:Show()
	DormVisitTools:SetListIndex(3)
...
function DormMypraiseModule:Hide()
...
function DormMypraiseModule:Dispose()
	self.scrollHelper_:Dispose()
	self.danceShareList:Dispose()
	DormMypraiseModule.super.Dispose(self)
end

return DormMypraiseModule
