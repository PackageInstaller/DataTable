local StrategyMatrixProcessSelectHeroView = class("StrategyMatrixProcessSelectHeroView", MatrixProcessSelectHeroView)

function StrategyMatrixProcessSelectHeroView:OnEnter()
	self.matrix_activity_id = self.params_.matrix_activity_id

	StrategyMatrixProcessSelectHeroView.super.OnEnter(self)
end

function StrategyMatrixProcessSelectHeroView:OnRewardAction()
...
function StrategyMatrixProcessSelectHeroView:GetHeroData(arg_5_1)
	return StrategyMatrixData:GetHeroDataNew(arg_5_1)
end

function StrategyMatrixProcessSelectHeroView:GetMatrixHeroTeam()
	return StrategyMatrixData:GetMatrixHeroTeam(self.matrix_activity_id)
end

function StrategyMatrixProcessSelectHeroView:GetHeroEquipMaxCount()
	return StrategyMatrixData:GetHeroEquipMaxCount(self.matrix_activity_id)
end

return StrategyMatrixProcessSelectHeroView
