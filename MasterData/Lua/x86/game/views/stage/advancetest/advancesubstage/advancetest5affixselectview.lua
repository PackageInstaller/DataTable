local AdvanceTest5AffixSelectView = class("AdvanceTest5AffixSelectView", ReduxView)

function AdvanceTest5AffixSelectView:UIName()
	return "Widget/System/AdvanceTest/AdvanceTest_StageType5UI"
end

function AdvanceTest5AffixSelectView:UIParent()
	return manager.ui.uiMain.transform
end

function AdvanceTest5AffixSelectView:Init()
	self:InitUI()
	self:AddUIListener()
end

function AdvanceTest5AffixSelectView:InitUI()
	self:BindCfgUI()

	self.showTipController = self.controller_:GetController("showTips")
	self.buffList = LuaList.New(handler(self, self.IndexBuffItem), self.bufflList_, AdvanceTest5AffixSelectItem)
	self.deBuffList = LuaList.New(handler(self, self.IndexDeBuffItem), self.debuffList_, AdvanceTest5AffixSelectItem)
	self.clickAffixHandler = handler(self, self.ClickAffix)
	self.selectAffixHandler = handler(self, self.SelectAffix)
end

function AdvanceTest5AffixSelectView:AddUIListener()
...
function AdvanceTest5AffixSelectView:OnTop()
...
function AdvanceTest5AffixSelectView:OnEnter()
	...
	self.maxCost = GameSetting.test_challenge_core_mode2_cost_num.value[1]
...
function AdvanceTest5AffixSelectView:OnExit()
...
function AdvanceTest5AffixSelectView:RecordSelect()
	local var_12_0 = {}
...
function AdvanceTest5AffixSelectView:Dispose()
	self.buffList:Dispose()
	self.deBuffList:Dispose()
	AdvanceTest5AffixSelectView.super.Dispose(self)
end

function AdvanceTest5AffixSelectView:RefreshUI(arg_14_1)
	local var_14_0 = 100
	local var_14_1 = 0
	...
	for iter_14_0, iter_14_1 in pairs(self.select_affix) do
		...
		var_14_1 = var_14_1 + ActivityAffixPoolCfg[((var_14_2 == 0 or nil) and (self.affix_buff or self.affix_debuff))[iter_14_1 % 100][1]].point

		if var_14_2 == 1 then
			var_14_0 = var_14_0 + ActivityAffixPoolCfg[((var_14_2 == 0 or nil) and (self.affix_buff or self.affix_debuff))[iter_14_1 % 100][1]].point * 10
		end
	end
	...
	self.limitNumText_.text = var_14_1 .. "/" .. self.maxCost
end

function AdvanceTest5AffixSelectView:ShowTipsView(arg_15_1)
...
function AdvanceTest5AffixSelectView:IndexBuffItem(arg_16_1, arg_16_2)
...
function AdvanceTest5AffixSelectView:IndexDeBuffItem(arg_17_1, arg_17_2)
...
function AdvanceTest5AffixSelectView:IndexSelectItem(arg_18_1, arg_18_2)
...
function AdvanceTest5AffixSelectView:ClickAffix(arg_19_1, arg_19_2, arg_19_3)
...
function AdvanceTest5AffixSelectView:SelectAffix(arg_20_1, arg_20_2)
	local var_20_0 = arg_20_2 * 100 + arg_20_1
	local var_20_1 = table.indexof(self.select_affix, arg_20_2 * 100 + arg_20_1)

	if var_20_1 then
		table.remove(self.select_affix, var_20_1)
		self:RefreshUI()
	else
		local var_20_2 = 0

		for iter_20_0, iter_20_1 in pairs(self.select_affix) do
			local var_20_4 = ((math.floor(iter_20_1 / 100) == 0 or nil) and (self.affix_buff or self.affix_debuff))[iter_20_1 % 100][2]

			var_20_2 = var_20_2 + ActivityAffixPoolCfg[((math.floor(iter_20_1 / 100) == 0 or nil) and (self.affix_buff or self.affix_debuff))[iter_20_1 % 100][1]].point
		end

		if var_20_2 + ActivityAffixPoolCfg[((arg_20_2 == 0 or nil) and (self.affix_buff or self.affix_debuff))[arg_20_1][1]].point > self.maxCost then
			ShowTips("CORE_VERIFICATION_CL_COST_OVERLIMIT")

			return
		end

		table.insert(self.select_affix, var_20_0)
		self:RefreshUI()
	end
end

return AdvanceTest5AffixSelectView
