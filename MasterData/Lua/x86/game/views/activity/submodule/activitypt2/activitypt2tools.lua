...
function var_0_0.GetToggleClickEffect(arg_5_0, arg_5_1)
	...
	if var_5_0 and #var_5_0 > 0 then
		local var_5_1 = #var_5_0 > 1 and var_5_0[arg_5_1] or var_5_0[1]
...
function var_0_0.GetMainActivityID(arg_11_0, arg_11_1)
	for iter_11_0, iter_11_1 in ipairs(ActivityCfg.get_id_list_by_activity_template[ActivityTemplateConst.ACTIVITY_PT_2]) do
		if table.indexof(ActivityCfg[iter_11_1].sub_activity_list, arg_11_1) then
			return iter_11_1
		end
	end
end
