...
function SpringFestivalZumaGameView:ZumaAdaptiveMask()
	local var_15_0 = GameObject.Find("ZumaPlayEnter/Bg").transform
	...
	local var_15_5, var_15_6 = UnityEngine.RectTransformUtility.ScreenPointToLocalPointInRectangle(manager.ui.canvas.transform, UnityEngine.Camera.main:WorldToScreenPoint(var_15_0:GetComponent("SpriteRenderer").sprite.bounds.min), var_15_1, nil)
