...
function var_0_0.GetSubActivityID(arg_5_0)
	return (ActivityCfg[arg_5_0] or nil) and (ActivityCfg[arg_5_0].sub_activity_list or nil)
end
...
function var_0_0.GetSessionIsLock(arg_8_0, arg_8_1)
	if ActivitySummerChessConditionCfg.get_id_list_by_activity_id[arg_8_0] then
		return var_0_0.GetSessionIsLockByID(ActivitySummerChessConditionCfg.get_id_list_by_activity_id[arg_8_0][arg_8_1])
	end
...
function var_0_0.GetSessionIsLockByID(arg_9_0)
	return not IsConditionAchieved((ActivitySummerChessConditionCfg[arg_9_0] or nil) and (ActivitySummerChessConditionCfg[arg_9_0].condition or 0))
end
