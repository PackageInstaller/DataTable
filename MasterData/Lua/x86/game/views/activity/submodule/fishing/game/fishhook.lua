...
function FishHook:IsOutOfGameView()
	...
	local var_18_1 = UnityEngine.RectTransformUtility.WorldToScreenPoint(var_18_0, (self.hitGo_.transform:TransformPoint(0, 0, 0))) - UnityEngine.RectTransformUtility.WorldToScreenPoint(var_18_0, (FishGameManager.GetInstance():GetGameRoot():TransformPoint(0, 0, 0)))

	if -(1080 / Screen.height * var_18_1).y > 1080 or (1080 / Screen.height * var_18_1).x < 0 or (1080 / Screen.height * var_18_1).x > 1920 then
		CustomLog.Log(string.format("out !!!!!!!!!!!!!!!, screenPoint = %s", tostring(1080 / Screen.height * var_18_1)))
