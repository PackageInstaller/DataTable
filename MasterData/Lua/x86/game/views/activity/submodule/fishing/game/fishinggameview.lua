...
function FishingGameView:OnScoreChange()
	...
	local var_16_1 = FishGameManager.GetInstance()
	local var_16_2 = var_16_1:GetScore()

	self.tween_ = LeanTween.value(0, 1, 0.5).setOnUpdate(var_16_1, LuaHelper.FloatAction(function(arg_17_0)
		local var_17_0 = var_16_0 or 0
		local var_17_1 = math.floor(var_17_0 + (var_16_2 - var_17_0) * arg_17_0)
