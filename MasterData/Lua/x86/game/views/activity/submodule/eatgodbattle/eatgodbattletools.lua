...
function var_0_0.SetBackGroundStatus(arg_1_0, arg_1_1)
	if var_0_0.backGround == nil then
		...
		var_0_0.backGround.transform.localPosition = WeekBossConst.BackGroundTransform.position
		var_0_0.backGround.transform.localEulerAngles = WeekBossConst.BackGroundTransform.rotation
		var_0_0.backGround.transform.localScale = WeekBossConst.BackGroundTransform.scale
		var_0_0.backMaterials = var_0_0.backMaterials or var_0_0.backGround.transform:Find("I19_bg01"):GetComponent(typeof(MeshRenderer)).materials
		var_0_0.pillarMaterials = var_0_0.pillarMaterials or var_0_0.backGround.transform:Find("I19_bg02"):GetComponent(typeof(MeshRenderer)).materials
		var_0_0.backController = var_0_0.backController or var_0_0.backGround.transform:GetComponent("ControllerExCollection"):GetController("pillar")
	end
...
function var_0_0.GetVirtualCameras()
	if var_0_0.trackGo == nil or var_0_0.virtualCameraList == nil then
		...
		for iter_3_0, iter_3_1 in ipairs((var_0_0.trackGo.transform:GetComponentsInChildren(typeof(Cinemachine.CinemachineVirtualCamera), true):ToTable())) do
