...
function var_0_0.OnReceiveFlipCardData(arg_1_0, arg_1_1)
	...
	for iter_1_6, iter_1_7 in ipairs(FlipCardCfg[arg_1_1.activity_id].normal_card) do
		table.insert(var_1_2, iter_1_7)
	end

	var_0_0.data = {
		activity_id = arg_1_1.activity_id,
		clue_list = var_1_0,
		new_card_list = var_1_1,
		unlock_card_list = var_1_2
	}
