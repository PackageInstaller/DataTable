local NewMythicHeroTeamHeadItem = class("NewMythicHeroTeamHeadItem", (import("game.views.heroTeamInfo.SectionHeroTeamHeadItem")))
local var_0_1 = {
	Team_3 = 3,
	Team_2 = 2,
	CurTeam = 4,
...
function NewMythicHeroTeamHeadItem:RefreshTeamTag(arg_1_1, arg_1_2)
	local var_1_0 = var_0_1.None

	for iter_1_0 = 1, arg_1_2 do
		for iter_1_1, iter_1_2 in ipairs((ReserveTools.GetHeroList((ReserveParams.New(ReserveConst.RESERVE_TYPE.MYTHIC_FINAL_CACHE, ReserveConst.MYTHIC_CONT_ID.FINAL_MULTI, iter_1_0))))) do
			if self.heroId_ == iter_1_2 then
				var_1_0 = iter_1_0 == arg_1_1 and var_0_1.CurTeam or iter_1_0
			end
		end
	end
