...
local OsirisStoryStageInfoView = class("OsirisStoryStageInfoView", SectionInfoBaseView)

function OsirisStoryStageInfoView:InitUI()
	OsirisStoryStageInfoView.super.InitUI(self)
...
function OsirisStoryStageInfoView:OnClickBtn()
...
function OsirisStoryStageInfoView:RefreshData()
	OsirisStoryStageInfoView.super.RefreshData(self)
...
function OsirisStoryStageInfoView:RefreshStageInfo()
...
return OsirisStoryStageInfoView
