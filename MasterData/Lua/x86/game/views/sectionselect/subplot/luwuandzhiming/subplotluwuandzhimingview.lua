...
function SubPlotLuWuAndZhiMingView:RefreshLineItemList()
	...
	for iter_8_2, iter_8_3 in ipairs(self.openStageList_) do
		local var_8_2 = self.stageItemList_[table.keyof(self.stageList_, iter_8_3)]
		local var_8_3 = var_8_2:GetLocalPosition() + Vector3(self.itemWidth_ / -2, 0, 0)
		local var_8_4 = self:GetCfgName()[iter_8_3].pre_show_id_list
		...
		for iter_8_6, iter_8_7 in ipairs(var_8_4) do
			local var_8_7 = self:GetCfgName()[iter_8_3]

			if table.keyof(var_8_1, iter_8_7) then
				local var_8_8 = self.stageItemList_[table.keyof(self.stageList_, iter_8_7)]:GetLocalPosition() + Vector3(self.itemWidth_ / 2, 0, 0)
				local var_8_9 = self.lineList_[var_8_0] or SectionSingleLineItem.New(self.lineGo_, self.content_, 11)

				var_8_9:Show(true)

				self.lineList_[var_8_0] = var_8_9

				var_8_9:RefreshUI(var_8_8, var_8_3)
