...
function EquipBreakThroughMaterialStageInfoView:RefreshStageInfo()
	...
	if EquipBreakThroughMaterialMapCfg[EquipBreakThroughMaterialData:GetChooseMapStageID()].stage_type ~= EquipBreakThroughMaterialConst.EQUIP_BREAK_THROUGH_TYPE.BUFF and EquipBreakThroughMaterialMapCfg[EquipBreakThroughMaterialData:GetChooseMapStageID()].stage_type ~= EquipBreakThroughMaterialConst.EQUIP_BREAK_THROUGH_TYPE.HEAL then
		self.pointText_.text = EquipBreakThroughMaterialPointCfg[EquipBreakThroughMaterialMapCfg[EquipBreakThroughMaterialData:GetChooseMapStageID()].stage_type].stage_point[EquipBreakThroughMaterialMapCfg[EquipBreakThroughMaterialData:GetChooseMapStageID()].col]
