...
function SectionBaseView:CreateLineItemList()
	...
	for iter_34_4, iter_34_5 in ipairs(self.oepnStageList_) do
		local var_34_4 = self.missionItem_[table.keyof(self.stageList_, iter_34_5)]
		local var_34_5 = var_34_4:GetLocalPosition() + Vector3(0, 0, 0)
		local var_34_6 = self:GetCfgName()[iter_34_5].pre_show_id_list
		...
		for iter_34_8, iter_34_9 in ipairs(var_34_6) do
			local var_34_8 = self:GetCfgName()[iter_34_5]

			if type(var_34_8.custom_line) == "table" and #var_34_8.custom_line[iter_34_8] > 0 and (self.stageData_[iter_34_5] and self.stageData_[iter_34_5].clear_times > 0 or var_34_7) then
				self:DrawLine(var_34_0, var_34_8.custom_line[iter_34_8])

				var_34_0 = var_34_0 + 1
			elseif type(var_34_8.custom_lock_line) == "table" and #var_34_8.custom_lock_line[iter_34_8] > 0 then
				self:DrawLine(var_34_0, var_34_8.custom_lock_line[iter_34_8])

				var_34_0 = var_34_0 + 1
			elseif table.keyof(var_34_3, iter_34_9) then
				local var_34_9 = self.missionItem_[table.keyof(self.stageList_, iter_34_9)]:GetLocalPosition() + Vector3(0, 0, 0)
				...
				self.lineList_[var_34_0]:RefreshUI(var_34_9, var_34_5)
