...
function ChapterV2MapBaseMapView:SetCurrentMap()
	...
	if not self.misUnlockingMapGo_ or self.misUnlockingMapGo_ and self.misUnlockingMapGo_.name ~= ChapterV2MapData:GetCurrentMapId() .. "_MisUnlockingMap" then
		if self.misUnlockingMapGo_ then
			GameObject.DestroyImmediate(self.misUnlockingMapGo_)
		end

		self.misUnlockingMapGo_ = Object.Instantiate(Asset.Load("Widget/System/Xuheng_PlotMap/XuhengPlotMapMainUI/" .. ChapterV2MapData:GetCurrentMapId() .. "_MisUnlockingMap"), self.misUnlockMapContent_)
	end

	if not self.aboveMisUnlockingMapGo_ or self.aboveMisUnlockingMapGo_ and self.aboveMisUnlockingMapGo_.name ~= ChapterV2MapData:GetCurrentMapId() .. "_AboveMisUnlockingMap" then
		if self.aboveMisUnlockingMapGo_ then
			GameObject.DestroyImmediate(self.aboveMisUnlockingMapGo_)
		end

		self.aboveMisUnlockingMapGo_ = Object.Instantiate(Asset.Load("Widget/System/Xuheng_PlotMap/XuhengPlotMapMainUI/" .. ChapterV2MapData:GetCurrentMapId() .. "_AboveMisUnlockingMap"), self.aboveMisUnlockMapContent_)
	end
