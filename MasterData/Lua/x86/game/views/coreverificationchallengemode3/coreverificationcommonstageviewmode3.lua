local CoreVerificationCommonStageViewMode3 = class("CoreVerificationCommonStageViewMode3", ReduxView)

function CoreVerificationCommonStageViewMode3:UIName()
	return "Widget/System/Core_verification_new/Mode3/Core_Verification_OrdinaryStageUI_Mode3"
end

function CoreVerificationCommonStageViewMode3:UIParent()
	return manager.ui.uiMain.transform
end

function CoreVerificationCommonStageViewMode3:Init()
	self:InitUI()
	self:AddUIListeners()
end

function CoreVerificationCommonStageViewMode3:InitUI()
	self:BindCfgUI()
...
function CoreVerificationCommonStageViewMode3:AddUIListeners()
...
function CoreVerificationCommonStageViewMode3:OnEnter()
...
function CoreVerificationCommonStageViewMode3:UpdateCoreVerification()
...
function CoreVerificationCommonStageViewMode3:RefreshCallBack()
	return
end

function CoreVerificationCommonStageViewMode3:RefreshEnvAffix()
	...
	local var_14_2 = ActivityAffixPoolCfg[var_14_0.type_affix[1]].affix

	if var_14_0.type_affix and #var_14_0.type_affix > 0 then
		SetActive(self.recAgo_, true)
	else
		SetActive(self.recAgo_, false)
	end

	self.stageAffixDesc_.text = getAffixDesc(var_14_2)
...
function CoreVerificationCommonStageViewMode3:OnExit()
	...
	CoreVerificationCommonStageViewMode3.super.OnExit(self)
end

function CoreVerificationCommonStageViewMode3:RefreshTitle()
	...
	local var_16_0 = CoreVerificationChallengeMode3Data:GetCommonStageByIndex(self.stage_id)

	if var_16_0 and var_16_0.max_value and var_16_0.max_value > 0 then
		self.timeController_:SetSelectedIndex(1)
		self.pointsController_:SetSelectedIndex(1)

		self.scoreText_.text = var_16_0.reset_normal_value or 0
	...
	if var_16_0 then
		var_16_1 = var_16_0.common_lock_id or {}
	end
...
function CoreVerificationCommonStageViewMode3:Dispose()
	...
	CoreVerificationCommonStageViewMode3.super.Dispose(self)
end

return CoreVerificationCommonStageViewMode3
