...
function NoobAdvanceConditionItem:SetData(arg_2_1, arg_2_2, arg_2_3)
	if arg_2_1 == 1 then
		...
		self.stateController_:SetSelectedState(tostring(NoobVersionCfg[ActivityNewbieTools:GetVersionID()].noob_advance_task_open[arg_2_3] <= PlayerData:GetPlayerInfo().userLevel))
