local var_0_0 = {
	...
	CURRENCY_TYPE_ACTIVITY_REFORGE = 54058,
	DORM_TASK_WEEKLY = 61,
	CURRENCY_TYPE_STRONGHOLD_EXP_3 = 54026,
	...
	CURRENCY_TYPE_CHIP_COST = CurrencyIdMapCfg.CURRENCY_TYPE_CHIP_COST.item_id,
	CURRENCY_TYPE_PERIODICITY_EXPLORE_TICKER_INSTANCE = CurrencyIdMapCfg.CURRENCY_TYPE_PERIODICITY_EXPLORE_TICKER_INSTANCE.item_id,
	...
	CURRENCY_TYPE_AUTO_CHESS_CARD_ITEM = GameSetting.auto_chess_2_card_pack_id.value[1]
}
