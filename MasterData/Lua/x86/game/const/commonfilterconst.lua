...
function var_0_0.GetFilterList(arg_1_0)
	return var_0_1.GetGroupCfg(arg_1_0).tags or {}
end

function var_0_0.GetFilterTagCfg(arg_2_0)
	return CommonFilterCfg[arg_2_0]
end

function var_0_0.GetFilterCfg(arg_3_0)
...
function var_0_0.GetFilterGroups(arg_4_0)
	return var_0_1.GetFilterCfg(arg_4_0).groupList
end

function var_0_0.GetGroupCfg(arg_5_0)
...
function var_0_0.GetTagIndexAtGroup(arg_6_0, arg_6_1)
...
function var_0_0.GetDefaultHeroAttributeIdList(arg_7_0)
	local var_7_0 = {}
	...
	for iter_7_2, iter_7_3 in ipairs(Filter_Group_Define.ARRT.tags) do
		var_7_1[iter_7_3] = iter_7_2
	end

	local var_7_2 = {}

	for iter_7_4, iter_7_5 in ipairs(SkillElementCfg.all) do
		if not var_7_0[iter_7_5] and Filter_Tags_Define["ARRT" .. iter_7_5] then
			var_7_2[#var_7_2 + 1] = iter_7_5
		end
	end

	table.sort(var_7_2, function(arg_8_0, arg_8_1)
		return var_7_1[Filter_Tags_Define["ARRT" .. arg_8_0]] < var_7_1[Filter_Tags_Define["ARRT" .. arg_8_1]]
	end)
