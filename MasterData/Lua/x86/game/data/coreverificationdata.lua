...
function var_0_0:Init()
	...
	for iter_1_0, iter_1_1 in pairs(CoreVerificationInfoCfg.get_id_list_by_cycle) do
		...
		for iter_1_2, iter_1_3 in ipairs(iter_1_1) do
			var_0_1[iter_1_0][CoreVerificationInfoCfg[iter_1_3].boss_type][CoreVerificationInfoCfg[iter_1_3].difficult] = iter_1_3

			if self:IsChallengeType(iter_1_3) then
				var_0_15 = CoreVerificationInfoCfg[iter_1_3].difficult
			end
		end
	end
	...
	for iter_1_4, iter_1_5 in pairs(CoreVerificationRewardCfg.all) do
		if CoreVerificationRewardCfg[iter_1_5].reward_type == 1 or CoreVerificationRewardCfg[iter_1_5].reward_type == 2 then
			var_0_2[CoreVerificationRewardCfg[iter_1_5].reward_type][CoreVerificationRewardCfg[iter_1_5].cycle] = var_0_2[CoreVerificationRewardCfg[iter_1_5].reward_type][CoreVerificationRewardCfg[iter_1_5].cycle] or {}

			table.insert(var_0_2[CoreVerificationRewardCfg[iter_1_5].reward_type][CoreVerificationRewardCfg[iter_1_5].cycle], iter_1_5)
		else
			table.insert(var_0_2[CoreVerificationRewardCfg[iter_1_5].reward_type], iter_1_5)
		end
	end

	self:SetUpdateCycleCallBack()
end
...
function var_0_0.UpdateCycleInfo(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in ipairs(arg_4_1.stage_info) do
		...
		if iter_4_1.sign == 1 then
			var_0_6[iter_4_1.id].passTime = iter_4_1.min_time / 1000 or 3600
		end
	end
	...
	for iter_4_8, iter_4_9 in ipairs(var_0_1[var_0_3][1]) do
		if var_0_6[iter_4_9] and var_0_6[iter_4_9].passState then
			var_0_9[1] = iter_4_8
		end
	end

	for iter_4_10, iter_4_11 in ipairs(var_0_1[var_0_3][2]) do
	...
	for iter_4_16, iter_4_17 in ipairs((arg_4_1.max_score_info or nil) and (arg_4_1.max_score_info.lock_list or {})) do
		...
		var_4_0 = var_4_0 + (iter_4_17.score or 0)
	end
...
function var_0_0.BattleStageData(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	if CoreVerificationInfoCfg[arg_5_1].difficult > var_0_9[CoreVerificationInfoCfg[arg_5_1].boss_type] then
		var_0_9[CoreVerificationInfoCfg[arg_5_1].boss_type] = CoreVerificationInfoCfg[arg_5_1].difficult
	end

	for iter_5_0, iter_5_1 in ipairs(arg_5_2) do
		if not table.keyof(var_0_7[CoreVerificationInfoCfg[arg_5_1].boss_type], iter_5_1) then
			table.insert(var_0_7[CoreVerificationInfoCfg[arg_5_1].boss_type], iter_5_1)
		end
	end

	if var_0_6[CoreVerificationInfoCfg[arg_5_1].id] then
		var_0_6[CoreVerificationInfoCfg[arg_5_1].id].passState = true

		if arg_5_3 < var_0_6[CoreVerificationInfoCfg[arg_5_1].id].passTime then
			var_0_6[CoreVerificationInfoCfg[arg_5_1].id].passTime = arg_5_3
		end
	else
		var_0_6[CoreVerificationInfoCfg[arg_5_1].id] = {}
		var_0_6[CoreVerificationInfoCfg[arg_5_1].id].passState = true
		var_0_6[CoreVerificationInfoCfg[arg_5_1].id].passTime = arg_5_3
	end
...
function var_0_0.GetBossUICfgByBossType(arg_7_0, arg_7_1)
	return BossChallengeUICfg[CoreVerificationInfoCfg[var_0_1[var_0_3][arg_7_1][1]].stage_id] or BossChallengeUICfg[3090009]
end

function var_0_0.GetRecommendByBossType(arg_8_0, arg_8_1)
	return CoreVerificationInfoCfg[var_0_1[var_0_3][arg_8_1][1]].recommend
end
...
function var_0_0.GetLockHeroByInfoID(arg_11_0, arg_11_1, arg_11_2)
	if arg_11_2 then
		return var_0_7[CoreVerificationInfoCfg[arg_11_1].boss_type]
	elseif CoreVerificationInfoCfg[arg_11_1].boss_type == 1 then
		return var_0_7[2]
	elseif CoreVerificationInfoCfg[arg_11_1].boss_type == 2 then
		return var_0_7[1]
	end
...
function var_0_0.GetMaxPassByBossType(arg_12_0, arg_12_1)
	...
	if var_0_9[arg_12_1] > 0 then
		var_12_1 = var_0_9[arg_12_1] or 1
	end

	return var_12_0, var_12_1, (var_12_0 or nil) and (var_0_6[var_0_1[var_0_3][arg_12_1][var_12_1]].passTime or 0)
end

function var_0_0:GetMaxUnlockByBossType(arg_13_1)
	local var_13_0 = 1
	...
	for iter_13_0, iter_13_1 in ipairs(var_0_1[var_0_3][arg_13_1]) do
		if var_0_6[iter_13_1 - 1] and var_13_1 >= CoreVerificationInfoCfg[iter_13_1].unlock_level then
			if self:IsChallengeType(iter_13_1) then
				if self:IsOpenChallge() then
					var_13_0 = iter_13_0
				end
			else
				var_13_0 = iter_13_0
...
function var_0_0.GetStageInfoByTypeAndDiff(arg_14_0, arg_14_1, arg_14_2)
	return var_0_6[var_0_1[var_0_3][arg_14_1][arg_14_2]]
end

function var_0_0.GetInfoCfgByTypeAndDiff(arg_15_0, arg_15_1, arg_15_2)
	return CoreVerificationInfoCfg[var_0_1[var_0_3][arg_15_1][arg_15_2]]
end

function var_0_0.GetAffixByTypeAndDiff(arg_16_0, arg_16_1, arg_16_2)
	return CoreVerificationInfoCfg[var_0_1[var_0_3][arg_16_1][arg_16_2]].affix_type
end
...
function var_0_0.CheckFirstReward(arg_18_0)
	for iter_18_0, iter_18_1 in ipairs(var_0_2[4]) do
...
function var_0_0.GetTaskProcess(arg_24_0, arg_24_1)
	local var_24_0 = ConditionCfg[CoreVerificationRewardCfg[arg_24_1].condition]
	local var_24_1 = 0

	if ConditionCfg[CoreVerificationRewardCfg[arg_24_1].condition].type == 11300 then
		var_24_1 = var_24_0.params[2] <= var_0_9[var_24_0.params[1]] and 1 or 0
	elseif var_24_0.type == 11302 then
		var_24_1 = var_24_0.params[1] <= var_0_9[1] and var_24_0.params[1] <= var_0_9[2] and 1 or 0
	elseif var_24_0.type == 11301 then
		var_24_1 = var_0_6[var_0_1[var_0_3][1][var_24_0.params[1]]] and var_0_6[var_0_1[var_0_3][2][var_24_0.params[1]]] and 1 or 0
	elseif var_24_0.type == 11303 then
		var_24_1 = var_0_6[var_0_1[var_0_3][var_24_0.params[1]][var_24_0.params[2]]] and 1 or 0
	end

	return var_24_1, var_24_0.progress_show, var_24_1 == 1, var_0_8[arg_24_1] or false
end
...
function var_0_0:GetRecordSuffixIndexList(arg_33_1)
	local var_33_0 = self:GetRecordSuffixList(arg_33_1)
	local var_33_1 = {}

	for iter_33_0, iter_33_1 in ipairs((self:GetSuffixList(arg_33_1))) do
		var_33_1[iter_33_0] = 0

		if #iter_33_1 ~= 1 then
			for iter_33_2, iter_33_3 in ipairs(iter_33_1) do
				if table.indexof(var_33_0, iter_33_3) then
					var_33_1[iter_33_0] = iter_33_2
				end
			end
		end
	end
...
function var_0_0:IsOpenChallge()
	local var_38_0 = self:GetStageInfoByTypeAndDiff(1, var_0_15 - 1)
	local var_38_1 = self:GetStageInfoByTypeAndDiff(2, var_0_15 - 1)
	local var_38_2

	if var_38_0 and var_38_1 then
		::label_38_1::

		var_38_2 = var_38_0.passState and var_38_1.passState
	end

	return var_38_2
end

function var_0_0:IsPassChallengeChallge(arg_39_1)
	local var_39_0 = self:GetStageInfoByTypeAndDiff(arg_39_1, var_0_15)
	local var_39_1

	if var_39_0 then
		::label_39_0::

		var_39_1 = var_39_0.passState and self:IsChallengeType(var_0_1[var_0_3][arg_39_1][var_0_15] or 0)
	end

	return var_39_1
end

function var_0_0:IsOpenChallgeByType(arg_40_1)
	local var_40_0 = self:GetStageInfoByTypeAndDiff(arg_40_1, var_0_15 - 1)
