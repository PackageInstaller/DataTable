...
function var_0_0:InitPolyhedronGameData(arg_2_1)
	var_0_4 = arg_2_1.activity_id

	self:UpdateTerminalLevel()

	var_0_9 = arg_2_1.terminal.reset_times
	var_0_8 = {}

	for iter_2_0, iter_2_1 in ipairs(arg_2_1.terminal.upgrade_id_list) do
	...
	if not var_0_2 then
		var_0_2 = PolyhedronTemplate.New(arg_2_1.game)
	else
		var_0_2:UpdateGame(arg_2_1.game)
	end

	var_0_20 = var_0_2:GetTipsList()
	var_0_5 = {}

	for iter_2_4, iter_2_5 in ipairs(arg_2_1.decision.apply_id_list) do
	...
	for iter_2_6, iter_2_7 in ipairs(arg_2_1.unlocked_hero_list) do
		table.insert(var_0_11, iter_2_7.hero_id)
		...
		var_0_12[iter_2_7.hero_id] = var_2_0
	end
	...
	for iter_2_12, iter_2_13 in ipairs(arg_2_1.manual.sample_list) do
...
function var_0_0.GetHeroIDList(arg_4_0)
	...
	if PolyhedronHeroShelvesCfg[var_4_0] then
		if PolyhedronHeroShelvesCfg[var_4_0] then
			do return PolyhedronHeroShelvesCfg[var_4_0].leader_hero_id or PolyhedronHeroCfg.all end
...
function var_0_0.UpdatePolyhedronSettlement(arg_7_0, arg_7_1)
	var_0_3 = {
		point = arg_7_1.end_info.point,
		decision_exp = arg_7_1.end_info.decision_exp,
		terminal_exp = arg_7_1.end_info.terminal_exp
	}
end
...
function var_0_0.UpdateTerminalLevel(arg_11_0)
	var_0_6, var_0_7 = PolyhedronTools.PolyhedronTerminalExpToLevel((ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_POLYHEDRON_TERMINAL_EXP)))
end
...
function var_0_0:GetHeroData(arg_25_1)
	local var_25_0 = SkinCfg[HeroStandardSystemCfg[PolyhedronHeroCfg[arg_25_1].standard_id].skin_id].hero

	if not var_0_1[arg_25_1] then
		var_0_1[arg_25_1] = PolyhedronHeroDataTemplate.New(var_25_0, arg_25_1)

		var_0_1[arg_25_1]:Init(HeroStandardSystemCfg[PolyhedronHeroCfg[arg_25_1].standard_id], arg_25_1)

		var_0_1[arg_25_1].unlock = not self:GetPolyhedronHeroUnlock(arg_25_1) and 0 or 1

		PolyhedronData:SetUseAstrolabe(var_25_0, (self:GetUseAstrolabe(var_25_0)))
	end

	var_0_1[arg_25_1].using_skin = HeroData:GetHeroData(var_25_0).using_skin

	if var_0_1[arg_25_1].using_skin == 0 then
		var_0_1[arg_25_1].using_skin = var_25_0
	end
...
function var_0_0.GetSortRankHeroIDList(arg_29_0)
	...
	table.sort(var_29_1, function(arg_30_0, arg_30_1)
		local var_30_0 = var_29_0[arg_30_1]

		if var_29_0[arg_30_0] then
			local var_30_1 = var_29_0[arg_30_0].score or 0

			if var_30_0 then
				local var_30_2 = var_30_0.score or 0

				if var_30_1 ~= var_30_2 then
					do return var_30_2 < var_30_1 end
		...
		do return arg_30_0 < arg_30_1 end
...
function var_0_0.GetTipsData(arg_41_0)
	if var_0_20[var_0_21] then
		...
		return (deepClone(var_0_20[var_0_21]))
	else
		return nil
	end
end
...
function var_0_0.GetUseAstrolabe(arg_42_0, arg_42_1)
	...
	return (HeroStandardSystemCfg[PolyhedronHeroCfg[arg_42_1].standard_id].astrolabe_id ~= "" or nil) and (HeroStandardSystemCfg[PolyhedronHeroCfg[arg_42_1].standard_id].astrolabe_id or {})
end
...
function var_0_0:GetEquipDataList(arg_49_1)
	return self:GetHeroData(arg_49_1).equip_list
end
...
function var_0_0:GetHeroUsingSkinInfo(arg_52_1)
	local var_52_0 = self:GetHeroData(arg_52_1)
	local var_52_1 = HeroData:GetHeroData(arg_52_1).using_skin or 0

	if var_52_1 == 0 then
		var_52_1 = arg_52_1
	end

	return SkinCfg[var_52_1]
end

function var_0_0:GetHeroBattleUsingSkinInfo(arg_53_1)
	local var_53_0 = self:GetHeroData(arg_53_1)
	local var_53_1 = HeroData:GetHeroData(arg_53_1).battle_using_skin or 0

	if var_53_1 == 0 then
		var_53_1 = arg_53_1
	end

	return SkinCfg[var_53_1]
end
