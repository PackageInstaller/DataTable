	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1) do
		...
		for iter_2_2, iter_2_3 in ipairs(iter_2_1.equip) do
			...
			if iter_2_3.equip_id ~= 0 then
				var_0_2[iter_2_3.equip_id] = not var_0_2[iter_2_3.equip_id] and 1 or var_0_2[iter_2_3.equip_id] + 1
			end
		end
	end
end
...
function var_0_0.AddProposal(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	for iter_7_0, iter_7_1 in pairs((HeroTools.GetHeroEquipS(arg_7_1))) do
		...
		if iter_7_1.equip_id ~= 0 then
			var_0_2[iter_7_1.equip_id] = not var_0_2[iter_7_1.equip_id] and 1 or var_0_2[iter_7_1.equip_id] + 1
		end
	end
end
...
function var_0_0.AddProposalCommon(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	for iter_8_0, iter_8_1 in pairs(arg_8_1) do
		...
		if iter_8_1.equip_id ~= 0 then
			var_0_2[iter_8_1.equip_id] = not var_0_2[iter_8_1.equip_id] and 1 or var_0_2[iter_8_1.equip_id] + 1
		end
	end
end

function var_0_0.DeleteProposal(arg_9_0, arg_9_1)
	for iter_9_0, iter_9_1 in pairs(var_0_1[arg_9_1].equip_list) do
...
function var_0_0.Tools.SetEquipListFormat(arg_12_0)
	...
	for iter_12_2 = 1, 6 do
		var_12_0[iter_12_2] = var_12_0[iter_12_2] or {
			equip_id = 0,
			pos = iter_12_2
		}
	end
