...
function var_0_1:InitPopularity(arg_17_1)
	...
	local var_17_2 = math.modf((manager.time:GetServerTime() - arg_17_1.Popularity.updataTime) / GameSetting.canteen_hot_reduce.value[2])

	arg_17_1.Popularity.updataTime = arg_17_1.Popularity.updataTime + var_17_2 * var_17_1

	if arg_17_1.Popularity.dynamicNum > 0 then
		var_17_0 = math.max(0, arg_17_1.Popularity.dynamicNum - var_17_2 * var_17_1)
	end
	...
	arg_17_1.remainTime = (manager.time:GetServerTime() - arg_17_1.Popularity.updataTime) % GameSetting.canteen_hot_reduce.value[2]
