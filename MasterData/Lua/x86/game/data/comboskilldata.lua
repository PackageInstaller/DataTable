...
function var_0_0:InitData(arg_2_1)
	for iter_2_0, iter_2_1 in ipairs(arg_2_1.cooperate_unique_skill_list) do
		self.comboSkill_[iter_2_1.type] = self.comboSkill_[iter_2_1.type] or {}
		self.comboSkill_[iter_2_1.type][(iter_2_1.difficulty == nil or nil) and 1] = iter_2_1.cooperate_unique_skill_id
	end
end

function var_0_0:GetComboSkillID(arg_3_1, arg_3_2, arg_3_3)
	if arg_3_3 == nil then
		arg_3_3 = 1
	end
	...
	if self.comboSkill_[var_3_0] and self.comboSkill_[var_3_0][arg_3_3] then
		return self.comboSkill_[var_3_0][arg_3_3]
	else
		return 0
	end
end

function var_0_0:SetComboSkillID(arg_4_1, arg_4_2, arg_4_3)
	if self.comboSkill_[arg_4_1] == nil then
		self.comboSkill_[arg_4_1] = {}
	end

	self.comboSkill_[arg_4_1][arg_4_2] = arg_4_3
...
function var_0_0:GetNeedRefresh(arg_6_1, arg_6_2)
	return self.needRefresh_
end

function var_0_0:SetBossChallengeNeedRefresh(arg_7_1, arg_7_2)
	self.needRefreshBoss_[arg_7_1] = arg_7_2
end

function var_0_0:GetBossChallengeNeedRefresh(arg_8_1)
	return self.needRefreshBoss_[arg_8_1]
end
...
function var_0_0:GetMatrixNeedRefresh()
	return self.matrixNeedRefresh_
end

function var_0_0:GetComboSkill()
	return self.comboSkill_
end

function var_0_0.InitLevelData(arg_12_0, arg_12_1)
	var_0_1 = {}

	for iter_12_0, iter_12_1 in ipairs(arg_12_1.info.skill_list) do
		local var_12_0 = {}
...
function var_0_0.UpdateLevelData(arg_13_0, arg_13_1)
	...
	for iter_13_0, iter_13_1 in ipairs(arg_13_1.skill.progress_list) do
	...
	var_0_1[arg_13_1.skill.id] = {
		level = arg_13_1.skill.level,
		progress_list = var_13_0
	}
end

function var_0_0:UpgradeComboSkillLevel(arg_14_1)
	if var_0_1[arg_14_1] then
		var_0_1[arg_14_1].level = self:GetCurComboSkillLevel(arg_14_1) + 1
	else
		var_0_1[arg_14_1] = {
			level = 1,
			progress_list = {}
...
function var_0_0.GetComboSkillUpConditionProcess(arg_16_0, arg_16_1, arg_16_2)
	if var_0_1[arg_16_1] then
		for iter_16_0, iter_16_1 in ipairs(var_0_1[arg_16_1].progress_list) do
