...
function var_0_0.GetChapterSurveyID(arg_15_0, arg_15_1)
	return var_0_6[ChapterClientCfg[arg_15_1].chapter_list[#ChapterClientCfg[arg_15_1].chapter_list]]
end

function var_0_0:GetChapterSurveyUrl(arg_16_1)
	local var_16_1 = self:GetChapterSurveyID(arg_16_1)

	return (var_16_1 and var_16_1 ~= 0 or nil) and var_0_1[var_16_1].url
end

function var_0_0:GetChapterSurveyIsFinish(arg_17_1)
	local var_17_0 = self:GetChapterSurveyID(arg_17_1)
