...
function var_0_0.GetChallengeStageCfg(arg_13_0)
	for iter_13_0, iter_13_1 in ipairs(CoreVerificationClMode2Cfg.get_id_list_by_stage_type[2]) do
		if CoreVerificationClMode2Cfg[iter_13_1].activity_id == CoreVerificationChallengeTools.GetModeStageActivityId(ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE2) then
			return CoreVerificationClMode2Cfg[iter_13_1]
		end
	end
...
function var_0_0.GetEfficiencyNum(arg_19_0)
	local var_19_0 = var_0_0:GetChallengeStageCfg()
	local var_19_1, var_19_2, var_19_3 = var_0_0:GetPostNum()

	return 100 * (var_19_3 * GameSetting.core_verification_cl_score_2.value[3] + 1) .. "%"
end

function var_0_0.GetPostNum(arg_20_0)
	local var_20_0 = 0
	local var_20_1 = 0
	local var_20_2 = var_0_0:GetChallengeStageCfg()

	for iter_20_0, iter_20_1 in ipairs(var_0_6) do
		for iter_20_2, iter_20_3 in ipairs(var_20_2.stage_affix_buff) do
		...
		for iter_20_4, iter_20_5 in ipairs(var_20_2.stage_affix_debuff) do
		...
		for iter_20_6, iter_20_7 in ipairs(var_20_2.stage_affix_debuff) do
			if iter_20_1.buff_id == iter_20_7 then
				affixCfg = ActivityAffixPoolCfg[iter_20_7]
				var_20_1 = var_20_1 + affixCfg.point
			end
		end
	end

	return var_20_0, var_0_0:GetPostLimitNum(), var_20_1
end
...
function var_0_0:PushStageLockedHero(arg_30_1, arg_30_2)
	local var_30_0 = self:GetChallengeStage()

	if arg_30_1.stageID ~= var_30_0.stage_id and var_30_0.challenge_lock then
		for iter_30_0, iter_30_1 in ipairs(var_30_0.challenge_lock) do
			table.insert(arg_30_2, iter_30_1)
		end
	end

	local var_30_1 = self:GetCommonStage()

	if var_30_1 then
		for iter_30_2, iter_30_3 in ipairs(var_30_1) do
			if arg_30_1.stageID ~= iter_30_3.stage_id then
