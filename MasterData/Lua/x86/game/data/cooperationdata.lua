...
function var_0_0.InitRoomData(arg_2_0, arg_2_1)
	var_0_1 = var_0_1 or CooperationRoomTemplate.New()
...
function var_0_0.InitInviteInfo(arg_9_0, arg_9_1)
	for iter_9_0, iter_9_1 in ipairs(arg_9_1.invite_list) do
		local var_9_0 = CooperationInviteTemplate.New(iter_9_1)

		var_0_2[var_9_0.uid] = var_9_0
	end

	for iter_9_2, iter_9_3 in ipairs(arg_9_1.type_list) do
		table.insert(var_0_3, iter_9_3)
	end
end

function var_0_0.AddInviteInfo(arg_10_0, arg_10_1)
	local var_10_0 = CooperationInviteTemplate.New(arg_10_1.invite)

	var_0_2[var_10_0.uid] = var_10_0

	if not table.indexof(var_0_3, var_10_0.invite_type) then
		var_0_7 = {
...
function var_0_0.GetInviteList(arg_18_0, arg_18_1)
	...
	for iter_18_0, iter_18_1 in pairs(var_0_2) do
		if table.indexof(arg_18_1, iter_18_1.invite_type) then
			if iter_18_1.activity_id and iter_18_1.activity_id ~= 0 then
				if ActivityData:GetActivityIsOpen(iter_18_1.activity_id) then
...
function var_0_0.InitVisiteList(arg_23_0, arg_23_1)
	...
	for iter_23_0, iter_23_1 in ipairs(arg_23_1.player_list) do
		table.insert(var_0_4, (CooperationRecentVisitTemplate.New(iter_23_1)))
	end
end

function var_0_0.GetIsMaster(arg_24_0)
	local var_24_0 = var_0_1 and var_0_1:GetRoomPlayerData(PlayerData:GetPlayerInfo().userID)

	if var_24_0 then
		return var_24_0.is_master == 1
	else
		return false
	end
end
...
function var_0_0.GetInviteVisible(arg_26_0, arg_26_1)
	var_0_5[arg_26_1] = var_0_5[arg_26_1] or getData("CooperationVisible", tostring(arg_26_1))
...
function var_0_0.GetCooperationHero(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	if var_30_1 and type(var_30_1) == "table" then
		...
		if var_30_1.hero_type == 2 then
			var_30_3 = var_30_1.hero_id
			var_30_2 = HeroStandardSystemCfg[var_30_1.hero_id] and HeroStandardSystemCfg[var_30_1.hero_id].hero_id
		else
			var_30_3 = 0
			var_30_2 = var_30_1.hero_id
		end

		for iter_30_0, iter_30_1 in ipairs(var_30_0) do
			if iter_30_1.trialID == var_30_3 and iter_30_1.id == var_30_2 then
				return var_30_1
			end
		end
	end
	...
	if var_30_0[1].trialID ~= 0 then
		return {
			hero_type = 2,
			hero_id = var_30_4.trialID,
...
function var_0_0.SetCooperationHero(arg_31_0, arg_31_1)
	...
	if var_31_0 then
		saveData("cooperation", "cooperation_hero_" .. var_31_0.type, arg_31_1)
	end
end
...
function var_0_0.GetCooperationHeroPower(arg_32_0, arg_32_1)
	...
	if var_32_2[1].trialID and var_32_2[1].trialID ~= 0 then
		...
		local var_32_3 = var_0_0:GetHeroData(var_32_1.heroList[1].id)
		local var_32_4 = var_32_3:GetEquipInfoList()
		local var_32_5 = var_32_3:GetServantInfo()

		return calcBattlePower(var_32_3, var_32_5, var_32_4, nil, (GetHeroFinalAttr(var_32_3, var_32_5, var_32_4, nil, true)))
	end
end
...
function var_0_0.GetHeroData(arg_33_0, arg_33_1, arg_33_2)
	...
	if var_0_10 then
		for iter_33_0, iter_33_1 in ipairs(var_0_10.heroList) do
...
function var_0_0:GetEquipInfoList(arg_34_1, arg_34_2)
	return self:GetHeroData(arg_34_1, arg_34_2):GetEquipInfoList()
end

function var_0_0:GetEquipDataList(arg_35_1, arg_35_2)
	return self:GetHeroData(arg_35_1, arg_35_2).equip_list
end

function var_0_0:GetHeroWeaponInfo(arg_36_1, arg_36_2)
	return self:GetHeroData(arg_36_1, arg_36_2):GetWeaponInfo()
end

function var_0_0:GetHeroServantInfo(arg_37_1, arg_37_2)
	return self:GetHeroData(arg_37_1, arg_37_2):GetServantInfo()
end

function var_0_0:GetHeroSkillInfoList(arg_38_1, arg_38_2)
	return self:GetHeroData(arg_38_1, arg_38_2):GetSkillInfoList()
end

function var_0_0:GetHeroTransitionInfoList(arg_39_1, arg_39_2)
	return self:GetHeroData(arg_39_1, arg_39_2):GetTransitionInfoList()
end

function var_0_0:GetHeroUsingSkinInfo(arg_40_1, arg_40_2)
	local var_40_0 = self:GetHeroData(arg_40_1, arg_40_2)
	local var_40_1

	if var_40_0 then
		var_40_1 = var_40_0.using_skin or 0
