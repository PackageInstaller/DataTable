...
function var_0_0.InitClearStageList(arg_4_0, arg_4_1)
	for iter_4_0, iter_4_1 in ipairs(arg_4_1) do
		var_0_2[iter_4_1.id] = var_0_2[iter_4_1.id] or var_0_5(iter_4_1.id)
		var_0_2[iter_4_1.id].isClear = iter_4_1.state
		var_0_2[iter_4_1.id].topScore = iter_4_1.max_score
		var_0_2[iter_4_1.id].use_skill_list = iter_4_1.use_skill_list
	end
end

function var_0_0.InitEndLessScore(arg_5_0, arg_5_1)
	var_0_2[TetrisGameTools:GetEndLessStageIDByActivityID(var_0_1)].topScore = arg_5_1
end
...
function var_0_0.CheckSpecialStageIsUnLock(arg_8_0, arg_8_1)
	if ActivityTetrisGameStageCfg[arg_8_1].need_endless == 1 then
		if var_0_4[arg_8_1] then
			return true
		else
			local var_8_0 = ActivityTetrisGameStageCfg[arg_8_1].unlock_condition
			local var_8_1 = ""

			if #ActivityTetrisGameStageCfg[arg_8_1].unlock_condition > 0 then
				var_8_1 = ConditionCfg[var_8_0[#var_8_0]].desc

				for iter_8_0, iter_8_1 in pairs(var_8_0) do
					if not IsConditionAchieved(iter_8_1) then
						var_8_1 = ConditionCfg[iter_8_1].desc
...
function var_0_0:GetEndlessSkillList()
	local var_15_0 = {}

	table.insert(var_15_0, TetrisGameConst.ultimateID)

	for iter_15_0, iter_15_1 in pairs(self:GetSkillList()) do
...
function var_0_0.GetSpecialStageInfo(arg_16_0)
	return var_0_2[TetrisGameTools:GetEndLessStageIDByActivityID(var_0_1)]
end

function var_0_0.GetChapterIsClear(arg_17_0, arg_17_1)
	if arg_17_1 and ActivityTetrisGameChapterCfg[arg_17_1] then
		for iter_17_0, iter_17_1 in ipairs(ActivityTetrisGameChapterCfg[arg_17_1].tetris_stage_list) do
