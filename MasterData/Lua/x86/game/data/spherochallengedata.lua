...
var_0_6.shopItemID = ActivityHeroChallengeCfg[ActivityConst.ACTIVITY_HERO_CHALLENGE_3_1].shop_item_id or 216000001
var_0_6.maxChallengeTimes = GameSetting.activity_hero_challenge_max_num.value[1]
var_0_5[ActivityConst.ACTIVITY_HERO_CHALLENGE_3_1] = var_0_6
var_0_0.activityCfg = var_0_5
...
function var_0_0.GetBarbuceAccelerateNum(arg_14_0)
	return (var_0_3 or nil) and (var_0_3.accelerateNum or 0)
end
