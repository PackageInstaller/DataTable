...
function var_0_0.Init(arg_1_0)
	...
	for iter_1_0, iter_1_1 in ipairs(ProfileDecorateItemCfg.all) do
		if ProfileDecorateItemCfg[iter_1_1].item_type == 4 then
			var_0_2[iter_1_1] = {
				lock = true,
				page = 0
			}
		elseif ProfileDecorateItemCfg[iter_1_1].item_type == 5 then
			var_0_1[iter_1_1] = {
				lock = true,
				page = 0
			}
		elseif ProfileDecorateItemCfg[iter_1_1].item_type == 6 then
			var_0_3[iter_1_1] = {
				lock = true,
				page = 0
			}
