...
function var_0_1:BriefListCacheAvailable(arg_2_1)
	return nullable(self.cachedSharedFromOtherDIY, arg_2_1)
end

function var_0_1:CacheBriefList(arg_3_1, arg_3_2)
	self.cachedSharedFromOtherDIY[arg_3_1] = arg_3_2
end

function var_0_1.ParseIdolProperty(arg_4_0, arg_4_1, arg_4_2)
	if arg_4_2 then
		if IdolTraineePveBattleCfg[arg_4_2] then
			local var_4_0 = {
				0,
				0,
				0,
			...
			for iter_4_0, iter_4_1 in ipairs(IdolPveNpcCfg[IdolTraineePveBattleCfg[arg_4_2].npc_id].attribute) do
				var_4_0[iter_4_0] = iter_4_1
			end

			return var_4_0, IdolTraineePveBattleCfg[arg_4_2].npc_id
		end
	else
		local var_4_1 = BackHomeHeroCfg[arg_4_1]

		if BackHomeHeroCfg[arg_4_1] then
			local var_4_2 = {
				0,
				0,
				0,
			...
			for iter_4_2, iter_4_3 in ipairs(var_4_2) do
				var_4_2[iter_4_2] = var_4_1.idol_base_attribute[iter_4_2][1]
			end
...
function var_0_1:InitDataFromServer(arg_5_1)
	self:InitAttackHeroID(arg_5_1)
	self:InitDefendHeroID(arg_5_1)
	...
	self:UpdateHeroPosList(arg_5_1)
end
...
function var_0_1.UpdateHeroPosList(arg_8_0, arg_8_1)
	...
	for iter_8_2, iter_8_3 in ipairs(arg_8_1.hero_pos_list) do
		local var_8_0 = DormData:GetHeroTemplateInfo(iter_8_3.hero_id)

		var_8_0:SetCurHeroID(iter_8_3.hero_id)
		var_8_0:GoToDance(iter_8_3.pos)
	end
end
...
function var_0_1.UpdatePveChapterData(arg_15_0, arg_15_1)
	for iter_15_0, iter_15_1 in ipairs(arg_15_1.chapter_list) do
		var_0_8[iter_15_1.chapter_id] = var_0_8[iter_15_1.chapter_id] or {}
...
local function var_0_16(arg_16_0)
	...
	var_16_0.nick = arg_16_0.profile_base.nick
	var_16_0.icon = arg_16_0.profile_base.icon
	var_16_0.icon_frame = arg_16_0.profile_base.icon_frame
	var_16_0.hero_id = BackHomeHeroSkinCfg[arg_16_0.hero_list[1].skin_id].hero_id
	var_16_0.skin_id = arg_16_0.hero_list[1].skin_id
	var_16_0.property = var_0_1.ParseIdolProperty(arg_16_0.hero_list[1].attribute_list, BackHomeHeroSkinCfg[arg_16_0.hero_list[1].skin_id].hero_id)
...
function var_0_1.GetIdolHeroList(arg_21_0, arg_21_1)
	...
	if arg_21_1 then
		...
		for iter_21_0, iter_21_1 in ipairs(BackHomeHeroCfg.all) do
...
function var_0_1.GetIdolHeroSkillList(arg_22_0, arg_22_1)
	if IdolPveNpcCfg[arg_22_1] then
		...
		for iter_22_0, iter_22_1 in ipairs(IdolPveNpcCfg[arg_22_1].idol_active_skill_list) do
			table.insert(var_22_0, {
				skill = iter_22_1
			})
		end

		for iter_22_2, iter_22_3 in ipairs(IdolPveNpcCfg[arg_22_1].idol_passive_skill_list) do
			table.insert(var_22_0, {
				skill = iter_22_3
			})
		end
...
function var_0_1.GetIdolHeroData(arg_27_0, arg_27_1)
	if not HeroTools.GetHeroIsUnlock(arg_27_1) then
		...
		for iter_27_0, iter_27_1 in pairs(BackHomeHeroCfg[arg_27_1].idol_base_attribute) do
...
function var_0_1.GetHeroPosList(arg_36_0)
	...
	for iter_36_0, iter_36_1 in pairs((DormData:GetHeroInfoList())) do
...
function var_0_1:InitDanceDIY(arg_39_1)
	self.danceDIY = {}

	for iter_39_0, iter_39_1 in ipairs(arg_39_1.sequence_list) do
		self.danceDIY[iter_39_1.pos] = var_0_1.ParseDanceDIYSequence(iter_39_1.base_sequence)
	end

	if arg_39_1.shared_sequence_list then
		self.mySharedDIY = {}

		for iter_39_2, iter_39_3 in ipairs(arg_39_1.shared_sequence_list) do
			self.mySharedDIY[iter_39_3.uid] = self:ParseSharedDIYInfo(iter_39_3)
		end
	end
end

function var_0_1:ParseDanceDIYSequence(arg_40_1)
	local var_40_0 = {}

	if self.action_id_list then
		for iter_40_0, iter_40_1 in ipairs(self.action_id_list) do
	...
	arg_40_1.scene = self.scene_id
	arg_40_1.music = self.music_id
...
function var_0_1.ParseSharedDIYInfo(arg_42_0, arg_42_1)
	...
	var_0_1.UpdateDIYStatistics(var_42_0, arg_42_1.statistics)
...
function var_0_1:UpdateMySharedDanceDIYStatistics(arg_43_1, arg_43_2)
	local var_43_0 = nullable(self.mySharedDIY, arg_43_1)
...
function var_0_1:GetDanceDIYSequence(arg_45_1)
	return nullable(self.danceDIY, arg_45_1)
end

function var_0_1:GetSharedDanceDIYSequence(arg_46_1)
	return nullable(self.mySharedDIY, arg_46_1)
end

function var_0_1:SetDanceDIYSequence(arg_47_1, arg_47_2)
	self.danceDIY[arg_47_1] = arg_47_2

	manager.notify:CallUpdateFunc("OnDanceDIYUpdate", arg_47_1, arg_47_2)
end

function var_0_1:SetSharedDanceDIYSequence(arg_48_1, arg_48_2)
	self.mySharedDIY[arg_48_1] = arg_48_2

	manager.notify:CallUpdateFunc("OnSharedDanceDIYUpdate", arg_48_1, arg_48_2)
end

function var_0_1:GetDanceDIYAvailableSlotIdx()
	for iter_49_0 = 1, var_0_1.DanceDIYSlotLimit() do
		if self.danceDIY[iter_49_0] == nil then
			return iter_49_0
		end
	end
end
...
function var_0_1.DanceDIYActionAvailable(arg_52_0, arg_52_1)
	...
	if IdolDanceDIYActionCfg[arg_52_1] then
