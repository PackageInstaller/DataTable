...
function var_0_0.EnterDormSystem(arg_3_0)
	var_0_3 = getData("BackHome", "suitHelp") or false
end
...
function var_0_0.GetSuitFurInfo(arg_7_0, arg_7_1)
	...
	if BackHomeSuitCfg[arg_7_1].type == DormSuitTools.DORM_SUIT_TYPE.FULL_SET or var_7_0 == DormSuitTools.DORM_SUIT_TYPE.PART_SET then
		local var_7_1, var_7_2 = DormSuitTools:GetDeSerializeDormSuitDataInScene(arg_7_1)

		var_0_0:GenerateSingleSuitData({
			suitID = arg_7_1,
			furList = var_7_1,
			specialFur = var_7_2,
			suitType = var_7_0,
...
function var_0_0.GetSuitNeedTotalFurNumList(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in ipairs(var_0_0:GetSuitFurInfo(arg_9_1).suit_num) do
...
function var_0_0.GetTotalCanUseFurNumBySuitInRoom(arg_10_0, arg_10_1, arg_10_2)
	...
	if var_10_0 then
		for iter_10_0, iter_10_1 in ipairs(var_0_0:GetSuitFurInfo(arg_10_1).suit_num) do
...
function var_0_0.CheckSuitCanUseInRoom(arg_11_0, arg_11_1, arg_11_2)
	for iter_11_0, iter_11_1 in ipairs(BackHomeSuitCfg[arg_11_1].suit_num) do
		if not DormSpecialFurnitureTools:JudgeIsOriSpecialFur(iter_11_1[1]) and iter_11_1[2] > DormFurEditStateData:GetCanUseFurNumInRoom(arg_11_2, iter_11_1[1]) then
			return false
		end
	end
...
function var_0_0.GetFurNeedNumBySuitID(arg_12_0, arg_12_1, arg_12_2)
	...
	for iter_12_0, iter_12_1 in ipairs(var_0_0:GetSuitFurInfo(arg_12_1).suit_num) do
...
function var_0_0.GetFurCanUseNumBySuitIDAndRoomID(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_5 = var_0_0:GetFurNeedNumBySuitID(arg_13_1, arg_13_2)

	if var_13_1 == DormSuitTools.DORM_SUIT_TYPE.FULL_SET then
		var_13_3 = DormRoomTools:GetHasPlaceFurInfoByRoom(arg_13_3, arg_13_2) + DormFurEditStateData:GetCacheFurNum(arg_13_2) + var_13_4
	elseif var_13_1 == DormSuitTools.DORM_SUIT_TYPE.PART_SET then
		var_13_3 = var_13_4
	end

	return math.min(var_13_5, var_13_3)
end

function var_0_0.GetNeedUseFurNumInfoBySuitID(arg_14_0, arg_14_1)
	if BackHomeSuitCfg[arg_14_1] then
		return BackHomeSuitCfg[arg_14_1].suit_num
	end
end
...
function var_0_0.GetSuitIDListByType(arg_20_0, arg_20_1)
	...
	for iter_20_0, iter_20_1 in ipairs(BackHomeSuitCfg.all) do
...
function var_0_0.CheckCanUseSuitInRoom(arg_21_0, arg_21_1, arg_21_2)
	...
	if BackHomeSuitCfg[arg_21_2] then
		for iter_21_0, iter_21_1 in ipairs(BackHomeSuitCfg[arg_21_2].scene_id) do
			if BackHomeCfg[arg_21_1].type == iter_21_1 then
				var_21_1 = true
...
function var_0_0.CheckIsSuit(arg_23_0, arg_23_1)
	if BackHomeSuitCfg[arg_23_1] then
		return true, BackHomeSuitCfg[arg_23_1].type
...
function var_0_0.CheckIsConfigSuit(arg_24_0, arg_24_1)
	if BackHomeSuitCfg[arg_24_1] then
		return true, BackHomeSuitCfg[arg_24_1].type
	end
end
...
function var_0_0.GetSuitCanUseFurInfo(arg_25_0, arg_25_1)
	...
	for iter_25_0, iter_25_1 in ipairs(DormSuitTools:GetDeSerializeDormSuitData(arg_25_1).numList) do
