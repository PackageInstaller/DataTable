...
function var_0_0:GetSortAttribute(arg_5_1)
	local var_5_0 = HeroRecordCfg[arg_5_1.archive_id]
	local var_5_1 = HeroRecordCfg[arg_5_1.archive_id].hero_id
	local var_5_2 = false
	local var_5_5 = 0

	for iter_5_0, iter_5_1 in ipairs(HeroRecordCfg[arg_5_1.archive_id].hero_id) do
		if HeroData:GetHeroData(var_5_1[iter_5_0]).unlock == 1 then
			var_5_2 = true
		end
	end

	local var_5_7 = #ArchiveData:GetAnedoteList(var_5_1) == #ArchiveData:GetIsViewedArhiveStoryList(arg_5_1.archive_id)
	local var_5_8 = 0
	...
	local var_5_9 = var_5_8 + #ArchiveData:GetHasViewedSuperHeartList(arg_5_1.archive_id) == #var_5_0.plot_id + #var_5_0.super_plot_id

	for iter_5_4, iter_5_5 in ipairs(var_5_1) do
		local var_5_10 = HeroData:GetHeroData(var_5_1[iter_5_4])

		if var_5_5 < self:GetTrustLevel(var_5_10.id) then
			var_5_5 = self:GetTrustLevel(var_5_10.id)
		end
	end

	return var_5_2, var_5_7, var_5_9, var_5_5, #var_5_0.super_plot_id > 0
end
...
function var_0_0.GetContinuousHeartArchiveListByType(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in pairs(var_0_1) do
		if HeroRecordCfg[iter_8_1.archive_id] and HeroCfg[HeroRecordCfg[iter_8_1.archive_id].id].race == arg_8_1 and not table.isEmpty(HeroRecordCfg[iter_8_1.archive_id].plot_id) then
...
function var_0_0.GetContinuousSuperHeartArchiveListByType(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in pairs(var_0_1) do
		if HeroCfg[HeroRecordCfg[iter_9_1.archive_id].id].race == arg_9_1 and not table.isEmpty(HeroRecordCfg[iter_9_1.archive_id].super_plot_id) then
...
function var_0_0:GetSelectPicture(arg_11_1)
	return self:GetArchive(arg_11_1).selected_picture
end
...
function var_0_0.GetAnedoteList(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in pairs(arg_15_1) do
		if HeroAnedoteCfg[iter_15_1] then
			table.insert(var_15_0, HeroAnedoteCfg[iter_15_1])
		end
	end
...
function var_0_0:GetUnlockHeartListInfoLengthByHeroId(arg_25_1)
	local var_25_0 = self:GetArchive(HeroRecordCfg.get_id_list_by_hero_id[arg_25_1][1])
	local var_25_1 = 0
	local var_25_2 = 0
	local var_25_3 = 0

	for iter_25_0 = 1, 4 do
		local var_25_4, var_25_5, var_25_6 = IsConditionAchieved(GameSetting.hero_plot_unlock_condition.value[iter_25_0], {
	...
	if #HeroRecordCfg[var_25_0.archive_id].super_plot_id > 0 then
		for iter_25_1, iter_25_2 in ipairs(HeroRecordCfg[var_25_0.archive_id].hero_id) do
			local var_25_7 = 0

			for iter_25_3 = 1, 2 do
				local var_25_8, var_25_9, var_25_10 = IsConditionAchieved(GameSetting.hero_super_plot_unlock_condition.value[iter_25_3], {
					heroId = iter_25_2
				})
			...
			var_25_2 = math.max(var_25_2, var_25_7)
		end
	end

	for iter_25_4, iter_25_5 in ipairs(HeroRecordCfg[var_25_0.archive_id].hero_id) do
		if HeroAnedoteCfg[iter_25_5] then
			local var_25_11, var_25_12, var_25_13 = IsConditionAchieved(GameSetting.hero_anecdote_unlock_condition.value[1], {
				heroId = iter_25_5
			})
...
function var_0_0.GetArchive(arg_26_0, arg_26_1)
	...
	var_0_1[arg_26_1] = var_0_1[arg_26_1] or {
		exp = 0,
		lv = 1,
		archive_id = arg_26_1,
		gift_list = {},
...
function var_0_0:AddExp(arg_27_1, arg_27_2)
	local var_27_0 = self:GetArchive(arg_27_1).exp + arg_27_2
	local var_27_1, var_27_2 = LvTools.LoveExpToLevel(var_27_0)

	var_0_1[arg_27_1].exp = var_27_0
	var_0_1[arg_27_1].lv = var_27_1

	OathSupportData:UpdateOathCanCompleteNotice(arg_27_1)
end

function var_0_0.AddGift(arg_28_0, arg_28_1, arg_28_2)
	for iter_28_0, iter_28_1 in pairs(arg_28_2) do
		var_0_1[arg_28_1].gift_list[iter_28_1.id] = (var_0_1[arg_28_1].gift_list[iter_28_1.id] or 0) + iter_28_1.num
	end
end
...
function var_0_0.UpdateTrustGiftDisplaceCount(arg_35_0, arg_35_1, arg_35_2)
	var_0_3[arg_35_1] = var_0_3[arg_35_1] and var_0_3[arg_35_1] + arg_35_2 or arg_35_2
end
