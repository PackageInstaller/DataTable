...
function var_0_0.InitData(arg_2_0, arg_2_1)
	var_0_2[(arg_2_1.chapter ~= 0 or nil) and WarchessLevelCfg[arg_2_1.chapter].type] = arg_2_1.chapter

	for iter_2_0, iter_2_1 in ipairs((cleanProtoTable(arg_2_1.chapter_info))) do
		...
		for iter_2_2, iter_2_3 in ipairs((cleanProtoTable(iter_2_1.box))) do
...
function var_0_0:InitRedPoint()
	for iter_3_0, iter_3_1 in pairs(WarchessLevelCfg.all) do
		if WarchessLevelCfg[iter_3_1].tag ~= 0 then
			local var_3_0 = string.format("%s_%s_%s", RedPointConst.WAR_CHESS, WarchessLevelCfg[iter_3_1].tag, iter_3_1)

			if self:GetChessLevelIsLock(iter_3_1) then
...
function var_0_0.GetChessLevelIsLock(arg_4_0, arg_4_1)
	if WarchessLevelCfg[arg_4_1].unlock_level ~= 0 and ChessTools.GetChapterProgress(WarchessLevelCfg[arg_4_1].unlock_level) < WarchessLevelCfg[arg_4_1].success_progress then
		return true
	end

	local var_4_0 = WarchessLevelCfg[arg_4_1].unlock_condition

	if WarchessLevelCfg[arg_4_1].unlock_condition ~= "" then
		if var_4_0[1] == 1 then
			local var_4_1 = StoryStageActivityData:GetStageData(var_4_0[2][1])[var_4_0[2][2]]

			if var_4_1 and var_4_1.clear_times >= 1 then
				-- block empty
			else
				return true
			end
		elseif var_4_0[1] == 2 then
			return not ChapterTools.IsClearStage(var_4_0[2][2])
		end
	end
...
function var_0_0:GetChessTime(arg_6_1)
	return self.activiteList_[arg_6_1]
end

function var_0_0.GetChapterInfo(arg_7_0, arg_7_1)
	var_0_6[arg_7_1] = var_0_6[arg_7_1] or {
		box = {},
		id = arg_7_1
	}
...
function var_0_0:SetWarChessData(arg_9_1, arg_9_2)
	...
	for iter_9_0, iter_9_1 in ipairs((cleanProtoTable(arg_9_2.bag.item))) do
		var_0_10.bag.item[iter_9_1.type] = iter_9_1.num
	end

	for iter_9_2, iter_9_3 in ipairs((cleanProtoTable(arg_9_2.bag.artifact))) do
		var_0_10.bag.artifact[iter_9_3] = 1
	end

	for iter_9_4, iter_9_5 in ipairs((cleanProtoTable(arg_9_2.log))) do
	...
	for iter_9_6, iter_9_7 in ipairs(arg_9_2.event_list) do
		if not WarchessGlobalCfg[iter_9_7.id] then
			error("服务端下发了客户端不存在的全局事件 id:" .. iter_9_7.id)
		end

		if WarchessGlobalCfg[iter_9_7.id].type == ChessConst.GLOBAL.EVENT then
			var_0_10.event_list[WarchessGlobalCfg[iter_9_7.id].params[1]] = iter_9_7.progress
		end

		self:SetGlobalEventProgress(WarchessGlobalCfg[iter_9_7.id].type, iter_9_7.id, iter_9_7.progress or 0)
	end

	for iter_9_8, iter_9_9 in ipairs((cleanProtoTable(arg_9_2.hp_list))) do
	...
	for iter_9_10, iter_9_11 in ipairs(arg_9_2.map) do
		local var_9_1 = ChessTools.TwoDToOneD(iter_9_11.pos.x, iter_9_11.pos.z)
		local var_9_2 = {
			tag = iter_9_11.tag,
			pos = {
				x = iter_9_11.pos.x,
		...
		var_9_2.status = iter_9_11.state or 0
		var_9_2.attribute = cleanProtoTable(iter_9_11.attribute)
		var_9_2.direction = (iter_9_11.rotation or 0) / 60
		var_9_0[var_9_1] = var_9_2
	end

	var_0_10.mapChangeInfo = var_9_0
	...
	var_0_10.guidePos = arg_9_2.guide_pos and arg_9_2.guide_pos[1] and {
		arg_9_2.guide_pos[1],
		arg_9_2.guide_pos[2]
	} or nil
	var_0_10.direction = arg_9_2.direction
	...
	for iter_9_14, iter_9_15 in ipairs(arg_9_2.event_info) do
		var_9_3[iter_9_15.event_id] = var_9_3[iter_9_15.event_id] or {}

		for iter_9_16, iter_9_17 in ipairs(iter_9_15.pos_list) do
			local var_9_4 = ChessTools.TwoDToOneD(iter_9_17.pos.x, iter_9_17.pos.z)

			var_9_3[iter_9_15.event_id][var_9_4] = var_9_3[iter_9_15.event_id][var_9_4] or {}

			table.insert(var_9_3[iter_9_15.event_id][var_9_4], iter_9_17.tag)
		end
	end

	var_0_10.eventInfo = var_9_3

	if arg_9_2.extra_gameplay and arg_9_2.extra_gameplay.ocean_gameplay then
		var_0_10.extra_gameplay = var_0_10.extra_gameplay or {}
		var_0_10.extra_gameplay.research_vessel_hp = arg_9_2.extra_gameplay.ocean_gameplay.research_vessel_hp
		var_0_10.extra_gameplay.detector_pos = cleanProtoTable(arg_9_2.extra_gameplay.ocean_gameplay.detector_pos)
		var_0_10.extra_gameplay.boss_pos = cleanProtoTable(arg_9_2.extra_gameplay.ocean_gameplay.boss_pos)
	end
end
...
function var_0_0:ModifyItemData(arg_18_1, arg_18_2)
	if var_0_10.bag.item[arg_18_1] == nil then
		var_0_10.bag.item[arg_18_1] = 0
	end

	var_0_10.bag.item[arg_18_1] = arg_18_2 > 0 and WarchessObjectCfg[arg_18_1].max ~= 0 and math.min(WarchessObjectCfg[arg_18_1].max, var_0_10.bag.item[arg_18_1] + arg_18_2) or var_0_10.bag.item[arg_18_1] + arg_18_2

	if arg_18_2 > 0 then
		for iter_18_0, iter_18_1 in pairs(self:GetGlobalEventList()[ChessConst.GLOBAL.KEY] or {}) do
			if arg_18_1 == WarchessGlobalCfg[iter_18_0].params[1] then
				self:SetGlobalEventProgress(ChessConst.GLOBAL.KEY, iter_18_0, iter_18_1 + arg_18_2)
			end
		end
	end
...
function var_0_0.ModifyArtifactData(arg_19_0, arg_19_1, arg_19_2)
	var_0_10.bag.artifact[arg_19_1] = arg_19_2 > 0 and 1 or nil
end

function var_0_0.AddAllHp(arg_20_0, arg_20_1)
	for iter_20_0, iter_20_1 in pairs(var_0_10.hp_list) do
		if (iter_20_1 == 0 and 0 or iter_20_1 + arg_20_1) > 10000 then
			var_20_0 = 10000
		end
		...
		var_0_10.hp_list[iter_20_0] = var_20_0
	end
end
...
function var_0_0.AddBoxNum(arg_27_0, arg_27_1, arg_27_2)
	...
	var_27_0.box[arg_27_2] = (var_27_0.box[arg_27_2] or 0) + 1
...
function var_0_0.AddLog(arg_29_0, arg_29_1, arg_29_2, arg_29_3, arg_29_4)
	local var_29_0 = {
		index = arg_29_2 * manager.ChessManager.map_.width + arg_29_1 + 1,
		tag = arg_29_3,
		log = arg_29_4
	}

	for iter_29_0, iter_29_1 in ipairs(var_0_10.log) do
		if table.equal(iter_29_1, var_29_0, "all") then
			return
		end
	end

	var_0_10.log[#var_0_10.log + 1] = var_29_0
end
...
function var_0_0.ChangeGridLua(arg_34_0, arg_34_1, arg_34_2, arg_34_3)
	...
	var_34_0 = arg_34_3 ~= 0 and ChessTools.CreateChessData(arg_34_1, arg_34_2, var_0_11, arg_34_3) or ChessTools.CreateChessData(arg_34_1, arg_34_2, var_0_12, ChessTools.TwoDToOneD(arg_34_1, arg_34_2))
...
function var_0_0.GetGridAttribute(arg_38_0, arg_38_1, arg_38_2)
	...
	var_0_10.mapChangeInfo[var_38_0] = var_0_10.mapChangeInfo[var_38_0] or ChessTools.CreateChessData(arg_38_1, arg_38_2, var_0_12, var_38_0)
...
function var_0_0.SetGridAttribute(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	var_0_10.mapChangeInfo[var_39_0] = var_0_10.mapChangeInfo[var_39_0] or ChessTools.CreateChessData(arg_39_1, arg_39_2, var_0_12, var_39_0)
...
function var_0_0.SetGlobalEventProgress(arg_52_0, arg_52_1, arg_52_2, arg_52_3)
	var_0_10.global_event[arg_52_1] = var_0_10.global_event[arg_52_1] or {}
...
function var_0_0.GetGlobalEventProgress(arg_53_0, arg_53_1)
	if not var_0_10.global_event[WarchessGlobalCfg[arg_53_1].type] then
		return nil
	end

	return var_0_10.global_event[WarchessGlobalCfg[arg_53_1].type][arg_53_1]
end
...
function var_0_0:GetBattleIsFinish(arg_63_1, arg_63_2, arg_63_3)
	return self:IsEventExecute(10201, arg_63_1, arg_63_2, arg_63_3)
end

function var_0_0:GetMutiBattleIsFinish(arg_64_1, arg_64_2, arg_64_3)
	return self:IsEventExecute(10207, arg_64_1, arg_64_2, arg_64_3)
end

function var_0_0.IsEventExecute(arg_65_0, arg_65_1, arg_65_2, arg_65_3, arg_65_4)
	if not var_0_10.eventInfo[arg_65_1] then
		return false
	end

	local var_65_0 = var_0_10.eventInfo[arg_65_1][ChessTools.TwoDToOneD(arg_65_2, arg_65_3)]

	if not var_65_0 then
		return false
	end

	if not table.indexof(var_65_0, arg_65_4) then
		return false
	end
...
function var_0_0.SetEventExecute(arg_66_0, arg_66_1, arg_66_2, arg_66_3, arg_66_4)
	var_0_10.eventInfo[arg_66_1] = var_0_10.eventInfo[arg_66_1] or {}

	local var_66_0 = ChessTools.TwoDToOneD(arg_66_2, arg_66_3)
	local var_66_1 = var_0_10.eventInfo[arg_66_1][var_66_0]

	if not var_0_10.eventInfo[arg_66_1][var_66_0] then
...
function var_0_0.SetRedPoint(arg_67_0, arg_67_1)
	manager.redPoint:setTip(string.format("%s_%s_%s", RedPointConst.WAR_CHESS, WarchessLevelCfg[arg_67_1].tag, arg_67_1), 0)
	RedPointAction.HandleRedPoint(RedPointConst.WARCHESS_RANGE + arg_67_1)
end

function var_0_0.GetStepCountDownNum(arg_68_0)
	if not var_0_10.global_event[ChessConst.GLOBAL.COUNT_STEP] then
		return 0
	end

	for iter_68_0, iter_68_1 in pairs(var_0_10.global_event[ChessConst.GLOBAL.COUNT_STEP]) do
		return iter_68_1
	end
end
...
function var_0_0:SetMutiBattleData(arg_75_1, arg_75_2, arg_75_3)
	local var_75_0 = self:GetMutiBattleDataWithoutType(arg_75_1) or {
		{},
		[2] = 0,
		[3] = 0
	}
	...
	if arg_75_2 == 1 then
		for iter_75_0 = 1, 3 do
			local var_75_1 = self:GetMutiBattleDataWithoutType(iter_75_0)
			...
			if var_75_1 ~= var_75_0 and var_75_1 and var_75_1[1] then
				...
				self.teamData_[iter_75_0] = var_75_2

				saveData("chessMutiBattleData", "team_" .. iter_75_0, var_75_2)
			end
		end
	end

	saveData("chessMutiBattleData", "team_" .. arg_75_1, var_75_0)
end

function var_0_0:GetMutiBattleData(arg_76_1, arg_76_2)
	if self.teamData_[arg_76_1] == nil then
		self.teamData_[arg_76_1] = getData("chessMutiBattleData", "team_" .. arg_76_1) or {
			{},
			[2] = 0,
			[3] = 0
		}
	...
	return self.teamData_[arg_76_1][arg_76_2]
end

function var_0_0:GetMutiBattleDataWithoutType(arg_77_1)
	if self.teamData_[arg_77_1] == nil then
		self.teamData_[arg_77_1] = getData("chessMutiBattleData", "team_" .. arg_77_1) or {
			{},
			[2] = 0,
			[3] = 0
		}
	...
	return self.teamData_[arg_77_1]
end

function var_0_0:SwapTeam(arg_78_1, arg_78_2)
	self.teamData_[arg_78_1] = self.teamData_[arg_78_2]
	self.teamData_[arg_78_2] = deepClone(self.teamData_[arg_78_1])

	saveData("chessMutiBattleData", "team_" .. arg_78_1, self.teamData_[arg_78_1])
	saveData("chessMutiBattleData", "team_" .. arg_78_2, self.teamData_[arg_78_2])
end
...
function var_0_0.GetGridIsChanged(arg_85_0, arg_85_1, arg_85_2)
	local var_85_0 = var_0_10.mapChangeInfo[ChessTools.TwoDToOneD(arg_85_1, arg_85_2)]

	if var_85_0 then
		if var_85_0.tag == 0 then
			return false
		else
			return true
		end
