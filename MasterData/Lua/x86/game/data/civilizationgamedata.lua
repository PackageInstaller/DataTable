...
function var_0_1:UpdateData(arg_9_1, arg_9_2, arg_9_3)
	if arg_9_3 and not table.indexof(self.stage_list, arg_9_2) then
		table.insert(self.stage_list, arg_9_2)
	end

	for iter_9_0, iter_9_1 in ipairs(arg_9_1) do
		if not table.indexof(self.illu_list, iter_9_1) then
			table.insert(self.illu_list, iter_9_1)
		end
	end
end
