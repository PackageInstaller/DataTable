...
function var_0_1:InitSimplaDormData(arg_1_1)
	self:UpdateReceivedWeekGiftNum(arg_1_1.received_be_visited_gift_num)
...
function var_0_1.InitHeroInfo(arg_12_0, arg_12_1)
	...
	if arg_12_1.backhome_hero then
		for iter_12_0, iter_12_1 in ipairs(arg_12_1.backhome_hero) do
			...
			var_12_0.feed_times = iter_12_1.feed_times or 0
			var_12_0.fatigue = iter_12_1.fatigue
			var_12_0.totalFeedTime = iter_12_1.total_feed_times
			var_12_0.isLock = iter_12_1.is_lock

			if DormHeroTools:GetTemplateIDInDorm(iter_12_1.archives_id) then
				var_0_2[iter_12_1.archives_id] = DormHeroTemplate.New(var_12_0)
			end
		end
	end
	...
	if arg_12_1.hero_setting then
		for iter_12_2, iter_12_3 in ipairs(arg_12_1.hero_setting) do
			var_0_2[HeroRecordCfg.get_id_list_by_hero_id[iter_12_3.hero_id][1]]:SetHeroSkinID(iter_12_3.hero_id, iter_12_3.skin_id)
		end
	end
end
	...
	if var_0_2 and DormHeroTools:GetTemplateIDInDorm(arg_14_1) then
		if not var_0_2[arg_14_1] then
			if DormHeroTools:GetAllCanUseHeroIDInDorm(arg_14_1)[1] then
				var_0_2[arg_14_1] = DormHeroTemplate.New({
...
function var_0_1:GetHeroTemplateInfo(arg_15_1)
	return (self:GetHeroInfo((self:GetHeroArchiveID(arg_15_1))))
end
...
function var_0_1:GetHeroFatigue(arg_17_1)
	local var_17_0 = self:GetHeroInfo((self:GetHeroArchiveID(arg_17_1)))

	if var_17_0 then
		return var_17_0.fatigue
	else
		return 0
	end
end

function var_0_1:SetHeroFatigue(arg_18_1, arg_18_2)
	local var_18_0 = self:GetHeroArchiveID(arg_18_1)

	var_0_2 = var_0_2 or {}

	if DormHeroTools:GetTemplateIDInDorm(var_18_0) then
		var_0_2[var_18_0] = var_0_2[var_18_0] or DormHeroTemplate.New({
...
function var_0_1:RefreshInDormHeroInfo(arg_20_1, arg_20_2, arg_20_3)
	if not arg_20_1 or not arg_20_2 then
		return
	end

	local var_20_0 = DormitoryData:GetDormSceneData(arg_20_1)
	local var_20_1 = self:GetHeroInfoList()
	...
	if BackHomeCfg[arg_20_1].type == DormConst.BACKHOME_TYPE.PublicDorm then
		...
		for iter_20_0, iter_20_1 in ipairs(arg_20_2) do
			...
			local var_20_3 = self:GetHeroTemplateInfo(var_20_2)
	...
	elseif BackHomeCfg[arg_20_1].type == DormConst.BACKHOME_TYPE.PrivateDorm then
		local var_20_4 = DormData:GetHeroArchiveID(arg_20_2[1])

		if var_20_0.archiveIDList[1] ~= var_20_4 and var_20_0.archiveIDList and #var_20_0.archiveIDList > 0 then
			print("该房间已被其他角色使用")
		...
		table.insert(var_20_0.archiveIDList, var_20_4)

		local var_20_5 = self:GetHeroTemplateInfo(var_20_4)

		if not arg_20_3 then
			var_20_5:SetCurHeroID(arg_20_2[1])

			var_20_5.dancePos = nil
		end

		var_20_1[var_20_4]:ResetHeroSkill()
	end
end
...
function var_0_1.GetDormSceneData(arg_23_0, arg_23_1)
	if arg_23_1 then
		if BackHomeCfg[arg_23_1] then
			if BackHomeCfg[arg_23_1].type == DormConst.BACKHOME_TYPE.Canteen then
				return CanteenData:GetCanteenSceneData()
			elseif BackHomeCfg[arg_23_1].type == DormConst.BACKHOME_TYPE.PublicDorm or BackHomeCfg[arg_23_1].type == DormConst.BACKHOME_TYPE.PrivateDorm or BackHomeCfg[arg_23_1].type == DormConst.BACKHOME_TYPE.VISITPUBLICDORM or BackHomeCfg[arg_23_1].type == DormConst.BACKHOME_TYPE.VISITPRIVATEDORM then
...
function var_0_1.GetDormSceneDataList(arg_24_0, arg_24_1)
	if arg_24_1 == DormEnum.DormSystemType.Canteen then
		return {
			CanteenData:GetCanteenSceneData()
		}
	elseif arg_24_1 == DormEnum.DormSystemType.Dormitory then
...
function var_0_1:AddFurTotalNum(arg_28_1, arg_28_2, arg_28_3)
	if var_0_3 then
		local var_28_0 = self:GetFurNumInfo(arg_28_1)

		if var_28_0.num == 0 then
			DormRedPointTools:SetIlluNewTagRed("furNew", RedPointConst.DORM_ILLU_FUR_THEME, true, (DormIlluTools.GetThemeID(arg_28_1)))
		end
	...
	if BackHomeFurniture[arg_28_1].is_give == DormConst.BACKHOME_FUR_GIVE_TYPE.SPECIFY then
		local var_28_1 = DormRoomTools:GetDormIDViaArchive(BackHomeFurniture[arg_28_1].hero_id)

		if var_28_1 then
			local var_28_2 = DormitoryData:GetDormLevel(var_28_1)

			DormRoomTools:RefreshDormExp(var_28_1, arg_28_1, arg_28_2)

			local var_28_3 = DormitoryData:GetDormLevel(var_28_1)

			if var_28_2 ~= var_28_3 then
				DormRoomTools:GetDormLevelAward(BackHomeFurniture[arg_28_1].hero_id, var_28_2, var_28_3)
				manager.notify:Invoke(DORM_PRIVATE_LEVEL_UP, var_28_1, BackHomeFurniture[arg_28_1].hero_id)
			end
		end
	end
end
...
local function var_0_8()
	...
	for iter_29_2, iter_29_3 in pairs((DormitoryData:GetDormMapList())) do
		local var_29_0, var_29_1 = DormFurnitureTools:GetHasPlaceFurNumInfoInMap(iter_29_2)

		for iter_29_4, iter_29_5 in pairs(var_29_1) do
			var_0_3[iter_29_4] = var_0_3[iter_29_4] or {
				hasPlaceNum = 0,
				num = 0,
				give_num = 0
			}
			var_0_3[iter_29_4].hasPlaceNum = var_0_3[iter_29_4].hasPlaceNum or 0
...
local function var_0_9()
	...
	for iter_30_2, iter_30_3 in pairs(var_30_0) do
		for iter_30_4, iter_30_5 in pairs(var_30_0[iter_30_2].specialFur) do
			var_0_3[iter_30_5] = var_0_3[iter_30_5] or {
				hasPlaceNum = 0,
				num = 0,
				give_num = 0
			}
...
local function var_0_10()
	...
	for iter_31_0, iter_31_1 in pairs(var_31_0) do
		for iter_31_2, iter_31_3 in pairs(var_31_0[iter_31_0].suitInfo) do
			local var_31_1 = DormSuitData:GetNeedUseFurNumInfoBySuitID(iter_31_2)

			if var_31_1 then
				for iter_31_4, iter_31_5 in ipairs(var_31_1) do
					var_0_3[iter_31_5[1]] = var_0_3[iter_31_5[1]] or {
						hasPlaceNum = 0,
						num = 0,
						give_num = 0
					}
				...
				for iter_31_6 = 0, iter_31_3.furList.Length - 1 do
					var_0_3[iter_31_3.furList[iter_31_6].id] = var_0_3[iter_31_3.furList[iter_31_6].id] or {
						hasPlaceNum = 0,
						num = 0,
						give_num = 0
					}
					var_0_3[iter_31_3.furList[iter_31_6].id].hasPlaceNum = var_0_3[iter_31_3.furList[iter_31_6].id].hasPlaceNum + 1
				end
			end
		end
	end
