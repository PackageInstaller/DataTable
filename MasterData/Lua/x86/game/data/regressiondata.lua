...
function var_0_0.InitData(arg_2_0, arg_2_1)
	...
	if arg_2_1.bp ~= nil then
		var_0_11 = arg_2_1.bp.is_recharge

		for iter_2_2, iter_2_3 in ipairs(arg_2_1.bp.bp_assignment) do
	...
	if arg_2_1.gashapon_reward ~= nil then
		for iter_2_4, iter_2_5 in ipairs(arg_2_1.gashapon_reward) do
			var_0_9[iter_2_5.id] = {
				id = iter_2_5.id,
...
function var_0_0.IsRegressionOpen(arg_3_0)
	...
	return manager.time:GetServerTime() < var_0_2 + 86400 * GameSetting.return_duration_time.value[1]
end

function var_0_0:CheckRegressionGift()
	return self:IsRegressionOpen() and var_0_7 == 0
end
...
function var_0_0.GetSignIndex(arg_11_0)
	...
	if RegressionCfg[var_0_1] then
		local var_11_1 = RegressionCfg[var_0_1].sign_reward or {}
