...
function var_0_0.GetStageInfoByStageID(arg_5_0, arg_5_1)
	if arg_5_1 then
		...
		elseif ActivityTangramGameStageCfg[arg_5_1] then
			var_0_2[arg_5_1] = TangramGameStageTemplate.New({
				stage_id = arg_5_1
			})
...
function var_0_0:CheckStageIsClear(arg_6_1)
	return self:GetStageInfoByStageID(arg_6_1).isFin
end

function var_0_0.GetChapterFinProcess(arg_7_0, arg_7_1)
	if ActivityTangramGameChapterCfg[arg_7_1] then
		local var_7_0 = 0

		for iter_7_0, iter_7_1 in ipairs(ActivityTangramGameChapterCfg[arg_7_1].puzzle_stage_list) do
			if var_0_2[iter_7_1] and var_0_2[iter_7_1].isFin then
				var_7_0 = var_7_0 + 1
			end
		end

		return #ActivityTangramGameChapterCfg[arg_7_1].puzzle_stage_list <= var_7_0, var_7_0, #ActivityTangramGameChapterCfg[arg_7_1].puzzle_stage_list
	end
end

function var_0_0:GetChapterFinTotalProcess(arg_8_1)
	local var_8_0 = self:GetStageInfoByStageID(ActivityTangramGameChapterCfg[arg_8_1].inference_stage_list[1]).isFin

	return self:GetChapterFinProcess(arg_8_1) and var_8_0, var_8_0
end
...
function var_0_0.CheckDecodeResult(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in ipairs(ActivityTangramGameStageCfg[arg_12_1].answer) do
	...
	return var_12_0, ActivityTangramGameStageCfg[arg_12_1].answer
end
...
function var_0_0.GetErrorIndexList(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in ipairs(var_0_3) do
		if iter_14_1.stageID ~= 0 and iter_14_1.stageID ~= ActivityTangramGameStageCfg[arg_14_1].answer[iter_14_0] and not var_0_4[iter_14_0] then
