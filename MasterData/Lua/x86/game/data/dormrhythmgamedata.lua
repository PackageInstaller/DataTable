...
local function var_0_10()
	for iter_2_0, iter_2_1 in ipairs(var_0_8[var_0_1.levelID].check_speed) do
		if iter_2_1[1] > var_0_2.deterGenNum then
			var_0_2.gameSpeed = var_0_8[var_0_1.levelID].check_speed[iter_2_0 - 1][2]

			return
		end
	end

	var_0_2.gameSpeed = var_0_8[var_0_1.levelID].check_speed[#var_0_8[var_0_1.levelID].check_speed][2]
end

local function var_0_11()
	for iter_3_0, iter_3_1 in ipairs(var_0_8[var_0_1.levelID].check_hit_length) do
		if iter_3_1[1] > var_0_2.deterGenNum then
			var_0_2.deterLength = var_0_8[var_0_1.levelID].check_hit_length[iter_3_0 - 1][2]

			return
		end
	end

	var_0_2.deterLength = var_0_8[var_0_1.levelID].check_hit_length[#var_0_8[var_0_1.levelID].check_hit_length][2]
end

local function var_0_12()
	for iter_4_0, iter_4_1 in ipairs(var_0_8[var_0_1.levelID].time_interval) do
		if iter_4_1[1] > var_0_2.deterGenNum then
			var_0_2.interval = var_0_8[var_0_1.levelID].time_interval[iter_4_0 - 1][2]

			return
		end
	end

	var_0_2.interval = var_0_8[var_0_1.levelID].time_interval[#var_0_8[var_0_1.levelID].time_interval][2]
end
...
local function var_0_15()
	...
	if var_0_4[var_0_5] and var_0_2.gameRunFlag then
		if not isNil(var_0_7.parentTrs) and var_0_7.parentTrs.rect.width / 2 - var_0_4[var_0_5].trs.localPosition.x > var_0_4[var_0_5].trs.rect.width + math.random(var_0_2.interval[1], var_0_2.interval[2]) * 10 then
			var_0_5 = var_0_5 + 1
			var_0_2.deterGenNum = var_0_2.deterGenNum + 1
			var_0_4[var_0_5] = DormRhythmItemTemplate.New(var_0_7, {
				index = var_0_5,
...
local function var_0_20(arg_13_0)
	...
	var_0_1.levelID = var_13_0 == 1 and arg_13_0.diff or var_0_8.get_id_list_by_difficult[arg_13_0.diff][1]
end
...
function var_0_0.GetLevelIDByDiff(arg_21_0, arg_21_1, arg_21_2)
	...
	if (arg_21_2 or 1) == 1 then
		return arg_21_1
	end

	if DormRhythmGameTools.gameConfigData[var_21_0] then
		return DormRhythmGameTools.gameConfigData[var_21_0].stageCfg.get_id_list_by_difficult[arg_21_1][1]
	end
end
...
function var_0_0:ClickDetermination(arg_30_1)
	if var_0_2.gameRunFlag then
		...
		if var_0_4 then
			...
			for iter_30_0, iter_30_1 in pairs(var_0_4) do
				if iter_30_1.go and not self.hasCheck then
					local var_30_2, var_30_3 = iter_30_1:CheckHit(var_30_0)
			...
			var_0_0:UpdateBatterNum(var_30_1, arg_30_1, false)

			return var_30_1 and 1 or 0
		end
	end
end
