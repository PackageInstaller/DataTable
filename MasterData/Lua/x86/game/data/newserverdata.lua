...
function var_0_0.InitData(arg_2_0, arg_2_1)
	...
	if arg_2_1.bp ~= nil then
		var_0_7 = arg_2_1.bp.is_recharge
	...
	if arg_2_1.gashapon_reward_list ~= nil then
		for iter_2_4, iter_2_5 in ipairs(arg_2_1.gashapon_reward_list) do
			var_0_5[iter_2_5.id] = {
				id = iter_2_5.id,
...
function var_0_0.GetSignIndex(arg_6_0)
	if NewServerCfg[var_0_1] then
		local var_6_0 = NewServerCfg[var_0_1].sign_reward or {}

		if var_0_2 >= #var_6_0 then
			return #var_6_0
		end

		if manager.time:GetTodayFreshTime() > var_0_3 then
			return var_0_2 + 1
		end
	end
