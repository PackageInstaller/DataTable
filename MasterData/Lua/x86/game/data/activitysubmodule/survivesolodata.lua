...
function var_0_0.InitData(arg_2_0, arg_2_1)
	if not var_0_1[arg_2_1.activity_id] then
		...
		var_0_1[arg_2_1.activity_id].time = 0
		var_0_1[arg_2_1.activity_id].rewards = {}
		var_0_1[arg_2_1.activity_id].activityID = arg_2_1.activity_id
	end

	var_0_1[arg_2_1.activity_id].time = arg_2_1.survival_time
	var_0_1[arg_2_1.activity_id].rewards = arg_2_1.got_reward_list or {}
end
