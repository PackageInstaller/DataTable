...
function var_0_0.InitData(arg_2_0, arg_2_1)
	if not var_0_1[arg_2_1.activity_id] then
		...
		var_0_1[arg_2_1.activity_id].activityID = arg_2_1.activity_id
		var_0_1[arg_2_1.activity_id].open = arg_2_1.activity_point > -10000
	end

	var_0_1[arg_2_1.activity_id].score = arg_2_1.activity_point or -10000
	var_0_1[arg_2_1.activity_id].reward = cleanProtoTable(arg_2_1.reward_info, {
		"point_id",
		"point_reward_state"
	})
end
...
function var_0_0.GetRewardCount(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in ipairs(ActivityData:GetActivityData(arg_12_1).subActivityIdList) do
...
function var_0_0.IsRewardRedPointShow(arg_13_0, arg_13_1)
	if var_0_1[arg_13_1] then
		for iter_13_0, iter_13_1 in ipairs(var_0_1[arg_13_1].reward) do
			if var_0_1[arg_13_1].score > ActivityPointRewardCfg[iter_13_1.point_id].need and iter_13_1.point_reward_state == 1 then
				return true
			end
		end
	end
