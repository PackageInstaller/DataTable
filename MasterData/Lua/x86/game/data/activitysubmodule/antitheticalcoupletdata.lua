...
function var_0_0.InitData(arg_2_0, arg_2_1)
	if not var_0_1[arg_2_1.activity_id] then
		...
		var_0_1[arg_2_1.activity_id].id = arg_2_1.activity_id
		var_0_1[arg_2_1.activity_id].isOpen = arg_2_1.select_id ~= 0
	end

	var_0_1[arg_2_1.activity_id].chooseID = arg_2_1.select_id
	var_0_1[arg_2_1.activity_id].isReward = arg_2_1.is_already_receive
end
