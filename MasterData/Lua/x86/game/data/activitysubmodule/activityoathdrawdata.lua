...
function var_0_0:InitDrawData(arg_2_1)
	...
	self.sceneList_, self.sceneListDropList_, self.giftID_, self.giftDropID_ = OathDrawTools.GetAllReward(self.mainActivityId_)
	self.skinID_ = OathDrawTools.GetGiftReward(self.giftID_)
	...
	local var_2_0 = ActivityLimitedDrawPoolListCfg.get_id_list_by_activity_id[arg_2_1.activity_id][1]

	var_0_2[arg_2_1.activity_id].last_drop = arg_2_1.draw_info2.last_drop
	var_0_2[arg_2_1.activity_id].drawing_list = {}

	for iter_2_2, iter_2_3 in ipairs(arg_2_1.draw_info2.already_drop) do
		table.insert(var_0_2[arg_2_1.activity_id].drawing_list, {
			index = iter_2_2,
			dropID = iter_2_3,
			isOpen = iter_2_3 ~= 0,
			poolID = var_2_0
...
function var_0_0:RefreshData(arg_3_1, arg_3_2, arg_3_3)
	self:GetRemainCanDrawCnt(arg_3_1)

	if var_0_1[arg_3_1] then
		var_0_1[arg_3_1][arg_3_2].num = var_0_1[arg_3_1][arg_3_2].num - 1 >= 0 and var_0_1[arg_3_1][arg_3_2].num - 1 or 0
	end
...
function var_0_0.GetDrawInfo(arg_12_0, arg_12_1, arg_12_2)
	return (var_0_1[arg_12_1] or nil) and (var_0_1[arg_12_1][arg_12_2] or nil)
end

function var_0_0:IsGetSkinLastDrop(arg_13_1)
	local var_13_0

	for iter_13_0, iter_13_1 in pairs(WeddingSkinDrawCfg[arg_13_1].poolList) do
		if ActivityLimitedDrawPoolListCfg[iter_13_1].pool_type == 1 then
			var_13_0 = ActivityLimitedDrawPoolListCfg[iter_13_1].activity_id[1]

			break
		end
	end

	local var_13_1 = self:GetDrawInfo(var_13_0, self.giftDropID_)

	if var_13_1 and var_13_1.num <= 0 then
		return true
	end
...
function var_0_0:GetActivityList()
	...
	if self.mainActivityId_ then
		if ActivityData:GetActivityData(self.mainActivityId_):IsActivitying() then
			table.insert(var_14_0, self.mainActivityId_)
		end
	end
...
function var_0_0:GetMainActivityID()
	return self.mainActivityId_
end

function var_0_0:GetGiftID()
	return self.giftID_, self.giftDropID_
end

function var_0_0:GetSceneID(arg_17_1)
	return self.sceneList_[arg_17_1]
end

function var_0_0:GetSceneDropID(arg_18_1)
	return self.sceneListDropList_[arg_18_1]
end
