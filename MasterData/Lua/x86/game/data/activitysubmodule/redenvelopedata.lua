...
function var_0_0.GetCurDays(arg_4_0)
	...
	for iter_4_0, iter_4_1 in ipairs(ActivitySpringRedEnvelopeCfg.all) do
		if ActivityData:GetActivityIsOpen(ActivitySpringRedEnvelopeCfg[iter_4_1].sub_activity_id) then
			var_4_0 = var_4_0 + 1
		end
	end
...
function var_0_0.TotalSignDay(arg_9_0)
	return (ActivitySpringRedEnvelopeCfg or nil) and (#ActivitySpringRedEnvelopeCfg.all or 7)
end
...
function var_0_0.UpdateRedDotCount(arg_18_0, arg_18_1)
	if var_0_4 and #var_0_4 > 0 and QWorldTools.CheckTagCanOpen(var_0_7) then
		for iter_18_0, iter_18_1 in ipairs(ActivityCfg[arg_18_1].sub_activity_list) do
			manager.redPoint:setTip(RedPointConst.ACTIVITY_RED_ENVELOPE_CAN_CLAIMED .. "_" .. iter_18_1, 0)
		end

		for iter_18_2 = 1, #var_0_4 do
			manager.redPoint:setTip(RedPointConst.ACTIVITY_RED_ENVELOPE_CAN_CLAIMED .. "_" .. 3135900 + (var_0_4[iter_18_2] - 1000), 1)
		end
	else
		for iter_18_3, iter_18_4 in ipairs(ActivityCfg[arg_18_1].sub_activity_list) do
