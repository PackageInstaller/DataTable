...
function var_0_0.IsSkadiLevelPointShow(arg_11_0)
	for iter_11_0, iter_11_1 in pairs(var_0_2) do
		local var_11_0 = ActivityData:GetActivityData(iter_11_0).stopTime
		local var_11_1 = manager.time:GetServerTime()

		if ActivityData:GetActivityData(iter_11_0).startTime <= var_11_1 and var_11_1 <= var_11_0 and #iter_11_1.star < 1 then
			return true
		end
	end
...
function var_0_0.IsLeviathanLevelPointShow(arg_13_0)
	for iter_13_0, iter_13_1 in pairs(var_0_1) do
		local var_13_0 = ActivityData:GetActivityData(iter_13_0).stopTime
		local var_13_1 = manager.time:GetServerTime()

		if ActivityData:GetActivityData(iter_13_0).startTime <= var_13_1 and var_13_1 <= var_13_0 and iter_13_1 == 0 then
			return true
		end
	end
