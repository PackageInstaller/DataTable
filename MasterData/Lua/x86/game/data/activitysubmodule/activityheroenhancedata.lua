...
function var_0_0.InitData(arg_2_0, arg_2_1)
	var_0_1[arg_2_1.activity_id] = arg_2_1.day

	if var_0_5 then
		for iter_2_0, iter_2_1 in ipairs(arg_2_1.mission_list) do
			if not table.indexof(var_0_2[arg_2_1.activity_id] or {}, iter_2_1) and not table.indexof(var_0_4, iter_2_1) then
				table.insert(var_0_4, iter_2_1)
			end
		end
	end

	var_0_2[arg_2_1.activity_id] = arg_2_1.mission_list
	var_0_3[arg_2_1.activity_id] = arg_2_1.talent_list
...
function var_0_0.ActivateTalent(arg_5_0, arg_5_1, arg_5_2)
	if table.keyof(var_0_3[arg_5_1], arg_5_2) then
		return
	end

	local var_5_0 = ActivityHeroEnhanceTools.GetCfgByTalentId(arg_5_1, arg_5_2)

	for iter_5_0, iter_5_1 in ipairs((ActivityHeroEnhanceTools.GetCfgTalentListByStage(var_5_0, TalentTreeCfg[arg_5_2].stage))) do
		table.removebyvalue(var_0_3[arg_5_1], iter_5_1)
	end

	table.insert(var_0_3[arg_5_1], arg_5_2)
	var_0_6(arg_5_1, var_5_0.talent_list)
end

function var_0_0.DeactivateTalent(arg_6_0, arg_6_1, arg_6_2)
	if var_0_3[arg_6_1] == nil then
		return
	end

	table.removebyvalue(var_0_3[arg_6_1], arg_6_2)
	var_0_6(arg_6_1, ActivityHeroEnhanceTools.GetCfgByTalentId(arg_6_1, arg_6_2).talent_list)
end

function var_0_0.AddClearedStage(arg_7_0, arg_7_1, arg_7_2)
	if table.indexof(var_0_2[arg_7_1], arg_7_2) then
		-- block empty
	else
		...
		table.insert(var_0_2[arg_7_1], arg_7_2)
	end
end
