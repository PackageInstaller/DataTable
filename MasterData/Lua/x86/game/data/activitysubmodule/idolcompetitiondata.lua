	...
	for iter_4_0, iter_4_1 in ipairs(arg_4_1.phase_record_list) do
		...
		for iter_4_2, iter_4_3 in ipairs(iter_4_1.record_list) do
			...
			for iter_4_4, iter_4_5 in ipairs(iter_4_3.battle_detail_list) do
				...
				var_4_1.npc = iter_4_5.user1_battle_data.is_npc_hero or false
				var_4_1.advantage = iter_4_5.user1_battle_data.peculiarity_score
				var_4_1.skillAdd = iter_4_5.user1_battle_data.skill_add_score
				var_4_1.skillReduce = iter_4_5.user1_battle_data.skill_decrease_score
				var_4_0.player1Info = var_4_1
				...
				var_4_2.npc = iter_4_5.user2_battle_data.is_npc_hero or false
				var_4_2.advantage = iter_4_5.user2_battle_data.peculiarity_score
				var_4_2.skillAdd = iter_4_5.user2_battle_data.skill_add_score
				var_4_2.skillReduce = iter_4_5.user2_battle_data.skill_decrease_score
				var_4_0.player2Info = var_4_2
				var_4_0.result = iter_4_5.battle_result
				var_0_2[arg_4_2].schedule[iter_4_1.phase].recordData[iter_4_2].battleData[iter_4_4] = var_4_0
			end
		end
	end
...
function var_0_0:TryToRequestNewPhaseData(arg_5_1, arg_5_2)
	if not var_0_3[arg_5_1] then
		ShowTips("IDOL_COMPETITION_RACE_COMING")

		return
	end

	if var_0_3[arg_5_1] >= 4 or not self:CheckMeTakePartIn(arg_5_1) then
		arg_5_2()

		return
	end

	if var_0_3[arg_5_1] < var_0_1[arg_5_1].phase then
...
function var_0_0.GetSignUpInfo(arg_13_0, arg_13_1)
	...
	if var_0_1[arg_13_1] then
		for iter_13_0, iter_13_1 in ipairs(ActivityIdolCompetitionCfg[arg_13_1].stage_id_list) do
