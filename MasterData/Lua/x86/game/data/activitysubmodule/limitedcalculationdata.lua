...
function var_0_0.SetData(arg_2_0, arg_2_1)
	if not var_0_1[arg_2_1.activity_id] then
		...
		var_2_0.lastDifficulty = getData("LimitedCalculation", "lastDifficulty" .. arg_2_1.activity_id) or 1
	...
	for iter_2_4, iter_2_5 in ipairs(arg_2_1.got_reward_list) do
		if var_2_1[iter_2_5] then
			var_2_1[iter_2_5].complete_flag = 1
		end
	end

	var_0_1[arg_2_1.activity_id].rewards = var_2_1
	var_0_1[arg_2_1.activity_id].difficultyList = {}

	local var_2_2 = ActivityData:GetActivityData(arg_2_1.activity_id)

	if var_2_2 then
		for iter_2_6, iter_2_7 in ipairs(var_2_2.subActivityIdList or {}) do
			if ActivityTemplateConst.LIMITED_DIFFICULTY == ActivityTools.GetActivityType(iter_2_7) then
