...
function var_0_0.UpdatePostInfo(arg_3_0)
	...
	for iter_3_0, iter_3_1 in ipairs(RogueCardPostingCfg.all) do
		...
		var_3_1 = var_3_0 and var_3_0 >= 0 and var_3_0 or RogueCardGameTools.GetIsFinishPreById(iter_3_1) and 1 or 0
		var_0_21[iter_3_1] = {
			post_id = iter_3_1,
...
function var_0_0.UpdateLocalNum(arg_7_0)
	...
	for iter_7_0, iter_7_1 in ipairs(var_0_3) do
		if iter_7_1 ~= 107 then
			var_0_19 = var_0_19 + RogueCardPostingCfg[iter_7_1].fans

			for iter_7_2, iter_7_3 in ipairs(RogueCardPostingCfg.get_id_list_by_pre_id[iter_7_1]) do
				if RogueCardPostingCfg[iter_7_3].type == 2 then
					var_0_16 = var_0_16 + RogueCardPostingCfg[iter_7_3].likes
				end
			end

			for iter_7_4, iter_7_5 in ipairs(RogueCardPostingCfg.get_id_list_by_pre_id[iter_7_1]) do
				if RogueCardPostingCfg[iter_7_5].type == 2 then
					var_0_17 = var_0_17 + RogueCardPostingCfg[iter_7_5].views
				end
			end

			for iter_7_6, iter_7_7 in ipairs(RogueCardPostingCfg.get_id_list_by_pre_id[iter_7_1]) do
				if RogueCardPostingCfg[iter_7_7].type == 2 then
					var_0_18 = var_0_18 + #RogueCardPostingCfg[iter_7_7].comments

					for iter_7_8, iter_7_9 in ipairs(RogueCardPostingCfg[iter_7_7].comments) do
						var_0_18 = var_0_18 + (#RogueCardCommentCfg[iter_7_9].comment_sub or 0)
					end
				end
			end
		end
...
function var_0_0.SeparateList(arg_27_0)
	...
	for iter_27_0, iter_27_1 in ipairs(var_0_8) do
		if RogueCardItemCfg[iter_27_1].type == 1 then
			table.insert(var_0_11, iter_27_1)
		elseif RogueCardItemCfg[iter_27_1].type == 2 then
			table.insert(var_0_10, iter_27_1)
		elseif RogueCardItemCfg[iter_27_1].type == 3 then
...
function var_0_0.AddLikePost(arg_39_0, arg_39_1)
	if not table.indexof(var_0_5, arg_39_1) then
		...
		table.remove(var_0_5, (table.indexof(var_0_5, arg_39_1)))
	end
end
...
function var_0_0.InitRedPointGroup(arg_44_0)
	...
	for iter_44_0, iter_44_1 in pairs(ActivityCfg[ActivityConst.ACTIVITY_ROGUECARD_TASK].sub_activity_list) do
		table.insert(var_44_0, RedPointConst.ACTIVITY_ROGUECARD_LIMIT_TASK_TAG .. iter_44_1)
	end

	manager.redPoint:addGroup(RedPointConst.ACTIVITY_ROGUECARD_LIMIT_TASK .. ActivityConst.ACTIVITY_ROGUECARD_TASK, var_44_0)

	local var_44_1 = {}

	for iter_44_2, iter_44_3 in pairs(AssignmentCfg.get_id_list_by_activity_id[ActivityConst.ACTIVITY_ROGUECARD_TASK]) do
		table.insert(var_44_1, RedPointConst.ACTIVITY_ROGUECARD_LIMIT_TASK_POINT .. iter_44_3)
	end

	manager.redPoint:addGroup(RedPointConst.ACTIVITY_ROGUECARD_LIMIT_TASK .. ActivityConst.ACTIVITY_ROGUECARD_TASK, var_44_1)
	...
	manager.redPoint:addGroup(RedPointConst.ACTIVITY_ROGUECARD_5_0 .. ActivityConst.ACTIVITY_ROGUECARD_5_0, {
		RedPointConst.ACTIVITY_ROGUECARD_RESIDENT_TASK .. ActivityConst.ACTIVITY_ROGUECARD_5_0,
		RedPointConst.ACTIVITY_ROGUECARD_LIMIT_TASK .. ActivityConst.ACTIVITY_ROGUECARD_TASK,
		RedPointConst.ACTIVITY_ROGUECARD_SKIN_DLC_GIFT .. ActivityConst.ACTIVITY_ROGUECARD_SKIN,
...
function var_0_0:UpdatePointRed()
	...
	for iter_49_0, iter_49_1 in pairs(AssignmentCfg.get_id_list_by_activity_id[ActivityConst.ACTIVITY_ROGUECARD_5_0] or {}) do
		if not TaskData2:GetTaskComplete(iter_49_1) and TaskData2:GetTaskProgress(iter_49_1) >= AssignmentCfg[iter_49_1].need then
			var_49_0 = true
	...
	local var_49_1 = RedPointConst.ACTIVITY_ROGUECARD_RESIDENT_TASK .. ActivityConst.ACTIVITY_ROGUECARD_5_0

	if var_49_0 then
		manager.redPoint:setTip(var_49_1, 1)
	else
		manager.redPoint:setTip(var_49_1, 0)
	end

	local var_49_2 = ActivityData:GetActivityIsOpen(ActivityConst.ACTIVITY_ROGUECARD_SKIN)

	for iter_49_2, iter_49_3 in pairs(AssignmentCfg.get_id_list_by_activity_id[ActivityConst.ACTIVITY_ROGUECARD_SKIN]) do
		if var_49_2 then
			local var_49_3 = TaskData2:GetTaskProgress(iter_49_3)

			if TaskData2:GetTaskComplete(iter_49_3) then
				manager.redPoint:setTip(RedPointConst.ACTIVITY_ROGUECARD_SKIN_DLC_GIFT .. ActivityConst.ACTIVITY_ROGUECARD_SKIN, 0)
			elseif var_49_3 >= AssignmentCfg[iter_49_3].need then
				manager.redPoint:setTip(RedPointConst.ACTIVITY_ROGUECARD_SKIN_DLC_GIFT .. ActivityConst.ACTIVITY_ROGUECARD_SKIN, 1)
	...
	self:UpdateIllustratedRedPoint()
end
...
function var_0_0.UpdateLimitedTaskRedPoint(arg_50_0)
	if ActivityData:GetActivityIsOpen(ActivityConst.ACTIVITY_ROGUECARD_TASK) then
		for iter_50_0, iter_50_1 in pairs(ActivityCfg[ActivityConst.ACTIVITY_ROGUECARD_TASK].sub_activity_list) do
			local var_50_0 = ActivityData:GetActivityIsOpen(iter_50_1)

			for iter_50_2, iter_50_3 in pairs(AssignmentCfg.get_id_list_by_activity_id[iter_50_1]) do
				if var_50_0 then
					local var_50_1 = TaskData2:GetTaskProgress(iter_50_3)

					if TaskData2:GetTaskComplete(iter_50_3) then
						manager.redPoint:setTip(RedPointConst.ACTIVITY_ROGUECARD_LIMIT_TASK_TAG .. iter_50_1, 0)
					elseif var_50_1 >= AssignmentCfg[iter_50_3].need then
						manager.redPoint:setTip(RedPointConst.ACTIVITY_ROGUECARD_LIMIT_TASK_TAG .. iter_50_1, 1)
		...
		for iter_50_4, iter_50_5 in pairs(AssignmentCfg.get_id_list_by_activity_id[ActivityConst.ACTIVITY_ROGUECARD_TASK]) do
			manager.redPoint:setTip(RedPointConst.ACTIVITY_ROGUECARD_LIMIT_TASK_POINT .. iter_50_5, (not TaskData2:GetTaskComplete(iter_50_5) and TaskData2:GetTaskProgress(iter_50_5) >= AssignmentCfg[iter_50_5].need or nil) and 1)
		end
	end
end

function var_0_0:UpdateIllustratedRedPoint()
	self:UpdateIllustratedRedPoint_JockerWuchang()
	self:UpdateIllustratedRedPoint_Weal()
	self:UpdateIllustratedRedPoint_Enhance()
end
...
function var_0_0.UpdateIllustratedRedPoint_JockerWuchang(arg_52_0)
	...
	for iter_52_0, iter_52_1 in ipairs(var_0_8) do
		if not table.indexof(var_0_32, iter_52_1) then
			if RogueCardItemCfg[iter_52_1].type == 1 or RogueCardItemCfg[iter_52_1].type == 2 then
				var_52_1 = true
			elseif RogueCardItemCfg[iter_52_1].type == 3 then
				var_52_0 = true
			end
		end
	end
...
function var_0_0.ClearIllustratedRedPoint_Wuchang(arg_56_0)
	...
	for iter_56_0, iter_56_1 in ipairs(var_0_8) do
		if not table.indexof(var_0_32, iter_56_1) then
			if RogueCardItemCfg[iter_56_1].type == 1 or RogueCardItemCfg[iter_56_1].type == 2 then
...
function var_0_0:SetIllustratedRedPoint_JockerWuchang(arg_57_1)
...
function var_0_0:SetIllustratedRedPoint_Weal(arg_59_1)
...
function var_0_0:SetIllustratedRedPoint_Enhance(arg_61_1)
