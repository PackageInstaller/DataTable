...
function var_0_0:EnabledActivity(arg_2_1, arg_2_2)
	if arg_2_2 then
		table.insert(self.activityActiveList_, arg_2_1)
	else
		table.removebyvalue(self.activityActiveList_, arg_2_1)
	end
end
...
function var_0_0:GetActivityList()
	return self.activityActiveList_
end
