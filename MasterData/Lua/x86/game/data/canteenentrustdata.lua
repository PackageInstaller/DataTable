...
function var_0_0:InitSimpleCanteenEntrustData(arg_1_1)
	self:Init(arg_1_1.canteens[1].entrust)
end

function var_0_0:InitDetailCanteenEntrustData(arg_2_1)
	self:Init(arg_2_1.canteens[1].entrust)
	self:InitTaskTimeLevel()
end
...
function var_0_0:Init(arg_4_1)
	...
	for iter_4_0, iter_4_1 in ipairs(arg_4_1) do
		self:InitEntrustData(iter_4_1)
	end

	for iter_4_2 = 1, #GameSetting.dorm_canteen_task_unlock.value do
		if not var_0_1[iter_4_2] then
			self:InitEntrustData({
				id = -1,
				pos = iter_4_2
			})
		end
...
function var_0_0.CalcEntrustLastTime(arg_7_0, arg_7_1)
	local var_7_0 = arg_7_1.start_time + BackHomeCanteenTaskCfg[arg_7_1.id].time[arg_7_1.timeLevel][1] * 60 - manager.time:GetServerTime()

	if var_7_0 > 0 then
		arg_7_1.lastTime = var_7_0

		return manager.time:DescCDTime(var_7_0)
	else
		arg_7_1.lastTime = 0
...
function var_0_0.GetEntrustLastTime(arg_8_0, arg_8_1)
	if var_0_1[arg_8_1] and var_0_0:IsEntrustStarted(var_0_1[arg_8_1]) then
		return var_0_0:CalcEntrustLastTime(var_0_1[arg_8_1])
	end
end
...
function var_0_0.InsertToDispatchCharacterList(arg_16_0, arg_16_1)
	...
	for iter_16_0, iter_16_1 in ipairs(var_0_3) do
		if DormData:GetHeroArchiveID(iter_16_1) == var_16_0 then
	...
	if BackHomeCanteenTaskCfg[var_0_4.id].need[2] > #var_0_3 then
...
function var_0_0.CheckDispatchCharacterArchiveList(arg_20_0, arg_20_1)
	if var_0_3 then
		for iter_20_0, iter_20_1 in ipairs(var_0_3) do
			if HeroRecordCfg.get_id_list_by_hero_id[iter_20_1][1] == HeroRecordCfg.get_id_list_by_hero_id[arg_20_1][1] then
				return true
			end
		end
	...
	for iter_21_0, iter_21_1 in pairs(var_0_1) do
		if iter_21_1.hero_list then
			for iter_21_2, iter_21_3 in ipairs(iter_21_1.hero_list) do
				if HeroRecordCfg.get_id_list_by_hero_id[arg_21_1][1] == HeroRecordCfg.get_id_list_by_hero_id[iter_21_3][1] then
					return true
				end
			end
		end
...
function var_0_0:CalculateEntrustSuccess()
	if #var_0_3 == 0 then
		return 0
	end
	...
	for iter_23_0, iter_23_1 in ipairs(var_0_3) do
		var_23_1 = var_23_1 + self:CalHeroMatchNum(iter_23_1, var_23_0)
	end

	local var_23_2 = var_23_1 * BackHomeCanteenTaskCfg[var_0_4.id].tag_success

	for iter_23_2, iter_23_3 in ipairs(var_0_3) do
		var_23_2 = var_23_2 + DormSkillData:GetSkillEffect(CanteenConst.HeroSkillType.EntrustExternSucceedAdd, iter_23_3)
	end

	return (BackHomeCanteenTaskCfg[var_0_4.id].base_success + var_23_2 > 100 or nil) and 100
end
...
function var_0_0.CalHeroMatchNum(arg_24_0, arg_24_1, arg_24_2)
	...
	for iter_24_0, iter_24_1 in ipairs(arg_24_2) do
		...
		elseif iter_24_1.type == 2 then
			if HeroCfg[arg_24_1].race == iter_24_1.tag then
				var_24_0 = var_24_0 + 1
			end
		elseif iter_24_1.type == 3 then
			if HeroCfg[arg_24_1].ATK_attribute[1] == iter_24_1.tag then
				var_24_0 = var_24_0 + 1
			end
		elseif iter_24_1.type == 4 and HeroCfg[arg_24_1].mechanism_type[1] == iter_24_1.tag then
			var_24_0 = var_24_0 + 1
		end
	end
...
function var_0_0.RefreshEntrustData(arg_28_0, arg_28_1, arg_28_2)
	...
	CanteenAction:RefreshEntrust((arg_28_2 == nil or nil) and DormData:GetCurrectSceneID(), arg_28_1)
end

function var_0_0:EntrustFinish(arg_29_1, arg_29_2)
	self:CalEntrustAward(arg_29_1)

	if arg_29_2 then
		for iter_29_0, iter_29_1 in ipairs(arg_29_2) do
			self:InitEntrustData(iter_29_1)
		end
	end
...
function var_0_0.IsEntrustStarted(arg_38_0, arg_38_1)
	...
	if arg_38_1.id ~= -1 then
		::label_38_0::

		var_38_0 = arg_38_1.start_time and arg_38_1.start_time > 0
	end
