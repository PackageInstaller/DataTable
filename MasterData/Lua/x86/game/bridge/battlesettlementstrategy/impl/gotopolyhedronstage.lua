local GotoPolyhedronStage = class("GotoPolyhedronStage", BattleSettlementStrategyBase)

function GotoPolyhedronStage:OnGotoSettlement(arg_1_1)
	self:OnGotoPolyhedron(arg_1_1.num, arg_1_1.stageData, arg_1_1.starMissionData, arg_1_1.battleResult)
end

function GotoPolyhedronStage:OnGotoPolyhedron(arg_2_1, arg_2_2, arg_2_3, arg_2_4)
