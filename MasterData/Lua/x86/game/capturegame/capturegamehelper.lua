return {
	...
	GetAnimHashId = function(self, arg_4_1)
		if not self.animHashMap then
			local var_4_0 = {}

			self.animHashMap = var_4_0

			for iter_4_0, iter_4_1 in ipairs(ActivitySwimSkinAnimationCfg.all) do
				var_4_0[ActivitySwimSkinAnimationCfg[iter_4_1].Id] = Animator.StringToHash(ActivitySwimSkinAnimationCfg[iter_4_1].animName)
			end

			var_4_0[-1] = Animator.StringToHash("Idle")
		end

		return self.animHashMap[arg_4_1]
	end
}
