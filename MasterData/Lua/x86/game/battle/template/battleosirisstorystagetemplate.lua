...
function BattleOsirisStoryStageTemplate:GetClearTime()
	...
	if StoryStageActivityData:GetStageData(var_14_0)[self.id] and StoryStageActivityData:GetStageData(var_14_0)[self.id].clear_times then
		return StoryStageActivityData:GetStageData(var_14_0)[self.id].clear_times
	else
		return 0
	end
end
