	...
	Play321181038 = function(arg_155_0, arg_155_1)
		...
		function arg_155_1.onSingleLineUpdate_(arg_158_0)
			...
			if 1.999999999999 < arg_155_1.time_ and arg_155_1.time_ <= 1.999999999999 + arg_158_0 then
				...
				local var_158_16 = var_158_13.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_158_2, iter_158_3 in ipairs((var_158_16:ToTable())) do
					iter_158_3.transform.localScale = Vector3.New(iter_158_3.transform.localScale.x / var_158_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_158_16 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_158_3.transform.localScale.y / var_158_15, iter_158_3.transform.localScale.z)
				end
			end
			...
			if 4 < arg_155_1.time_ and arg_155_1.time_ <= var_158_18 + arg_158_0 then
				...
				local var_158_21 = arg_155_1:FormatText(arg_155_1:GetWordFromCfg(321181038).content)

				arg_155_1.text_.text = var_158_21

				LuaForUtil.ClearLinePrefixSymbol(arg_155_1.text_)

				local var_158_23 = 56 <= 0 and var_158_19 or var_158_19 * (utf8.len(var_158_21) / 56)

				if (56 <= 0 and var_158_19 or var_158_19 * (utf8.len(var_158_21) / 56)) > 0 and var_158_19 < var_158_23 then
