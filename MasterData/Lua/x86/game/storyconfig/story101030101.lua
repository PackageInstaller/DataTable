return {
	Play103011001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_4 = "1036ui_story"

			if arg_1_1.actors_["1036ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1036ui_story"))) then
				local var_4_5 = Object.Instantiate(Asset.Load("Char/" .. "1036ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_8 = arg_1_1.actors_["1036ui_story"]

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_8) and arg_1_1.var_.characterEffect1036ui_story == nil then
				arg_1_1.var_.characterEffect1036ui_story = var_4_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_9 = 0.1

			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_9 and not isNil(var_4_8) then
				if arg_1_1.var_.characterEffect1036ui_story and not isNil(var_4_8) then
					arg_1_1.var_.characterEffect1036ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 2 + var_4_9 and arg_1_1.time_ < 2 + var_4_9 + arg_4_0 and not isNil(var_4_8) and arg_1_1.var_.characterEffect1036ui_story then
				arg_1_1.var_.characterEffect1036ui_story.fillFlat = false
			end
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_13 = arg_1_1.bgs_.B03b:GetComponent("SpriteRenderer")

				if var_4_13 then
					arg_1_1.var_.alphaOldValueB03b = var_4_13.color.a
					arg_1_1.var_.alphaMatValueB03b = var_4_13
				end
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_14 then
				if arg_1_1.var_.alphaMatValueB03b then
					arg_1_1.var_.alphaMatValueB03b.color.a = Mathf.Lerp(arg_1_1.var_.alphaOldValueB03b, 1, (arg_1_1.time_ - 0) / var_4_14)
					arg_1_1.var_.alphaMatValueB03b.color = arg_1_1.var_.alphaMatValueB03b.color
				end
			end

			if arg_1_1.time_ >= 0 + var_4_14 and arg_1_1.time_ < 0 + var_4_14 + arg_4_0 and arg_1_1.var_.alphaMatValueB03b then
				arg_1_1.var_.alphaMatValueB03b.color.a = 1
				arg_1_1.var_.alphaMatValueB03b.color = arg_1_1.var_.alphaMatValueB03b.color
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_15 = arg_1_1.bgs_.B03b
			...
			local var_4_18 = arg_1_1.actors_["1036ui_story"].transform

			if 1.79999995231628 < arg_1_1.time_ and arg_1_1.time_ <= 1.79999995231628 + arg_4_0 then
				arg_1_1.var_.moveOldPos1036ui_story = var_4_18.localPosition
			end

			local var_4_19 = 0.001

			if 1.79999995231628 <= arg_1_1.time_ and arg_1_1.time_ < 1.79999995231628 + var_4_19 then
				var_4_18.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1036ui_story, Vector3.New(0, -1.09, -5.78), (arg_1_1.time_ - 1.79999995231628) / var_4_19)
			...
			if arg_1_1.time_ >= 1.79999995231628 + var_4_19 and arg_1_1.time_ < 1.79999995231628 + var_4_19 + arg_4_0 then
				var_4_18.localPosition = Vector3.New(0, -1.09, -5.78)
				var_4_18.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_18.position).x, (manager.ui.mainCamera.transform.position - var_4_18.position).y, (manager.ui.mainCamera.transform.position - var_4_18.position).z)
				var_4_18.localEulerAngles.z = 0
				var_4_18.localEulerAngles.x = 0
				var_4_18.localEulerAngles = var_4_18.localEulerAngles
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				arg_1_1:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/story1036/story1036action/1036action7_1")
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_21 + arg_4_0 then
				...
				local var_4_24 = arg_1_1:GetWordFromCfg(103011001)
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011001", "story_v_out_103011.awb") ~= 0 then
					local var_4_28 = manager.audio:GetVoiceLength("story_v_out_103011", "103011001", "story_v_out_103011.awb") / 1000
					...
					if var_4_24.prefab_name ~= "" and arg_1_1.actors_[var_4_24.prefab_name] ~= nil then
						local var_4_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_24.prefab_name].transform, "story_v_out_103011", "103011001", "story_v_out_103011.awb")

						arg_1_1:RecordAudio("103011001", var_4_29)
						arg_1_1:RecordAudio("103011001", var_4_29)
					else
	...
	Play103011002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 then
				arg_8_1:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/story1036/story1036actionlink/1036action476")
			end
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_0 + arg_11_0 then
				...
				local var_11_2 = arg_8_1:GetWordFromCfg(103011002)
				...
				local var_11_5 = 14 <= 0 and var_11_1 or var_11_1 * (utf8.len(var_11_3) / 14)

				if (14 <= 0 and var_11_1 or var_11_1 * (utf8.len(var_11_3) / 14)) > 0 and var_11_1 < var_11_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011002", "story_v_out_103011.awb") ~= 0 then
					local var_11_6 = manager.audio:GetVoiceLength("story_v_out_103011", "103011002", "story_v_out_103011.awb") / 1000
					...
					if var_11_2.prefab_name ~= "" and arg_8_1.actors_[var_11_2.prefab_name] ~= nil then
						local var_11_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_2.prefab_name].transform, "story_v_out_103011", "103011002", "story_v_out_103011.awb")

						arg_8_1:RecordAudio("103011002", var_11_7)
						arg_8_1:RecordAudio("103011002", var_11_7)
					else
	...
	Play103011003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_1 + arg_15_0 then
				...
				local var_15_3 = arg_12_1:FormatText(arg_12_1:GetWordFromCfg(103011003).content)

				arg_12_1.text_.text = var_15_3

				LuaForUtil.ClearLinePrefixSymbol(arg_12_1.text_)

				local var_15_5 = 34 <= 0 and var_15_2 or var_15_2 * (utf8.len(var_15_3) / 34)

				if (34 <= 0 and var_15_2 or var_15_2 * (utf8.len(var_15_3) / 34)) > 0 and var_15_2 < var_15_5 then
	...
	Play103011004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 then
				arg_16_1:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/story1036/story1036actionlink/1036action465")
			end
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_2 + arg_19_0 then
				...
				local var_19_4 = arg_16_1:GetWordFromCfg(103011004)
				...
				local var_19_7 = 14 <= 0 and var_19_3 or var_19_3 * (utf8.len(var_19_5) / 14)

				if (14 <= 0 and var_19_3 or var_19_3 * (utf8.len(var_19_5) / 14)) > 0 and var_19_3 < var_19_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011004", "story_v_out_103011.awb") ~= 0 then
					local var_19_8 = manager.audio:GetVoiceLength("story_v_out_103011", "103011004", "story_v_out_103011.awb") / 1000
					...
					if var_19_4.prefab_name ~= "" and arg_16_1.actors_[var_19_4.prefab_name] ~= nil then
						local var_19_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_4.prefab_name].transform, "story_v_out_103011", "103011004", "story_v_out_103011.awb")

						arg_16_1:RecordAudio("103011004", var_19_9)
						arg_16_1:RecordAudio("103011004", var_19_9)
					else
	...
	Play103011005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_1 + arg_23_0 then
				...
				local var_23_3 = arg_20_1:FormatText(arg_20_1:GetWordFromCfg(103011005).content)

				arg_20_1.text_.text = var_23_3

				LuaForUtil.ClearLinePrefixSymbol(arg_20_1.text_)

				local var_23_5 = 8 <= 0 and var_23_2 or var_23_2 * (utf8.len(var_23_3) / 8)

				if (8 <= 0 and var_23_2 or var_23_2 * (utf8.len(var_23_3) / 8)) > 0 and var_23_2 < var_23_5 then
	...
	Play103011006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 and not isNil(arg_24_1.actors_["1036ui_story"]) and arg_24_1.var_.characterEffect1036ui_story == nil then
				arg_24_1.var_.characterEffect1036ui_story = arg_24_1.actors_["1036ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_27_0 = 0.1

			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_0 and not isNil(arg_24_1.actors_["1036ui_story"]) then
				if arg_24_1.var_.characterEffect1036ui_story and not isNil(arg_24_1.actors_["1036ui_story"]) then
					arg_24_1.var_.characterEffect1036ui_story.fillFlat = false
				end
			end

			if arg_24_1.time_ >= 0 + var_27_0 and arg_24_1.time_ < 0 + var_27_0 + arg_27_0 and not isNil(arg_24_1.actors_["1036ui_story"]) and arg_24_1.var_.characterEffect1036ui_story then
				arg_24_1.var_.characterEffect1036ui_story.fillFlat = false
			end

			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 then
				arg_24_1:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/story1036/story1036actionlink/1036action452")
			end
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_2 + arg_27_0 then
				...
				local var_27_4 = arg_24_1:GetWordFromCfg(103011006)
				...
				local var_27_7 = 49 <= 0 and var_27_3 or var_27_3 * (utf8.len(var_27_5) / 49)

				if (49 <= 0 and var_27_3 or var_27_3 * (utf8.len(var_27_5) / 49)) > 0 and var_27_3 < var_27_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011006", "story_v_out_103011.awb") ~= 0 then
					local var_27_8 = manager.audio:GetVoiceLength("story_v_out_103011", "103011006", "story_v_out_103011.awb") / 1000
					...
					if var_27_4.prefab_name ~= "" and arg_24_1.actors_[var_27_4.prefab_name] ~= nil then
						local var_27_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_24_1.actors_[var_27_4.prefab_name].transform, "story_v_out_103011", "103011006", "story_v_out_103011.awb")

						arg_24_1:RecordAudio("103011006", var_27_9)
						arg_24_1:RecordAudio("103011006", var_27_9)
					else
	...
	Play103011007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 then
				arg_28_1:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/story1036/story1036actionlink/1036action424")
			end
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_0 + arg_31_0 then
				...
				local var_31_2 = arg_28_1:GetWordFromCfg(103011007)
				...
				local var_31_5 = 34 <= 0 and var_31_1 or var_31_1 * (utf8.len(var_31_3) / 34)

				if (34 <= 0 and var_31_1 or var_31_1 * (utf8.len(var_31_3) / 34)) > 0 and var_31_1 < var_31_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011007", "story_v_out_103011.awb") ~= 0 then
					local var_31_6 = manager.audio:GetVoiceLength("story_v_out_103011", "103011007", "story_v_out_103011.awb") / 1000
					...
					if var_31_2.prefab_name ~= "" and arg_28_1.actors_[var_31_2.prefab_name] ~= nil then
						local var_31_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_2.prefab_name].transform, "story_v_out_103011", "103011007", "story_v_out_103011.awb")

						arg_28_1:RecordAudio("103011007", var_31_7)
						arg_28_1:RecordAudio("103011007", var_31_7)
					else
	...
	Play103011008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_1 + arg_35_0 then
				...
				local var_35_3 = arg_32_1:FormatText(arg_32_1:GetWordFromCfg(103011008).content)
	...
	Play103011009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= 0 + arg_39_0 then
				arg_36_1:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/story1036/story1036actionlink/1036action445")
			end
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_2 + arg_39_0 then
				...
				local var_39_4 = arg_36_1:GetWordFromCfg(103011009)
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011009", "story_v_out_103011.awb") ~= 0 then
					local var_39_8 = manager.audio:GetVoiceLength("story_v_out_103011", "103011009", "story_v_out_103011.awb") / 1000
					...
					if var_39_4.prefab_name ~= "" and arg_36_1.actors_[var_39_4.prefab_name] ~= nil then
						local var_39_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_36_1.actors_[var_39_4.prefab_name].transform, "story_v_out_103011", "103011009", "story_v_out_103011.awb")

						arg_36_1:RecordAudio("103011009", var_39_9)
						arg_36_1:RecordAudio("103011009", var_39_9)
					else
	...
	Play103011010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_0 + arg_43_0 then
				...
				local var_43_2 = arg_40_1:GetWordFromCfg(103011010)
				...
				local var_43_5 = 25 <= 0 and var_43_1 or var_43_1 * (utf8.len(var_43_3) / 25)

				if (25 <= 0 and var_43_1 or var_43_1 * (utf8.len(var_43_3) / 25)) > 0 and var_43_1 < var_43_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011010", "story_v_out_103011.awb") ~= 0 then
					local var_43_6 = manager.audio:GetVoiceLength("story_v_out_103011", "103011010", "story_v_out_103011.awb") / 1000
					...
					if var_43_2.prefab_name ~= "" and arg_40_1.actors_[var_43_2.prefab_name] ~= nil then
						local var_43_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_2.prefab_name].transform, "story_v_out_103011", "103011010", "story_v_out_103011.awb")

						arg_40_1:RecordAudio("103011010", var_43_7)
						arg_40_1:RecordAudio("103011010", var_43_7)
					else
	...
	Play103011011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= var_47_1 + arg_47_0 then
				...
				local var_47_3 = arg_44_1:FormatText(arg_44_1:GetWordFromCfg(103011011).content)

				arg_44_1.text_.text = var_47_3

				LuaForUtil.ClearLinePrefixSymbol(arg_44_1.text_)

				local var_47_5 = 25 <= 0 and var_47_2 or var_47_2 * (utf8.len(var_47_3) / 25)

				if (25 <= 0 and var_47_2 or var_47_2 * (utf8.len(var_47_3) / 25)) > 0 and var_47_2 < var_47_5 then
