	...
	Play926072037 = function(arg_152_0, arg_152_1)
		...
		function arg_152_1.onSingleLineUpdate_(arg_155_0)
			...
			if 1.61666666666667 < arg_152_1.time_ and arg_152_1.time_ <= 1.61666666666667 + arg_155_0 then
				...
				local var_155_3 = var_155_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_155_0, iter_155_1 in ipairs((var_155_3:ToTable())) do
					iter_155_1.transform.localScale = Vector3.New(iter_155_1.transform.localScale.x / var_155_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_155_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_155_1.transform.localScale.y / var_155_2, iter_155_1.transform.localScale.z)
				end
			end

			if 1.61666666666667 < arg_152_1.time_ and arg_152_1.time_ <= 1.61666666666667 + arg_155_0 then
				local var_155_5 = arg_152_1.var_.effect336

				if not arg_152_1.var_.effect336 then
					var_155_5 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_heavy_ui"), manager.ui.mainCamera.transform)
					var_155_5.name = "336"
					arg_152_1.var_.effect336 = var_155_5
				else
					var_155_5.transform:SetParent(var_155_9000)
				end

				var_155_5.transform.localPosition = Vector3.New(0, 0, 0)
				var_155_5.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_155_7 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_155_8 = var_155_5.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_155_2, iter_155_3 in ipairs((var_155_8:ToTable())) do
					iter_155_3.transform.localScale = Vector3.New(iter_155_3.transform.localScale.x / var_155_7 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_155_8 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_155_3.transform.localScale.y / var_155_7, iter_155_3.transform.localScale.z)
				end
			end
			...
			if arg_152_1.time_ >= var_155_10 + var_155_11 and arg_152_1.time_ < var_155_10 + var_155_11 + arg_155_0 then
				local var_155_13 = Color.New(0, 0, 0)
			...
			if 1.61666666666667 < arg_152_1.time_ and arg_152_1.time_ <= var_155_14 + arg_155_0 then
				arg_152_1.mask_.enabled = true
				arg_152_1.mask_.raycastTarget = true
			...
			local var_155_15 = 1.2

			if var_155_14 <= arg_152_1.time_ and arg_152_1.time_ < var_155_14 + var_155_15 then
				local var_155_16 = Color.New(0, 0, 0)

				var_155_16.a = Mathf.Lerp(1, 0, (arg_152_1.time_ - var_155_14) / var_155_15)
				arg_152_1.mask_.color = var_155_16
			end

			if arg_152_1.time_ >= var_155_14 + var_155_15 and arg_152_1.time_ < var_155_14 + var_155_15 + arg_155_0 then
				local var_155_17 = Color.New(0, 0, 0)
			...
			local var_155_18 = 1.61666666666667
			...
			local var_155_19 = 0.0166666666666667

			if var_155_18 <= arg_152_1.time_ and arg_152_1.time_ < var_155_18 + var_155_19 then
				arg_152_1.screenFilterEffect_.weight = Mathf.Lerp(0, 1, (arg_152_1.time_ - var_155_18) / var_155_19)
			end
			...
			local var_155_20 = arg_152_1.actors_["10144"].transform

			if 1.61666666666667 < arg_152_1.time_ and arg_152_1.time_ <= 1.61666666666667 + arg_155_0 then
				arg_152_1.var_.moveOldPos10144 = var_155_20.localPosition
				var_155_20.localScale = Vector3.New(1, 1, 1)

				arg_152_1:CheckSpriteTmpPos("10144", 7)

				for iter_155_8 = 0, var_155_20.childCount - 1 do
					local var_155_21 = var_155_20:GetChild(iter_155_8)

					if var_155_21.name == "" or not string.find(var_155_21.name, "split") then
						var_155_21.gameObject:SetActive(true)
					else
						var_155_21.gameObject:SetActive(false)
					end
				end
			end
			...
			if 1.61666666666667 <= arg_152_1.time_ and arg_152_1.time_ < 1.61666666666667 + var_155_22 then
				var_155_20.localPosition = Vector3.Lerp(arg_152_1.var_.moveOldPos10144, Vector3.New(0, -2000, 0), (arg_152_1.time_ - 1.61666666666667) / var_155_22)
			end

			if arg_152_1.time_ >= 1.61666666666667 + var_155_22 and arg_152_1.time_ < 1.61666666666667 + var_155_22 + arg_155_0 then
				var_155_20.localPosition = Vector3.New(0, -2000, 0)
			end

			if 0 < arg_152_1.time_ and arg_152_1.time_ <= 0 + arg_155_0 then
				arg_152_1:AudioAction("play", "music", "ui_battle", "ui_battle_stopbgm", "")

				local var_155_25 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_152_1.bgmTxt_.text ~= var_155_25 and arg_152_1.bgmTxt_.text ~= "" then
						if arg_152_1.bgmTxt2_.text ~= "" then
							arg_152_1.bgmTxt_.text = arg_152_1.bgmTxt2_.text
						end

						arg_152_1.bgmTxt2_.text = var_155_25

						arg_152_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_152_1.bgmTxt_.text = var_155_25
						arg_152_1.bgmTxt2_.text = var_155_25
					end
			...
			if 0.216666666666667 < arg_152_1.time_ and arg_152_1.time_ <= 0.216666666666667 + arg_155_0 then
				...
				local var_155_28 = manager.audio:GetAudioName("bgm_activity_3_4_ui", "bgm_activity_3_4_ui")

				if "" ~= "" then
					if arg_152_1.bgmTxt_.text ~= var_155_28 and arg_152_1.bgmTxt_.text ~= "" then
						if arg_152_1.bgmTxt2_.text ~= "" then
							arg_152_1.bgmTxt_.text = arg_152_1.bgmTxt2_.text
						end

						arg_152_1.bgmTxt2_.text = var_155_28

						arg_152_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_152_1.bgmTxt_.text = var_155_28
						arg_152_1.bgmTxt2_.text = var_155_28
					end
			...
			if 0 < arg_152_1.time_ and arg_152_1.time_ <= var_155_29 + arg_155_0 then
				arg_152_1.allBtn_.enabled = false
			end

			if arg_152_1.time_ >= var_155_29 + 3.46666666666667 and arg_152_1.time_ < var_155_29 + 3.46666666666667 + arg_155_0 then
			...
			if 3 < arg_152_1.time_ and arg_152_1.time_ <= var_155_30 + arg_155_0 then
				...
				local var_155_32 = LeanTween.value(arg_152_1.dialog_, 0, 1, 0.3)

				var_155_32:setOnUpdate(LuaHelper.FloatAction(function(arg_158_0)
					arg_152_1.dialogCg_.alpha = arg_158_0
				end))
				var_155_32:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_152_1.dialog_)
					var_155_32:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_155_33 = arg_152_1:FormatText(arg_152_1:GetWordFromCfg(926072037).content)

				arg_152_1.text_.text = var_155_33

				LuaForUtil.ClearLinePrefixSymbol(arg_152_1.text_)

				local var_155_35 = 40 <= 0 and var_155_31 or var_155_31 * (utf8.len(var_155_33) / 40)

				if (40 <= 0 and var_155_31 or var_155_31 * (utf8.len(var_155_33) / 40)) > 0 and var_155_31 < var_155_35 then
					arg_152_1.talkMaxDuration = var_155_35
					var_155_30 = var_155_30 + 0.3

					if var_155_35 + var_155_30 > arg_152_1.duration_ then
						arg_152_1.duration_ = var_155_35 + var_155_30
					end
				end
			...
			local var_155_36 = var_155_30 + 0.3
			local var_155_37 = math.max(var_155_31, arg_152_1.talkMaxDuration)

			if var_155_30 + 0.3 <= arg_152_1.time_ and arg_152_1.time_ < var_155_36 + var_155_37 then
				arg_152_1.typewritter.percent = (arg_152_1.time_ - var_155_36) / var_155_37
	...
	Play926072045 = function(arg_188_0, arg_188_1)
		...
		function arg_188_1.onSingleLineUpdate_(arg_191_0)
			...
			if 0.2 < arg_188_1.time_ and arg_188_1.time_ <= 0.2 + arg_191_0 then
				...
				local var_191_21 = var_191_18.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_191_11, iter_191_12 in ipairs((var_191_21:ToTable())) do
					iter_191_12.transform.localScale = Vector3.New(iter_191_12.transform.localScale.x / var_191_20 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_191_21 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_191_12.transform.localScale.y / var_191_20, iter_191_12.transform.localScale.z)
				end
			end
			...
			if 1.26666666666667 < arg_188_1.time_ and arg_188_1.time_ <= 1.26666666666667 + arg_191_0 then
				local var_191_25 = arg_188_1.actors_["10144"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_191_25 then
					arg_188_1.var_.alphaOldValue10144 = var_191_25.alpha
					arg_188_1.var_.characterEffect10144 = var_191_25
				end

				arg_188_1.var_.alphaOldValue10144 = 0
			end

			local var_191_26 = 0.2

			if 1.26666666666667 <= arg_188_1.time_ and arg_188_1.time_ < 1.26666666666667 + var_191_26 then
				if arg_188_1.var_.characterEffect10144 then
					arg_188_1.var_.characterEffect10144.alpha = Mathf.Lerp(arg_188_1.var_.alphaOldValue10144, 1, (arg_188_1.time_ - 1.26666666666667) / var_191_26)
				end
			end

			if arg_188_1.time_ >= 1.26666666666667 + var_191_26 and arg_188_1.time_ < 1.26666666666667 + var_191_26 + arg_191_0 and arg_188_1.var_.characterEffect10144 then
				arg_188_1.var_.characterEffect10144.alpha = 1
			end

			local var_191_27 = 0

			if 0 < arg_188_1.time_ and arg_188_1.time_ <= var_191_27 + arg_191_0 then
				arg_188_1.allBtn_.enabled = false
			end

			if arg_188_1.time_ >= var_191_27 + 2.125 and arg_188_1.time_ < var_191_27 + 2.125 + arg_191_0 then
			...
			if 0.333333333333333 < arg_188_1.time_ and arg_188_1.time_ <= 0.333333333333333 + arg_191_0 then
				...
				local var_191_31 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_188_1.bgmTxt_.text ~= var_191_31 and arg_188_1.bgmTxt_.text ~= "" then
						if arg_188_1.bgmTxt2_.text ~= "" then
							arg_188_1.bgmTxt_.text = arg_188_1.bgmTxt2_.text
						end

						arg_188_1.bgmTxt2_.text = var_191_31

						arg_188_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_188_1.bgmTxt_.text = var_191_31
						arg_188_1.bgmTxt2_.text = var_191_31
					end
			...
			local var_191_33 = 0.034

			if var_191_32 <= arg_188_1.time_ and arg_188_1.time_ < var_191_32 + var_191_33 then
				arg_188_1.screenFilterEffect_.weight = Mathf.Lerp(1, 0, (arg_188_1.time_ - var_191_32) / var_191_33)
			end
			...
			local var_191_36 = 1.8
			local var_191_37 = 0.325

			if 1.8 < arg_188_1.time_ and arg_188_1.time_ <= var_191_36 + arg_191_0 then
				...
				local var_191_38 = LeanTween.value(arg_188_1.dialog_, 0, 1, 0.3)

				var_191_38:setOnUpdate(LuaHelper.FloatAction(function(arg_193_0)
					arg_188_1.dialogCg_.alpha = arg_193_0
				end))
				var_191_38:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_188_1.dialog_)
					var_191_38:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_191_39 = arg_188_1:GetWordFromCfg(926072045)
				local var_191_40 = arg_188_1:FormatText(var_191_39.content)

				arg_188_1.text_.text = var_191_40

				LuaForUtil.ClearLinePrefixSymbol(arg_188_1.text_)

				local var_191_42 = 13 <= 0 and var_191_37 or var_191_37 * (utf8.len(var_191_40) / 13)

				if (13 <= 0 and var_191_37 or var_191_37 * (utf8.len(var_191_40) / 13)) > 0 and var_191_37 < var_191_42 then
					arg_188_1.talkMaxDuration = var_191_42
					var_191_36 = var_191_36 + 0.3

					if var_191_42 + var_191_36 > arg_188_1.duration_ then
						arg_188_1.duration_ = var_191_42 + var_191_36
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_926072", "926072045", "story_v_out_926072.awb") ~= 0 then
					local var_191_43 = manager.audio:GetVoiceLength("story_v_out_926072", "926072045", "story_v_out_926072.awb") / 1000

					if var_191_43 + var_191_36 > arg_188_1.duration_ then
						arg_188_1.duration_ = var_191_43 + var_191_36
					end

					if var_191_39.prefab_name ~= "" and arg_188_1.actors_[var_191_39.prefab_name] ~= nil then
						local var_191_44 = LuaForUtil.PlayVoiceWithCriLipsync(arg_188_1.actors_[var_191_39.prefab_name].transform, "story_v_out_926072", "926072045", "story_v_out_926072.awb")

						arg_188_1:RecordAudio("926072045", var_191_44)
						arg_188_1:RecordAudio("926072045", var_191_44)
					else
			...
			local var_191_45 = var_191_36 + 0.3
			local var_191_46 = math.max(var_191_37, arg_188_1.talkMaxDuration)

			if var_191_36 + 0.3 <= arg_188_1.time_ and arg_188_1.time_ < var_191_45 + var_191_46 then
				arg_188_1.typewritter.percent = (arg_188_1.time_ - var_191_45) / var_191_46

				arg_188_1.typewritter:SetDirty()
			end

			if arg_188_1.time_ >= var_191_45 + var_191_46 and arg_188_1.time_ < var_191_45 + var_191_46 + arg_191_0 then
