return {
	Play321241001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.bgs_.MS2107a == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.paintGo_)

				var_4_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "MS2107a")
				var_4_0.name = "MS2107a"
				var_4_0.transform.parent = arg_1_1.stage_.transform
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.bgs_.MS2107a = var_4_0
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_1 = arg_1_1.bgs_.MS2107a

				arg_1_1.bgs_.MS2107a.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_9 = arg_1_1.var_.effecthundun1

				if not arg_1_1.var_.effecthundun1 then
					var_4_9 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_qiliu_in_keep"), manager.ui.mainCamera.transform)
					var_4_9.name = "hundun1"
					arg_1_1.var_.effecthundun1 = var_4_9
				else
			...
			if 0.3 < arg_1_1.time_ and arg_1_1.time_ <= 0.3 + arg_4_0 then
				...
				local var_4_16 = manager.audio:GetAudioName("bgm_activity_4_0_story_quake_unsettled", "bgm_activity_4_0_story_quake_unsettled")
			...
			if 0.034000001847744 < arg_1_1.time_ and arg_1_1.time_ <= 0.034000001847744 + arg_4_0 then
				arg_1_1:AudioAction("play", "effect", "se_story_140", "se_story_140_amb_wind_thunder", "")
			end
			...
			if 1.95 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:GetWordFromCfg(321241001)
				...
				local var_4_24 = 2 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_22) / 2)

				if (2 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_22) / 2)) > 0 and var_4_19 < var_4_24 then
				...
				if manager.audio:GetVoiceLength("story_v_out_321241", "321241001", "story_v_out_321241.awb") ~= 0 then
					local var_4_25 = manager.audio:GetVoiceLength("story_v_out_321241", "321241001", "story_v_out_321241.awb") / 1000
					...
					if var_4_21.prefab_name ~= "" and arg_1_1.actors_[var_4_21.prefab_name] ~= nil then
						local var_4_26 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_21.prefab_name].transform, "story_v_out_321241", "321241001", "story_v_out_321241.awb")

						arg_1_1:RecordAudio("321241001", var_4_26)
						arg_1_1:RecordAudio("321241001", var_4_26)
					else
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_4 and not isNil(var_12_3) then
				if arg_9_1.var_.characterEffect10131ui_story and not isNil(var_12_3) then
					...
					arg_9_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_9_1.time_ - 0) / var_12_4)
				end
			end
			...
			if arg_9_1.time_ >= 0 + var_12_4 and arg_9_1.time_ < 0 + var_12_4 + arg_12_0 and not isNil(var_12_3) and arg_9_1.var_.characterEffect10131ui_story then
				arg_9_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_9_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end

			if 0.034000001847744 < arg_9_1.time_ and arg_9_1.time_ <= 0.034000001847744 + arg_12_0 then
				arg_9_1:AudioAction("play", "effect", "se_story_140", "se_story_140_scythe6", "")
			end
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_6 + arg_12_0 then
				...
				local var_12_8 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(321241002).content)

				arg_9_1.text_.text = var_12_8

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_10 = 37 <= 0 and var_12_7 or var_12_7 * (utf8.len(var_12_8) / 37)

				if (37 <= 0 and var_12_7 or var_12_7 * (utf8.len(var_12_8) / 37)) > 0 and var_12_7 < var_12_10 then
	...
	Play321241003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				local var_16_1 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(321241003).content)
	...
	Play321241004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if arg_17_1.actors_["1284ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1284ui_story"))) then
				local var_20_0 = Object.Instantiate(Asset.Load("Char/" .. "1284ui_story"), arg_17_1.stage_.transform)

				var_20_0.name = "1284ui_story"
				var_20_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_17_1.actors_["1284ui_story"] = var_20_0
				...
				arg_17_1.var_["1284ui_story" .. "Animator"] = var_20_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_17_1.var_["1284ui_story" .. "Animator"].applyRootMotion = true
				arg_17_1.var_["1284ui_story" .. "LipSync"] = var_20_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_20_3 = arg_17_1.actors_["1284ui_story"]

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(var_20_3) and arg_17_1.var_.characterEffect1284ui_story == nil then
				arg_17_1.var_.characterEffect1284ui_story = var_20_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_4 = 0.200000002980232

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_4 and not isNil(var_20_3) then
				if arg_17_1.var_.characterEffect1284ui_story and not isNil(var_20_3) then
					arg_17_1.var_.characterEffect1284ui_story.fillFlat = false
				end
			end

			if arg_17_1.time_ >= 0 + var_20_4 and arg_17_1.time_ < 0 + var_20_4 + arg_20_0 and not isNil(var_20_3) and arg_17_1.var_.characterEffect1284ui_story then
				arg_17_1.var_.characterEffect1284ui_story.fillFlat = false
			end
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_8 = arg_17_1:GetWordFromCfg(321241004)
				...
				if manager.audio:GetVoiceLength("story_v_out_321241", "321241004", "story_v_out_321241.awb") ~= 0 then
					local var_20_12 = manager.audio:GetVoiceLength("story_v_out_321241", "321241004", "story_v_out_321241.awb") / 1000
					...
					if var_20_8.prefab_name ~= "" and arg_17_1.actors_[var_20_8.prefab_name] ~= nil then
						local var_20_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_8.prefab_name].transform, "story_v_out_321241", "321241004", "story_v_out_321241.awb")

						arg_17_1:RecordAudio("321241004", var_20_13)
						arg_17_1:RecordAudio("321241004", var_20_13)
					else
	...
	Play321241005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(arg_21_1.actors_["1284ui_story"]) and arg_21_1.var_.characterEffect1284ui_story == nil then
				arg_21_1.var_.characterEffect1284ui_story = arg_21_1.actors_["1284ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_24_0 = 0.200000002980232

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_0 and not isNil(arg_21_1.actors_["1284ui_story"]) then
				if arg_21_1.var_.characterEffect1284ui_story and not isNil(arg_21_1.actors_["1284ui_story"]) then
					arg_21_1.var_.characterEffect1284ui_story.fillFlat = true
					arg_21_1.var_.characterEffect1284ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_21_1.time_ - 0) / var_24_0)
				end
			end

			if arg_21_1.time_ >= 0 + var_24_0 and arg_21_1.time_ < 0 + var_24_0 + arg_24_0 and not isNil(arg_21_1.actors_["1284ui_story"]) and arg_21_1.var_.characterEffect1284ui_story then
				arg_21_1.var_.characterEffect1284ui_story.fillFlat = true
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_1 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(321241005).content)

				arg_21_1.text_.text = var_24_3

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_5 = 8 <= 0 and var_24_2 or var_24_2 * (utf8.len(var_24_3) / 8)

				if (8 <= 0 and var_24_2 or var_24_2 * (utf8.len(var_24_3) / 8)) > 0 and var_24_2 < var_24_5 then
	...
	Play321241006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:GetWordFromCfg(321241006)
				...
				if manager.audio:GetVoiceLength("story_v_out_321241", "321241006", "story_v_out_321241.awb") ~= 0 then
					local var_28_8 = manager.audio:GetVoiceLength("story_v_out_321241", "321241006", "story_v_out_321241.awb") / 1000
					...
					if var_28_4.prefab_name ~= "" and arg_25_1.actors_[var_28_4.prefab_name] ~= nil then
						local var_28_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_4.prefab_name].transform, "story_v_out_321241", "321241006", "story_v_out_321241.awb")

						arg_25_1:RecordAudio("321241006", var_28_9)
						arg_25_1:RecordAudio("321241006", var_28_9)
					else
	...
	Play321241007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(321241007).content)

				arg_29_1.text_.text = var_32_3

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_5 = 12 <= 0 and var_32_2 or var_32_2 * (utf8.len(var_32_3) / 12)

				if (12 <= 0 and var_32_2 or var_32_2 * (utf8.len(var_32_3) / 12)) > 0 and var_32_2 < var_32_5 then
	...
	Play321241008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			if 0.034000001847744 < arg_33_1.time_ and arg_33_1.time_ <= 0.034000001847744 + arg_36_0 then
				arg_33_1:AudioAction("play", "effect", "se_story_140", "se_story_140_catch", "")
			end
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_1 + arg_36_0 then
				...
				local var_36_3 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(321241008).content)
	...
	Play321241009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			if arg_37_1.bgs_.L12f == nil then
				local var_40_0 = Object.Instantiate(arg_37_1.paintGo_)

				var_40_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "L12f")
				var_40_0.name = "L12f"
				var_40_0.transform.parent = arg_37_1.stage_.transform
				var_40_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_37_1.bgs_.L12f = var_40_0
			end

			if 2 < arg_37_1.time_ and arg_37_1.time_ <= 2 + arg_40_0 then
				local var_40_1 = arg_37_1.bgs_.L12f

				arg_37_1.bgs_.L12f.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_40_4 = 3.86666666666667

			if 3.86666666666667 < arg_37_1.time_ and arg_37_1.time_ <= var_40_4 + arg_40_0 then
			...
			if 2 < arg_37_1.time_ and arg_37_1.time_ <= 2 + arg_40_0 then
				if arg_37_1.var_.effecthundun1 then
					Object.Destroy(arg_37_1.var_.effecthundun1)
			...
			local var_40_14 = 3.86666666666667
			local var_40_15 = 0.525

			if 3.86666666666667 < arg_37_1.time_ and arg_37_1.time_ <= var_40_14 + arg_40_0 then
				...
				local var_40_17 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(321241009).content)

				arg_37_1.text_.text = var_40_17

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_19 = 21 <= 0 and var_40_15 or var_40_15 * (utf8.len(var_40_17) / 21)

				if (21 <= 0 and var_40_15 or var_40_15 * (utf8.len(var_40_17) / 21)) > 0 and var_40_15 < var_40_19 then
	...
	Play321241010 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			if 1 < arg_43_1.time_ and arg_43_1.time_ <= 1 + arg_46_0 then
				arg_43_1:AudioAction("play", "effect", "se_story_140", "se_story_140_coffin", "")
			end
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_1 + arg_46_0 then
				...
				local var_46_3 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(321241010).content)

				arg_43_1.text_.text = var_46_3

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_5 = 47 <= 0 and var_46_2 or var_46_2 * (utf8.len(var_46_3) / 47)

				if (47 <= 0 and var_46_2 or var_46_2 * (utf8.len(var_46_3) / 47)) > 0 and var_46_2 < var_46_5 then
	...
	Play321241011 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0.3 < arg_47_1.time_ and arg_47_1.time_ <= 0.3 + arg_50_0 then
				arg_47_1:AudioAction("play", "effect", "se_story_140", "se_story_140_perish2", "")
			end
			...
			if arg_47_1.time_ >= var_50_1 + 2.4 and arg_47_1.time_ < var_50_1 + 2.4 + arg_50_0 then
				arg_47_1.allBtn_.enabled = true
			end

			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 then
				local var_50_2 = arg_47_1.var_.effect972

				if not arg_47_1.var_.effect972 then
					var_50_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_redtwister_keep"), manager.ui.mainCamera.transform)
					var_50_2.name = "972"
					arg_47_1.var_.effect972 = var_50_2
				else
					var_50_2.transform:SetParent(var_50_9000)
				end

				var_50_2.transform.localPosition = Vector3.New(0, 0, 1.54)
				var_50_2.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			local var_50_4 = 1
			local var_50_5 = 1.675

			if 1 < arg_47_1.time_ and arg_47_1.time_ <= var_50_4 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(321241011).content)

				arg_47_1.text_.text = var_50_7

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_9 = 67 <= 0 and var_50_5 or var_50_5 * (utf8.len(var_50_7) / 67)

				if (67 <= 0 and var_50_5 or var_50_5 * (utf8.len(var_50_7) / 67)) > 0 and var_50_5 < var_50_9 then
	...
	Play321241012 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				...
				local var_56_1 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(321241012).content)
	...
	Play321241013 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				...
				local var_60_1 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(321241013).content)
	...
	Play321241014 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				...
				local var_64_1 = arg_61_1:GetWordFromCfg(321241014)
				...
				if manager.audio:GetVoiceLength("story_v_out_321241", "321241014", "story_v_out_321241.awb") ~= 0 then
					local var_64_5 = manager.audio:GetVoiceLength("story_v_out_321241", "321241014", "story_v_out_321241.awb") / 1000
					...
					if var_64_1.prefab_name ~= "" and arg_61_1.actors_[var_64_1.prefab_name] ~= nil then
						local var_64_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_61_1.actors_[var_64_1.prefab_name].transform, "story_v_out_321241", "321241014", "story_v_out_321241.awb")

						arg_61_1:RecordAudio("321241014", var_64_6)
						arg_61_1:RecordAudio("321241014", var_64_6)
					else
	...
	Play321241015 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_1 + arg_68_0 then
				...
				local var_68_3 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(321241015).content)
	...
	Play321241016 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				...
				local var_72_1 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(321241016).content)

				arg_69_1.text_.text = var_72_1

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_3 = 37 <= 0 and var_72_0 or var_72_0 * (utf8.len(var_72_1) / 37)

				if (37 <= 0 and var_72_0 or var_72_0 * (utf8.len(var_72_1) / 37)) > 0 and var_72_0 < var_72_3 then
	...
	Play321241017 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				...
				local var_76_1 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(321241017).content)
	...
	Play321241018 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				arg_77_1.var_.moveOldPos1284ui_story = arg_77_1.actors_["1284ui_story"].transform.localPosition
			end

			local var_80_0 = 0.001

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_0 then
				arg_77_1.actors_["1284ui_story"].transform.localPosition = Vector3.Lerp(arg_77_1.var_.moveOldPos1284ui_story, Vector3.New(0, 100, 0), (arg_77_1.time_ - 0) / var_80_0)
				arg_77_1.actors_["1284ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["1284ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1284ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1284ui_story"].transform.position).z)
				arg_77_1.actors_["1284ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["1284ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["1284ui_story"].transform.localEulerAngles = arg_77_1.actors_["1284ui_story"].transform.localEulerAngles
			end

			if arg_77_1.time_ >= 0 + var_80_0 and arg_77_1.time_ < 0 + var_80_0 + arg_80_0 then
				arg_77_1.actors_["1284ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_77_1.actors_["1284ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["1284ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1284ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1284ui_story"].transform.position).z)
				arg_77_1.actors_["1284ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["1284ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["1284ui_story"].transform.localEulerAngles = arg_77_1.actors_["1284ui_story"].transform.localEulerAngles
			...
			if 3.53333333333334 < arg_77_1.time_ and arg_77_1.time_ <= 3.53333333333334 + arg_80_0 then
				local var_80_1 = arg_77_1.var_.effect973

				if not arg_77_1.var_.effect973 then
					var_80_1 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_redtwister_out"), manager.ui.mainCamera.transform)
					var_80_1.name = "973"
					arg_77_1.var_.effect973 = var_80_1
				else
					var_80_1.transform:SetParent(var_80_9002)
				end

				var_80_1.transform.localPosition = Vector3.New(0, 0, 1.06)
				var_80_1.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_80_3 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_80_4 = var_80_1.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_80_0, iter_80_1 in ipairs((var_80_4:ToTable())) do
					iter_80_1.transform.localScale = Vector3.New(iter_80_1.transform.localScale.x / var_80_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_80_4 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_80_1.transform.localScale.y / var_80_3, iter_80_1.transform.localScale.z)
				end
			end

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				if arg_77_1.var_.effect972 then
					Object.Destroy(arg_77_1.var_.effect972)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				if arg_77_1.var_.effect9998 then
					Object.Destroy(arg_77_1.var_.effect9998)

					arg_77_1.var_.effect9998 = nil
				end
			end

			local var_80_8 = manager.ui.mainCamera.transform

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				arg_77_1.var_.shakeOldPos = var_80_8.localPosition
			end

			local var_80_9 = 1.1

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_9 then
				local var_80_10, var_80_11 = math.modf((arg_77_1.time_ - 0) / 0.066)

				var_80_8.localPosition = Vector3.New(var_80_11 * 0.13, var_80_11 * 0.13, var_80_11 * 0.13) + arg_77_1.var_.shakeOldPos
			end

			if arg_77_1.time_ >= 0 + var_80_9 and arg_77_1.time_ < 0 + var_80_9 + arg_80_0 then
				var_80_8.localPosition = arg_77_1.var_.shakeOldPos
			end
			...
			if var_80_12 <= arg_77_1.time_ and arg_77_1.time_ < var_80_12 + var_80_13 then
				local var_80_14 = Color.New(0, 0, 0)

				var_80_14.a = Mathf.Lerp(1, 0, (arg_77_1.time_ - var_80_12) / var_80_13)
				arg_77_1.mask_.color = var_80_14
			end

			if arg_77_1.time_ >= var_80_12 + var_80_13 and arg_77_1.time_ < var_80_12 + var_80_13 + arg_80_0 then
				local var_80_15 = Color.New(0, 0, 0)

				arg_77_1.mask_.enabled = false
				var_80_15.a = 0
				arg_77_1.mask_.color = var_80_15
			end

			local var_80_16 = 1

			if 1 < arg_77_1.time_ and arg_77_1.time_ <= var_80_16 + arg_80_0 then
				arg_77_1.mask_.enabled = true
				arg_77_1.mask_.raycastTarget = true
			...
			local var_80_20 = 1.76666666666667

			if 1.76666666666667 < arg_77_1.time_ and arg_77_1.time_ <= var_80_20 + arg_80_0 then
				arg_77_1.mask_.enabled = true
				arg_77_1.mask_.raycastTarget = true
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				local var_80_24 = arg_77_1.var_.effect979

				if not arg_77_1.var_.effect979 then
					var_80_24 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_redtwister_keep"), manager.ui.mainCamera.transform)
					var_80_24.name = "979"
					arg_77_1.var_.effect979 = var_80_24
				else
					var_80_24.transform:SetParent(var_80_9001)
				end

				var_80_24.transform.localPosition = Vector3.New(0, 0, 1.06)
				var_80_24.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_80_26 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_80_27 = var_80_24.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_80_2, iter_80_3 in ipairs((var_80_27:ToTable())) do
					iter_80_3.transform.localScale = Vector3.New(iter_80_3.transform.localScale.x / var_80_26 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_80_27 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_80_3.transform.localScale.y / var_80_26, iter_80_3.transform.localScale.z)
				end
			end

			if 1.76666666666667 < arg_77_1.time_ and arg_77_1.time_ <= 1.76666666666667 + arg_80_0 then
				if arg_77_1.var_.effect979 then
					Object.Destroy(arg_77_1.var_.effect979)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_30 + arg_80_0 then
				arg_77_1.allBtn_.enabled = false
			end

			if arg_77_1.time_ >= var_80_30 + 5.53333333333333 and arg_77_1.time_ < var_80_30 + 5.53333333333333 + arg_80_0 then
				arg_77_1.allBtn_.enabled = true
			end

			if 1.66666666666667 < arg_77_1.time_ and arg_77_1.time_ <= 1.66666666666667 + arg_80_0 then
				local var_80_31 = arg_77_1.var_.effect978

				if not arg_77_1.var_.effect978 then
					var_80_31 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_redtwister_keep"), manager.ui.mainCamera.transform)
					var_80_31.name = "978"
					arg_77_1.var_.effect978 = var_80_31
				else
					var_80_31.transform:SetParent(var_80_9000)
				end

				var_80_31.transform.localPosition = Vector3.New(0, 0, -1.04)
				var_80_31.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_80_33 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_80_34 = var_80_31.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_80_4, iter_80_5 in ipairs((var_80_34:ToTable())) do
					iter_80_5.transform.localScale = Vector3.New(iter_80_5.transform.localScale.x / var_80_33 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_80_34 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_80_5.transform.localScale.y / var_80_33, iter_80_5.transform.localScale.z)
				end
			end

			if 3.56666666666667 < arg_77_1.time_ and arg_77_1.time_ <= 3.56666666666667 + arg_80_0 then
				if arg_77_1.var_.effect978 then
					Object.Destroy(arg_77_1.var_.effect978)
			...
			local var_80_37 = 4.66666666666667
			local var_80_38 = 1

			if 4.66666666666667 < arg_77_1.time_ and arg_77_1.time_ <= var_80_37 + arg_80_0 then
				...
				local var_80_39 = LeanTween.value(arg_77_1.dialog_, 0, 1, 0.3)

				var_80_39:setOnUpdate(LuaHelper.FloatAction(function(arg_81_0)
					arg_77_1.dialogCg_.alpha = arg_81_0
				end))
				var_80_39:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_77_1.dialog_)
					var_80_39:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_80_40 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(321241018).content)

				arg_77_1.text_.text = var_80_40

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_42 = 40 <= 0 and var_80_38 or var_80_38 * (utf8.len(var_80_40) / 40)

				if (40 <= 0 and var_80_38 or var_80_38 * (utf8.len(var_80_40) / 40)) > 0 and var_80_38 < var_80_42 then
					arg_77_1.talkMaxDuration = var_80_42
					var_80_37 = var_80_37 + 0.3

					if var_80_42 + var_80_37 > arg_77_1.duration_ then
						arg_77_1.duration_ = var_80_42 + var_80_37
					end
				end
			...
			local var_80_43 = var_80_37 + 0.3
			local var_80_44 = math.max(var_80_38, arg_77_1.talkMaxDuration)

			if var_80_37 + 0.3 <= arg_77_1.time_ and arg_77_1.time_ < var_80_43 + var_80_44 then
	...
	Play321241019 = function(arg_83_0, arg_83_1)
		...
		function arg_83_1.onSingleLineUpdate_(arg_86_0)
			...
			if 0 < arg_83_1.time_ and arg_83_1.time_ <= 0 + arg_86_0 then
				...
				local var_86_1 = arg_83_1:FormatText(arg_83_1:GetWordFromCfg(321241019).content)

				arg_83_1.text_.text = var_86_1

				LuaForUtil.ClearLinePrefixSymbol(arg_83_1.text_)

				local var_86_3 = 32 <= 0 and var_86_0 or var_86_0 * (utf8.len(var_86_1) / 32)

				if (32 <= 0 and var_86_0 or var_86_0 * (utf8.len(var_86_1) / 32)) > 0 and var_86_0 < var_86_3 then
	...
	Play321241020 = function(arg_87_0, arg_87_1)
		...
		function arg_87_1.onSingleLineUpdate_(arg_90_0)
			...
			if 0 < arg_87_1.time_ and arg_87_1.time_ <= 0 + arg_90_0 then
				...
				local var_90_1 = arg_87_1:FormatText(arg_87_1:GetWordFromCfg(321241020).content)
	...
	Play321241021 = function(arg_91_0, arg_91_1)
		...
		function arg_91_1.onSingleLineUpdate_(arg_94_0)
			if 1.23333333333333 < arg_91_1.time_ and arg_91_1.time_ <= 1.23333333333333 + arg_94_0 then
				arg_91_1:AudioAction("play", "effect", "se_story_140", "se_story_140_footstep_walk04", "")
			end

			local var_94_1 = 0
			local var_94_2 = 1.325
			...
			if 0 < arg_91_1.time_ and arg_91_1.time_ <= var_94_1 + arg_94_0 then
				...
				local var_94_3 = arg_91_1:FormatText(arg_91_1:GetWordFromCfg(321241021).content)

				arg_91_1.text_.text = var_94_3

				LuaForUtil.ClearLinePrefixSymbol(arg_91_1.text_)

				local var_94_5 = 53 <= 0 and var_94_2 or var_94_2 * (utf8.len(var_94_3) / 53)

				if (53 <= 0 and var_94_2 or var_94_2 * (utf8.len(var_94_3) / 53)) > 0 and var_94_2 < var_94_5 then
	...
	Play321241022 = function(arg_95_0, arg_95_1)
		...
		function arg_95_1.onSingleLineUpdate_(arg_98_0)
			...
			if 0 < arg_95_1.time_ and arg_95_1.time_ <= 0 + arg_98_0 then
				...
				local var_98_1 = arg_95_1:GetWordFromCfg(321241022)
				...
				if manager.audio:GetVoiceLength("story_v_out_321241", "321241022", "story_v_out_321241.awb") ~= 0 then
					local var_98_5 = manager.audio:GetVoiceLength("story_v_out_321241", "321241022", "story_v_out_321241.awb") / 1000
					...
					if var_98_1.prefab_name ~= "" and arg_95_1.actors_[var_98_1.prefab_name] ~= nil then
						local var_98_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_95_1.actors_[var_98_1.prefab_name].transform, "story_v_out_321241", "321241022", "story_v_out_321241.awb")

						arg_95_1:RecordAudio("321241022", var_98_6)
						arg_95_1:RecordAudio("321241022", var_98_6)
					else
	...
	Play321241023 = function(arg_99_0, arg_99_1)
		...
		function arg_99_1.onSingleLineUpdate_(arg_102_0)
			...
			if 0 < arg_99_1.time_ and arg_99_1.time_ <= var_102_1 + arg_102_0 then
				...
				local var_102_3 = arg_99_1:FormatText(arg_99_1:GetWordFromCfg(321241023).content)

				arg_99_1.text_.text = var_102_3

				LuaForUtil.ClearLinePrefixSymbol(arg_99_1.text_)

				local var_102_5 = 19 <= 0 and var_102_2 or var_102_2 * (utf8.len(var_102_3) / 19)

				if (19 <= 0 and var_102_2 or var_102_2 * (utf8.len(var_102_3) / 19)) > 0 and var_102_2 < var_102_5 then
	...
	Play321241024 = function(arg_103_0, arg_103_1)
		...
		function arg_103_1.onSingleLineUpdate_(arg_106_0)
			if 0 < arg_103_1.time_ and arg_103_1.time_ <= 0 + arg_106_0 then
				arg_103_1.var_.moveOldPos1284ui_story = arg_103_1.actors_["1284ui_story"].transform.localPosition
			end

			local var_106_0 = 0.001

			if 0 <= arg_103_1.time_ and arg_103_1.time_ < 0 + var_106_0 then
				arg_103_1.actors_["1284ui_story"].transform.localPosition = Vector3.Lerp(arg_103_1.var_.moveOldPos1284ui_story, Vector3.New(0, 100, 0), (arg_103_1.time_ - 0) / var_106_0)
				arg_103_1.actors_["1284ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_103_1.actors_["1284ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_103_1.actors_["1284ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_103_1.actors_["1284ui_story"].transform.position).z)
				arg_103_1.actors_["1284ui_story"].transform.localEulerAngles.z = 0
				arg_103_1.actors_["1284ui_story"].transform.localEulerAngles.x = 0
				arg_103_1.actors_["1284ui_story"].transform.localEulerAngles = arg_103_1.actors_["1284ui_story"].transform.localEulerAngles
			end

			if arg_103_1.time_ >= 0 + var_106_0 and arg_103_1.time_ < 0 + var_106_0 + arg_106_0 then
				arg_103_1.actors_["1284ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_103_1.actors_["1284ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_103_1.actors_["1284ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_103_1.actors_["1284ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_103_1.actors_["1284ui_story"].transform.position).z)
				arg_103_1.actors_["1284ui_story"].transform.localEulerAngles.z = 0
				arg_103_1.actors_["1284ui_story"].transform.localEulerAngles.x = 0
				arg_103_1.actors_["1284ui_story"].transform.localEulerAngles = arg_103_1.actors_["1284ui_story"].transform.localEulerAngles
			...
			if 0 < arg_103_1.time_ and arg_103_1.time_ <= var_106_1 + arg_106_0 then
				...
				local var_106_3 = arg_103_1:FormatText(arg_103_1:GetWordFromCfg(321241024).content)

				arg_103_1.text_.text = var_106_3

				LuaForUtil.ClearLinePrefixSymbol(arg_103_1.text_)

				local var_106_5 = 39 <= 0 and var_106_2 or var_106_2 * (utf8.len(var_106_3) / 39)

				if (39 <= 0 and var_106_2 or var_106_2 * (utf8.len(var_106_3) / 39)) > 0 and var_106_2 < var_106_5 then
	...
	Play321241025 = function(arg_107_0, arg_107_1)
		...
		function arg_107_1.onSingleLineUpdate_(arg_110_0)
			...
			if 0 < arg_107_1.time_ and arg_107_1.time_ <= 0 + arg_110_0 then
				...
				local var_110_1 = arg_107_1:FormatText(arg_107_1:GetWordFromCfg(321241025).content)

				arg_107_1.text_.text = var_110_1

				LuaForUtil.ClearLinePrefixSymbol(arg_107_1.text_)

				local var_110_3 = 18 <= 0 and var_110_0 or var_110_0 * (utf8.len(var_110_1) / 18)

				if (18 <= 0 and var_110_0 or var_110_0 * (utf8.len(var_110_1) / 18)) > 0 and var_110_0 < var_110_3 then
	...
	Play321241026 = function(arg_111_0, arg_111_1)
		...
		function arg_111_1.onSingleLineUpdate_(arg_114_0)
			...
			if 0 < arg_111_1.time_ and arg_111_1.time_ <= 0 + arg_114_0 then
				...
				local var_114_1 = arg_111_1:FormatText(arg_111_1:GetWordFromCfg(321241026).content)
	...
	Play321241027 = function(arg_115_0, arg_115_1)
		...
		function arg_115_1.onSingleLineUpdate_(arg_118_0)
			if arg_115_1.bgs_.MS2107 == nil then
				local var_118_0 = Object.Instantiate(arg_115_1.paintGo_)

				var_118_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "MS2107")
				var_118_0.name = "MS2107"
				var_118_0.transform.parent = arg_115_1.stage_.transform
				var_118_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_115_1.bgs_.MS2107 = var_118_0
			end

			if 2 < arg_115_1.time_ and arg_115_1.time_ <= 2 + arg_118_0 then
				local var_118_1 = arg_115_1.bgs_.MS2107

				arg_115_1.bgs_.MS2107.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_118_4 = 3.85

			if 3.85 < arg_115_1.time_ and arg_115_1.time_ <= var_118_4 + arg_118_0 then
			...
			local var_118_13 = arg_115_1.bgs_.MS2107.transform

			if 2 < arg_115_1.time_ and arg_115_1.time_ <= 2 + arg_118_0 then
				arg_115_1.var_.moveOldPosMS2107 = var_118_13.localPosition
			end

			local var_118_14 = 0.001

			if 2 <= arg_115_1.time_ and arg_115_1.time_ < 2 + var_118_14 then
				var_118_13.localPosition = Vector3.Lerp(arg_115_1.var_.moveOldPosMS2107, Vector3.New(0, 0.75, 10), (arg_115_1.time_ - 2) / var_118_14)
			end

			if arg_115_1.time_ >= 2 + var_118_14 and arg_115_1.time_ < 2 + var_118_14 + arg_118_0 then
				var_118_13.localPosition = Vector3.New(0, 0.75, 10)
			end

			local var_118_15 = arg_115_1.bgs_.MS2107.transform

			if 2 < arg_115_1.time_ and arg_115_1.time_ <= 2 + arg_118_0 then
				arg_115_1.var_.moveOldPosMS2107 = var_118_15.localPosition
			end

			local var_118_16 = 3

			if 2 <= arg_115_1.time_ and arg_115_1.time_ < 2 + var_118_16 then
				var_118_15.localPosition = Vector3.Lerp(arg_115_1.var_.moveOldPosMS2107, Vector3.New(0, 1, 9.5), (arg_115_1.time_ - 2) / var_118_16)
			end

			if arg_115_1.time_ >= 2 + var_118_16 and arg_115_1.time_ < 2 + var_118_16 + arg_118_0 then
				var_118_15.localPosition = Vector3.New(0, 1, 9.5)
			end

			if 2 < arg_115_1.time_ and arg_115_1.time_ <= 2 + arg_118_0 then
				if arg_115_1.var_.effecthundun1 then
					Object.Destroy(arg_115_1.var_.effecthundun1)

					arg_115_1.var_.effecthundun1 = nil
				end
			end

			if 2.03333333333333 < arg_115_1.time_ and arg_115_1.time_ <= 2.03333333333333 + arg_118_0 then
				if arg_115_1.var_.effect9998 then
					Object.Destroy(arg_115_1.var_.effect9998)

					arg_115_1.var_.effect9998 = nil
				end
			end

			local var_118_19 = 3.85

			if 3.85 < arg_115_1.time_ and arg_115_1.time_ <= var_118_19 + arg_118_0 then
				arg_115_1.allBtn_.enabled = false
			end

			if arg_115_1.time_ >= var_118_19 + 1.2 and arg_115_1.time_ < var_118_19 + 1.2 + arg_118_0 then
				arg_115_1.allBtn_.enabled = true
			end
			...
			local var_118_20 = 3.85
			local var_118_21 = 0.15

			if 3.85 < arg_115_1.time_ and arg_115_1.time_ <= var_118_20 + arg_118_0 then
				...
				local var_118_23 = arg_115_1:FormatText(arg_115_1:GetWordFromCfg(321241027).content)

				arg_115_1.text_.text = var_118_23

				LuaForUtil.ClearLinePrefixSymbol(arg_115_1.text_)

				local var_118_25 = 6 <= 0 and var_118_21 or var_118_21 * (utf8.len(var_118_23) / 6)

				if (6 <= 0 and var_118_21 or var_118_21 * (utf8.len(var_118_23) / 6)) > 0 and var_118_21 < var_118_25 then
					arg_115_1.talkMaxDuration = var_118_25
					var_118_20 = var_118_20 + 0.3

					if var_118_25 + var_118_20 > arg_115_1.duration_ then
						arg_115_1.duration_ = var_118_25 + var_118_20
					end
				end
			...
			local var_118_26 = var_118_20 + 0.3
			local var_118_27 = math.max(var_118_21, arg_115_1.talkMaxDuration)

			if var_118_20 + 0.3 <= arg_115_1.time_ and arg_115_1.time_ < var_118_26 + var_118_27 then
	...
	Play321241028 = function(arg_121_0, arg_121_1)
		...
		function arg_121_1.onSingleLineUpdate_(arg_124_0)
			if 0.166666666666667 < arg_121_1.time_ and arg_121_1.time_ <= 0.166666666666667 + arg_124_0 then
				arg_121_1:AudioAction("play", "effect", "se_story_140", "se_story_140_footstep_walk05", "")
			end

			local var_124_1 = 0
			local var_124_2 = 1.475
			...
			if 0 < arg_121_1.time_ and arg_121_1.time_ <= var_124_1 + arg_124_0 then
				...
				local var_124_3 = arg_121_1:FormatText(arg_121_1:GetWordFromCfg(321241028).content)

				arg_121_1.text_.text = var_124_3

				LuaForUtil.ClearLinePrefixSymbol(arg_121_1.text_)

				local var_124_5 = 59 <= 0 and var_124_2 or var_124_2 * (utf8.len(var_124_3) / 59)

				if (59 <= 0 and var_124_2 or var_124_2 * (utf8.len(var_124_3) / 59)) > 0 and var_124_2 < var_124_5 then
	...
	Play321241029 = function(arg_125_0, arg_125_1)
		...
		function arg_125_1.onSingleLineUpdate_(arg_128_0)
			...
			if 0 < arg_125_1.time_ and arg_125_1.time_ <= 0 + arg_128_0 then
				...
				local var_128_1 = arg_125_1:FormatText(arg_125_1:GetWordFromCfg(321241029).content)
	...
	Play321241030 = function(arg_129_0, arg_129_1)
		...
		function arg_129_1.onSingleLineUpdate_(arg_132_0)
			...
			if 0 < arg_129_1.time_ and arg_129_1.time_ <= 0 + arg_132_0 then
				...
				local var_132_1 = arg_129_1:FormatText(arg_129_1:GetWordFromCfg(321241030).content)
	...
	Play321241031 = function(arg_133_0, arg_133_1)
		...
		function arg_133_1.onSingleLineUpdate_(arg_136_0)
			...
			if 0 < arg_133_1.time_ and arg_133_1.time_ <= 0 + arg_136_0 then
				...
				local var_136_1 = arg_133_1:FormatText(arg_133_1:GetWordFromCfg(321241031).content)
	...
	Play321241032 = function(arg_137_0, arg_137_1)
		...
		function arg_137_1.onSingleLineUpdate_(arg_140_0)
			...
			if 0 < arg_137_1.time_ and arg_137_1.time_ <= 0 + arg_140_0 then
				...
				local var_140_1 = arg_137_1:GetWordFromCfg(321241032)
				...
				local var_140_4 = 25 <= 0 and var_140_0 or var_140_0 * (utf8.len(var_140_2) / 25)

				if (25 <= 0 and var_140_0 or var_140_0 * (utf8.len(var_140_2) / 25)) > 0 and var_140_0 < var_140_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_321241", "321241032", "story_v_out_321241.awb") ~= 0 then
					local var_140_5 = manager.audio:GetVoiceLength("story_v_out_321241", "321241032", "story_v_out_321241.awb") / 1000
					...
					if var_140_1.prefab_name ~= "" and arg_137_1.actors_[var_140_1.prefab_name] ~= nil then
						local var_140_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_137_1.actors_[var_140_1.prefab_name].transform, "story_v_out_321241", "321241032", "story_v_out_321241.awb")

						arg_137_1:RecordAudio("321241032", var_140_6)
						arg_137_1:RecordAudio("321241032", var_140_6)
					else
	...
	Play321241033 = function(arg_141_0, arg_141_1)
		...
		function arg_141_1.onSingleLineUpdate_(arg_144_0)
			if 0 < arg_141_1.time_ and arg_141_1.time_ <= 0 + arg_144_0 then
				local var_144_0 = arg_141_1.var_.effect9247

				if not arg_141_1.var_.effect9247 then
					var_144_0 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"), manager.ui.mainCamera.transform)
					var_144_0.name = "9247"
					arg_141_1.var_.effect9247 = var_144_0
				else
					var_144_0.transform:SetParent(manager.ui.mainCamera.transform)
				end

				var_144_0.transform.localPosition = Vector3.New(0, 0, 0)
				var_144_0.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_144_2 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_144_3 = var_144_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_144_0, iter_144_1 in ipairs((var_144_3:ToTable())) do
					iter_144_1.transform.localScale = Vector3.New(iter_144_1.transform.localScale.x / var_144_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_144_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_144_1.transform.localScale.y / var_144_2, iter_144_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_141_1.time_ and arg_141_1.time_ <= var_144_5 + arg_144_0 then
				...
				local var_144_7 = arg_141_1:GetWordFromCfg(321241033)
				...
				local var_144_10 = 23 <= 0 and var_144_6 or var_144_6 * (utf8.len(var_144_8) / 23)

				if (23 <= 0 and var_144_6 or var_144_6 * (utf8.len(var_144_8) / 23)) > 0 and var_144_6 < var_144_10 then
				...
				if manager.audio:GetVoiceLength("story_v_out_321241", "321241033", "story_v_out_321241.awb") ~= 0 then
					local var_144_11 = manager.audio:GetVoiceLength("story_v_out_321241", "321241033", "story_v_out_321241.awb") / 1000
					...
					if var_144_7.prefab_name ~= "" and arg_141_1.actors_[var_144_7.prefab_name] ~= nil then
						local var_144_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_141_1.actors_[var_144_7.prefab_name].transform, "story_v_out_321241", "321241033", "story_v_out_321241.awb")

						arg_141_1:RecordAudio("321241033", var_144_12)
						arg_141_1:RecordAudio("321241033", var_144_12)
					else
	...
	Play321241034 = function(arg_145_0, arg_145_1)
		...
		function arg_145_1.onSingleLineUpdate_(arg_148_0)
			if 0 < arg_145_1.time_ and arg_145_1.time_ <= 0 + arg_148_0 then
				...
				if var_148_0 then
					var_148_0.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.BlurByBackground
					var_148_0.radialBlurScale = 0
					var_148_0.radialBlurGradient = 1
					var_148_0.radialBlurIntensity = 1

					if nil then
						var_148_0.radialBlurTarget = (nil).transform
					end
				end
			end
			...
			if 0 <= arg_145_1.time_ and arg_145_1.time_ < 0 + var_148_1 then
				...
				if var_148_2 then
					...
					var_148_2.radialBlurScale = Mathf.Lerp(0, 0.558, (arg_145_1.time_ - 0) / var_148_1)
					var_148_2.radialBlurGradient = Mathf.Lerp(1, 1, (arg_145_1.time_ - 0) / var_148_1)
					var_148_2.radialBlurIntensity = Mathf.Lerp(1, 1, (arg_145_1.time_ - 0) / var_148_1)
				end
			end

			if arg_145_1.time_ >= 0 + var_148_1 and arg_145_1.time_ < 0 + var_148_1 + arg_148_0 then
				local var_148_3 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_148_3 then
					var_148_3.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.BlurByBackground
					var_148_3.radialBlurScale = 0.558
					var_148_3.radialBlurGradient = 1
					var_148_3.radialBlurIntensity = 1
				end
			end

			if 0 < arg_145_1.time_ and arg_145_1.time_ <= 0 + arg_148_0 then
				if arg_145_1.var_.effect9247 then
					Object.Destroy(arg_145_1.var_.effect9247)
			...
			if 0 < arg_145_1.time_ and arg_145_1.time_ <= var_148_5 + arg_148_0 then
				...
				local var_148_7 = arg_145_1:FormatText(arg_145_1:GetWordFromCfg(321241034).content)

				arg_145_1.text_.text = var_148_7

				LuaForUtil.ClearLinePrefixSymbol(arg_145_1.text_)

				local var_148_9 = 35 <= 0 and var_148_6 or var_148_6 * (utf8.len(var_148_7) / 35)

				if (35 <= 0 and var_148_6 or var_148_6 * (utf8.len(var_148_7) / 35)) > 0 and var_148_6 < var_148_9 then
	...
	Play321241035 = function(arg_149_0, arg_149_1)
		...
		function arg_149_1.onSingleLineUpdate_(arg_152_0)
			...
			if 0 < arg_149_1.time_ and arg_149_1.time_ <= 0 + arg_152_0 then
				...
				local var_152_1 = arg_149_1:FormatText(arg_149_1:GetWordFromCfg(321241035).content)

				arg_149_1.text_.text = var_152_1

				LuaForUtil.ClearLinePrefixSymbol(arg_149_1.text_)

				local var_152_3 = 46 <= 0 and var_152_0 or var_152_0 * (utf8.len(var_152_1) / 46)

				if (46 <= 0 and var_152_0 or var_152_0 * (utf8.len(var_152_1) / 46)) > 0 and var_152_0 < var_152_3 then
	...
	Play321241036 = function(arg_153_0, arg_153_1)
		...
		function arg_153_1.onSingleLineUpdate_(arg_156_0)
			...
			if 0 < arg_153_1.time_ and arg_153_1.time_ <= 0 + arg_156_0 then
				...
				local var_156_1 = arg_153_1:FormatText(arg_153_1:GetWordFromCfg(321241036).content)
	...
	Play321241037 = function(arg_157_0, arg_157_1)
		...
		function arg_157_1.onSingleLineUpdate_(arg_160_0)
			...
			if 0 < arg_157_1.time_ and arg_157_1.time_ <= 0 + arg_160_0 then
				...
				local var_160_1 = arg_157_1:FormatText(arg_157_1:GetWordFromCfg(321241037).content)
	...
	Play321241038 = function(arg_161_0, arg_161_1)
		...
		function arg_161_1.onSingleLineUpdate_(arg_164_0)
			...
			if 0 < arg_161_1.time_ and arg_161_1.time_ <= 0 + arg_164_0 then
				...
				local var_164_1 = arg_161_1:FormatText(arg_161_1:GetWordFromCfg(321241038).content)
	...
	Play321241039 = function(arg_165_0, arg_165_1)
		...
		function arg_165_1.onSingleLineUpdate_(arg_168_0)
			...
			if 0 < arg_165_1.time_ and arg_165_1.time_ <= 0 + arg_168_0 then
				...
				local var_168_1 = arg_165_1:FormatText(arg_165_1:GetWordFromCfg(321241039).content)
	...
	Play321241040 = function(arg_169_0, arg_169_1)
		...
		function arg_169_1.onSingleLineUpdate_(arg_172_0)
			...
			if 0 < arg_169_1.time_ and arg_169_1.time_ <= 0 + arg_172_0 then
				...
				local var_172_1 = arg_169_1:FormatText(arg_169_1:GetWordFromCfg(321241040).content)

				arg_169_1.text_.text = var_172_1

				LuaForUtil.ClearLinePrefixSymbol(arg_169_1.text_)

				local var_172_3 = 59 <= 0 and var_172_0 or var_172_0 * (utf8.len(var_172_1) / 59)

				if (59 <= 0 and var_172_0 or var_172_0 * (utf8.len(var_172_1) / 59)) > 0 and var_172_0 < var_172_3 then
	...
	Play321241041 = function(arg_173_0, arg_173_1)
		...
		function arg_173_1.onSingleLineUpdate_(arg_176_0)
			...
			if 0 < arg_173_1.time_ and arg_173_1.time_ <= 0 + arg_176_0 then
				...
				local var_176_1 = arg_173_1:FormatText(arg_173_1:GetWordFromCfg(321241041).content)

				arg_173_1.text_.text = var_176_1

				LuaForUtil.ClearLinePrefixSymbol(arg_173_1.text_)

				local var_176_3 = 12 <= 0 and var_176_0 or var_176_0 * (utf8.len(var_176_1) / 12)

				if (12 <= 0 and var_176_0 or var_176_0 * (utf8.len(var_176_1) / 12)) > 0 and var_176_0 < var_176_3 then
	...
	Play321241042 = function(arg_177_0, arg_177_1)
		...
		function arg_177_1.onSingleLineUpdate_(arg_180_0)
			...
			if 0 < arg_177_1.time_ and arg_177_1.time_ <= 0 + arg_180_0 then
				...
				local var_180_1 = arg_177_1:FormatText(arg_177_1:GetWordFromCfg(321241042).content)
	...
	Play321241043 = function(arg_181_0, arg_181_1)
		...
		function arg_181_1.onSingleLineUpdate_(arg_184_0)
			...
			if 0 < arg_181_1.time_ and arg_181_1.time_ <= 0 + arg_184_0 then
				...
				local var_184_1 = arg_181_1:FormatText(arg_181_1:GetWordFromCfg(321241043).content)

				arg_181_1.text_.text = var_184_1

				LuaForUtil.ClearLinePrefixSymbol(arg_181_1.text_)

				local var_184_3 = 30 <= 0 and var_184_0 or var_184_0 * (utf8.len(var_184_1) / 30)

				if (30 <= 0 and var_184_0 or var_184_0 * (utf8.len(var_184_1) / 30)) > 0 and var_184_0 < var_184_3 then
	...
	Play321241044 = function(arg_185_0, arg_185_1)
		...
		function arg_185_1.onSingleLineUpdate_(arg_188_0)
			...
			if 0 < arg_185_1.time_ and arg_185_1.time_ <= 0 + arg_188_0 then
				...
				local var_188_1 = arg_185_1:FormatText(arg_185_1:GetWordFromCfg(321241044).content)
	...
	Play321241045 = function(arg_189_0, arg_189_1)
		...
		function arg_189_1.onSingleLineUpdate_(arg_192_0)
			...
			if 0 < arg_189_1.time_ and arg_189_1.time_ <= 0 + arg_192_0 then
				...
				local var_192_1 = arg_189_1:FormatText(arg_189_1:GetWordFromCfg(321241045).content)
	...
	Play321241046 = function(arg_193_0, arg_193_1)
		...
		function arg_193_1.onSingleLineUpdate_(arg_196_0)
			...
			if 0 < arg_193_1.time_ and arg_193_1.time_ <= 0 + arg_196_0 then
				...
				local var_196_1 = arg_193_1:FormatText(arg_193_1:GetWordFromCfg(321241046).content)
	...
	Play321241047 = function(arg_197_0, arg_197_1)
		...
		function arg_197_1.onSingleLineUpdate_(arg_200_0)
			...
			if 0 < arg_197_1.time_ and arg_197_1.time_ <= 0 + arg_200_0 then
				...
				local var_200_1 = arg_197_1:FormatText(arg_197_1:GetWordFromCfg(321241047).content)

				arg_197_1.text_.text = var_200_1

				LuaForUtil.ClearLinePrefixSymbol(arg_197_1.text_)

				local var_200_3 = 24 <= 0 and var_200_0 or var_200_0 * (utf8.len(var_200_1) / 24)

				if (24 <= 0 and var_200_0 or var_200_0 * (utf8.len(var_200_1) / 24)) > 0 and var_200_0 < var_200_3 then
	...
	Play321241048 = function(arg_201_0, arg_201_1)
		...
		function arg_201_1.onSingleLineUpdate_(arg_204_0)
			if 1.83333333333333 < arg_201_1.time_ and arg_201_1.time_ <= 1.83333333333333 + arg_204_0 then
				local var_204_0 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_204_0 then
					var_204_0.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.Disabled
					var_204_0.radialBlurScale = 0
					var_204_0.radialBlurGradient = 1
					var_204_0.radialBlurIntensity = 1

					if nil then
						var_204_0.radialBlurTarget = (nil).transform
					end
				end
			end

			local var_204_1 = 0.0166666666666667

			if 1.83333333333333 <= arg_201_1.time_ and arg_201_1.time_ < 1.83333333333333 + var_204_1 then
				...
				if var_204_2 then
					...
					var_204_2.radialBlurScale = Mathf.Lerp(0, 0, (arg_201_1.time_ - 1.83333333333333) / var_204_1)
					var_204_2.radialBlurGradient = Mathf.Lerp(1, 1, (arg_201_1.time_ - 1.83333333333333) / var_204_1)
					var_204_2.radialBlurIntensity = Mathf.Lerp(1, 1, (arg_201_1.time_ - 1.83333333333333) / var_204_1)
				end
			end

			if arg_201_1.time_ >= 1.83333333333333 + var_204_1 and arg_201_1.time_ < 1.83333333333333 + var_204_1 + arg_204_0 then
				local var_204_3 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_204_3 then
					var_204_3.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.Disabled
					var_204_3.radialBlurScale = 0
					var_204_3.radialBlurGradient = 1
					var_204_3.radialBlurIntensity = 1
				end
			end
			...
			local var_204_5 = 1.83333333333333
			...
			if 1.83333333333333 < arg_201_1.time_ and arg_201_1.time_ <= var_204_8 + arg_204_0 then
				arg_201_1.mask_.enabled = true
				arg_201_1.mask_.raycastTarget = true
			...
			local var_204_9 = 1.76666666666567
			...
			local var_204_12 = arg_201_1.bgs_.MS2107.transform

			if 1.83333333333333 < arg_201_1.time_ and arg_201_1.time_ <= 1.83333333333333 + arg_204_0 then
				arg_201_1.var_.moveOldPosMS2107 = var_204_12.localPosition
			end

			local var_204_13 = 0.001

			if 1.83333333333333 <= arg_201_1.time_ and arg_201_1.time_ < 1.83333333333333 + var_204_13 then
				var_204_12.localPosition = Vector3.Lerp(arg_201_1.var_.moveOldPosMS2107, Vector3.New(0, 1, 9.5), (arg_201_1.time_ - 1.83333333333333) / var_204_13)
			end

			if arg_201_1.time_ >= 1.83333333333333 + var_204_13 and arg_201_1.time_ < 1.83333333333333 + var_204_13 + arg_204_0 then
				var_204_12.localPosition = Vector3.New(0, 1, 9.5)
			end

			local var_204_14 = arg_201_1.bgs_.MS2107.transform

			if 1.85 < arg_201_1.time_ and arg_201_1.time_ <= 1.85 + arg_204_0 then
				arg_201_1.var_.moveOldPosMS2107 = var_204_14.localPosition
			end

			local var_204_15 = 1.75

			if 1.85 <= arg_201_1.time_ and arg_201_1.time_ < 1.85 + var_204_15 then
				var_204_14.localPosition = Vector3.Lerp(arg_201_1.var_.moveOldPosMS2107, Vector3.New(0, 1, 8.55), (arg_201_1.time_ - 1.85) / var_204_15)
			end

			if arg_201_1.time_ >= 1.85 + var_204_15 and arg_201_1.time_ < 1.85 + var_204_15 + arg_204_0 then
				var_204_14.localPosition = Vector3.New(0, 1, 8.55)
			end

			local var_204_16 = 0.433333333333333

			if 0.433333333333333 < arg_201_1.time_ and arg_201_1.time_ <= var_204_16 + arg_204_0 then
				arg_201_1.allBtn_.enabled = false
			end

			if arg_201_1.time_ >= var_204_16 + 3.16666666666667 and arg_201_1.time_ < var_204_16 + 3.16666666666667 + arg_204_0 then
			...
			local var_204_17 = 3.175
			local var_204_18 = 0.425

			if 3.175 < arg_201_1.time_ and arg_201_1.time_ <= var_204_17 + arg_204_0 then
				...
				local var_204_20 = arg_201_1:FormatText(arg_201_1:GetWordFromCfg(321241048).content)

				arg_201_1.text_.text = var_204_20

				LuaForUtil.ClearLinePrefixSymbol(arg_201_1.text_)

				local var_204_22 = 17 <= 0 and var_204_18 or var_204_18 * (utf8.len(var_204_20) / 17)

				if (17 <= 0 and var_204_18 or var_204_18 * (utf8.len(var_204_20) / 17)) > 0 and var_204_18 < var_204_22 then
					arg_201_1.talkMaxDuration = var_204_22
					var_204_17 = var_204_17 + 0.3

					if var_204_22 + var_204_17 > arg_201_1.duration_ then
						arg_201_1.duration_ = var_204_22 + var_204_17
					end
				end
			...
			local var_204_23 = var_204_17 + 0.3
			local var_204_24 = math.max(var_204_18, arg_201_1.talkMaxDuration)

			if var_204_17 + 0.3 <= arg_201_1.time_ and arg_201_1.time_ < var_204_23 + var_204_24 then
				arg_201_1.typewritter.percent = (arg_201_1.time_ - var_204_23) / var_204_24
