	...
	Play423171001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_21 + arg_4_0 then
				...
				local var_4_24 = arg_1_1:GetWordFromCfg(423171001)
				...
				if manager.audio:GetVoiceLength("story_v_out_423171", "423171001", "story_v_out_423171.awb") ~= 0 then
					local var_4_28 = manager.audio:GetVoiceLength("story_v_out_423171", "423171001", "story_v_out_423171.awb") / 1000
					...
					if var_4_24.prefab_name ~= "" and arg_1_1.actors_[var_4_24.prefab_name] ~= nil then
						local var_4_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_24.prefab_name].transform, "story_v_out_423171", "423171001", "story_v_out_423171.awb")

						arg_1_1:RecordAudio("423171001", var_4_29)
						arg_1_1:RecordAudio("423171001", var_4_29)
					else
