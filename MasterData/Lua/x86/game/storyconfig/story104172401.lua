	...
	Play417241053 = function(arg_228_0, arg_228_1)
		...
		function arg_228_1.onSingleLineUpdate_(arg_231_0)
			...
			if 2 < arg_228_1.time_ and arg_228_1.time_ <= 2 + arg_231_0 then
				...
				local var_231_19 = var_231_16.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_231_3, iter_231_4 in ipairs((var_231_19:ToTable())) do
					iter_231_4.transform.localScale = Vector3.New(iter_231_4.transform.localScale.x / var_231_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_231_19 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_231_4.transform.localScale.y / var_231_18, iter_231_4.transform.localScale.z)
				end
			end
			...
			local var_231_24 = 3.999999999999
			local var_231_25 = 1.2

			if 3.999999999999 < arg_228_1.time_ and arg_228_1.time_ <= var_231_24 + arg_231_0 then
				...
				local var_231_26 = LeanTween.value(arg_228_1.dialog_, 0, 1, 0.3)

				var_231_26:setOnUpdate(LuaHelper.FloatAction(function(arg_232_0)
					arg_228_1.dialogCg_.alpha = arg_232_0
				end))
				var_231_26:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_228_1.dialog_)
					var_231_26:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_231_27 = arg_228_1:FormatText(arg_228_1:GetWordFromCfg(417241053).content)

				arg_228_1.text_.text = var_231_27

				LuaForUtil.ClearLinePrefixSymbol(arg_228_1.text_)

				local var_231_29 = 48 <= 0 and var_231_25 or var_231_25 * (utf8.len(var_231_27) / 48)

				if (48 <= 0 and var_231_25 or var_231_25 * (utf8.len(var_231_27) / 48)) > 0 and var_231_25 < var_231_29 then
					arg_228_1.talkMaxDuration = var_231_29
					var_231_24 = var_231_24 + 0.3

					if var_231_29 + var_231_24 > arg_228_1.duration_ then
						arg_228_1.duration_ = var_231_29 + var_231_24
					end
				end
			...
			local var_231_30 = var_231_24 + 0.3
			local var_231_31 = math.max(var_231_25, arg_228_1.talkMaxDuration)

			if var_231_24 + 0.3 <= arg_228_1.time_ and arg_228_1.time_ < var_231_30 + var_231_31 then
	...
	Play417241069 = function(arg_300_0, arg_300_1)
		...
		function arg_300_1.onSingleLineUpdate_(arg_303_0)
			...
			if 0 < arg_300_1.time_ and arg_300_1.time_ <= 0 + arg_303_0 then
				...
				local var_303_5 = var_303_2.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_303_1, iter_303_2 in ipairs((var_303_5:ToTable())) do
					iter_303_2.transform.localScale = Vector3.New(iter_303_2.transform.localScale.x / var_303_4 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_303_5 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_303_2.transform.localScale.y / var_303_4, iter_303_2.transform.localScale.z)
				end
			end
			...
			if 0.166666666666666 < arg_300_1.time_ and arg_300_1.time_ <= 0.166666666666666 + arg_303_0 then
				arg_300_1.var_.shakeOldPos = var_303_7.localPosition
			end

			local var_303_8 = 0.866666666666667

			if 0.166666666666666 <= arg_300_1.time_ and arg_300_1.time_ < 0.166666666666666 + var_303_8 then
				local var_303_9, var_303_10 = math.modf((arg_300_1.time_ - 0.166666666666666) / 0.066)

				var_303_7.localPosition = Vector3.New(var_303_10 * 0.13, var_303_10 * 0.13, var_303_10 * 0.13) + arg_300_1.var_.shakeOldPos
			end

			if arg_300_1.time_ >= 0.166666666666666 + var_303_8 and arg_300_1.time_ < 0.166666666666666 + var_303_8 + arg_303_0 then
				var_303_7.localPosition = arg_300_1.var_.shakeOldPos
			end
			...
			local var_303_12 = 1.65833333333333
			local var_303_13 = 1.375

			if 1.65833333333333 < arg_300_1.time_ and arg_300_1.time_ <= var_303_12 + arg_303_0 then
				...
				local var_303_15 = arg_300_1:FormatText(arg_300_1:GetWordFromCfg(417241069).content)

				arg_300_1.text_.text = var_303_15

				LuaForUtil.ClearLinePrefixSymbol(arg_300_1.text_)

				local var_303_17 = 55 <= 0 and var_303_13 or var_303_13 * (utf8.len(var_303_15) / 55)

				if (55 <= 0 and var_303_13 or var_303_13 * (utf8.len(var_303_15) / 55)) > 0 and var_303_13 < var_303_17 then
