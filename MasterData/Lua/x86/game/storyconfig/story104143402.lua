return {
	Play414342001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.9 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 then
				...
				local var_4_18 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414342001).content)
	...
	Play414342002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(414342002).content)
	...
	Play414342003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				local var_16_1 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(414342003).content)
	...
	Play414342004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				...
				local var_20_1 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(414342004).content)
	...
	Play414342005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0.266666666666667 < arg_21_1.time_ and arg_21_1.time_ <= 0.266666666666667 + arg_24_0 then
				arg_21_1:AudioAction("play", "effect", "se_story_133", "se_story_133_gaga", "")
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_1 + arg_24_0 then
				...
				arg_21_1.leftNameTxt_.text = arg_21_1:FormatText(StoryNameCfg[1016].name)
				...
				local var_24_3 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(414342005).content)
	...
	Play414342006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.playNext_(arg_27_0)
			...
			arg_25_1:RecordChoiceLog(414342006, 909, 910, 911)
		end
	...
	Play414342007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				arg_29_1.leftNameTxt_.text = arg_29_1:FormatText(StoryNameCfg[978].name)
				...
				local var_32_1 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(414342007).content)
	...
	Play414342011 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				arg_33_1.leftNameTxt_.text = arg_33_1:FormatText(StoryNameCfg[978].name)
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(414342011).content)

				arg_33_1.text_.text = var_36_1

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_3 = 44 <= 0 and var_36_0 or var_36_0 * (utf8.len(var_36_1) / 44)

				if (44 <= 0 and var_36_0 or var_36_0 * (utf8.len(var_36_1) / 44)) > 0 and var_36_0 < var_36_3 then
	...
	Play414342012 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				local var_40_1 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(414342012).content)
	...
	Play414342013 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_8 + arg_44_0 then
				...
				local var_44_10 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(414342013).content)

				arg_41_1.text_.text = var_44_10

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_12 = 25 <= 0 and var_44_9 or var_44_9 * (utf8.len(var_44_10) / 25)

				if (25 <= 0 and var_44_9 or var_44_9 * (utf8.len(var_44_10) / 25)) > 0 and var_44_9 < var_44_12 then
	...
	Play414342014 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_2 then
				var_48_1.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos104902ui_story, Vector3.New(0, 100, 0), (arg_45_1.time_ - 0) / var_48_2)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_3 + arg_48_0 then
				...
				local var_48_5 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(414342014).content)

				arg_45_1.text_.text = var_48_5

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_7 = 13 <= 0 and var_48_4 or var_48_4 * (utf8.len(var_48_5) / 13)

				if (13 <= 0 and var_48_4 or var_48_4 * (utf8.len(var_48_5) / 13)) > 0 and var_48_4 < var_48_7 then
	...
	Play414342015 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				...
				local var_52_1 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(414342015).content)
	...
	Play414342016 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				...
				arg_53_1.leftNameTxt_.text = arg_53_1:FormatText(StoryNameCfg[978].name)
				...
				local var_56_1 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(414342016).content)
	...
	Play414342017 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.playNext_(arg_59_0)
			...
			arg_57_1:RecordChoiceLog(414342017, 912, 913)
		end
	...
	Play414342018 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				...
				arg_61_1.leftNameTxt_.text = arg_61_1:FormatText(StoryNameCfg[978].name)
				...
				local var_64_1 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(414342018).content)
	...
	Play414342020 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				...
				arg_65_1:ShowWeapon(arg_65_1.var_["104902ui_story" .. "Animator"].transform, false)
			end
			...
			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_5 then
				var_68_4.localPosition = Vector3.Lerp(arg_65_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_65_1.time_ - 0) / var_68_5)
			...
			if arg_65_1.time_ >= 0 + var_68_5 and arg_65_1.time_ < 0 + var_68_5 + arg_68_0 then
				var_68_4.localPosition = Vector3.New(0, -1.2, -6)
				var_68_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_68_4.position).x, (manager.ui.mainCamera.transform.position - var_68_4.position).y, (manager.ui.mainCamera.transform.position - var_68_4.position).z)
				var_68_4.localEulerAngles.z = 0
				var_68_4.localEulerAngles.x = 0
				var_68_4.localEulerAngles = var_68_4.localEulerAngles
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_6 + arg_68_0 then
				...
				local var_68_8 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(414342020).content)

				arg_65_1.text_.text = var_68_8

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_10 = 13 <= 0 and var_68_7 or var_68_7 * (utf8.len(var_68_8) / 13)

				if (13 <= 0 and var_68_7 or var_68_7 * (utf8.len(var_68_8) / 13)) > 0 and var_68_7 < var_68_10 then
	...
	Play414342021 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_1 + arg_72_0 then
				...
				local var_72_3 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(414342021).content)
	...
	Play414342022 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				...
				local var_76_1 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(414342022).content)
	...
	Play414342023 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 and not isNil(var_80_0) and arg_77_1.var_.characterEffect104902ui_story == nil then
			...
			if arg_77_1.time_ >= 0 + var_80_1 and arg_77_1.time_ < 0 + var_80_1 + arg_80_0 and not isNil(var_80_0) and arg_77_1.var_.characterEffect104902ui_story then
				arg_77_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_3 + arg_80_0 then
				...
				local var_80_5 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(414342023).content)

				arg_77_1.text_.text = var_80_5

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_7 = 10 <= 0 and var_80_4 or var_80_4 * (utf8.len(var_80_5) / 10)

				if (10 <= 0 and var_80_4 or var_80_4 * (utf8.len(var_80_5) / 10)) > 0 and var_80_4 < var_80_7 then
	...
	Play414342019 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= 0 + arg_84_0 then
				...
				local var_84_1 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(414342019).content)
	...
	Play414342008 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				...
				arg_85_1.leftNameTxt_.text = arg_85_1:FormatText(StoryNameCfg[978].name)
				...
				local var_88_1 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(414342008).content)
	...
	Play414342009 = function(arg_89_0, arg_89_1)
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			...
			if 0 < arg_89_1.time_ and arg_89_1.time_ <= 0 + arg_92_0 then
				...
				arg_89_1.leftNameTxt_.text = arg_89_1:FormatText(StoryNameCfg[978].name)
				...
				local var_92_1 = arg_89_1:FormatText(arg_89_1:GetWordFromCfg(414342009).content)

				arg_89_1.text_.text = var_92_1

				LuaForUtil.ClearLinePrefixSymbol(arg_89_1.text_)

				local var_92_3 = 22 <= 0 and var_92_0 or var_92_0 * (utf8.len(var_92_1) / 22)

				if (22 <= 0 and var_92_0 or var_92_0 * (utf8.len(var_92_1) / 22)) > 0 and var_92_0 < var_92_3 then
	...
	Play414342010 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if 0 < arg_93_1.time_ and arg_93_1.time_ <= 0 + arg_96_0 then
				...
				local var_96_1 = arg_93_1:FormatText(arg_93_1:GetWordFromCfg(414342010).content)
