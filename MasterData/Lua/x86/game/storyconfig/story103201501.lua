	...
	Play320151046 = function(arg_195_0, arg_195_1)
		...
		function arg_195_1.onSingleLineUpdate_(arg_198_0)
			...
			if 2 < arg_195_1.time_ and arg_195_1.time_ <= 2 + arg_198_0 then
				...
				local var_198_24 = var_198_21.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_198_2, iter_198_3 in ipairs((var_198_24:ToTable())) do
					iter_198_3.transform.localScale = Vector3.New(iter_198_3.transform.localScale.x / var_198_23 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_198_24 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_198_3.transform.localScale.y / var_198_23, iter_198_3.transform.localScale.z)
				end
			end

			if 2 < arg_195_1.time_ and arg_195_1.time_ <= 2 + arg_198_0 then
				local var_198_26 = arg_195_1.var_.effectxiayu16

				if not arg_195_1.var_.effectxiayu16 then
					var_198_26 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_light"), manager.ui.mainCamera.transform)
					var_198_26.name = "xiayu16"
					arg_195_1.var_.effectxiayu16 = var_198_26
				else
					var_198_26.transform:SetParent(var_198_9000)
				end

				var_198_26.transform.localPosition = Vector3.New(0, 0, 0)
				var_198_26.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			if 4 < arg_195_1.time_ and arg_195_1.time_ <= var_198_29 + arg_198_0 then
				...
				var_198_31:setOnUpdate(LuaHelper.FloatAction(function(arg_199_0)
				...
				local var_198_32 = arg_195_1:GetWordFromCfg(320151046)
				...
				local var_198_35 = 7 <= 0 and var_198_30 or var_198_30 * (utf8.len(var_198_33) / 7)

				if (7 <= 0 and var_198_30 or var_198_30 * (utf8.len(var_198_33) / 7)) > 0 and var_198_30 < var_198_35 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320151", "320151046", "story_v_out_320151.awb") ~= 0 then
					local var_198_36 = manager.audio:GetVoiceLength("story_v_out_320151", "320151046", "story_v_out_320151.awb") / 1000
					...
					if var_198_32.prefab_name ~= "" and arg_195_1.actors_[var_198_32.prefab_name] ~= nil then
						local var_198_37 = LuaForUtil.PlayVoiceWithCriLipsync(arg_195_1.actors_[var_198_32.prefab_name].transform, "story_v_out_320151", "320151046", "story_v_out_320151.awb")

						arg_195_1:RecordAudio("320151046", var_198_37)
						arg_195_1:RecordAudio("320151046", var_198_37)
					else
