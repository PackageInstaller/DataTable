return {
	Play117061001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_8 = arg_1_1.var_.effecthuo

				if not arg_1_1.var_.effecthuo then
					var_4_8 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_red"), manager.ui.mainCamera.transform)
					var_4_8.name = "huo"
					arg_1_1.var_.effecthuo = var_4_8
				else
					var_4_8.transform:SetParent(var_4_9000)
				end

				var_4_8.transform.localPosition = Vector3.New(0, 0, 0.03)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 then
				...
				local var_4_16 = manager.audio:GetAudioName("bgm_story_v1_battleground_2", "bgm_story_v1_battleground_2")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_17 + arg_4_0 then
				...
				local var_4_20 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(117061001).content)

				arg_1_1.text_.text = var_4_20

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_22 = 27 <= 0 and var_4_18 or var_4_18 * (utf8.len(var_4_20) / 27)

				if (27 <= 0 and var_4_18 or var_4_18 * (utf8.len(var_4_20) / 27)) > 0 and var_4_18 < var_4_22 then
	...
	Play117061002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				if arg_9_1.var_.effecthuo then
					Object.Destroy(arg_9_1.var_.effecthuo)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(117061002).content)
	...
	Play117061003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				local var_16_5 = arg_13_1.actors_["1033"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_16_5 then
					arg_13_1.var_.alphaOldValue1033 = var_16_5.alpha
					arg_13_1.var_.characterEffect1033 = var_16_5
				end

				arg_13_1.var_.alphaOldValue1033 = 0
			end

			local var_16_6 = 0.333333333333333

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_6 then
				if arg_13_1.var_.characterEffect1033 then
					arg_13_1.var_.characterEffect1033.alpha = Mathf.Lerp(arg_13_1.var_.alphaOldValue1033, 1, (arg_13_1.time_ - 0) / var_16_6)
				end
			end

			if arg_13_1.time_ >= 0 + var_16_6 and arg_13_1.time_ < 0 + var_16_6 + arg_16_0 and arg_13_1.var_.characterEffect1033 then
				arg_13_1.var_.characterEffect1033.alpha = 1
			end

			local var_16_7 = arg_13_1.actors_["1033"]

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 and not isNil(var_16_7) and arg_13_1.var_.actorSpriteComps1033 == nil then
			...
			if arg_13_1.time_ >= 0 + var_16_8 and arg_13_1.time_ < 0 + var_16_8 + arg_16_0 and not isNil(var_16_7) and arg_13_1.var_.actorSpriteComps1033 then
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_10 + arg_16_0 then
				...
				local var_16_12 = arg_13_1:GetWordFromCfg(117061003)
				...
				local var_16_15 = 17 <= 0 and var_16_11 or var_16_11 * (utf8.len(var_16_13) / 17)

				if (17 <= 0 and var_16_11 or var_16_11 * (utf8.len(var_16_13) / 17)) > 0 and var_16_11 < var_16_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061003", "story_v_out_117061.awb") ~= 0 then
					local var_16_16 = manager.audio:GetVoiceLength("story_v_out_117061", "117061003", "story_v_out_117061.awb") / 1000
					...
					if var_16_12.prefab_name ~= "" and arg_13_1.actors_[var_16_12.prefab_name] ~= nil then
						local var_16_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_12.prefab_name].transform, "story_v_out_117061", "117061003", "story_v_out_117061.awb")

						arg_13_1:RecordAudio("117061003", var_16_17)
						arg_13_1:RecordAudio("117061003", var_16_17)
					else
	...
	Play117061004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				local var_20_0 = arg_17_1.actors_["1033"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_20_0 then
					arg_17_1.var_.alphaOldValue1033 = var_20_0.alpha
					arg_17_1.var_.characterEffect1033 = var_20_0
				end

				arg_17_1.var_.alphaOldValue1033 = 1
			end

			local var_20_1 = 0.333333333333333

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_1 then
				if arg_17_1.var_.characterEffect1033 then
					arg_17_1.var_.characterEffect1033.alpha = Mathf.Lerp(arg_17_1.var_.alphaOldValue1033, 0, (arg_17_1.time_ - 0) / var_20_1)
				end
			end

			if arg_17_1.time_ >= 0 + var_20_1 and arg_17_1.time_ < 0 + var_20_1 + arg_20_0 and arg_17_1.var_.characterEffect1033 then
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(117061004).content)

				arg_17_1.text_.text = var_20_4

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_6 = 21 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 21)

				if (21 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 21)) > 0 and var_20_3 < var_20_6 then
	...
	Play117061005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if arg_21_1.actors_["1132"] == nil then
				local var_24_0 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1132")
				...
				if not isNil(var_24_0) then
					...
					arg_21_1.actors_["1132"] = var_24_1
			...
			local var_24_2 = arg_21_1.actors_["1132"].transform

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos1132 = var_24_2.localPosition
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_4 then
				var_24_2.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1132, Vector3.New(-390, -413, -185), (arg_21_1.time_ - 0) / var_24_4)
			end

			if arg_21_1.time_ >= 0 + var_24_4 and arg_21_1.time_ < 0 + var_24_4 + arg_24_0 then
				var_24_2.localPosition = Vector3.New(-390, -413, -185)
			end

			local var_24_5 = arg_21_1.actors_["1033"].transform

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos1033 = var_24_5.localPosition
				...
				for iter_24_3 = 0, var_24_5.childCount - 1 do
					...
					if var_24_6.name == "split_6" or not string.find(var_24_6.name, "split") then
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_7 then
				var_24_5.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1033, Vector3.New(390, -420, 0), (arg_21_1.time_ - 0) / var_24_7)
			end

			if arg_21_1.time_ >= 0 + var_24_7 and arg_21_1.time_ < 0 + var_24_7 + arg_24_0 then
				var_24_5.localPosition = Vector3.New(390, -420, 0)
			end

			local var_24_8 = arg_21_1.actors_["1132"]

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(var_24_8) and arg_21_1.var_.actorSpriteComps1132 == nil then
				arg_21_1.var_.actorSpriteComps1132 = var_24_8:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_9 and not isNil(var_24_8) then
				if arg_21_1.var_.actorSpriteComps1132 then
					for iter_24_4, iter_24_5 in pairs(arg_21_1.var_.actorSpriteComps1132:ToTable()) do
						if iter_24_5 then
							if arg_21_1.isInRecall_ then
								iter_24_5.color = Color.New(Mathf.Lerp(iter_24_5.color.r, arg_21_1.hightColor1.r, (arg_21_1.time_ - 0) / var_24_9), Mathf.Lerp(iter_24_5.color.g, arg_21_1.hightColor1.g, (arg_21_1.time_ - 0) / var_24_9), (Mathf.Lerp(iter_24_5.color.b, arg_21_1.hightColor1.b, (arg_21_1.time_ - 0) / var_24_9)))
							else
								local var_24_10 = Mathf.Lerp(iter_24_5.color.r, 1, (arg_21_1.time_ - 0) / var_24_9)
			...
			if arg_21_1.time_ >= 0 + var_24_9 and arg_21_1.time_ < 0 + var_24_9 + arg_24_0 and not isNil(var_24_8) and arg_21_1.var_.actorSpriteComps1132 then
			...
			local var_24_11 = arg_21_1.actors_["1033"]

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(var_24_11) and arg_21_1.var_.actorSpriteComps1033 == nil then
				arg_21_1.var_.actorSpriteComps1033 = var_24_11:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_12 and not isNil(var_24_11) then
				if arg_21_1.var_.actorSpriteComps1033 then
					for iter_24_8, iter_24_9 in pairs(arg_21_1.var_.actorSpriteComps1033:ToTable()) do
						if iter_24_9 then
							if arg_21_1.isInRecall_ then
								iter_24_9.color = Color.New(Mathf.Lerp(iter_24_9.color.r, arg_21_1.hightColor2.r, (arg_21_1.time_ - 0) / var_24_12), Mathf.Lerp(iter_24_9.color.g, arg_21_1.hightColor2.g, (arg_21_1.time_ - 0) / var_24_12), (Mathf.Lerp(iter_24_9.color.b, arg_21_1.hightColor2.b, (arg_21_1.time_ - 0) / var_24_12)))
							else
								local var_24_13 = Mathf.Lerp(iter_24_9.color.r, 0.5, (arg_21_1.time_ - 0) / var_24_12)
			...
			if arg_21_1.time_ >= 0 + var_24_12 and arg_21_1.time_ < 0 + var_24_12 + arg_24_0 and not isNil(var_24_11) and arg_21_1.var_.actorSpriteComps1033 then
				for iter_24_10, iter_24_11 in pairs(arg_21_1.var_.actorSpriteComps1033:ToTable()) do
					if iter_24_11 then
						iter_24_11.color = arg_21_1.isInRecall_ and (arg_21_1.hightColor2 or Color.New(0.46, 0.43, 0.35)) or Color.New(0.5, 0.5, 0.5)
					end
				end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				local var_24_16 = arg_21_1.actors_["1033"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_24_16 then
					arg_21_1.var_.alphaOldValue1033 = var_24_16.alpha
					arg_21_1.var_.characterEffect1033 = var_24_16
				end

				arg_21_1.var_.alphaOldValue1033 = 0
			end

			local var_24_17 = 0.333333333333333

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_17 then
				if arg_21_1.var_.characterEffect1033 then
					arg_21_1.var_.characterEffect1033.alpha = Mathf.Lerp(arg_21_1.var_.alphaOldValue1033, 1, (arg_21_1.time_ - 0) / var_24_17)
				end
			end

			if arg_21_1.time_ >= 0 + var_24_17 and arg_21_1.time_ < 0 + var_24_17 + arg_24_0 and arg_21_1.var_.characterEffect1033 then
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_18 + arg_24_0 then
				...
				local var_24_20 = arg_21_1:GetWordFromCfg(117061005)
				...
				local var_24_23 = 8 <= 0 and var_24_19 or var_24_19 * (utf8.len(var_24_21) / 8)

				if (8 <= 0 and var_24_19 or var_24_19 * (utf8.len(var_24_21) / 8)) > 0 and var_24_19 < var_24_23 then
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061005", "story_v_out_117061.awb") ~= 0 then
					local var_24_24 = manager.audio:GetVoiceLength("story_v_out_117061", "117061005", "story_v_out_117061.awb") / 1000
					...
					if var_24_20.prefab_name ~= "" and arg_21_1.actors_[var_24_20.prefab_name] ~= nil then
						local var_24_25 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_20.prefab_name].transform, "story_v_out_117061", "117061005", "story_v_out_117061.awb")

						arg_21_1:RecordAudio("117061005", var_24_25)
						arg_21_1:RecordAudio("117061005", var_24_25)
					else
	...
	Play117061006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(arg_25_1.actors_["1132"]) and arg_25_1.var_.actorSpriteComps1132 == nil then
				arg_25_1.var_.actorSpriteComps1132 = arg_25_1.actors_["1132"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_28_0 = 0.2

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_0 and not isNil(arg_25_1.actors_["1132"]) then
			...
			if arg_25_1.time_ >= 0 + var_28_0 and arg_25_1.time_ < 0 + var_28_0 + arg_28_0 and not isNil(arg_25_1.actors_["1132"]) and arg_25_1.var_.actorSpriteComps1132 then
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_5 + arg_28_0 then
				...
				local var_28_7 = arg_25_1:GetWordFromCfg(117061006)
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061006", "story_v_out_117061.awb") ~= 0 then
					local var_28_11 = manager.audio:GetVoiceLength("story_v_out_117061", "117061006", "story_v_out_117061.awb") / 1000
					...
					if var_28_7.prefab_name ~= "" and arg_25_1.actors_[var_28_7.prefab_name] ~= nil then
						local var_28_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_7.prefab_name].transform, "story_v_out_117061", "117061006", "story_v_out_117061.awb")

						arg_25_1:RecordAudio("117061006", var_28_12)
						arg_25_1:RecordAudio("117061006", var_28_12)
					else
	...
	Play117061007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_5 + arg_32_0 then
				...
				local var_32_7 = arg_29_1:GetWordFromCfg(117061007)
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061007", "story_v_out_117061.awb") ~= 0 then
					local var_32_11 = manager.audio:GetVoiceLength("story_v_out_117061", "117061007", "story_v_out_117061.awb") / 1000
					...
					if var_32_7.prefab_name ~= "" and arg_29_1.actors_[var_32_7.prefab_name] ~= nil then
						local var_32_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_7.prefab_name].transform, "story_v_out_117061", "117061007", "story_v_out_117061.awb")

						arg_29_1:RecordAudio("117061007", var_32_12)
						arg_29_1:RecordAudio("117061007", var_32_12)
					else
	...
	Play117061008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 and not isNil(arg_33_1.actors_["1132"]) and arg_33_1.var_.actorSpriteComps1132 == nil then
				arg_33_1.var_.actorSpriteComps1132 = arg_33_1.actors_["1132"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_36_0 = 0.2

			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_0 and not isNil(arg_33_1.actors_["1132"]) then
			...
			if arg_33_1.time_ >= 0 + var_36_0 and arg_33_1.time_ < 0 + var_36_0 + arg_36_0 and not isNil(arg_33_1.actors_["1132"]) and arg_33_1.var_.actorSpriteComps1132 then
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_5 + arg_36_0 then
				...
				local var_36_7 = arg_33_1:GetWordFromCfg(117061008)
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061008", "story_v_out_117061.awb") ~= 0 then
					local var_36_11 = manager.audio:GetVoiceLength("story_v_out_117061", "117061008", "story_v_out_117061.awb") / 1000
					...
					if var_36_7.prefab_name ~= "" and arg_33_1.actors_[var_36_7.prefab_name] ~= nil then
						local var_36_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_7.prefab_name].transform, "story_v_out_117061", "117061008", "story_v_out_117061.awb")

						arg_33_1:RecordAudio("117061008", var_36_12)
						arg_33_1:RecordAudio("117061008", var_36_12)
					else
	...
	Play117061009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_2 + arg_40_0 then
				...
				local var_40_4 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(117061009).content)

				arg_37_1.text_.text = var_40_4

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_6 = 58 <= 0 and var_40_3 or var_40_3 * (utf8.len(var_40_4) / 58)

				if (58 <= 0 and var_40_3 or var_40_3 * (utf8.len(var_40_4) / 58)) > 0 and var_40_3 < var_40_6 then
	...
	Play117061010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_2 + arg_44_0 then
				...
				local var_44_4 = arg_41_1:GetWordFromCfg(117061010)
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061010", "story_v_out_117061.awb") ~= 0 then
					local var_44_8 = manager.audio:GetVoiceLength("story_v_out_117061", "117061010", "story_v_out_117061.awb") / 1000
					...
					if var_44_4.prefab_name ~= "" and arg_41_1.actors_[var_44_4.prefab_name] ~= nil then
						local var_44_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_4.prefab_name].transform, "story_v_out_117061", "117061010", "story_v_out_117061.awb")

						arg_41_1:RecordAudio("117061010", var_44_9)
						arg_41_1:RecordAudio("117061010", var_44_9)
					else
	...
	Play117061011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_5 + arg_48_0 then
				...
				local var_48_7 = arg_45_1:GetWordFromCfg(117061011)
				...
				local var_48_10 = 40 <= 0 and var_48_6 or var_48_6 * (utf8.len(var_48_8) / 40)

				if (40 <= 0 and var_48_6 or var_48_6 * (utf8.len(var_48_8) / 40)) > 0 and var_48_6 < var_48_10 then
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061011", "story_v_out_117061.awb") ~= 0 then
					local var_48_11 = manager.audio:GetVoiceLength("story_v_out_117061", "117061011", "story_v_out_117061.awb") / 1000
					...
					if var_48_7.prefab_name ~= "" and arg_45_1.actors_[var_48_7.prefab_name] ~= nil then
						local var_48_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_7.prefab_name].transform, "story_v_out_117061", "117061011", "story_v_out_117061.awb")

						arg_45_1:RecordAudio("117061011", var_48_12)
						arg_45_1:RecordAudio("117061011", var_48_12)
					else
	...
	Play117061012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				local var_52_2 = arg_49_1.actors_["1033"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_52_2 then
					arg_49_1.var_.alphaOldValue1033 = var_52_2.alpha
					arg_49_1.var_.characterEffect1033 = var_52_2
				end
			...
			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_3 then
				if arg_49_1.var_.characterEffect1033 then
					arg_49_1.var_.characterEffect1033.alpha = Mathf.Lerp(arg_49_1.var_.alphaOldValue1033, 0, (arg_49_1.time_ - 0) / var_52_3)
				end
			end

			if arg_49_1.time_ >= 0 + var_52_3 and arg_49_1.time_ < 0 + var_52_3 + arg_52_0 and arg_49_1.var_.characterEffect1033 then
			...
			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_5 then
				local var_52_6, var_52_7 = math.modf((arg_49_1.time_ - 0) / 0.066)

				var_52_4.localPosition = Vector3.New(var_52_7 * 0.13, var_52_7 * 0.13, var_52_7 * 0.13) + arg_49_1.var_.shakeOldPos
			end
			...
			if arg_49_1.time_ >= var_52_8 + 1 and arg_49_1.time_ < var_52_8 + 1 + arg_52_0 then
				arg_49_1.allBtn_.enabled = true
			end

			if 1 < arg_49_1.time_ and arg_49_1.time_ <= 1 + arg_52_0 then
				arg_49_1:AudioAction("play", "effect", "se_story_17", "se_story_17_fireblast", "")
			end
			...
			local var_52_10 = 1
			local var_52_11 = 0.725

			if 1 < arg_49_1.time_ and arg_49_1.time_ <= var_52_10 + arg_52_0 then
				...
				local var_52_12 = LeanTween.value(arg_49_1.dialog_, 0, 1, 0.3)

				var_52_12:setOnUpdate(LuaHelper.FloatAction(function(arg_53_0)
					arg_49_1.dialogCg_.alpha = arg_53_0
				end))
				var_52_12:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_49_1.dialog_)
					var_52_12:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_52_13 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(117061012).content)

				arg_49_1.text_.text = var_52_13

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_15 = 29 <= 0 and var_52_11 or var_52_11 * (utf8.len(var_52_13) / 29)

				if (29 <= 0 and var_52_11 or var_52_11 * (utf8.len(var_52_13) / 29)) > 0 and var_52_11 < var_52_15 then
					arg_49_1.talkMaxDuration = var_52_15
					var_52_10 = var_52_10 + 0.3
			...
			local var_52_16 = var_52_10 + 0.3
			local var_52_17 = math.max(var_52_11, arg_49_1.talkMaxDuration)

			if var_52_10 + 0.3 <= arg_49_1.time_ and arg_49_1.time_ < var_52_16 + var_52_17 then
				arg_49_1.typewritter.percent = (arg_49_1.time_ - var_52_16) / var_52_17
