return {
	Play123091001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.bgs_.K03f == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.paintGo_)

				var_4_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "K03f")
				var_4_0.name = "K03f"
				var_4_0.transform.parent = arg_1_1.stage_.transform
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.bgs_.K03f = var_4_0
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_1 = arg_1_1.bgs_.K03f

				arg_1_1.bgs_.K03f.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 1.999999999999 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				local var_4_17 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(123091001).content)
	...
	Play123091002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(123091002).content)
	...
	Play123091003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:GetWordFromCfg(123091003)
				...
				if manager.audio:GetVoiceLength("story_v_out_123091", "123091003", "story_v_out_123091.awb") ~= 0 then
					local var_16_14 = manager.audio:GetVoiceLength("story_v_out_123091", "123091003", "story_v_out_123091.awb") / 1000
					...
					if var_16_10.prefab_name ~= "" and arg_13_1.actors_[var_16_10.prefab_name] ~= nil then
						local var_16_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_10.prefab_name].transform, "story_v_out_123091", "123091003", "story_v_out_123091.awb")

						arg_13_1:RecordAudio("123091003", var_16_15)
						arg_13_1:RecordAudio("123091003", var_16_15)
					else
	...
	Play123091004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(123091004).content)
	...
	Play123091005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_3 + arg_24_0 then
				...
				local var_24_5 = arg_21_1:GetWordFromCfg(123091005)
				...
				if manager.audio:GetVoiceLength("story_v_out_123091", "123091005", "story_v_out_123091.awb") ~= 0 then
					local var_24_9 = manager.audio:GetVoiceLength("story_v_out_123091", "123091005", "story_v_out_123091.awb") / 1000
					...
					if var_24_5.prefab_name ~= "" and arg_21_1.actors_[var_24_5.prefab_name] ~= nil then
						local var_24_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_5.prefab_name].transform, "story_v_out_123091", "123091005", "story_v_out_123091.awb")

						arg_21_1:RecordAudio("123091005", var_24_10)
						arg_21_1:RecordAudio("123091005", var_24_10)
					else
	...
	Play123091006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_4 + arg_28_0 then
				...
				arg_25_1.leftNameTxt_.text = arg_25_1:FormatText(StoryNameCfg[494].name)
				...
				local var_28_6 = arg_25_1:GetWordFromCfg(123091006)
				...
				if manager.audio:GetVoiceLength("story_v_out_123091", "123091006", "story_v_out_123091.awb") ~= 0 then
					local var_28_10 = manager.audio:GetVoiceLength("story_v_out_123091", "123091006", "story_v_out_123091.awb") / 1000
					...
					if var_28_6.prefab_name ~= "" and arg_25_1.actors_[var_28_6.prefab_name] ~= nil then
						local var_28_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_6.prefab_name].transform, "story_v_out_123091", "123091006", "story_v_out_123091.awb")

						arg_25_1:RecordAudio("123091006", var_28_11)
						arg_25_1:RecordAudio("123091006", var_28_11)
					else
	...
	Play123091007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				arg_29_1:ShowWeapon(arg_29_1.var_["1050ui_story" .. "Animator"].transform, true)
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1:PlayTimeline("1050ui_story", "StoryTimeline/CharAction/story1050/story1050action/1050action6_1")
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_4 + arg_32_0 then
				...
				local var_32_6 = arg_29_1:GetWordFromCfg(123091007)
				...
				if manager.audio:GetVoiceLength("story_v_out_123091", "123091007", "story_v_out_123091.awb") ~= 0 then
					local var_32_10 = manager.audio:GetVoiceLength("story_v_out_123091", "123091007", "story_v_out_123091.awb") / 1000
					...
					if var_32_6.prefab_name ~= "" and arg_29_1.actors_[var_32_6.prefab_name] ~= nil then
						local var_32_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_6.prefab_name].transform, "story_v_out_123091", "123091007", "story_v_out_123091.awb")

						arg_29_1:RecordAudio("123091007", var_32_11)
						arg_29_1:RecordAudio("123091007", var_32_11)
					else
	...
	Play123091008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_1 + arg_36_0 then
				...
				local var_36_3 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(123091008).content)
	...
	Play123091009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_2 + arg_40_0 then
				...
				local var_40_4 = arg_37_1:GetWordFromCfg(123091009)
				...
				if manager.audio:GetVoiceLength("story_v_out_123091", "123091009", "story_v_out_123091.awb") ~= 0 then
					local var_40_8 = manager.audio:GetVoiceLength("story_v_out_123091", "123091009", "story_v_out_123091.awb") / 1000
					...
					if var_40_4.prefab_name ~= "" and arg_37_1.actors_[var_40_4.prefab_name] ~= nil then
						local var_40_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_4.prefab_name].transform, "story_v_out_123091", "123091009", "story_v_out_123091.awb")

						arg_37_1:RecordAudio("123091009", var_40_9)
						arg_37_1:RecordAudio("123091009", var_40_9)
					else
