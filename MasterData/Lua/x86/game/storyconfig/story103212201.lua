	...
	Play321221029 = function(arg_119_0, arg_119_1)
		...
		function arg_119_1.onSingleLineUpdate_(arg_122_0)
			...
			if 0.5 < arg_119_1.time_ and arg_119_1.time_ <= 0.5 + arg_122_0 then
				...
				local var_122_11 = var_122_8.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_122_2, iter_122_3 in ipairs((var_122_11:ToTable())) do
					iter_122_3.transform.localScale = Vector3.New(iter_122_3.transform.localScale.x / var_122_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_122_11 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_122_3.transform.localScale.y / var_122_10, iter_122_3.transform.localScale.z)
				end
			end
			...
			if 0.5 <= arg_119_1.time_ and arg_119_1.time_ < 0.5 + var_122_14 then
				local var_122_15, var_122_16 = math.modf((arg_119_1.time_ - 0.5) / 0.066)

				var_122_13.localPosition = Vector3.New(var_122_16 * 0.13, var_122_16 * 0.13, var_122_16 * 0.13) + arg_119_1.var_.shakeOldPos
			end

			if arg_119_1.time_ >= 0.5 + var_122_14 and arg_119_1.time_ < 0.5 + var_122_14 + arg_122_0 then
				var_122_13.localPosition = arg_119_1.var_.shakeOldPos
			end

			local var_122_17 = 0

			if 0 < arg_119_1.time_ and arg_119_1.time_ <= var_122_17 + arg_122_0 then
				arg_119_1.allBtn_.enabled = false
			end

			if arg_119_1.time_ >= var_122_17 + 0.5 and arg_119_1.time_ < var_122_17 + 0.5 + arg_122_0 then
			...
			if 0.5 < arg_119_1.time_ and arg_119_1.time_ <= 0.5 + arg_122_0 then
				local var_122_19 = arg_119_1.var_.effect909

				if not arg_119_1.var_.effect909 then
					var_122_19 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_qiliu_out"), manager.ui.mainCamera.transform)
					var_122_19.name = "909"
					arg_119_1.var_.effect909 = var_122_19
				else
			...
			local var_122_25 = 1.86666666666667
			local var_122_26 = 1.625

			if 1.86666666666667 < arg_119_1.time_ and arg_119_1.time_ <= var_122_25 + arg_122_0 then
				...
				local var_122_28 = arg_119_1:FormatText(arg_119_1:GetWordFromCfg(321221029).content)

				arg_119_1.text_.text = var_122_28

				LuaForUtil.ClearLinePrefixSymbol(arg_119_1.text_)

				local var_122_30 = 65 <= 0 and var_122_26 or var_122_26 * (utf8.len(var_122_28) / 65)

				if (65 <= 0 and var_122_26 or var_122_26 * (utf8.len(var_122_28) / 65)) > 0 and var_122_26 < var_122_30 then
	...
	Play321221040 = function(arg_165_0, arg_165_1)
		...
		function arg_165_1.onSingleLineUpdate_(arg_168_0)
			...
			if 0 < arg_165_1.time_ and arg_165_1.time_ <= 0 + arg_168_0 then
				...
				local var_168_4 = var_168_1.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_168_0, iter_168_1 in ipairs((var_168_4:ToTable())) do
					iter_168_1.transform.localScale = Vector3.New(iter_168_1.transform.localScale.x / var_168_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_168_4 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_168_1.transform.localScale.y / var_168_3, iter_168_1.transform.localScale.z)
				end
			end

			if 0 < arg_165_1.time_ and arg_165_1.time_ <= 0 + arg_168_0 then
				local var_168_6 = arg_165_1.var_.effect448

				if not arg_165_1.var_.effect448 then
					var_168_6 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"), manager.ui.mainCamera.transform)
					var_168_6.name = "448"
					arg_165_1.var_.effect448 = var_168_6
				else
					var_168_6.transform:SetParent(var_168_9000)
				end

				var_168_6.transform.localPosition = Vector3.New(0, 0, 0)
				var_168_6.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_168_8 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_168_9 = var_168_6.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_168_2, iter_168_3 in ipairs((var_168_9:ToTable())) do
					iter_168_3.transform.localScale = Vector3.New(iter_168_3.transform.localScale.x / var_168_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_168_9 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_168_3.transform.localScale.y / var_168_8, iter_168_3.transform.localScale.z)
				end
			end
			...
			if arg_165_1.time_ >= var_168_11 + 2 and arg_165_1.time_ < var_168_11 + 2 + arg_168_0 then
			...
			local var_168_12 = 1.73333333333333
			local var_168_13 = 0.6

			if 1.73333333333333 < arg_165_1.time_ and arg_165_1.time_ <= var_168_12 + arg_168_0 then
				...
				local var_168_15 = arg_165_1:GetWordFromCfg(321221040)
				...
				local var_168_18 = 24 <= 0 and var_168_13 or var_168_13 * (utf8.len(var_168_16) / 24)

				if (24 <= 0 and var_168_13 or var_168_13 * (utf8.len(var_168_16) / 24)) > 0 and var_168_13 < var_168_18 then
				...
				if manager.audio:GetVoiceLength("story_v_out_321221", "321221040", "story_v_out_321221.awb") ~= 0 then
					local var_168_19 = manager.audio:GetVoiceLength("story_v_out_321221", "321221040", "story_v_out_321221.awb") / 1000
					...
					if var_168_15.prefab_name ~= "" and arg_165_1.actors_[var_168_15.prefab_name] ~= nil then
						local var_168_20 = LuaForUtil.PlayVoiceWithCriLipsync(arg_165_1.actors_[var_168_15.prefab_name].transform, "story_v_out_321221", "321221040", "story_v_out_321221.awb")

						arg_165_1:RecordAudio("321221040", var_168_20)
						arg_165_1:RecordAudio("321221040", var_168_20)
					else
