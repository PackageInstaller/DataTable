	...
	Play416182002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_3 = var_12_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_12_0, iter_12_1 in ipairs((var_12_3:ToTable())) do
					iter_12_1.transform.localScale = Vector3.New(iter_12_1.transform.localScale.x / var_12_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_12_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_12_1.transform.localScale.y / var_12_2, iter_12_1.transform.localScale.z)
				end
			end
			...
			local var_12_8 = 0.866666666666667
			local var_12_9 = 1.075

			if 0.866666666666667 < arg_9_1.time_ and arg_9_1.time_ <= var_12_8 + arg_12_0 then
				...
				local var_12_11 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(416182002).content)

				arg_9_1.text_.text = var_12_11

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_13 = 43 <= 0 and var_12_9 or var_12_9 * (utf8.len(var_12_11) / 43)

				if (43 <= 0 and var_12_9 or var_12_9 * (utf8.len(var_12_11) / 43)) > 0 and var_12_9 < var_12_13 then
			...
			local var_12_14 = var_12_8 + 0.3
			local var_12_15 = math.max(var_12_9, arg_9_1.talkMaxDuration)

			if var_12_8 + 0.3 <= arg_9_1.time_ and arg_9_1.time_ < var_12_14 + var_12_15 then
				arg_9_1.typewritter.percent = (arg_9_1.time_ - var_12_14) / var_12_15
