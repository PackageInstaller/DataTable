	...
	Play321232018 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 1.7 < arg_77_1.time_ and arg_77_1.time_ <= 1.7 + arg_80_0 then
				...
				local var_80_8 = var_80_5.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_80_2, iter_80_3 in ipairs((var_80_8:ToTable())) do
					iter_80_3.transform.localScale = Vector3.New(iter_80_3.transform.localScale.x / var_80_7 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_80_8 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_80_3.transform.localScale.y / var_80_7, iter_80_3.transform.localScale.z)
				end
			end
			...
			if var_80_11 <= arg_77_1.time_ and arg_77_1.time_ < var_80_11 + var_80_12 then
				...
				var_80_13.a = Mathf.Lerp(0, 1, (arg_77_1.time_ - var_80_11) / var_80_12)
			...
			if 1 < arg_77_1.time_ and arg_77_1.time_ <= var_80_15 + arg_80_0 then
				arg_77_1.mask_.enabled = true
				arg_77_1.mask_.raycastTarget = true
			...
			if var_80_15 <= arg_77_1.time_ and arg_77_1.time_ < var_80_15 + var_80_16 then
				...
				var_80_17.a = Mathf.Lerp(1, 0, (arg_77_1.time_ - var_80_15) / var_80_16)
			...
			local var_80_19 = 2.83333333333333
			local var_80_20 = 0.6

			if 2.83333333333333 < arg_77_1.time_ and arg_77_1.time_ <= var_80_19 + arg_80_0 then
				...
				local var_80_22 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(321232018).content)

				arg_77_1.text_.text = var_80_22

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_24 = 24 <= 0 and var_80_20 or var_80_20 * (utf8.len(var_80_22) / 24)

				if (24 <= 0 and var_80_20 or var_80_20 * (utf8.len(var_80_22) / 24)) > 0 and var_80_20 < var_80_24 then
	...
	Play321232020 = function(arg_87_0, arg_87_1)
		...
		function arg_87_1.onSingleLineUpdate_(arg_90_0)
			...
			if 2.01666666666667 < arg_87_1.time_ and arg_87_1.time_ <= 2.01666666666667 + arg_90_0 then
				...
				local var_90_21 = var_90_18.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_90_2, iter_90_3 in ipairs((var_90_21:ToTable())) do
					iter_90_3.transform.localScale = Vector3.New(iter_90_3.transform.localScale.x / var_90_20 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_90_21 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_90_3.transform.localScale.y / var_90_20, iter_90_3.transform.localScale.z)
				end
			end
			...
			if 4.4 < arg_87_1.time_ and arg_87_1.time_ <= var_90_23 + arg_90_0 then
				...
				local var_90_26 = arg_87_1:FormatText(arg_87_1:GetWordFromCfg(321232020).content)

				arg_87_1.text_.text = var_90_26

				LuaForUtil.ClearLinePrefixSymbol(arg_87_1.text_)

				local var_90_28 = 60 <= 0 and var_90_24 or var_90_24 * (utf8.len(var_90_26) / 60)

				if (60 <= 0 and var_90_24 or var_90_24 * (utf8.len(var_90_26) / 60)) > 0 and var_90_24 < var_90_28 then
