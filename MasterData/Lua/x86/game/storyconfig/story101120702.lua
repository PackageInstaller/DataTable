return {
	Play112072001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_12 = arg_1_1.actors_["1148ui_story"]

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.characterEffect1148ui_story == nil then
				arg_1_1.var_.characterEffect1148ui_story = var_4_12:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_13 = 0.2

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_13 and not isNil(var_4_12) then
				if arg_1_1.var_.characterEffect1148ui_story and not isNil(var_4_12) then
					arg_1_1.var_.characterEffect1148ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 1.8 + var_4_13 and arg_1_1.time_ < 1.8 + var_4_13 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.characterEffect1148ui_story then
				arg_1_1.var_.characterEffect1148ui_story.fillFlat = false
			end

			local var_4_15 = arg_1_1.actors_["1148ui_story"].transform

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1.var_.moveOldPos1148ui_story = var_4_15.localPosition
			end

			local var_4_16 = 0.001

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_16 then
				var_4_15.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1148ui_story, Vector3.New(-0.7, -0.8, -6.2), (arg_1_1.time_ - 1.8) / var_4_16)
			...
			if arg_1_1.time_ >= 1.8 + var_4_16 and arg_1_1.time_ < 1.8 + var_4_16 + arg_4_0 then
				var_4_15.localPosition = Vector3.New(-0.7, -0.8, -6.2)
				var_4_15.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_15.position).x, (manager.ui.mainCamera.transform.position - var_4_15.position).y, (manager.ui.mainCamera.transform.position - var_4_15.position).z)
				var_4_15.localEulerAngles.z = 0
				var_4_15.localEulerAngles.x = 0
				var_4_15.localEulerAngles = var_4_15.localEulerAngles
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				...
				local var_4_26 = arg_1_1:GetWordFromCfg(112072001)
				...
				if manager.audio:GetVoiceLength("story_v_out_112072", "112072001", "story_v_out_112072.awb") ~= 0 then
					local var_4_30 = manager.audio:GetVoiceLength("story_v_out_112072", "112072001", "story_v_out_112072.awb") / 1000
					...
					if var_4_26.prefab_name ~= "" and arg_1_1.actors_[var_4_26.prefab_name] ~= nil then
						local var_4_31 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_26.prefab_name].transform, "story_v_out_112072", "112072001", "story_v_out_112072.awb")

						arg_1_1:RecordAudio("112072001", var_4_31)
						arg_1_1:RecordAudio("112072001", var_4_31)
					else
	...
	Play112072002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(112072002).content)
	...
	Play112072003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_3 + arg_16_0 then
				...
				local var_16_5 = arg_13_1:GetWordFromCfg(112072003)
				...
				local var_16_8 = 9 <= 0 and var_16_4 or var_16_4 * (utf8.len(var_16_6) / 9)

				if (9 <= 0 and var_16_4 or var_16_4 * (utf8.len(var_16_6) / 9)) > 0 and var_16_4 < var_16_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_112072", "112072003", "story_v_out_112072.awb") ~= 0 then
					local var_16_9 = manager.audio:GetVoiceLength("story_v_out_112072", "112072003", "story_v_out_112072.awb") / 1000
					...
					if var_16_5.prefab_name ~= "" and arg_13_1.actors_[var_16_5.prefab_name] ~= nil then
						local var_16_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_5.prefab_name].transform, "story_v_out_112072", "112072003", "story_v_out_112072.awb")

						arg_13_1:RecordAudio("112072003", var_16_10)
						arg_13_1:RecordAudio("112072003", var_16_10)
					else
	...
	Play112072004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				arg_17_1:PlayTimeline("1084ui_story", "StoryTimeline/CharAction/story1084/story1084action/1084action13_1")
			end
			...
			local var_20_8 = arg_17_1.actors_["1148ui_story"]

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(var_20_8) and arg_17_1.var_.characterEffect1148ui_story == nil then
				arg_17_1.var_.characterEffect1148ui_story = var_20_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_9 = 0.2

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_9 and not isNil(var_20_8) then
				if arg_17_1.var_.characterEffect1148ui_story and not isNil(var_20_8) then
					arg_17_1.var_.characterEffect1148ui_story.fillFlat = true
					arg_17_1.var_.characterEffect1148ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_17_1.time_ - 0) / var_20_9)
				end
			end

			if arg_17_1.time_ >= 0 + var_20_9 and arg_17_1.time_ < 0 + var_20_9 + arg_20_0 and not isNil(var_20_8) and arg_17_1.var_.characterEffect1148ui_story then
				arg_17_1.var_.characterEffect1148ui_story.fillFlat = true
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_10 + arg_20_0 then
				...
				local var_20_12 = arg_17_1:GetWordFromCfg(112072004)
				...
				if manager.audio:GetVoiceLength("story_v_out_112072", "112072004", "story_v_out_112072.awb") ~= 0 then
					local var_20_16 = manager.audio:GetVoiceLength("story_v_out_112072", "112072004", "story_v_out_112072.awb") / 1000
					...
					if var_20_12.prefab_name ~= "" and arg_17_1.actors_[var_20_12.prefab_name] ~= nil then
						local var_20_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_12.prefab_name].transform, "story_v_out_112072", "112072004", "story_v_out_112072.awb")

						arg_17_1:RecordAudio("112072004", var_20_17)
						arg_17_1:RecordAudio("112072004", var_20_17)
					else
	...
	Play112072005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			local var_24_1 = arg_21_1.actors_["1148ui_story"].transform

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos1148ui_story = var_24_1.localPosition
			end

			local var_24_2 = 0.001

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_2 then
				var_24_1.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1148ui_story, Vector3.New(0, 100, 0), (arg_21_1.time_ - 0) / var_24_2)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_3 + arg_24_0 then
				...
				local var_24_5 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(112072005).content)

				arg_21_1.text_.text = var_24_5

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_7 = 48 <= 0 and var_24_4 or var_24_4 * (utf8.len(var_24_5) / 48)

				if (48 <= 0 and var_24_4 or var_24_4 * (utf8.len(var_24_5) / 48)) > 0 and var_24_4 < var_24_7 then
	...
	Play112072006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				...
				local var_28_1 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(112072006).content)
	...
	Play112072007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				local var_32_1 = arg_29_1:GetWordFromCfg(112072007)
				...
				if manager.audio:GetVoiceLength("story_v_out_112072", "112072007", "story_v_out_112072.awb") ~= 0 then
					local var_32_5 = manager.audio:GetVoiceLength("story_v_out_112072", "112072007", "story_v_out_112072.awb") / 1000
					...
					if var_32_1.prefab_name ~= "" and arg_29_1.actors_[var_32_1.prefab_name] ~= nil then
						local var_32_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_1.prefab_name].transform, "story_v_out_112072", "112072007", "story_v_out_112072.awb")

						arg_29_1:RecordAudio("112072007", var_32_6)
						arg_29_1:RecordAudio("112072007", var_32_6)
					else
	...
	Play112072008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(112072008).content)
	...
	Play112072009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				local var_40_1 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(112072009).content)
	...
	Play112072010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if arg_41_1.actors_["1081ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1081ui_story"))) then
				local var_44_0 = Object.Instantiate(Asset.Load("Char/" .. "1081ui_story"), arg_41_1.stage_.transform)

				var_44_0.name = "1081ui_story"
				var_44_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_41_1.actors_["1081ui_story"] = var_44_0
				...
				arg_41_1.var_["1081ui_story" .. "Animator"] = var_44_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_41_1.var_["1081ui_story" .. "Animator"].applyRootMotion = true
				arg_41_1.var_["1081ui_story" .. "LipSync"] = var_44_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_44_3 = arg_41_1.actors_["1081ui_story"].transform

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1.var_.moveOldPos1081ui_story = var_44_3.localPosition
			end

			local var_44_4 = 0.001

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_4 then
				var_44_3.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1081ui_story, Vector3.New(0, -0.92, -5.8), (arg_41_1.time_ - 0) / var_44_4)
			...
			if arg_41_1.time_ >= 0 + var_44_4 and arg_41_1.time_ < 0 + var_44_4 + arg_44_0 then
				var_44_3.localPosition = Vector3.New(0, -0.92, -5.8)
				var_44_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_44_3.position).x, (manager.ui.mainCamera.transform.position - var_44_3.position).y, (manager.ui.mainCamera.transform.position - var_44_3.position).z)
				var_44_3.localEulerAngles.z = 0
				var_44_3.localEulerAngles.x = 0
				var_44_3.localEulerAngles = var_44_3.localEulerAngles
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1:PlayTimeline("1081ui_story", "StoryTimeline/CharAction/story1081/story1081action/1081action7_1")
			end
			...
			local var_44_5 = arg_41_1.actors_["1081ui_story"]

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(var_44_5) and arg_41_1.var_.characterEffect1081ui_story == nil then
				arg_41_1.var_.characterEffect1081ui_story = var_44_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_44_6 = 0.2

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_6 and not isNil(var_44_5) then
				if arg_41_1.var_.characterEffect1081ui_story and not isNil(var_44_5) then
					arg_41_1.var_.characterEffect1081ui_story.fillFlat = false
				end
			end

			if arg_41_1.time_ >= 0 + var_44_6 and arg_41_1.time_ < 0 + var_44_6 + arg_44_0 and not isNil(var_44_5) and arg_41_1.var_.characterEffect1081ui_story then
				arg_41_1.var_.characterEffect1081ui_story.fillFlat = false
			end
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_8 + arg_44_0 then
				...
				local var_44_10 = arg_41_1:GetWordFromCfg(112072010)
				...
				if manager.audio:GetVoiceLength("story_v_out_112072", "112072010", "story_v_out_112072.awb") ~= 0 then
					local var_44_14 = manager.audio:GetVoiceLength("story_v_out_112072", "112072010", "story_v_out_112072.awb") / 1000
					...
					if var_44_10.prefab_name ~= "" and arg_41_1.actors_[var_44_10.prefab_name] ~= nil then
						local var_44_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_10.prefab_name].transform, "story_v_out_112072", "112072010", "story_v_out_112072.awb")

						arg_41_1:RecordAudio("112072010", var_44_15)
						arg_41_1:RecordAudio("112072010", var_44_15)
					else
	...
	Play112072011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_0 then
				arg_45_1.actors_["1081ui_story"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1081ui_story, Vector3.New(0, 100, 0), (arg_45_1.time_ - 0) / var_48_0)
			...
			if arg_45_1.time_ >= 0 + var_48_0 and arg_45_1.time_ < 0 + var_48_0 + arg_48_0 then
				arg_45_1.actors_["1081ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_45_1.actors_["1081ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["1081ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1081ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1081ui_story"].transform.position).z)
				arg_45_1.actors_["1081ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["1081ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["1081ui_story"].transform.localEulerAngles = arg_45_1.actors_["1081ui_story"].transform.localEulerAngles
			...
			local var_48_1 = "1039ui_story"

			if arg_45_1.actors_["1039ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1039ui_story"))) then
				local var_48_2 = Object.Instantiate(Asset.Load("Char/" .. "1039ui_story"), arg_45_1.stage_.transform)
			...
			local var_48_5 = arg_45_1.actors_["1039ui_story"].transform

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1039ui_story = var_48_5.localPosition
			end

			local var_48_6 = 0.001

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_6 then
				var_48_5.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1039ui_story, Vector3.New(-0.7, -1.01, -5.9), (arg_45_1.time_ - 0) / var_48_6)
			...
			if arg_45_1.time_ >= 0 + var_48_6 and arg_45_1.time_ < 0 + var_48_6 + arg_48_0 then
				var_48_5.localPosition = Vector3.New(-0.7, -1.01, -5.9)
				var_48_5.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_48_5.position).x, (manager.ui.mainCamera.transform.position - var_48_5.position).y, (manager.ui.mainCamera.transform.position - var_48_5.position).z)
				var_48_5.localEulerAngles.z = 0
				var_48_5.localEulerAngles.x = 0
				var_48_5.localEulerAngles = var_48_5.localEulerAngles
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1:PlayTimeline("1039ui_story", "StoryTimeline/CharAction/story1039/story1039action/1039action5_1")
			end
			...
			local var_48_7 = arg_45_1.actors_["1039ui_story"]

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(var_48_7) and arg_45_1.var_.characterEffect1039ui_story == nil then
				arg_45_1.var_.characterEffect1039ui_story = var_48_7:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_48_8 = 0.2

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_8 and not isNil(var_48_7) then
				if arg_45_1.var_.characterEffect1039ui_story and not isNil(var_48_7) then
					arg_45_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_45_1.time_ >= 0 + var_48_8 and arg_45_1.time_ < 0 + var_48_8 + arg_48_0 and not isNil(var_48_7) and arg_45_1.var_.characterEffect1039ui_story then
				arg_45_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_10 + arg_48_0 then
				...
				local var_48_12 = arg_45_1:GetWordFromCfg(112072011)
				...
				local var_48_15 = 7 <= 0 and var_48_11 or var_48_11 * (utf8.len(var_48_13) / 7)

				if (7 <= 0 and var_48_11 or var_48_11 * (utf8.len(var_48_13) / 7)) > 0 and var_48_11 < var_48_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_112072", "112072011", "story_v_out_112072.awb") ~= 0 then
					local var_48_16 = manager.audio:GetVoiceLength("story_v_out_112072", "112072011", "story_v_out_112072.awb") / 1000
					...
					if var_48_12.prefab_name ~= "" and arg_45_1.actors_[var_48_12.prefab_name] ~= nil then
						local var_48_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_12.prefab_name].transform, "story_v_out_112072", "112072011", "story_v_out_112072.awb")

						arg_45_1:RecordAudio("112072011", var_48_17)
						arg_45_1:RecordAudio("112072011", var_48_17)
					else
	...
	Play112072012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1.var_.moveOldPos1084ui_story = arg_49_1.actors_["1084ui_story"].transform.localPosition
			end

			local var_52_0 = 0.001

			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_0 then
				arg_49_1.actors_["1084ui_story"].transform.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos1084ui_story, Vector3.New(0.7, -0.97, -6), (arg_49_1.time_ - 0) / var_52_0)
				arg_49_1.actors_["1084ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_49_1.actors_["1084ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_49_1.actors_["1084ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_49_1.actors_["1084ui_story"].transform.position).z)
				arg_49_1.actors_["1084ui_story"].transform.localEulerAngles.z = 0
				arg_49_1.actors_["1084ui_story"].transform.localEulerAngles.x = 0
				arg_49_1.actors_["1084ui_story"].transform.localEulerAngles = arg_49_1.actors_["1084ui_story"].transform.localEulerAngles
			end

			if arg_49_1.time_ >= 0 + var_52_0 and arg_49_1.time_ < 0 + var_52_0 + arg_52_0 then
				arg_49_1.actors_["1084ui_story"].transform.localPosition = Vector3.New(0.7, -0.97, -6)
				arg_49_1.actors_["1084ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_49_1.actors_["1084ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_49_1.actors_["1084ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_49_1.actors_["1084ui_story"].transform.position).z)
				arg_49_1.actors_["1084ui_story"].transform.localEulerAngles.z = 0
				arg_49_1.actors_["1084ui_story"].transform.localEulerAngles.x = 0
				arg_49_1.actors_["1084ui_story"].transform.localEulerAngles = arg_49_1.actors_["1084ui_story"].transform.localEulerAngles
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1:PlayTimeline("1084ui_story", "StoryTimeline/CharAction/story1084/story1084action/1084action5_1")
			end
			...
			local var_52_4 = arg_49_1.actors_["1039ui_story"]

			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 and not isNil(var_52_4) and arg_49_1.var_.characterEffect1039ui_story == nil then
				arg_49_1.var_.characterEffect1039ui_story = var_52_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_52_5 = 0.2

			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_5 and not isNil(var_52_4) then
				if arg_49_1.var_.characterEffect1039ui_story and not isNil(var_52_4) then
					arg_49_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_49_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_49_1.time_ - 0) / var_52_5)
				end
			end

			if arg_49_1.time_ >= 0 + var_52_5 and arg_49_1.time_ < 0 + var_52_5 + arg_52_0 and not isNil(var_52_4) and arg_49_1.var_.characterEffect1039ui_story then
				arg_49_1.var_.characterEffect1039ui_story.fillFlat = true
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_6 + arg_52_0 then
				...
				local var_52_8 = arg_49_1:GetWordFromCfg(112072012)
				...
				if manager.audio:GetVoiceLength("story_v_out_112072", "112072012", "story_v_out_112072.awb") ~= 0 then
					local var_52_12 = manager.audio:GetVoiceLength("story_v_out_112072", "112072012", "story_v_out_112072.awb") / 1000
					...
					if var_52_8.prefab_name ~= "" and arg_49_1.actors_[var_52_8.prefab_name] ~= nil then
						local var_52_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_8.prefab_name].transform, "story_v_out_112072", "112072012", "story_v_out_112072.awb")

						arg_49_1:RecordAudio("112072012", var_52_13)
						arg_49_1:RecordAudio("112072012", var_52_13)
					else
	...
	Play112072013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1:PlayTimeline("1148ui_story", "StoryTimeline/CharAction/story1148/story1148action/1148action9_1")
			end
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 and not isNil(var_56_1) and arg_53_1.var_.characterEffect1148ui_story == nil then
			...
			if arg_53_1.time_ >= 0 + var_56_2 and arg_53_1.time_ < 0 + var_56_2 + arg_56_0 and not isNil(var_56_1) and arg_53_1.var_.characterEffect1148ui_story then
				arg_53_1.var_.characterEffect1148ui_story.fillFlat = false
			end

			local var_56_4 = arg_53_1.actors_["1148ui_story"].transform

			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1.var_.moveOldPos1148ui_story = var_56_4.localPosition
			end

			local var_56_5 = 0.001

			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_5 then
				var_56_4.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPos1148ui_story, Vector3.New(-0.7, -0.8, -6.2), (arg_53_1.time_ - 0) / var_56_5)
			...
			if arg_53_1.time_ >= 0 + var_56_5 and arg_53_1.time_ < 0 + var_56_5 + arg_56_0 then
				var_56_4.localPosition = Vector3.New(-0.7, -0.8, -6.2)
				var_56_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_56_4.position).x, (manager.ui.mainCamera.transform.position - var_56_4.position).y, (manager.ui.mainCamera.transform.position - var_56_4.position).z)
				var_56_4.localEulerAngles.z = 0
				var_56_4.localEulerAngles.x = 0
				var_56_4.localEulerAngles = var_56_4.localEulerAngles
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 and not isNil(var_56_6) and arg_53_1.var_.characterEffect1084ui_story == nil then
			...
			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_7 and not isNil(var_56_6) then
				if arg_53_1.var_.characterEffect1084ui_story and not isNil(var_56_6) then
					arg_53_1.var_.characterEffect1084ui_story.fillFlat = true
					arg_53_1.var_.characterEffect1084ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_53_1.time_ - 0) / var_56_7)
				end
			end

			if arg_53_1.time_ >= 0 + var_56_7 and arg_53_1.time_ < 0 + var_56_7 + arg_56_0 and not isNil(var_56_6) and arg_53_1.var_.characterEffect1084ui_story then
				arg_53_1.var_.characterEffect1084ui_story.fillFlat = true
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_8 + arg_56_0 then
				...
				local var_56_10 = arg_53_1:GetWordFromCfg(112072013)
				...
				if manager.audio:GetVoiceLength("story_v_out_112072", "112072013", "story_v_out_112072.awb") ~= 0 then
					local var_56_14 = manager.audio:GetVoiceLength("story_v_out_112072", "112072013", "story_v_out_112072.awb") / 1000
					...
					if var_56_10.prefab_name ~= "" and arg_53_1.actors_[var_56_10.prefab_name] ~= nil then
						local var_56_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_10.prefab_name].transform, "story_v_out_112072", "112072013", "story_v_out_112072.awb")

						arg_53_1:RecordAudio("112072013", var_56_15)
						arg_53_1:RecordAudio("112072013", var_56_15)
					else
	...
	Play112072014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1.var_.moveOldPos1148ui_story = arg_57_1.actors_["1148ui_story"].transform.localPosition
			end

			local var_60_0 = 0.001

			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_0 then
				arg_57_1.actors_["1148ui_story"].transform.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos1148ui_story, Vector3.New(0, 100, 0), (arg_57_1.time_ - 0) / var_60_0)
				arg_57_1.actors_["1148ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_57_1.actors_["1148ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_57_1.actors_["1148ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_57_1.actors_["1148ui_story"].transform.position).z)
				arg_57_1.actors_["1148ui_story"].transform.localEulerAngles.z = 0
				arg_57_1.actors_["1148ui_story"].transform.localEulerAngles.x = 0
				arg_57_1.actors_["1148ui_story"].transform.localEulerAngles = arg_57_1.actors_["1148ui_story"].transform.localEulerAngles
			end

			if arg_57_1.time_ >= 0 + var_60_0 and arg_57_1.time_ < 0 + var_60_0 + arg_60_0 then
				arg_57_1.actors_["1148ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_57_1.actors_["1148ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_57_1.actors_["1148ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_57_1.actors_["1148ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_57_1.actors_["1148ui_story"].transform.position).z)
				arg_57_1.actors_["1148ui_story"].transform.localEulerAngles.z = 0
				arg_57_1.actors_["1148ui_story"].transform.localEulerAngles.x = 0
				arg_57_1.actors_["1148ui_story"].transform.localEulerAngles = arg_57_1.actors_["1148ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_2 then
				var_60_1.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos1084ui_story, Vector3.New(0, 100, 0), (arg_57_1.time_ - 0) / var_60_2)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1:AudioAction("play", "effect", "se_story_activity_1_2_summer1", "se_story_activity_1_2_summer1_quaketideloop", "")
			end
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_4 + arg_60_0 then
				...
				local var_60_6 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(112072014).content)

				arg_57_1.text_.text = var_60_6

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_8 = 50 <= 0 and var_60_5 or var_60_5 * (utf8.len(var_60_6) / 50)

				if (50 <= 0 and var_60_5 or var_60_5 * (utf8.len(var_60_6) / 50)) > 0 and var_60_5 < var_60_8 then
	...
	Play112072015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				local var_64_0 = arg_61_1.var_.effectshuizhu1

				if not arg_61_1.var_.effectshuizhu1 then
					var_64_0 = Object.Instantiate(Asset.Load("Effect/Scene/fx_raindrop"), manager.ui.mainCamera.transform)
					var_64_0.name = "shuizhu1"
					arg_61_1.var_.effectshuizhu1 = var_64_0
				else
			...
			local var_64_2 = 2
			local var_64_3 = 1.525

			if 2 < arg_61_1.time_ and arg_61_1.time_ <= var_64_2 + arg_64_0 then
				...
				local var_64_5 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(112072015).content)

				arg_61_1.text_.text = var_64_5

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_7 = 61 <= 0 and var_64_3 or var_64_3 * (utf8.len(var_64_5) / 61)

				if (61 <= 0 and var_64_3 or var_64_3 * (utf8.len(var_64_5) / 61)) > 0 and var_64_3 < var_64_7 then
			...
			local var_64_8 = var_64_2 + 0.3
			local var_64_9 = math.max(var_64_3, arg_61_1.talkMaxDuration)

			if var_64_2 + 0.3 <= arg_61_1.time_ and arg_61_1.time_ < var_64_8 + var_64_9 then
				arg_61_1.typewritter.percent = (arg_61_1.time_ - var_64_8) / var_64_9
	...
	Play112072016 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= 0 + arg_70_0 then
				if arg_67_1.var_.effectshuizhu1 then
					Object.Destroy(arg_67_1.var_.effectshuizhu1)
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_1 + arg_70_0 then
				...
				local var_70_3 = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(112072016).content)

				arg_67_1.text_.text = var_70_3

				LuaForUtil.ClearLinePrefixSymbol(arg_67_1.text_)

				local var_70_5 = 54 <= 0 and var_70_2 or var_70_2 * (utf8.len(var_70_3) / 54)

				if (54 <= 0 and var_70_2 or var_70_2 * (utf8.len(var_70_3) / 54)) > 0 and var_70_2 < var_70_5 then
	...
	Play112072017 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_3 + arg_74_0 then
				...
				local var_74_5 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(112072017).content)

				arg_71_1.text_.text = var_74_5

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_7 = 5 <= 0 and var_74_4 or var_74_4 * (utf8.len(var_74_5) / 5)

				if (5 <= 0 and var_74_4 or var_74_4 * (utf8.len(var_74_5) / 5)) > 0 and var_74_4 < var_74_7 then
