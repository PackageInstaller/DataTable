	...
	Play910102001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1 <= arg_1_1.time_ and arg_1_1.time_ < 1 + var_4_13 then
				var_4_11.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1084, Vector3.New(0, -350, -180), (arg_1_1.time_ - 1) / var_4_13)
			end
			...
			if 1 < arg_1_1.time_ and arg_1_1.time_ <= 1 + arg_4_0 then
				local var_4_14 = arg_1_1.actors_["1084"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_14 then
					arg_1_1.var_.alphaOldValue1084 = var_4_14.alpha
					arg_1_1.var_.characterEffect1084 = var_4_14
				end
			...
			if 1 <= arg_1_1.time_ and arg_1_1.time_ < 1 + var_4_15 then
				if arg_1_1.var_.characterEffect1084 then
					arg_1_1.var_.characterEffect1084.alpha = Mathf.Lerp(arg_1_1.var_.alphaOldValue1084, 1, (arg_1_1.time_ - 1) / var_4_15)
				end
			end

			if arg_1_1.time_ >= 1 + var_4_15 and arg_1_1.time_ < 1 + var_4_15 + arg_4_0 and arg_1_1.var_.characterEffect1084 then
			...
			if 1 < arg_1_1.time_ and arg_1_1.time_ <= var_4_16 + arg_4_0 then
				...
				local var_4_19 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910102001).content)
	...
	Play910102002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_2 + arg_10_0 then
				...
				local var_10_4 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910102002).content)

				arg_7_1.text_.text = var_10_4

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_6 = 21 <= 0 and var_10_3 or var_10_3 * (utf8.len(var_10_4) / 21)

				if (21 <= 0 and var_10_3 or var_10_3 * (utf8.len(var_10_4) / 21)) > 0 and var_10_3 < var_10_6 then
	...
	Play910102003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_2 + arg_14_0 then
				...
				local var_14_4 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910102003).content)

				arg_11_1.text_.text = var_14_4

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_6 = 22 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 22)

				if (22 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 22)) > 0 and var_14_3 < var_14_6 then
