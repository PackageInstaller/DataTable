return {
	Play605302001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 605302001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.333333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 0.333333333333333 + var_4_3 then
				var_4_2.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2410002, Vector3.New(0, -150, -125), (arg_1_1.time_ - 0.333333333333333) / var_4_3)
			end

			if arg_1_1.time_ >= 0.333333333333333 + var_4_3 and arg_1_1.time_ < 0.333333333333333 + var_4_3 + arg_4_0 then
				var_4_2.localPosition = Vector3.New(0, -150, -125)
			end

			local var_4_4 = arg_1_1.actors_["2410002"]
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 0.333333333333333 + arg_4_0 and not isNil(var_4_4) then
				...
				if var_4_5 then
					arg_1_1.var_.highlightMatValue2410002 = var_4_5
				end
			end
			...
			if 0.333333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 0.333333333333333 + var_4_6 and not isNil(var_4_4) then
				if arg_1_1.var_.highlightMatValue2410002 then
					...
					arg_1_1.var_.highlightMatValue2410002.color.r = var_4_7
					arg_1_1.var_.highlightMatValue2410002.color.g = var_4_7
					arg_1_1.var_.highlightMatValue2410002.color.b = var_4_7
					arg_1_1.var_.highlightMatValue2410002.color = arg_1_1.var_.highlightMatValue2410002.color
				end
			end

			if arg_1_1.time_ >= 0.333333333333333 + var_4_6 and arg_1_1.time_ < 0.333333333333333 + var_4_6 + arg_4_0 and not isNil(var_4_4) and arg_1_1.var_.highlightMatValue2410002 then
				var_4_4.transform:SetSiblingIndex(1)

				arg_1_1.var_.highlightMatValue2410002.color.r = 1
				arg_1_1.var_.highlightMatValue2410002.color.g = 1
				arg_1_1.var_.highlightMatValue2410002.color.b = 1
				arg_1_1.var_.highlightMatValue2410002.color = arg_1_1.var_.highlightMatValue2410002.color
			end
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[243].name)
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(605302001).content)
	...
	Play605302002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 605302002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.playNext_(arg_9_0)
			if arg_9_0 == 1 then
				arg_7_0:Play605302003(arg_7_1)
			end
		end

		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			local var_10_0 = 1.525
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[243].name)
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(605302002).content)

				arg_7_1.text_.text = var_10_1

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_3 = 61 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 61)

				if (61 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 61)) > 0 and var_10_0 < var_10_3 then
	...
	Play605302003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 605302003
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				arg_11_1.leftNameTxt_.text = arg_11_1:FormatText(StoryNameCfg[243].name)
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(605302003).content)

				arg_11_1.text_.text = var_14_1

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_3 = 8 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 8)

				if (8 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 8)) > 0 and var_14_0 < var_14_3 then
