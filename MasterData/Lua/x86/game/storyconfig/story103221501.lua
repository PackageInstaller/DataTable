	...
	Play322151055 = function(arg_231_0, arg_231_1)
		...
		function arg_231_1.onSingleLineUpdate_(arg_234_0)
			...
			if 0.1 < arg_231_1.time_ and arg_231_1.time_ <= 0.1 + arg_234_0 then
				...
				local var_234_11 = var_234_8.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_234_0, iter_234_1 in ipairs((var_234_11:ToTable())) do
					iter_234_1.transform.localScale = Vector3.New(iter_234_1.transform.localScale.x / var_234_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_234_11 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_234_1.transform.localScale.y / var_234_10, iter_234_1.transform.localScale.z)
				end
			end

			local var_234_13 = 0
			local var_234_14 = 0.875
			...
			if 0 < arg_231_1.time_ and arg_231_1.time_ <= var_234_13 + arg_234_0 then
				...
				local var_234_15 = arg_231_1:FormatText(arg_231_1:GetWordFromCfg(322151055).content)

				arg_231_1.text_.text = var_234_15

				LuaForUtil.ClearLinePrefixSymbol(arg_231_1.text_)

				local var_234_17 = 35 <= 0 and var_234_14 or var_234_14 * (utf8.len(var_234_15) / 35)

				if (35 <= 0 and var_234_14 or var_234_14 * (utf8.len(var_234_15) / 35)) > 0 and var_234_14 < var_234_17 then
