	...
	Play423172016 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 1.999999999999 < arg_69_1.time_ and arg_69_1.time_ <= 1.999999999999 + arg_72_0 then
				...
				local var_72_17 = var_72_14.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_72_2, iter_72_3 in ipairs((var_72_17:ToTable())) do
					iter_72_3.transform.localScale = Vector3.New(iter_72_3.transform.localScale.x / var_72_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_72_17 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_72_3.transform.localScale.y / var_72_16, iter_72_3.transform.localScale.z)
				end
			end

			if 1.999999999999 < arg_69_1.time_ and arg_69_1.time_ <= 1.999999999999 + arg_72_0 then
				local var_72_19 = arg_69_1.var_.effecthuangyuanbaoyu1

				if not arg_69_1.var_.effecthuangyuanbaoyu1 then
					var_72_19 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_heavy"), manager.ui.mainCamera.transform)
					var_72_19.name = "huangyuanbaoyu1"
					arg_69_1.var_.effecthuangyuanbaoyu1 = var_72_19
				else
					var_72_19.transform:SetParent(var_72_9000)
				end

				var_72_19.transform.localPosition = Vector3.New(0, 0, 0)
				var_72_19.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			if 4 < arg_69_1.time_ and arg_69_1.time_ <= var_72_23 + arg_72_0 then
				...
				local var_72_26 = arg_69_1:GetWordFromCfg(423172016)
				...
				local var_72_29 = 21 <= 0 and var_72_24 or var_72_24 * (utf8.len(var_72_27) / 21)

				if (21 <= 0 and var_72_24 or var_72_24 * (utf8.len(var_72_27) / 21)) > 0 and var_72_24 < var_72_29 then
				...
				if manager.audio:GetVoiceLength("story_v_out_423172", "423172016", "story_v_out_423172.awb") ~= 0 then
					local var_72_30 = manager.audio:GetVoiceLength("story_v_out_423172", "423172016", "story_v_out_423172.awb") / 1000
					...
					if var_72_26.prefab_name ~= "" and arg_69_1.actors_[var_72_26.prefab_name] ~= nil then
						local var_72_31 = LuaForUtil.PlayVoiceWithCriLipsync(arg_69_1.actors_[var_72_26.prefab_name].transform, "story_v_out_423172", "423172016", "story_v_out_423172.awb")

						arg_69_1:RecordAudio("423172016", var_72_31)
						arg_69_1:RecordAudio("423172016", var_72_31)
					else
