return {
	Play320061001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 then
				...
				local var_4_18 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(320061001).content)
	...
	Play320061002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:GetWordFromCfg(320061002)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061002", "story_v_out_320061.awb") ~= 0 then
					local var_12_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061002", "story_v_out_320061.awb") / 1000
					...
					if var_12_1.prefab_name ~= "" and arg_9_1.actors_[var_12_1.prefab_name] ~= nil then
						local var_12_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_1.prefab_name].transform, "story_v_out_320061", "320061002", "story_v_out_320061.awb")

						arg_9_1:RecordAudio("320061002", var_12_6)
						arg_9_1:RecordAudio("320061002", var_12_6)
					else
	...
	Play320061003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				local var_16_1 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(320061003).content)
	...
	Play320061004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if arg_17_1.actors_["1061ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1061ui_story"))) then
				local var_20_0 = Object.Instantiate(Asset.Load("Char/" .. "1061ui_story"), arg_17_1.stage_.transform)

				var_20_0.name = "1061ui_story"
				var_20_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_17_1.actors_["1061ui_story"] = var_20_0
				...
				arg_17_1.var_["1061ui_story" .. "Animator"] = var_20_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_17_1.var_["1061ui_story" .. "Animator"].applyRootMotion = true
				arg_17_1.var_["1061ui_story" .. "LipSync"] = var_20_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_20_3 = arg_17_1.actors_["1061ui_story"].transform

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				arg_17_1.var_.moveOldPos1061ui_story = var_20_3.localPosition
			end

			local var_20_4 = 0.001

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_4 then
				var_20_3.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos1061ui_story, Vector3.New(0, -1.18, -6.15), (arg_17_1.time_ - 0) / var_20_4)
			...
			if arg_17_1.time_ >= 0 + var_20_4 and arg_17_1.time_ < 0 + var_20_4 + arg_20_0 then
				var_20_3.localPosition = Vector3.New(0, -1.18, -6.15)
				var_20_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_20_3.position).x, (manager.ui.mainCamera.transform.position - var_20_3.position).y, (manager.ui.mainCamera.transform.position - var_20_3.position).z)
				var_20_3.localEulerAngles.z = 0
				var_20_3.localEulerAngles.x = 0
				var_20_3.localEulerAngles = var_20_3.localEulerAngles
			...
			local var_20_5 = arg_17_1.actors_["1061ui_story"]

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(var_20_5) and arg_17_1.var_.characterEffect1061ui_story == nil then
				arg_17_1.var_.characterEffect1061ui_story = var_20_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_6 = 0.200000002980232

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_6 and not isNil(var_20_5) then
				if arg_17_1.var_.characterEffect1061ui_story and not isNil(var_20_5) then
					arg_17_1.var_.characterEffect1061ui_story.fillFlat = false
				end
			end

			if arg_17_1.time_ >= 0 + var_20_6 and arg_17_1.time_ < 0 + var_20_6 + arg_20_0 and not isNil(var_20_5) and arg_17_1.var_.characterEffect1061ui_story then
				arg_17_1.var_.characterEffect1061ui_story.fillFlat = false
			end
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_8 + arg_20_0 then
				...
				local var_20_10 = arg_17_1:GetWordFromCfg(320061004)
				...
				local var_20_13 = 42 <= 0 and var_20_9 or var_20_9 * (utf8.len(var_20_11) / 42)

				if (42 <= 0 and var_20_9 or var_20_9 * (utf8.len(var_20_11) / 42)) > 0 and var_20_9 < var_20_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061004", "story_v_out_320061.awb") ~= 0 then
					local var_20_14 = manager.audio:GetVoiceLength("story_v_out_320061", "320061004", "story_v_out_320061.awb") / 1000
					...
					if var_20_10.prefab_name ~= "" and arg_17_1.actors_[var_20_10.prefab_name] ~= nil then
						local var_20_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_10.prefab_name].transform, "story_v_out_320061", "320061004", "story_v_out_320061.awb")

						arg_17_1:RecordAudio("320061004", var_20_15)
						arg_17_1:RecordAudio("320061004", var_20_15)
					else
	...
	Play320061005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_2 = arg_21_1:GetWordFromCfg(320061005)
				...
				local var_24_5 = 32 <= 0 and var_24_1 or var_24_1 * (utf8.len(var_24_3) / 32)

				if (32 <= 0 and var_24_1 or var_24_1 * (utf8.len(var_24_3) / 32)) > 0 and var_24_1 < var_24_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061005", "story_v_out_320061.awb") ~= 0 then
					local var_24_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061005", "story_v_out_320061.awb") / 1000
					...
					if var_24_2.prefab_name ~= "" and arg_21_1.actors_[var_24_2.prefab_name] ~= nil then
						local var_24_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_2.prefab_name].transform, "story_v_out_320061", "320061005", "story_v_out_320061.awb")

						arg_21_1:RecordAudio("320061005", var_24_7)
						arg_21_1:RecordAudio("320061005", var_24_7)
					else
	...
	Play320061006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(320061006).content)
	...
	Play320061007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				local var_32_1 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(320061007).content)
	...
	Play320061008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_2 + arg_36_0 then
				...
				local var_36_4 = arg_33_1:GetWordFromCfg(320061008)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061008", "story_v_out_320061.awb") ~= 0 then
					local var_36_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061008", "story_v_out_320061.awb") / 1000
					...
					if var_36_4.prefab_name ~= "" and arg_33_1.actors_[var_36_4.prefab_name] ~= nil then
						local var_36_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_4.prefab_name].transform, "story_v_out_320061", "320061008", "story_v_out_320061.awb")

						arg_33_1:RecordAudio("320061008", var_36_9)
						arg_33_1:RecordAudio("320061008", var_36_9)
					else
	...
	Play320061009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_0 + arg_40_0 then
				...
				local var_40_2 = arg_37_1:GetWordFromCfg(320061009)
				...
				local var_40_5 = 47 <= 0 and var_40_1 or var_40_1 * (utf8.len(var_40_3) / 47)

				if (47 <= 0 and var_40_1 or var_40_1 * (utf8.len(var_40_3) / 47)) > 0 and var_40_1 < var_40_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061009", "story_v_out_320061.awb") ~= 0 then
					local var_40_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061009", "story_v_out_320061.awb") / 1000
					...
					if var_40_2.prefab_name ~= "" and arg_37_1.actors_[var_40_2.prefab_name] ~= nil then
						local var_40_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_2.prefab_name].transform, "story_v_out_320061", "320061009", "story_v_out_320061.awb")

						arg_37_1:RecordAudio("320061009", var_40_7)
						arg_37_1:RecordAudio("320061009", var_40_7)
					else
	...
	Play320061010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(arg_41_1.actors_["1061ui_story"]) and arg_41_1.var_.characterEffect1061ui_story == nil then
				arg_41_1.var_.characterEffect1061ui_story = arg_41_1.actors_["1061ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_44_0 = 0.200000002980232

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_0 and not isNil(arg_41_1.actors_["1061ui_story"]) then
				if arg_41_1.var_.characterEffect1061ui_story and not isNil(arg_41_1.actors_["1061ui_story"]) then
					arg_41_1.var_.characterEffect1061ui_story.fillFlat = true
					arg_41_1.var_.characterEffect1061ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_41_1.time_ - 0) / var_44_0)
				end
			end

			if arg_41_1.time_ >= 0 + var_44_0 and arg_41_1.time_ < 0 + var_44_0 + arg_44_0 and not isNil(arg_41_1.actors_["1061ui_story"]) and arg_41_1.var_.characterEffect1061ui_story then
				arg_41_1.var_.characterEffect1061ui_story.fillFlat = true
				arg_41_1.var_.characterEffect1061ui_story.fillRatio = 0.5
			end

			local var_44_1 = 0
			local var_44_2 = 0.975
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(320061010).content)

				arg_41_1.text_.text = var_44_3

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_5 = 39 <= 0 and var_44_2 or var_44_2 * (utf8.len(var_44_3) / 39)

				if (39 <= 0 and var_44_2 or var_44_2 * (utf8.len(var_44_3) / 39)) > 0 and var_44_2 < var_44_5 then
	...
	Play320061011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 then
				...
				local var_48_4 = arg_45_1:GetWordFromCfg(320061011)
				...
				local var_48_7 = 33 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_5) / 33)

				if (33 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_5) / 33)) > 0 and var_48_3 < var_48_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061011", "story_v_out_320061.awb") ~= 0 then
					local var_48_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061011", "story_v_out_320061.awb") / 1000
					...
					if var_48_4.prefab_name ~= "" and arg_45_1.actors_[var_48_4.prefab_name] ~= nil then
						local var_48_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_4.prefab_name].transform, "story_v_out_320061", "320061011", "story_v_out_320061.awb")

						arg_45_1:RecordAudio("320061011", var_48_9)
						arg_45_1:RecordAudio("320061011", var_48_9)
					else
	...
	Play320061012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_0 + arg_52_0 then
				...
				local var_52_2 = arg_49_1:GetWordFromCfg(320061012)
				...
				local var_52_5 = 39 <= 0 and var_52_1 or var_52_1 * (utf8.len(var_52_3) / 39)

				if (39 <= 0 and var_52_1 or var_52_1 * (utf8.len(var_52_3) / 39)) > 0 and var_52_1 < var_52_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061012", "story_v_out_320061.awb") ~= 0 then
					local var_52_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061012", "story_v_out_320061.awb") / 1000
					...
					if var_52_2.prefab_name ~= "" and arg_49_1.actors_[var_52_2.prefab_name] ~= nil then
						local var_52_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_2.prefab_name].transform, "story_v_out_320061", "320061012", "story_v_out_320061.awb")

						arg_49_1:RecordAudio("320061012", var_52_7)
						arg_49_1:RecordAudio("320061012", var_52_7)
					else
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_0 and not isNil(arg_53_1.actors_["1061ui_story"]) then
				if arg_53_1.var_.characterEffect1061ui_story and not isNil(arg_53_1.actors_["1061ui_story"]) then
					...
					arg_53_1.var_.characterEffect1061ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_53_1.time_ - 0) / var_56_0)
				end
			end
			...
			if arg_53_1.time_ >= 0 + var_56_0 and arg_53_1.time_ < 0 + var_56_0 + arg_56_0 and not isNil(arg_53_1.actors_["1061ui_story"]) and arg_53_1.var_.characterEffect1061ui_story then
				arg_53_1.var_.characterEffect1061ui_story.fillFlat = true
				arg_53_1.var_.characterEffect1061ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_1 + arg_56_0 then
				...
				local var_56_3 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(320061013).content)
	...
	Play320061014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_2 + arg_60_0 then
				...
				local var_60_4 = arg_57_1:GetWordFromCfg(320061014)
				...
				local var_60_7 = 41 <= 0 and var_60_3 or var_60_3 * (utf8.len(var_60_5) / 41)

				if (41 <= 0 and var_60_3 or var_60_3 * (utf8.len(var_60_5) / 41)) > 0 and var_60_3 < var_60_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061014", "story_v_out_320061.awb") ~= 0 then
					local var_60_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061014", "story_v_out_320061.awb") / 1000
					...
					if var_60_4.prefab_name ~= "" and arg_57_1.actors_[var_60_4.prefab_name] ~= nil then
						local var_60_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_57_1.actors_[var_60_4.prefab_name].transform, "story_v_out_320061", "320061014", "story_v_out_320061.awb")

						arg_57_1:RecordAudio("320061014", var_60_9)
						arg_57_1:RecordAudio("320061014", var_60_9)
					else
	...
	Play320061015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_0 + arg_64_0 then
				...
				local var_64_2 = arg_61_1:GetWordFromCfg(320061015)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061015", "story_v_out_320061.awb") ~= 0 then
					local var_64_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061015", "story_v_out_320061.awb") / 1000
					...
					if var_64_2.prefab_name ~= "" and arg_61_1.actors_[var_64_2.prefab_name] ~= nil then
						local var_64_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_61_1.actors_[var_64_2.prefab_name].transform, "story_v_out_320061", "320061015", "story_v_out_320061.awb")

						arg_61_1:RecordAudio("320061015", var_64_7)
						arg_61_1:RecordAudio("320061015", var_64_7)
					else
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_0 and not isNil(arg_65_1.actors_["1061ui_story"]) then
				if arg_65_1.var_.characterEffect1061ui_story and not isNil(arg_65_1.actors_["1061ui_story"]) then
					...
					arg_65_1.var_.characterEffect1061ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_65_1.time_ - 0) / var_68_0)
				end
			end
			...
			if arg_65_1.time_ >= 0 + var_68_0 and arg_65_1.time_ < 0 + var_68_0 + arg_68_0 and not isNil(arg_65_1.actors_["1061ui_story"]) and arg_65_1.var_.characterEffect1061ui_story then
				arg_65_1.var_.characterEffect1061ui_story.fillFlat = true
				arg_65_1.var_.characterEffect1061ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_1 + arg_68_0 then
				...
				local var_68_3 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(320061016).content)
	...
	Play320061017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_2 + arg_72_0 then
				...
				local var_72_4 = arg_69_1:GetWordFromCfg(320061017)
				...
				local var_72_7 = 17 <= 0 and var_72_3 or var_72_3 * (utf8.len(var_72_5) / 17)

				if (17 <= 0 and var_72_3 or var_72_3 * (utf8.len(var_72_5) / 17)) > 0 and var_72_3 < var_72_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061017", "story_v_out_320061.awb") ~= 0 then
					local var_72_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061017", "story_v_out_320061.awb") / 1000
					...
					if var_72_4.prefab_name ~= "" and arg_69_1.actors_[var_72_4.prefab_name] ~= nil then
						local var_72_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_69_1.actors_[var_72_4.prefab_name].transform, "story_v_out_320061", "320061017", "story_v_out_320061.awb")

						arg_69_1:RecordAudio("320061017", var_72_9)
						arg_69_1:RecordAudio("320061017", var_72_9)
					else
	...
	Play320061018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 and not isNil(arg_73_1.actors_["1061ui_story"]) and arg_73_1.var_.characterEffect1061ui_story == nil then
				arg_73_1.var_.characterEffect1061ui_story = arg_73_1.actors_["1061ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_76_0 = 0.200000002980232

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_0 and not isNil(arg_73_1.actors_["1061ui_story"]) then
				if arg_73_1.var_.characterEffect1061ui_story and not isNil(arg_73_1.actors_["1061ui_story"]) then
					arg_73_1.var_.characterEffect1061ui_story.fillFlat = true
					arg_73_1.var_.characterEffect1061ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_73_1.time_ - 0) / var_76_0)
				end
			end

			if arg_73_1.time_ >= 0 + var_76_0 and arg_73_1.time_ < 0 + var_76_0 + arg_76_0 and not isNil(arg_73_1.actors_["1061ui_story"]) and arg_73_1.var_.characterEffect1061ui_story then
				arg_73_1.var_.characterEffect1061ui_story.fillFlat = true
				arg_73_1.var_.characterEffect1061ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_1 + arg_76_0 then
				...
				local var_76_3 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(320061018).content)
	...
	Play320061019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_0 then
				arg_77_1.actors_["1061ui_story"].transform.localPosition = Vector3.Lerp(arg_77_1.var_.moveOldPos1061ui_story, Vector3.New(0, 100, 0), (arg_77_1.time_ - 0) / var_80_0)
			...
			if arg_77_1.time_ >= 0 + var_80_0 and arg_77_1.time_ < 0 + var_80_0 + arg_80_0 then
				arg_77_1.actors_["1061ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_77_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1061ui_story"].transform.position).z)
				arg_77_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["1061ui_story"].transform.localEulerAngles = arg_77_1.actors_["1061ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_2 and not isNil(var_80_1) then
				if arg_77_1.var_.characterEffect1061ui_story and not isNil(var_80_1) then
					...
					arg_77_1.var_.characterEffect1061ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_77_1.time_ - 0) / var_80_2)
				end
			end
			...
			if arg_77_1.time_ >= 0 + var_80_2 and arg_77_1.time_ < 0 + var_80_2 + arg_80_0 and not isNil(var_80_1) and arg_77_1.var_.characterEffect1061ui_story then
				arg_77_1.var_.characterEffect1061ui_story.fillFlat = true
				arg_77_1.var_.characterEffect1061ui_story.fillRatio = 0.5
			end

			local var_80_3 = 0
			local var_80_4 = 1.075
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_3 + arg_80_0 then
				...
				local var_80_5 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(320061019).content)

				arg_77_1.text_.text = var_80_5

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_7 = 43 <= 0 and var_80_4 or var_80_4 * (utf8.len(var_80_5) / 43)

				if (43 <= 0 and var_80_4 or var_80_4 * (utf8.len(var_80_5) / 43)) > 0 and var_80_4 < var_80_7 then
	...
	Play320061020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= 0 + arg_84_0 then
				...
				local var_84_1 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(320061020).content)
	...
	Play320061021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				arg_85_1.var_.moveOldPos1061ui_story = arg_85_1.actors_["1061ui_story"].transform.localPosition
			end

			local var_88_0 = 0.001

			if 0 <= arg_85_1.time_ and arg_85_1.time_ < 0 + var_88_0 then
				arg_85_1.actors_["1061ui_story"].transform.localPosition = Vector3.Lerp(arg_85_1.var_.moveOldPos1061ui_story, Vector3.New(0, -1.18, -6.15), (arg_85_1.time_ - 0) / var_88_0)
				arg_85_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_85_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1061ui_story"].transform.position).z)
				arg_85_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_85_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_85_1.actors_["1061ui_story"].transform.localEulerAngles = arg_85_1.actors_["1061ui_story"].transform.localEulerAngles
			end

			if arg_85_1.time_ >= 0 + var_88_0 and arg_85_1.time_ < 0 + var_88_0 + arg_88_0 then
				arg_85_1.actors_["1061ui_story"].transform.localPosition = Vector3.New(0, -1.18, -6.15)
				arg_85_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_85_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1061ui_story"].transform.position).z)
				arg_85_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_85_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_85_1.actors_["1061ui_story"].transform.localEulerAngles = arg_85_1.actors_["1061ui_story"].transform.localEulerAngles
			...
			local var_88_1 = arg_85_1.actors_["1061ui_story"]

			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 and not isNil(var_88_1) and arg_85_1.var_.characterEffect1061ui_story == nil then
				arg_85_1.var_.characterEffect1061ui_story = var_88_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_88_2 = 0.200000002980232

			if 0 <= arg_85_1.time_ and arg_85_1.time_ < 0 + var_88_2 and not isNil(var_88_1) then
				if arg_85_1.var_.characterEffect1061ui_story and not isNil(var_88_1) then
					arg_85_1.var_.characterEffect1061ui_story.fillFlat = false
				end
			end

			if arg_85_1.time_ >= 0 + var_88_2 and arg_85_1.time_ < 0 + var_88_2 + arg_88_0 and not isNil(var_88_1) and arg_85_1.var_.characterEffect1061ui_story then
				arg_85_1.var_.characterEffect1061ui_story.fillFlat = false
			end
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= var_88_4 + arg_88_0 then
				...
				local var_88_6 = arg_85_1:GetWordFromCfg(320061021)
				...
				local var_88_9 = 2 <= 0 and var_88_5 or var_88_5 * (utf8.len(var_88_7) / 2)

				if (2 <= 0 and var_88_5 or var_88_5 * (utf8.len(var_88_7) / 2)) > 0 and var_88_5 < var_88_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061021", "story_v_out_320061.awb") ~= 0 then
					local var_88_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061021", "story_v_out_320061.awb") / 1000
					...
					if var_88_6.prefab_name ~= "" and arg_85_1.actors_[var_88_6.prefab_name] ~= nil then
						local var_88_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_85_1.actors_[var_88_6.prefab_name].transform, "story_v_out_320061", "320061021", "story_v_out_320061.awb")

						arg_85_1:RecordAudio("320061021", var_88_11)
						arg_85_1:RecordAudio("320061021", var_88_11)
					else
	...
	Play320061022 = function(arg_89_0, arg_89_1)
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			if 0 < arg_89_1.time_ and arg_89_1.time_ <= 0 + arg_92_0 then
				arg_89_1.var_.moveOldPos1061ui_story = arg_89_1.actors_["1061ui_story"].transform.localPosition
			end

			local var_92_0 = 0.001

			if 0 <= arg_89_1.time_ and arg_89_1.time_ < 0 + var_92_0 then
				arg_89_1.actors_["1061ui_story"].transform.localPosition = Vector3.Lerp(arg_89_1.var_.moveOldPos1061ui_story, Vector3.New(0, 100, 0), (arg_89_1.time_ - 0) / var_92_0)
				arg_89_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_89_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_89_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_89_1.actors_["1061ui_story"].transform.position).z)
				arg_89_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_89_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_89_1.actors_["1061ui_story"].transform.localEulerAngles = arg_89_1.actors_["1061ui_story"].transform.localEulerAngles
			end

			if arg_89_1.time_ >= 0 + var_92_0 and arg_89_1.time_ < 0 + var_92_0 + arg_92_0 then
				arg_89_1.actors_["1061ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_89_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_89_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_89_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_89_1.actors_["1061ui_story"].transform.position).z)
				arg_89_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_89_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_89_1.actors_["1061ui_story"].transform.localEulerAngles = arg_89_1.actors_["1061ui_story"].transform.localEulerAngles
			...
			local var_92_1 = arg_89_1.actors_["1061ui_story"]

			if 0 < arg_89_1.time_ and arg_89_1.time_ <= 0 + arg_92_0 and not isNil(var_92_1) and arg_89_1.var_.characterEffect1061ui_story == nil then
				arg_89_1.var_.characterEffect1061ui_story = var_92_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_92_2 = 0.200000002980232

			if 0 <= arg_89_1.time_ and arg_89_1.time_ < 0 + var_92_2 and not isNil(var_92_1) then
				if arg_89_1.var_.characterEffect1061ui_story and not isNil(var_92_1) then
					arg_89_1.var_.characterEffect1061ui_story.fillFlat = true
					arg_89_1.var_.characterEffect1061ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_89_1.time_ - 0) / var_92_2)
				end
			end

			if arg_89_1.time_ >= 0 + var_92_2 and arg_89_1.time_ < 0 + var_92_2 + arg_92_0 and not isNil(var_92_1) and arg_89_1.var_.characterEffect1061ui_story then
				arg_89_1.var_.characterEffect1061ui_story.fillFlat = true
			...
			if 0 < arg_89_1.time_ and arg_89_1.time_ <= var_92_3 + arg_92_0 then
				...
				local var_92_5 = arg_89_1:FormatText(arg_89_1:GetWordFromCfg(320061022).content)

				arg_89_1.text_.text = var_92_5

				LuaForUtil.ClearLinePrefixSymbol(arg_89_1.text_)

				local var_92_7 = 64 <= 0 and var_92_4 or var_92_4 * (utf8.len(var_92_5) / 64)

				if (64 <= 0 and var_92_4 or var_92_4 * (utf8.len(var_92_5) / 64)) > 0 and var_92_4 < var_92_7 then
	...
	Play320061023 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			if 0 < arg_93_1.time_ and arg_93_1.time_ <= 0 + arg_96_0 then
				arg_93_1.var_.moveOldPos1061ui_story = arg_93_1.actors_["1061ui_story"].transform.localPosition
			end

			local var_96_0 = 0.001

			if 0 <= arg_93_1.time_ and arg_93_1.time_ < 0 + var_96_0 then
				arg_93_1.actors_["1061ui_story"].transform.localPosition = Vector3.Lerp(arg_93_1.var_.moveOldPos1061ui_story, Vector3.New(0, -1.18, -6.15), (arg_93_1.time_ - 0) / var_96_0)
				arg_93_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_93_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_93_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_93_1.actors_["1061ui_story"].transform.position).z)
				arg_93_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_93_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_93_1.actors_["1061ui_story"].transform.localEulerAngles = arg_93_1.actors_["1061ui_story"].transform.localEulerAngles
			end

			if arg_93_1.time_ >= 0 + var_96_0 and arg_93_1.time_ < 0 + var_96_0 + arg_96_0 then
				arg_93_1.actors_["1061ui_story"].transform.localPosition = Vector3.New(0, -1.18, -6.15)
				arg_93_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_93_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_93_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_93_1.actors_["1061ui_story"].transform.position).z)
				arg_93_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_93_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_93_1.actors_["1061ui_story"].transform.localEulerAngles = arg_93_1.actors_["1061ui_story"].transform.localEulerAngles
			...
			local var_96_1 = arg_93_1.actors_["1061ui_story"]

			if 0 < arg_93_1.time_ and arg_93_1.time_ <= 0 + arg_96_0 and not isNil(var_96_1) and arg_93_1.var_.characterEffect1061ui_story == nil then
				arg_93_1.var_.characterEffect1061ui_story = var_96_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_96_2 = 0.200000002980232

			if 0 <= arg_93_1.time_ and arg_93_1.time_ < 0 + var_96_2 and not isNil(var_96_1) then
				if arg_93_1.var_.characterEffect1061ui_story and not isNil(var_96_1) then
					arg_93_1.var_.characterEffect1061ui_story.fillFlat = false
				end
			end

			if arg_93_1.time_ >= 0 + var_96_2 and arg_93_1.time_ < 0 + var_96_2 + arg_96_0 and not isNil(var_96_1) and arg_93_1.var_.characterEffect1061ui_story then
				arg_93_1.var_.characterEffect1061ui_story.fillFlat = false
			end
			...
			if 0 < arg_93_1.time_ and arg_93_1.time_ <= var_96_4 + arg_96_0 then
				...
				local var_96_6 = arg_93_1:GetWordFromCfg(320061023)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061023", "story_v_out_320061.awb") ~= 0 then
					local var_96_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061023", "story_v_out_320061.awb") / 1000
					...
					if var_96_6.prefab_name ~= "" and arg_93_1.actors_[var_96_6.prefab_name] ~= nil then
						local var_96_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_93_1.actors_[var_96_6.prefab_name].transform, "story_v_out_320061", "320061023", "story_v_out_320061.awb")

						arg_93_1:RecordAudio("320061023", var_96_11)
						arg_93_1:RecordAudio("320061023", var_96_11)
					else
	...
	Play320061024 = function(arg_97_0, arg_97_1)
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			...
			if 0 <= arg_97_1.time_ and arg_97_1.time_ < 0 + var_100_0 then
				arg_97_1.actors_["1061ui_story"].transform.localPosition = Vector3.Lerp(arg_97_1.var_.moveOldPos1061ui_story, Vector3.New(0, -1.18, -6.15), (arg_97_1.time_ - 0) / var_100_0)
			...
			if arg_97_1.time_ >= 0 + var_100_0 and arg_97_1.time_ < 0 + var_100_0 + arg_100_0 then
				arg_97_1.actors_["1061ui_story"].transform.localPosition = Vector3.New(0, -1.18, -6.15)
				arg_97_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_97_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_97_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_97_1.actors_["1061ui_story"].transform.position).z)
				arg_97_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_97_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_97_1.actors_["1061ui_story"].transform.localEulerAngles = arg_97_1.actors_["1061ui_story"].transform.localEulerAngles
			...
			local var_100_1 = arg_97_1.actors_["1061ui_story"]

			if 0 < arg_97_1.time_ and arg_97_1.time_ <= 0 + arg_100_0 and not isNil(var_100_1) and arg_97_1.var_.characterEffect1061ui_story == nil then
				arg_97_1.var_.characterEffect1061ui_story = var_100_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_100_2 = 0.200000002980232

			if 0 <= arg_97_1.time_ and arg_97_1.time_ < 0 + var_100_2 and not isNil(var_100_1) then
				if arg_97_1.var_.characterEffect1061ui_story and not isNil(var_100_1) then
					arg_97_1.var_.characterEffect1061ui_story.fillFlat = false
				end
			end

			if arg_97_1.time_ >= 0 + var_100_2 and arg_97_1.time_ < 0 + var_100_2 + arg_100_0 and not isNil(var_100_1) and arg_97_1.var_.characterEffect1061ui_story then
				arg_97_1.var_.characterEffect1061ui_story.fillFlat = false
			end
			...
			if 0 < arg_97_1.time_ and arg_97_1.time_ <= var_100_4 + arg_100_0 then
				...
				local var_100_6 = arg_97_1:GetWordFromCfg(320061024)
				...
				local var_100_9 = 22 <= 0 and var_100_5 or var_100_5 * (utf8.len(var_100_7) / 22)

				if (22 <= 0 and var_100_5 or var_100_5 * (utf8.len(var_100_7) / 22)) > 0 and var_100_5 < var_100_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061024", "story_v_out_320061.awb") ~= 0 then
					local var_100_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061024", "story_v_out_320061.awb") / 1000
					...
					if var_100_6.prefab_name ~= "" and arg_97_1.actors_[var_100_6.prefab_name] ~= nil then
						local var_100_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_97_1.actors_[var_100_6.prefab_name].transform, "story_v_out_320061", "320061024", "story_v_out_320061.awb")

						arg_97_1:RecordAudio("320061024", var_100_11)
						arg_97_1:RecordAudio("320061024", var_100_11)
					else
	...
	Play320061025 = function(arg_101_0, arg_101_1)
		...
		function arg_101_1.onSingleLineUpdate_(arg_104_0)
			if 0 < arg_101_1.time_ and arg_101_1.time_ <= 0 + arg_104_0 and not isNil(arg_101_1.actors_["1061ui_story"]) and arg_101_1.var_.characterEffect1061ui_story == nil then
				arg_101_1.var_.characterEffect1061ui_story = arg_101_1.actors_["1061ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_104_0 = 0.200000002980232

			if 0 <= arg_101_1.time_ and arg_101_1.time_ < 0 + var_104_0 and not isNil(arg_101_1.actors_["1061ui_story"]) then
				if arg_101_1.var_.characterEffect1061ui_story and not isNil(arg_101_1.actors_["1061ui_story"]) then
					arg_101_1.var_.characterEffect1061ui_story.fillFlat = true
					arg_101_1.var_.characterEffect1061ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_101_1.time_ - 0) / var_104_0)
				end
			end

			if arg_101_1.time_ >= 0 + var_104_0 and arg_101_1.time_ < 0 + var_104_0 + arg_104_0 and not isNil(arg_101_1.actors_["1061ui_story"]) and arg_101_1.var_.characterEffect1061ui_story then
				arg_101_1.var_.characterEffect1061ui_story.fillFlat = true
				arg_101_1.var_.characterEffect1061ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_101_1.time_ and arg_101_1.time_ <= var_104_1 + arg_104_0 then
				...
				local var_104_3 = arg_101_1:FormatText(arg_101_1:GetWordFromCfg(320061025).content)
	...
	Play320061026 = function(arg_105_0, arg_105_1)
		...
		function arg_105_1.onSingleLineUpdate_(arg_108_0)
			...
			if arg_105_1.time_ >= 0 + 1 and arg_105_1.time_ < 0 + 1 + arg_108_0 then
	...
	Play320061027 = function(arg_109_0, arg_109_1)
		...
		function arg_109_1.onSingleLineUpdate_(arg_112_0)
			if 1.999999999999 < arg_109_1.time_ and arg_109_1.time_ <= 1.999999999999 + arg_112_0 then
				local var_112_0 = arg_109_1.bgs_.ST61
			...
			local var_112_12 = arg_109_1.actors_["1061ui_story"].transform

			if 1.96599999815226 < arg_109_1.time_ and arg_109_1.time_ <= 1.96599999815226 + arg_112_0 then
				arg_109_1.var_.moveOldPos1061ui_story = var_112_12.localPosition
			end

			local var_112_13 = 0.001

			if 1.96599999815226 <= arg_109_1.time_ and arg_109_1.time_ < 1.96599999815226 + var_112_13 then
				var_112_12.localPosition = Vector3.Lerp(arg_109_1.var_.moveOldPos1061ui_story, Vector3.New(0, 100, 0), (arg_109_1.time_ - 1.96599999815226) / var_112_13)
			...
			local var_112_14 = arg_109_1.actors_["1061ui_story"]

			if 1.96599999815226 < arg_109_1.time_ and arg_109_1.time_ <= 1.96599999815226 + arg_112_0 and not isNil(var_112_14) and arg_109_1.var_.characterEffect1061ui_story == nil then
				arg_109_1.var_.characterEffect1061ui_story = var_112_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 1.96599999815226 <= arg_109_1.time_ and arg_109_1.time_ < 1.96599999815226 + var_112_15 and not isNil(var_112_14) then
				if arg_109_1.var_.characterEffect1061ui_story and not isNil(var_112_14) then
					arg_109_1.var_.characterEffect1061ui_story.fillFlat = true
					arg_109_1.var_.characterEffect1061ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_109_1.time_ - 1.96599999815226) / var_112_15)
				end
			end

			if arg_109_1.time_ >= 1.96599999815226 + var_112_15 and arg_109_1.time_ < 1.96599999815226 + var_112_15 + arg_112_0 and not isNil(var_112_14) and arg_109_1.var_.characterEffect1061ui_story then
				arg_109_1.var_.characterEffect1061ui_story.fillFlat = true
				arg_109_1.var_.characterEffect1061ui_story.fillRatio = 0.5
			end

			local var_112_16 = "1020ui_story"

			if arg_109_1.actors_["1020ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1020ui_story"))) then
				local var_112_17 = Object.Instantiate(Asset.Load("Char/" .. "1020ui_story"), arg_109_1.stage_.transform)

				var_112_17.name = var_112_16
				var_112_17.transform.localPosition = Vector3.New(0, 100, 0)
				arg_109_1.actors_[var_112_16] = var_112_17

				local var_112_18 = var_112_17:GetComponentInChildren(typeof(CharacterEffect))

				var_112_18.enabled = true

				local var_112_19 = GameObjectTools.GetOrAddComponent(var_112_17, typeof(DynamicBoneHelper))

				if var_112_19 then
					var_112_19:EnableDynamicBone(false)
				end

				arg_109_1:ShowWeapon(var_112_18.transform, false)

				arg_109_1.var_[var_112_16 .. "Animator"] = var_112_18.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_109_1.var_[var_112_16 .. "Animator"].applyRootMotion = true
				arg_109_1.var_[var_112_16 .. "LipSync"] = var_112_18.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_112_20 = arg_109_1.actors_["1020ui_story"].transform

			if 3.8 < arg_109_1.time_ and arg_109_1.time_ <= 3.8 + arg_112_0 then
				arg_109_1.var_.moveOldPos1020ui_story = var_112_20.localPosition
			end

			local var_112_21 = 0.001

			if 3.8 <= arg_109_1.time_ and arg_109_1.time_ < 3.8 + var_112_21 then
				var_112_20.localPosition = Vector3.Lerp(arg_109_1.var_.moveOldPos1020ui_story, Vector3.New(0, -0.85, -6.25), (arg_109_1.time_ - 3.8) / var_112_21)
				var_112_20.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_112_20.position).x, (manager.ui.mainCamera.transform.position - var_112_20.position).y, (manager.ui.mainCamera.transform.position - var_112_20.position).z)
				var_112_20.localEulerAngles.z = 0
				var_112_20.localEulerAngles.x = 0
				var_112_20.localEulerAngles = var_112_20.localEulerAngles
			end

			if arg_109_1.time_ >= 3.8 + var_112_21 and arg_109_1.time_ < 3.8 + var_112_21 + arg_112_0 then
				var_112_20.localPosition = Vector3.New(0, -0.85, -6.25)
				var_112_20.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_112_20.position).x, (manager.ui.mainCamera.transform.position - var_112_20.position).y, (manager.ui.mainCamera.transform.position - var_112_20.position).z)
				var_112_20.localEulerAngles.z = 0
				var_112_20.localEulerAngles.x = 0
				var_112_20.localEulerAngles = var_112_20.localEulerAngles
			...
			local var_112_22 = arg_109_1.actors_["1020ui_story"]

			if 3.8 < arg_109_1.time_ and arg_109_1.time_ <= 3.8 + arg_112_0 and not isNil(var_112_22) and arg_109_1.var_.characterEffect1020ui_story == nil then
				arg_109_1.var_.characterEffect1020ui_story = var_112_22:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_112_23 = 0.200000002980232

			if 3.8 <= arg_109_1.time_ and arg_109_1.time_ < 3.8 + var_112_23 and not isNil(var_112_22) then
				if arg_109_1.var_.characterEffect1020ui_story and not isNil(var_112_22) then
					arg_109_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_109_1.time_ >= 3.8 + var_112_23 and arg_109_1.time_ < 3.8 + var_112_23 + arg_112_0 and not isNil(var_112_22) and arg_109_1.var_.characterEffect1020ui_story then
				arg_109_1.var_.characterEffect1020ui_story.fillFlat = false
			end

			local var_112_25 = "1020ui_story"

			if arg_109_1.actors_["1020ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1020ui_story"))) then
				local var_112_26 = Object.Instantiate(Asset.Load("Char/" .. "1020ui_story"), arg_109_1.stage_.transform)

				var_112_26.name = var_112_25
				var_112_26.transform.localPosition = Vector3.New(0, 100, 0)
				arg_109_1.actors_[var_112_25] = var_112_26

				local var_112_27 = var_112_26:GetComponentInChildren(typeof(CharacterEffect))

				var_112_27.enabled = true

				local var_112_28 = GameObjectTools.GetOrAddComponent(var_112_26, typeof(DynamicBoneHelper))

				if var_112_28 then
					var_112_28:EnableDynamicBone(false)
				end

				arg_109_1:ShowWeapon(var_112_27.transform, false)

				arg_109_1.var_[var_112_25 .. "Animator"] = var_112_27.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_109_1.var_[var_112_25 .. "Animator"].applyRootMotion = true
				arg_109_1.var_[var_112_25 .. "LipSync"] = var_112_27.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end
			...
			local var_112_29 = "1020ui_story"

			if arg_109_1.actors_["1020ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1020ui_story"))) then
				local var_112_30 = Object.Instantiate(Asset.Load("Char/" .. "1020ui_story"), arg_109_1.stage_.transform)

				var_112_30.name = var_112_29
				var_112_30.transform.localPosition = Vector3.New(0, 100, 0)
				arg_109_1.actors_[var_112_29] = var_112_30

				local var_112_31 = var_112_30:GetComponentInChildren(typeof(CharacterEffect))

				var_112_31.enabled = true

				local var_112_32 = GameObjectTools.GetOrAddComponent(var_112_30, typeof(DynamicBoneHelper))

				if var_112_32 then
					var_112_32:EnableDynamicBone(false)
				end

				arg_109_1:ShowWeapon(var_112_31.transform, false)

				arg_109_1.var_[var_112_29 .. "Animator"] = var_112_31.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_109_1.var_[var_112_29 .. "Animator"].applyRootMotion = true
				arg_109_1.var_[var_112_29 .. "LipSync"] = var_112_31.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end
			...
			local var_112_33 = 3.999999999999
			local var_112_34 = 0.125

			if 3.999999999999 < arg_109_1.time_ and arg_109_1.time_ <= var_112_33 + arg_112_0 then
				...
				local var_112_35 = LeanTween.value(arg_109_1.dialog_, 0, 1, 0.3)

				var_112_35:setOnUpdate(LuaHelper.FloatAction(function(arg_113_0)
					arg_109_1.dialogCg_.alpha = arg_113_0
				end))
				var_112_35:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_109_1.dialog_)
					var_112_35:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_112_36 = arg_109_1:GetWordFromCfg(320061027)
				local var_112_37 = arg_109_1:FormatText(var_112_36.content)

				arg_109_1.text_.text = var_112_37

				LuaForUtil.ClearLinePrefixSymbol(arg_109_1.text_)

				local var_112_39 = 5 <= 0 and var_112_34 or var_112_34 * (utf8.len(var_112_37) / 5)

				if (5 <= 0 and var_112_34 or var_112_34 * (utf8.len(var_112_37) / 5)) > 0 and var_112_34 < var_112_39 then
					arg_109_1.talkMaxDuration = var_112_39
					var_112_33 = var_112_33 + 0.3

					if var_112_39 + var_112_33 > arg_109_1.duration_ then
						arg_109_1.duration_ = var_112_39 + var_112_33
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061027", "story_v_out_320061.awb") ~= 0 then
					local var_112_40 = manager.audio:GetVoiceLength("story_v_out_320061", "320061027", "story_v_out_320061.awb") / 1000

					if var_112_40 + var_112_33 > arg_109_1.duration_ then
						arg_109_1.duration_ = var_112_40 + var_112_33
					end

					if var_112_36.prefab_name ~= "" and arg_109_1.actors_[var_112_36.prefab_name] ~= nil then
						local var_112_41 = LuaForUtil.PlayVoiceWithCriLipsync(arg_109_1.actors_[var_112_36.prefab_name].transform, "story_v_out_320061", "320061027", "story_v_out_320061.awb")

						arg_109_1:RecordAudio("320061027", var_112_41)
						arg_109_1:RecordAudio("320061027", var_112_41)
					else
			...
			local var_112_42 = var_112_33 + 0.3
			local var_112_43 = math.max(var_112_34, arg_109_1.talkMaxDuration)

			if var_112_33 + 0.3 <= arg_109_1.time_ and arg_109_1.time_ < var_112_42 + var_112_43 then
	...
	Play320061028 = function(arg_115_0, arg_115_1)
		...
		function arg_115_1.onSingleLineUpdate_(arg_118_0)
			...
			if 0 <= arg_115_1.time_ and arg_115_1.time_ < 0 + var_118_0 then
				arg_115_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_115_1.var_.moveOldPos1020ui_story, Vector3.New(-0.7, -0.85, -6.25), (arg_115_1.time_ - 0) / var_118_0)
			...
			if arg_115_1.time_ >= 0 + var_118_0 and arg_115_1.time_ < 0 + var_118_0 + arg_118_0 then
				arg_115_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(-0.7, -0.85, -6.25)
				arg_115_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_115_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_115_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_115_1.actors_["1020ui_story"].transform.position).z)
				arg_115_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_115_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_115_1.actors_["1020ui_story"].transform.localEulerAngles = arg_115_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_118_3 = "10100ui_story"

			if arg_115_1.actors_["10100ui_story"] == nil and not isNil((Asset.Load("Char/" .. "10100ui_story"))) then
				local var_118_4 = Object.Instantiate(Asset.Load("Char/" .. "10100ui_story"), arg_115_1.stage_.transform)

				var_118_4.name = var_118_3
				var_118_4.transform.localPosition = Vector3.New(0, 100, 0)
				arg_115_1.actors_[var_118_3] = var_118_4

				local var_118_5 = var_118_4:GetComponentInChildren(typeof(CharacterEffect))

				var_118_5.enabled = true

				local var_118_6 = GameObjectTools.GetOrAddComponent(var_118_4, typeof(DynamicBoneHelper))

				if var_118_6 then
					var_118_6:EnableDynamicBone(false)
				end

				arg_115_1:ShowWeapon(var_118_5.transform, false)

				arg_115_1.var_[var_118_3 .. "Animator"] = var_118_5.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_115_1.var_[var_118_3 .. "Animator"].applyRootMotion = true
				arg_115_1.var_[var_118_3 .. "LipSync"] = var_118_5.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_118_7 = arg_115_1.actors_["10100ui_story"].transform

			if 0 < arg_115_1.time_ and arg_115_1.time_ <= 0 + arg_118_0 then
				arg_115_1.var_.moveOldPos10100ui_story = var_118_7.localPosition
			end

			local var_118_8 = 0.001

			if 0 <= arg_115_1.time_ and arg_115_1.time_ < 0 + var_118_8 then
				var_118_7.localPosition = Vector3.Lerp(arg_115_1.var_.moveOldPos10100ui_story, Vector3.New(0.7, -1.16, -6.25), (arg_115_1.time_ - 0) / var_118_8)
			...
			if arg_115_1.time_ >= 0 + var_118_8 and arg_115_1.time_ < 0 + var_118_8 + arg_118_0 then
				var_118_7.localPosition = Vector3.New(0.7, -1.16, -6.25)
				var_118_7.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_118_7.position).x, (manager.ui.mainCamera.transform.position - var_118_7.position).y, (manager.ui.mainCamera.transform.position - var_118_7.position).z)
				var_118_7.localEulerAngles.z = 0
				var_118_7.localEulerAngles.x = 0
				var_118_7.localEulerAngles = var_118_7.localEulerAngles
			...
			local var_118_9 = arg_115_1.actors_["10100ui_story"]

			if 0 < arg_115_1.time_ and arg_115_1.time_ <= 0 + arg_118_0 and not isNil(var_118_9) and arg_115_1.var_.characterEffect10100ui_story == nil then
				arg_115_1.var_.characterEffect10100ui_story = var_118_9:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_118_10 = 0.200000002980232

			if 0 <= arg_115_1.time_ and arg_115_1.time_ < 0 + var_118_10 and not isNil(var_118_9) then
				if arg_115_1.var_.characterEffect10100ui_story and not isNil(var_118_9) then
					arg_115_1.var_.characterEffect10100ui_story.fillFlat = false
				end
			end

			if arg_115_1.time_ >= 0 + var_118_10 and arg_115_1.time_ < 0 + var_118_10 + arg_118_0 and not isNil(var_118_9) and arg_115_1.var_.characterEffect10100ui_story then
				arg_115_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_115_1.time_ and arg_115_1.time_ <= var_118_12 + arg_118_0 then
				...
				arg_115_1.leftNameTxt_.text = arg_115_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_118_14 = arg_115_1:GetWordFromCfg(320061028)
				...
				local var_118_17 = 15 <= 0 and var_118_13 or var_118_13 * (utf8.len(var_118_15) / 15)

				if (15 <= 0 and var_118_13 or var_118_13 * (utf8.len(var_118_15) / 15)) > 0 and var_118_13 < var_118_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061028", "story_v_out_320061.awb") ~= 0 then
					local var_118_18 = manager.audio:GetVoiceLength("story_v_out_320061", "320061028", "story_v_out_320061.awb") / 1000
					...
					if var_118_14.prefab_name ~= "" and arg_115_1.actors_[var_118_14.prefab_name] ~= nil then
						local var_118_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_115_1.actors_[var_118_14.prefab_name].transform, "story_v_out_320061", "320061028", "story_v_out_320061.awb")

						arg_115_1:RecordAudio("320061028", var_118_19)
						arg_115_1:RecordAudio("320061028", var_118_19)
					else
	...
	Play320061029 = function(arg_119_0, arg_119_1)
		...
		function arg_119_1.onSingleLineUpdate_(arg_122_0)
			...
			if 0 <= arg_119_1.time_ and arg_119_1.time_ < 0 + var_122_0 then
				arg_119_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_119_1.var_.moveOldPos1020ui_story, Vector3.New(-0.7, -0.85, -6.25), (arg_119_1.time_ - 0) / var_122_0)
			...
			if arg_119_1.time_ >= 0 + var_122_0 and arg_119_1.time_ < 0 + var_122_0 + arg_122_0 then
				arg_119_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(-0.7, -0.85, -6.25)
				arg_119_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_119_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_119_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_119_1.actors_["1020ui_story"].transform.position).z)
				arg_119_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_119_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_119_1.actors_["1020ui_story"].transform.localEulerAngles = arg_119_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_122_4 = arg_119_1.actors_["10100ui_story"]

			if 0 < arg_119_1.time_ and arg_119_1.time_ <= 0 + arg_122_0 and not isNil(var_122_4) and arg_119_1.var_.characterEffect10100ui_story == nil then
				arg_119_1.var_.characterEffect10100ui_story = var_122_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_122_5 = 0.200000002980232

			if 0 <= arg_119_1.time_ and arg_119_1.time_ < 0 + var_122_5 and not isNil(var_122_4) then
				if arg_119_1.var_.characterEffect10100ui_story and not isNil(var_122_4) then
					arg_119_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_119_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_119_1.time_ - 0) / var_122_5)
				end
			end

			if arg_119_1.time_ >= 0 + var_122_5 and arg_119_1.time_ < 0 + var_122_5 + arg_122_0 and not isNil(var_122_4) and arg_119_1.var_.characterEffect10100ui_story then
				arg_119_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_119_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_122_6 = 0
			local var_122_7 = 0.45
			...
			if 0 < arg_119_1.time_ and arg_119_1.time_ <= var_122_6 + arg_122_0 then
				...
				local var_122_8 = arg_119_1:GetWordFromCfg(320061029)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061029", "story_v_out_320061.awb") ~= 0 then
					local var_122_12 = manager.audio:GetVoiceLength("story_v_out_320061", "320061029", "story_v_out_320061.awb") / 1000
					...
					if var_122_8.prefab_name ~= "" and arg_119_1.actors_[var_122_8.prefab_name] ~= nil then
						local var_122_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_119_1.actors_[var_122_8.prefab_name].transform, "story_v_out_320061", "320061029", "story_v_out_320061.awb")

						arg_119_1:RecordAudio("320061029", var_122_13)
						arg_119_1:RecordAudio("320061029", var_122_13)
					else
	...
	Play320061030 = function(arg_123_0, arg_123_1)
		...
		function arg_123_1.onSingleLineUpdate_(arg_126_0)
			if 0 < arg_123_1.time_ and arg_123_1.time_ <= 0 + arg_126_0 then
				arg_123_1.var_.moveOldPos1020ui_story = arg_123_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_126_0 = 0.001

			if 0 <= arg_123_1.time_ and arg_123_1.time_ < 0 + var_126_0 then
				arg_123_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_123_1.var_.moveOldPos1020ui_story, Vector3.New(0, 100, 0), (arg_123_1.time_ - 0) / var_126_0)
				arg_123_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_123_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_123_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_123_1.actors_["1020ui_story"].transform.position).z)
				arg_123_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_123_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_123_1.actors_["1020ui_story"].transform.localEulerAngles = arg_123_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_123_1.time_ >= 0 + var_126_0 and arg_123_1.time_ < 0 + var_126_0 + arg_126_0 then
				arg_123_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_123_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_123_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_123_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_123_1.actors_["1020ui_story"].transform.position).z)
				arg_123_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_123_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_123_1.actors_["1020ui_story"].transform.localEulerAngles = arg_123_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_126_1 = arg_123_1.actors_["1020ui_story"]

			if 0 < arg_123_1.time_ and arg_123_1.time_ <= 0 + arg_126_0 and not isNil(var_126_1) and arg_123_1.var_.characterEffect1020ui_story == nil then
				arg_123_1.var_.characterEffect1020ui_story = var_126_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_126_2 = 0.200000002980232

			if 0 <= arg_123_1.time_ and arg_123_1.time_ < 0 + var_126_2 and not isNil(var_126_1) then
				if arg_123_1.var_.characterEffect1020ui_story and not isNil(var_126_1) then
					arg_123_1.var_.characterEffect1020ui_story.fillFlat = true
					arg_123_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_123_1.time_ - 0) / var_126_2)
				end
			end

			if arg_123_1.time_ >= 0 + var_126_2 and arg_123_1.time_ < 0 + var_126_2 + arg_126_0 and not isNil(var_126_1) and arg_123_1.var_.characterEffect1020ui_story then
				arg_123_1.var_.characterEffect1020ui_story.fillFlat = true
				arg_123_1.var_.characterEffect1020ui_story.fillRatio = 0.5
			end

			local var_126_3 = arg_123_1.actors_["10100ui_story"].transform

			if 0 < arg_123_1.time_ and arg_123_1.time_ <= 0 + arg_126_0 then
				arg_123_1.var_.moveOldPos10100ui_story = var_126_3.localPosition
			end

			local var_126_4 = 0.001

			if 0 <= arg_123_1.time_ and arg_123_1.time_ < 0 + var_126_4 then
				var_126_3.localPosition = Vector3.Lerp(arg_123_1.var_.moveOldPos10100ui_story, Vector3.New(0, 100, 0), (arg_123_1.time_ - 0) / var_126_4)
			...
			local var_126_5 = arg_123_1.actors_["10100ui_story"]

			if 0 < arg_123_1.time_ and arg_123_1.time_ <= 0 + arg_126_0 and not isNil(var_126_5) and arg_123_1.var_.characterEffect10100ui_story == nil then
				arg_123_1.var_.characterEffect10100ui_story = var_126_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_126_6 = 0.200000002980232

			if 0 <= arg_123_1.time_ and arg_123_1.time_ < 0 + var_126_6 and not isNil(var_126_5) then
				if arg_123_1.var_.characterEffect10100ui_story and not isNil(var_126_5) then
					arg_123_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_123_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_123_1.time_ - 0) / var_126_6)
				end
			end

			if arg_123_1.time_ >= 0 + var_126_6 and arg_123_1.time_ < 0 + var_126_6 + arg_126_0 and not isNil(var_126_5) and arg_123_1.var_.characterEffect10100ui_story then
				arg_123_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_123_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_123_1.time_ and arg_123_1.time_ <= var_126_7 + arg_126_0 then
				...
				local var_126_9 = arg_123_1:FormatText(arg_123_1:GetWordFromCfg(320061030).content)

				arg_123_1.text_.text = var_126_9

				LuaForUtil.ClearLinePrefixSymbol(arg_123_1.text_)

				local var_126_11 = 44 <= 0 and var_126_8 or var_126_8 * (utf8.len(var_126_9) / 44)

				if (44 <= 0 and var_126_8 or var_126_8 * (utf8.len(var_126_9) / 44)) > 0 and var_126_8 < var_126_11 then
	...
	Play320061031 = function(arg_127_0, arg_127_1)
		...
		function arg_127_1.onSingleLineUpdate_(arg_130_0)
			...
			if 0 < arg_127_1.time_ and arg_127_1.time_ <= 0 + arg_130_0 then
				...
				local var_130_1 = arg_127_1:FormatText(arg_127_1:GetWordFromCfg(320061031).content)
	...
	Play320061032 = function(arg_131_0, arg_131_1)
		...
		function arg_131_1.onSingleLineUpdate_(arg_134_0)
			...
			if 0 < arg_131_1.time_ and arg_131_1.time_ <= var_134_4 + arg_134_0 then
				...
				local var_134_6 = arg_131_1:GetWordFromCfg(320061032)
				...
				local var_134_9 = 4 <= 0 and var_134_5 or var_134_5 * (utf8.len(var_134_7) / 4)

				if (4 <= 0 and var_134_5 or var_134_5 * (utf8.len(var_134_7) / 4)) > 0 and var_134_5 < var_134_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061032", "story_v_out_320061.awb") ~= 0 then
					local var_134_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061032", "story_v_out_320061.awb") / 1000
					...
					if var_134_6.prefab_name ~= "" and arg_131_1.actors_[var_134_6.prefab_name] ~= nil then
						local var_134_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_131_1.actors_[var_134_6.prefab_name].transform, "story_v_out_320061", "320061032", "story_v_out_320061.awb")

						arg_131_1:RecordAudio("320061032", var_134_11)
						arg_131_1:RecordAudio("320061032", var_134_11)
					else
	...
	Play320061033 = function(arg_135_0, arg_135_1)
		...
		function arg_135_1.onSingleLineUpdate_(arg_138_0)
			if 0 < arg_135_1.time_ and arg_135_1.time_ <= 0 + arg_138_0 then
				arg_135_1.var_.moveOldPos1020ui_story = arg_135_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_138_0 = 0.001

			if 0 <= arg_135_1.time_ and arg_135_1.time_ < 0 + var_138_0 then
				arg_135_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_135_1.var_.moveOldPos1020ui_story, Vector3.New(0, 100, 0), (arg_135_1.time_ - 0) / var_138_0)
				arg_135_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_135_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_135_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_135_1.actors_["1020ui_story"].transform.position).z)
				arg_135_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_135_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_135_1.actors_["1020ui_story"].transform.localEulerAngles = arg_135_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_135_1.time_ >= 0 + var_138_0 and arg_135_1.time_ < 0 + var_138_0 + arg_138_0 then
				arg_135_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_135_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_135_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_135_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_135_1.actors_["1020ui_story"].transform.position).z)
				arg_135_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_135_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_135_1.actors_["1020ui_story"].transform.localEulerAngles = arg_135_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_138_1 = arg_135_1.actors_["1020ui_story"]

			if 0 < arg_135_1.time_ and arg_135_1.time_ <= 0 + arg_138_0 and not isNil(var_138_1) and arg_135_1.var_.characterEffect1020ui_story == nil then
				arg_135_1.var_.characterEffect1020ui_story = var_138_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_138_2 = 0.200000002980232

			if 0 <= arg_135_1.time_ and arg_135_1.time_ < 0 + var_138_2 and not isNil(var_138_1) then
				if arg_135_1.var_.characterEffect1020ui_story and not isNil(var_138_1) then
					arg_135_1.var_.characterEffect1020ui_story.fillFlat = true
					arg_135_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_135_1.time_ - 0) / var_138_2)
				end
			end

			if arg_135_1.time_ >= 0 + var_138_2 and arg_135_1.time_ < 0 + var_138_2 + arg_138_0 and not isNil(var_138_1) and arg_135_1.var_.characterEffect1020ui_story then
				arg_135_1.var_.characterEffect1020ui_story.fillFlat = true
			...
			if 0 < arg_135_1.time_ and arg_135_1.time_ <= var_138_3 + arg_138_0 then
				...
				local var_138_5 = arg_135_1:FormatText(arg_135_1:GetWordFromCfg(320061033).content)
	...
	Play320061034 = function(arg_139_0, arg_139_1)
		...
		function arg_139_1.onSingleLineUpdate_(arg_142_0)
			...
			if 0 < arg_139_1.time_ and arg_139_1.time_ <= 0 + arg_142_0 then
				...
				local var_142_1 = arg_139_1:FormatText(arg_139_1:GetWordFromCfg(320061034).content)

				arg_139_1.text_.text = var_142_1

				LuaForUtil.ClearLinePrefixSymbol(arg_139_1.text_)

				local var_142_3 = 53 <= 0 and var_142_0 or var_142_0 * (utf8.len(var_142_1) / 53)

				if (53 <= 0 and var_142_0 or var_142_0 * (utf8.len(var_142_1) / 53)) > 0 and var_142_0 < var_142_3 then
	...
	Play320061035 = function(arg_143_0, arg_143_1)
		...
		function arg_143_1.onSingleLineUpdate_(arg_146_0)
			...
			if 0 < arg_143_1.time_ and arg_143_1.time_ <= var_146_4 + arg_146_0 then
				...
				local var_146_6 = arg_143_1:GetWordFromCfg(320061035)
				...
				local var_146_9 = 6 <= 0 and var_146_5 or var_146_5 * (utf8.len(var_146_7) / 6)

				if (6 <= 0 and var_146_5 or var_146_5 * (utf8.len(var_146_7) / 6)) > 0 and var_146_5 < var_146_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061035", "story_v_out_320061.awb") ~= 0 then
					local var_146_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061035", "story_v_out_320061.awb") / 1000
					...
					if var_146_6.prefab_name ~= "" and arg_143_1.actors_[var_146_6.prefab_name] ~= nil then
						local var_146_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_143_1.actors_[var_146_6.prefab_name].transform, "story_v_out_320061", "320061035", "story_v_out_320061.awb")

						arg_143_1:RecordAudio("320061035", var_146_11)
						arg_143_1:RecordAudio("320061035", var_146_11)
					else
	...
	Play320061036 = function(arg_147_0, arg_147_1)
		...
		function arg_147_1.onSingleLineUpdate_(arg_150_0)
			...
			if 0 < arg_147_1.time_ and arg_147_1.time_ <= 0 + arg_150_0 then
				...
				local var_150_1 = arg_147_1:FormatText(arg_147_1:GetWordFromCfg(320061036).content)
	...
	Play320061037 = function(arg_151_0, arg_151_1)
		...
		function arg_151_1.onSingleLineUpdate_(arg_154_0)
			...
			if arg_151_1.time_ >= 0 + 0.5 and arg_151_1.time_ < 0 + 0.5 + arg_154_0 then
	...
	Play320061038 = function(arg_155_0, arg_155_1)
		...
		function arg_155_1.onSingleLineUpdate_(arg_158_0)
			...
			if 0 <= arg_155_1.time_ and arg_155_1.time_ < 0 + var_158_0 then
				arg_155_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_155_1.var_.moveOldPos1020ui_story, Vector3.New(0, -0.85, -6.25), (arg_155_1.time_ - 0) / var_158_0)
			...
			if arg_155_1.time_ >= 0 + var_158_0 and arg_155_1.time_ < 0 + var_158_0 + arg_158_0 then
				arg_155_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, -0.85, -6.25)
				arg_155_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_155_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_155_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_155_1.actors_["1020ui_story"].transform.position).z)
				arg_155_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_155_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_155_1.actors_["1020ui_story"].transform.localEulerAngles = arg_155_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_158_1 = arg_155_1.actors_["1020ui_story"]

			if 0 < arg_155_1.time_ and arg_155_1.time_ <= 0 + arg_158_0 and not isNil(var_158_1) and arg_155_1.var_.characterEffect1020ui_story == nil then
				arg_155_1.var_.characterEffect1020ui_story = var_158_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_158_2 = 0.200000002980232

			if 0 <= arg_155_1.time_ and arg_155_1.time_ < 0 + var_158_2 and not isNil(var_158_1) then
				if arg_155_1.var_.characterEffect1020ui_story and not isNil(var_158_1) then
					arg_155_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_155_1.time_ >= 0 + var_158_2 and arg_155_1.time_ < 0 + var_158_2 + arg_158_0 and not isNil(var_158_1) and arg_155_1.var_.characterEffect1020ui_story then
				arg_155_1.var_.characterEffect1020ui_story.fillFlat = false
			end

			local var_158_4 = "1020ui_story"

			if arg_155_1.actors_["1020ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1020ui_story"))) then
				local var_158_5 = Object.Instantiate(Asset.Load("Char/" .. "1020ui_story"), arg_155_1.stage_.transform)
			...
			local var_158_8 = "1020ui_story"

			if arg_155_1.actors_["1020ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1020ui_story"))) then
				local var_158_9 = Object.Instantiate(Asset.Load("Char/" .. "1020ui_story"), arg_155_1.stage_.transform)

				var_158_9.name = var_158_8
				var_158_9.transform.localPosition = Vector3.New(0, 100, 0)
				arg_155_1.actors_[var_158_8] = var_158_9

				local var_158_10 = var_158_9:GetComponentInChildren(typeof(CharacterEffect))

				var_158_10.enabled = true

				local var_158_11 = GameObjectTools.GetOrAddComponent(var_158_9, typeof(DynamicBoneHelper))

				if var_158_11 then
					var_158_11:EnableDynamicBone(false)
				end

				arg_155_1:ShowWeapon(var_158_10.transform, false)

				arg_155_1.var_[var_158_8 .. "Animator"] = var_158_10.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_155_1.var_[var_158_8 .. "Animator"].applyRootMotion = true
				arg_155_1.var_[var_158_8 .. "LipSync"] = var_158_10.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end
			...
			if 0 < arg_155_1.time_ and arg_155_1.time_ <= var_158_12 + arg_158_0 then
				...
				arg_155_1.leftNameTxt_.text = arg_155_1:FormatText(StoryNameCfg[613].name)
				...
				local var_158_14 = arg_155_1:GetWordFromCfg(320061038)
				...
				local var_158_17 = 26 <= 0 and var_158_13 or var_158_13 * (utf8.len(var_158_15) / 26)

				if (26 <= 0 and var_158_13 or var_158_13 * (utf8.len(var_158_15) / 26)) > 0 and var_158_13 < var_158_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061038", "story_v_out_320061.awb") ~= 0 then
					local var_158_18 = manager.audio:GetVoiceLength("story_v_out_320061", "320061038", "story_v_out_320061.awb") / 1000
					...
					if var_158_14.prefab_name ~= "" and arg_155_1.actors_[var_158_14.prefab_name] ~= nil then
						local var_158_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_155_1.actors_[var_158_14.prefab_name].transform, "story_v_out_320061", "320061038", "story_v_out_320061.awb")

						arg_155_1:RecordAudio("320061038", var_158_19)
						arg_155_1:RecordAudio("320061038", var_158_19)
					else
	...
	Play320061039 = function(arg_159_0, arg_159_1)
		...
		function arg_159_1.onSingleLineUpdate_(arg_162_0)
			if 0 < arg_159_1.time_ and arg_159_1.time_ <= 0 + arg_162_0 and not isNil(arg_159_1.actors_["1020ui_story"]) and arg_159_1.var_.characterEffect1020ui_story == nil then
				arg_159_1.var_.characterEffect1020ui_story = arg_159_1.actors_["1020ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_162_0 = 0.200000002980232

			if 0 <= arg_159_1.time_ and arg_159_1.time_ < 0 + var_162_0 and not isNil(arg_159_1.actors_["1020ui_story"]) then
				if arg_159_1.var_.characterEffect1020ui_story and not isNil(arg_159_1.actors_["1020ui_story"]) then
					arg_159_1.var_.characterEffect1020ui_story.fillFlat = true
					arg_159_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_159_1.time_ - 0) / var_162_0)
				end
			end

			if arg_159_1.time_ >= 0 + var_162_0 and arg_159_1.time_ < 0 + var_162_0 + arg_162_0 and not isNil(arg_159_1.actors_["1020ui_story"]) and arg_159_1.var_.characterEffect1020ui_story then
				arg_159_1.var_.characterEffect1020ui_story.fillFlat = true
			...
			if 0 < arg_159_1.time_ and arg_159_1.time_ <= var_162_1 + arg_162_0 then
				...
				local var_162_3 = arg_159_1:FormatText(arg_159_1:GetWordFromCfg(320061039).content)
	...
	Play320061040 = function(arg_163_0, arg_163_1)
		...
		function arg_163_1.onSingleLineUpdate_(arg_166_0)
			if 0 < arg_163_1.time_ and arg_163_1.time_ <= 0 + arg_166_0 then
				arg_163_1.var_.moveOldPos1020ui_story = arg_163_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_166_0 = 0.001

			if 0 <= arg_163_1.time_ and arg_163_1.time_ < 0 + var_166_0 then
				arg_163_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_163_1.var_.moveOldPos1020ui_story, Vector3.New(0, -0.85, -6.25), (arg_163_1.time_ - 0) / var_166_0)
				arg_163_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_163_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_163_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_163_1.actors_["1020ui_story"].transform.position).z)
				arg_163_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_163_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_163_1.actors_["1020ui_story"].transform.localEulerAngles = arg_163_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_163_1.time_ >= 0 + var_166_0 and arg_163_1.time_ < 0 + var_166_0 + arg_166_0 then
				arg_163_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, -0.85, -6.25)
				arg_163_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_163_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_163_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_163_1.actors_["1020ui_story"].transform.position).z)
				arg_163_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_163_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_163_1.actors_["1020ui_story"].transform.localEulerAngles = arg_163_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_166_1 = arg_163_1.actors_["1020ui_story"]

			if 0 < arg_163_1.time_ and arg_163_1.time_ <= 0 + arg_166_0 and not isNil(var_166_1) and arg_163_1.var_.characterEffect1020ui_story == nil then
				arg_163_1.var_.characterEffect1020ui_story = var_166_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_166_2 = 0.200000002980232

			if 0 <= arg_163_1.time_ and arg_163_1.time_ < 0 + var_166_2 and not isNil(var_166_1) then
				if arg_163_1.var_.characterEffect1020ui_story and not isNil(var_166_1) then
					arg_163_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_163_1.time_ >= 0 + var_166_2 and arg_163_1.time_ < 0 + var_166_2 + arg_166_0 and not isNil(var_166_1) and arg_163_1.var_.characterEffect1020ui_story then
				arg_163_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			if 0 < arg_163_1.time_ and arg_163_1.time_ <= var_166_4 + arg_166_0 then
				...
				local var_166_6 = arg_163_1:GetWordFromCfg(320061040)
				...
				local var_166_9 = 31 <= 0 and var_166_5 or var_166_5 * (utf8.len(var_166_7) / 31)

				if (31 <= 0 and var_166_5 or var_166_5 * (utf8.len(var_166_7) / 31)) > 0 and var_166_5 < var_166_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061040", "story_v_out_320061.awb") ~= 0 then
					local var_166_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061040", "story_v_out_320061.awb") / 1000
					...
					if var_166_6.prefab_name ~= "" and arg_163_1.actors_[var_166_6.prefab_name] ~= nil then
						local var_166_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_163_1.actors_[var_166_6.prefab_name].transform, "story_v_out_320061", "320061040", "story_v_out_320061.awb")

						arg_163_1:RecordAudio("320061040", var_166_11)
						arg_163_1:RecordAudio("320061040", var_166_11)
					else
	...
	Play320061041 = function(arg_167_0, arg_167_1)
		...
		function arg_167_1.onSingleLineUpdate_(arg_170_0)
			if 0 < arg_167_1.time_ and arg_167_1.time_ <= 0 + arg_170_0 then
				arg_167_1.var_.moveOldPos1020ui_story = arg_167_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_170_0 = 0.001

			if 0 <= arg_167_1.time_ and arg_167_1.time_ < 0 + var_170_0 then
				arg_167_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_167_1.var_.moveOldPos1020ui_story, Vector3.New(0, -0.85, -6.25), (arg_167_1.time_ - 0) / var_170_0)
				arg_167_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_167_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_167_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_167_1.actors_["1020ui_story"].transform.position).z)
				arg_167_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_167_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_167_1.actors_["1020ui_story"].transform.localEulerAngles = arg_167_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_167_1.time_ >= 0 + var_170_0 and arg_167_1.time_ < 0 + var_170_0 + arg_170_0 then
				arg_167_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, -0.85, -6.25)
				arg_167_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_167_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_167_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_167_1.actors_["1020ui_story"].transform.position).z)
				arg_167_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_167_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_167_1.actors_["1020ui_story"].transform.localEulerAngles = arg_167_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_170_1 = arg_167_1.actors_["1020ui_story"]

			if 0 < arg_167_1.time_ and arg_167_1.time_ <= 0 + arg_170_0 and not isNil(var_170_1) and arg_167_1.var_.characterEffect1020ui_story == nil then
				arg_167_1.var_.characterEffect1020ui_story = var_170_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_170_2 = 0.200000002980232

			if 0 <= arg_167_1.time_ and arg_167_1.time_ < 0 + var_170_2 and not isNil(var_170_1) then
				if arg_167_1.var_.characterEffect1020ui_story and not isNil(var_170_1) then
					arg_167_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_167_1.time_ >= 0 + var_170_2 and arg_167_1.time_ < 0 + var_170_2 + arg_170_0 and not isNil(var_170_1) and arg_167_1.var_.characterEffect1020ui_story then
				arg_167_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			if 0 < arg_167_1.time_ and arg_167_1.time_ <= var_170_4 + arg_170_0 then
				...
				local var_170_6 = arg_167_1:GetWordFromCfg(320061041)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061041", "story_v_out_320061.awb") ~= 0 then
					local var_170_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061041", "story_v_out_320061.awb") / 1000
					...
					if var_170_6.prefab_name ~= "" and arg_167_1.actors_[var_170_6.prefab_name] ~= nil then
						local var_170_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_167_1.actors_[var_170_6.prefab_name].transform, "story_v_out_320061", "320061041", "story_v_out_320061.awb")

						arg_167_1:RecordAudio("320061041", var_170_11)
						arg_167_1:RecordAudio("320061041", var_170_11)
					else
	...
	Play320061042 = function(arg_171_0, arg_171_1)
		...
		function arg_171_1.onSingleLineUpdate_(arg_174_0)
			...
			if 0 <= arg_171_1.time_ and arg_171_1.time_ < 0 + var_174_0 then
				arg_171_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_171_1.var_.moveOldPos1020ui_story, Vector3.New(-0.7, -0.85, -6.25), (arg_171_1.time_ - 0) / var_174_0)
			...
			if arg_171_1.time_ >= 0 + var_174_0 and arg_171_1.time_ < 0 + var_174_0 + arg_174_0 then
				arg_171_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(-0.7, -0.85, -6.25)
				arg_171_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_171_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_171_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_171_1.actors_["1020ui_story"].transform.position).z)
				arg_171_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_171_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_171_1.actors_["1020ui_story"].transform.localEulerAngles = arg_171_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_171_1.time_ and arg_171_1.time_ < 0 + var_174_2 and not isNil(var_174_1) then
				if arg_171_1.var_.characterEffect1020ui_story and not isNil(var_174_1) then
					...
					arg_171_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_171_1.time_ - 0) / var_174_2)
				end
			end
			...
			if arg_171_1.time_ >= 0 + var_174_2 and arg_171_1.time_ < 0 + var_174_2 + arg_174_0 and not isNil(var_174_1) and arg_171_1.var_.characterEffect1020ui_story then
				arg_171_1.var_.characterEffect1020ui_story.fillFlat = true
				arg_171_1.var_.characterEffect1020ui_story.fillRatio = 0.5
			end

			local var_174_3 = arg_171_1.actors_["10100ui_story"].transform

			if 0 < arg_171_1.time_ and arg_171_1.time_ <= 0 + arg_174_0 then
				arg_171_1.var_.moveOldPos10100ui_story = var_174_3.localPosition
			end

			local var_174_4 = 0.001

			if 0 <= arg_171_1.time_ and arg_171_1.time_ < 0 + var_174_4 then
				var_174_3.localPosition = Vector3.Lerp(arg_171_1.var_.moveOldPos10100ui_story, Vector3.New(0.7, -1.16, -6.25), (arg_171_1.time_ - 0) / var_174_4)
			...
			if arg_171_1.time_ >= 0 + var_174_4 and arg_171_1.time_ < 0 + var_174_4 + arg_174_0 then
				var_174_3.localPosition = Vector3.New(0.7, -1.16, -6.25)
				var_174_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_174_3.position).x, (manager.ui.mainCamera.transform.position - var_174_3.position).y, (manager.ui.mainCamera.transform.position - var_174_3.position).z)
				var_174_3.localEulerAngles.z = 0
				var_174_3.localEulerAngles.x = 0
				var_174_3.localEulerAngles = var_174_3.localEulerAngles
			...
			local var_174_5 = arg_171_1.actors_["10100ui_story"]

			if 0 < arg_171_1.time_ and arg_171_1.time_ <= 0 + arg_174_0 and not isNil(var_174_5) and arg_171_1.var_.characterEffect10100ui_story == nil then
				arg_171_1.var_.characterEffect10100ui_story = var_174_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_174_6 = 0.200000002980232

			if 0 <= arg_171_1.time_ and arg_171_1.time_ < 0 + var_174_6 and not isNil(var_174_5) then
				if arg_171_1.var_.characterEffect10100ui_story and not isNil(var_174_5) then
					arg_171_1.var_.characterEffect10100ui_story.fillFlat = false
				end
			end

			if arg_171_1.time_ >= 0 + var_174_6 and arg_171_1.time_ < 0 + var_174_6 + arg_174_0 and not isNil(var_174_5) and arg_171_1.var_.characterEffect10100ui_story then
				arg_171_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_171_1.time_ and arg_171_1.time_ <= var_174_8 + arg_174_0 then
				...
				arg_171_1.leftNameTxt_.text = arg_171_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_174_10 = arg_171_1:GetWordFromCfg(320061042)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061042", "story_v_out_320061.awb") ~= 0 then
					local var_174_14 = manager.audio:GetVoiceLength("story_v_out_320061", "320061042", "story_v_out_320061.awb") / 1000
					...
					if var_174_10.prefab_name ~= "" and arg_171_1.actors_[var_174_10.prefab_name] ~= nil then
						local var_174_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_171_1.actors_[var_174_10.prefab_name].transform, "story_v_out_320061", "320061042", "story_v_out_320061.awb")

						arg_171_1:RecordAudio("320061042", var_174_15)
						arg_171_1:RecordAudio("320061042", var_174_15)
					else
	...
	Play320061043 = function(arg_175_0, arg_175_1)
		...
		function arg_175_1.onSingleLineUpdate_(arg_178_0)
			if 0 < arg_175_1.time_ and arg_175_1.time_ <= 0 + arg_178_0 then
				arg_175_1.var_.moveOldPos1020ui_story = arg_175_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_178_0 = 0.001

			if 0 <= arg_175_1.time_ and arg_175_1.time_ < 0 + var_178_0 then
				arg_175_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_175_1.var_.moveOldPos1020ui_story, Vector3.New(0, 100, 0), (arg_175_1.time_ - 0) / var_178_0)
				arg_175_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_175_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_175_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_175_1.actors_["1020ui_story"].transform.position).z)
				arg_175_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_175_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_175_1.actors_["1020ui_story"].transform.localEulerAngles = arg_175_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_175_1.time_ >= 0 + var_178_0 and arg_175_1.time_ < 0 + var_178_0 + arg_178_0 then
				arg_175_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_175_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_175_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_175_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_175_1.actors_["1020ui_story"].transform.position).z)
				arg_175_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_175_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_175_1.actors_["1020ui_story"].transform.localEulerAngles = arg_175_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_178_1 = arg_175_1.actors_["1020ui_story"]

			if 0 < arg_175_1.time_ and arg_175_1.time_ <= 0 + arg_178_0 and not isNil(var_178_1) and arg_175_1.var_.characterEffect1020ui_story == nil then
				arg_175_1.var_.characterEffect1020ui_story = var_178_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_178_2 = 0.200000002980232

			if 0 <= arg_175_1.time_ and arg_175_1.time_ < 0 + var_178_2 and not isNil(var_178_1) then
				if arg_175_1.var_.characterEffect1020ui_story and not isNil(var_178_1) then
					arg_175_1.var_.characterEffect1020ui_story.fillFlat = true
					arg_175_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_175_1.time_ - 0) / var_178_2)
				end
			end

			if arg_175_1.time_ >= 0 + var_178_2 and arg_175_1.time_ < 0 + var_178_2 + arg_178_0 and not isNil(var_178_1) and arg_175_1.var_.characterEffect1020ui_story then
				arg_175_1.var_.characterEffect1020ui_story.fillFlat = true
				arg_175_1.var_.characterEffect1020ui_story.fillRatio = 0.5
			end

			local var_178_3 = arg_175_1.actors_["10100ui_story"].transform

			if 0 < arg_175_1.time_ and arg_175_1.time_ <= 0 + arg_178_0 then
				arg_175_1.var_.moveOldPos10100ui_story = var_178_3.localPosition
			end

			local var_178_4 = 0.001

			if 0 <= arg_175_1.time_ and arg_175_1.time_ < 0 + var_178_4 then
				var_178_3.localPosition = Vector3.Lerp(arg_175_1.var_.moveOldPos10100ui_story, Vector3.New(0, 100, 0), (arg_175_1.time_ - 0) / var_178_4)
			...
			local var_178_5 = arg_175_1.actors_["10100ui_story"]

			if 0 < arg_175_1.time_ and arg_175_1.time_ <= 0 + arg_178_0 and not isNil(var_178_5) and arg_175_1.var_.characterEffect10100ui_story == nil then
				arg_175_1.var_.characterEffect10100ui_story = var_178_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_178_6 = 0.200000002980232

			if 0 <= arg_175_1.time_ and arg_175_1.time_ < 0 + var_178_6 and not isNil(var_178_5) then
				if arg_175_1.var_.characterEffect10100ui_story and not isNil(var_178_5) then
					arg_175_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_175_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_175_1.time_ - 0) / var_178_6)
				end
			end

			if arg_175_1.time_ >= 0 + var_178_6 and arg_175_1.time_ < 0 + var_178_6 + arg_178_0 and not isNil(var_178_5) and arg_175_1.var_.characterEffect10100ui_story then
				arg_175_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_175_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_175_1.time_ and arg_175_1.time_ <= var_178_7 + arg_178_0 then
				...
				local var_178_9 = arg_175_1:FormatText(arg_175_1:GetWordFromCfg(320061043).content)
	...
	Play320061044 = function(arg_179_0, arg_179_1)
		...
		function arg_179_1.onSingleLineUpdate_(arg_182_0)
			...
			if 0 < arg_179_1.time_ and arg_179_1.time_ <= 0 + arg_182_0 then
				...
				local var_182_1 = arg_179_1:FormatText(arg_179_1:GetWordFromCfg(320061044).content)
	...
	Play320061045 = function(arg_183_0, arg_183_1)
		...
		function arg_183_1.onSingleLineUpdate_(arg_186_0)
			if 0 < arg_183_1.time_ and arg_183_1.time_ <= 0 + arg_186_0 then
				arg_183_1.var_.moveOldPos1020ui_story = arg_183_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_186_0 = 0.001

			if 0 <= arg_183_1.time_ and arg_183_1.time_ < 0 + var_186_0 then
				arg_183_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_183_1.var_.moveOldPos1020ui_story, Vector3.New(0, -0.85, -6.25), (arg_183_1.time_ - 0) / var_186_0)
				arg_183_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_183_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_183_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_183_1.actors_["1020ui_story"].transform.position).z)
				arg_183_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_183_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_183_1.actors_["1020ui_story"].transform.localEulerAngles = arg_183_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_183_1.time_ >= 0 + var_186_0 and arg_183_1.time_ < 0 + var_186_0 + arg_186_0 then
				arg_183_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, -0.85, -6.25)
				arg_183_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_183_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_183_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_183_1.actors_["1020ui_story"].transform.position).z)
				arg_183_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_183_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_183_1.actors_["1020ui_story"].transform.localEulerAngles = arg_183_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_186_1 = arg_183_1.actors_["1020ui_story"]

			if 0 < arg_183_1.time_ and arg_183_1.time_ <= 0 + arg_186_0 and not isNil(var_186_1) and arg_183_1.var_.characterEffect1020ui_story == nil then
				arg_183_1.var_.characterEffect1020ui_story = var_186_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_186_2 = 0.200000002980232

			if 0 <= arg_183_1.time_ and arg_183_1.time_ < 0 + var_186_2 and not isNil(var_186_1) then
				if arg_183_1.var_.characterEffect1020ui_story and not isNil(var_186_1) then
					arg_183_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_183_1.time_ >= 0 + var_186_2 and arg_183_1.time_ < 0 + var_186_2 + arg_186_0 and not isNil(var_186_1) and arg_183_1.var_.characterEffect1020ui_story then
				arg_183_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			if 0 < arg_183_1.time_ and arg_183_1.time_ <= var_186_4 + arg_186_0 then
				...
				local var_186_6 = arg_183_1:GetWordFromCfg(320061045)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061045", "story_v_out_320061.awb") ~= 0 then
					local var_186_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061045", "story_v_out_320061.awb") / 1000
					...
					if var_186_6.prefab_name ~= "" and arg_183_1.actors_[var_186_6.prefab_name] ~= nil then
						local var_186_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_183_1.actors_[var_186_6.prefab_name].transform, "story_v_out_320061", "320061045", "story_v_out_320061.awb")

						arg_183_1:RecordAudio("320061045", var_186_11)
						arg_183_1:RecordAudio("320061045", var_186_11)
					else
	...
	Play320061046 = function(arg_187_0, arg_187_1)
		...
		function arg_187_1.onSingleLineUpdate_(arg_190_0)
			...
			if 0 < arg_187_1.time_ and arg_187_1.time_ <= var_190_1 + arg_190_0 then
				...
				local var_190_3 = arg_187_1:FormatText(arg_187_1:GetWordFromCfg(320061046).content)

				arg_187_1.text_.text = var_190_3

				LuaForUtil.ClearLinePrefixSymbol(arg_187_1.text_)

				local var_190_5 = 28 <= 0 and var_190_2 or var_190_2 * (utf8.len(var_190_3) / 28)

				if (28 <= 0 and var_190_2 or var_190_2 * (utf8.len(var_190_3) / 28)) > 0 and var_190_2 < var_190_5 then
	...
	Play320061047 = function(arg_191_0, arg_191_1)
		...
		function arg_191_1.onSingleLineUpdate_(arg_194_0)
			...
			if 0 < arg_191_1.time_ and arg_191_1.time_ <= var_194_2 + arg_194_0 then
				...
				local var_194_4 = arg_191_1:GetWordFromCfg(320061047)
				...
				local var_194_7 = 32 <= 0 and var_194_3 or var_194_3 * (utf8.len(var_194_5) / 32)

				if (32 <= 0 and var_194_3 or var_194_3 * (utf8.len(var_194_5) / 32)) > 0 and var_194_3 < var_194_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061047", "story_v_out_320061.awb") ~= 0 then
					local var_194_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061047", "story_v_out_320061.awb") / 1000
					...
					if var_194_4.prefab_name ~= "" and arg_191_1.actors_[var_194_4.prefab_name] ~= nil then
						local var_194_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_191_1.actors_[var_194_4.prefab_name].transform, "story_v_out_320061", "320061047", "story_v_out_320061.awb")

						arg_191_1:RecordAudio("320061047", var_194_9)
						arg_191_1:RecordAudio("320061047", var_194_9)
					else
	...
	Play320061048 = function(arg_195_0, arg_195_1)
		...
		function arg_195_1.onSingleLineUpdate_(arg_198_0)
			...
			if 0 < arg_195_1.time_ and arg_195_1.time_ <= var_198_1 + arg_198_0 then
				...
				local var_198_3 = arg_195_1:FormatText(arg_195_1:GetWordFromCfg(320061048).content)
	...
	Play320061049 = function(arg_199_0, arg_199_1)
		...
		function arg_199_1.onSingleLineUpdate_(arg_202_0)
			...
			if 0 < arg_199_1.time_ and arg_199_1.time_ <= var_202_2 + arg_202_0 then
				...
				local var_202_4 = arg_199_1:GetWordFromCfg(320061049)
				...
				local var_202_7 = 22 <= 0 and var_202_3 or var_202_3 * (utf8.len(var_202_5) / 22)

				if (22 <= 0 and var_202_3 or var_202_3 * (utf8.len(var_202_5) / 22)) > 0 and var_202_3 < var_202_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061049", "story_v_out_320061.awb") ~= 0 then
					local var_202_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061049", "story_v_out_320061.awb") / 1000
					...
					if var_202_4.prefab_name ~= "" and arg_199_1.actors_[var_202_4.prefab_name] ~= nil then
						local var_202_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_199_1.actors_[var_202_4.prefab_name].transform, "story_v_out_320061", "320061049", "story_v_out_320061.awb")

						arg_199_1:RecordAudio("320061049", var_202_9)
						arg_199_1:RecordAudio("320061049", var_202_9)
					else
	...
	Play320061050 = function(arg_203_0, arg_203_1)
		...
		function arg_203_1.onSingleLineUpdate_(arg_206_0)
			...
			if 0 < arg_203_1.time_ and arg_203_1.time_ <= var_206_1 + arg_206_0 then
				...
				local var_206_3 = arg_203_1:FormatText(arg_203_1:GetWordFromCfg(320061050).content)

				arg_203_1.text_.text = var_206_3

				LuaForUtil.ClearLinePrefixSymbol(arg_203_1.text_)

				local var_206_5 = 5 <= 0 and var_206_2 or var_206_2 * (utf8.len(var_206_3) / 5)

				if (5 <= 0 and var_206_2 or var_206_2 * (utf8.len(var_206_3) / 5)) > 0 and var_206_2 < var_206_5 then
	...
	Play320061051 = function(arg_207_0, arg_207_1)
		...
		function arg_207_1.onSingleLineUpdate_(arg_210_0)
			...
			if 0 < arg_207_1.time_ and arg_207_1.time_ <= var_210_2 + arg_210_0 then
				...
				local var_210_4 = arg_207_1:GetWordFromCfg(320061051)
				...
				local var_210_7 = 19 <= 0 and var_210_3 or var_210_3 * (utf8.len(var_210_5) / 19)

				if (19 <= 0 and var_210_3 or var_210_3 * (utf8.len(var_210_5) / 19)) > 0 and var_210_3 < var_210_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061051", "story_v_out_320061.awb") ~= 0 then
					local var_210_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061051", "story_v_out_320061.awb") / 1000
					...
					if var_210_4.prefab_name ~= "" and arg_207_1.actors_[var_210_4.prefab_name] ~= nil then
						local var_210_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_207_1.actors_[var_210_4.prefab_name].transform, "story_v_out_320061", "320061051", "story_v_out_320061.awb")

						arg_207_1:RecordAudio("320061051", var_210_9)
						arg_207_1:RecordAudio("320061051", var_210_9)
					else
	...
	Play320061052 = function(arg_211_0, arg_211_1)
		...
		function arg_211_1.onSingleLineUpdate_(arg_214_0)
			...
			if 0 < arg_211_1.time_ and arg_211_1.time_ <= var_214_0 + arg_214_0 then
				...
				local var_214_2 = arg_211_1:GetWordFromCfg(320061052)
				...
				local var_214_5 = 33 <= 0 and var_214_1 or var_214_1 * (utf8.len(var_214_3) / 33)

				if (33 <= 0 and var_214_1 or var_214_1 * (utf8.len(var_214_3) / 33)) > 0 and var_214_1 < var_214_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061052", "story_v_out_320061.awb") ~= 0 then
					local var_214_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061052", "story_v_out_320061.awb") / 1000
					...
					if var_214_2.prefab_name ~= "" and arg_211_1.actors_[var_214_2.prefab_name] ~= nil then
						local var_214_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_211_1.actors_[var_214_2.prefab_name].transform, "story_v_out_320061", "320061052", "story_v_out_320061.awb")

						arg_211_1:RecordAudio("320061052", var_214_7)
						arg_211_1:RecordAudio("320061052", var_214_7)
					else
	...
	Play320061053 = function(arg_215_0, arg_215_1)
		...
		function arg_215_1.onSingleLineUpdate_(arg_218_0)
			...
			if 0 < arg_215_1.time_ and arg_215_1.time_ <= var_218_1 + arg_218_0 then
				...
				local var_218_3 = arg_215_1:FormatText(arg_215_1:GetWordFromCfg(320061053).content)

				arg_215_1.text_.text = var_218_3

				LuaForUtil.ClearLinePrefixSymbol(arg_215_1.text_)

				local var_218_5 = 68 <= 0 and var_218_2 or var_218_2 * (utf8.len(var_218_3) / 68)

				if (68 <= 0 and var_218_2 or var_218_2 * (utf8.len(var_218_3) / 68)) > 0 and var_218_2 < var_218_5 then
	...
	Play320061054 = function(arg_219_0, arg_219_1)
		...
		function arg_219_1.onSingleLineUpdate_(arg_222_0)
			...
			if 0 < arg_219_1.time_ and arg_219_1.time_ <= var_222_2 + arg_222_0 then
				...
				local var_222_4 = arg_219_1:GetWordFromCfg(320061054)
				...
				local var_222_7 = 25 <= 0 and var_222_3 or var_222_3 * (utf8.len(var_222_5) / 25)

				if (25 <= 0 and var_222_3 or var_222_3 * (utf8.len(var_222_5) / 25)) > 0 and var_222_3 < var_222_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061054", "story_v_out_320061.awb") ~= 0 then
					local var_222_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061054", "story_v_out_320061.awb") / 1000
					...
					if var_222_4.prefab_name ~= "" and arg_219_1.actors_[var_222_4.prefab_name] ~= nil then
						local var_222_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_219_1.actors_[var_222_4.prefab_name].transform, "story_v_out_320061", "320061054", "story_v_out_320061.awb")

						arg_219_1:RecordAudio("320061054", var_222_9)
						arg_219_1:RecordAudio("320061054", var_222_9)
					else
	...
	Play320061055 = function(arg_223_0, arg_223_1)
		...
		function arg_223_1.onSingleLineUpdate_(arg_226_0)
			...
			if 0 < arg_223_1.time_ and arg_223_1.time_ <= var_226_1 + arg_226_0 then
				...
				local var_226_3 = arg_223_1:FormatText(arg_223_1:GetWordFromCfg(320061055).content)

				arg_223_1.text_.text = var_226_3

				LuaForUtil.ClearLinePrefixSymbol(arg_223_1.text_)

				local var_226_5 = 41 <= 0 and var_226_2 or var_226_2 * (utf8.len(var_226_3) / 41)

				if (41 <= 0 and var_226_2 or var_226_2 * (utf8.len(var_226_3) / 41)) > 0 and var_226_2 < var_226_5 then
	...
	Play320061056 = function(arg_227_0, arg_227_1)
		...
		function arg_227_1.onSingleLineUpdate_(arg_230_0)
			if 0 < arg_227_1.time_ and arg_227_1.time_ <= 0 + arg_230_0 and not isNil(arg_227_1.actors_["1020ui_story"]) and arg_227_1.var_.characterEffect1020ui_story == nil then
				arg_227_1.var_.characterEffect1020ui_story = arg_227_1.actors_["1020ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_230_0 = 0.200000002980232

			if 0 <= arg_227_1.time_ and arg_227_1.time_ < 0 + var_230_0 and not isNil(arg_227_1.actors_["1020ui_story"]) then
				if arg_227_1.var_.characterEffect1020ui_story and not isNil(arg_227_1.actors_["1020ui_story"]) then
					arg_227_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_227_1.time_ >= 0 + var_230_0 and arg_227_1.time_ < 0 + var_230_0 + arg_230_0 and not isNil(arg_227_1.actors_["1020ui_story"]) and arg_227_1.var_.characterEffect1020ui_story then
				arg_227_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			if 0 < arg_227_1.time_ and arg_227_1.time_ <= var_230_2 + arg_230_0 then
				...
				local var_230_4 = arg_227_1:GetWordFromCfg(320061056)
				...
				local var_230_7 = 15 <= 0 and var_230_3 or var_230_3 * (utf8.len(var_230_5) / 15)

				if (15 <= 0 and var_230_3 or var_230_3 * (utf8.len(var_230_5) / 15)) > 0 and var_230_3 < var_230_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061056", "story_v_out_320061.awb") ~= 0 then
					local var_230_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061056", "story_v_out_320061.awb") / 1000
					...
					if var_230_4.prefab_name ~= "" and arg_227_1.actors_[var_230_4.prefab_name] ~= nil then
						local var_230_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_227_1.actors_[var_230_4.prefab_name].transform, "story_v_out_320061", "320061056", "story_v_out_320061.awb")

						arg_227_1:RecordAudio("320061056", var_230_9)
						arg_227_1:RecordAudio("320061056", var_230_9)
					else
	...
	Play320061057 = function(arg_231_0, arg_231_1)
		...
		function arg_231_1.onSingleLineUpdate_(arg_234_0)
			...
			if 0 < arg_231_1.time_ and arg_231_1.time_ <= var_234_1 + arg_234_0 then
				...
				local var_234_3 = arg_231_1:FormatText(arg_231_1:GetWordFromCfg(320061057).content)
	...
	Play320061058 = function(arg_235_0, arg_235_1)
		...
		function arg_235_1.onSingleLineUpdate_(arg_238_0)
			...
			if 0 < arg_235_1.time_ and arg_235_1.time_ <= var_238_2 + arg_238_0 then
				...
				local var_238_4 = arg_235_1:GetWordFromCfg(320061058)
				...
				local var_238_7 = 48 <= 0 and var_238_3 or var_238_3 * (utf8.len(var_238_5) / 48)

				if (48 <= 0 and var_238_3 or var_238_3 * (utf8.len(var_238_5) / 48)) > 0 and var_238_3 < var_238_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061058", "story_v_out_320061.awb") ~= 0 then
					local var_238_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061058", "story_v_out_320061.awb") / 1000
					...
					if var_238_4.prefab_name ~= "" and arg_235_1.actors_[var_238_4.prefab_name] ~= nil then
						local var_238_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_235_1.actors_[var_238_4.prefab_name].transform, "story_v_out_320061", "320061058", "story_v_out_320061.awb")

						arg_235_1:RecordAudio("320061058", var_238_9)
						arg_235_1:RecordAudio("320061058", var_238_9)
					else
	...
	Play320061059 = function(arg_239_0, arg_239_1)
		...
		function arg_239_1.onSingleLineUpdate_(arg_242_0)
			...
			if 0 < arg_239_1.time_ and arg_239_1.time_ <= 0 + arg_242_0 then
				...
				local var_242_1 = arg_239_1:GetWordFromCfg(320061059)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061059", "story_v_out_320061.awb") ~= 0 then
					local var_242_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061059", "story_v_out_320061.awb") / 1000
					...
					if var_242_1.prefab_name ~= "" and arg_239_1.actors_[var_242_1.prefab_name] ~= nil then
						local var_242_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_239_1.actors_[var_242_1.prefab_name].transform, "story_v_out_320061", "320061059", "story_v_out_320061.awb")

						arg_239_1:RecordAudio("320061059", var_242_6)
						arg_239_1:RecordAudio("320061059", var_242_6)
					else
	...
	Play320061060 = function(arg_243_0, arg_243_1)
		...
		function arg_243_1.onSingleLineUpdate_(arg_246_0)
			if 2 < arg_243_1.time_ and arg_243_1.time_ <= 2 + arg_246_0 then
				local var_246_0 = arg_243_1.bgs_.ST61

				arg_243_1.bgs_.ST61.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 4 < arg_243_1.time_ and arg_243_1.time_ <= var_246_3 + arg_246_0 then
			...
			local var_246_12 = arg_243_1.actors_["1020ui_story"].transform

			if 1.96599999815226 < arg_243_1.time_ and arg_243_1.time_ <= 1.96599999815226 + arg_246_0 then
				arg_243_1.var_.moveOldPos1020ui_story = var_246_12.localPosition
			end

			local var_246_13 = 0.001

			if 1.96599999815226 <= arg_243_1.time_ and arg_243_1.time_ < 1.96599999815226 + var_246_13 then
				var_246_12.localPosition = Vector3.Lerp(arg_243_1.var_.moveOldPos1020ui_story, Vector3.New(0, 100, 0), (arg_243_1.time_ - 1.96599999815226) / var_246_13)
			...
			local var_246_14 = arg_243_1.actors_["1020ui_story"]

			if 1.96599999815226 < arg_243_1.time_ and arg_243_1.time_ <= 1.96599999815226 + arg_246_0 and not isNil(var_246_14) and arg_243_1.var_.characterEffect1020ui_story == nil then
				arg_243_1.var_.characterEffect1020ui_story = var_246_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 1.96599999815226 <= arg_243_1.time_ and arg_243_1.time_ < 1.96599999815226 + var_246_15 and not isNil(var_246_14) then
				if arg_243_1.var_.characterEffect1020ui_story and not isNil(var_246_14) then
					arg_243_1.var_.characterEffect1020ui_story.fillFlat = true
					arg_243_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_243_1.time_ - 1.96599999815226) / var_246_15)
				end
			end

			if arg_243_1.time_ >= 1.96599999815226 + var_246_15 and arg_243_1.time_ < 1.96599999815226 + var_246_15 + arg_246_0 and not isNil(var_246_14) and arg_243_1.var_.characterEffect1020ui_story then
				arg_243_1.var_.characterEffect1020ui_story.fillFlat = true
				arg_243_1.var_.characterEffect1020ui_story.fillRatio = 0.5
			end

			local var_246_16 = "10102ui_story"

			if arg_243_1.actors_["10102ui_story"] == nil and not isNil((Asset.Load("Char/" .. "10102ui_story"))) then
				local var_246_17 = Object.Instantiate(Asset.Load("Char/" .. "10102ui_story"), arg_243_1.stage_.transform)

				var_246_17.name = var_246_16
				var_246_17.transform.localPosition = Vector3.New(0, 100, 0)
				arg_243_1.actors_[var_246_16] = var_246_17

				local var_246_18 = var_246_17:GetComponentInChildren(typeof(CharacterEffect))

				var_246_18.enabled = true

				local var_246_19 = GameObjectTools.GetOrAddComponent(var_246_17, typeof(DynamicBoneHelper))

				if var_246_19 then
					var_246_19:EnableDynamicBone(false)
				end

				arg_243_1:ShowWeapon(var_246_18.transform, false)

				arg_243_1.var_[var_246_16 .. "Animator"] = var_246_18.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_243_1.var_[var_246_16 .. "Animator"].applyRootMotion = true
				arg_243_1.var_[var_246_16 .. "LipSync"] = var_246_18.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_246_20 = arg_243_1.actors_["10102ui_story"].transform

			if 3.8 < arg_243_1.time_ and arg_243_1.time_ <= 3.8 + arg_246_0 then
				arg_243_1.var_.moveOldPos10102ui_story = var_246_20.localPosition
			end

			local var_246_21 = 0.001

			if 3.8 <= arg_243_1.time_ and arg_243_1.time_ < 3.8 + var_246_21 then
				var_246_20.localPosition = Vector3.Lerp(arg_243_1.var_.moveOldPos10102ui_story, Vector3.New(-0.7, -0.985, -6.275), (arg_243_1.time_ - 3.8) / var_246_21)
				var_246_20.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_246_20.position).x, (manager.ui.mainCamera.transform.position - var_246_20.position).y, (manager.ui.mainCamera.transform.position - var_246_20.position).z)
				var_246_20.localEulerAngles.z = 0
				var_246_20.localEulerAngles.x = 0
				var_246_20.localEulerAngles = var_246_20.localEulerAngles
			end

			if arg_243_1.time_ >= 3.8 + var_246_21 and arg_243_1.time_ < 3.8 + var_246_21 + arg_246_0 then
				var_246_20.localPosition = Vector3.New(-0.7, -0.985, -6.275)
				var_246_20.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_246_20.position).x, (manager.ui.mainCamera.transform.position - var_246_20.position).y, (manager.ui.mainCamera.transform.position - var_246_20.position).z)
				var_246_20.localEulerAngles.z = 0
				var_246_20.localEulerAngles.x = 0
				var_246_20.localEulerAngles = var_246_20.localEulerAngles
			...
			local var_246_22 = arg_243_1.actors_["10102ui_story"]

			if 3.8 < arg_243_1.time_ and arg_243_1.time_ <= 3.8 + arg_246_0 and not isNil(var_246_22) and arg_243_1.var_.characterEffect10102ui_story == nil then
				arg_243_1.var_.characterEffect10102ui_story = var_246_22:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_246_23 = 0.200000002980232

			if 3.8 <= arg_243_1.time_ and arg_243_1.time_ < 3.8 + var_246_23 and not isNil(var_246_22) then
				if arg_243_1.var_.characterEffect10102ui_story and not isNil(var_246_22) then
					arg_243_1.var_.characterEffect10102ui_story.fillFlat = false
				end
			end

			if arg_243_1.time_ >= 3.8 + var_246_23 and arg_243_1.time_ < 3.8 + var_246_23 + arg_246_0 and not isNil(var_246_22) and arg_243_1.var_.characterEffect10102ui_story then
				arg_243_1.var_.characterEffect10102ui_story.fillFlat = false
			end
			...
			local var_246_25 = 4
			local var_246_26 = 0.125

			if 4 < arg_243_1.time_ and arg_243_1.time_ <= var_246_25 + arg_246_0 then
				...
				local var_246_28 = arg_243_1:GetWordFromCfg(320061060)
				...
				local var_246_31 = 5 <= 0 and var_246_26 or var_246_26 * (utf8.len(var_246_29) / 5)

				if (5 <= 0 and var_246_26 or var_246_26 * (utf8.len(var_246_29) / 5)) > 0 and var_246_26 < var_246_31 then
					arg_243_1.talkMaxDuration = var_246_31
					var_246_25 = var_246_25 + 0.3

					if var_246_31 + var_246_25 > arg_243_1.duration_ then
						arg_243_1.duration_ = var_246_31 + var_246_25
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061060", "story_v_out_320061.awb") ~= 0 then
					local var_246_32 = manager.audio:GetVoiceLength("story_v_out_320061", "320061060", "story_v_out_320061.awb") / 1000

					if var_246_32 + var_246_25 > arg_243_1.duration_ then
						arg_243_1.duration_ = var_246_32 + var_246_25
					end

					if var_246_28.prefab_name ~= "" and arg_243_1.actors_[var_246_28.prefab_name] ~= nil then
						local var_246_33 = LuaForUtil.PlayVoiceWithCriLipsync(arg_243_1.actors_[var_246_28.prefab_name].transform, "story_v_out_320061", "320061060", "story_v_out_320061.awb")

						arg_243_1:RecordAudio("320061060", var_246_33)
						arg_243_1:RecordAudio("320061060", var_246_33)
					else
			...
			local var_246_34 = var_246_25 + 0.3
			local var_246_35 = math.max(var_246_26, arg_243_1.talkMaxDuration)

			if var_246_25 + 0.3 <= arg_243_1.time_ and arg_243_1.time_ < var_246_34 + var_246_35 then
				arg_243_1.typewritter.percent = (arg_243_1.time_ - var_246_34) / var_246_35

				arg_243_1.typewritter:SetDirty()
			end

			if arg_243_1.time_ >= var_246_34 + var_246_35 and arg_243_1.time_ < var_246_34 + var_246_35 + arg_246_0 then
	...
	Play320061061 = function(arg_249_0, arg_249_1)
		...
		function arg_249_1.onSingleLineUpdate_(arg_252_0)
			if arg_249_1.actors_["1056ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1056ui_story"))) then
				local var_252_0 = Object.Instantiate(Asset.Load("Char/" .. "1056ui_story"), arg_249_1.stage_.transform)

				var_252_0.name = "1056ui_story"
				var_252_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_249_1.actors_["1056ui_story"] = var_252_0
				...
				arg_249_1.var_["1056ui_story" .. "Animator"] = var_252_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_249_1.var_["1056ui_story" .. "Animator"].applyRootMotion = true
				arg_249_1.var_["1056ui_story" .. "LipSync"] = var_252_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_252_3 = arg_249_1.actors_["1056ui_story"].transform

			if 0 < arg_249_1.time_ and arg_249_1.time_ <= 0 + arg_252_0 then
				arg_249_1.var_.moveOldPos1056ui_story = var_252_3.localPosition
			end

			local var_252_4 = 0.001

			if 0 <= arg_249_1.time_ and arg_249_1.time_ < 0 + var_252_4 then
				var_252_3.localPosition = Vector3.Lerp(arg_249_1.var_.moveOldPos1056ui_story, Vector3.New(0.7, -1, -5.75), (arg_249_1.time_ - 0) / var_252_4)
			...
			if arg_249_1.time_ >= 0 + var_252_4 and arg_249_1.time_ < 0 + var_252_4 + arg_252_0 then
				var_252_3.localPosition = Vector3.New(0.7, -1, -5.75)
				var_252_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_252_3.position).x, (manager.ui.mainCamera.transform.position - var_252_3.position).y, (manager.ui.mainCamera.transform.position - var_252_3.position).z)
				var_252_3.localEulerAngles.z = 0
				var_252_3.localEulerAngles.x = 0
				var_252_3.localEulerAngles = var_252_3.localEulerAngles
			...
			local var_252_5 = arg_249_1.actors_["1056ui_story"]

			if 0 < arg_249_1.time_ and arg_249_1.time_ <= 0 + arg_252_0 and not isNil(var_252_5) and arg_249_1.var_.characterEffect1056ui_story == nil then
				arg_249_1.var_.characterEffect1056ui_story = var_252_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_252_6 = 0.200000002980232

			if 0 <= arg_249_1.time_ and arg_249_1.time_ < 0 + var_252_6 and not isNil(var_252_5) then
				if arg_249_1.var_.characterEffect1056ui_story and not isNil(var_252_5) then
					arg_249_1.var_.characterEffect1056ui_story.fillFlat = false
				end
			end

			if arg_249_1.time_ >= 0 + var_252_6 and arg_249_1.time_ < 0 + var_252_6 + arg_252_0 and not isNil(var_252_5) and arg_249_1.var_.characterEffect1056ui_story then
				arg_249_1.var_.characterEffect1056ui_story.fillFlat = false
			end
			...
			local var_252_8 = arg_249_1.actors_["10102ui_story"]

			if 0 < arg_249_1.time_ and arg_249_1.time_ <= 0 + arg_252_0 and not isNil(var_252_8) and arg_249_1.var_.characterEffect10102ui_story == nil then
				arg_249_1.var_.characterEffect10102ui_story = var_252_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_252_9 = 0.200000002980232

			if 0 <= arg_249_1.time_ and arg_249_1.time_ < 0 + var_252_9 and not isNil(var_252_8) then
				if arg_249_1.var_.characterEffect10102ui_story and not isNil(var_252_8) then
					arg_249_1.var_.characterEffect10102ui_story.fillFlat = true
					arg_249_1.var_.characterEffect10102ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_249_1.time_ - 0) / var_252_9)
				end
			end

			if arg_249_1.time_ >= 0 + var_252_9 and arg_249_1.time_ < 0 + var_252_9 + arg_252_0 and not isNil(var_252_8) and arg_249_1.var_.characterEffect10102ui_story then
				arg_249_1.var_.characterEffect10102ui_story.fillFlat = true
				arg_249_1.var_.characterEffect10102ui_story.fillRatio = 0.5
			end

			local var_252_10 = 0
			local var_252_11 = 0.55
			...
			if 0 < arg_249_1.time_ and arg_249_1.time_ <= var_252_10 + arg_252_0 then
				...
				local var_252_12 = arg_249_1:GetWordFromCfg(320061061)
				...
				local var_252_15 = 22 <= 0 and var_252_11 or var_252_11 * (utf8.len(var_252_13) / 22)

				if (22 <= 0 and var_252_11 or var_252_11 * (utf8.len(var_252_13) / 22)) > 0 and var_252_11 < var_252_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061061", "story_v_out_320061.awb") ~= 0 then
					local var_252_16 = manager.audio:GetVoiceLength("story_v_out_320061", "320061061", "story_v_out_320061.awb") / 1000
					...
					if var_252_12.prefab_name ~= "" and arg_249_1.actors_[var_252_12.prefab_name] ~= nil then
						local var_252_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_249_1.actors_[var_252_12.prefab_name].transform, "story_v_out_320061", "320061061", "story_v_out_320061.awb")

						arg_249_1:RecordAudio("320061061", var_252_17)
						arg_249_1:RecordAudio("320061061", var_252_17)
					else
	...
	Play320061062 = function(arg_253_0, arg_253_1)
		...
		function arg_253_1.onSingleLineUpdate_(arg_256_0)
			...
			if 0 < arg_253_1.time_ and arg_253_1.time_ <= 0 + arg_256_0 then
				...
				local var_256_1 = arg_253_1:GetWordFromCfg(320061062)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061062", "story_v_out_320061.awb") ~= 0 then
					local var_256_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061062", "story_v_out_320061.awb") / 1000
					...
					if var_256_1.prefab_name ~= "" and arg_253_1.actors_[var_256_1.prefab_name] ~= nil then
						local var_256_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_253_1.actors_[var_256_1.prefab_name].transform, "story_v_out_320061", "320061062", "story_v_out_320061.awb")

						arg_253_1:RecordAudio("320061062", var_256_6)
						arg_253_1:RecordAudio("320061062", var_256_6)
					else
	...
	Play320061063 = function(arg_257_0, arg_257_1)
		...
		function arg_257_1.onSingleLineUpdate_(arg_260_0)
			...
			if 0 < arg_257_1.time_ and arg_257_1.time_ <= 0 + arg_260_0 then
				...
				local var_260_1 = arg_257_1:GetWordFromCfg(320061063)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061063", "story_v_out_320061.awb") ~= 0 then
					local var_260_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061063", "story_v_out_320061.awb") / 1000
					...
					if var_260_1.prefab_name ~= "" and arg_257_1.actors_[var_260_1.prefab_name] ~= nil then
						local var_260_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_257_1.actors_[var_260_1.prefab_name].transform, "story_v_out_320061", "320061063", "story_v_out_320061.awb")

						arg_257_1:RecordAudio("320061063", var_260_6)
						arg_257_1:RecordAudio("320061063", var_260_6)
					else
	...
	Play320061064 = function(arg_261_0, arg_261_1)
		...
		function arg_261_1.onSingleLineUpdate_(arg_264_0)
			if 0 < arg_261_1.time_ and arg_261_1.time_ <= 0 + arg_264_0 and not isNil(arg_261_1.actors_["10102ui_story"]) and arg_261_1.var_.characterEffect10102ui_story == nil then
				arg_261_1.var_.characterEffect10102ui_story = arg_261_1.actors_["10102ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_264_0 = 0.200000002980232

			if 0 <= arg_261_1.time_ and arg_261_1.time_ < 0 + var_264_0 and not isNil(arg_261_1.actors_["10102ui_story"]) then
				if arg_261_1.var_.characterEffect10102ui_story and not isNil(arg_261_1.actors_["10102ui_story"]) then
					arg_261_1.var_.characterEffect10102ui_story.fillFlat = false
				end
			end

			if arg_261_1.time_ >= 0 + var_264_0 and arg_261_1.time_ < 0 + var_264_0 + arg_264_0 and not isNil(arg_261_1.actors_["10102ui_story"]) and arg_261_1.var_.characterEffect10102ui_story then
				arg_261_1.var_.characterEffect10102ui_story.fillFlat = false
			end
			...
			local var_264_2 = arg_261_1.actors_["1056ui_story"]

			if 0 < arg_261_1.time_ and arg_261_1.time_ <= 0 + arg_264_0 and not isNil(var_264_2) and arg_261_1.var_.characterEffect1056ui_story == nil then
				arg_261_1.var_.characterEffect1056ui_story = var_264_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_264_3 = 0.200000002980232

			if 0 <= arg_261_1.time_ and arg_261_1.time_ < 0 + var_264_3 and not isNil(var_264_2) then
				if arg_261_1.var_.characterEffect1056ui_story and not isNil(var_264_2) then
					arg_261_1.var_.characterEffect1056ui_story.fillFlat = true
					arg_261_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_261_1.time_ - 0) / var_264_3)
				end
			end

			if arg_261_1.time_ >= 0 + var_264_3 and arg_261_1.time_ < 0 + var_264_3 + arg_264_0 and not isNil(var_264_2) and arg_261_1.var_.characterEffect1056ui_story then
				arg_261_1.var_.characterEffect1056ui_story.fillFlat = true
			...
			if 0 < arg_261_1.time_ and arg_261_1.time_ <= var_264_4 + arg_264_0 then
				...
				local var_264_6 = arg_261_1:GetWordFromCfg(320061064)
				...
				local var_264_9 = 36 <= 0 and var_264_5 or var_264_5 * (utf8.len(var_264_7) / 36)

				if (36 <= 0 and var_264_5 or var_264_5 * (utf8.len(var_264_7) / 36)) > 0 and var_264_5 < var_264_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061064", "story_v_out_320061.awb") ~= 0 then
					local var_264_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061064", "story_v_out_320061.awb") / 1000
					...
					if var_264_6.prefab_name ~= "" and arg_261_1.actors_[var_264_6.prefab_name] ~= nil then
						local var_264_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_261_1.actors_[var_264_6.prefab_name].transform, "story_v_out_320061", "320061064", "story_v_out_320061.awb")

						arg_261_1:RecordAudio("320061064", var_264_11)
						arg_261_1:RecordAudio("320061064", var_264_11)
					else
	...
	Play320061065 = function(arg_265_0, arg_265_1)
		...
		function arg_265_1.onSingleLineUpdate_(arg_268_0)
			...
			local var_268_2 = arg_265_1.actors_["10102ui_story"]

			if 0 < arg_265_1.time_ and arg_265_1.time_ <= 0 + arg_268_0 and not isNil(var_268_2) and arg_265_1.var_.characterEffect10102ui_story == nil then
				arg_265_1.var_.characterEffect10102ui_story = var_268_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_268_3 = 0.200000002980232

			if 0 <= arg_265_1.time_ and arg_265_1.time_ < 0 + var_268_3 and not isNil(var_268_2) then
				if arg_265_1.var_.characterEffect10102ui_story and not isNil(var_268_2) then
					arg_265_1.var_.characterEffect10102ui_story.fillFlat = true
					arg_265_1.var_.characterEffect10102ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_265_1.time_ - 0) / var_268_3)
				end
			end

			if arg_265_1.time_ >= 0 + var_268_3 and arg_265_1.time_ < 0 + var_268_3 + arg_268_0 and not isNil(var_268_2) and arg_265_1.var_.characterEffect10102ui_story then
				arg_265_1.var_.characterEffect10102ui_story.fillFlat = true
			...
			if 0 < arg_265_1.time_ and arg_265_1.time_ <= var_268_4 + arg_268_0 then
				...
				local var_268_6 = arg_265_1:GetWordFromCfg(320061065)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061065", "story_v_out_320061.awb") ~= 0 then
					local var_268_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061065", "story_v_out_320061.awb") / 1000
					...
					if var_268_6.prefab_name ~= "" and arg_265_1.actors_[var_268_6.prefab_name] ~= nil then
						local var_268_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_265_1.actors_[var_268_6.prefab_name].transform, "story_v_out_320061", "320061065", "story_v_out_320061.awb")

						arg_265_1:RecordAudio("320061065", var_268_11)
						arg_265_1:RecordAudio("320061065", var_268_11)
					else
	...
	Play320061066 = function(arg_269_0, arg_269_1)
		...
		function arg_269_1.onSingleLineUpdate_(arg_272_0)
			if 1.48333333333333 < arg_269_1.time_ and arg_269_1.time_ <= 1.48333333333333 + arg_272_0 then
				arg_269_1.var_.moveOldPos1056ui_story = arg_269_1.actors_["1056ui_story"].transform.localPosition
			end

			local var_272_0 = 0.001

			if 1.48333333333333 <= arg_269_1.time_ and arg_269_1.time_ < 1.48333333333333 + var_272_0 then
				arg_269_1.actors_["1056ui_story"].transform.localPosition = Vector3.Lerp(arg_269_1.var_.moveOldPos1056ui_story, Vector3.New(0, 100, 0), (arg_269_1.time_ - 1.48333333333333) / var_272_0)
				arg_269_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_269_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_269_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_269_1.actors_["1056ui_story"].transform.position).z)
				arg_269_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_269_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_269_1.actors_["1056ui_story"].transform.localEulerAngles = arg_269_1.actors_["1056ui_story"].transform.localEulerAngles
			end

			if arg_269_1.time_ >= 1.48333333333333 + var_272_0 and arg_269_1.time_ < 1.48333333333333 + var_272_0 + arg_272_0 then
				arg_269_1.actors_["1056ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_269_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_269_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_269_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_269_1.actors_["1056ui_story"].transform.position).z)
				arg_269_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_269_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_269_1.actors_["1056ui_story"].transform.localEulerAngles = arg_269_1.actors_["1056ui_story"].transform.localEulerAngles
			...
			local var_272_1 = arg_269_1.actors_["1056ui_story"]

			if 1.48333333333333 < arg_269_1.time_ and arg_269_1.time_ <= 1.48333333333333 + arg_272_0 and not isNil(var_272_1) and arg_269_1.var_.characterEffect1056ui_story == nil then
				arg_269_1.var_.characterEffect1056ui_story = var_272_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_272_2 = 0.0166666666666666

			if 1.48333333333333 <= arg_269_1.time_ and arg_269_1.time_ < 1.48333333333333 + var_272_2 and not isNil(var_272_1) then
				if arg_269_1.var_.characterEffect1056ui_story and not isNil(var_272_1) then
					arg_269_1.var_.characterEffect1056ui_story.fillFlat = true
					arg_269_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_269_1.time_ - 1.48333333333333) / var_272_2)
				end
			end

			if arg_269_1.time_ >= 1.48333333333333 + var_272_2 and arg_269_1.time_ < 1.48333333333333 + var_272_2 + arg_272_0 and not isNil(var_272_1) and arg_269_1.var_.characterEffect1056ui_story then
				arg_269_1.var_.characterEffect1056ui_story.fillFlat = true
				arg_269_1.var_.characterEffect1056ui_story.fillRatio = 0.5
			end

			local var_272_3 = arg_269_1.actors_["10102ui_story"].transform

			if 1.48333333333333 < arg_269_1.time_ and arg_269_1.time_ <= 1.48333333333333 + arg_272_0 then
				arg_269_1.var_.moveOldPos10102ui_story = var_272_3.localPosition
			end

			local var_272_4 = 0.001

			if 1.48333333333333 <= arg_269_1.time_ and arg_269_1.time_ < 1.48333333333333 + var_272_4 then
				var_272_3.localPosition = Vector3.Lerp(arg_269_1.var_.moveOldPos10102ui_story, Vector3.New(0, 100, 0), (arg_269_1.time_ - 1.48333333333333) / var_272_4)
			...
			if arg_269_1.time_ >= 1.48333333333333 + var_272_4 and arg_269_1.time_ < 1.48333333333333 + var_272_4 + arg_272_0 then
				var_272_3.localPosition = Vector3.New(0, 100, 0)
				var_272_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_272_3.position).x, (manager.ui.mainCamera.transform.position - var_272_3.position).y, (manager.ui.mainCamera.transform.position - var_272_3.position).z)
				var_272_3.localEulerAngles.z = 0
				var_272_3.localEulerAngles.x = 0
				var_272_3.localEulerAngles = var_272_3.localEulerAngles
			...
			local var_272_5 = arg_269_1.actors_["10102ui_story"]

			if 1.48333333333333 < arg_269_1.time_ and arg_269_1.time_ <= 1.48333333333333 + arg_272_0 and not isNil(var_272_5) and arg_269_1.var_.characterEffect10102ui_story == nil then
				arg_269_1.var_.characterEffect10102ui_story = var_272_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_272_6 = 0.0166666666666666

			if 1.48333333333333 <= arg_269_1.time_ and arg_269_1.time_ < 1.48333333333333 + var_272_6 and not isNil(var_272_5) then
				if arg_269_1.var_.characterEffect10102ui_story and not isNil(var_272_5) then
					arg_269_1.var_.characterEffect10102ui_story.fillFlat = true
					arg_269_1.var_.characterEffect10102ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_269_1.time_ - 1.48333333333333) / var_272_6)
				end
			end

			if arg_269_1.time_ >= 1.48333333333333 + var_272_6 and arg_269_1.time_ < 1.48333333333333 + var_272_6 + arg_272_0 and not isNil(var_272_5) and arg_269_1.var_.characterEffect10102ui_story then
				arg_269_1.var_.characterEffect10102ui_story.fillFlat = true
				arg_269_1.var_.characterEffect10102ui_story.fillRatio = 0.5
			end

			local var_272_7 = 0

			if 0 < arg_269_1.time_ and arg_269_1.time_ <= var_272_7 + arg_272_0 then
			...
			local var_272_11 = 1.5

			if 1.5 < arg_269_1.time_ and arg_269_1.time_ <= var_272_11 + arg_272_0 then
				arg_269_1.mask_.enabled = true
				arg_269_1.mask_.raycastTarget = true
			...
			if 1.5 < arg_269_1.time_ and arg_269_1.time_ <= 1.5 + arg_272_0 then
				...
				arg_269_1.fswt_.text = arg_269_1:FormatText(arg_269_1:GetWordFromCfg(320061066).content)
			...
			local var_272_15 = 1.51666666666667

			if 1.51666666666667 < arg_269_1.time_ and arg_269_1.time_ <= var_272_15 + arg_272_0 then
			...
			local var_272_16 = 6
			local var_272_17 = 0.4
			local var_272_18, var_272_19 = arg_269_1:GetPercentByPara(arg_269_1:FormatText(arg_269_1:GetWordFromCfg(320061066).content), 1)

			if var_272_15 < arg_269_1.time_ and arg_269_1.time_ <= var_272_15 + arg_272_0 then
				arg_269_1.talkMaxDuration = 0

				local var_272_20 = var_272_16 <= 0 and var_272_17 or var_272_17 * ((var_272_19 - arg_269_1.typewritterCharCountI18N) / var_272_16)

				if (var_272_16 <= 0 and var_272_17 or var_272_17 * ((var_272_19 - arg_269_1.typewritterCharCountI18N) / var_272_16)) > 0 and var_272_17 < var_272_20 then
			...
			local var_272_21 = math.max(0.4, arg_269_1.talkMaxDuration)

			if var_272_15 <= arg_269_1.time_ and arg_269_1.time_ < var_272_15 + var_272_21 then
				arg_269_1.fswtw_.percent = Mathf.Lerp(arg_269_1.var_.oldValueTypewriter, var_272_18, (arg_269_1.time_ - var_272_15) / var_272_21)
				arg_269_1.fswt_:GetComponent("Text").color = Color(1, 1, 1)

				arg_269_1.fswtw_:SetDirty()
			end

			if arg_269_1.time_ >= var_272_15 + var_272_21 and arg_269_1.time_ < var_272_15 + var_272_21 + arg_272_0 then
				arg_269_1.fswtw_.percent = var_272_18

				arg_269_1.fswtw_:SetDirty()
				arg_269_1:ShowNextGo(true)

				arg_269_1.typewritterCharCountI18N = var_272_19
			end

			if 1.51666666666667 < arg_269_1.time_ and arg_269_1.time_ <= 1.51666666666667 + arg_272_0 then
				local var_272_22 = arg_269_1.fswbg_.transform:Find("textbox/adapt/content") or arg_269_1.fswbg_.transform:Find("textbox/content")
				local var_272_23 = arg_269_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image")
				local var_272_24 = var_272_22:GetComponent("RectTransform")

				var_272_22:GetComponent("Text").alignment = UnityEngine.TextAnchor.MiddleCenter
				var_272_24.offsetMin = Vector2.New(0, 0)
				var_272_24.offsetMax = Vector2.New(0, 0)
			end

			local var_272_25 = "STblack"

			if arg_269_1.bgs_.STblack == nil then
				local var_272_26 = Object.Instantiate(arg_269_1.paintGo_)

				var_272_26:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. var_272_25)
				var_272_26.name = var_272_25
				var_272_26.transform.parent = arg_269_1.stage_.transform
				var_272_26.transform.localPosition = Vector3.New(0, 100, 0)
				arg_269_1.bgs_[var_272_25] = var_272_26
			end

			if 1.51666666666667 < arg_269_1.time_ and arg_269_1.time_ <= 1.51666666666667 + arg_272_0 then
				local var_272_27 = arg_269_1.bgs_.STblack
				...
				var_272_27.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_272_28 = var_272_27:GetComponent("SpriteRenderer")

				if var_272_28 and var_272_28.sprite then
					local var_272_29 = 2 * (var_272_27.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_272_27.transform.localScale = Vector3.New(var_272_29 / var_272_28.sprite.bounds.size.y < var_272_29 * manager.ui.mainCameraCom_.aspect / var_272_28.sprite.bounds.size.x and var_272_29 * manager.ui.mainCameraCom_.aspect / var_272_28.sprite.bounds.size.x or var_272_29 / var_272_28.sprite.bounds.size.y, var_272_29 / var_272_28.sprite.bounds.size.y < var_272_29 * manager.ui.mainCameraCom_.aspect / var_272_28.sprite.bounds.size.x and var_272_29 * manager.ui.mainCameraCom_.aspect / var_272_28.sprite.bounds.size.x or var_272_29 / var_272_28.sprite.bounds.size.y, 0)
				end
	...
	Play320061067 = function(arg_273_0, arg_273_1)
		...
		function arg_273_1.onSingleLineUpdate_(arg_276_0)
			if 1 < arg_273_1.time_ and arg_273_1.time_ <= 1 + arg_276_0 then
				arg_273_1.var_.moveOldPos10102ui_story = arg_273_1.actors_["10102ui_story"].transform.localPosition
			end

			local var_276_0 = 0.001

			if 1 <= arg_273_1.time_ and arg_273_1.time_ < 1 + var_276_0 then
				arg_273_1.actors_["10102ui_story"].transform.localPosition = Vector3.Lerp(arg_273_1.var_.moveOldPos10102ui_story, Vector3.New(0, -0.985, -6.275), (arg_273_1.time_ - 1) / var_276_0)
				arg_273_1.actors_["10102ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_273_1.actors_["10102ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_273_1.actors_["10102ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_273_1.actors_["10102ui_story"].transform.position).z)
				arg_273_1.actors_["10102ui_story"].transform.localEulerAngles.z = 0
				arg_273_1.actors_["10102ui_story"].transform.localEulerAngles.x = 0
				arg_273_1.actors_["10102ui_story"].transform.localEulerAngles = arg_273_1.actors_["10102ui_story"].transform.localEulerAngles
			end

			if arg_273_1.time_ >= 1 + var_276_0 and arg_273_1.time_ < 1 + var_276_0 + arg_276_0 then
				arg_273_1.actors_["10102ui_story"].transform.localPosition = Vector3.New(0, -0.985, -6.275)
				arg_273_1.actors_["10102ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_273_1.actors_["10102ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_273_1.actors_["10102ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_273_1.actors_["10102ui_story"].transform.position).z)
				arg_273_1.actors_["10102ui_story"].transform.localEulerAngles.z = 0
				arg_273_1.actors_["10102ui_story"].transform.localEulerAngles.x = 0
				arg_273_1.actors_["10102ui_story"].transform.localEulerAngles = arg_273_1.actors_["10102ui_story"].transform.localEulerAngles
			...
			local var_276_1 = arg_273_1.actors_["10102ui_story"]

			if 1 < arg_273_1.time_ and arg_273_1.time_ <= 1 + arg_276_0 and not isNil(var_276_1) and arg_273_1.var_.characterEffect10102ui_story == nil then
				arg_273_1.var_.characterEffect10102ui_story = var_276_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_276_2 = 0.200000002980232

			if 1 <= arg_273_1.time_ and arg_273_1.time_ < 1 + var_276_2 and not isNil(var_276_1) then
				if arg_273_1.var_.characterEffect10102ui_story and not isNil(var_276_1) then
					arg_273_1.var_.characterEffect10102ui_story.fillFlat = false
				end
			end

			if arg_273_1.time_ >= 1 + var_276_2 and arg_273_1.time_ < 1 + var_276_2 + arg_276_0 and not isNil(var_276_1) and arg_273_1.var_.characterEffect10102ui_story then
				arg_273_1.var_.characterEffect10102ui_story.fillFlat = false
			end
			...
			if 0 < arg_273_1.time_ and arg_273_1.time_ <= 0 + arg_276_0 then
				local var_276_8 = arg_273_1.bgs_.ST61
				...
				var_276_8.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_276_9 = var_276_8:GetComponent("SpriteRenderer")

				if var_276_9 and var_276_9.sprite then
					local var_276_10 = 2 * (var_276_8.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_276_8.transform.localScale = Vector3.New(var_276_10 / var_276_9.sprite.bounds.size.y < var_276_10 * manager.ui.mainCameraCom_.aspect / var_276_9.sprite.bounds.size.x and var_276_10 * manager.ui.mainCameraCom_.aspect / var_276_9.sprite.bounds.size.x or var_276_10 / var_276_9.sprite.bounds.size.y, var_276_10 / var_276_9.sprite.bounds.size.y < var_276_10 * manager.ui.mainCameraCom_.aspect / var_276_9.sprite.bounds.size.x and var_276_10 * manager.ui.mainCameraCom_.aspect / var_276_9.sprite.bounds.size.x or var_276_10 / var_276_9.sprite.bounds.size.y, 0)
				end
			...
			local var_276_11 = 1
			local var_276_12 = 0.125

			if 1 < arg_273_1.time_ and arg_273_1.time_ <= var_276_11 + arg_276_0 then
				...
				local var_276_14 = arg_273_1:GetWordFromCfg(320061067)
				...
				local var_276_17 = 5 <= 0 and var_276_12 or var_276_12 * (utf8.len(var_276_15) / 5)

				if (5 <= 0 and var_276_12 or var_276_12 * (utf8.len(var_276_15) / 5)) > 0 and var_276_12 < var_276_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061067", "story_v_out_320061.awb") ~= 0 then
					local var_276_18 = manager.audio:GetVoiceLength("story_v_out_320061", "320061067", "story_v_out_320061.awb") / 1000
					...
					if var_276_14.prefab_name ~= "" and arg_273_1.actors_[var_276_14.prefab_name] ~= nil then
						local var_276_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_273_1.actors_[var_276_14.prefab_name].transform, "story_v_out_320061", "320061067", "story_v_out_320061.awb")

						arg_273_1:RecordAudio("320061067", var_276_19)
						arg_273_1:RecordAudio("320061067", var_276_19)
					else
			...
			local var_276_20 = var_276_11 + 0.3
			local var_276_21 = math.max(var_276_12, arg_273_1.talkMaxDuration)

			if var_276_11 + 0.3 <= arg_273_1.time_ and arg_273_1.time_ < var_276_20 + var_276_21 then
				arg_273_1.typewritter.percent = (arg_273_1.time_ - var_276_20) / var_276_21
	...
	Play320061068 = function(arg_279_0, arg_279_1)
		...
		function arg_279_1.onSingleLineUpdate_(arg_282_0)
			...
			if 0 <= arg_279_1.time_ and arg_279_1.time_ < 0 + var_282_0 then
				arg_279_1.actors_["10102ui_story"].transform.localPosition = Vector3.Lerp(arg_279_1.var_.moveOldPos10102ui_story, Vector3.New(0, 100, 0), (arg_279_1.time_ - 0) / var_282_0)
			...
			if arg_279_1.time_ >= 0 + var_282_0 and arg_279_1.time_ < 0 + var_282_0 + arg_282_0 then
				arg_279_1.actors_["10102ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_279_1.actors_["10102ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_279_1.actors_["10102ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_279_1.actors_["10102ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_279_1.actors_["10102ui_story"].transform.position).z)
				arg_279_1.actors_["10102ui_story"].transform.localEulerAngles.z = 0
				arg_279_1.actors_["10102ui_story"].transform.localEulerAngles.x = 0
				arg_279_1.actors_["10102ui_story"].transform.localEulerAngles = arg_279_1.actors_["10102ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_279_1.time_ and arg_279_1.time_ < 0 + var_282_2 and not isNil(var_282_1) then
				if arg_279_1.var_.characterEffect10102ui_story and not isNil(var_282_1) then
					...
					arg_279_1.var_.characterEffect10102ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_279_1.time_ - 0) / var_282_2)
				end
			end
			...
			if arg_279_1.time_ >= 0 + var_282_2 and arg_279_1.time_ < 0 + var_282_2 + arg_282_0 and not isNil(var_282_1) and arg_279_1.var_.characterEffect10102ui_story then
				arg_279_1.var_.characterEffect10102ui_story.fillFlat = true
				arg_279_1.var_.characterEffect10102ui_story.fillRatio = 0.5
			end

			local var_282_3 = 0
			local var_282_4 = 1.05
			...
			if 0 < arg_279_1.time_ and arg_279_1.time_ <= var_282_3 + arg_282_0 then
				...
				local var_282_5 = arg_279_1:FormatText(arg_279_1:GetWordFromCfg(320061068).content)

				arg_279_1.text_.text = var_282_5

				LuaForUtil.ClearLinePrefixSymbol(arg_279_1.text_)

				local var_282_7 = 42 <= 0 and var_282_4 or var_282_4 * (utf8.len(var_282_5) / 42)

				if (42 <= 0 and var_282_4 or var_282_4 * (utf8.len(var_282_5) / 42)) > 0 and var_282_4 < var_282_7 then
	...
	Play320061069 = function(arg_283_0, arg_283_1)
		...
		function arg_283_1.onSingleLineUpdate_(arg_286_0)
			...
			if 0 < arg_283_1.time_ and arg_283_1.time_ <= 0 + arg_286_0 then
				...
				local var_286_1 = arg_283_1:FormatText(arg_283_1:GetWordFromCfg(320061069).content)

				arg_283_1.text_.text = var_286_1

				LuaForUtil.ClearLinePrefixSymbol(arg_283_1.text_)

				local var_286_3 = 23 <= 0 and var_286_0 or var_286_0 * (utf8.len(var_286_1) / 23)

				if (23 <= 0 and var_286_0 or var_286_0 * (utf8.len(var_286_1) / 23)) > 0 and var_286_0 < var_286_3 then
	...
	Play320061070 = function(arg_287_0, arg_287_1)
		...
		function arg_287_1.onSingleLineUpdate_(arg_290_0)
			if 0 < arg_287_1.time_ and arg_287_1.time_ <= 0 + arg_290_0 then
				arg_287_1.var_.moveOldPos1056ui_story = arg_287_1.actors_["1056ui_story"].transform.localPosition
			end

			local var_290_0 = 0.001

			if 0 <= arg_287_1.time_ and arg_287_1.time_ < 0 + var_290_0 then
				arg_287_1.actors_["1056ui_story"].transform.localPosition = Vector3.Lerp(arg_287_1.var_.moveOldPos1056ui_story, Vector3.New(0, -1, -5.75), (arg_287_1.time_ - 0) / var_290_0)
				arg_287_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_287_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_287_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_287_1.actors_["1056ui_story"].transform.position).z)
				arg_287_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_287_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_287_1.actors_["1056ui_story"].transform.localEulerAngles = arg_287_1.actors_["1056ui_story"].transform.localEulerAngles
			end

			if arg_287_1.time_ >= 0 + var_290_0 and arg_287_1.time_ < 0 + var_290_0 + arg_290_0 then
				arg_287_1.actors_["1056ui_story"].transform.localPosition = Vector3.New(0, -1, -5.75)
				arg_287_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_287_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_287_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_287_1.actors_["1056ui_story"].transform.position).z)
				arg_287_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_287_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_287_1.actors_["1056ui_story"].transform.localEulerAngles = arg_287_1.actors_["1056ui_story"].transform.localEulerAngles
			...
			local var_290_1 = arg_287_1.actors_["1056ui_story"]

			if 0 < arg_287_1.time_ and arg_287_1.time_ <= 0 + arg_290_0 and not isNil(var_290_1) and arg_287_1.var_.characterEffect1056ui_story == nil then
				arg_287_1.var_.characterEffect1056ui_story = var_290_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_290_2 = 0.200000002980232

			if 0 <= arg_287_1.time_ and arg_287_1.time_ < 0 + var_290_2 and not isNil(var_290_1) then
				if arg_287_1.var_.characterEffect1056ui_story and not isNil(var_290_1) then
					arg_287_1.var_.characterEffect1056ui_story.fillFlat = false
				end
			end

			if arg_287_1.time_ >= 0 + var_290_2 and arg_287_1.time_ < 0 + var_290_2 + arg_290_0 and not isNil(var_290_1) and arg_287_1.var_.characterEffect1056ui_story then
				arg_287_1.var_.characterEffect1056ui_story.fillFlat = false
			end
			...
			if 0 < arg_287_1.time_ and arg_287_1.time_ <= var_290_4 + arg_290_0 then
				...
				arg_287_1.leftNameTxt_.text = arg_287_1:FormatText(StoryNameCfg[605].name)
				...
				local var_290_6 = arg_287_1:GetWordFromCfg(320061070)
				...
				local var_290_9 = 33 <= 0 and var_290_5 or var_290_5 * (utf8.len(var_290_7) / 33)

				if (33 <= 0 and var_290_5 or var_290_5 * (utf8.len(var_290_7) / 33)) > 0 and var_290_5 < var_290_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061070", "story_v_out_320061.awb") ~= 0 then
					local var_290_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061070", "story_v_out_320061.awb") / 1000
					...
					if var_290_6.prefab_name ~= "" and arg_287_1.actors_[var_290_6.prefab_name] ~= nil then
						local var_290_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_287_1.actors_[var_290_6.prefab_name].transform, "story_v_out_320061", "320061070", "story_v_out_320061.awb")

						arg_287_1:RecordAudio("320061070", var_290_11)
						arg_287_1:RecordAudio("320061070", var_290_11)
					else
	...
	Play320061071 = function(arg_291_0, arg_291_1)
		...
		function arg_291_1.onSingleLineUpdate_(arg_294_0)
			if arg_291_1.bgs_.XS0102 == nil then
				local var_294_0 = Object.Instantiate(arg_291_1.paintGo_)

				var_294_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "XS0102")
				var_294_0.name = "XS0102"
				var_294_0.transform.parent = arg_291_1.stage_.transform
				var_294_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_291_1.bgs_.XS0102 = var_294_0
			end

			if 1.98333333333333 < arg_291_1.time_ and arg_291_1.time_ <= 1.98333333333333 + arg_294_0 then
				local var_294_1 = arg_291_1.bgs_.XS0102

				arg_291_1.bgs_.XS0102.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_294_13 = arg_291_1.actors_["1056ui_story"].transform

			if 1.96599999815226 < arg_291_1.time_ and arg_291_1.time_ <= 1.96599999815226 + arg_294_0 then
				arg_291_1.var_.moveOldPos1056ui_story = var_294_13.localPosition
			end

			local var_294_14 = 0.001

			if 1.96599999815226 <= arg_291_1.time_ and arg_291_1.time_ < 1.96599999815226 + var_294_14 then
				var_294_13.localPosition = Vector3.Lerp(arg_291_1.var_.moveOldPos1056ui_story, Vector3.New(0, 100, 0), (arg_291_1.time_ - 1.96599999815226) / var_294_14)
				var_294_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_294_13.position).x, (manager.ui.mainCamera.transform.position - var_294_13.position).y, (manager.ui.mainCamera.transform.position - var_294_13.position).z)
				var_294_13.localEulerAngles.z = 0
				var_294_13.localEulerAngles.x = 0
				var_294_13.localEulerAngles = var_294_13.localEulerAngles
			end

			if arg_291_1.time_ >= 1.96599999815226 + var_294_14 and arg_291_1.time_ < 1.96599999815226 + var_294_14 + arg_294_0 then
			...
			local var_294_15 = arg_291_1.actors_["1056ui_story"]

			if 1.96599999815226 < arg_291_1.time_ and arg_291_1.time_ <= 1.96599999815226 + arg_294_0 and not isNil(var_294_15) and arg_291_1.var_.characterEffect1056ui_story == nil then
				arg_291_1.var_.characterEffect1056ui_story = var_294_15:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_294_16 = 0.034000001847744

			if 1.96599999815226 <= arg_291_1.time_ and arg_291_1.time_ < 1.96599999815226 + var_294_16 and not isNil(var_294_15) then
				if arg_291_1.var_.characterEffect1056ui_story and not isNil(var_294_15) then
					arg_291_1.var_.characterEffect1056ui_story.fillFlat = true
					arg_291_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_291_1.time_ - 1.96599999815226) / var_294_16)
				end
			end

			if arg_291_1.time_ >= 1.96599999815226 + var_294_16 and arg_291_1.time_ < 1.96599999815226 + var_294_16 + arg_294_0 and not isNil(var_294_15) and arg_291_1.var_.characterEffect1056ui_story then
				arg_291_1.var_.characterEffect1056ui_story.fillFlat = true
				arg_291_1.var_.characterEffect1056ui_story.fillRatio = 0.5
			end

			local var_294_17 = arg_291_1.bgs_.XS0102.transform

			if 2 < arg_291_1.time_ and arg_291_1.time_ <= 2 + arg_294_0 then
				arg_291_1.var_.moveOldPosXS0102 = var_294_17.localPosition
			end

			local var_294_18 = 0.001

			if 2 <= arg_291_1.time_ and arg_291_1.time_ < 2 + var_294_18 then
				var_294_17.localPosition = Vector3.Lerp(arg_291_1.var_.moveOldPosXS0102, Vector3.New(3, 0.5, 4), (arg_291_1.time_ - 2) / var_294_18)
			end

			if arg_291_1.time_ >= 2 + var_294_18 and arg_291_1.time_ < 2 + var_294_18 + arg_294_0 then
				var_294_17.localPosition = Vector3.New(3, 0.5, 4)
			end

			local var_294_19 = arg_291_1.bgs_.XS0102.transform

			if 2.03400000184774 < arg_291_1.time_ and arg_291_1.time_ <= 2.03400000184774 + arg_294_0 then
				arg_291_1.var_.moveOldPosXS0102 = var_294_19.localPosition
			end

			local var_294_20 = 5.8

			if 2.03400000184774 <= arg_291_1.time_ and arg_291_1.time_ < 2.03400000184774 + var_294_20 then
				var_294_19.localPosition = Vector3.Lerp(arg_291_1.var_.moveOldPosXS0102, Vector3.New(3, 0, 4), (arg_291_1.time_ - 2.03400000184774) / var_294_20)
			end

			if arg_291_1.time_ >= 2.03400000184774 + var_294_20 and arg_291_1.time_ < 2.03400000184774 + var_294_20 + arg_294_0 then
				var_294_19.localPosition = Vector3.New(3, 0, 4)
			end

			local var_294_21 = 4

			if 4 < arg_291_1.time_ and arg_291_1.time_ <= var_294_21 + arg_294_0 then
				arg_291_1.allBtn_.enabled = false
			end

			if arg_291_1.time_ >= var_294_21 + 3.8 and arg_291_1.time_ < var_294_21 + 3.8 + arg_294_0 then
				arg_291_1.allBtn_.enabled = true
			end
			...
			local var_294_22 = 4
			local var_294_23 = 0.875

			if 4 < arg_291_1.time_ and arg_291_1.time_ <= var_294_22 + arg_294_0 then
				...
				arg_291_1.leftNameTxt_.text = arg_291_1:FormatText(StoryNameCfg[37].name)
				...
				local var_294_25 = arg_291_1:GetWordFromCfg(320061071)
				...
				local var_294_28 = 35 <= 0 and var_294_23 or var_294_23 * (utf8.len(var_294_26) / 35)

				if (35 <= 0 and var_294_23 or var_294_23 * (utf8.len(var_294_26) / 35)) > 0 and var_294_23 < var_294_28 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061071", "story_v_out_320061.awb") ~= 0 then
					local var_294_29 = manager.audio:GetVoiceLength("story_v_out_320061", "320061071", "story_v_out_320061.awb") / 1000
					...
					if var_294_25.prefab_name ~= "" and arg_291_1.actors_[var_294_25.prefab_name] ~= nil then
						local var_294_30 = LuaForUtil.PlayVoiceWithCriLipsync(arg_291_1.actors_[var_294_25.prefab_name].transform, "story_v_out_320061", "320061071", "story_v_out_320061.awb")

						arg_291_1:RecordAudio("320061071", var_294_30)
						arg_291_1:RecordAudio("320061071", var_294_30)
					else
			...
			local var_294_31 = var_294_22 + 0.3
			local var_294_32 = math.max(var_294_23, arg_291_1.talkMaxDuration)

			if var_294_22 + 0.3 <= arg_291_1.time_ and arg_291_1.time_ < var_294_31 + var_294_32 then
				arg_291_1.typewritter.percent = (arg_291_1.time_ - var_294_31) / var_294_32
	...
	Play320061072 = function(arg_297_0, arg_297_1)
		...
		function arg_297_1.onSingleLineUpdate_(arg_300_0)
			...
			if 0 < arg_297_1.time_ and arg_297_1.time_ <= 0 + arg_300_0 then
				...
				local var_300_1 = arg_297_1:GetWordFromCfg(320061072)
				...
				local var_300_4 = 24 <= 0 and var_300_0 or var_300_0 * (utf8.len(var_300_2) / 24)

				if (24 <= 0 and var_300_0 or var_300_0 * (utf8.len(var_300_2) / 24)) > 0 and var_300_0 < var_300_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061072", "story_v_out_320061.awb") ~= 0 then
					local var_300_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061072", "story_v_out_320061.awb") / 1000
					...
					if var_300_1.prefab_name ~= "" and arg_297_1.actors_[var_300_1.prefab_name] ~= nil then
						local var_300_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_297_1.actors_[var_300_1.prefab_name].transform, "story_v_out_320061", "320061072", "story_v_out_320061.awb")

						arg_297_1:RecordAudio("320061072", var_300_6)
						arg_297_1:RecordAudio("320061072", var_300_6)
					else
	...
	Play320061073 = function(arg_301_0, arg_301_1)
		...
		function arg_301_1.onSingleLineUpdate_(arg_304_0)
			...
			if 0 < arg_301_1.time_ and arg_301_1.time_ <= 0 + arg_304_0 then
				...
				local var_304_1 = arg_301_1:GetWordFromCfg(320061073)
				...
				local var_304_4 = 42 <= 0 and var_304_0 or var_304_0 * (utf8.len(var_304_2) / 42)

				if (42 <= 0 and var_304_0 or var_304_0 * (utf8.len(var_304_2) / 42)) > 0 and var_304_0 < var_304_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061073", "story_v_out_320061.awb") ~= 0 then
					local var_304_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061073", "story_v_out_320061.awb") / 1000
					...
					if var_304_1.prefab_name ~= "" and arg_301_1.actors_[var_304_1.prefab_name] ~= nil then
						local var_304_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_301_1.actors_[var_304_1.prefab_name].transform, "story_v_out_320061", "320061073", "story_v_out_320061.awb")

						arg_301_1:RecordAudio("320061073", var_304_6)
						arg_301_1:RecordAudio("320061073", var_304_6)
					else
	...
	Play320061074 = function(arg_305_0, arg_305_1)
		...
		function arg_305_1.onSingleLineUpdate_(arg_308_0)
			...
			if 0 < arg_305_1.time_ and arg_305_1.time_ <= 0 + arg_308_0 then
				...
				local var_308_1 = arg_305_1:GetWordFromCfg(320061074)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061074", "story_v_out_320061.awb") ~= 0 then
					local var_308_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061074", "story_v_out_320061.awb") / 1000
					...
					if var_308_1.prefab_name ~= "" and arg_305_1.actors_[var_308_1.prefab_name] ~= nil then
						local var_308_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_305_1.actors_[var_308_1.prefab_name].transform, "story_v_out_320061", "320061074", "story_v_out_320061.awb")

						arg_305_1:RecordAudio("320061074", var_308_6)
						arg_305_1:RecordAudio("320061074", var_308_6)
					else
	...
	Play320061075 = function(arg_309_0, arg_309_1)
		...
		function arg_309_1.onSingleLineUpdate_(arg_312_0)
			...
			if 0 < arg_309_1.time_ and arg_309_1.time_ <= 0 + arg_312_0 then
				...
				local var_312_1 = arg_309_1:GetWordFromCfg(320061075)
				...
				local var_312_4 = 14 <= 0 and var_312_0 or var_312_0 * (utf8.len(var_312_2) / 14)

				if (14 <= 0 and var_312_0 or var_312_0 * (utf8.len(var_312_2) / 14)) > 0 and var_312_0 < var_312_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061075", "story_v_out_320061.awb") ~= 0 then
					local var_312_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061075", "story_v_out_320061.awb") / 1000
					...
					if var_312_1.prefab_name ~= "" and arg_309_1.actors_[var_312_1.prefab_name] ~= nil then
						local var_312_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_309_1.actors_[var_312_1.prefab_name].transform, "story_v_out_320061", "320061075", "story_v_out_320061.awb")

						arg_309_1:RecordAudio("320061075", var_312_6)
						arg_309_1:RecordAudio("320061075", var_312_6)
					else
	...
	Play320061076 = function(arg_313_0, arg_313_1)
		...
		function arg_313_1.onSingleLineUpdate_(arg_316_0)
			...
			if 0 < arg_313_1.time_ and arg_313_1.time_ <= 0 + arg_316_0 then
				...
				arg_313_1.leftNameTxt_.text = arg_313_1:FormatText(StoryNameCfg[606].name)
				...
				local var_316_1 = arg_313_1:GetWordFromCfg(320061076)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061076", "story_v_out_320061.awb") ~= 0 then
					local var_316_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061076", "story_v_out_320061.awb") / 1000
					...
					if var_316_1.prefab_name ~= "" and arg_313_1.actors_[var_316_1.prefab_name] ~= nil then
						local var_316_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_313_1.actors_[var_316_1.prefab_name].transform, "story_v_out_320061", "320061076", "story_v_out_320061.awb")

						arg_313_1:RecordAudio("320061076", var_316_6)
						arg_313_1:RecordAudio("320061076", var_316_6)
					else
	...
	Play320061077 = function(arg_317_0, arg_317_1)
		...
		function arg_317_1.onSingleLineUpdate_(arg_320_0)
			...
			if 0 < arg_317_1.time_ and arg_317_1.time_ <= 0 + arg_320_0 then
				...
				local var_320_1 = arg_317_1:GetWordFromCfg(320061077)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061077", "story_v_out_320061.awb") ~= 0 then
					local var_320_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061077", "story_v_out_320061.awb") / 1000
					...
					if var_320_1.prefab_name ~= "" and arg_317_1.actors_[var_320_1.prefab_name] ~= nil then
						local var_320_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_317_1.actors_[var_320_1.prefab_name].transform, "story_v_out_320061", "320061077", "story_v_out_320061.awb")

						arg_317_1:RecordAudio("320061077", var_320_6)
						arg_317_1:RecordAudio("320061077", var_320_6)
					else
	...
	Play320061078 = function(arg_321_0, arg_321_1)
		...
		function arg_321_1.onSingleLineUpdate_(arg_324_0)
			...
			if 0 < arg_321_1.time_ and arg_321_1.time_ <= 0 + arg_324_0 then
				...
				arg_321_1.leftNameTxt_.text = arg_321_1:FormatText(StoryNameCfg[606].name)
				...
				local var_324_1 = arg_321_1:GetWordFromCfg(320061078)
				...
				local var_324_4 = 12 <= 0 and var_324_0 or var_324_0 * (utf8.len(var_324_2) / 12)

				if (12 <= 0 and var_324_0 or var_324_0 * (utf8.len(var_324_2) / 12)) > 0 and var_324_0 < var_324_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061078", "story_v_out_320061.awb") ~= 0 then
					local var_324_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061078", "story_v_out_320061.awb") / 1000
					...
					if var_324_1.prefab_name ~= "" and arg_321_1.actors_[var_324_1.prefab_name] ~= nil then
						local var_324_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_321_1.actors_[var_324_1.prefab_name].transform, "story_v_out_320061", "320061078", "story_v_out_320061.awb")

						arg_321_1:RecordAudio("320061078", var_324_6)
						arg_321_1:RecordAudio("320061078", var_324_6)
					else
	...
	Play320061079 = function(arg_325_0, arg_325_1)
		...
		function arg_325_1.onSingleLineUpdate_(arg_328_0)
			if 1.98333333333333 < arg_325_1.time_ and arg_325_1.time_ <= 1.98333333333333 + arg_328_0 then
				local var_328_0 = arg_325_1.bgs_.XS0102

				arg_325_1.bgs_.XS0102.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 4 < arg_325_1.time_ and arg_325_1.time_ <= var_328_3 + arg_328_0 then
			...
			local var_328_12 = arg_325_1.bgs_.XS0102.transform

			if 2 < arg_325_1.time_ and arg_325_1.time_ <= 2 + arg_328_0 then
				arg_325_1.var_.moveOldPosXS0102 = var_328_12.localPosition
			end

			local var_328_13 = 0.001

			if 2 <= arg_325_1.time_ and arg_325_1.time_ < 2 + var_328_13 then
				var_328_12.localPosition = Vector3.Lerp(arg_325_1.var_.moveOldPosXS0102, Vector3.New(-1, 0.5, 7), (arg_325_1.time_ - 2) / var_328_13)
			end

			if arg_325_1.time_ >= 2 + var_328_13 and arg_325_1.time_ < 2 + var_328_13 + arg_328_0 then
				var_328_12.localPosition = Vector3.New(-1, 0.5, 7)
			end

			local var_328_14 = arg_325_1.bgs_.XS0102.transform

			if 2.01666666666667 < arg_325_1.time_ and arg_325_1.time_ <= 2.01666666666667 + arg_328_0 then
				arg_325_1.var_.moveOldPosXS0102 = var_328_14.localPosition
			end

			local var_328_15 = 6

			if 2.01666666666667 <= arg_325_1.time_ and arg_325_1.time_ < 2.01666666666667 + var_328_15 then
				var_328_14.localPosition = Vector3.Lerp(arg_325_1.var_.moveOldPosXS0102, Vector3.New(-1.4, 0.5, 7), (arg_325_1.time_ - 2.01666666666667) / var_328_15)
			end

			if arg_325_1.time_ >= 2.01666666666667 + var_328_15 and arg_325_1.time_ < 2.01666666666667 + var_328_15 + arg_328_0 then
				var_328_14.localPosition = Vector3.New(-1.4, 0.5, 7)
			end

			local var_328_16 = 4.26666666666667

			if 4.26666666666667 < arg_325_1.time_ and arg_325_1.time_ <= var_328_16 + arg_328_0 then
				arg_325_1.allBtn_.enabled = false
			end

			if arg_325_1.time_ >= var_328_16 + 3.75 and arg_325_1.time_ < var_328_16 + 3.75 + arg_328_0 then
				arg_325_1.allBtn_.enabled = true
			end
			...
			if 4 < arg_325_1.time_ and arg_325_1.time_ <= var_328_17 + arg_328_0 then
				...
				local var_328_19 = LeanTween.value(arg_325_1.dialog_, 0, 1, 0.3)

				var_328_19:setOnUpdate(LuaHelper.FloatAction(function(arg_329_0)
					arg_325_1.dialogCg_.alpha = arg_329_0
				end))
				var_328_19:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_325_1.dialog_)
					var_328_19:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_328_20 = arg_325_1:GetWordFromCfg(320061079)
				local var_328_21 = arg_325_1:FormatText(var_328_20.content)

				arg_325_1.text_.text = var_328_21

				LuaForUtil.ClearLinePrefixSymbol(arg_325_1.text_)

				local var_328_23 = 13 <= 0 and var_328_18 or var_328_18 * (utf8.len(var_328_21) / 13)

				if (13 <= 0 and var_328_18 or var_328_18 * (utf8.len(var_328_21) / 13)) > 0 and var_328_18 < var_328_23 then
					arg_325_1.talkMaxDuration = var_328_23
					var_328_17 = var_328_17 + 0.3
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061079", "story_v_out_320061.awb") ~= 0 then
					local var_328_24 = manager.audio:GetVoiceLength("story_v_out_320061", "320061079", "story_v_out_320061.awb") / 1000

					if var_328_24 + var_328_17 > arg_325_1.duration_ then
						arg_325_1.duration_ = var_328_24 + var_328_17
					end

					if var_328_20.prefab_name ~= "" and arg_325_1.actors_[var_328_20.prefab_name] ~= nil then
						local var_328_25 = LuaForUtil.PlayVoiceWithCriLipsync(arg_325_1.actors_[var_328_20.prefab_name].transform, "story_v_out_320061", "320061079", "story_v_out_320061.awb")

						arg_325_1:RecordAudio("320061079", var_328_25)
						arg_325_1:RecordAudio("320061079", var_328_25)
					else
			...
			local var_328_26 = var_328_17 + 0.3
			local var_328_27 = math.max(var_328_18, arg_325_1.talkMaxDuration)

			if var_328_17 + 0.3 <= arg_325_1.time_ and arg_325_1.time_ < var_328_26 + var_328_27 then
				arg_325_1.typewritter.percent = (arg_325_1.time_ - var_328_26) / var_328_27

				arg_325_1.typewritter:SetDirty()
			end

			if arg_325_1.time_ >= var_328_26 + var_328_27 and arg_325_1.time_ < var_328_26 + var_328_27 + arg_328_0 then
	...
	Play320061080 = function(arg_331_0, arg_331_1)
		...
		function arg_331_1.onSingleLineUpdate_(arg_334_0)
			...
			if 0 < arg_331_1.time_ and arg_331_1.time_ <= 0 + arg_334_0 then
				...
				local var_334_1 = arg_331_1:FormatText(arg_331_1:GetWordFromCfg(320061080).content)
	...
	Play320061081 = function(arg_335_0, arg_335_1)
		...
		function arg_335_1.onSingleLineUpdate_(arg_338_0)
			...
			if 0 < arg_335_1.time_ and arg_335_1.time_ <= 0 + arg_338_0 then
				...
				arg_335_1.leftNameTxt_.text = arg_335_1:FormatText(StoryNameCfg[605].name)
				...
				local var_338_1 = arg_335_1:GetWordFromCfg(320061081)
				...
				local var_338_4 = 15 <= 0 and var_338_0 or var_338_0 * (utf8.len(var_338_2) / 15)

				if (15 <= 0 and var_338_0 or var_338_0 * (utf8.len(var_338_2) / 15)) > 0 and var_338_0 < var_338_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061081", "story_v_out_320061.awb") ~= 0 then
					local var_338_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061081", "story_v_out_320061.awb") / 1000
					...
					if var_338_1.prefab_name ~= "" and arg_335_1.actors_[var_338_1.prefab_name] ~= nil then
						local var_338_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_335_1.actors_[var_338_1.prefab_name].transform, "story_v_out_320061", "320061081", "story_v_out_320061.awb")

						arg_335_1:RecordAudio("320061081", var_338_6)
						arg_335_1:RecordAudio("320061081", var_338_6)
					else
	...
	Play320061082 = function(arg_339_0, arg_339_1)
		...
		function arg_339_1.onSingleLineUpdate_(arg_342_0)
			...
			if 0 < arg_339_1.time_ and arg_339_1.time_ <= 0 + arg_342_0 then
				...
				local var_342_1 = arg_339_1:GetWordFromCfg(320061082)
				...
				local var_342_4 = 28 <= 0 and var_342_0 or var_342_0 * (utf8.len(var_342_2) / 28)

				if (28 <= 0 and var_342_0 or var_342_0 * (utf8.len(var_342_2) / 28)) > 0 and var_342_0 < var_342_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061082", "story_v_out_320061.awb") ~= 0 then
					local var_342_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061082", "story_v_out_320061.awb") / 1000
					...
					if var_342_1.prefab_name ~= "" and arg_339_1.actors_[var_342_1.prefab_name] ~= nil then
						local var_342_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_339_1.actors_[var_342_1.prefab_name].transform, "story_v_out_320061", "320061082", "story_v_out_320061.awb")

						arg_339_1:RecordAudio("320061082", var_342_6)
						arg_339_1:RecordAudio("320061082", var_342_6)
					else
	...
	Play320061083 = function(arg_343_0, arg_343_1)
		...
		function arg_343_1.onSingleLineUpdate_(arg_346_0)
			...
			if 0 < arg_343_1.time_ and arg_343_1.time_ <= 0 + arg_346_0 then
				...
				local var_346_1 = arg_343_1:GetWordFromCfg(320061083)
				...
				local var_346_4 = 27 <= 0 and var_346_0 or var_346_0 * (utf8.len(var_346_2) / 27)

				if (27 <= 0 and var_346_0 or var_346_0 * (utf8.len(var_346_2) / 27)) > 0 and var_346_0 < var_346_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061083", "story_v_out_320061.awb") ~= 0 then
					local var_346_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061083", "story_v_out_320061.awb") / 1000
					...
					if var_346_1.prefab_name ~= "" and arg_343_1.actors_[var_346_1.prefab_name] ~= nil then
						local var_346_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_343_1.actors_[var_346_1.prefab_name].transform, "story_v_out_320061", "320061083", "story_v_out_320061.awb")

						arg_343_1:RecordAudio("320061083", var_346_6)
						arg_343_1:RecordAudio("320061083", var_346_6)
					else
	...
	Play320061084 = function(arg_347_0, arg_347_1)
		...
		function arg_347_1.onSingleLineUpdate_(arg_350_0)
			...
			if 0 < arg_347_1.time_ and arg_347_1.time_ <= 0 + arg_350_0 then
				...
				local var_350_1 = arg_347_1:GetWordFromCfg(320061084)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061084", "story_v_out_320061.awb") ~= 0 then
					local var_350_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061084", "story_v_out_320061.awb") / 1000
					...
					if var_350_1.prefab_name ~= "" and arg_347_1.actors_[var_350_1.prefab_name] ~= nil then
						local var_350_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_347_1.actors_[var_350_1.prefab_name].transform, "story_v_out_320061", "320061084", "story_v_out_320061.awb")

						arg_347_1:RecordAudio("320061084", var_350_6)
						arg_347_1:RecordAudio("320061084", var_350_6)
					else
	...
	Play320061085 = function(arg_351_0, arg_351_1)
		...
		function arg_351_1.onSingleLineUpdate_(arg_354_0)
			...
			if 0 < arg_351_1.time_ and arg_351_1.time_ <= 0 + arg_354_0 then
				...
				local var_354_1 = arg_351_1:GetWordFromCfg(320061085)
				...
				local var_354_4 = 13 <= 0 and var_354_0 or var_354_0 * (utf8.len(var_354_2) / 13)

				if (13 <= 0 and var_354_0 or var_354_0 * (utf8.len(var_354_2) / 13)) > 0 and var_354_0 < var_354_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061085", "story_v_out_320061.awb") ~= 0 then
					local var_354_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061085", "story_v_out_320061.awb") / 1000
					...
					if var_354_1.prefab_name ~= "" and arg_351_1.actors_[var_354_1.prefab_name] ~= nil then
						local var_354_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_351_1.actors_[var_354_1.prefab_name].transform, "story_v_out_320061", "320061085", "story_v_out_320061.awb")

						arg_351_1:RecordAudio("320061085", var_354_6)
						arg_351_1:RecordAudio("320061085", var_354_6)
					else
	...
	Play320061086 = function(arg_355_0, arg_355_1)
		...
		function arg_355_1.onSingleLineUpdate_(arg_358_0)
			...
			if 0 < arg_355_1.time_ and arg_355_1.time_ <= 0 + arg_358_0 then
				...
				arg_355_1.leftNameTxt_.text = arg_355_1:FormatText(StoryNameCfg[1033].name)
				...
				local var_358_1 = arg_355_1:FormatText(arg_355_1:GetWordFromCfg(320061086).content)

				arg_355_1.text_.text = var_358_1

				LuaForUtil.ClearLinePrefixSymbol(arg_355_1.text_)

				local var_358_3 = 6 <= 0 and var_358_0 or var_358_0 * (utf8.len(var_358_1) / 6)

				if (6 <= 0 and var_358_0 or var_358_0 * (utf8.len(var_358_1) / 6)) > 0 and var_358_0 < var_358_3 then
	...
	Play320061087 = function(arg_359_0, arg_359_1)
		...
		function arg_359_1.onSingleLineUpdate_(arg_362_0)
			if 2 < arg_359_1.time_ and arg_359_1.time_ <= 2 + arg_362_0 then
				local var_362_0 = arg_359_1.bgs_.ST61

				arg_359_1.bgs_.ST61.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_362_3 = 4.00000000298023

			if 4.00000000298023 < arg_359_1.time_ and arg_359_1.time_ <= var_362_3 + arg_362_0 then
				arg_359_1.allBtn_.enabled = false
			end

			if arg_359_1.time_ >= var_362_3 + 0.3 and arg_359_1.time_ < var_362_3 + 0.3 + arg_362_0 then
			...
			local var_362_8 = 2.00000000298023

			if 2.00000000298023 < arg_359_1.time_ and arg_359_1.time_ <= var_362_8 + arg_362_0 then
				arg_359_1.mask_.enabled = true
				arg_359_1.mask_.raycastTarget = true
			...
			local var_362_12 = arg_359_1.actors_["1020ui_story"].transform

			if 3.8 < arg_359_1.time_ and arg_359_1.time_ <= 3.8 + arg_362_0 then
				arg_359_1.var_.moveOldPos1020ui_story = var_362_12.localPosition
			end

			local var_362_13 = 0.001

			if 3.8 <= arg_359_1.time_ and arg_359_1.time_ < 3.8 + var_362_13 then
				var_362_12.localPosition = Vector3.Lerp(arg_359_1.var_.moveOldPos1020ui_story, Vector3.New(0, -0.85, -6.25), (arg_359_1.time_ - 3.8) / var_362_13)
				var_362_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_362_12.position).x, (manager.ui.mainCamera.transform.position - var_362_12.position).y, (manager.ui.mainCamera.transform.position - var_362_12.position).z)
				var_362_12.localEulerAngles.z = 0
				var_362_12.localEulerAngles.x = 0
				var_362_12.localEulerAngles = var_362_12.localEulerAngles
			end

			if arg_359_1.time_ >= 3.8 + var_362_13 and arg_359_1.time_ < 3.8 + var_362_13 + arg_362_0 then
				var_362_12.localPosition = Vector3.New(0, -0.85, -6.25)
				var_362_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_362_12.position).x, (manager.ui.mainCamera.transform.position - var_362_12.position).y, (manager.ui.mainCamera.transform.position - var_362_12.position).z)
				var_362_12.localEulerAngles.z = 0
				var_362_12.localEulerAngles.x = 0
				var_362_12.localEulerAngles = var_362_12.localEulerAngles
			...
			local var_362_14 = arg_359_1.actors_["1020ui_story"]

			if 3.8 < arg_359_1.time_ and arg_359_1.time_ <= 3.8 + arg_362_0 and not isNil(var_362_14) and arg_359_1.var_.characterEffect1020ui_story == nil then
				arg_359_1.var_.characterEffect1020ui_story = var_362_14:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_362_15 = 0.200000002980232

			if 3.8 <= arg_359_1.time_ and arg_359_1.time_ < 3.8 + var_362_15 and not isNil(var_362_14) then
				if arg_359_1.var_.characterEffect1020ui_story and not isNil(var_362_14) then
					arg_359_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_359_1.time_ >= 3.8 + var_362_15 and arg_359_1.time_ < 3.8 + var_362_15 + arg_362_0 and not isNil(var_362_14) and arg_359_1.var_.characterEffect1020ui_story then
				arg_359_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			local var_362_17 = 4.00000000298023
			local var_362_18 = 0.85

			if 4.00000000298023 < arg_359_1.time_ and arg_359_1.time_ <= var_362_17 + arg_362_0 then
				...
				arg_359_1.leftNameTxt_.text = arg_359_1:FormatText(StoryNameCfg[613].name)
				...
				local var_362_20 = arg_359_1:GetWordFromCfg(320061087)
				...
				local var_362_23 = 34 <= 0 and var_362_18 or var_362_18 * (utf8.len(var_362_21) / 34)

				if (34 <= 0 and var_362_18 or var_362_18 * (utf8.len(var_362_21) / 34)) > 0 and var_362_18 < var_362_23 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061087", "story_v_out_320061.awb") ~= 0 then
					local var_362_24 = manager.audio:GetVoiceLength("story_v_out_320061", "320061087", "story_v_out_320061.awb") / 1000

					if var_362_24 + var_362_17 > arg_359_1.duration_ then
						arg_359_1.duration_ = var_362_24 + var_362_17
					end

					if var_362_20.prefab_name ~= "" and arg_359_1.actors_[var_362_20.prefab_name] ~= nil then
						local var_362_25 = LuaForUtil.PlayVoiceWithCriLipsync(arg_359_1.actors_[var_362_20.prefab_name].transform, "story_v_out_320061", "320061087", "story_v_out_320061.awb")

						arg_359_1:RecordAudio("320061087", var_362_25)
						arg_359_1:RecordAudio("320061087", var_362_25)
					else
			...
			local var_362_26 = var_362_17 + 0.3
			local var_362_27 = math.max(var_362_18, arg_359_1.talkMaxDuration)

			if var_362_17 + 0.3 <= arg_359_1.time_ and arg_359_1.time_ < var_362_26 + var_362_27 then
				arg_359_1.typewritter.percent = (arg_359_1.time_ - var_362_26) / var_362_27
	...
	Play320061088 = function(arg_365_0, arg_365_1)
		...
		function arg_365_1.onSingleLineUpdate_(arg_368_0)
			...
			if 0 < arg_365_1.time_ and arg_365_1.time_ <= 0 + arg_368_0 then
				...
				local var_368_1 = arg_365_1:GetWordFromCfg(320061088)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061088", "story_v_out_320061.awb") ~= 0 then
					local var_368_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061088", "story_v_out_320061.awb") / 1000
					...
					if var_368_1.prefab_name ~= "" and arg_365_1.actors_[var_368_1.prefab_name] ~= nil then
						local var_368_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_365_1.actors_[var_368_1.prefab_name].transform, "story_v_out_320061", "320061088", "story_v_out_320061.awb")

						arg_365_1:RecordAudio("320061088", var_368_6)
						arg_365_1:RecordAudio("320061088", var_368_6)
					else
	...
	Play320061089 = function(arg_369_0, arg_369_1)
		...
		function arg_369_1.onSingleLineUpdate_(arg_372_0)
			...
			if 0 < arg_369_1.time_ and arg_369_1.time_ <= var_372_0 + arg_372_0 then
				...
				arg_369_1.leftNameTxt_.text = arg_369_1:FormatText(StoryNameCfg[613].name)
				...
				local var_372_2 = arg_369_1:GetWordFromCfg(320061089)
				...
				local var_372_5 = 51 <= 0 and var_372_1 or var_372_1 * (utf8.len(var_372_3) / 51)

				if (51 <= 0 and var_372_1 or var_372_1 * (utf8.len(var_372_3) / 51)) > 0 and var_372_1 < var_372_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061089", "story_v_out_320061.awb") ~= 0 then
					local var_372_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061089", "story_v_out_320061.awb") / 1000
					...
					if var_372_2.prefab_name ~= "" and arg_369_1.actors_[var_372_2.prefab_name] ~= nil then
						local var_372_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_369_1.actors_[var_372_2.prefab_name].transform, "story_v_out_320061", "320061089", "story_v_out_320061.awb")

						arg_369_1:RecordAudio("320061089", var_372_7)
						arg_369_1:RecordAudio("320061089", var_372_7)
					else
		...
		function arg_373_1.onSingleLineUpdate_(arg_376_0)
			...
			if 0 <= arg_373_1.time_ and arg_373_1.time_ < 0 + var_376_0 and not isNil(arg_373_1.actors_["1020ui_story"]) then
				if arg_373_1.var_.characterEffect1020ui_story and not isNil(arg_373_1.actors_["1020ui_story"]) then
					...
					arg_373_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_373_1.time_ - 0) / var_376_0)
				end
			end
			...
			if arg_373_1.time_ >= 0 + var_376_0 and arg_373_1.time_ < 0 + var_376_0 + arg_376_0 and not isNil(arg_373_1.actors_["1020ui_story"]) and arg_373_1.var_.characterEffect1020ui_story then
				arg_373_1.var_.characterEffect1020ui_story.fillFlat = true
				arg_373_1.var_.characterEffect1020ui_story.fillRatio = 0.5
			end

			local var_376_1 = 0
			local var_376_2 = 0.075
			...
			if 0 < arg_373_1.time_ and arg_373_1.time_ <= var_376_1 + arg_376_0 then
				...
				local var_376_3 = arg_373_1:FormatText(arg_373_1:GetWordFromCfg(320061090).content)

				arg_373_1.text_.text = var_376_3

				LuaForUtil.ClearLinePrefixSymbol(arg_373_1.text_)

				local var_376_5 = 3 <= 0 and var_376_2 or var_376_2 * (utf8.len(var_376_3) / 3)

				if (3 <= 0 and var_376_2 or var_376_2 * (utf8.len(var_376_3) / 3)) > 0 and var_376_2 < var_376_5 then
	...
	Play320061091 = function(arg_377_0, arg_377_1)
		...
		function arg_377_1.onSingleLineUpdate_(arg_380_0)
			if 0 < arg_377_1.time_ and arg_377_1.time_ <= 0 + arg_380_0 then
				arg_377_1.var_.moveOldPos1020ui_story = arg_377_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_380_0 = 0.001

			if 0 <= arg_377_1.time_ and arg_377_1.time_ < 0 + var_380_0 then
				arg_377_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_377_1.var_.moveOldPos1020ui_story, Vector3.New(0, 100, 0), (arg_377_1.time_ - 0) / var_380_0)
				arg_377_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_377_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_377_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_377_1.actors_["1020ui_story"].transform.position).z)
				arg_377_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_377_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_377_1.actors_["1020ui_story"].transform.localEulerAngles = arg_377_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_377_1.time_ >= 0 + var_380_0 and arg_377_1.time_ < 0 + var_380_0 + arg_380_0 then
				arg_377_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_377_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_377_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_377_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_377_1.actors_["1020ui_story"].transform.position).z)
				arg_377_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_377_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_377_1.actors_["1020ui_story"].transform.localEulerAngles = arg_377_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_380_1 = "1089ui_story"

			if arg_377_1.actors_["1089ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1089ui_story"))) then
				local var_380_2 = Object.Instantiate(Asset.Load("Char/" .. "1089ui_story"), arg_377_1.stage_.transform)

				var_380_2.name = var_380_1
				var_380_2.transform.localPosition = Vector3.New(0, 100, 0)
				arg_377_1.actors_[var_380_1] = var_380_2
				...
				arg_377_1.var_[var_380_1 .. "Animator"] = var_380_3.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_377_1.var_[var_380_1 .. "Animator"].applyRootMotion = true
				arg_377_1.var_[var_380_1 .. "LipSync"] = var_380_3.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_380_5 = arg_377_1.actors_["1089ui_story"]

			if 0 < arg_377_1.time_ and arg_377_1.time_ <= 0 + arg_380_0 and not isNil(var_380_5) and arg_377_1.var_.characterEffect1089ui_story == nil then
				arg_377_1.var_.characterEffect1089ui_story = var_380_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_380_6 = 0.200000002980232

			if 0 <= arg_377_1.time_ and arg_377_1.time_ < 0 + var_380_6 and not isNil(var_380_5) then
				if arg_377_1.var_.characterEffect1089ui_story and not isNil(var_380_5) then
					arg_377_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_377_1.time_ >= 0 + var_380_6 and arg_377_1.time_ < 0 + var_380_6 + arg_380_0 and not isNil(var_380_5) and arg_377_1.var_.characterEffect1089ui_story then
				arg_377_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			local var_380_8 = arg_377_1.actors_["1089ui_story"].transform

			if 0 < arg_377_1.time_ and arg_377_1.time_ <= 0 + arg_380_0 then
				arg_377_1.var_.moveOldPos1089ui_story = var_380_8.localPosition
			end

			local var_380_9 = 0.001

			if 0 <= arg_377_1.time_ and arg_377_1.time_ < 0 + var_380_9 then
				var_380_8.localPosition = Vector3.Lerp(arg_377_1.var_.moveOldPos1089ui_story, Vector3.New(0, -1.1, -6.17), (arg_377_1.time_ - 0) / var_380_9)
				var_380_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_380_8.position).x, (manager.ui.mainCamera.transform.position - var_380_8.position).y, (manager.ui.mainCamera.transform.position - var_380_8.position).z)
				var_380_8.localEulerAngles.z = 0
				var_380_8.localEulerAngles.x = 0
				var_380_8.localEulerAngles = var_380_8.localEulerAngles
			end

			if arg_377_1.time_ >= 0 + var_380_9 and arg_377_1.time_ < 0 + var_380_9 + arg_380_0 then
				var_380_8.localPosition = Vector3.New(0, -1.1, -6.17)
				var_380_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_380_8.position).x, (manager.ui.mainCamera.transform.position - var_380_8.position).y, (manager.ui.mainCamera.transform.position - var_380_8.position).z)
				var_380_8.localEulerAngles.z = 0
				var_380_8.localEulerAngles.x = 0
				var_380_8.localEulerAngles = var_380_8.localEulerAngles
			...
			if 0 < arg_377_1.time_ and arg_377_1.time_ <= var_380_10 + arg_380_0 then
				...
				arg_377_1.leftNameTxt_.text = arg_377_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_380_12 = arg_377_1:GetWordFromCfg(320061091)
				...
				local var_380_15 = 31 <= 0 and var_380_11 or var_380_11 * (utf8.len(var_380_13) / 31)

				if (31 <= 0 and var_380_11 or var_380_11 * (utf8.len(var_380_13) / 31)) > 0 and var_380_11 < var_380_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061091", "story_v_out_320061.awb") ~= 0 then
					local var_380_16 = manager.audio:GetVoiceLength("story_v_out_320061", "320061091", "story_v_out_320061.awb") / 1000
					...
					if var_380_12.prefab_name ~= "" and arg_377_1.actors_[var_380_12.prefab_name] ~= nil then
						local var_380_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_377_1.actors_[var_380_12.prefab_name].transform, "story_v_out_320061", "320061091", "story_v_out_320061.awb")

						arg_377_1:RecordAudio("320061091", var_380_17)
						arg_377_1:RecordAudio("320061091", var_380_17)
					else
	...
	Play320061092 = function(arg_381_0, arg_381_1)
		...
		function arg_381_1.onSingleLineUpdate_(arg_384_0)
			...
			if 0 < arg_381_1.time_ and arg_381_1.time_ <= var_384_0 + arg_384_0 then
				...
				arg_381_1.leftNameTxt_.text = arg_381_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_384_2 = arg_381_1:GetWordFromCfg(320061092)
				...
				local var_384_5 = 16 <= 0 and var_384_1 or var_384_1 * (utf8.len(var_384_3) / 16)

				if (16 <= 0 and var_384_1 or var_384_1 * (utf8.len(var_384_3) / 16)) > 0 and var_384_1 < var_384_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061092", "story_v_out_320061.awb") ~= 0 then
					local var_384_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061092", "story_v_out_320061.awb") / 1000
					...
					if var_384_2.prefab_name ~= "" and arg_381_1.actors_[var_384_2.prefab_name] ~= nil then
						local var_384_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_381_1.actors_[var_384_2.prefab_name].transform, "story_v_out_320061", "320061092", "story_v_out_320061.awb")

						arg_381_1:RecordAudio("320061092", var_384_7)
						arg_381_1:RecordAudio("320061092", var_384_7)
					else
	...
	Play320061093 = function(arg_385_0, arg_385_1)
		...
		function arg_385_1.onSingleLineUpdate_(arg_388_0)
			if 0 < arg_385_1.time_ and arg_385_1.time_ <= 0 + arg_388_0 then
				arg_385_1.var_.moveOldPos1089ui_story = arg_385_1.actors_["1089ui_story"].transform.localPosition
			end

			local var_388_0 = 0.001

			if 0 <= arg_385_1.time_ and arg_385_1.time_ < 0 + var_388_0 then
				arg_385_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_385_1.var_.moveOldPos1089ui_story, Vector3.New(0, 100, 0), (arg_385_1.time_ - 0) / var_388_0)
				arg_385_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_385_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_385_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_385_1.actors_["1089ui_story"].transform.position).z)
				arg_385_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_385_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_385_1.actors_["1089ui_story"].transform.localEulerAngles = arg_385_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_385_1.time_ >= 0 + var_388_0 and arg_385_1.time_ < 0 + var_388_0 + arg_388_0 then
				arg_385_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_385_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_385_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_385_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_385_1.actors_["1089ui_story"].transform.position).z)
				arg_385_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_385_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_385_1.actors_["1089ui_story"].transform.localEulerAngles = arg_385_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_388_1 = arg_385_1.actors_["1089ui_story"]

			if 0 < arg_385_1.time_ and arg_385_1.time_ <= 0 + arg_388_0 and not isNil(var_388_1) and arg_385_1.var_.characterEffect1089ui_story == nil then
				arg_385_1.var_.characterEffect1089ui_story = var_388_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_388_2 = 0.200000002980232

			if 0 <= arg_385_1.time_ and arg_385_1.time_ < 0 + var_388_2 and not isNil(var_388_1) then
				if arg_385_1.var_.characterEffect1089ui_story and not isNil(var_388_1) then
					arg_385_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_385_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_385_1.time_ - 0) / var_388_2)
				end
			end

			if arg_385_1.time_ >= 0 + var_388_2 and arg_385_1.time_ < 0 + var_388_2 + arg_388_0 and not isNil(var_388_1) and arg_385_1.var_.characterEffect1089ui_story then
				arg_385_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_385_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end

			local var_388_3 = 0
			local var_388_4 = 1.45
			...
			if 0 < arg_385_1.time_ and arg_385_1.time_ <= var_388_3 + arg_388_0 then
				...
				local var_388_5 = arg_385_1:FormatText(arg_385_1:GetWordFromCfg(320061093).content)

				arg_385_1.text_.text = var_388_5

				LuaForUtil.ClearLinePrefixSymbol(arg_385_1.text_)

				local var_388_7 = 58 <= 0 and var_388_4 or var_388_4 * (utf8.len(var_388_5) / 58)

				if (58 <= 0 and var_388_4 or var_388_4 * (utf8.len(var_388_5) / 58)) > 0 and var_388_4 < var_388_7 then
	...
	Play320061094 = function(arg_389_0, arg_389_1)
		...
		function arg_389_1.onSingleLineUpdate_(arg_392_0)
			...
			if 0 < arg_389_1.time_ and arg_389_1.time_ <= 0 + arg_392_0 then
				...
				local var_392_1 = arg_389_1:FormatText(arg_389_1:GetWordFromCfg(320061094).content)

				arg_389_1.text_.text = var_392_1

				LuaForUtil.ClearLinePrefixSymbol(arg_389_1.text_)

				local var_392_3 = 20 <= 0 and var_392_0 or var_392_0 * (utf8.len(var_392_1) / 20)

				if (20 <= 0 and var_392_0 or var_392_0 * (utf8.len(var_392_1) / 20)) > 0 and var_392_0 < var_392_3 then
	...
	Play320061095 = function(arg_393_0, arg_393_1)
		...
		function arg_393_1.onSingleLineUpdate_(arg_396_0)
			if 0 < arg_393_1.time_ and arg_393_1.time_ <= 0 + arg_396_0 then
				arg_393_1.var_.moveOldPos1089ui_story = arg_393_1.actors_["1089ui_story"].transform.localPosition
			end

			local var_396_0 = 0.001

			if 0 <= arg_393_1.time_ and arg_393_1.time_ < 0 + var_396_0 then
				arg_393_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_393_1.var_.moveOldPos1089ui_story, Vector3.New(0, -1.1, -6.17), (arg_393_1.time_ - 0) / var_396_0)
				arg_393_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_393_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_393_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_393_1.actors_["1089ui_story"].transform.position).z)
				arg_393_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_393_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_393_1.actors_["1089ui_story"].transform.localEulerAngles = arg_393_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_393_1.time_ >= 0 + var_396_0 and arg_393_1.time_ < 0 + var_396_0 + arg_396_0 then
				arg_393_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(0, -1.1, -6.17)
				arg_393_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_393_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_393_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_393_1.actors_["1089ui_story"].transform.position).z)
				arg_393_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_393_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_393_1.actors_["1089ui_story"].transform.localEulerAngles = arg_393_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_396_1 = arg_393_1.actors_["1089ui_story"]

			if 0 < arg_393_1.time_ and arg_393_1.time_ <= 0 + arg_396_0 and not isNil(var_396_1) and arg_393_1.var_.characterEffect1089ui_story == nil then
				arg_393_1.var_.characterEffect1089ui_story = var_396_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_396_2 = 0.200000002980232

			if 0 <= arg_393_1.time_ and arg_393_1.time_ < 0 + var_396_2 and not isNil(var_396_1) then
				if arg_393_1.var_.characterEffect1089ui_story and not isNil(var_396_1) then
					arg_393_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_393_1.time_ >= 0 + var_396_2 and arg_393_1.time_ < 0 + var_396_2 + arg_396_0 and not isNil(var_396_1) and arg_393_1.var_.characterEffect1089ui_story then
				arg_393_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			if 0 < arg_393_1.time_ and arg_393_1.time_ <= var_396_4 + arg_396_0 then
				...
				arg_393_1.leftNameTxt_.text = arg_393_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_396_6 = arg_393_1:GetWordFromCfg(320061095)
				...
				local var_396_9 = 22 <= 0 and var_396_5 or var_396_5 * (utf8.len(var_396_7) / 22)

				if (22 <= 0 and var_396_5 or var_396_5 * (utf8.len(var_396_7) / 22)) > 0 and var_396_5 < var_396_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061095", "story_v_out_320061.awb") ~= 0 then
					local var_396_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061095", "story_v_out_320061.awb") / 1000
					...
					if var_396_6.prefab_name ~= "" and arg_393_1.actors_[var_396_6.prefab_name] ~= nil then
						local var_396_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_393_1.actors_[var_396_6.prefab_name].transform, "story_v_out_320061", "320061095", "story_v_out_320061.awb")

						arg_393_1:RecordAudio("320061095", var_396_11)
						arg_393_1:RecordAudio("320061095", var_396_11)
					else
	...
	Play320061096 = function(arg_397_0, arg_397_1)
		...
		function arg_397_1.onSingleLineUpdate_(arg_400_0)
			...
			if 0 < arg_397_1.time_ and arg_397_1.time_ <= var_400_0 + arg_400_0 then
				...
				arg_397_1.leftNameTxt_.text = arg_397_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_400_2 = arg_397_1:GetWordFromCfg(320061096)
				...
				local var_400_5 = 44 <= 0 and var_400_1 or var_400_1 * (utf8.len(var_400_3) / 44)

				if (44 <= 0 and var_400_1 or var_400_1 * (utf8.len(var_400_3) / 44)) > 0 and var_400_1 < var_400_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061096", "story_v_out_320061.awb") ~= 0 then
					local var_400_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061096", "story_v_out_320061.awb") / 1000
					...
					if var_400_2.prefab_name ~= "" and arg_397_1.actors_[var_400_2.prefab_name] ~= nil then
						local var_400_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_397_1.actors_[var_400_2.prefab_name].transform, "story_v_out_320061", "320061096", "story_v_out_320061.awb")

						arg_397_1:RecordAudio("320061096", var_400_7)
						arg_397_1:RecordAudio("320061096", var_400_7)
					else
	...
	Play320061097 = function(arg_401_0, arg_401_1)
		...
		function arg_401_1.onSingleLineUpdate_(arg_404_0)
			if 0 < arg_401_1.time_ and arg_401_1.time_ <= 0 + arg_404_0 then
				arg_401_1.var_.moveOldPos1089ui_story = arg_401_1.actors_["1089ui_story"].transform.localPosition
			end

			local var_404_0 = 0.001

			if 0 <= arg_401_1.time_ and arg_401_1.time_ < 0 + var_404_0 then
				arg_401_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_401_1.var_.moveOldPos1089ui_story, Vector3.New(-0.7, -1.1, -6.17), (arg_401_1.time_ - 0) / var_404_0)
				arg_401_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_401_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_401_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_401_1.actors_["1089ui_story"].transform.position).z)
				arg_401_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_401_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_401_1.actors_["1089ui_story"].transform.localEulerAngles = arg_401_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_401_1.time_ >= 0 + var_404_0 and arg_401_1.time_ < 0 + var_404_0 + arg_404_0 then
				arg_401_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(-0.7, -1.1, -6.17)
				arg_401_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_401_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_401_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_401_1.actors_["1089ui_story"].transform.position).z)
				arg_401_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_401_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_401_1.actors_["1089ui_story"].transform.localEulerAngles = arg_401_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_404_1 = arg_401_1.actors_["1089ui_story"]

			if 0 < arg_401_1.time_ and arg_401_1.time_ <= 0 + arg_404_0 and not isNil(var_404_1) and arg_401_1.var_.characterEffect1089ui_story == nil then
				arg_401_1.var_.characterEffect1089ui_story = var_404_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_404_2 = 0.200000002980232

			if 0 <= arg_401_1.time_ and arg_401_1.time_ < 0 + var_404_2 and not isNil(var_404_1) then
				if arg_401_1.var_.characterEffect1089ui_story and not isNil(var_404_1) then
					arg_401_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_401_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_401_1.time_ - 0) / var_404_2)
				end
			end

			if arg_401_1.time_ >= 0 + var_404_2 and arg_401_1.time_ < 0 + var_404_2 + arg_404_0 and not isNil(var_404_1) and arg_401_1.var_.characterEffect1089ui_story then
				arg_401_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_401_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end

			local var_404_3 = arg_401_1.actors_["1020ui_story"].transform

			if 0 < arg_401_1.time_ and arg_401_1.time_ <= 0 + arg_404_0 then
				arg_401_1.var_.moveOldPos1020ui_story = var_404_3.localPosition
			end

			local var_404_4 = 0.001

			if 0 <= arg_401_1.time_ and arg_401_1.time_ < 0 + var_404_4 then
				var_404_3.localPosition = Vector3.Lerp(arg_401_1.var_.moveOldPos1020ui_story, Vector3.New(0.7, -0.85, -6.25), (arg_401_1.time_ - 0) / var_404_4)
				var_404_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_404_3.position).x, (manager.ui.mainCamera.transform.position - var_404_3.position).y, (manager.ui.mainCamera.transform.position - var_404_3.position).z)
				var_404_3.localEulerAngles.z = 0
				var_404_3.localEulerAngles.x = 0
				var_404_3.localEulerAngles = var_404_3.localEulerAngles
			end

			if arg_401_1.time_ >= 0 + var_404_4 and arg_401_1.time_ < 0 + var_404_4 + arg_404_0 then
				var_404_3.localPosition = Vector3.New(0.7, -0.85, -6.25)
				var_404_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_404_3.position).x, (manager.ui.mainCamera.transform.position - var_404_3.position).y, (manager.ui.mainCamera.transform.position - var_404_3.position).z)
				var_404_3.localEulerAngles.z = 0
				var_404_3.localEulerAngles.x = 0
				var_404_3.localEulerAngles = var_404_3.localEulerAngles
			...
			local var_404_5 = arg_401_1.actors_["1020ui_story"]

			if 0 < arg_401_1.time_ and arg_401_1.time_ <= 0 + arg_404_0 and not isNil(var_404_5) and arg_401_1.var_.characterEffect1020ui_story == nil then
				arg_401_1.var_.characterEffect1020ui_story = var_404_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_404_6 = 0.200000002980232

			if 0 <= arg_401_1.time_ and arg_401_1.time_ < 0 + var_404_6 and not isNil(var_404_5) then
				if arg_401_1.var_.characterEffect1020ui_story and not isNil(var_404_5) then
					arg_401_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_401_1.time_ >= 0 + var_404_6 and arg_401_1.time_ < 0 + var_404_6 + arg_404_0 and not isNil(var_404_5) and arg_401_1.var_.characterEffect1020ui_story then
				arg_401_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			if 0 < arg_401_1.time_ and arg_401_1.time_ <= var_404_8 + arg_404_0 then
				...
				local var_404_10 = arg_401_1:GetWordFromCfg(320061097)
				...
				local var_404_13 = 18 <= 0 and var_404_9 or var_404_9 * (utf8.len(var_404_11) / 18)

				if (18 <= 0 and var_404_9 or var_404_9 * (utf8.len(var_404_11) / 18)) > 0 and var_404_9 < var_404_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061097", "story_v_out_320061.awb") ~= 0 then
					local var_404_14 = manager.audio:GetVoiceLength("story_v_out_320061", "320061097", "story_v_out_320061.awb") / 1000
					...
					if var_404_10.prefab_name ~= "" and arg_401_1.actors_[var_404_10.prefab_name] ~= nil then
						local var_404_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_401_1.actors_[var_404_10.prefab_name].transform, "story_v_out_320061", "320061097", "story_v_out_320061.awb")

						arg_401_1:RecordAudio("320061097", var_404_15)
						arg_401_1:RecordAudio("320061097", var_404_15)
					else
	...
	Play320061098 = function(arg_405_0, arg_405_1)
		...
		function arg_405_1.onSingleLineUpdate_(arg_408_0)
			...
			if 0 < arg_405_1.time_ and arg_405_1.time_ <= var_408_0 + arg_408_0 then
				...
				local var_408_2 = arg_405_1:GetWordFromCfg(320061098)
				...
				local var_408_5 = 41 <= 0 and var_408_1 or var_408_1 * (utf8.len(var_408_3) / 41)

				if (41 <= 0 and var_408_1 or var_408_1 * (utf8.len(var_408_3) / 41)) > 0 and var_408_1 < var_408_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061098", "story_v_out_320061.awb") ~= 0 then
					local var_408_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061098", "story_v_out_320061.awb") / 1000
					...
					if var_408_2.prefab_name ~= "" and arg_405_1.actors_[var_408_2.prefab_name] ~= nil then
						local var_408_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_405_1.actors_[var_408_2.prefab_name].transform, "story_v_out_320061", "320061098", "story_v_out_320061.awb")

						arg_405_1:RecordAudio("320061098", var_408_7)
						arg_405_1:RecordAudio("320061098", var_408_7)
					else
	...
	Play320061099 = function(arg_409_0, arg_409_1)
		...
		function arg_409_1.onSingleLineUpdate_(arg_412_0)
			if 0 < arg_409_1.time_ and arg_409_1.time_ <= 0 + arg_412_0 then
				arg_409_1.var_.moveOldPos1020ui_story = arg_409_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_412_0 = 0.001

			if 0 <= arg_409_1.time_ and arg_409_1.time_ < 0 + var_412_0 then
				arg_409_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_409_1.var_.moveOldPos1020ui_story, Vector3.New(0, 100, 0), (arg_409_1.time_ - 0) / var_412_0)
				arg_409_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_409_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_409_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_409_1.actors_["1020ui_story"].transform.position).z)
				arg_409_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_409_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_409_1.actors_["1020ui_story"].transform.localEulerAngles = arg_409_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_409_1.time_ >= 0 + var_412_0 and arg_409_1.time_ < 0 + var_412_0 + arg_412_0 then
				arg_409_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_409_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_409_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_409_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_409_1.actors_["1020ui_story"].transform.position).z)
				arg_409_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_409_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_409_1.actors_["1020ui_story"].transform.localEulerAngles = arg_409_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_412_1 = arg_409_1.actors_["1020ui_story"]

			if 0 < arg_409_1.time_ and arg_409_1.time_ <= 0 + arg_412_0 and not isNil(var_412_1) and arg_409_1.var_.characterEffect1020ui_story == nil then
				arg_409_1.var_.characterEffect1020ui_story = var_412_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_412_2 = 0.200000002980232

			if 0 <= arg_409_1.time_ and arg_409_1.time_ < 0 + var_412_2 and not isNil(var_412_1) then
				if arg_409_1.var_.characterEffect1020ui_story and not isNil(var_412_1) then
					arg_409_1.var_.characterEffect1020ui_story.fillFlat = true
					arg_409_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_409_1.time_ - 0) / var_412_2)
				end
			end

			if arg_409_1.time_ >= 0 + var_412_2 and arg_409_1.time_ < 0 + var_412_2 + arg_412_0 and not isNil(var_412_1) and arg_409_1.var_.characterEffect1020ui_story then
				arg_409_1.var_.characterEffect1020ui_story.fillFlat = true
				arg_409_1.var_.characterEffect1020ui_story.fillRatio = 0.5
			end

			local var_412_3 = arg_409_1.actors_["1089ui_story"].transform

			if 0 < arg_409_1.time_ and arg_409_1.time_ <= 0 + arg_412_0 then
				arg_409_1.var_.moveOldPos1089ui_story = var_412_3.localPosition
			end

			local var_412_4 = 0.001

			if 0 <= arg_409_1.time_ and arg_409_1.time_ < 0 + var_412_4 then
				var_412_3.localPosition = Vector3.Lerp(arg_409_1.var_.moveOldPos1089ui_story, Vector3.New(0, 100, 0), (arg_409_1.time_ - 0) / var_412_4)
			...
			if arg_409_1.time_ >= 0 + var_412_4 and arg_409_1.time_ < 0 + var_412_4 + arg_412_0 then
				var_412_3.localPosition = Vector3.New(0, 100, 0)
				var_412_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_412_3.position).x, (manager.ui.mainCamera.transform.position - var_412_3.position).y, (manager.ui.mainCamera.transform.position - var_412_3.position).z)
				var_412_3.localEulerAngles.z = 0
				var_412_3.localEulerAngles.x = 0
				var_412_3.localEulerAngles = var_412_3.localEulerAngles
			...
			local var_412_5 = arg_409_1.actors_["1020ui_story"]

			if 0 < arg_409_1.time_ and arg_409_1.time_ <= 0 + arg_412_0 and not isNil(var_412_5) and arg_409_1.var_.characterEffect1020ui_story == nil then
				arg_409_1.var_.characterEffect1020ui_story = var_412_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_412_6 = 0.200000002980232

			if 0 <= arg_409_1.time_ and arg_409_1.time_ < 0 + var_412_6 and not isNil(var_412_5) then
				if arg_409_1.var_.characterEffect1020ui_story and not isNil(var_412_5) then
					arg_409_1.var_.characterEffect1020ui_story.fillFlat = true
					arg_409_1.var_.characterEffect1020ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_409_1.time_ - 0) / var_412_6)
				end
			end

			if arg_409_1.time_ >= 0 + var_412_6 and arg_409_1.time_ < 0 + var_412_6 + arg_412_0 and not isNil(var_412_5) and arg_409_1.var_.characterEffect1020ui_story then
				arg_409_1.var_.characterEffect1020ui_story.fillFlat = true
				arg_409_1.var_.characterEffect1020ui_story.fillRatio = 0.5
			end

			local var_412_7 = 0
			local var_412_8 = 1.025

			if 0 < arg_409_1.time_ and arg_409_1.time_ <= var_412_7 + arg_412_0 then
				...
				local var_412_9 = arg_409_1:FormatText(arg_409_1:GetWordFromCfg(320061099).content)

				arg_409_1.text_.text = var_412_9

				LuaForUtil.ClearLinePrefixSymbol(arg_409_1.text_)

				local var_412_11 = 41 <= 0 and var_412_8 or var_412_8 * (utf8.len(var_412_9) / 41)

				if (41 <= 0 and var_412_8 or var_412_8 * (utf8.len(var_412_9) / 41)) > 0 and var_412_8 < var_412_11 then
					arg_409_1.talkMaxDuration = var_412_11

					if var_412_11 + var_412_7 > arg_409_1.duration_ then
						arg_409_1.duration_ = var_412_11 + var_412_7
					end
				end
			...
			local var_412_12 = math.max(var_412_8, arg_409_1.talkMaxDuration)

			if var_412_7 <= arg_409_1.time_ and arg_409_1.time_ < var_412_7 + var_412_12 then
				arg_409_1.typewritter.percent = (arg_409_1.time_ - var_412_7) / var_412_12

				arg_409_1.typewritter:SetDirty()
			end

			if arg_409_1.time_ >= var_412_7 + var_412_12 and arg_409_1.time_ < var_412_7 + var_412_12 + arg_412_0 then
	...
	Play320061100 = function(arg_413_0, arg_413_1)
		...
		function arg_413_1.onSingleLineUpdate_(arg_416_0)
			if 0 < arg_413_1.time_ and arg_413_1.time_ <= 0 + arg_416_0 then
				arg_413_1.var_.moveOldPos1089ui_story = arg_413_1.actors_["1089ui_story"].transform.localPosition
			end

			local var_416_0 = 0.001

			if 0 <= arg_413_1.time_ and arg_413_1.time_ < 0 + var_416_0 then
				arg_413_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_413_1.var_.moveOldPos1089ui_story, Vector3.New(0, -1.1, -6.17), (arg_413_1.time_ - 0) / var_416_0)
				arg_413_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_413_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_413_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_413_1.actors_["1089ui_story"].transform.position).z)
				arg_413_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_413_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_413_1.actors_["1089ui_story"].transform.localEulerAngles = arg_413_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_413_1.time_ >= 0 + var_416_0 and arg_413_1.time_ < 0 + var_416_0 + arg_416_0 then
				arg_413_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(0, -1.1, -6.17)
				arg_413_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_413_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_413_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_413_1.actors_["1089ui_story"].transform.position).z)
				arg_413_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_413_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_413_1.actors_["1089ui_story"].transform.localEulerAngles = arg_413_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_416_1 = arg_413_1.actors_["1089ui_story"]

			if 0 < arg_413_1.time_ and arg_413_1.time_ <= 0 + arg_416_0 and not isNil(var_416_1) and arg_413_1.var_.characterEffect1089ui_story == nil then
				arg_413_1.var_.characterEffect1089ui_story = var_416_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_416_2 = 0.200000002980232

			if 0 <= arg_413_1.time_ and arg_413_1.time_ < 0 + var_416_2 and not isNil(var_416_1) then
				if arg_413_1.var_.characterEffect1089ui_story and not isNil(var_416_1) then
					arg_413_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_413_1.time_ >= 0 + var_416_2 and arg_413_1.time_ < 0 + var_416_2 + arg_416_0 and not isNil(var_416_1) and arg_413_1.var_.characterEffect1089ui_story then
				arg_413_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			if 0 < arg_413_1.time_ and arg_413_1.time_ <= var_416_4 + arg_416_0 then
				...
				arg_413_1.leftNameTxt_.text = arg_413_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_416_6 = arg_413_1:GetWordFromCfg(320061100)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061100", "story_v_out_320061.awb") ~= 0 then
					local var_416_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061100", "story_v_out_320061.awb") / 1000
					...
					if var_416_6.prefab_name ~= "" and arg_413_1.actors_[var_416_6.prefab_name] ~= nil then
						local var_416_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_413_1.actors_[var_416_6.prefab_name].transform, "story_v_out_320061", "320061100", "story_v_out_320061.awb")

						arg_413_1:RecordAudio("320061100", var_416_11)
						arg_413_1:RecordAudio("320061100", var_416_11)
					else
	...
	Play320061101 = function(arg_417_0, arg_417_1)
		...
		function arg_417_1.onSingleLineUpdate_(arg_420_0)
			if 0 < arg_417_1.time_ and arg_417_1.time_ <= 0 + arg_420_0 and not isNil(arg_417_1.actors_["1089ui_story"]) and arg_417_1.var_.characterEffect1089ui_story == nil then
				arg_417_1.var_.characterEffect1089ui_story = arg_417_1.actors_["1089ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_420_0 = 0.200000002980232

			if 0 <= arg_417_1.time_ and arg_417_1.time_ < 0 + var_420_0 and not isNil(arg_417_1.actors_["1089ui_story"]) then
				if arg_417_1.var_.characterEffect1089ui_story and not isNil(arg_417_1.actors_["1089ui_story"]) then
					arg_417_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_417_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_417_1.time_ - 0) / var_420_0)
				end
			end

			if arg_417_1.time_ >= 0 + var_420_0 and arg_417_1.time_ < 0 + var_420_0 + arg_420_0 and not isNil(arg_417_1.actors_["1089ui_story"]) and arg_417_1.var_.characterEffect1089ui_story then
				arg_417_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_417_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_417_1.time_ and arg_417_1.time_ <= var_420_1 + arg_420_0 then
				...
				local var_420_3 = arg_417_1:FormatText(arg_417_1:GetWordFromCfg(320061101).content)

				arg_417_1.text_.text = var_420_3

				LuaForUtil.ClearLinePrefixSymbol(arg_417_1.text_)

				local var_420_5 = 10 <= 0 and var_420_2 or var_420_2 * (utf8.len(var_420_3) / 10)

				if (10 <= 0 and var_420_2 or var_420_2 * (utf8.len(var_420_3) / 10)) > 0 and var_420_2 < var_420_5 then
	...
	Play320061102 = function(arg_421_0, arg_421_1)
		...
		function arg_421_1.onSingleLineUpdate_(arg_424_0)
			if arg_421_1.bgs_.ST12 == nil then
				local var_424_0 = Object.Instantiate(arg_421_1.paintGo_)

				var_424_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "ST12")
				var_424_0.name = "ST12"
				var_424_0.transform.parent = arg_421_1.stage_.transform
				var_424_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_421_1.bgs_.ST12 = var_424_0
			end

			if 2 < arg_421_1.time_ and arg_421_1.time_ <= 2 + arg_424_0 then
				local var_424_1 = arg_421_1.bgs_.ST12

				arg_421_1.bgs_.ST12.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_424_13 = arg_421_1.actors_["1089ui_story"].transform

			if 1.96599999815226 < arg_421_1.time_ and arg_421_1.time_ <= 1.96599999815226 + arg_424_0 then
				arg_421_1.var_.moveOldPos1089ui_story = var_424_13.localPosition
			end

			local var_424_14 = 0.001

			if 1.96599999815226 <= arg_421_1.time_ and arg_421_1.time_ < 1.96599999815226 + var_424_14 then
				var_424_13.localPosition = Vector3.Lerp(arg_421_1.var_.moveOldPos1089ui_story, Vector3.New(0, 100, 0), (arg_421_1.time_ - 1.96599999815226) / var_424_14)
			...
			local var_424_15 = arg_421_1.actors_["1089ui_story"]

			if 1.96599999815226 < arg_421_1.time_ and arg_421_1.time_ <= 1.96599999815226 + arg_424_0 and not isNil(var_424_15) and arg_421_1.var_.characterEffect1089ui_story == nil then
				arg_421_1.var_.characterEffect1089ui_story = var_424_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 1.96599999815226 <= arg_421_1.time_ and arg_421_1.time_ < 1.96599999815226 + var_424_16 and not isNil(var_424_15) then
				if arg_421_1.var_.characterEffect1089ui_story and not isNil(var_424_15) then
					arg_421_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_421_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_421_1.time_ - 1.96599999815226) / var_424_16)
				end
			end

			if arg_421_1.time_ >= 1.96599999815226 + var_424_16 and arg_421_1.time_ < 1.96599999815226 + var_424_16 + arg_424_0 and not isNil(var_424_15) and arg_421_1.var_.characterEffect1089ui_story then
				arg_421_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_421_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end
			...
			if var_424_17 < arg_421_1.time_ and arg_421_1.time_ <= var_424_17 + arg_424_0 then
				...
				for iter_424_2, iter_424_3 in pairs(arg_421_1.actors_) do
					for iter_424_4, iter_424_5 in ipairs((iter_424_3:GetComponentsInChildren(typeof(Image), true):ToTable())) do
						iter_424_5.color = iter_424_5.color.r > 0.51 and Color.New(1, 1, 1) or Color.New(0.5, 0.5, 0.5)
					end
				end
			end

			local var_424_18 = 0.2

			if var_424_17 <= arg_421_1.time_ and arg_421_1.time_ < var_424_17 + var_424_18 then
				arg_421_1.screenFilterEffect_.weight = Mathf.Lerp(0, 1, (arg_421_1.time_ - var_424_17) / var_424_18)
			end
			...
			local var_424_19 = 4
			local var_424_20 = 0.625

			if 4 < arg_421_1.time_ and arg_421_1.time_ <= var_424_19 + arg_424_0 then
				...
				local var_424_21 = LeanTween.value(arg_421_1.dialog_, 0, 1, 0.3)

				var_424_21:setOnUpdate(LuaHelper.FloatAction(function(arg_425_0)
					arg_421_1.dialogCg_.alpha = arg_425_0
				end))
				var_424_21:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_421_1.dialog_)
					var_424_21:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_424_22 = arg_421_1:FormatText(arg_421_1:GetWordFromCfg(320061102).content)

				arg_421_1.text_.text = var_424_22

				LuaForUtil.ClearLinePrefixSymbol(arg_421_1.text_)

				local var_424_24 = 25 <= 0 and var_424_20 or var_424_20 * (utf8.len(var_424_22) / 25)

				if (25 <= 0 and var_424_20 or var_424_20 * (utf8.len(var_424_22) / 25)) > 0 and var_424_20 < var_424_24 then
					arg_421_1.talkMaxDuration = var_424_24
					var_424_19 = var_424_19 + 0.3

					if var_424_24 + var_424_19 > arg_421_1.duration_ then
						arg_421_1.duration_ = var_424_24 + var_424_19
					end
				end
			...
			local var_424_25 = var_424_19 + 0.3
			local var_424_26 = math.max(var_424_20, arg_421_1.talkMaxDuration)

			if var_424_19 + 0.3 <= arg_421_1.time_ and arg_421_1.time_ < var_424_25 + var_424_26 then
				arg_421_1.typewritter.percent = (arg_421_1.time_ - var_424_25) / var_424_26

				arg_421_1.typewritter:SetDirty()
			end

			if arg_421_1.time_ >= var_424_25 + var_424_26 and arg_421_1.time_ < var_424_25 + var_424_26 + arg_424_0 then
	...
	Play320061103 = function(arg_427_0, arg_427_1)
		...
		function arg_427_1.onSingleLineUpdate_(arg_430_0)
			if arg_427_1.actors_["1019ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1019ui_story"))) then
				local var_430_0 = Object.Instantiate(Asset.Load("Char/" .. "1019ui_story"), arg_427_1.stage_.transform)

				var_430_0.name = "1019ui_story"
				var_430_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_427_1.actors_["1019ui_story"] = var_430_0
				...
				arg_427_1.var_["1019ui_story" .. "Animator"] = var_430_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_427_1.var_["1019ui_story" .. "Animator"].applyRootMotion = true
				arg_427_1.var_["1019ui_story" .. "LipSync"] = var_430_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_430_3 = arg_427_1.actors_["1019ui_story"].transform

			if 0 < arg_427_1.time_ and arg_427_1.time_ <= 0 + arg_430_0 then
				arg_427_1.var_.moveOldPos1019ui_story = var_430_3.localPosition
			end

			local var_430_4 = 0.001

			if 0 <= arg_427_1.time_ and arg_427_1.time_ < 0 + var_430_4 then
				var_430_3.localPosition = Vector3.Lerp(arg_427_1.var_.moveOldPos1019ui_story, Vector3.New(-0.2, -1.08, -5.9), (arg_427_1.time_ - 0) / var_430_4)
			...
			if arg_427_1.time_ >= 0 + var_430_4 and arg_427_1.time_ < 0 + var_430_4 + arg_430_0 then
				var_430_3.localPosition = Vector3.New(-0.2, -1.08, -5.9)
				var_430_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_430_3.position).x, (manager.ui.mainCamera.transform.position - var_430_3.position).y, (manager.ui.mainCamera.transform.position - var_430_3.position).z)
				var_430_3.localEulerAngles.z = 0
				var_430_3.localEulerAngles.x = 0
				var_430_3.localEulerAngles = var_430_3.localEulerAngles
			...
			local var_430_5 = arg_427_1.actors_["1019ui_story"]

			if 0 < arg_427_1.time_ and arg_427_1.time_ <= 0 + arg_430_0 and not isNil(var_430_5) and arg_427_1.var_.characterEffect1019ui_story == nil then
				arg_427_1.var_.characterEffect1019ui_story = var_430_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_430_6 = 0.200000002980232

			if 0 <= arg_427_1.time_ and arg_427_1.time_ < 0 + var_430_6 and not isNil(var_430_5) then
				if arg_427_1.var_.characterEffect1019ui_story and not isNil(var_430_5) then
					arg_427_1.var_.characterEffect1019ui_story.fillFlat = false
				end
			end

			if arg_427_1.time_ >= 0 + var_430_6 and arg_427_1.time_ < 0 + var_430_6 + arg_430_0 and not isNil(var_430_5) and arg_427_1.var_.characterEffect1019ui_story then
				arg_427_1.var_.characterEffect1019ui_story.fillFlat = false
			end
			...
			if 0 < arg_427_1.time_ and arg_427_1.time_ <= var_430_8 + arg_430_0 then
				...
				local var_430_10 = arg_427_1:GetWordFromCfg(320061103)
				...
				local var_430_13 = 49 <= 0 and var_430_9 or var_430_9 * (utf8.len(var_430_11) / 49)

				if (49 <= 0 and var_430_9 or var_430_9 * (utf8.len(var_430_11) / 49)) > 0 and var_430_9 < var_430_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061103", "story_v_out_320061.awb") ~= 0 then
					local var_430_14 = manager.audio:GetVoiceLength("story_v_out_320061", "320061103", "story_v_out_320061.awb") / 1000
					...
					if var_430_10.prefab_name ~= "" and arg_427_1.actors_[var_430_10.prefab_name] ~= nil then
						local var_430_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_427_1.actors_[var_430_10.prefab_name].transform, "story_v_out_320061", "320061103", "story_v_out_320061.awb")

						arg_427_1:RecordAudio("320061103", var_430_15)
						arg_427_1:RecordAudio("320061103", var_430_15)
					else
	...
	Play320061104 = function(arg_431_0, arg_431_1)
		...
		function arg_431_1.onSingleLineUpdate_(arg_434_0)
			if 0 < arg_431_1.time_ and arg_431_1.time_ <= 0 + arg_434_0 and not isNil(arg_431_1.actors_["1019ui_story"]) and arg_431_1.var_.characterEffect1019ui_story == nil then
				arg_431_1.var_.characterEffect1019ui_story = arg_431_1.actors_["1019ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_434_0 = 0.200000002980232

			if 0 <= arg_431_1.time_ and arg_431_1.time_ < 0 + var_434_0 and not isNil(arg_431_1.actors_["1019ui_story"]) then
				if arg_431_1.var_.characterEffect1019ui_story and not isNil(arg_431_1.actors_["1019ui_story"]) then
					arg_431_1.var_.characterEffect1019ui_story.fillFlat = true
					arg_431_1.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_431_1.time_ - 0) / var_434_0)
				end
			end

			if arg_431_1.time_ >= 0 + var_434_0 and arg_431_1.time_ < 0 + var_434_0 + arg_434_0 and not isNil(arg_431_1.actors_["1019ui_story"]) and arg_431_1.var_.characterEffect1019ui_story then
				arg_431_1.var_.characterEffect1019ui_story.fillFlat = true
				arg_431_1.var_.characterEffect1019ui_story.fillRatio = 0.5
			end

			local var_434_1 = 0
			local var_434_2 = 1.175
			...
			if 0 < arg_431_1.time_ and arg_431_1.time_ <= var_434_1 + arg_434_0 then
				...
				local var_434_3 = arg_431_1:FormatText(arg_431_1:GetWordFromCfg(320061104).content)

				arg_431_1.text_.text = var_434_3

				LuaForUtil.ClearLinePrefixSymbol(arg_431_1.text_)

				local var_434_5 = 47 <= 0 and var_434_2 or var_434_2 * (utf8.len(var_434_3) / 47)

				if (47 <= 0 and var_434_2 or var_434_2 * (utf8.len(var_434_3) / 47)) > 0 and var_434_2 < var_434_5 then
	...
	Play320061105 = function(arg_435_0, arg_435_1)
		...
		function arg_435_1.onSingleLineUpdate_(arg_438_0)
			...
			if 0 <= arg_435_1.time_ and arg_435_1.time_ < 0 + var_438_0 then
				arg_435_1.actors_["1019ui_story"].transform.localPosition = Vector3.Lerp(arg_435_1.var_.moveOldPos1019ui_story, Vector3.New(-0.2, -1.08, -5.9), (arg_435_1.time_ - 0) / var_438_0)
			...
			if arg_435_1.time_ >= 0 + var_438_0 and arg_435_1.time_ < 0 + var_438_0 + arg_438_0 then
				arg_435_1.actors_["1019ui_story"].transform.localPosition = Vector3.New(-0.2, -1.08, -5.9)
				arg_435_1.actors_["1019ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_435_1.actors_["1019ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_435_1.actors_["1019ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_435_1.actors_["1019ui_story"].transform.position).z)
				arg_435_1.actors_["1019ui_story"].transform.localEulerAngles.z = 0
				arg_435_1.actors_["1019ui_story"].transform.localEulerAngles.x = 0
				arg_435_1.actors_["1019ui_story"].transform.localEulerAngles = arg_435_1.actors_["1019ui_story"].transform.localEulerAngles
			...
			local var_438_1 = arg_435_1.actors_["1019ui_story"]

			if 0 < arg_435_1.time_ and arg_435_1.time_ <= 0 + arg_438_0 and not isNil(var_438_1) and arg_435_1.var_.characterEffect1019ui_story == nil then
				arg_435_1.var_.characterEffect1019ui_story = var_438_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_438_2 = 0.200000002980232

			if 0 <= arg_435_1.time_ and arg_435_1.time_ < 0 + var_438_2 and not isNil(var_438_1) then
				if arg_435_1.var_.characterEffect1019ui_story and not isNil(var_438_1) then
					arg_435_1.var_.characterEffect1019ui_story.fillFlat = false
				end
			end

			if arg_435_1.time_ >= 0 + var_438_2 and arg_435_1.time_ < 0 + var_438_2 + arg_438_0 and not isNil(var_438_1) and arg_435_1.var_.characterEffect1019ui_story then
				arg_435_1.var_.characterEffect1019ui_story.fillFlat = false
			end
			...
			if 0 < arg_435_1.time_ and arg_435_1.time_ <= var_438_4 + arg_438_0 then
				...
				arg_435_1.leftNameTxt_.text = arg_435_1:FormatText(StoryNameCfg[13].name)
				...
				local var_438_6 = arg_435_1:GetWordFromCfg(320061105)
				...
				local var_438_9 = 41 <= 0 and var_438_5 or var_438_5 * (utf8.len(var_438_7) / 41)

				if (41 <= 0 and var_438_5 or var_438_5 * (utf8.len(var_438_7) / 41)) > 0 and var_438_5 < var_438_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061105", "story_v_out_320061.awb") ~= 0 then
					local var_438_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061105", "story_v_out_320061.awb") / 1000
					...
					if var_438_6.prefab_name ~= "" and arg_435_1.actors_[var_438_6.prefab_name] ~= nil then
						local var_438_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_435_1.actors_[var_438_6.prefab_name].transform, "story_v_out_320061", "320061105", "story_v_out_320061.awb")

						arg_435_1:RecordAudio("320061105", var_438_11)
						arg_435_1:RecordAudio("320061105", var_438_11)
					else
	...
	Play320061106 = function(arg_439_0, arg_439_1)
		...
		function arg_439_1.onSingleLineUpdate_(arg_442_0)
			if 0 < arg_439_1.time_ and arg_439_1.time_ <= 0 + arg_442_0 and not isNil(arg_439_1.actors_["1019ui_story"]) and arg_439_1.var_.characterEffect1019ui_story == nil then
				arg_439_1.var_.characterEffect1019ui_story = arg_439_1.actors_["1019ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_442_0 = 0.200000002980232

			if 0 <= arg_439_1.time_ and arg_439_1.time_ < 0 + var_442_0 and not isNil(arg_439_1.actors_["1019ui_story"]) then
				if arg_439_1.var_.characterEffect1019ui_story and not isNil(arg_439_1.actors_["1019ui_story"]) then
					arg_439_1.var_.characterEffect1019ui_story.fillFlat = true
					arg_439_1.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_439_1.time_ - 0) / var_442_0)
				end
			end

			if arg_439_1.time_ >= 0 + var_442_0 and arg_439_1.time_ < 0 + var_442_0 + arg_442_0 and not isNil(arg_439_1.actors_["1019ui_story"]) and arg_439_1.var_.characterEffect1019ui_story then
				arg_439_1.var_.characterEffect1019ui_story.fillFlat = true
				arg_439_1.var_.characterEffect1019ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_439_1.time_ and arg_439_1.time_ <= var_442_1 + arg_442_0 then
				...
				local var_442_3 = arg_439_1:FormatText(arg_439_1:GetWordFromCfg(320061106).content)

				arg_439_1.text_.text = var_442_3

				LuaForUtil.ClearLinePrefixSymbol(arg_439_1.text_)

				local var_442_5 = 16 <= 0 and var_442_2 or var_442_2 * (utf8.len(var_442_3) / 16)

				if (16 <= 0 and var_442_2 or var_442_2 * (utf8.len(var_442_3) / 16)) > 0 and var_442_2 < var_442_5 then
	...
	Play320061107 = function(arg_443_0, arg_443_1)
		...
		function arg_443_1.onSingleLineUpdate_(arg_446_0)
			...
			if 0 < arg_443_1.time_ and arg_443_1.time_ <= 0 + arg_446_0 then
				...
				local var_446_1 = arg_443_1:FormatText(arg_443_1:GetWordFromCfg(320061107).content)

				arg_443_1.text_.text = var_446_1

				LuaForUtil.ClearLinePrefixSymbol(arg_443_1.text_)

				local var_446_3 = 36 <= 0 and var_446_0 or var_446_0 * (utf8.len(var_446_1) / 36)

				if (36 <= 0 and var_446_0 or var_446_0 * (utf8.len(var_446_1) / 36)) > 0 and var_446_0 < var_446_3 then
	...
	Play320061108 = function(arg_447_0, arg_447_1)
		...
		function arg_447_1.onSingleLineUpdate_(arg_450_0)
			...
			if 0 < arg_447_1.time_ and arg_447_1.time_ <= var_450_2 + arg_450_0 then
				...
				arg_447_1.leftNameTxt_.text = arg_447_1:FormatText(StoryNameCfg[13].name)
				...
				local var_450_4 = arg_447_1:GetWordFromCfg(320061108)
				...
				local var_450_7 = 33 <= 0 and var_450_3 or var_450_3 * (utf8.len(var_450_5) / 33)

				if (33 <= 0 and var_450_3 or var_450_3 * (utf8.len(var_450_5) / 33)) > 0 and var_450_3 < var_450_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061108", "story_v_out_320061.awb") ~= 0 then
					local var_450_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061108", "story_v_out_320061.awb") / 1000
					...
					if var_450_4.prefab_name ~= "" and arg_447_1.actors_[var_450_4.prefab_name] ~= nil then
						local var_450_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_447_1.actors_[var_450_4.prefab_name].transform, "story_v_out_320061", "320061108", "story_v_out_320061.awb")

						arg_447_1:RecordAudio("320061108", var_450_9)
						arg_447_1:RecordAudio("320061108", var_450_9)
					else
	...
	Play320061109 = function(arg_451_0, arg_451_1)
		...
		function arg_451_1.onSingleLineUpdate_(arg_454_0)
			...
			if 0 < arg_451_1.time_ and arg_451_1.time_ <= var_454_0 + arg_454_0 then
				...
				local var_454_2 = arg_451_1:GetWordFromCfg(320061109)
				...
				local var_454_5 = 31 <= 0 and var_454_1 or var_454_1 * (utf8.len(var_454_3) / 31)

				if (31 <= 0 and var_454_1 or var_454_1 * (utf8.len(var_454_3) / 31)) > 0 and var_454_1 < var_454_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061109", "story_v_out_320061.awb") ~= 0 then
					local var_454_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061109", "story_v_out_320061.awb") / 1000
					...
					if var_454_2.prefab_name ~= "" and arg_451_1.actors_[var_454_2.prefab_name] ~= nil then
						local var_454_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_451_1.actors_[var_454_2.prefab_name].transform, "story_v_out_320061", "320061109", "story_v_out_320061.awb")

						arg_451_1:RecordAudio("320061109", var_454_7)
						arg_451_1:RecordAudio("320061109", var_454_7)
					else
		...
		function arg_455_1.onSingleLineUpdate_(arg_458_0)
			...
			if 0 <= arg_455_1.time_ and arg_455_1.time_ < 0 + var_458_0 and not isNil(arg_455_1.actors_["1019ui_story"]) then
				if arg_455_1.var_.characterEffect1019ui_story and not isNil(arg_455_1.actors_["1019ui_story"]) then
					...
					arg_455_1.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_455_1.time_ - 0) / var_458_0)
				end
			end
			...
			if arg_455_1.time_ >= 0 + var_458_0 and arg_455_1.time_ < 0 + var_458_0 + arg_458_0 and not isNil(arg_455_1.actors_["1019ui_story"]) and arg_455_1.var_.characterEffect1019ui_story then
				arg_455_1.var_.characterEffect1019ui_story.fillFlat = true
				arg_455_1.var_.characterEffect1019ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_455_1.time_ and arg_455_1.time_ <= var_458_1 + arg_458_0 then
				...
				local var_458_3 = arg_455_1:FormatText(arg_455_1:GetWordFromCfg(320061110).content)

				arg_455_1.text_.text = var_458_3

				LuaForUtil.ClearLinePrefixSymbol(arg_455_1.text_)

				local var_458_5 = 6 <= 0 and var_458_2 or var_458_2 * (utf8.len(var_458_3) / 6)

				if (6 <= 0 and var_458_2 or var_458_2 * (utf8.len(var_458_3) / 6)) > 0 and var_458_2 < var_458_5 then
	...
	Play320061111 = function(arg_459_0, arg_459_1)
		...
		function arg_459_1.onSingleLineUpdate_(arg_462_0)
			...
			if 0 < arg_459_1.time_ and arg_459_1.time_ <= var_462_2 + arg_462_0 then
				...
				arg_459_1.leftNameTxt_.text = arg_459_1:FormatText(StoryNameCfg[13].name)
				...
				local var_462_4 = arg_459_1:GetWordFromCfg(320061111)
				...
				local var_462_7 = 43 <= 0 and var_462_3 or var_462_3 * (utf8.len(var_462_5) / 43)

				if (43 <= 0 and var_462_3 or var_462_3 * (utf8.len(var_462_5) / 43)) > 0 and var_462_3 < var_462_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061111", "story_v_out_320061.awb") ~= 0 then
					local var_462_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061111", "story_v_out_320061.awb") / 1000
					...
					if var_462_4.prefab_name ~= "" and arg_459_1.actors_[var_462_4.prefab_name] ~= nil then
						local var_462_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_459_1.actors_[var_462_4.prefab_name].transform, "story_v_out_320061", "320061111", "story_v_out_320061.awb")

						arg_459_1:RecordAudio("320061111", var_462_9)
						arg_459_1:RecordAudio("320061111", var_462_9)
					else
	...
	Play320061112 = function(arg_463_0, arg_463_1)
		...
		function arg_463_1.onSingleLineUpdate_(arg_466_0)
			...
			if 0 < arg_463_1.time_ and arg_463_1.time_ <= 0 + arg_466_0 then
				...
				local var_466_1 = arg_463_1:GetWordFromCfg(320061112)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061112", "story_v_out_320061.awb") ~= 0 then
					local var_466_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061112", "story_v_out_320061.awb") / 1000
					...
					if var_466_1.prefab_name ~= "" and arg_463_1.actors_[var_466_1.prefab_name] ~= nil then
						local var_466_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_463_1.actors_[var_466_1.prefab_name].transform, "story_v_out_320061", "320061112", "story_v_out_320061.awb")

						arg_463_1:RecordAudio("320061112", var_466_6)
						arg_463_1:RecordAudio("320061112", var_466_6)
					else
	...
	Play320061113 = function(arg_467_0, arg_467_1)
		...
		function arg_467_1.onSingleLineUpdate_(arg_470_0)
			if arg_467_1.bgs_.ST0503 == nil then
				local var_470_0 = Object.Instantiate(arg_467_1.paintGo_)

				var_470_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "ST0503")
				var_470_0.name = "ST0503"
				var_470_0.transform.parent = arg_467_1.stage_.transform
				var_470_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_467_1.bgs_.ST0503 = var_470_0
			end

			if 2 < arg_467_1.time_ and arg_467_1.time_ <= 2 + arg_470_0 then
				local var_470_1 = arg_467_1.bgs_.ST0503

				arg_467_1.bgs_.ST0503.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 4 < arg_467_1.time_ and arg_467_1.time_ <= var_470_4 + arg_470_0 then
				arg_467_1.allBtn_.enabled = false
			end

			if arg_467_1.time_ >= var_470_4 + 0.3 and arg_467_1.time_ < var_470_4 + 0.3 + arg_470_0 then
			...
			if var_470_5 <= arg_467_1.time_ and arg_467_1.time_ < var_470_5 + var_470_6 then
				...
				var_470_7.a = Mathf.Lerp(0, 1, (arg_467_1.time_ - var_470_5) / var_470_6)
			...
			if arg_467_1.time_ >= var_470_5 + var_470_6 and arg_467_1.time_ < var_470_5 + var_470_6 + arg_470_0 then
				local var_470_8 = Color.New(0, 0, 0)

				var_470_8.a = 1
				arg_467_1.mask_.color = var_470_8
			end

			local var_470_9 = 2

			if 2 < arg_467_1.time_ and arg_467_1.time_ <= var_470_9 + arg_470_0 then
				arg_467_1.mask_.enabled = true
				arg_467_1.mask_.raycastTarget = true
			...
			if var_470_9 <= arg_467_1.time_ and arg_467_1.time_ < var_470_9 + var_470_10 then
				...
				var_470_11.a = Mathf.Lerp(1, 0, (arg_467_1.time_ - var_470_9) / var_470_10)
				arg_467_1.mask_.color = var_470_11
			end

			if arg_467_1.time_ >= var_470_9 + var_470_10 and arg_467_1.time_ < var_470_9 + var_470_10 + arg_470_0 then
				local var_470_12 = Color.New(0, 0, 0)

				arg_467_1.mask_.enabled = false
				var_470_12.a = 0
				arg_467_1.mask_.color = var_470_12
			end

			local var_470_13 = arg_467_1.actors_["1019ui_story"].transform

			if 1.96599999815226 < arg_467_1.time_ and arg_467_1.time_ <= 1.96599999815226 + arg_470_0 then
				arg_467_1.var_.moveOldPos1019ui_story = var_470_13.localPosition
			end

			local var_470_14 = 0.001

			if 1.96599999815226 <= arg_467_1.time_ and arg_467_1.time_ < 1.96599999815226 + var_470_14 then
				var_470_13.localPosition = Vector3.Lerp(arg_467_1.var_.moveOldPos1019ui_story, Vector3.New(0, 100, 0), (arg_467_1.time_ - 1.96599999815226) / var_470_14)
				var_470_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_470_13.position).x, (manager.ui.mainCamera.transform.position - var_470_13.position).y, (manager.ui.mainCamera.transform.position - var_470_13.position).z)
				var_470_13.localEulerAngles.z = 0
				var_470_13.localEulerAngles.x = 0
				var_470_13.localEulerAngles = var_470_13.localEulerAngles
			end

			if arg_467_1.time_ >= 1.96599999815226 + var_470_14 and arg_467_1.time_ < 1.96599999815226 + var_470_14 + arg_470_0 then
				var_470_13.localPosition = Vector3.New(0, 100, 0)
				var_470_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_470_13.position).x, (manager.ui.mainCamera.transform.position - var_470_13.position).y, (manager.ui.mainCamera.transform.position - var_470_13.position).z)
				var_470_13.localEulerAngles.z = 0
				var_470_13.localEulerAngles.x = 0
				var_470_13.localEulerAngles = var_470_13.localEulerAngles
			...
			local var_470_15 = arg_467_1.actors_["1019ui_story"]

			if 1.96599999815226 < arg_467_1.time_ and arg_467_1.time_ <= 1.96599999815226 + arg_470_0 and not isNil(var_470_15) and arg_467_1.var_.characterEffect1019ui_story == nil then
				arg_467_1.var_.characterEffect1019ui_story = var_470_15:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_470_16 = 0.034000001847744

			if 1.96599999815226 <= arg_467_1.time_ and arg_467_1.time_ < 1.96599999815226 + var_470_16 and not isNil(var_470_15) then
				if arg_467_1.var_.characterEffect1019ui_story and not isNil(var_470_15) then
					arg_467_1.var_.characterEffect1019ui_story.fillFlat = true
					arg_467_1.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_467_1.time_ - 1.96599999815226) / var_470_16)
				end
			end

			if arg_467_1.time_ >= 1.96599999815226 + var_470_16 and arg_467_1.time_ < 1.96599999815226 + var_470_16 + arg_470_0 and not isNil(var_470_15) and arg_467_1.var_.characterEffect1019ui_story then
				arg_467_1.var_.characterEffect1019ui_story.fillFlat = true
			...
			if var_470_17 < arg_467_1.time_ and arg_467_1.time_ <= var_470_17 + arg_470_0 then
				...
				for iter_470_2, iter_470_3 in pairs(arg_467_1.actors_) do
					for iter_470_4, iter_470_5 in ipairs((iter_470_3:GetComponentsInChildren(typeof(Image), true):ToTable())) do
						iter_470_5.color = iter_470_5.color.r > 0.51 and Color.New(1, 1, 1) or Color.New(0.5, 0.5, 0.5)
					end
				end
			end

			local var_470_18 = 0.2

			if var_470_17 <= arg_467_1.time_ and arg_467_1.time_ < var_470_17 + var_470_18 then
				arg_467_1.screenFilterEffect_.weight = Mathf.Lerp(1, 0, (arg_467_1.time_ - var_470_17) / var_470_18)
			end

			if arg_467_1.time_ >= var_470_17 + var_470_18 and arg_467_1.time_ < var_470_17 + var_470_18 + arg_470_0 then
			...
			local var_470_19 = 4
			local var_470_20 = 1.175

			if 4 < arg_467_1.time_ and arg_467_1.time_ <= var_470_19 + arg_470_0 then
				...
				local var_470_21 = LeanTween.value(arg_467_1.dialog_, 0, 1, 0.3)

				var_470_21:setOnUpdate(LuaHelper.FloatAction(function(arg_471_0)
					arg_467_1.dialogCg_.alpha = arg_471_0
				end))
				var_470_21:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_467_1.dialog_)
					var_470_21:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_470_22 = arg_467_1:FormatText(arg_467_1:GetWordFromCfg(320061113).content)

				arg_467_1.text_.text = var_470_22

				LuaForUtil.ClearLinePrefixSymbol(arg_467_1.text_)

				local var_470_24 = 47 <= 0 and var_470_20 or var_470_20 * (utf8.len(var_470_22) / 47)

				if (47 <= 0 and var_470_20 or var_470_20 * (utf8.len(var_470_22) / 47)) > 0 and var_470_20 < var_470_24 then
					arg_467_1.talkMaxDuration = var_470_24
					var_470_19 = var_470_19 + 0.3

					if var_470_24 + var_470_19 > arg_467_1.duration_ then
						arg_467_1.duration_ = var_470_24 + var_470_19
					end
				end
			...
			local var_470_25 = var_470_19 + 0.3
			local var_470_26 = math.max(var_470_20, arg_467_1.talkMaxDuration)

			if var_470_19 + 0.3 <= arg_467_1.time_ and arg_467_1.time_ < var_470_25 + var_470_26 then
				arg_467_1.typewritter.percent = (arg_467_1.time_ - var_470_25) / var_470_26

				arg_467_1.typewritter:SetDirty()
			end

			if arg_467_1.time_ >= var_470_25 + var_470_26 and arg_467_1.time_ < var_470_25 + var_470_26 + arg_470_0 then
	...
	Play320061114 = function(arg_473_0, arg_473_1)
		...
		function arg_473_1.onSingleLineUpdate_(arg_476_0)
			...
			if 0 <= arg_473_1.time_ and arg_473_1.time_ < 0 + var_476_0 then
				arg_473_1.actors_["10100ui_story"].transform.localPosition = Vector3.Lerp(arg_473_1.var_.moveOldPos10100ui_story, Vector3.New(0, -1.16, -6.25), (arg_473_1.time_ - 0) / var_476_0)
			...
			if arg_473_1.time_ >= 0 + var_476_0 and arg_473_1.time_ < 0 + var_476_0 + arg_476_0 then
				arg_473_1.actors_["10100ui_story"].transform.localPosition = Vector3.New(0, -1.16, -6.25)
				arg_473_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_473_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_473_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_473_1.actors_["10100ui_story"].transform.position).z)
				arg_473_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_473_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_473_1.actors_["10100ui_story"].transform.localEulerAngles = arg_473_1.actors_["10100ui_story"].transform.localEulerAngles
			...
			if 0 < arg_473_1.time_ and arg_473_1.time_ <= 0 + arg_476_0 and not isNil(var_476_1) and arg_473_1.var_.characterEffect10100ui_story == nil then
			...
			if arg_473_1.time_ >= 0 + var_476_2 and arg_473_1.time_ < 0 + var_476_2 + arg_476_0 and not isNil(var_476_1) and arg_473_1.var_.characterEffect10100ui_story then
				arg_473_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_473_1.time_ and arg_473_1.time_ <= var_476_4 + arg_476_0 then
				...
				arg_473_1.leftNameTxt_.text = arg_473_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_476_6 = arg_473_1:GetWordFromCfg(320061114)
				...
				local var_476_9 = 10 <= 0 and var_476_5 or var_476_5 * (utf8.len(var_476_7) / 10)

				if (10 <= 0 and var_476_5 or var_476_5 * (utf8.len(var_476_7) / 10)) > 0 and var_476_5 < var_476_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061114", "story_v_out_320061.awb") ~= 0 then
					local var_476_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061114", "story_v_out_320061.awb") / 1000
					...
					if var_476_6.prefab_name ~= "" and arg_473_1.actors_[var_476_6.prefab_name] ~= nil then
						local var_476_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_473_1.actors_[var_476_6.prefab_name].transform, "story_v_out_320061", "320061114", "story_v_out_320061.awb")

						arg_473_1:RecordAudio("320061114", var_476_11)
						arg_473_1:RecordAudio("320061114", var_476_11)
					else
	...
	Play320061115 = function(arg_477_0, arg_477_1)
		...
		function arg_477_1.onSingleLineUpdate_(arg_480_0)
			if 0 < arg_477_1.time_ and arg_477_1.time_ <= 0 + arg_480_0 and not isNil(arg_477_1.actors_["10100ui_story"]) and arg_477_1.var_.characterEffect10100ui_story == nil then
				arg_477_1.var_.characterEffect10100ui_story = arg_477_1.actors_["10100ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_480_0 = 0.200000002980232

			if 0 <= arg_477_1.time_ and arg_477_1.time_ < 0 + var_480_0 and not isNil(arg_477_1.actors_["10100ui_story"]) then
				if arg_477_1.var_.characterEffect10100ui_story and not isNil(arg_477_1.actors_["10100ui_story"]) then
					arg_477_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_477_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_477_1.time_ - 0) / var_480_0)
				end
			end

			if arg_477_1.time_ >= 0 + var_480_0 and arg_477_1.time_ < 0 + var_480_0 + arg_480_0 and not isNil(arg_477_1.actors_["10100ui_story"]) and arg_477_1.var_.characterEffect10100ui_story then
				arg_477_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_477_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_480_1 = 0
			local var_480_2 = 1.25
			...
			if 0 < arg_477_1.time_ and arg_477_1.time_ <= var_480_1 + arg_480_0 then
				...
				local var_480_3 = arg_477_1:FormatText(arg_477_1:GetWordFromCfg(320061115).content)

				arg_477_1.text_.text = var_480_3

				LuaForUtil.ClearLinePrefixSymbol(arg_477_1.text_)

				local var_480_5 = 50 <= 0 and var_480_2 or var_480_2 * (utf8.len(var_480_3) / 50)

				if (50 <= 0 and var_480_2 or var_480_2 * (utf8.len(var_480_3) / 50)) > 0 and var_480_2 < var_480_5 then
	...
	Play320061116 = function(arg_481_0, arg_481_1)
		...
		function arg_481_1.onSingleLineUpdate_(arg_484_0)
			...
			if 0 < arg_481_1.time_ and arg_481_1.time_ <= 0 + arg_484_0 then
				...
				local var_484_1 = arg_481_1:FormatText(arg_481_1:GetWordFromCfg(320061116).content)
	...
	Play320061117 = function(arg_485_0, arg_485_1)
		...
		function arg_485_1.onSingleLineUpdate_(arg_488_0)
			if 0 < arg_485_1.time_ and arg_485_1.time_ <= 0 + arg_488_0 and not isNil(arg_485_1.actors_["10100ui_story"]) and arg_485_1.var_.characterEffect10100ui_story == nil then
				arg_485_1.var_.characterEffect10100ui_story = arg_485_1.actors_["10100ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_488_0 = 0.200000002980232

			if 0 <= arg_485_1.time_ and arg_485_1.time_ < 0 + var_488_0 and not isNil(arg_485_1.actors_["10100ui_story"]) then
				if arg_485_1.var_.characterEffect10100ui_story and not isNil(arg_485_1.actors_["10100ui_story"]) then
					arg_485_1.var_.characterEffect10100ui_story.fillFlat = false
				end
			end

			if arg_485_1.time_ >= 0 + var_488_0 and arg_485_1.time_ < 0 + var_488_0 + arg_488_0 and not isNil(arg_485_1.actors_["10100ui_story"]) and arg_485_1.var_.characterEffect10100ui_story then
				arg_485_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_485_1.time_ and arg_485_1.time_ <= var_488_2 + arg_488_0 then
				...
				arg_485_1.leftNameTxt_.text = arg_485_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_488_4 = arg_485_1:GetWordFromCfg(320061117)
				...
				local var_488_7 = 35 <= 0 and var_488_3 or var_488_3 * (utf8.len(var_488_5) / 35)

				if (35 <= 0 and var_488_3 or var_488_3 * (utf8.len(var_488_5) / 35)) > 0 and var_488_3 < var_488_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061117", "story_v_out_320061.awb") ~= 0 then
					local var_488_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061117", "story_v_out_320061.awb") / 1000
					...
					if var_488_4.prefab_name ~= "" and arg_485_1.actors_[var_488_4.prefab_name] ~= nil then
						local var_488_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_485_1.actors_[var_488_4.prefab_name].transform, "story_v_out_320061", "320061117", "story_v_out_320061.awb")

						arg_485_1:RecordAudio("320061117", var_488_9)
						arg_485_1:RecordAudio("320061117", var_488_9)
					else
	...
	Play320061118 = function(arg_489_0, arg_489_1)
		...
		function arg_489_1.onSingleLineUpdate_(arg_492_0)
			if arg_489_1.actors_["1011ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1011ui_story"))) then
				local var_492_0 = Object.Instantiate(Asset.Load("Char/" .. "1011ui_story"), arg_489_1.stage_.transform)

				var_492_0.name = "1011ui_story"
				var_492_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_489_1.actors_["1011ui_story"] = var_492_0

				local var_492_1 = var_492_0:GetComponentInChildren(typeof(CharacterEffect))

				var_492_1.enabled = true

				local var_492_2 = GameObjectTools.GetOrAddComponent(var_492_0, typeof(DynamicBoneHelper))

				if var_492_2 then
					var_492_2:EnableDynamicBone(false)
				end

				arg_489_1:ShowWeapon(var_492_1.transform, false)

				arg_489_1.var_["1011ui_story" .. "Animator"] = var_492_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_489_1.var_["1011ui_story" .. "Animator"].applyRootMotion = true
				arg_489_1.var_["1011ui_story" .. "LipSync"] = var_492_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_492_3 = arg_489_1.actors_["1011ui_story"].transform

			if 0 < arg_489_1.time_ and arg_489_1.time_ <= 0 + arg_492_0 then
				arg_489_1.var_.moveOldPos1011ui_story = var_492_3.localPosition
			end

			local var_492_4 = 0.001

			if 0 <= arg_489_1.time_ and arg_489_1.time_ < 0 + var_492_4 then
				var_492_3.localPosition = Vector3.Lerp(arg_489_1.var_.moveOldPos1011ui_story, Vector3.New(0, -0.71, -6), (arg_489_1.time_ - 0) / var_492_4)
				var_492_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_492_3.position).x, (manager.ui.mainCamera.transform.position - var_492_3.position).y, (manager.ui.mainCamera.transform.position - var_492_3.position).z)
				var_492_3.localEulerAngles.z = 0
				var_492_3.localEulerAngles.x = 0
				var_492_3.localEulerAngles = var_492_3.localEulerAngles
			end

			if arg_489_1.time_ >= 0 + var_492_4 and arg_489_1.time_ < 0 + var_492_4 + arg_492_0 then
				var_492_3.localPosition = Vector3.New(0, -0.71, -6)
				var_492_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_492_3.position).x, (manager.ui.mainCamera.transform.position - var_492_3.position).y, (manager.ui.mainCamera.transform.position - var_492_3.position).z)
				var_492_3.localEulerAngles.z = 0
				var_492_3.localEulerAngles.x = 0
				var_492_3.localEulerAngles = var_492_3.localEulerAngles
			...
			local var_492_5 = arg_489_1.actors_["1011ui_story"]

			if 0 < arg_489_1.time_ and arg_489_1.time_ <= 0 + arg_492_0 and not isNil(var_492_5) and arg_489_1.var_.characterEffect1011ui_story == nil then
				arg_489_1.var_.characterEffect1011ui_story = var_492_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_492_6 = 0.200000002980232

			if 0 <= arg_489_1.time_ and arg_489_1.time_ < 0 + var_492_6 and not isNil(var_492_5) then
				if arg_489_1.var_.characterEffect1011ui_story and not isNil(var_492_5) then
					arg_489_1.var_.characterEffect1011ui_story.fillFlat = false
				end
			end

			if arg_489_1.time_ >= 0 + var_492_6 and arg_489_1.time_ < 0 + var_492_6 + arg_492_0 and not isNil(var_492_5) and arg_489_1.var_.characterEffect1011ui_story then
				arg_489_1.var_.characterEffect1011ui_story.fillFlat = false
			end
			...
			local var_492_8 = arg_489_1.actors_["10100ui_story"].transform

			if 0 < arg_489_1.time_ and arg_489_1.time_ <= 0 + arg_492_0 then
				arg_489_1.var_.moveOldPos10100ui_story = var_492_8.localPosition
			end

			local var_492_9 = 0.001

			if 0 <= arg_489_1.time_ and arg_489_1.time_ < 0 + var_492_9 then
				var_492_8.localPosition = Vector3.Lerp(arg_489_1.var_.moveOldPos10100ui_story, Vector3.New(0, 100, 0), (arg_489_1.time_ - 0) / var_492_9)
			...
			if arg_489_1.time_ >= 0 + var_492_9 and arg_489_1.time_ < 0 + var_492_9 + arg_492_0 then
				var_492_8.localPosition = Vector3.New(0, 100, 0)
				var_492_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_492_8.position).x, (manager.ui.mainCamera.transform.position - var_492_8.position).y, (manager.ui.mainCamera.transform.position - var_492_8.position).z)
				var_492_8.localEulerAngles.z = 0
				var_492_8.localEulerAngles.x = 0
				var_492_8.localEulerAngles = var_492_8.localEulerAngles
			...
			local var_492_10 = arg_489_1.actors_["10100ui_story"]

			if 0 < arg_489_1.time_ and arg_489_1.time_ <= 0 + arg_492_0 and not isNil(var_492_10) and arg_489_1.var_.characterEffect10100ui_story == nil then
				arg_489_1.var_.characterEffect10100ui_story = var_492_10:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_492_11 = 0.200000002980232

			if 0 <= arg_489_1.time_ and arg_489_1.time_ < 0 + var_492_11 and not isNil(var_492_10) then
				if arg_489_1.var_.characterEffect10100ui_story and not isNil(var_492_10) then
					arg_489_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_489_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_489_1.time_ - 0) / var_492_11)
				end
			end

			if arg_489_1.time_ >= 0 + var_492_11 and arg_489_1.time_ < 0 + var_492_11 + arg_492_0 and not isNil(var_492_10) and arg_489_1.var_.characterEffect10100ui_story then
				arg_489_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_489_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_492_12 = 0
			local var_492_13 = 0.325

			if 0 < arg_489_1.time_ and arg_489_1.time_ <= var_492_12 + arg_492_0 then
				...
				arg_489_1.leftNameTxt_.text = arg_489_1:FormatText(StoryNameCfg[37].name)
				...
				local var_492_14 = arg_489_1:GetWordFromCfg(320061118)
				...
				local var_492_17 = 13 <= 0 and var_492_13 or var_492_13 * (utf8.len(var_492_15) / 13)

				if (13 <= 0 and var_492_13 or var_492_13 * (utf8.len(var_492_15) / 13)) > 0 and var_492_13 < var_492_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061118", "story_v_out_320061.awb") ~= 0 then
					local var_492_18 = manager.audio:GetVoiceLength("story_v_out_320061", "320061118", "story_v_out_320061.awb") / 1000

					if var_492_18 + var_492_12 > arg_489_1.duration_ then
						arg_489_1.duration_ = var_492_18 + var_492_12
					end

					if var_492_14.prefab_name ~= "" and arg_489_1.actors_[var_492_14.prefab_name] ~= nil then
						local var_492_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_489_1.actors_[var_492_14.prefab_name].transform, "story_v_out_320061", "320061118", "story_v_out_320061.awb")

						arg_489_1:RecordAudio("320061118", var_492_19)
						arg_489_1:RecordAudio("320061118", var_492_19)
					else
	...
	Play320061119 = function(arg_493_0, arg_493_1)
		...
		function arg_493_1.onSingleLineUpdate_(arg_496_0)
			if 0 < arg_493_1.time_ and arg_493_1.time_ <= 0 + arg_496_0 and not isNil(arg_493_1.actors_["1011ui_story"]) and arg_493_1.var_.characterEffect1011ui_story == nil then
				arg_493_1.var_.characterEffect1011ui_story = arg_493_1.actors_["1011ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_496_0 = 0.200000002980232

			if 0 <= arg_493_1.time_ and arg_493_1.time_ < 0 + var_496_0 and not isNil(arg_493_1.actors_["1011ui_story"]) then
				if arg_493_1.var_.characterEffect1011ui_story and not isNil(arg_493_1.actors_["1011ui_story"]) then
					arg_493_1.var_.characterEffect1011ui_story.fillFlat = true
					arg_493_1.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_493_1.time_ - 0) / var_496_0)
				end
			end

			if arg_493_1.time_ >= 0 + var_496_0 and arg_493_1.time_ < 0 + var_496_0 + arg_496_0 and not isNil(arg_493_1.actors_["1011ui_story"]) and arg_493_1.var_.characterEffect1011ui_story then
				arg_493_1.var_.characterEffect1011ui_story.fillFlat = true
				arg_493_1.var_.characterEffect1011ui_story.fillRatio = 0.5
			end

			local var_496_1 = 0
			local var_496_2 = 0.825
			...
			if 0 < arg_493_1.time_ and arg_493_1.time_ <= var_496_1 + arg_496_0 then
				...
				local var_496_3 = arg_493_1:FormatText(arg_493_1:GetWordFromCfg(320061119).content)

				arg_493_1.text_.text = var_496_3

				LuaForUtil.ClearLinePrefixSymbol(arg_493_1.text_)

				local var_496_5 = 33 <= 0 and var_496_2 or var_496_2 * (utf8.len(var_496_3) / 33)

				if (33 <= 0 and var_496_2 or var_496_2 * (utf8.len(var_496_3) / 33)) > 0 and var_496_2 < var_496_5 then
	...
	Play320061120 = function(arg_497_0, arg_497_1)
		...
		function arg_497_1.onSingleLineUpdate_(arg_500_0)
			...
			if 0 < arg_497_1.time_ and arg_497_1.time_ <= 0 + arg_500_0 then
				...
				local var_500_1 = arg_497_1:FormatText(arg_497_1:GetWordFromCfg(320061120).content)

				arg_497_1.text_.text = var_500_1

				LuaForUtil.ClearLinePrefixSymbol(arg_497_1.text_)

				local var_500_3 = 36 <= 0 and var_500_0 or var_500_0 * (utf8.len(var_500_1) / 36)

				if (36 <= 0 and var_500_0 or var_500_0 * (utf8.len(var_500_1) / 36)) > 0 and var_500_0 < var_500_3 then
	...
	Play320061121 = function(arg_501_0, arg_501_1)
		...
		function arg_501_1.onSingleLineUpdate_(arg_504_0)
			...
			if 0 < arg_501_1.time_ and arg_501_1.time_ <= 0 + arg_504_0 then
				...
				local var_504_1 = arg_501_1:FormatText(arg_501_1:GetWordFromCfg(320061121).content)

				arg_501_1.text_.text = var_504_1

				LuaForUtil.ClearLinePrefixSymbol(arg_501_1.text_)

				local var_504_3 = 32 <= 0 and var_504_0 or var_504_0 * (utf8.len(var_504_1) / 32)

				if (32 <= 0 and var_504_0 or var_504_0 * (utf8.len(var_504_1) / 32)) > 0 and var_504_0 < var_504_3 then
	...
	Play320061122 = function(arg_505_0, arg_505_1)
		...
		function arg_505_1.onSingleLineUpdate_(arg_508_0)
			if 0 < arg_505_1.time_ and arg_505_1.time_ <= 0 + arg_508_0 then
				arg_505_1.var_.moveOldPos1011ui_story = arg_505_1.actors_["1011ui_story"].transform.localPosition
			end

			local var_508_0 = 0.001

			if 0 <= arg_505_1.time_ and arg_505_1.time_ < 0 + var_508_0 then
				arg_505_1.actors_["1011ui_story"].transform.localPosition = Vector3.Lerp(arg_505_1.var_.moveOldPos1011ui_story, Vector3.New(0, -0.71, -6), (arg_505_1.time_ - 0) / var_508_0)
				arg_505_1.actors_["1011ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_505_1.actors_["1011ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_505_1.actors_["1011ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_505_1.actors_["1011ui_story"].transform.position).z)
				arg_505_1.actors_["1011ui_story"].transform.localEulerAngles.z = 0
				arg_505_1.actors_["1011ui_story"].transform.localEulerAngles.x = 0
				arg_505_1.actors_["1011ui_story"].transform.localEulerAngles = arg_505_1.actors_["1011ui_story"].transform.localEulerAngles
			end

			if arg_505_1.time_ >= 0 + var_508_0 and arg_505_1.time_ < 0 + var_508_0 + arg_508_0 then
				arg_505_1.actors_["1011ui_story"].transform.localPosition = Vector3.New(0, -0.71, -6)
				arg_505_1.actors_["1011ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_505_1.actors_["1011ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_505_1.actors_["1011ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_505_1.actors_["1011ui_story"].transform.position).z)
				arg_505_1.actors_["1011ui_story"].transform.localEulerAngles.z = 0
				arg_505_1.actors_["1011ui_story"].transform.localEulerAngles.x = 0
				arg_505_1.actors_["1011ui_story"].transform.localEulerAngles = arg_505_1.actors_["1011ui_story"].transform.localEulerAngles
			...
			local var_508_1 = arg_505_1.actors_["1011ui_story"]

			if 0 < arg_505_1.time_ and arg_505_1.time_ <= 0 + arg_508_0 and not isNil(var_508_1) and arg_505_1.var_.characterEffect1011ui_story == nil then
				arg_505_1.var_.characterEffect1011ui_story = var_508_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_508_2 = 0.200000002980232

			if 0 <= arg_505_1.time_ and arg_505_1.time_ < 0 + var_508_2 and not isNil(var_508_1) then
				if arg_505_1.var_.characterEffect1011ui_story and not isNil(var_508_1) then
					arg_505_1.var_.characterEffect1011ui_story.fillFlat = false
				end
			end

			if arg_505_1.time_ >= 0 + var_508_2 and arg_505_1.time_ < 0 + var_508_2 + arg_508_0 and not isNil(var_508_1) and arg_505_1.var_.characterEffect1011ui_story then
				arg_505_1.var_.characterEffect1011ui_story.fillFlat = false
			end
			...
			if 0 < arg_505_1.time_ and arg_505_1.time_ <= var_508_4 + arg_508_0 then
				...
				arg_505_1.leftNameTxt_.text = arg_505_1:FormatText(StoryNameCfg[37].name)
				...
				local var_508_6 = arg_505_1:GetWordFromCfg(320061122)
				...
				local var_508_9 = 16 <= 0 and var_508_5 or var_508_5 * (utf8.len(var_508_7) / 16)

				if (16 <= 0 and var_508_5 or var_508_5 * (utf8.len(var_508_7) / 16)) > 0 and var_508_5 < var_508_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061122", "story_v_out_320061.awb") ~= 0 then
					local var_508_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061122", "story_v_out_320061.awb") / 1000
					...
					if var_508_6.prefab_name ~= "" and arg_505_1.actors_[var_508_6.prefab_name] ~= nil then
						local var_508_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_505_1.actors_[var_508_6.prefab_name].transform, "story_v_out_320061", "320061122", "story_v_out_320061.awb")

						arg_505_1:RecordAudio("320061122", var_508_11)
						arg_505_1:RecordAudio("320061122", var_508_11)
					else
	...
	Play320061123 = function(arg_509_0, arg_509_1)
		...
		function arg_509_1.onSingleLineUpdate_(arg_512_0)
			...
			if 0 <= arg_509_1.time_ and arg_509_1.time_ < 0 + var_512_0 then
				arg_509_1.actors_["1011ui_story"].transform.localPosition = Vector3.Lerp(arg_509_1.var_.moveOldPos1011ui_story, Vector3.New(0, 100, 0), (arg_509_1.time_ - 0) / var_512_0)
			...
			if arg_509_1.time_ >= 0 + var_512_0 and arg_509_1.time_ < 0 + var_512_0 + arg_512_0 then
				arg_509_1.actors_["1011ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_509_1.actors_["1011ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_509_1.actors_["1011ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_509_1.actors_["1011ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_509_1.actors_["1011ui_story"].transform.position).z)
				arg_509_1.actors_["1011ui_story"].transform.localEulerAngles.z = 0
				arg_509_1.actors_["1011ui_story"].transform.localEulerAngles.x = 0
				arg_509_1.actors_["1011ui_story"].transform.localEulerAngles = arg_509_1.actors_["1011ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_509_1.time_ and arg_509_1.time_ < 0 + var_512_2 and not isNil(var_512_1) then
				if arg_509_1.var_.characterEffect1011ui_story and not isNil(var_512_1) then
					...
					arg_509_1.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_509_1.time_ - 0) / var_512_2)
				end
			end
			...
			if arg_509_1.time_ >= 0 + var_512_2 and arg_509_1.time_ < 0 + var_512_2 + arg_512_0 and not isNil(var_512_1) and arg_509_1.var_.characterEffect1011ui_story then
				arg_509_1.var_.characterEffect1011ui_story.fillFlat = true
				arg_509_1.var_.characterEffect1011ui_story.fillRatio = 0.5
			end

			local var_512_3 = arg_509_1.actors_["10100ui_story"].transform

			if 0 < arg_509_1.time_ and arg_509_1.time_ <= 0 + arg_512_0 then
				arg_509_1.var_.moveOldPos10100ui_story = var_512_3.localPosition
			end

			local var_512_4 = 0.001

			if 0 <= arg_509_1.time_ and arg_509_1.time_ < 0 + var_512_4 then
				var_512_3.localPosition = Vector3.Lerp(arg_509_1.var_.moveOldPos10100ui_story, Vector3.New(0, -1.16, -6.25), (arg_509_1.time_ - 0) / var_512_4)
				var_512_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_512_3.position).x, (manager.ui.mainCamera.transform.position - var_512_3.position).y, (manager.ui.mainCamera.transform.position - var_512_3.position).z)
				var_512_3.localEulerAngles.z = 0
				var_512_3.localEulerAngles.x = 0
				var_512_3.localEulerAngles = var_512_3.localEulerAngles
			end

			if arg_509_1.time_ >= 0 + var_512_4 and arg_509_1.time_ < 0 + var_512_4 + arg_512_0 then
				var_512_3.localPosition = Vector3.New(0, -1.16, -6.25)
				var_512_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_512_3.position).x, (manager.ui.mainCamera.transform.position - var_512_3.position).y, (manager.ui.mainCamera.transform.position - var_512_3.position).z)
				var_512_3.localEulerAngles.z = 0
				var_512_3.localEulerAngles.x = 0
				var_512_3.localEulerAngles = var_512_3.localEulerAngles
			...
			local var_512_5 = arg_509_1.actors_["10100ui_story"]

			if 0 < arg_509_1.time_ and arg_509_1.time_ <= 0 + arg_512_0 and not isNil(var_512_5) and arg_509_1.var_.characterEffect10100ui_story == nil then
				arg_509_1.var_.characterEffect10100ui_story = var_512_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_512_6 = 0.200000002980232

			if 0 <= arg_509_1.time_ and arg_509_1.time_ < 0 + var_512_6 and not isNil(var_512_5) then
				if arg_509_1.var_.characterEffect10100ui_story and not isNil(var_512_5) then
					arg_509_1.var_.characterEffect10100ui_story.fillFlat = false
				end
			end

			if arg_509_1.time_ >= 0 + var_512_6 and arg_509_1.time_ < 0 + var_512_6 + arg_512_0 and not isNil(var_512_5) and arg_509_1.var_.characterEffect10100ui_story then
				arg_509_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_509_1.time_ and arg_509_1.time_ <= var_512_8 + arg_512_0 then
				...
				arg_509_1.leftNameTxt_.text = arg_509_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_512_10 = arg_509_1:GetWordFromCfg(320061123)
				...
				local var_512_13 = 22 <= 0 and var_512_9 or var_512_9 * (utf8.len(var_512_11) / 22)

				if (22 <= 0 and var_512_9 or var_512_9 * (utf8.len(var_512_11) / 22)) > 0 and var_512_9 < var_512_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061123", "story_v_out_320061.awb") ~= 0 then
					local var_512_14 = manager.audio:GetVoiceLength("story_v_out_320061", "320061123", "story_v_out_320061.awb") / 1000
					...
					if var_512_10.prefab_name ~= "" and arg_509_1.actors_[var_512_10.prefab_name] ~= nil then
						local var_512_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_509_1.actors_[var_512_10.prefab_name].transform, "story_v_out_320061", "320061123", "story_v_out_320061.awb")

						arg_509_1:RecordAudio("320061123", var_512_15)
						arg_509_1:RecordAudio("320061123", var_512_15)
					else
	...
	Play320061124 = function(arg_513_0, arg_513_1)
		...
		function arg_513_1.onSingleLineUpdate_(arg_516_0)
			...
			if 0 < arg_513_1.time_ and arg_513_1.time_ <= 0 + arg_516_0 then
				...
				arg_513_1.leftNameTxt_.text = arg_513_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_516_1 = arg_513_1:GetWordFromCfg(320061124)
				...
				local var_516_4 = 17 <= 0 and var_516_0 or var_516_0 * (utf8.len(var_516_2) / 17)

				if (17 <= 0 and var_516_0 or var_516_0 * (utf8.len(var_516_2) / 17)) > 0 and var_516_0 < var_516_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061124", "story_v_out_320061.awb") ~= 0 then
					local var_516_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061124", "story_v_out_320061.awb") / 1000
					...
					if var_516_1.prefab_name ~= "" and arg_513_1.actors_[var_516_1.prefab_name] ~= nil then
						local var_516_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_513_1.actors_[var_516_1.prefab_name].transform, "story_v_out_320061", "320061124", "story_v_out_320061.awb")

						arg_513_1:RecordAudio("320061124", var_516_6)
						arg_513_1:RecordAudio("320061124", var_516_6)
					else
	...
	Play320061125 = function(arg_517_0, arg_517_1)
		...
		function arg_517_1.onSingleLineUpdate_(arg_520_0)
			...
			if 0 < arg_517_1.time_ and arg_517_1.time_ <= var_520_0 + arg_520_0 then
				...
				arg_517_1.leftNameTxt_.text = arg_517_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_520_2 = arg_517_1:GetWordFromCfg(320061125)
				...
				local var_520_5 = 16 <= 0 and var_520_1 or var_520_1 * (utf8.len(var_520_3) / 16)

				if (16 <= 0 and var_520_1 or var_520_1 * (utf8.len(var_520_3) / 16)) > 0 and var_520_1 < var_520_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061125", "story_v_out_320061.awb") ~= 0 then
					local var_520_6 = manager.audio:GetVoiceLength("story_v_out_320061", "320061125", "story_v_out_320061.awb") / 1000
					...
					if var_520_2.prefab_name ~= "" and arg_517_1.actors_[var_520_2.prefab_name] ~= nil then
						local var_520_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_517_1.actors_[var_520_2.prefab_name].transform, "story_v_out_320061", "320061125", "story_v_out_320061.awb")

						arg_517_1:RecordAudio("320061125", var_520_7)
						arg_517_1:RecordAudio("320061125", var_520_7)
					else
	...
	Play320061126 = function(arg_521_0, arg_521_1)
		...
		function arg_521_1.onSingleLineUpdate_(arg_524_0)
			if 0 < arg_521_1.time_ and arg_521_1.time_ <= 0 + arg_524_0 then
				arg_521_1.var_.moveOldPos10100ui_story = arg_521_1.actors_["10100ui_story"].transform.localPosition
			end

			local var_524_0 = 0.001

			if 0 <= arg_521_1.time_ and arg_521_1.time_ < 0 + var_524_0 then
				arg_521_1.actors_["10100ui_story"].transform.localPosition = Vector3.Lerp(arg_521_1.var_.moveOldPos10100ui_story, Vector3.New(0, 100, 0), (arg_521_1.time_ - 0) / var_524_0)
				arg_521_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_521_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_521_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_521_1.actors_["10100ui_story"].transform.position).z)
				arg_521_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_521_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_521_1.actors_["10100ui_story"].transform.localEulerAngles = arg_521_1.actors_["10100ui_story"].transform.localEulerAngles
			end

			if arg_521_1.time_ >= 0 + var_524_0 and arg_521_1.time_ < 0 + var_524_0 + arg_524_0 then
				arg_521_1.actors_["10100ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_521_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_521_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_521_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_521_1.actors_["10100ui_story"].transform.position).z)
				arg_521_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_521_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_521_1.actors_["10100ui_story"].transform.localEulerAngles = arg_521_1.actors_["10100ui_story"].transform.localEulerAngles
			...
			local var_524_1 = arg_521_1.actors_["10100ui_story"]

			if 0 < arg_521_1.time_ and arg_521_1.time_ <= 0 + arg_524_0 and not isNil(var_524_1) and arg_521_1.var_.characterEffect10100ui_story == nil then
				arg_521_1.var_.characterEffect10100ui_story = var_524_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_524_2 = 0.200000002980232

			if 0 <= arg_521_1.time_ and arg_521_1.time_ < 0 + var_524_2 and not isNil(var_524_1) then
				if arg_521_1.var_.characterEffect10100ui_story and not isNil(var_524_1) then
					arg_521_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_521_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_521_1.time_ - 0) / var_524_2)
				end
			end

			if arg_521_1.time_ >= 0 + var_524_2 and arg_521_1.time_ < 0 + var_524_2 + arg_524_0 and not isNil(var_524_1) and arg_521_1.var_.characterEffect10100ui_story then
				arg_521_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_521_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_524_3 = 0
			local var_524_4 = 1.025
			...
			if 0 < arg_521_1.time_ and arg_521_1.time_ <= var_524_3 + arg_524_0 then
				...
				local var_524_5 = arg_521_1:FormatText(arg_521_1:GetWordFromCfg(320061126).content)

				arg_521_1.text_.text = var_524_5

				LuaForUtil.ClearLinePrefixSymbol(arg_521_1.text_)

				local var_524_7 = 41 <= 0 and var_524_4 or var_524_4 * (utf8.len(var_524_5) / 41)

				if (41 <= 0 and var_524_4 or var_524_4 * (utf8.len(var_524_5) / 41)) > 0 and var_524_4 < var_524_7 then
	...
	Play320061127 = function(arg_525_0, arg_525_1)
		...
		function arg_525_1.onSingleLineUpdate_(arg_528_0)
			if 0 < arg_525_1.time_ and arg_525_1.time_ <= 0 + arg_528_0 then
				arg_525_1:AudioAction("play", "effect", "se_story_side_1148", "se_story_1148_explosion", "")
			end
			...
			if 0 < arg_525_1.time_ and arg_525_1.time_ <= var_528_1 + arg_528_0 then
				...
				local var_528_3 = arg_525_1:FormatText(arg_525_1:GetWordFromCfg(320061127).content)

				arg_525_1.text_.text = var_528_3

				LuaForUtil.ClearLinePrefixSymbol(arg_525_1.text_)

				local var_528_5 = 40 <= 0 and var_528_2 or var_528_2 * (utf8.len(var_528_3) / 40)

				if (40 <= 0 and var_528_2 or var_528_2 * (utf8.len(var_528_3) / 40)) > 0 and var_528_2 < var_528_5 then
	...
	Play320061128 = function(arg_529_0, arg_529_1)
		...
		function arg_529_1.onSingleLineUpdate_(arg_532_0)
			if 0 < arg_529_1.time_ and arg_529_1.time_ <= 0 + arg_532_0 then
				arg_529_1.var_.moveOldPos10100ui_story = arg_529_1.actors_["10100ui_story"].transform.localPosition
			end

			local var_532_0 = 0.001

			if 0 <= arg_529_1.time_ and arg_529_1.time_ < 0 + var_532_0 then
				arg_529_1.actors_["10100ui_story"].transform.localPosition = Vector3.Lerp(arg_529_1.var_.moveOldPos10100ui_story, Vector3.New(0, -1.16, -6.25), (arg_529_1.time_ - 0) / var_532_0)
				arg_529_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_529_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_529_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_529_1.actors_["10100ui_story"].transform.position).z)
				arg_529_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_529_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_529_1.actors_["10100ui_story"].transform.localEulerAngles = arg_529_1.actors_["10100ui_story"].transform.localEulerAngles
			end

			if arg_529_1.time_ >= 0 + var_532_0 and arg_529_1.time_ < 0 + var_532_0 + arg_532_0 then
				arg_529_1.actors_["10100ui_story"].transform.localPosition = Vector3.New(0, -1.16, -6.25)
				arg_529_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_529_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_529_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_529_1.actors_["10100ui_story"].transform.position).z)
				arg_529_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_529_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_529_1.actors_["10100ui_story"].transform.localEulerAngles = arg_529_1.actors_["10100ui_story"].transform.localEulerAngles
			...
			local var_532_1 = arg_529_1.actors_["10100ui_story"]

			if 0 < arg_529_1.time_ and arg_529_1.time_ <= 0 + arg_532_0 and not isNil(var_532_1) and arg_529_1.var_.characterEffect10100ui_story == nil then
				arg_529_1.var_.characterEffect10100ui_story = var_532_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_532_2 = 0.200000002980232

			if 0 <= arg_529_1.time_ and arg_529_1.time_ < 0 + var_532_2 and not isNil(var_532_1) then
				if arg_529_1.var_.characterEffect10100ui_story and not isNil(var_532_1) then
					arg_529_1.var_.characterEffect10100ui_story.fillFlat = false
				end
			end

			if arg_529_1.time_ >= 0 + var_532_2 and arg_529_1.time_ < 0 + var_532_2 + arg_532_0 and not isNil(var_532_1) and arg_529_1.var_.characterEffect10100ui_story then
				arg_529_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_529_1.time_ and arg_529_1.time_ <= var_532_4 + arg_532_0 then
				...
				arg_529_1.leftNameTxt_.text = arg_529_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_532_6 = arg_529_1:GetWordFromCfg(320061128)
				...
				local var_532_9 = 25 <= 0 and var_532_5 or var_532_5 * (utf8.len(var_532_7) / 25)

				if (25 <= 0 and var_532_5 or var_532_5 * (utf8.len(var_532_7) / 25)) > 0 and var_532_5 < var_532_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061128", "story_v_out_320061.awb") ~= 0 then
					local var_532_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061128", "story_v_out_320061.awb") / 1000
					...
					if var_532_6.prefab_name ~= "" and arg_529_1.actors_[var_532_6.prefab_name] ~= nil then
						local var_532_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_529_1.actors_[var_532_6.prefab_name].transform, "story_v_out_320061", "320061128", "story_v_out_320061.awb")

						arg_529_1:RecordAudio("320061128", var_532_11)
						arg_529_1:RecordAudio("320061128", var_532_11)
					else
	...
	Play320061129 = function(arg_533_0, arg_533_1)
		...
		function arg_533_1.onSingleLineUpdate_(arg_536_0)
			if 2 < arg_533_1.time_ and arg_533_1.time_ <= 2 + arg_536_0 then
				local var_536_0 = arg_533_1.bgs_.ST0503

				arg_533_1.bgs_.ST0503.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
				var_536_0.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_536_1 = var_536_0:GetComponent("SpriteRenderer")

				if var_536_1 and var_536_1.sprite then
					local var_536_2 = 2 * (var_536_0.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_536_0.transform.localScale = Vector3.New(var_536_2 / var_536_1.sprite.bounds.size.y < var_536_2 * manager.ui.mainCameraCom_.aspect / var_536_1.sprite.bounds.size.x and var_536_2 * manager.ui.mainCameraCom_.aspect / var_536_1.sprite.bounds.size.x or var_536_2 / var_536_1.sprite.bounds.size.y, var_536_2 / var_536_1.sprite.bounds.size.y < var_536_2 * manager.ui.mainCameraCom_.aspect / var_536_1.sprite.bounds.size.x and var_536_2 * manager.ui.mainCameraCom_.aspect / var_536_1.sprite.bounds.size.x or var_536_2 / var_536_1.sprite.bounds.size.y, 0)
				end
			...
			if 4 < arg_533_1.time_ and arg_533_1.time_ <= var_536_3 + arg_536_0 then
				arg_533_1.allBtn_.enabled = false
			end

			if arg_533_1.time_ >= var_536_3 + 0.3 and arg_533_1.time_ < var_536_3 + 0.3 + arg_536_0 then
			...
			if var_536_4 <= arg_533_1.time_ and arg_533_1.time_ < var_536_4 + var_536_5 then
				local var_536_6 = Color.New(0, 0, 0)

				var_536_6.a = Mathf.Lerp(0, 1, (arg_533_1.time_ - var_536_4) / var_536_5)
				arg_533_1.mask_.color = var_536_6
			end

			if arg_533_1.time_ >= var_536_4 + var_536_5 and arg_533_1.time_ < var_536_4 + var_536_5 + arg_536_0 then
				local var_536_7 = Color.New(0, 0, 0)

				var_536_7.a = 1
				arg_533_1.mask_.color = var_536_7
			end

			local var_536_8 = 2

			if 2 < arg_533_1.time_ and arg_533_1.time_ <= var_536_8 + arg_536_0 then
				arg_533_1.mask_.enabled = true
				arg_533_1.mask_.raycastTarget = true
			...
			if var_536_8 <= arg_533_1.time_ and arg_533_1.time_ < var_536_8 + var_536_9 then
				local var_536_10 = Color.New(0, 0, 0)

				var_536_10.a = Mathf.Lerp(1, 0, (arg_533_1.time_ - var_536_8) / var_536_9)
				arg_533_1.mask_.color = var_536_10
			end

			if arg_533_1.time_ >= var_536_8 + var_536_9 and arg_533_1.time_ < var_536_8 + var_536_9 + arg_536_0 then
				local var_536_11 = Color.New(0, 0, 0)

				arg_533_1.mask_.enabled = false
				var_536_11.a = 0
				arg_533_1.mask_.color = var_536_11
			end

			local var_536_12 = arg_533_1.actors_["10100ui_story"].transform

			if 1.96599999815226 < arg_533_1.time_ and arg_533_1.time_ <= 1.96599999815226 + arg_536_0 then
				arg_533_1.var_.moveOldPos10100ui_story = var_536_12.localPosition
			end

			local var_536_13 = 0.001

			if 1.96599999815226 <= arg_533_1.time_ and arg_533_1.time_ < 1.96599999815226 + var_536_13 then
				var_536_12.localPosition = Vector3.Lerp(arg_533_1.var_.moveOldPos10100ui_story, Vector3.New(0, 100, 0), (arg_533_1.time_ - 1.96599999815226) / var_536_13)
				var_536_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_536_12.position).x, (manager.ui.mainCamera.transform.position - var_536_12.position).y, (manager.ui.mainCamera.transform.position - var_536_12.position).z)
				var_536_12.localEulerAngles.z = 0
				var_536_12.localEulerAngles.x = 0
				var_536_12.localEulerAngles = var_536_12.localEulerAngles
			end

			if arg_533_1.time_ >= 1.96599999815226 + var_536_13 and arg_533_1.time_ < 1.96599999815226 + var_536_13 + arg_536_0 then
				var_536_12.localPosition = Vector3.New(0, 100, 0)
				var_536_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_536_12.position).x, (manager.ui.mainCamera.transform.position - var_536_12.position).y, (manager.ui.mainCamera.transform.position - var_536_12.position).z)
				var_536_12.localEulerAngles.z = 0
				var_536_12.localEulerAngles.x = 0
				var_536_12.localEulerAngles = var_536_12.localEulerAngles
			...
			local var_536_14 = arg_533_1.actors_["10100ui_story"]

			if 1.96599999815226 < arg_533_1.time_ and arg_533_1.time_ <= 1.96599999815226 + arg_536_0 and not isNil(var_536_14) and arg_533_1.var_.characterEffect10100ui_story == nil then
				arg_533_1.var_.characterEffect10100ui_story = var_536_14:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_536_15 = 0.034000001847744

			if 1.96599999815226 <= arg_533_1.time_ and arg_533_1.time_ < 1.96599999815226 + var_536_15 and not isNil(var_536_14) then
				if arg_533_1.var_.characterEffect10100ui_story and not isNil(var_536_14) then
					arg_533_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_533_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_533_1.time_ - 1.96599999815226) / var_536_15)
				end
			end

			if arg_533_1.time_ >= 1.96599999815226 + var_536_15 and arg_533_1.time_ < 1.96599999815226 + var_536_15 + arg_536_0 and not isNil(var_536_14) and arg_533_1.var_.characterEffect10100ui_story then
				arg_533_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_533_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end
			...
			local var_536_16 = 4
			local var_536_17 = 1.675

			if 4 < arg_533_1.time_ and arg_533_1.time_ <= var_536_16 + arg_536_0 then
				...
				local var_536_18 = LeanTween.value(arg_533_1.dialog_, 0, 1, 0.3)

				var_536_18:setOnUpdate(LuaHelper.FloatAction(function(arg_537_0)
					arg_533_1.dialogCg_.alpha = arg_537_0
				end))
				var_536_18:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_533_1.dialog_)
					var_536_18:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_536_19 = arg_533_1:FormatText(arg_533_1:GetWordFromCfg(320061129).content)

				arg_533_1.text_.text = var_536_19

				LuaForUtil.ClearLinePrefixSymbol(arg_533_1.text_)

				local var_536_21 = 67 <= 0 and var_536_17 or var_536_17 * (utf8.len(var_536_19) / 67)

				if (67 <= 0 and var_536_17 or var_536_17 * (utf8.len(var_536_19) / 67)) > 0 and var_536_17 < var_536_21 then
					arg_533_1.talkMaxDuration = var_536_21
					var_536_16 = var_536_16 + 0.3

					if var_536_21 + var_536_16 > arg_533_1.duration_ then
						arg_533_1.duration_ = var_536_21 + var_536_16
					end
				end
			...
			local var_536_22 = var_536_16 + 0.3
			local var_536_23 = math.max(var_536_17, arg_533_1.talkMaxDuration)

			if var_536_16 + 0.3 <= arg_533_1.time_ and arg_533_1.time_ < var_536_22 + var_536_23 then
				arg_533_1.typewritter.percent = (arg_533_1.time_ - var_536_22) / var_536_23

				arg_533_1.typewritter:SetDirty()
			end

			if arg_533_1.time_ >= var_536_22 + var_536_23 and arg_533_1.time_ < var_536_22 + var_536_23 + arg_536_0 then
	...
	Play320061130 = function(arg_539_0, arg_539_1)
		...
		function arg_539_1.onSingleLineUpdate_(arg_542_0)
			...
			if 0 < arg_539_1.time_ and arg_539_1.time_ <= 0 + arg_542_0 then
				...
				local var_542_1 = arg_539_1:FormatText(arg_539_1:GetWordFromCfg(320061130).content)

				arg_539_1.text_.text = var_542_1

				LuaForUtil.ClearLinePrefixSymbol(arg_539_1.text_)

				local var_542_3 = 12 <= 0 and var_542_0 or var_542_0 * (utf8.len(var_542_1) / 12)

				if (12 <= 0 and var_542_0 or var_542_0 * (utf8.len(var_542_1) / 12)) > 0 and var_542_0 < var_542_3 then
	...
	Play320061131 = function(arg_543_0, arg_543_1)
		...
		function arg_543_1.onSingleLineUpdate_(arg_546_0)
			if 0 < arg_543_1.time_ and arg_543_1.time_ <= 0 + arg_546_0 then
				arg_543_1.var_.moveOldPos10100ui_story = arg_543_1.actors_["10100ui_story"].transform.localPosition
			end

			local var_546_0 = 0.001

			if 0 <= arg_543_1.time_ and arg_543_1.time_ < 0 + var_546_0 then
				arg_543_1.actors_["10100ui_story"].transform.localPosition = Vector3.Lerp(arg_543_1.var_.moveOldPos10100ui_story, Vector3.New(0, -1.16, -6.25), (arg_543_1.time_ - 0) / var_546_0)
				arg_543_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_543_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_543_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_543_1.actors_["10100ui_story"].transform.position).z)
				arg_543_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_543_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_543_1.actors_["10100ui_story"].transform.localEulerAngles = arg_543_1.actors_["10100ui_story"].transform.localEulerAngles
			end

			if arg_543_1.time_ >= 0 + var_546_0 and arg_543_1.time_ < 0 + var_546_0 + arg_546_0 then
				arg_543_1.actors_["10100ui_story"].transform.localPosition = Vector3.New(0, -1.16, -6.25)
				arg_543_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_543_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_543_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_543_1.actors_["10100ui_story"].transform.position).z)
				arg_543_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_543_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_543_1.actors_["10100ui_story"].transform.localEulerAngles = arg_543_1.actors_["10100ui_story"].transform.localEulerAngles
			...
			local var_546_1 = arg_543_1.actors_["10100ui_story"]

			if 0 < arg_543_1.time_ and arg_543_1.time_ <= 0 + arg_546_0 and not isNil(var_546_1) and arg_543_1.var_.characterEffect10100ui_story == nil then
				arg_543_1.var_.characterEffect10100ui_story = var_546_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_546_2 = 0.200000002980232

			if 0 <= arg_543_1.time_ and arg_543_1.time_ < 0 + var_546_2 and not isNil(var_546_1) then
				if arg_543_1.var_.characterEffect10100ui_story and not isNil(var_546_1) then
					arg_543_1.var_.characterEffect10100ui_story.fillFlat = false
				end
			end

			if arg_543_1.time_ >= 0 + var_546_2 and arg_543_1.time_ < 0 + var_546_2 + arg_546_0 and not isNil(var_546_1) and arg_543_1.var_.characterEffect10100ui_story then
				arg_543_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_543_1.time_ and arg_543_1.time_ <= var_546_4 + arg_546_0 then
				...
				arg_543_1.leftNameTxt_.text = arg_543_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_546_6 = arg_543_1:GetWordFromCfg(320061131)
				...
				local var_546_9 = 37 <= 0 and var_546_5 or var_546_5 * (utf8.len(var_546_7) / 37)

				if (37 <= 0 and var_546_5 or var_546_5 * (utf8.len(var_546_7) / 37)) > 0 and var_546_5 < var_546_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061131", "story_v_out_320061.awb") ~= 0 then
					local var_546_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061131", "story_v_out_320061.awb") / 1000
					...
					if var_546_6.prefab_name ~= "" and arg_543_1.actors_[var_546_6.prefab_name] ~= nil then
						local var_546_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_543_1.actors_[var_546_6.prefab_name].transform, "story_v_out_320061", "320061131", "story_v_out_320061.awb")

						arg_543_1:RecordAudio("320061131", var_546_11)
						arg_543_1:RecordAudio("320061131", var_546_11)
					else
	...
	Play320061132 = function(arg_547_0, arg_547_1)
		...
		function arg_547_1.onSingleLineUpdate_(arg_550_0)
			...
			if 0 <= arg_547_1.time_ and arg_547_1.time_ < 0 + var_550_0 then
				arg_547_1.actors_["10100ui_story"].transform.localPosition = Vector3.Lerp(arg_547_1.var_.moveOldPos10100ui_story, Vector3.New(-0.7, -1.16, -6.25), (arg_547_1.time_ - 0) / var_550_0)
			...
			if arg_547_1.time_ >= 0 + var_550_0 and arg_547_1.time_ < 0 + var_550_0 + arg_550_0 then
				arg_547_1.actors_["10100ui_story"].transform.localPosition = Vector3.New(-0.7, -1.16, -6.25)
				arg_547_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_547_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_547_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_547_1.actors_["10100ui_story"].transform.position).z)
				arg_547_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_547_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_547_1.actors_["10100ui_story"].transform.localEulerAngles = arg_547_1.actors_["10100ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_547_1.time_ and arg_547_1.time_ < 0 + var_550_2 and not isNil(var_550_1) then
				if arg_547_1.var_.characterEffect10100ui_story and not isNil(var_550_1) then
					...
					arg_547_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_547_1.time_ - 0) / var_550_2)
				end
			end
			...
			if arg_547_1.time_ >= 0 + var_550_2 and arg_547_1.time_ < 0 + var_550_2 + arg_550_0 and not isNil(var_550_1) and arg_547_1.var_.characterEffect10100ui_story then
				arg_547_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_547_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_550_3 = arg_547_1.actors_["1011ui_story"].transform

			if 0 < arg_547_1.time_ and arg_547_1.time_ <= 0 + arg_550_0 then
				arg_547_1.var_.moveOldPos1011ui_story = var_550_3.localPosition
			end

			local var_550_4 = 0.001

			if 0 <= arg_547_1.time_ and arg_547_1.time_ < 0 + var_550_4 then
				var_550_3.localPosition = Vector3.Lerp(arg_547_1.var_.moveOldPos1011ui_story, Vector3.New(0.7, -0.71, -6), (arg_547_1.time_ - 0) / var_550_4)
				var_550_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_550_3.position).x, (manager.ui.mainCamera.transform.position - var_550_3.position).y, (manager.ui.mainCamera.transform.position - var_550_3.position).z)
				var_550_3.localEulerAngles.z = 0
				var_550_3.localEulerAngles.x = 0
				var_550_3.localEulerAngles = var_550_3.localEulerAngles
			end

			if arg_547_1.time_ >= 0 + var_550_4 and arg_547_1.time_ < 0 + var_550_4 + arg_550_0 then
				var_550_3.localPosition = Vector3.New(0.7, -0.71, -6)
				var_550_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_550_3.position).x, (manager.ui.mainCamera.transform.position - var_550_3.position).y, (manager.ui.mainCamera.transform.position - var_550_3.position).z)
				var_550_3.localEulerAngles.z = 0
				var_550_3.localEulerAngles.x = 0
				var_550_3.localEulerAngles = var_550_3.localEulerAngles
			...
			local var_550_5 = arg_547_1.actors_["1011ui_story"]

			if 0 < arg_547_1.time_ and arg_547_1.time_ <= 0 + arg_550_0 and not isNil(var_550_5) and arg_547_1.var_.characterEffect1011ui_story == nil then
				arg_547_1.var_.characterEffect1011ui_story = var_550_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_550_6 = 0.200000002980232

			if 0 <= arg_547_1.time_ and arg_547_1.time_ < 0 + var_550_6 and not isNil(var_550_5) then
				if arg_547_1.var_.characterEffect1011ui_story and not isNil(var_550_5) then
					arg_547_1.var_.characterEffect1011ui_story.fillFlat = false
				end
			end

			if arg_547_1.time_ >= 0 + var_550_6 and arg_547_1.time_ < 0 + var_550_6 + arg_550_0 and not isNil(var_550_5) and arg_547_1.var_.characterEffect1011ui_story then
				arg_547_1.var_.characterEffect1011ui_story.fillFlat = false
			end
			...
			if 0 < arg_547_1.time_ and arg_547_1.time_ <= var_550_8 + arg_550_0 then
				...
				arg_547_1.leftNameTxt_.text = arg_547_1:FormatText(StoryNameCfg[37].name)
				...
				local var_550_10 = arg_547_1:GetWordFromCfg(320061132)
				...
				local var_550_13 = 8 <= 0 and var_550_9 or var_550_9 * (utf8.len(var_550_11) / 8)

				if (8 <= 0 and var_550_9 or var_550_9 * (utf8.len(var_550_11) / 8)) > 0 and var_550_9 < var_550_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061132", "story_v_out_320061.awb") ~= 0 then
					local var_550_14 = manager.audio:GetVoiceLength("story_v_out_320061", "320061132", "story_v_out_320061.awb") / 1000
					...
					if var_550_10.prefab_name ~= "" and arg_547_1.actors_[var_550_10.prefab_name] ~= nil then
						local var_550_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_547_1.actors_[var_550_10.prefab_name].transform, "story_v_out_320061", "320061132", "story_v_out_320061.awb")

						arg_547_1:RecordAudio("320061132", var_550_15)
						arg_547_1:RecordAudio("320061132", var_550_15)
					else
	...
	Play320061133 = function(arg_551_0, arg_551_1)
		...
		function arg_551_1.onSingleLineUpdate_(arg_554_0)
			...
			local var_554_2 = arg_551_1.actors_["1011ui_story"]

			if 0 < arg_551_1.time_ and arg_551_1.time_ <= 0 + arg_554_0 and not isNil(var_554_2) and arg_551_1.var_.characterEffect1011ui_story == nil then
				arg_551_1.var_.characterEffect1011ui_story = var_554_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_554_3 = 0.200000002980232

			if 0 <= arg_551_1.time_ and arg_551_1.time_ < 0 + var_554_3 and not isNil(var_554_2) then
				if arg_551_1.var_.characterEffect1011ui_story and not isNil(var_554_2) then
					arg_551_1.var_.characterEffect1011ui_story.fillFlat = true
					arg_551_1.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_551_1.time_ - 0) / var_554_3)
				end
			end

			if arg_551_1.time_ >= 0 + var_554_3 and arg_551_1.time_ < 0 + var_554_3 + arg_554_0 and not isNil(var_554_2) and arg_551_1.var_.characterEffect1011ui_story then
				arg_551_1.var_.characterEffect1011ui_story.fillFlat = true
				arg_551_1.var_.characterEffect1011ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_551_1.time_ and arg_551_1.time_ <= var_554_4 + arg_554_0 then
				...
				arg_551_1.leftNameTxt_.text = arg_551_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_554_6 = arg_551_1:GetWordFromCfg(320061133)
				...
				local var_554_9 = 24 <= 0 and var_554_5 or var_554_5 * (utf8.len(var_554_7) / 24)

				if (24 <= 0 and var_554_5 or var_554_5 * (utf8.len(var_554_7) / 24)) > 0 and var_554_5 < var_554_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061133", "story_v_out_320061.awb") ~= 0 then
					local var_554_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061133", "story_v_out_320061.awb") / 1000
					...
					if var_554_6.prefab_name ~= "" and arg_551_1.actors_[var_554_6.prefab_name] ~= nil then
						local var_554_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_551_1.actors_[var_554_6.prefab_name].transform, "story_v_out_320061", "320061133", "story_v_out_320061.awb")

						arg_551_1:RecordAudio("320061133", var_554_11)
						arg_551_1:RecordAudio("320061133", var_554_11)
					else
	...
	Play320061134 = function(arg_555_0, arg_555_1)
		...
		function arg_555_1.onSingleLineUpdate_(arg_558_0)
			if 0 < arg_555_1.time_ and arg_555_1.time_ <= 0 + arg_558_0 and not isNil(arg_555_1.actors_["10100ui_story"]) and arg_555_1.var_.characterEffect10100ui_story == nil then
				arg_555_1.var_.characterEffect10100ui_story = arg_555_1.actors_["10100ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_558_0 = 0.200000002980232

			if 0 <= arg_555_1.time_ and arg_555_1.time_ < 0 + var_558_0 and not isNil(arg_555_1.actors_["10100ui_story"]) then
				if arg_555_1.var_.characterEffect10100ui_story and not isNil(arg_555_1.actors_["10100ui_story"]) then
					arg_555_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_555_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_555_1.time_ - 0) / var_558_0)
				end
			end

			if arg_555_1.time_ >= 0 + var_558_0 and arg_555_1.time_ < 0 + var_558_0 + arg_558_0 and not isNil(arg_555_1.actors_["10100ui_story"]) and arg_555_1.var_.characterEffect10100ui_story then
				arg_555_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_555_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_558_1 = arg_555_1.actors_["1011ui_story"].transform

			if 0 < arg_555_1.time_ and arg_555_1.time_ <= 0 + arg_558_0 then
				arg_555_1.var_.moveOldPos1011ui_story = var_558_1.localPosition
			end

			local var_558_2 = 0.001

			if 0 <= arg_555_1.time_ and arg_555_1.time_ < 0 + var_558_2 then
				var_558_1.localPosition = Vector3.Lerp(arg_555_1.var_.moveOldPos1011ui_story, Vector3.New(0, 100, 0), (arg_555_1.time_ - 0) / var_558_2)
			...
			local var_558_3 = arg_555_1.actors_["10100ui_story"].transform

			if 0 < arg_555_1.time_ and arg_555_1.time_ <= 0 + arg_558_0 then
				arg_555_1.var_.moveOldPos10100ui_story = var_558_3.localPosition
			end

			local var_558_4 = 0.001

			if 0 <= arg_555_1.time_ and arg_555_1.time_ < 0 + var_558_4 then
				var_558_3.localPosition = Vector3.Lerp(arg_555_1.var_.moveOldPos10100ui_story, Vector3.New(0, 100, 0), (arg_555_1.time_ - 0) / var_558_4)
				var_558_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_558_3.position).x, (manager.ui.mainCamera.transform.position - var_558_3.position).y, (manager.ui.mainCamera.transform.position - var_558_3.position).z)
				var_558_3.localEulerAngles.z = 0
				var_558_3.localEulerAngles.x = 0
				var_558_3.localEulerAngles = var_558_3.localEulerAngles
			end

			if arg_555_1.time_ >= 0 + var_558_4 and arg_555_1.time_ < 0 + var_558_4 + arg_558_0 then
				var_558_3.localPosition = Vector3.New(0, 100, 0)
				var_558_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_558_3.position).x, (manager.ui.mainCamera.transform.position - var_558_3.position).y, (manager.ui.mainCamera.transform.position - var_558_3.position).z)
				var_558_3.localEulerAngles.z = 0
				var_558_3.localEulerAngles.x = 0
				var_558_3.localEulerAngles = var_558_3.localEulerAngles
			...
			if 0 < arg_555_1.time_ and arg_555_1.time_ <= var_558_5 + arg_558_0 then
				...
				local var_558_7 = arg_555_1:FormatText(arg_555_1:GetWordFromCfg(320061134).content)

				arg_555_1.text_.text = var_558_7

				LuaForUtil.ClearLinePrefixSymbol(arg_555_1.text_)

				local var_558_9 = 48 <= 0 and var_558_6 or var_558_6 * (utf8.len(var_558_7) / 48)

				if (48 <= 0 and var_558_6 or var_558_6 * (utf8.len(var_558_7) / 48)) > 0 and var_558_6 < var_558_9 then
					arg_555_1.talkMaxDuration = var_558_9

					if var_558_9 + var_558_5 > arg_555_1.duration_ then
						arg_555_1.duration_ = var_558_9 + var_558_5
					end
				end
			...
			local var_558_10 = math.max(var_558_6, arg_555_1.talkMaxDuration)

			if var_558_5 <= arg_555_1.time_ and arg_555_1.time_ < var_558_5 + var_558_10 then
				arg_555_1.typewritter.percent = (arg_555_1.time_ - var_558_5) / var_558_10

				arg_555_1.typewritter:SetDirty()
			end

			if arg_555_1.time_ >= var_558_5 + var_558_10 and arg_555_1.time_ < var_558_5 + var_558_10 + arg_558_0 then
	...
	Play320061135 = function(arg_559_0, arg_559_1)
		...
		function arg_559_1.onSingleLineUpdate_(arg_562_0)
			...
			if 0 <= arg_559_1.time_ and arg_559_1.time_ < 0 + var_562_0 then
				arg_559_1.actors_["10100ui_story"].transform.localPosition = Vector3.Lerp(arg_559_1.var_.moveOldPos10100ui_story, Vector3.New(0, -1.16, -6.25), (arg_559_1.time_ - 0) / var_562_0)
			...
			if arg_559_1.time_ >= 0 + var_562_0 and arg_559_1.time_ < 0 + var_562_0 + arg_562_0 then
				arg_559_1.actors_["10100ui_story"].transform.localPosition = Vector3.New(0, -1.16, -6.25)
				arg_559_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_559_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_559_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_559_1.actors_["10100ui_story"].transform.position).z)
				arg_559_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_559_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_559_1.actors_["10100ui_story"].transform.localEulerAngles = arg_559_1.actors_["10100ui_story"].transform.localEulerAngles
			...
			if 0 < arg_559_1.time_ and arg_559_1.time_ <= var_562_4 + arg_562_0 then
				...
				arg_559_1.leftNameTxt_.text = arg_559_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_562_6 = arg_559_1:GetWordFromCfg(320061135)
				...
				local var_562_9 = 64 <= 0 and var_562_5 or var_562_5 * (utf8.len(var_562_7) / 64)

				if (64 <= 0 and var_562_5 or var_562_5 * (utf8.len(var_562_7) / 64)) > 0 and var_562_5 < var_562_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061135", "story_v_out_320061.awb") ~= 0 then
					local var_562_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061135", "story_v_out_320061.awb") / 1000
					...
					if var_562_6.prefab_name ~= "" and arg_559_1.actors_[var_562_6.prefab_name] ~= nil then
						local var_562_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_559_1.actors_[var_562_6.prefab_name].transform, "story_v_out_320061", "320061135", "story_v_out_320061.awb")

						arg_559_1:RecordAudio("320061135", var_562_11)
						arg_559_1:RecordAudio("320061135", var_562_11)
					else
	...
	Play320061136 = function(arg_563_0, arg_563_1)
		...
		function arg_563_1.onSingleLineUpdate_(arg_566_0)
			if 0 < arg_563_1.time_ and arg_563_1.time_ <= 0 + arg_566_0 and not isNil(arg_563_1.actors_["10100ui_story"]) and arg_563_1.var_.characterEffect10100ui_story == nil then
				arg_563_1.var_.characterEffect10100ui_story = arg_563_1.actors_["10100ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_566_0 = 0.200000002980232

			if 0 <= arg_563_1.time_ and arg_563_1.time_ < 0 + var_566_0 and not isNil(arg_563_1.actors_["10100ui_story"]) then
				if arg_563_1.var_.characterEffect10100ui_story and not isNil(arg_563_1.actors_["10100ui_story"]) then
					arg_563_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_563_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_563_1.time_ - 0) / var_566_0)
				end
			end

			if arg_563_1.time_ >= 0 + var_566_0 and arg_563_1.time_ < 0 + var_566_0 + arg_566_0 and not isNil(arg_563_1.actors_["10100ui_story"]) and arg_563_1.var_.characterEffect10100ui_story then
				arg_563_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_563_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_566_1 = 0
			local var_566_2 = 1.075
			...
			if 0 < arg_563_1.time_ and arg_563_1.time_ <= var_566_1 + arg_566_0 then
				...
				local var_566_3 = arg_563_1:FormatText(arg_563_1:GetWordFromCfg(320061136).content)

				arg_563_1.text_.text = var_566_3

				LuaForUtil.ClearLinePrefixSymbol(arg_563_1.text_)

				local var_566_5 = 43 <= 0 and var_566_2 or var_566_2 * (utf8.len(var_566_3) / 43)

				if (43 <= 0 and var_566_2 or var_566_2 * (utf8.len(var_566_3) / 43)) > 0 and var_566_2 < var_566_5 then
	...
	Play320061137 = function(arg_567_0, arg_567_1)
		...
		function arg_567_1.onSingleLineUpdate_(arg_570_0)
			...
			if 0 < arg_567_1.time_ and arg_567_1.time_ <= 0 + arg_570_0 then
				...
				local var_570_1 = arg_567_1:FormatText(arg_567_1:GetWordFromCfg(320061137).content)

				arg_567_1.text_.text = var_570_1

				LuaForUtil.ClearLinePrefixSymbol(arg_567_1.text_)

				local var_570_3 = 27 <= 0 and var_570_0 or var_570_0 * (utf8.len(var_570_1) / 27)

				if (27 <= 0 and var_570_0 or var_570_0 * (utf8.len(var_570_1) / 27)) > 0 and var_570_0 < var_570_3 then
	...
	Play320061138 = function(arg_571_0, arg_571_1)
		...
		function arg_571_1.onSingleLineUpdate_(arg_574_0)
			if 0 < arg_571_1.time_ and arg_571_1.time_ <= 0 + arg_574_0 and not isNil(arg_571_1.actors_["10100ui_story"]) and arg_571_1.var_.characterEffect10100ui_story == nil then
				arg_571_1.var_.characterEffect10100ui_story = arg_571_1.actors_["10100ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_574_0 = 0.200000002980232

			if 0 <= arg_571_1.time_ and arg_571_1.time_ < 0 + var_574_0 and not isNil(arg_571_1.actors_["10100ui_story"]) then
				if arg_571_1.var_.characterEffect10100ui_story and not isNil(arg_571_1.actors_["10100ui_story"]) then
					arg_571_1.var_.characterEffect10100ui_story.fillFlat = false
				end
			end

			if arg_571_1.time_ >= 0 + var_574_0 and arg_571_1.time_ < 0 + var_574_0 + arg_574_0 and not isNil(arg_571_1.actors_["10100ui_story"]) and arg_571_1.var_.characterEffect10100ui_story then
				arg_571_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_571_1.time_ and arg_571_1.time_ <= var_574_2 + arg_574_0 then
				...
				arg_571_1.leftNameTxt_.text = arg_571_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_574_4 = arg_571_1:GetWordFromCfg(320061138)
				...
				local var_574_7 = 34 <= 0 and var_574_3 or var_574_3 * (utf8.len(var_574_5) / 34)

				if (34 <= 0 and var_574_3 or var_574_3 * (utf8.len(var_574_5) / 34)) > 0 and var_574_3 < var_574_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061138", "story_v_out_320061.awb") ~= 0 then
					local var_574_8 = manager.audio:GetVoiceLength("story_v_out_320061", "320061138", "story_v_out_320061.awb") / 1000
					...
					if var_574_4.prefab_name ~= "" and arg_571_1.actors_[var_574_4.prefab_name] ~= nil then
						local var_574_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_571_1.actors_[var_574_4.prefab_name].transform, "story_v_out_320061", "320061138", "story_v_out_320061.awb")

						arg_571_1:RecordAudio("320061138", var_574_9)
						arg_571_1:RecordAudio("320061138", var_574_9)
					else
	...
	Play320061139 = function(arg_575_0, arg_575_1)
		...
		function arg_575_1.onSingleLineUpdate_(arg_578_0)
			if 0 < arg_575_1.time_ and arg_575_1.time_ <= 0 + arg_578_0 then
				arg_575_1.var_.moveOldPos1011ui_story = arg_575_1.actors_["1011ui_story"].transform.localPosition
			end

			local var_578_0 = 0.001

			if 0 <= arg_575_1.time_ and arg_575_1.time_ < 0 + var_578_0 then
				arg_575_1.actors_["1011ui_story"].transform.localPosition = Vector3.Lerp(arg_575_1.var_.moveOldPos1011ui_story, Vector3.New(0.7, -0.71, -6), (arg_575_1.time_ - 0) / var_578_0)
				arg_575_1.actors_["1011ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_575_1.actors_["1011ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_575_1.actors_["1011ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_575_1.actors_["1011ui_story"].transform.position).z)
				arg_575_1.actors_["1011ui_story"].transform.localEulerAngles.z = 0
				arg_575_1.actors_["1011ui_story"].transform.localEulerAngles.x = 0
				arg_575_1.actors_["1011ui_story"].transform.localEulerAngles = arg_575_1.actors_["1011ui_story"].transform.localEulerAngles
			end

			if arg_575_1.time_ >= 0 + var_578_0 and arg_575_1.time_ < 0 + var_578_0 + arg_578_0 then
				arg_575_1.actors_["1011ui_story"].transform.localPosition = Vector3.New(0.7, -0.71, -6)
				arg_575_1.actors_["1011ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_575_1.actors_["1011ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_575_1.actors_["1011ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_575_1.actors_["1011ui_story"].transform.position).z)
				arg_575_1.actors_["1011ui_story"].transform.localEulerAngles.z = 0
				arg_575_1.actors_["1011ui_story"].transform.localEulerAngles.x = 0
				arg_575_1.actors_["1011ui_story"].transform.localEulerAngles = arg_575_1.actors_["1011ui_story"].transform.localEulerAngles
			...
			local var_578_1 = arg_575_1.actors_["1011ui_story"]

			if 0 < arg_575_1.time_ and arg_575_1.time_ <= 0 + arg_578_0 and not isNil(var_578_1) and arg_575_1.var_.characterEffect1011ui_story == nil then
				arg_575_1.var_.characterEffect1011ui_story = var_578_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_578_2 = 0.200000002980232

			if 0 <= arg_575_1.time_ and arg_575_1.time_ < 0 + var_578_2 and not isNil(var_578_1) then
				if arg_575_1.var_.characterEffect1011ui_story and not isNil(var_578_1) then
					arg_575_1.var_.characterEffect1011ui_story.fillFlat = false
				end
			end

			if arg_575_1.time_ >= 0 + var_578_2 and arg_575_1.time_ < 0 + var_578_2 + arg_578_0 and not isNil(var_578_1) and arg_575_1.var_.characterEffect1011ui_story then
				arg_575_1.var_.characterEffect1011ui_story.fillFlat = false
			end
			...
			local var_578_4 = arg_575_1.actors_["10100ui_story"]

			if 0 < arg_575_1.time_ and arg_575_1.time_ <= 0 + arg_578_0 and not isNil(var_578_4) and arg_575_1.var_.characterEffect10100ui_story == nil then
				arg_575_1.var_.characterEffect10100ui_story = var_578_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_578_5 = 0.200000002980232

			if 0 <= arg_575_1.time_ and arg_575_1.time_ < 0 + var_578_5 and not isNil(var_578_4) then
				if arg_575_1.var_.characterEffect10100ui_story and not isNil(var_578_4) then
					arg_575_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_575_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_575_1.time_ - 0) / var_578_5)
				end
			end

			if arg_575_1.time_ >= 0 + var_578_5 and arg_575_1.time_ < 0 + var_578_5 + arg_578_0 and not isNil(var_578_4) and arg_575_1.var_.characterEffect10100ui_story then
				arg_575_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_575_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_578_6 = arg_575_1.actors_["10100ui_story"].transform

			if 0 < arg_575_1.time_ and arg_575_1.time_ <= 0 + arg_578_0 then
				arg_575_1.var_.moveOldPos10100ui_story = var_578_6.localPosition
			end

			local var_578_7 = 0.001

			if 0 <= arg_575_1.time_ and arg_575_1.time_ < 0 + var_578_7 then
				var_578_6.localPosition = Vector3.Lerp(arg_575_1.var_.moveOldPos10100ui_story, Vector3.New(-0.7, -1.16, -6.25), (arg_575_1.time_ - 0) / var_578_7)
				var_578_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_578_6.position).x, (manager.ui.mainCamera.transform.position - var_578_6.position).y, (manager.ui.mainCamera.transform.position - var_578_6.position).z)
				var_578_6.localEulerAngles.z = 0
				var_578_6.localEulerAngles.x = 0
				var_578_6.localEulerAngles = var_578_6.localEulerAngles
			end

			if arg_575_1.time_ >= 0 + var_578_7 and arg_575_1.time_ < 0 + var_578_7 + arg_578_0 then
				var_578_6.localPosition = Vector3.New(-0.7, -1.16, -6.25)
				var_578_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_578_6.position).x, (manager.ui.mainCamera.transform.position - var_578_6.position).y, (manager.ui.mainCamera.transform.position - var_578_6.position).z)
				var_578_6.localEulerAngles.z = 0
				var_578_6.localEulerAngles.x = 0
				var_578_6.localEulerAngles = var_578_6.localEulerAngles
			...
			if 1.06666666666667 < arg_575_1.time_ and arg_575_1.time_ <= 1.06666666666667 + arg_578_0 then
				arg_575_1:AudioAction("play", "music", "ui_battle", "ui_battle_stopbgm", "")

				local var_578_10 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_575_1.bgmTxt_.text ~= var_578_10 and arg_575_1.bgmTxt_.text ~= "" then
						if arg_575_1.bgmTxt2_.text ~= "" then
							arg_575_1.bgmTxt_.text = arg_575_1.bgmTxt2_.text
						end

						arg_575_1.bgmTxt2_.text = var_578_10

						arg_575_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_575_1.bgmTxt_.text = var_578_10
						arg_575_1.bgmTxt2_.text = var_578_10
					end
			...
			local var_578_11 = 0
			local var_578_12 = 0.275

			if 0 < arg_575_1.time_ and arg_575_1.time_ <= var_578_11 + arg_578_0 then
				...
				local var_578_13 = arg_575_1:GetWordFromCfg(320061139)
				...
				local var_578_16 = 11 <= 0 and var_578_12 or var_578_12 * (utf8.len(var_578_14) / 11)

				if (11 <= 0 and var_578_12 or var_578_12 * (utf8.len(var_578_14) / 11)) > 0 and var_578_12 < var_578_16 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061139", "story_v_out_320061.awb") ~= 0 then
					local var_578_17 = manager.audio:GetVoiceLength("story_v_out_320061", "320061139", "story_v_out_320061.awb") / 1000

					if var_578_17 + var_578_11 > arg_575_1.duration_ then
						arg_575_1.duration_ = var_578_17 + var_578_11
					end

					if var_578_13.prefab_name ~= "" and arg_575_1.actors_[var_578_13.prefab_name] ~= nil then
						local var_578_18 = LuaForUtil.PlayVoiceWithCriLipsync(arg_575_1.actors_[var_578_13.prefab_name].transform, "story_v_out_320061", "320061139", "story_v_out_320061.awb")

						arg_575_1:RecordAudio("320061139", var_578_18)
						arg_575_1:RecordAudio("320061139", var_578_18)
					else
			...
			local var_578_19 = math.max(var_578_12, arg_575_1.talkMaxDuration)

			if var_578_11 <= arg_575_1.time_ and arg_575_1.time_ < var_578_11 + var_578_19 then
				arg_575_1.typewritter.percent = (arg_575_1.time_ - var_578_11) / var_578_19

				arg_575_1.typewritter:SetDirty()
			end

			if arg_575_1.time_ >= var_578_11 + var_578_19 and arg_575_1.time_ < var_578_11 + var_578_19 + arg_578_0 then
	...
	Play320061140 = function(arg_580_0, arg_580_1)
		...
		function arg_580_1.onSingleLineUpdate_(arg_583_0)
			if 0 < arg_580_1.time_ and arg_580_1.time_ <= 0 + arg_583_0 then
				arg_580_1.var_.moveOldPos1011ui_story = arg_580_1.actors_["1011ui_story"].transform.localPosition
			end

			local var_583_0 = 0.001

			if 0 <= arg_580_1.time_ and arg_580_1.time_ < 0 + var_583_0 then
				arg_580_1.actors_["1011ui_story"].transform.localPosition = Vector3.Lerp(arg_580_1.var_.moveOldPos1011ui_story, Vector3.New(0, 100, 0), (arg_580_1.time_ - 0) / var_583_0)
				arg_580_1.actors_["1011ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_580_1.actors_["1011ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_580_1.actors_["1011ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_580_1.actors_["1011ui_story"].transform.position).z)
				arg_580_1.actors_["1011ui_story"].transform.localEulerAngles.z = 0
				arg_580_1.actors_["1011ui_story"].transform.localEulerAngles.x = 0
				arg_580_1.actors_["1011ui_story"].transform.localEulerAngles = arg_580_1.actors_["1011ui_story"].transform.localEulerAngles
			end

			if arg_580_1.time_ >= 0 + var_583_0 and arg_580_1.time_ < 0 + var_583_0 + arg_583_0 then
				arg_580_1.actors_["1011ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_580_1.actors_["1011ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_580_1.actors_["1011ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_580_1.actors_["1011ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_580_1.actors_["1011ui_story"].transform.position).z)
				arg_580_1.actors_["1011ui_story"].transform.localEulerAngles.z = 0
				arg_580_1.actors_["1011ui_story"].transform.localEulerAngles.x = 0
				arg_580_1.actors_["1011ui_story"].transform.localEulerAngles = arg_580_1.actors_["1011ui_story"].transform.localEulerAngles
			...
			local var_583_1 = arg_580_1.actors_["1011ui_story"]

			if 0 < arg_580_1.time_ and arg_580_1.time_ <= 0 + arg_583_0 and not isNil(var_583_1) and arg_580_1.var_.characterEffect1011ui_story == nil then
				arg_580_1.var_.characterEffect1011ui_story = var_583_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_583_2 = 0.200000002980232

			if 0 <= arg_580_1.time_ and arg_580_1.time_ < 0 + var_583_2 and not isNil(var_583_1) then
				if arg_580_1.var_.characterEffect1011ui_story and not isNil(var_583_1) then
					arg_580_1.var_.characterEffect1011ui_story.fillFlat = true
					arg_580_1.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_580_1.time_ - 0) / var_583_2)
				end
			end

			if arg_580_1.time_ >= 0 + var_583_2 and arg_580_1.time_ < 0 + var_583_2 + arg_583_0 and not isNil(var_583_1) and arg_580_1.var_.characterEffect1011ui_story then
				arg_580_1.var_.characterEffect1011ui_story.fillFlat = true
				arg_580_1.var_.characterEffect1011ui_story.fillRatio = 0.5
			end

			local var_583_3 = arg_580_1.actors_["10100ui_story"].transform

			if 0 < arg_580_1.time_ and arg_580_1.time_ <= 0 + arg_583_0 then
				arg_580_1.var_.moveOldPos10100ui_story = var_583_3.localPosition
			end

			local var_583_4 = 0.001

			if 0 <= arg_580_1.time_ and arg_580_1.time_ < 0 + var_583_4 then
				var_583_3.localPosition = Vector3.Lerp(arg_580_1.var_.moveOldPos10100ui_story, Vector3.New(0, 100, 0), (arg_580_1.time_ - 0) / var_583_4)
				var_583_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_583_3.position).x, (manager.ui.mainCamera.transform.position - var_583_3.position).y, (manager.ui.mainCamera.transform.position - var_583_3.position).z)
				var_583_3.localEulerAngles.z = 0
				var_583_3.localEulerAngles.x = 0
				var_583_3.localEulerAngles = var_583_3.localEulerAngles
			end

			if arg_580_1.time_ >= 0 + var_583_4 and arg_580_1.time_ < 0 + var_583_4 + arg_583_0 then
				var_583_3.localPosition = Vector3.New(0, 100, 0)
				var_583_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_583_3.position).x, (manager.ui.mainCamera.transform.position - var_583_3.position).y, (manager.ui.mainCamera.transform.position - var_583_3.position).z)
				var_583_3.localEulerAngles.z = 0
				var_583_3.localEulerAngles.x = 0
				var_583_3.localEulerAngles = var_583_3.localEulerAngles
			...
			local var_583_5 = arg_580_1.actors_["10100ui_story"]

			if 0 < arg_580_1.time_ and arg_580_1.time_ <= 0 + arg_583_0 and not isNil(var_583_5) and arg_580_1.var_.characterEffect10100ui_story == nil then
				arg_580_1.var_.characterEffect10100ui_story = var_583_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_583_6 = 0.200000002980232

			if 0 <= arg_580_1.time_ and arg_580_1.time_ < 0 + var_583_6 and not isNil(var_583_5) then
				if arg_580_1.var_.characterEffect10100ui_story and not isNil(var_583_5) then
					arg_580_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_580_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_580_1.time_ - 0) / var_583_6)
				end
			end

			if arg_580_1.time_ >= 0 + var_583_6 and arg_580_1.time_ < 0 + var_583_6 + arg_583_0 and not isNil(var_583_5) and arg_580_1.var_.characterEffect10100ui_story then
				arg_580_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_580_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end

			local var_583_7 = 0
			local var_583_8 = 0.825

			if 0 < arg_580_1.time_ and arg_580_1.time_ <= var_583_7 + arg_583_0 then
				...
				local var_583_9 = arg_580_1:FormatText(arg_580_1:GetWordFromCfg(320061140).content)

				arg_580_1.text_.text = var_583_9

				LuaForUtil.ClearLinePrefixSymbol(arg_580_1.text_)

				local var_583_11 = 33 <= 0 and var_583_8 or var_583_8 * (utf8.len(var_583_9) / 33)

				if (33 <= 0 and var_583_8 or var_583_8 * (utf8.len(var_583_9) / 33)) > 0 and var_583_8 < var_583_11 then
					arg_580_1.talkMaxDuration = var_583_11

					if var_583_11 + var_583_7 > arg_580_1.duration_ then
						arg_580_1.duration_ = var_583_11 + var_583_7
					end
				end
			...
			local var_583_12 = math.max(var_583_8, arg_580_1.talkMaxDuration)

			if var_583_7 <= arg_580_1.time_ and arg_580_1.time_ < var_583_7 + var_583_12 then
				arg_580_1.typewritter.percent = (arg_580_1.time_ - var_583_7) / var_583_12

				arg_580_1.typewritter:SetDirty()
			end

			if arg_580_1.time_ >= var_583_7 + var_583_12 and arg_580_1.time_ < var_583_7 + var_583_12 + arg_583_0 then
	...
	Play320061141 = function(arg_584_0, arg_584_1)
		...
		function arg_584_1.onSingleLineUpdate_(arg_587_0)
			...
			if 0 < arg_584_1.time_ and arg_584_1.time_ <= 0 + arg_587_0 then
				...
				local var_587_1 = arg_584_1:FormatText(arg_584_1:GetWordFromCfg(320061141).content)

				arg_584_1.text_.text = var_587_1

				LuaForUtil.ClearLinePrefixSymbol(arg_584_1.text_)

				local var_587_3 = 48 <= 0 and var_587_0 or var_587_0 * (utf8.len(var_587_1) / 48)

				if (48 <= 0 and var_587_0 or var_587_0 * (utf8.len(var_587_1) / 48)) > 0 and var_587_0 < var_587_3 then
	...
	Play320061142 = function(arg_588_0, arg_588_1)
		...
		function arg_588_1.onSingleLineUpdate_(arg_591_0)
			...
			if 0 < arg_588_1.time_ and arg_588_1.time_ <= 0 + arg_591_0 then
				...
				local var_591_1 = arg_588_1:FormatText(arg_588_1:GetWordFromCfg(320061142).content)
	...
	Play320061143 = function(arg_592_0, arg_592_1)
		...
		function arg_592_1.onSingleLineUpdate_(arg_595_0)
			...
			if 0 < arg_592_1.time_ and arg_592_1.time_ <= 0 + arg_595_0 then
				...
				local var_595_1 = arg_592_1:FormatText(arg_592_1:GetWordFromCfg(320061143).content)

				arg_592_1.text_.text = var_595_1

				LuaForUtil.ClearLinePrefixSymbol(arg_592_1.text_)

				local var_595_3 = 27 <= 0 and var_595_0 or var_595_0 * (utf8.len(var_595_1) / 27)

				if (27 <= 0 and var_595_0 or var_595_0 * (utf8.len(var_595_1) / 27)) > 0 and var_595_0 < var_595_3 then
	...
	Play320061144 = function(arg_596_0, arg_596_1)
		...
		function arg_596_1.onSingleLineUpdate_(arg_599_0)
			if 0 < arg_596_1.time_ and arg_596_1.time_ <= 0 + arg_599_0 then
				arg_596_1:AudioAction("play", "music", "bgm_activity_1_6_story_intense", "bgm_activity_1_6_story_intense", "bgm_activity_1_6_story_intense.awb")

				local var_599_2 = manager.audio:GetAudioName("bgm_activity_1_6_story_intense", "bgm_activity_1_6_story_intense")
			...
			if 0 < arg_596_1.time_ and arg_596_1.time_ <= var_599_3 + arg_599_0 then
				...
				local var_599_5 = arg_596_1:FormatText(arg_596_1:GetWordFromCfg(320061144).content)

				arg_596_1.text_.text = var_599_5

				LuaForUtil.ClearLinePrefixSymbol(arg_596_1.text_)

				local var_599_7 = 32 <= 0 and var_599_4 or var_599_4 * (utf8.len(var_599_5) / 32)

				if (32 <= 0 and var_599_4 or var_599_4 * (utf8.len(var_599_5) / 32)) > 0 and var_599_4 < var_599_7 then
					arg_596_1.talkMaxDuration = var_599_7

					if var_599_7 + var_599_3 > arg_596_1.duration_ then
						arg_596_1.duration_ = var_599_7 + var_599_3
					end
				end
			...
			local var_599_8 = math.max(var_599_4, arg_596_1.talkMaxDuration)

			if var_599_3 <= arg_596_1.time_ and arg_596_1.time_ < var_599_3 + var_599_8 then
				arg_596_1.typewritter.percent = (arg_596_1.time_ - var_599_3) / var_599_8

				arg_596_1.typewritter:SetDirty()
			end

			if arg_596_1.time_ >= var_599_3 + var_599_8 and arg_596_1.time_ < var_599_3 + var_599_8 + arg_599_0 then
	...
	Play320061145 = function(arg_601_0, arg_601_1)
		...
		function arg_601_1.onSingleLineUpdate_(arg_604_0)
			if 0 < arg_601_1.time_ and arg_601_1.time_ <= 0 + arg_604_0 then
				arg_601_1.var_.shakeOldPos = manager.ui.mainCamera.transform.localPosition
			end

			local var_604_0 = 0.6

			if 0 <= arg_601_1.time_ and arg_601_1.time_ < 0 + var_604_0 then
				local var_604_1, var_604_2 = math.modf((arg_601_1.time_ - 0) / 0.066)

				manager.ui.mainCamera.transform.localPosition = Vector3.New(var_604_2 * 0.13, var_604_2 * 0.13, var_604_2 * 0.13) + arg_601_1.var_.shakeOldPos
			end

			if arg_601_1.time_ >= 0 + var_604_0 and arg_601_1.time_ < 0 + var_604_0 + arg_604_0 then
				manager.ui.mainCamera.transform.localPosition = arg_601_1.var_.shakeOldPos
			end
			...
			if arg_601_1.time_ >= var_604_3 + 0.6 and arg_601_1.time_ < var_604_3 + 0.6 + arg_604_0 then
				arg_601_1.allBtn_.enabled = true
			end

			local var_604_4 = 0
			local var_604_5 = 0.275
			...
			if 0 < arg_601_1.time_ and arg_601_1.time_ <= var_604_4 + arg_604_0 then
				...
				local var_604_6 = arg_601_1:FormatText(arg_601_1:GetWordFromCfg(320061145).content)

				arg_601_1.text_.text = var_604_6

				LuaForUtil.ClearLinePrefixSymbol(arg_601_1.text_)

				local var_604_8 = 11 <= 0 and var_604_5 or var_604_5 * (utf8.len(var_604_6) / 11)

				if (11 <= 0 and var_604_5 or var_604_5 * (utf8.len(var_604_6) / 11)) > 0 and var_604_5 < var_604_8 then
					arg_601_1.talkMaxDuration = var_604_8

					if var_604_8 + var_604_4 > arg_601_1.duration_ then
						arg_601_1.duration_ = var_604_8 + var_604_4
					end
				end
			...
			local var_604_9 = math.max(var_604_5, arg_601_1.talkMaxDuration)

			if var_604_4 <= arg_601_1.time_ and arg_601_1.time_ < var_604_4 + var_604_9 then
				arg_601_1.typewritter.percent = (arg_601_1.time_ - var_604_4) / var_604_9

				arg_601_1.typewritter:SetDirty()
			end

			if arg_601_1.time_ >= var_604_4 + var_604_9 and arg_601_1.time_ < var_604_4 + var_604_9 + arg_604_0 then
	...
	Play320061146 = function(arg_605_0, arg_605_1)
		...
		function arg_605_1.onSingleLineUpdate_(arg_608_0)
			...
			if 0 < arg_605_1.time_ and arg_605_1.time_ <= 0 + arg_608_0 then
				...
				local var_608_1 = arg_605_1:FormatText(arg_605_1:GetWordFromCfg(320061146).content)

				arg_605_1.text_.text = var_608_1

				LuaForUtil.ClearLinePrefixSymbol(arg_605_1.text_)

				local var_608_3 = 43 <= 0 and var_608_0 or var_608_0 * (utf8.len(var_608_1) / 43)

				if (43 <= 0 and var_608_0 or var_608_0 * (utf8.len(var_608_1) / 43)) > 0 and var_608_0 < var_608_3 then
	...
	Play320061147 = function(arg_609_0, arg_609_1)
		...
		function arg_609_1.onSingleLineUpdate_(arg_612_0)
			...
			if 0 < arg_609_1.time_ and arg_609_1.time_ <= 0 + arg_612_0 then
				...
				arg_609_1.leftNameTxt_.text = arg_609_1:FormatText(StoryNameCfg[36].name)
				...
				local var_612_1 = arg_609_1:GetWordFromCfg(320061147)
				...
				local var_612_4 = 7 <= 0 and var_612_0 or var_612_0 * (utf8.len(var_612_2) / 7)

				if (7 <= 0 and var_612_0 or var_612_0 * (utf8.len(var_612_2) / 7)) > 0 and var_612_0 < var_612_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061147", "story_v_out_320061.awb") ~= 0 then
					local var_612_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061147", "story_v_out_320061.awb") / 1000
					...
					if var_612_1.prefab_name ~= "" and arg_609_1.actors_[var_612_1.prefab_name] ~= nil then
						local var_612_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_609_1.actors_[var_612_1.prefab_name].transform, "story_v_out_320061", "320061147", "story_v_out_320061.awb")

						arg_609_1:RecordAudio("320061147", var_612_6)
						arg_609_1:RecordAudio("320061147", var_612_6)
					else
	...
	Play320061148 = function(arg_613_0, arg_613_1)
		...
		function arg_613_1.onSingleLineUpdate_(arg_616_0)
			...
			if 0 < arg_613_1.time_ and arg_613_1.time_ <= 0 + arg_616_0 then
				...
				local var_616_1 = arg_613_1:FormatText(arg_613_1:GetWordFromCfg(320061148).content)

				arg_613_1.text_.text = var_616_1

				LuaForUtil.ClearLinePrefixSymbol(arg_613_1.text_)

				local var_616_3 = 5 <= 0 and var_616_0 or var_616_0 * (utf8.len(var_616_1) / 5)

				if (5 <= 0 and var_616_0 or var_616_0 * (utf8.len(var_616_1) / 5)) > 0 and var_616_0 < var_616_3 then
	...
	Play320061149 = function(arg_617_0, arg_617_1)
		...
		function arg_617_1.onSingleLineUpdate_(arg_620_0)
			...
			if 0 < arg_617_1.time_ and arg_617_1.time_ <= 0 + arg_620_0 then
				...
				local var_620_1 = arg_617_1:FormatText(arg_617_1:GetWordFromCfg(320061149).content)

				arg_617_1.text_.text = var_620_1

				LuaForUtil.ClearLinePrefixSymbol(arg_617_1.text_)

				local var_620_3 = 48 <= 0 and var_620_0 or var_620_0 * (utf8.len(var_620_1) / 48)

				if (48 <= 0 and var_620_0 or var_620_0 * (utf8.len(var_620_1) / 48)) > 0 and var_620_0 < var_620_3 then
	...
	Play320061150 = function(arg_621_0, arg_621_1)
		...
		function arg_621_1.onSingleLineUpdate_(arg_624_0)
			if 0 < arg_621_1.time_ and arg_621_1.time_ <= 0 + arg_624_0 then
				arg_621_1.var_.moveOldPos10100ui_story = arg_621_1.actors_["10100ui_story"].transform.localPosition
			end

			local var_624_0 = 0.001

			if 0 <= arg_621_1.time_ and arg_621_1.time_ < 0 + var_624_0 then
				arg_621_1.actors_["10100ui_story"].transform.localPosition = Vector3.Lerp(arg_621_1.var_.moveOldPos10100ui_story, Vector3.New(0, -1.16, -6.25), (arg_621_1.time_ - 0) / var_624_0)
				arg_621_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_621_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_621_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_621_1.actors_["10100ui_story"].transform.position).z)
				arg_621_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_621_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_621_1.actors_["10100ui_story"].transform.localEulerAngles = arg_621_1.actors_["10100ui_story"].transform.localEulerAngles
			end

			if arg_621_1.time_ >= 0 + var_624_0 and arg_621_1.time_ < 0 + var_624_0 + arg_624_0 then
				arg_621_1.actors_["10100ui_story"].transform.localPosition = Vector3.New(0, -1.16, -6.25)
				arg_621_1.actors_["10100ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_621_1.actors_["10100ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_621_1.actors_["10100ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_621_1.actors_["10100ui_story"].transform.position).z)
				arg_621_1.actors_["10100ui_story"].transform.localEulerAngles.z = 0
				arg_621_1.actors_["10100ui_story"].transform.localEulerAngles.x = 0
				arg_621_1.actors_["10100ui_story"].transform.localEulerAngles = arg_621_1.actors_["10100ui_story"].transform.localEulerAngles
			...
			local var_624_1 = arg_621_1.actors_["10100ui_story"]

			if 0 < arg_621_1.time_ and arg_621_1.time_ <= 0 + arg_624_0 and not isNil(var_624_1) and arg_621_1.var_.characterEffect10100ui_story == nil then
				arg_621_1.var_.characterEffect10100ui_story = var_624_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_624_2 = 0.200000002980232

			if 0 <= arg_621_1.time_ and arg_621_1.time_ < 0 + var_624_2 and not isNil(var_624_1) then
				if arg_621_1.var_.characterEffect10100ui_story and not isNil(var_624_1) then
					arg_621_1.var_.characterEffect10100ui_story.fillFlat = false
				end
			end

			if arg_621_1.time_ >= 0 + var_624_2 and arg_621_1.time_ < 0 + var_624_2 + arg_624_0 and not isNil(var_624_1) and arg_621_1.var_.characterEffect10100ui_story then
				arg_621_1.var_.characterEffect10100ui_story.fillFlat = false
			end
			...
			if 0 < arg_621_1.time_ and arg_621_1.time_ <= var_624_4 + arg_624_0 then
				...
				arg_621_1.leftNameTxt_.text = arg_621_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_624_6 = arg_621_1:GetWordFromCfg(320061150)
				...
				local var_624_9 = 24 <= 0 and var_624_5 or var_624_5 * (utf8.len(var_624_7) / 24)

				if (24 <= 0 and var_624_5 or var_624_5 * (utf8.len(var_624_7) / 24)) > 0 and var_624_5 < var_624_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061150", "story_v_out_320061.awb") ~= 0 then
					local var_624_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061150", "story_v_out_320061.awb") / 1000
					...
					if var_624_6.prefab_name ~= "" and arg_621_1.actors_[var_624_6.prefab_name] ~= nil then
						local var_624_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_621_1.actors_[var_624_6.prefab_name].transform, "story_v_out_320061", "320061150", "story_v_out_320061.awb")

						arg_621_1:RecordAudio("320061150", var_624_11)
						arg_621_1:RecordAudio("320061150", var_624_11)
					else
	...
	Play320061151 = function(arg_625_0, arg_625_1)
		...
		function arg_625_1.onSingleLineUpdate_(arg_628_0)
			if arg_625_1.actors_["1111ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1111ui_story"))) then
				local var_628_0 = Object.Instantiate(Asset.Load("Char/" .. "1111ui_story"), arg_625_1.stage_.transform)

				var_628_0.name = "1111ui_story"
				var_628_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_625_1.actors_["1111ui_story"] = var_628_0
				...
				arg_625_1.var_["1111ui_story" .. "Animator"] = var_628_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_625_1.var_["1111ui_story" .. "Animator"].applyRootMotion = true
				arg_625_1.var_["1111ui_story" .. "LipSync"] = var_628_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_628_3 = arg_625_1.actors_["1111ui_story"].transform

			if 0 < arg_625_1.time_ and arg_625_1.time_ <= 0 + arg_628_0 then
				arg_625_1.var_.moveOldPos1111ui_story = var_628_3.localPosition
			end

			local var_628_4 = 0.001

			if 0 <= arg_625_1.time_ and arg_625_1.time_ < 0 + var_628_4 then
				var_628_3.localPosition = Vector3.Lerp(arg_625_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_625_1.time_ - 0) / var_628_4)
			...
			if arg_625_1.time_ >= 0 + var_628_4 and arg_625_1.time_ < 0 + var_628_4 + arg_628_0 then
				var_628_3.localPosition = Vector3.New(0, -0.87, -5.7)
				var_628_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_628_3.position).x, (manager.ui.mainCamera.transform.position - var_628_3.position).y, (manager.ui.mainCamera.transform.position - var_628_3.position).z)
				var_628_3.localEulerAngles.z = 0
				var_628_3.localEulerAngles.x = 0
				var_628_3.localEulerAngles = var_628_3.localEulerAngles
			...
			local var_628_5 = arg_625_1.actors_["1111ui_story"]

			if 0 < arg_625_1.time_ and arg_625_1.time_ <= 0 + arg_628_0 and not isNil(var_628_5) and arg_625_1.var_.characterEffect1111ui_story == nil then
				arg_625_1.var_.characterEffect1111ui_story = var_628_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_628_6 = 0.200000002980232

			if 0 <= arg_625_1.time_ and arg_625_1.time_ < 0 + var_628_6 and not isNil(var_628_5) then
				if arg_625_1.var_.characterEffect1111ui_story and not isNil(var_628_5) then
					arg_625_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_625_1.time_ >= 0 + var_628_6 and arg_625_1.time_ < 0 + var_628_6 + arg_628_0 and not isNil(var_628_5) and arg_625_1.var_.characterEffect1111ui_story then
				arg_625_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			local var_628_8 = arg_625_1.actors_["10100ui_story"].transform

			if 0 < arg_625_1.time_ and arg_625_1.time_ <= 0 + arg_628_0 then
				arg_625_1.var_.moveOldPos10100ui_story = var_628_8.localPosition
			end

			local var_628_9 = 0.001

			if 0 <= arg_625_1.time_ and arg_625_1.time_ < 0 + var_628_9 then
				var_628_8.localPosition = Vector3.Lerp(arg_625_1.var_.moveOldPos10100ui_story, Vector3.New(0, 100, 0), (arg_625_1.time_ - 0) / var_628_9)
				var_628_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_628_8.position).x, (manager.ui.mainCamera.transform.position - var_628_8.position).y, (manager.ui.mainCamera.transform.position - var_628_8.position).z)
				var_628_8.localEulerAngles.z = 0
				var_628_8.localEulerAngles.x = 0
				var_628_8.localEulerAngles = var_628_8.localEulerAngles
			end

			if arg_625_1.time_ >= 0 + var_628_9 and arg_625_1.time_ < 0 + var_628_9 + arg_628_0 then
				var_628_8.localPosition = Vector3.New(0, 100, 0)
				var_628_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_628_8.position).x, (manager.ui.mainCamera.transform.position - var_628_8.position).y, (manager.ui.mainCamera.transform.position - var_628_8.position).z)
				var_628_8.localEulerAngles.z = 0
				var_628_8.localEulerAngles.x = 0
				var_628_8.localEulerAngles = var_628_8.localEulerAngles
			...
			local var_628_10 = arg_625_1.actors_["10100ui_story"]

			if 0 < arg_625_1.time_ and arg_625_1.time_ <= 0 + arg_628_0 and not isNil(var_628_10) and arg_625_1.var_.characterEffect10100ui_story == nil then
				arg_625_1.var_.characterEffect10100ui_story = var_628_10:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_628_11 = 0.200000002980232

			if 0 <= arg_625_1.time_ and arg_625_1.time_ < 0 + var_628_11 and not isNil(var_628_10) then
				if arg_625_1.var_.characterEffect10100ui_story and not isNil(var_628_10) then
					arg_625_1.var_.characterEffect10100ui_story.fillFlat = true
					arg_625_1.var_.characterEffect10100ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_625_1.time_ - 0) / var_628_11)
				end
			end

			if arg_625_1.time_ >= 0 + var_628_11 and arg_625_1.time_ < 0 + var_628_11 + arg_628_0 and not isNil(var_628_10) and arg_625_1.var_.characterEffect10100ui_story then
				arg_625_1.var_.characterEffect10100ui_story.fillFlat = true
				arg_625_1.var_.characterEffect10100ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_625_1.time_ and arg_625_1.time_ <= var_628_12 + arg_628_0 then
				...
				arg_625_1.leftNameTxt_.text = arg_625_1:FormatText(StoryNameCfg[67].name)
				...
				local var_628_14 = arg_625_1:GetWordFromCfg(320061151)
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061151", "story_v_out_320061.awb") ~= 0 then
					local var_628_18 = manager.audio:GetVoiceLength("story_v_out_320061", "320061151", "story_v_out_320061.awb") / 1000
					...
					if var_628_14.prefab_name ~= "" and arg_625_1.actors_[var_628_14.prefab_name] ~= nil then
						local var_628_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_625_1.actors_[var_628_14.prefab_name].transform, "story_v_out_320061", "320061151", "story_v_out_320061.awb")

						arg_625_1:RecordAudio("320061151", var_628_19)
						arg_625_1:RecordAudio("320061151", var_628_19)
					else
	...
	Play320061152 = function(arg_629_0, arg_629_1)
		...
		function arg_629_1.onSingleLineUpdate_(arg_632_0)
			if 0 < arg_629_1.time_ and arg_629_1.time_ <= 0 + arg_632_0 and not isNil(arg_629_1.actors_["1111ui_story"]) and arg_629_1.var_.characterEffect1111ui_story == nil then
				arg_629_1.var_.characterEffect1111ui_story = arg_629_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_632_0 = 0.200000002980232

			if 0 <= arg_629_1.time_ and arg_629_1.time_ < 0 + var_632_0 and not isNil(arg_629_1.actors_["1111ui_story"]) then
				if arg_629_1.var_.characterEffect1111ui_story and not isNil(arg_629_1.actors_["1111ui_story"]) then
					arg_629_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_629_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_629_1.time_ - 0) / var_632_0)
				end
			end

			if arg_629_1.time_ >= 0 + var_632_0 and arg_629_1.time_ < 0 + var_632_0 + arg_632_0 and not isNil(arg_629_1.actors_["1111ui_story"]) and arg_629_1.var_.characterEffect1111ui_story then
				arg_629_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_629_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end

			local var_632_1 = 0
			local var_632_2 = 0.25
			...
			if 0 < arg_629_1.time_ and arg_629_1.time_ <= var_632_1 + arg_632_0 then
				...
				local var_632_3 = arg_629_1:FormatText(arg_629_1:GetWordFromCfg(320061152).content)

				arg_629_1.text_.text = var_632_3

				LuaForUtil.ClearLinePrefixSymbol(arg_629_1.text_)

				local var_632_5 = 10 <= 0 and var_632_2 or var_632_2 * (utf8.len(var_632_3) / 10)

				if (10 <= 0 and var_632_2 or var_632_2 * (utf8.len(var_632_3) / 10)) > 0 and var_632_2 < var_632_5 then
	...
	Play320061153 = function(arg_633_0, arg_633_1)
		...
		function arg_633_1.onSingleLineUpdate_(arg_636_0)
			if 0 < arg_633_1.time_ and arg_633_1.time_ <= 0 + arg_636_0 then
				arg_633_1.var_.moveOldPos1111ui_story = arg_633_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_636_0 = 0.001

			if 0 <= arg_633_1.time_ and arg_633_1.time_ < 0 + var_636_0 then
				arg_633_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_633_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_633_1.time_ - 0) / var_636_0)
				arg_633_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_633_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_633_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_633_1.actors_["1111ui_story"].transform.position).z)
				arg_633_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_633_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_633_1.actors_["1111ui_story"].transform.localEulerAngles = arg_633_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_633_1.time_ >= 0 + var_636_0 and arg_633_1.time_ < 0 + var_636_0 + arg_636_0 then
				arg_633_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, -0.87, -5.7)
				arg_633_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_633_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_633_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_633_1.actors_["1111ui_story"].transform.position).z)
				arg_633_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_633_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_633_1.actors_["1111ui_story"].transform.localEulerAngles = arg_633_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_636_1 = arg_633_1.actors_["1111ui_story"]

			if 0 < arg_633_1.time_ and arg_633_1.time_ <= 0 + arg_636_0 and not isNil(var_636_1) and arg_633_1.var_.characterEffect1111ui_story == nil then
				arg_633_1.var_.characterEffect1111ui_story = var_636_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_636_2 = 0.200000002980232

			if 0 <= arg_633_1.time_ and arg_633_1.time_ < 0 + var_636_2 and not isNil(var_636_1) then
				if arg_633_1.var_.characterEffect1111ui_story and not isNil(var_636_1) then
					arg_633_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_633_1.time_ >= 0 + var_636_2 and arg_633_1.time_ < 0 + var_636_2 + arg_636_0 and not isNil(var_636_1) and arg_633_1.var_.characterEffect1111ui_story then
				arg_633_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if 0 < arg_633_1.time_ and arg_633_1.time_ <= var_636_4 + arg_636_0 then
				...
				arg_633_1.leftNameTxt_.text = arg_633_1:FormatText(StoryNameCfg[67].name)
				...
				local var_636_6 = arg_633_1:GetWordFromCfg(320061153)
				...
				local var_636_9 = 17 <= 0 and var_636_5 or var_636_5 * (utf8.len(var_636_7) / 17)

				if (17 <= 0 and var_636_5 or var_636_5 * (utf8.len(var_636_7) / 17)) > 0 and var_636_5 < var_636_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061153", "story_v_out_320061.awb") ~= 0 then
					local var_636_10 = manager.audio:GetVoiceLength("story_v_out_320061", "320061153", "story_v_out_320061.awb") / 1000
					...
					if var_636_6.prefab_name ~= "" and arg_633_1.actors_[var_636_6.prefab_name] ~= nil then
						local var_636_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_633_1.actors_[var_636_6.prefab_name].transform, "story_v_out_320061", "320061153", "story_v_out_320061.awb")

						arg_633_1:RecordAudio("320061153", var_636_11)
						arg_633_1:RecordAudio("320061153", var_636_11)
					else
	...
	Play320061154 = function(arg_637_0, arg_637_1)
		...
		function arg_637_1.onSingleLineUpdate_(arg_640_0)
			...
			if 0 < arg_637_1.time_ and arg_637_1.time_ <= 0 + arg_640_0 then
				arg_637_1.var_.moveOldPos1111ui_story = arg_637_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_640_0 = 0.001

			if 0 <= arg_637_1.time_ and arg_637_1.time_ < 0 + var_640_0 then
				arg_637_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_637_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_637_1.time_ - 0) / var_640_0)
				arg_637_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_637_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_637_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_637_1.actors_["1111ui_story"].transform.position).z)
				arg_637_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_637_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_637_1.actors_["1111ui_story"].transform.localEulerAngles = arg_637_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_637_1.time_ >= 0 + var_640_0 and arg_637_1.time_ < 0 + var_640_0 + arg_640_0 then
				arg_637_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_637_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_637_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_637_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_637_1.actors_["1111ui_story"].transform.position).z)
				arg_637_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_637_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_637_1.actors_["1111ui_story"].transform.localEulerAngles = arg_637_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_640_1 = arg_637_1.actors_["1111ui_story"]

			if 0 < arg_637_1.time_ and arg_637_1.time_ <= 0 + arg_640_0 and not isNil(var_640_1) and arg_637_1.var_.characterEffect1111ui_story == nil then
				arg_637_1.var_.characterEffect1111ui_story = var_640_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_640_2 = 0.200000002980232

			if 0 <= arg_637_1.time_ and arg_637_1.time_ < 0 + var_640_2 and not isNil(var_640_1) then
				if arg_637_1.var_.characterEffect1111ui_story and not isNil(var_640_1) then
					arg_637_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_637_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_637_1.time_ - 0) / var_640_2)
				end
			end

			if arg_637_1.time_ >= 0 + var_640_2 and arg_637_1.time_ < 0 + var_640_2 + arg_640_0 and not isNil(var_640_1) and arg_637_1.var_.characterEffect1111ui_story then
				arg_637_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_637_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end

			if 0 < arg_637_1.time_ and arg_637_1.time_ <= 0 + arg_640_0 then
				local var_640_3 = arg_637_1.var_.effectyiyang1

				if not arg_637_1.var_.effectyiyang1 then
					var_640_3 = Object.Instantiate(Asset.Load("Effect/Scene/fx_scence_pingmu_niuqu"), manager.ui.mainCamera.transform)
					var_640_3.name = "yiyang1"
					arg_637_1.var_.effectyiyang1 = var_640_3
				else
					var_640_3.transform:SetParent(var_640_9000)
				end

				var_640_3.transform.localPosition = Vector3.New(0, 0, 0)
				var_640_3.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			if 0.6 < arg_637_1.time_ and arg_637_1.time_ <= 0.6 + arg_640_0 then
				if arg_637_1.var_.effectyiyang1 then
					Object.Destroy(arg_637_1.var_.effectyiyang1)
			...
			if 0 < arg_637_1.time_ and arg_637_1.time_ <= var_640_6 + arg_640_0 then
				arg_637_1.allBtn_.enabled = false
			end

			if arg_637_1.time_ >= var_640_6 + 0.9 and arg_637_1.time_ < var_640_6 + 0.9 + arg_640_0 then
			...
			local var_640_7 = 0.9
			local var_640_8 = 1.025

			if 0.9 < arg_637_1.time_ and arg_637_1.time_ <= var_640_7 + arg_640_0 then
				...
				local var_640_9 = LeanTween.value(arg_637_1.dialog_, 0, 1, 0.3)

				var_640_9:setOnUpdate(LuaHelper.FloatAction(function(arg_641_0)
					arg_637_1.dialogCg_.alpha = arg_641_0
				end))
				var_640_9:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_637_1.dialog_)
					var_640_9:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_640_10 = arg_637_1:FormatText(arg_637_1:GetWordFromCfg(320061154).content)

				arg_637_1.text_.text = var_640_10

				LuaForUtil.ClearLinePrefixSymbol(arg_637_1.text_)

				local var_640_12 = 41 <= 0 and var_640_8 or var_640_8 * (utf8.len(var_640_10) / 41)

				if (41 <= 0 and var_640_8 or var_640_8 * (utf8.len(var_640_10) / 41)) > 0 and var_640_8 < var_640_12 then
					arg_637_1.talkMaxDuration = var_640_12
					var_640_7 = var_640_7 + 0.3

					if var_640_12 + var_640_7 > arg_637_1.duration_ then
						arg_637_1.duration_ = var_640_12 + var_640_7
					end
				end
			...
			local var_640_13 = var_640_7 + 0.3
			local var_640_14 = math.max(var_640_8, arg_637_1.talkMaxDuration)

			if var_640_7 + 0.3 <= arg_637_1.time_ and arg_637_1.time_ < var_640_13 + var_640_14 then
				arg_637_1.typewritter.percent = (arg_637_1.time_ - var_640_13) / var_640_14

				arg_637_1.typewritter:SetDirty()
			end

			if arg_637_1.time_ >= var_640_13 + var_640_14 and arg_637_1.time_ < var_640_13 + var_640_14 + arg_640_0 then
	...
	Play320061155 = function(arg_643_0, arg_643_1)
		...
		function arg_643_1.onSingleLineUpdate_(arg_646_0)
			...
			if 0 < arg_643_1.time_ and arg_643_1.time_ <= 0 + arg_646_0 then
				...
				local var_646_1 = arg_643_1:FormatText(arg_643_1:GetWordFromCfg(320061155).content)

				arg_643_1.text_.text = var_646_1

				LuaForUtil.ClearLinePrefixSymbol(arg_643_1.text_)

				local var_646_3 = 9 <= 0 and var_646_0 or var_646_0 * (utf8.len(var_646_1) / 9)

				if (9 <= 0 and var_646_0 or var_646_0 * (utf8.len(var_646_1) / 9)) > 0 and var_646_0 < var_646_3 then
	...
	Play320061156 = function(arg_647_0, arg_647_1)
		...
		function arg_647_1.onSingleLineUpdate_(arg_650_0)
			...
			if 0 < arg_647_1.time_ and arg_647_1.time_ <= 0 + arg_650_0 then
				...
				local var_650_1 = arg_647_1:FormatText(arg_647_1:GetWordFromCfg(320061156).content)

				arg_647_1.text_.text = var_650_1

				LuaForUtil.ClearLinePrefixSymbol(arg_647_1.text_)

				local var_650_3 = 63 <= 0 and var_650_0 or var_650_0 * (utf8.len(var_650_1) / 63)

				if (63 <= 0 and var_650_0 or var_650_0 * (utf8.len(var_650_1) / 63)) > 0 and var_650_0 < var_650_3 then
	...
	Play320061157 = function(arg_651_0, arg_651_1)
		...
		function arg_651_1.onSingleLineUpdate_(arg_654_0)
			...
			if 0 < arg_651_1.time_ and arg_651_1.time_ <= 0 + arg_654_0 then
				...
				local var_654_1 = arg_651_1:FormatText(arg_651_1:GetWordFromCfg(320061157).content)

				arg_651_1.text_.text = var_654_1

				LuaForUtil.ClearLinePrefixSymbol(arg_651_1.text_)

				local var_654_3 = 4 <= 0 and var_654_0 or var_654_0 * (utf8.len(var_654_1) / 4)

				if (4 <= 0 and var_654_0 or var_654_0 * (utf8.len(var_654_1) / 4)) > 0 and var_654_0 < var_654_3 then
	...
	Play320061158 = function(arg_655_0, arg_655_1)
		...
		function arg_655_1.onSingleLineUpdate_(arg_658_0)
			...
			if 0 < arg_655_1.time_ and arg_655_1.time_ <= 0 + arg_658_0 then
				...
				arg_655_1.leftNameTxt_.text = arg_655_1:FormatText(StoryNameCfg[36].name)
				...
				local var_658_1 = arg_655_1:GetWordFromCfg(320061158)
				...
				local var_658_4 = 6 <= 0 and var_658_0 or var_658_0 * (utf8.len(var_658_2) / 6)

				if (6 <= 0 and var_658_0 or var_658_0 * (utf8.len(var_658_2) / 6)) > 0 and var_658_0 < var_658_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061158", "story_v_out_320061.awb") ~= 0 then
					local var_658_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061158", "story_v_out_320061.awb") / 1000
					...
					if var_658_1.prefab_name ~= "" and arg_655_1.actors_[var_658_1.prefab_name] ~= nil then
						local var_658_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_655_1.actors_[var_658_1.prefab_name].transform, "story_v_out_320061", "320061158", "story_v_out_320061.awb")

						arg_655_1:RecordAudio("320061158", var_658_6)
						arg_655_1:RecordAudio("320061158", var_658_6)
					else
	...
	Play320061159 = function(arg_659_0, arg_659_1)
		...
		function arg_659_1.onSingleLineUpdate_(arg_662_0)
			if 0 < arg_659_1.time_ and arg_659_1.time_ <= 0 + arg_662_0 then
				local var_662_0 = arg_659_1.var_.effectfeiqu1

				if not arg_659_1.var_.effectfeiqu1 then
					var_662_0 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_slash_01"), manager.ui.mainCamera.transform)
					var_662_0.name = "feiqu1"
					arg_659_1.var_.effectfeiqu1 = var_662_0
				else
					var_662_0.transform:SetParent(manager.ui.mainCamera.transform)
				end

				var_662_0.transform.localPosition = Vector3.New(0, 0, 0.44)
				var_662_0.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			if arg_659_1.time_ >= var_662_2 + 1 and arg_659_1.time_ < var_662_2 + 1 + arg_662_0 then
				arg_659_1.allBtn_.enabled = true
			end

			local var_662_3 = manager.ui.mainCamera.transform

			if 0 < arg_659_1.time_ and arg_659_1.time_ <= 0 + arg_662_0 then
				arg_659_1.var_.shakeOldPos = var_662_3.localPosition
			end

			local var_662_4 = 1

			if 0 <= arg_659_1.time_ and arg_659_1.time_ < 0 + var_662_4 then
				local var_662_5, var_662_6 = math.modf((arg_659_1.time_ - 0) / 0.066)

				var_662_3.localPosition = Vector3.New(var_662_6 * 0.13, var_662_6 * 0.13, var_662_6 * 0.13) + arg_659_1.var_.shakeOldPos
			end

			if arg_659_1.time_ >= 0 + var_662_4 and arg_659_1.time_ < 0 + var_662_4 + arg_662_0 then
				var_662_3.localPosition = arg_659_1.var_.shakeOldPos
			end
			...
			if 1 < arg_659_1.time_ and arg_659_1.time_ <= var_662_7 + arg_662_0 then
				...
				local var_662_9 = LeanTween.value(arg_659_1.dialog_, 0, 1, 0.3)

				var_662_9:setOnUpdate(LuaHelper.FloatAction(function(arg_663_0)
					arg_659_1.dialogCg_.alpha = arg_663_0
				end))
				var_662_9:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_659_1.dialog_)
					var_662_9:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_662_10 = arg_659_1:FormatText(arg_659_1:GetWordFromCfg(320061159).content)

				arg_659_1.text_.text = var_662_10

				LuaForUtil.ClearLinePrefixSymbol(arg_659_1.text_)

				local var_662_12 = 36 <= 0 and var_662_8 or var_662_8 * (utf8.len(var_662_10) / 36)

				if (36 <= 0 and var_662_8 or var_662_8 * (utf8.len(var_662_10) / 36)) > 0 and var_662_8 < var_662_12 then
					arg_659_1.talkMaxDuration = var_662_12
					var_662_7 = var_662_7 + 0.3

					if var_662_12 + var_662_7 > arg_659_1.duration_ then
						arg_659_1.duration_ = var_662_12 + var_662_7
					end
				end
			...
			local var_662_13 = var_662_7 + 0.3
			local var_662_14 = math.max(var_662_8, arg_659_1.talkMaxDuration)

			if var_662_7 + 0.3 <= arg_659_1.time_ and arg_659_1.time_ < var_662_13 + var_662_14 then
				arg_659_1.typewritter.percent = (arg_659_1.time_ - var_662_13) / var_662_14

				arg_659_1.typewritter:SetDirty()
			end

			if arg_659_1.time_ >= var_662_13 + var_662_14 and arg_659_1.time_ < var_662_13 + var_662_14 + arg_662_0 then
	...
	Play320061160 = function(arg_665_0, arg_665_1)
		...
		function arg_665_1.onSingleLineUpdate_(arg_668_0)
			...
			if 0 < arg_665_1.time_ and arg_665_1.time_ <= 0 + arg_668_0 then
				...
				arg_665_1.leftNameTxt_.text = arg_665_1:FormatText(StoryNameCfg[1021].name)
				...
				local var_668_1 = arg_665_1:GetWordFromCfg(320061160)
				...
				local var_668_4 = 9 <= 0 and var_668_0 or var_668_0 * (utf8.len(var_668_2) / 9)

				if (9 <= 0 and var_668_0 or var_668_0 * (utf8.len(var_668_2) / 9)) > 0 and var_668_0 < var_668_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061160", "story_v_out_320061.awb") ~= 0 then
					local var_668_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061160", "story_v_out_320061.awb") / 1000
					...
					if var_668_1.prefab_name ~= "" and arg_665_1.actors_[var_668_1.prefab_name] ~= nil then
						local var_668_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_665_1.actors_[var_668_1.prefab_name].transform, "story_v_out_320061", "320061160", "story_v_out_320061.awb")

						arg_665_1:RecordAudio("320061160", var_668_6)
						arg_665_1:RecordAudio("320061160", var_668_6)
					else
	...
	Play320061161 = function(arg_669_0, arg_669_1)
		...
		function arg_669_1.onSingleLineUpdate_(arg_672_0)
			...
			if 0 < arg_669_1.time_ and arg_669_1.time_ <= 0 + arg_672_0 then
				local var_672_0 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_672_0 then
					var_672_0.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.BlurByBackground
					var_672_0.radialBlurScale = 0
					var_672_0.radialBlurGradient = 1
					var_672_0.radialBlurIntensity = 1

					if nil then
						var_672_0.radialBlurTarget = (nil).transform
					end
				end
			end
			...
			if 0 <= arg_669_1.time_ and arg_669_1.time_ < 0 + var_672_1 then
				...
				if var_672_2 then
					...
					var_672_2.radialBlurScale = Mathf.Lerp(0, 0.822, (arg_669_1.time_ - 0) / var_672_1)
					var_672_2.radialBlurGradient = Mathf.Lerp(1, 1, (arg_669_1.time_ - 0) / var_672_1)
					var_672_2.radialBlurIntensity = Mathf.Lerp(1, 1, (arg_669_1.time_ - 0) / var_672_1)
				end
			end

			if arg_669_1.time_ >= 0 + var_672_1 and arg_669_1.time_ < 0 + var_672_1 + arg_672_0 then
				local var_672_3 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_672_3 then
					var_672_3.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.BlurByBackground
					var_672_3.radialBlurScale = 0.822
					var_672_3.radialBlurGradient = 1
					var_672_3.radialBlurIntensity = 1
				end
			end

			if 0 < arg_669_1.time_ and arg_669_1.time_ <= 0 + arg_672_0 then
				local var_672_4 = arg_669_1.var_.effectxueji1

				if not arg_669_1.var_.effectxueji1 then
					var_672_4 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in"), manager.ui.mainCamera.transform)
					var_672_4.name = "xueji1"
					arg_669_1.var_.effectxueji1 = var_672_4
				else
					var_672_4.transform:SetParent(var_672_9000)
				end

				var_672_4.transform.localPosition = Vector3.New(0, 0, 0)
				var_672_4.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_672_6 = 0
			local var_672_7 = 0.05

			if 0 < arg_669_1.time_ and arg_669_1.time_ <= var_672_6 + arg_672_0 then
				...
				local var_672_8 = arg_669_1:FormatText(arg_669_1:GetWordFromCfg(320061161).content)

				arg_669_1.text_.text = var_672_8

				LuaForUtil.ClearLinePrefixSymbol(arg_669_1.text_)

				local var_672_10 = 2 <= 0 and var_672_7 or var_672_7 * (utf8.len(var_672_8) / 2)

				if (2 <= 0 and var_672_7 or var_672_7 * (utf8.len(var_672_8) / 2)) > 0 and var_672_7 < var_672_10 then
					arg_669_1.talkMaxDuration = var_672_10

					if var_672_10 + var_672_6 > arg_669_1.duration_ then
						arg_669_1.duration_ = var_672_10 + var_672_6
					end
				end
			...
			local var_672_11 = math.max(var_672_7, arg_669_1.talkMaxDuration)

			if var_672_6 <= arg_669_1.time_ and arg_669_1.time_ < var_672_6 + var_672_11 then
				arg_669_1.typewritter.percent = (arg_669_1.time_ - var_672_6) / var_672_11

				arg_669_1.typewritter:SetDirty()
			end

			if arg_669_1.time_ >= var_672_6 + var_672_11 and arg_669_1.time_ < var_672_6 + var_672_11 + arg_672_0 then
	...
	Play320061162 = function(arg_673_0, arg_673_1)
		...
		function arg_673_1.onSingleLineUpdate_(arg_676_0)
			if 0 < arg_673_1.time_ and arg_673_1.time_ <= 0 + arg_676_0 then
				arg_673_1:AudioAction("play", "effect", "se_story_122_03", "se_story_122_03_swordhit", "")
			end

			local var_676_1 = 0
			local var_676_2 = 0.875
			...
			if 0 < arg_673_1.time_ and arg_673_1.time_ <= var_676_1 + arg_676_0 then
				...
				local var_676_3 = arg_673_1:FormatText(arg_673_1:GetWordFromCfg(320061162).content)

				arg_673_1.text_.text = var_676_3

				LuaForUtil.ClearLinePrefixSymbol(arg_673_1.text_)

				local var_676_5 = 35 <= 0 and var_676_2 or var_676_2 * (utf8.len(var_676_3) / 35)

				if (35 <= 0 and var_676_2 or var_676_2 * (utf8.len(var_676_3) / 35)) > 0 and var_676_2 < var_676_5 then
	...
	Play320061163 = function(arg_677_0, arg_677_1)
		...
		function arg_677_1.onSingleLineUpdate_(arg_680_0)
			if 0 < arg_677_1.time_ and arg_677_1.time_ <= 0 + arg_680_0 then
				local var_680_0 = arg_677_1.var_.effectxueji2

				if not arg_677_1.var_.effectxueji2 then
					var_680_0 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in_ui"), manager.ui.mainCamera.transform)
					var_680_0.name = "xueji2"
					arg_677_1.var_.effectxueji2 = var_680_0
				else
					var_680_0.transform:SetParent(manager.ui.mainCamera.transform)
				end

				var_680_0.transform.localPosition = Vector3.New(0, 0, 0)
				var_680_0.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_680_2 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_680_3 = var_680_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_680_0, iter_680_1 in ipairs((var_680_3:ToTable())) do
					iter_680_1.transform.localScale = Vector3.New(iter_680_1.transform.localScale.x / var_680_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_680_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_680_1.transform.localScale.y / var_680_2, iter_680_1.transform.localScale.z)
				end
			end

			local var_680_5 = 0
			local var_680_6 = 0.95
			...
			if 0 < arg_677_1.time_ and arg_677_1.time_ <= var_680_5 + arg_680_0 then
				...
				local var_680_7 = arg_677_1:FormatText(arg_677_1:GetWordFromCfg(320061163).content)

				arg_677_1.text_.text = var_680_7

				LuaForUtil.ClearLinePrefixSymbol(arg_677_1.text_)

				local var_680_9 = 38 <= 0 and var_680_6 or var_680_6 * (utf8.len(var_680_7) / 38)

				if (38 <= 0 and var_680_6 or var_680_6 * (utf8.len(var_680_7) / 38)) > 0 and var_680_6 < var_680_9 then
					arg_677_1.talkMaxDuration = var_680_9

					if var_680_9 + var_680_5 > arg_677_1.duration_ then
						arg_677_1.duration_ = var_680_9 + var_680_5
					end
				end
			...
			local var_680_10 = math.max(var_680_6, arg_677_1.talkMaxDuration)

			if var_680_5 <= arg_677_1.time_ and arg_677_1.time_ < var_680_5 + var_680_10 then
				arg_677_1.typewritter.percent = (arg_677_1.time_ - var_680_5) / var_680_10

				arg_677_1.typewritter:SetDirty()
			end

			if arg_677_1.time_ >= var_680_5 + var_680_10 and arg_677_1.time_ < var_680_5 + var_680_10 + arg_680_0 then
	...
	Play320061164 = function(arg_681_0, arg_681_1)
		...
		function arg_681_1.onSingleLineUpdate_(arg_684_0)
			...
			if 0 < arg_681_1.time_ and arg_681_1.time_ <= 0 + arg_684_0 then
				...
				local var_684_1 = arg_681_1:FormatText(arg_681_1:GetWordFromCfg(320061164).content)

				arg_681_1.text_.text = var_684_1

				LuaForUtil.ClearLinePrefixSymbol(arg_681_1.text_)

				local var_684_3 = 59 <= 0 and var_684_0 or var_684_0 * (utf8.len(var_684_1) / 59)

				if (59 <= 0 and var_684_0 or var_684_0 * (utf8.len(var_684_1) / 59)) > 0 and var_684_0 < var_684_3 then
					arg_681_1.talkMaxDuration = var_684_3

					if var_684_3 + 0 > arg_681_1.duration_ then
						arg_681_1.duration_ = var_684_3 + 0
					end
				end
			...
			local var_684_4 = math.max(var_684_0, arg_681_1.talkMaxDuration)

			if 0 <= arg_681_1.time_ and arg_681_1.time_ < 0 + var_684_4 then
				arg_681_1.typewritter.percent = (arg_681_1.time_ - 0) / var_684_4

				arg_681_1.typewritter:SetDirty()
			end

			if arg_681_1.time_ >= 0 + var_684_4 and arg_681_1.time_ < 0 + var_684_4 + arg_684_0 then
	...
	Play320061165 = function(arg_685_0, arg_685_1)
		...
		function arg_685_1.onSingleLineUpdate_(arg_688_0)
			...
			if 0 < arg_685_1.time_ and arg_685_1.time_ <= 0 + arg_688_0 then
				...
				local var_688_1 = arg_685_1:FormatText(arg_685_1:GetWordFromCfg(320061165).content)

				arg_685_1.text_.text = var_688_1

				LuaForUtil.ClearLinePrefixSymbol(arg_685_1.text_)

				local var_688_3 = 14 <= 0 and var_688_0 or var_688_0 * (utf8.len(var_688_1) / 14)

				if (14 <= 0 and var_688_0 or var_688_0 * (utf8.len(var_688_1) / 14)) > 0 and var_688_0 < var_688_3 then
	...
	Play320061166 = function(arg_689_0, arg_689_1)
		...
		function arg_689_1.onSingleLineUpdate_(arg_692_0)
			...
			if 0 < arg_689_1.time_ and arg_689_1.time_ <= 0 + arg_692_0 then
				...
				arg_689_1.leftNameTxt_.text = arg_689_1:FormatText(StoryNameCfg[36].name)
				...
				local var_692_1 = arg_689_1:GetWordFromCfg(320061166)
				...
				local var_692_4 = 7 <= 0 and var_692_0 or var_692_0 * (utf8.len(var_692_2) / 7)

				if (7 <= 0 and var_692_0 or var_692_0 * (utf8.len(var_692_2) / 7)) > 0 and var_692_0 < var_692_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061166", "story_v_out_320061.awb") ~= 0 then
					local var_692_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061166", "story_v_out_320061.awb") / 1000
					...
					if var_692_1.prefab_name ~= "" and arg_689_1.actors_[var_692_1.prefab_name] ~= nil then
						local var_692_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_689_1.actors_[var_692_1.prefab_name].transform, "story_v_out_320061", "320061166", "story_v_out_320061.awb")

						arg_689_1:RecordAudio("320061166", var_692_6)
						arg_689_1:RecordAudio("320061166", var_692_6)
					else
	...
	Play320061167 = function(arg_693_0, arg_693_1)
		...
		function arg_693_1.onSingleLineUpdate_(arg_696_0)
			...
			if 0 < arg_693_1.time_ and arg_693_1.time_ <= 0 + arg_696_0 then
				...
				arg_693_1.leftNameTxt_.text = arg_693_1:FormatText(StoryNameCfg[36].name)
				...
				local var_696_1 = arg_693_1:GetWordFromCfg(320061167)
				...
				local var_696_4 = 8 <= 0 and var_696_0 or var_696_0 * (utf8.len(var_696_2) / 8)

				if (8 <= 0 and var_696_0 or var_696_0 * (utf8.len(var_696_2) / 8)) > 0 and var_696_0 < var_696_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320061", "320061167", "story_v_out_320061.awb") ~= 0 then
					local var_696_5 = manager.audio:GetVoiceLength("story_v_out_320061", "320061167", "story_v_out_320061.awb") / 1000
					...
					if var_696_1.prefab_name ~= "" and arg_693_1.actors_[var_696_1.prefab_name] ~= nil then
						local var_696_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_693_1.actors_[var_696_1.prefab_name].transform, "story_v_out_320061", "320061167", "story_v_out_320061.awb")

						arg_693_1:RecordAudio("320061167", var_696_6)
						arg_693_1:RecordAudio("320061167", var_696_6)
					else
	...
	Play320061168 = function(arg_697_0, arg_697_1)
		...
		function arg_697_1.onSingleLineUpdate_(arg_700_0)
			if 0 < arg_697_1.time_ and arg_697_1.time_ <= 0 + arg_700_0 then
				local var_700_0 = arg_697_1.var_.effectxuanyun1

				if not arg_697_1.var_.effectxuanyun1 then
					var_700_0 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ripple"), manager.ui.mainCamera.transform)
					var_700_0.name = "xuanyun1"
					arg_697_1.var_.effectxuanyun1 = var_700_0
				else
					var_700_0.transform:SetParent(manager.ui.mainCamera.transform)
				end

				var_700_0.transform.localPosition = Vector3.New(0, 0, 0)
				var_700_0.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_700_2 = 0
			local var_700_3 = 1.825
			...
			if 0 < arg_697_1.time_ and arg_697_1.time_ <= var_700_2 + arg_700_0 then
				...
				local var_700_4 = arg_697_1:FormatText(arg_697_1:GetWordFromCfg(320061168).content)

				arg_697_1.text_.text = var_700_4

				LuaForUtil.ClearLinePrefixSymbol(arg_697_1.text_)

				local var_700_6 = 73 <= 0 and var_700_3 or var_700_3 * (utf8.len(var_700_4) / 73)

				if (73 <= 0 and var_700_3 or var_700_3 * (utf8.len(var_700_4) / 73)) > 0 and var_700_3 < var_700_6 then
					arg_697_1.talkMaxDuration = var_700_6

					if var_700_6 + var_700_2 > arg_697_1.duration_ then
						arg_697_1.duration_ = var_700_6 + var_700_2
					end
				end
			...
			local var_700_7 = math.max(var_700_3, arg_697_1.talkMaxDuration)

			if var_700_2 <= arg_697_1.time_ and arg_697_1.time_ < var_700_2 + var_700_7 then
				arg_697_1.typewritter.percent = (arg_697_1.time_ - var_700_2) / var_700_7

				arg_697_1.typewritter:SetDirty()
			end

			if arg_697_1.time_ >= var_700_2 + var_700_7 and arg_697_1.time_ < var_700_2 + var_700_7 + arg_700_0 then
	...
	Play320061169 = function(arg_701_0, arg_701_1)
		...
		function arg_701_1.onSingleLineUpdate_(arg_704_0)
			...
			if 0 < arg_701_1.time_ and arg_701_1.time_ <= 0 + arg_704_0 then
				...
				local var_704_1 = arg_701_1:FormatText(arg_701_1:GetWordFromCfg(320061169).content)

				arg_701_1.text_.text = var_704_1

				LuaForUtil.ClearLinePrefixSymbol(arg_701_1.text_)

				local var_704_3 = 45 <= 0 and var_704_0 or var_704_0 * (utf8.len(var_704_1) / 45)

				if (45 <= 0 and var_704_0 or var_704_0 * (utf8.len(var_704_1) / 45)) > 0 and var_704_0 < var_704_3 then
	...
	Play320061170 = function(arg_705_0, arg_705_1)
		...
		function arg_705_1.onSingleLineUpdate_(arg_708_0)
			if 1 < arg_705_1.time_ and arg_705_1.time_ <= 1 + arg_708_0 then
				local var_708_0 = arg_705_1.bgs_.STblack

				arg_705_1.bgs_.STblack.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
				var_708_0.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_708_1 = var_708_0:GetComponent("SpriteRenderer")

				if var_708_1 and var_708_1.sprite then
					local var_708_2 = 2 * (var_708_0.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_708_0.transform.localScale = Vector3.New(var_708_2 / var_708_1.sprite.bounds.size.y < var_708_2 * manager.ui.mainCameraCom_.aspect / var_708_1.sprite.bounds.size.x and var_708_2 * manager.ui.mainCameraCom_.aspect / var_708_1.sprite.bounds.size.x or var_708_2 / var_708_1.sprite.bounds.size.y, var_708_2 / var_708_1.sprite.bounds.size.y < var_708_2 * manager.ui.mainCameraCom_.aspect / var_708_1.sprite.bounds.size.x and var_708_2 * manager.ui.mainCameraCom_.aspect / var_708_1.sprite.bounds.size.x or var_708_2 / var_708_1.sprite.bounds.size.y, 0)
				end
			...
			if 0 < arg_705_1.time_ and arg_705_1.time_ <= var_708_3 + arg_708_0 then
			...
			if var_708_3 <= arg_705_1.time_ and arg_705_1.time_ < var_708_3 + var_708_4 then
				local var_708_5 = Color.New(0, 0, 0)

				var_708_5.a = Mathf.Lerp(0, 1, (arg_705_1.time_ - var_708_3) / var_708_4)
				arg_705_1.mask_.color = var_708_5
			end

			if arg_705_1.time_ >= var_708_3 + var_708_4 and arg_705_1.time_ < var_708_3 + var_708_4 + arg_708_0 then
				local var_708_6 = Color.New(0, 0, 0)

				var_708_6.a = 1
				arg_705_1.mask_.color = var_708_6
			end

			local var_708_7 = 1

			if 1 < arg_705_1.time_ and arg_705_1.time_ <= var_708_7 + arg_708_0 then
				arg_705_1.mask_.enabled = true
				arg_705_1.mask_.raycastTarget = true
			...
			if var_708_7 <= arg_705_1.time_ and arg_705_1.time_ < var_708_7 + var_708_8 then
				local var_708_9 = Color.New(0, 0, 0)

				var_708_9.a = Mathf.Lerp(1, 0, (arg_705_1.time_ - var_708_7) / var_708_8)
				arg_705_1.mask_.color = var_708_9
			end
			...
			if 1 < arg_705_1.time_ and arg_705_1.time_ <= 1 + arg_708_0 then
				local var_708_12 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_708_12 then
					var_708_12.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.Disabled
					var_708_12.radialBlurScale = 0
					var_708_12.radialBlurGradient = 1
					var_708_12.radialBlurIntensity = 1

					if var_708_11 then
						var_708_12.radialBlurTarget = var_708_11.transform
					end
				end
			end
			...
			if 1 <= arg_705_1.time_ and arg_705_1.time_ < 1 + var_708_13 then
				local var_708_14 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_708_14 then
					var_708_14.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.Disabled
					var_708_14.radialBlurScale = Mathf.Lerp(0, 0, (arg_705_1.time_ - 1) / var_708_13)
					var_708_14.radialBlurGradient = Mathf.Lerp(1, 1, (arg_705_1.time_ - 1) / var_708_13)
					var_708_14.radialBlurIntensity = Mathf.Lerp(1, 1, (arg_705_1.time_ - 1) / var_708_13)
				end
			end

			if arg_705_1.time_ >= 1 + var_708_13 and arg_705_1.time_ < 1 + var_708_13 + arg_708_0 then
				local var_708_15 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_708_15 then
					var_708_15.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.Disabled
					var_708_15.radialBlurScale = 0
					var_708_15.radialBlurGradient = 1
					var_708_15.radialBlurIntensity = 1
				end
			end

			if 0.3 < arg_705_1.time_ and arg_705_1.time_ <= 0.3 + arg_708_0 then
				arg_705_1:AudioAction("play", "effect", "se_story_side_1094", "se_story_1094_gun", "")
			end
			...
			local var_708_17 = 1.63333333333333
			local var_708_18 = 1.575

			if 1.63333333333333 < arg_705_1.time_ and arg_705_1.time_ <= var_708_17 + arg_708_0 then
				...
				local var_708_19 = LeanTween.value(arg_705_1.dialog_, 0, 1, 0.3)

				var_708_19:setOnUpdate(LuaHelper.FloatAction(function(arg_709_0)
					arg_705_1.dialogCg_.alpha = arg_709_0
				end))
				var_708_19:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_705_1.dialog_)
					var_708_19:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_708_20 = arg_705_1:FormatText(arg_705_1:GetWordFromCfg(320061170).content)

				arg_705_1.text_.text = var_708_20

				LuaForUtil.ClearLinePrefixSymbol(arg_705_1.text_)

				local var_708_22 = 63 <= 0 and var_708_18 or var_708_18 * (utf8.len(var_708_20) / 63)

				if (63 <= 0 and var_708_18 or var_708_18 * (utf8.len(var_708_20) / 63)) > 0 and var_708_18 < var_708_22 then
					arg_705_1.talkMaxDuration = var_708_22
					var_708_17 = var_708_17 + 0.3

					if var_708_22 + var_708_17 > arg_705_1.duration_ then
						arg_705_1.duration_ = var_708_22 + var_708_17
					end
				end
			...
			local var_708_23 = var_708_17 + 0.3
			local var_708_24 = math.max(var_708_18, arg_705_1.talkMaxDuration)

			if var_708_17 + 0.3 <= arg_705_1.time_ and arg_705_1.time_ < var_708_23 + var_708_24 then
				arg_705_1.typewritter.percent = (arg_705_1.time_ - var_708_23) / var_708_24

				arg_705_1.typewritter:SetDirty()
			end

			if arg_705_1.time_ >= var_708_23 + var_708_24 and arg_705_1.time_ < var_708_23 + var_708_24 + arg_708_0 then
