	...
	Play423021072 = function(arg_293_0, arg_293_1)
		...
		function arg_293_1.onSingleLineUpdate_(arg_296_0)
			...
			if 2 < arg_293_1.time_ and arg_293_1.time_ <= 2 + arg_296_0 then
				...
				local var_296_24 = var_296_21.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_296_7, iter_296_8 in ipairs((var_296_24:ToTable())) do
					iter_296_8.transform.localScale = Vector3.New(iter_296_8.transform.localScale.x / var_296_23 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_296_24 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_296_8.transform.localScale.y / var_296_23, iter_296_8.transform.localScale.z)
				end
			end
			...
			if 0 < arg_293_1.time_ and arg_293_1.time_ <= 0 + arg_296_0 then
				...
				local var_296_28 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_293_1.bgmTxt_.text ~= var_296_28 and arg_293_1.bgmTxt_.text ~= "" then
						if arg_293_1.bgmTxt2_.text ~= "" then
							arg_293_1.bgmTxt_.text = arg_293_1.bgmTxt2_.text
						end

						arg_293_1.bgmTxt2_.text = var_296_28

						arg_293_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_293_1.bgmTxt_.text = var_296_28
						arg_293_1.bgmTxt2_.text = var_296_28
					end
			...
			if 1.36666666666667 < arg_293_1.time_ and arg_293_1.time_ <= 1.36666666666667 + arg_296_0 then
				...
				local var_296_31 = manager.audio:GetAudioName("bgm_story_scheme", "bgm_story_scheme")

				if "" ~= "" then
					if arg_293_1.bgmTxt_.text ~= var_296_31 and arg_293_1.bgmTxt_.text ~= "" then
						if arg_293_1.bgmTxt2_.text ~= "" then
							arg_293_1.bgmTxt_.text = arg_293_1.bgmTxt2_.text
						end

						arg_293_1.bgmTxt2_.text = var_296_31

						arg_293_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_293_1.bgmTxt_.text = var_296_31
						arg_293_1.bgmTxt2_.text = var_296_31
					end
			...
			local var_296_32 = 4
			local var_296_33 = 1.35

			if 4 < arg_293_1.time_ and arg_293_1.time_ <= var_296_32 + arg_296_0 then
				...
				var_296_34:setOnUpdate(LuaHelper.FloatAction(function(arg_299_0)
				...
				local var_296_35 = arg_293_1:FormatText(arg_293_1:GetWordFromCfg(423021072).content)

				arg_293_1.text_.text = var_296_35

				LuaForUtil.ClearLinePrefixSymbol(arg_293_1.text_)

				local var_296_37 = 54 <= 0 and var_296_33 or var_296_33 * (utf8.len(var_296_35) / 54)

				if (54 <= 0 and var_296_33 or var_296_33 * (utf8.len(var_296_35) / 54)) > 0 and var_296_33 < var_296_37 then
					arg_293_1.talkMaxDuration = var_296_37
					var_296_32 = var_296_32 + 0.3

					if var_296_37 + var_296_32 > arg_293_1.duration_ then
						arg_293_1.duration_ = var_296_37 + var_296_32
					end
				end
			...
			local var_296_38 = var_296_32 + 0.3
			local var_296_39 = math.max(var_296_33, arg_293_1.talkMaxDuration)

			if var_296_32 + 0.3 <= arg_293_1.time_ and arg_293_1.time_ < var_296_38 + var_296_39 then
