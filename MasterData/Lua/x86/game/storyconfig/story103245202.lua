	...
	Play324522001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.63333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				local var_4_17 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(324522001).content)
	...
	Play324522002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 then
				...
				local var_11_1 = arg_8_1:FormatText(arg_8_1:GetWordFromCfg(324522002).content)

				arg_8_1.text_.text = var_11_1

				LuaForUtil.ClearLinePrefixSymbol(arg_8_1.text_)

				local var_11_3 = 21 <= 0 and var_11_0 or var_11_0 * (utf8.len(var_11_1) / 21)

				if (21 <= 0 and var_11_0 or var_11_0 * (utf8.len(var_11_1) / 21)) > 0 and var_11_0 < var_11_3 then
	...
	Play324522003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_10 + arg_15_0 then
				...
				local var_15_12 = arg_12_1:GetWordFromCfg(324522003)
				...
				if manager.audio:GetVoiceLength("story_v_out_324522", "324522003", "story_v_out_324522.awb") ~= 0 then
					local var_15_16 = manager.audio:GetVoiceLength("story_v_out_324522", "324522003", "story_v_out_324522.awb") / 1000
					...
					if var_15_12.prefab_name ~= "" and arg_12_1.actors_[var_15_12.prefab_name] ~= nil then
						local var_15_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_12_1.actors_[var_15_12.prefab_name].transform, "story_v_out_324522", "324522003", "story_v_out_324522.awb")

						arg_12_1:RecordAudio("324522003", var_15_17)
						arg_12_1:RecordAudio("324522003", var_15_17)
					else
	...
	Play324522004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_1 + arg_19_0 then
				...
				local var_19_3 = arg_16_1:FormatText(arg_16_1:GetWordFromCfg(324522004).content)

				arg_16_1.text_.text = var_19_3

				LuaForUtil.ClearLinePrefixSymbol(arg_16_1.text_)

				local var_19_5 = 35 <= 0 and var_19_2 or var_19_2 * (utf8.len(var_19_3) / 35)

				if (35 <= 0 and var_19_2 or var_19_2 * (utf8.len(var_19_3) / 35)) > 0 and var_19_2 < var_19_5 then
	...
	Play324522005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_2 + arg_23_0 then
				...
				local var_23_4 = arg_20_1:GetWordFromCfg(324522005)
				...
				local var_23_7 = 24 <= 0 and var_23_3 or var_23_3 * (utf8.len(var_23_5) / 24)

				if (24 <= 0 and var_23_3 or var_23_3 * (utf8.len(var_23_5) / 24)) > 0 and var_23_3 < var_23_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_324522", "324522005", "story_v_out_324522.awb") ~= 0 then
					local var_23_8 = manager.audio:GetVoiceLength("story_v_out_324522", "324522005", "story_v_out_324522.awb") / 1000
					...
					if var_23_4.prefab_name ~= "" and arg_20_1.actors_[var_23_4.prefab_name] ~= nil then
						local var_23_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_20_1.actors_[var_23_4.prefab_name].transform, "story_v_out_324522", "324522005", "story_v_out_324522.awb")

						arg_20_1:RecordAudio("324522005", var_23_9)
						arg_20_1:RecordAudio("324522005", var_23_9)
					else
	...
	Play324522006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_1 + arg_27_0 then
				...
				local var_27_3 = arg_24_1:FormatText(arg_24_1:GetWordFromCfg(324522006).content)
	...
	Play324522007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 then
				...
				local var_31_1 = arg_28_1:FormatText(arg_28_1:GetWordFromCfg(324522007).content)
	...
	Play324522008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_2 + arg_35_0 then
				...
				arg_32_1.leftNameTxt_.text = arg_32_1:FormatText(StoryNameCfg[1450].name)
				...
				local var_35_4 = arg_32_1:GetWordFromCfg(324522008)
				...
				local var_35_7 = 20 <= 0 and var_35_3 or var_35_3 * (utf8.len(var_35_5) / 20)

				if (20 <= 0 and var_35_3 or var_35_3 * (utf8.len(var_35_5) / 20)) > 0 and var_35_3 < var_35_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_324522", "324522008", "story_v_out_324522.awb") ~= 0 then
					local var_35_8 = manager.audio:GetVoiceLength("story_v_out_324522", "324522008", "story_v_out_324522.awb") / 1000
					...
					if var_35_4.prefab_name ~= "" and arg_32_1.actors_[var_35_4.prefab_name] ~= nil then
						local var_35_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_32_1.actors_[var_35_4.prefab_name].transform, "story_v_out_324522", "324522008", "story_v_out_324522.awb")

						arg_32_1:RecordAudio("324522008", var_35_9)
						arg_32_1:RecordAudio("324522008", var_35_9)
					else
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if 0 <= arg_36_1.time_ and arg_36_1.time_ < 0 + var_39_0 and not isNil(arg_36_1.actors_["10170ui_story"]) then
				if arg_36_1.var_.characterEffect10170ui_story and not isNil(arg_36_1.actors_["10170ui_story"]) then
					...
					arg_36_1.var_.characterEffect10170ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_36_1.time_ - 0) / var_39_0)
				end
			end
			...
			if arg_36_1.time_ >= 0 + var_39_0 and arg_36_1.time_ < 0 + var_39_0 + arg_39_0 and not isNil(arg_36_1.actors_["10170ui_story"]) and arg_36_1.var_.characterEffect10170ui_story then
				arg_36_1.var_.characterEffect10170ui_story.fillFlat = true
				arg_36_1.var_.characterEffect10170ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_1 + arg_39_0 then
				...
				local var_39_3 = arg_36_1:FormatText(arg_36_1:GetWordFromCfg(324522009).content)

				arg_36_1.text_.text = var_39_3

				LuaForUtil.ClearLinePrefixSymbol(arg_36_1.text_)

				local var_39_5 = 25 <= 0 and var_39_2 or var_39_2 * (utf8.len(var_39_3) / 25)

				if (25 <= 0 and var_39_2 or var_39_2 * (utf8.len(var_39_3) / 25)) > 0 and var_39_2 < var_39_5 then
	...
	Play324522010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_2 + arg_43_0 then
				...
				local var_43_4 = arg_40_1:GetWordFromCfg(324522010)
				...
				if manager.audio:GetVoiceLength("story_v_out_324522", "324522010", "story_v_out_324522.awb") ~= 0 then
					local var_43_8 = manager.audio:GetVoiceLength("story_v_out_324522", "324522010", "story_v_out_324522.awb") / 1000
					...
					if var_43_4.prefab_name ~= "" and arg_40_1.actors_[var_43_4.prefab_name] ~= nil then
						local var_43_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_4.prefab_name].transform, "story_v_out_324522", "324522010", "story_v_out_324522.awb")

						arg_40_1:RecordAudio("324522010", var_43_9)
						arg_40_1:RecordAudio("324522010", var_43_9)
					else
	...
	Play324522011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 then
				arg_44_1.var_.moveOldPos10170ui_story = arg_44_1.actors_["10170ui_story"].transform.localPosition

				local var_47_0 = GameObjectTools.GetOrAddComponent(arg_44_1.actors_["10170ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			if 0 <= arg_44_1.time_ and arg_44_1.time_ < 0 + var_47_1 then
				arg_44_1.actors_["10170ui_story"].transform.localPosition = Vector3.Lerp(arg_44_1.var_.moveOldPos10170ui_story, Vector3.New(0, 100, 0), (arg_44_1.time_ - 0) / var_47_1)
				arg_44_1.actors_["10170ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_44_1.actors_["10170ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_44_1.actors_["10170ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_44_1.actors_["10170ui_story"].transform.position).z)
				arg_44_1.actors_["10170ui_story"].transform.localEulerAngles.z = 0
				arg_44_1.actors_["10170ui_story"].transform.localEulerAngles.x = 0
				arg_44_1.actors_["10170ui_story"].transform.localEulerAngles = arg_44_1.actors_["10170ui_story"].transform.localEulerAngles
			end

			if arg_44_1.time_ >= 0 + var_47_1 and arg_44_1.time_ < 0 + var_47_1 + arg_47_0 then
				arg_44_1.actors_["10170ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_44_1.actors_["10170ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_44_1.actors_["10170ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_44_1.actors_["10170ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_44_1.actors_["10170ui_story"].transform.position).z)
				arg_44_1.actors_["10170ui_story"].transform.localEulerAngles.z = 0
				arg_44_1.actors_["10170ui_story"].transform.localEulerAngles.x = 0
				arg_44_1.actors_["10170ui_story"].transform.localEulerAngles = arg_44_1.actors_["10170ui_story"].transform.localEulerAngles

				local var_47_2 = GameObjectTools.GetOrAddComponent(arg_44_1.actors_["10170ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			local var_47_3 = arg_44_1.actors_["10170ui_story"]

			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 and not isNil(var_47_3) and arg_44_1.var_.characterEffect10170ui_story == nil then
				arg_44_1.var_.characterEffect10170ui_story = var_47_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_47_4 = 0.200000002980232

			if 0 <= arg_44_1.time_ and arg_44_1.time_ < 0 + var_47_4 and not isNil(var_47_3) then
				if arg_44_1.var_.characterEffect10170ui_story and not isNil(var_47_3) then
					arg_44_1.var_.characterEffect10170ui_story.fillFlat = true
					arg_44_1.var_.characterEffect10170ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_44_1.time_ - 0) / var_47_4)
				end
			end

			if arg_44_1.time_ >= 0 + var_47_4 and arg_44_1.time_ < 0 + var_47_4 + arg_47_0 and not isNil(var_47_3) and arg_44_1.var_.characterEffect10170ui_story then
				arg_44_1.var_.characterEffect10170ui_story.fillFlat = true
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= var_47_5 + arg_47_0 then
				...
				local var_47_7 = arg_44_1:FormatText(arg_44_1:GetWordFromCfg(324522011).content)
	...
	Play324522012 = function(arg_48_0, arg_48_1)
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if 0 < arg_48_1.time_ and arg_48_1.time_ <= 0 + arg_51_0 then
				...
				local var_51_1 = arg_48_1:FormatText(arg_48_1:GetWordFromCfg(324522012).content)

				arg_48_1.text_.text = var_51_1

				LuaForUtil.ClearLinePrefixSymbol(arg_48_1.text_)

				local var_51_3 = 40 <= 0 and var_51_0 or var_51_0 * (utf8.len(var_51_1) / 40)

				if (40 <= 0 and var_51_0 or var_51_0 * (utf8.len(var_51_1) / 40)) > 0 and var_51_0 < var_51_3 then
