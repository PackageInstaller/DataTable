	...
	Play321011121 = function(arg_507_0, arg_507_1)
		...
		function arg_507_1.onSingleLineUpdate_(arg_510_0)
			...
			if 0 < arg_507_1.time_ and arg_507_1.time_ <= 0 + arg_510_0 then
				...
				local var_510_7 = var_510_4.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_510_0, iter_510_1 in ipairs((var_510_7:ToTable())) do
					iter_510_1.transform.localScale = Vector3.New(iter_510_1.transform.localScale.x / var_510_6 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_510_7 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_510_1.transform.localScale.y / var_510_6, iter_510_1.transform.localScale.z)
				end
			end
			...
			if arg_507_1.time_ >= var_510_9 + 0.925 and arg_507_1.time_ < var_510_9 + 0.925 + arg_510_0 then
				arg_507_1.allBtn_.enabled = true
			end

			local var_510_10 = 0
			local var_510_11 = 0.925

			if 0 < arg_507_1.time_ and arg_507_1.time_ <= var_510_10 + arg_510_0 then
				...
				local var_510_12 = arg_507_1:FormatText(arg_507_1:GetWordFromCfg(321011121).content)

				arg_507_1.text_.text = var_510_12

				LuaForUtil.ClearLinePrefixSymbol(arg_507_1.text_)

				local var_510_14 = 37 <= 0 and var_510_11 or var_510_11 * (utf8.len(var_510_12) / 37)

				if (37 <= 0 and var_510_11 or var_510_11 * (utf8.len(var_510_12) / 37)) > 0 and var_510_11 < var_510_14 then
					arg_507_1.talkMaxDuration = var_510_14

					if var_510_14 + var_510_10 > arg_507_1.duration_ then
						arg_507_1.duration_ = var_510_14 + var_510_10
					end
				end
			...
			local var_510_15 = math.max(var_510_11, arg_507_1.talkMaxDuration)

			if var_510_10 <= arg_507_1.time_ and arg_507_1.time_ < var_510_10 + var_510_15 then
				arg_507_1.typewritter.percent = (arg_507_1.time_ - var_510_10) / var_510_15

				arg_507_1.typewritter:SetDirty()
			end

			if arg_507_1.time_ >= var_510_10 + var_510_15 and arg_507_1.time_ < var_510_10 + var_510_15 + arg_510_0 then
