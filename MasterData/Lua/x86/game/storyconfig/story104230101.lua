		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0.3 < arg_69_1.time_ and arg_69_1.time_ <= 0.3 + arg_72_0 then
				...
				if not arg_69_1.var_.effectjilieqiangsheng2 then
					...
					var_72_8.transform:SetParent(var_72_9001)
				end
			...
			if 0.6 < arg_69_1.time_ and arg_69_1.time_ <= 0.6 + arg_72_0 then
				...
				if not arg_69_1.var_.effectjilieqiangsheng3 then
					...
					var_72_11.transform:SetParent(var_72_9000)
				end
			...
			if 1 < arg_69_1.time_ and arg_69_1.time_ <= 1 + arg_72_0 then
				...
				if not arg_69_1.var_.effectjilieqiangsheng4 then
					...
					var_72_14.transform:SetParent(var_72_9002)
				end
	...
	Play423011026 = function(arg_113_0, arg_113_1)
		...
		function arg_113_1.onSingleLineUpdate_(arg_116_0)
			...
			if 1 < arg_113_1.time_ and arg_113_1.time_ <= 1 + arg_116_0 then
				...
				local var_116_15 = var_116_12.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_116_2, iter_116_3 in ipairs((var_116_15:ToTable())) do
					iter_116_3.transform.localScale = Vector3.New(iter_116_3.transform.localScale.x / var_116_14 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_116_15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_116_3.transform.localScale.y / var_116_14, iter_116_3.transform.localScale.z)
				end
			end

			local var_116_17 = arg_113_1.bgs_.ST0113.transform

			if 1 < arg_113_1.time_ and arg_113_1.time_ <= 1 + arg_116_0 then
				arg_113_1.var_.moveOldPosST0113 = var_116_17.localPosition
			end

			local var_116_18 = 6.5

			if 1 <= arg_113_1.time_ and arg_113_1.time_ < 1 + var_116_18 then
				var_116_17.localPosition = Vector3.Lerp(arg_113_1.var_.moveOldPosST0113, Vector3.New(0, 1, 10), (arg_113_1.time_ - 1) / var_116_18)
			end

			if arg_113_1.time_ >= 1 + var_116_18 and arg_113_1.time_ < 1 + var_116_18 + arg_116_0 then
				var_116_17.localPosition = Vector3.New(0, 1, 10)
			end

			if 1 < arg_113_1.time_ and arg_113_1.time_ <= 1 + arg_116_0 then
				local var_116_19 = arg_113_1.var_.effectchechuangwai1

				if not arg_113_1.var_.effectchechuangwai1 then
					var_116_19 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_heavy_ui"), manager.ui.mainCamera.transform)
					var_116_19.name = "chechuangwai1"
					arg_113_1.var_.effectchechuangwai1 = var_116_19
				else
					var_116_19.transform:SetParent(var_116_9000)
				end

				var_116_19.transform.localPosition = Vector3.New(0, 0, 0)
				var_116_19.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_116_21 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_116_22 = var_116_19.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_116_4, iter_116_5 in ipairs((var_116_22:ToTable())) do
					iter_116_5.transform.localScale = Vector3.New(iter_116_5.transform.localScale.x / var_116_21 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_116_22 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_116_5.transform.localScale.y / var_116_21, iter_116_5.transform.localScale.z)
				end
			end

			local var_116_24 = 2
			local var_116_25 = 1.325

			if 2 < arg_113_1.time_ and arg_113_1.time_ <= var_116_24 + arg_116_0 then
				...
				local var_116_26 = arg_113_1:FormatText(arg_113_1:GetWordFromCfg(423011026).content)

				arg_113_1.text_.text = var_116_26

				LuaForUtil.ClearLinePrefixSymbol(arg_113_1.text_)

				local var_116_28 = 53 <= 0 and var_116_25 or var_116_25 * (utf8.len(var_116_26) / 53)

				if (53 <= 0 and var_116_25 or var_116_25 * (utf8.len(var_116_26) / 53)) > 0 and var_116_25 < var_116_28 then
					arg_113_1.talkMaxDuration = var_116_28

					if var_116_28 + var_116_24 > arg_113_1.duration_ then
						arg_113_1.duration_ = var_116_28 + var_116_24
					end
				end
			...
			local var_116_29 = math.max(var_116_25, arg_113_1.talkMaxDuration)

			if var_116_24 <= arg_113_1.time_ and arg_113_1.time_ < var_116_24 + var_116_29 then
				arg_113_1.typewritter.percent = (arg_113_1.time_ - var_116_24) / var_116_29

				arg_113_1.typewritter:SetDirty()
			end

			if arg_113_1.time_ >= var_116_24 + var_116_29 and arg_113_1.time_ < var_116_24 + var_116_29 + arg_116_0 then
	...
	Play423011069 = function(arg_282_0, arg_282_1)
		...
		function arg_282_1.onSingleLineUpdate_(arg_285_0)
			...
			if 0 < arg_282_1.time_ and arg_282_1.time_ <= 0 + arg_285_0 then
				...
				local var_285_9 = var_285_6.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_285_0, iter_285_1 in ipairs((var_285_9:ToTable())) do
					iter_285_1.transform.localScale = Vector3.New(iter_285_1.transform.localScale.x / var_285_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_285_9 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_285_1.transform.localScale.y / var_285_8, iter_285_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_282_1.time_ and arg_282_1.time_ <= var_285_12 + arg_285_0 then
				...
				local var_285_14 = arg_282_1:FormatText(arg_282_1:GetWordFromCfg(423011069).content)

				arg_282_1.text_.text = var_285_14

				LuaForUtil.ClearLinePrefixSymbol(arg_282_1.text_)

				local var_285_16 = 68 <= 0 and var_285_13 or var_285_13 * (utf8.len(var_285_14) / 68)

				if (68 <= 0 and var_285_13 or var_285_13 * (utf8.len(var_285_14) / 68)) > 0 and var_285_13 < var_285_16 then
					arg_282_1.talkMaxDuration = var_285_16

					if var_285_16 + var_285_12 > arg_282_1.duration_ then
						arg_282_1.duration_ = var_285_16 + var_285_12
					end
				end
			...
			local var_285_17 = math.max(var_285_13, arg_282_1.talkMaxDuration)

			if var_285_12 <= arg_282_1.time_ and arg_282_1.time_ < var_285_12 + var_285_17 then
				arg_282_1.typewritter.percent = (arg_282_1.time_ - var_285_12) / var_285_17

				arg_282_1.typewritter:SetDirty()
			end

			if arg_282_1.time_ >= var_285_12 + var_285_17 and arg_282_1.time_ < var_285_12 + var_285_17 + arg_285_0 then
