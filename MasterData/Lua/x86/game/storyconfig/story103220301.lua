	...
	Play322031046 = function(arg_191_0, arg_191_1)
		...
		function arg_191_1.onSingleLineUpdate_(arg_194_0)
			...
			if 2.00000000298023 < arg_191_1.time_ and arg_191_1.time_ <= 2.00000000298023 + arg_194_0 then
				...
				local var_194_20 = var_194_17.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_194_2, iter_194_3 in ipairs((var_194_20:ToTable())) do
					iter_194_3.transform.localScale = Vector3.New(iter_194_3.transform.localScale.x / var_194_19 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_194_20 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_194_3.transform.localScale.y / var_194_19, iter_194_3.transform.localScale.z)
				end
			end

			if 2.00000000298023 < arg_191_1.time_ and arg_191_1.time_ <= 2.00000000298023 + arg_194_0 then
				local var_194_22 = arg_191_1.var_.effect10461

				if not arg_191_1.var_.effect10461 then
					var_194_22 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_vignetting"), manager.ui.mainCamera.transform)
					var_194_22.name = "10461"
					arg_191_1.var_.effect10461 = var_194_22
				else
					var_194_22.transform:SetParent(var_194_9000)
				end

				var_194_22.transform.localPosition = Vector3.New(0, 0, -6)
				var_194_22.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_194_24 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_194_25 = var_194_22.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_194_4, iter_194_5 in ipairs((var_194_25:ToTable())) do
					iter_194_5.transform.localScale = Vector3.New(iter_194_5.transform.localScale.x / var_194_24 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_194_25 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_194_5.transform.localScale.y / var_194_24, iter_194_5.transform.localScale.z)
				end
			end
			...
			if var_194_27 <= arg_191_1.time_ and arg_191_1.time_ < var_194_27 + var_194_28 then
				arg_191_1.screenFilterEffect_.weight = Mathf.Lerp(0, 1, (arg_191_1.time_ - var_194_27) / var_194_28)
			end

			if arg_191_1.time_ >= var_194_27 + var_194_28 and arg_191_1.time_ < var_194_27 + var_194_28 + arg_194_0 then
			...
			local var_194_29 = 3.974999999999
			local var_194_30 = 0.325

			if 3.974999999999 < arg_191_1.time_ and arg_191_1.time_ <= var_194_29 + arg_194_0 then
				...
				local var_194_31 = LeanTween.value(arg_191_1.dialog_, 0, 1, 0.3)

				var_194_31:setOnUpdate(LuaHelper.FloatAction(function(arg_195_0)
					arg_191_1.dialogCg_.alpha = arg_195_0
				end))
				var_194_31:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_191_1.dialog_)
					var_194_31:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_194_32 = arg_191_1:GetWordFromCfg(322031046)
				...
				local var_194_35 = 13 <= 0 and var_194_30 or var_194_30 * (utf8.len(var_194_33) / 13)

				if (13 <= 0 and var_194_30 or var_194_30 * (utf8.len(var_194_33) / 13)) > 0 and var_194_30 < var_194_35 then
					arg_191_1.talkMaxDuration = var_194_35
					var_194_29 = var_194_29 + 0.3

					if var_194_35 + var_194_29 > arg_191_1.duration_ then
						arg_191_1.duration_ = var_194_35 + var_194_29
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_322031", "322031046", "story_v_out_322031.awb") ~= 0 then
					local var_194_36 = manager.audio:GetVoiceLength("story_v_out_322031", "322031046", "story_v_out_322031.awb") / 1000
					...
					if var_194_32.prefab_name ~= "" and arg_191_1.actors_[var_194_32.prefab_name] ~= nil then
						local var_194_37 = LuaForUtil.PlayVoiceWithCriLipsync(arg_191_1.actors_[var_194_32.prefab_name].transform, "story_v_out_322031", "322031046", "story_v_out_322031.awb")

						arg_191_1:RecordAudio("322031046", var_194_37)
						arg_191_1:RecordAudio("322031046", var_194_37)
					else
			...
			local var_194_38 = var_194_29 + 0.3
			local var_194_39 = math.max(var_194_30, arg_191_1.talkMaxDuration)

			if var_194_29 + 0.3 <= arg_191_1.time_ and arg_191_1.time_ < var_194_38 + var_194_39 then
				arg_191_1.typewritter.percent = (arg_191_1.time_ - var_194_38) / var_194_39

				arg_191_1.typewritter:SetDirty()
			end

			if arg_191_1.time_ >= var_194_38 + var_194_39 and arg_191_1.time_ < var_194_38 + var_194_39 + arg_194_0 then
