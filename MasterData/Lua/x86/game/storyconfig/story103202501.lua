	...
	Play320251096 = function(arg_409_0, arg_409_1)
		...
		function arg_409_1.onSingleLineUpdate_(arg_412_0)
			if 0 < arg_409_1.time_ and arg_409_1.time_ <= 0 + arg_412_0 then
				...
				local var_412_3 = var_412_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_412_0, iter_412_1 in ipairs((var_412_3:ToTable())) do
					iter_412_1.transform.localScale = Vector3.New(iter_412_1.transform.localScale.x / var_412_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_412_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_412_1.transform.localScale.y / var_412_2, iter_412_1.transform.localScale.z)
				end
			end
			...
			if arg_409_1.time_ >= var_412_6 + var_412_7 and arg_409_1.time_ < var_412_6 + var_412_7 + arg_412_0 then
				local var_412_9 = Color.New(1, 1, 1)

				arg_409_1.mask_.enabled = false
				var_412_9.a = 0
				arg_409_1.mask_.color = var_412_9
			end
			...
			local var_412_11 = 1.1
			local var_412_12 = 1.6

			if 1.1 < arg_409_1.time_ and arg_409_1.time_ <= var_412_11 + arg_412_0 then
				...
				local var_412_13 = LeanTween.value(arg_409_1.dialog_, 0, 1, 0.3)

				var_412_13:setOnUpdate(LuaHelper.FloatAction(function(arg_413_0)
					arg_409_1.dialogCg_.alpha = arg_413_0
				end))
				var_412_13:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_409_1.dialog_)
					var_412_13:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_412_14 = arg_409_1:FormatText(arg_409_1:GetWordFromCfg(320251096).content)

				arg_409_1.text_.text = var_412_14

				LuaForUtil.ClearLinePrefixSymbol(arg_409_1.text_)

				local var_412_16 = 64 <= 0 and var_412_12 or var_412_12 * (utf8.len(var_412_14) / 64)

				if (64 <= 0 and var_412_12 or var_412_12 * (utf8.len(var_412_14) / 64)) > 0 and var_412_12 < var_412_16 then
					arg_409_1.talkMaxDuration = var_412_16
					var_412_11 = var_412_11 + 0.3
			...
			local var_412_17 = var_412_11 + 0.3
			local var_412_18 = math.max(var_412_12, arg_409_1.talkMaxDuration)

			if var_412_11 + 0.3 <= arg_409_1.time_ and arg_409_1.time_ < var_412_17 + var_412_18 then
