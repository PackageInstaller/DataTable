return {
	Play116152001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2.2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_6 + arg_4_0 then
				...
				local var_4_9 = arg_1_1:GetWordFromCfg(116152001)
				...
				local var_4_12 = 18 <= 0 and var_4_7 or var_4_7 * (utf8.len(var_4_10) / 18)

				if (18 <= 0 and var_4_7 or var_4_7 * (utf8.len(var_4_10) / 18)) > 0 and var_4_7 < var_4_12 then
				...
				if manager.audio:GetVoiceLength("story_v_out_116152", "116152001", "story_v_out_116152.awb") ~= 0 then
					local var_4_13 = manager.audio:GetVoiceLength("story_v_out_116152", "116152001", "story_v_out_116152.awb") / 1000
					...
					if var_4_9.prefab_name ~= "" and arg_1_1.actors_[var_4_9.prefab_name] ~= nil then
						local var_4_14 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_9.prefab_name].transform, "story_v_out_116152", "116152001", "story_v_out_116152.awb")

						arg_1_1:RecordAudio("116152001", var_4_14)
						arg_1_1:RecordAudio("116152001", var_4_14)
					else
	...
	Play116152002 = function(arg_8_0, arg_8_1)
		arg_8_1.time_ = 0
		arg_8_1.frameCnt_ = 0
		arg_8_1.state_ = "playing"
		arg_8_1.curTalkId_ = 116152002
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 then
				...
				arg_8_1.leftNameTxt_.text = arg_8_1:FormatText(StoryNameCfg[327].name)
				...
				arg_8_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1028")
				...
				local var_11_1 = arg_8_1:GetWordFromCfg(116152002)
				...
				local var_11_4 = 31 <= 0 and var_11_0 or var_11_0 * (utf8.len(var_11_2) / 31)

				if (31 <= 0 and var_11_0 or var_11_0 * (utf8.len(var_11_2) / 31)) > 0 and var_11_0 < var_11_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_116152", "116152002", "story_v_out_116152.awb") ~= 0 then
					local var_11_5 = manager.audio:GetVoiceLength("story_v_out_116152", "116152002", "story_v_out_116152.awb") / 1000
					...
					if var_11_1.prefab_name ~= "" and arg_8_1.actors_[var_11_1.prefab_name] ~= nil then
						local var_11_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_1.prefab_name].transform, "story_v_out_116152", "116152002", "story_v_out_116152.awb")

						arg_8_1:RecordAudio("116152002", var_11_6)
						arg_8_1:RecordAudio("116152002", var_11_6)
					else
						arg_8_1:AudioAction("play", "voice", "story_v_out_116152", "116152002", "story_v_out_116152.awb")
					end

					arg_8_1:RecordHistoryTalkVoice("story_v_out_116152", "116152002", "story_v_out_116152.awb")
				end
	...
	Play116152003 = function(arg_12_0, arg_12_1)
		arg_12_1.time_ = 0
		arg_12_1.frameCnt_ = 0
		arg_12_1.state_ = "playing"
		arg_12_1.curTalkId_ = 116152003
		arg_12_1.duration_ = 7.27
		...
		function arg_12_1.playNext_(arg_14_0)
			if arg_14_0 == 1 then
				arg_12_0:Play116152004(arg_12_1)
			end
		end
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 then
				...
				arg_12_1.leftNameTxt_.text = arg_12_1:FormatText(StoryNameCfg[327].name)
				...
				arg_12_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1028")
				...
				local var_15_1 = arg_12_1:GetWordFromCfg(116152003)
				...
				if manager.audio:GetVoiceLength("story_v_out_116152", "116152003", "story_v_out_116152.awb") ~= 0 then
					local var_15_5 = manager.audio:GetVoiceLength("story_v_out_116152", "116152003", "story_v_out_116152.awb") / 1000
					...
					if var_15_1.prefab_name ~= "" and arg_12_1.actors_[var_15_1.prefab_name] ~= nil then
						local var_15_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_12_1.actors_[var_15_1.prefab_name].transform, "story_v_out_116152", "116152003", "story_v_out_116152.awb")

						arg_12_1:RecordAudio("116152003", var_15_6)
						arg_12_1:RecordAudio("116152003", var_15_6)
					else
						arg_12_1:AudioAction("play", "voice", "story_v_out_116152", "116152003", "story_v_out_116152.awb")
					end

					arg_12_1:RecordHistoryTalkVoice("story_v_out_116152", "116152003", "story_v_out_116152.awb")
				end
	...
	Play116152004 = function(arg_16_0, arg_16_1)
		arg_16_1.time_ = 0
		arg_16_1.frameCnt_ = 0
		arg_16_1.state_ = "playing"
		arg_16_1.curTalkId_ = 116152004
		arg_16_1.duration_ = 4.57
		...
		function arg_16_1.onSingleLineFinish_()
			...
			arg_16_1.auto_ = false
		end

		function arg_16_1.playNext_(arg_18_0)
			arg_16_1.onStoryFinished_()
		end
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 then
				...
				arg_16_1.leftNameTxt_.text = arg_16_1:FormatText(StoryNameCfg[327].name)
				...
				arg_16_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1028")
				...
				local var_19_1 = arg_16_1:GetWordFromCfg(116152004)
				...
				if manager.audio:GetVoiceLength("story_v_out_116152", "116152004", "story_v_out_116152.awb") ~= 0 then
					local var_19_5 = manager.audio:GetVoiceLength("story_v_out_116152", "116152004", "story_v_out_116152.awb") / 1000
					...
					if var_19_1.prefab_name ~= "" and arg_16_1.actors_[var_19_1.prefab_name] ~= nil then
						local var_19_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_1.prefab_name].transform, "story_v_out_116152", "116152004", "story_v_out_116152.awb")

						arg_16_1:RecordAudio("116152004", var_19_6)
						arg_16_1:RecordAudio("116152004", var_19_6)
					else
						arg_16_1:AudioAction("play", "voice", "story_v_out_116152", "116152004", "story_v_out_116152.awb")
					end

					arg_16_1:RecordHistoryTalkVoice("story_v_out_116152", "116152004", "story_v_out_116152.awb")
				end
