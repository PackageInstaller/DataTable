	...
	Play321102008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0.034 < arg_33_1.time_ and arg_33_1.time_ <= 0.034 + arg_36_0 then
				...
				local var_36_14 = var_36_11.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_36_0, iter_36_1 in ipairs((var_36_14:ToTable())) do
					iter_36_1.transform.localScale = Vector3.New(iter_36_1.transform.localScale.x / var_36_13 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_36_14 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_36_1.transform.localScale.y / var_36_13, iter_36_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_17 + arg_36_0 then
			...
			local var_36_21 = manager.ui.mainCamera.transform

			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				arg_33_1.var_.shakeOldPos = var_36_21.localPosition
			end

			local var_36_22 = 0.466666666666667

			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_22 then
				local var_36_23, var_36_24 = math.modf((arg_33_1.time_ - 0) / 0.066)

				var_36_21.localPosition = Vector3.New(var_36_24 * 0.13, var_36_24 * 0.13, var_36_24 * 0.13) + arg_33_1.var_.shakeOldPos
			end

			if arg_33_1.time_ >= 0 + var_36_22 and arg_33_1.time_ < 0 + var_36_22 + arg_36_0 then
				var_36_21.localPosition = arg_33_1.var_.shakeOldPos
			end
			...
			local var_36_26 = 1
			local var_36_27 = 1.275

			if 1 < arg_33_1.time_ and arg_33_1.time_ <= var_36_26 + arg_36_0 then
				...
				local var_36_28 = LeanTween.value(arg_33_1.dialog_, 0, 1, 0.3)

				var_36_28:setOnUpdate(LuaHelper.FloatAction(function(arg_37_0)
					arg_33_1.dialogCg_.alpha = arg_37_0
				end))
				var_36_28:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_33_1.dialog_)
					var_36_28:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_36_29 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(321102008).content)

				arg_33_1.text_.text = var_36_29

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_31 = 51 <= 0 and var_36_27 or var_36_27 * (utf8.len(var_36_29) / 51)

				if (51 <= 0 and var_36_27 or var_36_27 * (utf8.len(var_36_29) / 51)) > 0 and var_36_27 < var_36_31 then
					arg_33_1.talkMaxDuration = var_36_31
					var_36_26 = var_36_26 + 0.3

					if var_36_31 + var_36_26 > arg_33_1.duration_ then
						arg_33_1.duration_ = var_36_31 + var_36_26
					end
				end
			...
			local var_36_32 = var_36_26 + 0.3
			local var_36_33 = math.max(var_36_27, arg_33_1.talkMaxDuration)

			if var_36_26 + 0.3 <= arg_33_1.time_ and arg_33_1.time_ < var_36_32 + var_36_33 then
