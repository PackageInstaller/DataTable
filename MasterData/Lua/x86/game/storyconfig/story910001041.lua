return {
	Play910004001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_8 = "1039ui_story"

			if arg_1_1.actors_["1039ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1039ui_story"))) then
				local var_4_9 = Object.Instantiate(Asset.Load("Char/" .. "1039ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_12 = arg_1_1.actors_["1039ui_story"].transform

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1.var_.moveOldPos1039ui_story = var_4_12.localPosition
			end

			local var_4_13 = 0.001

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_13 then
				var_4_12.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1039ui_story, Vector3.New(0, -1.01, -5.9), (arg_1_1.time_ - 1.8) / var_4_13)
			...
			if arg_1_1.time_ >= 1.8 + var_4_13 and arg_1_1.time_ < 1.8 + var_4_13 + arg_4_0 then
				var_4_12.localPosition = Vector3.New(0, -1.01, -5.9)
				var_4_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_12.position).x, (manager.ui.mainCamera.transform.position - var_4_12.position).y, (manager.ui.mainCamera.transform.position - var_4_12.position).z)
				var_4_12.localEulerAngles.z = 0
				var_4_12.localEulerAngles.x = 0
				var_4_12.localEulerAngles = var_4_12.localEulerAngles
			...
			local var_4_14 = arg_1_1.actors_["1039ui_story"]

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.characterEffect1039ui_story == nil then
				arg_1_1.var_.characterEffect1039ui_story = var_4_14:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_15 = 0.2

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_15 and not isNil(var_4_14) then
				if arg_1_1.var_.characterEffect1039ui_story and not isNil(var_4_14) then
					arg_1_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 1.8 + var_4_15 and arg_1_1.time_ < 1.8 + var_4_15 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.characterEffect1039ui_story then
				arg_1_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_17 + arg_4_0 then
				...
				local var_4_20 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910004001).content)
	...
	Play910004002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				...
				local var_10_3 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910004002).content)
	...
	Play910004003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_2 + arg_14_0 then
				...
				local var_14_4 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910004003).content)
	...
	Play910004004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 and not isNil(arg_15_1.actors_["1039ui_story"]) and arg_15_1.var_.characterEffect1039ui_story == nil then
				arg_15_1.var_.characterEffect1039ui_story = arg_15_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_18_0 = 0.2

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_0 and not isNil(arg_15_1.actors_["1039ui_story"]) then
				if arg_15_1.var_.characterEffect1039ui_story and not isNil(arg_15_1.actors_["1039ui_story"]) then
					arg_15_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_15_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_15_1.time_ - 0) / var_18_0)
				end
			end

			if arg_15_1.time_ >= 0 + var_18_0 and arg_15_1.time_ < 0 + var_18_0 + arg_18_0 and not isNil(arg_15_1.actors_["1039ui_story"]) and arg_15_1.var_.characterEffect1039ui_story then
				arg_15_1.var_.characterEffect1039ui_story.fillFlat = true
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 then
				...
				local var_18_3 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910004004).content)

				arg_15_1.text_.text = var_18_3

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_5 = 8 <= 0 and var_18_2 or var_18_2 * (utf8.len(var_18_3) / 8)

				if (8 <= 0 and var_18_2 or var_18_2 * (utf8.len(var_18_3) / 8)) > 0 and var_18_2 < var_18_5 then
	...
	Play910004005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 and not isNil(var_22_0) and arg_19_1.var_.characterEffect1039ui_story == nil then
			...
			if arg_19_1.time_ >= 0 + var_22_1 and arg_19_1.time_ < 0 + var_22_1 + arg_22_0 and not isNil(var_22_0) and arg_19_1.var_.characterEffect1039ui_story then
				arg_19_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_3 + arg_22_0 then
				...
				local var_22_5 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910004005).content)

				arg_19_1.text_.text = var_22_5

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_7 = 12 <= 0 and var_22_4 or var_22_4 * (utf8.len(var_22_5) / 12)

				if (12 <= 0 and var_22_4 or var_22_4 * (utf8.len(var_22_5) / 12)) > 0 and var_22_4 < var_22_7 then
	...
	Play910004006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				...
				local var_26_3 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910004006).content)

				arg_23_1.text_.text = var_26_3

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_5 = 24 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 24)

				if (24 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 24)) > 0 and var_26_2 < var_26_5 then
	...
	Play910004007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 and not isNil(arg_27_1.actors_["1039ui_story"]) and arg_27_1.var_.characterEffect1039ui_story == nil then
				arg_27_1.var_.characterEffect1039ui_story = arg_27_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_30_0 = 0.2

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_0 and not isNil(arg_27_1.actors_["1039ui_story"]) then
				if arg_27_1.var_.characterEffect1039ui_story and not isNil(arg_27_1.actors_["1039ui_story"]) then
					arg_27_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_27_1.time_ >= 0 + var_30_0 and arg_27_1.time_ < 0 + var_30_0 + arg_30_0 and not isNil(arg_27_1.actors_["1039ui_story"]) and arg_27_1.var_.characterEffect1039ui_story then
				arg_27_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_2 + arg_30_0 then
				...
				local var_30_4 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910004007).content)

				arg_27_1.text_.text = var_30_4

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_6 = 19 <= 0 and var_30_3 or var_30_3 * (utf8.len(var_30_4) / 19)

				if (19 <= 0 and var_30_3 or var_30_3 * (utf8.len(var_30_4) / 19)) > 0 and var_30_3 < var_30_6 then
	...
	Play910004008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 and not isNil(arg_31_1.actors_["1039ui_story"]) and arg_31_1.var_.characterEffect1039ui_story == nil then
				arg_31_1.var_.characterEffect1039ui_story = arg_31_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_34_0 = 0.2

			if 0 <= arg_31_1.time_ and arg_31_1.time_ < 0 + var_34_0 and not isNil(arg_31_1.actors_["1039ui_story"]) then
				if arg_31_1.var_.characterEffect1039ui_story and not isNil(arg_31_1.actors_["1039ui_story"]) then
					arg_31_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_31_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_31_1.time_ - 0) / var_34_0)
				end
			end

			if arg_31_1.time_ >= 0 + var_34_0 and arg_31_1.time_ < 0 + var_34_0 + arg_34_0 and not isNil(arg_31_1.actors_["1039ui_story"]) and arg_31_1.var_.characterEffect1039ui_story then
				arg_31_1.var_.characterEffect1039ui_story.fillFlat = true
				arg_31_1.var_.characterEffect1039ui_story.fillRatio = 0.5
			end

			local var_34_1 = 0
			local var_34_2 = 0.375
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_1 + arg_34_0 then
				...
				local var_34_3 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910004008).content)

				arg_31_1.text_.text = var_34_3

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_5 = 15 <= 0 and var_34_2 or var_34_2 * (utf8.len(var_34_3) / 15)

				if (15 <= 0 and var_34_2 or var_34_2 * (utf8.len(var_34_3) / 15)) > 0 and var_34_2 < var_34_5 then
	...
	Play910004009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 and not isNil(arg_35_1.actors_["1039ui_story"]) and arg_35_1.var_.characterEffect1039ui_story == nil then
				arg_35_1.var_.characterEffect1039ui_story = arg_35_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_38_0 = 0.2

			if 0 <= arg_35_1.time_ and arg_35_1.time_ < 0 + var_38_0 and not isNil(arg_35_1.actors_["1039ui_story"]) then
				if arg_35_1.var_.characterEffect1039ui_story and not isNil(arg_35_1.actors_["1039ui_story"]) then
					arg_35_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_35_1.time_ >= 0 + var_38_0 and arg_35_1.time_ < 0 + var_38_0 + arg_38_0 and not isNil(arg_35_1.actors_["1039ui_story"]) and arg_35_1.var_.characterEffect1039ui_story then
				arg_35_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_2 + arg_38_0 then
				...
				local var_38_4 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910004009).content)

				arg_35_1.text_.text = var_38_4

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_6 = 18 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 18)

				if (18 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 18)) > 0 and var_38_3 < var_38_6 then
	...
	Play910004010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_1 + arg_42_0 then
				...
				local var_42_3 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910004010).content)
	...
	Play910004011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= 0 + arg_46_0 and not isNil(arg_43_1.actors_["1039ui_story"]) and arg_43_1.var_.characterEffect1039ui_story == nil then
				arg_43_1.var_.characterEffect1039ui_story = arg_43_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_46_0 = 0.2

			if 0 <= arg_43_1.time_ and arg_43_1.time_ < 0 + var_46_0 and not isNil(arg_43_1.actors_["1039ui_story"]) then
				if arg_43_1.var_.characterEffect1039ui_story and not isNil(arg_43_1.actors_["1039ui_story"]) then
					arg_43_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_43_1.time_ >= 0 + var_46_0 and arg_43_1.time_ < 0 + var_46_0 + arg_46_0 and not isNil(arg_43_1.actors_["1039ui_story"]) and arg_43_1.var_.characterEffect1039ui_story then
				arg_43_1.var_.characterEffect1039ui_story.fillFlat = false
			end

			local var_46_2 = 0
			local var_46_3 = 0.075
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_2 + arg_46_0 then
				...
				local var_46_4 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910004011).content)

				arg_43_1.text_.text = var_46_4

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_6 = 3 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 3)

				if (3 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 3)) > 0 and var_46_3 < var_46_6 then
	...
	Play910004012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 and not isNil(arg_47_1.actors_["1039ui_story"]) and arg_47_1.var_.characterEffect1039ui_story == nil then
				arg_47_1.var_.characterEffect1039ui_story = arg_47_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_50_0 = 0.2

			if 0 <= arg_47_1.time_ and arg_47_1.time_ < 0 + var_50_0 and not isNil(arg_47_1.actors_["1039ui_story"]) then
				if arg_47_1.var_.characterEffect1039ui_story and not isNil(arg_47_1.actors_["1039ui_story"]) then
					arg_47_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_47_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_47_1.time_ - 0) / var_50_0)
				end
			end

			if arg_47_1.time_ >= 0 + var_50_0 and arg_47_1.time_ < 0 + var_50_0 + arg_50_0 and not isNil(arg_47_1.actors_["1039ui_story"]) and arg_47_1.var_.characterEffect1039ui_story then
				arg_47_1.var_.characterEffect1039ui_story.fillFlat = true
				arg_47_1.var_.characterEffect1039ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_1 + arg_50_0 then
				...
				local var_50_3 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910004012).content)
	...
	Play910004013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_2 + arg_54_0 then
				...
				local var_54_4 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910004013).content)

				arg_51_1.text_.text = var_54_4

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_6 = 11 <= 0 and var_54_3 or var_54_3 * (utf8.len(var_54_4) / 11)

				if (11 <= 0 and var_54_3 or var_54_3 * (utf8.len(var_54_4) / 11)) > 0 and var_54_3 < var_54_6 then
	...
	Play910004014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineFinish_()
			...
			for iter_56_0, iter_56_1 in ipairs(arg_55_1.choices_) do
				SetActive(iter_56_1.go, iter_56_0 <= 3)
			end
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= 0 + arg_58_0 and not isNil(arg_55_1.actors_["1039ui_story"]) and arg_55_1.var_.characterEffect1039ui_story == nil then
				arg_55_1.var_.characterEffect1039ui_story = arg_55_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_58_0 = 0.2

			if 0 <= arg_55_1.time_ and arg_55_1.time_ < 0 + var_58_0 and not isNil(arg_55_1.actors_["1039ui_story"]) then
				if arg_55_1.var_.characterEffect1039ui_story and not isNil(arg_55_1.actors_["1039ui_story"]) then
					arg_55_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_55_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_55_1.time_ - 0) / var_58_0)
				end
			end

			if arg_55_1.time_ >= 0 + var_58_0 and arg_55_1.time_ < 0 + var_58_0 + arg_58_0 and not isNil(arg_55_1.actors_["1039ui_story"]) and arg_55_1.var_.characterEffect1039ui_story then
				arg_55_1.var_.characterEffect1039ui_story.fillFlat = true
				arg_55_1.var_.characterEffect1039ui_story.fillRatio = 0.5
			end
		end
	...
	Play910004015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_2 + arg_62_0 then
				...
				local var_62_4 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(910004015).content)

				arg_59_1.text_.text = var_62_4

				LuaForUtil.ClearLinePrefixSymbol(arg_59_1.text_)

				local var_62_6 = 11 <= 0 and var_62_3 or var_62_3 * (utf8.len(var_62_4) / 11)

				if (11 <= 0 and var_62_3 or var_62_3 * (utf8.len(var_62_4) / 11)) > 0 and var_62_3 < var_62_6 then
	...
	Play910004016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= 0 + arg_66_0 and not isNil(arg_63_1.actors_["1039ui_story"]) and arg_63_1.var_.characterEffect1039ui_story == nil then
				arg_63_1.var_.characterEffect1039ui_story = arg_63_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_66_0 = 0.2

			if 0 <= arg_63_1.time_ and arg_63_1.time_ < 0 + var_66_0 and not isNil(arg_63_1.actors_["1039ui_story"]) then
				if arg_63_1.var_.characterEffect1039ui_story and not isNil(arg_63_1.actors_["1039ui_story"]) then
					arg_63_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_63_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_63_1.time_ - 0) / var_66_0)
				end
			end

			if arg_63_1.time_ >= 0 + var_66_0 and arg_63_1.time_ < 0 + var_66_0 + arg_66_0 and not isNil(arg_63_1.actors_["1039ui_story"]) and arg_63_1.var_.characterEffect1039ui_story then
				arg_63_1.var_.characterEffect1039ui_story.fillFlat = true
				arg_63_1.var_.characterEffect1039ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= var_66_1 + arg_66_0 then
				...
				local var_66_3 = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(910004016).content)

				arg_63_1.text_.text = var_66_3

				LuaForUtil.ClearLinePrefixSymbol(arg_63_1.text_)

				local var_66_5 = 55 <= 0 and var_66_2 or var_66_2 * (utf8.len(var_66_3) / 55)

				if (55 <= 0 and var_66_2 or var_66_2 * (utf8.len(var_66_3) / 55)) > 0 and var_66_2 < var_66_5 then
	...
	Play910004017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			local var_70_2 = "1039ui_story"

			if arg_67_1.actors_["1039ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1039ui_story"))) then
				local var_70_3 = Object.Instantiate(Asset.Load("Char/" .. "1039ui_story"), arg_67_1.stage_.transform)
			...
			local var_70_6 = "1039ui_story"

			if arg_67_1.actors_["1039ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1039ui_story"))) then
				local var_70_7 = Object.Instantiate(Asset.Load("Char/" .. "1039ui_story"), arg_67_1.stage_.transform)
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_10 + arg_70_0 then
				...
				local var_70_12 = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(910004017).content)

				arg_67_1.text_.text = var_70_12

				LuaForUtil.ClearLinePrefixSymbol(arg_67_1.text_)

				local var_70_14 = 31 <= 0 and var_70_11 or var_70_11 * (utf8.len(var_70_12) / 31)

				if (31 <= 0 and var_70_11 or var_70_11 * (utf8.len(var_70_12) / 31)) > 0 and var_70_11 < var_70_14 then
	...
	Play910004018 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= 0 + arg_74_0 and not isNil(arg_71_1.actors_["1039ui_story"]) and arg_71_1.var_.characterEffect1039ui_story == nil then
				arg_71_1.var_.characterEffect1039ui_story = arg_71_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_74_0 = 0.2

			if 0 <= arg_71_1.time_ and arg_71_1.time_ < 0 + var_74_0 and not isNil(arg_71_1.actors_["1039ui_story"]) then
				if arg_71_1.var_.characterEffect1039ui_story and not isNil(arg_71_1.actors_["1039ui_story"]) then
					arg_71_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_71_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_71_1.time_ - 0) / var_74_0)
				end
			end

			if arg_71_1.time_ >= 0 + var_74_0 and arg_71_1.time_ < 0 + var_74_0 + arg_74_0 and not isNil(arg_71_1.actors_["1039ui_story"]) and arg_71_1.var_.characterEffect1039ui_story then
				arg_71_1.var_.characterEffect1039ui_story.fillFlat = true
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_1 + arg_74_0 then
				...
				local var_74_3 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(910004018).content)

				arg_71_1.text_.text = var_74_3

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_5 = 20 <= 0 and var_74_2 or var_74_2 * (utf8.len(var_74_3) / 20)

				if (20 <= 0 and var_74_2 or var_74_2 * (utf8.len(var_74_3) / 20)) > 0 and var_74_2 < var_74_5 then
	...
	Play910004019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			...
			local var_78_2 = "1039ui_story"

			if arg_75_1.actors_["1039ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1039ui_story"))) then
				local var_78_3 = Object.Instantiate(Asset.Load("Char/" .. "1039ui_story"), arg_75_1.stage_.transform)
			...
			local var_78_6 = "1039ui_story"

			if arg_75_1.actors_["1039ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1039ui_story"))) then
				local var_78_7 = Object.Instantiate(Asset.Load("Char/" .. "1039ui_story"), arg_75_1.stage_.transform)
			...
			if 0 < arg_75_1.time_ and arg_75_1.time_ <= var_78_10 + arg_78_0 then
				...
				local var_78_12 = arg_75_1:FormatText(arg_75_1:GetWordFromCfg(910004019).content)

				arg_75_1.text_.text = var_78_12

				LuaForUtil.ClearLinePrefixSymbol(arg_75_1.text_)

				local var_78_14 = 26 <= 0 and var_78_11 or var_78_11 * (utf8.len(var_78_12) / 26)

				if (26 <= 0 and var_78_11 or var_78_11 * (utf8.len(var_78_12) / 26)) > 0 and var_78_11 < var_78_14 then
