return {
	Play318092001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				local var_4_17 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(318092001).content)
	...
	Play318092002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(318092002).content)
	...
	Play318092003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:GetWordFromCfg(318092003)
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092003", "story_v_out_318092.awb") ~= 0 then
					local var_16_14 = manager.audio:GetVoiceLength("story_v_out_318092", "318092003", "story_v_out_318092.awb") / 1000
					...
					if var_16_10.prefab_name ~= "" and arg_13_1.actors_[var_16_10.prefab_name] ~= nil then
						local var_16_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_10.prefab_name].transform, "story_v_out_318092", "318092003", "story_v_out_318092.awb")

						arg_13_1:RecordAudio("318092003", var_16_15)
						arg_13_1:RecordAudio("318092003", var_16_15)
					else
	...
	Play318092004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_0 + arg_20_0 then
				...
				local var_20_2 = arg_17_1:GetWordFromCfg(318092004)
				...
				local var_20_5 = 8 <= 0 and var_20_1 or var_20_1 * (utf8.len(var_20_3) / 8)

				if (8 <= 0 and var_20_1 or var_20_1 * (utf8.len(var_20_3) / 8)) > 0 and var_20_1 < var_20_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092004", "story_v_out_318092.awb") ~= 0 then
					local var_20_6 = manager.audio:GetVoiceLength("story_v_out_318092", "318092004", "story_v_out_318092.awb") / 1000
					...
					if var_20_2.prefab_name ~= "" and arg_17_1.actors_[var_20_2.prefab_name] ~= nil then
						local var_20_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_2.prefab_name].transform, "story_v_out_318092", "318092004", "story_v_out_318092.awb")

						arg_17_1:RecordAudio("318092004", var_20_7)
						arg_17_1:RecordAudio("318092004", var_20_7)
					else
	...
	Play318092005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_12 + arg_24_0 then
				...
				local var_24_14 = arg_21_1:GetWordFromCfg(318092005)
				...
				local var_24_17 = 24 <= 0 and var_24_13 or var_24_13 * (utf8.len(var_24_15) / 24)

				if (24 <= 0 and var_24_13 or var_24_13 * (utf8.len(var_24_15) / 24)) > 0 and var_24_13 < var_24_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092005", "story_v_out_318092.awb") ~= 0 then
					local var_24_18 = manager.audio:GetVoiceLength("story_v_out_318092", "318092005", "story_v_out_318092.awb") / 1000
					...
					if var_24_14.prefab_name ~= "" and arg_21_1.actors_[var_24_14.prefab_name] ~= nil then
						local var_24_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_14.prefab_name].transform, "story_v_out_318092", "318092005", "story_v_out_318092.awb")

						arg_21_1:RecordAudio("318092005", var_24_19)
						arg_21_1:RecordAudio("318092005", var_24_19)
					else
	...
	Play318092006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_8 + arg_28_0 then
				...
				local var_28_10 = arg_25_1:GetWordFromCfg(318092006)
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092006", "story_v_out_318092.awb") ~= 0 then
					local var_28_14 = manager.audio:GetVoiceLength("story_v_out_318092", "318092006", "story_v_out_318092.awb") / 1000
					...
					if var_28_10.prefab_name ~= "" and arg_25_1.actors_[var_28_10.prefab_name] ~= nil then
						local var_28_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_10.prefab_name].transform, "story_v_out_318092", "318092006", "story_v_out_318092.awb")

						arg_25_1:RecordAudio("318092006", var_28_15)
						arg_25_1:RecordAudio("318092006", var_28_15)
					else
	...
	Play318092007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_0 then
				arg_29_1.actors_["10065ui_story"].transform.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos10065ui_story, Vector3.New(0, 100, 0), (arg_29_1.time_ - 0) / var_32_0)
			...
			if arg_29_1.time_ >= 0 + var_32_0 and arg_29_1.time_ < 0 + var_32_0 + arg_32_0 then
				arg_29_1.actors_["10065ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_29_1.actors_["10065ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_29_1.actors_["10065ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_29_1.actors_["10065ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_29_1.actors_["10065ui_story"].transform.position).z)
				arg_29_1.actors_["10065ui_story"].transform.localEulerAngles.z = 0
				arg_29_1.actors_["10065ui_story"].transform.localEulerAngles.x = 0
				arg_29_1.actors_["10065ui_story"].transform.localEulerAngles = arg_29_1.actors_["10065ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_2 and not isNil(var_32_1) then
				if arg_29_1.var_.characterEffect10065ui_story and not isNil(var_32_1) then
					...
					arg_29_1.var_.characterEffect10065ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_29_1.time_ - 0) / var_32_2)
				end
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_3 + arg_32_0 then
				...
				local var_32_5 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(318092007).content)

				arg_29_1.text_.text = var_32_5

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_7 = 21 <= 0 and var_32_4 or var_32_4 * (utf8.len(var_32_5) / 21)

				if (21 <= 0 and var_32_4 or var_32_4 * (utf8.len(var_32_5) / 21)) > 0 and var_32_4 < var_32_7 then
	...
	Play318092008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(318092008).content)
	...
	Play318092009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_4 + arg_40_0 then
				...
				local var_40_6 = arg_37_1:GetWordFromCfg(318092009)
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092009", "story_v_out_318092.awb") ~= 0 then
					local var_40_10 = manager.audio:GetVoiceLength("story_v_out_318092", "318092009", "story_v_out_318092.awb") / 1000
					...
					if var_40_6.prefab_name ~= "" and arg_37_1.actors_[var_40_6.prefab_name] ~= nil then
						local var_40_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_6.prefab_name].transform, "story_v_out_318092", "318092009", "story_v_out_318092.awb")

						arg_37_1:RecordAudio("318092009", var_40_11)
						arg_37_1:RecordAudio("318092009", var_40_11)
					else
	...
	Play318092010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			local var_44_4 = arg_41_1.actors_["10065ui_story"].transform

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1.var_.moveOldPos10065ui_story = var_44_4.localPosition
			end

			local var_44_5 = 0.001

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_5 then
				var_44_4.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos10065ui_story, Vector3.New(0, 100, 0), (arg_41_1.time_ - 0) / var_44_5)
			...
			local var_44_6 = arg_41_1.actors_["10065ui_story"]

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(var_44_6) and arg_41_1.var_.characterEffect10065ui_story == nil then
				arg_41_1.var_.characterEffect10065ui_story = var_44_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_44_7 = 0.200000002980232

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_7 and not isNil(var_44_6) then
				if arg_41_1.var_.characterEffect10065ui_story and not isNil(var_44_6) then
					arg_41_1.var_.characterEffect10065ui_story.fillFlat = true
					arg_41_1.var_.characterEffect10065ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_41_1.time_ - 0) / var_44_7)
				end
			end

			if arg_41_1.time_ >= 0 + var_44_7 and arg_41_1.time_ < 0 + var_44_7 + arg_44_0 and not isNil(var_44_6) and arg_41_1.var_.characterEffect10065ui_story then
				arg_41_1.var_.characterEffect10065ui_story.fillFlat = true
				arg_41_1.var_.characterEffect10065ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_8 + arg_44_0 then
				...
				local var_44_10 = arg_41_1:GetWordFromCfg(318092010)
				...
				local var_44_13 = 22 <= 0 and var_44_9 or var_44_9 * (utf8.len(var_44_11) / 22)

				if (22 <= 0 and var_44_9 or var_44_9 * (utf8.len(var_44_11) / 22)) > 0 and var_44_9 < var_44_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092010", "story_v_out_318092.awb") ~= 0 then
					local var_44_14 = manager.audio:GetVoiceLength("story_v_out_318092", "318092010", "story_v_out_318092.awb") / 1000
					...
					if var_44_10.prefab_name ~= "" and arg_41_1.actors_[var_44_10.prefab_name] ~= nil then
						local var_44_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_10.prefab_name].transform, "story_v_out_318092", "318092010", "story_v_out_318092.awb")

						arg_41_1:RecordAudio("318092010", var_44_15)
						arg_41_1:RecordAudio("318092010", var_44_15)
					else
	...
	Play318092011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos10065ui_story = arg_45_1.actors_["10065ui_story"].transform.localPosition
			end

			local var_48_0 = 0.001

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_0 then
				arg_45_1.actors_["10065ui_story"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos10065ui_story, Vector3.New(0, -0.81, -6.19), (arg_45_1.time_ - 0) / var_48_0)
				arg_45_1.actors_["10065ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["10065ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["10065ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["10065ui_story"].transform.position).z)
				arg_45_1.actors_["10065ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["10065ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["10065ui_story"].transform.localEulerAngles = arg_45_1.actors_["10065ui_story"].transform.localEulerAngles
			end

			if arg_45_1.time_ >= 0 + var_48_0 and arg_45_1.time_ < 0 + var_48_0 + arg_48_0 then
				arg_45_1.actors_["10065ui_story"].transform.localPosition = Vector3.New(0, -0.81, -6.19)
				arg_45_1.actors_["10065ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["10065ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["10065ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["10065ui_story"].transform.position).z)
				arg_45_1.actors_["10065ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["10065ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["10065ui_story"].transform.localEulerAngles = arg_45_1.actors_["10065ui_story"].transform.localEulerAngles
			...
			local var_48_1 = arg_45_1.actors_["10065ui_story"]

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(var_48_1) and arg_45_1.var_.characterEffect10065ui_story == nil then
				arg_45_1.var_.characterEffect10065ui_story = var_48_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_48_2 = 0.200000002980232

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_2 and not isNil(var_48_1) then
				if arg_45_1.var_.characterEffect10065ui_story and not isNil(var_48_1) then
					arg_45_1.var_.characterEffect10065ui_story.fillFlat = false
				end
			end

			if arg_45_1.time_ >= 0 + var_48_2 and arg_45_1.time_ < 0 + var_48_2 + arg_48_0 and not isNil(var_48_1) and arg_45_1.var_.characterEffect10065ui_story then
				arg_45_1.var_.characterEffect10065ui_story.fillFlat = false
			end
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_8 + arg_48_0 then
				...
				local var_48_10 = arg_45_1:GetWordFromCfg(318092011)
				...
				local var_48_13 = 37 <= 0 and var_48_9 or var_48_9 * (utf8.len(var_48_11) / 37)

				if (37 <= 0 and var_48_9 or var_48_9 * (utf8.len(var_48_11) / 37)) > 0 and var_48_9 < var_48_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092011", "story_v_out_318092.awb") ~= 0 then
					local var_48_14 = manager.audio:GetVoiceLength("story_v_out_318092", "318092011", "story_v_out_318092.awb") / 1000
					...
					if var_48_10.prefab_name ~= "" and arg_45_1.actors_[var_48_10.prefab_name] ~= nil then
						local var_48_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_10.prefab_name].transform, "story_v_out_318092", "318092011", "story_v_out_318092.awb")

						arg_45_1:RecordAudio("318092011", var_48_15)
						arg_45_1:RecordAudio("318092011", var_48_15)
					else
	...
	Play318092012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			local var_52_4 = arg_49_1.actors_["10065ui_story"].transform

			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1.var_.moveOldPos10065ui_story = var_52_4.localPosition
			end

			local var_52_5 = 0.001

			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_5 then
				var_52_4.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos10065ui_story, Vector3.New(0, 100, 0), (arg_49_1.time_ - 0) / var_52_5)
			...
			local var_52_6 = arg_49_1.actors_["10065ui_story"]

			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 and not isNil(var_52_6) and arg_49_1.var_.characterEffect10065ui_story == nil then
				arg_49_1.var_.characterEffect10065ui_story = var_52_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_52_7 = 0.200000002980232

			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_7 and not isNil(var_52_6) then
				if arg_49_1.var_.characterEffect10065ui_story and not isNil(var_52_6) then
					arg_49_1.var_.characterEffect10065ui_story.fillFlat = true
					arg_49_1.var_.characterEffect10065ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_49_1.time_ - 0) / var_52_7)
				end
			end

			if arg_49_1.time_ >= 0 + var_52_7 and arg_49_1.time_ < 0 + var_52_7 + arg_52_0 and not isNil(var_52_6) and arg_49_1.var_.characterEffect10065ui_story then
				arg_49_1.var_.characterEffect10065ui_story.fillFlat = true
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_8 + arg_52_0 then
				...
				local var_52_10 = arg_49_1:GetWordFromCfg(318092012)
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092012", "story_v_out_318092.awb") ~= 0 then
					local var_52_14 = manager.audio:GetVoiceLength("story_v_out_318092", "318092012", "story_v_out_318092.awb") / 1000
					...
					if var_52_10.prefab_name ~= "" and arg_49_1.actors_[var_52_10.prefab_name] ~= nil then
						local var_52_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_10.prefab_name].transform, "story_v_out_318092", "318092012", "story_v_out_318092.awb")

						arg_49_1:RecordAudio("318092012", var_52_15)
						arg_49_1:RecordAudio("318092012", var_52_15)
					else
	...
	Play318092013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_0 then
				arg_53_1.actors_["10065ui_story"].transform.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPos10065ui_story, Vector3.New(0, -0.81, -6.19), (arg_53_1.time_ - 0) / var_56_0)
			...
			if arg_53_1.time_ >= 0 + var_56_0 and arg_53_1.time_ < 0 + var_56_0 + arg_56_0 then
				arg_53_1.actors_["10065ui_story"].transform.localPosition = Vector3.New(0, -0.81, -6.19)
				arg_53_1.actors_["10065ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_53_1.actors_["10065ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_53_1.actors_["10065ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_53_1.actors_["10065ui_story"].transform.position).z)
				arg_53_1.actors_["10065ui_story"].transform.localEulerAngles.z = 0
				arg_53_1.actors_["10065ui_story"].transform.localEulerAngles.x = 0
				arg_53_1.actors_["10065ui_story"].transform.localEulerAngles = arg_53_1.actors_["10065ui_story"].transform.localEulerAngles
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_8 + arg_56_0 then
				...
				local var_56_10 = arg_53_1:GetWordFromCfg(318092013)
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092013", "story_v_out_318092.awb") ~= 0 then
					local var_56_14 = manager.audio:GetVoiceLength("story_v_out_318092", "318092013", "story_v_out_318092.awb") / 1000
					...
					if var_56_10.prefab_name ~= "" and arg_53_1.actors_[var_56_10.prefab_name] ~= nil then
						local var_56_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_10.prefab_name].transform, "story_v_out_318092", "318092013", "story_v_out_318092.awb")

						arg_53_1:RecordAudio("318092013", var_56_15)
						arg_53_1:RecordAudio("318092013", var_56_15)
					else
	...
	Play318092014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_0 then
				arg_57_1.actors_["10065ui_story"].transform.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos10065ui_story, Vector3.New(0, 100, 0), (arg_57_1.time_ - 0) / var_60_0)
			...
			if arg_57_1.time_ >= 0 + var_60_0 and arg_57_1.time_ < 0 + var_60_0 + arg_60_0 then
				arg_57_1.actors_["10065ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_57_1.actors_["10065ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_57_1.actors_["10065ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_57_1.actors_["10065ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_57_1.actors_["10065ui_story"].transform.position).z)
				arg_57_1.actors_["10065ui_story"].transform.localEulerAngles.z = 0
				arg_57_1.actors_["10065ui_story"].transform.localEulerAngles.x = 0
				arg_57_1.actors_["10065ui_story"].transform.localEulerAngles = arg_57_1.actors_["10065ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_2 and not isNil(var_60_1) then
				if arg_57_1.var_.characterEffect10065ui_story and not isNil(var_60_1) then
					...
					arg_57_1.var_.characterEffect10065ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_57_1.time_ - 0) / var_60_2)
				end
			end
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_3 + arg_60_0 then
				...
				local var_60_5 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(318092014).content)

				arg_57_1.text_.text = var_60_5

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_7 = 17 <= 0 and var_60_4 or var_60_4 * (utf8.len(var_60_5) / 17)

				if (17 <= 0 and var_60_4 or var_60_4 * (utf8.len(var_60_5) / 17)) > 0 and var_60_4 < var_60_7 then
	...
	Play318092015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_4 + arg_64_0 then
				...
				local var_64_6 = arg_61_1:GetWordFromCfg(318092015)
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092015", "story_v_out_318092.awb") ~= 0 then
					local var_64_10 = manager.audio:GetVoiceLength("story_v_out_318092", "318092015", "story_v_out_318092.awb") / 1000
					...
					if var_64_6.prefab_name ~= "" and arg_61_1.actors_[var_64_6.prefab_name] ~= nil then
						local var_64_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_61_1.actors_[var_64_6.prefab_name].transform, "story_v_out_318092", "318092015", "story_v_out_318092.awb")

						arg_61_1:RecordAudio("318092015", var_64_11)
						arg_61_1:RecordAudio("318092015", var_64_11)
					else
	...
	Play318092016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			local var_68_4 = arg_65_1.actors_["10065ui_story"].transform

			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				arg_65_1.var_.moveOldPos10065ui_story = var_68_4.localPosition
			end

			local var_68_5 = 0.001

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_5 then
				var_68_4.localPosition = Vector3.Lerp(arg_65_1.var_.moveOldPos10065ui_story, Vector3.New(0, 100, 0), (arg_65_1.time_ - 0) / var_68_5)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_6 + arg_68_0 then
				...
				local var_68_8 = arg_65_1:GetWordFromCfg(318092016)
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092016", "story_v_out_318092.awb") ~= 0 then
					local var_68_12 = manager.audio:GetVoiceLength("story_v_out_318092", "318092016", "story_v_out_318092.awb") / 1000
					...
					if var_68_8.prefab_name ~= "" and arg_65_1.actors_[var_68_8.prefab_name] ~= nil then
						local var_68_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_65_1.actors_[var_68_8.prefab_name].transform, "story_v_out_318092", "318092016", "story_v_out_318092.awb")

						arg_65_1:RecordAudio("318092016", var_68_13)
						arg_65_1:RecordAudio("318092016", var_68_13)
					else
	...
	Play318092017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			if arg_69_1.actors_["1199ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1199ui_story"))) then
				local var_72_0 = Object.Instantiate(Asset.Load("Char/" .. "1199ui_story"), arg_69_1.stage_.transform)

				var_72_0.name = "1199ui_story"
				var_72_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_69_1.actors_["1199ui_story"] = var_72_0
				...
				arg_69_1.var_["1199ui_story" .. "Animator"] = var_72_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_69_1.var_["1199ui_story" .. "Animator"].applyRootMotion = true
				arg_69_1.var_["1199ui_story" .. "LipSync"] = var_72_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_72_3 = arg_69_1.actors_["1199ui_story"].transform

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				arg_69_1.var_.moveOldPos1199ui_story = var_72_3.localPosition
			end

			local var_72_4 = 0.001

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_4 then
				var_72_3.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos1199ui_story, Vector3.New(0, -1.08, -5.9), (arg_69_1.time_ - 0) / var_72_4)
			...
			if arg_69_1.time_ >= 0 + var_72_4 and arg_69_1.time_ < 0 + var_72_4 + arg_72_0 then
				var_72_3.localPosition = Vector3.New(0, -1.08, -5.9)
				var_72_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_72_3.position).x, (manager.ui.mainCamera.transform.position - var_72_3.position).y, (manager.ui.mainCamera.transform.position - var_72_3.position).z)
				var_72_3.localEulerAngles.z = 0
				var_72_3.localEulerAngles.x = 0
				var_72_3.localEulerAngles = var_72_3.localEulerAngles
			...
			local var_72_5 = arg_69_1.actors_["1199ui_story"]

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 and not isNil(var_72_5) and arg_69_1.var_.characterEffect1199ui_story == nil then
				arg_69_1.var_.characterEffect1199ui_story = var_72_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_72_6 = 0.200000002980232

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_6 and not isNil(var_72_5) then
				if arg_69_1.var_.characterEffect1199ui_story and not isNil(var_72_5) then
					arg_69_1.var_.characterEffect1199ui_story.fillFlat = false
				end
			end

			if arg_69_1.time_ >= 0 + var_72_6 and arg_69_1.time_ < 0 + var_72_6 + arg_72_0 and not isNil(var_72_5) and arg_69_1.var_.characterEffect1199ui_story then
				arg_69_1.var_.characterEffect1199ui_story.fillFlat = false
			end
			...
			local var_72_8 = arg_69_1.actors_["1093ui_story"].transform

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				arg_69_1.var_.moveOldPos1093ui_story = var_72_8.localPosition
			end

			local var_72_9 = 0.001

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_9 then
				var_72_8.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos1093ui_story, Vector3.New(0, 100, 0), (arg_69_1.time_ - 0) / var_72_9)
			...
			local var_72_10 = arg_69_1.actors_["1093ui_story"]

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 and not isNil(var_72_10) and arg_69_1.var_.characterEffect1093ui_story == nil then
				arg_69_1.var_.characterEffect1093ui_story = var_72_10:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_72_11 = 0.200000002980232

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_11 and not isNil(var_72_10) then
				if arg_69_1.var_.characterEffect1093ui_story and not isNil(var_72_10) then
					arg_69_1.var_.characterEffect1093ui_story.fillFlat = true
					arg_69_1.var_.characterEffect1093ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_69_1.time_ - 0) / var_72_11)
				end
			end

			if arg_69_1.time_ >= 0 + var_72_11 and arg_69_1.time_ < 0 + var_72_11 + arg_72_0 and not isNil(var_72_10) and arg_69_1.var_.characterEffect1093ui_story then
				arg_69_1.var_.characterEffect1093ui_story.fillFlat = true
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_12 + arg_72_0 then
				...
				local var_72_14 = arg_69_1:GetWordFromCfg(318092017)
				...
				if manager.audio:GetVoiceLength("story_v_out_318092", "318092017", "story_v_out_318092.awb") ~= 0 then
					local var_72_18 = manager.audio:GetVoiceLength("story_v_out_318092", "318092017", "story_v_out_318092.awb") / 1000
					...
					if var_72_14.prefab_name ~= "" and arg_69_1.actors_[var_72_14.prefab_name] ~= nil then
						local var_72_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_69_1.actors_[var_72_14.prefab_name].transform, "story_v_out_318092", "318092017", "story_v_out_318092.awb")

						arg_69_1:RecordAudio("318092017", var_72_19)
						arg_69_1:RecordAudio("318092017", var_72_19)
					else
	...
	Play318092018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_0 then
				arg_73_1.actors_["1199ui_story"].transform.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPos1199ui_story, Vector3.New(0, 100, 0), (arg_73_1.time_ - 0) / var_76_0)
			...
			if arg_73_1.time_ >= 0 + var_76_0 and arg_73_1.time_ < 0 + var_76_0 + arg_76_0 then
				arg_73_1.actors_["1199ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_73_1.actors_["1199ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_73_1.actors_["1199ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["1199ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["1199ui_story"].transform.position).z)
				arg_73_1.actors_["1199ui_story"].transform.localEulerAngles.z = 0
				arg_73_1.actors_["1199ui_story"].transform.localEulerAngles.x = 0
				arg_73_1.actors_["1199ui_story"].transform.localEulerAngles = arg_73_1.actors_["1199ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_2 and not isNil(var_76_1) then
				if arg_73_1.var_.characterEffect1199ui_story and not isNil(var_76_1) then
					...
					arg_73_1.var_.characterEffect1199ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_73_1.time_ - 0) / var_76_2)
				end
			end
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_3 + arg_76_0 then
				...
				local var_76_5 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(318092018).content)

				arg_73_1.text_.text = var_76_5

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_7 = 26 <= 0 and var_76_4 or var_76_4 * (utf8.len(var_76_5) / 26)

				if (26 <= 0 and var_76_4 or var_76_4 * (utf8.len(var_76_5) / 26)) > 0 and var_76_4 < var_76_7 then
	...
	Play318092019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			if arg_77_1.bgs_.STblack == nil then
				local var_80_0 = Object.Instantiate(arg_77_1.paintGo_)

				var_80_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "STblack")
				var_80_0.name = "STblack"
				var_80_0.transform.parent = arg_77_1.stage_.transform
				var_80_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_77_1.bgs_.STblack = var_80_0
			end

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				local var_80_1 = arg_77_1.bgs_.STblack
			...
			if var_80_4 <= arg_77_1.time_ and arg_77_1.time_ < var_80_4 + var_80_5 then
				...
				var_80_6.a = Mathf.Lerp(1, 0, (arg_77_1.time_ - var_80_4) / var_80_5)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				...
				local var_80_10 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_77_1.bgmTxt_.text ~= var_80_10 and arg_77_1.bgmTxt_.text ~= "" then
						if arg_77_1.bgmTxt2_.text ~= "" then
							arg_77_1.bgmTxt_.text = arg_77_1.bgmTxt2_.text
						end

						arg_77_1.bgmTxt2_.text = var_80_10

						arg_77_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_77_1.bgmTxt_.text = var_80_10
						arg_77_1.bgmTxt2_.text = var_80_10
					end
			...
			if 2 < arg_77_1.time_ and arg_77_1.time_ <= var_80_11 + arg_80_0 then
				...
				var_80_13:setOnUpdate(LuaHelper.FloatAction(function(arg_82_0)
				...
				local var_80_14 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(318092019).content)

				arg_77_1.text_.text = var_80_14

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_16 = 13 <= 0 and var_80_12 or var_80_12 * (utf8.len(var_80_14) / 13)

				if (13 <= 0 and var_80_12 or var_80_12 * (utf8.len(var_80_14) / 13)) > 0 and var_80_12 < var_80_16 then
			...
			local var_80_17 = var_80_11 + 0.3
			local var_80_18 = math.max(var_80_12, arg_77_1.talkMaxDuration)

			if var_80_11 + 0.3 <= arg_77_1.time_ and arg_77_1.time_ < var_80_17 + var_80_18 then
