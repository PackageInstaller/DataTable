return {
	...
	Play417041056 = function(arg_230_0, arg_230_1)
		...
		function arg_230_1.onSingleLineUpdate_(arg_233_0)
			...
			if 0 < arg_230_1.time_ and arg_230_1.time_ <= 0 + arg_233_0 then
				...
				local var_233_11 = var_233_8.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_233_6, iter_233_7 in ipairs((var_233_11:ToTable())) do
					iter_233_7.transform.localScale = Vector3.New(iter_233_7.transform.localScale.x / var_233_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_233_11 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_233_7.transform.localScale.y / var_233_10, iter_233_7.transform.localScale.z)
				end
			end
			...
			if 0.2 < arg_230_1.time_ and arg_230_1.time_ <= 0.2 + arg_233_0 then
				local var_233_14 = arg_230_1.var_.effect498

				if not arg_230_1.var_.effect498 then
					var_233_14 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_daoguang01"), manager.ui.mainCamera.transform)
					var_233_14.name = "498"
					arg_230_1.var_.effect498 = var_233_14
				else
					var_233_14.transform:SetParent(var_233_9000)
				end

				var_233_14.transform.localPosition = Vector3.New(0, 0, 0.66)
				var_233_14.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_233_16 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_233_17 = var_233_14.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_233_8, iter_233_9 in ipairs((var_233_17:ToTable())) do
					iter_233_9.transform.localScale = Vector3.New(iter_233_9.transform.localScale.x / var_233_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_233_17 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_233_9.transform.localScale.y / var_233_16, iter_233_9.transform.localScale.z)
				end
			end
			...
			local var_233_20 = 0.766666666666667
			local var_233_21 = 1.575

			if 0.766666666666667 < arg_230_1.time_ and arg_230_1.time_ <= var_233_20 + arg_233_0 then
				...
				local var_233_23 = arg_230_1:FormatText(arg_230_1:GetWordFromCfg(417041056).content)

				arg_230_1.text_.text = var_233_23

				LuaForUtil.ClearLinePrefixSymbol(arg_230_1.text_)

				local var_233_25 = 63 <= 0 and var_233_21 or var_233_21 * (utf8.len(var_233_23) / 63)

				if (63 <= 0 and var_233_21 or var_233_21 * (utf8.len(var_233_23) / 63)) > 0 and var_233_21 < var_233_25 then
					arg_230_1.talkMaxDuration = var_233_25
					var_233_20 = var_233_20 + 0.3

					if var_233_25 + var_233_20 > arg_230_1.duration_ then
						arg_230_1.duration_ = var_233_25 + var_233_20
					end
				end
			...
			local var_233_26 = var_233_20 + 0.3
			local var_233_27 = math.max(var_233_21, arg_230_1.talkMaxDuration)

			if var_233_20 + 0.3 <= arg_230_1.time_ and arg_230_1.time_ < var_233_26 + var_233_27 then
	...
	Play417041067 = function(arg_278_0, arg_278_1)
		...
		function arg_278_1.onSingleLineUpdate_(arg_281_0)
			...
			if 0.166666666666667 < arg_278_1.time_ and arg_278_1.time_ <= 0.166666666666667 + arg_281_0 then
				...
				local var_281_6 = var_281_3.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_281_0, iter_281_1 in ipairs((var_281_6:ToTable())) do
					iter_281_1.transform.localScale = Vector3.New(iter_281_1.transform.localScale.x / var_281_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_281_6 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_281_1.transform.localScale.y / var_281_5, iter_281_1.transform.localScale.z)
				end
			end
			...
			local var_281_9 = 0.8
			local var_281_10 = 1.4

			if 0.8 < arg_278_1.time_ and arg_278_1.time_ <= var_281_9 + arg_281_0 then
				...
				local var_281_11 = LeanTween.value(arg_278_1.dialog_, 0, 1, 0.3)

				var_281_11:setOnUpdate(LuaHelper.FloatAction(function(arg_282_0)
					arg_278_1.dialogCg_.alpha = arg_282_0
				end))
				var_281_11:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_278_1.dialog_)
					var_281_11:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_281_12 = arg_278_1:FormatText(arg_278_1:GetWordFromCfg(417041067).content)

				arg_278_1.text_.text = var_281_12

				LuaForUtil.ClearLinePrefixSymbol(arg_278_1.text_)

				local var_281_14 = 56 <= 0 and var_281_10 or var_281_10 * (utf8.len(var_281_12) / 56)

				if (56 <= 0 and var_281_10 or var_281_10 * (utf8.len(var_281_12) / 56)) > 0 and var_281_10 < var_281_14 then
					arg_278_1.talkMaxDuration = var_281_14
					var_281_9 = var_281_9 + 0.3

					if var_281_14 + var_281_9 > arg_278_1.duration_ then
						arg_278_1.duration_ = var_281_14 + var_281_9
					end
				end
			...
			local var_281_15 = var_281_9 + 0.3
			local var_281_16 = math.max(var_281_10, arg_278_1.talkMaxDuration)

			if var_281_9 + 0.3 <= arg_278_1.time_ and arg_278_1.time_ < var_281_15 + var_281_16 then
				arg_278_1.typewritter.percent = (arg_278_1.time_ - var_281_15) / var_281_16

				arg_278_1.typewritter:SetDirty()
			end

			if arg_278_1.time_ >= var_281_15 + var_281_16 and arg_278_1.time_ < var_281_15 + var_281_16 + arg_281_0 then
	...
	Play417041070 = function(arg_292_0, arg_292_1)
		...
		function arg_292_1.onSingleLineUpdate_(arg_295_0)
			...
			if 0 < arg_292_1.time_ and arg_292_1.time_ <= 0 + arg_295_0 then
				...
				local var_295_5 = var_295_2.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_295_4, iter_295_5 in ipairs((var_295_5:ToTable())) do
					iter_295_5.transform.localScale = Vector3.New(iter_295_5.transform.localScale.x / var_295_4 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_295_5 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_295_5.transform.localScale.y / var_295_4, iter_295_5.transform.localScale.z)
				end
			end
			...
			local var_295_9 = 0.466666666666667
			local var_295_10 = 0.3

			if 0.466666666666667 < arg_292_1.time_ and arg_292_1.time_ <= var_295_9 + arg_295_0 then
				...
				local var_295_11 = LeanTween.value(arg_292_1.dialog_, 0, 1, 0.3)

				var_295_11:setOnUpdate(LuaHelper.FloatAction(function(arg_296_0)
					arg_292_1.dialogCg_.alpha = arg_296_0
				end))
				var_295_11:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_292_1.dialog_)
					var_295_11:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_295_12 = arg_292_1:GetWordFromCfg(417041070)
				...
				local var_295_15 = 12 <= 0 and var_295_10 or var_295_10 * (utf8.len(var_295_13) / 12)

				if (12 <= 0 and var_295_10 or var_295_10 * (utf8.len(var_295_13) / 12)) > 0 and var_295_10 < var_295_15 then
					arg_292_1.talkMaxDuration = var_295_15
					var_295_9 = var_295_9 + 0.3

					if var_295_15 + var_295_9 > arg_292_1.duration_ then
						arg_292_1.duration_ = var_295_15 + var_295_9
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_417041", "417041070", "story_v_out_417041.awb") ~= 0 then
					local var_295_16 = manager.audio:GetVoiceLength("story_v_out_417041", "417041070", "story_v_out_417041.awb") / 1000

					if var_295_16 + var_295_9 > arg_292_1.duration_ then
						arg_292_1.duration_ = var_295_16 + var_295_9
					end

					if var_295_12.prefab_name ~= "" and arg_292_1.actors_[var_295_12.prefab_name] ~= nil then
						local var_295_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_292_1.actors_[var_295_12.prefab_name].transform, "story_v_out_417041", "417041070", "story_v_out_417041.awb")

						arg_292_1:RecordAudio("417041070", var_295_17)
						arg_292_1:RecordAudio("417041070", var_295_17)
					else
			...
			local var_295_18 = var_295_9 + 0.3
			local var_295_19 = math.max(var_295_10, arg_292_1.talkMaxDuration)

			if var_295_9 + 0.3 <= arg_292_1.time_ and arg_292_1.time_ < var_295_18 + var_295_19 then
	...
	Play417041074 = function(arg_319_0, arg_319_1)
		...
		function arg_319_1.onSingleLineUpdate_(arg_322_0)
			...
			if 1 < arg_319_1.time_ and arg_319_1.time_ <= var_322_5 + arg_322_0 then
				...
				local var_322_7 = LeanTween.value(arg_319_1.dialog_, 0, 1, 0.3)

				var_322_7:setOnUpdate(LuaHelper.FloatAction(function(arg_323_0)
					arg_319_1.dialogCg_.alpha = arg_323_0
				end))
				var_322_7:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_319_1.dialog_)
					var_322_7:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_322_8 = arg_319_1:GetWordFromCfg(417041074)
				...
				local var_322_11 = 18 <= 0 and var_322_6 or var_322_6 * (utf8.len(var_322_9) / 18)

				if (18 <= 0 and var_322_6 or var_322_6 * (utf8.len(var_322_9) / 18)) > 0 and var_322_6 < var_322_11 then
					arg_319_1.talkMaxDuration = var_322_11
					var_322_5 = var_322_5 + 0.3
				...
				if manager.audio:GetVoiceLength("story_v_out_417041", "417041074", "story_v_out_417041.awb") ~= 0 then
					local var_322_12 = manager.audio:GetVoiceLength("story_v_out_417041", "417041074", "story_v_out_417041.awb") / 1000
					...
					if var_322_8.prefab_name ~= "" and arg_319_1.actors_[var_322_8.prefab_name] ~= nil then
						local var_322_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_319_1.actors_[var_322_8.prefab_name].transform, "story_v_out_417041", "417041074", "story_v_out_417041.awb")

						arg_319_1:RecordAudio("417041074", var_322_13)
						arg_319_1:RecordAudio("417041074", var_322_13)
					else
			...
			local var_322_14 = var_322_5 + 0.3
			local var_322_15 = math.max(var_322_6, arg_319_1.talkMaxDuration)

			if var_322_5 + 0.3 <= arg_319_1.time_ and arg_319_1.time_ < var_322_14 + var_322_15 then
