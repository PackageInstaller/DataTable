return {
	Play60503001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 60503001
		arg_1_1.duration_ = 5
		...
		function arg_1_1.playNext_(arg_3_0)
			if arg_3_0 == 1 then
				arg_1_0:Play60503002(arg_1_1)
			end
		end

		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.actors_["2440001"] == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.imageGo_, arg_1_1.canvasGo_.transform)

				var_4_0.transform:SetSiblingIndex(1)

				var_4_0.name = "2440001"

				local var_4_1 = var_4_0:GetComponent(typeof(Image))

				var_4_1.sprite = getSpriteWithoutAtlas("TextureConfig/WeaponServant/Portrait/" .. "2440001")

				var_4_1:SetNativeSize()

				var_4_0.transform.localPosition = Vector3.New(0, 100000, 0)
				arg_1_1.actors_["2440001"] = var_4_0
			end

			local var_4_2 = arg_1_1.actors_["2440001"].transform

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				arg_1_1.var_.moveOldPos2440001 = var_4_2.localPosition
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_3 then
				var_4_2.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2440001, Vector3.New(0, -170, -800), (arg_1_1.time_ - 0) / var_4_3)
			end

			if arg_1_1.time_ >= 0 + var_4_3 and arg_1_1.time_ < 0 + var_4_3 + arg_4_0 then
				var_4_2.localPosition = Vector3.New(0, -170, -800)
			end
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[130].name)
				...
				local var_4_7 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60503001).content)

				arg_1_1.text_.text = var_4_7

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_9 = 43 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_7) / 43)

				if (43 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_7) / 43)) > 0 and var_4_5 < var_4_9 then
	...
	Play60503002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 60503002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.playNext_(arg_9_0)
			if arg_9_0 == 1 then
				arg_7_0:Play60503003(arg_7_1)
			end
		end

		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				arg_7_1.var_.moveOldPos2440001 = arg_7_1.actors_["2440001"].transform.localPosition
				arg_7_1.actors_["2440001"].transform.localScale = Vector3.New(1, 1, 1)
			end

			local var_10_0 = 0.001

			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_0 then
				arg_7_1.actors_["2440001"].transform.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos2440001, Vector3.New(10, -2000.17, -3.7), (arg_7_1.time_ - 0) / var_10_0)
			end

			if arg_7_1.time_ >= 0 + var_10_0 and arg_7_1.time_ < 0 + var_10_0 + arg_10_0 then
				arg_7_1.actors_["2440001"].transform.localPosition = Vector3.New(10, -2000.17, -3.7)
			end
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[130].name)
				...
				local var_10_3 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(60503002).content)

				arg_7_1.text_.text = var_10_3

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_5 = 30 <= 0 and var_10_2 or var_10_2 * (utf8.len(var_10_3) / 30)

				if (30 <= 0 and var_10_2 or var_10_2 * (utf8.len(var_10_3) / 30)) > 0 and var_10_2 < var_10_5 then
	...
	Play60503003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 60503003
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(60503003).content)
