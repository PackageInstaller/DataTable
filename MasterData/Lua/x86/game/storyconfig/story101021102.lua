return {
	Play102112001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_4 = "3009ui_story"

			if arg_1_1.actors_["3009ui_story"] == nil and not isNil((Asset.Load("Char/" .. "3009ui_story"))) then
				local var_4_5 = Object.Instantiate(Asset.Load("Char/" .. "3009ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_8 = arg_1_1.actors_["3009ui_story"]

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 and not isNil(var_4_8) and arg_1_1.var_.characterEffect3009ui_story == nil then
				arg_1_1.var_.characterEffect3009ui_story = var_4_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_9 = 0.1

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_9 and not isNil(var_4_8) then
				if arg_1_1.var_.characterEffect3009ui_story and not isNil(var_4_8) then
					arg_1_1.var_.characterEffect3009ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 1.8 + var_4_9 and arg_1_1.time_ < 1.8 + var_4_9 + arg_4_0 and not isNil(var_4_8) and arg_1_1.var_.characterEffect3009ui_story then
				arg_1_1.var_.characterEffect3009ui_story.fillFlat = false
			end
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_13 = arg_1_1.bgs_.B08b
			...
			local var_4_16 = arg_1_1.actors_["3009ui_story"].transform

			if 1.79999995231628 < arg_1_1.time_ and arg_1_1.time_ <= 1.79999995231628 + arg_4_0 then
				arg_1_1.var_.moveOldPos3009ui_story = var_4_16.localPosition

				arg_1_1:ShowWeapon(arg_1_1.var_["3009ui_story" .. "Animator"].transform, true)
			end

			local var_4_17 = 0.001

			if 1.79999995231628 <= arg_1_1.time_ and arg_1_1.time_ < 1.79999995231628 + var_4_17 then
				var_4_16.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos3009ui_story, Vector3.New(-0.7, -1.75, -4.8), (arg_1_1.time_ - 1.79999995231628) / var_4_17)
			...
			if arg_1_1.time_ >= 1.79999995231628 + var_4_17 and arg_1_1.time_ < 1.79999995231628 + var_4_17 + arg_4_0 then
				var_4_16.localPosition = Vector3.New(-0.7, -1.75, -4.8)
				var_4_16.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_16.position).x, (manager.ui.mainCamera.transform.position - var_4_16.position).y, (manager.ui.mainCamera.transform.position - var_4_16.position).z)
				var_4_16.localEulerAngles.z = 0
				var_4_16.localEulerAngles.x = 0
				var_4_16.localEulerAngles = var_4_16.localEulerAngles
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				...
				local var_4_25 = arg_1_1:GetWordFromCfg(102112001)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112001", "story_v_out_102112.awb") ~= 0 then
					local var_4_29 = manager.audio:GetVoiceLength("story_v_out_102112", "102112001", "story_v_out_102112.awb") / 1000
					...
					if var_4_25.prefab_name ~= "" and arg_1_1.actors_[var_4_25.prefab_name] ~= nil then
						local var_4_30 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_25.prefab_name].transform, "story_v_out_102112", "102112001", "story_v_out_102112.awb")

						arg_1_1:RecordAudio("102112001", var_4_30)
						arg_1_1:RecordAudio("102112001", var_4_30)
					else
	...
	Play102112002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			local var_11_8 = arg_8_1.actors_["3008ui_story"].transform

			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 then
				arg_8_1.var_.moveOldPos3008ui_story = var_11_8.localPosition
			end

			local var_11_9 = 0.001

			if 0 <= arg_8_1.time_ and arg_8_1.time_ < 0 + var_11_9 then
				var_11_8.localPosition = Vector3.Lerp(arg_8_1.var_.moveOldPos3008ui_story, Vector3.New(0.7, -1.51, -4.3), (arg_8_1.time_ - 0) / var_11_9)
			...
			if arg_8_1.time_ >= 0 + var_11_9 and arg_8_1.time_ < 0 + var_11_9 + arg_11_0 then
				var_11_8.localPosition = Vector3.New(0.7, -1.51, -4.3)
				var_11_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_11_8.position).x, (manager.ui.mainCamera.transform.position - var_11_8.position).y, (manager.ui.mainCamera.transform.position - var_11_8.position).z)
				var_11_8.localEulerAngles.z = 0
				var_11_8.localEulerAngles.x = 0
				var_11_8.localEulerAngles = var_11_8.localEulerAngles
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_10 + arg_11_0 then
				...
				local var_11_12 = arg_8_1:GetWordFromCfg(102112002)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112002", "story_v_out_102112.awb") ~= 0 then
					local var_11_16 = manager.audio:GetVoiceLength("story_v_out_102112", "102112002", "story_v_out_102112.awb") / 1000
					...
					if var_11_12.prefab_name ~= "" and arg_8_1.actors_[var_11_12.prefab_name] ~= nil then
						local var_11_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_12.prefab_name].transform, "story_v_out_102112", "102112002", "story_v_out_102112.awb")

						arg_8_1:RecordAudio("102112002", var_11_17)
						arg_8_1:RecordAudio("102112002", var_11_17)
					else
	...
	Play102112003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0 <= arg_12_1.time_ and arg_12_1.time_ < 0 + var_15_7 then
				var_15_6.localPosition = Vector3.Lerp(arg_12_1.var_.moveOldPos3008ui_story, Vector3.New(0, 100, 0), (arg_12_1.time_ - 0) / var_15_7)
			...
			local var_15_8 = arg_12_1.actors_["3009ui_story"].transform

			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 then
				arg_12_1.var_.moveOldPos3009ui_story = var_15_8.localPosition
			end

			local var_15_9 = 0.001

			if 0 <= arg_12_1.time_ and arg_12_1.time_ < 0 + var_15_9 then
				var_15_8.localPosition = Vector3.Lerp(arg_12_1.var_.moveOldPos3009ui_story, Vector3.New(0, 100, 0), (arg_12_1.time_ - 0) / var_15_9)
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_12 + arg_15_0 then
				...
				local var_15_14 = arg_12_1:GetWordFromCfg(102112003)
				...
				local var_15_17 = 9 <= 0 and var_15_13 or var_15_13 * (utf8.len(var_15_15) / 9)

				if (9 <= 0 and var_15_13 or var_15_13 * (utf8.len(var_15_15) / 9)) > 0 and var_15_13 < var_15_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112003", "story_v_out_102112.awb") ~= 0 then
					local var_15_18 = manager.audio:GetVoiceLength("story_v_out_102112", "102112003", "story_v_out_102112.awb") / 1000
					...
					if var_15_14.prefab_name ~= "" and arg_12_1.actors_[var_15_14.prefab_name] ~= nil then
						local var_15_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_12_1.actors_[var_15_14.prefab_name].transform, "story_v_out_102112", "102112003", "story_v_out_102112.awb")

						arg_12_1:RecordAudio("102112003", var_15_19)
						arg_12_1:RecordAudio("102112003", var_15_19)
					else
	...
	Play102112004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			local var_19_6 = arg_16_1.actors_["1011ui_story"]

			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 and not isNil(var_19_6) and arg_16_1.var_.characterEffect1011ui_story == nil then
				arg_16_1.var_.characterEffect1011ui_story = var_19_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_19_7 = 0.1

			if 0 <= arg_16_1.time_ and arg_16_1.time_ < 0 + var_19_7 and not isNil(var_19_6) then
				if arg_16_1.var_.characterEffect1011ui_story and not isNil(var_19_6) then
					arg_16_1.var_.characterEffect1011ui_story.fillFlat = true
					arg_16_1.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_16_1.time_ - 0) / var_19_7)
				end
			end

			if arg_16_1.time_ >= 0 + var_19_7 and arg_16_1.time_ < 0 + var_19_7 + arg_19_0 and not isNil(var_19_6) and arg_16_1.var_.characterEffect1011ui_story then
				arg_16_1.var_.characterEffect1011ui_story.fillFlat = true
				arg_16_1.var_.characterEffect1011ui_story.fillRatio = 0.5
			end

			local var_19_8 = arg_16_1.actors_["1019ui_story"].transform

			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 then
				arg_16_1.var_.moveOldPos1019ui_story = var_19_8.localPosition
			end

			local var_19_9 = 0.001

			if 0 <= arg_16_1.time_ and arg_16_1.time_ < 0 + var_19_9 then
				var_19_8.localPosition = Vector3.Lerp(arg_16_1.var_.moveOldPos1019ui_story, Vector3.New(0.7, -1.08, -5.9), (arg_16_1.time_ - 0) / var_19_9)
			...
			if arg_16_1.time_ >= 0 + var_19_9 and arg_16_1.time_ < 0 + var_19_9 + arg_19_0 then
				var_19_8.localPosition = Vector3.New(0.7, -1.08, -5.9)
				var_19_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_19_8.position).x, (manager.ui.mainCamera.transform.position - var_19_8.position).y, (manager.ui.mainCamera.transform.position - var_19_8.position).z)
				var_19_8.localEulerAngles.z = 0
				var_19_8.localEulerAngles.x = 0
				var_19_8.localEulerAngles = var_19_8.localEulerAngles
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_10 + arg_19_0 then
				...
				local var_19_12 = arg_16_1:GetWordFromCfg(102112004)
				...
				local var_19_15 = 20 <= 0 and var_19_11 or var_19_11 * (utf8.len(var_19_13) / 20)

				if (20 <= 0 and var_19_11 or var_19_11 * (utf8.len(var_19_13) / 20)) > 0 and var_19_11 < var_19_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112004", "story_v_out_102112.awb") ~= 0 then
					local var_19_16 = manager.audio:GetVoiceLength("story_v_out_102112", "102112004", "story_v_out_102112.awb") / 1000
					...
					if var_19_12.prefab_name ~= "" and arg_16_1.actors_[var_19_12.prefab_name] ~= nil then
						local var_19_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_12.prefab_name].transform, "story_v_out_102112", "102112004", "story_v_out_102112.awb")

						arg_16_1:RecordAudio("102112004", var_19_17)
						arg_16_1:RecordAudio("102112004", var_19_17)
					else
	...
	Play102112005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 and not isNil(arg_20_1.actors_["3008ui_story"]) and arg_20_1.var_.characterEffect3008ui_story == nil then
				arg_20_1.var_.characterEffect3008ui_story = arg_20_1.actors_["3008ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_23_0 = 0.1

			if 0 <= arg_20_1.time_ and arg_20_1.time_ < 0 + var_23_0 and not isNil(arg_20_1.actors_["3008ui_story"]) then
				if arg_20_1.var_.characterEffect3008ui_story and not isNil(arg_20_1.actors_["3008ui_story"]) then
					arg_20_1.var_.characterEffect3008ui_story.fillFlat = false
				end
			end

			if arg_20_1.time_ >= 0 + var_23_0 and arg_20_1.time_ < 0 + var_23_0 + arg_23_0 and not isNil(arg_20_1.actors_["3008ui_story"]) and arg_20_1.var_.characterEffect3008ui_story then
				arg_20_1.var_.characterEffect3008ui_story.fillFlat = false
			end

			local var_23_2 = arg_20_1.actors_["1019ui_story"].transform

			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 then
				arg_20_1.var_.moveOldPos1019ui_story = var_23_2.localPosition
			end

			local var_23_3 = 0.001

			if 0 <= arg_20_1.time_ and arg_20_1.time_ < 0 + var_23_3 then
				var_23_2.localPosition = Vector3.Lerp(arg_20_1.var_.moveOldPos1019ui_story, Vector3.New(0, 100, 0), (arg_20_1.time_ - 0) / var_23_3)
			...
			if arg_20_1.time_ >= 0 + var_23_3 and arg_20_1.time_ < 0 + var_23_3 + arg_23_0 then
				var_23_2.localPosition = Vector3.New(0, 100, 0)
				var_23_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_23_2.position).x, (manager.ui.mainCamera.transform.position - var_23_2.position).y, (manager.ui.mainCamera.transform.position - var_23_2.position).z)
				var_23_2.localEulerAngles.z = 0
				var_23_2.localEulerAngles.x = 0
				var_23_2.localEulerAngles = var_23_2.localEulerAngles
			...
			if 0 <= arg_20_1.time_ and arg_20_1.time_ < 0 + var_23_5 then
				var_23_4.localPosition = Vector3.Lerp(arg_20_1.var_.moveOldPos1011ui_story, Vector3.New(0, 100, 0), (arg_20_1.time_ - 0) / var_23_5)
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_8 + arg_23_0 then
				...
				local var_23_10 = arg_20_1:GetWordFromCfg(102112005)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112005", "story_v_out_102112.awb") ~= 0 then
					local var_23_14 = manager.audio:GetVoiceLength("story_v_out_102112", "102112005", "story_v_out_102112.awb") / 1000
					...
					if var_23_10.prefab_name ~= "" and arg_20_1.actors_[var_23_10.prefab_name] ~= nil then
						local var_23_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_20_1.actors_[var_23_10.prefab_name].transform, "story_v_out_102112", "102112005", "story_v_out_102112.awb")

						arg_20_1:RecordAudio("102112005", var_23_15)
						arg_20_1:RecordAudio("102112005", var_23_15)
					else
	...
	Play102112006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 and not isNil(arg_24_1.actors_["1011ui_story"]) and arg_24_1.var_.characterEffect1011ui_story == nil then
				arg_24_1.var_.characterEffect1011ui_story = arg_24_1.actors_["1011ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_27_0 = 0.1

			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_0 and not isNil(arg_24_1.actors_["1011ui_story"]) then
				if arg_24_1.var_.characterEffect1011ui_story and not isNil(arg_24_1.actors_["1011ui_story"]) then
					arg_24_1.var_.characterEffect1011ui_story.fillFlat = false
				end
			end

			if arg_24_1.time_ >= 0 + var_27_0 and arg_24_1.time_ < 0 + var_27_0 + arg_27_0 and not isNil(arg_24_1.actors_["1011ui_story"]) and arg_24_1.var_.characterEffect1011ui_story then
				arg_24_1.var_.characterEffect1011ui_story.fillFlat = false
			end

			local var_27_2 = arg_24_1.actors_["3008ui_story"]

			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 and not isNil(var_27_2) and arg_24_1.var_.characterEffect3008ui_story == nil then
				arg_24_1.var_.characterEffect3008ui_story = var_27_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_27_3 = 0.1

			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_3 and not isNil(var_27_2) then
				if arg_24_1.var_.characterEffect3008ui_story and not isNil(var_27_2) then
					arg_24_1.var_.characterEffect3008ui_story.fillFlat = true
					arg_24_1.var_.characterEffect3008ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_24_1.time_ - 0) / var_27_3)
				end
			end

			if arg_24_1.time_ >= 0 + var_27_3 and arg_24_1.time_ < 0 + var_27_3 + arg_27_0 and not isNil(var_27_2) and arg_24_1.var_.characterEffect3008ui_story then
				arg_24_1.var_.characterEffect3008ui_story.fillFlat = true
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_4 + arg_27_0 then
				...
				local var_27_6 = arg_24_1:GetWordFromCfg(102112006)
				...
				local var_27_9 = 12 <= 0 and var_27_5 or var_27_5 * (utf8.len(var_27_7) / 12)

				if (12 <= 0 and var_27_5 or var_27_5 * (utf8.len(var_27_7) / 12)) > 0 and var_27_5 < var_27_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112006", "story_v_out_102112.awb") ~= 0 then
					local var_27_10 = manager.audio:GetVoiceLength("story_v_out_102112", "102112006", "story_v_out_102112.awb") / 1000
					...
					if var_27_6.prefab_name ~= "" and arg_24_1.actors_[var_27_6.prefab_name] ~= nil then
						local var_27_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_24_1.actors_[var_27_6.prefab_name].transform, "story_v_out_102112", "102112006", "story_v_out_102112.awb")

						arg_24_1:RecordAudio("102112006", var_27_11)
						arg_24_1:RecordAudio("102112006", var_27_11)
					else
	...
	Play102112007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			if arg_28_1.actors_["4010ui_story"] == nil and not isNil((Asset.Load("Char/" .. "4010ui_story"))) then
				local var_31_0 = Object.Instantiate(Asset.Load("Char/" .. "4010ui_story"), arg_28_1.stage_.transform)

				var_31_0.name = "4010ui_story"
				var_31_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_28_1.actors_["4010ui_story"] = var_31_0
				...
				arg_28_1.var_["4010ui_story" .. "Animator"] = var_31_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_28_1.var_["4010ui_story" .. "Animator"].applyRootMotion = true
				arg_28_1.var_["4010ui_story" .. "LipSync"] = var_31_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_31_3 = arg_28_1.actors_["4010ui_story"]

			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 and not isNil(var_31_3) and arg_28_1.var_.characterEffect4010ui_story == nil then
				arg_28_1.var_.characterEffect4010ui_story = var_31_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_31_4 = 0.1

			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_4 and not isNil(var_31_3) then
				if arg_28_1.var_.characterEffect4010ui_story and not isNil(var_31_3) then
					arg_28_1.var_.characterEffect4010ui_story.fillFlat = false
				end
			end

			if arg_28_1.time_ >= 0 + var_31_4 and arg_28_1.time_ < 0 + var_31_4 + arg_31_0 and not isNil(var_31_3) and arg_28_1.var_.characterEffect4010ui_story then
				arg_28_1.var_.characterEffect4010ui_story.fillFlat = false
			end

			local var_31_6 = arg_28_1.actors_["3008ui_story"].transform

			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 then
				arg_28_1.var_.moveOldPos3008ui_story = var_31_6.localPosition
			end

			local var_31_7 = 0.001

			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_7 then
				var_31_6.localPosition = Vector3.Lerp(arg_28_1.var_.moveOldPos3008ui_story, Vector3.New(0, 100, 0), (arg_28_1.time_ - 0) / var_31_7)
			...
			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_9 then
				var_31_8.localPosition = Vector3.Lerp(arg_28_1.var_.moveOldPos4010ui_story, Vector3.New(0, -1.59, -5.2), (arg_28_1.time_ - 0) / var_31_9)
			...
			if arg_28_1.time_ >= 0 + var_31_9 and arg_28_1.time_ < 0 + var_31_9 + arg_31_0 then
				var_31_8.localPosition = Vector3.New(0, -1.59, -5.2)
				var_31_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_31_8.position).x, (manager.ui.mainCamera.transform.position - var_31_8.position).y, (manager.ui.mainCamera.transform.position - var_31_8.position).z)
				var_31_8.localEulerAngles.z = 0
				var_31_8.localEulerAngles.x = 0
				var_31_8.localEulerAngles = var_31_8.localEulerAngles
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_10 + arg_31_0 then
				...
				local var_31_12 = arg_28_1:GetWordFromCfg(102112007)
				...
				local var_31_15 = 17 <= 0 and var_31_11 or var_31_11 * (utf8.len(var_31_13) / 17)

				if (17 <= 0 and var_31_11 or var_31_11 * (utf8.len(var_31_13) / 17)) > 0 and var_31_11 < var_31_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112007", "story_v_out_102112.awb") ~= 0 then
					local var_31_16 = manager.audio:GetVoiceLength("story_v_out_102112", "102112007", "story_v_out_102112.awb") / 1000
					...
					if var_31_12.prefab_name ~= "" and arg_28_1.actors_[var_31_12.prefab_name] ~= nil then
						local var_31_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_12.prefab_name].transform, "story_v_out_102112", "102112007", "story_v_out_102112.awb")

						arg_28_1:RecordAudio("102112007", var_31_17)
						arg_28_1:RecordAudio("102112007", var_31_17)
					else
	...
	Play102112008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			local var_35_2 = arg_32_1.actors_["4010ui_story"].transform

			if 0 < arg_32_1.time_ and arg_32_1.time_ <= 0 + arg_35_0 then
				arg_32_1.var_.moveOldPos4010ui_story = var_35_2.localPosition
			end

			local var_35_3 = 0.001

			if 0 <= arg_32_1.time_ and arg_32_1.time_ < 0 + var_35_3 then
				var_35_2.localPosition = Vector3.Lerp(arg_32_1.var_.moveOldPos4010ui_story, Vector3.New(0, 100, 0), (arg_32_1.time_ - 0) / var_35_3)
			...
			if arg_32_1.time_ >= 0 + var_35_3 and arg_32_1.time_ < 0 + var_35_3 + arg_35_0 then
				var_35_2.localPosition = Vector3.New(0, 100, 0)
				var_35_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_35_2.position).x, (manager.ui.mainCamera.transform.position - var_35_2.position).y, (manager.ui.mainCamera.transform.position - var_35_2.position).z)
				var_35_2.localEulerAngles.z = 0
				var_35_2.localEulerAngles.x = 0
				var_35_2.localEulerAngles = var_35_2.localEulerAngles
			...
			if 0 <= arg_32_1.time_ and arg_32_1.time_ < 0 + var_35_5 then
				var_35_4.localPosition = Vector3.Lerp(arg_32_1.var_.moveOldPos3008ui_story, Vector3.New(0, -1.51, -4.3), (arg_32_1.time_ - 0) / var_35_5)
			...
			if arg_32_1.time_ >= 0 + var_35_5 and arg_32_1.time_ < 0 + var_35_5 + arg_35_0 then
				var_35_4.localPosition = Vector3.New(0, -1.51, -4.3)
				var_35_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_35_4.position).x, (manager.ui.mainCamera.transform.position - var_35_4.position).y, (manager.ui.mainCamera.transform.position - var_35_4.position).z)
				var_35_4.localEulerAngles.z = 0
				var_35_4.localEulerAngles.x = 0
				var_35_4.localEulerAngles = var_35_4.localEulerAngles
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_6 + arg_35_0 then
				...
				local var_35_8 = arg_32_1:GetWordFromCfg(102112008)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112008", "story_v_out_102112.awb") ~= 0 then
					local var_35_12 = manager.audio:GetVoiceLength("story_v_out_102112", "102112008", "story_v_out_102112.awb") / 1000
					...
					if var_35_8.prefab_name ~= "" and arg_32_1.actors_[var_35_8.prefab_name] ~= nil then
						local var_35_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_32_1.actors_[var_35_8.prefab_name].transform, "story_v_out_102112", "102112008", "story_v_out_102112.awb")

						arg_32_1:RecordAudio("102112008", var_35_13)
						arg_32_1:RecordAudio("102112008", var_35_13)
					else
	...
	Play102112009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			local var_39_6 = arg_36_1.actors_["3008ui_story"].transform

			if 0 < arg_36_1.time_ and arg_36_1.time_ <= 0 + arg_39_0 then
				arg_36_1.var_.moveOldPos3008ui_story = var_39_6.localPosition
			end

			local var_39_7 = 0.001

			if 0 <= arg_36_1.time_ and arg_36_1.time_ < 0 + var_39_7 then
				var_39_6.localPosition = Vector3.Lerp(arg_36_1.var_.moveOldPos3008ui_story, Vector3.New(0, 100, 0), (arg_36_1.time_ - 0) / var_39_7)
			...
			if 0 <= arg_36_1.time_ and arg_36_1.time_ < 0 + var_39_9 then
				var_39_8.localPosition = Vector3.Lerp(arg_36_1.var_.moveOldPos1084ui_story, Vector3.New(-0.7, -0.97, -6), (arg_36_1.time_ - 0) / var_39_9)
			...
			if arg_36_1.time_ >= 0 + var_39_9 and arg_36_1.time_ < 0 + var_39_9 + arg_39_0 then
				var_39_8.localPosition = Vector3.New(-0.7, -0.97, -6)
				var_39_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_39_8.position).x, (manager.ui.mainCamera.transform.position - var_39_8.position).y, (manager.ui.mainCamera.transform.position - var_39_8.position).z)
				var_39_8.localEulerAngles.z = 0
				var_39_8.localEulerAngles.x = 0
				var_39_8.localEulerAngles = var_39_8.localEulerAngles
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_10 + arg_39_0 then
				...
				local var_39_12 = arg_36_1:GetWordFromCfg(102112009)
				...
				local var_39_15 = 8 <= 0 and var_39_11 or var_39_11 * (utf8.len(var_39_13) / 8)

				if (8 <= 0 and var_39_11 or var_39_11 * (utf8.len(var_39_13) / 8)) > 0 and var_39_11 < var_39_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112009", "story_v_out_102112.awb") ~= 0 then
					local var_39_16 = manager.audio:GetVoiceLength("story_v_out_102112", "102112009", "story_v_out_102112.awb") / 1000
					...
					if var_39_12.prefab_name ~= "" and arg_36_1.actors_[var_39_12.prefab_name] ~= nil then
						local var_39_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_36_1.actors_[var_39_12.prefab_name].transform, "story_v_out_102112", "102112009", "story_v_out_102112.awb")

						arg_36_1:RecordAudio("102112009", var_39_17)
						arg_36_1:RecordAudio("102112009", var_39_17)
					else
	...
	Play102112010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			local var_43_4 = arg_40_1.actors_["1019ui_story"].transform

			if 0 < arg_40_1.time_ and arg_40_1.time_ <= 0 + arg_43_0 then
				arg_40_1.var_.moveOldPos1019ui_story = var_43_4.localPosition
			end

			local var_43_5 = 0.001

			if 0 <= arg_40_1.time_ and arg_40_1.time_ < 0 + var_43_5 then
				var_43_4.localPosition = Vector3.Lerp(arg_40_1.var_.moveOldPos1019ui_story, Vector3.New(0.7, -1.08, -5.9), (arg_40_1.time_ - 0) / var_43_5)
			...
			if arg_40_1.time_ >= 0 + var_43_5 and arg_40_1.time_ < 0 + var_43_5 + arg_43_0 then
				var_43_4.localPosition = Vector3.New(0.7, -1.08, -5.9)
				var_43_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_43_4.position).x, (manager.ui.mainCamera.transform.position - var_43_4.position).y, (manager.ui.mainCamera.transform.position - var_43_4.position).z)
				var_43_4.localEulerAngles.z = 0
				var_43_4.localEulerAngles.x = 0
				var_43_4.localEulerAngles = var_43_4.localEulerAngles
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_6 + arg_43_0 then
				...
				local var_43_8 = arg_40_1:GetWordFromCfg(102112010)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112010", "story_v_out_102112.awb") ~= 0 then
					local var_43_12 = manager.audio:GetVoiceLength("story_v_out_102112", "102112010", "story_v_out_102112.awb") / 1000
					...
					if var_43_8.prefab_name ~= "" and arg_40_1.actors_[var_43_8.prefab_name] ~= nil then
						local var_43_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_8.prefab_name].transform, "story_v_out_102112", "102112010", "story_v_out_102112.awb")

						arg_40_1:RecordAudio("102112010", var_43_13)
						arg_40_1:RecordAudio("102112010", var_43_13)
					else
	...
	Play102112011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			local var_47_2 = arg_44_1.actors_["1019ui_story"].transform

			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 then
				arg_44_1.var_.moveOldPos1019ui_story = var_47_2.localPosition
			end

			local var_47_3 = 0.001

			if 0 <= arg_44_1.time_ and arg_44_1.time_ < 0 + var_47_3 then
				var_47_2.localPosition = Vector3.Lerp(arg_44_1.var_.moveOldPos1019ui_story, Vector3.New(0, 100, 0), (arg_44_1.time_ - 0) / var_47_3)
			...
			if arg_44_1.time_ >= 0 + var_47_3 and arg_44_1.time_ < 0 + var_47_3 + arg_47_0 then
				var_47_2.localPosition = Vector3.New(0, 100, 0)
				var_47_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_47_2.position).x, (manager.ui.mainCamera.transform.position - var_47_2.position).y, (manager.ui.mainCamera.transform.position - var_47_2.position).z)
				var_47_2.localEulerAngles.z = 0
				var_47_2.localEulerAngles.x = 0
				var_47_2.localEulerAngles = var_47_2.localEulerAngles
			...
			local var_47_6 = arg_44_1.actors_["3008ui_story"].transform

			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 then
				arg_44_1.var_.moveOldPos3008ui_story = var_47_6.localPosition
			end

			local var_47_7 = 0.001

			if 0 <= arg_44_1.time_ and arg_44_1.time_ < 0 + var_47_7 then
				var_47_6.localPosition = Vector3.Lerp(arg_44_1.var_.moveOldPos3008ui_story, Vector3.New(-0.7, -1.51, -4.3), (arg_44_1.time_ - 0) / var_47_7)
			...
			if arg_44_1.time_ >= 0 + var_47_7 and arg_44_1.time_ < 0 + var_47_7 + arg_47_0 then
				var_47_6.localPosition = Vector3.New(-0.7, -1.51, -4.3)
				var_47_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_47_6.position).x, (manager.ui.mainCamera.transform.position - var_47_6.position).y, (manager.ui.mainCamera.transform.position - var_47_6.position).z)
				var_47_6.localEulerAngles.z = 0
				var_47_6.localEulerAngles.x = 0
				var_47_6.localEulerAngles = var_47_6.localEulerAngles
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= var_47_8 + arg_47_0 then
				...
				local var_47_10 = arg_44_1:GetWordFromCfg(102112011)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112011", "story_v_out_102112.awb") ~= 0 then
					local var_47_14 = manager.audio:GetVoiceLength("story_v_out_102112", "102112011", "story_v_out_102112.awb") / 1000
					...
					if var_47_10.prefab_name ~= "" and arg_44_1.actors_[var_47_10.prefab_name] ~= nil then
						local var_47_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_44_1.actors_[var_47_10.prefab_name].transform, "story_v_out_102112", "102112011", "story_v_out_102112.awb")

						arg_44_1:RecordAudio("102112011", var_47_15)
						arg_44_1:RecordAudio("102112011", var_47_15)
					else
	...
	Play102112012 = function(arg_48_0, arg_48_1)
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if 0 < arg_48_1.time_ and arg_48_1.time_ <= var_51_6 + arg_51_0 then
				...
				local var_51_8 = arg_48_1:GetWordFromCfg(102112012)
				...
				local var_51_11 = 42 <= 0 and var_51_7 or var_51_7 * (utf8.len(var_51_9) / 42)

				if (42 <= 0 and var_51_7 or var_51_7 * (utf8.len(var_51_9) / 42)) > 0 and var_51_7 < var_51_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112012", "story_v_out_102112.awb") ~= 0 then
					local var_51_12 = manager.audio:GetVoiceLength("story_v_out_102112", "102112012", "story_v_out_102112.awb") / 1000
					...
					if var_51_8.prefab_name ~= "" and arg_48_1.actors_[var_51_8.prefab_name] ~= nil then
						local var_51_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_48_1.actors_[var_51_8.prefab_name].transform, "story_v_out_102112", "102112012", "story_v_out_102112.awb")

						arg_48_1:RecordAudio("102112012", var_51_13)
						arg_48_1:RecordAudio("102112012", var_51_13)
					else
	...
	Play102112013 = function(arg_52_0, arg_52_1)
		...
		function arg_52_1.onSingleLineUpdate_(arg_55_0)
			...
			if 0 <= arg_52_1.time_ and arg_52_1.time_ < 0 + var_55_5 then
				var_55_4.localPosition = Vector3.Lerp(arg_52_1.var_.moveOldPos4010ui_story, Vector3.New(0, 100, 0), (arg_52_1.time_ - 0) / var_55_5)
			...
			local var_55_6 = arg_52_1.actors_["1019ui_story"].transform

			if 0 < arg_52_1.time_ and arg_52_1.time_ <= 0 + arg_55_0 then
				arg_52_1.var_.moveOldPos1019ui_story = var_55_6.localPosition
			end

			local var_55_7 = 0.001

			if 0 <= arg_52_1.time_ and arg_52_1.time_ < 0 + var_55_7 then
				var_55_6.localPosition = Vector3.Lerp(arg_52_1.var_.moveOldPos1019ui_story, Vector3.New(-0.2, -1.08, -5.9), (arg_52_1.time_ - 0) / var_55_7)
			...
			if arg_52_1.time_ >= 0 + var_55_7 and arg_52_1.time_ < 0 + var_55_7 + arg_55_0 then
				var_55_6.localPosition = Vector3.New(-0.2, -1.08, -5.9)
				var_55_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_55_6.position).x, (manager.ui.mainCamera.transform.position - var_55_6.position).y, (manager.ui.mainCamera.transform.position - var_55_6.position).z)
				var_55_6.localEulerAngles.z = 0
				var_55_6.localEulerAngles.x = 0
				var_55_6.localEulerAngles = var_55_6.localEulerAngles
			...
			if 0 < arg_52_1.time_ and arg_52_1.time_ <= var_55_10 + arg_55_0 then
				...
				local var_55_12 = arg_52_1:GetWordFromCfg(102112013)
				...
				local var_55_15 = 3 <= 0 and var_55_11 or var_55_11 * (utf8.len(var_55_13) / 3)

				if (3 <= 0 and var_55_11 or var_55_11 * (utf8.len(var_55_13) / 3)) > 0 and var_55_11 < var_55_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112013", "story_v_out_102112.awb") ~= 0 then
					local var_55_16 = manager.audio:GetVoiceLength("story_v_out_102112", "102112013", "story_v_out_102112.awb") / 1000
					...
					if var_55_12.prefab_name ~= "" and arg_52_1.actors_[var_55_12.prefab_name] ~= nil then
						local var_55_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_52_1.actors_[var_55_12.prefab_name].transform, "story_v_out_102112", "102112013", "story_v_out_102112.awb")

						arg_52_1:RecordAudio("102112013", var_55_17)
						arg_52_1:RecordAudio("102112013", var_55_17)
					else
	...
	Play102112014 = function(arg_56_0, arg_56_1)
		...
		function arg_56_1.onSingleLineUpdate_(arg_59_0)
			...
			local var_59_6 = arg_56_1.actors_["4010ui_story"].transform

			if 0 < arg_56_1.time_ and arg_56_1.time_ <= 0 + arg_59_0 then
				arg_56_1.var_.moveOldPos4010ui_story = var_59_6.localPosition
			end

			local var_59_7 = 0.001

			if 0 <= arg_56_1.time_ and arg_56_1.time_ < 0 + var_59_7 then
				var_59_6.localPosition = Vector3.Lerp(arg_56_1.var_.moveOldPos4010ui_story, Vector3.New(0, -1.59, -5.2), (arg_56_1.time_ - 0) / var_59_7)
			...
			if arg_56_1.time_ >= 0 + var_59_7 and arg_56_1.time_ < 0 + var_59_7 + arg_59_0 then
				var_59_6.localPosition = Vector3.New(0, -1.59, -5.2)
				var_59_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_59_6.position).x, (manager.ui.mainCamera.transform.position - var_59_6.position).y, (manager.ui.mainCamera.transform.position - var_59_6.position).z)
				var_59_6.localEulerAngles.z = 0
				var_59_6.localEulerAngles.x = 0
				var_59_6.localEulerAngles = var_59_6.localEulerAngles
			...
			if 0 < arg_56_1.time_ and arg_56_1.time_ <= var_59_8 + arg_59_0 then
				...
				local var_59_10 = arg_56_1:GetWordFromCfg(102112014)
				...
				local var_59_13 = 42 <= 0 and var_59_9 or var_59_9 * (utf8.len(var_59_11) / 42)

				if (42 <= 0 and var_59_9 or var_59_9 * (utf8.len(var_59_11) / 42)) > 0 and var_59_9 < var_59_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112014", "story_v_out_102112.awb") ~= 0 then
					local var_59_14 = manager.audio:GetVoiceLength("story_v_out_102112", "102112014", "story_v_out_102112.awb") / 1000
					...
					if var_59_10.prefab_name ~= "" and arg_56_1.actors_[var_59_10.prefab_name] ~= nil then
						local var_59_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_56_1.actors_[var_59_10.prefab_name].transform, "story_v_out_102112", "102112014", "story_v_out_102112.awb")

						arg_56_1:RecordAudio("102112014", var_59_15)
						arg_56_1:RecordAudio("102112014", var_59_15)
					else
