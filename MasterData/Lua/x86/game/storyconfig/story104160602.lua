	...
	Play416062061 = function(arg_253_0, arg_253_1)
		...
		function arg_253_1.onSingleLineUpdate_(arg_256_0)
			...
			if 0 < arg_253_1.time_ and arg_253_1.time_ <= 0 + arg_256_0 then
				...
				local var_256_11 = var_256_8.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_256_7, iter_256_8 in ipairs((var_256_11:ToTable())) do
					iter_256_8.transform.localScale = Vector3.New(iter_256_8.transform.localScale.x / var_256_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_256_11 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_256_8.transform.localScale.y / var_256_10, iter_256_8.transform.localScale.z)
				end
			end

			local var_256_13 = 0

			if 0 < arg_253_1.time_ and arg_253_1.time_ <= var_256_13 + arg_256_0 then
				arg_253_1.allBtn_.enabled = false
			end

			if arg_253_1.time_ >= var_256_13 + 0.3 and arg_253_1.time_ < var_256_13 + 0.3 + arg_256_0 then
				arg_253_1.allBtn_.enabled = true
			end

			if 0 < arg_253_1.time_ and arg_253_1.time_ <= 0 + arg_256_0 then
				local var_256_14 = arg_253_1.actors_["10109"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_256_14 then
					arg_253_1.var_.alphaOldValue10109 = var_256_14.alpha
					arg_253_1.var_.characterEffect10109 = var_256_14
				end

				arg_253_1.var_.alphaOldValue10109 = 0
			end

			local var_256_15 = 0.857666666666667

			if 0 <= arg_253_1.time_ and arg_253_1.time_ < 0 + var_256_15 then
				if arg_253_1.var_.characterEffect10109 then
					arg_253_1.var_.characterEffect10109.alpha = Mathf.Lerp(arg_253_1.var_.alphaOldValue10109, 1, (arg_253_1.time_ - 0) / var_256_15)
				end
			end

			if arg_253_1.time_ >= 0 + var_256_15 and arg_253_1.time_ < 0 + var_256_15 + arg_256_0 and arg_253_1.var_.characterEffect10109 then
				arg_253_1.var_.characterEffect10109.alpha = 1
			end

			local var_256_16 = 0.433333333333333
			local var_256_17 = 0.625

			if 0.433333333333333 < arg_253_1.time_ and arg_253_1.time_ <= var_256_16 + arg_256_0 then
				...
				local var_256_18 = arg_253_1:GetWordFromCfg(416062061)
				...
				local var_256_21 = 25 <= 0 and var_256_17 or var_256_17 * (utf8.len(var_256_19) / 25)

				if (25 <= 0 and var_256_17 or var_256_17 * (utf8.len(var_256_19) / 25)) > 0 and var_256_17 < var_256_21 then
					arg_253_1.talkMaxDuration = var_256_21

					if var_256_21 + var_256_16 > arg_253_1.duration_ then
						arg_253_1.duration_ = var_256_21 + var_256_16
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_416062", "416062061", "story_v_out_416062.awb") ~= 0 then
					local var_256_22 = manager.audio:GetVoiceLength("story_v_out_416062", "416062061", "story_v_out_416062.awb") / 1000
					...
					if var_256_18.prefab_name ~= "" and arg_253_1.actors_[var_256_18.prefab_name] ~= nil then
						local var_256_23 = LuaForUtil.PlayVoiceWithCriLipsync(arg_253_1.actors_[var_256_18.prefab_name].transform, "story_v_out_416062", "416062061", "story_v_out_416062.awb")

						arg_253_1:RecordAudio("416062061", var_256_23)
						arg_253_1:RecordAudio("416062061", var_256_23)
					else
			...
			local var_256_24 = math.max(var_256_17, arg_253_1.talkMaxDuration)

			if var_256_16 <= arg_253_1.time_ and arg_253_1.time_ < var_256_16 + var_256_24 then
				arg_253_1.typewritter.percent = (arg_253_1.time_ - var_256_16) / var_256_24

				arg_253_1.typewritter:SetDirty()
			end

			if arg_253_1.time_ >= var_256_16 + var_256_24 and arg_253_1.time_ < var_256_16 + var_256_24 + arg_256_0 then
