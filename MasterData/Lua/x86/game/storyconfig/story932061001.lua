return {
	Play932061001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_12 = arg_1_1.actors_["1194"].transform

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				arg_1_1.var_.moveOldPos1194 = var_4_12.localPosition
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_14 then
				var_4_12.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1194, Vector3.New(-60, -360, -240), (arg_1_1.time_ - 0) / var_4_14)
			end

			if arg_1_1.time_ >= 0 + var_4_14 and arg_1_1.time_ < 0 + var_4_14 + arg_4_0 then
				var_4_12.localPosition = Vector3.New(-60, -360, -240)
			end

			local var_4_15 = arg_1_1.actors_["1194"]

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.actorSpriteComps1194 == nil then
				arg_1_1.var_.actorSpriteComps1194 = var_4_15:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_16 and not isNil(var_4_15) then
				if arg_1_1.var_.actorSpriteComps1194 then
					for iter_4_5, iter_4_6 in pairs(arg_1_1.var_.actorSpriteComps1194:ToTable()) do
						if iter_4_6 then
							if arg_1_1.isInRecall_ then
								iter_4_6.color = Color.New(Mathf.Lerp(iter_4_6.color.r, arg_1_1.hightColor2.r, (arg_1_1.time_ - 0) / var_4_16), Mathf.Lerp(iter_4_6.color.g, arg_1_1.hightColor2.g, (arg_1_1.time_ - 0) / var_4_16), (Mathf.Lerp(iter_4_6.color.b, arg_1_1.hightColor2.b, (arg_1_1.time_ - 0) / var_4_16)))
							else
								local var_4_17 = Mathf.Lerp(iter_4_6.color.r, 0.5, (arg_1_1.time_ - 0) / var_4_16)
			...
			if arg_1_1.time_ >= 0 + var_4_16 and arg_1_1.time_ < 0 + var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.actorSpriteComps1194 then
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_25 + arg_4_0 then
				...
				local var_4_28 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(932061001).content)

				arg_1_1.text_.text = var_4_28

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_30 = 35 <= 0 and var_4_26 or var_4_26 * (utf8.len(var_4_28) / 35)

				if (35 <= 0 and var_4_26 or var_4_26 * (utf8.len(var_4_28) / 35)) > 0 and var_4_26 < var_4_30 then
	...
	Play932061002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_5 + arg_12_0 then
				...
				local var_12_7 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(932061002).content)

				arg_9_1.text_.text = var_12_7

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_9 = 25 <= 0 and var_12_6 or var_12_6 * (utf8.len(var_12_7) / 25)

				if (25 <= 0 and var_12_6 or var_12_6 * (utf8.len(var_12_7) / 25)) > 0 and var_12_6 < var_12_9 then
	...
	Play932061003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_4 then
				var_16_2.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1194, Vector3.New(-60, -360, -240), (arg_13_1.time_ - 0) / var_16_4)
			end

			if arg_13_1.time_ >= 0 + var_16_4 and arg_13_1.time_ < 0 + var_16_4 + arg_16_0 then
				var_16_2.localPosition = Vector3.New(-60, -360, -240)
			end

			local var_16_5 = 0
			local var_16_6 = 1.375
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_5 + arg_16_0 then
				...
				arg_13_1.leftNameTxt_.text = arg_13_1:FormatText(StoryNameCfg[177].name)
				...
				local var_16_7 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(932061003).content)

				arg_13_1.text_.text = var_16_7

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_9 = 55 <= 0 and var_16_6 or var_16_6 * (utf8.len(var_16_7) / 55)

				if (55 <= 0 and var_16_6 or var_16_6 * (utf8.len(var_16_7) / 55)) > 0 and var_16_6 < var_16_9 then
	...
	Play932061004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(932061004).content)

				arg_17_1.text_.text = var_20_4

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_6 = 49 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 49)

				if (49 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 49)) > 0 and var_20_3 < var_20_6 then
	...
	Play932061005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_2 + arg_24_0 then
				...
				local var_24_4 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(932061005).content)
	...
	Play932061006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_5 + arg_28_0 then
				...
				local var_28_7 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(932061006).content)
	...
	Play932061007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_2 + arg_32_0 then
				...
				local var_32_4 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(932061007).content)

				arg_29_1.text_.text = var_32_4

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_6 = 24 <= 0 and var_32_3 or var_32_3 * (utf8.len(var_32_4) / 24)

				if (24 <= 0 and var_32_3 or var_32_3 * (utf8.len(var_32_4) / 24)) > 0 and var_32_3 < var_32_6 then
	...
	Play932061008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_5 + arg_36_0 then
				...
				arg_33_1.leftNameTxt_.text = arg_33_1:FormatText(StoryNameCfg[177].name)
				...
				local var_36_7 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(932061008).content)
