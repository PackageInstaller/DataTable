return {
	Play62102001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.bgs_.B06h == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.paintGo_)

				var_4_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "B06h")
				var_4_0.name = "B06h"
				var_4_0.transform.parent = arg_1_1.stage_.transform
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.bgs_.B06h = var_4_0
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_1 = arg_1_1.bgs_.B06h

				arg_1_1.bgs_.B06h.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if arg_1_1.actors_["2030_tpose"] == nil and not isNil((Asset.Load("Char/" .. "2030_tpose"))) then
				local var_4_9 = Object.Instantiate(Asset.Load("Char/" .. "2030_tpose"), arg_1_1.stage_.transform)
			...
			local var_4_12 = arg_1_1.actors_["2030_tpose"].transform

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 then
				arg_1_1.var_.moveOldPos2030_tpose = var_4_12.localPosition
			...
			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_14 then
				var_4_12.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2030_tpose, Vector3.New(0, -1.2, -4.2), (arg_1_1.time_ - 2) / var_4_14)
			...
			if arg_1_1.time_ >= 2 + var_4_14 and arg_1_1.time_ < 2 + var_4_14 + arg_4_0 then
				var_4_12.localPosition = Vector3.New(0, -1.2, -4.2)
				var_4_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_12.position).x, (manager.ui.mainCamera.transform.position - var_4_12.position).y, (manager.ui.mainCamera.transform.position - var_4_12.position).z)
				var_4_12.localEulerAngles.z = 0
				var_4_12.localEulerAngles.x = 0
				var_4_12.localEulerAngles = var_4_12.localEulerAngles
			...
			local var_4_16 = arg_1_1.actors_["2030_tpose"]

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_16) and arg_1_1.var_.characterEffect2030_tpose == nil then
				arg_1_1.var_.characterEffect2030_tpose = var_4_16:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_17 = 0.2

			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_17 and not isNil(var_4_16) then
				if arg_1_1.var_.characterEffect2030_tpose and not isNil(var_4_16) then
					arg_1_1.var_.characterEffect2030_tpose.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 2 + var_4_17 and arg_1_1.time_ < 2 + var_4_17 + arg_4_0 and not isNil(var_4_16) and arg_1_1.var_.characterEffect2030_tpose then
				arg_1_1.var_.characterEffect2030_tpose.fillFlat = false
			end
			...
			if 0.5 < arg_1_1.time_ and arg_1_1.time_ <= 0.5 + arg_4_0 then
				...
				local var_4_24 = manager.audio:GetAudioName("bgm_activity_1_0_1_osiris_ui", "bgm_activity_1_0_1_osiris_ui")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_25 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[34].name)
				...
				local var_4_28 = arg_1_1:GetWordFromCfg(62102001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62102", "62102001", "story_v_chess_62102.awb") ~= 0 then
					local var_4_32 = manager.audio:GetVoiceLength("story_v_chess_62102", "62102001", "story_v_chess_62102.awb") / 1000
					...
					if var_4_28.prefab_name ~= "" and arg_1_1.actors_[var_4_28.prefab_name] ~= nil then
						local var_4_33 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_28.prefab_name].transform, "story_v_chess_62102", "62102001", "story_v_chess_62102.awb")

						arg_1_1:RecordAudio("62102001", var_4_33)
						arg_1_1:RecordAudio("62102001", var_4_33)
					else
	...
	Play62101002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(arg_9_1.actors_["2030_tpose"]) and arg_9_1.var_.characterEffect2030_tpose == nil then
				arg_9_1.var_.characterEffect2030_tpose = arg_9_1.actors_["2030_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_0 = 0.2

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_0 and not isNil(arg_9_1.actors_["2030_tpose"]) then
				if arg_9_1.var_.characterEffect2030_tpose and not isNil(arg_9_1.actors_["2030_tpose"]) then
					arg_9_1.var_.characterEffect2030_tpose.fillFlat = true
					arg_9_1.var_.characterEffect2030_tpose.fillRatio = Mathf.Lerp(0, 0.5, (arg_9_1.time_ - 0) / var_12_0)
				end
			end

			if arg_9_1.time_ >= 0 + var_12_0 and arg_9_1.time_ < 0 + var_12_0 + arg_12_0 and not isNil(arg_9_1.actors_["2030_tpose"]) and arg_9_1.var_.characterEffect2030_tpose then
				arg_9_1.var_.characterEffect2030_tpose.fillFlat = true
				arg_9_1.var_.characterEffect2030_tpose.fillRatio = 0.5
			end
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(62102002).content)

				arg_9_1.text_.text = var_12_3

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_5 = 24 <= 0 and var_12_2 or var_12_2 * (utf8.len(var_12_3) / 24)

				if (24 <= 0 and var_12_2 or var_12_2 * (utf8.len(var_12_3) / 24)) > 0 and var_12_2 < var_12_5 then
	...
	Play62101003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			local var_16_8 = arg_13_1.actors_["2030_tpose"].transform

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos2030_tpose = var_16_8.localPosition

				local var_16_9 = GameObjectTools.GetOrAddComponent(var_16_8.gameObject, typeof(DynamicBoneHelper))
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_10 then
				var_16_8.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos2030_tpose, Vector3.New(0, 100, 0), (arg_13_1.time_ - 0) / var_16_10)
			...
			if arg_13_1.time_ >= 0 + var_16_10 and arg_13_1.time_ < 0 + var_16_10 + arg_16_0 then
				...
				local var_16_11 = GameObjectTools.GetOrAddComponent(var_16_8.gameObject, typeof(DynamicBoneHelper))

				if var_16_11 then
					var_16_11:EnableDynamicBone(true)
				end
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_12 + arg_16_0 then
				...
				local var_16_14 = arg_13_1:GetWordFromCfg(62102003)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62102", "62102003", "story_v_chess_62102.awb") ~= 0 then
					local var_16_18 = manager.audio:GetVoiceLength("story_v_chess_62102", "62102003", "story_v_chess_62102.awb") / 1000
					...
					if var_16_14.prefab_name ~= "" and arg_13_1.actors_[var_16_14.prefab_name] ~= nil then
						local var_16_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_14.prefab_name].transform, "story_v_chess_62102", "62102003", "story_v_chess_62102.awb")

						arg_13_1:RecordAudio("62102003", var_16_19)
						arg_13_1:RecordAudio("62102003", var_16_19)
					else
