	...
	Play1102002049 = function(arg_215_0, arg_215_1)
		...
		function arg_215_1.onSingleLineUpdate_(arg_218_0)
			...
			if 0 < arg_215_1.time_ and arg_215_1.time_ <= 0 + arg_218_0 then
				...
				local var_218_16 = var_218_13.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_218_4, iter_218_5 in ipairs((var_218_16:ToTable())) do
					iter_218_5.transform.localScale = Vector3.New(iter_218_5.transform.localScale.x / var_218_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_218_16 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_218_5.transform.localScale.y / var_218_15, iter_218_5.transform.localScale.z)
				end
			end
			...
			if 1.50066666851441 < arg_215_1.time_ and arg_215_1.time_ <= 1.50066666851441 + arg_218_0 then
				local var_218_19 = arg_215_1.var_.effect213222222123213

				if not arg_215_1.var_.effect213222222123213 then
					var_218_19 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_out"), manager.ui.mainCamera.transform)
					var_218_19.name = "213222222123213"
					arg_215_1.var_.effect213222222123213 = var_218_19
				else
					var_218_19.transform:SetParent(var_218_9000)
				end

				var_218_19.transform.localPosition = Vector3.New(0, 0, 0)
				var_218_19.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_218_21 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_218_22 = var_218_19.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_218_6, iter_218_7 in ipairs((var_218_22:ToTable())) do
					iter_218_7.transform.localScale = Vector3.New(iter_218_7.transform.localScale.x / var_218_21 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_218_22 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_218_7.transform.localScale.y / var_218_21, iter_218_7.transform.localScale.z)
				end
			end
			...
			local var_218_27 = 3.00066666851441
			local var_218_28 = 0.125

			if 3.00066666851441 < arg_215_1.time_ and arg_215_1.time_ <= var_218_27 + arg_218_0 then
				...
				local var_218_30 = arg_215_1:GetWordFromCfg(1102002049)
				...
				local var_218_33 = 5 <= 0 and var_218_28 or var_218_28 * (utf8.len(var_218_31) / 5)

				if (5 <= 0 and var_218_28 or var_218_28 * (utf8.len(var_218_31) / 5)) > 0 and var_218_28 < var_218_33 then
					arg_215_1.talkMaxDuration = var_218_33
					var_218_27 = var_218_27 + 0.3

					if var_218_33 + var_218_27 > arg_215_1.duration_ then
						arg_215_1.duration_ = var_218_33 + var_218_27
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_side_new_1102002", "1102002049", "story_v_side_new_1102002.awb") ~= 0 then
					local var_218_34 = manager.audio:GetVoiceLength("story_v_side_new_1102002", "1102002049", "story_v_side_new_1102002.awb") / 1000

					if var_218_34 + var_218_27 > arg_215_1.duration_ then
						arg_215_1.duration_ = var_218_34 + var_218_27
					end

					if var_218_30.prefab_name ~= "" and arg_215_1.actors_[var_218_30.prefab_name] ~= nil then
						local var_218_35 = LuaForUtil.PlayVoiceWithCriLipsync(arg_215_1.actors_[var_218_30.prefab_name].transform, "story_v_side_new_1102002", "1102002049", "story_v_side_new_1102002.awb")

						arg_215_1:RecordAudio("1102002049", var_218_35)
						arg_215_1:RecordAudio("1102002049", var_218_35)
					else
			...
			if var_218_27 + 0.3 <= arg_215_1.time_ and arg_215_1.time_ < var_218_36 + var_218_37 then
	...
	Play1102002056 = function(arg_245_0, arg_245_1)
		...
		function arg_245_1.onSingleLineUpdate_(arg_248_0)
			...
			if 0 < arg_245_1.time_ and arg_245_1.time_ <= 0 + arg_248_0 then
				...
				local var_248_14 = var_248_11.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_248_4, iter_248_5 in ipairs((var_248_14:ToTable())) do
					iter_248_5.transform.localScale = Vector3.New(iter_248_5.transform.localScale.x / var_248_13 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_248_14 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_248_5.transform.localScale.y / var_248_13, iter_248_5.transform.localScale.z)
				end
			end
			...
			if 1.50066666851441 < arg_245_1.time_ and arg_245_1.time_ <= 1.50066666851441 + arg_248_0 then
				local var_248_17 = arg_245_1.var_.effect213222222123213

				if not arg_245_1.var_.effect213222222123213 then
					var_248_17 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_out"), manager.ui.mainCamera.transform)
					var_248_17.name = "213222222123213"
					arg_245_1.var_.effect213222222123213 = var_248_17
				else
					var_248_17.transform:SetParent(var_248_9000)
				end

				var_248_17.transform.localPosition = Vector3.New(0, 0, 0)
				var_248_17.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_248_19 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_248_20 = var_248_17.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_248_6, iter_248_7 in ipairs((var_248_20:ToTable())) do
					iter_248_7.transform.localScale = Vector3.New(iter_248_7.transform.localScale.x / var_248_19 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_248_20 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_248_7.transform.localScale.y / var_248_19, iter_248_7.transform.localScale.z)
				end
			end

			local var_248_22 = arg_245_1.actors_["1020ui_story"].transform

			if 1.16599999815226 < arg_245_1.time_ and arg_245_1.time_ <= 1.16599999815226 + arg_248_0 then
				arg_245_1.var_.moveOldPos1020ui_story = var_248_22.localPosition
			end

			local var_248_23 = 0.001

			if 1.16599999815226 <= arg_245_1.time_ and arg_245_1.time_ < 1.16599999815226 + var_248_23 then
				var_248_22.localPosition = Vector3.Lerp(arg_245_1.var_.moveOldPos1020ui_story, Vector3.New(0, 100, 0), (arg_245_1.time_ - 1.16599999815226) / var_248_23)
				var_248_22.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_248_22.position).x, (manager.ui.mainCamera.transform.position - var_248_22.position).y, (manager.ui.mainCamera.transform.position - var_248_22.position).z)
				var_248_22.localEulerAngles.z = 0
				var_248_22.localEulerAngles.x = 0
				var_248_22.localEulerAngles = var_248_22.localEulerAngles
			end

			if arg_245_1.time_ >= 1.16599999815226 + var_248_23 and arg_245_1.time_ < 1.16599999815226 + var_248_23 + arg_248_0 then
				var_248_22.localPosition = Vector3.New(0, 100, 0)
				var_248_22.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_248_22.position).x, (manager.ui.mainCamera.transform.position - var_248_22.position).y, (manager.ui.mainCamera.transform.position - var_248_22.position).z)
				var_248_22.localEulerAngles.z = 0
				var_248_22.localEulerAngles.x = 0
				var_248_22.localEulerAngles = var_248_22.localEulerAngles
			...
			local var_248_27 = 2.5
			local var_248_28 = 0.375

			if 2.5 < arg_245_1.time_ and arg_245_1.time_ <= var_248_27 + arg_248_0 then
				...
				local var_248_30 = arg_245_1:GetWordFromCfg(1102002056)
				...
				local var_248_33 = 15 <= 0 and var_248_28 or var_248_28 * (utf8.len(var_248_31) / 15)

				if (15 <= 0 and var_248_28 or var_248_28 * (utf8.len(var_248_31) / 15)) > 0 and var_248_28 < var_248_33 then
					arg_245_1.talkMaxDuration = var_248_33
					var_248_27 = var_248_27 + 0.3

					if var_248_33 + var_248_27 > arg_245_1.duration_ then
						arg_245_1.duration_ = var_248_33 + var_248_27
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_side_new_1102002", "1102002056", "story_v_side_new_1102002.awb") ~= 0 then
					local var_248_34 = manager.audio:GetVoiceLength("story_v_side_new_1102002", "1102002056", "story_v_side_new_1102002.awb") / 1000

					if var_248_34 + var_248_27 > arg_245_1.duration_ then
						arg_245_1.duration_ = var_248_34 + var_248_27
					end

					if var_248_30.prefab_name ~= "" and arg_245_1.actors_[var_248_30.prefab_name] ~= nil then
						local var_248_35 = LuaForUtil.PlayVoiceWithCriLipsync(arg_245_1.actors_[var_248_30.prefab_name].transform, "story_v_side_new_1102002", "1102002056", "story_v_side_new_1102002.awb")

						arg_245_1:RecordAudio("1102002056", var_248_35)
						arg_245_1:RecordAudio("1102002056", var_248_35)
					else
			...
			local var_248_36 = var_248_27 + 0.3
			local var_248_37 = math.max(var_248_28, arg_245_1.talkMaxDuration)

			if var_248_27 + 0.3 <= arg_245_1.time_ and arg_245_1.time_ < var_248_36 + var_248_37 then
	...
	Play1102002061 = function(arg_267_0, arg_267_1)
		...
		function arg_267_1.onSingleLineUpdate_(arg_270_0)
			...
			if 0 < arg_267_1.time_ and arg_267_1.time_ <= 0 + arg_270_0 then
				...
				local var_270_12 = var_270_9.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_270_4, iter_270_5 in ipairs((var_270_12:ToTable())) do
					iter_270_5.transform.localScale = Vector3.New(iter_270_5.transform.localScale.x / var_270_11 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_270_12 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_270_5.transform.localScale.y / var_270_11, iter_270_5.transform.localScale.z)
				end
			end
			...
			if 1.50066666851441 < arg_267_1.time_ and arg_267_1.time_ <= 1.50066666851441 + arg_270_0 then
				local var_270_15 = arg_267_1.var_.effect213222222123213

				if not arg_267_1.var_.effect213222222123213 then
					var_270_15 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_out"), manager.ui.mainCamera.transform)
					var_270_15.name = "213222222123213"
					arg_267_1.var_.effect213222222123213 = var_270_15
				else
					var_270_15.transform:SetParent(var_270_9000)
				end

				var_270_15.transform.localPosition = Vector3.New(0, 0, 0)
				var_270_15.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_270_17 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_270_18 = var_270_15.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_270_6, iter_270_7 in ipairs((var_270_18:ToTable())) do
					iter_270_7.transform.localScale = Vector3.New(iter_270_7.transform.localScale.x / var_270_17 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_270_18 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_270_7.transform.localScale.y / var_270_17, iter_270_7.transform.localScale.z)
				end
			end
			...
			local var_270_20 = 2.72566666851441
			local var_270_21 = 0.775

			if 2.72566666851441 < arg_267_1.time_ and arg_267_1.time_ <= var_270_20 + arg_270_0 then
				...
				local var_270_23 = arg_267_1:FormatText(arg_267_1:GetWordFromCfg(1102002061).content)

				arg_267_1.text_.text = var_270_23

				LuaForUtil.ClearLinePrefixSymbol(arg_267_1.text_)

				local var_270_25 = 31 <= 0 and var_270_21 or var_270_21 * (utf8.len(var_270_23) / 31)

				if (31 <= 0 and var_270_21 or var_270_21 * (utf8.len(var_270_23) / 31)) > 0 and var_270_21 < var_270_25 then
					arg_267_1.talkMaxDuration = var_270_25
					var_270_20 = var_270_20 + 0.3

					if var_270_25 + var_270_20 > arg_267_1.duration_ then
						arg_267_1.duration_ = var_270_25 + var_270_20
					end
				end
			...
			local var_270_26 = var_270_20 + 0.3
			local var_270_27 = math.max(var_270_21, arg_267_1.talkMaxDuration)

			if var_270_20 + 0.3 <= arg_267_1.time_ and arg_267_1.time_ < var_270_26 + var_270_27 then
				arg_267_1.typewritter.percent = (arg_267_1.time_ - var_270_26) / var_270_27
