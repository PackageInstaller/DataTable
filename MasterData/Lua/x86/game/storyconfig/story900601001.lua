	...
	Play900601003 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				arg_1_0.narr_chapter_text.text = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(900601001).content)
				arg_1_0.narr_time_text.text = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(900601002).content)
			...
			if 0.0334 < arg_1_1.time_ and arg_1_1.time_ <= 0.0334 + arg_4_0 then
				...
				arg_1_0.narr_item_content.text = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(900601003).content)
	...
	Play900601004 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_0.narr_item_content.text = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(900601004).content)
	...
	Play900601005 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				arg_11_0.narr_item_content.text = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(900601005).content)
	...
	Play900601006 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				arg_15_0.narr_item_content.text = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(900601006).content)
	...
	Play900601007 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				arg_19_0.narr_item_content.text = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(900601007).content)
	...
	Play900601008 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				...
				arg_23_0.narr_item_content.text = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(900601008).content)
	...
	Play900601009 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				...
				arg_27_0.narr_item_content.text = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(900601009).content)
	...
	Play900601010 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				...
				arg_31_0.narr_item_content.text = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(900601010).content)
	...
	Play900601011 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				...
				arg_35_0.narr_item_content.text = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(900601011).content)
	...
	Play900601012 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 then
				...
				arg_39_0.narr_item_content.text = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(900601012).content)
	...
	Play900601013 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= 0 + arg_46_0 then
				...
				arg_43_0.narr_item_content.text = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(900601013).content)
	...
	Play900601014 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 then
				...
				arg_47_0.narr_item_content.text = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(900601014).content)
	...
	Play900601015 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 then
				...
				arg_51_0.narr_item_content.text = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(900601015).content)
	...
	Play900601016 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= 0 + arg_58_0 then
				...
				arg_55_0.narr_item_content.text = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(900601016).content)
	...
	Play900601017 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= 0 + arg_62_0 then
				...
				arg_59_0.narr_item_content.text = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(900601017).content)
	...
	Play900601018 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= 0 + arg_66_0 then
				...
				arg_63_0.narr_item_content.text = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(900601018).content)
	...
	Play900601019 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= 0 + arg_70_0 then
				...
				arg_67_0.narr_item_content.text = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(900601019).content)
	...
	Play900601020 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= 0 + arg_74_0 then
				...
				arg_71_0.narr_item_content.text = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(900601020).content)
	...
	Play900601021 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			...
			if 0 < arg_75_1.time_ and arg_75_1.time_ <= 0 + arg_78_0 then
				...
				arg_75_0.narr_item_content.text = arg_75_1:FormatText(arg_75_1:GetWordFromCfg(900601021).content)
			...
			local var_78_3 = 0.0334

			if 1 <= arg_75_1.time_ and arg_75_1.time_ < 1 + var_78_3 and arg_75_1.narrativeListGo_.verticalNormalizedPosition >= 0.001 then
				arg_75_1.narrativeListGo_.verticalNormalizedPosition = 0
			end

			if arg_75_1.time_ >= 1 + var_78_3 and arg_75_1.time_ < 1 + var_78_3 + arg_78_0 then
				arg_75_1.narrativeListGo_.movementType = ScrollRect.MovementType.Elastic

				local var_78_4 = arg_75_1.narrativeListGo_:GetComponent(typeof(Image))

				if var_78_4 then
					var_78_4.raycastTarget = true
				end
