	...
	Play322021154 = function(arg_625_0, arg_625_1)
		...
		function arg_625_1.onSingleLineUpdate_(arg_628_0)
			...
			if 0.1 < arg_625_1.time_ and arg_625_1.time_ <= 0.1 + arg_628_0 then
				...
				local var_628_4 = var_628_1.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_628_0, iter_628_1 in ipairs((var_628_4:ToTable())) do
					iter_628_1.transform.localScale = Vector3.New(iter_628_1.transform.localScale.x / var_628_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_628_4 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_628_1.transform.localScale.y / var_628_3, iter_628_1.transform.localScale.z)
				end
			end

			local var_628_6 = 0
			local var_628_7 = 1.075

			if 0 < arg_625_1.time_ and arg_625_1.time_ <= var_628_6 + arg_628_0 then
				...
				local var_628_8 = arg_625_1:FormatText(arg_625_1:GetWordFromCfg(322021154).content)

				arg_625_1.text_.text = var_628_8

				LuaForUtil.ClearLinePrefixSymbol(arg_625_1.text_)

				local var_628_10 = 43 <= 0 and var_628_7 or var_628_7 * (utf8.len(var_628_8) / 43)

				if (43 <= 0 and var_628_7 or var_628_7 * (utf8.len(var_628_8) / 43)) > 0 and var_628_7 < var_628_10 then
					arg_625_1.talkMaxDuration = var_628_10

					if var_628_10 + var_628_6 > arg_625_1.duration_ then
						arg_625_1.duration_ = var_628_10 + var_628_6
					end
				end
			...
			local var_628_11 = math.max(var_628_7, arg_625_1.talkMaxDuration)

			if var_628_6 <= arg_625_1.time_ and arg_625_1.time_ < var_628_6 + var_628_11 then
				arg_625_1.typewritter.percent = (arg_625_1.time_ - var_628_6) / var_628_11

				arg_625_1.typewritter:SetDirty()
			end

			if arg_625_1.time_ >= var_628_6 + var_628_11 and arg_625_1.time_ < var_628_6 + var_628_11 + arg_628_0 then
