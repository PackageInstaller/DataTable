	...
	Play322082020 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 1.23333333333333 < arg_85_1.time_ and arg_85_1.time_ <= 1.23333333333333 + arg_88_0 then
				...
				local var_88_9 = var_88_6.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_88_0, iter_88_1 in ipairs((var_88_9:ToTable())) do
					iter_88_1.transform.localScale = Vector3.New(iter_88_1.transform.localScale.x / var_88_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_88_9 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_88_1.transform.localScale.y / var_88_8, iter_88_1.transform.localScale.z)
				end
			end

			local var_88_11 = arg_85_1.bgs_.MS2211.transform

			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				arg_85_1.var_.moveOldPosMS2211 = var_88_11.localPosition
			end

			local var_88_12 = 1

			if 0 <= arg_85_1.time_ and arg_85_1.time_ < 0 + var_88_12 then
				var_88_11.localPosition = Vector3.Lerp(arg_85_1.var_.moveOldPosMS2211, Vector3.New(0, 2.3, 1), (arg_85_1.time_ - 0) / var_88_12)
			end

			if arg_85_1.time_ >= 0 + var_88_12 and arg_85_1.time_ < 0 + var_88_12 + arg_88_0 then
				var_88_11.localPosition = Vector3.New(0, 2.3, 1)
			end
			...
			if 1.5 < arg_85_1.time_ and arg_85_1.time_ <= 1.5 + arg_88_0 then
				local var_88_14 = arg_85_1.var_.effect202011

				if not arg_85_1.var_.effect202011 then
					var_88_14 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit_blue4"), manager.ui.mainCamera.transform)
					var_88_14.name = "202011"
					arg_85_1.var_.effect202011 = var_88_14
				else
					var_88_14.transform:SetParent(var_88_9000)
				end

				var_88_14.transform.localPosition = Vector3.New(-1.41, 0.67, 0)
				var_88_14.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_88_16 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_88_17 = var_88_14.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_88_2, iter_88_3 in ipairs((var_88_17:ToTable())) do
					iter_88_3.transform.localScale = Vector3.New(iter_88_3.transform.localScale.x / var_88_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_88_17 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_88_3.transform.localScale.y / var_88_16, iter_88_3.transform.localScale.z)
				end
			end
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= var_88_19 + arg_88_0 then
				...
				local var_88_21 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(322082020).content)

				arg_85_1.text_.text = var_88_21

				LuaForUtil.ClearLinePrefixSymbol(arg_85_1.text_)

				local var_88_23 = 60 <= 0 and var_88_20 or var_88_20 * (utf8.len(var_88_21) / 60)

				if (60 <= 0 and var_88_20 or var_88_20 * (utf8.len(var_88_21) / 60)) > 0 and var_88_20 < var_88_23 then
					arg_85_1.talkMaxDuration = var_88_23

					if var_88_23 + var_88_19 > arg_85_1.duration_ then
						arg_85_1.duration_ = var_88_23 + var_88_19
					end
				end
			...
			local var_88_24 = math.max(var_88_20, arg_85_1.talkMaxDuration)

			if var_88_19 <= arg_85_1.time_ and arg_85_1.time_ < var_88_19 + var_88_24 then
				arg_85_1.typewritter.percent = (arg_85_1.time_ - var_88_19) / var_88_24

				arg_85_1.typewritter:SetDirty()
			end

			if arg_85_1.time_ >= var_88_19 + var_88_24 and arg_85_1.time_ < var_88_19 + var_88_24 + arg_88_0 then
	...
	Play322082022 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if 0.566666666666667 < arg_93_1.time_ and arg_93_1.time_ <= 0.566666666666667 + arg_96_0 then
				...
				local var_96_4 = var_96_1.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_96_0, iter_96_1 in ipairs((var_96_4:ToTable())) do
					iter_96_1.transform.localScale = Vector3.New(iter_96_1.transform.localScale.x / var_96_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_96_4 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_96_1.transform.localScale.y / var_96_3, iter_96_1.transform.localScale.z)
				end
			end
			...
			if 0.766666666666667 < arg_93_1.time_ and arg_93_1.time_ <= 0.766666666666667 + arg_96_0 then
				local var_96_7 = arg_93_1.var_.effect20221

				if not arg_93_1.var_.effect20221 then
					var_96_7 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_ripple"), manager.ui.mainCamera.transform)
					var_96_7.name = "20221"
					arg_93_1.var_.effect20221 = var_96_7
				else
					var_96_7.transform:SetParent(var_96_9001)
				end

				var_96_7.transform.localPosition = Vector3.New(2.53, 0.65, 5.9)
				var_96_7.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_96_9 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_96_10 = var_96_7.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_96_2, iter_96_3 in ipairs((var_96_10:ToTable())) do
					iter_96_3.transform.localScale = Vector3.New(iter_96_3.transform.localScale.x / var_96_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_96_10 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_96_3.transform.localScale.y / var_96_9, iter_96_3.transform.localScale.z)
				end
			end
			...
			if 0.566666666666667 < arg_93_1.time_ and arg_93_1.time_ <= 0.566666666666667 + arg_96_0 then
				arg_93_1.var_.shakeOldPos = var_96_13.localPosition
			end

			local var_96_14 = 0.133333333333333

			if 0.566666666666667 <= arg_93_1.time_ and arg_93_1.time_ < 0.566666666666667 + var_96_14 then
				local var_96_15, var_96_16 = math.modf((arg_93_1.time_ - 0.566666666666667) / 0.066)

				var_96_13.localPosition = Vector3.New(var_96_16 * 0.13, var_96_16 * 0.13, var_96_16 * 0.13) + arg_93_1.var_.shakeOldPos
			end

			if arg_93_1.time_ >= 0.566666666666667 + var_96_14 and arg_93_1.time_ < 0.566666666666667 + var_96_14 + arg_96_0 then
				var_96_13.localPosition = arg_93_1.var_.shakeOldPos
			end

			local var_96_17 = manager.ui.mainCamera.transform

			if 0.766666666666667 < arg_93_1.time_ and arg_93_1.time_ <= 0.766666666666667 + arg_96_0 then
				arg_93_1.var_.shakeOldPos = var_96_17.localPosition
			end

			local var_96_18 = 0.166666666666667

			if 0.766666666666667 <= arg_93_1.time_ and arg_93_1.time_ < 0.766666666666667 + var_96_18 then
				local var_96_19, var_96_20 = math.modf((arg_93_1.time_ - 0.766666666666667) / 0.066)

				var_96_17.localPosition = Vector3.New(var_96_20 * 0.13, var_96_20 * 0.13, var_96_20 * 0.13) + arg_93_1.var_.shakeOldPos
			end

			if arg_93_1.time_ >= 0.766666666666667 + var_96_18 and arg_93_1.time_ < 0.766666666666667 + var_96_18 + arg_96_0 then
				var_96_17.localPosition = arg_93_1.var_.shakeOldPos
			end
			...
			if 1 <= arg_93_1.time_ and arg_93_1.time_ < 1 + var_96_22 then
				local var_96_23, var_96_24 = math.modf((arg_93_1.time_ - 1) / 0.066)

				var_96_21.localPosition = Vector3.New(var_96_24 * 0.13, var_96_24 * 0.13, var_96_24 * 0.13) + arg_93_1.var_.shakeOldPos
			end

			if arg_93_1.time_ >= 1 + var_96_22 and arg_93_1.time_ < 1 + var_96_22 + arg_96_0 then
				var_96_21.localPosition = arg_93_1.var_.shakeOldPos
			end

			if 1 < arg_93_1.time_ and arg_93_1.time_ <= 1 + arg_96_0 then
				local var_96_25 = arg_93_1.var_.effect20223

				if not arg_93_1.var_.effect20223 then
					var_96_25 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_ripple"), manager.ui.mainCamera.transform)
					var_96_25.name = "20223"
					arg_93_1.var_.effect20223 = var_96_25
				else
					var_96_25.transform:SetParent(var_96_9000)
				end

				var_96_25.transform.localPosition = Vector3.New(-4.46, -0.6, 5.9)
				var_96_25.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_96_27 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_96_28 = var_96_25.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_96_4, iter_96_5 in ipairs((var_96_28:ToTable())) do
					iter_96_5.transform.localScale = Vector3.New(iter_96_5.transform.localScale.x / var_96_27 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_96_28 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_96_5.transform.localScale.y / var_96_27, iter_96_5.transform.localScale.z)
				end
			end
			...
			local var_96_31 = 0
			local var_96_32 = 1.25

			if 0 < arg_93_1.time_ and arg_93_1.time_ <= var_96_31 + arg_96_0 then
				...
				local var_96_33 = arg_93_1:FormatText(arg_93_1:GetWordFromCfg(322082022).content)

				arg_93_1.text_.text = var_96_33

				LuaForUtil.ClearLinePrefixSymbol(arg_93_1.text_)

				local var_96_35 = 50 <= 0 and var_96_32 or var_96_32 * (utf8.len(var_96_33) / 50)

				if (50 <= 0 and var_96_32 or var_96_32 * (utf8.len(var_96_33) / 50)) > 0 and var_96_32 < var_96_35 then
					arg_93_1.talkMaxDuration = var_96_35

					if var_96_35 + var_96_31 > arg_93_1.duration_ then
						arg_93_1.duration_ = var_96_35 + var_96_31
					end
				end
			...
			local var_96_36 = math.max(var_96_32, arg_93_1.talkMaxDuration)

			if var_96_31 <= arg_93_1.time_ and arg_93_1.time_ < var_96_31 + var_96_36 then
				arg_93_1.typewritter.percent = (arg_93_1.time_ - var_96_31) / var_96_36

				arg_93_1.typewritter:SetDirty()
			end

			if arg_93_1.time_ >= var_96_31 + var_96_36 and arg_93_1.time_ < var_96_31 + var_96_36 + arg_96_0 then
