return {
	Play937101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				local var_4_27 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(937101001).content)

				arg_1_1.text_.text = var_4_27

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_29 = 30 <= 0 and var_4_25 or var_4_25 * (utf8.len(var_4_27) / 30)

				if (30 <= 0 and var_4_25 or var_4_25 * (utf8.len(var_4_27) / 30)) > 0 and var_4_25 < var_4_29 then
	...
	Play937101002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(arg_9_1.actors_["1044ui_story"]) and arg_9_1.var_.characterEffect1044ui_story == nil then
				arg_9_1.var_.characterEffect1044ui_story = arg_9_1.actors_["1044ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_0 = 0.200000002980232

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_0 and not isNil(arg_9_1.actors_["1044ui_story"]) then
				if arg_9_1.var_.characterEffect1044ui_story and not isNil(arg_9_1.actors_["1044ui_story"]) then
					arg_9_1.var_.characterEffect1044ui_story.fillFlat = true
					arg_9_1.var_.characterEffect1044ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_9_1.time_ - 0) / var_12_0)
				end
			end

			if arg_9_1.time_ >= 0 + var_12_0 and arg_9_1.time_ < 0 + var_12_0 + arg_12_0 and not isNil(arg_9_1.actors_["1044ui_story"]) and arg_9_1.var_.characterEffect1044ui_story then
				arg_9_1.var_.characterEffect1044ui_story.fillFlat = true
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(937101002).content)
	...
	Play937101003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_0 then
				arg_13_1.actors_["1044ui_story"].transform.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1044ui_story, Vector3.New(0, -1, -5.93), (arg_13_1.time_ - 0) / var_16_0)
			...
			if arg_13_1.time_ >= 0 + var_16_0 and arg_13_1.time_ < 0 + var_16_0 + arg_16_0 then
				arg_13_1.actors_["1044ui_story"].transform.localPosition = Vector3.New(0, -1, -5.93)
				arg_13_1.actors_["1044ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_13_1.actors_["1044ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1044ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1044ui_story"].transform.position).z)
				arg_13_1.actors_["1044ui_story"].transform.localEulerAngles.z = 0
				arg_13_1.actors_["1044ui_story"].transform.localEulerAngles.x = 0
				arg_13_1.actors_["1044ui_story"].transform.localEulerAngles = arg_13_1.actors_["1044ui_story"].transform.localEulerAngles
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_4 + arg_16_0 then
				...
				arg_13_1.leftNameTxt_.text = arg_13_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_16_6 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(937101003).content)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_0 and not isNil(arg_17_1.actors_["1044ui_story"]) then
				if arg_17_1.var_.characterEffect1044ui_story and not isNil(arg_17_1.actors_["1044ui_story"]) then
					...
					arg_17_1.var_.characterEffect1044ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_17_1.time_ - 0) / var_20_0)
				end
			end
			...
			if arg_17_1.time_ >= 0 + var_20_0 and arg_17_1.time_ < 0 + var_20_0 + arg_20_0 and not isNil(arg_17_1.actors_["1044ui_story"]) and arg_17_1.var_.characterEffect1044ui_story then
				arg_17_1.var_.characterEffect1044ui_story.fillFlat = true
				arg_17_1.var_.characterEffect1044ui_story.fillRatio = 0.5
			end
			...
			if arg_17_1.time_ >= var_20_7 + 0.5 and arg_17_1.time_ < var_20_7 + 0.5 + arg_20_0 then
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_8 + arg_20_0 then
				...
				local var_20_10 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(937101004).content)
	...
	Play937101005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos1044ui_story = arg_21_1.actors_["1044ui_story"].transform.localPosition
			end

			local var_24_0 = 0.001

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_0 then
				arg_21_1.actors_["1044ui_story"].transform.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1044ui_story, Vector3.New(0, -1, -5.93), (arg_21_1.time_ - 0) / var_24_0)
				arg_21_1.actors_["1044ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_21_1.actors_["1044ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1044ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1044ui_story"].transform.position).z)
				arg_21_1.actors_["1044ui_story"].transform.localEulerAngles.z = 0
				arg_21_1.actors_["1044ui_story"].transform.localEulerAngles.x = 0
				arg_21_1.actors_["1044ui_story"].transform.localEulerAngles = arg_21_1.actors_["1044ui_story"].transform.localEulerAngles
			end

			if arg_21_1.time_ >= 0 + var_24_0 and arg_21_1.time_ < 0 + var_24_0 + arg_24_0 then
				arg_21_1.actors_["1044ui_story"].transform.localPosition = Vector3.New(0, -1, -5.93)
				arg_21_1.actors_["1044ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_21_1.actors_["1044ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1044ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1044ui_story"].transform.position).z)
				arg_21_1.actors_["1044ui_story"].transform.localEulerAngles.z = 0
				arg_21_1.actors_["1044ui_story"].transform.localEulerAngles.x = 0
				arg_21_1.actors_["1044ui_story"].transform.localEulerAngles = arg_21_1.actors_["1044ui_story"].transform.localEulerAngles
			...
			local var_24_1 = arg_21_1.actors_["1044ui_story"]

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(var_24_1) and arg_21_1.var_.characterEffect1044ui_story == nil then
				arg_21_1.var_.characterEffect1044ui_story = var_24_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_24_2 = 0.200000002980232

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_2 and not isNil(var_24_1) then
				if arg_21_1.var_.characterEffect1044ui_story and not isNil(var_24_1) then
					arg_21_1.var_.characterEffect1044ui_story.fillFlat = false
				end
			end

			if arg_21_1.time_ >= 0 + var_24_2 and arg_21_1.time_ < 0 + var_24_2 + arg_24_0 and not isNil(var_24_1) and arg_21_1.var_.characterEffect1044ui_story then
				arg_21_1.var_.characterEffect1044ui_story.fillFlat = false
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_4 + arg_24_0 then
				...
				arg_21_1.leftNameTxt_.text = arg_21_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_24_6 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(937101005).content)

				arg_21_1.text_.text = var_24_6

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_8 = 43 <= 0 and var_24_5 or var_24_5 * (utf8.len(var_24_6) / 43)

				if (43 <= 0 and var_24_5 or var_24_5 * (utf8.len(var_24_6) / 43)) > 0 and var_24_5 < var_24_8 then
	...
	Play937101006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(arg_25_1.actors_["1044ui_story"]) and arg_25_1.var_.characterEffect1044ui_story == nil then
				arg_25_1.var_.characterEffect1044ui_story = arg_25_1.actors_["1044ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_28_0 = 0.200000002980232

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_0 and not isNil(arg_25_1.actors_["1044ui_story"]) then
				if arg_25_1.var_.characterEffect1044ui_story and not isNil(arg_25_1.actors_["1044ui_story"]) then
					arg_25_1.var_.characterEffect1044ui_story.fillFlat = true
					arg_25_1.var_.characterEffect1044ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_25_1.time_ - 0) / var_28_0)
				end
			end

			if arg_25_1.time_ >= 0 + var_28_0 and arg_25_1.time_ < 0 + var_28_0 + arg_28_0 and not isNil(arg_25_1.actors_["1044ui_story"]) and arg_25_1.var_.characterEffect1044ui_story then
				arg_25_1.var_.characterEffect1044ui_story.fillFlat = true
				arg_25_1.var_.characterEffect1044ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(937101006).content)
	...
	Play937101007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_2 + arg_32_0 then
				...
				local var_32_4 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(937101007).content)

				arg_29_1.text_.text = var_32_4

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_6 = 12 <= 0 and var_32_3 or var_32_3 * (utf8.len(var_32_4) / 12)

				if (12 <= 0 and var_32_3 or var_32_3 * (utf8.len(var_32_4) / 12)) > 0 and var_32_3 < var_32_6 then
	...
	Play937101008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_1 + arg_36_0 then
				...
				local var_36_3 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(937101008).content)
	...
	Play937101009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_4 + arg_40_0 then
				...
				local var_40_6 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(937101009).content)

				arg_37_1.text_.text = var_40_6

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_8 = 24 <= 0 and var_40_5 or var_40_5 * (utf8.len(var_40_6) / 24)

				if (24 <= 0 and var_40_5 or var_40_5 * (utf8.len(var_40_6) / 24)) > 0 and var_40_5 < var_40_8 then
	...
	Play937101010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(937101010).content)

				arg_41_1.text_.text = var_44_3

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_5 = 6 <= 0 and var_44_2 or var_44_2 * (utf8.len(var_44_3) / 6)

				if (6 <= 0 and var_44_2 or var_44_2 * (utf8.len(var_44_3) / 6)) > 0 and var_44_2 < var_44_5 then
	...
	Play937101011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 then
				...
				arg_45_1.leftNameTxt_.text = arg_45_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_48_4 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(937101011).content)

				arg_45_1.text_.text = var_48_4

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_6 = 35 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 35)

				if (35 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 35)) > 0 and var_48_3 < var_48_6 then
	...
	Play937101012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 and not isNil(arg_49_1.actors_["1044ui_story"]) and arg_49_1.var_.characterEffect1044ui_story == nil then
				arg_49_1.var_.characterEffect1044ui_story = arg_49_1.actors_["1044ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_52_0 = 0.200000002980232

			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_0 and not isNil(arg_49_1.actors_["1044ui_story"]) then
				if arg_49_1.var_.characterEffect1044ui_story and not isNil(arg_49_1.actors_["1044ui_story"]) then
					arg_49_1.var_.characterEffect1044ui_story.fillFlat = true
					arg_49_1.var_.characterEffect1044ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_49_1.time_ - 0) / var_52_0)
				end
			end

			if arg_49_1.time_ >= 0 + var_52_0 and arg_49_1.time_ < 0 + var_52_0 + arg_52_0 and not isNil(arg_49_1.actors_["1044ui_story"]) and arg_49_1.var_.characterEffect1044ui_story then
				arg_49_1.var_.characterEffect1044ui_story.fillFlat = true
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(937101012).content)
	...
	Play937101013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_4 + arg_56_0 then
				...
				local var_56_6 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(937101013).content)

				arg_53_1.text_.text = var_56_6

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_8 = 28 <= 0 and var_56_5 or var_56_5 * (utf8.len(var_56_6) / 28)

				if (28 <= 0 and var_56_5 or var_56_5 * (utf8.len(var_56_6) / 28)) > 0 and var_56_5 < var_56_8 then
	...
	Play937101014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_1 + arg_60_0 then
				...
				local var_60_3 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(937101014).content)

				arg_57_1.text_.text = var_60_3

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_5 = 48 <= 0 and var_60_2 or var_60_2 * (utf8.len(var_60_3) / 48)

				if (48 <= 0 and var_60_2 or var_60_2 * (utf8.len(var_60_3) / 48)) > 0 and var_60_2 < var_60_5 then
	...
	Play937101015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_4 + arg_64_0 then
				...
				local var_64_6 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(937101015).content)

				arg_61_1.text_.text = var_64_6

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_8 = 30 <= 0 and var_64_5 or var_64_5 * (utf8.len(var_64_6) / 30)

				if (30 <= 0 and var_64_5 or var_64_5 * (utf8.len(var_64_6) / 30)) > 0 and var_64_5 < var_64_8 then
	...
	Play937101016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_1 + arg_68_0 then
				...
				local var_68_3 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(937101016).content)
	...
	Play937101017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				...
				local var_72_1 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(937101017).content)

				arg_69_1.text_.text = var_72_1

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_3 = 11 <= 0 and var_72_0 or var_72_0 * (utf8.len(var_72_1) / 11)

				if (11 <= 0 and var_72_0 or var_72_0 * (utf8.len(var_72_1) / 11)) > 0 and var_72_0 < var_72_3 then
	...
	Play937101018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_0 then
				arg_73_1.actors_["1044ui_story"].transform.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPos1044ui_story, Vector3.New(0, -1, -5.93), (arg_73_1.time_ - 0) / var_76_0)
			...
			if arg_73_1.time_ >= 0 + var_76_0 and arg_73_1.time_ < 0 + var_76_0 + arg_76_0 then
				arg_73_1.actors_["1044ui_story"].transform.localPosition = Vector3.New(0, -1, -5.93)
				arg_73_1.actors_["1044ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_73_1.actors_["1044ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["1044ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["1044ui_story"].transform.position).z)
				arg_73_1.actors_["1044ui_story"].transform.localEulerAngles.z = 0
				arg_73_1.actors_["1044ui_story"].transform.localEulerAngles.x = 0
				arg_73_1.actors_["1044ui_story"].transform.localEulerAngles = arg_73_1.actors_["1044ui_story"].transform.localEulerAngles
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_4 + arg_76_0 then
				...
				arg_73_1.leftNameTxt_.text = arg_73_1:FormatText(StoryNameCfg[1367].name)
				...
				local var_76_6 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(937101018).content)

				arg_73_1.text_.text = var_76_6

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_8 = 15 <= 0 and var_76_5 or var_76_5 * (utf8.len(var_76_6) / 15)

				if (15 <= 0 and var_76_5 or var_76_5 * (utf8.len(var_76_6) / 15)) > 0 and var_76_5 < var_76_8 then
