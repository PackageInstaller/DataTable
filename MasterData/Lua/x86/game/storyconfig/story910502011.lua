return {
	Play910502001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_9 = 1.974999999999
			local var_4_10 = 0.325

			if 1.974999999999 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[494].name)
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910502001).content)

				arg_1_1.text_.text = var_4_12

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_14 = 13 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 13)

				if (13 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 13)) > 0 and var_4_10 < var_4_14 then
	...
	Play910502002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			local var_10_3 = arg_7_1.actors_["1015ui_story"].transform

			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				arg_7_1.var_.moveOldPos1015ui_story = var_10_3.localPosition
			end

			local var_10_4 = 0.001

			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_4 then
				var_10_3.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos1015ui_story, Vector3.New(0, -1.15, -6.2), (arg_7_1.time_ - 0) / var_10_4)
			...
			if arg_7_1.time_ >= 0 + var_10_4 and arg_7_1.time_ < 0 + var_10_4 + arg_10_0 then
				var_10_3.localPosition = Vector3.New(0, -1.15, -6.2)
				var_10_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_10_3.position).x, (manager.ui.mainCamera.transform.position - var_10_3.position).y, (manager.ui.mainCamera.transform.position - var_10_3.position).z)
				var_10_3.localEulerAngles.z = 0
				var_10_3.localEulerAngles.x = 0
				var_10_3.localEulerAngles = var_10_3.localEulerAngles
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 and not isNil(var_10_5) and arg_7_1.var_.characterEffect1015ui_story == nil then
			...
			if arg_7_1.time_ >= 0 + var_10_6 and arg_7_1.time_ < 0 + var_10_6 + arg_10_0 and not isNil(var_10_5) and arg_7_1.var_.characterEffect1015ui_story then
				arg_7_1.var_.characterEffect1015ui_story.fillFlat = false
			end
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 then
				...
				local var_10_10 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910502002).content)

				arg_7_1.text_.text = var_10_10

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_12 = 44 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 44)

				if (44 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 44)) > 0 and var_10_9 < var_10_12 then
	...
	Play910502003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 and not isNil(arg_11_1.actors_["1015ui_story"]) and arg_11_1.var_.characterEffect1015ui_story == nil then
				arg_11_1.var_.characterEffect1015ui_story = arg_11_1.actors_["1015ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_14_0 = 0.200000002980232

			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_0 and not isNil(arg_11_1.actors_["1015ui_story"]) then
				if arg_11_1.var_.characterEffect1015ui_story and not isNil(arg_11_1.actors_["1015ui_story"]) then
					arg_11_1.var_.characterEffect1015ui_story.fillFlat = true
					arg_11_1.var_.characterEffect1015ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_11_1.time_ - 0) / var_14_0)
				end
			end

			if arg_11_1.time_ >= 0 + var_14_0 and arg_11_1.time_ < 0 + var_14_0 + arg_14_0 and not isNil(arg_11_1.actors_["1015ui_story"]) and arg_11_1.var_.characterEffect1015ui_story then
				arg_11_1.var_.characterEffect1015ui_story.fillFlat = true
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_1 + arg_14_0 then
				...
				arg_11_1.leftNameTxt_.text = arg_11_1:FormatText(StoryNameCfg[494].name)
				...
				local var_14_3 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910502003).content)

				arg_11_1.text_.text = var_14_3

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_5 = 20 <= 0 and var_14_2 or var_14_2 * (utf8.len(var_14_3) / 20)

				if (20 <= 0 and var_14_2 or var_14_2 * (utf8.len(var_14_3) / 20)) > 0 and var_14_2 < var_14_5 then
	...
	Play910502004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_0 then
				arg_15_1.actors_["1015ui_story"].transform.localPosition = Vector3.Lerp(arg_15_1.var_.moveOldPos1015ui_story, Vector3.New(0, 100, 0), (arg_15_1.time_ - 0) / var_18_0)
			...
			if arg_15_1.time_ >= 0 + var_18_0 and arg_15_1.time_ < 0 + var_18_0 + arg_18_0 then
				arg_15_1.actors_["1015ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_15_1.actors_["1015ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_15_1.actors_["1015ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_15_1.actors_["1015ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_15_1.actors_["1015ui_story"].transform.position).z)
				arg_15_1.actors_["1015ui_story"].transform.localEulerAngles.z = 0
				arg_15_1.actors_["1015ui_story"].transform.localEulerAngles.x = 0
				arg_15_1.actors_["1015ui_story"].transform.localEulerAngles = arg_15_1.actors_["1015ui_story"].transform.localEulerAngles
			...
			local var_18_1 = arg_15_1.actors_["1015ui_story"]

			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 and not isNil(var_18_1) and arg_15_1.var_.characterEffect1015ui_story == nil then
				arg_15_1.var_.characterEffect1015ui_story = var_18_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_18_2 = 0.200000002980232

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_2 and not isNil(var_18_1) then
				if arg_15_1.var_.characterEffect1015ui_story and not isNil(var_18_1) then
					arg_15_1.var_.characterEffect1015ui_story.fillFlat = true
					arg_15_1.var_.characterEffect1015ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_15_1.time_ - 0) / var_18_2)
				end
			end

			if arg_15_1.time_ >= 0 + var_18_2 and arg_15_1.time_ < 0 + var_18_2 + arg_18_0 and not isNil(var_18_1) and arg_15_1.var_.characterEffect1015ui_story then
				arg_15_1.var_.characterEffect1015ui_story.fillFlat = true
				arg_15_1.var_.characterEffect1015ui_story.fillRatio = 0.5
			end

			local var_18_3 = 0
			local var_18_4 = 0.425
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_3 + arg_18_0 then
				...
				local var_18_5 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910502004).content)

				arg_15_1.text_.text = var_18_5

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_7 = 17 <= 0 and var_18_4 or var_18_4 * (utf8.len(var_18_5) / 17)

				if (17 <= 0 and var_18_4 or var_18_4 * (utf8.len(var_18_5) / 17)) > 0 and var_18_4 < var_18_7 then
	...
	Play910502005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			if arg_19_1.actors_["1050ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1050ui_story"))) then
				local var_22_0 = Object.Instantiate(Asset.Load("Char/" .. "1050ui_story"), arg_19_1.stage_.transform)

				var_22_0.name = "1050ui_story"
				var_22_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_19_1.actors_["1050ui_story"] = var_22_0
				...
				arg_19_1.var_["1050ui_story" .. "Animator"] = var_22_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_19_1.var_["1050ui_story" .. "Animator"].applyRootMotion = true
				arg_19_1.var_["1050ui_story" .. "LipSync"] = var_22_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_22_3 = arg_19_1.actors_["1050ui_story"].transform

			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				arg_19_1.var_.moveOldPos1050ui_story = var_22_3.localPosition
			end

			local var_22_4 = 0.001

			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_4 then
				var_22_3.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos1050ui_story, Vector3.New(0, -1, -6.1), (arg_19_1.time_ - 0) / var_22_4)
			...
			if arg_19_1.time_ >= 0 + var_22_4 and arg_19_1.time_ < 0 + var_22_4 + arg_22_0 then
				var_22_3.localPosition = Vector3.New(0, -1, -6.1)
				var_22_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_22_3.position).x, (manager.ui.mainCamera.transform.position - var_22_3.position).y, (manager.ui.mainCamera.transform.position - var_22_3.position).z)
				var_22_3.localEulerAngles.z = 0
				var_22_3.localEulerAngles.x = 0
				var_22_3.localEulerAngles = var_22_3.localEulerAngles
			...
			local var_22_5 = arg_19_1.actors_["1050ui_story"]

			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 and not isNil(var_22_5) and arg_19_1.var_.characterEffect1050ui_story == nil then
				arg_19_1.var_.characterEffect1050ui_story = var_22_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_22_6 = 0.200000002980232

			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_6 and not isNil(var_22_5) then
				if arg_19_1.var_.characterEffect1050ui_story and not isNil(var_22_5) then
					arg_19_1.var_.characterEffect1050ui_story.fillFlat = false
				end
			end

			if arg_19_1.time_ >= 0 + var_22_6 and arg_19_1.time_ < 0 + var_22_6 + arg_22_0 and not isNil(var_22_5) and arg_19_1.var_.characterEffect1050ui_story then
				arg_19_1.var_.characterEffect1050ui_story.fillFlat = false
			end
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_8 + arg_22_0 then
				...
				local var_22_10 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910502005).content)
	...
	Play910502006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				...
				local var_26_3 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910502006).content)

				arg_23_1.text_.text = var_26_3

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_5 = 40 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 40)

				if (40 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 40)) > 0 and var_26_2 < var_26_5 then
	...
	Play910502007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				...
				arg_27_1.leftNameTxt_.text = arg_27_1:FormatText(StoryNameCfg[484].name)
				...
				local var_30_1 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910502007).content)
