return {
	Play120102001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 120102001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				arg_1_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1075")
				...
				local var_4_17 = arg_1_1:GetWordFromCfg(120102001)
				...
				if manager.audio:GetVoiceLength("story_v_out_120102", "120102001", "story_v_out_120102.awb") ~= 0 then
					local var_4_21 = manager.audio:GetVoiceLength("story_v_out_120102", "120102001", "story_v_out_120102.awb") / 1000
					...
					if var_4_17.prefab_name ~= "" and arg_1_1.actors_[var_4_17.prefab_name] ~= nil then
						local var_4_22 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_17.prefab_name].transform, "story_v_out_120102", "120102001", "story_v_out_120102.awb")

						arg_1_1:RecordAudio("120102001", var_4_22)
						arg_1_1:RecordAudio("120102001", var_4_22)
					else
						arg_1_1:AudioAction("play", "voice", "story_v_out_120102", "120102001", "story_v_out_120102.awb")
					end

					arg_1_1:RecordHistoryTalkVoice("story_v_out_120102", "120102001", "story_v_out_120102.awb")
				end
	...
	Play120102002 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 120102002
		arg_9_1.duration_ = 5
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(120102002).content)
	...
	Play120102003 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 120102003
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play120102004(arg_13_1)
			end
		end
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1:PlayTimeline("1075ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3103cva")
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:GetWordFromCfg(120102003)
				...
				if manager.audio:GetVoiceLength("story_v_out_120102", "120102003", "story_v_out_120102.awb") ~= 0 then
					local var_16_14 = manager.audio:GetVoiceLength("story_v_out_120102", "120102003", "story_v_out_120102.awb") / 1000
					...
					if var_16_10.prefab_name ~= "" and arg_13_1.actors_[var_16_10.prefab_name] ~= nil then
						local var_16_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_10.prefab_name].transform, "story_v_out_120102", "120102003", "story_v_out_120102.awb")

						arg_13_1:RecordAudio("120102003", var_16_15)
						arg_13_1:RecordAudio("120102003", var_16_15)
					else
						arg_13_1:AudioAction("play", "voice", "story_v_out_120102", "120102003", "story_v_out_120102.awb")
					end

					arg_13_1:RecordHistoryTalkVoice("story_v_out_120102", "120102003", "story_v_out_120102.awb")
				end
	...
	Play120102004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 120102004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play120102005(arg_17_1)
			end
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_0 then
				arg_17_1.actors_["1075ui_story"].transform.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos1075ui_story, Vector3.New(0, 100, 0), (arg_17_1.time_ - 0) / var_20_0)
			...
			if arg_17_1.time_ >= 0 + var_20_0 and arg_17_1.time_ < 0 + var_20_0 + arg_20_0 then
				arg_17_1.actors_["1075ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_17_1.actors_["1075ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_17_1.actors_["1075ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_17_1.actors_["1075ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_17_1.actors_["1075ui_story"].transform.position).z)
				arg_17_1.actors_["1075ui_story"].transform.localEulerAngles.z = 0
				arg_17_1.actors_["1075ui_story"].transform.localEulerAngles.x = 0
				arg_17_1.actors_["1075ui_story"].transform.localEulerAngles = arg_17_1.actors_["1075ui_story"].transform.localEulerAngles
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(120102004).content)
	...
	Play120102005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 120102005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play120102006(arg_21_1)
			end
		end

		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_lingguang01", "")
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_1 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(120102005).content)
	...
	Play120102006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 120102006
		...
		function arg_25_1.playNext_(arg_27_0)
			if arg_27_0 == 1 then
				arg_25_0:Play120102007(arg_25_1)
			end
		end
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				arg_25_1:PlayTimeline("1075ui_story", "StoryTimeline/CharAction/story1075/story1075action/1075action5_1")
			end

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				arg_25_1:PlayTimeline("1075ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0103cva")
			end

			local var_28_2 = arg_25_1.actors_["1075ui_story"].transform

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				arg_25_1.var_.moveOldPos1075ui_story = var_28_2.localPosition
			end

			local var_28_3 = 0.001

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_3 then
				var_28_2.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos1075ui_story, Vector3.New(0, -1.055, -6.16), (arg_25_1.time_ - 0) / var_28_3)
			...
			if arg_25_1.time_ >= 0 + var_28_3 and arg_25_1.time_ < 0 + var_28_3 + arg_28_0 then
				var_28_2.localPosition = Vector3.New(0, -1.055, -6.16)
				var_28_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_28_2.position).x, (manager.ui.mainCamera.transform.position - var_28_2.position).y, (manager.ui.mainCamera.transform.position - var_28_2.position).z)
				var_28_2.localEulerAngles.z = 0
				var_28_2.localEulerAngles.x = 0
				var_28_2.localEulerAngles = var_28_2.localEulerAngles
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_4 + arg_28_0 then
				...
				local var_28_6 = arg_25_1:GetWordFromCfg(120102006)
				...
				if manager.audio:GetVoiceLength("story_v_out_120102", "120102006", "story_v_out_120102.awb") ~= 0 then
					local var_28_10 = manager.audio:GetVoiceLength("story_v_out_120102", "120102006", "story_v_out_120102.awb") / 1000
					...
					if var_28_6.prefab_name ~= "" and arg_25_1.actors_[var_28_6.prefab_name] ~= nil then
						local var_28_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_6.prefab_name].transform, "story_v_out_120102", "120102006", "story_v_out_120102.awb")

						arg_25_1:RecordAudio("120102006", var_28_11)
						arg_25_1:RecordAudio("120102006", var_28_11)
					else
						arg_25_1:AudioAction("play", "voice", "story_v_out_120102", "120102006", "story_v_out_120102.awb")
					end

					arg_25_1:RecordHistoryTalkVoice("story_v_out_120102", "120102006", "story_v_out_120102.awb")
				end
	...
	Play120102007 = function(arg_29_0, arg_29_1)
		arg_29_1.time_ = 0
		arg_29_1.frameCnt_ = 0
		arg_29_1.state_ = "playing"
		arg_29_1.curTalkId_ = 120102007
		...
		function arg_29_1.playNext_(arg_31_0)
			if arg_31_0 == 1 then
				arg_29_0:Play120102008(arg_29_1)
			end
		end
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_highheel_loop", "")
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_2 + arg_32_0 then
				...
				local var_32_4 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(120102007).content)
	...
	Play120102008 = function(arg_33_0, arg_33_1)
		arg_33_1.time_ = 0
		arg_33_1.frameCnt_ = 0
		arg_33_1.state_ = "playing"
		arg_33_1.curTalkId_ = 120102008
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				arg_33_1:AudioAction("stop", "effect", "se_story_120_00", "se_story_120_00_highheel_loop", "")
			end

			if 0.0333333333333333 < arg_33_1.time_ and arg_33_1.time_ <= 0.0333333333333333 + arg_36_0 then
				arg_33_1:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_lingguang02", "")
			end
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_2 + arg_36_0 then
				...
				local var_36_4 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(120102008).content)
