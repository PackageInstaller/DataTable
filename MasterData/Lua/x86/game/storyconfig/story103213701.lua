	...
	Play321371084 = function(arg_355_0, arg_355_1)
		...
		function arg_355_1.onSingleLineUpdate_(arg_358_0)
			...
			if 0 < arg_355_1.time_ and arg_355_1.time_ <= 0 + arg_358_0 then
				...
				local var_358_3 = var_358_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_358_0, iter_358_1 in ipairs((var_358_3:ToTable())) do
					iter_358_1.transform.localScale = Vector3.New(iter_358_1.transform.localScale.x / var_358_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_358_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_358_1.transform.localScale.y / var_358_2, iter_358_1.transform.localScale.z)
				end
			end
			...
			if arg_355_1.time_ >= var_358_6 + 0.875 and arg_355_1.time_ < var_358_6 + 0.875 + arg_358_0 then
				arg_355_1.allBtn_.enabled = true
			end

			if 0 < arg_355_1.time_ and arg_355_1.time_ <= 0 + arg_358_0 then
				local var_358_7 = arg_355_1.var_.effecttankai1

				if not arg_355_1.var_.effecttankai1 then
					var_358_7 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), manager.ui.mainCamera.transform)
					var_358_7.name = "tankai1"
					arg_355_1.var_.effecttankai1 = var_358_7
				else
					var_358_7.transform:SetParent(var_358_9000)
				end

				var_358_7.transform.localPosition = Vector3.New(0, 0, -1)
				var_358_7.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			local var_358_11 = 0.333333333333333
			local var_358_12 = 0.975

			if 0.333333333333333 < arg_355_1.time_ and arg_355_1.time_ <= var_358_11 + arg_358_0 then
				...
				local var_358_13 = arg_355_1:FormatText(arg_355_1:GetWordFromCfg(321371084).content)

				arg_355_1.text_.text = var_358_13

				LuaForUtil.ClearLinePrefixSymbol(arg_355_1.text_)

				local var_358_15 = 39 <= 0 and var_358_12 or var_358_12 * (utf8.len(var_358_13) / 39)

				if (39 <= 0 and var_358_12 or var_358_12 * (utf8.len(var_358_13) / 39)) > 0 and var_358_12 < var_358_15 then
					arg_355_1.talkMaxDuration = var_358_15

					if var_358_15 + var_358_11 > arg_355_1.duration_ then
						arg_355_1.duration_ = var_358_15 + var_358_11
					end
				end
			...
			local var_358_16 = math.max(var_358_12, arg_355_1.talkMaxDuration)

			if var_358_11 <= arg_355_1.time_ and arg_355_1.time_ < var_358_11 + var_358_16 then
				arg_355_1.typewritter.percent = (arg_355_1.time_ - var_358_11) / var_358_16

				arg_355_1.typewritter:SetDirty()
			end

			if arg_355_1.time_ >= var_358_11 + var_358_16 and arg_355_1.time_ < var_358_11 + var_358_16 + arg_358_0 then
	...
	Play321371119 = function(arg_501_0, arg_501_1)
		...
		function arg_501_1.onSingleLineUpdate_(arg_504_0)
			...
			if 0 < arg_501_1.time_ and arg_501_1.time_ <= 0 + arg_504_0 then
				...
				local var_504_11 = var_504_8.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_504_0, iter_504_1 in ipairs((var_504_11:ToTable())) do
					iter_504_1.transform.localScale = Vector3.New(iter_504_1.transform.localScale.x / var_504_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_504_11 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_504_1.transform.localScale.y / var_504_10, iter_504_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_501_1.time_ and arg_501_1.time_ <= var_504_14 + arg_504_0 then
			...
			local var_504_18 = 0.1

			if 0.1 < arg_501_1.time_ and arg_501_1.time_ <= var_504_18 + arg_504_0 then
				arg_501_1.mask_.enabled = true
				arg_501_1.mask_.raycastTarget = true
			...
			local var_504_23 = 1.8
			local var_504_24 = 1.35

			if 1.8 < arg_501_1.time_ and arg_501_1.time_ <= var_504_23 + arg_504_0 then
				...
				local var_504_25 = LeanTween.value(arg_501_1.dialog_, 0, 1, 0.3)

				var_504_25:setOnUpdate(LuaHelper.FloatAction(function(arg_505_0)
					arg_501_1.dialogCg_.alpha = arg_505_0
				end))
				var_504_25:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_501_1.dialog_)
					var_504_25:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_504_26 = arg_501_1:FormatText(arg_501_1:GetWordFromCfg(321371119).content)

				arg_501_1.text_.text = var_504_26

				LuaForUtil.ClearLinePrefixSymbol(arg_501_1.text_)

				local var_504_28 = 54 <= 0 and var_504_24 or var_504_24 * (utf8.len(var_504_26) / 54)

				if (54 <= 0 and var_504_24 or var_504_24 * (utf8.len(var_504_26) / 54)) > 0 and var_504_24 < var_504_28 then
					arg_501_1.talkMaxDuration = var_504_28
					var_504_23 = var_504_23 + 0.3

					if var_504_28 + var_504_23 > arg_501_1.duration_ then
						arg_501_1.duration_ = var_504_28 + var_504_23
					end
				end
			...
			local var_504_29 = var_504_23 + 0.3
			local var_504_30 = math.max(var_504_24, arg_501_1.talkMaxDuration)

			if var_504_23 + 0.3 <= arg_501_1.time_ and arg_501_1.time_ < var_504_29 + var_504_30 then
				arg_501_1.typewritter.percent = (arg_501_1.time_ - var_504_29) / var_504_30
