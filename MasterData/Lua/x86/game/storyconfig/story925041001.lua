return {
	Play925041001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 925041001
		arg_1_1.duration_ = 7
		...
		function arg_1_1.playNext_(arg_3_0)
			if arg_3_0 == 1 then
				arg_1_0:Play925041002(arg_1_1)
			end
		end

		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.bgs_.I05e == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.paintGo_)

				var_4_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "I05e")
				var_4_0.name = "I05e"
				var_4_0.transform.parent = arg_1_1.stage_.transform
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.bgs_.I05e = var_4_0
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_1 = arg_1_1.bgs_.I05e

				arg_1_1.bgs_.I05e.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if arg_1_1.actors_["1034"] == nil then
				local var_4_9 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1034")
			...
			local var_4_11 = arg_1_1.actors_["1034"]

			if 1.675 < arg_1_1.time_ and arg_1_1.time_ <= 1.675 + arg_4_0 and not isNil(var_4_11) and arg_1_1.var_.actorSpriteComps1034 == nil then
				arg_1_1.var_.actorSpriteComps1034 = var_4_11:GetComponentsInChildren(typeof(Image), true)
			end

			local var_4_12 = 0.2

			if 1.675 <= arg_1_1.time_ and arg_1_1.time_ < 1.675 + var_4_12 and not isNil(var_4_11) then
				if arg_1_1.var_.actorSpriteComps1034 then
					for iter_4_4, iter_4_5 in pairs(arg_1_1.var_.actorSpriteComps1034:ToTable()) do
						if iter_4_5 then
							if arg_1_1.isInRecall_ then
								iter_4_5.color = Color.New(Mathf.Lerp(iter_4_5.color.r, arg_1_1.hightColor1.r, (arg_1_1.time_ - 1.675) / var_4_12), Mathf.Lerp(iter_4_5.color.g, arg_1_1.hightColor1.g, (arg_1_1.time_ - 1.675) / var_4_12), (Mathf.Lerp(iter_4_5.color.b, arg_1_1.hightColor1.b, (arg_1_1.time_ - 1.675) / var_4_12)))
							else
								local var_4_13 = Mathf.Lerp(iter_4_5.color.r, 1, (arg_1_1.time_ - 1.675) / var_4_12)
			...
			if arg_1_1.time_ >= 1.675 + var_4_12 and arg_1_1.time_ < 1.675 + var_4_12 + arg_4_0 and not isNil(var_4_11) and arg_1_1.var_.actorSpriteComps1034 then
			...
			local var_4_14 = arg_1_1.actors_["1034"].transform

			if 1.675 < arg_1_1.time_ and arg_1_1.time_ <= 1.675 + arg_4_0 then
				arg_1_1.var_.moveOldPos1034 = var_4_14.localPosition
			...
			if 1.675 <= arg_1_1.time_ and arg_1_1.time_ < 1.675 + var_4_16 then
				var_4_14.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_1_1.time_ - 1.675) / var_4_16)
			end

			if arg_1_1.time_ >= 1.675 + var_4_16 and arg_1_1.time_ < 1.675 + var_4_16 + arg_4_0 then
				var_4_14.localPosition = Vector3.New(0, -350, -180)
			end

			if 1.675 < arg_1_1.time_ and arg_1_1.time_ <= 1.675 + arg_4_0 then
				local var_4_17 = arg_1_1.actors_["1034"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_17 then
					arg_1_1.var_.alphaOldValue1034 = var_4_17.alpha
					arg_1_1.var_.characterEffect1034 = var_4_17
				end
			...
			if 1.675 <= arg_1_1.time_ and arg_1_1.time_ < 1.675 + var_4_18 then
				if arg_1_1.var_.characterEffect1034 then
					arg_1_1.var_.characterEffect1034.alpha = Mathf.Lerp(arg_1_1.var_.alphaOldValue1034, 1, (arg_1_1.time_ - 1.675) / var_4_18)
				end
			end

			if arg_1_1.time_ >= 1.675 + var_4_18 and arg_1_1.time_ < 1.675 + var_4_18 + arg_4_0 and arg_1_1.var_.characterEffect1034 then
			...
			if 0.233333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 0.233333333333333 + arg_4_0 then
				...
				local var_4_24 = manager.audio:GetAudioName("bgm_side_daily03", "bgm_side_daily03")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_25 + arg_4_0 then
				...
				local var_4_28 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(925041001).content)

				arg_1_1.text_.text = var_4_28

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_30 = 3 <= 0 and var_4_26 or var_4_26 * (utf8.len(var_4_28) / 3)

				if (3 <= 0 and var_4_26 or var_4_26 * (utf8.len(var_4_28) / 3)) > 0 and var_4_26 < var_4_30 then
	...
	Play925041002 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 925041002
		arg_9_1.duration_ = 5
		...
		function arg_9_1.playNext_(arg_11_0)
			if arg_11_0 == 1 then
				arg_9_0:Play925041003(arg_9_1)
			end
		end

		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(arg_9_1.actors_["1034"]) and arg_9_1.var_.actorSpriteComps1034 == nil then
				arg_9_1.var_.actorSpriteComps1034 = arg_9_1.actors_["1034"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_12_0 = 0.2

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_0 and not isNil(arg_9_1.actors_["1034"]) then
				if arg_9_1.var_.actorSpriteComps1034 then
					for iter_12_0, iter_12_1 in pairs(arg_9_1.var_.actorSpriteComps1034:ToTable()) do
						if iter_12_1 then
			...
			if arg_9_1.time_ >= 0 + var_12_0 and arg_9_1.time_ < 0 + var_12_0 + arg_12_0 and not isNil(arg_9_1.actors_["1034"]) and arg_9_1.var_.actorSpriteComps1034 then
				for iter_12_2, iter_12_3 in pairs(arg_9_1.var_.actorSpriteComps1034:ToTable()) do
					if iter_12_3 then
						iter_12_3.color = arg_9_1.isInRecall_ and (arg_9_1.hightColor2 or Color.New(0.46, 0.43, 0.35)) or Color.New(0.5, 0.5, 0.5)
					end
				end

				arg_9_1.var_.actorSpriteComps1034 = nil
			end

			local var_12_2 = 0
			local var_12_3 = 0.075
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_2 + arg_12_0 then
				...
				local var_12_4 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(925041002).content)

				arg_9_1.text_.text = var_12_4

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_6 = 3 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 3)

				if (3 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 3)) > 0 and var_12_3 < var_12_6 then
	...
	Play925041003 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 925041003
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play925041004(arg_13_1)
			end
		end

		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 and not isNil(arg_13_1.actors_["1034"]) and arg_13_1.var_.actorSpriteComps1034 == nil then
				arg_13_1.var_.actorSpriteComps1034 = arg_13_1.actors_["1034"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_16_0 = 0.2

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_0 and not isNil(arg_13_1.actors_["1034"]) then
				if arg_13_1.var_.actorSpriteComps1034 then
					for iter_16_0, iter_16_1 in pairs(arg_13_1.var_.actorSpriteComps1034:ToTable()) do
						if iter_16_1 then
			...
			if arg_13_1.time_ >= 0 + var_16_0 and arg_13_1.time_ < 0 + var_16_0 + arg_16_0 and not isNil(arg_13_1.actors_["1034"]) and arg_13_1.var_.actorSpriteComps1034 then
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_2 + arg_16_0 then
				...
				local var_16_4 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(925041003).content)

				arg_13_1.text_.text = var_16_4

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_6 = 3 <= 0 and var_16_3 or var_16_3 * (utf8.len(var_16_4) / 3)

				if (3 <= 0 and var_16_3 or var_16_3 * (utf8.len(var_16_4) / 3)) > 0 and var_16_3 < var_16_6 then
	...
	Play925041004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 925041004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play925041005(arg_17_1)
			end
		end

		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(arg_17_1.actors_["1034"]) and arg_17_1.var_.actorSpriteComps1034 == nil then
				arg_17_1.var_.actorSpriteComps1034 = arg_17_1.actors_["1034"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_20_0 = 0.2

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_0 and not isNil(arg_17_1.actors_["1034"]) then
				if arg_17_1.var_.actorSpriteComps1034 then
					for iter_20_0, iter_20_1 in pairs(arg_17_1.var_.actorSpriteComps1034:ToTable()) do
						if iter_20_1 then
			...
			if arg_17_1.time_ >= 0 + var_20_0 and arg_17_1.time_ < 0 + var_20_0 + arg_20_0 and not isNil(arg_17_1.actors_["1034"]) and arg_17_1.var_.actorSpriteComps1034 then
				for iter_20_2, iter_20_3 in pairs(arg_17_1.var_.actorSpriteComps1034:ToTable()) do
					if iter_20_3 then
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(925041004).content)

				arg_17_1.text_.text = var_20_4

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_6 = 4 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 4)

				if (4 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 4)) > 0 and var_20_3 < var_20_6 then
	...
	Play925041005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 925041005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play925041006(arg_21_1)
			end
		end
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			local var_24_2 = arg_21_1.actors_["1034"].transform

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos1034 = var_24_2.localPosition
				var_24_2.localScale = Vector3.New(1, 1, 1)

				arg_21_1:CheckSpriteTmpPos("1034", 3)
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_4 then
				var_24_2.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_21_1.time_ - 0) / var_24_4)
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_5 + arg_24_0 then
				...
				arg_21_1.leftNameTxt_.text = arg_21_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_24_7 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(925041005).content)

				arg_21_1.text_.text = var_24_7

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_9 = 12 <= 0 and var_24_6 or var_24_6 * (utf8.len(var_24_7) / 12)

				if (12 <= 0 and var_24_6 or var_24_6 * (utf8.len(var_24_7) / 12)) > 0 and var_24_6 < var_24_9 then
	...
	Play925041006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 925041006
		...
		function arg_25_1.playNext_(arg_27_0)
			if arg_27_0 == 1 then
				arg_25_0:Play925041007(arg_25_1)
			end
		end
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(925041006).content)

				arg_25_1.text_.text = var_28_4

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_6 = 25 <= 0 and var_28_3 or var_28_3 * (utf8.len(var_28_4) / 25)

				if (25 <= 0 and var_28_3 or var_28_3 * (utf8.len(var_28_4) / 25)) > 0 and var_28_3 < var_28_6 then
	...
	Play925041007 = function(arg_29_0, arg_29_1)
		arg_29_1.time_ = 0
		arg_29_1.frameCnt_ = 0
		arg_29_1.state_ = "playing"
		arg_29_1.curTalkId_ = 925041007
		...
		function arg_29_1.playNext_(arg_31_0)
			if arg_31_0 == 1 then
				arg_29_0:Play925041008(arg_29_1)
			end
		end
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			local var_32_2 = arg_29_1.actors_["1034"].transform

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos1034 = var_32_2.localPosition
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_4 then
				var_32_2.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_29_1.time_ - 0) / var_32_4)
			end

			if arg_29_1.time_ >= 0 + var_32_4 and arg_29_1.time_ < 0 + var_32_4 + arg_32_0 then
				var_32_2.localPosition = Vector3.New(0, -350, -180)
			end

			local var_32_5 = 0
			local var_32_6 = 0.825
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_5 + arg_32_0 then
				...
				arg_29_1.leftNameTxt_.text = arg_29_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_32_7 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(925041007).content)

				arg_29_1.text_.text = var_32_7

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_9 = 33 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 33)

				if (33 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 33)) > 0 and var_32_6 < var_32_9 then
	...
	Play925041008 = function(arg_33_0, arg_33_1)
		arg_33_1.time_ = 0
		arg_33_1.frameCnt_ = 0
		arg_33_1.state_ = "playing"
		arg_33_1.curTalkId_ = 925041008
		...
		function arg_33_1.playNext_(arg_35_0)
			if arg_35_0 == 1 then
				arg_33_0:Play925041009(arg_33_1)
			end
		end
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(925041008).content)
	...
	Play925041009 = function(arg_37_0, arg_37_1)
		arg_37_1.time_ = 0
		arg_37_1.frameCnt_ = 0
		arg_37_1.state_ = "playing"
		arg_37_1.curTalkId_ = 925041009
		...
		function arg_37_1.playNext_(arg_39_0)
			if arg_39_0 == 1 then
				arg_37_0:Play925041010(arg_37_1)
			end
		end
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_2 + arg_40_0 then
				...
				local var_40_4 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(925041009).content)

				arg_37_1.text_.text = var_40_4

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_6 = 15 <= 0 and var_40_3 or var_40_3 * (utf8.len(var_40_4) / 15)

				if (15 <= 0 and var_40_3 or var_40_3 * (utf8.len(var_40_4) / 15)) > 0 and var_40_3 < var_40_6 then
	...
	Play925041010 = function(arg_41_0, arg_41_1)
		arg_41_1.time_ = 0
		arg_41_1.frameCnt_ = 0
		arg_41_1.state_ = "playing"
		arg_41_1.curTalkId_ = 925041010
		...
		function arg_41_1.playNext_(arg_43_0)
			if arg_43_0 == 1 then
				arg_41_0:Play925041011(arg_41_1)
			end
		end

		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(arg_41_1.actors_["1034"]) and arg_41_1.var_.actorSpriteComps1034 == nil then
				arg_41_1.var_.actorSpriteComps1034 = arg_41_1.actors_["1034"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_44_0 = 0.2

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_0 and not isNil(arg_41_1.actors_["1034"]) then
				if arg_41_1.var_.actorSpriteComps1034 then
					for iter_44_0, iter_44_1 in pairs(arg_41_1.var_.actorSpriteComps1034:ToTable()) do
						if iter_44_1 then
			...
			if arg_41_1.time_ >= 0 + var_44_0 and arg_41_1.time_ < 0 + var_44_0 + arg_44_0 and not isNil(arg_41_1.actors_["1034"]) and arg_41_1.var_.actorSpriteComps1034 then
				for iter_44_2, iter_44_3 in pairs(arg_41_1.var_.actorSpriteComps1034:ToTable()) do
					if iter_44_3 then
						iter_44_3.color = arg_41_1.isInRecall_ and (arg_41_1.hightColor1 or Color.New(0.82, 0.77, 0.62)) or Color.New(1, 1, 1)
					end
				end

				arg_41_1.var_.actorSpriteComps1034 = nil
			end

			local var_44_2 = arg_41_1.actors_["1034"].transform

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1.var_.moveOldPos1034 = var_44_2.localPosition
				var_44_2.localScale = Vector3.New(1, 1, 1)

				arg_41_1:CheckSpriteTmpPos("1034", 3)
			...
			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_4 then
				var_44_2.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_41_1.time_ - 0) / var_44_4)
			end

			if arg_41_1.time_ >= 0 + var_44_4 and arg_41_1.time_ < 0 + var_44_4 + arg_44_0 then
				var_44_2.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_5 + arg_44_0 then
				...
				local var_44_7 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(925041010).content)

				arg_41_1.text_.text = var_44_7

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_9 = 18 <= 0 and var_44_6 or var_44_6 * (utf8.len(var_44_7) / 18)

				if (18 <= 0 and var_44_6 or var_44_6 * (utf8.len(var_44_7) / 18)) > 0 and var_44_6 < var_44_9 then
	...
	Play925041011 = function(arg_45_0, arg_45_1)
		arg_45_1.time_ = 0
		arg_45_1.frameCnt_ = 0
		arg_45_1.state_ = "playing"
		arg_45_1.curTalkId_ = 925041011
		...
		function arg_45_1.playNext_(arg_47_0)
			if arg_47_0 == 1 then
				arg_45_0:Play925041012(arg_45_1)
			end
		end

		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1034 = arg_45_1.actors_["1034"].transform.localPosition
				arg_45_1.actors_["1034"].transform.localScale = Vector3.New(1, 1, 1)

				arg_45_1:CheckSpriteTmpPos("1034", 3)

				for iter_48_0 = 0, arg_45_1.actors_["1034"].transform.childCount - 1 do
					local var_48_0 = arg_45_1.actors_["1034"].transform:GetChild(iter_48_0)
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_1 then
				arg_45_1.actors_["1034"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_45_1.time_ - 0) / var_48_1)
			end

			if arg_45_1.time_ >= 0 + var_48_1 and arg_45_1.time_ < 0 + var_48_1 + arg_48_0 then
				arg_45_1.actors_["1034"].transform.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 then
				...
				local var_48_4 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(925041011).content)

				arg_45_1.text_.text = var_48_4

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_6 = 55 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 55)

				if (55 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 55)) > 0 and var_48_3 < var_48_6 then
	...
	Play925041012 = function(arg_49_0, arg_49_1)
		arg_49_1.time_ = 0
		arg_49_1.frameCnt_ = 0
		arg_49_1.state_ = "playing"
		arg_49_1.curTalkId_ = 925041012
		...
		function arg_49_1.playNext_(arg_51_0)
			if arg_51_0 == 1 then
				arg_49_0:Play925041013(arg_49_1)
			end
		end

		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 and not isNil(arg_49_1.actors_["1034"]) and arg_49_1.var_.actorSpriteComps1034 == nil then
				arg_49_1.var_.actorSpriteComps1034 = arg_49_1.actors_["1034"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_52_0 = 0.2

			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_0 and not isNil(arg_49_1.actors_["1034"]) then
				if arg_49_1.var_.actorSpriteComps1034 then
					for iter_52_0, iter_52_1 in pairs(arg_49_1.var_.actorSpriteComps1034:ToTable()) do
						if iter_52_1 then
			...
			if arg_49_1.time_ >= 0 + var_52_0 and arg_49_1.time_ < 0 + var_52_0 + arg_52_0 and not isNil(arg_49_1.actors_["1034"]) and arg_49_1.var_.actorSpriteComps1034 then
				for iter_52_2, iter_52_3 in pairs(arg_49_1.var_.actorSpriteComps1034:ToTable()) do
					if iter_52_3 then
						iter_52_3.color = arg_49_1.isInRecall_ and (arg_49_1.hightColor2 or Color.New(0.46, 0.43, 0.35)) or Color.New(0.5, 0.5, 0.5)
					end
				end

				arg_49_1.var_.actorSpriteComps1034 = nil
			end
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_2 + arg_52_0 then
				...
				local var_52_4 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(925041012).content)

				arg_49_1.text_.text = var_52_4

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_6 = 12 <= 0 and var_52_3 or var_52_3 * (utf8.len(var_52_4) / 12)

				if (12 <= 0 and var_52_3 or var_52_3 * (utf8.len(var_52_4) / 12)) > 0 and var_52_3 < var_52_6 then
	...
	Play925041013 = function(arg_53_0, arg_53_1)
		arg_53_1.time_ = 0
		arg_53_1.frameCnt_ = 0
		arg_53_1.state_ = "playing"
		arg_53_1.curTalkId_ = 925041013
		...
		function arg_53_1.playNext_(arg_55_0)
			if arg_55_0 == 1 then
				arg_53_0:Play925041014(arg_53_1)
			end
		end
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_4 then
				var_56_2.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_53_1.time_ - 0) / var_56_4)
			end
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_5 + arg_56_0 then
				...
				local var_56_7 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(925041013).content)

				arg_53_1.text_.text = var_56_7

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_9 = 27 <= 0 and var_56_6 or var_56_6 * (utf8.len(var_56_7) / 27)

				if (27 <= 0 and var_56_6 or var_56_6 * (utf8.len(var_56_7) / 27)) > 0 and var_56_6 < var_56_9 then
	...
	Play925041014 = function(arg_57_0, arg_57_1)
		arg_57_1.time_ = 0
		arg_57_1.frameCnt_ = 0
		arg_57_1.state_ = "playing"
		arg_57_1.curTalkId_ = 925041014
		...
		function arg_57_1.playNext_(arg_59_0)
			if arg_59_0 == 1 then
				arg_57_0:Play925041015(arg_57_1)
			end
		end

		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 and not isNil(arg_57_1.actors_["1034"]) and arg_57_1.var_.actorSpriteComps1034 == nil then
				arg_57_1.var_.actorSpriteComps1034 = arg_57_1.actors_["1034"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_60_0 = 0.2

			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_0 and not isNil(arg_57_1.actors_["1034"]) then
				if arg_57_1.var_.actorSpriteComps1034 then
					for iter_60_0, iter_60_1 in pairs(arg_57_1.var_.actorSpriteComps1034:ToTable()) do
						if iter_60_1 then
			...
			if arg_57_1.time_ >= 0 + var_60_0 and arg_57_1.time_ < 0 + var_60_0 + arg_60_0 and not isNil(arg_57_1.actors_["1034"]) and arg_57_1.var_.actorSpriteComps1034 then
				for iter_60_2, iter_60_3 in pairs(arg_57_1.var_.actorSpriteComps1034:ToTable()) do
					if iter_60_3 then
						iter_60_3.color = arg_57_1.isInRecall_ and (arg_57_1.hightColor2 or Color.New(0.46, 0.43, 0.35)) or Color.New(0.5, 0.5, 0.5)
					end
				end

				arg_57_1.var_.actorSpriteComps1034 = nil
			end
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_2 + arg_60_0 then
				...
				local var_60_4 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(925041014).content)

				arg_57_1.text_.text = var_60_4

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_6 = 6 <= 0 and var_60_3 or var_60_3 * (utf8.len(var_60_4) / 6)

				if (6 <= 0 and var_60_3 or var_60_3 * (utf8.len(var_60_4) / 6)) > 0 and var_60_3 < var_60_6 then
	...
	Play925041015 = function(arg_61_0, arg_61_1)
		arg_61_1.time_ = 0
		arg_61_1.frameCnt_ = 0
		arg_61_1.state_ = "playing"
		arg_61_1.curTalkId_ = 925041015
		...
		function arg_61_1.playNext_(arg_63_0)
			if arg_63_0 == 1 then
				arg_61_0:Play925041016(arg_61_1)
			end
		end
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			local var_64_2 = arg_61_1.actors_["1034"].transform

			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				arg_61_1.var_.moveOldPos1034 = var_64_2.localPosition
				var_64_2.localScale = Vector3.New(1, 1, 1)

				arg_61_1:CheckSpriteTmpPos("1034", 3)
			...
			if 0 <= arg_61_1.time_ and arg_61_1.time_ < 0 + var_64_4 then
				var_64_2.localPosition = Vector3.Lerp(arg_61_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_61_1.time_ - 0) / var_64_4)
			end

			if arg_61_1.time_ >= 0 + var_64_4 and arg_61_1.time_ < 0 + var_64_4 + arg_64_0 then
				var_64_2.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_5 + arg_64_0 then
				...
				local var_64_7 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(925041015).content)

				arg_61_1.text_.text = var_64_7

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_9 = 36 <= 0 and var_64_6 or var_64_6 * (utf8.len(var_64_7) / 36)

				if (36 <= 0 and var_64_6 or var_64_6 * (utf8.len(var_64_7) / 36)) > 0 and var_64_6 < var_64_9 then
	...
	Play925041016 = function(arg_65_0, arg_65_1)
		arg_65_1.time_ = 0
		arg_65_1.frameCnt_ = 0
		arg_65_1.state_ = "playing"
		arg_65_1.curTalkId_ = 925041016
		...
		function arg_65_1.playNext_(arg_67_0)
			if arg_67_0 == 1 then
				arg_65_0:Play925041017(arg_65_1)
			end
		end
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_2 + arg_68_0 then
				...
				local var_68_4 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(925041016).content)
	...
	Play925041017 = function(arg_69_0, arg_69_1)
		arg_69_1.time_ = 0
		arg_69_1.frameCnt_ = 0
		arg_69_1.state_ = "playing"
		arg_69_1.curTalkId_ = 925041017
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			local var_72_2 = arg_69_1.actors_["1034"].transform

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				arg_69_1.var_.moveOldPos1034 = var_72_2.localPosition
				var_72_2.localScale = Vector3.New(1, 1, 1)

				arg_69_1:CheckSpriteTmpPos("1034", 3)
			...
			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_4 then
				var_72_2.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_69_1.time_ - 0) / var_72_4)
			end

			if arg_69_1.time_ >= 0 + var_72_4 and arg_69_1.time_ < 0 + var_72_4 + arg_72_0 then
				var_72_2.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_5 + arg_72_0 then
				...
				arg_69_1.leftNameTxt_.text = arg_69_1:FormatText(StoryNameCfg[1109].name)
				...
				local var_72_7 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(925041017).content)

				arg_69_1.text_.text = var_72_7

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_9 = 20 <= 0 and var_72_6 or var_72_6 * (utf8.len(var_72_7) / 20)

				if (20 <= 0 and var_72_6 or var_72_6 * (utf8.len(var_72_7) / 20)) > 0 and var_72_6 < var_72_9 then
