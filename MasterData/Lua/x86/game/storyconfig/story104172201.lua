	...
	Play417221114 = function(arg_496_0, arg_496_1)
		...
		function arg_496_1.onSingleLineUpdate_(arg_499_0)
			...
			if 2 < arg_496_1.time_ and arg_496_1.time_ <= 2 + arg_499_0 then
				...
				local var_499_16 = var_499_13.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_499_2, iter_499_3 in ipairs((var_499_16:ToTable())) do
					iter_499_3.transform.localScale = Vector3.New(iter_499_3.transform.localScale.x / var_499_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_499_16 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_499_3.transform.localScale.y / var_499_15, iter_499_3.transform.localScale.z)
				end
			end
			...
			local var_499_19 = 4
			local var_499_20 = 0.65

			if 4 < arg_496_1.time_ and arg_496_1.time_ <= var_499_19 + arg_499_0 then
				...
				local var_499_21 = LeanTween.value(arg_496_1.dialog_, 0, 1, 0.3)

				var_499_21:setOnUpdate(LuaHelper.FloatAction(function(arg_500_0)
					arg_496_1.dialogCg_.alpha = arg_500_0
				end))
				var_499_21:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_496_1.dialog_)
					var_499_21:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_499_22 = arg_496_1:GetWordFromCfg(417221114)
				local var_499_23 = arg_496_1:FormatText(var_499_22.content)

				arg_496_1.text_.text = var_499_23

				LuaForUtil.ClearLinePrefixSymbol(arg_496_1.text_)

				local var_499_25 = 26 <= 0 and var_499_20 or var_499_20 * (utf8.len(var_499_23) / 26)

				if (26 <= 0 and var_499_20 or var_499_20 * (utf8.len(var_499_23) / 26)) > 0 and var_499_20 < var_499_25 then
					arg_496_1.talkMaxDuration = var_499_25
					var_499_19 = var_499_19 + 0.3

					if var_499_25 + var_499_19 > arg_496_1.duration_ then
						arg_496_1.duration_ = var_499_25 + var_499_19
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_417221", "417221114", "story_v_out_417221.awb") ~= 0 then
					local var_499_26 = manager.audio:GetVoiceLength("story_v_out_417221", "417221114", "story_v_out_417221.awb") / 1000

					if var_499_26 + var_499_19 > arg_496_1.duration_ then
						arg_496_1.duration_ = var_499_26 + var_499_19
					end

					if var_499_22.prefab_name ~= "" and arg_496_1.actors_[var_499_22.prefab_name] ~= nil then
						local var_499_27 = LuaForUtil.PlayVoiceWithCriLipsync(arg_496_1.actors_[var_499_22.prefab_name].transform, "story_v_out_417221", "417221114", "story_v_out_417221.awb")

						arg_496_1:RecordAudio("417221114", var_499_27)
						arg_496_1:RecordAudio("417221114", var_499_27)
					else
			...
			local var_499_28 = var_499_19 + 0.3
			local var_499_29 = math.max(var_499_20, arg_496_1.talkMaxDuration)

			if var_499_19 + 0.3 <= arg_496_1.time_ and arg_496_1.time_ < var_499_28 + var_499_29 then
				arg_496_1.typewritter.percent = (arg_496_1.time_ - var_499_28) / var_499_29
