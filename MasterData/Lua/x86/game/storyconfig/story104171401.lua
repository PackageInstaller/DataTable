	...
	Play417141036 = function(arg_137_0, arg_137_1)
		...
		function arg_137_1.onSingleLineUpdate_(arg_140_0)
			...
			if 6.2 < arg_137_1.time_ and arg_137_1.time_ <= 6.2 + arg_140_0 then
				...
				local var_140_21 = var_140_18.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_140_2, iter_140_3 in ipairs((var_140_21:ToTable())) do
					iter_140_3.transform.localScale = Vector3.New(iter_140_3.transform.localScale.x / var_140_20 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_140_21 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_140_3.transform.localScale.y / var_140_20, iter_140_3.transform.localScale.z)
				end
			end

			local var_140_23 = arg_137_1.actors_["10113"].transform

			if 0 < arg_137_1.time_ and arg_137_1.time_ <= 0 + arg_140_0 then
				arg_137_1.var_.moveOldPos10113 = var_140_23.localPosition
				var_140_23.localScale = Vector3.New(1, 1, 1)

				arg_137_1:CheckSpriteTmpPos("10113", 7)

				for iter_140_4 = 0, var_140_23.childCount - 1 do
					local var_140_24 = var_140_23:GetChild(iter_140_4)

					if var_140_24.name == "" or not string.find(var_140_24.name, "split") then
						var_140_24.gameObject:SetActive(true)
					else
						var_140_24.gameObject:SetActive(false)
					end
				end
			end

			local var_140_25 = 0.001

			if 0 <= arg_137_1.time_ and arg_137_1.time_ < 0 + var_140_25 then
				var_140_23.localPosition = Vector3.Lerp(arg_137_1.var_.moveOldPos10113, Vector3.New(0, -2000, 0), (arg_137_1.time_ - 0) / var_140_25)
			end

			if arg_137_1.time_ >= 0 + var_140_25 and arg_137_1.time_ < 0 + var_140_25 + arg_140_0 then
			...
			local var_140_27 = 0.1

			if var_140_26 <= arg_137_1.time_ and arg_137_1.time_ < var_140_26 + var_140_27 then
				arg_137_1.screenFilterEffect_.weight = Mathf.Lerp(1, 0, (arg_137_1.time_ - var_140_26) / var_140_27)
			end
			...
			if 0 < arg_137_1.time_ and arg_137_1.time_ <= 0 + arg_140_0 then
				...
				local var_140_31 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_137_1.bgmTxt_.text ~= var_140_31 and arg_137_1.bgmTxt_.text ~= "" then
						if arg_137_1.bgmTxt2_.text ~= "" then
							arg_137_1.bgmTxt_.text = arg_137_1.bgmTxt2_.text
						end

						arg_137_1.bgmTxt2_.text = var_140_31

						arg_137_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_137_1.bgmTxt_.text = var_140_31
						arg_137_1.bgmTxt2_.text = var_140_31
					end
			...
			if 0.2 < arg_137_1.time_ and arg_137_1.time_ <= 0.2 + arg_140_0 then
				...
				local var_140_34 = manager.audio:GetAudioName("bgm_activity_3_8_story_corg", "bgm_activity_3_8_story_corg")

				if "" ~= "" then
					if arg_137_1.bgmTxt_.text ~= var_140_34 and arg_137_1.bgmTxt_.text ~= "" then
						if arg_137_1.bgmTxt2_.text ~= "" then
							arg_137_1.bgmTxt_.text = arg_137_1.bgmTxt2_.text
						end

						arg_137_1.bgmTxt2_.text = var_140_34

						arg_137_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_137_1.bgmTxt_.text = var_140_34
						arg_137_1.bgmTxt2_.text = var_140_34
					end
			...
			local var_140_35 = 7.03333333333333
			local var_140_36 = 0.825

			if 7.03333333333333 < arg_137_1.time_ and arg_137_1.time_ <= var_140_35 + arg_140_0 then
				...
				local var_140_37 = LeanTween.value(arg_137_1.dialog_, 0, 1, 0.3)

				var_140_37:setOnUpdate(LuaHelper.FloatAction(function(arg_144_0)
					arg_137_1.dialogCg_.alpha = arg_144_0
				end))
				var_140_37:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_137_1.dialog_)
					var_140_37:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_140_38 = arg_137_1:GetWordFromCfg(417141036)
				...
				local var_140_41 = 33 <= 0 and var_140_36 or var_140_36 * (utf8.len(var_140_39) / 33)

				if (33 <= 0 and var_140_36 or var_140_36 * (utf8.len(var_140_39) / 33)) > 0 and var_140_36 < var_140_41 then
					arg_137_1.talkMaxDuration = var_140_41
					var_140_35 = var_140_35 + 0.3
				...
				if manager.audio:GetVoiceLength("story_v_out_417141", "417141036", "story_v_out_417141.awb") ~= 0 then
					local var_140_42 = manager.audio:GetVoiceLength("story_v_out_417141", "417141036", "story_v_out_417141.awb") / 1000
					...
					if var_140_38.prefab_name ~= "" and arg_137_1.actors_[var_140_38.prefab_name] ~= nil then
						local var_140_43 = LuaForUtil.PlayVoiceWithCriLipsync(arg_137_1.actors_[var_140_38.prefab_name].transform, "story_v_out_417141", "417141036", "story_v_out_417141.awb")

						arg_137_1:RecordAudio("417141036", var_140_43)
						arg_137_1:RecordAudio("417141036", var_140_43)
					else
			...
			local var_140_44 = var_140_35 + 0.3
			local var_140_45 = math.max(var_140_36, arg_137_1.talkMaxDuration)

			if var_140_35 + 0.3 <= arg_137_1.time_ and arg_137_1.time_ < var_140_44 + var_140_45 then
