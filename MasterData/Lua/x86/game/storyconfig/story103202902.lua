	...
	Play320292022 = function(arg_100_0, arg_100_1)
		...
		function arg_100_1.onSingleLineUpdate_(arg_103_0)
			if 0 < arg_100_1.time_ and arg_100_1.time_ <= 0 + arg_103_0 then
				...
				local var_103_3 = var_103_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_103_0, iter_103_1 in ipairs((var_103_3:ToTable())) do
					iter_103_1.transform.localScale = Vector3.New(iter_103_1.transform.localScale.x / var_103_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_103_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_103_1.transform.localScale.y / var_103_2, iter_103_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_100_1.time_ and arg_100_1.time_ <= var_103_6 + arg_103_0 then
				...
				local var_103_8 = arg_100_1:FormatText(arg_100_1:GetWordFromCfg(320292022).content)

				arg_100_1.text_.text = var_103_8

				LuaForUtil.ClearLinePrefixSymbol(arg_100_1.text_)

				local var_103_10 = 66 <= 0 and var_103_7 or var_103_7 * (utf8.len(var_103_8) / 66)

				if (66 <= 0 and var_103_7 or var_103_7 * (utf8.len(var_103_8) / 66)) > 0 and var_103_7 < var_103_10 then
					arg_100_1.talkMaxDuration = var_103_10

					if var_103_10 + var_103_6 > arg_100_1.duration_ then
						arg_100_1.duration_ = var_103_10 + var_103_6
					end
				end
			...
			local var_103_11 = math.max(var_103_7, arg_100_1.talkMaxDuration)

			if var_103_6 <= arg_100_1.time_ and arg_100_1.time_ < var_103_6 + var_103_11 then
				arg_100_1.typewritter.percent = (arg_100_1.time_ - var_103_6) / var_103_11

				arg_100_1.typewritter:SetDirty()
			end

			if arg_100_1.time_ >= var_103_6 + var_103_11 and arg_100_1.time_ < var_103_6 + var_103_11 + arg_103_0 then
