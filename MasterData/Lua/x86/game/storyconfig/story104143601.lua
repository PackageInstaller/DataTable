return {
	Play414361001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[1017].name)
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414361001).content)
	...
	Play414361002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[1018].name)
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(414361002).content)
	...
	Play414361003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(414361003).content)
	...
	Play414361004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(414361004).content)
	...
	Play414361005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				arg_19_1.leftNameTxt_.text = arg_19_1:FormatText(StoryNameCfg[943].name)
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(414361005).content)

				arg_19_1.text_.text = var_22_1

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_3 = 39 <= 0 and var_22_0 or var_22_0 * (utf8.len(var_22_1) / 39)

				if (39 <= 0 and var_22_0 or var_22_0 * (utf8.len(var_22_1) / 39)) > 0 and var_22_0 < var_22_3 then
	...
	Play414361006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				...
				local var_26_1 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(414361006).content)
	...
	Play414361007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				...
				arg_27_1.leftNameTxt_.text = arg_27_1:FormatText(StoryNameCfg[943].name)
				...
				local var_30_1 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(414361007).content)

				arg_27_1.text_.text = var_30_1

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_3 = 57 <= 0 and var_30_0 or var_30_0 * (utf8.len(var_30_1) / 57)

				if (57 <= 0 and var_30_0 or var_30_0 * (utf8.len(var_30_1) / 57)) > 0 and var_30_0 < var_30_3 then
	...
	Play414361008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				...
				arg_31_1.leftNameTxt_.text = arg_31_1:FormatText(StoryNameCfg[943].name)
				...
				local var_34_1 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(414361008).content)
	...
	Play414361009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				...
				local var_38_1 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(414361009).content)
	...
	Play414361010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0.633333333333333 < arg_39_1.time_ and arg_39_1.time_ <= var_42_0 + arg_42_0 then
				...
				local var_42_3 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(414361010).content)

				arg_39_1.text_.text = var_42_3

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_5 = 8 <= 0 and var_42_1 or var_42_1 * (utf8.len(var_42_3) / 8)

				if (8 <= 0 and var_42_1 or var_42_1 * (utf8.len(var_42_3) / 8)) > 0 and var_42_1 < var_42_5 then
	...
	Play414361011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if arg_45_1.actors_["104902ui_story"] == nil and not isNil((Asset.Load("Char/" .. "104902ui_story"))) then
				local var_48_0 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_45_1.stage_.transform)

				var_48_0.name = "104902ui_story"
				var_48_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_45_1.actors_["104902ui_story"] = var_48_0
				...
				arg_45_1.var_["104902ui_story" .. "Animator"] = var_48_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_45_1.var_["104902ui_story" .. "Animator"].applyRootMotion = true
				arg_45_1.var_["104902ui_story" .. "LipSync"] = var_48_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_48_3 = arg_45_1.actors_["104902ui_story"].transform

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos104902ui_story = var_48_3.localPosition
			end

			local var_48_4 = 0.001

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_4 then
				var_48_3.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_45_1.time_ - 0) / var_48_4)
			...
			if arg_45_1.time_ >= 0 + var_48_4 and arg_45_1.time_ < 0 + var_48_4 + arg_48_0 then
				var_48_3.localPosition = Vector3.New(0, -1.2, -6)
				var_48_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_48_3.position).x, (manager.ui.mainCamera.transform.position - var_48_3.position).y, (manager.ui.mainCamera.transform.position - var_48_3.position).z)
				var_48_3.localEulerAngles.z = 0
				var_48_3.localEulerAngles.x = 0
				var_48_3.localEulerAngles = var_48_3.localEulerAngles
			...
			local var_48_5 = arg_45_1.actors_["104902ui_story"]

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(var_48_5) and arg_45_1.var_.characterEffect104902ui_story == nil then
				arg_45_1.var_.characterEffect104902ui_story = var_48_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_48_6 = 0.200000002980232

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_6 and not isNil(var_48_5) then
				if arg_45_1.var_.characterEffect104902ui_story and not isNil(var_48_5) then
					arg_45_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_45_1.time_ >= 0 + var_48_6 and arg_45_1.time_ < 0 + var_48_6 + arg_48_0 and not isNil(var_48_5) and arg_45_1.var_.characterEffect104902ui_story then
				arg_45_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_8 + arg_48_0 then
				...
				local var_48_10 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(414361011).content)

				arg_45_1.text_.text = var_48_10

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_12 = 10 <= 0 and var_48_9 or var_48_9 * (utf8.len(var_48_10) / 10)

				if (10 <= 0 and var_48_9 or var_48_9 * (utf8.len(var_48_10) / 10)) > 0 and var_48_9 < var_48_12 then
	...
	Play414361012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(414361012).content)
