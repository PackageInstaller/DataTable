	...
	Play926091096 = function(arg_397_0, arg_397_1)
		...
		function arg_397_1.onSingleLineUpdate_(arg_400_0)
			...
			if 0 < arg_397_1.time_ and arg_397_1.time_ <= 0 + arg_400_0 then
				...
				local var_400_11 = var_400_8.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_400_4, iter_400_5 in ipairs((var_400_11:ToTable())) do
					iter_400_5.transform.localScale = Vector3.New(iter_400_5.transform.localScale.x / var_400_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_400_11 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_400_5.transform.localScale.y / var_400_10, iter_400_5.transform.localScale.z)
				end
			end
			...
			if arg_397_1.time_ >= var_400_13 + 1.841666666666 and arg_397_1.time_ < var_400_13 + 1.841666666666 + arg_400_0 then
			...
			local var_400_15 = 1.26666666666667
			local var_400_16 = 0.175

			if 1.26666666666667 < arg_397_1.time_ and arg_397_1.time_ <= var_400_15 + arg_400_0 then
				...
				local var_400_18 = arg_397_1:GetWordFromCfg(926091096)
				...
				local var_400_21 = 7 <= 0 and var_400_16 or var_400_16 * (utf8.len(var_400_19) / 7)

				if (7 <= 0 and var_400_16 or var_400_16 * (utf8.len(var_400_19) / 7)) > 0 and var_400_16 < var_400_21 then
				...
				if manager.audio:GetVoiceLength("story_v_out_926091", "926091096", "story_v_out_926091.awb") ~= 0 then
					local var_400_22 = manager.audio:GetVoiceLength("story_v_out_926091", "926091096", "story_v_out_926091.awb") / 1000
					...
					if var_400_18.prefab_name ~= "" and arg_397_1.actors_[var_400_18.prefab_name] ~= nil then
						local var_400_23 = LuaForUtil.PlayVoiceWithCriLipsync(arg_397_1.actors_[var_400_18.prefab_name].transform, "story_v_out_926091", "926091096", "story_v_out_926091.awb")

						arg_397_1:RecordAudio("926091096", var_400_23)
						arg_397_1:RecordAudio("926091096", var_400_23)
					else
			...
			local var_400_24 = var_400_15 + 0.3
			local var_400_25 = math.max(var_400_16, arg_397_1.talkMaxDuration)

			if var_400_15 + 0.3 <= arg_397_1.time_ and arg_397_1.time_ < var_400_24 + var_400_25 then
				arg_397_1.typewritter.percent = (arg_397_1.time_ - var_400_24) / var_400_25
