	...
	Play910806001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910806001).content)
	...
	Play910806002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_5 + arg_10_0 then
				...
				local var_10_7 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910806002).content)
	...
	Play910806003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_2 + arg_14_0 then
				...
				local var_14_4 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910806003).content)

				arg_11_1.text_.text = var_14_4

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_6 = 14 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 14)

				if (14 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 14)) > 0 and var_14_3 < var_14_6 then
	...
	Play910806004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910806004).content)

				arg_15_1.text_.text = var_18_7

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_9 = 20 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 20)

				if (20 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 20)) > 0 and var_18_6 < var_18_9 then
	...
	Play910806005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_2 + arg_22_0 then
				...
				local var_22_4 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910806005).content)

				arg_19_1.text_.text = var_22_4

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_6 = 13 <= 0 and var_22_3 or var_22_3 * (utf8.len(var_22_4) / 13)

				if (13 <= 0 and var_22_3 or var_22_3 * (utf8.len(var_22_4) / 13)) > 0 and var_22_3 < var_22_6 then
	...
	Play910806006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910806006).content)

				arg_23_1.text_.text = var_26_7

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_9 = 8 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 8)

				if (8 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 8)) > 0 and var_26_6 < var_26_9 then
	...
	Play910806007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_2 + arg_30_0 then
				...
				local var_30_4 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910806007).content)
	...
	Play910806008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910806008).content)

				arg_31_1.text_.text = var_34_7

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_9 = 14 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 14)

				if (14 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 14)) > 0 and var_34_6 < var_34_9 then
	...
	Play910806009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_2 + arg_38_0 then
				...
				local var_38_4 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910806009).content)

				arg_35_1.text_.text = var_38_4

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_6 = 16 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 16)

				if (16 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 16)) > 0 and var_38_3 < var_38_6 then
	...
	Play910806010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 then
				...
				local var_42_1 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910806010).content)
	...
	Play910806011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= 0 + arg_46_0 then
				...
				local var_46_1 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910806011).content)
	...
	Play910806012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_5 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910806012).content)
	...
	Play910806013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_2 + arg_54_0 then
				...
				local var_54_4 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910806013).content)

				arg_51_1.text_.text = var_54_4

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_6 = 12 <= 0 and var_54_3 or var_54_3 * (utf8.len(var_54_4) / 12)

				if (12 <= 0 and var_54_3 or var_54_3 * (utf8.len(var_54_4) / 12)) > 0 and var_54_3 < var_54_6 then
	...
	Play910806014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_6 + arg_58_0 then
				...
				local var_58_8 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910806014).content)

				arg_55_1.text_.text = var_58_8

				LuaForUtil.ClearLinePrefixSymbol(arg_55_1.text_)

				local var_58_10 = 24 <= 0 and var_58_7 or var_58_7 * (utf8.len(var_58_8) / 24)

				if (24 <= 0 and var_58_7 or var_58_7 * (utf8.len(var_58_8) / 24)) > 0 and var_58_7 < var_58_10 then
