	...
	Play320122001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				local var_4_27 = arg_1_1:GetWordFromCfg(320122001)
				...
				if manager.audio:GetVoiceLength("story_v_out_320122", "320122001", "story_v_out_320122.awb") ~= 0 then
					local var_4_31 = manager.audio:GetVoiceLength("story_v_out_320122", "320122001", "story_v_out_320122.awb") / 1000
					...
					if var_4_27.prefab_name ~= "" and arg_1_1.actors_[var_4_27.prefab_name] ~= nil then
						local var_4_32 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_27.prefab_name].transform, "story_v_out_320122", "320122001", "story_v_out_320122.awb")

						arg_1_1:RecordAudio("320122001", var_4_32)
						arg_1_1:RecordAudio("320122001", var_4_32)
					else
	...
	Play320122002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(320122002).content)

				arg_9_1.text_.text = var_12_3

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_5 = 37 <= 0 and var_12_2 or var_12_2 * (utf8.len(var_12_3) / 37)

				if (37 <= 0 and var_12_2 or var_12_2 * (utf8.len(var_12_3) / 37)) > 0 and var_12_2 < var_12_5 then
	...
	Play320122003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_0 then
				arg_13_1.actors_["10102ui_story"].transform.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos10102ui_story, Vector3.New(0, 100, 0), (arg_13_1.time_ - 0) / var_16_0)
			...
			if arg_13_1.time_ >= 0 + var_16_0 and arg_13_1.time_ < 0 + var_16_0 + arg_16_0 then
				arg_13_1.actors_["10102ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_13_1.actors_["10102ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_13_1.actors_["10102ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["10102ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["10102ui_story"].transform.position).z)
				arg_13_1.actors_["10102ui_story"].transform.localEulerAngles.z = 0
				arg_13_1.actors_["10102ui_story"].transform.localEulerAngles.x = 0
				arg_13_1.actors_["10102ui_story"].transform.localEulerAngles = arg_13_1.actors_["10102ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_2 and not isNil(var_16_1) then
				if arg_13_1.var_.characterEffect10102ui_story and not isNil(var_16_1) then
					...
					arg_13_1.var_.characterEffect10102ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_13_1.time_ - 0) / var_16_2)
				end
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1:AudioAction("play", "effect", "se_story_activity_1_4_3", "se_story_activity_1_4_3_door", "")
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_4 + arg_16_0 then
				...
				local var_16_6 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(320122003).content)
	...
	Play320122004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				...
				arg_17_1.leftNameTxt_.text = arg_17_1:FormatText(StoryNameCfg[1041].name)
				...
				local var_20_1 = arg_17_1:GetWordFromCfg(320122004)
				...
				if manager.audio:GetVoiceLength("story_v_out_320122", "320122004", "story_v_out_320122.awb") ~= 0 then
					local var_20_5 = manager.audio:GetVoiceLength("story_v_out_320122", "320122004", "story_v_out_320122.awb") / 1000
					...
					if var_20_1.prefab_name ~= "" and arg_17_1.actors_[var_20_1.prefab_name] ~= nil then
						local var_20_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_1.prefab_name].transform, "story_v_out_320122", "320122004", "story_v_out_320122.awb")

						arg_17_1:RecordAudio("320122004", var_20_6)
						arg_17_1:RecordAudio("320122004", var_20_6)
					else
	...
	Play320122005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				...
				local var_24_1 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(320122005).content)
	...
	Play320122006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				...
				local var_28_1 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(320122006).content)
	...
	Play320122007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				local var_32_1 = arg_29_1:GetWordFromCfg(320122007)
				...
				if manager.audio:GetVoiceLength("story_v_out_320122", "320122007", "story_v_out_320122.awb") ~= 0 then
					local var_32_5 = manager.audio:GetVoiceLength("story_v_out_320122", "320122007", "story_v_out_320122.awb") / 1000
					...
					if var_32_1.prefab_name ~= "" and arg_29_1.actors_[var_32_1.prefab_name] ~= nil then
						local var_32_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_1.prefab_name].transform, "story_v_out_320122", "320122007", "story_v_out_320122.awb")

						arg_29_1:RecordAudio("320122007", var_32_6)
						arg_29_1:RecordAudio("320122007", var_32_6)
					else
	...
	Play320122008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(320122008).content)
	...
	Play320122009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				local var_40_1 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(320122009).content)

				arg_37_1.text_.text = var_40_1

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_3 = 34 <= 0 and var_40_0 or var_40_0 * (utf8.len(var_40_1) / 34)

				if (34 <= 0 and var_40_0 or var_40_0 * (utf8.len(var_40_1) / 34)) > 0 and var_40_0 < var_40_3 then
	...
	Play320122010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				...
				arg_41_1.leftNameTxt_.text = arg_41_1:FormatText(StoryNameCfg[1041].name)
				...
				local var_44_1 = arg_41_1:GetWordFromCfg(320122010)
				...
				if manager.audio:GetVoiceLength("story_v_out_320122", "320122010", "story_v_out_320122.awb") ~= 0 then
					local var_44_5 = manager.audio:GetVoiceLength("story_v_out_320122", "320122010", "story_v_out_320122.awb") / 1000
					...
					if var_44_1.prefab_name ~= "" and arg_41_1.actors_[var_44_1.prefab_name] ~= nil then
						local var_44_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_1.prefab_name].transform, "story_v_out_320122", "320122010", "story_v_out_320122.awb")

						arg_41_1:RecordAudio("320122010", var_44_6)
						arg_41_1:RecordAudio("320122010", var_44_6)
					else
	...
	Play320122011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				local var_48_1 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(320122011).content)
	...
	Play320122012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				...
				arg_49_1.leftNameTxt_.text = arg_49_1:FormatText(StoryNameCfg[1041].name)
				...
				local var_52_1 = arg_49_1:GetWordFromCfg(320122012)
				...
				if manager.audio:GetVoiceLength("story_v_out_320122", "320122012", "story_v_out_320122.awb") ~= 0 then
					local var_52_5 = manager.audio:GetVoiceLength("story_v_out_320122", "320122012", "story_v_out_320122.awb") / 1000
					...
					if var_52_1.prefab_name ~= "" and arg_49_1.actors_[var_52_1.prefab_name] ~= nil then
						local var_52_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_1.prefab_name].transform, "story_v_out_320122", "320122012", "story_v_out_320122.awb")

						arg_49_1:RecordAudio("320122012", var_52_6)
						arg_49_1:RecordAudio("320122012", var_52_6)
					else
