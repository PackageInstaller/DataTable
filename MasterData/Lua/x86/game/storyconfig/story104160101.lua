	...
	Play416011101 = function(arg_418_0, arg_418_1)
		...
		function arg_418_1.onSingleLineUpdate_(arg_421_0)
			...
			if 2.03333333333333 < arg_418_1.time_ and arg_418_1.time_ <= 2.03333333333333 + arg_421_0 then
				...
				local var_421_18 = var_421_15.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_421_3, iter_421_4 in ipairs((var_421_18:ToTable())) do
					iter_421_4.transform.localScale = Vector3.New(iter_421_4.transform.localScale.x / var_421_17 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_421_18 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_421_4.transform.localScale.y / var_421_17, iter_421_4.transform.localScale.z)
				end
			end
			...
			if 0 < arg_418_1.time_ and arg_418_1.time_ <= 0 + arg_421_0 then
				...
				local var_421_22 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_418_1.bgmTxt_.text ~= var_421_22 and arg_418_1.bgmTxt_.text ~= "" then
						if arg_418_1.bgmTxt2_.text ~= "" then
							arg_418_1.bgmTxt_.text = arg_418_1.bgmTxt2_.text
						end

						arg_418_1.bgmTxt2_.text = var_421_22

						arg_418_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_418_1.bgmTxt_.text = var_421_22
						arg_418_1.bgmTxt2_.text = var_421_22
					end
			...
			if 1.43333333333333 < arg_418_1.time_ and arg_418_1.time_ <= 1.43333333333333 + arg_421_0 then
				...
				local var_421_25 = manager.audio:GetAudioName("bgm_activity_3_8_story_tide", "bgm_activity_3_8_story_tide")
			...
			local var_421_26 = 4
			local var_421_27 = 1.625

			if 4 < arg_418_1.time_ and arg_418_1.time_ <= var_421_26 + arg_421_0 then
				...
				local var_421_28 = LeanTween.value(arg_418_1.dialog_, 0, 1, 0.3)

				var_421_28:setOnUpdate(LuaHelper.FloatAction(function(arg_424_0)
					arg_418_1.dialogCg_.alpha = arg_424_0
				end))
				var_421_28:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_418_1.dialog_)
					var_421_28:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_421_29 = arg_418_1:FormatText(arg_418_1:GetWordFromCfg(416011101).content)

				arg_418_1.text_.text = var_421_29

				LuaForUtil.ClearLinePrefixSymbol(arg_418_1.text_)

				local var_421_31 = 65 <= 0 and var_421_27 or var_421_27 * (utf8.len(var_421_29) / 65)

				if (65 <= 0 and var_421_27 or var_421_27 * (utf8.len(var_421_29) / 65)) > 0 and var_421_27 < var_421_31 then
					arg_418_1.talkMaxDuration = var_421_31
					var_421_26 = var_421_26 + 0.3

					if var_421_31 + var_421_26 > arg_418_1.duration_ then
						arg_418_1.duration_ = var_421_31 + var_421_26
					end
				end
			...
			local var_421_32 = var_421_26 + 0.3
			local var_421_33 = math.max(var_421_27, arg_418_1.talkMaxDuration)

			if var_421_26 + 0.3 <= arg_418_1.time_ and arg_418_1.time_ < var_421_32 + var_421_33 then
				arg_418_1.typewritter.percent = (arg_418_1.time_ - var_421_32) / var_421_33

				arg_418_1.typewritter:SetDirty()
			end

			if arg_418_1.time_ >= var_421_32 + var_421_33 and arg_418_1.time_ < var_421_32 + var_421_33 + arg_421_0 then
