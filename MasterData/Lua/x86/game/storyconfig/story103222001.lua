	...
	Play322201015 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 2 < arg_63_1.time_ and arg_63_1.time_ <= 2 + arg_66_0 then
				...
				local var_66_16 = var_66_13.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_66_2, iter_66_3 in ipairs((var_66_16:ToTable())) do
					iter_66_3.transform.localScale = Vector3.New(iter_66_3.transform.localScale.x / var_66_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_66_16 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_66_3.transform.localScale.y / var_66_15, iter_66_3.transform.localScale.z)
				end
			end
		end
