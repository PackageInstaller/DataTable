	...
	Play926071009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 1.66666666666667 < arg_37_1.time_ and arg_37_1.time_ <= 1.66666666666667 + arg_40_0 then
				...
				local var_40_21 = var_40_18.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_40_5, iter_40_6 in ipairs((var_40_21:ToTable())) do
					iter_40_6.transform.localScale = Vector3.New(iter_40_6.transform.localScale.x / var_40_20 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_40_21 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_40_6.transform.localScale.y / var_40_20, iter_40_6.transform.localScale.z)
				end
			end

			local var_40_23 = manager.ui.mainCamera.transform

			if 1.43333333333333 < arg_37_1.time_ and arg_37_1.time_ <= 1.43333333333333 + arg_40_0 then
				arg_37_1.var_.shakeOldPos = var_40_23.localPosition
			end

			local var_40_24 = 0.433333333333333

			if 1.43333333333333 <= arg_37_1.time_ and arg_37_1.time_ < 1.43333333333333 + var_40_24 then
				local var_40_25, var_40_26 = math.modf((arg_37_1.time_ - 1.43333333333333) / 0.066)

				var_40_23.localPosition = Vector3.New(var_40_26 * 0.13, var_40_26 * 0.13, var_40_26 * 0.13) + arg_37_1.var_.shakeOldPos
			end

			if arg_37_1.time_ >= 1.43333333333333 + var_40_24 and arg_37_1.time_ < 1.43333333333333 + var_40_24 + arg_40_0 then
				var_40_23.localPosition = arg_37_1.var_.shakeOldPos
			end
			...
			local var_40_28 = 2.6
			local var_40_29 = 0.775

			if 2.6 < arg_37_1.time_ and arg_37_1.time_ <= var_40_28 + arg_40_0 then
				...
				local var_40_30 = LeanTween.value(arg_37_1.dialog_, 0, 1, 0.3)

				var_40_30:setOnUpdate(LuaHelper.FloatAction(function(arg_41_0)
					arg_37_1.dialogCg_.alpha = arg_41_0
				end))
				var_40_30:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_37_1.dialog_)
					var_40_30:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_40_31 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(926071009).content)

				arg_37_1.text_.text = var_40_31

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_33 = 31 <= 0 and var_40_29 or var_40_29 * (utf8.len(var_40_31) / 31)

				if (31 <= 0 and var_40_29 or var_40_29 * (utf8.len(var_40_31) / 31)) > 0 and var_40_29 < var_40_33 then
					arg_37_1.talkMaxDuration = var_40_33
					var_40_28 = var_40_28 + 0.3

					if var_40_33 + var_40_28 > arg_37_1.duration_ then
						arg_37_1.duration_ = var_40_33 + var_40_28
					end
				end
			...
			local var_40_34 = var_40_28 + 0.3
			local var_40_35 = math.max(var_40_29, arg_37_1.talkMaxDuration)

			if var_40_28 + 0.3 <= arg_37_1.time_ and arg_37_1.time_ < var_40_34 + var_40_35 then
	...
	Play926071010 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0.233333333333333 < arg_43_1.time_ and arg_43_1.time_ <= 0.233333333333333 + arg_46_0 then
				...
				local var_46_4 = var_46_1.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_46_0, iter_46_1 in ipairs((var_46_4:ToTable())) do
					iter_46_1.transform.localScale = Vector3.New(iter_46_1.transform.localScale.x / var_46_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_46_4 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_46_1.transform.localScale.y / var_46_3, iter_46_1.transform.localScale.z)
				end
			end

			local var_46_6 = 0.366666666666667

			if 0.366666666666667 < arg_43_1.time_ and arg_43_1.time_ <= var_46_6 + arg_46_0 then
			...
			if arg_43_1.time_ >= var_46_10 + 2.13333333333333 and arg_43_1.time_ < var_46_10 + 2.13333333333333 + arg_46_0 then
			...
			local var_46_13 = 1.46666666666667
			local var_46_14 = 0.975

			if 1.46666666666667 < arg_43_1.time_ and arg_43_1.time_ <= var_46_13 + arg_46_0 then
				...
				local var_46_16 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(926071010).content)

				arg_43_1.text_.text = var_46_16

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_18 = 39 <= 0 and var_46_14 or var_46_14 * (utf8.len(var_46_16) / 39)

				if (39 <= 0 and var_46_14 or var_46_14 * (utf8.len(var_46_16) / 39)) > 0 and var_46_14 < var_46_18 then
	...
	Play926071020 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				...
				local var_88_8 = var_88_5.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_88_5, iter_88_6 in ipairs((var_88_8:ToTable())) do
					iter_88_6.transform.localScale = Vector3.New(iter_88_6.transform.localScale.x / var_88_7 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_88_8 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_88_6.transform.localScale.y / var_88_7, iter_88_6.transform.localScale.z)
				end
			end
			...
			if arg_85_1.time_ >= var_88_14 + 1.7 and arg_85_1.time_ < var_88_14 + 1.7 + arg_88_0 then
			...
			local var_88_16 = 1.23333333333333
			local var_88_17 = 1.15

			if 1.23333333333333 < arg_85_1.time_ and arg_85_1.time_ <= var_88_16 + arg_88_0 then
				...
				local var_88_19 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(926071020).content)

				arg_85_1.text_.text = var_88_19

				LuaForUtil.ClearLinePrefixSymbol(arg_85_1.text_)

				local var_88_21 = 46 <= 0 and var_88_17 or var_88_17 * (utf8.len(var_88_19) / 46)

				if (46 <= 0 and var_88_17 or var_88_17 * (utf8.len(var_88_19) / 46)) > 0 and var_88_17 < var_88_21 then
