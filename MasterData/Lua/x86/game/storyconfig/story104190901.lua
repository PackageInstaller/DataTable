	...
	Play419091031 = function(arg_129_0, arg_129_1)
		...
		function arg_129_1.onSingleLineUpdate_(arg_132_0)
			...
			if 0.533333333333333 < arg_129_1.time_ and arg_129_1.time_ <= 0.533333333333333 + arg_132_0 then
				...
				local var_132_6 = var_132_3.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_132_0, iter_132_1 in ipairs((var_132_6:ToTable())) do
					iter_132_1.transform.localScale = Vector3.New(iter_132_1.transform.localScale.x / var_132_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_132_6 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_132_1.transform.localScale.y / var_132_5, iter_132_1.transform.localScale.z)
				end
			end
			...
			if arg_129_1.time_ >= var_132_9 + 2.1333333303531 and arg_129_1.time_ < var_132_9 + 2.1333333303531 + arg_132_0 then
			...
			local var_132_11 = 1.36666666666667
			local var_132_12 = 1

			if 1.36666666666667 < arg_129_1.time_ and arg_129_1.time_ <= var_132_11 + arg_132_0 then
				...
				local var_132_14 = arg_129_1:FormatText(arg_129_1:GetWordFromCfg(419091031).content)

				arg_129_1.text_.text = var_132_14

				LuaForUtil.ClearLinePrefixSymbol(arg_129_1.text_)

				local var_132_16 = 40 <= 0 and var_132_12 or var_132_12 * (utf8.len(var_132_14) / 40)

				if (40 <= 0 and var_132_12 or var_132_12 * (utf8.len(var_132_14) / 40)) > 0 and var_132_12 < var_132_16 then
