return {
	Play910808001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910808001).content)
	...
	Play910808002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_5 + arg_10_0 then
				...
				local var_10_7 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910808002).content)
	...
	Play910808003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_2 + arg_14_0 then
				...
				local var_14_4 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910808003).content)

				arg_11_1.text_.text = var_14_4

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_6 = 35 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 35)

				if (35 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 35)) > 0 and var_14_3 < var_14_6 then
	...
	Play910808004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910808004).content)

				arg_15_1.text_.text = var_18_7

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_9 = 17 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 17)

				if (17 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 17)) > 0 and var_18_6 < var_18_9 then
	...
	Play910808005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_5 + arg_22_0 then
				...
				local var_22_7 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910808005).content)

				arg_19_1.text_.text = var_22_7

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_9 = 45 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 45)

				if (45 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 45)) > 0 and var_22_6 < var_22_9 then
	...
	Play910808006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 and not isNil(arg_23_1.actors_["1061"]) and arg_23_1.var_.actorSpriteComps1061 == nil then
				arg_23_1.var_.actorSpriteComps1061 = arg_23_1.actors_["1061"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_26_0 = 2

			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_0 and not isNil(arg_23_1.actors_["1061"]) then
			...
			if arg_23_1.time_ >= 0 + var_26_0 and arg_23_1.time_ < 0 + var_26_0 + arg_26_0 and not isNil(arg_23_1.actors_["1061"]) and arg_23_1.var_.actorSpriteComps1061 then
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_2 + arg_26_0 then
				...
				local var_26_4 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910808006).content)

				arg_23_1.text_.text = var_26_4

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_6 = 8 <= 0 and var_26_3 or var_26_3 * (utf8.len(var_26_4) / 8)

				if (8 <= 0 and var_26_3 or var_26_3 * (utf8.len(var_26_4) / 8)) > 0 and var_26_3 < var_26_6 then
	...
	Play910808007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910808007).content)

				arg_27_1.text_.text = var_30_7

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_9 = 6 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 6)

				if (6 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 6)) > 0 and var_30_6 < var_30_9 then
	...
	Play910808008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_2 + arg_34_0 then
				...
				local var_34_4 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910808008).content)

				arg_31_1.text_.text = var_34_4

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_6 = 19 <= 0 and var_34_3 or var_34_3 * (utf8.len(var_34_4) / 19)

				if (19 <= 0 and var_34_3 or var_34_3 * (utf8.len(var_34_4) / 19)) > 0 and var_34_3 < var_34_6 then
	...
	Play910808009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_5 + arg_38_0 then
				...
				local var_38_7 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910808009).content)
	...
	Play910808010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_2 + arg_42_0 then
				...
				local var_42_4 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910808010).content)

				arg_39_1.text_.text = var_42_4

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_6 = 14 <= 0 and var_42_3 or var_42_3 * (utf8.len(var_42_4) / 14)

				if (14 <= 0 and var_42_3 or var_42_3 * (utf8.len(var_42_4) / 14)) > 0 and var_42_3 < var_42_6 then
	...
	Play910808011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_5 + arg_46_0 then
				...
				local var_46_7 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910808011).content)
	...
	Play910808012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_5 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910808012).content)
	...
	Play910808013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_2 + arg_54_0 then
				...
				local var_54_4 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910808013).content)

				arg_51_1.text_.text = var_54_4

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_6 = 6 <= 0 and var_54_3 or var_54_3 * (utf8.len(var_54_4) / 6)

				if (6 <= 0 and var_54_3 or var_54_3 * (utf8.len(var_54_4) / 6)) > 0 and var_54_3 < var_54_6 then
	...
	Play910808014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_5 + arg_58_0 then
				...
				local var_58_7 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910808014).content)
	...
	Play910808015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_6 + arg_62_0 then
				...
				local var_62_8 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(910808015).content)

				arg_59_1.text_.text = var_62_8

				LuaForUtil.ClearLinePrefixSymbol(arg_59_1.text_)

				local var_62_10 = 21 <= 0 and var_62_7 or var_62_7 * (utf8.len(var_62_8) / 21)

				if (21 <= 0 and var_62_7 or var_62_7 * (utf8.len(var_62_8) / 21)) > 0 and var_62_7 < var_62_10 then
