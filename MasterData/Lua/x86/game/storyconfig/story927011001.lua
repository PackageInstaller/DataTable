return {
	Play927011001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_14 = 0.200666668514411

			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_14 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1211ui_story, Vector3.New(0, -0.67, -6.07), (arg_1_1.time_ - 2) / var_4_14)
			...
			if arg_1_1.time_ >= 2 + var_4_14 and arg_1_1.time_ < 2 + var_4_14 + arg_4_0 then
				var_4_13.localPosition = Vector3.New(0, -0.67, -6.07)
				var_4_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_13.position).x, (manager.ui.mainCamera.transform.position - var_4_13.position).y, (manager.ui.mainCamera.transform.position - var_4_13.position).z)
				var_4_13.localEulerAngles.z = 0
				var_4_13.localEulerAngles.x = 0
				var_4_13.localEulerAngles = var_4_13.localEulerAngles
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1211ui_story == nil then
			...
			if arg_1_1.time_ >= 2 + var_4_16 and arg_1_1.time_ < 2 + var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1211ui_story then
				arg_1_1.var_.characterEffect1211ui_story.fillFlat = false
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(927011001).content)
	...
	Play927011002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 and not isNil(arg_7_1.actors_["1211ui_story"]) and arg_7_1.var_.characterEffect1211ui_story == nil then
				arg_7_1.var_.characterEffect1211ui_story = arg_7_1.actors_["1211ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_10_0 = 0.200000002980232

			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_0 and not isNil(arg_7_1.actors_["1211ui_story"]) then
				if arg_7_1.var_.characterEffect1211ui_story and not isNil(arg_7_1.actors_["1211ui_story"]) then
					arg_7_1.var_.characterEffect1211ui_story.fillFlat = true
					arg_7_1.var_.characterEffect1211ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_7_1.time_ - 0) / var_10_0)
				end
			end

			if arg_7_1.time_ >= 0 + var_10_0 and arg_7_1.time_ < 0 + var_10_0 + arg_10_0 and not isNil(arg_7_1.actors_["1211ui_story"]) and arg_7_1.var_.characterEffect1211ui_story then
				arg_7_1.var_.characterEffect1211ui_story.fillFlat = true
				arg_7_1.var_.characterEffect1211ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				...
				local var_10_3 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(927011002).content)
	...
	Play927011003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				arg_11_1.var_.moveOldPos1211ui_story = arg_11_1.actors_["1211ui_story"].transform.localPosition
			end

			local var_14_0 = 0.001

			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_0 then
				arg_11_1.actors_["1211ui_story"].transform.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1211ui_story, Vector3.New(0, -0.67, -6.07), (arg_11_1.time_ - 0) / var_14_0)
				arg_11_1.actors_["1211ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_11_1.actors_["1211ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_11_1.actors_["1211ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_11_1.actors_["1211ui_story"].transform.position).z)
				arg_11_1.actors_["1211ui_story"].transform.localEulerAngles.z = 0
				arg_11_1.actors_["1211ui_story"].transform.localEulerAngles.x = 0
				arg_11_1.actors_["1211ui_story"].transform.localEulerAngles = arg_11_1.actors_["1211ui_story"].transform.localEulerAngles
			end

			if arg_11_1.time_ >= 0 + var_14_0 and arg_11_1.time_ < 0 + var_14_0 + arg_14_0 then
				arg_11_1.actors_["1211ui_story"].transform.localPosition = Vector3.New(0, -0.67, -6.07)
				arg_11_1.actors_["1211ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_11_1.actors_["1211ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_11_1.actors_["1211ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_11_1.actors_["1211ui_story"].transform.position).z)
				arg_11_1.actors_["1211ui_story"].transform.localEulerAngles.z = 0
				arg_11_1.actors_["1211ui_story"].transform.localEulerAngles.x = 0
				arg_11_1.actors_["1211ui_story"].transform.localEulerAngles = arg_11_1.actors_["1211ui_story"].transform.localEulerAngles
			...
			local var_14_1 = arg_11_1.actors_["1211ui_story"]

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 and not isNil(var_14_1) and arg_11_1.var_.characterEffect1211ui_story == nil then
				arg_11_1.var_.characterEffect1211ui_story = var_14_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_14_2 = 0.200000002980232

			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_2 and not isNil(var_14_1) then
				if arg_11_1.var_.characterEffect1211ui_story and not isNil(var_14_1) then
					arg_11_1.var_.characterEffect1211ui_story.fillFlat = false
				end
			end

			if arg_11_1.time_ >= 0 + var_14_2 and arg_11_1.time_ < 0 + var_14_2 + arg_14_0 and not isNil(var_14_1) and arg_11_1.var_.characterEffect1211ui_story then
				arg_11_1.var_.characterEffect1211ui_story.fillFlat = false
			end
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_4 + arg_14_0 then
				...
				local var_14_6 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(927011003).content)
	...
	Play927011004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 then
				...
				local var_18_3 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(927011004).content)

				arg_15_1.text_.text = var_18_3

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_5 = 35 <= 0 and var_18_2 or var_18_2 * (utf8.len(var_18_3) / 35)

				if (35 <= 0 and var_18_2 or var_18_2 * (utf8.len(var_18_3) / 35)) > 0 and var_18_2 < var_18_5 then
	...
	Play927011005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_1 + arg_22_0 then
				...
				local var_22_3 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(927011005).content)

				arg_19_1.text_.text = var_22_3

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_5 = 13 <= 0 and var_22_2 or var_22_2 * (utf8.len(var_22_3) / 13)

				if (13 <= 0 and var_22_2 or var_22_2 * (utf8.len(var_22_3) / 13)) > 0 and var_22_2 < var_22_5 then
	...
	Play927011006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 and not isNil(arg_23_1.actors_["1211ui_story"]) and arg_23_1.var_.characterEffect1211ui_story == nil then
				arg_23_1.var_.characterEffect1211ui_story = arg_23_1.actors_["1211ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_26_0 = 0.200000002980232

			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_0 and not isNil(arg_23_1.actors_["1211ui_story"]) then
				if arg_23_1.var_.characterEffect1211ui_story and not isNil(arg_23_1.actors_["1211ui_story"]) then
					arg_23_1.var_.characterEffect1211ui_story.fillFlat = true
					arg_23_1.var_.characterEffect1211ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_23_1.time_ - 0) / var_26_0)
				end
			end

			if arg_23_1.time_ >= 0 + var_26_0 and arg_23_1.time_ < 0 + var_26_0 + arg_26_0 and not isNil(arg_23_1.actors_["1211ui_story"]) and arg_23_1.var_.characterEffect1211ui_story then
				arg_23_1.var_.characterEffect1211ui_story.fillFlat = true
				arg_23_1.var_.characterEffect1211ui_story.fillRatio = 0.5
			end

			local var_26_1 = 0
			local var_26_2 = 0.725
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				...
				local var_26_3 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(927011006).content)

				arg_23_1.text_.text = var_26_3

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_5 = 29 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 29)

				if (29 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 29)) > 0 and var_26_2 < var_26_5 then
	...
	Play927011007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			local var_30_1 = arg_27_1.actors_["1211ui_story"]

			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect1211ui_story == nil then
				arg_27_1.var_.characterEffect1211ui_story = var_30_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_30_2 = 0.200000002980232

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_2 and not isNil(var_30_1) then
				if arg_27_1.var_.characterEffect1211ui_story and not isNil(var_30_1) then
					arg_27_1.var_.characterEffect1211ui_story.fillFlat = false
				end
			end

			if arg_27_1.time_ >= 0 + var_30_2 and arg_27_1.time_ < 0 + var_30_2 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect1211ui_story then
				arg_27_1.var_.characterEffect1211ui_story.fillFlat = false
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_4 + arg_30_0 then
				...
				local var_30_6 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(927011007).content)
	...
	Play927011008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 <= arg_31_1.time_ and arg_31_1.time_ < 0 + var_34_0 then
				arg_31_1.actors_["1211ui_story"].transform.localPosition = Vector3.Lerp(arg_31_1.var_.moveOldPos1211ui_story, Vector3.New(0, -0.67, -6.07), (arg_31_1.time_ - 0) / var_34_0)
			...
			if arg_31_1.time_ >= 0 + var_34_0 and arg_31_1.time_ < 0 + var_34_0 + arg_34_0 then
				arg_31_1.actors_["1211ui_story"].transform.localPosition = Vector3.New(0, -0.67, -6.07)
				arg_31_1.actors_["1211ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_31_1.actors_["1211ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_31_1.actors_["1211ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_31_1.actors_["1211ui_story"].transform.position).z)
				arg_31_1.actors_["1211ui_story"].transform.localEulerAngles.z = 0
				arg_31_1.actors_["1211ui_story"].transform.localEulerAngles.x = 0
				arg_31_1.actors_["1211ui_story"].transform.localEulerAngles = arg_31_1.actors_["1211ui_story"].transform.localEulerAngles
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_1 + arg_34_0 then
				...
				local var_34_3 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(927011008).content)
	...
	Play927011009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 <= arg_35_1.time_ and arg_35_1.time_ < 0 + var_38_0 then
				arg_35_1.actors_["1211ui_story"].transform.localPosition = Vector3.Lerp(arg_35_1.var_.moveOldPos1211ui_story, Vector3.New(0, -0.67, -6.07), (arg_35_1.time_ - 0) / var_38_0)
			...
			if arg_35_1.time_ >= 0 + var_38_0 and arg_35_1.time_ < 0 + var_38_0 + arg_38_0 then
				arg_35_1.actors_["1211ui_story"].transform.localPosition = Vector3.New(0, -0.67, -6.07)
				arg_35_1.actors_["1211ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_35_1.actors_["1211ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["1211ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["1211ui_story"].transform.position).z)
				arg_35_1.actors_["1211ui_story"].transform.localEulerAngles.z = 0
				arg_35_1.actors_["1211ui_story"].transform.localEulerAngles.x = 0
				arg_35_1.actors_["1211ui_story"].transform.localEulerAngles = arg_35_1.actors_["1211ui_story"].transform.localEulerAngles
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_1 + arg_38_0 then
				...
				local var_38_3 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(927011009).content)

				arg_35_1.text_.text = var_38_3

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_5 = 39 <= 0 and var_38_2 or var_38_2 * (utf8.len(var_38_3) / 39)

				if (39 <= 0 and var_38_2 or var_38_2 * (utf8.len(var_38_3) / 39)) > 0 and var_38_2 < var_38_5 then
