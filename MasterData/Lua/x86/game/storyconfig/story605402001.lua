	...
	Play605402001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(605402001).content)
	...
	Play605402002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(605402002).content)

				arg_7_1.text_.text = var_10_1

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_3 = 41 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 41)

				if (41 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 41)) > 0 and var_10_0 < var_10_3 then
