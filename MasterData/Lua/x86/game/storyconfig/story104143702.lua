return {
	Play414372001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414372001).content)
	...
	Play414372002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[1019].name)
				...
				local var_10_3 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(414372002).content)

				arg_7_1.text_.text = var_10_3

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_5 = 9 <= 0 and var_10_2 or var_10_2 * (utf8.len(var_10_3) / 9)

				if (9 <= 0 and var_10_2 or var_10_2 * (utf8.len(var_10_3) / 9)) > 0 and var_10_2 < var_10_5 then
	...
	Play414372003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 and not isNil(arg_11_1.actors_["1039ui_story"]) and arg_11_1.var_.characterEffect1039ui_story == nil then
				arg_11_1.var_.characterEffect1039ui_story = arg_11_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_14_0 = 0.200000002980232

			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_0 and not isNil(arg_11_1.actors_["1039ui_story"]) then
				if arg_11_1.var_.characterEffect1039ui_story and not isNil(arg_11_1.actors_["1039ui_story"]) then
					arg_11_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_11_1.time_ >= 0 + var_14_0 and arg_11_1.time_ < 0 + var_14_0 + arg_14_0 and not isNil(arg_11_1.actors_["1039ui_story"]) and arg_11_1.var_.characterEffect1039ui_story then
				arg_11_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_2 + arg_14_0 then
				...
				local var_14_4 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(414372003).content)

				arg_11_1.text_.text = var_14_4

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_6 = 44 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 44)

				if (44 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 44)) > 0 and var_14_3 < var_14_6 then
	...
	Play414372004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_0 then
				arg_15_1.actors_["1039ui_story"].transform.localPosition = Vector3.Lerp(arg_15_1.var_.moveOldPos1039ui_story, Vector3.New(0, -1.01, -5.9), (arg_15_1.time_ - 0) / var_18_0)
			...
			if arg_15_1.time_ >= 0 + var_18_0 and arg_15_1.time_ < 0 + var_18_0 + arg_18_0 then
				arg_15_1.actors_["1039ui_story"].transform.localPosition = Vector3.New(0, -1.01, -5.9)
				arg_15_1.actors_["1039ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_15_1.actors_["1039ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_15_1.actors_["1039ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_15_1.actors_["1039ui_story"].transform.position).z)
				arg_15_1.actors_["1039ui_story"].transform.localEulerAngles.z = 0
				arg_15_1.actors_["1039ui_story"].transform.localEulerAngles.x = 0
				arg_15_1.actors_["1039ui_story"].transform.localEulerAngles = arg_15_1.actors_["1039ui_story"].transform.localEulerAngles
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_4 + arg_18_0 then
				...
				local var_18_6 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(414372004).content)

				arg_15_1.text_.text = var_18_6

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_8 = 50 <= 0 and var_18_5 or var_18_5 * (utf8.len(var_18_6) / 50)

				if (50 <= 0 and var_18_5 or var_18_5 * (utf8.len(var_18_6) / 50)) > 0 and var_18_5 < var_18_8 then
	...
	Play414372005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 and not isNil(arg_19_1.actors_["1039ui_story"]) and arg_19_1.var_.characterEffect1039ui_story == nil then
				arg_19_1.var_.characterEffect1039ui_story = arg_19_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_22_0 = 0.200000002980232

			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_0 and not isNil(arg_19_1.actors_["1039ui_story"]) then
				if arg_19_1.var_.characterEffect1039ui_story and not isNil(arg_19_1.actors_["1039ui_story"]) then
					arg_19_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_19_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_19_1.time_ - 0) / var_22_0)
				end
			end

			if arg_19_1.time_ >= 0 + var_22_0 and arg_19_1.time_ < 0 + var_22_0 + arg_22_0 and not isNil(arg_19_1.actors_["1039ui_story"]) and arg_19_1.var_.characterEffect1039ui_story then
				arg_19_1.var_.characterEffect1039ui_story.fillFlat = true
				arg_19_1.var_.characterEffect1039ui_story.fillRatio = 0.5
			end

			local var_22_1 = 0
			local var_22_2 = 0.425
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_1 + arg_22_0 then
				...
				local var_22_3 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(414372005).content)

				arg_19_1.text_.text = var_22_3

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_5 = 17 <= 0 and var_22_2 or var_22_2 * (utf8.len(var_22_3) / 17)

				if (17 <= 0 and var_22_2 or var_22_2 * (utf8.len(var_22_3) / 17)) > 0 and var_22_2 < var_22_5 then
	...
	Play414372006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_0 then
				arg_23_1.actors_["1039ui_story"].transform.localPosition = Vector3.Lerp(arg_23_1.var_.moveOldPos1039ui_story, Vector3.New(0, -1.01, -5.9), (arg_23_1.time_ - 0) / var_26_0)
			...
			if arg_23_1.time_ >= 0 + var_26_0 and arg_23_1.time_ < 0 + var_26_0 + arg_26_0 then
				arg_23_1.actors_["1039ui_story"].transform.localPosition = Vector3.New(0, -1.01, -5.9)
				arg_23_1.actors_["1039ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_23_1.actors_["1039ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_23_1.actors_["1039ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_23_1.actors_["1039ui_story"].transform.position).z)
				arg_23_1.actors_["1039ui_story"].transform.localEulerAngles.z = 0
				arg_23_1.actors_["1039ui_story"].transform.localEulerAngles.x = 0
				arg_23_1.actors_["1039ui_story"].transform.localEulerAngles = arg_23_1.actors_["1039ui_story"].transform.localEulerAngles
			...
			local var_26_1 = arg_23_1.actors_["1039ui_story"]

			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 and not isNil(var_26_1) and arg_23_1.var_.characterEffect1039ui_story == nil then
				arg_23_1.var_.characterEffect1039ui_story = var_26_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_26_2 = 0.200000002980232

			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_2 and not isNil(var_26_1) then
				if arg_23_1.var_.characterEffect1039ui_story and not isNil(var_26_1) then
					arg_23_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_23_1.time_ >= 0 + var_26_2 and arg_23_1.time_ < 0 + var_26_2 + arg_26_0 and not isNil(var_26_1) and arg_23_1.var_.characterEffect1039ui_story then
				arg_23_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_4 + arg_26_0 then
				...
				local var_26_6 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(414372006).content)

				arg_23_1.text_.text = var_26_6

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_8 = 14 <= 0 and var_26_5 or var_26_5 * (utf8.len(var_26_6) / 14)

				if (14 <= 0 and var_26_5 or var_26_5 * (utf8.len(var_26_6) / 14)) > 0 and var_26_5 < var_26_8 then
	...
	Play414372007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_0 then
				arg_27_1.actors_["1039ui_story"].transform.localPosition = Vector3.Lerp(arg_27_1.var_.moveOldPos1039ui_story, Vector3.New(0, 100, 0), (arg_27_1.time_ - 0) / var_30_0)
			...
			if arg_27_1.time_ >= 0 + var_30_0 and arg_27_1.time_ < 0 + var_30_0 + arg_30_0 then
				arg_27_1.actors_["1039ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_27_1.actors_["1039ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_27_1.actors_["1039ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["1039ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["1039ui_story"].transform.position).z)
				arg_27_1.actors_["1039ui_story"].transform.localEulerAngles.z = 0
				arg_27_1.actors_["1039ui_story"].transform.localEulerAngles.x = 0
				arg_27_1.actors_["1039ui_story"].transform.localEulerAngles = arg_27_1.actors_["1039ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_2 and not isNil(var_30_1) then
				if arg_27_1.var_.characterEffect1039ui_story and not isNil(var_30_1) then
					...
					arg_27_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_27_1.time_ - 0) / var_30_2)
				end
			end
			...
			if arg_27_1.time_ >= 0 + var_30_2 and arg_27_1.time_ < 0 + var_30_2 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect1039ui_story then
				arg_27_1.var_.characterEffect1039ui_story.fillFlat = true
				arg_27_1.var_.characterEffect1039ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_3 + arg_30_0 then
				...
				local var_30_5 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(414372007).content)

				arg_27_1.text_.text = var_30_5

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_7 = 40 <= 0 and var_30_4 or var_30_4 * (utf8.len(var_30_5) / 40)

				if (40 <= 0 and var_30_4 or var_30_4 * (utf8.len(var_30_5) / 40)) > 0 and var_30_4 < var_30_7 then
	...
	Play414372008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				...
				local var_34_1 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(414372008).content)

				arg_31_1.text_.text = var_34_1

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_3 = 31 <= 0 and var_34_0 or var_34_0 * (utf8.len(var_34_1) / 31)

				if (31 <= 0 and var_34_0 or var_34_0 * (utf8.len(var_34_1) / 31)) > 0 and var_34_0 < var_34_3 then
	...
	Play414372009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			if arg_35_1.actors_["104902ui_story"] == nil and not isNil((Asset.Load("Char/" .. "104902ui_story"))) then
				local var_38_0 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_35_1.stage_.transform)

				var_38_0.name = "104902ui_story"
				var_38_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_35_1.actors_["104902ui_story"] = var_38_0
				...
				arg_35_1.var_["104902ui_story" .. "Animator"] = var_38_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_35_1.var_["104902ui_story" .. "Animator"].applyRootMotion = true
				arg_35_1.var_["104902ui_story" .. "LipSync"] = var_38_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_38_3 = arg_35_1.actors_["104902ui_story"].transform

			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				arg_35_1.var_.moveOldPos104902ui_story = var_38_3.localPosition
			end

			local var_38_4 = 0.001

			if 0 <= arg_35_1.time_ and arg_35_1.time_ < 0 + var_38_4 then
				var_38_3.localPosition = Vector3.Lerp(arg_35_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_35_1.time_ - 0) / var_38_4)
			...
			if arg_35_1.time_ >= 0 + var_38_4 and arg_35_1.time_ < 0 + var_38_4 + arg_38_0 then
				var_38_3.localPosition = Vector3.New(0, -1.2, -6)
				var_38_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_38_3.position).x, (manager.ui.mainCamera.transform.position - var_38_3.position).y, (manager.ui.mainCamera.transform.position - var_38_3.position).z)
				var_38_3.localEulerAngles.z = 0
				var_38_3.localEulerAngles.x = 0
				var_38_3.localEulerAngles = var_38_3.localEulerAngles
			...
			local var_38_5 = arg_35_1.actors_["104902ui_story"]

			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 and not isNil(var_38_5) and arg_35_1.var_.characterEffect104902ui_story == nil then
				arg_35_1.var_.characterEffect104902ui_story = var_38_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_38_6 = 0.200000002980232

			if 0 <= arg_35_1.time_ and arg_35_1.time_ < 0 + var_38_6 and not isNil(var_38_5) then
				if arg_35_1.var_.characterEffect104902ui_story and not isNil(var_38_5) then
					arg_35_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_35_1.time_ >= 0 + var_38_6 and arg_35_1.time_ < 0 + var_38_6 + arg_38_0 and not isNil(var_38_5) and arg_35_1.var_.characterEffect104902ui_story then
				arg_35_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_8 + arg_38_0 then
				...
				local var_38_10 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(414372009).content)

				arg_35_1.text_.text = var_38_10

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_12 = 7 <= 0 and var_38_9 or var_38_9 * (utf8.len(var_38_10) / 7)

				if (7 <= 0 and var_38_9 or var_38_9 * (utf8.len(var_38_10) / 7)) > 0 and var_38_9 < var_38_12 then
					arg_35_1.talkMaxDuration = var_38_12

					if var_38_12 + var_38_8 > arg_35_1.duration_ then
						arg_35_1.duration_ = var_38_12 + var_38_8
					end
				end
			...
			local var_38_13 = math.max(var_38_9, arg_35_1.talkMaxDuration)

			if var_38_8 <= arg_35_1.time_ and arg_35_1.time_ < var_38_8 + var_38_13 then
				arg_35_1.typewritter.percent = (arg_35_1.time_ - var_38_8) / var_38_13

				arg_35_1.typewritter:SetDirty()
			end

			if arg_35_1.time_ >= var_38_8 + var_38_13 and arg_35_1.time_ < var_38_8 + var_38_13 + arg_38_0 then
