return {
	Play111141001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_4 = arg_1_1.bgs_.D999:GetComponent("SpriteRenderer")

				if var_4_4 then
					arg_1_1.var_.alphaOldValueD999 = var_4_4.color.a
					arg_1_1.var_.alphaMatValueD999 = var_4_4
				end
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_5 then
				if arg_1_1.var_.alphaMatValueD999 then
					arg_1_1.var_.alphaMatValueD999.color.a = Mathf.Lerp(arg_1_1.var_.alphaOldValueD999, 1, (arg_1_1.time_ - 0) / var_4_5)
					arg_1_1.var_.alphaMatValueD999.color = arg_1_1.var_.alphaMatValueD999.color
				end
			end

			if arg_1_1.time_ >= 0 + var_4_5 and arg_1_1.time_ < 0 + var_4_5 + arg_4_0 and arg_1_1.var_.alphaMatValueD999 then
				arg_1_1.var_.alphaMatValueD999.color.a = 1
				arg_1_1.var_.alphaMatValueD999.color = arg_1_1.var_.alphaMatValueD999.color
			end

			local var_4_6 = "1094ui_story"

			if arg_1_1.actors_["1094ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1094ui_story"))) then
				local var_4_7 = Object.Instantiate(Asset.Load("Char/" .. "1094ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_10 = arg_1_1.actors_["1094ui_story"].transform

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1.var_.moveOldPos1094ui_story = var_4_10.localPosition
			end

			local var_4_11 = 0.001

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_11 then
				var_4_10.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1094ui_story, Vector3.New(0, -0.84, -6.1), (arg_1_1.time_ - 1.8) / var_4_11)
			...
			if arg_1_1.time_ >= 1.8 + var_4_11 and arg_1_1.time_ < 1.8 + var_4_11 + arg_4_0 then
				var_4_10.localPosition = Vector3.New(0, -0.84, -6.1)
				var_4_10.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_10.position).x, (manager.ui.mainCamera.transform.position - var_4_10.position).y, (manager.ui.mainCamera.transform.position - var_4_10.position).z)
				var_4_10.localEulerAngles.z = 0
				var_4_10.localEulerAngles.x = 0
				var_4_10.localEulerAngles = var_4_10.localEulerAngles
			...
			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1:PlayTimeline("1094ui_story", "StoryTimeline/CharAction/story1094/story1094action/1094action1_1")
			end

			if 1.80833333333333 < arg_1_1.time_ and arg_1_1.time_ <= 1.80833333333333 + arg_4_0 then
				arg_1_1:PlayTimeline("1094ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface2104cva")
			end

			local var_4_12 = arg_1_1.actors_["1094ui_story"]

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.characterEffect1094ui_story == nil then
				arg_1_1.var_.characterEffect1094ui_story = var_4_12:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_13 = 0.2

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_13 and not isNil(var_4_12) then
				if arg_1_1.var_.characterEffect1094ui_story and not isNil(var_4_12) then
					arg_1_1.var_.characterEffect1094ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 1.8 + var_4_13 and arg_1_1.time_ < 1.8 + var_4_13 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.characterEffect1094ui_story then
				arg_1_1.var_.characterEffect1094ui_story.fillFlat = false
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				...
				local var_4_25 = arg_1_1:GetWordFromCfg(111141001)
				...
				local var_4_28 = 7 <= 0 and var_4_23 or var_4_23 * (utf8.len(var_4_26) / 7)

				if (7 <= 0 and var_4_23 or var_4_23 * (utf8.len(var_4_26) / 7)) > 0 and var_4_23 < var_4_28 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141001", "story_v_out_111141.awb") ~= 0 then
					local var_4_29 = manager.audio:GetVoiceLength("story_v_out_111141", "111141001", "story_v_out_111141.awb") / 1000
					...
					if var_4_25.prefab_name ~= "" and arg_1_1.actors_[var_4_25.prefab_name] ~= nil then
						local var_4_30 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_25.prefab_name].transform, "story_v_out_111141", "111141001", "story_v_out_111141.awb")

						arg_1_1:RecordAudio("111141001", var_4_30)
						arg_1_1:RecordAudio("111141001", var_4_30)
					else
	...
	Play111141002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(arg_9_1.actors_["1094ui_story"]) and arg_9_1.var_.characterEffect1094ui_story == nil then
				arg_9_1.var_.characterEffect1094ui_story = arg_9_1.actors_["1094ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_0 = 0.2

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_0 and not isNil(arg_9_1.actors_["1094ui_story"]) then
				if arg_9_1.var_.characterEffect1094ui_story and not isNil(arg_9_1.actors_["1094ui_story"]) then
					arg_9_1.var_.characterEffect1094ui_story.fillFlat = true
					arg_9_1.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_9_1.time_ - 0) / var_12_0)
				end
			end

			if arg_9_1.time_ >= 0 + var_12_0 and arg_9_1.time_ < 0 + var_12_0 + arg_12_0 and not isNil(arg_9_1.actors_["1094ui_story"]) and arg_9_1.var_.characterEffect1094ui_story then
				arg_9_1.var_.characterEffect1094ui_story.fillFlat = true
				arg_9_1.var_.characterEffect1094ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				arg_9_1.leftNameTxt_.text = arg_9_1:FormatText(StoryNameCfg[185].name)
				...
				local var_12_3 = arg_9_1:GetWordFromCfg(111141002)
				...
				local var_12_6 = 7 <= 0 and var_12_2 or var_12_2 * (utf8.len(var_12_4) / 7)

				if (7 <= 0 and var_12_2 or var_12_2 * (utf8.len(var_12_4) / 7)) > 0 and var_12_2 < var_12_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141002", "story_v_out_111141.awb") ~= 0 then
					local var_12_7 = manager.audio:GetVoiceLength("story_v_out_111141", "111141002", "story_v_out_111141.awb") / 1000
					...
					if var_12_3.prefab_name ~= "" and arg_9_1.actors_[var_12_3.prefab_name] ~= nil then
						local var_12_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_3.prefab_name].transform, "story_v_out_111141", "111141002", "story_v_out_111141.awb")

						arg_9_1:RecordAudio("111141002", var_12_8)
						arg_9_1:RecordAudio("111141002", var_12_8)
					else
	...
	Play111141003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				arg_13_1.leftNameTxt_.text = arg_13_1:FormatText(StoryNameCfg[185].name)
				...
				local var_16_1 = arg_13_1:GetWordFromCfg(111141003)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141003", "story_v_out_111141.awb") ~= 0 then
					local var_16_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141003", "story_v_out_111141.awb") / 1000
					...
					if var_16_1.prefab_name ~= "" and arg_13_1.actors_[var_16_1.prefab_name] ~= nil then
						local var_16_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_1.prefab_name].transform, "story_v_out_111141", "111141003", "story_v_out_111141.awb")

						arg_13_1:RecordAudio("111141003", var_16_6)
						arg_13_1:RecordAudio("111141003", var_16_6)
					else
	...
	Play111141004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			local var_20_0 = arg_17_1.actors_["1094ui_story"]

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(var_20_0) and arg_17_1.var_.characterEffect1094ui_story == nil then
				arg_17_1.var_.characterEffect1094ui_story = var_20_0:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_1 = 0.2

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_1 and not isNil(var_20_0) then
				if arg_17_1.var_.characterEffect1094ui_story and not isNil(var_20_0) then
					arg_17_1.var_.characterEffect1094ui_story.fillFlat = false
				end
			end

			if arg_17_1.time_ >= 0 + var_20_1 and arg_17_1.time_ < 0 + var_20_1 + arg_20_0 and not isNil(var_20_0) and arg_17_1.var_.characterEffect1094ui_story then
				arg_17_1.var_.characterEffect1094ui_story.fillFlat = false
			end
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_3 + arg_20_0 then
				...
				local var_20_5 = arg_17_1:GetWordFromCfg(111141004)
				...
				local var_20_8 = 10 <= 0 and var_20_4 or var_20_4 * (utf8.len(var_20_6) / 10)

				if (10 <= 0 and var_20_4 or var_20_4 * (utf8.len(var_20_6) / 10)) > 0 and var_20_4 < var_20_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141004", "story_v_out_111141.awb") ~= 0 then
					local var_20_9 = manager.audio:GetVoiceLength("story_v_out_111141", "111141004", "story_v_out_111141.awb") / 1000
					...
					if var_20_5.prefab_name ~= "" and arg_17_1.actors_[var_20_5.prefab_name] ~= nil then
						local var_20_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_5.prefab_name].transform, "story_v_out_111141", "111141004", "story_v_out_111141.awb")

						arg_17_1:RecordAudio("111141004", var_20_10)
						arg_17_1:RecordAudio("111141004", var_20_10)
					else
	...
	Play111141005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1:PlayTimeline("1094ui_story", "StoryTimeline/CharAction/story1094/story1094action/1094action5_1")
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_2 = arg_21_1:GetWordFromCfg(111141005)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141005", "story_v_out_111141.awb") ~= 0 then
					local var_24_6 = manager.audio:GetVoiceLength("story_v_out_111141", "111141005", "story_v_out_111141.awb") / 1000
					...
					if var_24_2.prefab_name ~= "" and arg_21_1.actors_[var_24_2.prefab_name] ~= nil then
						local var_24_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_2.prefab_name].transform, "story_v_out_111141", "111141005", "story_v_out_111141.awb")

						arg_21_1:RecordAudio("111141005", var_24_7)
						arg_21_1:RecordAudio("111141005", var_24_7)
					else
	...
	Play111141006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(arg_25_1.actors_["1094ui_story"]) and arg_25_1.var_.characterEffect1094ui_story == nil then
				arg_25_1.var_.characterEffect1094ui_story = arg_25_1.actors_["1094ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_28_0 = 0.2

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_0 and not isNil(arg_25_1.actors_["1094ui_story"]) then
				if arg_25_1.var_.characterEffect1094ui_story and not isNil(arg_25_1.actors_["1094ui_story"]) then
					arg_25_1.var_.characterEffect1094ui_story.fillFlat = true
					arg_25_1.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_25_1.time_ - 0) / var_28_0)
				end
			end

			if arg_25_1.time_ >= 0 + var_28_0 and arg_25_1.time_ < 0 + var_28_0 + arg_28_0 and not isNil(arg_25_1.actors_["1094ui_story"]) and arg_25_1.var_.characterEffect1094ui_story then
				arg_25_1.var_.characterEffect1094ui_story.fillFlat = true
				arg_25_1.var_.characterEffect1094ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				arg_25_1.leftNameTxt_.text = arg_25_1:FormatText(StoryNameCfg[185].name)
				...
				local var_28_3 = arg_25_1:GetWordFromCfg(111141006)
				...
				local var_28_6 = 16 <= 0 and var_28_2 or var_28_2 * (utf8.len(var_28_4) / 16)

				if (16 <= 0 and var_28_2 or var_28_2 * (utf8.len(var_28_4) / 16)) > 0 and var_28_2 < var_28_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141006", "story_v_out_111141.awb") ~= 0 then
					local var_28_7 = manager.audio:GetVoiceLength("story_v_out_111141", "111141006", "story_v_out_111141.awb") / 1000
					...
					if var_28_3.prefab_name ~= "" and arg_25_1.actors_[var_28_3.prefab_name] ~= nil then
						local var_28_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_3.prefab_name].transform, "story_v_out_111141", "111141006", "story_v_out_111141.awb")

						arg_25_1:RecordAudio("111141006", var_28_8)
						arg_25_1:RecordAudio("111141006", var_28_8)
					else
	...
	Play111141007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				arg_29_1.leftNameTxt_.text = arg_29_1:FormatText(StoryNameCfg[185].name)
				...
				local var_32_1 = arg_29_1:GetWordFromCfg(111141007)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141007", "story_v_out_111141.awb") ~= 0 then
					local var_32_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141007", "story_v_out_111141.awb") / 1000
					...
					if var_32_1.prefab_name ~= "" and arg_29_1.actors_[var_32_1.prefab_name] ~= nil then
						local var_32_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_1.prefab_name].transform, "story_v_out_111141", "111141007", "story_v_out_111141.awb")

						arg_29_1:RecordAudio("111141007", var_32_6)
						arg_29_1:RecordAudio("111141007", var_32_6)
					else
	...
	Play111141008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				arg_33_1.leftNameTxt_.text = arg_33_1:FormatText(StoryNameCfg[185].name)
				...
				local var_36_1 = arg_33_1:GetWordFromCfg(111141008)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141008", "story_v_out_111141.awb") ~= 0 then
					local var_36_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141008", "story_v_out_111141.awb") / 1000
					...
					if var_36_1.prefab_name ~= "" and arg_33_1.actors_[var_36_1.prefab_name] ~= nil then
						local var_36_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_1.prefab_name].transform, "story_v_out_111141", "111141008", "story_v_out_111141.awb")

						arg_33_1:RecordAudio("111141008", var_36_6)
						arg_33_1:RecordAudio("111141008", var_36_6)
					else
	...
	Play111141009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				arg_37_1.leftNameTxt_.text = arg_37_1:FormatText(StoryNameCfg[185].name)
				...
				local var_40_1 = arg_37_1:GetWordFromCfg(111141009)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141009", "story_v_out_111141.awb") ~= 0 then
					local var_40_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141009", "story_v_out_111141.awb") / 1000
					...
					if var_40_1.prefab_name ~= "" and arg_37_1.actors_[var_40_1.prefab_name] ~= nil then
						local var_40_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_1.prefab_name].transform, "story_v_out_111141", "111141009", "story_v_out_111141.awb")

						arg_37_1:RecordAudio("111141009", var_40_6)
						arg_37_1:RecordAudio("111141009", var_40_6)
					else
	...
	Play111141010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				...
				arg_41_1.leftNameTxt_.text = arg_41_1:FormatText(StoryNameCfg[185].name)
				...
				local var_44_1 = arg_41_1:GetWordFromCfg(111141010)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141010", "story_v_out_111141.awb") ~= 0 then
					local var_44_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141010", "story_v_out_111141.awb") / 1000
					...
					if var_44_1.prefab_name ~= "" and arg_41_1.actors_[var_44_1.prefab_name] ~= nil then
						local var_44_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_1.prefab_name].transform, "story_v_out_111141", "111141010", "story_v_out_111141.awb")

						arg_41_1:RecordAudio("111141010", var_44_6)
						arg_41_1:RecordAudio("111141010", var_44_6)
					else
	...
	Play111141011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_3 + arg_48_0 then
				...
				local var_48_5 = arg_45_1:GetWordFromCfg(111141011)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141011", "story_v_out_111141.awb") ~= 0 then
					local var_48_9 = manager.audio:GetVoiceLength("story_v_out_111141", "111141011", "story_v_out_111141.awb") / 1000
					...
					if var_48_5.prefab_name ~= "" and arg_45_1.actors_[var_48_5.prefab_name] ~= nil then
						local var_48_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_5.prefab_name].transform, "story_v_out_111141", "111141011", "story_v_out_111141.awb")

						arg_45_1:RecordAudio("111141011", var_48_10)
						arg_45_1:RecordAudio("111141011", var_48_10)
					else
	...
	Play111141012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1.var_.moveOldPos1094ui_story = arg_49_1.actors_["1094ui_story"].transform.localPosition
			end

			local var_52_0 = 0.001

			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_0 then
				arg_49_1.actors_["1094ui_story"].transform.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos1094ui_story, Vector3.New(0, 100, 0), (arg_49_1.time_ - 0) / var_52_0)
				arg_49_1.actors_["1094ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_49_1.actors_["1094ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_49_1.actors_["1094ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_49_1.actors_["1094ui_story"].transform.position).z)
				arg_49_1.actors_["1094ui_story"].transform.localEulerAngles.z = 0
				arg_49_1.actors_["1094ui_story"].transform.localEulerAngles.x = 0
				arg_49_1.actors_["1094ui_story"].transform.localEulerAngles = arg_49_1.actors_["1094ui_story"].transform.localEulerAngles
			end

			if arg_49_1.time_ >= 0 + var_52_0 and arg_49_1.time_ < 0 + var_52_0 + arg_52_0 then
				arg_49_1.actors_["1094ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_49_1.actors_["1094ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_49_1.actors_["1094ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_49_1.actors_["1094ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_49_1.actors_["1094ui_story"].transform.position).z)
				arg_49_1.actors_["1094ui_story"].transform.localEulerAngles.z = 0
				arg_49_1.actors_["1094ui_story"].transform.localEulerAngles.x = 0
				arg_49_1.actors_["1094ui_story"].transform.localEulerAngles = arg_49_1.actors_["1094ui_story"].transform.localEulerAngles
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(111141012).content)
	...
	Play111141013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				...
				arg_53_1.leftNameTxt_.text = arg_53_1:FormatText(StoryNameCfg[178].name)
				...
				local var_56_1 = arg_53_1:GetWordFromCfg(111141013)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141013", "story_v_out_111141.awb") ~= 0 then
					local var_56_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141013", "story_v_out_111141.awb") / 1000
					...
					if var_56_1.prefab_name ~= "" and arg_53_1.actors_[var_56_1.prefab_name] ~= nil then
						local var_56_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_1.prefab_name].transform, "story_v_out_111141", "111141013", "story_v_out_111141.awb")

						arg_53_1:RecordAudio("111141013", var_56_6)
						arg_53_1:RecordAudio("111141013", var_56_6)
					else
	...
	Play111141014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 and not isNil(var_60_0) and arg_57_1.var_.characterEffect1094ui_story == nil then
			...
			if arg_57_1.time_ >= 0 + var_60_1 and arg_57_1.time_ < 0 + var_60_1 + arg_60_0 and not isNil(var_60_0) and arg_57_1.var_.characterEffect1094ui_story then
				arg_57_1.var_.characterEffect1094ui_story.fillFlat = false
			end

			local var_60_3 = arg_57_1.actors_["1094ui_story"].transform

			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1.var_.moveOldPos1094ui_story = var_60_3.localPosition
			end

			local var_60_4 = 0.001

			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_4 then
				var_60_3.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos1094ui_story, Vector3.New(0, -0.84, -6.1), (arg_57_1.time_ - 0) / var_60_4)
			...
			if arg_57_1.time_ >= 0 + var_60_4 and arg_57_1.time_ < 0 + var_60_4 + arg_60_0 then
				var_60_3.localPosition = Vector3.New(0, -0.84, -6.1)
				var_60_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_60_3.position).x, (manager.ui.mainCamera.transform.position - var_60_3.position).y, (manager.ui.mainCamera.transform.position - var_60_3.position).z)
				var_60_3.localEulerAngles.z = 0
				var_60_3.localEulerAngles.x = 0
				var_60_3.localEulerAngles = var_60_3.localEulerAngles
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1:PlayTimeline("1094ui_story", "StoryTimeline/CharAction/story1094/story1094action/1094action5_2")
			end
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_5 + arg_60_0 then
				...
				local var_60_7 = arg_57_1:GetWordFromCfg(111141014)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141014", "story_v_out_111141.awb") ~= 0 then
					local var_60_11 = manager.audio:GetVoiceLength("story_v_out_111141", "111141014", "story_v_out_111141.awb") / 1000
					...
					if var_60_7.prefab_name ~= "" and arg_57_1.actors_[var_60_7.prefab_name] ~= nil then
						local var_60_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_57_1.actors_[var_60_7.prefab_name].transform, "story_v_out_111141", "111141014", "story_v_out_111141.awb")

						arg_57_1:RecordAudio("111141014", var_60_12)
						arg_57_1:RecordAudio("111141014", var_60_12)
					else
	...
	Play111141015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_1 + arg_64_0 then
				...
				arg_61_1.leftNameTxt_.text = arg_61_1:FormatText(StoryNameCfg[178].name)
				...
				local var_64_3 = arg_61_1:GetWordFromCfg(111141015)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141015", "story_v_out_111141.awb") ~= 0 then
					local var_64_7 = manager.audio:GetVoiceLength("story_v_out_111141", "111141015", "story_v_out_111141.awb") / 1000
					...
					if var_64_3.prefab_name ~= "" and arg_61_1.actors_[var_64_3.prefab_name] ~= nil then
						local var_64_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_61_1.actors_[var_64_3.prefab_name].transform, "story_v_out_111141", "111141015", "story_v_out_111141.awb")

						arg_61_1:RecordAudio("111141015", var_64_8)
						arg_61_1:RecordAudio("111141015", var_64_8)
					else
	...
	Play111141016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				...
				arg_65_1.leftNameTxt_.text = arg_65_1:FormatText(StoryNameCfg[178].name)
				...
				local var_68_1 = arg_65_1:GetWordFromCfg(111141016)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141016", "story_v_out_111141.awb") ~= 0 then
					local var_68_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141016", "story_v_out_111141.awb") / 1000
					...
					if var_68_1.prefab_name ~= "" and arg_65_1.actors_[var_68_1.prefab_name] ~= nil then
						local var_68_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_65_1.actors_[var_68_1.prefab_name].transform, "story_v_out_111141", "111141016", "story_v_out_111141.awb")

						arg_65_1:RecordAudio("111141016", var_68_6)
						arg_65_1:RecordAudio("111141016", var_68_6)
					else
	...
	Play111141017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				...
				arg_69_1.leftNameTxt_.text = arg_69_1:FormatText(StoryNameCfg[178].name)
				...
				local var_72_1 = arg_69_1:GetWordFromCfg(111141017)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141017", "story_v_out_111141.awb") ~= 0 then
					local var_72_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141017", "story_v_out_111141.awb") / 1000
					...
					if var_72_1.prefab_name ~= "" and arg_69_1.actors_[var_72_1.prefab_name] ~= nil then
						local var_72_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_69_1.actors_[var_72_1.prefab_name].transform, "story_v_out_111141", "111141017", "story_v_out_111141.awb")

						arg_69_1:RecordAudio("111141017", var_72_6)
						arg_69_1:RecordAudio("111141017", var_72_6)
					else
	...
	Play111141018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				...
				arg_73_1.leftNameTxt_.text = arg_73_1:FormatText(StoryNameCfg[178].name)
				...
				local var_76_1 = arg_73_1:GetWordFromCfg(111141018)
				...
				local var_76_4 = 18 <= 0 and var_76_0 or var_76_0 * (utf8.len(var_76_2) / 18)

				if (18 <= 0 and var_76_0 or var_76_0 * (utf8.len(var_76_2) / 18)) > 0 and var_76_0 < var_76_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141018", "story_v_out_111141.awb") ~= 0 then
					local var_76_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141018", "story_v_out_111141.awb") / 1000
					...
					if var_76_1.prefab_name ~= "" and arg_73_1.actors_[var_76_1.prefab_name] ~= nil then
						local var_76_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_73_1.actors_[var_76_1.prefab_name].transform, "story_v_out_111141", "111141018", "story_v_out_111141.awb")

						arg_73_1:RecordAudio("111141018", var_76_6)
						arg_73_1:RecordAudio("111141018", var_76_6)
					else
	...
	Play111141019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				...
				arg_77_1.leftNameTxt_.text = arg_77_1:FormatText(StoryNameCfg[178].name)
				...
				local var_80_1 = arg_77_1:GetWordFromCfg(111141019)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141019", "story_v_out_111141.awb") ~= 0 then
					local var_80_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141019", "story_v_out_111141.awb") / 1000
					...
					if var_80_1.prefab_name ~= "" and arg_77_1.actors_[var_80_1.prefab_name] ~= nil then
						local var_80_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_77_1.actors_[var_80_1.prefab_name].transform, "story_v_out_111141", "111141019", "story_v_out_111141.awb")

						arg_77_1:RecordAudio("111141019", var_80_6)
						arg_77_1:RecordAudio("111141019", var_80_6)
					else
	...
	Play111141020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= 0 + arg_84_0 then
				...
				arg_81_1.leftNameTxt_.text = arg_81_1:FormatText(StoryNameCfg[178].name)
				...
				local var_84_1 = arg_81_1:GetWordFromCfg(111141020)
				...
				if manager.audio:GetVoiceLength("story_v_out_111141", "111141020", "story_v_out_111141.awb") ~= 0 then
					local var_84_5 = manager.audio:GetVoiceLength("story_v_out_111141", "111141020", "story_v_out_111141.awb") / 1000
					...
					if var_84_1.prefab_name ~= "" and arg_81_1.actors_[var_84_1.prefab_name] ~= nil then
						local var_84_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_81_1.actors_[var_84_1.prefab_name].transform, "story_v_out_111141", "111141020", "story_v_out_111141.awb")

						arg_81_1:RecordAudio("111141020", var_84_6)
						arg_81_1:RecordAudio("111141020", var_84_6)
					else
