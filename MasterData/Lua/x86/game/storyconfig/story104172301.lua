	...
	Play417231123 = function(arg_514_0, arg_514_1)
		...
		function arg_514_1.onSingleLineUpdate_(arg_517_0)
			...
			if 2 < arg_514_1.time_ and arg_514_1.time_ <= 2 + arg_517_0 then
				...
				local var_517_20 = var_517_17.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_517_2, iter_517_3 in ipairs((var_517_20:ToTable())) do
					iter_517_3.transform.localScale = Vector3.New(iter_517_3.transform.localScale.x / var_517_19 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_517_20 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_517_3.transform.localScale.y / var_517_19, iter_517_3.transform.localScale.z)
				end
			end
			...
			local var_517_22 = 4
			local var_517_23 = 0.475

			if 4 < arg_514_1.time_ and arg_514_1.time_ <= var_517_22 + arg_517_0 then
				...
				local var_517_24 = LeanTween.value(arg_514_1.dialog_, 0, 1, 0.3)

				var_517_24:setOnUpdate(LuaHelper.FloatAction(function(arg_518_0)
					arg_514_1.dialogCg_.alpha = arg_518_0
				end))
				var_517_24:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_514_1.dialog_)
					var_517_24:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_517_25 = arg_514_1:GetWordFromCfg(417231123)
				local var_517_26 = arg_514_1:FormatText(var_517_25.content)

				arg_514_1.text_.text = var_517_26

				LuaForUtil.ClearLinePrefixSymbol(arg_514_1.text_)

				local var_517_28 = 19 <= 0 and var_517_23 or var_517_23 * (utf8.len(var_517_26) / 19)

				if (19 <= 0 and var_517_23 or var_517_23 * (utf8.len(var_517_26) / 19)) > 0 and var_517_23 < var_517_28 then
					arg_514_1.talkMaxDuration = var_517_28
					var_517_22 = var_517_22 + 0.3

					if var_517_28 + var_517_22 > arg_514_1.duration_ then
						arg_514_1.duration_ = var_517_28 + var_517_22
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_417231", "417231123", "story_v_out_417231.awb") ~= 0 then
					local var_517_29 = manager.audio:GetVoiceLength("story_v_out_417231", "417231123", "story_v_out_417231.awb") / 1000

					if var_517_29 + var_517_22 > arg_514_1.duration_ then
						arg_514_1.duration_ = var_517_29 + var_517_22
					end

					if var_517_25.prefab_name ~= "" and arg_514_1.actors_[var_517_25.prefab_name] ~= nil then
						local var_517_30 = LuaForUtil.PlayVoiceWithCriLipsync(arg_514_1.actors_[var_517_25.prefab_name].transform, "story_v_out_417231", "417231123", "story_v_out_417231.awb")

						arg_514_1:RecordAudio("417231123", var_517_30)
						arg_514_1:RecordAudio("417231123", var_517_30)
					else
			...
			local var_517_31 = var_517_22 + 0.3
			local var_517_32 = math.max(var_517_23, arg_514_1.talkMaxDuration)

			if var_517_22 + 0.3 <= arg_514_1.time_ and arg_514_1.time_ < var_517_31 + var_517_32 then
				arg_514_1.typewritter.percent = (arg_514_1.time_ - var_517_31) / var_517_32
