return {
	Play414171001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.9 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[975].name)
				...
				local var_4_17 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414171001).content)
	...
	Play414171002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(414171002).content)
	...
	Play414171003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				local var_16_1 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(414171003).content)
	...
	Play414171004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(414171004).content)
	...
	Play414171005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 1 < arg_21_1.time_ and arg_21_1.time_ <= 1 + arg_24_0 then
				local var_24_0 = arg_21_1.bgs_.H07f

				arg_21_1.bgs_.H07f.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if var_24_3 <= arg_21_1.time_ and arg_21_1.time_ < var_24_3 + var_24_4 then
				...
				var_24_5.a = Mathf.Lerp(0, 1, (arg_21_1.time_ - var_24_3) / var_24_4)
			...
			if 1 < arg_21_1.time_ and arg_21_1.time_ <= var_24_7 + arg_24_0 then
				arg_21_1.mask_.enabled = true
				arg_21_1.mask_.raycastTarget = true
			...
			if var_24_7 <= arg_21_1.time_ and arg_21_1.time_ < var_24_7 + var_24_8 then
				...
				var_24_9.a = Mathf.Lerp(1, 0, (arg_21_1.time_ - var_24_7) / var_24_8)
			...
			local var_24_11 = 1.799999999999
			local var_24_12 = 1.825

			if 1.799999999999 < arg_21_1.time_ and arg_21_1.time_ <= var_24_11 + arg_24_0 then
				...
				local var_24_14 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(414171005).content)

				arg_21_1.text_.text = var_24_14

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_16 = 73 <= 0 and var_24_12 or var_24_12 * (utf8.len(var_24_14) / 73)

				if (73 <= 0 and var_24_12 or var_24_12 * (utf8.len(var_24_14) / 73)) > 0 and var_24_12 < var_24_16 then
	...
	Play414171006 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				...
				local var_30_1 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(414171006).content)

				arg_27_1.text_.text = var_30_1

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_3 = 68 <= 0 and var_30_0 or var_30_0 * (utf8.len(var_30_1) / 68)

				if (68 <= 0 and var_30_0 or var_30_0 * (utf8.len(var_30_1) / 68)) > 0 and var_30_0 < var_30_3 then
	...
	Play414171007 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_8 + arg_34_0 then
				...
				local var_34_10 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(414171007).content)

				arg_31_1.text_.text = var_34_10

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_12 = 19 <= 0 and var_34_9 or var_34_9 * (utf8.len(var_34_10) / 19)

				if (19 <= 0 and var_34_9 or var_34_9 * (utf8.len(var_34_10) / 19)) > 0 and var_34_9 < var_34_12 then
	...
	Play414171008 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_1 + arg_38_0 then
				...
				local var_38_3 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(414171008).content)

				arg_35_1.text_.text = var_38_3

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_5 = 16 <= 0 and var_38_2 or var_38_2 * (utf8.len(var_38_3) / 16)

				if (16 <= 0 and var_38_2 or var_38_2 * (utf8.len(var_38_3) / 16)) > 0 and var_38_2 < var_38_5 then
	...
	Play414171009 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 then
				arg_39_1:AudioAction("play", "effect", "se_story_133", "se_story_133_gaga2", "")
			end

			local var_42_1 = 0
			local var_42_2 = 0.075
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_1 + arg_42_0 then
				...
				arg_39_1.leftNameTxt_.text = arg_39_1:FormatText(StoryNameCfg[945].name)
				...
				local var_42_3 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(414171009).content)

				arg_39_1.text_.text = var_42_3

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_5 = 3 <= 0 and var_42_2 or var_42_2 * (utf8.len(var_42_3) / 3)

				if (3 <= 0 and var_42_2 or var_42_2 * (utf8.len(var_42_3) / 3)) > 0 and var_42_2 < var_42_5 then
	...
	Play414171010 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= 0 + arg_46_0 then
				...
				arg_43_1:ShowWeapon(arg_43_1.var_["104902ui_story" .. "Animator"].transform, false)
			end
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_4 + arg_46_0 then
				...
				local var_46_6 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(414171010).content)

				arg_43_1.text_.text = var_46_6

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_8 = 21 <= 0 and var_46_5 or var_46_5 * (utf8.len(var_46_6) / 21)

				if (21 <= 0 and var_46_5 or var_46_5 * (utf8.len(var_46_6) / 21)) > 0 and var_46_5 < var_46_8 then
	...
	Play414171011 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_1 + arg_50_0 then
				...
				local var_50_3 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(414171011).content)
	...
	Play414171012 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 <= arg_51_1.time_ and arg_51_1.time_ < 0 + var_54_0 then
				arg_51_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_51_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_51_1.time_ - 0) / var_54_0)
			...
			if arg_51_1.time_ >= 0 + var_54_0 and arg_51_1.time_ < 0 + var_54_0 + arg_54_0 then
				arg_51_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, -1.2, -6)
				arg_51_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_51_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_51_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_51_1.actors_["104902ui_story"].transform.position).z)
				arg_51_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_51_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_51_1.actors_["104902ui_story"].transform.localEulerAngles = arg_51_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_4 + arg_54_0 then
				...
				arg_51_1.leftNameTxt_.text = arg_51_1:FormatText(StoryNameCfg[562].name)
				...
				local var_54_6 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(414171012).content)
	...
	Play414171013 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.playNext_(arg_57_0)
			...
			arg_55_1:RecordChoiceLog(414171013, 851, 852)
		end

		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= 0 + arg_58_0 and not isNil(arg_55_1.actors_["104902ui_story"]) and arg_55_1.var_.characterEffect104902ui_story == nil then
				arg_55_1.var_.characterEffect104902ui_story = arg_55_1.actors_["104902ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_58_0 = 0.200000002980232

			if 0 <= arg_55_1.time_ and arg_55_1.time_ < 0 + var_58_0 and not isNil(arg_55_1.actors_["104902ui_story"]) then
				if arg_55_1.var_.characterEffect104902ui_story and not isNil(arg_55_1.actors_["104902ui_story"]) then
					arg_55_1.var_.characterEffect104902ui_story.fillFlat = true
					arg_55_1.var_.characterEffect104902ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_55_1.time_ - 0) / var_58_0)
				end
			end

			if arg_55_1.time_ >= 0 + var_58_0 and arg_55_1.time_ < 0 + var_58_0 + arg_58_0 and not isNil(arg_55_1.actors_["104902ui_story"]) and arg_55_1.var_.characterEffect104902ui_story then
				arg_55_1.var_.characterEffect104902ui_story.fillFlat = true
				arg_55_1.var_.characterEffect104902ui_story.fillRatio = 0.5
			end
		end
	...
	Play414171014 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= 0 + arg_62_0 then
				...
				local var_62_1 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(414171014).content)

				arg_59_1.text_.text = var_62_1

				LuaForUtil.ClearLinePrefixSymbol(arg_59_1.text_)

				local var_62_3 = 12 <= 0 and var_62_0 or var_62_0 * (utf8.len(var_62_1) / 12)

				if (12 <= 0 and var_62_0 or var_62_0 * (utf8.len(var_62_1) / 12)) > 0 and var_62_0 < var_62_3 then
	...
	Play414171016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= var_66_0 + arg_66_0 then
				...
				local var_66_2 = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(414171016).content)

				arg_63_1.text_.text = var_66_2

				LuaForUtil.ClearLinePrefixSymbol(arg_63_1.text_)

				local var_66_4 = 6 <= 0 and var_66_1 or var_66_1 * (utf8.len(var_66_2) / 6)

				if (6 <= 0 and var_66_1 or var_66_1 * (utf8.len(var_66_2) / 6)) > 0 and var_66_1 < var_66_4 then
	...
	Play414171015 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= 0 + arg_70_0 then
				...
				local var_70_1 = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(414171015).content)

				arg_67_1.text_.text = var_70_1

				LuaForUtil.ClearLinePrefixSymbol(arg_67_1.text_)

				local var_70_3 = 25 <= 0 and var_70_0 or var_70_0 * (utf8.len(var_70_1) / 25)

				if (25 <= 0 and var_70_0 or var_70_0 * (utf8.len(var_70_1) / 25)) > 0 and var_70_0 < var_70_3 then
