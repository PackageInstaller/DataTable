	...
	Play60507001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_0 + arg_4_0 then
				...
				local var_4_3 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60507001).content)

				arg_1_1.text_.text = var_4_3

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_5 = 46 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 46)

				if (46 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 46)) > 0 and var_4_1 < var_4_5 then
