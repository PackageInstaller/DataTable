	...
	Play416232013 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				...
				local var_60_3 = var_60_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_60_0, iter_60_1 in ipairs((var_60_3:ToTable())) do
					iter_60_1.transform.localScale = Vector3.New(iter_60_1.transform.localScale.x / var_60_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_60_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_60_1.transform.localScale.y / var_60_2, iter_60_1.transform.localScale.z)
				end
			end
			...
			if 0.166666666666667 < arg_57_1.time_ and arg_57_1.time_ <= 0.166666666666667 + arg_60_0 then
				local var_60_6 = arg_57_1.var_.effect778

				if not arg_57_1.var_.effect778 then
					var_60_6 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"), manager.ui.mainCamera.transform)
					var_60_6.name = "778"
					arg_57_1.var_.effect778 = var_60_6
				else
					var_60_6.transform:SetParent(var_60_9000)
				end

				var_60_6.transform.localPosition = Vector3.New(0, 0, 0)
				var_60_6.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_60_8 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_60_9 = var_60_6.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_60_2, iter_60_3 in ipairs((var_60_9:ToTable())) do
					iter_60_3.transform.localScale = Vector3.New(iter_60_3.transform.localScale.x / var_60_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_60_9 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_60_3.transform.localScale.y / var_60_8, iter_60_3.transform.localScale.z)
				end
			end
			...
			if arg_57_1.time_ >= var_60_12 + 1.16666666666667 and arg_57_1.time_ < var_60_12 + 1.16666666666667 + arg_60_0 then
			...
			local var_60_14 = 0.633333333332
			local var_60_15 = 1.05

			if 0.633333333332 < arg_57_1.time_ and arg_57_1.time_ <= var_60_14 + arg_60_0 then
				...
				local var_60_17 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(416232013).content)

				arg_57_1.text_.text = var_60_17

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_19 = 42 <= 0 and var_60_15 or var_60_15 * (utf8.len(var_60_17) / 42)

				if (42 <= 0 and var_60_15 or var_60_15 * (utf8.len(var_60_17) / 42)) > 0 and var_60_15 < var_60_19 then
					arg_57_1.talkMaxDuration = var_60_19
					var_60_14 = var_60_14 + 0.3

					if var_60_19 + var_60_14 > arg_57_1.duration_ then
						arg_57_1.duration_ = var_60_19 + var_60_14
					end
				end
			...
			local var_60_20 = var_60_14 + 0.3
			local var_60_21 = math.max(var_60_15, arg_57_1.talkMaxDuration)

			if var_60_14 + 0.3 <= arg_57_1.time_ and arg_57_1.time_ < var_60_20 + var_60_21 then
	...
	Play416232033 = function(arg_143_0, arg_143_1)
		...
		function arg_143_1.onSingleLineUpdate_(arg_146_0)
			if 0 < arg_143_1.time_ and arg_143_1.time_ <= 0 + arg_146_0 then
				...
				local var_146_3 = var_146_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_146_0, iter_146_1 in ipairs((var_146_3:ToTable())) do
					iter_146_1.transform.localScale = Vector3.New(iter_146_1.transform.localScale.x / var_146_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_146_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_146_1.transform.localScale.y / var_146_2, iter_146_1.transform.localScale.z)
				end
			end
			...
			if 0.5 < arg_143_1.time_ and arg_143_1.time_ <= var_146_6 + arg_146_0 then
			...
			local var_146_7 = 0.633333333333333
			...
			local var_146_10 = 1.13333333333333

			if 1.13333333333333 < arg_143_1.time_ and arg_143_1.time_ <= var_146_10 + arg_146_0 then
				arg_143_1.mask_.enabled = true
				arg_143_1.mask_.raycastTarget = true
			...
			if 1.13333333333333 < arg_143_1.time_ and arg_143_1.time_ <= 1.13333333333333 + arg_146_0 then
				local var_146_14 = arg_143_1.bgs_.STblack
				...
				var_146_14.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_146_15 = var_146_14:GetComponent("SpriteRenderer")

				if var_146_15 and var_146_15.sprite then
					local var_146_16 = 2 * (var_146_14.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_146_14.transform.localScale = Vector3.New(var_146_16 / var_146_15.sprite.bounds.size.y < var_146_16 * manager.ui.mainCameraCom_.aspect / var_146_15.sprite.bounds.size.x and var_146_16 * manager.ui.mainCameraCom_.aspect / var_146_15.sprite.bounds.size.x or var_146_16 / var_146_15.sprite.bounds.size.y, var_146_16 / var_146_15.sprite.bounds.size.y < var_146_16 * manager.ui.mainCameraCom_.aspect / var_146_15.sprite.bounds.size.x and var_146_16 * manager.ui.mainCameraCom_.aspect / var_146_15.sprite.bounds.size.x or var_146_16 / var_146_15.sprite.bounds.size.y, 0)
				end
			...
			local var_146_18 = 1.9
			local var_146_19 = 1.325

			if 1.9 < arg_143_1.time_ and arg_143_1.time_ <= var_146_18 + arg_146_0 then
				...
				local var_146_20 = LeanTween.value(arg_143_1.dialog_, 0, 1, 0.3)

				var_146_20:setOnUpdate(LuaHelper.FloatAction(function(arg_147_0)
					arg_143_1.dialogCg_.alpha = arg_147_0
				end))
				var_146_20:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_143_1.dialog_)
					var_146_20:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_146_21 = arg_143_1:FormatText(arg_143_1:GetWordFromCfg(416232033).content)

				arg_143_1.text_.text = var_146_21

				LuaForUtil.ClearLinePrefixSymbol(arg_143_1.text_)

				local var_146_23 = 53 <= 0 and var_146_19 or var_146_19 * (utf8.len(var_146_21) / 53)

				if (53 <= 0 and var_146_19 or var_146_19 * (utf8.len(var_146_21) / 53)) > 0 and var_146_19 < var_146_23 then
					arg_143_1.talkMaxDuration = var_146_23
					var_146_18 = var_146_18 + 0.3

					if var_146_23 + var_146_18 > arg_143_1.duration_ then
						arg_143_1.duration_ = var_146_23 + var_146_18
					end
				end
			...
			local var_146_24 = var_146_18 + 0.3
			local var_146_25 = math.max(var_146_19, arg_143_1.talkMaxDuration)

			if var_146_18 + 0.3 <= arg_143_1.time_ and arg_143_1.time_ < var_146_24 + var_146_25 then
	...
	Play416232089 = function(arg_375_0, arg_375_1)
		...
		function arg_375_1.onSingleLineUpdate_(arg_378_0)
			...
			if 0.5 < arg_375_1.time_ and arg_375_1.time_ <= 0.5 + arg_378_0 then
				...
				local var_378_6 = var_378_3.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_378_0, iter_378_1 in ipairs((var_378_6:ToTable())) do
					iter_378_1.transform.localScale = Vector3.New(iter_378_1.transform.localScale.x / var_378_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_378_6 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_378_1.transform.localScale.y / var_378_5, iter_378_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_375_1.time_ and arg_375_1.time_ <= var_378_9 + arg_378_0 then
				arg_375_1.allBtn_.enabled = false
			end

			if arg_375_1.time_ >= var_378_9 + 3.13333333333333 and arg_375_1.time_ < var_378_9 + 3.13333333333333 + arg_378_0 then
				arg_375_1.allBtn_.enabled = true
			end

			if 0.933333333333334 < arg_375_1.time_ and arg_375_1.time_ <= 0.933333333333334 + arg_378_0 then
				local var_378_10 = arg_375_1.var_.effect118

				if not arg_375_1.var_.effect118 then
					var_378_10 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Lightning_in"), manager.ui.mainCamera.transform)
					var_378_10.name = "118"
					arg_375_1.var_.effect118 = var_378_10
				else
					var_378_10.transform:SetParent(var_378_9000)
				end

				var_378_10.transform.localPosition = Vector3.New(-0.55, 0.42, 0)
				var_378_10.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_378_12 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_378_13 = var_378_10.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_378_2, iter_378_3 in ipairs((var_378_13:ToTable())) do
					iter_378_3.transform.localScale = Vector3.New(iter_378_3.transform.localScale.x / var_378_12 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_378_13 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_378_3.transform.localScale.y / var_378_12, iter_378_3.transform.localScale.z)
				end
			end
			...
			local var_378_16 = 1.4

			if 1.4 < arg_375_1.time_ and arg_375_1.time_ <= var_378_16 + arg_378_0 then
			...
			local var_378_17 = 0.466666666666667

			if var_378_16 <= arg_375_1.time_ and arg_375_1.time_ < var_378_16 + var_378_17 then
				local var_378_18 = Color.New(1, 1, 1)

				var_378_18.a = Mathf.Lerp(1, 0, (arg_375_1.time_ - var_378_16) / var_378_17)
			...
			if arg_375_1.time_ >= var_378_16 + var_378_17 and arg_375_1.time_ < var_378_16 + var_378_17 + arg_378_0 then
				local var_378_19 = Color.New(1, 1, 1)
			...
			local var_378_23 = 2.13333333333333
			local var_378_24 = 1.6

			if 2.13333333333333 < arg_375_1.time_ and arg_375_1.time_ <= var_378_23 + arg_378_0 then
				...
				local var_378_25 = LeanTween.value(arg_375_1.dialog_, 0, 1, 0.3)

				var_378_25:setOnUpdate(LuaHelper.FloatAction(function(arg_379_0)
					arg_375_1.dialogCg_.alpha = arg_379_0
				end))
				var_378_25:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_375_1.dialog_)
					var_378_25:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_378_26 = arg_375_1:FormatText(arg_375_1:GetWordFromCfg(416232089).content)

				arg_375_1.text_.text = var_378_26

				LuaForUtil.ClearLinePrefixSymbol(arg_375_1.text_)

				local var_378_28 = 64 <= 0 and var_378_24 or var_378_24 * (utf8.len(var_378_26) / 64)

				if (64 <= 0 and var_378_24 or var_378_24 * (utf8.len(var_378_26) / 64)) > 0 and var_378_24 < var_378_28 then
					arg_375_1.talkMaxDuration = var_378_28
					var_378_23 = var_378_23 + 0.3

					if var_378_28 + var_378_23 > arg_375_1.duration_ then
						arg_375_1.duration_ = var_378_28 + var_378_23
					end
				end
			...
			local var_378_29 = var_378_23 + 0.3
			local var_378_30 = math.max(var_378_24, arg_375_1.talkMaxDuration)

			if var_378_23 + 0.3 <= arg_375_1.time_ and arg_375_1.time_ < var_378_29 + var_378_30 then
				arg_375_1.typewritter.percent = (arg_375_1.time_ - var_378_29) / var_378_30

				arg_375_1.typewritter:SetDirty()
			end

			if arg_375_1.time_ >= var_378_29 + var_378_30 and arg_375_1.time_ < var_378_29 + var_378_30 + arg_378_0 then
