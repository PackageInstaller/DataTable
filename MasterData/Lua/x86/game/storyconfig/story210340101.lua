	...
	Play1103401010 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 then
				...
				local var_47_12 = var_47_9.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_47_2, iter_47_3 in ipairs((var_47_12:ToTable())) do
					iter_47_3.transform.localScale = Vector3.New(iter_47_3.transform.localScale.x / var_47_11 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_47_12 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_47_3.transform.localScale.y / var_47_11, iter_47_3.transform.localScale.z)
				end
			end
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 then
				...
				local var_47_16 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_44_1.bgmTxt_.text ~= var_47_16 and arg_44_1.bgmTxt_.text ~= "" then
						if arg_44_1.bgmTxt2_.text ~= "" then
							arg_44_1.bgmTxt_.text = arg_44_1.bgmTxt2_.text
						end

						arg_44_1.bgmTxt2_.text = var_47_16

						arg_44_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_44_1.bgmTxt_.text = var_47_16
						arg_44_1.bgmTxt2_.text = var_47_16
					end
			...
			if 0.4 < arg_44_1.time_ and arg_44_1.time_ <= 0.4 + arg_47_0 then
				...
				local var_47_19 = manager.audio:GetAudioName("bgm_side_daily01", "bgm_side_daily01")

				if "" ~= "" then
					if arg_44_1.bgmTxt_.text ~= var_47_19 and arg_44_1.bgmTxt_.text ~= "" then
						if arg_44_1.bgmTxt2_.text ~= "" then
							arg_44_1.bgmTxt_.text = arg_44_1.bgmTxt2_.text
						end

						arg_44_1.bgmTxt2_.text = var_47_19

						arg_44_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_44_1.bgmTxt_.text = var_47_19
						arg_44_1.bgmTxt2_.text = var_47_19
					end
			...
			local var_47_21 = 2
			local var_47_22 = 0.35

			if 2 < arg_44_1.time_ and arg_44_1.time_ <= var_47_21 + arg_47_0 then
				...
				var_47_23:setOnUpdate(LuaHelper.FloatAction(function(arg_50_0)
				...
				local var_47_24 = arg_44_1:FormatText(arg_44_1:GetWordFromCfg(1103401010).content)

				arg_44_1.text_.text = var_47_24

				LuaForUtil.ClearLinePrefixSymbol(arg_44_1.text_)

				local var_47_26 = 14 <= 0 and var_47_22 or var_47_22 * (utf8.len(var_47_24) / 14)

				if (14 <= 0 and var_47_22 or var_47_22 * (utf8.len(var_47_24) / 14)) > 0 and var_47_22 < var_47_26 then
					arg_44_1.talkMaxDuration = var_47_26
					var_47_21 = var_47_21 + 0.3

					if var_47_26 + var_47_21 > arg_44_1.duration_ then
						arg_44_1.duration_ = var_47_26 + var_47_21
					end
				end
			...
			local var_47_27 = var_47_21 + 0.3
			local var_47_28 = math.max(var_47_22, arg_44_1.talkMaxDuration)

			if var_47_21 + 0.3 <= arg_44_1.time_ and arg_44_1.time_ < var_47_27 + var_47_28 then
				arg_44_1.typewritter.percent = (arg_44_1.time_ - var_47_27) / var_47_28

				arg_44_1.typewritter:SetDirty()
			end

			if arg_44_1.time_ >= var_47_27 + var_47_28 and arg_44_1.time_ < var_47_27 + var_47_28 + arg_47_0 then
	...
	Play1103401038 = function(arg_154_0, arg_154_1)
		...
		function arg_154_1.onSingleLineUpdate_(arg_157_0)
			...
			if 0 < arg_154_1.time_ and arg_154_1.time_ <= 0 + arg_157_0 then
				...
				local var_157_4 = var_157_1.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_157_0, iter_157_1 in ipairs((var_157_4:ToTable())) do
					iter_157_1.transform.localScale = Vector3.New(iter_157_1.transform.localScale.x / var_157_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_157_4 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_157_1.transform.localScale.y / var_157_3, iter_157_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_154_1.time_ and arg_154_1.time_ <= var_157_7 + arg_157_0 then
				...
				local var_157_9 = arg_154_1:FormatText(arg_154_1:GetWordFromCfg(1103401038).content)

				arg_154_1.text_.text = var_157_9

				LuaForUtil.ClearLinePrefixSymbol(arg_154_1.text_)

				local var_157_11 = 86 <= 0 and var_157_8 or var_157_8 * (utf8.len(var_157_9) / 86)

				if (86 <= 0 and var_157_8 or var_157_8 * (utf8.len(var_157_9) / 86)) > 0 and var_157_8 < var_157_11 then
	...
	Play1103401071 = function(arg_282_0, arg_282_1)
		...
		function arg_282_1.onSingleLineUpdate_(arg_285_0)
			...
			if 0 < arg_282_1.time_ and arg_282_1.time_ <= var_285_9 + arg_285_0 then
				...
				local var_285_11 = arg_282_1:FormatText(arg_282_1:GetWordFromCfg(1103401071).content)

				arg_282_1.text_.text = var_285_11

				LuaForUtil.ClearLinePrefixSymbol(arg_282_1.text_)

				local var_285_13 = 67 <= 0 and var_285_10 or var_285_10 * (utf8.len(var_285_11) / 67)

				if (67 <= 0 and var_285_10 or var_285_10 * (utf8.len(var_285_11) / 67)) > 0 and var_285_10 < var_285_13 then
