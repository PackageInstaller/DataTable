	...
	Play910107001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_["1019"] == nil then
				local var_4_9 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1019")
			...
			local var_4_11 = arg_1_1.actors_["1019"].transform

			if 1 < arg_1_1.time_ and arg_1_1.time_ <= 1 + arg_4_0 then
				arg_1_1.var_.moveOldPos1019 = var_4_11.localPosition
			...
			if 1 <= arg_1_1.time_ and arg_1_1.time_ < 1 + var_4_13 then
				var_4_11.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1019, Vector3.New(0, -350, -180), (arg_1_1.time_ - 1) / var_4_13)
			end
			...
			if 1 < arg_1_1.time_ and arg_1_1.time_ <= 1 + arg_4_0 then
				local var_4_14 = arg_1_1.actors_["1019"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_14 then
					arg_1_1.var_.alphaOldValue1019 = var_4_14.alpha
					arg_1_1.var_.characterEffect1019 = var_4_14
				end
			...
			if 1 <= arg_1_1.time_ and arg_1_1.time_ < 1 + var_4_15 then
				if arg_1_1.var_.characterEffect1019 then
					arg_1_1.var_.characterEffect1019.alpha = Mathf.Lerp(arg_1_1.var_.alphaOldValue1019, 1, (arg_1_1.time_ - 1) / var_4_15)
				end
			end

			if arg_1_1.time_ >= 1 + var_4_15 and arg_1_1.time_ < 1 + var_4_15 + arg_4_0 and arg_1_1.var_.characterEffect1019 then
			...
			if 1 < arg_1_1.time_ and arg_1_1.time_ <= var_4_16 + arg_4_0 then
				...
				local var_4_19 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910107001).content)
	...
	Play910107002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[13].name)
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910107002).content)

				arg_7_1.text_.text = var_10_1

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_3 = 26 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 26)

				if (26 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 26)) > 0 and var_10_0 < var_10_3 then
	...
	Play910107003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910107003).content)
