	...
	Play926061001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				local var_4_20 = var_4_17.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_4_8, iter_4_9 in ipairs((var_4_20:ToTable())) do
					iter_4_9.transform.localScale = Vector3.New(iter_4_9.transform.localScale.x / var_4_19 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_4_20 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_9.transform.localScale.y / var_4_19, iter_4_9.transform.localScale.z)
				end
			end

			local var_4_22 = arg_1_1.actors_["10144"].transform

			if 2.275 < arg_1_1.time_ and arg_1_1.time_ <= 2.275 + arg_4_0 then
				arg_1_1.var_.moveOldPos10144 = var_4_22.localPosition
				var_4_22.localScale = Vector3.New(1, 1, 1)

				arg_1_1:CheckSpriteTmpPos("10144", 3)

				for iter_4_10 = 0, var_4_22.childCount - 1 do
					local var_4_23 = var_4_22:GetChild(iter_4_10)

					if var_4_23.name == "split_10" or not string.find(var_4_23.name, "split") then
			...
			if 2.275 <= arg_1_1.time_ and arg_1_1.time_ < 2.275 + var_4_24 then
				var_4_22.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos10144, Vector3.New(-8.8, -458.8, -89.4), (arg_1_1.time_ - 2.275) / var_4_24)
			end

			if arg_1_1.time_ >= 2.275 + var_4_24 and arg_1_1.time_ < 2.275 + var_4_24 + arg_4_0 then
				var_4_22.localPosition = Vector3.New(-8.8, -458.8, -89.4)
			end

			if 2.275 < arg_1_1.time_ and arg_1_1.time_ <= 2.275 + arg_4_0 then
				local var_4_25 = arg_1_1.actors_["10144"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_25 then
					arg_1_1.var_.alphaOldValue10144 = var_4_25.alpha
					arg_1_1.var_.characterEffect10144 = var_4_25
				end

				arg_1_1.var_.alphaOldValue10144 = 0
			end

			local var_4_26 = 0.358333333333333

			if 2.275 <= arg_1_1.time_ and arg_1_1.time_ < 2.275 + var_4_26 then
				if arg_1_1.var_.characterEffect10144 then
					arg_1_1.var_.characterEffect10144.alpha = Mathf.Lerp(arg_1_1.var_.alphaOldValue10144, 1, (arg_1_1.time_ - 2.275) / var_4_26)
				end
			end

			if arg_1_1.time_ >= 2.275 + var_4_26 and arg_1_1.time_ < 2.275 + var_4_26 + arg_4_0 and arg_1_1.var_.characterEffect10144 then
			...
			if 0.833333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 0.833333333333333 + arg_4_0 then
				local var_4_31 = arg_1_1.var_.effect2323

				if not arg_1_1.var_.effect2323 then
					var_4_31 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_juguangdeng01_in_keep"), manager.ui.mainCamera.transform)
					var_4_31.name = "2323"
					arg_1_1.var_.effect2323 = var_4_31
				else
					var_4_31.transform:SetParent(var_4_9000)
				end
			...
			local var_4_33 = 3.23333333333333
			local var_4_34 = 0.275

			if 3.23333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_33 + arg_4_0 then
				...
				local var_4_36 = arg_1_1:GetWordFromCfg(926061001)
				...
				local var_4_39 = 11 <= 0 and var_4_34 or var_4_34 * (utf8.len(var_4_37) / 11)

				if (11 <= 0 and var_4_34 or var_4_34 * (utf8.len(var_4_37) / 11)) > 0 and var_4_34 < var_4_39 then
				...
				if manager.audio:GetVoiceLength("story_v_out_926061", "926061001", "story_v_out_926061.awb") ~= 0 then
					local var_4_40 = manager.audio:GetVoiceLength("story_v_out_926061", "926061001", "story_v_out_926061.awb") / 1000
					...
					if var_4_36.prefab_name ~= "" and arg_1_1.actors_[var_4_36.prefab_name] ~= nil then
						local var_4_41 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_36.prefab_name].transform, "story_v_out_926061", "926061001", "story_v_out_926061.awb")

						arg_1_1:RecordAudio("926061001", var_4_41)
						arg_1_1:RecordAudio("926061001", var_4_41)
					else
	...
	Play926061006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 then
				...
				local var_27_10 = var_27_7.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_27_5, iter_27_6 in ipairs((var_27_10:ToTable())) do
					iter_27_6.transform.localScale = Vector3.New(iter_27_6.transform.localScale.x / var_27_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_27_10 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_27_6.transform.localScale.y / var_27_9, iter_27_6.transform.localScale.z)
				end
			end

			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 then
				local var_27_12 = arg_24_1.var_.effect1126

				if not arg_24_1.var_.effect1126 then
					var_27_12 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_juguangdeng01_out"), manager.ui.mainCamera.transform)
					var_27_12.name = "1126"
					arg_24_1.var_.effect1126 = var_27_12
				else
					var_27_12.transform:SetParent(var_27_9000)
				end

				var_27_12.transform.localPosition = Vector3.New(0, 0, 0)
				var_27_12.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			if 0.034 < arg_24_1.time_ and arg_24_1.time_ <= 0.034 + arg_27_0 then
				...
				local var_27_18 = manager.audio:GetAudioName("bgm_activity_4_3_story_tavern", "bgm_activity_4_3_story_tavern")
			...
			local var_27_19 = 0
			local var_27_20 = 0.875

			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_19 + arg_27_0 then
				...
				local var_27_21 = arg_24_1:FormatText(arg_24_1:GetWordFromCfg(926061006).content)

				arg_24_1.text_.text = var_27_21

				LuaForUtil.ClearLinePrefixSymbol(arg_24_1.text_)

				local var_27_23 = 35 <= 0 and var_27_20 or var_27_20 * (utf8.len(var_27_21) / 35)

				if (35 <= 0 and var_27_20 or var_27_20 * (utf8.len(var_27_21) / 35)) > 0 and var_27_20 < var_27_23 then
					arg_24_1.talkMaxDuration = var_27_23

					if var_27_23 + var_27_19 > arg_24_1.duration_ then
						arg_24_1.duration_ = var_27_23 + var_27_19
					end
				end
			...
			local var_27_24 = math.max(var_27_20, arg_24_1.talkMaxDuration)

			if var_27_19 <= arg_24_1.time_ and arg_24_1.time_ < var_27_19 + var_27_24 then
				arg_24_1.typewritter.percent = (arg_24_1.time_ - var_27_19) / var_27_24

				arg_24_1.typewritter:SetDirty()
			end

			if arg_24_1.time_ >= var_27_19 + var_27_24 and arg_24_1.time_ < var_27_19 + var_27_24 + arg_27_0 then
