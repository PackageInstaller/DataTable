	...
	Play321161028 = function(arg_117_0, arg_117_1)
		...
		function arg_117_1.onSingleLineUpdate_(arg_120_0)
			...
			if 0 < arg_117_1.time_ and arg_117_1.time_ <= 0 + arg_120_0 then
				...
				local var_120_6 = var_120_3.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_120_0, iter_120_1 in ipairs((var_120_6:ToTable())) do
					iter_120_1.transform.localScale = Vector3.New(iter_120_1.transform.localScale.x / var_120_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_120_6 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_120_1.transform.localScale.y / var_120_5, iter_120_1.transform.localScale.z)
				end
			end
			...
			if arg_117_1.time_ >= var_120_8 + 1 and arg_117_1.time_ < var_120_8 + 1 + arg_120_0 then
				arg_117_1.allBtn_.enabled = true
			end

			local var_120_9 = manager.ui.mainCamera.transform

			if 0 < arg_117_1.time_ and arg_117_1.time_ <= 0 + arg_120_0 then
				arg_117_1.var_.shakeOldPos = var_120_9.localPosition
			end

			local var_120_10 = 1

			if 0 <= arg_117_1.time_ and arg_117_1.time_ < 0 + var_120_10 then
				local var_120_11, var_120_12 = math.modf((arg_117_1.time_ - 0) / 0.066)

				var_120_9.localPosition = Vector3.New(var_120_12 * 0.13, var_120_12 * 0.13, var_120_12 * 0.13) + arg_117_1.var_.shakeOldPos
			end

			if arg_117_1.time_ >= 0 + var_120_10 and arg_117_1.time_ < 0 + var_120_10 + arg_120_0 then
				var_120_9.localPosition = arg_117_1.var_.shakeOldPos
			end
			...
			local var_120_14 = 0.833333333333333
			local var_120_15 = 0.925

			if 0.833333333333333 < arg_117_1.time_ and arg_117_1.time_ <= var_120_14 + arg_120_0 then
				...
				local var_120_17 = arg_117_1:FormatText(arg_117_1:GetWordFromCfg(321161028).content)

				arg_117_1.text_.text = var_120_17

				LuaForUtil.ClearLinePrefixSymbol(arg_117_1.text_)

				local var_120_19 = 37 <= 0 and var_120_15 or var_120_15 * (utf8.len(var_120_17) / 37)

				if (37 <= 0 and var_120_15 or var_120_15 * (utf8.len(var_120_17) / 37)) > 0 and var_120_15 < var_120_19 then
	...
	Play321161074 = function(arg_310_0, arg_310_1)
		...
		function arg_310_1.onSingleLineUpdate_(arg_313_0)
			...
			if 0.766666666666667 < arg_310_1.time_ and arg_310_1.time_ <= 0.766666666666667 + arg_313_0 then
				...
				local var_313_18 = var_313_15.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_313_0, iter_313_1 in ipairs((var_313_18:ToTable())) do
					iter_313_1.transform.localScale = Vector3.New(iter_313_1.transform.localScale.x / var_313_17 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_313_18 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_313_1.transform.localScale.y / var_313_17, iter_313_1.transform.localScale.z)
				end
			end
			...
			local var_313_20 = 1.16666666666667
			local var_313_21 = 1.425

			if 1.16666666666667 < arg_310_1.time_ and arg_310_1.time_ <= var_313_20 + arg_313_0 then
				...
				local var_313_23 = arg_310_1:FormatText(arg_310_1:GetWordFromCfg(321161074).content)

				arg_310_1.text_.text = var_313_23

				LuaForUtil.ClearLinePrefixSymbol(arg_310_1.text_)

				local var_313_25 = 57 <= 0 and var_313_21 or var_313_21 * (utf8.len(var_313_23) / 57)

				if (57 <= 0 and var_313_21 or var_313_21 * (utf8.len(var_313_23) / 57)) > 0 and var_313_21 < var_313_25 then
					arg_310_1.talkMaxDuration = var_313_25
					var_313_20 = var_313_20 + 0.3

					if var_313_25 + var_313_20 > arg_310_1.duration_ then
						arg_310_1.duration_ = var_313_25 + var_313_20
					end
				end
			...
			local var_313_26 = var_313_20 + 0.3
			local var_313_27 = math.max(var_313_21, arg_310_1.talkMaxDuration)

			if var_313_20 + 0.3 <= arg_310_1.time_ and arg_310_1.time_ < var_313_26 + var_313_27 then
				arg_310_1.typewritter.percent = (arg_310_1.time_ - var_313_26) / var_313_27
	...
	Play321161089 = function(arg_380_0, arg_380_1)
		...
		function arg_380_1.onSingleLineUpdate_(arg_383_0)
			if 0 < arg_380_1.time_ and arg_380_1.time_ <= 0 + arg_383_0 then
				...
				local var_383_3 = var_383_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_383_0, iter_383_1 in ipairs((var_383_3:ToTable())) do
					iter_383_1.transform.localScale = Vector3.New(iter_383_1.transform.localScale.x / var_383_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_383_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_383_1.transform.localScale.y / var_383_2, iter_383_1.transform.localScale.z)
				end
			end
			...
			local var_383_7 = manager.ui.mainCamera.transform

			if 0.366666666666666 < arg_380_1.time_ and arg_380_1.time_ <= 0.366666666666666 + arg_383_0 then
				arg_380_1.var_.shakeOldPos = var_383_7.localPosition
			end

			local var_383_8 = 0.667333335181078

			if 0.366666666666666 <= arg_380_1.time_ and arg_380_1.time_ < 0.366666666666666 + var_383_8 then
				local var_383_9, var_383_10 = math.modf((arg_380_1.time_ - 0.366666666666666) / 0.066)

				var_383_7.localPosition = Vector3.New(var_383_10 * 0.13, var_383_10 * 0.13, var_383_10 * 0.13) + arg_380_1.var_.shakeOldPos
			end

			if arg_380_1.time_ >= 0.366666666666666 + var_383_8 and arg_380_1.time_ < 0.366666666666666 + var_383_8 + arg_383_0 then
				var_383_7.localPosition = arg_380_1.var_.shakeOldPos
			end
			...
			local var_383_11 = 0.566666666666667
			local var_383_12 = 1.3

			if 0.566666666666667 < arg_380_1.time_ and arg_380_1.time_ <= var_383_11 + arg_383_0 then
				...
				local var_383_13 = LeanTween.value(arg_380_1.dialog_, 0, 1, 0.3)

				var_383_13:setOnUpdate(LuaHelper.FloatAction(function(arg_384_0)
					arg_380_1.dialogCg_.alpha = arg_384_0
				end))
				var_383_13:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_380_1.dialog_)
					var_383_13:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_383_14 = arg_380_1:FormatText(arg_380_1:GetWordFromCfg(321161089).content)

				arg_380_1.text_.text = var_383_14

				LuaForUtil.ClearLinePrefixSymbol(arg_380_1.text_)

				local var_383_16 = 52 <= 0 and var_383_12 or var_383_12 * (utf8.len(var_383_14) / 52)

				if (52 <= 0 and var_383_12 or var_383_12 * (utf8.len(var_383_14) / 52)) > 0 and var_383_12 < var_383_16 then
					arg_380_1.talkMaxDuration = var_383_16
					var_383_11 = var_383_11 + 0.3
			...
			local var_383_17 = var_383_11 + 0.3
			local var_383_18 = math.max(var_383_12, arg_380_1.talkMaxDuration)

			if var_383_11 + 0.3 <= arg_380_1.time_ and arg_380_1.time_ < var_383_17 + var_383_18 then
				arg_380_1.typewritter.percent = (arg_380_1.time_ - var_383_17) / var_383_18

				arg_380_1.typewritter:SetDirty()
			end

			if arg_380_1.time_ >= var_383_17 + var_383_18 and arg_380_1.time_ < var_383_17 + var_383_18 + arg_383_0 then
