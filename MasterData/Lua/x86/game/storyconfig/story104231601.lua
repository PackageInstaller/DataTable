	...
	Play423161013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 2 < arg_53_1.time_ and arg_53_1.time_ <= 2 + arg_56_0 then
				...
				local var_56_16 = var_56_13.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_56_2, iter_56_3 in ipairs((var_56_16:ToTable())) do
					iter_56_3.transform.localScale = Vector3.New(iter_56_3.transform.localScale.x / var_56_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_56_16 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_56_3.transform.localScale.y / var_56_15, iter_56_3.transform.localScale.z)
				end
			end

			local var_56_18 = arg_53_1.bgs_.ST0113.transform

			if 2 < arg_53_1.time_ and arg_53_1.time_ <= 2 + arg_56_0 then
				arg_53_1.var_.moveOldPosST0113 = var_56_18.localPosition
			end

			local var_56_19 = 2.9

			if 2 <= arg_53_1.time_ and arg_53_1.time_ < 2 + var_56_19 then
				var_56_18.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPosST0113, Vector3.New(0, 1, 9.5), (arg_53_1.time_ - 2) / var_56_19)
			end

			if arg_53_1.time_ >= 2 + var_56_19 and arg_53_1.time_ < 2 + var_56_19 + arg_56_0 then
				var_56_18.localPosition = Vector3.New(0, 1, 9.5)
			end

			local var_56_20 = 4

			if 4 < arg_53_1.time_ and arg_53_1.time_ <= var_56_20 + arg_56_0 then
				arg_53_1.allBtn_.enabled = false
			end

			if arg_53_1.time_ >= var_56_20 + 0.9 and arg_53_1.time_ < var_56_20 + 0.9 + arg_56_0 then
				arg_53_1.allBtn_.enabled = true
			end
			...
			if 4 < arg_53_1.time_ and arg_53_1.time_ <= var_56_24 + arg_56_0 then
				...
				local var_56_27 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(423161013).content)

				arg_53_1.text_.text = var_56_27

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_29 = 53 <= 0 and var_56_25 or var_56_25 * (utf8.len(var_56_27) / 53)

				if (53 <= 0 and var_56_25 or var_56_25 * (utf8.len(var_56_27) / 53)) > 0 and var_56_25 < var_56_29 then
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 0.433333333333335 < arg_85_1.time_ and arg_85_1.time_ <= 0.433333333333335 + arg_88_0 then
				...
				if not arg_85_1.var_.effectyudianzidan4 then
					...
					var_88_9.transform:SetParent(var_88_9002)
				end
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				...
				if not arg_85_1.var_.effectyudianhuichen1 then
					...
					var_88_12.transform:SetParent(var_88_9001)
				end
