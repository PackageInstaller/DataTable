	...
	Play423111078 = function(arg_305_0, arg_305_1)
		...
		function arg_305_1.onSingleLineUpdate_(arg_308_0)
			...
			if 2 < arg_305_1.time_ and arg_305_1.time_ <= 2 + arg_308_0 then
				...
				local var_308_21 = var_308_18.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_308_7, iter_308_8 in ipairs((var_308_21:ToTable())) do
					iter_308_8.transform.localScale = Vector3.New(iter_308_8.transform.localScale.x / var_308_20 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_308_21 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_308_8.transform.localScale.y / var_308_20, iter_308_8.transform.localScale.z)
				end
			end

			if 2 < arg_305_1.time_ and arg_305_1.time_ <= 2 + arg_308_0 then
				local var_308_23 = arg_305_1.var_.effectlageqieting2

				if not arg_305_1.var_.effectlageqieting2 then
					var_308_23 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_heavymax_ui"), manager.ui.mainCamera.transform)
					var_308_23.name = "lageqieting2"
					arg_305_1.var_.effectlageqieting2 = var_308_23
				else
					var_308_23.transform:SetParent(var_308_9000)
				end

				var_308_23.transform.localPosition = Vector3.New(0, 0, 0)
				var_308_23.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_308_25 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_308_26 = var_308_23.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_308_9, iter_308_10 in ipairs((var_308_26:ToTable())) do
					iter_308_10.transform.localScale = Vector3.New(iter_308_10.transform.localScale.x / var_308_25 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_308_26 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_308_10.transform.localScale.y / var_308_25, iter_308_10.transform.localScale.z)
				end
			end
			...
			local var_308_28 = 4
			local var_308_29 = 0.85

			if 4 < arg_305_1.time_ and arg_305_1.time_ <= var_308_28 + arg_308_0 then
				...
				local var_308_30 = LeanTween.value(arg_305_1.dialog_, 0, 1, 0.3)

				var_308_30:setOnUpdate(LuaHelper.FloatAction(function(arg_309_0)
					arg_305_1.dialogCg_.alpha = arg_309_0
				end))
				var_308_30:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_305_1.dialog_)
					var_308_30:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_308_31 = arg_305_1:FormatText(arg_305_1:GetWordFromCfg(423111078).content)

				arg_305_1.text_.text = var_308_31

				LuaForUtil.ClearLinePrefixSymbol(arg_305_1.text_)

				local var_308_33 = 34 <= 0 and var_308_29 or var_308_29 * (utf8.len(var_308_31) / 34)

				if (34 <= 0 and var_308_29 or var_308_29 * (utf8.len(var_308_31) / 34)) > 0 and var_308_29 < var_308_33 then
					arg_305_1.talkMaxDuration = var_308_33
					var_308_28 = var_308_28 + 0.3

					if var_308_33 + var_308_28 > arg_305_1.duration_ then
						arg_305_1.duration_ = var_308_33 + var_308_28
					end
				end
			...
			local var_308_34 = var_308_28 + 0.3
			local var_308_35 = math.max(var_308_29, arg_305_1.talkMaxDuration)

			if var_308_28 + 0.3 <= arg_305_1.time_ and arg_305_1.time_ < var_308_34 + var_308_35 then
