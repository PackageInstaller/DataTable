	...
	Play416221078 = function(arg_315_0, arg_315_1)
		...
		function arg_315_1.onSingleLineUpdate_(arg_318_0)
			...
			if 0.034 < arg_315_1.time_ and arg_315_1.time_ <= 0.034 + arg_318_0 then
				...
				local var_318_19 = var_318_16.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_318_6, iter_318_7 in ipairs((var_318_19:ToTable())) do
					iter_318_7.transform.localScale = Vector3.New(iter_318_7.transform.localScale.x / var_318_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_318_19 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_318_7.transform.localScale.y / var_318_18, iter_318_7.transform.localScale.z)
				end
			end

			if 0.534 < arg_315_1.time_ and arg_315_1.time_ <= 0.534 + arg_318_0 then
				local var_318_21 = arg_315_1.var_.effect245

				if not arg_315_1.var_.effect245 then
					var_318_21 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Lightning_in"), manager.ui.mainCamera.transform)
					var_318_21.name = "245"
					arg_315_1.var_.effect245 = var_318_21
				else
					var_318_21.transform:SetParent(var_318_9000)
				end

				var_318_21.transform.localPosition = Vector3.New(0, 0, 0)
				var_318_21.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_318_23 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_318_24 = var_318_21.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_318_8, iter_318_9 in ipairs((var_318_24:ToTable())) do
					iter_318_9.transform.localScale = Vector3.New(iter_318_9.transform.localScale.x / var_318_23 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_318_24 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_318_9.transform.localScale.y / var_318_23, iter_318_9.transform.localScale.z)
				end
			end
			...
			if 0 < arg_315_1.time_ and arg_315_1.time_ <= var_318_28 + arg_318_0 then
				arg_315_1.allBtn_.enabled = false
			end

			if arg_315_1.time_ >= var_318_28 + 1.7 and arg_315_1.time_ < var_318_28 + 1.7 + arg_318_0 then
			...
			local var_318_30 = 1
			local var_318_31 = 1.55

			if 1 < arg_315_1.time_ and arg_315_1.time_ <= var_318_30 + arg_318_0 then
				...
				local var_318_33 = arg_315_1:FormatText(arg_315_1:GetWordFromCfg(416221078).content)

				arg_315_1.text_.text = var_318_33

				LuaForUtil.ClearLinePrefixSymbol(arg_315_1.text_)

				local var_318_35 = 62 <= 0 and var_318_31 or var_318_31 * (utf8.len(var_318_33) / 62)

				if (62 <= 0 and var_318_31 or var_318_31 * (utf8.len(var_318_33) / 62)) > 0 and var_318_31 < var_318_35 then
					arg_315_1.talkMaxDuration = var_318_35
					var_318_30 = var_318_30 + 0.3

					if var_318_35 + var_318_30 > arg_315_1.duration_ then
						arg_315_1.duration_ = var_318_35 + var_318_30
					end
				end
			...
			local var_318_36 = var_318_30 + 0.3
			local var_318_37 = math.max(var_318_31, arg_315_1.talkMaxDuration)

			if var_318_30 + 0.3 <= arg_315_1.time_ and arg_315_1.time_ < var_318_36 + var_318_37 then
				arg_315_1.typewritter.percent = (arg_315_1.time_ - var_318_36) / var_318_37

				arg_315_1.typewritter:SetDirty()
			end

			if arg_315_1.time_ >= var_318_36 + var_318_37 and arg_315_1.time_ < var_318_36 + var_318_37 + arg_318_0 then
