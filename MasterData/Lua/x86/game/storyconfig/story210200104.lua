	...
	Play1102004069 = function(arg_283_0, arg_283_1)
		...
		function arg_283_1.onSingleLineUpdate_(arg_286_0)
			...
			if 0 < arg_283_1.time_ and arg_283_1.time_ <= 0 + arg_286_0 then
				...
				local var_286_6 = var_286_3.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_286_2, iter_286_3 in ipairs((var_286_6:ToTable())) do
					iter_286_3.transform.localScale = Vector3.New(iter_286_3.transform.localScale.x / var_286_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_286_6 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_286_3.transform.localScale.y / var_286_5, iter_286_3.transform.localScale.z)
				end
			end
			...
			if 1.7 < arg_283_1.time_ and arg_283_1.time_ <= 1.7 + arg_286_0 then
				local var_286_9 = arg_283_1.var_.effectfantianxinlian4

				if not arg_283_1.var_.effectfantianxinlian4 then
					var_286_9 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_out"), manager.ui.mainCamera.transform)
					var_286_9.name = "fantianxinlian4"
					arg_283_1.var_.effectfantianxinlian4 = var_286_9
				else
					var_286_9.transform:SetParent(var_286_9000)
				end

				var_286_9.transform.localPosition = Vector3.New(0, 0, 0)
				var_286_9.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_286_11 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_286_12 = var_286_9.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_286_4, iter_286_5 in ipairs((var_286_12:ToTable())) do
					iter_286_5.transform.localScale = Vector3.New(iter_286_5.transform.localScale.x / var_286_11 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_286_12 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_286_5.transform.localScale.y / var_286_11, iter_286_5.transform.localScale.z)
				end
			end
			...
			if 1.46666666666667 <= arg_283_1.time_ and arg_283_1.time_ < 1.46666666666667 + var_286_15 then
				var_286_14.localPosition = Vector3.Lerp(arg_283_1.var_.moveOldPosR2001, Vector3.New(0, 1, 9.5), (arg_283_1.time_ - 1.46666666666667) / var_286_15)
			end

			if arg_283_1.time_ >= 1.46666666666667 + var_286_15 and arg_283_1.time_ < 1.46666666666667 + var_286_15 + arg_286_0 then
				var_286_14.localPosition = Vector3.New(0, 1, 9.5)
			end

			local var_286_16 = arg_283_1.bgs_.R2001.transform

			if 1.5 < arg_283_1.time_ and arg_283_1.time_ <= 1.5 + arg_286_0 then
				arg_283_1.var_.moveOldPosR2001 = var_286_16.localPosition
			end

			local var_286_17 = 4

			if 1.5 <= arg_283_1.time_ and arg_283_1.time_ < 1.5 + var_286_17 then
				var_286_16.localPosition = Vector3.Lerp(arg_283_1.var_.moveOldPosR2001, Vector3.New(0, 1, 10), (arg_283_1.time_ - 1.5) / var_286_17)
			end

			if arg_283_1.time_ >= 1.5 + var_286_17 and arg_283_1.time_ < 1.5 + var_286_17 + arg_286_0 then
				var_286_16.localPosition = Vector3.New(0, 1, 10)
			end

			local var_286_18 = 3.2

			if 3.2 < arg_283_1.time_ and arg_283_1.time_ <= var_286_18 + arg_286_0 then
				arg_283_1.allBtn_.enabled = false
			end

			if arg_283_1.time_ >= var_286_18 + 2.4 and arg_283_1.time_ < var_286_18 + 2.4 + arg_286_0 then
			...
			local var_286_19 = 2.5
			local var_286_20 = 0.825

			if 2.5 < arg_283_1.time_ and arg_283_1.time_ <= var_286_19 + arg_286_0 then
				...
				var_286_21:setOnUpdate(LuaHelper.FloatAction(function(arg_287_0)
				...
				local var_286_22 = arg_283_1:FormatText(arg_283_1:GetWordFromCfg(1102004069).content)

				arg_283_1.text_.text = var_286_22

				LuaForUtil.ClearLinePrefixSymbol(arg_283_1.text_)

				local var_286_24 = 33 <= 0 and var_286_20 or var_286_20 * (utf8.len(var_286_22) / 33)

				if (33 <= 0 and var_286_20 or var_286_20 * (utf8.len(var_286_22) / 33)) > 0 and var_286_20 < var_286_24 then
					arg_283_1.talkMaxDuration = var_286_24
					var_286_19 = var_286_19 + 0.3

					if var_286_24 + var_286_19 > arg_283_1.duration_ then
						arg_283_1.duration_ = var_286_24 + var_286_19
					end
				end
			...
			local var_286_25 = var_286_19 + 0.3
			local var_286_26 = math.max(var_286_20, arg_283_1.talkMaxDuration)

			if var_286_19 + 0.3 <= arg_283_1.time_ and arg_283_1.time_ < var_286_25 + var_286_26 then
				arg_283_1.typewritter.percent = (arg_283_1.time_ - var_286_25) / var_286_26
