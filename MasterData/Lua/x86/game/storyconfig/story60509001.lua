	...
	Play60509001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[132].name)
				...
				local var_4_7 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60509001).content)

				arg_1_1.text_.text = var_4_7

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_9 = 40 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_7) / 40)

				if (40 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_7) / 40)) > 0 and var_4_5 < var_4_9 then
	...
	Play60509002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[132].name)
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(60509002).content)
