	...
	Play419052003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0.883333333333333 < arg_11_1.time_ and arg_11_1.time_ <= 0.883333333333333 + arg_14_0 then
				...
				local var_14_25 = var_14_22.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_14_2, iter_14_3 in ipairs((var_14_25:ToTable())) do
					iter_14_3.transform.localScale = Vector3.New(iter_14_3.transform.localScale.x / var_14_24 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_14_25 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_14_3.transform.localScale.y / var_14_24, iter_14_3.transform.localScale.z)
				end
			end

			local var_14_27 = arg_11_1.bgs_.SS1903.transform

			if 0.883333333333333 < arg_11_1.time_ and arg_11_1.time_ <= 0.883333333333333 + arg_14_0 then
				arg_11_1.var_.moveOldPosSS1903 = var_14_27.localPosition
			end

			local var_14_28 = 0.001

			if 0.883333333333333 <= arg_11_1.time_ and arg_11_1.time_ < 0.883333333333333 + var_14_28 then
				var_14_27.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPosSS1903, Vector3.New(0, 0.76, 6.09), (arg_11_1.time_ - 0.883333333333333) / var_14_28)
			end

			if arg_11_1.time_ >= 0.883333333333333 + var_14_28 and arg_11_1.time_ < 0.883333333333333 + var_14_28 + arg_14_0 then
				var_14_27.localPosition = Vector3.New(0, 0.76, 6.09)
			end

			local var_14_29 = arg_11_1.bgs_.SS1903.transform

			if 0.9 < arg_11_1.time_ and arg_11_1.time_ <= 0.9 + arg_14_0 then
				arg_11_1.var_.moveOldPosSS1903 = var_14_29.localPosition
			end

			local var_14_30 = 2.05

			if 0.9 <= arg_11_1.time_ and arg_11_1.time_ < 0.9 + var_14_30 then
				var_14_29.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPosSS1903, Vector3.New(0, 1, 9.02), (arg_11_1.time_ - 0.9) / var_14_30)
			end

			if arg_11_1.time_ >= 0.9 + var_14_30 and arg_11_1.time_ < 0.9 + var_14_30 + arg_14_0 then
				var_14_29.localPosition = Vector3.New(0, 1, 9.02)
			end
			...
			local var_14_32 = 2.55
			local var_14_33 = 1.25

			if 2.55 < arg_11_1.time_ and arg_11_1.time_ <= var_14_32 + arg_14_0 then
				...
				local var_14_35 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(419052003).content)

				arg_11_1.text_.text = var_14_35

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_37 = 50 <= 0 and var_14_33 or var_14_33 * (utf8.len(var_14_35) / 50)

				if (50 <= 0 and var_14_33 or var_14_33 * (utf8.len(var_14_35) / 50)) > 0 and var_14_33 < var_14_37 then
					arg_11_1.talkMaxDuration = var_14_37
					var_14_32 = var_14_32 + 0.3

					if var_14_37 + var_14_32 > arg_11_1.duration_ then
						arg_11_1.duration_ = var_14_37 + var_14_32
					end
				end
			...
			local var_14_38 = var_14_32 + 0.3
			local var_14_39 = math.max(var_14_33, arg_11_1.talkMaxDuration)

			if var_14_32 + 0.3 <= arg_11_1.time_ and arg_11_1.time_ < var_14_38 + var_14_39 then
