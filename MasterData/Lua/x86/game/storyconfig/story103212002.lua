	...
	Play321202049 = function(arg_201_0, arg_201_1)
		...
		function arg_201_1.onSingleLineUpdate_(arg_204_0)
			...
			if 0.275 < arg_201_1.time_ and arg_201_1.time_ <= 0.275 + arg_204_0 then
				...
				local var_204_11 = var_204_8.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_204_0, iter_204_1 in ipairs((var_204_11:ToTable())) do
					iter_204_1.transform.localScale = Vector3.New(iter_204_1.transform.localScale.x / var_204_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_204_11 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_204_1.transform.localScale.y / var_204_10, iter_204_1.transform.localScale.z)
				end
			end
			...
			if arg_201_1.time_ >= var_204_14 + 0.866666666666667 and arg_201_1.time_ < var_204_14 + 0.866666666666667 + arg_204_0 then
			...
			if 0 < arg_201_1.time_ and arg_201_1.time_ <= var_204_15 + arg_204_0 then
				...
				local var_204_17 = arg_201_1:GetWordFromCfg(321202049)
				...
				local var_204_20 = 11 <= 0 and var_204_16 or var_204_16 * (utf8.len(var_204_18) / 11)

				if (11 <= 0 and var_204_16 or var_204_16 * (utf8.len(var_204_18) / 11)) > 0 and var_204_16 < var_204_20 then
				...
				if manager.audio:GetVoiceLength("story_v_out_321202", "321202049", "story_v_out_321202.awb") ~= 0 then
					local var_204_21 = manager.audio:GetVoiceLength("story_v_out_321202", "321202049", "story_v_out_321202.awb") / 1000
					...
					if var_204_17.prefab_name ~= "" and arg_201_1.actors_[var_204_17.prefab_name] ~= nil then
						local var_204_22 = LuaForUtil.PlayVoiceWithCriLipsync(arg_201_1.actors_[var_204_17.prefab_name].transform, "story_v_out_321202", "321202049", "story_v_out_321202.awb")

						arg_201_1:RecordAudio("321202049", var_204_22)
						arg_201_1:RecordAudio("321202049", var_204_22)
					else
