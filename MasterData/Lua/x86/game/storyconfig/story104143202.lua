return {
	Play414322001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 414322001
		arg_1_1.duration_ = 7
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.83333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 1.83333333333333 + var_4_14 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1148ui_story, Vector3.New(0, -0.8, -6.2), (arg_1_1.time_ - 1.83333333333333) / var_4_14)
			...
			if 1.83333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 1.83333333333333 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1148ui_story == nil then
			...
			if arg_1_1.time_ >= 1.83333333333333 + var_4_16 and arg_1_1.time_ < 1.83333333333333 + var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1148ui_story then
				arg_1_1.var_.characterEffect1148ui_story.fillFlat = false
			end
			...
			if 1.999999999999 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				local var_4_27 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414322001).content)

				arg_1_1.text_.text = var_4_27

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_29 = 20 <= 0 and var_4_25 or var_4_25 * (utf8.len(var_4_27) / 20)

				if (20 <= 0 and var_4_25 or var_4_25 * (utf8.len(var_4_27) / 20)) > 0 and var_4_25 < var_4_29 then
	...
	Play414322002 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 414322002
		arg_9_1.duration_ = 5
		...
		function arg_9_1.playNext_(arg_11_0)
			if arg_11_0 == 1 then
				arg_9_0:Play414322003(arg_9_1)
			end
		end

		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				arg_9_1.var_.moveOldPos1148ui_story = arg_9_1.actors_["1148ui_story"].transform.localPosition
			end

			local var_12_0 = 0.001

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_0 then
				arg_9_1.actors_["1148ui_story"].transform.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1148ui_story, Vector3.New(0, 100, 0), (arg_9_1.time_ - 0) / var_12_0)
				arg_9_1.actors_["1148ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_9_1.actors_["1148ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_9_1.actors_["1148ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_9_1.actors_["1148ui_story"].transform.position).z)
				arg_9_1.actors_["1148ui_story"].transform.localEulerAngles.z = 0
				arg_9_1.actors_["1148ui_story"].transform.localEulerAngles.x = 0
				arg_9_1.actors_["1148ui_story"].transform.localEulerAngles = arg_9_1.actors_["1148ui_story"].transform.localEulerAngles
			end

			if arg_9_1.time_ >= 0 + var_12_0 and arg_9_1.time_ < 0 + var_12_0 + arg_12_0 then
				arg_9_1.actors_["1148ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_9_1.actors_["1148ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_9_1.actors_["1148ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_9_1.actors_["1148ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_9_1.actors_["1148ui_story"].transform.position).z)
				arg_9_1.actors_["1148ui_story"].transform.localEulerAngles.z = 0
				arg_9_1.actors_["1148ui_story"].transform.localEulerAngles.x = 0
				arg_9_1.actors_["1148ui_story"].transform.localEulerAngles = arg_9_1.actors_["1148ui_story"].transform.localEulerAngles
			...
			local var_12_1 = arg_9_1.actors_["1148ui_story"]

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(var_12_1) and arg_9_1.var_.characterEffect1148ui_story == nil then
				arg_9_1.var_.characterEffect1148ui_story = var_12_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_2 = 0.200000002980232

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_2 and not isNil(var_12_1) then
				if arg_9_1.var_.characterEffect1148ui_story and not isNil(var_12_1) then
					arg_9_1.var_.characterEffect1148ui_story.fillFlat = true
					arg_9_1.var_.characterEffect1148ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_9_1.time_ - 0) / var_12_2)
				end
			end

			if arg_9_1.time_ >= 0 + var_12_2 and arg_9_1.time_ < 0 + var_12_2 + arg_12_0 and not isNil(var_12_1) and arg_9_1.var_.characterEffect1148ui_story then
				arg_9_1.var_.characterEffect1148ui_story.fillFlat = true
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_3 + arg_12_0 then
				...
				local var_12_5 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(414322002).content)
	...
	Play414322003 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 414322003
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play414322004(arg_13_1)
			end
		end

		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if arg_13_1.actors_["107001ui_story"] == nil and not isNil((Asset.Load("Char/" .. "107001ui_story"))) then
				local var_16_0 = Object.Instantiate(Asset.Load("Char/" .. "107001ui_story"), arg_13_1.stage_.transform)

				var_16_0.name = "107001ui_story"
				var_16_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_13_1.actors_["107001ui_story"] = var_16_0
				...
				arg_13_1.var_["107001ui_story" .. "Animator"] = var_16_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_13_1.var_["107001ui_story" .. "Animator"].applyRootMotion = true
				arg_13_1.var_["107001ui_story" .. "LipSync"] = var_16_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_16_3 = arg_13_1.actors_["107001ui_story"].transform

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos107001ui_story = var_16_3.localPosition

				arg_13_1:ShowWeapon(arg_13_1.var_["107001ui_story" .. "Animator"].transform, false)
			end

			local var_16_4 = 0.001

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_4 then
				var_16_3.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos107001ui_story, Vector3.New(0, -0.95, -6.05), (arg_13_1.time_ - 0) / var_16_4)
			...
			local var_16_5 = arg_13_1.actors_["107001ui_story"]

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 and not isNil(var_16_5) and arg_13_1.var_.characterEffect107001ui_story == nil then
				arg_13_1.var_.characterEffect107001ui_story = var_16_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_16_6 = 0.200000002980232

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_6 and not isNil(var_16_5) then
				if arg_13_1.var_.characterEffect107001ui_story and not isNil(var_16_5) then
					arg_13_1.var_.characterEffect107001ui_story.fillFlat = false
				end
			end

			if arg_13_1.time_ >= 0 + var_16_6 and arg_13_1.time_ < 0 + var_16_6 + arg_16_0 and not isNil(var_16_5) and arg_13_1.var_.characterEffect107001ui_story then
				arg_13_1.var_.characterEffect107001ui_story.fillFlat = false
			end

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1:PlayTimeline("107001ui_story", "StoryTimeline/CharAction/story1070/story1070action/1070action4_1")
			end

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1:PlayTimeline("107001ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0102cva")
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(414322003).content)

				arg_13_1.text_.text = var_16_10

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_12 = 19 <= 0 and var_16_9 or var_16_9 * (utf8.len(var_16_10) / 19)

				if (19 <= 0 and var_16_9 or var_16_9 * (utf8.len(var_16_10) / 19)) > 0 and var_16_9 < var_16_12 then
	...
	Play414322004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 414322004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play414322005(arg_17_1)
			end
		end

		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(arg_17_1.actors_["107001ui_story"]) and arg_17_1.var_.characterEffect107001ui_story == nil then
				arg_17_1.var_.characterEffect107001ui_story = arg_17_1.actors_["107001ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_0 = 0.200000002980232

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_0 and not isNil(arg_17_1.actors_["107001ui_story"]) then
				if arg_17_1.var_.characterEffect107001ui_story and not isNil(arg_17_1.actors_["107001ui_story"]) then
					arg_17_1.var_.characterEffect107001ui_story.fillFlat = true
					arg_17_1.var_.characterEffect107001ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_17_1.time_ - 0) / var_20_0)
				end
			end

			if arg_17_1.time_ >= 0 + var_20_0 and arg_17_1.time_ < 0 + var_20_0 + arg_20_0 and not isNil(arg_17_1.actors_["107001ui_story"]) and arg_17_1.var_.characterEffect107001ui_story then
				arg_17_1.var_.characterEffect107001ui_story.fillFlat = true
				arg_17_1.var_.characterEffect107001ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(414322004).content)
	...
	Play414322005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 414322005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play414322006(arg_21_1)
			end
		end

		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos107001ui_story = arg_21_1.actors_["107001ui_story"].transform.localPosition
			end

			local var_24_0 = 0.001

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_0 then
				arg_21_1.actors_["107001ui_story"].transform.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos107001ui_story, Vector3.New(0, 100, 0), (arg_21_1.time_ - 0) / var_24_0)
				arg_21_1.actors_["107001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_21_1.actors_["107001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["107001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["107001ui_story"].transform.position).z)
				arg_21_1.actors_["107001ui_story"].transform.localEulerAngles.z = 0
				arg_21_1.actors_["107001ui_story"].transform.localEulerAngles.x = 0
				arg_21_1.actors_["107001ui_story"].transform.localEulerAngles = arg_21_1.actors_["107001ui_story"].transform.localEulerAngles
			end

			if arg_21_1.time_ >= 0 + var_24_0 and arg_21_1.time_ < 0 + var_24_0 + arg_24_0 then
				arg_21_1.actors_["107001ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_21_1.actors_["107001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_21_1.actors_["107001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["107001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["107001ui_story"].transform.position).z)
				arg_21_1.actors_["107001ui_story"].transform.localEulerAngles.z = 0
				arg_21_1.actors_["107001ui_story"].transform.localEulerAngles.x = 0
				arg_21_1.actors_["107001ui_story"].transform.localEulerAngles = arg_21_1.actors_["107001ui_story"].transform.localEulerAngles
			...
			if 0.233333333333333 < arg_21_1.time_ and arg_21_1.time_ <= 0.233333333333333 + arg_24_0 then
				arg_21_1:AudioAction("play", "effect", "se_story_135_02", "se_story_135_02_gagagroup", "")
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_2 + arg_24_0 then
				...
				arg_21_1.leftNameTxt_.text = arg_21_1:FormatText(StoryNameCfg[945].name)
				...
				local var_24_4 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(414322005).content)

				arg_21_1.text_.text = var_24_4

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_6 = 4 <= 0 and var_24_3 or var_24_3 * (utf8.len(var_24_4) / 4)

				if (4 <= 0 and var_24_3 or var_24_3 * (utf8.len(var_24_4) / 4)) > 0 and var_24_3 < var_24_6 then
	...
	Play414322006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 414322006
		...
		function arg_25_1.playNext_(arg_27_0)
			if arg_27_0 == 1 then
				arg_25_0:Play414322007(arg_25_1)
			end
		end
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				...
				local var_28_1 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(414322006).content)
	...
	Play414322007 = function(arg_29_0, arg_29_1)
		arg_29_1.time_ = 0
		arg_29_1.frameCnt_ = 0
		arg_29_1.state_ = "playing"
		arg_29_1.curTalkId_ = 414322007
		...
		function arg_29_1.playNext_(arg_31_0)
			if arg_31_0 == 1 then
				arg_29_0:Play414322008(arg_29_1)
			end
		end
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_4 then
				var_32_3.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1024ui_story, Vector3.New(0, -1, -6.05), (arg_29_1.time_ - 0) / var_32_4)
			...
			if arg_29_1.time_ >= 0 + var_32_4 and arg_29_1.time_ < 0 + var_32_4 + arg_32_0 then
				var_32_3.localPosition = Vector3.New(0, -1, -6.05)
				var_32_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_32_3.position).x, (manager.ui.mainCamera.transform.position - var_32_3.position).y, (manager.ui.mainCamera.transform.position - var_32_3.position).z)
				var_32_3.localEulerAngles.z = 0
				var_32_3.localEulerAngles.x = 0
				var_32_3.localEulerAngles = var_32_3.localEulerAngles
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(var_32_5) and arg_29_1.var_.characterEffect1024ui_story == nil then
			...
			if arg_29_1.time_ >= 0 + var_32_6 and arg_29_1.time_ < 0 + var_32_6 + arg_32_0 and not isNil(var_32_5) and arg_29_1.var_.characterEffect1024ui_story then
				arg_29_1.var_.characterEffect1024ui_story.fillFlat = false
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_8 + arg_32_0 then
				...
				local var_32_10 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(414322007).content)

				arg_29_1.text_.text = var_32_10

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_12 = 11 <= 0 and var_32_9 or var_32_9 * (utf8.len(var_32_10) / 11)

				if (11 <= 0 and var_32_9 or var_32_9 * (utf8.len(var_32_10) / 11)) > 0 and var_32_9 < var_32_12 then
	...
	Play414322008 = function(arg_33_0, arg_33_1)
		arg_33_1.time_ = 0
		arg_33_1.frameCnt_ = 0
		arg_33_1.state_ = "playing"
		arg_33_1.curTalkId_ = 414322008
		...
		function arg_33_1.onSingleLineFinish_()
			...
			arg_33_1.choices_[1].txt.text = arg_33_1:FormatText(StoryChoiceCfg[892].name)
			arg_33_1.choices_[2].txt.text = arg_33_1:FormatText(StoryChoiceCfg[893].name)
		end

		function arg_33_1.playNext_(arg_35_0)
			if arg_35_0 == 1 then
				arg_33_0:Play414322009(arg_33_1)
			end

			if arg_35_0 == 2 then
				arg_33_0:Play414322010(arg_33_1)
			end

			arg_33_1:RecordChoiceLog(414322008, 892, 893)
		end
	...
	Play414322009 = function(arg_37_0, arg_37_1)
		arg_37_1.time_ = 0
		arg_37_1.frameCnt_ = 0
		arg_37_1.state_ = "playing"
		arg_37_1.curTalkId_ = 414322009
		...
		function arg_37_1.playNext_(arg_39_0)
			if arg_39_0 == 1 then
				arg_37_0:Play414322012(arg_37_1)
			end
		end
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				local var_40_1 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(414322009).content)

				arg_37_1.text_.text = var_40_1

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_3 = 6 <= 0 and var_40_0 or var_40_0 * (utf8.len(var_40_1) / 6)

				if (6 <= 0 and var_40_0 or var_40_0 * (utf8.len(var_40_1) / 6)) > 0 and var_40_0 < var_40_3 then
	...
	Play414322012 = function(arg_41_0, arg_41_1)
		arg_41_1.time_ = 0
		arg_41_1.frameCnt_ = 0
		arg_41_1.state_ = "playing"
		arg_41_1.curTalkId_ = 414322012
		...
		function arg_41_1.playNext_(arg_43_0)
			if arg_43_0 == 1 then
				arg_41_0:Play414322013(arg_41_1)
			end
		end
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_0 then
				arg_41_1.actors_["1024ui_story"].transform.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1024ui_story, Vector3.New(0, 100, 0), (arg_41_1.time_ - 0) / var_44_0)
			...
			if arg_41_1.time_ >= 0 + var_44_0 and arg_41_1.time_ < 0 + var_44_0 + arg_44_0 then
				arg_41_1.actors_["1024ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_41_1.actors_["1024ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_41_1.actors_["1024ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_41_1.actors_["1024ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_41_1.actors_["1024ui_story"].transform.position).z)
				arg_41_1.actors_["1024ui_story"].transform.localEulerAngles.z = 0
				arg_41_1.actors_["1024ui_story"].transform.localEulerAngles.x = 0
				arg_41_1.actors_["1024ui_story"].transform.localEulerAngles = arg_41_1.actors_["1024ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_2 and not isNil(var_44_1) then
				if arg_41_1.var_.characterEffect1024ui_story and not isNil(var_44_1) then
					...
					arg_41_1.var_.characterEffect1024ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_41_1.time_ - 0) / var_44_2)
				end
			end
			...
			local var_44_3 = "104902ui_story"

			if arg_41_1.actors_["104902ui_story"] == nil and not isNil((Asset.Load("Char/" .. "104902ui_story"))) then
				local var_44_4 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_41_1.stage_.transform)
			...
			local var_44_7 = arg_41_1.actors_["104902ui_story"].transform

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1.var_.moveOldPos104902ui_story = var_44_7.localPosition
			end

			local var_44_8 = 0.001

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_8 then
				var_44_7.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_41_1.time_ - 0) / var_44_8)
			...
			if arg_41_1.time_ >= 0 + var_44_8 and arg_41_1.time_ < 0 + var_44_8 + arg_44_0 then
				var_44_7.localPosition = Vector3.New(0, -1.2, -6)
				var_44_7.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_44_7.position).x, (manager.ui.mainCamera.transform.position - var_44_7.position).y, (manager.ui.mainCamera.transform.position - var_44_7.position).z)
				var_44_7.localEulerAngles.z = 0
				var_44_7.localEulerAngles.x = 0
				var_44_7.localEulerAngles = var_44_7.localEulerAngles
			...
			local var_44_9 = arg_41_1.actors_["104902ui_story"]

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(var_44_9) and arg_41_1.var_.characterEffect104902ui_story == nil then
				arg_41_1.var_.characterEffect104902ui_story = var_44_9:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_44_10 = 0.200000002980232

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_10 and not isNil(var_44_9) then
				if arg_41_1.var_.characterEffect104902ui_story and not isNil(var_44_9) then
					arg_41_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_41_1.time_ >= 0 + var_44_10 and arg_41_1.time_ < 0 + var_44_10 + arg_44_0 and not isNil(var_44_9) and arg_41_1.var_.characterEffect104902ui_story then
				arg_41_1.var_.characterEffect104902ui_story.fillFlat = false
			end

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1101cva")
			end

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action7_1")
			end
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_12 + arg_44_0 then
				...
				local var_44_14 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(414322012).content)

				arg_41_1.text_.text = var_44_14

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_16 = 13 <= 0 and var_44_13 or var_44_13 * (utf8.len(var_44_14) / 13)

				if (13 <= 0 and var_44_13 or var_44_13 * (utf8.len(var_44_14) / 13)) > 0 and var_44_13 < var_44_16 then
					arg_41_1.talkMaxDuration = var_44_16

					if var_44_16 + var_44_12 > arg_41_1.duration_ then
						arg_41_1.duration_ = var_44_16 + var_44_12
					end
				end
			...
			local var_44_17 = math.max(var_44_13, arg_41_1.talkMaxDuration)

			if var_44_12 <= arg_41_1.time_ and arg_41_1.time_ < var_44_12 + var_44_17 then
				arg_41_1.typewritter.percent = (arg_41_1.time_ - var_44_12) / var_44_17

				arg_41_1.typewritter:SetDirty()
			end

			if arg_41_1.time_ >= var_44_12 + var_44_17 and arg_41_1.time_ < var_44_12 + var_44_17 + arg_44_0 then
	...
	Play414322013 = function(arg_45_0, arg_45_1)
		arg_45_1.time_ = 0
		arg_45_1.frameCnt_ = 0
		arg_45_1.state_ = "playing"
		arg_45_1.curTalkId_ = 414322013
		...
		function arg_45_1.playNext_(arg_47_0)
			if arg_47_0 == 1 then
				arg_45_0:Play414322014(arg_45_1)
			end
		end
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_1 + arg_48_0 then
				...
				local var_48_3 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(414322013).content)
	...
	Play414322014 = function(arg_49_0, arg_49_1)
		arg_49_1.time_ = 0
		arg_49_1.frameCnt_ = 0
		arg_49_1.state_ = "playing"
		arg_49_1.curTalkId_ = 414322014
		...
		function arg_49_1.playNext_(arg_51_0)
			if arg_51_0 == 1 then
				arg_49_0:Play414322015(arg_49_1)
			end
		end
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_8 + arg_52_0 then
				...
				local var_52_10 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(414322014).content)

				arg_49_1.text_.text = var_52_10

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_12 = 21 <= 0 and var_52_9 or var_52_9 * (utf8.len(var_52_10) / 21)

				if (21 <= 0 and var_52_9 or var_52_9 * (utf8.len(var_52_10) / 21)) > 0 and var_52_9 < var_52_12 then
	...
	Play414322015 = function(arg_53_0, arg_53_1)
		arg_53_1.time_ = 0
		arg_53_1.frameCnt_ = 0
		arg_53_1.state_ = "playing"
		arg_53_1.curTalkId_ = 414322015
		...
		function arg_53_1.onSingleLineFinish_()
			...
			arg_53_1.choices_[1].txt.text = arg_53_1:FormatText(StoryChoiceCfg[894].name)
			arg_53_1.choices_[2].txt.text = arg_53_1:FormatText(StoryChoiceCfg[895].name)
		end

		function arg_53_1.playNext_(arg_55_0)
			if arg_55_0 == 1 then
				arg_53_0:Play414322016(arg_53_1)
			end
			...
			arg_53_1:RecordChoiceLog(414322015, 894, 895)
		end
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_0 and not isNil(arg_53_1.actors_["1024ui_story"]) then
				if arg_53_1.var_.characterEffect1024ui_story and not isNil(arg_53_1.actors_["1024ui_story"]) then
					...
					arg_53_1.var_.characterEffect1024ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_53_1.time_ - 0) / var_56_0)
				end
			end
	...
	Play414322016 = function(arg_57_0, arg_57_1)
		arg_57_1.time_ = 0
		arg_57_1.frameCnt_ = 0
		arg_57_1.state_ = "playing"
		arg_57_1.curTalkId_ = 414322016
		...
		function arg_57_1.playNext_(arg_59_0)
			if arg_59_0 == 1 then
				arg_57_0:Play414322017(arg_57_1)
			end
		end
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			local var_60_4 = "1024ui_story"

			if arg_57_1.actors_["1024ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1024ui_story"))) then
				local var_60_5 = Object.Instantiate(Asset.Load("Char/" .. "1024ui_story"), arg_57_1.stage_.transform)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1:PlayTimeline("1024ui_story", "StoryTimeline/CharAction/story1024/story1024action/1024action4_1")
			end

			local var_60_8 = "1024ui_story"

			if arg_57_1.actors_["1024ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1024ui_story"))) then
				local var_60_9 = Object.Instantiate(Asset.Load("Char/" .. "1024ui_story"), arg_57_1.stage_.transform)

				var_60_9.name = var_60_8
				var_60_9.transform.localPosition = Vector3.New(0, 100, 0)
				arg_57_1.actors_[var_60_8] = var_60_9

				local var_60_10 = var_60_9:GetComponentInChildren(typeof(CharacterEffect))

				var_60_10.enabled = true

				local var_60_11 = GameObjectTools.GetOrAddComponent(var_60_9, typeof(DynamicBoneHelper))

				if var_60_11 then
					var_60_11:EnableDynamicBone(false)
				end

				arg_57_1:ShowWeapon(var_60_10.transform, false)

				arg_57_1.var_[var_60_8 .. "Animator"] = var_60_10.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_57_1.var_[var_60_8 .. "Animator"].applyRootMotion = true
				arg_57_1.var_[var_60_8 .. "LipSync"] = var_60_10.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1:PlayTimeline("1024ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1101cva")
			end
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_12 + arg_60_0 then
				...
				local var_60_14 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(414322016).content)

				arg_57_1.text_.text = var_60_14

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_16 = 14 <= 0 and var_60_13 or var_60_13 * (utf8.len(var_60_14) / 14)

				if (14 <= 0 and var_60_13 or var_60_13 * (utf8.len(var_60_14) / 14)) > 0 and var_60_13 < var_60_16 then
	...
	Play414322017 = function(arg_61_0, arg_61_1)
		arg_61_1.time_ = 0
		arg_61_1.frameCnt_ = 0
		arg_61_1.state_ = "playing"
		arg_61_1.curTalkId_ = 414322017
		...
		function arg_61_1.playNext_(arg_63_0)
			if arg_63_0 == 1 then
				arg_61_0:Play414322018(arg_61_1)
			end
		end
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0.200000002980232 < arg_61_1.time_ and arg_61_1.time_ <= 0.200000002980232 + arg_64_0 then
				arg_61_1:AudioAction("play", "effect", "se_story_133", "se_story_133_gaga", "")
			end
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_2 + arg_64_0 then
				...
				arg_61_1.leftNameTxt_.text = arg_61_1:FormatText(StoryNameCfg[945].name)
				...
				local var_64_4 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(414322017).content)

				arg_61_1.text_.text = var_64_4

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_6 = 4 <= 0 and var_64_3 or var_64_3 * (utf8.len(var_64_4) / 4)

				if (4 <= 0 and var_64_3 or var_64_3 * (utf8.len(var_64_4) / 4)) > 0 and var_64_3 < var_64_6 then
	...
	Play414322018 = function(arg_65_0, arg_65_1)
		arg_65_1.time_ = 0
		arg_65_1.frameCnt_ = 0
		arg_65_1.state_ = "playing"
		arg_65_1.curTalkId_ = 414322018
		...
		function arg_65_1.playNext_(arg_67_0)
			if arg_67_0 == 1 then
				arg_65_0:Play414322019(arg_65_1)
			end
		end
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				arg_65_1:PlayTimeline("1024ui_story", "StoryTimeline/CharAction/story1024/story1024action/1024action4_2")
			end

			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				arg_65_1:PlayTimeline("1024ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3101cva")
			end
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_4 + arg_68_0 then
				...
				local var_68_6 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(414322018).content)

				arg_65_1.text_.text = var_68_6

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_8 = 8 <= 0 and var_68_5 or var_68_5 * (utf8.len(var_68_6) / 8)

				if (8 <= 0 and var_68_5 or var_68_5 * (utf8.len(var_68_6) / 8)) > 0 and var_68_5 < var_68_8 then
	...
	Play414322019 = function(arg_69_0, arg_69_1)
		arg_69_1.time_ = 0
		arg_69_1.frameCnt_ = 0
		arg_69_1.state_ = "playing"
		arg_69_1.curTalkId_ = 414322019
		...
		function arg_69_1.playNext_(arg_71_0)
			if arg_71_0 == 1 then
				arg_69_0:Play414322020(arg_69_1)
			end
		end
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_3 + arg_72_0 then
				...
				local var_72_5 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(414322019).content)
	...
	Play414322020 = function(arg_73_0, arg_73_1)
		arg_73_1.time_ = 0
		arg_73_1.frameCnt_ = 0
		arg_73_1.state_ = "playing"
		arg_73_1.curTalkId_ = 414322020
		...
		function arg_73_1.playNext_(arg_75_0)
			if arg_75_0 == 1 then
				arg_73_0:Play414322021(arg_73_1)
			end
		end
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_0 then
				arg_73_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_73_1.time_ - 0) / var_76_0)
			...
			if arg_73_1.time_ >= 0 + var_76_0 and arg_73_1.time_ < 0 + var_76_0 + arg_76_0 then
				arg_73_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, -1.2, -6)
				arg_73_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_73_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["104902ui_story"].transform.position).z)
				arg_73_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_73_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_73_1.actors_["104902ui_story"].transform.localEulerAngles = arg_73_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				arg_73_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action7_2")
			end
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_4 + arg_76_0 then
				...
				local var_76_6 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(414322020).content)

				arg_73_1.text_.text = var_76_6

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_8 = 14 <= 0 and var_76_5 or var_76_5 * (utf8.len(var_76_6) / 14)

				if (14 <= 0 and var_76_5 or var_76_5 * (utf8.len(var_76_6) / 14)) > 0 and var_76_5 < var_76_8 then
	...
	Play414322021 = function(arg_77_0, arg_77_1)
		arg_77_1.time_ = 0
		arg_77_1.frameCnt_ = 0
		arg_77_1.state_ = "playing"
		arg_77_1.curTalkId_ = 414322021
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_1 + arg_80_0 then
				...
				local var_80_3 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(414322021).content)
	...
	Play414322010 = function(arg_81_0, arg_81_1)
		arg_81_1.time_ = 0
		arg_81_1.frameCnt_ = 0
		arg_81_1.state_ = "playing"
		arg_81_1.curTalkId_ = 414322010
		...
		function arg_81_1.playNext_(arg_83_0)
			if arg_83_0 == 1 then
				arg_81_0:Play414322011(arg_81_1)
			end
		end
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= 0 + arg_84_0 then
				...
				local var_84_1 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(414322010).content)
	...
	Play414322011 = function(arg_85_0, arg_85_1)
		arg_85_1.time_ = 0
		arg_85_1.frameCnt_ = 0
		arg_85_1.state_ = "playing"
		arg_85_1.curTalkId_ = 414322011
		...
		function arg_85_1.playNext_(arg_87_0)
			if arg_87_0 == 1 then
				arg_85_0:Play414322012(arg_85_1)
			end
		end

		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				arg_85_1.var_.moveOldPos1024ui_story = arg_85_1.actors_["1024ui_story"].transform.localPosition

				arg_85_1:ShowWeapon(arg_85_1.var_["1024ui_story" .. "Animator"].transform, false)
			end

			local var_88_0 = 0.001

			if 0 <= arg_85_1.time_ and arg_85_1.time_ < 0 + var_88_0 then
				arg_85_1.actors_["1024ui_story"].transform.localPosition = Vector3.Lerp(arg_85_1.var_.moveOldPos1024ui_story, Vector3.New(0, -1, -6.05), (arg_85_1.time_ - 0) / var_88_0)
				arg_85_1.actors_["1024ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_85_1.actors_["1024ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1024ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1024ui_story"].transform.position).z)
				arg_85_1.actors_["1024ui_story"].transform.localEulerAngles.z = 0
				arg_85_1.actors_["1024ui_story"].transform.localEulerAngles.x = 0
				arg_85_1.actors_["1024ui_story"].transform.localEulerAngles = arg_85_1.actors_["1024ui_story"].transform.localEulerAngles
			end

			if arg_85_1.time_ >= 0 + var_88_0 and arg_85_1.time_ < 0 + var_88_0 + arg_88_0 then
				arg_85_1.actors_["1024ui_story"].transform.localPosition = Vector3.New(0, -1, -6.05)
				arg_85_1.actors_["1024ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_85_1.actors_["1024ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1024ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1024ui_story"].transform.position).z)
				arg_85_1.actors_["1024ui_story"].transform.localEulerAngles.z = 0
				arg_85_1.actors_["1024ui_story"].transform.localEulerAngles.x = 0
				arg_85_1.actors_["1024ui_story"].transform.localEulerAngles = arg_85_1.actors_["1024ui_story"].transform.localEulerAngles
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 and not isNil(var_88_1) and arg_85_1.var_.characterEffect1024ui_story == nil then
			...
			if arg_85_1.time_ >= 0 + var_88_2 and arg_85_1.time_ < 0 + var_88_2 + arg_88_0 and not isNil(var_88_1) and arg_85_1.var_.characterEffect1024ui_story then
				arg_85_1.var_.characterEffect1024ui_story.fillFlat = false
			end

			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				arg_85_1:PlayTimeline("1024ui_story", "StoryTimeline/CharAction/story1024/story1024action/1024action2_1")
			end

			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				arg_85_1:PlayTimeline("1024ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0102cva")
			end
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= var_88_4 + arg_88_0 then
				...
				local var_88_6 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(414322011).content)

				arg_85_1.text_.text = var_88_6

				LuaForUtil.ClearLinePrefixSymbol(arg_85_1.text_)

				local var_88_8 = 27 <= 0 and var_88_5 or var_88_5 * (utf8.len(var_88_6) / 27)

				if (27 <= 0 and var_88_5 or var_88_5 * (utf8.len(var_88_6) / 27)) > 0 and var_88_5 < var_88_8 then
