return {
	Play62106001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.bgs_.B07a == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.paintGo_)

				var_4_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "B07a")
				var_4_0.name = "B07a"
				var_4_0.transform.parent = arg_1_1.stage_.transform
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.bgs_.B07a = var_4_0
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_1 = arg_1_1.bgs_.B07a

				arg_1_1.bgs_.B07a.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				local var_4_17 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(62106001).content)

				arg_1_1.text_.text = var_4_17

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_19 = 31 <= 0 and var_4_15 or var_4_15 * (utf8.len(var_4_17) / 31)

				if (31 <= 0 and var_4_15 or var_4_15 * (utf8.len(var_4_17) / 31)) > 0 and var_4_15 < var_4_19 then
	...
	Play62106002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_8 + arg_12_0 then
				...
				local var_12_10 = arg_9_1:GetWordFromCfg(62106002)
				...
				local var_12_13 = 56 <= 0 and var_12_9 or var_12_9 * (utf8.len(var_12_11) / 56)

				if (56 <= 0 and var_12_9 or var_12_9 * (utf8.len(var_12_11) / 56)) > 0 and var_12_9 < var_12_13 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62106", "62106002", "story_v_chess_62106.awb") ~= 0 then
					local var_12_14 = manager.audio:GetVoiceLength("story_v_chess_62106", "62106002", "story_v_chess_62106.awb") / 1000
					...
					if var_12_10.prefab_name ~= "" and arg_9_1.actors_[var_12_10.prefab_name] ~= nil then
						local var_12_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_10.prefab_name].transform, "story_v_chess_62106", "62106002", "story_v_chess_62106.awb")

						arg_9_1:RecordAudio("62106002", var_12_15)
						arg_9_1:RecordAudio("62106002", var_12_15)
					else
	...
	Play62106003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/story1111/story1111action/1111action3_1")
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_3 + arg_16_0 then
				...
				local var_16_5 = arg_13_1:GetWordFromCfg(62106003)
				...
				local var_16_8 = 29 <= 0 and var_16_4 or var_16_4 * (utf8.len(var_16_6) / 29)

				if (29 <= 0 and var_16_4 or var_16_4 * (utf8.len(var_16_6) / 29)) > 0 and var_16_4 < var_16_8 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62106", "62106003", "story_v_chess_62106.awb") ~= 0 then
					local var_16_9 = manager.audio:GetVoiceLength("story_v_chess_62106", "62106003", "story_v_chess_62106.awb") / 1000
					...
					if var_16_5.prefab_name ~= "" and arg_13_1.actors_[var_16_5.prefab_name] ~= nil then
						local var_16_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_5.prefab_name].transform, "story_v_chess_62106", "62106003", "story_v_chess_62106.awb")

						arg_13_1:RecordAudio("62106003", var_16_10)
						arg_13_1:RecordAudio("62106003", var_16_10)
					else
	...
	Play62106004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(62106004).content)
	...
	Play62106005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/story1111/story1111action/1111action3_2")
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_3 + arg_24_0 then
				...
				local var_24_5 = arg_21_1:GetWordFromCfg(62106005)
				...
				local var_24_8 = 36 <= 0 and var_24_4 or var_24_4 * (utf8.len(var_24_6) / 36)

				if (36 <= 0 and var_24_4 or var_24_4 * (utf8.len(var_24_6) / 36)) > 0 and var_24_4 < var_24_8 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62106", "62106005", "story_v_chess_62106.awb") ~= 0 then
					local var_24_9 = manager.audio:GetVoiceLength("story_v_chess_62106", "62106005", "story_v_chess_62106.awb") / 1000
					...
					if var_24_5.prefab_name ~= "" and arg_21_1.actors_[var_24_5.prefab_name] ~= nil then
						local var_24_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_5.prefab_name].transform, "story_v_chess_62106", "62106005", "story_v_chess_62106.awb")

						arg_21_1:RecordAudio("62106005", var_24_10)
						arg_21_1:RecordAudio("62106005", var_24_10)
					else
	...
	Play62106006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(62106006).content)
