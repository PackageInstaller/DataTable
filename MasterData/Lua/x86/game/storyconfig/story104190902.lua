	...
	Play419092003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				local var_16_3 = var_16_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_16_0, iter_16_1 in ipairs((var_16_3:ToTable())) do
					iter_16_1.transform.localScale = Vector3.New(iter_16_1.transform.localScale.x / var_16_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_16_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_16_1.transform.localScale.y / var_16_2, iter_16_1.transform.localScale.z)
				end
			end

			local var_16_5 = 0.034000001847744

			if 0.034000001847744 < arg_13_1.time_ and arg_13_1.time_ <= var_16_5 + arg_16_0 then
				arg_13_1.allBtn_.enabled = false
			end

			if arg_13_1.time_ >= var_16_5 + 1.36599999815226 and arg_13_1.time_ < var_16_5 + 1.36599999815226 + arg_16_0 then
			...
			local var_16_8 = 1
			local var_16_9 = 0.725

			if 1 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_11 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(419092003).content)

				arg_13_1.text_.text = var_16_11

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_13 = 29 <= 0 and var_16_9 or var_16_9 * (utf8.len(var_16_11) / 29)

				if (29 <= 0 and var_16_9 or var_16_9 * (utf8.len(var_16_11) / 29)) > 0 and var_16_9 < var_16_13 then
			...
			local var_16_14 = var_16_8 + 0.3
			local var_16_15 = math.max(var_16_9, arg_13_1.talkMaxDuration)

			if var_16_8 + 0.3 <= arg_13_1.time_ and arg_13_1.time_ < var_16_14 + var_16_15 then
				arg_13_1.typewritter.percent = (arg_13_1.time_ - var_16_14) / var_16_15
	...
	Play419092038 = function(arg_167_0, arg_167_1)
		...
		function arg_167_1.onSingleLineUpdate_(arg_170_0)
			if 0.3 < arg_167_1.time_ and arg_167_1.time_ <= 0.3 + arg_170_0 then
				...
				local var_170_3 = var_170_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_170_0, iter_170_1 in ipairs((var_170_3:ToTable())) do
					iter_170_1.transform.localScale = Vector3.New(iter_170_1.transform.localScale.x / var_170_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_170_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_170_1.transform.localScale.y / var_170_2, iter_170_1.transform.localScale.z)
				end
			end

			local var_170_5 = arg_167_1.bgs_.I18j.transform

			if 0.2 < arg_167_1.time_ and arg_167_1.time_ <= 0.2 + arg_170_0 then
				arg_167_1.var_.moveOldPosI18j = var_170_5.localPosition
			end

			local var_170_6 = 0.233333333333333

			if 0.2 <= arg_167_1.time_ and arg_167_1.time_ < 0.2 + var_170_6 then
				var_170_5.localPosition = Vector3.Lerp(arg_167_1.var_.moveOldPosI18j, Vector3.New(0, 1, 5), (arg_167_1.time_ - 0.2) / var_170_6)
			end

			if arg_167_1.time_ >= 0.2 + var_170_6 and arg_167_1.time_ < 0.2 + var_170_6 + arg_170_0 then
				var_170_5.localPosition = Vector3.New(0, 1, 5)
			end

			local var_170_7 = 0.3

			if 0.3 < arg_167_1.time_ and arg_167_1.time_ <= var_170_7 + arg_170_0 then
				arg_167_1.allBtn_.enabled = false
			end

			if arg_167_1.time_ >= var_170_7 + 1.1 and arg_167_1.time_ < var_170_7 + 1.1 + arg_170_0 then
			...
			local var_170_13 = 0.733333333333333
			local var_170_14 = 0.85

			if 0.733333333333333 < arg_167_1.time_ and arg_167_1.time_ <= var_170_13 + arg_170_0 then
				...
				local var_170_16 = arg_167_1:FormatText(arg_167_1:GetWordFromCfg(419092038).content)

				arg_167_1.text_.text = var_170_16

				LuaForUtil.ClearLinePrefixSymbol(arg_167_1.text_)

				local var_170_18 = 34 <= 0 and var_170_14 or var_170_14 * (utf8.len(var_170_16) / 34)

				if (34 <= 0 and var_170_14 or var_170_14 * (utf8.len(var_170_16) / 34)) > 0 and var_170_14 < var_170_18 then
