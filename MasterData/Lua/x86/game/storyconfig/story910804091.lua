return {
	Play910836001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910836001).content)
	...
	Play910836002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910836002).content)
	...
	Play910836003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if arg_11_1.actors_["1084"] == nil then
				local var_14_0 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1084")
				...
				if not isNil(var_14_0) then
					...
					arg_11_1.actors_["1084"] = var_14_1
			...
			local var_14_2 = arg_11_1.actors_["1084"].transform

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				arg_11_1.var_.moveOldPos1084 = var_14_2.localPosition
			...
			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_4 then
				var_14_2.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1084, Vector3.New(0, -350, -180), (arg_11_1.time_ - 0) / var_14_4)
			end
			...
			local var_14_5 = arg_11_1.actors_["1084"]

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 and not isNil(var_14_5) and arg_11_1.var_.actorSpriteComps1084 == nil then
				arg_11_1.var_.actorSpriteComps1084 = var_14_5:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_11_1.time_ >= 0 + var_14_6 and arg_11_1.time_ < 0 + var_14_6 + arg_14_0 and not isNil(var_14_5) and arg_11_1.var_.actorSpriteComps1084 then
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_8 + arg_14_0 then
				...
				local var_14_10 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910836003).content)

				arg_11_1.text_.text = var_14_10

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_12 = 33 <= 0 and var_14_9 or var_14_9 * (utf8.len(var_14_10) / 33)

				if (33 <= 0 and var_14_9 or var_14_9 * (utf8.len(var_14_10) / 33)) > 0 and var_14_9 < var_14_12 then
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				for iter_18_0 = 0, arg_15_1.actors_["1084"].transform.childCount - 1 do
					...
					if var_18_0.name == "split_5" or not string.find(var_18_0.name, "split") then
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910836004).content)

				arg_15_1.text_.text = var_18_7

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_9 = 41 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 41)

				if (41 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 41)) > 0 and var_18_6 < var_18_9 then
	...
	Play910836005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_5 + arg_22_0 then
				...
				local var_22_7 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910836005).content)

				arg_19_1.text_.text = var_22_7

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_9 = 16 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 16)

				if (16 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 16)) > 0 and var_22_6 < var_22_9 then
	...
	Play910836006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910836006).content)

				arg_23_1.text_.text = var_26_7

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_9 = 25 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 25)

				if (25 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 25)) > 0 and var_26_6 < var_26_9 then
	...
	Play910836007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910836007).content)

				arg_27_1.text_.text = var_30_7

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_9 = 7 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 7)

				if (7 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 7)) > 0 and var_30_6 < var_30_9 then
	...
	Play910836008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910836008).content)

				arg_31_1.text_.text = var_34_7

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_9 = 19 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 19)

				if (19 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 19)) > 0 and var_34_6 < var_34_9 then
	...
	Play910836009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_5 + arg_38_0 then
				...
				local var_38_7 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910836009).content)

				arg_35_1.text_.text = var_38_7

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_9 = 31 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 31)

				if (31 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 31)) > 0 and var_38_6 < var_38_9 then
	...
	Play910836010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910836010).content)

				arg_39_1.text_.text = var_42_7

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_9 = 8 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 8)

				if (8 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 8)) > 0 and var_42_6 < var_42_9 then
	...
	Play910836011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_5 + arg_46_0 then
				...
				local var_46_7 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910836011).content)

				arg_43_1.text_.text = var_46_7

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_9 = 4 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 4)

				if (4 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 4)) > 0 and var_46_6 < var_46_9 then
	...
	Play910836012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_5 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910836012).content)

				arg_47_1.text_.text = var_50_7

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_9 = 39 <= 0 and var_50_6 or var_50_6 * (utf8.len(var_50_7) / 39)

				if (39 <= 0 and var_50_6 or var_50_6 * (utf8.len(var_50_7) / 39)) > 0 and var_50_6 < var_50_9 then
	...
	Play910836013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_5 + arg_54_0 then
				...
				local var_54_7 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910836013).content)
	...
	Play910836014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= 0 + arg_58_0 then
				arg_55_1:AudioAction("play", "effect", "ui_skip", "ui_bgm_lower_back", "")
			end
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_6 + arg_58_0 then
				...
				local var_58_8 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910836014).content)

				arg_55_1.text_.text = var_58_8

				LuaForUtil.ClearLinePrefixSymbol(arg_55_1.text_)

				local var_58_10 = 4 <= 0 and var_58_7 or var_58_7 * (utf8.len(var_58_8) / 4)

				if (4 <= 0 and var_58_7 or var_58_7 * (utf8.len(var_58_8) / 4)) > 0 and var_58_7 < var_58_10 then
