	...
	Play60106001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_0 + arg_4_0 then
				...
				local var_4_3 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60106001).content)

				arg_1_1.text_.text = var_4_3

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_5 = 21 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 21)

				if (21 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 21)) > 0 and var_4_1 < var_4_5 then
	...
	Play60106002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(60106002).content)

				arg_7_1.text_.text = var_10_1

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_3 = 21 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 21)

				if (21 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 21)) > 0 and var_10_0 < var_10_3 then
	...
	Play60106003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(60106003).content)

				arg_11_1.text_.text = var_14_1

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_3 = 72 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 72)

				if (72 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 72)) > 0 and var_14_0 < var_14_3 then
