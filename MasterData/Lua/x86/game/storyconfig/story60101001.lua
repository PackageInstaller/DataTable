	...
	Play60101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_0 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[108].name)
				...
				local var_4_3 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60101001).content)

				arg_1_1.text_.text = var_4_3

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_5 = 69 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 69)

				if (69 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 69)) > 0 and var_4_1 < var_4_5 then
	...
	Play60101002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[108].name)
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(60101002).content)

				arg_7_1.text_.text = var_10_1

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_3 = 81 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 81)

				if (81 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 81)) > 0 and var_10_0 < var_10_3 then
	...
	Play60101003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(60101003).content)
	...
	Play60101004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(60101004).content)
