return {
	Play910814001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910814001).content)
	...
	Play910814002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910814002).content)
	...
	Play910814003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_8 + arg_14_0 then
				...
				local var_14_10 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910814003).content)

				arg_11_1.text_.text = var_14_10

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_12 = 22 <= 0 and var_14_9 or var_14_9 * (utf8.len(var_14_10) / 22)

				if (22 <= 0 and var_14_9 or var_14_9 * (utf8.len(var_14_10) / 22)) > 0 and var_14_9 < var_14_12 then
	...
	Play910814004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910814004).content)

				arg_15_1.text_.text = var_18_7

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_9 = 15 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 15)

				if (15 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 15)) > 0 and var_18_6 < var_18_9 then
	...
	Play910814005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_5 + arg_22_0 then
				...
				local var_22_7 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910814005).content)

				arg_19_1.text_.text = var_22_7

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_9 = 35 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 35)

				if (35 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 35)) > 0 and var_22_6 < var_22_9 then
	...
	Play910814006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910814006).content)

				arg_23_1.text_.text = var_26_7

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_9 = 11 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 11)

				if (11 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 11)) > 0 and var_26_6 < var_26_9 then
	...
	Play910814007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910814007).content)

				arg_27_1.text_.text = var_30_7

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_9 = 10 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 10)

				if (10 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 10)) > 0 and var_30_6 < var_30_9 then
	...
	Play910814008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910814008).content)
	...
	Play910814009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_5 + arg_38_0 then
				...
				local var_38_7 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910814009).content)

				arg_35_1.text_.text = var_38_7

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_9 = 16 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 16)

				if (16 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 16)) > 0 and var_38_6 < var_38_9 then
	...
	Play910814010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910814010).content)

				arg_39_1.text_.text = var_42_7

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_9 = 35 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 35)

				if (35 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 35)) > 0 and var_42_6 < var_42_9 then
	...
	Play910814011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_5 + arg_46_0 then
				...
				local var_46_7 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910814011).content)

				arg_43_1.text_.text = var_46_7

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_9 = 9 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 9)

				if (9 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 9)) > 0 and var_46_6 < var_46_9 then
	...
	Play910814012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_5 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910814012).content)
	...
	Play910814013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 and not isNil(arg_51_1.actors_["1070"]) and arg_51_1.var_.actorSpriteComps1070 == nil then
				arg_51_1.var_.actorSpriteComps1070 = arg_51_1.actors_["1070"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_54_0 = 0.034

			if 0 <= arg_51_1.time_ and arg_51_1.time_ < 0 + var_54_0 and not isNil(arg_51_1.actors_["1070"]) then
			...
			if arg_51_1.time_ >= 0 + var_54_0 and arg_51_1.time_ < 0 + var_54_0 + arg_54_0 and not isNil(arg_51_1.actors_["1070"]) and arg_51_1.var_.actorSpriteComps1070 then
			...
			local var_54_2 = arg_51_1.actors_["1070"].transform

			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 then
				arg_51_1.var_.moveOldPos1070 = var_54_2.localPosition
			...
			if 0 <= arg_51_1.time_ and arg_51_1.time_ < 0 + var_54_4 then
				var_54_2.localPosition = Vector3.Lerp(arg_51_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_51_1.time_ - 0) / var_54_4)
			end
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_6 + arg_54_0 then
				...
				local var_54_8 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910814013).content)

				arg_51_1.text_.text = var_54_8

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_10 = 6 <= 0 and var_54_7 or var_54_7 * (utf8.len(var_54_8) / 6)

				if (6 <= 0 and var_54_7 or var_54_7 * (utf8.len(var_54_8) / 6)) > 0 and var_54_7 < var_54_10 then
