return {
	Play323102001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.73333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 1.73333333333333 + var_4_15 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1053ui_story, Vector3.New(0, -1.08, -6), (arg_1_1.time_ - 1.73333333333333) / var_4_15)
			...
			if 1.73333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 1.73333333333333 + arg_4_0 and not isNil(var_4_17) and arg_1_1.var_.characterEffect1053ui_story == nil then
			...
			if arg_1_1.time_ >= 1.73333333333333 + var_4_18 and arg_1_1.time_ < 1.73333333333333 + var_4_18 + arg_4_0 and not isNil(var_4_17) and arg_1_1.var_.characterEffect1053ui_story then
				arg_1_1.var_.characterEffect1053ui_story.fillFlat = false
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[1453].name)
				...
				local var_4_27 = arg_1_1:GetWordFromCfg(323102001)
				...
				if manager.audio:GetVoiceLength("story_v_out_323102", "323102001", "story_v_out_323102.awb") ~= 0 then
					local var_4_31 = manager.audio:GetVoiceLength("story_v_out_323102", "323102001", "story_v_out_323102.awb") / 1000
					...
					if var_4_27.prefab_name ~= "" and arg_1_1.actors_[var_4_27.prefab_name] ~= nil then
						local var_4_32 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_27.prefab_name].transform, "story_v_out_323102", "323102001", "story_v_out_323102.awb")

						arg_1_1:RecordAudio("323102001", var_4_32)
						arg_1_1:RecordAudio("323102001", var_4_32)
					else
	...
	Play323102002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 and not isNil(arg_8_1.actors_["1053ui_story"]) and arg_8_1.var_.characterEffect1053ui_story == nil then
				arg_8_1.var_.characterEffect1053ui_story = arg_8_1.actors_["1053ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_11_0 = 0.200000002980232

			if 0 <= arg_8_1.time_ and arg_8_1.time_ < 0 + var_11_0 and not isNil(arg_8_1.actors_["1053ui_story"]) then
				if arg_8_1.var_.characterEffect1053ui_story and not isNil(arg_8_1.actors_["1053ui_story"]) then
					arg_8_1.var_.characterEffect1053ui_story.fillFlat = true
					arg_8_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_8_1.time_ - 0) / var_11_0)
				end
			end

			if arg_8_1.time_ >= 0 + var_11_0 and arg_8_1.time_ < 0 + var_11_0 + arg_11_0 and not isNil(arg_8_1.actors_["1053ui_story"]) and arg_8_1.var_.characterEffect1053ui_story then
				arg_8_1.var_.characterEffect1053ui_story.fillFlat = true
				arg_8_1.var_.characterEffect1053ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_1 + arg_11_0 then
				...
				local var_11_3 = arg_8_1:FormatText(arg_8_1:GetWordFromCfg(323102002).content)

				arg_8_1.text_.text = var_11_3

				LuaForUtil.ClearLinePrefixSymbol(arg_8_1.text_)

				local var_11_5 = 22 <= 0 and var_11_2 or var_11_2 * (utf8.len(var_11_3) / 22)

				if (22 <= 0 and var_11_2 or var_11_2 * (utf8.len(var_11_3) / 22)) > 0 and var_11_2 < var_11_5 then
	...
	Play323102003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0.166666666666667 < arg_12_1.time_ and arg_12_1.time_ <= 0.166666666666667 + arg_15_0 then
				arg_12_1:AudioAction("play", "effect", "se_story_148", "se_story_148_footstep_stomp", "")
			end
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_4 + arg_15_0 then
				...
				local var_15_6 = arg_12_1:FormatText(arg_12_1:GetWordFromCfg(323102003).content)

				arg_12_1.text_.text = var_15_6

				LuaForUtil.ClearLinePrefixSymbol(arg_12_1.text_)

				local var_15_8 = 52 <= 0 and var_15_5 or var_15_5 * (utf8.len(var_15_6) / 52)

				if (52 <= 0 and var_15_5 or var_15_5 * (utf8.len(var_15_6) / 52)) > 0 and var_15_5 < var_15_8 then
					arg_12_1.talkMaxDuration = var_15_8

					if var_15_8 + var_15_4 > arg_12_1.duration_ then
						arg_12_1.duration_ = var_15_8 + var_15_4
					end
				end
			...
			local var_15_9 = math.max(var_15_5, arg_12_1.talkMaxDuration)

			if var_15_4 <= arg_12_1.time_ and arg_12_1.time_ < var_15_4 + var_15_9 then
				arg_12_1.typewritter.percent = (arg_12_1.time_ - var_15_4) / var_15_9

				arg_12_1.typewritter:SetDirty()
			end

			if arg_12_1.time_ >= var_15_4 + var_15_9 and arg_12_1.time_ < var_15_4 + var_15_9 + arg_15_0 then
	...
	Play323102004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			if 0.0249999999999998 < arg_16_1.time_ and arg_16_1.time_ <= 0.0249999999999998 + arg_19_0 then
				arg_16_1:AudioAction("play", "effect", "se_story_148", "se_story_148_earthquake01", "")
			end

			local var_19_1 = 0
			local var_19_2 = 1.025
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_1 + arg_19_0 then
				...
				local var_19_3 = arg_16_1:FormatText(arg_16_1:GetWordFromCfg(323102004).content)

				arg_16_1.text_.text = var_19_3

				LuaForUtil.ClearLinePrefixSymbol(arg_16_1.text_)

				local var_19_5 = 41 <= 0 and var_19_2 or var_19_2 * (utf8.len(var_19_3) / 41)

				if (41 <= 0 and var_19_2 or var_19_2 * (utf8.len(var_19_3) / 41)) > 0 and var_19_2 < var_19_5 then
	...
	Play323102005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 then
				arg_20_1:AudioAction("play", "effect", "se_story_120", "se_story_120_mountainbreak", "")
			end

			local var_23_1 = 0
			local var_23_2 = 1.425
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_1 + arg_23_0 then
				...
				local var_23_3 = arg_20_1:FormatText(arg_20_1:GetWordFromCfg(323102005).content)

				arg_20_1.text_.text = var_23_3

				LuaForUtil.ClearLinePrefixSymbol(arg_20_1.text_)

				local var_23_5 = 57 <= 0 and var_23_2 or var_23_2 * (utf8.len(var_23_3) / 57)

				if (57 <= 0 and var_23_2 or var_23_2 * (utf8.len(var_23_3) / 57)) > 0 and var_23_2 < var_23_5 then
	...
	Play323102006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_1 then
				arg_24_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_24_1.var_.moveOldPos1053ui_story, Vector3.New(0, -1.08, -6), (arg_24_1.time_ - 0) / var_27_1)
			...
			if arg_24_1.time_ >= 0 + var_27_1 and arg_24_1.time_ < 0 + var_27_1 + arg_27_0 then
				arg_24_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, -1.08, -6)
				arg_24_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_24_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_24_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_24_1.actors_["1053ui_story"].transform.position).z)
				arg_24_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_24_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_24_1.actors_["1053ui_story"].transform.localEulerAngles = arg_24_1.actors_["1053ui_story"].transform.localEulerAngles
			...
			local var_27_3 = arg_24_1.actors_["1053ui_story"]

			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 and not isNil(var_27_3) and arg_24_1.var_.characterEffect1053ui_story == nil then
				arg_24_1.var_.characterEffect1053ui_story = var_27_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_27_4 = 0.200000002980232

			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_4 and not isNil(var_27_3) then
				if arg_24_1.var_.characterEffect1053ui_story and not isNil(var_27_3) then
					arg_24_1.var_.characterEffect1053ui_story.fillFlat = false
				end
			end

			if arg_24_1.time_ >= 0 + var_27_4 and arg_24_1.time_ < 0 + var_27_4 + arg_27_0 and not isNil(var_27_3) and arg_24_1.var_.characterEffect1053ui_story then
				arg_24_1.var_.characterEffect1053ui_story.fillFlat = false
			end
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_6 + arg_27_0 then
				...
				arg_24_1.leftNameTxt_.text = arg_24_1:FormatText(StoryNameCfg[1453].name)
				...
				local var_27_8 = arg_24_1:GetWordFromCfg(323102006)
				...
				local var_27_11 = 7 <= 0 and var_27_7 or var_27_7 * (utf8.len(var_27_9) / 7)

				if (7 <= 0 and var_27_7 or var_27_7 * (utf8.len(var_27_9) / 7)) > 0 and var_27_7 < var_27_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_323102", "323102006", "story_v_out_323102.awb") ~= 0 then
					local var_27_12 = manager.audio:GetVoiceLength("story_v_out_323102", "323102006", "story_v_out_323102.awb") / 1000
					...
					if var_27_8.prefab_name ~= "" and arg_24_1.actors_[var_27_8.prefab_name] ~= nil then
						local var_27_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_24_1.actors_[var_27_8.prefab_name].transform, "story_v_out_323102", "323102006", "story_v_out_323102.awb")

						arg_24_1:RecordAudio("323102006", var_27_13)
						arg_24_1:RecordAudio("323102006", var_27_13)
					else
	...
	Play323102007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			if arg_28_1.actors_["1048ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1048ui_story"))) then
				local var_31_0 = Object.Instantiate(Asset.Load("Char/" .. "1048ui_story"), arg_28_1.stage_.transform)

				var_31_0.name = "1048ui_story"
				var_31_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_28_1.actors_["1048ui_story"] = var_31_0
				...
				arg_28_1.var_["1048ui_story" .. "Animator"] = var_31_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_28_1.var_["1048ui_story" .. "Animator"].applyRootMotion = true
				arg_28_1.var_["1048ui_story" .. "LipSync"] = var_31_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_31_3 = arg_28_1.actors_["1048ui_story"]

			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 and not isNil(var_31_3) and arg_28_1.var_.characterEffect1048ui_story == nil then
				arg_28_1.var_.characterEffect1048ui_story = var_31_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_31_4 = 0.200000002980232

			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_4 and not isNil(var_31_3) then
				if arg_28_1.var_.characterEffect1048ui_story and not isNil(var_31_3) then
					arg_28_1.var_.characterEffect1048ui_story.fillFlat = true
					arg_28_1.var_.characterEffect1048ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_28_1.time_ - 0) / var_31_4)
				end
			end

			if arg_28_1.time_ >= 0 + var_31_4 and arg_28_1.time_ < 0 + var_31_4 + arg_31_0 and not isNil(var_31_3) and arg_28_1.var_.characterEffect1048ui_story then
				arg_28_1.var_.characterEffect1048ui_story.fillFlat = true
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_5 + arg_31_0 then
				...
				local var_31_7 = arg_28_1:FormatText(arg_28_1:GetWordFromCfg(323102007).content)

				arg_28_1.text_.text = var_31_7

				LuaForUtil.ClearLinePrefixSymbol(arg_28_1.text_)

				local var_31_9 = 13 <= 0 and var_31_6 or var_31_6 * (utf8.len(var_31_7) / 13)

				if (13 <= 0 and var_31_6 or var_31_6 * (utf8.len(var_31_7) / 13)) > 0 and var_31_6 < var_31_9 then
