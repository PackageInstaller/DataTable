return {
	Play322061001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				...
				local var_4_25 = arg_1_1:GetWordFromCfg(322061001)
				...
				local var_4_28 = 17 <= 0 and var_4_23 or var_4_23 * (utf8.len(var_4_26) / 17)

				if (17 <= 0 and var_4_23 or var_4_23 * (utf8.len(var_4_26) / 17)) > 0 and var_4_23 < var_4_28 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061001", "story_v_out_322061.awb") ~= 0 then
					local var_4_29 = manager.audio:GetVoiceLength("story_v_out_322061", "322061001", "story_v_out_322061.awb") / 1000
					...
					if var_4_25.prefab_name ~= "" and arg_1_1.actors_[var_4_25.prefab_name] ~= nil then
						local var_4_30 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_25.prefab_name].transform, "story_v_out_322061", "322061001", "story_v_out_322061.awb")

						arg_1_1:RecordAudio("322061001", var_4_30)
						arg_1_1:RecordAudio("322061001", var_4_30)
					else
	...
	Play322061002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 then
				arg_8_1.var_.moveOldPos1089ui_story = arg_8_1.actors_["1089ui_story"].transform.localPosition
			end

			local var_11_0 = 0.001

			if 0 <= arg_8_1.time_ and arg_8_1.time_ < 0 + var_11_0 then
				arg_8_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_8_1.var_.moveOldPos1089ui_story, Vector3.New(0, 100, 0), (arg_8_1.time_ - 0) / var_11_0)
				arg_8_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_8_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_8_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_8_1.actors_["1089ui_story"].transform.position).z)
				arg_8_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_8_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_8_1.actors_["1089ui_story"].transform.localEulerAngles = arg_8_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_8_1.time_ >= 0 + var_11_0 and arg_8_1.time_ < 0 + var_11_0 + arg_11_0 then
				arg_8_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_8_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_8_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_8_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_8_1.actors_["1089ui_story"].transform.position).z)
				arg_8_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_8_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_8_1.actors_["1089ui_story"].transform.localEulerAngles = arg_8_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_11_1 = arg_8_1.actors_["1089ui_story"]

			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 and not isNil(var_11_1) and arg_8_1.var_.characterEffect1089ui_story == nil then
				arg_8_1.var_.characterEffect1089ui_story = var_11_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_11_2 = 0.200000002980232

			if 0 <= arg_8_1.time_ and arg_8_1.time_ < 0 + var_11_2 and not isNil(var_11_1) then
				if arg_8_1.var_.characterEffect1089ui_story and not isNil(var_11_1) then
					arg_8_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_8_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_8_1.time_ - 0) / var_11_2)
				end
			end

			if arg_8_1.time_ >= 0 + var_11_2 and arg_8_1.time_ < 0 + var_11_2 + arg_11_0 and not isNil(var_11_1) and arg_8_1.var_.characterEffect1089ui_story then
				arg_8_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_8_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end
			...
			if 0.333333333333333 < arg_8_1.time_ and arg_8_1.time_ <= 0.333333333333333 + arg_11_0 then
				arg_8_1:AudioAction("play", "music", "bgm_activity_4_5_story_serious", "bgm_activity_4_5_story_serious", "bgm_activity_4_5_story_serious.awb")

				local var_11_8 = manager.audio:GetAudioName("bgm_activity_4_5_story_serious", "bgm_activity_4_5_story_serious")

				if "" ~= "" then
					if arg_8_1.bgmTxt_.text ~= var_11_8 and arg_8_1.bgmTxt_.text ~= "" then
						if arg_8_1.bgmTxt2_.text ~= "" then
							arg_8_1.bgmTxt_.text = arg_8_1.bgmTxt2_.text
						end

						arg_8_1.bgmTxt2_.text = var_11_8

						arg_8_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_8_1.bgmTxt_.text = var_11_8
						arg_8_1.bgmTxt2_.text = var_11_8
					end
			...
			if 0.34 < arg_8_1.time_ and arg_8_1.time_ <= 0.34 + arg_11_0 then
				arg_8_1:AudioAction("play", "music", "bgm_activity_4_5_story_serious", "init_story", "bgm_activity_4_5_story_serious.awb")

				local var_11_11 = manager.audio:GetAudioName("bgm_activity_4_5_story_serious", "init_story")

				if "" ~= "" then
					if arg_8_1.bgmTxt_.text ~= var_11_11 and arg_8_1.bgmTxt_.text ~= "" then
						if arg_8_1.bgmTxt2_.text ~= "" then
							arg_8_1.bgmTxt_.text = arg_8_1.bgmTxt2_.text
						end

						arg_8_1.bgmTxt2_.text = var_11_11

						arg_8_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_8_1.bgmTxt_.text = var_11_11
						arg_8_1.bgmTxt2_.text = var_11_11
					end
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_12 + arg_11_0 then
				...
				local var_11_14 = arg_8_1:GetWordFromCfg(322061002)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061002", "story_v_out_322061.awb") ~= 0 then
					local var_11_18 = manager.audio:GetVoiceLength("story_v_out_322061", "322061002", "story_v_out_322061.awb") / 1000
					...
					if var_11_14.prefab_name ~= "" and arg_8_1.actors_[var_11_14.prefab_name] ~= nil then
						local var_11_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_14.prefab_name].transform, "story_v_out_322061", "322061002", "story_v_out_322061.awb")

						arg_8_1:RecordAudio("322061002", var_11_19)
						arg_8_1:RecordAudio("322061002", var_11_19)
					else
	...
	Play322061003 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(322061003).content)

				arg_15_1.text_.text = var_18_1

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_3 = 51 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 51)

				if (51 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 51)) > 0 and var_18_0 < var_18_3 then
	...
	Play322061004 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(322061004).content)

				arg_19_1.text_.text = var_22_1

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_3 = 65 <= 0 and var_22_0 or var_22_0 * (utf8.len(var_22_1) / 65)

				if (65 <= 0 and var_22_0 or var_22_0 * (utf8.len(var_22_1) / 65)) > 0 and var_22_0 < var_22_3 then
	...
	Play322061005 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				...
				local var_26_1 = arg_23_1:GetWordFromCfg(322061005)
				...
				local var_26_4 = 10 <= 0 and var_26_0 or var_26_0 * (utf8.len(var_26_2) / 10)

				if (10 <= 0 and var_26_0 or var_26_0 * (utf8.len(var_26_2) / 10)) > 0 and var_26_0 < var_26_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061005", "story_v_out_322061.awb") ~= 0 then
					local var_26_5 = manager.audio:GetVoiceLength("story_v_out_322061", "322061005", "story_v_out_322061.awb") / 1000
					...
					if var_26_1.prefab_name ~= "" and arg_23_1.actors_[var_26_1.prefab_name] ~= nil then
						local var_26_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_23_1.actors_[var_26_1.prefab_name].transform, "story_v_out_322061", "322061005", "story_v_out_322061.awb")

						arg_23_1:RecordAudio("322061005", var_26_6)
						arg_23_1:RecordAudio("322061005", var_26_6)
					else
	...
	Play322061006 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				arg_27_1.var_.moveOldPos1089ui_story = arg_27_1.actors_["1089ui_story"].transform.localPosition

				arg_27_1:ShowWeapon(arg_27_1.var_["1089ui_story" .. "Animator"].transform, false)
			end

			local var_30_0 = 0.001

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_0 then
				arg_27_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_27_1.var_.moveOldPos1089ui_story, Vector3.New(0, -1.1, -6.17), (arg_27_1.time_ - 0) / var_30_0)
				arg_27_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_27_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["1089ui_story"].transform.position).z)
				arg_27_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_27_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_27_1.actors_["1089ui_story"].transform.localEulerAngles = arg_27_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_27_1.time_ >= 0 + var_30_0 and arg_27_1.time_ < 0 + var_30_0 + arg_30_0 then
				arg_27_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(0, -1.1, -6.17)
				arg_27_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_27_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["1089ui_story"].transform.position).z)
				arg_27_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_27_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_27_1.actors_["1089ui_story"].transform.localEulerAngles = arg_27_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_30_1 = arg_27_1.actors_["1089ui_story"]

			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect1089ui_story == nil then
				arg_27_1.var_.characterEffect1089ui_story = var_30_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_30_2 = 0.200000002980232

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_2 and not isNil(var_30_1) then
				if arg_27_1.var_.characterEffect1089ui_story and not isNil(var_30_1) then
					arg_27_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_27_1.time_ >= 0 + var_30_2 and arg_27_1.time_ < 0 + var_30_2 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect1089ui_story then
				arg_27_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_4 + arg_30_0 then
				...
				arg_27_1.leftNameTxt_.text = arg_27_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_30_6 = arg_27_1:GetWordFromCfg(322061006)
				...
				local var_30_9 = 43 <= 0 and var_30_5 or var_30_5 * (utf8.len(var_30_7) / 43)

				if (43 <= 0 and var_30_5 or var_30_5 * (utf8.len(var_30_7) / 43)) > 0 and var_30_5 < var_30_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061006", "story_v_out_322061.awb") ~= 0 then
					local var_30_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061006", "story_v_out_322061.awb") / 1000
					...
					if var_30_6.prefab_name ~= "" and arg_27_1.actors_[var_30_6.prefab_name] ~= nil then
						local var_30_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_27_1.actors_[var_30_6.prefab_name].transform, "story_v_out_322061", "322061006", "story_v_out_322061.awb")

						arg_27_1:RecordAudio("322061006", var_30_11)
						arg_27_1:RecordAudio("322061006", var_30_11)
					else
	...
	Play322061007 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				...
				arg_31_1.leftNameTxt_.text = arg_31_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_34_1 = arg_31_1:GetWordFromCfg(322061007)
				...
				local var_34_4 = 54 <= 0 and var_34_0 or var_34_0 * (utf8.len(var_34_2) / 54)

				if (54 <= 0 and var_34_0 or var_34_0 * (utf8.len(var_34_2) / 54)) > 0 and var_34_0 < var_34_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061007", "story_v_out_322061.awb") ~= 0 then
					local var_34_5 = manager.audio:GetVoiceLength("story_v_out_322061", "322061007", "story_v_out_322061.awb") / 1000
					...
					if var_34_1.prefab_name ~= "" and arg_31_1.actors_[var_34_1.prefab_name] ~= nil then
						local var_34_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_31_1.actors_[var_34_1.prefab_name].transform, "story_v_out_322061", "322061007", "story_v_out_322061.awb")

						arg_31_1:RecordAudio("322061007", var_34_6)
						arg_31_1:RecordAudio("322061007", var_34_6)
					else
	...
	Play322061008 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_0 + arg_38_0 then
				...
				local var_38_2 = arg_35_1:GetWordFromCfg(322061008)
				...
				local var_38_5 = 36 <= 0 and var_38_1 or var_38_1 * (utf8.len(var_38_3) / 36)

				if (36 <= 0 and var_38_1 or var_38_1 * (utf8.len(var_38_3) / 36)) > 0 and var_38_1 < var_38_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061008", "story_v_out_322061.awb") ~= 0 then
					local var_38_6 = manager.audio:GetVoiceLength("story_v_out_322061", "322061008", "story_v_out_322061.awb") / 1000
					...
					if var_38_2.prefab_name ~= "" and arg_35_1.actors_[var_38_2.prefab_name] ~= nil then
						local var_38_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_35_1.actors_[var_38_2.prefab_name].transform, "story_v_out_322061", "322061008", "story_v_out_322061.awb")

						arg_35_1:RecordAudio("322061008", var_38_7)
						arg_35_1:RecordAudio("322061008", var_38_7)
					else
	...
	Play322061009 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 and not isNil(arg_39_1.actors_["1089ui_story"]) and arg_39_1.var_.characterEffect1089ui_story == nil then
				arg_39_1.var_.characterEffect1089ui_story = arg_39_1.actors_["1089ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_42_0 = 0.200000002980232

			if 0 <= arg_39_1.time_ and arg_39_1.time_ < 0 + var_42_0 and not isNil(arg_39_1.actors_["1089ui_story"]) then
				if arg_39_1.var_.characterEffect1089ui_story and not isNil(arg_39_1.actors_["1089ui_story"]) then
					arg_39_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_39_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_39_1.time_ - 0) / var_42_0)
				end
			end

			if arg_39_1.time_ >= 0 + var_42_0 and arg_39_1.time_ < 0 + var_42_0 + arg_42_0 and not isNil(arg_39_1.actors_["1089ui_story"]) and arg_39_1.var_.characterEffect1089ui_story then
				arg_39_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_39_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end

			local var_42_1 = 0
			local var_42_2 = 0.975
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_1 + arg_42_0 then
				...
				local var_42_3 = arg_39_1:GetWordFromCfg(322061009)
				...
				local var_42_6 = 39 <= 0 and var_42_2 or var_42_2 * (utf8.len(var_42_4) / 39)

				if (39 <= 0 and var_42_2 or var_42_2 * (utf8.len(var_42_4) / 39)) > 0 and var_42_2 < var_42_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061009", "story_v_out_322061.awb") ~= 0 then
					local var_42_7 = manager.audio:GetVoiceLength("story_v_out_322061", "322061009", "story_v_out_322061.awb") / 1000
					...
					if var_42_3.prefab_name ~= "" and arg_39_1.actors_[var_42_3.prefab_name] ~= nil then
						local var_42_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_39_1.actors_[var_42_3.prefab_name].transform, "story_v_out_322061", "322061009", "story_v_out_322061.awb")

						arg_39_1:RecordAudio("322061009", var_42_8)
						arg_39_1:RecordAudio("322061009", var_42_8)
					else
	...
	Play322061010 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= 0 + arg_46_0 and not isNil(arg_43_1.actors_["1089ui_story"]) and arg_43_1.var_.characterEffect1089ui_story == nil then
				arg_43_1.var_.characterEffect1089ui_story = arg_43_1.actors_["1089ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_46_0 = 0.200000002980232

			if 0 <= arg_43_1.time_ and arg_43_1.time_ < 0 + var_46_0 and not isNil(arg_43_1.actors_["1089ui_story"]) then
				if arg_43_1.var_.characterEffect1089ui_story and not isNil(arg_43_1.actors_["1089ui_story"]) then
					arg_43_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_43_1.time_ >= 0 + var_46_0 and arg_43_1.time_ < 0 + var_46_0 + arg_46_0 and not isNil(arg_43_1.actors_["1089ui_story"]) and arg_43_1.var_.characterEffect1089ui_story then
				arg_43_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_2 + arg_46_0 then
				...
				arg_43_1.leftNameTxt_.text = arg_43_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_46_4 = arg_43_1:GetWordFromCfg(322061010)
				...
				local var_46_7 = 15 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_5) / 15)

				if (15 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_5) / 15)) > 0 and var_46_3 < var_46_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061010", "story_v_out_322061.awb") ~= 0 then
					local var_46_8 = manager.audio:GetVoiceLength("story_v_out_322061", "322061010", "story_v_out_322061.awb") / 1000
					...
					if var_46_4.prefab_name ~= "" and arg_43_1.actors_[var_46_4.prefab_name] ~= nil then
						local var_46_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_43_1.actors_[var_46_4.prefab_name].transform, "story_v_out_322061", "322061010", "story_v_out_322061.awb")

						arg_43_1:RecordAudio("322061010", var_46_9)
						arg_43_1:RecordAudio("322061010", var_46_9)
					else
	...
	Play322061011 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 and not isNil(arg_47_1.actors_["1089ui_story"]) and arg_47_1.var_.characterEffect1089ui_story == nil then
				arg_47_1.var_.characterEffect1089ui_story = arg_47_1.actors_["1089ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_50_0 = 0.200000002980232

			if 0 <= arg_47_1.time_ and arg_47_1.time_ < 0 + var_50_0 and not isNil(arg_47_1.actors_["1089ui_story"]) then
				if arg_47_1.var_.characterEffect1089ui_story and not isNil(arg_47_1.actors_["1089ui_story"]) then
					arg_47_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_47_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_47_1.time_ - 0) / var_50_0)
				end
			end

			if arg_47_1.time_ >= 0 + var_50_0 and arg_47_1.time_ < 0 + var_50_0 + arg_50_0 and not isNil(arg_47_1.actors_["1089ui_story"]) and arg_47_1.var_.characterEffect1089ui_story then
				arg_47_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_47_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_1 + arg_50_0 then
				...
				local var_50_3 = arg_47_1:GetWordFromCfg(322061011)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061011", "story_v_out_322061.awb") ~= 0 then
					local var_50_7 = manager.audio:GetVoiceLength("story_v_out_322061", "322061011", "story_v_out_322061.awb") / 1000
					...
					if var_50_3.prefab_name ~= "" and arg_47_1.actors_[var_50_3.prefab_name] ~= nil then
						local var_50_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_47_1.actors_[var_50_3.prefab_name].transform, "story_v_out_322061", "322061011", "story_v_out_322061.awb")

						arg_47_1:RecordAudio("322061011", var_50_8)
						arg_47_1:RecordAudio("322061011", var_50_8)
					else
	...
	Play322061012 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 and not isNil(arg_51_1.actors_["1089ui_story"]) and arg_51_1.var_.characterEffect1089ui_story == nil then
				arg_51_1.var_.characterEffect1089ui_story = arg_51_1.actors_["1089ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_54_0 = 0.200000002980232

			if 0 <= arg_51_1.time_ and arg_51_1.time_ < 0 + var_54_0 and not isNil(arg_51_1.actors_["1089ui_story"]) then
				if arg_51_1.var_.characterEffect1089ui_story and not isNil(arg_51_1.actors_["1089ui_story"]) then
					arg_51_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_51_1.time_ >= 0 + var_54_0 and arg_51_1.time_ < 0 + var_54_0 + arg_54_0 and not isNil(arg_51_1.actors_["1089ui_story"]) and arg_51_1.var_.characterEffect1089ui_story then
				arg_51_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_2 + arg_54_0 then
				...
				arg_51_1.leftNameTxt_.text = arg_51_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_54_4 = arg_51_1:GetWordFromCfg(322061012)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061012", "story_v_out_322061.awb") ~= 0 then
					local var_54_8 = manager.audio:GetVoiceLength("story_v_out_322061", "322061012", "story_v_out_322061.awb") / 1000
					...
					if var_54_4.prefab_name ~= "" and arg_51_1.actors_[var_54_4.prefab_name] ~= nil then
						local var_54_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_51_1.actors_[var_54_4.prefab_name].transform, "story_v_out_322061", "322061012", "story_v_out_322061.awb")

						arg_51_1:RecordAudio("322061012", var_54_9)
						arg_51_1:RecordAudio("322061012", var_54_9)
					else
	...
	Play322061013 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_0 + arg_58_0 then
				...
				local var_58_2 = arg_55_1:GetWordFromCfg(322061013)
				...
				local var_58_5 = 30 <= 0 and var_58_1 or var_58_1 * (utf8.len(var_58_3) / 30)

				if (30 <= 0 and var_58_1 or var_58_1 * (utf8.len(var_58_3) / 30)) > 0 and var_58_1 < var_58_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061013", "story_v_out_322061.awb") ~= 0 then
					local var_58_6 = manager.audio:GetVoiceLength("story_v_out_322061", "322061013", "story_v_out_322061.awb") / 1000
					...
					if var_58_2.prefab_name ~= "" and arg_55_1.actors_[var_58_2.prefab_name] ~= nil then
						local var_58_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_55_1.actors_[var_58_2.prefab_name].transform, "story_v_out_322061", "322061013", "story_v_out_322061.awb")

						arg_55_1:RecordAudio("322061013", var_58_7)
						arg_55_1:RecordAudio("322061013", var_58_7)
					else
	...
	Play322061014 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= 0 + arg_62_0 and not isNil(arg_59_1.actors_["1089ui_story"]) and arg_59_1.var_.characterEffect1089ui_story == nil then
				arg_59_1.var_.characterEffect1089ui_story = arg_59_1.actors_["1089ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_62_0 = 0.200000002980232

			if 0 <= arg_59_1.time_ and arg_59_1.time_ < 0 + var_62_0 and not isNil(arg_59_1.actors_["1089ui_story"]) then
				if arg_59_1.var_.characterEffect1089ui_story and not isNil(arg_59_1.actors_["1089ui_story"]) then
					arg_59_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_59_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_59_1.time_ - 0) / var_62_0)
				end
			end

			if arg_59_1.time_ >= 0 + var_62_0 and arg_59_1.time_ < 0 + var_62_0 + arg_62_0 and not isNil(arg_59_1.actors_["1089ui_story"]) and arg_59_1.var_.characterEffect1089ui_story then
				arg_59_1.var_.characterEffect1089ui_story.fillFlat = true
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_1 + arg_62_0 then
				...
				local var_62_3 = arg_59_1:GetWordFromCfg(322061014)
				...
				local var_62_6 = 16 <= 0 and var_62_2 or var_62_2 * (utf8.len(var_62_4) / 16)

				if (16 <= 0 and var_62_2 or var_62_2 * (utf8.len(var_62_4) / 16)) > 0 and var_62_2 < var_62_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061014", "story_v_out_322061.awb") ~= 0 then
					local var_62_7 = manager.audio:GetVoiceLength("story_v_out_322061", "322061014", "story_v_out_322061.awb") / 1000
					...
					if var_62_3.prefab_name ~= "" and arg_59_1.actors_[var_62_3.prefab_name] ~= nil then
						local var_62_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_59_1.actors_[var_62_3.prefab_name].transform, "story_v_out_322061", "322061014", "story_v_out_322061.awb")

						arg_59_1:RecordAudio("322061014", var_62_8)
						arg_59_1:RecordAudio("322061014", var_62_8)
					else
	...
	Play322061015 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= 0 + arg_66_0 then
				...
				local var_66_1 = arg_63_1:GetWordFromCfg(322061015)
				...
				local var_66_4 = 40 <= 0 and var_66_0 or var_66_0 * (utf8.len(var_66_2) / 40)

				if (40 <= 0 and var_66_0 or var_66_0 * (utf8.len(var_66_2) / 40)) > 0 and var_66_0 < var_66_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061015", "story_v_out_322061.awb") ~= 0 then
					local var_66_5 = manager.audio:GetVoiceLength("story_v_out_322061", "322061015", "story_v_out_322061.awb") / 1000
					...
					if var_66_1.prefab_name ~= "" and arg_63_1.actors_[var_66_1.prefab_name] ~= nil then
						local var_66_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_63_1.actors_[var_66_1.prefab_name].transform, "story_v_out_322061", "322061015", "story_v_out_322061.awb")

						arg_63_1:RecordAudio("322061015", var_66_6)
						arg_63_1:RecordAudio("322061015", var_66_6)
					else
	...
	Play322061016 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= 0 + arg_70_0 and not isNil(arg_67_1.actors_["1089ui_story"]) and arg_67_1.var_.characterEffect1089ui_story == nil then
				arg_67_1.var_.characterEffect1089ui_story = arg_67_1.actors_["1089ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_70_0 = 0.200000002980232

			if 0 <= arg_67_1.time_ and arg_67_1.time_ < 0 + var_70_0 and not isNil(arg_67_1.actors_["1089ui_story"]) then
				if arg_67_1.var_.characterEffect1089ui_story and not isNil(arg_67_1.actors_["1089ui_story"]) then
					arg_67_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_67_1.time_ >= 0 + var_70_0 and arg_67_1.time_ < 0 + var_70_0 + arg_70_0 and not isNil(arg_67_1.actors_["1089ui_story"]) and arg_67_1.var_.characterEffect1089ui_story then
				arg_67_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_2 + arg_70_0 then
				...
				local var_70_4 = arg_67_1:GetWordFromCfg(322061016)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061016", "story_v_out_322061.awb") ~= 0 then
					local var_70_8 = manager.audio:GetVoiceLength("story_v_out_322061", "322061016", "story_v_out_322061.awb") / 1000
					...
					if var_70_4.prefab_name ~= "" and arg_67_1.actors_[var_70_4.prefab_name] ~= nil then
						local var_70_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_67_1.actors_[var_70_4.prefab_name].transform, "story_v_out_322061", "322061016", "story_v_out_322061.awb")

						arg_67_1:RecordAudio("322061016", var_70_9)
						arg_67_1:RecordAudio("322061016", var_70_9)
					else
	...
	Play322061017 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= 0 + arg_74_0 then
				arg_71_1.var_.moveOldPos1089ui_story = arg_71_1.actors_["1089ui_story"].transform.localPosition
			end

			local var_74_0 = 0.001

			if 0 <= arg_71_1.time_ and arg_71_1.time_ < 0 + var_74_0 then
				arg_71_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_71_1.var_.moveOldPos1089ui_story, Vector3.New(0, 100, 0), (arg_71_1.time_ - 0) / var_74_0)
				arg_71_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_71_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_71_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_71_1.actors_["1089ui_story"].transform.position).z)
				arg_71_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_71_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_71_1.actors_["1089ui_story"].transform.localEulerAngles = arg_71_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_71_1.time_ >= 0 + var_74_0 and arg_71_1.time_ < 0 + var_74_0 + arg_74_0 then
				arg_71_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_71_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_71_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_71_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_71_1.actors_["1089ui_story"].transform.position).z)
				arg_71_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_71_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_71_1.actors_["1089ui_story"].transform.localEulerAngles = arg_71_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_74_1 = arg_71_1.actors_["1089ui_story"]

			if 0 < arg_71_1.time_ and arg_71_1.time_ <= 0 + arg_74_0 and not isNil(var_74_1) and arg_71_1.var_.characterEffect1089ui_story == nil then
				arg_71_1.var_.characterEffect1089ui_story = var_74_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_74_2 = 0.200000002980232

			if 0 <= arg_71_1.time_ and arg_71_1.time_ < 0 + var_74_2 and not isNil(var_74_1) then
				if arg_71_1.var_.characterEffect1089ui_story and not isNil(var_74_1) then
					arg_71_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_71_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_71_1.time_ - 0) / var_74_2)
				end
			end

			if arg_71_1.time_ >= 0 + var_74_2 and arg_71_1.time_ < 0 + var_74_2 + arg_74_0 and not isNil(var_74_1) and arg_71_1.var_.characterEffect1089ui_story then
				arg_71_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_71_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_3 + arg_74_0 then
				...
				local var_74_5 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(322061017).content)

				arg_71_1.text_.text = var_74_5

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_7 = 46 <= 0 and var_74_4 or var_74_4 * (utf8.len(var_74_5) / 46)

				if (46 <= 0 and var_74_4 or var_74_4 * (utf8.len(var_74_5) / 46)) > 0 and var_74_4 < var_74_7 then
	...
	Play322061018 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			if arg_75_1.bgs_.L15h == nil then
				local var_78_0 = Object.Instantiate(arg_75_1.paintGo_)

				var_78_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "L15h")
				var_78_0.name = "L15h"
				var_78_0.transform.parent = arg_75_1.stage_.transform
				var_78_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_75_1.bgs_.L15h = var_78_0
			end

			if 2 < arg_75_1.time_ and arg_75_1.time_ <= 2 + arg_78_0 then
				local var_78_1 = arg_75_1.bgs_.L15h

				arg_75_1.bgs_.L15h.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 0.1 < arg_75_1.time_ and arg_75_1.time_ <= 0.1 + arg_78_0 then
				arg_75_1:AudioAction("stop", "effect", "se_story_141", "se_story_141_amb_street_night02", "")
			end

			if 1.66666666666667 < arg_75_1.time_ and arg_75_1.time_ <= 1.66666666666667 + arg_78_0 then
				arg_75_1:AudioAction("play", "effect", "se_story_145", "se_story_145_amb_drone_haizhen", "")
			end

			if 1.66666666666667 < arg_75_1.time_ and arg_75_1.time_ <= 1.66666666666667 + arg_78_0 then
				arg_75_1:AudioAction("play", "music", "bgm_activity_4_5_story_serious", "battle", "bgm_activity_4_5_story_serious.awb")

				local var_78_17 = manager.audio:GetAudioName("bgm_activity_4_5_story_serious", "battle")

				if "" ~= "" then
					if arg_75_1.bgmTxt_.text ~= var_78_17 and arg_75_1.bgmTxt_.text ~= "" then
						if arg_75_1.bgmTxt2_.text ~= "" then
							arg_75_1.bgmTxt_.text = arg_75_1.bgmTxt2_.text
						end

						arg_75_1.bgmTxt2_.text = var_78_17

						arg_75_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_75_1.bgmTxt_.text = var_78_17
						arg_75_1.bgmTxt2_.text = var_78_17
					end
			...
			local var_78_18 = 4
			local var_78_19 = 0.125

			if 4 < arg_75_1.time_ and arg_75_1.time_ <= var_78_18 + arg_78_0 then
				...
				var_78_20:setOnUpdate(LuaHelper.FloatAction(function(arg_80_0)
				...
				local var_78_21 = arg_75_1:GetWordFromCfg(322061018)
				...
				local var_78_24 = 3 <= 0 and var_78_19 or var_78_19 * (utf8.len(var_78_22) / 3)

				if (3 <= 0 and var_78_19 or var_78_19 * (utf8.len(var_78_22) / 3)) > 0 and var_78_19 < var_78_24 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061018", "story_v_out_322061.awb") ~= 0 then
					local var_78_25 = manager.audio:GetVoiceLength("story_v_out_322061", "322061018", "story_v_out_322061.awb") / 1000
					...
					if var_78_21.prefab_name ~= "" and arg_75_1.actors_[var_78_21.prefab_name] ~= nil then
						local var_78_26 = LuaForUtil.PlayVoiceWithCriLipsync(arg_75_1.actors_[var_78_21.prefab_name].transform, "story_v_out_322061", "322061018", "story_v_out_322061.awb")

						arg_75_1:RecordAudio("322061018", var_78_26)
						arg_75_1:RecordAudio("322061018", var_78_26)
					else
	...
	Play322061019 = function(arg_82_0, arg_82_1)
		...
		function arg_82_1.onSingleLineUpdate_(arg_85_0)
			if arg_82_1.actors_["404001ui_story"] == nil and not isNil((Asset.Load("Char/" .. "404001ui_story"))) then
				local var_85_0 = Object.Instantiate(Asset.Load("Char/" .. "404001ui_story"), arg_82_1.stage_.transform)

				var_85_0.name = "404001ui_story"
				var_85_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_82_1.actors_["404001ui_story"] = var_85_0
				...
				arg_82_1.var_["404001ui_story" .. "Animator"] = var_85_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_82_1.var_["404001ui_story" .. "Animator"].applyRootMotion = true
				arg_82_1.var_["404001ui_story" .. "LipSync"] = var_85_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_85_3 = arg_82_1.actors_["404001ui_story"].transform

			if 0 < arg_82_1.time_ and arg_82_1.time_ <= 0 + arg_85_0 then
				arg_82_1.var_.moveOldPos404001ui_story = var_85_3.localPosition
			end

			local var_85_4 = 0.001

			if 0 <= arg_82_1.time_ and arg_82_1.time_ < 0 + var_85_4 then
				var_85_3.localPosition = Vector3.Lerp(arg_82_1.var_.moveOldPos404001ui_story, Vector3.New(0, -1.55, -5.5), (arg_82_1.time_ - 0) / var_85_4)
			...
			if arg_82_1.time_ >= 0 + var_85_4 and arg_82_1.time_ < 0 + var_85_4 + arg_85_0 then
				var_85_3.localPosition = Vector3.New(0, -1.55, -5.5)
				var_85_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_85_3.position).x, (manager.ui.mainCamera.transform.position - var_85_3.position).y, (manager.ui.mainCamera.transform.position - var_85_3.position).z)
				var_85_3.localEulerAngles.z = 0
				var_85_3.localEulerAngles.x = 0
				var_85_3.localEulerAngles = var_85_3.localEulerAngles
			...
			local var_85_5 = arg_82_1.actors_["404001ui_story"]

			if 0 < arg_82_1.time_ and arg_82_1.time_ <= 0 + arg_85_0 and not isNil(var_85_5) and arg_82_1.var_.characterEffect404001ui_story == nil then
				arg_82_1.var_.characterEffect404001ui_story = var_85_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_85_6 = 0.200000002980232

			if 0 <= arg_82_1.time_ and arg_82_1.time_ < 0 + var_85_6 and not isNil(var_85_5) then
				if arg_82_1.var_.characterEffect404001ui_story and not isNil(var_85_5) then
					arg_82_1.var_.characterEffect404001ui_story.fillFlat = false
				end
			end

			if arg_82_1.time_ >= 0 + var_85_6 and arg_82_1.time_ < 0 + var_85_6 + arg_85_0 and not isNil(var_85_5) and arg_82_1.var_.characterEffect404001ui_story then
				arg_82_1.var_.characterEffect404001ui_story.fillFlat = false
			end
			...
			if 0 < arg_82_1.time_ and arg_82_1.time_ <= var_85_8 + arg_85_0 then
				...
				arg_82_1.leftNameTxt_.text = arg_82_1:FormatText(StoryNameCfg[668].name)
				...
				local var_85_10 = arg_82_1:GetWordFromCfg(322061019)
				...
				local var_85_13 = 11 <= 0 and var_85_9 or var_85_9 * (utf8.len(var_85_11) / 11)

				if (11 <= 0 and var_85_9 or var_85_9 * (utf8.len(var_85_11) / 11)) > 0 and var_85_9 < var_85_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061019", "story_v_out_322061.awb") ~= 0 then
					local var_85_14 = manager.audio:GetVoiceLength("story_v_out_322061", "322061019", "story_v_out_322061.awb") / 1000
					...
					if var_85_10.prefab_name ~= "" and arg_82_1.actors_[var_85_10.prefab_name] ~= nil then
						local var_85_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_82_1.actors_[var_85_10.prefab_name].transform, "story_v_out_322061", "322061019", "story_v_out_322061.awb")

						arg_82_1:RecordAudio("322061019", var_85_15)
						arg_82_1:RecordAudio("322061019", var_85_15)
					else
	...
	Play322061020 = function(arg_86_0, arg_86_1)
		...
		function arg_86_1.onSingleLineUpdate_(arg_89_0)
			...
			if 0 <= arg_86_1.time_ and arg_86_1.time_ < 0 + var_89_0 then
				arg_86_1.actors_["404001ui_story"].transform.localPosition = Vector3.Lerp(arg_86_1.var_.moveOldPos404001ui_story, Vector3.New(0, 100, 0), (arg_86_1.time_ - 0) / var_89_0)
			...
			if arg_86_1.time_ >= 0 + var_89_0 and arg_86_1.time_ < 0 + var_89_0 + arg_89_0 then
				arg_86_1.actors_["404001ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_86_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_86_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_86_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_86_1.actors_["404001ui_story"].transform.position).z)
				arg_86_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_86_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_86_1.actors_["404001ui_story"].transform.localEulerAngles = arg_86_1.actors_["404001ui_story"].transform.localEulerAngles
			...
			local var_89_1 = arg_86_1.actors_["404001ui_story"]

			if 0 < arg_86_1.time_ and arg_86_1.time_ <= 0 + arg_89_0 and not isNil(var_89_1) and arg_86_1.var_.characterEffect404001ui_story == nil then
				arg_86_1.var_.characterEffect404001ui_story = var_89_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_89_2 = 0.200000002980232

			if 0 <= arg_86_1.time_ and arg_86_1.time_ < 0 + var_89_2 and not isNil(var_89_1) then
				if arg_86_1.var_.characterEffect404001ui_story and not isNil(var_89_1) then
					arg_86_1.var_.characterEffect404001ui_story.fillFlat = true
					arg_86_1.var_.characterEffect404001ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_86_1.time_ - 0) / var_89_2)
				end
			end

			if arg_86_1.time_ >= 0 + var_89_2 and arg_86_1.time_ < 0 + var_89_2 + arg_89_0 and not isNil(var_89_1) and arg_86_1.var_.characterEffect404001ui_story then
				arg_86_1.var_.characterEffect404001ui_story.fillFlat = true
				arg_86_1.var_.characterEffect404001ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_86_1.time_ and arg_86_1.time_ <= var_89_3 + arg_89_0 then
				...
				local var_89_5 = arg_86_1:FormatText(arg_86_1:GetWordFromCfg(322061020).content)

				arg_86_1.text_.text = var_89_5

				LuaForUtil.ClearLinePrefixSymbol(arg_86_1.text_)

				local var_89_7 = 44 <= 0 and var_89_4 or var_89_4 * (utf8.len(var_89_5) / 44)

				if (44 <= 0 and var_89_4 or var_89_4 * (utf8.len(var_89_5) / 44)) > 0 and var_89_4 < var_89_7 then
	...
	Play322061021 = function(arg_90_0, arg_90_1)
		...
		function arg_90_1.onSingleLineUpdate_(arg_93_0)
			...
			if 0 < arg_90_1.time_ and arg_90_1.time_ <= 0 + arg_93_0 then
				...
				local var_93_1 = arg_90_1:FormatText(arg_90_1:GetWordFromCfg(322061021).content)

				arg_90_1.text_.text = var_93_1

				LuaForUtil.ClearLinePrefixSymbol(arg_90_1.text_)

				local var_93_3 = 60 <= 0 and var_93_0 or var_93_0 * (utf8.len(var_93_1) / 60)

				if (60 <= 0 and var_93_0 or var_93_0 * (utf8.len(var_93_1) / 60)) > 0 and var_93_0 < var_93_3 then
	...
	Play322061022 = function(arg_94_0, arg_94_1)
		...
		function arg_94_1.onSingleLineUpdate_(arg_97_0)
			if arg_94_1.actors_["1156ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1156ui_story"))) then
				local var_97_0 = Object.Instantiate(Asset.Load("Char/" .. "1156ui_story"), arg_94_1.stage_.transform)

				var_97_0.name = "1156ui_story"
				var_97_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_94_1.actors_["1156ui_story"] = var_97_0
				...
				arg_94_1.var_["1156ui_story" .. "Animator"] = var_97_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_94_1.var_["1156ui_story" .. "Animator"].applyRootMotion = true
				arg_94_1.var_["1156ui_story" .. "LipSync"] = var_97_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_97_3 = arg_94_1.actors_["1156ui_story"].transform

			if 0 < arg_94_1.time_ and arg_94_1.time_ <= 0 + arg_97_0 then
				arg_94_1.var_.moveOldPos1156ui_story = var_97_3.localPosition
			end

			local var_97_4 = 0.001

			if 0 <= arg_94_1.time_ and arg_94_1.time_ < 0 + var_97_4 then
				var_97_3.localPosition = Vector3.Lerp(arg_94_1.var_.moveOldPos1156ui_story, Vector3.New(-0.9, -1.1, -6.18), (arg_94_1.time_ - 0) / var_97_4)
			...
			if arg_94_1.time_ >= 0 + var_97_4 and arg_94_1.time_ < 0 + var_97_4 + arg_97_0 then
				var_97_3.localPosition = Vector3.New(-0.9, -1.1, -6.18)
				var_97_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_97_3.position).x, (manager.ui.mainCamera.transform.position - var_97_3.position).y, (manager.ui.mainCamera.transform.position - var_97_3.position).z)
				var_97_3.localEulerAngles.z = 0
				var_97_3.localEulerAngles.x = 0
				var_97_3.localEulerAngles = var_97_3.localEulerAngles
			...
			local var_97_5 = arg_94_1.actors_["1156ui_story"]

			if 0 < arg_94_1.time_ and arg_94_1.time_ <= 0 + arg_97_0 and not isNil(var_97_5) and arg_94_1.var_.characterEffect1156ui_story == nil then
				arg_94_1.var_.characterEffect1156ui_story = var_97_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_97_6 = 0.200000002980232

			if 0 <= arg_94_1.time_ and arg_94_1.time_ < 0 + var_97_6 and not isNil(var_97_5) then
				if arg_94_1.var_.characterEffect1156ui_story and not isNil(var_97_5) then
					arg_94_1.var_.characterEffect1156ui_story.fillFlat = false
				end
			end

			if arg_94_1.time_ >= 0 + var_97_6 and arg_94_1.time_ < 0 + var_97_6 + arg_97_0 and not isNil(var_97_5) and arg_94_1.var_.characterEffect1156ui_story then
				arg_94_1.var_.characterEffect1156ui_story.fillFlat = false
			end
			...
			if 0 < arg_94_1.time_ and arg_94_1.time_ <= var_97_8 + arg_97_0 then
				...
				arg_94_1.leftNameTxt_.text = arg_94_1:FormatText(StoryNameCfg[605].name)
				...
				local var_97_10 = arg_94_1:GetWordFromCfg(322061022)
				...
				local var_97_13 = 15 <= 0 and var_97_9 or var_97_9 * (utf8.len(var_97_11) / 15)

				if (15 <= 0 and var_97_9 or var_97_9 * (utf8.len(var_97_11) / 15)) > 0 and var_97_9 < var_97_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061022", "story_v_out_322061.awb") ~= 0 then
					local var_97_14 = manager.audio:GetVoiceLength("story_v_out_322061", "322061022", "story_v_out_322061.awb") / 1000
					...
					if var_97_10.prefab_name ~= "" and arg_94_1.actors_[var_97_10.prefab_name] ~= nil then
						local var_97_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_94_1.actors_[var_97_10.prefab_name].transform, "story_v_out_322061", "322061022", "story_v_out_322061.awb")

						arg_94_1:RecordAudio("322061022", var_97_15)
						arg_94_1:RecordAudio("322061022", var_97_15)
					else
	...
	Play322061023 = function(arg_98_0, arg_98_1)
		...
		function arg_98_1.onSingleLineUpdate_(arg_101_0)
			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 then
				arg_98_1.var_.moveOldPos404001ui_story = arg_98_1.actors_["404001ui_story"].transform.localPosition
			end

			local var_101_0 = 0.001

			if 0 <= arg_98_1.time_ and arg_98_1.time_ < 0 + var_101_0 then
				arg_98_1.actors_["404001ui_story"].transform.localPosition = Vector3.Lerp(arg_98_1.var_.moveOldPos404001ui_story, Vector3.New(0.8, -1.55, -5.5), (arg_98_1.time_ - 0) / var_101_0)
				arg_98_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_98_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["404001ui_story"].transform.position).z)
				arg_98_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_98_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_98_1.actors_["404001ui_story"].transform.localEulerAngles = arg_98_1.actors_["404001ui_story"].transform.localEulerAngles
			end

			if arg_98_1.time_ >= 0 + var_101_0 and arg_98_1.time_ < 0 + var_101_0 + arg_101_0 then
				arg_98_1.actors_["404001ui_story"].transform.localPosition = Vector3.New(0.8, -1.55, -5.5)
				arg_98_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_98_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["404001ui_story"].transform.position).z)
				arg_98_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_98_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_98_1.actors_["404001ui_story"].transform.localEulerAngles = arg_98_1.actors_["404001ui_story"].transform.localEulerAngles
			...
			local var_101_1 = arg_98_1.actors_["404001ui_story"]

			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 and not isNil(var_101_1) and arg_98_1.var_.characterEffect404001ui_story == nil then
				arg_98_1.var_.characterEffect404001ui_story = var_101_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_101_2 = 0.200000002980232

			if 0 <= arg_98_1.time_ and arg_98_1.time_ < 0 + var_101_2 and not isNil(var_101_1) then
				if arg_98_1.var_.characterEffect404001ui_story and not isNil(var_101_1) then
					arg_98_1.var_.characterEffect404001ui_story.fillFlat = false
				end
			end

			if arg_98_1.time_ >= 0 + var_101_2 and arg_98_1.time_ < 0 + var_101_2 + arg_101_0 and not isNil(var_101_1) and arg_98_1.var_.characterEffect404001ui_story then
				arg_98_1.var_.characterEffect404001ui_story.fillFlat = false
			end

			local var_101_4 = arg_98_1.actors_["1156ui_story"]

			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 and not isNil(var_101_4) and arg_98_1.var_.characterEffect1156ui_story == nil then
				arg_98_1.var_.characterEffect1156ui_story = var_101_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_101_5 = 0.200000002980232

			if 0 <= arg_98_1.time_ and arg_98_1.time_ < 0 + var_101_5 and not isNil(var_101_4) then
				if arg_98_1.var_.characterEffect1156ui_story and not isNil(var_101_4) then
					arg_98_1.var_.characterEffect1156ui_story.fillFlat = true
					arg_98_1.var_.characterEffect1156ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_98_1.time_ - 0) / var_101_5)
				end
			end

			if arg_98_1.time_ >= 0 + var_101_5 and arg_98_1.time_ < 0 + var_101_5 + arg_101_0 and not isNil(var_101_4) and arg_98_1.var_.characterEffect1156ui_story then
				arg_98_1.var_.characterEffect1156ui_story.fillFlat = true
				arg_98_1.var_.characterEffect1156ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_98_1.time_ and arg_98_1.time_ <= var_101_6 + arg_101_0 then
				...
				local var_101_8 = arg_98_1:GetWordFromCfg(322061023)
				...
				local var_101_11 = 8 <= 0 and var_101_7 or var_101_7 * (utf8.len(var_101_9) / 8)

				if (8 <= 0 and var_101_7 or var_101_7 * (utf8.len(var_101_9) / 8)) > 0 and var_101_7 < var_101_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061023", "story_v_out_322061.awb") ~= 0 then
					local var_101_12 = manager.audio:GetVoiceLength("story_v_out_322061", "322061023", "story_v_out_322061.awb") / 1000
					...
					if var_101_8.prefab_name ~= "" and arg_98_1.actors_[var_101_8.prefab_name] ~= nil then
						local var_101_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_98_1.actors_[var_101_8.prefab_name].transform, "story_v_out_322061", "322061023", "story_v_out_322061.awb")

						arg_98_1:RecordAudio("322061023", var_101_13)
						arg_98_1:RecordAudio("322061023", var_101_13)
					else
	...
	Play322061024 = function(arg_102_0, arg_102_1)
		...
		function arg_102_1.onSingleLineUpdate_(arg_105_0)
			if 0 < arg_102_1.time_ and arg_102_1.time_ <= 0 + arg_105_0 then
				arg_102_1.var_.moveOldPos1156ui_story = arg_102_1.actors_["1156ui_story"].transform.localPosition
			end

			local var_105_0 = 0.001

			if 0 <= arg_102_1.time_ and arg_102_1.time_ < 0 + var_105_0 then
				arg_102_1.actors_["1156ui_story"].transform.localPosition = Vector3.Lerp(arg_102_1.var_.moveOldPos1156ui_story, Vector3.New(-0.9, -1.1, -6.18), (arg_102_1.time_ - 0) / var_105_0)
				arg_102_1.actors_["1156ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_102_1.actors_["1156ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_102_1.actors_["1156ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_102_1.actors_["1156ui_story"].transform.position).z)
				arg_102_1.actors_["1156ui_story"].transform.localEulerAngles.z = 0
				arg_102_1.actors_["1156ui_story"].transform.localEulerAngles.x = 0
				arg_102_1.actors_["1156ui_story"].transform.localEulerAngles = arg_102_1.actors_["1156ui_story"].transform.localEulerAngles
			end

			if arg_102_1.time_ >= 0 + var_105_0 and arg_102_1.time_ < 0 + var_105_0 + arg_105_0 then
				arg_102_1.actors_["1156ui_story"].transform.localPosition = Vector3.New(-0.9, -1.1, -6.18)
				arg_102_1.actors_["1156ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_102_1.actors_["1156ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_102_1.actors_["1156ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_102_1.actors_["1156ui_story"].transform.position).z)
				arg_102_1.actors_["1156ui_story"].transform.localEulerAngles.z = 0
				arg_102_1.actors_["1156ui_story"].transform.localEulerAngles.x = 0
				arg_102_1.actors_["1156ui_story"].transform.localEulerAngles = arg_102_1.actors_["1156ui_story"].transform.localEulerAngles
			...
			local var_105_1 = arg_102_1.actors_["1156ui_story"]

			if 0 < arg_102_1.time_ and arg_102_1.time_ <= 0 + arg_105_0 and not isNil(var_105_1) and arg_102_1.var_.characterEffect1156ui_story == nil then
				arg_102_1.var_.characterEffect1156ui_story = var_105_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_105_2 = 0.200000002980232

			if 0 <= arg_102_1.time_ and arg_102_1.time_ < 0 + var_105_2 and not isNil(var_105_1) then
				if arg_102_1.var_.characterEffect1156ui_story and not isNil(var_105_1) then
					arg_102_1.var_.characterEffect1156ui_story.fillFlat = false
				end
			end

			if arg_102_1.time_ >= 0 + var_105_2 and arg_102_1.time_ < 0 + var_105_2 + arg_105_0 and not isNil(var_105_1) and arg_102_1.var_.characterEffect1156ui_story then
				arg_102_1.var_.characterEffect1156ui_story.fillFlat = false
			end

			local var_105_4 = arg_102_1.actors_["404001ui_story"]

			if 0 < arg_102_1.time_ and arg_102_1.time_ <= 0 + arg_105_0 and not isNil(var_105_4) and arg_102_1.var_.characterEffect404001ui_story == nil then
				arg_102_1.var_.characterEffect404001ui_story = var_105_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_105_5 = 0.200000002980232

			if 0 <= arg_102_1.time_ and arg_102_1.time_ < 0 + var_105_5 and not isNil(var_105_4) then
				if arg_102_1.var_.characterEffect404001ui_story and not isNil(var_105_4) then
					arg_102_1.var_.characterEffect404001ui_story.fillFlat = true
					arg_102_1.var_.characterEffect404001ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_102_1.time_ - 0) / var_105_5)
				end
			end

			if arg_102_1.time_ >= 0 + var_105_5 and arg_102_1.time_ < 0 + var_105_5 + arg_105_0 and not isNil(var_105_4) and arg_102_1.var_.characterEffect404001ui_story then
				arg_102_1.var_.characterEffect404001ui_story.fillFlat = true
				arg_102_1.var_.characterEffect404001ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_102_1.time_ and arg_102_1.time_ <= var_105_6 + arg_105_0 then
				...
				arg_102_1.leftNameTxt_.text = arg_102_1:FormatText(StoryNameCfg[605].name)
				...
				local var_105_8 = arg_102_1:GetWordFromCfg(322061024)
				...
				local var_105_11 = 29 <= 0 and var_105_7 or var_105_7 * (utf8.len(var_105_9) / 29)

				if (29 <= 0 and var_105_7 or var_105_7 * (utf8.len(var_105_9) / 29)) > 0 and var_105_7 < var_105_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061024", "story_v_out_322061.awb") ~= 0 then
					local var_105_12 = manager.audio:GetVoiceLength("story_v_out_322061", "322061024", "story_v_out_322061.awb") / 1000
					...
					if var_105_8.prefab_name ~= "" and arg_102_1.actors_[var_105_8.prefab_name] ~= nil then
						local var_105_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_102_1.actors_[var_105_8.prefab_name].transform, "story_v_out_322061", "322061024", "story_v_out_322061.awb")

						arg_102_1:RecordAudio("322061024", var_105_13)
						arg_102_1:RecordAudio("322061024", var_105_13)
					else
	...
	Play322061025 = function(arg_106_0, arg_106_1)
		...
		function arg_106_1.onSingleLineUpdate_(arg_109_0)
			if 0 < arg_106_1.time_ and arg_106_1.time_ <= 0 + arg_109_0 and not isNil(arg_106_1.actors_["404001ui_story"]) and arg_106_1.var_.characterEffect404001ui_story == nil then
				arg_106_1.var_.characterEffect404001ui_story = arg_106_1.actors_["404001ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_109_0 = 0.200000002980232

			if 0 <= arg_106_1.time_ and arg_106_1.time_ < 0 + var_109_0 and not isNil(arg_106_1.actors_["404001ui_story"]) then
				if arg_106_1.var_.characterEffect404001ui_story and not isNil(arg_106_1.actors_["404001ui_story"]) then
					arg_106_1.var_.characterEffect404001ui_story.fillFlat = false
				end
			end

			if arg_106_1.time_ >= 0 + var_109_0 and arg_106_1.time_ < 0 + var_109_0 + arg_109_0 and not isNil(arg_106_1.actors_["404001ui_story"]) and arg_106_1.var_.characterEffect404001ui_story then
				arg_106_1.var_.characterEffect404001ui_story.fillFlat = false
			end

			local var_109_2 = arg_106_1.actors_["1156ui_story"]

			if 0 < arg_106_1.time_ and arg_106_1.time_ <= 0 + arg_109_0 and not isNil(var_109_2) and arg_106_1.var_.characterEffect1156ui_story == nil then
				arg_106_1.var_.characterEffect1156ui_story = var_109_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_109_3 = 0.200000002980232

			if 0 <= arg_106_1.time_ and arg_106_1.time_ < 0 + var_109_3 and not isNil(var_109_2) then
				if arg_106_1.var_.characterEffect1156ui_story and not isNil(var_109_2) then
					arg_106_1.var_.characterEffect1156ui_story.fillFlat = true
					arg_106_1.var_.characterEffect1156ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_106_1.time_ - 0) / var_109_3)
				end
			end

			if arg_106_1.time_ >= 0 + var_109_3 and arg_106_1.time_ < 0 + var_109_3 + arg_109_0 and not isNil(var_109_2) and arg_106_1.var_.characterEffect1156ui_story then
				arg_106_1.var_.characterEffect1156ui_story.fillFlat = true
				arg_106_1.var_.characterEffect1156ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_106_1.time_ and arg_106_1.time_ <= var_109_4 + arg_109_0 then
				...
				local var_109_6 = arg_106_1:GetWordFromCfg(322061025)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061025", "story_v_out_322061.awb") ~= 0 then
					local var_109_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061025", "story_v_out_322061.awb") / 1000
					...
					if var_109_6.prefab_name ~= "" and arg_106_1.actors_[var_109_6.prefab_name] ~= nil then
						local var_109_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_106_1.actors_[var_109_6.prefab_name].transform, "story_v_out_322061", "322061025", "story_v_out_322061.awb")

						arg_106_1:RecordAudio("322061025", var_109_11)
						arg_106_1:RecordAudio("322061025", var_109_11)
					else
	...
	Play322061026 = function(arg_110_0, arg_110_1)
		...
		function arg_110_1.onSingleLineUpdate_(arg_113_0)
			if 0 < arg_110_1.time_ and arg_110_1.time_ <= 0 + arg_113_0 then
				arg_110_1.var_.moveOldPos404001ui_story = arg_110_1.actors_["404001ui_story"].transform.localPosition
			end

			local var_113_0 = 0.001

			if 0 <= arg_110_1.time_ and arg_110_1.time_ < 0 + var_113_0 then
				arg_110_1.actors_["404001ui_story"].transform.localPosition = Vector3.Lerp(arg_110_1.var_.moveOldPos404001ui_story, Vector3.New(0, 100, 0), (arg_110_1.time_ - 0) / var_113_0)
				arg_110_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_110_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_110_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_110_1.actors_["404001ui_story"].transform.position).z)
				arg_110_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_110_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_110_1.actors_["404001ui_story"].transform.localEulerAngles = arg_110_1.actors_["404001ui_story"].transform.localEulerAngles
			end

			if arg_110_1.time_ >= 0 + var_113_0 and arg_110_1.time_ < 0 + var_113_0 + arg_113_0 then
				arg_110_1.actors_["404001ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_110_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_110_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_110_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_110_1.actors_["404001ui_story"].transform.position).z)
				arg_110_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_110_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_110_1.actors_["404001ui_story"].transform.localEulerAngles = arg_110_1.actors_["404001ui_story"].transform.localEulerAngles
			...
			local var_113_1 = arg_110_1.actors_["1156ui_story"].transform

			if 0 < arg_110_1.time_ and arg_110_1.time_ <= 0 + arg_113_0 then
				arg_110_1.var_.moveOldPos1156ui_story = var_113_1.localPosition
			end

			local var_113_2 = 0.001

			if 0 <= arg_110_1.time_ and arg_110_1.time_ < 0 + var_113_2 then
				var_113_1.localPosition = Vector3.Lerp(arg_110_1.var_.moveOldPos1156ui_story, Vector3.New(0, 100, 0), (arg_110_1.time_ - 0) / var_113_2)
			...
			local var_113_3 = arg_110_1.actors_["404001ui_story"]

			if 0 < arg_110_1.time_ and arg_110_1.time_ <= 0 + arg_113_0 and not isNil(var_113_3) and arg_110_1.var_.characterEffect404001ui_story == nil then
				arg_110_1.var_.characterEffect404001ui_story = var_113_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_113_4 = 0.200000002980232

			if 0 <= arg_110_1.time_ and arg_110_1.time_ < 0 + var_113_4 and not isNil(var_113_3) then
				if arg_110_1.var_.characterEffect404001ui_story and not isNil(var_113_3) then
					arg_110_1.var_.characterEffect404001ui_story.fillFlat = true
					arg_110_1.var_.characterEffect404001ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_110_1.time_ - 0) / var_113_4)
				end
			end

			if arg_110_1.time_ >= 0 + var_113_4 and arg_110_1.time_ < 0 + var_113_4 + arg_113_0 and not isNil(var_113_3) and arg_110_1.var_.characterEffect404001ui_story then
				arg_110_1.var_.characterEffect404001ui_story.fillFlat = true
				arg_110_1.var_.characterEffect404001ui_story.fillRatio = 0.5
			end

			if 0.733333333333333 < arg_110_1.time_ and arg_110_1.time_ <= 0.733333333333333 + arg_113_0 then
				arg_110_1:AudioAction("play", "effect", "se_story_1310", "se_story_1310_footstep02", "")
			end

			local var_113_6 = 0
			local var_113_7 = 1.175
			...
			if 0 < arg_110_1.time_ and arg_110_1.time_ <= var_113_6 + arg_113_0 then
				...
				local var_113_8 = arg_110_1:FormatText(arg_110_1:GetWordFromCfg(322061026).content)

				arg_110_1.text_.text = var_113_8

				LuaForUtil.ClearLinePrefixSymbol(arg_110_1.text_)

				local var_113_10 = 47 <= 0 and var_113_7 or var_113_7 * (utf8.len(var_113_8) / 47)

				if (47 <= 0 and var_113_7 or var_113_7 * (utf8.len(var_113_8) / 47)) > 0 and var_113_7 < var_113_10 then
					arg_110_1.talkMaxDuration = var_113_10

					if var_113_10 + var_113_6 > arg_110_1.duration_ then
						arg_110_1.duration_ = var_113_10 + var_113_6
					end
				end
			...
			local var_113_11 = math.max(var_113_7, arg_110_1.talkMaxDuration)

			if var_113_6 <= arg_110_1.time_ and arg_110_1.time_ < var_113_6 + var_113_11 then
				arg_110_1.typewritter.percent = (arg_110_1.time_ - var_113_6) / var_113_11

				arg_110_1.typewritter:SetDirty()
			end

			if arg_110_1.time_ >= var_113_6 + var_113_11 and arg_110_1.time_ < var_113_6 + var_113_11 + arg_113_0 then
	...
	Play322061027 = function(arg_114_0, arg_114_1)
		...
		function arg_114_1.onSingleLineUpdate_(arg_117_0)
			if 0 < arg_114_1.time_ and arg_114_1.time_ <= 0 + arg_117_0 then
				arg_114_1.var_.moveOldPos1156ui_story = arg_114_1.actors_["1156ui_story"].transform.localPosition
			end

			local var_117_0 = 0.001

			if 0 <= arg_114_1.time_ and arg_114_1.time_ < 0 + var_117_0 then
				arg_114_1.actors_["1156ui_story"].transform.localPosition = Vector3.Lerp(arg_114_1.var_.moveOldPos1156ui_story, Vector3.New(-0.9, -1.1, -6.18), (arg_114_1.time_ - 0) / var_117_0)
				arg_114_1.actors_["1156ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_114_1.actors_["1156ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_114_1.actors_["1156ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_114_1.actors_["1156ui_story"].transform.position).z)
				arg_114_1.actors_["1156ui_story"].transform.localEulerAngles.z = 0
				arg_114_1.actors_["1156ui_story"].transform.localEulerAngles.x = 0
				arg_114_1.actors_["1156ui_story"].transform.localEulerAngles = arg_114_1.actors_["1156ui_story"].transform.localEulerAngles
			end

			if arg_114_1.time_ >= 0 + var_117_0 and arg_114_1.time_ < 0 + var_117_0 + arg_117_0 then
				arg_114_1.actors_["1156ui_story"].transform.localPosition = Vector3.New(-0.9, -1.1, -6.18)
				arg_114_1.actors_["1156ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_114_1.actors_["1156ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_114_1.actors_["1156ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_114_1.actors_["1156ui_story"].transform.position).z)
				arg_114_1.actors_["1156ui_story"].transform.localEulerAngles.z = 0
				arg_114_1.actors_["1156ui_story"].transform.localEulerAngles.x = 0
				arg_114_1.actors_["1156ui_story"].transform.localEulerAngles = arg_114_1.actors_["1156ui_story"].transform.localEulerAngles
			...
			local var_117_1 = arg_114_1.actors_["1156ui_story"]

			if 0 < arg_114_1.time_ and arg_114_1.time_ <= 0 + arg_117_0 and not isNil(var_117_1) and arg_114_1.var_.characterEffect1156ui_story == nil then
				arg_114_1.var_.characterEffect1156ui_story = var_117_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_117_2 = 0.200000002980232

			if 0 <= arg_114_1.time_ and arg_114_1.time_ < 0 + var_117_2 and not isNil(var_117_1) then
				if arg_114_1.var_.characterEffect1156ui_story and not isNil(var_117_1) then
					arg_114_1.var_.characterEffect1156ui_story.fillFlat = false
				end
			end

			if arg_114_1.time_ >= 0 + var_117_2 and arg_114_1.time_ < 0 + var_117_2 + arg_117_0 and not isNil(var_117_1) and arg_114_1.var_.characterEffect1156ui_story then
				arg_114_1.var_.characterEffect1156ui_story.fillFlat = false
			end
			...
			if 0 < arg_114_1.time_ and arg_114_1.time_ <= var_117_4 + arg_117_0 then
				...
				arg_114_1.leftNameTxt_.text = arg_114_1:FormatText(StoryNameCfg[605].name)
				...
				local var_117_6 = arg_114_1:GetWordFromCfg(322061027)
				...
				local var_117_9 = 18 <= 0 and var_117_5 or var_117_5 * (utf8.len(var_117_7) / 18)

				if (18 <= 0 and var_117_5 or var_117_5 * (utf8.len(var_117_7) / 18)) > 0 and var_117_5 < var_117_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061027", "story_v_out_322061.awb") ~= 0 then
					local var_117_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061027", "story_v_out_322061.awb") / 1000
					...
					if var_117_6.prefab_name ~= "" and arg_114_1.actors_[var_117_6.prefab_name] ~= nil then
						local var_117_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_114_1.actors_[var_117_6.prefab_name].transform, "story_v_out_322061", "322061027", "story_v_out_322061.awb")

						arg_114_1:RecordAudio("322061027", var_117_11)
						arg_114_1:RecordAudio("322061027", var_117_11)
					else
	...
	Play322061028 = function(arg_118_0, arg_118_1)
		...
		function arg_118_1.onSingleLineUpdate_(arg_121_0)
			...
			if 0 <= arg_118_1.time_ and arg_118_1.time_ < 0 + var_121_0 then
				arg_118_1.actors_["404001ui_story"].transform.localPosition = Vector3.Lerp(arg_118_1.var_.moveOldPos404001ui_story, Vector3.New(0.8, -1.55, -5.5), (arg_118_1.time_ - 0) / var_121_0)
			...
			if arg_118_1.time_ >= 0 + var_121_0 and arg_118_1.time_ < 0 + var_121_0 + arg_121_0 then
				arg_118_1.actors_["404001ui_story"].transform.localPosition = Vector3.New(0.8, -1.55, -5.5)
				arg_118_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_118_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_118_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_118_1.actors_["404001ui_story"].transform.position).z)
				arg_118_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_118_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_118_1.actors_["404001ui_story"].transform.localEulerAngles = arg_118_1.actors_["404001ui_story"].transform.localEulerAngles
			...
			local var_121_1 = arg_118_1.actors_["404001ui_story"]

			if 0 < arg_118_1.time_ and arg_118_1.time_ <= 0 + arg_121_0 and not isNil(var_121_1) and arg_118_1.var_.characterEffect404001ui_story == nil then
				arg_118_1.var_.characterEffect404001ui_story = var_121_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_121_2 = 0.200000002980232

			if 0 <= arg_118_1.time_ and arg_118_1.time_ < 0 + var_121_2 and not isNil(var_121_1) then
				if arg_118_1.var_.characterEffect404001ui_story and not isNil(var_121_1) then
					arg_118_1.var_.characterEffect404001ui_story.fillFlat = false
				end
			end

			if arg_118_1.time_ >= 0 + var_121_2 and arg_118_1.time_ < 0 + var_121_2 + arg_121_0 and not isNil(var_121_1) and arg_118_1.var_.characterEffect404001ui_story then
				arg_118_1.var_.characterEffect404001ui_story.fillFlat = false
			end

			local var_121_4 = arg_118_1.actors_["1156ui_story"]

			if 0 < arg_118_1.time_ and arg_118_1.time_ <= 0 + arg_121_0 and not isNil(var_121_4) and arg_118_1.var_.characterEffect1156ui_story == nil then
				arg_118_1.var_.characterEffect1156ui_story = var_121_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_121_5 = 0.200000002980232

			if 0 <= arg_118_1.time_ and arg_118_1.time_ < 0 + var_121_5 and not isNil(var_121_4) then
				if arg_118_1.var_.characterEffect1156ui_story and not isNil(var_121_4) then
					arg_118_1.var_.characterEffect1156ui_story.fillFlat = true
					arg_118_1.var_.characterEffect1156ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_118_1.time_ - 0) / var_121_5)
				end
			end

			if arg_118_1.time_ >= 0 + var_121_5 and arg_118_1.time_ < 0 + var_121_5 + arg_121_0 and not isNil(var_121_4) and arg_118_1.var_.characterEffect1156ui_story then
				arg_118_1.var_.characterEffect1156ui_story.fillFlat = true
				arg_118_1.var_.characterEffect1156ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_118_1.time_ and arg_118_1.time_ <= var_121_6 + arg_121_0 then
				...
				local var_121_8 = arg_118_1:GetWordFromCfg(322061028)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061028", "story_v_out_322061.awb") ~= 0 then
					local var_121_12 = manager.audio:GetVoiceLength("story_v_out_322061", "322061028", "story_v_out_322061.awb") / 1000
					...
					if var_121_8.prefab_name ~= "" and arg_118_1.actors_[var_121_8.prefab_name] ~= nil then
						local var_121_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_118_1.actors_[var_121_8.prefab_name].transform, "story_v_out_322061", "322061028", "story_v_out_322061.awb")

						arg_118_1:RecordAudio("322061028", var_121_13)
						arg_118_1:RecordAudio("322061028", var_121_13)
					else
	...
	Play322061029 = function(arg_122_0, arg_122_1)
		...
		function arg_122_1.onSingleLineUpdate_(arg_125_0)
			if 0 < arg_122_1.time_ and arg_122_1.time_ <= 0 + arg_125_0 then
				arg_122_1.var_.moveOldPos404001ui_story = arg_122_1.actors_["404001ui_story"].transform.localPosition
			end

			local var_125_0 = 0.001

			if 0 <= arg_122_1.time_ and arg_122_1.time_ < 0 + var_125_0 then
				arg_122_1.actors_["404001ui_story"].transform.localPosition = Vector3.Lerp(arg_122_1.var_.moveOldPos404001ui_story, Vector3.New(0.8, -1.55, -5.5), (arg_122_1.time_ - 0) / var_125_0)
				arg_122_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_122_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_122_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_122_1.actors_["404001ui_story"].transform.position).z)
				arg_122_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_122_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_122_1.actors_["404001ui_story"].transform.localEulerAngles = arg_122_1.actors_["404001ui_story"].transform.localEulerAngles
			end

			if arg_122_1.time_ >= 0 + var_125_0 and arg_122_1.time_ < 0 + var_125_0 + arg_125_0 then
				arg_122_1.actors_["404001ui_story"].transform.localPosition = Vector3.New(0.8, -1.55, -5.5)
				arg_122_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_122_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_122_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_122_1.actors_["404001ui_story"].transform.position).z)
				arg_122_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_122_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_122_1.actors_["404001ui_story"].transform.localEulerAngles = arg_122_1.actors_["404001ui_story"].transform.localEulerAngles
			...
			if 0 < arg_122_1.time_ and arg_122_1.time_ <= var_125_1 + arg_125_0 then
				...
				local var_125_3 = arg_122_1:GetWordFromCfg(322061029)
				...
				local var_125_6 = 26 <= 0 and var_125_2 or var_125_2 * (utf8.len(var_125_4) / 26)

				if (26 <= 0 and var_125_2 or var_125_2 * (utf8.len(var_125_4) / 26)) > 0 and var_125_2 < var_125_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061029", "story_v_out_322061.awb") ~= 0 then
					local var_125_7 = manager.audio:GetVoiceLength("story_v_out_322061", "322061029", "story_v_out_322061.awb") / 1000
					...
					if var_125_3.prefab_name ~= "" and arg_122_1.actors_[var_125_3.prefab_name] ~= nil then
						local var_125_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_122_1.actors_[var_125_3.prefab_name].transform, "story_v_out_322061", "322061029", "story_v_out_322061.awb")

						arg_122_1:RecordAudio("322061029", var_125_8)
						arg_122_1:RecordAudio("322061029", var_125_8)
					else
	...
	Play322061030 = function(arg_126_0, arg_126_1)
		...
		function arg_126_1.onSingleLineUpdate_(arg_129_0)
			if 0 < arg_126_1.time_ and arg_126_1.time_ <= 0 + arg_129_0 and not isNil(arg_126_1.actors_["1156ui_story"]) and arg_126_1.var_.characterEffect1156ui_story == nil then
				arg_126_1.var_.characterEffect1156ui_story = arg_126_1.actors_["1156ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_129_0 = 0.200000002980232

			if 0 <= arg_126_1.time_ and arg_126_1.time_ < 0 + var_129_0 and not isNil(arg_126_1.actors_["1156ui_story"]) then
				if arg_126_1.var_.characterEffect1156ui_story and not isNil(arg_126_1.actors_["1156ui_story"]) then
					arg_126_1.var_.characterEffect1156ui_story.fillFlat = false
				end
			end

			if arg_126_1.time_ >= 0 + var_129_0 and arg_126_1.time_ < 0 + var_129_0 + arg_129_0 and not isNil(arg_126_1.actors_["1156ui_story"]) and arg_126_1.var_.characterEffect1156ui_story then
				arg_126_1.var_.characterEffect1156ui_story.fillFlat = false
			end

			local var_129_2 = arg_126_1.actors_["404001ui_story"]

			if 0 < arg_126_1.time_ and arg_126_1.time_ <= 0 + arg_129_0 and not isNil(var_129_2) and arg_126_1.var_.characterEffect404001ui_story == nil then
				arg_126_1.var_.characterEffect404001ui_story = var_129_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_129_3 = 0.200000002980232

			if 0 <= arg_126_1.time_ and arg_126_1.time_ < 0 + var_129_3 and not isNil(var_129_2) then
				if arg_126_1.var_.characterEffect404001ui_story and not isNil(var_129_2) then
					arg_126_1.var_.characterEffect404001ui_story.fillFlat = true
					arg_126_1.var_.characterEffect404001ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_126_1.time_ - 0) / var_129_3)
				end
			end

			if arg_126_1.time_ >= 0 + var_129_3 and arg_126_1.time_ < 0 + var_129_3 + arg_129_0 and not isNil(var_129_2) and arg_126_1.var_.characterEffect404001ui_story then
				arg_126_1.var_.characterEffect404001ui_story.fillFlat = true
				arg_126_1.var_.characterEffect404001ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_126_1.time_ and arg_126_1.time_ <= var_129_4 + arg_129_0 then
				...
				arg_126_1.leftNameTxt_.text = arg_126_1:FormatText(StoryNameCfg[605].name)
				...
				local var_129_6 = arg_126_1:GetWordFromCfg(322061030)
				...
				local var_129_9 = 6 <= 0 and var_129_5 or var_129_5 * (utf8.len(var_129_7) / 6)

				if (6 <= 0 and var_129_5 or var_129_5 * (utf8.len(var_129_7) / 6)) > 0 and var_129_5 < var_129_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061030", "story_v_out_322061.awb") ~= 0 then
					local var_129_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061030", "story_v_out_322061.awb") / 1000
					...
					if var_129_6.prefab_name ~= "" and arg_126_1.actors_[var_129_6.prefab_name] ~= nil then
						local var_129_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_126_1.actors_[var_129_6.prefab_name].transform, "story_v_out_322061", "322061030", "story_v_out_322061.awb")

						arg_126_1:RecordAudio("322061030", var_129_11)
						arg_126_1:RecordAudio("322061030", var_129_11)
					else
	...
	Play322061031 = function(arg_130_0, arg_130_1)
		...
		function arg_130_1.onSingleLineUpdate_(arg_133_0)
			if 0 < arg_130_1.time_ and arg_130_1.time_ <= 0 + arg_133_0 and not isNil(arg_130_1.actors_["404001ui_story"]) and arg_130_1.var_.characterEffect404001ui_story == nil then
				arg_130_1.var_.characterEffect404001ui_story = arg_130_1.actors_["404001ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_133_0 = 0.200000002980232

			if 0 <= arg_130_1.time_ and arg_130_1.time_ < 0 + var_133_0 and not isNil(arg_130_1.actors_["404001ui_story"]) then
				if arg_130_1.var_.characterEffect404001ui_story and not isNil(arg_130_1.actors_["404001ui_story"]) then
					arg_130_1.var_.characterEffect404001ui_story.fillFlat = false
				end
			end

			if arg_130_1.time_ >= 0 + var_133_0 and arg_130_1.time_ < 0 + var_133_0 + arg_133_0 and not isNil(arg_130_1.actors_["404001ui_story"]) and arg_130_1.var_.characterEffect404001ui_story then
				arg_130_1.var_.characterEffect404001ui_story.fillFlat = false
			end

			local var_133_2 = arg_130_1.actors_["1156ui_story"]

			if 0 < arg_130_1.time_ and arg_130_1.time_ <= 0 + arg_133_0 and not isNil(var_133_2) and arg_130_1.var_.characterEffect1156ui_story == nil then
				arg_130_1.var_.characterEffect1156ui_story = var_133_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_133_3 = 0.200000002980232

			if 0 <= arg_130_1.time_ and arg_130_1.time_ < 0 + var_133_3 and not isNil(var_133_2) then
				if arg_130_1.var_.characterEffect1156ui_story and not isNil(var_133_2) then
					arg_130_1.var_.characterEffect1156ui_story.fillFlat = true
					arg_130_1.var_.characterEffect1156ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_130_1.time_ - 0) / var_133_3)
				end
			end

			if arg_130_1.time_ >= 0 + var_133_3 and arg_130_1.time_ < 0 + var_133_3 + arg_133_0 and not isNil(var_133_2) and arg_130_1.var_.characterEffect1156ui_story then
				arg_130_1.var_.characterEffect1156ui_story.fillFlat = true
				arg_130_1.var_.characterEffect1156ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_130_1.time_ and arg_130_1.time_ <= var_133_4 + arg_133_0 then
				...
				local var_133_6 = arg_130_1:GetWordFromCfg(322061031)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061031", "story_v_out_322061.awb") ~= 0 then
					local var_133_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061031", "story_v_out_322061.awb") / 1000
					...
					if var_133_6.prefab_name ~= "" and arg_130_1.actors_[var_133_6.prefab_name] ~= nil then
						local var_133_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_130_1.actors_[var_133_6.prefab_name].transform, "story_v_out_322061", "322061031", "story_v_out_322061.awb")

						arg_130_1:RecordAudio("322061031", var_133_11)
						arg_130_1:RecordAudio("322061031", var_133_11)
					else
	...
	Play322061032 = function(arg_134_0, arg_134_1)
		...
		function arg_134_1.onSingleLineUpdate_(arg_137_0)
			...
			if 0 <= arg_134_1.time_ and arg_134_1.time_ < 0 + var_137_0 then
				arg_134_1.actors_["404001ui_story"].transform.localPosition = Vector3.Lerp(arg_134_1.var_.moveOldPos404001ui_story, Vector3.New(0, 100, 0), (arg_134_1.time_ - 0) / var_137_0)
			...
			if arg_134_1.time_ >= 0 + var_137_0 and arg_134_1.time_ < 0 + var_137_0 + arg_137_0 then
				arg_134_1.actors_["404001ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_134_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_134_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_134_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_134_1.actors_["404001ui_story"].transform.position).z)
				arg_134_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_134_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_134_1.actors_["404001ui_story"].transform.localEulerAngles = arg_134_1.actors_["404001ui_story"].transform.localEulerAngles
			...
			local var_137_1 = arg_134_1.actors_["1156ui_story"].transform

			if 0 < arg_134_1.time_ and arg_134_1.time_ <= 0 + arg_137_0 then
				arg_134_1.var_.moveOldPos1156ui_story = var_137_1.localPosition
			end

			local var_137_2 = 0.001

			if 0 <= arg_134_1.time_ and arg_134_1.time_ < 0 + var_137_2 then
				var_137_1.localPosition = Vector3.Lerp(arg_134_1.var_.moveOldPos1156ui_story, Vector3.New(0, 100, 0), (arg_134_1.time_ - 0) / var_137_2)
			...
			if 0 < arg_134_1.time_ and arg_134_1.time_ <= var_137_3 + arg_137_0 then
				...
				local var_137_5 = arg_134_1:GetWordFromCfg(322061032)
				...
				local var_137_8 = 12 <= 0 and var_137_4 or var_137_4 * (utf8.len(var_137_6) / 12)

				if (12 <= 0 and var_137_4 or var_137_4 * (utf8.len(var_137_6) / 12)) > 0 and var_137_4 < var_137_8 then
					arg_134_1.talkMaxDuration = var_137_8

					if var_137_8 + var_137_3 > arg_134_1.duration_ then
						arg_134_1.duration_ = var_137_8 + var_137_3
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061032", "story_v_out_322061.awb") ~= 0 then
					local var_137_9 = manager.audio:GetVoiceLength("story_v_out_322061", "322061032", "story_v_out_322061.awb") / 1000

					if var_137_9 + var_137_3 > arg_134_1.duration_ then
						arg_134_1.duration_ = var_137_9 + var_137_3
					end

					if var_137_5.prefab_name ~= "" and arg_134_1.actors_[var_137_5.prefab_name] ~= nil then
						local var_137_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_134_1.actors_[var_137_5.prefab_name].transform, "story_v_out_322061", "322061032", "story_v_out_322061.awb")

						arg_134_1:RecordAudio("322061032", var_137_10)
						arg_134_1:RecordAudio("322061032", var_137_10)
					else
			...
			local var_137_11 = math.max(var_137_4, arg_134_1.talkMaxDuration)

			if var_137_3 <= arg_134_1.time_ and arg_134_1.time_ < var_137_3 + var_137_11 then
				arg_134_1.typewritter.percent = (arg_134_1.time_ - var_137_3) / var_137_11

				arg_134_1.typewritter:SetDirty()
			end

			if arg_134_1.time_ >= var_137_3 + var_137_11 and arg_134_1.time_ < var_137_3 + var_137_11 + arg_137_0 then
	...
	Play322061033 = function(arg_138_0, arg_138_1)
		...
		function arg_138_1.onSingleLineUpdate_(arg_141_0)
			...
			if 0 < arg_138_1.time_ and arg_138_1.time_ <= 0 + arg_141_0 then
				...
				local var_141_1 = arg_138_1:FormatText(arg_138_1:GetWordFromCfg(322061033).content)
	...
	Play322061034 = function(arg_142_0, arg_142_1)
		...
		function arg_142_1.onSingleLineUpdate_(arg_145_0)
			if 0 < arg_142_1.time_ and arg_142_1.time_ <= 0 + arg_145_0 then
				arg_142_1.var_.moveOldPos404001ui_story = arg_142_1.actors_["404001ui_story"].transform.localPosition
			end

			local var_145_0 = 0.001

			if 0 <= arg_142_1.time_ and arg_142_1.time_ < 0 + var_145_0 then
				arg_142_1.actors_["404001ui_story"].transform.localPosition = Vector3.Lerp(arg_142_1.var_.moveOldPos404001ui_story, Vector3.New(-0.8, -1.55, -5.5), (arg_142_1.time_ - 0) / var_145_0)
				arg_142_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_142_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_142_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_142_1.actors_["404001ui_story"].transform.position).z)
				arg_142_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_142_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_142_1.actors_["404001ui_story"].transform.localEulerAngles = arg_142_1.actors_["404001ui_story"].transform.localEulerAngles
			end

			if arg_142_1.time_ >= 0 + var_145_0 and arg_142_1.time_ < 0 + var_145_0 + arg_145_0 then
				arg_142_1.actors_["404001ui_story"].transform.localPosition = Vector3.New(-0.8, -1.55, -5.5)
				arg_142_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_142_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_142_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_142_1.actors_["404001ui_story"].transform.position).z)
				arg_142_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_142_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_142_1.actors_["404001ui_story"].transform.localEulerAngles = arg_142_1.actors_["404001ui_story"].transform.localEulerAngles
			...
			local var_145_1 = arg_142_1.actors_["404001ui_story"]

			if 0 < arg_142_1.time_ and arg_142_1.time_ <= 0 + arg_145_0 and not isNil(var_145_1) and arg_142_1.var_.characterEffect404001ui_story == nil then
				arg_142_1.var_.characterEffect404001ui_story = var_145_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_145_2 = 0.200000002980232

			if 0 <= arg_142_1.time_ and arg_142_1.time_ < 0 + var_145_2 and not isNil(var_145_1) then
				if arg_142_1.var_.characterEffect404001ui_story and not isNil(var_145_1) then
					arg_142_1.var_.characterEffect404001ui_story.fillFlat = false
				end
			end

			if arg_142_1.time_ >= 0 + var_145_2 and arg_142_1.time_ < 0 + var_145_2 + arg_145_0 and not isNil(var_145_1) and arg_142_1.var_.characterEffect404001ui_story then
				arg_142_1.var_.characterEffect404001ui_story.fillFlat = false
			end
			...
			if 0 < arg_142_1.time_ and arg_142_1.time_ <= var_145_4 + arg_145_0 then
				...
				local var_145_6 = arg_142_1:GetWordFromCfg(322061034)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061034", "story_v_out_322061.awb") ~= 0 then
					local var_145_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061034", "story_v_out_322061.awb") / 1000
					...
					if var_145_6.prefab_name ~= "" and arg_142_1.actors_[var_145_6.prefab_name] ~= nil then
						local var_145_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_142_1.actors_[var_145_6.prefab_name].transform, "story_v_out_322061", "322061034", "story_v_out_322061.awb")

						arg_142_1:RecordAudio("322061034", var_145_11)
						arg_142_1:RecordAudio("322061034", var_145_11)
					else
	...
	Play322061035 = function(arg_146_0, arg_146_1)
		...
		function arg_146_1.onSingleLineUpdate_(arg_149_0)
			if arg_146_1.actors_["10104ui_story"] == nil and not isNil((Asset.Load("Char/" .. "10104ui_story"))) then
				local var_149_0 = Object.Instantiate(Asset.Load("Char/" .. "10104ui_story"), arg_146_1.stage_.transform)

				var_149_0.name = "10104ui_story"
				var_149_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_146_1.actors_["10104ui_story"] = var_149_0

				local var_149_1 = var_149_0:GetComponentInChildren(typeof(CharacterEffect))

				var_149_1.enabled = true

				local var_149_2 = GameObjectTools.GetOrAddComponent(var_149_0, typeof(DynamicBoneHelper))

				if var_149_2 then
					var_149_2:EnableDynamicBone(false)
				end

				arg_146_1:ShowWeapon(var_149_1.transform, false)

				arg_146_1.var_["10104ui_story" .. "Animator"] = var_149_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_146_1.var_["10104ui_story" .. "Animator"].applyRootMotion = true
				arg_146_1.var_["10104ui_story" .. "LipSync"] = var_149_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_149_3 = arg_146_1.actors_["10104ui_story"].transform

			if 0 < arg_146_1.time_ and arg_146_1.time_ <= 0 + arg_149_0 then
				arg_146_1.var_.moveOldPos10104ui_story = var_149_3.localPosition
			end

			local var_149_4 = 0.001

			if 0 <= arg_146_1.time_ and arg_146_1.time_ < 0 + var_149_4 then
				var_149_3.localPosition = Vector3.Lerp(arg_146_1.var_.moveOldPos10104ui_story, Vector3.New(0.99, -1.12, -5.99), (arg_146_1.time_ - 0) / var_149_4)
			...
			if arg_146_1.time_ >= 0 + var_149_4 and arg_146_1.time_ < 0 + var_149_4 + arg_149_0 then
				var_149_3.localPosition = Vector3.New(0.99, -1.12, -5.99)
				var_149_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_149_3.position).x, (manager.ui.mainCamera.transform.position - var_149_3.position).y, (manager.ui.mainCamera.transform.position - var_149_3.position).z)
				var_149_3.localEulerAngles.z = 0
				var_149_3.localEulerAngles.x = 0
				var_149_3.localEulerAngles = var_149_3.localEulerAngles
			...
			local var_149_5 = arg_146_1.actors_["10104ui_story"]

			if 0 < arg_146_1.time_ and arg_146_1.time_ <= 0 + arg_149_0 and not isNil(var_149_5) and arg_146_1.var_.characterEffect10104ui_story == nil then
				arg_146_1.var_.characterEffect10104ui_story = var_149_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_149_6 = 0.200000002980232

			if 0 <= arg_146_1.time_ and arg_146_1.time_ < 0 + var_149_6 and not isNil(var_149_5) then
				if arg_146_1.var_.characterEffect10104ui_story and not isNil(var_149_5) then
					arg_146_1.var_.characterEffect10104ui_story.fillFlat = false
				end
			end

			if arg_146_1.time_ >= 0 + var_149_6 and arg_146_1.time_ < 0 + var_149_6 + arg_149_0 and not isNil(var_149_5) and arg_146_1.var_.characterEffect10104ui_story then
				arg_146_1.var_.characterEffect10104ui_story.fillFlat = false
			end

			local var_149_8 = arg_146_1.actors_["404001ui_story"]

			if 0 < arg_146_1.time_ and arg_146_1.time_ <= 0 + arg_149_0 and not isNil(var_149_8) and arg_146_1.var_.characterEffect404001ui_story == nil then
				arg_146_1.var_.characterEffect404001ui_story = var_149_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_149_9 = 0.200000002980232

			if 0 <= arg_146_1.time_ and arg_146_1.time_ < 0 + var_149_9 and not isNil(var_149_8) then
				if arg_146_1.var_.characterEffect404001ui_story and not isNil(var_149_8) then
					arg_146_1.var_.characterEffect404001ui_story.fillFlat = true
					arg_146_1.var_.characterEffect404001ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_146_1.time_ - 0) / var_149_9)
				end
			end

			if arg_146_1.time_ >= 0 + var_149_9 and arg_146_1.time_ < 0 + var_149_9 + arg_149_0 and not isNil(var_149_8) and arg_146_1.var_.characterEffect404001ui_story then
				arg_146_1.var_.characterEffect404001ui_story.fillFlat = true
				arg_146_1.var_.characterEffect404001ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_146_1.time_ and arg_146_1.time_ <= 0 + arg_149_0 then
				if arg_146_1.var_.characterEffect10104ui_story == nil then
					arg_146_1.var_.characterEffect10104ui_story = arg_146_1.actors_["10104ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
				end

				local var_149_10 = arg_146_1.var_.characterEffect10104ui_story

				arg_146_1.var_.characterEffect10104ui_story.imageEffect:turnOff()

				var_149_10.interferenceEffect.enabled = true
				var_149_10.interferenceEffect.noise = 0.001
				var_149_10.interferenceEffect.simTimeScale = 1
				var_149_10.interferenceEffect.geometryOutlineColor = Color.New(0.3725, 0.88, 1, 1)
			end
			...
			if 0 < arg_146_1.time_ and arg_146_1.time_ <= var_149_12 + arg_149_0 then
				...
				local var_149_14 = arg_146_1:GetWordFromCfg(322061035)
				...
				local var_149_17 = 15 <= 0 and var_149_13 or var_149_13 * (utf8.len(var_149_15) / 15)

				if (15 <= 0 and var_149_13 or var_149_13 * (utf8.len(var_149_15) / 15)) > 0 and var_149_13 < var_149_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061035", "story_v_out_322061.awb") ~= 0 then
					local var_149_18 = manager.audio:GetVoiceLength("story_v_out_322061", "322061035", "story_v_out_322061.awb") / 1000
					...
					if var_149_14.prefab_name ~= "" and arg_146_1.actors_[var_149_14.prefab_name] ~= nil then
						local var_149_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_146_1.actors_[var_149_14.prefab_name].transform, "story_v_out_322061", "322061035", "story_v_out_322061.awb")

						arg_146_1:RecordAudio("322061035", var_149_19)
						arg_146_1:RecordAudio("322061035", var_149_19)
					else
	...
	Play322061036 = function(arg_150_0, arg_150_1)
		...
		function arg_150_1.onSingleLineUpdate_(arg_153_0)
			if arg_150_1.actors_["1284ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1284ui_story"))) then
				local var_153_0 = Object.Instantiate(Asset.Load("Char/" .. "1284ui_story"), arg_150_1.stage_.transform)

				var_153_0.name = "1284ui_story"
				var_153_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_150_1.actors_["1284ui_story"] = var_153_0
				...
				arg_150_1.var_["1284ui_story" .. "Animator"] = var_153_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_150_1.var_["1284ui_story" .. "Animator"].applyRootMotion = true
				arg_150_1.var_["1284ui_story" .. "LipSync"] = var_153_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_153_3 = arg_150_1.actors_["1284ui_story"].transform

			if 0 < arg_150_1.time_ and arg_150_1.time_ <= 0 + arg_153_0 then
				arg_150_1.var_.moveOldPos1284ui_story = var_153_3.localPosition

				arg_150_1:ShowWeapon(arg_150_1.var_["1284ui_story" .. "Animator"].transform, false)
			end

			local var_153_4 = 0.001

			if 0 <= arg_150_1.time_ and arg_150_1.time_ < 0 + var_153_4 then
				var_153_3.localPosition = Vector3.Lerp(arg_150_1.var_.moveOldPos1284ui_story, Vector3.New(-0.7, -0.985, -6.22), (arg_150_1.time_ - 0) / var_153_4)
			...
			if arg_150_1.time_ >= 0 + var_153_4 and arg_150_1.time_ < 0 + var_153_4 + arg_153_0 then
				var_153_3.localPosition = Vector3.New(-0.7, -0.985, -6.22)
				var_153_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_153_3.position).x, (manager.ui.mainCamera.transform.position - var_153_3.position).y, (manager.ui.mainCamera.transform.position - var_153_3.position).z)
				var_153_3.localEulerAngles.z = 0
				var_153_3.localEulerAngles.x = 0
				var_153_3.localEulerAngles = var_153_3.localEulerAngles
			...
			local var_153_5 = arg_150_1.actors_["404001ui_story"].transform

			if 0 < arg_150_1.time_ and arg_150_1.time_ <= 0 + arg_153_0 then
				arg_150_1.var_.moveOldPos404001ui_story = var_153_5.localPosition
			end

			local var_153_6 = 0.001

			if 0 <= arg_150_1.time_ and arg_150_1.time_ < 0 + var_153_6 then
				var_153_5.localPosition = Vector3.Lerp(arg_150_1.var_.moveOldPos404001ui_story, Vector3.New(0, 100, 0), (arg_150_1.time_ - 0) / var_153_6)
				var_153_5.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_153_5.position).x, (manager.ui.mainCamera.transform.position - var_153_5.position).y, (manager.ui.mainCamera.transform.position - var_153_5.position).z)
				var_153_5.localEulerAngles.z = 0
				var_153_5.localEulerAngles.x = 0
				var_153_5.localEulerAngles = var_153_5.localEulerAngles
			end
			...
			local var_153_7 = arg_150_1.actors_["1284ui_story"]

			if 0 < arg_150_1.time_ and arg_150_1.time_ <= 0 + arg_153_0 and not isNil(var_153_7) and arg_150_1.var_.characterEffect1284ui_story == nil then
				arg_150_1.var_.characterEffect1284ui_story = var_153_7:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_153_8 = 0.200000002980232

			if 0 <= arg_150_1.time_ and arg_150_1.time_ < 0 + var_153_8 and not isNil(var_153_7) then
				if arg_150_1.var_.characterEffect1284ui_story and not isNil(var_153_7) then
					arg_150_1.var_.characterEffect1284ui_story.fillFlat = false
				end
			end

			if arg_150_1.time_ >= 0 + var_153_8 and arg_150_1.time_ < 0 + var_153_8 + arg_153_0 and not isNil(var_153_7) and arg_150_1.var_.characterEffect1284ui_story then
				arg_150_1.var_.characterEffect1284ui_story.fillFlat = false
			end

			local var_153_10 = arg_150_1.actors_["10104ui_story"]

			if 0 < arg_150_1.time_ and arg_150_1.time_ <= 0 + arg_153_0 and not isNil(var_153_10) and arg_150_1.var_.characterEffect10104ui_story == nil then
				arg_150_1.var_.characterEffect10104ui_story = var_153_10:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_153_11 = 0.200000002980232

			if 0 <= arg_150_1.time_ and arg_150_1.time_ < 0 + var_153_11 and not isNil(var_153_10) then
				if arg_150_1.var_.characterEffect10104ui_story and not isNil(var_153_10) then
					arg_150_1.var_.characterEffect10104ui_story.fillFlat = true
					arg_150_1.var_.characterEffect10104ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_150_1.time_ - 0) / var_153_11)
				end
			end

			if arg_150_1.time_ >= 0 + var_153_11 and arg_150_1.time_ < 0 + var_153_11 + arg_153_0 and not isNil(var_153_10) and arg_150_1.var_.characterEffect10104ui_story then
				arg_150_1.var_.characterEffect10104ui_story.fillFlat = true
				arg_150_1.var_.characterEffect10104ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_150_1.time_ and arg_150_1.time_ <= var_153_12 + arg_153_0 then
				...
				local var_153_14 = arg_150_1:GetWordFromCfg(322061036)
				...
				local var_153_17 = 24 <= 0 and var_153_13 or var_153_13 * (utf8.len(var_153_15) / 24)

				if (24 <= 0 and var_153_13 or var_153_13 * (utf8.len(var_153_15) / 24)) > 0 and var_153_13 < var_153_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061036", "story_v_out_322061.awb") ~= 0 then
					local var_153_18 = manager.audio:GetVoiceLength("story_v_out_322061", "322061036", "story_v_out_322061.awb") / 1000
					...
					if var_153_14.prefab_name ~= "" and arg_150_1.actors_[var_153_14.prefab_name] ~= nil then
						local var_153_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_150_1.actors_[var_153_14.prefab_name].transform, "story_v_out_322061", "322061036", "story_v_out_322061.awb")

						arg_150_1:RecordAudio("322061036", var_153_19)
						arg_150_1:RecordAudio("322061036", var_153_19)
					else
	...
	Play322061037 = function(arg_154_0, arg_154_1)
		...
		function arg_154_1.onSingleLineUpdate_(arg_157_0)
			if 0 < arg_154_1.time_ and arg_154_1.time_ <= 0 + arg_157_0 and not isNil(arg_154_1.actors_["10104ui_story"]) and arg_154_1.var_.characterEffect10104ui_story == nil then
				arg_154_1.var_.characterEffect10104ui_story = arg_154_1.actors_["10104ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_157_0 = 0.200000002980232

			if 0 <= arg_154_1.time_ and arg_154_1.time_ < 0 + var_157_0 and not isNil(arg_154_1.actors_["10104ui_story"]) then
				if arg_154_1.var_.characterEffect10104ui_story and not isNil(arg_154_1.actors_["10104ui_story"]) then
					arg_154_1.var_.characterEffect10104ui_story.fillFlat = false
				end
			end

			if arg_154_1.time_ >= 0 + var_157_0 and arg_154_1.time_ < 0 + var_157_0 + arg_157_0 and not isNil(arg_154_1.actors_["10104ui_story"]) and arg_154_1.var_.characterEffect10104ui_story then
				arg_154_1.var_.characterEffect10104ui_story.fillFlat = false
			end

			local var_157_2 = arg_154_1.actors_["1284ui_story"]

			if 0 < arg_154_1.time_ and arg_154_1.time_ <= 0 + arg_157_0 and not isNil(var_157_2) and arg_154_1.var_.characterEffect1284ui_story == nil then
				arg_154_1.var_.characterEffect1284ui_story = var_157_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_157_3 = 0.200000002980232

			if 0 <= arg_154_1.time_ and arg_154_1.time_ < 0 + var_157_3 and not isNil(var_157_2) then
				if arg_154_1.var_.characterEffect1284ui_story and not isNil(var_157_2) then
					arg_154_1.var_.characterEffect1284ui_story.fillFlat = true
					arg_154_1.var_.characterEffect1284ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_154_1.time_ - 0) / var_157_3)
				end
			end

			if arg_154_1.time_ >= 0 + var_157_3 and arg_154_1.time_ < 0 + var_157_3 + arg_157_0 and not isNil(var_157_2) and arg_154_1.var_.characterEffect1284ui_story then
				arg_154_1.var_.characterEffect1284ui_story.fillFlat = true
				arg_154_1.var_.characterEffect1284ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_154_1.time_ and arg_154_1.time_ <= var_157_4 + arg_157_0 then
				...
				local var_157_6 = arg_154_1:GetWordFromCfg(322061037)
				...
				local var_157_9 = 22 <= 0 and var_157_5 or var_157_5 * (utf8.len(var_157_7) / 22)

				if (22 <= 0 and var_157_5 or var_157_5 * (utf8.len(var_157_7) / 22)) > 0 and var_157_5 < var_157_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061037", "story_v_out_322061.awb") ~= 0 then
					local var_157_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061037", "story_v_out_322061.awb") / 1000
					...
					if var_157_6.prefab_name ~= "" and arg_154_1.actors_[var_157_6.prefab_name] ~= nil then
						local var_157_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_154_1.actors_[var_157_6.prefab_name].transform, "story_v_out_322061", "322061037", "story_v_out_322061.awb")

						arg_154_1:RecordAudio("322061037", var_157_11)
						arg_154_1:RecordAudio("322061037", var_157_11)
					else
	...
	Play322061038 = function(arg_158_0, arg_158_1)
		...
		function arg_158_1.onSingleLineUpdate_(arg_161_0)
			if 0 < arg_158_1.time_ and arg_158_1.time_ <= 0 + arg_161_0 then
				arg_158_1.var_.moveOldPos10104ui_story = arg_158_1.actors_["10104ui_story"].transform.localPosition
			end

			local var_161_0 = 0.001

			if 0 <= arg_158_1.time_ and arg_158_1.time_ < 0 + var_161_0 then
				arg_158_1.actors_["10104ui_story"].transform.localPosition = Vector3.Lerp(arg_158_1.var_.moveOldPos10104ui_story, Vector3.New(0.99, -1.12, -5.99), (arg_158_1.time_ - 0) / var_161_0)
				arg_158_1.actors_["10104ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_158_1.actors_["10104ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_158_1.actors_["10104ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_158_1.actors_["10104ui_story"].transform.position).z)
				arg_158_1.actors_["10104ui_story"].transform.localEulerAngles.z = 0
				arg_158_1.actors_["10104ui_story"].transform.localEulerAngles.x = 0
				arg_158_1.actors_["10104ui_story"].transform.localEulerAngles = arg_158_1.actors_["10104ui_story"].transform.localEulerAngles
			end

			if arg_158_1.time_ >= 0 + var_161_0 and arg_158_1.time_ < 0 + var_161_0 + arg_161_0 then
				arg_158_1.actors_["10104ui_story"].transform.localPosition = Vector3.New(0.99, -1.12, -5.99)
				arg_158_1.actors_["10104ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_158_1.actors_["10104ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_158_1.actors_["10104ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_158_1.actors_["10104ui_story"].transform.position).z)
				arg_158_1.actors_["10104ui_story"].transform.localEulerAngles.z = 0
				arg_158_1.actors_["10104ui_story"].transform.localEulerAngles.x = 0
				arg_158_1.actors_["10104ui_story"].transform.localEulerAngles = arg_158_1.actors_["10104ui_story"].transform.localEulerAngles
			...
			if 0 < arg_158_1.time_ and arg_158_1.time_ <= 0 + arg_161_0 then
				if arg_158_1.var_.characterEffect10104ui_story == nil then
					arg_158_1.var_.characterEffect10104ui_story = arg_158_1.actors_["10104ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
				end

				local var_161_1 = arg_158_1.var_.characterEffect10104ui_story

				arg_158_1.var_.characterEffect10104ui_story.imageEffect:turnOff()

				var_161_1.interferenceEffect.enabled = true
				var_161_1.interferenceEffect.noise = 0.001
				var_161_1.interferenceEffect.simTimeScale = 1
				var_161_1.interferenceEffect.geometryOutlineColor = Color.New(0.3725, 0.88, 1, 1)
			end
			...
			if 0 < arg_158_1.time_ and arg_158_1.time_ <= var_161_3 + arg_161_0 then
				...
				arg_158_1.leftNameTxt_.text = arg_158_1:FormatText(StoryNameCfg[1030].name)
				...
				local var_161_5 = arg_158_1:GetWordFromCfg(322061038)
				...
				local var_161_8 = 45 <= 0 and var_161_4 or var_161_4 * (utf8.len(var_161_6) / 45)

				if (45 <= 0 and var_161_4 or var_161_4 * (utf8.len(var_161_6) / 45)) > 0 and var_161_4 < var_161_8 then
					arg_158_1.talkMaxDuration = var_161_8

					if var_161_8 + var_161_3 > arg_158_1.duration_ then
						arg_158_1.duration_ = var_161_8 + var_161_3
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061038", "story_v_out_322061.awb") ~= 0 then
					local var_161_9 = manager.audio:GetVoiceLength("story_v_out_322061", "322061038", "story_v_out_322061.awb") / 1000

					if var_161_9 + var_161_3 > arg_158_1.duration_ then
						arg_158_1.duration_ = var_161_9 + var_161_3
					end

					if var_161_5.prefab_name ~= "" and arg_158_1.actors_[var_161_5.prefab_name] ~= nil then
						local var_161_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_158_1.actors_[var_161_5.prefab_name].transform, "story_v_out_322061", "322061038", "story_v_out_322061.awb")

						arg_158_1:RecordAudio("322061038", var_161_10)
						arg_158_1:RecordAudio("322061038", var_161_10)
					else
			...
			local var_161_11 = math.max(var_161_4, arg_158_1.talkMaxDuration)

			if var_161_3 <= arg_158_1.time_ and arg_158_1.time_ < var_161_3 + var_161_11 then
				arg_158_1.typewritter.percent = (arg_158_1.time_ - var_161_3) / var_161_11

				arg_158_1.typewritter:SetDirty()
			end

			if arg_158_1.time_ >= var_161_3 + var_161_11 and arg_158_1.time_ < var_161_3 + var_161_11 + arg_161_0 then
	...
	Play322061039 = function(arg_162_0, arg_162_1)
		...
		function arg_162_1.onSingleLineUpdate_(arg_165_0)
			if 0 < arg_162_1.time_ and arg_162_1.time_ <= 0 + arg_165_0 and not isNil(arg_162_1.actors_["1284ui_story"]) and arg_162_1.var_.characterEffect1284ui_story == nil then
				arg_162_1.var_.characterEffect1284ui_story = arg_162_1.actors_["1284ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_165_0 = 0.200000002980232

			if 0 <= arg_162_1.time_ and arg_162_1.time_ < 0 + var_165_0 and not isNil(arg_162_1.actors_["1284ui_story"]) then
				if arg_162_1.var_.characterEffect1284ui_story and not isNil(arg_162_1.actors_["1284ui_story"]) then
					arg_162_1.var_.characterEffect1284ui_story.fillFlat = false
				end
			end

			if arg_162_1.time_ >= 0 + var_165_0 and arg_162_1.time_ < 0 + var_165_0 + arg_165_0 and not isNil(arg_162_1.actors_["1284ui_story"]) and arg_162_1.var_.characterEffect1284ui_story then
				arg_162_1.var_.characterEffect1284ui_story.fillFlat = false
			end

			local var_165_2 = arg_162_1.actors_["10104ui_story"]

			if 0 < arg_162_1.time_ and arg_162_1.time_ <= 0 + arg_165_0 and not isNil(var_165_2) and arg_162_1.var_.characterEffect10104ui_story == nil then
				arg_162_1.var_.characterEffect10104ui_story = var_165_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_165_3 = 0.200000002980232

			if 0 <= arg_162_1.time_ and arg_162_1.time_ < 0 + var_165_3 and not isNil(var_165_2) then
				if arg_162_1.var_.characterEffect10104ui_story and not isNil(var_165_2) then
					arg_162_1.var_.characterEffect10104ui_story.fillFlat = true
					arg_162_1.var_.characterEffect10104ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_162_1.time_ - 0) / var_165_3)
				end
			end

			if arg_162_1.time_ >= 0 + var_165_3 and arg_162_1.time_ < 0 + var_165_3 + arg_165_0 and not isNil(var_165_2) and arg_162_1.var_.characterEffect10104ui_story then
				arg_162_1.var_.characterEffect10104ui_story.fillFlat = true
				arg_162_1.var_.characterEffect10104ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_162_1.time_ and arg_162_1.time_ <= var_165_4 + arg_165_0 then
				...
				local var_165_6 = arg_162_1:GetWordFromCfg(322061039)
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061039", "story_v_out_322061.awb") ~= 0 then
					local var_165_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061039", "story_v_out_322061.awb") / 1000
					...
					if var_165_6.prefab_name ~= "" and arg_162_1.actors_[var_165_6.prefab_name] ~= nil then
						local var_165_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_162_1.actors_[var_165_6.prefab_name].transform, "story_v_out_322061", "322061039", "story_v_out_322061.awb")

						arg_162_1:RecordAudio("322061039", var_165_11)
						arg_162_1:RecordAudio("322061039", var_165_11)
					else
	...
	Play322061040 = function(arg_166_0, arg_166_1)
		...
		function arg_166_1.onSingleLineUpdate_(arg_169_0)
			if 0 < arg_166_1.time_ and arg_166_1.time_ <= 0 + arg_169_0 and not isNil(arg_166_1.actors_["10104ui_story"]) and arg_166_1.var_.characterEffect10104ui_story == nil then
				arg_166_1.var_.characterEffect10104ui_story = arg_166_1.actors_["10104ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_169_0 = 0.200000002980232

			if 0 <= arg_166_1.time_ and arg_166_1.time_ < 0 + var_169_0 and not isNil(arg_166_1.actors_["10104ui_story"]) then
				if arg_166_1.var_.characterEffect10104ui_story and not isNil(arg_166_1.actors_["10104ui_story"]) then
					arg_166_1.var_.characterEffect10104ui_story.fillFlat = false
				end
			end

			if arg_166_1.time_ >= 0 + var_169_0 and arg_166_1.time_ < 0 + var_169_0 + arg_169_0 and not isNil(arg_166_1.actors_["10104ui_story"]) and arg_166_1.var_.characterEffect10104ui_story then
				arg_166_1.var_.characterEffect10104ui_story.fillFlat = false
			end

			local var_169_2 = arg_166_1.actors_["1284ui_story"]

			if 0 < arg_166_1.time_ and arg_166_1.time_ <= 0 + arg_169_0 and not isNil(var_169_2) and arg_166_1.var_.characterEffect1284ui_story == nil then
				arg_166_1.var_.characterEffect1284ui_story = var_169_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_169_3 = 0.200000002980232

			if 0 <= arg_166_1.time_ and arg_166_1.time_ < 0 + var_169_3 and not isNil(var_169_2) then
				if arg_166_1.var_.characterEffect1284ui_story and not isNil(var_169_2) then
					arg_166_1.var_.characterEffect1284ui_story.fillFlat = true
					arg_166_1.var_.characterEffect1284ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_166_1.time_ - 0) / var_169_3)
				end
			end

			if arg_166_1.time_ >= 0 + var_169_3 and arg_166_1.time_ < 0 + var_169_3 + arg_169_0 and not isNil(var_169_2) and arg_166_1.var_.characterEffect1284ui_story then
				arg_166_1.var_.characterEffect1284ui_story.fillFlat = true
				arg_166_1.var_.characterEffect1284ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_166_1.time_ and arg_166_1.time_ <= 0 + arg_169_0 then
				...
				local var_169_4 = arg_166_1.var_.characterEffect10104ui_story

				arg_166_1.var_.characterEffect10104ui_story.imageEffect:turnOff()

				var_169_4.interferenceEffect.enabled = true
				var_169_4.interferenceEffect.noise = 0.001
				var_169_4.interferenceEffect.simTimeScale = 1
				var_169_4.interferenceEffect.geometryOutlineColor = Color.New(0.3725, 0.88, 1, 1)
			end
			...
			if 0 < arg_166_1.time_ and arg_166_1.time_ <= var_169_6 + arg_169_0 then
				...
				arg_166_1.leftNameTxt_.text = arg_166_1:FormatText(StoryNameCfg[1030].name)
				...
				local var_169_8 = arg_166_1:GetWordFromCfg(322061040)
				...
				local var_169_11 = 43 <= 0 and var_169_7 or var_169_7 * (utf8.len(var_169_9) / 43)

				if (43 <= 0 and var_169_7 or var_169_7 * (utf8.len(var_169_9) / 43)) > 0 and var_169_7 < var_169_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061040", "story_v_out_322061.awb") ~= 0 then
					local var_169_12 = manager.audio:GetVoiceLength("story_v_out_322061", "322061040", "story_v_out_322061.awb") / 1000
					...
					if var_169_8.prefab_name ~= "" and arg_166_1.actors_[var_169_8.prefab_name] ~= nil then
						local var_169_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_166_1.actors_[var_169_8.prefab_name].transform, "story_v_out_322061", "322061040", "story_v_out_322061.awb")

						arg_166_1:RecordAudio("322061040", var_169_13)
						arg_166_1:RecordAudio("322061040", var_169_13)
					else
		...
		function arg_170_1.onSingleLineUpdate_(arg_173_0)
			if 0 < arg_170_1.time_ and arg_170_1.time_ <= 0 + arg_173_0 then
				if arg_170_1.var_.characterEffect10104ui_story == nil then
					arg_170_1.var_.characterEffect10104ui_story = arg_170_1.actors_["10104ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
				end

				local var_173_0 = arg_170_1.var_.characterEffect10104ui_story

				arg_170_1.var_.characterEffect10104ui_story.imageEffect:turnOff()

				var_173_0.interferenceEffect.enabled = true
				var_173_0.interferenceEffect.noise = 0.001
				var_173_0.interferenceEffect.simTimeScale = 1
				var_173_0.interferenceEffect.geometryOutlineColor = Color.New(0.3725, 0.88, 1, 1)
			end
			...
			if 0 < arg_170_1.time_ and arg_170_1.time_ <= var_173_2 + arg_173_0 then
				...
				local var_173_4 = arg_170_1:GetWordFromCfg(322061041)
				...
				local var_173_7 = 40 <= 0 and var_173_3 or var_173_3 * (utf8.len(var_173_5) / 40)

				if (40 <= 0 and var_173_3 or var_173_3 * (utf8.len(var_173_5) / 40)) > 0 and var_173_3 < var_173_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061041", "story_v_out_322061.awb") ~= 0 then
					local var_173_8 = manager.audio:GetVoiceLength("story_v_out_322061", "322061041", "story_v_out_322061.awb") / 1000
					...
					if var_173_4.prefab_name ~= "" and arg_170_1.actors_[var_173_4.prefab_name] ~= nil then
						local var_173_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_170_1.actors_[var_173_4.prefab_name].transform, "story_v_out_322061", "322061041", "story_v_out_322061.awb")

						arg_170_1:RecordAudio("322061041", var_173_9)
						arg_170_1:RecordAudio("322061041", var_173_9)
					else
		...
		function arg_174_1.onSingleLineUpdate_(arg_177_0)
			...
			if 0 < arg_174_1.time_ and arg_174_1.time_ <= 0 + arg_177_0 then
				if arg_174_1.var_.characterEffect10104ui_story == nil then
					arg_174_1.var_.characterEffect10104ui_story = arg_174_1.actors_["10104ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
				end

				local var_177_0 = arg_174_1.var_.characterEffect10104ui_story

				arg_174_1.var_.characterEffect10104ui_story.imageEffect:turnOff()

				var_177_0.interferenceEffect.enabled = true
				var_177_0.interferenceEffect.noise = 0.001
				var_177_0.interferenceEffect.simTimeScale = 1
				var_177_0.interferenceEffect.geometryOutlineColor = Color.New(0.3725, 0.88, 1, 1)
			end
			...
			if 0 < arg_174_1.time_ and arg_174_1.time_ <= var_177_2 + arg_177_0 then
				...
				arg_174_1.leftNameTxt_.text = arg_174_1:FormatText(StoryNameCfg[1030].name)
				...
				local var_177_4 = arg_174_1:GetWordFromCfg(322061042)
				...
				local var_177_7 = 58 <= 0 and var_177_3 or var_177_3 * (utf8.len(var_177_5) / 58)

				if (58 <= 0 and var_177_3 or var_177_3 * (utf8.len(var_177_5) / 58)) > 0 and var_177_3 < var_177_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061042", "story_v_out_322061.awb") ~= 0 then
					local var_177_8 = manager.audio:GetVoiceLength("story_v_out_322061", "322061042", "story_v_out_322061.awb") / 1000
					...
					if var_177_4.prefab_name ~= "" and arg_174_1.actors_[var_177_4.prefab_name] ~= nil then
						local var_177_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_174_1.actors_[var_177_4.prefab_name].transform, "story_v_out_322061", "322061042", "story_v_out_322061.awb")

						arg_174_1:RecordAudio("322061042", var_177_9)
						arg_174_1:RecordAudio("322061042", var_177_9)
					else
	...
	Play322061043 = function(arg_178_0, arg_178_1)
		...
		function arg_178_1.onSingleLineUpdate_(arg_181_0)
			if 0 < arg_178_1.time_ and arg_178_1.time_ <= 0 + arg_181_0 then
				arg_178_1.var_.moveOldPos404001ui_story = arg_178_1.actors_["404001ui_story"].transform.localPosition
			end

			local var_181_0 = 0.001

			if 0 <= arg_178_1.time_ and arg_178_1.time_ < 0 + var_181_0 then
				arg_178_1.actors_["404001ui_story"].transform.localPosition = Vector3.Lerp(arg_178_1.var_.moveOldPos404001ui_story, Vector3.New(-0.8, -1.55, -5.5), (arg_178_1.time_ - 0) / var_181_0)
				arg_178_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_178_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_178_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_178_1.actors_["404001ui_story"].transform.position).z)
				arg_178_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_178_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_178_1.actors_["404001ui_story"].transform.localEulerAngles = arg_178_1.actors_["404001ui_story"].transform.localEulerAngles
			end

			if arg_178_1.time_ >= 0 + var_181_0 and arg_178_1.time_ < 0 + var_181_0 + arg_181_0 then
				arg_178_1.actors_["404001ui_story"].transform.localPosition = Vector3.New(-0.8, -1.55, -5.5)
				arg_178_1.actors_["404001ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_178_1.actors_["404001ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_178_1.actors_["404001ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_178_1.actors_["404001ui_story"].transform.position).z)
				arg_178_1.actors_["404001ui_story"].transform.localEulerAngles.z = 0
				arg_178_1.actors_["404001ui_story"].transform.localEulerAngles.x = 0
				arg_178_1.actors_["404001ui_story"].transform.localEulerAngles = arg_178_1.actors_["404001ui_story"].transform.localEulerAngles
			...
			local var_181_1 = arg_178_1.actors_["1284ui_story"].transform

			if 0 < arg_178_1.time_ and arg_178_1.time_ <= 0 + arg_181_0 then
				arg_178_1.var_.moveOldPos1284ui_story = var_181_1.localPosition
			end

			local var_181_2 = 0.001

			if 0 <= arg_178_1.time_ and arg_178_1.time_ < 0 + var_181_2 then
				var_181_1.localPosition = Vector3.Lerp(arg_178_1.var_.moveOldPos1284ui_story, Vector3.New(0, 100, 0), (arg_178_1.time_ - 0) / var_181_2)
			...
			local var_181_3 = arg_178_1.actors_["404001ui_story"]

			if 0 < arg_178_1.time_ and arg_178_1.time_ <= 0 + arg_181_0 and not isNil(var_181_3) and arg_178_1.var_.characterEffect404001ui_story == nil then
				arg_178_1.var_.characterEffect404001ui_story = var_181_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_181_4 = 0.200000002980232

			if 0 <= arg_178_1.time_ and arg_178_1.time_ < 0 + var_181_4 and not isNil(var_181_3) then
				if arg_178_1.var_.characterEffect404001ui_story and not isNil(var_181_3) then
					arg_178_1.var_.characterEffect404001ui_story.fillFlat = false
				end
			end

			if arg_178_1.time_ >= 0 + var_181_4 and arg_178_1.time_ < 0 + var_181_4 + arg_181_0 and not isNil(var_181_3) and arg_178_1.var_.characterEffect404001ui_story then
				arg_178_1.var_.characterEffect404001ui_story.fillFlat = false
			end

			local var_181_6 = arg_178_1.actors_["10104ui_story"]

			if 0 < arg_178_1.time_ and arg_178_1.time_ <= 0 + arg_181_0 and not isNil(var_181_6) and arg_178_1.var_.characterEffect10104ui_story == nil then
				arg_178_1.var_.characterEffect10104ui_story = var_181_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_181_7 = 0.200000002980232

			if 0 <= arg_178_1.time_ and arg_178_1.time_ < 0 + var_181_7 and not isNil(var_181_6) then
				if arg_178_1.var_.characterEffect10104ui_story and not isNil(var_181_6) then
					arg_178_1.var_.characterEffect10104ui_story.fillFlat = true
					arg_178_1.var_.characterEffect10104ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_178_1.time_ - 0) / var_181_7)
				end
			end

			if arg_178_1.time_ >= 0 + var_181_7 and arg_178_1.time_ < 0 + var_181_7 + arg_181_0 and not isNil(var_181_6) and arg_178_1.var_.characterEffect10104ui_story then
				arg_178_1.var_.characterEffect10104ui_story.fillFlat = true
				arg_178_1.var_.characterEffect10104ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_178_1.time_ and arg_178_1.time_ <= var_181_8 + arg_181_0 then
				...
				local var_181_10 = arg_178_1:GetWordFromCfg(322061043)
				...
				local var_181_13 = 40 <= 0 and var_181_9 or var_181_9 * (utf8.len(var_181_11) / 40)

				if (40 <= 0 and var_181_9 or var_181_9 * (utf8.len(var_181_11) / 40)) > 0 and var_181_9 < var_181_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061043", "story_v_out_322061.awb") ~= 0 then
					local var_181_14 = manager.audio:GetVoiceLength("story_v_out_322061", "322061043", "story_v_out_322061.awb") / 1000
					...
					if var_181_10.prefab_name ~= "" and arg_178_1.actors_[var_181_10.prefab_name] ~= nil then
						local var_181_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_178_1.actors_[var_181_10.prefab_name].transform, "story_v_out_322061", "322061043", "story_v_out_322061.awb")

						arg_178_1:RecordAudio("322061043", var_181_15)
						arg_178_1:RecordAudio("322061043", var_181_15)
					else
	...
	Play322061044 = function(arg_182_0, arg_182_1)
		...
		function arg_182_1.onSingleLineUpdate_(arg_185_0)
			if 0 < arg_182_1.time_ and arg_182_1.time_ <= 0 + arg_185_0 and not isNil(arg_182_1.actors_["10104ui_story"]) and arg_182_1.var_.characterEffect10104ui_story == nil then
				arg_182_1.var_.characterEffect10104ui_story = arg_182_1.actors_["10104ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_185_0 = 0.200000002980232

			if 0 <= arg_182_1.time_ and arg_182_1.time_ < 0 + var_185_0 and not isNil(arg_182_1.actors_["10104ui_story"]) then
				if arg_182_1.var_.characterEffect10104ui_story and not isNil(arg_182_1.actors_["10104ui_story"]) then
					arg_182_1.var_.characterEffect10104ui_story.fillFlat = false
				end
			end

			if arg_182_1.time_ >= 0 + var_185_0 and arg_182_1.time_ < 0 + var_185_0 + arg_185_0 and not isNil(arg_182_1.actors_["10104ui_story"]) and arg_182_1.var_.characterEffect10104ui_story then
				arg_182_1.var_.characterEffect10104ui_story.fillFlat = false
			end

			local var_185_2 = arg_182_1.actors_["404001ui_story"]

			if 0 < arg_182_1.time_ and arg_182_1.time_ <= 0 + arg_185_0 and not isNil(var_185_2) and arg_182_1.var_.characterEffect404001ui_story == nil then
				arg_182_1.var_.characterEffect404001ui_story = var_185_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_185_3 = 0.200000002980232

			if 0 <= arg_182_1.time_ and arg_182_1.time_ < 0 + var_185_3 and not isNil(var_185_2) then
				if arg_182_1.var_.characterEffect404001ui_story and not isNil(var_185_2) then
					arg_182_1.var_.characterEffect404001ui_story.fillFlat = true
					arg_182_1.var_.characterEffect404001ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_182_1.time_ - 0) / var_185_3)
				end
			end

			if arg_182_1.time_ >= 0 + var_185_3 and arg_182_1.time_ < 0 + var_185_3 + arg_185_0 and not isNil(var_185_2) and arg_182_1.var_.characterEffect404001ui_story then
				arg_182_1.var_.characterEffect404001ui_story.fillFlat = true
				arg_182_1.var_.characterEffect404001ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_182_1.time_ and arg_182_1.time_ <= 0 + arg_185_0 then
				...
				local var_185_4 = arg_182_1.var_.characterEffect10104ui_story

				arg_182_1.var_.characterEffect10104ui_story.imageEffect:turnOff()

				var_185_4.interferenceEffect.enabled = true
				var_185_4.interferenceEffect.noise = 0.001
				var_185_4.interferenceEffect.simTimeScale = 1
				var_185_4.interferenceEffect.geometryOutlineColor = Color.New(0.3725, 0.88, 1, 1)
			end
			...
			if 0 < arg_182_1.time_ and arg_182_1.time_ <= var_185_6 + arg_185_0 then
				...
				arg_182_1.leftNameTxt_.text = arg_182_1:FormatText(StoryNameCfg[1030].name)
				...
				local var_185_8 = arg_182_1:GetWordFromCfg(322061044)
				...
				local var_185_11 = 15 <= 0 and var_185_7 or var_185_7 * (utf8.len(var_185_9) / 15)

				if (15 <= 0 and var_185_7 or var_185_7 * (utf8.len(var_185_9) / 15)) > 0 and var_185_7 < var_185_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061044", "story_v_out_322061.awb") ~= 0 then
					local var_185_12 = manager.audio:GetVoiceLength("story_v_out_322061", "322061044", "story_v_out_322061.awb") / 1000
					...
					if var_185_8.prefab_name ~= "" and arg_182_1.actors_[var_185_8.prefab_name] ~= nil then
						local var_185_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_182_1.actors_[var_185_8.prefab_name].transform, "story_v_out_322061", "322061044", "story_v_out_322061.awb")

						arg_182_1:RecordAudio("322061044", var_185_13)
						arg_182_1:RecordAudio("322061044", var_185_13)
					else
	...
	Play322061045 = function(arg_186_0, arg_186_1)
		...
		function arg_186_1.onSingleLineUpdate_(arg_189_0)
			if 0 < arg_186_1.time_ and arg_186_1.time_ <= 0 + arg_189_0 and not isNil(arg_186_1.actors_["404001ui_story"]) and arg_186_1.var_.characterEffect404001ui_story == nil then
				arg_186_1.var_.characterEffect404001ui_story = arg_186_1.actors_["404001ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_189_0 = 0.200000002980232

			if 0 <= arg_186_1.time_ and arg_186_1.time_ < 0 + var_189_0 and not isNil(arg_186_1.actors_["404001ui_story"]) then
				if arg_186_1.var_.characterEffect404001ui_story and not isNil(arg_186_1.actors_["404001ui_story"]) then
					arg_186_1.var_.characterEffect404001ui_story.fillFlat = false
				end
			end

			if arg_186_1.time_ >= 0 + var_189_0 and arg_186_1.time_ < 0 + var_189_0 + arg_189_0 and not isNil(arg_186_1.actors_["404001ui_story"]) and arg_186_1.var_.characterEffect404001ui_story then
				arg_186_1.var_.characterEffect404001ui_story.fillFlat = false
			end

			local var_189_2 = arg_186_1.actors_["10104ui_story"]

			if 0 < arg_186_1.time_ and arg_186_1.time_ <= 0 + arg_189_0 and not isNil(var_189_2) and arg_186_1.var_.characterEffect10104ui_story == nil then
				arg_186_1.var_.characterEffect10104ui_story = var_189_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_189_3 = 0.200000002980232

			if 0 <= arg_186_1.time_ and arg_186_1.time_ < 0 + var_189_3 and not isNil(var_189_2) then
				if arg_186_1.var_.characterEffect10104ui_story and not isNil(var_189_2) then
					arg_186_1.var_.characterEffect10104ui_story.fillFlat = true
					arg_186_1.var_.characterEffect10104ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_186_1.time_ - 0) / var_189_3)
				end
			end

			if arg_186_1.time_ >= 0 + var_189_3 and arg_186_1.time_ < 0 + var_189_3 + arg_189_0 and not isNil(var_189_2) and arg_186_1.var_.characterEffect10104ui_story then
				arg_186_1.var_.characterEffect10104ui_story.fillFlat = true
				arg_186_1.var_.characterEffect10104ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_186_1.time_ and arg_186_1.time_ <= var_189_4 + arg_189_0 then
				...
				local var_189_6 = arg_186_1:GetWordFromCfg(322061045)
				...
				local var_189_9 = 7 <= 0 and var_189_5 or var_189_5 * (utf8.len(var_189_7) / 7)

				if (7 <= 0 and var_189_5 or var_189_5 * (utf8.len(var_189_7) / 7)) > 0 and var_189_5 < var_189_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061045", "story_v_out_322061.awb") ~= 0 then
					local var_189_10 = manager.audio:GetVoiceLength("story_v_out_322061", "322061045", "story_v_out_322061.awb") / 1000
					...
					if var_189_6.prefab_name ~= "" and arg_186_1.actors_[var_189_6.prefab_name] ~= nil then
						local var_189_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_186_1.actors_[var_189_6.prefab_name].transform, "story_v_out_322061", "322061045", "story_v_out_322061.awb")

						arg_186_1:RecordAudio("322061045", var_189_11)
						arg_186_1:RecordAudio("322061045", var_189_11)
					else
	...
	Play322061046 = function(arg_190_0, arg_190_1)
		...
		function arg_190_1.onSingleLineUpdate_(arg_193_0)
			...
			if 0 < arg_190_1.time_ and arg_190_1.time_ <= var_193_0 + arg_193_0 then
				...
				local var_193_2 = arg_190_1:GetWordFromCfg(322061046)
				...
				local var_193_5 = 19 <= 0 and var_193_1 or var_193_1 * (utf8.len(var_193_3) / 19)

				if (19 <= 0 and var_193_1 or var_193_1 * (utf8.len(var_193_3) / 19)) > 0 and var_193_1 < var_193_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322061", "322061046", "story_v_out_322061.awb") ~= 0 then
					local var_193_6 = manager.audio:GetVoiceLength("story_v_out_322061", "322061046", "story_v_out_322061.awb") / 1000
					...
					if var_193_2.prefab_name ~= "" and arg_190_1.actors_[var_193_2.prefab_name] ~= nil then
						local var_193_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_190_1.actors_[var_193_2.prefab_name].transform, "story_v_out_322061", "322061046", "story_v_out_322061.awb")

						arg_190_1:RecordAudio("322061046", var_193_7)
						arg_190_1:RecordAudio("322061046", var_193_7)
					else
