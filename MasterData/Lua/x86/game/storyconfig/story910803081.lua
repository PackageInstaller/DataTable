return {
	Play910826001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910826001).content)
	...
	Play910826002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910826002).content)

				arg_7_1.text_.text = var_10_1

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_3 = 7 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 7)

				if (7 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 7)) > 0 and var_10_0 < var_10_3 then
	...
	Play910826003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				arg_11_1.var_.moveOldPos1111 = arg_11_1.actors_["1111"].transform.localPosition
				arg_11_1.actors_["1111"].transform.localScale = Vector3.New(1, 1, 1)

				arg_11_1:CheckSpriteTmpPos("1111", 3)

				for iter_14_0 = 0, arg_11_1.actors_["1111"].transform.childCount - 1 do
					local var_14_0 = arg_11_1.actors_["1111"].transform:GetChild(iter_14_0)

					if var_14_0.name == "split_3" or not string.find(var_14_0.name, "split") then
			...
			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_1 then
				arg_11_1.actors_["1111"].transform.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1111, Vector3.New(-100, -290, -350), (arg_11_1.time_ - 0) / var_14_1)
			end

			if arg_11_1.time_ >= 0 + var_14_1 and arg_11_1.time_ < 0 + var_14_1 + arg_14_0 then
				arg_11_1.actors_["1111"].transform.localPosition = Vector3.New(-100, -290, -350)
			end

			local var_14_2 = arg_11_1.actors_["1111"]

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 and not isNil(var_14_2) and arg_11_1.var_.actorSpriteComps1111 == nil then
				arg_11_1.var_.actorSpriteComps1111 = var_14_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_11_1.time_ >= 0 + var_14_3 and arg_11_1.time_ < 0 + var_14_3 + arg_14_0 and not isNil(var_14_2) and arg_11_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_5 + arg_14_0 then
				...
				local var_14_7 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910826003).content)

				arg_11_1.text_.text = var_14_7

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_9 = 18 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 18)

				if (18 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 18)) > 0 and var_14_6 < var_14_9 then
	...
	Play910826004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 and not isNil(arg_15_1.actors_["1111"]) and arg_15_1.var_.actorSpriteComps1111 == nil then
				arg_15_1.var_.actorSpriteComps1111 = arg_15_1.actors_["1111"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_18_0 = 2

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_0 and not isNil(arg_15_1.actors_["1111"]) then
			...
			if arg_15_1.time_ >= 0 + var_18_0 and arg_15_1.time_ < 0 + var_18_0 + arg_18_0 and not isNil(arg_15_1.actors_["1111"]) and arg_15_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_2 + arg_18_0 then
				...
				local var_18_4 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910826004).content)

				arg_15_1.text_.text = var_18_4

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_6 = 10 <= 0 and var_18_3 or var_18_3 * (utf8.len(var_18_4) / 10)

				if (10 <= 0 and var_18_3 or var_18_3 * (utf8.len(var_18_4) / 10)) > 0 and var_18_3 < var_18_6 then
	...
	Play910826005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910826005).content)
	...
	Play910826006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910826006).content)
	...
	Play910826007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_2 + arg_30_0 then
				...
				local var_30_4 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910826007).content)

				arg_27_1.text_.text = var_30_4

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_6 = 21 <= 0 and var_30_3 or var_30_3 * (utf8.len(var_30_4) / 21)

				if (21 <= 0 and var_30_3 or var_30_3 * (utf8.len(var_30_4) / 21)) > 0 and var_30_3 < var_30_6 then
	...
	Play910826008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910826008).content)

				arg_31_1.text_.text = var_34_7

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_9 = 25 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 25)

				if (25 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 25)) > 0 and var_34_6 < var_34_9 then
	...
	Play910826009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_2 + arg_38_0 then
				...
				local var_38_4 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910826009).content)

				arg_35_1.text_.text = var_38_4

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_6 = 31 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 31)

				if (31 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 31)) > 0 and var_38_3 < var_38_6 then
	...
	Play910826010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910826010).content)
	...
	Play910826011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_2 + arg_46_0 then
				...
				local var_46_4 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910826011).content)

				arg_43_1.text_.text = var_46_4

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_6 = 39 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 39)

				if (39 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 39)) > 0 and var_46_3 < var_46_6 then
	...
	Play910826012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 then
				...
				local var_50_1 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910826012).content)

				arg_47_1.text_.text = var_50_1

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_3 = 40 <= 0 and var_50_0 or var_50_0 * (utf8.len(var_50_1) / 40)

				if (40 <= 0 and var_50_0 or var_50_0 * (utf8.len(var_50_1) / 40)) > 0 and var_50_0 < var_50_3 then
	...
	Play910826013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_6 + arg_54_0 then
				...
				local var_54_8 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910826013).content)

				arg_51_1.text_.text = var_54_8

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_10 = 29 <= 0 and var_54_7 or var_54_7 * (utf8.len(var_54_8) / 29)

				if (29 <= 0 and var_54_7 or var_54_7 * (utf8.len(var_54_8) / 29)) > 0 and var_54_7 < var_54_10 then
