return {
	Play320541001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.999999999999 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 then
				...
				local var_4_18 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(320541001).content)
	...
	Play320541002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_8 + arg_12_0 then
				...
				local var_12_10 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(320541002).content)

				arg_9_1.text_.text = var_12_10

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_12 = 32 <= 0 and var_12_9 or var_12_9 * (utf8.len(var_12_10) / 32)

				if (32 <= 0 and var_12_9 or var_12_9 * (utf8.len(var_12_10) / 32)) > 0 and var_12_9 < var_12_12 then
	...
	Play320541003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_1 + arg_16_0 then
				...
				local var_16_3 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(320541003).content)
	...
	Play320541004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(320541004).content)

				arg_17_1.text_.text = var_20_4

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_6 = 20 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 20)

				if (20 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 20)) > 0 and var_20_3 < var_20_6 then
	...
	Play320541005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_1 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(320541005).content)

				arg_21_1.text_.text = var_24_3

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_5 = 13 <= 0 and var_24_2 or var_24_2 * (utf8.len(var_24_3) / 13)

				if (13 <= 0 and var_24_2 or var_24_2 * (utf8.len(var_24_3) / 13)) > 0 and var_24_2 < var_24_5 then
	...
	Play320541006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(320541006).content)
	...
	Play320541007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(320541007).content)

				arg_29_1.text_.text = var_32_3

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_5 = 15 <= 0 and var_32_2 or var_32_2 * (utf8.len(var_32_3) / 15)

				if (15 <= 0 and var_32_2 or var_32_2 * (utf8.len(var_32_3) / 15)) > 0 and var_32_2 < var_32_5 then
	...
	Play320541008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_3 + arg_36_0 then
				...
				local var_36_5 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(320541008).content)

				arg_33_1.text_.text = var_36_5

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_7 = 28 <= 0 and var_36_4 or var_36_4 * (utf8.len(var_36_5) / 28)

				if (28 <= 0 and var_36_4 or var_36_4 * (utf8.len(var_36_5) / 28)) > 0 and var_36_4 < var_36_7 then
	...
	Play320541009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				local var_40_1 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(320541009).content)
	...
	Play320541010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				...
				local var_44_1 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(320541010).content)
	...
	Play320541011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				local var_48_1 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(320541011).content)
	...
	Play320541012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				...
				local var_52_1 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(320541012).content)
	...
	Play320541013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				...
				local var_56_1 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(320541013).content)
	...
	Play320541014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				...
				local var_60_1 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(320541014).content)
	...
	Play320541015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			local var_64_0 = 0.0329999998211861
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				...
				local var_64_1 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(320541015).content)

				arg_61_1.text_.text = var_64_1

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_3 = 1 <= 0 and var_64_0 or var_64_0 * (utf8.len(var_64_1) / 1)

				if (1 <= 0 and var_64_0 or var_64_0 * (utf8.len(var_64_1) / 1)) > 0 and var_64_0 < var_64_3 then
	...
	Play320541016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				...
				local var_68_1 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(320541016).content)
	...
	Play320541017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				...
				local var_72_1 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(320541017).content)
	...
	Play320541018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				...
				local var_76_1 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(320541018).content)
	...
	Play320541019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				...
				local var_80_1 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(320541019).content)
	...
	Play320541020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= 0 + arg_84_0 then
				...
				local var_84_1 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(320541020).content)
	...
	Play320541021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				...
				local var_88_1 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(320541021).content)
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			...
			if 0 <= arg_89_1.time_ and arg_89_1.time_ < 0 + var_92_0 and not isNil(arg_89_1.actors_["1056ui_story"]) then
				if arg_89_1.var_.characterEffect1056ui_story and not isNil(arg_89_1.actors_["1056ui_story"]) then
					...
					arg_89_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_89_1.time_ - 0) / var_92_0)
				end
			end
			...
			if arg_89_1.time_ >= 0 + var_92_0 and arg_89_1.time_ < 0 + var_92_0 + arg_92_0 and not isNil(arg_89_1.actors_["1056ui_story"]) and arg_89_1.var_.characterEffect1056ui_story then
				arg_89_1.var_.characterEffect1056ui_story.fillFlat = true
				arg_89_1.var_.characterEffect1056ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_89_1.time_ and arg_89_1.time_ <= var_92_1 + arg_92_0 then
				...
				local var_92_3 = arg_89_1:FormatText(arg_89_1:GetWordFromCfg(320541022).content)
	...
	Play320541023 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if 0 < arg_93_1.time_ and arg_93_1.time_ <= 0 + arg_96_0 then
				...
				local var_96_1 = arg_93_1:FormatText(arg_93_1:GetWordFromCfg(320541023).content)
	...
	Play320541024 = function(arg_97_0, arg_97_1)
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			...
			if 0 < arg_97_1.time_ and arg_97_1.time_ <= 0 + arg_100_0 then
				...
				local var_100_1 = arg_97_1:FormatText(arg_97_1:GetWordFromCfg(320541024).content)
	...
	Play320541025 = function(arg_101_0, arg_101_1)
		...
		function arg_101_1.onSingleLineUpdate_(arg_104_0)
			...
			if 0 < arg_101_1.time_ and arg_101_1.time_ <= var_104_1 + arg_104_0 then
				...
				local var_104_3 = arg_101_1:FormatText(arg_101_1:GetWordFromCfg(320541025).content)
