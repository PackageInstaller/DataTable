return {
	Play102061001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				arg_1_1:AudioAction("play", "effect", "se_story", "se_story_robot_broken", "")
			end

			local var_4_5 = "2025_tpose"

			if arg_1_1.actors_["2025_tpose"] == nil and not isNil((Asset.Load("Char/" .. "2025_tpose"))) then
				local var_4_6 = Object.Instantiate(Asset.Load("Char/" .. "2025_tpose"), arg_1_1.stage_.transform)
			...
			local var_4_9 = arg_1_1.actors_["2025_tpose"]

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_9) and arg_1_1.var_.characterEffect2025_tpose == nil then
				arg_1_1.var_.characterEffect2025_tpose = var_4_9:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_10 = 0.1

			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_10 and not isNil(var_4_9) then
				if arg_1_1.var_.characterEffect2025_tpose and not isNil(var_4_9) then
					arg_1_1.var_.characterEffect2025_tpose.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 2 + var_4_10 and arg_1_1.time_ < 2 + var_4_10 + arg_4_0 and not isNil(var_4_9) and arg_1_1.var_.characterEffect2025_tpose then
				arg_1_1.var_.characterEffect2025_tpose.fillFlat = false
			end

			local var_4_12 = "B02a"

			if arg_1_1.bgs_.B02a == nil then
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_14 = arg_1_1.bgs_.B02a:GetComponent("SpriteRenderer")

				if var_4_14 then
					arg_1_1.var_.alphaOldValueB02a = var_4_14.color.a
					arg_1_1.var_.alphaMatValueB02a = var_4_14
				end
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_15 then
				if arg_1_1.var_.alphaMatValueB02a then
					arg_1_1.var_.alphaMatValueB02a.color.a = Mathf.Lerp(arg_1_1.var_.alphaOldValueB02a, 1, (arg_1_1.time_ - 0) / var_4_15)
					arg_1_1.var_.alphaMatValueB02a.color = arg_1_1.var_.alphaMatValueB02a.color
				end
			end

			if arg_1_1.time_ >= 0 + var_4_15 and arg_1_1.time_ < 0 + var_4_15 + arg_4_0 and arg_1_1.var_.alphaMatValueB02a then
				arg_1_1.var_.alphaMatValueB02a.color.a = 1
				arg_1_1.var_.alphaMatValueB02a.color = arg_1_1.var_.alphaMatValueB02a.color
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_16 = arg_1_1.bgs_.B02a

				arg_1_1.bgs_.B02a.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_4_19 = arg_1_1.actors_["2025_tpose"].transform

			if 1.79999995231628 < arg_1_1.time_ and arg_1_1.time_ <= 1.79999995231628 + arg_4_0 then
				arg_1_1.var_.moveOldPos2025_tpose = var_4_19.localPosition

				local var_4_20 = GameObjectTools.GetOrAddComponent(var_4_19.gameObject, typeof(DynamicBoneHelper))
			...
			if 1.79999995231628 <= arg_1_1.time_ and arg_1_1.time_ < 1.79999995231628 + var_4_21 then
				var_4_19.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2025_tpose, Vector3.New(0, -1.42, -4.3), (arg_1_1.time_ - 1.79999995231628) / var_4_21)
			...
			if arg_1_1.time_ >= 1.79999995231628 + var_4_21 and arg_1_1.time_ < 1.79999995231628 + var_4_21 + arg_4_0 then
				var_4_19.localPosition = Vector3.New(0, -1.42, -4.3)
				var_4_19.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_19.position).x, (manager.ui.mainCamera.transform.position - var_4_19.position).y, (manager.ui.mainCamera.transform.position - var_4_19.position).z)
				var_4_19.localEulerAngles.z = 0
				var_4_19.localEulerAngles.x = 0
				var_4_19.localEulerAngles = var_4_19.localEulerAngles

				local var_4_22 = GameObjectTools.GetOrAddComponent(var_4_19.gameObject, typeof(DynamicBoneHelper))

				if var_4_22 then
					var_4_22:EnableDynamicBone(true)
				end
			end
			...
			if arg_1_1.time_ >= var_4_23 + 2 and arg_1_1.time_ < var_4_23 + 2 + arg_4_0 then
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				local var_4_27 = arg_1_1:GetWordFromCfg(102061001)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061001", "story_v_out_102061.awb") ~= 0 then
					local var_4_31 = manager.audio:GetVoiceLength("story_v_out_102061", "102061001", "story_v_out_102061.awb") / 1000
					...
					if var_4_27.prefab_name ~= "" and arg_1_1.actors_[var_4_27.prefab_name] ~= nil then
						local var_4_32 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_27.prefab_name].transform, "story_v_out_102061", "102061001", "story_v_out_102061.awb")

						arg_1_1:RecordAudio("102061001", var_4_32)
						arg_1_1:RecordAudio("102061001", var_4_32)
					else
	...
	Play102061002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_1 + arg_11_0 then
				...
				local var_11_3 = arg_8_1:GetWordFromCfg(102061002)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061002", "story_v_out_102061.awb") ~= 0 then
					local var_11_7 = manager.audio:GetVoiceLength("story_v_out_102061", "102061002", "story_v_out_102061.awb") / 1000
					...
					if var_11_3.prefab_name ~= "" and arg_8_1.actors_[var_11_3.prefab_name] ~= nil then
						local var_11_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_3.prefab_name].transform, "story_v_out_102061", "102061002", "story_v_out_102061.awb")

						arg_8_1:RecordAudio("102061002", var_11_8)
						arg_8_1:RecordAudio("102061002", var_11_8)
					else
	...
	Play102061003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			local var_15_6 = arg_12_1.actors_["2025_tpose"]

			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 and not isNil(var_15_6) and arg_12_1.var_.characterEffect2025_tpose == nil then
				arg_12_1.var_.characterEffect2025_tpose = var_15_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_15_7 = 0.1

			if 0 <= arg_12_1.time_ and arg_12_1.time_ < 0 + var_15_7 and not isNil(var_15_6) then
				if arg_12_1.var_.characterEffect2025_tpose and not isNil(var_15_6) then
					arg_12_1.var_.characterEffect2025_tpose.fillFlat = true
					arg_12_1.var_.characterEffect2025_tpose.fillRatio = Mathf.Lerp(0, 0.5, (arg_12_1.time_ - 0) / var_15_7)
				end
			end

			if arg_12_1.time_ >= 0 + var_15_7 and arg_12_1.time_ < 0 + var_15_7 + arg_15_0 and not isNil(var_15_6) and arg_12_1.var_.characterEffect2025_tpose then
				arg_12_1.var_.characterEffect2025_tpose.fillFlat = true
				arg_12_1.var_.characterEffect2025_tpose.fillRatio = 0.5
			end

			local var_15_8 = arg_12_1.actors_["2025_tpose"].transform

			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 then
				arg_12_1.var_.moveOldPos2025_tpose = var_15_8.localPosition
			...
			if 0 <= arg_12_1.time_ and arg_12_1.time_ < 0 + var_15_10 then
				var_15_8.localPosition = Vector3.Lerp(arg_12_1.var_.moveOldPos2025_tpose, Vector3.New(0, 100, 0), (arg_12_1.time_ - 0) / var_15_10)
			...
			local var_15_12 = arg_12_1.actors_["1084ui_story"].transform

			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 then
				arg_12_1.var_.moveOldPos1084ui_story = var_15_12.localPosition
			end

			local var_15_13 = 0.001

			if 0 <= arg_12_1.time_ and arg_12_1.time_ < 0 + var_15_13 then
				var_15_12.localPosition = Vector3.Lerp(arg_12_1.var_.moveOldPos1084ui_story, Vector3.New(-0.7, -0.97, -6), (arg_12_1.time_ - 0) / var_15_13)
			...
			if arg_12_1.time_ >= 0 + var_15_13 and arg_12_1.time_ < 0 + var_15_13 + arg_15_0 then
				var_15_12.localPosition = Vector3.New(-0.7, -0.97, -6)
				var_15_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_15_12.position).x, (manager.ui.mainCamera.transform.position - var_15_12.position).y, (manager.ui.mainCamera.transform.position - var_15_12.position).z)
				var_15_12.localEulerAngles.z = 0
				var_15_12.localEulerAngles.x = 0
				var_15_12.localEulerAngles = var_15_12.localEulerAngles
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_14 + arg_15_0 then
				...
				local var_15_16 = arg_12_1:GetWordFromCfg(102061003)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061003", "story_v_out_102061.awb") ~= 0 then
					local var_15_20 = manager.audio:GetVoiceLength("story_v_out_102061", "102061003", "story_v_out_102061.awb") / 1000
					...
					if var_15_16.prefab_name ~= "" and arg_12_1.actors_[var_15_16.prefab_name] ~= nil then
						local var_15_21 = LuaForUtil.PlayVoiceWithCriLipsync(arg_12_1.actors_[var_15_16.prefab_name].transform, "story_v_out_102061", "102061003", "story_v_out_102061.awb")

						arg_12_1:RecordAudio("102061003", var_15_21)
						arg_12_1:RecordAudio("102061003", var_15_21)
					else
	...
	Play102061004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_10 + arg_19_0 then
				...
				local var_19_12 = arg_16_1:GetWordFromCfg(102061004)
				...
				local var_19_15 = 32 <= 0 and var_19_11 or var_19_11 * (utf8.len(var_19_13) / 32)

				if (32 <= 0 and var_19_11 or var_19_11 * (utf8.len(var_19_13) / 32)) > 0 and var_19_11 < var_19_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061004", "story_v_out_102061.awb") ~= 0 then
					local var_19_16 = manager.audio:GetVoiceLength("story_v_out_102061", "102061004", "story_v_out_102061.awb") / 1000
					...
					if var_19_12.prefab_name ~= "" and arg_16_1.actors_[var_19_12.prefab_name] ~= nil then
						local var_19_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_12.prefab_name].transform, "story_v_out_102061", "102061004", "story_v_out_102061.awb")

						arg_16_1:RecordAudio("102061004", var_19_17)
						arg_16_1:RecordAudio("102061004", var_19_17)
					else
	...
	Play102061005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_0 + arg_23_0 then
				...
				local var_23_2 = arg_20_1:GetWordFromCfg(102061005)
				...
				local var_23_5 = 17 <= 0 and var_23_1 or var_23_1 * (utf8.len(var_23_3) / 17)

				if (17 <= 0 and var_23_1 or var_23_1 * (utf8.len(var_23_3) / 17)) > 0 and var_23_1 < var_23_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061005", "story_v_out_102061.awb") ~= 0 then
					local var_23_6 = manager.audio:GetVoiceLength("story_v_out_102061", "102061005", "story_v_out_102061.awb") / 1000
					...
					if var_23_2.prefab_name ~= "" and arg_20_1.actors_[var_23_2.prefab_name] ~= nil then
						local var_23_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_20_1.actors_[var_23_2.prefab_name].transform, "story_v_out_102061", "102061005", "story_v_out_102061.awb")

						arg_20_1:RecordAudio("102061005", var_23_7)
						arg_20_1:RecordAudio("102061005", var_23_7)
					else
	...
	Play102061006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_11 then
				var_27_10.localPosition = Vector3.Lerp(arg_24_1.var_.moveOldPos1084ui_story, Vector3.New(0, 100, 0), (arg_24_1.time_ - 0) / var_27_11)
			...
			local var_27_12 = arg_24_1.actors_["3008ui_story"].transform

			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 then
				arg_24_1.var_.moveOldPos3008ui_story = var_27_12.localPosition
			end

			local var_27_13 = 0.001

			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_13 then
				var_27_12.localPosition = Vector3.Lerp(arg_24_1.var_.moveOldPos3008ui_story, Vector3.New(0, -1.51, -4.3), (arg_24_1.time_ - 0) / var_27_13)
			...
			if arg_24_1.time_ >= 0 + var_27_13 and arg_24_1.time_ < 0 + var_27_13 + arg_27_0 then
				var_27_12.localPosition = Vector3.New(0, -1.51, -4.3)
				var_27_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_27_12.position).x, (manager.ui.mainCamera.transform.position - var_27_12.position).y, (manager.ui.mainCamera.transform.position - var_27_12.position).z)
				var_27_12.localEulerAngles.z = 0
				var_27_12.localEulerAngles.x = 0
				var_27_12.localEulerAngles = var_27_12.localEulerAngles
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_14 + arg_27_0 then
				...
				local var_27_16 = arg_24_1:GetWordFromCfg(102061006)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061006", "story_v_out_102061.awb") ~= 0 then
					local var_27_20 = manager.audio:GetVoiceLength("story_v_out_102061", "102061006", "story_v_out_102061.awb") / 1000
					...
					if var_27_16.prefab_name ~= "" and arg_24_1.actors_[var_27_16.prefab_name] ~= nil then
						local var_27_21 = LuaForUtil.PlayVoiceWithCriLipsync(arg_24_1.actors_[var_27_16.prefab_name].transform, "story_v_out_102061", "102061006", "story_v_out_102061.awb")

						arg_24_1:RecordAudio("102061006", var_27_21)
						arg_24_1:RecordAudio("102061006", var_27_21)
					else
	...
	Play102061007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_2 + arg_31_0 then
				...
				local var_31_4 = arg_28_1:GetWordFromCfg(102061007)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061007", "story_v_out_102061.awb") ~= 0 then
					local var_31_8 = manager.audio:GetVoiceLength("story_v_out_102061", "102061007", "story_v_out_102061.awb") / 1000
					...
					if var_31_4.prefab_name ~= "" and arg_28_1.actors_[var_31_4.prefab_name] ~= nil then
						local var_31_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_4.prefab_name].transform, "story_v_out_102061", "102061007", "story_v_out_102061.awb")

						arg_28_1:RecordAudio("102061007", var_31_9)
						arg_28_1:RecordAudio("102061007", var_31_9)
					else
	...
	Play102061008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if 0 <= arg_32_1.time_ and arg_32_1.time_ < 0 + var_35_7 then
				var_35_6.localPosition = Vector3.Lerp(arg_32_1.var_.moveOldPos1019ui_story, Vector3.New(-0.2, -1.08, -5.9), (arg_32_1.time_ - 0) / var_35_7)
			...
			if arg_32_1.time_ >= 0 + var_35_7 and arg_32_1.time_ < 0 + var_35_7 + arg_35_0 then
				var_35_6.localPosition = Vector3.New(-0.2, -1.08, -5.9)
				var_35_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_35_6.position).x, (manager.ui.mainCamera.transform.position - var_35_6.position).y, (manager.ui.mainCamera.transform.position - var_35_6.position).z)
				var_35_6.localEulerAngles.z = 0
				var_35_6.localEulerAngles.x = 0
				var_35_6.localEulerAngles = var_35_6.localEulerAngles
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_8 + arg_35_0 then
				...
				local var_35_10 = arg_32_1:GetWordFromCfg(102061008)
				...
				local var_35_13 = 8 <= 0 and var_35_9 or var_35_9 * (utf8.len(var_35_11) / 8)

				if (8 <= 0 and var_35_9 or var_35_9 * (utf8.len(var_35_11) / 8)) > 0 and var_35_9 < var_35_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061008", "story_v_out_102061.awb") ~= 0 then
					local var_35_14 = manager.audio:GetVoiceLength("story_v_out_102061", "102061008", "story_v_out_102061.awb") / 1000
					...
					if var_35_10.prefab_name ~= "" and arg_32_1.actors_[var_35_10.prefab_name] ~= nil then
						local var_35_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_32_1.actors_[var_35_10.prefab_name].transform, "story_v_out_102061", "102061008", "story_v_out_102061.awb")

						arg_32_1:RecordAudio("102061008", var_35_15)
						arg_32_1:RecordAudio("102061008", var_35_15)
					else
	...
	Play102061009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_0 + arg_39_0 then
				...
				local var_39_2 = arg_36_1:GetWordFromCfg(102061009)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061009", "story_v_out_102061.awb") ~= 0 then
					local var_39_6 = manager.audio:GetVoiceLength("story_v_out_102061", "102061009", "story_v_out_102061.awb") / 1000
					...
					if var_39_2.prefab_name ~= "" and arg_36_1.actors_[var_39_2.prefab_name] ~= nil then
						local var_39_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_36_1.actors_[var_39_2.prefab_name].transform, "story_v_out_102061", "102061009", "story_v_out_102061.awb")

						arg_36_1:RecordAudio("102061009", var_39_7)
						arg_36_1:RecordAudio("102061009", var_39_7)
					else
	...
	Play102061010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			if arg_40_1.actors_["1011ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1011ui_story"))) then
				local var_43_0 = Object.Instantiate(Asset.Load("Char/" .. "1011ui_story"), arg_40_1.stage_.transform)

				var_43_0.name = "1011ui_story"
				var_43_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_40_1.actors_["1011ui_story"] = var_43_0
				...
				arg_40_1.var_["1011ui_story" .. "Animator"] = var_43_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_40_1.var_["1011ui_story" .. "Animator"].applyRootMotion = true
				arg_40_1.var_["1011ui_story" .. "LipSync"] = var_43_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_43_3 = arg_40_1.actors_["1011ui_story"]

			if 0 < arg_40_1.time_ and arg_40_1.time_ <= 0 + arg_43_0 and not isNil(var_43_3) and arg_40_1.var_.characterEffect1011ui_story == nil then
				arg_40_1.var_.characterEffect1011ui_story = var_43_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_43_4 = 0.1

			if 0 <= arg_40_1.time_ and arg_40_1.time_ < 0 + var_43_4 and not isNil(var_43_3) then
				if arg_40_1.var_.characterEffect1011ui_story and not isNil(var_43_3) then
					arg_40_1.var_.characterEffect1011ui_story.fillFlat = false
				end
			end

			if arg_40_1.time_ >= 0 + var_43_4 and arg_40_1.time_ < 0 + var_43_4 + arg_43_0 and not isNil(var_43_3) and arg_40_1.var_.characterEffect1011ui_story then
				arg_40_1.var_.characterEffect1011ui_story.fillFlat = false
			end

			local var_43_6 = arg_40_1.actors_["1019ui_story"]

			if 0 < arg_40_1.time_ and arg_40_1.time_ <= 0 + arg_43_0 and not isNil(var_43_6) and arg_40_1.var_.characterEffect1019ui_story == nil then
				arg_40_1.var_.characterEffect1019ui_story = var_43_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_43_7 = 0.1

			if 0 <= arg_40_1.time_ and arg_40_1.time_ < 0 + var_43_7 and not isNil(var_43_6) then
				if arg_40_1.var_.characterEffect1019ui_story and not isNil(var_43_6) then
					arg_40_1.var_.characterEffect1019ui_story.fillFlat = true
					arg_40_1.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_40_1.time_ - 0) / var_43_7)
				end
			end

			if arg_40_1.time_ >= 0 + var_43_7 and arg_40_1.time_ < 0 + var_43_7 + arg_43_0 and not isNil(var_43_6) and arg_40_1.var_.characterEffect1019ui_story then
				arg_40_1.var_.characterEffect1019ui_story.fillFlat = true
				arg_40_1.var_.characterEffect1019ui_story.fillRatio = 0.5
			end

			local var_43_8 = arg_40_1.actors_["1019ui_story"].transform

			if 0 < arg_40_1.time_ and arg_40_1.time_ <= 0 + arg_43_0 then
				arg_40_1.var_.moveOldPos1019ui_story = var_43_8.localPosition
			end

			local var_43_9 = 0.001

			if 0 <= arg_40_1.time_ and arg_40_1.time_ < 0 + var_43_9 then
				var_43_8.localPosition = Vector3.Lerp(arg_40_1.var_.moveOldPos1019ui_story, Vector3.New(0, 100, 0), (arg_40_1.time_ - 0) / var_43_9)
			...
			local var_43_10 = arg_40_1.actors_["1011ui_story"].transform

			if 0 < arg_40_1.time_ and arg_40_1.time_ <= 0 + arg_43_0 then
				arg_40_1.var_.moveOldPos1011ui_story = var_43_10.localPosition
			end

			local var_43_11 = 0.001

			if 0 <= arg_40_1.time_ and arg_40_1.time_ < 0 + var_43_11 then
				var_43_10.localPosition = Vector3.Lerp(arg_40_1.var_.moveOldPos1011ui_story, Vector3.New(-0.7, -0.71, -6), (arg_40_1.time_ - 0) / var_43_11)
			...
			if arg_40_1.time_ >= 0 + var_43_11 and arg_40_1.time_ < 0 + var_43_11 + arg_43_0 then
				var_43_10.localPosition = Vector3.New(-0.7, -0.71, -6)
				var_43_10.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_43_10.position).x, (manager.ui.mainCamera.transform.position - var_43_10.position).y, (manager.ui.mainCamera.transform.position - var_43_10.position).z)
				var_43_10.localEulerAngles.z = 0
				var_43_10.localEulerAngles.x = 0
				var_43_10.localEulerAngles = var_43_10.localEulerAngles
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_12 + arg_43_0 then
				...
				local var_43_14 = arg_40_1:GetWordFromCfg(102061010)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061010", "story_v_out_102061.awb") ~= 0 then
					local var_43_18 = manager.audio:GetVoiceLength("story_v_out_102061", "102061010", "story_v_out_102061.awb") / 1000
					...
					if var_43_14.prefab_name ~= "" and arg_40_1.actors_[var_43_14.prefab_name] ~= nil then
						local var_43_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_14.prefab_name].transform, "story_v_out_102061", "102061010", "story_v_out_102061.awb")

						arg_40_1:RecordAudio("102061010", var_43_19)
						arg_40_1:RecordAudio("102061010", var_43_19)
					else
	...
	Play102061011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			local var_47_6 = arg_44_1.actors_["1011ui_story"]

			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 and not isNil(var_47_6) and arg_44_1.var_.characterEffect1011ui_story == nil then
				arg_44_1.var_.characterEffect1011ui_story = var_47_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_47_7 = 0.1

			if 0 <= arg_44_1.time_ and arg_44_1.time_ < 0 + var_47_7 and not isNil(var_47_6) then
				if arg_44_1.var_.characterEffect1011ui_story and not isNil(var_47_6) then
					arg_44_1.var_.characterEffect1011ui_story.fillFlat = true
					arg_44_1.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_44_1.time_ - 0) / var_47_7)
				end
			end

			if arg_44_1.time_ >= 0 + var_47_7 and arg_44_1.time_ < 0 + var_47_7 + arg_47_0 and not isNil(var_47_6) and arg_44_1.var_.characterEffect1011ui_story then
				arg_44_1.var_.characterEffect1011ui_story.fillFlat = true
			...
			if 0 <= arg_44_1.time_ and arg_44_1.time_ < 0 + var_47_10 then
				var_47_8.localPosition = Vector3.Lerp(arg_44_1.var_.moveOldPos2020_tpose, Vector3.New(0.7, -1.2, -4.1), (arg_44_1.time_ - 0) / var_47_10)
			...
			if arg_44_1.time_ >= 0 + var_47_10 and arg_44_1.time_ < 0 + var_47_10 + arg_47_0 then
				var_47_8.localPosition = Vector3.New(0.7, -1.2, -4.1)
				var_47_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_47_8.position).x, (manager.ui.mainCamera.transform.position - var_47_8.position).y, (manager.ui.mainCamera.transform.position - var_47_8.position).z)
				var_47_8.localEulerAngles.z = 0
				var_47_8.localEulerAngles.x = 0
				var_47_8.localEulerAngles = var_47_8.localEulerAngles
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= var_47_12 + arg_47_0 then
				...
				local var_47_14 = arg_44_1:GetWordFromCfg(102061011)
				...
				local var_47_17 = 24 <= 0 and var_47_13 or var_47_13 * (utf8.len(var_47_15) / 24)

				if (24 <= 0 and var_47_13 or var_47_13 * (utf8.len(var_47_15) / 24)) > 0 and var_47_13 < var_47_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061011", "story_v_out_102061.awb") ~= 0 then
					local var_47_18 = manager.audio:GetVoiceLength("story_v_out_102061", "102061011", "story_v_out_102061.awb") / 1000
					...
					if var_47_14.prefab_name ~= "" and arg_44_1.actors_[var_47_14.prefab_name] ~= nil then
						local var_47_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_44_1.actors_[var_47_14.prefab_name].transform, "story_v_out_102061", "102061011", "story_v_out_102061.awb")

						arg_44_1:RecordAudio("102061011", var_47_19)
						arg_44_1:RecordAudio("102061011", var_47_19)
					else
	...
	Play102061012 = function(arg_48_0, arg_48_1)
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if 0 <= arg_48_1.time_ and arg_48_1.time_ < 0 + var_51_5 then
				var_51_4.localPosition = Vector3.Lerp(arg_48_1.var_.moveOldPos1011ui_story, Vector3.New(0, 100, 0), (arg_48_1.time_ - 0) / var_51_5)
			...
			local var_51_6 = arg_48_1.actors_["3008ui_story"].transform

			if 0 < arg_48_1.time_ and arg_48_1.time_ <= 0 + arg_51_0 then
				arg_48_1.var_.moveOldPos3008ui_story = var_51_6.localPosition
			end

			local var_51_7 = 0.001

			if 0 <= arg_48_1.time_ and arg_48_1.time_ < 0 + var_51_7 then
				var_51_6.localPosition = Vector3.Lerp(arg_48_1.var_.moveOldPos3008ui_story, Vector3.New(-0.7, -1.51, -4.3), (arg_48_1.time_ - 0) / var_51_7)
			...
			if arg_48_1.time_ >= 0 + var_51_7 and arg_48_1.time_ < 0 + var_51_7 + arg_51_0 then
				var_51_6.localPosition = Vector3.New(-0.7, -1.51, -4.3)
				var_51_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_51_6.position).x, (manager.ui.mainCamera.transform.position - var_51_6.position).y, (manager.ui.mainCamera.transform.position - var_51_6.position).z)
				var_51_6.localEulerAngles.z = 0
				var_51_6.localEulerAngles.x = 0
				var_51_6.localEulerAngles = var_51_6.localEulerAngles
			...
			if 0 < arg_48_1.time_ and arg_48_1.time_ <= var_51_8 + arg_51_0 then
				...
				local var_51_10 = arg_48_1:GetWordFromCfg(102061012)
				...
				local var_51_13 = 11 <= 0 and var_51_9 or var_51_9 * (utf8.len(var_51_11) / 11)

				if (11 <= 0 and var_51_9 or var_51_9 * (utf8.len(var_51_11) / 11)) > 0 and var_51_9 < var_51_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061012", "story_v_out_102061.awb") ~= 0 then
					local var_51_14 = manager.audio:GetVoiceLength("story_v_out_102061", "102061012", "story_v_out_102061.awb") / 1000
					...
					if var_51_10.prefab_name ~= "" and arg_48_1.actors_[var_51_10.prefab_name] ~= nil then
						local var_51_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_48_1.actors_[var_51_10.prefab_name].transform, "story_v_out_102061", "102061012", "story_v_out_102061.awb")

						arg_48_1:RecordAudio("102061012", var_51_15)
						arg_48_1:RecordAudio("102061012", var_51_15)
					else
	...
	Play102061013 = function(arg_52_0, arg_52_1)
		...
		function arg_52_1.onSingleLineUpdate_(arg_55_0)
			...
			local var_55_2 = arg_52_1.actors_["3008ui_story"]

			if 0 < arg_52_1.time_ and arg_52_1.time_ <= 0 + arg_55_0 and not isNil(var_55_2) and arg_52_1.var_.characterEffect3008ui_story == nil then
				arg_52_1.var_.characterEffect3008ui_story = var_55_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_55_3 = 0.1

			if 0 <= arg_52_1.time_ and arg_52_1.time_ < 0 + var_55_3 and not isNil(var_55_2) then
				if arg_52_1.var_.characterEffect3008ui_story and not isNil(var_55_2) then
					arg_52_1.var_.characterEffect3008ui_story.fillFlat = true
					arg_52_1.var_.characterEffect3008ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_52_1.time_ - 0) / var_55_3)
				end
			end

			if arg_52_1.time_ >= 0 + var_55_3 and arg_52_1.time_ < 0 + var_55_3 + arg_55_0 and not isNil(var_55_2) and arg_52_1.var_.characterEffect3008ui_story then
				arg_52_1.var_.characterEffect3008ui_story.fillFlat = true
			...
			if 0 < arg_52_1.time_ and arg_52_1.time_ <= var_55_4 + arg_55_0 then
				...
				arg_52_1.leftNameTxt_.text = arg_52_1:FormatText(StoryNameCfg[34].name)
				...
				local var_55_6 = arg_52_1:GetWordFromCfg(102061013)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061013", "story_v_out_102061.awb") ~= 0 then
					local var_55_10 = manager.audio:GetVoiceLength("story_v_out_102061", "102061013", "story_v_out_102061.awb") / 1000
					...
					if var_55_6.prefab_name ~= "" and arg_52_1.actors_[var_55_6.prefab_name] ~= nil then
						local var_55_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_52_1.actors_[var_55_6.prefab_name].transform, "story_v_out_102061", "102061013", "story_v_out_102061.awb")

						arg_52_1:RecordAudio("102061013", var_55_11)
						arg_52_1:RecordAudio("102061013", var_55_11)
					else
	...
	Play102061014 = function(arg_56_0, arg_56_1)
		...
		function arg_56_1.onSingleLineUpdate_(arg_59_0)
			...
			local var_59_4 = arg_56_1.actors_["2020_tpose"].transform

			if 0 < arg_56_1.time_ and arg_56_1.time_ <= 0 + arg_59_0 then
				arg_56_1.var_.moveOldPos2020_tpose = var_59_4.localPosition
			...
			if 0 <= arg_56_1.time_ and arg_56_1.time_ < 0 + var_59_6 then
				var_59_4.localPosition = Vector3.Lerp(arg_56_1.var_.moveOldPos2020_tpose, Vector3.New(0, 100, 0), (arg_56_1.time_ - 0) / var_59_6)
			...
			if 0 <= arg_56_1.time_ and arg_56_1.time_ < 0 + var_59_9 then
				var_59_8.localPosition = Vector3.Lerp(arg_56_1.var_.moveOldPos1011ui_story, Vector3.New(0.7, -0.71, -6), (arg_56_1.time_ - 0) / var_59_9)
			...
			if arg_56_1.time_ >= 0 + var_59_9 and arg_56_1.time_ < 0 + var_59_9 + arg_59_0 then
				var_59_8.localPosition = Vector3.New(0.7, -0.71, -6)
				var_59_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_59_8.position).x, (manager.ui.mainCamera.transform.position - var_59_8.position).y, (manager.ui.mainCamera.transform.position - var_59_8.position).z)
				var_59_8.localEulerAngles.z = 0
				var_59_8.localEulerAngles.x = 0
				var_59_8.localEulerAngles = var_59_8.localEulerAngles
			...
			if 0 < arg_56_1.time_ and arg_56_1.time_ <= var_59_10 + arg_59_0 then
				...
				local var_59_12 = arg_56_1:GetWordFromCfg(102061014)
				...
				local var_59_15 = 30 <= 0 and var_59_11 or var_59_11 * (utf8.len(var_59_13) / 30)

				if (30 <= 0 and var_59_11 or var_59_11 * (utf8.len(var_59_13) / 30)) > 0 and var_59_11 < var_59_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061014", "story_v_out_102061.awb") ~= 0 then
					local var_59_16 = manager.audio:GetVoiceLength("story_v_out_102061", "102061014", "story_v_out_102061.awb") / 1000
					...
					if var_59_12.prefab_name ~= "" and arg_56_1.actors_[var_59_12.prefab_name] ~= nil then
						local var_59_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_56_1.actors_[var_59_12.prefab_name].transform, "story_v_out_102061", "102061014", "story_v_out_102061.awb")

						arg_56_1:RecordAudio("102061014", var_59_17)
						arg_56_1:RecordAudio("102061014", var_59_17)
					else
	...
	Play102061015 = function(arg_60_0, arg_60_1)
		...
		function arg_60_1.onSingleLineUpdate_(arg_63_0)
			...
			local var_63_2 = arg_60_1.actors_["1011ui_story"]

			if 0 < arg_60_1.time_ and arg_60_1.time_ <= 0 + arg_63_0 and not isNil(var_63_2) and arg_60_1.var_.characterEffect1011ui_story == nil then
				arg_60_1.var_.characterEffect1011ui_story = var_63_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_63_3 = 0.1

			if 0 <= arg_60_1.time_ and arg_60_1.time_ < 0 + var_63_3 and not isNil(var_63_2) then
				if arg_60_1.var_.characterEffect1011ui_story and not isNil(var_63_2) then
					arg_60_1.var_.characterEffect1011ui_story.fillFlat = true
					arg_60_1.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_60_1.time_ - 0) / var_63_3)
				end
			end

			if arg_60_1.time_ >= 0 + var_63_3 and arg_60_1.time_ < 0 + var_63_3 + arg_63_0 and not isNil(var_63_2) and arg_60_1.var_.characterEffect1011ui_story then
				arg_60_1.var_.characterEffect1011ui_story.fillFlat = true
				arg_60_1.var_.characterEffect1011ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_60_1.time_ and arg_60_1.time_ <= var_63_4 + arg_63_0 then
				...
				local var_63_6 = arg_60_1:GetWordFromCfg(102061015)
				...
				local var_63_9 = 23 <= 0 and var_63_5 or var_63_5 * (utf8.len(var_63_7) / 23)

				if (23 <= 0 and var_63_5 or var_63_5 * (utf8.len(var_63_7) / 23)) > 0 and var_63_5 < var_63_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061015", "story_v_out_102061.awb") ~= 0 then
					local var_63_10 = manager.audio:GetVoiceLength("story_v_out_102061", "102061015", "story_v_out_102061.awb") / 1000
					...
					if var_63_6.prefab_name ~= "" and arg_60_1.actors_[var_63_6.prefab_name] ~= nil then
						local var_63_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_60_1.actors_[var_63_6.prefab_name].transform, "story_v_out_102061", "102061015", "story_v_out_102061.awb")

						arg_60_1:RecordAudio("102061015", var_63_11)
						arg_60_1:RecordAudio("102061015", var_63_11)
					else
	...
	Play102061016 = function(arg_64_0, arg_64_1)
		...
		function arg_64_1.onSingleLineUpdate_(arg_67_0)
			...
			if 0 <= arg_64_1.time_ and arg_64_1.time_ < 0 + var_67_5 then
				var_67_4.localPosition = Vector3.Lerp(arg_64_1.var_.moveOldPos1011ui_story, Vector3.New(0, 100, 0), (arg_64_1.time_ - 0) / var_67_5)
			...
			local var_67_6 = arg_64_1.actors_["1019ui_story"].transform

			if 0 < arg_64_1.time_ and arg_64_1.time_ <= 0 + arg_67_0 then
				arg_64_1.var_.moveOldPos1019ui_story = var_67_6.localPosition
			end

			local var_67_7 = 0.001

			if 0 <= arg_64_1.time_ and arg_64_1.time_ < 0 + var_67_7 then
				var_67_6.localPosition = Vector3.Lerp(arg_64_1.var_.moveOldPos1019ui_story, Vector3.New(0.7, -1.08, -5.9), (arg_64_1.time_ - 0) / var_67_7)
			...
			if arg_64_1.time_ >= 0 + var_67_7 and arg_64_1.time_ < 0 + var_67_7 + arg_67_0 then
				var_67_6.localPosition = Vector3.New(0.7, -1.08, -5.9)
				var_67_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_67_6.position).x, (manager.ui.mainCamera.transform.position - var_67_6.position).y, (manager.ui.mainCamera.transform.position - var_67_6.position).z)
				var_67_6.localEulerAngles.z = 0
				var_67_6.localEulerAngles.x = 0
				var_67_6.localEulerAngles = var_67_6.localEulerAngles
			...
			if 0 < arg_64_1.time_ and arg_64_1.time_ <= var_67_8 + arg_67_0 then
				...
				local var_67_10 = arg_64_1:GetWordFromCfg(102061016)
				...
				local var_67_13 = 22 <= 0 and var_67_9 or var_67_9 * (utf8.len(var_67_11) / 22)

				if (22 <= 0 and var_67_9 or var_67_9 * (utf8.len(var_67_11) / 22)) > 0 and var_67_9 < var_67_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061016", "story_v_out_102061.awb") ~= 0 then
					local var_67_14 = manager.audio:GetVoiceLength("story_v_out_102061", "102061016", "story_v_out_102061.awb") / 1000
					...
					if var_67_10.prefab_name ~= "" and arg_64_1.actors_[var_67_10.prefab_name] ~= nil then
						local var_67_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_64_1.actors_[var_67_10.prefab_name].transform, "story_v_out_102061", "102061016", "story_v_out_102061.awb")

						arg_64_1:RecordAudio("102061016", var_67_15)
						arg_64_1:RecordAudio("102061016", var_67_15)
					else
	...
	Play102061017 = function(arg_68_0, arg_68_1)
		...
		function arg_68_1.onSingleLineUpdate_(arg_71_0)
			if 0 < arg_68_1.time_ and arg_68_1.time_ <= 0 + arg_71_0 and not isNil(arg_68_1.actors_["3008ui_story"]) and arg_68_1.var_.characterEffect3008ui_story == nil then
				arg_68_1.var_.characterEffect3008ui_story = arg_68_1.actors_["3008ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_71_0 = 0.1

			if 0 <= arg_68_1.time_ and arg_68_1.time_ < 0 + var_71_0 and not isNil(arg_68_1.actors_["3008ui_story"]) then
				if arg_68_1.var_.characterEffect3008ui_story and not isNil(arg_68_1.actors_["3008ui_story"]) then
					arg_68_1.var_.characterEffect3008ui_story.fillFlat = false
				end
			end

			if arg_68_1.time_ >= 0 + var_71_0 and arg_68_1.time_ < 0 + var_71_0 + arg_71_0 and not isNil(arg_68_1.actors_["3008ui_story"]) and arg_68_1.var_.characterEffect3008ui_story then
				arg_68_1.var_.characterEffect3008ui_story.fillFlat = false
			end

			local var_71_2 = arg_68_1.actors_["1019ui_story"].transform

			if 0 < arg_68_1.time_ and arg_68_1.time_ <= 0 + arg_71_0 then
				arg_68_1.var_.moveOldPos1019ui_story = var_71_2.localPosition
			end

			local var_71_3 = 0.001

			if 0 <= arg_68_1.time_ and arg_68_1.time_ < 0 + var_71_3 then
				var_71_2.localPosition = Vector3.Lerp(arg_68_1.var_.moveOldPos1019ui_story, Vector3.New(0, 100, 0), (arg_68_1.time_ - 0) / var_71_3)
			...
			if arg_68_1.time_ >= 0 + var_71_3 and arg_68_1.time_ < 0 + var_71_3 + arg_71_0 then
				var_71_2.localPosition = Vector3.New(0, 100, 0)
				var_71_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_71_2.position).x, (manager.ui.mainCamera.transform.position - var_71_2.position).y, (manager.ui.mainCamera.transform.position - var_71_2.position).z)
				var_71_2.localEulerAngles.z = 0
				var_71_2.localEulerAngles.x = 0
				var_71_2.localEulerAngles = var_71_2.localEulerAngles
			...
			local var_71_4 = arg_68_1.actors_["3008ui_story"].transform

			if 0 < arg_68_1.time_ and arg_68_1.time_ <= 0 + arg_71_0 then
				arg_68_1.var_.moveOldPos3008ui_story = var_71_4.localPosition
			end

			local var_71_5 = 0.5

			if 0 <= arg_68_1.time_ and arg_68_1.time_ < 0 + var_71_5 then
				var_71_4.localPosition = Vector3.Lerp(arg_68_1.var_.moveOldPos3008ui_story, Vector3.New(0, -1.51, -4.3), (arg_68_1.time_ - 0) / var_71_5)
			...
			if arg_68_1.time_ >= 0 + var_71_5 and arg_68_1.time_ < 0 + var_71_5 + arg_71_0 then
				var_71_4.localPosition = Vector3.New(0, -1.51, -4.3)
				var_71_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_71_4.position).x, (manager.ui.mainCamera.transform.position - var_71_4.position).y, (manager.ui.mainCamera.transform.position - var_71_4.position).z)
				var_71_4.localEulerAngles.z = 0
				var_71_4.localEulerAngles.x = 0
				var_71_4.localEulerAngles = var_71_4.localEulerAngles
			...
			if 0 < arg_68_1.time_ and arg_68_1.time_ <= var_71_6 + arg_71_0 then
				...
				local var_71_8 = arg_68_1:GetWordFromCfg(102061017)
				...
				local var_71_11 = 21 <= 0 and var_71_7 or var_71_7 * (utf8.len(var_71_9) / 21)

				if (21 <= 0 and var_71_7 or var_71_7 * (utf8.len(var_71_9) / 21)) > 0 and var_71_7 < var_71_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061017", "story_v_out_102061.awb") ~= 0 then
					local var_71_12 = manager.audio:GetVoiceLength("story_v_out_102061", "102061017", "story_v_out_102061.awb") / 1000
					...
					if var_71_8.prefab_name ~= "" and arg_68_1.actors_[var_71_8.prefab_name] ~= nil then
						local var_71_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_68_1.actors_[var_71_8.prefab_name].transform, "story_v_out_102061", "102061017", "story_v_out_102061.awb")

						arg_68_1:RecordAudio("102061017", var_71_13)
						arg_68_1:RecordAudio("102061017", var_71_13)
					else
		...
		function arg_72_1.onSingleLineUpdate_(arg_75_0)
			...
			if 0 <= arg_72_1.time_ and arg_72_1.time_ < 0 + var_75_0 and not isNil(arg_72_1.actors_["3008ui_story"]) then
				if arg_72_1.var_.characterEffect3008ui_story and not isNil(arg_72_1.actors_["3008ui_story"]) then
					...
					arg_72_1.var_.characterEffect3008ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_72_1.time_ - 0) / var_75_0)
				end
			end
			...
			if arg_72_1.time_ >= 0 + var_75_0 and arg_72_1.time_ < 0 + var_75_0 + arg_75_0 and not isNil(arg_72_1.actors_["3008ui_story"]) and arg_72_1.var_.characterEffect3008ui_story then
				arg_72_1.var_.characterEffect3008ui_story.fillFlat = true
				arg_72_1.var_.characterEffect3008ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_72_1.time_ and arg_72_1.time_ <= var_75_1 + arg_75_0 then
				...
				arg_72_1.leftNameTxt_.text = arg_72_1:FormatText(StoryNameCfg[34].name)
				...
				local var_75_3 = arg_72_1:GetWordFromCfg(102061018)
				...
				local var_75_6 = 23 <= 0 and var_75_2 or var_75_2 * (utf8.len(var_75_4) / 23)

				if (23 <= 0 and var_75_2 or var_75_2 * (utf8.len(var_75_4) / 23)) > 0 and var_75_2 < var_75_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061018", "story_v_out_102061.awb") ~= 0 then
					local var_75_7 = manager.audio:GetVoiceLength("story_v_out_102061", "102061018", "story_v_out_102061.awb") / 1000
					...
					if var_75_3.prefab_name ~= "" and arg_72_1.actors_[var_75_3.prefab_name] ~= nil then
						local var_75_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_72_1.actors_[var_75_3.prefab_name].transform, "story_v_out_102061", "102061018", "story_v_out_102061.awb")

						arg_72_1:RecordAudio("102061018", var_75_8)
						arg_72_1:RecordAudio("102061018", var_75_8)
					else
	...
	Play102061019 = function(arg_76_0, arg_76_1)
		...
		function arg_76_1.onSingleLineUpdate_(arg_79_0)
			if 0 < arg_76_1.time_ and arg_76_1.time_ <= 0 + arg_79_0 and not isNil(arg_76_1.actors_["3008ui_story"]) and arg_76_1.var_.characterEffect3008ui_story == nil then
				arg_76_1.var_.characterEffect3008ui_story = arg_76_1.actors_["3008ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_79_0 = 0.1

			if 0 <= arg_76_1.time_ and arg_76_1.time_ < 0 + var_79_0 and not isNil(arg_76_1.actors_["3008ui_story"]) then
				if arg_76_1.var_.characterEffect3008ui_story and not isNil(arg_76_1.actors_["3008ui_story"]) then
					arg_76_1.var_.characterEffect3008ui_story.fillFlat = false
				end
			end

			if arg_76_1.time_ >= 0 + var_79_0 and arg_76_1.time_ < 0 + var_79_0 + arg_79_0 and not isNil(arg_76_1.actors_["3008ui_story"]) and arg_76_1.var_.characterEffect3008ui_story then
				arg_76_1.var_.characterEffect3008ui_story.fillFlat = false
			end
			...
			if 0 < arg_76_1.time_ and arg_76_1.time_ <= var_79_2 + arg_79_0 then
				...
				local var_79_4 = arg_76_1:GetWordFromCfg(102061019)
				...
				local var_79_7 = 11 <= 0 and var_79_3 or var_79_3 * (utf8.len(var_79_5) / 11)

				if (11 <= 0 and var_79_3 or var_79_3 * (utf8.len(var_79_5) / 11)) > 0 and var_79_3 < var_79_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061019", "story_v_out_102061.awb") ~= 0 then
					local var_79_8 = manager.audio:GetVoiceLength("story_v_out_102061", "102061019", "story_v_out_102061.awb") / 1000
					...
					if var_79_4.prefab_name ~= "" and arg_76_1.actors_[var_79_4.prefab_name] ~= nil then
						local var_79_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_76_1.actors_[var_79_4.prefab_name].transform, "story_v_out_102061", "102061019", "story_v_out_102061.awb")

						arg_76_1:RecordAudio("102061019", var_79_9)
						arg_76_1:RecordAudio("102061019", var_79_9)
					else
	...
	Play102061020 = function(arg_80_0, arg_80_1)
		...
		function arg_80_1.onSingleLineUpdate_(arg_83_0)
			...
			if 0 < arg_80_1.time_ and arg_80_1.time_ <= var_83_0 + arg_83_0 then
				...
				local var_83_2 = arg_80_1:GetWordFromCfg(102061020)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061020", "story_v_out_102061.awb") ~= 0 then
					local var_83_6 = manager.audio:GetVoiceLength("story_v_out_102061", "102061020", "story_v_out_102061.awb") / 1000
					...
					if var_83_2.prefab_name ~= "" and arg_80_1.actors_[var_83_2.prefab_name] ~= nil then
						local var_83_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_80_1.actors_[var_83_2.prefab_name].transform, "story_v_out_102061", "102061020", "story_v_out_102061.awb")

						arg_80_1:RecordAudio("102061020", var_83_7)
						arg_80_1:RecordAudio("102061020", var_83_7)
					else
	...
	Play102061021 = function(arg_84_0, arg_84_1)
		...
		function arg_84_1.onSingleLineUpdate_(arg_87_0)
			...
			local var_87_4 = arg_84_1.actors_["3008ui_story"].transform

			if 0 < arg_84_1.time_ and arg_84_1.time_ <= 0 + arg_87_0 then
				arg_84_1.var_.moveOldPos3008ui_story = var_87_4.localPosition
			end

			local var_87_5 = 0.001

			if 0 <= arg_84_1.time_ and arg_84_1.time_ < 0 + var_87_5 then
				var_87_4.localPosition = Vector3.Lerp(arg_84_1.var_.moveOldPos3008ui_story, Vector3.New(0, 100, 0), (arg_84_1.time_ - 0) / var_87_5)
			...
			local var_87_6 = arg_84_1.actors_["1011ui_story"].transform

			if 0 < arg_84_1.time_ and arg_84_1.time_ <= 0 + arg_87_0 then
				arg_84_1.var_.moveOldPos1011ui_story = var_87_6.localPosition
			end

			local var_87_7 = 0.001

			if 0 <= arg_84_1.time_ and arg_84_1.time_ < 0 + var_87_7 then
				var_87_6.localPosition = Vector3.Lerp(arg_84_1.var_.moveOldPos1011ui_story, Vector3.New(0, -0.71, -6), (arg_84_1.time_ - 0) / var_87_7)
			...
			if arg_84_1.time_ >= 0 + var_87_7 and arg_84_1.time_ < 0 + var_87_7 + arg_87_0 then
				var_87_6.localPosition = Vector3.New(0, -0.71, -6)
				var_87_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_87_6.position).x, (manager.ui.mainCamera.transform.position - var_87_6.position).y, (manager.ui.mainCamera.transform.position - var_87_6.position).z)
				var_87_6.localEulerAngles.z = 0
				var_87_6.localEulerAngles.x = 0
				var_87_6.localEulerAngles = var_87_6.localEulerAngles
			...
			if 0 < arg_84_1.time_ and arg_84_1.time_ <= var_87_8 + arg_87_0 then
				...
				local var_87_10 = arg_84_1:GetWordFromCfg(102061021)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061021", "story_v_out_102061.awb") ~= 0 then
					local var_87_14 = manager.audio:GetVoiceLength("story_v_out_102061", "102061021", "story_v_out_102061.awb") / 1000
					...
					if var_87_10.prefab_name ~= "" and arg_84_1.actors_[var_87_10.prefab_name] ~= nil then
						local var_87_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_84_1.actors_[var_87_10.prefab_name].transform, "story_v_out_102061", "102061021", "story_v_out_102061.awb")

						arg_84_1:RecordAudio("102061021", var_87_15)
						arg_84_1:RecordAudio("102061021", var_87_15)
					else
