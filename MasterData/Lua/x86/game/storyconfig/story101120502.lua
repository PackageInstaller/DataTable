	...
	Play112052001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 then
				...
				local var_4_16 = manager.audio:GetAudioName("bgm_activity_1_2_summer1_story_intense", "bgm_activity_1_2_summer1_story_intense")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_17 + arg_4_0 then
				...
				local var_4_20 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(112052001).content)

				arg_1_1.text_.text = var_4_20

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_22 = 52 <= 0 and var_4_18 or var_4_18 * (utf8.len(var_4_20) / 52)

				if (52 <= 0 and var_4_18 or var_4_18 * (utf8.len(var_4_20) / 52)) > 0 and var_4_18 < var_4_22 then
	...
	Play112052002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_8 + arg_11_0 then
				...
				local var_11_10 = arg_8_1:GetWordFromCfg(112052002)
				...
				local var_11_13 = 22 <= 0 and var_11_9 or var_11_9 * (utf8.len(var_11_11) / 22)

				if (22 <= 0 and var_11_9 or var_11_9 * (utf8.len(var_11_11) / 22)) > 0 and var_11_9 < var_11_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_112052", "112052002", "story_v_out_112052.awb") ~= 0 then
					local var_11_14 = manager.audio:GetVoiceLength("story_v_out_112052", "112052002", "story_v_out_112052.awb") / 1000
					...
					if var_11_10.prefab_name ~= "" and arg_8_1.actors_[var_11_10.prefab_name] ~= nil then
						local var_11_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_10.prefab_name].transform, "story_v_out_112052", "112052002", "story_v_out_112052.awb")

						arg_8_1:RecordAudio("112052002", var_11_15)
						arg_8_1:RecordAudio("112052002", var_11_15)
					else
	...
	Play112052003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 then
				arg_12_1.var_.moveOldPos1027ui_story = arg_12_1.actors_["1027ui_story"].transform.localPosition
			end

			local var_15_0 = 0.001

			if 0 <= arg_12_1.time_ and arg_12_1.time_ < 0 + var_15_0 then
				arg_12_1.actors_["1027ui_story"].transform.localPosition = Vector3.Lerp(arg_12_1.var_.moveOldPos1027ui_story, Vector3.New(0, 100, 0), (arg_12_1.time_ - 0) / var_15_0)
				arg_12_1.actors_["1027ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_12_1.actors_["1027ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_12_1.actors_["1027ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_12_1.actors_["1027ui_story"].transform.position).z)
				arg_12_1.actors_["1027ui_story"].transform.localEulerAngles.z = 0
				arg_12_1.actors_["1027ui_story"].transform.localEulerAngles.x = 0
				arg_12_1.actors_["1027ui_story"].transform.localEulerAngles = arg_12_1.actors_["1027ui_story"].transform.localEulerAngles
			end

			if arg_12_1.time_ >= 0 + var_15_0 and arg_12_1.time_ < 0 + var_15_0 + arg_15_0 then
				arg_12_1.actors_["1027ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_12_1.actors_["1027ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_12_1.actors_["1027ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_12_1.actors_["1027ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_12_1.actors_["1027ui_story"].transform.position).z)
				arg_12_1.actors_["1027ui_story"].transform.localEulerAngles.z = 0
				arg_12_1.actors_["1027ui_story"].transform.localEulerAngles.x = 0
				arg_12_1.actors_["1027ui_story"].transform.localEulerAngles = arg_12_1.actors_["1027ui_story"].transform.localEulerAngles
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 then
				arg_12_1:AudioAction("play", "effect", "se_story", "se_story_quake", "")
			end
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_6 + arg_15_0 then
				...
				local var_15_8 = arg_12_1:FormatText(arg_12_1:GetWordFromCfg(112052003).content)

				arg_12_1.text_.text = var_15_8

				LuaForUtil.ClearLinePrefixSymbol(arg_12_1.text_)

				local var_15_10 = 48 <= 0 and var_15_7 or var_15_7 * (utf8.len(var_15_8) / 48)

				if (48 <= 0 and var_15_7 or var_15_7 * (utf8.len(var_15_8) / 48)) > 0 and var_15_7 < var_15_10 then
	...
	Play112052004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 then
				...
				local var_19_1 = arg_16_1:FormatText(arg_16_1:GetWordFromCfg(112052004).content)
	...
	Play112052005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 then
				arg_20_1.var_.moveOldPos1027ui_story = arg_20_1.actors_["1027ui_story"].transform.localPosition
			end

			local var_23_0 = 0.001

			if 0 <= arg_20_1.time_ and arg_20_1.time_ < 0 + var_23_0 then
				arg_20_1.actors_["1027ui_story"].transform.localPosition = Vector3.Lerp(arg_20_1.var_.moveOldPos1027ui_story, Vector3.New(0, -0.81, -5.8), (arg_20_1.time_ - 0) / var_23_0)
				arg_20_1.actors_["1027ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_20_1.actors_["1027ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_20_1.actors_["1027ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_20_1.actors_["1027ui_story"].transform.position).z)
				arg_20_1.actors_["1027ui_story"].transform.localEulerAngles.z = 0
				arg_20_1.actors_["1027ui_story"].transform.localEulerAngles.x = 0
				arg_20_1.actors_["1027ui_story"].transform.localEulerAngles = arg_20_1.actors_["1027ui_story"].transform.localEulerAngles
			end

			if arg_20_1.time_ >= 0 + var_23_0 and arg_20_1.time_ < 0 + var_23_0 + arg_23_0 then
				arg_20_1.actors_["1027ui_story"].transform.localPosition = Vector3.New(0, -0.81, -5.8)
				arg_20_1.actors_["1027ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_20_1.actors_["1027ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_20_1.actors_["1027ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_20_1.actors_["1027ui_story"].transform.position).z)
				arg_20_1.actors_["1027ui_story"].transform.localEulerAngles.z = 0
				arg_20_1.actors_["1027ui_story"].transform.localEulerAngles.x = 0
				arg_20_1.actors_["1027ui_story"].transform.localEulerAngles = arg_20_1.actors_["1027ui_story"].transform.localEulerAngles
			...
			local var_23_1 = arg_20_1.actors_["1027ui_story"]

			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 and not isNil(var_23_1) and arg_20_1.var_.characterEffect1027ui_story == nil then
				arg_20_1.var_.characterEffect1027ui_story = var_23_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_23_2 = 0.2

			if 0 <= arg_20_1.time_ and arg_20_1.time_ < 0 + var_23_2 and not isNil(var_23_1) then
				if arg_20_1.var_.characterEffect1027ui_story and not isNil(var_23_1) then
					arg_20_1.var_.characterEffect1027ui_story.fillFlat = false
				end
			end

			if arg_20_1.time_ >= 0 + var_23_2 and arg_20_1.time_ < 0 + var_23_2 + arg_23_0 and not isNil(var_23_1) and arg_20_1.var_.characterEffect1027ui_story then
				arg_20_1.var_.characterEffect1027ui_story.fillFlat = false
			end
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_4 + arg_23_0 then
				...
				local var_23_6 = arg_20_1:GetWordFromCfg(112052005)
				...
				local var_23_9 = 14 <= 0 and var_23_5 or var_23_5 * (utf8.len(var_23_7) / 14)

				if (14 <= 0 and var_23_5 or var_23_5 * (utf8.len(var_23_7) / 14)) > 0 and var_23_5 < var_23_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_112052", "112052005", "story_v_out_112052.awb") ~= 0 then
					local var_23_10 = manager.audio:GetVoiceLength("story_v_out_112052", "112052005", "story_v_out_112052.awb") / 1000
					...
					if var_23_6.prefab_name ~= "" and arg_20_1.actors_[var_23_6.prefab_name] ~= nil then
						local var_23_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_20_1.actors_[var_23_6.prefab_name].transform, "story_v_out_112052", "112052005", "story_v_out_112052.awb")

						arg_20_1:RecordAudio("112052005", var_23_11)
						arg_20_1:RecordAudio("112052005", var_23_11)
					else
	...
	Play112052006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_0 + arg_27_0 then
				...
				local var_27_2 = arg_24_1:GetWordFromCfg(112052006)
				...
				local var_27_5 = 8 <= 0 and var_27_1 or var_27_1 * (utf8.len(var_27_3) / 8)

				if (8 <= 0 and var_27_1 or var_27_1 * (utf8.len(var_27_3) / 8)) > 0 and var_27_1 < var_27_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_112052", "112052006", "story_v_out_112052.awb") ~= 0 then
					local var_27_6 = manager.audio:GetVoiceLength("story_v_out_112052", "112052006", "story_v_out_112052.awb") / 1000
					...
					if var_27_2.prefab_name ~= "" and arg_24_1.actors_[var_27_2.prefab_name] ~= nil then
						local var_27_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_24_1.actors_[var_27_2.prefab_name].transform, "story_v_out_112052", "112052006", "story_v_out_112052.awb")

						arg_24_1:RecordAudio("112052006", var_27_7)
						arg_24_1:RecordAudio("112052006", var_27_7)
					else
	...
	Play112052007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_0 + arg_31_0 then
				...
				local var_31_2 = arg_28_1:GetWordFromCfg(112052007)
				...
				local var_31_5 = 25 <= 0 and var_31_1 or var_31_1 * (utf8.len(var_31_3) / 25)

				if (25 <= 0 and var_31_1 or var_31_1 * (utf8.len(var_31_3) / 25)) > 0 and var_31_1 < var_31_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_112052", "112052007", "story_v_out_112052.awb") ~= 0 then
					local var_31_6 = manager.audio:GetVoiceLength("story_v_out_112052", "112052007", "story_v_out_112052.awb") / 1000
					...
					if var_31_2.prefab_name ~= "" and arg_28_1.actors_[var_31_2.prefab_name] ~= nil then
						local var_31_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_2.prefab_name].transform, "story_v_out_112052", "112052007", "story_v_out_112052.awb")

						arg_28_1:RecordAudio("112052007", var_31_7)
						arg_28_1:RecordAudio("112052007", var_31_7)
					else
	...
	Play112052008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_1 + arg_35_0 then
				...
				local var_35_3 = arg_32_1:FormatText(arg_32_1:GetWordFromCfg(112052008).content)
