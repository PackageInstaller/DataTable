return {
	Play937061001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 then
				...
				local var_4_18 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(937061001).content)
	...
	Play937061002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_10 + arg_12_0 then
				...
				local var_12_12 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(937061002).content)
	...
	Play937061003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_1 + arg_16_0 then
				...
				local var_16_3 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(937061003).content)
	...
	Play937061004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(937061004).content)
	...
	Play937061005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_1 then
				arg_21_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1053ui_story, Vector3.New(0, 100, 0), (arg_21_1.time_ - 0) / var_24_1)
			...
			if arg_21_1.time_ >= 0 + var_24_1 and arg_21_1.time_ < 0 + var_24_1 + arg_24_0 then
				arg_21_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_21_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_21_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1053ui_story"].transform.position).z)
				arg_21_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_21_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_21_1.actors_["1053ui_story"].transform.localEulerAngles = arg_21_1.actors_["1053ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_4 and not isNil(var_24_3) then
				if arg_21_1.var_.characterEffect1053ui_story and not isNil(var_24_3) then
					...
					arg_21_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_21_1.time_ - 0) / var_24_4)
				end
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_5 + arg_24_0 then
				...
				local var_24_7 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(937061005).content)
	...
	Play937061006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_1 then
				arg_25_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos1053ui_story, Vector3.New(0, -1.08, -6), (arg_25_1.time_ - 0) / var_28_1)
			...
			if arg_25_1.time_ >= 0 + var_28_1 and arg_25_1.time_ < 0 + var_28_1 + arg_28_0 then
				arg_25_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, -1.08, -6)
				arg_25_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_25_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_25_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_25_1.actors_["1053ui_story"].transform.position).z)
				arg_25_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_25_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_25_1.actors_["1053ui_story"].transform.localEulerAngles = arg_25_1.actors_["1053ui_story"].transform.localEulerAngles
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_6 + arg_28_0 then
				...
				local var_28_8 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(937061006).content)

				arg_25_1.text_.text = var_28_8

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_10 = 9 <= 0 and var_28_7 or var_28_7 * (utf8.len(var_28_8) / 9)

				if (9 <= 0 and var_28_7 or var_28_7 * (utf8.len(var_28_8) / 9)) > 0 and var_28_7 < var_28_10 then
	...
	Play937061007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(937061007).content)
	...
	Play937061008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_2 + arg_36_0 then
				...
				local var_36_4 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(937061008).content)

				arg_33_1.text_.text = var_36_4

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_6 = 19 <= 0 and var_36_3 or var_36_3 * (utf8.len(var_36_4) / 19)

				if (19 <= 0 and var_36_3 or var_36_3 * (utf8.len(var_36_4) / 19)) > 0 and var_36_3 < var_36_6 then
	...
	Play937061009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_1 + arg_40_0 then
				...
				local var_40_3 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(937061009).content)
	...
	Play937061010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_2 + arg_44_0 then
				...
				local var_44_4 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(937061010).content)

				arg_41_1.text_.text = var_44_4

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_6 = 5 <= 0 and var_44_3 or var_44_3 * (utf8.len(var_44_4) / 5)

				if (5 <= 0 and var_44_3 or var_44_3 * (utf8.len(var_44_4) / 5)) > 0 and var_44_3 < var_44_6 then
	...
	Play937061011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				local var_48_1 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(937061011).content)
	...
	Play937061012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_0 + arg_52_0 then
				...
				local var_52_2 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(937061012).content)

				arg_49_1.text_.text = var_52_2

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_4 = 51 <= 0 and var_52_1 or var_52_1 * (utf8.len(var_52_2) / 51)

				if (51 <= 0 and var_52_1 or var_52_1 * (utf8.len(var_52_2) / 51)) > 0 and var_52_1 < var_52_4 then
	...
	Play937061013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_1 + arg_56_0 then
				...
				local var_56_3 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(937061013).content)
	...
	Play937061014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_2 + arg_60_0 then
				...
				local var_60_4 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(937061014).content)
	...
	Play937061015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_1 + arg_64_0 then
				...
				local var_64_3 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(937061015).content)
	...
	Play937061016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_3 + arg_68_0 then
				...
				local var_68_5 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(937061016).content)
	...
	Play937061017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_6 + arg_72_0 then
				...
				local var_72_8 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(937061017).content)
	...
	Play937061018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_1 + arg_76_0 then
				...
				local var_76_3 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(937061018).content)
	...
	Play937061019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			local var_80_3 = arg_77_1.actors_["1053ui_story"]

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 and not isNil(var_80_3) and arg_77_1.var_.characterEffect1053ui_story == nil then
				arg_77_1.var_.characterEffect1053ui_story = var_80_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_80_4 = 0.200000002980232

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_4 and not isNil(var_80_3) then
				if arg_77_1.var_.characterEffect1053ui_story and not isNil(var_80_3) then
					arg_77_1.var_.characterEffect1053ui_story.fillFlat = false
				end
			end

			if arg_77_1.time_ >= 0 + var_80_4 and arg_77_1.time_ < 0 + var_80_4 + arg_80_0 and not isNil(var_80_3) and arg_77_1.var_.characterEffect1053ui_story then
				arg_77_1.var_.characterEffect1053ui_story.fillFlat = false
			end
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_6 + arg_80_0 then
				...
				local var_80_8 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(937061019).content)

				arg_77_1.text_.text = var_80_8

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_10 = 12 <= 0 and var_80_7 or var_80_7 * (utf8.len(var_80_8) / 12)

				if (12 <= 0 and var_80_7 or var_80_7 * (utf8.len(var_80_8) / 12)) > 0 and var_80_7 < var_80_10 then
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 <= arg_81_1.time_ and arg_81_1.time_ < 0 + var_84_0 and not isNil(arg_81_1.actors_["1053ui_story"]) then
				if arg_81_1.var_.characterEffect1053ui_story and not isNil(arg_81_1.actors_["1053ui_story"]) then
					...
					arg_81_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_81_1.time_ - 0) / var_84_0)
				end
			end
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= var_84_1 + arg_84_0 then
				...
				local var_84_3 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(937061020).content)
	...
	Play937061021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= var_88_3 + arg_88_0 then
				...
				local var_88_5 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(937061021).content)
	...
	Play937061022 = function(arg_89_0, arg_89_1)
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			...
			if 0 <= arg_89_1.time_ and arg_89_1.time_ < 0 + var_92_1 then
				arg_89_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_89_1.var_.moveOldPos1053ui_story, Vector3.New(0, -1.08, -6), (arg_89_1.time_ - 0) / var_92_1)
			...
			if arg_89_1.time_ >= 0 + var_92_1 and arg_89_1.time_ < 0 + var_92_1 + arg_92_0 then
				arg_89_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, -1.08, -6)
				arg_89_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_89_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_89_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_89_1.actors_["1053ui_story"].transform.position).z)
				arg_89_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_89_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_89_1.actors_["1053ui_story"].transform.localEulerAngles = arg_89_1.actors_["1053ui_story"].transform.localEulerAngles
			...
			if 0 < arg_89_1.time_ and arg_89_1.time_ <= var_92_6 + arg_92_0 then
				...
				local var_92_8 = arg_89_1:FormatText(arg_89_1:GetWordFromCfg(937061022).content)

				arg_89_1.text_.text = var_92_8

				LuaForUtil.ClearLinePrefixSymbol(arg_89_1.text_)

				local var_92_10 = 15 <= 0 and var_92_7 or var_92_7 * (utf8.len(var_92_8) / 15)

				if (15 <= 0 and var_92_7 or var_92_7 * (utf8.len(var_92_8) / 15)) > 0 and var_92_7 < var_92_10 then
