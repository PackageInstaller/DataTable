	...
	Play416092030 = function(arg_123_0, arg_123_1)
		...
		function arg_123_1.onSingleLineUpdate_(arg_126_0)
			if 0 < arg_123_1.time_ and arg_123_1.time_ <= 0 + arg_126_0 then
				...
				local var_126_3 = var_126_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_126_0, iter_126_1 in ipairs((var_126_3:ToTable())) do
					iter_126_1.transform.localScale = Vector3.New(iter_126_1.transform.localScale.x / var_126_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_126_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_126_1.transform.localScale.y / var_126_2, iter_126_1.transform.localScale.z)
				end
			end
			...
			local var_126_14 = arg_123_1.actors_["10123"].transform

			if 0 < arg_123_1.time_ and arg_123_1.time_ <= 0 + arg_126_0 then
				arg_123_1.var_.moveOldPos10123 = var_126_14.localPosition
				var_126_14.localScale = Vector3.New(1, 1, 1)

				arg_123_1:CheckSpriteTmpPos("10123", 7)

				for iter_126_2 = 0, var_126_14.childCount - 1 do
					local var_126_15 = var_126_14:GetChild(iter_126_2)
			...
			if 0 <= arg_123_1.time_ and arg_123_1.time_ < 0 + var_126_16 then
				var_126_14.localPosition = Vector3.Lerp(arg_123_1.var_.moveOldPos10123, Vector3.New(0, -2000, 0), (arg_123_1.time_ - 0) / var_126_16)
			end

			if arg_123_1.time_ >= 0 + var_126_16 and arg_123_1.time_ < 0 + var_126_16 + arg_126_0 then
				var_126_14.localPosition = Vector3.New(0, -2000, 0)
			end
			...
			local var_126_17 = 0.666666666666667
			local var_126_18 = 1.2

			if 0.666666666666667 < arg_123_1.time_ and arg_123_1.time_ <= var_126_17 + arg_126_0 then
				...
				local var_126_19 = LeanTween.value(arg_123_1.dialog_, 0, 1, 0.3)

				var_126_19:setOnUpdate(LuaHelper.FloatAction(function(arg_127_0)
					arg_123_1.dialogCg_.alpha = arg_127_0
				end))
				var_126_19:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_123_1.dialog_)
					var_126_19:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_126_20 = arg_123_1:FormatText(arg_123_1:GetWordFromCfg(416092030).content)

				arg_123_1.text_.text = var_126_20

				LuaForUtil.ClearLinePrefixSymbol(arg_123_1.text_)

				local var_126_22 = 48 <= 0 and var_126_18 or var_126_18 * (utf8.len(var_126_20) / 48)

				if (48 <= 0 and var_126_18 or var_126_18 * (utf8.len(var_126_20) / 48)) > 0 and var_126_18 < var_126_22 then
					arg_123_1.talkMaxDuration = var_126_22
					var_126_17 = var_126_17 + 0.3

					if var_126_22 + var_126_17 > arg_123_1.duration_ then
						arg_123_1.duration_ = var_126_22 + var_126_17
					end
				end
			...
			local var_126_23 = var_126_17 + 0.3
			local var_126_24 = math.max(var_126_18, arg_123_1.talkMaxDuration)

			if var_126_17 + 0.3 <= arg_123_1.time_ and arg_123_1.time_ < var_126_23 + var_126_24 then
				arg_123_1.typewritter.percent = (arg_123_1.time_ - var_126_23) / var_126_24
