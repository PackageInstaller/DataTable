	...
	Play928011037 = function(arg_155_0, arg_155_1)
		...
		function arg_155_1.onSingleLineUpdate_(arg_158_0)
			...
			if 0 < arg_155_1.time_ and arg_155_1.time_ <= 0 + arg_158_0 then
				...
				local var_158_8 = var_158_5.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_158_0, iter_158_1 in ipairs((var_158_8:ToTable())) do
					iter_158_1.transform.localScale = Vector3.New(iter_158_1.transform.localScale.x / var_158_7 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_158_8 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_158_1.transform.localScale.y / var_158_7, iter_158_1.transform.localScale.z)
				end
			end
			...
			if arg_155_1.time_ >= var_158_10 + 0.8 and arg_155_1.time_ < var_158_10 + 0.8 + arg_158_0 then
			...
			local var_158_12 = 0.8
			local var_158_13 = 1.075

			if 0.8 < arg_155_1.time_ and arg_155_1.time_ <= var_158_12 + arg_158_0 then
				...
				local var_158_15 = arg_155_1:FormatText(arg_155_1:GetWordFromCfg(928011037).content)

				arg_155_1.text_.text = var_158_15

				LuaForUtil.ClearLinePrefixSymbol(arg_155_1.text_)

				local var_158_17 = 43 <= 0 and var_158_13 or var_158_13 * (utf8.len(var_158_15) / 43)

				if (43 <= 0 and var_158_13 or var_158_13 * (utf8.len(var_158_15) / 43)) > 0 and var_158_13 < var_158_17 then
	...
	Play928011051 = function(arg_218_0, arg_218_1)
		...
		function arg_218_1.onSingleLineUpdate_(arg_221_0)
			...
			if 0 < arg_218_1.time_ and arg_218_1.time_ <= 0 + arg_221_0 then
				...
				local var_221_4 = var_221_1.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_221_0, iter_221_1 in ipairs((var_221_4:ToTable())) do
					iter_221_1.transform.localScale = Vector3.New(iter_221_1.transform.localScale.x / var_221_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_221_4 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_221_1.transform.localScale.y / var_221_3, iter_221_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_218_1.time_ and arg_218_1.time_ <= var_221_6 + arg_221_0 then
				...
				local var_221_8 = arg_218_1:FormatText(arg_218_1:GetWordFromCfg(928011051).content)

				arg_218_1.text_.text = var_221_8

				LuaForUtil.ClearLinePrefixSymbol(arg_218_1.text_)

				local var_221_10 = 36 <= 0 and var_221_7 or var_221_7 * (utf8.len(var_221_8) / 36)

				if (36 <= 0 and var_221_7 or var_221_7 * (utf8.len(var_221_8) / 36)) > 0 and var_221_7 < var_221_10 then
	...
	Play928011052 = function(arg_222_0, arg_222_1)
		...
		function arg_222_1.onSingleLineUpdate_(arg_225_0)
			...
			if 0.833333333333333 < arg_222_1.time_ and arg_222_1.time_ <= 0.833333333333333 + arg_225_0 then
				...
				local var_225_10 = var_225_7.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_225_0, iter_225_1 in ipairs((var_225_10:ToTable())) do
					iter_225_1.transform.localScale = Vector3.New(iter_225_1.transform.localScale.x / var_225_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_225_10 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_225_1.transform.localScale.y / var_225_9, iter_225_1.transform.localScale.z)
				end
			end
			...
			local var_225_12 = 1.833333333332
			local var_225_13 = 1.3

			if 1.833333333332 < arg_222_1.time_ and arg_222_1.time_ <= var_225_12 + arg_225_0 then
				...
				local var_225_14 = LeanTween.value(arg_222_1.dialog_, 0, 1, 0.3)

				var_225_14:setOnUpdate(LuaHelper.FloatAction(function(arg_226_0)
					arg_222_1.dialogCg_.alpha = arg_226_0
				end))
				var_225_14:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_222_1.dialog_)
					var_225_14:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_225_15 = arg_222_1:FormatText(arg_222_1:GetWordFromCfg(928011052).content)

				arg_222_1.text_.text = var_225_15

				LuaForUtil.ClearLinePrefixSymbol(arg_222_1.text_)

				local var_225_17 = 52 <= 0 and var_225_13 or var_225_13 * (utf8.len(var_225_15) / 52)

				if (52 <= 0 and var_225_13 or var_225_13 * (utf8.len(var_225_15) / 52)) > 0 and var_225_13 < var_225_17 then
					arg_222_1.talkMaxDuration = var_225_17
					var_225_12 = var_225_12 + 0.3
			...
			local var_225_18 = var_225_12 + 0.3
			local var_225_19 = math.max(var_225_13, arg_222_1.talkMaxDuration)

			if var_225_12 + 0.3 <= arg_222_1.time_ and arg_222_1.time_ < var_225_18 + var_225_19 then
				arg_222_1.typewritter.percent = (arg_222_1.time_ - var_225_18) / var_225_19
	...
	Play928011056 = function(arg_240_0, arg_240_1)
		...
		function arg_240_1.onSingleLineUpdate_(arg_243_0)
			...
			if 0 < arg_240_1.time_ and arg_240_1.time_ <= 0 + arg_243_0 then
				...
				local var_243_22 = var_243_19.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_243_2, iter_243_3 in ipairs((var_243_22:ToTable())) do
					iter_243_3.transform.localScale = Vector3.New(iter_243_3.transform.localScale.x / var_243_21 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_243_22 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_243_3.transform.localScale.y / var_243_21, iter_243_3.transform.localScale.z)
				end
			end
			...
			if 0 < arg_240_1.time_ and arg_240_1.time_ <= 0 + arg_243_0 then
				local var_243_25 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_243_25 then
					var_243_25.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.Disabled
					var_243_25.radialBlurScale = 0
					var_243_25.radialBlurGradient = 1
					var_243_25.radialBlurIntensity = 1

					if var_243_24 then
						var_243_25.radialBlurTarget = var_243_24.transform
					end
				end
			end

			local var_243_26 = 1.48333333333333

			if 0 <= arg_240_1.time_ and arg_240_1.time_ < 0 + var_243_26 then
				...
				if var_243_27 then
					...
					var_243_27.radialBlurScale = Mathf.Lerp(0, 0.712, (arg_240_1.time_ - 0) / var_243_26)
					var_243_27.radialBlurGradient = Mathf.Lerp(1, 1, (arg_240_1.time_ - 0) / var_243_26)
					var_243_27.radialBlurIntensity = Mathf.Lerp(1, 1, (arg_240_1.time_ - 0) / var_243_26)
				end
			end

			if arg_240_1.time_ >= 0 + var_243_26 and arg_240_1.time_ < 0 + var_243_26 + arg_243_0 then
				local var_243_28 = manager.ui.mainCamera:GetComponent("CameraExtension")

				if var_243_28 then
					var_243_28.dofType = UnityEngine.Pipelines.SimPipeline.DepthOfFieldType.Disabled
					var_243_28.radialBlurScale = 0.712
					var_243_28.radialBlurGradient = 1
					var_243_28.radialBlurIntensity = 1
				end
			end
			...
			local var_243_29 = 2.3
			local var_243_30 = 0.075

			if 2.3 < arg_240_1.time_ and arg_240_1.time_ <= var_243_29 + arg_243_0 then
				...
				var_243_31:setOnUpdate(LuaHelper.FloatAction(function(arg_246_0)
				...
				local var_243_32 = arg_240_1:GetWordFromCfg(928011056)
				local var_243_33 = arg_240_1:FormatText(var_243_32.content)

				arg_240_1.text_.text = var_243_33

				LuaForUtil.ClearLinePrefixSymbol(arg_240_1.text_)

				local var_243_35 = 3 <= 0 and var_243_30 or var_243_30 * (utf8.len(var_243_33) / 3)

				if (3 <= 0 and var_243_30 or var_243_30 * (utf8.len(var_243_33) / 3)) > 0 and var_243_30 < var_243_35 then
					arg_240_1.talkMaxDuration = var_243_35
					var_243_29 = var_243_29 + 0.3

					if var_243_35 + var_243_29 > arg_240_1.duration_ then
						arg_240_1.duration_ = var_243_35 + var_243_29
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_side_old_928011", "928011056", "story_v_side_old_928011.awb") ~= 0 then
					local var_243_36 = manager.audio:GetVoiceLength("story_v_side_old_928011", "928011056", "story_v_side_old_928011.awb") / 1000

					if var_243_36 + var_243_29 > arg_240_1.duration_ then
						arg_240_1.duration_ = var_243_36 + var_243_29
					end

					if var_243_32.prefab_name ~= "" and arg_240_1.actors_[var_243_32.prefab_name] ~= nil then
						local var_243_37 = LuaForUtil.PlayVoiceWithCriLipsync(arg_240_1.actors_[var_243_32.prefab_name].transform, "story_v_side_old_928011", "928011056", "story_v_side_old_928011.awb")

						arg_240_1:RecordAudio("928011056", var_243_37)
						arg_240_1:RecordAudio("928011056", var_243_37)
					else
			...
			local var_243_38 = var_243_29 + 0.3
			local var_243_39 = math.max(var_243_30, arg_240_1.talkMaxDuration)

			if var_243_29 + 0.3 <= arg_240_1.time_ and arg_240_1.time_ < var_243_38 + var_243_39 then
