return {
	Play910101001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 910101001
		arg_1_1.duration_ = 6
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1 <= arg_1_1.time_ and arg_1_1.time_ < 1 + var_4_13 then
				var_4_11.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_1_1.time_ - 1) / var_4_13)
			end
			...
			if 1 < arg_1_1.time_ and arg_1_1.time_ <= 1 + arg_4_0 then
				local var_4_14 = arg_1_1.actors_["1070"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_14 then
					arg_1_1.var_.alphaOldValue1070 = var_4_14.alpha
					arg_1_1.var_.characterEffect1070 = var_4_14
				end

				arg_1_1.var_.alphaOldValue1070 = 0
			end

			local var_4_15 = 0.5

			if 1 <= arg_1_1.time_ and arg_1_1.time_ < 1 + var_4_15 then
				if arg_1_1.var_.characterEffect1070 then
					arg_1_1.var_.characterEffect1070.alpha = Mathf.Lerp(arg_1_1.var_.alphaOldValue1070, 1, (arg_1_1.time_ - 1) / var_4_15)
				end
			end

			if arg_1_1.time_ >= 1 + var_4_15 and arg_1_1.time_ < 1 + var_4_15 + arg_4_0 and arg_1_1.var_.characterEffect1070 then
				arg_1_1.var_.characterEffect1070.alpha = 1
			end
			...
			if 1 < arg_1_1.time_ and arg_1_1.time_ <= var_4_16 + arg_4_0 then
				...
				local var_4_19 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910101001).content)
	...
	Play910101002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 910101002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				for iter_10_0 = 0, arg_7_1.actors_["1070"].transform.childCount - 1 do
					...
					if var_10_0.name == "split_4" or not string.find(var_10_0.name, "split") then
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_2 + arg_10_0 then
				...
				local var_10_4 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910101002).content)

				arg_7_1.text_.text = var_10_4

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_6 = 46 <= 0 and var_10_3 or var_10_3 * (utf8.len(var_10_4) / 46)

				if (46 <= 0 and var_10_3 or var_10_3 * (utf8.len(var_10_4) / 46)) > 0 and var_10_3 < var_10_6 then
	...
	Play910101003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 910101003
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_2 + arg_14_0 then
				...
				local var_14_4 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910101003).content)
