	...
	Play910824001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910824001).content)
	...
	Play910824002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910824002).content)
	...
	Play910824003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_5 + arg_14_0 then
				...
				local var_14_7 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910824003).content)

				arg_11_1.text_.text = var_14_7

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_9 = 24 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 24)

				if (24 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 24)) > 0 and var_14_6 < var_14_9 then
	...
	Play910824004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_2 + arg_18_0 then
				...
				local var_18_4 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910824004).content)
	...
	Play910824005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910824005).content)

				arg_19_1.text_.text = var_22_1

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_3 = 10 <= 0 and var_22_0 or var_22_0 * (utf8.len(var_22_1) / 10)

				if (10 <= 0 and var_22_0 or var_22_0 * (utf8.len(var_22_1) / 10)) > 0 and var_22_0 < var_22_3 then
	...
	Play910824006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910824006).content)

				arg_23_1.text_.text = var_26_7

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_9 = 21 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 21)

				if (21 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 21)) > 0 and var_26_6 < var_26_9 then
	...
	Play910824007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_2 + arg_30_0 then
				...
				local var_30_4 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910824007).content)
	...
	Play910824008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910824008).content)
	...
	Play910824009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_2 + arg_38_0 then
				...
				local var_38_4 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910824009).content)

				arg_35_1.text_.text = var_38_4

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_6 = 49 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 49)

				if (49 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 49)) > 0 and var_38_3 < var_38_6 then
	...
	Play910824010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910824010).content)

				arg_39_1.text_.text = var_42_7

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_9 = 3 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 3)

				if (3 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 3)) > 0 and var_42_6 < var_42_9 then
	...
	Play910824011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_2 + arg_46_0 then
				...
				local var_46_4 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910824011).content)

				arg_43_1.text_.text = var_46_4

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_6 = 26 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 26)

				if (26 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 26)) > 0 and var_46_3 < var_46_6 then
	...
	Play910824012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 then
				...
				local var_50_1 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910824012).content)

				arg_47_1.text_.text = var_50_1

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_3 = 19 <= 0 and var_50_0 or var_50_0 * (utf8.len(var_50_1) / 19)

				if (19 <= 0 and var_50_0 or var_50_0 * (utf8.len(var_50_1) / 19)) > 0 and var_50_0 < var_50_3 then
	...
	Play910824013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_6 + arg_54_0 then
				...
				local var_54_8 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910824013).content)
