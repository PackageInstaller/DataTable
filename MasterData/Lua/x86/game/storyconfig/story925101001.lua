return {
	Play925101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_12 = arg_1_1.actors_["10022"]

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.actorSpriteComps10022 == nil then
				arg_1_1.var_.actorSpriteComps10022 = var_4_12:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_1_1.time_ >= 1.8 + var_4_13 and arg_1_1.time_ < 1.8 + var_4_13 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.actorSpriteComps10022 then
			...
			local var_4_15 = arg_1_1.actors_["10022"].transform

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1.var_.moveOldPos10022 = var_4_15.localPosition
			...
			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_17 then
				var_4_15.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos10022, Vector3.New(0, -340, -365), (arg_1_1.time_ - 1.8) / var_4_17)
			end

			if arg_1_1.time_ >= 1.8 + var_4_17 and arg_1_1.time_ < 1.8 + var_4_17 + arg_4_0 then
				var_4_15.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_26 + arg_4_0 then
				...
				local var_4_29 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(925101001).content)
	...
	Play925101002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(arg_9_1.actors_["10022"]) and arg_9_1.var_.actorSpriteComps10022 == nil then
				arg_9_1.var_.actorSpriteComps10022 = arg_9_1.actors_["10022"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_12_0 = 0.2

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_0 and not isNil(arg_9_1.actors_["10022"]) then
			...
			if arg_9_1.time_ >= 0 + var_12_0 and arg_9_1.time_ < 0 + var_12_0 + arg_12_0 and not isNil(arg_9_1.actors_["10022"]) and arg_9_1.var_.actorSpriteComps10022 then
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_2 + arg_12_0 then
				...
				local var_12_4 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(925101002).content)

				arg_9_1.text_.text = var_12_4

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_6 = 23 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 23)

				if (23 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 23)) > 0 and var_12_3 < var_12_6 then
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				for iter_16_4 = 0, var_16_2.childCount - 1 do
					...
					if var_16_3.name == "split_8" or not string.find(var_16_3.name, "split") then
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_4 then
				var_16_2.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos10022, Vector3.New(0, -340, -365), (arg_13_1.time_ - 0) / var_16_4)
			end

			if arg_13_1.time_ >= 0 + var_16_4 and arg_13_1.time_ < 0 + var_16_4 + arg_16_0 then
				var_16_2.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_5 + arg_16_0 then
				...
				local var_16_7 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(925101003).content)
	...
	Play925101004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(925101004).content)
	...
	Play925101005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_4 then
				var_24_2.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos10022, Vector3.New(0, -340, -365), (arg_21_1.time_ - 0) / var_24_4)
			end

			if arg_21_1.time_ >= 0 + var_24_4 and arg_21_1.time_ < 0 + var_24_4 + arg_24_0 then
				var_24_2.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_5 + arg_24_0 then
				...
				local var_24_7 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(925101005).content)

				arg_21_1.text_.text = var_24_7

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_9 = 26 <= 0 and var_24_6 or var_24_6 * (utf8.len(var_24_7) / 26)

				if (26 <= 0 and var_24_6 or var_24_6 * (utf8.len(var_24_7) / 26)) > 0 and var_24_6 < var_24_9 then
	...
	Play925101006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(925101006).content)
	...
	Play925101007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			local var_32_2 = arg_29_1.actors_["10022"].transform

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos10022 = var_32_2.localPosition
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_4 then
				var_32_2.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos10022, Vector3.New(0, -340, -365), (arg_29_1.time_ - 0) / var_32_4)
			end

			if arg_29_1.time_ >= 0 + var_32_4 and arg_29_1.time_ < 0 + var_32_4 + arg_32_0 then
				var_32_2.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_5 + arg_32_0 then
				...
				local var_32_7 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(925101007).content)

				arg_29_1.text_.text = var_32_7

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_9 = 26 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 26)

				if (26 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 26)) > 0 and var_32_6 < var_32_9 then
	...
	Play925101008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(925101008).content)
	...
	Play925101009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_2 + arg_40_0 then
				...
				local var_40_4 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(925101009).content)

				arg_37_1.text_.text = var_40_4

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_6 = 42 <= 0 and var_40_3 or var_40_3 * (utf8.len(var_40_4) / 42)

				if (42 <= 0 and var_40_3 or var_40_3 * (utf8.len(var_40_4) / 42)) > 0 and var_40_3 < var_40_6 then
	...
	Play925101010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_5 + arg_44_0 then
				...
				local var_44_7 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(925101010).content)

				arg_41_1.text_.text = var_44_7

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_9 = 59 <= 0 and var_44_6 or var_44_6 * (utf8.len(var_44_7) / 59)

				if (59 <= 0 and var_44_6 or var_44_6 * (utf8.len(var_44_7) / 59)) > 0 and var_44_6 < var_44_9 then
	...
	Play925101011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 then
				...
				local var_48_4 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(925101011).content)

				arg_45_1.text_.text = var_48_4

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_6 = 17 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 17)

				if (17 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 17)) > 0 and var_48_3 < var_48_6 then
	...
	Play925101012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			local var_52_2 = arg_49_1.actors_["10022"].transform

			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1.var_.moveOldPos10022 = var_52_2.localPosition
				...
				for iter_52_4 = 0, var_52_2.childCount - 1 do
					...
					if var_52_3.name == "split_8" or not string.find(var_52_3.name, "split") then
			...
			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_4 then
				var_52_2.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos10022, Vector3.New(0, -340, -365), (arg_49_1.time_ - 0) / var_52_4)
			end

			if arg_49_1.time_ >= 0 + var_52_4 and arg_49_1.time_ < 0 + var_52_4 + arg_52_0 then
				var_52_2.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_5 + arg_52_0 then
				...
				local var_52_7 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(925101012).content)

				arg_49_1.text_.text = var_52_7

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_9 = 16 <= 0 and var_52_6 or var_52_6 * (utf8.len(var_52_7) / 16)

				if (16 <= 0 and var_52_6 or var_52_6 * (utf8.len(var_52_7) / 16)) > 0 and var_52_6 < var_52_9 then
	...
	Play925101013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_2 + arg_56_0 then
				...
				local var_56_4 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(925101013).content)
	...
	Play925101014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_2 + arg_60_0 then
				...
				local var_60_4 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(925101014).content)

				arg_57_1.text_.text = var_60_4

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_6 = 41 <= 0 and var_60_3 or var_60_3 * (utf8.len(var_60_4) / 41)

				if (41 <= 0 and var_60_3 or var_60_3 * (utf8.len(var_60_4) / 41)) > 0 and var_60_3 < var_60_6 then
	...
	Play925101015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			local var_64_2 = arg_61_1.actors_["10022"].transform

			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				arg_61_1.var_.moveOldPos10022 = var_64_2.localPosition
			...
			if 0 <= arg_61_1.time_ and arg_61_1.time_ < 0 + var_64_4 then
				var_64_2.localPosition = Vector3.Lerp(arg_61_1.var_.moveOldPos10022, Vector3.New(0, -340, -365), (arg_61_1.time_ - 0) / var_64_4)
			end

			if arg_61_1.time_ >= 0 + var_64_4 and arg_61_1.time_ < 0 + var_64_4 + arg_64_0 then
				var_64_2.localPosition = Vector3.New(0, -340, -365)
			end

			local var_64_5 = 0
			local var_64_6 = 1.325
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_5 + arg_64_0 then
				...
				local var_64_7 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(925101015).content)

				arg_61_1.text_.text = var_64_7

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_9 = 53 <= 0 and var_64_6 or var_64_6 * (utf8.len(var_64_7) / 53)

				if (53 <= 0 and var_64_6 or var_64_6 * (utf8.len(var_64_7) / 53)) > 0 and var_64_6 < var_64_9 then
