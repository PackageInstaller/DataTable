return {
	Play111022001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_6 = "1048ui_story"

			if arg_1_1.actors_["1048ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1048ui_story"))) then
				local var_4_7 = Object.Instantiate(Asset.Load("Char/" .. "1048ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_10 = arg_1_1.actors_["1048ui_story"].transform

			if 1.5 < arg_1_1.time_ and arg_1_1.time_ <= 1.5 + arg_4_0 then
				arg_1_1.var_.moveOldPos1048ui_story = var_4_10.localPosition
			end

			local var_4_11 = 0.001

			if 1.5 <= arg_1_1.time_ and arg_1_1.time_ < 1.5 + var_4_11 then
				var_4_10.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1048ui_story, Vector3.New(0.7, -0.8, -6.2), (arg_1_1.time_ - 1.5) / var_4_11)
			...
			if arg_1_1.time_ >= 1.5 + var_4_11 and arg_1_1.time_ < 1.5 + var_4_11 + arg_4_0 then
				var_4_10.localPosition = Vector3.New(0.7, -0.8, -6.2)
				var_4_10.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_10.position).x, (manager.ui.mainCamera.transform.position - var_4_10.position).y, (manager.ui.mainCamera.transform.position - var_4_10.position).z)
				var_4_10.localEulerAngles.z = 0
				var_4_10.localEulerAngles.x = 0
				var_4_10.localEulerAngles = var_4_10.localEulerAngles
			...
			if arg_1_1.time_ >= var_4_12 + 1.5 and arg_1_1.time_ < var_4_12 + 1.5 + arg_4_0 then
				arg_1_1.allBtn_.enabled = true
			end

			local var_4_13 = arg_1_1.actors_["1048ui_story"]

			if 1.5 < arg_1_1.time_ and arg_1_1.time_ <= 1.5 + arg_4_0 and not isNil(var_4_13) and arg_1_1.var_.characterEffect1048ui_story == nil then
				arg_1_1.var_.characterEffect1048ui_story = var_4_13:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_14 = 0.2

			if 1.5 <= arg_1_1.time_ and arg_1_1.time_ < 1.5 + var_4_14 and not isNil(var_4_13) then
				if arg_1_1.var_.characterEffect1048ui_story and not isNil(var_4_13) then
					arg_1_1.var_.characterEffect1048ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 1.5 + var_4_14 and arg_1_1.time_ < 1.5 + var_4_14 + arg_4_0 and not isNil(var_4_13) and arg_1_1.var_.characterEffect1048ui_story then
				arg_1_1.var_.characterEffect1048ui_story.fillFlat = false
			end
			...
			if 1.5 < arg_1_1.time_ and arg_1_1.time_ <= var_4_19 + arg_4_0 then
				...
				local var_4_22 = arg_1_1:GetWordFromCfg(111022001)
				...
				local var_4_25 = 19 <= 0 and var_4_20 or var_4_20 * (utf8.len(var_4_23) / 19)

				if (19 <= 0 and var_4_20 or var_4_20 * (utf8.len(var_4_23) / 19)) > 0 and var_4_20 < var_4_25 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022001", "story_v_out_111022.awb") ~= 0 then
					local var_4_26 = manager.audio:GetVoiceLength("story_v_out_111022", "111022001", "story_v_out_111022.awb") / 1000
					...
					if var_4_22.prefab_name ~= "" and arg_1_1.actors_[var_4_22.prefab_name] ~= nil then
						local var_4_27 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_22.prefab_name].transform, "story_v_out_111022", "111022001", "story_v_out_111022.awb")

						arg_1_1:RecordAudio("111022001", var_4_27)
						arg_1_1:RecordAudio("111022001", var_4_27)
					else
	...
	Play111022002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			local var_11_5 = arg_8_1.actors_["1048ui_story"]

			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 and not isNil(var_11_5) and arg_8_1.var_.characterEffect1048ui_story == nil then
				arg_8_1.var_.characterEffect1048ui_story = var_11_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_11_6 = 0.2

			if 0 <= arg_8_1.time_ and arg_8_1.time_ < 0 + var_11_6 and not isNil(var_11_5) then
				if arg_8_1.var_.characterEffect1048ui_story and not isNil(var_11_5) then
					arg_8_1.var_.characterEffect1048ui_story.fillFlat = true
					arg_8_1.var_.characterEffect1048ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_8_1.time_ - 0) / var_11_6)
				end
			end

			if arg_8_1.time_ >= 0 + var_11_6 and arg_8_1.time_ < 0 + var_11_6 + arg_11_0 and not isNil(var_11_5) and arg_8_1.var_.characterEffect1048ui_story then
				arg_8_1.var_.characterEffect1048ui_story.fillFlat = true
				arg_8_1.var_.characterEffect1048ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_10 + arg_11_0 then
				...
				local var_11_12 = arg_8_1:GetWordFromCfg(111022002)
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022002", "story_v_out_111022.awb") ~= 0 then
					local var_11_16 = manager.audio:GetVoiceLength("story_v_out_111022", "111022002", "story_v_out_111022.awb") / 1000
					...
					if var_11_12.prefab_name ~= "" and arg_8_1.actors_[var_11_12.prefab_name] ~= nil then
						local var_11_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_12.prefab_name].transform, "story_v_out_111022", "111022002", "story_v_out_111022.awb")

						arg_8_1:RecordAudio("111022002", var_11_17)
						arg_8_1:RecordAudio("111022002", var_11_17)
					else
	...
	Play111022003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_1 + arg_15_0 then
				...
				local var_15_3 = arg_12_1:FormatText(arg_12_1:GetWordFromCfg(111022003).content)
	...
	Play111022004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 then
				...
				local var_19_1 = arg_16_1:GetWordFromCfg(111022004)
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022004", "story_v_out_111022.awb") ~= 0 then
					local var_19_5 = manager.audio:GetVoiceLength("story_v_out_111022", "111022004", "story_v_out_111022.awb") / 1000
					...
					if var_19_1.prefab_name ~= "" and arg_16_1.actors_[var_19_1.prefab_name] ~= nil then
						local var_19_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_1.prefab_name].transform, "story_v_out_111022", "111022004", "story_v_out_111022.awb")

						arg_16_1:RecordAudio("111022004", var_19_6)
						arg_16_1:RecordAudio("111022004", var_19_6)
					else
	...
	Play111022005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 then
				...
				local var_23_1 = arg_20_1:FormatText(arg_20_1:GetWordFromCfg(111022005).content)

				arg_20_1.text_.text = var_23_1

				LuaForUtil.ClearLinePrefixSymbol(arg_20_1.text_)

				local var_23_3 = 42 <= 0 and var_23_0 or var_23_0 * (utf8.len(var_23_1) / 42)

				if (42 <= 0 and var_23_0 or var_23_0 * (utf8.len(var_23_1) / 42)) > 0 and var_23_0 < var_23_3 then
	...
	Play111022006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 then
				...
				local var_27_1 = arg_24_1:FormatText(arg_24_1:GetWordFromCfg(111022006).content)

				arg_24_1.text_.text = var_27_1

				LuaForUtil.ClearLinePrefixSymbol(arg_24_1.text_)

				local var_27_3 = 54 <= 0 and var_27_0 or var_27_0 * (utf8.len(var_27_1) / 54)

				if (54 <= 0 and var_27_0 or var_27_0 * (utf8.len(var_27_1) / 54)) > 0 and var_27_0 < var_27_3 then
	...
	Play111022007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 then
				arg_28_1:AudioAction("play", "music", "bgm_activity_1_1_hel_story", "bgm_activity_1_1_hel_story", "bgm_activity_1_1_hel_story.awb")

				local var_31_2 = manager.audio:GetAudioName("bgm_activity_1_1_hel_story", "bgm_activity_1_1_hel_story")

				if "" ~= "" then
					if arg_28_1.bgmTxt_.text ~= var_31_2 and arg_28_1.bgmTxt_.text ~= "" then
						if arg_28_1.bgmTxt2_.text ~= "" then
							arg_28_1.bgmTxt_.text = arg_28_1.bgmTxt2_.text
						end

						arg_28_1.bgmTxt2_.text = var_31_2

						arg_28_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_28_1.bgmTxt_.text = var_31_2
						arg_28_1.bgmTxt2_.text = var_31_2
					end
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_3 + arg_31_0 then
				...
				local var_31_5 = arg_28_1:GetWordFromCfg(111022007)
				...
				local var_31_8 = 28 <= 0 and var_31_4 or var_31_4 * (utf8.len(var_31_6) / 28)

				if (28 <= 0 and var_31_4 or var_31_4 * (utf8.len(var_31_6) / 28)) > 0 and var_31_4 < var_31_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022007", "story_v_out_111022.awb") ~= 0 then
					local var_31_9 = manager.audio:GetVoiceLength("story_v_out_111022", "111022007", "story_v_out_111022.awb") / 1000
					...
					if var_31_5.prefab_name ~= "" and arg_28_1.actors_[var_31_5.prefab_name] ~= nil then
						local var_31_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_5.prefab_name].transform, "story_v_out_111022", "111022007", "story_v_out_111022.awb")

						arg_28_1:RecordAudio("111022007", var_31_10)
						arg_28_1:RecordAudio("111022007", var_31_10)
					else
	...
	Play111022008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(111022008).content)
	...
	Play111022009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				local var_40_1 = arg_37_1:GetWordFromCfg(111022009)
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022009", "story_v_out_111022.awb") ~= 0 then
					local var_40_5 = manager.audio:GetVoiceLength("story_v_out_111022", "111022009", "story_v_out_111022.awb") / 1000
					...
					if var_40_1.prefab_name ~= "" and arg_37_1.actors_[var_40_1.prefab_name] ~= nil then
						local var_40_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_1.prefab_name].transform, "story_v_out_111022", "111022009", "story_v_out_111022.awb")

						arg_37_1:RecordAudio("111022009", var_40_6)
						arg_37_1:RecordAudio("111022009", var_40_6)
					else
	...
	Play111022010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				...
				local var_44_1 = arg_41_1:GetWordFromCfg(111022010)
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022010", "story_v_out_111022.awb") ~= 0 then
					local var_44_5 = manager.audio:GetVoiceLength("story_v_out_111022", "111022010", "story_v_out_111022.awb") / 1000
					...
					if var_44_1.prefab_name ~= "" and arg_41_1.actors_[var_44_1.prefab_name] ~= nil then
						local var_44_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_1.prefab_name].transform, "story_v_out_111022", "111022010", "story_v_out_111022.awb")

						arg_41_1:RecordAudio("111022010", var_44_6)
						arg_41_1:RecordAudio("111022010", var_44_6)
					else
	...
	Play111022011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				local var_48_1 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(111022011).content)
	...
	Play111022012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			local var_52_0 = arg_49_1.actors_["1048ui_story"]

			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 and not isNil(var_52_0) and arg_49_1.var_.characterEffect1048ui_story == nil then
				arg_49_1.var_.characterEffect1048ui_story = var_52_0:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_52_1 = 0.2

			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_1 and not isNil(var_52_0) then
				if arg_49_1.var_.characterEffect1048ui_story and not isNil(var_52_0) then
					arg_49_1.var_.characterEffect1048ui_story.fillFlat = false
				end
			end

			if arg_49_1.time_ >= 0 + var_52_1 and arg_49_1.time_ < 0 + var_52_1 + arg_52_0 and not isNil(var_52_0) and arg_49_1.var_.characterEffect1048ui_story then
				arg_49_1.var_.characterEffect1048ui_story.fillFlat = false
			end
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_3 + arg_52_0 then
				...
				local var_52_5 = arg_49_1:GetWordFromCfg(111022012)
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022012", "story_v_out_111022.awb") ~= 0 then
					local var_52_9 = manager.audio:GetVoiceLength("story_v_out_111022", "111022012", "story_v_out_111022.awb") / 1000
					...
					if var_52_5.prefab_name ~= "" and arg_49_1.actors_[var_52_5.prefab_name] ~= nil then
						local var_52_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_5.prefab_name].transform, "story_v_out_111022", "111022012", "story_v_out_111022.awb")

						arg_49_1:RecordAudio("111022012", var_52_10)
						arg_49_1:RecordAudio("111022012", var_52_10)
					else
	...
	Play111022013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			if arg_53_1.actors_["1039ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1039ui_story"))) then
				local var_56_0 = Object.Instantiate(Asset.Load("Char/" .. "1039ui_story"), arg_53_1.stage_.transform)

				var_56_0.name = "1039ui_story"
				var_56_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_53_1.actors_["1039ui_story"] = var_56_0
				...
				arg_53_1.var_["1039ui_story" .. "Animator"] = var_56_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_53_1.var_["1039ui_story" .. "Animator"].applyRootMotion = true
				arg_53_1.var_["1039ui_story" .. "LipSync"] = var_56_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end
			...
			local var_56_3 = arg_53_1.actors_["1039ui_story"]

			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 and not isNil(var_56_3) and arg_53_1.var_.characterEffect1039ui_story == nil then
				arg_53_1.var_.characterEffect1039ui_story = var_56_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_56_4 = 0.2

			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_4 and not isNil(var_56_3) then
				if arg_53_1.var_.characterEffect1039ui_story and not isNil(var_56_3) then
					arg_53_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_53_1.time_ >= 0 + var_56_4 and arg_53_1.time_ < 0 + var_56_4 + arg_56_0 and not isNil(var_56_3) and arg_53_1.var_.characterEffect1039ui_story then
				arg_53_1.var_.characterEffect1039ui_story.fillFlat = false
			end

			local var_56_6 = arg_53_1.actors_["1048ui_story"].transform

			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1.var_.moveOldPos1048ui_story = var_56_6.localPosition
			end

			local var_56_7 = 0.001

			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_7 then
				var_56_6.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPos1048ui_story, Vector3.New(0, 100, 0), (arg_53_1.time_ - 0) / var_56_7)
			...
			local var_56_8 = arg_53_1.actors_["1039ui_story"].transform

			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1.var_.moveOldPos1039ui_story = var_56_8.localPosition
			end

			local var_56_9 = 0.001

			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_9 then
				var_56_8.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPos1039ui_story, Vector3.New(0.7, -1.01, -5.9), (arg_53_1.time_ - 0) / var_56_9)
			...
			if arg_53_1.time_ >= 0 + var_56_9 and arg_53_1.time_ < 0 + var_56_9 + arg_56_0 then
				var_56_8.localPosition = Vector3.New(0.7, -1.01, -5.9)
				var_56_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_56_8.position).x, (manager.ui.mainCamera.transform.position - var_56_8.position).y, (manager.ui.mainCamera.transform.position - var_56_8.position).z)
				var_56_8.localEulerAngles.z = 0
				var_56_8.localEulerAngles.x = 0
				var_56_8.localEulerAngles = var_56_8.localEulerAngles
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_10 + arg_56_0 then
				...
				local var_56_12 = arg_53_1:GetWordFromCfg(111022013)
				...
				local var_56_15 = 34 <= 0 and var_56_11 or var_56_11 * (utf8.len(var_56_13) / 34)

				if (34 <= 0 and var_56_11 or var_56_11 * (utf8.len(var_56_13) / 34)) > 0 and var_56_11 < var_56_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022013", "story_v_out_111022.awb") ~= 0 then
					local var_56_16 = manager.audio:GetVoiceLength("story_v_out_111022", "111022013", "story_v_out_111022.awb") / 1000
					...
					if var_56_12.prefab_name ~= "" and arg_53_1.actors_[var_56_12.prefab_name] ~= nil then
						local var_56_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_12.prefab_name].transform, "story_v_out_111022", "111022013", "story_v_out_111022.awb")

						arg_53_1:RecordAudio("111022013", var_56_17)
						arg_53_1:RecordAudio("111022013", var_56_17)
					else
	...
	Play111022014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 and not isNil(arg_57_1.actors_["1039ui_story"]) and arg_57_1.var_.characterEffect1039ui_story == nil then
				arg_57_1.var_.characterEffect1039ui_story = arg_57_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_60_0 = 0.2

			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_0 and not isNil(arg_57_1.actors_["1039ui_story"]) then
				if arg_57_1.var_.characterEffect1039ui_story and not isNil(arg_57_1.actors_["1039ui_story"]) then
					arg_57_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_57_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_57_1.time_ - 0) / var_60_0)
				end
			end

			if arg_57_1.time_ >= 0 + var_60_0 and arg_57_1.time_ < 0 + var_60_0 + arg_60_0 and not isNil(arg_57_1.actors_["1039ui_story"]) and arg_57_1.var_.characterEffect1039ui_story then
				arg_57_1.var_.characterEffect1039ui_story.fillFlat = true
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_1 + arg_60_0 then
				...
				local var_60_3 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(111022014).content)
	...
	Play111022015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				...
				local var_64_1 = arg_61_1:GetWordFromCfg(111022015)
				...
				local var_64_4 = 17 <= 0 and var_64_0 or var_64_0 * (utf8.len(var_64_2) / 17)

				if (17 <= 0 and var_64_0 or var_64_0 * (utf8.len(var_64_2) / 17)) > 0 and var_64_0 < var_64_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022015", "story_v_out_111022.awb") ~= 0 then
					local var_64_5 = manager.audio:GetVoiceLength("story_v_out_111022", "111022015", "story_v_out_111022.awb") / 1000
					...
					if var_64_1.prefab_name ~= "" and arg_61_1.actors_[var_64_1.prefab_name] ~= nil then
						local var_64_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_61_1.actors_[var_64_1.prefab_name].transform, "story_v_out_111022", "111022015", "story_v_out_111022.awb")

						arg_61_1:RecordAudio("111022015", var_64_6)
						arg_61_1:RecordAudio("111022015", var_64_6)
					else
	...
	Play111022016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_3 + arg_68_0 then
				...
				local var_68_5 = arg_65_1:GetWordFromCfg(111022016)
				...
				local var_68_8 = 20 <= 0 and var_68_4 or var_68_4 * (utf8.len(var_68_6) / 20)

				if (20 <= 0 and var_68_4 or var_68_4 * (utf8.len(var_68_6) / 20)) > 0 and var_68_4 < var_68_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022016", "story_v_out_111022.awb") ~= 0 then
					local var_68_9 = manager.audio:GetVoiceLength("story_v_out_111022", "111022016", "story_v_out_111022.awb") / 1000
					...
					if var_68_5.prefab_name ~= "" and arg_65_1.actors_[var_68_5.prefab_name] ~= nil then
						local var_68_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_65_1.actors_[var_68_5.prefab_name].transform, "story_v_out_111022", "111022016", "story_v_out_111022.awb")

						arg_65_1:RecordAudio("111022016", var_68_10)
						arg_65_1:RecordAudio("111022016", var_68_10)
					else
	...
	Play111022017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_1 + arg_72_0 then
				...
				local var_72_3 = arg_69_1:GetWordFromCfg(111022017)
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022017", "story_v_out_111022.awb") ~= 0 then
					local var_72_7 = manager.audio:GetVoiceLength("story_v_out_111022", "111022017", "story_v_out_111022.awb") / 1000
					...
					if var_72_3.prefab_name ~= "" and arg_69_1.actors_[var_72_3.prefab_name] ~= nil then
						local var_72_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_69_1.actors_[var_72_3.prefab_name].transform, "story_v_out_111022", "111022017", "story_v_out_111022.awb")

						arg_69_1:RecordAudio("111022017", var_72_8)
						arg_69_1:RecordAudio("111022017", var_72_8)
					else
	...
	Play111022018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				...
				local var_76_1 = arg_73_1:GetWordFromCfg(111022018)
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022018", "story_v_out_111022.awb") ~= 0 then
					local var_76_5 = manager.audio:GetVoiceLength("story_v_out_111022", "111022018", "story_v_out_111022.awb") / 1000
					...
					if var_76_1.prefab_name ~= "" and arg_73_1.actors_[var_76_1.prefab_name] ~= nil then
						local var_76_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_73_1.actors_[var_76_1.prefab_name].transform, "story_v_out_111022", "111022018", "story_v_out_111022.awb")

						arg_73_1:RecordAudio("111022018", var_76_6)
						arg_73_1:RecordAudio("111022018", var_76_6)
					else
	...
	Play111022019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 and not isNil(var_80_0) and arg_77_1.var_.characterEffect1039ui_story == nil then
			...
			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_1 and not isNil(var_80_0) then
				if arg_77_1.var_.characterEffect1039ui_story and not isNil(var_80_0) then
					arg_77_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_77_1.time_ >= 0 + var_80_1 and arg_77_1.time_ < 0 + var_80_1 + arg_80_0 and not isNil(var_80_0) and arg_77_1.var_.characterEffect1039ui_story then
				arg_77_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_3 + arg_80_0 then
				...
				local var_80_5 = arg_77_1:GetWordFromCfg(111022019)
				...
				local var_80_8 = 17 <= 0 and var_80_4 or var_80_4 * (utf8.len(var_80_6) / 17)

				if (17 <= 0 and var_80_4 or var_80_4 * (utf8.len(var_80_6) / 17)) > 0 and var_80_4 < var_80_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022019", "story_v_out_111022.awb") ~= 0 then
					local var_80_9 = manager.audio:GetVoiceLength("story_v_out_111022", "111022019", "story_v_out_111022.awb") / 1000
					...
					if var_80_5.prefab_name ~= "" and arg_77_1.actors_[var_80_5.prefab_name] ~= nil then
						local var_80_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_77_1.actors_[var_80_5.prefab_name].transform, "story_v_out_111022", "111022019", "story_v_out_111022.awb")

						arg_77_1:RecordAudio("111022019", var_80_10)
						arg_77_1:RecordAudio("111022019", var_80_10)
					else
	...
	Play111022020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= var_84_1 + arg_84_0 then
				...
				local var_84_3 = arg_81_1:GetWordFromCfg(111022020)
				...
				local var_84_6 = 21 <= 0 and var_84_2 or var_84_2 * (utf8.len(var_84_4) / 21)

				if (21 <= 0 and var_84_2 or var_84_2 * (utf8.len(var_84_4) / 21)) > 0 and var_84_2 < var_84_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022020", "story_v_out_111022.awb") ~= 0 then
					local var_84_7 = manager.audio:GetVoiceLength("story_v_out_111022", "111022020", "story_v_out_111022.awb") / 1000
					...
					if var_84_3.prefab_name ~= "" and arg_81_1.actors_[var_84_3.prefab_name] ~= nil then
						local var_84_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_81_1.actors_[var_84_3.prefab_name].transform, "story_v_out_111022", "111022020", "story_v_out_111022.awb")

						arg_81_1:RecordAudio("111022020", var_84_8)
						arg_81_1:RecordAudio("111022020", var_84_8)
					else
	...
	Play111022021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				...
				local var_88_1 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(111022021).content)
	...
	Play111022022 = function(arg_89_0, arg_89_1)
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			...
			if 0 < arg_89_1.time_ and arg_89_1.time_ <= 0 + arg_92_0 then
				...
				local var_92_1 = arg_89_1:FormatText(arg_89_1:GetWordFromCfg(111022022).content)
	...
	Play111022023 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if 0 < arg_93_1.time_ and arg_93_1.time_ <= 0 + arg_96_0 and not isNil(var_96_0) and arg_93_1.var_.characterEffect1039ui_story == nil then
			...
			if arg_93_1.time_ >= 0 + var_96_1 and arg_93_1.time_ < 0 + var_96_1 + arg_96_0 and not isNil(var_96_0) and arg_93_1.var_.characterEffect1039ui_story then
				arg_93_1.var_.characterEffect1039ui_story.fillFlat = false
			end

			local var_96_3 = 0
			local var_96_4 = 0.125
			...
			if 0 < arg_93_1.time_ and arg_93_1.time_ <= var_96_3 + arg_96_0 then
				...
				local var_96_5 = arg_93_1:GetWordFromCfg(111022023)
				...
				local var_96_8 = 5 <= 0 and var_96_4 or var_96_4 * (utf8.len(var_96_6) / 5)

				if (5 <= 0 and var_96_4 or var_96_4 * (utf8.len(var_96_6) / 5)) > 0 and var_96_4 < var_96_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111022", "111022023", "story_v_out_111022.awb") ~= 0 then
					local var_96_9 = manager.audio:GetVoiceLength("story_v_out_111022", "111022023", "story_v_out_111022.awb") / 1000
					...
					if var_96_5.prefab_name ~= "" and arg_93_1.actors_[var_96_5.prefab_name] ~= nil then
						local var_96_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_93_1.actors_[var_96_5.prefab_name].transform, "story_v_out_111022", "111022023", "story_v_out_111022.awb")

						arg_93_1:RecordAudio("111022023", var_96_10)
						arg_93_1:RecordAudio("111022023", var_96_10)
					else
	...
	Play111022024 = function(arg_97_0, arg_97_1)
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			if 0 < arg_97_1.time_ and arg_97_1.time_ <= 0 + arg_100_0 and not isNil(arg_97_1.actors_["1039ui_story"]) and arg_97_1.var_.characterEffect1039ui_story == nil then
				arg_97_1.var_.characterEffect1039ui_story = arg_97_1.actors_["1039ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_100_0 = 0.2

			if 0 <= arg_97_1.time_ and arg_97_1.time_ < 0 + var_100_0 and not isNil(arg_97_1.actors_["1039ui_story"]) then
				if arg_97_1.var_.characterEffect1039ui_story and not isNil(arg_97_1.actors_["1039ui_story"]) then
					arg_97_1.var_.characterEffect1039ui_story.fillFlat = true
					arg_97_1.var_.characterEffect1039ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_97_1.time_ - 0) / var_100_0)
				end
			end

			if arg_97_1.time_ >= 0 + var_100_0 and arg_97_1.time_ < 0 + var_100_0 + arg_100_0 and not isNil(arg_97_1.actors_["1039ui_story"]) and arg_97_1.var_.characterEffect1039ui_story then
				arg_97_1.var_.characterEffect1039ui_story.fillFlat = true
				arg_97_1.var_.characterEffect1039ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_97_1.time_ and arg_97_1.time_ <= var_100_1 + arg_100_0 then
				...
				local var_100_3 = arg_97_1:FormatText(arg_97_1:GetWordFromCfg(111022024).content)
