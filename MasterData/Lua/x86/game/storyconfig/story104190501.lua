	...
	Play419051068 = function(arg_277_0, arg_277_1)
		...
		function arg_277_1.onSingleLineUpdate_(arg_280_0)
			...
			if 0 < arg_277_1.time_ and arg_277_1.time_ <= 0 + arg_280_0 then
				...
				local var_280_11 = var_280_8.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_280_0, iter_280_1 in ipairs((var_280_11:ToTable())) do
					iter_280_1.transform.localScale = Vector3.New(iter_280_1.transform.localScale.x / var_280_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_280_11 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_280_1.transform.localScale.y / var_280_10, iter_280_1.transform.localScale.z)
				end
			end

			if 0.633333333333333 < arg_277_1.time_ and arg_277_1.time_ <= 0.633333333333333 + arg_280_0 then
				local var_280_13 = arg_277_1.var_.effect456

				if not arg_277_1.var_.effect456 then
					var_280_13 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), manager.ui.mainCamera.transform)
					var_280_13.name = "456"
					arg_277_1.var_.effect456 = var_280_13
				else
					var_280_13.transform:SetParent(var_280_9000)
				end

				var_280_13.transform.localPosition = Vector3.New(0, -0.29, -0.76)
				var_280_13.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_280_15 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_280_16 = var_280_13.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_280_2, iter_280_3 in ipairs((var_280_16:ToTable())) do
					iter_280_3.transform.localScale = Vector3.New(iter_280_3.transform.localScale.x / var_280_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_280_16 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_280_3.transform.localScale.y / var_280_15, iter_280_3.transform.localScale.z)
				end
			end

			local var_280_18 = 0

			if 0 < arg_277_1.time_ and arg_277_1.time_ <= var_280_18 + arg_280_0 then
				arg_277_1.allBtn_.enabled = false
			end

			if arg_277_1.time_ >= var_280_18 + 1.833333333332 and arg_277_1.time_ < var_280_18 + 1.833333333332 + arg_280_0 then
				arg_277_1.allBtn_.enabled = true
			end
			...
			local var_280_20 = 1.833333333332
			local var_280_21 = 0.825

			if 1.833333333332 < arg_277_1.time_ and arg_277_1.time_ <= var_280_20 + arg_280_0 then
				...
				local var_280_22 = LeanTween.value(arg_277_1.dialog_, 0, 1, 0.3)

				var_280_22:setOnUpdate(LuaHelper.FloatAction(function(arg_281_0)
					arg_277_1.dialogCg_.alpha = arg_281_0
				end))
				var_280_22:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_277_1.dialog_)
					var_280_22:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_280_23 = arg_277_1:FormatText(arg_277_1:GetWordFromCfg(419051068).content)

				arg_277_1.text_.text = var_280_23

				LuaForUtil.ClearLinePrefixSymbol(arg_277_1.text_)

				local var_280_25 = 33 <= 0 and var_280_21 or var_280_21 * (utf8.len(var_280_23) / 33)

				if (33 <= 0 and var_280_21 or var_280_21 * (utf8.len(var_280_23) / 33)) > 0 and var_280_21 < var_280_25 then
					arg_277_1.talkMaxDuration = var_280_25
					var_280_20 = var_280_20 + 0.3

					if var_280_25 + var_280_20 > arg_277_1.duration_ then
						arg_277_1.duration_ = var_280_25 + var_280_20
					end
				end
			...
			local var_280_26 = var_280_20 + 0.3
			local var_280_27 = math.max(var_280_21, arg_277_1.talkMaxDuration)

			if var_280_20 + 0.3 <= arg_277_1.time_ and arg_277_1.time_ < var_280_26 + var_280_27 then
				arg_277_1.typewritter.percent = (arg_277_1.time_ - var_280_26) / var_280_27
