return {
	Play117102001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				arg_1_1:AudioAction("play", "effect", "se_story_8", "se_story_8_fire_loop", "")
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_16 + arg_4_0 then
				...
				local var_4_19 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(117102001).content)

				arg_1_1.text_.text = var_4_19

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_21 = 51 <= 0 and var_4_17 or var_4_17 * (utf8.len(var_4_19) / 51)

				if (51 <= 0 and var_4_17 or var_4_17 * (utf8.len(var_4_19) / 51)) > 0 and var_4_17 < var_4_21 then
	...
	Play117102002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if arg_9_1.actors_["1132"] == nil then
				local var_12_0 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1132")
			...
			local var_12_2 = arg_9_1.actors_["1132"].transform

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				arg_9_1.var_.moveOldPos1132 = var_12_2.localPosition
			...
			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_4 then
				var_12_2.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1132, Vector3.New(0, -413, -185), (arg_9_1.time_ - 0) / var_12_4)
			end

			if arg_9_1.time_ >= 0 + var_12_4 and arg_9_1.time_ < 0 + var_12_4 + arg_12_0 then
				var_12_2.localPosition = Vector3.New(0, -413, -185)
			end

			local var_12_5 = arg_9_1.actors_["1132"]

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(var_12_5) and arg_9_1.var_.actorSpriteComps1132 == nil then
				arg_9_1.var_.actorSpriteComps1132 = var_12_5:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_9_1.time_ >= 0 + var_12_6 and arg_9_1.time_ < 0 + var_12_6 + arg_12_0 and not isNil(var_12_5) and arg_9_1.var_.actorSpriteComps1132 then
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_8 + arg_12_0 then
				...
				arg_9_1.leftNameTxt_.text = arg_9_1:FormatText(StoryNameCfg[61].name)
				...
				local var_12_10 = arg_9_1:GetWordFromCfg(117102002)
				...
				if manager.audio:GetVoiceLength("story_v_out_117102", "117102002", "story_v_out_117102.awb") ~= 0 then
					local var_12_14 = manager.audio:GetVoiceLength("story_v_out_117102", "117102002", "story_v_out_117102.awb") / 1000
					...
					if var_12_10.prefab_name ~= "" and arg_9_1.actors_[var_12_10.prefab_name] ~= nil then
						local var_12_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_10.prefab_name].transform, "story_v_out_117102", "117102002", "story_v_out_117102.awb")

						arg_9_1:RecordAudio("117102002", var_12_15)
						arg_9_1:RecordAudio("117102002", var_12_15)
					else
	...
	Play117102003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos1132 = arg_13_1.actors_["1132"].transform.localPosition
				arg_13_1.actors_["1132"].transform.localScale = Vector3.New(1, 1, 1)

				arg_13_1:CheckSpriteTmpPos("1132", 7)

				for iter_16_0 = 0, arg_13_1.actors_["1132"].transform.childCount - 1 do
					local var_16_0 = arg_13_1.actors_["1132"].transform:GetChild(iter_16_0)
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_1 then
				arg_13_1.actors_["1132"].transform.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1132, Vector3.New(0, -2000, -185), (arg_13_1.time_ - 0) / var_16_1)
			end

			if arg_13_1.time_ >= 0 + var_16_1 and arg_13_1.time_ < 0 + var_16_1 + arg_16_0 then
				arg_13_1.actors_["1132"].transform.localPosition = Vector3.New(0, -2000, -185)
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_2 + arg_16_0 then
				...
				local var_16_4 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(117102003).content)

				arg_13_1.text_.text = var_16_4

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_6 = 28 <= 0 and var_16_3 or var_16_3 * (utf8.len(var_16_4) / 28)

				if (28 <= 0 and var_16_3 or var_16_3 * (utf8.len(var_16_4) / 28)) > 0 and var_16_3 < var_16_6 then
	...
	Play117102004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				arg_17_1.var_.moveOldPos1132 = arg_17_1.actors_["1132"].transform.localPosition
				arg_17_1.actors_["1132"].transform.localScale = Vector3.New(1, 1, 1)

				arg_17_1:CheckSpriteTmpPos("1132", 3)

				for iter_20_0 = 0, arg_17_1.actors_["1132"].transform.childCount - 1 do
					local var_20_0 = arg_17_1.actors_["1132"].transform:GetChild(iter_20_0)

					if var_20_0.name == "split_6" or not string.find(var_20_0.name, "split") then
			...
			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_1 then
				arg_17_1.actors_["1132"].transform.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos1132, Vector3.New(0, -413, -185), (arg_17_1.time_ - 0) / var_20_1)
			end

			if arg_17_1.time_ >= 0 + var_20_1 and arg_17_1.time_ < 0 + var_20_1 + arg_20_0 then
				arg_17_1.actors_["1132"].transform.localPosition = Vector3.New(0, -413, -185)
			end

			local var_20_2 = arg_17_1.actors_["1132"]

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(var_20_2) and arg_17_1.var_.actorSpriteComps1132 == nil then
				arg_17_1.var_.actorSpriteComps1132 = var_20_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_17_1.time_ >= 0 + var_20_3 and arg_17_1.time_ < 0 + var_20_3 + arg_20_0 and not isNil(var_20_2) and arg_17_1.var_.actorSpriteComps1132 then
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_5 + arg_20_0 then
				...
				arg_17_1.leftNameTxt_.text = arg_17_1:FormatText(StoryNameCfg[61].name)
				...
				local var_20_7 = arg_17_1:GetWordFromCfg(117102004)
				...
				if manager.audio:GetVoiceLength("story_v_out_117102", "117102004", "story_v_out_117102.awb") ~= 0 then
					local var_20_11 = manager.audio:GetVoiceLength("story_v_out_117102", "117102004", "story_v_out_117102.awb") / 1000
					...
					if var_20_7.prefab_name ~= "" and arg_17_1.actors_[var_20_7.prefab_name] ~= nil then
						local var_20_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_7.prefab_name].transform, "story_v_out_117102", "117102004", "story_v_out_117102.awb")

						arg_17_1:RecordAudio("117102004", var_20_12)
						arg_17_1:RecordAudio("117102004", var_20_12)
					else
	...
	Play117102005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_1 then
				arg_21_1.actors_["1132"].transform.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1132, Vector3.New(0, -2000, -185), (arg_21_1.time_ - 0) / var_24_1)
			end

			if arg_21_1.time_ >= 0 + var_24_1 and arg_21_1.time_ < 0 + var_24_1 + arg_24_0 then
				arg_21_1.actors_["1132"].transform.localPosition = Vector3.New(0, -2000, -185)
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_2 + arg_24_0 then
				...
				local var_24_4 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(117102005).content)
	...
	Play117102006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			if arg_25_1.actors_["10036"] == nil then
				local var_28_0 = Asset.Load("Widget/System/Story/StoryExpression/" .. "10036")
				...
				if not isNil(var_28_0) then
					...
					arg_25_1.actors_["10036"] = var_28_1
			...
			local var_28_2 = arg_25_1.actors_["10036"].transform

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				arg_25_1.var_.moveOldPos10036 = var_28_2.localPosition
			...
			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_4 then
				var_28_2.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos10036, Vector3.New(390, -445, -290), (arg_25_1.time_ - 0) / var_28_4)
			end

			if arg_25_1.time_ >= 0 + var_28_4 and arg_25_1.time_ < 0 + var_28_4 + arg_28_0 then
				var_28_2.localPosition = Vector3.New(390, -445, -290)
			end

			local var_28_5 = arg_25_1.actors_["1132"].transform

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				arg_25_1.var_.moveOldPos1132 = var_28_5.localPosition
			...
			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_7 then
				var_28_5.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos1132, Vector3.New(-390, -413, -185), (arg_25_1.time_ - 0) / var_28_7)
			end

			if arg_25_1.time_ >= 0 + var_28_7 and arg_25_1.time_ < 0 + var_28_7 + arg_28_0 then
				var_28_5.localPosition = Vector3.New(-390, -413, -185)
			end

			local var_28_8 = arg_25_1.actors_["1132"]

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(var_28_8) and arg_25_1.var_.actorSpriteComps1132 == nil then
				arg_25_1.var_.actorSpriteComps1132 = var_28_8:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_25_1.time_ >= 0 + var_28_9 and arg_25_1.time_ < 0 + var_28_9 + arg_28_0 and not isNil(var_28_8) and arg_25_1.var_.actorSpriteComps1132 then
			...
			local var_28_11 = arg_25_1.actors_["10036"]

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(var_28_11) and arg_25_1.var_.actorSpriteComps10036 == nil then
				arg_25_1.var_.actorSpriteComps10036 = var_28_11:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_25_1.time_ >= 0 + var_28_12 and arg_25_1.time_ < 0 + var_28_12 + arg_28_0 and not isNil(var_28_11) and arg_25_1.var_.actorSpriteComps10036 then
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_14 + arg_28_0 then
				...
				arg_25_1.leftNameTxt_.text = arg_25_1:FormatText(StoryNameCfg[61].name)
				...
				local var_28_16 = arg_25_1:GetWordFromCfg(117102006)
				...
				local var_28_19 = 12 <= 0 and var_28_15 or var_28_15 * (utf8.len(var_28_17) / 12)

				if (12 <= 0 and var_28_15 or var_28_15 * (utf8.len(var_28_17) / 12)) > 0 and var_28_15 < var_28_19 then
				...
				if manager.audio:GetVoiceLength("story_v_out_117102", "117102006", "story_v_out_117102.awb") ~= 0 then
					local var_28_20 = manager.audio:GetVoiceLength("story_v_out_117102", "117102006", "story_v_out_117102.awb") / 1000
					...
					if var_28_16.prefab_name ~= "" and arg_25_1.actors_[var_28_16.prefab_name] ~= nil then
						local var_28_21 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_16.prefab_name].transform, "story_v_out_117102", "117102006", "story_v_out_117102.awb")

						arg_25_1:RecordAudio("117102006", var_28_21)
						arg_25_1:RecordAudio("117102006", var_28_21)
					else
	...
	Play117102007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos10036 = arg_29_1.actors_["10036"].transform.localPosition
				arg_29_1.actors_["10036"].transform.localScale = Vector3.New(1, 1, 1)

				arg_29_1:CheckSpriteTmpPos("10036", 4)

				for iter_32_0 = 0, arg_29_1.actors_["10036"].transform.childCount - 1 do
					local var_32_0 = arg_29_1.actors_["10036"].transform:GetChild(iter_32_0)
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_1 then
				arg_29_1.actors_["10036"].transform.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos10036, Vector3.New(390, -445, -290), (arg_29_1.time_ - 0) / var_32_1)
			end

			if arg_29_1.time_ >= 0 + var_32_1 and arg_29_1.time_ < 0 + var_32_1 + arg_32_0 then
				arg_29_1.actors_["10036"].transform.localPosition = Vector3.New(390, -445, -290)
			end

			local var_32_2 = arg_29_1.actors_["1132"].transform

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos1132 = var_32_2.localPosition
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_4 then
				var_32_2.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1132, Vector3.New(-390, -413, -185), (arg_29_1.time_ - 0) / var_32_4)
			end

			if arg_29_1.time_ >= 0 + var_32_4 and arg_29_1.time_ < 0 + var_32_4 + arg_32_0 then
				var_32_2.localPosition = Vector3.New(-390, -413, -185)
			end

			local var_32_5 = arg_29_1.actors_["1132"]

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(var_32_5) and arg_29_1.var_.actorSpriteComps1132 == nil then
				arg_29_1.var_.actorSpriteComps1132 = var_32_5:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_29_1.time_ >= 0 + var_32_6 and arg_29_1.time_ < 0 + var_32_6 + arg_32_0 and not isNil(var_32_5) and arg_29_1.var_.actorSpriteComps1132 then
			...
			local var_32_8 = arg_29_1.actors_["10036"]

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(var_32_8) and arg_29_1.var_.actorSpriteComps10036 == nil then
				arg_29_1.var_.actorSpriteComps10036 = var_32_8:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_9 and not isNil(var_32_8) then
				if arg_29_1.var_.actorSpriteComps10036 then
					for iter_32_6, iter_32_7 in pairs(arg_29_1.var_.actorSpriteComps10036:ToTable()) do
						if iter_32_7 then
							if arg_29_1.isInRecall_ then
								iter_32_7.color = Color.New(Mathf.Lerp(iter_32_7.color.r, arg_29_1.hightColor1.r, (arg_29_1.time_ - 0) / var_32_9), Mathf.Lerp(iter_32_7.color.g, arg_29_1.hightColor1.g, (arg_29_1.time_ - 0) / var_32_9), (Mathf.Lerp(iter_32_7.color.b, arg_29_1.hightColor1.b, (arg_29_1.time_ - 0) / var_32_9)))
							else
								local var_32_10 = Mathf.Lerp(iter_32_7.color.r, 1, (arg_29_1.time_ - 0) / var_32_9)
			...
			if arg_29_1.time_ >= 0 + var_32_9 and arg_29_1.time_ < 0 + var_32_9 + arg_32_0 and not isNil(var_32_8) and arg_29_1.var_.actorSpriteComps10036 then
				for iter_32_8, iter_32_9 in pairs(arg_29_1.var_.actorSpriteComps10036:ToTable()) do
					if iter_32_9 then
						iter_32_9.color = arg_29_1.isInRecall_ and (arg_29_1.hightColor1 or Color.New(0.82, 0.77, 0.62)) or Color.New(1, 1, 1)
					end
				end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_11 + arg_32_0 then
				...
				arg_29_1.leftNameTxt_.text = arg_29_1:FormatText(StoryNameCfg[370].name)
				...
				local var_32_13 = arg_29_1:GetWordFromCfg(117102007)
				...
				local var_32_16 = 11 <= 0 and var_32_12 or var_32_12 * (utf8.len(var_32_14) / 11)

				if (11 <= 0 and var_32_12 or var_32_12 * (utf8.len(var_32_14) / 11)) > 0 and var_32_12 < var_32_16 then
				...
				if manager.audio:GetVoiceLength("story_v_out_117102", "117102007", "story_v_out_117102.awb") ~= 0 then
					local var_32_17 = manager.audio:GetVoiceLength("story_v_out_117102", "117102007", "story_v_out_117102.awb") / 1000
					...
					if var_32_13.prefab_name ~= "" and arg_29_1.actors_[var_32_13.prefab_name] ~= nil then
						local var_32_18 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_13.prefab_name].transform, "story_v_out_117102", "117102007", "story_v_out_117102.awb")

						arg_29_1:RecordAudio("117102007", var_32_18)
						arg_29_1:RecordAudio("117102007", var_32_18)
					else
	...
	Play117102008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				arg_33_1.leftNameTxt_.text = arg_33_1:FormatText(StoryNameCfg[370].name)
				...
				local var_36_1 = arg_33_1:GetWordFromCfg(117102008)
				...
				if manager.audio:GetVoiceLength("story_v_out_117102", "117102008", "story_v_out_117102.awb") ~= 0 then
					local var_36_5 = manager.audio:GetVoiceLength("story_v_out_117102", "117102008", "story_v_out_117102.awb") / 1000
					...
					if var_36_1.prefab_name ~= "" and arg_33_1.actors_[var_36_1.prefab_name] ~= nil then
						local var_36_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_1.prefab_name].transform, "story_v_out_117102", "117102008", "story_v_out_117102.awb")

						arg_33_1:RecordAudio("117102008", var_36_6)
						arg_33_1:RecordAudio("117102008", var_36_6)
					else
	...
	Play117102009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				arg_37_1.leftNameTxt_.text = arg_37_1:FormatText(StoryNameCfg[370].name)
				...
				local var_40_1 = arg_37_1:GetWordFromCfg(117102009)
				...
				if manager.audio:GetVoiceLength("story_v_out_117102", "117102009", "story_v_out_117102.awb") ~= 0 then
					local var_40_5 = manager.audio:GetVoiceLength("story_v_out_117102", "117102009", "story_v_out_117102.awb") / 1000
					...
					if var_40_1.prefab_name ~= "" and arg_37_1.actors_[var_40_1.prefab_name] ~= nil then
						local var_40_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_1.prefab_name].transform, "story_v_out_117102", "117102009", "story_v_out_117102.awb")

						arg_37_1:RecordAudio("117102009", var_40_6)
						arg_37_1:RecordAudio("117102009", var_40_6)
					else
	...
	Play117102010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1.var_.moveOldPos10036 = arg_41_1.actors_["10036"].transform.localPosition
				arg_41_1.actors_["10036"].transform.localScale = Vector3.New(1, 1, 1)

				arg_41_1:CheckSpriteTmpPos("10036", 4)

				for iter_44_0 = 0, arg_41_1.actors_["10036"].transform.childCount - 1 do
					local var_44_0 = arg_41_1.actors_["10036"].transform:GetChild(iter_44_0)
			...
			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_1 then
				arg_41_1.actors_["10036"].transform.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos10036, Vector3.New(390, -445, -290), (arg_41_1.time_ - 0) / var_44_1)
			end

			if arg_41_1.time_ >= 0 + var_44_1 and arg_41_1.time_ < 0 + var_44_1 + arg_44_0 then
				arg_41_1.actors_["10036"].transform.localPosition = Vector3.New(390, -445, -290)
			end

			local var_44_2 = arg_41_1.actors_["1132"].transform

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1.var_.moveOldPos1132 = var_44_2.localPosition
			...
			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_4 then
				var_44_2.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1132, Vector3.New(-390, -413, -185), (arg_41_1.time_ - 0) / var_44_4)
			end

			if arg_41_1.time_ >= 0 + var_44_4 and arg_41_1.time_ < 0 + var_44_4 + arg_44_0 then
				var_44_2.localPosition = Vector3.New(-390, -413, -185)
			end

			local var_44_5 = arg_41_1.actors_["10036"]

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(var_44_5) and arg_41_1.var_.actorSpriteComps10036 == nil then
				arg_41_1.var_.actorSpriteComps10036 = var_44_5:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_41_1.time_ >= 0 + var_44_6 and arg_41_1.time_ < 0 + var_44_6 + arg_44_0 and not isNil(var_44_5) and arg_41_1.var_.actorSpriteComps10036 then
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_8 + arg_44_0 then
				...
				local var_44_10 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(117102010).content)

				arg_41_1.text_.text = var_44_10

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_12 = 18 <= 0 and var_44_9 or var_44_9 * (utf8.len(var_44_10) / 18)

				if (18 <= 0 and var_44_9 or var_44_9 * (utf8.len(var_44_10) / 18)) > 0 and var_44_9 < var_44_12 then
	...
	Play117102011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos10036 = arg_45_1.actors_["10036"].transform.localPosition
				arg_45_1.actors_["10036"].transform.localScale = Vector3.New(1, 1, 1)

				arg_45_1:CheckSpriteTmpPos("10036", 4)

				for iter_48_0 = 0, arg_45_1.actors_["10036"].transform.childCount - 1 do
					local var_48_0 = arg_45_1.actors_["10036"].transform:GetChild(iter_48_0)
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_1 then
				arg_45_1.actors_["10036"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos10036, Vector3.New(390, -445, -290), (arg_45_1.time_ - 0) / var_48_1)
			end

			if arg_45_1.time_ >= 0 + var_48_1 and arg_45_1.time_ < 0 + var_48_1 + arg_48_0 then
				arg_45_1.actors_["10036"].transform.localPosition = Vector3.New(390, -445, -290)
			end

			local var_48_2 = arg_45_1.actors_["1132"].transform

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1132 = var_48_2.localPosition
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_4 then
				var_48_2.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1132, Vector3.New(-390, -413, -185), (arg_45_1.time_ - 0) / var_48_4)
			end

			if arg_45_1.time_ >= 0 + var_48_4 and arg_45_1.time_ < 0 + var_48_4 + arg_48_0 then
				var_48_2.localPosition = Vector3.New(-390, -413, -185)
			end

			local var_48_5 = arg_45_1.actors_["1132"]

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(var_48_5) and arg_45_1.var_.actorSpriteComps1132 == nil then
				arg_45_1.var_.actorSpriteComps1132 = var_48_5:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_45_1.time_ >= 0 + var_48_6 and arg_45_1.time_ < 0 + var_48_6 + arg_48_0 and not isNil(var_48_5) and arg_45_1.var_.actorSpriteComps1132 then
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_8 + arg_48_0 then
				...
				arg_45_1.leftNameTxt_.text = arg_45_1:FormatText(StoryNameCfg[61].name)
				...
				local var_48_10 = arg_45_1:GetWordFromCfg(117102011)
				...
				if manager.audio:GetVoiceLength("story_v_out_117102", "117102011", "story_v_out_117102.awb") ~= 0 then
					local var_48_14 = manager.audio:GetVoiceLength("story_v_out_117102", "117102011", "story_v_out_117102.awb") / 1000
					...
					if var_48_10.prefab_name ~= "" and arg_45_1.actors_[var_48_10.prefab_name] ~= nil then
						local var_48_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_10.prefab_name].transform, "story_v_out_117102", "117102011", "story_v_out_117102.awb")

						arg_45_1:RecordAudio("117102011", var_48_15)
						arg_45_1:RecordAudio("117102011", var_48_15)
					else
	...
	Play117102012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				...
				local var_52_1 = arg_49_1:GetWordFromCfg(117102012)
				...
				if manager.audio:GetVoiceLength("story_v_out_117102", "117102012", "story_v_out_117102.awb") ~= 0 then
					local var_52_5 = manager.audio:GetVoiceLength("story_v_out_117102", "117102012", "story_v_out_117102.awb") / 1000
					...
					if var_52_1.prefab_name ~= "" and arg_49_1.actors_[var_52_1.prefab_name] ~= nil then
						local var_52_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_1.prefab_name].transform, "story_v_out_117102", "117102012", "story_v_out_117102.awb")

						arg_49_1:RecordAudio("117102012", var_52_6)
						arg_49_1:RecordAudio("117102012", var_52_6)
					else
	...
	Play117102013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				local var_56_2 = arg_53_1.actors_["10036"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_56_2 then
					arg_53_1.var_.alphaOldValue10036 = var_56_2.alpha
					arg_53_1.var_.characterEffect10036 = var_56_2
				end
			...
			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_3 then
				if arg_53_1.var_.characterEffect10036 then
					arg_53_1.var_.characterEffect10036.alpha = Mathf.Lerp(arg_53_1.var_.alphaOldValue10036, 0, (arg_53_1.time_ - 0) / var_56_3)
				end
			end

			if arg_53_1.time_ >= 0 + var_56_3 and arg_53_1.time_ < 0 + var_56_3 + arg_56_0 and arg_53_1.var_.characterEffect10036 then
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1:AudioAction("play", "effect", "se_story_17", "se_story_17_boss_hawk1", "")
			end
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_9 + arg_56_0 then
				...
				local var_56_11 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(117102013).content)

				arg_53_1.text_.text = var_56_11

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_13 = 33 <= 0 and var_56_10 or var_56_10 * (utf8.len(var_56_11) / 33)

				if (33 <= 0 and var_56_10 or var_56_10 * (utf8.len(var_56_11) / 33)) > 0 and var_56_10 < var_56_13 then
