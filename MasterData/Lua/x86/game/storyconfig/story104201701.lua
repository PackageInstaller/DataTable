	...
	Play420171001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.999999999999 < arg_1_1.time_ and arg_1_1.time_ <= var_4_21 + arg_4_0 then
				...
				local var_4_24 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(420171001).content)

				arg_1_1.text_.text = var_4_24

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_26 = 24 <= 0 and var_4_22 or var_4_22 * (utf8.len(var_4_24) / 24)

				if (24 <= 0 and var_4_22 or var_4_22 * (utf8.len(var_4_24) / 24)) > 0 and var_4_22 < var_4_26 then
	...
	Play420171007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0.983333333333333 < arg_29_1.time_ and arg_29_1.time_ <= 0.983333333333333 + arg_32_0 then
				...
				for iter_32_2, iter_32_3 in ipairs((var_32_15:ToTable())) do
					iter_32_3.transform.localScale = Vector3.New(iter_32_3.transform.localScale.x / var_32_14 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_32_15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_32_3.transform.localScale.y / var_32_14, iter_32_3.transform.localScale.z)
				end
			end

			if 1.15 < arg_29_1.time_ and arg_29_1.time_ <= 1.15 + arg_32_0 then
				local var_32_17 = arg_29_1.var_.effect1008

				if not arg_29_1.var_.effect1008 then
					var_32_17 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_xishan"), manager.ui.mainCamera.transform)
					var_32_17.name = "1008"
					arg_29_1.var_.effect1008 = var_32_17
				else
					var_32_17.transform:SetParent(var_32_9000)
				end

				var_32_17.transform.localPosition = Vector3.New(0, 0, -14.7)
				var_32_17.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_32_19 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_32_20 = var_32_17.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_32_4, iter_32_5 in ipairs((var_32_20:ToTable())) do
					iter_32_5.transform.localScale = Vector3.New(iter_32_5.transform.localScale.x / var_32_19 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_32_20 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_32_5.transform.localScale.y / var_32_19, iter_32_5.transform.localScale.z)
				end
			end
			...
			local var_32_25 = 1.98333333333333
			local var_32_26 = 0.875

			if 1.98333333333333 < arg_29_1.time_ and arg_29_1.time_ <= var_32_25 + arg_32_0 then
				...
				local var_32_28 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(420171007).content)

				arg_29_1.text_.text = var_32_28

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_30 = 35 <= 0 and var_32_26 or var_32_26 * (utf8.len(var_32_28) / 35)

				if (35 <= 0 and var_32_26 or var_32_26 * (utf8.len(var_32_28) / 35)) > 0 and var_32_26 < var_32_30 then
					arg_29_1.talkMaxDuration = var_32_30
					var_32_25 = var_32_25 + 0.3

					if var_32_30 + var_32_25 > arg_29_1.duration_ then
						arg_29_1.duration_ = var_32_30 + var_32_25
					end
				end
			...
			local var_32_31 = var_32_25 + 0.3
			local var_32_32 = math.max(var_32_26, arg_29_1.talkMaxDuration)

			if var_32_25 + 0.3 <= arg_29_1.time_ and arg_29_1.time_ < var_32_31 + var_32_32 then
				arg_29_1.typewritter.percent = (arg_29_1.time_ - var_32_31) / var_32_32
