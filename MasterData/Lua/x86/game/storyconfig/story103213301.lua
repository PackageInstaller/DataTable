	...
	Play321331042 = function(arg_171_0, arg_171_1)
		...
		function arg_171_1.onSingleLineUpdate_(arg_174_0)
			...
			if 0 < arg_171_1.time_ and arg_171_1.time_ <= 0 + arg_174_0 then
				...
				local var_174_14 = var_174_11.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_174_0, iter_174_1 in ipairs((var_174_14:ToTable())) do
					iter_174_1.transform.localScale = Vector3.New(iter_174_1.transform.localScale.x / var_174_13 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_174_14 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_174_1.transform.localScale.y / var_174_13, iter_174_1.transform.localScale.z)
				end
			end

			local var_174_16 = 0

			if 0 < arg_171_1.time_ and arg_171_1.time_ <= var_174_16 + arg_174_0 then
				arg_171_1.allBtn_.enabled = false
			end

			if arg_171_1.time_ >= var_174_16 + 2 and arg_171_1.time_ < var_174_16 + 2 + arg_174_0 then
			...
			local var_174_18 = 0.85
			local var_174_19 = 1.15

			if 0.85 < arg_171_1.time_ and arg_171_1.time_ <= var_174_18 + arg_174_0 then
				...
				local var_174_20 = LeanTween.value(arg_171_1.dialog_, 0, 1, 0.3)

				var_174_20:setOnUpdate(LuaHelper.FloatAction(function(arg_175_0)
					arg_171_1.dialogCg_.alpha = arg_175_0
				end))
				var_174_20:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_171_1.dialog_)
					var_174_20:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_174_21 = arg_171_1:FormatText(arg_171_1:GetWordFromCfg(321331042).content)

				arg_171_1.text_.text = var_174_21

				LuaForUtil.ClearLinePrefixSymbol(arg_171_1.text_)

				local var_174_23 = 46 <= 0 and var_174_19 or var_174_19 * (utf8.len(var_174_21) / 46)

				if (46 <= 0 and var_174_19 or var_174_19 * (utf8.len(var_174_21) / 46)) > 0 and var_174_19 < var_174_23 then
					arg_171_1.talkMaxDuration = var_174_23
					var_174_18 = var_174_18 + 0.3

					if var_174_23 + var_174_18 > arg_171_1.duration_ then
						arg_171_1.duration_ = var_174_23 + var_174_18
					end
				end
			...
			local var_174_24 = var_174_18 + 0.3
			local var_174_25 = math.max(var_174_19, arg_171_1.talkMaxDuration)

			if var_174_18 + 0.3 <= arg_171_1.time_ and arg_171_1.time_ < var_174_24 + var_174_25 then
				arg_171_1.typewritter.percent = (arg_171_1.time_ - var_174_24) / var_174_25
