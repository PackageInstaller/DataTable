	...
	Play60103001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_0 + arg_4_0 then
				...
				local var_4_3 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60103001).content)

				arg_1_1.text_.text = var_4_3

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_5 = 43 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 43)

				if (43 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 43)) > 0 and var_4_1 < var_4_5 then
	...
	Play60103002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(60103002).content)
