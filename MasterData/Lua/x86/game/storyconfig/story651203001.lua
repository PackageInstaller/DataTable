	...
	Play651203001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				local var_4_1 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(651203001).content)

				arg_1_1.text_.text = var_4_1

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_3 = 20 <= 0 and var_4_0 or var_4_0 * (utf8.len(var_4_1) / 20)

				if (20 <= 0 and var_4_0 or var_4_0 * (utf8.len(var_4_1) / 20)) > 0 and var_4_0 < var_4_3 then
	...
	Play651203002 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				...
				arg_5_1.leftNameTxt_.text = arg_5_1:FormatText(StoryNameCfg[55].name)
				...
				local var_8_1 = arg_5_1:FormatText(arg_5_1:GetWordFromCfg(651203002).content)

				arg_5_1.text_.text = var_8_1

				LuaForUtil.ClearLinePrefixSymbol(arg_5_1.text_)

				local var_8_3 = 22 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 22)

				if (22 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 22)) > 0 and var_8_0 < var_8_3 then
