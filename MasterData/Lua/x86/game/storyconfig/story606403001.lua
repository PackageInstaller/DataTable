return {
	Play606403001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_4 = 0
			local var_4_5 = 0.233333333333333
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				...
				local var_4_6 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(606403001).content)

				arg_1_1.text_.text = var_4_6

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_8 = 4 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_6) / 4)

				if (4 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_6) / 4)) > 0 and var_4_5 < var_4_8 then
	...
	Play606403002 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				...
				local var_8_1 = arg_5_1:FormatText(arg_5_1:GetWordFromCfg(606403002).content)
