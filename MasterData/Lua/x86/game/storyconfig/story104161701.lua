	...
	Play416171009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0.566666666666667 < arg_37_1.time_ and arg_37_1.time_ <= 0.566666666666667 + arg_40_0 then
				...
				local var_40_22 = var_40_19.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_40_2, iter_40_3 in ipairs((var_40_22:ToTable())) do
					iter_40_3.transform.localScale = Vector3.New(iter_40_3.transform.localScale.x / var_40_21 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_40_22 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_40_3.transform.localScale.y / var_40_21, iter_40_3.transform.localScale.z)
				end
			end
			...
			local var_40_24 = 1.63333333333333
			local var_40_25 = 1.775

			if 1.63333333333333 < arg_37_1.time_ and arg_37_1.time_ <= var_40_24 + arg_40_0 then
				...
				local var_40_27 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(416171009).content)

				arg_37_1.text_.text = var_40_27

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_29 = 71 <= 0 and var_40_25 or var_40_25 * (utf8.len(var_40_27) / 71)

				if (71 <= 0 and var_40_25 or var_40_25 * (utf8.len(var_40_27) / 71)) > 0 and var_40_25 < var_40_29 then
	...
	Play416171028 = function(arg_123_0, arg_123_1)
		...
		function arg_123_1.onSingleLineUpdate_(arg_126_0)
			...
			if 0 < arg_123_1.time_ and arg_123_1.time_ <= 0 + arg_126_0 then
				...
				local var_126_5 = var_126_2.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_126_1, iter_126_2 in ipairs((var_126_5:ToTable())) do
					iter_126_2.transform.localScale = Vector3.New(iter_126_2.transform.localScale.x / var_126_4 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_126_5 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_126_2.transform.localScale.y / var_126_4, iter_126_2.transform.localScale.z)
				end
			end
			...
			if arg_123_1.time_ >= var_126_8 + 0.833333333333333 and arg_123_1.time_ < var_126_8 + 0.833333333333333 + arg_126_0 then
			...
			local var_126_10 = 0.833333333333333
			local var_126_11 = 0.725

			if 0.833333333333333 < arg_123_1.time_ and arg_123_1.time_ <= var_126_10 + arg_126_0 then
				...
				local var_126_13 = arg_123_1:FormatText(arg_123_1:GetWordFromCfg(416171028).content)

				arg_123_1.text_.text = var_126_13

				LuaForUtil.ClearLinePrefixSymbol(arg_123_1.text_)

				local var_126_15 = 29 <= 0 and var_126_11 or var_126_11 * (utf8.len(var_126_13) / 29)

				if (29 <= 0 and var_126_11 or var_126_11 * (utf8.len(var_126_13) / 29)) > 0 and var_126_11 < var_126_15 then
