	...
	Play1103306131 = function(arg_533_0, arg_533_1)
		...
		function arg_533_1.onSingleLineUpdate_(arg_536_0)
			...
			if 2 < arg_533_1.time_ and arg_533_1.time_ <= 2 + arg_536_0 then
				...
				local var_536_20 = var_536_17.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_536_2, iter_536_3 in ipairs((var_536_20:ToTable())) do
					iter_536_3.transform.localScale = Vector3.New(iter_536_3.transform.localScale.x / var_536_19 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_536_20 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_536_3.transform.localScale.y / var_536_19, iter_536_3.transform.localScale.z)
				end
			end
			...
			if 0 < arg_533_1.time_ and arg_533_1.time_ <= 0 + arg_536_0 then
				...
				local var_536_24 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_533_1.bgmTxt_.text ~= var_536_24 and arg_533_1.bgmTxt_.text ~= "" then
						if arg_533_1.bgmTxt2_.text ~= "" then
							arg_533_1.bgmTxt_.text = arg_533_1.bgmTxt2_.text
						end

						arg_533_1.bgmTxt2_.text = var_536_24

						arg_533_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_533_1.bgmTxt_.text = var_536_24
						arg_533_1.bgmTxt2_.text = var_536_24
					end
			...
			if 1 < arg_533_1.time_ and arg_533_1.time_ <= 1 + arg_536_0 then
				...
				local var_536_27 = manager.audio:GetAudioName("bgm_side_daily07", "bgm_side_daily07")

				if "" ~= "" then
					if arg_533_1.bgmTxt_.text ~= var_536_27 and arg_533_1.bgmTxt_.text ~= "" then
						if arg_533_1.bgmTxt2_.text ~= "" then
							arg_533_1.bgmTxt_.text = arg_533_1.bgmTxt2_.text
						end

						arg_533_1.bgmTxt2_.text = var_536_27

						arg_533_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_533_1.bgmTxt_.text = var_536_27
						arg_533_1.bgmTxt2_.text = var_536_27
					end
			...
			local var_536_30 = arg_533_1.actors_["113301ui_story"].transform

			if 2 < arg_533_1.time_ and arg_533_1.time_ <= 2 + arg_536_0 then
				arg_533_1.var_.moveOldPos113301ui_story = var_536_30.localPosition
			end

			local var_536_31 = 0.001

			if 2 <= arg_533_1.time_ and arg_533_1.time_ < 2 + var_536_31 then
				var_536_30.localPosition = Vector3.Lerp(arg_533_1.var_.moveOldPos113301ui_story, Vector3.New(0, 100, 0), (arg_533_1.time_ - 2) / var_536_31)
				var_536_30.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_536_30.position).x, (manager.ui.mainCamera.transform.position - var_536_30.position).y, (manager.ui.mainCamera.transform.position - var_536_30.position).z)
				var_536_30.localEulerAngles.z = 0
				var_536_30.localEulerAngles.x = 0
				var_536_30.localEulerAngles = var_536_30.localEulerAngles
			end

			if arg_533_1.time_ >= 2 + var_536_31 and arg_533_1.time_ < 2 + var_536_31 + arg_536_0 then
			...
			local var_536_32 = 4
			local var_536_33 = 0.975

			if 4 < arg_533_1.time_ and arg_533_1.time_ <= var_536_32 + arg_536_0 then
				...
				local var_536_34 = LeanTween.value(arg_533_1.dialog_, 0, 1, 0.3)

				var_536_34:setOnUpdate(LuaHelper.FloatAction(function(arg_539_0)
					arg_533_1.dialogCg_.alpha = arg_539_0
				end))
				var_536_34:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_533_1.dialog_)
					var_536_34:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_536_35 = arg_533_1:FormatText(arg_533_1:GetWordFromCfg(1103306131).content)

				arg_533_1.text_.text = var_536_35

				LuaForUtil.ClearLinePrefixSymbol(arg_533_1.text_)

				local var_536_37 = 39 <= 0 and var_536_33 or var_536_33 * (utf8.len(var_536_35) / 39)

				if (39 <= 0 and var_536_33 or var_536_33 * (utf8.len(var_536_35) / 39)) > 0 and var_536_33 < var_536_37 then
					arg_533_1.talkMaxDuration = var_536_37
					var_536_32 = var_536_32 + 0.3

					if var_536_37 + var_536_32 > arg_533_1.duration_ then
						arg_533_1.duration_ = var_536_37 + var_536_32
					end
				end
			...
			local var_536_38 = var_536_32 + 0.3
			local var_536_39 = math.max(var_536_33, arg_533_1.talkMaxDuration)

			if var_536_32 + 0.3 <= arg_533_1.time_ and arg_533_1.time_ < var_536_38 + var_536_39 then
				arg_533_1.typewritter.percent = (arg_533_1.time_ - var_536_38) / var_536_39
