	...
	Play419082017 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= 0 + arg_74_0 then
				...
				local var_74_3 = var_74_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_74_0, iter_74_1 in ipairs((var_74_3:ToTable())) do
					iter_74_1.transform.localScale = Vector3.New(iter_74_1.transform.localScale.x / var_74_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_74_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_74_1.transform.localScale.y / var_74_2, iter_74_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_5 + arg_74_0 then
				...
				local var_74_7 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(419082017).content)

				arg_71_1.text_.text = var_74_7

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_9 = 28 <= 0 and var_74_6 or var_74_6 * (utf8.len(var_74_7) / 28)

				if (28 <= 0 and var_74_6 or var_74_6 * (utf8.len(var_74_7) / 28)) > 0 and var_74_6 < var_74_9 then
	...
	Play419082024 = function(arg_101_0, arg_101_1)
		...
		function arg_101_1.onSingleLineUpdate_(arg_104_0)
			...
			if 0.4 < arg_101_1.time_ and arg_101_1.time_ <= 0.4 + arg_104_0 then
				...
				local var_104_6 = var_104_3.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_104_0, iter_104_1 in ipairs((var_104_6:ToTable())) do
					iter_104_1.transform.localScale = Vector3.New(iter_104_1.transform.localScale.x / var_104_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_104_6 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_104_1.transform.localScale.y / var_104_5, iter_104_1.transform.localScale.z)
				end
			end
			...
			if arg_101_1.time_ >= var_104_8 + 1.6 and arg_101_1.time_ < var_104_8 + 1.6 + arg_104_0 then
				arg_101_1.allBtn_.enabled = true
			end

			if 0.4 < arg_101_1.time_ and arg_101_1.time_ <= 0.4 + arg_104_0 then
				local var_104_9 = arg_101_1.var_.effect787

				if not arg_101_1.var_.effect787 then
					var_104_9 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_qiliu_in_keep"), manager.ui.mainCamera.transform)
					var_104_9.name = "787"
					arg_101_1.var_.effect787 = var_104_9
				else
					var_104_9.transform:SetParent(var_104_9000)
				end

				var_104_9.transform.localPosition = Vector3.New(0, -0.29, -0.76)
				var_104_9.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			local var_104_12 = 1.599999999999
			local var_104_13 = 0.825

			if 1.599999999999 < arg_101_1.time_ and arg_101_1.time_ <= var_104_12 + arg_104_0 then
				...
				local var_104_15 = arg_101_1:FormatText(arg_101_1:GetWordFromCfg(419082024).content)
