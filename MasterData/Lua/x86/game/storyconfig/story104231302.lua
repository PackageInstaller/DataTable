	...
	Play423132007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				local var_32_15 = var_32_12.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_32_6, iter_32_7 in ipairs((var_32_15:ToTable())) do
					iter_32_7.transform.localScale = Vector3.New(iter_32_7.transform.localScale.x / var_32_14 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_32_15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_32_7.transform.localScale.y / var_32_14, iter_32_7.transform.localScale.z)
				end
			end
			...
			if 1 < arg_29_1.time_ and arg_29_1.time_ <= var_32_20 + arg_32_0 then
				...
				local var_32_23 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(423132007).content)

				arg_29_1.text_.text = var_32_23

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_25 = 56 <= 0 and var_32_21 or var_32_21 * (utf8.len(var_32_23) / 56)

				if (56 <= 0 and var_32_21 or var_32_21 * (utf8.len(var_32_23) / 56)) > 0 and var_32_21 < var_32_25 then
	...
	Play423132008 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0.533333333333333 < arg_35_1.time_ and arg_35_1.time_ <= 0.533333333333333 + arg_38_0 then
				...
				local var_38_3 = var_38_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_38_0, iter_38_1 in ipairs((var_38_3:ToTable())) do
					iter_38_1.transform.localScale = Vector3.New(iter_38_1.transform.localScale.x / var_38_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_38_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_38_1.transform.localScale.y / var_38_2, iter_38_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				local var_38_6 = arg_35_1.var_.effectcaisezhadan2

				if not arg_35_1.var_.effectcaisezhadan2 then
					var_38_6 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_heibaishan"), manager.ui.mainCamera.transform)
					var_38_6.name = "caisezhadan2"
					arg_35_1.var_.effectcaisezhadan2 = var_38_6
				else
					var_38_6.transform:SetParent(var_38_9001)
				end

				var_38_6.transform.localPosition = Vector3.New(0, 0, 0)
				var_38_6.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_38_8 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_38_9 = var_38_6.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_38_2, iter_38_3 in ipairs((var_38_9:ToTable())) do
					iter_38_3.transform.localScale = Vector3.New(iter_38_3.transform.localScale.x / var_38_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_38_9 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_38_3.transform.localScale.y / var_38_8, iter_38_3.transform.localScale.z)
				end
			end
			...
			local var_38_12 = manager.ui.mainCamera.transform

			if 0.533333333333333 < arg_35_1.time_ and arg_35_1.time_ <= 0.533333333333333 + arg_38_0 then
				arg_35_1.var_.shakeOldPos = var_38_12.localPosition
			end

			local var_38_13 = 2

			if 0.533333333333333 <= arg_35_1.time_ and arg_35_1.time_ < 0.533333333333333 + var_38_13 then
				local var_38_14, var_38_15 = math.modf((arg_35_1.time_ - 0.533333333333333) / 0.066)

				var_38_12.localPosition = Vector3.New(var_38_15 * 0.2, var_38_15 * 0.2, var_38_15 * 0.2) + arg_35_1.var_.shakeOldPos
			end

			if arg_35_1.time_ >= 0.533333333333333 + var_38_13 and arg_35_1.time_ < 0.533333333333333 + var_38_13 + arg_38_0 then
				var_38_12.localPosition = arg_35_1.var_.shakeOldPos
			end
			...
			if arg_35_1.time_ >= var_38_16 + 2 and arg_35_1.time_ < var_38_16 + 2 + arg_38_0 then
			...
			if 0.533333333333333 < arg_35_1.time_ and arg_35_1.time_ <= 0.533333333333333 + arg_38_0 then
				local var_38_18 = arg_35_1.var_.effectyanhualiangjingjing1

				if not arg_35_1.var_.effectyanhualiangjingjing1 then
					var_38_18 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_xishan"), manager.ui.mainCamera.transform)
					var_38_18.name = "yanhualiangjingjing1"
					arg_35_1.var_.effectyanhualiangjingjing1 = var_38_18
				else
					var_38_18.transform:SetParent(var_38_9000)
				end

				var_38_18.transform.localPosition = Vector3.New(0, 0, -10)
				var_38_18.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_38_20 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_38_21 = var_38_18.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_38_4, iter_38_5 in ipairs((var_38_21:ToTable())) do
					iter_38_5.transform.localScale = Vector3.New(iter_38_5.transform.localScale.x / var_38_20 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_38_21 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_38_5.transform.localScale.y / var_38_20, iter_38_5.transform.localScale.z)
				end
			end
			...
			if 2 < arg_35_1.time_ and arg_35_1.time_ <= var_38_23 + arg_38_0 then
				...
				local var_38_26 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(423132008).content)

				arg_35_1.text_.text = var_38_26

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_28 = 52 <= 0 and var_38_24 or var_38_24 * (utf8.len(var_38_26) / 52)

				if (52 <= 0 and var_38_24 or var_38_24 * (utf8.len(var_38_26) / 52)) > 0 and var_38_24 < var_38_28 then
					arg_35_1.talkMaxDuration = var_38_28
					var_38_23 = var_38_23 + 0.3

					if var_38_28 + var_38_23 > arg_35_1.duration_ then
						arg_35_1.duration_ = var_38_28 + var_38_23
					end
				end
			...
			local var_38_29 = var_38_23 + 0.3
			local var_38_30 = math.max(var_38_24, arg_35_1.talkMaxDuration)

			if var_38_23 + 0.3 <= arg_35_1.time_ and arg_35_1.time_ < var_38_29 + var_38_30 then
				arg_35_1.typewritter.percent = (arg_35_1.time_ - var_38_29) / var_38_30
