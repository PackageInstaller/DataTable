	...
	Play62108001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				local var_4_17 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(62108001).content)
	...
	Play62108002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_8 + arg_12_0 then
				...
				local var_12_10 = arg_9_1:GetWordFromCfg(62108002)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62108", "62108002", "story_v_chess_62108.awb") ~= 0 then
					local var_12_14 = manager.audio:GetVoiceLength("story_v_chess_62108", "62108002", "story_v_chess_62108.awb") / 1000
					...
					if var_12_10.prefab_name ~= "" and arg_9_1.actors_[var_12_10.prefab_name] ~= nil then
						local var_12_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_10.prefab_name].transform, "story_v_chess_62108", "62108002", "story_v_chess_62108.awb")

						arg_9_1:RecordAudio("62108002", var_12_15)
						arg_9_1:RecordAudio("62108002", var_12_15)
					else
	...
	Play62108003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_1 + arg_16_0 then
				...
				local var_16_3 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(62108003).content)
	...
	Play62108004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_3 + arg_20_0 then
				...
				local var_20_5 = arg_17_1:GetWordFromCfg(62108004)
				...
				local var_20_8 = 61 <= 0 and var_20_4 or var_20_4 * (utf8.len(var_20_6) / 61)

				if (61 <= 0 and var_20_4 or var_20_4 * (utf8.len(var_20_6) / 61)) > 0 and var_20_4 < var_20_8 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62108", "62108004", "story_v_chess_62108.awb") ~= 0 then
					local var_20_9 = manager.audio:GetVoiceLength("story_v_chess_62108", "62108004", "story_v_chess_62108.awb") / 1000
					...
					if var_20_5.prefab_name ~= "" and arg_17_1.actors_[var_20_5.prefab_name] ~= nil then
						local var_20_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_5.prefab_name].transform, "story_v_chess_62108", "62108004", "story_v_chess_62108.awb")

						arg_17_1:RecordAudio("62108004", var_20_10)
						arg_17_1:RecordAudio("62108004", var_20_10)
					else
	...
	Play62108005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_2 = arg_21_1:GetWordFromCfg(62108005)
				...
				local var_24_5 = 51 <= 0 and var_24_1 or var_24_1 * (utf8.len(var_24_3) / 51)

				if (51 <= 0 and var_24_1 or var_24_1 * (utf8.len(var_24_3) / 51)) > 0 and var_24_1 < var_24_5 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62108", "62108005", "story_v_chess_62108.awb") ~= 0 then
					local var_24_6 = manager.audio:GetVoiceLength("story_v_chess_62108", "62108005", "story_v_chess_62108.awb") / 1000
					...
					if var_24_2.prefab_name ~= "" and arg_21_1.actors_[var_24_2.prefab_name] ~= nil then
						local var_24_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_2.prefab_name].transform, "story_v_chess_62108", "62108005", "story_v_chess_62108.awb")

						arg_21_1:RecordAudio("62108005", var_24_7)
						arg_21_1:RecordAudio("62108005", var_24_7)
					else
	...
	Play62108006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(62108006).content)
