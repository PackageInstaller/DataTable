	...
	Play417111121 = function(arg_503_0, arg_503_1)
		...
		function arg_503_1.onSingleLineUpdate_(arg_506_0)
			if 0 < arg_503_1.time_ and arg_503_1.time_ <= 0 + arg_506_0 then
				...
				local var_506_3 = var_506_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_506_0, iter_506_1 in ipairs((var_506_3:ToTable())) do
					iter_506_1.transform.localScale = Vector3.New(iter_506_1.transform.localScale.x / var_506_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_506_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_506_1.transform.localScale.y / var_506_2, iter_506_1.transform.localScale.z)
				end
			end
			...
			local var_506_6 = 0.266666666666667

			if var_506_5 <= arg_503_1.time_ and arg_503_1.time_ < var_506_5 + var_506_6 then
				local var_506_7 = Color.New(1, 1, 1)

				var_506_7.a = Mathf.Lerp(1, 0, (arg_503_1.time_ - var_506_5) / var_506_6)
				arg_503_1.mask_.color = var_506_7
			end

			if arg_503_1.time_ >= var_506_5 + var_506_6 and arg_503_1.time_ < var_506_5 + var_506_6 + arg_506_0 then
				local var_506_8 = Color.New(1, 1, 1)

				arg_503_1.mask_.enabled = false
				var_506_8.a = 0
				arg_503_1.mask_.color = var_506_8
			end

			local var_506_9 = arg_503_1.bgs_.SS1704.transform

			if 0 < arg_503_1.time_ and arg_503_1.time_ <= 0 + arg_506_0 then
				arg_503_1.var_.moveOldPosSS1704 = var_506_9.localPosition
			end

			local var_506_10 = 0.001

			if 0 <= arg_503_1.time_ and arg_503_1.time_ < 0 + var_506_10 then
				var_506_9.localPosition = Vector3.Lerp(arg_503_1.var_.moveOldPosSS1704, Vector3.New(0, 1, 9), (arg_503_1.time_ - 0) / var_506_10)
			end

			if arg_503_1.time_ >= 0 + var_506_10 and arg_503_1.time_ < 0 + var_506_10 + arg_506_0 then
				var_506_9.localPosition = Vector3.New(0, 1, 9)
			end

			local var_506_11 = arg_503_1.bgs_.SS1704.transform

			if 0.0166666666666667 < arg_503_1.time_ and arg_503_1.time_ <= 0.0166666666666667 + arg_506_0 then
				arg_503_1.var_.moveOldPosSS1704 = var_506_11.localPosition
			end

			local var_506_12 = 0.816666666666667

			if 0.0166666666666667 <= arg_503_1.time_ and arg_503_1.time_ < 0.0166666666666667 + var_506_12 then
				var_506_11.localPosition = Vector3.Lerp(arg_503_1.var_.moveOldPosSS1704, Vector3.New(0, 1, 10), (arg_503_1.time_ - 0.0166666666666667) / var_506_12)
			end

			if arg_503_1.time_ >= 0.0166666666666667 + var_506_12 and arg_503_1.time_ < 0.0166666666666667 + var_506_12 + arg_506_0 then
				var_506_11.localPosition = Vector3.New(0, 1, 10)
			end

			local var_506_13 = 0

			if 0 < arg_503_1.time_ and arg_503_1.time_ <= var_506_13 + arg_506_0 then
				arg_503_1.allBtn_.enabled = false
			end

			if arg_503_1.time_ >= var_506_13 + 1.73771769693121 and arg_503_1.time_ < var_506_13 + 1.73771769693121 + arg_506_0 then
			...
			local var_506_15 = 1.26666666666667
			local var_506_16 = 1.1

			if 1.26666666666667 < arg_503_1.time_ and arg_503_1.time_ <= var_506_15 + arg_506_0 then
				...
				local var_506_17 = LeanTween.value(arg_503_1.dialog_, 0, 1, 0.3)

				var_506_17:setOnUpdate(LuaHelper.FloatAction(function(arg_507_0)
					arg_503_1.dialogCg_.alpha = arg_507_0
				end))
				var_506_17:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_503_1.dialog_)
					var_506_17:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_506_18 = arg_503_1:FormatText(arg_503_1:GetWordFromCfg(417111121).content)

				arg_503_1.text_.text = var_506_18

				LuaForUtil.ClearLinePrefixSymbol(arg_503_1.text_)

				local var_506_20 = 44 <= 0 and var_506_16 or var_506_16 * (utf8.len(var_506_18) / 44)

				if (44 <= 0 and var_506_16 or var_506_16 * (utf8.len(var_506_18) / 44)) > 0 and var_506_16 < var_506_20 then
					arg_503_1.talkMaxDuration = var_506_20
					var_506_15 = var_506_15 + 0.3

					if var_506_20 + var_506_15 > arg_503_1.duration_ then
						arg_503_1.duration_ = var_506_20 + var_506_15
					end
				end
			...
			local var_506_21 = var_506_15 + 0.3
			local var_506_22 = math.max(var_506_16, arg_503_1.talkMaxDuration)

			if var_506_15 + 0.3 <= arg_503_1.time_ and arg_503_1.time_ < var_506_21 + var_506_22 then
				arg_503_1.typewritter.percent = (arg_503_1.time_ - var_506_21) / var_506_22
