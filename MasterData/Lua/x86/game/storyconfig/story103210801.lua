	...
	Play321081085 = function(arg_347_0, arg_347_1)
		...
		function arg_347_1.onSingleLineUpdate_(arg_350_0)
			...
			if 0 < arg_347_1.time_ and arg_347_1.time_ <= 0 + arg_350_0 then
				...
				local var_350_6 = var_350_3.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_350_0, iter_350_1 in ipairs((var_350_6:ToTable())) do
					iter_350_1.transform.localScale = Vector3.New(iter_350_1.transform.localScale.x / var_350_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_350_6 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_350_1.transform.localScale.y / var_350_5, iter_350_1.transform.localScale.z)
				end
			end
			...
			local var_350_8 = 0.433333333333333
			local var_350_9 = 0.1

			if 0.433333333333333 < arg_347_1.time_ and arg_347_1.time_ <= var_350_8 + arg_350_0 then
				...
				local var_350_11 = arg_347_1:GetWordFromCfg(321081085)
				...
				local var_350_14 = 4 <= 0 and var_350_9 or var_350_9 * (utf8.len(var_350_12) / 4)

				if (4 <= 0 and var_350_9 or var_350_9 * (utf8.len(var_350_12) / 4)) > 0 and var_350_9 < var_350_14 then
				...
				if manager.audio:GetVoiceLength("story_v_out_321081", "321081085", "story_v_out_321081.awb") ~= 0 then
					local var_350_15 = manager.audio:GetVoiceLength("story_v_out_321081", "321081085", "story_v_out_321081.awb") / 1000
					...
					if var_350_11.prefab_name ~= "" and arg_347_1.actors_[var_350_11.prefab_name] ~= nil then
						local var_350_16 = LuaForUtil.PlayVoiceWithCriLipsync(arg_347_1.actors_[var_350_11.prefab_name].transform, "story_v_out_321081", "321081085", "story_v_out_321081.awb")

						arg_347_1:RecordAudio("321081085", var_350_16)
						arg_347_1:RecordAudio("321081085", var_350_16)
					else
			...
			local var_350_17 = var_350_8 + 0.3
			local var_350_18 = math.max(var_350_9, arg_347_1.talkMaxDuration)

			if var_350_8 + 0.3 <= arg_347_1.time_ and arg_347_1.time_ < var_350_17 + var_350_18 then
				arg_347_1.typewritter.percent = (arg_347_1.time_ - var_350_17) / var_350_18

				arg_347_1.typewritter:SetDirty()
			end

			if arg_347_1.time_ >= var_350_17 + var_350_18 and arg_347_1.time_ < var_350_17 + var_350_18 + arg_350_0 then
	...
	Play321081089 = function(arg_365_0, arg_365_1)
		...
		function arg_365_1.onSingleLineUpdate_(arg_368_0)
			if 0.6 < arg_365_1.time_ and arg_365_1.time_ <= 0.6 + arg_368_0 then
				...
				local var_368_3 = var_368_0.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_368_0, iter_368_1 in ipairs((var_368_3:ToTable())) do
					iter_368_1.transform.localScale = Vector3.New(iter_368_1.transform.localScale.x / var_368_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_368_3 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_368_1.transform.localScale.y / var_368_2, iter_368_1.transform.localScale.z)
				end
			end
			...
			if 0.133333333333333 < arg_365_1.time_ and arg_365_1.time_ <= 0.133333333333333 + arg_368_0 then
				arg_365_1.var_.shakeOldPos = var_368_5.localPosition
			end

			local var_368_6 = 1

			if 0.133333333333333 <= arg_365_1.time_ and arg_365_1.time_ < 0.133333333333333 + var_368_6 then
				local var_368_7, var_368_8 = math.modf((arg_365_1.time_ - 0.133333333333333) / 0.066)

				var_368_5.localPosition = Vector3.New(var_368_8 * 0.13, var_368_8 * 0.13, var_368_8 * 0.13) + arg_365_1.var_.shakeOldPos
			end

			if arg_365_1.time_ >= 0.133333333333333 + var_368_6 and arg_365_1.time_ < 0.133333333333333 + var_368_6 + arg_368_0 then
				var_368_5.localPosition = arg_365_1.var_.shakeOldPos
			end

			local var_368_9 = 0.3

			if 0.3 < arg_365_1.time_ and arg_365_1.time_ <= var_368_9 + arg_368_0 then
				arg_365_1.allBtn_.enabled = false
			end

			if arg_365_1.time_ >= var_368_9 + 3 and arg_365_1.time_ < var_368_9 + 3 + arg_368_0 then
			...
			if arg_365_1.time_ >= var_368_10 + var_368_11 and arg_365_1.time_ < var_368_10 + var_368_11 + arg_368_0 then
				local var_368_13 = Color.New(1, 1, 1)

				arg_365_1.mask_.enabled = false
				var_368_13.a = 0
				arg_365_1.mask_.color = var_368_13
			end
			...
			local var_368_15 = 3.1
			local var_368_16 = 1.725

			if 3.1 < arg_365_1.time_ and arg_365_1.time_ <= var_368_15 + arg_368_0 then
				...
				local var_368_17 = LeanTween.value(arg_365_1.dialog_, 0, 1, 0.3)

				var_368_17:setOnUpdate(LuaHelper.FloatAction(function(arg_369_0)
					arg_365_1.dialogCg_.alpha = arg_369_0
				end))
				var_368_17:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_365_1.dialog_)
					var_368_17:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_368_18 = arg_365_1:FormatText(arg_365_1:GetWordFromCfg(321081089).content)

				arg_365_1.text_.text = var_368_18

				LuaForUtil.ClearLinePrefixSymbol(arg_365_1.text_)

				local var_368_20 = 69 <= 0 and var_368_16 or var_368_16 * (utf8.len(var_368_18) / 69)

				if (69 <= 0 and var_368_16 or var_368_16 * (utf8.len(var_368_18) / 69)) > 0 and var_368_16 < var_368_20 then
					arg_365_1.talkMaxDuration = var_368_20
					var_368_15 = var_368_15 + 0.3

					if var_368_20 + var_368_15 > arg_365_1.duration_ then
						arg_365_1.duration_ = var_368_20 + var_368_15
					end
				end
			...
			local var_368_21 = var_368_15 + 0.3
			local var_368_22 = math.max(var_368_16, arg_365_1.talkMaxDuration)

			if var_368_15 + 0.3 <= arg_365_1.time_ and arg_365_1.time_ < var_368_21 + var_368_22 then
	...
	Play321081091 = function(arg_375_0, arg_375_1)
		...
		function arg_375_1.onSingleLineUpdate_(arg_378_0)
			...
			if 0 < arg_375_1.time_ and arg_375_1.time_ <= 0 + arg_378_0 then
				...
				local var_378_5 = var_378_2.transform:GetComponentsInChildren(typeof(Transform), true)

				for iter_378_0, iter_378_1 in ipairs((var_378_5:ToTable())) do
					iter_378_1.transform.localScale = Vector3.New(iter_378_1.transform.localScale.x / var_378_4 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * var_378_5 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_378_1.transform.localScale.y / var_378_4, iter_378_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_375_1.time_ and arg_375_1.time_ <= var_378_7 + arg_378_0 then
				...
				local var_378_10 = arg_375_1:FormatText(arg_375_1:GetWordFromCfg(321081091).content)

				arg_375_1.text_.text = var_378_10

				LuaForUtil.ClearLinePrefixSymbol(arg_375_1.text_)

				local var_378_12 = 40 <= 0 and var_378_8 or var_378_8 * (utf8.len(var_378_10) / 40)

				if (40 <= 0 and var_378_8 or var_378_8 * (utf8.len(var_378_10) / 40)) > 0 and var_378_8 < var_378_12 then
					arg_375_1.talkMaxDuration = var_378_12
					var_378_7 = var_378_7 + 0.3

					if var_378_12 + var_378_7 > arg_375_1.duration_ then
						arg_375_1.duration_ = var_378_12 + var_378_7
					end
				end
			...
			local var_378_13 = var_378_7 + 0.3
			local var_378_14 = math.max(var_378_8, arg_375_1.talkMaxDuration)

			if var_378_7 + 0.3 <= arg_375_1.time_ and arg_375_1.time_ < var_378_13 + var_378_14 then
