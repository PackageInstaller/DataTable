return {
	Play937041001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 then
				...
				local var_4_18 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(937041001).content)
	...
	Play937041002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if arg_9_1.actors_["1053ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1053ui_story"))) then
				local var_12_0 = Object.Instantiate(Asset.Load("Char/" .. "1053ui_story"), arg_9_1.stage_.transform)

				var_12_0.name = "1053ui_story"
				var_12_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_9_1.actors_["1053ui_story"] = var_12_0
				...
				arg_9_1.var_["1053ui_story" .. "Animator"] = var_12_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_9_1.var_["1053ui_story" .. "Animator"].applyRootMotion = true
				arg_9_1.var_["1053ui_story" .. "LipSync"] = var_12_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_12_3 = arg_9_1.actors_["1053ui_story"].transform

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				arg_9_1.var_.moveOldPos1053ui_story = var_12_3.localPosition
			...
			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_5 then
				var_12_3.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1053ui_story, Vector3.New(0, -1.08, -6), (arg_9_1.time_ - 0) / var_12_5)
			...
			local var_12_7 = arg_9_1.actors_["1053ui_story"]

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(var_12_7) and arg_9_1.var_.characterEffect1053ui_story == nil then
				arg_9_1.var_.characterEffect1053ui_story = var_12_7:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_8 = 0.200000002980232

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_8 and not isNil(var_12_7) then
				if arg_9_1.var_.characterEffect1053ui_story and not isNil(var_12_7) then
					arg_9_1.var_.characterEffect1053ui_story.fillFlat = false
				end
			end

			if arg_9_1.time_ >= 0 + var_12_8 and arg_9_1.time_ < 0 + var_12_8 + arg_12_0 and not isNil(var_12_7) and arg_9_1.var_.characterEffect1053ui_story then
				arg_9_1.var_.characterEffect1053ui_story.fillFlat = false
			end
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_10 + arg_12_0 then
				...
				local var_12_12 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(937041002).content)

				arg_9_1.text_.text = var_12_12

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_14 = 22 <= 0 and var_12_11 or var_12_11 * (utf8.len(var_12_12) / 22)

				if (22 <= 0 and var_12_11 or var_12_11 * (utf8.len(var_12_12) / 22)) > 0 and var_12_11 < var_12_14 then
	...
	Play937041003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos1053ui_story = arg_13_1.actors_["1053ui_story"].transform.localPosition

				local var_16_0 = GameObjectTools.GetOrAddComponent(arg_13_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_1 then
				arg_13_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1053ui_story, Vector3.New(0, 100, 0), (arg_13_1.time_ - 0) / var_16_1)
				arg_13_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_13_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1053ui_story"].transform.position).z)
				arg_13_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_13_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_13_1.actors_["1053ui_story"].transform.localEulerAngles = arg_13_1.actors_["1053ui_story"].transform.localEulerAngles
			end

			if arg_13_1.time_ >= 0 + var_16_1 and arg_13_1.time_ < 0 + var_16_1 + arg_16_0 then
				arg_13_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_13_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_13_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1053ui_story"].transform.position).z)
				arg_13_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_13_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_13_1.actors_["1053ui_story"].transform.localEulerAngles = arg_13_1.actors_["1053ui_story"].transform.localEulerAngles

				local var_16_2 = GameObjectTools.GetOrAddComponent(arg_13_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			local var_16_3 = arg_13_1.actors_["1053ui_story"]

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 and not isNil(var_16_3) and arg_13_1.var_.characterEffect1053ui_story == nil then
				arg_13_1.var_.characterEffect1053ui_story = var_16_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_16_4 = 0.200000002980232

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_4 and not isNil(var_16_3) then
				if arg_13_1.var_.characterEffect1053ui_story and not isNil(var_16_3) then
					arg_13_1.var_.characterEffect1053ui_story.fillFlat = true
					arg_13_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_13_1.time_ - 0) / var_16_4)
				end
			end

			if arg_13_1.time_ >= 0 + var_16_4 and arg_13_1.time_ < 0 + var_16_4 + arg_16_0 and not isNil(var_16_3) and arg_13_1.var_.characterEffect1053ui_story then
				arg_13_1.var_.characterEffect1053ui_story.fillFlat = true
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_5 + arg_16_0 then
				...
				local var_16_7 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(937041003).content)

				arg_13_1.text_.text = var_16_7

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_9 = 24 <= 0 and var_16_6 or var_16_6 * (utf8.len(var_16_7) / 24)

				if (24 <= 0 and var_16_6 or var_16_6 * (utf8.len(var_16_7) / 24)) > 0 and var_16_6 < var_16_9 then
	...
	Play937041004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				arg_17_1.var_.moveOldPos1053ui_story = arg_17_1.actors_["1053ui_story"].transform.localPosition

				local var_20_0 = GameObjectTools.GetOrAddComponent(arg_17_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_1 then
				arg_17_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos1053ui_story, Vector3.New(0, -1.08, -6), (arg_17_1.time_ - 0) / var_20_1)
				arg_17_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_17_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_17_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_17_1.actors_["1053ui_story"].transform.position).z)
				arg_17_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_17_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_17_1.actors_["1053ui_story"].transform.localEulerAngles = arg_17_1.actors_["1053ui_story"].transform.localEulerAngles
			end

			if arg_17_1.time_ >= 0 + var_20_1 and arg_17_1.time_ < 0 + var_20_1 + arg_20_0 then
				arg_17_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, -1.08, -6)
				arg_17_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_17_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_17_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_17_1.actors_["1053ui_story"].transform.position).z)
				arg_17_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_17_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_17_1.actors_["1053ui_story"].transform.localEulerAngles = arg_17_1.actors_["1053ui_story"].transform.localEulerAngles

				local var_20_2 = GameObjectTools.GetOrAddComponent(arg_17_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			local var_20_3 = arg_17_1.actors_["1053ui_story"]

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(var_20_3) and arg_17_1.var_.characterEffect1053ui_story == nil then
				arg_17_1.var_.characterEffect1053ui_story = var_20_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_4 = 0.200000002980232

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_4 and not isNil(var_20_3) then
				if arg_17_1.var_.characterEffect1053ui_story and not isNil(var_20_3) then
					arg_17_1.var_.characterEffect1053ui_story.fillFlat = false
				end
			end

			if arg_17_1.time_ >= 0 + var_20_4 and arg_17_1.time_ < 0 + var_20_4 + arg_20_0 and not isNil(var_20_3) and arg_17_1.var_.characterEffect1053ui_story then
				arg_17_1.var_.characterEffect1053ui_story.fillFlat = false
			end
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_8 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(937041004).content)

				arg_17_1.text_.text = var_20_8

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_10 = 44 <= 0 and var_20_7 or var_20_7 * (utf8.len(var_20_8) / 44)

				if (44 <= 0 and var_20_7 or var_20_7 * (utf8.len(var_20_8) / 44)) > 0 and var_20_7 < var_20_10 then
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_0 and not isNil(arg_21_1.actors_["1053ui_story"]) then
				if arg_21_1.var_.characterEffect1053ui_story and not isNil(arg_21_1.actors_["1053ui_story"]) then
					...
					arg_21_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_21_1.time_ - 0) / var_24_0)
				end
			end
			...
			if arg_21_1.time_ >= 0 + var_24_0 and arg_21_1.time_ < 0 + var_24_0 + arg_24_0 and not isNil(arg_21_1.actors_["1053ui_story"]) and arg_21_1.var_.characterEffect1053ui_story then
				arg_21_1.var_.characterEffect1053ui_story.fillFlat = true
				arg_21_1.var_.characterEffect1053ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_1 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(937041005).content)
	...
	Play937041006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(arg_25_1.actors_["1053ui_story"]) and arg_25_1.var_.characterEffect1053ui_story == nil then
				arg_25_1.var_.characterEffect1053ui_story = arg_25_1.actors_["1053ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_28_0 = 0.200000002980232

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_0 and not isNil(arg_25_1.actors_["1053ui_story"]) then
				if arg_25_1.var_.characterEffect1053ui_story and not isNil(arg_25_1.actors_["1053ui_story"]) then
					arg_25_1.var_.characterEffect1053ui_story.fillFlat = false
				end
			end

			if arg_25_1.time_ >= 0 + var_28_0 and arg_25_1.time_ < 0 + var_28_0 + arg_28_0 and not isNil(arg_25_1.actors_["1053ui_story"]) and arg_25_1.var_.characterEffect1053ui_story then
				arg_25_1.var_.characterEffect1053ui_story.fillFlat = false
			end
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(937041006).content)
	...
	Play937041007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(arg_29_1.actors_["1053ui_story"]) and arg_29_1.var_.characterEffect1053ui_story == nil then
				arg_29_1.var_.characterEffect1053ui_story = arg_29_1.actors_["1053ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_32_0 = 0.200000002980232

			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_0 and not isNil(arg_29_1.actors_["1053ui_story"]) then
				if arg_29_1.var_.characterEffect1053ui_story and not isNil(arg_29_1.actors_["1053ui_story"]) then
					arg_29_1.var_.characterEffect1053ui_story.fillFlat = true
					arg_29_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_29_1.time_ - 0) / var_32_0)
				end
			end

			if arg_29_1.time_ >= 0 + var_32_0 and arg_29_1.time_ < 0 + var_32_0 + arg_32_0 and not isNil(arg_29_1.actors_["1053ui_story"]) and arg_29_1.var_.characterEffect1053ui_story then
				arg_29_1.var_.characterEffect1053ui_story.fillFlat = true
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(937041007).content)

				arg_29_1.text_.text = var_32_3

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_5 = 48 <= 0 and var_32_2 or var_32_2 * (utf8.len(var_32_3) / 48)

				if (48 <= 0 and var_32_2 or var_32_2 * (utf8.len(var_32_3) / 48)) > 0 and var_32_2 < var_32_5 then
	...
	Play937041008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				arg_33_1.var_.moveOldPos1053ui_story = arg_33_1.actors_["1053ui_story"].transform.localPosition

				local var_36_0 = GameObjectTools.GetOrAddComponent(arg_33_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_1 then
				arg_33_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_33_1.var_.moveOldPos1053ui_story, Vector3.New(0, 100, 0), (arg_33_1.time_ - 0) / var_36_1)
				arg_33_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_33_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_33_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_33_1.actors_["1053ui_story"].transform.position).z)
				arg_33_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_33_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_33_1.actors_["1053ui_story"].transform.localEulerAngles = arg_33_1.actors_["1053ui_story"].transform.localEulerAngles
			end

			if arg_33_1.time_ >= 0 + var_36_1 and arg_33_1.time_ < 0 + var_36_1 + arg_36_0 then
				arg_33_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_33_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_33_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_33_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_33_1.actors_["1053ui_story"].transform.position).z)
				arg_33_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_33_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_33_1.actors_["1053ui_story"].transform.localEulerAngles = arg_33_1.actors_["1053ui_story"].transform.localEulerAngles

				local var_36_2 = GameObjectTools.GetOrAddComponent(arg_33_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_3 + arg_36_0 then
				...
				local var_36_5 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(937041008).content)
	...
	Play937041009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 <= arg_37_1.time_ and arg_37_1.time_ < 0 + var_40_1 then
				arg_37_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_37_1.var_.moveOldPos1053ui_story, Vector3.New(0, -1.08, -6), (arg_37_1.time_ - 0) / var_40_1)
			...
			if arg_37_1.time_ >= 0 + var_40_1 and arg_37_1.time_ < 0 + var_40_1 + arg_40_0 then
				arg_37_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, -1.08, -6)
				arg_37_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_37_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_37_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_37_1.actors_["1053ui_story"].transform.position).z)
				arg_37_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_37_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_37_1.actors_["1053ui_story"].transform.localEulerAngles = arg_37_1.actors_["1053ui_story"].transform.localEulerAngles
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_6 + arg_40_0 then
				...
				local var_40_8 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(937041009).content)

				arg_37_1.text_.text = var_40_8

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_10 = 36 <= 0 and var_40_7 or var_40_7 * (utf8.len(var_40_8) / 36)

				if (36 <= 0 and var_40_7 or var_40_7 * (utf8.len(var_40_8) / 36)) > 0 and var_40_7 < var_40_10 then
	...
	Play937041010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(arg_41_1.actors_["1053ui_story"]) and arg_41_1.var_.characterEffect1053ui_story == nil then
				arg_41_1.var_.characterEffect1053ui_story = arg_41_1.actors_["1053ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_44_0 = 0.200000002980232

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_0 and not isNil(arg_41_1.actors_["1053ui_story"]) then
				if arg_41_1.var_.characterEffect1053ui_story and not isNil(arg_41_1.actors_["1053ui_story"]) then
					arg_41_1.var_.characterEffect1053ui_story.fillFlat = true
					arg_41_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_41_1.time_ - 0) / var_44_0)
				end
			end

			if arg_41_1.time_ >= 0 + var_44_0 and arg_41_1.time_ < 0 + var_44_0 + arg_44_0 and not isNil(arg_41_1.actors_["1053ui_story"]) and arg_41_1.var_.characterEffect1053ui_story then
				arg_41_1.var_.characterEffect1053ui_story.fillFlat = true
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(937041010).content)
	...
	Play937041011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 then
				...
				local var_48_4 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(937041011).content)

				arg_45_1.text_.text = var_48_4

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_6 = 13 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 13)

				if (13 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 13)) > 0 and var_48_3 < var_48_6 then
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_0 and not isNil(arg_49_1.actors_["1053ui_story"]) then
				if arg_49_1.var_.characterEffect1053ui_story and not isNil(arg_49_1.actors_["1053ui_story"]) then
					...
					arg_49_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_49_1.time_ - 0) / var_52_0)
				end
			end
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(937041012).content)

				arg_49_1.text_.text = var_52_3

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_5 = 14 <= 0 and var_52_2 or var_52_2 * (utf8.len(var_52_3) / 14)

				if (14 <= 0 and var_52_2 or var_52_2 * (utf8.len(var_52_3) / 14)) > 0 and var_52_2 < var_52_5 then
	...
	Play937041013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_2 + arg_56_0 then
				...
				local var_56_4 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(937041013).content)

				arg_53_1.text_.text = var_56_4

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_6 = 13 <= 0 and var_56_3 or var_56_3 * (utf8.len(var_56_4) / 13)

				if (13 <= 0 and var_56_3 or var_56_3 * (utf8.len(var_56_4) / 13)) > 0 and var_56_3 < var_56_6 then
	...
	Play937041014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_1 + arg_60_0 then
				...
				local var_60_3 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(937041014).content)
	...
	Play937041015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_2 + arg_64_0 then
				...
				local var_64_4 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(937041015).content)

				arg_61_1.text_.text = var_64_4

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_6 = 34 <= 0 and var_64_3 or var_64_3 * (utf8.len(var_64_4) / 34)

				if (34 <= 0 and var_64_3 or var_64_3 * (utf8.len(var_64_4) / 34)) > 0 and var_64_3 < var_64_6 then
	...
	Play937041016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				arg_65_1.var_.moveOldPos1053ui_story = arg_65_1.actors_["1053ui_story"].transform.localPosition

				local var_68_0 = GameObjectTools.GetOrAddComponent(arg_65_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_1 then
				arg_65_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_65_1.var_.moveOldPos1053ui_story, Vector3.New(0, 100, 0), (arg_65_1.time_ - 0) / var_68_1)
				arg_65_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_65_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_65_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_65_1.actors_["1053ui_story"].transform.position).z)
				arg_65_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_65_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_65_1.actors_["1053ui_story"].transform.localEulerAngles = arg_65_1.actors_["1053ui_story"].transform.localEulerAngles
			end

			if arg_65_1.time_ >= 0 + var_68_1 and arg_65_1.time_ < 0 + var_68_1 + arg_68_0 then
				arg_65_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_65_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_65_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_65_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_65_1.actors_["1053ui_story"].transform.position).z)
				arg_65_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_65_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_65_1.actors_["1053ui_story"].transform.localEulerAngles = arg_65_1.actors_["1053ui_story"].transform.localEulerAngles

				local var_68_2 = GameObjectTools.GetOrAddComponent(arg_65_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			local var_68_3 = arg_65_1.actors_["1053ui_story"]

			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 and not isNil(var_68_3) and arg_65_1.var_.characterEffect1053ui_story == nil then
				arg_65_1.var_.characterEffect1053ui_story = var_68_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_68_4 = 0.200000002980232

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_4 and not isNil(var_68_3) then
				if arg_65_1.var_.characterEffect1053ui_story and not isNil(var_68_3) then
					arg_65_1.var_.characterEffect1053ui_story.fillFlat = true
					arg_65_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_65_1.time_ - 0) / var_68_4)
				end
			end

			if arg_65_1.time_ >= 0 + var_68_4 and arg_65_1.time_ < 0 + var_68_4 + arg_68_0 and not isNil(var_68_3) and arg_65_1.var_.characterEffect1053ui_story then
				arg_65_1.var_.characterEffect1053ui_story.fillFlat = true
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_5 + arg_68_0 then
				...
				local var_68_7 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(937041016).content)

				arg_65_1.text_.text = var_68_7

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_9 = 28 <= 0 and var_68_6 or var_68_6 * (utf8.len(var_68_7) / 28)

				if (28 <= 0 and var_68_6 or var_68_6 * (utf8.len(var_68_7) / 28)) > 0 and var_68_6 < var_68_9 then
	...
	Play937041017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_6 + arg_72_0 then
				...
				local var_72_8 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(937041017).content)

				arg_69_1.text_.text = var_72_8

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_10 = 38 <= 0 and var_72_7 or var_72_7 * (utf8.len(var_72_8) / 38)

				if (38 <= 0 and var_72_7 or var_72_7 * (utf8.len(var_72_8) / 38)) > 0 and var_72_7 < var_72_10 then
	...
	Play937041018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_1 + arg_76_0 then
				...
				local var_76_3 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(937041018).content)
	...
	Play937041019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_2 + arg_80_0 then
				...
				local var_80_4 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(937041019).content)

				arg_77_1.text_.text = var_80_4

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_6 = 35 <= 0 and var_80_3 or var_80_3 * (utf8.len(var_80_4) / 35)

				if (35 <= 0 and var_80_3 or var_80_3 * (utf8.len(var_80_4) / 35)) > 0 and var_80_3 < var_80_6 then
	...
	Play937041020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 <= arg_81_1.time_ and arg_81_1.time_ < 0 + var_84_1 then
				arg_81_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_81_1.var_.moveOldPos1053ui_story, Vector3.New(0, 100, 0), (arg_81_1.time_ - 0) / var_84_1)
			...
			if arg_81_1.time_ >= 0 + var_84_1 and arg_81_1.time_ < 0 + var_84_1 + arg_84_0 then
				arg_81_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_81_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_81_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_81_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_81_1.actors_["1053ui_story"].transform.position).z)
				arg_81_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_81_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_81_1.actors_["1053ui_story"].transform.localEulerAngles = arg_81_1.actors_["1053ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_81_1.time_ and arg_81_1.time_ < 0 + var_84_4 and not isNil(var_84_3) then
				if arg_81_1.var_.characterEffect1053ui_story and not isNil(var_84_3) then
					...
					arg_81_1.var_.characterEffect1053ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_81_1.time_ - 0) / var_84_4)
				end
			end
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= var_84_5 + arg_84_0 then
				...
				local var_84_7 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(937041020).content)

				arg_81_1.text_.text = var_84_7

				LuaForUtil.ClearLinePrefixSymbol(arg_81_1.text_)

				local var_84_9 = 42 <= 0 and var_84_6 or var_84_6 * (utf8.len(var_84_7) / 42)

				if (42 <= 0 and var_84_6 or var_84_6 * (utf8.len(var_84_7) / 42)) > 0 and var_84_6 < var_84_9 then
	...
	Play937041021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				arg_85_1.var_.moveOldPos1053ui_story = arg_85_1.actors_["1053ui_story"].transform.localPosition

				local var_88_0 = GameObjectTools.GetOrAddComponent(arg_85_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			if 0 <= arg_85_1.time_ and arg_85_1.time_ < 0 + var_88_1 then
				arg_85_1.actors_["1053ui_story"].transform.localPosition = Vector3.Lerp(arg_85_1.var_.moveOldPos1053ui_story, Vector3.New(0, -1.08, -6), (arg_85_1.time_ - 0) / var_88_1)
				arg_85_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_85_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1053ui_story"].transform.position).z)
				arg_85_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_85_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_85_1.actors_["1053ui_story"].transform.localEulerAngles = arg_85_1.actors_["1053ui_story"].transform.localEulerAngles
			end

			if arg_85_1.time_ >= 0 + var_88_1 and arg_85_1.time_ < 0 + var_88_1 + arg_88_0 then
				arg_85_1.actors_["1053ui_story"].transform.localPosition = Vector3.New(0, -1.08, -6)
				arg_85_1.actors_["1053ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_85_1.actors_["1053ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1053ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_85_1.actors_["1053ui_story"].transform.position).z)
				arg_85_1.actors_["1053ui_story"].transform.localEulerAngles.z = 0
				arg_85_1.actors_["1053ui_story"].transform.localEulerAngles.x = 0
				arg_85_1.actors_["1053ui_story"].transform.localEulerAngles = arg_85_1.actors_["1053ui_story"].transform.localEulerAngles

				local var_88_2 = GameObjectTools.GetOrAddComponent(arg_85_1.actors_["1053ui_story"].transform.gameObject, typeof(DynamicBoneHelper))
			...
			local var_88_3 = arg_85_1.actors_["1053ui_story"]

			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 and not isNil(var_88_3) and arg_85_1.var_.characterEffect1053ui_story == nil then
				arg_85_1.var_.characterEffect1053ui_story = var_88_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_88_4 = 0.200000002980232

			if 0 <= arg_85_1.time_ and arg_85_1.time_ < 0 + var_88_4 and not isNil(var_88_3) then
				if arg_85_1.var_.characterEffect1053ui_story and not isNil(var_88_3) then
					arg_85_1.var_.characterEffect1053ui_story.fillFlat = false
				end
			end

			if arg_85_1.time_ >= 0 + var_88_4 and arg_85_1.time_ < 0 + var_88_4 + arg_88_0 and not isNil(var_88_3) and arg_85_1.var_.characterEffect1053ui_story then
				arg_85_1.var_.characterEffect1053ui_story.fillFlat = false
			end
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= var_88_6 + arg_88_0 then
				...
				local var_88_8 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(937041021).content)

				arg_85_1.text_.text = var_88_8

				LuaForUtil.ClearLinePrefixSymbol(arg_85_1.text_)

				local var_88_10 = 22 <= 0 and var_88_7 or var_88_7 * (utf8.len(var_88_8) / 22)

				if (22 <= 0 and var_88_7 or var_88_7 * (utf8.len(var_88_8) / 22)) > 0 and var_88_7 < var_88_10 then
