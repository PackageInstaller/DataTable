...
function var_0_0.RollAffix(arg_2_0)
	local var_2_0 = ItemTools.getItemNum(GameSetting.activity_kali_cost_item.value[1])

	manager.net:SendWithLoadingNew(84202, {
		activity_id = arg_2_0
	}, 84203, function(arg_3_0)
...
function var_0_0.SendTugGameResult(arg_5_0, arg_5_1, arg_5_2)
	...
	manager.net:SendWithLoadingNew(84212, var_5_0, 84213, function(arg_6_0)
		if isSuccess(arg_6_0.result) then
			...
			var_6_1.use_seconds = arg_5_2 or 0
