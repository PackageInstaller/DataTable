...
function var_0_0.UpdateRedPoints()
	...
	for iter_9_0, iter_9_1 in ipairs(RechargeRecommendCfg.all) do
		...
		if not var_9_1 then
			...
			local var_9_4 = TimeMgr.GetInstance():GetServerTime()

			var_9_1 = var_9_4 < TimeMgr.GetInstance():parseTimeFromConfig(var_9_0.time[2]) and var_9_3 <= var_9_4
		end

		local var_9_5 = RedPointConst.RECHARGE_RECOMMEND .. iter_9_1

		if var_9_0.new_recommend == 0 or not var_9_1 or getData("recharge_recommend", tostring(iter_9_1)) ~= nil then
			manager.redPoint:setTip(var_9_5, 0)
		else
			manager.redPoint:setTip(var_9_5, 1)
		end
	end
end
