...
manager.notify:RegistListener(CURRENCY_UPDATE, function(arg_6_0)
	...
	if var_6_0 == arg_6_0 then
		manager.redPoint:setTip(RedPointConst.INVITE_DRAW, ItemTools.getItemNum(var_6_0) > 0 and 1 or 0)
	end
end)

function var_0_0.UpdateRedPoint()
	local var_7_0 = InviteData:GetDataByPara("inviteTimes")
	local var_7_1 = InviteData:GetDataByPara("allComplete")

	manager.redPoint:setTip(RedPointConst.INVITE_DRAW, ItemTools.getItemNum((InviteData:GetDataByPara("drawItemId"))) > 0 and 1 or 0)
	manager.redPoint:setTip(RedPointConst.INVITE_PLOT, var_7_0 > 0 and not var_7_1 and 1 or 0)
end
