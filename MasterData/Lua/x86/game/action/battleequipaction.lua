...
function var_0_0.ChangeUpSuit(arg_3_0)
	...
	}, 43005, var_0_0.OnChangeUpSuit)
end

function var_0_0:OnChangeUpSuit(arg_4_1)
	if isSuccess(self.result) then
		BattleEquipData:ChangeUpSuitId(arg_4_1.equip_suit_id)
	end

	manager.notify:CallUpdateFunc(CHANGE_UP_SUIT, self, arg_4_1)
end
...
function var_0_0.CaculateGuaranteeNum(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_1) do
		...
		for iter_5_2, iter_5_3 in ipairs(iter_5_1) do
			if ItemCfg[iter_5_3[1]] and ItemConst.ITEM_TYPE.EQUIP == ItemCfg[iter_5_3[1]].type and EquipCfg[iter_5_3[1]].starlevel == 5 then
				var_5_2 = true
			end
		end
