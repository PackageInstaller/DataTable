...
function var_0_0.CheckBPRedPoint()
	...
	for iter_14_0, iter_14_1 in ipairs(RegressionCfg[var_14_0].regression_bp) do
		if var_14_3 >= RegressionBPTaskCfg[iter_14_1].need and (var_14_1[iter_14_1] == nil or var_14_1[iter_14_1].is_receive_reward < 1 or var_14_2 >= 1 and var_14_1[iter_14_1].is_receive_recharge_reward < 1) then
			var_14_4 = true
	...
	manager.redPoint:setTip(RedPointConst.REGRESSION_BP, var_14_4 and 1 or 0)
end
