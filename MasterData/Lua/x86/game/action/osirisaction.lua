...
function var_0_0.UpdateRewardRedPoint()
	...
	for iter_8_0, iter_8_1 in pairs((OsirisInfinityPoolData:GetPoolList())) do
		local var_8_1 = ActivityInfinityPoolCfg[iter_8_0]

		if var_8_0[ActivityInfinityPoolCfg[iter_8_0].activity_id] == nil then
			var_8_0[var_8_1.activity_id] = 0
		end

		if var_0_1(iter_8_1.openBoxList) ~= #iter_8_1.itemList + (iter_8_1.coreItem == nil and 0 or 1) and var_8_1.cost_item[2] <= ItemTools.getItemNum(var_8_1.cost_item[1]) then
			var_8_0[var_8_1.activity_id] = 1
		end
	end
