...
manager.net:Bind(40035, function(arg_3_0)
	OperationData:SetFunctionStopIdList((var_0_1(arg_3_0.sys_supend_list, 1)))
end)
...
function var_0_0.UpdateUrlContext(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4, arg_7_5)
	...
	var_7_0.screenOrientation = arg_7_4 == nil and OperationConst.SCREEN_ORIENTATION.FREE or arg_7_4
	var_7_0.isNeedCloseBtn = arg_7_5 == nil and true or arg_7_5
...
function var_0_0.OpenOperationUrlBeforeLogin(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4)
	...
	var_0_0.OpenUrl(var_0_0.ParseUrl(var_0_0.curUrlContext.url, var_0_0.curUrlContext.params, var_0_0.curUrlContext.key), var_0_0.curUrlContext.urlOpenWay, var_0_0.curUrlContext.screenOrientation, var_0_0.curUrlContext.isNeedCloseBtn)
end
...
function var_0_0.GetOperationUrl(arg_13_0, arg_13_1)
	...
	if not GameToSDK.clientInfo.configS:ContainsKey(arg_13_0) then
		if not arg_13_1 then
	...
	return GameToSDK.clientInfo.configS:get_Item(arg_13_0)
end

function var_0_0.InitUrlOpenWay(arg_14_0)
	return (not arg_14_0 or GameToSDK.IsEditorOrPcPlatform()) and OperationConst.URL_OPEN_WAY.NORMAL or GameToSDK.PLATFORM_ID == 1 and (arg_14_0 == "FORUM_URL" or arg_14_0 == "PC_SHOP" or arg_14_0 == "FORUM_URL_HOME" or arg_14_0 == "FORUM_URL_HERO" or arg_14_0 == "REFUND_URL" or arg_14_0 == "OFFICIAL_SUGGEST_URL") and OperationConst.URL_OPEN_WAY.NORMAL or GameToSDK.PLATFORM_ID == 4 and arg_14_0 == "REFUND_URL" and OperationConst.URL_OPEN_WAY.NORMAL or OperationConst.URL_OPEN_WAY.INTERNAL
end
...
function var_0_0.ParseUrl(arg_21_0, arg_21_1, arg_21_2)
	return (EncodeURL(var_0_0.ContainsParamHolder(arg_21_0, arg_21_1) and var_0_0.ReplaceUrlParamHolders(arg_21_0, arg_21_1) or var_0_0.ParseUrlParams(arg_21_0, arg_21_1, arg_21_2)))
end
...
function var_0_0:ReplaceUrlParamHolders(arg_23_1)
	return self:gsub("{(.-)}", function(arg_24_0)
...
function var_0_0.ParseUrlParams(arg_25_0, arg_25_1, arg_25_2)
	return arg_25_2 == "INQUERY_URL" and string.format(arg_25_0, arg_25_1.userId, arg_25_1.signUserId) or (arg_25_2 == "FORUM_URL" or arg_25_2 == "OFFICIAL_SUGGEST_URL" or arg_25_2 == "PC_SHOP") and string.format(arg_25_0, arg_25_1.userId, arg_25_1.signUserId, arg_25_1.gameAppId, arg_25_1.token) or arg_25_2 == "FORUM_URL_HERO" and string.format(arg_25_0, arg_25_1.userId, arg_25_1.signUserId, arg_25_1.gameAppId, arg_25_1.token, arg_25_1.heroName) or arg_25_2 == "OFFICIAL_DISCUSS_URL" and string.format(arg_25_0, arg_25_1.gameAppId, arg_25_1.token) or arg_25_2 == "ACTIVITY_URL" and string.format(arg_25_0, arg_25_1.userId, arg_25_1.signUserId) or (arg_25_2 == "GUIDE_URL" or arg_25_2 == "INFORMATION_URL") and string.format(arg_25_0, arg_25_1.userId, arg_25_1.signUserId) or arg_25_2 == "PC_FEEDBACK" and string.format(arg_25_0, arg_25_1.userId, arg_25_1.signUserId) or (arg_25_2 == BattleStageData:GetDiscussKey() or arg_25_2 == BattleStageData:GetQuestionKey()) and string.format(arg_25_0, arg_25_1.userId, arg_25_1.signUserId, arg_25_1.gameAppId, arg_25_1.token) or arg_25_0
end
...
function var_0_0.GetUnreadMsgResult()
	...
	if var_27_0 then
		...
		LuaForUtil.GetUnreadMsg(var_27_0, var_27_1.userID .. "_" .. var_27_1.signUserId, 1, function(arg_28_0)
			if arg_28_0 > 0 then
...
function var_0_0.ChangeScreenSettingToPortrait()
	...
	local var_29_0, var_29_1 = SettingTools.GetSettingScreenSize((tonumber(SettingData:GetSettingData().pic.resolution)))
	...
	FrameTimer.New(function()
		...
		FrameTimer.New(function()
			Screen.SetResolution(var_29_1, var_29_0, true)
...
function var_0_0.RecoverScreenSetting()
	...
	FrameTimer.New(function()
		...
		local var_38_0, var_38_1 = SettingTools.GetSettingScreenSize((tonumber(SettingData:GetSettingData().pic.resolution)))

		UnityEngine.Pipelines.SimPipeline.CanvasManager.Instance:RotateScreen(false)
		U3DHud.mInstance:SetWidthAndHeight(1920, 1080)
		FrameTimer.New(function()
			Screen.SetResolution(var_38_0, var_38_1, true)
		end, 2, 1):Start()
	end, 1, 1):Start()
	FrameTimer.New(function()
		SetActive(manager.ui.mainCamera, true)
