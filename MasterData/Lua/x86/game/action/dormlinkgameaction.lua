...
function var_0_0.ClearanceLevel(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_2_0 then
		...
		manager.net:SendWithLoadingNew(65210, {
			id = arg_2_1,
			point = DormLinkGameData:GetLastPoint(),
			remain_time = arg_2_2.gameTime,
			item_list = var_2_2
...
function var_0_0:ClearanceLevelCallBack(arg_3_1)
...
function var_0_0:GetLevelAwardCallBack(arg_6_1)
	if isSuccess(self.result) then
...
function var_0_0:GetMultiplyLevelAwardCallBack(arg_7_1)
	if isSuccess(self.result) then
