...
function var_0_0:OnfinishPinBall(arg_2_1)
...
function var_0_0:OnViewComplete(arg_4_1)
	if isSuccess(self.result) then
...
function var_0_0:OnFinishCook(arg_7_1, arg_7_2)
	if isSuccess(self.result) then
		...
		elseif arg_7_1.stage == SummerPubConst.COOK_STATE.VIEW_CG then
			...
			elseif arg_7_1.stage_id == SummerPubConst.COOK_LAST_STAGE then
				...
				JumpTools.OpenPopUp("summerPubPartnerDetailView", {
					isAnim = true,
					id = SummerPubCookCfg[arg_7_1.stage_id].hero_id
				})
				SDKTools.SendMessageToSDK("activity_currency_opt", {
					activity_id = ActivityConst.ACTIVITY_NYA_SUMMER_PUB,
					hero_id = SummerPubCookCfg[arg_7_1.stage_id].hero_id
				})
			end
		end
	else
...
function var_0_0:changeTimeStateBackCall(arg_10_1, arg_10_2)
	if isSuccess(self.result) then
...
function var_0_0.OpenBattle(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	local var_13_0 = SummerPubLevelCfg[arg_13_0].stage_id
	...
	if SummerPubData:GetLevelIDIsOpen(arg_13_0) then
		...
		if SummerPubLevelCfg[arg_13_0].type == SummerPubConst.STAGE_TYPE.BATTLE then
			if BattleStageTools.GetStageCfg(arg_13_2, var_13_0[arg_13_1]).tag == BattleConst.BATTLE_TAG.STORY then
				BattleController.GetInstance():LaunchStoryBattle(arg_13_2, var_13_0[arg_13_1], 0, (arg_13_3 or nil) and function(arg_14_0)
					if isSuccess(arg_14_0.result) then
						arg_13_3()
					end
				end)
			elseif arg_13_0 == SummerPubConst.FIRST_LEVEL_ID then
				BattleController.GetInstance():LaunchBattle(BattleStageFactory.Produce(arg_13_2, var_13_0[arg_13_1], 0), nil, (arg_13_3 or nil) and function(arg_15_0)
				...
				gameContext:Go("/sectionSelectHero", {
					section = var_13_0[arg_13_1],
					sectionType = arg_13_2
				})
			end
		elseif SummerPubLevelCfg[arg_13_0].type == SummerPubConst.STAGE_TYPE.BALL then
			if arg_13_3 then
				arg_13_3()
			end

			JumpTools.OpenPageByJump("billiardGameHeroSelect", {
				stageID = var_13_0[arg_13_1],
				levelID = arg_13_0,
				isEasy = arg_13_1 == 1
			})
		elseif SummerPubLevelCfg[arg_13_0].type == SummerPubConst.STAGE_TYPE.COOK then
			if SummerPubLevelCfg[arg_13_0].pre_story_id ~= 0 then
				if arg_13_3 then
					arg_13_3()
				end

				manager.story:StartStoryById(SummerPubLevelCfg[arg_13_0].pre_story_id, function(arg_16_0)
