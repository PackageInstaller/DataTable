...
function var_0_0.ApplyLockEquip(arg_5_0, arg_5_1)
	...
	var_5_0.is_lock = arg_5_1 and 1 or 0

	manager.net:SendWithLoadingNew(13016, var_5_0, 13017, var_0_0.OnApplyLockEquipCallBack)
end

function var_0_0:OnApplyLockEquipCallBack(arg_6_1)
	if isSuccess(self.result) then
		local var_6_0 = arg_6_1.is_lock == 1

		EquipData:ApplyLockEquipSuccess(arg_6_1.equip_id, arg_6_1.is_lock == 1)
...
function var_0_0.OnStrengthEquip(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	EquipData:ApplyEquipStrengthSuccess(tonumber(arg_9_1), arg_9_3, arg_9_4, (math.floor(arg_9_2 / GameSetting.equip_strengthen_gold_cost.value[1])))
	manager.notify:Invoke(EQUIP_STRENGTH_SUCCESS, var_9_0:GetMaxLv() <= var_9_0:GetLevel(), var_9_1:GetLevel() ~= var_9_0:GetLevel(), {
		type = "levelup",
		equipId = arg_9_1,
		equip = var_9_0,
		oldEquip = var_9_1,
...
function var_0_0.OneKeyStrength(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4, arg_15_5)
	...
	return manager.net:SendWithLoading(13058, {
		...
		if isSuccess(arg_16_0.result) then
			...
			EquipData:ApplyEquipStrengthSuccess(tonumber(arg_15_0), arg_15_1, arg_15_2, (math.floor(arg_15_3 / GameSetting.equip_strengthen_gold_cost.value[1])))

			local var_16_1 = EquipData:GetEquipData(arg_15_0)

			manager.notify:Invoke(EQUIP_STRENGTH_SUCCESS, var_16_1:GetLevel() >= var_16_1:GetMaxLv(), var_16_0:GetLevel() ~= var_16_1:GetLevel(), {
				type = "levelup",
				equipId = arg_15_0,
				equip = var_16_1,
				oldEquip = var_16_0,
...
function var_0_0:OnEquipQuickDressOn(arg_20_1)
	local var_20_0 = true

	for iter_20_0, iter_20_1 in ipairs(self.result) do
	...
	if not var_20_0 then
		...
		manager.notify:CallUpdateFunc(EQUIP_QUICK_DRESS_ON, self, arg_20_1)
	end
end

function var_0_0.QueryEquipEnchant(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	if not checkGold(arg_21_2.money) then
		return
	end

	if arg_21_2.number > ItemTools.getItemNum(arg_21_2.id) then
	...
	local var_21_0 = ItemCfg[arg_21_2.id] and ItemCfg[arg_21_2.id].param and ItemCfg[arg_21_2.id].param[1]

	if not var_21_0 and var_21_0 ~= "" then
		return
	end
...
function var_0_0.QueryEquipRace(arg_27_0, arg_27_1, arg_27_2)
	...
	if not checkGold(var_27_0.money) then
		return
	end

	if var_27_0.number > ItemTools.getItemNum(var_27_0.id) then
		ShowPopItem(POP_SOURCE_ITEM, {
			var_27_0.id,
			var_27_0.number
		})
	...
	if arg_27_1 == 1 then
		...
		var_27_1 = 13046
		var_27_2 = 13047
		var_27_3.hero_id = arg_27_2
	end

	manager.net:SendWithLoading(var_27_1, var_27_3, var_27_2):next(function(arg_28_0)
...
function var_0_0:OnInheritEquip(arg_34_1)
	if isSuccess(self.result) then
...
function var_0_0.DirectionalEnchant(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	manager.net:SendWithLoadingNew(13060, {
		...
		if isSuccess(arg_39_0.result) then
			...
			var_39_0.equipLevel = EquipData:GetEquipData(arg_38_0):GetLevel()

			EquipData:DirectionalEnchant(arg_38_0, arg_38_1, arg_38_2, var_39_0)
