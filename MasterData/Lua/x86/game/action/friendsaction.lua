...
manager.net:Bind(19029, function(arg_6_0)
	...
	FriendsData:FriendsDataInit(arg_6_0.brief_friend_list or {}, var_6_1, arg_6_0.black_list or {})
...
function var_0_0:TryToRequestToFriend(arg_8_1, arg_8_2, arg_8_3)
	manager.net:SendWithLoadingNew(19002, {
		request_user_id = arg_8_1,
		source = arg_8_2,
		activity_id = arg_8_3 or 0
	}, 19003, handler(self, self.OnTryToRequestToFriend))
end
...
function var_0_0:TryToDealRequest(arg_10_1, arg_10_2)
	if arg_10_2 == 1 then
	...
	manager.net:SendWithLoadingNew(19004, {
		...
		deal = arg_10_2
	}, 19005, handler(self, self.OnTryToDealRequest))
end
...
function var_0_0:TryToDelectFromMyFriendsList(arg_12_1)
	manager.net:SendWithLoadingNew(19006, {
		friend_id = arg_12_1
	}, 19007, handler(self, self.OnTryToDelectFromMyFriendsList))
end
...
function var_0_0.OnTryToDelectFromMyFriendsList(arg_13_0, arg_13_1, arg_13_2)
	if isSuccess(arg_13_1.result) then
		...
		FriendsAction:OnFriendsDelect(arg_13_2.friend_id)
	else
		ShowTips(arg_13_1.result)
	end
end

function var_0_0:TryToAddToBlacklist(arg_14_1)
	if FriendsData:IsCanBeBlackList(arg_14_1) then
		manager.net:SendWithLoadingNew(19008, {
			black_user_id = arg_14_1
		}, 19009, handler(self, self.OnTryToAddToBlacklist))
	end
end
...
function var_0_0.OnTryToAddToBlacklist(arg_15_0, arg_15_1, arg_15_2)
	if isSuccess(arg_15_1.result) then
		...
		ChatAction.RefreshWorldChatData()
		FriendsAction:OnFriendsDelect(arg_15_2.black_user_id)
	else
		ShowTips(arg_15_1.result)
	end
end

function var_0_0:TryToDelectFromBlackList(arg_16_1, arg_16_2)
	manager.net:SendWithLoadingNew(19010, {
		black_user_id = arg_16_1,
		is_request = arg_16_2
	}, 19011, handler(self, self.OnTryToDelectFromBlackList))
end
...
function var_0_0:TryToSearchFriend(arg_18_1)
	manager.net:SendWithLoadingNew(19012, {
		user_id = arg_18_1
	}, 19013, handler(self, self.OnTryToSearchFriend))
end
...
function var_0_0:TryToDealRequestList(arg_20_1)
	...
	manager.net:SendWithLoadingNew(19014, {
		deal = arg_20_1
	}, 19015, handler(self, self.OnTryToDealRequestList))
end
...
function var_0_0.OnTryToDealRequestList(arg_21_0, arg_21_1, arg_21_2)
	if isSuccess(arg_21_1.result) then
		if arg_21_2.deal == 1 then
			FriendsData:AllAcceptRequestList(arg_21_1.friend_list or {}, arg_21_2.deal)
			SendMessageManagerToSDK("add_friend")
		else
...
function var_0_0:TryToRefreshNewFriendsList(arg_22_1)
	manager.net:SendWithLoadingNew(19016, {
		cmd = arg_22_1
	}, 19017, handler(self, self.OnTryToRefreshNewFriendsList))
end

function var_0_0.OnTryToRefreshNewFriendsList(arg_23_0, arg_23_1, arg_23_2)
	if isSuccess(arg_23_1.result) then
		FriendsData:RefreshNewFriendsList(arg_23_1.recommend_list or {}, arg_23_2.cmd)
		FriendsAction:OnFriendsDataChange(FriendsConst.FRIEND_TYPE.NEW_FRIENDS)
	else
...
function var_0_0.TryToRefreshFriendsView(arg_24_0, arg_24_1, arg_24_2)
	manager.net:SendWithLoadingNew(19030, {
		type = arg_24_1
	}, 19031, function(arg_25_0, arg_25_1)
...
function var_0_0:UpdateFriendsRedTip()
	self:UpdateChatRedTip()
	self:UpdateFriendsRequestRedTip()
end
...
function var_0_0.UpdateChatRedTip(arg_32_0)
	...
	for iter_32_0, iter_32_1 in pairs(FriendsData:GetChatList() or {}) do
