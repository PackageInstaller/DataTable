...
manager.net:Bind(90101, function(arg_3_0)
	...
	if AutoChessData:GetIsInPrepareEnd() and AutoChessBattleSimulator.GetInstance().isInit then
		...
		AutoChessData:SetRandomBgIndex((math.random(1, #AutoChessConst.BACKGROUND_ID)))
...
manager.net:Bind(90137, function(arg_8_0)
	...
	elseif AutoChessData:GetOnlineBattleData() ~= nil then
		...
		for iter_8_0 = #GameSetting.auto_chess_2_count_down.value, 1, -1 do
			if var_8_2 > GameSetting.auto_chess_2_count_down.value[iter_8_0][1] then
				var_8_1 = GameSetting.auto_chess_2_count_down.value[iter_8_0][2]
...
function var_0_0:OnStopMatchBack(arg_12_1)
	if isSuccess(self.result) then
		AutoChessData:SetIsInMatch(false)
...
function var_0_0:OnStopPrepareBack(arg_14_1)
	if isSuccess(self.result) then
		AutoChessData:SetIsInPrepareEnd(true)
	else
		ShowTips(self.result)
...
function var_0_0:OnCancelGameBack(arg_19_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnBuyChessBack(arg_21_1)
	if isSuccess(self.result) then
		manager.notify:Invoke("AUTO_CHESS_SHOP_BUY_CHESS", var_0_0.shopData, arg_21_1.to_index)

		if arg_21_1.shop_type == AutoChessConst.SHOP_TYPE.PROP and AutoChessItemCfg[var_0_0.shopData.chessId] and AutoChessTools.IsPrepareStatus() and not AutoChessData:GetIsInUseProp() then
			AutoChessData:SetIsInUseProp(true)

			local var_21_0 = AutoChessBattleRenderer.GetInstance():GetPrepareView()

			if var_21_0 then
				if AutoChessTools.IsTargetProp(AutoChessItemCfg[var_0_0.shopData.chessId].id) then
					local var_21_1 = var_21_0:GetChessItemByTargetIndex(arg_21_1.to_index)

					if var_21_1 then
						var_21_1:PlayPropAnimator(AutoChessItemCfg[var_0_0.shopData.chessId].icon)
					end
				else
					var_21_0:PlayPropAnimator(AutoChessItemCfg[var_0_0.shopData.chessId].icon)
				end
			end
		end
...
function var_0_0:OnSellChessBack(arg_23_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnRefreshShopBack(arg_25_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0.LockShop(arg_26_0, arg_26_1, arg_26_2)
	manager.net:SendWithLoadingNew(90120, {
		round = arg_26_0,
		type = arg_26_1,
		info_list = arg_26_2
	}, 90121, var_0_0.OnLockShopBack)
end

function var_0_0:OnLockShopBack(arg_27_1)
	if isSuccess(self.result) then
...
function var_0_0:OnChangeChessTeamBack(arg_29_1)
	if isSuccess(self.result) then
		local var_29_0 = {}
		local var_29_1 = AutoChessData:GetPointChessData()

		for iter_29_0, iter_29_1 in ipairs(self.chess_list or {}) do
...
function var_0_0:OnMergeChessBack(arg_31_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnPlayerChessUpgradeBack(arg_33_1)
	if isSuccess(self.result) then
...
function var_0_0:OnCheckScoreBoardBack()
	if isSuccess(self.result) then
		AutoChessData:UpdateScoreBoardData(self.all_score_info)
...
function var_0_0:OnSendStickerBack()
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnExPortChessInfoBack(arg_40_1)
	if isSuccess(self.result) then
		AutoChessTools.SetCurExportData(self.export_info)
	else
		ShowTips(self.result)
	end
end
...
function var_0_0.OpenTeamnfoPopAfterFetch(arg_42_0, arg_42_1)
	if arg_42_1.user_id then
		var_0_0.FetchRankTeamInfo(arg_42_0, arg_42_1.user_id, function(arg_43_0)
			JumpTools.OpenPageByJump("autoChessRankTeamInfoPop", {
				rankData = arg_42_1,
				teamData = arg_43_0.record
			})
		end)
	end
end
...
function var_0_0.RequestRecord(arg_47_0, arg_47_1)
	manager.net:SendWithLoadingNew(90080, {
		type = (arg_47_0 == AutoChessConst.RECORD_TYPE.PVP_4_8_ONLINE or nil) and 0
	}, 90081, function(arg_48_0, arg_48_1)
		var_0_0.OnRequestRecordBack(arg_48_0, arg_48_1, arg_47_0, arg_47_1)
	end)
end

function var_0_0:OnRequestRecordBack(arg_49_1, arg_49_2, arg_49_3)
	if isSuccess(self.result) then
		AutoChessData:InitOnlineBattleRecord(self, arg_49_2)
...
function var_0_0:OnReconnectAutoChessBack(arg_51_1)
	if isSuccess(self.result) then
		AutoChessData:SetIsCanReconnectAutoChess(false)
...
function var_0_0.InitRedPointGroup()
	...
	for iter_56_0, iter_56_1 in pairs(ActivityCfg[ActivityConst.ACTIVITY_AUTO_CHESS_4_8_LIMITED_TASK].sub_activity_list) do
		table.insert(var_56_0, RedPointConst.AUTO_CHESS_4_8_LIMIT_TASK_TAG .. iter_56_1)
	end

	manager.redPoint:addGroup(RedPointConst.AUTO_CHESS_4_8_LIMIT_TASK .. ActivityConst.ACTIVITY_AUTO_CHESS_4_8_LIMITED_TASK, var_56_0)
	manager.notify:RegistListener(OSIRIS_TASK_UPDATE, function()
		var_0_0:UpdateTaskRedPoint()
	end)
	manager.redPoint:addGroup(RedPointConst.AUTO_CHESS_4_8_DESIRE .. ActivityConst.ACTIVITY_AUTO_CHESS_EXCHANGE_CARD, {
		RedPointConst.AUTO_CHESS_4_8_DESIRE_VIEW
	})
	manager.redPoint:addGroup(RedPointConst.AUTO_CHESS_4_8_OPEN_CARD, {
		RedPointConst.AUTO_CHESS_4_8_OPEN_CARD_VIEW
	})
	manager.redPoint:addGroup(RedPointConst.AUTO_CHESS_4_8_GO_BTN, {
		RedPointConst.AUTO_CHESS_4_8_LIMIT_TASK .. ActivityConst.ACTIVITY_AUTO_CHESS_4_8_LIMITED_TASK,
		RedPointConst.AUTO_CHESS_4_8_RESIDENT_TASK .. ActivityConst.ACTIVITY_AUTO_CHESS_4_8,
		RedPointConst.AUTO_CHESS_4_8_DESIRE .. ActivityConst.ACTIVITY_AUTO_CHESS_EXCHANGE_CARD,
		RedPointConst.AUTO_CHESS_4_8_OPEN_CARD
	})
	manager.redPoint:addGroup(RedPointConst.AUTO_CHESS_4_8_ACTIVITY_MAIN .. ActivityConst.ACTIVITY_AUTO_CHESS_4_8, {
...
function var_0_0.UpdateTaskRedPoint()
	var_0_0.TaskRedSet(ActivityCfg[ActivityConst.ACTIVITY_AUTO_CHESS_4_8_LIMITED_TASK].sub_activity_list, RedPointConst.AUTO_CHESS_4_8_LIMIT_TASK_TAG)
	var_0_0.TaskRedSet({
...
function var_0_0.TaskRedSet(arg_59_0, arg_59_1)
	for iter_59_0, iter_59_1 in pairs(arg_59_0) do
		...
		for iter_59_2, iter_59_3 in pairs(AssignmentCfg.get_id_list_by_activity_id[iter_59_1]) do
			if var_59_0 then
				local var_59_1 = TaskData2:GetTaskProgress(iter_59_3)

				if TaskData2:GetTaskComplete(iter_59_3) then
					manager.redPoint:setTip(arg_59_1 .. iter_59_1, 0)
				elseif var_59_1 >= AssignmentCfg[iter_59_3].need then
					manager.redPoint:setTip(arg_59_1 .. iter_59_1, 1)
