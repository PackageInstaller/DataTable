...
function var_0_0:OnTrainHeroPropertyCallBack(arg_12_1)
	if isSuccess(self.result) then
		IdolTraineeData:UpdateTrainData(arg_12_1, self)
		manager.notify:Invoke(IDOL_TRAINEE_TRAIN_HERO_PROPERTY_CALLBACK, arg_12_1.hero_id, arg_12_1.attribute_index, DormData:GetHeroTemplateInfo(arg_12_1.hero_id).property[arg_12_1.hero_id][arg_12_1.attribute_index] - DormData:GetHeroTemplateInfo(arg_12_1.hero_id).property[arg_12_1.hero_id][arg_12_1.attribute_index])
	else
...
local function var_0_2()
	for iter_15_0, iter_15_1 in ipairs((IdolTraineeData:GetIdolHeroList())) do
...
function var_0_0:OnDeleteDanceDIYSequence(arg_34_1)
	if isSuccess(self.result) then
		IdolTraineeData:SetDanceDIYSequence(arg_34_1.pos, nil)
	end
end

function var_0_0:ShareDanceDIYSequence(arg_35_1)
	manager.net:SendWithLoadingNew(58204, {
		base_sequence = {
			scene_id = self.scene,
			music_id = self.music,
			action_id_list = self.actionList
		}
	}, 58205, var_0_0.OnShareDanceDIYSequence(self, arg_35_1))
end
...
function var_0_0:OnStopShareDanceDIYSeqence(arg_39_1)
	if isSuccess(self.result) then
...
function var_0_0:ProcessAuthorInfo(arg_49_1)
	arg_49_1 = arg_49_1 or {}

	for iter_49_0, iter_49_1 in ipairs(self.user_brief_list) do
...
function var_0_0:ProcessBriefList(arg_50_1)
	local var_50_0 = {}

	for iter_50_0, iter_50_1 in ipairs(self.sequence_brief_list) do
		...
		table.insert(var_50_0, {
			...
			name = IdolTraineeTools.GetSharedDIYDanceDataName(var_50_2),
	...
	return function(arg_53_0)
		if isSuccess(arg_53_0.result) then
			for iter_53_0, iter_53_1 in ipairs(arg_53_0.sequence_statistics_list) do
				IdolTraineeData:UpdateMySharedDanceDIYStatistics(iter_53_1.sequence_uid, iter_53_1.statistics)
			end
