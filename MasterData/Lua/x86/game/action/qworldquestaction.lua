...
function var_0_0.SubmitMainQuest(arg_8_0, arg_8_1)
	manager.net:SendWithLoadingNew(28820, {
		quest_id_list = arg_8_0
	}, 28821, function(arg_9_0, arg_9_1)
...
function var_0_0.SubmitQuest(arg_10_0, arg_10_1)
	manager.net:SendWithLoadingNew(28822, {
		quest_task_id = arg_10_0
	}, 28823, function(arg_11_0, arg_11_1)
...
function var_0_0.TakeMainQuest(arg_12_0, arg_12_1)
	manager.net:SendWithLoadingNew(28830, {
		quest_id = arg_12_0
	}, 28831, function(arg_13_0, arg_13_1)
...
function var_0_0.QuestSetParam(arg_14_0, arg_14_1, arg_14_2)
	manager.net:SendWithLoadingNew(28832, {
		param = arg_14_0,
		value = arg_14_1
	}, 28833, function(arg_15_0, arg_15_1)
...
function var_0_0.UpdateTrackingMainQuestId(arg_17_0, arg_17_1)
	...
	if QWorldMgr:GetQWorldQuestMgr() then
		QWorldMgr:GetQWorldQuestMgr():OnUpdateTrackingQuest(arg_17_0, (QWorldQuestData:GetMainQuestTrackingIdRaw()))
	end
...
function var_0_0.SendUpdateQuestTrackToSdk(arg_18_0, arg_18_1)
	...
	for iter_18_0, iter_18_1 in ipairs(SandPlayMapCfg.all) do
		if SandPlayMapCfg[iter_18_1].id == var_18_0 then
			var_18_1 = SandPlayMapCfg[iter_18_1].activity_id
	...
	local var_18_2 = SandplayTaskMainCfg[arg_18_0]

	if not SandplayTaskMainCfg[arg_18_0] then
		return
	end

	local var_18_3 = QWorldQuestData:GetMainQuestData(arg_18_0)
	...
	for iter_18_2, iter_18_3 in ipairs(var_18_3.taskIdList) do
	...
	SDKTools.SendMessageToSDK("task_accept", {
		...
		stage_id = var_18_0,
		task_id = arg_18_0,
		params_list = string.format("[%s]", table.concat(var_18_4, ",")),
		task_type = var_18_2.main_task_type,
		opt = arg_18_1
	})
end
