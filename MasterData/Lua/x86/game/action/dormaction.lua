...
function var_0_0.SetFurListInMap(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	if arg_1_2 == nil then
		...
		for iter_1_0 = 0, arg_1_3.furInfoList.Length - 1 do
			local var_1_7 = {
				furniture_id = arg_1_3.furInfoList[iter_1_0].id,
				x = math.floor(arg_1_3.furInfoList[iter_1_0].pos.x * DormConst.POS_PRECISION),
				y = math.floor(arg_1_3.furInfoList[iter_1_0].pos.y * DormConst.POS_PRECISION),
				rotation = math.floor(arg_1_3.furInfoList[iter_1_0].rotation * DormConst.POS_PRECISION)
			}

			if DormFurnitureTools:CheckFurTileType(arg_1_3.furInfoList[iter_1_0].id, arg_1_3.furInfoList[iter_1_0].tileType) then
				if arg_1_3.furInfoList[iter_1_0].tileType == DormConst.TILE_TYPE.FLOOR then
					table.insert(var_1_5, var_1_7)
				elseif arg_1_3.furInfoList[iter_1_0].tileType == DormConst.TILE_TYPE.WALL_LEFT then
					table.insert(var_1_1, var_1_7)
				elseif arg_1_3.furInfoList[iter_1_0].tileType == DormConst.TILE_TYPE.WALL_RIGHT then
					table.insert(var_1_2, var_1_7)
				elseif arg_1_3.furInfoList[iter_1_0].tileType == DormConst.TILE_TYPE.WALL_BEHIND then
					table.insert(var_1_4, var_1_7)
				elseif arg_1_3.furInfoList[iter_1_0].tileType == DormConst.TILE_TYPE.WALL_FRONT then
					table.insert(var_1_3, var_1_7)
				end
			else
				var_0_1 = nil

				print("同步家具失败，" .. arg_1_3.furInfoList[iter_1_0].id .. "家具所在地块和配置地块不匹配")

				return
			end
		end

		if arg_1_3.specialInfo then
			for iter_1_1, iter_1_2 in pairs(arg_1_3.specialInfo) do
		...
		if arg_1_3.suitInfo then
			...
			for iter_1_3, iter_1_4 in pairs(arg_1_3.suitInfo) do
		...
		var_1_6.furniture_layout.furniture_pos_list = {
			{
				default_suit_id = 0,
				type = 1,
				furniture_pos = var_1_1
			},
			{
				default_suit_id = 0,
				type = 2,
		...
		if arg_1_3.suitInfo then
			...
			for iter_1_5, iter_1_6 in pairs(arg_1_3.suitInfo) do
				if iter_1_5 < 1000 then
					...
					var_1_10.furniture_pos = var_1_11
					var_1_10.default_suit_id = iter_1_6.oriSuitID and iter_1_6.oriSuitID or 0
					var_1_9 = var_1_9 + 1

					table.insert(var_1_6.furniture_layout.furniture_pos_list, var_1_10)
				end
			end
		end

		if DormData:GetDevModelFlag() then
			DormSuitTools:SerializeDormSuitData(clone(var_1_6.furniture_layout.furniture_pos_list), (DormSuitData:GetSuitSerializeData()))
		end

		manager.net:SendWithLoadingNew(58010, var_1_6, 58011, var_0_0.SetFurListInMapCallBack)
	else
...
function var_0_0:SetFurListInMapCallBack(arg_2_1)
	if isSuccess(self.result) then
		local var_2_0

		if not var_0_1 then
			local var_2_1 = DormFurnitureTemplateData:GetDormTemplateInfo(arg_2_1.furniture_layout.temp_id)

			var_0_1 = var_2_1:GetDormTemplateFurList()
			var_2_0 = {}

			for iter_2_0, iter_2_1 in pairs((var_2_1:GetTemplateWallAndFloorInfo())) do
...
function var_0_0:UnLockDormArchitectureCallBack(arg_4_1)
	if isSuccess(self.result) then
...
function var_0_0:DeployHeroInRoomCallBack(arg_8_1)
	if isSuccess(self.result) then
		...
		elseif var_0_3 == DormEnum.DormDeployType.Occupy then
			...
			local var_8_0 = DormData:GetHeroArchiveID(arg_8_1.hero_id[1])

			DormData:GetHeroInfo(var_8_0):InitHeroRoomID(arg_8_1.architecture_id)
			DormRoomTools:GetDormLevelAward(var_8_0, 0, 1)
			DormitoryData:UpdatePrivateDormRedPoint()

			local var_8_1 = DormitoryData:GetDormLevel(arg_8_1.architecture_id)
			...
			if var_8_1 ~= var_8_2 then
				DormRoomTools:GetDormLevelAward(var_8_0, var_8_1, var_8_2)
				manager.notify:Invoke(DORM_PRIVATE_LEVEL_UP, arg_8_1.architecture_id, var_8_0)
			end
...
function var_0_0:RecallHeroInPrivateDormCallBack(arg_10_1)
	if isSuccess(self.result) then
...
function var_0_0:GiftFurToHeroCallBack(arg_12_1)
	if isSuccess(self.result) then
		local var_12_0 = DormData:GetHeroTemplateInfo(arg_12_1.hero_id)
		local var_12_1 = DormRoomTools:GetDormIDViaArchive(arg_12_1.hero_id)

		for iter_12_0, iter_12_1 in ipairs(arg_12_1.furniture) do
			var_12_0:GiftFur(iter_12_1.id, iter_12_1.num, var_0_4)
		end
		...
		local var_12_2 = DormitoryData:GetDormLevel(var_12_1)

		DormRoomTools:RefreshDormExp(var_12_1)

		local var_12_3 = DormitoryData:GetDormLevel(var_12_1)

		if var_12_2 ~= var_12_3 then
			DormRoomTools:GetDormLevelAward(arg_12_1.hero_id, var_12_2, var_12_3)
			manager.notify:Invoke(DORM_PRIVATE_LEVEL_UP, var_12_1, arg_12_1.hero_id)
		end
	else
		ShowTips(self.result)
	end
...
function var_0_0:SaveFurTemplate(arg_16_1, arg_16_2, arg_16_3, arg_16_4, arg_16_5, arg_16_6, arg_16_7, arg_16_8)
	local var_16_0

	if arg_16_8 then
		local var_16_1 = {}

		var_16_1.user_id = arg_16_8.user_id or PlayerData.INVALID_PLAYER
		var_16_1.layout_uid = tonumber(arg_16_8.layout_uid) or 0
		var_16_0 = var_16_1
	end
	...
	if arg_16_4 == 0 or arg_16_4 > 1000 then
		var_16_2.architecture_id = 0

		local var_16_3, var_16_4, var_16_5, var_16_6, var_16_7, var_16_8 = self:SwitchFurInfoToLayout(arg_16_5)
	...
	manager.net:SendWithLoadingNew(58040, var_16_2, 58041, var_0_0.SaveFurTemplateCallBack)
end
...
function var_0_0:SaveFurTemplateCallBack(arg_18_1)
	if isSuccess(self.result) then
...
function var_0_0:ReviseFurTemplateNameCallBack(arg_20_1)
	if isSuccess(self.result) then
		DormFurnitureTemplateData:GetDormTemplateInfo(arg_20_1.id):ReviseFurTemplateNameInfo(arg_20_1.name)
...
function var_0_0:DeleteFurTemplateCallBack(arg_22_1)
	if isSuccess(self.result) then
...
function var_0_0:RevisePrivateDormPosCallBack(arg_24_1)
	if isSuccess(self.result) then
...
function var_0_0:AskFurTemplateExhibitListCallBack(arg_26_1)
	if isSuccess(self.result) then
		DormVisitTools:RefreshTemplateExhibit(self.exhibition_brief, arg_26_1.type)
		manager.notify:Invoke(DORM_REFRESH_TEMPLATE_EXHI, #self.exhibition_brief, arg_26_1.type)
	else
		ShowTips(self.result)
	end
end
		...
		manager.net:SendWithLoadingNew(58050, {
			...
			if isSuccess(arg_29_0.result) then
				...
				if arg_29_0.architecture_id then
					if BackHomeCfg[arg_29_0.architecture_id].type == DormConst.BACKHOME_TYPE.PublicDorm then
						BackHomeDataManager:GotoBackHomeScene(DormConst.DORM_VISIT_LOBBY)
					elseif BackHomeCfg[arg_29_0.architecture_id].type == DormConst.BACKHOME_TYPE.PrivateDorm then
		...
		manager.net:SendWithLoadingNew(58050, {
			...
			if isSuccess(arg_32_0.result) then
				...
				if arg_32_0.architecture_id then
					if BackHomeCfg[arg_32_0.architecture_id].type == DormConst.BACKHOME_TYPE.PublicDorm then
						BackHomeDataManager:GotoBackHomeScene(DormConst.DORM_VISIT_LOBBY)
					elseif BackHomeCfg[arg_32_0.architecture_id].type == DormConst.BACKHOME_TYPE.PrivateDorm then
						BackHomeDataManager:GotoBackHomeScene(DormConst.DORM_VISIT_PRIVATE)
					end
				end
			else
...
function var_0_0:SetFurTemplateExhibitCallBack(arg_34_1)
	if isSuccess(self.result) then
...
function var_0_0:WatchTheatreCallBack(arg_36_1)
	if isSuccess(self.result) then
...
function var_0_0:SettlementRhythmGameCallBack(arg_38_1)
	if isSuccess(self.result) then
		DormData:GetHeroTemplateInfo(arg_38_1.hero_id):SetFatigue(self.fatigue)
		manager.notify:Invoke(BACKHOME_HERO_FATIGUR_REFRESH)

		local var_38_0 = {}

		for iter_38_0, iter_38_1 in ipairs(self.reward_list) do
...
function var_0_0.SetHeroSkin(arg_39_0, arg_39_1, arg_39_2)
	if BackHomeHeroSkinCfg[arg_39_1] then
		manager.net:SendWithLoadingNew(58126, {
			hero_id = BackHomeHeroSkinCfg[arg_39_1].hero_id,
			skin_id = arg_39_1,
			source = arg_39_2
		}, 58127, var_0_0.SetHeroSkinCallBack)
	else
		print("不存在的皮肤配置信息" .. arg_39_1)
	end
end

function var_0_0:SetHeroSkinCallBack(arg_40_1)
	if isSuccess(self.result) then
		DormData:GetHeroTemplateInfo(BackHomeHeroSkinCfg[arg_40_1.skin_id].hero_id):SetHeroSkinID(BackHomeHeroSkinCfg[arg_40_1.skin_id].hero_id, arg_40_1.skin_id)
		manager.notify:Invoke(DORM_HERO_SKIN_CHANGE, arg_40_1.skin_id)
...
function var_0_0:SetFurnitureTemplatCanSaveCallBack(arg_43_1)
	if isSuccess(self.result) then
