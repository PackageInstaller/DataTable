...
function var_0_0.InitRedPoint(arg_7_0)
	...
	for iter_7_0, iter_7_1 in ipairs(ActivityCfg[arg_7_0].sub_activity_list) do
		table.insert(var_7_0, (string.format("%s_%s", RedPointConst.SEQUENTIAL_BATTLE_DAY, iter_7_1)))
	end
...
function var_0_0.UpdateRedPoint(arg_9_0)
	...
	if var_9_1 < var_9_0.stopTime and var_9_0.startTime <= var_9_1 and getData("sequentialBattle", "activityID_" .. arg_9_0) ~= true and #SequentialBattleData:GetFinishStageList(arg_9_0) < #SequentialBattleChapterCfg[arg_9_0].stage_id then
