...
function var_0_0:OnStartPost(arg_3_1)
	if isSuccess(self.result) then
		local var_3_0 = 1
		local var_3_1 = arg_3_1.thread_id
		local var_3_2 = RogueCardPostingCfg[arg_3_1.thread_id].story_id1

		if RogueCardPostingCfg[arg_3_1.thread_id].story_id1 > 0 then
			manager.story:StartStoryById(RogueCardPostingCfg[arg_3_1.thread_id].story_id1, function(arg_4_0)
				var_0_0.OnCompleteStory(var_3_1, var_3_2, var_3_0)
			end, false)
			var_0_0.CompleteStory(arg_3_1.thread_id, RogueCardPostingCfg[arg_3_1.thread_id].story_id1, 1)
		elseif arg_3_1.thread_id ~= 107 and RogueCardPostingCfg[arg_3_1.thread_id].story_id1 == 0 then
			gameContext:Back()
			RogueCardGameBridge.EnterRogueCardGame(arg_3_1.thread_id, nil, nil, false)
		end
	else
...
function var_0_0:OnRebackPost(arg_6_1)
	if isSuccess(self.result) then
		local var_6_0 = 1
		local var_6_1 = arg_6_1.thread_id
		local var_6_2 = RogueCardPostingCfg[arg_6_1.thread_id].story_id1

		if RogueCardPostingCfg[arg_6_1.thread_id].story_id1 > 0 then
			manager.story:StartStoryById(RogueCardPostingCfg[arg_6_1.thread_id].story_id1, function(arg_7_0)
				var_0_0.OnCompleteStory(var_6_1, var_6_2, var_6_0)
			end, false)
			var_0_0.CompleteStory(arg_6_1.thread_id, RogueCardPostingCfg[arg_6_1.thread_id].story_id1, 1)
		elseif arg_6_1.thread_id ~= 107 and RogueCardPostingCfg[arg_6_1.thread_id].story_id1 == 0 then
			gameContext:Back()
			RogueCardGameBridge.EnterRogueCardGame(arg_6_1.thread_id, nil, nil, false)
		end
	else
		ShowTips(GetTips(self.result))
	end
...
function var_0_0:OnCompletePost(arg_9_1)
	if isSuccess(self.result) then
		if arg_9_1.joker_result == 1 then
			local var_9_0 = arg_9_1.thread_id
			local var_9_1 = RogueCardPostingCfg[arg_9_1.thread_id].story_id2
			local var_9_2 = 2

			if RogueCardPostingCfg[arg_9_1.thread_id].story_id2 and RogueCardPostingCfg[arg_9_1.thread_id].story_id2 > 0 then
				manager.story:StartStoryById(RogueCardPostingCfg[arg_9_1.thread_id].story_id2, function(arg_10_0)
					var_0_0.OnCompleteStory(var_9_0, var_9_1, var_9_2, false)
				end, false)
				var_0_0.CompleteStory(arg_9_1.thread_id, RogueCardPostingCfg[arg_9_1.thread_id].story_id2, 2)
			else
				var_0_0.OnCompleteStory(arg_9_1.thread_id, RogueCardPostingCfg[arg_9_1.thread_id].story_id2, 2, false)
				var_0_0.CompleteStory(arg_9_1.thread_id, RogueCardPostingCfg[arg_9_1.thread_id].story_id2, 2)
			end
		else
...
function var_0_0:OnRogueCardChallengeSettle(arg_17_1)
	if isSuccess(self.result) then
		RogueCardGameBridge.FinishRogueCardGame(function()
...
function var_0_0:OnEnterRogueCardGame(arg_20_1)
	if isSuccess(self.result) then
		if (RogueCardStageCfg[arg_20_1.stage_id].type == 2 and 2 or 1) == 1 then
			RogueCardGameData:SetBattleId(self.battle_id)
		else
			RogueCardGameData:SetChallengeBattleId(self.battle_id)
		end
...
function var_0_0.SaveProgressPost(arg_21_0, arg_21_1, arg_21_2)
	...
	var_21_0 = var_21_1 == 1 and RogueCardGameData:GetBattleId() or RogueCardGameData:GetChallengeBattleId()
...
function var_0_0:OnSaveProgressPost(arg_22_1)
	if isSuccess(self.result) then
...
function var_0_0.SaveRollBackPost(arg_23_0, arg_23_1)
	...
	var_23_1.battle_type = RogueCardStageCfg[arg_23_0].type == 2 and 2 or 1
	var_23_1.save_rollback = arg_23_1

	manager.net:SendWithLoadingNew(89626, var_23_1, 89627, var_0_0.OnSaveRollBackPost)
end

function var_0_0:OnSaveRollBackPost(arg_24_1)
	if isSuccess(self.result) then
...
function var_0_0.ContinueProgressPost(arg_25_0)
	...
	var_25_0 = (RogueCardStageCfg[arg_25_0].type == 2 and 2 or 1) == 1 and RogueCardGameData:GetBattleId() or RogueCardGameData:GetChallengeBattleId()
...
function var_0_0:OnContinueProgressPost(arg_26_1)
	if isSuccess(self.result) then
		...
		RogueCardGameData:SaveStageData(self.save_data, var_26_0)
		RogueCardGameData:SaveRollbackData(self.save_rollback, var_26_0)
		RogueCardGameBridge.EnterRogueCardGame(var_26_0, RogueCardGameData:GetDeck(), RogueCardGameData:GetDiff(), true)
	else
		ShowTips(GetTips(self.result))
	end
end
...
function var_0_0.InterruptPost(arg_31_0)
	...
	var_31_0 = (RogueCardStageCfg[arg_31_0].type == 2 and 2 or 1) == 1 and RogueCardGameData:GetBattleId() or RogueCardGameData:GetChallengeBattleId()
...
function var_0_0:OnInterruptPost(arg_33_1)
	if isSuccess(self.result) then
		...
		RogueCardGameData:SaveSettleData(self.settle_info)
...
function var_0_0.InGameInterruptPost(arg_34_0, arg_34_1)
	...
	var_34_0 = (RogueCardStageCfg[arg_34_0].type == 2 and 2 or 1) == 1 and RogueCardGameData:GetBattleId() or RogueCardGameData:GetChallengeBattleId()
...
function var_0_0:OnInGameInterruptPost(arg_36_1, arg_36_2)
	if isSuccess(self.result) then
		...
		if (RogueCardStageCfg[RogueCardGameTools.GetCurPostingId()].type == 2 and 2 or 1) == 1 then
			RogueCardGameBridge.FinishRogueCardGame(function()
				OpenPageUntilLoaded("/rogueCardGameForumView", {
					isSettle = false
				})
...
function var_0_0:OnViewThreadPost(arg_40_1)
	if isSuccess(self.result) then
...
function var_0_0:OnClickLikePost(arg_42_1)
	if isSuccess(self.result) then
