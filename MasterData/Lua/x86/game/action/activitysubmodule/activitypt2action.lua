...
function var_0_0.RefreshRedPoint(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in ipairs(ActivityCfg.get_id_list_by_activity_theme[ActivityCfg[arg_8_1].activity_theme]) do
	...
	manager.redPoint:setTip(RedPointConst.ACTIVITY_PT_2_OPEN .. "_" .. var_8_0, (ActivityTools.GetActivityStatus(var_8_0) == 1 and ActivityTools.IsUnlockActivity(var_8_0) and not (getData(RedPointConst.ACTIVITY_PT_2_OPEN, tostring(var_8_0)) or false) or nil) and true and 1 or 0)
end
