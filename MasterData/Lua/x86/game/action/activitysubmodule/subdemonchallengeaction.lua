...
function var_0_0.GetChallengeReward(arg_3_0, arg_3_1)
	...
	manager.net:SendWithLoadingNew(11032, {
		id = arg_3_0
	}, 11033, var_0_0.OnGetChallengeReward)
end

function var_0_0:OnGetChallengeReward(arg_4_1)
	...
	manager.notify:CallUpdateFunc(DEMON_CHALLENGE_RECEIVE_REWARD, self, arg_4_1)
end
...
function var_0_0.InitRedPointKey(arg_6_0)
	...
	for iter_6_0 = 1, #var_6_0 do
		manager.redPoint:addGroup(RedPointConst.DEMON_CHALLENGE .. var_6_0[iter_6_0], {
			RedPointConst.DEMON_CHALLENGE_REWARD .. var_6_0[iter_6_0],
			RedPointConst.DEMON_CHALLENGE_UNFINISH .. var_6_0[iter_6_0]
		})
		table.insert(var_6_1, RedPointConst.DEMON_CHALLENGE .. var_6_0[iter_6_0])
	end
...
function var_0_0.UpdateRedPoint(arg_7_0)
	...
	if var_7_0 then
		for iter_7_0, iter_7_1 in pairs(var_7_0.challengeInfo) do
			if iter_7_1.challenge_state > ActivityConst.DEMON_CHALLENGE_STATE.UNFINISHED and iter_7_1.reward_state == ActivityConst.DEMON_CHALLENGE_REWARD_STATE.UNRECEIVE then
				var_7_1 = true
			elseif iter_7_1.challenge_state == ActivityConst.DEMON_CHALLENGE_STATE.FINISHED then
				var_7_2 = false
			end
		end
	end
	...
	if not manager.time:IsToday(getData("DemonChallenge" .. "_" .. USER_ID, tostring(arg_7_0)) or 0) and var_7_2 and not SubDemonChallengeData:GetIsSelected(arg_7_0) then
...
function var_0_0.RefreshRedPoint(arg_8_0)
	if manager.time:GetServerTime() >= ActivityData:GetActivityData(arg_8_0).stopTime then
		for iter_8_0, iter_8_1 in ipairs(ActivityData:GetActivityData(arg_8_0).subActivityIdList) do
