...
function var_0_0:OnHealthRewardBack(arg_6_1)
...
function var_0_0:OnBossDataBack(arg_8_1)
	if isSuccess(self.result) then
		if var_0_1 then
			var_0_1()
		end
...
function var_0_0.CheckRedPoint(arg_9_0)
	if ActivityData:GetActivityIsOpen(arg_9_0) then
		for iter_9_0, iter_9_1 in ipairs(ActivityWorldBossCfg[arg_9_0].health_reward_list) do
