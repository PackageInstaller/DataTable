...
function var_0_0.InitRedPoint(arg_4_0)
	...
	if ActivityData:GetActivityIsOpen(arg_4_0) then
		local var_4_0 = SpringFestivalRiddleData:GetLastAnswerTime(arg_4_0)
		local var_4_1 = var_4_0 + GameSetting.activity_spring_festival_riddle_punish_time.value[1] * 60
		local var_4_2 = GameSetting.refresh_time1.value[1][1]
		local var_4_3 = manager.time:GetNextTime(GameSetting.refresh_time1.value[1][1], 0, 0)

		if SpringFestivalRiddleData:CanAnswer(arg_4_0) then
			if ActivityData:GetActivityIsOpen(arg_4_0) and (var_4_0 + GameSetting.activity_spring_festival_riddle_punish_time.value[1] * 60 <= manager.time:GetServerTime() or var_4_3 - var_4_0 > 86400) then
			...
			var_0_1 = Timer.New(function()
				var_4_3 = manager.time:GetNextTime(var_4_2, 0, 0)

				if ActivityData:GetActivityIsOpen(arg_4_0) and (var_4_1 <= manager.time:GetServerTime() or var_4_3 - var_4_0 > 86400) then
					manager.redPoint:setTip(string.format("%s_%s", RedPointConst.SPRING_FESTIVAL_RIDDLE, arg_4_0), 1)
					var_0_0.StopTimer()
			...
			var_0_1 = Timer.New(function()
				...
				if ActivityData:GetActivityIsOpen(arg_4_0) and var_4_3 - var_4_0 > 86400 then
					manager.redPoint:setTip(string.format("%s_%s", RedPointConst.SPRING_FESTIVAL_RIDDLE, arg_4_0), 1)
					var_0_0.StopTimer()
