...
function var_0_0.RefreshFatigueRedPoint(arg_14_0)
	...
	manager.redPoint:setTip(RedPointConst.ACTIVITY_PUSH_BOX_FATIGUE .. "_" .. arg_14_0, PushBoxTool:GetFatigueMax(arg_14_0) <= ActivityPushBoxData:GetFatigue(arg_14_0) and 1 or 0)
end
