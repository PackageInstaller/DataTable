...
function var_0_0:OnFinisDraw(arg_8_1, arg_8_2)
	if isSuccess(self.result) then
		local var_8_0 = {}
		local var_8_1 = false

		for iter_8_0, iter_8_1 in ipairs(self.drop_list) do
		...
		if not var_8_1 and arg_8_1.card_index > 0 then
			for iter_8_2, iter_8_3 in ipairs(self.drop_list) do
		...
		manager.notify:Invoke(ACTIVITY_OATH_SKIN_DRAW_OPEN, var_8_0, var_8_1)
	else
