...
function var_0_0.QueryCommonRank(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	var_1_1.start = 1
	var_1_1.stop = var_1_0
	var_1_1.version = RankData:GetRankVersion(arg_1_0, arg_1_1)

	manager.net:SendWithLoadingNew(69000, var_1_1, 69001, function(arg_2_0, arg_2_1)
		var_0_0.OnQueryCommonRankBack(arg_2_0, arg_2_1, arg_1_2)
	end)
end

function var_0_0:OnQueryCommonRankBack(arg_3_1, arg_3_2)
	if isSuccess(self.result) then
		if self.version ~= arg_3_1.version or arg_3_1.version == 0 then
			RankData:SetCommonRankData(arg_3_1.rank_id, arg_3_1.children_id, self)
		end
...
function var_0_0.QueryGuildCommonRank(arg_4_0, arg_4_1, arg_4_2)
	...
	manager.net:SendWithLoadingNew(33300, {
		rank_id = arg_4_0,
		children_id = arg_4_1
	}, 33301, function(arg_5_0, arg_5_1)
		var_0_0.OnQueryGuildCommonRankBack(arg_5_0, arg_5_1, arg_4_2)
	end)
end

function var_0_0:OnQueryGuildCommonRankBack(arg_6_1, arg_6_2)
	if isSuccess(self.result) then
		RankData:SetGuildCommonRankData(arg_6_1.rank_id, arg_6_1.children_id, self)
...
function var_0_0.QueryActivityRank(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	var_7_1.version = RankData:GetActivityRankVersion(arg_7_0, arg_7_1)

	manager.net:SendWithLoadingNew(69004, var_7_1, 69005, function(arg_8_0, arg_8_1)
		var_0_0.OnQueryActivityRankBack(arg_8_0, arg_8_1, arg_7_2)
	end)
end

function var_0_0:OnQueryActivityRankBack(arg_9_1, arg_9_2)
	if isSuccess(self.result) then
		if self.version ~= arg_9_1.version or arg_9_1.version == 0 then
			RankData:SetActivityRankData(arg_9_1.activity_id, arg_9_1.children_id, self)
		end
...
function var_0_0.QueryActivityRankWitchCallBack(arg_10_0, arg_10_1, arg_10_2)
	...
	var_10_0.start = 1
	var_10_0.stop = 100
	var_10_0.version = RankData:GetActivityRankVersion(arg_10_0, arg_10_1)

	manager.net:SendWithLoadingNew(69004, var_10_0, 69005, function(arg_11_0)
...
function var_0_0.QueryGuildActivityRank(arg_12_0, arg_12_1)
	...
	}, 33303, var_0_0.OnQueryGuildActivityRankBack)
end

function var_0_0:OnQueryGuildActivityRankBack(arg_13_1)
	if isSuccess(self.result) then
		RankData:SetGuildActivityRankData(arg_13_1.activity_id, arg_13_1.children_id, self)
...
function var_0_0:OnQueryOwnCommonRankBack(arg_18_1, arg_18_2)
	if isSuccess(self.result) then
		for iter_18_0, iter_18_1 in ipairs(self.children_rank_list) do
