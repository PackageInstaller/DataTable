local var_0_0 = {
	[10002] = {
		[NewChessConst.TIMING_ALL] = function(arg_1_0, arg_1_1)
			...
			getReward(getRewardFromDropCfg(arg_1_1, true), nil, function()
	...
	[10004] = {
		[NewChessConst.TIMING_ALL] = function(arg_3_0, arg_3_1)
			...
			manager.NewChessManager:ChangeGridByExtentID(var_3_0.x, var_3_0.z, arg_3_1, false, function()
				return manager.NewChessManager:DoNextEvent()
			end)
		end
	},
	...
	[10009] = {
		[NewChessConst.TIMING_START] = function(arg_9_0, arg_9_1)
			if NewWarChessData:AddNewHero(arg_9_1) then
				if NewWarChessHeroCfg[arg_9_1].effect_type == NewChessConst.HERO_EFFECT_TYPE.BUFF then
					if NewWarChessHeroCfg[arg_9_1].effect_id ~= 0 then
						manager.NewChessManager:AddBuff(NewWarChessHeroCfg[arg_9_1].effect_id)
					else
						print("lrq 当前英雄配置了效果类型没配置效果ID")
					end
				elseif NewWarChessHeroCfg[arg_9_1].effect_type == NewChessConst.HERO_EFFECT_TYPE.DICESKILL then
					if NewWarChessHeroCfg[arg_9_1].effect_id ~= 0 then
						NewWarChessData:AddNewSkill(NewWarChessHeroCfg[arg_9_1].effect_id)
						manager.redPoint:setTip(RedPointConst.NEW_WARCHESS_NEW_DICESKILL .. NewWarChessHeroCfg[arg_9_1].effect_id, 1)
					else
						print("lrq 当前英雄配置了效果类型没配置效果ID")
					end
				end
		...
		[NewChessConst.TIMING_ALL] = function(arg_10_0, arg_10_1)
			if NewWarChessData:AddNewHero(arg_10_1) then
				if NewWarChessHeroCfg[arg_10_1].effect_type == NewChessConst.HERO_EFFECT_TYPE.BUFF then
					if NewWarChessHeroCfg[arg_10_1].effect_id ~= 0 then
						manager.NewChessManager:AddBuff(NewWarChessHeroCfg[arg_10_1].effect_id)
					else
						print("lrq 当前英雄配置了效果类型没配置效果ID")
					end
				elseif NewWarChessHeroCfg[arg_10_1].effect_type == NewChessConst.HERO_EFFECT_TYPE.DICESKILL then
					if NewWarChessHeroCfg[arg_10_1].effect_id ~= 0 then
						NewWarChessData:AddNewSkill(NewWarChessHeroCfg[arg_10_1].effect_id)
						manager.redPoint:setTip(RedPointConst.NEW_WARCHESS_NEW_DICESKILL .. NewWarChessHeroCfg[arg_10_1].effect_id, 1)
					else
						print("lrq 当前英雄配置了效果类型没配置效果ID")
					end
				end
	...
	[10011] = {
		[NewChessConst.TIMING_ALL] = function(arg_13_0, arg_13_1)
			...
			manager.NewChessManager:ChangeObjectByExtentID(var_13_0.x, var_13_0.z, arg_13_1, function()
				return manager.NewChessManager:DoNextEvent()
			end)
		end
	},
	...
	[10013] = {
		[NewChessConst.TIMING_ALL] = function(arg_17_0)
			...
			manager.NewChessManager:DeleteObject(var_17_0.x, var_17_0.z, function()
				return manager.NewChessManager:DoNextEvent()
			end)
		end
	},
	...
	[10022] = {
		[NewChessConst.TIMING_ALL] = function(arg_31_0, arg_31_1)
			...
			NewChessLuaBridge.OpenAreaFog(var_31_0.x, var_31_0.z, arg_31_1, function()
				return manager.NewChessManager:DoNextEvent()
			end)
		end
	},
	[10023] = {
		[NewChessConst.TIMING_ALL] = function(arg_33_0, arg_33_1)
			if arg_33_0[1] and arg_33_0[1] == 1 then
				...
				manager.NewChessManager:ClearInteractChess()
				NewChessLuaBridge.MoveConveyor(var_33_0.x, var_33_0.z, var_33_1, function()
	...
	[10024] = {
		[NewChessConst.TIMING_ALL] = function(arg_35_0, arg_35_1)
			...
			manager.NewChessManager:ClearInteractChess()
			manager.NewChessManager:JumpBoard(var_35_0.x, var_35_0.z, arg_35_1, arg_35_0[1], function()
				manager.NewChessManager:CloseBlock()
		...
		[NewChessConst.TIMING_ALL] = function(arg_37_0, arg_37_1, arg_37_2)
			...
			if arg_37_1 == NewWarChessAttributeCfg.GAME_NEWCHESS_ATTRIBUTE_MOVE_POINT.id and arg_37_2 > 0 and manager.NewChessManager then
				manager.NewChessManager:CreateTips({
					...
					tipsText = string.format(GetTips("ACTIVITY_NEW_WARCHESS_GET_MOVEPOINT"), arg_37_2)
				})
			end

			if arg_37_1 == NewWarChessAttributeCfg.GAME_NEWCHESS_ATTRIBUTE_FINISH.id and arg_37_2 > 0 then
				local var_37_0 = NewWarChessData:GetCurrentWarChessMapID()
				local var_37_1

				for iter_37_0, iter_37_1 in pairs(NewWarChessLevelCfg.all) do
					if NewWarChessLevelCfg[iter_37_1].front_level_id == var_37_0 then
						var_37_1 = NewWarChessLevelCfg[iter_37_1].name_level

						break
					end
				end

				local var_37_2 = var_37_1 ~= nil and string.format(GetTips("ACTIVITY_NEW_WARCHESS_UNLOCK_NEW_LEVEL"), var_37_1) or GetTips("ACTIVITY_NEW_WARCHESS_LEVEL_FINISH")
	...
	[10028] = {
		[NewChessConst.TIMING_ALL] = function(arg_40_0, arg_40_1, arg_40_2)
			...
			if arg_40_1 == NewWarChessAttributeCfg.GAME_NEWCHESS_ATTRIBUTE_FINISH.id and arg_40_2 > 0 then
				...
				local var_40_2 = var_40_1 ~= nil and string.format(GetTips("ACTIVITY_NEW_WARCHESS_UNLOCK_NEW_LEVEL"), var_40_1) or GetTips("ACTIVITY_NEW_WARCHESS_LEVEL_FINISH")
	...
	[10029] = {
		[NewChessConst.TIMING_ALL] = function(arg_41_0, arg_41_1, arg_41_2)
			...
			manager.NewChessManager:PlayGridAnimation(var_41_0.x, var_41_0.z, arg_41_1, arg_41_2, function()
				return manager.NewChessManager:DoNextEvent()
			end)
		end
	},
...
var_0_0.DiceTypeFunc = {
	function(arg_50_0, arg_50_1)
		return {
			var_0_0.OperatorFunc[arg_50_0[2]](var_0_0.OperatorFunc.sum(arg_50_1), arg_50_0[3])
		}
	end,
	...
	function(arg_52_0, arg_52_1)
		...
		for iter_52_0 = 1, var_0_0.OperatorFunc.sum(arg_52_1) do
			table.insert(var_52_0, arg_52_0[2])
		end
	...
	function(arg_57_0, arg_57_1)
		if arg_57_1[1] and arg_57_1[2] then
			return {
				var_0_0.OperatorFunc[arg_57_0[2]](arg_57_1[1], arg_57_1[2]) * arg_57_0[3]
			}
		else
			return {}
		end
...
var_0_0[10031] = {
	[NewChessConst.TIMING_ALL] = function(arg_59_0, arg_59_1, arg_59_2, arg_59_3)
		local var_59_0 = var_0_0.DiceTypeFunc[NewWarChessDiceEventTypeCfg[arg_59_1].param[1]](NewWarChessDiceEventTypeCfg[arg_59_1].param, arg_59_3)
		local var_59_1 = {}
		...
		for iter_59_0, iter_59_1 in pairs(arg_59_2) do
			if iter_59_0 > 1 then
				...
				if type(iter_59_1) == "table" and iter_59_1[1] == -1 then
					table.insert(var_59_1, var_59_0[1])
		...
		var_0_0[arg_59_2[1]][NewChessConst.TIMING_ALL](unpack(var_59_1))
	end
}
var_0_0[10032] = {
	[NewChessConst.TIMING_ALL] = function(arg_60_0, arg_60_1)
		NewWarChessData:SubAllHeroHp(arg_60_1 / 100 * NewChessConst.HERO_HP_RATE)
...
var_0_0[10034] = {
	[NewChessConst.TIMING_ALL] = function(arg_62_0, arg_62_1, arg_62_2)
		...
		NewChessLuaBridge.OpenBarFog(var_62_0.x, var_62_0.z, arg_62_1, arg_62_2, function()
			return manager.NewChessManager:DoNextEvent()
		end)
	end
}
...
var_0_0[10037] = {
	[NewChessConst.TIMING_ALL] = function(arg_67_0, arg_67_1)
		...
		manager.NewChessManager:CreateTips({
			...
			tipsText = string.format(GetTips("ACTIVITY_NEW_WARCHESS_LOST_DICE"), arg_67_1)
		})
...
var_0_0[10044] = {
	[NewChessConst.TIMING_ALL] = function(arg_74_0)
		if arg_74_0[1] and arg_74_0[1] == 1 then
			...
			if arg_74_0[2] then
				NewChessLuaBridge.MoveByDir(var_74_0.x, var_74_0.z, arg_74_0[2], function()
					manager.NewChessManager:CloseBlock()

					return manager.NewChessManager:DoNextEvent()
				end)
			else
				error(var_74_0.x, " ", var_74_0.z, "格子服务器下发的数据中触发冰面滑动事件没有下发方向")
			end
		else
			return manager.NewChessManager:DoNextEvent()
		end
...
function NewWarChessEventIterator:MoveNext()
	self.curEventIndex_ = self.curEventIndex_ + 1

	if self.curEventIndex_ <= #self.eventList_ then
		if self.eventList_[self.curEventIndex_][1] == 10004 then
			manager.NewChessManager:ChangeGridByExtentID(self.chess_.x, self.chess_.z, self.eventList_[self.curEventIndex_][2], false, function()
				self:MoveNext()
			end)
		elseif self.eventList_[self.curEventIndex_][1] == 10029 then
			manager.NewChessManager:PlayGridAnimation(self.chess_.x, self.chess_.z, self.eventList_[self.curEventIndex_][2], self.eventList_[self.curEventIndex_][3], function()
				self:MoveNext()
			end)
		elseif self.eventList_[self.curEventIndex_][1] == 10041 then
			NewChessLuaBridge.FixRoleY(self.eventList_[self.curEventIndex_][2], self.eventList_[self.curEventIndex_][3])
			self:MoveNext()
		elseif self.eventList_[self.curEventIndex_][1] == 10046 then
			manager.NewChessManager:ChangeGridDirection(self.chess_.x, self.chess_.z, self.eventList_[self.curEventIndex_][2], self.eventList_[self.curEventIndex_][3], function()
				self:MoveNext()
			end)
		elseif self.eventList_[self.curEventIndex_][1] == 10052 then
			manager.NewChessManager:ChangeGridByExtentID(self.chess_.x, self.chess_.z, self.eventList_[self.curEventIndex_][2], true, function()
				self:MoveNext()
			end)
		end
	else
...
function NewWarChessEventIterator:Dispose()
	if self.disposeFunc_ then
		self.disposeFunc_(self.entityID_)

		self.entityID_ = nil
		self.chess_ = nil
		self.eventList_ = nil
		self.curEventIndex_ = nil
		self.disposeFunc_ = nil
	end
end
	...
	[NewChessConst.TIMING_ALL] = function(arg_83_0, arg_83_1, arg_83_2)
		...
		for iter_83_0 = -arg_83_1, arg_83_1 do
			for iter_83_1 = math.max(-arg_83_1, iter_83_0 - arg_83_1), math.min(arg_83_1, iter_83_0 + arg_83_1) do
				local var_83_3 = NewChessLuaBridge.GetNewGridData(var_83_0.x + iter_83_0, var_83_0.z + iter_83_1)

				for iter_83_2, iter_83_3 in pairs(arg_83_2) do
					if var_83_3.typeID == iter_83_3[1] then
						var_83_2 = var_83_2 + 1
						var_83_1[var_83_2] = NewWarChessEventIterator.New(var_83_2, var_83_3, iter_83_3[2], function(arg_84_0)
							var_83_1[arg_84_0] = nil
							var_83_2 = var_83_2 - 1
		...
		if var_83_2 == 0 then
			...
			for iter_83_4, iter_83_5 in pairs(var_83_1) do
				iter_83_5:MoveNext()
			end
		end
	end
...
var_0_0[10046] = {
	[NewChessConst.TIMING_ALL] = function(arg_85_0, arg_85_1, arg_85_2)
		...
		manager.NewChessManager:ChangeGridDirection(var_85_0.x, var_85_0.z, arg_85_1, arg_85_2, function()
			return manager.NewChessManager:DoNextEvent()
		end)
	end
}
...
function NewWarChessCheckEventIterator:MoveNext()
	self.curEventIndex_ = self.curEventIndex_ + 1

	if self.curEventIndex_ <= #self.eventList_ then
		if self.eventList_[self.curEventIndex_][1] == 10041 then
			NewChessLuaBridge.FixRoleY(self.eventList_[self.curEventIndex_][2], self.eventList_[self.curEventIndex_][3])
			self:MoveNext()
		elseif self.eventList_[self.curEventIndex_][1] == 10055 then
			manager.NewChessManager:ClearInteractChess()
			NewChessLuaBridge.TelePortRoleToPosition(self.params_.x, self.params_.z, function()
				self:MoveNext()
			end)
		end
	else
...
function NewWarChessCheckEventIterator:Dispose()
	if self.disposeFunc_ then
		self.disposeFunc_()
		...
		if arg_93_0[1] == 1 then
			...
			for iter_93_0, iter_93_1 in pairs(arg_93_1) do
				for iter_93_2, iter_93_3 in pairs(iter_93_1[1]) do
					if iter_93_3 == arg_93_0[2] then
						var_93_0 = iter_93_1[2]
...
var_0_0[10051] = {
	[NewChessConst.TIMING_ALL] = function(arg_99_0, arg_99_1)
		...
		for iter_99_0, iter_99_1 in pairs(arg_99_1) do
			manager.NewChessManager:PlayGridAnimation(iter_99_1[1], iter_99_1[2], iter_99_1[3], iter_99_1[4], function()
				var_99_0 = var_99_0 - 1
...
var_0_0[10052] = {
	[NewChessConst.TIMING_ALL] = function(arg_101_0, arg_101_1)
		...
		manager.NewChessManager:ChangeGridByExtentID(var_101_0.x, var_101_0.z, arg_101_1, true, function()
			return manager.NewChessManager:DoNextEvent()
		end)
	end
}
