...
local function var_0_3(arg_4_0, arg_4_1)
	...
	var_0_1(arg_4_0.entityId, (arg_4_1 or nil) and (arg_4_1.index or -1))
...
local function var_0_4(arg_5_0, arg_5_1)
	...
	if arg_5_0.localData.childUnits[arg_5_0.localData.nowStep] then
		var_0_0(arg_5_0.localData.childUnits[arg_5_0.localData.nowStep], false)
	end
	...
	if arg_5_0.localData.childUnits[arg_5_0.localData.nowStep] then
		var_0_0(arg_5_0.localData.childUnits[arg_5_0.localData.nowStep], true)
...
local function var_0_5(arg_6_0)
	...
	arg_6_0.localData.childCount = var_6_0.entity_child_list.Count

	for iter_6_0 = 0, var_6_0.entity_child_list.Count - 1 do
		local var_6_1 = QWorldLuaBridge.GetMapEntityData(var_6_0.entity_child_list[iter_6_0])
		local var_6_2 = arg_6_0:SpawnChild(var_6_1.script_name, var_6_0.entity_child_list[iter_6_0], var_6_1.configId)
		local var_6_3 = var_6_1.index

		arg_6_0.localData.childUnits[var_6_1.index] = var_6_2

		var_6_2.entity:SetBuild(var_6_1.isLast and "QWWorld/Effect/fx_yahaha_catch_footprint_white" or "QWWorld/Effect/fx_yahaha_catch_footprint")
		var_0_0(var_6_2, false)

		var_6_2.localData.hasEnter = true
		var_6_2.localData.hasExit = true
		var_6_2.localData.index = var_6_3
		var_6_2.localData.isLast = var_6_1.isLast
		...
		if var_6_2.localData.isLast then
...
return QWorldPrefab.New("QWCatchFlower", function(arg_13_0, arg_13_1)
