...
return QWorldPrefab.New("QWNpc", function(arg_2_0, arg_2_1)
	...
	function var_2_0.entity.bubbleClick(arg_3_0)
		...
		if var_2_0:HudLogic() then
			return
		end

		local var_3_1 = var_2_0:GetDefaultTalk()

		if var_3_1 and var_3_1 ~= 0 then
			QWorldTools.SendMessageToSDK(QWorldMgr:GetActivityId(), QWorldMgr:GetMapId(), QWorldMessageType.TALK, var_3_1, "", var_2_0.entityId)
			var_2_0:StartStory(var_3_1)
		end
	end
