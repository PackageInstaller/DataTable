...
local function var_0_3(arg_4_0, arg_4_1)
	QWorldLuaBridge.DestroyQWorldAsset(var_0_1(arg_4_0, arg_4_0.config.collectStartEffect), 1)
...
local function var_0_5(arg_6_0, arg_6_1)
	QWorldLuaBridge.DestroyQWorldAsset(var_0_1(arg_6_0, arg_6_0.config.winEffect), 1)
end

local function var_0_6(arg_7_0, arg_7_1)
	QWorldLuaBridge.DestroyQWorldAsset(var_0_1(arg_7_0, arg_7_0.config.failEffect), 1)
end
...
return QWorldPrefab.New("QWMiniGameCellUnit", function(arg_11_0, arg_11_1)
