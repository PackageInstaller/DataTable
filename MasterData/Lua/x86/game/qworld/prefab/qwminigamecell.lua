local function var_0_0(arg_1_0, arg_1_1)
	...
	local var_1_0 = manager.time:GetServerTime()
	local var_1_1 = arg_1_0.localData.startTime
	local var_1_3
	local var_1_2

	if not arg_1_0.localData.startTime then
		var_1_1 = 0
		var_1_2 = "activity_combat_over"
		var_1_3 = {
	...
	var_1_3.use_seconds = var_1_0 - var_1_1 or 0

	SDKTools.SendMessageToSDK(var_1_2, var_1_3)
...
local function var_0_2(arg_3_0)
	...
	for iter_3_0 = 0, var_3_1.entity_child_list.Count - 1 do
		local var_3_2 = QWorldLuaBridge.GetMapEntityData(var_3_1.entity_child_list[iter_3_0])
		local var_3_3 = arg_3_0:SpawnChild(var_3_2.script_name, var_3_1.entity_child_list[iter_3_0], var_3_2.configId)

		if var_3_2.script_name == "QWMiniGameCellUnit" then
			table.insert(arg_3_0.localData.cell_uniqueId_list, var_3_3.uniqueId)
			table.insert(arg_3_0.localData.cell_uniqueId_process, var_3_3.uniqueId)
...
return QWorldPrefab.New("QWMiniGameCell", function(arg_10_0, arg_10_1)
