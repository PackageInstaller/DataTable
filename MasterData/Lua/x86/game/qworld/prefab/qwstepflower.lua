...
local function var_0_5(arg_5_0, arg_5_1)
	...
	var_0_3(arg_5_0.entityId, (arg_5_1 or nil) and (arg_5_1.index or -1))
...
local function var_0_6(arg_7_0, arg_7_1)
	...
	if arg_7_1.index == arg_7_0.localData.nowIndex + 1 then
		...
		arg_7_0.localData.childUnits[arg_7_0.localData.nowIndex].entity:SetBuild(var_0_0.pass .. arg_7_0.localData.childUnits[arg_7_0.localData.nowIndex].localData.index)
...
local function var_0_7(arg_8_0)
	...
	arg_8_0.localData.totalNum = var_8_0.entity_child_list.Count - 1

	for iter_8_0 = 0, var_8_0.entity_child_list.Count - 1 do
		local var_8_1 = QWorldLuaBridge.GetMapEntityData(var_8_0.entity_child_list[iter_8_0])
		local var_8_2 = arg_8_0:SpawnChild(var_8_1.script_name, var_8_0.entity_child_list[iter_8_0], var_8_1.configId)

		var_8_2.localData.hasExit = not var_8_1.isAreaNode

		if not var_8_1.isAreaNode then
			arg_8_0.localData.childUnits[var_8_1.index] = var_8_2
			var_8_2.localData.hasEnter = false
			var_8_2.localData.index = var_8_1.index
			var_8_2.localData.isLast = var_8_1.isLast

			var_8_2.entity:SetBuild(var_0_0.start .. var_8_1.index)
			arg_8_0:ListenForEvent("next_step", function(arg_9_0, arg_9_1)
				var_0_6(arg_8_0, arg_9_1)
			end, var_8_2)

			if var_8_2.localData.isLast then
...
return QWorldPrefab.New("QWStepFlower", function(arg_14_0, arg_14_1)
