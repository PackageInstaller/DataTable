...
local function var_0_1(arg_2_0)
	...
	local var_2_1 = QWorldMgr:GetQWorldEntityMgr():GetEntByEntityId(arg_2_0.entity.entityId)

	if var_2_1 then
		var_2_1:RemoveMiniMapEntity(QWorldEntityMiniMapTag.Thing, SandplayThingCfg[arg_2_0.configId].label[1])
	end
...
local function var_0_2(arg_3_0)
	...
	QWorldMgr:StartBlackFade(0.3, 0.3, 0.2, function()
		...
		FrameTimer.New(function()
			QWorldLuaBridge.TeleportToCachePos(arg_3_0:GetPosition(), Quaternion.Euler(0, Quaternion.LookRotation(manager.ui.mainCamera.transform.position - arg_3_0:GetPosition()).eulerAngles.y, 0), false, true)
		end, 1, 1):Start()
	end)
end
...
return QWorldPrefab.New("QWPhotoGame", function(arg_8_0, arg_8_1)
