...
function var_0_0:DialogueNode_2()
	...
	self:ShowTalkView()
	self:SetTalkContent(11261001, "", 907301)
...
function var_0_0:DialogueNode_3()
	self:ShowTalkView()
	self:SetTalkContent(11261002, "", 9520)
	self:SetChoice({
		[0] = {
			id = 11261003,
			icon = "",
...
function var_0_0:PureActorDialogueNode_6()
	self:PlayActorAnimationAction(907301, "win", 0, 1.933333, function()
		return
	end)
...
function var_0_0:DialogueNode_7()
	self:EnableCameraByTagAction("1", 1, 0)
	self:PlayActorAnimationAction(907301, "embarrassed", 0, 2.6, function()
		return
	end)
	self:ShowTalkView()
	self:SetTalkContent(11261005, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_8()
	...
	self:ShowTalkView()
	self:SetTalkContent(11261006, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_9()
	self:ShowTalkView()
	self:SetTalkContent(11261007, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_10()
	...
	self:ShowTalkView()
	self:SetTalkContent(11261008, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_11()
	self:PlayActorAnimationAction(907301, "conversation_2", 0, 3.166667, function()
		return
	end)
	self:ShowTalkView()
	self:SetTalkContent(11261009, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_12()
	self:ShowTalkView()
	self:SetTalkContent(11261010, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_13()
	self:ShowTalkView()
	self:SetTalkContent(11261011, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_14()
	self:PlayActorAnimationAction(907301, "think_start", 0, 1.333333, function()
		return
	end)
	self:ShowTalkView()
	self:SetTalkContent(11261012, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_15()
	self:ShowTalkView()
	self:SetTalkContent(11261013, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_16()
	...
	self:ShowTalkView()
	self:SetTalkContent(11261014, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_17()
	self:ShowTalkView()
	self:SetTalkContent(11261015, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
