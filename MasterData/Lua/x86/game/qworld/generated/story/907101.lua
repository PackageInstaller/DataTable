...
function var_0_0:DialogueNode_1()
	self:ShowTalkView()
	self:SetTalkContent(907101001, "", 0)
	self:SetChoice({
		[0] = {
			id = 907101002,
			icon = "",
...
function var_0_0:DialogueNode_4()
	self:ShowTalkView()
	self:SetTalkContent(907101004, "", 0)
...
function var_0_0:DialogueNode_5()
	self:ShowTalkView()
	self:SetTalkContent(907101005, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_6()
	self:ShowTalkView()
	self:SetTalkContent(907101006, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_7()
	self:ShowTalkView()
	self:SetTalkContent(907101007, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
