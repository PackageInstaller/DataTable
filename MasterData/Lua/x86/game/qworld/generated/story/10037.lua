...
local var_0_0 = class("10037", BaseStoryGraph)
...
function var_0_0:ConfigPath()
	return "QWWorld/StoryGraph/10037"
end
...
function var_0_0:DialogueNode_1()
	self:ShowTalkView()
	self:SetTalkContent(10037001, "", 0)
...
function var_0_0:DialogueNode_2()
	self:ShowTalkView()
	self:SetTalkContent(10037002, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_3()
	self:ShowTalkView()
	self:SetTalkContent(10037003, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_4()
	self:ShowTalkView()
	self:SetTalkContent(10037004, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_5()
	self:ShowTalkView()
	self:SetTalkContent(10037005, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_6()
	self:ShowTalkView()
	self:SetTalkContent(10037006, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_7()
	self:ShowTalkView()
	self:SetTalkContent(10037007, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_8()
	self:ShowTalkView()
	self:SetTalkContent(10037008, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_9()
	self:ShowTalkView()
	self:SetTalkContent(10037009, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_10()
	self:ShowTalkView()
	self:SetTalkContent(10037010, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_11()
	self:ShowTalkView()
	self:SetTalkContent(10037011, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
