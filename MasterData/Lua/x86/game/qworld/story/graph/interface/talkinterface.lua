return {
	Inject = function(arg_1_0, arg_1_1)
		...
		function arg_1_1:SetTalkContent(arg_2_1, arg_2_2, arg_2_3)
			if SandplayStoryTalkCfg[arg_2_1] then
				self:RememberHistory(arg_2_1)
				var_1_0:RenderContent(arg_2_1, arg_2_2, arg_2_3)
				self.blackboard:PlayTalkSheet(SandplayStoryTalkCfg[arg_2_1].voice_actor or -1, SandplayStoryTalkCfg[arg_2_1].cue_sheet, SandplayStoryTalkCfg[arg_2_1].cue_name)
			else
