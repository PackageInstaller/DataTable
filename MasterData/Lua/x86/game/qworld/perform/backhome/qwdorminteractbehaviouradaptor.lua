...
local var_0_2 = {
	play = function(self, arg_1_1)
		...
		QWorldMgr:GetQWorldPerformMgr().GetCManager(var_1_0):PlayAnimeDuringInteract(var_1_0:GetEnt(arg_1_1.eID).entity, self.animeActionName, self.crossFade, self.entity)
	end,
	putAt = function(self, arg_2_1)
		local var_2_0 = QWorldMgr:GetQWorldEntityMgr()

		QWorldMgr:GetQWorldPerformMgr().GetCManager(var_2_0):PutAt(var_2_0:GetEnt(arg_2_1.eID).entity, self.referencePointName)
	end,
	...
	clearEfx = function(self, arg_4_1)
		local var_4_0 = QWorldMgr:GetQWorldEntityMgr()

		QWorldMgr:GetQWorldPerformMgr().GetCManager(var_4_0):ClearEffect(var_4_0:GetEnt(arg_4_1.eID).entity, self.attachPoint, self.entity)
	end,
	attachTo = function(self, arg_5_1)
		local var_5_0 = QWorldMgr:GetQWorldEntityMgr()
		local var_5_1 = var_5_0:GetEnt(arg_5_1.eID).entity

		QWorldMgr:GetQWorldPerformMgr().GetCManager(var_5_0):AttachToEntity(1, self.attachPoint)
	end,
	grabPart = function(self, arg_6_1)
		local var_6_0 = QWorldMgr:GetQWorldEntityMgr()
		local var_6_1 = var_6_0:GetEnt(arg_6_1.eID).entity

		QWorldMgr:GetQWorldPerformMgr().GetCManager(var_6_0):GrabItemPart(1, self.itemPartName, self.attachPoint)
	end,
	restorePart = function(arg_7_0, arg_7_1)
		return
	end,
	setEntityVisible = function(self, arg_8_1)
		local var_8_0 = QWorldMgr:GetQWorldEntityMgr()
		local var_8_1 = var_8_0:GetEnt(arg_8_1.eID).entity

		QWorldMgr:GetQWorldPerformMgr().GetCManager(var_8_0):SetVisible(self.entity, self.visible)
	end
}
