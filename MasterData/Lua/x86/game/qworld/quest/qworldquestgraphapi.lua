return {
	Init = function(arg_1_0)
		...
		function _GRAPH_API.BubbleOptionAdd(arg_29_0, arg_29_1, arg_29_2)
			local var_29_0 = QWorldMgr:GetQWorldEntityMgr():GetEntByEntityId(arg_29_1)
			...
			var_29_0:AddQuestTag(arg_29_0, SandplayTaskCfg[arg_29_0].task_tag, function()
				arg_29_2()
			end)
		end

		function _GRAPH_API.BubbleOptionRemove(arg_31_0, arg_31_1)
			local var_31_0 = QWorldMgr:GetQWorldEntityMgr():GetEntByEntityId(arg_31_1)
			...
			var_31_0:RemoveQuestTag(arg_31_0)
		end
		...
		function _GRAPH_API.FollowNpc(arg_36_0, arg_36_1, arg_36_2, arg_36_3, arg_36_4, arg_36_5, arg_36_6)
			...
			if var_36_0.StartSeeker then
				if not arg_36_6 then
					...
					var_36_3.enableInteraction = arg_36_6.enableInteraction or false
					var_36_3.mode = arg_36_6.mode

					var_36_0:StartSeeker(var_36_1, arg_36_3, arg_36_5, nil, arg_36_4, 0.01, arg_36_2 == 1, var_36_3)
				end
			else
		...
		function _GRAPH_API.Delay(arg_43_0, arg_43_1)
			QWorldQuestGraph:StartTimer((Timer.New(arg_43_1, arg_43_0, 0)))
		end
	end,
