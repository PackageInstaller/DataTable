local var_0_0 = {
	...
	SnapToNearestInteractPoint = function(arg_8_0, arg_8_1, arg_8_2)
		local var_8_0 = CanteenAIFunction:GetNearestPoint(arg_8_0, (CanteenItemManager.GetItemInteractPositions(arg_8_1)))

		arg_8_2 = arg_8_2 or Dorm.DormEntityManager.QueryPosition(arg_8_1) - var_8_0

		Dorm.DormEntityManager.PutEntityLookToDir(arg_8_0, var_8_0, arg_8_2)
	end
}
...
function var_0_0.RefreshFoodContainer(arg_9_0, arg_9_1)
	...
	for iter_9_0 = 1, (var_9_3.foodList or nil) and (#var_9_3.foodList or 0) do
		if iter_9_0 <= var_9_2 then
			Dorm.DormEntityManager.PutEntityAt(arg_9_1[iter_9_0], arg_9_0, var_9_1[iter_9_0])
			Dorm.DormEntityManager.SetEntityVisible(arg_9_1[iter_9_0], true)
		else
			Dorm.DormEntityManager.SetEntityVisible(arg_9_1[iter_9_0], false)
		end
	end
end
...
function var_0_0.PutFoodOnTable(arg_11_0, arg_11_1)
	...
	table.insert(var_11_0.foodList, arg_11_0)
...
var_0_0.waitAnime.waitAnimeFunc = var_0_2
var_0_0.waitAnime.defaultWaitAnimation = var_0_2(Dorm.DormEntityManager.IsSameAnimeAction)
var_0_0.waitAnime.defaultWaitExactAnimation = var_0_2(var_0_1)
var_0_0.waitAnime.handleEventWaitAnimation = var_0_3(Dorm.DormEntityManager.IsSameAnimeAction)
var_0_0.waitAnime.handleEventWaitExactAnimation = var_0_3(var_0_1)
...
function var_0_0.commonAction.PlaceCarryingItemAction(arg_20_0, arg_20_1, arg_20_2)
	...
	end):HandleAnimeLoop(var_0_0.waitAnime.handleEventWaitExactAnimation(arg_20_0, "serve02", {
		release = function()
...
function var_0_0.commonAction.PickItemAction(arg_24_0, arg_24_1, arg_24_2)
	...
	return (var_0_0.NewTask():WaitUntil(function()
	...
	end):HandleAnimeLoop(var_0_0.waitAnime.handleEventWaitExactAnimation(arg_24_0, "serve01", {
		grab = function()
