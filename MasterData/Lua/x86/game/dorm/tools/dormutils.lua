...
local function var_0_1(arg_8_0, arg_8_1, arg_8_2)
	return arg_8_0[arg_8_2 and arg_8_0.Length - arg_8_1 or arg_8_1 - 1]
end
...
local function var_0_7(arg_13_0)
	if var_0_0.GetEntityData(arg_13_0).heroID == nil then
		return
	end
	...
	if DormHeroTools:CheckIsVisitHero(arg_13_0) then
		...
		if Dorm.charaVfxActiveType then
			for iter_13_0, iter_13_1 in ipairs(Dorm.charaVfxActiveType) do
				if var_0_6[iter_13_1] then
					var_13_2.vfxStatus[iter_13_1] = var_0_5[iter_13_1] and var_0_5[iter_13_1](var_0_0.GetEntityData(arg_13_0).heroID, arg_13_0)
				end
			end
		end
		...
		local var_13_3 = Dorm.storage:GetData(var_0_4, var_0_0.GetEntityData(arg_13_0).heroID)
		...
		if var_13_3 == nil then
			...
			if Dorm.charaVfxActiveType then
				for iter_13_2, iter_13_3 in ipairs(Dorm.charaVfxActiveType) do
					var_13_3.vfxStatus[iter_13_3] = var_0_5[iter_13_3] and var_0_5[iter_13_3](var_0_0.GetEntityData(arg_13_0).heroID, arg_13_0)
				end
			end

			Dorm.storage:RecordData(var_0_4, var_0_0.GetEntityData(arg_13_0).heroID, var_13_3)
		end
...
function var_0_0.ShowCharaSpecialVfx(arg_14_0, arg_14_1)
	...
	if next(arg_14_1) then
		...
		for iter_14_0, iter_14_1 in ipairs(arg_14_1) do
			if var_0_3[iter_14_1] and var_14_0.vfxStatus[iter_14_1] and not var_14_0.hideVfx then
				Dorm.DormEntityManager.PlayEffect(arg_14_0, var_0_3[iter_14_1].attachPoint, var_0_8, var_0_3[iter_14_1].path, var_0_3[iter_14_1].duration)
