...
local function var_0_4(arg_4_0, arg_4_1)
	if package.loaded["game.dorm.interacts.canteen.cook_" .. arg_4_0 .. "_" .. arg_4_1] then
		if type(package.loaded["game.dorm.interacts.canteen.cook_" .. arg_4_0 .. "_" .. arg_4_1]) == "table" then
			return package.loaded["game.dorm.interacts.canteen.cook_" .. arg_4_0 .. "_" .. arg_4_1]
		end
	else
		local var_4_0 = Dorm.InteractionGrouping["game.dorm.interacts.canteen.cook_" .. arg_4_0 .. "_" .. arg_4_1]

		if Dorm.InteractionGrouping["game.dorm.interacts.canteen.cook_" .. arg_4_0 .. "_" .. arg_4_1] then
			return var_4_0[math.random(#var_4_0)]
		end
	end
end
...
function var_0_0.Cook(arg_5_0, arg_5_1, arg_5_2)
	for iter_5_0, iter_5_1 in pairs(var_0_2) do
		if arg_5_0 == iter_5_1.eid then
			local var_5_0 = DormCharacterInteractBehaviour.MakeCtx(arg_5_0, arg_5_1)
			local var_5_1 = DormCharacterInteractBehaviour.MakeInteractTask(var_0_4("saucepan", DormUtils.GetEntityData(arg_5_0).style), var_5_0) or DormCharacterActionManager.taskRunner:NewTask()

			var_5_1:Then(function()
				arg_5_2:Notify()
			end)

			var_5_0.curActionTask = var_5_1

			DormUtils.SetEntityInteractContext(arg_5_0, var_5_0)
		end
	end
end
...
local function var_0_5(arg_7_0, arg_7_1)
	if arg_7_0 == arg_7_1.eid then
		if arg_7_1.wait ~= nil then
			...
			local var_7_0 = DormUtils.GetEntityData(arg_7_1.eid)
		end

		arg_7_1.wait = DormCharacterActionManager.taskRunner:NewTask():WaitUntil(function()
			return (var_7_0.pause or 0) <= UnityEngine.Time.time
		end):Then(function()
			var_7_0.pause = nil
