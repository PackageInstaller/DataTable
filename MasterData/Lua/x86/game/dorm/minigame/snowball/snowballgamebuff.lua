...
local function var_0_2(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_0.speedUpFactor, var_1_0.slowdownFactor = arg_1_1 or var_1_0.speedUpFactor or 1, arg_1_2 or var_1_0.slowdownFactor or 1

	local var_1_1 = var_1_0.speed or defaultEntitySpeed
	local var_1_2 = 1
	...
	print("SetGameEntitySpeedByScale", arg_1_1, arg_1_2, var_1_2)
	Dorm.DormEntityManager.SetEntitySpeed(arg_1_0, var_1_1 * var_1_2)
end
