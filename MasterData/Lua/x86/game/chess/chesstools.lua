...
function var_0_2.GetChapterProgress(arg_20_0)
	...
	if WarchessLevelCfg[arg_20_0] == nil then
		...
		var_20_0 = WarChessData:GetBoxNum(arg_20_0, ChessConst.BOX.BIG)
	end

	local var_20_1 = WarChessData:GetBoxNum(arg_20_0, ChessConst.BOX.SMALL) * WarchessLevelCfg[arg_20_0].sbox_progress

	return var_20_1 + var_20_0 * WarchessLevelCfg[arg_20_0].lbox_progress > 100 and 100 or var_20_1 + var_20_0 * WarchessLevelCfg[arg_20_0].lbox_progress
end
