...
function var_0_0:RecordCombatOpers()
	local var_3_0 = {}

	for iter_3_0 = 0, self.Length - 1 do
		if self[iter_3_0] == 6 then
			table.insert(var_3_0, {
				op_type = "combat",
				oper = "combat_shanbi"
			})
		elseif self[iter_3_0] == 5 then
			table.insert(var_3_0, {
				op_type = "combat",
				oper = "combat_pugong"
			})
		elseif self[iter_3_0] == 0 then
			table.insert(var_3_0, {
				op_type = "combat",
				oper = "combat_jineng1"
			})
		elseif self[iter_3_0] == 1 then
			table.insert(var_3_0, {
				op_type = "combat",
				oper = "combat_jineng2"
			})
		elseif self[iter_3_0] == 2 then
			table.insert(var_3_0, {
				op_type = "combat",
				oper = "combat_jineng3"
			})
		elseif self[iter_3_0] == 7 then
			table.insert(var_3_0, {
				op_type = "combat",
				oper = "combat_QTE"
			})
		elseif self[iter_3_0] == 8 then
			table.insert(var_3_0, {
				op_type = "combat",
				oper = "combat_suoding"
			})
...
function var_0_0.RecordStayView(arg_4_0, arg_4_1, ...)
	...
	elseif arg_4_0 == "STAY_VIEW_GAME_HELP" then
		var_0_0.sendStayViewWithType("duration_explain", arg_4_1, var_4_0[1] or 0)
	elseif arg_4_0 == "STAY_VIEW_SETTING_SKILL" then
		var_0_0.sendStayViewWithType("duration_skill_description", arg_4_1, var_4_0[1] or 0)
	end
end
...
function var_0_0.sendStayHeroChess(arg_8_0, arg_8_1, arg_8_2)
	SDKTools.SendMessageToSDK(arg_8_0, {
		...
		map_id = WarChessData:GetCurrentWarChessMapData().mapId
	})
end
