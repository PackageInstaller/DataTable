...
function var_0_0.NeedShowLocation(arg_81_0, arg_81_1)
	...
	if BattleStageData:GetStageData()[ChapterLocationCfg[arg_81_1].show_by_stage_id] and BattleStageData:GetStageData()[ChapterLocationCfg[arg_81_1].show_by_stage_id].clear_times > 0 then
		return true
	end

	if BattleStageData:GetStageData()[ChapterLocationCfg[arg_81_1].hide_by_stage_id] and BattleStageData:GetStageData()[ChapterLocationCfg[arg_81_1].hide_by_stage_id].clear_times > 0 then
		return false
	end
	...
	if ChapterLocationCfg[arg_81_1].type == BattleConst.LOCATION_TYPE.CLUE or ChapterLocationCfg[arg_81_1].type == BattleConst.LOCATION_TYPE.BATTLE_CLUE then
		local var_81_1 = BattleStageData:GetMapLocationData(arg_81_0)

		if ChapterLocationCfg[arg_81_1].need_scan == 1 and (not var_81_1 or not var_81_1[arg_81_1]) then
			return false
		else
			return true
		end
