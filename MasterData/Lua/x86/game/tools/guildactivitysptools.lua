...
function var_0_0.GetActivityEnterViewPrefab(arg_1_0)
	return arg_1_0 == ActivityConst.GUILD_ACTIVITY_SP_2_4 and Asset.Load("UI/GuildActivitySPUI/GuildActivitySPEnterUI") or Asset.Load("UI/VersionUI/IndiaUI_2_8/IndiaGuildUI/IndiaGuildActivitySPEnterUI")
end
...
function var_0_0.GetCurOpenActivityStateInfo()
	return var_0_1[GuildActivitySPData:GetCurMainActivityID()]
end
...
function var_0_0.CheckGuildActivitySPIsOpen()
	...
	if var_6_0 then
		...
		if var_6_1.startTime <= var_6_2 and var_6_2 < var_6_1.stopTime then
			return true, var_6_0
		end
	end
...
function var_0_0.CheckActivityCurState(arg_7_0)
	if var_0_1[arg_7_0] then
		if var_0_0.CheckActivityIsOpen(var_0_1[arg_7_0].start) then
			return "start", var_0_1[arg_7_0].start
		end

		if var_0_0.CheckActivityIsOpen(var_0_1[arg_7_0].register) then
			return "register", var_0_1[arg_7_0].register
		end
	end
end
...
function var_0_0.CheckActivityIsOpen(arg_8_0)
	...
	if var_8_0.startTime <= var_8_1 and var_8_1 < var_8_0.stopTime then
		return true
	end
end
...
function var_0_0.GetCurActivityTimeStage(arg_9_0)
	...
	if var_9_0.startTime + GameSetting.activity_club_sp_phase_two_open.value[1] * 24 * 3600 < manager.time:GetServerTime() then
		return 2, var_9_0.stopTime, var_9_0.startTime + GameSetting.activity_club_sp_phase_two_open.value[1] * 24 * 3600
	else
		return 1, var_9_0.stopTime, var_9_0.startTime + GameSetting.activity_club_sp_phase_two_open.value[1] * 24 * 3600
	end
end

function var_0_0.GetTopUserLevel(arg_10_0)
	if ActivityClubLevelSettingCfg.get_id_list_by_activity[arg_10_0] then
		return #ActivityClubLevelSettingCfg.get_id_list_by_activity[arg_10_0]
	end
end
...
function var_0_0.GetCantUseHeroList()
	...
	for iter_12_0, iter_12_1 in ipairs((GuildActivitySPData:GetFightHeroList())) do
		table.insert(var_12_0, iter_12_1.id)
	end

	local var_12_1 = {}

	for iter_12_2, iter_12_3 in ipairs((HeroData:GetUnlockHeros())) do
		if not table.indexof(var_12_0, iter_12_3) then
