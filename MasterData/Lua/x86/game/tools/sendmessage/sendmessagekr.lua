...
var_0_0.typeToFunction = {
	...
	purchase_crystal = function(self)
		SDKTools.SetParamsAttribute("af_buy_pay" .. tostring(self.purchaseNum), {
			subType = 0
		})
		SDKTools.SetParamsAttribute("Fire_buy_pay" .. tostring(self.purchaseNum), {
			subType = 0
		})
	end,
	...
	account_create_ys = function()
		...
		var_11_0.os_version = tostring((var_0_2 or nil) and (var_0_2.system or nil))
		var_11_0.ram = tostring(UnityEngine.SystemInfo.systemMemorySize)
		var_11_0.rom = tostring(LuaForUtil.GetFreeDiskSpace())
		var_11_0.cpu_hardware = _G.CPUINFO
		var_11_0.network = _G.NETTYPE
		var_11_0.mac = tostring(var_0_2.mac)
		var_11_0.ip = _G.TCP_ADDR
		var_0_1 = var_11_0
	...
	role_level = function(self)
		...
		if self.level == 7 or self.level == 10 or self.level == 15 or self.level == 30 then
			SDKTools.SetParamsAttribute("af_levelachieved" .. tostring(self.level), var_0_1)
			SDKTools.SetParamsAttribute("Fire_levelachieved" .. tostring(self.level), {
				subType = 0
			})
		end
	end
