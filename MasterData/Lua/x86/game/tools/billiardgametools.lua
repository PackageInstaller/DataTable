return {
	...
	GetIsInTrackChain = function(arg_2_0)
		...
		if not MergeBallBuffCfg[arg_2_0] then
			return false
		end

		local var_2_2 = MergeBallBuffCfg[var_2_0]

		if not MergeBallBuffCfg[var_2_0] then
			return false
		end
		...
		if var_2_1.parent_id and type(var_2_2.formula) == "table" and #var_2_2.formula > 0 then
			local var_2_4 = true
			local var_2_5 = false

			for iter_2_0, iter_2_1 in ipairs(var_2_1.parent_id) do
				for iter_2_2, iter_2_3 in ipairs(var_2_2.formula) do
		...
		local function var_2_6(arg_4_0)
			...
			if MergeBallBuffCfg[arg_4_0] and var_4_0.parent_id then
				for iter_4_0, iter_4_1 in ipairs(var_4_0.parent_id) do
					if var_2_6(iter_4_1) then
						return true
					end
				end
			end
