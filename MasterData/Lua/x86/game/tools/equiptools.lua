	...
	if arg_17_1 then
		for iter_17_2 = 1, #EquipCfg[self.prefab_id].effect do
			if EquipCfg[self.prefab_id].effect[iter_17_2] and var_17_1 >= EquipCfg[self.prefab_id].effect_unlock_level[iter_17_2] then
				var_17_0[EquipSkillCfg[EquipCfg[self.prefab_id].effect[iter_17_2][1]].attribute] = ((not var_17_0[EquipSkillCfg[EquipCfg[self.prefab_id].effect[iter_17_2][1]].attribute] or nil) and 0) + EquipSkillCfg[EquipCfg[self.prefab_id].effect[iter_17_2][1]].upgrade * EquipCfg[self.prefab_id].effect[iter_17_2][2]
			end
		end
...
function var_0_0.GetSuitEquipNum(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
	...
	for iter_32_0, iter_32_1 in pairs((EquipData:GetEquipList())) do
		...
		if arg_32_3 then
			...
			var_32_2 = HeroData:GetEquipMap()[iter_32_1.equip_id]
		end

		if not var_32_2 and (arg_32_2 == 0 or arg_32_2 == nil or var_32_1.pos == arg_32_2) and (not arg_32_1 or not table.keyof(arg_32_1, iter_32_1.equip_id)) and var_32_1.suit == arg_32_0 then
			var_32_0 = var_32_0 + 1
		end
	end
...
function var_0_0.GetEquipSkillNum(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	for iter_33_0, iter_33_1 in pairs((EquipData:GetEquipList())) do
		...
		if arg_33_3 then
			...
			var_33_2 = HeroData:GetEquipMap()[iter_33_1.equip_id]
		end

		local var_33_3 = false

		if not var_33_2 and (arg_33_2 == 0 or arg_33_2 == nil or var_33_1.pos == arg_33_2) and (not arg_33_1 or not table.keyof(arg_33_1, iter_33_1.equip_id)) then
