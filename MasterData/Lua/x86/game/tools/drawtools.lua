...
function var_0_0.GetRechargeDrawGiftList(arg_1_0)
	if not DrawPoolCfg[arg_1_0] or DrawPoolCfg[arg_1_0].recharge_shop_list == "" then
		return {}
	else
		local var_1_0 = {}

		for iter_1_0, iter_1_1 in pairs(DrawPoolCfg[arg_1_0].recharge_shop_list) do
			if ShopCfg[iter_1_1] and ShopTools.IsGoodCanDisplay(ShopCfg[iter_1_1].shop_id, iter_1_1) then
...
function var_0_0.GetGoodStatus(arg_3_0)
	...
	if (var_3_2 ~= nil and var_3_1.limit_num ~= nil and var_3_1.limit_num ~= -1 and var_3_1.limit_num - var_3_2.buy_times <= 0 or nil) and true then
		return 2
	end
...
function var_0_0.GetCostTicketList(arg_5_0)
	...
	if not table.keyof(var_5_0, var_5_1[#var_5_1]) then
		table.insert(var_5_0, var_5_1[#var_5_1])
	end
...
function var_0_0.GetActivityPoolIdByTicketId(arg_7_0)
	for iter_7_0, iter_7_1 in pairs(DrawPoolCfg) do
		if DrawPoolCfg[iter_7_0].cost_once_activity_material and DrawPoolCfg[iter_7_0].cost_once_activity_material[1] == arg_7_0 then
			return iter_7_0
		end
	end
...
function var_0_0:LoadDrawLevel()
	...
	self.operation_ = Asset.LoadLevelAsync("Levels/X102", true)
...
function var_0_0:UnLoadDrawLevel()
	if self.operation_ then
		return
	end
	...
	if var_10_0 and var_10_0.isLoaded == true then
		self.exoperation_ = SceneManager.UnloadSceneAsync("X102")
...
local function var_0_2(arg_13_0)
	...
	if DrawPoolCfg[arg_13_0].pool_type == 3 then
...
function var_0_0.GetNowAllPool(arg_14_0)
	...
	for iter_14_0, iter_14_1 in ipairs(ActivityCfg.get_id_list_by_activity_template[ActivityTemplateConst.DRAW] or {}) do
		if ActivityData:GetActivityIsOpen(iter_14_1) then
			if ActivityDrawPoolCfg[iter_14_1] then
				for iter_14_2, iter_14_3 in ipairs(ActivityDrawPoolCfg[iter_14_1].config_list) do
...
function var_0_0.GetNowAllRolePool(arg_15_0)
	...
	for iter_15_0, iter_15_1 in ipairs((DrawData:GetPoolList())) do
...
function var_0_0.GetNowAllServantPool(arg_16_0)
	...
	for iter_16_0, iter_16_1 in ipairs((var_0_0:GetNowAllPool())) do
...
function var_0_0.GetRoleUpPoolID(arg_17_0, arg_17_1)
	for iter_17_0, iter_17_1 in ipairs((var_0_0:GetNowAllPool())) do
...
function var_0_0:GoToSelectUpHeroView(arg_18_1, arg_18_2, arg_18_3)
	if DrawPoolCfg[arg_18_1].is_grid_select == 1 then
		gameContext:Go("/drawAllHeroSelect", {
			poolId = arg_18_1,
			heroIdList = DrawPoolCfg[arg_18_1].optional_detail,
			isFirst = arg_18_3
		})
	...
	if DrawPoolCfg[arg_18_1].pool_selected_type == 2 then
		if DrawPoolCfg[arg_18_1].pool_type == 1 then
	...
	elseif DrawPoolCfg[arg_18_1].pool_selected_type == 8 then
		gameContext:Go("/newbieDrawHeroSelect", {
			poolId = arg_18_1,
			heroIdList = DrawPoolCfg[arg_18_1].optional_detail
		})
	elseif DrawPoolCfg[arg_18_1].pool_selected_type == 9 and arg_18_1 == DrawConst.WEAPON_SERVANT_POOL_ID then
	...
	elseif DrawPoolCfg[arg_18_1].pool_selected_type == 1 then
		if table.indexof(DrawPoolCfg[arg_18_1].optional_lists_poolId, self.showId) == false then
			return
		end
...
function var_0_0.HasDrawBonusPoolID(arg_22_0, arg_22_1)
	for iter_22_0, iter_22_1 in ipairs(arg_22_0) do
		if table.keyof(ActivityDrawBonusCfg[iter_22_1].draw_pool_id, arg_22_1) then
			return iter_22_1
		end
	end
...
function var_0_0.HasDrawPiecePoolID(arg_23_0, arg_23_1)
	for iter_23_0, iter_23_1 in ipairs(arg_23_0) do
		if table.keyof(ActivityDrawPieceCfg[iter_23_1].draw_pool_id, arg_23_1) then
			return iter_23_1
		end
	end
...
function var_0_0.GetBonusCnt(arg_24_0)
	return math.floor(DrawData:GetPoolBonus(arg_24_0) / ActivityDrawBonusCfg[arg_24_0].need) * ActivityDrawBonusCfg[arg_24_0].reward[1][2]
end
