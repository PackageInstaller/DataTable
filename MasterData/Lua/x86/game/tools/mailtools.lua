local var_0_0 = {
	Sort = function(arg_1_0)
		...
		return var_1_0, #var_1_2, var_1_2[1] or 0, var_1_2[#var_1_2] or 0
	end
}
...
function var_0_0.SortBySelectId(arg_5_0, arg_5_1)
	...
	if arg_5_1 ~= 0 and var_0_0.lastSort then
		local var_5_2 = table.keyof(var_5_0, arg_5_1)

		if var_5_2 and table.keyof(var_0_0.lastSort, arg_5_1) ~= var_5_2 then
...
function var_0_0.GetLostTimeStr(arg_8_0)
	local var_8_0 = TimeMgr.GetInstance()
	local var_8_1 = arg_8_0 - var_8_0:GetServerTime()
	local var_8_2 = math.fmod(math.floor(var_8_1 / 3600), 24)
	local var_8_3 = math.fmod(math.floor(var_8_1 / 60), 60)
	local var_8_4 = math.fmod(var_8_1, 60)

	if var_8_0 > 0 then
		return string.format(GetTips("EXPIRED_DAY"), math.floor(var_8_1 / 86400) + 1)
