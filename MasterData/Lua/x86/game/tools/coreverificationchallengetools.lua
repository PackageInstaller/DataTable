...
function var_0_0.UpdateActivityCache()
	...
	for iter_2_0, iter_2_1 in ipairs(var_0_0.GetAllActivityIds()) do
		if ActivityData:GetActivityIsOpen(iter_2_1) then
			var_0_0.templateCache_[ActivityTools.GetActivityType(iter_2_1)] = {
				activityId = iter_2_1,
				rankActivityId = ActivityCfg[iter_2_1].sub_activity_list[1],
	...
	for iter_2_2, iter_2_3 in ipairs((var_0_0.GetAllCoreVerificationChallengeMode())) do
		if not var_0_0.templateCache_[iter_2_3] then
			for iter_2_4, iter_2_5 in ipairs(ActivityCfg.get_id_list_by_activity_template[iter_2_3]) do
				if ActivityData:GetActivityIsOpen(iter_2_5) then
					...
					var_0_0.selectedActivityId_ = var_0_0.selectedActivityId_ or iter_2_5
				end
			end
		end
	end
	...
	for iter_2_10, iter_2_11 in pairs(var_0_0.templateCache_) do
		table.insert(var_2_0, string.format("%s_%s", RedPointConst.CORE_VERIFICATION_REWARD5, iter_2_11.activityId))
	end

	manager.redPoint:addGroup(RedPointConst.CORE_VERIFICATION_REWARD5, var_2_0, true)
end
	...
	if not var_0_0.selectedActivityId_ then
		...
		if var_10_2 > 0 and var_10_2 <= var_10_1 and var_10_3 and ActivityData:GetActivityIsOpen(var_10_3) and table.indexof(var_0_0.GetAllActivityIds(), var_10_3) then
			...
			for iter_10_0, iter_10_1 in ipairs(var_10_0) do
				...
				for iter_10_2, iter_10_3 in ipairs((var_0_0.GetTaskInfoByType(iter_10_1, 1))) do
		...
		var_0_0.selectedActivityId_ = var_0_0.selectedActivityId_ or var_10_0[1]
	end
...
function var_0_0.GetModeIndex(arg_15_0)
	...
	for iter_15_0, iter_15_1 in ipairs((var_0_0.GetAllCoreVerificationChallengeMode())) do
...
function var_0_0.GetBattleClCfg(arg_20_0)
	local var_20_0 = ActivityTools.GetActivityType(arg_20_0 or var_0_0.GetActivityId())

	if var_20_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE1 then
		return BattleCoreVerificationClCfg
	elseif var_20_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE2 then
		return BattleCoreVerificationCl2Cfg
	elseif var_20_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE3 then
		return BattleCoreVerificationCl3Cfg
	elseif var_20_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE4 then
		return BattleCoreVerificationCl4Cfg
	end
end

function var_0_0.GetChallengeStage(arg_23_0)
	local var_23_0 = var_0_0.GetDataCls(arg_23_0 or var_0_0.GetActivityId())

	if var_23_0 then
		return var_23_0:GetChallengeStage()
	end
end

function var_0_0.GetChallengeStageCfg(arg_24_0)
	local var_24_0 = var_0_0.GetDataCls(arg_24_0 or var_0_0.GetActivityId())

	if var_24_0 then
		return var_24_0:GetChallengeStageCfg()
	end
end

function var_0_0.GetChallengeStageCfgByIndex(arg_25_0)
	local var_25_0 = ActivityTools.GetActivityType(CoreVerificationClBadgeCfg[CoreVerificationClBadgeCfg.get_id_list_by_set_id_sort[arg_25_0][1]].activity_id)

	if var_25_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE1 then
		return CoreVerificationClMode1Cfg
	elseif var_25_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE2 then
		return CoreVerificationClMode2Cfg
	elseif var_25_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE3 then
		return CoreVerificationClMode3Cfg
	elseif var_25_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE4 then
...
function var_0_0.GetModeCfg(arg_28_0)
	local var_28_0 = ActivityTools.GetActivityType(arg_28_0 or var_0_0.GetActivityId())

	if var_28_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE1 then
		return CoreVerificationClMode1Cfg
	elseif var_28_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE2 then
		return CoreVerificationClMode2Cfg
	elseif var_28_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE3 then
		return CoreVerificationClMode3Cfg
	elseif var_28_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE4 then
		return CoreVerificationClMode4Cfg
	end
end

function var_0_0.GetModeCfgBySetId(arg_29_0)
	local var_29_0 = ActivityTools.GetActivityType(CoreVerificationClBadgeCfg[CoreVerificationClBadgeCfg.get_id_list_by_set_id[arg_29_0][1]].activity_id)

	if var_29_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE1 then
		return CoreVerificationClMode1Cfg
	elseif var_29_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE2 then
		return CoreVerificationClMode2Cfg
	elseif var_29_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE3 then
		return CoreVerificationClMode3Cfg
	elseif var_29_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE4 then
		return CoreVerificationClMode4Cfg
	end
end
...
function var_0_0.GetCommonStage()
	local var_31_0 = var_0_0.GetDataCls((var_0_0.GetActivityId()))

	if var_31_0 then
		return var_31_0:GetCommonStage()
	end
end

function var_0_0.PushStageLockedHero(arg_32_0, arg_32_1)
	local var_32_0 = var_0_0.GetDataCls((var_0_0.GetActivityId()))

	if var_32_0 then
		return var_32_0:PushStageLockedHero(arg_32_0, arg_32_1)
	end
end
...
function var_0_0.GetActivityFirstRankId(arg_35_0, arg_35_1)
	...
	return ActivityCfg[ActivityCfg[arg_35_1].sub_activity_list[1]].sub_activity_list[1] or 0
end

function var_0_0.GetTaskInfoById(arg_36_0, arg_36_1)
	local var_36_0 = var_0_0.GetDataCls(arg_36_0 or var_0_0.GetActivityId())

	if var_36_0 then
		return var_36_0:GetTaskInfoById(arg_36_1)
	end
end

function var_0_0.GetTaskStateById(arg_37_0, arg_37_1)
	local var_37_0 = var_0_0.GetDataCls(arg_37_1 or var_0_0.GetActivityId())

	if var_37_0 then
		return var_37_0:GetTaskState(arg_37_0)
	end
end
...
function var_0_0.GetTaskInfoByType(arg_40_0, arg_40_1)
	local var_40_0 = var_0_0.GetDataCls(arg_40_0 or var_0_0.GetActivityId())

	if var_40_0 then
		return var_0_3(var_40_0, arg_40_1)
	end
end

function var_0_0.ResetSelectAffix(arg_41_0)
	local var_41_0 = ActivityTools.GetActivityType((var_0_0.GetActivityId()))

	if var_41_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE1 then
		CoreVerificationChallengeData:ResetSelectAffix()
	elseif var_41_0 == ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE2 then
		CoreVerificationChallengeMode2Data:ResetSelectAffix()
	end
end

function var_0_0.CheckCycleReward()
	local var_42_0 = var_0_0.GetDataCls((var_0_0.GetActivityId()))

	if var_42_0 then
		return var_42_0:IsGetAllTaskReward()
	end
end
...
function var_0_0.GetBadgeCount()
	...
	for iter_45_0, iter_45_1 in pairs(CoreVerificationClBadgeCfg.get_id_list_by_set_id) do
		local var_45_1 = manager.time:GetServerTime()

		if ActivityData:GetActivityData(CoreVerificationClBadgeCfg[CoreVerificationClBadgeCfg.get_id_list_by_set_id[iter_45_0][1]].activity_id).startTime <= manager.time:GetServerTime() then
...
function var_0_0:CheckCanStartBattle()
	if var_0_0.GetModeIndex() == 4 then
		local var_49_0 = {}
		local var_49_1 = nullable(CoreVerificationChallengeMode4Data:GetStageDataByStageID(self.stageID), "teams", self.teamIndex, "heroList") or {}
		local var_49_2 = ReserveTools.GetHeroList(self)
