...
local function var_0_2()
	...
	for iter_1_0, iter_1_1 in ipairs(ComboSkillCfg.all) do
		if not var_0_0.GetIsHide(iter_1_1) then
			for iter_1_2, iter_1_3 in ipairs(ComboSkillCfg[iter_1_1].cooperate_role_ids) do
				var_1_0[iter_1_3] = var_1_0[iter_1_3] or {}

				table.insert(var_1_0[iter_1_3], ComboSkillCfg[iter_1_1].id)
			end
		end
	end
...
function var_0_0.GetIsHide(arg_3_0)
	for iter_3_0, iter_3_1 in ipairs(ComboSkillCfg[arg_3_0].cooperate_role_ids) do
...
function var_0_0.IsAllMatch(arg_6_0, arg_6_1)
	local var_6_0, var_6_1 = var_0_3(arg_6_1, ComboSkillCfg[arg_6_0].cooperate_role_ids)
...
function var_0_0.GroupByMatchFromHeroListComboSkills(arg_8_0)
	...
	for iter_8_0, iter_8_1 in ipairs(ComboSkillCfg.all) do
		local var_8_2, var_8_3, var_8_4 = var_0_3(arg_8_0, ComboSkillCfg[iter_8_1].cooperate_role_ids)

		if var_8_2 then
			var_8_0[iter_8_1] = true
		elseif var_8_3 and not var_0_4(var_8_4) then
...
function var_0_0.GetComboSkillLevel(arg_9_0)
	...
	for iter_9_0, iter_9_1 in ipairs(ComboSkillCfg[arg_9_0].cooperate_role_ids) do
		if HeroData:GetHeroList()[iter_9_1].unlock == 0 then
			break
		end

		var_9_0 = var_9_0 + HeroTools.GetTotalSkillLv(iter_9_1, HeroCfg[iter_9_1].skills[GameSetting.hero_combo_skill_relate.value[1]])
	end

	local var_9_1 = math.floor(var_9_0 / #ComboSkillCfg[arg_9_0].cooperate_role_ids)

	return var_9_1 > 0 and var_9_1 or 1
end

function var_0_0.GetMatrixComboSkillLevel(arg_10_0, arg_10_1)
	local var_10_1 = 0

	for iter_10_0, iter_10_1 in ipairs(ComboSkillCfg[arg_10_0].cooperate_role_ids) do
		var_10_1 = var_10_1 + HeroStandardSystemCfg[MatrixData:GetHeroData(iter_10_1):GetStandardId()].skill_lv
	end

	local var_10_2 = math.floor(var_10_1 / #ComboSkillCfg[arg_10_0].cooperate_role_ids)

	return var_10_2 > 0 and var_10_2 or 1
end
...
function var_0_0.GetComboSkillList(arg_11_0, arg_11_1)
	...
	table.sort(var_11_3, function(arg_12_0, arg_12_1)
		...
		if #ComboSkillCfg[arg_12_0].cooperate_role_ids == #ComboSkillCfg[arg_12_1].cooperate_role_ids then
...
function var_0_0.CheckComboSkillUpContion(arg_17_0, arg_17_1)
	local var_17_0 = ComboSkillLevelCfg[arg_17_0].target

	if ComboSkillLevelCfg[arg_17_0].condition_type == 1 then
		local var_17_1

		for iter_17_0, iter_17_1 in ipairs(ComboSkillCfg[arg_17_1].cooperate_role_ids) do
			local var_17_2 = HeroTools.GetTotalSkillLv(iter_17_1, HeroCfg[iter_17_1].skills[GameSetting.hero_combo_skill_relate.value[1]])

			if var_17_1 == nil or var_17_2 < var_17_1 then
				var_17_1 = var_17_2
			end
		end

		return var_17_0 <= var_17_1, math.min(var_17_1, var_17_0), var_17_0
	else
		local var_17_3 = ComboSkillData:GetComboSkillUpConditionProcess(arg_17_1, arg_17_0)

		return var_17_0 <= var_17_3, math.min(var_17_3, var_17_0), var_17_0
	end
end
