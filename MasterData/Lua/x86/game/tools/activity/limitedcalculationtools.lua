return {
	...
	GetBuffList = function(arg_4_0)
		...
		for iter_4_0, iter_4_1 in ipairs((LimitedCalculationData:GetDifficultyList(arg_4_0))) do
	...
	GetDebuffList = function(arg_5_0)
		...
		for iter_5_0, iter_5_1 in ipairs((LimitedCalculationData:GetDifficultyList(arg_5_0))) do
