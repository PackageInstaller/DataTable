local var_0_0 = {
	GetRewardPanelList = function(arg_1_0)
		...
		for iter_1_0, iter_1_1 in ipairs(DestroyBoxGameRewardCfg.get_id_list_by_main_activity_id[arg_1_0]) do
			if not var_1_0[DestroyBoxGameRewardCfg[iter_1_1].activity_id] and DestroyBoxGameRewardCfg[iter_1_1].need_show == 1 then
				var_1_0[DestroyBoxGameRewardCfg[iter_1_1].activity_id] = clone(DestroyBoxGameRewardCfg.get_id_list_by_activity_id[DestroyBoxGameRewardCfg[iter_1_1].activity_id])
			end
		end
...
function var_0_0.IsUnlockReward(arg_7_0)
	...
	for iter_7_0, iter_7_1 in ipairs(DestroyBoxGameRewardCfg[arg_7_0].difficulty_id) do
		local var_7_2 = DestroyBoxGameData:GetStageData(var_7_0.need_show ~= 1 and DestroyBoxGameCfg.get_id_list_by_activity_id[DestroyBoxGameRewardCfg[arg_7_0].activity_id][1] or DestroyBoxGameCfg.get_id_list_by_activity_id[DestroyBoxGameRewardCfg[arg_7_0].activity_id][iter_7_1])

		if var_7_2 and var_7_2.maxScore >= var_7_0.complete_num then
			return true
		end
	end
