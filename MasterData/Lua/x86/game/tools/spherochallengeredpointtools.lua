return {
	UpdataLogInRedPoint = function(self)
		for iter_1_0, iter_1_1 in ipairs((SPHeroChallengeTools:GetOpenActivityID())) do
			self:UpdataCanGetEntrustRewardRedPoint(iter_1_1)
			self:UpdataCanGetChallengeRewardRedPoint(iter_1_1)
		end
	end,
	UpdataCanGetEntrustRewardRedPoint = function(arg_2_0, arg_2_1)
		if SPHeroChallengeTools:CheckActivityIsOpen(arg_2_1) then
			...
			if var_2_0 then
				if next((var_2_0:GetCanGetRewardEntrustIndexList())) then
