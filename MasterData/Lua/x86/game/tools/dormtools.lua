local var_0_0 = {
	GetDormAdditionByHeroID = function(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
		...
		if not arg_1_2 and not table.indexof(DormHeroTools:GetCanUseHeroInDorm(), var_1_1) then
			return var_1_0
		end

		local var_1_2 = DormHeroTools:GetTemplateIDInDorm(var_1_1)

		for iter_1_0 = 1, (not arg_1_3 or nil) and (arg_1_2 or DormHeroTools:GetDormLevelByHeroID(var_1_2)) do
			for iter_1_1, iter_1_2 in ipairs(BackHomeHeroCfg[var_1_2].level_reward[iter_1_0]) do
				if BackHomeDormLevelRewardCfg[iter_1_2].type == 1 then
					var_1_0.attribute[BackHomeDormLevelRewardCfg[iter_1_2].reward[1]] = var_1_0.attribute[BackHomeDormLevelRewardCfg[iter_1_2].reward[1]] or 0
					var_1_0.attribute[BackHomeDormLevelRewardCfg[iter_1_2].reward[1]] = var_1_0.attribute[BackHomeDormLevelRewardCfg[iter_1_2].reward[1]] + BackHomeDormLevelRewardCfg[iter_1_2].reward[2]
				elseif BackHomeDormLevelRewardCfg[iter_1_2].type == 2 then
					table.insert(var_1_0.voice, BackHomeDormLevelRewardCfg[iter_1_2].reward[1])
				end
			end
		end
	...
	SecondSwitchTime = function(arg_2_0, arg_2_1)
		...
		return string.format("%d%s%02d%s", math.modf(var_2_0 / 60), GetTips("HOUR"), var_2_0 % 60, (GetTips("MINUTE")))
	end,
	...
	AnyShopInDiscount = function(self)
		return ShopTools.IsAnyShopDiscount(self:GetAllDormShopIDList())
	end,
	...
	GetFurLableDesc = function(self, arg_10_1, arg_10_2)
		local var_10_0 = ""

		if arg_10_2 == "is_give" then
			var_10_0 = BackHomeFurniture[arg_10_1].is_give == 1 and string.format(GetTips("DORM_FUR_INFO_TAG2"), BackHomeFurniture[arg_10_1].give_max) or GetTips("DORM_FUR_INFO_TAG1")
		...
		elseif arg_10_2 == "hero_id" then
			if HeroRecordCfg[BackHomeFurniture[arg_10_1].hero_id] then
				var_10_0 = string.format(GetTips("DORM_FUR_INFO_TAG3"), HeroRecordCfg[BackHomeFurniture[arg_10_1].hero_id].name)
			end
		elseif arg_10_2 == "scene_id" then
			var_10_0 = GetTips("DORM_FUR_INFO_TAG4")

			for iter_10_0, iter_10_1 in ipairs(BackHomeFurniture[arg_10_1].scene_id) do
				var_10_0 = var_10_0 .. self:GetRoomTypeName(iter_10_1) .. " "
			end
	...
	GetFurGiftTypeDesc = function(arg_11_0, arg_11_1)
		...
		elseif BackHomeFurniture[arg_11_1].is_give == 3 then
			if HeroRecordCfg[BackHomeFurniture[arg_11_1].hero_id] then
				var_11_0 = string.format(GetTips("DORM_FUR_INFO_TAG3"), GetI18NText(HeroRecordCfg[BackHomeFurniture[arg_11_1].hero_id].name))
			end
		end

		return var_11_0
	end,
	GetFurPlaceSceneDesc = function(self, arg_12_1)
		local var_12_1 = GetTips("DORM_FUR_INFO_TAG4")

		for iter_12_0, iter_12_1 in ipairs(BackHomeFurniture[arg_12_1].scene_id) do
			var_12_1 = var_12_1 .. self:GetRoomTypeName(iter_12_1) .. " "
		end

		string.sub(var_12_1, 1, -2)
	...
	if arg_17_2 == true then
		if var_0_1[arg_17_1] then
			SDKTools.SendMessageToSDK("backhome_dorm_opt", {
				...
				opt_time = manager.time:GetServerTime() - var_0_1[arg_17_1]
			})
		...
		elseif var_23_0[tostring(arg_24_0)] then
			...
			if arg_24_3 > arg_23_2 then
				...
				for iter_24_0, iter_24_1 in pairs(arg_24_0) do
					var_24_1[#var_24_1 + 1] = iter_24_0

					local var_24_4 = string.len((dump_value_(iter_24_0)))

					if var_24_2 < var_24_4 then
						var_24_2 = var_24_4
					end

					var_24_3[iter_24_0] = iter_24_1
				end
				...
				for iter_24_2, iter_24_3 in ipairs(var_24_1) do
					var_23_3(var_24_3[iter_24_3], iter_24_3, arg_24_2 .. "    ", arg_24_3 + 1, var_24_2)
				end
