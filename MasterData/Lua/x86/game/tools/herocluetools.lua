return {
	...
	GetActivityDesc = function(arg_7_0)
		...
		elseif var_7_0 == ActivityConst.THEME.ACTIVITY_4_3 then
			return ActivityToggleCfg[ActivityToggleCfg.get_id_list_by_activity_id[arg_7_0][1]].desc
	...
	GetActivityTitle = function(arg_8_0)
		if ActivityToggleCfg.get_id_list_by_activity_id[arg_8_0] then
			return ActivityToggleCfg[ActivityToggleCfg.get_id_list_by_activity_id[arg_8_0][1]].name
		end
	end,
