...
function wordSplit(arg_1_0)
	...
	for iter_1_0 in arg_1_0:gmatch("[\x01-\x7F\xC2-\xF4][\x80-\xBF]*") do
...
function WordVerifyBySDK(arg_3_0, arg_3_1, arg_3_2)
	...
	if not OperationData:IsOperationOpen(OperationConst.MANUAL_WORD_VERIFY) then
		var_3_0 = wordVerify((string.gsub(arg_3_0, " ", "")))
	end

	local var_3_1 = string.match(arg_3_0, "<.+>.*</.+>") ~= nil
	...
	if GameToSDK.CURRENT_SDK_ID == SDK_PLATFORM.DEV then
		...
		if var_3_2 then
			var_3_3 = ChatConst.VERIFY_STATUS.PASS or ChatConst.VERIFY_STATUS.LOCAL_NO_PASS
		end

		SendJudgeResult(arg_3_2, arg_3_0, var_3_3, "")
		arg_3_1(var_3_2, var_3_3)
	...
	if not var_3_2 then
		...
		arg_3_1(var_3_2, ChatConst.VERIFY_STATUS.LOCAL_NO_PASS)
	...
	while var_6_0 <= #arg_6_0 do
		...
		if var_6_1 >= 48 and var_6_1 <= 57 or var_6_1 >= 65 and var_6_1 <= 90 or var_6_1 >= 97 and var_6_1 <= 122 then
			...
			if #arg_6_0 - var_6_0 <= 1 then
				...
				var_6_2 = string.byte(arg_6_0, var_6_0 + 2)
			end

			local var_6_3 = var_6_2 + string.byte(arg_6_0, var_6_0 + 1) * 256 + var_6_1 * 65536

			if var_6_3 < 14989440 or 15318693 < var_6_3 then
				return false
			else
				var_6_0 = var_6_0 + 3
			end
...
function textLimit(arg_7_0, arg_7_1)
	...
	while 1 <= #arg_7_0 do
		...
		for iter_7_0 = 0, getByteLength(string.byte(arg_7_0, 1)) - 1 do
			var_7_3 = var_7_3 * 256 + string.byte(arg_7_0, 1 + iter_7_0)
		end

		local var_7_4 = isNumOrEn(var_7_3) and 1 or isChinese(var_7_3) and 2 or isJanpanese(var_7_3) and 2 or isKorean(var_7_3) and 2 or isSymbolForTwoWord(var_7_3) and 2 or isSymbolForOneWord(var_7_3) and 1 or 1

		if arg_7_1 < var_7_0 + var_7_4 then
			return string.sub(arg_7_0, 1, 1 - 1), false
		end
...
function isChinese(arg_12_0)
	return 14989440 <= arg_12_0 and arg_12_0 <= 15318693
end
...
function isJanpanese(arg_14_0)
	return 14909825 <= arg_14_0 and arg_14_0 <= 14910399 or 14911408 <= arg_14_0 and arg_14_0 <= 14911423
end

function isKorean(arg_15_0)
	return 15380608 <= arg_15_0 and arg_15_0 <= 15572655 or 14779520 <= arg_15_0 and arg_15_0 <= 14780303 or 14910640 <= arg_15_0 and arg_15_0 <= 14911119
end

function isSymbol(arg_16_0)
	return 14909568 <= arg_16_0 and arg_16_0 <= 14909631 or 15711360 <= arg_16_0 and arg_16_0 <= 15712175 or 14844032 <= arg_16_0 and arg_16_0 <= 14844335 or 32 <= arg_16_0 and arg_16_0 <= 127 or 49824 <= arg_16_0 and arg_16_0 <= 50111 or arg_16_0 >= 48 and arg_16_0 <= 57 or arg_16_0 >= 65 and arg_16_0 <= 90 or arg_16_0 >= 97 and arg_16_0 <= 122
end

function isSymbolForOneWord(arg_17_0)
	return 32 <= arg_17_0 and arg_17_0 <= 127 or 49824 <= arg_17_0 and arg_17_0 <= 50111 or arg_17_0 >= 48 and arg_17_0 <= 57 or arg_17_0 >= 65 and arg_17_0 <= 90 or arg_17_0 >= 97 and arg_17_0 <= 122
end

function isSymbolForTwoWord(arg_18_0)
	return 14909568 <= arg_18_0 and arg_18_0 <= 14909631 or 15711360 <= arg_18_0 and arg_18_0 <= 15712175 or 14844032 <= arg_18_0 and arg_18_0 <= 14844335 or arg_18_0 >= 48 and arg_18_0 <= 57 or arg_18_0 >= 65 and arg_18_0 <= 90 or arg_18_0 >= 97 and arg_18_0 <= 122
end
...
function nameRule(arg_19_0, arg_19_1)
	if AreaDifferenceCfg[GameToSDK.CURRENT_SERVER] then
		...
		while var_19_0 <= #arg_19_0 do
			local var_19_1 = getByteLength(string.byte(arg_19_0, var_19_0))
			local var_19_2 = 0

			for iter_19_0 = 0, var_19_1 - 1 do
				var_19_2 = var_19_2 * 256 + string.byte(arg_19_0, var_19_0 + iter_19_0)
			end

			local var_19_3 = false

			if isChinese(var_19_2) then
				var_19_3 = table.indexof(AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].language_sent, 0) ~= false
			elseif isJanpanese(var_19_2) then
				var_19_3 = table.indexof(AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].language_sent, 1) ~= false
			elseif isEnglish(var_19_2) then
				var_19_3 = table.indexof(AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].language_sent, 2) ~= false
			elseif isKorean(var_19_2) then
				var_19_3 = table.indexof(AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].language_sent, 3) ~= false
			elseif var_19_2 >= 48 and var_19_2 <= 57 then
				var_19_3 = true
			elseif arg_19_1 then
				var_19_3 = isSymbol(var_19_2)
			end
		...
		print("未定义命名规则 area = ", GameToSDK.CURRENT_SERVER)
...
function wordVerify(arg_21_0, arg_21_1)
	...
	while var_21_3 <= #var_21_1 do
		local var_21_6, var_21_7, var_21_8 = wordVerMatch(var_21_1, var_21_2, arg_21_1, var_21_3, "", false, var_21_3, "")
		...
		if var_21_6 then
			...
			if arg_21_1.isReplace then
				var_21_4 = var_21_4 .. var_21_8
			end
		else
			if arg_21_1.isReplace then
				var_21_4 = var_21_4 .. var_21_1[var_21_3]
			end
...
function shortenString(arg_22_0, arg_22_1)
	...
	while var_22_0 < #arg_22_0 do
		local var_22_3 = string.byte(arg_22_0, var_22_0 + 1)
		local var_22_4 = 1

		if var_22_3 < 128 then
			var_22_0 = var_22_0 + 1
		elseif var_22_3 >= 192 and var_22_3 < 224 then
			var_22_0 = var_22_0 + 2
		elseif var_22_3 >= 224 and var_22_3 < 240 then
			var_22_0 = var_22_0 + 3
		elseif var_22_3 >= 240 and var_22_3 < 248 then
			var_22_0 = var_22_0 + 4
		elseif var_22_3 >= 248 and var_22_3 < 252 then
			var_22_0 = var_22_0 + 5
		elseif var_22_3 >= 252 and var_22_3 < 254 then
			var_22_0 = var_22_0 + 6
		else
			error("invalid utf8 string")
		end

		var_22_1 = var_22_1 + var_22_4
	...
	if var_22_2 == 0 or var_22_2 == #arg_22_0 then
		return arg_22_0
	end
...
function strrchr(arg_24_0, arg_24_1)
	local var_24_0, var_24_1 = string.find(string.reverse(arg_24_0), (string.reverse(arg_24_1)))

	if var_24_0 then
		return #arg_24_0 - var_24_1 + 1, #arg_24_0 - var_24_0 + 1
	else
		return 0, 0
	end
end
...
function replaceSensitiveWordAll(arg_28_0, arg_28_1)
	local var_28_0 = replaceSensitiveWord(arg_28_0, arg_28_1)

	while arg_28_0 ~= var_28_0 do
		var_28_0 = replaceSensitiveWord(var_28_0, arg_28_1)
	end
...
function replaceSensitiveWord(arg_29_0, arg_29_1)
	...
	if var_29_1 and var_29_2 then
		...
		for iter_29_0 = 1, getWordCount(arg_29_1) do
			var_29_3 = var_29_3 .. "*"
		end

		var_29_0 = var_29_1 == 1 and var_29_3 .. string.sub(arg_29_0, var_29_2 + 1, -1) or var_29_2 == string.len(arg_29_0) and string.sub(arg_29_0, 1, var_29_1 - 1) .. var_29_3 or string.sub(arg_29_0, 1, var_29_1 - 1) .. var_29_3 .. string.sub(arg_29_0, var_29_2 + 1, -1)
	end
...
function containSymbol(arg_31_0)
	...
	if not var_31_0 then
		for iter_31_0, iter_31_1 in ipairs((wordSplit(arg_31_0))) do
...
function getWordTable(arg_32_0)
	...
	while 1 <= string.len(arg_32_0) do
		table.insert(var_32_1, string.sub(arg_32_0, 1, 1 + var_32_0(string.byte(arg_32_0, 1)) - 1))
	end
...
function utf8sub(arg_37_0, arg_37_1, arg_37_2)
	...
	while arg_37_1 > 1 do
		var_37_0 = var_37_0 + chsize((string.byte(arg_37_0, var_37_0)))
		arg_37_1 = arg_37_1 - 1
	end

	local var_37_1 = var_37_0

	while arg_37_2 > 0 and var_37_1 <= #arg_37_0 do
		var_37_1 = var_37_1 + chsize((string.byte(arg_37_0, var_37_1)))
		arg_37_2 = arg_37_2 - 1
	end

	return arg_37_0:sub(var_37_0, var_37_1 - 1), arg_37_2
end
...
function utf8len(arg_38_0)
	...
	while 1 <= #arg_38_0 do
		local var_38_1 = 1 + chsize((string.byte(arg_38_0, 1)))
