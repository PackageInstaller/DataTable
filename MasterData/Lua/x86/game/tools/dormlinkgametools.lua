...
function var_0_0.GetLostTimeStr(arg_7_0, arg_7_1)
	local var_7_0 = TimeMgr.GetInstance()
	local var_7_1 = ActivityData:GetActivityData(ActivityLinkGameCfg[arg_7_1].activity_id).stopTime - var_7_0:GetServerTime()
	local var_7_2 = math.fmod(math.floor(var_7_1 / 3600), 24)
	local var_7_3 = math.fmod(math.floor(var_7_1 / 60), 60)

	if var_7_0 > 0 then
		return (nil).format(GetTips("ACTIVITY_LINKGAME_TIME_LIMIT"), math.floor(var_7_1 / 86400) + 1)
	elseif var_7_2 > 0 then
		return var_7_2 + 1 .. GetTips("HOUR")
	elseif var_7_3 > 0 then
		return var_7_3 + 1 .. GetTips("MINUTE")
	elseif math.fmod(var_7_1, 60) > 0 then
		return var_7_3 + 1 .. GetTips("MINUTE")
	end
end
