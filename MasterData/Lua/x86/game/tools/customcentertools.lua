...
function var_0_0.GetRandomHeroList()
	...
	for iter_2_0 = #var_2_0, 1, -1 do
		if not var_0_0.IsValidHeroSkin(SkinCfg[var_2_0[iter_2_0]].hero, var_2_0[iter_2_0]) then
			local var_2_1 = var_0_0.GetValidHeroSkin(SkinCfg[var_2_0[iter_2_0]].hero)

			if var_0_0.IsValidHeroSkin(SkinCfg[var_2_0[iter_2_0]].hero, var_2_1) and not table.keyof(var_2_0, var_2_1) then
				var_2_0[iter_2_0] = var_2_1
			else
...
function var_0_0.IsValidHeroSkin(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in ipairs(HeroData:GetHeroData(arg_4_0).unlocked_skin) do
...
function var_0_0.IsContentRandomHeroSkinID(arg_7_0)
	...
	return table.keyof(PlayerData:GetCacheHeroSkinList(), arg_7_0) ~= nil
end
...
function var_0_0.GetHeroUseSkinCnt(arg_11_0)
	...
	if CustomCenterTools.IsRandomHero() then
		for iter_11_0, iter_11_1 in pairs((PlayerData:GetCacheHeroSkinList())) do
		...
		return var_11_0
	elseif SkinCfg[PlayerData:GetPosterGirlHeroSkinId()].hero == arg_11_0 then
		return 1
	else
		return 0
	end
...
function var_0_0.GetSkinSceneCfg(arg_12_0, arg_12_1)
	return nullable(SkinSceneActionCfg, (nullable(SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id, arg_12_0, arg_12_1, 1)))
end

function var_0_0.PickMatchSkinScene(arg_13_0, arg_13_1)
	if SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_13_0] then
		local var_13_0 = {}

		for iter_13_0, iter_13_1 in pairs(SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_13_0]) do
			table.insert(var_13_0, iter_13_0)
		end

		table.sort(var_13_0, arg_13_1)
...
function var_0_0.PickSkinSceneCfg(arg_14_0, arg_14_1)
	return var_0_0.GetSkinSceneCfg(arg_14_0, var_0_0.PickMatchSkinScene(arg_14_0, arg_14_1) or 0)
end
...
function var_0_0.GetSceneList(arg_16_0, arg_16_1)
	...
	var_0_1(var_0_0.IsRandomScene() and HomeSceneSettingData:GetCacheRandomSceneList()[1] or HomeSceneSettingData:GetSceneID(arg_16_0), var_16_3, var_16_0, var_16_1)
...
function var_0_0.HasDLCScene(arg_17_0)
	if SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_17_0] == nil then
		return false
	end

	for iter_17_0, iter_17_1 in ipairs(SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_17_0]) do
		if HomeSceneSettingCfg[iter_17_0].limit_display ~= 1 and HomeSceneSettingData:GetUsedState(iter_17_0) ~= SceneConst.HOME_SCENE_TYPE.LOCK then
			return true
		end
	end
...
function var_0_0.PickSkinMatchedScene(arg_20_0)
	if SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_20_0] then
		local var_20_0 = next(SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_20_0])
...
function var_0_0.PickRndSkinMatchedScene(arg_21_0)
	if SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_21_0] then
		local var_21_0 = var_0_2(SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_21_0], var_0_3)

		if SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_21_0][var_21_0[math.random(#var_21_0)]] ~= 0 then
			return SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_21_0][var_21_0[math.random(#var_21_0)]]
		end
	end
...
function var_0_0.PickFirstAvailableMatchedScene(arg_22_0)
	if SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_22_0] then
		for iter_22_0, iter_22_1 in ipairs((var_0_2(SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_22_0], var_0_3))) do
...
function var_0_0.GetDlcMatchSkinIndex(arg_25_0, arg_25_1)
	if SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_25_1] then
		for iter_25_0, iter_25_1 in ipairs((var_0_2(SkinSceneActionCfg.get_id_list_by_skin_id_special_scene_id[arg_25_1], var_0_3))) do
...
function var_0_0.IsContentRandomSceneID(arg_29_0)
	...
	return table.keyof(HomeSceneSettingData:GetCacheRandomSceneList(), arg_29_0) ~= nil
end
...
function var_0_0.SetUseSelectedScene()
	HomeSceneSettingAction.SetHomeScene(HomeSceneSettingData:GetPreviewScene(), true)
end
...
function var_0_0.GetMatchSkinByScene(arg_36_0)
	return nullable(SkinSceneActionCfg, nullable(SkinSceneActionCfg.get_id_list_by_special_scene_id, arg_36_0, 1), "skin_id")
end
...
local function var_0_6(arg_39_0, arg_39_1)
	local var_39_0 = tonumber((manager.time:STimeDescS(arg_39_0, "!%H")))
	local var_39_1 = {}

	var_0_5(var_39_1, nullable(arg_39_1, 1) or 0, nullable(arg_39_1, 2) or 24)

	for iter_39_0, iter_39_1 in ipairs(var_39_1) do
		if var_39_0 >= iter_39_1[1] and var_39_0 < iter_39_1[2] then
			return true
		end
	end
...
function var_0_0.GetTimeChangeNextScene(arg_40_0, arg_40_1)
	for iter_40_0, iter_40_1 in ipairs(var_0_4) do
		if iter_40_1.from_scene == arg_40_0 then
			if arg_40_1 and var_0_6(arg_40_1, iter_40_1.time) or true then
...
function var_0_0.GetLastPreviewHero()
	...
	for iter_42_0 = #var_42_0, 1, -1 do
		if table.keyof(var_42_1, var_42_0[iter_42_0]) then
			return var_42_0[iter_42_0]
		end
	end
...
function var_0_0.GetLastPreviewScene()
	...
	for iter_43_0 = #var_43_0, 1, -1 do
		if table.keyof(var_43_1, var_43_0[iter_43_0]) then
