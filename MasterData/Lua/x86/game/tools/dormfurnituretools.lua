local var_0_0 = {
	GenerateFurnitureWhenEnterScene = function(arg_1_0)
		...
		DormFurnitureManager.GetInstance():ClearAndGenByFurList(DormitoryData:GetDormFurListByRoomID(var_1_0), false, var_1_1.suitInfo)
	end,
	DestoryRandomPruralFurByID = function(self, arg_2_1, arg_2_2, arg_2_3)
		for iter_2_0, iter_2_1 in ipairs((DormFurnitureManager.GetInstance():GetAllFurniture())) do
	...
	ResolverFurnitureInfo = function(self, arg_5_1, arg_5_2)
		local var_5_0 = {}
		local var_5_1 = {}

		for iter_5_0, iter_5_1 in ipairs(arg_5_1) do
			if iter_5_1.type < 100 then
				self:AddFurnitureInfo(var_5_0, iter_5_1.furniture_pos, DormConst.PROTOCOL_TILE_TYPE[iter_5_1.type])
			end

			if iter_5_1.type == DormConst.PROTOCOL_TILE_TYPE_INDEX.FLOOR then
				var_5_1 = iter_5_1.furniture_pos
			end
		end

		local var_5_2 = {}

		DormSpecialFurnitureTools:AddSpecialFurInfo(var_5_2, DormRoomTools:GetRoomSceneType(arg_5_2), var_5_1, false)
		...
		for iter_5_2, iter_5_3 in ipairs(arg_5_1) do
			if iter_5_3.type < 100 then
				...
				var_5_3[iter_5_3.type] = {}

				local var_5_4 = {}

				DormFurnitureTools:AddFurnitureInfo(var_5_4, iter_5_3.furniture_pos, DormConst.PROTOCOL_TILE_TYPE[5])

				local var_5_5 = RoomInfo.New()

				var_5_5.furnitureInfoS = var_5_4
				var_5_3[iter_5_3.type].furList = var_5_5.furnitureInfoS
				var_5_3[iter_5_3.type].tileType = DormConst.PROTOCOL_TILE_TYPE_INDEX.FLOOR
			end
		end

		return var_5_0, var_5_2.specialFur, var_5_3
	end,
	...
	CheckFurCanUseRoom = function(arg_7_0, arg_7_1, arg_7_2)
		...
		for iter_7_0, iter_7_1 in ipairs(BackHomeFurniture[arg_7_2].scene_id) do
	...
	JudgeFurIsOri = function(arg_8_0, arg_8_1, arg_8_2)
		for iter_8_0, iter_8_1 in ipairs(BackHomeCfg[arg_8_1].default_item) do
	...
	GetCanUseFurListByRoomID = function(arg_9_0, arg_9_1)
		...
		for iter_9_0, iter_9_1 in pairs((DormData:GetFurnitureInfoList())) do
			for iter_9_2, iter_9_3 in ipairs(BackHomeFurniture[iter_9_0].scene_id) do
				if iter_9_3 == BackHomeCfg[arg_9_1].type then
...
function var_0_0.GetRoomCanPlaceFurMaxNum(arg_11_0, arg_11_1, arg_11_2)
	...
	elseif BackHomeCfg[arg_11_1].type == DormConst.BACKHOME_TYPE.PrivateDorm then
		local var_11_2 = DormData:GetHeroInfo(DormitoryData:GetArchiveIDViaRoomID(arg_11_1)[1])
		...
		if DormSpecialFurnitureTools:JudgeFurIsSpecialType(arg_11_2) then
			...
			elseif BackHomeFurniture[arg_11_2].is_give == 1 and var_11_2:GetGiftNum(arg_11_2) > 0 then
				var_11_0 = 1
			end
		elseif BackHomeFurniture[arg_11_2].is_give == 0 or BackHomeFurniture[arg_11_2].is_give == 3 then
			var_11_0 = var_11_1[arg_11_2].num
		elseif BackHomeFurniture[arg_11_2].is_give == 1 then
			var_11_0 = var_11_2:GetGiftNum(arg_11_2)
		end
	end
...
function var_0_0.GetHasPlaceFurNumInfoInMap(arg_12_0, arg_12_1)
	...
	if var_12_2.roomInfo then
		for iter_12_0 = 0, var_12_2.roomInfo.furnitureInfoS.Length - 1 do
			var_12_0 = var_12_0 + 1
			var_12_1[var_12_2.roomInfo.furnitureInfoS[iter_12_0].id] = var_12_1[var_12_2.roomInfo.furnitureInfoS[iter_12_0].id] or 0
			var_12_1[var_12_2.roomInfo.furnitureInfoS[iter_12_0].id] = var_12_1[var_12_2.roomInfo.furnitureInfoS[iter_12_0].id] + 1
		end
	end

	if var_12_2.suitInfo then
		for iter_12_1, iter_12_2 in pairs(var_12_2.suitInfo) do
			var_12_0 = iter_12_1 < DormConst.DORM_VISIT_ROOM_MIN and var_12_0 + iter_12_2.furList.Length or var_12_0 + DormSuitData:GetSuitNeedTotalFurNumList(iter_12_1)
		end
	end
...
function var_0_0.CheckFurCanGiftInRoom(arg_13_0, arg_13_1, arg_13_2)
	for iter_13_0, iter_13_1 in ipairs((DormitoryData:GetArchiveIDViaRoomID(arg_13_1))) do
		...
		for iter_15_0, iter_15_1 in ipairs(var_15_1) do
			if BackHomeFurniture[iter_15_1].is_give == DormConst.BACKHOME_FUR_GIVE_TYPE.GIFT then
				...
				elseif BackHomeCfg[arg_15_1].type == DormConst.BACKHOME_TYPE.PrivateDorm then
					if var_15_2.num - var_15_2.give_num > 0 and DormData:GetHeroInfo(DormitoryData:GetArchiveIDViaRoomID(arg_15_1)[1]):GetGiftNum(iter_15_1) < BackHomeFurniture[iter_15_1].give_max then
						table.insert(var_15_0, iter_15_1)
					end
				end
			end
...
function var_0_0.GetIsOverLoad(arg_16_0, arg_16_1)
	...
	if BackHomeCfg[arg_16_1].type == DormConst.BACKHOME_TYPE.PublicDorm then
		var_16_0 = GameSetting.dorm_lobby_furniture_limited.value[1]
	elseif BackHomeCfg[arg_16_1].type == DormConst.BACKHOME_TYPE.PrivateDorm then
		var_16_0 = BackHomeDormLevel[DormitoryData:GetDormLevel(arg_16_1)].furniture_max
	end

	if var_16_0 - DormRoomTools:GetFurHasPlaceTotalNum(arg_16_1) - DormFurEditStateData:GetCacheFurTotalNum() - DormConst.DORM_SPECIAL_FURNITURE_NUM > 0 then
		return true
	end
...
function var_0_0.CheckFurTileType(arg_22_0, arg_22_1, arg_22_2)
	if BackHomeFurniture[arg_22_1] then
		if BackHomeFurniture[arg_22_1].display_type == 0 and arg_22_2 == DormConst.TILE_TYPE.FLOOR then
			return true
		end

		if BackHomeFurniture[arg_22_1].display_type == 2 and (arg_22_2 == DormConst.TILE_TYPE.WALL_LEFT or arg_22_2 == DormConst.TILE_TYPE.WALL_RIGHT or arg_22_2 == DormConst.TILE_TYPE.WALL_BEHIND or arg_22_2 == DormConst.TILE_TYPE.WALL_FRONT) then
			return true
		end
