local var_0_0 = {}
local ShopConst = import("game.const.ShopConst")
...
function var_0_0.FilterShopDataList(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in pairs(ShopData.GetShop(arg_3_0).shopItemIDs) do
		if var_0_0.IsGoodCanDisplay(arg_3_0, iter_3_1, arg_3_1) then
			local var_3_1 = ShopData.GetShop(arg_3_0)[iter_3_1]
			local var_3_2 = {
				id = iter_3_1,
				shopId = arg_3_0
			}
			...
			if var_3_1 ~= nil then
				var_3_2.buyTime = var_3_1.buy_times or 0
			end

			if var_3_1 ~= nil then
				var_3_2.next_refresh_timestamp = var_3_1.next_refresh_timestamp or 0
			end
	...
	if arg_3_0 == ShopConst.SHOP_ID.DLC_SHOP then
...
function var_0_0.GetGoodStatus(arg_7_0)
	...
	if var_7_2 ~= nil and var_7_1.limit_num ~= nil and var_7_1.limit_num ~= -1 then
		local var_7_3 = var_7_1.description and RechargeShopDescriptionCfg[var_7_1.description] or ItemCfg[var_7_1.give_id]
		...
		elseif var_7_1.limit_num - ((not var_7_2.buy_times or nil) and 0) <= 0 then
			var_7_0 = true
		end
	end
...
function var_0_0.IsShopSuspended(arg_9_0)
	if OperationData:IsFunctionStoped(ShopListCfg[arg_9_0].operation_stop_id) then
...
function var_0_0.IsGoodCanDisplay(arg_10_0, arg_10_1, arg_10_2)
	...
	if var_10_0.pre_goods_id ~= nil and #var_10_0.pre_goods_id > 0 then
		for iter_10_0, iter_10_1 in ipairs(var_10_0.pre_goods_id) do
			...
			if var_10_7 ~= nil and var_10_6.limit_num ~= nil and var_10_6.limit_num ~= -1 then
				if var_10_6.limit_num - (var_10_7.buy_times or 0) > 0 then
					var_10_1 = false
	...
	if var_10_0.taken_down == 0 and var_10_1 and var_10_2 and var_10_3 and var_0_0.CheckInSoldTime(arg_10_1) and (not var_0_0.GetIsTakenDown(var_10_0) or false) and (var_10_0.limit_display == 1 or ShopData.IsGoodUnlock(var_10_0.goods_id, arg_10_0) == 1) and not (HideInfoData:GetSkinHideList()[arg_10_1] or false) then
	...
	if var_10_0.shop_id == ShopConst.SHOP_ID.REGRESSION_SHOP then
		return true
	end
...
function var_0_0.CheckInSoldTime(arg_11_0)
	...
	return (#var_11_0.open_time < 2 and true or var_11_1 >= TimeMgr.GetInstance():parseTimeFromConfig(var_11_0.open_time)) and (#var_11_0.close_time < 2 and true or var_11_1 < TimeMgr.GetInstance():parseTimeFromConfig(var_11_0.close_time))
end

function var_0_0:GetIsTakenDown()
	if self.taken_down == 0 then
		if ItemCfg[self.give_id] and ItemCfg[self.give_id].type == ItemConst.ITEM_TYPE.HERO_PIECE and HeroTools.GetIsHide(ItemCfg[self.give_id].hero_id) then
			return true
		end

		if ItemCfg[self.give_id] and ItemCfg[self.give_id].type == ItemConst.ITEM_TYPE.WEAPON_SERVANT and ServantTools.GetIsHide(ItemCfg[self.give_id].id) then
			return true
		end

		if ItemCfg[self.give_id] and ItemCfg[self.give_id].type == ItemConst.ITEM_TYPE.EQUIP and EquipTools.GetIsHide(ItemCfg[self.give_id].id) then
			return true
		end
	else
		return true
...
function var_0_0.CheckSoldOut(arg_13_0)
	...
	if var_13_1[arg_13_0] ~= nil and var_13_0.limit_num ~= nil and var_13_0.limit_num ~= -1 then
		if var_13_0.limit_num - (var_13_1[arg_13_0].buy_times or 0) <= 0 then
			return true
		end
	end
...
function var_0_0.CheckShopSoldOut(arg_14_0)
	for iter_14_0, iter_14_1 in ipairs((getShopIDListByShopID(arg_14_0))) do
		local var_14_0 = getShopCfg(iter_14_1)

		if var_14_0.give_id then
			local var_14_1 = ItemCfg[var_14_0.give_id] or RechargeShopDescriptionCfg[var_14_0.description]

			if not var_0_0.CheckSoldOut(iter_14_1) then
				if var_14_1.type == var_14_1.HERO_SKIN then
...
function var_0_0.IsGoodCanBuyInShop(arg_15_0, arg_15_1, arg_15_2)
	...
	if var_15_0.pre_goods_id ~= nil and #var_15_0.pre_goods_id > 0 then
		for iter_15_0, iter_15_1 in ipairs(var_15_0.pre_goods_id) do
			...
			if var_15_7 ~= nil and var_15_6.limit_num ~= nil and var_15_6.limit_num ~= -1 then
				if var_15_6.limit_num - (var_15_7.buy_times or 0) > 0 then
					var_15_1 = false
	...
	if var_15_0.taken_down == 0 and var_15_1 and var_15_2 and var_15_3 and var_0_0.CheckInSoldTime(arg_15_1) and (var_15_0.limit_display == 1 or ShopData.IsGoodUnlock(var_15_0.goods_id, arg_15_0) == 1) then
...
function var_0_0.JudgeIsLvLimit(arg_18_0)
	...
	for iter_18_0, iter_18_1 in ipairs(arg_18_0) do
		if ShopConst.SHOP_LIMIT.PLAYER_LV == iter_18_1[1] and var_18_0 < iter_18_1[2] then
...
function var_0_0.HaveSkin(arg_19_0)
	for iter_19_0, iter_19_1 in ipairs(HeroData:GetHeroData(SkinCfg[arg_19_0].hero).unlocked_skin) do
...
function var_0_0.GetCostLevel(arg_20_0, arg_20_1)
	...
	if var_20_1.type == ItemConst.ITEM_TYPE.CURRENCY then
		if var_20_1.id == CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_FREE or var_20_1.id == CurrencyConst.GetPlatformDiamondId() then
			return ShopConst.COST_LEVEL.FREE_DIAMOND
		elseif var_20_1.id == CurrencyConst.CURRENCY_TYPE_SKIN then
			return ShopConst.COST_LEVEL.CURRENCY_TYPE_SKIN
		else
			return ShopConst.COST_LEVEL.RECHARGE_DIAMOND
		end
	else
		return ShopConst.COST_LEVEL.MATERIAL
	end
end
...
function var_0_0.CostEnoughJump(arg_28_0)
	if arg_28_0 == ShopConst.COST_LEVEL.FREE_DIAMOND then
		var_0_0.DiamondEnoughMessageBox()
	elseif arg_28_0 == ShopConst.COST_LEVEL.RECHARGE_DIAMOND then
		var_0_0.DefaultOpenPopUp(0)
	elseif arg_28_0 == ShopConst.COST_LEVEL.MATERIAL then
		ShowTips("ERROR_ITEM_NOT_ENOUGH_MATERIAL")
	elseif arg_28_0 == ShopConst.COST_LEVEL.CURRENCY_TYPE_SKIN then
...
function var_0_0.ConfirmBuyItem(arg_29_0, arg_29_1, arg_29_2, arg_29_3, arg_29_4, arg_29_5)
	...
	if var_29_0.give_id then
		var_29_1 = ItemCfg[var_29_0.give_id] or RechargeShopDescriptionCfg[var_29_0.description]
	end
	...
	if arg_29_5 == 1 then
		...
		var_29_4 = var_29_5
		var_29_2 = var_29_3
		var_29_11 = var_0_0.GetCostLevel(arg_29_0, var_29_3.id)
	end

	ShowMessageBox({
		title = GetTips("PROMPT"),
		content = string.format(GetTips("CONFIRM_BUY"), GetI18NText(var_29_2.name), var_29_6 * arg_29_1, GetI18NText(var_29_1.name), arg_29_1),
		OkCallback = function()
...
function var_0_0.ConfirmBuySkin(arg_31_0, arg_31_1, arg_31_2, arg_31_3, arg_31_4, arg_31_5)
	...
	for iter_31_0, iter_31_1 in ipairs(arg_31_0) do
		...
		if var_31_5.give_id then
			var_31_6 = ItemCfg[var_31_5.give_id] or RechargeShopDescriptionCfg[var_31_5.description]
		end
		...
		var_31_0[var_31_7.id] = var_31_0[var_31_7.id] or 0
		var_31_0[var_31_7.id] = var_31_0[var_31_7.id] + var_31_9 * arg_31_1[iter_31_0]
		var_31_2 = iter_31_0 == 1 and GetI18NText(var_31_6.name) or var_31_2 .. "+" .. GetI18NText(var_31_6.name)
...
function var_0_0.GetCostCount(arg_34_0, arg_34_1)
	...
	if arg_34_1 and var_34_0.cost_id_2 > var_34_0.cost_id then
		var_34_2 = var_34_0.cost_id
		var_34_1 = var_34_0.cost_id_2
	end
...
function var_0_0.GetGoodsCostCountMap(arg_35_0)
	...
	for iter_35_0, iter_35_1 in ipairs(arg_35_0) do
		...
		if var_35_1 ~= 0 then
			var_35_0[var_35_1] = var_35_0[var_35_1] or 0
			var_35_0[var_35_1] = ItemTools.getItemNum(var_35_1)
		end

		if var_35_2 ~= 0 then
			var_35_0[var_35_2] = var_35_0[var_35_2] or 0
...
function CheckGoodsTime(arg_38_0, arg_38_1)
	...
	if #arg_38_1 > 0 and #arg_38_0 > 0 then
		...
		return TimeMgr.GetInstance():parseTimeFromConfig(arg_38_0) <= var_38_0 and var_38_0 <= TimeMgr.GetInstance():parseTimeFromConfig(arg_38_1)
	end
...
function var_0_0.GetIsLimitDisount(arg_40_0)
	if not getShopCfg(arg_40_0) then
		do return false, false, false end

		local var_40_0, var_40_1 = shopCfg.is_limit_time_discount_2 == 1, shopCfg.is_limit_time_discount == 1
	end

	return var_40_1, var_40_0, ShopListCfg[shopCfg.shop_id].is_limit_time_discount == 1
end
...
function var_0_0.GetPrice(arg_42_0)
	...
	if var_42_4 and var_42_6 then
		...
		return var_42_2, var_42_2, 1, var_42_3, var_42_3
	end
end
...
function var_0_0.GetDiscountLabel(arg_45_0)
	...
	return var_0_0.GetDiscountLabelByPercent((math.min(var_45_0, var_45_1)))
end
...
function var_0_0.GetDiscount(arg_47_0)
	...
	var_47_2 = var_47_0 and var_47_0.is_limit_time_discount and var_47_0.is_limit_time_discount == 1 and (var_0_0.IsRMB(arg_47_0) and math.ceil(100 * PaymentCfg[var_47_0.cheap_cost_id].cost / PaymentCfg[var_47_0.cost_id].cost) or math.ceil(100 * var_47_0.cheap_cost / var_47_0.cost)) or var_47_0 and var_47_0.discount and var_47_0.discount ~= 0 and var_47_0.discount or 100
	var_47_3 = var_47_0 and var_47_0.is_limit_time_discount_2 and var_47_0.is_limit_time_discount_2 == 1 and math.ceil(100 * var_47_0.cheap_cost_2 / var_47_0.cost_2) or var_47_0 and var_47_0.discount and var_47_0.discount ~= 0 and var_47_0.discount or 100
	var_47_4 = var_47_2 == 100 and var_47_0.cost_id or var_47_0.cheap_cost_id
	...
	if var_47_1 and var_47_1.is_limit_time_discount == 1 and CheckGoodsTime(var_47_1.cheap_open_time, var_47_1.cheap_close_time) then
...
function var_0_0.GetOriPrice(arg_48_0)
	local var_48_2, var_48_3 = var_0_0.CalculateOriPriceFromDiscountPrice((getShopCfg(arg_48_0)))

	return var_48_2, var_48_3
end

function var_0_0:CalculateOriPriceFromDiscountPrice()
	local var_49_0 = self.cost or 0
	local var_49_1 = self.cost_2 or 0

	if var_0_0.IsRMB(self.goods_id) then
		if self.cheap_cost and self.cheap_cost ~= 0 and self.discount < 100 and self.discount > 0 then
			var_49_1 = self.cost_2
			var_49_0 = math.ceil(PaymentCfg[self.cheap_cost].cost / 100 * 100 / self.discount)
		else
			var_49_1 = self.cost_2
			var_49_0 = PaymentCfg[self.cost_id].cost / 100
		end
	end

	if self.discount < 100 and self.discount > 0 then
		if self.cheap_cost and self.cheap_cost ~= 0 then
			var_49_0 = math.ceil(self.cheap_cost * 100 / self.discount)
		end

		if self.cheap_cost_2 and self.cheap_cost_2 ~= 0 and self.cheap_cost_2 and self.cheap_cost_2 ~= 0 then
			var_49_1 = math.ceil(self.cheap_cost_2 * 100 / self.discount)
		end
	end
	...
	if var_51_4 ~= 100 or var_51_5 ~= 100 then
		if var_0_0.IsRMB(arg_51_0) then
			...
			if var_51_3 and var_51_3.discount ~= 0 then
				local var_51_6 = var_51_3.discount * var_51_2 * 100 / 10000
				local var_51_7 = math.floor(var_51_3.discount * var_51_1 * 100 / 10000)
				local var_51_8 = math.floor(var_51_3.discount * var_51_2 * 100 / 10000)
				local var_51_10 = var_51_8 == var_51_6

				if var_51_0.cheap_cost == 0 then
					return flag and math.max(var_51_7, 1) or var_51_7
				elseif var_51_3.is_limit_buy_discount == 0 and var_51_0.limit_num > 0 then
					...
					return math.min(flag and math.max(var_51_7, 1) or var_51_7, var_51_0.cheap_cost), math.min(var_51_10 and math.max(var_51_8, 1) or var_51_7, var_51_0.cheap_cost_2)
				end
			end

			return var_51_0.cheap_cost, (var_51_0.cheap_cost_2 ~= 0 or nil) and (var_51_0.cheap_cost_2 or var_51_2)
		end
	else
...
function var_0_0.IsShopOpen(arg_52_0)
	if ShopListCfg[arg_52_0].activity_id == 0 then
		return true, 0
	elseif ActivityData:GetActivityIsOpen(ShopListCfg[arg_52_0].activity_id) then
		return true, 1
	else
		local var_52_0 = ActivityData:GetActivityData(ShopListCfg[arg_52_0].activity_id)

		if var_52_0 and manager.time:GetServerTime() < var_52_0.startTime then
			return false, 3
		else
			return false, 2
		end
...
function var_0_0.GetGoodsIDListByItemID(arg_53_0, arg_53_1)
	...
	if #getShopIDListByShopID(arg_53_0) > 0 then
		for iter_53_0, iter_53_1 in ipairs((getShopIDListByShopID(arg_53_0))) do
...
function var_0_0.CheckShopIsUnLock(arg_55_0)
	if arg_55_0 then
		if ShopListCfg[arg_55_0].open_condition and ShopListCfg[arg_55_0].open_condition > 0 and (ShopListCfg[arg_55_0].display_group == 18 or ShopListCfg[arg_55_0].display_group == 24) then
			return IsConditionAchieved(ShopListCfg[arg_55_0].open_condition)
		end
	end
...
function var_0_0.GetShopIsUnLockDesc(arg_56_0)
	if ShopListCfg[arg_56_0].open_condition and ShopListCfg[arg_56_0].open_condition > 0 and ShopListCfg[arg_56_0].display_group == 18 then
		local var_56_0, var_56_1, var_56_2 = IsConditionAchieved(ShopListCfg[arg_56_0].open_condition)

		return GuildActivityTools.GetGuildSpConditionDesc(ShopListCfg[arg_56_0].open_condition) .. GetTips("DORM_CANTEEN_LEVEL_UNLOCK") .. string.format(GetTips("ACTIVITY_CLUB_SP_SHOP_UNLOCK_PROGRESS"), tostring(var_56_1), tostring(var_56_2))
	end
end
...
function var_0_0.CheckDlcPurchased(arg_57_0)
	...
	local var_57_3 = var_57_0.description and RechargeShopDescriptionCfg[var_57_0.description] or ItemCfg[var_57_0.give_id or var_57_0.description]

	if var_57_3 and var_57_3.type == ItemConst.ITEM_TYPE.SCENE and (SceneConst.HOME_SCENE_TYPE.LOCK == HomeSceneSettingData:GetUsedState(var_57_3.id) or SceneConst.HOME_SCENE_TYPE.TRIAL == HomeSceneSettingData:GetUsedState(var_57_3.id)) then
		return false
	end
...
function var_0_0.CheckDlcPurchasedByItemID(arg_58_0)
	if ItemCfg[arg_58_0] and ItemCfg[arg_58_0].type == ItemConst.ITEM_TYPE.SCENE and (SceneConst.HOME_SCENE_TYPE.LOCK == HomeSceneSettingData:GetUsedState(ItemCfg[arg_58_0].id) or SceneConst.HOME_SCENE_TYPE.TRIAL == HomeSceneSettingData:GetUsedState(ItemCfg[arg_58_0].id)) then
		return false
	end
...
function var_0_0.CheckDlcTrialByItemID(arg_59_0)
	if ItemCfg[arg_59_0] and ItemCfg[arg_59_0].type == ItemConst.ITEM_TYPE.SCENE and SceneConst.HOME_SCENE_TYPE.TRIAL == HomeSceneSettingData:GetUsedState(ItemCfg[arg_59_0].id) then
		return true
	end
...
function var_0_0.GetFragmentList()
	...
	for iter_60_0 = 1, #var_60_1 do
		var_60_0[GameSetting.fragment_break_num.value[ItemCfg[var_60_1[iter_60_0].id].rare - 2][1]] = (var_60_0[GameSetting.fragment_break_num.value[ItemCfg[var_60_1[iter_60_0].id].rare - 2][1]] or 0) + var_60_1[iter_60_0].number * GameSetting.fragment_break_num.value[ItemCfg[var_60_1[iter_60_0].id].rare - 2][2]
	end
...
function var_0_0.CheckGiftSkinOwn(arg_61_0)
	local var_61_0 = RechargeShopDescriptionCfg[getShopCfg(arg_61_0).description]

	if var_61_0.sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_PACKS then
		for iter_61_0, iter_61_1 in ipairs(var_61_0.param) do
			if iter_61_1[1] then
				if ItemTools.getItemNum(iter_61_1[1]) == 1 and ItemCfg[iter_61_1[1]].type == ItemConst.ITEM_TYPE.HERO_SKIN and ShopTools.HaveSkin(iter_61_1[1]) then
					return true
				end
			end
		end
...
function var_0_0.SplitDataByShopID(arg_62_0, arg_62_1)
	...
	for iter_62_0, iter_62_1 in ipairs(arg_62_0) do
		...
		if var_62_3.shop_refresh == 4 and ItemCfg[var_62_3.give_id].type == ItemConst.ITEM_TYPE.HERO_PIECE then
			table.insert(var_62_1[5], iter_62_1)
		elseif ItemCfg[var_62_3.give_id].type == ItemConst.ITEM_TYPE.HERO_PIECE then
			table.insert(var_62_1[4], iter_62_1)
		elseif ItemCfg[var_62_3.give_id].type == ItemConst.ITEM_TYPE.EQUIP then
			table.insert(var_62_1[3], iter_62_1)
		elseif ItemCfg[var_62_3.give_id].type == ItemConst.ITEM_TYPE.WEAPON_SERVANT then
	...
	for iter_62_2, iter_62_3 in ipairs(var_62_0.shop_label) do
		var_62_4[iter_62_3] = true
	end

	for iter_62_4, iter_62_5 in ipairs(var_62_1) do
		if var_62_4[iter_62_4] == false then
	...
	for iter_62_10, iter_62_11 in ipairs(var_62_1[3]) do
		local var_62_6 = EquipCfg[getShopCfg(iter_62_11.id).give_id]

		if var_62_5[var_62_6.suit] == nil then
			var_62_5[var_62_6.suit] = {}
		end

		if var_62_5[var_62_6.suit][var_62_6.starlevel] == nil then
			var_62_5[var_62_6.suit][var_62_6.starlevel] = {}
		end

		table.insert(var_62_5[var_62_6.suit][var_62_6.starlevel], iter_62_11)
	end

	local var_62_7 = {}

	for iter_62_12, iter_62_13 in pairs(var_62_5) do
		table.insert(var_62_7, iter_62_12)
	end

	local var_62_8 = {}

	for iter_62_14, iter_62_15 in ipairs(EquipSuitCfg.all) do
		if var_62_5[iter_62_15] then
			for iter_62_16, iter_62_17 in pairs(var_62_5[iter_62_15]) do
				table.insert(var_62_8, iter_62_17)
			end
		end
	end

	if #var_62_8 == 0 or #var_62_8[1] == 6 then
		var_62_1[3] = var_62_8
	end
	...
	for iter_62_20, iter_62_21 in ipairs(var_62_0.shop_label) do
		if #var_62_1[iter_62_21] ~= 0 then
			table.insert(var_62_9, var_62_1[iter_62_21])
		end
	end

	return var_62_9, var_62_2, var_62_7
end
...
function var_0_0.CheckDlcCanBuy(arg_65_0)
	...
	return ShopConst.SHOP_ID.DLC_SHOP == var_65_0.shop_id or ShopConst.SHOP_ID.REPURCHASE_SHOP == var_65_0.shop_id
end
...
function var_0_0.JumpToSkinShop(arg_66_0, arg_66_1, arg_66_2, arg_66_3)
	...
	if not not (ShopTools.CheckShopIsUnLock(var_66_2.shop_id) and ShopTools.IsGoodCanDisplay(var_66_2.shop_id, var_66_2.goods_id)) then
		JumpTools.GoToSystem("/rechargeMain", {
			page = ShopListCfg[var_66_2.shop_id].display_group,
			shopListId = ShopListCfg[var_66_2.shop_id].id
		}, ShopListCfg[var_66_2.shop_id].system)

		if var_66_1 == ShopConst.SHOP_ID.PASSPORT_SHOP then
			JumpTools.OpenPageByJump("shop", {
				goodID = var_66_2.goods_id,
				heroID = SkinCfg[arg_66_0].hero,
				skinID = arg_66_0,
...
function var_0_0.CheckGiveIsOwn(arg_67_0, arg_67_1)
	local function var_67_0(arg_68_0, arg_68_1)
		...
		if ItemTools.getItemNum(arg_68_0) + arg_68_1 >= ItemCfg[arg_68_0].limit then
			return false
		end
	...
	if var_67_1.description then
		if RechargeShopDescriptionCfg[var_67_1.description].sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_PACKS then
			for iter_67_0, iter_67_1 in ipairs(RechargeShopDescriptionCfg[var_67_1.description].param) do
...
function var_0_0.GetGoodsIdBySkinId(arg_69_0)
	for iter_69_0, iter_69_1 in pairs((var_0_0.FilterShopDataList(ShopConst.SHOP_ID.SKIN_SHOP))) do
...
function var_0_0.GetGoodsIdByDlcId(arg_70_0)
	for iter_70_0, iter_70_1 in pairs((var_0_0.FilterShopDataList(ShopConst.SHOP_ID.SKIN_SHOP))) do
		if getShopCfg(iter_70_1.id).description == arg_70_0 then
			return iter_70_1.id, ShopConst.SHOP_ID.SKIN_SHOP
		end
	end

	for iter_70_2, iter_70_3 in pairs((var_0_0.FilterShopDataList(ShopConst.SHOP_ID.PASSPORT_SHOP))) do
		if getShopCfg(iter_70_3.id).give_id == arg_70_0 then
			return iter_70_3.id, ShopConst.SHOP_ID.PASSPORT_SHOP
		end
	end
end
...
function var_0_0.CheckGoodsOwen(arg_71_0)
	...
	if var_71_0.shop_refresh ~= 3 then
		if ItemCfg[var_71_0.give_id].num_exchange_item then
			return ItemTools.getItemNum(var_71_0.give_id) >= ItemCfg[var_71_0.give_id].limit
		end
	else
		local var_71_1 = RechargeShopDescriptionCfg[var_71_0.description]

		if RechargeShopDescriptionCfg[var_71_0.description].sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_PACKS then
			for iter_71_0, iter_71_1 in ipairs(RechargeShopDescriptionCfg[var_71_0.description].param) do
				if ItemCfg[iter_71_1[1]].num_exchange_item and ItemTools.getItemNum(iter_71_1[1]) >= ItemCfg[iter_71_1[1]].limit then
					return true
				end
			end
		elseif var_71_1.sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_SEVEN_PACKS then
			for iter_71_2, iter_71_3 in pairs(var_71_1.param[2]) do
				if ItemCfg[iter_71_3[1]].num_exchange_item and ItemTools.getItemNum(iter_71_3[1]) >= ItemCfg[iter_71_3[1]].limit then
					return true
				end
			end
		end
...
function var_0_0.rewertReward(arg_72_0, arg_72_1)
	...
	if var_72_1.description then
		if RechargeShopDescriptionCfg[var_72_1.description].sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_PACKS then
			for iter_72_0, iter_72_1 in pairs(RechargeShopDescriptionCfg[var_72_1.description].param) do
				table.insert(var_72_0, {
					id = iter_72_1[1],
					num = iter_72_1[2] * arg_72_1
				})
			end
		elseif RechargeShopDescriptionCfg[var_72_1.description].sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_SEVEN_PACKS then
			for iter_72_2, iter_72_3 in pairs(RechargeShopDescriptionCfg[var_72_1.description].param[2]) do
				table.insert(var_72_0, {
					id = iter_72_3[1],
					num = iter_72_3[2] * arg_72_1 * RechargeShopDescriptionCfg[var_72_1.description].param[3]
				})
			end
		end
	else
	...
	for iter_72_4, iter_72_5 in ipairs(var_72_0) do
		if ItemCfg[iter_72_5.id].num_exchange_item and ItemTools.getItemNum(iter_72_5.id) + iter_72_5.num > ItemCfg[iter_72_5.id].limit then
			if ItemTools.getItemNum(iter_72_5.id) > ItemCfg[iter_72_5.id].limit then
				table.insert(var_72_2, {
					id = iter_72_5.id,
					num = iter_72_5.num
				})
				table.insert(var_72_3, {
					id = ItemCfg[iter_72_5.id].num_exchange_item[1][1],
					num = iter_72_5.num * ItemCfg[iter_72_5.id].num_exchange_item[1][2]
				})
			else
				table.insert(var_72_2, {
					id = iter_72_5.id,
					num = ItemTools.getItemNum(iter_72_5.id) + iter_72_5.num - ItemCfg[iter_72_5.id].limit
				})
				table.insert(var_72_3, {
					id = ItemCfg[iter_72_5.id].num_exchange_item[1][1],
					num = (ItemTools.getItemNum(iter_72_5.id) + iter_72_5.num - ItemCfg[iter_72_5.id].limit) * ItemCfg[iter_72_5.id].num_exchange_item[1][2]
				})
			end
		end
	end

	return var_72_2, (mergeReward((formatRewardCfgList(var_72_3))))
end
...
function var_0_0.revertGoodsReward(arg_73_0)
	...
	for iter_73_0, iter_73_1 in ipairs(arg_73_0) do
		local var_73_1 = iter_73_1.num
		local var_73_2 = ItemTools.getItemNum(iter_73_1.id)

		if ItemCfg[iter_73_1.id].num_exchange_item and ItemTools.getItemNum(iter_73_1.id) > ItemCfg[iter_73_1.id].limit then
			var_73_1 = math.max(ItemCfg[iter_73_1.id].limit - (var_73_2 - var_73_1), 0)
			...
			table.insert(var_73_0, {
				id = ItemCfg[iter_73_1.id].num_exchange_item[1][1],
				num = (var_73_2 - ItemCfg[iter_73_1.id].limit) * ItemCfg[iter_73_1.id].num_exchange_item[1][2],
				convert_from = {
					id = iter_73_1.id,
					num = var_73_2 - ItemCfg[iter_73_1.id].limit
				}
			})
		else
			table.insert(var_73_0, {
...
function var_0_0.IsShopDiscount(arg_74_0)
	if #ShopListCfg[arg_74_0].cheap_close_time > 0 then
		local var_74_0 = TimeMgr.GetInstance():GetServerTime()

		if TimeMgr.GetInstance():parseTimeFromConfig(ShopListCfg[arg_74_0].cheap_open_time) <= var_74_0 and var_74_0 <= TimeMgr.GetInstance():parseTimeFromConfig(ShopListCfg[arg_74_0].cheap_close_time) then
			return true
		end
...
function var_0_0.GetSkinIdByDlcGoodsId(arg_77_0)
	return nullable(SkinSceneActionCfg, SkinSceneActionCfg.get_id_list_by_special_scene_id[RechargeShopDescriptionCfg[getShopCfg(arg_77_0).description].param[1]][1], "skin_id")
end
...
function var_0_0.GetFakeShopDataList(arg_78_0)
	...
	for iter_78_0, iter_78_1 in ipairs(arg_78_0) do
		...
		if RechargeShopDescriptionCfg[var_78_1.description or 0] and RechargeShopDescriptionCfg[var_78_1.description or 0].type == ItemConst.ITEM_TYPE.SCENE then
			local var_78_2 = var_0_0.GetSkinIdByDlcGoodsId(iter_78_1.id)

			if HeroTools.GetShopIdBySkinId(var_78_2) <= 0 then
				table.insert(var_78_0, {
					next_refresh_timestamp = 0,
					buyTime = 0,
					id = -iter_78_1.id,
					shopId = ShopConst.SHOP_ID.DLC_SHOP
				})
				...
				ShopCfg[-iter_78_1.id] = {
					...
					shop_id = ShopConst.SHOP_ID.DLC_SHOP,
					shop_sort = var_78_1.shop_sort,
					give_id = var_78_2,
					description = var_78_2,
					give = var_78_1.give,
				...
				SkinIDToGoodIDCfg[var_78_2] = {
					id = -iter_78_1.id,
					goods_id = {
						-iter_78_1.id
					}
				}
				RechargeShopDescriptionCfg[var_78_2] = clone(ItemCfg[var_78_2])
				RechargeShopDescriptionCfg[var_78_2].param[1] = var_78_2
			end
		end
	end
...
function var_0_0.OpenWebRecharge()
	ShowMessageBox({
		...
		OkCallback = function()
			OperationAction.OpenOperationUrl("PC_SHOP", {
