local this = class("chat_bubble_shell", G_BaseConfig)
local core = G_Tables.TDChatBubbleTable.GetInstance()
...
function this:_getName(offset)
  local langStr = G_TableMgrIns:GetLangStr("chat_bubble", core:GetVString(offset, this.indexMap.name))
  return G_ConfigParser.ParseConfigStr(langStr, G_ConfigConst.ParseType.langstring, "name")
end

function this:_getDesc(offset)
  local langStr = G_TableMgrIns:GetLangStr("chat_bubble", core:GetVString(offset, this.indexMap.desc))
  return G_ConfigParser.ParseConfigStr(langStr, G_ConfigConst.ParseType.langstring, "desc")
end

function this:_getSpecialdesc(offset)
  local langStr = G_TableMgrIns:GetLangStr("chat_bubble", core:GetVString(offset, this.indexMap.specialDesc))
...
function this:_getVfx(offset)
  local str = core:GetVString(offset, this.indexMap.vfx).value
  return G_ConfigParser.ParseConfigStr(str, G_ConfigConst.ParseType.resourceStr, 1)
end

function this:_getAnimation(offset)
  local str = core:GetVString(offset, this.indexMap.animation).value
  return G_ConfigParser.ParseConfigStr(str, G_ConfigConst.ParseType.resourceStr, 1)
end
...
function this:_getWaydesc(offset)
  local langStrList = G_TableMgrIns:GetListLangStr("chat_bubble", core:GetVString(offset, this.indexMap.wayDesc))
  return G_ConfigParser.ParseConfigStr(langStrList, G_ConfigConst.ParseType.listLangstring, "chat_bubble")
end
