local this = class("task_shell", G_BaseConfig)
local core = G_Tables.TDTaskTable.GetInstance()
...
function this:_getName(offset)
  local langStr = G_TableMgrIns:GetLangStr("task", core:GetVString(offset, this.indexMap.name))
  return G_ConfigParser.ParseConfigStr(langStr, G_ConfigConst.ParseType.langstring, "name")
end

function this:_getDesc(offset)
  local langStr = G_TableMgrIns:GetLangStr("task", core:GetVString(offset, this.indexMap.desc))
