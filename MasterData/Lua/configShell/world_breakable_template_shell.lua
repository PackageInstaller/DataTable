local this = class("world_breakable_template_shell", G_BaseConfig)
local core = G_Tables.TDWorldBreakableTemplateTable.GetInstance()
...
function this:_getMediapack(offset)
  return core:GetVString(offset, this.indexMap.mediaPack).value
end
