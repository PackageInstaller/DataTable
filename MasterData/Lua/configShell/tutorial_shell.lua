local this = class("tutorial_shell", G_BaseConfig)
local core = G_Tables.TDTutorialTable.GetInstance()
...
function this:_getTutorialname(offset)
  local langStr = G_TableMgrIns:GetLangStr("tutorial", core:GetVString(offset, this.indexMap.tutorialName))
