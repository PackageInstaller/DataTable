local this = class("mall_shop_group_shell", G_BaseConfig)
local core = G_Tables.TDMallShopGroupTable.GetInstance()
...
function this:_getShopgroupname(offset)
  local langStr = G_TableMgrIns:GetLangStr("mall_shop_group", core:GetVString(offset, this.indexMap.shopGroupName))
...
function this:_getShowsubtab(offset)
  return core:GetBool(offset, this.indexMap.ShowSubTab)
end
...
this.keyToMethodsMap = {
  ...
  icon = this._getIcon,
  ShowSubTab = this._getShowsubtab,
