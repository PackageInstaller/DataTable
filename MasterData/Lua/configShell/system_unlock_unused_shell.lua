local this = class("system_unlock_unused_shell", G_BaseConfig)
local core = G_Tables.TDSystemUnlockUnusedTable.GetInstance()
...
function this:_getName(offset)
  local langStr = G_TableMgrIns:GetLangStr("system_unlock_unused", core:GetVString(offset, this.indexMap.name))
...
function this:_getLocktips(offset)
  local langStr = G_TableMgrIns:GetLangStr("system_unlock_unused", core:GetVString(offset, this.indexMap.lockTips))
...
function this:_getGmclosetips(offset)
  local langStr = G_TableMgrIns:GetLangStr("system_unlock_unused", core:GetVString(offset, this.indexMap.gmCloseTips))
