local this = class("optiondata_unused_shell", G_BaseConfig)
local core = G_Tables.TDOptionDataUnusedTable.GetInstance()
...
function this:_getOptionclassification2name(offset)
  local langStr = G_TableMgrIns:GetLangStr("optionData_unused", core:GetVString(offset, this.indexMap.optionclassification2Name))
...
function this:_getOptionname(offset)
  local langStr = G_TableMgrIns:GetLangStr("optionData_unused", core:GetVString(offset, this.indexMap.optionName))
...
function this:_getOptionpara4(offset)
  local langStr = G_TableMgrIns:GetLangStr("optionData_unused", core:GetVString(offset, this.indexMap.optionPara4))
...
function this:_getOptionpara6(offset)
  local langStrList = G_TableMgrIns:GetListLangStr("optionData_unused", core:GetVString(offset, this.indexMap.optionPara6))
  return G_ConfigParser.ParseConfigStr(langStrList, G_ConfigConst.ParseType.listLangstring, "optionData_unused")
end

function this:_getOptionpara6mobile(offset)
  local langStrList = G_TableMgrIns:GetListLangStr("optionData_unused", core:GetVString(offset, this.indexMap.optionPara6mobile))
  return G_ConfigParser.ParseConfigStr(langStrList, G_ConfigConst.ParseType.listLangstring, "optionData_unused")
end
