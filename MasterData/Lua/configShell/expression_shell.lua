local this = class("expression_shell", G_BaseConfig)
local core = G_Tables.TDExpressionTable.GetInstance()
...
function this:_getName(offset)
  local langStr = G_TableMgrIns:GetLangStr("expression", core:GetVString(offset, this.indexMap.name))
