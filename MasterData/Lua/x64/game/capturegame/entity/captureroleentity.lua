...
function CaptureRoleEntity:AddListener()
	...
	function self.context.trigger.onBeginDrag(arg_8_0, arg_8_1)
		local var_8_0 = LuaHelper.ScreenToLocal(CaptureGameMgr:GetCameraMgr():GetControllerRectTransform(), arg_8_1.position, arg_8_1.enterEventCamera)
	...
	function self.context.trigger.onDrag(arg_9_0, arg_9_1)
		...
		local var_9_0 = LuaHelper.ScreenToLocal(CaptureGameMgr:GetCameraMgr():GetControllerRectTransform(), arg_9_1.position, arg_9_1.enterEventCamera)
		...
		local var_9_1 = self.context.rotateModel.localEulerAngles
		local var_9_2 = self.context.rotateModel.localEulerAngles.y + (self.context.preDragPos.x - var_9_0.x) * HeroConst.ROTATE_RATIO - self.context.rotateModel.localEulerAngles.y
		local var_9_3 = var_9_2

		if var_9_2 < -HeroConst.MAX_RORATE_ANGLE then
			var_9_3 = -HeroConst.MAX_RORATE_ANGLE
		elseif var_9_2 > HeroConst.MAX_RORATE_ANGLE then
			var_9_3 = HeroConst.MAX_RORATE_ANGLE
		end

		self.context.rotateModel.localRotation = Quaternion.RotateTowards(self.context.rotateModel.localRotation, Quaternion.Euler(var_9_1.x, self.context.rotateModel.localEulerAngles.y + var_9_3, var_9_1.z), HeroConst.MAX_RORATE_ANGLE)
	end
end
