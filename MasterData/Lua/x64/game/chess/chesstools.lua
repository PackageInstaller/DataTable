...
local var_0_2 = {
	IsInteract = function(arg_1_0, arg_1_1)
		if WarchessHexCfg[arg_1_1 == 0 and arg_1_0 or arg_1_0 * 10 + arg_1_1] then
			return WarchessHexCfg[arg_1_1 == 0 and arg_1_0 or arg_1_0 * 10 + arg_1_1].interact == 1
		end

		return WarchessHexCfg[arg_1_0].interact == 1
	end,
	IsMove = function(arg_2_0, arg_2_1)
		if WarchessHexCfg[arg_2_1 == 0 and arg_2_0 or arg_2_0 * 10 + arg_2_1] then
			return WarchessHexCfg[arg_2_1 == 0 and arg_2_0 or arg_2_0 * 10 + arg_2_1].move ~= 0
		end

		return WarchessHexCfg[arg_2_0].move ~= 0
	end,
	WayFindingWeight = function(arg_3_0, arg_3_1)
		if WarchessHexCfg[arg_3_1 == 0 and arg_3_0 or arg_3_0 * 10 + arg_3_1] then
			return WarchessHexCfg[arg_3_1 == 0 and arg_3_0 or arg_3_0 * 10 + arg_3_1].move
		end

		return WarchessHexCfg[arg_3_0].move
	end,
	IsWalkEvent = function(arg_4_0, arg_4_1)
		if WarchessHexCfg[arg_4_1 == 0 and arg_4_0 or arg_4_0 * 10 + arg_4_1] then
			return WarchessHexCfg[arg_4_1 == 0 and arg_4_0 or arg_4_0 * 10 + arg_4_1].interact == 2
		end
	...
	IsStoneInteract = function(arg_5_0, arg_5_1, arg_5_2)
		...
		if (arg_5_1 == 0 and arg_5_0 or arg_5_0 * 10 + arg_5_1) == ChessConst.HOLE_GRID_ID and arg_5_2 == 2 then
			return false
		end
	...
	IsExplode = function(self)
		if WarchessHexCfg[self.status == 0 and self.typeID or self.typeID * 10 + self.status].explode == 1 then
			return true
		end
...
function var_0_2:IsBreakAuto()
	local var_7_0 = var_0_2.ParseParameter(self)
	local var_7_1 = self.typeID

	if WarchessHexCfg[self.status == 0 and var_7_1 or var_7_1 * 10 + self.status].interact ~= 2 then
		return false
	end
...
function var_0_2.LoadMap(arg_8_0)
	return (cjson.decode((AssetEx.LoadText("Map/Chess/JsonMap/" .. arg_8_0 .. ".json"))))
end
...
function var_0_2:ParseParameter(arg_10_1, arg_10_2)
	local var_10_0

	if arg_10_1 then
		if type(self.paramList) ~= "table" or #self.paramList <= 0 then
			return {}
		end

		var_10_0 = self.paramList[1]
	else
		if self.paramList.Length <= 0 then
			return {}
		end

		var_10_0 = self.paramList[0]
	end
	...
	local var_10_1 = not arg_10_2 and WarchessEventPoolCfg[var_10_0].event_group or WarchessEventPoolCfg[var_10_0].event_group_second
...
function var_0_2.GetProgress(arg_14_0)
	local var_14_0 = WarChessData:GetBoxNum(arg_14_0, ChessConst.BOX.SMALL) * WarchessLevelCfg[arg_14_0].sbox_progress
	local var_14_1 = WarChessData:GetBoxNum(arg_14_0, ChessConst.BOX.BIG) * WarchessLevelCfg[arg_14_0].lbox_progress

	return var_14_0 + var_14_1 > 100 and 100 or var_14_0 + var_14_1
end
...
function var_0_2.OneDToTwoD(arg_17_0)
	return math.fmod(arg_17_0, 1000), (math.floor(arg_17_0 / 1000))
end

function var_0_2:GetExtendID(arg_18_1)
	local var_18_0
	local var_18_1 = table.keyof(self, arg_18_1)
	...
	elseif not var_18_1 then
		...
		local var_18_2 = math.fmod(var_18_1 + 1, #self + 1)

		if var_18_2 == 0 then
			var_18_2 = var_18_2 + 1
		end

		var_18_0 = self[var_18_2]
	end
...
function var_0_2.GetChapterProgress(arg_20_0)
	...
	local var_20_0 = WarChessData:GetBoxNum(arg_20_0, ChessConst.BOX.SMALL) * WarchessLevelCfg[arg_20_0].sbox_progress
	local var_20_1 = WarChessData:GetBoxNum(arg_20_0, ChessConst.BOX.BIG) * WarchessLevelCfg[arg_20_0].lbox_progress

	return WarChessData:GetBoxNum(arg_20_0, ChessConst.BOX.SMALL) * WarchessLevelCfg[arg_20_0].sbox_progress + var_20_1 > 100 and 100 or var_20_0 + var_20_1
end

function var_0_2.EnterChessMap(arg_21_0, arg_21_1)
	local var_21_0 = not arg_21_1 and ChapterClientCfg[arg_21_0].chapter_list[1] or arg_21_0

	if not WarchessLevelCfg[var_21_0] then
		-- block empty
	end

	local var_21_1 = WarChessData:GetCurrentChapter(WarchessLevelCfg[var_21_0].type)

	if var_21_1 == 0 or var_21_1 ~= var_21_0 then
	...
	if var_21_1 ~= 0 then
		if ChapterClientCfg[var_21_1] then
			var_21_3 = GetTips("CHESS_NAME_" .. WarchessLevelCfg[var_21_1].tag)
			var_21_4 = ChapterClientCfg[var_21_1].name
		else
			var_21_4 = WarchessLevelCfg[var_21_1].name_level
		end
	end
	...
	if var_21_1 ~= var_21_0 then
		ShowMessageBox({
			...
			content = string.format(GetTips("OPEN_NEW_WARCHESS"), GetI18NText(var_21_3), GetI18NText(var_21_4), GetI18NText(var_21_3), GetI18NText(var_21_4)),
			OkCallback = function()
				var_21_2()
			end,
...
function var_0_2.IsShowMessage(arg_26_0, arg_26_1)
	if WarchessEventPoolCfg[arg_26_0].click_form == "" then
		return WarchessEventPoolCfg[arg_26_0].click_form
	end

	for iter_26_0, iter_26_1 in ipairs(WarchessEventPoolCfg[arg_26_0].click_form) do
...
function var_0_2.PhraseArea(arg_30_0)
	...
	for iter_30_0, iter_30_1 in ipairs(arg_30_0) do
		if iter_30_1[1] == 1 then
			for iter_30_2 = -iter_30_1[4], iter_30_1[4] do
				for iter_30_3 = math.max(-iter_30_1[4], iter_30_2 - iter_30_1[4]), math.min(iter_30_1[4], iter_30_2 + iter_30_1[4]) do
					var_30_0[var_0_2.TwoDToOneD(iter_30_2 + iter_30_1[2], iter_30_3 + iter_30_1[3])] = true
				end
			end
		elseif iter_30_1[1] == 2 then
			var_30_0[var_0_2.TwoDToOneD(iter_30_1[2], iter_30_1[3])] = true
			var_30_0[var_0_2.TwoDToOneD(iter_30_1[2], iter_30_1[5])] = true
			var_30_0[var_0_2.TwoDToOneD(iter_30_1[4], iter_30_1[3])] = true
			var_30_0[var_0_2.TwoDToOneD(iter_30_1[4], iter_30_1[5])] = true
		elseif iter_30_1[1] == 3 then
			for iter_30_4 = 2, #iter_30_1, 2 do
				var_30_0[var_0_2.TwoDToOneD(iter_30_1[iter_30_4], iter_30_1[iter_30_4 + 1])] = true
			end
		end
	end
...
function var_0_2.DoSpecialEvent(arg_31_0, arg_31_1)
	(ChessSpecialEventConfig[arg_31_0][arg_31_1] or ChessSpecialEventConfig[arg_31_0][ChessConst.TIMING_ALL])(unpack(WarchessSpecialEventCfg[arg_31_0].param))
end
...
function var_0_2.CreateChessData(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
	...
	var_32_0.direction = (arg_32_2[arg_32_3].rotationY or 0) / 60
	var_32_0.status = arg_32_2[arg_32_3].status
	var_32_0.attribute = {}
...
function var_0_2.CheckCanEnterMutiBattle(arg_33_0, arg_33_1)
	for iter_33_0 = 1, arg_33_0 do
		local var_33_0 = ReserveTools.GetHeroList((ReserveParams.New(ReserveConst.RESERVE_TYPE.MULTI_CHESS, arg_33_1, iter_33_0)))

		if #var_33_0 == 0 or var_33_0[1] == 0 then
			return false
		end
	end
...
function var_0_2:CreateChessDataViaJson()
	local var_34_0 = Chess.GridData.New()

	var_34_0.paramList = self.paramList
	var_34_0.prefab = self.prefab
	var_34_0.rotationY = self.rotationY
	var_34_0.status = self.status
	var_34_0.typeID = self.typeID
	var_34_0.x = self.x
	var_34_0.z = self.z
