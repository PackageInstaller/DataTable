return {
	...
	[10002] = {
		[ChessBoardConst.TIMING.FIRST_ENTER_MAP] = function(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
			if arg_3_0[1] == 0 then
				...
				var_3_0.pos.x = arg_3_2
				var_3_0.pos.z = arg_3_3
				var_3_0.dir = arg_3_4
				var_3_0.attribute = {}

				for iter_3_0, iter_3_1 in pairs(ChessBoardNPCPoolCfg[arg_3_1].init_attribute_list) do
					var_3_0.attribute[iter_3_1[1]] = iter_3_1[2]
				end

				var_3_0.buffList = {}

				manager.ChessBoardManager:AddNPC(var_3_0)
			end
		...
		[ChessBoardConst.TIMING.ALL] = function(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
			if arg_4_0[1] == 0 then
				...
				var_4_0.pos.x = arg_4_2
				var_4_0.pos.z = arg_4_3
				var_4_0.dir = arg_4_4
				var_4_0.attribute = {}

				for iter_4_0, iter_4_1 in pairs(ChessBoardNPCPoolCfg[arg_4_1].init_attribute_list) do
					var_4_0.attribute[iter_4_1[1]] = iter_4_1[2]
				end

				var_4_0.buffList = {}

				manager.ChessBoardManager:AddNPC(var_4_0)
	...
	[10005] = {
		[ChessBoardConst.TIMING.ALL] = function(arg_10_0, arg_10_1)
			...
			manager.ChessBoardManager:ChangeGridByExtentID(var_10_0.x, var_10_0.z, arg_10_1, false, function()
				return manager.ChessBoardManager:DoNextEvent()
			end)
		end
	},
	[10006] = {
		[ChessBoardConst.TIMING.ALL] = function(arg_12_0, arg_12_1)
			...
			manager.ChessBoardManager:ChangeThingByExtentID(var_12_0.x, var_12_0.z, arg_12_1, function()
				return manager.ChessBoardManager:DoNextEvent()
			end)
		end
	},
	[10007] = {
		[ChessBoardConst.TIMING.HERO_STAY_NPC] = function(arg_14_0)
			...
			local var_14_1 = manager.ChessBoardManager.NPCManager_:FindNPCWithPos(var_14_0.x, var_14_0.z)

			if var_14_1 then
				manager.ChessBoardManager:DeleteNPC(var_14_1)
			end
		...
		[ChessBoardConst.TIMING.ALL] = function(arg_15_0)
			...
			local var_15_1 = manager.ChessBoardManager.NPCManager_:FindNPCWithPos(var_15_0.x, var_15_0.z)

			if var_15_1 then
				ChessBoardLuaBridge.ShowNPCDestoryEffectActive(var_15_0.x, var_15_0.z)
				manager.ChessBoardManager:AddDelayTimer(0.5, function()
					ChessBoardLuaBridge.ClearNPCDestoryEffect()

					return manager.ChessBoardManager:DoNextEvent()
				end)
				manager.ChessBoardManager:DeleteNPC(var_15_1)
			else
				return manager.ChessBoardManager:DoNextEvent()
			end
		end
	...
	[10008] = {
		[ChessBoardConst.TIMING.ALL] = function(arg_17_0, arg_17_1)
			...
			elseif arg_17_0[1] == arg_17_0.playerB then
				...
				var_17_1.pos.x = var_17_0.x
				var_17_1.pos.z = var_17_0.z
				var_17_1.dir = arg_17_0[2]
				var_17_1.attribute = {}
				var_17_1.actionType = ChessBoardConst.ACTIONTYPE.GROW

				for iter_17_0, iter_17_1 in pairs(ChessBoardNPCPoolCfg[arg_17_1].init_attribute_list) do
					var_17_1.attribute[iter_17_1[1]] = iter_17_1[2]
				end

				var_17_1.buffList = {}

				ShowTips("CHESSBOARD_NEW_BIG_DUCK")
				manager.ChessBoardManager:AddNPC(var_17_1)
				ChessBoardLuaBridge.SetNPCToCameraTarget(var_17_1.id)
	...
	[10009] = {
		[ChessBoardConst.TIMING.ALL] = function(arg_19_0, arg_19_1, arg_19_2)
			...
			manager.ChessBoardManager:PlayGridAnimation(var_19_0.x, var_19_0.z, arg_19_1, arg_19_2, function()
				return manager.ChessBoardManager:DoNextEvent()
			end)
		end
	},
		...
		[ChessBoardConst.TIMING.ALL] = function(arg_30_0, arg_30_1, arg_30_2, arg_30_3, arg_30_4)
			if arg_30_0[1] == 0 then
				...
				elseif arg_30_0[1] == var_30_0[2] then
					...
					var_30_1.pos.x = arg_30_1
					var_30_1.pos.z = arg_30_2
					var_30_1.dir = arg_30_4
					var_30_1.attribute = {}
					var_30_1.actionType = ChessBoardConst.ACTIONTYPE.GROW

					for iter_30_0, iter_30_1 in pairs(ChessBoardNPCPoolCfg[arg_30_3].init_attribute_list) do
						var_30_1.attribute[iter_30_1[1]] = iter_30_1[2]
					end

					var_30_1.buffList = {}

					ShowTips("CHESSBOARD_NEW_BIG_DUCK")
					manager.ChessBoardManager:AddNPC(var_30_1)
					ChessBoardLuaBridge.SetNPCToCameraTarget(var_30_1.id)
					ChessBoardLuaBridge.ChangeCameraToCloseCamera()
					manager.ChessBoardManager:AddDelayTimer(1, function()
						manager.ChessBoardManager:DoNextEvent()
					end)
	...
	[10020] = {
		[ChessBoardConst.TIMING.ALL] = function(arg_37_0, arg_37_1, arg_37_2)
			...
			if var_37_0.thingTypeID > 0 then
				manager.ChessBoardManager:DeleteThing(var_37_0.x, var_37_0.z, function()
					return manager.ChessBoardManager:DoNextEvent()
				end)
			else
				return manager.ChessBoardManager:DoNextEvent()
	...
	[10021] = {
		[ChessBoardConst.TIMING.ALL] = function(arg_39_0, arg_39_1)
			...
			for iter_39_0, iter_39_1 in pairs(arg_39_1) do
				manager.ChessBoardManager:PlayGridAnimation(iter_39_1[1], iter_39_1[2], iter_39_1[3], iter_39_1[4], function()
					var_39_0 = var_39_0 - 1
		...
		[ChessBoardConst.TIMING.ALL] = function(arg_51_0, arg_51_1, arg_51_2, arg_51_3)
			if arg_51_1 == 1 then
				if arg_51_0.playerA == 0 then
					manager.ChessBoardManager:SubHeroAttribute(arg_51_2, arg_51_0[1] - manager.ChessBoardManager:GetHeroAttribute(arg_51_2))
		...
		[ChessBoardConst.TIMING.ALL] = function(arg_52_0, arg_52_1)
			if playerType == 1 then
				if arg_52_0.playerA == 0 then
					manager.ChessBoardManager:SubHeroAttribute(attributeID, arg_52_0[1] - manager.ChessBoardManager:GetHeroAttribute(attributeID))
