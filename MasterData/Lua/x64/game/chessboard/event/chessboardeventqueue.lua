local ChessBoardEventQueue = class("ChessBoardEventQueue", (require("game/chess/ChessEventQueue")))

function ChessBoardEventQueue:InsertNewEventQueue(arg_1_1, arg_1_2, arg_1_3)
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_3) do
		if not ChessBoardEventConfig[iter_1_1.eventID] then
			-- block empty
		end
		...
		var_1_2.func = ChessBoardEventConfig[iter_1_1.eventID][arg_1_1] or ChessBoardEventConfig[iter_1_1.eventID][ChessBoardConst.TIMING.ALL]
...
function ChessBoardEventQueue:InsertCurEventQueue(arg_2_1)
...
function ChessBoardEventQueue:IsEmpty()
