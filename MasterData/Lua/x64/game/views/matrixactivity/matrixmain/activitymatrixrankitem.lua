...
function LimitedCalculationRankItem:RefreshUI(arg_6_1)
	...
	self.rank_.text = arg_6_1.rank
	self.score_.text = arg_6_1.score
	self.difficulty_.text = arg_6_1.difficulty
	...
	for iter_6_0 = 1, var_6_1 do
		self["m_heroIcon_" .. iter_6_0].sprite = getSpriteViaConfig("HeroLittleIcon", SkinCfg[(var_6_0[iter_6_0].skin_id == 0 or nil) and var_6_0[iter_6_0].hero_id].picture_id)
	end
