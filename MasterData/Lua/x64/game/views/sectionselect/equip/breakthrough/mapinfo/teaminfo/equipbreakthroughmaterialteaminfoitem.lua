...
function EquipBreakThroughMaterialTeamInfoItem:RefreshUI()
	...
	local var_6_3 = HeroData:GetHeroList()[var_6_1].level

	var_6_3 = var_6_3 or 1
	self.lvText_.text = var_6_3
	self.hpSlider_.value = var_6_0.rate / 10000

	local var_6_4 = math.ceil(var_6_0.rate / 100)

	if var_6_4 <= 0 and var_6_0.rate > 0 then
		var_6_4 = 1
	end

	self.hpText_.text = string.format("%s%%", var_6_4)
