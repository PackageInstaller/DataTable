...
function ItemExchangeView:during()
	return CurrencyData:GetLastFatigueRecoverTime() == 0 and GameSetting.fatigue_recovery.value[1] * 60 or GameSetting.fatigue_recovery.value[1] * 60 - (manager.time:GetServerTime() - CurrencyData:GetLastFatigueRecoverTime()) % (GameSetting.fatigue_recovery.value[1] * 60)
end
