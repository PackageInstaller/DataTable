local SkinTrialSelect1002 = class("SkinTrialSelect1002", SkinTrialActivitySelectView)

function SkinTrialSelect1002:UIName()
	return "UI/OsirisUI/OsirisSkinTrialUI_101"
end

function SkinTrialSelect1002:OnEnter()
	SkinTrialSelect1002.super.OnEnter(self)
...
function SkinTrialSelect1002:AddListeners()
...
function SkinTrialSelect1002:OnExit()
	SkinTrialSelect1002.super.OnExit(self)
	self:StopTimer()
end

function SkinTrialSelect1002:RefreshUI()
...
function SkinTrialSelect1002:GetRewardItem()
	return CommonItem
end

function SkinTrialSelect1002:GetCommonItem(arg_8_1)
	return arg_8_1
end

function SkinTrialSelect1002:IndexItem(arg_9_1, arg_9_2)
...
function SkinTrialSelect1002:AddTimer()
...
function SkinTrialSelect1002:StopTimer()
	if self.timer_ then
		self.timer_:Stop()
