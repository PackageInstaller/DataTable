local SkinTrialSelect108 = class("SkinTrialSelect108", SkinTrialActivitySelectView)

function SkinTrialSelect108:UIName()
	return "UI/VolumeIIIDownUI/SkinTrial/VolumeSkinTrialUI_" .. self.params_.skinTrialID
end

function SkinTrialSelect108:RefreshUI()
