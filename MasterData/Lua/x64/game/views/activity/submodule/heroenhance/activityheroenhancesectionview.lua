...
function ActivityHeroEnhanceSectionView:CreateLineItemList()
	...
	for iter_14_0, iter_14_1 in ipairs(self.oepnStageList_) do
		local var_14_1 = self.missionItem_[table.keyof(self.stageList_, iter_14_1)]:GetLocalPosition() + Vector3(0, 0, 0)

		for iter_14_2, iter_14_3 in ipairs(self:GetCfgName()[iter_14_1].next_unlock_id_list or {}) do
			local var_14_2 = self:GetCfgName()[iter_14_1]

			if table.keyof(self.oepnStageList_, iter_14_3) then
				local var_14_3 = self.missionItem_[table.keyof(self.stageList_, iter_14_3)]:GetLocalPosition() + Vector3(0, 0, 0)
				...
				self.lineList_[var_14_0]:RefreshUI(var_14_1, var_14_3)
			end
		end
	end
