...
function ActivityHeroEnhanceSectionView_4_5:CreateLineItemList()
	...
	for iter_18_0, iter_18_1 in ipairs(self.oepnStageList_) do
		local var_18_1 = self.missionItem_[table.keyof(self.stageList_, iter_18_1)]:GetLocalPosition() + Vector3(0, 0, 0)

		for iter_18_2, iter_18_3 in ipairs(self:GetCfgName()[iter_18_1].next_unlock_id_list or {}) do
			local var_18_2 = self:GetCfgName()[iter_18_1]

			if table.keyof(self.oepnStageList_, iter_18_3) then
				local var_18_3 = self.missionItem_[table.keyof(self.stageList_, iter_18_3)]:GetLocalPosition() + Vector3(0, 0, 0)
				...
				self.lineList_[var_18_0]:RefreshUI(var_18_1, var_18_3)
			end
		end
	end
