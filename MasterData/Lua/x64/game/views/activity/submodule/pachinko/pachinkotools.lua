...
function var_0_0.GetBallOffset(arg_14_0)
	...
	if var_14_1 <= 0 then
		...
		if math.random(0, 99) < 50 + (GameSetting.pachinko_pity.value[2] or 0) then
			var_14_2 = true
			var_14_4 = GameSetting.pachinko_add_force_range.value[1]
		end
	end

	return Vector2.New(math.random(var_14_4, GameSetting.pachinko_add_force_range.value[2]) * (var_14_2 and -0.01 or 0.01), 0)
end
