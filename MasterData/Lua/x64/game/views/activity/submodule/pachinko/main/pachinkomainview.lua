...
function PaChinKoMainView:OnEnter()
	...
	local var_4_1 = manager.ui.mainCameraCom_:ScreenToWorldPoint(PaChinKoMainView.GetUICam():WorldToScreenPoint(self.uiTouchBtn_.transform.position) - Vector3(0, self.uiTouchBtn_.transform.rect.height / 2, 0))

	self.heroModelTf_.localPosition = Vector3(var_4_1.x, PaChinKoUICfg[PaChinKoUICfg.get_id_list_by_activity_id[self.activityID_][1]].posY, var_4_1.z)
