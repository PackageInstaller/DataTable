local ActivityPT2RankItem = class("ActivityPT2RankItem", ReduxView)

function ActivityPT2RankItem:OnCtor(arg_1_1)
...
function ActivityPT2RankItem:Init()
	self:InitUI()
end

function ActivityPT2RankItem:InitUI()
	self:BindCfgUI()
...
function ActivityPT2RankItem:RefreshUI(arg_4_1)
	...
	self.frame_.sprite = ItemTools.getItemSprite(arg_4_1.icon_frame)
	...
	for iter_4_0 = 1, var_4_0 do
		self["m_heroIcon_" .. iter_4_0].sprite = getSpriteViaConfig("HeroLittleIcon", (arg_4_1.select_hero_id_list[iter_4_0].skin_id == 0 or nil) and arg_4_1.select_hero_id_list[iter_4_0].id)
	end
