...
function ZumaGameView:ZumaAdaptiveMask()
	...
	local var_8_5, var_8_6 = UnityEngine.RectTransformUtility.ScreenPointToLocalPointInRectangle(manager.ui.canvas.transform, UnityEngine.Camera.main:WorldToScreenPoint(var_8_0.min), var_8_1, nil)
