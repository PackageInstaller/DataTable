local ActivityReforgePassiveSkillItem = class("ActivityReforgePassiveSkillItem", ReduxView)

function ActivityReforgePassiveSkillItem:OnCtor(arg_1_1)
...
function ActivityReforgePassiveSkillItem:Init()
	self:InitUI()
end

function ActivityReforgePassiveSkillItem:InitUI()
	self:BindCfgUI()

	self.skillItemList_ = {}
end

function ActivityReforgePassiveSkillItem:SetData(arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5, arg_4_6)
	...
	self.curSkillID_ = arg_4_6
	self.slotText_.text = GetTips("ACTIVITY_REFORGE_PASSIVE_SLOT")
	self.slotNumText_.text = string.format(GetTips("ACTIVITY_REFORGE_USE_MAX"), ActivityReforgeData:GetPassiveSkillUseNum() .. "/" .. #self.skillList_)
...
function ActivityReforgePassiveSkillItem:OnExit()
	for iter_5_0, iter_5_1 in pairs(self.skillItemList_) do
		iter_5_1:OnExit()
	end
end

function ActivityReforgePassiveSkillItem:Dispose()
	...
	ActivityReforgePassiveSkillItem.super.Dispose(self)
end

return ActivityReforgePassiveSkillItem
