...
function GoldMinerThief:IsOutOfGameView()
	...
	local var_13_1 = GoldMinerManager.GetInstance():GetGameRoot()
	local var_13_2 = -(1080 / Screen.height * (UnityEngine.RectTransformUtility.WorldToScreenPoint(var_13_0, (self.hitGo_.transform:TransformPoint(0, 0, 0))) - UnityEngine.RectTransformUtility.WorldToScreenPoint(var_13_0, (var_13_1:TransformPoint(0, 0, 0))))).y

	if var_13_2 < 0 or var_13_2 > 1080 or (1080 / Screen.height * var_13_1).x < 0 or (1080 / Screen.height * var_13_1).x > 1920 then
		return true
	end
