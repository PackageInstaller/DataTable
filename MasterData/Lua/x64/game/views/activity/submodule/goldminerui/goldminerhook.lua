...
function GoldMinerHook:IsOutOfGameView()
	...
	local var_9_1 = GoldMinerManager.GetInstance():GetGameRoot()
	local var_9_2 = -(1080 / Screen.height * (UnityEngine.RectTransformUtility.WorldToScreenPoint(var_9_0, (self.hitGo_.transform:TransformPoint(0, 0, 0))) - UnityEngine.RectTransformUtility.WorldToScreenPoint(var_9_0, (var_9_1:TransformPoint(0, 0, 0))))).y

	if var_9_2 < 0 or var_9_2 > 1080 or (1080 / Screen.height * var_9_1).x < 0 or (1080 / Screen.height * var_9_1).x > 1920 then
		return true
	end
