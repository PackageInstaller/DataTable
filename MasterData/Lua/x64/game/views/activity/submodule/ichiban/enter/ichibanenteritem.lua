local IchiBanEnterItem = class("IchiBanEnterItem", ReduxView)

function IchiBanEnterItem:Ctor(arg_1_1)
...
function IchiBanEnterItem:Dispose()
	...
	IchiBanEnterItem.super.Dispose(self)
end

function IchiBanEnterItem:AddListeners()
	self:AddBtnListener(self.btn_, nil, function()
		TaskAction:SubmitTask(self.taskID_)
	end)
end

function IchiBanEnterItem:Refresh(arg_5_1, arg_5_2)
	self.taskID_ = arg_5_1
	self.activityID_ = arg_5_2
	self.taskActivityID_ = IchiBanTools.GetTaskActivityID(self.activityID_)
...
function IchiBanEnterItem:RefreshNormalTask()
...
function IchiBanEnterItem:RefreshReward(arg_7_1)
