...
function var_0_0.GetSkinDrawCfg(arg_1_0)
	if T0SkinDrawCfg[arg_1_0] == nil then
		-- block empty
	end

	return T0SkinDrawCfg[arg_1_0]
end
...
function var_0_0.GetAllReward(arg_17_0)
	...
	for iter_17_0, iter_17_1 in ipairs(var_0_0.GetPoolIdList(arg_17_0)) do
		for iter_17_2, iter_17_3 in ipairs(ActivityLimitedDrawPoolListCfg[iter_17_1].main_icon_info) do
			if ItemCfg[iter_17_3[2]].type == ItemConst.ITEM_TYPE.SCENE then
				var_17_0[ActivityLimitedDrawPoolListCfg[iter_17_1].activity_id[1]] = iter_17_3[2]
			elseif ItemCfg[iter_17_3[2]].type == ItemConst.ITEM_TYPE.HERO_SKIN then
				var_17_1 = iter_17_3[2]
			elseif ActivitySkinDrawTools.GetIsSkinGift(iter_17_3[2]) then
				var_17_1 = ItemCfg[iter_17_3[2]].param[1][1]
			end
		end
	end
...
function var_0_0.GetSoundEffect(arg_22_0)
	return var_0_1[ActivitySkinDrawData:GetSkinId()] or var_0_1.normal
end

function var_0_0.GetOpenBoxEffect(arg_23_0)
	return var_0_2[ActivitySkinDrawData:GetSkinId()] or var_0_2.normal
end

function var_0_0.GetEnterDrawEffect(arg_24_0)
	return var_0_3[ActivitySkinDrawData:GetSkinId()]
end
...
function var_0_0.JumpToDLCSource(arg_25_0, arg_25_1)
	if arg_25_0 == var_0_4.TASK then
		...
		for iter_25_0, iter_25_1 in ipairs((var_0_0.GetPoolIdList(arg_25_1))) do
		...
		if arg_25_0 == var_0_4.SKINPOOL then
			manager.notify:Invoke(ACTIVITY_SKIN_DRAW_SELECT_POOL, var_25_0)
...
function var_0_0.GetIsSkinGift(arg_26_0)
	...
	if ItemCfg[arg_26_0] and var_26_0.type == ItemConst.ITEM_TYPE.GIFT then
		return ItemCfg[var_26_0.param[1][1]].type == ItemConst.ITEM_TYPE.HERO_SKIN
	end
end
