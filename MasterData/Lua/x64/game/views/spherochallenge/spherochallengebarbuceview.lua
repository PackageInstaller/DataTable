...
function SPHeroChallengeBarbuceView:RefreshSettleView(arg_42_1)
	...
	local var_42_2 = ActivityHeroChallengeBarbecueCfg[DormRhythmGameData:GetLevelIDByDiff(self.diff, self.activityID)].reward_list_coin[1][1]

	self.awardIcon1.sprite = ItemTools.getItemSprite(var_42_2)
	...
	if arg_42_1 then
		for iter_42_0, iter_42_1 in ipairs(arg_42_1) do
			if var_42_2 == iter_42_1.id then
				var_42_3 = iter_42_1.num
			end

			if SpHeroChallengeConst.accelerateID == iter_42_1.id then
				var_42_4 = iter_42_1.num
			end
		end
	end

	self.awardtext1.text = var_42_3
	self.awardtext2.text = var_42_4

	local var_42_5 = SPHeroChallengeData:GetBrabuceGameAwardNum()

	self.curAwardText1.text = var_42_5 == GameSetting.activity_hero_challenge_barbecue_coin_limit.value[1] and string.format("<color='#FF000B'>%d</color>", var_42_5) .. "/" .. GameSetting.activity_hero_challenge_barbecue_coin_limit.value[1] or var_42_5 .. "/" .. GameSetting.activity_hero_challenge_barbecue_coin_limit.value[1]

	local var_42_6 = GameSetting.activity_hero_challenge_barbecue_ticket_limit.value[1]
	local var_42_7 = SPHeroChallengeData:GetBarbuceAccelerateNum()

	self.curAwardText2.text = var_42_7 == GameSetting.activity_hero_challenge_barbecue_ticket_limit.value[1] and string.format("<color='#FF000B'>%d</color>", var_42_7) .. "/" .. var_42_6 or var_42_7 .. "/" .. var_42_6
end
