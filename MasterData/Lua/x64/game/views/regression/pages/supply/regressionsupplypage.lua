...
function RegressionBPTaskPage:OnCtor(arg_1_1)
	local var_1_0 = Object.Instantiate(Asset.Load("Widget/System/ReturnTwo/RT2stSuppliesPackUI"), arg_1_1)
...
function RegressionBPTaskPage:AddEventListeners()
...
function RegressionBPTaskPage:SetActive(arg_8_1)
...
function RegressionBPTaskPage:RefreshList()
	self.shopDataList_ = self:InitShopList(self.curShopId_)

	self.giftList_:StartScroll(#self.shopDataList_)
end

function RegressionBPTaskPage:InitShopList(arg_15_1)
	local var_15_0 = {}
...
function RegressionBPTaskPage:GetGoodStatus(arg_17_1, arg_17_2)
...
function RegressionBPTaskPage:RefreshShopGoodInfo(arg_18_1, arg_18_2)
...
function RegressionBPTaskPage:OnShopBuyResult(arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	if arg_19_1 == 0 then
		self:RefreshList()
	end
end
