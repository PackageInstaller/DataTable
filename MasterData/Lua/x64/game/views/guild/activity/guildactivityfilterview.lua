local GuildActivityFilterView = class("GuildActivityFilterView", ReduxView)

function GuildActivityFilterView:OnCtor(arg_1_1)
...
function GuildActivityFilterView:Init()
	self.curOrder_ = "desc"
	self.isAll_ = true
	self.curSortType_ = 0
	self.curSortRace_ = {}
...
function GuildActivityFilterView:InitDropDown()
...
function GuildActivityFilterView:InitUI()
	self:BindCfgUI()
...
function GuildActivityFilterView:AddUIListener()
...
function GuildActivityFilterView:SortListByOrder(arg_9_1)
...
function GuildActivityFilterView:SetHeroDataList(arg_10_1)
...
function GuildActivityFilterView:SortListByType(arg_11_1)
...
function GuildActivityFilterView:RefreshSort(arg_12_1, arg_12_2, arg_12_3, arg_12_4, arg_12_5)
	...
	if self.isAll_ then
		...
		for iter_12_2, iter_12_3 in ipairs(self.heroList_) do
			...
			local var_12_1 = HeroCfg[iter_12_3.id]
			local var_12_2 = false

			var_12_2 = (#self.curSortRace_ <= 0 or table.indexof(self.curSortRace_, var_12_1.race)) and true

			local var_12_3 = false

			var_12_3 = (#self.curEnergyType_ <= 0 or table.indexof(self.curEnergyType_, var_12_1.mechanism_type[1])) and true
			...
			if var_12_2 and var_12_3 and var_12_4 then
				table.insert(self.displayHeroList_, var_12_0)
			end
		end
	end
...
function GuildActivityFilterView:RefreshType()
	self.typeTxt_.text = self.isAll_ and GetTips("ALL") or GetTips("ROLE_FILTERING")
end

function GuildActivityFilterView:UpdateList()
	...
	table.sort(self.displayHeroList_, function(arg_15_0, arg_15_1)
		...
		elseif self.curSortType_ == 1 then
			local var_15_21, var_15_22 = self:FightPowerSorter(var_15_6, var_15_7)

			if var_15_21 then
				return var_15_22
			end

			local var_15_23, var_15_24 = self:StarSorter(var_15_6, var_15_7)

			if var_15_23 then
				return var_15_24
			end

			local var_15_25, var_15_26 = self:RareSorter(var_15_6, var_15_7)
...
function GuildActivityFilterView:SetListChangeHandler(arg_16_1)
	self.callback_ = arg_16_1
end

function GuildActivityFilterView:SetExtraSorter(arg_17_1)
	self.extraSorter_ = arg_17_1
end

function GuildActivityFilterView:SetIsSelfHero(arg_18_1)
	self.isSelfHero_ = arg_18_1
end

function GuildActivityFilterView:OnEnter()
	return
end

function GuildActivityFilterView:OnExit()
	return
end

function GuildActivityFilterView:EnergySorter(arg_21_1, arg_21_2)
...
function GuildActivityFilterView:FightPowerSorter(arg_22_1, arg_22_2)
...
function GuildActivityFilterView:StarSorter(arg_23_1, arg_23_2)
...
function GuildActivityFilterView:RareSorter(arg_24_1, arg_24_2)
...
function GuildActivityFilterView:LevelSorter(arg_25_1, arg_25_2)
...
function GuildActivityFilterView:Reset(arg_26_1)
...
function GuildActivityFilterView:ShowSortBtn(arg_27_1)
	SetActive(self.sortBtnGo_, arg_27_1)
end

function GuildActivityFilterView:ShowDropDown(arg_28_1)
	SetActive(self.panel_, arg_28_1)
end

function GuildActivityFilterView:Dispose()
	...
	GuildActivityFilterView.super.Dispose(self)
end
