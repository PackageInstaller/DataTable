local PolyhedronRankItem = class("PolyhedronRankItem", ReduxView)

function PolyhedronRankItem:OnCtor(arg_1_1)
...
function PolyhedronRankItem:initUI()
	self:BindCfgUI()
...
function PolyhedronRankItem:AddListeners()
...
function PolyhedronRankItem:Refresh(arg_5_1)
...
function PolyhedronRankItem:Dispose()
	self.commonPortrait_:Dispose()
	PolyhedronRankItem.super.Dispose(self)
end

return PolyhedronRankItem
