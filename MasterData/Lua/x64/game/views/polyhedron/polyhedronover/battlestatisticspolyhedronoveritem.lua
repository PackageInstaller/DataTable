local BattleStatisticsPolyhedronOverItem = class("BattleStatisticsPolyhedronOverItem", (import("game.views.battleResult.statistics.BattleStatisticsHeroItem")))

function BattleStatisticsPolyhedronOverItem:RefreshUI()
