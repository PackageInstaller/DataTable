local BattleCooperationSettlementStrategyBase = class("BattleCooperationSettlementStrategyBase")

function BattleCooperationSettlementStrategyBase:GotoSettlement(arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5)
	local var_1_0 = {}
	...
	if isSuccess(arg_1_2) then
		...
		for iter_1_1 = 1, #var_1_3 do
			if var_1_5[iter_1_1] == nil and var_1_3[iter_1_1] ~= 0 and (var_1_4[iter_1_1] == nil or var_1_4[iter_1_1] == 0) then
				HeroData:HeroClearTimesModify(var_1_3[iter_1_1], GameSetting.mastery_gain.value[1])

				local var_1_7 = HeroTools.GetHeroOntologyID(var_1_3[iter_1_1])

				if var_1_7 then
					ArchiveData:AddExp(var_1_7, GameSetting.hero_love_exp_gain.value[1] * var_1_6)
				end
			end
		end
...
function BattleCooperationSettlementStrategyBase:OnGotoSettlement(arg_2_1)
	return
end

function BattleCooperationSettlementStrategyBase:GotoCooperationResult(arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	if isSuccess(arg_3_1) then
		local var_3_0 = self:GetResultReward()
		...
		self:GotoBattleFaild(arg_3_1, arg_3_2)
	end
end

function BattleCooperationSettlementStrategyBase:GotoBattleFaild(arg_5_1, arg_5_2)
	function BattleCallLuaCallBack()
...
function BattleCooperationSettlementStrategyBase:GetResultReward()
	local var_7_0 = {}
	local var_7_1 = {}
...
return BattleCooperationSettlementStrategyBase
