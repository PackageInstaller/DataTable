local var_0_0 = {}
local BattleCooperationGotoHandler = require("game/bridge/BattleCooperationSettlementStrategy/BattleCooperationGotoHandler")

BattleCooperationGotoHandler:Init()
...
function var_0_0.GotoTeam(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	if arg_1_1.result > BattleConst.BATTLE_RESULT.UNFINISHED and arg_1_1.result <= BattleConst.BATTLE_RESULT.NOSYNC then
		...
		var_0_0.goToResult(arg_1_1.result - 1, arg_1_1.star_list, {
			...
			heroDataCollect = CollectHeroExpChange(var_1_0),
			errorCode = arg_1_2
		})
...
function var_0_0.goToResult(arg_2_0, arg_2_1, arg_2_2)
	...
	BattleCooperationGotoHandler:GotoResult(var_2_0, arg_2_0, arg_2_1, arg_2_2)
