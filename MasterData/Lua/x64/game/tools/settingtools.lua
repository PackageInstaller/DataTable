local var_0_0 = {}
local SettingConst = import("game.const.SettingConst")

function var_0_0.GetDefaultScreenSize()
	if _G.SCREEN_WIDTH / SettingConst.DESIGN_WIDTH > 1 or _G.SCREEN_HEIGHT / SettingConst.DESIGN_HEIGHT > 1 then
		local var_1_0 = math.max(_G.SCREEN_WIDTH / SettingConst.DESIGN_WIDTH, _G.SCREEN_HEIGHT / SettingConst.DESIGN_HEIGHT)

		return math.floor(_G.SCREEN_WIDTH / var_1_0), math.floor(_G.SCREEN_HEIGHT / var_1_0)
	else
...
function var_0_0.GetSettingScreenSize(arg_2_0)
	...
	if (GameToSDK.PLATFORM_ID == 0 or GameToSDK.PLATFORM_ID == 4) and SettingData:GetPicSettingData().super_resolution_enable == 0 then
		if 3000000 < var_2_0 * var_2_1 then
			local var_2_2 = math.sqrt(3000000 / (var_2_0 * var_2_1))

			var_2_1 = math.floor(var_2_1 * var_2_2)
			var_2_0 = math.floor(var_2_0 * var_2_2)
		end
	end
