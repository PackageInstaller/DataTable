...
function var_0_0:EnsureHasInputPage()
	if self.gameObject_ == nil or var_0_1 == nil then
		return
	end

	local var_1_0 = typeof(var_0_1)

	if self.gameObject_:GetComponent(var_1_0) == nil then
		return self.gameObject_:AddComponent(var_1_0)
	end
end

local function var_0_2(arg_2_0)
	if arg_2_0.gameObject_ == nil or var_0_1 == nil then
		return nil
	end

	return (arg_2_0.gameObject_:GetComponent(typeof(var_0_1)))
end
...
function GetKeyCodeMappedName(arg_5_0)
	local var_5_0 = TipsCfg.get_id_list_by_define["KEYCODE_" .. string.upper(arg_5_0)]

	if var_5_0 then
		return GetTips(var_5_0)
...
function OnGamepadDeviceAdded(arg_8_0, arg_8_1)
	...
	var_0_7 = Timer.New(function()
		...
		if manager.managerInit then
			local var_9_0 = LuaForGamepad.GetGamepadType()

			if var_9_0 == HID_TYPES.Xbox or var_9_0 == HID_TYPES.PS4 then
				if not LuaHidTools.IsKeepJoystickType() then
					var_0_0.OpenGamepadSelectWin(var_0_6[1].gamepadType)
				end
...
function var_0_0.IsKeyNotAllow(arg_12_0, arg_12_1, arg_12_2)
	...
	if var_0_3[arg_12_0] and var_0_8[var_0_3[arg_12_0] .. arg_12_1] then
		return true
	end
...
function var_0_0.ResetRemapNotice()
	...
	var_0_0.SetRemapNotice(HID_TYPES.None, (var_0_0.GetRemapNotice(HID_TYPES.None)))
end
