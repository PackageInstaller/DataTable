return {
	EnterCaptureGame = function(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
		...
		var_1_0.singleModeRoleId = ActivitySwimSkinSectionCfg[arg_1_1].mode == CaptureGameConst.CaptureGameMode.Single and ActivitySwimSkinSectionCfg[arg_1_1].scene_hero_list[1] or -1

		CaptureGameData:RegisterSectionData(arg_1_1, arg_1_2, arg_1_3)
		StartCaptureGameMode(var_1_0)
	end,
	GetActivityListByMode = function(self, arg_2_1)
		if not self.gameModeList then
			self.gameModeList = {}

			for iter_2_0, iter_2_1 in ipairs(ActivitySwimSkinSectionCfg.all) do
				self.gameModeList[ActivitySwimSkinSectionCfg[iter_2_1].mode] = self.gameModeList[ActivitySwimSkinSectionCfg[iter_2_1].mode] or {}

				table.insert(self.gameModeList[ActivitySwimSkinSectionCfg[iter_2_1].mode], ActivitySwimSkinSectionCfg[iter_2_1])
			end
		end

		return self.gameModeList[arg_2_1] or {}
	end,
	...
	GetLensPath = function(arg_4_0, arg_4_1)
		return "TextureBg/CaptureGameLens/" .. ActivitySwimSkinLensCfg[arg_4_1].imgPath
	end,
	...
	SendShareSdk = function(arg_7_0, arg_7_1, arg_7_2)
		...
		for iter_7_0, iter_7_1 in ipairs(var_7_2) do
			var_7_1[1] = var_7_0
			var_7_1[2] = iter_7_1
			var_7_1[3] = var_7_3 == #var_7_2 and "" or ","
			var_7_3 = var_7_3 + 1
			var_7_0 = table.concat(var_7_1)
		end

		local var_7_4 = ""
		local var_7_5 = CaptureGameMgr:GetCurUsingHeroPoseList()
		local var_7_6 = 1

		for iter_7_2, iter_7_3 in ipairs(var_7_5) do
			var_7_1[1] = var_7_4
			var_7_1[2] = iter_7_3
			var_7_1[3] = var_7_6 == #var_7_5 and "" or ","
			var_7_6 = var_7_6 + 1
			var_7_4 = table.concat(var_7_1)
		end
		...
		SDKTools.SendMessageToSDK("screenshot", {
			...
			posture_list = var_7_4
		})
	end,
	CaptureGameCanOpen = function(self, arg_8_1)
		if not self.cacheGameOrder then
			self.cacheGameOrder = {
			...
			for iter_8_0, iter_8_1 in ipairs(ActivitySwimSkinSectionCfg.all) do
				if self.cacheGameOrder[ActivitySwimSkinSectionCfg[iter_8_1].mode] then
					table.insert(self.cacheGameOrder[ActivitySwimSkinSectionCfg[iter_8_1].mode], iter_8_1)
				end
			end
		end

		local var_8_0 = ActivitySwimSkinSectionCfg[arg_8_1]

		if ActivitySwimSkinSectionCfg[arg_8_1] and self.cacheGameOrder[var_8_0.mode] then
			local var_8_1 = table.indexof(self.cacheGameOrder[var_8_0.mode], arg_8_1)

			if var_8_1 == 1 then
				return true
			end

			if CaptureGameData:GetReachActivityCountByMode(var_8_0.mode) >= var_8_1 - 1 then
				return true
			end
		else
			return false
