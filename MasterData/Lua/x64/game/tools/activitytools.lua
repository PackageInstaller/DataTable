...
function var_0_0.IsValidAdv(arg_3_0)
	...
	if MainAdvinfoCfg[arg_3_0].activityId and MainAdvinfoCfg[arg_3_0].activityId ~= 0 then
		...
		local var_3_6 = TimeMgr.GetInstance()
		local var_3_7 = TimeMgr.GetInstance():GetServerTime()

		return var_3_7 < var_3_6:parseTimeFromConfig(var_3_0.time[2]) and var_3_5 <= var_3_7
	end
end
