local var_0_0 = {
	GetConditionProgress = function(arg_1_0, arg_1_1)
		...
		if ConditionCfg[arg_1_0].type == 8010 then
			return DormData:GetDormSceneData((DormData:GetCurrectSceneID())).accruing_earnings, var_1_0.params[1]
		elseif var_1_0.type == 8011 then
			return DormData:GetSceneAttractiveValue((DormData:GetCurrectSceneID())), var_1_0.params[1]
		elseif var_1_0.type == 8012 then
			local var_1_1 = DormData:GetDormSceneData(var_1_0.params[1])

			if var_1_1 == nil then
				return 0, var_1_0.params[2]
			end

			return var_1_1.level, var_1_0.params[2]
