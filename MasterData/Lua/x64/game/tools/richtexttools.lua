local var_0_0 = {
	AddEventUpdateListener = function(self, arg_1_1)
		self:AddEventListUpdateListener(function(arg_2_0, arg_2_1)
			arg_1_1(arg_2_0:ToTable(), arg_2_1:ToTable())
		end)
	end
}

function var_0_0:AddAllEventClickHandler(arg_3_1, arg_3_2, arg_3_3)
	local var_3_0 = {}
	...
	if arg_3_2 == nil then
		arg_3_2 = self:GetOrAddComponent(arg_3_1.gameObject, typeof(Button))
		arg_3_2.transition = UnityEngine.UI.Selectable.Transition.None
	end

	self:AddBtnListener(arg_3_2, nil, function()
...
function var_0_0:SetMixedTextWithImage(arg_9_1)
	for iter_9_0, iter_9_1 in string.gmatch(arg_9_1, "<icon%s+name=([%w_]+)%s+sprite_path=([^%s>]+)/") do
		self:AddSprite(iter_9_0, (AtlasManager.GetSpriteWithoutAtlas(iter_9_1)))
	end
