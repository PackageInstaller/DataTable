...
function var_0_0.InitConst()
	...
	for iter_1_0, iter_1_1 in ipairs(ActivityCfg.get_id_list_by_activity_template[ActivityTemplateConst.MOON_CAKE]) do
		local var_1_0 = {}

		for iter_1_2, iter_1_3 in ipairs(ActivityCfg[iter_1_1].sub_activity_list) do
			if ActivityTools.GetActivityType(iter_1_3) == ActivityTemplateConst.MOON_CAKE_MAKE then
				var_1_0.cake_activity_id = iter_1_3
			elseif ActivityTools.GetActivityType(iter_1_3) == ActivityTemplateConst.MOON_CAKE_PARTY then
				var_1_0.party_activity_id = iter_1_3
			elseif ActivityTools.GetActivityType(iter_1_3) == ActivityTemplateConst.MOONBO then
				var_1_0.moon_bo_activity_id = iter_1_3
			end

			var_0_0.mainActivityIdDic_[iter_1_3] = iter_1_1
		end

		var_0_0.subActivityIdDic_[iter_1_1] = var_1_0
	end

	for iter_1_4, iter_1_5 in ipairs(ItemCfg.get_id_list_by_sub_type[ItemConst.ITEM_SUB_TYPE.MOON_FILLING_MATERIAL]) do
		var_0_0.materialItemIdList[ItemCfg[iter_1_5].time[2][1]] = var_0_0.materialItemIdList[ItemCfg[iter_1_5].time[2][1]] or {}

		table.insert(var_0_0.materialItemIdList[ItemCfg[iter_1_5].time[2][1]], iter_1_5)
	end

	for iter_1_6, iter_1_7 in ipairs(ItemCfg.get_id_list_by_sub_type[ItemConst.ITEM_SUB_TYPE.MOON_FILLING]) do
		var_0_0.fillingItemIdList[ItemCfg[iter_1_7].time[2][1]] = var_0_0.fillingItemIdList[ItemCfg[iter_1_7].time[2][1]] or {}

		table.insert(var_0_0.fillingItemIdList[ItemCfg[iter_1_7].time[2][1]], iter_1_7)
	end

	for iter_1_8, iter_1_9 in ipairs(ItemCfg.get_id_list_by_sub_type[ItemConst.ITEM_SUB_TYPE.MOON_CAKE]) do
		var_0_0.cakeItemIdList[ItemCfg[iter_1_9].time[2][1]] = var_0_0.cakeItemIdList[ItemCfg[iter_1_9].time[2][1]] or {}

		table.insert(var_0_0.cakeItemIdList[ItemCfg[iter_1_9].time[2][1]], iter_1_9)
	end

	for iter_1_10, iter_1_11 in ipairs(ItemCfg.get_id_list_by_sub_type[ItemConst.ITEM_SUB_TYPE.MOON_CAKE_GIFT]) do
		var_0_0.giftItemIdList[ItemCfg[iter_1_11].time[2][1]] = var_0_0.giftItemIdList[ItemCfg[iter_1_11].time[2][1]] or {}

		table.insert(var_0_0.giftItemIdList[ItemCfg[iter_1_11].time[2][1]], iter_1_11)
	end
	...
	for iter_1_12, iter_1_13 in pairs(MoonCakeCfg.get_id_list_by_activity) do
		...
		for iter_1_14, iter_1_15 in ipairs(iter_1_13) do
			var_1_1[MoonCakeCfg[iter_1_15].patties] = var_1_1[MoonCakeCfg[iter_1_15].patties] or {}
			var_1_1[MoonCakeCfg[iter_1_15].patties][MoonCakeCfg[iter_1_15].mold] = iter_1_15
			var_0_0.cakeIdDicByCakeItemID_[MoonCakeCfg[iter_1_15].moon_cakes] = iter_1_15
		end

		var_0_0.cakeRecipeDic_[iter_1_12] = var_1_1
	end
end
...
function var_0_0.GetFillingMultiTimes(arg_11_0)
	...
	for iter_11_0, iter_11_1 in ipairs(MoonCakeFillingCfg[arg_11_0].recipe) do
		var_11_2[iter_11_0] = ItemTools.getItemNum(iter_11_1[1])
	end
	...
	if var_11_3 then
		repeat
			for iter_11_2 = 1, #var_11_2 do
				if var_11_2[iter_11_2] - MoonCakeFillingCfg[arg_11_0].recipe[iter_11_2][2] < 0 then
					var_11_3 = false

					break
				else
					var_11_2[iter_11_2] = var_11_2[iter_11_2] - MoonCakeFillingCfg[arg_11_0].recipe[iter_11_2][2]
				end
			end
	...
	return var_11_4, var_11_1 > 0 and 1 or 0
end
...
function var_0_0.GetSortedFilling(arg_12_0)
	...
	table.sort(var_12_0, function(arg_13_0, arg_13_1)
		var_12_1[arg_13_0] = var_12_1[arg_13_0] or var_0_0.GetFillingMultiTimes(arg_13_0)
		var_12_1[arg_13_1] = var_12_1[arg_13_1] or var_0_0.GetFillingMultiTimes(arg_13_1)
...
function var_0_0.CanVisitNext(arg_14_0)
	...
	if var_14_0.type == MoonCakeConst.VISIT_TYPE.ALL then
	...
	if #var_14_3 > 0 and var_14_2 + 1 > #var_14_3 then
		return false
	end
...
function var_0_0.GetSortedCakeGroupList(arg_15_0)
	...
	for iter_15_0, iter_15_1 in ipairs(MoonCakeGroupCfg.get_id_list_by_activity[arg_15_0]) do
		if var_15_0[iter_15_1] then
			var_15_2[#var_15_2 + 1] = iter_15_1
		else
			local var_15_5 = true

			for iter_15_2, iter_15_3 in ipairs(MoonCakeGroupCfg[iter_15_1].collect_condition) do
	...
	table.insertto(var_15_3, var_15_4)
	table.insertto(var_15_3, var_15_2)
...
function var_0_0.CheckPartyPlanValid(arg_17_0, arg_17_1)
	...
	if arg_17_1 == MoonCakeConst.PARTY_TYPE.CAKE then
		for iter_17_0, iter_17_1 in ipairs(var_0_0.cakeItemIdList[var_0_0.GetMainActivityID(arg_17_0)]) do
			var_17_0 = var_17_0 + ItemTools.getItemNum(iter_17_1)
		end

		var_17_1 = GameSetting.activity_mid_autumn_party_consume_1.value[1]
		var_17_2 = GameSetting.activity_mid_autumn_party_consume_1.value[1] <= var_17_0
	elseif arg_17_1 == MoonCakeConst.PARTY_TYPE.VISIT then
		...
		var_17_2 = GameSetting.activity_mid_autumn_party_consume_2.value[1] <= var_17_0
	end
