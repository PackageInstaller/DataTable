return {
	GotoFightSelect = function(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
		JumpTools.OpenPageByJump("/sectionSelectHero", {
			...
			reserveParams = ReserveParams.New(ReserveConst.RESERVE_TYPE.CORE_VERIFICATION, arg_1_2, nil, {
	...
	IsOpenSuperStage = function()
		...
		return var_2_4 <= var_2_1 + 1 and var_2_5 <= var_2_3 + 1 and (var_2_6 and var_2_6.stage_type == 1 or false) and (var_2_7 and var_2_7.stage_type == 1 or false) and not var_2_0 and not var_2_2
	end,
	IsPassSuperStage = function()
		return CoreVerificationData:IsPassChallengeChallge(1) and CoreVerificationData:IsPassChallengeChallge(2)
	end
}
