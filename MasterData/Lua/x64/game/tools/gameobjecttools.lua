local var_0_0 = {
	ToggleTextInverse = function(self, arg_1_1, arg_1_2)
		local var_1_0 = self:FindCom(typeof(Text), "" .. arg_1_2, arg_1_1)
	...
	GetOrAddComponent = function(self, arg_2_1)
		local var_2_0 = self:GetComponent(arg_2_1)

		if var_2_0 ~= nil then
			return var_2_0
		else
			return self:AddComponent(arg_2_1)
		end
	end
}
local var_0_1 = 1920
...
function var_0_0:GetAdaptedLocalPosition(arg_3_1)
	local var_3_0 = Vector3(arg_3_1.x, arg_3_1.y, arg_3_1.z)
	local var_3_1 = self:GetComponent("RectTransform")
