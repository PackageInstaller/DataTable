local var_0_0 = {
	SortChipManager = function(arg_1_0)
		...
		local var_1_1 = {}
		local var_1_2 = {}
		local var_1_3 = ChipData:GetUnlockChipManagerIDList()

		for iter_1_0, iter_1_1 in pairs((ChipData:GetChipManagerList())) do
			if iter_1_0 ~= arg_1_0 then
				if table.keyof(var_1_3, iter_1_0) then
		...
		table.sort(var_1_1, function(arg_3_0, arg_3_1)
			return arg_3_0 < arg_3_1
		end)
		table.sort(var_1_2, function(arg_4_0, arg_4_1)
		...
		if arg_1_0 ~= 0 then
			table.insert(var_1_0, 1, arg_1_0)
		end

		if manager.guide:IsPlaying() then
			local var_1_4 = table.indexof(var_1_0, 6)

			if var_1_4 then
				table.remove(var_1_0, var_1_4)
				table.insert(var_1_0, 1, 6)
			end
		end
...
function var_0_0.SortChip(arg_5_0, arg_5_1)
	return var_0_0.SortChipList(ChipData:GetChipManagerList()[arg_5_1], arg_5_0, arg_5_1)
end
...
function var_0_0.SortChipList(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	local var_6_2 = {}
	local var_6_3 = {}
	local var_6_4 = arg_6_3 and ChipData:GetUnlockHeroChipIDList() or ChipData:GetUnlockChipIDList()

	for iter_6_0, iter_6_1 in pairs(arg_6_1) do
		if not table.keyof(arg_6_0, iter_6_1) then
			if table.keyof(var_6_4, iter_6_1) then
				table.insert(var_6_1, iter_6_1)
			elseif ChipCfg[iter_6_1].new_condition > 0 and (ChipCfg[iter_6_1].spec_char > 0 and IsConditionAchieved(ChipCfg[iter_6_1].new_condition, {
				heroId = ChipCfg[iter_6_1].spec_char
			}) or IsConditionAchieved(ChipCfg[iter_6_1].new_condition)) or ItemTools.getItemNum(ChipCfg[iter_6_1].cost_condition[1][1]) >= ChipCfg[iter_6_1].cost_condition[1][1] then
...
function var_0_0.GetChipCanLocked(arg_7_0)
	...
	return (IsConditionAchieved(ChipCfg[arg_7_0].new_condition))
end

function var_0_0.SortRegular(arg_8_0)
	table.sort(arg_8_0, function(arg_9_0, arg_9_1)
		if ChipCfg[arg_9_0].spec_char ~= 0 and ChipCfg[arg_9_1].spec_char == 0 then
			return false
		end
...
function var_0_0.GetChipTypeList(arg_11_0)
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_0) do
		if not table.keyof(var_11_1, ChipCfg[iter_11_1].spec_char) and ChipCfg[iter_11_1].spec_char ~= 0 then
			table.insert(var_11_1, ChipCfg[iter_11_1].spec_char)
		end
	end

	table.insertto(var_11_0, (HeroTools.SortHero(var_11_1)))
...
function var_0_0.GetChipTypeCntList(arg_12_0)
	...
	for iter_12_0, iter_12_1 in ipairs(arg_12_0) do
		var_12_0[ChipCfg[iter_12_1].spec_char] = var_12_0[ChipCfg[iter_12_1].spec_char] or {}

		table.insert(var_12_0[ChipCfg[iter_12_1].spec_char], iter_12_1)
...
function var_0_0.SortScheme(arg_13_0)
	...
	for iter_13_0, iter_13_1 in pairs((ChipData:GetSchemeList())) do
		local var_13_2 = #var_13_0 == #iter_13_1.chipList
		...
		if var_13_2 then
			var_13_1[1] = clone(iter_13_1)
		else
			table.insert(var_13_1, clone(iter_13_1))
		end
	end

	for iter_13_4 = #var_13_1 + 1, GameSetting.ai_chip_proposal_num_max.value[1] + (var_13_1[1].id == 0 and 1 or 0) do
...
function var_0_0.InternalInsertChip(arg_16_0, arg_16_1)
	...
	for iter_16_0, iter_16_1 in ipairs(arg_16_0) do
		if ChipCfg[iter_16_1].spec_char ~= 0 and table.keyof(ChipCfg.get_id_list_by_spec_char[ChipCfg[arg_16_1].spec_char], iter_16_1) and iter_16_1 ~= arg_16_1 then
			var_16_2 = true
			var_16_3 = iter_16_1
	...
	if var_16_2 then
		local var_16_4 = table.indexof(arg_16_0, var_16_3)

		if var_16_4 then
			table.remove(arg_16_0, var_16_4)
		end
	end
...
function var_0_0.GetChipManagerIcon(arg_18_0)
	if not ChipCfg[arg_18_0] then
		Debug.Log(string.format("<color=ff0000>ChipCfg has no ID(%d)</color>", arg_18_0))

		return
	end

	return getSpriteWithoutAtlas("TextureConfig/Managecat_l/" .. ChipCfg[arg_18_0].picture_id)
end

function var_0_0.GetChipManagerIconPath(arg_19_0)
	if not ChipCfg[arg_19_0] then
		Debug.Log(string.format("<color=ff0000>ChipCfg has no ID(%d)</color>", arg_19_0))

		return
	end

	return "TextureConfig/Managecat_l/" .. ChipCfg[arg_19_0].picture_id
end
...
function var_0_0.IsCharChipBaseCanUnlock(arg_24_0)
	for iter_24_0, iter_24_1 in ipairs(ChipCfg[arg_24_0].module_condition) do
...
function var_0_0.GetNextCharChipIDToUnlock(arg_29_0)
	...
	if not ChipTools.IsCharChipBaseUnlock(arg_29_0) then
		do return arg_29_0 end

		var_29_0 = ChipTools.GetCharChipExtraIDListUnlock(arg_29_0)
	end

	for iter_29_0, iter_29_1 in ipairs((ChipTools.GetCharChipExtraIDList(arg_29_0))) do
		if not table.keyof(var_29_0, iter_29_1) then
			return iter_29_1
		end
	end
...
function var_0_0.GetAllCharChipBaseIDList(arg_30_0)
	...
	for iter_30_0, iter_30_1 in pairs(ChipCfg.all) do
		if ChipCfg[iter_30_1].type_id == ChipConst.TYPE_CHAR_CHIP and ChipCfg[iter_30_1].role_type_id == ChipConst.ROLE_TYPE_CHAR_CHIP_BASE then
...
function var_0_0.SortCharChipBaseIDList(arg_31_0)
	...
	for iter_31_0, iter_31_1 in ipairs(arg_31_0) do
		local var_31_3 = var_0_0.IsCharChipBaseUnlock(iter_31_1)
		local var_31_4 = var_0_0.IsCharChipBaseCanUnlock(iter_31_1)
		local var_31_5 = 0

		if var_31_3 then
			var_31_5 = #var_0_0.GetCharChipExtraIDListUnlock(iter_31_1)
		end

		if var_31_4 and not var_31_3 then
			table.insert(var_31_0, {
				id = iter_31_1,
				sort = ChipCfg[iter_31_1].sort
			})
		elseif var_31_3 then
			...
			for iter_31_2, iter_31_3 in ipairs(ChipCfg[iter_31_1].module_condition) do
	...
	for iter_31_4, iter_31_5 in ipairs(var_31_0) do
		table.insert(var_31_7, iter_31_5.id)
	end

	for iter_31_6, iter_31_7 in ipairs(var_31_1) do
		table.insert(var_31_7, iter_31_7.id)
	end

	for iter_31_8, iter_31_9 in ipairs(var_31_2) do
		table.insert(var_31_7, iter_31_9.id)
	end
...
function var_0_0.GetCharChipIcon(arg_35_0, arg_35_1)
	if not ChipCfg[arg_35_0] then
		Debug.Log(string.format("<color=ff0000>ChipCfg has no ID(%d)</color>", arg_35_0))

		return
	end

	local var_35_0 = HeroTools.HeroUsingSkinInfo((tonumber(ChipCfg[arg_35_0].picture_id))).id

	if arg_35_1 then
		return getSpriteWithoutAtlas("TextureConfig/Character/LittleIcon/" .. var_35_0)
	end

	return getSpriteWithoutAtlas("TextureConfig/Character/Icon/" .. var_35_0)
end
...
function var_0_0.GetChipUnlockProgress()
	...
	return var_36_2 / (#var_36_0 + #var_36_1)
end
