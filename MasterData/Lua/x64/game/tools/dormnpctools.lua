local var_0_0 = {
	...
	GetNpcInfoListByConstJobType = function(arg_1_0, arg_1_1)
		...
		for iter_1_0, iter_1_1 in pairs((BackHomeNpcData:GetBackHomeNpcInfoList())) do
...
function var_0_0.CheckHasNpcWorkOnJob(arg_5_0, arg_5_1)
	for iter_5_0, iter_5_1 in ipairs((var_0_0:GetNpcInfoListByConstJobType(arg_5_1))) do
