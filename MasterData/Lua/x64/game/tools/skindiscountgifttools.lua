local var_0_0 = {
	...
	HasGiftActivityID = function()
		for iter_2_0, iter_2_1 in ipairs((SkinDiscountGiftTools.GetActivityList())) do
	...
	HasDiscountGoodsID = function(arg_3_0)
		for iter_3_0, iter_3_1 in ipairs((SkinDiscountGiftTools.GetActivityList())) do
			for iter_3_2, iter_3_3 in ipairs(ActivitySkinDiscountCfg.get_id_list_by_activity_id[iter_3_1]) do
				if ActivitySkinDiscountCfg[iter_3_3].limit_num > SkinDiscountGiftData:GetUsedTimes(iter_3_3) then
					for iter_3_4, iter_3_5 in ipairs(ActivitySkinDiscountCfg[iter_3_3].goods_id) do
	...
	IsShowMain = function(arg_4_0)
		return ActivitySkinDiscountCfg[ActivitySkinDiscountCfg.get_id_list_by_activity_id[arg_4_0][1]].entrance == 1
	end
}

function var_0_0.HasCheapGoodsList(arg_5_0)
	for iter_5_0, iter_5_1 in ipairs((SkinDiscountGiftData:GetGoodsIDList())) do
...
function var_0_0.HasCheapGoods(arg_6_0, arg_6_1)
	local var_6_0 = SkinCfg[var_0_0.GetItemIDByGoodsID(arg_6_1)].hero
	local var_6_1 = ShopTools.GetPrice(arg_6_1)

	for iter_6_0, iter_6_1 in ipairs(ActivitySkinDiscountCfg[arg_6_0].goods_id) do
		if not var_0_0.HasSkin(iter_6_1[1]) then
			local var_6_2 = var_0_0.GetItemIDByGoodsID(iter_6_1[1])

			if var_6_1 < ShopTools.GetPrice(iter_6_1[1]) then
				return true
			end
		end
	end
...
function var_0_0.GetDiscountActivityID(arg_7_0)
	for iter_7_0, iter_7_1 in ipairs((SkinDiscountGiftTools.GetActivityList())) do
		for iter_7_2, iter_7_3 in ipairs(ActivitySkinDiscountCfg.get_id_list_by_activity_id[iter_7_1]) do
			if ActivitySkinDiscountCfg[iter_7_3].limit_num > SkinDiscountGiftData:GetUsedTimes(iter_7_3) then
				for iter_7_4, iter_7_5 in ipairs(ActivitySkinDiscountCfg[iter_7_3].goods_id) do
...
function var_0_0.HasAllGoodsSkin(arg_12_0)
	for iter_12_0, iter_12_1 in ipairs(ActivitySkinDiscountCfg[arg_12_0].goods_id) do
...
function var_0_0.GetGoodsList(arg_13_0, arg_13_1)
	...
	for iter_13_0, iter_13_1 in ipairs(ActivitySkinDiscountCfg[arg_13_0].goods_id) do
		local var_13_5 = iter_13_1[1]
		local var_13_6 = iter_13_1[2]

		if var_0_0.HasSkin(iter_13_1[1]) then
	...
	for iter_13_2, iter_13_3 in ipairs(var_13_0) do
		table.insert(var_13_9, ActivitySkinDiscountCfg[arg_13_0].goods_id[iter_13_3])
	end
...
function var_0_0.HasSkin(arg_16_0)
	local var_16_0 = RechargeShopDescriptionCfg[getShopCfg(arg_16_0).description].param[1]

	if ShopTools.HaveSkin(var_16_0) or HeroTools.CanChangeSkin(var_16_0) then
		return true
	end
...
function var_0_0.GetItemIDByGoodsID(arg_18_0)
	...
	if var_18_0.shop_refresh == 3 then
		return RechargeShopDescriptionCfg[var_18_0.description].param[1]
	else
...
function var_0_0.IsSelectSkinGoodsID(arg_19_0)
	for iter_19_0, iter_19_1 in ipairs((SkinDiscountGiftData:GetGoodsIDList())) do
...
function var_0_0.IsSelectSceneGoodsID(arg_20_0)
	for iter_20_0, iter_20_1 in ipairs((SkinDiscountGiftData:GetGoodsIDList())) do
...
function var_0_0.GetTotalDiscountPrice(arg_23_0)
	...
	for iter_23_0 = 1, 2 do
		if var_23_0[iter_23_0] then
			local var_23_2, var_23_3 = ShopTools.GetPrice(var_23_0[iter_23_0].skinGoodsID)

			var_23_1 = var_23_1 + math.floor(var_23_2 * arg_23_0)

			if var_23_0[iter_23_0].isSelectSceneID and var_23_0[iter_23_0].sceneGoodsID then
				local var_23_4, var_23_5 = ShopTools.GetPrice(var_23_0[iter_23_0].sceneGoodsID)

				var_23_1 = var_23_1 + math.floor(var_23_4 * arg_23_0)
			end
		end
	end
...
function var_0_0.GetReturePrice()
	...
	for iter_24_0, iter_24_1 in ipairs((SkinDiscountGiftData:GetGoodsIDList())) do
		local var_24_1 = getShopCfg(iter_24_1.skinGoodsID)

		if not SkinDiscountGiftTools.HasSkin(iter_24_1.skinGoodsID) and var_24_1.give_back_list and #var_24_1.give_back_list > 0 then
			var_24_0 = var_24_0 + var_24_1.give_back_list[1].num
		end
	end
