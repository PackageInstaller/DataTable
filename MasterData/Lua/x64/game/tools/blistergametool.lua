local var_0_0 = {
	...
	GetSubActiveID = function(arg_2_0)
		return (ActivityCfg[arg_2_0] or nil) and (ActivityCfg[arg_2_0].sub_activity_list or nil)
	end,
...
function var_0_0.GetSessionIsLock(arg_5_0, arg_5_1)
	if arg_5_0 == ActivityConst.ACTIVITY_3_4_BLISTER_GAME or arg_5_0 == ActivityConst.SUMMER_CHESS_BOARD_BUBBLE then
		if ActivitySummerChessConditionCfg.get_id_list_by_activity_id[arg_5_0] then
			return var_0_0.GetSessionIsLockByID(arg_5_0, ActivitySummerChessConditionCfg.get_id_list_by_activity_id[arg_5_0][arg_5_1])
		end
	else
...
function var_0_0.GetSessionIsLockByID(arg_6_0, arg_6_1)
	if arg_6_0 == ActivityConst.ACTIVITY_3_4_BLISTER_GAME then
		return not IsConditionAchieved((ActivitySummerChessConditionCfg[arg_6_1] or nil) and (ActivitySummerChessConditionCfg[arg_6_1].condition or 0))
	else
		return false
	end
end
...
function var_0_0.GetSession(arg_7_0, arg_7_1)
	if arg_7_0 == ActivityConst.ACTIVITY_3_4_BLISTER_GAME or arg_7_0 == ActivityConst.SUMMER_CHESS_BOARD_BUBBLE then
		if ActivitySummerChessConditionCfg.get_id_list_by_activity_id[arg_7_0] then
			return ActivitySummerChessConditionCfg.get_id_list_by_activity_id[arg_7_0][arg_7_1]
		end
