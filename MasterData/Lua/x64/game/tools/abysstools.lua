...
function var_0_0.GetTeamIndex(arg_3_0, arg_3_1)
	...
	if var_3_1[1] == 3 then
		local var_3_2 = ReserveTools.GetReserveTemplateByReserveType(ReserveConst.RESERVE_TYPE.ABYSS):GetContDataTemplateById(var_3_1[2]):GetTeamCount()

		if var_0_0.GetLayerBossTeamCacheFlag(arg_3_0, arg_3_1) then
			var_3_0 = var_3_2
		else
			var_3_0 = var_3_2 + 1
