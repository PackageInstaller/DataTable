...
function var_0_0.DecodeFogInfo(arg_1_0)
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_0) do
		...
		for iter_1_2 = var_0_4 - 1, 0, -1 do
			table.insert(var_1_0, var_0_2.band(var_0_2.rshift(var_1_1, iter_1_2), var_0_5) == 1)
		end
	end
...
function var_0_0.GetGuiderAssetPath(arg_2_0)
	if WarchessLevelCfg[arg_2_0] then
		for iter_2_0 = 1, #WarchessLevelCfg[arg_2_0].extra_gameplay do
			if WarchessLevelCfg[arg_2_0].extra_gameplay[iter_2_0] == var_0_6.GUIDER_1094 then
