...
function var_0_0.GetHeroLvSchedule(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_0) do
		if iter_3_1 > 0 then
			var_3_0 = var_3_0 + var_0_0.GetHeroLv(iter_3_1)
		end
	end

	return var_3_0 / (var_0_0.GetHeroLvCfg(arg_3_1).lv * 3) * 0.4
end
...
function var_0_0.GetWeaponLvSchedule(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_0) do
		if iter_5_1 > 0 then
			var_5_0 = var_5_0 + var_0_0.GetWeaponServantLv(iter_5_1)
		end
	end

	return var_5_0 / (var_0_0.GetHeroLvCfg(arg_5_1).weaponservant * 3) * 0.3
end

function var_0_0.GetSkillLv(arg_6_0)
	local var_6_0 = 0

	for iter_6_0, iter_6_1 in ipairs(HeroData:GetHeroData(arg_6_0).skill) do
		if iter_6_0 <= 5 then
			var_6_0 = var_6_0 + iter_6_1.skill_level + HeroTools.GetSkillAttrLv(arg_6_0, (SkillTools.GetSkillIdIndex(iter_6_1.skill_id)))
		end
	end
...
function var_0_0.GetSkillLvSchedule(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_0) do
		if iter_7_1 > 0 then
			var_7_0 = var_7_0 + var_0_0.GetSkillLv(iter_7_1)
		end
	end

	return var_7_0 / (var_0_0.GetHeroLvCfg(arg_7_1).skill * 5 * 3) * 0.3
end

function var_0_0.GetEquipLv(arg_8_0)
	local var_8_0 = 0

	for iter_8_0, iter_8_1 in ipairs(HeroData:GetHeroData(arg_8_0).equip) do
...
function var_0_0.GetEquipStrengthSchedule(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in ipairs(arg_9_0) do
		if iter_9_1 > 0 then
			var_9_0 = var_9_0 + var_0_0.GetEquipLv(iter_9_1)
		end
	end

	return var_9_0 / (var_0_0.GetHeroLvCfg(arg_9_1).equip * 6 * 3) * 0.4
end

function var_0_0.GetEquipRebuild(arg_10_0)
	local var_10_0 = 0

	for iter_10_0, iter_10_1 in ipairs(HeroData:GetHeroData(arg_10_0).equip) do
		if iter_10_1.equip_id > 0 then
			local var_10_1 = EquipData:GetEquipData(iter_10_1.equip_id)

			var_10_0 = var_10_1.race == 0 and var_10_0 + 0 or table.keyof(RaceEffectCfg.all, var_10_1.race) == nil and var_10_0 + 5 or var_10_0 + 1
		end
	end
...
function var_0_0.GetEquipEnchant(arg_12_0)
	...
	for iter_12_0, iter_12_1 in ipairs(var_12_1.equip) do
		if iter_12_1.equip_id > 0 then
			var_12_0 = var_12_0 + var_0_0.GetEnchantLv(EquipData:GetEquipData(iter_12_1.equip_id).enchant, arg_12_0)
		end
	end

	local var_12_2, var_12_3, var_12_4 = EquipTools.CountHeroTotalSkill(EquipTools.GetEquipDataList(var_12_1.equip), var_12_1, true)
	local var_12_5 = 0

	for iter_12_2, iter_12_3 in pairs(var_12_2) do
		if iter_12_3 > EquipSkillCfg[iter_12_2].lvmax then
			var_12_5 = var_12_5 + var_0_0.GetEnchantCoefficient(iter_12_2, arg_12_0) * (iter_12_3 - EquipSkillCfg[iter_12_2].lvmax)
		end
	end

	return var_12_0 - var_12_5
end
...
function var_0_0.GetEnchantCoefficient(arg_14_0, arg_14_1)
	if HeroCfg[arg_14_1].recommend_equip_skill then
		for iter_14_0, iter_14_1 in ipairs(HeroCfg[arg_14_1].recommend_equip_skill) do
...
function var_0_0.GetTransitionLv(arg_17_0)
	...
	for iter_17_0, iter_17_1 in ipairs((HeroData:GetHeroTransitionInfoList(arg_17_0))) do
