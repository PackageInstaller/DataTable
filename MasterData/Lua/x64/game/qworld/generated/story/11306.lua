...
function var_0_0:DialogueNode_2()
	self:ShowTalkView()
	self:SetTalkContent(11306001, "", 9073)
...
function var_0_0:DialogueNode_3()
	self:ShowTalkView()
	self:SetTalkContent(11306002, "", 9073)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_4()
	...
	self:ShowTalkView()
	self:SetTalkContent(11306003, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_5()
	self:ShowTalkView()
	self:SetTalkContent(11306004, "", 9073)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_6()
	self:ShowTalkView()
	self:SetTalkContent(11306005, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
