...
local var_0_0 = class("919901", BaseStoryGraph)
...
function var_0_0:ConfigPath()
	return "QWWorld/StoryGraph/919901"
end
...
function var_0_0:DialogueNode_1()
	self:ShowTalkView()
	self:SetTalkContent(919901001, "", 0)
...
function var_0_0:DialogueNode_2()
	self:ShowTalkView()
	self:SetTalkContent(919901002, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_3()
	self:ShowTalkView()
	self:SetTalkContent(919901003, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
