...
function var_0_0:DialogueNode_2()
	...
	self:ShowTalkView()
	self:SetTalkContent(11121001, "", 0)
...
function var_0_0:DialogueNode_3()
	...
	self:ShowTalkView()
	self:SetTalkContent(11121002, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_4()
	...
	self:ShowTalkView()
	self:SetTalkContent(11121003, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_5()
	...
	self:ShowTalkView()
	self:SetTalkContent(11121004, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_6()
	...
	self:ShowTalkView()
	self:SetTalkContent(11121005, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_7()
	self:ShowTalkView()
	self:SetTalkContent(11121006, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_8()
	...
	self:ShowTalkView()
	self:SetTalkContent(11121007, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_9()
	self:PlayActorAnimationAction(9073, "think_end", 0.05, 1.666667, function()
		return
	end)
	self:ShowTalkView()
	self:SetTalkContent(11121008, "", 0)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
