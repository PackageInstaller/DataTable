...
local var_0_0 = class("11304", BaseStoryGraph)
...
function var_0_0:ConfigPath()
	return "QWWorld/StoryGraph/11304"
end
...
function var_0_0:BlackFadeDialogueNode_1()
	...
	self:OnBlackFade(false, 0, 0.5, 0.5, 1, function()
		...
		self:PlayActorAnimationAction(9073, "chair1_sit_stand", 0.05, 2, function()
			return
		end)
...
function var_0_0:DialogueNode_3()
	...
	self:ShowTalkView()
	self:SetTalkContent(11304002, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_4()
	self:ShowTalkView()
	self:SetTalkContent(11304003, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:BlackFadeDialogueNode_5()
	...
	self:OnBlackFade(false, 0, 0.2, 0.5, 0.5, function()
		...
		self:LookAtRoleAction(true, 9073, "9516")
		self:SetLookAtParamsAction(9516, 0.6, 0.8, 1)
		self:LookAtRoleAction(true, 9516, "9073")
...
function var_0_0:DialogueNode_6()
	...
	self:ShowTalkView()
	self:SetTalkContent(11304004, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
