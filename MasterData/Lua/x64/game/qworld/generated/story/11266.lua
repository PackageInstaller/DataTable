...
local var_0_0 = class("11266", BaseStoryGraph)
...
function var_0_0:ConfigPath()
	return "QWWorld/StoryGraph/11266"
end
...
function var_0_0:DialogueNode_2()
	...
	self:ShowTalkView()
	self:SetTalkContent(11166001, "", 9073)
...
function var_0_0:DialogueNode_3()
	self:ShowTalkView()
	self:SetTalkContent(11166002, "", 9520)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_4()
	...
	self:ShowTalkView()
	self:SetTalkContent(11166003, "", 9073)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_5()
	self:ShowTalkView()
	self:SetTalkContent(11166004, "", 9520)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
