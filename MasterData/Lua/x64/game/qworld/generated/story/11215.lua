...
function var_0_0:DialogueNode_2()
	...
	self:ShowTalkView()
	self:SetTalkContent(11115001, "", 9073)
...
function var_0_0:DialogueNode_3()
	...
	self:ShowTalkView()
	self:SetTalkContent(11115002, "", 9518)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_4()
	...
	self:ShowTalkView()
	self:SetTalkContent(11115003, "", 9518)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_5()
	...
	self:ShowTalkView()
	self:SetTalkContent(11115004, "", 9073)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_6()
	self:ShowTalkView()
	self:SetTalkContent(11115005, "", 9518)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_7()
	...
	self:ShowTalkView()
	self:SetTalkContent(11115006, "", 9518)
	self:SetNeedSkip(true, {
		Invoke = function()
			self:Skip("End")
		end
