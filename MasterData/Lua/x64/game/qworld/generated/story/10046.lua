...
function var_0_0:DialogueNode_1()
	self:ShowTalkView()
	self:SetTalkContent(10046001, "", 0)
...
function var_0_0:DialogueNode_2()
	self:ShowTalkView()
	self:SetTalkContent(10046002, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_3()
	self:ShowTalkView()
	self:SetTalkContent(10046003, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_4()
	self:ShowTalkView()
	self:SetTalkContent(10046004, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_5()
	self:ShowTalkView()
	self:SetTalkContent(10046005, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_6()
	self:ShowTalkView()
	self:SetTalkContent(10046006, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_7()
	self:ShowTalkView()
	self:SetTalkContent(10046007, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
...
function var_0_0:DialogueNode_8()
	self:ShowTalkView()
	self:SetTalkContent(10046008, "", 0)
	self:SetNeedSkip(false, {
		Invoke = function()
			self:Skip("End")
		end
