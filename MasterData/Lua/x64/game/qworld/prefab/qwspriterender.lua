return QWorldPrefab.New("QWSpriteRender", function(arg_1_0, arg_1_1)
	...
	local var_1_2 = Asset.Instantiate(string.isNullOrEmpty(var_1_1.spritePath) and "QWWorld/Game/Props_lattice_wall_1" or var_1_1.spritePath)

	var_1_2.transform.parent = var_1_0:GetTransform()
	var_1_2.transform.localPosition = Vector3.zero
	var_1_2.transform.localRotation = Quaternion.identity
	var_1_2:GetComponent("SpriteRenderer").size = var_1_1.size
