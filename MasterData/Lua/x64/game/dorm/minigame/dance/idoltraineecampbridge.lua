...
local function var_0_4(arg_4_0)
	...
	return nullable(Dorm.storage:PickData("idol.camp.pos." .. arg_4_0.spawnAt), "transform")
end
...
function var_0_0:Enter(arg_5_1, arg_5_2)
	...
	self.listener:Register(IDOL_TRAINEE_TRAIN_HERO_PROPERTY_CALLBACK, var_0_0.OnTrainingStart)
	self.listener:Register(DORM_REGENERATE_HERO, var_0_0.RefreshCharacterAtPos)
...
function var_0_0.RefreshCharacterAtPos(arg_8_0)
	...
	for iter_8_2, iter_8_3 in pairs((IdolTraineeData:GetHeroPosList())) do
		if arg_8_0 or var_0_0.GetCharacterHeroID(var_0_0.charaAtPos[iter_8_2]) ~= iter_8_3 then
			var_0_0.SetPosOfCharacter(var_0_0.GenCharacter(iter_8_3, iter_8_2), iter_8_2)
		end
...
function var_0_0.UpdateCharacterPosInfo(arg_12_0, arg_12_1)
	var_0_5(DormUtils.GetEntityData(arg_12_0), arg_12_1)
end
...
function var_0_0.RemoveEntity(arg_14_0)
	if var_0_0.entityManager then
		local var_14_0 = var_0_0.entityManager:Find(arg_14_0)

		if var_14_0 then
			var_0_0.entityManager:Remove(var_14_0)
		end
	end
end
...
local function var_0_7(arg_17_0)
	...
	if DormConst.PUBLIC_DORM_ID then
		for iter_17_0, iter_17_1 in ipairs(DormData:GetDormSceneData(DormConst.PUBLIC_DORM_ID).archiveIDList) do
			if iter_17_1 == arg_17_0.archives_id then
				return DormEnum.DormHeroState.InPublicDorm
			end
		end

		if DormRoomTools:GetDormIDViaArchive(arg_17_0.archives_id) then
...
function var_0_0.RemoveEntityTemp(arg_19_0)
	if arg_19_0 then
		var_0_8(DormData:GetHeroTemplateInfo((var_0_0.GetCharacterHeroID(arg_19_0))), nil, true)
	end
...
function var_0_0.SetPosOfCharacter(arg_21_0, arg_21_1, arg_21_2)
	if var_0_0.charaAtPos[arg_21_1] then
		var_0_0.entityManager:Remove(var_0_0.GetCharacterArchiveID(var_0_0.charaAtPos[arg_21_1]))
		var_0_8(DormData:GetHeroTemplateInfo((var_0_0.GetCharacterHeroID(var_0_0.charaAtPos[arg_21_1]))), nil, arg_21_2)
	end
	...
	var_0_0.SetPosOfHero(var_0_0.GetCharacterHeroID(arg_21_0), arg_21_1, arg_21_2)
end
...
function var_0_0.SetHeroStateNil(arg_23_0)
	var_0_8(DormData:GetHeroTemplateInfo(arg_23_0), nil, false)
end
...
function var_0_0.SetTrainingCharacter(arg_26_0)
	if var_0_0.trainerEntityManager then
		return var_0_0.trainerEntityManager:Update(1, {
			...
			spawnAt = "training",
			heroID = arg_26_0,
			archiveID = DormData:GetHeroArchiveID(arg_26_0)
		})
	end
end
...
function var_0_0.SetCompetitionCharacter(arg_28_0, arg_28_1)
	if var_0_0.competitionEntityManager then
		return var_0_0.competitionEntityManager:Update(arg_28_1, {
			complex = true,
			heroID = arg_28_0,
			archiveID = DormData:GetHeroArchiveID(arg_28_0),
			pos = arg_28_1,
...
function var_0_0.SetVCamActive(arg_30_0, arg_30_1)
	SetActive(var_0_0.camera[arg_30_0], arg_30_1)
end
...
local function var_0_9(arg_32_0, arg_32_1)
	...
	local var_32_1 = nullable(IdolTrainingActionCfg, DormHeroTools:GetCurSkinID(arg_32_0), var_32_0)

	if var_32_1 == nil or #var_32_1 < 1 then
		var_32_1 = nullable(GameDisplayCfg, "dorm_idol_train_prefab_" .. var_32_0, "value")
	end

	return var_32_1[math.random(#var_32_1)]
end
...
function var_0_0.OnTrainingStart(arg_33_0, arg_33_1)
	...
	Dorm.LuaBridge.MiniGameBridge.PlayStory(var_0_9(arg_33_0, arg_33_1), {
		arg_33_0
	}, {
		var_0_2(arg_33_0)
	}, false)
