...
local function var_0_9(arg_3_0, arg_3_1, arg_3_2)
	...
	return (var_3_0 or nil) and (var_3_0.passThroughConnect or false)
end
...
local function var_0_11(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5)
	if arg_5_5 == nil then
		...
		local var_5_1 = arg_5_1 + var_0_6[arg_5_5].x
		local var_5_2 = arg_5_2 + var_0_6[arg_5_5].y

		if arg_5_1 + var_0_6[arg_5_5].x == arg_5_3 and var_5_2 == arg_5_4 then
			return true
		end
...
local function var_0_14(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6, arg_9_7)
	...
	local var_9_1 = arg_9_1 + var_0_6[arg_9_6].x
	local var_9_2 = arg_9_2 + var_0_6[arg_9_6].y
	...
	while var_0_9(arg_9_0, var_9_1, var_9_2) do
		...
		var_9_2 = var_9_2 + var_9_0.y
		var_9_1 = var_9_1 + var_9_0.x
	end
