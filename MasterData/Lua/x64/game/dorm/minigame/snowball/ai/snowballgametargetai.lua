...
function var_0_0:AddEntityToRow(arg_4_1, arg_4_2)
	self:Remove(arg_4_1)

	local var_4_0 = DormUtils.GetEntityData(arg_4_1)

	table.insert(self.row[arg_4_2], {
		move = false,
		eid = arg_4_1,
		dir = var_0_1.stop,
		isHumanoidTarget = var_4_0.isHumanoidTarget,
		unitType = var_4_0.cfgID,
		timer = var_0_2(var_4_0.cfgID)
	})
	table.sort(self.row[arg_4_2], function(arg_5_0, arg_5_1)
		return var_0_4(arg_5_0.eid).x < var_0_4(arg_5_1.eid).x
	end)
end

function var_0_0:Remove(arg_6_1)
	for iter_6_0, iter_6_1 in pairs(self.row) do
...
local function var_0_9(arg_10_0, arg_10_1)
	return Vector3.Distance(Vector3(arg_10_0.x, 0, arg_10_0.z), (Vector3(arg_10_1.x, 0, arg_10_1.z))) <= 1
end

local function var_0_10(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	local var_11_0 = arg_11_3.dir
	local var_11_1 = var_0_4(arg_11_0)
	local var_11_2 = var_0_4(arg_11_1)
	local var_11_3 = arg_11_2.move and arg_11_2.dir * var_0_5(arg_11_0) or 0
	local var_11_4 = arg_11_3.move and var_11_0 * var_0_5(arg_11_1) or 0
	...
	return var_0_9(var_11_1, var_11_2) and var_11_4 < var_11_3
end
...
local function var_0_12(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4)
	...
	local var_13_3 = var_0_4(arg_13_1.eid)
	local var_13_4 = arg_13_1.dir

	if arg_13_1.dir == var_0_1.stop then
		if math.random() < 0.5 then
			arg_13_1.dir = var_0_1.l or var_0_1.r
		end
	end
	...
	if arg_13_2[arg_13_0 - 1] and var_0_7(arg_13_1.dir) and var_0_10(var_13_2, var_13_5.eid, arg_13_1, var_13_5) then
		var_13_0 = false
		var_13_6 = true
	end

	if arg_13_2[arg_13_0 + 1] and var_0_8(arg_13_1.dir) and var_0_10(var_13_2, arg_13_2[arg_13_0 + 1].eid, arg_13_1, arg_13_2[arg_13_0 + 1]) then
		var_13_1 = false
		var_13_6 = true
	end
...
local function var_0_14(arg_15_0, arg_15_1)
	Dorm.LuaBridge.MiniGameBridge.SetMoveControllerInput(arg_15_0.eid, (Vector2(arg_15_0.dir, 0)))

	if arg_15_0.dirChanged and arg_15_0.dir ~= var_0_1.stop then
		Dorm.DormEntityManager.ChangeEntityAnimeScheme(arg_15_0.eid, var_0_13(arg_15_0.dir))
		Dorm.DormEntityManager.TryTriggerResetAnimeDuringMove(arg_15_0.eid)
	end
end
...
function var_0_0:ShouldStop(arg_17_1)
	local var_17_0 = self.pause or arg_17_1.move and self.pauseNonHumanoid and not arg_17_1.isHumanoidTarget or true
