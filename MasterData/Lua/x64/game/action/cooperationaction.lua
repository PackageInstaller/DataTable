...
manager.net:Bind(54201, function(arg_3_0)
	...
	elseif arg_3_0.room_info == nil or var_0_1 == arg_3_0.room_info.room_id then
		if var_3_0 ~= nil then
			CooperationData:ClearRoomData()
			CooperationTools.GotoCooperationEntry(var_3_0.type, var_3_0.dest, var_3_0.activity_id)
		else
			CooperationData:ClearRoomData()
		end
	else
...
manager.net:Bind(37099, function(arg_5_0)
	...
	CooperationTools.GotoCooperationEntry(var_5_1, var_5_0.dest, var_5_0.activity_id)
...
function var_0_0.CreateRoom(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	manager.net:SendWithLoadingNew(37010, {
		...
		activity_id = arg_6_3
	}, 37011, var_0_0.OnCreateRoomBack)
end

function var_0_0:OnCreateRoomBack(arg_7_1)
...
function var_0_0.JoinRoom(arg_8_0, arg_8_1, arg_8_2)
	...
	manager.net:SendWithLoadingNew(37012, {
		...
		battle_vs = LuaForUtil.GetBattleVersion(),
		source = arg_8_2
	}, 37013, var_0_0.OnJoinRoomBack)
end

function var_0_0:OnJoinRoomBack(arg_9_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0.StartMatching(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	if not CooperationData:GetIsMatching() then
		manager.net:SendWithLoadingNew(37036, {
			...
			battle_vs = LuaForUtil.GetBattleVersion()
		}, 37037, var_0_0.OnStartMatchingBack)
	end
end

function var_0_0:OnStartMatchingBack()
	if isSuccess(self.result) then
...
function var_0_0:OnCancelMatchingBack()
	if isSuccess(self.result) then
		CooperationData:SetIsMatching(false)
		manager.notify:CallUpdateFunc(COOPERATION_IS_MATCHING_CHANGE)
...
function var_0_0.ChangeHero(arg_14_0)
	manager.net:SendWithLoadingNew(37016, {
		hero_list = arg_14_0
	}, 37017, var_0_0.OnChangeHeroBack)
end

function var_0_0:OnChangeHeroBack(arg_15_1)
	if isSuccess(self.result) then
...
function var_0_0:OnLeaveRoomBack(arg_17_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnKickOutRoomBack(arg_21_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnChangeRoomMasterBack(arg_23_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnGetReadyBack(arg_25_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnCancelReadyBack(arg_27_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0.ChangeRoomAvailable(arg_28_0)
	manager.net:SendWithLoadingNew(37028, {
		available = arg_28_0
	}, 37029, var_0_0.OnRoomAvailableBack)
end

function var_0_0:OnRoomAvailableBack(arg_29_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnThumbsUpBack(arg_35_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0:OnCooperationReportBack()
	if isSuccess(self.result) then
		-- block empty
	end
end
...
function var_0_0:OnInvitePlayerBack(arg_41_1)
	if isSuccess(self.result) then
...
function var_0_0:OnDelectInviteBack(arg_43_1)
	if isSuccess(self.result) then
...
function var_0_0:OnClearInviteBack()
	if isSuccess(self.result) then
		CooperationData:ClearInvite()
		manager.notify:CallUpdateFunc(COOPERATION_INVIT_CLEAR)
	else
...
function var_0_0:OnReceiveInviteBack(arg_47_1)
	if isSuccess(self.result) then
		local var_47_0 = CooperationData:GetInvite(arg_47_1.uid)

		if var_47_0 then
			if var_47_0:IsOverdue() then
				ShowTips("COOPERATION_INVITE_OVERDUE")
			elseif var_47_0.activity_id ~= 0 and not ActivityTools.GetActivityIsOpenWithTip(var_47_0.activity_id, true) then
				-- block empty
			else
				local var_47_1 = {}

				var_47_1[1] = CooperationData:GetCooperationHero(var_47_0.battle_type, var_47_0.dest, var_47_0.activity_id)

				var_0_0.JoinRoom(var_47_0.room_id, var_47_1, CooperationConst.JOIN_ROOM_SOURCE.INVET)
			end
		end

		CooperationData:DelectInvite(arg_47_1.uid)
		manager.notify:CallUpdateFunc(COOPERATION_INVIT_CLEAR)
	else
		ShowTips(self.result)
		CooperationData:DelectInvite(arg_47_1.uid)
...
function var_0_0:SetInviteRestrictByList()
	local var_49_0 = deepClone(self)

	table.remove(var_49_0, #self)

	if #self == 1 then
		manager.net:SendWithLoadingNew(37114, {
			type = #self,
			op = self[#self] == 1 and 2 or 1
		}, 37115, var_0_0.OnSetInvitRestrictBack)
	else
		local var_49_1 = {
			type = #self
		...
		var_49_1.op = self[#self] == 1 and 2 or 1

		manager.net:SendWithLoadingNew(37114, var_49_1, 37115, function(arg_50_0, arg_50_1)
			if isSuccess(arg_50_0.result) then
				CooperationData:SetInviteRestrict(arg_50_1.type, arg_50_1.op)
				manager.notify:CallUpdateFunc(COOPERATION_INVIT_RESTRICT_UPDATE)
				var_0_0.SetInviteRestrictByList(var_49_0)
			else
...
function var_0_0:OnSetInvitRestrictBack(arg_51_1)
	if isSuccess(self.result) then
		CooperationData:SetInviteRestrict(arg_51_1.type, arg_51_1.op)
		manager.notify:CallUpdateFunc(COOPERATION_INVIT_RESTRICT_UPDATE)
	else
		ShowTips(self.result)
	end
...
function var_0_0:OnQueryRecentVisitBack()
	if isSuccess(self.result) then
		CooperationData:InitVisiteList(self)
...
function var_0_0.RequestInviteList(arg_54_0)
	manager.net:SendWithLoadingNew(37118, {
		type = arg_54_0
	}, 37119, var_0_0.OnRequestInviteListCallback)
end

function var_0_0:OnRequestInviteListCallback(arg_55_1)
	if isSuccess(self.result) then
		local var_55_0 = {}

		for iter_55_0, iter_55_1 in ipairs(self.invite_list) do
			var_55_0[iter_55_1.type] = {}

			for iter_55_2, iter_55_3 in ipairs(iter_55_1.player_list) do
				local var_55_1 = {
					uid = iter_55_3.uid,
					nick = iter_55_3.user_base_info.nick,
					icon = iter_55_3.user_base_info.icon,
					icon_frame = iter_55_3.user_base_info.icon_frame,
					level = iter_55_3.level,
					timestamp = iter_55_3.timestamp,
					activity_data_list = {}
				}

				for iter_55_4, iter_55_5 in ipairs(iter_55_3.activity_data_list) do
					table.insert(var_55_1.activity_data_list, {
						enum = iter_55_5.enum,
						data = iter_55_5.data
					})
				end

				table.insert(var_55_0[iter_55_1.type], var_55_1)
			end
		end

		manager.notify:CallUpdateFunc(COOPERATION_INVITE_LIST_UPDATE, var_55_0)
	else
		ShowTips(GetTips(self.result))
	end
end

function var_0_0.CheckCooperationApplyLimit(arg_56_0)
