...
function var_0_0.Init(arg_6_0)
	...
	if #var_6_0 > 0 then
		...
		for iter_6_0, iter_6_1 in ipairs(var_6_0) do
			...
			if ActivityPointRewardCfg.get_id_list_by_activity_id[iter_6_1] ~= nil then
				for iter_6_2, iter_6_3 in ipairs(ActivityPointRewardCfg.get_id_list_by_activity_id[iter_6_1]) do
					PaperCutCfg[ActivityPointRewardCfg[iter_6_3].activity_id].task_id = iter_6_3
				end
			end
		...
		local var_6_3 = string.format("%s_%s_Select", RedPointConst.PAPER_CUT, arg_6_0)
		local var_6_4 = string.format("%s_%s_Reward", RedPointConst.PAPER_CUT, arg_6_0)

		manager.redPoint:addGroup(var_6_3, var_6_1)
		manager.redPoint:addGroup(var_6_4, var_6_2)
