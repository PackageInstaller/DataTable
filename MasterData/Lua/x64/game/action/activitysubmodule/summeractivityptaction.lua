...
function var_0_0.UpdateRedPoint(arg_3_0)
	if not ActivityData:GetActivityData(arg_3_0):IsActivitying() then
		manager.redPoint:setTip(RedPointConst.SUMMER_ACTIVITY_PT_OPEN .. "_" .. arg_3_0, 0)
	...
	if var_3_0 ~= nil and manager.time:GetServerTime() >= var_3_0.startTime and manager.time:GetServerTime() <= var_3_0.stopTime then
		if not getData("activity_pt_" .. arg_3_0, "opened") then
			manager.redPoint:setTip(RedPointConst.SUMMER_ACTIVITY_PT_OPEN .. "_" .. arg_3_0, 1)
		else
			manager.redPoint:setTip(RedPointConst.SUMMER_ACTIVITY_PT_OPEN .. "_" .. arg_3_0, 0)
		end
	else
