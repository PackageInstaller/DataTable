...
function var_0_0.UpdateAssignmentRedPoint()
	...
	if challengeID ~= 0 then
		for iter_5_0, iter_5_1 in ipairs(AssignmentCfg.get_id_list_by_activity_id[challengeID]) do
			table.insert(AssignmentCfg.get_id_list_by_activity_id[var_5_0], iter_5_1)
		end
	end

	for iter_5_2, iter_5_3 in ipairs(AssignmentCfg.get_id_list_by_activity_id[var_5_0]) do
