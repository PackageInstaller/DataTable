...
function var_0_0.SendFishingSuccess(arg_4_0, arg_4_1)
	local var_4_0 = math.max(0, (math.min(GameSetting.activity_kagutsuchi_fatigue_fish_recover.value[1], GameSetting.activity_kagutsuchi_battle_fatigue_max.value[1] - var_0_1())))

	manager.net:SendWithLoadingNew(76006, {
		activity_id = KagutsuchiFishingEventData.GetInstance().activityID,
		fish_id = arg_4_0
	}, 76007, function(arg_5_0)
		...
		manager.notify:Invoke(KAGUTSUCHI_FISHING_EVENT_QTE_FINISH, arg_4_0, var_5_0, (var_5_0 or nil) and (var_4_0 or 0), var_5_0 and var_5_1)
