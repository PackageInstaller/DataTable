...
function var_0_0:OnReceivePointReward(arg_4_1, arg_4_2)
	LimitedCalculationData:SetRewardState(arg_4_1, arg_4_2)
	self:RefreshRewardRedPoint(arg_4_1)
end

function var_0_0:RefreshRedPoint(arg_5_1)
	...
	self:RefreshActivityOpenRedPoint(arg_5_1)
...
function var_0_0.RefreshRewardRedPoint(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in ipairs((LimitedCalculationData:GetRewardList(arg_7_1))) do
...
function var_0_0.GetAllRewardAction(arg_8_0, arg_8_1)
	local var_8_0 = {}
	local var_8_1 = {}
	local var_8_2 = LimitedCalculationData:GetScore(arg_8_1)

	for iter_8_0, iter_8_1 in ipairs((LimitedCalculationData:GetRewardList(arg_8_1))) do
		if iter_8_1.complete_flag <= 0 and ActivityPointRewardCfg[iter_8_1.id].need <= var_8_2 then
