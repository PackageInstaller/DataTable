...
function var_0_0:OnGetLeviathanReward(arg_4_1)
...
function var_0_0:OnGetSkadiReward(arg_6_1)
	if isSuccess(self.result) then
...
function var_0_0.RefreshSkadiRewardRedPoint()
	manager.redPoint:setTip(RedPointConst.SKADI_LITTLE_GAME_REWARD, not var_0_0.ActivityOpenCheck(ActivityConst.SIKADI_GAME) and 0 or SummerLittleGameData:IsSkadiRewardPointShow() and 1 or 0)
end

function var_0_0.RefreshLeviathanRewardRedPoint()
	manager.redPoint:setTip(RedPointConst.LEVIATHAN_LITTLE_GAME_REWARD, not var_0_0.ActivityOpenCheck(ActivityConst.LEVIATHAN_GAME) and 0 or SummerLittleGameData:IsLeviathanRewardPointShow() and 1 or 0)
end
