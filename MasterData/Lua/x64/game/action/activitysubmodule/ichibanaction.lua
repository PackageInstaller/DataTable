...
function var_0_0.ShowRewardList(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in ipairs(IchiBanData:GetUISeqList(arg_5_0)) do
		IchiBanData:SetIchiBanData(arg_5_0, iter_5_1.level, iter_5_1.seq)

		if IchiBanTools.IsGotAllLevelReward(IchiBanTeaserCfg.get_id_list_by_activity_id[arg_5_0][iter_5_1.level]) then
			IchiBanData:SetUILevelReward(arg_5_0, iter_5_1.level)
		end
	end
...
function var_0_0.InitRedPoint(arg_6_0)
	manager.redPoint:addGroup(string.format("%s%s", ActivityTools.GetRedPointKey(arg_6_0), arg_6_0), (var_0_0.GetRedList(arg_6_0)))
end
...
function var_0_0.UpdateRedPoint(arg_7_0)
	...
	if IchiBanTools.GetUnRaffleCnt(arg_7_0) <= 0 then
		manager.redPoint:delGroup(string.format("%s%s", ActivityTools.GetRedPointKey(arg_7_0), arg_7_0), (var_0_0.GetRedList(arg_7_0)))
	end
end

function var_0_0.GetRedList(arg_8_0)
	return {
		RedPointConst.ACTIVITY_TASK .. "_" .. IchiBanTools.GetTaskActivityID(arg_8_0),
