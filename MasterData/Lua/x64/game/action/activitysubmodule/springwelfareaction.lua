...
function var_0_0.StartPray(arg_3_0, arg_3_1, arg_3_2)
	...
	manager.net:SendWithLoadingNew(76414, {
		...
		type = var_3_0
	}, 76415, function(arg_4_0, arg_4_1)
...
function var_0_0.AcquireDailyPointReward(arg_5_0, arg_5_1, arg_5_2)
	...
	}, 60055, function(arg_6_0, arg_6_1)
...
function var_0_0.FetchAllLetterPlayerInfo(arg_7_0)
	...
	}, 32037, function(arg_8_0, arg_8_1)
...
function var_0_0.AcquireLetterReward(arg_9_0, arg_9_1, arg_9_2)
	manager.net:SendWithLoadingNew(76412, {
		activity_id = SpringWelfareData:GetActivityId(),
		day = arg_9_1
	}, 76413, function(arg_10_0, arg_10_1)
		...
		SpringWelfareData:AcquireLetterReward(arg_9_1)
		getReward(arg_10_0.reward_list or {})
		arg_9_2()
	end)
end

function var_0_0:InitRedPoint(arg_11_1)
	self.BannedRedPoint_ = self.BannedRedPoint_ or {}
	self.activityId_ = arg_11_1.activity_id

	if not ActivityData:GetActivityIsOpen(arg_11_1.activity_id) then
		return
	end

	local var_11_0 = ActivityTools.GetRedPointKey(arg_11_1.activity_id) .. arg_11_1.activity_id
	local var_11_1 = {}

	table.insert(var_11_1, (string.format("%s_%s", RedPointConst.ACTIVITY_2_9_SPRING_WELFARE_LETTER, var_11_0)))
	table.insert(var_11_1, (string.format("%s_%s", RedPointConst.ACTIVITY_2_9_SPRING_WELFARE_REWARD, var_11_0)))
	manager.redPoint:addGroup(var_11_0, var_11_1)

	if not self.registerEvent_ then
		manager.notify:RegistListener(OSIRIS_TASK_UPDATE, function()
			self:UpdateRedPoint(self.activityId_)
		end)

		self.registerEvent_ = true
	end
end
...
function var_0_0.UpdateRedPoint(arg_13_0, arg_13_1)
	...
	for iter_13_0, iter_13_1 in ipairs((SpringWelfareData:GetSystemLetterIdList())) do
	...
	manager.redPoint:setTip(var_13_2, var_13_4)
end

function var_0_0:BanRedPoint(arg_14_1)
	self.BannedRedPoint_[arg_14_1] = true
end
