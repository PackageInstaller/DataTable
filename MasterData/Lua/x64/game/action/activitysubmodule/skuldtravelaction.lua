...
function var_0_0:GotoTravel(arg_2_1)
	manager.net:SendWithLoadingNew(24020, {
		plot_id = arg_2_1
	}, 24021, handler(self, self.OnGotoTravel))
end
...
function var_0_0:OpenEnding(arg_4_1)
	manager.net:SendWithLoadingNew(24022, {
		ending_id = arg_4_1
	}, 24023, handler(self, self.OnOpenEnding))
end
...
function var_0_0:GetTravelReward(arg_6_1)
	manager.net:SendWithLoadingNew(24024, {
		task_id = arg_6_1
	}, 24025, handler(self, self.OnGetTravelReward))
end
...
function var_0_0:ReadTravelResult()
	manager.net:SendWithLoadingNew(24026, {}, 24027, handler(self, self.OnReadTravelResult))
end
...
function var_0_0.CheckUnBindActivitySkuld(arg_10_0)
	if ActivityData:GetActivityIsOpen(ActivityConst.ACTIVITY_1_6) then
		...
		manager.redPoint:delGroup(RedPointConst.TRAVEL_SKULD_ACTIVITY .. ActivityConst.ACTIVITY_1_6_SKULD_TRAVEL, {
			RedPointConst.TRAVEL_SKULD_GOTOTRAVEL .. ActivityConst.ACTIVITY_1_6_SKULD_TRAVEL,
			RedPointConst.TRAVEL_SKULD_ENDING .. ActivityConst.ACTIVITY_1_6_SKULD_TRAVEL
		})
	end
...
function var_0_0.CheckUnBindChapterKey(arg_11_0)
	...
	elseif ChapterTools.IsFinishPreChapter(SkuldTravelData:GetChapterID()) then
		...
		manager.redPoint:delGroup(RedPointConst.TRAVEL_SKULD_CHAPTER .. ActivityConst.ACTIVITY_1_6_SKULD_TRAVEL, {
			RedPointConst.TRAVEL_SKULD_REWARD .. ActivityConst.ACTIVITY_1_6_SKULD_TRAVEL
		})
	end
end
