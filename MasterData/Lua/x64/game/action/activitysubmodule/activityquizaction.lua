...
function var_0_0.InitRedPointKey(arg_6_0)
	...
	for iter_6_0, iter_6_1 in ipairs(ActivityCfg[var_6_1].sub_activity_list) do
	...
	manager.redPoint:addGroup(ActivityTools.GetRedPointKey(arg_6_0) .. arg_6_0, {
...
function var_0_0:OnStartMarch(arg_8_1)
...
function var_0_0:OnCancelMarch(arg_10_1)
	if isSuccess(self.result) then
...
function var_0_0:OnExitRoom(arg_12_1)
	if isSuccess(self.result) then
		QuitQuizScene()
	else
		ShowTips(self.result)
...
function var_0_0:OnChangeHero(arg_14_1)
	if isSuccess(self.result) then
		QuizGameManager:ChangePlayerModel(QuizGameManager.localPlayerId, arg_14_1.role_id)
...
function var_0_0:OnPushPosition(arg_16_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(self.result)
...
function var_0_0.RefreshTaskAvailableRedPoint(arg_17_0, arg_17_1)
	...
	if arg_17_1 then
		for iter_17_0, iter_17_1 in pairs((TaskTools:GetActivityTaskList(arg_17_0))) do
	...
	manager.redPoint:setTip(RedPointConst.ACTIVITY_QUIZ_CHALLENGE_AVAILABLE .. "_" .. arg_17_0, var_17_0)
end
...
function var_0_0.RefreshRedPoint(arg_18_0)
	...
	ActivityTools.CreateActivityTimer(arg_18_0, function()
		local var_19_0 = ActivityQuizTools.GetTaskActivityID(arg_18_0)

		if ActivityTools.GetActivityStatus(arg_18_0) == ActivityConst.ACTIVITY_STATE.OVER then
			ActivityTools.ClearActivityTimer(arg_18_0)
			var_0_0.RefreshTaskAvailableRedPoint(var_19_0, false)

			return
		end

		local var_19_1 = ActivityQuizTools.IsInOpenTimeSpan(arg_18_0)

		if var_19_1 and not ActivityQuizTools.AlreadyEnterTodayLocal(arg_18_0) and gameContext:GetLastOpenPage() == "qworldMainHome" then
			ActivityQuizTools.HintActivityOpen(arg_18_0)
		end

		var_0_0.RefreshTaskAvailableRedPoint(var_19_0, var_19_1 and not ActivityQuizTools.AlreadyEnterThisLogin())
	end)
end
