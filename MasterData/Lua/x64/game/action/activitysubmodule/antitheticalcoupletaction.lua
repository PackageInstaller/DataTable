...
function var_0_0.GetReward(arg_4_0, arg_4_1)
	manager.net:SendWithLoadingNew(61080, {
		activity_id = arg_4_1
	}, 61081, handler(var_0_0, var_0_0.OnGetReward))
end
...
function var_0_0.ChooseStoryID(arg_6_0, arg_6_1, arg_6_2)
	manager.net:SendWithLoadingNew(61084, {
		activity_id = arg_6_1,
		select_id = arg_6_2
	}, 61085, handler(var_0_0, var_0_0.OnChooseStoryID))
end

function var_0_0:OnChooseStoryID(arg_7_1, arg_7_2)
	if isSuccess(arg_7_1.result) then
		AntitheticalCoupletData:SetChooseID(arg_7_2.activity_id, arg_7_2.select_id)
		self:RefreshRedPoint(arg_7_2.activity_id)
	else
...
function var_0_0:RefreshRedPoint(arg_8_1)
	self:RefreshOpenRedPoint(arg_8_1)
	self:RefreshRewardRedPoint(arg_8_1)
end
