...
function var_0_0.InitRedPoint(arg_5_0)
	manager.redPoint:addGroup(string.format("%s%s", ActivityTools.GetRedPointKey(arg_5_0), arg_5_0), (var_0_0.GetRedList(arg_5_0)))
end
...
function var_0_0.UpdateRedPoint(arg_6_0)
	...
	if var_6_1 >= var_6_0.stopTime then
		-- block empty
	elseif var_6_1 >= var_6_0.startTime and ItemTools.getItemNum((PaChinKoTools.GetCurrencyID(arg_6_0))) > 0 and var_6_2 == false then
	...
	if var_6_2 then
		manager.redPoint:delGroup(string.format("%s%s", ActivityTools.GetRedPointKey(arg_6_0), arg_6_0), (var_0_0.GetRedList(arg_6_0)))
	end
end

function var_0_0.GetRedList(arg_7_0)
	return {
		RedPointConst.ACTIVITY_TASK .. "_" .. PaChinKoTools.GetTaskActivityID(arg_7_0),
