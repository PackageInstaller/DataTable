...
function var_0_0.InitRedPointKey(arg_3_0)
	...
	elseif arg_3_0 == ActivityConst.INDIA_VALENTINE_GAME_V2 then
		...
		for iter_3_2, iter_3_3 in ipairs(ActivityData:GetActivityData(arg_3_0).subActivityIdList) do
			...
			table.insert(var_3_3, RedPointConst.VALENTINE_GAME .. "_" .. iter_3_3)
		end

		manager.redPoint:addGroup(RedPointConst.VALENTINE_GAME .. "_" .. arg_3_0, var_3_3)
	end
end
...
function var_0_0.GetReward(arg_4_0, arg_4_1)
	manager.net:SendWithLoadingNew(64070, {
		activity_id = arg_4_1
	}, 64071, handler(var_0_0, var_0_0.OnGetReward))
end
...
function var_0_0:OnGetReward(arg_5_1, arg_5_2)
	if isSuccess(arg_5_1.result) then
		...
		self:RefreshRewardRedPoint(arg_5_2.activity_id)
...
function var_0_0.SetPoint(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	if ActivityTools.GetMainActivityId(arg_6_1) == ActivityConst.INDIA_VALENTINE_GAME_V2 then
		...
		manager.net:SendWithLoadingNew(64074, {
			...
			qa_id = var_6_1,
			choose_id = var_6_0
		}, 64075, function(arg_7_0, arg_7_1)
		...
		manager.net:SendWithLoadingNew(64074, {
			activity_id = arg_6_1,
			point = arg_6_2
		}, 64075, function(arg_8_0, arg_8_1)
...
function var_0_0:RefreshRedPoint(arg_10_1)
	self:RefreshOpenRedPoint(arg_10_1)
	self:RefreshRewardRedPoint(arg_10_1)
end
...
function var_0_0.InitValentineGameV3RedPointKey(arg_14_0)
	if ActivityData:GetActivityIsOpen(arg_14_0) then
		...
		manager.redPoint:addGroup(RedPointConst.VALENTINE_GAME_ENTER .. "_" .. arg_14_0, var_14_0)
		manager.redPoint:addGroup(RedPointConst.VALENTINE_GAME .. "_" .. arg_14_0, {
			RedPointConst.VALENTINE_GAME_ENTER .. "_" .. arg_14_0
		})
	end
end
...
function var_0_0:OnGetStoryReward(arg_17_1, arg_17_2)
	if isSuccess(arg_17_1.result) then
		...
		self:RefreshRedV3RedPoint(arg_17_2.activity_id)
