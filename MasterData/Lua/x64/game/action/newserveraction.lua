...
function var_0_0:OnSignBack(arg_5_1)
	if isSuccess(self.result) then
		getReward2(self.item_list)
		NewServerData:UpdateSign(arg_5_1.index)
		manager.notify:CallUpdateFunc(NEW_SERVER_SIGN, arg_5_1.index)
		var_0_0.CheckSignRedPoint()
	else
...
function var_0_0.UpdateTaskRedTip(arg_8_0, arg_8_1)
	for iter_8_0, iter_8_1 in pairs((TaskData2:GetTaskIDListByType(arg_8_0))) do
		local var_8_0 = TaskData2:GetTask(iter_8_0)

		if var_8_0.progress >= AssignmentCfg[var_8_0.id].need and var_8_0.complete_flag < 1 then
...
function var_0_0.CheckSignRedPoint()
	...
	for iter_9_0 = 1, NewServerData:GetSignIndex() do
...
function var_0_0.CheckBPRedPoint()
	...
	if not ActivityData:GetActivityIsOpen(ActivityConst.ACTIVITY_NEW_SERVER) then
		...
		var_10_0 = NewServerData:GetBPTaskStatus()
		var_10_1 = NewServerData:GetBPTaskIsRecharge()
		var_10_2 = NewServerData:GetAccumulateCurrency()
		var_10_3 = false
	end

	for iter_10_0, iter_10_1 in ipairs(NewServerCfg[ActivityConst.ACTIVITY_NEW_SERVER].bp) do
		if var_10_2 >= NewServerBPTaskCfg[iter_10_1].need and (var_10_0[iter_10_1] == nil or var_10_0[iter_10_1].is_receive_reward < 1 or var_10_1 >= 1 and var_10_0[iter_10_1].is_receive_recharge_reward < 1) then
			var_10_3 = true
	...
	manager.redPoint:setTip(RedPointConst.ACTIVITY_NEW_SERVER_BP, var_10_3 and 1 or 0)
end
...
function var_0_0.ReceiveBPReward(arg_11_0, arg_11_1)
	manager.net:SendWithLoadingNew(83106, {
		...
		if isSuccess(arg_12_0.result) then
			...
			NewServerData:SetBPTaskStatus(arg_12_1.bp_submit)
			var_0_0.CheckBPRedPoint()
