...
manager.net:Bind(54007, function(arg_2_0)
	if isSuccess(arg_2_0.battle_start.result) then
		...
		local var_2_0 = arg_2_0.battle_start.battle_id

		WaitStartBattle = true

		print("战斗开始", var_2_0, arg_2_0.battle_start.battle_server_ip, arg_2_0.battle_start.battle_server_port)
		BattleFieldData:SetServerBattleParams(var_2_0, arg_2_0.battle_start.battle_server_ip, arg_2_0.battle_start.battle_server_port)
		BattleController.GetInstance():StartBattle()
	else
		if arg_2_0.battle_start.result == TipsCfg.get_id_list_by_define.ERROR_NO_TEMPLATE then
			JumpTools.Back()
			ShowTips("STAGE_REFRESH_DATA")
		else
			ShowTips(arg_2_0.battle_start.result)
		end
...
manager.net:Bind(54107, function(arg_3_0)
	if isSuccess(arg_3_0.battle_start.result) then
		print("联机战斗开始", arg_3_0.battle_start.battle_id, arg_3_0.battle_start.battle_server_ip, arg_3_0.battle_start.battle_server_port)
		manager.notify:Invoke(START_COOPERATION_BATTLE)

		local var_3_0 = CooperationData:GetRoomData()
		local var_3_1 = BattleStageFactory.ProduceCooperation(var_3_0.type, var_3_0.dest, var_3_0.activity_id)

		BattleController.GetInstance():SetBattleStageData(var_3_1)
		var_3_1:UpdateRoleDatas()
		BattleFieldData:SetServerBattleParams(arg_3_0.battle_start.battle_id, arg_3_0.battle_start.battle_server_ip, arg_3_0.battle_start.battle_server_port)
		BattleController.GetInstance():StartBattle(true)
	elseif arg_3_0.battle_start.result == TipsCfg.get_id_list_by_define.ERROR_NO_TEMPLATE then
		JumpTools.Back()
		ShowTips("STAGE_REFRESH_DATA")
	else
		ShowTips(arg_3_0.battle_start.result)
	end
end)
manager.net:Bind(54003, function(arg_4_0)
	BattleController.GetInstance():UpdateHeroTeam((BattleTeamPlayerTemplate.New(arg_4_0.player_info)))
end)
...
function var_0_0.PushTeamsByParams(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	var_0_0.PushTeams(arg_8_1, arg_8_0, var_8_0, var_8_1, BattleTeamData:GetComboInfo(arg_8_0, arg_8_1, arg_8_2, arg_8_3), {
		id = var_8_2,
		chip = var_8_3
	}, arg_8_2, arg_8_3)
end
...
function var_0_0.PushTeams(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6, arg_9_7)
	...
	for iter_9_0 = 1, 3 do
		if arg_9_3[iter_9_0] ~= 0 then
			...
			var_9_5.hero_id = arg_9_3[iter_9_0] or 0
			var_9_0[iter_9_0] = var_9_5
		else
			local var_9_6 = {
				hero_type = 1,
				owner_id = BattleTeamData.NO_OWNER
			...
			var_9_6.hero_id = arg_9_2[iter_9_0] or 0
			var_9_0[iter_9_0] = var_9_6
		end
...
function var_0_0.PushTeamsToServer(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5, arg_10_6)
	...
	local var_10_1 = GetHeroTeamActivityID(arg_10_0 or 0, arg_10_2)
