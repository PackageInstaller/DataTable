...
function var_0_0.UpdateRedPoint(arg_4_0)
	...
	for iter_4_0, iter_4_1 in ipairs(ActivityCfg[arg_4_0].sub_activity_list) do
		...
		for iter_4_2, iter_4_3 in ipairs(ActivityPointRewardCfg.get_id_list_by_activity_id[iter_4_1]) do
			if var_4_1 >= ActivityPointRewardCfg[iter_4_3].need and not MardukSpecialData:HaveGotReward(iter_4_1, iter_4_3) then
				var_4_0 = true
				var_4_2 = true
...
function var_0_0.UpdateNotFightRedPoint(arg_5_0)
	...
	if MardukSpecialData:GetPoint(arg_5_0) > 0 then
		...
		local var_5_2 = getData(tostring(arg_5_0), "nextTime")

		var_5_1 = not var_5_2 or manager.time:GetServerTime() >= var_5_2
	end

	manager.redPoint:setTip(string.format("%s_%d", RedPointConst.MARDUK_SPECIAL_NOT_FIGHT, arg_5_0), var_5_1 and 1 or 0)
end
