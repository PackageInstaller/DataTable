...
manager.net:Bind(83227, function(arg_2_0)
	...
	var_0_0.UpdateRewardRedPoint(ActivityCfg.get_id_list_by_sub_activity_list[arg_2_0.area_battle_data.activity_id][1])
end)

function var_0_0.ResetBattleData(arg_3_0, arg_3_1)
	manager.net:SendWithLoadingNew(83222, {
		activity_id = arg_3_0,
		stage_id_list = arg_3_1
	}, 83223, var_0_0.ResetBattleDataCallBack)
end

function var_0_0:ResetBattleDataCallBack(arg_4_1)
	if isSuccess(self.result) then
		ActivityAreaBattleData:ResetBattleData(arg_4_1)

		local var_4_0 = 1

		for iter_4_0, iter_4_1 in pairs(ActivityAreaBattleCfg[arg_4_1.activity_id].stage_id[3 - var_4_0]) do
			if arg_4_1.stage_id_list[1] == iter_4_1 then
				var_4_0 = 2
			end
		end

		saveData("AreaBattle", tostring(ActivityAreaBattleCfg[arg_4_1.activity_id].stage_id[var_4_0][3]), "")
...
function var_0_0.GetReward(arg_5_0, arg_5_1)
	manager.net:SendWithLoadingNew(83224, {
		activity_id = arg_5_0,
		target_score_list = arg_5_1
	}, 83225, var_0_0.GetRewardCallBack)
end

function var_0_0:GetRewardCallBack(arg_6_1)
	if isSuccess(self.result) then
		ActivityAreaBattleData:GetReward(arg_6_1)
		manager.notify:CallUpdateFunc(AREA_BATTLE_GET_REWARD)
		var_0_0.UpdateRewardRedPoint(ActivityCfg.get_id_list_by_sub_activity_list[arg_6_1.activity_id][1])
	else
		ShowTips(GetTips(self.result))
	end
end
...
function var_0_0.SaveAffix(arg_7_0, arg_7_1, arg_7_2)
	manager.net:SendWithLoadingNew(83228, {
		activity_id = arg_7_0,
		affix_list = arg_7_1,
		stage_id = arg_7_2
	}, 83229, var_0_0.SaveAffixCallBack)
end

function var_0_0:SaveAffixCallBack(arg_8_1)
	if isSuccess(self.result) then
		-- block empty
	else
		ShowTips(GetTips(self.result))
...
function var_0_0.UpdateRewardRedPoint(arg_9_0)
	for iter_9_0, iter_9_1 in pairs((ActivityAreaBattleData:GetDataByActivityID(arg_9_0))) do
