local var_0_0 = {
	EnterChessMap = function()
		...
		local var_1_2 = MapConfig.New()

		var_1_2.mapId = var_1_0.mapId
		var_1_2.sceneId = ChessBoardLevelCfg[var_1_0.mapId].scene_id
		var_1_2.minFreeLookX = ChessBoardLevelCfg[var_1_0.mapId].freelook_range[1][1]
		var_1_2.maxFreeLookX = ChessBoardLevelCfg[var_1_0.mapId].freelook_range[1][2]
		var_1_2.minFreeLookZ = ChessBoardLevelCfg[var_1_0.mapId].freelook_range[2][1]
		var_1_2.maxFreeLookZ = ChessBoardLevelCfg[var_1_0.mapId].freelook_range[2][2]
		var_1_2.modelName = ChessBoardLevelCfg[var_1_0.mapId].model
		var_1_2.modelScale = tonumber(ChessBoardLevelCfg[var_1_0.mapId].model_scale)
		var_1_0.MapConfig = var_1_2

		local var_1_3 = {}

		for iter_1_0, iter_1_1 in pairs(var_1_1.mapChangeInfo) do
			local var_1_4 = ChessBoardGirdChangeData.New()

			var_1_4.x = iter_1_1.pos.x
			var_1_4.z = iter_1_1.pos.z
			var_1_4.tag = iter_1_1.tag
			var_1_4.rotationY = iter_1_1.rotationY * 60
		...
		for iter_1_2, iter_1_3 in pairs(var_1_1.thingChangeInfo) do
			local var_1_6 = ChessBoardThingChangeData.New()

			var_1_6.x = iter_1_3.pos.x
			var_1_6.z = iter_1_3.pos.z
			var_1_6.thingtag = iter_1_3.thingtag
			var_1_6.thingRotationY = iter_1_3.thingRotationY * 60
		...
		for iter_1_4, iter_1_5 in pairs(var_1_1.banDirChangeInfo) do
			local var_1_8 = ChessBoardBanDirChangeData.New()

			var_1_8.x = iter_1_5.pos.x
			var_1_8.z = iter_1_5.pos.z
			var_1_8.banDir = {
				false,
				false,
				false,
			...
			for iter_1_6, iter_1_7 in pairs(iter_1_5.banDirList) do
				var_1_8.banDir[iter_1_7.dir] = true
				var_1_8.banDirIsHide[iter_1_7.isHide] = true
			end
		...
		for iter_1_8, iter_1_9 in pairs(var_1_1.NPCInfoList) do
			local var_1_10 = ChessBoardNPCData.New()

			var_1_10.entityID = iter_1_9.id
			var_1_10.x = iter_1_9.pos.x
			var_1_10.z = iter_1_9.pos.z
			var_1_10.dir = iter_1_9.dir
			var_1_10.prefab = ChessBoardNPCPoolCfg[iter_1_9.typeID].prefab

			table.insert(var_1_9, var_1_10)
		end

		var_1_0.mapInfoS = var_1_3
		var_1_0.thingInfoS = var_1_5
		var_1_0.banDirInfoS = var_1_7
		var_1_0.NPCInfos = var_1_9
...
function var_0_0:OnEnterChessBoard(arg_3_1)
	if isSuccess(self.result) then
		ChessBoardData:SetChessBoardData(arg_3_1.chapter_id, self.map)
	...
	for iter_4_0, iter_4_1 in ipairs(arg_4_0.event.event_list) do
		...
		for iter_4_2, iter_4_3 in ipairs(iter_4_1.event) do
			...
			elseif iter_4_3.type == ChessBoardConst.SERVER_SEND_EVENTPARAMS_TYPE.ARRAY then
				table.insert(var_4_1.params, (cleanProtoTable(iter_4_3.array)))
			elseif iter_4_3.type == ChessBoardConst.SERVER_SEND_EVENTPARAMS_TYPE.ARRAY2 then
				...
				for iter_4_4, iter_4_5 in ipairs(iter_4_3.array2) do
					table.insert(var_4_3, (cleanProtoTable(iter_4_5.array)))
				end
			...
			elseif iter_4_3.type == ChessBoardConst.SERVER_SEND_EVENTPARAMS_TYPE.TYPEID_AND_EVENTINFO then
				...
				for iter_4_6, iter_4_7 in ipairs(iter_4_3.array3) do
					...
					table.insert(var_4_5, iter_4_7.integer)

					local var_4_6 = {}

					for iter_4_8, iter_4_9 in ipairs(iter_4_7.two_array) do
						table.insert(var_4_6, (cleanProtoTable(iter_4_9.array)))
					end
			...
			elseif iter_4_3.type == ChessBoardConst.SERVER_SEND_EVENTPARAMS_TYPE.TYPEIDLIST_AND_EVENTINFO then
				...
				for iter_4_10, iter_4_11 in ipairs(iter_4_3.array4) do
					...
					for iter_4_12, iter_4_13 in ipairs(iter_4_11.list) do
						table.insert(var_4_9, iter_4_13)
					end
					...
					for iter_4_14, iter_4_15 in ipairs(iter_4_11.two_array) do
						table.insert(var_4_10, (cleanProtoTable(iter_4_15.array)))
					end

					table.insert(var_4_8, var_4_10)
					table.insert(var_4_7, var_4_8)
				end

				table.insert(var_4_1.params, var_4_7)
			end
		end
...
manager.net:Bind(85033, function(arg_5_0)
	manager.ChessBoardManager:SetChanceServerData({
...
function var_0_0.HeroWantToMoveByPos(arg_7_0, arg_7_1)
	manager.net:SendWithLoadingNew(85010, {
		next_pos = arg_7_0
	}, 85011, function(arg_8_0, arg_8_1)
		var_0_0.OnHeroWantToMoveByPos(arg_8_0, arg_8_1, arg_7_1)
	end)
end

function var_0_0:OnHeroWantToMoveByPos(arg_9_1, arg_9_2)
	if isSuccess(self.result) then
...
function var_0_0:OnHeroRollDice(arg_12_1, arg_12_2)
	if isSuccess(self.result) then
		if arg_12_2 then
			arg_12_2((cleanProtoTable(self.dice_list)))
		end
	else
		ShowTips(self.result)
	end
...
function var_0_0:OnRollChanceDice(arg_15_1, arg_15_2)
	if isSuccess(self.result) then
		if arg_15_2 then
			arg_15_2(cleanProtoTable(self.dice_list), {
				curAuraDiceNum = self.total_cnt
			})
		end
	else
		ShowTips(self.result)
...
function var_0_0:OnHeroMoveEnd(arg_19_1, arg_19_2)
	if isSuccess(self.result) then
		if manager.ChessBoardManager then
			manager.ChessBoardManager.NPCManager_:SetNPCMoveListServerData(self.npc_path_list)
...
function var_0_0:OnUseProp(arg_22_1, arg_22_2)
	if isSuccess(self.result) then
		if manager.ChessBoardManager then
			if arg_22_2 then
				arg_22_2()
...
function var_0_0:OnUnlockChance(arg_25_1, arg_25_2)
	if isSuccess(self.result) then
		if manager.ChessBoardManager then
...
function var_0_0:OnFinishChance(arg_28_1, arg_28_2)
	if isSuccess(self.result) then
		if manager.ChessBoardManager then
			local var_28_0
			...
			if ChessBoardChanceCfg[arg_28_1.chance_id].type == ChessBoardConst.CHANCE_TYPE.QTE then
				local var_28_1 = ChessBoardData:GetCurrentChessBoardMapData().heroInfos.tmp_item
...
function var_0_0:OnGetSelectProp(arg_31_1, arg_31_2)
	if isSuccess(self.result) then
...
function var_0_0:OnGiveUpProp(arg_34_1, arg_34_2)
	if isSuccess(self.result) then
		if arg_34_2 then
			arg_34_2()
		end
...
function var_0_0:OnBuyShopProp(arg_37_1, arg_37_2)
	if isSuccess(self.result) then
...
function var_0_0:OnFinishTask(arg_40_1, arg_40_2)
	if isSuccess(self.result) then
		if arg_40_2 then
			arg_40_2()
		end
...
function var_0_0:OnFinishCurrentBoard(arg_43_1, arg_43_2)
	if isSuccess(self.result) then
