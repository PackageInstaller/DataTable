...
manager.net:Bind(27019, function(arg_4_0)
	for iter_4_0, iter_4_1 in ipairs(arg_4_0.remove_msg_list) do
		...
		elseif iter_4_1.channel_type == ChatConst.CHAT_CHANNEL_FRIEND then
			var_0_0.RemoveFriendChat(iter_4_1.msg_id, (iter_4_1.sender_uid == USER_ID or nil) and (iter_4_1.channel_id or iter_4_1.sender_uid))
...
manager.net:Bind(27023, function(arg_23_0)
	...
	if arg_23_0.msg[#arg_23_0.msg].type == ChatConst.CHAT_CONTENT_TYPE.STICKER then
		local var_23_2 = string.format("[%s]", ChatStickerCfg[tonumber(arg_23_0.msg[#arg_23_0.msg].content)].name)

		var_23_3 = GuildData:GetGuildInfo().id or 0
	end

	ChatTools.SaveGuildChatCache(var_23_3)
...
manager.net:Bind(19039, function(arg_31_0)
	...
	for iter_31_0, iter_31_1 in ipairs(arg_31_0.friend_msg_list) do
		...
		local var_31_2 = iter_31_1.chat_base_info.content

		if iter_31_1.chat_base_info.type == ChatConst.CHAT_CONTENT_TYPE.STICKER then
			var_31_2 = string.format("[%s]", GetI18NText(ChatStickerCfg[tonumber(iter_31_1.chat_base_info.content)].name))
		end

		local var_31_3

		if USER_ID == iter_31_1.chat_base_info.id then
			var_31_3 = iter_31_1.receive_uid or iter_31_1.chat_base_info.id

			if not table.keyof(var_31_1, var_31_3) then
				table.insert(var_31_1, var_31_3)
			end
		end

		FriendsAction:RefreshChat(var_31_3, var_31_2, iter_31_1.chat_base_info.timestamp)
		FriendsAction:RefreshUnread(var_31_3, ChatFriendData:GetUnreadMsgCnt(var_31_3))
		manager.notify:Invoke(CHAT_FRIEND_NEW_MESSAGE, var_31_3)
		table.insert(var_31_0, iter_31_1.chat_base_info.msg_id)
	end

	ChatTools.SaveFriendsCache(var_31_1)
	manager.net:Push(19036, {
...
function var_0_0.RequireGuildShareInfo()
	manager.net:SendWithLoadingNew(27402, {
		...
		if isSuccess(arg_46_0.result) then
			...
			ChatGuildRecruitData:SortMsg((FriendsData:GetList(FriendsConst.FRIEND_TYPE.BLACKLIST)))
...
function var_0_0.RequireRecallInfo()
	manager.net:SendWithLoadingNew(27602, {
		...
		if isSuccess(arg_48_0.result) then
			...
			ActivityRecallData:SortMsg((FriendsData:GetList(FriendsConst.FRIEND_TYPE.BLACKLIST)))
...
manager.net:Bind(27033, function(arg_49_0)
	...
	for iter_49_0, iter_49_1 in ipairs(arg_49_0.msg) do
		ChatChannelData:AddChat(arg_49_0.channel_type, iter_49_1)
		table.insert(var_49_0, iter_49_1.msg.msg_id)
	end

	if arg_49_0.msg[#arg_49_0.msg].msg.type == ChatConst.CHAT_CONTENT_TYPE.STICKER then
		local var_49_2 = string.format("[%s]", ChatStickerCfg[tonumber(arg_49_0.msg[#arg_49_0.msg].msg.content)].name)
	end

	manager.notify:Invoke(CHAT_NEW_MESSAGE, {
		chatToggleID = arg_49_0.channel_type
	})
	manager.net:Push(19036, {
		channel = arg_49_0.channel_type,
		msg_id_list = var_49_0
	})
	ChatTools.SaveChannelChatCache(arg_49_0.channel_type)
end)
...
function var_0_0.LoadChannelChatData()
	for iter_58_0, iter_58_1 in ipairs(ChatToggleCfg.all) do
		if ActivityData:GetActivityIsOpen(ChatToggleCfg[iter_58_1].activity_id) then
