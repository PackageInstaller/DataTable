...
function var_0_0.DeployPicSetting(arg_6_0, arg_6_1)
	...
	if arg_6_0 == "picOptionId" and arg_6_1 ~= SettingConst.GRAPHIC_CUSTOM_ID then
		if GameToSDK.IsPCPlatform() then
			var_6_0.picOptionId = PictureQualitySettingPcCfg[arg_6_1].id
			var_6_0.user_effect = PictureQualitySettingPcCfg[arg_6_1].user_effect
			var_6_0.teammate_effect = PictureQualitySettingPcCfg[arg_6_1].teammate_effect
			var_6_0.frame = PictureQualitySettingPcCfg[arg_6_1].frame
			var_6_0.shadow = PictureQualitySettingPcCfg[arg_6_1].shadow
			var_6_0.post_process = PictureQualitySettingPcCfg[arg_6_1].post_process
			var_6_0.anti_aliasing = PictureQualitySettingPcCfg[arg_6_1].anti_aliasing
			var_6_0.vertical_sync = PictureQualitySettingPcCfg[arg_6_1].vertical_sync
		else
			local var_6_1 = PictureQualitySettingCfg[arg_6_1]

			var_6_0.picOptionId = PictureQualitySettingCfg[arg_6_1].id
			...
			var_6_0.super_resolution_enable = var_6_1.super_resolution_enable
		end
	...
	if var_6_0.resolution then
		local var_6_2, var_6_3 = SettingTools.GetSettingScreenSize((tonumber(var_6_0.resolution)))

		Screen.SetResolution(var_6_2, var_6_3, true)
	...
	elseif var_6_0.frame then
		Application.targetFrameRate = GameToSDK.IsPCPlatform() and (SettingConst.TARGET_FRAME_RATE[var_6_0.frame] or 60) or var_6_0.frame == 0 and 30 or var_6_0.frame == 1 and 60 or 120
...
function var_0_0.ChangeHomeSceneSetting(arg_7_0, arg_7_1)
	...
	SDKTools.SendMessageToSDK("home_scene_setting", {
		sound_effect_setting = var_7_0.home_scene_sound_effect,
		music_setting = var_7_0.home_scene_scene_bgm
	})
end
...
function var_0_0.ChangeSingleSoundSetting(arg_9_0, arg_9_1)
	...
	elseif arg_9_0 == "voice_language" then
		if VoiceLanguageCfg[AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].voice_list[table.indexof(AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].voice_list, arg_9_1) or 1]] then
			manager.audio:SetLocalizationFlag(VoiceLanguageCfg[AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].voice_list[table.indexof(AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].voice_list, arg_9_1) or 1]].affix)
		end
...
function var_0_0.ChangeSingleGameSetting(arg_11_0, arg_11_1)
	if arg_11_0 == "adapter_value" then
		...
		for iter_11_0, iter_11_1 in pairs((gameContext:GetAllOpenPage())) do
...
function var_0_0.ExchangeCode(arg_12_0, arg_12_1)
	...
	GameToSDK.ExChangeGiftCode(var_12_0.userID .. "_" .. var_12_0.signUserId, arg_12_0)
	print("ExchangeCode:" .. var_12_0.userID .. "_" .. var_12_0.signUserId)
