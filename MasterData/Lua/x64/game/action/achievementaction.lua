...
function var_0_0:OnGetReceiveReward(arg_5_1, arg_5_2)
	if isSuccess(self.result) then
		...
		for iter_5_0, iter_5_1 in ipairs(self.reward_list) do
...
function var_0_0.TryToSubmitAchievementList(arg_7_0)
	local var_7_0 = AchievementData:GetCurrentPoint()

	manager.net:SendWithLoadingNew(53004, {
		id = AchievementData:GetReadyAchievementList(arg_7_0)
	}, 53005, function(arg_8_0, arg_8_1)
		var_0_0.OnTryToSubmitAchievementList(arg_8_0, arg_8_1, var_7_0)
	end)
end

function var_0_0:OnTryToSubmitAchievementList(arg_9_1, arg_9_2)
	...
	local var_9_2 = mergeReward(self.reward_list)
	local var_9_3 = false
...
function var_0_0:SendMessageForDrawAction(arg_22_1)
	if var_0_1 == 1 then
		var_0_1 = 0
	...
	for iter_22_0, iter_22_1 in ipairs(self.item) do
