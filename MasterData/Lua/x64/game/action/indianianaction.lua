...
function var_0_0:GetNianDataResultHandler(arg_5_1)
	if isSuccess(self.result) then
		IndiaNianData:UpdateNianData(self)
	else
...
function var_0_0.IsActivityTime()
	...
	if var_6_0.stopTime > manager.time:GetServerTime() and var_6_0.startTime < manager.time:GetServerTime() then
		return true
	end
