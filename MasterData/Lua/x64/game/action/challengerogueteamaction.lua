...
manager.net:Bind(88021, function(arg_9_0)
	for iter_9_0, iter_9_1 in ipairs(arg_9_0.item_list) do
		for iter_9_2, iter_9_3 in ipairs(iter_9_1.treasure_list) do
			ChallengeRogueTeamData:TreasureListUpdate(iter_9_1.opt, iter_9_3)
		end

		for iter_9_4, iter_9_5 in ipairs(iter_9_1.other_list) do
			ChallengeRogueTeamData:EffectItemListUpdate(iter_9_1.opt, iter_9_5)
		end
	end
...
function var_0_0.UpdateHistoryData()
	if ChallengeRogueTeamData:PathGetFloorState() == ChallengeRogueTeamConst.FLOOR_STATE.OVER then
		...
		ChallengeRogueTeamData:AddHistoryDifficultyClearCnt(var_17_0, (ChallengeRogueTeamData:GetSelectDifficultyID(var_17_0)))
		ChallengeRogueTeamData:AddHistoryEndingPassCnt(var_17_0, (ChallengeRogueTeamData.PlotGetEndingID()))
	end
end
	...
	manager.net:SendWithLoadingNew(88008, {
		...
		if isSuccess(arg_21_0.result) then
			...
			if var_20_0 == ChallengeRogueTeamConst.MAP_FLOOR_SWTICH.EXIT_HIDDEN then
				...
				ChallengeRogueTeamData:AddServerTriggerQueue(ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.MAP_NODE_EFFECT, {
					nodeID = var_21_0[#var_21_0]
				})
				ChallengeRogueTeamData:UIInsertPlayAnimatorNodeIDList(var_21_0[#var_21_0])
				ChallengeRogueTeamData:UISetNodeEffectID(var_21_0[#var_21_0])
...
function var_0_0:UpdatePopWindow()
	ChallengeRogueTeamData:UpdateOperateData(self.other_info)
	manager.notify:Invoke(CHALLENGE_ROGUE_TEAM_UPDATE_OPERATE_WINDOW)
	manager.notify:Invoke(CHALLENGE_ROGUE_TEAM_UPDATE_WINDOW)
end

function var_0_0:UpdateShopWindow()
	ChallengeRogueTeamData:UpdateShopData(self.shop_info)
	manager.notify:Invoke(CHALLENGE_ROGUE_TEAM_UPDATE_OPERATE_WINDOW)
	manager.notify:Invoke(CHALLENGE_ROGUE_TEAM_UPDATE_WINDOW)
end
...
function var_0_0.PopWindowProcessSystem()
	...
	if var_61_0 then
		if var_61_0.triggerType ~= ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.TREASURE and ChallengeRogueTeamTools.NeedPlaySuitSkillEffectAnimation() then
		...
		if var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.ATTRIBUTE then
			return var_0_0.TriggerGlobalAttributePop(var_61_0) or var_0_0.PopWindowProcessSystem()
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.OPERATE_POP_WINDOW then
			return var_0_0.TriggerOperateWindow(var_61_0) or var_0_0.PopWindowProcessSystem()
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.REWARD_POP_WINDOW then
			return var_0_0.TriggerRewardWindow(var_61_0) or var_0_0.PopWindowProcessSystem()
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.HERO_HP_MODITY then
			var_0_0.AddPopWindowCnt()
			manager.rogueTeamInGameInfoBox:PlayHeroTeamEffect(var_61_0)

			return var_0_0.PopWindowProcessSystem()
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.HERO_UNLOCK then
			var_0_0.AddPopWindowCnt()
			manager.rogueTeamInGameInfoBox:PlayAddHeroEffect()

			return var_0_0.PopWindowProcessSystem()
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.WORLD_LINE_CHANGE then
			var_0_0.AddPopWindowCnt()

			return var_0_0.TriggerWorldLineWindow(var_61_0)
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.RELIC_CNT_EFFECT then
			var_0_0.AddPopWindowCnt()
			manager.rogueTeamInGameInfoBox:PlayRelicEffect(var_61_0.value)

			return true
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.BUFF_CNT_EFFECT then
			var_0_0.AddPopWindowCnt()
			manager.rogueTeamInGameInfoBox:PlayBuffEffect()

			return true
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.TREASURE then
			var_0_0.AddPopWindowCnt()
			manager.rogueTeamInGameInfoBox:RefreshTreasureBox(var_61_0)

			return true
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.MAP_SWITCH then
			var_0_0:AddPopWindowCnt()

			return var_0_0.TriggerMapSwitchWindow(var_61_0)
		elseif var_61_0.triggerType == ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.MAP_NODE_EFFECT then
			var_0_0:AddPopWindowCnt()
...
function var_0_0:TriggerGlobalAttributePop()
	local var_62_0 = self.value.attributeID

	if self.value.attributeID == ChallengeRogueTeamConst.ATTRIBUTE_ENUM.MECHANISM_VALUE then
		var_0_0.AddPopWindowCnt()
		manager.rogueTeamMechanismBar:PlayAnimator(self)

		return true
	elseif (var_62_0 == ChallengeRogueTeamConst.ATTRIBUTE_ENUM.GOLD or var_62_0 == ChallengeRogueTeamConst.ATTRIBUTE_ENUM.REVIVE_CNT or var_62_0 == ChallengeRogueTeamConst.ATTRIBUTE_ENUM.REVIVE_LIMIT_CNT) and ChallengeRogueTeamData:UIGetAttributeValue(var_62_0) ~= ChallengeRogueTeamData:AttributeGetValue(var_62_0) then
		var_0_0.AddPopWindowCnt()
	...
	ChallengeRogueTeamData:UISetAttributeValue(var_62_0, (ChallengeRogueTeamData:AttributeGetValue(var_62_0)))
	ChallengeRogueTeamData:RemoveServerTriggerQueue()
...
function var_0_0:TriggerRewardWindow()
	if self.value.itemList[1].operate == ChallengeRogueTeamConst.ITEM_OPERATE.UPDATE then
		var_0_0.AddPopWindowCnt()
	...
	if self.value.sourceType == ChallengeRogueTeamConst.ITEM_SOURCE_TYPE.HIDE and RogueTeamItemCfg[self.value.itemList[1].id].type ~= ChallengeRogueTeamConst.ITEM_TYPE.SUIT_SKILL then
		var_0_0.UpdateUIItemData(self)
	...
	if RogueTeamItemCfg[self.value.itemList[1].id].type == ChallengeRogueTeamConst.ITEM_TYPE.SUIT_SKILL then
		var_0_0.AddPopWindowCnt()
...
function var_0_0:UpdateUIItemData()
	if RogueTeamItemCfg[self.value.itemList[1].id].type == ChallengeRogueTeamConst.ITEM_TYPE.TREASURE then
		ChallengeRogueTeamData:InsertServerTriggerQueue(ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.TREASURE, 2, self.value)
	elseif RogueTeamItemCfg[self.value.itemList[1].id].type == ChallengeRogueTeamConst.ITEM_TYPE.RELIC then
		ChallengeRogueTeamData:InsertServerTriggerQueue(ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.RELIC_CNT_EFFECT, 2, self)
	elseif RogueTeamItemCfg[self.value.itemList[1].id].type == ChallengeRogueTeamConst.ITEM_TYPE.MECHANISM and self.value.itemList[1].operate ~= ChallengeRogueTeamConst.ITEM_OPERATE.DELETE then
		ChallengeRogueTeamData:InsertServerTriggerQueue(ChallengeRogueTeamConst.SERVER_TRIGGER_TYPE.BUFF_CNT_EFFECT, 2, self)
	end
end
...
function var_0_0.TriggerPopEventWindow()
	if ChallengeRogueTeamData:EventGetCurrentID() ~= 0 then
		local var_71_0, var_71_1 = ChallengeRogueTeamData:UIGetSelectEventOption()

		if var_71_0 == ChallengeRogueTeamData:EventGetCurrentID() and var_71_1 ~= nil then
			local var_71_2 = ChallengeRogueTeamTools.GetRogueTeamEventStageID(var_71_1)

			if var_71_2 ~= 0 then
				var_0_0.GotoRogueTeamEventReserve(var_71_2)
...
function var_0_0.GotoRogueTeamEventReserve(arg_74_0, arg_74_1)
	if arg_74_0 ~= 0 then
		...
		var_0_0.GotoRogueTeamReserve(ChallengeRogueTeamData:PathGetSelectedNodeID(), arg_74_0, arg_74_1)
	end
end
...
function var_0_0.ClickItemAffix(arg_79_0, arg_79_1, arg_79_2)
	if arg_79_0 == "terminology" then
		...
		for iter_79_1, iter_79_2 in ipairs(var_79_0) do
			table.insert(var_79_1, TerminologyCfg[iter_79_2].word)
			table.insert(var_79_2, TerminologyCfg[iter_79_2].desc)
		end
