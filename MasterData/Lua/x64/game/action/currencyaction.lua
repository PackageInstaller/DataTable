...
function var_0_0:OnBuyDiamond(arg_12_1)
	if isSuccess(self.result) then
		manager.notify:CallUpdateFunc(ON_BUY_DIAMOND, self, arg_12_1)
...
function var_0_0.ReadExpiredCurrency()
	manager.net:SendWithLoadingNew(15024, {
		nothing = 0
	}, 15025, var_0_0.OnReadExpiredCurrencyCallback)
end

function var_0_0:OnReadExpiredCurrencyCallback(arg_17_1)
	if isSuccess(self.result) then
