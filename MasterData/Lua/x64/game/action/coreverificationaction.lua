...
function var_0_0.ResetChallenge(arg_3_0)
	manager.net:SendWithLoadingNew(75010, {
		type = arg_3_0
	}, 75011, var_0_0.OnResetChallengeCallBack)
end

function var_0_0:OnResetChallengeCallBack(arg_4_1)
...
function var_0_0.UpdateRewardRedPoints()
	...
	for iter_7_0 = 1, 4 do
		for iter_7_1, iter_7_2 in ipairs((CoreVerificationData:GetRewardListByType(iter_7_0))) do
			local var_7_1, var_7_2, var_7_3, var_7_4 = CoreVerificationData:GetTaskProcess(iter_7_2)
...
function var_0_0.UpdateChallengeRedPoints()
	local var_8_0 = getData("CoreVerification", "click_time") or 0
	local var_8_1 = _G.gameTimer:GetNextDayFreshTime()
	...
	elseif CoreVerificationData:IsStageProcess() or var_8_1 > 0 and var_8_1 <= var_8_0 then
		manager.redPoint:setTip(RedPointConst.CORE_VERIFICATION_CHALLENGE, 0)
	else
...
function var_0_0.SelectSuffix(arg_9_0, arg_9_1)
	manager.net:SendWithLoadingNew(75012, {
		affix_info = {
			id = arg_9_0,
			affix_list = arg_9_1
		}
	}, 75013, var_0_0.OnSelectSuffix)
end

function var_0_0:OnSelectSuffix(arg_10_1)
	if isSuccess(self.result) then
