...
function var_0_0.Oath(arg_6_0)
	manager.net:SendWithLoadingNew(14514, {
		hero_id = arg_6_0
	}, 14515, var_0_0.OnOath)
end

function var_0_0:OnOath(arg_7_1)
	if isSuccess(self.result) then
		if self:HasField("time") then
			OathCollectionContentData:UpdateOathTime(self.time)
		end
...
function var_0_0.UpdateWeddingPhoto(arg_8_0, arg_8_1)
	manager.net:SendWithLoadingNew(14514, {
		hero_id = arg_8_0,
		picture_url = arg_8_1
	}, 14515, var_0_0.OnUpdateWeddingPhoto)
end

function var_0_0:OnUpdateWeddingPhoto(arg_9_1)
	if isSuccess(self.result) then
...
function var_0_0.SetHeroNickName(arg_11_0, arg_11_1)
	...
	manager.net:SendWithLoadingNew(14516, {
		hero_id = arg_11_0,
		nick = arg_11_1
	}, 14517, var_0_0.OnSetHeroNickName)
end

function var_0_0:OnSetHeroNickName(arg_12_1)
	if isSuccess(self.result) then
...
function var_0_0.ReadPlotStory(arg_13_0, arg_13_1)
	manager.net:SendWithLoadingNew(14510, {
		oath_plot = {
			hero_id = arg_13_0,
			text_list = {
				arg_13_1
...
function var_0_0:OnReadPlotStory(arg_15_1)
	if isSuccess(self.result) then
