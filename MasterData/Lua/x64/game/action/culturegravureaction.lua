...
function var_0_0.GetSortedEquipIDByEquipList(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1) do
		for iter_2_2, iter_2_3 in ipairs((deepClone(EquipData:GetEquipPrefabMap(iter_2_1)))) do
	...
	if #var_2_0 > 1 then
		table.sort(var_2_0, function(arg_3_0, arg_3_1)
			...
			elseif var_3_0.race ~= var_3_1.race then
				...
				return #var_3_0.enchant[1] + #var_3_0.enchant[2] ~= 0 and #var_3_1.enchant[1] + #var_3_1.enchant[2] == 0
			end
		end)
	end
...
function var_0_0.GetRecommendEquip(arg_5_0, arg_5_1)
	local var_5_0 = HeroData:GetEquipMap()
	local var_5_1 = {}

	for iter_5_0, iter_5_1 in ipairs((var_0_0.GetSortedEquipIDByEquipList(arg_5_0, (CultureGravureData:GetEquiptPrefabListByEquiptID(arg_5_1))))) do
		if not var_5_0[iter_5_1] then
			var_5_1.pos = EquipCfg[EquipData:GetEquipData(iter_5_1).prefab_id].pos
			var_5_1.id = iter_5_1
...
function var_0_0.EquipByList(arg_6_0, arg_6_1)
	EquipAction.EquipQuickDressOn(arg_6_0, (var_0_0.GetRecommendEquipList(arg_6_0, arg_6_1)))
end
...
function var_0_0.GetRecommendEquipList(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_1) do
		for iter_7_2, iter_7_3 in ipairs((var_0_0.GetSortedEquipIDByEquipList(arg_7_0, (CultureGravureData:GetEquiptPrefabListByEquiptID(iter_7_1))))) do
			if var_7_1[iter_7_3] then
				if var_7_1[iter_7_3] == arg_7_0 then
					local var_7_3 = {}

					var_7_3.pos = EquipCfg[EquipData:GetEquipData(iter_7_3).prefab_id].pos
					var_7_3.equip_id = iter_7_3
...
function var_0_0.EquipByServantID(arg_8_0, arg_8_1)
	local var_8_0 = ServantTools.GetServantMap()
	local var_8_1 = {}

	for iter_8_0, iter_8_1 in ipairs((WeaponServantData:GetWeaponServantById(arg_8_1))) do
		if not var_8_0[iter_8_1.uid] then
	...
	ServantAction.ServantReplace(arg_8_0, var_8_1[1].uid)
end
