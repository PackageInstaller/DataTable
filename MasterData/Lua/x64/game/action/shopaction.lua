...
function var_0_0.LateInitLua()
	JumpTools.SetSystemOpenCheck(ViewConst.SYSTEM_ID.RECHARGE_SKIN, function(arg_6_0)
		local var_6_0 = getShopCfg(arg_6_0.goodID)

		if var_6_0 and not ShopTools.IsGoodCanDisplay(var_6_0.shop_id, var_6_0.goods_id) then
			return false, GetTips("GOODS_HAS_BEEN_REMOVED")
		end

		if (ShopTools.HaveSkin(arg_6_0.skinID) or HeroTools.CanChangeSkin(arg_6_0.skinID)) and var_6_0.dlc and ShopTools.CheckDlcPurchased(var_6_0.dlc) then
	...
	JumpTools.SetSystemOpenCheck(ViewConst.SYSTEM_ID.RECHARGE_FUKUBUKURO, function(arg_7_0)
		local var_7_0 = getShopCfg(arg_7_0.goodID)

		if var_7_0 and not ShopTools.IsGoodCanDisplay(var_7_0.shop_id, var_7_0.goods_id) then
			return false, GetTips("GOODS_HAS_BEEN_REMOVED")
		end

		local var_7_1 = ShopData.GetShop(arg_7_0.shopID)[arg_7_0.goodID]

		if var_7_1 ~= nil and var_7_0.limit_num ~= nil and var_7_0.limit_num ~= -1 then
			if var_7_0.limit_num - (var_7_1.buy_times or 0) <= 0 then
				return false, GetTips("SOLD_OUT")
			end
		end
...
function var_0_0.UpdateRedPoints()
	...
	for iter_9_0, iter_9_1 in ipairs(RechargeRecommendCfg.all) do
		...
		local var_9_1 = not RechargeRecommendCfg[iter_9_1].time[1] or #RechargeRecommendCfg[iter_9_1].time[1][1] < 3 or #RechargeRecommendCfg[iter_9_1].time[1][2] < 3
		local var_9_2 = var_9_0.time[2]

		if not var_9_0.time[2] or #var_9_2[1] < 3 or #var_9_2[2] < 3 then
			var_9_1 = true
		end

		if not var_9_1 then
			local var_9_3 = TimeMgr.GetInstance():parseTimeFromConfig(var_9_0.time[1])
			local var_9_4 = TimeMgr.GetInstance()
			local var_9_5 = TimeMgr.GetInstance():GetServerTime()

			var_9_1 = var_9_5 < var_9_4:parseTimeFromConfig(var_9_0.time[2]) and var_9_3 <= var_9_5
		end

		local var_9_6 = RedPointConst.RECHARGE_RECOMMEND .. iter_9_1

		if var_9_0.new_recommend == 0 or not var_9_1 or getData("recharge_recommend", tostring(iter_9_1)) ~= nil then
			manager.redPoint:setTip(var_9_6, 0)
		else
			manager.redPoint:setTip(var_9_6, 1)
		end
	end
end
...
function var_0_0.UpdateNewShopRedPoints()
	...
	for iter_10_0, iter_10_1 in pairs(ShopListCfg.all) do
		if ShopListCfg[iter_10_1].system == "2" then
			manager.redPoint:setTip(RedPointConst.NEW_SHOP_RECHARGE .. ShopListCfg[iter_10_1].display_group, 0, RedPointStyle.SHOW_NEW_TAG)
		elseif ShopListCfg[iter_10_1].system == "1" then
			manager.redPoint:setTip(RedPointConst.NEW_SHOP_SHOP .. ShopListCfg[iter_10_1].display_group, 0, RedPointStyle.SHOW_NEW_TAG)
		end
	end
...
function var_0_0.BuyItem(arg_12_0, arg_12_1, arg_12_2)
	...
	for iter_12_0, iter_12_1 in ipairs(arg_12_0) do
		...
		if not ShopTools.IsShopOpen(var_12_2.shop_id) then
			ShowTips("TIME_OVER")
		...
		local var_12_11 = ((arg_12_1 or nil) and arg_12_1) * iter_12_1.buyNum
		local var_12_12 = {}

		if var_12_2.cost_type == 2 then
			local var_12_13 = math.min(var_12_11, (ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_DIAMOND)))
			...
			if var_12_11 - var_12_13 > 0 then
				table.insert(var_12_12, {
					id = CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_FREE,
					num = var_12_11 - var_12_13
				})
			end

			if var_12_11 - var_12_13 > 0 and var_12_11 - var_12_13 > CurrencyData:GetRechargeDiamond() then
			...
			if var_12_10 == ItemConst.ITEM_TYPE.CURRENCY then
				local var_12_14 = var_12_4
				local var_12_15 = ItemTools.getItemNum(var_12_4)

				if var_12_15 < var_12_11 then
					if var_12_14 == CurrencyConst.CURRENCY_TYPE_GOLD then
						local var_12_16 = false

						for iter_12_2, iter_12_3 in ipairs(ItemCfg.get_id_list_by_sub_type[ItemConst.ITEM_SUB_TYPE.PROPS_BOND] or {}) do
						...
						if CurrencyData:GetGoldBuyTimes() < GameSetting.coin_max_buy_time.value[1] or var_12_16 then
							JumpTools.OpenPopUp("currencyBuyGold", nil, ViewConst.SYSTEM_ID.BUY_GOLD)

							return
						end
					elseif var_12_14 == CurrencyConst.CURRENCY_TYPE_DIAMOND then
						if AreaDifferenceCfg[GameToSDK.CURRENT_SERVER].payment == 1 then
							ShopTools.DefaultOpenPopUp(var_12_11 - var_12_15)
						else
							ShowTips("ERROR_ITEM_NOT_ENOUGH_CURRENCY")
						end

						return
					elseif var_12_14 == CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_FREE then
						ShopTools.DiamondEnoughMessageBox()
			...
			elseif var_12_10 == ItemConst.ITEM_TYPE.MATERIAL then
				if var_12_11 > ItemTools.getItemNum(var_12_4) then
					ShowTips(string.format(GetTips("CURRENCY_NO_ENOUGH"), GetI18NText(ItemCfg[var_12_4].name)))
		...
		if iter_12_1.buyNum > 0 then
			...
			var_12_19.buy_type = iter_12_1.buyType or 0

			table.insert(var_12_0, var_12_19)
		else
	...
	manager.net:SendWithLoadingNew(20012, {
		buy_goods_list = var_12_0,
		shop_id = var_12_1,
		buy_source = arg_12_2
	}, 20013, var_0_0.ShopItemUpdate)
end

function var_0_0:ShopItemUpdate(arg_13_1)
	local var_13_0 = {}
	local var_13_1 = {}

	if self.result == 0 then
		if var_0_0.CheckIsDlcAndSkin(arg_13_1.buy_goods_list) then
			manager.notify:CallUpdateFunc(SHOP_BUY_CALLBACK, self.result, arg_13_1.buy_goods_list[1].buy_id, arg_13_1.shop_id, arg_13_1.buy_goods_list[1].buy_num)
			manager.notify:CallUpdateFunc(SHOP_BUY_CALLBACK, self.result, arg_13_1.buy_goods_list[2].buy_id, arg_13_1.shop_id, arg_13_1.buy_goods_list[2].buy_num)
			getReward(var_0_0.GetSkinGiveBackList(arg_13_1.buy_goods_list), nil, nil, nil, nil, {
				isBuy = true
			})
		...
		for iter_13_0, iter_13_1 in ipairs(arg_13_1.buy_goods_list) do
			...
			local var_13_6 = var_13_2.description and RechargeShopDescriptionCfg[var_13_2.description] or ItemCfg[var_13_3]

			if var_13_6.sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_PACKS then
				local var_13_7 = {}

				for iter_13_2, iter_13_3 in ipairs(var_13_6.param) do
					table.insert(var_13_7, {
						iter_13_3[1],
			...
			elseif var_13_6.sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_SEVEN_PACKS then
				...
				for iter_13_4, iter_13_5 in ipairs(var_13_6.param[1]) do
			...
			elseif var_13_6.type == ItemConst.ITEM_TYPE.HERO then
				var_13_0 = {
					{
						var_13_6.id,
						[2] = 1
			...
			if var_13_2.give_back_list and next(var_13_2.give_back_list) ~= nil then
				...
				table.insertto(var_13_0, var_13_9)
			end
			...
			manager.notify:CallUpdateFunc(SHOP_BUY_CALLBACK, self.result, iter_13_1.buy_id, arg_13_1.shop_id, iter_13_1.buy_num)

			if var_13_2.shop_id == ShopConst.SHOP_ID.REGRESSION_SHOP then
				...
				if iter_13_0 == #arg_13_1.buy_goods_list then
					if #var_13_1 > 0 then
						...
						if var_13_2.shop_refresh == 1 then
							table.insert(var_13_1, {
								id = var_13_2.give_id,
								num = var_13_2.give
							})
						else
							for iter_13_10, iter_13_11 in ipairs(var_13_6.param) do
								table.insert(var_13_1, {
									id = iter_13_11[1],
									num = iter_13_11[2]
								})
			...
			elseif var_13_6.type == ItemConst.ITEM_TYPE.SCENE then
				getReward(var_13_0)
			elseif var_13_6.type == ItemConst.ITEM_TYPE.HERO then
				getReward(mergeReward(self.give_items))
	...
	elseif self.result == 406 then
		ShowTips("ITEM_INVALID")
	elseif TipsCfg[self.result] ~= nil then
...
function var_0_0:CheckIsDlcAndSkin()
	if #self ~= 2 then
		return false
	end

	local var_16_0 = getShopCfg(self[1].buy_id)
	local var_16_1 = getShopCfg(self[2].buy_id)

	return (var_16_0.description and RechargeShopDescriptionCfg[var_16_0.description] or ItemCfg[var_16_0.give_id]).type == 8 and (var_16_1.description and RechargeShopDescriptionCfg[var_16_1.description] or ItemCfg[var_16_1.give_id]).type == 21
end

function var_0_0:GetSkinGiveBackList()
	local var_17_1 = getShopCfg(self[1].buy_id)
	local var_17_2 = getShopCfg(self[2].buy_id)
	local var_17_4
	...
	var_17_6[1] = (var_17_1.description and RechargeShopDescriptionCfg[var_17_1.description] or ItemCfg[var_17_1.give_id]).param[1]
	var_17_5[1] = var_17_6
	var_17_5[2] = {
		var_17_4.id,
		1
	...
	if var_17_1.give_back_list and next(var_17_1.give_back_list) ~= nil then
		...
		table.insertto(var_17_7, var_17_8)
	end
	...
	if var_17_2.give_back_list and next(var_17_2.give_back_list) ~= nil then
		...
		for iter_17_2, iter_17_3 in ipairs(var_17_2.give_back_list) do
			table.insert(var_17_9, {
				iter_17_3.id,
				iter_17_3.num
			})
		end

		table.insertto(var_17_7, var_17_9)
	end

	return (mergeReward((formatRewardCfgList(var_17_7))))
end
...
function var_0_0:OnRefreshSingleShop(arg_21_1)
	if self.result == 0 then
		var_0_0.diamondRequire_ = nil
	end

	manager.notify:CallUpdateFunc(ON_SHOP_REFRESH_ONE_SHOP, self)
end
...
function var_0_0:OnRemoveShopRedPoint(arg_27_1)
	if self.result == 0 then
