...
function var_0_0.UpdateRewardRedPoints()
	...
	if not not JumpTools.IsSystemLocked(ViewConst.SYSTEM_ID.BATTLE_ABYSS) then
...
function var_0_0.UpdateChallengeRedPoints()
	...
	for iter_9_0, iter_9_1 in ipairs(AbyssData:GetCurrentIdList()) do
		for iter_9_2, iter_9_3 in ipairs(AbyssCfg[iter_9_1].stage_list) do
			local var_9_1 = AbyssData:GetStageData(AbyssCfg[iter_9_1].level, iter_9_2)

			if var_9_1 and var_9_1.is_completed then
				var_9_0 = true
	...
	local var_9_2 = AbyssData:HaveGetBonusNum()
	local var_9_3 = getData("abyss", "click_time") or 0
	local var_9_4 = _G.gameTimer:GetNextDayFreshTime()

	if ChapterClientCfg[502] then
		if not not JumpTools.IsSystemLocked(ViewConst.SYSTEM_ID.BATTLE_ABYSS) then
			manager.redPoint:setTip(RedPointConst.ABYSS_CHALLENGE, 0)
		elseif var_9_0 or var_9_2 > 0 or var_9_4 > 0 and var_9_4 <= var_9_3 then
			manager.redPoint:setTip(RedPointConst.ABYSS_CHALLENGE, 0)
		else
...
function var_0_0.ResetLayer(arg_11_0)
	manager.net:SendWithLoadingNew(55002, {
		layer = arg_11_0
	}, 55003, var_0_0.OnResetLayerCallback)
end

function var_0_0:OnResetLayerCallback(arg_12_1)
	if isSuccess(self.result) then
		for iter_12_0, iter_12_1 in ipairs(AbyssData:GetAbyssCfg(arg_12_1.layer).stage_list) do
...
function var_0_0.ResetStage(arg_13_0, arg_13_1, arg_13_2)
	...
	manager.net:SendWithLoadingNew(55004, {
		stage_id = arg_13_2
	}, 55005, var_0_0.OnResetStageCallback)
end

function var_0_0:OnResetStageCallback(arg_14_1)
	if isSuccess(self.result) then
...
function var_0_0.GetLayerBonus(arg_15_0)
	manager.net:SendWithLoadingNew(55006, {
		layer_list = arg_15_0
	}, 55007, var_0_0.OnGetLayerBonusCallback)
end

function var_0_0:OnGetLayerBonusCallback(arg_16_1)
	if isSuccess(self.result) then
		local var_16_0 = {}

		for iter_16_0, iter_16_1 in ipairs(arg_16_1.layer_list) do
			table.insertto(var_16_0, AbyssData:GetAbyssCfg(iter_16_1).reward_list)
		end
...
function var_0_0.SaveProgress(arg_17_0, arg_17_1)
	manager.net:SendWithLoadingNew(55012, {
		stage_id = arg_17_0,
		is_save = arg_17_1
	}, 55013, var_0_0.OnSaveProgressCallback)
end

function var_0_0:OnSaveProgressCallback(arg_18_1)
	if isSuccess(self.result) then
		var_0_0.UpdateRedPoints()
	else
		ShowTips(GetTips(self.result))
...
function var_0_0.ReadBackFlag()
	manager.net:SendWithLoadingNew(55020, {}, 55021, var_0_0.OnReadBackFlagCallback)
end

function var_0_0:OnReadBackFlagCallback(arg_20_1)
	if isSuccess(self.result) then
