...
local function var_0_9(arg_5_0, arg_5_1)
	...
	function var_5_3.__index(arg_6_0, arg_6_1)
		if not var_5_2.keys_map[arg_6_1] then
		...
		local var_6_0 = rawget(arg_6_0, var_5_2.keys_map[arg_6_1])

		if var_0_2 and var_5_2.string_hashed[var_5_2.keys_map[arg_6_1]] and type(var_6_0) == "number" then
			return var_0_7(var_6_0)
		end
	...
	function var_5_3.__newindex(arg_7_0, arg_7_1, arg_7_2)
		...
		if not var_5_2.keys_map[arg_7_1] then
	...
	function var_5_3.__pairs(arg_8_0)
		return function(arg_9_0, arg_9_1)
			...
			if var_9_0 then
				return var_9_0, arg_9_0[var_9_0]
			end
	...
	for iter_5_4, iter_5_5 in pairs(arg_5_0) do
		...
		elseif var_5_5 and var_0_6(iter_5_4, "get_id_list_by_") then
			...
			for iter_5_6, iter_5_7 in pairs(iter_5_5) do
				var_5_4[iter_5_6] = type(iter_5_7) == "table" and table.length(iter_5_7) == 0 and var_0_5 or iter_5_7
			end
		end
