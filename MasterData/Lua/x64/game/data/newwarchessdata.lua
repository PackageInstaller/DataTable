...
function var_0_0.SetWarChessData(arg_2_0, arg_2_1, arg_2_2)
	var_0_2 = NewWarChessLevelCfg[arg_2_1].activity
	var_0_3 = ActivityTools.GetMainActivityId(var_0_2)
	var_0_4.mapId = NewWarChessLevelCfg[arg_2_1].id_level
	var_0_4.bronPos = {
		x = arg_2_2.pos.x,
		z = arg_2_2.pos.z
	}
	...
	var_0_4.buffList = var_2_1

	local var_2_2 = {}

	for iter_2_4, iter_2_5 in ipairs(arg_2_2.global_event) do
		table.insert(var_2_2, iter_2_5.global_event_id)
	end

	var_0_4.globalEventList = var_2_2
	var_0_9 = {}
	...
	for iter_2_10, iter_2_11 in ipairs(arg_2_2.skill) do
		...
		if NewWarChessDiceSkillCfg[iter_2_11.id].use_limit ~= 0 then
			var_2_3 = NewWarChessDiceSkillCfg[iter_2_11.id].use_limit
			var_2_3 = NewWarChessDiceSkillCfg[iter_2_11.id].use_limit - iter_2_11.times
		else
			var_2_3 = -1
		end
	...
	for iter_2_14, iter_2_15 in ipairs(arg_2_2.floor) do
		...
		var_2_5.status = iter_2_15.state or 0
		var_2_5.direction = (iter_2_15.rotation or 0) / 60
		var_2_4[NewChessTools.TwoDToOneD(iter_2_15.pos.x, iter_2_15.pos.z)] = var_2_5
	end

	var_0_4.mapChangeInfo = var_2_4
	...
	for iter_2_16, iter_2_17 in ipairs(arg_2_2.object) do
		...
		var_2_7.objectdirection = (iter_2_17.rotation or 0) / 60
		var_2_6[NewChessTools.TwoDToOneD(iter_2_17.pos.x, iter_2_17.pos.z)] = var_2_7
	end

	var_0_4.objectChangeInfo = var_2_6
...
function var_0_0:GetCurrentWarChessMapID()
...
function var_0_0.GetAttribute(arg_12_0, arg_12_1)
	...
	if type(arg_12_1) == "string" then
		var_12_0 = arg_12_1
		var_12_1 = NewWarChessAttributeCfg[arg_12_1].id
...
function var_0_0.SubAttribute(arg_13_0, arg_13_1, arg_13_2)
	...
	if type(arg_13_1) == "string" then
		var_13_0 = arg_13_1
		var_13_1 = NewWarChessAttributeCfg[arg_13_1].id
	...
	var_0_9[var_13_1] = var_0_9[var_13_1] and var_0_9[var_13_1] + arg_13_2 or NewWarChessAttributeCfg[var_13_0].default + arg_13_2
...
function var_0_0.SetAttribute(arg_14_0, arg_14_1, arg_14_2)
	...
	if type(arg_14_1) == "string" then
		var_14_0 = arg_14_1
		var_14_1 = NewWarChessAttributeCfg[arg_14_1].id
...
function var_0_0:FixCurMapNewDayMovePoint()
	if var_0_4 and var_0_4.mapId then
		self:SetAttribute("GAME_NEWCHESS_ATTRIBUTE_MOVE_POINT", self:GetMovePoint(var_0_4.mapId))
	end
end
...
function var_0_0.ChangeGridLua(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	if var_21_0 then
		var_21_1 = arg_21_3 ~= 0 and NewChessTools.CreateChessData(arg_21_1, arg_21_2, var_0_5, arg_21_3) or NewChessTools.CreateChessData(arg_21_1, arg_21_2, var_0_7, NewChessTools.TwoDToOneD(arg_21_1, arg_21_2))
...
function var_0_0.ChangeGridLuaInheritDir(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	if var_22_0 then
		var_22_1 = arg_22_3 ~= 0 and NewChessTools.CreateChessData(arg_22_1, arg_22_2, var_0_5, arg_22_3) or NewChessTools.CreateChessData(arg_22_1, arg_22_2, var_0_7, NewChessTools.TwoDToOneD(arg_22_1, arg_22_2))
...
function var_0_0.ChangeObjectLua(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	if var_23_0 then
		var_23_0.objectdirection = (arg_23_3 ~= 0 and NewChessTools.CreateChessData(arg_23_1, arg_23_2, var_0_6, arg_23_3) or NewChessTools.CreateChessData(arg_23_1, arg_23_2, var_0_7, NewChessTools.TwoDToOneD(arg_23_1, arg_23_2))).objectdirection
	elseif arg_23_3 ~= 0 then
		...
		var_23_0.objectdirection = NewChessTools.CreateChessData(arg_23_1, arg_23_2, var_0_6, arg_23_3).objectdirection
	else
		var_23_0 = NewChessTools.CreateChessData(arg_23_1, arg_23_2, var_0_7, NewChessTools.TwoDToOneD(arg_23_1, arg_23_2))
	end
...
function var_0_0:CheckDiceNum()
	if self:GetDiceNum() >= self:GetAttribute("GAME_NEWCHESS_ATTRIBUTE_DICE_MAX") then
		return true
	end
...
function var_0_0.AddNewSkill(arg_41_0, arg_41_1)
	local var_41_0 = NewWarChessDiceSkillCfg[arg_41_1].use_limit ~= 0 and NewWarChessDiceSkillCfg[arg_41_1].use_limit or -1
...
function var_0_0.AddAllSkillCount(arg_44_0)
	for iter_44_0, iter_44_1 in pairs(var_0_13) do
		iter_44_1.useLimit = NewWarChessDiceSkillCfg[iter_44_1.skillID].use_limit ~= 0 and NewWarChessDiceSkillCfg[iter_44_1.skillID].use_limit or -1
	end
end
...
function var_0_0.GetCurChanceID(arg_54_0)
	...
	return var_0_17, var_0_4.curChancePosx, var_0_4.curChancePosz
end
...
function var_0_0.GetServerEvent(arg_60_0, arg_60_1, arg_60_2)
	...
	if var_60_0 ~= 0 then
		...
		return var_0_20[var_60_0].eventList
	end
...
function var_0_0:SaveDataToSystem()
	if var_0_21[var_0_4.mapId] == nil then
		var_0_21[var_0_4.mapId] = {
			movePoint = 0,
			exploreValue = 0,
			isFinish = 0,
			getRewardLevelList = {}
	...
	var_0_21[var_0_4.mapId].movePoint = self:GetAttribute("GAME_NEWCHESS_ATTRIBUTE_MOVE_POINT")

	local var_70_0 = self:GetAttribute("GAME_NEWCHESS_ATTRIBUTE_FINISH")

	if var_0_21[var_0_4.mapId].isFinish == 0 and var_70_0 == 1 then
		for iter_70_0, iter_70_1 in pairs(NewWarChessLevelCfg.all) do
			if NewWarChessLevelCfg[iter_70_1].front_level_id == var_0_4.mapId then
	...
	var_0_21[var_0_4.mapId].isFinish = var_70_0
end
