...
function var_0_0:InitFromServer(arg_2_1)
	...
	self.dailyGameCount = arg_2_1.today_fish_num

	self:UpdateFishRemain(arg_2_1.fish_list)
end

function var_0_0:UpdateFishRemain(arg_3_1)
	self.fishRemain = {}

	local var_3_0 = var_0_2(var_0_1.S)

	for iter_3_0, iter_3_1 in ipairs(HanafudaCardCfg.all) do
		self.fishRemain[iter_3_1] = var_3_0
	end

	for iter_3_2, iter_3_3 in ipairs(arg_3_1) do
		self.fishRemain[iter_3_3.id] = self.fishRemain[iter_3_3.id] - iter_3_3.num > 0 and self.fishRemain[iter_3_3.id] - iter_3_3.num or nil
	end
end

function var_0_0:OnFishingGameFinish(arg_4_1, arg_4_2)
	if arg_4_2 then
		self.dailyGameCount = self.dailyGameCount + 1

		local var_4_0 = nullable(self.fishRemain, arg_4_1)

		var_4_0 = var_4_0 and (var_4_0 > 1 and var_4_0 - 1 or nil)
		self.fishRemain[arg_4_1] = var_4_0
	end
end
...
function var_0_0:GetRemainFishForUpgrade(arg_6_1)
	return self.fishRemain[arg_6_1] or 0
end

function var_0_0:GetRarity(arg_7_1)
	return var_0_0.TestRarity((self:GetRemainFishForUpgrade(arg_7_1)))
end

function var_0_0:FishNotYetGet(arg_8_1)
	return var_0_2(var_0_1.S) - self:GetRemainFishForUpgrade(arg_8_1) == 0
end

function var_0_0:GetNextRarity(arg_9_1)
	local var_9_0 = self:GetRemainFishForUpgrade(arg_9_1)
