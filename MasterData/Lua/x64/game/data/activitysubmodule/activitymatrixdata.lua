...
function var_0_0.InitMatrixClue(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1.clue_list) do
		table.insert(var_0_3[arg_2_1.activity_id], {
...
function var_0_0.InitMatrixUser(arg_3_0, arg_3_1)
	if var_0_1[arg_3_1.activity_id] then
		var_0_1[arg_3_1.activity_id]:SetData(arg_3_1)
	else
		var_0_1[arg_3_1.activity_id] = ActivityMartixUserTemplata.New(arg_3_1)
	end
...
function var_0_0.GetScoreAddition(arg_30_0, arg_30_1)
	if not var_0_1[arg_30_1].attribute_list[MatrixConst.MATRIX_ATTRIBUTE_TYPE.SCORE_ADDITION] then
		return 0
	end

	return var_0_1[arg_30_1].attribute_list[MatrixConst.MATRIX_ATTRIBUTE_TYPE.SCORE_ADDITION] / 1000
end

function var_0_0.GetGiveUpRewardAddition(arg_31_0, arg_31_1)
	if not var_0_1[arg_31_1].attribute_list[MatrixConst.MATRIX_ATTRIBUTE_TYPE.GIVE_UP_REWARD_ADDITION] then
		return 0
	end

	return var_0_1[arg_31_1].attribute_list[MatrixConst.MATRIX_ATTRIBUTE_TYPE.GIVE_UP_REWARD_ADDITION] / 1000
end
...
function var_0_0.GetAffixList(arg_33_0, arg_33_1)
	if var_0_1[arg_33_1] then
		...
		for iter_33_0, iter_33_1 in ipairs(var_0_1[arg_33_1].custom_affix_id_list) do
			if ActivityAffixPoolCfg[iter_33_1] then
				table.insert(var_33_0, ActivityAffixPoolCfg[iter_33_1].affix)
			end
		end
...
function var_0_0.GetArtifactAffixList(arg_34_0, arg_34_1)
	if var_0_1[arg_34_1] then
		...
		for iter_34_0, iter_34_1 in ipairs(var_0_1[arg_34_1].artifact_list) do
			if MatrixItemCfg[iter_34_1.id] then
				local var_34_1 = MatrixTools.GetAffixByEffectId(MatrixItemCfg[iter_34_1.id].params[1], iter_34_1.wins)
...
function var_0_0.GetInitAffixList(arg_35_0, arg_35_1)
	...
	if ActivityMatrixCfg[arg_35_1] then
		for iter_35_0, iter_35_1 in pairs(ActivityMatrixInitEffectTemplateCfg[ActivityMatrixCfg[arg_35_1].init_effect_template_id].effect_list) do
			local var_35_1 = MatrixTools.GetAffixByEffectId(iter_35_1)
...
function var_0_0:GetTotalAffix(arg_36_1)
	local var_36_0 = {}

	table.insertto(var_36_0, self:GetAffixList(arg_36_1))
	table.insertto(var_36_0, self:GetArtifactAffixList(arg_36_1))
	table.insertto(var_36_0, self:GetInitAffixList(arg_36_1))
...
function var_0_0.CalMatrixAttribute(arg_37_0, arg_37_1)
	...
	if ActivityMatrixCfg[arg_37_1] then
		for iter_37_0, iter_37_1 in pairs(ActivityMatrixInitEffectTemplateCfg[ActivityMatrixCfg[arg_37_1].init_effect_template_id].effect_list) do
...
function var_0_0.GetMatrixPointCanReward(arg_42_0, arg_42_1)
	if var_0_1[arg_42_1] then
		for iter_42_0, iter_42_1 in ipairs(ActivityPointRewardCfg.get_id_list_by_activity_id[arg_42_1] or {}) do
			if var_0_1[arg_42_1].point >= ActivityPointRewardCfg[iter_42_1].need and not table.indexof(var_0_1[arg_42_1].got_reward_list, iter_42_1) then
				return true
			end
		end
	end
...
function var_0_0:SetClueRead(arg_48_1, arg_48_2)
	local var_48_0 = self:GetReadClueList(arg_48_1)
...
function var_0_0:GetClueRead(arg_49_1, arg_49_2)
	return table.indexof(self:GetReadClueList(arg_49_1), arg_49_2)
end

function var_0_0.GetReadClueList(arg_50_0, arg_50_1)
	var_0_5[arg_50_1] = var_0_5[arg_50_1] or getData("AcvityMatrixClue", tostring(arg_50_1))
