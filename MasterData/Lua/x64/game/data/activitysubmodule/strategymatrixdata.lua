...
function var_0_0.InitMatrixUser(arg_2_0, arg_2_1)
	...
	if var_0_1[arg_2_1.activity_id] then
		var_0_1[arg_2_1.activity_id]:SetData(arg_2_1)
	else
		var_0_1[arg_2_1.activity_id] = StrategyMartixUserTemplata.New(arg_2_1)
	end
...
function var_0_0.InitMatrixOver(arg_4_0, arg_4_1)
	if var_0_2[arg_4_1.activity_id] then
		var_0_2[arg_4_1.activity_id]:SetData(arg_4_1)

		return
	end

	var_0_2[arg_4_1.activity_id] = ActivityMartixOverTemplata.New(arg_4_1)
end
...
function var_0_0.GetHeroData(arg_15_0, arg_15_1)
	local var_15_0 = HeroStandardSystemCfg[var_0_1[var_0_6].matrix_hero_net_rec[arg_15_1]:GetStandardId()]
	local var_15_1 = {}

	for iter_15_0, iter_15_1 in pairs(var_0_1[var_0_6].matrix_hero_net_rec[arg_15_1].astrolabe_count_list) do
		for iter_15_2 = 1, iter_15_1 do
			table.insert(var_15_1, HeroAstrolabeCfg.get_id_list_by_hero_astrolabe_suit_id[iter_15_0][iter_15_2])
		end
	end

	var_0_3[SkinCfg[var_15_0.skin_id].hero] = var_0_3[SkinCfg[var_15_0.skin_id].hero] or StrategyMatrixHeroDataTemplate.New(SkinCfg[var_15_0.skin_id].hero)

	var_0_3[SkinCfg[var_15_0.skin_id].hero]:Init(var_15_0, var_0_1[var_0_6].matrix_hero_net_rec[arg_15_1].equip_list, var_15_1, {
		uid = 0,
		locked = true,
		id = var_0_1[var_0_6].matrix_hero_net_rec[arg_15_1]:GetWeaponServantEffect(),
		stage = var_0_1[var_0_6].matrix_hero_net_rec[arg_15_1]:GetWeaponServantEffectLevel()
	})

	return var_0_3[SkinCfg[var_15_0.skin_id].hero]
end
...
function var_0_0:GetEquipDataList(arg_18_1)
	return self:GetHeroData(arg_18_1).equip_list
end

function var_0_0:GetEquipDataListNew(arg_19_1)
	return self:GetHeroData(arg_19_1).equip_list_data
end
...
function var_0_0.GetHeroSkin(arg_23_0, arg_23_1, arg_23_2)
	...
	if var_23_0 then
		var_23_1 = var_23_0.using_skin or 0
...
function var_0_0.GetHeroSkinCfg(arg_24_0, arg_24_1, arg_24_2)
	...
	if var_24_0 then
		var_24_1 = var_24_0.using_skin or 0
...
function var_0_0.GetScoreAddition(arg_37_0, arg_37_1)
	if not var_0_1[arg_37_1].attribute_list[MatrixConst.MATRIX_ATTRIBUTE_TYPE.SCORE_ADDITION] then
		return 0
	end

	return var_0_1[arg_37_1].attribute_list[MatrixConst.MATRIX_ATTRIBUTE_TYPE.SCORE_ADDITION] / 1000
end

function var_0_0.GetGiveUpRewardAddition(arg_38_0, arg_38_1)
	if not var_0_1[arg_38_1].attribute_list[MatrixConst.MATRIX_ATTRIBUTE_TYPE.GIVE_UP_REWARD_ADDITION] then
		return 0
	end

	return var_0_1[arg_38_1].attribute_list[MatrixConst.MATRIX_ATTRIBUTE_TYPE.GIVE_UP_REWARD_ADDITION] / 1000
end
...
function var_0_0.GetAffixList(arg_40_0, arg_40_1)
	if var_0_1[arg_40_1] then
		...
		for iter_40_0, iter_40_1 in ipairs(var_0_1[arg_40_1].custom_affix_id_list) do
			if ActivityAffixPoolCfg[iter_40_1] then
				table.insert(var_40_0, ActivityAffixPoolCfg[iter_40_1].affix)
			end
		end
...
function var_0_0.GetArtifactAffixList(arg_41_0, arg_41_1)
	if var_0_1[arg_41_1] then
		...
		for iter_41_0, iter_41_1 in ipairs(var_0_1[arg_41_1].artifact_list) do
			if MatrixItemCfg[iter_41_1.id] then
				local var_41_1 = MatrixTools.GetAffixByEffectId(MatrixItemCfg[iter_41_1.id].params[1], iter_41_1.wins)
...
function var_0_0.GetInitAffixList(arg_42_0, arg_42_1)
	...
	if var_0_1[arg_42_1] then
		for iter_42_0, iter_42_1 in ipairs((var_0_1[arg_42_1]:GetEffectList())) do
			local var_42_1 = MatrixTools.GetAffixByEffectId(iter_42_1.id, iter_42_1.level)
...
function var_0_0:GetTotalAffix(arg_43_1)
	local var_43_0 = {}

	table.insertto(var_43_0, self:GetAffixList(arg_43_1))
	table.insertto(var_43_0, self:GetInitAffixList(arg_43_1))
...
function var_0_0.CalMatrixAttribute(arg_44_0, arg_44_1)
	...
	if var_0_1[arg_44_1] then
		for iter_44_0, iter_44_1 in ipairs((var_0_1[arg_44_1]:GetEffectList())) do
...
function var_0_0:GetViewDataType()
	return self.viewDataType
end
