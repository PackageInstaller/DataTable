...
function var_0_0.InitFromServer(arg_2_0, arg_2_1)
	...
	for iter_2_2, iter_2_3 in ipairs(arg_2_1.fish_info) do
		var_0_1.fish_infos[iter_2_3.id] = {
			id = iter_2_3.id,
			num = iter_2_3.num,
			len = iter_2_3.length
		}
...
function var_0_0.OnFishingResult(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_2) do
		var_0_1.fish_infos[iter_3_1.id] = {
			id = iter_3_1.id,
			num = iter_3_1.num,
			len = iter_3_1.length
		}
...
function var_0_0.OnReceiveFriendsFish(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	for iter_7_2, iter_7_3 in ipairs(arg_7_3) do
		var_0_1.fish_infos[iter_7_3.id] = {
			id = iter_7_3.id,
			num = iter_7_3.num,
			len = iter_7_3.length
		}
...
function var_0_0:OnGiveComplete(arg_8_1, arg_8_2, arg_8_3)
	self:RemoveFish(arg_8_2, arg_8_3)

	var_0_1.send_present_list[arg_8_1] = not var_0_1.send_present_list[arg_8_1] and 1 or var_0_1.send_present_list[arg_8_1] + 1
...
function var_0_0.OnGetGroupReward(arg_10_0, arg_10_1)
	for iter_10_0, iter_10_1 in ipairs(ActivitySummerFishGroupCfg[arg_10_1].group[1]) do
