...
function var_0_0.InitFromServer(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in ipairs(cleanProtoTable(arg_2_1.card_id_list)) do
		unlockCardMap[iter_2_1] = not unlockCardMap[iter_2_1] and 1 or unlockCardMap[iter_2_1] + 1
...
function var_0_0:GetStageHasUnlock(arg_7_1)
	return BloodCardGameStageCfg[arg_7_1].pre_id == 0 or self:GetStageHasPass(BloodCardGameStageCfg[arg_7_1].pre_id)
end

function var_0_0:GetNpcUnlock(arg_8_1, arg_8_2)
	return ActivityData:GetActivityIsOpen(arg_8_2) and self:GetStageHasUnlock(BloodCardGameNPCCfg[arg_8_1].stage_list[1])
end
...
function var_0_0.GetTaskActivityID(arg_15_0, arg_15_1)
	if arg_15_1 then
		if ActivityCfg[arg_15_1] then
			return ActivityCfg[arg_15_1].sub_activity_list[#ActivityCfg[arg_15_1].sub_activity_list]
		end
	end
...
function var_0_0:GetUnPassNpc()
	for iter_21_0, iter_21_1 in ipairs(BloodCardGameStageCfg.all) do
		if self:GetStageHasUnlock(iter_21_1) and not self:GetStageHasPass(iter_21_1) then
			for iter_21_2, iter_21_3 in ipairs(BloodCardGameNPCCfg.all) do
				if table.indexof(BloodCardGameNPCCfg[iter_21_3].stage_list, iter_21_1) then
					return iter_21_3
				end
			end
		end
...
function var_0_0:GetNpcIsUnlock(arg_22_1)
	for iter_22_0, iter_22_1 in ipairs(BloodCardGameNPCCfg[arg_22_1].stage_list) do
		if self:GetStageHasUnlock(iter_22_1) then
			return true
		end
	end
...
function var_0_0.GetAllCardIDSortList(arg_24_0)
	...
	for iter_24_0, iter_24_1 in ipairs(BloodCardGameCardCfg.all) do
...
function var_0_0.UnlockCard(arg_27_0, arg_27_1)
	unlockCardMap[arg_27_1] = unlockCardMap[arg_27_1] or 0
