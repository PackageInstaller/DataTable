local SummerRaceRewardData = class("SummerRaceRewardData")

function SummerRaceRewardData:ExportMethod()
	return {
...
function SummerRaceRewardData:BuildDefaultPendingUnlock(arg_2_1)
...
function SummerRaceRewardData:BuildDefaultPendingStageUnlockBanner(arg_3_1)
	return {
		shouldOpenPop = false,
		title = "",
		desc = "",
...
function SummerRaceRewardData:BuildFallbackStageUnlockBannerModel(arg_4_1, arg_4_2)
...
function SummerRaceRewardData:BuildUnlockPopItemFromRewardData(arg_5_1, arg_5_2)
	...
	if var_5_0 == 3 then
		...
		if var_5_2 then
			var_5_3.itemId = var_5_2.bodyId or var_5_1
		end

		var_5_3.itemName = tostring((var_5_2 or nil) and (var_5_2.bodyName or arg_5_2.rewardName or ""))
		var_5_3.iconPath = tostring((var_5_2 or nil) and (var_5_2.iconPath or var_5_2.icon or arg_5_2.iconPath or ""))
	...
	if var_5_0 ~= 1 then
		if var_5_0 == 2 then
			var_5_4 = arg_5_1:FindDefById(var_5_0 == 1 and arg_5_1:_GetWeaponDefs() or arg_5_1:_GetEquipDefs(), var_5_1)
		end
	end
	...
	if var_5_4 then
		var_5_5.itemId = var_5_4.itemId or var_5_1
	end

	var_5_5.itemName = tostring((var_5_4 or nil) and (var_5_4.itemName or arg_5_2.rewardName or ""))
	var_5_5.iconPath = tostring((var_5_4 or nil) and (var_5_4.iconPath or var_5_4.icon or arg_5_2.iconPath or ""))

	return var_5_5
end

function SummerRaceRewardData:BuildUnlockPopItemListFromRewardList(arg_6_1, arg_6_2, arg_6_3)
	local var_6_0 = {}
	...
	for iter_6_0 = 1, #arg_6_3 do
		local var_6_1 = arg_6_1:BuildUnlockPopItemFromRewardData((arg_6_1:BuildRewardEntry(arg_6_2, "clear", iter_6_0, arg_6_3[iter_6_0], "received", "1/1")))
...
function SummerRaceRewardData:BuildPendingUnlockModelFromStageReward(arg_7_1, arg_7_2)
	local var_7_0

	if type(arg_7_2) == "table" and type(arg_7_2.rewardList) == "table" then
		var_7_0 = arg_7_2.rewardList or nil

		local var_7_1

		if var_7_0 then
			var_7_1 = var_7_0[1] or nil
		end
	end
	...
	if var_7_6 ~= 1 then
		...
		elseif var_7_6 == 3 then
			local var_7_9 = arg_7_1:FindDefById(arg_7_1:_GetBodyDefs(), var_7_2.itemId)

			if var_7_9 then
				var_7_5 = tostring(var_7_9.desc or var_7_2.rewardName) or var_7_5
			end
		end
	end
	...
	if var_7_4 then
		var_7_11.itemId = var_7_4.itemId or var_7_2.itemId
	end

	var_7_11.itemName = tostring((var_7_4 or nil) and (var_7_4.itemName or var_7_2.rewardName or ""))
	var_7_11.itemDesc = tostring(var_7_5 or "")
	var_7_11.title = arg_7_1:ResolveTipsText("ACTIVITY_TANK_WEAPON_UNLOCK")
	var_7_11.bannerDesc = tostring(var_7_2.rewardName or "")
	var_7_11.unlockItemList = var_7_3

	return var_7_11
end

function SummerRaceRewardData:BuildPendingStageUnlockBannerModel(arg_8_1, arg_8_2, arg_8_3)
	local var_8_1 = arg_8_2 == SummerRaceConst.SOURCE_TYPE.CHALLENGE and arg_8_1:ResolveTipsText("ACTIVITY_TANK_CHALLAGE_UNLOCK") or arg_8_1:ResolveTipsText((tonumber(arg_8_3 and arg_8_3.modeType) or 0) == 3 and "ACTIVITY_TANK_PRACTICE_1V2_UNLOCK" or "ACTIVITY_TANK_PRACTICE_UNLOCK")
	local var_8_2 = {
		shouldOpenPop = true
	}

	if arg_8_2 == SummerRaceConst.SOURCE_TYPE.CHALLENGE then
		var_8_2.sourceType = SummerRaceConst.SOURCE_TYPE.CHALLENGE or SummerRaceConst.SOURCE_TYPE.REWARD
	end

	var_8_2.title = var_8_1
	var_8_2.desc = var_8_1

	return var_8_2
end

function SummerRaceRewardData:ResolveRewardName(arg_9_1, arg_9_2)
...
function SummerRaceRewardData:BuildRewardEntry(arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5, arg_10_6, arg_10_7)
	...
	if var_10_3 then
		var_10_4.rewardName = tostring(var_10_3.itemName or var_10_3.bodyName or "") or arg_10_1:ResolveRewardName(var_10_1)
	end

	var_10_4.rewardCount = var_10_2

	if var_10_3 then
		var_10_4.iconPath = tostring(var_10_3.iconPath or var_10_3.icon or "") or ""
	end

	var_10_4.progressText = arg_10_7 or "0/1"
	var_10_4.state = arg_10_6 or "locked"

	return var_10_4
end

function SummerRaceRewardData:AppendRewardEntry(arg_11_1, arg_11_2, arg_11_3, arg_11_4)
...
function SummerRaceRewardData:BuildStageRewardList(arg_12_1, arg_12_2, arg_12_3)
	local var_12_0 = {}
...
function SummerRaceRewardData:BuildChallengeRewardList(arg_13_1, arg_13_2)
	local var_13_0 = {}
	local var_13_1 = {}
	...
	for iter_13_0, iter_13_1 in ipairs({
		...
		for iter_13_2 = 1, #var_13_3 do
			...
			if var_13_3[iter_13_2] ~= nil then
				for iter_13_3 = 1, #(var_13_4.rewardList or {}) do
					if var_13_4.isCompleted ~= true then
						arg_13_1:AppendRewardEntry(var_13_0, var_13_1, (arg_13_1:BuildRewardEntry(var_13_4.stageId, "challengePreview", iter_13_3, var_13_4.rewardList[iter_13_3], var_13_4.isCompleted and "received" or var_13_4.isUnlocked and "canReceive" or "locked", var_13_4.isCompleted and "1/1" or var_13_4.isUnlocked and "0/1" or "0/1")))
					end
				end
			end
		end
	...
	for iter_13_4, iter_13_5 in ipairs({
		...
		for iter_13_6 = 1, #var_13_6 do
			...
			if var_13_6[iter_13_6] ~= nil then
...
function SummerRaceRewardData:GetAssignmentIdListByActivityId(arg_14_1, arg_14_2)
	...
	if AssignmentCfg then
		var_14_0 = AssignmentCfg.get_id_list_by_activity_id or nil
...
function SummerRaceRewardData:GetTaskProgressValue(arg_15_1, arg_15_2)
	local var_15_0

	if TaskData2 == nil or TaskData2.GetTaskProgress == nil then
		do return 0 end

		var_15_0 = tonumber(TaskData2:GetTaskProgress(arg_15_2)) or 0
	end

	return math.max(0, var_15_0)
end

function SummerRaceRewardData:IsTaskComplete(arg_16_1, arg_16_2)
	return TaskData2 ~= nil and TaskData2.GetTaskComplete ~= nil and TaskData2:GetTaskComplete(arg_16_2) == true
end

function SummerRaceRewardData:IsTaskFinishedOrReceivable(arg_17_1, arg_17_2)
	local var_17_1

	if AssignmentCfg then
		local var_17_0 = AssignmentCfg[arg_17_2] or nil
		...
		if var_17_0 ~= nil then
			if arg_17_1:GetTaskProgressValue(arg_17_2) < (tonumber(var_17_0.need) or 0) then
				var_17_1 = false
...
function SummerRaceRewardData:BuildTaskRewardList(arg_18_1, arg_18_2, arg_18_3)
	...
	for iter_18_0 = 1, #var_18_0 do
		...
		if AssignmentCfg[var_18_0[iter_18_0]] ~= nil then
			local var_18_3 = arg_18_3[var_18_2.id]
			local var_18_4

			if type(var_18_2.reward) == "table" then
				var_18_4 = var_18_2.reward[1] or nil

				local var_18_5

				if var_18_4 then
					var_18_5 = var_18_4[1] or 0
				end
			end
			...
			local var_18_10 = #var_18_1 + 1
			local var_18_11 = {
				rewardId = var_18_2.id
			}

			var_18_11.rewardName = var_18_5 ~= 0 and arg_18_1:ResolveRewardName(var_18_5) or arg_18_1:ResolveDisplayText(var_18_2.name)
			var_18_11.rewardCount = var_18_6
			var_18_11.progressText = string.format("%d/%d", var_18_8, var_18_7)
			var_18_11.state = var_18_9
			var_18_11.taskName = arg_18_1:ResolveDisplayText(var_18_2.name)
			var_18_11.taskDesc = arg_18_1:ResolveDisplayText(var_18_2.desc)
			var_18_11.activityId = arg_18_2
			var_18_1[var_18_10] = var_18_11
		end
	end
...
function SummerRaceRewardData:BuildPreviewRewardList(arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	local var_19_0

	if ActivityCfg then
		var_19_0 = ActivityCfg[SummerRaceConst.ACTIVITY_ID.MAIN] or nil
	end

	local var_19_1 = {}

	if var_19_0 ~= nil then
		var_19_1 = arg_19_2 == SummerRaceConst.REWARD_PAGE.RESIDENT and (var_19_0.reward_show_permanent or {}) or var_19_0.reward_show or {}
	end
	...
	for iter_19_0 = 1, #var_19_1 do
		...
		var_19_5.state = arg_19_4[var_19_4] or iter_19_0 == 1 and "canReceive" or "locked"
		var_19_2[#var_19_2 + 1] = var_19_5
	end

	if #var_19_2 == 0 then
		local var_19_7 = (SummerRaceConst.REWARD_DEFS[arg_19_2] or {})[arg_19_3] or {}

		for iter_19_1 = 1, #var_19_7 do
			local var_19_8 = arg_19_1:CloneTable(var_19_7[iter_19_1])

			var_19_8.state = arg_19_4[var_19_8.rewardId] or var_19_8.state
			var_19_2[#var_19_2 + 1] = var_19_8
		end
	end
...
function SummerRaceRewardData:BuildRewardPageModelFromCfg(arg_20_1, arg_20_2, arg_20_3, arg_20_4)
	local var_20_0 = arg_20_1:ResolveRewardActivityId(arg_20_2, arg_20_3)
	local var_20_1

	if var_20_0 ~= 0 and LimitTimeTaskCfg then
		var_20_1 = LimitTimeTaskCfg[var_20_0] or nil
	end
...
function SummerRaceRewardData:BuildResidentRewardEntryModel(arg_21_1)
	local var_21_0 = arg_21_1:GetAssignmentIdListByActivityId(ActivityConst.ACTIVITY_SUMMER_RACE_MAIN)
	local var_21_1 = 0
	...
	return {
		activityId = ActivityConst.ACTIVITY_SUMMER_RACE_MAIN,
		completedCount = var_21_1,
		totalCount = #var_21_0,
		progressText = string.format("<size=48>%d</size>/%d", math.max(0, var_21_1), math.max(0, #var_21_0))
	}
end

function SummerRaceRewardData:SetRewardPage(arg_22_1, arg_22_2, arg_22_3, arg_22_4)
...
function SummerRaceRewardData:GetRewardPageSelection(arg_23_1)
	return arg_23_1.outGameState_.rewardPageType, arg_23_1.outGameState_.rewardSubType
end

function SummerRaceRewardData:GetRewardRootActivityId(arg_24_1)
	return arg_24_1:GetSummerRaceTaskRootActivityId()
end

function SummerRaceRewardData:GetRewardActivityId(arg_25_1, arg_25_2, arg_25_3)
	local var_25_0

	if arg_25_2 ~= nil then
		var_25_0 = arg_25_1:NormalizeRewardPageType(arg_25_2)

		if not var_25_0 then
			if arg_25_3 ~= nil then
				var_25_0 = SummerRaceConst.REWARD_PAGE.LIMITED or arg_25_1.outGameState_.rewardPageType
			end
		end
	end

	return arg_25_1:ResolveRewardActivityId(var_25_0, (arg_25_1:NormalizeRewardSubType(arg_25_3 or arg_25_1.outGameState_.rewardSubType)))
end

function SummerRaceRewardData:ResolveRewardEntryPage(arg_26_1, arg_26_2, arg_26_3)
	...
	if arg_26_2 == SummerRaceConst.REWARD_PAGE.LIMITED or arg_26_3 ~= nil then
		...
		for iter_26_0 = 1, #SummerRaceConst.LIMITED_ENTRY_SUBTYPE_PRIORITY do
			local var_26_1 = arg_26_1:BuildRewardPageModelFromCfg(SummerRaceConst.REWARD_PAGE.LIMITED, SummerRaceConst.LIMITED_ENTRY_SUBTYPE_PRIORITY[iter_26_0], var_26_0).rewardList or {}

			for iter_26_1 = 1, #var_26_1 do
				if var_26_1[iter_26_1].state == "canReceive" then
					return SummerRaceConst.REWARD_PAGE.LIMITED, SummerRaceConst.LIMITED_ENTRY_SUBTYPE_PRIORITY[iter_26_0]
				end
			end
		end

		local var_26_2 = arg_26_1:NormalizeRewardSubType(arg_26_1.outGameState_.rewardSubType)

		if arg_26_1:BuildRewardPageModelFromCfg(SummerRaceConst.REWARD_PAGE.LIMITED, var_26_2, var_26_0).emptyState ~= true then
			return SummerRaceConst.REWARD_PAGE.LIMITED, var_26_2
		end

		return SummerRaceConst.REWARD_PAGE.LIMITED, SummerRaceConst.REWARD_SUBTYPE.DAILY
	end

	local var_26_3 = arg_26_1.outGameState_.rewardStateMap

	for iter_26_2 = 1, #SummerRaceConst.REWARD_ENTRY_PRIORITY do
		local var_26_4 = arg_26_1:BuildRewardPageModelFromCfg(SummerRaceConst.REWARD_ENTRY_PRIORITY[iter_26_2][1], SummerRaceConst.REWARD_ENTRY_PRIORITY[iter_26_2][2], var_26_3).rewardList or {}

		for iter_26_3 = 1, #var_26_4 do
			if var_26_4[iter_26_3].state == "canReceive" then
				return SummerRaceConst.REWARD_ENTRY_PRIORITY[iter_26_2][1], SummerRaceConst.REWARD_ENTRY_PRIORITY[iter_26_2][2]
			end
		end
	end

	local var_26_5, var_26_6 = arg_26_1:GetRewardPageSelection()

	if arg_26_1:BuildRewardPageModelFromCfg(var_26_5, var_26_6, var_26_3).emptyState ~= true then
		return var_26_5, var_26_6
	end

	return SummerRaceConst.REWARD_PAGE.LIMITED, SummerRaceConst.REWARD_SUBTYPE.DAILY
end

function SummerRaceRewardData:MarkRewardReceived(arg_27_1, arg_27_2, arg_27_3)
...
function SummerRaceRewardData:TryPrepareStageFirstClearUnlock(arg_28_1, arg_28_2, arg_28_3, arg_28_4)
...
function SummerRaceRewardData:ConsumePendingUnlockPopModel(arg_29_1)
...
function SummerRaceRewardData:ConsumePendingStageUnlockBannerModel(arg_30_1)
	local var_30_0 = arg_30_1.outGameState_.pendingStageUnlockBannerQueue
	local var_30_1

	if type(arg_30_1.outGameState_.pendingStageUnlockBannerQueue) == "table" and #var_30_0 > 0 then
...
function SummerRaceRewardData:GetRewardPageModel(arg_31_1, arg_31_2, arg_31_3)
...
function SummerRaceRewardData:GetPendingUnlockModel(arg_32_1)
	return arg_32_1:CloneTable(arg_32_1.outGameState_.pendingUnlockModel)
end

function SummerRaceRewardData:GetPendingStageUnlockBannerModel(arg_33_1)
	return arg_33_1:CloneTable(arg_33_1.outGameState_.pendingStageUnlockBannerModel)
end

function SummerRaceRewardData:GetUnlockPopViewModel(arg_34_1)
	...
	if type(var_34_1) ~= "table" or #var_34_1 == 0 then
		...
		local var_34_3 = arg_34_1:GetOptionDefById(var_34_0.itemId)
		local var_34_4
		...
		if var_34_3 ~= nil then
			...
			var_34_5.itemName = tostring(var_34_3.itemName or var_34_0.itemName or "")
			var_34_5.iconPath = tostring(var_34_3.iconPath or var_34_3.icon or "")
			var_34_4 = var_34_5
		else
			local var_34_6 = arg_34_1:GetBodyDefs()
			local var_34_7

			for iter_34_0 = 1, #var_34_6 do
				if tostring(var_34_6[iter_34_0].bodyId or "") == tostring(var_34_2 or "") then
					var_34_7 = var_34_6[iter_34_0]
			...
			if var_34_7 then
				var_34_9.itemId = var_34_7.bodyId or var_34_2
			end

			var_34_9.itemName = tostring((var_34_7 or nil) and (var_34_7.bodyName or var_34_0.itemName or ""))
			var_34_9.iconPath = tostring((var_34_7 or nil) and (var_34_7.iconPath or var_34_7.icon or ""))
			var_34_9.isCar = var_34_7 ~= nil
			var_34_4 = var_34_9
		end
...
function SummerRaceRewardData:GetUnlockBannerModel(arg_35_1, arg_35_2)
	...
	if var_35_0.title == nil or var_35_2 == "" then
