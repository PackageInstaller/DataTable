...
function var_0_0.InitData(arg_2_0, arg_2_1)
	if not var_0_1[arg_2_1.activity_id] then
		...
		var_0_1[arg_2_1.activity_id].isOpen = arg_2_1.clear_state == 0
	end

	var_0_1[arg_2_1.activity_id].isClear = arg_2_1.clear_state ~= 0
	var_0_1[arg_2_1.activity_id].isReward = arg_2_1.reward_state ~= 0
	var_0_1[arg_2_1.activity_id].point = arg_2_1.point or 0
	var_0_1[arg_2_1.activity_id].answerQuestionID = cleanProtoTable(arg_2_1.qa_list)
	var_0_1[arg_2_1.activity_id].selectQuestionID = cleanProtoTable(arg_2_1.choose_list)
end
...
function var_0_0:SetPoint(arg_7_1, arg_7_2)
	var_0_1[arg_7_1].point = arg_7_2

	self:SetClear(arg_7_1)
end
...
function var_0_0:GetStoryIDIsGetReward(arg_16_1)
	if table.indexof(self.gotRewardStoryIDList_, arg_16_1) then
		return true
	else
		return false
	end
...
function var_0_0:StoryIDGetReward(arg_17_1)
	table.insert(self.gotRewardStoryIDList_, arg_17_1)
end
