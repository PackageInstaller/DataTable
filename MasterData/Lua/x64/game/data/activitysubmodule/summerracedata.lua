...
function var_0_0.NormalizeServerTankBuild(arg_145_0, arg_145_1)
	...
	local var_145_6 = 1
	local var_145_7 = #(var_145_5.weaponMounts or {})
	local var_145_8 = #(var_145_5.equipMounts or {})
	local var_145_9 = var_0_0:_GetWeaponDefs()
	local var_145_10 = var_0_0:_GetEquipDefs()

	for iter_145_0 = 1, #var_145_3 do
		local var_145_11 = tonumber(var_145_3[iter_145_0]) or var_145_3[iter_145_0]
		local var_145_12 = var_0_0:FindDefById(var_145_9, var_145_11) or var_0_0:FindDefById(var_145_10, var_145_11)

		if var_145_12 == nil then
			error("[SummerRaceData] unknown server tank option id: " .. tostring(var_145_11))
		end

		if var_145_12.typeText == SummerRaceConst.FILTER.WEAPON then
			if var_145_7 < var_145_6 then
				error("[SummerRaceData] server weapon_list overflow weapon slots, bodyId=" .. tostring(var_145_2.bodyId) .. ", optionId=" .. tostring(var_145_11))
			end

			var_145_4.weaponIds[var_145_6] = var_145_11
			var_145_6 = var_145_6 + 1
		else
			local var_145_13

			if var_145_12.typeText == SummerRaceConst.FILTER.EQUIP then
				if var_145_8 < 1 then
					error("[SummerRaceData] server weapon_list overflow equip slots, bodyId=" .. tostring(var_145_2.bodyId) .. ", optionId=" .. tostring(var_145_11))
				end

				var_145_4.equipIds[1] = var_145_11
				var_145_13 = 1 + 1
			else
				error("[SummerRaceData] invalid server option type for optionId=" .. tostring(var_145_11))
			end
		end
	end
