...
function var_0_0:Init()
	...
	var_0_27 = nil
	var_0_28 = nil
	var_0_22 = self:GetMusicActThemeList()
	var_0_26 = {}
...
function var_0_0.InitMusicData(arg_2_0, arg_2_1)
	for iter_2_0, iter_2_1 in ipairs(arg_2_1.challenge_info) do
		var_0_1[iter_2_1.id] = {
...
function var_0_0.GetTagImagePath(arg_4_0, arg_4_1)
	if ActivityMusicCfg[arg_4_1].tagname and ActivityMusicCfg[arg_4_1].tagname ~= "" then
		return "TextureConfig/Music/Music_CollabLogo/" .. ActivityMusicCfg[arg_4_1].tagname
	else
		return nil
	end
end
...
function var_0_0.ModifGameData(arg_12_0, arg_12_1)
	...
	if var_0_4[arg_12_1] then
		var_0_4[arg_12_1] = var_0_4[arg_12_1] + 1 or 1
	end
end
...
function var_0_0.GetSpeedValue(arg_27_0, arg_27_1)
	var_0_7 = var_0_7 or {}
	var_0_7[arg_27_1] = var_0_7[arg_27_1] or getData("Music", "TrackSpeed" .. tostring(arg_27_1))
...
function var_0_0:GetSpeedData(arg_29_1)
	local var_29_0 = self:GetSpeedValue(arg_29_1)

	return 45.833333333333336 * var_29_0 * var_29_0 - 562.5 * var_29_0 + 2016.6666666666667
end

function var_0_0:GetConstantSpeed()
	return (self:GetSpeedValue(MusicConst.MusicTrackType.Constant_Slope))
end

function var_0_0.GetJudgeValue(arg_31_0)
	var_0_8 = var_0_8 or getData("Music", "Judge")
...
function var_0_0:GetJudgeData()
	local var_33_0 = self:GetJudgeValue()
...
function var_0_0.GetScreanValue(arg_34_0)
	var_0_9 = var_0_9 or getData("Music", "Screan")
...
function var_0_0:GetScreanData()
	local var_36_0 = self:GetScreanValue()
...
function var_0_0.GetVolumeValue(arg_37_0)
	var_0_10 = var_0_10 or getData("Music", "Volume")
...
function var_0_0:GetVolumeData()
	return math.abs((self:GetVolumeValue())) / 100
end

function var_0_0.GetShowMovie(arg_40_0)
	var_0_11 = var_0_11 or getData("Music", "ShowMovie")
...
function var_0_0.GetVerical(arg_42_0)
	var_0_13 = var_0_13 or getData("Music", "isVertical")
...
function var_0_0.GetTrackPathType(arg_44_0)
	var_0_14 = var_0_14 or getData("Music", "useTrackPathType")
...
function var_0_0.GetSpectralType(arg_46_0)
	var_0_15 = var_0_15 or getData("Music", "SpectralType")
...
function var_0_0:GetSpectralAndVercialSDKKey()
	local var_48_0 = "[" .. self:GetSpectralType() + 1 .. ","

	var_48_0 = self:GetVerical() and var_48_0 .. 1 or var_48_0 .. 2

	return var_48_0 .. "]"
end

function var_0_0:GetSpectralSendData()
	local var_49_0 = {}

	table.insert(var_49_0, self:GetSpectralType() + 1)

	if self:GetVerical() then
...
function var_0_0.GetMixValue(arg_50_0)
	var_0_16 = var_0_16 or getData("Music", "MixRangeValue")
...
function var_0_0.GetPlayKeyEffectSound(arg_52_0)
	var_0_12 = var_0_12 or getData("Music", "PlayKeyEffectSound")
...
function var_0_0.GetDifficultyIndex(arg_54_0, arg_54_1)
	...
	var_0_17[arg_54_1] = var_0_17[arg_54_1] or getData("Music", "SelectDiffcult" .. tostring(arg_54_1))
...
function var_0_0.GetTrackCount(arg_56_0, arg_56_1)
	...
	var_0_18[arg_56_1] = var_0_18[arg_56_1] or getData("Music", "SelectTrackCount" .. tostring(arg_56_1))
...
function var_0_0.GetSelectIndex(arg_61_0)
	var_0_20[arg_61_0] = var_0_20[arg_61_0] or getData("MusicSelect", tostring(arg_61_0))
...
function var_0_0.GetAisacSet(arg_62_0, arg_62_1)
	...
	if MusicRecordCfg[arg_62_1] and MusicRecordCfg[arg_62_1].initAISAC ~= "" then
		for iter_62_0, iter_62_1 in ipairs(MusicRecordCfg[arg_62_1].initAISAC) do
...
function var_0_0:GetNowMusicUINameList()
	return self:GetMusicUINameList(var_0_24)
end

function var_0_0:GetMusicUINameList(arg_64_1)
	return MusicConst.MusicViewUIName[self:GetMusicViewType(arg_64_1)]
end

function var_0_0:GetMusicViewPathList(arg_65_1, arg_65_2)
	return MusicConst.MusicViewRoutesName[self:GetMusicViewType(arg_65_1, arg_65_2)]
end

function var_0_0:GetMusicViewType(arg_66_1, arg_66_2)
	return self:GetMusicTypeByTheme((ActivityTools.GetActivityTheme(var_0_24)))
end
...
function var_0_0:GetTrackKeySetData(arg_77_1)
	if not var_0_26[arg_77_1] then
		local var_77_0 = getData("Music", "Key_Set" .. arg_77_1)

		var_0_26[arg_77_1] = var_77_0 and var_77_0 or self:GetDefaultKeyData(arg_77_1)
	end
...
function var_0_0.GetActivityTaskID(arg_80_0, arg_80_1)
	...
	for iter_80_0, iter_80_1 in pairs(ActivityCfg[arg_80_1].sub_activity_list) do
		if ActivityCfg[iter_80_1] and ActivityCfg[iter_80_1].activity_template == ActivityTemplateConst.TASK then
			var_80_0 = iter_80_1
