...
function var_0_0.SetParkourEntrustReward(arg_6_0, arg_6_1, arg_6_2)
	if var_0_2[arg_6_1] then
		table.insert(var_0_2[arg_6_1].rewards, arg_6_2)
	end
end
...
function var_0_0.GetStarCount(arg_9_0, arg_9_1)
	if var_0_2[arg_9_1] then
		if table.indexof(var_0_2[arg_9_1].stars, 4) then
			return #var_0_2[arg_9_1].stars - 1
		else
			return #var_0_2[arg_9_1].stars
		end
	end
...
function var_0_0.GetCollectRedList(arg_13_0, arg_13_1)
	var_0_4[arg_13_1] = var_0_4[arg_13_1] or getData("Parkour", tostring(arg_13_1))
...
function var_0_0:SetParkourCollectRedPoint(arg_14_1, arg_14_2)
	local var_14_0 = self:GetCollectRedList(arg_14_1)
