...
function var_0_0.Init(arg_1_0)
	...
	for iter_1_0, iter_1_1 in ipairs(SwimsuitBattleInfoCfg.all) do
		...
		for iter_1_2 = 1, #SwimsuitBattleInfoCfg[iter_1_1].hero_list do
			table.insert(var_0_4[iter_1_1], {
				heroID = SwimsuitBattleInfoCfg[iter_1_1].hero_list[iter_1_2],
				skinID = SwimsuitBattleInfoCfg[iter_1_1].skin_id[iter_1_2],
				activityID = SwimsuitBattleInfoCfg[iter_1_1].subactivity_list[iter_1_2]
			})
		end
	end
...
function var_0_0.GetVoteTicketInfo(arg_9_0, arg_9_1)
	return SwimsuitBattleInfoCfg[arg_9_1].voting_ticket_id, var_0_2, SwimsuitBattleInfoCfg[arg_9_1].voting_ticket_limit
end
...
function var_0_0.CheckInRoundTime(arg_22_0)
	...
	if manager.time:GetServerTime() < var_0_7[var_0_8].startTime then
...
function var_0_0.GetTaskIdByRound(arg_23_0, arg_23_1)
	if not arg_23_1 then
		return AssignmentCfg.get_id_list_by_activity_id[SwimsuitBattleInfoCfg[var_0_1].vote_activity_id]
	end

	local var_23_0 = {}

	for iter_23_0, iter_23_1 in ipairs(AssignmentCfg.get_id_list_by_activity_id[SwimsuitBattleInfoCfg[var_0_1].vote_activity_id]) do
