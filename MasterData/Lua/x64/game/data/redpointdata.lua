...
function var_0_0:InitRedPointS(arg_2_1)
	for iter_2_0, iter_2_1 in ipairs(arg_2_1) do
		self:SetNeedRedPointOpen(iter_2_1, true)
	end
end
...
function var_0_0:InitClientRedPoint(arg_4_1)
	for iter_4_0, iter_4_1 in ipairs(arg_4_1) do
		self:SetRedPointOpen(iter_4_1, true)
	end
end
...
function var_0_0:UpdateRedPoint(arg_12_1)
	if arg_12_1 == ActivityConst.CHESS_ACTIVITY_CHINESE_ZONE then
		if ActivityData:GetActivityIsOpen(ActivityConst.CHESS_ACTIVITY_CHINESE_ZONE) then
			manager.redPoint:setTip(RedPointConst.WARCHESS_CHINESE .. "_" .. ActivityConst.CHESS_ACTIVITY_CHINESE_ZONE, self:GetJsonCacheRedPoint(RedPointConst.WARCHESS_CHINESE .. "_" .. ActivityConst.CHESS_ACTIVITY_CHINESE_ZONE))
		else
			manager.redPoint:setTip(RedPointConst.WARCHESS_CHINESE .. "_" .. ActivityConst.CHESS_ACTIVITY_CHINESE_ZONE, 0)
		end
	end
end
