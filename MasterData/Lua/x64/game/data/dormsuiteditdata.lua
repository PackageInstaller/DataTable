...
function var_0_0.GetFurNumInfoInSuit(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	if var_4_0 then
		for iter_4_0, iter_4_1 in ipairs(var_4_0.suit_num) do
	...
	return var_4_1, (BackHomeSuitCfg[arg_4_1] and BackHomeSuitCfg[arg_4_1].type == DormSuitTools.DORM_SUIT_TYPE.FULL_SET or nil) and DormRoomTools:GetHasPlaceFurInfoByRoom(arg_4_2, arg_4_3) + DormFurEditStateData:GetCanUseFurNumInRoom(arg_4_2, arg_4_3) + DormFurEditStateData:GetCacheFurNum(arg_4_3)
end
