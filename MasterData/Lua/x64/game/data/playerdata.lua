...
function var_0_0:GetPlayerInfo()
	var_0_1.icon_frame = self:GetCurFrame()
	var_0_1.card_bg_id = self:GetCurCardBg()
...
function var_0_0.EXPChange(arg_16_0, arg_16_1)
	...
	if var_0_1.userLevel ~= var_0_1.userLevel then
		manager.notify:Invoke(PLAYER_LEVEL_UP, var_0_1.userLevel, var_0_1.userLevel)
		ChapterResidentTools.SetNewTag()
		SDKTools.SetDefaultPublicAttribute()
		SendMessageManagerToSDK("role_level", {
			level = var_0_1.userLevel
		})
	end
end
...
function var_0_0.PlayerCardInit(arg_17_0, arg_17_1)
	...
	if arg_17_1.sticker_background ~= 0 then
		var_0_1.show_sticker_flag = arg_17_1.sticker_background or GameSetting.sticker_background_default.value[1]
	end
	...
	var_0_1.poster_girl = arg_17_1.poster_girl and arg_17_1.poster_girl ~= 0 and arg_17_1.poster_girl or 1084
	var_0_1.portrait = arg_17_1.icon and arg_17_1.icon ~= 0 and arg_17_1.icon ~= 1 and arg_17_1.icon or GameSetting.profile_avatar_default.value[1]
	var_0_1.icon_frame = arg_17_1.icon_frame and arg_17_1.icon_frame ~= 0 and arg_17_1.icon_frame ~= 1 and arg_17_1.icon_frame or GameSetting.profile_avatar_frame_default.value[1]
...
function var_0_0:InitStickerShowList(arg_18_1, arg_18_2)
	local var_18_0 = {}

	for iter_18_0, iter_18_1 in ipairs(arg_18_1) do
		local var_18_1 = {}

		var_18_1.foreground = iter_18_1.foreground or 0
		var_18_1.sticker = {}
		var_18_1.hierarchy = {}
		var_18_0[iter_18_1.page_id] = var_18_1
	...
	if not arg_18_2 then
		for iter_18_4, iter_18_5 in ipairs(self:GetStickerBgList()) do
			var_18_0[iter_18_5] = var_18_0[iter_18_5] or {
				foreground = 0,
				sticker = {},
				hierarchy = {}
			}
...
function var_0_0:InitOverdueFrameList(arg_20_1)
	if #arg_20_1 > 0 then
		for iter_20_0, iter_20_1 in ipairs(arg_20_1) do
			if not self:CheckOverdueRepeat(iter_20_1.id, var_0_8) then
...
function var_0_0:InitOverduePortraitList(arg_21_1)
	if #arg_21_1 > 0 then
		for iter_21_0, iter_21_1 in ipairs(arg_21_1) do
			if not self:CheckOverdueRepeat(iter_21_1.id, var_0_9) then
				table.insert(var_0_9, {
					id = iter_21_1.id,
					num = iter_21_1.num,
					timeValid = iter_21_1.time_valid
				})
			end
		end
	end
...
function var_0_0:InitOverdueChatBubbleList(arg_22_1)
	if #arg_22_1 > 0 then
		for iter_22_0, iter_22_1 in ipairs(arg_22_1) do
			if not self:CheckOverdueRepeat(iter_22_1.id, var_0_10) then
				table.insert(var_0_10, {
					id = iter_22_1.id,
					num = iter_22_1.num,
					timeValid = iter_22_1.time_valid
				})
			end
		end
	end
...
function var_0_0:InitOverdueCardBgList(arg_23_1)
	if #arg_23_1 > 0 then
		for iter_23_0, iter_23_1 in ipairs(arg_23_1) do
			if not self:CheckOverdueRepeat(iter_23_1.id, var_0_15) then
...
function var_0_0:InitOverdueTagList(arg_24_1)
	if #arg_24_1 > 0 then
		for iter_24_0, iter_24_1 in ipairs(arg_24_1) do
			if not self:CheckOverdueRepeat(iter_24_1.id, var_0_17) then
...
function var_0_0.ChangeLevel(arg_35_0, arg_35_1)
	var_0_1.levelUpInfos = var_0_1.levelUpInfos or {}
...
function var_0_0.InitStickerList(arg_39_0)
	...
	for iter_39_0, iter_39_1 in ipairs(ProfileDecorateItemCfg.all) do
		if ProfileDecorateItemCfg[iter_39_1].item_type == 4 then
			var_0_4[iter_39_1] = {
				suit = 0,
				lock = true,
				page = iter_39_1
			}
		elseif ProfileDecorateItemCfg[iter_39_1].item_type == 5 then
			var_0_5[iter_39_1] = {
				suit = 0,
				lock = true,
				page = 0
			}
		elseif ProfileDecorateItemCfg[iter_39_1].item_type == 6 then
			var_0_3[iter_39_1] = {
				suit = 0,
				lock = true,
				page = 0
	...
	for iter_39_8, iter_39_9 in ipairs(StickerSuitCfg.all) do
		for iter_39_10, iter_39_11 in ipairs(StickerSuitCfg[iter_39_9].content) do
			if ProfileDecorateItemCfg[iter_39_11].item_type == 4 then
				var_0_4[iter_39_11].suit = iter_39_9
			elseif ProfileDecorateItemCfg[iter_39_11].item_type == 5 then
				var_0_5[iter_39_11].suit = iter_39_9
			elseif ProfileDecorateItemCfg[iter_39_11].item_type == 6 then
...
local function var_0_19(arg_40_0)
	return arg_40_0.lasted_time == 0 or manager.time:GetServerTime() < arg_40_0.lasted_time
end
...
function var_0_0.InitPortraitList(arg_41_0)
	...
	for iter_41_0, iter_41_1 in ipairs(ItemCfg.get_id_list_by_type[ItemConst.ITEM_TYPE.PORTRAIT]) do
		var_0_6[iter_41_1] = {
			lasted_time = 0,
			unlock = 0,
			id = iter_41_1
	...
	for iter_41_2, iter_41_3 in ipairs(var_0_1.unlocked_portraits) do
		if var_0_19(iter_41_3) then
			var_0_6[iter_41_3.id].unlock = 1
			var_0_6[iter_41_3.id].lasted_time = iter_41_3.lasted_time
		end
	end
end
...
function var_0_0.InitChatBubbleList(arg_42_0)
	...
	for iter_42_0, iter_42_1 in ipairs(ItemCfg.get_id_list_by_type[ItemConst.ITEM_TYPE.CHAT_BUBBLE]) do
		var_0_13[iter_42_1] = {
			lasted_time = 0,
			unlock = 0,
			id = iter_42_1
	...
	for iter_42_2, iter_42_3 in ipairs(var_0_1.chat_bubble_unlock_list) do
		local var_42_0 = manager.time:GetServerTime()

		if var_0_19(iter_42_3) then
			var_0_13[iter_42_3.id].unlock = 1
			var_0_13[iter_42_3.id].lasted_time = iter_42_3.lasted_time
		end
	end
end
...
function var_0_0.InitFrameList(arg_43_0)
	...
	for iter_43_0, iter_43_1 in ipairs(ItemCfg.get_id_list_by_type[ItemConst.ITEM_TYPE.FRAME]) do
		var_0_7[iter_43_1] = {
			lasted_time = 0,
			unlock = 0,
			id = iter_43_1
	...
	for iter_43_2, iter_43_3 in ipairs(var_0_1.icon_frame_list) do
		if var_0_19(iter_43_3) then
			var_0_7[iter_43_3.id].unlock = 1
			var_0_7[iter_43_3.id].lasted_time = iter_43_3.lasted_time
		end
	end
end
...
function var_0_0.InitCardBgList(arg_44_0)
	...
	for iter_44_0, iter_44_1 in ipairs(ItemCfg.get_id_list_by_type[ItemConst.ITEM_TYPE.CARD_BG]) do
		var_0_14[iter_44_1] = {
			lasted_time = 0,
			unlock = 0,
			id = iter_44_1
	...
	for iter_44_2, iter_44_3 in ipairs(var_0_1.card_background_list) do
		if var_0_19(iter_44_3) then
			var_0_14[iter_44_3.id].unlock = 1
			var_0_14[iter_44_3.id].lasted_time = iter_44_3.lasted_time
		end
	end
end
...
function var_0_0.InitTagInfoList(arg_45_0)
	...
	for iter_45_0, iter_45_1 in ipairs(ItemCfg.get_id_list_by_type[ItemConst.ITEM_TYPE.TAG]) do
		var_0_16[iter_45_1] = {
			obtain_time = 0,
			lasted_time = 0,
			unlock = 0,
	...
	for iter_45_2, iter_45_3 in ipairs(var_0_1.tag_info_list) do
		if var_0_19(iter_45_3) then
			var_0_16[iter_45_3.id].unlock = 1
			var_0_16[iter_45_3.id].lasted_time = iter_45_3.lasted_time
			var_0_16[iter_45_3.id].obtain_time = iter_45_3.obtain_time
		end
	end
end
...
function var_0_0:GetCurFrame()
	if var_0_7[var_0_1.icon_frame] and var_0_7[var_0_1.icon_frame].lasted_time > 0 and var_0_7[var_0_1.icon_frame].unlock == 1 and var_0_7[var_0_1.icon_frame].lasted_time < manager.time:GetServerTime() then
		self:RefreshFrameList(function()
...
function var_0_0:GetCurCardBg()
	if var_0_14[var_0_1.card_bg_id] and var_0_14[var_0_1.card_bg_id].unlock == 1 and var_0_14[var_0_1.card_bg_id].lasted_time > 0 and var_0_14[var_0_1.card_bg_id].lasted_time < manager.time:GetServerTime() then
		self:LockCardBg(var_0_1.card_bg_id)
...
local function var_0_22(arg_63_0, arg_63_1)
	return ItemCfg[arg_63_0] and ItemCfg[arg_63_0].sub_type == arg_63_1
end
...
function var_0_0.SetStickerPage(arg_66_0, arg_66_1, arg_66_2)
	if var_0_5[arg_66_1] then
		var_0_5[arg_66_1].page = arg_66_2
	end
end
...
function var_0_0.SetStickerFgPage(arg_71_0, arg_71_1, arg_71_2)
	if var_0_3[arg_71_1] then
		var_0_3[arg_71_1].page = arg_71_2
	end
end

function var_0_0:ClearStickerCollectPageRedPoint(arg_72_1)
	local var_72_0 = {}
	...
	elseif arg_72_1 == 1 then
		var_72_0 = self:GetStickerList()
	elseif arg_72_1 == 2 then
		var_72_0 = self:GetStickerBgList()
	elseif arg_72_1 == 3 then
		var_72_0 = self:GetStickerFgList()
	end
...
function var_0_0.UnlockSticker(arg_82_0, arg_82_1)
	if var_0_5[arg_82_1] then
		...
		if var_0_5[arg_82_1].suit ~= 0 then
			...
			for iter_82_0, iter_82_1 in ipairs(StickerSuitCfg[var_0_5[arg_82_1].suit].content) do
				if ProfileDecorateItemCfg[iter_82_1].item_type == 4 then
					var_82_0 = PlayerData:GetStickerBg(iter_82_1).lock
				elseif ProfileDecorateItemCfg[iter_82_1].item_type == 5 then
					var_82_0 = PlayerData:GetSticker(iter_82_1).lock
				elseif ProfileDecorateItemCfg[iter_82_1].item_type == 6 then
					var_82_0 = PlayerData:GetStickerFg(iter_82_1).lock
				end
...
function var_0_0.UnlockStickerBg(arg_83_0, arg_83_1)
	if var_0_4[arg_83_1] and var_0_4[arg_83_1].lock then
		...
		if var_0_4[arg_83_1].suit ~= 0 then
			...
			for iter_83_0, iter_83_1 in ipairs(StickerSuitCfg[var_0_4[arg_83_1].suit].content) do
				if ProfileDecorateItemCfg[iter_83_1].item_type == 4 then
					var_83_0 = PlayerData:GetStickerBg(iter_83_1).lock
				elseif ProfileDecorateItemCfg[iter_83_1].item_type == 5 then
					var_83_0 = PlayerData:GetSticker(iter_83_1).lock
				elseif ProfileDecorateItemCfg[iter_83_1].item_type == 6 then
					var_83_0 = PlayerData:GetStickerFg(iter_83_1).lock
				end
...
function var_0_0.UnlockStickerFg(arg_84_0, arg_84_1)
	if var_0_3[arg_84_1] and var_0_3[arg_84_1].lock then
		...
		if var_0_3[arg_84_1].suit ~= 0 then
			...
			for iter_84_0, iter_84_1 in ipairs(StickerSuitCfg[var_0_3[arg_84_1].suit].content) do
				if ProfileDecorateItemCfg[iter_84_1].item_type == 4 then
					var_84_0 = PlayerData:GetStickerBg(iter_84_1).lock
				elseif ProfileDecorateItemCfg[iter_84_1].item_type == 5 then
					var_84_0 = PlayerData:GetSticker(iter_84_1).lock
				elseif ProfileDecorateItemCfg[iter_84_1].item_type == 6 then
					var_84_0 = PlayerData:GetStickerFg(iter_84_1).lock
				end
...
function var_0_0.UnlockPortrait(arg_85_0, arg_85_1, arg_85_2)
	if var_0_6[arg_85_1].unlock == 0 then
		manager.redPoint:setTip(RedPointConst.PORTRAIT .. "_" .. arg_85_1, 1)
		saveData("limitRed", "portrait_" .. arg_85_1, 1)
	end

	var_0_6[arg_85_1].unlock = 1
	var_0_6[arg_85_1].lasted_time = arg_85_2 or 0
end

function var_0_0.UnlockFrame(arg_86_0, arg_86_1)
	if var_0_7[ItemCfg[arg_86_1].param[1]] then
		if ItemCfg[arg_86_1].sub_type == ItemConst.ITEM_SUB_TYPE.FRAME_LIMIT or ItemCfg[arg_86_1].sub_type == ItemConst.ITEM_SUB_TYPE.FRAME_LIMIT_COVER then
			local var_86_0 = ItemCfg[arg_86_1].param[2]

			if var_0_7[ItemCfg[arg_86_1].param[1]].unlock == 0 then
				var_0_7[ItemCfg[arg_86_1].param[1]].unlock = 1
				var_0_7[ItemCfg[arg_86_1].param[1]].lasted_time = manager.time:GetServerTime() + var_86_0 * 86400

				table.insert(var_0_1.icon_frame_list, {
					id = ItemCfg[arg_86_1].param[1],
					lasted_time = var_0_7[ItemCfg[arg_86_1].param[1]].lasted_time
				})
				manager.redPoint:setTip(RedPointConst.FRAME .. "_" .. ItemCfg[arg_86_1].param[1], 1)
				saveData("limitRed", "frame_" .. ItemCfg[arg_86_1].param[1], 1)
			elseif var_0_7[ItemCfg[arg_86_1].param[1]].lasted_time == 0 then
				return
			else
				var_0_7[ItemCfg[arg_86_1].param[1]].lasted_time = var_0_7[ItemCfg[arg_86_1].param[1]].lasted_time + var_86_0 * 86400
			end
		else
			if var_0_7[ItemCfg[arg_86_1].param[1]].unlock == 0 then
				manager.redPoint:setTip(RedPointConst.FRAME .. "_" .. ItemCfg[arg_86_1].param[1], 1)
			...
			var_0_7[ItemCfg[arg_86_1].param[1]].unlock = 1
			var_0_7[ItemCfg[arg_86_1].param[1]].lasted_time = 0
		end
	end
end
...
function var_0_0.UnlockTag(arg_88_0, arg_88_1)
	if var_0_16[ItemCfg[arg_88_1].param[1]] then
		if ItemCfg[arg_88_1].sub_type == ItemConst.ITEM_SUB_TYPE.TAG_LIMIT then
			local var_88_0 = ItemCfg[arg_88_1].param[2] or 0

			if var_0_16[ItemCfg[arg_88_1].param[1]].unlock == 0 then
				var_0_16[ItemCfg[arg_88_1].param[1]].unlock = 1
				var_0_16[ItemCfg[arg_88_1].param[1]].lasted_time = manager.time:GetServerTime() + var_88_0 * 86400

				table.insert(var_0_1.tag_info_list, {
					id = ItemCfg[arg_88_1].param[1],
					lasted_time = var_0_16[ItemCfg[arg_88_1].param[1]].lasted_time,
					obtain_time = var_0_16[ItemCfg[arg_88_1].param[1]].obtain_time
				})
				manager.redPoint:setTip(RedPointConst.TAG .. "_" .. ItemCfg[arg_88_1].param[1], 1)
				saveData("limitRed", "tag_" .. ItemCfg[arg_88_1].param[1], 1)
			elseif var_0_16[ItemCfg[arg_88_1].param[1]].lasted_time == 0 then
				return
			else
				var_0_16[ItemCfg[arg_88_1].param[1]].lasted_time = var_0_16[ItemCfg[arg_88_1].param[1]].lasted_time + var_88_0 * 86400
			end
		else
			if var_0_16[ItemCfg[arg_88_1].param[1]].unlock == 0 then
				var_0_16[ItemCfg[arg_88_1].param[1]].obtain_time = manager.time:GetServerTime()
			...
			var_0_16[ItemCfg[arg_88_1].param[1]].unlock = 1
			var_0_16[ItemCfg[arg_88_1].param[1]].lasted_time = 0
		end
	end
end
...
function var_0_0.UnlockCardBg(arg_90_0, arg_90_1)
	if var_0_14[ItemCfg[arg_90_1].param[1]] then
		if ItemCfg[arg_90_1].sub_type == ItemConst.ITEM_SUB_TYPE.CARD_BG_LIMIT then
			local var_90_0 = ItemCfg[arg_90_1].param[2] or 0

			if var_0_14[ItemCfg[arg_90_1].param[1]].unlock == 0 then
				var_0_14[ItemCfg[arg_90_1].param[1]].unlock = 1
				var_0_14[ItemCfg[arg_90_1].param[1]].lasted_time = manager.time:GetServerTime() + var_90_0 * 86400

				table.insert(var_0_1.card_background_list, {
					id = ItemCfg[arg_90_1].param[1],
					lasted_time = var_0_14[ItemCfg[arg_90_1].param[1]].lasted_time
				})
				manager.redPoint:setTip(RedPointConst.CARD_BG .. "_" .. ItemCfg[arg_90_1].param[1], 1)
				saveData("limitRed", "cardBg_" .. ItemCfg[arg_90_1].param[1], 1)
			elseif var_0_14[ItemCfg[arg_90_1].param[1]].lasted_time == 0 then
				return
			else
				var_0_14[ItemCfg[arg_90_1].param[1]].lasted_time = var_0_14[ItemCfg[arg_90_1].param[1]].lasted_time + var_90_0 * 86400
			end
		else
			if var_0_14[ItemCfg[arg_90_1].param[1]].unlock == 0 then
				saveData("limitRed", "cardBg_" .. ItemCfg[arg_90_1].param[1], 1)
			...
			var_0_14[ItemCfg[arg_90_1].param[1]].unlock = 1
			var_0_14[ItemCfg[arg_90_1].param[1]].lasted_time = 0
		end
	end
end
...
function var_0_0:RefreshFrameList(arg_92_1)
	local var_92_1 = false
	local var_92_2 = manager.time:GetServerTime()

	for iter_92_0, iter_92_1 in ipairs(var_0_7.get_frame_id_list) do
		if var_0_7[iter_92_1].unlock == 1 and var_0_7[iter_92_1].lasted_time > 0 and var_92_2 > var_0_7[iter_92_1].lasted_time then
			self:LockFrame(iter_92_1)

			if iter_92_1 == var_0_1.icon_frame then
				var_92_1 = true
			end
		end
	end
...
function var_0_0:GetUnlockTagListInfo()
	local var_102_0 = {}
	local var_102_1 = manager.time:GetServerTime()

	for iter_102_0, iter_102_1 in ipairs(var_0_16.get_tagList_id_list) do
		if var_0_16[iter_102_1] and var_0_16[iter_102_1].unlock == 1 then
			if var_0_16[iter_102_1].lasted_time == 0 or var_102_1 < var_0_16[iter_102_1].lasted_time then
				table.insert(var_102_0, var_0_16[iter_102_1])
			else
				self:LockTag(iter_102_1)
			end
		end
	end

	table.sort(var_102_0, function(arg_103_0, arg_103_1)
		if ProfileLabelCfg[arg_103_0.id].type ~= ProfileLabelCfg[arg_103_1.id].type then
			return ProfileLabelCfg[arg_103_0.id].type > ProfileLabelCfg[arg_103_1.id].type
		end
...
function var_0_0.GetUsingTagListInfo(arg_104_0)
	...
	for iter_104_0, iter_104_1 in ipairs(var_0_1.used_tag_list) do
		if var_0_16[iter_104_1] and var_0_16[iter_104_1].unlock == 1 and (var_0_16[iter_104_1].lasted_time == 0 or var_104_1 < var_0_16[iter_104_1].lasted_time) then
			table.insert(var_104_0, iter_104_1)
		end
	end

	table.sort(var_104_0, function(arg_105_0, arg_105_1)
		if ProfileLabelCfg[arg_105_0].type ~= ProfileLabelCfg[arg_105_1].type then
			return ProfileLabelCfg[arg_105_0].type > ProfileLabelCfg[arg_105_1].type
		end
...
function var_0_0:RefreshTagRed()
	self:StopTagRed()
	...
	var_0_23 = Timer.New(function()
		...
		for iter_115_0, iter_115_1 in ipairs(var_0_16.get_tagList_id_list) do
			if var_0_16[iter_115_1].unlock == 1 and var_0_16[iter_115_1].lasted_time > 0 and (getData("limitRed", "tag_" .. iter_115_1) or 0) == 1 then
				var_115_0 = var_115_0 + 1

				if var_115_1 >= var_0_16[iter_115_1].lasted_time then
					self:LockTag(iter_115_1)
...
function var_0_0:RefreshPortraitRed()
	self:StopPortraitRed()
	...
	var_0_24 = Timer.New(function()
		...
		for iter_122_0, iter_122_1 in ipairs(var_0_6.get_portrait_id_list) do
			if var_0_6[iter_122_1].unlock == 1 and var_0_6[iter_122_1].lasted_time > 0 and (getData("limitRed", "portrait_" .. iter_122_1) or 0) == 1 then
				var_122_0 = var_122_0 + 1

				if var_122_1 >= var_0_6[iter_122_1].lasted_time then
...
function var_0_0:RefreshFrameRed()
	self:StopFrameRed()
	...
	var_0_25 = Timer.New(function()
		...
		for iter_125_0, iter_125_1 in ipairs(var_0_7.get_frame_id_list) do
			if var_0_7[iter_125_1].unlock == 1 and var_0_7[iter_125_1].lasted_time > 0 and (getData("limitRed", "frame_" .. iter_125_1) or 0) == 1 then
				var_125_0 = var_125_0 + 1

				if var_125_1 >= var_0_7[iter_125_1].lasted_time then
					self:LockFrame(iter_125_1)
...
function var_0_0:RefreshCardBgRed()
	self:StopCardRed()
	...
	var_0_26 = Timer.New(function()
		...
		for iter_129_0, iter_129_1 in ipairs(var_0_14.get_cardBg_id_list) do
			if var_0_14[iter_129_1].unlock == 1 and var_0_14[iter_129_1].lasted_time > 0 and (getData("limitRed", "cardBg_" .. iter_129_1) or 0) == 1 then
				var_129_0 = var_129_0 + 1

				if var_129_1 >= var_0_14[iter_129_1].lasted_time then
					self:LockCardBg(iter_129_1)
...
function var_0_0.UnlockChatBubble(arg_134_0, arg_134_1, arg_134_2)
	var_0_13[arg_134_1].unlock = 1
	var_0_13[arg_134_1].lasted_time = arg_134_2 or 0

	manager.redPoint:setTip(string.format("%s_%s", RedPointConst.CHAT_BUBBLE, arg_134_1), 1)
end
...
function var_0_0.GetAllAppIconList(arg_136_0)
	...
	for iter_136_0, iter_136_1 in ipairs(var_0_1.game_icon) do
		table.insert(var_136_0, {
			id = iter_136_1.id,
			name = ItemCfg[iter_136_1.id].name
		})
	end

	table.sort(var_136_0, function(arg_137_0, arg_137_1)
		if ItemCfg[arg_137_0.id] and ItemCfg[arg_137_0.id].param then
			local var_137_0 = ItemCfg[arg_137_0.id].param[1] or 0

			if ItemCfg[arg_137_1.id] and ItemCfg[arg_137_1.id].param then
				local var_137_1 = ItemCfg[arg_137_1.id].param[1] or 0
...
function var_0_0.AddPlayerStoryTrigger(arg_141_0, arg_141_1)
	if var_0_18[StoryTriggerCfg[arg_141_1].trigger_group] then
		if table.indexof(var_0_18[StoryTriggerCfg[arg_141_1].trigger_group], arg_141_1) == false then
			table.insert(var_0_18[StoryTriggerCfg[arg_141_1].trigger_group], arg_141_1)
		end
	else
		var_0_18[StoryTriggerCfg[arg_141_1].trigger_group] = {
			arg_141_1
		}
	end
end
...
function var_0_0.GetPlayerStoryTriggerGroupInfo(arg_142_0, arg_142_1)
	return (var_0_18[StoryTriggerCfg[arg_142_1].trigger_group] or nil) and #var_0_18[StoryTriggerCfg[arg_142_1].trigger_group], #StoryTriggerCfg.get_id_list_by_trigger_group[StoryTriggerCfg[arg_142_1].trigger_group]
end
...
function var_0_0.SetRandomHeroData(arg_145_0, arg_145_1)
	...
	for iter_145_0 = #var_0_28, 1, -1 do
		if table.keyof(var_0_28, var_0_28[iter_145_0]) ~= iter_145_0 then
...
function var_0_0:SetRandomHeroMode(arg_153_1)
	var_0_27 = PlayerTools.MakeRandomModeData(self:IsRandomHero(), arg_153_1)
end
...
function var_0_0:SetIsRandomHero(arg_155_1)
	var_0_27 = PlayerTools.MakeRandomModeData(arg_155_1, self:GetRandomHeroMode())
end

function var_0_0:GetRandomHero()
	if var_0_29 == 0 then
		self:CalcNextRandomHero()
	end
...
function var_0_0:GetForceRandomHeroID()
	return self.forceRandomHeroID_
end

function var_0_0:CalcNextRandomHero()
	local var_160_0 = CustomCenterTools.GetRandomHeroList()

	if #var_160_0 == 0 then
		var_0_29 = var_0_1.poster_girl
		self.forceRandomHeroID_ = nil

		return var_0_29
	end

	if self.forceRandomHeroID_ then
		var_0_29 = self.forceRandomHeroID_
		self.forceRandomHeroID_ = nil

		return
	end

	local var_160_1 = math.random(#var_160_0)
	local var_160_2 = var_160_0[var_160_1]

	if var_160_0[var_160_1] == var_0_29 then
		if #var_160_0 >= var_160_1 + 1 then
			var_160_2 = var_160_0[var_160_1 + 1]
		elseif var_160_1 - 1 >= 1 then
			var_160_2 = var_160_0[var_160_1 - 1]
		end
	end
...
function var_0_0:GetPosterGirlHeroSkinId()
	if var_0_32 then
		return var_0_32
	elseif self:IsRandomHero() then
...
function var_0_0:GetCacheHeroSkinList()
	return self.cacheHeroSkinList_
end
...
function var_0_0:UpdateCacheHeroSkinID(arg_164_1)
	local var_164_0 = table.keyof(self.cacheHeroSkinList_, arg_164_1)

	if var_164_0 then
		table.remove(self.cacheHeroSkinList_, var_164_0)
	else
		table.insert(self.cacheHeroSkinList_, arg_164_1)
	end
end

function var_0_0:GetCacheHeroSkinID(arg_165_1)
	self.cacheHeroSkin_[arg_165_1] = self.cacheHeroSkin_[arg_165_1] or HeroTools.HeroUsingSkinInfo(arg_165_1).id

	return self.cacheHeroSkin_[arg_165_1]
end

function var_0_0:SetCacheHeroSkinID(arg_166_1, arg_166_2)
	self.cacheHeroSkin_[arg_166_1] = arg_166_2
end
...
function var_0_0:GetClearHeroFlag()
	return self.clearHeroFlag_
end
...
function var_0_0:GetPosterGirlDebut()
	return self.posterGrilDebut_
end

function var_0_0:AddSelectSkinID(arg_172_1)
	table.insert(self.selectSkinList_, arg_172_1)
end

function var_0_0:GetSelectSkinList()
	return self.selectSkinList_
end
...
function var_0_0:GetPlayAssistantVoice()
	return self.heroAssistantVoice_
end
...
function var_0_0:GetDeskMode()
	return self.deskMode_
end
...
function var_0_0:SetPureModeData(arg_181_1)
	self.pureModeData_ = {}

	if arg_181_1 then
		self.pureModeData_.randomModeIndex = arg_181_1.pattern_id or 0

		if arg_181_1.pattern_scope ~= 0 then
			self.pureModeData_.randomModeRangeIndex = arg_181_1.pattern_scope or 1
		end

		if arg_181_1.switch_frequency ~= 0 then
			self.pureModeData_.randomTimeIndex = arg_181_1.switch_frequency or 1
		end

		if arg_181_1.entry_time ~= 0 then
			self.pureModeData_.pureModeTimeIndex = arg_181_1.entry_time or 1
		end
	end
end

function var_0_0:GetPureModeData()
	return self.pureModeData_
end

function var_0_0:SetPureModeComponentData(arg_183_1)
	self.pureModeComponentData_ = {}

	for iter_183_0, iter_183_1 in ipairs(arg_183_1 or {}) do
		self.pureModeComponentData_[iter_183_0] = {
...
function var_0_0:GetPureModeComponentData()
	return self.pureModeComponentData_
end
