...
function var_0_0:IsUnlockScene(arg_1_1)
	if self:GetDormSceneData(arg_1_1) == nil then
		return false
	end
...
local function var_0_12(arg_3_0)
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_0.dorm) do
		...
		var_3_0.exp = iter_3_1.exp or 0
		var_3_0.likeNum = iter_3_1.liked_num or 0
		var_0_1[iter_3_1.id] = var_3_0
...
local function var_0_14()
	...
	var_0_6 = getData("Dorm", "buyFurCurrencyID") or DormConst.DORM_CURRENCY_ID
end
...
function var_0_0.Init(arg_9_0)
	...
	for iter_9_0, iter_9_1 in ipairs(getData("Dorm", "likeInfo") or {}) do
...
function var_0_0.GetDormExp(arg_20_0, arg_20_1)
	var_0_1[arg_20_1].exp = var_0_1[arg_20_1].exp or 0

	return var_0_1[arg_20_1].exp
end

function var_0_0:GetDormLevel(arg_21_1)
	if not arg_21_1 then
		return
	end

	local var_21_0
	local var_21_1 = self:GetDormExp(arg_21_1)
	local var_21_2 = 0
...
function var_0_0.SetLastLikeNum(arg_31_0, arg_31_1, arg_31_2)
	...
	var_0_8[arg_31_2] = var_0_8[arg_31_2] or 0
...
function var_0_0.GetLastLikeNum(arg_32_0, arg_32_1)
	...
	var_0_8[arg_32_1] = var_0_8[arg_32_1] or 0
...
function var_0_0.UnLockDormArchitecture(arg_35_0, arg_35_1, arg_35_2)
	...
	for iter_35_0, iter_35_1 in ipairs(BackHomeCfg[arg_35_1].default_item) do
		local var_35_0 = DormData:GetFurNumInfo(iter_35_1[1])

		if DormSpecialFurnitureTools:JudgeFurIsSpecialType(iter_35_1[1]) then
			var_35_0.num = var_35_0.num + iter_35_1[2]
			var_35_0.hasPlaceNum = var_35_0.hasPlaceNum + iter_35_1[2]
		else
			var_35_0.num = var_35_0.num + iter_35_1[2]
		end
	end
...
function var_0_0.HaveWatchedTheatre(arg_41_0, arg_41_1)
	for iter_41_0, iter_41_1 in ipairs(var_0_2) do
		if arg_41_1 == iter_41_1.id then
			if iter_41_1.timestamp_list[1] ~= nil and tonumber(os.date("!%Y", iter_41_1.timestamp_list[1])) == tonumber(os.date("!%Y", manager.time:GetServerTime())) then
				return true
			end
