...
function var_0_0.Init(arg_1_0)
	...
	for iter_1_0, iter_1_1 in ipairs(ActivityMultiRewardCfg.all) do
		...
		if not var_0_1[ActivityMultiRewardCfg[iter_1_1].activity_id] then
		...
		var_0_5[var_1_0.chapter_id] = var_0_5[var_1_0.chapter_id] or {}
...
function var_0_0.GetBattleUseMultiCount(arg_5_0)
	...
	return ((var_0_3[var_0_4] or nil) and (var_0_3[var_0_4].count or 0)) - var_0_2[var_0_4].count
end
...
function var_0_0:GetMultiRatioByChapterOrToggle(arg_8_1, arg_8_2, arg_8_3)
	if not self:CheckMultiReward() then
		return 0
	end
	...
	if arg_8_1 then
		if ChapterClientCfg.get_id_list_by_toggle[arg_8_1] then
			for iter_8_0, iter_8_1 in ipairs(ChapterClientCfg.get_id_list_by_toggle[arg_8_1]) do
