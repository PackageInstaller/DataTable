...
function var_0_0.GetCurrentActivityPt(arg_5_0, arg_5_1)
	return (var_0_1[arg_5_1] or nil) and (var_0_1[arg_5_1].num or 0)
end

function var_0_0.GetGiftPt(arg_6_0, arg_6_1, arg_6_2)
	return (ActivityPtCfg[arg_6_1] or nil) and (ActivityPtCfg[arg_6_1].target[arg_6_2] or 0)
end

function var_0_0.GetTotalPt(arg_7_0, arg_7_1)
	return (ActivityPtCfg[arg_7_1] or nil) and (ActivityPtCfg[arg_7_1].target[#ActivityPtCfg[arg_7_1].target] or 0)
end
