...
function var_0_0.InitWithServerData(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1.receive_info) do
		var_0_1.receiveInfo[iter_2_1.id] = var_0_1.receiveInfo[iter_2_1.id] or {}
...
function var_0_0.GetBonusSuccess(arg_3_0, arg_3_1, arg_3_2)
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_2) do
		var_0_1.receiveInfo[iter_3_1.id] = var_0_1.receiveInfo[iter_3_1.id] or {}
...
function var_0_0.MarkAllBonusGet(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in ipairs(arg_6_1.receive_info) do
		var_0_1.receiveInfo[iter_6_1.id] = var_0_1.receiveInfo[iter_6_1.id] or {}
...
function var_0_0:GetLevel()
	...
	for iter_7_0 = self:GetMaxLevel(), 1, -1 do
...
function var_0_0:GetUpgradeNeedExp()
	local var_9_0 = self:GetLevel()

	if var_9_0 >= self:GetMaxLevel() then
		return GameLevelSetting[self:GetMaxLevel()].battlepass_level_exp
	end

	return GameLevelSetting[var_9_0 + 1].battlepass_level_exp
end

function var_0_0:GetCurrentStatus()
	local var_10_0 = self:GetLevel()
	local var_10_1 = var_10_0 == self:GetMaxLevel() and 0 or var_10_0 + 1
	local var_10_2 = 0
	...
	for iter_10_0, iter_10_1 in ipairs(BattlePassCfg.get_id_list_by_type[BattlePassListCfg[var_0_1.id].battlepass_type]) do
		if iter_10_0 <= var_10_0 then
			if var_0_1.receiveInfo[iter_10_1] == nil or #var_0_1.receiveInfo[iter_10_1] == 0 then
				for iter_10_2, iter_10_3 in ipairs(BattlePassCfg[iter_10_1].reward_free) do
					var_10_2 = iter_10_0

					return iter_10_0, var_10_1
				end

				if self:GetPayLevel() > 0 then
					for iter_10_4, iter_10_5 in ipairs(BattlePassCfg[iter_10_1].reward_pay) do
						var_10_2 = iter_10_0

						return iter_10_0, var_10_1
					end
				end
			elseif self:GetPayLevel() > 0 and #var_0_1.receiveInfo[iter_10_1] == 1 and var_0_1.receiveInfo[iter_10_1][1].isPay == 0 then
				for iter_10_6, iter_10_7 in ipairs(BattlePassCfg[iter_10_1].reward_pay) do
					var_10_2 = iter_10_0
...
function var_0_0:GetCanGetBonusList()
	local var_11_0 = self:GetLevel()
	local var_11_1 = {}
	...
	for iter_11_0, iter_11_1 in ipairs(BattlePassCfg.get_id_list_by_type[BattlePassListCfg[var_0_1.id].battlepass_type]) do
		if iter_11_0 <= var_11_0 then
			if var_0_1.receiveInfo[iter_11_1] == nil then
				for iter_11_2, iter_11_3 in ipairs(BattlePassCfg[iter_11_1].reward_free) do
					table.insert(var_11_1, iter_11_3)
				end

				if self:GetPayLevel() > 0 then
					for iter_11_4, iter_11_5 in ipairs(BattlePassCfg[iter_11_1].reward_pay) do
						table.insert(var_11_1, iter_11_5)
					end
				end
			elseif self:GetPayLevel() > 0 and #var_0_1.receiveInfo[iter_11_1] == 1 and var_0_1.receiveInfo[iter_11_1][1].isPay == 0 then
				for iter_11_6, iter_11_7 in ipairs(BattlePassCfg[iter_11_1].reward_pay) do
...
function var_0_0:GetRewardStatus(arg_13_1, arg_13_2)
	local var_13_0 = GameLevelSetting[arg_13_1]
	local var_13_1 = ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_BATTLEPASS_EXP)
	local var_13_2 = self:GetPayLevel() > 0 and "pay" or "free"

	if self:HaveGetBonus(arg_13_2) then
		return var_13_2 .. "HaveGet"
	elseif var_13_1 >= var_13_0.battlepass_lv_exp_sum then
		if var_13_2 == "free" then
			return var_13_2 .. "CanGet"
		elseif self:HaveReceiveInfo(arg_13_2) then
			return var_13_2 .. "HalfCanGet"
		else
			return var_13_2 .. "CanGet"
		end
	else
		return var_13_2 .. "CannotGet"
	end
end
...
function var_0_0:GetPassportType()
	if self:GetId() == PassportConst.VSN_42_PASSPORT_ID then
...
function var_0_0:HasDiscount()
	...
	local var_27_1 = self:GetPassportType()
