...
function var_0_29.InitMatrixSystem(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1.ready_hero_list) do
		table.insert(var_0_0, iter_2_1.hero_standard_id)

		var_0_1[HeroStandardSystemCfg[iter_2_1.hero_standard_id].hero_id] = iter_2_1.skin_id
	end

	var_0_2 = {}

	for iter_2_2, iter_2_3 in ipairs(arg_2_1.difficulty_list) do
		table.insert(var_0_2, (MatrixDifficultyTemplate.New(iter_2_3)))
	end
...
function var_0_29.InitMatrixUser(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_1.point_reward_list) do
		...
		for iter_3_2 = 1, #iter_3_1.item_list do
			table.insert(var_3_0.item_list, {
				item_id = iter_3_1.item_list[iter_3_2].item_id,
				item_num = iter_3_1.item_list[iter_3_2].item_num
			})
		end
	...
	local var_3_1 = arg_3_1.current_progress

	if arg_3_1.current_progress then
		var_0_11 = var_3_1.tier_id
		var_0_13 = {}

		for iter_3_7, iter_3_8 in ipairs(var_3_1.artifact_list) do
		...
		var_0_17 = MatrixDifficultyTemplate.New(var_3_1.difficulty)
		var_0_12 = MatrixPhaseTemplate.New(var_3_1.phase, var_0_17.price_template_id)
		var_0_19 = {}
		var_0_18 = {}

		for iter_3_9, iter_3_10 in ipairs(var_3_1.hero_list) do
			if HeroStandardSystemCfg[iter_3_10.hero_id] then
				local var_3_2 = HeroStandardSystemCfg[iter_3_10.hero_id].hero_id
				local var_3_3 = var_0_17.difficulty == 3 and MatrixOwnerHeroTemplate.New(var_3_2, iter_3_10.hero_id) or MatrixHeroTemplate.New(var_3_2, iter_3_10.hero_id)

				var_3_3:InitData(iter_3_10)

				var_0_19[var_3_2] = var_3_3

				table.insert(var_0_18, var_3_2)
			end
		end

		var_0_14 = {}

		for iter_3_11, iter_3_12 in ipairs(var_3_1.custom_affix_id_list) do
			table.insert(var_0_14, iter_3_12)
		end

		var_0_15 = {}

		for iter_3_13, iter_3_14 in ipairs(var_3_1.attribute_list) do
			var_0_15[iter_3_14.id] = iter_3_14.value
		end

		var_0_16 = {}

		for iter_3_15, iter_3_16 in ipairs(var_3_1.beacon_id_list) do
			table.insert(var_0_16, iter_3_16)
		end

		var_0_10 = {}

		for iter_3_17, iter_3_18 in ipairs(var_3_1.current_terminal.gift_list) do
...
function var_0_29.UpdateTerminalLevel(arg_6_0)
	var_0_7, var_0_8 = MatrixTools.MatrixExpToLevel((ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_MATRIX_TERMINAL_EXP)))
end
...
function var_0_29:GetTierScore(arg_29_1)
	if arg_29_1 == nil then
		arg_29_1 = var_0_11
	end

	if MatrixTierCfg[arg_29_1] then
		local var_29_0 = MatrixTierCfg[arg_29_1].level_reward[self:GetDifficulty()]

		if var_29_0 then
			return math.floor(var_29_0 * (1 + self:GetAffixDifficultyRate() + self:GetScoreAddition()))
		end
	end
...
function var_0_29.GetAffixDifficultyRate(arg_30_0)
	...
	for iter_30_0, iter_30_1 in ipairs((MatrixData:GetDifficultyData():GetRegularAffix())) do
		var_30_0 = var_30_0 + ActivityAffixPoolCfg[iter_30_1].multiple
	end

	for iter_30_2, iter_30_3 in ipairs((MatrixData:GetCustomAffix())) do
...
function var_0_29.GetHeroSkin(arg_32_0, arg_32_1)
	...
	if var_32_0 then
		var_32_1 = var_32_0.using_skin or 0
...
function var_0_29.GetScoreAddition(arg_48_0)
	if not var_0_15[MatrixConst.MATRIX_ATTRIBUTE_TYPE.SCORE_ADDITION] then
		return 0
	end

	return var_0_15[MatrixConst.MATRIX_ATTRIBUTE_TYPE.SCORE_ADDITION] / 1000
end

function var_0_29.GetGiveUpRewardAddition(arg_49_0)
	if not var_0_15[MatrixConst.MATRIX_ATTRIBUTE_TYPE.GIVE_UP_REWARD_ADDITION] then
		return 0
	end

	return var_0_15[MatrixConst.MATRIX_ATTRIBUTE_TYPE.GIVE_UP_REWARD_ADDITION] / 1000
end
...
function var_0_29.GetAffixList(arg_51_0)
	if var_0_17 then
		...
		for iter_51_0, iter_51_1 in ipairs((var_0_17:GetRegularAffix())) do
			if ActivityAffixPoolCfg[iter_51_1] then
				table.insert(var_51_0, ActivityAffixPoolCfg[iter_51_1].affix)
			end
		end

		for iter_51_2, iter_51_3 in ipairs(var_0_14) do
			if ActivityAffixPoolCfg[iter_51_3] then
				table.insert(var_51_0, ActivityAffixPoolCfg[iter_51_3].affix)
			end
		end
...
function var_0_29.GetArtifactAffixList(arg_52_0)
	...
	for iter_52_0, iter_52_1 in ipairs(var_0_13) do
		if MatrixItemCfg[iter_52_1.id] then
			local var_52_1 = MatrixTools.GetAffixByEffectId(MatrixItemCfg[iter_52_1.id].params[1], iter_52_1.wins)
...
function var_0_29.GetBeaconAffixList(arg_53_0)
	...
	for iter_53_0, iter_53_1 in pairs(var_0_16) do
		if MatrixBeaconCfg[iter_53_1] then
			for iter_53_2, iter_53_3 in ipairs(MatrixBeaconCfg[iter_53_1].effect_id_list) do
				local var_53_1 = MatrixTools.GetAffixByEffectId(iter_53_3)
...
function var_0_29.GetTerminalAffixList(arg_54_0)
	...
	for iter_54_0, iter_54_1 in pairs(var_0_10) do
		if MatrixTerminalGiftCfg[iter_54_0] then
			local var_54_1 = MatrixTools.GetAffixByEffectId(MatrixTerminalGiftCfg[iter_54_0].effect_id_list[iter_54_1])
...
function var_0_29:GetTotalAffix()
	local var_55_0 = {}

	table.insertto(var_55_0, self:GetAffixList())
	table.insertto(var_55_0, self:GetArtifactAffixList())
	table.insertto(var_55_0, self:GetBeaconAffixList())
	table.insertto(var_55_0, self:GetTerminalAffixList())
...
function var_0_29.CalMatrixAttribute(arg_56_0)
	...
	for iter_56_0, iter_56_1 in pairs(var_0_10) do
		if MatrixTerminalGiftCfg[iter_56_0] then
			MatrixTools.GetAttrByEffectId(var_56_0, MatrixTerminalGiftCfg[iter_56_0].effect_id_list[iter_56_1])
		end
	end

	for iter_56_2, iter_56_3 in pairs(var_0_16) do
		if MatrixBeaconCfg[iter_56_3] then
			for iter_56_4, iter_56_5 in ipairs(MatrixBeaconCfg[iter_56_3].effect_id_list) do
...
function var_0_29.CalMatrixSelectHeroAttribute(arg_57_0)
	...
	for iter_57_0, iter_57_1 in pairs(var_0_9) do
		if MatrixTerminalGiftCfg[iter_57_0] then
			MatrixTools.GetAttrByEffectId(var_57_0, MatrixTerminalGiftCfg[iter_57_0].effect_id_list[iter_57_1])
		end
	end
