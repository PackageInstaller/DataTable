...
function var_0_0.Init(arg_1_0)
	...
	arg_1_0.activitySuspendByControl = {}
end
...
function var_0_0.GetActivityIsOpen(arg_6_0, arg_6_1)
	if var_0_1[arg_6_1] == nil then
		return false
	end

	return var_0_1[arg_6_1]:IsActivitying()
end

function var_0_0:RefreshActivityTime(arg_7_1)
	local var_7_0 = {}
	...
	self.activityTimeList_[arg_7_1.activity_id] = var_7_0

	manager.notify:Invoke(ACTIVITY_UPDATE, arg_7_1.activity_id)
end

function var_0_0:GetActivityRefreshTime(arg_8_1)
	if self.activityTimeList_[arg_8_1] then
		return self.activityTimeList_[arg_8_1][1] or 0
	else
		return 0
	end
end

function var_0_0:GetActivityRefreshTimeList(arg_9_1)
	return self.activityTimeList_[arg_9_1] or {}
end
...
function var_0_0:SetActivitySuspendByControl(arg_11_1, arg_11_2, arg_11_3)
	self.activitySuspendByControl[arg_11_1] = arg_11_2

	if arg_11_3 then
		local var_11_0 = nullable(ActivityCfg, arg_11_1, "sub_activity_list")

		if var_11_0 then
			for iter_11_0, iter_11_1 in ipairs(var_11_0) do
				self:SetActivitySuspendByControl(iter_11_1, arg_11_2, arg_11_3)
			end
		end
	end
end

function var_0_0:InitActivitySuspendByControl(arg_12_1, arg_12_2)
	if arg_12_2 then
		self.activitySuspendByControl = {}
	end

	if arg_12_1 and arg_12_1.id_list then
		for iter_12_0, iter_12_1 in ipairs(arg_12_1.id_list) do
			self:SetActivitySuspendByControl(iter_12_1, true, true)
		end
	end
end

function var_0_0:IsActivitySuspendByControl(arg_13_1)
	return self.activitySuspendByControl[arg_13_1]
end
