...
function var_0_0:ModifyBaseTeach(arg_3_1)
	for iter_3_0, iter_3_1 in ipairs(arg_3_1.base_stage_list) do
		self.baseStageList_[iter_3_1.id] = iter_3_1.clear_times
		self.stageList_[iter_3_1.id] = iter_3_1.clear_times
	end
end

function var_0_0:ModifyHeroTeach(arg_4_1)
	for iter_4_0, iter_4_1 in ipairs(arg_4_1.hero_teaching_list) do
		self.heroStageList_[iter_4_1.hero_id] = self.heroStageList_[iter_4_1.hero_id] or {}

		for iter_4_2, iter_4_3 in ipairs(iter_4_1.stage_list) do
			self.heroStageList_[iter_4_1.hero_id][iter_4_3.id] = iter_4_3.clear_times
			self.stageList_[iter_4_3.id] = iter_4_3.clear_times
		end
	end
end
...
function var_0_0:GetSwitchType()
	return self.switchType_
end
...
function var_0_0:GetBaseTeachList()
	return self.baseStageList_
end

function var_0_0:GetHeroTeachInfo(arg_9_1, arg_9_2)
	if not self.heroStageList_[arg_9_1] then
		return 0
	end

	return self.heroStageList_[arg_9_1][arg_9_2]
end
...
function var_0_0:GetCacheTeachHeroID()
	return self.cacheSelectHeroID_
end
...
function var_0_0:GetBaseScrollViewHorizontal()
	return self.baseScrollViewHorizontal_
end
...
function var_0_0:GetHeroScrollViewHorizontal()
	return self.heroScrollViewHorizontal_
end
