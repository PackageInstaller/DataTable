...
function var_0_0.Update(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in ipairs((cleanProtoTable(var_0_1.challenge_buff))) do
		var_0_0:SetSelectAffixsAdd(iter_1_1, (var_0_0:GetAffixState(iter_1_1)))
	end
...
function var_0_0.InitTaskInfo(arg_2_0)
	...
	if CoreVerificationClRewardCfg.get_id_list_by_activity_id[ActivityCfg[var_0_7].sub_activity_list[2]] and #var_0_5 < #CoreVerificationClRewardCfg.get_id_list_by_activity_id[ActivityCfg[var_0_7].sub_activity_list[2]] then
		for iter_2_0, iter_2_1 in ipairs(CoreVerificationClRewardCfg.get_id_list_by_activity_id[ActivityCfg[var_0_7].sub_activity_list[2]]) do
...
function var_0_0.GetChallengeStageCfg(arg_15_0)
	for iter_15_0, iter_15_1 in ipairs(CoreVerificationClMode1Cfg.get_id_list_by_stage_type[2]) do
		if CoreVerificationClMode1Cfg[iter_15_1].activity_id == CoreVerificationChallengeTools.GetModeStageActivityId(ActivityTemplateConst.CORE_VERIFICATION_CHALLENGE_MODE1) then
			return CoreVerificationClMode1Cfg[iter_15_1]
		end
	end
...
function var_0_0:GetMaxIllustrated()
	...
	for iter_27_0, iter_27_1 in ipairs(self:GetIllustrated()) do
		if CoreVerificationClBadgeCfg[iter_27_1.illustrated_id].activity_id == CoreVerificationChallengeTools.GetActivityId() then
			if CoreVerificationClBadgeCfg[iter_27_1.illustrated_id].level == 0 and -1 < CoreVerificationClBadgeCfg[iter_27_1.illustrated_id].level and var_27_0 < iter_27_1.illustrated_id then
				var_27_0 = iter_27_1.illustrated_id
			end

			if CoreVerificationClBadgeCfg[iter_27_1.illustrated_id] and -1 < CoreVerificationClBadgeCfg[iter_27_1.illustrated_id].level then
				var_27_0 = iter_27_1.illustrated_id
			end
		end
	end
...
function var_0_0:IsUnlockIllustratedById(arg_28_1)
	for iter_28_0, iter_28_1 in ipairs(self:GetIllustrated()) do
...
function var_0_0.GetIllustratedInfoByLevel(arg_29_0, arg_29_1, arg_29_2)
	for iter_29_0, iter_29_1 in ipairs(CoreVerificationClBadgeCfg.all) do
		if arg_29_1 == CoreVerificationClBadgeCfg[iter_29_1].level and CoreVerificationClBadgeCfg[iter_29_1].set_id == arg_29_2 then
			return CoreVerificationClBadgeCfg[iter_29_1]
		end
	end
...
function var_0_0:GetIllustratedById(arg_30_1)
	for iter_30_0, iter_30_1 in ipairs(self:GetIllustrated()) do
...
function var_0_0:IsUnLockIllustrated(arg_31_1)
	local var_31_0 = false

	for iter_31_0, iter_31_1 in ipairs(self:GetIllustrated()) do
...
function var_0_0.IsJumpAllStage(arg_34_0)
	return #var_0_2 >= 2 and not not (var_0_1.stage_id and var_0_1.stage_id > 0)
end
...
function var_0_0:PushStageLockedHero(arg_37_1, arg_37_2)
	local var_37_0 = self:GetChallengeStage()

	if arg_37_1.stageID ~= var_37_0.stage_id and var_37_0.challenge_lock then
		for iter_37_0, iter_37_1 in ipairs(var_37_0.challenge_lock) do
			table.insert(arg_37_2, iter_37_1)
		end
	end

	local var_37_1 = self:GetCommonStage()

	if var_37_1 then
		for iter_37_2, iter_37_3 in ipairs(var_37_1) do
			if arg_37_1.stageID ~= iter_37_3.stage_id then
...
function var_0_0:GetRankScore()
	return self:GetChallengeStage().max_challenge_value
end
