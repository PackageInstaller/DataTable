...
function var_0_0:GetWelfareExchangeCnt()
	return self.welfareExchangeCnt_
end

function var_0_0:CommunityExit()
	self:SetWelfareType(CommunityConst.WELFARE_TYPE.CLOSE)
