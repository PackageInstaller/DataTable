local ChallengeRogueTeamHeroDataTemplate = class("ChallengeRogueTeamHeroDataTemplate", BaseHeroDataTemplate)

function ChallengeRogueTeamHeroDataTemplate:Ctor(arg_1_1)
	self.id = arg_1_1
	self.exp = 0
	self.level = 1
...
function ChallengeRogueTeamHeroDataTemplate:Init(arg_2_1, arg_2_2)
	self.hpPercent = arg_2_2
	self.id = arg_2_1.id
	...
	self.servantInfo = arg_2_1:GetServantInfo()
...
function ChallengeRogueTeamHeroDataTemplate:ModifyHero(arg_3_1, arg_3_2)
	self:Init(arg_3_1, arg_3_2)
end

function ChallengeRogueTeamHeroDataTemplate:GetServantInfo()
	return self.servantInfo
end

function ChallengeRogueTeamHeroDataTemplate:GetWeaponInfo()
	return self.weapon_info
end

function ChallengeRogueTeamHeroDataTemplate:GetEquipInfoList()
	return self.equip
end

function ChallengeRogueTeamHeroDataTemplate:GetSkillInfoList()
	return self.skill
end

function ChallengeRogueTeamHeroDataTemplate:GetTransitionInfoList()
	return self.transition
end

function ChallengeRogueTeamHeroDataTemplate:GetType()
	return HeroConst.HERO_DATA_TYPE.CHALLENGEROUGETEAM
end

return ChallengeRogueTeamHeroDataTemplate
