local OsirisPlayGameDataTemplate = class("OsirisPlayGameDataTemplate", TemplateHeroDataTemplate)

function OsirisPlayGameDataTemplate:Ctor(arg_1_1)
	self.id = arg_1_1
	self.exp = 0
	self.level = 1
...
function OsirisPlayGameDataTemplate:Init(arg_2_1)
	self.id = arg_2_1.id
	...
	self.battle_using_skin = arg_2_1.using_skin
	self.weapon_module_level = arg_2_1.weapon_module_level
end

function OsirisPlayGameDataTemplate:ModifyHero(arg_3_1, arg_3_2)
	self:Init(arg_3_1, arg_3_2)
end

function OsirisPlayGameDataTemplate:GetServantInfo()
	return self.servantInfo
end

function OsirisPlayGameDataTemplate:GetWeaponInfo()
	return self.weapon_info
end

function OsirisPlayGameDataTemplate:GetEquipInfoList()
	return self.equip
end

function OsirisPlayGameDataTemplate:GetSkillInfoList()
	return self.skill
end

function OsirisPlayGameDataTemplate:GetTransitionInfoList()
	return self.transition
end

function OsirisPlayGameDataTemplate:GetType()
	return HeroConst.HERO_DATA_TYPE.OSIRISPLAYGAME
end

return OsirisPlayGameDataTemplate
