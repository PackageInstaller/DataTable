	...
	Play926011063 = function(arg_260_0, arg_260_1)
		...
		function arg_260_1.onSingleLineUpdate_(arg_263_0)
			...
			if 1.96666666666667 < arg_260_1.time_ and arg_260_1.time_ <= 1.96666666666667 + arg_263_0 then
				...
				for iter_263_2, iter_263_3 in ipairs((var_263_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_263_3.transform.localScale = Vector3.New(iter_263_3.transform.localScale.x / var_263_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_263_3.transform.localScale.y / var_263_15, iter_263_3.transform.localScale.z)
				end
			end
			...
			local var_263_19 = 3.43333333333333
			local var_263_20 = 1.35

			if 3.43333333333333 < arg_260_1.time_ and arg_260_1.time_ <= var_263_19 + arg_263_0 then
				...
				local var_263_21 = LeanTween.value(arg_260_1.dialog_, 0, 1, 0.3)

				var_263_21:setOnUpdate(LuaHelper.FloatAction(function(arg_264_0)
					arg_260_1.dialogCg_.alpha = arg_264_0
				end))
				var_263_21:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_260_1.dialog_)
					var_263_21:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_263_22 = arg_260_1:FormatText(arg_260_1:GetWordFromCfg(926011063).content)

				arg_260_1.text_.text = var_263_22

				LuaForUtil.ClearLinePrefixSymbol(arg_260_1.text_)

				local var_263_24 = 54 <= 0 and var_263_20 or var_263_20 * (utf8.len(var_263_22) / 54)

				if (54 <= 0 and var_263_20 or var_263_20 * (utf8.len(var_263_22) / 54)) > 0 and var_263_20 < var_263_24 then
					arg_260_1.talkMaxDuration = var_263_24
					var_263_19 = var_263_19 + 0.3

					if var_263_24 + var_263_19 > arg_260_1.duration_ then
						arg_260_1.duration_ = var_263_24 + var_263_19
					end
				end
			...
			local var_263_25 = var_263_19 + 0.3
			local var_263_26 = math.max(var_263_20, arg_260_1.talkMaxDuration)

			if var_263_19 + 0.3 <= arg_260_1.time_ and arg_260_1.time_ < var_263_25 + var_263_26 then
				arg_260_1.typewritter.percent = (arg_260_1.time_ - var_263_25) / var_263_26
	...
	Play926011074 = function(arg_308_0, arg_308_1)
		...
		function arg_308_1.onSingleLineUpdate_(arg_311_0)
			...
			if 0.0666666666666667 < arg_308_1.time_ and arg_308_1.time_ <= 0.0666666666666667 + arg_311_0 then
				...
				for iter_311_5, iter_311_6 in ipairs((var_311_16.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_311_6.transform.localScale = Vector3.New(iter_311_6.transform.localScale.x / var_311_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_311_6.transform.localScale.y / var_311_18, iter_311_6.transform.localScale.z)
				end
			end
			...
			local var_311_21 = 0.433333333333333
			local var_311_22 = 0.1

			if 0.433333333333333 < arg_308_1.time_ and arg_308_1.time_ <= var_311_21 + arg_311_0 then
				...
				local var_311_23 = arg_308_1:GetWordFromCfg(926011074)
				local var_311_24 = arg_308_1:FormatText(var_311_23.content)

				arg_308_1.text_.text = var_311_24

				LuaForUtil.ClearLinePrefixSymbol(arg_308_1.text_)

				local var_311_26 = 4 <= 0 and var_311_22 or var_311_22 * (utf8.len(var_311_24) / 4)

				if (4 <= 0 and var_311_22 or var_311_22 * (utf8.len(var_311_24) / 4)) > 0 and var_311_22 < var_311_26 then
					arg_308_1.talkMaxDuration = var_311_26

					if var_311_26 + var_311_21 > arg_308_1.duration_ then
						arg_308_1.duration_ = var_311_26 + var_311_21
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_926011", "926011074", "story_v_out_926011.awb") ~= 0 then
					local var_311_27 = manager.audio:GetVoiceLength("story_v_out_926011", "926011074", "story_v_out_926011.awb") / 1000

					if var_311_27 + var_311_21 > arg_308_1.duration_ then
						arg_308_1.duration_ = var_311_27 + var_311_21
					end

					if var_311_23.prefab_name ~= "" and arg_308_1.actors_[var_311_23.prefab_name] ~= nil then
						local var_311_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_308_1.actors_[var_311_23.prefab_name].transform, "story_v_out_926011", "926011074", "story_v_out_926011.awb")

						arg_308_1:RecordAudio("926011074", var_311_28)
						arg_308_1:RecordAudio("926011074", var_311_28)
					else
			...
			local var_311_29 = math.max(var_311_22, arg_308_1.talkMaxDuration)

			if var_311_21 <= arg_308_1.time_ and arg_308_1.time_ < var_311_21 + var_311_29 then
				arg_308_1.typewritter.percent = (arg_308_1.time_ - var_311_21) / var_311_29

				arg_308_1.typewritter:SetDirty()
			end

			if arg_308_1.time_ >= var_311_21 + var_311_29 and arg_308_1.time_ < var_311_21 + var_311_29 + arg_311_0 then
