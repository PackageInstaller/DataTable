	...
	Play417261088 = function(arg_362_0, arg_362_1)
		...
		function arg_362_1.onSingleLineUpdate_(arg_365_0)
			...
			if 1.33333333333333 < arg_362_1.time_ and arg_362_1.time_ <= 1.33333333333333 + arg_365_0 then
				...
				for iter_365_2, iter_365_3 in ipairs((var_365_25.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_365_3.transform.localScale = Vector3.New(iter_365_3.transform.localScale.x / var_365_27 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_365_3.transform.localScale.y / var_365_27, iter_365_3.transform.localScale.z)
				end
			end
	...
	Play417261089 = function(arg_366_0, arg_366_1)
		...
		function arg_366_1.onSingleLineUpdate_(arg_369_0)
			...
			if 1 < arg_366_1.time_ and arg_366_1.time_ <= 1 + arg_369_0 then
				...
				for iter_369_0, iter_369_1 in ipairs((var_369_9.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_369_1.transform.localScale = Vector3.New(iter_369_1.transform.localScale.x / var_369_11 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_369_1.transform.localScale.y / var_369_11, iter_369_1.transform.localScale.z)
				end
			end
