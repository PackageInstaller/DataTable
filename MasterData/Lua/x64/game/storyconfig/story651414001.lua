	...
	Play651414001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				local var_4_1 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(651414001).content)

				arg_1_1.text_.text = var_4_1

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_3 = 72 <= 0 and var_4_0 or var_4_0 * (utf8.len(var_4_1) / 72)

				if (72 <= 0 and var_4_0 or var_4_0 * (utf8.len(var_4_1) / 72)) > 0 and var_4_0 < var_4_3 then
