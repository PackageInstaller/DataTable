return {
	Play910831001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910831001).content)
	...
	Play910831002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 then
				...
				local var_10_10 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910831002).content)

				arg_7_1.text_.text = var_10_10

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_12 = 16 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 16)

				if (16 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 16)) > 0 and var_10_9 < var_10_12 then
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				for iter_14_0 = 0, arg_11_1.actors_["1084"].transform.childCount - 1 do
					...
					if var_14_0.name == "split_5" or not string.find(var_14_0.name, "split") then
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_5 + arg_14_0 then
				...
				local var_14_7 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910831003).content)

				arg_11_1.text_.text = var_14_7

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_9 = 16 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 16)

				if (16 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 16)) > 0 and var_14_6 < var_14_9 then
	...
	Play910831004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910831004).content)
	...
	Play910831005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_5 + arg_22_0 then
				...
				local var_22_7 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910831005).content)

				arg_19_1.text_.text = var_22_7

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_9 = 23 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 23)

				if (23 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 23)) > 0 and var_22_6 < var_22_9 then
	...
	Play910831006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910831006).content)

				arg_23_1.text_.text = var_26_7

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_9 = 31 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 31)

				if (31 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 31)) > 0 and var_26_6 < var_26_9 then
	...
	Play910831007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910831007).content)
	...
	Play910831008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910831008).content)
	...
	Play910831009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_5 + arg_38_0 then
				...
				local var_38_7 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910831009).content)
	...
	Play910831010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 then
				arg_39_1:AudioAction("play", "effect", "ui_skip", "ui_bgm_lower_back", "")
			end
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_6 + arg_42_0 then
				...
				local var_42_8 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910831010).content)

				arg_39_1.text_.text = var_42_8

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_10 = 5 <= 0 and var_42_7 or var_42_7 * (utf8.len(var_42_8) / 5)

				if (5 <= 0 and var_42_7 or var_42_7 * (utf8.len(var_42_8) / 5)) > 0 and var_42_7 < var_42_10 then
