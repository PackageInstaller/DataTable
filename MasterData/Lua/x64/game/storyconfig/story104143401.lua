return {
	Play414341001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 then
				...
				local var_4_18 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414341001).content)
	...
	Play414341002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(414341002).content)
	...
	Play414341003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(414341003).content)

				arg_13_1.text_.text = var_16_10

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_12 = 16 <= 0 and var_16_9 or var_16_9 * (utf8.len(var_16_10) / 16)

				if (16 <= 0 and var_16_9 or var_16_9 * (utf8.len(var_16_10) / 16)) > 0 and var_16_9 < var_16_12 then
	...
	Play414341004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.playNext_(arg_19_0)
			...
			arg_17_1:RecordChoiceLog(414341004, 905, 906)
		end
	...
	Play414341005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos1024ui_story = arg_21_1.actors_["1024ui_story"].transform.localPosition

				arg_21_1:ShowWeapon(arg_21_1.var_["1024ui_story" .. "Animator"].transform, false)
			end

			local var_24_0 = 0.001

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_0 then
				arg_21_1.actors_["1024ui_story"].transform.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1024ui_story, Vector3.New(0, -1, -6.05), (arg_21_1.time_ - 0) / var_24_0)
				arg_21_1.actors_["1024ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_21_1.actors_["1024ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1024ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1024ui_story"].transform.position).z)
				arg_21_1.actors_["1024ui_story"].transform.localEulerAngles.z = 0
				arg_21_1.actors_["1024ui_story"].transform.localEulerAngles.x = 0
				arg_21_1.actors_["1024ui_story"].transform.localEulerAngles = arg_21_1.actors_["1024ui_story"].transform.localEulerAngles
			end

			if arg_21_1.time_ >= 0 + var_24_0 and arg_21_1.time_ < 0 + var_24_0 + arg_24_0 then
				arg_21_1.actors_["1024ui_story"].transform.localPosition = Vector3.New(0, -1, -6.05)
				arg_21_1.actors_["1024ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_21_1.actors_["1024ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1024ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_21_1.actors_["1024ui_story"].transform.position).z)
				arg_21_1.actors_["1024ui_story"].transform.localEulerAngles.z = 0
				arg_21_1.actors_["1024ui_story"].transform.localEulerAngles.x = 0
				arg_21_1.actors_["1024ui_story"].transform.localEulerAngles = arg_21_1.actors_["1024ui_story"].transform.localEulerAngles
			...
			local var_24_1 = arg_21_1.actors_["1024ui_story"]

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(var_24_1) and arg_21_1.var_.characterEffect1024ui_story == nil then
				arg_21_1.var_.characterEffect1024ui_story = var_24_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_24_2 = 0.200000002980232

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_2 and not isNil(var_24_1) then
				if arg_21_1.var_.characterEffect1024ui_story and not isNil(var_24_1) then
					arg_21_1.var_.characterEffect1024ui_story.fillFlat = false
				end
			end

			if arg_21_1.time_ >= 0 + var_24_2 and arg_21_1.time_ < 0 + var_24_2 + arg_24_0 and not isNil(var_24_1) and arg_21_1.var_.characterEffect1024ui_story then
				arg_21_1.var_.characterEffect1024ui_story.fillFlat = false
			end

			local var_24_4 = "1024ui_story"

			if arg_21_1.actors_["1024ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1024ui_story"))) then
				local var_24_5 = Object.Instantiate(Asset.Load("Char/" .. "1024ui_story"), arg_21_1.stage_.transform)
			...
			local var_24_8 = "1024ui_story"

			if arg_21_1.actors_["1024ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1024ui_story"))) then
				local var_24_9 = Object.Instantiate(Asset.Load("Char/" .. "1024ui_story"), arg_21_1.stage_.transform)

				var_24_9.name = var_24_8
				var_24_9.transform.localPosition = Vector3.New(0, 100, 0)
				arg_21_1.actors_[var_24_8] = var_24_9

				local var_24_10 = var_24_9:GetComponentInChildren(typeof(CharacterEffect))

				var_24_10.enabled = true

				local var_24_11 = GameObjectTools.GetOrAddComponent(var_24_9, typeof(DynamicBoneHelper))

				if var_24_11 then
					var_24_11:EnableDynamicBone(false)
				end

				arg_21_1:ShowWeapon(var_24_10.transform, false)

				arg_21_1.var_[var_24_8 .. "Animator"] = var_24_10.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_21_1.var_[var_24_8 .. "Animator"].applyRootMotion = true
				arg_21_1.var_[var_24_8 .. "LipSync"] = var_24_10.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_12 + arg_24_0 then
				...
				local var_24_14 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(414341005).content)

				arg_21_1.text_.text = var_24_14

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_16 = 11 <= 0 and var_24_13 or var_24_13 * (utf8.len(var_24_14) / 11)

				if (11 <= 0 and var_24_13 or var_24_13 * (utf8.len(var_24_14) / 11)) > 0 and var_24_13 < var_24_16 then
	...
	Play414341006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_0 then
				arg_25_1.actors_["1024ui_story"].transform.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos1024ui_story, Vector3.New(0, 100, 0), (arg_25_1.time_ - 0) / var_28_0)
			...
			if arg_25_1.time_ >= 0 + var_28_0 and arg_25_1.time_ < 0 + var_28_0 + arg_28_0 then
				arg_25_1.actors_["1024ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_25_1.actors_["1024ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_25_1.actors_["1024ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_25_1.actors_["1024ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_25_1.actors_["1024ui_story"].transform.position).z)
				arg_25_1.actors_["1024ui_story"].transform.localEulerAngles.z = 0
				arg_25_1.actors_["1024ui_story"].transform.localEulerAngles.x = 0
				arg_25_1.actors_["1024ui_story"].transform.localEulerAngles = arg_25_1.actors_["1024ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_2 and not isNil(var_28_1) then
				if arg_25_1.var_.characterEffect1024ui_story and not isNil(var_28_1) then
					...
					arg_25_1.var_.characterEffect1024ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_25_1.time_ - 0) / var_28_2)
				end
			end
			...
			local var_28_3 = "1035ui_story"

			if arg_25_1.actors_["1035ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1035ui_story"))) then
				local var_28_4 = Object.Instantiate(Asset.Load("Char/" .. "1035ui_story"), arg_25_1.stage_.transform)
			...
			local var_28_7 = arg_25_1.actors_["1035ui_story"].transform

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				arg_25_1.var_.moveOldPos1035ui_story = var_28_7.localPosition
			end

			local var_28_8 = 0.001

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_8 then
				var_28_7.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos1035ui_story, Vector3.New(0, -1.05, -5.6), (arg_25_1.time_ - 0) / var_28_8)
			...
			if arg_25_1.time_ >= 0 + var_28_8 and arg_25_1.time_ < 0 + var_28_8 + arg_28_0 then
				var_28_7.localPosition = Vector3.New(0, -1.05, -5.6)
				var_28_7.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_28_7.position).x, (manager.ui.mainCamera.transform.position - var_28_7.position).y, (manager.ui.mainCamera.transform.position - var_28_7.position).z)
				var_28_7.localEulerAngles.z = 0
				var_28_7.localEulerAngles.x = 0
				var_28_7.localEulerAngles = var_28_7.localEulerAngles
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(var_28_9) and arg_25_1.var_.characterEffect1035ui_story == nil then
			...
			if arg_25_1.time_ >= 0 + var_28_10 and arg_25_1.time_ < 0 + var_28_10 + arg_28_0 and not isNil(var_28_9) and arg_25_1.var_.characterEffect1035ui_story then
				arg_25_1.var_.characterEffect1035ui_story.fillFlat = false
			end

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				arg_25_1:PlayTimeline("1035ui_story", "StoryTimeline/CharAction/story1035/story1035action/1035action6_1")
			end
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_12 + arg_28_0 then
				...
				local var_28_14 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(414341006).content)

				arg_25_1.text_.text = var_28_14

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_16 = 13 <= 0 and var_28_13 or var_28_13 * (utf8.len(var_28_14) / 13)

				if (13 <= 0 and var_28_13 or var_28_13 * (utf8.len(var_28_14) / 13)) > 0 and var_28_13 < var_28_16 then
	...
	Play414341007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			local var_32_3 = "1016ui_story"

			if arg_29_1.actors_["1016ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1016ui_story"))) then
				local var_32_4 = Object.Instantiate(Asset.Load("Char/" .. "1016ui_story"), arg_29_1.stage_.transform)
			...
			local var_32_7 = arg_29_1.actors_["1016ui_story"].transform

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos1016ui_story = var_32_7.localPosition

				arg_29_1:ShowWeapon(arg_29_1.var_["1016ui_story" .. "Animator"].transform, false)
			end

			local var_32_8 = 0.001

			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_8 then
				var_32_7.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1016ui_story, Vector3.New(0, -18.66, -121.78), (arg_29_1.time_ - 0) / var_32_8)
			...
			if arg_29_1.time_ >= 0 + var_32_8 and arg_29_1.time_ < 0 + var_32_8 + arg_32_0 then
				var_32_7.localPosition = Vector3.New(0, -18.66, -121.78)
				var_32_7.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_32_7.position).x, (manager.ui.mainCamera.transform.position - var_32_7.position).y, (manager.ui.mainCamera.transform.position - var_32_7.position).z)
				var_32_7.localEulerAngles.z = 0
				var_32_7.localEulerAngles.x = 0
				var_32_7.localEulerAngles = var_32_7.localEulerAngles
			...
			local var_32_9 = arg_29_1.actors_["1016ui_story"]

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(var_32_9) and arg_29_1.var_.characterEffect1016ui_story == nil then
				arg_29_1.var_.characterEffect1016ui_story = var_32_9:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_32_10 = 0.200000002980232

			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_10 and not isNil(var_32_9) then
				if arg_29_1.var_.characterEffect1016ui_story and not isNil(var_32_9) then
					arg_29_1.var_.characterEffect1016ui_story.fillFlat = false
				end
			end

			if arg_29_1.time_ >= 0 + var_32_10 and arg_29_1.time_ < 0 + var_32_10 + arg_32_0 and not isNil(var_32_9) and arg_29_1.var_.characterEffect1016ui_story then
				arg_29_1.var_.characterEffect1016ui_story.fillFlat = false
			end

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1:PlayTimeline("1016ui_story", "StoryTimeline/CharAction/story1016/story1016action/1016action4_1")
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_12 + arg_32_0 then
				...
				local var_32_14 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(414341007).content)

				arg_29_1.text_.text = var_32_14

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_16 = 10 <= 0 and var_32_13 or var_32_13 * (utf8.len(var_32_14) / 10)

				if (10 <= 0 and var_32_13 or var_32_13 * (utf8.len(var_32_14) / 10)) > 0 and var_32_13 < var_32_16 then
					arg_29_1.talkMaxDuration = var_32_16

					if var_32_16 + var_32_12 > arg_29_1.duration_ then
						arg_29_1.duration_ = var_32_16 + var_32_12
					end
				end
			...
			local var_32_17 = math.max(var_32_13, arg_29_1.talkMaxDuration)

			if var_32_12 <= arg_29_1.time_ and arg_29_1.time_ < var_32_12 + var_32_17 then
				arg_29_1.typewritter.percent = (arg_29_1.time_ - var_32_12) / var_32_17

				arg_29_1.typewritter:SetDirty()
			end

			if arg_29_1.time_ >= var_32_12 + var_32_17 and arg_29_1.time_ < var_32_12 + var_32_17 + arg_32_0 then
	...
	Play414341008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_0 then
				arg_33_1.actors_["1016ui_story"].transform.localPosition = Vector3.Lerp(arg_33_1.var_.moveOldPos1016ui_story, Vector3.New(0, 100, 0), (arg_33_1.time_ - 0) / var_36_0)
			...
			if arg_33_1.time_ >= 0 + var_36_0 and arg_33_1.time_ < 0 + var_36_0 + arg_36_0 then
				arg_33_1.actors_["1016ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_33_1.actors_["1016ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_33_1.actors_["1016ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_33_1.actors_["1016ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_33_1.actors_["1016ui_story"].transform.position).z)
				arg_33_1.actors_["1016ui_story"].transform.localEulerAngles.z = 0
				arg_33_1.actors_["1016ui_story"].transform.localEulerAngles.x = 0
				arg_33_1.actors_["1016ui_story"].transform.localEulerAngles = arg_33_1.actors_["1016ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_2 and not isNil(var_36_1) then
				if arg_33_1.var_.characterEffect1016ui_story and not isNil(var_36_1) then
					...
					arg_33_1.var_.characterEffect1016ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_33_1.time_ - 0) / var_36_2)
				end
			end
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				arg_33_1:PlayTimeline("1024ui_story", "StoryTimeline/CharAction/story1024/story1024action/1024action2_2")
			end
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_8 + arg_36_0 then
				...
				local var_36_10 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(414341008).content)

				arg_33_1.text_.text = var_36_10

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_12 = 28 <= 0 and var_36_9 or var_36_9 * (utf8.len(var_36_10) / 28)

				if (28 <= 0 and var_36_9 or var_36_9 * (utf8.len(var_36_10) / 28)) > 0 and var_36_9 < var_36_12 then
	...
	Play414341009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_3 + arg_40_0 then
				...
				local var_40_5 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(414341009).content)

				arg_37_1.text_.text = var_40_5

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_7 = 69 <= 0 and var_40_4 or var_40_4 * (utf8.len(var_40_5) / 69)

				if (69 <= 0 and var_40_4 or var_40_4 * (utf8.len(var_40_5) / 69)) > 0 and var_40_4 < var_40_7 then
	...
	Play414341010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1.var_.moveOldPos1035ui_story = arg_41_1.actors_["1035ui_story"].transform.localPosition
			end

			local var_44_0 = 0.001

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_0 then
				arg_41_1.actors_["1035ui_story"].transform.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1035ui_story, Vector3.New(0, -1.05, -5.6), (arg_41_1.time_ - 0) / var_44_0)
				arg_41_1.actors_["1035ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_41_1.actors_["1035ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_41_1.actors_["1035ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_41_1.actors_["1035ui_story"].transform.position).z)
				arg_41_1.actors_["1035ui_story"].transform.localEulerAngles.z = 0
				arg_41_1.actors_["1035ui_story"].transform.localEulerAngles.x = 0
				arg_41_1.actors_["1035ui_story"].transform.localEulerAngles = arg_41_1.actors_["1035ui_story"].transform.localEulerAngles
			end

			if arg_41_1.time_ >= 0 + var_44_0 and arg_41_1.time_ < 0 + var_44_0 + arg_44_0 then
				arg_41_1.actors_["1035ui_story"].transform.localPosition = Vector3.New(0, -1.05, -5.6)
				arg_41_1.actors_["1035ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_41_1.actors_["1035ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_41_1.actors_["1035ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_41_1.actors_["1035ui_story"].transform.position).z)
				arg_41_1.actors_["1035ui_story"].transform.localEulerAngles.z = 0
				arg_41_1.actors_["1035ui_story"].transform.localEulerAngles.x = 0
				arg_41_1.actors_["1035ui_story"].transform.localEulerAngles = arg_41_1.actors_["1035ui_story"].transform.localEulerAngles
			...
			local var_44_1 = arg_41_1.actors_["1035ui_story"]

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(var_44_1) and arg_41_1.var_.characterEffect1035ui_story == nil then
				arg_41_1.var_.characterEffect1035ui_story = var_44_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_44_2 = 0.200000002980232

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_2 and not isNil(var_44_1) then
				if arg_41_1.var_.characterEffect1035ui_story and not isNil(var_44_1) then
					arg_41_1.var_.characterEffect1035ui_story.fillFlat = false
				end
			end

			if arg_41_1.time_ >= 0 + var_44_2 and arg_41_1.time_ < 0 + var_44_2 + arg_44_0 and not isNil(var_44_1) and arg_41_1.var_.characterEffect1035ui_story then
				arg_41_1.var_.characterEffect1035ui_story.fillFlat = false
			end

			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1:PlayTimeline("1035ui_story", "StoryTimeline/CharAction/story1035/story1035actionlink/1035action462")
			end
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_4 + arg_44_0 then
				...
				arg_41_1.leftNameTxt_.text = arg_41_1:FormatText(StoryNameCfg[21].name)
				...
				local var_44_6 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(414341010).content)

				arg_41_1.text_.text = var_44_6

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_8 = 14 <= 0 and var_44_5 or var_44_5 * (utf8.len(var_44_6) / 14)

				if (14 <= 0 and var_44_5 or var_44_5 * (utf8.len(var_44_6) / 14)) > 0 and var_44_5 < var_44_8 then
	...
	Play414341011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1016ui_story = arg_45_1.actors_["1016ui_story"].transform.localPosition
			end

			local var_48_0 = 0.001

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_0 then
				arg_45_1.actors_["1016ui_story"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1016ui_story, Vector3.New(0, 100, 0), (arg_45_1.time_ - 0) / var_48_0)
				arg_45_1.actors_["1016ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["1016ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1016ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1016ui_story"].transform.position).z)
				arg_45_1.actors_["1016ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["1016ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["1016ui_story"].transform.localEulerAngles = arg_45_1.actors_["1016ui_story"].transform.localEulerAngles
			end

			if arg_45_1.time_ >= 0 + var_48_0 and arg_45_1.time_ < 0 + var_48_0 + arg_48_0 then
				arg_45_1.actors_["1016ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_45_1.actors_["1016ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["1016ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1016ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1016ui_story"].transform.position).z)
				arg_45_1.actors_["1016ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["1016ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["1016ui_story"].transform.localEulerAngles = arg_45_1.actors_["1016ui_story"].transform.localEulerAngles
			...
			local var_48_1 = arg_45_1.actors_["1016ui_story"]

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(var_48_1) and arg_45_1.var_.characterEffect1016ui_story == nil then
				arg_45_1.var_.characterEffect1016ui_story = var_48_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_48_2 = 0.200000002980232

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_2 and not isNil(var_48_1) then
				if arg_45_1.var_.characterEffect1016ui_story and not isNil(var_48_1) then
					arg_45_1.var_.characterEffect1016ui_story.fillFlat = true
					arg_45_1.var_.characterEffect1016ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_45_1.time_ - 0) / var_48_2)
				end
			end

			if arg_45_1.time_ >= 0 + var_48_2 and arg_45_1.time_ < 0 + var_48_2 + arg_48_0 and not isNil(var_48_1) and arg_45_1.var_.characterEffect1016ui_story then
				arg_45_1.var_.characterEffect1016ui_story.fillFlat = true
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_4 then
				var_48_3.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1024ui_story, Vector3.New(0, -1, -6.05), (arg_45_1.time_ - 0) / var_48_4)
			...
			if arg_45_1.time_ >= 0 + var_48_4 and arg_45_1.time_ < 0 + var_48_4 + arg_48_0 then
				var_48_3.localPosition = Vector3.New(0, -1, -6.05)
				var_48_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_48_3.position).x, (manager.ui.mainCamera.transform.position - var_48_3.position).y, (manager.ui.mainCamera.transform.position - var_48_3.position).z)
				var_48_3.localEulerAngles.z = 0
				var_48_3.localEulerAngles.x = 0
				var_48_3.localEulerAngles = var_48_3.localEulerAngles
			...
			local var_48_8 = arg_45_1.actors_["1035ui_story"]

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(var_48_8) and arg_45_1.var_.characterEffect1035ui_story == nil then
				arg_45_1.var_.characterEffect1035ui_story = var_48_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_48_9 = 0.200000002980232

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_9 and not isNil(var_48_8) then
				if arg_45_1.var_.characterEffect1035ui_story and not isNil(var_48_8) then
					arg_45_1.var_.characterEffect1035ui_story.fillFlat = true
					arg_45_1.var_.characterEffect1035ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_45_1.time_ - 0) / var_48_9)
				end
			end

			if arg_45_1.time_ >= 0 + var_48_9 and arg_45_1.time_ < 0 + var_48_9 + arg_48_0 and not isNil(var_48_8) and arg_45_1.var_.characterEffect1035ui_story then
				arg_45_1.var_.characterEffect1035ui_story.fillFlat = true
				arg_45_1.var_.characterEffect1035ui_story.fillRatio = 0.5
			end

			local var_48_10 = arg_45_1.actors_["1035ui_story"].transform

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1035ui_story = var_48_10.localPosition
			end

			local var_48_11 = 0.001

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_11 then
				var_48_10.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1035ui_story, Vector3.New(0, 100, 0), (arg_45_1.time_ - 0) / var_48_11)
				var_48_10.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_48_10.position).x, (manager.ui.mainCamera.transform.position - var_48_10.position).y, (manager.ui.mainCamera.transform.position - var_48_10.position).z)
				var_48_10.localEulerAngles.z = 0
				var_48_10.localEulerAngles.x = 0
				var_48_10.localEulerAngles = var_48_10.localEulerAngles
			end
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_12 + arg_48_0 then
				...
				local var_48_14 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(414341011).content)

				arg_45_1.text_.text = var_48_14

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_16 = 3 <= 0 and var_48_13 or var_48_13 * (utf8.len(var_48_14) / 3)

				if (3 <= 0 and var_48_13 or var_48_13 * (utf8.len(var_48_14) / 3)) > 0 and var_48_13 < var_48_16 then
	...
	Play414341012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(414341012).content)
	...
	Play414341013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_3 + arg_56_0 then
				...
				local var_56_5 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(414341013).content)
	...
	Play414341014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				...
				local var_60_1 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(414341014).content)
	...
	Play414341015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_8 + arg_64_0 then
				...
				local var_64_10 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(414341015).content)

				arg_61_1.text_.text = var_64_10

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_12 = 11 <= 0 and var_64_9 or var_64_9 * (utf8.len(var_64_10) / 11)

				if (11 <= 0 and var_64_9 or var_64_9 * (utf8.len(var_64_10) / 11)) > 0 and var_64_9 < var_64_12 then
	...
	Play414341016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.playNext_(arg_67_0)
			...
			arg_65_1:RecordChoiceLog(414341016, 907, 908)
		end
	...
	Play414341017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				arg_69_1.var_.moveOldPos104902ui_story = arg_69_1.actors_["104902ui_story"].transform.localPosition
			end

			local var_72_0 = 0.001

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_0 then
				arg_69_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos104902ui_story, Vector3.New(0, 100, 0), (arg_69_1.time_ - 0) / var_72_0)
				arg_69_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).z)
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles = arg_69_1.actors_["104902ui_story"].transform.localEulerAngles
			end

			if arg_69_1.time_ >= 0 + var_72_0 and arg_69_1.time_ < 0 + var_72_0 + arg_72_0 then
				arg_69_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_69_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).z)
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles = arg_69_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				arg_69_1:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_machineactivate", "")
			end
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_2 + arg_72_0 then
				...
				local var_72_4 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(414341017).content)
	...
	Play414341019 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0.333333333333333 < arg_73_1.time_ and arg_73_1.time_ <= 0.333333333333333 + arg_76_0 then
				...
				local var_76_1 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(414341019).content)
				...
				if (54 <= 0 and var_76_0 or var_76_0 * (utf8.len(var_76_1) / 54)) > 0 and var_76_0 < var_76_3 then
					...
					if var_76_3 + 0.333333333333333 > arg_73_1.duration_ then
						arg_73_1.duration_ = var_76_3 + 0.333333333333333
					end
				end
			...
			if 0.333333333333333 <= arg_73_1.time_ and arg_73_1.time_ < 0.333333333333333 + var_76_4 then
				arg_73_1.typewritter.percent = (arg_73_1.time_ - 0.333333333333333) / var_76_4

				arg_73_1.typewritter:SetDirty()
			end

			if arg_73_1.time_ >= 0.333333333333333 + var_76_4 and arg_73_1.time_ < 0.333333333333333 + var_76_4 + arg_76_0 then
	...
	Play414341020 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				...
				local var_80_1 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(414341020).content)
	...
	Play414341018 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= 0 + arg_84_0 then
				arg_81_1:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_machineactivate", "")
			end
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= var_84_2 + arg_84_0 then
				...
				local var_84_4 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(414341018).content)

				arg_81_1.text_.text = var_84_4

				LuaForUtil.ClearLinePrefixSymbol(arg_81_1.text_)

				local var_84_6 = 11 <= 0 and var_84_3 or var_84_3 * (utf8.len(var_84_4) / 11)

				if (11 <= 0 and var_84_3 or var_84_3 * (utf8.len(var_84_4) / 11)) > 0 and var_84_3 < var_84_6 then
