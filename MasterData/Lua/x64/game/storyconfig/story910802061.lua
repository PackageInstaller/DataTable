	...
	Play910815001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910815001).content)
	...
	Play910815002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 then
				...
				local var_10_10 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910815002).content)
	...
	Play910815003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_5 + arg_14_0 then
				...
				local var_14_7 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910815003).content)

				arg_11_1.text_.text = var_14_7

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_9 = 45 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 45)

				if (45 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 45)) > 0 and var_14_6 < var_14_9 then
	...
	Play910815004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910815004).content)
	...
	Play910815005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_5 + arg_22_0 then
				...
				local var_22_7 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910815005).content)

				arg_19_1.text_.text = var_22_7

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_9 = 14 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 14)

				if (14 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 14)) > 0 and var_22_6 < var_22_9 then
	...
	Play910815006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910815006).content)

				arg_23_1.text_.text = var_26_7

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_9 = 28 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 28)

				if (28 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 28)) > 0 and var_26_6 < var_26_9 then
	...
	Play910815007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910815007).content)

				arg_27_1.text_.text = var_30_7

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_9 = 39 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 39)

				if (39 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 39)) > 0 and var_30_6 < var_30_9 then
	...
	Play910815008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910815008).content)
	...
	Play910815009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_5 + arg_38_0 then
				...
				local var_38_7 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910815009).content)

				arg_35_1.text_.text = var_38_7

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_9 = 45 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 45)

				if (45 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 45)) > 0 and var_38_6 < var_38_9 then
	...
	Play910815010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910815010).content)

				arg_39_1.text_.text = var_42_7

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_9 = 25 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 25)

				if (25 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 25)) > 0 and var_42_6 < var_42_9 then
	...
	Play910815011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_5 + arg_46_0 then
				...
				local var_46_7 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910815011).content)

				arg_43_1.text_.text = var_46_7

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_9 = 16 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 16)

				if (16 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 16)) > 0 and var_46_6 < var_46_9 then
	...
	Play910815012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_5 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910815012).content)

				arg_47_1.text_.text = var_50_7

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_9 = 26 <= 0 and var_50_6 or var_50_6 * (utf8.len(var_50_7) / 26)

				if (26 <= 0 and var_50_6 or var_50_6 * (utf8.len(var_50_7) / 26)) > 0 and var_50_6 < var_50_9 then
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 then
				...
				for iter_54_0 = 0, arg_51_1.actors_["1070"].transform.childCount - 1 do
					...
					if var_54_0.name == "split_6" or not string.find(var_54_0.name, "split") then
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_5 + arg_54_0 then
				...
				local var_54_7 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910815013).content)
	...
	Play910815014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_5 + arg_58_0 then
				...
				local var_58_7 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910815014).content)

				arg_55_1.text_.text = var_58_7

				LuaForUtil.ClearLinePrefixSymbol(arg_55_1.text_)

				local var_58_9 = 14 <= 0 and var_58_6 or var_58_6 * (utf8.len(var_58_7) / 14)

				if (14 <= 0 and var_58_6 or var_58_6 * (utf8.len(var_58_7) / 14)) > 0 and var_58_6 < var_58_9 then
	...
	Play910815015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_6 + arg_62_0 then
				...
				local var_62_8 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(910815015).content)
