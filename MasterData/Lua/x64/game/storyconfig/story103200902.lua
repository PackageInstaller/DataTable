	...
	Play320092009 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 then
				...
				for iter_42_0, iter_42_1 in ipairs((var_42_3.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_42_1.transform.localScale = Vector3.New(iter_42_1.transform.localScale.x / var_42_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_42_1.transform.localScale.y / var_42_5, iter_42_1.transform.localScale.z)
				end
			end
			...
			if 1 < arg_39_1.time_ and arg_39_1.time_ <= var_42_9 + arg_42_0 then
				...
				local var_42_12 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(320092009).content)

				arg_39_1.text_.text = var_42_12

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_14 = 23 <= 0 and var_42_10 or var_42_10 * (utf8.len(var_42_12) / 23)

				if (23 <= 0 and var_42_10 or var_42_10 * (utf8.len(var_42_12) / 23)) > 0 and var_42_10 < var_42_14 then
