	...
	Play924011048 = function(arg_198_0, arg_198_1)
		...
		function arg_198_1.onSingleLineUpdate_(arg_201_0)
			...
			if 1 < arg_198_1.time_ and arg_198_1.time_ <= 1 + arg_201_0 then
				...
				for iter_201_0, iter_201_1 in ipairs((var_201_9.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_201_1.transform.localScale = Vector3.New(iter_201_1.transform.localScale.x / var_201_11 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_201_1.transform.localScale.y / var_201_11, iter_201_1.transform.localScale.z)
				end
			end

			if 5.499999999999 < arg_198_1.time_ and arg_198_1.time_ <= 5.499999999999 + arg_201_0 then
				local var_201_13 = arg_198_1.var_.effectjingbao2

				if not arg_198_1.var_.effectjingbao2 then
					var_201_13 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_jingbao_out"), manager.ui.mainCamera.transform)
					var_201_13.name = "jingbao2"
					arg_198_1.var_.effectjingbao2 = var_201_13
				else
					var_201_13.transform:SetParent(var_201_9001)
				end

				var_201_13.transform.localPosition = Vector3.New(0, 0, 0)
				var_201_13.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_201_15 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_201_2, iter_201_3 in ipairs((var_201_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_201_3.transform.localScale = Vector3.New(iter_201_3.transform.localScale.x / var_201_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_201_3.transform.localScale.y / var_201_15, iter_201_3.transform.localScale.z)
				end
			end
			...
			if 1 < arg_198_1.time_ and arg_198_1.time_ <= 1 + arg_201_0 then
				local var_201_19 = arg_198_1.var_.effectjingbao3jingbao3

				if not arg_198_1.var_.effectjingbao3jingbao3 then
					var_201_19 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_mist_out"), manager.ui.mainCamera.transform)
					var_201_19.name = "jingbao3"
					arg_198_1.var_.effectjingbao3jingbao3 = var_201_19
				else
					var_201_19.transform:SetParent(var_201_9000)
				end

				var_201_19.transform.localPosition = Vector3.New(0, 0, 0)
				var_201_19.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_201_21 = 2.55

			if 2.55 < arg_198_1.time_ and arg_198_1.time_ <= var_201_21 + arg_201_0 then
				arg_198_1.allBtn_.enabled = false
			end

			if arg_198_1.time_ >= var_201_21 + 2.949999999999 and arg_198_1.time_ < var_201_21 + 2.949999999999 + arg_201_0 then
			...
			local var_201_23 = 4
			local var_201_24 = 0.125

			if 4 < arg_198_1.time_ and arg_198_1.time_ <= var_201_23 + arg_201_0 then
				...
				local var_201_25 = LeanTween.value(arg_198_1.dialog_, 0, 1, 0.3)

				var_201_25:setOnUpdate(LuaHelper.FloatAction(function(arg_202_0)
					arg_198_1.dialogCg_.alpha = arg_202_0
				end))
				var_201_25:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_198_1.dialog_)
					var_201_25:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_201_26 = arg_198_1:FormatText(arg_198_1:GetWordFromCfg(924011048).content)

				arg_198_1.text_.text = var_201_26

				LuaForUtil.ClearLinePrefixSymbol(arg_198_1.text_)

				local var_201_28 = 5 <= 0 and var_201_24 or var_201_24 * (utf8.len(var_201_26) / 5)

				if (5 <= 0 and var_201_24 or var_201_24 * (utf8.len(var_201_26) / 5)) > 0 and var_201_24 < var_201_28 then
					arg_198_1.talkMaxDuration = var_201_28
					var_201_23 = var_201_23 + 0.3

					if var_201_28 + var_201_23 > arg_198_1.duration_ then
						arg_198_1.duration_ = var_201_28 + var_201_23
					end
				end
			...
			local var_201_29 = var_201_23 + 0.3
			local var_201_30 = math.max(var_201_24, arg_198_1.talkMaxDuration)

			if var_201_23 + 0.3 <= arg_198_1.time_ and arg_198_1.time_ < var_201_29 + var_201_30 then
				arg_198_1.typewritter.percent = (arg_198_1.time_ - var_201_29) / var_201_30

				arg_198_1.typewritter:SetDirty()
			end

			if arg_198_1.time_ >= var_201_29 + var_201_30 and arg_198_1.time_ < var_201_29 + var_201_30 + arg_201_0 then
