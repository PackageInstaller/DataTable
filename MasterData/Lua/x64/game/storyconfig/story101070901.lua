return {
	Play107091001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.actors_["1038ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1038ui_story"))) then
				local var_4_0 = Object.Instantiate(Asset.Load("Char/" .. "1038ui_story"), arg_1_1.stage_.transform)

				var_4_0.name = "1038ui_story"
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.actors_["1038ui_story"] = var_4_0
				...
				arg_1_1.var_["1038ui_story" .. "Animator"] = var_4_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_1_1.var_["1038ui_story" .. "Animator"].applyRootMotion = true
				arg_1_1.var_["1038ui_story" .. "LipSync"] = var_4_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_4_3 = arg_1_1.actors_["1038ui_story"]

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 and not isNil(var_4_3) and arg_1_1.var_.characterEffect1038ui_story == nil then
				arg_1_1.var_.characterEffect1038ui_story = var_4_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_4 = 0.1

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_4 and not isNil(var_4_3) then
				if arg_1_1.var_.characterEffect1038ui_story and not isNil(var_4_3) then
					arg_1_1.var_.characterEffect1038ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 1.8 + var_4_4 and arg_1_1.time_ < 1.8 + var_4_4 + arg_4_0 and not isNil(var_4_3) and arg_1_1.var_.characterEffect1038ui_story then
				arg_1_1.var_.characterEffect1038ui_story.fillFlat = false
			end
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_8 = arg_1_1.bgs_.C06b
			...
			local var_4_11 = arg_1_1.actors_["1038ui_story"].transform

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1.var_.moveOldPos1038ui_story = var_4_11.localPosition
			end

			local var_4_12 = 0.001

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_12 then
				var_4_11.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1038ui_story, Vector3.New(0, -1.11, -5.9), (arg_1_1.time_ - 1.8) / var_4_12)
			...
			if arg_1_1.time_ >= 1.8 + var_4_12 and arg_1_1.time_ < 1.8 + var_4_12 + arg_4_0 then
				var_4_11.localPosition = Vector3.New(0, -1.11, -5.9)
				var_4_11.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_11.position).x, (manager.ui.mainCamera.transform.position - var_4_11.position).y, (manager.ui.mainCamera.transform.position - var_4_11.position).z)
				var_4_11.localEulerAngles.z = 0
				var_4_11.localEulerAngles.x = 0
				var_4_11.localEulerAngles = var_4_11.localEulerAngles
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_13 = arg_1_1.bgs_.C06b:GetComponent("SpriteRenderer")
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_14 then
				if arg_1_1.var_.alphaMatValueC06b then
					arg_1_1.var_.alphaMatValueC06b.color.a = Mathf.Lerp(arg_1_1.var_.alphaOldValueC06b, 1, (arg_1_1.time_ - 0) / var_4_14)
					arg_1_1.var_.alphaMatValueC06b.color = arg_1_1.var_.alphaMatValueC06b.color
				end
			end

			if arg_1_1.time_ >= 0 + var_4_14 and arg_1_1.time_ < 0 + var_4_14 + arg_4_0 and arg_1_1.var_.alphaMatValueC06b then
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_19 + arg_4_0 then
				...
				local var_4_22 = arg_1_1:GetWordFromCfg(107091001)
				...
				local var_4_25 = 37 <= 0 and var_4_20 or var_4_20 * (utf8.len(var_4_23) / 37)

				if (37 <= 0 and var_4_20 or var_4_20 * (utf8.len(var_4_23) / 37)) > 0 and var_4_20 < var_4_25 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091001", "story_v_out_107091.awb") ~= 0 then
					local var_4_26 = manager.audio:GetVoiceLength("story_v_out_107091", "107091001", "story_v_out_107091.awb") / 1000
					...
					if var_4_22.prefab_name ~= "" and arg_1_1.actors_[var_4_22.prefab_name] ~= nil then
						local var_4_27 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_22.prefab_name].transform, "story_v_out_107091", "107091001", "story_v_out_107091.awb")

						arg_1_1:RecordAudio("107091001", var_4_27)
						arg_1_1:RecordAudio("107091001", var_4_27)
					else
	...
	Play107091002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_0 + arg_11_0 then
				...
				arg_8_1.leftNameTxt_.text = arg_8_1:FormatText(StoryNameCfg[94].name)
				...
				local var_11_2 = arg_8_1:GetWordFromCfg(107091002)
				...
				local var_11_5 = 35 <= 0 and var_11_1 or var_11_1 * (utf8.len(var_11_3) / 35)

				if (35 <= 0 and var_11_1 or var_11_1 * (utf8.len(var_11_3) / 35)) > 0 and var_11_1 < var_11_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091002", "story_v_out_107091.awb") ~= 0 then
					local var_11_6 = manager.audio:GetVoiceLength("story_v_out_107091", "107091002", "story_v_out_107091.awb") / 1000
					...
					if var_11_2.prefab_name ~= "" and arg_8_1.actors_[var_11_2.prefab_name] ~= nil then
						local var_11_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_2.prefab_name].transform, "story_v_out_107091", "107091002", "story_v_out_107091.awb")

						arg_8_1:RecordAudio("107091002", var_11_7)
						arg_8_1:RecordAudio("107091002", var_11_7)
					else
	...
	Play107091003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 and not isNil(arg_12_1.actors_["1038ui_story"]) and arg_12_1.var_.characterEffect1038ui_story == nil then
				arg_12_1.var_.characterEffect1038ui_story = arg_12_1.actors_["1038ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_15_0 = 0.1

			if 0 <= arg_12_1.time_ and arg_12_1.time_ < 0 + var_15_0 and not isNil(arg_12_1.actors_["1038ui_story"]) then
				if arg_12_1.var_.characterEffect1038ui_story and not isNil(arg_12_1.actors_["1038ui_story"]) then
					arg_12_1.var_.characterEffect1038ui_story.fillFlat = true
					arg_12_1.var_.characterEffect1038ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_12_1.time_ - 0) / var_15_0)
				end
			end

			if arg_12_1.time_ >= 0 + var_15_0 and arg_12_1.time_ < 0 + var_15_0 + arg_15_0 and not isNil(arg_12_1.actors_["1038ui_story"]) and arg_12_1.var_.characterEffect1038ui_story then
				arg_12_1.var_.characterEffect1038ui_story.fillFlat = true
				arg_12_1.var_.characterEffect1038ui_story.fillRatio = 0.5
			end

			local var_15_1 = 0
			local var_15_2 = 0.075
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_1 + arg_15_0 then
				...
				local var_15_3 = arg_12_1:FormatText(arg_12_1:GetWordFromCfg(107091003).content)

				arg_12_1.text_.text = var_15_3

				LuaForUtil.ClearLinePrefixSymbol(arg_12_1.text_)

				local var_15_5 = 3 <= 0 and var_15_2 or var_15_2 * (utf8.len(var_15_3) / 3)

				if (3 <= 0 and var_15_2 or var_15_2 * (utf8.len(var_15_3) / 3)) > 0 and var_15_2 < var_15_5 then
	...
	Play107091004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 then
				...
				local var_19_1 = arg_16_1:FormatText(arg_16_1:GetWordFromCfg(107091004).content)
	...
	Play107091005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 then
				arg_20_1.var_.moveOldPos1038ui_story = arg_20_1.actors_["1038ui_story"].transform.localPosition
			end

			local var_23_0 = 0.001

			if 0 <= arg_20_1.time_ and arg_20_1.time_ < 0 + var_23_0 then
				arg_20_1.actors_["1038ui_story"].transform.localPosition = Vector3.Lerp(arg_20_1.var_.moveOldPos1038ui_story, Vector3.New(0, 100, 0), (arg_20_1.time_ - 0) / var_23_0)
				arg_20_1.actors_["1038ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_20_1.actors_["1038ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_20_1.actors_["1038ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_20_1.actors_["1038ui_story"].transform.position).z)
				arg_20_1.actors_["1038ui_story"].transform.localEulerAngles.z = 0
				arg_20_1.actors_["1038ui_story"].transform.localEulerAngles.x = 0
				arg_20_1.actors_["1038ui_story"].transform.localEulerAngles = arg_20_1.actors_["1038ui_story"].transform.localEulerAngles
			end

			if arg_20_1.time_ >= 0 + var_23_0 and arg_20_1.time_ < 0 + var_23_0 + arg_23_0 then
				arg_20_1.actors_["1038ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_20_1.actors_["1038ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_20_1.actors_["1038ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_20_1.actors_["1038ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_20_1.actors_["1038ui_story"].transform.position).z)
				arg_20_1.actors_["1038ui_story"].transform.localEulerAngles.z = 0
				arg_20_1.actors_["1038ui_story"].transform.localEulerAngles.x = 0
				arg_20_1.actors_["1038ui_story"].transform.localEulerAngles = arg_20_1.actors_["1038ui_story"].transform.localEulerAngles
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_1 + arg_23_0 then
				...
				local var_23_3 = arg_20_1:FormatText(arg_20_1:GetWordFromCfg(107091005).content)
	...
	Play107091006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_7 then
				var_27_6.localPosition = Vector3.Lerp(arg_24_1.var_.moveOldPos1084ui_story, Vector3.New(0, -0.97, -6), (arg_24_1.time_ - 0) / var_27_7)
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_8 + arg_27_0 then
				...
				local var_27_10 = arg_24_1:GetWordFromCfg(107091006)
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091006", "story_v_out_107091.awb") ~= 0 then
					local var_27_14 = manager.audio:GetVoiceLength("story_v_out_107091", "107091006", "story_v_out_107091.awb") / 1000
					...
					if var_27_10.prefab_name ~= "" and arg_24_1.actors_[var_27_10.prefab_name] ~= nil then
						local var_27_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_24_1.actors_[var_27_10.prefab_name].transform, "story_v_out_107091", "107091006", "story_v_out_107091.awb")

						arg_24_1:RecordAudio("107091006", var_27_15)
						arg_24_1:RecordAudio("107091006", var_27_15)
					else
	...
	Play107091007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 and not isNil(arg_28_1.actors_["1038ui_story"]) and arg_28_1.var_.characterEffect1038ui_story == nil then
				arg_28_1.var_.characterEffect1038ui_story = arg_28_1.actors_["1038ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_31_0 = 0.1

			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_0 and not isNil(arg_28_1.actors_["1038ui_story"]) then
				if arg_28_1.var_.characterEffect1038ui_story and not isNil(arg_28_1.actors_["1038ui_story"]) then
					arg_28_1.var_.characterEffect1038ui_story.fillFlat = false
				end
			end

			if arg_28_1.time_ >= 0 + var_31_0 and arg_28_1.time_ < 0 + var_31_0 + arg_31_0 and not isNil(arg_28_1.actors_["1038ui_story"]) and arg_28_1.var_.characterEffect1038ui_story then
				arg_28_1.var_.characterEffect1038ui_story.fillFlat = false
			end
			...
			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_5 then
				var_31_4.localPosition = Vector3.Lerp(arg_28_1.var_.moveOldPos1084ui_story, Vector3.New(0, 100, 0), (arg_28_1.time_ - 0) / var_31_5)
			...
			local var_31_6 = arg_28_1.actors_["1038ui_story"].transform

			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 then
				arg_28_1.var_.moveOldPos1038ui_story = var_31_6.localPosition
			end

			local var_31_7 = 0.001

			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_7 then
				var_31_6.localPosition = Vector3.Lerp(arg_28_1.var_.moveOldPos1038ui_story, Vector3.New(0, -1.11, -5.9), (arg_28_1.time_ - 0) / var_31_7)
			...
			if arg_28_1.time_ >= 0 + var_31_7 and arg_28_1.time_ < 0 + var_31_7 + arg_31_0 then
				var_31_6.localPosition = Vector3.New(0, -1.11, -5.9)
				var_31_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_31_6.position).x, (manager.ui.mainCamera.transform.position - var_31_6.position).y, (manager.ui.mainCamera.transform.position - var_31_6.position).z)
				var_31_6.localEulerAngles.z = 0
				var_31_6.localEulerAngles.x = 0
				var_31_6.localEulerAngles = var_31_6.localEulerAngles
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_8 + arg_31_0 then
				...
				arg_28_1.leftNameTxt_.text = arg_28_1:FormatText(StoryNameCfg[94].name)
				...
				local var_31_10 = arg_28_1:GetWordFromCfg(107091007)
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091007", "story_v_out_107091.awb") ~= 0 then
					local var_31_14 = manager.audio:GetVoiceLength("story_v_out_107091", "107091007", "story_v_out_107091.awb") / 1000
					...
					if var_31_10.prefab_name ~= "" and arg_28_1.actors_[var_31_10.prefab_name] ~= nil then
						local var_31_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_10.prefab_name].transform, "story_v_out_107091", "107091007", "story_v_out_107091.awb")

						arg_28_1:RecordAudio("107091007", var_31_15)
						arg_28_1:RecordAudio("107091007", var_31_15)
					else
	...
	Play107091008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= 0 + arg_35_0 and not isNil(arg_32_1.actors_["1038ui_story"]) and arg_32_1.var_.characterEffect1038ui_story == nil then
				arg_32_1.var_.characterEffect1038ui_story = arg_32_1.actors_["1038ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_35_0 = 0.1

			if 0 <= arg_32_1.time_ and arg_32_1.time_ < 0 + var_35_0 and not isNil(arg_32_1.actors_["1038ui_story"]) then
				if arg_32_1.var_.characterEffect1038ui_story and not isNil(arg_32_1.actors_["1038ui_story"]) then
					arg_32_1.var_.characterEffect1038ui_story.fillFlat = true
					arg_32_1.var_.characterEffect1038ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_32_1.time_ - 0) / var_35_0)
				end
			end

			if arg_32_1.time_ >= 0 + var_35_0 and arg_32_1.time_ < 0 + var_35_0 + arg_35_0 and not isNil(arg_32_1.actors_["1038ui_story"]) and arg_32_1.var_.characterEffect1038ui_story then
				arg_32_1.var_.characterEffect1038ui_story.fillFlat = true
				arg_32_1.var_.characterEffect1038ui_story.fillRatio = 0.5
			end

			local var_35_1 = arg_32_1.actors_["1038ui_story"].transform

			if 0 < arg_32_1.time_ and arg_32_1.time_ <= 0 + arg_35_0 then
				arg_32_1.var_.moveOldPos1038ui_story = var_35_1.localPosition
			end

			local var_35_2 = 0.001

			if 0 <= arg_32_1.time_ and arg_32_1.time_ < 0 + var_35_2 then
				var_35_1.localPosition = Vector3.Lerp(arg_32_1.var_.moveOldPos1038ui_story, Vector3.New(0, 100, 0), (arg_32_1.time_ - 0) / var_35_2)
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_3 + arg_35_0 then
				...
				local var_35_5 = arg_32_1:FormatText(arg_32_1:GetWordFromCfg(107091008).content)

				arg_32_1.text_.text = var_35_5

				LuaForUtil.ClearLinePrefixSymbol(arg_32_1.text_)

				local var_35_7 = 9 <= 0 and var_35_4 or var_35_4 * (utf8.len(var_35_5) / 9)

				if (9 <= 0 and var_35_4 or var_35_4 * (utf8.len(var_35_5) / 9)) > 0 and var_35_4 < var_35_7 then
	...
	Play107091009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			local var_39_2 = arg_36_1.actors_["1084ui_story"].transform

			if 0 < arg_36_1.time_ and arg_36_1.time_ <= 0 + arg_39_0 then
				arg_36_1.var_.moveOldPos1084ui_story = var_39_2.localPosition
			end

			local var_39_3 = 0.001

			if 0 <= arg_36_1.time_ and arg_36_1.time_ < 0 + var_39_3 then
				var_39_2.localPosition = Vector3.Lerp(arg_36_1.var_.moveOldPos1084ui_story, Vector3.New(0, -0.97, -6), (arg_36_1.time_ - 0) / var_39_3)
			...
			if arg_36_1.time_ >= 0 + var_39_3 and arg_36_1.time_ < 0 + var_39_3 + arg_39_0 then
				var_39_2.localPosition = Vector3.New(0, -0.97, -6)
				var_39_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_39_2.position).x, (manager.ui.mainCamera.transform.position - var_39_2.position).y, (manager.ui.mainCamera.transform.position - var_39_2.position).z)
				var_39_2.localEulerAngles.z = 0
				var_39_2.localEulerAngles.x = 0
				var_39_2.localEulerAngles = var_39_2.localEulerAngles
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_4 + arg_39_0 then
				...
				local var_39_6 = arg_36_1:GetWordFromCfg(107091009)
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091009", "story_v_out_107091.awb") ~= 0 then
					local var_39_10 = manager.audio:GetVoiceLength("story_v_out_107091", "107091009", "story_v_out_107091.awb") / 1000
					...
					if var_39_6.prefab_name ~= "" and arg_36_1.actors_[var_39_6.prefab_name] ~= nil then
						local var_39_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_36_1.actors_[var_39_6.prefab_name].transform, "story_v_out_107091", "107091009", "story_v_out_107091.awb")

						arg_36_1:RecordAudio("107091009", var_39_11)
						arg_36_1:RecordAudio("107091009", var_39_11)
					else
	...
	Play107091010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_1 + arg_43_0 then
				...
				local var_43_3 = arg_40_1:GetWordFromCfg(107091010)
				...
				local var_43_6 = 48 <= 0 and var_43_2 or var_43_2 * (utf8.len(var_43_4) / 48)

				if (48 <= 0 and var_43_2 or var_43_2 * (utf8.len(var_43_4) / 48)) > 0 and var_43_2 < var_43_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091010", "story_v_out_107091.awb") ~= 0 then
					local var_43_7 = manager.audio:GetVoiceLength("story_v_out_107091", "107091010", "story_v_out_107091.awb") / 1000
					...
					if var_43_3.prefab_name ~= "" and arg_40_1.actors_[var_43_3.prefab_name] ~= nil then
						local var_43_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_3.prefab_name].transform, "story_v_out_107091", "107091010", "story_v_out_107091.awb")

						arg_40_1:RecordAudio("107091010", var_43_8)
						arg_40_1:RecordAudio("107091010", var_43_8)
					else
	...
	Play107091011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 then
				...
				local var_47_1 = arg_44_1:GetWordFromCfg(107091011)
				...
				local var_47_4 = 32 <= 0 and var_47_0 or var_47_0 * (utf8.len(var_47_2) / 32)

				if (32 <= 0 and var_47_0 or var_47_0 * (utf8.len(var_47_2) / 32)) > 0 and var_47_0 < var_47_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091011", "story_v_out_107091.awb") ~= 0 then
					local var_47_5 = manager.audio:GetVoiceLength("story_v_out_107091", "107091011", "story_v_out_107091.awb") / 1000
					...
					if var_47_1.prefab_name ~= "" and arg_44_1.actors_[var_47_1.prefab_name] ~= nil then
						local var_47_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_44_1.actors_[var_47_1.prefab_name].transform, "story_v_out_107091", "107091011", "story_v_out_107091.awb")

						arg_44_1:RecordAudio("107091011", var_47_6)
						arg_44_1:RecordAudio("107091011", var_47_6)
					else
	...
	Play107091012 = function(arg_48_0, arg_48_1)
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if 0 < arg_48_1.time_ and arg_48_1.time_ <= var_51_2 + arg_51_0 then
				...
				local var_51_4 = arg_48_1:GetWordFromCfg(107091012)
				...
				local var_51_7 = 18 <= 0 and var_51_3 or var_51_3 * (utf8.len(var_51_5) / 18)

				if (18 <= 0 and var_51_3 or var_51_3 * (utf8.len(var_51_5) / 18)) > 0 and var_51_3 < var_51_7 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091012", "story_v_out_107091.awb") ~= 0 then
					local var_51_8 = manager.audio:GetVoiceLength("story_v_out_107091", "107091012", "story_v_out_107091.awb") / 1000
					...
					if var_51_4.prefab_name ~= "" and arg_48_1.actors_[var_51_4.prefab_name] ~= nil then
						local var_51_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_48_1.actors_[var_51_4.prefab_name].transform, "story_v_out_107091", "107091012", "story_v_out_107091.awb")

						arg_48_1:RecordAudio("107091012", var_51_9)
						arg_48_1:RecordAudio("107091012", var_51_9)
					else
	...
	Play107091013 = function(arg_52_0, arg_52_1)
		...
		function arg_52_1.onSingleLineUpdate_(arg_55_0)
			...
			if 0 < arg_52_1.time_ and arg_52_1.time_ <= 0 + arg_55_0 then
				...
				local var_55_1 = arg_52_1:GetWordFromCfg(107091013)
				...
				local var_55_4 = 29 <= 0 and var_55_0 or var_55_0 * (utf8.len(var_55_2) / 29)

				if (29 <= 0 and var_55_0 or var_55_0 * (utf8.len(var_55_2) / 29)) > 0 and var_55_0 < var_55_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091013", "story_v_out_107091.awb") ~= 0 then
					local var_55_5 = manager.audio:GetVoiceLength("story_v_out_107091", "107091013", "story_v_out_107091.awb") / 1000
					...
					if var_55_1.prefab_name ~= "" and arg_52_1.actors_[var_55_1.prefab_name] ~= nil then
						local var_55_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_52_1.actors_[var_55_1.prefab_name].transform, "story_v_out_107091", "107091013", "story_v_out_107091.awb")

						arg_52_1:RecordAudio("107091013", var_55_6)
						arg_52_1:RecordAudio("107091013", var_55_6)
					else
	...
	Play107091014 = function(arg_56_0, arg_56_1)
		...
		function arg_56_1.onSingleLineUpdate_(arg_59_0)
			...
			if 0 < arg_56_1.time_ and arg_56_1.time_ <= var_59_1 + arg_59_0 then
				...
				local var_59_3 = arg_56_1:FormatText(arg_56_1:GetWordFromCfg(107091014).content)

				arg_56_1.text_.text = var_59_3

				LuaForUtil.ClearLinePrefixSymbol(arg_56_1.text_)

				local var_59_5 = 10 <= 0 and var_59_2 or var_59_2 * (utf8.len(var_59_3) / 10)

				if (10 <= 0 and var_59_2 or var_59_2 * (utf8.len(var_59_3) / 10)) > 0 and var_59_2 < var_59_5 then
	...
	Play107091015 = function(arg_60_0, arg_60_1)
		...
		function arg_60_1.onSingleLineUpdate_(arg_63_0)
			...
			if 0 < arg_60_1.time_ and arg_60_1.time_ <= var_63_1 + arg_63_0 then
				...
				arg_60_1.leftNameTxt_.text = arg_60_1:FormatText(StoryNameCfg[97].name)
				...
				local var_63_3 = arg_60_1:FormatText(arg_60_1:GetWordFromCfg(107091015).content)
	...
	Play107091016 = function(arg_64_0, arg_64_1)
		...
		function arg_64_1.onSingleLineUpdate_(arg_67_0)
			...
			local var_67_2 = arg_64_1.actors_["1084ui_story"].transform

			if 0 < arg_64_1.time_ and arg_64_1.time_ <= 0 + arg_67_0 then
				arg_64_1.var_.moveOldPos1084ui_story = var_67_2.localPosition

				arg_64_1:ShowWeapon(arg_64_1.var_["1084ui_story" .. "Animator"].transform, true)
			end

			local var_67_3 = 0.001

			if 0 <= arg_64_1.time_ and arg_64_1.time_ < 0 + var_67_3 then
				var_67_2.localPosition = Vector3.Lerp(arg_64_1.var_.moveOldPos1084ui_story, Vector3.New(0, -0.97, -6), (arg_64_1.time_ - 0) / var_67_3)
			...
			if arg_64_1.time_ >= 0 + var_67_3 and arg_64_1.time_ < 0 + var_67_3 + arg_67_0 then
				var_67_2.localPosition = Vector3.New(0, -0.97, -6)
				var_67_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_67_2.position).x, (manager.ui.mainCamera.transform.position - var_67_2.position).y, (manager.ui.mainCamera.transform.position - var_67_2.position).z)
				var_67_2.localEulerAngles.z = 0
				var_67_2.localEulerAngles.x = 0
				var_67_2.localEulerAngles = var_67_2.localEulerAngles
			...
			if 0 < arg_64_1.time_ and arg_64_1.time_ <= var_67_4 + arg_67_0 then
				...
				local var_67_6 = arg_64_1:GetWordFromCfg(107091016)
				...
				local var_67_9 = 15 <= 0 and var_67_5 or var_67_5 * (utf8.len(var_67_7) / 15)

				if (15 <= 0 and var_67_5 or var_67_5 * (utf8.len(var_67_7) / 15)) > 0 and var_67_5 < var_67_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091016", "story_v_out_107091.awb") ~= 0 then
					local var_67_10 = manager.audio:GetVoiceLength("story_v_out_107091", "107091016", "story_v_out_107091.awb") / 1000
					...
					if var_67_6.prefab_name ~= "" and arg_64_1.actors_[var_67_6.prefab_name] ~= nil then
						local var_67_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_64_1.actors_[var_67_6.prefab_name].transform, "story_v_out_107091", "107091016", "story_v_out_107091.awb")

						arg_64_1:RecordAudio("107091016", var_67_11)
						arg_64_1:RecordAudio("107091016", var_67_11)
					else
	...
	Play107091017 = function(arg_68_0, arg_68_1)
		...
		function arg_68_1.onSingleLineFinish_()
			...
			for iter_69_0, iter_69_1 in ipairs(arg_68_1.choices_) do
				SetActive(iter_69_1.go, iter_69_0 <= 1)
			end
	...
	Play107091018 = function(arg_72_0, arg_72_1)
		...
		function arg_72_1.onSingleLineUpdate_(arg_75_0)
			if 0 < arg_72_1.time_ and arg_72_1.time_ <= 0 + arg_75_0 and not isNil(arg_72_1.actors_["1038ui_story"]) and arg_72_1.var_.characterEffect1038ui_story == nil then
				arg_72_1.var_.characterEffect1038ui_story = arg_72_1.actors_["1038ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_75_0 = 0.1

			if 0 <= arg_72_1.time_ and arg_72_1.time_ < 0 + var_75_0 and not isNil(arg_72_1.actors_["1038ui_story"]) then
				if arg_72_1.var_.characterEffect1038ui_story and not isNil(arg_72_1.actors_["1038ui_story"]) then
					arg_72_1.var_.characterEffect1038ui_story.fillFlat = false
				end
			end

			if arg_72_1.time_ >= 0 + var_75_0 and arg_72_1.time_ < 0 + var_75_0 + arg_75_0 and not isNil(arg_72_1.actors_["1038ui_story"]) and arg_72_1.var_.characterEffect1038ui_story then
				arg_72_1.var_.characterEffect1038ui_story.fillFlat = false
			end
			...
			if 0 <= arg_72_1.time_ and arg_72_1.time_ < 0 + var_75_3 then
				var_75_2.localPosition = Vector3.Lerp(arg_72_1.var_.moveOldPos1084ui_story, Vector3.New(0, 100, 0), (arg_72_1.time_ - 0) / var_75_3)
			...
			local var_75_4 = arg_72_1.actors_["1038ui_story"].transform

			if 0 < arg_72_1.time_ and arg_72_1.time_ <= 0 + arg_75_0 then
				arg_72_1.var_.moveOldPos1038ui_story = var_75_4.localPosition
			end

			local var_75_5 = 0.001

			if 0 <= arg_72_1.time_ and arg_72_1.time_ < 0 + var_75_5 then
				var_75_4.localPosition = Vector3.Lerp(arg_72_1.var_.moveOldPos1038ui_story, Vector3.New(0, -1.11, -5.9), (arg_72_1.time_ - 0) / var_75_5)
			...
			if arg_72_1.time_ >= 0 + var_75_5 and arg_72_1.time_ < 0 + var_75_5 + arg_75_0 then
				var_75_4.localPosition = Vector3.New(0, -1.11, -5.9)
				var_75_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_75_4.position).x, (manager.ui.mainCamera.transform.position - var_75_4.position).y, (manager.ui.mainCamera.transform.position - var_75_4.position).z)
				var_75_4.localEulerAngles.z = 0
				var_75_4.localEulerAngles.x = 0
				var_75_4.localEulerAngles = var_75_4.localEulerAngles
			...
			if 0 < arg_72_1.time_ and arg_72_1.time_ <= var_75_6 + arg_75_0 then
				...
				local var_75_8 = arg_72_1:GetWordFromCfg(107091018)
				...
				local var_75_11 = 15 <= 0 and var_75_7 or var_75_7 * (utf8.len(var_75_9) / 15)

				if (15 <= 0 and var_75_7 or var_75_7 * (utf8.len(var_75_9) / 15)) > 0 and var_75_7 < var_75_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091018", "story_v_out_107091.awb") ~= 0 then
					local var_75_12 = manager.audio:GetVoiceLength("story_v_out_107091", "107091018", "story_v_out_107091.awb") / 1000
					...
					if var_75_8.prefab_name ~= "" and arg_72_1.actors_[var_75_8.prefab_name] ~= nil then
						local var_75_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_72_1.actors_[var_75_8.prefab_name].transform, "story_v_out_107091", "107091018", "story_v_out_107091.awb")

						arg_72_1:RecordAudio("107091018", var_75_13)
						arg_72_1:RecordAudio("107091018", var_75_13)
					else
	...
	Play107091019 = function(arg_76_0, arg_76_1)
		...
		function arg_76_1.onSingleLineUpdate_(arg_79_0)
			...
			if 0 < arg_76_1.time_ and arg_76_1.time_ <= var_79_1 + arg_79_0 then
				...
				local var_79_3 = arg_76_1:GetWordFromCfg(107091019)
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091019", "story_v_out_107091.awb") ~= 0 then
					local var_79_7 = manager.audio:GetVoiceLength("story_v_out_107091", "107091019", "story_v_out_107091.awb") / 1000
					...
					if var_79_3.prefab_name ~= "" and arg_76_1.actors_[var_79_3.prefab_name] ~= nil then
						local var_79_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_76_1.actors_[var_79_3.prefab_name].transform, "story_v_out_107091", "107091019", "story_v_out_107091.awb")

						arg_76_1:RecordAudio("107091019", var_79_8)
						arg_76_1:RecordAudio("107091019", var_79_8)
					else
	...
	Play107091020 = function(arg_80_0, arg_80_1)
		...
		function arg_80_1.onSingleLineUpdate_(arg_83_0)
			if 0 < arg_80_1.time_ and arg_80_1.time_ <= 0 + arg_83_0 and not isNil(arg_80_1.actors_["1038ui_story"]) and arg_80_1.var_.characterEffect1038ui_story == nil then
				arg_80_1.var_.characterEffect1038ui_story = arg_80_1.actors_["1038ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_83_0 = 0.1

			if 0 <= arg_80_1.time_ and arg_80_1.time_ < 0 + var_83_0 and not isNil(arg_80_1.actors_["1038ui_story"]) then
				if arg_80_1.var_.characterEffect1038ui_story and not isNil(arg_80_1.actors_["1038ui_story"]) then
					arg_80_1.var_.characterEffect1038ui_story.fillFlat = false
				end
			end

			if arg_80_1.time_ >= 0 + var_83_0 and arg_80_1.time_ < 0 + var_83_0 + arg_83_0 and not isNil(arg_80_1.actors_["1038ui_story"]) and arg_80_1.var_.characterEffect1038ui_story then
				arg_80_1.var_.characterEffect1038ui_story.fillFlat = false
			end
			...
			if 0 < arg_80_1.time_ and arg_80_1.time_ <= var_83_2 + arg_83_0 then
				...
				local var_83_4 = arg_80_1:GetWordFromCfg(107091020)
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091020", "story_v_out_107091.awb") ~= 0 then
					local var_83_8 = manager.audio:GetVoiceLength("story_v_out_107091", "107091020", "story_v_out_107091.awb") / 1000
					...
					if var_83_4.prefab_name ~= "" and arg_80_1.actors_[var_83_4.prefab_name] ~= nil then
						local var_83_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_80_1.actors_[var_83_4.prefab_name].transform, "story_v_out_107091", "107091020", "story_v_out_107091.awb")

						arg_80_1:RecordAudio("107091020", var_83_9)
						arg_80_1:RecordAudio("107091020", var_83_9)
					else
	...
	Play107091021 = function(arg_84_0, arg_84_1)
		...
		function arg_84_1.onSingleLineUpdate_(arg_87_0)
			...
			local var_87_2 = arg_84_1.actors_["1038ui_story"]

			if 0 < arg_84_1.time_ and arg_84_1.time_ <= 0 + arg_87_0 and not isNil(var_87_2) and arg_84_1.var_.characterEffect1038ui_story == nil then
				arg_84_1.var_.characterEffect1038ui_story = var_87_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_87_3 = 0.1

			if 0 <= arg_84_1.time_ and arg_84_1.time_ < 0 + var_87_3 and not isNil(var_87_2) then
				if arg_84_1.var_.characterEffect1038ui_story and not isNil(var_87_2) then
					arg_84_1.var_.characterEffect1038ui_story.fillFlat = true
					arg_84_1.var_.characterEffect1038ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_84_1.time_ - 0) / var_87_3)
				end
			end

			if arg_84_1.time_ >= 0 + var_87_3 and arg_84_1.time_ < 0 + var_87_3 + arg_87_0 and not isNil(var_87_2) and arg_84_1.var_.characterEffect1038ui_story then
				arg_84_1.var_.characterEffect1038ui_story.fillFlat = true
				arg_84_1.var_.characterEffect1038ui_story.fillRatio = 0.5
			end

			local var_87_4 = arg_84_1.actors_["1038ui_story"].transform

			if 0 < arg_84_1.time_ and arg_84_1.time_ <= 0 + arg_87_0 then
				arg_84_1.var_.moveOldPos1038ui_story = var_87_4.localPosition
			end

			local var_87_5 = 0.001

			if 0 <= arg_84_1.time_ and arg_84_1.time_ < 0 + var_87_5 then
				var_87_4.localPosition = Vector3.Lerp(arg_84_1.var_.moveOldPos1038ui_story, Vector3.New(0, 100, 0), (arg_84_1.time_ - 0) / var_87_5)
			...
			if 0 < arg_84_1.time_ and arg_84_1.time_ <= 0 + arg_87_0 then
				...
				arg_84_1:ShowWeapon(arg_84_1.var_["1084ui_story" .. "Animator"].transform, false)
			end

			local var_87_7 = 0.001

			if 0 <= arg_84_1.time_ and arg_84_1.time_ < 0 + var_87_7 then
				var_87_6.localPosition = Vector3.Lerp(arg_84_1.var_.moveOldPos1084ui_story, Vector3.New(0, -0.97, -6), (arg_84_1.time_ - 0) / var_87_7)
			...
			if arg_84_1.time_ >= 0 + var_87_7 and arg_84_1.time_ < 0 + var_87_7 + arg_87_0 then
				var_87_6.localPosition = Vector3.New(0, -0.97, -6)
				var_87_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_87_6.position).x, (manager.ui.mainCamera.transform.position - var_87_6.position).y, (manager.ui.mainCamera.transform.position - var_87_6.position).z)
				var_87_6.localEulerAngles.z = 0
				var_87_6.localEulerAngles.x = 0
				var_87_6.localEulerAngles = var_87_6.localEulerAngles
			...
			if 0 < arg_84_1.time_ and arg_84_1.time_ <= var_87_8 + arg_87_0 then
				...
				local var_87_10 = arg_84_1:GetWordFromCfg(107091021)
				...
				local var_87_13 = 12 <= 0 and var_87_9 or var_87_9 * (utf8.len(var_87_11) / 12)

				if (12 <= 0 and var_87_9 or var_87_9 * (utf8.len(var_87_11) / 12)) > 0 and var_87_9 < var_87_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091021", "story_v_out_107091.awb") ~= 0 then
					local var_87_14 = manager.audio:GetVoiceLength("story_v_out_107091", "107091021", "story_v_out_107091.awb") / 1000
					...
					if var_87_10.prefab_name ~= "" and arg_84_1.actors_[var_87_10.prefab_name] ~= nil then
						local var_87_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_84_1.actors_[var_87_10.prefab_name].transform, "story_v_out_107091", "107091021", "story_v_out_107091.awb")

						arg_84_1:RecordAudio("107091021", var_87_15)
						arg_84_1:RecordAudio("107091021", var_87_15)
					else
	...
	Play107091022 = function(arg_88_0, arg_88_1)
		...
		function arg_88_1.onSingleLineUpdate_(arg_91_0)
			...
			local var_91_4 = arg_88_1.actors_["1084ui_story"].transform

			if 0 < arg_88_1.time_ and arg_88_1.time_ <= 0 + arg_91_0 then
				arg_88_1.var_.moveOldPos1084ui_story = var_91_4.localPosition
			end

			local var_91_5 = 0.001

			if 0 <= arg_88_1.time_ and arg_88_1.time_ < 0 + var_91_5 then
				var_91_4.localPosition = Vector3.Lerp(arg_88_1.var_.moveOldPos1084ui_story, Vector3.New(0, 100, 0), (arg_88_1.time_ - 0) / var_91_5)
			...
			local var_91_6 = arg_88_1.actors_["1038ui_story"].transform

			if 0 < arg_88_1.time_ and arg_88_1.time_ <= 0 + arg_91_0 then
				arg_88_1.var_.moveOldPos1038ui_story = var_91_6.localPosition
			end

			local var_91_7 = 0.001

			if 0 <= arg_88_1.time_ and arg_88_1.time_ < 0 + var_91_7 then
				var_91_6.localPosition = Vector3.Lerp(arg_88_1.var_.moveOldPos1038ui_story, Vector3.New(0, -1.11, -5.9), (arg_88_1.time_ - 0) / var_91_7)
			...
			if arg_88_1.time_ >= 0 + var_91_7 and arg_88_1.time_ < 0 + var_91_7 + arg_91_0 then
				var_91_6.localPosition = Vector3.New(0, -1.11, -5.9)
				var_91_6.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_91_6.position).x, (manager.ui.mainCamera.transform.position - var_91_6.position).y, (manager.ui.mainCamera.transform.position - var_91_6.position).z)
				var_91_6.localEulerAngles.z = 0
				var_91_6.localEulerAngles.x = 0
				var_91_6.localEulerAngles = var_91_6.localEulerAngles
			...
			if 0 < arg_88_1.time_ and arg_88_1.time_ <= var_91_8 + arg_91_0 then
				...
				local var_91_10 = arg_88_1:GetWordFromCfg(107091022)
				...
				local var_91_13 = 31 <= 0 and var_91_9 or var_91_9 * (utf8.len(var_91_11) / 31)

				if (31 <= 0 and var_91_9 or var_91_9 * (utf8.len(var_91_11) / 31)) > 0 and var_91_9 < var_91_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_107091", "107091022", "story_v_out_107091.awb") ~= 0 then
					local var_91_14 = manager.audio:GetVoiceLength("story_v_out_107091", "107091022", "story_v_out_107091.awb") / 1000
					...
					if var_91_10.prefab_name ~= "" and arg_88_1.actors_[var_91_10.prefab_name] ~= nil then
						local var_91_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_88_1.actors_[var_91_10.prefab_name].transform, "story_v_out_107091", "107091022", "story_v_out_107091.awb")

						arg_88_1:RecordAudio("107091022", var_91_15)
						arg_88_1:RecordAudio("107091022", var_91_15)
					else
