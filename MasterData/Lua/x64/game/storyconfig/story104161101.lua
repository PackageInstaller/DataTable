		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0.266666666666667 < arg_35_1.time_ and arg_35_1.time_ <= 0.266666666666667 + arg_38_0 then
				...
				if not arg_35_1.var_.effect1104 then
					...
					var_38_17.transform:SetParent(var_38_9000)
				end
			...
			if 0.4 < arg_35_1.time_ and arg_35_1.time_ <= 0.4 + arg_38_0 then
				...
				if not arg_35_1.var_.effect1105 then
					...
					var_38_24.transform:SetParent(var_38_9001)
				end
	...
	Play416111047 = function(arg_203_0, arg_203_1)
		...
		function arg_203_1.onSingleLineUpdate_(arg_206_0)
			...
			if 1.70066666666667 < arg_203_1.time_ and arg_203_1.time_ <= 1.70066666666667 + arg_206_0 then
				...
				for iter_206_3, iter_206_4 in ipairs((var_206_16.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_206_4.transform.localScale = Vector3.New(iter_206_4.transform.localScale.x / var_206_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_206_4.transform.localScale.y / var_206_18, iter_206_4.transform.localScale.z)
				end
			end
			...
			local var_206_21 = manager.ui.mainCamera.transform

			if 1.70066666666667 < arg_203_1.time_ and arg_203_1.time_ <= 1.70066666666667 + arg_206_0 then
				arg_203_1.var_.shakeOldPos = var_206_21.localPosition
			end

			local var_206_22 = 0.9

			if 1.70066666666667 <= arg_203_1.time_ and arg_203_1.time_ < 1.70066666666667 + var_206_22 then
				local var_206_23, var_206_24 = math.modf((arg_203_1.time_ - 1.70066666666667) / 0.066)

				var_206_21.localPosition = Vector3.New(var_206_24 * 0.13, var_206_24 * 0.13, var_206_24 * 0.13) + arg_203_1.var_.shakeOldPos
			end

			if arg_203_1.time_ >= 1.70066666666667 + var_206_22 and arg_203_1.time_ < 1.70066666666667 + var_206_22 + arg_206_0 then
				var_206_21.localPosition = arg_203_1.var_.shakeOldPos
			end
			...
			local var_206_28 = 2.69319013655124
			local var_206_29 = 1.425

			if 2.69319013655124 < arg_203_1.time_ and arg_203_1.time_ <= var_206_28 + arg_206_0 then
				...
				local var_206_30 = LeanTween.value(arg_203_1.dialog_, 0, 1, 0.3)

				var_206_30:setOnUpdate(LuaHelper.FloatAction(function(arg_207_0)
					arg_203_1.dialogCg_.alpha = arg_207_0
				end))
				var_206_30:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_203_1.dialog_)
					var_206_30:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_206_31 = arg_203_1:FormatText(arg_203_1:GetWordFromCfg(416111047).content)

				arg_203_1.text_.text = var_206_31

				LuaForUtil.ClearLinePrefixSymbol(arg_203_1.text_)

				local var_206_33 = 57 <= 0 and var_206_29 or var_206_29 * (utf8.len(var_206_31) / 57)

				if (57 <= 0 and var_206_29 or var_206_29 * (utf8.len(var_206_31) / 57)) > 0 and var_206_29 < var_206_33 then
					arg_203_1.talkMaxDuration = var_206_33
					var_206_28 = var_206_28 + 0.3

					if var_206_33 + var_206_28 > arg_203_1.duration_ then
						arg_203_1.duration_ = var_206_33 + var_206_28
					end
				end
			...
			local var_206_34 = var_206_28 + 0.3
			local var_206_35 = math.max(var_206_29, arg_203_1.talkMaxDuration)

			if var_206_28 + 0.3 <= arg_203_1.time_ and arg_203_1.time_ < var_206_34 + var_206_35 then
