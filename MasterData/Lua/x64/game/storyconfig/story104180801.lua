	...
	Play418081001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.4 < arg_1_1.time_ and arg_1_1.time_ <= 0.4 + arg_4_0 then
				...
				local var_4_20 = manager.audio:GetAudioName("bgm_activity_4_0_story_citong_daily", "bgm_activity_4_0_story_citong_daily")
			...
			local var_4_21 = 1.8
			local var_4_22 = 0.975

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= var_4_21 + arg_4_0 then
				...
				local var_4_24 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(418081001).content)

				arg_1_1.text_.text = var_4_24

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_26 = 39 <= 0 and var_4_22 or var_4_22 * (utf8.len(var_4_24) / 39)

				if (39 <= 0 and var_4_22 or var_4_22 * (utf8.len(var_4_24) / 39)) > 0 and var_4_22 < var_4_26 then
