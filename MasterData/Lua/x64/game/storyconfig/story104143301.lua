return {
	Play414331001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.86666666666667 <= arg_1_1.time_ and arg_1_1.time_ < 1.86666666666667 + var_4_14 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1148ui_story, Vector3.New(0, -0.8, -6.2), (arg_1_1.time_ - 1.86666666666667) / var_4_14)
			...
			if 1.86666666666667 < arg_1_1.time_ and arg_1_1.time_ <= 1.86666666666667 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1148ui_story == nil then
			...
			if arg_1_1.time_ >= 1.86666666666667 + var_4_16 and arg_1_1.time_ < 1.86666666666667 + var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1148ui_story then
				arg_1_1.var_.characterEffect1148ui_story.fillFlat = false
			end
			...
			if 1.90066666851441 < arg_1_1.time_ and arg_1_1.time_ <= 1.90066666851441 + arg_4_0 then
				arg_1_1:AudioAction("play", "effect", "se_story_135_02", "se_story_135_02_watergun", "")
			end
			...
			local var_4_25 = 2.0666666696469
			local var_4_26 = 0.275

			if 2.0666666696469 < arg_1_1.time_ and arg_1_1.time_ <= var_4_25 + arg_4_0 then
				...
				local var_4_28 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414331001).content)

				arg_1_1.text_.text = var_4_28

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_30 = 11 <= 0 and var_4_26 or var_4_26 * (utf8.len(var_4_28) / 11)

				if (11 <= 0 and var_4_26 or var_4_26 * (utf8.len(var_4_28) / 11)) > 0 and var_4_26 < var_4_30 then
	...
	Play414331002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if arg_9_1.actors_["107001ui_story"] == nil and not isNil((Asset.Load("Char/" .. "107001ui_story"))) then
				local var_12_0 = Object.Instantiate(Asset.Load("Char/" .. "107001ui_story"), arg_9_1.stage_.transform)

				var_12_0.name = "107001ui_story"
				var_12_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_9_1.actors_["107001ui_story"] = var_12_0
				...
				arg_9_1.var_["107001ui_story" .. "Animator"] = var_12_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_9_1.var_["107001ui_story" .. "Animator"].applyRootMotion = true
				arg_9_1.var_["107001ui_story" .. "LipSync"] = var_12_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_12_3 = arg_9_1.actors_["107001ui_story"].transform

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				arg_9_1.var_.moveOldPos107001ui_story = var_12_3.localPosition

				arg_9_1:ShowWeapon(arg_9_1.var_["107001ui_story" .. "Animator"].transform, false)
			end

			local var_12_4 = 0.001

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_4 then
				var_12_3.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos107001ui_story, Vector3.New(0, -0.95, -6.05), (arg_9_1.time_ - 0) / var_12_4)
			...
			local var_12_5 = arg_9_1.actors_["107001ui_story"]

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(var_12_5) and arg_9_1.var_.characterEffect107001ui_story == nil then
				arg_9_1.var_.characterEffect107001ui_story = var_12_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_6 = 0.200000002980232

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_6 and not isNil(var_12_5) then
				if arg_9_1.var_.characterEffect107001ui_story and not isNil(var_12_5) then
					arg_9_1.var_.characterEffect107001ui_story.fillFlat = false
				end
			end

			if arg_9_1.time_ >= 0 + var_12_6 and arg_9_1.time_ < 0 + var_12_6 + arg_12_0 and not isNil(var_12_5) and arg_9_1.var_.characterEffect107001ui_story then
				arg_9_1.var_.characterEffect107001ui_story.fillFlat = false
			end
			...
			local var_12_8 = arg_9_1.actors_["1148ui_story"].transform

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				arg_9_1.var_.moveOldPos1148ui_story = var_12_8.localPosition
			end

			local var_12_9 = 0.001

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_9 then
				var_12_8.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1148ui_story, Vector3.New(0, 100, 0), (arg_9_1.time_ - 0) / var_12_9)
			...
			local var_12_10 = arg_9_1.actors_["1148ui_story"]

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(var_12_10) and arg_9_1.var_.characterEffect1148ui_story == nil then
				arg_9_1.var_.characterEffect1148ui_story = var_12_10:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_11 = 0.200000002980232

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_11 and not isNil(var_12_10) then
				if arg_9_1.var_.characterEffect1148ui_story and not isNil(var_12_10) then
					arg_9_1.var_.characterEffect1148ui_story.fillFlat = true
					arg_9_1.var_.characterEffect1148ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_9_1.time_ - 0) / var_12_11)
				end
			end

			if arg_9_1.time_ >= 0 + var_12_11 and arg_9_1.time_ < 0 + var_12_11 + arg_12_0 and not isNil(var_12_10) and arg_9_1.var_.characterEffect1148ui_story then
				arg_9_1.var_.characterEffect1148ui_story.fillFlat = true
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_12 + arg_12_0 then
				...
				local var_12_14 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(414331002).content)

				arg_9_1.text_.text = var_12_14

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_16 = 25 <= 0 and var_12_13 or var_12_13 * (utf8.len(var_12_14) / 25)

				if (25 <= 0 and var_12_13 or var_12_13 * (utf8.len(var_12_14) / 25)) > 0 and var_12_13 < var_12_16 then
	...
	Play414331003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1:PlayTimeline("1148ui_story", "StoryTimeline/CharAction/story1148/story1148actionlink/1148action435")
			end
			...
			local var_16_4 = arg_13_1.actors_["107001ui_story"].transform

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos107001ui_story = var_16_4.localPosition
			end

			local var_16_5 = 0.001

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_5 then
				var_16_4.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos107001ui_story, Vector3.New(0, 100, 0), (arg_13_1.time_ - 0) / var_16_5)
			...
			local var_16_6 = arg_13_1.actors_["107001ui_story"]

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 and not isNil(var_16_6) and arg_13_1.var_.characterEffect107001ui_story == nil then
				arg_13_1.var_.characterEffect107001ui_story = var_16_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_16_7 = 0.200000002980232

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_7 and not isNil(var_16_6) then
				if arg_13_1.var_.characterEffect107001ui_story and not isNil(var_16_6) then
					arg_13_1.var_.characterEffect107001ui_story.fillFlat = true
					arg_13_1.var_.characterEffect107001ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_13_1.time_ - 0) / var_16_7)
				end
			end

			if arg_13_1.time_ >= 0 + var_16_7 and arg_13_1.time_ < 0 + var_16_7 + arg_16_0 and not isNil(var_16_6) and arg_13_1.var_.characterEffect107001ui_story then
				arg_13_1.var_.characterEffect107001ui_story.fillFlat = true
				arg_13_1.var_.characterEffect107001ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(414331003).content)

				arg_13_1.text_.text = var_16_10

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_12 = 18 <= 0 and var_16_9 or var_16_9 * (utf8.len(var_16_10) / 18)

				if (18 <= 0 and var_16_9 or var_16_9 * (utf8.len(var_16_10) / 18)) > 0 and var_16_9 < var_16_12 then
	...
	Play414331004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_3 + arg_20_0 then
				...
				local var_20_5 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(414331004).content)

				arg_17_1.text_.text = var_20_5

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_7 = 71 <= 0 and var_20_4 or var_20_4 * (utf8.len(var_20_5) / 71)

				if (71 <= 0 and var_20_4 or var_20_4 * (utf8.len(var_20_5) / 71)) > 0 and var_20_4 < var_20_7 then
	...
	Play414331005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if arg_21_1.actors_["10089ui_story"] == nil and not isNil((Asset.Load("Char/" .. "10089ui_story"))) then
				local var_24_0 = Object.Instantiate(Asset.Load("Char/" .. "10089ui_story"), arg_21_1.stage_.transform)

				var_24_0.name = "10089ui_story"
				var_24_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_21_1.actors_["10089ui_story"] = var_24_0
				...
				arg_21_1.var_["10089ui_story" .. "Animator"] = var_24_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_21_1.var_["10089ui_story" .. "Animator"].applyRootMotion = true
				arg_21_1.var_["10089ui_story" .. "LipSync"] = var_24_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_24_3 = arg_21_1.actors_["10089ui_story"].transform

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos10089ui_story = var_24_3.localPosition
			end

			local var_24_4 = 0.001

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_4 then
				var_24_3.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos10089ui_story, Vector3.New(0, -1.12, -5.99), (arg_21_1.time_ - 0) / var_24_4)
			...
			if arg_21_1.time_ >= 0 + var_24_4 and arg_21_1.time_ < 0 + var_24_4 + arg_24_0 then
				var_24_3.localPosition = Vector3.New(0, -1.12, -5.99)
				var_24_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_24_3.position).x, (manager.ui.mainCamera.transform.position - var_24_3.position).y, (manager.ui.mainCamera.transform.position - var_24_3.position).z)
				var_24_3.localEulerAngles.z = 0
				var_24_3.localEulerAngles.x = 0
				var_24_3.localEulerAngles = var_24_3.localEulerAngles
			...
			local var_24_5 = arg_21_1.actors_["10089ui_story"]

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(var_24_5) and arg_21_1.var_.characterEffect10089ui_story == nil then
				arg_21_1.var_.characterEffect10089ui_story = var_24_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_24_6 = 0.200000002980232

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_6 and not isNil(var_24_5) then
				if arg_21_1.var_.characterEffect10089ui_story and not isNil(var_24_5) then
					arg_21_1.var_.characterEffect10089ui_story.fillFlat = false
				end
			end

			if arg_21_1.time_ >= 0 + var_24_6 and arg_21_1.time_ < 0 + var_24_6 + arg_24_0 and not isNil(var_24_5) and arg_21_1.var_.characterEffect10089ui_story then
				arg_21_1.var_.characterEffect10089ui_story.fillFlat = false
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_8 + arg_24_0 then
				...
				local var_24_10 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(414331005).content)

				arg_21_1.text_.text = var_24_10

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_12 = 22 <= 0 and var_24_9 or var_24_9 * (utf8.len(var_24_10) / 22)

				if (22 <= 0 and var_24_9 or var_24_9 * (utf8.len(var_24_10) / 22)) > 0 and var_24_9 < var_24_12 then
	...
	Play414331006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				...
				local var_28_1 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(414331006).content)
	...
	Play414331007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(414331007).content)
	...
	Play414331008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				arg_33_1:AudioAction("play", "effect", "se_story_135_02", "se_story_135_02_gagagroup", "")
			end
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_1 + arg_36_0 then
				...
				arg_33_1.leftNameTxt_.text = arg_33_1:FormatText(StoryNameCfg[945].name)
				...
				local var_36_3 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(414331008).content)

				arg_33_1.text_.text = var_36_3

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_5 = 3 <= 0 and var_36_2 or var_36_2 * (utf8.len(var_36_3) / 3)

				if (3 <= 0 and var_36_2 or var_36_2 * (utf8.len(var_36_3) / 3)) > 0 and var_36_2 < var_36_5 then
	...
	Play414331009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 <= arg_37_1.time_ and arg_37_1.time_ < 0 + var_40_0 then
				arg_37_1.actors_["10089ui_story"].transform.localPosition = Vector3.Lerp(arg_37_1.var_.moveOldPos10089ui_story, Vector3.New(0, 100, 0), (arg_37_1.time_ - 0) / var_40_0)
			...
			if arg_37_1.time_ >= 0 + var_40_0 and arg_37_1.time_ < 0 + var_40_0 + arg_40_0 then
				arg_37_1.actors_["10089ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_37_1.actors_["10089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_37_1.actors_["10089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_37_1.actors_["10089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_37_1.actors_["10089ui_story"].transform.position).z)
				arg_37_1.actors_["10089ui_story"].transform.localEulerAngles.z = 0
				arg_37_1.actors_["10089ui_story"].transform.localEulerAngles.x = 0
				arg_37_1.actors_["10089ui_story"].transform.localEulerAngles = arg_37_1.actors_["10089ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_37_1.time_ and arg_37_1.time_ < 0 + var_40_2 and not isNil(var_40_1) then
				if arg_37_1.var_.characterEffect10089ui_story and not isNil(var_40_1) then
					...
					arg_37_1.var_.characterEffect10089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_37_1.time_ - 0) / var_40_2)
				end
			end
			...
			if arg_37_1.time_ >= 0 + var_40_2 and arg_37_1.time_ < 0 + var_40_2 + arg_40_0 and not isNil(var_40_1) and arg_37_1.var_.characterEffect10089ui_story then
				arg_37_1.var_.characterEffect10089ui_story.fillFlat = true
				arg_37_1.var_.characterEffect10089ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_3 + arg_40_0 then
				...
				local var_40_5 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(414331009).content)
	...
	Play414331010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				...
				local var_44_1 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(414331010).content)
	...
	Play414331011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				local var_48_1 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(414331011).content)
	...
	Play414331012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineFinish_()
			...
			for iter_50_0, iter_50_1 in ipairs(arg_49_1.choices_) do
				SetActive(iter_50_1.go, iter_50_0 <= 3)
			end
		...
		function arg_49_1.playNext_(arg_51_0)
			...
			arg_49_1:RecordChoiceLog(414331012, 896, 897, 898)
		end
	...
	Play414331013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_4 + arg_56_0 then
				...
				local var_56_6 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(414331013).content)

				arg_53_1.text_.text = var_56_6

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_8 = 15 <= 0 and var_56_5 or var_56_5 * (utf8.len(var_56_6) / 15)

				if (15 <= 0 and var_56_5 or var_56_5 * (utf8.len(var_56_6) / 15)) > 0 and var_56_5 < var_56_8 then
	...
	Play414331014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0.433333333333333 < arg_57_1.time_ and arg_57_1.time_ <= 0.433333333333333 + arg_60_0 then
				arg_57_1:AudioAction("play", "effect", "se_story_130", "se_story_130_didi", "")
			end
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_4 + arg_60_0 then
				...
				local var_60_6 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(414331014).content)

				arg_57_1.text_.text = var_60_6

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_8 = 68 <= 0 and var_60_5 or var_60_5 * (utf8.len(var_60_6) / 68)

				if (68 <= 0 and var_60_5 or var_60_5 * (utf8.len(var_60_6) / 68)) > 0 and var_60_5 < var_60_8 then
	...
	Play414331019 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				arg_61_1:AudioAction("stop", "effect", "se_story_130", "se_story_130_didi", "")
			end
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_9 + arg_64_0 then
				...
				local var_64_11 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(414331019).content)

				arg_61_1.text_.text = var_64_11

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_13 = 8 <= 0 and var_64_10 or var_64_10 * (utf8.len(var_64_11) / 8)

				if (8 <= 0 and var_64_10 or var_64_10 * (utf8.len(var_64_11) / 8)) > 0 and var_64_10 < var_64_13 then
					arg_61_1.talkMaxDuration = var_64_13

					if var_64_13 + var_64_9 > arg_61_1.duration_ then
						arg_61_1.duration_ = var_64_13 + var_64_9
					end
				end
			...
			local var_64_14 = math.max(var_64_10, arg_61_1.talkMaxDuration)

			if var_64_9 <= arg_61_1.time_ and arg_61_1.time_ < var_64_9 + var_64_14 then
				arg_61_1.typewritter.percent = (arg_61_1.time_ - var_64_9) / var_64_14

				arg_61_1.typewritter:SetDirty()
			end

			if arg_61_1.time_ >= var_64_9 + var_64_14 and arg_61_1.time_ < var_64_9 + var_64_14 + arg_64_0 then
	...
	Play414331015 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			local var_68_4 = "10089ui_story"

			if arg_65_1.actors_["10089ui_story"] == nil and not isNil((Asset.Load("Char/" .. "10089ui_story"))) then
				local var_68_5 = Object.Instantiate(Asset.Load("Char/" .. "10089ui_story"), arg_65_1.stage_.transform)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_8 + arg_68_0 then
				...
				local var_68_10 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(414331015).content)

				arg_65_1.text_.text = var_68_10

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_12 = 18 <= 0 and var_68_9 or var_68_9 * (utf8.len(var_68_10) / 18)

				if (18 <= 0 and var_68_9 or var_68_9 * (utf8.len(var_68_10) / 18)) > 0 and var_68_9 < var_68_12 then
	...
	Play414331016 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_3 + arg_72_0 then
				...
				local var_72_5 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(414331016).content)

				arg_69_1.text_.text = var_72_5

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_7 = 51 <= 0 and var_72_4 or var_72_4 * (utf8.len(var_72_5) / 51)

				if (51 <= 0 and var_72_4 or var_72_4 * (utf8.len(var_72_5) / 51)) > 0 and var_72_4 < var_72_7 then
	...
	Play414331017 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				arg_73_1.var_.moveOldPos10089ui_story = arg_73_1.actors_["10089ui_story"].transform.localPosition
			end

			local var_76_0 = 0.001

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_0 then
				arg_73_1.actors_["10089ui_story"].transform.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPos10089ui_story, Vector3.New(0, -1.12, -5.99), (arg_73_1.time_ - 0) / var_76_0)
				arg_73_1.actors_["10089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_73_1.actors_["10089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["10089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["10089ui_story"].transform.position).z)
				arg_73_1.actors_["10089ui_story"].transform.localEulerAngles.z = 0
				arg_73_1.actors_["10089ui_story"].transform.localEulerAngles.x = 0
				arg_73_1.actors_["10089ui_story"].transform.localEulerAngles = arg_73_1.actors_["10089ui_story"].transform.localEulerAngles
			end

			if arg_73_1.time_ >= 0 + var_76_0 and arg_73_1.time_ < 0 + var_76_0 + arg_76_0 then
				arg_73_1.actors_["10089ui_story"].transform.localPosition = Vector3.New(0, -1.12, -5.99)
				arg_73_1.actors_["10089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_73_1.actors_["10089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["10089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["10089ui_story"].transform.position).z)
				arg_73_1.actors_["10089ui_story"].transform.localEulerAngles.z = 0
				arg_73_1.actors_["10089ui_story"].transform.localEulerAngles.x = 0
				arg_73_1.actors_["10089ui_story"].transform.localEulerAngles = arg_73_1.actors_["10089ui_story"].transform.localEulerAngles
			...
			local var_76_1 = arg_73_1.actors_["10089ui_story"]

			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 and not isNil(var_76_1) and arg_73_1.var_.characterEffect10089ui_story == nil then
				arg_73_1.var_.characterEffect10089ui_story = var_76_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_76_2 = 0.200000002980232

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_2 and not isNil(var_76_1) then
				if arg_73_1.var_.characterEffect10089ui_story and not isNil(var_76_1) then
					arg_73_1.var_.characterEffect10089ui_story.fillFlat = false
				end
			end

			if arg_73_1.time_ >= 0 + var_76_2 and arg_73_1.time_ < 0 + var_76_2 + arg_76_0 and not isNil(var_76_1) and arg_73_1.var_.characterEffect10089ui_story then
				arg_73_1.var_.characterEffect10089ui_story.fillFlat = false
			end

			local var_76_4 = "10089ui_story"

			if arg_73_1.actors_["10089ui_story"] == nil and not isNil((Asset.Load("Char/" .. "10089ui_story"))) then
				local var_76_5 = Object.Instantiate(Asset.Load("Char/" .. "10089ui_story"), arg_73_1.stage_.transform)
			...
			local var_76_8 = "10089ui_story"

			if arg_73_1.actors_["10089ui_story"] == nil and not isNil((Asset.Load("Char/" .. "10089ui_story"))) then
				local var_76_9 = Object.Instantiate(Asset.Load("Char/" .. "10089ui_story"), arg_73_1.stage_.transform)

				var_76_9.name = var_76_8
				var_76_9.transform.localPosition = Vector3.New(0, 100, 0)
				arg_73_1.actors_[var_76_8] = var_76_9

				local var_76_10 = var_76_9:GetComponentInChildren(typeof(CharacterEffect))

				var_76_10.enabled = true

				local var_76_11 = GameObjectTools.GetOrAddComponent(var_76_9, typeof(DynamicBoneHelper))

				if var_76_11 then
					var_76_11:EnableDynamicBone(false)
				end

				arg_73_1:ShowWeapon(var_76_10.transform, false)

				arg_73_1.var_[var_76_8 .. "Animator"] = var_76_10.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_73_1.var_[var_76_8 .. "Animator"].applyRootMotion = true
				arg_73_1.var_[var_76_8 .. "LipSync"] = var_76_10.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_12 + arg_76_0 then
				...
				arg_73_1.leftNameTxt_.text = arg_73_1:FormatText(StoryNameCfg[988].name)
				...
				local var_76_14 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(414331017).content)

				arg_73_1.text_.text = var_76_14

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_16 = 10 <= 0 and var_76_13 or var_76_13 * (utf8.len(var_76_14) / 10)

				if (10 <= 0 and var_76_13 or var_76_13 * (utf8.len(var_76_14) / 10)) > 0 and var_76_13 < var_76_16 then
					arg_73_1.talkMaxDuration = var_76_16

					if var_76_16 + var_76_12 > arg_73_1.duration_ then
						arg_73_1.duration_ = var_76_16 + var_76_12
					end
				end
			...
			local var_76_17 = math.max(var_76_13, arg_73_1.talkMaxDuration)

			if var_76_12 <= arg_73_1.time_ and arg_73_1.time_ < var_76_12 + var_76_17 then
				arg_73_1.typewritter.percent = (arg_73_1.time_ - var_76_12) / var_76_17

				arg_73_1.typewritter:SetDirty()
			end

			if arg_73_1.time_ >= var_76_12 + var_76_17 and arg_73_1.time_ < var_76_12 + var_76_17 + arg_76_0 then
	...
	Play414331018 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				arg_77_1.var_.moveOldPos10089ui_story = arg_77_1.actors_["10089ui_story"].transform.localPosition
			end

			local var_80_0 = 0.001

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_0 then
				arg_77_1.actors_["10089ui_story"].transform.localPosition = Vector3.Lerp(arg_77_1.var_.moveOldPos10089ui_story, Vector3.New(0, 100, 0), (arg_77_1.time_ - 0) / var_80_0)
				arg_77_1.actors_["10089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["10089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["10089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["10089ui_story"].transform.position).z)
				arg_77_1.actors_["10089ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["10089ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["10089ui_story"].transform.localEulerAngles = arg_77_1.actors_["10089ui_story"].transform.localEulerAngles
			end

			if arg_77_1.time_ >= 0 + var_80_0 and arg_77_1.time_ < 0 + var_80_0 + arg_80_0 then
				arg_77_1.actors_["10089ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_77_1.actors_["10089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["10089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["10089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["10089ui_story"].transform.position).z)
				arg_77_1.actors_["10089ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["10089ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["10089ui_story"].transform.localEulerAngles = arg_77_1.actors_["10089ui_story"].transform.localEulerAngles
			...
			local var_80_1 = arg_77_1.actors_["10089ui_story"]

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 and not isNil(var_80_1) and arg_77_1.var_.characterEffect10089ui_story == nil then
				arg_77_1.var_.characterEffect10089ui_story = var_80_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_80_2 = 0.200000002980232

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_2 and not isNil(var_80_1) then
				if arg_77_1.var_.characterEffect10089ui_story and not isNil(var_80_1) then
					arg_77_1.var_.characterEffect10089ui_story.fillFlat = true
					arg_77_1.var_.characterEffect10089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_77_1.time_ - 0) / var_80_2)
				end
			end

			if arg_77_1.time_ >= 0 + var_80_2 and arg_77_1.time_ < 0 + var_80_2 + arg_80_0 and not isNil(var_80_1) and arg_77_1.var_.characterEffect10089ui_story then
				arg_77_1.var_.characterEffect10089ui_story.fillFlat = true
				arg_77_1.var_.characterEffect10089ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_3 + arg_80_0 then
				...
				local var_80_5 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(414331018).content)

				arg_77_1.text_.text = var_80_5

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_7 = 50 <= 0 and var_80_4 or var_80_4 * (utf8.len(var_80_5) / 50)

				if (50 <= 0 and var_80_4 or var_80_4 * (utf8.len(var_80_5) / 50)) > 0 and var_80_4 < var_80_7 then
