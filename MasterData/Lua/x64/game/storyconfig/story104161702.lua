	...
	Play416172031 = function(arg_127_0, arg_127_1)
		...
		function arg_127_1.onSingleLineUpdate_(arg_130_0)
			...
			if 0 < arg_127_1.time_ and arg_127_1.time_ <= 0 + arg_130_0 then
				...
				for iter_130_1, iter_130_2 in ipairs((var_130_3.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_130_2.transform.localScale = Vector3.New(iter_130_2.transform.localScale.x / var_130_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_130_2.transform.localScale.y / var_130_5, iter_130_2.transform.localScale.z)
				end
			end

			if 0.3 < arg_127_1.time_ and arg_127_1.time_ <= 0.3 + arg_130_0 then
				local var_130_7 = arg_127_1.var_.effect745

				if not arg_127_1.var_.effect745 then
					var_130_7 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), manager.ui.mainCamera.transform)
					var_130_7.name = "745"
					arg_127_1.var_.effect745 = var_130_7
				else
					var_130_7.transform:SetParent(var_130_9000)
				end

				var_130_7.transform.localPosition = Vector3.New(0, 0.21, 0)
				var_130_7.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_130_9 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_130_3, iter_130_4 in ipairs((var_130_7.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_130_4.transform.localScale = Vector3.New(iter_130_4.transform.localScale.x / var_130_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_130_4.transform.localScale.y / var_130_9, iter_130_4.transform.localScale.z)
				end
			end
			...
			local var_130_14 = 0.9
			local var_130_15 = 1.825

			if 0.9 < arg_127_1.time_ and arg_127_1.time_ <= var_130_14 + arg_130_0 then
				...
				local var_130_17 = arg_127_1:FormatText(arg_127_1:GetWordFromCfg(416172031).content)

				arg_127_1.text_.text = var_130_17

				LuaForUtil.ClearLinePrefixSymbol(arg_127_1.text_)

				local var_130_19 = 73 <= 0 and var_130_15 or var_130_15 * (utf8.len(var_130_17) / 73)

				if (73 <= 0 and var_130_15 or var_130_15 * (utf8.len(var_130_17) / 73)) > 0 and var_130_15 < var_130_19 then
