	...
	Play322062001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				for iter_4_2, iter_4_3 in ipairs((var_4_16.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_3.transform.localScale = Vector3.New(iter_4_3.transform.localScale.x / var_4_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_3.transform.localScale.y / var_4_18, iter_4_3.transform.localScale.z)
				end
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_20 + arg_4_0 then
				...
				local var_4_23 = arg_1_1:GetWordFromCfg(322062001)
				...
				if manager.audio:GetVoiceLength("story_v_out_322062", "322062001", "story_v_out_322062.awb") ~= 0 then
					local var_4_27 = manager.audio:GetVoiceLength("story_v_out_322062", "322062001", "story_v_out_322062.awb") / 1000
					...
					if var_4_23.prefab_name ~= "" and arg_1_1.actors_[var_4_23.prefab_name] ~= nil then
						local var_4_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_23.prefab_name].transform, "story_v_out_322062", "322062001", "story_v_out_322062.awb")

						arg_1_1:RecordAudio("322062001", var_4_28)
						arg_1_1:RecordAudio("322062001", var_4_28)
					else
	...
	Play322062078 = function(arg_322_0, arg_322_1)
		...
		function arg_322_1.onSingleLineUpdate_(arg_325_0)
			...
			if 1.01666666666667 < arg_322_1.time_ and arg_322_1.time_ <= 1.01666666666667 + arg_325_0 then
				...
				for iter_325_0, iter_325_1 in ipairs((var_325_10.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_325_1.transform.localScale = Vector3.New(iter_325_1.transform.localScale.x / var_325_12 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_325_1.transform.localScale.y / var_325_12, iter_325_1.transform.localScale.z)
				end
			end

			if 1 < arg_322_1.time_ and arg_322_1.time_ <= 1 + arg_325_0 then
				local var_325_14 = arg_322_1.var_.effect0781

				if not arg_322_1.var_.effect0781 then
					var_325_14 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_vignetting"), manager.ui.mainCamera.transform)
					var_325_14.name = "0781"
					arg_322_1.var_.effect0781 = var_325_14
				else
					var_325_14.transform:SetParent(var_325_9000)
				end

				var_325_14.transform.localPosition = Vector3.New(0, 0, -1)
				var_325_14.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_325_16 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_325_2, iter_325_3 in ipairs((var_325_14.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_325_3.transform.localScale = Vector3.New(iter_325_3.transform.localScale.x / var_325_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_325_3.transform.localScale.y / var_325_16, iter_325_3.transform.localScale.z)
				end
			end

			if 1.01666666666667 < arg_322_1.time_ and arg_322_1.time_ <= 1.01666666666667 + arg_325_0 then
				if not isNil(arg_322_1.actors_["10103ui_story"]) then
					local var_325_18 = GameObjectTools.GetOrAddComponent(arg_322_1.actors_["10103ui_story"], typeof(DynamicBoneHelper))

					if var_325_18 then
						var_325_18:EnableDynamicBone(true)
					end
				end
			end
			...
			local var_325_20 = 0.0166666666666667

			if var_325_19 <= arg_322_1.time_ and arg_322_1.time_ < var_325_19 + var_325_20 then
				arg_322_1.screenFilterEffect_.weight = Mathf.Lerp(0, 1, (arg_322_1.time_ - var_325_19) / var_325_20)
			end

			if arg_322_1.time_ >= var_325_19 + var_325_20 and arg_322_1.time_ < var_325_19 + var_325_20 + arg_325_0 then
				arg_322_1.screenFilterEffect_.weight = 1
			end

			local var_325_21 = 0

			if 0 < arg_322_1.time_ and arg_322_1.time_ <= var_325_21 + arg_325_0 then
			...
			if var_325_21 <= arg_322_1.time_ and arg_322_1.time_ < var_325_21 + var_325_22 then
				local var_325_23 = Color.New(0, 0, 0)

				var_325_23.a = Mathf.Lerp(0, 1, (arg_322_1.time_ - var_325_21) / var_325_22)
				arg_322_1.mask_.color = var_325_23
			end

			if arg_322_1.time_ >= var_325_21 + var_325_22 and arg_322_1.time_ < var_325_21 + var_325_22 + arg_325_0 then
				local var_325_24 = Color.New(0, 0, 0)

				var_325_24.a = 1
				arg_322_1.mask_.color = var_325_24
			end

			local var_325_25 = 1

			if 1 < arg_322_1.time_ and arg_322_1.time_ <= var_325_25 + arg_325_0 then
				arg_322_1.mask_.enabled = true
				arg_322_1.mask_.raycastTarget = true
			...
			if var_325_25 <= arg_322_1.time_ and arg_322_1.time_ < var_325_25 + var_325_26 then
				...
				var_325_27.a = Mathf.Lerp(1, 0, (arg_322_1.time_ - var_325_25) / var_325_26)
				arg_322_1.mask_.color = var_325_27
			end

			if arg_322_1.time_ >= var_325_25 + var_325_26 and arg_322_1.time_ < var_325_25 + var_325_26 + arg_325_0 then
				local var_325_28 = Color.New(0, 0, 0)

				arg_322_1.mask_.enabled = false
				var_325_28.a = 0
				arg_322_1.mask_.color = var_325_28
			end

			local var_325_29 = "L01h"

			if arg_322_1.bgs_.L01h == nil then
				local var_325_30 = Object.Instantiate(arg_322_1.paintGo_)

				var_325_30:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. var_325_29)
				var_325_30.name = var_325_29
				var_325_30.transform.parent = arg_322_1.stage_.transform
				var_325_30.transform.localPosition = Vector3.New(0, 100, 0)
				arg_322_1.bgs_[var_325_29] = var_325_30
			end

			if 1 < arg_322_1.time_ and arg_322_1.time_ <= 1 + arg_325_0 then
				local var_325_31 = arg_322_1.bgs_.L01h
				...
				var_325_31.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_325_32 = var_325_31:GetComponent("SpriteRenderer")

				if var_325_32 and var_325_32.sprite then
					local var_325_33 = 2 * (var_325_31.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_325_31.transform.localScale = Vector3.New(var_325_33 / var_325_32.sprite.bounds.size.y < var_325_33 * manager.ui.mainCameraCom_.aspect / var_325_32.sprite.bounds.size.x and var_325_33 * manager.ui.mainCameraCom_.aspect / var_325_32.sprite.bounds.size.x or var_325_33 / var_325_32.sprite.bounds.size.y, var_325_33 / var_325_32.sprite.bounds.size.y < var_325_33 * manager.ui.mainCameraCom_.aspect / var_325_32.sprite.bounds.size.x and var_325_33 * manager.ui.mainCameraCom_.aspect / var_325_32.sprite.bounds.size.x or var_325_33 / var_325_32.sprite.bounds.size.y, 0)
				end
			...
			local var_325_34 = 1.6
			local var_325_35 = 0.725

			if 1.6 < arg_322_1.time_ and arg_322_1.time_ <= var_325_34 + arg_325_0 then
				...
				local var_325_36 = LeanTween.value(arg_322_1.dialog_, 0, 1, 0.3)

				var_325_36:setOnUpdate(LuaHelper.FloatAction(function(arg_326_0)
					arg_322_1.dialogCg_.alpha = arg_326_0
				end))
				var_325_36:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_322_1.dialog_)
					var_325_36:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_325_37 = arg_322_1:GetWordFromCfg(322062078)
				local var_325_38 = arg_322_1:FormatText(var_325_37.content)

				arg_322_1.text_.text = var_325_38

				LuaForUtil.ClearLinePrefixSymbol(arg_322_1.text_)

				local var_325_40 = 29 <= 0 and var_325_35 or var_325_35 * (utf8.len(var_325_38) / 29)

				if (29 <= 0 and var_325_35 or var_325_35 * (utf8.len(var_325_38) / 29)) > 0 and var_325_35 < var_325_40 then
					arg_322_1.talkMaxDuration = var_325_40
					var_325_34 = var_325_34 + 0.3

					if var_325_40 + var_325_34 > arg_322_1.duration_ then
						arg_322_1.duration_ = var_325_40 + var_325_34
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_322062", "322062078", "story_v_out_322062.awb") ~= 0 then
					local var_325_41 = manager.audio:GetVoiceLength("story_v_out_322062", "322062078", "story_v_out_322062.awb") / 1000

					if var_325_41 + var_325_34 > arg_322_1.duration_ then
						arg_322_1.duration_ = var_325_41 + var_325_34
					end

					if var_325_37.prefab_name ~= "" and arg_322_1.actors_[var_325_37.prefab_name] ~= nil then
						local var_325_42 = LuaForUtil.PlayVoiceWithCriLipsync(arg_322_1.actors_[var_325_37.prefab_name].transform, "story_v_out_322062", "322062078", "story_v_out_322062.awb")

						arg_322_1:RecordAudio("322062078", var_325_42)
						arg_322_1:RecordAudio("322062078", var_325_42)
					else
			...
			local var_325_43 = var_325_34 + 0.3
			local var_325_44 = math.max(var_325_35, arg_322_1.talkMaxDuration)

			if var_325_34 + 0.3 <= arg_322_1.time_ and arg_322_1.time_ < var_325_43 + var_325_44 then
				arg_322_1.typewritter.percent = (arg_322_1.time_ - var_325_43) / var_325_44

				arg_322_1.typewritter:SetDirty()
			end

			if arg_322_1.time_ >= var_325_43 + var_325_44 and arg_322_1.time_ < var_325_43 + var_325_44 + arg_325_0 then
