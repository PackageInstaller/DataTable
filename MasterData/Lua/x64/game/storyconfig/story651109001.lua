	...
	Play651109001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				local var_4_1 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(651109001).content)
	...
	Play651109002 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				...
				local var_8_1 = arg_5_1:FormatText(arg_5_1:GetWordFromCfg(651109002).content)

				arg_5_1.text_.text = var_8_1

				LuaForUtil.ClearLinePrefixSymbol(arg_5_1.text_)

				local var_8_3 = 59 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 59)

				if (59 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 59)) > 0 and var_8_0 < var_8_3 then
	...
	Play651109003 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(651109003).content)

				arg_9_1.text_.text = var_12_1

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_3 = 91 <= 0 and var_12_0 or var_12_0 * (utf8.len(var_12_1) / 91)

				if (91 <= 0 and var_12_0 or var_12_0 * (utf8.len(var_12_1) / 91)) > 0 and var_12_0 < var_12_3 then
