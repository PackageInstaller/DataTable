	...
	Play61102001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(61102001).content)

				arg_1_1.text_.text = var_4_11

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_13 = 45 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 45)

				if (45 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 45)) > 0 and var_4_9 < var_4_13 then
