return {
	Play606103001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 606103001
		arg_1_1.duration_ = 5
		...
		function arg_1_1.playNext_(arg_3_0)
			if arg_3_0 == 1 then
				arg_1_0:Play606103002(arg_1_1)
			end
		end

		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.actors_["2490002"] == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.imageGo_, arg_1_1.canvasGo_.transform)

				var_4_0.transform:SetSiblingIndex(1)

				var_4_0.name = "2490002"

				local var_4_1 = var_4_0:GetComponent(typeof(Image))

				var_4_1.sprite = getSpriteWithoutAtlas("TextureConfig/WeaponServant/Portrait/" .. "2490002")

				var_4_1:SetNativeSize()

				var_4_0.transform.localPosition = Vector3.New(0, 100000, 0)
				arg_1_1.actors_["2490002"] = var_4_0
			end

			local var_4_2 = arg_1_1.actors_["2490002"].transform

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				arg_1_1.var_.moveOldPos2490002 = var_4_2.localPosition
				var_4_2.localScale = Vector3.New(1, 1, 1)

				arg_1_1:CheckSpriteTmpPos("2490002", 3)
			end

			local var_4_3 = 0.001

			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_3 then
				var_4_2.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2490002, Vector3.New(0, 0, 0), (arg_1_1.time_ - 0) / var_4_3)
			end
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[419].name)
				...
				local var_4_6 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(606103001).content)

				arg_1_1.text_.text = var_4_6

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_8 = 17 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_6) / 17)

				if (17 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_6) / 17)) > 0 and var_4_5 < var_4_8 then
	...
	Play606103002 = function(arg_5_0, arg_5_1)
		arg_5_1.time_ = 0
		arg_5_1.frameCnt_ = 0
		arg_5_1.state_ = "playing"
		arg_5_1.curTalkId_ = 606103002
		arg_5_1.duration_ = 5
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				...
				arg_5_1.leftNameTxt_.text = arg_5_1:FormatText(StoryNameCfg[419].name)
				...
				local var_8_1 = arg_5_1:FormatText(arg_5_1:GetWordFromCfg(606103002).content)

				arg_5_1.text_.text = var_8_1

				LuaForUtil.ClearLinePrefixSymbol(arg_5_1.text_)

				local var_8_3 = 15 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 15)

				if (15 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 15)) > 0 and var_8_0 < var_8_3 then
