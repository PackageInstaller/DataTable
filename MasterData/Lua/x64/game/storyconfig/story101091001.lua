return {
	Play109101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[159].name)
				...
				local var_4_17 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(109101001).content)

				arg_1_1.text_.text = var_4_17

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_19 = 4 <= 0 and var_4_16 or var_4_16 * (utf8.len(var_4_17) / 4)

				if (4 <= 0 and var_4_16 or var_4_16 * (utf8.len(var_4_17) / 4)) > 0 and var_4_16 < var_4_19 then
	...
	Play109101002 = function(arg_6_0, arg_6_1)
		...
		function arg_6_1.onSingleLineUpdate_(arg_9_0)
			if 0 < arg_6_1.time_ and arg_6_1.time_ <= 0 + arg_9_0 then
				arg_6_1:AudioAction("play", "effect", "se_story_9", "se_story_9_puncture02", "")
			end

			local var_9_1 = 0
			local var_9_2 = 1.2

			if 0 < arg_6_1.time_ and arg_6_1.time_ <= var_9_1 + arg_9_0 then
				...
				local var_9_3 = arg_6_1:FormatText(arg_6_1:GetWordFromCfg(109101002).content)

				arg_6_1.text_.text = var_9_3

				LuaForUtil.ClearLinePrefixSymbol(arg_6_1.text_)

				local var_9_5 = 48 <= 0 and var_9_2 or var_9_2 * (utf8.len(var_9_3) / 48)

				if (48 <= 0 and var_9_2 or var_9_2 * (utf8.len(var_9_3) / 48)) > 0 and var_9_2 < var_9_5 then
					arg_6_1.talkMaxDuration = var_9_5

					if var_9_5 + var_9_1 > arg_6_1.duration_ then
						arg_6_1.duration_ = var_9_5 + var_9_1
					end
				end
			...
			local var_9_6 = math.max(var_9_2, arg_6_1.talkMaxDuration)

			if var_9_1 <= arg_6_1.time_ and arg_6_1.time_ < var_9_1 + var_9_6 then
				arg_6_1.typewritter.percent = (arg_6_1.time_ - var_9_1) / var_9_6

				arg_6_1.typewritter:SetDirty()
			end

			if arg_6_1.time_ >= var_9_1 + var_9_6 and arg_6_1.time_ < var_9_1 + var_9_6 + arg_9_0 then
	...
	Play109101003 = function(arg_10_0, arg_10_1)
		...
		function arg_10_1.onSingleLineUpdate_(arg_13_0)
			...
			if 0 < arg_10_1.time_ and arg_10_1.time_ <= 0 + arg_13_0 then
				...
				arg_10_1.leftNameTxt_.text = arg_10_1:FormatText(StoryNameCfg[76].name)
				...
				local var_13_1 = arg_10_1:GetWordFromCfg(109101003)
				...
				local var_13_4 = 8 <= 0 and var_13_0 or var_13_0 * (utf8.len(var_13_2) / 8)

				if (8 <= 0 and var_13_0 or var_13_0 * (utf8.len(var_13_2) / 8)) > 0 and var_13_0 < var_13_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101003", "story_v_out_109101.awb") ~= 0 then
					local var_13_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101003", "story_v_out_109101.awb") / 1000
					...
					if var_13_1.prefab_name ~= "" and arg_10_1.actors_[var_13_1.prefab_name] ~= nil then
						local var_13_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_10_1.actors_[var_13_1.prefab_name].transform, "story_v_out_109101", "109101003", "story_v_out_109101.awb")

						arg_10_1:RecordAudio("109101003", var_13_6)
						arg_10_1:RecordAudio("109101003", var_13_6)
					else
	...
	Play109101004 = function(arg_14_0, arg_14_1)
		...
		function arg_14_1.onSingleLineUpdate_(arg_17_0)
			if arg_14_1.actors_["1099ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1099ui_story"))) then
				local var_17_0 = Object.Instantiate(Asset.Load("Char/" .. "1099ui_story"), arg_14_1.stage_.transform)

				var_17_0.name = "1099ui_story"
				var_17_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_14_1.actors_["1099ui_story"] = var_17_0
				...
				arg_14_1.var_["1099ui_story" .. "Animator"] = var_17_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_14_1.var_["1099ui_story" .. "Animator"].applyRootMotion = true
				arg_14_1.var_["1099ui_story" .. "LipSync"] = var_17_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_17_3 = arg_14_1.actors_["1099ui_story"].transform

			if 0 < arg_14_1.time_ and arg_14_1.time_ <= 0 + arg_17_0 then
				arg_14_1.var_.moveOldPos1099ui_story = var_17_3.localPosition
			end

			local var_17_4 = 0.001

			if 0 <= arg_14_1.time_ and arg_14_1.time_ < 0 + var_17_4 then
				var_17_3.localPosition = Vector3.Lerp(arg_14_1.var_.moveOldPos1099ui_story, Vector3.New(0, -1.08, -5.9), (arg_14_1.time_ - 0) / var_17_4)
			...
			if arg_14_1.time_ >= 0 + var_17_4 and arg_14_1.time_ < 0 + var_17_4 + arg_17_0 then
				var_17_3.localPosition = Vector3.New(0, -1.08, -5.9)
				var_17_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_17_3.position).x, (manager.ui.mainCamera.transform.position - var_17_3.position).y, (manager.ui.mainCamera.transform.position - var_17_3.position).z)
				var_17_3.localEulerAngles.z = 0
				var_17_3.localEulerAngles.x = 0
				var_17_3.localEulerAngles = var_17_3.localEulerAngles
			...
			local var_17_5 = arg_14_1.actors_["1099ui_story"]

			if 0 < arg_14_1.time_ and arg_14_1.time_ <= 0 + arg_17_0 and not isNil(var_17_5) and arg_14_1.var_.characterEffect1099ui_story == nil then
				arg_14_1.var_.characterEffect1099ui_story = var_17_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_17_6 = 0.2

			if 0 <= arg_14_1.time_ and arg_14_1.time_ < 0 + var_17_6 and not isNil(var_17_5) then
				if arg_14_1.var_.characterEffect1099ui_story and not isNil(var_17_5) then
					arg_14_1.var_.characterEffect1099ui_story.fillFlat = false
				end
			end

			if arg_14_1.time_ >= 0 + var_17_6 and arg_14_1.time_ < 0 + var_17_6 + arg_17_0 and not isNil(var_17_5) and arg_14_1.var_.characterEffect1099ui_story then
				arg_14_1.var_.characterEffect1099ui_story.fillFlat = false
			end
			...
			if 0 < arg_14_1.time_ and arg_14_1.time_ <= var_17_8 + arg_17_0 then
				...
				arg_14_1.leftNameTxt_.text = arg_14_1:FormatText(StoryNameCfg[84].name)
				...
				local var_17_10 = arg_14_1:GetWordFromCfg(109101004)
				...
				local var_17_13 = 20 <= 0 and var_17_9 or var_17_9 * (utf8.len(var_17_11) / 20)

				if (20 <= 0 and var_17_9 or var_17_9 * (utf8.len(var_17_11) / 20)) > 0 and var_17_9 < var_17_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101004", "story_v_out_109101.awb") ~= 0 then
					local var_17_14 = manager.audio:GetVoiceLength("story_v_out_109101", "109101004", "story_v_out_109101.awb") / 1000
					...
					if var_17_10.prefab_name ~= "" and arg_14_1.actors_[var_17_10.prefab_name] ~= nil then
						local var_17_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_14_1.actors_[var_17_10.prefab_name].transform, "story_v_out_109101", "109101004", "story_v_out_109101.awb")

						arg_14_1:RecordAudio("109101004", var_17_15)
						arg_14_1:RecordAudio("109101004", var_17_15)
					else
	...
	Play109101005 = function(arg_18_0, arg_18_1)
		...
		function arg_18_1.onSingleLineUpdate_(arg_21_0)
			if 0 < arg_18_1.time_ and arg_18_1.time_ <= 0 + arg_21_0 and not isNil(arg_18_1.actors_["1099ui_story"]) and arg_18_1.var_.characterEffect1099ui_story == nil then
				arg_18_1.var_.characterEffect1099ui_story = arg_18_1.actors_["1099ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_21_0 = 0.2

			if 0 <= arg_18_1.time_ and arg_18_1.time_ < 0 + var_21_0 and not isNil(arg_18_1.actors_["1099ui_story"]) then
				if arg_18_1.var_.characterEffect1099ui_story and not isNil(arg_18_1.actors_["1099ui_story"]) then
					arg_18_1.var_.characterEffect1099ui_story.fillFlat = true
					arg_18_1.var_.characterEffect1099ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_18_1.time_ - 0) / var_21_0)
				end
			end

			if arg_18_1.time_ >= 0 + var_21_0 and arg_18_1.time_ < 0 + var_21_0 + arg_21_0 and not isNil(arg_18_1.actors_["1099ui_story"]) and arg_18_1.var_.characterEffect1099ui_story then
				arg_18_1.var_.characterEffect1099ui_story.fillFlat = true
				arg_18_1.var_.characterEffect1099ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_18_1.time_ and arg_18_1.time_ <= var_21_1 + arg_21_0 then
				...
				arg_18_1.leftNameTxt_.text = arg_18_1:FormatText(StoryNameCfg[76].name)
				...
				local var_21_3 = arg_18_1:GetWordFromCfg(109101005)
				...
				local var_21_6 = 12 <= 0 and var_21_2 or var_21_2 * (utf8.len(var_21_4) / 12)

				if (12 <= 0 and var_21_2 or var_21_2 * (utf8.len(var_21_4) / 12)) > 0 and var_21_2 < var_21_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101005", "story_v_out_109101.awb") ~= 0 then
					local var_21_7 = manager.audio:GetVoiceLength("story_v_out_109101", "109101005", "story_v_out_109101.awb") / 1000
					...
					if var_21_3.prefab_name ~= "" and arg_18_1.actors_[var_21_3.prefab_name] ~= nil then
						local var_21_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_18_1.actors_[var_21_3.prefab_name].transform, "story_v_out_109101", "109101005", "story_v_out_109101.awb")

						arg_18_1:RecordAudio("109101005", var_21_8)
						arg_18_1:RecordAudio("109101005", var_21_8)
					else
	...
	Play109101006 = function(arg_22_0, arg_22_1)
		...
		function arg_22_1.onSingleLineUpdate_(arg_25_0)
			...
			if 0 < arg_22_1.time_ and arg_22_1.time_ <= 0 + arg_25_0 then
				...
				arg_22_1.leftNameTxt_.text = arg_22_1:FormatText(StoryNameCfg[74].name)
				...
				local var_25_1 = arg_22_1:GetWordFromCfg(109101006)
				...
				local var_25_4 = 4 <= 0 and var_25_0 or var_25_0 * (utf8.len(var_25_2) / 4)

				if (4 <= 0 and var_25_0 or var_25_0 * (utf8.len(var_25_2) / 4)) > 0 and var_25_0 < var_25_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101006", "story_v_out_109101.awb") ~= 0 then
					local var_25_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101006", "story_v_out_109101.awb") / 1000
					...
					if var_25_1.prefab_name ~= "" and arg_22_1.actors_[var_25_1.prefab_name] ~= nil then
						local var_25_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_22_1.actors_[var_25_1.prefab_name].transform, "story_v_out_109101", "109101006", "story_v_out_109101.awb")

						arg_22_1:RecordAudio("109101006", var_25_6)
						arg_22_1:RecordAudio("109101006", var_25_6)
					else
	...
	Play109101007 = function(arg_26_0, arg_26_1)
		...
		function arg_26_1.onSingleLineUpdate_(arg_29_0)
			if arg_26_1.bgs_.S0901 == nil then
				local var_29_0 = Object.Instantiate(arg_26_1.paintGo_)

				var_29_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "S0901")
				var_29_0.name = "S0901"
				var_29_0.transform.parent = arg_26_1.stage_.transform
				var_29_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_26_1.bgs_.S0901 = var_29_0
			end

			if 0 < arg_26_1.time_ and arg_26_1.time_ <= 0 + arg_29_0 then
				local var_29_1 = arg_26_1.bgs_.S0901

				arg_26_1.bgs_.S0901.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 0 < arg_26_1.time_ and arg_26_1.time_ <= 0 + arg_29_0 then
				local var_29_4 = arg_26_1.bgs_.S0901:GetComponent("SpriteRenderer")

				if var_29_4 then
					arg_26_1.var_.alphaOldValueS0901 = var_29_4.color.a
					arg_26_1.var_.alphaMatValueS0901 = var_29_4
				end
			...
			if 0 <= arg_26_1.time_ and arg_26_1.time_ < 0 + var_29_5 then
				if arg_26_1.var_.alphaMatValueS0901 then
					arg_26_1.var_.alphaMatValueS0901.color.a = Mathf.Lerp(arg_26_1.var_.alphaOldValueS0901, 1, (arg_26_1.time_ - 0) / var_29_5)
					arg_26_1.var_.alphaMatValueS0901.color = arg_26_1.var_.alphaMatValueS0901.color
				end
			end

			if arg_26_1.time_ >= 0 + var_29_5 and arg_26_1.time_ < 0 + var_29_5 + arg_29_0 and arg_26_1.var_.alphaMatValueS0901 then
				arg_26_1.var_.alphaMatValueS0901.color.a = 1
				arg_26_1.var_.alphaMatValueS0901.color = arg_26_1.var_.alphaMatValueS0901.color
			end

			local var_29_6 = arg_26_1.bgs_.S0901.transform

			if 0 < arg_26_1.time_ and arg_26_1.time_ <= 0 + arg_29_0 then
				arg_26_1.var_.moveOldPosS0901 = var_29_6.localPosition
			end

			local var_29_7 = 3.5

			if 0 <= arg_26_1.time_ and arg_26_1.time_ < 0 + var_29_7 then
				var_29_6.localPosition = Vector3.Lerp(arg_26_1.var_.moveOldPosS0901, Vector3.New(0, 1, 9.5), (arg_26_1.time_ - 0) / var_29_7)
			end

			if arg_26_1.time_ >= 0 + var_29_7 and arg_26_1.time_ < 0 + var_29_7 + arg_29_0 then
				var_29_6.localPosition = Vector3.New(0, 1, 9.5)
			end

			local var_29_8 = "1050ui_story"

			if arg_26_1.actors_["1050ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1050ui_story"))) then
				local var_29_9 = Object.Instantiate(Asset.Load("Char/" .. "1050ui_story"), arg_26_1.stage_.transform)

				var_29_9.name = var_29_8
				var_29_9.transform.localPosition = Vector3.New(0, 100, 0)
				arg_26_1.actors_[var_29_8] = var_29_9

				local var_29_10 = var_29_9:GetComponentInChildren(typeof(CharacterEffect))

				var_29_10.enabled = true

				local var_29_11 = GameObjectTools.GetOrAddComponent(var_29_9, typeof(DynamicBoneHelper))

				if var_29_11 then
					var_29_11:EnableDynamicBone(false)
				end

				arg_26_1:ShowWeapon(var_29_10.transform, false)

				arg_26_1.var_[var_29_8 .. "Animator"] = var_29_10.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_26_1.var_[var_29_8 .. "Animator"].applyRootMotion = true
				arg_26_1.var_[var_29_8 .. "LipSync"] = var_29_10.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_29_12 = arg_26_1.actors_["1050ui_story"].transform

			if 0 < arg_26_1.time_ and arg_26_1.time_ <= 0 + arg_29_0 then
				arg_26_1.var_.moveOldPos1050ui_story = var_29_12.localPosition
			end

			local var_29_13 = 0.001

			if 0 <= arg_26_1.time_ and arg_26_1.time_ < 0 + var_29_13 then
				var_29_12.localPosition = Vector3.Lerp(arg_26_1.var_.moveOldPos1050ui_story, Vector3.New(0, 100, 0), (arg_26_1.time_ - 0) / var_29_13)
				var_29_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_29_12.position).x, (manager.ui.mainCamera.transform.position - var_29_12.position).y, (manager.ui.mainCamera.transform.position - var_29_12.position).z)
				var_29_12.localEulerAngles.z = 0
				var_29_12.localEulerAngles.x = 0
				var_29_12.localEulerAngles = var_29_12.localEulerAngles
			end

			if arg_26_1.time_ >= 0 + var_29_13 and arg_26_1.time_ < 0 + var_29_13 + arg_29_0 then
				var_29_12.localPosition = Vector3.New(0, 100, 0)
				var_29_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_29_12.position).x, (manager.ui.mainCamera.transform.position - var_29_12.position).y, (manager.ui.mainCamera.transform.position - var_29_12.position).z)
				var_29_12.localEulerAngles.z = 0
				var_29_12.localEulerAngles.x = 0
				var_29_12.localEulerAngles = var_29_12.localEulerAngles
			...
			local var_29_14 = arg_26_1.actors_["1099ui_story"].transform

			if 0 < arg_26_1.time_ and arg_26_1.time_ <= 0 + arg_29_0 then
				arg_26_1.var_.moveOldPos1099ui_story = var_29_14.localPosition
			end

			local var_29_15 = 0.001

			if 0 <= arg_26_1.time_ and arg_26_1.time_ < 0 + var_29_15 then
				var_29_14.localPosition = Vector3.Lerp(arg_26_1.var_.moveOldPos1099ui_story, Vector3.New(0, 100, 0), (arg_26_1.time_ - 0) / var_29_15)
				var_29_14.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_29_14.position).x, (manager.ui.mainCamera.transform.position - var_29_14.position).y, (manager.ui.mainCamera.transform.position - var_29_14.position).z)
				var_29_14.localEulerAngles.z = 0
				var_29_14.localEulerAngles.x = 0
				var_29_14.localEulerAngles = var_29_14.localEulerAngles
			end

			if arg_26_1.time_ >= 0 + var_29_15 and arg_26_1.time_ < 0 + var_29_15 + arg_29_0 then
				var_29_14.localPosition = Vector3.New(0, 100, 0)
				var_29_14.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_29_14.position).x, (manager.ui.mainCamera.transform.position - var_29_14.position).y, (manager.ui.mainCamera.transform.position - var_29_14.position).z)
				var_29_14.localEulerAngles.z = 0
				var_29_14.localEulerAngles.x = 0
				var_29_14.localEulerAngles = var_29_14.localEulerAngles
			...
			local var_29_16 = 1.5
			local var_29_17 = 0.325

			if 1.5 < arg_26_1.time_ and arg_26_1.time_ <= var_29_16 + arg_29_0 then
				...
				local var_29_19 = arg_26_1:FormatText(arg_26_1:GetWordFromCfg(109101007).content)

				arg_26_1.text_.text = var_29_19

				LuaForUtil.ClearLinePrefixSymbol(arg_26_1.text_)

				local var_29_21 = 13 <= 0 and var_29_17 or var_29_17 * (utf8.len(var_29_19) / 13)

				if (13 <= 0 and var_29_17 or var_29_17 * (utf8.len(var_29_19) / 13)) > 0 and var_29_17 < var_29_21 then
	...
	Play109101008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= 0 + arg_35_0 then
				arg_32_1:AudioAction("play", "effect", "se_story_9", "se_story_9_black_fog_loop", "")
			end
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_1 + arg_35_0 then
				...
				local var_35_3 = arg_32_1:FormatText(arg_32_1:GetWordFromCfg(109101008).content)
	...
	Play109101009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= 0 + arg_39_0 then
				...
				local var_39_1 = arg_36_1:FormatText(arg_36_1:GetWordFromCfg(109101009).content)

				arg_36_1.text_.text = var_39_1

				LuaForUtil.ClearLinePrefixSymbol(arg_36_1.text_)

				local var_39_3 = 59 <= 0 and var_39_0 or var_39_0 * (utf8.len(var_39_1) / 59)

				if (59 <= 0 and var_39_0 or var_39_0 * (utf8.len(var_39_1) / 59)) > 0 and var_39_0 < var_39_3 then
	...
	Play109101010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= 0 + arg_43_0 then
				...
				local var_43_1 = arg_40_1:GetWordFromCfg(109101010)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101010", "story_v_out_109101.awb") ~= 0 then
					local var_43_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101010", "story_v_out_109101.awb") / 1000
					...
					if var_43_1.prefab_name ~= "" and arg_40_1.actors_[var_43_1.prefab_name] ~= nil then
						local var_43_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_1.prefab_name].transform, "story_v_out_109101", "109101010", "story_v_out_109101.awb")

						arg_40_1:RecordAudio("109101010", var_43_6)
						arg_40_1:RecordAudio("109101010", var_43_6)
					else
	...
	Play109101011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= 0 + arg_47_0 then
				...
				local var_47_1 = arg_44_1:GetWordFromCfg(109101011)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101011", "story_v_out_109101.awb") ~= 0 then
					local var_47_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101011", "story_v_out_109101.awb") / 1000
					...
					if var_47_1.prefab_name ~= "" and arg_44_1.actors_[var_47_1.prefab_name] ~= nil then
						local var_47_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_44_1.actors_[var_47_1.prefab_name].transform, "story_v_out_109101", "109101011", "story_v_out_109101.awb")

						arg_44_1:RecordAudio("109101011", var_47_6)
						arg_44_1:RecordAudio("109101011", var_47_6)
					else
	...
	Play109101012 = function(arg_48_0, arg_48_1)
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if 0 < arg_48_1.time_ and arg_48_1.time_ <= 0 + arg_51_0 then
				...
				local var_51_1 = arg_48_1:GetWordFromCfg(109101012)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101012", "story_v_out_109101.awb") ~= 0 then
					local var_51_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101012", "story_v_out_109101.awb") / 1000
					...
					if var_51_1.prefab_name ~= "" and arg_48_1.actors_[var_51_1.prefab_name] ~= nil then
						local var_51_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_48_1.actors_[var_51_1.prefab_name].transform, "story_v_out_109101", "109101012", "story_v_out_109101.awb")

						arg_48_1:RecordAudio("109101012", var_51_6)
						arg_48_1:RecordAudio("109101012", var_51_6)
					else
	...
	Play109101013 = function(arg_52_0, arg_52_1)
		...
		function arg_52_1.onSingleLineUpdate_(arg_55_0)
			...
			if 0 < arg_52_1.time_ and arg_52_1.time_ <= 0 + arg_55_0 then
				...
				local var_55_1 = arg_52_1:GetWordFromCfg(109101013)
				...
				local var_55_4 = 15 <= 0 and var_55_0 or var_55_0 * (utf8.len(var_55_2) / 15)

				if (15 <= 0 and var_55_0 or var_55_0 * (utf8.len(var_55_2) / 15)) > 0 and var_55_0 < var_55_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101013", "story_v_out_109101.awb") ~= 0 then
					local var_55_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101013", "story_v_out_109101.awb") / 1000
					...
					if var_55_1.prefab_name ~= "" and arg_52_1.actors_[var_55_1.prefab_name] ~= nil then
						local var_55_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_52_1.actors_[var_55_1.prefab_name].transform, "story_v_out_109101", "109101013", "story_v_out_109101.awb")

						arg_52_1:RecordAudio("109101013", var_55_6)
						arg_52_1:RecordAudio("109101013", var_55_6)
					else
	...
	Play109101014 = function(arg_56_0, arg_56_1)
		...
		function arg_56_1.onSingleLineUpdate_(arg_59_0)
			...
			if 0 < arg_56_1.time_ and arg_56_1.time_ <= 0 + arg_59_0 then
				...
				local var_59_1 = arg_56_1:GetWordFromCfg(109101014)
				...
				local var_59_4 = 7 <= 0 and var_59_0 or var_59_0 * (utf8.len(var_59_2) / 7)

				if (7 <= 0 and var_59_0 or var_59_0 * (utf8.len(var_59_2) / 7)) > 0 and var_59_0 < var_59_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101014", "story_v_out_109101.awb") ~= 0 then
					local var_59_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101014", "story_v_out_109101.awb") / 1000
					...
					if var_59_1.prefab_name ~= "" and arg_56_1.actors_[var_59_1.prefab_name] ~= nil then
						local var_59_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_56_1.actors_[var_59_1.prefab_name].transform, "story_v_out_109101", "109101014", "story_v_out_109101.awb")

						arg_56_1:RecordAudio("109101014", var_59_6)
						arg_56_1:RecordAudio("109101014", var_59_6)
					else
	...
	Play109101015 = function(arg_60_0, arg_60_1)
		...
		function arg_60_1.onSingleLineUpdate_(arg_63_0)
			...
			if 0 < arg_60_1.time_ and arg_60_1.time_ <= 0 + arg_63_0 then
				...
				local var_63_1 = arg_60_1:GetWordFromCfg(109101015)
				...
				local var_63_4 = 57 <= 0 and var_63_0 or var_63_0 * (utf8.len(var_63_2) / 57)

				if (57 <= 0 and var_63_0 or var_63_0 * (utf8.len(var_63_2) / 57)) > 0 and var_63_0 < var_63_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101015", "story_v_out_109101.awb") ~= 0 then
					local var_63_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101015", "story_v_out_109101.awb") / 1000
					...
					if var_63_1.prefab_name ~= "" and arg_60_1.actors_[var_63_1.prefab_name] ~= nil then
						local var_63_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_60_1.actors_[var_63_1.prefab_name].transform, "story_v_out_109101", "109101015", "story_v_out_109101.awb")

						arg_60_1:RecordAudio("109101015", var_63_6)
						arg_60_1:RecordAudio("109101015", var_63_6)
					else
	...
	Play109101016 = function(arg_64_0, arg_64_1)
		...
		function arg_64_1.onSingleLineUpdate_(arg_67_0)
			...
			if 0 < arg_64_1.time_ and arg_64_1.time_ <= 0 + arg_67_0 then
				...
				local var_67_1 = arg_64_1:GetWordFromCfg(109101016)
				...
				local var_67_4 = 42 <= 0 and var_67_0 or var_67_0 * (utf8.len(var_67_2) / 42)

				if (42 <= 0 and var_67_0 or var_67_0 * (utf8.len(var_67_2) / 42)) > 0 and var_67_0 < var_67_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101016", "story_v_out_109101.awb") ~= 0 then
					local var_67_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101016", "story_v_out_109101.awb") / 1000
					...
					if var_67_1.prefab_name ~= "" and arg_64_1.actors_[var_67_1.prefab_name] ~= nil then
						local var_67_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_64_1.actors_[var_67_1.prefab_name].transform, "story_v_out_109101", "109101016", "story_v_out_109101.awb")

						arg_64_1:RecordAudio("109101016", var_67_6)
						arg_64_1:RecordAudio("109101016", var_67_6)
					else
	...
	Play109101017 = function(arg_68_0, arg_68_1)
		...
		function arg_68_1.onSingleLineUpdate_(arg_71_0)
			...
			if 0 < arg_68_1.time_ and arg_68_1.time_ <= 0 + arg_71_0 then
				...
				local var_71_1 = arg_68_1:GetWordFromCfg(109101017)
				...
				local var_71_4 = 12 <= 0 and var_71_0 or var_71_0 * (utf8.len(var_71_2) / 12)

				if (12 <= 0 and var_71_0 or var_71_0 * (utf8.len(var_71_2) / 12)) > 0 and var_71_0 < var_71_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101017", "story_v_out_109101.awb") ~= 0 then
					local var_71_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101017", "story_v_out_109101.awb") / 1000
					...
					if var_71_1.prefab_name ~= "" and arg_68_1.actors_[var_71_1.prefab_name] ~= nil then
						local var_71_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_68_1.actors_[var_71_1.prefab_name].transform, "story_v_out_109101", "109101017", "story_v_out_109101.awb")

						arg_68_1:RecordAudio("109101017", var_71_6)
						arg_68_1:RecordAudio("109101017", var_71_6)
					else
	...
	Play109101018 = function(arg_72_0, arg_72_1)
		...
		function arg_72_1.onSingleLineUpdate_(arg_75_0)
			...
			if 0 < arg_72_1.time_ and arg_72_1.time_ <= 0 + arg_75_0 then
				...
				local var_75_1 = arg_72_1:GetWordFromCfg(109101018)
				...
				local var_75_4 = 2 <= 0 and var_75_0 or var_75_0 * (utf8.len(var_75_2) / 2)

				if (2 <= 0 and var_75_0 or var_75_0 * (utf8.len(var_75_2) / 2)) > 0 and var_75_0 < var_75_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101018", "story_v_out_109101.awb") ~= 0 then
					local var_75_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101018", "story_v_out_109101.awb") / 1000
					...
					if var_75_1.prefab_name ~= "" and arg_72_1.actors_[var_75_1.prefab_name] ~= nil then
						local var_75_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_72_1.actors_[var_75_1.prefab_name].transform, "story_v_out_109101", "109101018", "story_v_out_109101.awb")

						arg_72_1:RecordAudio("109101018", var_75_6)
						arg_72_1:RecordAudio("109101018", var_75_6)
					else
	...
	Play109101019 = function(arg_76_0, arg_76_1)
		...
		function arg_76_1.onSingleLineUpdate_(arg_79_0)
			...
			if 0 < arg_76_1.time_ and arg_76_1.time_ <= 0 + arg_79_0 then
				...
				arg_76_1.leftNameTxt_.text = arg_76_1:FormatText(StoryNameCfg[74].name)
				...
				local var_79_1 = arg_76_1:GetWordFromCfg(109101019)
				...
				local var_79_4 = 12 <= 0 and var_79_0 or var_79_0 * (utf8.len(var_79_2) / 12)

				if (12 <= 0 and var_79_0 or var_79_0 * (utf8.len(var_79_2) / 12)) > 0 and var_79_0 < var_79_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101019", "story_v_out_109101.awb") ~= 0 then
					local var_79_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101019", "story_v_out_109101.awb") / 1000
					...
					if var_79_1.prefab_name ~= "" and arg_76_1.actors_[var_79_1.prefab_name] ~= nil then
						local var_79_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_76_1.actors_[var_79_1.prefab_name].transform, "story_v_out_109101", "109101019", "story_v_out_109101.awb")

						arg_76_1:RecordAudio("109101019", var_79_6)
						arg_76_1:RecordAudio("109101019", var_79_6)
					else
	...
	Play109101020 = function(arg_80_0, arg_80_1)
		...
		function arg_80_1.onSingleLineUpdate_(arg_83_0)
			...
			if 0 < arg_80_1.time_ and arg_80_1.time_ <= 0 + arg_83_0 then
				...
				local var_83_1 = arg_80_1:GetWordFromCfg(109101020)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101020", "story_v_out_109101.awb") ~= 0 then
					local var_83_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101020", "story_v_out_109101.awb") / 1000
					...
					if var_83_1.prefab_name ~= "" and arg_80_1.actors_[var_83_1.prefab_name] ~= nil then
						local var_83_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_80_1.actors_[var_83_1.prefab_name].transform, "story_v_out_109101", "109101020", "story_v_out_109101.awb")

						arg_80_1:RecordAudio("109101020", var_83_6)
						arg_80_1:RecordAudio("109101020", var_83_6)
					else
	...
	Play109101021 = function(arg_84_0, arg_84_1)
		...
		function arg_84_1.onSingleLineUpdate_(arg_87_0)
			...
			if 0 < arg_84_1.time_ and arg_84_1.time_ <= 0 + arg_87_0 then
				...
				arg_84_1.leftNameTxt_.text = arg_84_1:FormatText(StoryNameCfg[84].name)
				...
				local var_87_1 = arg_84_1:GetWordFromCfg(109101021)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101021", "story_v_out_109101.awb") ~= 0 then
					local var_87_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101021", "story_v_out_109101.awb") / 1000
					...
					if var_87_1.prefab_name ~= "" and arg_84_1.actors_[var_87_1.prefab_name] ~= nil then
						local var_87_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_84_1.actors_[var_87_1.prefab_name].transform, "story_v_out_109101", "109101021", "story_v_out_109101.awb")

						arg_84_1:RecordAudio("109101021", var_87_6)
						arg_84_1:RecordAudio("109101021", var_87_6)
					else
	...
	Play109101022 = function(arg_88_0, arg_88_1)
		...
		function arg_88_1.onSingleLineUpdate_(arg_91_0)
			...
			if 0 < arg_88_1.time_ and arg_88_1.time_ <= 0 + arg_91_0 then
				...
				local var_91_1 = arg_88_1:GetWordFromCfg(109101022)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101022", "story_v_out_109101.awb") ~= 0 then
					local var_91_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101022", "story_v_out_109101.awb") / 1000
					...
					if var_91_1.prefab_name ~= "" and arg_88_1.actors_[var_91_1.prefab_name] ~= nil then
						local var_91_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_88_1.actors_[var_91_1.prefab_name].transform, "story_v_out_109101", "109101022", "story_v_out_109101.awb")

						arg_88_1:RecordAudio("109101022", var_91_6)
						arg_88_1:RecordAudio("109101022", var_91_6)
					else
	...
	Play109101023 = function(arg_92_0, arg_92_1)
		...
		function arg_92_1.onSingleLineUpdate_(arg_95_0)
			...
			if 0 < arg_92_1.time_ and arg_92_1.time_ <= 0 + arg_95_0 then
				...
				local var_95_1 = arg_92_1:GetWordFromCfg(109101023)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101023", "story_v_out_109101.awb") ~= 0 then
					local var_95_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101023", "story_v_out_109101.awb") / 1000
					...
					if var_95_1.prefab_name ~= "" and arg_92_1.actors_[var_95_1.prefab_name] ~= nil then
						local var_95_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_92_1.actors_[var_95_1.prefab_name].transform, "story_v_out_109101", "109101023", "story_v_out_109101.awb")

						arg_92_1:RecordAudio("109101023", var_95_6)
						arg_92_1:RecordAudio("109101023", var_95_6)
					else
	...
	Play109101024 = function(arg_96_0, arg_96_1)
		...
		function arg_96_1.onSingleLineUpdate_(arg_99_0)
			...
			if 0 < arg_96_1.time_ and arg_96_1.time_ <= 0 + arg_99_0 then
				...
				arg_96_1.leftNameTxt_.text = arg_96_1:FormatText(StoryNameCfg[10].name)
				...
				local var_99_1 = arg_96_1:GetWordFromCfg(109101024)
				...
				local var_99_4 = 25 <= 0 and var_99_0 or var_99_0 * (utf8.len(var_99_2) / 25)

				if (25 <= 0 and var_99_0 or var_99_0 * (utf8.len(var_99_2) / 25)) > 0 and var_99_0 < var_99_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101024", "story_v_out_109101.awb") ~= 0 then
					local var_99_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101024", "story_v_out_109101.awb") / 1000
					...
					if var_99_1.prefab_name ~= "" and arg_96_1.actors_[var_99_1.prefab_name] ~= nil then
						local var_99_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_96_1.actors_[var_99_1.prefab_name].transform, "story_v_out_109101", "109101024", "story_v_out_109101.awb")

						arg_96_1:RecordAudio("109101024", var_99_6)
						arg_96_1:RecordAudio("109101024", var_99_6)
					else
	...
	Play109101025 = function(arg_100_0, arg_100_1)
		...
		function arg_100_1.onSingleLineUpdate_(arg_103_0)
			...
			if 0 < arg_100_1.time_ and arg_100_1.time_ <= 0 + arg_103_0 then
				...
				arg_100_1.leftNameTxt_.text = arg_100_1:FormatText(StoryNameCfg[74].name)
				...
				local var_103_1 = arg_100_1:GetWordFromCfg(109101025)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101025", "story_v_out_109101.awb") ~= 0 then
					local var_103_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101025", "story_v_out_109101.awb") / 1000
					...
					if var_103_1.prefab_name ~= "" and arg_100_1.actors_[var_103_1.prefab_name] ~= nil then
						local var_103_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_100_1.actors_[var_103_1.prefab_name].transform, "story_v_out_109101", "109101025", "story_v_out_109101.awb")

						arg_100_1:RecordAudio("109101025", var_103_6)
						arg_100_1:RecordAudio("109101025", var_103_6)
					else
	...
	Play109101026 = function(arg_104_0, arg_104_1)
		...
		function arg_104_1.onSingleLineUpdate_(arg_107_0)
			...
			if 0 < arg_104_1.time_ and arg_104_1.time_ <= 0 + arg_107_0 then
				...
				local var_107_1 = arg_104_1:GetWordFromCfg(109101026)
				...
				local var_107_4 = 49 <= 0 and var_107_0 or var_107_0 * (utf8.len(var_107_2) / 49)

				if (49 <= 0 and var_107_0 or var_107_0 * (utf8.len(var_107_2) / 49)) > 0 and var_107_0 < var_107_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101026", "story_v_out_109101.awb") ~= 0 then
					local var_107_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101026", "story_v_out_109101.awb") / 1000
					...
					if var_107_1.prefab_name ~= "" and arg_104_1.actors_[var_107_1.prefab_name] ~= nil then
						local var_107_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_104_1.actors_[var_107_1.prefab_name].transform, "story_v_out_109101", "109101026", "story_v_out_109101.awb")

						arg_104_1:RecordAudio("109101026", var_107_6)
						arg_104_1:RecordAudio("109101026", var_107_6)
					else
	...
	Play109101027 = function(arg_108_0, arg_108_1)
		...
		function arg_108_1.onSingleLineUpdate_(arg_111_0)
			...
			if 0 < arg_108_1.time_ and arg_108_1.time_ <= 0 + arg_111_0 then
				...
				local var_111_1 = arg_108_1:GetWordFromCfg(109101027)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101027", "story_v_out_109101.awb") ~= 0 then
					local var_111_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101027", "story_v_out_109101.awb") / 1000
					...
					if var_111_1.prefab_name ~= "" and arg_108_1.actors_[var_111_1.prefab_name] ~= nil then
						local var_111_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_108_1.actors_[var_111_1.prefab_name].transform, "story_v_out_109101", "109101027", "story_v_out_109101.awb")

						arg_108_1:RecordAudio("109101027", var_111_6)
						arg_108_1:RecordAudio("109101027", var_111_6)
					else
	...
	Play109101028 = function(arg_112_0, arg_112_1)
		...
		function arg_112_1.onSingleLineUpdate_(arg_115_0)
			...
			if 0 < arg_112_1.time_ and arg_112_1.time_ <= 0 + arg_115_0 then
				...
				arg_112_1.leftNameTxt_.text = arg_112_1:FormatText(StoryNameCfg[74].name)
				...
				local var_115_1 = arg_112_1:GetWordFromCfg(109101028)
				...
				local var_115_4 = 40 <= 0 and var_115_0 or var_115_0 * (utf8.len(var_115_2) / 40)

				if (40 <= 0 and var_115_0 or var_115_0 * (utf8.len(var_115_2) / 40)) > 0 and var_115_0 < var_115_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101028", "story_v_out_109101.awb") ~= 0 then
					local var_115_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101028", "story_v_out_109101.awb") / 1000
					...
					if var_115_1.prefab_name ~= "" and arg_112_1.actors_[var_115_1.prefab_name] ~= nil then
						local var_115_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_112_1.actors_[var_115_1.prefab_name].transform, "story_v_out_109101", "109101028", "story_v_out_109101.awb")

						arg_112_1:RecordAudio("109101028", var_115_6)
						arg_112_1:RecordAudio("109101028", var_115_6)
					else
	...
	Play109101029 = function(arg_116_0, arg_116_1)
		...
		function arg_116_1.onSingleLineUpdate_(arg_119_0)
			...
			if 0 < arg_116_1.time_ and arg_116_1.time_ <= 0 + arg_119_0 then
				...
				arg_116_1.leftNameTxt_.text = arg_116_1:FormatText(StoryNameCfg[74].name)
				...
				local var_119_1 = arg_116_1:GetWordFromCfg(109101029)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101029", "story_v_out_109101.awb") ~= 0 then
					local var_119_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101029", "story_v_out_109101.awb") / 1000
					...
					if var_119_1.prefab_name ~= "" and arg_116_1.actors_[var_119_1.prefab_name] ~= nil then
						local var_119_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_116_1.actors_[var_119_1.prefab_name].transform, "story_v_out_109101", "109101029", "story_v_out_109101.awb")

						arg_116_1:RecordAudio("109101029", var_119_6)
						arg_116_1:RecordAudio("109101029", var_119_6)
					else
	...
	Play109101030 = function(arg_120_0, arg_120_1)
		...
		function arg_120_1.onSingleLineUpdate_(arg_123_0)
			...
			if 0 < arg_120_1.time_ and arg_120_1.time_ <= 0 + arg_123_0 then
				...
				arg_120_1.leftNameTxt_.text = arg_120_1:FormatText(StoryNameCfg[74].name)
				...
				local var_123_1 = arg_120_1:GetWordFromCfg(109101030)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101030", "story_v_out_109101.awb") ~= 0 then
					local var_123_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101030", "story_v_out_109101.awb") / 1000
					...
					if var_123_1.prefab_name ~= "" and arg_120_1.actors_[var_123_1.prefab_name] ~= nil then
						local var_123_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_120_1.actors_[var_123_1.prefab_name].transform, "story_v_out_109101", "109101030", "story_v_out_109101.awb")

						arg_120_1:RecordAudio("109101030", var_123_6)
						arg_120_1:RecordAudio("109101030", var_123_6)
					else
	...
	Play109101031 = function(arg_124_0, arg_124_1)
		...
		function arg_124_1.onSingleLineUpdate_(arg_127_0)
			...
			if 0 < arg_124_1.time_ and arg_124_1.time_ <= 0 + arg_127_0 then
				...
				arg_124_1.leftNameTxt_.text = arg_124_1:FormatText(StoryNameCfg[76].name)
				...
				local var_127_1 = arg_124_1:GetWordFromCfg(109101031)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101031", "story_v_out_109101.awb") ~= 0 then
					local var_127_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101031", "story_v_out_109101.awb") / 1000
					...
					if var_127_1.prefab_name ~= "" and arg_124_1.actors_[var_127_1.prefab_name] ~= nil then
						local var_127_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_124_1.actors_[var_127_1.prefab_name].transform, "story_v_out_109101", "109101031", "story_v_out_109101.awb")

						arg_124_1:RecordAudio("109101031", var_127_6)
						arg_124_1:RecordAudio("109101031", var_127_6)
					else
	...
	Play109101032 = function(arg_128_0, arg_128_1)
		...
		function arg_128_1.onSingleLineUpdate_(arg_131_0)
			...
			if 0 < arg_128_1.time_ and arg_128_1.time_ <= 0 + arg_131_0 then
				...
				arg_128_1.leftNameTxt_.text = arg_128_1:FormatText(StoryNameCfg[74].name)
				...
				local var_131_1 = arg_128_1:GetWordFromCfg(109101032)
				...
				local var_131_4 = 13 <= 0 and var_131_0 or var_131_0 * (utf8.len(var_131_2) / 13)

				if (13 <= 0 and var_131_0 or var_131_0 * (utf8.len(var_131_2) / 13)) > 0 and var_131_0 < var_131_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101032", "story_v_out_109101.awb") ~= 0 then
					local var_131_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101032", "story_v_out_109101.awb") / 1000
					...
					if var_131_1.prefab_name ~= "" and arg_128_1.actors_[var_131_1.prefab_name] ~= nil then
						local var_131_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_128_1.actors_[var_131_1.prefab_name].transform, "story_v_out_109101", "109101032", "story_v_out_109101.awb")

						arg_128_1:RecordAudio("109101032", var_131_6)
						arg_128_1:RecordAudio("109101032", var_131_6)
					else
	...
	Play109101033 = function(arg_132_0, arg_132_1)
		...
		function arg_132_1.onSingleLineUpdate_(arg_135_0)
			...
			if 0 < arg_132_1.time_ and arg_132_1.time_ <= 0 + arg_135_0 then
				...
				local var_135_1 = arg_132_1:GetWordFromCfg(109101033)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101033", "story_v_out_109101.awb") ~= 0 then
					local var_135_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101033", "story_v_out_109101.awb") / 1000
					...
					if var_135_1.prefab_name ~= "" and arg_132_1.actors_[var_135_1.prefab_name] ~= nil then
						local var_135_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_132_1.actors_[var_135_1.prefab_name].transform, "story_v_out_109101", "109101033", "story_v_out_109101.awb")

						arg_132_1:RecordAudio("109101033", var_135_6)
						arg_132_1:RecordAudio("109101033", var_135_6)
					else
	...
	Play109101034 = function(arg_136_0, arg_136_1)
		...
		function arg_136_1.onSingleLineUpdate_(arg_139_0)
			...
			if 0 < arg_136_1.time_ and arg_136_1.time_ <= 0 + arg_139_0 then
				...
				local var_139_1 = arg_136_1:FormatText(arg_136_1:GetWordFromCfg(109101034).content)

				arg_136_1.text_.text = var_139_1

				LuaForUtil.ClearLinePrefixSymbol(arg_136_1.text_)

				local var_139_3 = 3 <= 0 and var_139_0 or var_139_0 * (utf8.len(var_139_1) / 3)

				if (3 <= 0 and var_139_0 or var_139_0 * (utf8.len(var_139_1) / 3)) > 0 and var_139_0 < var_139_3 then
	...
	Play109101035 = function(arg_140_0, arg_140_1)
		...
		function arg_140_1.onSingleLineUpdate_(arg_143_0)
			...
			if 0 < arg_140_1.time_ and arg_140_1.time_ <= 0 + arg_143_0 then
				...
				arg_140_1.leftNameTxt_.text = arg_140_1:FormatText(StoryNameCfg[74].name)
				...
				local var_143_1 = arg_140_1:GetWordFromCfg(109101035)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101035", "story_v_out_109101.awb") ~= 0 then
					local var_143_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101035", "story_v_out_109101.awb") / 1000
					...
					if var_143_1.prefab_name ~= "" and arg_140_1.actors_[var_143_1.prefab_name] ~= nil then
						local var_143_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_140_1.actors_[var_143_1.prefab_name].transform, "story_v_out_109101", "109101035", "story_v_out_109101.awb")

						arg_140_1:RecordAudio("109101035", var_143_6)
						arg_140_1:RecordAudio("109101035", var_143_6)
					else
	...
	Play109101036 = function(arg_144_0, arg_144_1)
		...
		function arg_144_1.onSingleLineUpdate_(arg_147_0)
			...
			if 0 < arg_144_1.time_ and arg_144_1.time_ <= 0 + arg_147_0 then
				...
				local var_147_1 = arg_144_1:FormatText(arg_144_1:GetWordFromCfg(109101036).content)

				arg_144_1.text_.text = var_147_1

				LuaForUtil.ClearLinePrefixSymbol(arg_144_1.text_)

				local var_147_3 = 4 <= 0 and var_147_0 or var_147_0 * (utf8.len(var_147_1) / 4)

				if (4 <= 0 and var_147_0 or var_147_0 * (utf8.len(var_147_1) / 4)) > 0 and var_147_0 < var_147_3 then
	...
	Play109101037 = function(arg_148_0, arg_148_1)
		...
		function arg_148_1.onSingleLineUpdate_(arg_151_0)
			if 0 < arg_148_1.time_ and arg_148_1.time_ <= 0 + arg_151_0 then
				local var_151_0 = arg_148_1.bgs_.S0901:GetComponent("SpriteRenderer")

				if var_151_0 then
					arg_148_1.var_.alphaOldValueS0901 = var_151_0.color.a
					arg_148_1.var_.alphaMatValueS0901 = var_151_0
				end
			...
			if 0 <= arg_148_1.time_ and arg_148_1.time_ < 0 + var_151_1 then
				if arg_148_1.var_.alphaMatValueS0901 then
					arg_148_1.var_.alphaMatValueS0901.color.a = Mathf.Lerp(arg_148_1.var_.alphaOldValueS0901, 0, (arg_148_1.time_ - 0) / var_151_1)
					arg_148_1.var_.alphaMatValueS0901.color = arg_148_1.var_.alphaMatValueS0901.color
				end
			end

			if arg_148_1.time_ >= 0 + var_151_1 and arg_148_1.time_ < 0 + var_151_1 + arg_151_0 and arg_148_1.var_.alphaMatValueS0901 then
				arg_148_1.var_.alphaMatValueS0901.color.a = 0
				arg_148_1.var_.alphaMatValueS0901.color = arg_148_1.var_.alphaMatValueS0901.color
			end
			...
			local var_151_2 = 2
			local var_151_3 = 0.15

			if 2 < arg_148_1.time_ and arg_148_1.time_ <= var_151_2 + arg_151_0 then
				...
				local var_151_4 = LeanTween.value(arg_148_1.dialog_, 0, 1, 0.3)

				var_151_4:setOnUpdate(LuaHelper.FloatAction(function(arg_152_0)
					arg_148_1.dialogCg_.alpha = arg_152_0
				end))
				var_151_4:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_148_1.dialog_)
					var_151_4:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_151_5 = arg_148_1:GetWordFromCfg(109101037)
				...
				local var_151_8 = 6 <= 0 and var_151_3 or var_151_3 * (utf8.len(var_151_6) / 6)

				if (6 <= 0 and var_151_3 or var_151_3 * (utf8.len(var_151_6) / 6)) > 0 and var_151_3 < var_151_8 then
					arg_148_1.talkMaxDuration = var_151_8
					var_151_2 = var_151_2 + 0.3
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101037", "story_v_out_109101.awb") ~= 0 then
					local var_151_9 = manager.audio:GetVoiceLength("story_v_out_109101", "109101037", "story_v_out_109101.awb") / 1000
					...
					if var_151_5.prefab_name ~= "" and arg_148_1.actors_[var_151_5.prefab_name] ~= nil then
						local var_151_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_148_1.actors_[var_151_5.prefab_name].transform, "story_v_out_109101", "109101037", "story_v_out_109101.awb")

						arg_148_1:RecordAudio("109101037", var_151_10)
						arg_148_1:RecordAudio("109101037", var_151_10)
					else
			...
			local var_151_11 = var_151_2 + 0.3
			local var_151_12 = math.max(var_151_3, arg_148_1.talkMaxDuration)

			if var_151_2 + 0.3 <= arg_148_1.time_ and arg_148_1.time_ < var_151_11 + var_151_12 then
				arg_148_1.typewritter.percent = (arg_148_1.time_ - var_151_11) / var_151_12
	...
	Play109101038 = function(arg_154_0, arg_154_1)
		...
		function arg_154_1.onSingleLineUpdate_(arg_157_0)
			...
			if 0 < arg_154_1.time_ and arg_154_1.time_ <= 0 + arg_157_0 then
				...
				arg_154_1.leftNameTxt_.text = arg_154_1:FormatText(StoryNameCfg[87].name)
				...
				local var_157_1 = arg_154_1:GetWordFromCfg(109101038)
				...
				local var_157_4 = 41 <= 0 and var_157_0 or var_157_0 * (utf8.len(var_157_2) / 41)

				if (41 <= 0 and var_157_0 or var_157_0 * (utf8.len(var_157_2) / 41)) > 0 and var_157_0 < var_157_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101038", "story_v_out_109101.awb") ~= 0 then
					local var_157_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101038", "story_v_out_109101.awb") / 1000
					...
					if var_157_1.prefab_name ~= "" and arg_154_1.actors_[var_157_1.prefab_name] ~= nil then
						local var_157_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_154_1.actors_[var_157_1.prefab_name].transform, "story_v_out_109101", "109101038", "story_v_out_109101.awb")

						arg_154_1:RecordAudio("109101038", var_157_6)
						arg_154_1:RecordAudio("109101038", var_157_6)
					else
	...
	Play109101039 = function(arg_158_0, arg_158_1)
		...
		function arg_158_1.onSingleLineUpdate_(arg_161_0)
			if 0 < arg_158_1.time_ and arg_158_1.time_ <= 0 + arg_161_0 then
				local var_161_0 = arg_158_1.bgs_.S0901

				arg_158_1.bgs_.S0901.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 0 < arg_158_1.time_ and arg_158_1.time_ <= 0 + arg_161_0 then
				local var_161_3 = arg_158_1.bgs_.S0901:GetComponent("SpriteRenderer")

				if var_161_3 then
					arg_158_1.var_.alphaOldValueS0901 = var_161_3.color.a
					arg_158_1.var_.alphaMatValueS0901 = var_161_3
				end
			...
			if 0 <= arg_158_1.time_ and arg_158_1.time_ < 0 + var_161_4 then
				if arg_158_1.var_.alphaMatValueS0901 then
					arg_158_1.var_.alphaMatValueS0901.color.a = Mathf.Lerp(arg_158_1.var_.alphaOldValueS0901, 1, (arg_158_1.time_ - 0) / var_161_4)
					arg_158_1.var_.alphaMatValueS0901.color = arg_158_1.var_.alphaMatValueS0901.color
				end
			end

			if arg_158_1.time_ >= 0 + var_161_4 and arg_158_1.time_ < 0 + var_161_4 + arg_161_0 and arg_158_1.var_.alphaMatValueS0901 then
				arg_158_1.var_.alphaMatValueS0901.color.a = 1
				arg_158_1.var_.alphaMatValueS0901.color = arg_158_1.var_.alphaMatValueS0901.color
			end
			...
			local var_161_5 = 1.324999999999
			local var_161_6 = 0.175

			if 1.324999999999 < arg_158_1.time_ and arg_158_1.time_ <= var_161_5 + arg_161_0 then
				...
				local var_161_7 = LeanTween.value(arg_158_1.dialog_, 0, 1, 0.3)

				var_161_7:setOnUpdate(LuaHelper.FloatAction(function(arg_162_0)
					arg_158_1.dialogCg_.alpha = arg_162_0
				end))
				var_161_7:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_158_1.dialog_)
					var_161_7:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_161_8 = arg_158_1:GetWordFromCfg(109101039)
				...
				local var_161_11 = 7 <= 0 and var_161_6 or var_161_6 * (utf8.len(var_161_9) / 7)

				if (7 <= 0 and var_161_6 or var_161_6 * (utf8.len(var_161_9) / 7)) > 0 and var_161_6 < var_161_11 then
					arg_158_1.talkMaxDuration = var_161_11
					var_161_5 = var_161_5 + 0.3
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101039", "story_v_out_109101.awb") ~= 0 then
					local var_161_12 = manager.audio:GetVoiceLength("story_v_out_109101", "109101039", "story_v_out_109101.awb") / 1000
					...
					if var_161_8.prefab_name ~= "" and arg_158_1.actors_[var_161_8.prefab_name] ~= nil then
						local var_161_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_158_1.actors_[var_161_8.prefab_name].transform, "story_v_out_109101", "109101039", "story_v_out_109101.awb")

						arg_158_1:RecordAudio("109101039", var_161_13)
						arg_158_1:RecordAudio("109101039", var_161_13)
					else
			...
			local var_161_14 = var_161_5 + 0.3
			local var_161_15 = math.max(var_161_6, arg_158_1.talkMaxDuration)

			if var_161_5 + 0.3 <= arg_158_1.time_ and arg_158_1.time_ < var_161_14 + var_161_15 then
				arg_158_1.typewritter.percent = (arg_158_1.time_ - var_161_14) / var_161_15
	...
	Play109101040 = function(arg_164_0, arg_164_1)
		...
		function arg_164_1.onSingleLineUpdate_(arg_167_0)
			...
			if 0 < arg_164_1.time_ and arg_164_1.time_ <= 0 + arg_167_0 then
				...
				local var_167_1 = arg_164_1:FormatText(arg_164_1:GetWordFromCfg(109101040).content)
	...
	Play109101041 = function(arg_168_0, arg_168_1)
		...
		function arg_168_1.onSingleLineUpdate_(arg_171_0)
			if 0.7 < arg_168_1.time_ and arg_168_1.time_ <= 0.7 + arg_171_0 then
				arg_168_1.var_.shakeOldPos = manager.ui.mainCamera.transform.localPosition
			end

			local var_171_0 = 0.4

			if 0.7 <= arg_168_1.time_ and arg_168_1.time_ < 0.7 + var_171_0 then
				local var_171_1, var_171_2 = math.modf((arg_168_1.time_ - 0.7) / 0.099)

				manager.ui.mainCamera.transform.localPosition = Vector3.New(var_171_2 * 0.13, var_171_2 * 0.13, var_171_2 * 0.13) + arg_168_1.var_.shakeOldPos
			end

			if arg_168_1.time_ >= 0.7 + var_171_0 and arg_168_1.time_ < 0.7 + var_171_0 + arg_171_0 then
				manager.ui.mainCamera.transform.localPosition = arg_168_1.var_.shakeOldPos
			end
			...
			if 0 < arg_168_1.time_ and arg_168_1.time_ <= var_171_3 + arg_171_0 then
				...
				local var_171_5 = arg_168_1:GetWordFromCfg(109101041)
				...
				local var_171_8 = 11 <= 0 and var_171_4 or var_171_4 * (utf8.len(var_171_6) / 11)

				if (11 <= 0 and var_171_4 or var_171_4 * (utf8.len(var_171_6) / 11)) > 0 and var_171_4 < var_171_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101041", "story_v_out_109101.awb") ~= 0 then
					local var_171_9 = manager.audio:GetVoiceLength("story_v_out_109101", "109101041", "story_v_out_109101.awb") / 1000
					...
					if var_171_5.prefab_name ~= "" and arg_168_1.actors_[var_171_5.prefab_name] ~= nil then
						local var_171_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_168_1.actors_[var_171_5.prefab_name].transform, "story_v_out_109101", "109101041", "story_v_out_109101.awb")

						arg_168_1:RecordAudio("109101041", var_171_10)
						arg_168_1:RecordAudio("109101041", var_171_10)
					else
	...
	Play109101042 = function(arg_172_0, arg_172_1)
		...
		function arg_172_1.onSingleLineUpdate_(arg_175_0)
			...
			if 0 < arg_172_1.time_ and arg_172_1.time_ <= 0 + arg_175_0 then
				...
				local var_175_1 = arg_172_1:FormatText(arg_172_1:GetWordFromCfg(109101042).content)

				arg_172_1.text_.text = var_175_1

				LuaForUtil.ClearLinePrefixSymbol(arg_172_1.text_)

				local var_175_3 = 16 <= 0 and var_175_0 or var_175_0 * (utf8.len(var_175_1) / 16)

				if (16 <= 0 and var_175_0 or var_175_0 * (utf8.len(var_175_1) / 16)) > 0 and var_175_0 < var_175_3 then
	...
	Play109101043 = function(arg_176_0, arg_176_1)
		...
		function arg_176_1.onSingleLineUpdate_(arg_179_0)
			...
			if 0 < arg_176_1.time_ and arg_176_1.time_ <= 0 + arg_179_0 then
				...
				local var_179_1 = arg_176_1:FormatText(arg_176_1:GetWordFromCfg(109101043).content)

				arg_176_1.text_.text = var_179_1

				LuaForUtil.ClearLinePrefixSymbol(arg_176_1.text_)

				local var_179_3 = 68 <= 0 and var_179_0 or var_179_0 * (utf8.len(var_179_1) / 68)

				if (68 <= 0 and var_179_0 or var_179_0 * (utf8.len(var_179_1) / 68)) > 0 and var_179_0 < var_179_3 then
	...
	Play109101044 = function(arg_180_0, arg_180_1)
		...
		function arg_180_1.onSingleLineUpdate_(arg_183_0)
			...
			if 0 < arg_180_1.time_ and arg_180_1.time_ <= 0 + arg_183_0 then
				...
				local var_183_1 = arg_180_1:FormatText(arg_180_1:GetWordFromCfg(109101044).content)

				arg_180_1.text_.text = var_183_1

				LuaForUtil.ClearLinePrefixSymbol(arg_180_1.text_)

				local var_183_3 = 42 <= 0 and var_183_0 or var_183_0 * (utf8.len(var_183_1) / 42)

				if (42 <= 0 and var_183_0 or var_183_0 * (utf8.len(var_183_1) / 42)) > 0 and var_183_0 < var_183_3 then
	...
	Play109101045 = function(arg_184_0, arg_184_1)
		...
		function arg_184_1.onSingleLineUpdate_(arg_187_0)
			...
			if 0 < arg_184_1.time_ and arg_184_1.time_ <= 0 + arg_187_0 then
				...
				local var_187_1 = arg_184_1:FormatText(arg_184_1:GetWordFromCfg(109101045).content)

				arg_184_1.text_.text = var_187_1

				LuaForUtil.ClearLinePrefixSymbol(arg_184_1.text_)

				local var_187_3 = 33 <= 0 and var_187_0 or var_187_0 * (utf8.len(var_187_1) / 33)

				if (33 <= 0 and var_187_0 or var_187_0 * (utf8.len(var_187_1) / 33)) > 0 and var_187_0 < var_187_3 then
	...
	Play109101046 = function(arg_188_0, arg_188_1)
		...
		function arg_188_1.onSingleLineUpdate_(arg_191_0)
			if 0.55 < arg_188_1.time_ and arg_188_1.time_ <= 0.55 + arg_191_0 then
				local var_191_0 = arg_188_1.bgs_.S0901:GetComponent("SpriteRenderer")

				if var_191_0 then
					arg_188_1.var_.alphaOldValueS0901 = var_191_0.color.a
					arg_188_1.var_.alphaMatValueS0901 = var_191_0
				end
			...
			if 0.55 <= arg_188_1.time_ and arg_188_1.time_ < 0.55 + var_191_1 then
				if arg_188_1.var_.alphaMatValueS0901 then
					arg_188_1.var_.alphaMatValueS0901.color.a = Mathf.Lerp(arg_188_1.var_.alphaOldValueS0901, 0, (arg_188_1.time_ - 0.55) / var_191_1)
					arg_188_1.var_.alphaMatValueS0901.color = arg_188_1.var_.alphaMatValueS0901.color
				end
			end

			if arg_188_1.time_ >= 0.55 + var_191_1 and arg_188_1.time_ < 0.55 + var_191_1 + arg_191_0 and arg_188_1.var_.alphaMatValueS0901 then
				arg_188_1.var_.alphaMatValueS0901.color.a = 0
				arg_188_1.var_.alphaMatValueS0901.color = arg_188_1.var_.alphaMatValueS0901.color
			end
			...
			if 0 < arg_188_1.time_ and arg_188_1.time_ <= var_191_2 + arg_191_0 then
				...
				local var_191_4 = arg_188_1:FormatText(arg_188_1:GetWordFromCfg(109101046).content)

				arg_188_1.text_.text = var_191_4

				LuaForUtil.ClearLinePrefixSymbol(arg_188_1.text_)

				local var_191_6 = 22 <= 0 and var_191_3 or var_191_3 * (utf8.len(var_191_4) / 22)

				if (22 <= 0 and var_191_3 or var_191_3 * (utf8.len(var_191_4) / 22)) > 0 and var_191_3 < var_191_6 then
	...
	Play109101047 = function(arg_192_0, arg_192_1)
		...
		function arg_192_1.onSingleLineUpdate_(arg_195_0)
			if 0.233333333333333 < arg_192_1.time_ and arg_192_1.time_ <= 0.233333333333333 + arg_195_0 then
				arg_192_1.var_.shakeOldPos = manager.ui.mainCamera.transform.localPosition
			end

			local var_195_0 = 0.5

			if 0.233333333333333 <= arg_192_1.time_ and arg_192_1.time_ < 0.233333333333333 + var_195_0 then
				local var_195_1, var_195_2 = math.modf((arg_192_1.time_ - 0.233333333333333) / 0.099)

				manager.ui.mainCamera.transform.localPosition = Vector3.New(var_195_2 * 0.13, var_195_2 * 0.13, var_195_2 * 0.13) + arg_192_1.var_.shakeOldPos
			end

			if arg_192_1.time_ >= 0.233333333333333 + var_195_0 and arg_192_1.time_ < 0.233333333333333 + var_195_0 + arg_195_0 then
				manager.ui.mainCamera.transform.localPosition = arg_192_1.var_.shakeOldPos
			end

			if 0 < arg_192_1.time_ and arg_192_1.time_ <= 0 + arg_195_0 then
				arg_192_1:AudioAction("play", "effect", "se_story_9", "se_story_9_shoot02", "")
			end
			...
			if 0 < arg_192_1.time_ and arg_192_1.time_ <= var_195_4 + arg_195_0 then
				...
				local var_195_6 = arg_192_1:FormatText(arg_192_1:GetWordFromCfg(109101047).content)

				arg_192_1.text_.text = var_195_6

				LuaForUtil.ClearLinePrefixSymbol(arg_192_1.text_)

				local var_195_8 = 4 <= 0 and var_195_5 or var_195_5 * (utf8.len(var_195_6) / 4)

				if (4 <= 0 and var_195_5 or var_195_5 * (utf8.len(var_195_6) / 4)) > 0 and var_195_5 < var_195_8 then
	...
	Play109101048 = function(arg_196_0, arg_196_1)
		...
		function arg_196_1.onSingleLineUpdate_(arg_199_0)
			...
			if 0 < arg_196_1.time_ and arg_196_1.time_ <= 0 + arg_199_0 then
				...
				arg_196_1.leftNameTxt_.text = arg_196_1:FormatText(StoryNameCfg[74].name)
				...
				local var_199_1 = arg_196_1:GetWordFromCfg(109101048)
				...
				local var_199_4 = 4 <= 0 and var_199_0 or var_199_0 * (utf8.len(var_199_2) / 4)

				if (4 <= 0 and var_199_0 or var_199_0 * (utf8.len(var_199_2) / 4)) > 0 and var_199_0 < var_199_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101048", "story_v_out_109101.awb") ~= 0 then
					local var_199_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101048", "story_v_out_109101.awb") / 1000
					...
					if var_199_1.prefab_name ~= "" and arg_196_1.actors_[var_199_1.prefab_name] ~= nil then
						local var_199_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_196_1.actors_[var_199_1.prefab_name].transform, "story_v_out_109101", "109101048", "story_v_out_109101.awb")

						arg_196_1:RecordAudio("109101048", var_199_6)
						arg_196_1:RecordAudio("109101048", var_199_6)
					else
	...
	Play109101049 = function(arg_200_0, arg_200_1)
		...
		function arg_200_1.onSingleLineUpdate_(arg_203_0)
			...
			if 0 < arg_200_1.time_ and arg_200_1.time_ <= 0 + arg_203_0 then
				...
				local var_203_1 = arg_200_1:GetWordFromCfg(109101049)
				...
				local var_203_4 = 11 <= 0 and var_203_0 or var_203_0 * (utf8.len(var_203_2) / 11)

				if (11 <= 0 and var_203_0 or var_203_0 * (utf8.len(var_203_2) / 11)) > 0 and var_203_0 < var_203_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101049", "story_v_out_109101.awb") ~= 0 then
					local var_203_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101049", "story_v_out_109101.awb") / 1000
					...
					if var_203_1.prefab_name ~= "" and arg_200_1.actors_[var_203_1.prefab_name] ~= nil then
						local var_203_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_200_1.actors_[var_203_1.prefab_name].transform, "story_v_out_109101", "109101049", "story_v_out_109101.awb")

						arg_200_1:RecordAudio("109101049", var_203_6)
						arg_200_1:RecordAudio("109101049", var_203_6)
					else
	...
	Play109101050 = function(arg_204_0, arg_204_1)
		...
		function arg_204_1.onSingleLineUpdate_(arg_207_0)
			...
			if 0 < arg_204_1.time_ and arg_204_1.time_ <= 0 + arg_207_0 then
				...
				local var_207_1 = arg_204_1:FormatText(arg_204_1:GetWordFromCfg(109101050).content)

				arg_204_1.text_.text = var_207_1

				LuaForUtil.ClearLinePrefixSymbol(arg_204_1.text_)

				local var_207_3 = 9 <= 0 and var_207_0 or var_207_0 * (utf8.len(var_207_1) / 9)

				if (9 <= 0 and var_207_0 or var_207_0 * (utf8.len(var_207_1) / 9)) > 0 and var_207_0 < var_207_3 then
	...
	Play109101051 = function(arg_208_0, arg_208_1)
		...
		function arg_208_1.onSingleLineUpdate_(arg_211_0)
			...
			if 0 < arg_208_1.time_ and arg_208_1.time_ <= 0 + arg_211_0 then
				...
				local var_211_1 = arg_208_1:FormatText(arg_208_1:GetWordFromCfg(109101051).content)

				arg_208_1.text_.text = var_211_1

				LuaForUtil.ClearLinePrefixSymbol(arg_208_1.text_)

				local var_211_3 = 38 <= 0 and var_211_0 or var_211_0 * (utf8.len(var_211_1) / 38)

				if (38 <= 0 and var_211_0 or var_211_0 * (utf8.len(var_211_1) / 38)) > 0 and var_211_0 < var_211_3 then
	...
	Play109101052 = function(arg_212_0, arg_212_1)
		...
		function arg_212_1.onSingleLineUpdate_(arg_215_0)
			if 0 < arg_212_1.time_ and arg_212_1.time_ <= 0 + arg_215_0 then
				local var_215_0 = arg_212_1.bgs_.S0901

				arg_212_1.bgs_.S0901.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
				var_215_0.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_215_1 = var_215_0:GetComponent("SpriteRenderer")

				if var_215_1 and var_215_1.sprite then
					local var_215_2 = 2 * (var_215_0.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_215_0.transform.localScale = Vector3.New(var_215_2 / var_215_1.sprite.bounds.size.y < var_215_2 * manager.ui.mainCameraCom_.aspect / var_215_1.sprite.bounds.size.x and var_215_2 * manager.ui.mainCameraCom_.aspect / var_215_1.sprite.bounds.size.x or var_215_2 / var_215_1.sprite.bounds.size.y, var_215_2 / var_215_1.sprite.bounds.size.y < var_215_2 * manager.ui.mainCameraCom_.aspect / var_215_1.sprite.bounds.size.x and var_215_2 * manager.ui.mainCameraCom_.aspect / var_215_1.sprite.bounds.size.x or var_215_2 / var_215_1.sprite.bounds.size.y, 0)
				end
			...
			if 0 < arg_212_1.time_ and arg_212_1.time_ <= 0 + arg_215_0 then
				local var_215_3 = arg_212_1.bgs_.S0901:GetComponent("SpriteRenderer")

				if var_215_3 then
					arg_212_1.var_.alphaOldValueS0901 = var_215_3.color.a
					arg_212_1.var_.alphaMatValueS0901 = var_215_3
				end
			...
			if 0 <= arg_212_1.time_ and arg_212_1.time_ < 0 + var_215_4 then
				if arg_212_1.var_.alphaMatValueS0901 then
					arg_212_1.var_.alphaMatValueS0901.color.a = Mathf.Lerp(arg_212_1.var_.alphaOldValueS0901, 1, (arg_212_1.time_ - 0) / var_215_4)
					arg_212_1.var_.alphaMatValueS0901.color = arg_212_1.var_.alphaMatValueS0901.color
				end
			end

			if arg_212_1.time_ >= 0 + var_215_4 and arg_212_1.time_ < 0 + var_215_4 + arg_215_0 and arg_212_1.var_.alphaMatValueS0901 then
				arg_212_1.var_.alphaMatValueS0901.color.a = 1
				arg_212_1.var_.alphaMatValueS0901.color = arg_212_1.var_.alphaMatValueS0901.color
			end
			...
			if arg_212_1.time_ >= var_215_5 + 2 and arg_212_1.time_ < var_215_5 + 2 + arg_215_0 then
			...
			if 2 < arg_212_1.time_ and arg_212_1.time_ <= var_215_6 + arg_215_0 then
				...
				local var_215_8 = LeanTween.value(arg_212_1.dialog_, 0, 1, 0.3)

				var_215_8:setOnUpdate(LuaHelper.FloatAction(function(arg_216_0)
					arg_212_1.dialogCg_.alpha = arg_216_0
				end))
				var_215_8:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_212_1.dialog_)
					var_215_8:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_215_9 = arg_212_1:FormatText(arg_212_1:GetWordFromCfg(109101052).content)

				arg_212_1.text_.text = var_215_9

				LuaForUtil.ClearLinePrefixSymbol(arg_212_1.text_)

				local var_215_11 = 48 <= 0 and var_215_7 or var_215_7 * (utf8.len(var_215_9) / 48)

				if (48 <= 0 and var_215_7 or var_215_7 * (utf8.len(var_215_9) / 48)) > 0 and var_215_7 < var_215_11 then
					arg_212_1.talkMaxDuration = var_215_11
					var_215_6 = var_215_6 + 0.3
			...
			local var_215_12 = var_215_6 + 0.3
			local var_215_13 = math.max(var_215_7, arg_212_1.talkMaxDuration)

			if var_215_6 + 0.3 <= arg_212_1.time_ and arg_212_1.time_ < var_215_12 + var_215_13 then
				arg_212_1.typewritter.percent = (arg_212_1.time_ - var_215_12) / var_215_13
	...
	Play109101053 = function(arg_218_0, arg_218_1)
		...
		function arg_218_1.onSingleLineUpdate_(arg_221_0)
			...
			if 0 < arg_218_1.time_ and arg_218_1.time_ <= 0 + arg_221_0 then
				...
				local var_221_1 = arg_218_1:FormatText(arg_218_1:GetWordFromCfg(109101053).content)

				arg_218_1.text_.text = var_221_1

				LuaForUtil.ClearLinePrefixSymbol(arg_218_1.text_)

				local var_221_3 = 25 <= 0 and var_221_0 or var_221_0 * (utf8.len(var_221_1) / 25)

				if (25 <= 0 and var_221_0 or var_221_0 * (utf8.len(var_221_1) / 25)) > 0 and var_221_0 < var_221_3 then
	...
	Play109101054 = function(arg_222_0, arg_222_1)
		...
		function arg_222_1.onSingleLineUpdate_(arg_225_0)
			...
			if 0 < arg_222_1.time_ and arg_222_1.time_ <= 0 + arg_225_0 then
				...
				local var_225_1 = arg_222_1:FormatText(arg_222_1:GetWordFromCfg(109101054).content)

				arg_222_1.text_.text = var_225_1

				LuaForUtil.ClearLinePrefixSymbol(arg_222_1.text_)

				local var_225_3 = 37 <= 0 and var_225_0 or var_225_0 * (utf8.len(var_225_1) / 37)

				if (37 <= 0 and var_225_0 or var_225_0 * (utf8.len(var_225_1) / 37)) > 0 and var_225_0 < var_225_3 then
	...
	Play109101055 = function(arg_226_0, arg_226_1)
		...
		function arg_226_1.onSingleLineUpdate_(arg_229_0)
			...
			if 0 < arg_226_1.time_ and arg_226_1.time_ <= 0 + arg_229_0 then
				...
				local var_229_1 = arg_226_1:FormatText(arg_226_1:GetWordFromCfg(109101055).content)

				arg_226_1.text_.text = var_229_1

				LuaForUtil.ClearLinePrefixSymbol(arg_226_1.text_)

				local var_229_3 = 32 <= 0 and var_229_0 or var_229_0 * (utf8.len(var_229_1) / 32)

				if (32 <= 0 and var_229_0 or var_229_0 * (utf8.len(var_229_1) / 32)) > 0 and var_229_0 < var_229_3 then
	...
	Play109101056 = function(arg_230_0, arg_230_1)
		...
		function arg_230_1.onSingleLineUpdate_(arg_233_0)
			...
			if 0 < arg_230_1.time_ and arg_230_1.time_ <= 0 + arg_233_0 then
				...
				local var_233_1 = arg_230_1:FormatText(arg_230_1:GetWordFromCfg(109101056).content)

				arg_230_1.text_.text = var_233_1

				LuaForUtil.ClearLinePrefixSymbol(arg_230_1.text_)

				local var_233_3 = 32 <= 0 and var_233_0 or var_233_0 * (utf8.len(var_233_1) / 32)

				if (32 <= 0 and var_233_0 or var_233_0 * (utf8.len(var_233_1) / 32)) > 0 and var_233_0 < var_233_3 then
	...
	Play109101057 = function(arg_234_0, arg_234_1)
		...
		function arg_234_1.onSingleLineUpdate_(arg_237_0)
			...
			if 0 < arg_234_1.time_ and arg_234_1.time_ <= 0 + arg_237_0 then
				...
				local var_237_1 = arg_234_1:GetWordFromCfg(109101057)
				...
				local var_237_4 = 19 <= 0 and var_237_0 or var_237_0 * (utf8.len(var_237_2) / 19)

				if (19 <= 0 and var_237_0 or var_237_0 * (utf8.len(var_237_2) / 19)) > 0 and var_237_0 < var_237_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101057", "story_v_out_109101.awb") ~= 0 then
					local var_237_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101057", "story_v_out_109101.awb") / 1000
					...
					if var_237_1.prefab_name ~= "" and arg_234_1.actors_[var_237_1.prefab_name] ~= nil then
						local var_237_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_234_1.actors_[var_237_1.prefab_name].transform, "story_v_out_109101", "109101057", "story_v_out_109101.awb")

						arg_234_1:RecordAudio("109101057", var_237_6)
						arg_234_1:RecordAudio("109101057", var_237_6)
					else
	...
	Play109101058 = function(arg_238_0, arg_238_1)
		...
		function arg_238_1.onSingleLineUpdate_(arg_241_0)
			if arg_238_1.bgs_.S0906 == nil then
				local var_241_0 = Object.Instantiate(arg_238_1.paintGo_)

				var_241_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "S0906")
				var_241_0.name = "S0906"
				var_241_0.transform.parent = arg_238_1.stage_.transform
				var_241_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_238_1.bgs_.S0906 = var_241_0
			end

			if 2 < arg_238_1.time_ and arg_238_1.time_ <= 2 + arg_241_0 then
				local var_241_1 = arg_238_1.bgs_.S0906

				arg_238_1.bgs_.S0906.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_241_12 = arg_238_1.bgs_.S0906.transform

			if 2 < arg_238_1.time_ and arg_238_1.time_ <= 2 + arg_241_0 then
				arg_238_1.var_.moveOldPosS0906 = var_241_12.localPosition
			end

			local var_241_13 = 0.001

			if 2 <= arg_238_1.time_ and arg_238_1.time_ < 2 + var_241_13 then
				var_241_12.localPosition = Vector3.Lerp(arg_238_1.var_.moveOldPosS0906, Vector3.New(0, 1, 9), (arg_238_1.time_ - 2) / var_241_13)
			end

			if arg_238_1.time_ >= 2 + var_241_13 and arg_238_1.time_ < 2 + var_241_13 + arg_241_0 then
				var_241_12.localPosition = Vector3.New(0, 1, 9)
			end

			local var_241_14 = arg_238_1.bgs_.S0906.transform

			if 2.034 < arg_238_1.time_ and arg_238_1.time_ <= 2.034 + arg_241_0 then
				arg_238_1.var_.moveOldPosS0906 = var_241_14.localPosition
			end

			local var_241_15 = 3.041

			if 2.034 <= arg_238_1.time_ and arg_238_1.time_ < 2.034 + var_241_15 then
				var_241_14.localPosition = Vector3.Lerp(arg_238_1.var_.moveOldPosS0906, Vector3.New(0, 1, 10), (arg_238_1.time_ - 2.034) / var_241_15)
			end

			if arg_238_1.time_ >= 2.034 + var_241_15 and arg_238_1.time_ < 2.034 + var_241_15 + arg_241_0 then
				var_241_14.localPosition = Vector3.New(0, 1, 10)
			end
			...
			local var_241_16 = 4
			local var_241_17 = 1.075

			if 4 < arg_238_1.time_ and arg_238_1.time_ <= var_241_16 + arg_241_0 then
				...
				local var_241_18 = LeanTween.value(arg_238_1.dialog_, 0, 1, 0.3)

				var_241_18:setOnUpdate(LuaHelper.FloatAction(function(arg_242_0)
					arg_238_1.dialogCg_.alpha = arg_242_0
				end))
				var_241_18:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_238_1.dialog_)
					var_241_18:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				arg_238_1.leftNameTxt_.text = arg_238_1:FormatText(StoryNameCfg[84].name)
				...
				local var_241_19 = arg_238_1:GetWordFromCfg(109101058)
				...
				local var_241_22 = 43 <= 0 and var_241_17 or var_241_17 * (utf8.len(var_241_20) / 43)

				if (43 <= 0 and var_241_17 or var_241_17 * (utf8.len(var_241_20) / 43)) > 0 and var_241_17 < var_241_22 then
					arg_238_1.talkMaxDuration = var_241_22
					var_241_16 = var_241_16 + 0.3

					if var_241_22 + var_241_16 > arg_238_1.duration_ then
						arg_238_1.duration_ = var_241_22 + var_241_16
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101058", "story_v_out_109101.awb") ~= 0 then
					local var_241_23 = manager.audio:GetVoiceLength("story_v_out_109101", "109101058", "story_v_out_109101.awb") / 1000
					...
					if var_241_19.prefab_name ~= "" and arg_238_1.actors_[var_241_19.prefab_name] ~= nil then
						local var_241_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_238_1.actors_[var_241_19.prefab_name].transform, "story_v_out_109101", "109101058", "story_v_out_109101.awb")

						arg_238_1:RecordAudio("109101058", var_241_24)
						arg_238_1:RecordAudio("109101058", var_241_24)
					else
			...
			local var_241_25 = var_241_16 + 0.3
			local var_241_26 = math.max(var_241_17, arg_238_1.talkMaxDuration)

			if var_241_16 + 0.3 <= arg_238_1.time_ and arg_238_1.time_ < var_241_25 + var_241_26 then
				arg_238_1.typewritter.percent = (arg_238_1.time_ - var_241_25) / var_241_26

				arg_238_1.typewritter:SetDirty()
			end

			if arg_238_1.time_ >= var_241_25 + var_241_26 and arg_238_1.time_ < var_241_25 + var_241_26 + arg_241_0 then
	...
	Play109101059 = function(arg_244_0, arg_244_1)
		...
		function arg_244_1.onSingleLineUpdate_(arg_247_0)
			...
			if 0 < arg_244_1.time_ and arg_244_1.time_ <= 0 + arg_247_0 then
				...
				arg_244_1.leftNameTxt_.text = arg_244_1:FormatText(StoryNameCfg[74].name)
				...
				local var_247_1 = arg_244_1:GetWordFromCfg(109101059)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101059", "story_v_out_109101.awb") ~= 0 then
					local var_247_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101059", "story_v_out_109101.awb") / 1000
					...
					if var_247_1.prefab_name ~= "" and arg_244_1.actors_[var_247_1.prefab_name] ~= nil then
						local var_247_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_244_1.actors_[var_247_1.prefab_name].transform, "story_v_out_109101", "109101059", "story_v_out_109101.awb")

						arg_244_1:RecordAudio("109101059", var_247_6)
						arg_244_1:RecordAudio("109101059", var_247_6)
					else
	...
	Play109101060 = function(arg_248_0, arg_248_1)
		...
		function arg_248_1.onSingleLineUpdate_(arg_251_0)
			...
			if 0 < arg_248_1.time_ and arg_248_1.time_ <= 0 + arg_251_0 then
				...
				arg_248_1.leftNameTxt_.text = arg_248_1:FormatText(StoryNameCfg[84].name)
				...
				local var_251_1 = arg_248_1:GetWordFromCfg(109101060)
				...
				local var_251_4 = 54 <= 0 and var_251_0 or var_251_0 * (utf8.len(var_251_2) / 54)

				if (54 <= 0 and var_251_0 or var_251_0 * (utf8.len(var_251_2) / 54)) > 0 and var_251_0 < var_251_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101060", "story_v_out_109101.awb") ~= 0 then
					local var_251_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101060", "story_v_out_109101.awb") / 1000
					...
					if var_251_1.prefab_name ~= "" and arg_248_1.actors_[var_251_1.prefab_name] ~= nil then
						local var_251_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_248_1.actors_[var_251_1.prefab_name].transform, "story_v_out_109101", "109101060", "story_v_out_109101.awb")

						arg_248_1:RecordAudio("109101060", var_251_6)
						arg_248_1:RecordAudio("109101060", var_251_6)
					else
	...
	Play109101061 = function(arg_252_0, arg_252_1)
		...
		function arg_252_1.onSingleLineUpdate_(arg_255_0)
			...
			if 0 < arg_252_1.time_ and arg_252_1.time_ <= 0 + arg_255_0 then
				...
				local var_255_1 = arg_252_1:GetWordFromCfg(109101061)
				...
				local var_255_4 = 13 <= 0 and var_255_0 or var_255_0 * (utf8.len(var_255_2) / 13)

				if (13 <= 0 and var_255_0 or var_255_0 * (utf8.len(var_255_2) / 13)) > 0 and var_255_0 < var_255_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101061", "story_v_out_109101.awb") ~= 0 then
					local var_255_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101061", "story_v_out_109101.awb") / 1000
					...
					if var_255_1.prefab_name ~= "" and arg_252_1.actors_[var_255_1.prefab_name] ~= nil then
						local var_255_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_252_1.actors_[var_255_1.prefab_name].transform, "story_v_out_109101", "109101061", "story_v_out_109101.awb")

						arg_252_1:RecordAudio("109101061", var_255_6)
						arg_252_1:RecordAudio("109101061", var_255_6)
					else
	...
	Play109101062 = function(arg_256_0, arg_256_1)
		...
		function arg_256_1.onSingleLineUpdate_(arg_259_0)
			...
			if 0 < arg_256_1.time_ and arg_256_1.time_ <= 0 + arg_259_0 then
				...
				arg_256_1.leftNameTxt_.text = arg_256_1:FormatText(StoryNameCfg[84].name)
				...
				local var_259_1 = arg_256_1:GetWordFromCfg(109101062)
				...
				local var_259_4 = 63 <= 0 and var_259_0 or var_259_0 * (utf8.len(var_259_2) / 63)

				if (63 <= 0 and var_259_0 or var_259_0 * (utf8.len(var_259_2) / 63)) > 0 and var_259_0 < var_259_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101062", "story_v_out_109101.awb") ~= 0 then
					local var_259_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101062", "story_v_out_109101.awb") / 1000
					...
					if var_259_1.prefab_name ~= "" and arg_256_1.actors_[var_259_1.prefab_name] ~= nil then
						local var_259_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_256_1.actors_[var_259_1.prefab_name].transform, "story_v_out_109101", "109101062", "story_v_out_109101.awb")

						arg_256_1:RecordAudio("109101062", var_259_6)
						arg_256_1:RecordAudio("109101062", var_259_6)
					else
	...
	Play109101063 = function(arg_260_0, arg_260_1)
		...
		function arg_260_1.onSingleLineUpdate_(arg_263_0)
			...
			if 0 < arg_260_1.time_ and arg_260_1.time_ <= 0 + arg_263_0 then
				...
				arg_260_1.leftNameTxt_.text = arg_260_1:FormatText(StoryNameCfg[84].name)
				...
				local var_263_1 = arg_260_1:GetWordFromCfg(109101063)
				...
				local var_263_4 = 33 <= 0 and var_263_0 or var_263_0 * (utf8.len(var_263_2) / 33)

				if (33 <= 0 and var_263_0 or var_263_0 * (utf8.len(var_263_2) / 33)) > 0 and var_263_0 < var_263_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101063", "story_v_out_109101.awb") ~= 0 then
					local var_263_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101063", "story_v_out_109101.awb") / 1000
					...
					if var_263_1.prefab_name ~= "" and arg_260_1.actors_[var_263_1.prefab_name] ~= nil then
						local var_263_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_260_1.actors_[var_263_1.prefab_name].transform, "story_v_out_109101", "109101063", "story_v_out_109101.awb")

						arg_260_1:RecordAudio("109101063", var_263_6)
						arg_260_1:RecordAudio("109101063", var_263_6)
					else
	...
	Play109101064 = function(arg_264_0, arg_264_1)
		...
		function arg_264_1.onSingleLineUpdate_(arg_267_0)
			...
			if 0 < arg_264_1.time_ and arg_264_1.time_ <= 0 + arg_267_0 then
				...
				arg_264_1.leftNameTxt_.text = arg_264_1:FormatText(StoryNameCfg[84].name)
				...
				local var_267_1 = arg_264_1:GetWordFromCfg(109101064)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101064", "story_v_out_109101.awb") ~= 0 then
					local var_267_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101064", "story_v_out_109101.awb") / 1000
					...
					if var_267_1.prefab_name ~= "" and arg_264_1.actors_[var_267_1.prefab_name] ~= nil then
						local var_267_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_264_1.actors_[var_267_1.prefab_name].transform, "story_v_out_109101", "109101064", "story_v_out_109101.awb")

						arg_264_1:RecordAudio("109101064", var_267_6)
						arg_264_1:RecordAudio("109101064", var_267_6)
					else
	...
	Play109101065 = function(arg_268_0, arg_268_1)
		...
		function arg_268_1.onSingleLineUpdate_(arg_271_0)
			...
			if 0 < arg_268_1.time_ and arg_268_1.time_ <= 0 + arg_271_0 then
				...
				arg_268_1.leftNameTxt_.text = arg_268_1:FormatText(StoryNameCfg[74].name)
				...
				local var_271_1 = arg_268_1:GetWordFromCfg(109101065)
				...
				local var_271_4 = 4 <= 0 and var_271_0 or var_271_0 * (utf8.len(var_271_2) / 4)

				if (4 <= 0 and var_271_0 or var_271_0 * (utf8.len(var_271_2) / 4)) > 0 and var_271_0 < var_271_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101065", "story_v_out_109101.awb") ~= 0 then
					local var_271_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101065", "story_v_out_109101.awb") / 1000
					...
					if var_271_1.prefab_name ~= "" and arg_268_1.actors_[var_271_1.prefab_name] ~= nil then
						local var_271_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_268_1.actors_[var_271_1.prefab_name].transform, "story_v_out_109101", "109101065", "story_v_out_109101.awb")

						arg_268_1:RecordAudio("109101065", var_271_6)
						arg_268_1:RecordAudio("109101065", var_271_6)
					else
	...
	Play109101066 = function(arg_272_0, arg_272_1)
		...
		function arg_272_1.onSingleLineUpdate_(arg_275_0)
			...
			if 0 < arg_272_1.time_ and arg_272_1.time_ <= 0 + arg_275_0 then
				...
				local var_275_1 = arg_272_1:GetWordFromCfg(109101066)
				...
				local var_275_4 = 9 <= 0 and var_275_0 or var_275_0 * (utf8.len(var_275_2) / 9)

				if (9 <= 0 and var_275_0 or var_275_0 * (utf8.len(var_275_2) / 9)) > 0 and var_275_0 < var_275_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101066", "story_v_out_109101.awb") ~= 0 then
					local var_275_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101066", "story_v_out_109101.awb") / 1000
					...
					if var_275_1.prefab_name ~= "" and arg_272_1.actors_[var_275_1.prefab_name] ~= nil then
						local var_275_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_272_1.actors_[var_275_1.prefab_name].transform, "story_v_out_109101", "109101066", "story_v_out_109101.awb")

						arg_272_1:RecordAudio("109101066", var_275_6)
						arg_272_1:RecordAudio("109101066", var_275_6)
					else
	...
	Play109101067 = function(arg_276_0, arg_276_1)
		...
		function arg_276_1.onSingleLineUpdate_(arg_279_0)
			...
			if 0 < arg_276_1.time_ and arg_276_1.time_ <= 0 + arg_279_0 then
				...
				arg_276_1.leftNameTxt_.text = arg_276_1:FormatText(StoryNameCfg[84].name)
				...
				local var_279_1 = arg_276_1:GetWordFromCfg(109101067)
				...
				local var_279_4 = 18 <= 0 and var_279_0 or var_279_0 * (utf8.len(var_279_2) / 18)

				if (18 <= 0 and var_279_0 or var_279_0 * (utf8.len(var_279_2) / 18)) > 0 and var_279_0 < var_279_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101067", "story_v_out_109101.awb") ~= 0 then
					local var_279_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101067", "story_v_out_109101.awb") / 1000
					...
					if var_279_1.prefab_name ~= "" and arg_276_1.actors_[var_279_1.prefab_name] ~= nil then
						local var_279_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_276_1.actors_[var_279_1.prefab_name].transform, "story_v_out_109101", "109101067", "story_v_out_109101.awb")

						arg_276_1:RecordAudio("109101067", var_279_6)
						arg_276_1:RecordAudio("109101067", var_279_6)
					else
	...
	Play109101068 = function(arg_280_0, arg_280_1)
		...
		function arg_280_1.onSingleLineUpdate_(arg_283_0)
			if 0 < arg_280_1.time_ and arg_280_1.time_ <= 0 + arg_283_0 and not isNil(arg_280_1.actors_["1099ui_story"]) and arg_280_1.var_.characterEffect1099ui_story == nil then
				arg_280_1.var_.characterEffect1099ui_story = arg_280_1.actors_["1099ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_283_0 = 0.2

			if 0 <= arg_280_1.time_ and arg_280_1.time_ < 0 + var_283_0 and not isNil(arg_280_1.actors_["1099ui_story"]) then
				if arg_280_1.var_.characterEffect1099ui_story and not isNil(arg_280_1.actors_["1099ui_story"]) then
					arg_280_1.var_.characterEffect1099ui_story.fillFlat = true
					arg_280_1.var_.characterEffect1099ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_280_1.time_ - 0) / var_283_0)
				end
			end

			if arg_280_1.time_ >= 0 + var_283_0 and arg_280_1.time_ < 0 + var_283_0 + arg_283_0 and not isNil(arg_280_1.actors_["1099ui_story"]) and arg_280_1.var_.characterEffect1099ui_story then
				arg_280_1.var_.characterEffect1099ui_story.fillFlat = true
				arg_280_1.var_.characterEffect1099ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_280_1.time_ and arg_280_1.time_ <= var_283_1 + arg_283_0 then
				...
				arg_280_1.leftNameTxt_.text = arg_280_1:FormatText(StoryNameCfg[74].name)
				...
				local var_283_3 = arg_280_1:GetWordFromCfg(109101068)
				...
				local var_283_6 = 4 <= 0 and var_283_2 or var_283_2 * (utf8.len(var_283_4) / 4)

				if (4 <= 0 and var_283_2 or var_283_2 * (utf8.len(var_283_4) / 4)) > 0 and var_283_2 < var_283_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101068", "story_v_out_109101.awb") ~= 0 then
					local var_283_7 = manager.audio:GetVoiceLength("story_v_out_109101", "109101068", "story_v_out_109101.awb") / 1000
					...
					if var_283_3.prefab_name ~= "" and arg_280_1.actors_[var_283_3.prefab_name] ~= nil then
						local var_283_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_280_1.actors_[var_283_3.prefab_name].transform, "story_v_out_109101", "109101068", "story_v_out_109101.awb")

						arg_280_1:RecordAudio("109101068", var_283_8)
						arg_280_1:RecordAudio("109101068", var_283_8)
					else
	...
	Play109101069 = function(arg_284_0, arg_284_1)
		...
		function arg_284_1.onSingleLineUpdate_(arg_287_0)
			...
			if 0 < arg_284_1.time_ and arg_284_1.time_ <= 0 + arg_287_0 then
				...
				arg_284_1.leftNameTxt_.text = arg_284_1:FormatText(StoryNameCfg[84].name)
				...
				local var_287_1 = arg_284_1:GetWordFromCfg(109101069)
				...
				local var_287_4 = 21 <= 0 and var_287_0 or var_287_0 * (utf8.len(var_287_2) / 21)

				if (21 <= 0 and var_287_0 or var_287_0 * (utf8.len(var_287_2) / 21)) > 0 and var_287_0 < var_287_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101069", "story_v_out_109101.awb") ~= 0 then
					local var_287_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101069", "story_v_out_109101.awb") / 1000
					...
					if var_287_1.prefab_name ~= "" and arg_284_1.actors_[var_287_1.prefab_name] ~= nil then
						local var_287_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_284_1.actors_[var_287_1.prefab_name].transform, "story_v_out_109101", "109101069", "story_v_out_109101.awb")

						arg_284_1:RecordAudio("109101069", var_287_6)
						arg_284_1:RecordAudio("109101069", var_287_6)
					else
	...
	Play109101070 = function(arg_288_0, arg_288_1)
		...
		function arg_288_1.onSingleLineUpdate_(arg_291_0)
			...
			if 0 < arg_288_1.time_ and arg_288_1.time_ <= 0 + arg_291_0 then
				...
				arg_288_1.leftNameTxt_.text = arg_288_1:FormatText(StoryNameCfg[84].name)
				...
				local var_291_1 = arg_288_1:GetWordFromCfg(109101070)
				...
				local var_291_4 = 49 <= 0 and var_291_0 or var_291_0 * (utf8.len(var_291_2) / 49)

				if (49 <= 0 and var_291_0 or var_291_0 * (utf8.len(var_291_2) / 49)) > 0 and var_291_0 < var_291_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101070", "story_v_out_109101.awb") ~= 0 then
					local var_291_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101070", "story_v_out_109101.awb") / 1000
					...
					if var_291_1.prefab_name ~= "" and arg_288_1.actors_[var_291_1.prefab_name] ~= nil then
						local var_291_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_288_1.actors_[var_291_1.prefab_name].transform, "story_v_out_109101", "109101070", "story_v_out_109101.awb")

						arg_288_1:RecordAudio("109101070", var_291_6)
						arg_288_1:RecordAudio("109101070", var_291_6)
					else
	...
	Play109101071 = function(arg_292_0, arg_292_1)
		...
		function arg_292_1.onSingleLineUpdate_(arg_295_0)
			if 0 < arg_292_1.time_ and arg_292_1.time_ <= 0 + arg_295_0 and not isNil(arg_292_1.actors_["1099ui_story"]) and arg_292_1.var_.characterEffect1099ui_story == nil then
				arg_292_1.var_.characterEffect1099ui_story = arg_292_1.actors_["1099ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_295_0 = 0.2

			if 0 <= arg_292_1.time_ and arg_292_1.time_ < 0 + var_295_0 and not isNil(arg_292_1.actors_["1099ui_story"]) then
				if arg_292_1.var_.characterEffect1099ui_story and not isNil(arg_292_1.actors_["1099ui_story"]) then
					arg_292_1.var_.characterEffect1099ui_story.fillFlat = true
					arg_292_1.var_.characterEffect1099ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_292_1.time_ - 0) / var_295_0)
				end
			end

			if arg_292_1.time_ >= 0 + var_295_0 and arg_292_1.time_ < 0 + var_295_0 + arg_295_0 and not isNil(arg_292_1.actors_["1099ui_story"]) and arg_292_1.var_.characterEffect1099ui_story then
				arg_292_1.var_.characterEffect1099ui_story.fillFlat = true
				arg_292_1.var_.characterEffect1099ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_292_1.time_ and arg_292_1.time_ <= var_295_1 + arg_295_0 then
				...
				arg_292_1.leftNameTxt_.text = arg_292_1:FormatText(StoryNameCfg[74].name)
				...
				local var_295_3 = arg_292_1:GetWordFromCfg(109101071)
				...
				local var_295_6 = 15 <= 0 and var_295_2 or var_295_2 * (utf8.len(var_295_4) / 15)

				if (15 <= 0 and var_295_2 or var_295_2 * (utf8.len(var_295_4) / 15)) > 0 and var_295_2 < var_295_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101071", "story_v_out_109101.awb") ~= 0 then
					local var_295_7 = manager.audio:GetVoiceLength("story_v_out_109101", "109101071", "story_v_out_109101.awb") / 1000
					...
					if var_295_3.prefab_name ~= "" and arg_292_1.actors_[var_295_3.prefab_name] ~= nil then
						local var_295_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_292_1.actors_[var_295_3.prefab_name].transform, "story_v_out_109101", "109101071", "story_v_out_109101.awb")

						arg_292_1:RecordAudio("109101071", var_295_8)
						arg_292_1:RecordAudio("109101071", var_295_8)
					else
	...
	Play109101072 = function(arg_296_0, arg_296_1)
		...
		function arg_296_1.onSingleLineUpdate_(arg_299_0)
			if 4 < arg_296_1.time_ and arg_296_1.time_ <= 4 + arg_299_0 then
				arg_296_1.var_.moveOldPos1050ui_story = arg_296_1.actors_["1050ui_story"].transform.localPosition
			end

			local var_299_0 = 0.001

			if 4 <= arg_296_1.time_ and arg_296_1.time_ < 4 + var_299_0 then
				arg_296_1.actors_["1050ui_story"].transform.localPosition = Vector3.Lerp(arg_296_1.var_.moveOldPos1050ui_story, Vector3.New(0, 100, 0), (arg_296_1.time_ - 4) / var_299_0)
				arg_296_1.actors_["1050ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_296_1.actors_["1050ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_296_1.actors_["1050ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_296_1.actors_["1050ui_story"].transform.position).z)
				arg_296_1.actors_["1050ui_story"].transform.localEulerAngles.z = 0
				arg_296_1.actors_["1050ui_story"].transform.localEulerAngles.x = 0
				arg_296_1.actors_["1050ui_story"].transform.localEulerAngles = arg_296_1.actors_["1050ui_story"].transform.localEulerAngles
			end

			if arg_296_1.time_ >= 4 + var_299_0 and arg_296_1.time_ < 4 + var_299_0 + arg_299_0 then
				arg_296_1.actors_["1050ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_296_1.actors_["1050ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_296_1.actors_["1050ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_296_1.actors_["1050ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_296_1.actors_["1050ui_story"].transform.position).z)
				arg_296_1.actors_["1050ui_story"].transform.localEulerAngles.z = 0
				arg_296_1.actors_["1050ui_story"].transform.localEulerAngles.x = 0
				arg_296_1.actors_["1050ui_story"].transform.localEulerAngles = arg_296_1.actors_["1050ui_story"].transform.localEulerAngles
			...
			local var_299_1 = arg_296_1.actors_["1099ui_story"].transform

			if 4 < arg_296_1.time_ and arg_296_1.time_ <= 4 + arg_299_0 then
				arg_296_1.var_.moveOldPos1099ui_story = var_299_1.localPosition
			end

			local var_299_2 = 0.001

			if 4 <= arg_296_1.time_ and arg_296_1.time_ < 4 + var_299_2 then
				var_299_1.localPosition = Vector3.Lerp(arg_296_1.var_.moveOldPos1099ui_story, Vector3.New(0, 100, 0), (arg_296_1.time_ - 4) / var_299_2)
			...
			if arg_296_1.time_ >= 4 + var_299_2 and arg_296_1.time_ < 4 + var_299_2 + arg_299_0 then
			...
			if 2 < arg_296_1.time_ and arg_296_1.time_ <= 2 + arg_299_0 then
				local var_299_3 = arg_296_1.bgs_.C07_1

				arg_296_1.bgs_.C07_1.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
				...
				if var_299_4 and var_299_4.sprite then
					local var_299_5 = 2 * (var_299_3.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_299_3.transform.localScale = Vector3.New(var_299_5 / var_299_4.sprite.bounds.size.y < var_299_5 * manager.ui.mainCameraCom_.aspect / var_299_4.sprite.bounds.size.x and var_299_5 * manager.ui.mainCameraCom_.aspect / var_299_4.sprite.bounds.size.x or var_299_5 / var_299_4.sprite.bounds.size.y, var_299_5 / var_299_4.sprite.bounds.size.y < var_299_5 * manager.ui.mainCameraCom_.aspect / var_299_4.sprite.bounds.size.x and var_299_5 * manager.ui.mainCameraCom_.aspect / var_299_4.sprite.bounds.size.x or var_299_5 / var_299_4.sprite.bounds.size.y, 0)
				end
			...
			if var_299_6 <= arg_296_1.time_ and arg_296_1.time_ < var_299_6 + var_299_7 then
				...
				var_299_8.a = Mathf.Lerp(0, 1, (arg_296_1.time_ - var_299_6) / var_299_7)
			...
			if 2 < arg_296_1.time_ and arg_296_1.time_ <= var_299_10 + arg_299_0 then
				arg_296_1.mask_.enabled = true
				arg_296_1.mask_.raycastTarget = true
			...
			if var_299_10 <= arg_296_1.time_ and arg_296_1.time_ < var_299_10 + var_299_11 then
				...
				var_299_12.a = Mathf.Lerp(1, 0, (arg_296_1.time_ - var_299_10) / var_299_11)
			...
			if arg_296_1.time_ >= var_299_10 + var_299_11 and arg_296_1.time_ < var_299_10 + var_299_11 + arg_299_0 then
				local var_299_13 = Color.New(0, 0, 0)

				arg_296_1.mask_.enabled = false
				var_299_13.a = 0
				arg_296_1.mask_.color = var_299_13
			end
			...
			local var_299_14 = 4
			local var_299_15 = 0.775

			if 4 < arg_296_1.time_ and arg_296_1.time_ <= var_299_14 + arg_299_0 then
				...
				arg_296_1.leftNameTxt_.text = arg_296_1:FormatText(StoryNameCfg[87].name)
				...
				local var_299_17 = arg_296_1:GetWordFromCfg(109101072)
				...
				local var_299_20 = 31 <= 0 and var_299_15 or var_299_15 * (utf8.len(var_299_18) / 31)

				if (31 <= 0 and var_299_15 or var_299_15 * (utf8.len(var_299_18) / 31)) > 0 and var_299_15 < var_299_20 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101072", "story_v_out_109101.awb") ~= 0 then
					local var_299_21 = manager.audio:GetVoiceLength("story_v_out_109101", "109101072", "story_v_out_109101.awb") / 1000

					if var_299_21 + var_299_14 > arg_296_1.duration_ then
						arg_296_1.duration_ = var_299_21 + var_299_14
					end

					if var_299_17.prefab_name ~= "" and arg_296_1.actors_[var_299_17.prefab_name] ~= nil then
						local var_299_22 = LuaForUtil.PlayVoiceWithCriLipsync(arg_296_1.actors_[var_299_17.prefab_name].transform, "story_v_out_109101", "109101072", "story_v_out_109101.awb")

						arg_296_1:RecordAudio("109101072", var_299_22)
						arg_296_1:RecordAudio("109101072", var_299_22)
					else
			...
			local var_299_23 = var_299_14 + 0.3
			local var_299_24 = math.max(var_299_15, arg_296_1.talkMaxDuration)

			if var_299_14 + 0.3 <= arg_296_1.time_ and arg_296_1.time_ < var_299_23 + var_299_24 then
				arg_296_1.typewritter.percent = (arg_296_1.time_ - var_299_23) / var_299_24
	...
	Play109101073 = function(arg_302_0, arg_302_1)
		...
		function arg_302_1.onSingleLineUpdate_(arg_305_0)
			...
			if 0 < arg_302_1.time_ and arg_302_1.time_ <= 0 + arg_305_0 then
				...
				arg_302_1.leftNameTxt_.text = arg_302_1:FormatText(StoryNameCfg[87].name)
				...
				local var_305_1 = arg_302_1:GetWordFromCfg(109101073)
				...
				local var_305_4 = 25 <= 0 and var_305_0 or var_305_0 * (utf8.len(var_305_2) / 25)

				if (25 <= 0 and var_305_0 or var_305_0 * (utf8.len(var_305_2) / 25)) > 0 and var_305_0 < var_305_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101073", "story_v_out_109101.awb") ~= 0 then
					local var_305_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101073", "story_v_out_109101.awb") / 1000
					...
					if var_305_1.prefab_name ~= "" and arg_302_1.actors_[var_305_1.prefab_name] ~= nil then
						local var_305_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_302_1.actors_[var_305_1.prefab_name].transform, "story_v_out_109101", "109101073", "story_v_out_109101.awb")

						arg_302_1:RecordAudio("109101073", var_305_6)
						arg_302_1:RecordAudio("109101073", var_305_6)
					else
	...
	Play109101074 = function(arg_306_0, arg_306_1)
		...
		function arg_306_1.onSingleLineUpdate_(arg_309_0)
			if 0 < arg_306_1.time_ and arg_306_1.time_ <= 0 + arg_309_0 then
				arg_306_1:AudioAction("play", "effect", "se_story_9", "se_story_9_black_fog02", "")
			end

			if 0 < arg_306_1.time_ and arg_306_1.time_ <= 0 + arg_309_0 then
				arg_306_1:AudioAction("stop", "music", "se_story_9", "se_story_9_black_fog_loop", "")

				local var_309_3 = manager.audio:GetAudioName("se_story_9", "se_story_9_black_fog_loop")
			...
			if 0 < arg_306_1.time_ and arg_306_1.time_ <= var_309_4 + arg_309_0 then
				...
				local var_309_6 = arg_306_1:FormatText(arg_306_1:GetWordFromCfg(109101074).content)

				arg_306_1.text_.text = var_309_6

				LuaForUtil.ClearLinePrefixSymbol(arg_306_1.text_)

				local var_309_8 = 44 <= 0 and var_309_5 or var_309_5 * (utf8.len(var_309_6) / 44)

				if (44 <= 0 and var_309_5 or var_309_5 * (utf8.len(var_309_6) / 44)) > 0 and var_309_5 < var_309_8 then
					arg_306_1.talkMaxDuration = var_309_8

					if var_309_8 + var_309_4 > arg_306_1.duration_ then
						arg_306_1.duration_ = var_309_8 + var_309_4
					end
				end
			...
			local var_309_9 = math.max(var_309_5, arg_306_1.talkMaxDuration)

			if var_309_4 <= arg_306_1.time_ and arg_306_1.time_ < var_309_4 + var_309_9 then
				arg_306_1.typewritter.percent = (arg_306_1.time_ - var_309_4) / var_309_9

				arg_306_1.typewritter:SetDirty()
			end

			if arg_306_1.time_ >= var_309_4 + var_309_9 and arg_306_1.time_ < var_309_4 + var_309_9 + arg_309_0 then
	...
	Play109101075 = function(arg_311_0, arg_311_1)
		...
		function arg_311_1.onSingleLineUpdate_(arg_314_0)
			if 0 < arg_311_1.time_ and arg_311_1.time_ <= 0 + arg_314_0 then
				arg_311_1.var_.moveOldPos1099ui_story = arg_311_1.actors_["1099ui_story"].transform.localPosition
			end

			local var_314_0 = 0.001

			if 0 <= arg_311_1.time_ and arg_311_1.time_ < 0 + var_314_0 then
				arg_311_1.actors_["1099ui_story"].transform.localPosition = Vector3.Lerp(arg_311_1.var_.moveOldPos1099ui_story, Vector3.New(0, -1.08, -5.9), (arg_311_1.time_ - 0) / var_314_0)
				arg_311_1.actors_["1099ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_311_1.actors_["1099ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_311_1.actors_["1099ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_311_1.actors_["1099ui_story"].transform.position).z)
				arg_311_1.actors_["1099ui_story"].transform.localEulerAngles.z = 0
				arg_311_1.actors_["1099ui_story"].transform.localEulerAngles.x = 0
				arg_311_1.actors_["1099ui_story"].transform.localEulerAngles = arg_311_1.actors_["1099ui_story"].transform.localEulerAngles
			end

			if arg_311_1.time_ >= 0 + var_314_0 and arg_311_1.time_ < 0 + var_314_0 + arg_314_0 then
				arg_311_1.actors_["1099ui_story"].transform.localPosition = Vector3.New(0, -1.08, -5.9)
				arg_311_1.actors_["1099ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_311_1.actors_["1099ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_311_1.actors_["1099ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_311_1.actors_["1099ui_story"].transform.position).z)
				arg_311_1.actors_["1099ui_story"].transform.localEulerAngles.z = 0
				arg_311_1.actors_["1099ui_story"].transform.localEulerAngles.x = 0
				arg_311_1.actors_["1099ui_story"].transform.localEulerAngles = arg_311_1.actors_["1099ui_story"].transform.localEulerAngles
			...
			local var_314_1 = arg_311_1.actors_["1099ui_story"]

			if 0 < arg_311_1.time_ and arg_311_1.time_ <= 0 + arg_314_0 and not isNil(var_314_1) and arg_311_1.var_.characterEffect1099ui_story == nil then
				arg_311_1.var_.characterEffect1099ui_story = var_314_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_314_2 = 0.2

			if 0 <= arg_311_1.time_ and arg_311_1.time_ < 0 + var_314_2 and not isNil(var_314_1) then
				if arg_311_1.var_.characterEffect1099ui_story and not isNil(var_314_1) then
					arg_311_1.var_.characterEffect1099ui_story.fillFlat = false
				end
			end

			if arg_311_1.time_ >= 0 + var_314_2 and arg_311_1.time_ < 0 + var_314_2 + arg_314_0 and not isNil(var_314_1) and arg_311_1.var_.characterEffect1099ui_story then
				arg_311_1.var_.characterEffect1099ui_story.fillFlat = false
			end
			...
			if 0 < arg_311_1.time_ and arg_311_1.time_ <= var_314_4 + arg_314_0 then
				...
				local var_314_6 = arg_311_1:GetWordFromCfg(109101075)
				...
				local var_314_9 = 25 <= 0 and var_314_5 or var_314_5 * (utf8.len(var_314_7) / 25)

				if (25 <= 0 and var_314_5 or var_314_5 * (utf8.len(var_314_7) / 25)) > 0 and var_314_5 < var_314_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101075", "story_v_out_109101.awb") ~= 0 then
					local var_314_10 = manager.audio:GetVoiceLength("story_v_out_109101", "109101075", "story_v_out_109101.awb") / 1000
					...
					if var_314_6.prefab_name ~= "" and arg_311_1.actors_[var_314_6.prefab_name] ~= nil then
						local var_314_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_311_1.actors_[var_314_6.prefab_name].transform, "story_v_out_109101", "109101075", "story_v_out_109101.awb")

						arg_311_1:RecordAudio("109101075", var_314_11)
						arg_311_1:RecordAudio("109101075", var_314_11)
					else
	...
	Play109101076 = function(arg_315_0, arg_315_1)
		...
		function arg_315_1.onSingleLineUpdate_(arg_318_0)
			...
			if 0 < arg_315_1.time_ and arg_315_1.time_ <= var_318_1 + arg_318_0 then
				...
				local var_318_3 = arg_315_1:FormatText(arg_315_1:GetWordFromCfg(109101076).content)

				arg_315_1.text_.text = var_318_3

				LuaForUtil.ClearLinePrefixSymbol(arg_315_1.text_)

				local var_318_5 = 16 <= 0 and var_318_2 or var_318_2 * (utf8.len(var_318_3) / 16)

				if (16 <= 0 and var_318_2 or var_318_2 * (utf8.len(var_318_3) / 16)) > 0 and var_318_2 < var_318_5 then
	...
	Play109101077 = function(arg_319_0, arg_319_1)
		...
		function arg_319_1.onSingleLineUpdate_(arg_322_0)
			...
			if 0 < arg_319_1.time_ and arg_319_1.time_ <= 0 + arg_322_0 and not isNil(var_322_0) and arg_319_1.var_.characterEffect1099ui_story == nil then
			...
			if 0 <= arg_319_1.time_ and arg_319_1.time_ < 0 + var_322_1 and not isNil(var_322_0) then
				if arg_319_1.var_.characterEffect1099ui_story and not isNil(var_322_0) then
					arg_319_1.var_.characterEffect1099ui_story.fillFlat = false
				end
			end

			if arg_319_1.time_ >= 0 + var_322_1 and arg_319_1.time_ < 0 + var_322_1 + arg_322_0 and not isNil(var_322_0) and arg_319_1.var_.characterEffect1099ui_story then
				arg_319_1.var_.characterEffect1099ui_story.fillFlat = false
			end

			local var_322_3 = 0
			local var_322_4 = 0.725
			...
			if 0 < arg_319_1.time_ and arg_319_1.time_ <= var_322_3 + arg_322_0 then
				...
				local var_322_5 = arg_319_1:GetWordFromCfg(109101077)
				...
				local var_322_8 = 26 <= 0 and var_322_4 or var_322_4 * (utf8.len(var_322_6) / 26)

				if (26 <= 0 and var_322_4 or var_322_4 * (utf8.len(var_322_6) / 26)) > 0 and var_322_4 < var_322_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101077", "story_v_out_109101.awb") ~= 0 then
					local var_322_9 = manager.audio:GetVoiceLength("story_v_out_109101", "109101077", "story_v_out_109101.awb") / 1000
					...
					if var_322_5.prefab_name ~= "" and arg_319_1.actors_[var_322_5.prefab_name] ~= nil then
						local var_322_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_319_1.actors_[var_322_5.prefab_name].transform, "story_v_out_109101", "109101077", "story_v_out_109101.awb")

						arg_319_1:RecordAudio("109101077", var_322_10)
						arg_319_1:RecordAudio("109101077", var_322_10)
					else
	...
	Play109101078 = function(arg_323_0, arg_323_1)
		...
		function arg_323_1.onSingleLineUpdate_(arg_326_0)
			...
			local var_326_1 = manager.ui.mainCamera.transform

			if 1.075 < arg_323_1.time_ and arg_323_1.time_ <= 1.075 + arg_326_0 then
				arg_323_1.var_.shakeOldPosC07_1 = var_326_1.localPosition
			end

			local var_326_2 = 1.425

			if 1.075 <= arg_323_1.time_ and arg_323_1.time_ < 1.075 + var_326_2 then
				local var_326_3, var_326_4 = math.modf((arg_323_1.time_ - 1.075) / 0.099)

				var_326_1.localPosition = Vector3.New(var_326_4 * 0.13, var_326_4 * 0.13, var_326_4 * 0.13) + arg_323_1.var_.shakeOldPosC07_1
			end

			if arg_323_1.time_ >= 1.075 + var_326_2 and arg_323_1.time_ < 1.075 + var_326_2 + arg_326_0 then
				var_326_1.localPosition = arg_323_1.var_.shakeOldPosC07_1
			end

			if 0 < arg_323_1.time_ and arg_323_1.time_ <= 0 + arg_326_0 then
				arg_323_1:AudioAction("play", "effect", "se_story_9", "se_story_9_skill", "")
			end

			if 0.766666666666667 < arg_323_1.time_ and arg_323_1.time_ <= 0.766666666666667 + arg_326_0 then
				arg_323_1:AudioAction("play", "effect", "se_story_9", "se_story_9_skill02_loop", "")
			end

			local var_326_7 = 0
			local var_326_8 = 1.075
			...
			if 0 < arg_323_1.time_ and arg_323_1.time_ <= var_326_7 + arg_326_0 then
				...
				local var_326_9 = arg_323_1:FormatText(arg_323_1:GetWordFromCfg(109101078).content)

				arg_323_1.text_.text = var_326_9

				LuaForUtil.ClearLinePrefixSymbol(arg_323_1.text_)

				local var_326_11 = 43 <= 0 and var_326_8 or var_326_8 * (utf8.len(var_326_9) / 43)

				if (43 <= 0 and var_326_8 or var_326_8 * (utf8.len(var_326_9) / 43)) > 0 and var_326_8 < var_326_11 then
	...
	Play109101079 = function(arg_327_0, arg_327_1)
		...
		function arg_327_1.onSingleLineUpdate_(arg_330_0)
			if arg_327_1.bgs_.S0902 == nil then
				local var_330_0 = Object.Instantiate(arg_327_1.paintGo_)

				var_330_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "S0902")
				var_330_0.name = "S0902"
				var_330_0.transform.parent = arg_327_1.stage_.transform
				var_330_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_327_1.bgs_.S0902 = var_330_0
			end

			if 0 < arg_327_1.time_ and arg_327_1.time_ <= 0 + arg_330_0 then
				local var_330_1 = arg_327_1.bgs_.S0902

				arg_327_1.bgs_.S0902.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 0 < arg_327_1.time_ and arg_327_1.time_ <= 0 + arg_330_0 then
				local var_330_4 = arg_327_1.bgs_.S0902:GetComponent("SpriteRenderer")

				if var_330_4 then
					arg_327_1.var_.alphaOldValueS0902 = var_330_4.color.a
					arg_327_1.var_.alphaMatValueS0902 = var_330_4
				end
			...
			if 0 <= arg_327_1.time_ and arg_327_1.time_ < 0 + var_330_5 then
				if arg_327_1.var_.alphaMatValueS0902 then
					arg_327_1.var_.alphaMatValueS0902.color.a = Mathf.Lerp(arg_327_1.var_.alphaOldValueS0902, 1, (arg_327_1.time_ - 0) / var_330_5)
					arg_327_1.var_.alphaMatValueS0902.color = arg_327_1.var_.alphaMatValueS0902.color
				end
			end

			if arg_327_1.time_ >= 0 + var_330_5 and arg_327_1.time_ < 0 + var_330_5 + arg_330_0 and arg_327_1.var_.alphaMatValueS0902 then
				arg_327_1.var_.alphaMatValueS0902.color.a = 1
				arg_327_1.var_.alphaMatValueS0902.color = arg_327_1.var_.alphaMatValueS0902.color
			end

			local var_330_6 = manager.ui.mainCamera.transform

			if 1.5 < arg_327_1.time_ and arg_327_1.time_ <= 1.5 + arg_330_0 then
				arg_327_1.var_.shakeOldPos = var_330_6.localPosition
			end

			local var_330_7 = 0.6

			if 1.5 <= arg_327_1.time_ and arg_327_1.time_ < 1.5 + var_330_7 then
				local var_330_8, var_330_9 = math.modf((arg_327_1.time_ - 1.5) / 0.099)

				var_330_6.localPosition = Vector3.New(var_330_9 * 0.13, var_330_9 * 0.13, var_330_9 * 0.13) + arg_327_1.var_.shakeOldPos
			end

			if arg_327_1.time_ >= 1.5 + var_330_7 and arg_327_1.time_ < 1.5 + var_330_7 + arg_330_0 then
				var_330_6.localPosition = arg_327_1.var_.shakeOldPos
			end

			local var_330_10 = 0

			if 0 < arg_327_1.time_ and arg_327_1.time_ <= var_330_10 + arg_330_0 then
				arg_327_1.allBtn_.enabled = false
			end

			if arg_327_1.time_ >= var_330_10 + 2 and arg_327_1.time_ < var_330_10 + 2 + arg_330_0 then
				arg_327_1.allBtn_.enabled = true
			end

			if 0 < arg_327_1.time_ and arg_327_1.time_ <= 0 + arg_330_0 then
				arg_327_1:AudioAction("stop", "music", "se_story_9", "se_story_9_skill02_loop", "")

				local var_330_13 = manager.audio:GetAudioName("se_story_9", "se_story_9_skill02_loop")

				if "" ~= "" then
					if arg_327_1.bgmTxt_.text ~= var_330_13 and arg_327_1.bgmTxt_.text ~= "" then
						if arg_327_1.bgmTxt2_.text ~= "" then
							arg_327_1.bgmTxt_.text = arg_327_1.bgmTxt2_.text
						end

						arg_327_1.bgmTxt2_.text = var_330_13

						arg_327_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_327_1.bgmTxt_.text = var_330_13
						arg_327_1.bgmTxt2_.text = var_330_13
					end
			...
			if 0.633333333333333 < arg_327_1.time_ and arg_327_1.time_ <= 0.633333333333333 + arg_330_0 then
				arg_327_1:AudioAction("play", "effect", "se_story_9", "se_story_9_cleave", "")
			end
			...
			if 2 < arg_327_1.time_ and arg_327_1.time_ <= var_330_15 + arg_330_0 then
				...
				var_330_17:setOnUpdate(LuaHelper.FloatAction(function(arg_332_0)
				...
				local var_330_18 = arg_327_1:FormatText(arg_327_1:GetWordFromCfg(109101079).content)

				arg_327_1.text_.text = var_330_18

				LuaForUtil.ClearLinePrefixSymbol(arg_327_1.text_)

				local var_330_20 = 41 <= 0 and var_330_16 or var_330_16 * (utf8.len(var_330_18) / 41)

				if (41 <= 0 and var_330_16 or var_330_16 * (utf8.len(var_330_18) / 41)) > 0 and var_330_16 < var_330_20 then
					arg_327_1.talkMaxDuration = var_330_20
					var_330_15 = var_330_15 + 0.3

					if var_330_20 + var_330_15 > arg_327_1.duration_ then
						arg_327_1.duration_ = var_330_20 + var_330_15
					end
				end
			...
			local var_330_21 = var_330_15 + 0.3
			local var_330_22 = math.max(var_330_16, arg_327_1.talkMaxDuration)

			if var_330_15 + 0.3 <= arg_327_1.time_ and arg_327_1.time_ < var_330_21 + var_330_22 then
				arg_327_1.typewritter.percent = (arg_327_1.time_ - var_330_21) / var_330_22
	...
	Play109101080 = function(arg_334_0, arg_334_1)
		...
		function arg_334_1.onSingleLineUpdate_(arg_337_0)
			...
			if 0 < arg_334_1.time_ and arg_334_1.time_ <= 0 + arg_337_0 then
				...
				arg_334_1.leftNameTxt_.text = arg_334_1:FormatText(StoryNameCfg[84].name)
				...
				local var_337_1 = arg_334_1:GetWordFromCfg(109101080)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101080", "story_v_out_109101.awb") ~= 0 then
					local var_337_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101080", "story_v_out_109101.awb") / 1000
					...
					if var_337_1.prefab_name ~= "" and arg_334_1.actors_[var_337_1.prefab_name] ~= nil then
						local var_337_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_334_1.actors_[var_337_1.prefab_name].transform, "story_v_out_109101", "109101080", "story_v_out_109101.awb")

						arg_334_1:RecordAudio("109101080", var_337_6)
						arg_334_1:RecordAudio("109101080", var_337_6)
					else
	...
	Play109101081 = function(arg_338_0, arg_338_1)
		...
		function arg_338_1.onSingleLineUpdate_(arg_341_0)
			...
			if 0 < arg_338_1.time_ and arg_338_1.time_ <= 0 + arg_341_0 then
				...
				arg_338_1.leftNameTxt_.text = arg_338_1:FormatText(StoryNameCfg[87].name)
				...
				local var_341_1 = arg_338_1:GetWordFromCfg(109101081)
				...
				local var_341_4 = 9 <= 0 and var_341_0 or var_341_0 * (utf8.len(var_341_2) / 9)

				if (9 <= 0 and var_341_0 or var_341_0 * (utf8.len(var_341_2) / 9)) > 0 and var_341_0 < var_341_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101081", "story_v_out_109101.awb") ~= 0 then
					local var_341_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101081", "story_v_out_109101.awb") / 1000
					...
					if var_341_1.prefab_name ~= "" and arg_338_1.actors_[var_341_1.prefab_name] ~= nil then
						local var_341_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_338_1.actors_[var_341_1.prefab_name].transform, "story_v_out_109101", "109101081", "story_v_out_109101.awb")

						arg_338_1:RecordAudio("109101081", var_341_6)
						arg_338_1:RecordAudio("109101081", var_341_6)
					else
	...
	Play109101082 = function(arg_342_0, arg_342_1)
		...
		function arg_342_1.onSingleLineUpdate_(arg_345_0)
			...
			if 0 < arg_342_1.time_ and arg_342_1.time_ <= 0 + arg_345_0 then
				...
				arg_342_1.leftNameTxt_.text = arg_342_1:FormatText(StoryNameCfg[87].name)
				...
				local var_345_1 = arg_342_1:GetWordFromCfg(109101082)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101082", "story_v_out_109101.awb") ~= 0 then
					local var_345_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101082", "story_v_out_109101.awb") / 1000
					...
					if var_345_1.prefab_name ~= "" and arg_342_1.actors_[var_345_1.prefab_name] ~= nil then
						local var_345_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_342_1.actors_[var_345_1.prefab_name].transform, "story_v_out_109101", "109101082", "story_v_out_109101.awb")

						arg_342_1:RecordAudio("109101082", var_345_6)
						arg_342_1:RecordAudio("109101082", var_345_6)
					else
	...
	Play109101083 = function(arg_346_0, arg_346_1)
		...
		function arg_346_1.onSingleLineUpdate_(arg_349_0)
			...
			if 0 < arg_346_1.time_ and arg_346_1.time_ <= 0 + arg_349_0 then
				...
				arg_346_1.leftNameTxt_.text = arg_346_1:FormatText(StoryNameCfg[84].name)
				...
				local var_349_1 = arg_346_1:GetWordFromCfg(109101083)
				...
				local var_349_4 = 12 <= 0 and var_349_0 or var_349_0 * (utf8.len(var_349_2) / 12)

				if (12 <= 0 and var_349_0 or var_349_0 * (utf8.len(var_349_2) / 12)) > 0 and var_349_0 < var_349_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101083", "story_v_out_109101.awb") ~= 0 then
					local var_349_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101083", "story_v_out_109101.awb") / 1000
					...
					if var_349_1.prefab_name ~= "" and arg_346_1.actors_[var_349_1.prefab_name] ~= nil then
						local var_349_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_346_1.actors_[var_349_1.prefab_name].transform, "story_v_out_109101", "109101083", "story_v_out_109101.awb")

						arg_346_1:RecordAudio("109101083", var_349_6)
						arg_346_1:RecordAudio("109101083", var_349_6)
					else
	...
	Play109101084 = function(arg_350_0, arg_350_1)
		...
		function arg_350_1.onSingleLineUpdate_(arg_353_0)
			...
			if 0 < arg_350_1.time_ and arg_350_1.time_ <= 0 + arg_353_0 then
				...
				arg_350_1.leftNameTxt_.text = arg_350_1:FormatText(StoryNameCfg[84].name)
				...
				local var_353_1 = arg_350_1:GetWordFromCfg(109101084)
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101084", "story_v_out_109101.awb") ~= 0 then
					local var_353_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101084", "story_v_out_109101.awb") / 1000
					...
					if var_353_1.prefab_name ~= "" and arg_350_1.actors_[var_353_1.prefab_name] ~= nil then
						local var_353_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_350_1.actors_[var_353_1.prefab_name].transform, "story_v_out_109101", "109101084", "story_v_out_109101.awb")

						arg_350_1:RecordAudio("109101084", var_353_6)
						arg_350_1:RecordAudio("109101084", var_353_6)
					else
	...
	Play109101085 = function(arg_354_0, arg_354_1)
		...
		function arg_354_1.onSingleLineUpdate_(arg_357_0)
			...
			if 0 < arg_354_1.time_ and arg_354_1.time_ <= 0 + arg_357_0 then
				...
				arg_354_1.leftNameTxt_.text = arg_354_1:FormatText(StoryNameCfg[87].name)
				...
				local var_357_1 = arg_354_1:GetWordFromCfg(109101085)
				...
				local var_357_4 = 6 <= 0 and var_357_0 or var_357_0 * (utf8.len(var_357_2) / 6)

				if (6 <= 0 and var_357_0 or var_357_0 * (utf8.len(var_357_2) / 6)) > 0 and var_357_0 < var_357_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101085", "story_v_out_109101.awb") ~= 0 then
					local var_357_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101085", "story_v_out_109101.awb") / 1000
					...
					if var_357_1.prefab_name ~= "" and arg_354_1.actors_[var_357_1.prefab_name] ~= nil then
						local var_357_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_354_1.actors_[var_357_1.prefab_name].transform, "story_v_out_109101", "109101085", "story_v_out_109101.awb")

						arg_354_1:RecordAudio("109101085", var_357_6)
						arg_354_1:RecordAudio("109101085", var_357_6)
					else
	...
	Play109101086 = function(arg_358_0, arg_358_1)
		...
		function arg_358_1.onSingleLineUpdate_(arg_361_0)
			...
			if 0 < arg_358_1.time_ and arg_358_1.time_ <= 0 + arg_361_0 then
				...
				arg_358_1.leftNameTxt_.text = arg_358_1:FormatText(StoryNameCfg[84].name)
				...
				local var_361_1 = arg_358_1:GetWordFromCfg(109101086)
				...
				local var_361_4 = 29 <= 0 and var_361_0 or var_361_0 * (utf8.len(var_361_2) / 29)

				if (29 <= 0 and var_361_0 or var_361_0 * (utf8.len(var_361_2) / 29)) > 0 and var_361_0 < var_361_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101086", "story_v_out_109101.awb") ~= 0 then
					local var_361_5 = manager.audio:GetVoiceLength("story_v_out_109101", "109101086", "story_v_out_109101.awb") / 1000
					...
					if var_361_1.prefab_name ~= "" and arg_358_1.actors_[var_361_1.prefab_name] ~= nil then
						local var_361_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_358_1.actors_[var_361_1.prefab_name].transform, "story_v_out_109101", "109101086", "story_v_out_109101.awb")

						arg_358_1:RecordAudio("109101086", var_361_6)
						arg_358_1:RecordAudio("109101086", var_361_6)
					else
	...
	Play109101087 = function(arg_362_0, arg_362_1)
		...
		function arg_362_1.onSingleLineFinish_()
			...
			for iter_363_0, iter_363_1 in ipairs(arg_362_1.choices_) do
				SetActive(iter_363_1.go, iter_363_0 <= 1)
			end
	...
	Play109101088 = function(arg_366_0, arg_366_1)
		...
		function arg_366_1.onSingleLineUpdate_(arg_369_0)
			if 0 < arg_366_1.time_ and arg_366_1.time_ <= 0 + arg_369_0 then
				arg_366_1.var_.moveOldPosS0902 = arg_366_1.bgs_.S0902.transform.localPosition
			end

			local var_369_0 = 2

			if 0 <= arg_366_1.time_ and arg_366_1.time_ < 0 + var_369_0 then
				arg_366_1.bgs_.S0902.transform.localPosition = Vector3.Lerp(arg_366_1.var_.moveOldPosS0902, Vector3.New(0, 1, 9), (arg_366_1.time_ - 0) / var_369_0)
			end

			if arg_366_1.time_ >= 0 + var_369_0 and arg_366_1.time_ < 0 + var_369_0 + arg_369_0 then
				arg_366_1.bgs_.S0902.transform.localPosition = Vector3.New(0, 1, 9)
			end
			...
			if 0 < arg_366_1.time_ and arg_366_1.time_ <= var_369_1 + arg_369_0 then
				...
				arg_366_1.leftNameTxt_.text = arg_366_1:FormatText(StoryNameCfg[84].name)
				...
				local var_369_3 = arg_366_1:GetWordFromCfg(109101088)
				...
				local var_369_6 = 24 <= 0 and var_369_2 or var_369_2 * (utf8.len(var_369_4) / 24)

				if (24 <= 0 and var_369_2 or var_369_2 * (utf8.len(var_369_4) / 24)) > 0 and var_369_2 < var_369_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_109101", "109101088", "story_v_out_109101.awb") ~= 0 then
					local var_369_7 = manager.audio:GetVoiceLength("story_v_out_109101", "109101088", "story_v_out_109101.awb") / 1000
					...
					if var_369_3.prefab_name ~= "" and arg_366_1.actors_[var_369_3.prefab_name] ~= nil then
						local var_369_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_366_1.actors_[var_369_3.prefab_name].transform, "story_v_out_109101", "109101088", "story_v_out_109101.awb")

						arg_366_1:RecordAudio("109101088", var_369_8)
						arg_366_1:RecordAudio("109101088", var_369_8)
					else
