return {
	Play925111001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.bgs_.H06 == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.paintGo_)

				var_4_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "H06")
				var_4_0.name = "H06"
				var_4_0.transform.parent = arg_1_1.stage_.transform
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.bgs_.H06 = var_4_0
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_1 = arg_1_1.bgs_.H06

				arg_1_1.bgs_.H06.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if arg_1_1.actors_["1021"] == nil then
				local var_4_10 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1021")
			...
			local var_4_12 = arg_1_1.actors_["1021"]

			if 1.799999999999 < arg_1_1.time_ and arg_1_1.time_ <= 1.799999999999 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.actorSpriteComps1021 == nil then
				arg_1_1.var_.actorSpriteComps1021 = var_4_12:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_1_1.time_ >= 1.799999999999 + var_4_13 and arg_1_1.time_ < 1.799999999999 + var_4_13 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.actorSpriteComps1021 then
			...
			local var_4_15 = arg_1_1.actors_["1021"].transform

			if 1.799999999999 < arg_1_1.time_ and arg_1_1.time_ <= 1.799999999999 + arg_4_0 then
				arg_1_1.var_.moveOldPos1021 = var_4_15.localPosition
			...
			if 1.799999999999 <= arg_1_1.time_ and arg_1_1.time_ < 1.799999999999 + var_4_17 then
				var_4_15.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1021, Vector3.New(0, -340, -365), (arg_1_1.time_ - 1.799999999999) / var_4_17)
			end
			...
			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				local var_4_18 = arg_1_1.actors_["1021"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_18 then
					arg_1_1.var_.alphaOldValue1021 = var_4_18.alpha
					arg_1_1.var_.characterEffect1021 = var_4_18
				end
			...
			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_19 then
				if arg_1_1.var_.characterEffect1021 then
					arg_1_1.var_.characterEffect1021.alpha = Mathf.Lerp(arg_1_1.var_.alphaOldValue1021, 1, (arg_1_1.time_ - 1.8) / var_4_19)
				end
			end

			if arg_1_1.time_ >= 1.8 + var_4_19 and arg_1_1.time_ < 1.8 + var_4_19 + arg_4_0 and arg_1_1.var_.characterEffect1021 then
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_26 + arg_4_0 then
				...
				local var_4_29 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(925111001).content)

				arg_1_1.text_.text = var_4_29

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_31 = 17 <= 0 and var_4_27 or var_4_27 * (utf8.len(var_4_29) / 17)

				if (17 <= 0 and var_4_27 or var_4_27 * (utf8.len(var_4_29) / 17)) > 0 and var_4_27 < var_4_31 then
	...
	Play925111002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(arg_9_1.actors_["1021"]) and arg_9_1.var_.actorSpriteComps1021 == nil then
				arg_9_1.var_.actorSpriteComps1021 = arg_9_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_12_0 = 0.2

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_0 and not isNil(arg_9_1.actors_["1021"]) then
			...
			if arg_9_1.time_ >= 0 + var_12_0 and arg_9_1.time_ < 0 + var_12_0 + arg_12_0 and not isNil(arg_9_1.actors_["1021"]) and arg_9_1.var_.actorSpriteComps1021 then
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_2 + arg_12_0 then
				...
				local var_12_4 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(925111002).content)

				arg_9_1.text_.text = var_12_4

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_6 = 32 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 32)

				if (32 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 32)) > 0 and var_12_3 < var_12_6 then
	...
	Play925111003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 and not isNil(arg_13_1.actors_["1021"]) and arg_13_1.var_.actorSpriteComps1021 == nil then
				arg_13_1.var_.actorSpriteComps1021 = arg_13_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_16_0 = 0.2

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_0 and not isNil(arg_13_1.actors_["1021"]) then
			...
			if arg_13_1.time_ >= 0 + var_16_0 and arg_13_1.time_ < 0 + var_16_0 + arg_16_0 and not isNil(arg_13_1.actors_["1021"]) and arg_13_1.var_.actorSpriteComps1021 then
			...
			local var_16_2 = arg_13_1.actors_["1021"].transform

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos1021 = var_16_2.localPosition
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_4 then
				var_16_2.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1021, Vector3.New(0, -340, -365), (arg_13_1.time_ - 0) / var_16_4)
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_5 + arg_16_0 then
				...
				local var_16_7 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(925111003).content)

				arg_13_1.text_.text = var_16_7

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_9 = 33 <= 0 and var_16_6 or var_16_6 * (utf8.len(var_16_7) / 33)

				if (33 <= 0 and var_16_6 or var_16_6 * (utf8.len(var_16_7) / 33)) > 0 and var_16_6 < var_16_9 then
	...
	Play925111004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(arg_17_1.actors_["1021"]) and arg_17_1.var_.actorSpriteComps1021 == nil then
				arg_17_1.var_.actorSpriteComps1021 = arg_17_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_20_0 = 0.2

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_0 and not isNil(arg_17_1.actors_["1021"]) then
			...
			if arg_17_1.time_ >= 0 + var_20_0 and arg_17_1.time_ < 0 + var_20_0 + arg_20_0 and not isNil(arg_17_1.actors_["1021"]) and arg_17_1.var_.actorSpriteComps1021 then
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(925111004).content)
	...
	Play925111005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(arg_21_1.actors_["1021"]) and arg_21_1.var_.actorSpriteComps1021 == nil then
				arg_21_1.var_.actorSpriteComps1021 = arg_21_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_24_0 = 0.2

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_0 and not isNil(arg_21_1.actors_["1021"]) then
			...
			if arg_21_1.time_ >= 0 + var_24_0 and arg_21_1.time_ < 0 + var_24_0 + arg_24_0 and not isNil(arg_21_1.actors_["1021"]) and arg_21_1.var_.actorSpriteComps1021 then
			...
			local var_24_2 = arg_21_1.actors_["1021"].transform

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos1021 = var_24_2.localPosition
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_4 then
				var_24_2.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1021, Vector3.New(0, -340, -365), (arg_21_1.time_ - 0) / var_24_4)
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_5 + arg_24_0 then
				...
				local var_24_7 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(925111005).content)

				arg_21_1.text_.text = var_24_7

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_9 = 19 <= 0 and var_24_6 or var_24_6 * (utf8.len(var_24_7) / 19)

				if (19 <= 0 and var_24_6 or var_24_6 * (utf8.len(var_24_7) / 19)) > 0 and var_24_6 < var_24_9 then
	...
	Play925111006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(arg_25_1.actors_["1021"]) and arg_25_1.var_.actorSpriteComps1021 == nil then
				arg_25_1.var_.actorSpriteComps1021 = arg_25_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_28_0 = 0.2

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_0 and not isNil(arg_25_1.actors_["1021"]) then
			...
			if arg_25_1.time_ >= 0 + var_28_0 and arg_25_1.time_ < 0 + var_28_0 + arg_28_0 and not isNil(arg_25_1.actors_["1021"]) and arg_25_1.var_.actorSpriteComps1021 then
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(925111006).content)

				arg_25_1.text_.text = var_28_4

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_6 = 62 <= 0 and var_28_3 or var_28_3 * (utf8.len(var_28_4) / 62)

				if (62 <= 0 and var_28_3 or var_28_3 * (utf8.len(var_28_4) / 62)) > 0 and var_28_3 < var_28_6 then
	...
	Play925111007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(arg_29_1.actors_["1021"]) and arg_29_1.var_.actorSpriteComps1021 == nil then
				arg_29_1.var_.actorSpriteComps1021 = arg_29_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_32_0 = 0.2

			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_0 and not isNil(arg_29_1.actors_["1021"]) then
			...
			if arg_29_1.time_ >= 0 + var_32_0 and arg_29_1.time_ < 0 + var_32_0 + arg_32_0 and not isNil(arg_29_1.actors_["1021"]) and arg_29_1.var_.actorSpriteComps1021 then
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_2 + arg_32_0 then
				...
				local var_32_4 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(925111007).content)

				arg_29_1.text_.text = var_32_4

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_6 = 13 <= 0 and var_32_3 or var_32_3 * (utf8.len(var_32_4) / 13)

				if (13 <= 0 and var_32_3 or var_32_3 * (utf8.len(var_32_4) / 13)) > 0 and var_32_3 < var_32_6 then
	...
	Play925111008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				arg_33_1.var_.moveOldPos1021 = arg_33_1.actors_["1021"].transform.localPosition
				arg_33_1.actors_["1021"].transform.localScale = Vector3.New(1, 1, 1)

				arg_33_1:CheckSpriteTmpPos("1021", 3)

				for iter_36_0 = 0, arg_33_1.actors_["1021"].transform.childCount - 1 do
					local var_36_0 = arg_33_1.actors_["1021"].transform:GetChild(iter_36_0)
			...
			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_1 then
				arg_33_1.actors_["1021"].transform.localPosition = Vector3.Lerp(arg_33_1.var_.moveOldPos1021, Vector3.New(0, -340, -365), (arg_33_1.time_ - 0) / var_36_1)
			end

			if arg_33_1.time_ >= 0 + var_36_1 and arg_33_1.time_ < 0 + var_36_1 + arg_36_0 then
				arg_33_1.actors_["1021"].transform.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_2 + arg_36_0 then
				...
				local var_36_4 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(925111008).content)

				arg_33_1.text_.text = var_36_4

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_6 = 31 <= 0 and var_36_3 or var_36_3 * (utf8.len(var_36_4) / 31)

				if (31 <= 0 and var_36_3 or var_36_3 * (utf8.len(var_36_4) / 31)) > 0 and var_36_3 < var_36_6 then
	...
	Play925111009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				local var_40_1 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(925111009).content)
	...
	Play925111010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(arg_41_1.actors_["1021"]) and arg_41_1.var_.actorSpriteComps1021 == nil then
				arg_41_1.var_.actorSpriteComps1021 = arg_41_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_44_0 = 0.2

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_0 and not isNil(arg_41_1.actors_["1021"]) then
			...
			if arg_41_1.time_ >= 0 + var_44_0 and arg_41_1.time_ < 0 + var_44_0 + arg_44_0 and not isNil(arg_41_1.actors_["1021"]) and arg_41_1.var_.actorSpriteComps1021 then
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_2 + arg_44_0 then
				...
				local var_44_4 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(925111010).content)
	...
	Play925111011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1021 = arg_45_1.actors_["1021"].transform.localPosition
				arg_45_1.actors_["1021"].transform.localScale = Vector3.New(1, 1, 1)

				arg_45_1:CheckSpriteTmpPos("1021", 7)

				for iter_48_0 = 0, arg_45_1.actors_["1021"].transform.childCount - 1 do
					local var_48_0 = arg_45_1.actors_["1021"].transform:GetChild(iter_48_0)
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_1 then
				arg_45_1.actors_["1021"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1021, Vector3.New(0, -2000, 0), (arg_45_1.time_ - 0) / var_48_1)
			end

			if arg_45_1.time_ >= 0 + var_48_1 and arg_45_1.time_ < 0 + var_48_1 + arg_48_0 then
				arg_45_1.actors_["1021"].transform.localPosition = Vector3.New(0, -2000, 0)
			end
			...
			local var_48_3 = 0.733333333333333

			if var_48_2 <= arg_45_1.time_ and arg_45_1.time_ < var_48_2 + var_48_3 then
				local var_48_4 = Color.New(0, 0, 0)

				var_48_4.a = Mathf.Lerp(1, 0, (arg_45_1.time_ - var_48_2) / var_48_3)
				arg_45_1.mask_.color = var_48_4
			end

			if arg_45_1.time_ >= var_48_2 + var_48_3 and arg_45_1.time_ < var_48_2 + var_48_3 + arg_48_0 then
			...
			if 1 < arg_45_1.time_ and arg_45_1.time_ <= var_48_6 + arg_48_0 then
				...
				local var_48_9 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(925111011).content)
	...
	Play925111012 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 and not isNil(arg_51_1.actors_["1021"]) and arg_51_1.var_.actorSpriteComps1021 == nil then
				arg_51_1.var_.actorSpriteComps1021 = arg_51_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_54_0 = 0.2

			if 0 <= arg_51_1.time_ and arg_51_1.time_ < 0 + var_54_0 and not isNil(arg_51_1.actors_["1021"]) then
			...
			if arg_51_1.time_ >= 0 + var_54_0 and arg_51_1.time_ < 0 + var_54_0 + arg_54_0 and not isNil(arg_51_1.actors_["1021"]) and arg_51_1.var_.actorSpriteComps1021 then
			...
			local var_54_2 = arg_51_1.actors_["1021"].transform

			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 then
				arg_51_1.var_.moveOldPos1021 = var_54_2.localPosition
			...
			if 0 <= arg_51_1.time_ and arg_51_1.time_ < 0 + var_54_4 then
				var_54_2.localPosition = Vector3.Lerp(arg_51_1.var_.moveOldPos1021, Vector3.New(0, -340, -365), (arg_51_1.time_ - 0) / var_54_4)
			end

			if arg_51_1.time_ >= 0 + var_54_4 and arg_51_1.time_ < 0 + var_54_4 + arg_54_0 then
				var_54_2.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_5 + arg_54_0 then
				...
				local var_54_7 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(925111012).content)
	...
	Play925111013 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= 0 + arg_58_0 and not isNil(arg_55_1.actors_["1021"]) and arg_55_1.var_.actorSpriteComps1021 == nil then
				arg_55_1.var_.actorSpriteComps1021 = arg_55_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_58_0 = 0.2

			if 0 <= arg_55_1.time_ and arg_55_1.time_ < 0 + var_58_0 and not isNil(arg_55_1.actors_["1021"]) then
			...
			if arg_55_1.time_ >= 0 + var_58_0 and arg_55_1.time_ < 0 + var_58_0 + arg_58_0 and not isNil(arg_55_1.actors_["1021"]) and arg_55_1.var_.actorSpriteComps1021 then
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_2 + arg_58_0 then
				...
				local var_58_4 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(925111013).content)

				arg_55_1.text_.text = var_58_4

				LuaForUtil.ClearLinePrefixSymbol(arg_55_1.text_)

				local var_58_6 = 19 <= 0 and var_58_3 or var_58_3 * (utf8.len(var_58_4) / 19)

				if (19 <= 0 and var_58_3 or var_58_3 * (utf8.len(var_58_4) / 19)) > 0 and var_58_3 < var_58_6 then
	...
	Play925111014 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= 0 + arg_62_0 and not isNil(arg_59_1.actors_["1021"]) and arg_59_1.var_.actorSpriteComps1021 == nil then
				arg_59_1.var_.actorSpriteComps1021 = arg_59_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_62_0 = 0.2

			if 0 <= arg_59_1.time_ and arg_59_1.time_ < 0 + var_62_0 and not isNil(arg_59_1.actors_["1021"]) then
			...
			if arg_59_1.time_ >= 0 + var_62_0 and arg_59_1.time_ < 0 + var_62_0 + arg_62_0 and not isNil(arg_59_1.actors_["1021"]) and arg_59_1.var_.actorSpriteComps1021 then
			...
			local var_62_2 = arg_59_1.actors_["1021"].transform

			if 0 < arg_59_1.time_ and arg_59_1.time_ <= 0 + arg_62_0 then
				arg_59_1.var_.moveOldPos1021 = var_62_2.localPosition
			...
			if 0 <= arg_59_1.time_ and arg_59_1.time_ < 0 + var_62_4 then
				var_62_2.localPosition = Vector3.Lerp(arg_59_1.var_.moveOldPos1021, Vector3.New(0, -340, -365), (arg_59_1.time_ - 0) / var_62_4)
			end

			if arg_59_1.time_ >= 0 + var_62_4 and arg_59_1.time_ < 0 + var_62_4 + arg_62_0 then
				var_62_2.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_5 + arg_62_0 then
				...
				arg_59_1.leftNameTxt_.text = arg_59_1:FormatText(StoryNameCfg[614].name)
				...
				local var_62_7 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(925111014).content)
	...
	Play925111015 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= 0 + arg_66_0 and not isNil(arg_63_1.actors_["1021"]) and arg_63_1.var_.actorSpriteComps1021 == nil then
				arg_63_1.var_.actorSpriteComps1021 = arg_63_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_66_0 = 0.2

			if 0 <= arg_63_1.time_ and arg_63_1.time_ < 0 + var_66_0 and not isNil(arg_63_1.actors_["1021"]) then
			...
			if arg_63_1.time_ >= 0 + var_66_0 and arg_63_1.time_ < 0 + var_66_0 + arg_66_0 and not isNil(arg_63_1.actors_["1021"]) and arg_63_1.var_.actorSpriteComps1021 then
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= var_66_2 + arg_66_0 then
				...
				local var_66_4 = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(925111015).content)

				arg_63_1.text_.text = var_66_4

				LuaForUtil.ClearLinePrefixSymbol(arg_63_1.text_)

				local var_66_6 = 33 <= 0 and var_66_3 or var_66_3 * (utf8.len(var_66_4) / 33)

				if (33 <= 0 and var_66_3 or var_66_3 * (utf8.len(var_66_4) / 33)) > 0 and var_66_3 < var_66_6 then
	...
	Play925111016 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= 0 + arg_70_0 and not isNil(arg_67_1.actors_["1021"]) and arg_67_1.var_.actorSpriteComps1021 == nil then
				arg_67_1.var_.actorSpriteComps1021 = arg_67_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_70_0 = 0.2

			if 0 <= arg_67_1.time_ and arg_67_1.time_ < 0 + var_70_0 and not isNil(arg_67_1.actors_["1021"]) then
			...
			if arg_67_1.time_ >= 0 + var_70_0 and arg_67_1.time_ < 0 + var_70_0 + arg_70_0 and not isNil(arg_67_1.actors_["1021"]) and arg_67_1.var_.actorSpriteComps1021 then
			...
			local var_70_2 = arg_67_1.actors_["1021"].transform

			if 0 < arg_67_1.time_ and arg_67_1.time_ <= 0 + arg_70_0 then
				arg_67_1.var_.moveOldPos1021 = var_70_2.localPosition
			...
			if 0 <= arg_67_1.time_ and arg_67_1.time_ < 0 + var_70_4 then
				var_70_2.localPosition = Vector3.Lerp(arg_67_1.var_.moveOldPos1021, Vector3.New(0, -340, -365), (arg_67_1.time_ - 0) / var_70_4)
			end

			if arg_67_1.time_ >= 0 + var_70_4 and arg_67_1.time_ < 0 + var_70_4 + arg_70_0 then
				var_70_2.localPosition = Vector3.New(0, -340, -365)
			end
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_5 + arg_70_0 then
				...
				local var_70_7 = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(925111016).content)

				arg_67_1.text_.text = var_70_7

				LuaForUtil.ClearLinePrefixSymbol(arg_67_1.text_)

				local var_70_9 = 6 <= 0 and var_70_6 or var_70_6 * (utf8.len(var_70_7) / 6)

				if (6 <= 0 and var_70_6 or var_70_6 * (utf8.len(var_70_7) / 6)) > 0 and var_70_6 < var_70_9 then
	...
	Play925111017 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= 0 + arg_74_0 and not isNil(arg_71_1.actors_["1021"]) and arg_71_1.var_.actorSpriteComps1021 == nil then
				arg_71_1.var_.actorSpriteComps1021 = arg_71_1.actors_["1021"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_74_0 = 0.2

			if 0 <= arg_71_1.time_ and arg_71_1.time_ < 0 + var_74_0 and not isNil(arg_71_1.actors_["1021"]) then
			...
			if arg_71_1.time_ >= 0 + var_74_0 and arg_71_1.time_ < 0 + var_74_0 + arg_74_0 and not isNil(arg_71_1.actors_["1021"]) and arg_71_1.var_.actorSpriteComps1021 then
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_2 + arg_74_0 then
				...
				local var_74_4 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(925111017).content)

				arg_71_1.text_.text = var_74_4

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_6 = 16 <= 0 and var_74_3 or var_74_3 * (utf8.len(var_74_4) / 16)

				if (16 <= 0 and var_74_3 or var_74_3 * (utf8.len(var_74_4) / 16)) > 0 and var_74_3 < var_74_6 then
