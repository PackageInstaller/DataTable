return {
	Play61101001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 61101001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.333333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 0.333333333333333 + var_4_3 then
				var_4_2.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2530007, Vector3.New(0, 25, -135), (arg_1_1.time_ - 0.333333333333333) / var_4_3)
			end

			if arg_1_1.time_ >= 0.333333333333333 + var_4_3 and arg_1_1.time_ < 0.333333333333333 + var_4_3 + arg_4_0 then
				var_4_2.localPosition = Vector3.New(0, 25, -135)
			end

			local var_4_4 = arg_1_1.actors_["2530007"]
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 0.333333333333333 + arg_4_0 and not isNil(var_4_4) then
				...
				if var_4_5 then
					arg_1_1.var_.highlightMatValue2530007 = var_4_5
				end
			end
			...
			if 0.333333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 0.333333333333333 + var_4_6 and not isNil(var_4_4) then
				if arg_1_1.var_.highlightMatValue2530007 then
					local var_4_7 = Mathf.Lerp(0.5, 1, (arg_1_1.time_ - 0.333333333333333) / var_4_6)

					arg_1_1.var_.highlightMatValue2530007.color.r = var_4_7
					arg_1_1.var_.highlightMatValue2530007.color.g = var_4_7
					arg_1_1.var_.highlightMatValue2530007.color.b = var_4_7
					arg_1_1.var_.highlightMatValue2530007.color = arg_1_1.var_.highlightMatValue2530007.color
				end
			end

			if arg_1_1.time_ >= 0.333333333333333 + var_4_6 and arg_1_1.time_ < 0.333333333333333 + var_4_6 + arg_4_0 and not isNil(var_4_4) and arg_1_1.var_.highlightMatValue2530007 then
				var_4_4.transform:SetSiblingIndex(1)

				arg_1_1.var_.highlightMatValue2530007.color.r = 1
				arg_1_1.var_.highlightMatValue2530007.color.g = 1
				arg_1_1.var_.highlightMatValue2530007.color.b = 1
				arg_1_1.var_.highlightMatValue2530007.color = arg_1_1.var_.highlightMatValue2530007.color
			end
			...
			local var_4_8 = 0.333333333332
			local var_4_9 = 0.6

			if 0.333333333332 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[164].name)
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(61101001).content)

				arg_1_1.text_.text = var_4_11

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_13 = 24 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 24)

				if (24 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 24)) > 0 and var_4_9 < var_4_13 then
	...
	Play61101002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 61101002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[164].name)
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(61101002).content)
	...
	Play61101003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 61101003
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				arg_11_1.leftNameTxt_.text = arg_11_1:FormatText(StoryNameCfg[164].name)
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(61101003).content)

				arg_11_1.text_.text = var_14_1

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_3 = 47 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 47)

				if (47 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 47)) > 0 and var_14_0 < var_14_3 then
