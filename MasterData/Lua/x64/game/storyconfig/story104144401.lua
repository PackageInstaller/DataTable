return {
	Play414441001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 414441001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.96666666666667 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414441001).content)
	...
	Play414441002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 414441002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			local var_10_3 = arg_7_1.actors_["104902ui_story"]

			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 and not isNil(var_10_3) and arg_7_1.var_.characterEffect104902ui_story == nil then
				arg_7_1.var_.characterEffect104902ui_story = var_10_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_10_4 = 0.200000002980232

			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_4 and not isNil(var_10_3) then
				if arg_7_1.var_.characterEffect104902ui_story and not isNil(var_10_3) then
					arg_7_1.var_.characterEffect104902ui_story.fillFlat = true
					arg_7_1.var_.characterEffect104902ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_7_1.time_ - 0) / var_10_4)
				end
			end

			if arg_7_1.time_ >= 0 + var_10_4 and arg_7_1.time_ < 0 + var_10_4 + arg_10_0 and not isNil(var_10_3) and arg_7_1.var_.characterEffect104902ui_story then
				arg_7_1.var_.characterEffect104902ui_story.fillFlat = true
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_5 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[978].name)
				...
				local var_10_7 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(414441002).content)
	...
	Play414441003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 414441003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play414441004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				arg_11_1.leftNameTxt_.text = arg_11_1:FormatText(StoryNameCfg[978].name)
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(414441003).content)
	...
	Play414441004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 414441004
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(414441004).content)
