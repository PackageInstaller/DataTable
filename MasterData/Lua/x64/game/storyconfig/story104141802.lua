	...
	Play414182001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.366666666666667 < arg_1_1.time_ and arg_1_1.time_ <= 0.366666666666667 + arg_4_0 then
				...
				local var_4_13 = manager.audio:GetAudioName("bgm_side_daily06", "bgm_side_daily06")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				local var_4_17 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414182001).content)
	...
	Play414182002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				arg_9_1:AudioAction("play", "effect", "se_story_5", "se_story_5_robotstop", "")
			end
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(414182002).content)
	...
	Play414182003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(414182003).content)
	...
	Play414182004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				...
				local var_20_1 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(414182004).content)
	...
	Play414182005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_1 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(414182005).content)
	...
	Play414182006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_0 then
				arg_25_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos104902ui_story, Vector3.New(0, 100, 0), (arg_25_1.time_ - 0) / var_28_0)
			...
			if arg_25_1.time_ >= 0 + var_28_0 and arg_25_1.time_ < 0 + var_28_0 + arg_28_0 then
				arg_25_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_25_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_25_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_25_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_25_1.actors_["104902ui_story"].transform.position).z)
				arg_25_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_25_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_25_1.actors_["104902ui_story"].transform.localEulerAngles = arg_25_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				arg_25_1.leftNameTxt_.text = arg_25_1:FormatText(StoryNameCfg[943].name)
				...
				local var_28_3 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(414182006).content)
	...
	Play414182007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				local var_32_1 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(414182007).content)
	...
	Play414182008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				arg_33_1.leftNameTxt_.text = arg_33_1:FormatText(StoryNameCfg[943].name)
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(414182008).content)
	...
	Play414182009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				arg_37_1.leftNameTxt_.text = arg_37_1:FormatText(StoryNameCfg[943].name)
				...
				local var_40_1 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(414182009).content)
	...
	Play414182010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				...
				local var_44_1 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(414182010).content)
	...
	Play414182011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				local var_48_1 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(414182011).content)

				arg_45_1.text_.text = var_48_1

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_3 = 13 <= 0 and var_48_0 or var_48_0 * (utf8.len(var_48_1) / 13)

				if (13 <= 0 and var_48_0 or var_48_0 * (utf8.len(var_48_1) / 13)) > 0 and var_48_0 < var_48_3 then
	...
	Play414182013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				...
				local var_56_1 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(414182013).content)
	...
	Play414182014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				...
				local var_60_1 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(414182014).content)
	...
	Play414182015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				arg_61_1.var_.moveOldPos104902ui_story = arg_61_1.actors_["104902ui_story"].transform.localPosition
			end

			local var_64_0 = 0.001

			if 0 <= arg_61_1.time_ and arg_61_1.time_ < 0 + var_64_0 then
				arg_61_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_61_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_61_1.time_ - 0) / var_64_0)
				arg_61_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_61_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_61_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_61_1.actors_["104902ui_story"].transform.position).z)
				arg_61_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_61_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_61_1.actors_["104902ui_story"].transform.localEulerAngles = arg_61_1.actors_["104902ui_story"].transform.localEulerAngles
			end

			if arg_61_1.time_ >= 0 + var_64_0 and arg_61_1.time_ < 0 + var_64_0 + arg_64_0 then
				arg_61_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, -1.2, -6)
				arg_61_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_61_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_61_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_61_1.actors_["104902ui_story"].transform.position).z)
				arg_61_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_61_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_61_1.actors_["104902ui_story"].transform.localEulerAngles = arg_61_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			local var_64_1 = arg_61_1.actors_["104902ui_story"]

			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 and not isNil(var_64_1) and arg_61_1.var_.characterEffect104902ui_story == nil then
				arg_61_1.var_.characterEffect104902ui_story = var_64_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_64_2 = 0.200000002980232

			if 0 <= arg_61_1.time_ and arg_61_1.time_ < 0 + var_64_2 and not isNil(var_64_1) then
				if arg_61_1.var_.characterEffect104902ui_story and not isNil(var_64_1) then
					arg_61_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_61_1.time_ >= 0 + var_64_2 and arg_61_1.time_ < 0 + var_64_2 + arg_64_0 and not isNil(var_64_1) and arg_61_1.var_.characterEffect104902ui_story then
				arg_61_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_4 + arg_64_0 then
				...
				local var_64_6 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(414182015).content)

				arg_61_1.text_.text = var_64_6

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_8 = 16 <= 0 and var_64_5 or var_64_5 * (utf8.len(var_64_6) / 16)

				if (16 <= 0 and var_64_5 or var_64_5 * (utf8.len(var_64_6) / 16)) > 0 and var_64_5 < var_64_8 then
	...
	Play414182016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_1 + arg_68_0 then
				...
				local var_68_3 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(414182016).content)
	...
	Play414182017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_0 then
				arg_69_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_69_1.time_ - 0) / var_72_0)
			...
			if arg_69_1.time_ >= 0 + var_72_0 and arg_69_1.time_ < 0 + var_72_0 + arg_72_0 then
				arg_69_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, -1.2, -6)
				arg_69_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["104902ui_story"].transform.position).z)
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_69_1.actors_["104902ui_story"].transform.localEulerAngles = arg_69_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			local var_72_1 = arg_69_1.actors_["104902ui_story"]

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 and not isNil(var_72_1) and arg_69_1.var_.characterEffect104902ui_story == nil then
				arg_69_1.var_.characterEffect104902ui_story = var_72_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_72_2 = 0.200000002980232

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_2 and not isNil(var_72_1) then
				if arg_69_1.var_.characterEffect104902ui_story and not isNil(var_72_1) then
					arg_69_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_69_1.time_ >= 0 + var_72_2 and arg_69_1.time_ < 0 + var_72_2 + arg_72_0 and not isNil(var_72_1) and arg_69_1.var_.characterEffect104902ui_story then
				arg_69_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_4 + arg_72_0 then
				...
				local var_72_6 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(414182017).content)

				arg_69_1.text_.text = var_72_6

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_8 = 15 <= 0 and var_72_5 or var_72_5 * (utf8.len(var_72_6) / 15)

				if (15 <= 0 and var_72_5 or var_72_5 * (utf8.len(var_72_6) / 15)) > 0 and var_72_5 < var_72_8 then
