	...
	Play711190201 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_1 = Vector3.New(0, 1, -10)

				manager.ui.mainCamera.transform.localPosition = var_4_1

				local var_4_2 = arg_1_1.bgs_.D999

				arg_1_1.bgs_.D999.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(var_4_1.x, var_4_1.y, 0)
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_6 and arg_1_1.narrativeListGo_.verticalNormalizedPosition >= 0.001 then
				arg_1_1.narrativeListGo_.verticalNormalizedPosition = 0
			end

			if arg_1_1.time_ >= 0 + var_4_6 and arg_1_1.time_ < 0 + var_4_6 + arg_4_0 then
				-- block empty
			end
			...
			if 0.0334 < arg_1_1.time_ and arg_1_1.time_ <= 0.0334 + arg_4_0 then
				local var_4_7 = Object.Instantiate(arg_1_1.narrativeItemGo_)
				local var_4_8 = var_4_7:GetComponent("ComponentCfger")

				ComponentBinder.GetInstance():BindCfgUI(arg_1_0, var_4_7)

				arg_1_0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1028")
				arg_1_0.narr_item_content.text = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(711190201).content)

				var_4_7.transform:SetParent(arg_1_1.narrativeItemGo_.transform.parent)

				var_4_7.transform.localPosition = Vector3(0, 0, 0)
				var_4_7.transform.localScale = Vector3(1, 1, 1)
			...
			if 0.0334 <= arg_1_1.time_ and arg_1_1.time_ < 0.0334 + var_4_9 and arg_1_1.narrativeListGo_.verticalNormalizedPosition >= 0.001 then
				arg_1_1.narrativeListGo_.verticalNormalizedPosition = 0
			end

			if arg_1_1.time_ >= 0.0334 + var_4_9 and arg_1_1.time_ < 0.0334 + var_4_9 + arg_4_0 then
				-- block empty
			end
		end
	...
	Play711190202 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				local var_8_0 = Vector3.New(0, 1, -10)

				manager.ui.mainCamera.transform.localPosition = var_8_0

				local var_8_1 = arg_5_1.bgs_.D999

				arg_5_1.bgs_.D999.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(var_8_0.x, var_8_0.y, 0)
				var_8_1.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_8_2 = var_8_1:GetComponent("SpriteRenderer")

				if var_8_2 and var_8_2.sprite then
					local var_8_3 = 2 * (var_8_1.transform.localPosition - var_8_0).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_8_1.transform.localScale = Vector3.New(var_8_3 / var_8_2.sprite.bounds.size.y < var_8_3 * manager.ui.mainCameraCom_.aspect / var_8_2.sprite.bounds.size.x and var_8_3 * manager.ui.mainCameraCom_.aspect / var_8_2.sprite.bounds.size.x or var_8_3 / var_8_2.sprite.bounds.size.y, var_8_3 / var_8_2.sprite.bounds.size.y < var_8_3 * manager.ui.mainCameraCom_.aspect / var_8_2.sprite.bounds.size.x and var_8_3 * manager.ui.mainCameraCom_.aspect / var_8_2.sprite.bounds.size.x or var_8_3 / var_8_2.sprite.bounds.size.y, 0)
				end
			...
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				local var_8_4 = Object.Instantiate(arg_5_1.narrativeItemGo_)
				local var_8_5 = var_8_4:GetComponent("ComponentCfger")

				ComponentBinder.GetInstance():BindCfgUI(arg_5_0, var_8_4)

				arg_5_0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1119")
				arg_5_0.narr_item_content.text = arg_5_1:FormatText(arg_5_1:GetWordFromCfg(711190202).content)

				var_8_4.transform:SetParent(arg_5_1.narrativeItemGo_.transform.parent)

				var_8_4.transform.localPosition = Vector3(0, 0, 0)
				var_8_4.transform.localScale = Vector3(1, 1, 1)
			...
			if 0 <= arg_5_1.time_ and arg_5_1.time_ < 0 + var_8_6 and arg_5_1.narrativeListGo_.verticalNormalizedPosition >= 0.001 then
				arg_5_1.narrativeListGo_.verticalNormalizedPosition = 0
			end

			if arg_5_1.time_ >= 0 + var_8_6 and arg_5_1.time_ < 0 + var_8_6 + arg_8_0 then
				-- block empty
			end
		end
	...
	Play711190203 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				arg_9_0.narr_item_content.text = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(711190203).content)
	...
	Play711190204 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				arg_13_0.narr_item_content.text = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(711190204).content)
	...
	Play711190205 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				...
				arg_17_0.narr_item_content.text = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(711190205).content)
	...
	Play711190206 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				...
				arg_21_0.narr_item_content.text = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(711190206).content)
	...
	Play711190207 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				...
				arg_25_0.narr_item_content.text = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(711190207).content)
	...
	Play711190208 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				arg_29_0.narr_item_content.text = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(711190208).content)
	...
	Play711190209 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				arg_33_0.narr_item_content.text = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(711190209).content)
	...
	Play711190210 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				arg_37_0.narr_item_content.text = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(711190210).content)
	...
	Play711190211 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				...
				arg_41_0.narr_item_content.text = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(711190211).content)
