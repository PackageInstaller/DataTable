return {
	Play423202001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_13 = arg_1_1.var_.effectzhenzilengyu2
				...
				if not arg_1_1.var_.effectzhenzilengyu2 then
					...
					var_4_13.name = "zhenzilengyu2"
					arg_1_1.var_.effectzhenzilengyu2 = var_4_13
				else
				...
				for iter_4_4, iter_4_5 in ipairs((var_4_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_5.transform.localScale = Vector3.New(iter_4_5.transform.localScale.x / var_4_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_5.transform.localScale.y / var_4_15, iter_4_5.transform.localScale.z)
				end
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_26 + arg_4_0 then
				...
				local var_4_29 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(423202001).content)

				arg_1_1.text_.text = var_4_29

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_31 = 39 <= 0 and var_4_27 or var_4_27 * (utf8.len(var_4_29) / 39)

				if (39 <= 0 and var_4_27 or var_4_27 * (utf8.len(var_4_29) / 39)) > 0 and var_4_27 < var_4_31 then
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0.1 < arg_39_1.time_ and arg_39_1.time_ <= 0.1 + arg_42_0 then
				...
				if not arg_39_1.var_.effectbuqiangzidan2 then
					...
					var_42_11.transform:SetParent(var_42_9001)
				end
			...
			if 0.266 < arg_39_1.time_ and arg_39_1.time_ <= 0.266 + arg_42_0 then
				...
				if not arg_39_1.var_.effectbuqiangzidan3 then
					...
					var_42_14.transform:SetParent(var_42_9000)
				end
			...
			if 0.466 < arg_39_1.time_ and arg_39_1.time_ <= 0.466 + arg_42_0 then
				...
				if not arg_39_1.var_.effectbuqiangzidan4 then
					...
					var_42_17.transform:SetParent(var_42_9002)
				end
