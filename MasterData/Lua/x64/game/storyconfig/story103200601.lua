	...
	Play320061163 = function(arg_677_0, arg_677_1)
		...
		function arg_677_1.onSingleLineUpdate_(arg_680_0)
			if 0 < arg_677_1.time_ and arg_677_1.time_ <= 0 + arg_680_0 then
				...
				for iter_680_0, iter_680_1 in ipairs((var_680_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_680_1.transform.localScale = Vector3.New(iter_680_1.transform.localScale.x / var_680_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_680_1.transform.localScale.y / var_680_2, iter_680_1.transform.localScale.z)
				end
			end

			local var_680_4 = 0
			local var_680_5 = 0.95
			...
			if 0 < arg_677_1.time_ and arg_677_1.time_ <= var_680_4 + arg_680_0 then
				...
				local var_680_6 = arg_677_1:FormatText(arg_677_1:GetWordFromCfg(320061163).content)

				arg_677_1.text_.text = var_680_6

				LuaForUtil.ClearLinePrefixSymbol(arg_677_1.text_)

				local var_680_8 = 38 <= 0 and var_680_5 or var_680_5 * (utf8.len(var_680_6) / 38)

				if (38 <= 0 and var_680_5 or var_680_5 * (utf8.len(var_680_6) / 38)) > 0 and var_680_5 < var_680_8 then
					arg_677_1.talkMaxDuration = var_680_8

					if var_680_8 + var_680_4 > arg_677_1.duration_ then
						arg_677_1.duration_ = var_680_8 + var_680_4
					end
				end
			...
			local var_680_9 = math.max(var_680_5, arg_677_1.talkMaxDuration)

			if var_680_4 <= arg_677_1.time_ and arg_677_1.time_ < var_680_4 + var_680_9 then
				arg_677_1.typewritter.percent = (arg_677_1.time_ - var_680_4) / var_680_9

				arg_677_1.typewritter:SetDirty()
			end

			if arg_677_1.time_ >= var_680_4 + var_680_9 and arg_677_1.time_ < var_680_4 + var_680_9 + arg_680_0 then
