	...
	Play605105001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_0 + arg_4_0 then
				...
				local var_4_3 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(605105001).content)

				arg_1_1.text_.text = var_4_3

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_5 = 54 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 54)

				if (54 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 54)) > 0 and var_4_1 < var_4_5 then
	...
	Play605105002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_3 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(605105002).content)

				arg_7_1.text_.text = var_10_3

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_5 = 87 <= 0 and var_10_1 or var_10_1 * (utf8.len(var_10_3) / 87)

				if (87 <= 0 and var_10_1 or var_10_1 * (utf8.len(var_10_3) / 87)) > 0 and var_10_1 < var_10_5 then
			...
			local var_10_6 = var_10_0 + 0.3
			local var_10_7 = math.max(var_10_1, arg_7_1.talkMaxDuration)

			if var_10_0 + 0.3 <= arg_7_1.time_ and arg_7_1.time_ < var_10_6 + var_10_7 then
				arg_7_1.typewritter.percent = (arg_7_1.time_ - var_10_6) / var_10_7
	...
	Play605105003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				local var_16_1 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(605105003).content)
