	...
	Play320302058 = function(arg_249_0, arg_249_1)
		...
		function arg_249_1.onSingleLineUpdate_(arg_252_0)
			...
			if 0 < arg_249_1.time_ and arg_249_1.time_ <= 0 + arg_252_0 then
				...
				for iter_252_0, iter_252_1 in ipairs((var_252_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_252_1.transform.localScale = Vector3.New(iter_252_1.transform.localScale.x / var_252_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_252_1.transform.localScale.y / var_252_2, iter_252_1.transform.localScale.z)
				end
			end
			...
			local var_252_5 = 0.533333333333333

			if var_252_4 <= arg_249_1.time_ and arg_249_1.time_ < var_252_4 + var_252_5 then
				local var_252_6 = Color.New(0.3962264, 0, 0)

				var_252_6.a = Mathf.Lerp(1, 0, (arg_249_1.time_ - var_252_4) / var_252_5)
			...
			if 0 < arg_249_1.time_ and arg_249_1.time_ <= 0 + arg_252_0 then
				local var_252_9 = arg_249_1.var_.effect222999

				if not arg_249_1.var_.effect222999 then
					var_252_9 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in"), manager.ui.mainCamera.transform)
					var_252_9.name = "999"
					arg_249_1.var_.effect222999 = var_252_9
				else
					var_252_9.transform:SetParent(var_252_9000)
				end

				var_252_9.transform.localPosition = Vector3.New(0, 0, 0)
				var_252_9.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_252_11 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_252_2, iter_252_3 in ipairs((var_252_9.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_252_3.transform.localScale = Vector3.New(iter_252_3.transform.localScale.x / var_252_11 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_252_3.transform.localScale.y / var_252_11, iter_252_3.transform.localScale.z)
				end
			end
			...
			local var_252_13 = 0.833333333333333
			local var_252_14 = 1.7

			if 0.833333333333333 < arg_249_1.time_ and arg_249_1.time_ <= var_252_13 + arg_252_0 then
				...
				local var_252_16 = arg_249_1:FormatText(arg_249_1:GetWordFromCfg(320302058).content)

				arg_249_1.text_.text = var_252_16

				LuaForUtil.ClearLinePrefixSymbol(arg_249_1.text_)

				local var_252_18 = 68 <= 0 and var_252_14 or var_252_14 * (utf8.len(var_252_16) / 68)

				if (68 <= 0 and var_252_14 or var_252_14 * (utf8.len(var_252_16) / 68)) > 0 and var_252_14 < var_252_18 then
	...
	Play320302060 = function(arg_259_0, arg_259_1)
		...
		function arg_259_1.onSingleLineUpdate_(arg_262_0)
			...
			if 0 < arg_259_1.time_ and arg_259_1.time_ <= 0 + arg_262_0 then
				...
				for iter_262_0, iter_262_1 in ipairs((var_262_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_262_1.transform.localScale = Vector3.New(iter_262_1.transform.localScale.x / var_262_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_262_1.transform.localScale.y / var_262_2, iter_262_1.transform.localScale.z)
				end
			end

			if 0 < arg_259_1.time_ and arg_259_1.time_ <= 0 + arg_262_0 then
				local var_262_4 = arg_259_1.var_.effect2221002

				if not arg_259_1.var_.effect2221002 then
					var_262_4 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in_ui_1"), manager.ui.mainCamera.transform)
					var_262_4.name = "1002"
					arg_259_1.var_.effect2221002 = var_262_4
				else
					var_262_4.transform:SetParent(var_262_9000)
				end

				var_262_4.transform.localPosition = Vector3.New(0, 0, 0)
				var_262_4.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_262_6 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_262_2, iter_262_3 in ipairs((var_262_4.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_262_3.transform.localScale = Vector3.New(iter_262_3.transform.localScale.x / var_262_6 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_262_3.transform.localScale.y / var_262_6, iter_262_3.transform.localScale.z)
				end
			end
			...
			if 0 < arg_259_1.time_ and arg_259_1.time_ <= var_262_10 + arg_262_0 then
				...
				local var_262_12 = arg_259_1:FormatText(arg_259_1:GetWordFromCfg(320302060).content)

				arg_259_1.text_.text = var_262_12

				LuaForUtil.ClearLinePrefixSymbol(arg_259_1.text_)

				local var_262_14 = 27 <= 0 and var_262_11 or var_262_11 * (utf8.len(var_262_12) / 27)

				if (27 <= 0 and var_262_11 or var_262_11 * (utf8.len(var_262_12) / 27)) > 0 and var_262_11 < var_262_14 then
