	...
	Play321241018 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 3.53333333333334 < arg_77_1.time_ and arg_77_1.time_ <= 3.53333333333334 + arg_80_0 then
				...
				for iter_80_0, iter_80_1 in ipairs((var_80_1.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_80_1.transform.localScale = Vector3.New(iter_80_1.transform.localScale.x / var_80_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_80_1.transform.localScale.y / var_80_3, iter_80_1.transform.localScale.z)
				end
			end
			...
			local var_80_7 = manager.ui.mainCamera.transform

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				arg_77_1.var_.shakeOldPos = var_80_7.localPosition
			end

			local var_80_8 = 1.1

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_8 then
				local var_80_9, var_80_10 = math.modf((arg_77_1.time_ - 0) / 0.066)

				var_80_7.localPosition = Vector3.New(var_80_10 * 0.13, var_80_10 * 0.13, var_80_10 * 0.13) + arg_77_1.var_.shakeOldPos
			end

			if arg_77_1.time_ >= 0 + var_80_8 and arg_77_1.time_ < 0 + var_80_8 + arg_80_0 then
				var_80_7.localPosition = arg_77_1.var_.shakeOldPos
			end
			...
			if var_80_11 <= arg_77_1.time_ and arg_77_1.time_ < var_80_11 + var_80_12 then
				...
				var_80_13.a = Mathf.Lerp(1, 0, (arg_77_1.time_ - var_80_11) / var_80_12)
			...
			local var_80_19 = 1.76666666666667

			if 1.76666666666667 < arg_77_1.time_ and arg_77_1.time_ <= var_80_19 + arg_80_0 then
				arg_77_1.mask_.enabled = true
				arg_77_1.mask_.raycastTarget = true
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				local var_80_23 = arg_77_1.var_.effect979

				if not arg_77_1.var_.effect979 then
					var_80_23 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_redtwister_keep"), manager.ui.mainCamera.transform)
					var_80_23.name = "979"
					arg_77_1.var_.effect979 = var_80_23
				else
					var_80_23.transform:SetParent(var_80_9000)
				end

				var_80_23.transform.localPosition = Vector3.New(0, 0, 1.06)
				var_80_23.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_80_25 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_80_2, iter_80_3 in ipairs((var_80_23.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_80_3.transform.localScale = Vector3.New(iter_80_3.transform.localScale.x / var_80_25 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_80_3.transform.localScale.y / var_80_25, iter_80_3.transform.localScale.z)
				end
			end
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_28 + arg_80_0 then
				arg_77_1.allBtn_.enabled = false
			end

			if arg_77_1.time_ >= var_80_28 + 5.53333333333333 and arg_77_1.time_ < var_80_28 + 5.53333333333333 + arg_80_0 then
				arg_77_1.allBtn_.enabled = true
			end

			if 1.66666666666667 < arg_77_1.time_ and arg_77_1.time_ <= 1.66666666666667 + arg_80_0 then
				local var_80_29 = arg_77_1.var_.effect978

				if not arg_77_1.var_.effect978 then
					var_80_29 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_redtwister_keep"), manager.ui.mainCamera.transform)
					var_80_29.name = "978"
					arg_77_1.var_.effect978 = var_80_29
				else
					var_80_29.transform:SetParent(var_80_9001)
				end

				var_80_29.transform.localPosition = Vector3.New(0, 0, -1.04)
				var_80_29.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_80_31 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_80_4, iter_80_5 in ipairs((var_80_29.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_80_5.transform.localScale = Vector3.New(iter_80_5.transform.localScale.x / var_80_31 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_80_5.transform.localScale.y / var_80_31, iter_80_5.transform.localScale.z)
				end
			end
			...
			local var_80_34 = 4.66666666666667
			local var_80_35 = 1

			if 4.66666666666667 < arg_77_1.time_ and arg_77_1.time_ <= var_80_34 + arg_80_0 then
				...
				local var_80_36 = LeanTween.value(arg_77_1.dialog_, 0, 1, 0.3)

				var_80_36:setOnUpdate(LuaHelper.FloatAction(function(arg_81_0)
					arg_77_1.dialogCg_.alpha = arg_81_0
				end))
				var_80_36:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_77_1.dialog_)
					var_80_36:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_80_37 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(321241018).content)

				arg_77_1.text_.text = var_80_37

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_39 = 40 <= 0 and var_80_35 or var_80_35 * (utf8.len(var_80_37) / 40)

				if (40 <= 0 and var_80_35 or var_80_35 * (utf8.len(var_80_37) / 40)) > 0 and var_80_35 < var_80_39 then
					arg_77_1.talkMaxDuration = var_80_39
					var_80_34 = var_80_34 + 0.3

					if var_80_39 + var_80_34 > arg_77_1.duration_ then
						arg_77_1.duration_ = var_80_39 + var_80_34
					end
				end
			...
			local var_80_40 = var_80_34 + 0.3
			local var_80_41 = math.max(var_80_35, arg_77_1.talkMaxDuration)

			if var_80_34 + 0.3 <= arg_77_1.time_ and arg_77_1.time_ < var_80_40 + var_80_41 then
	...
	Play321241033 = function(arg_141_0, arg_141_1)
		...
		function arg_141_1.onSingleLineUpdate_(arg_144_0)
			if 0 < arg_141_1.time_ and arg_141_1.time_ <= 0 + arg_144_0 then
				...
				for iter_144_0, iter_144_1 in ipairs((var_144_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_144_1.transform.localScale = Vector3.New(iter_144_1.transform.localScale.x / var_144_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_144_1.transform.localScale.y / var_144_2, iter_144_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_141_1.time_ and arg_141_1.time_ <= var_144_4 + arg_144_0 then
				...
				local var_144_6 = arg_141_1:GetWordFromCfg(321241033)
				...
				if manager.audio:GetVoiceLength("story_v_out_321241", "321241033", "story_v_out_321241.awb") ~= 0 then
					local var_144_10 = manager.audio:GetVoiceLength("story_v_out_321241", "321241033", "story_v_out_321241.awb") / 1000
					...
					if var_144_6.prefab_name ~= "" and arg_141_1.actors_[var_144_6.prefab_name] ~= nil then
						local var_144_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_141_1.actors_[var_144_6.prefab_name].transform, "story_v_out_321241", "321241033", "story_v_out_321241.awb")

						arg_141_1:RecordAudio("321241033", var_144_11)
						arg_141_1:RecordAudio("321241033", var_144_11)
					else
