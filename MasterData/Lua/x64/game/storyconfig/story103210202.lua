	...
	Play321022004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0.2 < arg_17_1.time_ and arg_17_1.time_ <= 0.2 + arg_20_0 then
				...
				for iter_20_0, iter_20_1 in ipairs((var_20_7.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_20_1.transform.localScale = Vector3.New(iter_20_1.transform.localScale.x / var_20_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_20_1.transform.localScale.y / var_20_9, iter_20_1.transform.localScale.z)
				end
			end
			...
			local var_20_12 = 0.833333333333333
			local var_20_13 = 1.225

			if 0.833333333333333 < arg_17_1.time_ and arg_17_1.time_ <= var_20_12 + arg_20_0 then
				...
				local var_20_15 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(321022004).content)

				arg_17_1.text_.text = var_20_15

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_17 = 49 <= 0 and var_20_13 or var_20_13 * (utf8.len(var_20_15) / 49)

				if (49 <= 0 and var_20_13 or var_20_13 * (utf8.len(var_20_15) / 49)) > 0 and var_20_13 < var_20_17 then
