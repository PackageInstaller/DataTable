	...
	Play419081095 = function(arg_387_0, arg_387_1)
		...
		function arg_387_1.onSingleLineUpdate_(arg_390_0)
			...
			if 0 < arg_387_1.time_ and arg_387_1.time_ <= 0 + arg_390_0 then
				...
				for iter_390_0, iter_390_1 in ipairs((var_390_7.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_390_1.transform.localScale = Vector3.New(iter_390_1.transform.localScale.x / var_390_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_390_1.transform.localScale.y / var_390_9, iter_390_1.transform.localScale.z)
				end
			end
			...
			if 0.866 < arg_387_1.time_ and arg_387_1.time_ <= 0.866 + arg_390_0 then
				local var_390_12 = arg_387_1.var_.effectyanchen1

				if not arg_387_1.var_.effectyanchen1 then
					var_390_12 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_dust"), manager.ui.mainCamera.transform)
					var_390_12.name = "yanchen1"
					arg_387_1.var_.effectyanchen1 = var_390_12
				else
					var_390_12.transform:SetParent(var_390_9000)
				end

				var_390_12.transform.localPosition = Vector3.New(0, 0, 0)
				var_390_12.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_390_14 = 0.034000001847744

			if 0.034000001847744 < arg_387_1.time_ and arg_387_1.time_ <= var_390_14 + arg_390_0 then
				arg_387_1.allBtn_.enabled = false
			end

			if arg_387_1.time_ >= var_390_14 + 1.43266666481892 and arg_387_1.time_ < var_390_14 + 1.43266666481892 + arg_390_0 then
			...
			local var_390_17 = 1.46666666666667
			local var_390_18 = 1.3

			if 1.46666666666667 < arg_387_1.time_ and arg_387_1.time_ <= var_390_17 + arg_390_0 then
				...
				local var_390_19 = LeanTween.value(arg_387_1.dialog_, 0, 1, 0.3)

				var_390_19:setOnUpdate(LuaHelper.FloatAction(function(arg_391_0)
					arg_387_1.dialogCg_.alpha = arg_391_0
				end))
				var_390_19:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_387_1.dialog_)
					var_390_19:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_390_20 = arg_387_1:FormatText(arg_387_1:GetWordFromCfg(419081095).content)

				arg_387_1.text_.text = var_390_20

				LuaForUtil.ClearLinePrefixSymbol(arg_387_1.text_)

				local var_390_22 = 52 <= 0 and var_390_18 or var_390_18 * (utf8.len(var_390_20) / 52)

				if (52 <= 0 and var_390_18 or var_390_18 * (utf8.len(var_390_20) / 52)) > 0 and var_390_18 < var_390_22 then
					arg_387_1.talkMaxDuration = var_390_22
					var_390_17 = var_390_17 + 0.3

					if var_390_22 + var_390_17 > arg_387_1.duration_ then
						arg_387_1.duration_ = var_390_22 + var_390_17
					end
				end
			...
			local var_390_23 = var_390_17 + 0.3
			local var_390_24 = math.max(var_390_18, arg_387_1.talkMaxDuration)

			if var_390_17 + 0.3 <= arg_387_1.time_ and arg_387_1.time_ < var_390_23 + var_390_24 then
				arg_387_1.typewritter.percent = (arg_387_1.time_ - var_390_23) / var_390_24
