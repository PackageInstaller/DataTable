	...
	Play1103403065 = function(arg_238_0, arg_238_1)
		...
		function arg_238_1.onSingleLineUpdate_(arg_241_0)
			...
			if 2 < arg_238_1.time_ and arg_238_1.time_ <= 2 + arg_241_0 then
				...
				for iter_241_2, iter_241_3 in ipairs((var_241_14.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_241_3.transform.localScale = Vector3.New(iter_241_3.transform.localScale.x / var_241_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_241_3.transform.localScale.y / var_241_16, iter_241_3.transform.localScale.z)
				end
			end
			...
			local var_241_19 = 2.8
			local var_241_20 = 1.075

			if 2.8 < arg_238_1.time_ and arg_238_1.time_ <= var_241_19 + arg_241_0 then
				...
				local var_241_21 = LeanTween.value(arg_238_1.dialog_, 0, 1, 0.3)

				var_241_21:setOnUpdate(LuaHelper.FloatAction(function(arg_242_0)
					arg_238_1.dialogCg_.alpha = arg_242_0
				end))
				var_241_21:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_238_1.dialog_)
					var_241_21:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_241_22 = arg_238_1:FormatText(arg_238_1:GetWordFromCfg(1103403065).content)

				arg_238_1.text_.text = var_241_22

				LuaForUtil.ClearLinePrefixSymbol(arg_238_1.text_)

				local var_241_24 = 43 <= 0 and var_241_20 or var_241_20 * (utf8.len(var_241_22) / 43)

				if (43 <= 0 and var_241_20 or var_241_20 * (utf8.len(var_241_22) / 43)) > 0 and var_241_20 < var_241_24 then
					arg_238_1.talkMaxDuration = var_241_24
					var_241_19 = var_241_19 + 0.3

					if var_241_24 + var_241_19 > arg_238_1.duration_ then
						arg_238_1.duration_ = var_241_24 + var_241_19
					end
				end
			...
			local var_241_25 = var_241_19 + 0.3
			local var_241_26 = math.max(var_241_20, arg_238_1.talkMaxDuration)

			if var_241_19 + 0.3 <= arg_238_1.time_ and arg_238_1.time_ < var_241_25 + var_241_26 then
	...
	Play1103403066 = function(arg_244_0, arg_244_1)
		...
		function arg_244_1.onSingleLineUpdate_(arg_247_0)
			if 0 < arg_244_1.time_ and arg_244_1.time_ <= 0 + arg_247_0 then
				...
				for iter_247_0, iter_247_1 in ipairs((var_247_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_247_1.transform.localScale = Vector3.New(iter_247_1.transform.localScale.x / var_247_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_247_1.transform.localScale.y / var_247_2, iter_247_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_244_1.time_ and arg_244_1.time_ <= 0 + arg_247_0 then
				...
				local var_247_6 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_244_1.bgmTxt_.text ~= var_247_6 and arg_244_1.bgmTxt_.text ~= "" then
						if arg_244_1.bgmTxt2_.text ~= "" then
							arg_244_1.bgmTxt_.text = arg_244_1.bgmTxt2_.text
						end

						arg_244_1.bgmTxt2_.text = var_247_6

						arg_244_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_244_1.bgmTxt_.text = var_247_6
						arg_244_1.bgmTxt2_.text = var_247_6
					end
			...
			if 0.4 < arg_244_1.time_ and arg_244_1.time_ <= 0.4 + arg_247_0 then
				...
				local var_247_9 = manager.audio:GetAudioName("bgm_activity_3_0_story_intense_argue", "bgm_activity_3_0_story_intense_argue")

				if "" ~= "" then
					if arg_244_1.bgmTxt_.text ~= var_247_9 and arg_244_1.bgmTxt_.text ~= "" then
						if arg_244_1.bgmTxt2_.text ~= "" then
							arg_244_1.bgmTxt_.text = arg_244_1.bgmTxt2_.text
						end

						arg_244_1.bgmTxt2_.text = var_247_9

						arg_244_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_244_1.bgmTxt_.text = var_247_9
						arg_244_1.bgmTxt2_.text = var_247_9
					end
			...
			if 0 < arg_244_1.time_ and arg_244_1.time_ <= var_247_10 + arg_247_0 then
				...
				local var_247_12 = arg_244_1:FormatText(arg_244_1:GetWordFromCfg(1103403066).content)

				arg_244_1.text_.text = var_247_12

				LuaForUtil.ClearLinePrefixSymbol(arg_244_1.text_)

				local var_247_14 = 52 <= 0 and var_247_11 or var_247_11 * (utf8.len(var_247_12) / 52)

				if (52 <= 0 and var_247_11 or var_247_11 * (utf8.len(var_247_12) / 52)) > 0 and var_247_11 < var_247_14 then
					arg_244_1.talkMaxDuration = var_247_14

					if var_247_14 + var_247_10 > arg_244_1.duration_ then
						arg_244_1.duration_ = var_247_14 + var_247_10
					end
				end
			...
			local var_247_15 = math.max(var_247_11, arg_244_1.talkMaxDuration)

			if var_247_10 <= arg_244_1.time_ and arg_244_1.time_ < var_247_10 + var_247_15 then
				arg_244_1.typewritter.percent = (arg_244_1.time_ - var_247_10) / var_247_15

				arg_244_1.typewritter:SetDirty()
			end

			if arg_244_1.time_ >= var_247_10 + var_247_15 and arg_244_1.time_ < var_247_10 + var_247_15 + arg_247_0 then
	...
	Play1103403075 = function(arg_282_0, arg_282_1)
		...
		function arg_282_1.onSingleLineUpdate_(arg_285_0)
			...
			if 0 < arg_282_1.time_ and arg_282_1.time_ <= var_285_8 + arg_285_0 then
				...
				local var_285_10 = arg_282_1:FormatText(arg_282_1:GetWordFromCfg(1103403075).content)

				arg_282_1.text_.text = var_285_10

				LuaForUtil.ClearLinePrefixSymbol(arg_282_1.text_)

				local var_285_12 = 58 <= 0 and var_285_9 or var_285_9 * (utf8.len(var_285_10) / 58)

				if (58 <= 0 and var_285_9 or var_285_9 * (utf8.len(var_285_10) / 58)) > 0 and var_285_9 < var_285_12 then
