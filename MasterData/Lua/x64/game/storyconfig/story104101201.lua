	...
	Play410121001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				...
				local var_4_26 = arg_1_1:GetWordFromCfg(410121001)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121001", "story_v_out_410121.awb") ~= 0 then
					local var_4_30 = manager.audio:GetVoiceLength("story_v_out_410121", "410121001", "story_v_out_410121.awb") / 1000
					...
					if var_4_26.prefab_name ~= "" and arg_1_1.actors_[var_4_26.prefab_name] ~= nil then
						local var_4_31 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_26.prefab_name].transform, "story_v_out_410121", "410121001", "story_v_out_410121.awb")

						arg_1_1:RecordAudio("410121001", var_4_31)
						arg_1_1:RecordAudio("410121001", var_4_31)
					else
	...
	Play410121002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_5 + arg_12_0 then
				...
				local var_12_7 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(410121002).content)

				arg_9_1.text_.text = var_12_7

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_9 = 55 <= 0 and var_12_6 or var_12_6 * (utf8.len(var_12_7) / 55)

				if (55 <= 0 and var_12_6 or var_12_6 * (utf8.len(var_12_7) / 55)) > 0 and var_12_6 < var_12_9 then
	...
	Play410121003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				local var_16_1 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(410121003).content)
	...
	Play410121004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				...
				arg_17_1.leftNameTxt_.text = arg_17_1:FormatText(StoryNameCfg[68].name)
				...
				local var_20_1 = arg_17_1:GetWordFromCfg(410121004)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121004", "story_v_out_410121.awb") ~= 0 then
					local var_20_5 = manager.audio:GetVoiceLength("story_v_out_410121", "410121004", "story_v_out_410121.awb") / 1000
					...
					if var_20_1.prefab_name ~= "" and arg_17_1.actors_[var_20_1.prefab_name] ~= nil then
						local var_20_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_1.prefab_name].transform, "story_v_out_410121", "410121004", "story_v_out_410121.awb")

						arg_17_1:RecordAudio("410121004", var_20_6)
						arg_17_1:RecordAudio("410121004", var_20_6)
					else
	...
	Play410121005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_5 + arg_24_0 then
				...
				local var_24_7 = arg_21_1:GetWordFromCfg(410121005)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121005", "story_v_out_410121.awb") ~= 0 then
					local var_24_11 = manager.audio:GetVoiceLength("story_v_out_410121", "410121005", "story_v_out_410121.awb") / 1000
					...
					if var_24_7.prefab_name ~= "" and arg_21_1.actors_[var_24_7.prefab_name] ~= nil then
						local var_24_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_7.prefab_name].transform, "story_v_out_410121", "410121005", "story_v_out_410121.awb")

						arg_21_1:RecordAudio("410121005", var_24_12)
						arg_21_1:RecordAudio("410121005", var_24_12)
					else
	...
	Play410121006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_5 + arg_28_0 then
				...
				local var_28_7 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(410121006).content)

				arg_25_1.text_.text = var_28_7

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_9 = 34 <= 0 and var_28_6 or var_28_6 * (utf8.len(var_28_7) / 34)

				if (34 <= 0 and var_28_6 or var_28_6 * (utf8.len(var_28_7) / 34)) > 0 and var_28_6 < var_28_9 then
	...
	Play410121007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				...
				local var_32_1 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(410121007).content)
	...
	Play410121008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_5 + arg_36_0 then
				...
				local var_36_7 = arg_33_1:GetWordFromCfg(410121008)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121008", "story_v_out_410121.awb") ~= 0 then
					local var_36_11 = manager.audio:GetVoiceLength("story_v_out_410121", "410121008", "story_v_out_410121.awb") / 1000
					...
					if var_36_7.prefab_name ~= "" and arg_33_1.actors_[var_36_7.prefab_name] ~= nil then
						local var_36_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_7.prefab_name].transform, "story_v_out_410121", "410121008", "story_v_out_410121.awb")

						arg_33_1:RecordAudio("410121008", var_36_12)
						arg_33_1:RecordAudio("410121008", var_36_12)
					else
	...
	Play410121009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_5 + arg_40_0 then
				...
				local var_40_7 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(410121009).content)

				arg_37_1.text_.text = var_40_7

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_9 = 43 <= 0 and var_40_6 or var_40_6 * (utf8.len(var_40_7) / 43)

				if (43 <= 0 and var_40_6 or var_40_6 * (utf8.len(var_40_7) / 43)) > 0 and var_40_6 < var_40_9 then
	...
	Play410121010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1:AudioAction("play", "effect", "se_story_128", "se_story_128_stab", "")
			end
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(410121010).content)
	...
	Play410121011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				local var_48_1 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(410121011).content)

				arg_45_1.text_.text = var_48_1

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_3 = 68 <= 0 and var_48_0 or var_48_0 * (utf8.len(var_48_1) / 68)

				if (68 <= 0 and var_48_0 or var_48_0 * (utf8.len(var_48_1) / 68)) > 0 and var_48_0 < var_48_3 then
	...
	Play410121012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_5 + arg_52_0 then
				...
				local var_52_7 = arg_49_1:GetWordFromCfg(410121012)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121012", "story_v_out_410121.awb") ~= 0 then
					local var_52_11 = manager.audio:GetVoiceLength("story_v_out_410121", "410121012", "story_v_out_410121.awb") / 1000
					...
					if var_52_7.prefab_name ~= "" and arg_49_1.actors_[var_52_7.prefab_name] ~= nil then
						local var_52_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_7.prefab_name].transform, "story_v_out_410121", "410121012", "story_v_out_410121.awb")

						arg_49_1:RecordAudio("410121012", var_52_12)
						arg_49_1:RecordAudio("410121012", var_52_12)
					else
	...
	Play410121013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_2 + arg_56_0 then
				...
				local var_56_4 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(410121013).content)
	...
	Play410121014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				...
				local var_60_1 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(410121014).content)
	...
	Play410121015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_5 + arg_64_0 then
				...
				local var_64_7 = arg_61_1:GetWordFromCfg(410121015)
				...
				local var_64_10 = 6 <= 0 and var_64_6 or var_64_6 * (utf8.len(var_64_8) / 6)

				if (6 <= 0 and var_64_6 or var_64_6 * (utf8.len(var_64_8) / 6)) > 0 and var_64_6 < var_64_10 then
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121015", "story_v_out_410121.awb") ~= 0 then
					local var_64_11 = manager.audio:GetVoiceLength("story_v_out_410121", "410121015", "story_v_out_410121.awb") / 1000
					...
					if var_64_7.prefab_name ~= "" and arg_61_1.actors_[var_64_7.prefab_name] ~= nil then
						local var_64_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_61_1.actors_[var_64_7.prefab_name].transform, "story_v_out_410121", "410121015", "story_v_out_410121.awb")

						arg_61_1:RecordAudio("410121015", var_64_12)
						arg_61_1:RecordAudio("410121015", var_64_12)
					else
