return {
	Play911011001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 911011001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_5 = 1.96666666666667

			if var_4_4 <= arg_1_1.time_ and arg_1_1.time_ < var_4_4 + var_4_5 then
				local var_4_6 = Color.New(0.0471698, 0.0471698, 0.0471698)
			...
			if arg_1_1.time_ >= var_4_4 + var_4_5 and arg_1_1.time_ < var_4_4 + var_4_5 + arg_4_0 then
				local var_4_7 = Color.New(0.0471698, 0.0471698, 0.0471698)
			...
			local var_4_8 = 1.96666666666667
			local var_4_9 = 0.8

			if 1.96666666666667 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(911011001).content)

				arg_1_1.text_.text = var_4_11

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_13 = 32 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 32)

				if (32 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 32)) > 0 and var_4_9 < var_4_13 then
	...
	Play911011002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 911011002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(911011002).content)
	...
	Play911011003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 911011003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play911011004(arg_11_1)
			end
		end

		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if arg_11_1.actors_["1049ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1049ui_story"))) then
				local var_14_0 = Object.Instantiate(Asset.Load("Char/" .. "1049ui_story"), arg_11_1.stage_.transform)

				var_14_0.name = "1049ui_story"
				var_14_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_11_1.actors_["1049ui_story"] = var_14_0
				...
				arg_11_1.var_["1049ui_story" .. "Animator"] = var_14_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_11_1.var_["1049ui_story" .. "Animator"].applyRootMotion = true
				arg_11_1.var_["1049ui_story" .. "LipSync"] = var_14_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_14_3 = arg_11_1.actors_["1049ui_story"].transform

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				arg_11_1.var_.moveOldPos1049ui_story = var_14_3.localPosition

				arg_11_1:ShowWeapon(arg_11_1.var_["1049ui_story" .. "Animator"].transform, false)
			end

			local var_14_4 = 0.001

			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_4 then
				var_14_3.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1049ui_story, Vector3.New(0, -1.2, -6), (arg_11_1.time_ - 0) / var_14_4)
			...
			if arg_11_1.time_ >= 0 + var_14_4 and arg_11_1.time_ < 0 + var_14_4 + arg_14_0 then
				var_14_3.localPosition = Vector3.New(0, -1.2, -6)
				var_14_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_14_3.position).x, (manager.ui.mainCamera.transform.position - var_14_3.position).y, (manager.ui.mainCamera.transform.position - var_14_3.position).z)
				var_14_3.localEulerAngles.z = 0
				var_14_3.localEulerAngles.x = 0
				var_14_3.localEulerAngles = var_14_3.localEulerAngles
			...
			local var_14_5 = arg_11_1.actors_["1049ui_story"]

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 and not isNil(var_14_5) and arg_11_1.var_.characterEffect1049ui_story == nil then
				arg_11_1.var_.characterEffect1049ui_story = var_14_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_14_6 = 0.200000002980232

			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_6 and not isNil(var_14_5) then
				if arg_11_1.var_.characterEffect1049ui_story and not isNil(var_14_5) then
					arg_11_1.var_.characterEffect1049ui_story.fillFlat = false
				end
			end

			if arg_11_1.time_ >= 0 + var_14_6 and arg_11_1.time_ < 0 + var_14_6 + arg_14_0 and not isNil(var_14_5) and arg_11_1.var_.characterEffect1049ui_story then
				arg_11_1.var_.characterEffect1049ui_story.fillFlat = false
			end

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				arg_11_1:PlayTimeline("1049ui_story", "StoryTimeline/CharAction/story1049/story1049action/1049action4_1")
			end
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_8 + arg_14_0 then
				...
				local var_14_10 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(911011003).content)
	...
	Play911011004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 911011004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play911011005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 then
				...
				local var_18_3 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(911011004).content)
	...
	Play911011005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 911011005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play911011006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_0 then
				arg_19_1.actors_["1049ui_story"].transform.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos1049ui_story, Vector3.New(0, -1.2, -6), (arg_19_1.time_ - 0) / var_22_0)
			...
			if arg_19_1.time_ >= 0 + var_22_0 and arg_19_1.time_ < 0 + var_22_0 + arg_22_0 then
				arg_19_1.actors_["1049ui_story"].transform.localPosition = Vector3.New(0, -1.2, -6)
				arg_19_1.actors_["1049ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_19_1.actors_["1049ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["1049ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["1049ui_story"].transform.position).z)
				arg_19_1.actors_["1049ui_story"].transform.localEulerAngles.z = 0
				arg_19_1.actors_["1049ui_story"].transform.localEulerAngles.x = 0
				arg_19_1.actors_["1049ui_story"].transform.localEulerAngles = arg_19_1.actors_["1049ui_story"].transform.localEulerAngles
			...
			local var_22_1 = arg_19_1.actors_["1049ui_story"]

			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 and not isNil(var_22_1) and arg_19_1.var_.characterEffect1049ui_story == nil then
				arg_19_1.var_.characterEffect1049ui_story = var_22_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_22_2 = 0.200000002980232

			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_2 and not isNil(var_22_1) then
				if arg_19_1.var_.characterEffect1049ui_story and not isNil(var_22_1) then
					arg_19_1.var_.characterEffect1049ui_story.fillFlat = false
				end
			end

			if arg_19_1.time_ >= 0 + var_22_2 and arg_19_1.time_ < 0 + var_22_2 + arg_22_0 and not isNil(var_22_1) and arg_19_1.var_.characterEffect1049ui_story then
				arg_19_1.var_.characterEffect1049ui_story.fillFlat = false
			end

			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				arg_19_1:PlayTimeline("1049ui_story", "StoryTimeline/CharAction/story1049/story1049action/1049action4_2")
			end

			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				arg_19_1:PlayTimeline("1049ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1101cva")
			end

			local var_22_4 = 0
			local var_22_5 = 0.275
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_4 + arg_22_0 then
				...
				local var_22_6 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(911011005).content)

				arg_19_1.text_.text = var_22_6

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_8 = 11 <= 0 and var_22_5 or var_22_5 * (utf8.len(var_22_6) / 11)

				if (11 <= 0 and var_22_5 or var_22_5 * (utf8.len(var_22_6) / 11)) > 0 and var_22_5 < var_22_8 then
	...
	Play911011006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 911011006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play911011007(arg_23_1)
			end
		end

		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 and not isNil(arg_23_1.actors_["1049ui_story"]) and arg_23_1.var_.characterEffect1049ui_story == nil then
				arg_23_1.var_.characterEffect1049ui_story = arg_23_1.actors_["1049ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_26_0 = 0.200000002980232

			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_0 and not isNil(arg_23_1.actors_["1049ui_story"]) then
				if arg_23_1.var_.characterEffect1049ui_story and not isNil(arg_23_1.actors_["1049ui_story"]) then
					arg_23_1.var_.characterEffect1049ui_story.fillFlat = true
					arg_23_1.var_.characterEffect1049ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_23_1.time_ - 0) / var_26_0)
				end
			end

			if arg_23_1.time_ >= 0 + var_26_0 and arg_23_1.time_ < 0 + var_26_0 + arg_26_0 and not isNil(arg_23_1.actors_["1049ui_story"]) and arg_23_1.var_.characterEffect1049ui_story then
				arg_23_1.var_.characterEffect1049ui_story.fillFlat = true
				arg_23_1.var_.characterEffect1049ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				...
				arg_23_1.leftNameTxt_.text = arg_23_1:FormatText(StoryNameCfg[945].name)
				...
				arg_23_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_2121")
				...
				local var_26_3 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(911011006).content)

				arg_23_1.text_.text = var_26_3

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_5 = 2 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 2)

				if (2 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 2)) > 0 and var_26_2 < var_26_5 then
	...
	Play911011007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 911011007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play911011008(arg_27_1)
			end
		end
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				...
				local var_30_1 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(911011007).content)

				arg_27_1.text_.text = var_30_1

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_3 = 22 <= 0 and var_30_0 or var_30_0 * (utf8.len(var_30_1) / 22)

				if (22 <= 0 and var_30_0 or var_30_0 * (utf8.len(var_30_1) / 22)) > 0 and var_30_0 < var_30_3 then
	...
	Play911011008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 911011008
		...
		function arg_31_1.playNext_(arg_33_0)
			if arg_33_0 == 1 then
				arg_31_0:Play911011009(arg_31_1)
			end
		end
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				...
				arg_31_1.leftNameTxt_.text = arg_31_1:FormatText(StoryNameCfg[945].name)
				...
				arg_31_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_2121")
				...
				local var_34_1 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(911011008).content)

				arg_31_1.text_.text = var_34_1

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_3 = 5 <= 0 and var_34_0 or var_34_0 * (utf8.len(var_34_1) / 5)

				if (5 <= 0 and var_34_0 or var_34_0 * (utf8.len(var_34_1) / 5)) > 0 and var_34_0 < var_34_3 then
	...
	Play911011009 = function(arg_35_0, arg_35_1)
		arg_35_1.time_ = 0
		arg_35_1.frameCnt_ = 0
		arg_35_1.state_ = "playing"
		arg_35_1.curTalkId_ = 911011009
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				...
				local var_38_1 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(911011009).content)
