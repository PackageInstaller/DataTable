	...
	Play423012001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				for iter_4_9, iter_4_10 in ipairs((var_4_27.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_10.transform.localScale = Vector3.New(iter_4_10.transform.localScale.x / var_4_29 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_10.transform.localScale.y / var_4_29, iter_4_10.transform.localScale.z)
				end
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_31 + arg_4_0 then
				...
				local var_4_34 = arg_1_1:GetWordFromCfg(423012001)
				...
				local var_4_37 = 17 <= 0 and var_4_32 or var_4_32 * (utf8.len(var_4_35) / 17)

				if (17 <= 0 and var_4_32 or var_4_32 * (utf8.len(var_4_35) / 17)) > 0 and var_4_32 < var_4_37 then
				...
				if manager.audio:GetVoiceLength("story_v_out_423012", "423012001", "story_v_out_423012.awb") ~= 0 then
					local var_4_38 = manager.audio:GetVoiceLength("story_v_out_423012", "423012001", "story_v_out_423012.awb") / 1000
					...
					if var_4_34.prefab_name ~= "" and arg_1_1.actors_[var_4_34.prefab_name] ~= nil then
						local var_4_39 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_34.prefab_name].transform, "story_v_out_423012", "423012001", "story_v_out_423012.awb")

						arg_1_1:RecordAudio("423012001", var_4_39)
						arg_1_1:RecordAudio("423012001", var_4_39)
					else
