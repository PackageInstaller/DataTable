	...
	Play423101012 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 1 < arg_51_1.time_ and arg_51_1.time_ <= 1 + arg_54_0 then
				...
				for iter_54_1, iter_54_2 in ipairs((var_54_10.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_54_2.transform.localScale = Vector3.New(iter_54_2.transform.localScale.x / var_54_12 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_54_2.transform.localScale.y / var_54_12, iter_54_2.transform.localScale.z)
				end
			end
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 then
				...
				local var_54_16 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_51_1.bgmTxt_.text ~= var_54_16 and arg_51_1.bgmTxt_.text ~= "" then
						if arg_51_1.bgmTxt2_.text ~= "" then
							arg_51_1.bgmTxt_.text = arg_51_1.bgmTxt2_.text
						end

						arg_51_1.bgmTxt2_.text = var_54_16

						arg_51_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_51_1.bgmTxt_.text = var_54_16
						arg_51_1.bgmTxt2_.text = var_54_16
					end
			...
			if 0.500666666666667 < arg_51_1.time_ and arg_51_1.time_ <= 0.500666666666667 + arg_54_0 then
				...
				local var_54_19 = manager.audio:GetAudioName("bgm_activity_4_4_story_nervous", "bgm_activity_4_4_story_nervous")
			...
			local var_54_21 = 2.6
			local var_54_22 = 1.875

			if 2.6 < arg_51_1.time_ and arg_51_1.time_ <= var_54_21 + arg_54_0 then
				...
				local var_54_23 = LeanTween.value(arg_51_1.dialog_, 0, 1, 0.3)

				var_54_23:setOnUpdate(LuaHelper.FloatAction(function(arg_57_0)
					arg_51_1.dialogCg_.alpha = arg_57_0
				end))
				var_54_23:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_51_1.dialog_)
					var_54_23:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_54_24 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(423101012).content)

				arg_51_1.text_.text = var_54_24

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_26 = 75 <= 0 and var_54_22 or var_54_22 * (utf8.len(var_54_24) / 75)

				if (75 <= 0 and var_54_22 or var_54_22 * (utf8.len(var_54_24) / 75)) > 0 and var_54_22 < var_54_26 then
					arg_51_1.talkMaxDuration = var_54_26
					var_54_21 = var_54_21 + 0.3

					if var_54_26 + var_54_21 > arg_51_1.duration_ then
						arg_51_1.duration_ = var_54_26 + var_54_21
					end
				end
			...
			local var_54_27 = var_54_21 + 0.3
			local var_54_28 = math.max(var_54_22, arg_51_1.talkMaxDuration)

			if var_54_21 + 0.3 <= arg_51_1.time_ and arg_51_1.time_ < var_54_27 + var_54_28 then
