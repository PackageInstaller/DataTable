return {
	Play937081001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 937081001
		arg_1_1.duration_ = 7
		...
		function arg_1_1.playNext_(arg_3_0)
			if arg_3_0 == 1 then
				arg_1_0:Play937081002(arg_1_1)
			end
		end

		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.bgs_.ST14 == nil then
				local var_4_0 = Object.Instantiate(arg_1_1.paintGo_)

				var_4_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "ST14")
				var_4_0.name = "ST14"
				var_4_0.transform.parent = arg_1_1.stage_.transform
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.bgs_.ST14 = var_4_0
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_1 = arg_1_1.bgs_.ST14

				arg_1_1.bgs_.ST14.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_14 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_1_1.time_ - 2) / var_4_14)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1066ui_story == nil then
			...
			if arg_1_1.time_ >= 2 + var_4_16 and arg_1_1.time_ < 2 + var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1066ui_story then
				arg_1_1.var_.characterEffect1066ui_story.fillFlat = false
			end

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 then
				arg_1_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action8_1")
			end

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 then
				arg_1_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface2101cva", "EmotionTimelineAnimator")
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				local var_4_27 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(937081001).content)
	...
	Play937081002 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 937081002
		arg_9_1.duration_ = 5
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(937081002).content)
	...
	Play937081003 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 937081003
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play937081004(arg_13_1)
			end
		end

		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos1066ui_story = arg_13_1.actors_["1066ui_story"].transform.localPosition
			end

			local var_16_0 = 0.001

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_0 then
				arg_13_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_13_1.time_ - 0) / var_16_0)
				arg_13_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_13_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1066ui_story"].transform.position).z)
				arg_13_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_13_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_13_1.actors_["1066ui_story"].transform.localEulerAngles = arg_13_1.actors_["1066ui_story"].transform.localEulerAngles
			end

			if arg_13_1.time_ >= 0 + var_16_0 and arg_13_1.time_ < 0 + var_16_0 + arg_16_0 then
				arg_13_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_13_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_13_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_13_1.actors_["1066ui_story"].transform.position).z)
				arg_13_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_13_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_13_1.actors_["1066ui_story"].transform.localEulerAngles = arg_13_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			local var_16_1 = arg_13_1.actors_["1066ui_story"]

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 and not isNil(var_16_1) and arg_13_1.var_.characterEffect1066ui_story == nil then
				arg_13_1.var_.characterEffect1066ui_story = var_16_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_16_2 = 0.200000002980232

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_2 and not isNil(var_16_1) then
				if arg_13_1.var_.characterEffect1066ui_story and not isNil(var_16_1) then
					arg_13_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_13_1.time_ >= 0 + var_16_2 and arg_13_1.time_ < 0 + var_16_2 + arg_16_0 and not isNil(var_16_1) and arg_13_1.var_.characterEffect1066ui_story then
				arg_13_1.var_.characterEffect1066ui_story.fillFlat = false
			end

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action8_2")
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_4 + arg_16_0 then
				...
				local var_16_6 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(937081003).content)

				arg_13_1.text_.text = var_16_6

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_8 = 18 <= 0 and var_16_5 or var_16_5 * (utf8.len(var_16_6) / 18)

				if (18 <= 0 and var_16_5 or var_16_5 * (utf8.len(var_16_6) / 18)) > 0 and var_16_5 < var_16_8 then
	...
	Play937081004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 937081004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play937081005(arg_17_1)
			end
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(937081004).content)
	...
	Play937081005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 937081005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play937081006(arg_21_1)
			end
		end
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action1_1")
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_4 + arg_24_0 then
				...
				local var_24_6 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(937081005).content)

				arg_21_1.text_.text = var_24_6

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_8 = 20 <= 0 and var_24_5 or var_24_5 * (utf8.len(var_24_6) / 20)

				if (20 <= 0 and var_24_5 or var_24_5 * (utf8.len(var_24_6) / 20)) > 0 and var_24_5 < var_24_8 then
	...
	Play937081006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 937081006
		...
		function arg_25_1.playNext_(arg_27_0)
			if arg_27_0 == 1 then
				arg_25_0:Play937081007(arg_25_1)
			end
		end
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(937081006).content)
	...
	Play937081007 = function(arg_29_0, arg_29_1)
		arg_29_1.time_ = 0
		arg_29_1.frameCnt_ = 0
		arg_29_1.state_ = "playing"
		arg_29_1.curTalkId_ = 937081007
		...
		function arg_29_1.playNext_(arg_31_0)
			if arg_31_0 == 1 then
				arg_29_0:Play937081008(arg_29_1)
			end
		end

		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos1066ui_story = arg_29_1.actors_["1066ui_story"].transform.localPosition
			end

			local var_32_0 = 0.001

			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_0 then
				arg_29_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_29_1.time_ - 0) / var_32_0)
				...
				arg_29_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_29_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_29_1.actors_["1066ui_story"].transform.localEulerAngles = arg_29_1.actors_["1066ui_story"].transform.localEulerAngles
			end

			if arg_29_1.time_ >= 0 + var_32_0 and arg_29_1.time_ < 0 + var_32_0 + arg_32_0 then
				arg_29_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_29_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_29_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_29_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_29_1.actors_["1066ui_story"].transform.position).z)
				arg_29_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_29_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_29_1.actors_["1066ui_story"].transform.localEulerAngles = arg_29_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			local var_32_1 = arg_29_1.actors_["1066ui_story"]

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(var_32_1) and arg_29_1.var_.characterEffect1066ui_story == nil then
				arg_29_1.var_.characterEffect1066ui_story = var_32_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_32_2 = 0.200000002980232

			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_2 and not isNil(var_32_1) then
				if arg_29_1.var_.characterEffect1066ui_story and not isNil(var_32_1) then
					arg_29_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_29_1.time_ >= 0 + var_32_2 and arg_29_1.time_ < 0 + var_32_2 + arg_32_0 and not isNil(var_32_1) and arg_29_1.var_.characterEffect1066ui_story then
				arg_29_1.var_.characterEffect1066ui_story.fillFlat = false
			end

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action5_1")
			end

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0102cva", "EmotionTimelineAnimator")
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_4 + arg_32_0 then
				...
				local var_32_6 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(937081007).content)

				arg_29_1.text_.text = var_32_6

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_8 = 3 <= 0 and var_32_5 or var_32_5 * (utf8.len(var_32_6) / 3)

				if (3 <= 0 and var_32_5 or var_32_5 * (utf8.len(var_32_6) / 3)) > 0 and var_32_5 < var_32_8 then
	...
	Play937081008 = function(arg_33_0, arg_33_1)
		arg_33_1.time_ = 0
		arg_33_1.frameCnt_ = 0
		arg_33_1.state_ = "playing"
		arg_33_1.curTalkId_ = 937081008
		...
		function arg_33_1.playNext_(arg_35_0)
			if arg_35_0 == 1 then
				arg_33_0:Play937081009(arg_33_1)
			end
		end
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_0 then
				arg_33_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_33_1.var_.moveOldPos1066ui_story, Vector3.New(0, 100, 0), (arg_33_1.time_ - 0) / var_36_0)
			...
			if arg_33_1.time_ >= 0 + var_36_0 and arg_33_1.time_ < 0 + var_36_0 + arg_36_0 then
				arg_33_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_33_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_33_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_33_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_33_1.actors_["1066ui_story"].transform.position).z)
				arg_33_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_33_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_33_1.actors_["1066ui_story"].transform.localEulerAngles = arg_33_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_2 and not isNil(var_36_1) then
				if arg_33_1.var_.characterEffect1066ui_story and not isNil(var_36_1) then
					...
					arg_33_1.var_.characterEffect1066ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_33_1.time_ - 0) / var_36_2)
				end
			end
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_3 + arg_36_0 then
				...
				local var_36_5 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(937081008).content)

				arg_33_1.text_.text = var_36_5

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_7 = 47 <= 0 and var_36_4 or var_36_4 * (utf8.len(var_36_5) / 47)

				if (47 <= 0 and var_36_4 or var_36_4 * (utf8.len(var_36_5) / 47)) > 0 and var_36_4 < var_36_7 then
	...
	Play937081009 = function(arg_37_0, arg_37_1)
		arg_37_1.time_ = 0
		arg_37_1.frameCnt_ = 0
		arg_37_1.state_ = "playing"
		arg_37_1.curTalkId_ = 937081009
		...
		function arg_37_1.playNext_(arg_39_0)
			if arg_39_0 == 1 then
				arg_37_0:Play937081010(arg_37_1)
			end
		end
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 <= arg_37_1.time_ and arg_37_1.time_ < 0 + var_40_0 then
				arg_37_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_37_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_37_1.time_ - 0) / var_40_0)
			...
			if arg_37_1.time_ >= 0 + var_40_0 and arg_37_1.time_ < 0 + var_40_0 + arg_40_0 then
				arg_37_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_37_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_37_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_37_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_37_1.actors_["1066ui_story"].transform.position).z)
				arg_37_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_37_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_37_1.actors_["1066ui_story"].transform.localEulerAngles = arg_37_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				arg_37_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066actionlink/1066action457")
			end

			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				arg_37_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0102cva", "EmotionTimelineAnimator")
			end
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_4 + arg_40_0 then
				...
				local var_40_6 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(937081009).content)

				arg_37_1.text_.text = var_40_6

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_8 = 13 <= 0 and var_40_5 or var_40_5 * (utf8.len(var_40_6) / 13)

				if (13 <= 0 and var_40_5 or var_40_5 * (utf8.len(var_40_6) / 13)) > 0 and var_40_5 < var_40_8 then
	...
	Play937081010 = function(arg_41_0, arg_41_1)
		arg_41_1.time_ = 0
		arg_41_1.frameCnt_ = 0
		arg_41_1.state_ = "playing"
		arg_41_1.curTalkId_ = 937081010
		...
		function arg_41_1.playNext_(arg_43_0)
			if arg_43_0 == 1 then
				arg_41_0:Play937081011(arg_41_1)
			end
		end
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(937081010).content)
	...
	Play937081011 = function(arg_45_0, arg_45_1)
		arg_45_1.time_ = 0
		arg_45_1.frameCnt_ = 0
		arg_45_1.state_ = "playing"
		arg_45_1.curTalkId_ = 937081011
		...
		function arg_45_1.playNext_(arg_47_0)
			if arg_47_0 == 1 then
				arg_45_0:Play937081012(arg_45_1)
			end
		end

		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1066ui_story = arg_45_1.actors_["1066ui_story"].transform.localPosition
			end

			local var_48_0 = 0.001

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_0 then
				arg_45_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1066ui_story, Vector3.New(0, 100, 0), (arg_45_1.time_ - 0) / var_48_0)
				arg_45_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1066ui_story"].transform.position).z)
				arg_45_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["1066ui_story"].transform.localEulerAngles = arg_45_1.actors_["1066ui_story"].transform.localEulerAngles
			end

			if arg_45_1.time_ >= 0 + var_48_0 and arg_45_1.time_ < 0 + var_48_0 + arg_48_0 then
				arg_45_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_45_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1066ui_story"].transform.position).z)
				arg_45_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["1066ui_story"].transform.localEulerAngles = arg_45_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_1 + arg_48_0 then
				...
				local var_48_3 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(937081011).content)

				arg_45_1.text_.text = var_48_3

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_5 = 73 <= 0 and var_48_2 or var_48_2 * (utf8.len(var_48_3) / 73)

				if (73 <= 0 and var_48_2 or var_48_2 * (utf8.len(var_48_3) / 73)) > 0 and var_48_2 < var_48_5 then
	...
	Play937081012 = function(arg_49_0, arg_49_1)
		arg_49_1.time_ = 0
		arg_49_1.frameCnt_ = 0
		arg_49_1.state_ = "playing"
		arg_49_1.curTalkId_ = 937081012
		...
		function arg_49_1.playNext_(arg_51_0)
			if arg_51_0 == 1 then
				arg_49_0:Play937081013(arg_49_1)
			end
		end
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				...
				local var_52_1 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(937081012).content)

				arg_49_1.text_.text = var_52_1

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_3 = 5 <= 0 and var_52_0 or var_52_0 * (utf8.len(var_52_1) / 5)

				if (5 <= 0 and var_52_0 or var_52_0 * (utf8.len(var_52_1) / 5)) > 0 and var_52_0 < var_52_3 then
	...
	Play937081013 = function(arg_53_0, arg_53_1)
		arg_53_1.time_ = 0
		arg_53_1.frameCnt_ = 0
		arg_53_1.state_ = "playing"
		arg_53_1.curTalkId_ = 937081013
		...
		function arg_53_1.playNext_(arg_55_0)
			if arg_55_0 == 1 then
				arg_53_0:Play937081014(arg_53_1)
			end
		end

		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1.var_.moveOldPos1066ui_story = arg_53_1.actors_["1066ui_story"].transform.localPosition
			end

			local var_56_0 = 0.001

			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_0 then
				arg_53_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_53_1.time_ - 0) / var_56_0)
				arg_53_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_53_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_53_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_53_1.actors_["1066ui_story"].transform.position).z)
				arg_53_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_53_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_53_1.actors_["1066ui_story"].transform.localEulerAngles = arg_53_1.actors_["1066ui_story"].transform.localEulerAngles
			end

			if arg_53_1.time_ >= 0 + var_56_0 and arg_53_1.time_ < 0 + var_56_0 + arg_56_0 then
				arg_53_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_53_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_53_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_53_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_53_1.actors_["1066ui_story"].transform.position).z)
				arg_53_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_53_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_53_1.actors_["1066ui_story"].transform.localEulerAngles = arg_53_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			local var_56_1 = arg_53_1.actors_["1066ui_story"]

			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 and not isNil(var_56_1) and arg_53_1.var_.characterEffect1066ui_story == nil then
				arg_53_1.var_.characterEffect1066ui_story = var_56_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_56_2 = 0.200000002980232

			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_2 and not isNil(var_56_1) then
				if arg_53_1.var_.characterEffect1066ui_story and not isNil(var_56_1) then
					arg_53_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_53_1.time_ >= 0 + var_56_2 and arg_53_1.time_ < 0 + var_56_2 + arg_56_0 and not isNil(var_56_1) and arg_53_1.var_.characterEffect1066ui_story then
				arg_53_1.var_.characterEffect1066ui_story.fillFlat = false
			end

			if 0.034000001847744 < arg_53_1.time_ and arg_53_1.time_ <= 0.034000001847744 + arg_56_0 then
				arg_53_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action7_2")
			end

			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0102cva", "EmotionTimelineAnimator")
			end
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_4 + arg_56_0 then
				...
				local var_56_6 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(937081013).content)
	...
	Play937081014 = function(arg_57_0, arg_57_1)
		arg_57_1.time_ = 0
		arg_57_1.frameCnt_ = 0
		arg_57_1.state_ = "playing"
		arg_57_1.curTalkId_ = 937081014
		...
		function arg_57_1.playNext_(arg_59_0)
			if arg_59_0 == 1 then
				arg_57_0:Play937081015(arg_57_1)
			end
		end
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_0 then
				arg_57_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos1066ui_story, Vector3.New(0, 100, 0), (arg_57_1.time_ - 0) / var_60_0)
			...
			if arg_57_1.time_ >= 0 + var_60_0 and arg_57_1.time_ < 0 + var_60_0 + arg_60_0 then
				arg_57_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_57_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_57_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_57_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_57_1.actors_["1066ui_story"].transform.position).z)
				arg_57_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_57_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_57_1.actors_["1066ui_story"].transform.localEulerAngles = arg_57_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_2 and not isNil(var_60_1) then
				if arg_57_1.var_.characterEffect1066ui_story and not isNil(var_60_1) then
					...
					arg_57_1.var_.characterEffect1066ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_57_1.time_ - 0) / var_60_2)
				end
			end
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_3 + arg_60_0 then
				...
				local var_60_5 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(937081014).content)

				arg_57_1.text_.text = var_60_5

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_7 = 43 <= 0 and var_60_4 or var_60_4 * (utf8.len(var_60_5) / 43)

				if (43 <= 0 and var_60_4 or var_60_4 * (utf8.len(var_60_5) / 43)) > 0 and var_60_4 < var_60_7 then
	...
	Play937081015 = function(arg_61_0, arg_61_1)
		arg_61_1.time_ = 0
		arg_61_1.frameCnt_ = 0
		arg_61_1.state_ = "playing"
		arg_61_1.curTalkId_ = 937081015
		...
		function arg_61_1.playNext_(arg_63_0)
			if arg_63_0 == 1 then
				arg_61_0:Play937081016(arg_61_1)
			end
		end
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_4 + arg_64_0 then
				...
				local var_64_6 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(937081015).content)

				arg_61_1.text_.text = var_64_6

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_8 = 17 <= 0 and var_64_5 or var_64_5 * (utf8.len(var_64_6) / 17)

				if (17 <= 0 and var_64_5 or var_64_5 * (utf8.len(var_64_6) / 17)) > 0 and var_64_5 < var_64_8 then
	...
	Play937081016 = function(arg_65_0, arg_65_1)
		arg_65_1.time_ = 0
		arg_65_1.frameCnt_ = 0
		arg_65_1.state_ = "playing"
		arg_65_1.curTalkId_ = 937081016
		...
		function arg_65_1.playNext_(arg_67_0)
			if arg_67_0 == 1 then
				arg_65_0:Play937081017(arg_65_1)
			end
		end
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_1 + arg_68_0 then
				...
				local var_68_3 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(937081016).content)

				arg_65_1.text_.text = var_68_3

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_5 = 10 <= 0 and var_68_2 or var_68_2 * (utf8.len(var_68_3) / 10)

				if (10 <= 0 and var_68_2 or var_68_2 * (utf8.len(var_68_3) / 10)) > 0 and var_68_2 < var_68_5 then
	...
	Play937081017 = function(arg_69_0, arg_69_1)
		arg_69_1.time_ = 0
		arg_69_1.frameCnt_ = 0
		arg_69_1.state_ = "playing"
		arg_69_1.curTalkId_ = 937081017
		...
		function arg_69_1.playNext_(arg_71_0)
			if arg_71_0 == 1 then
				arg_69_0:Play937081018(arg_69_1)
			end
		end

		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				arg_69_1.var_.moveOldPos1066ui_story = arg_69_1.actors_["1066ui_story"].transform.localPosition
			end

			local var_72_0 = 0.001

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_0 then
				arg_69_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_69_1.time_ - 0) / var_72_0)
				arg_69_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_69_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["1066ui_story"].transform.position).z)
				arg_69_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_69_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_69_1.actors_["1066ui_story"].transform.localEulerAngles = arg_69_1.actors_["1066ui_story"].transform.localEulerAngles
			end

			if arg_69_1.time_ >= 0 + var_72_0 and arg_69_1.time_ < 0 + var_72_0 + arg_72_0 then
				arg_69_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_69_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_69_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_69_1.actors_["1066ui_story"].transform.position).z)
				arg_69_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_69_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_69_1.actors_["1066ui_story"].transform.localEulerAngles = arg_69_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			local var_72_1 = arg_69_1.actors_["1066ui_story"]

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 and not isNil(var_72_1) and arg_69_1.var_.characterEffect1066ui_story == nil then
				arg_69_1.var_.characterEffect1066ui_story = var_72_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_72_2 = 0.200000002980232

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_2 and not isNil(var_72_1) then
				if arg_69_1.var_.characterEffect1066ui_story and not isNil(var_72_1) then
					arg_69_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_69_1.time_ >= 0 + var_72_2 and arg_69_1.time_ < 0 + var_72_2 + arg_72_0 and not isNil(var_72_1) and arg_69_1.var_.characterEffect1066ui_story then
				arg_69_1.var_.characterEffect1066ui_story.fillFlat = false
			end

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				arg_69_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action4_2")
			end
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_4 + arg_72_0 then
				...
				local var_72_6 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(937081017).content)

				arg_69_1.text_.text = var_72_6

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_8 = 17 <= 0 and var_72_5 or var_72_5 * (utf8.len(var_72_6) / 17)

				if (17 <= 0 and var_72_5 or var_72_5 * (utf8.len(var_72_6) / 17)) > 0 and var_72_5 < var_72_8 then
	...
	Play937081018 = function(arg_73_0, arg_73_1)
		arg_73_1.time_ = 0
		arg_73_1.frameCnt_ = 0
		arg_73_1.state_ = "playing"
		arg_73_1.curTalkId_ = 937081018
		...
		function arg_73_1.playNext_(arg_75_0)
			if arg_75_0 == 1 then
				arg_73_0:Play937081019(arg_73_1)
			end
		end

		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				arg_73_1.var_.moveOldPos1066ui_story = arg_73_1.actors_["1066ui_story"].transform.localPosition
			end

			local var_76_0 = 0.001

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_0 then
				arg_73_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPos1066ui_story, Vector3.New(0, 100, 0), (arg_73_1.time_ - 0) / var_76_0)
				arg_73_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_73_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["1066ui_story"].transform.position).z)
				arg_73_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_73_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_73_1.actors_["1066ui_story"].transform.localEulerAngles = arg_73_1.actors_["1066ui_story"].transform.localEulerAngles
			end

			if arg_73_1.time_ >= 0 + var_76_0 and arg_73_1.time_ < 0 + var_76_0 + arg_76_0 then
				arg_73_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_73_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_73_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_73_1.actors_["1066ui_story"].transform.position).z)
				arg_73_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_73_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_73_1.actors_["1066ui_story"].transform.localEulerAngles = arg_73_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			local var_76_1 = arg_73_1.actors_["1066ui_story"]

			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 and not isNil(var_76_1) and arg_73_1.var_.characterEffect1066ui_story == nil then
				arg_73_1.var_.characterEffect1066ui_story = var_76_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_76_2 = 0.200000002980232

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_2 and not isNil(var_76_1) then
				if arg_73_1.var_.characterEffect1066ui_story and not isNil(var_76_1) then
					arg_73_1.var_.characterEffect1066ui_story.fillFlat = true
					arg_73_1.var_.characterEffect1066ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_73_1.time_ - 0) / var_76_2)
				end
			end

			if arg_73_1.time_ >= 0 + var_76_2 and arg_73_1.time_ < 0 + var_76_2 + arg_76_0 and not isNil(var_76_1) and arg_73_1.var_.characterEffect1066ui_story then
				arg_73_1.var_.characterEffect1066ui_story.fillFlat = true
				arg_73_1.var_.characterEffect1066ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_3 + arg_76_0 then
				...
				local var_76_5 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(937081018).content)
	...
	Play937081019 = function(arg_77_0, arg_77_1)
		arg_77_1.time_ = 0
		arg_77_1.frameCnt_ = 0
		arg_77_1.state_ = "playing"
		arg_77_1.curTalkId_ = 937081019
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				arg_77_1.var_.moveOldPos1066ui_story = arg_77_1.actors_["1066ui_story"].transform.localPosition
			end

			local var_80_0 = 0.001

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_0 then
				arg_77_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_77_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_77_1.time_ - 0) / var_80_0)
				arg_77_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1066ui_story"].transform.position).z)
				arg_77_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["1066ui_story"].transform.localEulerAngles = arg_77_1.actors_["1066ui_story"].transform.localEulerAngles
			end

			if arg_77_1.time_ >= 0 + var_80_0 and arg_77_1.time_ < 0 + var_80_0 + arg_80_0 then
				arg_77_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_77_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1066ui_story"].transform.position).z)
				arg_77_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["1066ui_story"].transform.localEulerAngles = arg_77_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 and not isNil(var_80_1) and arg_77_1.var_.characterEffect1066ui_story == nil then
			...
			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_2 and not isNil(var_80_1) then
				if arg_77_1.var_.characterEffect1066ui_story and not isNil(var_80_1) then
					arg_77_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_77_1.time_ >= 0 + var_80_2 and arg_77_1.time_ < 0 + var_80_2 + arg_80_0 and not isNil(var_80_1) and arg_77_1.var_.characterEffect1066ui_story then
				arg_77_1.var_.characterEffect1066ui_story.fillFlat = false
			end

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				arg_77_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action2_1")
			end

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				arg_77_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1101cva", "EmotionTimelineAnimator")
			end
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_4 + arg_80_0 then
				...
				local var_80_6 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(937081019).content)

				arg_77_1.text_.text = var_80_6

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_8 = 24 <= 0 and var_80_5 or var_80_5 * (utf8.len(var_80_6) / 24)

				if (24 <= 0 and var_80_5 or var_80_5 * (utf8.len(var_80_6) / 24)) > 0 and var_80_5 < var_80_8 then
