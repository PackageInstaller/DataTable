	...
	Play322141022 = function(arg_91_0, arg_91_1)
		...
		function arg_91_1.onSingleLineUpdate_(arg_94_0)
			if 0 < arg_91_1.time_ and arg_91_1.time_ <= 0 + arg_94_0 then
				...
				for iter_94_0, iter_94_1 in ipairs((var_94_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_94_1.transform.localScale = Vector3.New(iter_94_1.transform.localScale.x / var_94_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_94_1.transform.localScale.y / var_94_2, iter_94_1.transform.localScale.z)
				end
			end
			...
			local var_94_5 = 0.833333333333333
			...
			local var_94_9 = 1.36666666666667
			local var_94_10 = 1.575

			if 1.36666666666667 < arg_91_1.time_ and arg_91_1.time_ <= var_94_9 + arg_94_0 then
				...
				local var_94_11 = LeanTween.value(arg_91_1.dialog_, 0, 1, 0.3)

				var_94_11:setOnUpdate(LuaHelper.FloatAction(function(arg_95_0)
					arg_91_1.dialogCg_.alpha = arg_95_0
				end))
				var_94_11:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_91_1.dialog_)
					var_94_11:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_94_12 = arg_91_1:FormatText(arg_91_1:GetWordFromCfg(322141022).content)

				arg_91_1.text_.text = var_94_12

				LuaForUtil.ClearLinePrefixSymbol(arg_91_1.text_)

				local var_94_14 = 63 <= 0 and var_94_10 or var_94_10 * (utf8.len(var_94_12) / 63)

				if (63 <= 0 and var_94_10 or var_94_10 * (utf8.len(var_94_12) / 63)) > 0 and var_94_10 < var_94_14 then
					arg_91_1.talkMaxDuration = var_94_14
					var_94_9 = var_94_9 + 0.3

					if var_94_14 + var_94_9 > arg_91_1.duration_ then
						arg_91_1.duration_ = var_94_14 + var_94_9
					end
				end
			...
			local var_94_15 = var_94_9 + 0.3
			local var_94_16 = math.max(var_94_10, arg_91_1.talkMaxDuration)

			if var_94_9 + 0.3 <= arg_91_1.time_ and arg_91_1.time_ < var_94_15 + var_94_16 then
				arg_91_1.typewritter.percent = (arg_91_1.time_ - var_94_15) / var_94_16
