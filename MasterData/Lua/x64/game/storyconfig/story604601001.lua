return {
	Play604601001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 604601001
		arg_1_1.duration_ = 5
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_0 + arg_4_0 then
				...
				local var_4_3 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(604601001).content)

				arg_1_1.text_.text = var_4_3

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_5 = 7 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 7)

				if (7 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 7)) > 0 and var_4_1 < var_4_5 then
	...
	Play604601002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 604601002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(604601002).content)
	...
	Play604601003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 604601003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play604601004(arg_11_1)
			end
		end

		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			local var_14_0 = 0.475
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				arg_11_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1081")
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(604601003).content)

				arg_11_1.text_.text = var_14_1

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_3 = 19 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 19)

				if (19 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 19)) > 0 and var_14_0 < var_14_3 then
	...
	Play604601004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 604601004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play604601005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(604601004).content)
	...
	Play604601005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 604601005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play604601006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(604601005).content)

				arg_19_1.text_.text = var_22_1

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_3 = 18 <= 0 and var_22_0 or var_22_0 * (utf8.len(var_22_1) / 18)

				if (18 <= 0 and var_22_0 or var_22_0 * (utf8.len(var_22_1) / 18)) > 0 and var_22_0 < var_22_3 then
	...
	Play604601006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 604601006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play604601007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				...
				local var_26_1 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(604601006).content)
	...
	Play604601007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 604601007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play604601008(arg_27_1)
			end
		end
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				...
				local var_30_1 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(604601007).content)

				arg_27_1.text_.text = var_30_1

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_3 = 25 <= 0 and var_30_0 or var_30_0 * (utf8.len(var_30_1) / 25)

				if (25 <= 0 and var_30_0 or var_30_0 * (utf8.len(var_30_1) / 25)) > 0 and var_30_0 < var_30_3 then
	...
	Play604601008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 604601008
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				...
				local var_34_1 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(604601008).content)
