	...
	Play910501012 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_14 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1055ui_story, Vector3.New(-0.7, -0.965, -6.2), (arg_1_1.time_ - 1.8) / var_4_14)
			...
			if arg_1_1.time_ >= 1.8 + var_4_14 and arg_1_1.time_ < 1.8 + var_4_14 + arg_4_0 then
				var_4_13.localPosition = Vector3.New(-0.7, -0.965, -6.2)
				var_4_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_13.position).x, (manager.ui.mainCamera.transform.position - var_4_13.position).y, (manager.ui.mainCamera.transform.position - var_4_13.position).z)
				var_4_13.localEulerAngles.z = 0
				var_4_13.localEulerAngles.x = 0
				var_4_13.localEulerAngles = var_4_13.localEulerAngles
			...
			if 1.999999999999 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910501012).content)

				arg_1_1.text_.text = var_4_21

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_23 = 20 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_21) / 20)

				if (20 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_21) / 20)) > 0 and var_4_19 < var_4_23 then
	...
	Play910501013 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_4 then
				var_10_3.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos1093ui_story, Vector3.New(0.7, -1.11, -5.88), (arg_7_1.time_ - 0) / var_10_4)
			...
			if arg_7_1.time_ >= 0 + var_10_4 and arg_7_1.time_ < 0 + var_10_4 + arg_10_0 then
				var_10_3.localPosition = Vector3.New(0.7, -1.11, -5.88)
				var_10_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_10_3.position).x, (manager.ui.mainCamera.transform.position - var_10_3.position).y, (manager.ui.mainCamera.transform.position - var_10_3.position).z)
				var_10_3.localEulerAngles.z = 0
				var_10_3.localEulerAngles.x = 0
				var_10_3.localEulerAngles = var_10_3.localEulerAngles
			...
			local var_10_8 = arg_7_1.actors_["1055ui_story"]

			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 and not isNil(var_10_8) and arg_7_1.var_.characterEffect1055ui_story == nil then
				arg_7_1.var_.characterEffect1055ui_story = var_10_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_10_9 = 0.200000002980232

			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_9 and not isNil(var_10_8) then
				if arg_7_1.var_.characterEffect1055ui_story and not isNil(var_10_8) then
					arg_7_1.var_.characterEffect1055ui_story.fillFlat = true
					arg_7_1.var_.characterEffect1055ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_7_1.time_ - 0) / var_10_9)
				end
			end

			if arg_7_1.time_ >= 0 + var_10_9 and arg_7_1.time_ < 0 + var_10_9 + arg_10_0 and not isNil(var_10_8) and arg_7_1.var_.characterEffect1055ui_story then
				arg_7_1.var_.characterEffect1055ui_story.fillFlat = true
				arg_7_1.var_.characterEffect1055ui_story.fillRatio = 0.5
			end

			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				arg_7_1:PlayTimeline("1093ui_story", "StoryTimeline/CharAction/story1093/story1093action/1093action4_1")
			end

			local var_10_10 = 0
			local var_10_11 = 0.85
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_10 + arg_10_0 then
				...
				local var_10_12 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910501013).content)

				arg_7_1.text_.text = var_10_12

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_14 = 34 <= 0 and var_10_11 or var_10_11 * (utf8.len(var_10_12) / 34)

				if (34 <= 0 and var_10_11 or var_10_11 * (utf8.len(var_10_12) / 34)) > 0 and var_10_11 < var_10_14 then
	...
	Play910501014 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_4 + arg_14_0 then
				...
				local var_14_6 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910501014).content)

				arg_11_1.text_.text = var_14_6

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_8 = 39 <= 0 and var_14_5 or var_14_5 * (utf8.len(var_14_6) / 39)

				if (39 <= 0 and var_14_5 or var_14_5 * (utf8.len(var_14_6) / 39)) > 0 and var_14_5 < var_14_8 then
	...
	Play910501015 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				arg_15_1.var_.moveOldPos1093ui_story = arg_15_1.actors_["1093ui_story"].transform.localPosition
			end

			local var_18_0 = 0.001

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_0 then
				arg_15_1.actors_["1093ui_story"].transform.localPosition = Vector3.Lerp(arg_15_1.var_.moveOldPos1093ui_story, Vector3.New(0, 100, 0), (arg_15_1.time_ - 0) / var_18_0)
				arg_15_1.actors_["1093ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_15_1.actors_["1093ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_15_1.actors_["1093ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_15_1.actors_["1093ui_story"].transform.position).z)
				arg_15_1.actors_["1093ui_story"].transform.localEulerAngles.z = 0
				arg_15_1.actors_["1093ui_story"].transform.localEulerAngles.x = 0
				arg_15_1.actors_["1093ui_story"].transform.localEulerAngles = arg_15_1.actors_["1093ui_story"].transform.localEulerAngles
			end

			if arg_15_1.time_ >= 0 + var_18_0 and arg_15_1.time_ < 0 + var_18_0 + arg_18_0 then
				arg_15_1.actors_["1093ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_15_1.actors_["1093ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_15_1.actors_["1093ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_15_1.actors_["1093ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_15_1.actors_["1093ui_story"].transform.position).z)
				arg_15_1.actors_["1093ui_story"].transform.localEulerAngles.z = 0
				arg_15_1.actors_["1093ui_story"].transform.localEulerAngles.x = 0
				arg_15_1.actors_["1093ui_story"].transform.localEulerAngles = arg_15_1.actors_["1093ui_story"].transform.localEulerAngles
			...
			local var_18_1 = arg_15_1.actors_["1055ui_story"]

			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 and not isNil(var_18_1) and arg_15_1.var_.characterEffect1055ui_story == nil then
				arg_15_1.var_.characterEffect1055ui_story = var_18_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_18_2 = 0.200000002980232

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_2 and not isNil(var_18_1) then
				if arg_15_1.var_.characterEffect1055ui_story and not isNil(var_18_1) then
					arg_15_1.var_.characterEffect1055ui_story.fillFlat = true
					arg_15_1.var_.characterEffect1055ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_15_1.time_ - 0) / var_18_2)
				end
			end

			if arg_15_1.time_ >= 0 + var_18_2 and arg_15_1.time_ < 0 + var_18_2 + arg_18_0 and not isNil(var_18_1) and arg_15_1.var_.characterEffect1055ui_story then
				arg_15_1.var_.characterEffect1055ui_story.fillFlat = true
				arg_15_1.var_.characterEffect1055ui_story.fillRatio = 0.5
			end

			local var_18_3 = "1050ui_story"

			if arg_15_1.actors_["1050ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1050ui_story"))) then
				local var_18_4 = Object.Instantiate(Asset.Load("Char/" .. "1050ui_story"), arg_15_1.stage_.transform)
			...
			local var_18_7 = arg_15_1.actors_["1050ui_story"].transform

			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				arg_15_1.var_.moveOldPos1050ui_story = var_18_7.localPosition
			end

			local var_18_8 = 0.001

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_8 then
				var_18_7.localPosition = Vector3.Lerp(arg_15_1.var_.moveOldPos1050ui_story, Vector3.New(0.7, -1, -6.1), (arg_15_1.time_ - 0) / var_18_8)
			...
			if arg_15_1.time_ >= 0 + var_18_8 and arg_15_1.time_ < 0 + var_18_8 + arg_18_0 then
				var_18_7.localPosition = Vector3.New(0.7, -1, -6.1)
				var_18_7.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_18_7.position).x, (manager.ui.mainCamera.transform.position - var_18_7.position).y, (manager.ui.mainCamera.transform.position - var_18_7.position).z)
				var_18_7.localEulerAngles.z = 0
				var_18_7.localEulerAngles.x = 0
				var_18_7.localEulerAngles = var_18_7.localEulerAngles
			...
			local var_18_9 = arg_15_1.actors_["1050ui_story"]

			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 and not isNil(var_18_9) and arg_15_1.var_.characterEffect1050ui_story == nil then
				arg_15_1.var_.characterEffect1050ui_story = var_18_9:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_18_10 = 0.200000002980232

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_10 and not isNil(var_18_9) then
				if arg_15_1.var_.characterEffect1050ui_story and not isNil(var_18_9) then
					arg_15_1.var_.characterEffect1050ui_story.fillFlat = false
				end
			end

			if arg_15_1.time_ >= 0 + var_18_10 and arg_15_1.time_ < 0 + var_18_10 + arg_18_0 and not isNil(var_18_9) and arg_15_1.var_.characterEffect1050ui_story then
				arg_15_1.var_.characterEffect1050ui_story.fillFlat = false
			end

			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				arg_15_1:PlayTimeline("1050ui_story", "StoryTimeline/CharAction/story1050/story1050action/1050action1_1")
			end
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_12 + arg_18_0 then
				...
				arg_15_1.leftNameTxt_.text = arg_15_1:FormatText(StoryNameCfg[74].name)
				...
				local var_18_14 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910501015).content)

				arg_15_1.text_.text = var_18_14

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_16 = 29 <= 0 and var_18_13 or var_18_13 * (utf8.len(var_18_14) / 29)

				if (29 <= 0 and var_18_13 or var_18_13 * (utf8.len(var_18_14) / 29)) > 0 and var_18_13 < var_18_16 then
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_0 and not isNil(arg_19_1.actors_["1050ui_story"]) then
				if arg_19_1.var_.characterEffect1050ui_story and not isNil(arg_19_1.actors_["1050ui_story"]) then
					...
					arg_19_1.var_.characterEffect1050ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_19_1.time_ - 0) / var_22_0)
				end
			end
			...
			if arg_19_1.time_ >= 0 + var_22_0 and arg_19_1.time_ < 0 + var_22_0 + arg_22_0 and not isNil(arg_19_1.actors_["1050ui_story"]) and arg_19_1.var_.characterEffect1050ui_story then
				arg_19_1.var_.characterEffect1050ui_story.fillFlat = true
				arg_19_1.var_.characterEffect1050ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_1 + arg_22_0 then
				...
				arg_19_1.leftNameTxt_.text = arg_19_1:FormatText(StoryNameCfg[484].name)
				...
				local var_22_3 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910501016).content)

				arg_19_1.text_.text = var_22_3

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_5 = 51 <= 0 and var_22_2 or var_22_2 * (utf8.len(var_22_3) / 51)

				if (51 <= 0 and var_22_2 or var_22_2 * (utf8.len(var_22_3) / 51)) > 0 and var_22_2 < var_22_5 then
	...
	Play910501017 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				...
				arg_23_1.leftNameTxt_.text = arg_23_1:FormatText(StoryNameCfg[484].name)
				...
				local var_26_1 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910501017).content)

				arg_23_1.text_.text = var_26_1

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_3 = 20 <= 0 and var_26_0 or var_26_0 * (utf8.len(var_26_1) / 20)

				if (20 <= 0 and var_26_0 or var_26_0 * (utf8.len(var_26_1) / 20)) > 0 and var_26_0 < var_26_3 then
	...
	Play910501018 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				...
				local var_30_1 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910501018).content)
