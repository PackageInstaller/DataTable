return {
	Play60501001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 60501001
		arg_1_1.duration_ = 5
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_3 then
				var_4_2.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2540004, Vector3.New(0, -270, -900), (arg_1_1.time_ - 0) / var_4_3)
			end

			if arg_1_1.time_ >= 0 + var_4_3 and arg_1_1.time_ < 0 + var_4_3 + arg_4_0 then
				var_4_2.localPosition = Vector3.New(0, -270, -900)
			end
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[128].name)
				...
				local var_4_7 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60501001).content)

				arg_1_1.text_.text = var_4_7

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_9 = 35 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_7) / 35)

				if (35 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_7) / 35)) > 0 and var_4_5 < var_4_9 then
	...
	Play60501002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 60501002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.playNext_(arg_9_0)
			if arg_9_0 == 1 then
				arg_7_0:Play60501003(arg_7_1)
			end
		end

		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			local var_10_0 = 1.175
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[129].name)
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(60501002).content)

				arg_7_1.text_.text = var_10_1

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_3 = 47 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 47)

				if (47 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 47)) > 0 and var_10_0 < var_10_3 then
	...
	Play60501003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 60501003
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				arg_11_1.leftNameTxt_.text = arg_11_1:FormatText(StoryNameCfg[129].name)
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(60501003).content)
