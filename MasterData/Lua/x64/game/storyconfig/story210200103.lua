	...
	Play1102003083 = function(arg_340_0, arg_340_1)
		...
		function arg_340_1.onSingleLineUpdate_(arg_343_0)
			...
			if 0 < arg_340_1.time_ and arg_340_1.time_ <= 0 + arg_343_0 then
				...
				for iter_343_0, iter_343_1 in ipairs((var_343_23.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_343_1.transform.localScale = Vector3.New(iter_343_1.transform.localScale.x / var_343_25 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_343_1.transform.localScale.y / var_343_25, iter_343_1.transform.localScale.z)
				end
			end

			if 0 < arg_340_1.time_ and arg_340_1.time_ <= 0 + arg_343_0 then
				local var_343_27 = arg_340_1.var_.effectfantianxiayu2

				if not arg_340_1.var_.effectfantianxiayu2 then
					var_343_27 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_heavy_ui"), manager.ui.mainCamera.transform)
					var_343_27.name = "fantianxiayu2"
					arg_340_1.var_.effectfantianxiayu2 = var_343_27
				else
					var_343_27.transform:SetParent(var_343_9000)
				end

				var_343_27.transform.localPosition = Vector3.New(0, 0, 0)
				var_343_27.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_343_29 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_343_2, iter_343_3 in ipairs((var_343_27.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_343_3.transform.localScale = Vector3.New(iter_343_3.transform.localScale.x / var_343_29 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_343_3.transform.localScale.y / var_343_29, iter_343_3.transform.localScale.z)
				end
			end

			local var_343_31 = 0

			if 0 < arg_340_1.time_ and arg_340_1.time_ <= var_343_31 + arg_343_0 then
				arg_340_1.allBtn_.enabled = false
			end

			if arg_340_1.time_ >= var_343_31 + 0.433333333333333 and arg_340_1.time_ < var_343_31 + 0.433333333333333 + arg_343_0 then
			...
			if 0 < arg_340_1.time_ and arg_340_1.time_ <= 0 + arg_343_0 then
				...
				local var_343_37 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_340_1.bgmTxt_.text ~= var_343_37 and arg_340_1.bgmTxt_.text ~= "" then
						if arg_340_1.bgmTxt2_.text ~= "" then
							arg_340_1.bgmTxt_.text = arg_340_1.bgmTxt2_.text
						end

						arg_340_1.bgmTxt2_.text = var_343_37

						arg_340_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_340_1.bgmTxt_.text = var_343_37
						arg_340_1.bgmTxt2_.text = var_343_37
					end
			...
			local var_343_38 = 1.675
			local var_343_39 = 0.325

			if 1.675 < arg_340_1.time_ and arg_340_1.time_ <= var_343_38 + arg_343_0 then
				...
				local var_343_40 = LeanTween.value(arg_340_1.dialog_, 0, 1, 0.3)

				var_343_40:setOnUpdate(LuaHelper.FloatAction(function(arg_345_0)
					arg_340_1.dialogCg_.alpha = arg_345_0
				end))
				var_343_40:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_340_1.dialog_)
					var_343_40:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_343_41 = arg_340_1:FormatText(arg_340_1:GetWordFromCfg(1102003083).content)

				arg_340_1.text_.text = var_343_41

				LuaForUtil.ClearLinePrefixSymbol(arg_340_1.text_)

				local var_343_43 = 13 <= 0 and var_343_39 or var_343_39 * (utf8.len(var_343_41) / 13)

				if (13 <= 0 and var_343_39 or var_343_39 * (utf8.len(var_343_41) / 13)) > 0 and var_343_39 < var_343_43 then
					arg_340_1.talkMaxDuration = var_343_43
					var_343_38 = var_343_38 + 0.3

					if var_343_43 + var_343_38 > arg_340_1.duration_ then
						arg_340_1.duration_ = var_343_43 + var_343_38
					end
				end
			...
			local var_343_44 = var_343_38 + 0.3
			local var_343_45 = math.max(var_343_39, arg_340_1.talkMaxDuration)

			if var_343_38 + 0.3 <= arg_340_1.time_ and arg_340_1.time_ < var_343_44 + var_343_45 then
				arg_340_1.typewritter.percent = (arg_340_1.time_ - var_343_44) / var_343_45

				arg_340_1.typewritter:SetDirty()
			end

			if arg_340_1.time_ >= var_343_44 + var_343_45 and arg_340_1.time_ < var_343_44 + var_343_45 + arg_343_0 then
