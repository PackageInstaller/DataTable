	...
	Play423082008 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0.2 < arg_37_1.time_ and arg_37_1.time_ <= 0.2 + arg_40_0 then
				...
				for iter_40_0, iter_40_1 in ipairs((var_40_7.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_40_1.transform.localScale = Vector3.New(iter_40_1.transform.localScale.x / var_40_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_40_1.transform.localScale.y / var_40_9, iter_40_1.transform.localScale.z)
				end
			end
			...
			local var_40_13 = manager.ui.mainCamera.transform

			if 0.2 < arg_37_1.time_ and arg_37_1.time_ <= 0.2 + arg_40_0 then
				arg_37_1.var_.shakeOldPos = var_40_13.localPosition
			end

			local var_40_14 = 1.5

			if 0.2 <= arg_37_1.time_ and arg_37_1.time_ < 0.2 + var_40_14 then
				local var_40_15, var_40_16 = math.modf((arg_37_1.time_ - 0.2) / 0.066)

				var_40_13.localPosition = Vector3.New(var_40_16 * 0.13, var_40_16 * 0.13, var_40_16 * 0.13) + arg_37_1.var_.shakeOldPos
			end

			if arg_37_1.time_ >= 0.2 + var_40_14 and arg_37_1.time_ < 0.2 + var_40_14 + arg_40_0 then
				var_40_13.localPosition = arg_37_1.var_.shakeOldPos
			end
			...
			local var_40_20 = 1.03333333333333
			local var_40_21 = 1.9

			if 1.03333333333333 < arg_37_1.time_ and arg_37_1.time_ <= var_40_20 + arg_40_0 then
				...
				local var_40_23 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(423082008).content)

				arg_37_1.text_.text = var_40_23

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_25 = 76 <= 0 and var_40_21 or var_40_21 * (utf8.len(var_40_23) / 76)

				if (76 <= 0 and var_40_21 or var_40_21 * (utf8.len(var_40_23) / 76)) > 0 and var_40_21 < var_40_25 then
					arg_37_1.talkMaxDuration = var_40_25
					var_40_20 = var_40_20 + 0.3

					if var_40_25 + var_40_20 > arg_37_1.duration_ then
						arg_37_1.duration_ = var_40_25 + var_40_20
					end
				end
			...
			local var_40_26 = var_40_20 + 0.3
			local var_40_27 = math.max(var_40_21, arg_37_1.talkMaxDuration)

			if var_40_20 + 0.3 <= arg_37_1.time_ and arg_37_1.time_ < var_40_26 + var_40_27 then
