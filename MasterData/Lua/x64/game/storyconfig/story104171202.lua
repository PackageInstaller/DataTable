	...
	Play417122008 = function(arg_34_0, arg_34_1)
		...
		function arg_34_1.onSingleLineUpdate_(arg_37_0)
			...
			if 1.95207314730249 < arg_34_1.time_ and arg_34_1.time_ <= 1.95207314730249 + arg_37_0 then
				...
				for iter_37_9, iter_37_10 in ipairs((var_37_22.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_37_10.transform.localScale = Vector3.New(iter_37_10.transform.localScale.x / var_37_24 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_37_10.transform.localScale.y / var_37_24, iter_37_10.transform.localScale.z)
				end
			end

			local var_37_26 = arg_34_1.bgs_.SS1704.transform

			if 1.93614629460499 < arg_34_1.time_ and arg_34_1.time_ <= 1.93614629460499 + arg_37_0 then
				arg_34_1.var_.moveOldPosSS1704 = var_37_26.localPosition
			end

			local var_37_27 = 0.001

			if 1.93614629460499 <= arg_34_1.time_ and arg_34_1.time_ < 1.93614629460499 + var_37_27 then
				var_37_26.localPosition = Vector3.Lerp(arg_34_1.var_.moveOldPosSS1704, Vector3.New(0, 1, 10), (arg_34_1.time_ - 1.93614629460499) / var_37_27)
			end

			if arg_34_1.time_ >= 1.93614629460499 + var_37_27 and arg_34_1.time_ < 1.93614629460499 + var_37_27 + arg_37_0 then
				var_37_26.localPosition = Vector3.New(0, 1, 10)
			end

			local var_37_28 = arg_34_1.bgs_.SS1704.transform

			if 1.95281296127165 < arg_34_1.time_ and arg_34_1.time_ <= 1.95281296127165 + arg_37_0 then
				arg_34_1.var_.moveOldPosSS1704 = var_37_28.localPosition
			end

			local var_37_29 = 2.21666666666667

			if 1.95281296127165 <= arg_34_1.time_ and arg_34_1.time_ < 1.95281296127165 + var_37_29 then
				var_37_28.localPosition = Vector3.Lerp(arg_34_1.var_.moveOldPosSS1704, Vector3.New(0, 1, 9), (arg_34_1.time_ - 1.95281296127165) / var_37_29)
			end

			if arg_34_1.time_ >= 1.95281296127165 + var_37_29 and arg_34_1.time_ < 1.95281296127165 + var_37_29 + arg_37_0 then
				var_37_28.localPosition = Vector3.New(0, 1, 9)
			end
			...
			local var_37_30 = 3.95207314730249
			local var_37_31 = 0.75

			if 3.95207314730249 < arg_34_1.time_ and arg_34_1.time_ <= var_37_30 + arg_37_0 then
				...
				var_37_32:setOnUpdate(LuaHelper.FloatAction(function(arg_38_0)
				...
				local var_37_33 = arg_34_1:FormatText(arg_34_1:GetWordFromCfg(417122008).content)

				arg_34_1.text_.text = var_37_33

				LuaForUtil.ClearLinePrefixSymbol(arg_34_1.text_)

				local var_37_35 = 30 <= 0 and var_37_31 or var_37_31 * (utf8.len(var_37_33) / 30)

				if (30 <= 0 and var_37_31 or var_37_31 * (utf8.len(var_37_33) / 30)) > 0 and var_37_31 < var_37_35 then
					arg_34_1.talkMaxDuration = var_37_35
					var_37_30 = var_37_30 + 0.3

					if var_37_35 + var_37_30 > arg_34_1.duration_ then
						arg_34_1.duration_ = var_37_35 + var_37_30
					end
				end
			...
			local var_37_36 = var_37_30 + 0.3
			local var_37_37 = math.max(var_37_31, arg_34_1.talkMaxDuration)

			if var_37_30 + 0.3 <= arg_34_1.time_ and arg_34_1.time_ < var_37_36 + var_37_37 then
				arg_34_1.typewritter.percent = (arg_34_1.time_ - var_37_36) / var_37_37

				arg_34_1.typewritter:SetDirty()
			end

			if arg_34_1.time_ >= var_37_36 + var_37_37 and arg_34_1.time_ < var_37_36 + var_37_37 + arg_37_0 then
	...
	Play417122029 = function(arg_125_0, arg_125_1)
		...
		function arg_125_1.onSingleLineUpdate_(arg_128_0)
			if 1.66666666666667 < arg_125_1.time_ and arg_125_1.time_ <= 1.66666666666667 + arg_128_0 then
				...
				for iter_128_0, iter_128_1 in ipairs((var_128_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_128_1.transform.localScale = Vector3.New(iter_128_1.transform.localScale.x / var_128_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_128_1.transform.localScale.y / var_128_2, iter_128_1.transform.localScale.z)
				end
			end
			...
			local var_128_5 = 1.66666666666667
			...
			if 1.66666666666667 < arg_125_1.time_ and arg_125_1.time_ <= var_128_8 + arg_128_0 then
				arg_125_1.mask_.enabled = true
				arg_125_1.mask_.raycastTarget = true
			...
			local var_128_16 = 3.13333333333333
			local var_128_17 = 1.125

			if 3.13333333333333 < arg_125_1.time_ and arg_125_1.time_ <= var_128_16 + arg_128_0 then
				...
				local var_128_19 = arg_125_1:FormatText(arg_125_1:GetWordFromCfg(417122029).content)

				arg_125_1.text_.text = var_128_19

				LuaForUtil.ClearLinePrefixSymbol(arg_125_1.text_)

				local var_128_21 = 45 <= 0 and var_128_17 or var_128_17 * (utf8.len(var_128_19) / 45)

				if (45 <= 0 and var_128_17 or var_128_17 * (utf8.len(var_128_19) / 45)) > 0 and var_128_17 < var_128_21 then
			...
			local var_128_22 = var_128_16 + 0.3
			local var_128_23 = math.max(var_128_17, arg_125_1.talkMaxDuration)

			if var_128_16 + 0.3 <= arg_125_1.time_ and arg_125_1.time_ < var_128_22 + var_128_23 then
	...
	Play417122040 = function(arg_171_0, arg_171_1)
		...
		function arg_171_1.onSingleLineUpdate_(arg_174_0)
			...
			if 0.866666666666667 < arg_171_1.time_ and arg_171_1.time_ <= 0.866666666666667 + arg_174_0 then
				...
				for iter_174_2, iter_174_3 in ipairs((var_174_25.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_174_3.transform.localScale = Vector3.New(iter_174_3.transform.localScale.x / var_174_27 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_174_3.transform.localScale.y / var_174_27, iter_174_3.transform.localScale.z)
				end
			end

			if 0.866666666666666 < arg_171_1.time_ and arg_171_1.time_ <= 0.866666666666666 + arg_174_0 then
				local var_174_29 = arg_171_1.var_.effect244

				if not arg_171_1.var_.effect244 then
					var_174_29 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Lightning_in"), manager.ui.mainCamera.transform)
					var_174_29.name = "244"
					arg_171_1.var_.effect244 = var_174_29
				else
					var_174_29.transform:SetParent(var_174_9000)
				end

				var_174_29.transform.localPosition = Vector3.New(0, 0, 0)
				var_174_29.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_174_31 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_174_4, iter_174_5 in ipairs((var_174_29.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_174_5.transform.localScale = Vector3.New(iter_174_5.transform.localScale.x / var_174_31 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_174_5.transform.localScale.y / var_174_31, iter_174_5.transform.localScale.z)
				end
			end
			...
			local var_174_34 = 1.06666666666667

			if 1.06666666666667 < arg_171_1.time_ and arg_171_1.time_ <= var_174_34 + arg_174_0 then
				arg_171_1.mask_.enabled = true
				arg_171_1.mask_.raycastTarget = true
			...
			local var_174_35 = 0.557196466314296

			if var_174_34 <= arg_171_1.time_ and arg_171_1.time_ < var_174_34 + var_174_35 then
				local var_174_36 = Color.New(0.9528302, 0.9528302, 0.9528302)

				var_174_36.a = Mathf.Lerp(1, 0, (arg_171_1.time_ - var_174_34) / var_174_35)
				arg_171_1.mask_.color = var_174_36
			end

			if arg_171_1.time_ >= var_174_34 + var_174_35 and arg_171_1.time_ < var_174_34 + var_174_35 + arg_174_0 then
				local var_174_37 = Color.New(0.9528302, 0.9528302, 0.9528302)

				arg_171_1.mask_.enabled = false
				var_174_37.a = 0
				arg_171_1.mask_.color = var_174_37
			end
			...
			local var_174_39 = 2.23333333333233
			local var_174_40 = manager.audio:GetVoiceLength("story_v_out_417122", "417122040", "") / 1000

			if var_174_40 > 0 and 2.066 < var_174_40 and var_174_40 + var_174_39 > arg_171_1.duration_ then
				arg_171_1.duration_ = var_174_40 + var_174_39
			end
