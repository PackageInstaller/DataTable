return {
	Play603104001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(603104001).content)

				arg_1_1.text_.text = var_4_11

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_13 = 3 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 3)

				if (3 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 3)) > 0 and var_4_9 < var_4_13 then
	...
	Play603104002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_3 + arg_10_0 then
				...
				local var_10_5 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(603104002).content)

				arg_7_1.text_.text = var_10_5

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_7 = 18 <= 0 and var_10_4 or var_10_4 * (utf8.len(var_10_5) / 18)

				if (18 <= 0 and var_10_4 or var_10_4 * (utf8.len(var_10_5) / 18)) > 0 and var_10_4 < var_10_7 then
	...
	Play603104003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(603104003).content)
	...
	Play603104004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(603104004).content)
	...
	Play603104005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(603104005).content)
	...
	Play603104006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 and not isNil(arg_23_1.actors_["1094"]) then
				local var_26_0 = arg_23_1.actors_["1094"]:GetComponent("Image")

				if var_26_0 then
					arg_23_1.var_.highlightMatValue1094 = var_26_0
				end
			end

			local var_26_1 = 0.2

			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_1 and not isNil(arg_23_1.actors_["1094"]) then
				if arg_23_1.var_.highlightMatValue1094 then
					local var_26_2 = Mathf.Lerp(0.5, 1, (arg_23_1.time_ - 0) / var_26_1)

					arg_23_1.var_.highlightMatValue1094.color.r = var_26_2
					arg_23_1.var_.highlightMatValue1094.color.g = var_26_2
					arg_23_1.var_.highlightMatValue1094.color.b = var_26_2
					arg_23_1.var_.highlightMatValue1094.color = arg_23_1.var_.highlightMatValue1094.color
				end
			end

			if arg_23_1.time_ >= 0 + var_26_1 and arg_23_1.time_ < 0 + var_26_1 + arg_26_0 and not isNil(arg_23_1.actors_["1094"]) and arg_23_1.var_.highlightMatValue1094 then
				arg_23_1.actors_["1094"].transform:SetSiblingIndex(1)

				arg_23_1.var_.highlightMatValue1094.color.r = 1
				arg_23_1.var_.highlightMatValue1094.color.g = 1
				arg_23_1.var_.highlightMatValue1094.color.b = 1
				arg_23_1.var_.highlightMatValue1094.color = arg_23_1.var_.highlightMatValue1094.color
			end

			local var_26_3 = 0
			local var_26_4 = 0.275
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_3 + arg_26_0 then
				...
				local var_26_5 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(603104006).content)

				arg_23_1.text_.text = var_26_5

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_7 = 11 <= 0 and var_26_4 or var_26_4 * (utf8.len(var_26_5) / 11)

				if (11 <= 0 and var_26_4 or var_26_4 * (utf8.len(var_26_5) / 11)) > 0 and var_26_4 < var_26_7 then
