return {
	Play925151001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.time_ >= 2 + 0.134 and arg_1_1.time_ < 2 + 0.134 + arg_4_0 then
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_2 = arg_1_1.bgs_.I06b
			...
			if arg_1_1.actors_["1011"] == nil then
				local var_4_10 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1011")
			...
			local var_4_12 = arg_1_1.actors_["1011"].transform

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1.var_.moveOldPos1011 = var_4_12.localPosition
			...
			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_14 then
				var_4_12.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1011, Vector3.New(0, -390, 270), (arg_1_1.time_ - 1.8) / var_4_14)
			end

			if arg_1_1.time_ >= 1.8 + var_4_14 and arg_1_1.time_ < 1.8 + var_4_14 + arg_4_0 then
				var_4_12.localPosition = Vector3.New(0, -390, 270)
			end

			local var_4_15 = arg_1_1.actors_["1011"]

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.actorSpriteComps1011 == nil then
				arg_1_1.var_.actorSpriteComps1011 = var_4_15:GetComponentsInChildren(typeof(Image), true)
			end

			local var_4_16 = 0.0333333333333332
			...
			if arg_1_1.time_ >= 1.8 + var_4_16 and arg_1_1.time_ < 1.8 + var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.actorSpriteComps1011 then
			...
			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				local var_4_18 = arg_1_1.actors_["1011"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_18 then
					arg_1_1.var_.alphaOldValue1011 = var_4_18.alpha
					arg_1_1.var_.characterEffect1011 = var_4_18
				end
			...
			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_19 then
				if arg_1_1.var_.characterEffect1011 then
					arg_1_1.var_.characterEffect1011.alpha = Mathf.Lerp(arg_1_1.var_.alphaOldValue1011, 1, (arg_1_1.time_ - 1.8) / var_4_19)
				end
			end

			if arg_1_1.time_ >= 1.8 + var_4_19 and arg_1_1.time_ < 1.8 + var_4_19 + arg_4_0 and arg_1_1.var_.characterEffect1011 then
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_26 + arg_4_0 then
				...
				local var_4_29 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(925151001).content)

				arg_1_1.text_.text = var_4_29

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_31 = 11 <= 0 and var_4_27 or var_4_27 * (utf8.len(var_4_29) / 11)

				if (11 <= 0 and var_4_27 or var_4_27 * (utf8.len(var_4_29) / 11)) > 0 and var_4_27 < var_4_31 then
	...
	Play925151002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(arg_9_1.actors_["1011"]) and arg_9_1.var_.actorSpriteComps1011 == nil then
				arg_9_1.var_.actorSpriteComps1011 = arg_9_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_12_0 = 0.2

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_0 and not isNil(arg_9_1.actors_["1011"]) then
			...
			if arg_9_1.time_ >= 0 + var_12_0 and arg_9_1.time_ < 0 + var_12_0 + arg_12_0 and not isNil(arg_9_1.actors_["1011"]) and arg_9_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_2 + arg_12_0 then
				...
				local var_12_4 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(925151002).content)

				arg_9_1.text_.text = var_12_4

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_6 = 11 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 11)

				if (11 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 11)) > 0 and var_12_3 < var_12_6 then
	...
	Play925151003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_2 + arg_16_0 then
				...
				local var_16_4 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(925151003).content)

				arg_13_1.text_.text = var_16_4

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_6 = 13 <= 0 and var_16_3 or var_16_3 * (utf8.len(var_16_4) / 13)

				if (13 <= 0 and var_16_3 or var_16_3 * (utf8.len(var_16_4) / 13)) > 0 and var_16_3 < var_16_6 then
	...
	Play925151004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(925151004).content)
	...
	Play925151005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_2 + arg_24_0 then
				...
				local var_24_4 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(925151005).content)
	...
	Play925151006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(arg_25_1.actors_["1011"]) and arg_25_1.var_.actorSpriteComps1011 == nil then
				arg_25_1.var_.actorSpriteComps1011 = arg_25_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_28_0 = 0.2

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_0 and not isNil(arg_25_1.actors_["1011"]) then
			...
			if arg_25_1.time_ >= 0 + var_28_0 and arg_25_1.time_ < 0 + var_28_0 + arg_28_0 and not isNil(arg_25_1.actors_["1011"]) and arg_25_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(925151006).content)
	...
	Play925151007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos1011 = arg_29_1.actors_["1011"].transform.localPosition
				arg_29_1.actors_["1011"].transform.localScale = Vector3.New(1, 1, 1)

				arg_29_1:CheckSpriteTmpPos("1011", 3)

				for iter_32_0 = 0, arg_29_1.actors_["1011"].transform.childCount - 1 do
					local var_32_0 = arg_29_1.actors_["1011"].transform:GetChild(iter_32_0)
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_1 then
				arg_29_1.actors_["1011"].transform.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1011, Vector3.New(0, -390, 270), (arg_29_1.time_ - 0) / var_32_1)
			end

			if arg_29_1.time_ >= 0 + var_32_1 and arg_29_1.time_ < 0 + var_32_1 + arg_32_0 then
				arg_29_1.actors_["1011"].transform.localPosition = Vector3.New(0, -390, 270)
			end

			local var_32_2 = arg_29_1.actors_["1011"]

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(var_32_2) and arg_29_1.var_.actorSpriteComps1011 == nil then
				arg_29_1.var_.actorSpriteComps1011 = var_32_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_29_1.time_ >= 0 + var_32_3 and arg_29_1.time_ < 0 + var_32_3 + arg_32_0 and not isNil(var_32_2) and arg_29_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_5 + arg_32_0 then
				...
				local var_32_7 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(925151007).content)

				arg_29_1.text_.text = var_32_7

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_9 = 21 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 21)

				if (21 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 21)) > 0 and var_32_6 < var_32_9 then
	...
	Play925151008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 and not isNil(arg_33_1.actors_["1011"]) and arg_33_1.var_.actorSpriteComps1011 == nil then
				arg_33_1.var_.actorSpriteComps1011 = arg_33_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_36_0 = 0.2

			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_0 and not isNil(arg_33_1.actors_["1011"]) then
			...
			if arg_33_1.time_ >= 0 + var_36_0 and arg_33_1.time_ < 0 + var_36_0 + arg_36_0 and not isNil(arg_33_1.actors_["1011"]) and arg_33_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_2 + arg_36_0 then
				...
				local var_36_4 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(925151008).content)

				arg_33_1.text_.text = var_36_4

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_6 = 24 <= 0 and var_36_3 or var_36_3 * (utf8.len(var_36_4) / 24)

				if (24 <= 0 and var_36_3 or var_36_3 * (utf8.len(var_36_4) / 24)) > 0 and var_36_3 < var_36_6 then
	...
	Play925151009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 and not isNil(arg_37_1.actors_["1011"]) and arg_37_1.var_.actorSpriteComps1011 == nil then
				arg_37_1.var_.actorSpriteComps1011 = arg_37_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_40_0 = 0.2

			if 0 <= arg_37_1.time_ and arg_37_1.time_ < 0 + var_40_0 and not isNil(arg_37_1.actors_["1011"]) then
			...
			if arg_37_1.time_ >= 0 + var_40_0 and arg_37_1.time_ < 0 + var_40_0 + arg_40_0 and not isNil(arg_37_1.actors_["1011"]) and arg_37_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_2 + arg_40_0 then
				...
				local var_40_4 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(925151009).content)
	...
	Play925151010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 and not isNil(arg_41_1.actors_["1011"]) and arg_41_1.var_.actorSpriteComps1011 == nil then
				arg_41_1.var_.actorSpriteComps1011 = arg_41_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_44_0 = 0.2

			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_0 and not isNil(arg_41_1.actors_["1011"]) then
			...
			if arg_41_1.time_ >= 0 + var_44_0 and arg_41_1.time_ < 0 + var_44_0 + arg_44_0 and not isNil(arg_41_1.actors_["1011"]) and arg_41_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_2 + arg_44_0 then
				...
				local var_44_4 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(925151010).content)

				arg_41_1.text_.text = var_44_4

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_6 = 13 <= 0 and var_44_3 or var_44_3 * (utf8.len(var_44_4) / 13)

				if (13 <= 0 and var_44_3 or var_44_3 * (utf8.len(var_44_4) / 13)) > 0 and var_44_3 < var_44_6 then
	...
	Play925151011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(arg_45_1.actors_["1011"]) and arg_45_1.var_.actorSpriteComps1011 == nil then
				arg_45_1.var_.actorSpriteComps1011 = arg_45_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_48_0 = 0.2

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_0 and not isNil(arg_45_1.actors_["1011"]) then
			...
			if arg_45_1.time_ >= 0 + var_48_0 and arg_45_1.time_ < 0 + var_48_0 + arg_48_0 and not isNil(arg_45_1.actors_["1011"]) and arg_45_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 then
				...
				local var_48_4 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(925151011).content)

				arg_45_1.text_.text = var_48_4

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_6 = 7 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 7)

				if (7 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 7)) > 0 and var_48_3 < var_48_6 then
	...
	Play925151012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				...
				local var_52_1 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(925151012).content)
	...
	Play925151013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 and not isNil(arg_53_1.actors_["1011"]) and arg_53_1.var_.actorSpriteComps1011 == nil then
				arg_53_1.var_.actorSpriteComps1011 = arg_53_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_56_0 = 0.2

			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_0 and not isNil(arg_53_1.actors_["1011"]) then
			...
			if arg_53_1.time_ >= 0 + var_56_0 and arg_53_1.time_ < 0 + var_56_0 + arg_56_0 and not isNil(arg_53_1.actors_["1011"]) and arg_53_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_2 + arg_56_0 then
				...
				local var_56_4 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(925151013).content)
	...
	Play925151014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1.var_.moveOldPos1011 = arg_57_1.actors_["1011"].transform.localPosition
				arg_57_1.actors_["1011"].transform.localScale = Vector3.New(1, 1, 1)

				arg_57_1:CheckSpriteTmpPos("1011", 3)

				for iter_60_0 = 0, arg_57_1.actors_["1011"].transform.childCount - 1 do
					local var_60_0 = arg_57_1.actors_["1011"].transform:GetChild(iter_60_0)
			...
			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_1 then
				arg_57_1.actors_["1011"].transform.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos1011, Vector3.New(0, -390, 270), (arg_57_1.time_ - 0) / var_60_1)
			end

			if arg_57_1.time_ >= 0 + var_60_1 and arg_57_1.time_ < 0 + var_60_1 + arg_60_0 then
				arg_57_1.actors_["1011"].transform.localPosition = Vector3.New(0, -390, 270)
			end

			local var_60_2 = arg_57_1.actors_["1011"]

			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 and not isNil(var_60_2) and arg_57_1.var_.actorSpriteComps1011 == nil then
				arg_57_1.var_.actorSpriteComps1011 = var_60_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_57_1.time_ >= 0 + var_60_3 and arg_57_1.time_ < 0 + var_60_3 + arg_60_0 and not isNil(var_60_2) and arg_57_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_5 + arg_60_0 then
				...
				local var_60_7 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(925151014).content)

				arg_57_1.text_.text = var_60_7

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_9 = 23 <= 0 and var_60_6 or var_60_6 * (utf8.len(var_60_7) / 23)

				if (23 <= 0 and var_60_6 or var_60_6 * (utf8.len(var_60_7) / 23)) > 0 and var_60_6 < var_60_9 then
	...
	Play925151015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 and not isNil(arg_61_1.actors_["1011"]) and arg_61_1.var_.actorSpriteComps1011 == nil then
				arg_61_1.var_.actorSpriteComps1011 = arg_61_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_64_0 = 0.2

			if 0 <= arg_61_1.time_ and arg_61_1.time_ < 0 + var_64_0 and not isNil(arg_61_1.actors_["1011"]) then
			...
			if arg_61_1.time_ >= 0 + var_64_0 and arg_61_1.time_ < 0 + var_64_0 + arg_64_0 and not isNil(arg_61_1.actors_["1011"]) and arg_61_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_2 + arg_64_0 then
				...
				local var_64_4 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(925151015).content)
	...
	Play925151016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 and not isNil(arg_65_1.actors_["1011"]) and arg_65_1.var_.actorSpriteComps1011 == nil then
				arg_65_1.var_.actorSpriteComps1011 = arg_65_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_68_0 = 0.2

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_0 and not isNil(arg_65_1.actors_["1011"]) then
			...
			if arg_65_1.time_ >= 0 + var_68_0 and arg_65_1.time_ < 0 + var_68_0 + arg_68_0 and not isNil(arg_65_1.actors_["1011"]) and arg_65_1.var_.actorSpriteComps1011 then
			...
			local var_68_2 = arg_65_1.actors_["1011"].transform

			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				arg_65_1.var_.moveOldPos1011 = var_68_2.localPosition
			...
			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_4 then
				var_68_2.localPosition = Vector3.Lerp(arg_65_1.var_.moveOldPos1011, Vector3.New(0, -390, 270), (arg_65_1.time_ - 0) / var_68_4)
			end

			if arg_65_1.time_ >= 0 + var_68_4 and arg_65_1.time_ < 0 + var_68_4 + arg_68_0 then
				var_68_2.localPosition = Vector3.New(0, -390, 270)
			end
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_5 + arg_68_0 then
				...
				local var_68_7 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(925151016).content)

				arg_65_1.text_.text = var_68_7

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_9 = 34 <= 0 and var_68_6 or var_68_6 * (utf8.len(var_68_7) / 34)

				if (34 <= 0 and var_68_6 or var_68_6 * (utf8.len(var_68_7) / 34)) > 0 and var_68_6 < var_68_9 then
	...
	Play925151017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 and not isNil(arg_69_1.actors_["1011"]) and arg_69_1.var_.actorSpriteComps1011 == nil then
				arg_69_1.var_.actorSpriteComps1011 = arg_69_1.actors_["1011"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_72_0 = 0.2

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_0 and not isNil(arg_69_1.actors_["1011"]) then
			...
			if arg_69_1.time_ >= 0 + var_72_0 and arg_69_1.time_ < 0 + var_72_0 + arg_72_0 and not isNil(arg_69_1.actors_["1011"]) and arg_69_1.var_.actorSpriteComps1011 then
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_2 + arg_72_0 then
				...
				local var_72_4 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(925151017).content)

				arg_69_1.text_.text = var_72_4

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_6 = 15 <= 0 and var_72_3 or var_72_3 * (utf8.len(var_72_4) / 15)

				if (15 <= 0 and var_72_3 or var_72_3 * (utf8.len(var_72_4) / 15)) > 0 and var_72_3 < var_72_6 then
