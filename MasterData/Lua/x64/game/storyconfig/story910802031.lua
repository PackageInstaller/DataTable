return {
	Play910812001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_["1070"] == nil then
				local var_4_9 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1070")
			...
			local var_4_11 = arg_1_1.actors_["1070"].transform

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1.var_.moveOldPos1070 = var_4_11.localPosition
			...
			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_13 then
				var_4_11.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_1_1.time_ - 1.8) / var_4_13)
			end
			...
			local var_4_14 = arg_1_1.actors_["1070"]

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.actorSpriteComps1070 == nil then
				arg_1_1.var_.actorSpriteComps1070 = var_4_14:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_1_1.time_ >= 1.8 + var_4_15 and arg_1_1.time_ < 1.8 + var_4_15 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.actorSpriteComps1070 then
				for iter_4_7, iter_4_8 in pairs(arg_1_1.var_.actorSpriteComps1070:ToTable()) do
					if iter_4_8 then
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_20 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910812001).content)

				arg_1_1.text_.text = var_4_20

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_22 = 12 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_20) / 12)

				if (12 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_20) / 12)) > 0 and var_4_19 < var_4_22 then
	...
	Play910812002 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				arg_5_1.var_.moveOldPos1070 = arg_5_1.actors_["1070"].transform.localPosition
				arg_5_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_5_1:CheckSpriteTmpPos("1070", 3)

				for iter_8_0 = 0, arg_5_1.actors_["1070"].transform.childCount - 1 do
					local var_8_0 = arg_5_1.actors_["1070"].transform:GetChild(iter_8_0)

					if var_8_0.name == "split_4" or not string.find(var_8_0.name, "split") then
						var_8_0.gameObject:SetActive(true)
					else
						var_8_0.gameObject:SetActive(false)
					end
				end
			end
			...
			if 0 <= arg_5_1.time_ and arg_5_1.time_ < 0 + var_8_1 then
				arg_5_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_5_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_5_1.time_ - 0) / var_8_1)
			end

			if arg_5_1.time_ >= 0 + var_8_1 and arg_5_1.time_ < 0 + var_8_1 + arg_8_0 then
				arg_5_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_8_2 = arg_5_1.actors_["1070"]

			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 and not isNil(var_8_2) and arg_5_1.var_.actorSpriteComps1070 == nil then
				arg_5_1.var_.actorSpriteComps1070 = var_8_2:GetComponentsInChildren(typeof(Image), true)
			end

			local var_8_3 = 0.034

			if 0 <= arg_5_1.time_ and arg_5_1.time_ < 0 + var_8_3 and not isNil(var_8_2) then
				if arg_5_1.var_.actorSpriteComps1070 then
					for iter_8_1, iter_8_2 in pairs(arg_5_1.var_.actorSpriteComps1070:ToTable()) do
						if iter_8_2 then
							if arg_5_1.isInRecall_ then
								iter_8_2.color = Color.New(Mathf.Lerp(iter_8_2.color.r, arg_5_1.hightColor2.r, (arg_5_1.time_ - 0) / var_8_3), Mathf.Lerp(iter_8_2.color.g, arg_5_1.hightColor2.g, (arg_5_1.time_ - 0) / var_8_3), (Mathf.Lerp(iter_8_2.color.b, arg_5_1.hightColor2.b, (arg_5_1.time_ - 0) / var_8_3)))
							else
								local var_8_4 = Mathf.Lerp(iter_8_2.color.r, 0.5, (arg_5_1.time_ - 0) / var_8_3)

								iter_8_2.color = Color.New(var_8_4, var_8_4, var_8_4)
							end
						end
					end
				end
			...
			if arg_5_1.time_ >= 0 + var_8_3 and arg_5_1.time_ < 0 + var_8_3 + arg_8_0 and not isNil(var_8_2) and arg_5_1.var_.actorSpriteComps1070 then
				for iter_8_3, iter_8_4 in pairs(arg_5_1.var_.actorSpriteComps1070:ToTable()) do
					if iter_8_4 then
						iter_8_4.color = arg_5_1.isInRecall_ and (arg_5_1.hightColor2 or Color.New(0.46, 0.43, 0.35)) or Color.New(0.5, 0.5, 0.5)
					end
				end
			...
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= var_8_5 + arg_8_0 then
				...
				arg_5_1.leftNameTxt_.text = arg_5_1:FormatText(StoryNameCfg[623].name)
				...
				local var_8_7 = arg_5_1:FormatText(arg_5_1:GetWordFromCfg(910812002).content)

				arg_5_1.text_.text = var_8_7

				LuaForUtil.ClearLinePrefixSymbol(arg_5_1.text_)

				local var_8_9 = 10 <= 0 and var_8_6 or var_8_6 * (utf8.len(var_8_7) / 10)

				if (10 <= 0 and var_8_6 or var_8_6 * (utf8.len(var_8_7) / 10)) > 0 and var_8_6 < var_8_9 then
					arg_5_1.talkMaxDuration = var_8_9

					if var_8_9 + var_8_5 > arg_5_1.duration_ then
						arg_5_1.duration_ = var_8_9 + var_8_5
					end
				end
			...
			local var_8_10 = math.max(var_8_6, arg_5_1.talkMaxDuration)

			if var_8_5 <= arg_5_1.time_ and arg_5_1.time_ < var_8_5 + var_8_10 then
				arg_5_1.typewritter.percent = (arg_5_1.time_ - var_8_5) / var_8_10

				arg_5_1.typewritter:SetDirty()
			end

			if arg_5_1.time_ >= var_8_5 + var_8_10 and arg_5_1.time_ < var_8_5 + var_8_10 + arg_8_0 then
	...
	Play910812003 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				arg_9_1.var_.moveOldPos1070 = arg_9_1.actors_["1070"].transform.localPosition
				arg_9_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_9_1:CheckSpriteTmpPos("1070", 3)

				for iter_12_0 = 0, arg_9_1.actors_["1070"].transform.childCount - 1 do
					local var_12_0 = arg_9_1.actors_["1070"].transform:GetChild(iter_12_0)

					if var_12_0.name == "split_9" or not string.find(var_12_0.name, "split") then
			...
			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_1 then
				arg_9_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_9_1.time_ - 0) / var_12_1)
			end

			if arg_9_1.time_ >= 0 + var_12_1 and arg_9_1.time_ < 0 + var_12_1 + arg_12_0 then
				arg_9_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_12_2 = arg_9_1.actors_["1070"]

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(var_12_2) and arg_9_1.var_.actorSpriteComps1070 == nil then
				arg_9_1.var_.actorSpriteComps1070 = var_12_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_9_1.time_ >= 0 + var_12_3 and arg_9_1.time_ < 0 + var_12_3 + arg_12_0 and not isNil(var_12_2) and arg_9_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_5 + arg_12_0 then
				...
				local var_12_7 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(910812003).content)

				arg_9_1.text_.text = var_12_7

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_9 = 17 <= 0 and var_12_6 or var_12_6 * (utf8.len(var_12_7) / 17)

				if (17 <= 0 and var_12_6 or var_12_6 * (utf8.len(var_12_7) / 17)) > 0 and var_12_6 < var_12_9 then
	...
	Play910812004 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos1070 = arg_13_1.actors_["1070"].transform.localPosition
				arg_13_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_13_1:CheckSpriteTmpPos("1070", 3)

				for iter_16_0 = 0, arg_13_1.actors_["1070"].transform.childCount - 1 do
					local var_16_0 = arg_13_1.actors_["1070"].transform:GetChild(iter_16_0)

					if var_16_0.name == "split_9" or not string.find(var_16_0.name, "split") then
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_1 then
				arg_13_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_13_1.time_ - 0) / var_16_1)
			end

			if arg_13_1.time_ >= 0 + var_16_1 and arg_13_1.time_ < 0 + var_16_1 + arg_16_0 then
				arg_13_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_16_2 = arg_13_1.actors_["1070"]

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 and not isNil(var_16_2) and arg_13_1.var_.actorSpriteComps1070 == nil then
				arg_13_1.var_.actorSpriteComps1070 = var_16_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_13_1.time_ >= 0 + var_16_3 and arg_13_1.time_ < 0 + var_16_3 + arg_16_0 and not isNil(var_16_2) and arg_13_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_5 + arg_16_0 then
				...
				arg_13_1.leftNameTxt_.text = arg_13_1:FormatText(StoryNameCfg[623].name)
				...
				local var_16_7 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(910812004).content)

				arg_13_1.text_.text = var_16_7

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_9 = 11 <= 0 and var_16_6 or var_16_6 * (utf8.len(var_16_7) / 11)

				if (11 <= 0 and var_16_6 or var_16_6 * (utf8.len(var_16_7) / 11)) > 0 and var_16_6 < var_16_9 then
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				...
				for iter_20_0 = 0, arg_17_1.actors_["1070"].transform.childCount - 1 do
					...
					if var_20_0.name == "split_9" or not string.find(var_20_0.name, "split") then
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_5 + arg_20_0 then
				...
				local var_20_7 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(910812005).content)

				arg_17_1.text_.text = var_20_7

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_9 = 11 <= 0 and var_20_6 or var_20_6 * (utf8.len(var_20_7) / 11)

				if (11 <= 0 and var_20_6 or var_20_6 * (utf8.len(var_20_7) / 11)) > 0 and var_20_6 < var_20_9 then
	...
	Play910812006 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1.var_.moveOldPos1070 = arg_21_1.actors_["1070"].transform.localPosition
				arg_21_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_21_1:CheckSpriteTmpPos("1070", 3)

				for iter_24_0 = 0, arg_21_1.actors_["1070"].transform.childCount - 1 do
					local var_24_0 = arg_21_1.actors_["1070"].transform:GetChild(iter_24_0)
			...
			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_1 then
				arg_21_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_21_1.time_ - 0) / var_24_1)
			end

			if arg_21_1.time_ >= 0 + var_24_1 and arg_21_1.time_ < 0 + var_24_1 + arg_24_0 then
				arg_21_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_24_2 = arg_21_1.actors_["1070"]

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(var_24_2) and arg_21_1.var_.actorSpriteComps1070 == nil then
				arg_21_1.var_.actorSpriteComps1070 = var_24_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_21_1.time_ >= 0 + var_24_3 and arg_21_1.time_ < 0 + var_24_3 + arg_24_0 and not isNil(var_24_2) and arg_21_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_5 + arg_24_0 then
				...
				local var_24_7 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(910812006).content)
	...
	Play910812007 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_1 then
				arg_25_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_25_1.time_ - 0) / var_28_1)
			end

			if arg_25_1.time_ >= 0 + var_28_1 and arg_25_1.time_ < 0 + var_28_1 + arg_28_0 then
				arg_25_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_5 + arg_28_0 then
				...
				local var_28_7 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(910812007).content)

				arg_25_1.text_.text = var_28_7

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_9 = 22 <= 0 and var_28_6 or var_28_6 * (utf8.len(var_28_7) / 22)

				if (22 <= 0 and var_28_6 or var_28_6 * (utf8.len(var_28_7) / 22)) > 0 and var_28_6 < var_28_9 then
	...
	Play910812008 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos1070 = arg_29_1.actors_["1070"].transform.localPosition
				arg_29_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_29_1:CheckSpriteTmpPos("1070", 3)

				for iter_32_0 = 0, arg_29_1.actors_["1070"].transform.childCount - 1 do
					local var_32_0 = arg_29_1.actors_["1070"].transform:GetChild(iter_32_0)
			...
			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_1 then
				arg_29_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_29_1.time_ - 0) / var_32_1)
			end

			if arg_29_1.time_ >= 0 + var_32_1 and arg_29_1.time_ < 0 + var_32_1 + arg_32_0 then
				arg_29_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_32_2 = arg_29_1.actors_["1070"]

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(var_32_2) and arg_29_1.var_.actorSpriteComps1070 == nil then
				arg_29_1.var_.actorSpriteComps1070 = var_32_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_29_1.time_ >= 0 + var_32_3 and arg_29_1.time_ < 0 + var_32_3 + arg_32_0 and not isNil(var_32_2) and arg_29_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_5 + arg_32_0 then
				...
				local var_32_7 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(910812008).content)

				arg_29_1.text_.text = var_32_7

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_9 = 49 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 49)

				if (49 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 49)) > 0 and var_32_6 < var_32_9 then
	...
	Play910812009 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				arg_33_1.var_.moveOldPos1070 = arg_33_1.actors_["1070"].transform.localPosition
				arg_33_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_33_1:CheckSpriteTmpPos("1070", 3)

				for iter_36_0 = 0, arg_33_1.actors_["1070"].transform.childCount - 1 do
					local var_36_0 = arg_33_1.actors_["1070"].transform:GetChild(iter_36_0)
			...
			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_1 then
				arg_33_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_33_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_33_1.time_ - 0) / var_36_1)
			end

			if arg_33_1.time_ >= 0 + var_36_1 and arg_33_1.time_ < 0 + var_36_1 + arg_36_0 then
				arg_33_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_36_2 = arg_33_1.actors_["1070"]

			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 and not isNil(var_36_2) and arg_33_1.var_.actorSpriteComps1070 == nil then
				arg_33_1.var_.actorSpriteComps1070 = var_36_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_33_1.time_ >= 0 + var_36_3 and arg_33_1.time_ < 0 + var_36_3 + arg_36_0 and not isNil(var_36_2) and arg_33_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_5 + arg_36_0 then
				...
				local var_36_7 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(910812009).content)

				arg_33_1.text_.text = var_36_7

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_9 = 48 <= 0 and var_36_6 or var_36_6 * (utf8.len(var_36_7) / 48)

				if (48 <= 0 and var_36_6 or var_36_6 * (utf8.len(var_36_7) / 48)) > 0 and var_36_6 < var_36_9 then
	...
	Play910812010 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				arg_37_1.var_.moveOldPos1070 = arg_37_1.actors_["1070"].transform.localPosition
				arg_37_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_37_1:CheckSpriteTmpPos("1070", 3)

				for iter_40_0 = 0, arg_37_1.actors_["1070"].transform.childCount - 1 do
					local var_40_0 = arg_37_1.actors_["1070"].transform:GetChild(iter_40_0)

					if var_40_0.name == "split_8" or not string.find(var_40_0.name, "split") then
			...
			if 0 <= arg_37_1.time_ and arg_37_1.time_ < 0 + var_40_1 then
				arg_37_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_37_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_37_1.time_ - 0) / var_40_1)
			end

			if arg_37_1.time_ >= 0 + var_40_1 and arg_37_1.time_ < 0 + var_40_1 + arg_40_0 then
				arg_37_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_40_2 = arg_37_1.actors_["1070"]

			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 and not isNil(var_40_2) and arg_37_1.var_.actorSpriteComps1070 == nil then
				arg_37_1.var_.actorSpriteComps1070 = var_40_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_37_1.time_ >= 0 + var_40_3 and arg_37_1.time_ < 0 + var_40_3 + arg_40_0 and not isNil(var_40_2) and arg_37_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_5 + arg_40_0 then
				...
				local var_40_7 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(910812010).content)

				arg_37_1.text_.text = var_40_7

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_9 = 38 <= 0 and var_40_6 or var_40_6 * (utf8.len(var_40_7) / 38)

				if (38 <= 0 and var_40_6 or var_40_6 * (utf8.len(var_40_7) / 38)) > 0 and var_40_6 < var_40_9 then
	...
	Play910812011 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				arg_41_1.var_.moveOldPos1070 = arg_41_1.actors_["1070"].transform.localPosition
				arg_41_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_41_1:CheckSpriteTmpPos("1070", 3)

				for iter_44_0 = 0, arg_41_1.actors_["1070"].transform.childCount - 1 do
					local var_44_0 = arg_41_1.actors_["1070"].transform:GetChild(iter_44_0)

					if var_44_0.name == "split_8" or not string.find(var_44_0.name, "split") then
			...
			if 0 <= arg_41_1.time_ and arg_41_1.time_ < 0 + var_44_1 then
				arg_41_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_41_1.time_ - 0) / var_44_1)
			end

			if arg_41_1.time_ >= 0 + var_44_1 and arg_41_1.time_ < 0 + var_44_1 + arg_44_0 then
				arg_41_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_5 + arg_44_0 then
				...
				local var_44_7 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(910812011).content)

				arg_41_1.text_.text = var_44_7

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_9 = 33 <= 0 and var_44_6 or var_44_6 * (utf8.len(var_44_7) / 33)

				if (33 <= 0 and var_44_6 or var_44_6 * (utf8.len(var_44_7) / 33)) > 0 and var_44_6 < var_44_9 then
	...
	Play910812012 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1070 = arg_45_1.actors_["1070"].transform.localPosition
				arg_45_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_45_1:CheckSpriteTmpPos("1070", 3)

				for iter_48_0 = 0, arg_45_1.actors_["1070"].transform.childCount - 1 do
					local var_48_0 = arg_45_1.actors_["1070"].transform:GetChild(iter_48_0)
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_1 then
				arg_45_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_45_1.time_ - 0) / var_48_1)
			end

			if arg_45_1.time_ >= 0 + var_48_1 and arg_45_1.time_ < 0 + var_48_1 + arg_48_0 then
				arg_45_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_48_2 = arg_45_1.actors_["1070"]

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(var_48_2) and arg_45_1.var_.actorSpriteComps1070 == nil then
				arg_45_1.var_.actorSpriteComps1070 = var_48_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_45_1.time_ >= 0 + var_48_3 and arg_45_1.time_ < 0 + var_48_3 + arg_48_0 and not isNil(var_48_2) and arg_45_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_5 + arg_48_0 then
				...
				local var_48_7 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(910812012).content)

				arg_45_1.text_.text = var_48_7

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_9 = 15 <= 0 and var_48_6 or var_48_6 * (utf8.len(var_48_7) / 15)

				if (15 <= 0 and var_48_6 or var_48_6 * (utf8.len(var_48_7) / 15)) > 0 and var_48_6 < var_48_9 then
	...
	Play910812013 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1.var_.moveOldPos1070 = arg_49_1.actors_["1070"].transform.localPosition
				arg_49_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_49_1:CheckSpriteTmpPos("1070", 3)

				for iter_52_0 = 0, arg_49_1.actors_["1070"].transform.childCount - 1 do
					local var_52_0 = arg_49_1.actors_["1070"].transform:GetChild(iter_52_0)
			...
			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_1 then
				arg_49_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_49_1.time_ - 0) / var_52_1)
			end

			if arg_49_1.time_ >= 0 + var_52_1 and arg_49_1.time_ < 0 + var_52_1 + arg_52_0 then
				arg_49_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_52_2 = arg_49_1.actors_["1070"]

			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 and not isNil(var_52_2) and arg_49_1.var_.actorSpriteComps1070 == nil then
				arg_49_1.var_.actorSpriteComps1070 = var_52_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_49_1.time_ >= 0 + var_52_3 and arg_49_1.time_ < 0 + var_52_3 + arg_52_0 and not isNil(var_52_2) and arg_49_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_5 + arg_52_0 then
				...
				local var_52_7 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(910812013).content)

				arg_49_1.text_.text = var_52_7

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_9 = 18 <= 0 and var_52_6 or var_52_6 * (utf8.len(var_52_7) / 18)

				if (18 <= 0 and var_52_6 or var_52_6 * (utf8.len(var_52_7) / 18)) > 0 and var_52_6 < var_52_9 then
	...
	Play910812014 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1.var_.moveOldPos1070 = arg_53_1.actors_["1070"].transform.localPosition
				arg_53_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_53_1:CheckSpriteTmpPos("1070", 3)

				for iter_56_0 = 0, arg_53_1.actors_["1070"].transform.childCount - 1 do
					local var_56_0 = arg_53_1.actors_["1070"].transform:GetChild(iter_56_0)
			...
			if 0 <= arg_53_1.time_ and arg_53_1.time_ < 0 + var_56_1 then
				arg_53_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_53_1.time_ - 0) / var_56_1)
			end

			if arg_53_1.time_ >= 0 + var_56_1 and arg_53_1.time_ < 0 + var_56_1 + arg_56_0 then
				arg_53_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_56_2 = arg_53_1.actors_["1070"]

			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 and not isNil(var_56_2) and arg_53_1.var_.actorSpriteComps1070 == nil then
				arg_53_1.var_.actorSpriteComps1070 = var_56_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_53_1.time_ >= 0 + var_56_3 and arg_53_1.time_ < 0 + var_56_3 + arg_56_0 and not isNil(var_56_2) and arg_53_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_5 + arg_56_0 then
				...
				local var_56_7 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(910812014).content)
	...
	Play910812015 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1.var_.moveOldPos1070 = arg_57_1.actors_["1070"].transform.localPosition
				arg_57_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_57_1:CheckSpriteTmpPos("1070", 3)

				for iter_60_0 = 0, arg_57_1.actors_["1070"].transform.childCount - 1 do
					local var_60_0 = arg_57_1.actors_["1070"].transform:GetChild(iter_60_0)
			...
			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_1 then
				arg_57_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_57_1.time_ - 0) / var_60_1)
			end

			if arg_57_1.time_ >= 0 + var_60_1 and arg_57_1.time_ < 0 + var_60_1 + arg_60_0 then
				arg_57_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_60_2 = arg_57_1.actors_["1070"]

			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 and not isNil(var_60_2) and arg_57_1.var_.actorSpriteComps1070 == nil then
				arg_57_1.var_.actorSpriteComps1070 = var_60_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_57_1.time_ >= 0 + var_60_3 and arg_57_1.time_ < 0 + var_60_3 + arg_60_0 and not isNil(var_60_2) and arg_57_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_5 + arg_60_0 then
				...
				local var_60_7 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(910812015).content)

				arg_57_1.text_.text = var_60_7

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_9 = 27 <= 0 and var_60_6 or var_60_6 * (utf8.len(var_60_7) / 27)

				if (27 <= 0 and var_60_6 or var_60_6 * (utf8.len(var_60_7) / 27)) > 0 and var_60_6 < var_60_9 then
	...
	Play910812016 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				arg_61_1.var_.moveOldPos1070 = arg_61_1.actors_["1070"].transform.localPosition
				arg_61_1.actors_["1070"].transform.localScale = Vector3.New(1, 1, 1)

				arg_61_1:CheckSpriteTmpPos("1070", 3)

				for iter_64_0 = 0, arg_61_1.actors_["1070"].transform.childCount - 1 do
					local var_64_0 = arg_61_1.actors_["1070"].transform:GetChild(iter_64_0)
			...
			if 0 <= arg_61_1.time_ and arg_61_1.time_ < 0 + var_64_1 then
				arg_61_1.actors_["1070"].transform.localPosition = Vector3.Lerp(arg_61_1.var_.moveOldPos1070, Vector3.New(0, -350, -180), (arg_61_1.time_ - 0) / var_64_1)
			end

			if arg_61_1.time_ >= 0 + var_64_1 and arg_61_1.time_ < 0 + var_64_1 + arg_64_0 then
				arg_61_1.actors_["1070"].transform.localPosition = Vector3.New(0, -350, -180)
			end

			local var_64_2 = arg_61_1.actors_["1070"]

			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 and not isNil(var_64_2) and arg_61_1.var_.actorSpriteComps1070 == nil then
				arg_61_1.var_.actorSpriteComps1070 = var_64_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_61_1.time_ >= 0 + var_64_3 and arg_61_1.time_ < 0 + var_64_3 + arg_64_0 and not isNil(var_64_2) and arg_61_1.var_.actorSpriteComps1070 then
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				arg_61_1:AudioAction("play", "effect", "ui_skip", "ui_bgm_lower_back", "")
			end
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_6 + arg_64_0 then
				...
				local var_64_8 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(910812016).content)

				arg_61_1.text_.text = var_64_8

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_10 = 12 <= 0 and var_64_7 or var_64_7 * (utf8.len(var_64_8) / 12)

				if (12 <= 0 and var_64_7 or var_64_7 * (utf8.len(var_64_8) / 12)) > 0 and var_64_7 < var_64_10 then
