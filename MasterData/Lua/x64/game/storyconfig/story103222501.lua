	...
	Play322251110 = function(arg_412_0, arg_412_1)
		...
		function arg_412_1.onSingleLineUpdate_(arg_415_0)
			...
			if 2.01666666666667 < arg_412_1.time_ and arg_412_1.time_ <= 2.01666666666667 + arg_415_0 then
				...
				for iter_415_6, iter_415_7 in ipairs((var_415_17.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_415_7.transform.localScale = Vector3.New(iter_415_7.transform.localScale.x / var_415_19 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_415_7.transform.localScale.y / var_415_19, iter_415_7.transform.localScale.z)
				end
			end
			...
			local var_415_21 = 4
			local var_415_22 = 0.45

			if 4 < arg_412_1.time_ and arg_412_1.time_ <= var_415_21 + arg_415_0 then
				...
				local var_415_23 = LeanTween.value(arg_412_1.dialog_, 0, 1, 0.3)

				var_415_23:setOnUpdate(LuaHelper.FloatAction(function(arg_416_0)
					arg_412_1.dialogCg_.alpha = arg_416_0
				end))
				var_415_23:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_412_1.dialog_)
					var_415_23:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_415_24 = arg_412_1:FormatText(arg_412_1:GetWordFromCfg(322251110).content)

				arg_412_1.text_.text = var_415_24

				LuaForUtil.ClearLinePrefixSymbol(arg_412_1.text_)

				local var_415_26 = 18 <= 0 and var_415_22 or var_415_22 * (utf8.len(var_415_24) / 18)

				if (18 <= 0 and var_415_22 or var_415_22 * (utf8.len(var_415_24) / 18)) > 0 and var_415_22 < var_415_26 then
					arg_412_1.talkMaxDuration = var_415_26
					var_415_21 = var_415_21 + 0.3

					if var_415_26 + var_415_21 > arg_412_1.duration_ then
						arg_412_1.duration_ = var_415_26 + var_415_21
					end
				end
			...
			local var_415_27 = var_415_21 + 0.3
			local var_415_28 = math.max(var_415_22, arg_412_1.talkMaxDuration)

			if var_415_21 + 0.3 <= arg_412_1.time_ and arg_412_1.time_ < var_415_27 + var_415_28 then
				arg_412_1.typewritter.percent = (arg_412_1.time_ - var_415_27) / var_415_28

				arg_412_1.typewritter:SetDirty()
			end

			if arg_412_1.time_ >= var_415_27 + var_415_28 and arg_412_1.time_ < var_415_27 + var_415_28 + arg_415_0 then
