	...
	Play910823001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910823001).content)
	...
	Play910823002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_5 + arg_10_0 then
				...
				local var_10_7 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910823002).content)
	...
	Play910823003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_2 + arg_14_0 then
				...
				local var_14_4 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910823003).content)

				arg_11_1.text_.text = var_14_4

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_6 = 18 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 18)

				if (18 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 18)) > 0 and var_14_3 < var_14_6 then
	...
	Play910823004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910823004).content)
	...
	Play910823005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_2 + arg_22_0 then
				...
				local var_22_4 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910823005).content)

				arg_19_1.text_.text = var_22_4

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_6 = 27 <= 0 and var_22_3 or var_22_3 * (utf8.len(var_22_4) / 27)

				if (27 <= 0 and var_22_3 or var_22_3 * (utf8.len(var_22_4) / 27)) > 0 and var_22_3 < var_22_6 then
	...
	Play910823006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910823006).content)
	...
	Play910823007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_2 + arg_30_0 then
				...
				local var_30_4 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910823007).content)

				arg_27_1.text_.text = var_30_4

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_6 = 41 <= 0 and var_30_3 or var_30_3 * (utf8.len(var_30_4) / 41)

				if (41 <= 0 and var_30_3 or var_30_3 * (utf8.len(var_30_4) / 41)) > 0 and var_30_3 < var_30_6 then
	...
	Play910823008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910823008).content)
	...
	Play910823009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_2 + arg_38_0 then
				...
				local var_38_4 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910823009).content)

				arg_35_1.text_.text = var_38_4

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_6 = 17 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 17)

				if (17 <= 0 and var_38_3 or var_38_3 * (utf8.len(var_38_4) / 17)) > 0 and var_38_3 < var_38_6 then
	...
	Play910823010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910823010).content)
	...
	Play910823011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_2 + arg_46_0 then
				...
				local var_46_4 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910823011).content)
	...
	Play910823012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_6 + arg_50_0 then
				...
				local var_50_8 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910823012).content)

				arg_47_1.text_.text = var_50_8

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_10 = 3 <= 0 and var_50_7 or var_50_7 * (utf8.len(var_50_8) / 3)

				if (3 <= 0 and var_50_7 or var_50_7 * (utf8.len(var_50_8) / 3)) > 0 and var_50_7 < var_50_10 then
