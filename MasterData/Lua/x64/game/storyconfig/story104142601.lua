	...
	Play414261001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.999999999999 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414261001).content)

				arg_1_1.text_.text = var_4_11

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_13 = 11 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 11)

				if (11 <= 0 and var_4_9 or var_4_9 * (utf8.len(var_4_11) / 11)) > 0 and var_4_9 < var_4_13 then
	...
	Play414261002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 then
				...
				local var_10_10 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(414261002).content)

				arg_7_1.text_.text = var_10_10

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_12 = 5 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 5)

				if (5 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 5)) > 0 and var_10_9 < var_10_12 then
	...
	Play414261003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_1 + arg_14_0 then
				...
				arg_11_1.leftNameTxt_.text = arg_11_1:FormatText(StoryNameCfg[313].name)
				...
				local var_14_3 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(414261003).content)

				arg_11_1.text_.text = var_14_3

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_5 = 8 <= 0 and var_14_2 or var_14_2 * (utf8.len(var_14_3) / 8)

				if (8 <= 0 and var_14_2 or var_14_2 * (utf8.len(var_14_3) / 8)) > 0 and var_14_2 < var_14_5 then
	...
	Play414261004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(414261004).content)

				arg_15_1.text_.text = var_18_1

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_3 = 23 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 23)

				if (23 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 23)) > 0 and var_18_0 < var_18_3 then
	...
	Play414261005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				arg_19_1.leftNameTxt_.text = arg_19_1:FormatText(StoryNameCfg[313].name)
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(414261005).content)
	...
	Play414261006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_2 + arg_26_0 then
				...
				local var_26_4 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(414261006).content)
	...
	Play414261007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				arg_27_1.var_.moveOldPos104902ui_story = arg_27_1.actors_["104902ui_story"].transform.localPosition
			end

			local var_30_0 = 0.001

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_0 then
				arg_27_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_27_1.var_.moveOldPos104902ui_story, Vector3.New(0, 100, 0), (arg_27_1.time_ - 0) / var_30_0)
				arg_27_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_27_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["104902ui_story"].transform.position).z)
				arg_27_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_27_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_27_1.actors_["104902ui_story"].transform.localEulerAngles = arg_27_1.actors_["104902ui_story"].transform.localEulerAngles
			end

			if arg_27_1.time_ >= 0 + var_30_0 and arg_27_1.time_ < 0 + var_30_0 + arg_30_0 then
				arg_27_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_27_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_27_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["104902ui_story"].transform.position).z)
				arg_27_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_27_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_27_1.actors_["104902ui_story"].transform.localEulerAngles = arg_27_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			local var_30_1 = arg_27_1.actors_["104902ui_story"]

			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect104902ui_story == nil then
				arg_27_1.var_.characterEffect104902ui_story = var_30_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_30_2 = 0.200000002980232

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_2 and not isNil(var_30_1) then
				if arg_27_1.var_.characterEffect104902ui_story and not isNil(var_30_1) then
					arg_27_1.var_.characterEffect104902ui_story.fillFlat = true
					arg_27_1.var_.characterEffect104902ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_27_1.time_ - 0) / var_30_2)
				end
			end

			if arg_27_1.time_ >= 0 + var_30_2 and arg_27_1.time_ < 0 + var_30_2 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect104902ui_story then
				arg_27_1.var_.characterEffect104902ui_story.fillFlat = true
				arg_27_1.var_.characterEffect104902ui_story.fillRatio = 0.5
			end

			local var_30_3 = "102201ui_story"

			if arg_27_1.actors_["102201ui_story"] == nil and not isNil((Asset.Load("Char/" .. "102201ui_story"))) then
				local var_30_4 = Object.Instantiate(Asset.Load("Char/" .. "102201ui_story"), arg_27_1.stage_.transform)
			...
			local var_30_7 = arg_27_1.actors_["102201ui_story"].transform

			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				arg_27_1.var_.moveOldPos102201ui_story = var_30_7.localPosition

				arg_27_1:ShowWeapon(arg_27_1.var_["102201ui_story" .. "Animator"].transform, false)
			end

			local var_30_8 = 0.001

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_8 then
				var_30_7.localPosition = Vector3.Lerp(arg_27_1.var_.moveOldPos102201ui_story, Vector3.New(0, -1.08, -6), (arg_27_1.time_ - 0) / var_30_8)
			...
			if arg_27_1.time_ >= 0 + var_30_8 and arg_27_1.time_ < 0 + var_30_8 + arg_30_0 then
				var_30_7.localPosition = Vector3.New(0, -1.08, -6)
				var_30_7.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_30_7.position).x, (manager.ui.mainCamera.transform.position - var_30_7.position).y, (manager.ui.mainCamera.transform.position - var_30_7.position).z)
				var_30_7.localEulerAngles.z = 0
				var_30_7.localEulerAngles.x = 0
				var_30_7.localEulerAngles = var_30_7.localEulerAngles
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 and not isNil(var_30_9) and arg_27_1.var_.characterEffect102201ui_story == nil then
			...
			if arg_27_1.time_ >= 0 + var_30_10 and arg_27_1.time_ < 0 + var_30_10 + arg_30_0 and not isNil(var_30_9) and arg_27_1.var_.characterEffect102201ui_story then
				arg_27_1.var_.characterEffect102201ui_story.fillFlat = false
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_12 + arg_30_0 then
				...
				local var_30_14 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(414261007).content)

				arg_27_1.text_.text = var_30_14

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_16 = 8 <= 0 and var_30_13 or var_30_13 * (utf8.len(var_30_14) / 8)

				if (8 <= 0 and var_30_13 or var_30_13 * (utf8.len(var_30_14) / 8)) > 0 and var_30_13 < var_30_16 then
