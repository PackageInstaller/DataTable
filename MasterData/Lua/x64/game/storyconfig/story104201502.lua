return {
	Play420152001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_14 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1061ui_story, Vector3.New(0, -1.18, -6.15), (arg_1_1.time_ - 2) / var_4_14)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1061ui_story == nil then
			...
			if arg_1_1.time_ >= 2 + var_4_16 and arg_1_1.time_ < 2 + var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect1061ui_story then
				arg_1_1.var_.characterEffect1061ui_story.fillFlat = false
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				...
				local var_4_25 = arg_1_1:GetWordFromCfg(420152001)
				...
				local var_4_28 = 30 <= 0 and var_4_23 or var_4_23 * (utf8.len(var_4_26) / 30)

				if (30 <= 0 and var_4_23 or var_4_23 * (utf8.len(var_4_26) / 30)) > 0 and var_4_23 < var_4_28 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152001", "story_v_out_420152.awb") ~= 0 then
					local var_4_29 = manager.audio:GetVoiceLength("story_v_out_420152", "420152001", "story_v_out_420152.awb") / 1000
					...
					if var_4_25.prefab_name ~= "" and arg_1_1.actors_[var_4_25.prefab_name] ~= nil then
						local var_4_30 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_25.prefab_name].transform, "story_v_out_420152", "420152001", "story_v_out_420152.awb")

						arg_1_1:RecordAudio("420152001", var_4_30)
						arg_1_1:RecordAudio("420152001", var_4_30)
					else
	...
	Play420152002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 then
				arg_8_1.var_.moveOldPos1061ui_story = arg_8_1.actors_["1061ui_story"].transform.localPosition
			end

			local var_11_0 = 0.001

			if 0 <= arg_8_1.time_ and arg_8_1.time_ < 0 + var_11_0 then
				arg_8_1.actors_["1061ui_story"].transform.localPosition = Vector3.Lerp(arg_8_1.var_.moveOldPos1061ui_story, Vector3.New(0, 100, 0), (arg_8_1.time_ - 0) / var_11_0)
				arg_8_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_8_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_8_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_8_1.actors_["1061ui_story"].transform.position).z)
				arg_8_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_8_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_8_1.actors_["1061ui_story"].transform.localEulerAngles = arg_8_1.actors_["1061ui_story"].transform.localEulerAngles
			end

			if arg_8_1.time_ >= 0 + var_11_0 and arg_8_1.time_ < 0 + var_11_0 + arg_11_0 then
				arg_8_1.actors_["1061ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_8_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_8_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_8_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_8_1.actors_["1061ui_story"].transform.position).z)
				arg_8_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_8_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_8_1.actors_["1061ui_story"].transform.localEulerAngles = arg_8_1.actors_["1061ui_story"].transform.localEulerAngles
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_1 + arg_11_0 then
				...
				local var_11_3 = arg_8_1:FormatText(arg_8_1:GetWordFromCfg(420152002).content)

				arg_8_1.text_.text = var_11_3

				LuaForUtil.ClearLinePrefixSymbol(arg_8_1.text_)

				local var_11_5 = 63 <= 0 and var_11_2 or var_11_2 * (utf8.len(var_11_3) / 63)

				if (63 <= 0 and var_11_2 or var_11_2 * (utf8.len(var_11_3) / 63)) > 0 and var_11_2 < var_11_5 then
	...
	Play420152003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0.3 < arg_12_1.time_ and arg_12_1.time_ <= 0.3 + arg_15_0 then
				arg_12_1:AudioAction("play", "effect", "se_story_140", "se_story_140_light_on", "")
			end

			local var_15_1 = 0.6

			if 0.6 < arg_12_1.time_ and arg_12_1.time_ <= var_15_1 + arg_15_0 then
			...
			if 0.3 < arg_12_1.time_ and arg_12_1.time_ <= 0.3 + arg_15_0 then
				local var_15_5 = arg_12_1.var_.effect2003

				if not arg_12_1.var_.effect2003 then
					var_15_5 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"), manager.ui.mainCamera.transform)
					var_15_5.name = "2003"
					arg_12_1.var_.effect2003 = var_15_5
				else
					var_15_5.transform:SetParent(var_15_9000)
				end
			...
			if 1.175 < arg_12_1.time_ and arg_12_1.time_ <= 1.175 + arg_15_0 then
				if arg_12_1.var_.effect2003 then
					Object.Destroy(arg_12_1.var_.effect2003)
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_8 + arg_15_0 then
				...
				local var_15_10 = arg_12_1:FormatText(arg_12_1:GetWordFromCfg(420152003).content)

				arg_12_1.text_.text = var_15_10

				LuaForUtil.ClearLinePrefixSymbol(arg_12_1.text_)

				local var_15_12 = 47 <= 0 and var_15_9 or var_15_9 * (utf8.len(var_15_10) / 47)

				if (47 <= 0 and var_15_9 or var_15_9 * (utf8.len(var_15_10) / 47)) > 0 and var_15_9 < var_15_12 then
					arg_12_1.talkMaxDuration = var_15_12

					if var_15_12 + var_15_8 > arg_12_1.duration_ then
						arg_12_1.duration_ = var_15_12 + var_15_8
					end
				end
			...
			local var_15_13 = math.max(var_15_9, arg_12_1.talkMaxDuration)

			if var_15_8 <= arg_12_1.time_ and arg_12_1.time_ < var_15_8 + var_15_13 then
				arg_12_1.typewritter.percent = (arg_12_1.time_ - var_15_8) / var_15_13

				arg_12_1.typewritter:SetDirty()
			end

			if arg_12_1.time_ >= var_15_8 + var_15_13 and arg_12_1.time_ < var_15_8 + var_15_13 + arg_15_0 then
	...
	Play420152004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_8 + arg_19_0 then
				...
				local var_19_10 = arg_16_1:GetWordFromCfg(420152004)
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152004", "story_v_out_420152.awb") ~= 0 then
					local var_19_14 = manager.audio:GetVoiceLength("story_v_out_420152", "420152004", "story_v_out_420152.awb") / 1000
					...
					if var_19_10.prefab_name ~= "" and arg_16_1.actors_[var_19_10.prefab_name] ~= nil then
						local var_19_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_10.prefab_name].transform, "story_v_out_420152", "420152004", "story_v_out_420152.awb")

						arg_16_1:RecordAudio("420152004", var_19_15)
						arg_16_1:RecordAudio("420152004", var_19_15)
					else
	...
	Play420152005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_0 + arg_23_0 then
				...
				local var_23_2 = arg_20_1:GetWordFromCfg(420152005)
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152005", "story_v_out_420152.awb") ~= 0 then
					local var_23_6 = manager.audio:GetVoiceLength("story_v_out_420152", "420152005", "story_v_out_420152.awb") / 1000
					...
					if var_23_2.prefab_name ~= "" and arg_20_1.actors_[var_23_2.prefab_name] ~= nil then
						local var_23_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_20_1.actors_[var_23_2.prefab_name].transform, "story_v_out_420152", "420152005", "story_v_out_420152.awb")

						arg_20_1:RecordAudio("420152005", var_23_7)
						arg_20_1:RecordAudio("420152005", var_23_7)
					else
	...
	Play420152006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			if 0.933333333333333 < arg_24_1.time_ and arg_24_1.time_ <= 0.933333333333333 + arg_27_0 then
				arg_24_1:AudioAction("play", "effect", "se_story_140", "se_story_140_put", "")
			end

			local var_27_1 = arg_24_1.actors_["1085ui_story"].transform

			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 then
				arg_24_1.var_.moveOldPos1085ui_story = var_27_1.localPosition
			end

			local var_27_2 = 0.001

			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_2 then
				var_27_1.localPosition = Vector3.Lerp(arg_24_1.var_.moveOldPos1085ui_story, Vector3.New(0, 100, 0), (arg_24_1.time_ - 0) / var_27_2)
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_3 + arg_27_0 then
				...
				local var_27_5 = arg_24_1:FormatText(arg_24_1:GetWordFromCfg(420152006).content)

				arg_24_1.text_.text = var_27_5

				LuaForUtil.ClearLinePrefixSymbol(arg_24_1.text_)

				local var_27_7 = 43 <= 0 and var_27_4 or var_27_4 * (utf8.len(var_27_5) / 43)

				if (43 <= 0 and var_27_4 or var_27_4 * (utf8.len(var_27_5) / 43)) > 0 and var_27_4 < var_27_7 then
	...
	Play420152007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			local var_31_2 = arg_28_1.actors_["1085ui_story"].transform

			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 then
				arg_28_1.var_.moveOldPos1085ui_story = var_31_2.localPosition
			end

			local var_31_3 = 0.001

			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_3 then
				var_31_2.localPosition = Vector3.Lerp(arg_28_1.var_.moveOldPos1085ui_story, Vector3.New(0, -1.01, -5.83), (arg_28_1.time_ - 0) / var_31_3)
			...
			if arg_28_1.time_ >= 0 + var_31_3 and arg_28_1.time_ < 0 + var_31_3 + arg_31_0 then
				var_31_2.localPosition = Vector3.New(0, -1.01, -5.83)
				var_31_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_31_2.position).x, (manager.ui.mainCamera.transform.position - var_31_2.position).y, (manager.ui.mainCamera.transform.position - var_31_2.position).z)
				var_31_2.localEulerAngles.z = 0
				var_31_2.localEulerAngles.x = 0
				var_31_2.localEulerAngles = var_31_2.localEulerAngles
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_4 + arg_31_0 then
				...
				arg_28_1.leftNameTxt_.text = arg_28_1:FormatText(StoryNameCfg[328].name)
				...
				local var_31_6 = arg_28_1:GetWordFromCfg(420152007)
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152007", "story_v_out_420152.awb") ~= 0 then
					local var_31_10 = manager.audio:GetVoiceLength("story_v_out_420152", "420152007", "story_v_out_420152.awb") / 1000
					...
					if var_31_6.prefab_name ~= "" and arg_28_1.actors_[var_31_6.prefab_name] ~= nil then
						local var_31_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_6.prefab_name].transform, "story_v_out_420152", "420152007", "story_v_out_420152.awb")

						arg_28_1:RecordAudio("420152007", var_31_11)
						arg_28_1:RecordAudio("420152007", var_31_11)
					else
	...
	Play420152008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= 0 + arg_35_0 and not isNil(arg_32_1.actors_["1085ui_story"]) and arg_32_1.var_.characterEffect1085ui_story == nil then
				arg_32_1.var_.characterEffect1085ui_story = arg_32_1.actors_["1085ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_35_0 = 0.200000002980232

			if 0 <= arg_32_1.time_ and arg_32_1.time_ < 0 + var_35_0 and not isNil(arg_32_1.actors_["1085ui_story"]) then
				if arg_32_1.var_.characterEffect1085ui_story and not isNil(arg_32_1.actors_["1085ui_story"]) then
					arg_32_1.var_.characterEffect1085ui_story.fillFlat = true
					arg_32_1.var_.characterEffect1085ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_32_1.time_ - 0) / var_35_0)
				end
			end

			if arg_32_1.time_ >= 0 + var_35_0 and arg_32_1.time_ < 0 + var_35_0 + arg_35_0 and not isNil(arg_32_1.actors_["1085ui_story"]) and arg_32_1.var_.characterEffect1085ui_story then
				arg_32_1.var_.characterEffect1085ui_story.fillFlat = true
				arg_32_1.var_.characterEffect1085ui_story.fillRatio = 0.5
			end

			local var_35_1 = 0
			local var_35_2 = 1.575
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_1 + arg_35_0 then
				...
				local var_35_3 = arg_32_1:FormatText(arg_32_1:GetWordFromCfg(420152008).content)

				arg_32_1.text_.text = var_35_3

				LuaForUtil.ClearLinePrefixSymbol(arg_32_1.text_)

				local var_35_5 = 63 <= 0 and var_35_2 or var_35_2 * (utf8.len(var_35_3) / 63)

				if (63 <= 0 and var_35_2 or var_35_2 * (utf8.len(var_35_3) / 63)) > 0 and var_35_2 < var_35_5 then
	...
	Play420152009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if 0.200000002980232 < arg_36_1.time_ and arg_36_1.time_ <= 0.200000002980232 + arg_39_0 then
				arg_36_1:AudioAction("play", "effect", "se_story_140", "se_story_140_footstep_run07", "")
			end

			local var_39_3 = 0
			local var_39_4 = 0.575
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_3 + arg_39_0 then
				...
				local var_39_5 = arg_36_1:GetWordFromCfg(420152009)
				...
				local var_39_8 = 23 <= 0 and var_39_4 or var_39_4 * (utf8.len(var_39_6) / 23)

				if (23 <= 0 and var_39_4 or var_39_4 * (utf8.len(var_39_6) / 23)) > 0 and var_39_4 < var_39_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152009", "story_v_out_420152.awb") ~= 0 then
					local var_39_9 = manager.audio:GetVoiceLength("story_v_out_420152", "420152009", "story_v_out_420152.awb") / 1000
					...
					if var_39_5.prefab_name ~= "" and arg_36_1.actors_[var_39_5.prefab_name] ~= nil then
						local var_39_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_36_1.actors_[var_39_5.prefab_name].transform, "story_v_out_420152", "420152009", "story_v_out_420152.awb")

						arg_36_1:RecordAudio("420152009", var_39_10)
						arg_36_1:RecordAudio("420152009", var_39_10)
					else
	...
	Play420152010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if 0.166666666666667 < arg_40_1.time_ and arg_40_1.time_ <= 0.166666666666667 + arg_43_0 then
				arg_40_1:AudioAction("play", "effect", "se_story_140", "se_story_140_door_push", "")
			end
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_2 + arg_43_0 then
				...
				local var_43_4 = arg_40_1:FormatText(arg_40_1:GetWordFromCfg(420152010).content)

				arg_40_1.text_.text = var_43_4

				LuaForUtil.ClearLinePrefixSymbol(arg_40_1.text_)

				local var_43_6 = 32 <= 0 and var_43_3 or var_43_3 * (utf8.len(var_43_4) / 32)

				if (32 <= 0 and var_43_3 or var_43_3 * (utf8.len(var_43_4) / 32)) > 0 and var_43_3 < var_43_6 then
	...
	Play420152011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if arg_44_1.time_ >= var_47_3 + 0.575 and arg_44_1.time_ < var_47_3 + 0.575 + arg_47_0 then
			...
			if 0.5 < arg_44_1.time_ and arg_44_1.time_ <= var_47_4 + arg_47_0 then
				...
				local var_47_6 = LeanTween.value(arg_44_1.dialog_, 0, 1, 0.3)

				var_47_6:setOnUpdate(LuaHelper.FloatAction(function(arg_48_0)
					arg_44_1.dialogCg_.alpha = arg_48_0
				end))
				var_47_6:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_44_1.dialog_)
					var_47_6:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_47_7 = arg_44_1:FormatText(arg_44_1:GetWordFromCfg(420152011).content)

				arg_44_1.text_.text = var_47_7

				LuaForUtil.ClearLinePrefixSymbol(arg_44_1.text_)

				local var_47_9 = 3 <= 0 and var_47_5 or var_47_5 * (utf8.len(var_47_7) / 3)

				if (3 <= 0 and var_47_5 or var_47_5 * (utf8.len(var_47_7) / 3)) > 0 and var_47_5 < var_47_9 then
					arg_44_1.talkMaxDuration = var_47_9
					var_47_4 = var_47_4 + 0.3
			...
			local var_47_10 = var_47_4 + 0.3
			local var_47_11 = math.max(var_47_5, arg_44_1.talkMaxDuration)

			if var_47_4 + 0.3 <= arg_44_1.time_ and arg_44_1.time_ < var_47_10 + var_47_11 then
				arg_44_1.typewritter.percent = (arg_44_1.time_ - var_47_10) / var_47_11
	...
	Play420152012 = function(arg_50_0, arg_50_1)
		...
		function arg_50_1.onSingleLineUpdate_(arg_53_0)
			if 0.2 < arg_50_1.time_ and arg_50_1.time_ <= 0.2 + arg_53_0 then
				arg_50_1:AudioAction("play", "effect", "se_story_140", "se_story_140_footstep_run03", "")
			end

			local var_53_1 = 0
			local var_53_2 = 1.325
			...
			if 0 < arg_50_1.time_ and arg_50_1.time_ <= var_53_1 + arg_53_0 then
				...
				local var_53_3 = arg_50_1:FormatText(arg_50_1:GetWordFromCfg(420152012).content)

				arg_50_1.text_.text = var_53_3

				LuaForUtil.ClearLinePrefixSymbol(arg_50_1.text_)

				local var_53_5 = 53 <= 0 and var_53_2 or var_53_2 * (utf8.len(var_53_3) / 53)

				if (53 <= 0 and var_53_2 or var_53_2 * (utf8.len(var_53_3) / 53)) > 0 and var_53_2 < var_53_5 then
	...
	Play420152013 = function(arg_54_0, arg_54_1)
		...
		function arg_54_1.onSingleLineUpdate_(arg_57_0)
			...
			if 0 < arg_54_1.time_ and arg_54_1.time_ <= 0 + arg_57_0 then
				...
				local var_57_1 = arg_54_1:FormatText(arg_54_1:GetWordFromCfg(420152013).content)

				arg_54_1.text_.text = var_57_1

				LuaForUtil.ClearLinePrefixSymbol(arg_54_1.text_)

				local var_57_3 = 5 <= 0 and var_57_0 or var_57_0 * (utf8.len(var_57_1) / 5)

				if (5 <= 0 and var_57_0 or var_57_0 * (utf8.len(var_57_1) / 5)) > 0 and var_57_0 < var_57_3 then
	...
	Play420152014 = function(arg_58_0, arg_58_1)
		...
		function arg_58_1.onSingleLineUpdate_(arg_61_0)
			if 0 < arg_58_1.time_ and arg_58_1.time_ <= 0 + arg_61_0 then
				arg_58_1.var_.moveOldPos1085ui_story = arg_58_1.actors_["1085ui_story"].transform.localPosition
			end

			local var_61_0 = 0.001

			if 0 <= arg_58_1.time_ and arg_58_1.time_ < 0 + var_61_0 then
				arg_58_1.actors_["1085ui_story"].transform.localPosition = Vector3.Lerp(arg_58_1.var_.moveOldPos1085ui_story, Vector3.New(0, -1.01, -5.83), (arg_58_1.time_ - 0) / var_61_0)
				arg_58_1.actors_["1085ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_58_1.actors_["1085ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_58_1.actors_["1085ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_58_1.actors_["1085ui_story"].transform.position).z)
				arg_58_1.actors_["1085ui_story"].transform.localEulerAngles.z = 0
				arg_58_1.actors_["1085ui_story"].transform.localEulerAngles.x = 0
				arg_58_1.actors_["1085ui_story"].transform.localEulerAngles = arg_58_1.actors_["1085ui_story"].transform.localEulerAngles
			end

			if arg_58_1.time_ >= 0 + var_61_0 and arg_58_1.time_ < 0 + var_61_0 + arg_61_0 then
				arg_58_1.actors_["1085ui_story"].transform.localPosition = Vector3.New(0, -1.01, -5.83)
				arg_58_1.actors_["1085ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_58_1.actors_["1085ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_58_1.actors_["1085ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_58_1.actors_["1085ui_story"].transform.position).z)
				arg_58_1.actors_["1085ui_story"].transform.localEulerAngles.z = 0
				arg_58_1.actors_["1085ui_story"].transform.localEulerAngles.x = 0
				arg_58_1.actors_["1085ui_story"].transform.localEulerAngles = arg_58_1.actors_["1085ui_story"].transform.localEulerAngles
			...
			local var_61_1 = arg_58_1.actors_["1085ui_story"]

			if 0 < arg_58_1.time_ and arg_58_1.time_ <= 0 + arg_61_0 and not isNil(var_61_1) and arg_58_1.var_.characterEffect1085ui_story == nil then
				arg_58_1.var_.characterEffect1085ui_story = var_61_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_61_2 = 0.200000002980232

			if 0 <= arg_58_1.time_ and arg_58_1.time_ < 0 + var_61_2 and not isNil(var_61_1) then
				if arg_58_1.var_.characterEffect1085ui_story and not isNil(var_61_1) then
					arg_58_1.var_.characterEffect1085ui_story.fillFlat = false
				end
			end

			if arg_58_1.time_ >= 0 + var_61_2 and arg_58_1.time_ < 0 + var_61_2 + arg_61_0 and not isNil(var_61_1) and arg_58_1.var_.characterEffect1085ui_story then
				arg_58_1.var_.characterEffect1085ui_story.fillFlat = false
			end
			...
			if 0 < arg_58_1.time_ and arg_58_1.time_ <= var_61_4 + arg_61_0 then
				...
				local var_61_6 = arg_58_1:GetWordFromCfg(420152014)
				...
				local var_61_9 = 29 <= 0 and var_61_5 or var_61_5 * (utf8.len(var_61_7) / 29)

				if (29 <= 0 and var_61_5 or var_61_5 * (utf8.len(var_61_7) / 29)) > 0 and var_61_5 < var_61_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152014", "story_v_out_420152.awb") ~= 0 then
					local var_61_10 = manager.audio:GetVoiceLength("story_v_out_420152", "420152014", "story_v_out_420152.awb") / 1000
					...
					if var_61_6.prefab_name ~= "" and arg_58_1.actors_[var_61_6.prefab_name] ~= nil then
						local var_61_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_58_1.actors_[var_61_6.prefab_name].transform, "story_v_out_420152", "420152014", "story_v_out_420152.awb")

						arg_58_1:RecordAudio("420152014", var_61_11)
						arg_58_1:RecordAudio("420152014", var_61_11)
					else
	...
	Play420152015 = function(arg_62_0, arg_62_1)
		...
		function arg_62_1.onSingleLineUpdate_(arg_65_0)
			if 0.4 < arg_62_1.time_ and arg_62_1.time_ <= 0.4 + arg_65_0 then
				arg_62_1.var_.shakeOldPos = manager.ui.mainCamera.transform.localPosition
			end

			local var_65_0 = 0.3

			if 0.4 <= arg_62_1.time_ and arg_62_1.time_ < 0.4 + var_65_0 then
				local var_65_1, var_65_2 = math.modf((arg_62_1.time_ - 0.4) / 0.066)

				manager.ui.mainCamera.transform.localPosition = Vector3.New(var_65_2 * 0.13, var_65_2 * 0.13, var_65_2 * 0.13) + arg_62_1.var_.shakeOldPos
			end

			if arg_62_1.time_ >= 0.4 + var_65_0 and arg_62_1.time_ < 0.4 + var_65_0 + arg_65_0 then
				manager.ui.mainCamera.transform.localPosition = arg_62_1.var_.shakeOldPos
			end

			local var_65_3 = arg_62_1.actors_["1085ui_story"].transform

			if 0 < arg_62_1.time_ and arg_62_1.time_ <= 0 + arg_65_0 then
				arg_62_1.var_.moveOldPos1085ui_story = var_65_3.localPosition
			end

			local var_65_4 = 0.001

			if 0 <= arg_62_1.time_ and arg_62_1.time_ < 0 + var_65_4 then
				var_65_3.localPosition = Vector3.Lerp(arg_62_1.var_.moveOldPos1085ui_story, Vector3.New(0, 100, 0), (arg_62_1.time_ - 0) / var_65_4)
			...
			if 0 < arg_62_1.time_ and arg_62_1.time_ <= var_65_5 + arg_65_0 then
				...
				local var_65_7 = arg_62_1:FormatText(arg_62_1:GetWordFromCfg(420152015).content)

				arg_62_1.text_.text = var_65_7

				LuaForUtil.ClearLinePrefixSymbol(arg_62_1.text_)

				local var_65_9 = 23 <= 0 and var_65_6 or var_65_6 * (utf8.len(var_65_7) / 23)

				if (23 <= 0 and var_65_6 or var_65_6 * (utf8.len(var_65_7) / 23)) > 0 and var_65_6 < var_65_9 then
	...
	Play420152016 = function(arg_66_0, arg_66_1)
		...
		function arg_66_1.onSingleLineUpdate_(arg_69_0)
			...
			local var_69_2 = arg_66_1.actors_["1085ui_story"].transform

			if 0 < arg_66_1.time_ and arg_66_1.time_ <= 0 + arg_69_0 then
				arg_66_1.var_.moveOldPos1085ui_story = var_69_2.localPosition
			end

			local var_69_3 = 0.001

			if 0 <= arg_66_1.time_ and arg_66_1.time_ < 0 + var_69_3 then
				var_69_2.localPosition = Vector3.Lerp(arg_66_1.var_.moveOldPos1085ui_story, Vector3.New(0, -1.01, -5.83), (arg_66_1.time_ - 0) / var_69_3)
			...
			if arg_66_1.time_ >= 0 + var_69_3 and arg_66_1.time_ < 0 + var_69_3 + arg_69_0 then
				var_69_2.localPosition = Vector3.New(0, -1.01, -5.83)
				var_69_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_69_2.position).x, (manager.ui.mainCamera.transform.position - var_69_2.position).y, (manager.ui.mainCamera.transform.position - var_69_2.position).z)
				var_69_2.localEulerAngles.z = 0
				var_69_2.localEulerAngles.x = 0
				var_69_2.localEulerAngles = var_69_2.localEulerAngles
			...
			if 0 < arg_66_1.time_ and arg_66_1.time_ <= var_69_4 + arg_69_0 then
				...
				local var_69_6 = arg_66_1:GetWordFromCfg(420152016)
				...
				local var_69_9 = 22 <= 0 and var_69_5 or var_69_5 * (utf8.len(var_69_7) / 22)

				if (22 <= 0 and var_69_5 or var_69_5 * (utf8.len(var_69_7) / 22)) > 0 and var_69_5 < var_69_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152016", "story_v_out_420152.awb") ~= 0 then
					local var_69_10 = manager.audio:GetVoiceLength("story_v_out_420152", "420152016", "story_v_out_420152.awb") / 1000
					...
					if var_69_6.prefab_name ~= "" and arg_66_1.actors_[var_69_6.prefab_name] ~= nil then
						local var_69_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_66_1.actors_[var_69_6.prefab_name].transform, "story_v_out_420152", "420152016", "story_v_out_420152.awb")

						arg_66_1:RecordAudio("420152016", var_69_11)
						arg_66_1:RecordAudio("420152016", var_69_11)
					else
	...
	Play420152017 = function(arg_70_0, arg_70_1)
		...
		function arg_70_1.onSingleLineUpdate_(arg_73_0)
			...
			if 0 < arg_70_1.time_ and arg_70_1.time_ <= 0 + arg_73_0 then
				...
				local var_73_1 = arg_70_1:GetWordFromCfg(420152017)
				...
				local var_73_4 = 36 <= 0 and var_73_0 or var_73_0 * (utf8.len(var_73_2) / 36)

				if (36 <= 0 and var_73_0 or var_73_0 * (utf8.len(var_73_2) / 36)) > 0 and var_73_0 < var_73_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152017", "story_v_out_420152.awb") ~= 0 then
					local var_73_5 = manager.audio:GetVoiceLength("story_v_out_420152", "420152017", "story_v_out_420152.awb") / 1000
					...
					if var_73_1.prefab_name ~= "" and arg_70_1.actors_[var_73_1.prefab_name] ~= nil then
						local var_73_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_70_1.actors_[var_73_1.prefab_name].transform, "story_v_out_420152", "420152017", "story_v_out_420152.awb")

						arg_70_1:RecordAudio("420152017", var_73_6)
						arg_70_1:RecordAudio("420152017", var_73_6)
					else
		...
		function arg_74_1.onSingleLineUpdate_(arg_77_0)
			...
			if 0 <= arg_74_1.time_ and arg_74_1.time_ < 0 + var_77_0 and not isNil(arg_74_1.actors_["1085ui_story"]) then
				if arg_74_1.var_.characterEffect1085ui_story and not isNil(arg_74_1.actors_["1085ui_story"]) then
					...
					arg_74_1.var_.characterEffect1085ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_74_1.time_ - 0) / var_77_0)
				end
			end
			...
			if arg_74_1.time_ >= 0 + var_77_0 and arg_74_1.time_ < 0 + var_77_0 + arg_77_0 and not isNil(arg_74_1.actors_["1085ui_story"]) and arg_74_1.var_.characterEffect1085ui_story then
				arg_74_1.var_.characterEffect1085ui_story.fillFlat = true
				arg_74_1.var_.characterEffect1085ui_story.fillRatio = 0.5
			end

			local var_77_1 = 0
			local var_77_2 = 0.225
			...
			if 0 < arg_74_1.time_ and arg_74_1.time_ <= var_77_1 + arg_77_0 then
				...
				local var_77_3 = arg_74_1:FormatText(arg_74_1:GetWordFromCfg(420152018).content)

				arg_74_1.text_.text = var_77_3

				LuaForUtil.ClearLinePrefixSymbol(arg_74_1.text_)

				local var_77_5 = 9 <= 0 and var_77_2 or var_77_2 * (utf8.len(var_77_3) / 9)

				if (9 <= 0 and var_77_2 or var_77_2 * (utf8.len(var_77_3) / 9)) > 0 and var_77_2 < var_77_5 then
	...
	Play420152019 = function(arg_78_0, arg_78_1)
		...
		function arg_78_1.onSingleLineUpdate_(arg_81_0)
			if 0 < arg_78_1.time_ and arg_78_1.time_ <= 0 + arg_81_0 and not isNil(arg_78_1.actors_["1085ui_story"]) and arg_78_1.var_.characterEffect1085ui_story == nil then
				arg_78_1.var_.characterEffect1085ui_story = arg_78_1.actors_["1085ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_81_0 = 0.200000002980232

			if 0 <= arg_78_1.time_ and arg_78_1.time_ < 0 + var_81_0 and not isNil(arg_78_1.actors_["1085ui_story"]) then
				if arg_78_1.var_.characterEffect1085ui_story and not isNil(arg_78_1.actors_["1085ui_story"]) then
					arg_78_1.var_.characterEffect1085ui_story.fillFlat = false
				end
			end

			if arg_78_1.time_ >= 0 + var_81_0 and arg_78_1.time_ < 0 + var_81_0 + arg_81_0 and not isNil(arg_78_1.actors_["1085ui_story"]) and arg_78_1.var_.characterEffect1085ui_story then
				arg_78_1.var_.characterEffect1085ui_story.fillFlat = false
			end
			...
			if 0 < arg_78_1.time_ and arg_78_1.time_ <= var_81_2 + arg_81_0 then
				...
				local var_81_4 = arg_78_1:GetWordFromCfg(420152019)
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152019", "story_v_out_420152.awb") ~= 0 then
					local var_81_8 = manager.audio:GetVoiceLength("story_v_out_420152", "420152019", "story_v_out_420152.awb") / 1000
					...
					if var_81_4.prefab_name ~= "" and arg_78_1.actors_[var_81_4.prefab_name] ~= nil then
						local var_81_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_78_1.actors_[var_81_4.prefab_name].transform, "story_v_out_420152", "420152019", "story_v_out_420152.awb")

						arg_78_1:RecordAudio("420152019", var_81_9)
						arg_78_1:RecordAudio("420152019", var_81_9)
					else
	...
	Play420152020 = function(arg_82_0, arg_82_1)
		...
		function arg_82_1.onSingleLineUpdate_(arg_85_0)
			...
			if 0 <= arg_82_1.time_ and arg_82_1.time_ < 0 + var_85_0 then
				arg_82_1.actors_["1085ui_story"].transform.localPosition = Vector3.Lerp(arg_82_1.var_.moveOldPos1085ui_story, Vector3.New(0, 100, 0), (arg_82_1.time_ - 0) / var_85_0)
			...
			if arg_82_1.time_ >= 0 + var_85_0 and arg_82_1.time_ < 0 + var_85_0 + arg_85_0 then
				arg_82_1.actors_["1085ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_82_1.actors_["1085ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_82_1.actors_["1085ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_82_1.actors_["1085ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_82_1.actors_["1085ui_story"].transform.position).z)
				arg_82_1.actors_["1085ui_story"].transform.localEulerAngles.z = 0
				arg_82_1.actors_["1085ui_story"].transform.localEulerAngles.x = 0
				arg_82_1.actors_["1085ui_story"].transform.localEulerAngles = arg_82_1.actors_["1085ui_story"].transform.localEulerAngles
			...
			if 0 < arg_82_1.time_ and arg_82_1.time_ <= var_85_1 + arg_85_0 then
				...
				local var_85_3 = arg_82_1:FormatText(arg_82_1:GetWordFromCfg(420152020).content)

				arg_82_1.text_.text = var_85_3

				LuaForUtil.ClearLinePrefixSymbol(arg_82_1.text_)

				local var_85_5 = 38 <= 0 and var_85_2 or var_85_2 * (utf8.len(var_85_3) / 38)

				if (38 <= 0 and var_85_2 or var_85_2 * (utf8.len(var_85_3) / 38)) > 0 and var_85_2 < var_85_5 then
	...
	Play420152021 = function(arg_86_0, arg_86_1)
		...
		function arg_86_1.onSingleLineUpdate_(arg_89_0)
			...
			if 0 < arg_86_1.time_ and arg_86_1.time_ <= 0 + arg_89_0 then
				...
				local var_89_1 = arg_86_1:FormatText(arg_86_1:GetWordFromCfg(420152021).content)

				arg_86_1.text_.text = var_89_1

				LuaForUtil.ClearLinePrefixSymbol(arg_86_1.text_)

				local var_89_3 = 63 <= 0 and var_89_0 or var_89_0 * (utf8.len(var_89_1) / 63)

				if (63 <= 0 and var_89_0 or var_89_0 * (utf8.len(var_89_1) / 63)) > 0 and var_89_0 < var_89_3 then
	...
	Play420152022 = function(arg_90_0, arg_90_1)
		...
		function arg_90_1.onSingleLineUpdate_(arg_93_0)
			...
			if 0 < arg_90_1.time_ and arg_90_1.time_ <= 0 + arg_93_0 then
				...
				local var_93_1 = arg_90_1:FormatText(arg_90_1:GetWordFromCfg(420152022).content)
	...
	Play420152023 = function(arg_94_0, arg_94_1)
		...
		function arg_94_1.onSingleLineUpdate_(arg_97_0)
			...
			if 0 < arg_94_1.time_ and arg_94_1.time_ <= 0 + arg_97_0 then
				...
				local var_97_1 = arg_94_1:FormatText(arg_94_1:GetWordFromCfg(420152023).content)
	...
	Play420152024 = function(arg_98_0, arg_98_1)
		...
		function arg_98_1.onSingleLineUpdate_(arg_101_0)
			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 then
				arg_98_1.var_.moveOldPos1085ui_story = arg_98_1.actors_["1085ui_story"].transform.localPosition
			end

			local var_101_0 = 0.001

			if 0 <= arg_98_1.time_ and arg_98_1.time_ < 0 + var_101_0 then
				arg_98_1.actors_["1085ui_story"].transform.localPosition = Vector3.Lerp(arg_98_1.var_.moveOldPos1085ui_story, Vector3.New(0, -1.01, -5.83), (arg_98_1.time_ - 0) / var_101_0)
				arg_98_1.actors_["1085ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_98_1.actors_["1085ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["1085ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["1085ui_story"].transform.position).z)
				arg_98_1.actors_["1085ui_story"].transform.localEulerAngles.z = 0
				arg_98_1.actors_["1085ui_story"].transform.localEulerAngles.x = 0
				arg_98_1.actors_["1085ui_story"].transform.localEulerAngles = arg_98_1.actors_["1085ui_story"].transform.localEulerAngles
			end

			if arg_98_1.time_ >= 0 + var_101_0 and arg_98_1.time_ < 0 + var_101_0 + arg_101_0 then
				arg_98_1.actors_["1085ui_story"].transform.localPosition = Vector3.New(0, -1.01, -5.83)
				arg_98_1.actors_["1085ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_98_1.actors_["1085ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["1085ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["1085ui_story"].transform.position).z)
				arg_98_1.actors_["1085ui_story"].transform.localEulerAngles.z = 0
				arg_98_1.actors_["1085ui_story"].transform.localEulerAngles.x = 0
				arg_98_1.actors_["1085ui_story"].transform.localEulerAngles = arg_98_1.actors_["1085ui_story"].transform.localEulerAngles
			...
			local var_101_1 = arg_98_1.actors_["1085ui_story"]

			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 and not isNil(var_101_1) and arg_98_1.var_.characterEffect1085ui_story == nil then
				arg_98_1.var_.characterEffect1085ui_story = var_101_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_101_2 = 0.200000002980232

			if 0 <= arg_98_1.time_ and arg_98_1.time_ < 0 + var_101_2 and not isNil(var_101_1) then
				if arg_98_1.var_.characterEffect1085ui_story and not isNil(var_101_1) then
					arg_98_1.var_.characterEffect1085ui_story.fillFlat = false
				end
			end

			if arg_98_1.time_ >= 0 + var_101_2 and arg_98_1.time_ < 0 + var_101_2 + arg_101_0 and not isNil(var_101_1) and arg_98_1.var_.characterEffect1085ui_story then
				arg_98_1.var_.characterEffect1085ui_story.fillFlat = false
			end
			...
			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 then
				...
				local var_101_6 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_98_1.bgmTxt_.text ~= var_101_6 and arg_98_1.bgmTxt_.text ~= "" then
						if arg_98_1.bgmTxt2_.text ~= "" then
							arg_98_1.bgmTxt_.text = arg_98_1.bgmTxt2_.text
						end

						arg_98_1.bgmTxt2_.text = var_101_6

						arg_98_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_98_1.bgmTxt_.text = var_101_6
						arg_98_1.bgmTxt2_.text = var_101_6
					end
			...
			if 2 < arg_98_1.time_ and arg_98_1.time_ <= 2 + arg_101_0 then
				arg_98_1:AudioAction("play", "music", "bgm_activity_4_0_story_sad", "bgm_activity_4_0_story_sad", "bgm_activity_4_0_story_sad.awb")

				local var_101_9 = manager.audio:GetAudioName("bgm_activity_4_0_story_sad", "bgm_activity_4_0_story_sad")

				if "" ~= "" then
					if arg_98_1.bgmTxt_.text ~= var_101_9 and arg_98_1.bgmTxt_.text ~= "" then
						if arg_98_1.bgmTxt2_.text ~= "" then
							arg_98_1.bgmTxt_.text = arg_98_1.bgmTxt2_.text
						end

						arg_98_1.bgmTxt2_.text = var_101_9

						arg_98_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_98_1.bgmTxt_.text = var_101_9
						arg_98_1.bgmTxt2_.text = var_101_9
					end
			...
			if 0 < arg_98_1.time_ and arg_98_1.time_ <= var_101_10 + arg_101_0 then
				...
				local var_101_12 = arg_98_1:GetWordFromCfg(420152024)
				...
				local var_101_15 = 9 <= 0 and var_101_11 or var_101_11 * (utf8.len(var_101_13) / 9)

				if (9 <= 0 and var_101_11 or var_101_11 * (utf8.len(var_101_13) / 9)) > 0 and var_101_11 < var_101_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152024", "story_v_out_420152.awb") ~= 0 then
					local var_101_16 = manager.audio:GetVoiceLength("story_v_out_420152", "420152024", "story_v_out_420152.awb") / 1000
					...
					if var_101_12.prefab_name ~= "" and arg_98_1.actors_[var_101_12.prefab_name] ~= nil then
						local var_101_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_98_1.actors_[var_101_12.prefab_name].transform, "story_v_out_420152", "420152024", "story_v_out_420152.awb")

						arg_98_1:RecordAudio("420152024", var_101_17)
						arg_98_1:RecordAudio("420152024", var_101_17)
					else
		...
		function arg_104_1.onSingleLineUpdate_(arg_107_0)
			...
			if 0 <= arg_104_1.time_ and arg_104_1.time_ < 0 + var_107_0 and not isNil(arg_104_1.actors_["1085ui_story"]) then
				if arg_104_1.var_.characterEffect1085ui_story and not isNil(arg_104_1.actors_["1085ui_story"]) then
					...
					arg_104_1.var_.characterEffect1085ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_104_1.time_ - 0) / var_107_0)
				end
			end
			...
			if arg_104_1.time_ >= 0 + var_107_0 and arg_104_1.time_ < 0 + var_107_0 + arg_107_0 and not isNil(arg_104_1.actors_["1085ui_story"]) and arg_104_1.var_.characterEffect1085ui_story then
				arg_104_1.var_.characterEffect1085ui_story.fillFlat = true
				arg_104_1.var_.characterEffect1085ui_story.fillRatio = 0.5
			end

			local var_107_1 = 0
			local var_107_2 = 0.15
			...
			if 0 < arg_104_1.time_ and arg_104_1.time_ <= var_107_1 + arg_107_0 then
				...
				local var_107_3 = arg_104_1:FormatText(arg_104_1:GetWordFromCfg(420152025).content)

				arg_104_1.text_.text = var_107_3

				LuaForUtil.ClearLinePrefixSymbol(arg_104_1.text_)

				local var_107_5 = 6 <= 0 and var_107_2 or var_107_2 * (utf8.len(var_107_3) / 6)

				if (6 <= 0 and var_107_2 or var_107_2 * (utf8.len(var_107_3) / 6)) > 0 and var_107_2 < var_107_5 then
	...
	Play420152026 = function(arg_108_0, arg_108_1)
		...
		function arg_108_1.onSingleLineUpdate_(arg_111_0)
			...
			if 0 < arg_108_1.time_ and arg_108_1.time_ <= var_111_2 + arg_111_0 then
				...
				local var_111_4 = arg_108_1:GetWordFromCfg(420152026)
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152026", "story_v_out_420152.awb") ~= 0 then
					local var_111_8 = manager.audio:GetVoiceLength("story_v_out_420152", "420152026", "story_v_out_420152.awb") / 1000
					...
					if var_111_4.prefab_name ~= "" and arg_108_1.actors_[var_111_4.prefab_name] ~= nil then
						local var_111_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_108_1.actors_[var_111_4.prefab_name].transform, "story_v_out_420152", "420152026", "story_v_out_420152.awb")

						arg_108_1:RecordAudio("420152026", var_111_9)
						arg_108_1:RecordAudio("420152026", var_111_9)
					else
	...
	Play420152027 = function(arg_112_0, arg_112_1)
		...
		function arg_112_1.onSingleLineUpdate_(arg_115_0)
			...
			if 0 < arg_112_1.time_ and arg_112_1.time_ <= 0 + arg_115_0 then
				...
				local var_115_1 = arg_112_1:GetWordFromCfg(420152027)
				...
				local var_115_4 = 32 <= 0 and var_115_0 or var_115_0 * (utf8.len(var_115_2) / 32)

				if (32 <= 0 and var_115_0 or var_115_0 * (utf8.len(var_115_2) / 32)) > 0 and var_115_0 < var_115_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152027", "story_v_out_420152.awb") ~= 0 then
					local var_115_5 = manager.audio:GetVoiceLength("story_v_out_420152", "420152027", "story_v_out_420152.awb") / 1000
					...
					if var_115_1.prefab_name ~= "" and arg_112_1.actors_[var_115_1.prefab_name] ~= nil then
						local var_115_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_112_1.actors_[var_115_1.prefab_name].transform, "story_v_out_420152", "420152027", "story_v_out_420152.awb")

						arg_112_1:RecordAudio("420152027", var_115_6)
						arg_112_1:RecordAudio("420152027", var_115_6)
					else
	...
	Play420152028 = function(arg_116_0, arg_116_1)
		...
		function arg_116_1.onSingleLineUpdate_(arg_119_0)
			if 0 < arg_116_1.time_ and arg_116_1.time_ <= 0 + arg_119_0 and not isNil(arg_116_1.actors_["1085ui_story"]) and arg_116_1.var_.characterEffect1085ui_story == nil then
				arg_116_1.var_.characterEffect1085ui_story = arg_116_1.actors_["1085ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_119_0 = 0.200000002980232

			if 0 <= arg_116_1.time_ and arg_116_1.time_ < 0 + var_119_0 and not isNil(arg_116_1.actors_["1085ui_story"]) then
				if arg_116_1.var_.characterEffect1085ui_story and not isNil(arg_116_1.actors_["1085ui_story"]) then
					arg_116_1.var_.characterEffect1085ui_story.fillFlat = true
					arg_116_1.var_.characterEffect1085ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_116_1.time_ - 0) / var_119_0)
				end
			end

			if arg_116_1.time_ >= 0 + var_119_0 and arg_116_1.time_ < 0 + var_119_0 + arg_119_0 and not isNil(arg_116_1.actors_["1085ui_story"]) and arg_116_1.var_.characterEffect1085ui_story then
				arg_116_1.var_.characterEffect1085ui_story.fillFlat = true
			...
			if 0 < arg_116_1.time_ and arg_116_1.time_ <= var_119_1 + arg_119_0 then
				...
				local var_119_3 = arg_116_1:FormatText(arg_116_1:GetWordFromCfg(420152028).content)

				arg_116_1.text_.text = var_119_3

				LuaForUtil.ClearLinePrefixSymbol(arg_116_1.text_)

				local var_119_5 = 16 <= 0 and var_119_2 or var_119_2 * (utf8.len(var_119_3) / 16)

				if (16 <= 0 and var_119_2 or var_119_2 * (utf8.len(var_119_3) / 16)) > 0 and var_119_2 < var_119_5 then
	...
	Play420152029 = function(arg_120_0, arg_120_1)
		...
		function arg_120_1.onSingleLineUpdate_(arg_123_0)
			...
			if 0 < arg_120_1.time_ and arg_120_1.time_ <= var_123_2 + arg_123_0 then
				...
				local var_123_4 = arg_120_1:GetWordFromCfg(420152029)
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152029", "story_v_out_420152.awb") ~= 0 then
					local var_123_8 = manager.audio:GetVoiceLength("story_v_out_420152", "420152029", "story_v_out_420152.awb") / 1000
					...
					if var_123_4.prefab_name ~= "" and arg_120_1.actors_[var_123_4.prefab_name] ~= nil then
						local var_123_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_120_1.actors_[var_123_4.prefab_name].transform, "story_v_out_420152", "420152029", "story_v_out_420152.awb")

						arg_120_1:RecordAudio("420152029", var_123_9)
						arg_120_1:RecordAudio("420152029", var_123_9)
					else
	...
	Play420152030 = function(arg_124_0, arg_124_1)
		...
		function arg_124_1.onSingleLineUpdate_(arg_127_0)
			...
			if 0 < arg_124_1.time_ and arg_124_1.time_ <= var_127_0 + arg_127_0 then
				...
				local var_127_2 = arg_124_1:GetWordFromCfg(420152030)
				...
				local var_127_5 = 31 <= 0 and var_127_1 or var_127_1 * (utf8.len(var_127_3) / 31)

				if (31 <= 0 and var_127_1 or var_127_1 * (utf8.len(var_127_3) / 31)) > 0 and var_127_1 < var_127_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152030", "story_v_out_420152.awb") ~= 0 then
					local var_127_6 = manager.audio:GetVoiceLength("story_v_out_420152", "420152030", "story_v_out_420152.awb") / 1000
					...
					if var_127_2.prefab_name ~= "" and arg_124_1.actors_[var_127_2.prefab_name] ~= nil then
						local var_127_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_124_1.actors_[var_127_2.prefab_name].transform, "story_v_out_420152", "420152030", "story_v_out_420152.awb")

						arg_124_1:RecordAudio("420152030", var_127_7)
						arg_124_1:RecordAudio("420152030", var_127_7)
					else
	...
	Play420152031 = function(arg_128_0, arg_128_1)
		...
		function arg_128_1.onSingleLineUpdate_(arg_131_0)
			...
			if 0 < arg_128_1.time_ and arg_128_1.time_ <= var_131_0 + arg_131_0 then
				...
				local var_131_2 = arg_128_1:GetWordFromCfg(420152031)
				...
				local var_131_5 = 44 <= 0 and var_131_1 or var_131_1 * (utf8.len(var_131_3) / 44)

				if (44 <= 0 and var_131_1 or var_131_1 * (utf8.len(var_131_3) / 44)) > 0 and var_131_1 < var_131_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152031", "story_v_out_420152.awb") ~= 0 then
					local var_131_6 = manager.audio:GetVoiceLength("story_v_out_420152", "420152031", "story_v_out_420152.awb") / 1000
					...
					if var_131_2.prefab_name ~= "" and arg_128_1.actors_[var_131_2.prefab_name] ~= nil then
						local var_131_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_128_1.actors_[var_131_2.prefab_name].transform, "story_v_out_420152", "420152031", "story_v_out_420152.awb")

						arg_128_1:RecordAudio("420152031", var_131_7)
						arg_128_1:RecordAudio("420152031", var_131_7)
					else
	...
	Play420152032 = function(arg_132_0, arg_132_1)
		...
		function arg_132_1.onSingleLineUpdate_(arg_135_0)
			...
			if 0 < arg_132_1.time_ and arg_132_1.time_ <= 0 + arg_135_0 then
				...
				local var_135_1 = arg_132_1:GetWordFromCfg(420152032)
				...
				local var_135_4 = 43 <= 0 and var_135_0 or var_135_0 * (utf8.len(var_135_2) / 43)

				if (43 <= 0 and var_135_0 or var_135_0 * (utf8.len(var_135_2) / 43)) > 0 and var_135_0 < var_135_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152032", "story_v_out_420152.awb") ~= 0 then
					local var_135_5 = manager.audio:GetVoiceLength("story_v_out_420152", "420152032", "story_v_out_420152.awb") / 1000
					...
					if var_135_1.prefab_name ~= "" and arg_132_1.actors_[var_135_1.prefab_name] ~= nil then
						local var_135_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_132_1.actors_[var_135_1.prefab_name].transform, "story_v_out_420152", "420152032", "story_v_out_420152.awb")

						arg_132_1:RecordAudio("420152032", var_135_6)
						arg_132_1:RecordAudio("420152032", var_135_6)
					else
	...
	Play420152033 = function(arg_136_0, arg_136_1)
		...
		function arg_136_1.onSingleLineUpdate_(arg_139_0)
			...
			if arg_136_1.time_ >= var_139_0 + 1 and arg_136_1.time_ < var_139_0 + 1 + arg_139_0 then
				arg_136_1.allBtn_.enabled = true
			end

			local var_139_1 = 0
			local var_139_2 = 0.45
			...
			if 0 < arg_136_1.time_ and arg_136_1.time_ <= var_139_1 + arg_139_0 then
				...
				local var_139_3 = arg_136_1:GetWordFromCfg(420152033)
				...
				local var_139_6 = 18 <= 0 and var_139_2 or var_139_2 * (utf8.len(var_139_4) / 18)

				if (18 <= 0 and var_139_2 or var_139_2 * (utf8.len(var_139_4) / 18)) > 0 and var_139_2 < var_139_6 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152033", "story_v_out_420152.awb") ~= 0 then
					local var_139_7 = manager.audio:GetVoiceLength("story_v_out_420152", "420152033", "story_v_out_420152.awb") / 1000
					...
					if var_139_3.prefab_name ~= "" and arg_136_1.actors_[var_139_3.prefab_name] ~= nil then
						local var_139_8 = LuaForUtil.PlayVoiceWithCriLipsync(arg_136_1.actors_[var_139_3.prefab_name].transform, "story_v_out_420152", "420152033", "story_v_out_420152.awb")

						arg_136_1:RecordAudio("420152033", var_139_8)
						arg_136_1:RecordAudio("420152033", var_139_8)
					else
	...
	Play420152034 = function(arg_140_0, arg_140_1)
		...
		function arg_140_1.onSingleLineUpdate_(arg_143_0)
			...
			if 0 < arg_140_1.time_ and arg_140_1.time_ <= var_143_1 + arg_143_0 then
				...
				local var_143_3 = arg_140_1:FormatText(arg_140_1:GetWordFromCfg(420152034).content)

				arg_140_1.text_.text = var_143_3

				LuaForUtil.ClearLinePrefixSymbol(arg_140_1.text_)

				local var_143_5 = 36 <= 0 and var_143_2 or var_143_2 * (utf8.len(var_143_3) / 36)

				if (36 <= 0 and var_143_2 or var_143_2 * (utf8.len(var_143_3) / 36)) > 0 and var_143_2 < var_143_5 then
	...
	Play420152035 = function(arg_144_0, arg_144_1)
		...
		function arg_144_1.onSingleLineUpdate_(arg_147_0)
			...
			if 0 < arg_144_1.time_ and arg_144_1.time_ <= 0 + arg_147_0 then
				...
				local var_147_1 = arg_144_1:FormatText(arg_144_1:GetWordFromCfg(420152035).content)
	...
	Play420152036 = function(arg_148_0, arg_148_1)
		...
		function arg_148_1.onSingleLineUpdate_(arg_151_0)
			if arg_148_1.actors_["1085ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1085ui_story"))) then
				local var_151_0 = Object.Instantiate(Asset.Load("Char/" .. "1085ui_story"), arg_148_1.stage_.transform)

				var_151_0.name = "1085ui_story"
				var_151_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_148_1.actors_["1085ui_story"] = var_151_0
				...
				arg_148_1.var_["1085ui_story" .. "Animator"] = var_151_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_148_1.var_["1085ui_story" .. "Animator"].applyRootMotion = true
				arg_148_1.var_["1085ui_story" .. "LipSync"] = var_151_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_151_3 = arg_148_1.actors_["1085ui_story"].transform

			if 0 < arg_148_1.time_ and arg_148_1.time_ <= 0 + arg_151_0 then
				arg_148_1.var_.moveOldPos1085ui_story = var_151_3.localPosition
			end

			local var_151_4 = 0.001

			if 0 <= arg_148_1.time_ and arg_148_1.time_ < 0 + var_151_4 then
				var_151_3.localPosition = Vector3.Lerp(arg_148_1.var_.moveOldPos1085ui_story, Vector3.New(0, -1.01, -5.83), (arg_148_1.time_ - 0) / var_151_4)
			...
			if arg_148_1.time_ >= 0 + var_151_4 and arg_148_1.time_ < 0 + var_151_4 + arg_151_0 then
				var_151_3.localPosition = Vector3.New(0, -1.01, -5.83)
				var_151_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_151_3.position).x, (manager.ui.mainCamera.transform.position - var_151_3.position).y, (manager.ui.mainCamera.transform.position - var_151_3.position).z)
				var_151_3.localEulerAngles.z = 0
				var_151_3.localEulerAngles.x = 0
				var_151_3.localEulerAngles = var_151_3.localEulerAngles
			...
			local var_151_5 = arg_148_1.actors_["1085ui_story"]

			if 0 < arg_148_1.time_ and arg_148_1.time_ <= 0 + arg_151_0 and not isNil(var_151_5) and arg_148_1.var_.characterEffect1085ui_story == nil then
				arg_148_1.var_.characterEffect1085ui_story = var_151_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_151_6 = 0.200000002980232

			if 0 <= arg_148_1.time_ and arg_148_1.time_ < 0 + var_151_6 and not isNil(var_151_5) then
				if arg_148_1.var_.characterEffect1085ui_story and not isNil(var_151_5) then
					arg_148_1.var_.characterEffect1085ui_story.fillFlat = false
				end
			end

			if arg_148_1.time_ >= 0 + var_151_6 and arg_148_1.time_ < 0 + var_151_6 + arg_151_0 and not isNil(var_151_5) and arg_148_1.var_.characterEffect1085ui_story then
				arg_148_1.var_.characterEffect1085ui_story.fillFlat = false
			end
			...
			if 0 < arg_148_1.time_ and arg_148_1.time_ <= var_151_8 + arg_151_0 then
				...
				local var_151_10 = arg_148_1:GetWordFromCfg(420152036)
				...
				local var_151_13 = 18 <= 0 and var_151_9 or var_151_9 * (utf8.len(var_151_11) / 18)

				if (18 <= 0 and var_151_9 or var_151_9 * (utf8.len(var_151_11) / 18)) > 0 and var_151_9 < var_151_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152036", "story_v_out_420152.awb") ~= 0 then
					local var_151_14 = manager.audio:GetVoiceLength("story_v_out_420152", "420152036", "story_v_out_420152.awb") / 1000
					...
					if var_151_10.prefab_name ~= "" and arg_148_1.actors_[var_151_10.prefab_name] ~= nil then
						local var_151_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_148_1.actors_[var_151_10.prefab_name].transform, "story_v_out_420152", "420152036", "story_v_out_420152.awb")

						arg_148_1:RecordAudio("420152036", var_151_15)
						arg_148_1:RecordAudio("420152036", var_151_15)
					else
	...
	Play420152037 = function(arg_152_0, arg_152_1)
		...
		function arg_152_1.onSingleLineUpdate_(arg_155_0)
			if arg_152_1.bgs_.L03g == nil then
				local var_155_0 = Object.Instantiate(arg_152_1.paintGo_)

				var_155_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "L03g")
				var_155_0.name = "L03g"
				var_155_0.transform.parent = arg_152_1.stage_.transform
				var_155_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_152_1.bgs_.L03g = var_155_0
			end

			if 2 < arg_152_1.time_ and arg_152_1.time_ <= 2 + arg_155_0 then
				local var_155_1 = arg_152_1.bgs_.L03g

				arg_152_1.bgs_.L03g.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 4 < arg_152_1.time_ and arg_152_1.time_ <= var_155_4 + arg_155_0 then
				arg_152_1.allBtn_.enabled = false
			end

			if arg_152_1.time_ >= var_155_4 + 0.366666666666666 and arg_152_1.time_ < var_155_4 + 0.366666666666666 + arg_155_0 then
			...
			if 2 < arg_152_1.time_ and arg_152_1.time_ <= var_155_9 + arg_155_0 then
				arg_152_1.mask_.enabled = true
				arg_152_1.mask_.raycastTarget = true
			...
			local var_155_13 = arg_152_1.actors_["1085ui_story"].transform

			if 1.96666666666667 < arg_152_1.time_ and arg_152_1.time_ <= 1.96666666666667 + arg_155_0 then
				arg_152_1.var_.moveOldPos1085ui_story = var_155_13.localPosition
			end

			local var_155_14 = 0.001

			if 1.96666666666667 <= arg_152_1.time_ and arg_152_1.time_ < 1.96666666666667 + var_155_14 then
				var_155_13.localPosition = Vector3.Lerp(arg_152_1.var_.moveOldPos1085ui_story, Vector3.New(0, 100, 0), (arg_152_1.time_ - 1.96666666666667) / var_155_14)
				var_155_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_155_13.position).x, (manager.ui.mainCamera.transform.position - var_155_13.position).y, (manager.ui.mainCamera.transform.position - var_155_13.position).z)
				var_155_13.localEulerAngles.z = 0
				var_155_13.localEulerAngles.x = 0
				var_155_13.localEulerAngles = var_155_13.localEulerAngles
			end

			if arg_152_1.time_ >= 1.96666666666667 + var_155_14 and arg_152_1.time_ < 1.96666666666667 + var_155_14 + arg_155_0 then
			...
			if 0.05 < arg_152_1.time_ and arg_152_1.time_ <= 0.05 + arg_155_0 then
				arg_152_1:AudioAction("stop", "effect", "se_story_140", "se_story_140_amb_lab", "")
			end
			...
			local var_155_16 = 4
			local var_155_17 = 0.875

			if 4 < arg_152_1.time_ and arg_152_1.time_ <= var_155_16 + arg_155_0 then
				...
				local var_155_18 = LeanTween.value(arg_152_1.dialog_, 0, 1, 0.3)

				var_155_18:setOnUpdate(LuaHelper.FloatAction(function(arg_156_0)
					arg_152_1.dialogCg_.alpha = arg_156_0
				end))
				var_155_18:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_152_1.dialog_)
					var_155_18:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_155_19 = arg_152_1:FormatText(arg_152_1:GetWordFromCfg(420152037).content)

				arg_152_1.text_.text = var_155_19

				LuaForUtil.ClearLinePrefixSymbol(arg_152_1.text_)

				local var_155_21 = 35 <= 0 and var_155_17 or var_155_17 * (utf8.len(var_155_19) / 35)

				if (35 <= 0 and var_155_17 or var_155_17 * (utf8.len(var_155_19) / 35)) > 0 and var_155_17 < var_155_21 then
					arg_152_1.talkMaxDuration = var_155_21
					var_155_16 = var_155_16 + 0.3
			...
			local var_155_22 = var_155_16 + 0.3
			local var_155_23 = math.max(var_155_17, arg_152_1.talkMaxDuration)

			if var_155_16 + 0.3 <= arg_152_1.time_ and arg_152_1.time_ < var_155_22 + var_155_23 then
	...
	Play420152038 = function(arg_158_0, arg_158_1)
		...
		function arg_158_1.onSingleLineUpdate_(arg_161_0)
			...
			if 0 < arg_158_1.time_ and arg_158_1.time_ <= 0 + arg_161_0 then
				...
				local var_161_1 = arg_158_1:FormatText(arg_158_1:GetWordFromCfg(420152038).content)

				arg_158_1.text_.text = var_161_1

				LuaForUtil.ClearLinePrefixSymbol(arg_158_1.text_)

				local var_161_3 = 50 <= 0 and var_161_0 or var_161_0 * (utf8.len(var_161_1) / 50)

				if (50 <= 0 and var_161_0 or var_161_0 * (utf8.len(var_161_1) / 50)) > 0 and var_161_0 < var_161_3 then
	...
	Play420152039 = function(arg_162_0, arg_162_1)
		...
		function arg_162_1.onSingleLineUpdate_(arg_165_0)
			...
			if 0 < arg_162_1.time_ and arg_162_1.time_ <= 0 + arg_165_0 then
				...
				local var_165_1 = arg_162_1:FormatText(arg_162_1:GetWordFromCfg(420152039).content)
	...
	Play420152040 = function(arg_166_0, arg_166_1)
		...
		function arg_166_1.onSingleLineUpdate_(arg_169_0)
			...
			if 0 <= arg_166_1.time_ and arg_166_1.time_ < 0 + var_169_0 then
				arg_166_1.actors_["1061ui_story"].transform.localPosition = Vector3.Lerp(arg_166_1.var_.moveOldPos1061ui_story, Vector3.New(0, -1.18, -6.15), (arg_166_1.time_ - 0) / var_169_0)
			...
			if arg_166_1.time_ >= 0 + var_169_0 and arg_166_1.time_ < 0 + var_169_0 + arg_169_0 then
				arg_166_1.actors_["1061ui_story"].transform.localPosition = Vector3.New(0, -1.18, -6.15)
				arg_166_1.actors_["1061ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_166_1.actors_["1061ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_166_1.actors_["1061ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_166_1.actors_["1061ui_story"].transform.position).z)
				arg_166_1.actors_["1061ui_story"].transform.localEulerAngles.z = 0
				arg_166_1.actors_["1061ui_story"].transform.localEulerAngles.x = 0
				arg_166_1.actors_["1061ui_story"].transform.localEulerAngles = arg_166_1.actors_["1061ui_story"].transform.localEulerAngles
			...
			local var_169_1 = arg_166_1.actors_["1061ui_story"]

			if 0 < arg_166_1.time_ and arg_166_1.time_ <= 0 + arg_169_0 and not isNil(var_169_1) and arg_166_1.var_.characterEffect1061ui_story == nil then
				arg_166_1.var_.characterEffect1061ui_story = var_169_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_169_2 = 0.200000002980232

			if 0 <= arg_166_1.time_ and arg_166_1.time_ < 0 + var_169_2 and not isNil(var_169_1) then
				if arg_166_1.var_.characterEffect1061ui_story and not isNil(var_169_1) then
					arg_166_1.var_.characterEffect1061ui_story.fillFlat = false
				end
			end

			if arg_166_1.time_ >= 0 + var_169_2 and arg_166_1.time_ < 0 + var_169_2 + arg_169_0 and not isNil(var_169_1) and arg_166_1.var_.characterEffect1061ui_story then
				arg_166_1.var_.characterEffect1061ui_story.fillFlat = false
			end
			...
			if 0 < arg_166_1.time_ and arg_166_1.time_ <= var_169_4 + arg_169_0 then
				...
				local var_169_6 = arg_166_1:GetWordFromCfg(420152040)
				...
				if manager.audio:GetVoiceLength("story_v_out_420152", "420152040", "story_v_out_420152.awb") ~= 0 then
					local var_169_10 = manager.audio:GetVoiceLength("story_v_out_420152", "420152040", "story_v_out_420152.awb") / 1000
					...
					if var_169_6.prefab_name ~= "" and arg_166_1.actors_[var_169_6.prefab_name] ~= nil then
						local var_169_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_166_1.actors_[var_169_6.prefab_name].transform, "story_v_out_420152", "420152040", "story_v_out_420152.awb")

						arg_166_1:RecordAudio("420152040", var_169_11)
						arg_166_1:RecordAudio("420152040", var_169_11)
					else
