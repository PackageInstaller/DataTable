return {
	Play61401001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 61401001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.333333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 0.333333333333333 + var_4_3 then
				var_4_2.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2530006, Vector3.New(0, -50, -235), (arg_1_1.time_ - 0.333333333333333) / var_4_3)
			end

			if arg_1_1.time_ >= 0.333333333333333 + var_4_3 and arg_1_1.time_ < 0.333333333333333 + var_4_3 + arg_4_0 then
				var_4_2.localPosition = Vector3.New(0, -50, -235)
			end

			local var_4_4 = arg_1_1.actors_["2530006"]
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 0.333333333333333 + arg_4_0 and not isNil(var_4_4) then
				...
				if var_4_5 then
					arg_1_1.var_.highlightMatValue2530006 = var_4_5
				end
			end
			...
			if 0.333333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 0.333333333333333 + var_4_6 and not isNil(var_4_4) then
				if arg_1_1.var_.highlightMatValue2530006 then
					...
					arg_1_1.var_.highlightMatValue2530006.color.r = var_4_7
					arg_1_1.var_.highlightMatValue2530006.color.g = var_4_7
					arg_1_1.var_.highlightMatValue2530006.color.b = var_4_7
					arg_1_1.var_.highlightMatValue2530006.color = arg_1_1.var_.highlightMatValue2530006.color
				end
			end

			if arg_1_1.time_ >= 0.333333333333333 + var_4_6 and arg_1_1.time_ < 0.333333333333333 + var_4_6 + arg_4_0 and not isNil(var_4_4) and arg_1_1.var_.highlightMatValue2530006 then
				var_4_4.transform:SetSiblingIndex(1)

				arg_1_1.var_.highlightMatValue2530006.color.r = 1
				arg_1_1.var_.highlightMatValue2530006.color.g = 1
				arg_1_1.var_.highlightMatValue2530006.color.b = 1
				arg_1_1.var_.highlightMatValue2530006.color = arg_1_1.var_.highlightMatValue2530006.color
			end
			...
			if 0.333333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[166].name)
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(61401001).content)
