	...
	Play60405001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				...
				local var_4_6 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60405001).content)

				arg_1_1.text_.text = var_4_6

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_8 = 13 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_6) / 13)

				if (13 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_6) / 13)) > 0 and var_4_5 < var_4_8 then
