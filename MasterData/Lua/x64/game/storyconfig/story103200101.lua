	...
	Play320011121 = function(arg_499_0, arg_499_1)
		...
		function arg_499_1.onSingleLineUpdate_(arg_502_0)
			...
			if 2 < arg_499_1.time_ and arg_499_1.time_ <= 2 + arg_502_0 then
				...
				for iter_502_2, iter_502_3 in ipairs((var_502_16.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_502_3.transform.localScale = Vector3.New(iter_502_3.transform.localScale.x / var_502_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_502_3.transform.localScale.y / var_502_18, iter_502_3.transform.localScale.z)
				end
			end
			...
			local var_502_21 = 3.999999999999
			local var_502_22 = 0.35

			if 3.999999999999 < arg_499_1.time_ and arg_499_1.time_ <= var_502_21 + arg_502_0 then
				...
				local var_502_23 = LeanTween.value(arg_499_1.dialog_, 0, 1, 0.3)

				var_502_23:setOnUpdate(LuaHelper.FloatAction(function(arg_503_0)
					arg_499_1.dialogCg_.alpha = arg_503_0
				end))
				var_502_23:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_499_1.dialog_)
					var_502_23:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_502_24 = arg_499_1:GetWordFromCfg(320011121)
				...
				local var_502_27 = 14 <= 0 and var_502_22 or var_502_22 * (utf8.len(var_502_25) / 14)

				if (14 <= 0 and var_502_22 or var_502_22 * (utf8.len(var_502_25) / 14)) > 0 and var_502_22 < var_502_27 then
					arg_499_1.talkMaxDuration = var_502_27
					var_502_21 = var_502_21 + 0.3

					if var_502_27 + var_502_21 > arg_499_1.duration_ then
						arg_499_1.duration_ = var_502_27 + var_502_21
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_320011", "320011121", "story_v_out_320011.awb") ~= 0 then
					local var_502_28 = manager.audio:GetVoiceLength("story_v_out_320011", "320011121", "story_v_out_320011.awb") / 1000
					...
					if var_502_24.prefab_name ~= "" and arg_499_1.actors_[var_502_24.prefab_name] ~= nil then
						local var_502_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_499_1.actors_[var_502_24.prefab_name].transform, "story_v_out_320011", "320011121", "story_v_out_320011.awb")

						arg_499_1:RecordAudio("320011121", var_502_29)
						arg_499_1:RecordAudio("320011121", var_502_29)
					else
			...
			local var_502_30 = var_502_21 + 0.3
			local var_502_31 = math.max(var_502_22, arg_499_1.talkMaxDuration)

			if var_502_21 + 0.3 <= arg_499_1.time_ and arg_499_1.time_ < var_502_30 + var_502_31 then
				arg_499_1.typewritter.percent = (arg_499_1.time_ - var_502_30) / var_502_31

				arg_499_1.typewritter:SetDirty()
			end

			if arg_499_1.time_ >= var_502_30 + var_502_31 and arg_499_1.time_ < var_502_30 + var_502_31 + arg_502_0 then
	...
	Play320011138 = function(arg_574_0, arg_574_1)
		...
		function arg_574_1.onSingleLineUpdate_(arg_577_0)
			...
			if 0.366666666666667 < arg_574_1.time_ and arg_574_1.time_ <= 0.366666666666667 + arg_577_0 then
				...
				for iter_577_0, iter_577_1 in ipairs((var_577_6.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_577_1.transform.localScale = Vector3.New(iter_577_1.transform.localScale.x / var_577_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_577_1.transform.localScale.y / var_577_8, iter_577_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_574_1.time_ and arg_574_1.time_ <= 0 + arg_577_0 then
				...
				local var_577_12 = manager.audio:GetAudioName("se_story", "se_story_explosion")

				if "" ~= "" then
					if arg_574_1.bgmTxt_.text ~= var_577_12 and arg_574_1.bgmTxt_.text ~= "" then
						if arg_574_1.bgmTxt2_.text ~= "" then
							arg_574_1.bgmTxt_.text = arg_574_1.bgmTxt2_.text
						end

						arg_574_1.bgmTxt2_.text = var_577_12

						arg_574_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_574_1.bgmTxt_.text = var_577_12
						arg_574_1.bgmTxt2_.text = var_577_12
					end
			...
			local var_577_13 = 0
			local var_577_14 = 1.075

			if 0 < arg_574_1.time_ and arg_574_1.time_ <= var_577_13 + arg_577_0 then
				...
				local var_577_15 = arg_574_1:FormatText(arg_574_1:GetWordFromCfg(320011138).content)

				arg_574_1.text_.text = var_577_15

				LuaForUtil.ClearLinePrefixSymbol(arg_574_1.text_)

				local var_577_17 = 43 <= 0 and var_577_14 or var_577_14 * (utf8.len(var_577_15) / 43)

				if (43 <= 0 and var_577_14 or var_577_14 * (utf8.len(var_577_15) / 43)) > 0 and var_577_14 < var_577_17 then
					arg_574_1.talkMaxDuration = var_577_17

					if var_577_17 + var_577_13 > arg_574_1.duration_ then
						arg_574_1.duration_ = var_577_17 + var_577_13
					end
				end
			...
			local var_577_18 = math.max(var_577_14, arg_574_1.talkMaxDuration)

			if var_577_13 <= arg_574_1.time_ and arg_574_1.time_ < var_577_13 + var_577_18 then
				arg_574_1.typewritter.percent = (arg_574_1.time_ - var_577_13) / var_577_18

				arg_574_1.typewritter:SetDirty()
			end

			if arg_574_1.time_ >= var_577_13 + var_577_18 and arg_574_1.time_ < var_577_13 + var_577_18 + arg_577_0 then
