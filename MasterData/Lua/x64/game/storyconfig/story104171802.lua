	...
	Play417182011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				for iter_48_0, iter_48_1 in ipairs((var_48_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_48_1.transform.localScale = Vector3.New(iter_48_1.transform.localScale.x / var_48_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_48_1.transform.localScale.y / var_48_2, iter_48_1.transform.localScale.z)
				end
			end
			...
			local var_48_5 = arg_45_1.bgs_.I17i.transform

			if 0.1 < arg_45_1.time_ and arg_45_1.time_ <= 0.1 + arg_48_0 then
				arg_45_1.var_.moveOldPosI17i = var_48_5.localPosition
			end

			local var_48_6 = 0.1

			if 0.1 <= arg_45_1.time_ and arg_45_1.time_ < 0.1 + var_48_6 then
				var_48_5.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPosI17i, Vector3.New(0, 1, 10), (arg_45_1.time_ - 0.1) / var_48_6)
			end

			if arg_45_1.time_ >= 0.1 + var_48_6 and arg_45_1.time_ < 0.1 + var_48_6 + arg_48_0 then
				var_48_5.localPosition = Vector3.New(0, 1, 10)
			end

			local var_48_7 = arg_45_1.bgs_.I17i.transform

			if 0.2 < arg_45_1.time_ and arg_45_1.time_ <= 0.2 + arg_48_0 then
				arg_45_1.var_.moveOldPosI17i = var_48_7.localPosition
			end

			local var_48_8 = 0.8

			if 0.2 <= arg_45_1.time_ and arg_45_1.time_ < 0.2 + var_48_8 then
				var_48_7.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPosI17i, Vector3.New(0, 1, 3), (arg_45_1.time_ - 0.2) / var_48_8)
			end

			if arg_45_1.time_ >= 0.2 + var_48_8 and arg_45_1.time_ < 0.2 + var_48_8 + arg_48_0 then
				var_48_7.localPosition = Vector3.New(0, 1, 3)
			end

			local var_48_9 = arg_45_1.bgs_.I17i.transform

			if 1 < arg_45_1.time_ and arg_45_1.time_ <= 1 + arg_48_0 then
				arg_45_1.var_.moveOldPosI17i = var_48_9.localPosition
			end

			local var_48_10 = 0.1

			if 1 <= arg_45_1.time_ and arg_45_1.time_ < 1 + var_48_10 then
				var_48_9.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPosI17i, Vector3.New(0, 1, 10), (arg_45_1.time_ - 1) / var_48_10)
			end

			if arg_45_1.time_ >= 1 + var_48_10 and arg_45_1.time_ < 1 + var_48_10 + arg_48_0 then
				var_48_9.localPosition = Vector3.New(0, 1, 10)
			end

			local var_48_11 = arg_45_1.bgs_.I17i.transform

			if 1.1 < arg_45_1.time_ and arg_45_1.time_ <= 1.1 + arg_48_0 then
				arg_45_1.var_.moveOldPosI17i = var_48_11.localPosition
			end

			local var_48_12 = 0.1

			if 1.1 <= arg_45_1.time_ and arg_45_1.time_ < 1.1 + var_48_12 then
				var_48_11.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPosI17i, Vector3.New(0, 1, 9.5), (arg_45_1.time_ - 1.1) / var_48_12)
			end

			if arg_45_1.time_ >= 1.1 + var_48_12 and arg_45_1.time_ < 1.1 + var_48_12 + arg_48_0 then
				var_48_11.localPosition = Vector3.New(0, 1, 9.5)
			end
			...
			local var_48_14 = 0.466666666666667

			if 0.9 <= arg_45_1.time_ and arg_45_1.time_ < 0.9 + var_48_14 then
				local var_48_15, var_48_16 = math.modf((arg_45_1.time_ - 0.9) / 0.099)

				var_48_13.localPosition = Vector3.New(var_48_16 * 0.13, var_48_16 * 0.13, var_48_16 * 0.13) + arg_45_1.var_.shakeOldPos
			end

			if arg_45_1.time_ >= 0.9 + var_48_14 and arg_45_1.time_ < 0.9 + var_48_14 + arg_48_0 then
			...
			if 1.8 < arg_45_1.time_ and arg_45_1.time_ <= var_48_18 + arg_48_0 then
				...
				local var_48_20 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(417182011).content)

				arg_45_1.text_.text = var_48_20

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_22 = 40 <= 0 and var_48_19 or var_48_19 * (utf8.len(var_48_20) / 40)

				if (40 <= 0 and var_48_19 or var_48_19 * (utf8.len(var_48_20) / 40)) > 0 and var_48_19 < var_48_22 then
					arg_45_1.talkMaxDuration = var_48_22

					if var_48_22 + var_48_18 > arg_45_1.duration_ then
						arg_45_1.duration_ = var_48_22 + var_48_18
					end
				end
			...
			local var_48_23 = math.max(var_48_19, arg_45_1.talkMaxDuration)

			if var_48_18 <= arg_45_1.time_ and arg_45_1.time_ < var_48_18 + var_48_23 then
				arg_45_1.typewritter.percent = (arg_45_1.time_ - var_48_18) / var_48_23

				arg_45_1.typewritter:SetDirty()
			end

			if arg_45_1.time_ >= var_48_18 + var_48_23 and arg_45_1.time_ < var_48_18 + var_48_23 + arg_48_0 then
