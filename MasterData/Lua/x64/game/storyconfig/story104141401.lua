return {
	Play414141001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 414141001
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.9 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414141001).content)

				arg_1_1.text_.text = var_4_12

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_14 = 4 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 4)

				if (4 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 4)) > 0 and var_4_10 < var_4_14 then
	...
	Play414141002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 414141002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				arg_7_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3102cva")
			end

			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				arg_7_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action1_1")
			end

			local var_10_8 = 0
			local var_10_9 = 0.225
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 then
				...
				local var_10_10 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(414141002).content)

				arg_7_1.text_.text = var_10_10

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_12 = 9 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 9)

				if (9 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 9)) > 0 and var_10_9 < var_10_12 then
	...
	Play414141003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 414141003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play414141004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_1 + arg_14_0 then
				...
				local var_14_3 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(414141003).content)
	...
	Play414141004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 414141004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play414141005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				arg_15_1.leftNameTxt_.text = arg_15_1:FormatText(StoryNameCfg[945].name)
				...
				arg_15_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_2121")
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(414141004).content)

				arg_15_1.text_.text = var_18_1

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_3 = 6 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 6)

				if (6 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 6)) > 0 and var_18_0 < var_18_3 then
	...
	Play414141005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 414141005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play414141006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_0 then
				arg_19_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_19_1.time_ - 0) / var_22_0)
			...
			if arg_19_1.time_ >= 0 + var_22_0 and arg_19_1.time_ < 0 + var_22_0 + arg_22_0 then
				arg_19_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, -1.2, -6)
				arg_19_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_19_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["104902ui_story"].transform.position).z)
				arg_19_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_19_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_19_1.actors_["104902ui_story"].transform.localEulerAngles = arg_19_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				arg_19_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3102cva")
			end
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_4 + arg_22_0 then
				...
				local var_22_6 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(414141005).content)

				arg_19_1.text_.text = var_22_6

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_8 = 19 <= 0 and var_22_5 or var_22_5 * (utf8.len(var_22_6) / 19)

				if (19 <= 0 and var_22_5 or var_22_5 * (utf8.len(var_22_6) / 19)) > 0 and var_22_5 < var_22_8 then
	...
	Play414141006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 414141006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play414141007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				...
				local var_26_3 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(414141006).content)

				arg_23_1.text_.text = var_26_3

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_5 = 12 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 12)

				if (12 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 12)) > 0 and var_26_2 < var_26_5 then
	...
	Play414141007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 414141007
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_0 and not isNil(arg_27_1.actors_["104902ui_story"]) then
				if arg_27_1.var_.characterEffect104902ui_story and not isNil(arg_27_1.actors_["104902ui_story"]) then
					arg_27_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				arg_27_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3102cva")
			end

			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				arg_27_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action5_2")
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_2 + arg_30_0 then
				...
				local var_30_4 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(414141007).content)

				arg_27_1.text_.text = var_30_4

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_6 = 6 <= 0 and var_30_3 or var_30_3 * (utf8.len(var_30_4) / 6)

				if (6 <= 0 and var_30_3 or var_30_3 * (utf8.len(var_30_4) / 6)) > 0 and var_30_3 < var_30_6 then
