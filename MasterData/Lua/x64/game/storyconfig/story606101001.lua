	...
	Play606101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_4 + arg_4_0 then
				...
				local var_4_6 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(606101001).content)

				arg_1_1.text_.text = var_4_6

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_8 = 14 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_6) / 14)

				if (14 <= 0 and var_4_5 or var_4_5 * (utf8.len(var_4_6) / 14)) > 0 and var_4_5 < var_4_8 then
	...
	Play606101002 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				...
				local var_8_1 = arg_5_1:FormatText(arg_5_1:GetWordFromCfg(606101002).content)

				arg_5_1.text_.text = var_8_1

				LuaForUtil.ClearLinePrefixSymbol(arg_5_1.text_)

				local var_8_3 = 21 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 21)

				if (21 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 21)) > 0 and var_8_0 < var_8_3 then
	...
	Play606101003 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				arg_9_1.leftNameTxt_.text = arg_9_1:FormatText(StoryNameCfg[417].name)
				...
				local var_12_1 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(606101003).content)
