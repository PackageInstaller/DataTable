	...
	Play320141014 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				...
				for iter_64_2, iter_64_3 in ipairs((var_64_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_64_3.transform.localScale = Vector3.New(iter_64_3.transform.localScale.x / var_64_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_64_3.transform.localScale.y / var_64_15, iter_64_3.transform.localScale.z)
				end
			end

			local var_64_17 = arg_61_1.bgs_.XS0104.transform

			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				arg_61_1.var_.moveOldPosXS0104 = var_64_17.localPosition
			end

			local var_64_18 = 0.001

			if 0 <= arg_61_1.time_ and arg_61_1.time_ < 0 + var_64_18 then
				var_64_17.localPosition = Vector3.Lerp(arg_61_1.var_.moveOldPosXS0104, Vector3.New(0, 1, 9.5), (arg_61_1.time_ - 0) / var_64_18)
			end

			if arg_61_1.time_ >= 0 + var_64_18 and arg_61_1.time_ < 0 + var_64_18 + arg_64_0 then
				var_64_17.localPosition = Vector3.New(0, 1, 9.5)
			end

			local var_64_19 = arg_61_1.bgs_.XS0104.transform

			if 0.0166666666666667 < arg_61_1.time_ and arg_61_1.time_ <= 0.0166666666666667 + arg_64_0 then
				arg_61_1.var_.moveOldPosXS0104 = var_64_19.localPosition
			end

			local var_64_20 = 3

			if 0.0166666666666667 <= arg_61_1.time_ and arg_61_1.time_ < 0.0166666666666667 + var_64_20 then
				var_64_19.localPosition = Vector3.Lerp(arg_61_1.var_.moveOldPosXS0104, Vector3.New(0, 1, 10), (arg_61_1.time_ - 0.0166666666666667) / var_64_20)
			end

			if arg_61_1.time_ >= 0.0166666666666667 + var_64_20 and arg_61_1.time_ < 0.0166666666666667 + var_64_20 + arg_64_0 then
				var_64_19.localPosition = Vector3.New(0, 1, 10)
			end
			...
			if 2 < arg_61_1.time_ and arg_61_1.time_ <= var_64_21 + arg_64_0 then
				...
				local var_64_24 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(320141014).content)

				arg_61_1.text_.text = var_64_24

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_26 = 5 <= 0 and var_64_22 or var_64_22 * (utf8.len(var_64_24) / 5)

				if (5 <= 0 and var_64_22 or var_64_22 * (utf8.len(var_64_24) / 5)) > 0 and var_64_22 < var_64_26 then
