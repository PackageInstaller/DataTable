	...
	Play321122001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.3 < arg_1_1.time_ and arg_1_1.time_ <= 0.3 + arg_4_0 then
				...
				local var_4_18 = manager.audio:GetAudioName("bgm_activity_4_0_story_shashvat_source", "bgm_activity_4_0_story_shashvat_source")
			...
			local var_4_20 = 1.63333333333333
			local var_4_21 = 1.325

			if 1.63333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_20 + arg_4_0 then
				...
				local var_4_23 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(321122001).content)

				arg_1_1.text_.text = var_4_23

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_25 = 53 <= 0 and var_4_21 or var_4_21 * (utf8.len(var_4_23) / 53)

				if (53 <= 0 and var_4_21 or var_4_21 * (utf8.len(var_4_23) / 53)) > 0 and var_4_21 < var_4_25 then
