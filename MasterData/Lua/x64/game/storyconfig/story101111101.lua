return {
	Play111111001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_9 = 2.33333333333333
			local var_4_10 = 0.825

			if 2.33333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(111111001).content)

				arg_1_1.text_.text = var_4_12

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_14 = 33 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 33)

				if (33 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 33)) > 0 and var_4_10 < var_4_14 then
	...
	Play111111002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= 0 + arg_11_0 then
				...
				local var_11_1 = arg_8_1:FormatText(arg_8_1:GetWordFromCfg(111111002).content)
	...
	Play111111003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= 0 + arg_15_0 then
				...
				local var_15_1 = arg_12_1:FormatText(arg_12_1:GetWordFromCfg(111111003).content)
	...
	Play111111004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			if arg_16_1.actors_["1094ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1094ui_story"))) then
				local var_19_0 = Object.Instantiate(Asset.Load("Char/" .. "1094ui_story"), arg_16_1.stage_.transform)

				var_19_0.name = "1094ui_story"
				var_19_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_16_1.actors_["1094ui_story"] = var_19_0
				...
				arg_16_1.var_["1094ui_story" .. "Animator"] = var_19_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_16_1.var_["1094ui_story" .. "Animator"].applyRootMotion = true
				arg_16_1.var_["1094ui_story" .. "LipSync"] = var_19_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_19_3 = arg_16_1.actors_["1094ui_story"].transform

			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 then
				arg_16_1.var_.moveOldPos1094ui_story = var_19_3.localPosition
			end

			local var_19_4 = 0.001

			if 0 <= arg_16_1.time_ and arg_16_1.time_ < 0 + var_19_4 then
				var_19_3.localPosition = Vector3.Lerp(arg_16_1.var_.moveOldPos1094ui_story, Vector3.New(0, -0.84, -6.1), (arg_16_1.time_ - 0) / var_19_4)
			...
			if arg_16_1.time_ >= 0 + var_19_4 and arg_16_1.time_ < 0 + var_19_4 + arg_19_0 then
				var_19_3.localPosition = Vector3.New(0, -0.84, -6.1)
				var_19_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_19_3.position).x, (manager.ui.mainCamera.transform.position - var_19_3.position).y, (manager.ui.mainCamera.transform.position - var_19_3.position).z)
				var_19_3.localEulerAngles.z = 0
				var_19_3.localEulerAngles.x = 0
				var_19_3.localEulerAngles = var_19_3.localEulerAngles
			...
			local var_19_5 = arg_16_1.actors_["1094ui_story"]

			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 and not isNil(var_19_5) and arg_16_1.var_.characterEffect1094ui_story == nil then
				arg_16_1.var_.characterEffect1094ui_story = var_19_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_19_6 = 0.2

			if 0 <= arg_16_1.time_ and arg_16_1.time_ < 0 + var_19_6 and not isNil(var_19_5) then
				if arg_16_1.var_.characterEffect1094ui_story and not isNil(var_19_5) then
					arg_16_1.var_.characterEffect1094ui_story.fillFlat = false
				end
			end

			if arg_16_1.time_ >= 0 + var_19_6 and arg_16_1.time_ < 0 + var_19_6 + arg_19_0 and not isNil(var_19_5) and arg_16_1.var_.characterEffect1094ui_story then
				arg_16_1.var_.characterEffect1094ui_story.fillFlat = false
			end
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_8 + arg_19_0 then
				...
				arg_16_1.leftNameTxt_.text = arg_16_1:FormatText(StoryNameCfg[181].name)
				...
				local var_19_10 = arg_16_1:GetWordFromCfg(111111004)
				...
				if manager.audio:GetVoiceLength("story_v_out_111111", "111111004", "story_v_out_111111.awb") ~= 0 then
					local var_19_14 = manager.audio:GetVoiceLength("story_v_out_111111", "111111004", "story_v_out_111111.awb") / 1000
					...
					if var_19_10.prefab_name ~= "" and arg_16_1.actors_[var_19_10.prefab_name] ~= nil then
						local var_19_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_10.prefab_name].transform, "story_v_out_111111", "111111004", "story_v_out_111111.awb")

						arg_16_1:RecordAudio("111111004", var_19_15)
						arg_16_1:RecordAudio("111111004", var_19_15)
					else
	...
	Play111111005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 and not isNil(arg_20_1.actors_["1094ui_story"]) and arg_20_1.var_.characterEffect1094ui_story == nil then
				arg_20_1.var_.characterEffect1094ui_story = arg_20_1.actors_["1094ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_23_0 = 0.2

			if 0 <= arg_20_1.time_ and arg_20_1.time_ < 0 + var_23_0 and not isNil(arg_20_1.actors_["1094ui_story"]) then
				if arg_20_1.var_.characterEffect1094ui_story and not isNil(arg_20_1.actors_["1094ui_story"]) then
					arg_20_1.var_.characterEffect1094ui_story.fillFlat = true
					arg_20_1.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_20_1.time_ - 0) / var_23_0)
				end
			end

			if arg_20_1.time_ >= 0 + var_23_0 and arg_20_1.time_ < 0 + var_23_0 + arg_23_0 and not isNil(arg_20_1.actors_["1094ui_story"]) and arg_20_1.var_.characterEffect1094ui_story then
				arg_20_1.var_.characterEffect1094ui_story.fillFlat = true
				arg_20_1.var_.characterEffect1094ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_1 + arg_23_0 then
				...
				local var_23_3 = arg_20_1:FormatText(arg_20_1:GetWordFromCfg(111111005).content)
	...
	Play111111006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 then
				...
				local var_27_1 = arg_24_1:FormatText(arg_24_1:GetWordFromCfg(111111006).content)

				arg_24_1.text_.text = var_27_1

				LuaForUtil.ClearLinePrefixSymbol(arg_24_1.text_)

				local var_27_3 = 56 <= 0 and var_27_0 or var_27_0 * (utf8.len(var_27_1) / 56)

				if (56 <= 0 and var_27_0 or var_27_0 * (utf8.len(var_27_1) / 56)) > 0 and var_27_0 < var_27_3 then
	...
	Play111111007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 then
				...
				local var_31_1 = arg_28_1:FormatText(arg_28_1:GetWordFromCfg(111111007).content)

				arg_28_1.text_.text = var_31_1

				LuaForUtil.ClearLinePrefixSymbol(arg_28_1.text_)

				local var_31_3 = 9 <= 0 and var_31_0 or var_31_0 * (utf8.len(var_31_1) / 9)

				if (9 <= 0 and var_31_0 or var_31_0 * (utf8.len(var_31_1) / 9)) > 0 and var_31_0 < var_31_3 then
	...
	Play111111008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_3 + arg_35_0 then
				...
				local var_35_5 = arg_32_1:GetWordFromCfg(111111008)
				...
				local var_35_8 = 6 <= 0 and var_35_4 or var_35_4 * (utf8.len(var_35_6) / 6)

				if (6 <= 0 and var_35_4 or var_35_4 * (utf8.len(var_35_6) / 6)) > 0 and var_35_4 < var_35_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111111", "111111008", "story_v_out_111111.awb") ~= 0 then
					local var_35_9 = manager.audio:GetVoiceLength("story_v_out_111111", "111111008", "story_v_out_111111.awb") / 1000
					...
					if var_35_5.prefab_name ~= "" and arg_32_1.actors_[var_35_5.prefab_name] ~= nil then
						local var_35_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_32_1.actors_[var_35_5.prefab_name].transform, "story_v_out_111111", "111111008", "story_v_out_111111.awb")

						arg_32_1:RecordAudio("111111008", var_35_10)
						arg_32_1:RecordAudio("111111008", var_35_10)
					else
	...
	Play111111009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= 0 + arg_39_0 and not isNil(arg_36_1.actors_["1094ui_story"]) and arg_36_1.var_.characterEffect1094ui_story == nil then
				arg_36_1.var_.characterEffect1094ui_story = arg_36_1.actors_["1094ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_39_0 = 0.2

			if 0 <= arg_36_1.time_ and arg_36_1.time_ < 0 + var_39_0 and not isNil(arg_36_1.actors_["1094ui_story"]) then
				if arg_36_1.var_.characterEffect1094ui_story and not isNil(arg_36_1.actors_["1094ui_story"]) then
					arg_36_1.var_.characterEffect1094ui_story.fillFlat = true
					arg_36_1.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_36_1.time_ - 0) / var_39_0)
				end
			end

			if arg_36_1.time_ >= 0 + var_39_0 and arg_36_1.time_ < 0 + var_39_0 + arg_39_0 and not isNil(arg_36_1.actors_["1094ui_story"]) and arg_36_1.var_.characterEffect1094ui_story then
				arg_36_1.var_.characterEffect1094ui_story.fillFlat = true
				arg_36_1.var_.characterEffect1094ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_1 + arg_39_0 then
				...
				local var_39_3 = arg_36_1:FormatText(arg_36_1:GetWordFromCfg(111111009).content)

				arg_36_1.text_.text = var_39_3

				LuaForUtil.ClearLinePrefixSymbol(arg_36_1.text_)

				local var_39_5 = 6 <= 0 and var_39_2 or var_39_2 * (utf8.len(var_39_3) / 6)

				if (6 <= 0 and var_39_2 or var_39_2 * (utf8.len(var_39_3) / 6)) > 0 and var_39_2 < var_39_5 then
	...
	Play111111010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_3 + arg_43_0 then
				...
				local var_43_5 = arg_40_1:GetWordFromCfg(111111010)
				...
				local var_43_8 = 2 <= 0 and var_43_4 or var_43_4 * (utf8.len(var_43_6) / 2)

				if (2 <= 0 and var_43_4 or var_43_4 * (utf8.len(var_43_6) / 2)) > 0 and var_43_4 < var_43_8 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111111", "111111010", "story_v_out_111111.awb") ~= 0 then
					local var_43_9 = manager.audio:GetVoiceLength("story_v_out_111111", "111111010", "story_v_out_111111.awb") / 1000
					...
					if var_43_5.prefab_name ~= "" and arg_40_1.actors_[var_43_5.prefab_name] ~= nil then
						local var_43_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_5.prefab_name].transform, "story_v_out_111111", "111111010", "story_v_out_111111.awb")

						arg_40_1:RecordAudio("111111010", var_43_10)
						arg_40_1:RecordAudio("111111010", var_43_10)
					else
	...
	Play111111011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= var_47_1 + arg_47_0 then
				...
				local var_47_3 = arg_44_1:FormatText(arg_44_1:GetWordFromCfg(111111011).content)
	...
	Play111111012 = function(arg_48_0, arg_48_1)
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if 0 < arg_48_1.time_ and arg_48_1.time_ <= 0 + arg_51_0 then
				...
				local var_51_1 = arg_48_1:FormatText(arg_48_1:GetWordFromCfg(111111012).content)
