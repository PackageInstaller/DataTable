return {
	Play925051001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_2 = arg_1_1.bgs_.I06d
			...
			if arg_1_1.actors_["1034"] == nil then
				local var_4_10 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1034")
			...
			local var_4_12 = arg_1_1.actors_["1034"]

			if 1.675 < arg_1_1.time_ and arg_1_1.time_ <= 1.675 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.actorSpriteComps1034 == nil then
				arg_1_1.var_.actorSpriteComps1034 = var_4_12:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_1_1.time_ >= 1.675 + var_4_13 and arg_1_1.time_ < 1.675 + var_4_13 + arg_4_0 and not isNil(var_4_12) and arg_1_1.var_.actorSpriteComps1034 then
			...
			local var_4_15 = arg_1_1.actors_["1034"].transform

			if 1.675 < arg_1_1.time_ and arg_1_1.time_ <= 1.675 + arg_4_0 then
				arg_1_1.var_.moveOldPos1034 = var_4_15.localPosition
			...
			if 1.675 <= arg_1_1.time_ and arg_1_1.time_ < 1.675 + var_4_17 then
				var_4_15.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_1_1.time_ - 1.675) / var_4_17)
			end

			if arg_1_1.time_ >= 1.675 + var_4_17 and arg_1_1.time_ < 1.675 + var_4_17 + arg_4_0 then
				var_4_15.localPosition = Vector3.New(0, -350, -180)
			end

			if 1.675 < arg_1_1.time_ and arg_1_1.time_ <= 1.675 + arg_4_0 then
				local var_4_18 = arg_1_1.actors_["1034"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_4_18 then
					arg_1_1.var_.alphaOldValue1034 = var_4_18.alpha
					arg_1_1.var_.characterEffect1034 = var_4_18
				end
			...
			if 1.675 <= arg_1_1.time_ and arg_1_1.time_ < 1.675 + var_4_19 then
				if arg_1_1.var_.characterEffect1034 then
					arg_1_1.var_.characterEffect1034.alpha = Mathf.Lerp(arg_1_1.var_.alphaOldValue1034, 1, (arg_1_1.time_ - 1.675) / var_4_19)
				end
			end

			if arg_1_1.time_ >= 1.675 + var_4_19 and arg_1_1.time_ < 1.675 + var_4_19 + arg_4_0 and arg_1_1.var_.characterEffect1034 then
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_26 + arg_4_0 then
				...
				local var_4_29 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(925051001).content)

				arg_1_1.text_.text = var_4_29

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_31 = 29 <= 0 and var_4_27 or var_4_27 * (utf8.len(var_4_29) / 29)

				if (29 <= 0 and var_4_27 or var_4_27 * (utf8.len(var_4_29) / 29)) > 0 and var_4_27 < var_4_31 then
	...
	Play925051002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_2 + arg_12_0 then
				...
				local var_12_4 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(925051002).content)

				arg_9_1.text_.text = var_12_4

				LuaForUtil.ClearLinePrefixSymbol(arg_9_1.text_)

				local var_12_6 = 16 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 16)

				if (16 <= 0 and var_12_3 or var_12_3 * (utf8.len(var_12_4) / 16)) > 0 and var_12_3 < var_12_6 then
	...
	Play925051003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_2 + arg_16_0 then
				...
				local var_16_4 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(925051003).content)
	...
	Play925051004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_2 + arg_20_0 then
				...
				local var_20_4 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(925051004).content)

				arg_17_1.text_.text = var_20_4

				LuaForUtil.ClearLinePrefixSymbol(arg_17_1.text_)

				local var_20_6 = 12 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 12)

				if (12 <= 0 and var_20_3 or var_20_3 * (utf8.len(var_20_4) / 12)) > 0 and var_20_3 < var_20_6 then
	...
	Play925051005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_5 + arg_24_0 then
				...
				local var_24_7 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(925051005).content)
	...
	Play925051006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(925051006).content)

				arg_25_1.text_.text = var_28_4

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_6 = 21 <= 0 and var_28_3 or var_28_3 * (utf8.len(var_28_4) / 21)

				if (21 <= 0 and var_28_3 or var_28_3 * (utf8.len(var_28_4) / 21)) > 0 and var_28_3 < var_28_6 then
	...
	Play925051007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_5 + arg_32_0 then
				...
				local var_32_7 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(925051007).content)

				arg_29_1.text_.text = var_32_7

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_9 = 18 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 18)

				if (18 <= 0 and var_32_6 or var_32_6 * (utf8.len(var_32_7) / 18)) > 0 and var_32_6 < var_32_9 then
	...
	Play925051008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 then
				...
				local var_36_1 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(925051008).content)
	...
	Play925051009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_2 + arg_40_0 then
				...
				local var_40_4 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(925051009).content)

				arg_37_1.text_.text = var_40_4

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_6 = 23 <= 0 and var_40_3 or var_40_3 * (utf8.len(var_40_4) / 23)

				if (23 <= 0 and var_40_3 or var_40_3 * (utf8.len(var_40_4) / 23)) > 0 and var_40_3 < var_40_6 then
	...
	Play925051010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_5 + arg_44_0 then
				...
				local var_44_7 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(925051010).content)

				arg_41_1.text_.text = var_44_7

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_9 = 14 <= 0 and var_44_6 or var_44_6 * (utf8.len(var_44_7) / 14)

				if (14 <= 0 and var_44_6 or var_44_6 * (utf8.len(var_44_7) / 14)) > 0 and var_44_6 < var_44_9 then
	...
	Play925051011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(arg_45_1.actors_["1034"]) and arg_45_1.var_.actorSpriteComps1034 == nil then
				arg_45_1.var_.actorSpriteComps1034 = arg_45_1.actors_["1034"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_48_0 = 0.2

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_0 and not isNil(arg_45_1.actors_["1034"]) then
			...
			if arg_45_1.time_ >= 0 + var_48_0 and arg_45_1.time_ < 0 + var_48_0 + arg_48_0 and not isNil(arg_45_1.actors_["1034"]) and arg_45_1.var_.actorSpriteComps1034 then
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 then
				...
				local var_48_4 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(925051011).content)

				arg_45_1.text_.text = var_48_4

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_6 = 8 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 8)

				if (8 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 8)) > 0 and var_48_3 < var_48_6 then
	...
	Play925051012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			local var_52_2 = arg_49_1.actors_["1034"].transform

			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1.var_.moveOldPos1034 = var_52_2.localPosition
			...
			if 0 <= arg_49_1.time_ and arg_49_1.time_ < 0 + var_52_4 then
				var_52_2.localPosition = Vector3.Lerp(arg_49_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_49_1.time_ - 0) / var_52_4)
			end

			if arg_49_1.time_ >= 0 + var_52_4 and arg_49_1.time_ < 0 + var_52_4 + arg_52_0 then
				var_52_2.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_5 + arg_52_0 then
				...
				local var_52_7 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(925051012).content)

				arg_49_1.text_.text = var_52_7

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_9 = 23 <= 0 and var_52_6 or var_52_6 * (utf8.len(var_52_7) / 23)

				if (23 <= 0 and var_52_6 or var_52_6 * (utf8.len(var_52_7) / 23)) > 0 and var_52_6 < var_52_9 then
	...
	Play925051013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_2 + arg_56_0 then
				...
				local var_56_4 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(925051013).content)

				arg_53_1.text_.text = var_56_4

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_6 = 12 <= 0 and var_56_3 or var_56_3 * (utf8.len(var_56_4) / 12)

				if (12 <= 0 and var_56_3 or var_56_3 * (utf8.len(var_56_4) / 12)) > 0 and var_56_3 < var_56_6 then
	...
	Play925051014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_2 + arg_60_0 then
				...
				local var_60_4 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(925051014).content)
	...
	Play925051015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				arg_61_1.var_.moveOldPos1034 = arg_61_1.actors_["1034"].transform.localPosition
				arg_61_1.actors_["1034"].transform.localScale = Vector3.New(1, 1, 1)

				arg_61_1:CheckSpriteTmpPos("1034", 3)

				for iter_64_0 = 0, arg_61_1.actors_["1034"].transform.childCount - 1 do
					local var_64_0 = arg_61_1.actors_["1034"].transform:GetChild(iter_64_0)
			...
			if 0 <= arg_61_1.time_ and arg_61_1.time_ < 0 + var_64_1 then
				arg_61_1.actors_["1034"].transform.localPosition = Vector3.Lerp(arg_61_1.var_.moveOldPos1034, Vector3.New(0, -350, -180), (arg_61_1.time_ - 0) / var_64_1)
			end

			if arg_61_1.time_ >= 0 + var_64_1 and arg_61_1.time_ < 0 + var_64_1 + arg_64_0 then
				arg_61_1.actors_["1034"].transform.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_2 + arg_64_0 then
				...
				local var_64_4 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(925051015).content)
