return {
	Play62107001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_4 = "1111ui_story"

			if arg_1_1.actors_["1111ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1111ui_story"))) then
				local var_4_5 = Object.Instantiate(Asset.Load("Char/" .. "1111ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_8 = arg_1_1.actors_["1111ui_story"].transform

			if 1.8 < arg_1_1.time_ and arg_1_1.time_ <= 1.8 + arg_4_0 then
				arg_1_1.var_.moveOldPos1111ui_story = var_4_8.localPosition
			end

			local var_4_9 = 0.001

			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_9 then
				var_4_8.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_1_1.time_ - 1.8) / var_4_9)
			...
			if arg_1_1.time_ >= 1.8 + var_4_9 and arg_1_1.time_ < 1.8 + var_4_9 + arg_4_0 then
				var_4_8.localPosition = Vector3.New(0, -0.87, -5.7)
				var_4_8.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_8.position).x, (manager.ui.mainCamera.transform.position - var_4_8.position).y, (manager.ui.mainCamera.transform.position - var_4_8.position).z)
				var_4_8.localEulerAngles.z = 0
				var_4_8.localEulerAngles.x = 0
				var_4_8.localEulerAngles = var_4_8.localEulerAngles
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				...
				local var_4_26 = arg_1_1:GetWordFromCfg(62107001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62107", "62107001", "story_v_chess_62107.awb") ~= 0 then
					local var_4_30 = manager.audio:GetVoiceLength("story_v_chess_62107", "62107001", "story_v_chess_62107.awb") / 1000
					...
					if var_4_26.prefab_name ~= "" and arg_1_1.actors_[var_4_26.prefab_name] ~= nil then
						local var_4_31 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_26.prefab_name].transform, "story_v_chess_62107", "62107001", "story_v_chess_62107.awb")

						arg_1_1:RecordAudio("62107001", var_4_31)
						arg_1_1:RecordAudio("62107001", var_4_31)
					else
	...
	Play62107002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_1 + arg_12_0 then
				...
				local var_12_3 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(62107002).content)
	...
	Play62107003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/story1111/story1111actionlink/1111action454")
			end
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_3 + arg_16_0 then
				...
				local var_16_5 = arg_13_1:GetWordFromCfg(62107003)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62107", "62107003", "story_v_chess_62107.awb") ~= 0 then
					local var_16_9 = manager.audio:GetVoiceLength("story_v_chess_62107", "62107003", "story_v_chess_62107.awb") / 1000
					...
					if var_16_5.prefab_name ~= "" and arg_13_1.actors_[var_16_5.prefab_name] ~= nil then
						local var_16_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_5.prefab_name].transform, "story_v_chess_62107", "62107003", "story_v_chess_62107.awb")

						arg_13_1:RecordAudio("62107003", var_16_10)
						arg_13_1:RecordAudio("62107003", var_16_10)
					else
	...
	Play62107004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(62107004).content)
	...
	Play62107005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				arg_21_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/story1111/story1111action/1111action4_2")
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_3 + arg_24_0 then
				...
				local var_24_5 = arg_21_1:GetWordFromCfg(62107005)
				...
				local var_24_8 = 43 <= 0 and var_24_4 or var_24_4 * (utf8.len(var_24_6) / 43)

				if (43 <= 0 and var_24_4 or var_24_4 * (utf8.len(var_24_6) / 43)) > 0 and var_24_4 < var_24_8 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62107", "62107005", "story_v_chess_62107.awb") ~= 0 then
					local var_24_9 = manager.audio:GetVoiceLength("story_v_chess_62107", "62107005", "story_v_chess_62107.awb") / 1000
					...
					if var_24_5.prefab_name ~= "" and arg_21_1.actors_[var_24_5.prefab_name] ~= nil then
						local var_24_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_5.prefab_name].transform, "story_v_chess_62107", "62107005", "story_v_chess_62107.awb")

						arg_21_1:RecordAudio("62107005", var_24_10)
						arg_21_1:RecordAudio("62107005", var_24_10)
					else
	...
	Play62107006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(62107006).content)

				arg_25_1.text_.text = var_28_3

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_5 = 2 <= 0 and var_28_2 or var_28_2 * (utf8.len(var_28_3) / 2)

				if (2 <= 0 and var_28_2 or var_28_2 * (utf8.len(var_28_3) / 2)) > 0 and var_28_2 < var_28_5 then
