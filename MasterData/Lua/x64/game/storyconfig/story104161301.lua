	...
	Play416131020 = function(arg_91_0, arg_91_1)
		...
		function arg_91_1.onSingleLineUpdate_(arg_94_0)
			...
			if 0.333333333333333 < arg_91_1.time_ and arg_91_1.time_ <= 0.333333333333333 + arg_94_0 then
				...
				for iter_94_5, iter_94_6 in ipairs((var_94_9.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_94_6.transform.localScale = Vector3.New(iter_94_6.transform.localScale.x / var_94_11 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_94_6.transform.localScale.y / var_94_11, iter_94_6.transform.localScale.z)
				end
			end
			...
			if 1 < arg_91_1.time_ and arg_91_1.time_ <= var_94_14 + arg_94_0 then
				...
				local var_94_17 = arg_91_1:FormatText(arg_91_1:GetWordFromCfg(416131020).content)

				arg_91_1.text_.text = var_94_17

				LuaForUtil.ClearLinePrefixSymbol(arg_91_1.text_)

				local var_94_19 = 56 <= 0 and var_94_15 or var_94_15 * (utf8.len(var_94_17) / 56)

				if (56 <= 0 and var_94_15 or var_94_15 * (utf8.len(var_94_17) / 56)) > 0 and var_94_15 < var_94_19 then
