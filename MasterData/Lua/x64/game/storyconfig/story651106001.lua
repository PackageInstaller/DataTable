return {
	Play651106001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 651106001
		arg_1_1.duration_ = 5
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				local var_4_1 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(651106001).content)

				arg_1_1.text_.text = var_4_1

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_3 = 17 <= 0 and var_4_0 or var_4_0 * (utf8.len(var_4_1) / 17)

				if (17 <= 0 and var_4_0 or var_4_0 * (utf8.len(var_4_1) / 17)) > 0 and var_4_0 < var_4_3 then
	...
	Play651106002 = function(arg_5_0, arg_5_1)
		arg_5_1.time_ = 0
		arg_5_1.frameCnt_ = 0
		arg_5_1.state_ = "playing"
		arg_5_1.curTalkId_ = 651106002
		arg_5_1.duration_ = 5
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if 0 < arg_5_1.time_ and arg_5_1.time_ <= 0 + arg_8_0 then
				...
				arg_5_1.leftNameTxt_.text = arg_5_1:FormatText(StoryNameCfg[37].name)
				...
				arg_5_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1011")
				...
				local var_8_1 = arg_5_1:FormatText(arg_5_1:GetWordFromCfg(651106002).content)

				arg_5_1.text_.text = var_8_1

				LuaForUtil.ClearLinePrefixSymbol(arg_5_1.text_)

				local var_8_3 = 38 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 38)

				if (38 <= 0 and var_8_0 or var_8_0 * (utf8.len(var_8_1) / 38)) > 0 and var_8_0 < var_8_3 then
	...
	Play651106003 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 651106003
		arg_9_1.duration_ = 5
		...
		function arg_9_1.playNext_(arg_11_0)
			if arg_11_0 == 1 then
				arg_9_0:Play651106004(arg_9_1)
			end
		end

		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			local var_12_0 = 1.575
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(651106003).content)
	...
	Play651106004 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 651106004
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play651106005(arg_13_1)
			end
		end
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				...
				arg_13_1.leftNameTxt_.text = arg_13_1:FormatText(StoryNameCfg[10].name)
				...
				arg_13_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_mmr")
				...
				local var_16_1 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(651106004).content)

				arg_13_1.text_.text = var_16_1

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_3 = 160 <= 0 and var_16_0 or var_16_0 * (utf8.len(var_16_1) / 160)

				if (160 <= 0 and var_16_0 or var_16_0 * (utf8.len(var_16_1) / 160)) > 0 and var_16_0 < var_16_3 then
	...
	Play651106005 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 651106005
		...
		function arg_17_1.onSingleLineFinish_()
			...
			arg_17_1.auto_ = false
		end

		function arg_17_1.playNext_(arg_19_0)
			arg_17_1.onStoryFinished_()
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 then
				...
				local var_20_1 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(651106005).content)
