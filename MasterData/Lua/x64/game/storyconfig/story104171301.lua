	...
	Play417131001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 4.18791796957764 < arg_1_1.time_ and arg_1_1.time_ <= 4.18791796957764 + arg_4_0 then
				...
				for iter_4_2, iter_4_3 in ipairs((var_4_5.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_3.transform.localScale = Vector3.New(iter_4_3.transform.localScale.x / var_4_7 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_3.transform.localScale.y / var_4_7, iter_4_3.transform.localScale.z)
				end
			end
			...
			if 0.466666666666667 < arg_1_1.time_ and arg_1_1.time_ <= 0.466666666666667 + arg_4_0 then
				...
				local var_4_15 = manager.audio:GetAudioName("bgm_activity_3_10_story_dock", "bgm_activity_3_10_story_dock")
			...
			if arg_1_1.time_ >= var_4_16 + 3 and arg_1_1.time_ < var_4_16 + 3 + arg_4_0 then
			...
			if 3 < arg_1_1.time_ and arg_1_1.time_ <= var_4_17 + arg_4_0 then
			...
			if 4.2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_21 + arg_4_0 then
				arg_1_1.mask_.enabled = true
				arg_1_1.mask_.raycastTarget = true
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_29 + arg_4_0 then
				arg_1_1.allBtn_.enabled = false
			end

			if arg_1_1.time_ >= var_4_29 + 3 and arg_1_1.time_ < var_4_29 + 3 + arg_4_0 then
				arg_1_1.allBtn_.enabled = true
			end
			...
			if 5.4 < arg_1_1.time_ and arg_1_1.time_ <= var_4_30 + arg_4_0 then
				...
				local var_4_33 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(417131001).content)

				arg_1_1.text_.text = var_4_33

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_35 = 52 <= 0 and var_4_31 or var_4_31 * (utf8.len(var_4_33) / 52)

				if (52 <= 0 and var_4_31 or var_4_31 * (utf8.len(var_4_33) / 52)) > 0 and var_4_31 < var_4_35 then
	...
	Play417131070 = function(arg_286_0, arg_286_1)
		...
		function arg_286_1.onSingleLineUpdate_(arg_289_0)
			...
			if 2.43333333333333 < arg_286_1.time_ and arg_286_1.time_ <= 2.43333333333333 + arg_289_0 then
				...
				for iter_289_6, iter_289_7 in ipairs((var_289_14.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_289_7.transform.localScale = Vector3.New(iter_289_7.transform.localScale.x / var_289_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_289_7.transform.localScale.y / var_289_16, iter_289_7.transform.localScale.z)
				end
			end

			if 1.56666666666667 < arg_286_1.time_ and arg_286_1.time_ <= 1.56666666666667 + arg_289_0 then
				local var_289_18 = arg_286_1.var_.effect811

				if not arg_286_1.var_.effect811 then
					var_289_18 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_heavy"), manager.ui.mainCamera.transform)
					var_289_18.name = "811"
					arg_286_1.var_.effect811 = var_289_18
				else
					var_289_18.transform:SetParent(var_289_9000)
				end

				var_289_18.transform.localPosition = Vector3.New(0, 0, 0)
				var_289_18.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_289_20 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_289_8, iter_289_9 in ipairs((var_289_18.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_289_9.transform.localScale = Vector3.New(iter_289_9.transform.localScale.x / var_289_20 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_289_9.transform.localScale.y / var_289_20, iter_289_9.transform.localScale.z)
				end
			end
			...
			local var_289_24 = 3.43333333333333
			local var_289_25 = 1.25

			if 3.43333333333333 < arg_286_1.time_ and arg_286_1.time_ <= var_289_24 + arg_289_0 then
				...
				local var_289_26 = LeanTween.value(arg_286_1.dialog_, 0, 1, 0.3)

				var_289_26:setOnUpdate(LuaHelper.FloatAction(function(arg_290_0)
					arg_286_1.dialogCg_.alpha = arg_290_0
				end))
				var_289_26:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_286_1.dialog_)
					var_289_26:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_289_27 = arg_286_1:FormatText(arg_286_1:GetWordFromCfg(417131070).content)

				arg_286_1.text_.text = var_289_27

				LuaForUtil.ClearLinePrefixSymbol(arg_286_1.text_)

				local var_289_29 = 50 <= 0 and var_289_25 or var_289_25 * (utf8.len(var_289_27) / 50)

				if (50 <= 0 and var_289_25 or var_289_25 * (utf8.len(var_289_27) / 50)) > 0 and var_289_25 < var_289_29 then
					arg_286_1.talkMaxDuration = var_289_29
					var_289_24 = var_289_24 + 0.3

					if var_289_29 + var_289_24 > arg_286_1.duration_ then
						arg_286_1.duration_ = var_289_29 + var_289_24
					end
				end
			...
			local var_289_30 = var_289_24 + 0.3
			local var_289_31 = math.max(var_289_25, arg_286_1.talkMaxDuration)

			if var_289_24 + 0.3 <= arg_286_1.time_ and arg_286_1.time_ < var_289_30 + var_289_31 then
	...
	Play417131077 = function(arg_316_0, arg_316_1)
		...
		function arg_316_1.onSingleLineUpdate_(arg_319_0)
			...
			if 2.26666666666667 < arg_316_1.time_ and arg_316_1.time_ <= 2.26666666666667 + arg_319_0 then
				...
				for iter_319_5, iter_319_6 in ipairs((var_319_5.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_319_6.transform.localScale = Vector3.New(iter_319_6.transform.localScale.x / var_319_7 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_319_6.transform.localScale.y / var_319_7, iter_319_6.transform.localScale.z)
				end
			end

			local var_319_9 = 1.16666666666667

			if 1.16666666666667 < arg_316_1.time_ and arg_316_1.time_ <= var_319_9 + arg_319_0 then
				arg_316_1.allBtn_.enabled = false
			end

			if arg_316_1.time_ >= var_319_9 + 1.76666666666667 and arg_316_1.time_ < var_319_9 + 1.76666666666667 + arg_319_0 then
			...
			local var_319_15 = 1.23333333333333

			if 1.23333333333333 < arg_316_1.time_ and arg_316_1.time_ <= var_319_15 + arg_319_0 then
				arg_316_1.mask_.enabled = true
				arg_316_1.mask_.raycastTarget = true
			...
			if var_319_15 <= arg_316_1.time_ and arg_316_1.time_ < var_319_15 + var_319_16 then
				local var_319_17 = Color.New(0, 0, 0)

				var_319_17.a = Mathf.Lerp(1, 0, (arg_316_1.time_ - var_319_15) / var_319_16)
				arg_316_1.mask_.color = var_319_17
			end
			...
			local var_319_19 = "STblack"

			if arg_316_1.bgs_.STblack == nil then
				local var_319_20 = Object.Instantiate(arg_316_1.paintGo_)

				var_319_20:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. var_319_19)
				var_319_20.name = var_319_19
				var_319_20.transform.parent = arg_316_1.stage_.transform
				var_319_20.transform.localPosition = Vector3.New(0, 100, 0)
				arg_316_1.bgs_[var_319_19] = var_319_20
			end

			if 1.23333333333333 < arg_316_1.time_ and arg_316_1.time_ <= 1.23333333333333 + arg_319_0 then
				local var_319_21 = arg_316_1.bgs_.STblack
				...
				var_319_21.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_319_22 = var_319_21:GetComponent("SpriteRenderer")

				if var_319_22 and var_319_22.sprite then
					local var_319_23 = 2 * (var_319_21.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_319_21.transform.localScale = Vector3.New(var_319_23 / var_319_22.sprite.bounds.size.y < var_319_23 * manager.ui.mainCameraCom_.aspect / var_319_22.sprite.bounds.size.x and var_319_23 * manager.ui.mainCameraCom_.aspect / var_319_22.sprite.bounds.size.x or var_319_23 / var_319_22.sprite.bounds.size.y, var_319_23 / var_319_22.sprite.bounds.size.y < var_319_23 * manager.ui.mainCameraCom_.aspect / var_319_22.sprite.bounds.size.x and var_319_23 * manager.ui.mainCameraCom_.aspect / var_319_22.sprite.bounds.size.x or var_319_23 / var_319_22.sprite.bounds.size.y, 0)
				end
			...
			local var_319_24 = 3.23333333333333
			local var_319_25 = 1.5

			if 3.23333333333333 < arg_316_1.time_ and arg_316_1.time_ <= var_319_24 + arg_319_0 then
				...
				local var_319_27 = arg_316_1:FormatText(arg_316_1:GetWordFromCfg(417131077).content)

				arg_316_1.text_.text = var_319_27

				LuaForUtil.ClearLinePrefixSymbol(arg_316_1.text_)

				local var_319_29 = 60 <= 0 and var_319_25 or var_319_25 * (utf8.len(var_319_27) / 60)

				if (60 <= 0 and var_319_25 or var_319_25 * (utf8.len(var_319_27) / 60)) > 0 and var_319_25 < var_319_29 then
					arg_316_1.talkMaxDuration = var_319_29
					var_319_24 = var_319_24 + 0.3

					if var_319_29 + var_319_24 > arg_316_1.duration_ then
						arg_316_1.duration_ = var_319_29 + var_319_24
					end
				end
			...
			local var_319_30 = var_319_24 + 0.3
			local var_319_31 = math.max(var_319_25, arg_316_1.talkMaxDuration)

			if var_319_24 + 0.3 <= arg_316_1.time_ and arg_316_1.time_ < var_319_30 + var_319_31 then
	...
	Play417131079 = function(arg_326_0, arg_326_1)
		...
		function arg_326_1.onSingleLineUpdate_(arg_329_0)
			if 0.2 < arg_326_1.time_ and arg_326_1.time_ <= 0.2 + arg_329_0 then
				...
				for iter_329_0, iter_329_1 in ipairs((var_329_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_329_1.transform.localScale = Vector3.New(iter_329_1.transform.localScale.x / var_329_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_329_1.transform.localScale.y / var_329_2, iter_329_1.transform.localScale.z)
				end
			end
			...
			if var_329_4 <= arg_326_1.time_ and arg_326_1.time_ < var_329_4 + var_329_5 then
				local var_329_6 = Color.New(1, 1, 1)

				var_329_6.a = Mathf.Lerp(1, 0, (arg_326_1.time_ - var_329_4) / var_329_5)
			...
			local var_329_9 = 0.583333333333333
			local var_329_10 = 0.05

			if 0.583333333333333 < arg_326_1.time_ and arg_326_1.time_ <= var_329_9 + arg_329_0 then
				...
				local var_329_12 = arg_326_1:GetWordFromCfg(417131079)
				...
				local var_329_15 = 2 <= 0 and var_329_10 or var_329_10 * (utf8.len(var_329_13) / 2)

				if (2 <= 0 and var_329_10 or var_329_10 * (utf8.len(var_329_13) / 2)) > 0 and var_329_10 < var_329_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_417131", "417131079", "story_v_out_417131.awb") ~= 0 then
					local var_329_16 = manager.audio:GetVoiceLength("story_v_out_417131", "417131079", "story_v_out_417131.awb") / 1000
					...
					if var_329_12.prefab_name ~= "" and arg_326_1.actors_[var_329_12.prefab_name] ~= nil then
						local var_329_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_326_1.actors_[var_329_12.prefab_name].transform, "story_v_out_417131", "417131079", "story_v_out_417131.awb")

						arg_326_1:RecordAudio("417131079", var_329_17)
						arg_326_1:RecordAudio("417131079", var_329_17)
					else
			...
			local var_329_18 = var_329_9 + 0.3
			local var_329_19 = math.max(var_329_10, arg_326_1.talkMaxDuration)

			if var_329_9 + 0.3 <= arg_326_1.time_ and arg_326_1.time_ < var_329_18 + var_329_19 then
				arg_326_1.typewritter.percent = (arg_326_1.time_ - var_329_18) / var_329_19
	...
	Play417131094 = function(arg_393_0, arg_393_1)
		...
		function arg_393_1.onSingleLineUpdate_(arg_396_0)
			...
			if 1.4 < arg_393_1.time_ and arg_393_1.time_ <= 1.4 + arg_396_0 then
				...
				for iter_396_2, iter_396_3 in ipairs((var_396_23.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_396_3.transform.localScale = Vector3.New(iter_396_3.transform.localScale.x / var_396_25 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_396_3.transform.localScale.y / var_396_25, iter_396_3.transform.localScale.z)
				end
			end
	...
	Play417131095 = function(arg_397_0, arg_397_1)
		...
		function arg_397_1.onSingleLineUpdate_(arg_400_0)
			...
			if 1.434 < arg_397_1.time_ and arg_397_1.time_ <= 1.434 + arg_400_0 then
				...
				for iter_400_2, iter_400_3 in ipairs((var_400_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_400_3.transform.localScale = Vector3.New(iter_400_3.transform.localScale.x / var_400_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_400_3.transform.localScale.y / var_400_15, iter_400_3.transform.localScale.z)
				end
			end
			...
			local var_400_22 = 3.2
			local var_400_23 = 0.95

			if 3.2 < arg_397_1.time_ and arg_397_1.time_ <= var_400_22 + arg_400_0 then
				...
				local var_400_25 = arg_397_1:FormatText(arg_397_1:GetWordFromCfg(417131095).content)

				arg_397_1.text_.text = var_400_25

				LuaForUtil.ClearLinePrefixSymbol(arg_397_1.text_)

				local var_400_27 = 38 <= 0 and var_400_23 or var_400_23 * (utf8.len(var_400_25) / 38)

				if (38 <= 0 and var_400_23 or var_400_23 * (utf8.len(var_400_25) / 38)) > 0 and var_400_23 < var_400_27 then
					arg_397_1.talkMaxDuration = var_400_27
					var_400_22 = var_400_22 + 0.3

					if var_400_27 + var_400_22 > arg_397_1.duration_ then
						arg_397_1.duration_ = var_400_27 + var_400_22
					end
				end
			...
			local var_400_28 = var_400_22 + 0.3
			local var_400_29 = math.max(var_400_23, arg_397_1.talkMaxDuration)

			if var_400_22 + 0.3 <= arg_397_1.time_ and arg_397_1.time_ < var_400_28 + var_400_29 then
				arg_397_1.typewritter.percent = (arg_397_1.time_ - var_400_28) / var_400_29
