	...
	Play322051001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				for iter_4_6, iter_4_7 in ipairs((var_4_16.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_7.transform.localScale = Vector3.New(iter_4_7.transform.localScale.x / var_4_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_7.transform.localScale.y / var_4_18, iter_4_7.transform.localScale.z)
				end
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_20 = arg_1_1.var_.effect10012

				if not arg_1_1.var_.effect10012 then
					var_4_20 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_monitor"), manager.ui.mainCamera.transform)
					var_4_20.name = "10012"
					arg_1_1.var_.effect10012 = var_4_20
				else
					var_4_20.transform:SetParent(var_4_9001)
				end

				var_4_20.transform.localPosition = Vector3.New(0, 0, 0)
				var_4_20.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_4_22 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_4_8, iter_4_9 in ipairs((var_4_20.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_9.transform.localScale = Vector3.New(iter_4_9.transform.localScale.x / var_4_22 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_9.transform.localScale.y / var_4_22, iter_4_9.transform.localScale.z)
				end
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_24 = arg_1_1.var_.effect10013

				if not arg_1_1.var_.effect10013 then
					var_4_24 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_vignetting"), manager.ui.mainCamera.transform)
					var_4_24.name = "10013"
					arg_1_1.var_.effect10013 = var_4_24
				else
					var_4_24.transform:SetParent(var_4_9000)
				end

				var_4_24.transform.localPosition = Vector3.New(0, 0, -1.17)
				var_4_24.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_4_26 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_4_10, iter_4_11 in ipairs((var_4_24.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_11.transform.localScale = Vector3.New(iter_4_11.transform.localScale.x / var_4_26 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_11.transform.localScale.y / var_4_26, iter_4_11.transform.localScale.z)
				end
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_29 + arg_4_0 then
				...
				var_4_31:setOnUpdate(LuaHelper.FloatAction(function(arg_6_0)
				...
				local var_4_32 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(322051001).content)

				arg_1_1.text_.text = var_4_32

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_34 = 58 <= 0 and var_4_30 or var_4_30 * (utf8.len(var_4_32) / 58)

				if (58 <= 0 and var_4_30 or var_4_30 * (utf8.len(var_4_32) / 58)) > 0 and var_4_30 < var_4_34 then
