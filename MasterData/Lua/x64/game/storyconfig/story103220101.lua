	...
	Play322011011 = function(arg_46_0, arg_46_1)
		...
		function arg_46_1.onSingleLineUpdate_(arg_49_0)
			...
			if 0.333333333333333 < arg_46_1.time_ and arg_46_1.time_ <= 0.333333333333333 + arg_49_0 then
				...
				for iter_49_0, iter_49_1 in ipairs((var_49_1.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_49_1.transform.localScale = Vector3.New(iter_49_1.transform.localScale.x / var_49_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_49_1.transform.localScale.y / var_49_3, iter_49_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_46_1.time_ and arg_46_1.time_ <= var_49_5 + arg_49_0 then
				...
				local var_49_7 = arg_46_1:FormatText(arg_46_1:GetWordFromCfg(322011011).content)

				arg_46_1.text_.text = var_49_7

				LuaForUtil.ClearLinePrefixSymbol(arg_46_1.text_)

				local var_49_9 = 62 <= 0 and var_49_6 or var_49_6 * (utf8.len(var_49_7) / 62)

				if (62 <= 0 and var_49_6 or var_49_6 * (utf8.len(var_49_7) / 62)) > 0 and var_49_6 < var_49_9 then
