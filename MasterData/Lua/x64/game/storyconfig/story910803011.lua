return {
	Play910819001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910819001).content)

				arg_1_1.text_.text = var_4_21

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_23 = 2 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_21) / 2)

				if (2 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_21) / 2)) > 0 and var_4_19 < var_4_23 then
	...
	Play910819002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_2 + arg_10_0 then
				...
				local var_10_4 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910819002).content)

				arg_7_1.text_.text = var_10_4

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_6 = 49 <= 0 and var_10_3 or var_10_3 * (utf8.len(var_10_4) / 49)

				if (49 <= 0 and var_10_3 or var_10_3 * (utf8.len(var_10_4) / 49)) > 0 and var_10_3 < var_10_6 then
	...
	Play910819003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910819003).content)
	...
	Play910819004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910819004).content)

				arg_15_1.text_.text = var_18_1

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_3 = 14 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 14)

				if (14 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 14)) > 0 and var_18_0 < var_18_3 then
	...
	Play910819005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				arg_19_1.var_.moveOldPos1111 = arg_19_1.actors_["1111"].transform.localPosition
				arg_19_1.actors_["1111"].transform.localScale = Vector3.New(1, 1, 1)

				arg_19_1:CheckSpriteTmpPos("1111", 3)

				for iter_22_0 = 0, arg_19_1.actors_["1111"].transform.childCount - 1 do
					local var_22_0 = arg_19_1.actors_["1111"].transform:GetChild(iter_22_0)

					if var_22_0.name == "split_3" or not string.find(var_22_0.name, "split") then
			...
			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_1 then
				arg_19_1.actors_["1111"].transform.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos1111, Vector3.New(-100, -290, -350), (arg_19_1.time_ - 0) / var_22_1)
			end

			if arg_19_1.time_ >= 0 + var_22_1 and arg_19_1.time_ < 0 + var_22_1 + arg_22_0 then
				arg_19_1.actors_["1111"].transform.localPosition = Vector3.New(-100, -290, -350)
			end

			local var_22_2 = arg_19_1.actors_["1111"]

			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 and not isNil(var_22_2) and arg_19_1.var_.actorSpriteComps1111 == nil then
				arg_19_1.var_.actorSpriteComps1111 = var_22_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_19_1.time_ >= 0 + var_22_3 and arg_19_1.time_ < 0 + var_22_3 + arg_22_0 and not isNil(var_22_2) and arg_19_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_5 + arg_22_0 then
				...
				local var_22_7 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910819005).content)

				arg_19_1.text_.text = var_22_7

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_9 = 19 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 19)

				if (19 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 19)) > 0 and var_22_6 < var_22_9 then
	...
	Play910819006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 and not isNil(arg_23_1.actors_["1111"]) and arg_23_1.var_.actorSpriteComps1111 == nil then
				arg_23_1.var_.actorSpriteComps1111 = arg_23_1.actors_["1111"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_26_0 = 2

			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_0 and not isNil(arg_23_1.actors_["1111"]) then
			...
			if arg_23_1.time_ >= 0 + var_26_0 and arg_23_1.time_ < 0 + var_26_0 + arg_26_0 and not isNil(arg_23_1.actors_["1111"]) and arg_23_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_2 + arg_26_0 then
				...
				arg_23_1.leftNameTxt_.text = arg_23_1:FormatText(StoryNameCfg[623].name)
				...
				local var_26_4 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910819006).content)

				arg_23_1.text_.text = var_26_4

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_6 = 10 <= 0 and var_26_3 or var_26_3 * (utf8.len(var_26_4) / 10)

				if (10 <= 0 and var_26_3 or var_26_3 * (utf8.len(var_26_4) / 10)) > 0 and var_26_3 < var_26_6 then
	...
	Play910819007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				arg_27_1.var_.moveOldPos1111 = arg_27_1.actors_["1111"].transform.localPosition
				arg_27_1.actors_["1111"].transform.localScale = Vector3.New(1, 1, 1)

				arg_27_1:CheckSpriteTmpPos("1111", 3)

				for iter_30_0 = 0, arg_27_1.actors_["1111"].transform.childCount - 1 do
					local var_30_0 = arg_27_1.actors_["1111"].transform:GetChild(iter_30_0)

					if var_30_0.name == "split_3" or not string.find(var_30_0.name, "split") then
			...
			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_1 then
				arg_27_1.actors_["1111"].transform.localPosition = Vector3.Lerp(arg_27_1.var_.moveOldPos1111, Vector3.New(-100, -290, -350), (arg_27_1.time_ - 0) / var_30_1)
			end

			if arg_27_1.time_ >= 0 + var_30_1 and arg_27_1.time_ < 0 + var_30_1 + arg_30_0 then
				arg_27_1.actors_["1111"].transform.localPosition = Vector3.New(-100, -290, -350)
			end

			local var_30_2 = arg_27_1.actors_["1111"]

			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 and not isNil(var_30_2) and arg_27_1.var_.actorSpriteComps1111 == nil then
				arg_27_1.var_.actorSpriteComps1111 = var_30_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_27_1.time_ >= 0 + var_30_3 and arg_27_1.time_ < 0 + var_30_3 + arg_30_0 and not isNil(var_30_2) and arg_27_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910819007).content)

				arg_27_1.text_.text = var_30_7

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_9 = 9 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 9)

				if (9 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 9)) > 0 and var_30_6 < var_30_9 then
	...
	Play910819008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 and not isNil(arg_31_1.actors_["1111"]) and arg_31_1.var_.actorSpriteComps1111 == nil then
				arg_31_1.var_.actorSpriteComps1111 = arg_31_1.actors_["1111"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_34_0 = 2

			if 0 <= arg_31_1.time_ and arg_31_1.time_ < 0 + var_34_0 and not isNil(arg_31_1.actors_["1111"]) then
			...
			if arg_31_1.time_ >= 0 + var_34_0 and arg_31_1.time_ < 0 + var_34_0 + arg_34_0 and not isNil(arg_31_1.actors_["1111"]) and arg_31_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_2 + arg_34_0 then
				...
				local var_34_4 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910819008).content)

				arg_31_1.text_.text = var_34_4

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_6 = 10 <= 0 and var_34_3 or var_34_3 * (utf8.len(var_34_4) / 10)

				if (10 <= 0 and var_34_3 or var_34_3 * (utf8.len(var_34_4) / 10)) > 0 and var_34_3 < var_34_6 then
	...
	Play910819009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				...
				local var_38_1 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910819009).content)
	...
	Play910819010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910819010).content)

				arg_39_1.text_.text = var_42_7

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_9 = 29 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 29)

				if (29 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 29)) > 0 and var_42_6 < var_42_9 then
	...
	Play910819011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= 0 + arg_46_0 and not isNil(arg_43_1.actors_["1111"]) and arg_43_1.var_.actorSpriteComps1111 == nil then
				arg_43_1.var_.actorSpriteComps1111 = arg_43_1.actors_["1111"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_46_0 = 2

			if 0 <= arg_43_1.time_ and arg_43_1.time_ < 0 + var_46_0 and not isNil(arg_43_1.actors_["1111"]) then
			...
			if arg_43_1.time_ >= 0 + var_46_0 and arg_43_1.time_ < 0 + var_46_0 + arg_46_0 and not isNil(arg_43_1.actors_["1111"]) and arg_43_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_2 + arg_46_0 then
				...
				local var_46_4 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910819011).content)

				arg_43_1.text_.text = var_46_4

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_6 = 10 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 10)

				if (10 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 10)) > 0 and var_46_3 < var_46_6 then
	...
	Play910819012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_5 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910819012).content)

				arg_47_1.text_.text = var_50_7

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_9 = 14 <= 0 and var_50_6 or var_50_6 * (utf8.len(var_50_7) / 14)

				if (14 <= 0 and var_50_6 or var_50_6 * (utf8.len(var_50_7) / 14)) > 0 and var_50_6 < var_50_9 then
	...
	Play910819013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_2 + arg_54_0 then
				...
				local var_54_4 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910819013).content)

				arg_51_1.text_.text = var_54_4

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_6 = 17 <= 0 and var_54_3 or var_54_3 * (utf8.len(var_54_4) / 17)

				if (17 <= 0 and var_54_3 or var_54_3 * (utf8.len(var_54_4) / 17)) > 0 and var_54_3 < var_54_6 then
	...
	Play910819014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= 0 + arg_58_0 then
				...
				local var_58_1 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910819014).content)
	...
	Play910819015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= 0 + arg_62_0 then
				...
				local var_62_1 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(910819015).content)
	...
	Play910819016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= 0 + arg_66_0 then
				...
				local var_66_1 = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(910819016).content)
	...
	Play910819017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_5 + arg_70_0 then
				...
				local var_70_7 = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(910819017).content)

				arg_67_1.text_.text = var_70_7

				LuaForUtil.ClearLinePrefixSymbol(arg_67_1.text_)

				local var_70_9 = 20 <= 0 and var_70_6 or var_70_6 * (utf8.len(var_70_7) / 20)

				if (20 <= 0 and var_70_6 or var_70_6 * (utf8.len(var_70_7) / 20)) > 0 and var_70_6 < var_70_9 then
	...
	Play910819018 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= 0 + arg_74_0 and not isNil(arg_71_1.actors_["1111"]) and arg_71_1.var_.actorSpriteComps1111 == nil then
				arg_71_1.var_.actorSpriteComps1111 = arg_71_1.actors_["1111"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_74_0 = 2

			if 0 <= arg_71_1.time_ and arg_71_1.time_ < 0 + var_74_0 and not isNil(arg_71_1.actors_["1111"]) then
			...
			if arg_71_1.time_ >= 0 + var_74_0 and arg_71_1.time_ < 0 + var_74_0 + arg_74_0 and not isNil(arg_71_1.actors_["1111"]) and arg_71_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_2 + arg_74_0 then
				...
				local var_74_4 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(910819018).content)

				arg_71_1.text_.text = var_74_4

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_6 = 34 <= 0 and var_74_3 or var_74_3 * (utf8.len(var_74_4) / 34)

				if (34 <= 0 and var_74_3 or var_74_3 * (utf8.len(var_74_4) / 34)) > 0 and var_74_3 < var_74_6 then
	...
	Play910819019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			if 0 < arg_75_1.time_ and arg_75_1.time_ <= 0 + arg_78_0 then
				arg_75_1.var_.moveOldPos1111 = arg_75_1.actors_["1111"].transform.localPosition
				arg_75_1.actors_["1111"].transform.localScale = Vector3.New(1, 1, 1)

				arg_75_1:CheckSpriteTmpPos("1111", 3)

				for iter_78_0 = 0, arg_75_1.actors_["1111"].transform.childCount - 1 do
					local var_78_0 = arg_75_1.actors_["1111"].transform:GetChild(iter_78_0)
			...
			if 0 <= arg_75_1.time_ and arg_75_1.time_ < 0 + var_78_1 then
				arg_75_1.actors_["1111"].transform.localPosition = Vector3.Lerp(arg_75_1.var_.moveOldPos1111, Vector3.New(-100, -290, -350), (arg_75_1.time_ - 0) / var_78_1)
			end

			if arg_75_1.time_ >= 0 + var_78_1 and arg_75_1.time_ < 0 + var_78_1 + arg_78_0 then
				arg_75_1.actors_["1111"].transform.localPosition = Vector3.New(-100, -290, -350)
			end

			local var_78_2 = arg_75_1.actors_["1111"]

			if 0 < arg_75_1.time_ and arg_75_1.time_ <= 0 + arg_78_0 and not isNil(var_78_2) and arg_75_1.var_.actorSpriteComps1111 == nil then
				arg_75_1.var_.actorSpriteComps1111 = var_78_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_75_1.time_ >= 0 + var_78_3 and arg_75_1.time_ < 0 + var_78_3 + arg_78_0 and not isNil(var_78_2) and arg_75_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_75_1.time_ and arg_75_1.time_ <= var_78_5 + arg_78_0 then
				...
				local var_78_7 = arg_75_1:FormatText(arg_75_1:GetWordFromCfg(910819019).content)

				arg_75_1.text_.text = var_78_7

				LuaForUtil.ClearLinePrefixSymbol(arg_75_1.text_)

				local var_78_9 = 21 <= 0 and var_78_6 or var_78_6 * (utf8.len(var_78_7) / 21)

				if (21 <= 0 and var_78_6 or var_78_6 * (utf8.len(var_78_7) / 21)) > 0 and var_78_6 < var_78_9 then
	...
	Play910819020 = function(arg_79_0, arg_79_1)
		...
		function arg_79_1.onSingleLineUpdate_(arg_82_0)
			if 0 < arg_79_1.time_ and arg_79_1.time_ <= 0 + arg_82_0 and not isNil(arg_79_1.actors_["1111"]) and arg_79_1.var_.actorSpriteComps1111 == nil then
				arg_79_1.var_.actorSpriteComps1111 = arg_79_1.actors_["1111"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_82_0 = 2

			if 0 <= arg_79_1.time_ and arg_79_1.time_ < 0 + var_82_0 and not isNil(arg_79_1.actors_["1111"]) then
			...
			if arg_79_1.time_ >= 0 + var_82_0 and arg_79_1.time_ < 0 + var_82_0 + arg_82_0 and not isNil(arg_79_1.actors_["1111"]) and arg_79_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_79_1.time_ and arg_79_1.time_ <= var_82_2 + arg_82_0 then
				...
				local var_82_4 = arg_79_1:FormatText(arg_79_1:GetWordFromCfg(910819020).content)

				arg_79_1.text_.text = var_82_4

				LuaForUtil.ClearLinePrefixSymbol(arg_79_1.text_)

				local var_82_6 = 13 <= 0 and var_82_3 or var_82_3 * (utf8.len(var_82_4) / 13)

				if (13 <= 0 and var_82_3 or var_82_3 * (utf8.len(var_82_4) / 13)) > 0 and var_82_3 < var_82_6 then
	...
	Play910819021 = function(arg_83_0, arg_83_1)
		...
		function arg_83_1.onSingleLineUpdate_(arg_86_0)
			if 0 < arg_83_1.time_ and arg_83_1.time_ <= 0 + arg_86_0 then
				arg_83_1.var_.moveOldPos1111 = arg_83_1.actors_["1111"].transform.localPosition
				arg_83_1.actors_["1111"].transform.localScale = Vector3.New(1, 1, 1)

				arg_83_1:CheckSpriteTmpPos("1111", 3)

				for iter_86_0 = 0, arg_83_1.actors_["1111"].transform.childCount - 1 do
					local var_86_0 = arg_83_1.actors_["1111"].transform:GetChild(iter_86_0)
			...
			if 0 <= arg_83_1.time_ and arg_83_1.time_ < 0 + var_86_1 then
				arg_83_1.actors_["1111"].transform.localPosition = Vector3.Lerp(arg_83_1.var_.moveOldPos1111, Vector3.New(-100, -290, -350), (arg_83_1.time_ - 0) / var_86_1)
			end

			if arg_83_1.time_ >= 0 + var_86_1 and arg_83_1.time_ < 0 + var_86_1 + arg_86_0 then
				arg_83_1.actors_["1111"].transform.localPosition = Vector3.New(-100, -290, -350)
			end

			local var_86_2 = arg_83_1.actors_["1111"]

			if 0 < arg_83_1.time_ and arg_83_1.time_ <= 0 + arg_86_0 and not isNil(var_86_2) and arg_83_1.var_.actorSpriteComps1111 == nil then
				arg_83_1.var_.actorSpriteComps1111 = var_86_2:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_83_1.time_ >= 0 + var_86_3 and arg_83_1.time_ < 0 + var_86_3 + arg_86_0 and not isNil(var_86_2) and arg_83_1.var_.actorSpriteComps1111 then
			...
			if 0 < arg_83_1.time_ and arg_83_1.time_ <= var_86_6 + arg_86_0 then
				...
				local var_86_8 = arg_83_1:FormatText(arg_83_1:GetWordFromCfg(910819021).content)

				arg_83_1.text_.text = var_86_8

				LuaForUtil.ClearLinePrefixSymbol(arg_83_1.text_)

				local var_86_10 = 11 <= 0 and var_86_7 or var_86_7 * (utf8.len(var_86_8) / 11)

				if (11 <= 0 and var_86_7 or var_86_7 * (utf8.len(var_86_8) / 11)) > 0 and var_86_7 < var_86_10 then
