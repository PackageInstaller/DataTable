return {
	Play320711001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.8 <= arg_1_1.time_ and arg_1_1.time_ < 1.8 + var_4_14 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1089ui_story, Vector3.New(-0.7, -1.1, -6.17), (arg_1_1.time_ - 1.8) / var_4_14)
			...
			if arg_1_1.time_ >= 1.8 + var_4_14 and arg_1_1.time_ < 1.8 + var_4_14 + arg_4_0 then
				var_4_13.localPosition = Vector3.New(-0.7, -1.1, -6.17)
				var_4_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_13.position).x, (manager.ui.mainCamera.transform.position - var_4_13.position).y, (manager.ui.mainCamera.transform.position - var_4_13.position).z)
				var_4_13.localEulerAngles.z = 0
				var_4_13.localEulerAngles.x = 0
				var_4_13.localEulerAngles = var_4_13.localEulerAngles
			...
			if 2.00000000298023 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				local var_4_27 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(320711001).content)

				arg_1_1.text_.text = var_4_27

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_29 = 17 <= 0 and var_4_25 or var_4_25 * (utf8.len(var_4_27) / 17)

				if (17 <= 0 and var_4_25 or var_4_25 * (utf8.len(var_4_27) / 17)) > 0 and var_4_25 < var_4_29 then
	...
	Play320711002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			if arg_9_1.actors_["1020ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1020ui_story"))) then
				local var_12_0 = Object.Instantiate(Asset.Load("Char/" .. "1020ui_story"), arg_9_1.stage_.transform)

				var_12_0.name = "1020ui_story"
				var_12_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_9_1.actors_["1020ui_story"] = var_12_0
				...
				arg_9_1.var_["1020ui_story" .. "Animator"] = var_12_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_9_1.var_["1020ui_story" .. "Animator"].applyRootMotion = true
				arg_9_1.var_["1020ui_story" .. "LipSync"] = var_12_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_12_3 = arg_9_1.actors_["1020ui_story"].transform

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				arg_9_1.var_.moveOldPos1020ui_story = var_12_3.localPosition
			end

			local var_12_4 = 0.001

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_4 then
				var_12_3.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1020ui_story, Vector3.New(0.7, -0.85, -6.25), (arg_9_1.time_ - 0) / var_12_4)
			...
			if arg_9_1.time_ >= 0 + var_12_4 and arg_9_1.time_ < 0 + var_12_4 + arg_12_0 then
				var_12_3.localPosition = Vector3.New(0.7, -0.85, -6.25)
				var_12_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_12_3.position).x, (manager.ui.mainCamera.transform.position - var_12_3.position).y, (manager.ui.mainCamera.transform.position - var_12_3.position).z)
				var_12_3.localEulerAngles.z = 0
				var_12_3.localEulerAngles.x = 0
				var_12_3.localEulerAngles = var_12_3.localEulerAngles
			...
			local var_12_5 = arg_9_1.actors_["1020ui_story"]

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(var_12_5) and arg_9_1.var_.characterEffect1020ui_story == nil then
				arg_9_1.var_.characterEffect1020ui_story = var_12_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_6 = 0.200000002980232

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_6 and not isNil(var_12_5) then
				if arg_9_1.var_.characterEffect1020ui_story and not isNil(var_12_5) then
					arg_9_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_9_1.time_ >= 0 + var_12_6 and arg_9_1.time_ < 0 + var_12_6 + arg_12_0 and not isNil(var_12_5) and arg_9_1.var_.characterEffect1020ui_story then
				arg_9_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			local var_12_8 = arg_9_1.actors_["1089ui_story"]

			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 and not isNil(var_12_8) and arg_9_1.var_.characterEffect1089ui_story == nil then
				arg_9_1.var_.characterEffect1089ui_story = var_12_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_12_9 = 0.200000002980232

			if 0 <= arg_9_1.time_ and arg_9_1.time_ < 0 + var_12_9 and not isNil(var_12_8) then
				if arg_9_1.var_.characterEffect1089ui_story and not isNil(var_12_8) then
					arg_9_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_9_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_9_1.time_ - 0) / var_12_9)
				end
			end

			if arg_9_1.time_ >= 0 + var_12_9 and arg_9_1.time_ < 0 + var_12_9 + arg_12_0 and not isNil(var_12_8) and arg_9_1.var_.characterEffect1089ui_story then
				arg_9_1.var_.characterEffect1089ui_story.fillFlat = true
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_10 + arg_12_0 then
				...
				local var_12_12 = arg_9_1:FormatText(arg_9_1:GetWordFromCfg(320711002).content)
	...
	Play320711003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_4 then
				var_16_3.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1056ui_story, Vector3.New(0.7, -1, -5.75), (arg_13_1.time_ - 0) / var_16_4)
			...
			if arg_13_1.time_ >= 0 + var_16_4 and arg_13_1.time_ < 0 + var_16_4 + arg_16_0 then
				var_16_3.localPosition = Vector3.New(0.7, -1, -5.75)
				var_16_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_16_3.position).x, (manager.ui.mainCamera.transform.position - var_16_3.position).y, (manager.ui.mainCamera.transform.position - var_16_3.position).z)
				var_16_3.localEulerAngles.z = 0
				var_16_3.localEulerAngles.x = 0
				var_16_3.localEulerAngles = var_16_3.localEulerAngles
			...
			local var_16_8 = arg_13_1.actors_["1020ui_story"].transform

			if 0 < arg_13_1.time_ and arg_13_1.time_ <= 0 + arg_16_0 then
				arg_13_1.var_.moveOldPos1020ui_story = var_16_8.localPosition
			end

			local var_16_9 = 0.001

			if 0 <= arg_13_1.time_ and arg_13_1.time_ < 0 + var_16_9 then
				var_16_8.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1020ui_story, Vector3.New(0, 100, 0), (arg_13_1.time_ - 0) / var_16_9)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_10 + arg_16_0 then
				...
				local var_16_12 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(320711003).content)

				arg_13_1.text_.text = var_16_12

				LuaForUtil.ClearLinePrefixSymbol(arg_13_1.text_)

				local var_16_14 = 15 <= 0 and var_16_11 or var_16_11 * (utf8.len(var_16_12) / 15)

				if (15 <= 0 and var_16_11 or var_16_11 * (utf8.len(var_16_12) / 15)) > 0 and var_16_11 < var_16_14 then
					arg_13_1.talkMaxDuration = var_16_14

					if var_16_14 + var_16_10 > arg_13_1.duration_ then
						arg_13_1.duration_ = var_16_14 + var_16_10
					end
				end
			...
			local var_16_15 = math.max(var_16_11, arg_13_1.talkMaxDuration)

			if var_16_10 <= arg_13_1.time_ and arg_13_1.time_ < var_16_10 + var_16_15 then
				arg_13_1.typewritter.percent = (arg_13_1.time_ - var_16_10) / var_16_15

				arg_13_1.typewritter:SetDirty()
			end

			if arg_13_1.time_ >= var_16_10 + var_16_15 and arg_13_1.time_ < var_16_10 + var_16_15 + arg_16_0 then
	...
	Play320711004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			local var_20_4 = arg_17_1.actors_["1056ui_story"]

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(var_20_4) and arg_17_1.var_.characterEffect1056ui_story == nil then
				arg_17_1.var_.characterEffect1056ui_story = var_20_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_5 = 0.200000002980232

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_5 and not isNil(var_20_4) then
				if arg_17_1.var_.characterEffect1056ui_story and not isNil(var_20_4) then
					arg_17_1.var_.characterEffect1056ui_story.fillFlat = true
					arg_17_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_17_1.time_ - 0) / var_20_5)
				end
			end

			if arg_17_1.time_ >= 0 + var_20_5 and arg_17_1.time_ < 0 + var_20_5 + arg_20_0 and not isNil(var_20_4) and arg_17_1.var_.characterEffect1056ui_story then
				arg_17_1.var_.characterEffect1056ui_story.fillFlat = true
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_8 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(320711004).content)
	...
	Play320711005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			local var_24_2 = arg_21_1.actors_["1089ui_story"]

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(var_24_2) and arg_21_1.var_.characterEffect1089ui_story == nil then
				arg_21_1.var_.characterEffect1089ui_story = var_24_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_24_3 = 0.200000002980232

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_3 and not isNil(var_24_2) then
				if arg_21_1.var_.characterEffect1089ui_story and not isNil(var_24_2) then
					arg_21_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_21_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_21_1.time_ - 0) / var_24_3)
				end
			end

			if arg_21_1.time_ >= 0 + var_24_3 and arg_21_1.time_ < 0 + var_24_3 + arg_24_0 and not isNil(var_24_2) and arg_21_1.var_.characterEffect1089ui_story then
				arg_21_1.var_.characterEffect1089ui_story.fillFlat = true
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_4 + arg_24_0 then
				...
				local var_24_6 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(320711005).content)

				arg_21_1.text_.text = var_24_6

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_8 = 13 <= 0 and var_24_5 or var_24_5 * (utf8.len(var_24_6) / 13)

				if (13 <= 0 and var_24_5 or var_24_5 * (utf8.len(var_24_6) / 13)) > 0 and var_24_5 < var_24_8 then
	...
	Play320711006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			local var_28_1 = arg_25_1.actors_["1089ui_story"].transform

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 then
				arg_25_1.var_.moveOldPos1089ui_story = var_28_1.localPosition
			end

			local var_28_2 = 0.001

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_2 then
				var_28_1.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos1089ui_story, Vector3.New(0, 100, 0), (arg_25_1.time_ - 0) / var_28_2)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_3 + arg_28_0 then
				...
				local var_28_5 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(320711006).content)
	...
	Play320711007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 then
				arg_29_1.var_.moveOldPos1089ui_story = arg_29_1.actors_["1089ui_story"].transform.localPosition
			end

			local var_32_0 = 0.001

			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_0 then
				arg_29_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1089ui_story, Vector3.New(0, -1.1, -6.17), (arg_29_1.time_ - 0) / var_32_0)
				arg_29_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_29_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_29_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_29_1.actors_["1089ui_story"].transform.position).z)
				arg_29_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_29_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_29_1.actors_["1089ui_story"].transform.localEulerAngles = arg_29_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_29_1.time_ >= 0 + var_32_0 and arg_29_1.time_ < 0 + var_32_0 + arg_32_0 then
				arg_29_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(0, -1.1, -6.17)
				arg_29_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_29_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_29_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_29_1.actors_["1089ui_story"].transform.position).z)
				arg_29_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_29_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_29_1.actors_["1089ui_story"].transform.localEulerAngles = arg_29_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_32_1 = arg_29_1.actors_["1089ui_story"]

			if 0 < arg_29_1.time_ and arg_29_1.time_ <= 0 + arg_32_0 and not isNil(var_32_1) and arg_29_1.var_.characterEffect1089ui_story == nil then
				arg_29_1.var_.characterEffect1089ui_story = var_32_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_32_2 = 0.200000002980232

			if 0 <= arg_29_1.time_ and arg_29_1.time_ < 0 + var_32_2 and not isNil(var_32_1) then
				if arg_29_1.var_.characterEffect1089ui_story and not isNil(var_32_1) then
					arg_29_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_29_1.time_ >= 0 + var_32_2 and arg_29_1.time_ < 0 + var_32_2 + arg_32_0 and not isNil(var_32_1) and arg_29_1.var_.characterEffect1089ui_story then
				arg_29_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_4 + arg_32_0 then
				...
				local var_32_6 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(320711007).content)

				arg_29_1.text_.text = var_32_6

				LuaForUtil.ClearLinePrefixSymbol(arg_29_1.text_)

				local var_32_8 = 13 <= 0 and var_32_5 or var_32_5 * (utf8.len(var_32_6) / 13)

				if (13 <= 0 and var_32_5 or var_32_5 * (utf8.len(var_32_6) / 13)) > 0 and var_32_5 < var_32_8 then
	...
	Play320711008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_1 + arg_36_0 then
				...
				local var_36_3 = arg_33_1:FormatText(arg_33_1:GetWordFromCfg(320711008).content)

				arg_33_1.text_.text = var_36_3

				LuaForUtil.ClearLinePrefixSymbol(arg_33_1.text_)

				local var_36_5 = 12 <= 0 and var_36_2 or var_36_2 * (utf8.len(var_36_3) / 12)

				if (12 <= 0 and var_36_2 or var_36_2 * (utf8.len(var_36_3) / 12)) > 0 and var_36_2 < var_36_5 then
	...
	Play320711009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			local var_40_3 = arg_37_1.actors_["1020ui_story"].transform

			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				arg_37_1.var_.moveOldPos1020ui_story = var_40_3.localPosition
			end

			local var_40_4 = 0.001

			if 0 <= arg_37_1.time_ and arg_37_1.time_ < 0 + var_40_4 then
				var_40_3.localPosition = Vector3.Lerp(arg_37_1.var_.moveOldPos1020ui_story, Vector3.New(0, -0.85, -6.25), (arg_37_1.time_ - 0) / var_40_4)
			...
			if arg_37_1.time_ >= 0 + var_40_4 and arg_37_1.time_ < 0 + var_40_4 + arg_40_0 then
				var_40_3.localPosition = Vector3.New(0, -0.85, -6.25)
				var_40_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_40_3.position).x, (manager.ui.mainCamera.transform.position - var_40_3.position).y, (manager.ui.mainCamera.transform.position - var_40_3.position).z)
				var_40_3.localEulerAngles.z = 0
				var_40_3.localEulerAngles.x = 0
				var_40_3.localEulerAngles = var_40_3.localEulerAngles
			...
			local var_40_5 = arg_37_1.actors_["1020ui_story"]

			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 and not isNil(var_40_5) and arg_37_1.var_.characterEffect1020ui_story == nil then
				arg_37_1.var_.characterEffect1020ui_story = var_40_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_40_6 = 0.200000002980232

			if 0 <= arg_37_1.time_ and arg_37_1.time_ < 0 + var_40_6 and not isNil(var_40_5) then
				if arg_37_1.var_.characterEffect1020ui_story and not isNil(var_40_5) then
					arg_37_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_37_1.time_ >= 0 + var_40_6 and arg_37_1.time_ < 0 + var_40_6 + arg_40_0 and not isNil(var_40_5) and arg_37_1.var_.characterEffect1020ui_story then
				arg_37_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_8 + arg_40_0 then
				...
				local var_40_10 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(320711009).content)

				arg_37_1.text_.text = var_40_10

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_12 = 15 <= 0 and var_40_9 or var_40_9 * (utf8.len(var_40_10) / 15)

				if (15 <= 0 and var_40_9 or var_40_9 * (utf8.len(var_40_10) / 15)) > 0 and var_40_9 < var_40_12 then
	...
	Play320711010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(320711010).content)
	...
	Play320711011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_0 then
				arg_45_1.actors_["1056ui_story"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1056ui_story, Vector3.New(0.7, -1, -5.75), (arg_45_1.time_ - 0) / var_48_0)
			...
			if arg_45_1.time_ >= 0 + var_48_0 and arg_45_1.time_ < 0 + var_48_0 + arg_48_0 then
				arg_45_1.actors_["1056ui_story"].transform.localPosition = Vector3.New(0.7, -1, -5.75)
				arg_45_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1056ui_story"].transform.position).z)
				arg_45_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["1056ui_story"].transform.localEulerAngles = arg_45_1.actors_["1056ui_story"].transform.localEulerAngles
			...
			local var_48_1 = arg_45_1.actors_["1056ui_story"]

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 and not isNil(var_48_1) and arg_45_1.var_.characterEffect1056ui_story == nil then
				arg_45_1.var_.characterEffect1056ui_story = var_48_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_48_2 = 0.200000002980232

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_2 and not isNil(var_48_1) then
				if arg_45_1.var_.characterEffect1056ui_story and not isNil(var_48_1) then
					arg_45_1.var_.characterEffect1056ui_story.fillFlat = false
				end
			end

			if arg_45_1.time_ >= 0 + var_48_2 and arg_45_1.time_ < 0 + var_48_2 + arg_48_0 and not isNil(var_48_1) and arg_45_1.var_.characterEffect1056ui_story then
				arg_45_1.var_.characterEffect1056ui_story.fillFlat = false
			end
			...
			local var_48_4 = arg_45_1.actors_["1020ui_story"].transform

			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1020ui_story = var_48_4.localPosition
			end

			local var_48_5 = 0.001

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_5 then
				var_48_4.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1020ui_story, Vector3.New(-0.7, -0.85, -6.25), (arg_45_1.time_ - 0) / var_48_5)
			...
			if arg_45_1.time_ >= 0 + var_48_5 and arg_45_1.time_ < 0 + var_48_5 + arg_48_0 then
				var_48_4.localPosition = Vector3.New(-0.7, -0.85, -6.25)
				var_48_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_48_4.position).x, (manager.ui.mainCamera.transform.position - var_48_4.position).y, (manager.ui.mainCamera.transform.position - var_48_4.position).z)
				var_48_4.localEulerAngles.z = 0
				var_48_4.localEulerAngles.x = 0
				var_48_4.localEulerAngles = var_48_4.localEulerAngles
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_6 + arg_48_0 then
				...
				local var_48_8 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(320711011).content)

				arg_45_1.text_.text = var_48_8

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_10 = 16 <= 0 and var_48_7 or var_48_7 * (utf8.len(var_48_8) / 16)

				if (16 <= 0 and var_48_7 or var_48_7 * (utf8.len(var_48_8) / 16)) > 0 and var_48_7 < var_48_10 then
	...
	Play320711012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				...
				local var_52_1 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(320711012).content)
	...
	Play320711013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_0 + arg_56_0 then
				...
				local var_56_2 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(320711013).content)

				arg_53_1.text_.text = var_56_2

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_4 = 40 <= 0 and var_56_1 or var_56_1 * (utf8.len(var_56_2) / 40)

				if (40 <= 0 and var_56_1 or var_56_1 * (utf8.len(var_56_2) / 40)) > 0 and var_56_1 < var_56_4 then
	...
	Play320711014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			local var_60_3 = arg_57_1.actors_["1089ui_story"].transform

			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1.var_.moveOldPos1089ui_story = var_60_3.localPosition

				arg_57_1:ShowWeapon(arg_57_1.var_["1089ui_story" .. "Animator"].transform, false)
			end

			local var_60_4 = 0.001

			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_4 then
				var_60_3.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos1089ui_story, Vector3.New(-0.7, -1.1, -6.17), (arg_57_1.time_ - 0) / var_60_4)
			...
			if arg_57_1.time_ >= 0 + var_60_4 and arg_57_1.time_ < 0 + var_60_4 + arg_60_0 then
				var_60_3.localPosition = Vector3.New(-0.7, -1.1, -6.17)
				var_60_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_60_3.position).x, (manager.ui.mainCamera.transform.position - var_60_3.position).y, (manager.ui.mainCamera.transform.position - var_60_3.position).z)
				var_60_3.localEulerAngles.z = 0
				var_60_3.localEulerAngles.x = 0
				var_60_3.localEulerAngles = var_60_3.localEulerAngles
			...
			local var_60_5 = arg_57_1.actors_["1089ui_story"]

			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 and not isNil(var_60_5) and arg_57_1.var_.characterEffect1089ui_story == nil then
				arg_57_1.var_.characterEffect1089ui_story = var_60_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_60_6 = 0.200000002980232

			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_6 and not isNil(var_60_5) then
				if arg_57_1.var_.characterEffect1089ui_story and not isNil(var_60_5) then
					arg_57_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_57_1.time_ >= 0 + var_60_6 and arg_57_1.time_ < 0 + var_60_6 + arg_60_0 and not isNil(var_60_5) and arg_57_1.var_.characterEffect1089ui_story then
				arg_57_1.var_.characterEffect1089ui_story.fillFlat = false
			end
			...
			local var_60_8 = arg_57_1.actors_["1056ui_story"]

			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 and not isNil(var_60_8) and arg_57_1.var_.characterEffect1056ui_story == nil then
				arg_57_1.var_.characterEffect1056ui_story = var_60_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_60_9 = 0.200000002980232

			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_9 and not isNil(var_60_8) then
				if arg_57_1.var_.characterEffect1056ui_story and not isNil(var_60_8) then
					arg_57_1.var_.characterEffect1056ui_story.fillFlat = true
					arg_57_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_57_1.time_ - 0) / var_60_9)
				end
			end

			if arg_57_1.time_ >= 0 + var_60_9 and arg_57_1.time_ < 0 + var_60_9 + arg_60_0 and not isNil(var_60_8) and arg_57_1.var_.characterEffect1056ui_story then
				arg_57_1.var_.characterEffect1056ui_story.fillFlat = true
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_10 + arg_60_0 then
				...
				local var_60_12 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(320711014).content)
	...
	Play320711015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_4 + arg_64_0 then
				...
				local var_64_6 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(320711015).content)

				arg_61_1.text_.text = var_64_6

				LuaForUtil.ClearLinePrefixSymbol(arg_61_1.text_)

				local var_64_8 = 15 <= 0 and var_64_5 or var_64_5 * (utf8.len(var_64_6) / 15)

				if (15 <= 0 and var_64_5 or var_64_5 * (utf8.len(var_64_6) / 15)) > 0 and var_64_5 < var_64_8 then
	...
	Play320711016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				arg_65_1.var_.moveOldPos1089ui_story = arg_65_1.actors_["1089ui_story"].transform.localPosition
			end

			local var_68_0 = 0.001

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_0 then
				arg_65_1.actors_["1089ui_story"].transform.localPosition = Vector3.Lerp(arg_65_1.var_.moveOldPos1089ui_story, Vector3.New(-0.7, -1.1, -6.17), (arg_65_1.time_ - 0) / var_68_0)
				arg_65_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_65_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_65_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_65_1.actors_["1089ui_story"].transform.position).z)
				arg_65_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_65_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_65_1.actors_["1089ui_story"].transform.localEulerAngles = arg_65_1.actors_["1089ui_story"].transform.localEulerAngles
			end

			if arg_65_1.time_ >= 0 + var_68_0 and arg_65_1.time_ < 0 + var_68_0 + arg_68_0 then
				arg_65_1.actors_["1089ui_story"].transform.localPosition = Vector3.New(-0.7, -1.1, -6.17)
				arg_65_1.actors_["1089ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_65_1.actors_["1089ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_65_1.actors_["1089ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_65_1.actors_["1089ui_story"].transform.position).z)
				arg_65_1.actors_["1089ui_story"].transform.localEulerAngles.z = 0
				arg_65_1.actors_["1089ui_story"].transform.localEulerAngles.x = 0
				arg_65_1.actors_["1089ui_story"].transform.localEulerAngles = arg_65_1.actors_["1089ui_story"].transform.localEulerAngles
			...
			local var_68_1 = arg_65_1.actors_["1089ui_story"]

			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 and not isNil(var_68_1) and arg_65_1.var_.characterEffect1089ui_story == nil then
				arg_65_1.var_.characterEffect1089ui_story = var_68_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_68_2 = 0.200000002980232

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_2 and not isNil(var_68_1) then
				if arg_65_1.var_.characterEffect1089ui_story and not isNil(var_68_1) then
					arg_65_1.var_.characterEffect1089ui_story.fillFlat = false
				end
			end

			if arg_65_1.time_ >= 0 + var_68_2 and arg_65_1.time_ < 0 + var_68_2 + arg_68_0 and not isNil(var_68_1) and arg_65_1.var_.characterEffect1089ui_story then
				arg_65_1.var_.characterEffect1089ui_story.fillFlat = false
			end

			local var_68_4 = arg_65_1.actors_["1056ui_story"]

			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 and not isNil(var_68_4) and arg_65_1.var_.characterEffect1056ui_story == nil then
				arg_65_1.var_.characterEffect1056ui_story = var_68_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_68_5 = 0.200000002980232

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_5 and not isNil(var_68_4) then
				if arg_65_1.var_.characterEffect1056ui_story and not isNil(var_68_4) then
					arg_65_1.var_.characterEffect1056ui_story.fillFlat = true
					arg_65_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_65_1.time_ - 0) / var_68_5)
				end
			end

			if arg_65_1.time_ >= 0 + var_68_5 and arg_65_1.time_ < 0 + var_68_5 + arg_68_0 and not isNil(var_68_4) and arg_65_1.var_.characterEffect1056ui_story then
				arg_65_1.var_.characterEffect1056ui_story.fillFlat = true
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_6 + arg_68_0 then
				...
				local var_68_8 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(320711016).content)

				arg_65_1.text_.text = var_68_8

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_10 = 34 <= 0 and var_68_7 or var_68_7 * (utf8.len(var_68_8) / 34)

				if (34 <= 0 and var_68_7 or var_68_7 * (utf8.len(var_68_8) / 34)) > 0 and var_68_7 < var_68_10 then
	...
	Play320711017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_0 + arg_72_0 then
				...
				arg_69_1.leftNameTxt_.text = arg_69_1:FormatText(StoryNameCfg[1031].name)
				...
				local var_72_2 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(320711017).content)

				arg_69_1.text_.text = var_72_2

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_4 = 42 <= 0 and var_72_1 or var_72_1 * (utf8.len(var_72_2) / 42)

				if (42 <= 0 and var_72_1 or var_72_1 * (utf8.len(var_72_2) / 42)) > 0 and var_72_1 < var_72_4 then
	...
	Play320711018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 and not isNil(arg_73_1.actors_["1056ui_story"]) and arg_73_1.var_.characterEffect1056ui_story == nil then
				arg_73_1.var_.characterEffect1056ui_story = arg_73_1.actors_["1056ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_76_0 = 0.200000002980232

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_0 and not isNil(arg_73_1.actors_["1056ui_story"]) then
				if arg_73_1.var_.characterEffect1056ui_story and not isNil(arg_73_1.actors_["1056ui_story"]) then
					arg_73_1.var_.characterEffect1056ui_story.fillFlat = false
				end
			end

			if arg_73_1.time_ >= 0 + var_76_0 and arg_73_1.time_ < 0 + var_76_0 + arg_76_0 and not isNil(arg_73_1.actors_["1056ui_story"]) and arg_73_1.var_.characterEffect1056ui_story then
				arg_73_1.var_.characterEffect1056ui_story.fillFlat = false
			end
			...
			local var_76_2 = arg_73_1.actors_["1089ui_story"]

			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 and not isNil(var_76_2) and arg_73_1.var_.characterEffect1089ui_story == nil then
				arg_73_1.var_.characterEffect1089ui_story = var_76_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_76_3 = 0.200000002980232

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_3 and not isNil(var_76_2) then
				if arg_73_1.var_.characterEffect1089ui_story and not isNil(var_76_2) then
					arg_73_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_73_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_73_1.time_ - 0) / var_76_3)
				end
			end

			if arg_73_1.time_ >= 0 + var_76_3 and arg_73_1.time_ < 0 + var_76_3 + arg_76_0 and not isNil(var_76_2) and arg_73_1.var_.characterEffect1089ui_story then
				arg_73_1.var_.characterEffect1089ui_story.fillFlat = true
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_4 + arg_76_0 then
				...
				local var_76_6 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(320711018).content)

				arg_73_1.text_.text = var_76_6

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_8 = 32 <= 0 and var_76_5 or var_76_5 * (utf8.len(var_76_6) / 32)

				if (32 <= 0 and var_76_5 or var_76_5 * (utf8.len(var_76_6) / 32)) > 0 and var_76_5 < var_76_8 then
	...
	Play320711019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_0 then
				arg_77_1.actors_["1056ui_story"].transform.localPosition = Vector3.Lerp(arg_77_1.var_.moveOldPos1056ui_story, Vector3.New(0, 100, 0), (arg_77_1.time_ - 0) / var_80_0)
			...
			if arg_77_1.time_ >= 0 + var_80_0 and arg_77_1.time_ < 0 + var_80_0 + arg_80_0 then
				arg_77_1.actors_["1056ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_77_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["1056ui_story"].transform.position).z)
				arg_77_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["1056ui_story"].transform.localEulerAngles = arg_77_1.actors_["1056ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_2 and not isNil(var_80_1) then
				if arg_77_1.var_.characterEffect1056ui_story and not isNil(var_80_1) then
					...
					arg_77_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_77_1.time_ - 0) / var_80_2)
				end
			end
			...
			local var_80_3 = arg_77_1.actors_["1089ui_story"].transform

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				arg_77_1.var_.moveOldPos1089ui_story = var_80_3.localPosition
			end

			local var_80_4 = 0.001

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_4 then
				var_80_3.localPosition = Vector3.Lerp(arg_77_1.var_.moveOldPos1089ui_story, Vector3.New(0, 100, 0), (arg_77_1.time_ - 0) / var_80_4)
			...
			local var_80_5 = arg_77_1.actors_["1089ui_story"]

			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 and not isNil(var_80_5) and arg_77_1.var_.characterEffect1089ui_story == nil then
				arg_77_1.var_.characterEffect1089ui_story = var_80_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_80_6 = 0.200000002980232

			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_6 and not isNil(var_80_5) then
				if arg_77_1.var_.characterEffect1089ui_story and not isNil(var_80_5) then
					arg_77_1.var_.characterEffect1089ui_story.fillFlat = true
					arg_77_1.var_.characterEffect1089ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_77_1.time_ - 0) / var_80_6)
				end
			end

			if arg_77_1.time_ >= 0 + var_80_6 and arg_77_1.time_ < 0 + var_80_6 + arg_80_0 and not isNil(var_80_5) and arg_77_1.var_.characterEffect1089ui_story then
				arg_77_1.var_.characterEffect1089ui_story.fillFlat = true
				arg_77_1.var_.characterEffect1089ui_story.fillRatio = 0.5
			end

			local var_80_7 = 0
			local var_80_8 = 0.875
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_7 + arg_80_0 then
				...
				local var_80_9 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(320711019).content)

				arg_77_1.text_.text = var_80_9

				LuaForUtil.ClearLinePrefixSymbol(arg_77_1.text_)

				local var_80_11 = 35 <= 0 and var_80_8 or var_80_8 * (utf8.len(var_80_9) / 35)

				if (35 <= 0 and var_80_8 or var_80_8 * (utf8.len(var_80_9) / 35)) > 0 and var_80_8 < var_80_11 then
	...
	Play320711020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= 0 + arg_84_0 then
				...
				local var_84_1 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(320711020).content)
	...
	Play320711021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				...
				local var_88_1 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(320711021).content)

				arg_85_1.text_.text = var_88_1

				LuaForUtil.ClearLinePrefixSymbol(arg_85_1.text_)

				local var_88_3 = 22 <= 0 and var_88_0 or var_88_0 * (utf8.len(var_88_1) / 22)

				if (22 <= 0 and var_88_0 or var_88_0 * (utf8.len(var_88_1) / 22)) > 0 and var_88_0 < var_88_3 then
	...
	Play320711022 = function(arg_89_0, arg_89_1)
		...
		function arg_89_1.onSingleLineUpdate_(arg_92_0)
			...
			if 0 <= arg_89_1.time_ and arg_89_1.time_ < 0 + var_92_0 then
				arg_89_1.actors_["1056ui_story"].transform.localPosition = Vector3.Lerp(arg_89_1.var_.moveOldPos1056ui_story, Vector3.New(0, -1, -5.75), (arg_89_1.time_ - 0) / var_92_0)
			...
			if arg_89_1.time_ >= 0 + var_92_0 and arg_89_1.time_ < 0 + var_92_0 + arg_92_0 then
				arg_89_1.actors_["1056ui_story"].transform.localPosition = Vector3.New(0, -1, -5.75)
				arg_89_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_89_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_89_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_89_1.actors_["1056ui_story"].transform.position).z)
				arg_89_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_89_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_89_1.actors_["1056ui_story"].transform.localEulerAngles = arg_89_1.actors_["1056ui_story"].transform.localEulerAngles
			...
			local var_92_1 = arg_89_1.actors_["1056ui_story"]

			if 0 < arg_89_1.time_ and arg_89_1.time_ <= 0 + arg_92_0 and not isNil(var_92_1) and arg_89_1.var_.characterEffect1056ui_story == nil then
				arg_89_1.var_.characterEffect1056ui_story = var_92_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_92_2 = 0.200000002980232

			if 0 <= arg_89_1.time_ and arg_89_1.time_ < 0 + var_92_2 and not isNil(var_92_1) then
				if arg_89_1.var_.characterEffect1056ui_story and not isNil(var_92_1) then
					arg_89_1.var_.characterEffect1056ui_story.fillFlat = false
				end
			end

			if arg_89_1.time_ >= 0 + var_92_2 and arg_89_1.time_ < 0 + var_92_2 + arg_92_0 and not isNil(var_92_1) and arg_89_1.var_.characterEffect1056ui_story then
				arg_89_1.var_.characterEffect1056ui_story.fillFlat = false
			end
			...
			if 0 < arg_89_1.time_ and arg_89_1.time_ <= var_92_4 + arg_92_0 then
				...
				local var_92_6 = arg_89_1:FormatText(arg_89_1:GetWordFromCfg(320711022).content)
	...
	Play320711023 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if 0 < arg_93_1.time_ and arg_93_1.time_ <= var_96_1 + arg_96_0 then
				...
				local var_96_3 = arg_93_1:FormatText(arg_93_1:GetWordFromCfg(320711023).content)
	...
	Play320711024 = function(arg_97_0, arg_97_1)
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			if 0 < arg_97_1.time_ and arg_97_1.time_ <= 0 + arg_100_0 then
				arg_97_1.var_.moveOldPos1056ui_story = arg_97_1.actors_["1056ui_story"].transform.localPosition
			end

			local var_100_0 = 0.001

			if 0 <= arg_97_1.time_ and arg_97_1.time_ < 0 + var_100_0 then
				arg_97_1.actors_["1056ui_story"].transform.localPosition = Vector3.Lerp(arg_97_1.var_.moveOldPos1056ui_story, Vector3.New(0, 100, 0), (arg_97_1.time_ - 0) / var_100_0)
				arg_97_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_97_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_97_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_97_1.actors_["1056ui_story"].transform.position).z)
				arg_97_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_97_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_97_1.actors_["1056ui_story"].transform.localEulerAngles = arg_97_1.actors_["1056ui_story"].transform.localEulerAngles
			end

			if arg_97_1.time_ >= 0 + var_100_0 and arg_97_1.time_ < 0 + var_100_0 + arg_100_0 then
				arg_97_1.actors_["1056ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_97_1.actors_["1056ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_97_1.actors_["1056ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_97_1.actors_["1056ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_97_1.actors_["1056ui_story"].transform.position).z)
				arg_97_1.actors_["1056ui_story"].transform.localEulerAngles.z = 0
				arg_97_1.actors_["1056ui_story"].transform.localEulerAngles.x = 0
				arg_97_1.actors_["1056ui_story"].transform.localEulerAngles = arg_97_1.actors_["1056ui_story"].transform.localEulerAngles
			...
			local var_100_1 = arg_97_1.actors_["1056ui_story"]

			if 0 < arg_97_1.time_ and arg_97_1.time_ <= 0 + arg_100_0 and not isNil(var_100_1) and arg_97_1.var_.characterEffect1056ui_story == nil then
				arg_97_1.var_.characterEffect1056ui_story = var_100_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_100_2 = 0.200000002980232

			if 0 <= arg_97_1.time_ and arg_97_1.time_ < 0 + var_100_2 and not isNil(var_100_1) then
				if arg_97_1.var_.characterEffect1056ui_story and not isNil(var_100_1) then
					arg_97_1.var_.characterEffect1056ui_story.fillFlat = true
					arg_97_1.var_.characterEffect1056ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_97_1.time_ - 0) / var_100_2)
				end
			end

			if arg_97_1.time_ >= 0 + var_100_2 and arg_97_1.time_ < 0 + var_100_2 + arg_100_0 and not isNil(var_100_1) and arg_97_1.var_.characterEffect1056ui_story then
				arg_97_1.var_.characterEffect1056ui_story.fillFlat = true
			...
			if 0 < arg_97_1.time_ and arg_97_1.time_ <= var_100_3 + arg_100_0 then
				...
				local var_100_5 = arg_97_1:FormatText(arg_97_1:GetWordFromCfg(320711024).content)

				arg_97_1.text_.text = var_100_5

				LuaForUtil.ClearLinePrefixSymbol(arg_97_1.text_)

				local var_100_7 = 32 <= 0 and var_100_4 or var_100_4 * (utf8.len(var_100_5) / 32)

				if (32 <= 0 and var_100_4 or var_100_4 * (utf8.len(var_100_5) / 32)) > 0 and var_100_4 < var_100_7 then
	...
	Play320711025 = function(arg_101_0, arg_101_1)
		...
		function arg_101_1.onSingleLineUpdate_(arg_104_0)
			...
			if 0 < arg_101_1.time_ and arg_101_1.time_ <= 0 + arg_104_0 then
				...
				local var_104_1 = arg_101_1:FormatText(arg_101_1:GetWordFromCfg(320711025).content)

				arg_101_1.text_.text = var_104_1

				LuaForUtil.ClearLinePrefixSymbol(arg_101_1.text_)

				local var_104_3 = 47 <= 0 and var_104_0 or var_104_0 * (utf8.len(var_104_1) / 47)

				if (47 <= 0 and var_104_0 or var_104_0 * (utf8.len(var_104_1) / 47)) > 0 and var_104_0 < var_104_3 then
	...
	Play320711026 = function(arg_105_0, arg_105_1)
		...
		function arg_105_1.onSingleLineUpdate_(arg_108_0)
			if 0 < arg_105_1.time_ and arg_105_1.time_ <= 0 + arg_108_0 then
				arg_105_1.var_.moveOldPos1020ui_story = arg_105_1.actors_["1020ui_story"].transform.localPosition
			end

			local var_108_0 = 0.001

			if 0 <= arg_105_1.time_ and arg_105_1.time_ < 0 + var_108_0 then
				arg_105_1.actors_["1020ui_story"].transform.localPosition = Vector3.Lerp(arg_105_1.var_.moveOldPos1020ui_story, Vector3.New(0, -0.85, -6.25), (arg_105_1.time_ - 0) / var_108_0)
				arg_105_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_105_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_105_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_105_1.actors_["1020ui_story"].transform.position).z)
				arg_105_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_105_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_105_1.actors_["1020ui_story"].transform.localEulerAngles = arg_105_1.actors_["1020ui_story"].transform.localEulerAngles
			end

			if arg_105_1.time_ >= 0 + var_108_0 and arg_105_1.time_ < 0 + var_108_0 + arg_108_0 then
				arg_105_1.actors_["1020ui_story"].transform.localPosition = Vector3.New(0, -0.85, -6.25)
				arg_105_1.actors_["1020ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_105_1.actors_["1020ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_105_1.actors_["1020ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_105_1.actors_["1020ui_story"].transform.position).z)
				arg_105_1.actors_["1020ui_story"].transform.localEulerAngles.z = 0
				arg_105_1.actors_["1020ui_story"].transform.localEulerAngles.x = 0
				arg_105_1.actors_["1020ui_story"].transform.localEulerAngles = arg_105_1.actors_["1020ui_story"].transform.localEulerAngles
			...
			local var_108_1 = arg_105_1.actors_["1020ui_story"]

			if 0 < arg_105_1.time_ and arg_105_1.time_ <= 0 + arg_108_0 and not isNil(var_108_1) and arg_105_1.var_.characterEffect1020ui_story == nil then
				arg_105_1.var_.characterEffect1020ui_story = var_108_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_108_2 = 0.200000002980232

			if 0 <= arg_105_1.time_ and arg_105_1.time_ < 0 + var_108_2 and not isNil(var_108_1) then
				if arg_105_1.var_.characterEffect1020ui_story and not isNil(var_108_1) then
					arg_105_1.var_.characterEffect1020ui_story.fillFlat = false
				end
			end

			if arg_105_1.time_ >= 0 + var_108_2 and arg_105_1.time_ < 0 + var_108_2 + arg_108_0 and not isNil(var_108_1) and arg_105_1.var_.characterEffect1020ui_story then
				arg_105_1.var_.characterEffect1020ui_story.fillFlat = false
			end
			...
			if 0 < arg_105_1.time_ and arg_105_1.time_ <= var_108_4 + arg_108_0 then
				...
				local var_108_6 = arg_105_1:FormatText(arg_105_1:GetWordFromCfg(320711026).content)

				arg_105_1.text_.text = var_108_6

				LuaForUtil.ClearLinePrefixSymbol(arg_105_1.text_)

				local var_108_8 = 16 <= 0 and var_108_5 or var_108_5 * (utf8.len(var_108_6) / 16)

				if (16 <= 0 and var_108_5 or var_108_5 * (utf8.len(var_108_6) / 16)) > 0 and var_108_5 < var_108_8 then
