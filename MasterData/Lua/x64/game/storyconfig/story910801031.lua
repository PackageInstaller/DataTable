return {
	Play910803001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 910803001
		arg_1_1.duration_ = 7
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910803001).content)

				arg_1_1.text_.text = var_4_21

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_23 = 12 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_21) / 12)

				if (12 <= 0 and var_4_19 or var_4_19 * (utf8.len(var_4_21) / 12)) > 0 and var_4_19 < var_4_23 then
	...
	Play910803002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 910803002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_2 + arg_10_0 then
				...
				local var_10_4 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910803002).content)
	...
	Play910803003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 910803003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play910803004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910803003).content)
	...
	Play910803004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 910803004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play910803005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910803004).content)

				arg_15_1.text_.text = var_18_7

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_9 = 33 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 33)

				if (33 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 33)) > 0 and var_18_6 < var_18_9 then
	...
	Play910803005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 910803005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play910803006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_2 + arg_22_0 then
				...
				local var_22_4 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910803005).content)
	...
	Play910803006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 910803006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play910803007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910803006).content)
	...
	Play910803007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 910803007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play910803008(arg_27_1)
			end
		end
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910803007).content)
	...
	Play910803008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 910803008
		...
		function arg_31_1.playNext_(arg_33_0)
			if arg_33_0 == 1 then
				arg_31_0:Play910803009(arg_31_1)
			end
		end
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_2 + arg_34_0 then
				...
				local var_34_4 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910803008).content)

				arg_31_1.text_.text = var_34_4

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_6 = 27 <= 0 and var_34_3 or var_34_3 * (utf8.len(var_34_4) / 27)

				if (27 <= 0 and var_34_3 or var_34_3 * (utf8.len(var_34_4) / 27)) > 0 and var_34_3 < var_34_6 then
	...
	Play910803009 = function(arg_35_0, arg_35_1)
		arg_35_1.time_ = 0
		arg_35_1.frameCnt_ = 0
		arg_35_1.state_ = "playing"
		arg_35_1.curTalkId_ = 910803009
		...
		function arg_35_1.playNext_(arg_37_0)
			if arg_37_0 == 1 then
				arg_35_0:Play910803010(arg_35_1)
			end
		end
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				...
				local var_38_1 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910803009).content)
	...
	Play910803010 = function(arg_39_0, arg_39_1)
		arg_39_1.time_ = 0
		arg_39_1.frameCnt_ = 0
		arg_39_1.state_ = "playing"
		arg_39_1.curTalkId_ = 910803010
		...
		function arg_39_1.playNext_(arg_41_0)
			if arg_41_0 == 1 then
				arg_39_0:Play910803011(arg_39_1)
			end
		end
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910803010).content)
	...
	Play910803011 = function(arg_43_0, arg_43_1)
		arg_43_1.time_ = 0
		arg_43_1.frameCnt_ = 0
		arg_43_1.state_ = "playing"
		arg_43_1.curTalkId_ = 910803011
		...
		function arg_43_1.playNext_(arg_45_0)
			if arg_45_0 == 1 then
				arg_43_0:Play910803012(arg_43_1)
			end
		end
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_2 + arg_46_0 then
				...
				local var_46_4 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910803011).content)

				arg_43_1.text_.text = var_46_4

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_6 = 5 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 5)

				if (5 <= 0 and var_46_3 or var_46_3 * (utf8.len(var_46_4) / 5)) > 0 and var_46_3 < var_46_6 then
	...
	Play910803012 = function(arg_47_0, arg_47_1)
		arg_47_1.time_ = 0
		arg_47_1.frameCnt_ = 0
		arg_47_1.state_ = "playing"
		arg_47_1.curTalkId_ = 910803012
		...
		function arg_47_1.playNext_(arg_49_0)
			if arg_49_0 == 1 then
				arg_47_0:Play910803013(arg_47_1)
			end
		end
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 then
				...
				local var_50_1 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910803012).content)
	...
	Play910803013 = function(arg_51_0, arg_51_1)
		arg_51_1.time_ = 0
		arg_51_1.frameCnt_ = 0
		arg_51_1.state_ = "playing"
		arg_51_1.curTalkId_ = 910803013
		...
		function arg_51_1.playNext_(arg_53_0)
			if arg_53_0 == 1 then
				arg_51_0:Play910803014(arg_51_1)
			end
		end
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_5 + arg_54_0 then
				...
				local var_54_7 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910803013).content)

				arg_51_1.text_.text = var_54_7

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_9 = 11 <= 0 and var_54_6 or var_54_6 * (utf8.len(var_54_7) / 11)

				if (11 <= 0 and var_54_6 or var_54_6 * (utf8.len(var_54_7) / 11)) > 0 and var_54_6 < var_54_9 then
	...
	Play910803014 = function(arg_55_0, arg_55_1)
		arg_55_1.time_ = 0
		arg_55_1.frameCnt_ = 0
		arg_55_1.state_ = "playing"
		arg_55_1.curTalkId_ = 910803014
		...
		function arg_55_1.playNext_(arg_57_0)
			if arg_57_0 == 1 then
				arg_55_0:Play910803015(arg_55_1)
			end
		end
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_2 + arg_58_0 then
				...
				local var_58_4 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910803014).content)

				arg_55_1.text_.text = var_58_4

				LuaForUtil.ClearLinePrefixSymbol(arg_55_1.text_)

				local var_58_6 = 15 <= 0 and var_58_3 or var_58_3 * (utf8.len(var_58_4) / 15)

				if (15 <= 0 and var_58_3 or var_58_3 * (utf8.len(var_58_4) / 15)) > 0 and var_58_3 < var_58_6 then
	...
	Play910803015 = function(arg_59_0, arg_59_1)
		arg_59_1.time_ = 0
		arg_59_1.frameCnt_ = 0
		arg_59_1.state_ = "playing"
		arg_59_1.curTalkId_ = 910803015
		...
		function arg_59_1.playNext_(arg_61_0)
			if arg_61_0 == 1 then
				arg_59_0:Play910803016(arg_59_1)
			end
		end
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_5 + arg_62_0 then
				...
				local var_62_7 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(910803015).content)

				arg_59_1.text_.text = var_62_7

				LuaForUtil.ClearLinePrefixSymbol(arg_59_1.text_)

				local var_62_9 = 12 <= 0 and var_62_6 or var_62_6 * (utf8.len(var_62_7) / 12)

				if (12 <= 0 and var_62_6 or var_62_6 * (utf8.len(var_62_7) / 12)) > 0 and var_62_6 < var_62_9 then
	...
	Play910803016 = function(arg_63_0, arg_63_1)
		arg_63_1.time_ = 0
		arg_63_1.frameCnt_ = 0
		arg_63_1.state_ = "playing"
		arg_63_1.curTalkId_ = 910803016
		...
		function arg_63_1.playNext_(arg_65_0)
			if arg_65_0 == 1 then
				arg_63_0:Play910803017(arg_63_1)
			end
		end
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= 0 + arg_66_0 then
				...
				local var_66_1 = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(910803016).content)

				arg_63_1.text_.text = var_66_1

				LuaForUtil.ClearLinePrefixSymbol(arg_63_1.text_)

				local var_66_3 = 21 <= 0 and var_66_0 or var_66_0 * (utf8.len(var_66_1) / 21)

				if (21 <= 0 and var_66_0 or var_66_0 * (utf8.len(var_66_1) / 21)) > 0 and var_66_0 < var_66_3 then
	...
	Play910803017 = function(arg_67_0, arg_67_1)
		arg_67_1.time_ = 0
		arg_67_1.frameCnt_ = 0
		arg_67_1.state_ = "playing"
		arg_67_1.curTalkId_ = 910803017
		...
		function arg_67_1.playNext_(arg_69_0)
			if arg_69_0 == 1 then
				arg_67_0:Play910803018(arg_67_1)
			end
		end
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_5 + arg_70_0 then
				...
				local var_70_7 = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(910803017).content)
	...
	Play910803018 = function(arg_71_0, arg_71_1)
		arg_71_1.time_ = 0
		arg_71_1.frameCnt_ = 0
		arg_71_1.state_ = "playing"
		arg_71_1.curTalkId_ = 910803018
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_6 + arg_74_0 then
				...
				local var_74_8 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(910803018).content)

				arg_71_1.text_.text = var_74_8

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_10 = 17 <= 0 and var_74_7 or var_74_7 * (utf8.len(var_74_8) / 17)

				if (17 <= 0 and var_74_7 or var_74_7 * (utf8.len(var_74_8) / 17)) > 0 and var_74_7 < var_74_10 then
