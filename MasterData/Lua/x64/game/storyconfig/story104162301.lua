	...
	Play416231015 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 0.433333333333333 < arg_63_1.time_ and arg_63_1.time_ <= 0.433333333333333 + arg_66_0 then
				...
				for iter_66_3, iter_66_4 in ipairs((var_66_14.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_66_4.transform.localScale = Vector3.New(iter_66_4.transform.localScale.x / var_66_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_66_4.transform.localScale.y / var_66_16, iter_66_4.transform.localScale.z)
				end
			end
			...
			local var_66_19 = 1
			local var_66_20 = 1.125

			if 1 < arg_63_1.time_ and arg_63_1.time_ <= var_66_19 + arg_66_0 then
				...
				local var_66_22 = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(416231015).content)

				arg_63_1.text_.text = var_66_22

				LuaForUtil.ClearLinePrefixSymbol(arg_63_1.text_)

				local var_66_24 = 45 <= 0 and var_66_20 or var_66_20 * (utf8.len(var_66_22) / 45)

				if (45 <= 0 and var_66_20 or var_66_20 * (utf8.len(var_66_22) / 45)) > 0 and var_66_20 < var_66_24 then
					arg_63_1.talkMaxDuration = var_66_24
					var_66_19 = var_66_19 + 0.3

					if var_66_24 + var_66_19 > arg_63_1.duration_ then
						arg_63_1.duration_ = var_66_24 + var_66_19
					end
				end
			...
			local var_66_25 = var_66_19 + 0.3
			local var_66_26 = math.max(var_66_20, arg_63_1.talkMaxDuration)

			if var_66_19 + 0.3 <= arg_63_1.time_ and arg_63_1.time_ < var_66_25 + var_66_26 then
				arg_63_1.typewritter.percent = (arg_63_1.time_ - var_66_25) / var_66_26
	...
	Play416231023 = function(arg_97_0, arg_97_1)
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			...
			if 0 < arg_97_1.time_ and arg_97_1.time_ <= 0 + arg_100_0 then
				...
				for iter_100_6, iter_100_7 in ipairs((var_100_8.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_100_7.transform.localScale = Vector3.New(iter_100_7.transform.localScale.x / var_100_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_100_7.transform.localScale.y / var_100_10, iter_100_7.transform.localScale.z)
				end
			end
			...
			if 0 < arg_97_1.time_ and arg_97_1.time_ <= var_100_13 + arg_100_0 then
				arg_97_1.allBtn_.enabled = false
			end

			if arg_97_1.time_ >= var_100_13 + 0.9 and arg_97_1.time_ < var_100_13 + 0.9 + arg_100_0 then
			...
			local var_100_16 = 1.275

			if 0.6 < arg_97_1.time_ and arg_97_1.time_ <= var_100_15 + arg_100_0 then
				...
				local var_100_18 = arg_97_1:FormatText(arg_97_1:GetWordFromCfg(416231023).content)

				arg_97_1.text_.text = var_100_18

				LuaForUtil.ClearLinePrefixSymbol(arg_97_1.text_)

				local var_100_20 = 51 <= 0 and var_100_16 or var_100_16 * (utf8.len(var_100_18) / 51)

				if (51 <= 0 and var_100_16 or var_100_16 * (utf8.len(var_100_18) / 51)) > 0 and var_100_16 < var_100_20 then
