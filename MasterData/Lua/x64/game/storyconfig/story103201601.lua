	...
	Play320161055 = function(arg_227_0, arg_227_1)
		...
		function arg_227_1.onSingleLineUpdate_(arg_230_0)
			...
			if 2 < arg_227_1.time_ and arg_227_1.time_ <= 2 + arg_230_0 then
				...
				for iter_230_2, iter_230_3 in ipairs((var_230_17.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_230_3.transform.localScale = Vector3.New(iter_230_3.transform.localScale.x / var_230_19 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_230_3.transform.localScale.y / var_230_19, iter_230_3.transform.localScale.z)
				end
			end

			if 2 < arg_227_1.time_ and arg_227_1.time_ <= 2 + arg_230_0 then
				local var_230_21 = arg_227_1.var_.effectxiayu16

				if not arg_227_1.var_.effectxiayu16 then
					var_230_21 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_light"), manager.ui.mainCamera.transform)
					var_230_21.name = "xiayu16"
					arg_227_1.var_.effectxiayu16 = var_230_21
				else
					var_230_21.transform:SetParent(var_230_9000)
				end

				var_230_21.transform.localPosition = Vector3.New(0, 0, 0)
				var_230_21.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			if 0 < arg_227_1.time_ and arg_227_1.time_ <= 0 + arg_230_0 then
				arg_227_1:AudioAction("play", "music", "ui_battle", "ui_battle_stopbgm", "")

				local var_230_25 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_227_1.bgmTxt_.text ~= var_230_25 and arg_227_1.bgmTxt_.text ~= "" then
						if arg_227_1.bgmTxt2_.text ~= "" then
							arg_227_1.bgmTxt_.text = arg_227_1.bgmTxt2_.text
						end

						arg_227_1.bgmTxt2_.text = var_230_25

						arg_227_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_227_1.bgmTxt_.text = var_230_25
						arg_227_1.bgmTxt2_.text = var_230_25
					end
			...
			local var_230_27 = 3.999999999999
			local var_230_28 = 0.65

			if 3.999999999999 < arg_227_1.time_ and arg_227_1.time_ <= var_230_27 + arg_230_0 then
				...
				var_230_29:setOnUpdate(LuaHelper.FloatAction(function(arg_232_0)
				...
				local var_230_30 = arg_227_1:GetWordFromCfg(320161055)
				...
				local var_230_33 = 26 <= 0 and var_230_28 or var_230_28 * (utf8.len(var_230_31) / 26)

				if (26 <= 0 and var_230_28 or var_230_28 * (utf8.len(var_230_31) / 26)) > 0 and var_230_28 < var_230_33 then
					arg_227_1.talkMaxDuration = var_230_33
					var_230_27 = var_230_27 + 0.3

					if var_230_33 + var_230_27 > arg_227_1.duration_ then
						arg_227_1.duration_ = var_230_33 + var_230_27
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_320161", "320161055", "story_v_out_320161.awb") ~= 0 then
					local var_230_34 = manager.audio:GetVoiceLength("story_v_out_320161", "320161055", "story_v_out_320161.awb") / 1000
					...
					if var_230_30.prefab_name ~= "" and arg_227_1.actors_[var_230_30.prefab_name] ~= nil then
						local var_230_35 = LuaForUtil.PlayVoiceWithCriLipsync(arg_227_1.actors_[var_230_30.prefab_name].transform, "story_v_out_320161", "320161055", "story_v_out_320161.awb")

						arg_227_1:RecordAudio("320161055", var_230_35)
						arg_227_1:RecordAudio("320161055", var_230_35)
					else
			...
			local var_230_36 = var_230_27 + 0.3
			local var_230_37 = math.max(var_230_28, arg_227_1.talkMaxDuration)

			if var_230_27 + 0.3 <= arg_227_1.time_ and arg_227_1.time_ < var_230_36 + var_230_37 then
				arg_227_1.typewritter.percent = (arg_227_1.time_ - var_230_36) / var_230_37

				arg_227_1.typewritter:SetDirty()
			end

			if arg_227_1.time_ >= var_230_36 + var_230_37 and arg_227_1.time_ < var_230_36 + var_230_37 + arg_230_0 then
