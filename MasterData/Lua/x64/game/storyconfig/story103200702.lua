	...
	Play320072001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				for iter_4_2, iter_4_3 in ipairs((var_4_11.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_3.transform.localScale = Vector3.New(iter_4_3.transform.localScale.x / var_4_13 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_3.transform.localScale.y / var_4_13, iter_4_3.transform.localScale.z)
				end
			end
			...
			if 0.5 < arg_1_1.time_ and arg_1_1.time_ <= 0.5 + arg_4_0 then
				...
				local var_4_20 = manager.audio:GetAudioName("bgm_activity_2_8_story_jivitabad_slum", "bgm_activity_2_8_story_jivitabad_slum")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				...
				local var_4_26 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(320072001).content)

				arg_1_1.text_.text = var_4_26

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_28 = 61 <= 0 and var_4_24 or var_4_24 * (utf8.len(var_4_26) / 61)

				if (61 <= 0 and var_4_24 or var_4_24 * (utf8.len(var_4_26) / 61)) > 0 and var_4_24 < var_4_28 then
