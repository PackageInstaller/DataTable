	...
	Play423041050 = function(arg_215_0, arg_215_1)
		...
		function arg_215_1.onSingleLineUpdate_(arg_218_0)
			...
			if 0 < arg_215_1.time_ and arg_215_1.time_ <= 0 + arg_218_0 then
				...
				for iter_218_2, iter_218_3 in ipairs((var_218_3.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_218_3.transform.localScale = Vector3.New(iter_218_3.transform.localScale.x / var_218_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_218_3.transform.localScale.y / var_218_5, iter_218_3.transform.localScale.z)
				end
			end

			if 1.3 < arg_215_1.time_ and arg_215_1.time_ <= 1.3 + arg_218_0 then
				local var_218_7 = arg_215_1.var_.effectlagejiaoyang2

				if not arg_215_1.var_.effectlagejiaoyang2 then
					var_218_7 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_out"), manager.ui.mainCamera.transform)
					var_218_7.name = "lagejiaoyang2"
					arg_215_1.var_.effectlagejiaoyang2 = var_218_7
				else
					var_218_7.transform:SetParent(var_218_9000)
				end

				var_218_7.transform.localPosition = Vector3.New(0, 0, 0)
				var_218_7.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_218_9 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_218_4, iter_218_5 in ipairs((var_218_7.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_218_5.transform.localScale = Vector3.New(iter_218_5.transform.localScale.x / var_218_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_218_5.transform.localScale.y / var_218_9, iter_218_5.transform.localScale.z)
				end
			end
			...
			local var_218_12 = arg_215_1.bgs_.SS2302.transform

			if 1.3 < arg_215_1.time_ and arg_215_1.time_ <= 1.3 + arg_218_0 then
				arg_215_1.var_.moveOldPosSS2302 = var_218_12.localPosition
			end

			local var_218_13 = 3.5

			if 1.3 <= arg_215_1.time_ and arg_215_1.time_ < 1.3 + var_218_13 then
				var_218_12.localPosition = Vector3.Lerp(arg_215_1.var_.moveOldPosSS2302, Vector3.New(0, 1, 10), (arg_215_1.time_ - 1.3) / var_218_13)
			end

			if arg_215_1.time_ >= 1.3 + var_218_13 and arg_215_1.time_ < 1.3 + var_218_13 + arg_218_0 then
				var_218_12.localPosition = Vector3.New(0, 1, 10)
			end
			...
			if arg_215_1.time_ >= var_218_14 + 2.33333333333333 and arg_215_1.time_ < var_218_14 + 2.33333333333333 + arg_218_0 then
			...
			local var_218_16 = 2.33333333333333
			local var_218_17 = 1.75

			if 2.33333333333333 < arg_215_1.time_ and arg_215_1.time_ <= var_218_16 + arg_218_0 then
				...
				local var_218_18 = arg_215_1:FormatText(arg_215_1:GetWordFromCfg(423041050).content)

				arg_215_1.text_.text = var_218_18

				LuaForUtil.ClearLinePrefixSymbol(arg_215_1.text_)

				local var_218_20 = 70 <= 0 and var_218_17 or var_218_17 * (utf8.len(var_218_18) / 70)

				if (70 <= 0 and var_218_17 or var_218_17 * (utf8.len(var_218_18) / 70)) > 0 and var_218_17 < var_218_20 then
					arg_215_1.talkMaxDuration = var_218_20

					if var_218_20 + var_218_16 > arg_215_1.duration_ then
						arg_215_1.duration_ = var_218_20 + var_218_16
					end
				end
			...
			local var_218_21 = math.max(var_218_17, arg_215_1.talkMaxDuration)

			if var_218_16 <= arg_215_1.time_ and arg_215_1.time_ < var_218_16 + var_218_21 then
				arg_215_1.typewritter.percent = (arg_215_1.time_ - var_218_16) / var_218_21

				arg_215_1.typewritter:SetDirty()
			end

			if arg_215_1.time_ >= var_218_16 + var_218_21 and arg_215_1.time_ < var_218_16 + var_218_21 + arg_218_0 then
	...
	Play423041056 = function(arg_241_0, arg_241_1)
		...
		function arg_241_1.onSingleLineUpdate_(arg_244_0)
			...
			if 0.8 < arg_241_1.time_ and arg_241_1.time_ <= 0.8 + arg_244_0 then
				...
				for iter_244_0, iter_244_1 in ipairs((var_244_3.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_244_1.transform.localScale = Vector3.New(iter_244_1.transform.localScale.x / var_244_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_244_1.transform.localScale.y / var_244_5, iter_244_1.transform.localScale.z)
				end
			end
			...
			local var_244_8 = manager.ui.mainCamera.transform

			if 0.8 < arg_241_1.time_ and arg_241_1.time_ <= 0.8 + arg_244_0 then
				arg_241_1.var_.shakeOldPos = var_244_8.localPosition
			end

			local var_244_9 = 1

			if 0.8 <= arg_241_1.time_ and arg_241_1.time_ < 0.8 + var_244_9 then
				local var_244_10, var_244_11 = math.modf((arg_241_1.time_ - 0.8) / 0.066)

				var_244_8.localPosition = Vector3.New(var_244_11 * 0.02, var_244_11 * 0.02, var_244_11 * 0.02) + arg_241_1.var_.shakeOldPos
			end

			if arg_241_1.time_ >= 0.8 + var_244_9 and arg_241_1.time_ < 0.8 + var_244_9 + arg_244_0 then
				var_244_8.localPosition = arg_241_1.var_.shakeOldPos
			end
			...
			if arg_241_1.time_ >= var_244_12 + 1.8 and arg_241_1.time_ < var_244_12 + 1.8 + arg_244_0 then
			...
			local var_244_14 = 1.1
			local var_244_15 = 1.4

			if 1.1 < arg_241_1.time_ and arg_241_1.time_ <= var_244_14 + arg_244_0 then
				...
				local var_244_17 = arg_241_1:FormatText(arg_241_1:GetWordFromCfg(423041056).content)

				arg_241_1.text_.text = var_244_17

				LuaForUtil.ClearLinePrefixSymbol(arg_241_1.text_)

				local var_244_19 = 56 <= 0 and var_244_15 or var_244_15 * (utf8.len(var_244_17) / 56)

				if (56 <= 0 and var_244_15 or var_244_15 * (utf8.len(var_244_17) / 56)) > 0 and var_244_15 < var_244_19 then
