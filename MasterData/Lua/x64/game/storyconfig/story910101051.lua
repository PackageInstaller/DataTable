return {
	Play910105001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_["1039"] == nil then
				...
				var_4_10.sprite = getSpriteWithoutAtlas("TextureConfig/Character/Portrait/" .. "1039")
			...
			if 1 <= arg_1_1.time_ and arg_1_1.time_ < 1 + var_4_12 then
				var_4_11.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1039, Vector3.New(0, -350, -180), (arg_1_1.time_ - 1) / var_4_12)
			end

			if arg_1_1.time_ >= 1 + var_4_12 and arg_1_1.time_ < 1 + var_4_12 + arg_4_0 then
				var_4_11.localPosition = Vector3.New(0, -350, -180)
			end

			if 1 < arg_1_1.time_ and arg_1_1.time_ <= 1 + arg_4_0 then
				local var_4_13 = arg_1_1.actors_["1039"]:GetComponent("Image")

				if var_4_13 then
					arg_1_1.var_.alphaMatValue1039 = var_4_13
					arg_1_1.var_.alphaOldValue1039 = var_4_13.color.a
				end
			...
			if 1 <= arg_1_1.time_ and arg_1_1.time_ < 1 + var_4_14 then
				if arg_1_1.var_.alphaMatValue1039 then
					arg_1_1.var_.alphaMatValue1039.color.a = Mathf.Lerp(arg_1_1.var_.alphaOldValue1039, 1, (arg_1_1.time_ - 1) / var_4_14)
					arg_1_1.var_.alphaMatValue1039.color = arg_1_1.var_.alphaMatValue1039.color
				end
			end

			if arg_1_1.time_ >= 1 + var_4_14 and arg_1_1.time_ < 1 + var_4_14 + arg_4_0 and arg_1_1.var_.alphaMatValue1039 then
				arg_1_1.var_.alphaMatValue1039.color.a = 1
				arg_1_1.var_.alphaMatValue1039.color = arg_1_1.var_.alphaMatValue1039.color
			end
			...
			if 1 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 then
				...
				local var_4_18 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910105001).content)
	...
	Play910105002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910105002).content)
	...
	Play910105003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if 0.0333333333333333 < arg_11_1.time_ and arg_11_1.time_ <= 0.0333333333333333 + arg_14_0 then
				arg_11_1.var_.moveOldPos1039 = arg_11_1.actors_["1039"].transform.localPosition
				arg_11_1.actors_["1039"].transform.localScale = Vector3.New(1, 1, 1)

				arg_11_1:CheckSpriteTmpPos("1039", 3)

				for iter_14_0 = 0, arg_11_1.actors_["1039"].transform.childCount - 1 do
					local var_14_0 = arg_11_1.actors_["1039"].transform:GetChild(iter_14_0)
			...
			if 0.0333333333333333 <= arg_11_1.time_ and arg_11_1.time_ < 0.0333333333333333 + var_14_1 then
				arg_11_1.actors_["1039"].transform.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1039, Vector3.New(0, -350, -180), (arg_11_1.time_ - 0.0333333333333333) / var_14_1)
			end

			if arg_11_1.time_ >= 0.0333333333333333 + var_14_1 and arg_11_1.time_ < 0.0333333333333333 + var_14_1 + arg_14_0 then
				arg_11_1.actors_["1039"].transform.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_2 + arg_14_0 then
				...
				local var_14_4 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910105003).content)

				arg_11_1.text_.text = var_14_4

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_6 = 29 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 29)

				if (29 <= 0 and var_14_3 or var_14_3 * (utf8.len(var_14_4) / 29)) > 0 and var_14_3 < var_14_6 then
	...
	Play910105004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910105004).content)
	...
	Play910105005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910105005).content)
	...
	Play910105006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				...
				local var_26_1 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910105006).content)

				arg_23_1.text_.text = var_26_1

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_3 = 14 <= 0 and var_26_0 or var_26_0 * (utf8.len(var_26_1) / 14)

				if (14 <= 0 and var_26_0 or var_26_0 * (utf8.len(var_26_1) / 14)) > 0 and var_26_0 < var_26_3 then
