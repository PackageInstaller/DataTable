return {
	Play60105001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= var_4_0 + arg_4_0 then
				...
				local var_4_3 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(60105001).content)

				arg_1_1.text_.text = var_4_3

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_5 = 5 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 5)

				if (5 <= 0 and var_4_1 or var_4_1 * (utf8.len(var_4_3) / 5)) > 0 and var_4_1 < var_4_5 then
	...
	Play60105002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			if arg_7_1.actors_["2440001"] == nil then
				local var_10_0 = Object.Instantiate(arg_7_1.imageGo_, arg_7_1.canvasGo_.transform)

				var_10_0.transform:SetSiblingIndex(1)

				var_10_0.name = "2440001"

				local var_10_1 = var_10_0:GetComponent(typeof(Image))

				var_10_1.sprite = getSpriteWithoutAtlas("TextureConfig/WeaponServant/Portrait/" .. "2440001")

				var_10_1:SetNativeSize()

				var_10_0.transform.localPosition = Vector3.New(0, 100000, 0)
				arg_7_1.actors_["2440001"] = var_10_0
			end

			local var_10_2 = arg_7_1.actors_["2440001"].transform

			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				arg_7_1.var_.moveOldPos2440001 = var_10_2.localPosition
			...
			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_3 then
				var_10_2.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos2440001, Vector3.New(0, -170, -800), (arg_7_1.time_ - 0) / var_10_3)
			end

			if arg_7_1.time_ >= 0 + var_10_3 and arg_7_1.time_ < 0 + var_10_3 + arg_10_0 then
				var_10_2.localPosition = Vector3.New(0, -170, -800)
			end
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_4 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[122].name)
				...
				local var_10_6 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(60105002).content)

				arg_7_1.text_.text = var_10_6

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_8 = 51 <= 0 and var_10_5 or var_10_5 * (utf8.len(var_10_6) / 51)

				if (51 <= 0 and var_10_5 or var_10_5 * (utf8.len(var_10_6) / 51)) > 0 and var_10_5 < var_10_8 then
					arg_7_1.talkMaxDuration = var_10_8

					if var_10_8 + var_10_4 > arg_7_1.duration_ then
						arg_7_1.duration_ = var_10_8 + var_10_4
					end
				end
			...
			local var_10_9 = math.max(var_10_5, arg_7_1.talkMaxDuration)

			if var_10_4 <= arg_7_1.time_ and arg_7_1.time_ < var_10_4 + var_10_9 then
				arg_7_1.typewritter.percent = (arg_7_1.time_ - var_10_4) / var_10_9

				arg_7_1.typewritter:SetDirty()
			end

			if arg_7_1.time_ >= var_10_4 + var_10_9 and arg_7_1.time_ < var_10_4 + var_10_9 + arg_10_0 then
