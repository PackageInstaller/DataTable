	...
	Play320312007 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				...
				for iter_34_0, iter_34_1 in ipairs((var_34_3.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_34_1.transform.localScale = Vector3.New(iter_34_1.transform.localScale.x / var_34_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_34_1.transform.localScale.y / var_34_5, iter_34_1.transform.localScale.z)
				end
			end

			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				local var_34_7 = arg_31_1.var_.effect959

				if not arg_31_1.var_.effect959 then
					var_34_7 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in"), manager.ui.mainCamera.transform)
					var_34_7.name = "959"
					arg_31_1.var_.effect959 = var_34_7
				else
					var_34_7.transform:SetParent(var_34_9000)
				end

				var_34_7.transform.localPosition = Vector3.New(0, 0, 0)
				var_34_7.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_34_9 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_34_2, iter_34_3 in ipairs((var_34_7.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_34_3.transform.localScale = Vector3.New(iter_34_3.transform.localScale.x / var_34_9 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_34_3.transform.localScale.y / var_34_9, iter_34_3.transform.localScale.z)
				end
			end
			...
			if arg_31_1.time_ >= var_34_12 + 1.175 and arg_31_1.time_ < var_34_12 + 1.175 + arg_34_0 then
			...
			local var_34_13 = 0.566666666666667
			local var_34_14 = 1.125

			if 0.566666666666667 < arg_31_1.time_ and arg_31_1.time_ <= var_34_13 + arg_34_0 then
				...
				local var_34_16 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(320312007).content)

				arg_31_1.text_.text = var_34_16

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_18 = 45 <= 0 and var_34_14 or var_34_14 * (utf8.len(var_34_16) / 45)

				if (45 <= 0 and var_34_14 or var_34_14 * (utf8.len(var_34_16) / 45)) > 0 and var_34_14 < var_34_18 then
	...
	Play320312008 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				...
				for iter_40_0, iter_40_1 in ipairs((var_40_2.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_40_1.transform.localScale = Vector3.New(iter_40_1.transform.localScale.x / var_40_4 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_40_1.transform.localScale.y / var_40_4, iter_40_1.transform.localScale.z)
				end
			end

			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				local var_40_6 = arg_37_1.var_.effect961

				if not arg_37_1.var_.effect961 then
					var_40_6 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in_ui_1"), manager.ui.mainCamera.transform)
					var_40_6.name = "961"
					arg_37_1.var_.effect961 = var_40_6
				else
					var_40_6.transform:SetParent(var_40_9000)
				end

				var_40_6.transform.localPosition = Vector3.New(0, 0, 0)
				var_40_6.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_40_8 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_40_2, iter_40_3 in ipairs((var_40_6.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_40_3.transform.localScale = Vector3.New(iter_40_3.transform.localScale.x / var_40_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_40_3.transform.localScale.y / var_40_8, iter_40_3.transform.localScale.z)
				end
			end
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_12 + arg_40_0 then
				...
				local var_40_14 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(320312008).content)

				arg_37_1.text_.text = var_40_14

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_16 = 68 <= 0 and var_40_13 or var_40_13 * (utf8.len(var_40_14) / 68)

				if (68 <= 0 and var_40_13 or var_40_13 * (utf8.len(var_40_14) / 68)) > 0 and var_40_13 < var_40_16 then
