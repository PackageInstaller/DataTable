	...
	Play423061111 = function(arg_451_0, arg_451_1)
		...
		function arg_451_1.onSingleLineUpdate_(arg_454_0)
			...
			if 2 < arg_451_1.time_ and arg_451_1.time_ <= 2 + arg_454_0 then
				...
				for iter_454_7, iter_454_8 in ipairs((var_454_18.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_454_8.transform.localScale = Vector3.New(iter_454_8.transform.localScale.x / var_454_20 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_454_8.transform.localScale.y / var_454_20, iter_454_8.transform.localScale.z)
				end
			end

			if 2 < arg_451_1.time_ and arg_451_1.time_ <= 2 + arg_454_0 then
				local var_454_22 = arg_451_1.var_.effectyaan2

				if not arg_451_1.var_.effectyaan2 then
					var_454_22 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_rain_heavymax_ui"), manager.ui.mainCamera.transform)
					var_454_22.name = "yaan2"
					arg_451_1.var_.effectyaan2 = var_454_22
				else
					var_454_22.transform:SetParent(var_454_9000)
				end

				var_454_22.transform.localPosition = Vector3.New(0, 0, 0)
				var_454_22.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_454_24 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_454_9, iter_454_10 in ipairs((var_454_22.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_454_10.transform.localScale = Vector3.New(iter_454_10.transform.localScale.x / var_454_24 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_454_10.transform.localScale.y / var_454_24, iter_454_10.transform.localScale.z)
				end
			end
			...
			local var_454_26 = 4
			local var_454_27 = 1.475

			if 4 < arg_451_1.time_ and arg_451_1.time_ <= var_454_26 + arg_454_0 then
				...
				local var_454_28 = LeanTween.value(arg_451_1.dialog_, 0, 1, 0.3)

				var_454_28:setOnUpdate(LuaHelper.FloatAction(function(arg_455_0)
					arg_451_1.dialogCg_.alpha = arg_455_0
				end))
				var_454_28:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_451_1.dialog_)
					var_454_28:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_454_29 = arg_451_1:FormatText(arg_451_1:GetWordFromCfg(423061111).content)

				arg_451_1.text_.text = var_454_29

				LuaForUtil.ClearLinePrefixSymbol(arg_451_1.text_)

				local var_454_31 = 70 <= 0 and var_454_27 or var_454_27 * (utf8.len(var_454_29) / 70)

				if (70 <= 0 and var_454_27 or var_454_27 * (utf8.len(var_454_29) / 70)) > 0 and var_454_27 < var_454_31 then
					arg_451_1.talkMaxDuration = var_454_31
					var_454_26 = var_454_26 + 0.3

					if var_454_31 + var_454_26 > arg_451_1.duration_ then
						arg_451_1.duration_ = var_454_31 + var_454_26
					end
				end
			...
			local var_454_32 = var_454_26 + 0.3
			local var_454_33 = math.max(var_454_27, arg_451_1.talkMaxDuration)

			if var_454_26 + 0.3 <= arg_451_1.time_ and arg_451_1.time_ < var_454_32 + var_454_33 then
				arg_451_1.typewritter.percent = (arg_451_1.time_ - var_454_32) / var_454_33

				arg_451_1.typewritter:SetDirty()
			end

			if arg_451_1.time_ >= var_454_32 + var_454_33 and arg_451_1.time_ < var_454_32 + var_454_33 + arg_454_0 then
