	...
	Play103 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				for iter_18_2, iter_18_3 in ipairs((var_18_26.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_18_3.transform.localScale = Vector3.New(iter_18_3.transform.localScale.x / var_18_28 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_18_3.transform.localScale.y / var_18_28, iter_18_3.transform.localScale.z)
				end
			end

			local var_18_30 = 0
			local var_18_31 = 1.43333333333333

			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_30 + arg_18_0 then
				...
				local var_18_33 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(100).content)

				arg_15_1.text_.text = var_18_33

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_35 = 4 <= 0 and var_18_31 or var_18_31 * (utf8.len(var_18_33) / 4)

				if (4 <= 0 and var_18_31 or var_18_31 * (utf8.len(var_18_33) / 4)) > 0 and var_18_31 < var_18_35 then
					arg_15_1.talkMaxDuration = var_18_35
					var_18_30 = var_18_30 + 0.3

					if var_18_35 + var_18_30 > arg_15_1.duration_ then
						arg_15_1.duration_ = var_18_35 + var_18_30
					end
				end
			...
			local var_18_36 = var_18_30 + 0.3
			local var_18_37 = math.max(var_18_31, arg_15_1.talkMaxDuration)

			if var_18_30 + 0.3 <= arg_15_1.time_ and arg_15_1.time_ < var_18_36 + var_18_37 then
				arg_15_1.typewritter.percent = (arg_15_1.time_ - var_18_36) / var_18_37

				arg_15_1.typewritter:SetDirty()
			end

			if arg_15_1.time_ >= var_18_36 + var_18_37 and arg_15_1.time_ < var_18_36 + var_18_37 + arg_18_0 then
	...
	Play104 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 then
				...
				for iter_24_2, iter_24_3 in ipairs((var_24_16.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_24_3.transform.localScale = Vector3.New(iter_24_3.transform.localScale.x / var_24_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_24_3.transform.localScale.y / var_24_18, iter_24_3.transform.localScale.z)
				end
			end
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_20 + arg_24_0 then
				...
				local var_24_23 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(100).content)

				arg_21_1.text_.text = var_24_23

				LuaForUtil.ClearLinePrefixSymbol(arg_21_1.text_)

				local var_24_25 = 4 <= 0 and var_24_21 or var_24_21 * (utf8.len(var_24_23) / 4)

				if (4 <= 0 and var_24_21 or var_24_21 * (utf8.len(var_24_23) / 4)) > 0 and var_24_21 < var_24_25 then
					arg_21_1.talkMaxDuration = var_24_25
					var_24_20 = var_24_20 + 0.3

					if var_24_25 + var_24_20 > arg_21_1.duration_ then
						arg_21_1.duration_ = var_24_25 + var_24_20
					end
				end
			...
			local var_24_26 = var_24_20 + 0.3
			local var_24_27 = math.max(var_24_21, arg_21_1.talkMaxDuration)

			if var_24_20 + 0.3 <= arg_21_1.time_ and arg_21_1.time_ < var_24_26 + var_24_27 then
