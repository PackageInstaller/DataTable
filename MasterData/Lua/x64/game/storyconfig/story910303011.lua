return {
	Play910303001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_8 + arg_4_0 then
				...
				local var_4_11 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910303001).content)
	...
	Play910303002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910303002).content)
	...
	Play910303003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if arg_11_1.actors_["1066ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1066ui_story"))) then
				local var_14_0 = Object.Instantiate(Asset.Load("Char/" .. "1066ui_story"), arg_11_1.stage_.transform)

				var_14_0.name = "1066ui_story"
				var_14_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_11_1.actors_["1066ui_story"] = var_14_0
				...
				arg_11_1.var_["1066ui_story" .. "Animator"] = var_14_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_11_1.var_["1066ui_story" .. "Animator"].applyRootMotion = true
				arg_11_1.var_["1066ui_story" .. "LipSync"] = var_14_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end
			...
			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_4 then
				var_14_3.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_11_1.time_ - 0) / var_14_4)
			...
			if arg_11_1.time_ >= 0 + var_14_4 and arg_11_1.time_ < 0 + var_14_4 + arg_14_0 then
				var_14_3.localPosition = Vector3.New(0, -0.77, -6.1)
				var_14_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_14_3.position).x, (manager.ui.mainCamera.transform.position - var_14_3.position).y, (manager.ui.mainCamera.transform.position - var_14_3.position).z)
				var_14_3.localEulerAngles.z = 0
				var_14_3.localEulerAngles.x = 0
				var_14_3.localEulerAngles = var_14_3.localEulerAngles
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 and not isNil(var_14_5) and arg_11_1.var_.characterEffect1066ui_story == nil then
			...
			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_6 and not isNil(var_14_5) then
				if arg_11_1.var_.characterEffect1066ui_story and not isNil(var_14_5) then
					arg_11_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_11_1.time_ >= 0 + var_14_6 and arg_11_1.time_ < 0 + var_14_6 + arg_14_0 and not isNil(var_14_5) and arg_11_1.var_.characterEffect1066ui_story then
				arg_11_1.var_.characterEffect1066ui_story.fillFlat = false
			end

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				arg_11_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action2_1")
			end
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_8 + arg_14_0 then
				...
				local var_14_10 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910303003).content)

				arg_11_1.text_.text = var_14_10

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_12 = 10 <= 0 and var_14_9 or var_14_9 * (utf8.len(var_14_10) / 10)

				if (10 <= 0 and var_14_9 or var_14_9 * (utf8.len(var_14_10) / 10)) > 0 and var_14_9 < var_14_12 then
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_0 and not isNil(arg_15_1.actors_["1066ui_story"]) then
				if arg_15_1.var_.characterEffect1066ui_story and not isNil(arg_15_1.actors_["1066ui_story"]) then
					...
					arg_15_1.var_.characterEffect1066ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_15_1.time_ - 0) / var_18_0)
				end
			end
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 then
				...
				local var_18_3 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910303004).content)

				arg_15_1.text_.text = var_18_3

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_5 = 26 <= 0 and var_18_2 or var_18_2 * (utf8.len(var_18_3) / 26)

				if (26 <= 0 and var_18_2 or var_18_2 * (utf8.len(var_18_3) / 26)) > 0 and var_18_2 < var_18_5 then
	...
	Play910303005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_0 then
				arg_19_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_19_1.time_ - 0) / var_22_0)
			...
			if arg_19_1.time_ >= 0 + var_22_0 and arg_19_1.time_ < 0 + var_22_0 + arg_22_0 then
				arg_19_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_19_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_19_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["1066ui_story"].transform.position).z)
				arg_19_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_19_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_19_1.actors_["1066ui_story"].transform.localEulerAngles = arg_19_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				arg_19_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action2_2")
			end
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_4 + arg_22_0 then
				...
				local var_22_6 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910303005).content)

				arg_19_1.text_.text = var_22_6

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_8 = 13 <= 0 and var_22_5 or var_22_5 * (utf8.len(var_22_6) / 13)

				if (13 <= 0 and var_22_5 or var_22_5 * (utf8.len(var_22_6) / 13)) > 0 and var_22_5 < var_22_8 then
	...
	Play910303006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				...
				local var_26_1 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910303006).content)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_0 and not isNil(arg_27_1.actors_["1066ui_story"]) then
				if arg_27_1.var_.characterEffect1066ui_story and not isNil(arg_27_1.actors_["1066ui_story"]) then
					...
					arg_27_1.var_.characterEffect1066ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_27_1.time_ - 0) / var_30_0)
				end
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_1 + arg_30_0 then
				...
				local var_30_3 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910303007).content)
	...
	Play910303008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 <= arg_31_1.time_ and arg_31_1.time_ < 0 + var_34_0 then
				arg_31_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_31_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_31_1.time_ - 0) / var_34_0)
			...
			if arg_31_1.time_ >= 0 + var_34_0 and arg_31_1.time_ < 0 + var_34_0 + arg_34_0 then
				arg_31_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_31_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_31_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_31_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_31_1.actors_["1066ui_story"].transform.position).z)
				arg_31_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_31_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_31_1.actors_["1066ui_story"].transform.localEulerAngles = arg_31_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			local var_34_1 = arg_31_1.actors_["1066ui_story"]

			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 and not isNil(var_34_1) and arg_31_1.var_.characterEffect1066ui_story == nil then
				arg_31_1.var_.characterEffect1066ui_story = var_34_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_34_2 = 0.200000002980232

			if 0 <= arg_31_1.time_ and arg_31_1.time_ < 0 + var_34_2 and not isNil(var_34_1) then
				if arg_31_1.var_.characterEffect1066ui_story and not isNil(var_34_1) then
					arg_31_1.var_.characterEffect1066ui_story.fillFlat = false
				end
			end

			if arg_31_1.time_ >= 0 + var_34_2 and arg_31_1.time_ < 0 + var_34_2 + arg_34_0 and not isNil(var_34_1) and arg_31_1.var_.characterEffect1066ui_story then
				arg_31_1.var_.characterEffect1066ui_story.fillFlat = false
			end

			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 then
				arg_31_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action4_1")
			end
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_4 + arg_34_0 then
				...
				local var_34_6 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910303008).content)
	...
	Play910303009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				...
				local var_38_1 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910303009).content)
	...
	Play910303010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 then
				...
				local var_42_1 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910303010).content)
	...
	Play910303011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_1 + arg_46_0 then
				...
				local var_46_3 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910303011).content)
	...
	Play910303012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 <= arg_47_1.time_ and arg_47_1.time_ < 0 + var_50_0 then
				arg_47_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_47_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_47_1.time_ - 0) / var_50_0)
			...
			if arg_47_1.time_ >= 0 + var_50_0 and arg_47_1.time_ < 0 + var_50_0 + arg_50_0 then
				arg_47_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_47_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_47_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_47_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_47_1.actors_["1066ui_story"].transform.position).z)
				arg_47_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_47_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_47_1.actors_["1066ui_story"].transform.localEulerAngles = arg_47_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 then
				arg_47_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066actionlink/1066action446")
			end
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_4 + arg_50_0 then
				...
				local var_50_6 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910303012).content)

				arg_47_1.text_.text = var_50_6

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_8 = 22 <= 0 and var_50_5 or var_50_5 * (utf8.len(var_50_6) / 22)

				if (22 <= 0 and var_50_5 or var_50_5 * (utf8.len(var_50_6) / 22)) > 0 and var_50_5 < var_50_8 then
	...
	Play910303013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 <= arg_51_1.time_ and arg_51_1.time_ < 0 + var_54_0 then
				arg_51_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_51_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_51_1.time_ - 0) / var_54_0)
			...
			if arg_51_1.time_ >= 0 + var_54_0 and arg_51_1.time_ < 0 + var_54_0 + arg_54_0 then
				arg_51_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_51_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_51_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_51_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_51_1.actors_["1066ui_story"].transform.position).z)
				arg_51_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_51_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_51_1.actors_["1066ui_story"].transform.localEulerAngles = arg_51_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 then
				arg_51_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action6_2")
			end
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_1 + arg_54_0 then
				...
				local var_54_3 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910303013).content)

				arg_51_1.text_.text = var_54_3

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_5 = 48 <= 0 and var_54_2 or var_54_2 * (utf8.len(var_54_3) / 48)

				if (48 <= 0 and var_54_2 or var_54_2 * (utf8.len(var_54_3) / 48)) > 0 and var_54_2 < var_54_5 then
	...
	Play910303014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_1 + arg_58_0 then
				...
				local var_58_3 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910303014).content)
	...
	Play910303015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 <= arg_59_1.time_ and arg_59_1.time_ < 0 + var_62_0 then
				arg_59_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_59_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_59_1.time_ - 0) / var_62_0)
			...
			if arg_59_1.time_ >= 0 + var_62_0 and arg_59_1.time_ < 0 + var_62_0 + arg_62_0 then
				arg_59_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_59_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_59_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_59_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_59_1.actors_["1066ui_story"].transform.position).z)
				arg_59_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_59_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_59_1.actors_["1066ui_story"].transform.localEulerAngles = arg_59_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_4 + arg_62_0 then
				...
				local var_62_6 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(910303015).content)

				arg_59_1.text_.text = var_62_6

				LuaForUtil.ClearLinePrefixSymbol(arg_59_1.text_)

				local var_62_8 = 34 <= 0 and var_62_5 or var_62_5 * (utf8.len(var_62_6) / 34)

				if (34 <= 0 and var_62_5 or var_62_5 * (utf8.len(var_62_6) / 34)) > 0 and var_62_5 < var_62_8 then
	...
	Play910303016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= 0 + arg_66_0 then
				...
				local var_66_1 = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(910303016).content)
	...
	Play910303017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_1 + arg_70_0 then
				...
				local var_70_3 = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(910303017).content)
	...
	Play910303018 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= 0 + arg_74_0 then
				arg_71_1:PlayTimeline("1066ui_story", "StoryTimeline/CharAction/story1066/story1066action/1066action3_2")
			end
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_4 + arg_74_0 then
				...
				local var_74_6 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(910303018).content)

				arg_71_1.text_.text = var_74_6

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_8 = 23 <= 0 and var_74_5 or var_74_5 * (utf8.len(var_74_6) / 23)

				if (23 <= 0 and var_74_5 or var_74_5 * (utf8.len(var_74_6) / 23)) > 0 and var_74_5 < var_74_8 then
	...
	Play910303019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			...
			if 0 < arg_75_1.time_ and arg_75_1.time_ <= 0 + arg_78_0 then
				...
				local var_78_1 = arg_75_1:FormatText(arg_75_1:GetWordFromCfg(910303019).content)
		...
		function arg_79_1.onSingleLineUpdate_(arg_82_0)
			...
			if 0 <= arg_79_1.time_ and arg_79_1.time_ < 0 + var_82_0 and not isNil(arg_79_1.actors_["1066ui_story"]) then
				if arg_79_1.var_.characterEffect1066ui_story and not isNil(arg_79_1.actors_["1066ui_story"]) then
					...
					arg_79_1.var_.characterEffect1066ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_79_1.time_ - 0) / var_82_0)
				end
			end
			...
			if 0 < arg_79_1.time_ and arg_79_1.time_ <= var_82_1 + arg_82_0 then
				...
				local var_82_3 = arg_79_1:FormatText(arg_79_1:GetWordFromCfg(910303020).content)

				arg_79_1.text_.text = var_82_3

				LuaForUtil.ClearLinePrefixSymbol(arg_79_1.text_)

				local var_82_5 = 11 <= 0 and var_82_2 or var_82_2 * (utf8.len(var_82_3) / 11)

				if (11 <= 0 and var_82_2 or var_82_2 * (utf8.len(var_82_3) / 11)) > 0 and var_82_2 < var_82_5 then
	...
	Play910303021 = function(arg_83_0, arg_83_1)
		...
		function arg_83_1.onSingleLineUpdate_(arg_86_0)
			...
			if 0 < arg_83_1.time_ and arg_83_1.time_ <= 0 + arg_86_0 then
				...
				local var_86_1 = arg_83_1:FormatText(arg_83_1:GetWordFromCfg(910303021).content)
	...
	Play910303022 = function(arg_87_0, arg_87_1)
		...
		function arg_87_1.onSingleLineUpdate_(arg_90_0)
			...
			if 0 <= arg_87_1.time_ and arg_87_1.time_ < 0 + var_90_0 then
				arg_87_1.actors_["1066ui_story"].transform.localPosition = Vector3.Lerp(arg_87_1.var_.moveOldPos1066ui_story, Vector3.New(0, -0.77, -6.1), (arg_87_1.time_ - 0) / var_90_0)
			...
			if arg_87_1.time_ >= 0 + var_90_0 and arg_87_1.time_ < 0 + var_90_0 + arg_90_0 then
				arg_87_1.actors_["1066ui_story"].transform.localPosition = Vector3.New(0, -0.77, -6.1)
				arg_87_1.actors_["1066ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_87_1.actors_["1066ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_87_1.actors_["1066ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_87_1.actors_["1066ui_story"].transform.position).z)
				arg_87_1.actors_["1066ui_story"].transform.localEulerAngles.z = 0
				arg_87_1.actors_["1066ui_story"].transform.localEulerAngles.x = 0
				arg_87_1.actors_["1066ui_story"].transform.localEulerAngles = arg_87_1.actors_["1066ui_story"].transform.localEulerAngles
			...
			if 0 < arg_87_1.time_ and arg_87_1.time_ <= var_90_4 + arg_90_0 then
				...
				local var_90_6 = arg_87_1:FormatText(arg_87_1:GetWordFromCfg(910303022).content)
	...
	Play910303023 = function(arg_91_0, arg_91_1)
		...
		function arg_91_1.onSingleLineUpdate_(arg_94_0)
			...
			if 0 < arg_91_1.time_ and arg_91_1.time_ <= 0 + arg_94_0 then
				...
				local var_94_1 = arg_91_1:FormatText(arg_91_1:GetWordFromCfg(910303023).content)
	...
	Play910303024 = function(arg_95_0, arg_95_1)
		...
		function arg_95_1.onSingleLineUpdate_(arg_98_0)
			...
			if 0 < arg_95_1.time_ and arg_95_1.time_ <= var_98_1 + arg_98_0 then
				...
				local var_98_3 = arg_95_1:FormatText(arg_95_1:GetWordFromCfg(910303024).content)

				arg_95_1.text_.text = var_98_3

				LuaForUtil.ClearLinePrefixSymbol(arg_95_1.text_)

				local var_98_5 = 15 <= 0 and var_98_2 or var_98_2 * (utf8.len(var_98_3) / 15)

				if (15 <= 0 and var_98_2 or var_98_2 * (utf8.len(var_98_3) / 15)) > 0 and var_98_2 < var_98_5 then
