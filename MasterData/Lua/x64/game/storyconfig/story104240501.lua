	...
	Play424051018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0.3 < arg_73_1.time_ and arg_73_1.time_ <= 0.3 + arg_76_0 then
				...
				for iter_76_2, iter_76_3 in ipairs((var_76_5.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_76_3.transform.localScale = Vector3.New(iter_76_3.transform.localScale.x / var_76_7 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_76_3.transform.localScale.y / var_76_7, iter_76_3.transform.localScale.z)
				end
			end
			...
			if arg_73_1.time_ >= var_76_10 + 0.3 and arg_73_1.time_ < var_76_10 + 0.3 + arg_76_0 then
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_12 + arg_76_0 then
				...
				local var_76_15 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(424051018).content)

				arg_73_1.text_.text = var_76_15

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_17 = 27 <= 0 and var_76_13 or var_76_13 * (utf8.len(var_76_15) / 27)

				if (27 <= 0 and var_76_13 or var_76_13 * (utf8.len(var_76_15) / 27)) > 0 and var_76_13 < var_76_17 then
