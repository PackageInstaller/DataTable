return {
	Play419011001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(419011001).content)

				arg_1_1.text_.text = var_4_12

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_14 = 12 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 12)

				if (12 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 12)) > 0 and var_4_10 < var_4_14 then
	...
	Play419011002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(419011002).content)

				arg_7_1.text_.text = var_10_1

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_3 = 59 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 59)

				if (59 <= 0 and var_10_0 or var_10_0 * (utf8.len(var_10_1) / 59)) > 0 and var_10_0 < var_10_3 then
	...
	Play419011003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(419011003).content)

				arg_11_1.text_.text = var_14_1

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_3 = 63 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 63)

				if (63 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 63)) > 0 and var_14_0 < var_14_3 then
	...
	Play419011004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			if arg_15_1.actors_["2079ui_story"] == nil and not isNil((Asset.Load("Char/" .. "2079ui_story"))) then
				local var_18_0 = Object.Instantiate(Asset.Load("Char/" .. "2079ui_story"), arg_15_1.stage_.transform)

				var_18_0.name = "2079ui_story"
				var_18_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_15_1.actors_["2079ui_story"] = var_18_0
				...
				arg_15_1.var_["2079ui_story" .. "Animator"] = var_18_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_15_1.var_["2079ui_story" .. "Animator"].applyRootMotion = true
				arg_15_1.var_["2079ui_story" .. "LipSync"] = var_18_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_18_3 = arg_15_1.actors_["2079ui_story"].transform

			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				arg_15_1.var_.moveOldPos2079ui_story = var_18_3.localPosition
			end

			local var_18_4 = 0.001

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_4 then
				var_18_3.localPosition = Vector3.Lerp(arg_15_1.var_.moveOldPos2079ui_story, Vector3.New(0, -1.28, -5.6), (arg_15_1.time_ - 0) / var_18_4)
			...
			if arg_15_1.time_ >= 0 + var_18_4 and arg_15_1.time_ < 0 + var_18_4 + arg_18_0 then
				var_18_3.localPosition = Vector3.New(0, -1.28, -5.6)
				var_18_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_18_3.position).x, (manager.ui.mainCamera.transform.position - var_18_3.position).y, (manager.ui.mainCamera.transform.position - var_18_3.position).z)
				var_18_3.localEulerAngles.z = 0
				var_18_3.localEulerAngles.x = 0
				var_18_3.localEulerAngles = var_18_3.localEulerAngles
			...
			local var_18_5 = arg_15_1.actors_["2079ui_story"]

			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 and not isNil(var_18_5) and arg_15_1.var_.characterEffect2079ui_story == nil then
				arg_15_1.var_.characterEffect2079ui_story = var_18_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_18_6 = 0.200000002980232

			if 0 <= arg_15_1.time_ and arg_15_1.time_ < 0 + var_18_6 and not isNil(var_18_5) then
				if arg_15_1.var_.characterEffect2079ui_story and not isNil(var_18_5) then
					arg_15_1.var_.characterEffect2079ui_story.fillFlat = false
				end
			end

			if arg_15_1.time_ >= 0 + var_18_6 and arg_15_1.time_ < 0 + var_18_6 + arg_18_0 and not isNil(var_18_5) and arg_15_1.var_.characterEffect2079ui_story then
				arg_15_1.var_.characterEffect2079ui_story.fillFlat = false
			end
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_8 = arg_15_1.var_.characterEffect2079ui_story

				arg_15_1.var_.characterEffect2079ui_story.imageEffect:turnOff()
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_10 + arg_18_0 then
				...
				arg_15_1.leftNameTxt_.text = arg_15_1:FormatText(StoryNameCfg[646].name)
				...
				local var_18_12 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(419011004).content)

				arg_15_1.text_.text = var_18_12

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_14 = 18 <= 0 and var_18_11 or var_18_11 * (utf8.len(var_18_12) / 18)

				if (18 <= 0 and var_18_11 or var_18_11 * (utf8.len(var_18_12) / 18)) > 0 and var_18_11 < var_18_14 then
					arg_15_1.talkMaxDuration = var_18_14

					if var_18_14 + var_18_10 > arg_15_1.duration_ then
						arg_15_1.duration_ = var_18_14 + var_18_10
					end
				end
			...
			local var_18_15 = math.max(var_18_11, arg_15_1.talkMaxDuration)

			if var_18_10 <= arg_15_1.time_ and arg_15_1.time_ < var_18_10 + var_18_15 then
				arg_15_1.typewritter.percent = (arg_15_1.time_ - var_18_10) / var_18_15

				arg_15_1.typewritter:SetDirty()
			end

			if arg_15_1.time_ >= var_18_10 + var_18_15 and arg_15_1.time_ < var_18_10 + var_18_15 + arg_18_0 then
	...
	Play419011005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_1 + arg_22_0 then
				...
				arg_19_1.leftNameTxt_.text = arg_19_1:FormatText(StoryNameCfg[648].name)
				...
				local var_22_3 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(419011005).content)

				arg_19_1.text_.text = var_22_3

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_5 = 40 <= 0 and var_22_2 or var_22_2 * (utf8.len(var_22_3) / 40)

				if (40 <= 0 and var_22_2 or var_22_2 * (utf8.len(var_22_3) / 40)) > 0 and var_22_2 < var_22_5 then
	...
	Play419011006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				...
				arg_23_1.leftNameTxt_.text = arg_23_1:FormatText(StoryNameCfg[648].name)
				...
				local var_26_1 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(419011006).content)

				arg_23_1.text_.text = var_26_1

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_3 = 15 <= 0 and var_26_0 or var_26_0 * (utf8.len(var_26_1) / 15)

				if (15 <= 0 and var_26_0 or var_26_0 * (utf8.len(var_26_1) / 15)) > 0 and var_26_0 < var_26_3 then
	...
	Play419011007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 and not isNil(arg_27_1.actors_["2079ui_story"]) and arg_27_1.var_.characterEffect2079ui_story == nil then
				arg_27_1.var_.characterEffect2079ui_story = arg_27_1.actors_["2079ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_30_0 = 0.200000002980232

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_0 and not isNil(arg_27_1.actors_["2079ui_story"]) then
				if arg_27_1.var_.characterEffect2079ui_story and not isNil(arg_27_1.actors_["2079ui_story"]) then
					arg_27_1.var_.characterEffect2079ui_story.fillFlat = false
				end
			end

			if arg_27_1.time_ >= 0 + var_30_0 and arg_27_1.time_ < 0 + var_30_0 + arg_30_0 and not isNil(arg_27_1.actors_["2079ui_story"]) and arg_27_1.var_.characterEffect2079ui_story then
				arg_27_1.var_.characterEffect2079ui_story.fillFlat = false
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_2 + arg_30_0 then
				...
				arg_27_1.leftNameTxt_.text = arg_27_1:FormatText(StoryNameCfg[646].name)
				...
				local var_30_4 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(419011007).content)
	...
	Play419011008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= 0 + arg_34_0 and not isNil(arg_31_1.actors_["2079ui_story"]) and arg_31_1.var_.characterEffect2079ui_story == nil then
				arg_31_1.var_.characterEffect2079ui_story = arg_31_1.actors_["2079ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_34_0 = 0.200000002980232

			if 0 <= arg_31_1.time_ and arg_31_1.time_ < 0 + var_34_0 and not isNil(arg_31_1.actors_["2079ui_story"]) then
				if arg_31_1.var_.characterEffect2079ui_story and not isNil(arg_31_1.actors_["2079ui_story"]) then
					arg_31_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_31_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_31_1.time_ - 0) / var_34_0)
				end
			end

			if arg_31_1.time_ >= 0 + var_34_0 and arg_31_1.time_ < 0 + var_34_0 + arg_34_0 and not isNil(arg_31_1.actors_["2079ui_story"]) and arg_31_1.var_.characterEffect2079ui_story then
				arg_31_1.var_.characterEffect2079ui_story.fillFlat = true
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_1 + arg_34_0 then
				...
				arg_31_1.leftNameTxt_.text = arg_31_1:FormatText(StoryNameCfg[648].name)
				...
				local var_34_3 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(419011008).content)
	...
	Play419011009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				arg_35_1.var_.moveOldPos2079ui_story = arg_35_1.actors_["2079ui_story"].transform.localPosition
			end

			local var_38_0 = 0.001

			if 0 <= arg_35_1.time_ and arg_35_1.time_ < 0 + var_38_0 then
				arg_35_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_35_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_35_1.time_ - 0) / var_38_0)
				arg_35_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_35_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["2079ui_story"].transform.position).z)
				arg_35_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_35_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_35_1.actors_["2079ui_story"].transform.localEulerAngles = arg_35_1.actors_["2079ui_story"].transform.localEulerAngles
			end

			if arg_35_1.time_ >= 0 + var_38_0 and arg_35_1.time_ < 0 + var_38_0 + arg_38_0 then
				arg_35_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_35_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_35_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["2079ui_story"].transform.position).z)
				arg_35_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_35_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_35_1.actors_["2079ui_story"].transform.localEulerAngles = arg_35_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_1 + arg_38_0 then
				...
				local var_38_3 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(419011009).content)

				arg_35_1.text_.text = var_38_3

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_5 = 38 <= 0 and var_38_2 or var_38_2 * (utf8.len(var_38_3) / 38)

				if (38 <= 0 and var_38_2 or var_38_2 * (utf8.len(var_38_3) / 38)) > 0 and var_38_2 < var_38_5 then
	...
	Play419011010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 then
				arg_39_1.var_.moveOldPos2079ui_story = arg_39_1.actors_["2079ui_story"].transform.localPosition
			end

			local var_42_0 = 0.001

			if 0 <= arg_39_1.time_ and arg_39_1.time_ < 0 + var_42_0 then
				arg_39_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_39_1.var_.moveOldPos2079ui_story, Vector3.New(0, -1.28, -5.6), (arg_39_1.time_ - 0) / var_42_0)
				arg_39_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_39_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_39_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_39_1.actors_["2079ui_story"].transform.position).z)
				arg_39_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_39_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_39_1.actors_["2079ui_story"].transform.localEulerAngles = arg_39_1.actors_["2079ui_story"].transform.localEulerAngles
			end

			if arg_39_1.time_ >= 0 + var_42_0 and arg_39_1.time_ < 0 + var_42_0 + arg_42_0 then
				arg_39_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, -1.28, -5.6)
				arg_39_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_39_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_39_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_39_1.actors_["2079ui_story"].transform.position).z)
				arg_39_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_39_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_39_1.actors_["2079ui_story"].transform.localEulerAngles = arg_39_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			local var_42_1 = arg_39_1.actors_["2079ui_story"]

			if 0 < arg_39_1.time_ and arg_39_1.time_ <= 0 + arg_42_0 and not isNil(var_42_1) and arg_39_1.var_.characterEffect2079ui_story == nil then
				arg_39_1.var_.characterEffect2079ui_story = var_42_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_42_2 = 0.200000002980232

			if 0 <= arg_39_1.time_ and arg_39_1.time_ < 0 + var_42_2 and not isNil(var_42_1) then
				if arg_39_1.var_.characterEffect2079ui_story and not isNil(var_42_1) then
					arg_39_1.var_.characterEffect2079ui_story.fillFlat = false
				end
			end

			if arg_39_1.time_ >= 0 + var_42_2 and arg_39_1.time_ < 0 + var_42_2 + arg_42_0 and not isNil(var_42_1) and arg_39_1.var_.characterEffect2079ui_story then
				arg_39_1.var_.characterEffect2079ui_story.fillFlat = false
			end
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_4 + arg_42_0 then
				...
				arg_39_1.leftNameTxt_.text = arg_39_1:FormatText(StoryNameCfg[646].name)
				...
				local var_42_6 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(419011010).content)

				arg_39_1.text_.text = var_42_6

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_8 = 44 <= 0 and var_42_5 or var_42_5 * (utf8.len(var_42_6) / 44)

				if (44 <= 0 and var_42_5 or var_42_5 * (utf8.len(var_42_6) / 44)) > 0 and var_42_5 < var_42_8 then
	...
	Play419011011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_1 + arg_46_0 then
				...
				arg_43_1.leftNameTxt_.text = arg_43_1:FormatText(StoryNameCfg[648].name)
				...
				local var_46_3 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(419011011).content)

				arg_43_1.text_.text = var_46_3

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_5 = 32 <= 0 and var_46_2 or var_46_2 * (utf8.len(var_46_3) / 32)

				if (32 <= 0 and var_46_2 or var_46_2 * (utf8.len(var_46_3) / 32)) > 0 and var_46_2 < var_46_5 then
	...
	Play419011012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= 0 + arg_50_0 then
				...
				local var_50_1 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(419011012).content)
	...
	Play419011013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 then
				...
				arg_51_1.leftNameTxt_.text = arg_51_1:FormatText(StoryNameCfg[648].name)
				...
				local var_54_1 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(419011013).content)

				arg_51_1.text_.text = var_54_1

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_3 = 11 <= 0 and var_54_0 or var_54_0 * (utf8.len(var_54_1) / 11)

				if (11 <= 0 and var_54_0 or var_54_0 * (utf8.len(var_54_1) / 11)) > 0 and var_54_0 < var_54_3 then
	...
	Play419011014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_4 + arg_58_0 then
				...
				local var_58_6 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(419011014).content)

				arg_55_1.text_.text = var_58_6

				LuaForUtil.ClearLinePrefixSymbol(arg_55_1.text_)

				local var_58_8 = 10 <= 0 and var_58_5 or var_58_5 * (utf8.len(var_58_6) / 10)

				if (10 <= 0 and var_58_5 or var_58_5 * (utf8.len(var_58_6) / 10)) > 0 and var_58_5 < var_58_8 then
	...
	Play419011015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 <= arg_59_1.time_ and arg_59_1.time_ < 0 + var_62_0 then
				arg_59_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_59_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_59_1.time_ - 0) / var_62_0)
			...
			if arg_59_1.time_ >= 0 + var_62_0 and arg_59_1.time_ < 0 + var_62_0 + arg_62_0 then
				arg_59_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_59_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_59_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_59_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_59_1.actors_["2079ui_story"].transform.position).z)
				arg_59_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_59_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_59_1.actors_["2079ui_story"].transform.localEulerAngles = arg_59_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_59_1.time_ and arg_59_1.time_ < 0 + var_62_2 and not isNil(var_62_1) then
				if arg_59_1.var_.characterEffect2079ui_story and not isNil(var_62_1) then
					...
					arg_59_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_59_1.time_ - 0) / var_62_2)
				end
			end
			...
			local var_62_3 = manager.ui.mainCamera.transform

			if 0.034000001847744 < arg_59_1.time_ and arg_59_1.time_ <= 0.034000001847744 + arg_62_0 then
				arg_59_1.var_.shakeOldPos = var_62_3.localPosition
			end

			local var_62_4 = 1.2

			if 0.034000001847744 <= arg_59_1.time_ and arg_59_1.time_ < 0.034000001847744 + var_62_4 then
				local var_62_5, var_62_6 = math.modf((arg_59_1.time_ - 0.034000001847744) / 0.066)

				var_62_3.localPosition = Vector3.New(var_62_6 * 0.13, var_62_6 * 0.13, var_62_6 * 0.13) + arg_59_1.var_.shakeOldPos
			end

			if arg_59_1.time_ >= 0.034000001847744 + var_62_4 and arg_59_1.time_ < 0.034000001847744 + var_62_4 + arg_62_0 then
				var_62_3.localPosition = arg_59_1.var_.shakeOldPos
			end

			local var_62_7 = 0.034000001847744

			if 0.034000001847744 < arg_59_1.time_ and arg_59_1.time_ <= var_62_7 + arg_62_0 then
				arg_59_1.allBtn_.enabled = false
			end

			if arg_59_1.time_ >= var_62_7 + 1.86666666368643 and arg_59_1.time_ < var_62_7 + 1.86666666368643 + arg_62_0 then
				arg_59_1.allBtn_.enabled = true
			end

			if 0.434000001847744 < arg_59_1.time_ and arg_59_1.time_ <= 0.434000001847744 + arg_62_0 then
				local var_62_8 = arg_59_1.var_.effect456

				if not arg_59_1.var_.effect456 then
					var_62_8 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), manager.ui.mainCamera.transform)
					var_62_8.name = "456"
					arg_59_1.var_.effect456 = var_62_8
				else
					var_62_8.transform:SetParent(var_62_9003)
				end

				var_62_8.transform.localPosition = Vector3.New(0, -0.29, -0.76)
				var_62_8.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_62_10 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_62_0, iter_62_1 in ipairs((var_62_8.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_62_1.transform.localScale = Vector3.New(iter_62_1.transform.localScale.x / var_62_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_62_1.transform.localScale.y / var_62_10, iter_62_1.transform.localScale.z)
				end
			end

			if 0.567333332200845 < arg_59_1.time_ and arg_59_1.time_ <= 0.567333332200845 + arg_62_0 then
				local var_62_12 = arg_59_1.var_.effect457

				if not arg_59_1.var_.effect457 then
					var_62_12 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), manager.ui.mainCamera.transform)
					var_62_12.name = "457"
					arg_59_1.var_.effect457 = var_62_12
				else
					var_62_12.transform:SetParent(var_62_9002)
				end

				var_62_12.transform.localPosition = Vector3.New(0, -0.29, -0.76)
				var_62_12.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_62_14 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_62_2, iter_62_3 in ipairs((var_62_12.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_62_3.transform.localScale = Vector3.New(iter_62_3.transform.localScale.x / var_62_14 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_62_3.transform.localScale.y / var_62_14, iter_62_3.transform.localScale.z)
				end
			end

			if 0.700666665534178 < arg_59_1.time_ and arg_59_1.time_ <= 0.700666665534178 + arg_62_0 then
				local var_62_16 = arg_59_1.var_.effect458

				if not arg_59_1.var_.effect458 then
					var_62_16 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), manager.ui.mainCamera.transform)
					var_62_16.name = "458"
					arg_59_1.var_.effect458 = var_62_16
				else
					var_62_16.transform:SetParent(var_62_9001)
				end

				var_62_16.transform.localPosition = Vector3.New(0, -0.29, -0.76)
				var_62_16.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_62_18 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_62_4, iter_62_5 in ipairs((var_62_16.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_62_5.transform.localScale = Vector3.New(iter_62_5.transform.localScale.x / var_62_18 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_62_5.transform.localScale.y / var_62_18, iter_62_5.transform.localScale.z)
				end
			end

			if 0.834000001847744 < arg_59_1.time_ and arg_59_1.time_ <= 0.834000001847744 + arg_62_0 then
				local var_62_20 = arg_59_1.var_.effect459

				if not arg_59_1.var_.effect459 then
					var_62_20 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"), manager.ui.mainCamera.transform)
					var_62_20.name = "459"
					arg_59_1.var_.effect459 = var_62_20
				else
					var_62_20.transform:SetParent(var_62_9000)
				end

				var_62_20.transform.localPosition = Vector3.New(0, -0.29, -0.76)
				var_62_20.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_62_22 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_62_6, iter_62_7 in ipairs((var_62_20.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_62_7.transform.localScale = Vector3.New(iter_62_7.transform.localScale.x / var_62_22 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_62_7.transform.localScale.y / var_62_22, iter_62_7.transform.localScale.z)
				end
			end

			local var_62_24 = 0

			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_24 + arg_62_0 then
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= 0 + arg_62_0 then
				...
				local var_62_28 = arg_59_1.var_.characterEffect2079ui_story

				arg_59_1.var_.characterEffect2079ui_story.imageEffect:turnOff()

				var_62_28.interferenceEffect.enabled = false
				var_62_28.interferenceEffect.noise = 0.001
				var_62_28.interferenceEffect.simTimeScale = 1
				var_62_28.interferenceEffect.geometryOutlineColor = Color.New(0.3725, 0.88, 1, 1)
			end
			...
			local var_62_30 = 1.33333333333333
			local var_62_31 = 0.975

			if 1.33333333333333 < arg_59_1.time_ and arg_59_1.time_ <= var_62_30 + arg_62_0 then
				...
				local var_62_33 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(419011015).content)

				arg_59_1.text_.text = var_62_33

				LuaForUtil.ClearLinePrefixSymbol(arg_59_1.text_)

				local var_62_35 = 39 <= 0 and var_62_31 or var_62_31 * (utf8.len(var_62_33) / 39)

				if (39 <= 0 and var_62_31 or var_62_31 * (utf8.len(var_62_33) / 39)) > 0 and var_62_31 < var_62_35 then
					arg_59_1.talkMaxDuration = var_62_35
					var_62_30 = var_62_30 + 0.3

					if var_62_35 + var_62_30 > arg_59_1.duration_ then
						arg_59_1.duration_ = var_62_35 + var_62_30
					end
				end
			...
			local var_62_36 = var_62_30 + 0.3
			local var_62_37 = math.max(var_62_31, arg_59_1.talkMaxDuration)

			if var_62_30 + 0.3 <= arg_59_1.time_ and arg_59_1.time_ < var_62_36 + var_62_37 then
				arg_59_1.typewritter.percent = (arg_59_1.time_ - var_62_36) / var_62_37
	...
	Play419011016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				...
				local var_68_1 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(419011016).content)

				arg_65_1.text_.text = var_68_1

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_3 = 50 <= 0 and var_68_0 or var_68_0 * (utf8.len(var_68_1) / 50)

				if (50 <= 0 and var_68_0 or var_68_0 * (utf8.len(var_68_1) / 50)) > 0 and var_68_0 < var_68_3 then
	...
	Play419011017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			if arg_69_1.bgs_.ST2101 == nil then
				local var_72_0 = Object.Instantiate(arg_69_1.paintGo_)

				var_72_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "ST2101")
				var_72_0.name = "ST2101"
				var_72_0.transform.parent = arg_69_1.stage_.transform
				var_72_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_69_1.bgs_.ST2101 = var_72_0
			end

			if 2 < arg_69_1.time_ and arg_69_1.time_ <= 2 + arg_72_0 then
				local var_72_1 = arg_69_1.bgs_.ST2101

				arg_69_1.bgs_.ST2101.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_72_13 = "1095ui_story"

			if arg_69_1.actors_["1095ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1095ui_story"))) then
				local var_72_14 = Object.Instantiate(Asset.Load("Char/" .. "1095ui_story"), arg_69_1.stage_.transform)

				var_72_14.name = var_72_13
				var_72_14.transform.localPosition = Vector3.New(0, 100, 0)
				arg_69_1.actors_[var_72_13] = var_72_14

				local var_72_15 = var_72_14:GetComponentInChildren(typeof(CharacterEffect))

				var_72_15.enabled = true

				local var_72_16 = GameObjectTools.GetOrAddComponent(var_72_14, typeof(DynamicBoneHelper))

				if var_72_16 then
					var_72_16:EnableDynamicBone(false)
				end

				arg_69_1:ShowWeapon(var_72_15.transform, false)

				arg_69_1.var_[var_72_13 .. "Animator"] = var_72_15.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_69_1.var_[var_72_13 .. "Animator"].applyRootMotion = true
				arg_69_1.var_[var_72_13 .. "LipSync"] = var_72_15.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_72_17 = arg_69_1.actors_["1095ui_story"].transform

			if 3.83333333333333 < arg_69_1.time_ and arg_69_1.time_ <= 3.83333333333333 + arg_72_0 then
				arg_69_1.var_.moveOldPos1095ui_story = var_72_17.localPosition
			end

			local var_72_18 = 0.001

			if 3.83333333333333 <= arg_69_1.time_ and arg_69_1.time_ < 3.83333333333333 + var_72_18 then
				var_72_17.localPosition = Vector3.Lerp(arg_69_1.var_.moveOldPos1095ui_story, Vector3.New(0, -0.98, -6.1), (arg_69_1.time_ - 3.83333333333333) / var_72_18)
				var_72_17.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_72_17.position).x, (manager.ui.mainCamera.transform.position - var_72_17.position).y, (manager.ui.mainCamera.transform.position - var_72_17.position).z)
				var_72_17.localEulerAngles.z = 0
				var_72_17.localEulerAngles.x = 0
				var_72_17.localEulerAngles = var_72_17.localEulerAngles
			end

			if arg_69_1.time_ >= 3.83333333333333 + var_72_18 and arg_69_1.time_ < 3.83333333333333 + var_72_18 + arg_72_0 then
				var_72_17.localPosition = Vector3.New(0, -0.98, -6.1)
				var_72_17.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_72_17.position).x, (manager.ui.mainCamera.transform.position - var_72_17.position).y, (manager.ui.mainCamera.transform.position - var_72_17.position).z)
				var_72_17.localEulerAngles.z = 0
				var_72_17.localEulerAngles.x = 0
				var_72_17.localEulerAngles = var_72_17.localEulerAngles
			...
			local var_72_19 = arg_69_1.actors_["1095ui_story"]

			if 3.83333333333333 < arg_69_1.time_ and arg_69_1.time_ <= 3.83333333333333 + arg_72_0 and not isNil(var_72_19) and arg_69_1.var_.characterEffect1095ui_story == nil then
				arg_69_1.var_.characterEffect1095ui_story = var_72_19:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_72_20 = 0.200000002980232

			if 3.83333333333333 <= arg_69_1.time_ and arg_69_1.time_ < 3.83333333333333 + var_72_20 and not isNil(var_72_19) then
				if arg_69_1.var_.characterEffect1095ui_story and not isNil(var_72_19) then
					arg_69_1.var_.characterEffect1095ui_story.fillFlat = false
				end
			end

			if arg_69_1.time_ >= 3.83333333333333 + var_72_20 and arg_69_1.time_ < 3.83333333333333 + var_72_20 + arg_72_0 and not isNil(var_72_19) and arg_69_1.var_.characterEffect1095ui_story then
				arg_69_1.var_.characterEffect1095ui_story.fillFlat = false
			end
			...
			if 0.466666666666667 < arg_69_1.time_ and arg_69_1.time_ <= 0.466666666666667 + arg_72_0 then
				arg_69_1:AudioAction("stop", "effect", "se_story_142", "se_story_142_amb_wild", "")
			end

			if 0.466666666666667 < arg_69_1.time_ and arg_69_1.time_ <= 0.466666666666667 + arg_72_0 then
				arg_69_1:AudioAction("stop", "effect", "se_story_140", "se_story_140_amb_drone03", "")
			end

			if 1.66666666666667 < arg_69_1.time_ and arg_69_1.time_ <= 1.66666666666667 + arg_72_0 then
				arg_69_1:AudioAction("play", "effect", "se_story_142", "se_story_142_amb_command room", "")
			end
			...
			if 4 < arg_69_1.time_ and arg_69_1.time_ <= var_72_25 + arg_72_0 then
				...
				local var_72_28 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(419011017).content)

				arg_69_1.text_.text = var_72_28

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_30 = 5 <= 0 and var_72_26 or var_72_26 * (utf8.len(var_72_28) / 5)

				if (5 <= 0 and var_72_26 or var_72_26 * (utf8.len(var_72_28) / 5)) > 0 and var_72_26 < var_72_30 then
					arg_69_1.talkMaxDuration = var_72_30
					var_72_25 = var_72_25 + 0.3

					if var_72_30 + var_72_25 > arg_69_1.duration_ then
						arg_69_1.duration_ = var_72_30 + var_72_25
					end
				end
			...
			local var_72_31 = var_72_25 + 0.3
			local var_72_32 = math.max(var_72_26, arg_69_1.talkMaxDuration)

			if var_72_25 + 0.3 <= arg_69_1.time_ and arg_69_1.time_ < var_72_31 + var_72_32 then
	...
	Play419011018 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			...
			if 0 < arg_75_1.time_ and arg_75_1.time_ <= var_78_1 + arg_78_0 then
				...
				local var_78_3 = arg_75_1:FormatText(arg_75_1:GetWordFromCfg(419011018).content)
	...
	Play419011019 = function(arg_79_0, arg_79_1)
		...
		function arg_79_1.onSingleLineUpdate_(arg_82_0)
			...
			if 0 <= arg_79_1.time_ and arg_79_1.time_ < 0 + var_82_0 then
				arg_79_1.actors_["1095ui_story"].transform.localPosition = Vector3.Lerp(arg_79_1.var_.moveOldPos1095ui_story, Vector3.New(0, 100, 0), (arg_79_1.time_ - 0) / var_82_0)
			...
			if arg_79_1.time_ >= 0 + var_82_0 and arg_79_1.time_ < 0 + var_82_0 + arg_82_0 then
				arg_79_1.actors_["1095ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_79_1.actors_["1095ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_79_1.actors_["1095ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_79_1.actors_["1095ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_79_1.actors_["1095ui_story"].transform.position).z)
				arg_79_1.actors_["1095ui_story"].transform.localEulerAngles.z = 0
				arg_79_1.actors_["1095ui_story"].transform.localEulerAngles.x = 0
				arg_79_1.actors_["1095ui_story"].transform.localEulerAngles = arg_79_1.actors_["1095ui_story"].transform.localEulerAngles
			...
			if 0 < arg_79_1.time_ and arg_79_1.time_ <= var_82_1 + arg_82_0 then
				...
				local var_82_3 = arg_79_1:FormatText(arg_79_1:GetWordFromCfg(419011019).content)

				arg_79_1.text_.text = var_82_3

				LuaForUtil.ClearLinePrefixSymbol(arg_79_1.text_)

				local var_82_5 = 43 <= 0 and var_82_2 or var_82_2 * (utf8.len(var_82_3) / 43)

				if (43 <= 0 and var_82_2 or var_82_2 * (utf8.len(var_82_3) / 43)) > 0 and var_82_2 < var_82_5 then
	...
	Play419011020 = function(arg_83_0, arg_83_1)
		...
		function arg_83_1.onSingleLineUpdate_(arg_86_0)
			...
			if 0 < arg_83_1.time_ and arg_83_1.time_ <= var_86_4 + arg_86_0 then
				...
				arg_83_1.leftNameTxt_.text = arg_83_1:FormatText(StoryNameCfg[646].name)
				...
				local var_86_6 = arg_83_1:FormatText(arg_83_1:GetWordFromCfg(419011020).content)

				arg_83_1.text_.text = var_86_6

				LuaForUtil.ClearLinePrefixSymbol(arg_83_1.text_)

				local var_86_8 = 56 <= 0 and var_86_5 or var_86_5 * (utf8.len(var_86_6) / 56)

				if (56 <= 0 and var_86_5 or var_86_5 * (utf8.len(var_86_6) / 56)) > 0 and var_86_5 < var_86_8 then
	...
	Play419011021 = function(arg_87_0, arg_87_1)
		...
		function arg_87_1.onSingleLineUpdate_(arg_90_0)
			...
			if 0 < arg_87_1.time_ and arg_87_1.time_ <= 0 + arg_90_0 then
				...
				arg_87_1.leftNameTxt_.text = arg_87_1:FormatText(StoryNameCfg[646].name)
				...
				local var_90_1 = arg_87_1:FormatText(arg_87_1:GetWordFromCfg(419011021).content)
	...
	Play419011022 = function(arg_91_0, arg_91_1)
		...
		function arg_91_1.onSingleLineUpdate_(arg_94_0)
			...
			if 0 <= arg_91_1.time_ and arg_91_1.time_ < 0 + var_94_0 then
				arg_91_1.actors_["1095ui_story"].transform.localPosition = Vector3.Lerp(arg_91_1.var_.moveOldPos1095ui_story, Vector3.New(0, -0.98, -6.1), (arg_91_1.time_ - 0) / var_94_0)
			...
			if arg_91_1.time_ >= 0 + var_94_0 and arg_91_1.time_ < 0 + var_94_0 + arg_94_0 then
				arg_91_1.actors_["1095ui_story"].transform.localPosition = Vector3.New(0, -0.98, -6.1)
				arg_91_1.actors_["1095ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_91_1.actors_["1095ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_91_1.actors_["1095ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_91_1.actors_["1095ui_story"].transform.position).z)
				arg_91_1.actors_["1095ui_story"].transform.localEulerAngles.z = 0
				arg_91_1.actors_["1095ui_story"].transform.localEulerAngles.x = 0
				arg_91_1.actors_["1095ui_story"].transform.localEulerAngles = arg_91_1.actors_["1095ui_story"].transform.localEulerAngles
			...
			local var_94_1 = arg_91_1.actors_["2079ui_story"].transform

			if 0 < arg_91_1.time_ and arg_91_1.time_ <= 0 + arg_94_0 then
				arg_91_1.var_.moveOldPos2079ui_story = var_94_1.localPosition
			end

			local var_94_2 = 0.001

			if 0 <= arg_91_1.time_ and arg_91_1.time_ < 0 + var_94_2 then
				var_94_1.localPosition = Vector3.Lerp(arg_91_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_91_1.time_ - 0) / var_94_2)
			...
			local var_94_3 = arg_91_1.actors_["1095ui_story"]

			if 0 < arg_91_1.time_ and arg_91_1.time_ <= 0 + arg_94_0 and not isNil(var_94_3) and arg_91_1.var_.characterEffect1095ui_story == nil then
				arg_91_1.var_.characterEffect1095ui_story = var_94_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_94_4 = 0.200000002980232

			if 0 <= arg_91_1.time_ and arg_91_1.time_ < 0 + var_94_4 and not isNil(var_94_3) then
				if arg_91_1.var_.characterEffect1095ui_story and not isNil(var_94_3) then
					arg_91_1.var_.characterEffect1095ui_story.fillFlat = false
				end
			end

			if arg_91_1.time_ >= 0 + var_94_4 and arg_91_1.time_ < 0 + var_94_4 + arg_94_0 and not isNil(var_94_3) and arg_91_1.var_.characterEffect1095ui_story then
				arg_91_1.var_.characterEffect1095ui_story.fillFlat = false
			end

			local var_94_6 = arg_91_1.actors_["2079ui_story"]

			if 0 < arg_91_1.time_ and arg_91_1.time_ <= 0 + arg_94_0 and not isNil(var_94_6) and arg_91_1.var_.characterEffect2079ui_story == nil then
				arg_91_1.var_.characterEffect2079ui_story = var_94_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_94_7 = 0.200000002980232

			if 0 <= arg_91_1.time_ and arg_91_1.time_ < 0 + var_94_7 and not isNil(var_94_6) then
				if arg_91_1.var_.characterEffect2079ui_story and not isNil(var_94_6) then
					arg_91_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_91_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_91_1.time_ - 0) / var_94_7)
				end
			end

			if arg_91_1.time_ >= 0 + var_94_7 and arg_91_1.time_ < 0 + var_94_7 + arg_94_0 and not isNil(var_94_6) and arg_91_1.var_.characterEffect2079ui_story then
				arg_91_1.var_.characterEffect2079ui_story.fillFlat = true
			...
			if 0 < arg_91_1.time_ and arg_91_1.time_ <= var_94_8 + arg_94_0 then
				...
				local var_94_10 = arg_91_1:FormatText(arg_91_1:GetWordFromCfg(419011022).content)

				arg_91_1.text_.text = var_94_10

				LuaForUtil.ClearLinePrefixSymbol(arg_91_1.text_)

				local var_94_12 = 54 <= 0 and var_94_9 or var_94_9 * (utf8.len(var_94_10) / 54)

				if (54 <= 0 and var_94_9 or var_94_9 * (utf8.len(var_94_10) / 54)) > 0 and var_94_9 < var_94_12 then
	...
	Play419011023 = function(arg_95_0, arg_95_1)
		...
		function arg_95_1.onSingleLineUpdate_(arg_98_0)
			...
			if 0 < arg_95_1.time_ and arg_95_1.time_ <= 0 + arg_98_0 then
				...
				local var_98_1 = arg_95_1:FormatText(arg_95_1:GetWordFromCfg(419011023).content)
	...
	Play419011024 = function(arg_99_0, arg_99_1)
		...
		function arg_99_1.onSingleLineUpdate_(arg_102_0)
			...
			if 0 < arg_99_1.time_ and arg_99_1.time_ <= var_102_1 + arg_102_0 then
				...
				arg_99_1.leftNameTxt_.text = arg_99_1:FormatText(StoryNameCfg[646].name)
				...
				local var_102_3 = arg_99_1:FormatText(arg_99_1:GetWordFromCfg(419011024).content)
	...
	Play419011025 = function(arg_103_0, arg_103_1)
		...
		function arg_103_1.onSingleLineUpdate_(arg_106_0)
			...
			local var_106_4 = arg_103_1.actors_["2079ui_story"]

			if 0 < arg_103_1.time_ and arg_103_1.time_ <= 0 + arg_106_0 and not isNil(var_106_4) and arg_103_1.var_.characterEffect2079ui_story == nil then
				arg_103_1.var_.characterEffect2079ui_story = var_106_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_106_5 = 0.200000002980232

			if 0 <= arg_103_1.time_ and arg_103_1.time_ < 0 + var_106_5 and not isNil(var_106_4) then
				if arg_103_1.var_.characterEffect2079ui_story and not isNil(var_106_4) then
					arg_103_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_103_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_103_1.time_ - 0) / var_106_5)
				end
			end

			if arg_103_1.time_ >= 0 + var_106_5 and arg_103_1.time_ < 0 + var_106_5 + arg_106_0 and not isNil(var_106_4) and arg_103_1.var_.characterEffect2079ui_story then
				arg_103_1.var_.characterEffect2079ui_story.fillFlat = true
				arg_103_1.var_.characterEffect2079ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_103_1.time_ and arg_103_1.time_ <= var_106_6 + arg_106_0 then
				...
				local var_106_8 = arg_103_1:FormatText(arg_103_1:GetWordFromCfg(419011025).content)

				arg_103_1.text_.text = var_106_8

				LuaForUtil.ClearLinePrefixSymbol(arg_103_1.text_)

				local var_106_10 = 6 <= 0 and var_106_7 or var_106_7 * (utf8.len(var_106_8) / 6)

				if (6 <= 0 and var_106_7 or var_106_7 * (utf8.len(var_106_8) / 6)) > 0 and var_106_7 < var_106_10 then
	...
	Play419011026 = function(arg_107_0, arg_107_1)
		...
		function arg_107_1.onSingleLineUpdate_(arg_110_0)
			...
			local var_110_2 = arg_107_1.actors_["1095ui_story"]

			if 0 < arg_107_1.time_ and arg_107_1.time_ <= 0 + arg_110_0 and not isNil(var_110_2) and arg_107_1.var_.characterEffect1095ui_story == nil then
				arg_107_1.var_.characterEffect1095ui_story = var_110_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_110_3 = 0.200000002980232

			if 0 <= arg_107_1.time_ and arg_107_1.time_ < 0 + var_110_3 and not isNil(var_110_2) then
				if arg_107_1.var_.characterEffect1095ui_story and not isNil(var_110_2) then
					arg_107_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_107_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_107_1.time_ - 0) / var_110_3)
				end
			end

			if arg_107_1.time_ >= 0 + var_110_3 and arg_107_1.time_ < 0 + var_110_3 + arg_110_0 and not isNil(var_110_2) and arg_107_1.var_.characterEffect1095ui_story then
				arg_107_1.var_.characterEffect1095ui_story.fillFlat = true
			...
			if 0 < arg_107_1.time_ and arg_107_1.time_ <= var_110_4 + arg_110_0 then
				...
				arg_107_1.leftNameTxt_.text = arg_107_1:FormatText(StoryNameCfg[646].name)
				...
				local var_110_6 = arg_107_1:FormatText(arg_107_1:GetWordFromCfg(419011026).content)

				arg_107_1.text_.text = var_110_6

				LuaForUtil.ClearLinePrefixSymbol(arg_107_1.text_)

				local var_110_8 = 46 <= 0 and var_110_5 or var_110_5 * (utf8.len(var_110_6) / 46)

				if (46 <= 0 and var_110_5 or var_110_5 * (utf8.len(var_110_6) / 46)) > 0 and var_110_5 < var_110_8 then
	...
	Play419011027 = function(arg_111_0, arg_111_1)
		...
		function arg_111_1.onSingleLineUpdate_(arg_114_0)
			...
			if 0 < arg_111_1.time_ and arg_111_1.time_ <= 0 + arg_114_0 then
				...
				arg_111_1.leftNameTxt_.text = arg_111_1:FormatText(StoryNameCfg[646].name)
				...
				local var_114_1 = arg_111_1:FormatText(arg_111_1:GetWordFromCfg(419011027).content)

				arg_111_1.text_.text = var_114_1

				LuaForUtil.ClearLinePrefixSymbol(arg_111_1.text_)

				local var_114_3 = 29 <= 0 and var_114_0 or var_114_0 * (utf8.len(var_114_1) / 29)

				if (29 <= 0 and var_114_0 or var_114_0 * (utf8.len(var_114_1) / 29)) > 0 and var_114_0 < var_114_3 then
	...
	Play419011028 = function(arg_115_0, arg_115_1)
		...
		function arg_115_1.onSingleLineUpdate_(arg_118_0)
			...
			if 0 <= arg_115_1.time_ and arg_115_1.time_ < 0 + var_118_0 then
				arg_115_1.actors_["1095ui_story"].transform.localPosition = Vector3.Lerp(arg_115_1.var_.moveOldPos1095ui_story, Vector3.New(0, -0.98, -6.1), (arg_115_1.time_ - 0) / var_118_0)
			...
			if arg_115_1.time_ >= 0 + var_118_0 and arg_115_1.time_ < 0 + var_118_0 + arg_118_0 then
				arg_115_1.actors_["1095ui_story"].transform.localPosition = Vector3.New(0, -0.98, -6.1)
				arg_115_1.actors_["1095ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_115_1.actors_["1095ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_115_1.actors_["1095ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_115_1.actors_["1095ui_story"].transform.position).z)
				arg_115_1.actors_["1095ui_story"].transform.localEulerAngles.z = 0
				arg_115_1.actors_["1095ui_story"].transform.localEulerAngles.x = 0
				arg_115_1.actors_["1095ui_story"].transform.localEulerAngles = arg_115_1.actors_["1095ui_story"].transform.localEulerAngles
			...
			local var_118_4 = arg_115_1.actors_["2079ui_story"]

			if 0 < arg_115_1.time_ and arg_115_1.time_ <= 0 + arg_118_0 and not isNil(var_118_4) and arg_115_1.var_.characterEffect2079ui_story == nil then
				arg_115_1.var_.characterEffect2079ui_story = var_118_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_118_5 = 0.200000002980232

			if 0 <= arg_115_1.time_ and arg_115_1.time_ < 0 + var_118_5 and not isNil(var_118_4) then
				if arg_115_1.var_.characterEffect2079ui_story and not isNil(var_118_4) then
					arg_115_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_115_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_115_1.time_ - 0) / var_118_5)
				end
			end

			if arg_115_1.time_ >= 0 + var_118_5 and arg_115_1.time_ < 0 + var_118_5 + arg_118_0 and not isNil(var_118_4) and arg_115_1.var_.characterEffect2079ui_story then
				arg_115_1.var_.characterEffect2079ui_story.fillFlat = true
			...
			if 0 < arg_115_1.time_ and arg_115_1.time_ <= var_118_6 + arg_118_0 then
				...
				local var_118_8 = arg_115_1:FormatText(arg_115_1:GetWordFromCfg(419011028).content)
	...
	Play419011029 = function(arg_119_0, arg_119_1)
		...
		function arg_119_1.onSingleLineUpdate_(arg_122_0)
			...
			local var_122_1 = arg_119_1.actors_["2079ui_story"].transform

			if 0 < arg_119_1.time_ and arg_119_1.time_ <= 0 + arg_122_0 then
				arg_119_1.var_.moveOldPos2079ui_story = var_122_1.localPosition
			end

			local var_122_2 = 0.001

			if 0 <= arg_119_1.time_ and arg_119_1.time_ < 0 + var_122_2 then
				var_122_1.localPosition = Vector3.Lerp(arg_119_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_119_1.time_ - 0) / var_122_2)
			...
			local var_122_3 = arg_119_1.actors_["1095ui_story"].transform

			if 0 < arg_119_1.time_ and arg_119_1.time_ <= 0 + arg_122_0 then
				arg_119_1.var_.moveOldPos1095ui_story = var_122_3.localPosition
			end

			local var_122_4 = 0.001

			if 0 <= arg_119_1.time_ and arg_119_1.time_ < 0 + var_122_4 then
				var_122_3.localPosition = Vector3.Lerp(arg_119_1.var_.moveOldPos1095ui_story, Vector3.New(0, 100, 0), (arg_119_1.time_ - 0) / var_122_4)
			...
			if 0 < arg_119_1.time_ and arg_119_1.time_ <= var_122_5 + arg_122_0 then
				...
				local var_122_7 = arg_119_1:FormatText(arg_119_1:GetWordFromCfg(419011029).content)

				arg_119_1.text_.text = var_122_7

				LuaForUtil.ClearLinePrefixSymbol(arg_119_1.text_)

				local var_122_9 = 26 <= 0 and var_122_6 or var_122_6 * (utf8.len(var_122_7) / 26)

				if (26 <= 0 and var_122_6 or var_122_6 * (utf8.len(var_122_7) / 26)) > 0 and var_122_6 < var_122_9 then
	...
	Play419011030 = function(arg_123_0, arg_123_1)
		...
		function arg_123_1.onSingleLineUpdate_(arg_126_0)
			...
			if 0 < arg_123_1.time_ and arg_123_1.time_ <= 0 + arg_126_0 then
				...
				local var_126_1 = arg_123_1:FormatText(arg_123_1:GetWordFromCfg(419011030).content)
	...
	Play419011031 = function(arg_127_0, arg_127_1)
		...
		function arg_127_1.onSingleLineUpdate_(arg_130_0)
			if 0 < arg_127_1.time_ and arg_127_1.time_ <= 0 + arg_130_0 then
				arg_127_1.var_.moveOldPos2079ui_story = arg_127_1.actors_["2079ui_story"].transform.localPosition
			end

			local var_130_0 = 0.001

			if 0 <= arg_127_1.time_ and arg_127_1.time_ < 0 + var_130_0 then
				arg_127_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_127_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_127_1.time_ - 0) / var_130_0)
				arg_127_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_127_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_127_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_127_1.actors_["2079ui_story"].transform.position).z)
				arg_127_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_127_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_127_1.actors_["2079ui_story"].transform.localEulerAngles = arg_127_1.actors_["2079ui_story"].transform.localEulerAngles
			end

			if arg_127_1.time_ >= 0 + var_130_0 and arg_127_1.time_ < 0 + var_130_0 + arg_130_0 then
				arg_127_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_127_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_127_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_127_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_127_1.actors_["2079ui_story"].transform.position).z)
				arg_127_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_127_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_127_1.actors_["2079ui_story"].transform.localEulerAngles = arg_127_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			if 0 < arg_127_1.time_ and arg_127_1.time_ <= var_130_1 + arg_130_0 then
				...
				arg_127_1.leftNameTxt_.text = arg_127_1:FormatText(StoryNameCfg[646].name)
				...
				local var_130_3 = arg_127_1:FormatText(arg_127_1:GetWordFromCfg(419011031).content)

				arg_127_1.text_.text = var_130_3

				LuaForUtil.ClearLinePrefixSymbol(arg_127_1.text_)

				local var_130_5 = 47 <= 0 and var_130_2 or var_130_2 * (utf8.len(var_130_3) / 47)

				if (47 <= 0 and var_130_2 or var_130_2 * (utf8.len(var_130_3) / 47)) > 0 and var_130_2 < var_130_5 then
	...
	Play419011032 = function(arg_131_0, arg_131_1)
		...
		function arg_131_1.onSingleLineUpdate_(arg_134_0)
			...
			local var_134_4 = arg_131_1.actors_["2079ui_story"]

			if 0 < arg_131_1.time_ and arg_131_1.time_ <= 0 + arg_134_0 and not isNil(var_134_4) and arg_131_1.var_.characterEffect2079ui_story == nil then
				arg_131_1.var_.characterEffect2079ui_story = var_134_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_134_5 = 0.200000002980232

			if 0 <= arg_131_1.time_ and arg_131_1.time_ < 0 + var_134_5 and not isNil(var_134_4) then
				if arg_131_1.var_.characterEffect2079ui_story and not isNil(var_134_4) then
					arg_131_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_131_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_131_1.time_ - 0) / var_134_5)
				end
			end

			if arg_131_1.time_ >= 0 + var_134_5 and arg_131_1.time_ < 0 + var_134_5 + arg_134_0 and not isNil(var_134_4) and arg_131_1.var_.characterEffect2079ui_story then
				arg_131_1.var_.characterEffect2079ui_story.fillFlat = true
				arg_131_1.var_.characterEffect2079ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_131_1.time_ and arg_131_1.time_ <= var_134_6 + arg_134_0 then
				...
				local var_134_8 = arg_131_1:FormatText(arg_131_1:GetWordFromCfg(419011032).content)

				arg_131_1.text_.text = var_134_8

				LuaForUtil.ClearLinePrefixSymbol(arg_131_1.text_)

				local var_134_10 = 14 <= 0 and var_134_7 or var_134_7 * (utf8.len(var_134_8) / 14)

				if (14 <= 0 and var_134_7 or var_134_7 * (utf8.len(var_134_8) / 14)) > 0 and var_134_7 < var_134_10 then
	...
	Play419011033 = function(arg_135_0, arg_135_1)
		...
		function arg_135_1.onSingleLineUpdate_(arg_138_0)
			...
			if 0 < arg_135_1.time_ and arg_135_1.time_ <= 0 + arg_138_0 then
				...
				local var_138_1 = arg_135_1:FormatText(arg_135_1:GetWordFromCfg(419011033).content)
	...
	Play419011034 = function(arg_139_0, arg_139_1)
		...
		function arg_139_1.onSingleLineUpdate_(arg_142_0)
			...
			if 0 < arg_139_1.time_ and arg_139_1.time_ <= var_142_1 + arg_142_0 then
				...
				arg_139_1.leftNameTxt_.text = arg_139_1:FormatText(StoryNameCfg[646].name)
				...
				local var_142_3 = arg_139_1:FormatText(arg_139_1:GetWordFromCfg(419011034).content)

				arg_139_1.text_.text = var_142_3

				LuaForUtil.ClearLinePrefixSymbol(arg_139_1.text_)

				local var_142_5 = 40 <= 0 and var_142_2 or var_142_2 * (utf8.len(var_142_3) / 40)

				if (40 <= 0 and var_142_2 or var_142_2 * (utf8.len(var_142_3) / 40)) > 0 and var_142_2 < var_142_5 then
	...
	Play419011035 = function(arg_143_0, arg_143_1)
		...
		function arg_143_1.onSingleLineUpdate_(arg_146_0)
			...
			if 0 < arg_143_1.time_ and arg_143_1.time_ <= 0 + arg_146_0 then
				...
				arg_143_1.leftNameTxt_.text = arg_143_1:FormatText(StoryNameCfg[646].name)
				...
				local var_146_1 = arg_143_1:FormatText(arg_143_1:GetWordFromCfg(419011035).content)

				arg_143_1.text_.text = var_146_1

				LuaForUtil.ClearLinePrefixSymbol(arg_143_1.text_)

				local var_146_3 = 54 <= 0 and var_146_0 or var_146_0 * (utf8.len(var_146_1) / 54)

				if (54 <= 0 and var_146_0 or var_146_0 * (utf8.len(var_146_1) / 54)) > 0 and var_146_0 < var_146_3 then
	...
	Play419011036 = function(arg_147_0, arg_147_1)
		...
		function arg_147_1.onSingleLineUpdate_(arg_150_0)
			...
			local var_150_2 = arg_147_1.actors_["2079ui_story"]

			if 0 < arg_147_1.time_ and arg_147_1.time_ <= 0 + arg_150_0 and not isNil(var_150_2) and arg_147_1.var_.characterEffect2079ui_story == nil then
				arg_147_1.var_.characterEffect2079ui_story = var_150_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_150_3 = 0.200000002980232

			if 0 <= arg_147_1.time_ and arg_147_1.time_ < 0 + var_150_3 and not isNil(var_150_2) then
				if arg_147_1.var_.characterEffect2079ui_story and not isNil(var_150_2) then
					arg_147_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_147_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_147_1.time_ - 0) / var_150_3)
				end
			end

			if arg_147_1.time_ >= 0 + var_150_3 and arg_147_1.time_ < 0 + var_150_3 + arg_150_0 and not isNil(var_150_2) and arg_147_1.var_.characterEffect2079ui_story then
				arg_147_1.var_.characterEffect2079ui_story.fillFlat = true
				arg_147_1.var_.characterEffect2079ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_147_1.time_ and arg_147_1.time_ <= var_150_4 + arg_150_0 then
				...
				local var_150_6 = arg_147_1:FormatText(arg_147_1:GetWordFromCfg(419011036).content)

				arg_147_1.text_.text = var_150_6

				LuaForUtil.ClearLinePrefixSymbol(arg_147_1.text_)

				local var_150_8 = 9 <= 0 and var_150_5 or var_150_5 * (utf8.len(var_150_6) / 9)

				if (9 <= 0 and var_150_5 or var_150_5 * (utf8.len(var_150_6) / 9)) > 0 and var_150_5 < var_150_8 then
	...
	Play419011037 = function(arg_151_0, arg_151_1)
		...
		function arg_151_1.onSingleLineUpdate_(arg_154_0)
			if 0 < arg_151_1.time_ and arg_151_1.time_ <= 0 + arg_154_0 and not isNil(arg_151_1.actors_["2079ui_story"]) and arg_151_1.var_.characterEffect2079ui_story == nil then
				arg_151_1.var_.characterEffect2079ui_story = arg_151_1.actors_["2079ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_154_0 = 0.200000002980232

			if 0 <= arg_151_1.time_ and arg_151_1.time_ < 0 + var_154_0 and not isNil(arg_151_1.actors_["2079ui_story"]) then
				if arg_151_1.var_.characterEffect2079ui_story and not isNil(arg_151_1.actors_["2079ui_story"]) then
					arg_151_1.var_.characterEffect2079ui_story.fillFlat = false
				end
			end

			if arg_151_1.time_ >= 0 + var_154_0 and arg_151_1.time_ < 0 + var_154_0 + arg_154_0 and not isNil(arg_151_1.actors_["2079ui_story"]) and arg_151_1.var_.characterEffect2079ui_story then
				arg_151_1.var_.characterEffect2079ui_story.fillFlat = false
			end

			local var_154_2 = arg_151_1.actors_["1095ui_story"]

			if 0 < arg_151_1.time_ and arg_151_1.time_ <= 0 + arg_154_0 and not isNil(var_154_2) and arg_151_1.var_.characterEffect1095ui_story == nil then
				arg_151_1.var_.characterEffect1095ui_story = var_154_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_154_3 = 0.200000002980232

			if 0 <= arg_151_1.time_ and arg_151_1.time_ < 0 + var_154_3 and not isNil(var_154_2) then
				if arg_151_1.var_.characterEffect1095ui_story and not isNil(var_154_2) then
					arg_151_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_151_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_151_1.time_ - 0) / var_154_3)
				end
			end

			if arg_151_1.time_ >= 0 + var_154_3 and arg_151_1.time_ < 0 + var_154_3 + arg_154_0 and not isNil(var_154_2) and arg_151_1.var_.characterEffect1095ui_story then
				arg_151_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_151_1.var_.characterEffect1095ui_story.fillRatio = 0.5
			end

			local var_154_4 = 0
			local var_154_5 = 0.975
			...
			if 0 < arg_151_1.time_ and arg_151_1.time_ <= var_154_4 + arg_154_0 then
				...
				arg_151_1.leftNameTxt_.text = arg_151_1:FormatText(StoryNameCfg[646].name)
				...
				local var_154_6 = arg_151_1:FormatText(arg_151_1:GetWordFromCfg(419011037).content)

				arg_151_1.text_.text = var_154_6

				LuaForUtil.ClearLinePrefixSymbol(arg_151_1.text_)

				local var_154_8 = 39 <= 0 and var_154_5 or var_154_5 * (utf8.len(var_154_6) / 39)

				if (39 <= 0 and var_154_5 or var_154_5 * (utf8.len(var_154_6) / 39)) > 0 and var_154_5 < var_154_8 then
	...
	Play419011038 = function(arg_155_0, arg_155_1)
		...
		function arg_155_1.onSingleLineUpdate_(arg_158_0)
			...
			if 0 < arg_155_1.time_ and arg_155_1.time_ <= var_158_4 + arg_158_0 then
				...
				local var_158_6 = arg_155_1:FormatText(arg_155_1:GetWordFromCfg(419011038).content)

				arg_155_1.text_.text = var_158_6

				LuaForUtil.ClearLinePrefixSymbol(arg_155_1.text_)

				local var_158_8 = 4 <= 0 and var_158_5 or var_158_5 * (utf8.len(var_158_6) / 4)

				if (4 <= 0 and var_158_5 or var_158_5 * (utf8.len(var_158_6) / 4)) > 0 and var_158_5 < var_158_8 then
	...
	Play419011039 = function(arg_159_0, arg_159_1)
		...
		function arg_159_1.onSingleLineUpdate_(arg_162_0)
			if 0 < arg_159_1.time_ and arg_159_1.time_ <= 0 + arg_162_0 and not isNil(arg_159_1.actors_["2079ui_story"]) and arg_159_1.var_.characterEffect2079ui_story == nil then
				arg_159_1.var_.characterEffect2079ui_story = arg_159_1.actors_["2079ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_162_0 = 0.200000002980232

			if 0 <= arg_159_1.time_ and arg_159_1.time_ < 0 + var_162_0 and not isNil(arg_159_1.actors_["2079ui_story"]) then
				if arg_159_1.var_.characterEffect2079ui_story and not isNil(arg_159_1.actors_["2079ui_story"]) then
					arg_159_1.var_.characterEffect2079ui_story.fillFlat = false
				end
			end

			if arg_159_1.time_ >= 0 + var_162_0 and arg_159_1.time_ < 0 + var_162_0 + arg_162_0 and not isNil(arg_159_1.actors_["2079ui_story"]) and arg_159_1.var_.characterEffect2079ui_story then
				arg_159_1.var_.characterEffect2079ui_story.fillFlat = false
			end

			local var_162_2 = arg_159_1.actors_["1095ui_story"]

			if 0 < arg_159_1.time_ and arg_159_1.time_ <= 0 + arg_162_0 and not isNil(var_162_2) and arg_159_1.var_.characterEffect1095ui_story == nil then
				arg_159_1.var_.characterEffect1095ui_story = var_162_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_162_3 = 0.200000002980232

			if 0 <= arg_159_1.time_ and arg_159_1.time_ < 0 + var_162_3 and not isNil(var_162_2) then
				if arg_159_1.var_.characterEffect1095ui_story and not isNil(var_162_2) then
					arg_159_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_159_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_159_1.time_ - 0) / var_162_3)
				end
			end

			if arg_159_1.time_ >= 0 + var_162_3 and arg_159_1.time_ < 0 + var_162_3 + arg_162_0 and not isNil(var_162_2) and arg_159_1.var_.characterEffect1095ui_story then
				arg_159_1.var_.characterEffect1095ui_story.fillFlat = true
			...
			if 0 < arg_159_1.time_ and arg_159_1.time_ <= var_162_4 + arg_162_0 then
				...
				arg_159_1.leftNameTxt_.text = arg_159_1:FormatText(StoryNameCfg[646].name)
				...
				local var_162_6 = arg_159_1:FormatText(arg_159_1:GetWordFromCfg(419011039).content)
	...
	Play419011040 = function(arg_163_0, arg_163_1)
		...
		function arg_163_1.onSingleLineUpdate_(arg_166_0)
			...
			if 0 < arg_163_1.time_ and arg_163_1.time_ <= 0 + arg_166_0 then
				...
				arg_163_1.leftNameTxt_.text = arg_163_1:FormatText(StoryNameCfg[646].name)
				...
				local var_166_1 = arg_163_1:FormatText(arg_163_1:GetWordFromCfg(419011040).content)

				arg_163_1.text_.text = var_166_1

				LuaForUtil.ClearLinePrefixSymbol(arg_163_1.text_)

				local var_166_3 = 16 <= 0 and var_166_0 or var_166_0 * (utf8.len(var_166_1) / 16)

				if (16 <= 0 and var_166_0 or var_166_0 * (utf8.len(var_166_1) / 16)) > 0 and var_166_0 < var_166_3 then
	...
	Play419011041 = function(arg_167_0, arg_167_1)
		...
		function arg_167_1.onSingleLineUpdate_(arg_170_0)
			if 0 < arg_167_1.time_ and arg_167_1.time_ <= 0 + arg_170_0 then
				arg_167_1.var_.moveOldPos2079ui_story = arg_167_1.actors_["2079ui_story"].transform.localPosition
			end

			local var_170_0 = 0.001

			if 0 <= arg_167_1.time_ and arg_167_1.time_ < 0 + var_170_0 then
				arg_167_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_167_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_167_1.time_ - 0) / var_170_0)
				arg_167_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_167_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_167_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_167_1.actors_["2079ui_story"].transform.position).z)
				arg_167_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_167_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_167_1.actors_["2079ui_story"].transform.localEulerAngles = arg_167_1.actors_["2079ui_story"].transform.localEulerAngles
			end

			if arg_167_1.time_ >= 0 + var_170_0 and arg_167_1.time_ < 0 + var_170_0 + arg_170_0 then
				arg_167_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_167_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_167_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_167_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_167_1.actors_["2079ui_story"].transform.position).z)
				arg_167_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_167_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_167_1.actors_["2079ui_story"].transform.localEulerAngles = arg_167_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			local var_170_1 = arg_167_1.actors_["1095ui_story"].transform

			if 0 < arg_167_1.time_ and arg_167_1.time_ <= 0 + arg_170_0 then
				arg_167_1.var_.moveOldPos1095ui_story = var_170_1.localPosition
			end

			local var_170_2 = 0.001

			if 0 <= arg_167_1.time_ and arg_167_1.time_ < 0 + var_170_2 then
				var_170_1.localPosition = Vector3.Lerp(arg_167_1.var_.moveOldPos1095ui_story, Vector3.New(0, 100, 0), (arg_167_1.time_ - 0) / var_170_2)
			...
			local var_170_3 = arg_167_1.actors_["2079ui_story"]

			if 0 < arg_167_1.time_ and arg_167_1.time_ <= 0 + arg_170_0 and not isNil(var_170_3) and arg_167_1.var_.characterEffect2079ui_story == nil then
				arg_167_1.var_.characterEffect2079ui_story = var_170_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_170_4 = 0.200000002980232

			if 0 <= arg_167_1.time_ and arg_167_1.time_ < 0 + var_170_4 and not isNil(var_170_3) then
				if arg_167_1.var_.characterEffect2079ui_story and not isNil(var_170_3) then
					arg_167_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_167_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_167_1.time_ - 0) / var_170_4)
				end
			end

			if arg_167_1.time_ >= 0 + var_170_4 and arg_167_1.time_ < 0 + var_170_4 + arg_170_0 and not isNil(var_170_3) and arg_167_1.var_.characterEffect2079ui_story then
				arg_167_1.var_.characterEffect2079ui_story.fillFlat = true
				arg_167_1.var_.characterEffect2079ui_story.fillRatio = 0.5
			end

			if 0.333333333333333 < arg_167_1.time_ and arg_167_1.time_ <= 0.333333333333333 + arg_170_0 then
				arg_167_1:AudioAction("play", "effect", "se_story_142", "se_story_142_chopper02", "")
			end
			...
			if 0 < arg_167_1.time_ and arg_167_1.time_ <= var_170_6 + arg_170_0 then
				...
				local var_170_8 = arg_167_1:FormatText(arg_167_1:GetWordFromCfg(419011041).content)

				arg_167_1.text_.text = var_170_8

				LuaForUtil.ClearLinePrefixSymbol(arg_167_1.text_)

				local var_170_10 = 36 <= 0 and var_170_7 or var_170_7 * (utf8.len(var_170_8) / 36)

				if (36 <= 0 and var_170_7 or var_170_7 * (utf8.len(var_170_8) / 36)) > 0 and var_170_7 < var_170_10 then
					arg_167_1.talkMaxDuration = var_170_10

					if var_170_10 + var_170_6 > arg_167_1.duration_ then
						arg_167_1.duration_ = var_170_10 + var_170_6
					end
				end
			...
			local var_170_11 = math.max(var_170_7, arg_167_1.talkMaxDuration)

			if var_170_6 <= arg_167_1.time_ and arg_167_1.time_ < var_170_6 + var_170_11 then
				arg_167_1.typewritter.percent = (arg_167_1.time_ - var_170_6) / var_170_11

				arg_167_1.typewritter:SetDirty()
			end

			if arg_167_1.time_ >= var_170_6 + var_170_11 and arg_167_1.time_ < var_170_6 + var_170_11 + arg_170_0 then
	...
	Play419011042 = function(arg_171_0, arg_171_1)
		...
		function arg_171_1.onSingleLineUpdate_(arg_174_0)
			if 0 < arg_171_1.time_ and arg_171_1.time_ <= 0 + arg_174_0 then
				local var_174_0 = arg_171_1.var_.effect787

				if not arg_171_1.var_.effect787 then
					var_174_0 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_qiliu_in_keep"), manager.ui.mainCamera.transform)
					var_174_0.name = "787"
					arg_171_1.var_.effect787 = var_174_0
				else
					var_174_0.transform:SetParent(manager.ui.mainCamera.transform)
				end

				var_174_0.transform.localPosition = Vector3.New(0, -0.29, -0.76)
				var_174_0.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_174_2 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_174_0, iter_174_1 in ipairs((var_174_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_174_1.transform.localScale = Vector3.New(iter_174_1.transform.localScale.x / var_174_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_174_1.transform.localScale.y / var_174_2, iter_174_1.transform.localScale.z)
				end
			end

			local var_174_4 = 0
			local var_174_5 = 1.625
			...
			if 0 < arg_171_1.time_ and arg_171_1.time_ <= var_174_4 + arg_174_0 then
				...
				local var_174_6 = arg_171_1:FormatText(arg_171_1:GetWordFromCfg(419011042).content)

				arg_171_1.text_.text = var_174_6

				LuaForUtil.ClearLinePrefixSymbol(arg_171_1.text_)

				local var_174_8 = 65 <= 0 and var_174_5 or var_174_5 * (utf8.len(var_174_6) / 65)

				if (65 <= 0 and var_174_5 or var_174_5 * (utf8.len(var_174_6) / 65)) > 0 and var_174_5 < var_174_8 then
	...
	Play419011043 = function(arg_175_0, arg_175_1)
		...
		function arg_175_1.onSingleLineUpdate_(arg_178_0)
			...
			if 0 < arg_175_1.time_ and arg_175_1.time_ <= 0 + arg_178_0 then
				...
				local var_178_1 = arg_175_1:FormatText(arg_175_1:GetWordFromCfg(419011043).content)

				arg_175_1.text_.text = var_178_1

				LuaForUtil.ClearLinePrefixSymbol(arg_175_1.text_)

				local var_178_3 = 29 <= 0 and var_178_0 or var_178_0 * (utf8.len(var_178_1) / 29)

				if (29 <= 0 and var_178_0 or var_178_0 * (utf8.len(var_178_1) / 29)) > 0 and var_178_0 < var_178_3 then
	...
	Play419011044 = function(arg_179_0, arg_179_1)
		...
		function arg_179_1.onSingleLineUpdate_(arg_182_0)
			...
			if 0 <= arg_179_1.time_ and arg_179_1.time_ < 0 + var_182_0 then
				arg_179_1.actors_["1095ui_story"].transform.localPosition = Vector3.Lerp(arg_179_1.var_.moveOldPos1095ui_story, Vector3.New(0, 100, 0), (arg_179_1.time_ - 0) / var_182_0)
			...
			if arg_179_1.time_ >= 0 + var_182_0 and arg_179_1.time_ < 0 + var_182_0 + arg_182_0 then
				arg_179_1.actors_["1095ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_179_1.actors_["1095ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_179_1.actors_["1095ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_179_1.actors_["1095ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_179_1.actors_["1095ui_story"].transform.position).z)
				arg_179_1.actors_["1095ui_story"].transform.localEulerAngles.z = 0
				arg_179_1.actors_["1095ui_story"].transform.localEulerAngles.x = 0
				arg_179_1.actors_["1095ui_story"].transform.localEulerAngles = arg_179_1.actors_["1095ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_179_1.time_ and arg_179_1.time_ < 0 + var_182_2 and not isNil(var_182_1) then
				if arg_179_1.var_.characterEffect1095ui_story and not isNil(var_182_1) then
					...
					arg_179_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_179_1.time_ - 0) / var_182_2)
				end
			end
			...
			local var_182_3 = manager.ui.mainCamera.transform

			if 0 < arg_179_1.time_ and arg_179_1.time_ <= 0 + arg_182_0 then
				arg_179_1.var_.shakeOldPos = var_182_3.localPosition
			end

			local var_182_4 = 1.2

			if 0 <= arg_179_1.time_ and arg_179_1.time_ < 0 + var_182_4 then
				local var_182_5, var_182_6 = math.modf((arg_179_1.time_ - 0) / 0.066)

				var_182_3.localPosition = Vector3.New(var_182_6 * 0.13, var_182_6 * 0.13, var_182_6 * 0.13) + arg_179_1.var_.shakeOldPos
			end

			if arg_179_1.time_ >= 0 + var_182_4 and arg_179_1.time_ < 0 + var_182_4 + arg_182_0 then
				var_182_3.localPosition = arg_179_1.var_.shakeOldPos
			end
			...
			if arg_179_1.time_ >= var_182_7 + 1.43333333333333 and arg_179_1.time_ < var_182_7 + 1.43333333333333 + arg_182_0 then
			...
			if 1 < arg_179_1.time_ and arg_179_1.time_ <= var_182_8 + arg_182_0 then
				...
				local var_182_11 = arg_179_1:FormatText(arg_179_1:GetWordFromCfg(419011044).content)

				arg_179_1.text_.text = var_182_11

				LuaForUtil.ClearLinePrefixSymbol(arg_179_1.text_)

				local var_182_13 = 68 <= 0 and var_182_9 or var_182_9 * (utf8.len(var_182_11) / 68)

				if (68 <= 0 and var_182_9 or var_182_9 * (utf8.len(var_182_11) / 68)) > 0 and var_182_9 < var_182_13 then
	...
	Play419011045 = function(arg_185_0, arg_185_1)
		...
		function arg_185_1.onSingleLineUpdate_(arg_188_0)
			...
			if 0 <= arg_185_1.time_ and arg_185_1.time_ < 0 + var_188_0 then
				arg_185_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_185_1.var_.moveOldPos2079ui_story, Vector3.New(0, -1.28, -5.6), (arg_185_1.time_ - 0) / var_188_0)
			...
			if arg_185_1.time_ >= 0 + var_188_0 and arg_185_1.time_ < 0 + var_188_0 + arg_188_0 then
				arg_185_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, -1.28, -5.6)
				arg_185_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_185_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_185_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_185_1.actors_["2079ui_story"].transform.position).z)
				arg_185_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_185_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_185_1.actors_["2079ui_story"].transform.localEulerAngles = arg_185_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			if 0 < arg_185_1.time_ and arg_185_1.time_ <= var_188_4 + arg_188_0 then
				...
				arg_185_1.leftNameTxt_.text = arg_185_1:FormatText(StoryNameCfg[646].name)
				...
				local var_188_6 = arg_185_1:FormatText(arg_185_1:GetWordFromCfg(419011045).content)

				arg_185_1.text_.text = var_188_6

				LuaForUtil.ClearLinePrefixSymbol(arg_185_1.text_)

				local var_188_8 = 8 <= 0 and var_188_5 or var_188_5 * (utf8.len(var_188_6) / 8)

				if (8 <= 0 and var_188_5 or var_188_5 * (utf8.len(var_188_6) / 8)) > 0 and var_188_5 < var_188_8 then
	...
	Play419011046 = function(arg_189_0, arg_189_1)
		...
		function arg_189_1.onSingleLineUpdate_(arg_192_0)
			if 0 < arg_189_1.time_ and arg_189_1.time_ <= 0 + arg_192_0 then
				arg_189_1.var_.moveOldPos2079ui_story = arg_189_1.actors_["2079ui_story"].transform.localPosition
			end

			local var_192_0 = 0.001

			if 0 <= arg_189_1.time_ and arg_189_1.time_ < 0 + var_192_0 then
				arg_189_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_189_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_189_1.time_ - 0) / var_192_0)
				arg_189_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_189_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_189_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_189_1.actors_["2079ui_story"].transform.position).z)
				arg_189_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_189_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_189_1.actors_["2079ui_story"].transform.localEulerAngles = arg_189_1.actors_["2079ui_story"].transform.localEulerAngles
			end

			if arg_189_1.time_ >= 0 + var_192_0 and arg_189_1.time_ < 0 + var_192_0 + arg_192_0 then
				arg_189_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_189_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_189_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_189_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_189_1.actors_["2079ui_story"].transform.position).z)
				arg_189_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_189_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_189_1.actors_["2079ui_story"].transform.localEulerAngles = arg_189_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			local var_192_1 = arg_189_1.actors_["2079ui_story"]

			if 0 < arg_189_1.time_ and arg_189_1.time_ <= 0 + arg_192_0 and not isNil(var_192_1) and arg_189_1.var_.characterEffect2079ui_story == nil then
				arg_189_1.var_.characterEffect2079ui_story = var_192_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_192_2 = 0.200000002980232

			if 0 <= arg_189_1.time_ and arg_189_1.time_ < 0 + var_192_2 and not isNil(var_192_1) then
				if arg_189_1.var_.characterEffect2079ui_story and not isNil(var_192_1) then
					arg_189_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_189_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_189_1.time_ - 0) / var_192_2)
				end
			end

			if arg_189_1.time_ >= 0 + var_192_2 and arg_189_1.time_ < 0 + var_192_2 + arg_192_0 and not isNil(var_192_1) and arg_189_1.var_.characterEffect2079ui_story then
				arg_189_1.var_.characterEffect2079ui_story.fillFlat = true
				arg_189_1.var_.characterEffect2079ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_189_1.time_ and arg_189_1.time_ <= var_192_3 + arg_192_0 then
				...
				local var_192_5 = arg_189_1:FormatText(arg_189_1:GetWordFromCfg(419011046).content)

				arg_189_1.text_.text = var_192_5

				LuaForUtil.ClearLinePrefixSymbol(arg_189_1.text_)

				local var_192_7 = 44 <= 0 and var_192_4 or var_192_4 * (utf8.len(var_192_5) / 44)

				if (44 <= 0 and var_192_4 or var_192_4 * (utf8.len(var_192_5) / 44)) > 0 and var_192_4 < var_192_7 then
	...
	Play419011047 = function(arg_193_0, arg_193_1)
		...
		function arg_193_1.onSingleLineUpdate_(arg_196_0)
			...
			if 0 < arg_193_1.time_ and arg_193_1.time_ <= 0 + arg_196_0 then
				...
				local var_196_1 = arg_193_1:FormatText(arg_193_1:GetWordFromCfg(419011047).content)
	...
	Play419011048 = function(arg_197_0, arg_197_1)
		...
		function arg_197_1.onSingleLineUpdate_(arg_200_0)
			if arg_197_1.bgs_.I18f == nil then
				local var_200_0 = Object.Instantiate(arg_197_1.paintGo_)

				var_200_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "I18f")
				var_200_0.name = "I18f"
				var_200_0.transform.parent = arg_197_1.stage_.transform
				var_200_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_197_1.bgs_.I18f = var_200_0
			end

			if 1.999999999999 < arg_197_1.time_ and arg_197_1.time_ <= 1.999999999999 + arg_200_0 then
				local var_200_1 = arg_197_1.bgs_.I18f

				arg_197_1.bgs_.I18f.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 3.8 <= arg_197_1.time_ and arg_197_1.time_ < 3.8 + var_200_14 then
				var_200_13.localPosition = Vector3.Lerp(arg_197_1.var_.moveOldPos1095ui_story, Vector3.New(0, -0.98, -6.1), (arg_197_1.time_ - 3.8) / var_200_14)
			...
			if arg_197_1.time_ >= 3.8 + var_200_14 and arg_197_1.time_ < 3.8 + var_200_14 + arg_200_0 then
				var_200_13.localPosition = Vector3.New(0, -0.98, -6.1)
				var_200_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_200_13.position).x, (manager.ui.mainCamera.transform.position - var_200_13.position).y, (manager.ui.mainCamera.transform.position - var_200_13.position).z)
				var_200_13.localEulerAngles.z = 0
				var_200_13.localEulerAngles.x = 0
				var_200_13.localEulerAngles = var_200_13.localEulerAngles
			...
			local var_200_15 = arg_197_1.actors_["1095ui_story"]

			if 3.8 < arg_197_1.time_ and arg_197_1.time_ <= 3.8 + arg_200_0 and not isNil(var_200_15) and arg_197_1.var_.characterEffect1095ui_story == nil then
				arg_197_1.var_.characterEffect1095ui_story = var_200_15:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_200_16 = 0.200000002980232

			if 3.8 <= arg_197_1.time_ and arg_197_1.time_ < 3.8 + var_200_16 and not isNil(var_200_15) then
				if arg_197_1.var_.characterEffect1095ui_story and not isNil(var_200_15) then
					arg_197_1.var_.characterEffect1095ui_story.fillFlat = false
				end
			end

			if arg_197_1.time_ >= 3.8 + var_200_16 and arg_197_1.time_ < 3.8 + var_200_16 + arg_200_0 and not isNil(var_200_15) and arg_197_1.var_.characterEffect1095ui_story then
				arg_197_1.var_.characterEffect1095ui_story.fillFlat = false
			end
			...
			if 3.23333333333333 < arg_197_1.time_ and arg_197_1.time_ <= 3.23333333333333 + arg_200_0 then
			...
			if 2 < arg_197_1.time_ and arg_197_1.time_ <= 2 + arg_200_0 then
				if arg_197_1.var_.effect787 then
					Object.Destroy(arg_197_1.var_.effect787)

					arg_197_1.var_.effect787 = nil
				end
			end

			if 0.6 < arg_197_1.time_ and arg_197_1.time_ <= 0.6 + arg_200_0 then
				arg_197_1:AudioAction("stop", "effect", "se_story_142", "se_story_142_amb_command room", "")
			end

			if 1.6 < arg_197_1.time_ and arg_197_1.time_ <= 1.6 + arg_200_0 then
				arg_197_1:AudioAction("play", "effect", "se_story_142", "se_story_142_amb_wild", "")
			end

			if 1.6 < arg_197_1.time_ and arg_197_1.time_ <= 1.6 + arg_200_0 then
				arg_197_1:AudioAction("play", "effect", "se_story_142", "se_story_142_amb_battle monster", "")
			end
			...
			local var_200_22 = 4.00000000298023
			local var_200_23 = 0.4

			if 4.00000000298023 < arg_197_1.time_ and arg_197_1.time_ <= var_200_22 + arg_200_0 then
				...
				local var_200_24 = LeanTween.value(arg_197_1.dialog_, 0, 1, 0.3)

				var_200_24:setOnUpdate(LuaHelper.FloatAction(function(arg_201_0)
					arg_197_1.dialogCg_.alpha = arg_201_0
				end))
				var_200_24:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_197_1.dialog_)
					var_200_24:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_200_25 = arg_197_1:FormatText(arg_197_1:GetWordFromCfg(419011048).content)

				arg_197_1.text_.text = var_200_25

				LuaForUtil.ClearLinePrefixSymbol(arg_197_1.text_)

				local var_200_27 = 16 <= 0 and var_200_23 or var_200_23 * (utf8.len(var_200_25) / 16)

				if (16 <= 0 and var_200_23 or var_200_23 * (utf8.len(var_200_25) / 16)) > 0 and var_200_23 < var_200_27 then
					arg_197_1.talkMaxDuration = var_200_27
					var_200_22 = var_200_22 + 0.3

					if var_200_27 + var_200_22 > arg_197_1.duration_ then
						arg_197_1.duration_ = var_200_27 + var_200_22
					end
				end
			...
			local var_200_28 = var_200_22 + 0.3
			local var_200_29 = math.max(var_200_23, arg_197_1.talkMaxDuration)

			if var_200_22 + 0.3 <= arg_197_1.time_ and arg_197_1.time_ < var_200_28 + var_200_29 then
	...
	Play419011049 = function(arg_203_0, arg_203_1)
		...
		function arg_203_1.onSingleLineUpdate_(arg_206_0)
			...
			if 0 <= arg_203_1.time_ and arg_203_1.time_ < 0 + var_206_0 then
				arg_203_1.actors_["1095ui_story"].transform.localPosition = Vector3.Lerp(arg_203_1.var_.moveOldPos1095ui_story, Vector3.New(0, 100, 0), (arg_203_1.time_ - 0) / var_206_0)
			...
			if arg_203_1.time_ >= 0 + var_206_0 and arg_203_1.time_ < 0 + var_206_0 + arg_206_0 then
				arg_203_1.actors_["1095ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_203_1.actors_["1095ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_203_1.actors_["1095ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_203_1.actors_["1095ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_203_1.actors_["1095ui_story"].transform.position).z)
				arg_203_1.actors_["1095ui_story"].transform.localEulerAngles.z = 0
				arg_203_1.actors_["1095ui_story"].transform.localEulerAngles.x = 0
				arg_203_1.actors_["1095ui_story"].transform.localEulerAngles = arg_203_1.actors_["1095ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_203_1.time_ and arg_203_1.time_ < 0 + var_206_2 and not isNil(var_206_1) then
				if arg_203_1.var_.characterEffect1095ui_story and not isNil(var_206_1) then
					...
					arg_203_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_203_1.time_ - 0) / var_206_2)
				end
			end
			...
			if arg_203_1.time_ >= 0 + var_206_2 and arg_203_1.time_ < 0 + var_206_2 + arg_206_0 and not isNil(var_206_1) and arg_203_1.var_.characterEffect1095ui_story then
				arg_203_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_203_1.var_.characterEffect1095ui_story.fillRatio = 0.5
			end

			if 0 < arg_203_1.time_ and arg_203_1.time_ <= 0 + arg_206_0 then
				local var_206_3 = arg_203_1.var_.effect888

				if not arg_203_1.var_.effect888 then
					var_206_3 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_daoguang02"), manager.ui.mainCamera.transform)
					var_206_3.name = "888"
					arg_203_1.var_.effect888 = var_206_3
				else
					var_206_3.transform:SetParent(var_206_9000)
				end

				var_206_3.transform.localPosition = Vector3.New(0, -0.29, -0.76)
				var_206_3.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_206_5 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_206_0, iter_206_1 in ipairs((var_206_3.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_206_1.transform.localScale = Vector3.New(iter_206_1.transform.localScale.x / var_206_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_206_1.transform.localScale.y / var_206_5, iter_206_1.transform.localScale.z)
				end
			end
			...
			if arg_203_1.time_ >= var_206_7 + 1.43333333333333 and arg_203_1.time_ < var_206_7 + 1.43333333333333 + arg_206_0 then
			...
			local var_206_8 = 0.566666666666667
			local var_206_9 = 1.05

			if 0.566666666666667 < arg_203_1.time_ and arg_203_1.time_ <= var_206_8 + arg_206_0 then
				...
				local var_206_11 = arg_203_1:FormatText(arg_203_1:GetWordFromCfg(419011049).content)

				arg_203_1.text_.text = var_206_11

				LuaForUtil.ClearLinePrefixSymbol(arg_203_1.text_)

				local var_206_13 = 42 <= 0 and var_206_9 or var_206_9 * (utf8.len(var_206_11) / 42)

				if (42 <= 0 and var_206_9 or var_206_9 * (utf8.len(var_206_11) / 42)) > 0 and var_206_9 < var_206_13 then
	...
	Play419011050 = function(arg_209_0, arg_209_1)
		...
		function arg_209_1.onSingleLineUpdate_(arg_212_0)
			...
			if 0 < arg_209_1.time_ and arg_209_1.time_ <= 0 + arg_212_0 then
				...
				local var_212_1 = arg_209_1:FormatText(arg_209_1:GetWordFromCfg(419011050).content)
	...
	Play419011051 = function(arg_213_0, arg_213_1)
		...
		function arg_213_1.onSingleLineUpdate_(arg_216_0)
			...
			if 0 <= arg_213_1.time_ and arg_213_1.time_ < 0 + var_216_0 then
				arg_213_1.actors_["1095ui_story"].transform.localPosition = Vector3.Lerp(arg_213_1.var_.moveOldPos1095ui_story, Vector3.New(-0.7, -0.98, -6.1), (arg_213_1.time_ - 0) / var_216_0)
			...
			if arg_213_1.time_ >= 0 + var_216_0 and arg_213_1.time_ < 0 + var_216_0 + arg_216_0 then
				arg_213_1.actors_["1095ui_story"].transform.localPosition = Vector3.New(-0.7, -0.98, -6.1)
				arg_213_1.actors_["1095ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_213_1.actors_["1095ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_213_1.actors_["1095ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_213_1.actors_["1095ui_story"].transform.position).z)
				arg_213_1.actors_["1095ui_story"].transform.localEulerAngles.z = 0
				arg_213_1.actors_["1095ui_story"].transform.localEulerAngles.x = 0
				arg_213_1.actors_["1095ui_story"].transform.localEulerAngles = arg_213_1.actors_["1095ui_story"].transform.localEulerAngles
			...
			if 0 < arg_213_1.time_ and arg_213_1.time_ <= var_216_4 + arg_216_0 then
				...
				local var_216_6 = arg_213_1:FormatText(arg_213_1:GetWordFromCfg(419011051).content)

				arg_213_1.text_.text = var_216_6

				LuaForUtil.ClearLinePrefixSymbol(arg_213_1.text_)

				local var_216_8 = 36 <= 0 and var_216_5 or var_216_5 * (utf8.len(var_216_6) / 36)

				if (36 <= 0 and var_216_5 or var_216_5 * (utf8.len(var_216_6) / 36)) > 0 and var_216_5 < var_216_8 then
	...
	Play419011052 = function(arg_217_0, arg_217_1)
		...
		function arg_217_1.onSingleLineUpdate_(arg_220_0)
			if 0 < arg_217_1.time_ and arg_217_1.time_ <= 0 + arg_220_0 then
				arg_217_1.var_.moveOldPos2079ui_story = arg_217_1.actors_["2079ui_story"].transform.localPosition
			end

			local var_220_0 = 0.001

			if 0 <= arg_217_1.time_ and arg_217_1.time_ < 0 + var_220_0 then
				arg_217_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_217_1.var_.moveOldPos2079ui_story, Vector3.New(0.7, -1.28, -5.6), (arg_217_1.time_ - 0) / var_220_0)
				arg_217_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_217_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_217_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_217_1.actors_["2079ui_story"].transform.position).z)
				arg_217_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_217_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_217_1.actors_["2079ui_story"].transform.localEulerAngles = arg_217_1.actors_["2079ui_story"].transform.localEulerAngles
			end

			if arg_217_1.time_ >= 0 + var_220_0 and arg_217_1.time_ < 0 + var_220_0 + arg_220_0 then
				arg_217_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0.7, -1.28, -5.6)
				arg_217_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_217_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_217_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_217_1.actors_["2079ui_story"].transform.position).z)
				arg_217_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_217_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_217_1.actors_["2079ui_story"].transform.localEulerAngles = arg_217_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			local var_220_1 = arg_217_1.actors_["2079ui_story"]

			if 0 < arg_217_1.time_ and arg_217_1.time_ <= 0 + arg_220_0 and not isNil(var_220_1) and arg_217_1.var_.characterEffect2079ui_story == nil then
				arg_217_1.var_.characterEffect2079ui_story = var_220_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_220_2 = 0.200000002980232

			if 0 <= arg_217_1.time_ and arg_217_1.time_ < 0 + var_220_2 and not isNil(var_220_1) then
				if arg_217_1.var_.characterEffect2079ui_story and not isNil(var_220_1) then
					arg_217_1.var_.characterEffect2079ui_story.fillFlat = false
				end
			end

			if arg_217_1.time_ >= 0 + var_220_2 and arg_217_1.time_ < 0 + var_220_2 + arg_220_0 and not isNil(var_220_1) and arg_217_1.var_.characterEffect2079ui_story then
				arg_217_1.var_.characterEffect2079ui_story.fillFlat = false
			end

			local var_220_4 = arg_217_1.actors_["1095ui_story"]

			if 0 < arg_217_1.time_ and arg_217_1.time_ <= 0 + arg_220_0 and not isNil(var_220_4) and arg_217_1.var_.characterEffect1095ui_story == nil then
			...
			if 0 <= arg_217_1.time_ and arg_217_1.time_ < 0 + var_220_5 and not isNil(var_220_4) then
				if arg_217_1.var_.characterEffect1095ui_story and not isNil(var_220_4) then
					...
					arg_217_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_217_1.time_ - 0) / var_220_5)
				end
			end

			if arg_217_1.time_ >= 0 + var_220_5 and arg_217_1.time_ < 0 + var_220_5 + arg_220_0 and not isNil(var_220_4) and arg_217_1.var_.characterEffect1095ui_story then
				arg_217_1.var_.characterEffect1095ui_story.fillFlat = true
			...
			if 0 < arg_217_1.time_ and arg_217_1.time_ <= var_220_6 + arg_220_0 then
				...
				arg_217_1.leftNameTxt_.text = arg_217_1:FormatText(StoryNameCfg[646].name)
				...
				local var_220_8 = arg_217_1:FormatText(arg_217_1:GetWordFromCfg(419011052).content)

				arg_217_1.text_.text = var_220_8

				LuaForUtil.ClearLinePrefixSymbol(arg_217_1.text_)

				local var_220_10 = 22 <= 0 and var_220_7 or var_220_7 * (utf8.len(var_220_8) / 22)

				if (22 <= 0 and var_220_7 or var_220_7 * (utf8.len(var_220_8) / 22)) > 0 and var_220_7 < var_220_10 then
	...
	Play419011053 = function(arg_221_0, arg_221_1)
		...
		function arg_221_1.onSingleLineUpdate_(arg_224_0)
			...
			if 0 < arg_221_1.time_ and arg_221_1.time_ <= var_224_1 + arg_224_0 then
				...
				arg_221_1.leftNameTxt_.text = arg_221_1:FormatText(StoryNameCfg[648].name)
				...
				local var_224_3 = arg_221_1:FormatText(arg_221_1:GetWordFromCfg(419011053).content)

				arg_221_1.text_.text = var_224_3

				LuaForUtil.ClearLinePrefixSymbol(arg_221_1.text_)

				local var_224_5 = 11 <= 0 and var_224_2 or var_224_2 * (utf8.len(var_224_3) / 11)

				if (11 <= 0 and var_224_2 or var_224_2 * (utf8.len(var_224_3) / 11)) > 0 and var_224_2 < var_224_5 then
	...
	Play419011054 = function(arg_225_0, arg_225_1)
		...
		function arg_225_1.onSingleLineUpdate_(arg_228_0)
			if 0 < arg_225_1.time_ and arg_225_1.time_ <= 0 + arg_228_0 and not isNil(arg_225_1.actors_["2079ui_story"]) and arg_225_1.var_.characterEffect2079ui_story == nil then
				arg_225_1.var_.characterEffect2079ui_story = arg_225_1.actors_["2079ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_228_0 = 0.200000002980232

			if 0 <= arg_225_1.time_ and arg_225_1.time_ < 0 + var_228_0 and not isNil(arg_225_1.actors_["2079ui_story"]) then
				if arg_225_1.var_.characterEffect2079ui_story and not isNil(arg_225_1.actors_["2079ui_story"]) then
					arg_225_1.var_.characterEffect2079ui_story.fillFlat = false
				end
			end

			if arg_225_1.time_ >= 0 + var_228_0 and arg_225_1.time_ < 0 + var_228_0 + arg_228_0 and not isNil(arg_225_1.actors_["2079ui_story"]) and arg_225_1.var_.characterEffect2079ui_story then
				arg_225_1.var_.characterEffect2079ui_story.fillFlat = false
			end

			local var_228_2 = 0
			local var_228_3 = 0.525
			...
			if 0 < arg_225_1.time_ and arg_225_1.time_ <= var_228_2 + arg_228_0 then
				...
				arg_225_1.leftNameTxt_.text = arg_225_1:FormatText(StoryNameCfg[646].name)
				...
				local var_228_4 = arg_225_1:FormatText(arg_225_1:GetWordFromCfg(419011054).content)

				arg_225_1.text_.text = var_228_4

				LuaForUtil.ClearLinePrefixSymbol(arg_225_1.text_)

				local var_228_6 = 21 <= 0 and var_228_3 or var_228_3 * (utf8.len(var_228_4) / 21)

				if (21 <= 0 and var_228_3 or var_228_3 * (utf8.len(var_228_4) / 21)) > 0 and var_228_3 < var_228_6 then
	...
	Play419011055 = function(arg_229_0, arg_229_1)
		...
		function arg_229_1.onSingleLineUpdate_(arg_232_0)
			...
			if 0 < arg_229_1.time_ and arg_229_1.time_ <= var_232_0 + arg_232_0 then
				...
				arg_229_1.leftNameTxt_.text = arg_229_1:FormatText(StoryNameCfg[646].name)
				...
				local var_232_2 = arg_229_1:FormatText(arg_229_1:GetWordFromCfg(419011055).content)

				arg_229_1.text_.text = var_232_2

				LuaForUtil.ClearLinePrefixSymbol(arg_229_1.text_)

				local var_232_4 = 29 <= 0 and var_232_1 or var_232_1 * (utf8.len(var_232_2) / 29)

				if (29 <= 0 and var_232_1 or var_232_1 * (utf8.len(var_232_2) / 29)) > 0 and var_232_1 < var_232_4 then
					arg_229_1.talkMaxDuration = var_232_4

					if var_232_4 + var_232_0 > arg_229_1.duration_ then
						arg_229_1.duration_ = var_232_4 + var_232_0
					end
				end
			...
			local var_232_5 = math.max(var_232_1, arg_229_1.talkMaxDuration)

			if var_232_0 <= arg_229_1.time_ and arg_229_1.time_ < var_232_0 + var_232_5 then
				arg_229_1.typewritter.percent = (arg_229_1.time_ - var_232_0) / var_232_5

				arg_229_1.typewritter:SetDirty()
			end

			if arg_229_1.time_ >= var_232_0 + var_232_5 and arg_229_1.time_ < var_232_0 + var_232_5 + arg_232_0 then
	...
	Play419011056 = function(arg_233_0, arg_233_1)
		...
		function arg_233_1.onSingleLineUpdate_(arg_236_0)
			...
			if 0 <= arg_233_1.time_ and arg_233_1.time_ < 0 + var_236_0 then
				arg_233_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_233_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_233_1.time_ - 0) / var_236_0)
			...
			if arg_233_1.time_ >= 0 + var_236_0 and arg_233_1.time_ < 0 + var_236_0 + arg_236_0 then
				arg_233_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_233_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_233_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_233_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_233_1.actors_["2079ui_story"].transform.position).z)
				arg_233_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_233_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_233_1.actors_["2079ui_story"].transform.localEulerAngles = arg_233_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			local var_236_1 = arg_233_1.actors_["1095ui_story"].transform

			if 0 < arg_233_1.time_ and arg_233_1.time_ <= 0 + arg_236_0 then
				arg_233_1.var_.moveOldPos1095ui_story = var_236_1.localPosition
			end

			local var_236_2 = 0.001

			if 0 <= arg_233_1.time_ and arg_233_1.time_ < 0 + var_236_2 then
				var_236_1.localPosition = Vector3.Lerp(arg_233_1.var_.moveOldPos1095ui_story, Vector3.New(0, 100, 0), (arg_233_1.time_ - 0) / var_236_2)
			...
			local var_236_3 = arg_233_1.actors_["2079ui_story"]

			if 0 < arg_233_1.time_ and arg_233_1.time_ <= 0 + arg_236_0 and not isNil(var_236_3) and arg_233_1.var_.characterEffect2079ui_story == nil then
				arg_233_1.var_.characterEffect2079ui_story = var_236_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_236_4 = 0.200000002980232

			if 0 <= arg_233_1.time_ and arg_233_1.time_ < 0 + var_236_4 and not isNil(var_236_3) then
				if arg_233_1.var_.characterEffect2079ui_story and not isNil(var_236_3) then
					arg_233_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_233_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_233_1.time_ - 0) / var_236_4)
				end
			end

			if arg_233_1.time_ >= 0 + var_236_4 and arg_233_1.time_ < 0 + var_236_4 + arg_236_0 and not isNil(var_236_3) and arg_233_1.var_.characterEffect2079ui_story then
				arg_233_1.var_.characterEffect2079ui_story.fillFlat = true
				arg_233_1.var_.characterEffect2079ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_233_1.time_ and arg_233_1.time_ <= var_236_5 + arg_236_0 then
				...
				local var_236_7 = arg_233_1:FormatText(arg_233_1:GetWordFromCfg(419011056).content)

				arg_233_1.text_.text = var_236_7

				LuaForUtil.ClearLinePrefixSymbol(arg_233_1.text_)

				local var_236_9 = 55 <= 0 and var_236_6 or var_236_6 * (utf8.len(var_236_7) / 55)

				if (55 <= 0 and var_236_6 or var_236_6 * (utf8.len(var_236_7) / 55)) > 0 and var_236_6 < var_236_9 then
	...
	Play419011057 = function(arg_237_0, arg_237_1)
		...
		function arg_237_1.onSingleLineUpdate_(arg_240_0)
			...
			if 0 < arg_237_1.time_ and arg_237_1.time_ <= 0 + arg_240_0 then
				...
				local var_240_1 = arg_237_1:FormatText(arg_237_1:GetWordFromCfg(419011057).content)

				arg_237_1.text_.text = var_240_1

				LuaForUtil.ClearLinePrefixSymbol(arg_237_1.text_)

				local var_240_3 = 46 <= 0 and var_240_0 or var_240_0 * (utf8.len(var_240_1) / 46)

				if (46 <= 0 and var_240_0 or var_240_0 * (utf8.len(var_240_1) / 46)) > 0 and var_240_0 < var_240_3 then
	...
	Play419011058 = function(arg_241_0, arg_241_1)
		...
		function arg_241_1.onSingleLineUpdate_(arg_244_0)
			...
			if 0 < arg_241_1.time_ and arg_241_1.time_ <= var_244_4 + arg_244_0 then
				...
				local var_244_6 = arg_241_1:FormatText(arg_241_1:GetWordFromCfg(419011058).content)

				arg_241_1.text_.text = var_244_6

				LuaForUtil.ClearLinePrefixSymbol(arg_241_1.text_)

				local var_244_8 = 14 <= 0 and var_244_5 or var_244_5 * (utf8.len(var_244_6) / 14)

				if (14 <= 0 and var_244_5 or var_244_5 * (utf8.len(var_244_6) / 14)) > 0 and var_244_5 < var_244_8 then
	...
	Play419011059 = function(arg_245_0, arg_245_1)
		...
		function arg_245_1.onSingleLineUpdate_(arg_248_0)
			if 0 < arg_245_1.time_ and arg_245_1.time_ <= 0 + arg_248_0 then
				arg_245_1.var_.moveOldPos2079ui_story = arg_245_1.actors_["2079ui_story"].transform.localPosition
			end

			local var_248_0 = 0.001

			if 0 <= arg_245_1.time_ and arg_245_1.time_ < 0 + var_248_0 then
				arg_245_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_245_1.var_.moveOldPos2079ui_story, Vector3.New(0.7, -1.28, -5.6), (arg_245_1.time_ - 0) / var_248_0)
				arg_245_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_245_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_245_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_245_1.actors_["2079ui_story"].transform.position).z)
				arg_245_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_245_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_245_1.actors_["2079ui_story"].transform.localEulerAngles = arg_245_1.actors_["2079ui_story"].transform.localEulerAngles
			end

			if arg_245_1.time_ >= 0 + var_248_0 and arg_245_1.time_ < 0 + var_248_0 + arg_248_0 then
				arg_245_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0.7, -1.28, -5.6)
				arg_245_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_245_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_245_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_245_1.actors_["2079ui_story"].transform.position).z)
				arg_245_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_245_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_245_1.actors_["2079ui_story"].transform.localEulerAngles = arg_245_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			local var_248_1 = arg_245_1.actors_["2079ui_story"]

			if 0 < arg_245_1.time_ and arg_245_1.time_ <= 0 + arg_248_0 and not isNil(var_248_1) and arg_245_1.var_.characterEffect2079ui_story == nil then
				arg_245_1.var_.characterEffect2079ui_story = var_248_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_248_2 = 0.200000002980232

			if 0 <= arg_245_1.time_ and arg_245_1.time_ < 0 + var_248_2 and not isNil(var_248_1) then
				if arg_245_1.var_.characterEffect2079ui_story and not isNil(var_248_1) then
					arg_245_1.var_.characterEffect2079ui_story.fillFlat = false
				end
			end

			if arg_245_1.time_ >= 0 + var_248_2 and arg_245_1.time_ < 0 + var_248_2 + arg_248_0 and not isNil(var_248_1) and arg_245_1.var_.characterEffect2079ui_story then
				arg_245_1.var_.characterEffect2079ui_story.fillFlat = false
			end

			local var_248_4 = arg_245_1.actors_["1095ui_story"]

			if 0 < arg_245_1.time_ and arg_245_1.time_ <= 0 + arg_248_0 and not isNil(var_248_4) and arg_245_1.var_.characterEffect1095ui_story == nil then
				arg_245_1.var_.characterEffect1095ui_story = var_248_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_248_5 = 0.200000002980232

			if 0 <= arg_245_1.time_ and arg_245_1.time_ < 0 + var_248_5 and not isNil(var_248_4) then
				if arg_245_1.var_.characterEffect1095ui_story and not isNil(var_248_4) then
					arg_245_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_245_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_245_1.time_ - 0) / var_248_5)
				end
			end

			if arg_245_1.time_ >= 0 + var_248_5 and arg_245_1.time_ < 0 + var_248_5 + arg_248_0 and not isNil(var_248_4) and arg_245_1.var_.characterEffect1095ui_story then
				arg_245_1.var_.characterEffect1095ui_story.fillFlat = true
			...
			if 0 < arg_245_1.time_ and arg_245_1.time_ <= var_248_6 + arg_248_0 then
				...
				arg_245_1.leftNameTxt_.text = arg_245_1:FormatText(StoryNameCfg[646].name)
				...
				local var_248_8 = arg_245_1:FormatText(arg_245_1:GetWordFromCfg(419011059).content)

				arg_245_1.text_.text = var_248_8

				LuaForUtil.ClearLinePrefixSymbol(arg_245_1.text_)

				local var_248_10 = 4 <= 0 and var_248_7 or var_248_7 * (utf8.len(var_248_8) / 4)

				if (4 <= 0 and var_248_7 or var_248_7 * (utf8.len(var_248_8) / 4)) > 0 and var_248_7 < var_248_10 then
	...
	Play419011060 = function(arg_249_0, arg_249_1)
		...
		function arg_249_1.onSingleLineUpdate_(arg_252_0)
			...
			local var_252_2 = arg_249_1.actors_["2079ui_story"]

			if 0 < arg_249_1.time_ and arg_249_1.time_ <= 0 + arg_252_0 and not isNil(var_252_2) and arg_249_1.var_.characterEffect2079ui_story == nil then
				arg_249_1.var_.characterEffect2079ui_story = var_252_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_252_3 = 0.200000002980232

			if 0 <= arg_249_1.time_ and arg_249_1.time_ < 0 + var_252_3 and not isNil(var_252_2) then
				if arg_249_1.var_.characterEffect2079ui_story and not isNil(var_252_2) then
					arg_249_1.var_.characterEffect2079ui_story.fillFlat = true
					arg_249_1.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_249_1.time_ - 0) / var_252_3)
				end
			end

			if arg_249_1.time_ >= 0 + var_252_3 and arg_249_1.time_ < 0 + var_252_3 + arg_252_0 and not isNil(var_252_2) and arg_249_1.var_.characterEffect2079ui_story then
				arg_249_1.var_.characterEffect2079ui_story.fillFlat = true
				arg_249_1.var_.characterEffect2079ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_249_1.time_ and arg_249_1.time_ <= var_252_4 + arg_252_0 then
				...
				local var_252_6 = arg_249_1:FormatText(arg_249_1:GetWordFromCfg(419011060).content)

				arg_249_1.text_.text = var_252_6

				LuaForUtil.ClearLinePrefixSymbol(arg_249_1.text_)

				local var_252_8 = 14 <= 0 and var_252_5 or var_252_5 * (utf8.len(var_252_6) / 14)

				if (14 <= 0 and var_252_5 or var_252_5 * (utf8.len(var_252_6) / 14)) > 0 and var_252_5 < var_252_8 then
	...
	Play419011061 = function(arg_253_0, arg_253_1)
		...
		function arg_253_1.onSingleLineUpdate_(arg_256_0)
			if 0 < arg_253_1.time_ and arg_253_1.time_ <= 0 + arg_256_0 then
				arg_253_1.var_.moveOldPos2079ui_story = arg_253_1.actors_["2079ui_story"].transform.localPosition
			end

			local var_256_0 = 0.001

			if 0 <= arg_253_1.time_ and arg_253_1.time_ < 0 + var_256_0 then
				arg_253_1.actors_["2079ui_story"].transform.localPosition = Vector3.Lerp(arg_253_1.var_.moveOldPos2079ui_story, Vector3.New(0, 100, 0), (arg_253_1.time_ - 0) / var_256_0)
				arg_253_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_253_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_253_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_253_1.actors_["2079ui_story"].transform.position).z)
				arg_253_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_253_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_253_1.actors_["2079ui_story"].transform.localEulerAngles = arg_253_1.actors_["2079ui_story"].transform.localEulerAngles
			end

			if arg_253_1.time_ >= 0 + var_256_0 and arg_253_1.time_ < 0 + var_256_0 + arg_256_0 then
				arg_253_1.actors_["2079ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_253_1.actors_["2079ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_253_1.actors_["2079ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_253_1.actors_["2079ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_253_1.actors_["2079ui_story"].transform.position).z)
				arg_253_1.actors_["2079ui_story"].transform.localEulerAngles.z = 0
				arg_253_1.actors_["2079ui_story"].transform.localEulerAngles.x = 0
				arg_253_1.actors_["2079ui_story"].transform.localEulerAngles = arg_253_1.actors_["2079ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_253_1.time_ and arg_253_1.time_ < 0 + var_256_2 then
				var_256_1.localPosition = Vector3.Lerp(arg_253_1.var_.moveOldPos1095ui_story, Vector3.New(0, 100, 0), (arg_253_1.time_ - 0) / var_256_2)
			...
			local var_256_3 = arg_253_1.actors_["1095ui_story"]

			if 0 < arg_253_1.time_ and arg_253_1.time_ <= 0 + arg_256_0 and not isNil(var_256_3) and arg_253_1.var_.characterEffect1095ui_story == nil then
				arg_253_1.var_.characterEffect1095ui_story = var_256_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_256_4 = 0.200000002980232

			if 0 <= arg_253_1.time_ and arg_253_1.time_ < 0 + var_256_4 and not isNil(var_256_3) then
				if arg_253_1.var_.characterEffect1095ui_story and not isNil(var_256_3) then
					arg_253_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_253_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_253_1.time_ - 0) / var_256_4)
				end
			end

			if arg_253_1.time_ >= 0 + var_256_4 and arg_253_1.time_ < 0 + var_256_4 + arg_256_0 and not isNil(var_256_3) and arg_253_1.var_.characterEffect1095ui_story then
				arg_253_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_253_1.var_.characterEffect1095ui_story.fillRatio = 0.5
			end

			local var_256_5 = 0
			local var_256_6 = 1.425
			...
			if 0 < arg_253_1.time_ and arg_253_1.time_ <= var_256_5 + arg_256_0 then
				...
				local var_256_7 = arg_253_1:FormatText(arg_253_1:GetWordFromCfg(419011061).content)

				arg_253_1.text_.text = var_256_7

				LuaForUtil.ClearLinePrefixSymbol(arg_253_1.text_)

				local var_256_9 = 57 <= 0 and var_256_6 or var_256_6 * (utf8.len(var_256_7) / 57)

				if (57 <= 0 and var_256_6 or var_256_6 * (utf8.len(var_256_7) / 57)) > 0 and var_256_6 < var_256_9 then
	...
	Play419011062 = function(arg_257_0, arg_257_1)
		...
		function arg_257_1.onSingleLineUpdate_(arg_260_0)
			...
			local var_260_0 = 0.366666666666667

			if 0 <= arg_257_1.time_ and arg_257_1.time_ < 0 + var_260_0 then
				local var_260_1 = Color.New(0.7924528, 0.1308295, 0.1308295)

				var_260_1.a = Mathf.Lerp(1, 0, (arg_257_1.time_ - 0) / var_260_0)
				arg_257_1.mask_.color = var_260_1
			end

			if arg_257_1.time_ >= 0 + var_260_0 and arg_257_1.time_ < 0 + var_260_0 + arg_260_0 then
				local var_260_2 = Color.New(0.7924528, 0.1308295, 0.1308295)

				arg_257_1.mask_.enabled = false
				var_260_2.a = 0
				arg_257_1.mask_.color = var_260_2
			end

			local var_260_3 = 0.366666666666667

			if 0.366666666666667 < arg_257_1.time_ and arg_257_1.time_ <= var_260_3 + arg_260_0 then
				arg_257_1.mask_.enabled = true
				arg_257_1.mask_.raycastTarget = true
			...
			local var_260_4 = 0.533333333333333

			if var_260_3 <= arg_257_1.time_ and arg_257_1.time_ < var_260_3 + var_260_4 then
				local var_260_5 = Color.New(0.6603774, 0.08410467, 0.08410467)
			...
			if arg_257_1.time_ >= var_260_3 + var_260_4 and arg_257_1.time_ < var_260_3 + var_260_4 + arg_260_0 then
				local var_260_6 = Color.New(0.6603774, 0.08410467, 0.08410467)
			...
			if arg_257_1.time_ >= var_260_7 + 0.9 and arg_257_1.time_ < var_260_7 + 0.9 + arg_260_0 then
			...
			local var_260_8 = 0.7
			local var_260_9 = 1.55

			if 0.7 < arg_257_1.time_ and arg_257_1.time_ <= var_260_8 + arg_260_0 then
				...
				local var_260_10 = LeanTween.value(arg_257_1.dialog_, 0, 1, 0.3)

				var_260_10:setOnUpdate(LuaHelper.FloatAction(function(arg_261_0)
					arg_257_1.dialogCg_.alpha = arg_261_0
				end))
				var_260_10:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_257_1.dialog_)
					var_260_10:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_260_11 = arg_257_1:FormatText(arg_257_1:GetWordFromCfg(419011062).content)

				arg_257_1.text_.text = var_260_11

				LuaForUtil.ClearLinePrefixSymbol(arg_257_1.text_)

				local var_260_13 = 62 <= 0 and var_260_9 or var_260_9 * (utf8.len(var_260_11) / 62)

				if (62 <= 0 and var_260_9 or var_260_9 * (utf8.len(var_260_11) / 62)) > 0 and var_260_9 < var_260_13 then
					arg_257_1.talkMaxDuration = var_260_13
					var_260_8 = var_260_8 + 0.3
			...
			local var_260_14 = var_260_8 + 0.3
			local var_260_15 = math.max(var_260_9, arg_257_1.talkMaxDuration)

			if var_260_8 + 0.3 <= arg_257_1.time_ and arg_257_1.time_ < var_260_14 + var_260_15 then
				arg_257_1.typewritter.percent = (arg_257_1.time_ - var_260_14) / var_260_15
	...
	Play419011063 = function(arg_263_0, arg_263_1)
		...
		function arg_263_1.onSingleLineUpdate_(arg_266_0)
			if 0 < arg_263_1.time_ and arg_263_1.time_ <= 0 + arg_266_0 then
				...
				local var_266_2 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_263_1.bgmTxt_.text ~= var_266_2 and arg_263_1.bgmTxt_.text ~= "" then
						if arg_263_1.bgmTxt2_.text ~= "" then
							arg_263_1.bgmTxt_.text = arg_263_1.bgmTxt2_.text
						end

						arg_263_1.bgmTxt2_.text = var_266_2

						arg_263_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_263_1.bgmTxt_.text = var_266_2
						arg_263_1.bgmTxt2_.text = var_266_2
					end
			...
			if 0 < arg_263_1.time_ and arg_263_1.time_ <= var_266_3 + arg_266_0 then
				...
				arg_263_1.leftNameTxt_.text = arg_263_1:FormatText(StoryNameCfg[36].name)
				...
				local var_266_5 = arg_263_1:FormatText(arg_263_1:GetWordFromCfg(419011063).content)

				arg_263_1.text_.text = var_266_5

				LuaForUtil.ClearLinePrefixSymbol(arg_263_1.text_)

				local var_266_7 = 25 <= 0 and var_266_4 or var_266_4 * (utf8.len(var_266_5) / 25)

				if (25 <= 0 and var_266_4 or var_266_4 * (utf8.len(var_266_5) / 25)) > 0 and var_266_4 < var_266_7 then
	...
	Play419011064 = function(arg_268_0, arg_268_1)
		...
		function arg_268_1.onSingleLineUpdate_(arg_271_0)
			if 0 < arg_268_1.time_ and arg_268_1.time_ <= 0 + arg_271_0 then
				arg_268_1.var_.moveOldPos1095ui_story = arg_268_1.actors_["1095ui_story"].transform.localPosition
			end

			local var_271_0 = 0.001

			if 0 <= arg_268_1.time_ and arg_268_1.time_ < 0 + var_271_0 then
				arg_268_1.actors_["1095ui_story"].transform.localPosition = Vector3.Lerp(arg_268_1.var_.moveOldPos1095ui_story, Vector3.New(0, -0.98, -6.1), (arg_268_1.time_ - 0) / var_271_0)
				arg_268_1.actors_["1095ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_268_1.actors_["1095ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_268_1.actors_["1095ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_268_1.actors_["1095ui_story"].transform.position).z)
				arg_268_1.actors_["1095ui_story"].transform.localEulerAngles.z = 0
				arg_268_1.actors_["1095ui_story"].transform.localEulerAngles.x = 0
				arg_268_1.actors_["1095ui_story"].transform.localEulerAngles = arg_268_1.actors_["1095ui_story"].transform.localEulerAngles
			end

			if arg_268_1.time_ >= 0 + var_271_0 and arg_268_1.time_ < 0 + var_271_0 + arg_271_0 then
				arg_268_1.actors_["1095ui_story"].transform.localPosition = Vector3.New(0, -0.98, -6.1)
				arg_268_1.actors_["1095ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_268_1.actors_["1095ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_268_1.actors_["1095ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_268_1.actors_["1095ui_story"].transform.position).z)
				arg_268_1.actors_["1095ui_story"].transform.localEulerAngles.z = 0
				arg_268_1.actors_["1095ui_story"].transform.localEulerAngles.x = 0
				arg_268_1.actors_["1095ui_story"].transform.localEulerAngles = arg_268_1.actors_["1095ui_story"].transform.localEulerAngles
			...
			local var_271_1 = arg_268_1.actors_["1095ui_story"]

			if 0 < arg_268_1.time_ and arg_268_1.time_ <= 0 + arg_271_0 and not isNil(var_271_1) and arg_268_1.var_.characterEffect1095ui_story == nil then
				arg_268_1.var_.characterEffect1095ui_story = var_271_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_271_2 = 0.200000002980232

			if 0 <= arg_268_1.time_ and arg_268_1.time_ < 0 + var_271_2 and not isNil(var_271_1) then
				if arg_268_1.var_.characterEffect1095ui_story and not isNil(var_271_1) then
					arg_268_1.var_.characterEffect1095ui_story.fillFlat = false
				end
			end

			if arg_268_1.time_ >= 0 + var_271_2 and arg_268_1.time_ < 0 + var_271_2 + arg_271_0 and not isNil(var_271_1) and arg_268_1.var_.characterEffect1095ui_story then
				arg_268_1.var_.characterEffect1095ui_story.fillFlat = false
			end

			local var_271_4 = "1076ui_story"

			if arg_268_1.actors_["1076ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1076ui_story"))) then
				local var_271_5 = Object.Instantiate(Asset.Load("Char/" .. "1076ui_story"), arg_268_1.stage_.transform)

				var_271_5.name = var_271_4
				var_271_5.transform.localPosition = Vector3.New(0, 100, 0)
				arg_268_1.actors_[var_271_4] = var_271_5

				local var_271_6 = var_271_5:GetComponentInChildren(typeof(CharacterEffect))

				var_271_6.enabled = true

				local var_271_7 = GameObjectTools.GetOrAddComponent(var_271_5, typeof(DynamicBoneHelper))

				if var_271_7 then
					var_271_7:EnableDynamicBone(false)
				end

				arg_268_1:ShowWeapon(var_271_6.transform, false)

				arg_268_1.var_[var_271_4 .. "Animator"] = var_271_6.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_268_1.var_[var_271_4 .. "Animator"].applyRootMotion = true
				arg_268_1.var_[var_271_4 .. "LipSync"] = var_271_6.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_271_8 = arg_268_1.actors_["1076ui_story"]

			if 0 < arg_268_1.time_ and arg_268_1.time_ <= 0 + arg_271_0 and not isNil(var_271_8) and arg_268_1.var_.characterEffect1076ui_story == nil then
				arg_268_1.var_.characterEffect1076ui_story = var_271_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_271_9 = 0.200000002980232

			if 0 <= arg_268_1.time_ and arg_268_1.time_ < 0 + var_271_9 and not isNil(var_271_8) then
				if arg_268_1.var_.characterEffect1076ui_story and not isNil(var_271_8) then
					arg_268_1.var_.characterEffect1076ui_story.fillFlat = true
					arg_268_1.var_.characterEffect1076ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_268_1.time_ - 0) / var_271_9)
				end
			end

			if arg_268_1.time_ >= 0 + var_271_9 and arg_268_1.time_ < 0 + var_271_9 + arg_271_0 and not isNil(var_271_8) and arg_268_1.var_.characterEffect1076ui_story then
				arg_268_1.var_.characterEffect1076ui_story.fillFlat = true
				arg_268_1.var_.characterEffect1076ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_268_1.time_ and arg_268_1.time_ <= var_271_10 + arg_271_0 then
				...
				arg_268_1.leftNameTxt_.text = arg_268_1:FormatText(StoryNameCfg[471].name)
				...
				local var_271_12 = arg_268_1:FormatText(arg_268_1:GetWordFromCfg(419011064).content)

				arg_268_1.text_.text = var_271_12

				LuaForUtil.ClearLinePrefixSymbol(arg_268_1.text_)

				local var_271_14 = 3 <= 0 and var_271_11 or var_271_11 * (utf8.len(var_271_12) / 3)

				if (3 <= 0 and var_271_11 or var_271_11 * (utf8.len(var_271_12) / 3)) > 0 and var_271_11 < var_271_14 then
	...
	Play419011065 = function(arg_272_0, arg_272_1)
		...
		function arg_272_1.onSingleLineUpdate_(arg_275_0)
			...
			if arg_272_1.bgs_.SS1901 == nil then
				local var_275_0 = Object.Instantiate(arg_272_1.paintGo_)

				var_275_0:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. "SS1901")
				var_275_0.name = "SS1901"
				var_275_0.transform.parent = arg_272_1.stage_.transform
				var_275_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_272_1.bgs_.SS1901 = var_275_0
			end

			if 1.98333333333333 < arg_272_1.time_ and arg_272_1.time_ <= 1.98333333333333 + arg_275_0 then
				local var_275_1 = arg_272_1.bgs_.SS1901

				arg_272_1.bgs_.SS1901.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
				var_275_1.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_275_2 = var_275_1:GetComponent("SpriteRenderer")

				if var_275_2 and var_275_2.sprite then
					local var_275_3 = 2 * (var_275_1.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_275_1.transform.localScale = Vector3.New(var_275_3 / var_275_2.sprite.bounds.size.y < var_275_3 * manager.ui.mainCameraCom_.aspect / var_275_2.sprite.bounds.size.x and var_275_3 * manager.ui.mainCameraCom_.aspect / var_275_2.sprite.bounds.size.x or var_275_3 / var_275_2.sprite.bounds.size.y, var_275_3 / var_275_2.sprite.bounds.size.y < var_275_3 * manager.ui.mainCameraCom_.aspect / var_275_2.sprite.bounds.size.x and var_275_3 * manager.ui.mainCameraCom_.aspect / var_275_2.sprite.bounds.size.x or var_275_3 / var_275_2.sprite.bounds.size.y, 0)
				end
			...
			if 4 < arg_272_1.time_ and arg_272_1.time_ <= var_275_4 + arg_275_0 then
				arg_272_1.allBtn_.enabled = false
			end

			if arg_272_1.time_ >= var_275_4 + 0.3 and arg_272_1.time_ < var_275_4 + 0.3 + arg_275_0 then
			...
			if var_275_5 <= arg_272_1.time_ and arg_272_1.time_ < var_275_5 + var_275_6 then
				local var_275_7 = Color.New(0, 0, 0)

				var_275_7.a = Mathf.Lerp(0, 1, (arg_272_1.time_ - var_275_5) / var_275_6)
				arg_272_1.mask_.color = var_275_7
			end

			if arg_272_1.time_ >= var_275_5 + var_275_6 and arg_272_1.time_ < var_275_5 + var_275_6 + arg_275_0 then
				local var_275_8 = Color.New(0, 0, 0)

				var_275_8.a = 1
				arg_272_1.mask_.color = var_275_8
			end

			local var_275_9 = 2

			if 2 < arg_272_1.time_ and arg_272_1.time_ <= var_275_9 + arg_275_0 then
				arg_272_1.mask_.enabled = true
				arg_272_1.mask_.raycastTarget = true
			...
			if var_275_9 <= arg_272_1.time_ and arg_272_1.time_ < var_275_9 + var_275_10 then
				local var_275_11 = Color.New(0, 0, 0)

				var_275_11.a = Mathf.Lerp(1, 0, (arg_272_1.time_ - var_275_9) / var_275_10)
				arg_272_1.mask_.color = var_275_11
			end

			if arg_272_1.time_ >= var_275_9 + var_275_10 and arg_272_1.time_ < var_275_9 + var_275_10 + arg_275_0 then
				local var_275_12 = Color.New(0, 0, 0)

				arg_272_1.mask_.enabled = false
				var_275_12.a = 0
				arg_272_1.mask_.color = var_275_12
			end

			local var_275_13 = arg_272_1.actors_["1095ui_story"].transform

			if 1.96599999815226 < arg_272_1.time_ and arg_272_1.time_ <= 1.96599999815226 + arg_275_0 then
				arg_272_1.var_.moveOldPos1095ui_story = var_275_13.localPosition
			end

			local var_275_14 = 0.001

			if 1.96599999815226 <= arg_272_1.time_ and arg_272_1.time_ < 1.96599999815226 + var_275_14 then
				var_275_13.localPosition = Vector3.Lerp(arg_272_1.var_.moveOldPos1095ui_story, Vector3.New(0, 100, 0), (arg_272_1.time_ - 1.96599999815226) / var_275_14)
				var_275_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_275_13.position).x, (manager.ui.mainCamera.transform.position - var_275_13.position).y, (manager.ui.mainCamera.transform.position - var_275_13.position).z)
				var_275_13.localEulerAngles.z = 0
				var_275_13.localEulerAngles.x = 0
				var_275_13.localEulerAngles = var_275_13.localEulerAngles
			end

			if arg_272_1.time_ >= 1.96599999815226 + var_275_14 and arg_272_1.time_ < 1.96599999815226 + var_275_14 + arg_275_0 then
				var_275_13.localPosition = Vector3.New(0, 100, 0)
				var_275_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_275_13.position).x, (manager.ui.mainCamera.transform.position - var_275_13.position).y, (manager.ui.mainCamera.transform.position - var_275_13.position).z)
				var_275_13.localEulerAngles.z = 0
				var_275_13.localEulerAngles.x = 0
				var_275_13.localEulerAngles = var_275_13.localEulerAngles
			...
			local var_275_15 = arg_272_1.actors_["1095ui_story"]

			if 1.96599999815226 < arg_272_1.time_ and arg_272_1.time_ <= 1.96599999815226 + arg_275_0 and not isNil(var_275_15) and arg_272_1.var_.characterEffect1095ui_story == nil then
				arg_272_1.var_.characterEffect1095ui_story = var_275_15:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_275_16 = 0.034000001847744

			if 1.96599999815226 <= arg_272_1.time_ and arg_272_1.time_ < 1.96599999815226 + var_275_16 and not isNil(var_275_15) then
				if arg_272_1.var_.characterEffect1095ui_story and not isNil(var_275_15) then
					arg_272_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_272_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_272_1.time_ - 1.96599999815226) / var_275_16)
				end
			end

			if arg_272_1.time_ >= 1.96599999815226 + var_275_16 and arg_272_1.time_ < 1.96599999815226 + var_275_16 + arg_275_0 and not isNil(var_275_15) and arg_272_1.var_.characterEffect1095ui_story then
				arg_272_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_272_1.var_.characterEffect1095ui_story.fillRatio = 0.5
			end

			local var_275_17 = arg_272_1.bgs_.SS1901.transform

			if 2 < arg_272_1.time_ and arg_272_1.time_ <= 2 + arg_275_0 then
				arg_272_1.var_.moveOldPosSS1901 = var_275_17.localPosition
			end

			local var_275_18 = 0.001

			if 2 <= arg_272_1.time_ and arg_272_1.time_ < 2 + var_275_18 then
				var_275_17.localPosition = Vector3.Lerp(arg_272_1.var_.moveOldPosSS1901, Vector3.New(0, 0.76, 5.85), (arg_272_1.time_ - 2) / var_275_18)
			end

			if arg_272_1.time_ >= 2 + var_275_18 and arg_272_1.time_ < 2 + var_275_18 + arg_275_0 then
				var_275_17.localPosition = Vector3.New(0, 0.76, 5.85)
			end

			local var_275_19 = arg_272_1.bgs_.SS1901.transform

			if 2.01666666666667 < arg_272_1.time_ and arg_272_1.time_ <= 2.01666666666667 + arg_275_0 then
				arg_272_1.var_.moveOldPosSS1901 = var_275_19.localPosition
			end

			local var_275_20 = 2.18333333333333

			if 2.01666666666667 <= arg_272_1.time_ and arg_272_1.time_ < 2.01666666666667 + var_275_20 then
				var_275_19.localPosition = Vector3.Lerp(arg_272_1.var_.moveOldPosSS1901, Vector3.New(0, 1, 9.02), (arg_272_1.time_ - 2.01666666666667) / var_275_20)
			end

			if arg_272_1.time_ >= 2.01666666666667 + var_275_20 and arg_272_1.time_ < 2.01666666666667 + var_275_20 + arg_275_0 then
				var_275_19.localPosition = Vector3.New(0, 1, 9.02)
			end

			if 2.23333333333333 < arg_272_1.time_ and arg_272_1.time_ <= 2.23333333333333 + arg_275_0 then
				local var_275_21 = arg_272_1.var_.effect899

				if not arg_272_1.var_.effect899 then
					var_275_21 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_dust"), manager.ui.mainCamera.transform)
					var_275_21.name = "899"
					arg_272_1.var_.effect899 = var_275_21
				else
					var_275_21.transform:SetParent(var_275_9001)
				end

				var_275_21.transform.localPosition = Vector3.New(0, 0.17, -0.34)
				var_275_21.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_275_23 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_275_2, iter_275_3 in ipairs((var_275_21.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_275_3.transform.localScale = Vector3.New(iter_275_3.transform.localScale.x / var_275_23 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_275_3.transform.localScale.y / var_275_23, iter_275_3.transform.localScale.z)
				end
			end

			if 2.01666666666667 < arg_272_1.time_ and arg_272_1.time_ <= 2.01666666666667 + arg_275_0 then
				local var_275_25 = arg_272_1.var_.effect784

				if not arg_272_1.var_.effect784 then
					var_275_25 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_qiliu_in_keep"), manager.ui.mainCamera.transform)
					var_275_25.name = "784"
					arg_272_1.var_.effect784 = var_275_25
				else
					var_275_25.transform:SetParent(var_275_9000)
				end

				var_275_25.transform.localPosition = Vector3.New(0, -0.29, 0.21)
				var_275_25.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_275_27 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_275_4, iter_275_5 in ipairs((var_275_25.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_275_5.transform.localScale = Vector3.New(iter_275_5.transform.localScale.x / var_275_27 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_275_5.transform.localScale.y / var_275_27, iter_275_5.transform.localScale.z)
				end
			end

			local var_275_29 = 3.48333333333333

			if 3.48333333333333 < arg_272_1.time_ and arg_272_1.time_ <= var_275_29 + arg_275_0 then
				arg_272_1.allBtn_.enabled = false
			end

			if arg_272_1.time_ >= var_275_29 + 0.716666666666666 and arg_272_1.time_ < var_275_29 + 0.716666666666666 + arg_275_0 then
				arg_272_1.allBtn_.enabled = true
			end
			...
			local var_275_30 = 3.8
			local var_275_31 = 1.075

			if 3.8 < arg_272_1.time_ and arg_272_1.time_ <= var_275_30 + arg_275_0 then
				...
				local var_275_32 = LeanTween.value(arg_272_1.dialog_, 0, 1, 0.3)

				var_275_32:setOnUpdate(LuaHelper.FloatAction(function(arg_276_0)
					arg_272_1.dialogCg_.alpha = arg_276_0
				end))
				var_275_32:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_272_1.dialog_)
					var_275_32:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_275_33 = arg_272_1:FormatText(arg_272_1:GetWordFromCfg(419011065).content)

				arg_272_1.text_.text = var_275_33

				LuaForUtil.ClearLinePrefixSymbol(arg_272_1.text_)

				local var_275_35 = 43 <= 0 and var_275_31 or var_275_31 * (utf8.len(var_275_33) / 43)

				if (43 <= 0 and var_275_31 or var_275_31 * (utf8.len(var_275_33) / 43)) > 0 and var_275_31 < var_275_35 then
					arg_272_1.talkMaxDuration = var_275_35
					var_275_30 = var_275_30 + 0.3

					if var_275_35 + var_275_30 > arg_272_1.duration_ then
						arg_272_1.duration_ = var_275_35 + var_275_30
					end
				end
			...
			local var_275_36 = var_275_30 + 0.3
			local var_275_37 = math.max(var_275_31, arg_272_1.talkMaxDuration)

			if var_275_30 + 0.3 <= arg_272_1.time_ and arg_272_1.time_ < var_275_36 + var_275_37 then
				arg_272_1.typewritter.percent = (arg_272_1.time_ - var_275_36) / var_275_37

				arg_272_1.typewritter:SetDirty()
			end

			if arg_272_1.time_ >= var_275_36 + var_275_37 and arg_272_1.time_ < var_275_36 + var_275_37 + arg_275_0 then
	...
	Play419011066 = function(arg_278_0, arg_278_1)
		...
		function arg_278_1.onSingleLineUpdate_(arg_281_0)
			if 0.733333333333333 < arg_278_1.time_ and arg_278_1.time_ <= 0.733333333333333 + arg_281_0 then
				arg_278_1:AudioAction("play", "effect", "se_story_140", "se_story_140_laser", "")
			end
			...
			if 0 < arg_278_1.time_ and arg_278_1.time_ <= var_281_1 + arg_281_0 then
				...
				local var_281_3 = arg_278_1:FormatText(arg_278_1:GetWordFromCfg(419011066).content)

				arg_278_1.text_.text = var_281_3

				LuaForUtil.ClearLinePrefixSymbol(arg_278_1.text_)

				local var_281_5 = 44 <= 0 and var_281_2 or var_281_2 * (utf8.len(var_281_3) / 44)

				if (44 <= 0 and var_281_2 or var_281_2 * (utf8.len(var_281_3) / 44)) > 0 and var_281_2 < var_281_5 then
	...
	Play419011067 = function(arg_282_0, arg_282_1)
		...
		function arg_282_1.onSingleLineUpdate_(arg_285_0)
			if 0 < arg_282_1.time_ and arg_282_1.time_ <= 0 + arg_285_0 and not isNil(arg_282_1.actors_["1076ui_story"]) and arg_282_1.var_.characterEffect1076ui_story == nil then
				arg_282_1.var_.characterEffect1076ui_story = arg_282_1.actors_["1076ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_285_0 = 0.200000002980232

			if 0 <= arg_282_1.time_ and arg_282_1.time_ < 0 + var_285_0 and not isNil(arg_282_1.actors_["1076ui_story"]) then
				if arg_282_1.var_.characterEffect1076ui_story and not isNil(arg_282_1.actors_["1076ui_story"]) then
					arg_282_1.var_.characterEffect1076ui_story.fillFlat = false
				end
			end

			if arg_282_1.time_ >= 0 + var_285_0 and arg_282_1.time_ < 0 + var_285_0 + arg_285_0 and not isNil(arg_282_1.actors_["1076ui_story"]) and arg_282_1.var_.characterEffect1076ui_story then
				arg_282_1.var_.characterEffect1076ui_story.fillFlat = false
			end
			...
			if 0 < arg_282_1.time_ and arg_282_1.time_ <= var_285_2 + arg_285_0 then
				...
				local var_285_4 = arg_282_1:FormatText(arg_282_1:GetWordFromCfg(419011067).content)

				arg_282_1.text_.text = var_285_4

				LuaForUtil.ClearLinePrefixSymbol(arg_282_1.text_)

				local var_285_6 = 28 <= 0 and var_285_3 or var_285_3 * (utf8.len(var_285_4) / 28)

				if (28 <= 0 and var_285_3 or var_285_3 * (utf8.len(var_285_4) / 28)) > 0 and var_285_3 < var_285_6 then
	...
	Play419011068 = function(arg_286_0, arg_286_1)
		...
		function arg_286_1.onSingleLineUpdate_(arg_289_0)
			...
			if 0 < arg_286_1.time_ and arg_286_1.time_ <= 0 + arg_289_0 then
				...
				local var_289_1 = arg_286_1:FormatText(arg_286_1:GetWordFromCfg(419011068).content)
	...
	Play419011069 = function(arg_290_0, arg_290_1)
		...
		function arg_290_1.onSingleLineUpdate_(arg_293_0)
			if 0.266666666666667 < arg_290_1.time_ and arg_290_1.time_ <= 0.266666666666667 + arg_293_0 then
				arg_290_1:AudioAction("play", "effect", "se_story_141", "se_story_141_snake04", "")
			end

			local var_293_1 = 0
			local var_293_2 = 1.175
			...
			if 0 < arg_290_1.time_ and arg_290_1.time_ <= var_293_1 + arg_293_0 then
				...
				local var_293_3 = arg_290_1:FormatText(arg_290_1:GetWordFromCfg(419011069).content)

				arg_290_1.text_.text = var_293_3

				LuaForUtil.ClearLinePrefixSymbol(arg_290_1.text_)

				local var_293_5 = 47 <= 0 and var_293_2 or var_293_2 * (utf8.len(var_293_3) / 47)

				if (47 <= 0 and var_293_2 or var_293_2 * (utf8.len(var_293_3) / 47)) > 0 and var_293_2 < var_293_5 then
	...
	Play419011070 = function(arg_294_0, arg_294_1)
		...
		function arg_294_1.onSingleLineUpdate_(arg_297_0)
			...
			if 0 <= arg_294_1.time_ and arg_294_1.time_ < 0 + var_297_0 then
				local var_297_1 = Color.New(1, 1, 1)

				var_297_1.a = Mathf.Lerp(1, 0, (arg_294_1.time_ - 0) / var_297_0)
				arg_294_1.mask_.color = var_297_1
			end

			if arg_294_1.time_ >= 0 + var_297_0 and arg_294_1.time_ < 0 + var_297_0 + arg_297_0 then
				local var_297_2 = Color.New(1, 1, 1)
			...
			if 0 < arg_294_1.time_ and arg_294_1.time_ <= 0 + arg_297_0 then
				local var_297_3 = arg_294_1.bgs_.SS1901

				arg_294_1.bgs_.SS1901.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if arg_294_1.time_ >= var_297_6 + 1.36666666666667 and arg_294_1.time_ < var_297_6 + 1.36666666666667 + arg_297_0 then
				arg_294_1.allBtn_.enabled = true
			end

			if 0.0166666666666666 < arg_294_1.time_ and arg_294_1.time_ <= 0.0166666666666666 + arg_297_0 then
				arg_294_1:AudioAction("play", "effect", "se_story_142", "se_story_142_whip", "")
			end
			...
			if 1 < arg_294_1.time_ and arg_294_1.time_ <= var_297_8 + arg_297_0 then
				...
				local var_297_11 = arg_294_1:FormatText(arg_294_1:GetWordFromCfg(419011070).content)

				arg_294_1.text_.text = var_297_11

				LuaForUtil.ClearLinePrefixSymbol(arg_294_1.text_)

				local var_297_13 = 45 <= 0 and var_297_9 or var_297_9 * (utf8.len(var_297_11) / 45)

				if (45 <= 0 and var_297_9 or var_297_9 * (utf8.len(var_297_11) / 45)) > 0 and var_297_9 < var_297_13 then
			...
			local var_297_14 = var_297_8 + 0.3
			local var_297_15 = math.max(var_297_9, arg_294_1.talkMaxDuration)

			if var_297_8 + 0.3 <= arg_294_1.time_ and arg_294_1.time_ < var_297_14 + var_297_15 then
				arg_294_1.typewritter.percent = (arg_294_1.time_ - var_297_14) / var_297_15
	...
	Play419011071 = function(arg_300_0, arg_300_1)
		...
		function arg_300_1.onSingleLineUpdate_(arg_303_0)
			if 0.05 < arg_300_1.time_ and arg_300_1.time_ <= 0.05 + arg_303_0 then
				arg_300_1:AudioAction("play", "effect", "se_story_142", "se_story_142_sword01", "")
			end

			local var_303_1 = 0
			local var_303_2 = 1.45
			...
			if 0 < arg_300_1.time_ and arg_300_1.time_ <= var_303_1 + arg_303_0 then
				...
				local var_303_3 = arg_300_1:FormatText(arg_300_1:GetWordFromCfg(419011071).content)

				arg_300_1.text_.text = var_303_3

				LuaForUtil.ClearLinePrefixSymbol(arg_300_1.text_)

				local var_303_5 = 58 <= 0 and var_303_2 or var_303_2 * (utf8.len(var_303_3) / 58)

				if (58 <= 0 and var_303_2 or var_303_2 * (utf8.len(var_303_3) / 58)) > 0 and var_303_2 < var_303_5 then
	...
	Play419011072 = function(arg_304_0, arg_304_1)
		...
		function arg_304_1.onSingleLineUpdate_(arg_307_0)
			if 0 < arg_304_1.time_ and arg_304_1.time_ <= 0 + arg_307_0 and not isNil(arg_304_1.actors_["1076ui_story"]) and arg_304_1.var_.characterEffect1076ui_story == nil then
				arg_304_1.var_.characterEffect1076ui_story = arg_304_1.actors_["1076ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_307_0 = 0.200000002980232

			if 0 <= arg_304_1.time_ and arg_304_1.time_ < 0 + var_307_0 and not isNil(arg_304_1.actors_["1076ui_story"]) then
				if arg_304_1.var_.characterEffect1076ui_story and not isNil(arg_304_1.actors_["1076ui_story"]) then
					arg_304_1.var_.characterEffect1076ui_story.fillFlat = false
				end
			end

			if arg_304_1.time_ >= 0 + var_307_0 and arg_304_1.time_ < 0 + var_307_0 + arg_307_0 and not isNil(arg_304_1.actors_["1076ui_story"]) and arg_304_1.var_.characterEffect1076ui_story then
				arg_304_1.var_.characterEffect1076ui_story.fillFlat = false
			end

			local var_307_2 = 0
			local var_307_3 = 0.775
			...
			if 0 < arg_304_1.time_ and arg_304_1.time_ <= var_307_2 + arg_307_0 then
				...
				local var_307_4 = arg_304_1:FormatText(arg_304_1:GetWordFromCfg(419011072).content)

				arg_304_1.text_.text = var_307_4

				LuaForUtil.ClearLinePrefixSymbol(arg_304_1.text_)

				local var_307_6 = 38 <= 0 and var_307_3 or var_307_3 * (utf8.len(var_307_4) / 38)

				if (38 <= 0 and var_307_3 or var_307_3 * (utf8.len(var_307_4) / 38)) > 0 and var_307_3 < var_307_6 then
	...
	Play419011073 = function(arg_308_0, arg_308_1)
		...
		function arg_308_1.onSingleLineUpdate_(arg_311_0)
			...
			if 0 < arg_308_1.time_ and arg_308_1.time_ <= 0 + arg_311_0 then
				...
				local var_311_1 = arg_308_1:FormatText(arg_308_1:GetWordFromCfg(419011073).content)

				arg_308_1.text_.text = var_311_1

				LuaForUtil.ClearLinePrefixSymbol(arg_308_1.text_)

				local var_311_3 = 24 <= 0 and var_311_0 or var_311_0 * (utf8.len(var_311_1) / 24)

				if (24 <= 0 and var_311_0 or var_311_0 * (utf8.len(var_311_1) / 24)) > 0 and var_311_0 < var_311_3 then
	...
	Play419011074 = function(arg_312_0, arg_312_1)
		...
		function arg_312_1.onSingleLineUpdate_(arg_315_0)
			...
			if 0 < arg_312_1.time_ and arg_312_1.time_ <= 0 + arg_315_0 then
				...
				local var_315_1 = arg_312_1:FormatText(arg_312_1:GetWordFromCfg(419011074).content)
	...
	Play419011075 = function(arg_316_0, arg_316_1)
		...
		function arg_316_1.onSingleLineUpdate_(arg_319_0)
			if 0 < arg_316_1.time_ and arg_316_1.time_ <= 0 + arg_319_0 and not isNil(arg_316_1.actors_["1076ui_story"]) and arg_316_1.var_.characterEffect1076ui_story == nil then
				arg_316_1.var_.characterEffect1076ui_story = arg_316_1.actors_["1076ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_319_0 = 0.200000002980232

			if 0 <= arg_316_1.time_ and arg_316_1.time_ < 0 + var_319_0 and not isNil(arg_316_1.actors_["1076ui_story"]) then
				if arg_316_1.var_.characterEffect1076ui_story and not isNil(arg_316_1.actors_["1076ui_story"]) then
					arg_316_1.var_.characterEffect1076ui_story.fillFlat = false
				end
			end

			if arg_316_1.time_ >= 0 + var_319_0 and arg_316_1.time_ < 0 + var_319_0 + arg_319_0 and not isNil(arg_316_1.actors_["1076ui_story"]) and arg_316_1.var_.characterEffect1076ui_story then
				arg_316_1.var_.characterEffect1076ui_story.fillFlat = false
			end

			local var_319_2 = arg_316_1.actors_["1095ui_story"]

			if 0 < arg_316_1.time_ and arg_316_1.time_ <= 0 + arg_319_0 and not isNil(var_319_2) and arg_316_1.var_.characterEffect1095ui_story == nil then
				arg_316_1.var_.characterEffect1095ui_story = var_319_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_319_3 = 0.200000002980232

			if 0 <= arg_316_1.time_ and arg_316_1.time_ < 0 + var_319_3 and not isNil(var_319_2) then
				if arg_316_1.var_.characterEffect1095ui_story and not isNil(var_319_2) then
					arg_316_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_316_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_316_1.time_ - 0) / var_319_3)
				end
			end

			if arg_316_1.time_ >= 0 + var_319_3 and arg_316_1.time_ < 0 + var_319_3 + arg_319_0 and not isNil(var_319_2) and arg_316_1.var_.characterEffect1095ui_story then
				arg_316_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_316_1.var_.characterEffect1095ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_316_1.time_ and arg_316_1.time_ <= var_319_4 + arg_319_0 then
				...
				local var_319_6 = arg_316_1:FormatText(arg_316_1:GetWordFromCfg(419011075).content)

				arg_316_1.text_.text = var_319_6

				LuaForUtil.ClearLinePrefixSymbol(arg_316_1.text_)

				local var_319_8 = 25 <= 0 and var_319_5 or var_319_5 * (utf8.len(var_319_6) / 25)

				if (25 <= 0 and var_319_5 or var_319_5 * (utf8.len(var_319_6) / 25)) > 0 and var_319_5 < var_319_8 then
					arg_316_1.talkMaxDuration = var_319_8

					if var_319_8 + var_319_4 > arg_316_1.duration_ then
						arg_316_1.duration_ = var_319_8 + var_319_4
					end
				end
			...
			local var_319_9 = math.max(var_319_5, arg_316_1.talkMaxDuration)

			if var_319_4 <= arg_316_1.time_ and arg_316_1.time_ < var_319_4 + var_319_9 then
				arg_316_1.typewritter.percent = (arg_316_1.time_ - var_319_4) / var_319_9

				arg_316_1.typewritter:SetDirty()
			end

			if arg_316_1.time_ >= var_319_4 + var_319_9 and arg_316_1.time_ < var_319_4 + var_319_9 + arg_319_0 then
	...
	Play419011076 = function(arg_320_0, arg_320_1)
		...
		function arg_320_1.onSingleLineUpdate_(arg_323_0)
			if 0 < arg_320_1.time_ and arg_320_1.time_ <= 0 + arg_323_0 and not isNil(arg_320_1.actors_["1095ui_story"]) and arg_320_1.var_.characterEffect1095ui_story == nil then
				arg_320_1.var_.characterEffect1095ui_story = arg_320_1.actors_["1095ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_323_0 = 0.200000002980232

			if 0 <= arg_320_1.time_ and arg_320_1.time_ < 0 + var_323_0 and not isNil(arg_320_1.actors_["1095ui_story"]) then
				if arg_320_1.var_.characterEffect1095ui_story and not isNil(arg_320_1.actors_["1095ui_story"]) then
					arg_320_1.var_.characterEffect1095ui_story.fillFlat = false
				end
			end

			if arg_320_1.time_ >= 0 + var_323_0 and arg_320_1.time_ < 0 + var_323_0 + arg_323_0 and not isNil(arg_320_1.actors_["1095ui_story"]) and arg_320_1.var_.characterEffect1095ui_story then
				arg_320_1.var_.characterEffect1095ui_story.fillFlat = false
			end

			local var_323_2 = arg_320_1.actors_["1076ui_story"]

			if 0 < arg_320_1.time_ and arg_320_1.time_ <= 0 + arg_323_0 and not isNil(var_323_2) and arg_320_1.var_.characterEffect1076ui_story == nil then
				arg_320_1.var_.characterEffect1076ui_story = var_323_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_323_3 = 0.200000002980232

			if 0 <= arg_320_1.time_ and arg_320_1.time_ < 0 + var_323_3 and not isNil(var_323_2) then
				if arg_320_1.var_.characterEffect1076ui_story and not isNil(var_323_2) then
					arg_320_1.var_.characterEffect1076ui_story.fillFlat = true
					arg_320_1.var_.characterEffect1076ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_320_1.time_ - 0) / var_323_3)
				end
			end

			if arg_320_1.time_ >= 0 + var_323_3 and arg_320_1.time_ < 0 + var_323_3 + arg_323_0 and not isNil(var_323_2) and arg_320_1.var_.characterEffect1076ui_story then
				arg_320_1.var_.characterEffect1076ui_story.fillFlat = true
				arg_320_1.var_.characterEffect1076ui_story.fillRatio = 0.5
			end

			local var_323_4 = 0
			local var_323_5 = 0.225
			...
			if 0 < arg_320_1.time_ and arg_320_1.time_ <= var_323_4 + arg_323_0 then
				...
				local var_323_6 = arg_320_1:FormatText(arg_320_1:GetWordFromCfg(419011076).content)

				arg_320_1.text_.text = var_323_6

				LuaForUtil.ClearLinePrefixSymbol(arg_320_1.text_)

				local var_323_8 = 9 <= 0 and var_323_5 or var_323_5 * (utf8.len(var_323_6) / 9)

				if (9 <= 0 and var_323_5 or var_323_5 * (utf8.len(var_323_6) / 9)) > 0 and var_323_5 < var_323_8 then
	...
	Play419011077 = function(arg_324_0, arg_324_1)
		...
		function arg_324_1.onSingleLineUpdate_(arg_327_0)
			if 0 < arg_324_1.time_ and arg_324_1.time_ <= 0 + arg_327_0 and not isNil(arg_324_1.actors_["1076ui_story"]) and arg_324_1.var_.characterEffect1076ui_story == nil then
				arg_324_1.var_.characterEffect1076ui_story = arg_324_1.actors_["1076ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_327_0 = 0.200000002980232

			if 0 <= arg_324_1.time_ and arg_324_1.time_ < 0 + var_327_0 and not isNil(arg_324_1.actors_["1076ui_story"]) then
				if arg_324_1.var_.characterEffect1076ui_story and not isNil(arg_324_1.actors_["1076ui_story"]) then
					arg_324_1.var_.characterEffect1076ui_story.fillFlat = false
				end
			end

			if arg_324_1.time_ >= 0 + var_327_0 and arg_324_1.time_ < 0 + var_327_0 + arg_327_0 and not isNil(arg_324_1.actors_["1076ui_story"]) and arg_324_1.var_.characterEffect1076ui_story then
				arg_324_1.var_.characterEffect1076ui_story.fillFlat = false
			end

			local var_327_2 = arg_324_1.actors_["1095ui_story"]

			if 0 < arg_324_1.time_ and arg_324_1.time_ <= 0 + arg_327_0 and not isNil(var_327_2) and arg_324_1.var_.characterEffect1095ui_story == nil then
				arg_324_1.var_.characterEffect1095ui_story = var_327_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_327_3 = 0.200000002980232

			if 0 <= arg_324_1.time_ and arg_324_1.time_ < 0 + var_327_3 and not isNil(var_327_2) then
				if arg_324_1.var_.characterEffect1095ui_story and not isNil(var_327_2) then
					arg_324_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_324_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_324_1.time_ - 0) / var_327_3)
				end
			end

			if arg_324_1.time_ >= 0 + var_327_3 and arg_324_1.time_ < 0 + var_327_3 + arg_327_0 and not isNil(var_327_2) and arg_324_1.var_.characterEffect1095ui_story then
				arg_324_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_324_1.var_.characterEffect1095ui_story.fillRatio = 0.5
			end

			local var_327_4 = 0
			local var_327_5 = 0.575
			...
			if 0 < arg_324_1.time_ and arg_324_1.time_ <= var_327_4 + arg_327_0 then
				...
				local var_327_6 = arg_324_1:FormatText(arg_324_1:GetWordFromCfg(419011077).content)

				arg_324_1.text_.text = var_327_6

				LuaForUtil.ClearLinePrefixSymbol(arg_324_1.text_)

				local var_327_8 = 32 <= 0 and var_327_5 or var_327_5 * (utf8.len(var_327_6) / 32)

				if (32 <= 0 and var_327_5 or var_327_5 * (utf8.len(var_327_6) / 32)) > 0 and var_327_5 < var_327_8 then
					arg_324_1.talkMaxDuration = var_327_8

					if var_327_8 + var_327_4 > arg_324_1.duration_ then
						arg_324_1.duration_ = var_327_8 + var_327_4
					end
				end
			...
			local var_327_9 = math.max(var_327_5, arg_324_1.talkMaxDuration)

			if var_327_4 <= arg_324_1.time_ and arg_324_1.time_ < var_327_4 + var_327_9 then
				arg_324_1.typewritter.percent = (arg_324_1.time_ - var_327_4) / var_327_9

				arg_324_1.typewritter:SetDirty()
			end

			if arg_324_1.time_ >= var_327_4 + var_327_9 and arg_324_1.time_ < var_327_4 + var_327_9 + arg_327_0 then
	...
	Play419011078 = function(arg_328_0, arg_328_1)
		...
		function arg_328_1.onSingleLineUpdate_(arg_331_0)
			...
			if 0 < arg_328_1.time_ and arg_328_1.time_ <= 0 + arg_331_0 then
				...
				local var_331_1 = arg_328_1:FormatText(arg_328_1:GetWordFromCfg(419011078).content)

				arg_328_1.text_.text = var_331_1

				LuaForUtil.ClearLinePrefixSymbol(arg_328_1.text_)

				local var_331_3 = 7 <= 0 and var_331_0 or var_331_0 * (utf8.len(var_331_1) / 7)

				if (7 <= 0 and var_331_0 or var_331_0 * (utf8.len(var_331_1) / 7)) > 0 and var_331_0 < var_331_3 then
	...
	Play419011079 = function(arg_332_0, arg_332_1)
		...
		function arg_332_1.onSingleLineUpdate_(arg_335_0)
			...
			if 0 < arg_332_1.time_ and arg_332_1.time_ <= 0 + arg_335_0 then
				...
				arg_332_1.leftNameTxt_.text = arg_332_1:FormatText(StoryNameCfg[471].name)
				...
				local var_335_1 = arg_332_1:FormatText(arg_332_1:GetWordFromCfg(419011079).content)

				arg_332_1.text_.text = var_335_1

				LuaForUtil.ClearLinePrefixSymbol(arg_332_1.text_)

				local var_335_3 = 3 <= 0 and var_335_0 or var_335_0 * (utf8.len(var_335_1) / 3)

				if (3 <= 0 and var_335_0 or var_335_0 * (utf8.len(var_335_1) / 3)) > 0 and var_335_0 < var_335_3 then
	...
	Play419011080 = function(arg_336_0, arg_336_1)
		...
		function arg_336_1.onSingleLineUpdate_(arg_339_0)
			if 0 < arg_336_1.time_ and arg_336_1.time_ <= 0 + arg_339_0 and not isNil(arg_336_1.actors_["1076ui_story"]) and arg_336_1.var_.characterEffect1076ui_story == nil then
				arg_336_1.var_.characterEffect1076ui_story = arg_336_1.actors_["1076ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_339_0 = 0.200000002980232

			if 0 <= arg_336_1.time_ and arg_336_1.time_ < 0 + var_339_0 and not isNil(arg_336_1.actors_["1076ui_story"]) then
				if arg_336_1.var_.characterEffect1076ui_story and not isNil(arg_336_1.actors_["1076ui_story"]) then
					arg_336_1.var_.characterEffect1076ui_story.fillFlat = false
				end
			end

			if arg_336_1.time_ >= 0 + var_339_0 and arg_336_1.time_ < 0 + var_339_0 + arg_339_0 and not isNil(arg_336_1.actors_["1076ui_story"]) and arg_336_1.var_.characterEffect1076ui_story then
				arg_336_1.var_.characterEffect1076ui_story.fillFlat = false
			end

			local var_339_2 = arg_336_1.actors_["1095ui_story"]

			if 0 < arg_336_1.time_ and arg_336_1.time_ <= 0 + arg_339_0 and not isNil(var_339_2) and arg_336_1.var_.characterEffect1095ui_story == nil then
				arg_336_1.var_.characterEffect1095ui_story = var_339_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_339_3 = 0.200000002980232

			if 0 <= arg_336_1.time_ and arg_336_1.time_ < 0 + var_339_3 and not isNil(var_339_2) then
				if arg_336_1.var_.characterEffect1095ui_story and not isNil(var_339_2) then
					arg_336_1.var_.characterEffect1095ui_story.fillFlat = true
					arg_336_1.var_.characterEffect1095ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_336_1.time_ - 0) / var_339_3)
				end
			end

			if arg_336_1.time_ >= 0 + var_339_3 and arg_336_1.time_ < 0 + var_339_3 + arg_339_0 and not isNil(var_339_2) and arg_336_1.var_.characterEffect1095ui_story then
				arg_336_1.var_.characterEffect1095ui_story.fillFlat = true
				arg_336_1.var_.characterEffect1095ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_336_1.time_ and arg_336_1.time_ <= var_339_4 + arg_339_0 then
				...
				local var_339_6 = LeanTween.value(arg_336_1.dialog_, 0, 1, 0.3)

				var_339_6:setOnUpdate(LuaHelper.FloatAction(function(arg_340_0)
					arg_336_1.dialogCg_.alpha = arg_340_0
				end))
				var_339_6:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_336_1.dialog_)
					var_339_6:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				arg_336_1.leftNameTxt_.text = arg_336_1:FormatText(StoryNameCfg[1202].name)
				...
				local var_339_7 = arg_336_1:FormatText(arg_336_1:GetWordFromCfg(419011080).content)

				arg_336_1.text_.text = var_339_7

				LuaForUtil.ClearLinePrefixSymbol(arg_336_1.text_)

				local var_339_9 = 14 <= 0 and var_339_5 or var_339_5 * (utf8.len(var_339_7) / 14)

				if (14 <= 0 and var_339_5 or var_339_5 * (utf8.len(var_339_7) / 14)) > 0 and var_339_5 < var_339_9 then
					arg_336_1.talkMaxDuration = var_339_9
					var_339_4 = var_339_4 + 0.3
			...
			local var_339_10 = var_339_4 + 0.3
			local var_339_11 = math.max(var_339_5, arg_336_1.talkMaxDuration)

			if var_339_4 + 0.3 <= arg_336_1.time_ and arg_336_1.time_ < var_339_10 + var_339_11 then
				arg_336_1.typewritter.percent = (arg_336_1.time_ - var_339_10) / var_339_11
	...
	Play419011081 = function(arg_342_0, arg_342_1)
		...
		function arg_342_1.onSingleLineUpdate_(arg_345_0)
			...
			if 1.2 < arg_342_1.time_ and arg_342_1.time_ <= 1.2 + arg_345_0 and not isNil(arg_342_1.actors_["1076ui_story"]) and arg_342_1.var_.characterEffect1076ui_story == nil then
				arg_342_1.var_.characterEffect1076ui_story = arg_342_1.actors_["1076ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_345_0 = 0.200000002980232

			if 1.2 <= arg_342_1.time_ and arg_342_1.time_ < 1.2 + var_345_0 and not isNil(arg_342_1.actors_["1076ui_story"]) then
				if arg_342_1.var_.characterEffect1076ui_story and not isNil(arg_342_1.actors_["1076ui_story"]) then
					arg_342_1.var_.characterEffect1076ui_story.fillFlat = true
					arg_342_1.var_.characterEffect1076ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_342_1.time_ - 1.2) / var_345_0)
				end
			end

			if arg_342_1.time_ >= 1.2 + var_345_0 and arg_342_1.time_ < 1.2 + var_345_0 + arg_345_0 and not isNil(arg_342_1.actors_["1076ui_story"]) and arg_342_1.var_.characterEffect1076ui_story then
				arg_342_1.var_.characterEffect1076ui_story.fillFlat = true
				arg_342_1.var_.characterEffect1076ui_story.fillRatio = 0.5
			end

			local var_345_1 = 1.21666666666667

			if 1.21666666666667 < arg_342_1.time_ and arg_342_1.time_ <= var_345_1 + arg_345_0 then
			...
			local var_345_2 = 0.383333333333333

			if var_345_1 <= arg_342_1.time_ and arg_342_1.time_ < var_345_1 + var_345_2 then
				local var_345_3 = Color.New(1, 1, 1)

				var_345_3.a = Mathf.Lerp(1, 0, (arg_342_1.time_ - var_345_1) / var_345_2)
				arg_342_1.mask_.color = var_345_3
			end

			if arg_342_1.time_ >= var_345_1 + var_345_2 and arg_342_1.time_ < var_345_1 + var_345_2 + arg_345_0 then
				local var_345_4 = Color.New(1, 1, 1)

				arg_342_1.mask_.enabled = false
				var_345_4.a = 0
				arg_342_1.mask_.color = var_345_4
			end

			local var_345_5 = arg_342_1.bgs_.SS1901.transform

			if 1.2 < arg_342_1.time_ and arg_342_1.time_ <= 1.2 + arg_345_0 then
				arg_342_1.var_.moveOldPosSS1901 = var_345_5.localPosition
			end

			local var_345_6 = 0.001

			if 1.2 <= arg_342_1.time_ and arg_342_1.time_ < 1.2 + var_345_6 then
				var_345_5.localPosition = Vector3.Lerp(arg_342_1.var_.moveOldPosSS1901, Vector3.New(0, 2.49, 1.93), (arg_342_1.time_ - 1.2) / var_345_6)
			end

			if arg_342_1.time_ >= 1.2 + var_345_6 and arg_342_1.time_ < 1.2 + var_345_6 + arg_345_0 then
				var_345_5.localPosition = Vector3.New(0, 2.49, 1.93)
			end

			local var_345_7 = arg_342_1.bgs_.SS1901.transform

			if 1.3 < arg_342_1.time_ and arg_342_1.time_ <= 1.3 + arg_345_0 then
				arg_342_1.var_.moveOldPosSS1901 = var_345_7.localPosition
			end

			local var_345_8 = 3.03333333333333

			if 1.3 <= arg_342_1.time_ and arg_342_1.time_ < 1.3 + var_345_8 then
				var_345_7.localPosition = Vector3.Lerp(arg_342_1.var_.moveOldPosSS1901, Vector3.New(0, -0.09, 1.93), (arg_342_1.time_ - 1.3) / var_345_8)
			end

			if arg_342_1.time_ >= 1.3 + var_345_8 and arg_342_1.time_ < 1.3 + var_345_8 + arg_345_0 then
				var_345_7.localPosition = Vector3.New(0, -0.09, 1.93)
			end

			local var_345_9 = 1.2

			if 1.2 < arg_342_1.time_ and arg_342_1.time_ <= var_345_9 + arg_345_0 then
				arg_342_1.allBtn_.enabled = false
			end

			if arg_342_1.time_ >= var_345_9 + 3.13333333333333 and arg_342_1.time_ < var_345_9 + 3.13333333333333 + arg_345_0 then
				arg_342_1.allBtn_.enabled = true
			end

			if 0 < arg_342_1.time_ and arg_342_1.time_ <= 0 + arg_345_0 then
				local var_345_10 = arg_342_1.var_.effectshunshan

				if not arg_342_1.var_.effectshunshan then
					var_345_10 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_in_keep"), manager.ui.mainCamera.transform)
					var_345_10.name = "shunshan"
					arg_342_1.var_.effectshunshan = var_345_10
				else
					var_345_10.transform:SetParent(var_345_9001)
				end

				var_345_10.transform.localPosition = Vector3.New(0, 0, 0)
				var_345_10.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			if 1.2 < arg_342_1.time_ and arg_342_1.time_ <= 1.2 + arg_345_0 then
				if arg_342_1.var_.effectshunshan then
					Object.Destroy(arg_342_1.var_.effectshunshan)

					arg_342_1.var_.effectshunshan = nil
				end
			end

			if 1.21666666666667 < arg_342_1.time_ and arg_342_1.time_ <= 1.21666666666667 + arg_345_0 then
				local var_345_13 = arg_342_1.var_.effectshunshan1

				if not arg_342_1.var_.effectshunshan1 then
					var_345_13 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_out"), manager.ui.mainCamera.transform)
					var_345_13.name = "shunshan1"
					arg_342_1.var_.effectshunshan1 = var_345_13
				else
					var_345_13.transform:SetParent(var_345_9000)
				end

				var_345_13.transform.localPosition = Vector3.New(0, 0, 0)
				var_345_13.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			if 1.71666666666667 < arg_342_1.time_ and arg_342_1.time_ <= 1.71666666666667 + arg_345_0 then
				if arg_342_1.var_.effectshunshan1 then
					Object.Destroy(arg_342_1.var_.effectshunshan1)

					arg_342_1.var_.effectshunshan1 = nil
				end
			end

			if 1 < arg_342_1.time_ and arg_342_1.time_ <= 1 + arg_345_0 then
				arg_342_1:AudioAction("play", "effect", "se_story_142", "se_story_142_sword02", "")
			end
			...
			local var_345_17 = 3.93333333333333
			local var_345_18 = 1.15

			if 3.93333333333333 < arg_342_1.time_ and arg_342_1.time_ <= var_345_17 + arg_345_0 then
				...
				local var_345_20 = arg_342_1:FormatText(arg_342_1:GetWordFromCfg(419011081).content)

				arg_342_1.text_.text = var_345_20

				LuaForUtil.ClearLinePrefixSymbol(arg_342_1.text_)

				local var_345_22 = 46 <= 0 and var_345_18 or var_345_18 * (utf8.len(var_345_20) / 46)

				if (46 <= 0 and var_345_18 or var_345_18 * (utf8.len(var_345_20) / 46)) > 0 and var_345_18 < var_345_22 then
	...
	Play419011082 = function(arg_348_0, arg_348_1)
		...
		function arg_348_1.onSingleLineUpdate_(arg_351_0)
			if 0 < arg_348_1.time_ and arg_348_1.time_ <= 0 + arg_351_0 and not isNil(arg_348_1.actors_["1076ui_story"]) and arg_348_1.var_.characterEffect1076ui_story == nil then
				arg_348_1.var_.characterEffect1076ui_story = arg_348_1.actors_["1076ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_351_0 = 0.200000002980232

			if 0 <= arg_348_1.time_ and arg_348_1.time_ < 0 + var_351_0 and not isNil(arg_348_1.actors_["1076ui_story"]) then
				if arg_348_1.var_.characterEffect1076ui_story and not isNil(arg_348_1.actors_["1076ui_story"]) then
					arg_348_1.var_.characterEffect1076ui_story.fillFlat = false
				end
			end

			if arg_348_1.time_ >= 0 + var_351_0 and arg_348_1.time_ < 0 + var_351_0 + arg_351_0 and not isNil(arg_348_1.actors_["1076ui_story"]) and arg_348_1.var_.characterEffect1076ui_story then
				arg_348_1.var_.characterEffect1076ui_story.fillFlat = false
			end

			local var_351_2 = 0
			local var_351_3 = 0.375
			...
			if 0 < arg_348_1.time_ and arg_348_1.time_ <= var_351_2 + arg_351_0 then
				...
				arg_348_1.leftNameTxt_.text = arg_348_1:FormatText(StoryNameCfg[1202].name)
				...
				local var_351_4 = arg_348_1:FormatText(arg_348_1:GetWordFromCfg(419011082).content)

				arg_348_1.text_.text = var_351_4

				LuaForUtil.ClearLinePrefixSymbol(arg_348_1.text_)

				local var_351_6 = 9 <= 0 and var_351_3 or var_351_3 * (utf8.len(var_351_4) / 9)

				if (9 <= 0 and var_351_3 or var_351_3 * (utf8.len(var_351_4) / 9)) > 0 and var_351_3 < var_351_6 then
