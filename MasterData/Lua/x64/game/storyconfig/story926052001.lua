	...
	Play926052021 = function(arg_87_0, arg_87_1)
		...
		function arg_87_1.onSingleLineUpdate_(arg_90_0)
			...
			if 0.2 < arg_87_1.time_ and arg_87_1.time_ <= 0.2 + arg_90_0 then
				...
				for iter_90_12, iter_90_13 in ipairs((var_90_14.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_90_13.transform.localScale = Vector3.New(iter_90_13.transform.localScale.x / var_90_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_90_13.transform.localScale.y / var_90_16, iter_90_13.transform.localScale.z)
				end
			end

			if 0 < arg_87_1.time_ and arg_87_1.time_ <= 0 + arg_90_0 then
				local var_90_18 = arg_87_1.var_.effect777

				if not arg_87_1.var_.effect777 then
					var_90_18 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_voice_keep"), manager.ui.mainCamera.transform)
					var_90_18.name = "777"
					arg_87_1.var_.effect777 = var_90_18
				else
					var_90_18.transform:SetParent(var_90_9000)
				end

				var_90_18.transform.localPosition = Vector3.New(-0.07, 0, 1.46)
				var_90_18.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			if 0 < arg_87_1.time_ and arg_87_1.time_ <= 0 + arg_90_0 then
				local var_90_20 = arg_87_1.actors_["10144"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_90_20 then
					arg_87_1.var_.alphaOldValue10144 = var_90_20.alpha
					arg_87_1.var_.characterEffect10144 = var_90_20
				end

				arg_87_1.var_.alphaOldValue10144 = 0
			end

			local var_90_21 = 0.566666666666667

			if 0 <= arg_87_1.time_ and arg_87_1.time_ < 0 + var_90_21 then
				if arg_87_1.var_.characterEffect10144 then
					arg_87_1.var_.characterEffect10144.alpha = Mathf.Lerp(arg_87_1.var_.alphaOldValue10144, 1, (arg_87_1.time_ - 0) / var_90_21)
				end
			end

			if arg_87_1.time_ >= 0 + var_90_21 and arg_87_1.time_ < 0 + var_90_21 + arg_90_0 and arg_87_1.var_.characterEffect10144 then
			...
			local var_90_24 = 1.63333333333333
			local var_90_25 = 0.15

			if 1.63333333333333 < arg_87_1.time_ and arg_87_1.time_ <= var_90_24 + arg_90_0 then
				...
				local var_90_27 = arg_87_1:GetWordFromCfg(926052021)
				...
				local var_90_30 = 6 <= 0 and var_90_25 or var_90_25 * (utf8.len(var_90_28) / 6)

				if (6 <= 0 and var_90_25 or var_90_25 * (utf8.len(var_90_28) / 6)) > 0 and var_90_25 < var_90_30 then
				...
				if manager.audio:GetVoiceLength("story_v_out_926052", "926052021", "story_v_out_926052.awb") ~= 0 then
					local var_90_31 = manager.audio:GetVoiceLength("story_v_out_926052", "926052021", "story_v_out_926052.awb") / 1000
					...
					if var_90_27.prefab_name ~= "" and arg_87_1.actors_[var_90_27.prefab_name] ~= nil then
						local var_90_32 = LuaForUtil.PlayVoiceWithCriLipsync(arg_87_1.actors_[var_90_27.prefab_name].transform, "story_v_out_926052", "926052021", "story_v_out_926052.awb")

						arg_87_1:RecordAudio("926052021", var_90_32)
						arg_87_1:RecordAudio("926052021", var_90_32)
					else
			...
			local var_90_33 = var_90_24 + 0.3
			local var_90_34 = math.max(var_90_25, arg_87_1.talkMaxDuration)

			if var_90_24 + 0.3 <= arg_87_1.time_ and arg_87_1.time_ < var_90_33 + var_90_34 then
	...
	Play926052038 = function(arg_157_0, arg_157_1)
		...
		function arg_157_1.onSingleLineUpdate_(arg_160_0)
			...
			if 0 < arg_157_1.time_ and arg_157_1.time_ <= 0 + arg_160_0 then
				...
				for iter_160_4, iter_160_5 in ipairs((var_160_2.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_160_5.transform.localScale = Vector3.New(iter_160_5.transform.localScale.x / var_160_4 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_160_5.transform.localScale.y / var_160_4, iter_160_5.transform.localScale.z)
				end
			end

			if 0 < arg_157_1.time_ and arg_157_1.time_ <= 0 + arg_160_0 then
				local var_160_6 = arg_157_1.var_.effect222

				if not arg_157_1.var_.effect222 then
					var_160_6 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_voice_out"), manager.ui.mainCamera.transform)
					var_160_6.name = "222"
					arg_157_1.var_.effect222 = var_160_6
				else
					var_160_6.transform:SetParent(var_160_9000)
				end

				var_160_6.transform.localPosition = Vector3.New(-0.07, 0, 1.46)
				var_160_6.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			if arg_157_1.time_ >= var_160_10 + 2.7 and arg_157_1.time_ < var_160_10 + 2.7 + arg_160_0 then
			...
			local var_160_14 = 2.06666666666667
			local var_160_15 = 1.1

			if 2.06666666666667 < arg_157_1.time_ and arg_157_1.time_ <= var_160_14 + arg_160_0 then
				...
				local var_160_16 = LeanTween.value(arg_157_1.dialog_, 0, 1, 0.3)

				var_160_16:setOnUpdate(LuaHelper.FloatAction(function(arg_161_0)
					arg_157_1.dialogCg_.alpha = arg_161_0
				end))
				var_160_16:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_157_1.dialog_)
					var_160_16:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_160_17 = arg_157_1:FormatText(arg_157_1:GetWordFromCfg(926052038).content)

				arg_157_1.text_.text = var_160_17

				LuaForUtil.ClearLinePrefixSymbol(arg_157_1.text_)

				local var_160_19 = 44 <= 0 and var_160_15 or var_160_15 * (utf8.len(var_160_17) / 44)

				if (44 <= 0 and var_160_15 or var_160_15 * (utf8.len(var_160_17) / 44)) > 0 and var_160_15 < var_160_19 then
					arg_157_1.talkMaxDuration = var_160_19
					var_160_14 = var_160_14 + 0.3
			...
			local var_160_20 = var_160_14 + 0.3
			local var_160_21 = math.max(var_160_15, arg_157_1.talkMaxDuration)

			if var_160_14 + 0.3 <= arg_157_1.time_ and arg_157_1.time_ < var_160_20 + var_160_21 then
				arg_157_1.typewritter.percent = (arg_157_1.time_ - var_160_20) / var_160_21
