	...
	Play322072011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				...
				for iter_48_0, iter_48_1 in ipairs((var_48_1.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_48_1.transform.localScale = Vector3.New(iter_48_1.transform.localScale.x / var_48_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_48_1.transform.localScale.y / var_48_3, iter_48_1.transform.localScale.z)
				end
			end
			...
			local var_48_6 = manager.ui.mainCamera.transform

			if 0.1 < arg_45_1.time_ and arg_45_1.time_ <= 0.1 + arg_48_0 then
				arg_45_1.var_.shakeOldPos = var_48_6.localPosition
			end

			local var_48_7 = 0.9

			if 0.1 <= arg_45_1.time_ and arg_45_1.time_ < 0.1 + var_48_7 then
				local var_48_8, var_48_9 = math.modf((arg_45_1.time_ - 0.1) / 0.066)

				var_48_6.localPosition = Vector3.New(var_48_9 * 0.13, var_48_9 * 0.13, var_48_9 * 0.13) + arg_45_1.var_.shakeOldPos
			end

			if arg_45_1.time_ >= 0.1 + var_48_7 and arg_45_1.time_ < 0.1 + var_48_7 + arg_48_0 then
				var_48_6.localPosition = arg_45_1.var_.shakeOldPos
			end

			local var_48_10 = 0
			local var_48_11 = 1.25
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_10 + arg_48_0 then
				...
				local var_48_12 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(322072011).content)

				arg_45_1.text_.text = var_48_12

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_14 = 50 <= 0 and var_48_11 or var_48_11 * (utf8.len(var_48_12) / 50)

				if (50 <= 0 and var_48_11 or var_48_11 * (utf8.len(var_48_12) / 50)) > 0 and var_48_11 < var_48_14 then
	...
	Play322072071 = function(arg_298_0, arg_298_1)
		...
		function arg_298_1.onSingleLineUpdate_(arg_301_0)
			...
			if 0.1 < arg_298_1.time_ and arg_298_1.time_ <= 0.1 + arg_301_0 then
				...
				for iter_301_0, iter_301_1 in ipairs((var_301_1.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_301_1.transform.localScale = Vector3.New(iter_301_1.transform.localScale.x / var_301_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_301_1.transform.localScale.y / var_301_3, iter_301_1.transform.localScale.z)
				end
			end
			...
			if 0 < arg_298_1.time_ and arg_298_1.time_ <= var_301_5 + arg_301_0 then
				...
				local var_301_7 = arg_298_1:FormatText(arg_298_1:GetWordFromCfg(322072071).content)

				arg_298_1.text_.text = var_301_7

				LuaForUtil.ClearLinePrefixSymbol(arg_298_1.text_)

				local var_301_9 = 48 <= 0 and var_301_6 or var_301_6 * (utf8.len(var_301_7) / 48)

				if (48 <= 0 and var_301_6 or var_301_6 * (utf8.len(var_301_7) / 48)) > 0 and var_301_6 < var_301_9 then
	...
	Play322072086 = function(arg_358_0, arg_358_1)
		...
		function arg_358_1.onSingleLineUpdate_(arg_361_0)
			...
			if 0.1 < arg_358_1.time_ and arg_358_1.time_ <= 0.1 + arg_361_0 then
				...
				for iter_361_0, iter_361_1 in ipairs((var_361_6.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_361_1.transform.localScale = Vector3.New(iter_361_1.transform.localScale.x / var_361_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_361_1.transform.localScale.y / var_361_8, iter_361_1.transform.localScale.z)
				end
			end

			local var_361_10 = 0
			local var_361_11 = 0.925
			...
			if 0 < arg_358_1.time_ and arg_358_1.time_ <= var_361_10 + arg_361_0 then
				...
				local var_361_12 = arg_358_1:FormatText(arg_358_1:GetWordFromCfg(322072086).content)

				arg_358_1.text_.text = var_361_12

				LuaForUtil.ClearLinePrefixSymbol(arg_358_1.text_)

				local var_361_14 = 37 <= 0 and var_361_11 or var_361_11 * (utf8.len(var_361_12) / 37)

				if (37 <= 0 and var_361_11 or var_361_11 * (utf8.len(var_361_12) / 37)) > 0 and var_361_11 < var_361_14 then
	...
	Play322072105 = function(arg_439_0, arg_439_1)
		...
		function arg_439_1.onSingleLineUpdate_(arg_442_0)
			...
			if 0.366666666666667 < arg_439_1.time_ and arg_439_1.time_ <= 0.366666666666667 + arg_442_0 then
				...
				for iter_442_0, iter_442_1 in ipairs((var_442_8.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_442_1.transform.localScale = Vector3.New(iter_442_1.transform.localScale.x / var_442_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_442_1.transform.localScale.y / var_442_10, iter_442_1.transform.localScale.z)
				end
			end
			...
			if 0.366666666666667 < arg_439_1.time_ and arg_439_1.time_ <= 0.366666666666667 + arg_442_0 then
				local var_442_13 = arg_439_1.var_.effect21051

				if not arg_439_1.var_.effect21051 then
					var_442_13 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_dust"), manager.ui.mainCamera.transform)
					var_442_13.name = "21051"
					arg_439_1.var_.effect21051 = var_442_13
				else
					var_442_13.transform:SetParent(var_442_9000)
				end

				var_442_13.transform.localPosition = Vector3.New(0, 0, -10)
				var_442_13.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_442_15 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_442_2, iter_442_3 in ipairs((var_442_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_442_3.transform.localScale = Vector3.New(iter_442_3.transform.localScale.x / var_442_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_442_3.transform.localScale.y / var_442_15, iter_442_3.transform.localScale.z)
				end
			end
			...
			local var_442_18 = manager.ui.mainCamera.transform

			if 0.366666666666667 < arg_439_1.time_ and arg_439_1.time_ <= 0.366666666666667 + arg_442_0 then
				arg_439_1.var_.shakeOldPos = var_442_18.localPosition
			end

			local var_442_19 = 1.8

			if 0.366666666666667 <= arg_439_1.time_ and arg_439_1.time_ < 0.366666666666667 + var_442_19 then
				local var_442_20, var_442_21 = math.modf((arg_439_1.time_ - 0.366666666666667) / 0.066)

				var_442_18.localPosition = Vector3.New(var_442_21 * 0.13, var_442_21 * 0.13, var_442_21 * 0.13) + arg_439_1.var_.shakeOldPos
			end

			if arg_439_1.time_ >= 0.366666666666667 + var_442_19 and arg_439_1.time_ < 0.366666666666667 + var_442_19 + arg_442_0 then
				var_442_18.localPosition = arg_439_1.var_.shakeOldPos
			end
			...
			local var_442_22 = 2
			local var_442_23 = 1.525

			if 2 < arg_439_1.time_ and arg_439_1.time_ <= var_442_22 + arg_442_0 then
				...
				local var_442_25 = arg_439_1:FormatText(arg_439_1:GetWordFromCfg(322072105).content)

				arg_439_1.text_.text = var_442_25

				LuaForUtil.ClearLinePrefixSymbol(arg_439_1.text_)

				local var_442_27 = 61 <= 0 and var_442_23 or var_442_23 * (utf8.len(var_442_25) / 61)

				if (61 <= 0 and var_442_23 or var_442_23 * (utf8.len(var_442_25) / 61)) > 0 and var_442_23 < var_442_27 then
					arg_439_1.talkMaxDuration = var_442_27
					var_442_22 = var_442_22 + 0.3

					if var_442_27 + var_442_22 > arg_439_1.duration_ then
						arg_439_1.duration_ = var_442_27 + var_442_22
					end
				end
			...
			local var_442_28 = var_442_22 + 0.3
			local var_442_29 = math.max(var_442_23, arg_439_1.talkMaxDuration)

			if var_442_22 + 0.3 <= arg_439_1.time_ and arg_439_1.time_ < var_442_28 + var_442_29 then
				arg_439_1.typewritter.percent = (arg_439_1.time_ - var_442_28) / var_442_29
	...
	Play322072108 = function(arg_453_0, arg_453_1)
		...
		function arg_453_1.onSingleLineUpdate_(arg_456_0)
			...
			if 0.233333333333333 < arg_453_1.time_ and arg_453_1.time_ <= 0.233333333333333 + arg_456_0 then
				...
				for iter_456_0, iter_456_1 in ipairs((var_456_1.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_456_1.transform.localScale = Vector3.New(iter_456_1.transform.localScale.x / var_456_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_456_1.transform.localScale.y / var_456_3, iter_456_1.transform.localScale.z)
				end
			end
			...
			if 0.233333333333333 < arg_453_1.time_ and arg_453_1.time_ <= 0.233333333333333 + arg_456_0 then
				arg_453_1.var_.shakeOldPos = var_456_6.localPosition
			end

			local var_456_7 = 0.166666666666667

			if 0.233333333333333 <= arg_453_1.time_ and arg_453_1.time_ < 0.233333333333333 + var_456_7 then
				local var_456_8, var_456_9 = math.modf((arg_453_1.time_ - 0.233333333333333) / 0.066)

				var_456_6.localPosition = Vector3.New(var_456_9 * 0.13, var_456_9 * 0.13, var_456_9 * 0.13) + arg_453_1.var_.shakeOldPos
			end

			if arg_453_1.time_ >= 0.233333333333333 + var_456_7 and arg_453_1.time_ < 0.233333333333333 + var_456_7 + arg_456_0 then
				var_456_6.localPosition = arg_453_1.var_.shakeOldPos
			end

			local var_456_10 = 0
			local var_456_11 = 1.75
			...
			if 0 < arg_453_1.time_ and arg_453_1.time_ <= var_456_10 + arg_456_0 then
				...
				local var_456_12 = arg_453_1:FormatText(arg_453_1:GetWordFromCfg(322072108).content)

				arg_453_1.text_.text = var_456_12

				LuaForUtil.ClearLinePrefixSymbol(arg_453_1.text_)

				local var_456_14 = 70 <= 0 and var_456_11 or var_456_11 * (utf8.len(var_456_12) / 70)

				if (70 <= 0 and var_456_11 or var_456_11 * (utf8.len(var_456_12) / 70)) > 0 and var_456_11 < var_456_14 then
					arg_453_1.talkMaxDuration = var_456_14

					if var_456_14 + var_456_10 > arg_453_1.duration_ then
						arg_453_1.duration_ = var_456_14 + var_456_10
					end
				end
			...
			local var_456_15 = math.max(var_456_11, arg_453_1.talkMaxDuration)

			if var_456_10 <= arg_453_1.time_ and arg_453_1.time_ < var_456_10 + var_456_15 then
				arg_453_1.typewritter.percent = (arg_453_1.time_ - var_456_10) / var_456_15

				arg_453_1.typewritter:SetDirty()
			end

			if arg_453_1.time_ >= var_456_10 + var_456_15 and arg_453_1.time_ < var_456_10 + var_456_15 + arg_456_0 then
