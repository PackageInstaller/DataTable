	...
	Play910500001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				arg_1_1.leftNameTxt_.text = arg_1_1:FormatText(StoryNameCfg[484].name)
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910500001).content)

				arg_1_1.text_.text = var_4_12

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_14 = 19 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 19)

				if (19 <= 0 and var_4_10 or var_4_10 * (utf8.len(var_4_12) / 19)) > 0 and var_4_10 < var_4_14 then
	...
	Play910500002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				arg_7_1.leftNameTxt_.text = arg_7_1:FormatText(StoryNameCfg[484].name)
				...
				local var_10_1 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910500002).content)
	...
	Play910500003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				arg_11_1.leftNameTxt_.text = arg_11_1:FormatText(StoryNameCfg[484].name)
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910500003).content)

				arg_11_1.text_.text = var_14_1

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_3 = 45 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 45)

				if (45 <= 0 and var_14_0 or var_14_0 * (utf8.len(var_14_1) / 45)) > 0 and var_14_0 < var_14_3 then
	...
	Play910500004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910500004).content)

				arg_15_1.text_.text = var_18_1

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_3 = 36 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 36)

				if (36 <= 0 and var_18_0 or var_18_0 * (utf8.len(var_18_1) / 36)) > 0 and var_18_0 < var_18_3 then
