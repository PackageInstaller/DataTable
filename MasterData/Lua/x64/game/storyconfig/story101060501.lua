return {
	Play106051001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			if arg_1_1.actors_["3004_tpose"] == nil and not isNil((Asset.Load("Char/" .. "3004_tpose"))) then
				local var_4_0 = Object.Instantiate(Asset.Load("Char/" .. "3004_tpose"), arg_1_1.stage_.transform)

				var_4_0.name = "3004_tpose"
				var_4_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_1_1.actors_["3004_tpose"] = var_4_0
				...
				arg_1_1.var_["3004_tpose" .. "Animator"] = var_4_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_1_1.var_["3004_tpose" .. "Animator"].applyRootMotion = true
				arg_1_1.var_["3004_tpose" .. "LipSync"] = var_4_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_4_3 = arg_1_1.actors_["3004_tpose"]

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_3) and arg_1_1.var_.characterEffect3004_tpose == nil then
				arg_1_1.var_.characterEffect3004_tpose = var_4_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_4 = 0.1

			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_4 and not isNil(var_4_3) then
				if arg_1_1.var_.characterEffect3004_tpose and not isNil(var_4_3) then
					arg_1_1.var_.characterEffect3004_tpose.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 2 + var_4_4 and arg_1_1.time_ < 2 + var_4_4 + arg_4_0 and not isNil(var_4_3) and arg_1_1.var_.characterEffect3004_tpose then
				arg_1_1.var_.characterEffect3004_tpose.fillFlat = false
			end
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_8 = arg_1_1.bgs_.ST06a:GetComponent("SpriteRenderer")

				if var_4_8 then
					arg_1_1.var_.alphaOldValueST06a = var_4_8.color.a
					arg_1_1.var_.alphaMatValueST06a = var_4_8
				end
			...
			if 0 <= arg_1_1.time_ and arg_1_1.time_ < 0 + var_4_9 then
				if arg_1_1.var_.alphaMatValueST06a then
					arg_1_1.var_.alphaMatValueST06a.color.a = Mathf.Lerp(arg_1_1.var_.alphaOldValueST06a, 1, (arg_1_1.time_ - 0) / var_4_9)
					arg_1_1.var_.alphaMatValueST06a.color = arg_1_1.var_.alphaMatValueST06a.color
				end
			end

			if arg_1_1.time_ >= 0 + var_4_9 and arg_1_1.time_ < 0 + var_4_9 + arg_4_0 and arg_1_1.var_.alphaMatValueST06a then
			...
			local var_4_13 = arg_1_1.actors_["3004_tpose"].transform

			if 1.79999995231628 < arg_1_1.time_ and arg_1_1.time_ <= 1.79999995231628 + arg_4_0 then
				arg_1_1.var_.moveOldPos3004_tpose = var_4_13.localPosition
			...
			if 1.79999995231628 <= arg_1_1.time_ and arg_1_1.time_ < 1.79999995231628 + var_4_15 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos3004_tpose, Vector3.New(-0.7, -2.22, -3.1), (arg_1_1.time_ - 1.79999995231628) / var_4_15)
			...
			if arg_1_1.time_ >= 1.79999995231628 + var_4_15 and arg_1_1.time_ < 1.79999995231628 + var_4_15 + arg_4_0 then
				var_4_13.localPosition = Vector3.New(-0.7, -2.22, -3.1)
				var_4_13.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_13.position).x, (manager.ui.mainCamera.transform.position - var_4_13.position).y, (manager.ui.mainCamera.transform.position - var_4_13.position).z)
				var_4_13.localEulerAngles.z = 0
				var_4_13.localEulerAngles.x = 0
				var_4_13.localEulerAngles = var_4_13.localEulerAngles
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_21 + arg_4_0 then
				...
				local var_4_24 = arg_1_1:GetWordFromCfg(106051001)
				...
				local var_4_27 = 17 <= 0 and var_4_22 or var_4_22 * (utf8.len(var_4_25) / 17)

				if (17 <= 0 and var_4_22 or var_4_22 * (utf8.len(var_4_25) / 17)) > 0 and var_4_22 < var_4_27 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051001", "story_v_out_106051.awb") ~= 0 then
					local var_4_28 = manager.audio:GetVoiceLength("story_v_out_106051", "106051001", "story_v_out_106051.awb") / 1000
					...
					if var_4_24.prefab_name ~= "" and arg_1_1.actors_[var_4_24.prefab_name] ~= nil then
						local var_4_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_24.prefab_name].transform, "story_v_out_106051", "106051001", "story_v_out_106051.awb")

						arg_1_1:RecordAudio("106051001", var_4_29)
						arg_1_1:RecordAudio("106051001", var_4_29)
					else
	...
	Play106051002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if 0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_10 + arg_11_0 then
				...
				local var_11_12 = arg_8_1:GetWordFromCfg(106051002)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051002", "story_v_out_106051.awb") ~= 0 then
					local var_11_16 = manager.audio:GetVoiceLength("story_v_out_106051", "106051002", "story_v_out_106051.awb") / 1000
					...
					if var_11_12.prefab_name ~= "" and arg_8_1.actors_[var_11_12.prefab_name] ~= nil then
						local var_11_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_12.prefab_name].transform, "story_v_out_106051", "106051002", "story_v_out_106051.awb")

						arg_8_1:RecordAudio("106051002", var_11_17)
						arg_8_1:RecordAudio("106051002", var_11_17)
					else
	...
	Play106051003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if 0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_4 + arg_15_0 then
				...
				local var_15_6 = arg_12_1:GetWordFromCfg(106051003)
				...
				local var_15_9 = 16 <= 0 and var_15_5 or var_15_5 * (utf8.len(var_15_7) / 16)

				if (16 <= 0 and var_15_5 or var_15_5 * (utf8.len(var_15_7) / 16)) > 0 and var_15_5 < var_15_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051003", "story_v_out_106051.awb") ~= 0 then
					local var_15_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051003", "story_v_out_106051.awb") / 1000
					...
					if var_15_6.prefab_name ~= "" and arg_12_1.actors_[var_15_6.prefab_name] ~= nil then
						local var_15_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_12_1.actors_[var_15_6.prefab_name].transform, "story_v_out_106051", "106051003", "story_v_out_106051.awb")

						arg_12_1:RecordAudio("106051003", var_15_11)
						arg_12_1:RecordAudio("106051003", var_15_11)
					else
	...
	Play106051004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			local var_19_1 = arg_16_1.actors_["10004ui_story"]

			if 0 < arg_16_1.time_ and arg_16_1.time_ <= 0 + arg_19_0 and not isNil(var_19_1) and arg_16_1.var_.characterEffect10004ui_story == nil then
				arg_16_1.var_.characterEffect10004ui_story = var_19_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_19_2 = 0.1

			if 0 <= arg_16_1.time_ and arg_16_1.time_ < 0 + var_19_2 and not isNil(var_19_1) then
				if arg_16_1.var_.characterEffect10004ui_story and not isNil(var_19_1) then
					arg_16_1.var_.characterEffect10004ui_story.fillFlat = false
				end
			end

			if arg_16_1.time_ >= 0 + var_19_2 and arg_16_1.time_ < 0 + var_19_2 + arg_19_0 and not isNil(var_19_1) and arg_16_1.var_.characterEffect10004ui_story then
				arg_16_1.var_.characterEffect10004ui_story.fillFlat = false
			end
			...
			if 0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_4 + arg_19_0 then
				...
				arg_16_1.leftNameTxt_.text = arg_16_1:FormatText(StoryNameCfg[80].name)
				...
				local var_19_6 = arg_16_1:GetWordFromCfg(106051004)
				...
				local var_19_9 = 23 <= 0 and var_19_5 or var_19_5 * (utf8.len(var_19_7) / 23)

				if (23 <= 0 and var_19_5 or var_19_5 * (utf8.len(var_19_7) / 23)) > 0 and var_19_5 < var_19_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051004", "story_v_out_106051.awb") ~= 0 then
					local var_19_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051004", "story_v_out_106051.awb") / 1000
					...
					if var_19_6.prefab_name ~= "" and arg_16_1.actors_[var_19_6.prefab_name] ~= nil then
						local var_19_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_6.prefab_name].transform, "story_v_out_106051", "106051004", "story_v_out_106051.awb")

						arg_16_1:RecordAudio("106051004", var_19_11)
						arg_16_1:RecordAudio("106051004", var_19_11)
					else
	...
	Play106051005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			local var_23_2 = arg_20_1.actors_["10004ui_story"]

			if 0 < arg_20_1.time_ and arg_20_1.time_ <= 0 + arg_23_0 and not isNil(var_23_2) and arg_20_1.var_.characterEffect10004ui_story == nil then
				arg_20_1.var_.characterEffect10004ui_story = var_23_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_23_3 = 0.1

			if 0 <= arg_20_1.time_ and arg_20_1.time_ < 0 + var_23_3 and not isNil(var_23_2) then
				if arg_20_1.var_.characterEffect10004ui_story and not isNil(var_23_2) then
					arg_20_1.var_.characterEffect10004ui_story.fillFlat = true
					arg_20_1.var_.characterEffect10004ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_20_1.time_ - 0) / var_23_3)
				end
			end

			if arg_20_1.time_ >= 0 + var_23_3 and arg_20_1.time_ < 0 + var_23_3 + arg_23_0 and not isNil(var_23_2) and arg_20_1.var_.characterEffect10004ui_story then
				arg_20_1.var_.characterEffect10004ui_story.fillFlat = true
				arg_20_1.var_.characterEffect10004ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_4 + arg_23_0 then
				...
				local var_23_6 = arg_20_1:GetWordFromCfg(106051005)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051005", "story_v_out_106051.awb") ~= 0 then
					local var_23_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051005", "story_v_out_106051.awb") / 1000
					...
					if var_23_6.prefab_name ~= "" and arg_20_1.actors_[var_23_6.prefab_name] ~= nil then
						local var_23_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_20_1.actors_[var_23_6.prefab_name].transform, "story_v_out_106051", "106051005", "story_v_out_106051.awb")

						arg_20_1:RecordAudio("106051005", var_23_11)
						arg_20_1:RecordAudio("106051005", var_23_11)
					else
	...
	Play106051006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			local var_27_1 = arg_24_1.actors_["10004ui_story"]

			if 0 < arg_24_1.time_ and arg_24_1.time_ <= 0 + arg_27_0 and not isNil(var_27_1) and arg_24_1.var_.characterEffect10004ui_story == nil then
				arg_24_1.var_.characterEffect10004ui_story = var_27_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_27_2 = 0.1

			if 0 <= arg_24_1.time_ and arg_24_1.time_ < 0 + var_27_2 and not isNil(var_27_1) then
				if arg_24_1.var_.characterEffect10004ui_story and not isNil(var_27_1) then
					arg_24_1.var_.characterEffect10004ui_story.fillFlat = false
				end
			end

			if arg_24_1.time_ >= 0 + var_27_2 and arg_24_1.time_ < 0 + var_27_2 + arg_27_0 and not isNil(var_27_1) and arg_24_1.var_.characterEffect10004ui_story then
				arg_24_1.var_.characterEffect10004ui_story.fillFlat = false
			end
			...
			if 0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_4 + arg_27_0 then
				...
				local var_27_6 = arg_24_1:GetWordFromCfg(106051006)
				...
				local var_27_9 = 4 <= 0 and var_27_5 or var_27_5 * (utf8.len(var_27_7) / 4)

				if (4 <= 0 and var_27_5 or var_27_5 * (utf8.len(var_27_7) / 4)) > 0 and var_27_5 < var_27_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051006", "story_v_out_106051.awb") ~= 0 then
					local var_27_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051006", "story_v_out_106051.awb") / 1000
					...
					if var_27_6.prefab_name ~= "" and arg_24_1.actors_[var_27_6.prefab_name] ~= nil then
						local var_27_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_24_1.actors_[var_27_6.prefab_name].transform, "story_v_out_106051", "106051006", "story_v_out_106051.awb")

						arg_24_1:RecordAudio("106051006", var_27_11)
						arg_24_1:RecordAudio("106051006", var_27_11)
					else
	...
	Play106051007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			local var_31_2 = arg_28_1.actors_["10004ui_story"]

			if 0 < arg_28_1.time_ and arg_28_1.time_ <= 0 + arg_31_0 and not isNil(var_31_2) and arg_28_1.var_.characterEffect10004ui_story == nil then
				arg_28_1.var_.characterEffect10004ui_story = var_31_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_31_3 = 0.1

			if 0 <= arg_28_1.time_ and arg_28_1.time_ < 0 + var_31_3 and not isNil(var_31_2) then
				if arg_28_1.var_.characterEffect10004ui_story and not isNil(var_31_2) then
					arg_28_1.var_.characterEffect10004ui_story.fillFlat = true
					arg_28_1.var_.characterEffect10004ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_28_1.time_ - 0) / var_31_3)
				end
			end

			if arg_28_1.time_ >= 0 + var_31_3 and arg_28_1.time_ < 0 + var_31_3 + arg_31_0 and not isNil(var_31_2) and arg_28_1.var_.characterEffect10004ui_story then
				arg_28_1.var_.characterEffect10004ui_story.fillFlat = true
				arg_28_1.var_.characterEffect10004ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_4 + arg_31_0 then
				...
				local var_31_6 = arg_28_1:GetWordFromCfg(106051007)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051007", "story_v_out_106051.awb") ~= 0 then
					local var_31_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051007", "story_v_out_106051.awb") / 1000
					...
					if var_31_6.prefab_name ~= "" and arg_28_1.actors_[var_31_6.prefab_name] ~= nil then
						local var_31_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_6.prefab_name].transform, "story_v_out_106051", "106051007", "story_v_out_106051.awb")

						arg_28_1:RecordAudio("106051007", var_31_11)
						arg_28_1:RecordAudio("106051007", var_31_11)
					else
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if 0 <= arg_32_1.time_ and arg_32_1.time_ < 0 + var_35_0 and not isNil(arg_32_1.actors_["3004_tpose"]) then
				if arg_32_1.var_.characterEffect3004_tpose and not isNil(arg_32_1.actors_["3004_tpose"]) then
					...
					arg_32_1.var_.characterEffect3004_tpose.fillRatio = Mathf.Lerp(0, 0.5, (arg_32_1.time_ - 0) / var_35_0)
				end
			end
			...
			local var_35_1 = arg_32_1.actors_["10004ui_story"]

			if 0 < arg_32_1.time_ and arg_32_1.time_ <= 0 + arg_35_0 and not isNil(var_35_1) and arg_32_1.var_.characterEffect10004ui_story == nil then
				arg_32_1.var_.characterEffect10004ui_story = var_35_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_35_2 = 0.1

			if 0 <= arg_32_1.time_ and arg_32_1.time_ < 0 + var_35_2 and not isNil(var_35_1) then
				if arg_32_1.var_.characterEffect10004ui_story and not isNil(var_35_1) then
					arg_32_1.var_.characterEffect10004ui_story.fillFlat = false
				end
			end

			if arg_32_1.time_ >= 0 + var_35_2 and arg_32_1.time_ < 0 + var_35_2 + arg_35_0 and not isNil(var_35_1) and arg_32_1.var_.characterEffect10004ui_story then
				arg_32_1.var_.characterEffect10004ui_story.fillFlat = false
			end
			...
			if 0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_4 + arg_35_0 then
				...
				local var_35_6 = arg_32_1:GetWordFromCfg(106051008)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051008", "story_v_out_106051.awb") ~= 0 then
					local var_35_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051008", "story_v_out_106051.awb") / 1000
					...
					if var_35_6.prefab_name ~= "" and arg_32_1.actors_[var_35_6.prefab_name] ~= nil then
						local var_35_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_32_1.actors_[var_35_6.prefab_name].transform, "story_v_out_106051", "106051008", "story_v_out_106051.awb")

						arg_32_1:RecordAudio("106051008", var_35_11)
						arg_32_1:RecordAudio("106051008", var_35_11)
					else
	...
	Play106051009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if 0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_0 + arg_39_0 then
				...
				local var_39_2 = arg_36_1:GetWordFromCfg(106051009)
				...
				local var_39_5 = 38 <= 0 and var_39_1 or var_39_1 * (utf8.len(var_39_3) / 38)

				if (38 <= 0 and var_39_1 or var_39_1 * (utf8.len(var_39_3) / 38)) > 0 and var_39_1 < var_39_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051009", "story_v_out_106051.awb") ~= 0 then
					local var_39_6 = manager.audio:GetVoiceLength("story_v_out_106051", "106051009", "story_v_out_106051.awb") / 1000
					...
					if var_39_2.prefab_name ~= "" and arg_36_1.actors_[var_39_2.prefab_name] ~= nil then
						local var_39_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_36_1.actors_[var_39_2.prefab_name].transform, "story_v_out_106051", "106051009", "story_v_out_106051.awb")

						arg_36_1:RecordAudio("106051009", var_39_7)
						arg_36_1:RecordAudio("106051009", var_39_7)
					else
	...
	Play106051010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			local var_43_2 = arg_40_1.actors_["10004ui_story"]

			if 0 < arg_40_1.time_ and arg_40_1.time_ <= 0 + arg_43_0 and not isNil(var_43_2) and arg_40_1.var_.characterEffect10004ui_story == nil then
				arg_40_1.var_.characterEffect10004ui_story = var_43_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_43_3 = 0.1

			if 0 <= arg_40_1.time_ and arg_40_1.time_ < 0 + var_43_3 and not isNil(var_43_2) then
				if arg_40_1.var_.characterEffect10004ui_story and not isNil(var_43_2) then
					arg_40_1.var_.characterEffect10004ui_story.fillFlat = true
					arg_40_1.var_.characterEffect10004ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_40_1.time_ - 0) / var_43_3)
				end
			end

			if arg_40_1.time_ >= 0 + var_43_3 and arg_40_1.time_ < 0 + var_43_3 + arg_43_0 and not isNil(var_43_2) and arg_40_1.var_.characterEffect10004ui_story then
				arg_40_1.var_.characterEffect10004ui_story.fillFlat = true
				arg_40_1.var_.characterEffect10004ui_story.fillRatio = 0.5
			end

			local var_43_4 = 0
			local var_43_5 = 0.325
			...
			if 0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_4 + arg_43_0 then
				...
				local var_43_6 = arg_40_1:GetWordFromCfg(106051010)
				...
				local var_43_9 = 13 <= 0 and var_43_5 or var_43_5 * (utf8.len(var_43_7) / 13)

				if (13 <= 0 and var_43_5 or var_43_5 * (utf8.len(var_43_7) / 13)) > 0 and var_43_5 < var_43_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051010", "story_v_out_106051.awb") ~= 0 then
					local var_43_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051010", "story_v_out_106051.awb") / 1000
					...
					if var_43_6.prefab_name ~= "" and arg_40_1.actors_[var_43_6.prefab_name] ~= nil then
						local var_43_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_6.prefab_name].transform, "story_v_out_106051", "106051010", "story_v_out_106051.awb")

						arg_40_1:RecordAudio("106051010", var_43_11)
						arg_40_1:RecordAudio("106051010", var_43_11)
					else
	...
	Play106051011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if 0 < arg_44_1.time_ and arg_44_1.time_ <= var_47_4 + arg_47_0 then
				...
				local var_47_6 = arg_44_1:GetWordFromCfg(106051011)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051011", "story_v_out_106051.awb") ~= 0 then
					local var_47_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051011", "story_v_out_106051.awb") / 1000
					...
					if var_47_6.prefab_name ~= "" and arg_44_1.actors_[var_47_6.prefab_name] ~= nil then
						local var_47_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_44_1.actors_[var_47_6.prefab_name].transform, "story_v_out_106051", "106051011", "story_v_out_106051.awb")

						arg_44_1:RecordAudio("106051011", var_47_11)
						arg_44_1:RecordAudio("106051011", var_47_11)
					else
	...
	Play106051012 = function(arg_48_0, arg_48_1)
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if 0 < arg_48_1.time_ and arg_48_1.time_ <= var_51_0 + arg_51_0 then
				...
				local var_51_2 = arg_48_1:GetWordFromCfg(106051012)
				...
				local var_51_5 = 51 <= 0 and var_51_1 or var_51_1 * (utf8.len(var_51_3) / 51)

				if (51 <= 0 and var_51_1 or var_51_1 * (utf8.len(var_51_3) / 51)) > 0 and var_51_1 < var_51_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051012", "story_v_out_106051.awb") ~= 0 then
					local var_51_6 = manager.audio:GetVoiceLength("story_v_out_106051", "106051012", "story_v_out_106051.awb") / 1000
					...
					if var_51_2.prefab_name ~= "" and arg_48_1.actors_[var_51_2.prefab_name] ~= nil then
						local var_51_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_48_1.actors_[var_51_2.prefab_name].transform, "story_v_out_106051", "106051012", "story_v_out_106051.awb")

						arg_48_1:RecordAudio("106051012", var_51_7)
						arg_48_1:RecordAudio("106051012", var_51_7)
					else
	...
	Play106051013 = function(arg_52_0, arg_52_1)
		...
		function arg_52_1.onSingleLineUpdate_(arg_55_0)
			...
			if 0 < arg_52_1.time_ and arg_52_1.time_ <= var_55_0 + arg_55_0 then
				...
				local var_55_2 = arg_52_1:GetWordFromCfg(106051013)
				...
				local var_55_5 = 18 <= 0 and var_55_1 or var_55_1 * (utf8.len(var_55_3) / 18)

				if (18 <= 0 and var_55_1 or var_55_1 * (utf8.len(var_55_3) / 18)) > 0 and var_55_1 < var_55_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051013", "story_v_out_106051.awb") ~= 0 then
					local var_55_6 = manager.audio:GetVoiceLength("story_v_out_106051", "106051013", "story_v_out_106051.awb") / 1000
					...
					if var_55_2.prefab_name ~= "" and arg_52_1.actors_[var_55_2.prefab_name] ~= nil then
						local var_55_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_52_1.actors_[var_55_2.prefab_name].transform, "story_v_out_106051", "106051013", "story_v_out_106051.awb")

						arg_52_1:RecordAudio("106051013", var_55_7)
						arg_52_1:RecordAudio("106051013", var_55_7)
					else
	...
	Play106051014 = function(arg_56_0, arg_56_1)
		...
		function arg_56_1.onSingleLineUpdate_(arg_59_0)
			...
			local var_59_2 = arg_56_1.actors_["10004ui_story"]

			if 0 < arg_56_1.time_ and arg_56_1.time_ <= 0 + arg_59_0 and not isNil(var_59_2) and arg_56_1.var_.characterEffect10004ui_story == nil then
				arg_56_1.var_.characterEffect10004ui_story = var_59_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_59_3 = 0.1

			if 0 <= arg_56_1.time_ and arg_56_1.time_ < 0 + var_59_3 and not isNil(var_59_2) then
				if arg_56_1.var_.characterEffect10004ui_story and not isNil(var_59_2) then
					arg_56_1.var_.characterEffect10004ui_story.fillFlat = true
					arg_56_1.var_.characterEffect10004ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_56_1.time_ - 0) / var_59_3)
				end
			end

			if arg_56_1.time_ >= 0 + var_59_3 and arg_56_1.time_ < 0 + var_59_3 + arg_59_0 and not isNil(var_59_2) and arg_56_1.var_.characterEffect10004ui_story then
				arg_56_1.var_.characterEffect10004ui_story.fillFlat = true
				arg_56_1.var_.characterEffect10004ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_56_1.time_ and arg_56_1.time_ <= var_59_4 + arg_59_0 then
				...
				local var_59_6 = arg_56_1:GetWordFromCfg(106051014)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051014", "story_v_out_106051.awb") ~= 0 then
					local var_59_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051014", "story_v_out_106051.awb") / 1000
					...
					if var_59_6.prefab_name ~= "" and arg_56_1.actors_[var_59_6.prefab_name] ~= nil then
						local var_59_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_56_1.actors_[var_59_6.prefab_name].transform, "story_v_out_106051", "106051014", "story_v_out_106051.awb")

						arg_56_1:RecordAudio("106051014", var_59_11)
						arg_56_1:RecordAudio("106051014", var_59_11)
					else
		...
		function arg_60_1.onSingleLineUpdate_(arg_63_0)
			...
			if 0 <= arg_60_1.time_ and arg_60_1.time_ < 0 + var_63_0 and not isNil(arg_60_1.actors_["3004_tpose"]) then
				if arg_60_1.var_.characterEffect3004_tpose and not isNil(arg_60_1.actors_["3004_tpose"]) then
					...
					arg_60_1.var_.characterEffect3004_tpose.fillRatio = Mathf.Lerp(0, 0.5, (arg_60_1.time_ - 0) / var_63_0)
				end
			end
			...
			if arg_60_1.time_ >= 0 + var_63_0 and arg_60_1.time_ < 0 + var_63_0 + arg_63_0 and not isNil(arg_60_1.actors_["3004_tpose"]) and arg_60_1.var_.characterEffect3004_tpose then
				arg_60_1.var_.characterEffect3004_tpose.fillFlat = true
				arg_60_1.var_.characterEffect3004_tpose.fillRatio = 0.5
			end
			...
			if 0 < arg_60_1.time_ and arg_60_1.time_ <= var_63_4 + arg_63_0 then
				...
				local var_63_6 = arg_60_1:GetWordFromCfg(106051015)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051015", "story_v_out_106051.awb") ~= 0 then
					local var_63_10 = manager.audio:GetVoiceLength("story_v_out_106051", "106051015", "story_v_out_106051.awb") / 1000
					...
					if var_63_6.prefab_name ~= "" and arg_60_1.actors_[var_63_6.prefab_name] ~= nil then
						local var_63_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_60_1.actors_[var_63_6.prefab_name].transform, "story_v_out_106051", "106051015", "story_v_out_106051.awb")

						arg_60_1:RecordAudio("106051015", var_63_11)
						arg_60_1:RecordAudio("106051015", var_63_11)
					else
	...
	Play106051016 = function(arg_64_0, arg_64_1)
		...
		function arg_64_1.onSingleLineUpdate_(arg_67_0)
			...
			if 0 < arg_64_1.time_ and arg_64_1.time_ <= var_67_0 + arg_67_0 then
				...
				local var_67_2 = arg_64_1:GetWordFromCfg(106051016)
				...
				local var_67_5 = 21 <= 0 and var_67_1 or var_67_1 * (utf8.len(var_67_3) / 21)

				if (21 <= 0 and var_67_1 or var_67_1 * (utf8.len(var_67_3) / 21)) > 0 and var_67_1 < var_67_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051016", "story_v_out_106051.awb") ~= 0 then
					local var_67_6 = manager.audio:GetVoiceLength("story_v_out_106051", "106051016", "story_v_out_106051.awb") / 1000
					...
					if var_67_2.prefab_name ~= "" and arg_64_1.actors_[var_67_2.prefab_name] ~= nil then
						local var_67_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_64_1.actors_[var_67_2.prefab_name].transform, "story_v_out_106051", "106051016", "story_v_out_106051.awb")

						arg_64_1:RecordAudio("106051016", var_67_7)
						arg_64_1:RecordAudio("106051016", var_67_7)
					else
	...
	Play106051017 = function(arg_68_0, arg_68_1)
		...
		function arg_68_1.onSingleLineUpdate_(arg_71_0)
			...
			if 0 < arg_68_1.time_ and arg_68_1.time_ <= var_71_0 + arg_71_0 then
				...
				local var_71_2 = arg_68_1:GetWordFromCfg(106051017)
				...
				local var_71_5 = 10 <= 0 and var_71_1 or var_71_1 * (utf8.len(var_71_3) / 10)

				if (10 <= 0 and var_71_1 or var_71_1 * (utf8.len(var_71_3) / 10)) > 0 and var_71_1 < var_71_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051017", "story_v_out_106051.awb") ~= 0 then
					local var_71_6 = manager.audio:GetVoiceLength("story_v_out_106051", "106051017", "story_v_out_106051.awb") / 1000
					...
					if var_71_2.prefab_name ~= "" and arg_68_1.actors_[var_71_2.prefab_name] ~= nil then
						local var_71_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_68_1.actors_[var_71_2.prefab_name].transform, "story_v_out_106051", "106051017", "story_v_out_106051.awb")

						arg_68_1:RecordAudio("106051017", var_71_7)
						arg_68_1:RecordAudio("106051017", var_71_7)
					else
