	...
	Play416191035 = function(arg_146_0, arg_146_1)
		...
		function arg_146_1.onSingleLineUpdate_(arg_149_0)
			if 0 < arg_146_1.time_ and arg_146_1.time_ <= 0 + arg_149_0 then
				...
				for iter_149_0, iter_149_1 in ipairs((var_149_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_149_1.transform.localScale = Vector3.New(iter_149_1.transform.localScale.x / var_149_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_149_1.transform.localScale.y / var_149_2, iter_149_1.transform.localScale.z)
				end
			end

			local var_149_4 = arg_146_1.bgs_.SS1608.transform

			if 0 < arg_146_1.time_ and arg_146_1.time_ <= 0 + arg_149_0 then
				arg_146_1.var_.moveOldPosSS1608 = var_149_4.localPosition
			end

			local var_149_5 = 0.001

			if 0 <= arg_146_1.time_ and arg_146_1.time_ < 0 + var_149_5 then
				var_149_4.localPosition = Vector3.Lerp(arg_146_1.var_.moveOldPosSS1608, Vector3.New(0, 1, 10), (arg_146_1.time_ - 0) / var_149_5)
			end

			if arg_146_1.time_ >= 0 + var_149_5 and arg_146_1.time_ < 0 + var_149_5 + arg_149_0 then
				var_149_4.localPosition = Vector3.New(0, 1, 10)
			end

			local var_149_6 = arg_146_1.bgs_.SS1608.transform

			if 0.034 < arg_146_1.time_ and arg_146_1.time_ <= 0.034 + arg_149_0 then
				arg_146_1.var_.moveOldPosSS1608 = var_149_6.localPosition
			end

			local var_149_7 = 1.83266666666667

			if 0.034 <= arg_146_1.time_ and arg_146_1.time_ < 0.034 + var_149_7 then
				var_149_6.localPosition = Vector3.Lerp(arg_146_1.var_.moveOldPosSS1608, Vector3.New(0, 1, 9), (arg_146_1.time_ - 0.034) / var_149_7)
			end

			if arg_146_1.time_ >= 0.034 + var_149_7 and arg_146_1.time_ < 0.034 + var_149_7 + arg_149_0 then
				var_149_6.localPosition = Vector3.New(0, 1, 9)
			end
			...
			if 1.2 < arg_146_1.time_ and arg_146_1.time_ <= var_149_8 + arg_149_0 then
				...
				local var_149_11 = arg_146_1:FormatText(arg_146_1:GetWordFromCfg(416191035).content)

				arg_146_1.text_.text = var_149_11

				LuaForUtil.ClearLinePrefixSymbol(arg_146_1.text_)

				local var_149_13 = 57 <= 0 and var_149_9 or var_149_9 * (utf8.len(var_149_11) / 57)

				if (57 <= 0 and var_149_9 or var_149_9 * (utf8.len(var_149_11) / 57)) > 0 and var_149_9 < var_149_13 then
			...
			local var_149_14 = var_149_8 + 0.3
			local var_149_15 = math.max(var_149_9, arg_146_1.talkMaxDuration)

			if var_149_8 + 0.3 <= arg_146_1.time_ and arg_146_1.time_ < var_149_14 + var_149_15 then
				arg_146_1.typewritter.percent = (arg_146_1.time_ - var_149_14) / var_149_15
	...
	Play416191059 = function(arg_250_0, arg_250_1)
		...
		function arg_250_1.onSingleLineUpdate_(arg_253_0)
			...
			if 0.166666666666667 < arg_250_1.time_ and arg_250_1.time_ <= 0.166666666666667 + arg_253_0 then
				...
				for iter_253_1, iter_253_2 in ipairs((var_253_2.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_253_2.transform.localScale = Vector3.New(iter_253_2.transform.localScale.x / var_253_4 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_253_2.transform.localScale.y / var_253_4, iter_253_2.transform.localScale.z)
				end
			end
			...
			if arg_250_1.time_ >= var_253_7 + 1.76666666666667 and arg_250_1.time_ < var_253_7 + 1.76666666666667 + arg_253_0 then
				arg_250_1.allBtn_.enabled = true
			end

			if 0 < arg_250_1.time_ and arg_250_1.time_ <= 0 + arg_253_0 then
				local var_253_8 = arg_250_1.actors_["1028"]:GetComponentInChildren(typeof(CanvasGroup))

				if var_253_8 then
					arg_250_1.var_.alphaOldValue1028 = var_253_8.alpha
					arg_250_1.var_.characterEffect1028 = var_253_8
				end

				arg_250_1.var_.alphaOldValue1028 = 1
			end

			local var_253_9 = 0.433333333333333

			if 0 <= arg_250_1.time_ and arg_250_1.time_ < 0 + var_253_9 then
				if arg_250_1.var_.characterEffect1028 then
					arg_250_1.var_.characterEffect1028.alpha = Mathf.Lerp(arg_250_1.var_.alphaOldValue1028, 0, (arg_250_1.time_ - 0) / var_253_9)
				end
			end

			if arg_250_1.time_ >= 0 + var_253_9 and arg_250_1.time_ < 0 + var_253_9 + arg_253_0 and arg_250_1.var_.characterEffect1028 then
			...
			if 0.309470200352371 < arg_250_1.time_ and arg_250_1.time_ <= 0.309470200352371 + arg_253_0 then
				local var_253_10 = arg_250_1.var_.effect244

				if not arg_250_1.var_.effect244 then
					var_253_10 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Lightning_in"), manager.ui.mainCamera.transform)
					var_253_10.name = "244"
					arg_250_1.var_.effect244 = var_253_10
				else
					var_253_10.transform:SetParent(var_253_9000)
				end

				var_253_10.transform.localPosition = Vector3.New(0, 0, 0)
				var_253_10.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_253_12 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_253_3, iter_253_4 in ipairs((var_253_10.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_253_4.transform.localScale = Vector3.New(iter_253_4.transform.localScale.x / var_253_12 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_253_4.transform.localScale.y / var_253_12, iter_253_4.transform.localScale.z)
				end
			end
			...
			local var_253_16 = 1.0571964663143
			local var_253_17 = 1.375

			if 1.0571964663143 < arg_250_1.time_ and arg_250_1.time_ <= var_253_16 + arg_253_0 then
				...
				local var_253_18 = LeanTween.value(arg_250_1.dialog_, 0, 1, 0.3)

				var_253_18:setOnUpdate(LuaHelper.FloatAction(function(arg_254_0)
					arg_250_1.dialogCg_.alpha = arg_254_0
				end))
				var_253_18:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_250_1.dialog_)
					var_253_18:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_253_19 = arg_250_1:FormatText(arg_250_1:GetWordFromCfg(416191059).content)

				arg_250_1.text_.text = var_253_19

				LuaForUtil.ClearLinePrefixSymbol(arg_250_1.text_)

				local var_253_21 = 55 <= 0 and var_253_17 or var_253_17 * (utf8.len(var_253_19) / 55)

				if (55 <= 0 and var_253_17 or var_253_17 * (utf8.len(var_253_19) / 55)) > 0 and var_253_17 < var_253_21 then
					arg_250_1.talkMaxDuration = var_253_21
					var_253_16 = var_253_16 + 0.3

					if var_253_21 + var_253_16 > arg_250_1.duration_ then
						arg_250_1.duration_ = var_253_21 + var_253_16
					end
				end
			...
			local var_253_22 = var_253_16 + 0.3
			local var_253_23 = math.max(var_253_17, arg_250_1.talkMaxDuration)

			if var_253_16 + 0.3 <= arg_250_1.time_ and arg_250_1.time_ < var_253_22 + var_253_23 then
				arg_250_1.typewritter.percent = (arg_250_1.time_ - var_253_22) / var_253_23
	...
	Play416191067 = function(arg_284_0, arg_284_1)
		...
		function arg_284_1.onSingleLineUpdate_(arg_287_0)
			...
			if 0.366666666666667 < arg_284_1.time_ and arg_284_1.time_ <= 0.366666666666667 + arg_287_0 then
				...
				for iter_287_5, iter_287_6 in ipairs((var_287_14.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_287_6.transform.localScale = Vector3.New(iter_287_6.transform.localScale.x / var_287_16 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_287_6.transform.localScale.y / var_287_16, iter_287_6.transform.localScale.z)
				end
			end
			...
			local var_287_19 = 0.8
			local var_287_20 = 1.35

			if 0.8 < arg_284_1.time_ and arg_284_1.time_ <= var_287_19 + arg_287_0 then
				...
				local var_287_21 = LeanTween.value(arg_284_1.dialog_, 0, 1, 0.3)

				var_287_21:setOnUpdate(LuaHelper.FloatAction(function(arg_288_0)
					arg_284_1.dialogCg_.alpha = arg_288_0
				end))
				var_287_21:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_284_1.dialog_)
					var_287_21:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_287_22 = arg_284_1:FormatText(arg_284_1:GetWordFromCfg(416191067).content)

				arg_284_1.text_.text = var_287_22

				LuaForUtil.ClearLinePrefixSymbol(arg_284_1.text_)

				local var_287_24 = 54 <= 0 and var_287_20 or var_287_20 * (utf8.len(var_287_22) / 54)

				if (54 <= 0 and var_287_20 or var_287_20 * (utf8.len(var_287_22) / 54)) > 0 and var_287_20 < var_287_24 then
					arg_284_1.talkMaxDuration = var_287_24
					var_287_19 = var_287_19 + 0.3

					if var_287_24 + var_287_19 > arg_284_1.duration_ then
						arg_284_1.duration_ = var_287_24 + var_287_19
					end
				end
			...
			local var_287_25 = var_287_19 + 0.3
			local var_287_26 = math.max(var_287_20, arg_284_1.talkMaxDuration)

			if var_287_19 + 0.3 <= arg_284_1.time_ and arg_284_1.time_ < var_287_25 + var_287_26 then
				arg_284_1.typewritter.percent = (arg_284_1.time_ - var_287_25) / var_287_26

				arg_284_1.typewritter:SetDirty()
			end

			if arg_284_1.time_ >= var_287_25 + var_287_26 and arg_284_1.time_ < var_287_25 + var_287_26 + arg_287_0 then
