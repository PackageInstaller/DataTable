return {
	Play322211001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				local var_4_2 = arg_1_1.bgs_.L09f
			...
			if 0.466666666666667 < arg_1_1.time_ and arg_1_1.time_ <= 0.466666666666667 + arg_4_0 then
				...
				local var_4_24 = manager.audio:GetAudioName("bgm_activity_4_5_story_source", "bgm_activity_4_5_story_source")
			...
			if 0.47 < arg_1_1.time_ and arg_1_1.time_ <= 0.47 + arg_4_0 then
				arg_1_1:AudioAction("play", "music", "bgm_activity_4_5_story_source", "init_story", "bgm_activity_4_5_story_source.awb")

				local var_4_27 = manager.audio:GetAudioName("bgm_activity_4_5_story_source", "init_story")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_28 + arg_4_0 then
				...
				local var_4_31 = arg_1_1:GetWordFromCfg(322211001)
				...
				local var_4_34 = 8 <= 0 and var_4_29 or var_4_29 * (utf8.len(var_4_32) / 8)

				if (8 <= 0 and var_4_29 or var_4_29 * (utf8.len(var_4_32) / 8)) > 0 and var_4_29 < var_4_34 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211001", "story_v_out_322211.awb") ~= 0 then
					local var_4_35 = manager.audio:GetVoiceLength("story_v_out_322211", "322211001", "story_v_out_322211.awb") / 1000
					...
					if var_4_31.prefab_name ~= "" and arg_1_1.actors_[var_4_31.prefab_name] ~= nil then
						local var_4_36 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_31.prefab_name].transform, "story_v_out_322211", "322211001", "story_v_out_322211.awb")

						arg_1_1:RecordAudio("322211001", var_4_36)
						arg_1_1:RecordAudio("322211001", var_4_36)
					else
	...
	Play322211002 = function(arg_10_0, arg_10_1)
		...
		function arg_10_1.onSingleLineUpdate_(arg_13_0)
			...
			if 0 < arg_10_1.time_ and arg_10_1.time_ <= var_13_1 + arg_13_0 then
				...
				local var_13_3 = arg_10_1:FormatText(arg_10_1:GetWordFromCfg(322211002).content)

				arg_10_1.text_.text = var_13_3

				LuaForUtil.ClearLinePrefixSymbol(arg_10_1.text_)

				local var_13_5 = 49 <= 0 and var_13_2 or var_13_2 * (utf8.len(var_13_3) / 49)

				if (49 <= 0 and var_13_2 or var_13_2 * (utf8.len(var_13_3) / 49)) > 0 and var_13_2 < var_13_5 then
	...
	Play322211003 = function(arg_14_0, arg_14_1)
		...
		function arg_14_1.onSingleLineUpdate_(arg_17_0)
			if 0 < arg_14_1.time_ and arg_14_1.time_ <= 0 + arg_17_0 then
				arg_14_1.var_.moveOldPos1111ui_story = arg_14_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_17_0 = 0.001

			if 0 <= arg_14_1.time_ and arg_14_1.time_ < 0 + var_17_0 then
				arg_14_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_14_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_14_1.time_ - 0) / var_17_0)
				arg_14_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_14_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_14_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_14_1.actors_["1111ui_story"].transform.position).z)
				arg_14_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_14_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_14_1.actors_["1111ui_story"].transform.localEulerAngles = arg_14_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_14_1.time_ >= 0 + var_17_0 and arg_14_1.time_ < 0 + var_17_0 + arg_17_0 then
				arg_14_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, -0.87, -5.7)
				arg_14_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_14_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_14_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_14_1.actors_["1111ui_story"].transform.position).z)
				arg_14_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_14_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_14_1.actors_["1111ui_story"].transform.localEulerAngles = arg_14_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_17_1 = arg_14_1.actors_["1111ui_story"]

			if 0 < arg_14_1.time_ and arg_14_1.time_ <= 0 + arg_17_0 and not isNil(var_17_1) and arg_14_1.var_.characterEffect1111ui_story == nil then
				arg_14_1.var_.characterEffect1111ui_story = var_17_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_17_2 = 0.200000002980232

			if 0 <= arg_14_1.time_ and arg_14_1.time_ < 0 + var_17_2 and not isNil(var_17_1) then
				if arg_14_1.var_.characterEffect1111ui_story and not isNil(var_17_1) then
					arg_14_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_14_1.time_ >= 0 + var_17_2 and arg_14_1.time_ < 0 + var_17_2 + arg_17_0 and not isNil(var_17_1) and arg_14_1.var_.characterEffect1111ui_story then
				arg_14_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if 0 < arg_14_1.time_ and arg_14_1.time_ <= var_17_4 + arg_17_0 then
				...
				arg_14_1.leftNameTxt_.text = arg_14_1:FormatText(StoryNameCfg[67].name)
				...
				local var_17_6 = arg_14_1:GetWordFromCfg(322211003)
				...
				local var_17_9 = 21 <= 0 and var_17_5 or var_17_5 * (utf8.len(var_17_7) / 21)

				if (21 <= 0 and var_17_5 or var_17_5 * (utf8.len(var_17_7) / 21)) > 0 and var_17_5 < var_17_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211003", "story_v_out_322211.awb") ~= 0 then
					local var_17_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211003", "story_v_out_322211.awb") / 1000
					...
					if var_17_6.prefab_name ~= "" and arg_14_1.actors_[var_17_6.prefab_name] ~= nil then
						local var_17_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_14_1.actors_[var_17_6.prefab_name].transform, "story_v_out_322211", "322211003", "story_v_out_322211.awb")

						arg_14_1:RecordAudio("322211003", var_17_11)
						arg_14_1:RecordAudio("322211003", var_17_11)
					else
	...
	Play322211004 = function(arg_18_0, arg_18_1)
		...
		function arg_18_1.onSingleLineUpdate_(arg_21_0)
			if arg_18_1.actors_["10131ui_story"] == nil and not isNil((Asset.Load("Char/" .. "10131ui_story"))) then
				local var_21_0 = Object.Instantiate(Asset.Load("Char/" .. "10131ui_story"), arg_18_1.stage_.transform)

				var_21_0.name = "10131ui_story"
				var_21_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_18_1.actors_["10131ui_story"] = var_21_0
				...
				arg_18_1.var_["10131ui_story" .. "Animator"] = var_21_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_18_1.var_["10131ui_story" .. "Animator"].applyRootMotion = true
				arg_18_1.var_["10131ui_story" .. "LipSync"] = var_21_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_21_3 = arg_18_1.actors_["10131ui_story"].transform

			if 0 < arg_18_1.time_ and arg_18_1.time_ <= 0 + arg_21_0 then
				arg_18_1.var_.moveOldPos10131ui_story = var_21_3.localPosition
			end

			local var_21_4 = 0.001

			if 0 <= arg_18_1.time_ and arg_18_1.time_ < 0 + var_21_4 then
				var_21_3.localPosition = Vector3.Lerp(arg_18_1.var_.moveOldPos10131ui_story, Vector3.New(0.83, -0.96, -5.8), (arg_18_1.time_ - 0) / var_21_4)
			...
			if arg_18_1.time_ >= 0 + var_21_4 and arg_18_1.time_ < 0 + var_21_4 + arg_21_0 then
				var_21_3.localPosition = Vector3.New(0.83, -0.96, -5.8)
				var_21_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_21_3.position).x, (manager.ui.mainCamera.transform.position - var_21_3.position).y, (manager.ui.mainCamera.transform.position - var_21_3.position).z)
				var_21_3.localEulerAngles.z = 0
				var_21_3.localEulerAngles.x = 0
				var_21_3.localEulerAngles = var_21_3.localEulerAngles
			...
			if 0 <= arg_18_1.time_ and arg_18_1.time_ < 0 + var_21_6 then
				var_21_5.localPosition = Vector3.Lerp(arg_18_1.var_.moveOldPos1111ui_story, Vector3.New(-0.79, -0.87, -5.7), (arg_18_1.time_ - 0) / var_21_6)
				var_21_5.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_21_5.position).x, (manager.ui.mainCamera.transform.position - var_21_5.position).y, (manager.ui.mainCamera.transform.position - var_21_5.position).z)
				var_21_5.localEulerAngles.z = 0
				var_21_5.localEulerAngles.x = 0
				var_21_5.localEulerAngles = var_21_5.localEulerAngles
			end

			if arg_18_1.time_ >= 0 + var_21_6 and arg_18_1.time_ < 0 + var_21_6 + arg_21_0 then
				var_21_5.localPosition = Vector3.New(-0.79, -0.87, -5.7)
				var_21_5.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_21_5.position).x, (manager.ui.mainCamera.transform.position - var_21_5.position).y, (manager.ui.mainCamera.transform.position - var_21_5.position).z)
				var_21_5.localEulerAngles.z = 0
				var_21_5.localEulerAngles.x = 0
				var_21_5.localEulerAngles = var_21_5.localEulerAngles
			...
			local var_21_7 = arg_18_1.actors_["10131ui_story"]

			if 0 < arg_18_1.time_ and arg_18_1.time_ <= 0 + arg_21_0 and not isNil(var_21_7) and arg_18_1.var_.characterEffect10131ui_story == nil then
				arg_18_1.var_.characterEffect10131ui_story = var_21_7:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_21_8 = 0.200000002980232

			if 0 <= arg_18_1.time_ and arg_18_1.time_ < 0 + var_21_8 and not isNil(var_21_7) then
				if arg_18_1.var_.characterEffect10131ui_story and not isNil(var_21_7) then
					arg_18_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_18_1.time_ >= 0 + var_21_8 and arg_18_1.time_ < 0 + var_21_8 + arg_21_0 and not isNil(var_21_7) and arg_18_1.var_.characterEffect10131ui_story then
				arg_18_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_21_10 = arg_18_1.actors_["1111ui_story"]

			if 0 < arg_18_1.time_ and arg_18_1.time_ <= 0 + arg_21_0 and not isNil(var_21_10) and arg_18_1.var_.characterEffect1111ui_story == nil then
				arg_18_1.var_.characterEffect1111ui_story = var_21_10:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_21_11 = 0.200000002980232

			if 0 <= arg_18_1.time_ and arg_18_1.time_ < 0 + var_21_11 and not isNil(var_21_10) then
				if arg_18_1.var_.characterEffect1111ui_story and not isNil(var_21_10) then
					arg_18_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_18_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_18_1.time_ - 0) / var_21_11)
				end
			end

			if arg_18_1.time_ >= 0 + var_21_11 and arg_18_1.time_ < 0 + var_21_11 + arg_21_0 and not isNil(var_21_10) and arg_18_1.var_.characterEffect1111ui_story then
				arg_18_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_18_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_18_1.time_ and arg_18_1.time_ <= var_21_12 + arg_21_0 then
				...
				arg_18_1.leftNameTxt_.text = arg_18_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_21_14 = arg_18_1:GetWordFromCfg(322211004)
				...
				local var_21_17 = 8 <= 0 and var_21_13 or var_21_13 * (utf8.len(var_21_15) / 8)

				if (8 <= 0 and var_21_13 or var_21_13 * (utf8.len(var_21_15) / 8)) > 0 and var_21_13 < var_21_17 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211004", "story_v_out_322211.awb") ~= 0 then
					local var_21_18 = manager.audio:GetVoiceLength("story_v_out_322211", "322211004", "story_v_out_322211.awb") / 1000
					...
					if var_21_14.prefab_name ~= "" and arg_18_1.actors_[var_21_14.prefab_name] ~= nil then
						local var_21_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_18_1.actors_[var_21_14.prefab_name].transform, "story_v_out_322211", "322211004", "story_v_out_322211.awb")

						arg_18_1:RecordAudio("322211004", var_21_19)
						arg_18_1:RecordAudio("322211004", var_21_19)
					else
	...
	Play322211005 = function(arg_22_0, arg_22_1)
		...
		function arg_22_1.onSingleLineUpdate_(arg_25_0)
			if 0 < arg_22_1.time_ and arg_22_1.time_ <= 0 + arg_25_0 and not isNil(arg_22_1.actors_["1111ui_story"]) and arg_22_1.var_.characterEffect1111ui_story == nil then
				arg_22_1.var_.characterEffect1111ui_story = arg_22_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_25_0 = 0.200000002980232

			if 0 <= arg_22_1.time_ and arg_22_1.time_ < 0 + var_25_0 and not isNil(arg_22_1.actors_["1111ui_story"]) then
				if arg_22_1.var_.characterEffect1111ui_story and not isNil(arg_22_1.actors_["1111ui_story"]) then
					arg_22_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_22_1.time_ >= 0 + var_25_0 and arg_22_1.time_ < 0 + var_25_0 + arg_25_0 and not isNil(arg_22_1.actors_["1111ui_story"]) and arg_22_1.var_.characterEffect1111ui_story then
				arg_22_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_25_2 = arg_22_1.actors_["10131ui_story"]

			if 0 < arg_22_1.time_ and arg_22_1.time_ <= 0 + arg_25_0 and not isNil(var_25_2) and arg_22_1.var_.characterEffect10131ui_story == nil then
				arg_22_1.var_.characterEffect10131ui_story = var_25_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_25_3 = 0.200000002980232

			if 0 <= arg_22_1.time_ and arg_22_1.time_ < 0 + var_25_3 and not isNil(var_25_2) then
				if arg_22_1.var_.characterEffect10131ui_story and not isNil(var_25_2) then
					arg_22_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_22_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_22_1.time_ - 0) / var_25_3)
				end
			end

			if arg_22_1.time_ >= 0 + var_25_3 and arg_22_1.time_ < 0 + var_25_3 + arg_25_0 and not isNil(var_25_2) and arg_22_1.var_.characterEffect10131ui_story then
				arg_22_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_22_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_22_1.time_ and arg_22_1.time_ <= var_25_4 + arg_25_0 then
				...
				local var_25_6 = arg_22_1:GetWordFromCfg(322211005)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211005", "story_v_out_322211.awb") ~= 0 then
					local var_25_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211005", "story_v_out_322211.awb") / 1000
					...
					if var_25_6.prefab_name ~= "" and arg_22_1.actors_[var_25_6.prefab_name] ~= nil then
						local var_25_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_22_1.actors_[var_25_6.prefab_name].transform, "story_v_out_322211", "322211005", "story_v_out_322211.awb")

						arg_22_1:RecordAudio("322211005", var_25_11)
						arg_22_1:RecordAudio("322211005", var_25_11)
					else
	...
	Play322211006 = function(arg_26_0, arg_26_1)
		...
		function arg_26_1.onSingleLineUpdate_(arg_29_0)
			...
			if 0 < arg_26_1.time_ and arg_26_1.time_ <= var_29_0 + arg_29_0 then
				...
				local var_29_2 = arg_26_1:GetWordFromCfg(322211006)
				...
				local var_29_5 = 35 <= 0 and var_29_1 or var_29_1 * (utf8.len(var_29_3) / 35)

				if (35 <= 0 and var_29_1 or var_29_1 * (utf8.len(var_29_3) / 35)) > 0 and var_29_1 < var_29_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211006", "story_v_out_322211.awb") ~= 0 then
					local var_29_6 = manager.audio:GetVoiceLength("story_v_out_322211", "322211006", "story_v_out_322211.awb") / 1000
					...
					if var_29_2.prefab_name ~= "" and arg_26_1.actors_[var_29_2.prefab_name] ~= nil then
						local var_29_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_26_1.actors_[var_29_2.prefab_name].transform, "story_v_out_322211", "322211006", "story_v_out_322211.awb")

						arg_26_1:RecordAudio("322211006", var_29_7)
						arg_26_1:RecordAudio("322211006", var_29_7)
					else
	...
	Play322211007 = function(arg_30_0, arg_30_1)
		...
		function arg_30_1.onSingleLineUpdate_(arg_33_0)
			...
			if 0 < arg_30_1.time_ and arg_30_1.time_ <= 0 + arg_33_0 then
				...
				arg_30_1.leftNameTxt_.text = arg_30_1:FormatText(StoryNameCfg[67].name)
				...
				local var_33_1 = arg_30_1:GetWordFromCfg(322211007)
				...
				local var_33_4 = 22 <= 0 and var_33_0 or var_33_0 * (utf8.len(var_33_2) / 22)

				if (22 <= 0 and var_33_0 or var_33_0 * (utf8.len(var_33_2) / 22)) > 0 and var_33_0 < var_33_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211007", "story_v_out_322211.awb") ~= 0 then
					local var_33_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211007", "story_v_out_322211.awb") / 1000
					...
					if var_33_1.prefab_name ~= "" and arg_30_1.actors_[var_33_1.prefab_name] ~= nil then
						local var_33_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_30_1.actors_[var_33_1.prefab_name].transform, "story_v_out_322211", "322211007", "story_v_out_322211.awb")

						arg_30_1:RecordAudio("322211007", var_33_6)
						arg_30_1:RecordAudio("322211007", var_33_6)
					else
	...
	Play322211008 = function(arg_34_0, arg_34_1)
		...
		function arg_34_1.onSingleLineUpdate_(arg_37_0)
			if 0 < arg_34_1.time_ and arg_34_1.time_ <= 0 + arg_37_0 and not isNil(arg_34_1.actors_["10131ui_story"]) and arg_34_1.var_.characterEffect10131ui_story == nil then
				arg_34_1.var_.characterEffect10131ui_story = arg_34_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_37_0 = 0.200000002980232

			if 0 <= arg_34_1.time_ and arg_34_1.time_ < 0 + var_37_0 and not isNil(arg_34_1.actors_["10131ui_story"]) then
				if arg_34_1.var_.characterEffect10131ui_story and not isNil(arg_34_1.actors_["10131ui_story"]) then
					arg_34_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_34_1.time_ >= 0 + var_37_0 and arg_34_1.time_ < 0 + var_37_0 + arg_37_0 and not isNil(arg_34_1.actors_["10131ui_story"]) and arg_34_1.var_.characterEffect10131ui_story then
				arg_34_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_37_2 = arg_34_1.actors_["1111ui_story"]

			if 0 < arg_34_1.time_ and arg_34_1.time_ <= 0 + arg_37_0 and not isNil(var_37_2) and arg_34_1.var_.characterEffect1111ui_story == nil then
				arg_34_1.var_.characterEffect1111ui_story = var_37_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_37_3 = 0.200000002980232

			if 0 <= arg_34_1.time_ and arg_34_1.time_ < 0 + var_37_3 and not isNil(var_37_2) then
				if arg_34_1.var_.characterEffect1111ui_story and not isNil(var_37_2) then
					arg_34_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_34_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_34_1.time_ - 0) / var_37_3)
				end
			end

			if arg_34_1.time_ >= 0 + var_37_3 and arg_34_1.time_ < 0 + var_37_3 + arg_37_0 and not isNil(var_37_2) and arg_34_1.var_.characterEffect1111ui_story then
				arg_34_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_34_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_34_1.time_ and arg_34_1.time_ <= var_37_4 + arg_37_0 then
				...
				arg_34_1.leftNameTxt_.text = arg_34_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_37_6 = arg_34_1:GetWordFromCfg(322211008)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211008", "story_v_out_322211.awb") ~= 0 then
					local var_37_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211008", "story_v_out_322211.awb") / 1000
					...
					if var_37_6.prefab_name ~= "" and arg_34_1.actors_[var_37_6.prefab_name] ~= nil then
						local var_37_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_34_1.actors_[var_37_6.prefab_name].transform, "story_v_out_322211", "322211008", "story_v_out_322211.awb")

						arg_34_1:RecordAudio("322211008", var_37_11)
						arg_34_1:RecordAudio("322211008", var_37_11)
					else
	...
	Play322211009 = function(arg_38_0, arg_38_1)
		...
		function arg_38_1.onSingleLineUpdate_(arg_41_0)
			if 0 < arg_38_1.time_ and arg_38_1.time_ <= 0 + arg_41_0 and not isNil(arg_38_1.actors_["1111ui_story"]) and arg_38_1.var_.characterEffect1111ui_story == nil then
				arg_38_1.var_.characterEffect1111ui_story = arg_38_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_41_0 = 0.200000002980232

			if 0 <= arg_38_1.time_ and arg_38_1.time_ < 0 + var_41_0 and not isNil(arg_38_1.actors_["1111ui_story"]) then
				if arg_38_1.var_.characterEffect1111ui_story and not isNil(arg_38_1.actors_["1111ui_story"]) then
					arg_38_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_38_1.time_ >= 0 + var_41_0 and arg_38_1.time_ < 0 + var_41_0 + arg_41_0 and not isNil(arg_38_1.actors_["1111ui_story"]) and arg_38_1.var_.characterEffect1111ui_story then
				arg_38_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_41_2 = arg_38_1.actors_["10131ui_story"]

			if 0 < arg_38_1.time_ and arg_38_1.time_ <= 0 + arg_41_0 and not isNil(var_41_2) and arg_38_1.var_.characterEffect10131ui_story == nil then
				arg_38_1.var_.characterEffect10131ui_story = var_41_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_41_3 = 0.200000002980232

			if 0 <= arg_38_1.time_ and arg_38_1.time_ < 0 + var_41_3 and not isNil(var_41_2) then
				if arg_38_1.var_.characterEffect10131ui_story and not isNil(var_41_2) then
					arg_38_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_38_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_38_1.time_ - 0) / var_41_3)
				end
			end

			if arg_38_1.time_ >= 0 + var_41_3 and arg_38_1.time_ < 0 + var_41_3 + arg_41_0 and not isNil(var_41_2) and arg_38_1.var_.characterEffect10131ui_story then
				arg_38_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_38_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_38_1.time_ and arg_38_1.time_ <= var_41_4 + arg_41_0 then
				...
				arg_38_1.leftNameTxt_.text = arg_38_1:FormatText(StoryNameCfg[67].name)
				...
				local var_41_6 = arg_38_1:GetWordFromCfg(322211009)
				...
				local var_41_9 = 19 <= 0 and var_41_5 or var_41_5 * (utf8.len(var_41_7) / 19)

				if (19 <= 0 and var_41_5 or var_41_5 * (utf8.len(var_41_7) / 19)) > 0 and var_41_5 < var_41_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211009", "story_v_out_322211.awb") ~= 0 then
					local var_41_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211009", "story_v_out_322211.awb") / 1000
					...
					if var_41_6.prefab_name ~= "" and arg_38_1.actors_[var_41_6.prefab_name] ~= nil then
						local var_41_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_38_1.actors_[var_41_6.prefab_name].transform, "story_v_out_322211", "322211009", "story_v_out_322211.awb")

						arg_38_1:RecordAudio("322211009", var_41_11)
						arg_38_1:RecordAudio("322211009", var_41_11)
					else
	...
	Play322211010 = function(arg_42_0, arg_42_1)
		...
		function arg_42_1.onSingleLineUpdate_(arg_45_0)
			if 0 < arg_42_1.time_ and arg_42_1.time_ <= 0 + arg_45_0 and not isNil(arg_42_1.actors_["10131ui_story"]) and arg_42_1.var_.characterEffect10131ui_story == nil then
				arg_42_1.var_.characterEffect10131ui_story = arg_42_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_45_0 = 0.200000002980232

			if 0 <= arg_42_1.time_ and arg_42_1.time_ < 0 + var_45_0 and not isNil(arg_42_1.actors_["10131ui_story"]) then
				if arg_42_1.var_.characterEffect10131ui_story and not isNil(arg_42_1.actors_["10131ui_story"]) then
					arg_42_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_42_1.time_ >= 0 + var_45_0 and arg_42_1.time_ < 0 + var_45_0 + arg_45_0 and not isNil(arg_42_1.actors_["10131ui_story"]) and arg_42_1.var_.characterEffect10131ui_story then
				arg_42_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_45_2 = arg_42_1.actors_["1111ui_story"]

			if 0 < arg_42_1.time_ and arg_42_1.time_ <= 0 + arg_45_0 and not isNil(var_45_2) and arg_42_1.var_.characterEffect1111ui_story == nil then
				arg_42_1.var_.characterEffect1111ui_story = var_45_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_45_3 = 0.200000002980232

			if 0 <= arg_42_1.time_ and arg_42_1.time_ < 0 + var_45_3 and not isNil(var_45_2) then
				if arg_42_1.var_.characterEffect1111ui_story and not isNil(var_45_2) then
					arg_42_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_42_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_42_1.time_ - 0) / var_45_3)
				end
			end

			if arg_42_1.time_ >= 0 + var_45_3 and arg_42_1.time_ < 0 + var_45_3 + arg_45_0 and not isNil(var_45_2) and arg_42_1.var_.characterEffect1111ui_story then
				arg_42_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_42_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end

			local var_45_4 = 0
			local var_45_5 = 0.425
			...
			if 0 < arg_42_1.time_ and arg_42_1.time_ <= var_45_4 + arg_45_0 then
				...
				arg_42_1.leftNameTxt_.text = arg_42_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_45_6 = arg_42_1:GetWordFromCfg(322211010)
				...
				local var_45_9 = 17 <= 0 and var_45_5 or var_45_5 * (utf8.len(var_45_7) / 17)

				if (17 <= 0 and var_45_5 or var_45_5 * (utf8.len(var_45_7) / 17)) > 0 and var_45_5 < var_45_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211010", "story_v_out_322211.awb") ~= 0 then
					local var_45_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211010", "story_v_out_322211.awb") / 1000
					...
					if var_45_6.prefab_name ~= "" and arg_42_1.actors_[var_45_6.prefab_name] ~= nil then
						local var_45_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_42_1.actors_[var_45_6.prefab_name].transform, "story_v_out_322211", "322211010", "story_v_out_322211.awb")

						arg_42_1:RecordAudio("322211010", var_45_11)
						arg_42_1:RecordAudio("322211010", var_45_11)
					else
	...
	Play322211011 = function(arg_46_0, arg_46_1)
		...
		function arg_46_1.onSingleLineUpdate_(arg_49_0)
			if 0 < arg_46_1.time_ and arg_46_1.time_ <= 0 + arg_49_0 then
				arg_46_1.var_.moveOldPos10131ui_story = arg_46_1.actors_["10131ui_story"].transform.localPosition
			end

			local var_49_0 = 0.001

			if 0 <= arg_46_1.time_ and arg_46_1.time_ < 0 + var_49_0 then
				arg_46_1.actors_["10131ui_story"].transform.localPosition = Vector3.Lerp(arg_46_1.var_.moveOldPos10131ui_story, Vector3.New(0, 100, 0), (arg_46_1.time_ - 0) / var_49_0)
				arg_46_1.actors_["10131ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_46_1.actors_["10131ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_46_1.actors_["10131ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_46_1.actors_["10131ui_story"].transform.position).z)
				arg_46_1.actors_["10131ui_story"].transform.localEulerAngles.z = 0
				arg_46_1.actors_["10131ui_story"].transform.localEulerAngles.x = 0
				arg_46_1.actors_["10131ui_story"].transform.localEulerAngles = arg_46_1.actors_["10131ui_story"].transform.localEulerAngles
			end

			if arg_46_1.time_ >= 0 + var_49_0 and arg_46_1.time_ < 0 + var_49_0 + arg_49_0 then
				arg_46_1.actors_["10131ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_46_1.actors_["10131ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_46_1.actors_["10131ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_46_1.actors_["10131ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_46_1.actors_["10131ui_story"].transform.position).z)
				arg_46_1.actors_["10131ui_story"].transform.localEulerAngles.z = 0
				arg_46_1.actors_["10131ui_story"].transform.localEulerAngles.x = 0
				arg_46_1.actors_["10131ui_story"].transform.localEulerAngles = arg_46_1.actors_["10131ui_story"].transform.localEulerAngles
			...
			local var_49_1 = arg_46_1.actors_["1111ui_story"].transform

			if 0 < arg_46_1.time_ and arg_46_1.time_ <= 0 + arg_49_0 then
				arg_46_1.var_.moveOldPos1111ui_story = var_49_1.localPosition
			end

			local var_49_2 = 0.001

			if 0 <= arg_46_1.time_ and arg_46_1.time_ < 0 + var_49_2 then
				var_49_1.localPosition = Vector3.Lerp(arg_46_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_46_1.time_ - 0) / var_49_2)
			...
			if 0.533333333333333 < arg_46_1.time_ and arg_46_1.time_ <= 0.533333333333333 + arg_49_0 then
				arg_46_1:AudioAction("play", "effect", "se_story_141", "se_story_141_footstep_upstairs", "")
			end
			...
			if 0 < arg_46_1.time_ and arg_46_1.time_ <= var_49_4 + arg_49_0 then
				...
				local var_49_6 = arg_46_1:FormatText(arg_46_1:GetWordFromCfg(322211011).content)

				arg_46_1.text_.text = var_49_6

				LuaForUtil.ClearLinePrefixSymbol(arg_46_1.text_)

				local var_49_8 = 47 <= 0 and var_49_5 or var_49_5 * (utf8.len(var_49_6) / 47)

				if (47 <= 0 and var_49_5 or var_49_5 * (utf8.len(var_49_6) / 47)) > 0 and var_49_5 < var_49_8 then
					arg_46_1.talkMaxDuration = var_49_8

					if var_49_8 + var_49_4 > arg_46_1.duration_ then
						arg_46_1.duration_ = var_49_8 + var_49_4
					end
				end
			...
			local var_49_9 = math.max(var_49_5, arg_46_1.talkMaxDuration)

			if var_49_4 <= arg_46_1.time_ and arg_46_1.time_ < var_49_4 + var_49_9 then
				arg_46_1.typewritter.percent = (arg_46_1.time_ - var_49_4) / var_49_9

				arg_46_1.typewritter:SetDirty()
			end

			if arg_46_1.time_ >= var_49_4 + var_49_9 and arg_46_1.time_ < var_49_4 + var_49_9 + arg_49_0 then
	...
	Play322211012 = function(arg_50_0, arg_50_1)
		...
		function arg_50_1.onSingleLineUpdate_(arg_53_0)
			if 0 < arg_50_1.time_ and arg_50_1.time_ <= 0 + arg_53_0 then
				arg_50_1.var_.moveOldPos1111ui_story = arg_50_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_53_0 = 0.001

			if 0 <= arg_50_1.time_ and arg_50_1.time_ < 0 + var_53_0 then
				arg_50_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_50_1.var_.moveOldPos1111ui_story, Vector3.New(-0.79, -0.87, -5.7), (arg_50_1.time_ - 0) / var_53_0)
				arg_50_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_50_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_50_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_50_1.actors_["1111ui_story"].transform.position).z)
				arg_50_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_50_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_50_1.actors_["1111ui_story"].transform.localEulerAngles = arg_50_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_50_1.time_ >= 0 + var_53_0 and arg_50_1.time_ < 0 + var_53_0 + arg_53_0 then
				arg_50_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(-0.79, -0.87, -5.7)
				arg_50_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_50_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_50_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_50_1.actors_["1111ui_story"].transform.position).z)
				arg_50_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_50_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_50_1.actors_["1111ui_story"].transform.localEulerAngles = arg_50_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_53_1 = arg_50_1.actors_["1111ui_story"]

			if 0 < arg_50_1.time_ and arg_50_1.time_ <= 0 + arg_53_0 and not isNil(var_53_1) and arg_50_1.var_.characterEffect1111ui_story == nil then
				arg_50_1.var_.characterEffect1111ui_story = var_53_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_53_2 = 0.200000002980232

			if 0 <= arg_50_1.time_ and arg_50_1.time_ < 0 + var_53_2 and not isNil(var_53_1) then
				if arg_50_1.var_.characterEffect1111ui_story and not isNil(var_53_1) then
					arg_50_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_50_1.time_ >= 0 + var_53_2 and arg_50_1.time_ < 0 + var_53_2 + arg_53_0 and not isNil(var_53_1) and arg_50_1.var_.characterEffect1111ui_story then
				arg_50_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if 0 < arg_50_1.time_ and arg_50_1.time_ <= var_53_4 + arg_53_0 then
				...
				arg_50_1.leftNameTxt_.text = arg_50_1:FormatText(StoryNameCfg[67].name)
				...
				local var_53_6 = arg_50_1:GetWordFromCfg(322211012)
				...
				local var_53_9 = 5 <= 0 and var_53_5 or var_53_5 * (utf8.len(var_53_7) / 5)

				if (5 <= 0 and var_53_5 or var_53_5 * (utf8.len(var_53_7) / 5)) > 0 and var_53_5 < var_53_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211012", "story_v_out_322211.awb") ~= 0 then
					local var_53_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211012", "story_v_out_322211.awb") / 1000
					...
					if var_53_6.prefab_name ~= "" and arg_50_1.actors_[var_53_6.prefab_name] ~= nil then
						local var_53_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_50_1.actors_[var_53_6.prefab_name].transform, "story_v_out_322211", "322211012", "story_v_out_322211.awb")

						arg_50_1:RecordAudio("322211012", var_53_11)
						arg_50_1:RecordAudio("322211012", var_53_11)
					else
	...
	Play322211013 = function(arg_54_0, arg_54_1)
		...
		function arg_54_1.onSingleLineUpdate_(arg_57_0)
			if arg_54_1.actors_["4037ui_story"] == nil and not isNil((Asset.Load("Char/" .. "4037ui_story"))) then
				local var_57_0 = Object.Instantiate(Asset.Load("Char/" .. "4037ui_story"), arg_54_1.stage_.transform)

				var_57_0.name = "4037ui_story"
				var_57_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_54_1.actors_["4037ui_story"] = var_57_0
				...
				arg_54_1.var_["4037ui_story" .. "Animator"] = var_57_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_54_1.var_["4037ui_story" .. "Animator"].applyRootMotion = true
				arg_54_1.var_["4037ui_story" .. "LipSync"] = var_57_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_57_3 = arg_54_1.actors_["4037ui_story"].transform

			if 0 < arg_54_1.time_ and arg_54_1.time_ <= 0 + arg_57_0 then
				arg_54_1.var_.moveOldPos4037ui_story = var_57_3.localPosition
			end

			local var_57_4 = 0.001

			if 0 <= arg_54_1.time_ and arg_54_1.time_ < 0 + var_57_4 then
				var_57_3.localPosition = Vector3.Lerp(arg_54_1.var_.moveOldPos4037ui_story, Vector3.New(0.7, -1.12, -6.2), (arg_54_1.time_ - 0) / var_57_4)
			...
			if arg_54_1.time_ >= 0 + var_57_4 and arg_54_1.time_ < 0 + var_57_4 + arg_57_0 then
				var_57_3.localPosition = Vector3.New(0.7, -1.12, -6.2)
				var_57_3.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_57_3.position).x, (manager.ui.mainCamera.transform.position - var_57_3.position).y, (manager.ui.mainCamera.transform.position - var_57_3.position).z)
				var_57_3.localEulerAngles.z = 0
				var_57_3.localEulerAngles.x = 0
				var_57_3.localEulerAngles = var_57_3.localEulerAngles
			...
			local var_57_5 = arg_54_1.actors_["4037ui_story"]

			if 0 < arg_54_1.time_ and arg_54_1.time_ <= 0 + arg_57_0 and not isNil(var_57_5) and arg_54_1.var_.characterEffect4037ui_story == nil then
				arg_54_1.var_.characterEffect4037ui_story = var_57_5:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_57_6 = 0.200000002980232

			if 0 <= arg_54_1.time_ and arg_54_1.time_ < 0 + var_57_6 and not isNil(var_57_5) then
				if arg_54_1.var_.characterEffect4037ui_story and not isNil(var_57_5) then
					arg_54_1.var_.characterEffect4037ui_story.fillFlat = false
				end
			end

			if arg_54_1.time_ >= 0 + var_57_6 and arg_54_1.time_ < 0 + var_57_6 + arg_57_0 and not isNil(var_57_5) and arg_54_1.var_.characterEffect4037ui_story then
				arg_54_1.var_.characterEffect4037ui_story.fillFlat = false
			end

			local var_57_8 = arg_54_1.actors_["1111ui_story"]

			if 0 < arg_54_1.time_ and arg_54_1.time_ <= 0 + arg_57_0 and not isNil(var_57_8) and arg_54_1.var_.characterEffect1111ui_story == nil then
				arg_54_1.var_.characterEffect1111ui_story = var_57_8:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_57_9 = 0.200000002980232

			if 0 <= arg_54_1.time_ and arg_54_1.time_ < 0 + var_57_9 and not isNil(var_57_8) then
				if arg_54_1.var_.characterEffect1111ui_story and not isNil(var_57_8) then
					arg_54_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_54_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_54_1.time_ - 0) / var_57_9)
				end
			end

			if arg_54_1.time_ >= 0 + var_57_9 and arg_54_1.time_ < 0 + var_57_9 + arg_57_0 and not isNil(var_57_8) and arg_54_1.var_.characterEffect1111ui_story then
				arg_54_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_54_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_54_1.time_ and arg_54_1.time_ <= var_57_10 + arg_57_0 then
				...
				arg_54_1.leftNameTxt_.text = arg_54_1:FormatText(StoryNameCfg[453].name)
				...
				local var_57_12 = arg_54_1:GetWordFromCfg(322211013)
				...
				local var_57_15 = 7 <= 0 and var_57_11 or var_57_11 * (utf8.len(var_57_13) / 7)

				if (7 <= 0 and var_57_11 or var_57_11 * (utf8.len(var_57_13) / 7)) > 0 and var_57_11 < var_57_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211013", "story_v_out_322211.awb") ~= 0 then
					local var_57_16 = manager.audio:GetVoiceLength("story_v_out_322211", "322211013", "story_v_out_322211.awb") / 1000
					...
					if var_57_12.prefab_name ~= "" and arg_54_1.actors_[var_57_12.prefab_name] ~= nil then
						local var_57_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_54_1.actors_[var_57_12.prefab_name].transform, "story_v_out_322211", "322211013", "story_v_out_322211.awb")

						arg_54_1:RecordAudio("322211013", var_57_17)
						arg_54_1:RecordAudio("322211013", var_57_17)
					else
	...
	Play322211014 = function(arg_58_0, arg_58_1)
		...
		function arg_58_1.onSingleLineUpdate_(arg_61_0)
			if 0 < arg_58_1.time_ and arg_58_1.time_ <= 0 + arg_61_0 and not isNil(arg_58_1.actors_["1111ui_story"]) and arg_58_1.var_.characterEffect1111ui_story == nil then
				arg_58_1.var_.characterEffect1111ui_story = arg_58_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_61_0 = 0.200000002980232

			if 0 <= arg_58_1.time_ and arg_58_1.time_ < 0 + var_61_0 and not isNil(arg_58_1.actors_["1111ui_story"]) then
				if arg_58_1.var_.characterEffect1111ui_story and not isNil(arg_58_1.actors_["1111ui_story"]) then
					arg_58_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_58_1.time_ >= 0 + var_61_0 and arg_58_1.time_ < 0 + var_61_0 + arg_61_0 and not isNil(arg_58_1.actors_["1111ui_story"]) and arg_58_1.var_.characterEffect1111ui_story then
				arg_58_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_61_2 = arg_58_1.actors_["4037ui_story"]

			if 0 < arg_58_1.time_ and arg_58_1.time_ <= 0 + arg_61_0 and not isNil(var_61_2) and arg_58_1.var_.characterEffect4037ui_story == nil then
				arg_58_1.var_.characterEffect4037ui_story = var_61_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_61_3 = 0.200000002980232

			if 0 <= arg_58_1.time_ and arg_58_1.time_ < 0 + var_61_3 and not isNil(var_61_2) then
				if arg_58_1.var_.characterEffect4037ui_story and not isNil(var_61_2) then
					arg_58_1.var_.characterEffect4037ui_story.fillFlat = true
					arg_58_1.var_.characterEffect4037ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_58_1.time_ - 0) / var_61_3)
				end
			end

			if arg_58_1.time_ >= 0 + var_61_3 and arg_58_1.time_ < 0 + var_61_3 + arg_61_0 and not isNil(var_61_2) and arg_58_1.var_.characterEffect4037ui_story then
				arg_58_1.var_.characterEffect4037ui_story.fillFlat = true
				arg_58_1.var_.characterEffect4037ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_58_1.time_ and arg_58_1.time_ <= var_61_4 + arg_61_0 then
				...
				arg_58_1.leftNameTxt_.text = arg_58_1:FormatText(StoryNameCfg[67].name)
				...
				local var_61_6 = arg_58_1:GetWordFromCfg(322211014)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211014", "story_v_out_322211.awb") ~= 0 then
					local var_61_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211014", "story_v_out_322211.awb") / 1000
					...
					if var_61_6.prefab_name ~= "" and arg_58_1.actors_[var_61_6.prefab_name] ~= nil then
						local var_61_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_58_1.actors_[var_61_6.prefab_name].transform, "story_v_out_322211", "322211014", "story_v_out_322211.awb")

						arg_58_1:RecordAudio("322211014", var_61_11)
						arg_58_1:RecordAudio("322211014", var_61_11)
					else
	...
	Play322211015 = function(arg_62_0, arg_62_1)
		...
		function arg_62_1.onSingleLineUpdate_(arg_65_0)
			if 0 < arg_62_1.time_ and arg_62_1.time_ <= 0 + arg_65_0 and not isNil(arg_62_1.actors_["4037ui_story"]) and arg_62_1.var_.characterEffect4037ui_story == nil then
				arg_62_1.var_.characterEffect4037ui_story = arg_62_1.actors_["4037ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_65_0 = 0.200000002980232

			if 0 <= arg_62_1.time_ and arg_62_1.time_ < 0 + var_65_0 and not isNil(arg_62_1.actors_["4037ui_story"]) then
				if arg_62_1.var_.characterEffect4037ui_story and not isNil(arg_62_1.actors_["4037ui_story"]) then
					arg_62_1.var_.characterEffect4037ui_story.fillFlat = false
				end
			end

			if arg_62_1.time_ >= 0 + var_65_0 and arg_62_1.time_ < 0 + var_65_0 + arg_65_0 and not isNil(arg_62_1.actors_["4037ui_story"]) and arg_62_1.var_.characterEffect4037ui_story then
				arg_62_1.var_.characterEffect4037ui_story.fillFlat = false
			end

			local var_65_2 = arg_62_1.actors_["1111ui_story"]

			if 0 < arg_62_1.time_ and arg_62_1.time_ <= 0 + arg_65_0 and not isNil(var_65_2) and arg_62_1.var_.characterEffect1111ui_story == nil then
				arg_62_1.var_.characterEffect1111ui_story = var_65_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_65_3 = 0.200000002980232

			if 0 <= arg_62_1.time_ and arg_62_1.time_ < 0 + var_65_3 and not isNil(var_65_2) then
				if arg_62_1.var_.characterEffect1111ui_story and not isNil(var_65_2) then
					arg_62_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_62_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_62_1.time_ - 0) / var_65_3)
				end
			end

			if arg_62_1.time_ >= 0 + var_65_3 and arg_62_1.time_ < 0 + var_65_3 + arg_65_0 and not isNil(var_65_2) and arg_62_1.var_.characterEffect1111ui_story then
				arg_62_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_62_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_62_1.time_ and arg_62_1.time_ <= var_65_4 + arg_65_0 then
				...
				arg_62_1.leftNameTxt_.text = arg_62_1:FormatText(StoryNameCfg[453].name)
				...
				local var_65_6 = arg_62_1:GetWordFromCfg(322211015)
				...
				local var_65_9 = 11 <= 0 and var_65_5 or var_65_5 * (utf8.len(var_65_7) / 11)

				if (11 <= 0 and var_65_5 or var_65_5 * (utf8.len(var_65_7) / 11)) > 0 and var_65_5 < var_65_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211015", "story_v_out_322211.awb") ~= 0 then
					local var_65_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211015", "story_v_out_322211.awb") / 1000
					...
					if var_65_6.prefab_name ~= "" and arg_62_1.actors_[var_65_6.prefab_name] ~= nil then
						local var_65_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_62_1.actors_[var_65_6.prefab_name].transform, "story_v_out_322211", "322211015", "story_v_out_322211.awb")

						arg_62_1:RecordAudio("322211015", var_65_11)
						arg_62_1:RecordAudio("322211015", var_65_11)
					else
	...
	Play322211016 = function(arg_66_0, arg_66_1)
		...
		function arg_66_1.onSingleLineUpdate_(arg_69_0)
			if 0 < arg_66_1.time_ and arg_66_1.time_ <= 0 + arg_69_0 and not isNil(arg_66_1.actors_["1111ui_story"]) and arg_66_1.var_.characterEffect1111ui_story == nil then
				arg_66_1.var_.characterEffect1111ui_story = arg_66_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_69_0 = 0.200000002980232

			if 0 <= arg_66_1.time_ and arg_66_1.time_ < 0 + var_69_0 and not isNil(arg_66_1.actors_["1111ui_story"]) then
				if arg_66_1.var_.characterEffect1111ui_story and not isNil(arg_66_1.actors_["1111ui_story"]) then
					arg_66_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_66_1.time_ >= 0 + var_69_0 and arg_66_1.time_ < 0 + var_69_0 + arg_69_0 and not isNil(arg_66_1.actors_["1111ui_story"]) and arg_66_1.var_.characterEffect1111ui_story then
				arg_66_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_69_2 = arg_66_1.actors_["4037ui_story"]

			if 0 < arg_66_1.time_ and arg_66_1.time_ <= 0 + arg_69_0 and not isNil(var_69_2) and arg_66_1.var_.characterEffect4037ui_story == nil then
				arg_66_1.var_.characterEffect4037ui_story = var_69_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_69_3 = 0.200000002980232

			if 0 <= arg_66_1.time_ and arg_66_1.time_ < 0 + var_69_3 and not isNil(var_69_2) then
				if arg_66_1.var_.characterEffect4037ui_story and not isNil(var_69_2) then
					arg_66_1.var_.characterEffect4037ui_story.fillFlat = true
					arg_66_1.var_.characterEffect4037ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_66_1.time_ - 0) / var_69_3)
				end
			end

			if arg_66_1.time_ >= 0 + var_69_3 and arg_66_1.time_ < 0 + var_69_3 + arg_69_0 and not isNil(var_69_2) and arg_66_1.var_.characterEffect4037ui_story then
				arg_66_1.var_.characterEffect4037ui_story.fillFlat = true
				arg_66_1.var_.characterEffect4037ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_66_1.time_ and arg_66_1.time_ <= var_69_4 + arg_69_0 then
				...
				local var_69_6 = arg_66_1:GetWordFromCfg(322211016)
				...
				local var_69_9 = 41 <= 0 and var_69_5 or var_69_5 * (utf8.len(var_69_7) / 41)

				if (41 <= 0 and var_69_5 or var_69_5 * (utf8.len(var_69_7) / 41)) > 0 and var_69_5 < var_69_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211016", "story_v_out_322211.awb") ~= 0 then
					local var_69_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211016", "story_v_out_322211.awb") / 1000
					...
					if var_69_6.prefab_name ~= "" and arg_66_1.actors_[var_69_6.prefab_name] ~= nil then
						local var_69_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_66_1.actors_[var_69_6.prefab_name].transform, "story_v_out_322211", "322211016", "story_v_out_322211.awb")

						arg_66_1:RecordAudio("322211016", var_69_11)
						arg_66_1:RecordAudio("322211016", var_69_11)
					else
	...
	Play322211017 = function(arg_70_0, arg_70_1)
		...
		function arg_70_1.onSingleLineUpdate_(arg_73_0)
			if 0 < arg_70_1.time_ and arg_70_1.time_ <= 0 + arg_73_0 and not isNil(arg_70_1.actors_["4037ui_story"]) and arg_70_1.var_.characterEffect4037ui_story == nil then
				arg_70_1.var_.characterEffect4037ui_story = arg_70_1.actors_["4037ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_73_0 = 0.200000002980232

			if 0 <= arg_70_1.time_ and arg_70_1.time_ < 0 + var_73_0 and not isNil(arg_70_1.actors_["4037ui_story"]) then
				if arg_70_1.var_.characterEffect4037ui_story and not isNil(arg_70_1.actors_["4037ui_story"]) then
					arg_70_1.var_.characterEffect4037ui_story.fillFlat = false
				end
			end

			if arg_70_1.time_ >= 0 + var_73_0 and arg_70_1.time_ < 0 + var_73_0 + arg_73_0 and not isNil(arg_70_1.actors_["4037ui_story"]) and arg_70_1.var_.characterEffect4037ui_story then
				arg_70_1.var_.characterEffect4037ui_story.fillFlat = false
			end

			local var_73_2 = arg_70_1.actors_["1111ui_story"]

			if 0 < arg_70_1.time_ and arg_70_1.time_ <= 0 + arg_73_0 and not isNil(var_73_2) and arg_70_1.var_.characterEffect1111ui_story == nil then
				arg_70_1.var_.characterEffect1111ui_story = var_73_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_73_3 = 0.200000002980232

			if 0 <= arg_70_1.time_ and arg_70_1.time_ < 0 + var_73_3 and not isNil(var_73_2) then
				if arg_70_1.var_.characterEffect1111ui_story and not isNil(var_73_2) then
					arg_70_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_70_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_70_1.time_ - 0) / var_73_3)
				end
			end

			if arg_70_1.time_ >= 0 + var_73_3 and arg_70_1.time_ < 0 + var_73_3 + arg_73_0 and not isNil(var_73_2) and arg_70_1.var_.characterEffect1111ui_story then
				arg_70_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_70_1.time_ and arg_70_1.time_ <= var_73_4 + arg_73_0 then
				...
				arg_70_1.leftNameTxt_.text = arg_70_1:FormatText(StoryNameCfg[453].name)
				...
				local var_73_6 = arg_70_1:GetWordFromCfg(322211017)
				...
				local var_73_9 = 26 <= 0 and var_73_5 or var_73_5 * (utf8.len(var_73_7) / 26)

				if (26 <= 0 and var_73_5 or var_73_5 * (utf8.len(var_73_7) / 26)) > 0 and var_73_5 < var_73_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211017", "story_v_out_322211.awb") ~= 0 then
					local var_73_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211017", "story_v_out_322211.awb") / 1000
					...
					if var_73_6.prefab_name ~= "" and arg_70_1.actors_[var_73_6.prefab_name] ~= nil then
						local var_73_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_70_1.actors_[var_73_6.prefab_name].transform, "story_v_out_322211", "322211017", "story_v_out_322211.awb")

						arg_70_1:RecordAudio("322211017", var_73_11)
						arg_70_1:RecordAudio("322211017", var_73_11)
					else
	...
	Play322211018 = function(arg_74_0, arg_74_1)
		...
		function arg_74_1.onSingleLineUpdate_(arg_77_0)
			...
			local var_77_2 = arg_74_1.actors_["4037ui_story"]

			if 0 < arg_74_1.time_ and arg_74_1.time_ <= 0 + arg_77_0 and not isNil(var_77_2) and arg_74_1.var_.characterEffect4037ui_story == nil then
				arg_74_1.var_.characterEffect4037ui_story = var_77_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_77_3 = 0.200000002980232

			if 0 <= arg_74_1.time_ and arg_74_1.time_ < 0 + var_77_3 and not isNil(var_77_2) then
				if arg_74_1.var_.characterEffect4037ui_story and not isNil(var_77_2) then
					arg_74_1.var_.characterEffect4037ui_story.fillFlat = true
					arg_74_1.var_.characterEffect4037ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_74_1.time_ - 0) / var_77_3)
				end
			end

			if arg_74_1.time_ >= 0 + var_77_3 and arg_74_1.time_ < 0 + var_77_3 + arg_77_0 and not isNil(var_77_2) and arg_74_1.var_.characterEffect4037ui_story then
				arg_74_1.var_.characterEffect4037ui_story.fillFlat = true
				arg_74_1.var_.characterEffect4037ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_74_1.time_ and arg_74_1.time_ <= var_77_4 + arg_77_0 then
				...
				local var_77_6 = arg_74_1:GetWordFromCfg(322211018)
				...
				local var_77_9 = 14 <= 0 and var_77_5 or var_77_5 * (utf8.len(var_77_7) / 14)

				if (14 <= 0 and var_77_5 or var_77_5 * (utf8.len(var_77_7) / 14)) > 0 and var_77_5 < var_77_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211018", "story_v_out_322211.awb") ~= 0 then
					local var_77_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211018", "story_v_out_322211.awb") / 1000
					...
					if var_77_6.prefab_name ~= "" and arg_74_1.actors_[var_77_6.prefab_name] ~= nil then
						local var_77_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_74_1.actors_[var_77_6.prefab_name].transform, "story_v_out_322211", "322211018", "story_v_out_322211.awb")

						arg_74_1:RecordAudio("322211018", var_77_11)
						arg_74_1:RecordAudio("322211018", var_77_11)
					else
	...
	Play322211019 = function(arg_78_0, arg_78_1)
		...
		function arg_78_1.onSingleLineUpdate_(arg_81_0)
			if 0 < arg_78_1.time_ and arg_78_1.time_ <= 0 + arg_81_0 then
				arg_78_1.var_.moveOldPos1111ui_story = arg_78_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_81_0 = 0.001

			if 0 <= arg_78_1.time_ and arg_78_1.time_ < 0 + var_81_0 then
				arg_78_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_78_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_78_1.time_ - 0) / var_81_0)
				arg_78_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_78_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_78_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_78_1.actors_["1111ui_story"].transform.position).z)
				arg_78_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_78_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_78_1.actors_["1111ui_story"].transform.localEulerAngles = arg_78_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_78_1.time_ >= 0 + var_81_0 and arg_78_1.time_ < 0 + var_81_0 + arg_81_0 then
				arg_78_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_78_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_78_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_78_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_78_1.actors_["1111ui_story"].transform.position).z)
				arg_78_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_78_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_78_1.actors_["1111ui_story"].transform.localEulerAngles = arg_78_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_81_1 = arg_78_1.actors_["4037ui_story"].transform

			if 0 < arg_78_1.time_ and arg_78_1.time_ <= 0 + arg_81_0 then
				arg_78_1.var_.moveOldPos4037ui_story = var_81_1.localPosition
			end

			local var_81_2 = 0.001

			if 0 <= arg_78_1.time_ and arg_78_1.time_ < 0 + var_81_2 then
				var_81_1.localPosition = Vector3.Lerp(arg_78_1.var_.moveOldPos4037ui_story, Vector3.New(0, 100, 0), (arg_78_1.time_ - 0) / var_81_2)
			...
			if 0 < arg_78_1.time_ and arg_78_1.time_ <= var_81_3 + arg_81_0 then
				...
				local var_81_5 = arg_78_1:FormatText(arg_78_1:GetWordFromCfg(322211019).content)

				arg_78_1.text_.text = var_81_5

				LuaForUtil.ClearLinePrefixSymbol(arg_78_1.text_)

				local var_81_7 = 58 <= 0 and var_81_4 or var_81_4 * (utf8.len(var_81_5) / 58)

				if (58 <= 0 and var_81_4 or var_81_4 * (utf8.len(var_81_5) / 58)) > 0 and var_81_4 < var_81_7 then
	...
	Play322211020 = function(arg_82_0, arg_82_1)
		...
		function arg_82_1.onSingleLineUpdate_(arg_85_0)
			if 0 < arg_82_1.time_ and arg_82_1.time_ <= 0 + arg_85_0 then
				arg_82_1.var_.moveOldPos4037ui_story = arg_82_1.actors_["4037ui_story"].transform.localPosition
			end

			local var_85_0 = 0.001

			if 0 <= arg_82_1.time_ and arg_82_1.time_ < 0 + var_85_0 then
				arg_82_1.actors_["4037ui_story"].transform.localPosition = Vector3.Lerp(arg_82_1.var_.moveOldPos4037ui_story, Vector3.New(0, -1.12, -6.2), (arg_82_1.time_ - 0) / var_85_0)
				arg_82_1.actors_["4037ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_82_1.actors_["4037ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_82_1.actors_["4037ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_82_1.actors_["4037ui_story"].transform.position).z)
				arg_82_1.actors_["4037ui_story"].transform.localEulerAngles.z = 0
				arg_82_1.actors_["4037ui_story"].transform.localEulerAngles.x = 0
				arg_82_1.actors_["4037ui_story"].transform.localEulerAngles = arg_82_1.actors_["4037ui_story"].transform.localEulerAngles
			end

			if arg_82_1.time_ >= 0 + var_85_0 and arg_82_1.time_ < 0 + var_85_0 + arg_85_0 then
				arg_82_1.actors_["4037ui_story"].transform.localPosition = Vector3.New(0, -1.12, -6.2)
				arg_82_1.actors_["4037ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_82_1.actors_["4037ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_82_1.actors_["4037ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_82_1.actors_["4037ui_story"].transform.position).z)
				arg_82_1.actors_["4037ui_story"].transform.localEulerAngles.z = 0
				arg_82_1.actors_["4037ui_story"].transform.localEulerAngles.x = 0
				arg_82_1.actors_["4037ui_story"].transform.localEulerAngles = arg_82_1.actors_["4037ui_story"].transform.localEulerAngles
			...
			local var_85_1 = arg_82_1.actors_["4037ui_story"]

			if 0 < arg_82_1.time_ and arg_82_1.time_ <= 0 + arg_85_0 and not isNil(var_85_1) and arg_82_1.var_.characterEffect4037ui_story == nil then
				arg_82_1.var_.characterEffect4037ui_story = var_85_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_85_2 = 0.200000002980232

			if 0 <= arg_82_1.time_ and arg_82_1.time_ < 0 + var_85_2 and not isNil(var_85_1) then
				if arg_82_1.var_.characterEffect4037ui_story and not isNil(var_85_1) then
					arg_82_1.var_.characterEffect4037ui_story.fillFlat = false
				end
			end

			if arg_82_1.time_ >= 0 + var_85_2 and arg_82_1.time_ < 0 + var_85_2 + arg_85_0 and not isNil(var_85_1) and arg_82_1.var_.characterEffect4037ui_story then
				arg_82_1.var_.characterEffect4037ui_story.fillFlat = false
			end
			...
			if 0 < arg_82_1.time_ and arg_82_1.time_ <= var_85_4 + arg_85_0 then
				...
				arg_82_1.leftNameTxt_.text = arg_82_1:FormatText(StoryNameCfg[453].name)
				...
				local var_85_6 = arg_82_1:GetWordFromCfg(322211020)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211020", "story_v_out_322211.awb") ~= 0 then
					local var_85_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211020", "story_v_out_322211.awb") / 1000
					...
					if var_85_6.prefab_name ~= "" and arg_82_1.actors_[var_85_6.prefab_name] ~= nil then
						local var_85_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_82_1.actors_[var_85_6.prefab_name].transform, "story_v_out_322211", "322211020", "story_v_out_322211.awb")

						arg_82_1:RecordAudio("322211020", var_85_11)
						arg_82_1:RecordAudio("322211020", var_85_11)
					else
	...
	Play322211021 = function(arg_86_0, arg_86_1)
		...
		function arg_86_1.onSingleLineUpdate_(arg_89_0)
			...
			if 0 <= arg_86_1.time_ and arg_86_1.time_ < 0 + var_89_0 then
				arg_86_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_86_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_86_1.time_ - 0) / var_89_0)
			...
			if arg_86_1.time_ >= 0 + var_89_0 and arg_86_1.time_ < 0 + var_89_0 + arg_89_0 then
				arg_86_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, -0.87, -5.7)
				arg_86_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_86_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_86_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_86_1.actors_["1111ui_story"].transform.position).z)
				arg_86_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_86_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_86_1.actors_["1111ui_story"].transform.localEulerAngles = arg_86_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_89_1 = arg_86_1.actors_["4037ui_story"].transform

			if 0 < arg_86_1.time_ and arg_86_1.time_ <= 0 + arg_89_0 then
				arg_86_1.var_.moveOldPos4037ui_story = var_89_1.localPosition
			end

			local var_89_2 = 0.001

			if 0 <= arg_86_1.time_ and arg_86_1.time_ < 0 + var_89_2 then
				var_89_1.localPosition = Vector3.Lerp(arg_86_1.var_.moveOldPos4037ui_story, Vector3.New(0, 100, 0), (arg_86_1.time_ - 0) / var_89_2)
			...
			local var_89_3 = arg_86_1.actors_["1111ui_story"]

			if 0 < arg_86_1.time_ and arg_86_1.time_ <= 0 + arg_89_0 and not isNil(var_89_3) and arg_86_1.var_.characterEffect1111ui_story == nil then
				arg_86_1.var_.characterEffect1111ui_story = var_89_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_89_4 = 0.200000002980232

			if 0 <= arg_86_1.time_ and arg_86_1.time_ < 0 + var_89_4 and not isNil(var_89_3) then
				if arg_86_1.var_.characterEffect1111ui_story and not isNil(var_89_3) then
					arg_86_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_86_1.time_ >= 0 + var_89_4 and arg_86_1.time_ < 0 + var_89_4 + arg_89_0 and not isNil(var_89_3) and arg_86_1.var_.characterEffect1111ui_story then
				arg_86_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_89_6 = arg_86_1.actors_["4037ui_story"]

			if 0 < arg_86_1.time_ and arg_86_1.time_ <= 0 + arg_89_0 and not isNil(var_89_6) and arg_86_1.var_.characterEffect4037ui_story == nil then
				arg_86_1.var_.characterEffect4037ui_story = var_89_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_89_7 = 0.200000002980232

			if 0 <= arg_86_1.time_ and arg_86_1.time_ < 0 + var_89_7 and not isNil(var_89_6) then
				if arg_86_1.var_.characterEffect4037ui_story and not isNil(var_89_6) then
					arg_86_1.var_.characterEffect4037ui_story.fillFlat = true
					arg_86_1.var_.characterEffect4037ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_86_1.time_ - 0) / var_89_7)
				end
			end

			if arg_86_1.time_ >= 0 + var_89_7 and arg_86_1.time_ < 0 + var_89_7 + arg_89_0 and not isNil(var_89_6) and arg_86_1.var_.characterEffect4037ui_story then
				arg_86_1.var_.characterEffect4037ui_story.fillFlat = true
				arg_86_1.var_.characterEffect4037ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_86_1.time_ and arg_86_1.time_ <= var_89_8 + arg_89_0 then
				...
				local var_89_10 = arg_86_1:GetWordFromCfg(322211021)
				...
				local var_89_13 = 12 <= 0 and var_89_9 or var_89_9 * (utf8.len(var_89_11) / 12)

				if (12 <= 0 and var_89_9 or var_89_9 * (utf8.len(var_89_11) / 12)) > 0 and var_89_9 < var_89_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211021", "story_v_out_322211.awb") ~= 0 then
					local var_89_14 = manager.audio:GetVoiceLength("story_v_out_322211", "322211021", "story_v_out_322211.awb") / 1000
					...
					if var_89_10.prefab_name ~= "" and arg_86_1.actors_[var_89_10.prefab_name] ~= nil then
						local var_89_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_86_1.actors_[var_89_10.prefab_name].transform, "story_v_out_322211", "322211021", "story_v_out_322211.awb")

						arg_86_1:RecordAudio("322211021", var_89_15)
						arg_86_1:RecordAudio("322211021", var_89_15)
					else
	...
	Play322211022 = function(arg_90_0, arg_90_1)
		...
		function arg_90_1.onSingleLineUpdate_(arg_93_0)
			if 0 < arg_90_1.time_ and arg_90_1.time_ <= 0 + arg_93_0 then
				arg_90_1.var_.moveOldPos1111ui_story = arg_90_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_93_0 = 0.001

			if 0 <= arg_90_1.time_ and arg_90_1.time_ < 0 + var_93_0 then
				arg_90_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_90_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_90_1.time_ - 0) / var_93_0)
				arg_90_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_90_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_90_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_90_1.actors_["1111ui_story"].transform.position).z)
				arg_90_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_90_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_90_1.actors_["1111ui_story"].transform.localEulerAngles = arg_90_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_90_1.time_ >= 0 + var_93_0 and arg_90_1.time_ < 0 + var_93_0 + arg_93_0 then
				arg_90_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_90_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_90_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_90_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_90_1.actors_["1111ui_story"].transform.position).z)
				arg_90_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_90_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_90_1.actors_["1111ui_story"].transform.localEulerAngles = arg_90_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			if 0 < arg_90_1.time_ and arg_90_1.time_ <= var_93_1 + arg_93_0 then
				...
				local var_93_3 = arg_90_1:FormatText(arg_90_1:GetWordFromCfg(322211022).content)

				arg_90_1.text_.text = var_93_3

				LuaForUtil.ClearLinePrefixSymbol(arg_90_1.text_)

				local var_93_5 = 50 <= 0 and var_93_2 or var_93_2 * (utf8.len(var_93_3) / 50)

				if (50 <= 0 and var_93_2 or var_93_2 * (utf8.len(var_93_3) / 50)) > 0 and var_93_2 < var_93_5 then
	...
	Play322211023 = function(arg_94_0, arg_94_1)
		...
		function arg_94_1.onSingleLineUpdate_(arg_97_0)
			if 0 < arg_94_1.time_ and arg_94_1.time_ <= 0 + arg_97_0 then
				arg_94_1.var_.moveOldPos1111ui_story = arg_94_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_97_0 = 0.001

			if 0 <= arg_94_1.time_ and arg_94_1.time_ < 0 + var_97_0 then
				arg_94_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_94_1.var_.moveOldPos1111ui_story, Vector3.New(-0.79, -0.87, -5.7), (arg_94_1.time_ - 0) / var_97_0)
				arg_94_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_94_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_94_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_94_1.actors_["1111ui_story"].transform.position).z)
				arg_94_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_94_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_94_1.actors_["1111ui_story"].transform.localEulerAngles = arg_94_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_94_1.time_ >= 0 + var_97_0 and arg_94_1.time_ < 0 + var_97_0 + arg_97_0 then
				arg_94_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(-0.79, -0.87, -5.7)
				arg_94_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_94_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_94_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_94_1.actors_["1111ui_story"].transform.position).z)
				arg_94_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_94_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_94_1.actors_["1111ui_story"].transform.localEulerAngles = arg_94_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_97_1 = arg_94_1.actors_["1111ui_story"]

			if 0 < arg_94_1.time_ and arg_94_1.time_ <= 0 + arg_97_0 and not isNil(var_97_1) and arg_94_1.var_.characterEffect1111ui_story == nil then
				arg_94_1.var_.characterEffect1111ui_story = var_97_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_97_2 = 0.200000002980232

			if 0 <= arg_94_1.time_ and arg_94_1.time_ < 0 + var_97_2 and not isNil(var_97_1) then
				if arg_94_1.var_.characterEffect1111ui_story and not isNil(var_97_1) then
					arg_94_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_94_1.time_ >= 0 + var_97_2 and arg_94_1.time_ < 0 + var_97_2 + arg_97_0 and not isNil(var_97_1) and arg_94_1.var_.characterEffect1111ui_story then
				arg_94_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if 0 < arg_94_1.time_ and arg_94_1.time_ <= var_97_4 + arg_97_0 then
				...
				local var_97_6 = arg_94_1:GetWordFromCfg(322211023)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211023", "story_v_out_322211.awb") ~= 0 then
					local var_97_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211023", "story_v_out_322211.awb") / 1000
					...
					if var_97_6.prefab_name ~= "" and arg_94_1.actors_[var_97_6.prefab_name] ~= nil then
						local var_97_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_94_1.actors_[var_97_6.prefab_name].transform, "story_v_out_322211", "322211023", "story_v_out_322211.awb")

						arg_94_1:RecordAudio("322211023", var_97_11)
						arg_94_1:RecordAudio("322211023", var_97_11)
					else
	...
	Play322211024 = function(arg_98_0, arg_98_1)
		...
		function arg_98_1.onSingleLineUpdate_(arg_101_0)
			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 then
				arg_98_1.var_.moveOldPos4037ui_story = arg_98_1.actors_["4037ui_story"].transform.localPosition
			end

			local var_101_0 = 0.001

			if 0 <= arg_98_1.time_ and arg_98_1.time_ < 0 + var_101_0 then
				arg_98_1.actors_["4037ui_story"].transform.localPosition = Vector3.Lerp(arg_98_1.var_.moveOldPos4037ui_story, Vector3.New(0.7, -1.12, -6.2), (arg_98_1.time_ - 0) / var_101_0)
				arg_98_1.actors_["4037ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_98_1.actors_["4037ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["4037ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["4037ui_story"].transform.position).z)
				arg_98_1.actors_["4037ui_story"].transform.localEulerAngles.z = 0
				arg_98_1.actors_["4037ui_story"].transform.localEulerAngles.x = 0
				arg_98_1.actors_["4037ui_story"].transform.localEulerAngles = arg_98_1.actors_["4037ui_story"].transform.localEulerAngles
			end

			if arg_98_1.time_ >= 0 + var_101_0 and arg_98_1.time_ < 0 + var_101_0 + arg_101_0 then
				arg_98_1.actors_["4037ui_story"].transform.localPosition = Vector3.New(0.7, -1.12, -6.2)
				arg_98_1.actors_["4037ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_98_1.actors_["4037ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["4037ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_98_1.actors_["4037ui_story"].transform.position).z)
				arg_98_1.actors_["4037ui_story"].transform.localEulerAngles.z = 0
				arg_98_1.actors_["4037ui_story"].transform.localEulerAngles.x = 0
				arg_98_1.actors_["4037ui_story"].transform.localEulerAngles = arg_98_1.actors_["4037ui_story"].transform.localEulerAngles
			...
			local var_101_1 = arg_98_1.actors_["4037ui_story"]

			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 and not isNil(var_101_1) and arg_98_1.var_.characterEffect4037ui_story == nil then
				arg_98_1.var_.characterEffect4037ui_story = var_101_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_101_2 = 0.200000002980232

			if 0 <= arg_98_1.time_ and arg_98_1.time_ < 0 + var_101_2 and not isNil(var_101_1) then
				if arg_98_1.var_.characterEffect4037ui_story and not isNil(var_101_1) then
					arg_98_1.var_.characterEffect4037ui_story.fillFlat = false
				end
			end

			if arg_98_1.time_ >= 0 + var_101_2 and arg_98_1.time_ < 0 + var_101_2 + arg_101_0 and not isNil(var_101_1) and arg_98_1.var_.characterEffect4037ui_story then
				arg_98_1.var_.characterEffect4037ui_story.fillFlat = false
			end

			local var_101_4 = arg_98_1.actors_["1111ui_story"]

			if 0 < arg_98_1.time_ and arg_98_1.time_ <= 0 + arg_101_0 and not isNil(var_101_4) and arg_98_1.var_.characterEffect1111ui_story == nil then
				arg_98_1.var_.characterEffect1111ui_story = var_101_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_101_5 = 0.200000002980232

			if 0 <= arg_98_1.time_ and arg_98_1.time_ < 0 + var_101_5 and not isNil(var_101_4) then
				if arg_98_1.var_.characterEffect1111ui_story and not isNil(var_101_4) then
					arg_98_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_98_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_98_1.time_ - 0) / var_101_5)
				end
			end

			if arg_98_1.time_ >= 0 + var_101_5 and arg_98_1.time_ < 0 + var_101_5 + arg_101_0 and not isNil(var_101_4) and arg_98_1.var_.characterEffect1111ui_story then
				arg_98_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_98_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_98_1.time_ and arg_98_1.time_ <= var_101_6 + arg_101_0 then
				...
				arg_98_1.leftNameTxt_.text = arg_98_1:FormatText(StoryNameCfg[453].name)
				...
				local var_101_8 = arg_98_1:GetWordFromCfg(322211024)
				...
				local var_101_11 = 9 <= 0 and var_101_7 or var_101_7 * (utf8.len(var_101_9) / 9)

				if (9 <= 0 and var_101_7 or var_101_7 * (utf8.len(var_101_9) / 9)) > 0 and var_101_7 < var_101_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211024", "story_v_out_322211.awb") ~= 0 then
					local var_101_12 = manager.audio:GetVoiceLength("story_v_out_322211", "322211024", "story_v_out_322211.awb") / 1000
					...
					if var_101_8.prefab_name ~= "" and arg_98_1.actors_[var_101_8.prefab_name] ~= nil then
						local var_101_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_98_1.actors_[var_101_8.prefab_name].transform, "story_v_out_322211", "322211024", "story_v_out_322211.awb")

						arg_98_1:RecordAudio("322211024", var_101_13)
						arg_98_1:RecordAudio("322211024", var_101_13)
					else
	...
	Play322211025 = function(arg_102_0, arg_102_1)
		...
		function arg_102_1.onSingleLineUpdate_(arg_105_0)
			if 0 < arg_102_1.time_ and arg_102_1.time_ <= 0 + arg_105_0 and not isNil(arg_102_1.actors_["1111ui_story"]) and arg_102_1.var_.characterEffect1111ui_story == nil then
				arg_102_1.var_.characterEffect1111ui_story = arg_102_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_105_0 = 0.200000002980232

			if 0 <= arg_102_1.time_ and arg_102_1.time_ < 0 + var_105_0 and not isNil(arg_102_1.actors_["1111ui_story"]) then
				if arg_102_1.var_.characterEffect1111ui_story and not isNil(arg_102_1.actors_["1111ui_story"]) then
					arg_102_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_102_1.time_ >= 0 + var_105_0 and arg_102_1.time_ < 0 + var_105_0 + arg_105_0 and not isNil(arg_102_1.actors_["1111ui_story"]) and arg_102_1.var_.characterEffect1111ui_story then
				arg_102_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_105_2 = arg_102_1.actors_["4037ui_story"]

			if 0 < arg_102_1.time_ and arg_102_1.time_ <= 0 + arg_105_0 and not isNil(var_105_2) and arg_102_1.var_.characterEffect4037ui_story == nil then
				arg_102_1.var_.characterEffect4037ui_story = var_105_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_105_3 = 0.200000002980232

			if 0 <= arg_102_1.time_ and arg_102_1.time_ < 0 + var_105_3 and not isNil(var_105_2) then
				if arg_102_1.var_.characterEffect4037ui_story and not isNil(var_105_2) then
					arg_102_1.var_.characterEffect4037ui_story.fillFlat = true
					arg_102_1.var_.characterEffect4037ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_102_1.time_ - 0) / var_105_3)
				end
			end

			if arg_102_1.time_ >= 0 + var_105_3 and arg_102_1.time_ < 0 + var_105_3 + arg_105_0 and not isNil(var_105_2) and arg_102_1.var_.characterEffect4037ui_story then
				arg_102_1.var_.characterEffect4037ui_story.fillFlat = true
				arg_102_1.var_.characterEffect4037ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_102_1.time_ and arg_102_1.time_ <= var_105_4 + arg_105_0 then
				...
				local var_105_6 = arg_102_1:GetWordFromCfg(322211025)
				...
				local var_105_9 = 24 <= 0 and var_105_5 or var_105_5 * (utf8.len(var_105_7) / 24)

				if (24 <= 0 and var_105_5 or var_105_5 * (utf8.len(var_105_7) / 24)) > 0 and var_105_5 < var_105_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211025", "story_v_out_322211.awb") ~= 0 then
					local var_105_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211025", "story_v_out_322211.awb") / 1000
					...
					if var_105_6.prefab_name ~= "" and arg_102_1.actors_[var_105_6.prefab_name] ~= nil then
						local var_105_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_102_1.actors_[var_105_6.prefab_name].transform, "story_v_out_322211", "322211025", "story_v_out_322211.awb")

						arg_102_1:RecordAudio("322211025", var_105_11)
						arg_102_1:RecordAudio("322211025", var_105_11)
					else
	...
	Play322211026 = function(arg_106_0, arg_106_1)
		...
		function arg_106_1.onSingleLineUpdate_(arg_109_0)
			...
			if 0 < arg_106_1.time_ and arg_106_1.time_ <= 0 + arg_109_0 then
				...
				local var_109_1 = arg_106_1:GetWordFromCfg(322211026)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211026", "story_v_out_322211.awb") ~= 0 then
					local var_109_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211026", "story_v_out_322211.awb") / 1000
					...
					if var_109_1.prefab_name ~= "" and arg_106_1.actors_[var_109_1.prefab_name] ~= nil then
						local var_109_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_106_1.actors_[var_109_1.prefab_name].transform, "story_v_out_322211", "322211026", "story_v_out_322211.awb")

						arg_106_1:RecordAudio("322211026", var_109_6)
						arg_106_1:RecordAudio("322211026", var_109_6)
					else
	...
	Play322211027 = function(arg_110_0, arg_110_1)
		...
		function arg_110_1.onSingleLineUpdate_(arg_113_0)
			if 0 < arg_110_1.time_ and arg_110_1.time_ <= 0 + arg_113_0 and not isNil(arg_110_1.actors_["4037ui_story"]) and arg_110_1.var_.characterEffect4037ui_story == nil then
				arg_110_1.var_.characterEffect4037ui_story = arg_110_1.actors_["4037ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_113_0 = 0.200000002980232

			if 0 <= arg_110_1.time_ and arg_110_1.time_ < 0 + var_113_0 and not isNil(arg_110_1.actors_["4037ui_story"]) then
				if arg_110_1.var_.characterEffect4037ui_story and not isNil(arg_110_1.actors_["4037ui_story"]) then
					arg_110_1.var_.characterEffect4037ui_story.fillFlat = false
				end
			end

			if arg_110_1.time_ >= 0 + var_113_0 and arg_110_1.time_ < 0 + var_113_0 + arg_113_0 and not isNil(arg_110_1.actors_["4037ui_story"]) and arg_110_1.var_.characterEffect4037ui_story then
				arg_110_1.var_.characterEffect4037ui_story.fillFlat = false
			end
			...
			if 0 < arg_110_1.time_ and arg_110_1.time_ <= var_113_4 + arg_113_0 then
				...
				arg_110_1.leftNameTxt_.text = arg_110_1:FormatText(StoryNameCfg[453].name)
				...
				local var_113_6 = arg_110_1:GetWordFromCfg(322211027)
				...
				local var_113_9 = 11 <= 0 and var_113_5 or var_113_5 * (utf8.len(var_113_7) / 11)

				if (11 <= 0 and var_113_5 or var_113_5 * (utf8.len(var_113_7) / 11)) > 0 and var_113_5 < var_113_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211027", "story_v_out_322211.awb") ~= 0 then
					local var_113_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211027", "story_v_out_322211.awb") / 1000
					...
					if var_113_6.prefab_name ~= "" and arg_110_1.actors_[var_113_6.prefab_name] ~= nil then
						local var_113_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_110_1.actors_[var_113_6.prefab_name].transform, "story_v_out_322211", "322211027", "story_v_out_322211.awb")

						arg_110_1:RecordAudio("322211027", var_113_11)
						arg_110_1:RecordAudio("322211027", var_113_11)
					else
	...
	Play322211028 = function(arg_114_0, arg_114_1)
		...
		function arg_114_1.onSingleLineUpdate_(arg_117_0)
			...
			local var_117_2 = arg_114_1.actors_["4037ui_story"]

			if 0 < arg_114_1.time_ and arg_114_1.time_ <= 0 + arg_117_0 and not isNil(var_117_2) and arg_114_1.var_.characterEffect4037ui_story == nil then
				arg_114_1.var_.characterEffect4037ui_story = var_117_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_117_3 = 0.200000002980232

			if 0 <= arg_114_1.time_ and arg_114_1.time_ < 0 + var_117_3 and not isNil(var_117_2) then
				if arg_114_1.var_.characterEffect4037ui_story and not isNil(var_117_2) then
					arg_114_1.var_.characterEffect4037ui_story.fillFlat = true
					arg_114_1.var_.characterEffect4037ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_114_1.time_ - 0) / var_117_3)
				end
			end

			if arg_114_1.time_ >= 0 + var_117_3 and arg_114_1.time_ < 0 + var_117_3 + arg_117_0 and not isNil(var_117_2) and arg_114_1.var_.characterEffect4037ui_story then
				arg_114_1.var_.characterEffect4037ui_story.fillFlat = true
				arg_114_1.var_.characterEffect4037ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_114_1.time_ and arg_114_1.time_ <= var_117_4 + arg_117_0 then
				...
				local var_117_6 = arg_114_1:GetWordFromCfg(322211028)
				...
				local var_117_9 = 17 <= 0 and var_117_5 or var_117_5 * (utf8.len(var_117_7) / 17)

				if (17 <= 0 and var_117_5 or var_117_5 * (utf8.len(var_117_7) / 17)) > 0 and var_117_5 < var_117_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211028", "story_v_out_322211.awb") ~= 0 then
					local var_117_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211028", "story_v_out_322211.awb") / 1000
					...
					if var_117_6.prefab_name ~= "" and arg_114_1.actors_[var_117_6.prefab_name] ~= nil then
						local var_117_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_114_1.actors_[var_117_6.prefab_name].transform, "story_v_out_322211", "322211028", "story_v_out_322211.awb")

						arg_114_1:RecordAudio("322211028", var_117_11)
						arg_114_1:RecordAudio("322211028", var_117_11)
					else
	...
	Play322211029 = function(arg_118_0, arg_118_1)
		...
		function arg_118_1.onSingleLineUpdate_(arg_121_0)
			if 0 < arg_118_1.time_ and arg_118_1.time_ <= 0 + arg_121_0 and not isNil(arg_118_1.actors_["4037ui_story"]) and arg_118_1.var_.characterEffect4037ui_story == nil then
				arg_118_1.var_.characterEffect4037ui_story = arg_118_1.actors_["4037ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_121_0 = 0.200000002980232

			if 0 <= arg_118_1.time_ and arg_118_1.time_ < 0 + var_121_0 and not isNil(arg_118_1.actors_["4037ui_story"]) then
				if arg_118_1.var_.characterEffect4037ui_story and not isNil(arg_118_1.actors_["4037ui_story"]) then
					arg_118_1.var_.characterEffect4037ui_story.fillFlat = false
				end
			end

			if arg_118_1.time_ >= 0 + var_121_0 and arg_118_1.time_ < 0 + var_121_0 + arg_121_0 and not isNil(arg_118_1.actors_["4037ui_story"]) and arg_118_1.var_.characterEffect4037ui_story then
				arg_118_1.var_.characterEffect4037ui_story.fillFlat = false
			end

			local var_121_2 = arg_118_1.actors_["1111ui_story"]

			if 0 < arg_118_1.time_ and arg_118_1.time_ <= 0 + arg_121_0 and not isNil(var_121_2) and arg_118_1.var_.characterEffect1111ui_story == nil then
				arg_118_1.var_.characterEffect1111ui_story = var_121_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_121_3 = 0.200000002980232

			if 0 <= arg_118_1.time_ and arg_118_1.time_ < 0 + var_121_3 and not isNil(var_121_2) then
				if arg_118_1.var_.characterEffect1111ui_story and not isNil(var_121_2) then
					arg_118_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_118_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_118_1.time_ - 0) / var_121_3)
				end
			end

			if arg_118_1.time_ >= 0 + var_121_3 and arg_118_1.time_ < 0 + var_121_3 + arg_121_0 and not isNil(var_121_2) and arg_118_1.var_.characterEffect1111ui_story then
				arg_118_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_118_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end

			local var_121_4 = 0
			local var_121_5 = 0.175
			...
			if 0 < arg_118_1.time_ and arg_118_1.time_ <= var_121_4 + arg_121_0 then
				...
				arg_118_1.leftNameTxt_.text = arg_118_1:FormatText(StoryNameCfg[453].name)
				...
				local var_121_6 = arg_118_1:GetWordFromCfg(322211029)
				...
				local var_121_9 = 7 <= 0 and var_121_5 or var_121_5 * (utf8.len(var_121_7) / 7)

				if (7 <= 0 and var_121_5 or var_121_5 * (utf8.len(var_121_7) / 7)) > 0 and var_121_5 < var_121_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211029", "story_v_out_322211.awb") ~= 0 then
					local var_121_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211029", "story_v_out_322211.awb") / 1000
					...
					if var_121_6.prefab_name ~= "" and arg_118_1.actors_[var_121_6.prefab_name] ~= nil then
						local var_121_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_118_1.actors_[var_121_6.prefab_name].transform, "story_v_out_322211", "322211029", "story_v_out_322211.awb")

						arg_118_1:RecordAudio("322211029", var_121_11)
						arg_118_1:RecordAudio("322211029", var_121_11)
					else
	...
	Play322211030 = function(arg_122_0, arg_122_1)
		...
		function arg_122_1.onSingleLineUpdate_(arg_125_0)
			...
			if 0 < arg_122_1.time_ and arg_122_1.time_ <= var_125_0 + arg_125_0 then
				...
				arg_122_1.leftNameTxt_.text = arg_122_1:FormatText(StoryNameCfg[453].name)
				...
				local var_125_2 = arg_122_1:GetWordFromCfg(322211030)
				...
				local var_125_5 = 8 <= 0 and var_125_1 or var_125_1 * (utf8.len(var_125_3) / 8)

				if (8 <= 0 and var_125_1 or var_125_1 * (utf8.len(var_125_3) / 8)) > 0 and var_125_1 < var_125_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211030", "story_v_out_322211.awb") ~= 0 then
					local var_125_6 = manager.audio:GetVoiceLength("story_v_out_322211", "322211030", "story_v_out_322211.awb") / 1000
					...
					if var_125_2.prefab_name ~= "" and arg_122_1.actors_[var_125_2.prefab_name] ~= nil then
						local var_125_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_122_1.actors_[var_125_2.prefab_name].transform, "story_v_out_322211", "322211030", "story_v_out_322211.awb")

						arg_122_1:RecordAudio("322211030", var_125_7)
						arg_122_1:RecordAudio("322211030", var_125_7)
					else
	...
	Play322211031 = function(arg_126_0, arg_126_1)
		...
		function arg_126_1.onSingleLineUpdate_(arg_129_0)
			...
			if 0 < arg_126_1.time_ and arg_126_1.time_ <= 0 + arg_129_0 then
				arg_126_1.var_.moveOldPos1111ui_story = arg_126_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_129_0 = 0.001

			if 0 <= arg_126_1.time_ and arg_126_1.time_ < 0 + var_129_0 then
				arg_126_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_126_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_126_1.time_ - 0) / var_129_0)
				arg_126_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_126_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_126_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_126_1.actors_["1111ui_story"].transform.position).z)
				arg_126_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_126_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_126_1.actors_["1111ui_story"].transform.localEulerAngles = arg_126_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_126_1.time_ >= 0 + var_129_0 and arg_126_1.time_ < 0 + var_129_0 + arg_129_0 then
				arg_126_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_126_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_126_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_126_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_126_1.actors_["1111ui_story"].transform.position).z)
				arg_126_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_126_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_126_1.actors_["1111ui_story"].transform.localEulerAngles = arg_126_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_129_1 = arg_126_1.actors_["4037ui_story"].transform

			if 0 < arg_126_1.time_ and arg_126_1.time_ <= 0 + arg_129_0 then
				arg_126_1.var_.moveOldPos4037ui_story = var_129_1.localPosition
			end

			local var_129_2 = 0.001

			if 0 <= arg_126_1.time_ and arg_126_1.time_ < 0 + var_129_2 then
				var_129_1.localPosition = Vector3.Lerp(arg_126_1.var_.moveOldPos4037ui_story, Vector3.New(0, 100, 0), (arg_126_1.time_ - 0) / var_129_2)
			...
			if 0 < arg_126_1.time_ and arg_126_1.time_ <= 0 + arg_129_0 then
				local var_129_3 = arg_126_1.var_.effect1031

				if not arg_126_1.var_.effect1031 then
					var_129_3 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit_blue"), manager.ui.mainCamera.transform)
					var_129_3.name = "1031"
					arg_126_1.var_.effect1031 = var_129_3
				else
					var_129_3.transform:SetParent(var_129_9001)
				end

				var_129_3.transform.localPosition = Vector3.New(0, 0.45, -5.83)
				var_129_3.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_129_5 = manager.ui.mainCamera.transform

			if 0 < arg_126_1.time_ and arg_126_1.time_ <= 0 + arg_129_0 then
				arg_126_1.var_.shakeOldPos = var_129_5.localPosition
			end

			local var_129_6 = 0.3

			if 0 <= arg_126_1.time_ and arg_126_1.time_ < 0 + var_129_6 then
				local var_129_7, var_129_8 = math.modf((arg_126_1.time_ - 0) / 0.066)

				var_129_5.localPosition = Vector3.New(var_129_8 * 0.13, var_129_8 * 0.13, var_129_8 * 0.13) + arg_126_1.var_.shakeOldPos
			end

			if arg_126_1.time_ >= 0 + var_129_6 and arg_126_1.time_ < 0 + var_129_6 + arg_129_0 then
				var_129_5.localPosition = arg_126_1.var_.shakeOldPos
			end

			if 0 < arg_126_1.time_ and arg_126_1.time_ <= 0 + arg_129_0 then
				arg_126_1:AudioAction("play", "effect", "se_story_122_02", "se_story_122_02_broken", "")
			end

			if 0.1 < arg_126_1.time_ and arg_126_1.time_ <= 0.1 + arg_129_0 then
				local var_129_10 = arg_126_1.var_.effect10311

				if not arg_126_1.var_.effect10311 then
					var_129_10 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_posui3"), manager.ui.mainCamera.transform)
					var_129_10.name = "10311"
					arg_126_1.var_.effect10311 = var_129_10
				else
					var_129_10.transform:SetParent(var_129_9000)
				end

				var_129_10.transform.localPosition = Vector3.New(0, 0, 1.49)
				var_129_10.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			if 3.16666666666667 < arg_126_1.time_ and arg_126_1.time_ <= 3.16666666666667 + arg_129_0 then
				if arg_126_1.var_.effect10311 then
					Object.Destroy(arg_126_1.var_.effect10311)
			...
			local var_129_14 = 0.166666666666667

			if var_129_13 <= arg_126_1.time_ and arg_126_1.time_ < var_129_13 + var_129_14 then
				local var_129_15 = Color.New(1, 1, 1)

				var_129_15.a = Mathf.Lerp(1, 0, (arg_126_1.time_ - var_129_13) / var_129_14)
				arg_126_1.mask_.color = var_129_15
			end

			if arg_126_1.time_ >= var_129_13 + var_129_14 and arg_126_1.time_ < var_129_13 + var_129_14 + arg_129_0 then
				local var_129_16 = Color.New(1, 1, 1)

				arg_126_1.mask_.enabled = false
				var_129_16.a = 0
				arg_126_1.mask_.color = var_129_16
			end
			...
			local var_129_17 = 0.521887199487537
			local var_129_18 = 1.725

			if 0.521887199487537 < arg_126_1.time_ and arg_126_1.time_ <= var_129_17 + arg_129_0 then
				...
				local var_129_19 = LeanTween.value(arg_126_1.dialog_, 0, 1, 0.3)

				var_129_19:setOnUpdate(LuaHelper.FloatAction(function(arg_130_0)
					arg_126_1.dialogCg_.alpha = arg_130_0
				end))
				var_129_19:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_126_1.dialog_)
					var_129_19:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_129_20 = arg_126_1:FormatText(arg_126_1:GetWordFromCfg(322211031).content)

				arg_126_1.text_.text = var_129_20

				LuaForUtil.ClearLinePrefixSymbol(arg_126_1.text_)

				local var_129_22 = 69 <= 0 and var_129_18 or var_129_18 * (utf8.len(var_129_20) / 69)

				if (69 <= 0 and var_129_18 or var_129_18 * (utf8.len(var_129_20) / 69)) > 0 and var_129_18 < var_129_22 then
					arg_126_1.talkMaxDuration = var_129_22
					var_129_17 = var_129_17 + 0.3

					if var_129_22 + var_129_17 > arg_126_1.duration_ then
						arg_126_1.duration_ = var_129_22 + var_129_17
					end
				end
			...
			local var_129_23 = var_129_17 + 0.3
			local var_129_24 = math.max(var_129_18, arg_126_1.talkMaxDuration)

			if var_129_17 + 0.3 <= arg_126_1.time_ and arg_126_1.time_ < var_129_23 + var_129_24 then
				arg_126_1.typewritter.percent = (arg_126_1.time_ - var_129_23) / var_129_24
	...
	Play322211032 = function(arg_132_0, arg_132_1)
		...
		function arg_132_1.onSingleLineUpdate_(arg_135_0)
			if 0 < arg_132_1.time_ and arg_132_1.time_ <= 0 + arg_135_0 then
				arg_132_1.var_.moveOldPos4037ui_story = arg_132_1.actors_["4037ui_story"].transform.localPosition
			end

			local var_135_0 = 0.001

			if 0 <= arg_132_1.time_ and arg_132_1.time_ < 0 + var_135_0 then
				arg_132_1.actors_["4037ui_story"].transform.localPosition = Vector3.Lerp(arg_132_1.var_.moveOldPos4037ui_story, Vector3.New(0, -1.12, -6.2), (arg_132_1.time_ - 0) / var_135_0)
				arg_132_1.actors_["4037ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_132_1.actors_["4037ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_132_1.actors_["4037ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_132_1.actors_["4037ui_story"].transform.position).z)
				arg_132_1.actors_["4037ui_story"].transform.localEulerAngles.z = 0
				arg_132_1.actors_["4037ui_story"].transform.localEulerAngles.x = 0
				arg_132_1.actors_["4037ui_story"].transform.localEulerAngles = arg_132_1.actors_["4037ui_story"].transform.localEulerAngles
			end

			if arg_132_1.time_ >= 0 + var_135_0 and arg_132_1.time_ < 0 + var_135_0 + arg_135_0 then
				arg_132_1.actors_["4037ui_story"].transform.localPosition = Vector3.New(0, -1.12, -6.2)
				arg_132_1.actors_["4037ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_132_1.actors_["4037ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_132_1.actors_["4037ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_132_1.actors_["4037ui_story"].transform.position).z)
				arg_132_1.actors_["4037ui_story"].transform.localEulerAngles.z = 0
				arg_132_1.actors_["4037ui_story"].transform.localEulerAngles.x = 0
				arg_132_1.actors_["4037ui_story"].transform.localEulerAngles = arg_132_1.actors_["4037ui_story"].transform.localEulerAngles
			...
			local var_135_1 = arg_132_1.actors_["4037ui_story"]

			if 0 < arg_132_1.time_ and arg_132_1.time_ <= 0 + arg_135_0 and not isNil(var_135_1) and arg_132_1.var_.characterEffect4037ui_story == nil then
				arg_132_1.var_.characterEffect4037ui_story = var_135_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_135_2 = 0.200000002980232

			if 0 <= arg_132_1.time_ and arg_132_1.time_ < 0 + var_135_2 and not isNil(var_135_1) then
				if arg_132_1.var_.characterEffect4037ui_story and not isNil(var_135_1) then
					arg_132_1.var_.characterEffect4037ui_story.fillFlat = false
				end
			end

			if arg_132_1.time_ >= 0 + var_135_2 and arg_132_1.time_ < 0 + var_135_2 + arg_135_0 and not isNil(var_135_1) and arg_132_1.var_.characterEffect4037ui_story then
				arg_132_1.var_.characterEffect4037ui_story.fillFlat = false
			end
			...
			if 0 < arg_132_1.time_ and arg_132_1.time_ <= 0 + arg_135_0 then
				if arg_132_1.var_.effect1031 then
					Object.Destroy(arg_132_1.var_.effect1031)
			...
			if 0 < arg_132_1.time_ and arg_132_1.time_ <= var_135_5 + arg_135_0 then
				...
				local var_135_7 = arg_132_1:GetWordFromCfg(322211032)
				...
				local var_135_10 = 7 <= 0 and var_135_6 or var_135_6 * (utf8.len(var_135_8) / 7)

				if (7 <= 0 and var_135_6 or var_135_6 * (utf8.len(var_135_8) / 7)) > 0 and var_135_6 < var_135_10 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211032", "story_v_out_322211.awb") ~= 0 then
					local var_135_11 = manager.audio:GetVoiceLength("story_v_out_322211", "322211032", "story_v_out_322211.awb") / 1000
					...
					if var_135_7.prefab_name ~= "" and arg_132_1.actors_[var_135_7.prefab_name] ~= nil then
						local var_135_12 = LuaForUtil.PlayVoiceWithCriLipsync(arg_132_1.actors_[var_135_7.prefab_name].transform, "story_v_out_322211", "322211032", "story_v_out_322211.awb")

						arg_132_1:RecordAudio("322211032", var_135_12)
						arg_132_1:RecordAudio("322211032", var_135_12)
					else
	...
	Play322211033 = function(arg_136_0, arg_136_1)
		...
		function arg_136_1.onSingleLineUpdate_(arg_139_0)
			if 0 < arg_136_1.time_ and arg_136_1.time_ <= 0 + arg_139_0 then
				arg_136_1.var_.moveOldPos1111ui_story = arg_136_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_139_0 = 0.001

			if 0 <= arg_136_1.time_ and arg_136_1.time_ < 0 + var_139_0 then
				arg_136_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_136_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_136_1.time_ - 0) / var_139_0)
				arg_136_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_136_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_136_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_136_1.actors_["1111ui_story"].transform.position).z)
				arg_136_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_136_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_136_1.actors_["1111ui_story"].transform.localEulerAngles = arg_136_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_136_1.time_ >= 0 + var_139_0 and arg_136_1.time_ < 0 + var_139_0 + arg_139_0 then
				arg_136_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, -0.87, -5.7)
				arg_136_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_136_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_136_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_136_1.actors_["1111ui_story"].transform.position).z)
				arg_136_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_136_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_136_1.actors_["1111ui_story"].transform.localEulerAngles = arg_136_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_139_1 = arg_136_1.actors_["1111ui_story"]

			if 0 < arg_136_1.time_ and arg_136_1.time_ <= 0 + arg_139_0 and not isNil(var_139_1) and arg_136_1.var_.characterEffect1111ui_story == nil then
				arg_136_1.var_.characterEffect1111ui_story = var_139_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_139_2 = 0.200000002980232

			if 0 <= arg_136_1.time_ and arg_136_1.time_ < 0 + var_139_2 and not isNil(var_139_1) then
				if arg_136_1.var_.characterEffect1111ui_story and not isNil(var_139_1) then
					arg_136_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_136_1.time_ >= 0 + var_139_2 and arg_136_1.time_ < 0 + var_139_2 + arg_139_0 and not isNil(var_139_1) and arg_136_1.var_.characterEffect1111ui_story then
				arg_136_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_139_4 = arg_136_1.actors_["4037ui_story"]

			if 0 < arg_136_1.time_ and arg_136_1.time_ <= 0 + arg_139_0 and not isNil(var_139_4) and arg_136_1.var_.characterEffect4037ui_story == nil then
				arg_136_1.var_.characterEffect4037ui_story = var_139_4:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_139_5 = 0.200000002980232

			if 0 <= arg_136_1.time_ and arg_136_1.time_ < 0 + var_139_5 and not isNil(var_139_4) then
				if arg_136_1.var_.characterEffect4037ui_story and not isNil(var_139_4) then
					arg_136_1.var_.characterEffect4037ui_story.fillFlat = true
					arg_136_1.var_.characterEffect4037ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_136_1.time_ - 0) / var_139_5)
				end
			end

			if arg_136_1.time_ >= 0 + var_139_5 and arg_136_1.time_ < 0 + var_139_5 + arg_139_0 and not isNil(var_139_4) and arg_136_1.var_.characterEffect4037ui_story then
				arg_136_1.var_.characterEffect4037ui_story.fillFlat = true
			...
			local var_139_6 = arg_136_1.actors_["4037ui_story"].transform

			if 0 < arg_136_1.time_ and arg_136_1.time_ <= 0 + arg_139_0 then
				arg_136_1.var_.moveOldPos4037ui_story = var_139_6.localPosition
			end

			local var_139_7 = 0.001

			if 0 <= arg_136_1.time_ and arg_136_1.time_ < 0 + var_139_7 then
				var_139_6.localPosition = Vector3.Lerp(arg_136_1.var_.moveOldPos4037ui_story, Vector3.New(0, 100, 0), (arg_136_1.time_ - 0) / var_139_7)
			...
			if 0 < arg_136_1.time_ and arg_136_1.time_ <= var_139_8 + arg_139_0 then
				...
				local var_139_10 = arg_136_1:GetWordFromCfg(322211033)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211033", "story_v_out_322211.awb") ~= 0 then
					local var_139_14 = manager.audio:GetVoiceLength("story_v_out_322211", "322211033", "story_v_out_322211.awb") / 1000
					...
					if var_139_10.prefab_name ~= "" and arg_136_1.actors_[var_139_10.prefab_name] ~= nil then
						local var_139_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_136_1.actors_[var_139_10.prefab_name].transform, "story_v_out_322211", "322211033", "story_v_out_322211.awb")

						arg_136_1:RecordAudio("322211033", var_139_15)
						arg_136_1:RecordAudio("322211033", var_139_15)
					else
	...
	Play322211034 = function(arg_140_0, arg_140_1)
		...
		function arg_140_1.onSingleLineUpdate_(arg_143_0)
			if 0 < arg_140_1.time_ and arg_140_1.time_ <= 0 + arg_143_0 then
				arg_140_1.var_.moveOldPos1111ui_story = arg_140_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_143_0 = 0.001

			if 0 <= arg_140_1.time_ and arg_140_1.time_ < 0 + var_143_0 then
				arg_140_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_140_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_140_1.time_ - 0) / var_143_0)
				arg_140_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_140_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_140_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_140_1.actors_["1111ui_story"].transform.position).z)
				arg_140_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_140_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_140_1.actors_["1111ui_story"].transform.localEulerAngles = arg_140_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_140_1.time_ >= 0 + var_143_0 and arg_140_1.time_ < 0 + var_143_0 + arg_143_0 then
				arg_140_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_140_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_140_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_140_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_140_1.actors_["1111ui_story"].transform.position).z)
				arg_140_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_140_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_140_1.actors_["1111ui_story"].transform.localEulerAngles = arg_140_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			if 0 < arg_140_1.time_ and arg_140_1.time_ <= var_143_1 + arg_143_0 then
				...
				local var_143_3 = arg_140_1:FormatText(arg_140_1:GetWordFromCfg(322211034).content)

				arg_140_1.text_.text = var_143_3

				LuaForUtil.ClearLinePrefixSymbol(arg_140_1.text_)

				local var_143_5 = 50 <= 0 and var_143_2 or var_143_2 * (utf8.len(var_143_3) / 50)

				if (50 <= 0 and var_143_2 or var_143_2 * (utf8.len(var_143_3) / 50)) > 0 and var_143_2 < var_143_5 then
	...
	Play322211035 = function(arg_144_0, arg_144_1)
		...
		function arg_144_1.onSingleLineUpdate_(arg_147_0)
			if 0 < arg_144_1.time_ and arg_144_1.time_ <= 0 + arg_147_0 then
				arg_144_1.var_.moveOldPos1111ui_story = arg_144_1.actors_["1111ui_story"].transform.localPosition
			end

			local var_147_0 = 0.001

			if 0 <= arg_144_1.time_ and arg_144_1.time_ < 0 + var_147_0 then
				arg_144_1.actors_["1111ui_story"].transform.localPosition = Vector3.Lerp(arg_144_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_144_1.time_ - 0) / var_147_0)
				arg_144_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_144_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_144_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_144_1.actors_["1111ui_story"].transform.position).z)
				arg_144_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_144_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_144_1.actors_["1111ui_story"].transform.localEulerAngles = arg_144_1.actors_["1111ui_story"].transform.localEulerAngles
			end

			if arg_144_1.time_ >= 0 + var_147_0 and arg_144_1.time_ < 0 + var_147_0 + arg_147_0 then
				arg_144_1.actors_["1111ui_story"].transform.localPosition = Vector3.New(0, -0.87, -5.7)
				arg_144_1.actors_["1111ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_144_1.actors_["1111ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_144_1.actors_["1111ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_144_1.actors_["1111ui_story"].transform.position).z)
				arg_144_1.actors_["1111ui_story"].transform.localEulerAngles.z = 0
				arg_144_1.actors_["1111ui_story"].transform.localEulerAngles.x = 0
				arg_144_1.actors_["1111ui_story"].transform.localEulerAngles = arg_144_1.actors_["1111ui_story"].transform.localEulerAngles
			...
			local var_147_1 = arg_144_1.actors_["1111ui_story"]

			if 0 < arg_144_1.time_ and arg_144_1.time_ <= 0 + arg_147_0 and not isNil(var_147_1) and arg_144_1.var_.characterEffect1111ui_story == nil then
				arg_144_1.var_.characterEffect1111ui_story = var_147_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_147_2 = 0.200000002980232

			if 0 <= arg_144_1.time_ and arg_144_1.time_ < 0 + var_147_2 and not isNil(var_147_1) then
				if arg_144_1.var_.characterEffect1111ui_story and not isNil(var_147_1) then
					arg_144_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_144_1.time_ >= 0 + var_147_2 and arg_144_1.time_ < 0 + var_147_2 + arg_147_0 and not isNil(var_147_1) and arg_144_1.var_.characterEffect1111ui_story then
				arg_144_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if 0 < arg_144_1.time_ and arg_144_1.time_ <= 0 + arg_147_0 then
				...
				local var_147_6 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_144_1.bgmTxt_.text ~= var_147_6 and arg_144_1.bgmTxt_.text ~= "" then
						if arg_144_1.bgmTxt2_.text ~= "" then
							arg_144_1.bgmTxt_.text = arg_144_1.bgmTxt2_.text
						end

						arg_144_1.bgmTxt2_.text = var_147_6

						arg_144_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_144_1.bgmTxt_.text = var_147_6
						arg_144_1.bgmTxt2_.text = var_147_6
					end
			...
			if 0 < arg_144_1.time_ and arg_144_1.time_ <= var_147_7 + arg_147_0 then
				...
				arg_144_1.leftNameTxt_.text = arg_144_1:FormatText(StoryNameCfg[67].name)
				...
				local var_147_9 = arg_144_1:GetWordFromCfg(322211035)
				...
				local var_147_12 = 14 <= 0 and var_147_8 or var_147_8 * (utf8.len(var_147_10) / 14)

				if (14 <= 0 and var_147_8 or var_147_8 * (utf8.len(var_147_10) / 14)) > 0 and var_147_8 < var_147_12 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211035", "story_v_out_322211.awb") ~= 0 then
					local var_147_13 = manager.audio:GetVoiceLength("story_v_out_322211", "322211035", "story_v_out_322211.awb") / 1000
					...
					if var_147_9.prefab_name ~= "" and arg_144_1.actors_[var_147_9.prefab_name] ~= nil then
						local var_147_14 = LuaForUtil.PlayVoiceWithCriLipsync(arg_144_1.actors_[var_147_9.prefab_name].transform, "story_v_out_322211", "322211035", "story_v_out_322211.awb")

						arg_144_1:RecordAudio("322211035", var_147_14)
						arg_144_1:RecordAudio("322211035", var_147_14)
					else
	...
	Play322211036 = function(arg_149_0, arg_149_1)
		...
		function arg_149_1.onSingleLineUpdate_(arg_152_0)
			...
			local var_152_1 = arg_149_1.actors_["10131ui_story"].transform

			if 0 < arg_149_1.time_ and arg_149_1.time_ <= 0 + arg_152_0 then
				arg_149_1.var_.moveOldPos10131ui_story = var_152_1.localPosition
			end

			local var_152_2 = 0.001

			if 0 <= arg_149_1.time_ and arg_149_1.time_ < 0 + var_152_2 then
				var_152_1.localPosition = Vector3.Lerp(arg_149_1.var_.moveOldPos10131ui_story, Vector3.New(0.83, -0.96, -5.8), (arg_149_1.time_ - 0) / var_152_2)
			...
			if arg_149_1.time_ >= 0 + var_152_2 and arg_149_1.time_ < 0 + var_152_2 + arg_152_0 then
				var_152_1.localPosition = Vector3.New(0.83, -0.96, -5.8)
				var_152_1.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_152_1.position).x, (manager.ui.mainCamera.transform.position - var_152_1.position).y, (manager.ui.mainCamera.transform.position - var_152_1.position).z)
				var_152_1.localEulerAngles.z = 0
				var_152_1.localEulerAngles.x = 0
				var_152_1.localEulerAngles = var_152_1.localEulerAngles
			...
			local var_152_3 = arg_149_1.actors_["10131ui_story"]

			if 0 < arg_149_1.time_ and arg_149_1.time_ <= 0 + arg_152_0 and not isNil(var_152_3) and arg_149_1.var_.characterEffect10131ui_story == nil then
				arg_149_1.var_.characterEffect10131ui_story = var_152_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_152_4 = 0.200000002980232

			if 0 <= arg_149_1.time_ and arg_149_1.time_ < 0 + var_152_4 and not isNil(var_152_3) then
				if arg_149_1.var_.characterEffect10131ui_story and not isNil(var_152_3) then
					arg_149_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_149_1.time_ >= 0 + var_152_4 and arg_149_1.time_ < 0 + var_152_4 + arg_152_0 and not isNil(var_152_3) and arg_149_1.var_.characterEffect10131ui_story then
				arg_149_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_152_6 = arg_149_1.actors_["1111ui_story"]

			if 0 < arg_149_1.time_ and arg_149_1.time_ <= 0 + arg_152_0 and not isNil(var_152_6) and arg_149_1.var_.characterEffect1111ui_story == nil then
				arg_149_1.var_.characterEffect1111ui_story = var_152_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_152_7 = 0.200000002980232

			if 0 <= arg_149_1.time_ and arg_149_1.time_ < 0 + var_152_7 and not isNil(var_152_6) then
				if arg_149_1.var_.characterEffect1111ui_story and not isNil(var_152_6) then
					arg_149_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_149_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_149_1.time_ - 0) / var_152_7)
				end
			end

			if arg_149_1.time_ >= 0 + var_152_7 and arg_149_1.time_ < 0 + var_152_7 + arg_152_0 and not isNil(var_152_6) and arg_149_1.var_.characterEffect1111ui_story then
				arg_149_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_149_1.time_ and arg_149_1.time_ <= var_152_8 + arg_152_0 then
				...
				local var_152_10 = arg_149_1:GetWordFromCfg(322211036)
				...
				local var_152_13 = 46 <= 0 and var_152_9 or var_152_9 * (utf8.len(var_152_11) / 46)

				if (46 <= 0 and var_152_9 or var_152_9 * (utf8.len(var_152_11) / 46)) > 0 and var_152_9 < var_152_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211036", "story_v_out_322211.awb") ~= 0 then
					local var_152_14 = manager.audio:GetVoiceLength("story_v_out_322211", "322211036", "story_v_out_322211.awb") / 1000
					...
					if var_152_10.prefab_name ~= "" and arg_149_1.actors_[var_152_10.prefab_name] ~= nil then
						local var_152_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_149_1.actors_[var_152_10.prefab_name].transform, "story_v_out_322211", "322211036", "story_v_out_322211.awb")

						arg_149_1:RecordAudio("322211036", var_152_15)
						arg_149_1:RecordAudio("322211036", var_152_15)
					else
	...
	Play322211037 = function(arg_153_0, arg_153_1)
		...
		function arg_153_1.onSingleLineUpdate_(arg_156_0)
			...
			if 0 < arg_153_1.time_ and arg_153_1.time_ <= var_156_4 + arg_156_0 then
				...
				local var_156_6 = arg_153_1:GetWordFromCfg(322211037)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211037", "story_v_out_322211.awb") ~= 0 then
					local var_156_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211037", "story_v_out_322211.awb") / 1000
					...
					if var_156_6.prefab_name ~= "" and arg_153_1.actors_[var_156_6.prefab_name] ~= nil then
						local var_156_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_153_1.actors_[var_156_6.prefab_name].transform, "story_v_out_322211", "322211037", "story_v_out_322211.awb")

						arg_153_1:RecordAudio("322211037", var_156_11)
						arg_153_1:RecordAudio("322211037", var_156_11)
					else
	...
	Play322211038 = function(arg_157_0, arg_157_1)
		...
		function arg_157_1.onSingleLineUpdate_(arg_160_0)
			if 0 < arg_157_1.time_ and arg_157_1.time_ <= 0 + arg_160_0 and not isNil(arg_157_1.actors_["10131ui_story"]) and arg_157_1.var_.characterEffect10131ui_story == nil then
				arg_157_1.var_.characterEffect10131ui_story = arg_157_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_160_0 = 0.200000002980232

			if 0 <= arg_157_1.time_ and arg_157_1.time_ < 0 + var_160_0 and not isNil(arg_157_1.actors_["10131ui_story"]) then
				if arg_157_1.var_.characterEffect10131ui_story and not isNil(arg_157_1.actors_["10131ui_story"]) then
					arg_157_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_157_1.time_ >= 0 + var_160_0 and arg_157_1.time_ < 0 + var_160_0 + arg_160_0 and not isNil(arg_157_1.actors_["10131ui_story"]) and arg_157_1.var_.characterEffect10131ui_story then
				arg_157_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_160_2 = arg_157_1.actors_["1111ui_story"]

			if 0 < arg_157_1.time_ and arg_157_1.time_ <= 0 + arg_160_0 and not isNil(var_160_2) and arg_157_1.var_.characterEffect1111ui_story == nil then
				arg_157_1.var_.characterEffect1111ui_story = var_160_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_160_3 = 0.200000002980232

			if 0 <= arg_157_1.time_ and arg_157_1.time_ < 0 + var_160_3 and not isNil(var_160_2) then
				if arg_157_1.var_.characterEffect1111ui_story and not isNil(var_160_2) then
					arg_157_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_157_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_157_1.time_ - 0) / var_160_3)
				end
			end

			if arg_157_1.time_ >= 0 + var_160_3 and arg_157_1.time_ < 0 + var_160_3 + arg_160_0 and not isNil(var_160_2) and arg_157_1.var_.characterEffect1111ui_story then
				arg_157_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_157_1.time_ and arg_157_1.time_ <= var_160_4 + arg_160_0 then
				...
				local var_160_6 = arg_157_1:GetWordFromCfg(322211038)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211038", "story_v_out_322211.awb") ~= 0 then
					local var_160_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211038", "story_v_out_322211.awb") / 1000
					...
					if var_160_6.prefab_name ~= "" and arg_157_1.actors_[var_160_6.prefab_name] ~= nil then
						local var_160_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_157_1.actors_[var_160_6.prefab_name].transform, "story_v_out_322211", "322211038", "story_v_out_322211.awb")

						arg_157_1:RecordAudio("322211038", var_160_11)
						arg_157_1:RecordAudio("322211038", var_160_11)
					else
	...
	Play322211039 = function(arg_161_0, arg_161_1)
		...
		function arg_161_1.onSingleLineUpdate_(arg_164_0)
			if 0 < arg_161_1.time_ and arg_161_1.time_ <= 0 + arg_164_0 and not isNil(arg_161_1.actors_["1111ui_story"]) and arg_161_1.var_.characterEffect1111ui_story == nil then
				arg_161_1.var_.characterEffect1111ui_story = arg_161_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_164_0 = 0.200000002980232

			if 0 <= arg_161_1.time_ and arg_161_1.time_ < 0 + var_164_0 and not isNil(arg_161_1.actors_["1111ui_story"]) then
				if arg_161_1.var_.characterEffect1111ui_story and not isNil(arg_161_1.actors_["1111ui_story"]) then
					arg_161_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_161_1.time_ >= 0 + var_164_0 and arg_161_1.time_ < 0 + var_164_0 + arg_164_0 and not isNil(arg_161_1.actors_["1111ui_story"]) and arg_161_1.var_.characterEffect1111ui_story then
				arg_161_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_164_2 = arg_161_1.actors_["10131ui_story"]

			if 0 < arg_161_1.time_ and arg_161_1.time_ <= 0 + arg_164_0 and not isNil(var_164_2) and arg_161_1.var_.characterEffect10131ui_story == nil then
				arg_161_1.var_.characterEffect10131ui_story = var_164_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_164_3 = 0.200000002980232

			if 0 <= arg_161_1.time_ and arg_161_1.time_ < 0 + var_164_3 and not isNil(var_164_2) then
				if arg_161_1.var_.characterEffect10131ui_story and not isNil(var_164_2) then
					arg_161_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_161_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_161_1.time_ - 0) / var_164_3)
				end
			end

			if arg_161_1.time_ >= 0 + var_164_3 and arg_161_1.time_ < 0 + var_164_3 + arg_164_0 and not isNil(var_164_2) and arg_161_1.var_.characterEffect10131ui_story then
				arg_161_1.var_.characterEffect10131ui_story.fillFlat = true
			...
			if 0 < arg_161_1.time_ and arg_161_1.time_ <= var_164_4 + arg_164_0 then
				...
				local var_164_6 = arg_161_1:GetWordFromCfg(322211039)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211039", "story_v_out_322211.awb") ~= 0 then
					local var_164_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211039", "story_v_out_322211.awb") / 1000
					...
					if var_164_6.prefab_name ~= "" and arg_161_1.actors_[var_164_6.prefab_name] ~= nil then
						local var_164_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_161_1.actors_[var_164_6.prefab_name].transform, "story_v_out_322211", "322211039", "story_v_out_322211.awb")

						arg_161_1:RecordAudio("322211039", var_164_11)
						arg_161_1:RecordAudio("322211039", var_164_11)
					else
	...
	Play322211040 = function(arg_165_0, arg_165_1)
		...
		function arg_165_1.onSingleLineUpdate_(arg_168_0)
			...
			if 0 < arg_165_1.time_ and arg_165_1.time_ <= var_168_0 + arg_168_0 then
				...
				local var_168_2 = arg_165_1:GetWordFromCfg(322211040)
				...
				local var_168_5 = 17 <= 0 and var_168_1 or var_168_1 * (utf8.len(var_168_3) / 17)

				if (17 <= 0 and var_168_1 or var_168_1 * (utf8.len(var_168_3) / 17)) > 0 and var_168_1 < var_168_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211040", "story_v_out_322211.awb") ~= 0 then
					local var_168_6 = manager.audio:GetVoiceLength("story_v_out_322211", "322211040", "story_v_out_322211.awb") / 1000
					...
					if var_168_2.prefab_name ~= "" and arg_165_1.actors_[var_168_2.prefab_name] ~= nil then
						local var_168_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_165_1.actors_[var_168_2.prefab_name].transform, "story_v_out_322211", "322211040", "story_v_out_322211.awb")

						arg_165_1:RecordAudio("322211040", var_168_7)
						arg_165_1:RecordAudio("322211040", var_168_7)
					else
	...
	Play322211041 = function(arg_169_0, arg_169_1)
		...
		function arg_169_1.onSingleLineUpdate_(arg_172_0)
			...
			local var_172_2 = arg_169_1.actors_["1111ui_story"]

			if 0 < arg_169_1.time_ and arg_169_1.time_ <= 0 + arg_172_0 and not isNil(var_172_2) and arg_169_1.var_.characterEffect1111ui_story == nil then
				arg_169_1.var_.characterEffect1111ui_story = var_172_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_172_3 = 0.200000002980232

			if 0 <= arg_169_1.time_ and arg_169_1.time_ < 0 + var_172_3 and not isNil(var_172_2) then
				if arg_169_1.var_.characterEffect1111ui_story and not isNil(var_172_2) then
					arg_169_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_169_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_169_1.time_ - 0) / var_172_3)
				end
			end

			if arg_169_1.time_ >= 0 + var_172_3 and arg_169_1.time_ < 0 + var_172_3 + arg_172_0 and not isNil(var_172_2) and arg_169_1.var_.characterEffect1111ui_story then
				arg_169_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_169_1.time_ and arg_169_1.time_ <= var_172_4 + arg_172_0 then
				...
				local var_172_6 = arg_169_1:GetWordFromCfg(322211041)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211041", "story_v_out_322211.awb") ~= 0 then
					local var_172_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211041", "story_v_out_322211.awb") / 1000
					...
					if var_172_6.prefab_name ~= "" and arg_169_1.actors_[var_172_6.prefab_name] ~= nil then
						local var_172_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_169_1.actors_[var_172_6.prefab_name].transform, "story_v_out_322211", "322211041", "story_v_out_322211.awb")

						arg_169_1:RecordAudio("322211041", var_172_11)
						arg_169_1:RecordAudio("322211041", var_172_11)
					else
	...
	Play322211042 = function(arg_173_0, arg_173_1)
		...
		function arg_173_1.onSingleLineUpdate_(arg_176_0)
			...
			if 0 < arg_173_1.time_ and arg_173_1.time_ <= var_176_4 + arg_176_0 then
				...
				local var_176_6 = arg_173_1:GetWordFromCfg(322211042)
				...
				local var_176_9 = 18 <= 0 and var_176_5 or var_176_5 * (utf8.len(var_176_7) / 18)

				if (18 <= 0 and var_176_5 or var_176_5 * (utf8.len(var_176_7) / 18)) > 0 and var_176_5 < var_176_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211042", "story_v_out_322211.awb") ~= 0 then
					local var_176_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211042", "story_v_out_322211.awb") / 1000
					...
					if var_176_6.prefab_name ~= "" and arg_173_1.actors_[var_176_6.prefab_name] ~= nil then
						local var_176_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_173_1.actors_[var_176_6.prefab_name].transform, "story_v_out_322211", "322211042", "story_v_out_322211.awb")

						arg_173_1:RecordAudio("322211042", var_176_11)
						arg_173_1:RecordAudio("322211042", var_176_11)
					else
	...
	Play322211043 = function(arg_177_0, arg_177_1)
		...
		function arg_177_1.onSingleLineUpdate_(arg_180_0)
			...
			if 0 < arg_177_1.time_ and arg_177_1.time_ <= 0 + arg_180_0 then
				...
				local var_180_1 = arg_177_1:GetWordFromCfg(322211043)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211043", "story_v_out_322211.awb") ~= 0 then
					local var_180_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211043", "story_v_out_322211.awb") / 1000
					...
					if var_180_1.prefab_name ~= "" and arg_177_1.actors_[var_180_1.prefab_name] ~= nil then
						local var_180_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_177_1.actors_[var_180_1.prefab_name].transform, "story_v_out_322211", "322211043", "story_v_out_322211.awb")

						arg_177_1:RecordAudio("322211043", var_180_6)
						arg_177_1:RecordAudio("322211043", var_180_6)
					else
	...
	Play322211044 = function(arg_181_0, arg_181_1)
		...
		function arg_181_1.onSingleLineUpdate_(arg_184_0)
			...
			local var_184_2 = arg_181_1.actors_["1111ui_story"]

			if 0 < arg_181_1.time_ and arg_181_1.time_ <= 0 + arg_184_0 and not isNil(var_184_2) and arg_181_1.var_.characterEffect1111ui_story == nil then
				arg_181_1.var_.characterEffect1111ui_story = var_184_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_184_3 = 0.200000002980232

			if 0 <= arg_181_1.time_ and arg_181_1.time_ < 0 + var_184_3 and not isNil(var_184_2) then
				if arg_181_1.var_.characterEffect1111ui_story and not isNil(var_184_2) then
					arg_181_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_181_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_181_1.time_ - 0) / var_184_3)
				end
			end

			if arg_181_1.time_ >= 0 + var_184_3 and arg_181_1.time_ < 0 + var_184_3 + arg_184_0 and not isNil(var_184_2) and arg_181_1.var_.characterEffect1111ui_story then
				arg_181_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_181_1.time_ and arg_181_1.time_ <= 0 + arg_184_0 then
				...
				local var_184_6 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_181_1.bgmTxt_.text ~= var_184_6 and arg_181_1.bgmTxt_.text ~= "" then
						if arg_181_1.bgmTxt2_.text ~= "" then
							arg_181_1.bgmTxt_.text = arg_181_1.bgmTxt2_.text
						end

						arg_181_1.bgmTxt2_.text = var_184_6

						arg_181_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_181_1.bgmTxt_.text = var_184_6
						arg_181_1.bgmTxt2_.text = var_184_6
					end
			...
			if 0.466666666666667 < arg_181_1.time_ and arg_181_1.time_ <= 0.466666666666667 + arg_184_0 then
				arg_181_1:AudioAction("play", "music", "bgm_activity_4_5_story_ra_piano", "bgm_activity_4_5_story_ra_piano", "bgm_activity_4_5_story_ra_piano.awb")

				local var_184_9 = manager.audio:GetAudioName("bgm_activity_4_5_story_ra_piano", "bgm_activity_4_5_story_ra_piano")

				if "" ~= "" then
					if arg_181_1.bgmTxt_.text ~= var_184_9 and arg_181_1.bgmTxt_.text ~= "" then
						if arg_181_1.bgmTxt2_.text ~= "" then
							arg_181_1.bgmTxt_.text = arg_181_1.bgmTxt2_.text
						end

						arg_181_1.bgmTxt2_.text = var_184_9

						arg_181_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_181_1.bgmTxt_.text = var_184_9
						arg_181_1.bgmTxt2_.text = var_184_9
					end
			...
			if 0 < arg_181_1.time_ and arg_181_1.time_ <= var_184_10 + arg_184_0 then
				...
				local var_184_12 = arg_181_1:GetWordFromCfg(322211044)
				...
				local var_184_15 = 20 <= 0 and var_184_11 or var_184_11 * (utf8.len(var_184_13) / 20)

				if (20 <= 0 and var_184_11 or var_184_11 * (utf8.len(var_184_13) / 20)) > 0 and var_184_11 < var_184_15 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211044", "story_v_out_322211.awb") ~= 0 then
					local var_184_16 = manager.audio:GetVoiceLength("story_v_out_322211", "322211044", "story_v_out_322211.awb") / 1000
					...
					if var_184_12.prefab_name ~= "" and arg_181_1.actors_[var_184_12.prefab_name] ~= nil then
						local var_184_17 = LuaForUtil.PlayVoiceWithCriLipsync(arg_181_1.actors_[var_184_12.prefab_name].transform, "story_v_out_322211", "322211044", "story_v_out_322211.awb")

						arg_181_1:RecordAudio("322211044", var_184_17)
						arg_181_1:RecordAudio("322211044", var_184_17)
					else
	...
	Play322211045 = function(arg_187_0, arg_187_1)
		...
		function arg_187_1.onSingleLineUpdate_(arg_190_0)
			if 0 < arg_187_1.time_ and arg_187_1.time_ <= 0 + arg_190_0 and not isNil(arg_187_1.actors_["1111ui_story"]) and arg_187_1.var_.characterEffect1111ui_story == nil then
				arg_187_1.var_.characterEffect1111ui_story = arg_187_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_190_0 = 0.200000002980232

			if 0 <= arg_187_1.time_ and arg_187_1.time_ < 0 + var_190_0 and not isNil(arg_187_1.actors_["1111ui_story"]) then
				if arg_187_1.var_.characterEffect1111ui_story and not isNil(arg_187_1.actors_["1111ui_story"]) then
					arg_187_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_187_1.time_ >= 0 + var_190_0 and arg_187_1.time_ < 0 + var_190_0 + arg_190_0 and not isNil(arg_187_1.actors_["1111ui_story"]) and arg_187_1.var_.characterEffect1111ui_story then
				arg_187_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_190_2 = arg_187_1.actors_["10131ui_story"]

			if 0 < arg_187_1.time_ and arg_187_1.time_ <= 0 + arg_190_0 and not isNil(var_190_2) and arg_187_1.var_.characterEffect10131ui_story == nil then
				arg_187_1.var_.characterEffect10131ui_story = var_190_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_190_3 = 0.200000002980232

			if 0 <= arg_187_1.time_ and arg_187_1.time_ < 0 + var_190_3 and not isNil(var_190_2) then
				if arg_187_1.var_.characterEffect10131ui_story and not isNil(var_190_2) then
					arg_187_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_187_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_187_1.time_ - 0) / var_190_3)
				end
			end

			if arg_187_1.time_ >= 0 + var_190_3 and arg_187_1.time_ < 0 + var_190_3 + arg_190_0 and not isNil(var_190_2) and arg_187_1.var_.characterEffect10131ui_story then
				arg_187_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_187_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_187_1.time_ and arg_187_1.time_ <= var_190_4 + arg_190_0 then
				...
				local var_190_6 = arg_187_1:GetWordFromCfg(322211045)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211045", "story_v_out_322211.awb") ~= 0 then
					local var_190_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211045", "story_v_out_322211.awb") / 1000
					...
					if var_190_6.prefab_name ~= "" and arg_187_1.actors_[var_190_6.prefab_name] ~= nil then
						local var_190_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_187_1.actors_[var_190_6.prefab_name].transform, "story_v_out_322211", "322211045", "story_v_out_322211.awb")

						arg_187_1:RecordAudio("322211045", var_190_11)
						arg_187_1:RecordAudio("322211045", var_190_11)
					else
	...
	Play322211046 = function(arg_191_0, arg_191_1)
		...
		function arg_191_1.onSingleLineUpdate_(arg_194_0)
			if 0 < arg_191_1.time_ and arg_191_1.time_ <= 0 + arg_194_0 and not isNil(arg_191_1.actors_["10131ui_story"]) and arg_191_1.var_.characterEffect10131ui_story == nil then
				arg_191_1.var_.characterEffect10131ui_story = arg_191_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_194_0 = 0.200000002980232

			if 0 <= arg_191_1.time_ and arg_191_1.time_ < 0 + var_194_0 and not isNil(arg_191_1.actors_["10131ui_story"]) then
				if arg_191_1.var_.characterEffect10131ui_story and not isNil(arg_191_1.actors_["10131ui_story"]) then
					arg_191_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_191_1.time_ >= 0 + var_194_0 and arg_191_1.time_ < 0 + var_194_0 + arg_194_0 and not isNil(arg_191_1.actors_["10131ui_story"]) and arg_191_1.var_.characterEffect10131ui_story then
				arg_191_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_194_2 = arg_191_1.actors_["1111ui_story"]

			if 0 < arg_191_1.time_ and arg_191_1.time_ <= 0 + arg_194_0 and not isNil(var_194_2) and arg_191_1.var_.characterEffect1111ui_story == nil then
				arg_191_1.var_.characterEffect1111ui_story = var_194_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_194_3 = 0.200000002980232

			if 0 <= arg_191_1.time_ and arg_191_1.time_ < 0 + var_194_3 and not isNil(var_194_2) then
				if arg_191_1.var_.characterEffect1111ui_story and not isNil(var_194_2) then
					arg_191_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_191_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_191_1.time_ - 0) / var_194_3)
				end
			end

			if arg_191_1.time_ >= 0 + var_194_3 and arg_191_1.time_ < 0 + var_194_3 + arg_194_0 and not isNil(var_194_2) and arg_191_1.var_.characterEffect1111ui_story then
				arg_191_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_191_1.time_ and arg_191_1.time_ <= var_194_4 + arg_194_0 then
				...
				arg_191_1.leftNameTxt_.text = arg_191_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_194_6 = arg_191_1:GetWordFromCfg(322211046)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211046", "story_v_out_322211.awb") ~= 0 then
					local var_194_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211046", "story_v_out_322211.awb") / 1000
					...
					if var_194_6.prefab_name ~= "" and arg_191_1.actors_[var_194_6.prefab_name] ~= nil then
						local var_194_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_191_1.actors_[var_194_6.prefab_name].transform, "story_v_out_322211", "322211046", "story_v_out_322211.awb")

						arg_191_1:RecordAudio("322211046", var_194_11)
						arg_191_1:RecordAudio("322211046", var_194_11)
					else
	...
	Play322211047 = function(arg_195_0, arg_195_1)
		...
		function arg_195_1.onSingleLineUpdate_(arg_198_0)
			...
			if 0 < arg_195_1.time_ and arg_195_1.time_ <= 0 + arg_198_0 then
				...
				arg_195_1.leftNameTxt_.text = arg_195_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_198_1 = arg_195_1:GetWordFromCfg(322211047)
				...
				local var_198_4 = 43 <= 0 and var_198_0 or var_198_0 * (utf8.len(var_198_2) / 43)

				if (43 <= 0 and var_198_0 or var_198_0 * (utf8.len(var_198_2) / 43)) > 0 and var_198_0 < var_198_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211047", "story_v_out_322211.awb") ~= 0 then
					local var_198_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211047", "story_v_out_322211.awb") / 1000
					...
					if var_198_1.prefab_name ~= "" and arg_195_1.actors_[var_198_1.prefab_name] ~= nil then
						local var_198_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_195_1.actors_[var_198_1.prefab_name].transform, "story_v_out_322211", "322211047", "story_v_out_322211.awb")

						arg_195_1:RecordAudio("322211047", var_198_6)
						arg_195_1:RecordAudio("322211047", var_198_6)
					else
	...
	Play322211048 = function(arg_199_0, arg_199_1)
		...
		function arg_199_1.onSingleLineUpdate_(arg_202_0)
			...
			if 0 < arg_199_1.time_ and arg_199_1.time_ <= 0 + arg_202_0 then
				...
				arg_199_1.leftNameTxt_.text = arg_199_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_202_1 = arg_199_1:GetWordFromCfg(322211048)
				...
				local var_202_4 = 41 <= 0 and var_202_0 or var_202_0 * (utf8.len(var_202_2) / 41)

				if (41 <= 0 and var_202_0 or var_202_0 * (utf8.len(var_202_2) / 41)) > 0 and var_202_0 < var_202_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211048", "story_v_out_322211.awb") ~= 0 then
					local var_202_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211048", "story_v_out_322211.awb") / 1000
					...
					if var_202_1.prefab_name ~= "" and arg_199_1.actors_[var_202_1.prefab_name] ~= nil then
						local var_202_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_199_1.actors_[var_202_1.prefab_name].transform, "story_v_out_322211", "322211048", "story_v_out_322211.awb")

						arg_199_1:RecordAudio("322211048", var_202_6)
						arg_199_1:RecordAudio("322211048", var_202_6)
					else
	...
	Play322211049 = function(arg_203_0, arg_203_1)
		...
		function arg_203_1.onSingleLineUpdate_(arg_206_0)
			...
			if 0 < arg_203_1.time_ and arg_203_1.time_ <= var_206_0 + arg_206_0 then
				...
				arg_203_1.leftNameTxt_.text = arg_203_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_206_2 = arg_203_1:GetWordFromCfg(322211049)
				...
				local var_206_5 = 43 <= 0 and var_206_1 or var_206_1 * (utf8.len(var_206_3) / 43)

				if (43 <= 0 and var_206_1 or var_206_1 * (utf8.len(var_206_3) / 43)) > 0 and var_206_1 < var_206_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211049", "story_v_out_322211.awb") ~= 0 then
					local var_206_6 = manager.audio:GetVoiceLength("story_v_out_322211", "322211049", "story_v_out_322211.awb") / 1000
					...
					if var_206_2.prefab_name ~= "" and arg_203_1.actors_[var_206_2.prefab_name] ~= nil then
						local var_206_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_203_1.actors_[var_206_2.prefab_name].transform, "story_v_out_322211", "322211049", "story_v_out_322211.awb")

						arg_203_1:RecordAudio("322211049", var_206_7)
						arg_203_1:RecordAudio("322211049", var_206_7)
					else
	...
	Play322211050 = function(arg_207_0, arg_207_1)
		...
		function arg_207_1.onSingleLineUpdate_(arg_210_0)
			...
			local var_210_2 = arg_207_1.actors_["10131ui_story"]

			if 0 < arg_207_1.time_ and arg_207_1.time_ <= 0 + arg_210_0 and not isNil(var_210_2) and arg_207_1.var_.characterEffect10131ui_story == nil then
				arg_207_1.var_.characterEffect10131ui_story = var_210_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_210_3 = 0.200000002980232

			if 0 <= arg_207_1.time_ and arg_207_1.time_ < 0 + var_210_3 and not isNil(var_210_2) then
				if arg_207_1.var_.characterEffect10131ui_story and not isNil(var_210_2) then
					arg_207_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_207_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_207_1.time_ - 0) / var_210_3)
				end
			end

			if arg_207_1.time_ >= 0 + var_210_3 and arg_207_1.time_ < 0 + var_210_3 + arg_210_0 and not isNil(var_210_2) and arg_207_1.var_.characterEffect10131ui_story then
				arg_207_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_207_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_207_1.time_ and arg_207_1.time_ <= var_210_4 + arg_210_0 then
				...
				local var_210_6 = arg_207_1:GetWordFromCfg(322211050)
				...
				local var_210_9 = 9 <= 0 and var_210_5 or var_210_5 * (utf8.len(var_210_7) / 9)

				if (9 <= 0 and var_210_5 or var_210_5 * (utf8.len(var_210_7) / 9)) > 0 and var_210_5 < var_210_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211050", "story_v_out_322211.awb") ~= 0 then
					local var_210_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211050", "story_v_out_322211.awb") / 1000
					...
					if var_210_6.prefab_name ~= "" and arg_207_1.actors_[var_210_6.prefab_name] ~= nil then
						local var_210_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_207_1.actors_[var_210_6.prefab_name].transform, "story_v_out_322211", "322211050", "story_v_out_322211.awb")

						arg_207_1:RecordAudio("322211050", var_210_11)
						arg_207_1:RecordAudio("322211050", var_210_11)
					else
	...
	Play322211051 = function(arg_211_0, arg_211_1)
		...
		function arg_211_1.onSingleLineUpdate_(arg_214_0)
			if 0 < arg_211_1.time_ and arg_211_1.time_ <= 0 + arg_214_0 and not isNil(arg_211_1.actors_["10131ui_story"]) and arg_211_1.var_.characterEffect10131ui_story == nil then
				arg_211_1.var_.characterEffect10131ui_story = arg_211_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_214_0 = 0.200000002980232

			if 0 <= arg_211_1.time_ and arg_211_1.time_ < 0 + var_214_0 and not isNil(arg_211_1.actors_["10131ui_story"]) then
				if arg_211_1.var_.characterEffect10131ui_story and not isNil(arg_211_1.actors_["10131ui_story"]) then
					arg_211_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_211_1.time_ >= 0 + var_214_0 and arg_211_1.time_ < 0 + var_214_0 + arg_214_0 and not isNil(arg_211_1.actors_["10131ui_story"]) and arg_211_1.var_.characterEffect10131ui_story then
				arg_211_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_214_2 = arg_211_1.actors_["1111ui_story"]

			if 0 < arg_211_1.time_ and arg_211_1.time_ <= 0 + arg_214_0 and not isNil(var_214_2) and arg_211_1.var_.characterEffect1111ui_story == nil then
				arg_211_1.var_.characterEffect1111ui_story = var_214_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_214_3 = 0.200000002980232

			if 0 <= arg_211_1.time_ and arg_211_1.time_ < 0 + var_214_3 and not isNil(var_214_2) then
				if arg_211_1.var_.characterEffect1111ui_story and not isNil(var_214_2) then
					arg_211_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_211_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_211_1.time_ - 0) / var_214_3)
				end
			end

			if arg_211_1.time_ >= 0 + var_214_3 and arg_211_1.time_ < 0 + var_214_3 + arg_214_0 and not isNil(var_214_2) and arg_211_1.var_.characterEffect1111ui_story then
				arg_211_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_211_1.time_ and arg_211_1.time_ <= var_214_4 + arg_214_0 then
				...
				arg_211_1.leftNameTxt_.text = arg_211_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_214_6 = arg_211_1:GetWordFromCfg(322211051)
				...
				local var_214_9 = 24 <= 0 and var_214_5 or var_214_5 * (utf8.len(var_214_7) / 24)

				if (24 <= 0 and var_214_5 or var_214_5 * (utf8.len(var_214_7) / 24)) > 0 and var_214_5 < var_214_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211051", "story_v_out_322211.awb") ~= 0 then
					local var_214_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211051", "story_v_out_322211.awb") / 1000
					...
					if var_214_6.prefab_name ~= "" and arg_211_1.actors_[var_214_6.prefab_name] ~= nil then
						local var_214_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_211_1.actors_[var_214_6.prefab_name].transform, "story_v_out_322211", "322211051", "story_v_out_322211.awb")

						arg_211_1:RecordAudio("322211051", var_214_11)
						arg_211_1:RecordAudio("322211051", var_214_11)
					else
	...
	Play322211052 = function(arg_215_0, arg_215_1)
		...
		function arg_215_1.onSingleLineUpdate_(arg_218_0)
			...
			local var_218_2 = arg_215_1.actors_["10131ui_story"]

			if 0 < arg_215_1.time_ and arg_215_1.time_ <= 0 + arg_218_0 and not isNil(var_218_2) and arg_215_1.var_.characterEffect10131ui_story == nil then
				arg_215_1.var_.characterEffect10131ui_story = var_218_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_218_3 = 0.200000002980232

			if 0 <= arg_215_1.time_ and arg_215_1.time_ < 0 + var_218_3 and not isNil(var_218_2) then
				if arg_215_1.var_.characterEffect10131ui_story and not isNil(var_218_2) then
					arg_215_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_215_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_215_1.time_ - 0) / var_218_3)
				end
			end

			if arg_215_1.time_ >= 0 + var_218_3 and arg_215_1.time_ < 0 + var_218_3 + arg_218_0 and not isNil(var_218_2) and arg_215_1.var_.characterEffect10131ui_story then
				arg_215_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_215_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_215_1.time_ and arg_215_1.time_ <= var_218_4 + arg_218_0 then
				...
				local var_218_6 = arg_215_1:GetWordFromCfg(322211052)
				...
				local var_218_9 = 28 <= 0 and var_218_5 or var_218_5 * (utf8.len(var_218_7) / 28)

				if (28 <= 0 and var_218_5 or var_218_5 * (utf8.len(var_218_7) / 28)) > 0 and var_218_5 < var_218_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211052", "story_v_out_322211.awb") ~= 0 then
					local var_218_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211052", "story_v_out_322211.awb") / 1000
					...
					if var_218_6.prefab_name ~= "" and arg_215_1.actors_[var_218_6.prefab_name] ~= nil then
						local var_218_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_215_1.actors_[var_218_6.prefab_name].transform, "story_v_out_322211", "322211052", "story_v_out_322211.awb")

						arg_215_1:RecordAudio("322211052", var_218_11)
						arg_215_1:RecordAudio("322211052", var_218_11)
					else
	...
	Play322211053 = function(arg_219_0, arg_219_1)
		...
		function arg_219_1.onSingleLineUpdate_(arg_222_0)
			if 0 < arg_219_1.time_ and arg_219_1.time_ <= 0 + arg_222_0 and not isNil(arg_219_1.actors_["10131ui_story"]) and arg_219_1.var_.characterEffect10131ui_story == nil then
				arg_219_1.var_.characterEffect10131ui_story = arg_219_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_222_0 = 0.200000002980232

			if 0 <= arg_219_1.time_ and arg_219_1.time_ < 0 + var_222_0 and not isNil(arg_219_1.actors_["10131ui_story"]) then
				if arg_219_1.var_.characterEffect10131ui_story and not isNil(arg_219_1.actors_["10131ui_story"]) then
					arg_219_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_219_1.time_ >= 0 + var_222_0 and arg_219_1.time_ < 0 + var_222_0 + arg_222_0 and not isNil(arg_219_1.actors_["10131ui_story"]) and arg_219_1.var_.characterEffect10131ui_story then
				arg_219_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_222_2 = arg_219_1.actors_["1111ui_story"]

			if 0 < arg_219_1.time_ and arg_219_1.time_ <= 0 + arg_222_0 and not isNil(var_222_2) and arg_219_1.var_.characterEffect1111ui_story == nil then
				arg_219_1.var_.characterEffect1111ui_story = var_222_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_222_3 = 0.200000002980232

			if 0 <= arg_219_1.time_ and arg_219_1.time_ < 0 + var_222_3 and not isNil(var_222_2) then
				if arg_219_1.var_.characterEffect1111ui_story and not isNil(var_222_2) then
					arg_219_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_219_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_219_1.time_ - 0) / var_222_3)
				end
			end

			if arg_219_1.time_ >= 0 + var_222_3 and arg_219_1.time_ < 0 + var_222_3 + arg_222_0 and not isNil(var_222_2) and arg_219_1.var_.characterEffect1111ui_story then
				arg_219_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_219_1.time_ and arg_219_1.time_ <= var_222_4 + arg_222_0 then
				...
				arg_219_1.leftNameTxt_.text = arg_219_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_222_6 = arg_219_1:GetWordFromCfg(322211053)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211053", "story_v_out_322211.awb") ~= 0 then
					local var_222_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211053", "story_v_out_322211.awb") / 1000
					...
					if var_222_6.prefab_name ~= "" and arg_219_1.actors_[var_222_6.prefab_name] ~= nil then
						local var_222_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_219_1.actors_[var_222_6.prefab_name].transform, "story_v_out_322211", "322211053", "story_v_out_322211.awb")

						arg_219_1:RecordAudio("322211053", var_222_11)
						arg_219_1:RecordAudio("322211053", var_222_11)
					else
	...
	Play322211054 = function(arg_223_0, arg_223_1)
		...
		function arg_223_1.onSingleLineUpdate_(arg_226_0)
			if 0 < arg_223_1.time_ and arg_223_1.time_ <= 0 + arg_226_0 and not isNil(arg_223_1.actors_["1111ui_story"]) and arg_223_1.var_.characterEffect1111ui_story == nil then
				arg_223_1.var_.characterEffect1111ui_story = arg_223_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_226_0 = 0.200000002980232

			if 0 <= arg_223_1.time_ and arg_223_1.time_ < 0 + var_226_0 and not isNil(arg_223_1.actors_["1111ui_story"]) then
				if arg_223_1.var_.characterEffect1111ui_story and not isNil(arg_223_1.actors_["1111ui_story"]) then
					arg_223_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_223_1.time_ >= 0 + var_226_0 and arg_223_1.time_ < 0 + var_226_0 + arg_226_0 and not isNil(arg_223_1.actors_["1111ui_story"]) and arg_223_1.var_.characterEffect1111ui_story then
				arg_223_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_226_2 = arg_223_1.actors_["10131ui_story"]

			if 0 < arg_223_1.time_ and arg_223_1.time_ <= 0 + arg_226_0 and not isNil(var_226_2) and arg_223_1.var_.characterEffect10131ui_story == nil then
				arg_223_1.var_.characterEffect10131ui_story = var_226_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_226_3 = 0.200000002980232

			if 0 <= arg_223_1.time_ and arg_223_1.time_ < 0 + var_226_3 and not isNil(var_226_2) then
				if arg_223_1.var_.characterEffect10131ui_story and not isNil(var_226_2) then
					arg_223_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_223_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_223_1.time_ - 0) / var_226_3)
				end
			end

			if arg_223_1.time_ >= 0 + var_226_3 and arg_223_1.time_ < 0 + var_226_3 + arg_226_0 and not isNil(var_226_2) and arg_223_1.var_.characterEffect10131ui_story then
				arg_223_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_223_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_223_1.time_ and arg_223_1.time_ <= var_226_4 + arg_226_0 then
				...
				local var_226_6 = arg_223_1:GetWordFromCfg(322211054)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211054", "story_v_out_322211.awb") ~= 0 then
					local var_226_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211054", "story_v_out_322211.awb") / 1000
					...
					if var_226_6.prefab_name ~= "" and arg_223_1.actors_[var_226_6.prefab_name] ~= nil then
						local var_226_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_223_1.actors_[var_226_6.prefab_name].transform, "story_v_out_322211", "322211054", "story_v_out_322211.awb")

						arg_223_1:RecordAudio("322211054", var_226_11)
						arg_223_1:RecordAudio("322211054", var_226_11)
					else
	...
	Play322211055 = function(arg_227_0, arg_227_1)
		...
		function arg_227_1.onSingleLineUpdate_(arg_230_0)
			...
			if 0 < arg_227_1.time_ and arg_227_1.time_ <= 0 + arg_230_0 then
				...
				local var_230_1 = arg_227_1:GetWordFromCfg(322211055)
				...
				local var_230_4 = 17 <= 0 and var_230_0 or var_230_0 * (utf8.len(var_230_2) / 17)

				if (17 <= 0 and var_230_0 or var_230_0 * (utf8.len(var_230_2) / 17)) > 0 and var_230_0 < var_230_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211055", "story_v_out_322211.awb") ~= 0 then
					local var_230_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211055", "story_v_out_322211.awb") / 1000
					...
					if var_230_1.prefab_name ~= "" and arg_227_1.actors_[var_230_1.prefab_name] ~= nil then
						local var_230_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_227_1.actors_[var_230_1.prefab_name].transform, "story_v_out_322211", "322211055", "story_v_out_322211.awb")

						arg_227_1:RecordAudio("322211055", var_230_6)
						arg_227_1:RecordAudio("322211055", var_230_6)
					else
	...
	Play322211056 = function(arg_231_0, arg_231_1)
		...
		function arg_231_1.onSingleLineUpdate_(arg_234_0)
			if 0 < arg_231_1.time_ and arg_231_1.time_ <= 0 + arg_234_0 and not isNil(arg_231_1.actors_["10131ui_story"]) and arg_231_1.var_.characterEffect10131ui_story == nil then
				arg_231_1.var_.characterEffect10131ui_story = arg_231_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_234_0 = 0.200000002980232

			if 0 <= arg_231_1.time_ and arg_231_1.time_ < 0 + var_234_0 and not isNil(arg_231_1.actors_["10131ui_story"]) then
				if arg_231_1.var_.characterEffect10131ui_story and not isNil(arg_231_1.actors_["10131ui_story"]) then
					arg_231_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_231_1.time_ >= 0 + var_234_0 and arg_231_1.time_ < 0 + var_234_0 + arg_234_0 and not isNil(arg_231_1.actors_["10131ui_story"]) and arg_231_1.var_.characterEffect10131ui_story then
				arg_231_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_234_2 = arg_231_1.actors_["1111ui_story"]

			if 0 < arg_231_1.time_ and arg_231_1.time_ <= 0 + arg_234_0 and not isNil(var_234_2) and arg_231_1.var_.characterEffect1111ui_story == nil then
				arg_231_1.var_.characterEffect1111ui_story = var_234_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_234_3 = 0.200000002980232

			if 0 <= arg_231_1.time_ and arg_231_1.time_ < 0 + var_234_3 and not isNil(var_234_2) then
				if arg_231_1.var_.characterEffect1111ui_story and not isNil(var_234_2) then
					arg_231_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_231_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_231_1.time_ - 0) / var_234_3)
				end
			end

			if arg_231_1.time_ >= 0 + var_234_3 and arg_231_1.time_ < 0 + var_234_3 + arg_234_0 and not isNil(var_234_2) and arg_231_1.var_.characterEffect1111ui_story then
				arg_231_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_231_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_231_1.time_ and arg_231_1.time_ <= var_234_4 + arg_234_0 then
				...
				arg_231_1.leftNameTxt_.text = arg_231_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_234_6 = arg_231_1:GetWordFromCfg(322211056)
				...
				local var_234_9 = 12 <= 0 and var_234_5 or var_234_5 * (utf8.len(var_234_7) / 12)

				if (12 <= 0 and var_234_5 or var_234_5 * (utf8.len(var_234_7) / 12)) > 0 and var_234_5 < var_234_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211056", "story_v_out_322211.awb") ~= 0 then
					local var_234_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211056", "story_v_out_322211.awb") / 1000
					...
					if var_234_6.prefab_name ~= "" and arg_231_1.actors_[var_234_6.prefab_name] ~= nil then
						local var_234_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_231_1.actors_[var_234_6.prefab_name].transform, "story_v_out_322211", "322211056", "story_v_out_322211.awb")

						arg_231_1:RecordAudio("322211056", var_234_11)
						arg_231_1:RecordAudio("322211056", var_234_11)
					else
	...
	Play322211057 = function(arg_235_0, arg_235_1)
		...
		function arg_235_1.onSingleLineUpdate_(arg_238_0)
			...
			local var_238_2 = arg_235_1.actors_["10131ui_story"]

			if 0 < arg_235_1.time_ and arg_235_1.time_ <= 0 + arg_238_0 and not isNil(var_238_2) and arg_235_1.var_.characterEffect10131ui_story == nil then
				arg_235_1.var_.characterEffect10131ui_story = var_238_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_238_3 = 0.200000002980232

			if 0 <= arg_235_1.time_ and arg_235_1.time_ < 0 + var_238_3 and not isNil(var_238_2) then
				if arg_235_1.var_.characterEffect10131ui_story and not isNil(var_238_2) then
					arg_235_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_235_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_235_1.time_ - 0) / var_238_3)
				end
			end

			if arg_235_1.time_ >= 0 + var_238_3 and arg_235_1.time_ < 0 + var_238_3 + arg_238_0 and not isNil(var_238_2) and arg_235_1.var_.characterEffect10131ui_story then
				arg_235_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_235_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_235_1.time_ and arg_235_1.time_ <= var_238_4 + arg_238_0 then
				...
				local var_238_6 = arg_235_1:GetWordFromCfg(322211057)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211057", "story_v_out_322211.awb") ~= 0 then
					local var_238_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211057", "story_v_out_322211.awb") / 1000
					...
					if var_238_6.prefab_name ~= "" and arg_235_1.actors_[var_238_6.prefab_name] ~= nil then
						local var_238_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_235_1.actors_[var_238_6.prefab_name].transform, "story_v_out_322211", "322211057", "story_v_out_322211.awb")

						arg_235_1:RecordAudio("322211057", var_238_11)
						arg_235_1:RecordAudio("322211057", var_238_11)
					else
	...
	Play322211058 = function(arg_239_0, arg_239_1)
		...
		function arg_239_1.onSingleLineUpdate_(arg_242_0)
			if 0 < arg_239_1.time_ and arg_239_1.time_ <= 0 + arg_242_0 and not isNil(arg_239_1.actors_["10131ui_story"]) and arg_239_1.var_.characterEffect10131ui_story == nil then
				arg_239_1.var_.characterEffect10131ui_story = arg_239_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_242_0 = 0.200000002980232

			if 0 <= arg_239_1.time_ and arg_239_1.time_ < 0 + var_242_0 and not isNil(arg_239_1.actors_["10131ui_story"]) then
				if arg_239_1.var_.characterEffect10131ui_story and not isNil(arg_239_1.actors_["10131ui_story"]) then
					arg_239_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_239_1.time_ >= 0 + var_242_0 and arg_239_1.time_ < 0 + var_242_0 + arg_242_0 and not isNil(arg_239_1.actors_["10131ui_story"]) and arg_239_1.var_.characterEffect10131ui_story then
				arg_239_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_242_2 = arg_239_1.actors_["1111ui_story"]

			if 0 < arg_239_1.time_ and arg_239_1.time_ <= 0 + arg_242_0 and not isNil(var_242_2) and arg_239_1.var_.characterEffect1111ui_story == nil then
				arg_239_1.var_.characterEffect1111ui_story = var_242_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_242_3 = 0.200000002980232

			if 0 <= arg_239_1.time_ and arg_239_1.time_ < 0 + var_242_3 and not isNil(var_242_2) then
				if arg_239_1.var_.characterEffect1111ui_story and not isNil(var_242_2) then
					arg_239_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_239_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_239_1.time_ - 0) / var_242_3)
				end
			end

			if arg_239_1.time_ >= 0 + var_242_3 and arg_239_1.time_ < 0 + var_242_3 + arg_242_0 and not isNil(var_242_2) and arg_239_1.var_.characterEffect1111ui_story then
				arg_239_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_239_1.time_ and arg_239_1.time_ <= var_242_4 + arg_242_0 then
				...
				arg_239_1.leftNameTxt_.text = arg_239_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_242_6 = arg_239_1:GetWordFromCfg(322211058)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211058", "story_v_out_322211.awb") ~= 0 then
					local var_242_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211058", "story_v_out_322211.awb") / 1000
					...
					if var_242_6.prefab_name ~= "" and arg_239_1.actors_[var_242_6.prefab_name] ~= nil then
						local var_242_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_239_1.actors_[var_242_6.prefab_name].transform, "story_v_out_322211", "322211058", "story_v_out_322211.awb")

						arg_239_1:RecordAudio("322211058", var_242_11)
						arg_239_1:RecordAudio("322211058", var_242_11)
					else
	...
	Play322211059 = function(arg_243_0, arg_243_1)
		...
		function arg_243_1.onSingleLineUpdate_(arg_246_0)
			...
			if 0 < arg_243_1.time_ and arg_243_1.time_ <= var_246_0 + arg_246_0 then
				...
				arg_243_1.leftNameTxt_.text = arg_243_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_246_2 = arg_243_1:GetWordFromCfg(322211059)
				...
				local var_246_5 = 42 <= 0 and var_246_1 or var_246_1 * (utf8.len(var_246_3) / 42)

				if (42 <= 0 and var_246_1 or var_246_1 * (utf8.len(var_246_3) / 42)) > 0 and var_246_1 < var_246_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211059", "story_v_out_322211.awb") ~= 0 then
					local var_246_6 = manager.audio:GetVoiceLength("story_v_out_322211", "322211059", "story_v_out_322211.awb") / 1000
					...
					if var_246_2.prefab_name ~= "" and arg_243_1.actors_[var_246_2.prefab_name] ~= nil then
						local var_246_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_243_1.actors_[var_246_2.prefab_name].transform, "story_v_out_322211", "322211059", "story_v_out_322211.awb")

						arg_243_1:RecordAudio("322211059", var_246_7)
						arg_243_1:RecordAudio("322211059", var_246_7)
					else
	...
	Play322211060 = function(arg_247_0, arg_247_1)
		...
		function arg_247_1.onSingleLineUpdate_(arg_250_0)
			...
			if 0 < arg_247_1.time_ and arg_247_1.time_ <= var_250_4 + arg_250_0 then
				...
				local var_250_6 = arg_247_1:GetWordFromCfg(322211060)
				...
				local var_250_9 = 18 <= 0 and var_250_5 or var_250_5 * (utf8.len(var_250_7) / 18)

				if (18 <= 0 and var_250_5 or var_250_5 * (utf8.len(var_250_7) / 18)) > 0 and var_250_5 < var_250_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211060", "story_v_out_322211.awb") ~= 0 then
					local var_250_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211060", "story_v_out_322211.awb") / 1000
					...
					if var_250_6.prefab_name ~= "" and arg_247_1.actors_[var_250_6.prefab_name] ~= nil then
						local var_250_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_247_1.actors_[var_250_6.prefab_name].transform, "story_v_out_322211", "322211060", "story_v_out_322211.awb")

						arg_247_1:RecordAudio("322211060", var_250_11)
						arg_247_1:RecordAudio("322211060", var_250_11)
					else
	...
	Play322211061 = function(arg_251_0, arg_251_1)
		...
		function arg_251_1.onSingleLineUpdate_(arg_254_0)
			if 0 < arg_251_1.time_ and arg_251_1.time_ <= 0 + arg_254_0 and not isNil(arg_251_1.actors_["10131ui_story"]) and arg_251_1.var_.characterEffect10131ui_story == nil then
				arg_251_1.var_.characterEffect10131ui_story = arg_251_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_254_0 = 0.200000002980232

			if 0 <= arg_251_1.time_ and arg_251_1.time_ < 0 + var_254_0 and not isNil(arg_251_1.actors_["10131ui_story"]) then
				if arg_251_1.var_.characterEffect10131ui_story and not isNil(arg_251_1.actors_["10131ui_story"]) then
					arg_251_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_251_1.time_ >= 0 + var_254_0 and arg_251_1.time_ < 0 + var_254_0 + arg_254_0 and not isNil(arg_251_1.actors_["10131ui_story"]) and arg_251_1.var_.characterEffect10131ui_story then
				arg_251_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_254_2 = arg_251_1.actors_["1111ui_story"]

			if 0 < arg_251_1.time_ and arg_251_1.time_ <= 0 + arg_254_0 and not isNil(var_254_2) and arg_251_1.var_.characterEffect1111ui_story == nil then
				arg_251_1.var_.characterEffect1111ui_story = var_254_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_254_3 = 0.200000002980232

			if 0 <= arg_251_1.time_ and arg_251_1.time_ < 0 + var_254_3 and not isNil(var_254_2) then
				if arg_251_1.var_.characterEffect1111ui_story and not isNil(var_254_2) then
					arg_251_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_251_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_251_1.time_ - 0) / var_254_3)
				end
			end

			if arg_251_1.time_ >= 0 + var_254_3 and arg_251_1.time_ < 0 + var_254_3 + arg_254_0 and not isNil(var_254_2) and arg_251_1.var_.characterEffect1111ui_story then
				arg_251_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_251_1.time_ and arg_251_1.time_ <= var_254_4 + arg_254_0 then
				...
				arg_251_1.leftNameTxt_.text = arg_251_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_254_6 = arg_251_1:GetWordFromCfg(322211061)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211061", "story_v_out_322211.awb") ~= 0 then
					local var_254_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211061", "story_v_out_322211.awb") / 1000
					...
					if var_254_6.prefab_name ~= "" and arg_251_1.actors_[var_254_6.prefab_name] ~= nil then
						local var_254_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_251_1.actors_[var_254_6.prefab_name].transform, "story_v_out_322211", "322211061", "story_v_out_322211.awb")

						arg_251_1:RecordAudio("322211061", var_254_11)
						arg_251_1:RecordAudio("322211061", var_254_11)
					else
	...
	Play322211062 = function(arg_255_0, arg_255_1)
		...
		function arg_255_1.onSingleLineUpdate_(arg_258_0)
			...
			local var_258_12 = arg_255_1.actors_["1111ui_story"].transform

			if 1 < arg_255_1.time_ and arg_255_1.time_ <= 1 + arg_258_0 then
				arg_255_1.var_.moveOldPos1111ui_story = var_258_12.localPosition
			end

			local var_258_13 = 0.001

			if 1 <= arg_255_1.time_ and arg_255_1.time_ < 1 + var_258_13 then
				var_258_12.localPosition = Vector3.Lerp(arg_255_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_255_1.time_ - 1) / var_258_13)
			...
			if arg_255_1.time_ >= 1 + var_258_13 and arg_255_1.time_ < 1 + var_258_13 + arg_258_0 then
			...
			local var_258_14 = arg_255_1.actors_["10131ui_story"].transform

			if 1 < arg_255_1.time_ and arg_255_1.time_ <= 1 + arg_258_0 then
				arg_255_1.var_.moveOldPos10131ui_story = var_258_14.localPosition
			end

			local var_258_15 = 0.001

			if 1 <= arg_255_1.time_ and arg_255_1.time_ < 1 + var_258_15 then
				var_258_14.localPosition = Vector3.Lerp(arg_255_1.var_.moveOldPos10131ui_story, Vector3.New(0, 100, 0), (arg_255_1.time_ - 1) / var_258_15)
			...
			local var_258_16 = 2
			local var_258_17 = manager.audio:GetVoiceLength("story_v_out_322211", "322211062", "story_v_out_322211.awb") / 1000

			if var_258_17 > 0 and 13.1 < var_258_17 and var_258_17 + var_258_16 > arg_255_1.duration_ then
				arg_255_1.duration_ = var_258_17 + var_258_16
			end

			if var_258_16 < arg_255_1.time_ and arg_255_1.time_ <= var_258_16 + arg_258_0 then
				arg_255_1:AudioAction("play", "voice", "story_v_out_322211", "322211062", "story_v_out_322211.awb")
			end
		end
	...
	Play322211063 = function(arg_259_0, arg_259_1)
		...
		function arg_259_1.onSingleLineUpdate_(arg_262_0)
			local var_262_0 = manager.audio:GetVoiceLength("story_v_out_322211", "322211063", "story_v_out_322211.awb") / 1000

			if var_262_0 > 0 and 8.333 < var_262_0 and var_262_0 + 0 > arg_259_1.duration_ then
				arg_259_1.duration_ = var_262_0 + 0
			end

			if 0 < arg_259_1.time_ and arg_259_1.time_ <= 0 + arg_262_0 then
				arg_259_1:AudioAction("play", "voice", "story_v_out_322211", "322211063", "story_v_out_322211.awb")
			end
		end
	...
	Play322211064 = function(arg_263_0, arg_263_1)
		...
		function arg_263_1.onSingleLineUpdate_(arg_266_0)
			local var_266_0 = manager.audio:GetVoiceLength("story_v_out_322211", "322211064", "story_v_out_322211.awb") / 1000

			if var_266_0 > 0 and 8 < var_266_0 and var_266_0 + 0 > arg_263_1.duration_ then
				arg_263_1.duration_ = var_266_0 + 0
			end

			if 0 < arg_263_1.time_ and arg_263_1.time_ <= 0 + arg_266_0 then
				arg_263_1:AudioAction("play", "voice", "story_v_out_322211", "322211064", "story_v_out_322211.awb")
			end
		end
	...
	Play322211065 = function(arg_267_0, arg_267_1)
		...
		function arg_267_1.onSingleLineUpdate_(arg_270_0)
			...
			if 0 <= arg_267_1.time_ and arg_267_1.time_ < 0 + var_270_0 then
				local var_270_1 = Color.New(0, 0, 0)

				var_270_1.a = Mathf.Lerp(0, 1, (arg_267_1.time_ - 0) / var_270_0)
				arg_267_1.mask_.color = var_270_1
			end

			if arg_267_1.time_ >= 0 + var_270_0 and arg_267_1.time_ < 0 + var_270_0 + arg_270_0 then
				local var_270_2 = Color.New(0, 0, 0)

				var_270_2.a = 1
				arg_267_1.mask_.color = var_270_2
			end

			local var_270_3 = 1

			if 1 < arg_267_1.time_ and arg_267_1.time_ <= var_270_3 + arg_270_0 then
				arg_267_1.mask_.enabled = true
				arg_267_1.mask_.raycastTarget = true
			...
			if 1 < arg_267_1.time_ and arg_267_1.time_ <= 1 + arg_270_0 then
				local var_270_7 = arg_267_1.bgs_.L09f

				arg_267_1.bgs_.L09f.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
				...
				if var_270_8 and var_270_8.sprite then
					local var_270_9 = 2 * (var_270_7.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_270_7.transform.localScale = Vector3.New(var_270_9 / var_270_8.sprite.bounds.size.y < var_270_9 * manager.ui.mainCameraCom_.aspect / var_270_8.sprite.bounds.size.x and var_270_9 * manager.ui.mainCameraCom_.aspect / var_270_8.sprite.bounds.size.x or var_270_9 / var_270_8.sprite.bounds.size.y, var_270_9 / var_270_8.sprite.bounds.size.y < var_270_9 * manager.ui.mainCameraCom_.aspect / var_270_8.sprite.bounds.size.x and var_270_9 * manager.ui.mainCameraCom_.aspect / var_270_8.sprite.bounds.size.x or var_270_9 / var_270_8.sprite.bounds.size.y, 0)
				end
			...
			local var_270_10 = arg_267_1.actors_["1111ui_story"].transform

			if 2 < arg_267_1.time_ and arg_267_1.time_ <= 2 + arg_270_0 then
				arg_267_1.var_.moveOldPos1111ui_story = var_270_10.localPosition
			end

			local var_270_11 = 0.001

			if 2 <= arg_267_1.time_ and arg_267_1.time_ < 2 + var_270_11 then
				var_270_10.localPosition = Vector3.Lerp(arg_267_1.var_.moveOldPos1111ui_story, Vector3.New(-0.79, -0.87, -5.7), (arg_267_1.time_ - 2) / var_270_11)
				var_270_10.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_270_10.position).x, (manager.ui.mainCamera.transform.position - var_270_10.position).y, (manager.ui.mainCamera.transform.position - var_270_10.position).z)
				var_270_10.localEulerAngles.z = 0
				var_270_10.localEulerAngles.x = 0
				var_270_10.localEulerAngles = var_270_10.localEulerAngles
			end

			if arg_267_1.time_ >= 2 + var_270_11 and arg_267_1.time_ < 2 + var_270_11 + arg_270_0 then
				var_270_10.localPosition = Vector3.New(-0.79, -0.87, -5.7)
				var_270_10.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_270_10.position).x, (manager.ui.mainCamera.transform.position - var_270_10.position).y, (manager.ui.mainCamera.transform.position - var_270_10.position).z)
				var_270_10.localEulerAngles.z = 0
				var_270_10.localEulerAngles.x = 0
				var_270_10.localEulerAngles = var_270_10.localEulerAngles
			...
			local var_270_12 = arg_267_1.actors_["1111ui_story"]

			if 2 < arg_267_1.time_ and arg_267_1.time_ <= 2 + arg_270_0 and not isNil(var_270_12) and arg_267_1.var_.characterEffect1111ui_story == nil then
				arg_267_1.var_.characterEffect1111ui_story = var_270_12:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_270_13 = 0.200000002980232

			if 2 <= arg_267_1.time_ and arg_267_1.time_ < 2 + var_270_13 and not isNil(var_270_12) then
				if arg_267_1.var_.characterEffect1111ui_story and not isNil(var_270_12) then
					arg_267_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_267_1.time_ >= 2 + var_270_13 and arg_267_1.time_ < 2 + var_270_13 + arg_270_0 and not isNil(var_270_12) and arg_267_1.var_.characterEffect1111ui_story then
				arg_267_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			local var_270_15 = 2
			local var_270_16 = 0.35

			if 2 < arg_267_1.time_ and arg_267_1.time_ <= var_270_15 + arg_270_0 then
				...
				local var_270_17 = arg_267_1:GetWordFromCfg(322211065)
				...
				local var_270_20 = 14 <= 0 and var_270_16 or var_270_16 * (utf8.len(var_270_18) / 14)

				if (14 <= 0 and var_270_16 or var_270_16 * (utf8.len(var_270_18) / 14)) > 0 and var_270_16 < var_270_20 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211065", "story_v_out_322211.awb") ~= 0 then
					local var_270_21 = manager.audio:GetVoiceLength("story_v_out_322211", "322211065", "story_v_out_322211.awb") / 1000
					...
					if var_270_17.prefab_name ~= "" and arg_267_1.actors_[var_270_17.prefab_name] ~= nil then
						local var_270_22 = LuaForUtil.PlayVoiceWithCriLipsync(arg_267_1.actors_[var_270_17.prefab_name].transform, "story_v_out_322211", "322211065", "story_v_out_322211.awb")

						arg_267_1:RecordAudio("322211065", var_270_22)
						arg_267_1:RecordAudio("322211065", var_270_22)
					else
	...
	Play322211066 = function(arg_271_0, arg_271_1)
		...
		function arg_271_1.onSingleLineUpdate_(arg_274_0)
			if 0 < arg_271_1.time_ and arg_271_1.time_ <= 0 + arg_274_0 and not isNil(arg_271_1.actors_["10131ui_story"]) and arg_271_1.var_.characterEffect10131ui_story == nil then
				arg_271_1.var_.characterEffect10131ui_story = arg_271_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_274_0 = 0.200000002980232

			if 0 <= arg_271_1.time_ and arg_271_1.time_ < 0 + var_274_0 and not isNil(arg_271_1.actors_["10131ui_story"]) then
				if arg_271_1.var_.characterEffect10131ui_story and not isNil(arg_271_1.actors_["10131ui_story"]) then
					arg_271_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_271_1.time_ >= 0 + var_274_0 and arg_271_1.time_ < 0 + var_274_0 + arg_274_0 and not isNil(arg_271_1.actors_["10131ui_story"]) and arg_271_1.var_.characterEffect10131ui_story then
				arg_271_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_274_2 = arg_271_1.actors_["1111ui_story"]

			if 0 < arg_271_1.time_ and arg_271_1.time_ <= 0 + arg_274_0 and not isNil(var_274_2) and arg_271_1.var_.characterEffect1111ui_story == nil then
				arg_271_1.var_.characterEffect1111ui_story = var_274_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_274_3 = 0.200000002980232

			if 0 <= arg_271_1.time_ and arg_271_1.time_ < 0 + var_274_3 and not isNil(var_274_2) then
				if arg_271_1.var_.characterEffect1111ui_story and not isNil(var_274_2) then
					arg_271_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_271_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_271_1.time_ - 0) / var_274_3)
				end
			end

			if arg_271_1.time_ >= 0 + var_274_3 and arg_271_1.time_ < 0 + var_274_3 + arg_274_0 and not isNil(var_274_2) and arg_271_1.var_.characterEffect1111ui_story then
				arg_271_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			local var_274_4 = arg_271_1.actors_["10131ui_story"].transform

			if 0 < arg_271_1.time_ and arg_271_1.time_ <= 0 + arg_274_0 then
				arg_271_1.var_.moveOldPos10131ui_story = var_274_4.localPosition
			end

			local var_274_5 = 0.001

			if 0 <= arg_271_1.time_ and arg_271_1.time_ < 0 + var_274_5 then
				var_274_4.localPosition = Vector3.Lerp(arg_271_1.var_.moveOldPos10131ui_story, Vector3.New(0.83, -0.96, -5.8), (arg_271_1.time_ - 0) / var_274_5)
			...
			if arg_271_1.time_ >= 0 + var_274_5 and arg_271_1.time_ < 0 + var_274_5 + arg_274_0 then
				var_274_4.localPosition = Vector3.New(0.83, -0.96, -5.8)
				var_274_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_274_4.position).x, (manager.ui.mainCamera.transform.position - var_274_4.position).y, (manager.ui.mainCamera.transform.position - var_274_4.position).z)
				var_274_4.localEulerAngles.z = 0
				var_274_4.localEulerAngles.x = 0
				var_274_4.localEulerAngles = var_274_4.localEulerAngles
			...
			if 0 < arg_271_1.time_ and arg_271_1.time_ <= var_274_6 + arg_274_0 then
				...
				arg_271_1.leftNameTxt_.text = arg_271_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_274_8 = arg_271_1:GetWordFromCfg(322211066)
				...
				local var_274_11 = 48 <= 0 and var_274_7 or var_274_7 * (utf8.len(var_274_9) / 48)

				if (48 <= 0 and var_274_7 or var_274_7 * (utf8.len(var_274_9) / 48)) > 0 and var_274_7 < var_274_11 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211066", "story_v_out_322211.awb") ~= 0 then
					local var_274_12 = manager.audio:GetVoiceLength("story_v_out_322211", "322211066", "story_v_out_322211.awb") / 1000
					...
					if var_274_8.prefab_name ~= "" and arg_271_1.actors_[var_274_8.prefab_name] ~= nil then
						local var_274_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_271_1.actors_[var_274_8.prefab_name].transform, "story_v_out_322211", "322211066", "story_v_out_322211.awb")

						arg_271_1:RecordAudio("322211066", var_274_13)
						arg_271_1:RecordAudio("322211066", var_274_13)
					else
	...
	Play322211067 = function(arg_275_0, arg_275_1)
		...
		function arg_275_1.onSingleLineUpdate_(arg_278_0)
			...
			local var_278_2 = arg_275_1.actors_["10131ui_story"]

			if 0 < arg_275_1.time_ and arg_275_1.time_ <= 0 + arg_278_0 and not isNil(var_278_2) and arg_275_1.var_.characterEffect10131ui_story == nil then
				arg_275_1.var_.characterEffect10131ui_story = var_278_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_278_3 = 0.200000002980232

			if 0 <= arg_275_1.time_ and arg_275_1.time_ < 0 + var_278_3 and not isNil(var_278_2) then
				if arg_275_1.var_.characterEffect10131ui_story and not isNil(var_278_2) then
					arg_275_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_275_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_275_1.time_ - 0) / var_278_3)
				end
			end

			if arg_275_1.time_ >= 0 + var_278_3 and arg_275_1.time_ < 0 + var_278_3 + arg_278_0 and not isNil(var_278_2) and arg_275_1.var_.characterEffect10131ui_story then
				arg_275_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_275_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_275_1.time_ and arg_275_1.time_ <= var_278_4 + arg_278_0 then
				...
				arg_275_1.leftNameTxt_.text = arg_275_1:FormatText(StoryNameCfg[67].name)
				...
				local var_278_6 = arg_275_1:GetWordFromCfg(322211067)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211067", "story_v_out_322211.awb") ~= 0 then
					local var_278_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211067", "story_v_out_322211.awb") / 1000
					...
					if var_278_6.prefab_name ~= "" and arg_275_1.actors_[var_278_6.prefab_name] ~= nil then
						local var_278_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_275_1.actors_[var_278_6.prefab_name].transform, "story_v_out_322211", "322211067", "story_v_out_322211.awb")

						arg_275_1:RecordAudio("322211067", var_278_11)
						arg_275_1:RecordAudio("322211067", var_278_11)
					else
	...
	Play322211068 = function(arg_279_0, arg_279_1)
		...
		function arg_279_1.onSingleLineUpdate_(arg_282_0)
			if 0 < arg_279_1.time_ and arg_279_1.time_ <= 0 + arg_282_0 and not isNil(arg_279_1.actors_["10131ui_story"]) and arg_279_1.var_.characterEffect10131ui_story == nil then
				arg_279_1.var_.characterEffect10131ui_story = arg_279_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_282_0 = 0.200000002980232

			if 0 <= arg_279_1.time_ and arg_279_1.time_ < 0 + var_282_0 and not isNil(arg_279_1.actors_["10131ui_story"]) then
				if arg_279_1.var_.characterEffect10131ui_story and not isNil(arg_279_1.actors_["10131ui_story"]) then
					arg_279_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_279_1.time_ >= 0 + var_282_0 and arg_279_1.time_ < 0 + var_282_0 + arg_282_0 and not isNil(arg_279_1.actors_["10131ui_story"]) and arg_279_1.var_.characterEffect10131ui_story then
				arg_279_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_282_2 = arg_279_1.actors_["1111ui_story"]

			if 0 < arg_279_1.time_ and arg_279_1.time_ <= 0 + arg_282_0 and not isNil(var_282_2) and arg_279_1.var_.characterEffect1111ui_story == nil then
				arg_279_1.var_.characterEffect1111ui_story = var_282_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_282_3 = 0.200000002980232

			if 0 <= arg_279_1.time_ and arg_279_1.time_ < 0 + var_282_3 and not isNil(var_282_2) then
				if arg_279_1.var_.characterEffect1111ui_story and not isNil(var_282_2) then
					arg_279_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_279_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_279_1.time_ - 0) / var_282_3)
				end
			end

			if arg_279_1.time_ >= 0 + var_282_3 and arg_279_1.time_ < 0 + var_282_3 + arg_282_0 and not isNil(var_282_2) and arg_279_1.var_.characterEffect1111ui_story then
				arg_279_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_279_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_279_1.time_ and arg_279_1.time_ <= var_282_4 + arg_282_0 then
				...
				arg_279_1.leftNameTxt_.text = arg_279_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_282_6 = arg_279_1:GetWordFromCfg(322211068)
				...
				local var_282_9 = 16 <= 0 and var_282_5 or var_282_5 * (utf8.len(var_282_7) / 16)

				if (16 <= 0 and var_282_5 or var_282_5 * (utf8.len(var_282_7) / 16)) > 0 and var_282_5 < var_282_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211068", "story_v_out_322211.awb") ~= 0 then
					local var_282_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211068", "story_v_out_322211.awb") / 1000
					...
					if var_282_6.prefab_name ~= "" and arg_279_1.actors_[var_282_6.prefab_name] ~= nil then
						local var_282_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_279_1.actors_[var_282_6.prefab_name].transform, "story_v_out_322211", "322211068", "story_v_out_322211.awb")

						arg_279_1:RecordAudio("322211068", var_282_11)
						arg_279_1:RecordAudio("322211068", var_282_11)
					else
	...
	Play322211069 = function(arg_283_0, arg_283_1)
		...
		function arg_283_1.onSingleLineUpdate_(arg_286_0)
			...
			if 0 < arg_283_1.time_ and arg_283_1.time_ <= 0 + arg_286_0 then
				...
				arg_283_1.leftNameTxt_.text = arg_283_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_286_1 = arg_283_1:GetWordFromCfg(322211069)
				...
				local var_286_4 = 48 <= 0 and var_286_0 or var_286_0 * (utf8.len(var_286_2) / 48)

				if (48 <= 0 and var_286_0 or var_286_0 * (utf8.len(var_286_2) / 48)) > 0 and var_286_0 < var_286_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211069", "story_v_out_322211.awb") ~= 0 then
					local var_286_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211069", "story_v_out_322211.awb") / 1000
					...
					if var_286_1.prefab_name ~= "" and arg_283_1.actors_[var_286_1.prefab_name] ~= nil then
						local var_286_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_283_1.actors_[var_286_1.prefab_name].transform, "story_v_out_322211", "322211069", "story_v_out_322211.awb")

						arg_283_1:RecordAudio("322211069", var_286_6)
						arg_283_1:RecordAudio("322211069", var_286_6)
					else
	...
	Play322211070 = function(arg_287_0, arg_287_1)
		...
		function arg_287_1.onSingleLineUpdate_(arg_290_0)
			...
			if 0 < arg_287_1.time_ and arg_287_1.time_ <= 0 + arg_290_0 then
				...
				arg_287_1.leftNameTxt_.text = arg_287_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_290_1 = arg_287_1:GetWordFromCfg(322211070)
				...
				local var_290_4 = 28 <= 0 and var_290_0 or var_290_0 * (utf8.len(var_290_2) / 28)

				if (28 <= 0 and var_290_0 or var_290_0 * (utf8.len(var_290_2) / 28)) > 0 and var_290_0 < var_290_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211070", "story_v_out_322211.awb") ~= 0 then
					local var_290_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211070", "story_v_out_322211.awb") / 1000
					...
					if var_290_1.prefab_name ~= "" and arg_287_1.actors_[var_290_1.prefab_name] ~= nil then
						local var_290_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_287_1.actors_[var_290_1.prefab_name].transform, "story_v_out_322211", "322211070", "story_v_out_322211.awb")

						arg_287_1:RecordAudio("322211070", var_290_6)
						arg_287_1:RecordAudio("322211070", var_290_6)
					else
	...
	Play322211071 = function(arg_291_0, arg_291_1)
		...
		function arg_291_1.onSingleLineUpdate_(arg_294_0)
			if 0 < arg_291_1.time_ and arg_291_1.time_ <= 0 + arg_294_0 and not isNil(arg_291_1.actors_["1111ui_story"]) and arg_291_1.var_.characterEffect1111ui_story == nil then
				arg_291_1.var_.characterEffect1111ui_story = arg_291_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_294_0 = 0.200000002980232

			if 0 <= arg_291_1.time_ and arg_291_1.time_ < 0 + var_294_0 and not isNil(arg_291_1.actors_["1111ui_story"]) then
				if arg_291_1.var_.characterEffect1111ui_story and not isNil(arg_291_1.actors_["1111ui_story"]) then
					arg_291_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_291_1.time_ >= 0 + var_294_0 and arg_291_1.time_ < 0 + var_294_0 + arg_294_0 and not isNil(arg_291_1.actors_["1111ui_story"]) and arg_291_1.var_.characterEffect1111ui_story then
				arg_291_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_294_2 = arg_291_1.actors_["10131ui_story"]

			if 0 < arg_291_1.time_ and arg_291_1.time_ <= 0 + arg_294_0 and not isNil(var_294_2) and arg_291_1.var_.characterEffect10131ui_story == nil then
				arg_291_1.var_.characterEffect10131ui_story = var_294_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_294_3 = 0.200000002980232

			if 0 <= arg_291_1.time_ and arg_291_1.time_ < 0 + var_294_3 and not isNil(var_294_2) then
				if arg_291_1.var_.characterEffect10131ui_story and not isNil(var_294_2) then
					arg_291_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_291_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_291_1.time_ - 0) / var_294_3)
				end
			end

			if arg_291_1.time_ >= 0 + var_294_3 and arg_291_1.time_ < 0 + var_294_3 + arg_294_0 and not isNil(var_294_2) and arg_291_1.var_.characterEffect10131ui_story then
				arg_291_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_291_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_291_1.time_ and arg_291_1.time_ <= var_294_4 + arg_294_0 then
				...
				local var_294_6 = arg_291_1:GetWordFromCfg(322211071)
				...
				local var_294_9 = 14 <= 0 and var_294_5 or var_294_5 * (utf8.len(var_294_7) / 14)

				if (14 <= 0 and var_294_5 or var_294_5 * (utf8.len(var_294_7) / 14)) > 0 and var_294_5 < var_294_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211071", "story_v_out_322211.awb") ~= 0 then
					local var_294_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211071", "story_v_out_322211.awb") / 1000
					...
					if var_294_6.prefab_name ~= "" and arg_291_1.actors_[var_294_6.prefab_name] ~= nil then
						local var_294_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_291_1.actors_[var_294_6.prefab_name].transform, "story_v_out_322211", "322211071", "story_v_out_322211.awb")

						arg_291_1:RecordAudio("322211071", var_294_11)
						arg_291_1:RecordAudio("322211071", var_294_11)
					else
	...
	Play322211072 = function(arg_295_0, arg_295_1)
		...
		function arg_295_1.onSingleLineUpdate_(arg_298_0)
			if 0 < arg_295_1.time_ and arg_295_1.time_ <= 0 + arg_298_0 and not isNil(arg_295_1.actors_["10131ui_story"]) and arg_295_1.var_.characterEffect10131ui_story == nil then
				arg_295_1.var_.characterEffect10131ui_story = arg_295_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_298_0 = 0.200000002980232

			if 0 <= arg_295_1.time_ and arg_295_1.time_ < 0 + var_298_0 and not isNil(arg_295_1.actors_["10131ui_story"]) then
				if arg_295_1.var_.characterEffect10131ui_story and not isNil(arg_295_1.actors_["10131ui_story"]) then
					arg_295_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_295_1.time_ >= 0 + var_298_0 and arg_295_1.time_ < 0 + var_298_0 + arg_298_0 and not isNil(arg_295_1.actors_["10131ui_story"]) and arg_295_1.var_.characterEffect10131ui_story then
				arg_295_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_298_2 = arg_295_1.actors_["1111ui_story"]

			if 0 < arg_295_1.time_ and arg_295_1.time_ <= 0 + arg_298_0 and not isNil(var_298_2) and arg_295_1.var_.characterEffect1111ui_story == nil then
				arg_295_1.var_.characterEffect1111ui_story = var_298_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_298_3 = 0.200000002980232

			if 0 <= arg_295_1.time_ and arg_295_1.time_ < 0 + var_298_3 and not isNil(var_298_2) then
				if arg_295_1.var_.characterEffect1111ui_story and not isNil(var_298_2) then
					arg_295_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_295_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_295_1.time_ - 0) / var_298_3)
				end
			end

			if arg_295_1.time_ >= 0 + var_298_3 and arg_295_1.time_ < 0 + var_298_3 + arg_298_0 and not isNil(var_298_2) and arg_295_1.var_.characterEffect1111ui_story then
				arg_295_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_295_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_295_1.time_ and arg_295_1.time_ <= var_298_4 + arg_298_0 then
				...
				arg_295_1.leftNameTxt_.text = arg_295_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_298_6 = arg_295_1:GetWordFromCfg(322211072)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211072", "story_v_out_322211.awb") ~= 0 then
					local var_298_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211072", "story_v_out_322211.awb") / 1000
					...
					if var_298_6.prefab_name ~= "" and arg_295_1.actors_[var_298_6.prefab_name] ~= nil then
						local var_298_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_295_1.actors_[var_298_6.prefab_name].transform, "story_v_out_322211", "322211072", "story_v_out_322211.awb")

						arg_295_1:RecordAudio("322211072", var_298_11)
						arg_295_1:RecordAudio("322211072", var_298_11)
					else
	...
	Play322211073 = function(arg_299_0, arg_299_1)
		...
		function arg_299_1.onSingleLineUpdate_(arg_302_0)
			if 0 < arg_299_1.time_ and arg_299_1.time_ <= 0 + arg_302_0 and not isNil(arg_299_1.actors_["1111ui_story"]) and arg_299_1.var_.characterEffect1111ui_story == nil then
				arg_299_1.var_.characterEffect1111ui_story = arg_299_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_302_0 = 0.200000002980232

			if 0 <= arg_299_1.time_ and arg_299_1.time_ < 0 + var_302_0 and not isNil(arg_299_1.actors_["1111ui_story"]) then
				if arg_299_1.var_.characterEffect1111ui_story and not isNil(arg_299_1.actors_["1111ui_story"]) then
					arg_299_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_299_1.time_ >= 0 + var_302_0 and arg_299_1.time_ < 0 + var_302_0 + arg_302_0 and not isNil(arg_299_1.actors_["1111ui_story"]) and arg_299_1.var_.characterEffect1111ui_story then
				arg_299_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_302_2 = arg_299_1.actors_["10131ui_story"]

			if 0 < arg_299_1.time_ and arg_299_1.time_ <= 0 + arg_302_0 and not isNil(var_302_2) and arg_299_1.var_.characterEffect10131ui_story == nil then
				arg_299_1.var_.characterEffect10131ui_story = var_302_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_302_3 = 0.200000002980232

			if 0 <= arg_299_1.time_ and arg_299_1.time_ < 0 + var_302_3 and not isNil(var_302_2) then
				if arg_299_1.var_.characterEffect10131ui_story and not isNil(var_302_2) then
					arg_299_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_299_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_299_1.time_ - 0) / var_302_3)
				end
			end

			if arg_299_1.time_ >= 0 + var_302_3 and arg_299_1.time_ < 0 + var_302_3 + arg_302_0 and not isNil(var_302_2) and arg_299_1.var_.characterEffect10131ui_story then
				arg_299_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_299_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_299_1.time_ and arg_299_1.time_ <= var_302_4 + arg_302_0 then
				...
				arg_299_1.leftNameTxt_.text = arg_299_1:FormatText(StoryNameCfg[67].name)
				...
				local var_302_6 = arg_299_1:GetWordFromCfg(322211073)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211073", "story_v_out_322211.awb") ~= 0 then
					local var_302_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211073", "story_v_out_322211.awb") / 1000
					...
					if var_302_6.prefab_name ~= "" and arg_299_1.actors_[var_302_6.prefab_name] ~= nil then
						local var_302_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_299_1.actors_[var_302_6.prefab_name].transform, "story_v_out_322211", "322211073", "story_v_out_322211.awb")

						arg_299_1:RecordAudio("322211073", var_302_11)
						arg_299_1:RecordAudio("322211073", var_302_11)
					else
	...
	Play322211074 = function(arg_303_0, arg_303_1)
		...
		function arg_303_1.onSingleLineUpdate_(arg_306_0)
			if 0 < arg_303_1.time_ and arg_303_1.time_ <= 0 + arg_306_0 and not isNil(arg_303_1.actors_["10131ui_story"]) and arg_303_1.var_.characterEffect10131ui_story == nil then
				arg_303_1.var_.characterEffect10131ui_story = arg_303_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_306_0 = 0.200000002980232

			if 0 <= arg_303_1.time_ and arg_303_1.time_ < 0 + var_306_0 and not isNil(arg_303_1.actors_["10131ui_story"]) then
				if arg_303_1.var_.characterEffect10131ui_story and not isNil(arg_303_1.actors_["10131ui_story"]) then
					arg_303_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_303_1.time_ >= 0 + var_306_0 and arg_303_1.time_ < 0 + var_306_0 + arg_306_0 and not isNil(arg_303_1.actors_["10131ui_story"]) and arg_303_1.var_.characterEffect10131ui_story then
				arg_303_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_306_2 = arg_303_1.actors_["1111ui_story"]

			if 0 < arg_303_1.time_ and arg_303_1.time_ <= 0 + arg_306_0 and not isNil(var_306_2) and arg_303_1.var_.characterEffect1111ui_story == nil then
				arg_303_1.var_.characterEffect1111ui_story = var_306_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_306_3 = 0.200000002980232

			if 0 <= arg_303_1.time_ and arg_303_1.time_ < 0 + var_306_3 and not isNil(var_306_2) then
				if arg_303_1.var_.characterEffect1111ui_story and not isNil(var_306_2) then
					arg_303_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_303_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_303_1.time_ - 0) / var_306_3)
				end
			end

			if arg_303_1.time_ >= 0 + var_306_3 and arg_303_1.time_ < 0 + var_306_3 + arg_306_0 and not isNil(var_306_2) and arg_303_1.var_.characterEffect1111ui_story then
				arg_303_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_303_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_303_1.time_ and arg_303_1.time_ <= var_306_4 + arg_306_0 then
				...
				arg_303_1.leftNameTxt_.text = arg_303_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_306_6 = arg_303_1:GetWordFromCfg(322211074)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211074", "story_v_out_322211.awb") ~= 0 then
					local var_306_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211074", "story_v_out_322211.awb") / 1000
					...
					if var_306_6.prefab_name ~= "" and arg_303_1.actors_[var_306_6.prefab_name] ~= nil then
						local var_306_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_303_1.actors_[var_306_6.prefab_name].transform, "story_v_out_322211", "322211074", "story_v_out_322211.awb")

						arg_303_1:RecordAudio("322211074", var_306_11)
						arg_303_1:RecordAudio("322211074", var_306_11)
					else
	...
	Play322211075 = function(arg_307_0, arg_307_1)
		...
		function arg_307_1.onSingleLineUpdate_(arg_310_0)
			if 0 < arg_307_1.time_ and arg_307_1.time_ <= 0 + arg_310_0 and not isNil(arg_307_1.actors_["1111ui_story"]) and arg_307_1.var_.characterEffect1111ui_story == nil then
				arg_307_1.var_.characterEffect1111ui_story = arg_307_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_310_0 = 0.200000002980232

			if 0 <= arg_307_1.time_ and arg_307_1.time_ < 0 + var_310_0 and not isNil(arg_307_1.actors_["1111ui_story"]) then
				if arg_307_1.var_.characterEffect1111ui_story and not isNil(arg_307_1.actors_["1111ui_story"]) then
					arg_307_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_307_1.time_ >= 0 + var_310_0 and arg_307_1.time_ < 0 + var_310_0 + arg_310_0 and not isNil(arg_307_1.actors_["1111ui_story"]) and arg_307_1.var_.characterEffect1111ui_story then
				arg_307_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_310_2 = arg_307_1.actors_["10131ui_story"]

			if 0 < arg_307_1.time_ and arg_307_1.time_ <= 0 + arg_310_0 and not isNil(var_310_2) and arg_307_1.var_.characterEffect10131ui_story == nil then
				arg_307_1.var_.characterEffect10131ui_story = var_310_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_310_3 = 0.200000002980232

			if 0 <= arg_307_1.time_ and arg_307_1.time_ < 0 + var_310_3 and not isNil(var_310_2) then
				if arg_307_1.var_.characterEffect10131ui_story and not isNil(var_310_2) then
					arg_307_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_307_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_307_1.time_ - 0) / var_310_3)
				end
			end

			if arg_307_1.time_ >= 0 + var_310_3 and arg_307_1.time_ < 0 + var_310_3 + arg_310_0 and not isNil(var_310_2) and arg_307_1.var_.characterEffect10131ui_story then
				arg_307_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_307_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_307_1.time_ and arg_307_1.time_ <= var_310_4 + arg_310_0 then
				...
				arg_307_1.leftNameTxt_.text = arg_307_1:FormatText(StoryNameCfg[67].name)
				...
				local var_310_6 = arg_307_1:GetWordFromCfg(322211075)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211075", "story_v_out_322211.awb") ~= 0 then
					local var_310_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211075", "story_v_out_322211.awb") / 1000
					...
					if var_310_6.prefab_name ~= "" and arg_307_1.actors_[var_310_6.prefab_name] ~= nil then
						local var_310_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_307_1.actors_[var_310_6.prefab_name].transform, "story_v_out_322211", "322211075", "story_v_out_322211.awb")

						arg_307_1:RecordAudio("322211075", var_310_11)
						arg_307_1:RecordAudio("322211075", var_310_11)
					else
	...
	Play322211076 = function(arg_311_0, arg_311_1)
		...
		function arg_311_1.onSingleLineUpdate_(arg_314_0)
			if 0 < arg_311_1.time_ and arg_311_1.time_ <= 0 + arg_314_0 and not isNil(arg_311_1.actors_["10131ui_story"]) and arg_311_1.var_.characterEffect10131ui_story == nil then
				arg_311_1.var_.characterEffect10131ui_story = arg_311_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_314_0 = 0.200000002980232

			if 0 <= arg_311_1.time_ and arg_311_1.time_ < 0 + var_314_0 and not isNil(arg_311_1.actors_["10131ui_story"]) then
				if arg_311_1.var_.characterEffect10131ui_story and not isNil(arg_311_1.actors_["10131ui_story"]) then
					arg_311_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_311_1.time_ >= 0 + var_314_0 and arg_311_1.time_ < 0 + var_314_0 + arg_314_0 and not isNil(arg_311_1.actors_["10131ui_story"]) and arg_311_1.var_.characterEffect10131ui_story then
				arg_311_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_314_2 = arg_311_1.actors_["1111ui_story"]

			if 0 < arg_311_1.time_ and arg_311_1.time_ <= 0 + arg_314_0 and not isNil(var_314_2) and arg_311_1.var_.characterEffect1111ui_story == nil then
			...
			if 0 <= arg_311_1.time_ and arg_311_1.time_ < 0 + var_314_3 and not isNil(var_314_2) then
				if arg_311_1.var_.characterEffect1111ui_story and not isNil(var_314_2) then
					arg_311_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_311_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_311_1.time_ - 0) / var_314_3)
				end
			end

			if arg_311_1.time_ >= 0 + var_314_3 and arg_311_1.time_ < 0 + var_314_3 + arg_314_0 and not isNil(var_314_2) and arg_311_1.var_.characterEffect1111ui_story then
				arg_311_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_311_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_311_1.time_ and arg_311_1.time_ <= var_314_4 + arg_314_0 then
				...
				arg_311_1.leftNameTxt_.text = arg_311_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_314_6 = arg_311_1:GetWordFromCfg(322211076)
				...
				local var_314_9 = 46 <= 0 and var_314_5 or var_314_5 * (utf8.len(var_314_7) / 46)

				if (46 <= 0 and var_314_5 or var_314_5 * (utf8.len(var_314_7) / 46)) > 0 and var_314_5 < var_314_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211076", "story_v_out_322211.awb") ~= 0 then
					local var_314_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211076", "story_v_out_322211.awb") / 1000
					...
					if var_314_6.prefab_name ~= "" and arg_311_1.actors_[var_314_6.prefab_name] ~= nil then
						local var_314_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_311_1.actors_[var_314_6.prefab_name].transform, "story_v_out_322211", "322211076", "story_v_out_322211.awb")

						arg_311_1:RecordAudio("322211076", var_314_11)
						arg_311_1:RecordAudio("322211076", var_314_11)
					else
	...
	Play322211077 = function(arg_315_0, arg_315_1)
		...
		function arg_315_1.onSingleLineUpdate_(arg_318_0)
			...
			if 0 < arg_315_1.time_ and arg_315_1.time_ <= 0 + arg_318_0 then
				...
				arg_315_1.leftNameTxt_.text = arg_315_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_318_1 = arg_315_1:GetWordFromCfg(322211077)
				...
				local var_318_4 = 58 <= 0 and var_318_0 or var_318_0 * (utf8.len(var_318_2) / 58)

				if (58 <= 0 and var_318_0 or var_318_0 * (utf8.len(var_318_2) / 58)) > 0 and var_318_0 < var_318_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211077", "story_v_out_322211.awb") ~= 0 then
					local var_318_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211077", "story_v_out_322211.awb") / 1000
					...
					if var_318_1.prefab_name ~= "" and arg_315_1.actors_[var_318_1.prefab_name] ~= nil then
						local var_318_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_315_1.actors_[var_318_1.prefab_name].transform, "story_v_out_322211", "322211077", "story_v_out_322211.awb")

						arg_315_1:RecordAudio("322211077", var_318_6)
						arg_315_1:RecordAudio("322211077", var_318_6)
					else
	...
	Play322211078 = function(arg_319_0, arg_319_1)
		...
		function arg_319_1.onSingleLineUpdate_(arg_322_0)
			...
			if 0 < arg_319_1.time_ and arg_319_1.time_ <= 0 + arg_322_0 then
				...
				arg_319_1.leftNameTxt_.text = arg_319_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_322_1 = arg_319_1:GetWordFromCfg(322211078)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211078", "story_v_out_322211.awb") ~= 0 then
					local var_322_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211078", "story_v_out_322211.awb") / 1000
					...
					if var_322_1.prefab_name ~= "" and arg_319_1.actors_[var_322_1.prefab_name] ~= nil then
						local var_322_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_319_1.actors_[var_322_1.prefab_name].transform, "story_v_out_322211", "322211078", "story_v_out_322211.awb")

						arg_319_1:RecordAudio("322211078", var_322_6)
						arg_319_1:RecordAudio("322211078", var_322_6)
					else
	...
	Play322211079 = function(arg_323_0, arg_323_1)
		...
		function arg_323_1.onSingleLineUpdate_(arg_326_0)
			if 0 < arg_323_1.time_ and arg_323_1.time_ <= 0 + arg_326_0 and not isNil(arg_323_1.actors_["1111ui_story"]) and arg_323_1.var_.characterEffect1111ui_story == nil then
				arg_323_1.var_.characterEffect1111ui_story = arg_323_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_326_0 = 0.200000002980232

			if 0 <= arg_323_1.time_ and arg_323_1.time_ < 0 + var_326_0 and not isNil(arg_323_1.actors_["1111ui_story"]) then
				if arg_323_1.var_.characterEffect1111ui_story and not isNil(arg_323_1.actors_["1111ui_story"]) then
					arg_323_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_323_1.time_ >= 0 + var_326_0 and arg_323_1.time_ < 0 + var_326_0 + arg_326_0 and not isNil(arg_323_1.actors_["1111ui_story"]) and arg_323_1.var_.characterEffect1111ui_story then
				arg_323_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_326_2 = arg_323_1.actors_["10131ui_story"]

			if 0 < arg_323_1.time_ and arg_323_1.time_ <= 0 + arg_326_0 and not isNil(var_326_2) and arg_323_1.var_.characterEffect10131ui_story == nil then
				arg_323_1.var_.characterEffect10131ui_story = var_326_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_326_3 = 0.200000002980232

			if 0 <= arg_323_1.time_ and arg_323_1.time_ < 0 + var_326_3 and not isNil(var_326_2) then
				if arg_323_1.var_.characterEffect10131ui_story and not isNil(var_326_2) then
					arg_323_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_323_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_323_1.time_ - 0) / var_326_3)
				end
			end

			if arg_323_1.time_ >= 0 + var_326_3 and arg_323_1.time_ < 0 + var_326_3 + arg_326_0 and not isNil(var_326_2) and arg_323_1.var_.characterEffect10131ui_story then
				arg_323_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_323_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_323_1.time_ and arg_323_1.time_ <= var_326_4 + arg_326_0 then
				...
				arg_323_1.leftNameTxt_.text = arg_323_1:FormatText(StoryNameCfg[67].name)
				...
				local var_326_6 = arg_323_1:GetWordFromCfg(322211079)
				...
				local var_326_9 = 29 <= 0 and var_326_5 or var_326_5 * (utf8.len(var_326_7) / 29)

				if (29 <= 0 and var_326_5 or var_326_5 * (utf8.len(var_326_7) / 29)) > 0 and var_326_5 < var_326_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211079", "story_v_out_322211.awb") ~= 0 then
					local var_326_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211079", "story_v_out_322211.awb") / 1000
					...
					if var_326_6.prefab_name ~= "" and arg_323_1.actors_[var_326_6.prefab_name] ~= nil then
						local var_326_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_323_1.actors_[var_326_6.prefab_name].transform, "story_v_out_322211", "322211079", "story_v_out_322211.awb")

						arg_323_1:RecordAudio("322211079", var_326_11)
						arg_323_1:RecordAudio("322211079", var_326_11)
					else
	...
	Play322211080 = function(arg_327_0, arg_327_1)
		...
		function arg_327_1.onSingleLineUpdate_(arg_330_0)
			if 0 < arg_327_1.time_ and arg_327_1.time_ <= 0 + arg_330_0 and not isNil(arg_327_1.actors_["10131ui_story"]) and arg_327_1.var_.characterEffect10131ui_story == nil then
				arg_327_1.var_.characterEffect10131ui_story = arg_327_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_330_0 = 0.200000002980232

			if 0 <= arg_327_1.time_ and arg_327_1.time_ < 0 + var_330_0 and not isNil(arg_327_1.actors_["10131ui_story"]) then
				if arg_327_1.var_.characterEffect10131ui_story and not isNil(arg_327_1.actors_["10131ui_story"]) then
					arg_327_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_327_1.time_ >= 0 + var_330_0 and arg_327_1.time_ < 0 + var_330_0 + arg_330_0 and not isNil(arg_327_1.actors_["10131ui_story"]) and arg_327_1.var_.characterEffect10131ui_story then
				arg_327_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_330_2 = arg_327_1.actors_["1111ui_story"]

			if 0 < arg_327_1.time_ and arg_327_1.time_ <= 0 + arg_330_0 and not isNil(var_330_2) and arg_327_1.var_.characterEffect1111ui_story == nil then
				arg_327_1.var_.characterEffect1111ui_story = var_330_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_330_3 = 0.200000002980232

			if 0 <= arg_327_1.time_ and arg_327_1.time_ < 0 + var_330_3 and not isNil(var_330_2) then
				if arg_327_1.var_.characterEffect1111ui_story and not isNil(var_330_2) then
					arg_327_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_327_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_327_1.time_ - 0) / var_330_3)
				end
			end

			if arg_327_1.time_ >= 0 + var_330_3 and arg_327_1.time_ < 0 + var_330_3 + arg_330_0 and not isNil(var_330_2) and arg_327_1.var_.characterEffect1111ui_story then
				arg_327_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_327_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_327_1.time_ and arg_327_1.time_ <= var_330_4 + arg_330_0 then
				...
				arg_327_1.leftNameTxt_.text = arg_327_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_330_6 = arg_327_1:GetWordFromCfg(322211080)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211080", "story_v_out_322211.awb") ~= 0 then
					local var_330_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211080", "story_v_out_322211.awb") / 1000
					...
					if var_330_6.prefab_name ~= "" and arg_327_1.actors_[var_330_6.prefab_name] ~= nil then
						local var_330_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_327_1.actors_[var_330_6.prefab_name].transform, "story_v_out_322211", "322211080", "story_v_out_322211.awb")

						arg_327_1:RecordAudio("322211080", var_330_11)
						arg_327_1:RecordAudio("322211080", var_330_11)
					else
	...
	Play322211081 = function(arg_331_0, arg_331_1)
		...
		function arg_331_1.onSingleLineUpdate_(arg_334_0)
			if 0 < arg_331_1.time_ and arg_331_1.time_ <= 0 + arg_334_0 and not isNil(arg_331_1.actors_["1111ui_story"]) and arg_331_1.var_.characterEffect1111ui_story == nil then
				arg_331_1.var_.characterEffect1111ui_story = arg_331_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_334_0 = 0.200000002980232

			if 0 <= arg_331_1.time_ and arg_331_1.time_ < 0 + var_334_0 and not isNil(arg_331_1.actors_["1111ui_story"]) then
				if arg_331_1.var_.characterEffect1111ui_story and not isNil(arg_331_1.actors_["1111ui_story"]) then
					arg_331_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_331_1.time_ >= 0 + var_334_0 and arg_331_1.time_ < 0 + var_334_0 + arg_334_0 and not isNil(arg_331_1.actors_["1111ui_story"]) and arg_331_1.var_.characterEffect1111ui_story then
				arg_331_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_334_2 = arg_331_1.actors_["10131ui_story"]

			if 0 < arg_331_1.time_ and arg_331_1.time_ <= 0 + arg_334_0 and not isNil(var_334_2) and arg_331_1.var_.characterEffect10131ui_story == nil then
				arg_331_1.var_.characterEffect10131ui_story = var_334_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_334_3 = 0.200000002980232

			if 0 <= arg_331_1.time_ and arg_331_1.time_ < 0 + var_334_3 and not isNil(var_334_2) then
				if arg_331_1.var_.characterEffect10131ui_story and not isNil(var_334_2) then
					arg_331_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_331_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_331_1.time_ - 0) / var_334_3)
				end
			end

			if arg_331_1.time_ >= 0 + var_334_3 and arg_331_1.time_ < 0 + var_334_3 + arg_334_0 and not isNil(var_334_2) and arg_331_1.var_.characterEffect10131ui_story then
				arg_331_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_331_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_331_1.time_ and arg_331_1.time_ <= var_334_4 + arg_334_0 then
				...
				arg_331_1.leftNameTxt_.text = arg_331_1:FormatText(StoryNameCfg[67].name)
				...
				local var_334_6 = arg_331_1:GetWordFromCfg(322211081)
				...
				local var_334_9 = 35 <= 0 and var_334_5 or var_334_5 * (utf8.len(var_334_7) / 35)

				if (35 <= 0 and var_334_5 or var_334_5 * (utf8.len(var_334_7) / 35)) > 0 and var_334_5 < var_334_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211081", "story_v_out_322211.awb") ~= 0 then
					local var_334_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211081", "story_v_out_322211.awb") / 1000
					...
					if var_334_6.prefab_name ~= "" and arg_331_1.actors_[var_334_6.prefab_name] ~= nil then
						local var_334_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_331_1.actors_[var_334_6.prefab_name].transform, "story_v_out_322211", "322211081", "story_v_out_322211.awb")

						arg_331_1:RecordAudio("322211081", var_334_11)
						arg_331_1:RecordAudio("322211081", var_334_11)
					else
	...
	Play322211082 = function(arg_335_0, arg_335_1)
		...
		function arg_335_1.onSingleLineUpdate_(arg_338_0)
			...
			if 0 < arg_335_1.time_ and arg_335_1.time_ <= 0 + arg_338_0 then
				...
				local var_338_1 = arg_335_1:GetWordFromCfg(322211082)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211082", "story_v_out_322211.awb") ~= 0 then
					local var_338_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211082", "story_v_out_322211.awb") / 1000
					...
					if var_338_1.prefab_name ~= "" and arg_335_1.actors_[var_338_1.prefab_name] ~= nil then
						local var_338_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_335_1.actors_[var_338_1.prefab_name].transform, "story_v_out_322211", "322211082", "story_v_out_322211.awb")

						arg_335_1:RecordAudio("322211082", var_338_6)
						arg_335_1:RecordAudio("322211082", var_338_6)
					else
	...
	Play322211083 = function(arg_339_0, arg_339_1)
		...
		function arg_339_1.onSingleLineUpdate_(arg_342_0)
			if 0 < arg_339_1.time_ and arg_339_1.time_ <= 0 + arg_342_0 and not isNil(arg_339_1.actors_["10131ui_story"]) and arg_339_1.var_.characterEffect10131ui_story == nil then
				arg_339_1.var_.characterEffect10131ui_story = arg_339_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_342_0 = 0.200000002980232

			if 0 <= arg_339_1.time_ and arg_339_1.time_ < 0 + var_342_0 and not isNil(arg_339_1.actors_["10131ui_story"]) then
				if arg_339_1.var_.characterEffect10131ui_story and not isNil(arg_339_1.actors_["10131ui_story"]) then
					arg_339_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_339_1.time_ >= 0 + var_342_0 and arg_339_1.time_ < 0 + var_342_0 + arg_342_0 and not isNil(arg_339_1.actors_["10131ui_story"]) and arg_339_1.var_.characterEffect10131ui_story then
				arg_339_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_342_2 = arg_339_1.actors_["1111ui_story"]

			if 0 < arg_339_1.time_ and arg_339_1.time_ <= 0 + arg_342_0 and not isNil(var_342_2) and arg_339_1.var_.characterEffect1111ui_story == nil then
				arg_339_1.var_.characterEffect1111ui_story = var_342_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_342_3 = 0.200000002980232

			if 0 <= arg_339_1.time_ and arg_339_1.time_ < 0 + var_342_3 and not isNil(var_342_2) then
				if arg_339_1.var_.characterEffect1111ui_story and not isNil(var_342_2) then
					arg_339_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_339_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_339_1.time_ - 0) / var_342_3)
				end
			end

			if arg_339_1.time_ >= 0 + var_342_3 and arg_339_1.time_ < 0 + var_342_3 + arg_342_0 and not isNil(var_342_2) and arg_339_1.var_.characterEffect1111ui_story then
				arg_339_1.var_.characterEffect1111ui_story.fillFlat = true
			...
			if 0 < arg_339_1.time_ and arg_339_1.time_ <= var_342_4 + arg_342_0 then
				...
				local var_342_6 = arg_339_1:GetWordFromCfg(322211083)
				...
				local var_342_9 = 19 <= 0 and var_342_5 or var_342_5 * (utf8.len(var_342_7) / 19)

				if (19 <= 0 and var_342_5 or var_342_5 * (utf8.len(var_342_7) / 19)) > 0 and var_342_5 < var_342_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211083", "story_v_out_322211.awb") ~= 0 then
					local var_342_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211083", "story_v_out_322211.awb") / 1000
					...
					if var_342_6.prefab_name ~= "" and arg_339_1.actors_[var_342_6.prefab_name] ~= nil then
						local var_342_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_339_1.actors_[var_342_6.prefab_name].transform, "story_v_out_322211", "322211083", "story_v_out_322211.awb")

						arg_339_1:RecordAudio("322211083", var_342_11)
						arg_339_1:RecordAudio("322211083", var_342_11)
					else
	...
	Play322211084 = function(arg_343_0, arg_343_1)
		...
		function arg_343_1.onSingleLineUpdate_(arg_346_0)
			...
			if 0 < arg_343_1.time_ and arg_343_1.time_ <= 0 + arg_346_0 then
				...
				arg_343_1.leftNameTxt_.text = arg_343_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_346_1 = arg_343_1:GetWordFromCfg(322211084)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211084", "story_v_out_322211.awb") ~= 0 then
					local var_346_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211084", "story_v_out_322211.awb") / 1000
					...
					if var_346_1.prefab_name ~= "" and arg_343_1.actors_[var_346_1.prefab_name] ~= nil then
						local var_346_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_343_1.actors_[var_346_1.prefab_name].transform, "story_v_out_322211", "322211084", "story_v_out_322211.awb")

						arg_343_1:RecordAudio("322211084", var_346_6)
						arg_343_1:RecordAudio("322211084", var_346_6)
					else
	...
	Play322211085 = function(arg_347_0, arg_347_1)
		...
		function arg_347_1.onSingleLineUpdate_(arg_350_0)
			...
			if 0 < arg_347_1.time_ and arg_347_1.time_ <= 0 + arg_350_0 then
				...
				arg_347_1.leftNameTxt_.text = arg_347_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_350_1 = arg_347_1:GetWordFromCfg(322211085)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211085", "story_v_out_322211.awb") ~= 0 then
					local var_350_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211085", "story_v_out_322211.awb") / 1000
					...
					if var_350_1.prefab_name ~= "" and arg_347_1.actors_[var_350_1.prefab_name] ~= nil then
						local var_350_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_347_1.actors_[var_350_1.prefab_name].transform, "story_v_out_322211", "322211085", "story_v_out_322211.awb")

						arg_347_1:RecordAudio("322211085", var_350_6)
						arg_347_1:RecordAudio("322211085", var_350_6)
					else
	...
	Play322211086 = function(arg_351_0, arg_351_1)
		...
		function arg_351_1.onSingleLineUpdate_(arg_354_0)
			if 0 < arg_351_1.time_ and arg_351_1.time_ <= 0 + arg_354_0 and not isNil(arg_351_1.actors_["1111ui_story"]) and arg_351_1.var_.characterEffect1111ui_story == nil then
				arg_351_1.var_.characterEffect1111ui_story = arg_351_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_354_0 = 0.200000002980232

			if 0 <= arg_351_1.time_ and arg_351_1.time_ < 0 + var_354_0 and not isNil(arg_351_1.actors_["1111ui_story"]) then
				if arg_351_1.var_.characterEffect1111ui_story and not isNil(arg_351_1.actors_["1111ui_story"]) then
					arg_351_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_351_1.time_ >= 0 + var_354_0 and arg_351_1.time_ < 0 + var_354_0 + arg_354_0 and not isNil(arg_351_1.actors_["1111ui_story"]) and arg_351_1.var_.characterEffect1111ui_story then
				arg_351_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_354_2 = arg_351_1.actors_["10131ui_story"]

			if 0 < arg_351_1.time_ and arg_351_1.time_ <= 0 + arg_354_0 and not isNil(var_354_2) and arg_351_1.var_.characterEffect10131ui_story == nil then
				arg_351_1.var_.characterEffect10131ui_story = var_354_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_354_3 = 0.200000002980232

			if 0 <= arg_351_1.time_ and arg_351_1.time_ < 0 + var_354_3 and not isNil(var_354_2) then
				if arg_351_1.var_.characterEffect10131ui_story and not isNil(var_354_2) then
					arg_351_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_351_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_351_1.time_ - 0) / var_354_3)
				end
			end

			if arg_351_1.time_ >= 0 + var_354_3 and arg_351_1.time_ < 0 + var_354_3 + arg_354_0 and not isNil(var_354_2) and arg_351_1.var_.characterEffect10131ui_story then
				arg_351_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_351_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_351_1.time_ and arg_351_1.time_ <= var_354_4 + arg_354_0 then
				...
				arg_351_1.leftNameTxt_.text = arg_351_1:FormatText(StoryNameCfg[67].name)
				...
				local var_354_6 = arg_351_1:GetWordFromCfg(322211086)
				...
				local var_354_9 = 5 <= 0 and var_354_5 or var_354_5 * (utf8.len(var_354_7) / 5)

				if (5 <= 0 and var_354_5 or var_354_5 * (utf8.len(var_354_7) / 5)) > 0 and var_354_5 < var_354_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211086", "story_v_out_322211.awb") ~= 0 then
					local var_354_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211086", "story_v_out_322211.awb") / 1000
					...
					if var_354_6.prefab_name ~= "" and arg_351_1.actors_[var_354_6.prefab_name] ~= nil then
						local var_354_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_351_1.actors_[var_354_6.prefab_name].transform, "story_v_out_322211", "322211086", "story_v_out_322211.awb")

						arg_351_1:RecordAudio("322211086", var_354_11)
						arg_351_1:RecordAudio("322211086", var_354_11)
					else
	...
	Play322211087 = function(arg_355_0, arg_355_1)
		...
		function arg_355_1.onSingleLineUpdate_(arg_358_0)
			if 0 < arg_355_1.time_ and arg_355_1.time_ <= 0 + arg_358_0 and not isNil(arg_355_1.actors_["10131ui_story"]) and arg_355_1.var_.characterEffect10131ui_story == nil then
				arg_355_1.var_.characterEffect10131ui_story = arg_355_1.actors_["10131ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_358_0 = 0.200000002980232

			if 0 <= arg_355_1.time_ and arg_355_1.time_ < 0 + var_358_0 and not isNil(arg_355_1.actors_["10131ui_story"]) then
				if arg_355_1.var_.characterEffect10131ui_story and not isNil(arg_355_1.actors_["10131ui_story"]) then
					arg_355_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_355_1.time_ >= 0 + var_358_0 and arg_355_1.time_ < 0 + var_358_0 + arg_358_0 and not isNil(arg_355_1.actors_["10131ui_story"]) and arg_355_1.var_.characterEffect10131ui_story then
				arg_355_1.var_.characterEffect10131ui_story.fillFlat = false
			end

			local var_358_2 = arg_355_1.actors_["1111ui_story"]

			if 0 < arg_355_1.time_ and arg_355_1.time_ <= 0 + arg_358_0 and not isNil(var_358_2) and arg_355_1.var_.characterEffect1111ui_story == nil then
				arg_355_1.var_.characterEffect1111ui_story = var_358_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_358_3 = 0.200000002980232

			if 0 <= arg_355_1.time_ and arg_355_1.time_ < 0 + var_358_3 and not isNil(var_358_2) then
				if arg_355_1.var_.characterEffect1111ui_story and not isNil(var_358_2) then
					arg_355_1.var_.characterEffect1111ui_story.fillFlat = true
					arg_355_1.var_.characterEffect1111ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_355_1.time_ - 0) / var_358_3)
				end
			end

			if arg_355_1.time_ >= 0 + var_358_3 and arg_355_1.time_ < 0 + var_358_3 + arg_358_0 and not isNil(var_358_2) and arg_355_1.var_.characterEffect1111ui_story then
				arg_355_1.var_.characterEffect1111ui_story.fillFlat = true
				arg_355_1.var_.characterEffect1111ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_355_1.time_ and arg_355_1.time_ <= var_358_4 + arg_358_0 then
				...
				arg_355_1.leftNameTxt_.text = arg_355_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_358_6 = arg_355_1:GetWordFromCfg(322211087)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211087", "story_v_out_322211.awb") ~= 0 then
					local var_358_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211087", "story_v_out_322211.awb") / 1000
					...
					if var_358_6.prefab_name ~= "" and arg_355_1.actors_[var_358_6.prefab_name] ~= nil then
						local var_358_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_355_1.actors_[var_358_6.prefab_name].transform, "story_v_out_322211", "322211087", "story_v_out_322211.awb")

						arg_355_1:RecordAudio("322211087", var_358_11)
						arg_355_1:RecordAudio("322211087", var_358_11)
					else
	...
	Play322211088 = function(arg_359_0, arg_359_1)
		...
		function arg_359_1.onSingleLineUpdate_(arg_362_0)
			...
			if 0 < arg_359_1.time_ and arg_359_1.time_ <= 0 + arg_362_0 then
				...
				arg_359_1.leftNameTxt_.text = arg_359_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_362_1 = arg_359_1:GetWordFromCfg(322211088)
				...
				local var_362_4 = 36 <= 0 and var_362_0 or var_362_0 * (utf8.len(var_362_2) / 36)

				if (36 <= 0 and var_362_0 or var_362_0 * (utf8.len(var_362_2) / 36)) > 0 and var_362_0 < var_362_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211088", "story_v_out_322211.awb") ~= 0 then
					local var_362_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211088", "story_v_out_322211.awb") / 1000
					...
					if var_362_1.prefab_name ~= "" and arg_359_1.actors_[var_362_1.prefab_name] ~= nil then
						local var_362_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_359_1.actors_[var_362_1.prefab_name].transform, "story_v_out_322211", "322211088", "story_v_out_322211.awb")

						arg_359_1:RecordAudio("322211088", var_362_6)
						arg_359_1:RecordAudio("322211088", var_362_6)
					else
	...
	Play322211089 = function(arg_363_0, arg_363_1)
		...
		function arg_363_1.onSingleLineUpdate_(arg_366_0)
			...
			if 0 < arg_363_1.time_ and arg_363_1.time_ <= 0 + arg_366_0 then
				...
				local var_366_1 = arg_363_1:GetWordFromCfg(322211089)
				...
				local var_366_4 = 29 <= 0 and var_366_0 or var_366_0 * (utf8.len(var_366_2) / 29)

				if (29 <= 0 and var_366_0 or var_366_0 * (utf8.len(var_366_2) / 29)) > 0 and var_366_0 < var_366_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211089", "story_v_out_322211.awb") ~= 0 then
					local var_366_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211089", "story_v_out_322211.awb") / 1000
					...
					if var_366_1.prefab_name ~= "" and arg_363_1.actors_[var_366_1.prefab_name] ~= nil then
						local var_366_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_363_1.actors_[var_366_1.prefab_name].transform, "story_v_out_322211", "322211089", "story_v_out_322211.awb")

						arg_363_1:RecordAudio("322211089", var_366_6)
						arg_363_1:RecordAudio("322211089", var_366_6)
					else
	...
	Play322211090 = function(arg_367_0, arg_367_1)
		...
		function arg_367_1.onSingleLineUpdate_(arg_370_0)
			if 1 < arg_367_1.time_ and arg_367_1.time_ <= 1 + arg_370_0 then
				local var_370_0 = arg_367_1.bgs_.STblack
			...
			if var_370_3 <= arg_367_1.time_ and arg_367_1.time_ < var_370_3 + var_370_4 then
				local var_370_5 = Color.New(0, 0, 0)

				var_370_5.a = Mathf.Lerp(0, 1, (arg_367_1.time_ - var_370_3) / var_370_4)
			...
			if 1 < arg_367_1.time_ and arg_367_1.time_ <= var_370_7 + arg_370_0 then
				arg_367_1.mask_.enabled = true
				arg_367_1.mask_.raycastTarget = true
			...
			if var_370_7 <= arg_367_1.time_ and arg_367_1.time_ < var_370_7 + var_370_8 then
				local var_370_9 = Color.New(0, 0, 0)

				var_370_9.a = Mathf.Lerp(1, 0, (arg_367_1.time_ - var_370_7) / var_370_8)
				arg_367_1.mask_.color = var_370_9
			end
			...
			local var_370_11 = arg_367_1.actors_["1111ui_story"].transform

			if 1 < arg_367_1.time_ and arg_367_1.time_ <= 1 + arg_370_0 then
				arg_367_1.var_.moveOldPos1111ui_story = var_370_11.localPosition
			end

			local var_370_12 = 0.001

			if 1 <= arg_367_1.time_ and arg_367_1.time_ < 1 + var_370_12 then
				var_370_11.localPosition = Vector3.Lerp(arg_367_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_367_1.time_ - 1) / var_370_12)
				var_370_11.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_370_11.position).x, (manager.ui.mainCamera.transform.position - var_370_11.position).y, (manager.ui.mainCamera.transform.position - var_370_11.position).z)
				var_370_11.localEulerAngles.z = 0
				var_370_11.localEulerAngles.x = 0
				var_370_11.localEulerAngles = var_370_11.localEulerAngles
			end

			if arg_367_1.time_ >= 1 + var_370_12 and arg_367_1.time_ < 1 + var_370_12 + arg_370_0 then
			...
			local var_370_13 = arg_367_1.actors_["10131ui_story"].transform

			if 1 < arg_367_1.time_ and arg_367_1.time_ <= 1 + arg_370_0 then
				arg_367_1.var_.moveOldPos10131ui_story = var_370_13.localPosition
			end

			local var_370_14 = 0.001

			if 1 <= arg_367_1.time_ and arg_367_1.time_ < 1 + var_370_14 then
				var_370_13.localPosition = Vector3.Lerp(arg_367_1.var_.moveOldPos10131ui_story, Vector3.New(0, 100, 0), (arg_367_1.time_ - 1) / var_370_14)
			...
			if arg_367_1.time_ >= 1 + var_370_14 and arg_367_1.time_ < 1 + var_370_14 + arg_370_0 then
			...
			local var_370_15 = 2
			local var_370_16 = manager.audio:GetVoiceLength("story_v_out_322211", "322211090", "story_v_out_322211.awb") / 1000

			if var_370_16 > 0 and 12.066 < var_370_16 and var_370_16 + var_370_15 > arg_367_1.duration_ then
				arg_367_1.duration_ = var_370_16 + var_370_15
			end

			if var_370_15 < arg_367_1.time_ and arg_367_1.time_ <= var_370_15 + arg_370_0 then
				arg_367_1:AudioAction("play", "voice", "story_v_out_322211", "322211090", "story_v_out_322211.awb")
			end
		end
	...
	Play322211091 = function(arg_371_0, arg_371_1)
		...
		function arg_371_1.onSingleLineUpdate_(arg_374_0)
			local var_374_0 = manager.audio:GetVoiceLength("story_v_out_322211", "322211091", "story_v_out_322211.awb") / 1000

			if var_374_0 > 0 and 8.233 < var_374_0 and var_374_0 + 0 > arg_371_1.duration_ then
				arg_371_1.duration_ = var_374_0 + 0
			end

			if 0 < arg_371_1.time_ and arg_371_1.time_ <= 0 + arg_374_0 then
				arg_371_1:AudioAction("play", "voice", "story_v_out_322211", "322211091", "story_v_out_322211.awb")
			end
		end
	...
	Play322211092 = function(arg_375_0, arg_375_1)
		...
		function arg_375_1.onSingleLineUpdate_(arg_378_0)
			local var_378_0 = manager.audio:GetVoiceLength("story_v_out_322211", "322211092", "story_v_out_322211.awb") / 1000

			if var_378_0 > 0 and 12.9 < var_378_0 and var_378_0 + 0 > arg_375_1.duration_ then
				arg_375_1.duration_ = var_378_0 + 0
			end

			if 0 < arg_375_1.time_ and arg_375_1.time_ <= 0 + arg_378_0 then
				arg_375_1:AudioAction("play", "voice", "story_v_out_322211", "322211092", "story_v_out_322211.awb")
			end
		end
	...
	Play322211093 = function(arg_379_0, arg_379_1)
		...
		function arg_379_1.onSingleLineUpdate_(arg_382_0)
			if 0.6 < arg_379_1.time_ and arg_379_1.time_ <= 0.6 + arg_382_0 then
				local var_382_0 = arg_379_1.bgs_.L09f

				arg_379_1.bgs_.L09f.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			if 0.6 < arg_379_1.time_ and arg_379_1.time_ <= var_382_7 + arg_382_0 then
				arg_379_1.mask_.enabled = true
				arg_379_1.mask_.raycastTarget = true
			...
			local var_382_11 = arg_379_1.actors_["1111ui_story"].transform

			if 1.6 < arg_379_1.time_ and arg_379_1.time_ <= 1.6 + arg_382_0 then
				arg_379_1.var_.moveOldPos1111ui_story = var_382_11.localPosition
			end

			local var_382_12 = 0.001

			if 1.6 <= arg_379_1.time_ and arg_379_1.time_ < 1.6 + var_382_12 then
				var_382_11.localPosition = Vector3.Lerp(arg_379_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_379_1.time_ - 1.6) / var_382_12)
			...
			if arg_379_1.time_ >= 1.6 + var_382_12 and arg_379_1.time_ < 1.6 + var_382_12 + arg_382_0 then
				var_382_11.localPosition = Vector3.New(0, -0.87, -5.7)
				var_382_11.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_382_11.position).x, (manager.ui.mainCamera.transform.position - var_382_11.position).y, (manager.ui.mainCamera.transform.position - var_382_11.position).z)
				var_382_11.localEulerAngles.z = 0
				var_382_11.localEulerAngles.x = 0
				var_382_11.localEulerAngles = var_382_11.localEulerAngles
			...
			local var_382_13 = arg_379_1.actors_["1111ui_story"]

			if 1.6 < arg_379_1.time_ and arg_379_1.time_ <= 1.6 + arg_382_0 and not isNil(var_382_13) and arg_379_1.var_.characterEffect1111ui_story == nil then
				arg_379_1.var_.characterEffect1111ui_story = var_382_13:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_382_14 = 0.200000002980232

			if 1.6 <= arg_379_1.time_ and arg_379_1.time_ < 1.6 + var_382_14 and not isNil(var_382_13) then
				if arg_379_1.var_.characterEffect1111ui_story and not isNil(var_382_13) then
					arg_379_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_379_1.time_ >= 1.6 + var_382_14 and arg_379_1.time_ < 1.6 + var_382_14 + arg_382_0 and not isNil(var_382_13) and arg_379_1.var_.characterEffect1111ui_story then
				arg_379_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			local var_382_16 = 1.6
			local var_382_17 = 0.275

			if 1.6 < arg_379_1.time_ and arg_379_1.time_ <= var_382_16 + arg_382_0 then
				...
				local var_382_18 = LeanTween.value(arg_379_1.dialog_, 0, 1, 0.3)

				var_382_18:setOnUpdate(LuaHelper.FloatAction(function(arg_383_0)
					arg_379_1.dialogCg_.alpha = arg_383_0
				end))
				var_382_18:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_379_1.dialog_)
					var_382_18:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_382_19 = arg_379_1:GetWordFromCfg(322211093)
				...
				local var_382_22 = 11 <= 0 and var_382_17 or var_382_17 * (utf8.len(var_382_20) / 11)

				if (11 <= 0 and var_382_17 or var_382_17 * (utf8.len(var_382_20) / 11)) > 0 and var_382_17 < var_382_22 then
					arg_379_1.talkMaxDuration = var_382_22
					var_382_16 = var_382_16 + 0.3

					if var_382_22 + var_382_16 > arg_379_1.duration_ then
						arg_379_1.duration_ = var_382_22 + var_382_16
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211093", "story_v_out_322211.awb") ~= 0 then
					local var_382_23 = manager.audio:GetVoiceLength("story_v_out_322211", "322211093", "story_v_out_322211.awb") / 1000

					if var_382_23 + var_382_16 > arg_379_1.duration_ then
						arg_379_1.duration_ = var_382_23 + var_382_16
					end

					if var_382_19.prefab_name ~= "" and arg_379_1.actors_[var_382_19.prefab_name] ~= nil then
						local var_382_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_379_1.actors_[var_382_19.prefab_name].transform, "story_v_out_322211", "322211093", "story_v_out_322211.awb")

						arg_379_1:RecordAudio("322211093", var_382_24)
						arg_379_1:RecordAudio("322211093", var_382_24)
					else
			...
			local var_382_25 = var_382_16 + 0.3
			local var_382_26 = math.max(var_382_17, arg_379_1.talkMaxDuration)

			if var_382_16 + 0.3 <= arg_379_1.time_ and arg_379_1.time_ < var_382_25 + var_382_26 then
				arg_379_1.typewritter.percent = (arg_379_1.time_ - var_382_25) / var_382_26

				arg_379_1.typewritter:SetDirty()
			end

			if arg_379_1.time_ >= var_382_25 + var_382_26 and arg_379_1.time_ < var_382_25 + var_382_26 + arg_382_0 then
	...
	Play322211094 = function(arg_385_0, arg_385_1)
		...
		function arg_385_1.onSingleLineUpdate_(arg_388_0)
			...
			local var_388_2 = arg_385_1.actors_["1111ui_story"].transform

			if 0 < arg_385_1.time_ and arg_385_1.time_ <= 0 + arg_388_0 then
				arg_385_1.var_.moveOldPos1111ui_story = var_388_2.localPosition
			end

			local var_388_3 = 0.001

			if 0 <= arg_385_1.time_ and arg_385_1.time_ < 0 + var_388_3 then
				var_388_2.localPosition = Vector3.Lerp(arg_385_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_385_1.time_ - 0) / var_388_3)
			...
			local var_388_4 = arg_385_1.actors_["10131ui_story"].transform

			if 0 < arg_385_1.time_ and arg_385_1.time_ <= 0 + arg_388_0 then
				arg_385_1.var_.moveOldPos10131ui_story = var_388_4.localPosition
			end

			local var_388_5 = 0.001

			if 0 <= arg_385_1.time_ and arg_385_1.time_ < 0 + var_388_5 then
				var_388_4.localPosition = Vector3.Lerp(arg_385_1.var_.moveOldPos10131ui_story, Vector3.New(0.05, -0.96, -5.8), (arg_385_1.time_ - 0) / var_388_5)
			...
			if arg_385_1.time_ >= 0 + var_388_5 and arg_385_1.time_ < 0 + var_388_5 + arg_388_0 then
				var_388_4.localPosition = Vector3.New(0.05, -0.96, -5.8)
				var_388_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_388_4.position).x, (manager.ui.mainCamera.transform.position - var_388_4.position).y, (manager.ui.mainCamera.transform.position - var_388_4.position).z)
				var_388_4.localEulerAngles.z = 0
				var_388_4.localEulerAngles.x = 0
				var_388_4.localEulerAngles = var_388_4.localEulerAngles
			...
			local var_388_6 = 0
			local var_388_7 = 0.675

			if 0 < arg_385_1.time_ and arg_385_1.time_ <= var_388_6 + arg_388_0 then
				...
				arg_385_1.leftNameTxt_.text = arg_385_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_388_8 = arg_385_1:GetWordFromCfg(322211094)
				...
				local var_388_11 = 27 <= 0 and var_388_7 or var_388_7 * (utf8.len(var_388_9) / 27)

				if (27 <= 0 and var_388_7 or var_388_7 * (utf8.len(var_388_9) / 27)) > 0 and var_388_7 < var_388_11 then
					arg_385_1.talkMaxDuration = var_388_11

					if var_388_11 + var_388_6 > arg_385_1.duration_ then
						arg_385_1.duration_ = var_388_11 + var_388_6
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211094", "story_v_out_322211.awb") ~= 0 then
					local var_388_12 = manager.audio:GetVoiceLength("story_v_out_322211", "322211094", "story_v_out_322211.awb") / 1000
					...
					if var_388_8.prefab_name ~= "" and arg_385_1.actors_[var_388_8.prefab_name] ~= nil then
						local var_388_13 = LuaForUtil.PlayVoiceWithCriLipsync(arg_385_1.actors_[var_388_8.prefab_name].transform, "story_v_out_322211", "322211094", "story_v_out_322211.awb")

						arg_385_1:RecordAudio("322211094", var_388_13)
						arg_385_1:RecordAudio("322211094", var_388_13)
					else
	...
	Play322211095 = function(arg_389_0, arg_389_1)
		...
		function arg_389_1.onSingleLineUpdate_(arg_392_0)
			...
			if 0 < arg_389_1.time_ and arg_389_1.time_ <= var_392_0 + arg_392_0 then
				...
				arg_389_1.leftNameTxt_.text = arg_389_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_392_2 = arg_389_1:GetWordFromCfg(322211095)
				...
				local var_392_5 = 46 <= 0 and var_392_1 or var_392_1 * (utf8.len(var_392_3) / 46)

				if (46 <= 0 and var_392_1 or var_392_1 * (utf8.len(var_392_3) / 46)) > 0 and var_392_1 < var_392_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211095", "story_v_out_322211.awb") ~= 0 then
					local var_392_6 = manager.audio:GetVoiceLength("story_v_out_322211", "322211095", "story_v_out_322211.awb") / 1000
					...
					if var_392_2.prefab_name ~= "" and arg_389_1.actors_[var_392_2.prefab_name] ~= nil then
						local var_392_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_389_1.actors_[var_392_2.prefab_name].transform, "story_v_out_322211", "322211095", "story_v_out_322211.awb")

						arg_389_1:RecordAudio("322211095", var_392_7)
						arg_389_1:RecordAudio("322211095", var_392_7)
					else
	...
	Play322211096 = function(arg_393_0, arg_393_1)
		...
		function arg_393_1.onSingleLineUpdate_(arg_396_0)
			...
			if 0 < arg_393_1.time_ and arg_393_1.time_ <= 0 + arg_396_0 then
				...
				arg_393_1.leftNameTxt_.text = arg_393_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_396_1 = arg_393_1:GetWordFromCfg(322211096)
				...
				local var_396_4 = 41 <= 0 and var_396_0 or var_396_0 * (utf8.len(var_396_2) / 41)

				if (41 <= 0 and var_396_0 or var_396_0 * (utf8.len(var_396_2) / 41)) > 0 and var_396_0 < var_396_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211096", "story_v_out_322211.awb") ~= 0 then
					local var_396_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211096", "story_v_out_322211.awb") / 1000
					...
					if var_396_1.prefab_name ~= "" and arg_393_1.actors_[var_396_1.prefab_name] ~= nil then
						local var_396_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_393_1.actors_[var_396_1.prefab_name].transform, "story_v_out_322211", "322211096", "story_v_out_322211.awb")

						arg_393_1:RecordAudio("322211096", var_396_6)
						arg_393_1:RecordAudio("322211096", var_396_6)
					else
	...
	Play322211097 = function(arg_397_0, arg_397_1)
		...
		function arg_397_1.onSingleLineUpdate_(arg_400_0)
			...
			if 0 < arg_397_1.time_ and arg_397_1.time_ <= 0 + arg_400_0 then
				...
				arg_397_1.leftNameTxt_.text = arg_397_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_400_1 = arg_397_1:GetWordFromCfg(322211097)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211097", "story_v_out_322211.awb") ~= 0 then
					local var_400_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211097", "story_v_out_322211.awb") / 1000
					...
					if var_400_1.prefab_name ~= "" and arg_397_1.actors_[var_400_1.prefab_name] ~= nil then
						local var_400_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_397_1.actors_[var_400_1.prefab_name].transform, "story_v_out_322211", "322211097", "story_v_out_322211.awb")

						arg_397_1:RecordAudio("322211097", var_400_6)
						arg_397_1:RecordAudio("322211097", var_400_6)
					else
	...
	Play322211098 = function(arg_401_0, arg_401_1)
		...
		function arg_401_1.onSingleLineUpdate_(arg_404_0)
			...
			if 0 < arg_401_1.time_ and arg_401_1.time_ <= 0 + arg_404_0 then
				...
				arg_401_1.leftNameTxt_.text = arg_401_1:FormatText(StoryNameCfg[1178].name)
				...
				local var_404_1 = arg_401_1:GetWordFromCfg(322211098)
				...
				local var_404_4 = 46 <= 0 and var_404_0 or var_404_0 * (utf8.len(var_404_2) / 46)

				if (46 <= 0 and var_404_0 or var_404_0 * (utf8.len(var_404_2) / 46)) > 0 and var_404_0 < var_404_4 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211098", "story_v_out_322211.awb") ~= 0 then
					local var_404_5 = manager.audio:GetVoiceLength("story_v_out_322211", "322211098", "story_v_out_322211.awb") / 1000
					...
					if var_404_1.prefab_name ~= "" and arg_401_1.actors_[var_404_1.prefab_name] ~= nil then
						local var_404_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_401_1.actors_[var_404_1.prefab_name].transform, "story_v_out_322211", "322211098", "story_v_out_322211.awb")

						arg_401_1:RecordAudio("322211098", var_404_6)
						arg_401_1:RecordAudio("322211098", var_404_6)
					else
	...
	Play322211099 = function(arg_405_0, arg_405_1)
		...
		function arg_405_1.onSingleLineUpdate_(arg_408_0)
			if 0 < arg_405_1.time_ and arg_405_1.time_ <= 0 + arg_408_0 and not isNil(arg_405_1.actors_["1111ui_story"]) and arg_405_1.var_.characterEffect1111ui_story == nil then
				arg_405_1.var_.characterEffect1111ui_story = arg_405_1.actors_["1111ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_408_0 = 0.200000002980232

			if 0 <= arg_405_1.time_ and arg_405_1.time_ < 0 + var_408_0 and not isNil(arg_405_1.actors_["1111ui_story"]) then
				if arg_405_1.var_.characterEffect1111ui_story and not isNil(arg_405_1.actors_["1111ui_story"]) then
					arg_405_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_405_1.time_ >= 0 + var_408_0 and arg_405_1.time_ < 0 + var_408_0 + arg_408_0 and not isNil(arg_405_1.actors_["1111ui_story"]) and arg_405_1.var_.characterEffect1111ui_story then
				arg_405_1.var_.characterEffect1111ui_story.fillFlat = false
			end

			local var_408_2 = arg_405_1.actors_["10131ui_story"]

			if 0 < arg_405_1.time_ and arg_405_1.time_ <= 0 + arg_408_0 and not isNil(var_408_2) and arg_405_1.var_.characterEffect10131ui_story == nil then
				arg_405_1.var_.characterEffect10131ui_story = var_408_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_408_3 = 0.200000002980232

			if 0 <= arg_405_1.time_ and arg_405_1.time_ < 0 + var_408_3 and not isNil(var_408_2) then
				if arg_405_1.var_.characterEffect10131ui_story and not isNil(var_408_2) then
					arg_405_1.var_.characterEffect10131ui_story.fillFlat = true
					arg_405_1.var_.characterEffect10131ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_405_1.time_ - 0) / var_408_3)
				end
			end

			if arg_405_1.time_ >= 0 + var_408_3 and arg_405_1.time_ < 0 + var_408_3 + arg_408_0 and not isNil(var_408_2) and arg_405_1.var_.characterEffect10131ui_story then
				arg_405_1.var_.characterEffect10131ui_story.fillFlat = true
				arg_405_1.var_.characterEffect10131ui_story.fillRatio = 0.5
			end

			local var_408_4 = arg_405_1.actors_["1111ui_story"].transform

			if 0 < arg_405_1.time_ and arg_405_1.time_ <= 0 + arg_408_0 then
				arg_405_1.var_.moveOldPos1111ui_story = var_408_4.localPosition
			end

			local var_408_5 = 0.001

			if 0 <= arg_405_1.time_ and arg_405_1.time_ < 0 + var_408_5 then
				var_408_4.localPosition = Vector3.Lerp(arg_405_1.var_.moveOldPos1111ui_story, Vector3.New(0, -0.87, -5.7), (arg_405_1.time_ - 0) / var_408_5)
			...
			if arg_405_1.time_ >= 0 + var_408_5 and arg_405_1.time_ < 0 + var_408_5 + arg_408_0 then
				var_408_4.localPosition = Vector3.New(0, -0.87, -5.7)
				var_408_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_408_4.position).x, (manager.ui.mainCamera.transform.position - var_408_4.position).y, (manager.ui.mainCamera.transform.position - var_408_4.position).z)
				var_408_4.localEulerAngles.z = 0
				var_408_4.localEulerAngles.x = 0
				var_408_4.localEulerAngles = var_408_4.localEulerAngles
			...
			local var_408_6 = arg_405_1.actors_["10131ui_story"].transform

			if 0 < arg_405_1.time_ and arg_405_1.time_ <= 0 + arg_408_0 then
				arg_405_1.var_.moveOldPos10131ui_story = var_408_6.localPosition
			end

			local var_408_7 = 0.001

			if 0 <= arg_405_1.time_ and arg_405_1.time_ < 0 + var_408_7 then
				var_408_6.localPosition = Vector3.Lerp(arg_405_1.var_.moveOldPos10131ui_story, Vector3.New(0, 100, 0), (arg_405_1.time_ - 0) / var_408_7)
			...
			if 0 < arg_405_1.time_ and arg_405_1.time_ <= var_408_8 + arg_408_0 then
				...
				arg_405_1.leftNameTxt_.text = arg_405_1:FormatText(StoryNameCfg[67].name)
				...
				local var_408_10 = arg_405_1:GetWordFromCfg(322211099)
				...
				local var_408_13 = 8 <= 0 and var_408_9 or var_408_9 * (utf8.len(var_408_11) / 8)

				if (8 <= 0 and var_408_9 or var_408_9 * (utf8.len(var_408_11) / 8)) > 0 and var_408_9 < var_408_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211099", "story_v_out_322211.awb") ~= 0 then
					local var_408_14 = manager.audio:GetVoiceLength("story_v_out_322211", "322211099", "story_v_out_322211.awb") / 1000
					...
					if var_408_10.prefab_name ~= "" and arg_405_1.actors_[var_408_10.prefab_name] ~= nil then
						local var_408_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_405_1.actors_[var_408_10.prefab_name].transform, "story_v_out_322211", "322211099", "story_v_out_322211.awb")

						arg_405_1:RecordAudio("322211099", var_408_15)
						arg_405_1:RecordAudio("322211099", var_408_15)
					else
	...
	Play322211100 = function(arg_409_0, arg_409_1)
		...
		function arg_409_1.onSingleLineUpdate_(arg_412_0)
			if 0 < arg_409_1.time_ and arg_409_1.time_ <= 0 + arg_412_0 then
				arg_409_1.var_.moveOldPos10131ui_story = arg_409_1.actors_["10131ui_story"].transform.localPosition
			end

			local var_412_0 = 0.001

			if 0 <= arg_409_1.time_ and arg_409_1.time_ < 0 + var_412_0 then
				arg_409_1.actors_["10131ui_story"].transform.localPosition = Vector3.Lerp(arg_409_1.var_.moveOldPos10131ui_story, Vector3.New(0, 100, 0), (arg_409_1.time_ - 0) / var_412_0)
				arg_409_1.actors_["10131ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_409_1.actors_["10131ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_409_1.actors_["10131ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_409_1.actors_["10131ui_story"].transform.position).z)
				arg_409_1.actors_["10131ui_story"].transform.localEulerAngles.z = 0
				arg_409_1.actors_["10131ui_story"].transform.localEulerAngles.x = 0
				arg_409_1.actors_["10131ui_story"].transform.localEulerAngles = arg_409_1.actors_["10131ui_story"].transform.localEulerAngles
			end

			if arg_409_1.time_ >= 0 + var_412_0 and arg_409_1.time_ < 0 + var_412_0 + arg_412_0 then
				arg_409_1.actors_["10131ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_409_1.actors_["10131ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_409_1.actors_["10131ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_409_1.actors_["10131ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_409_1.actors_["10131ui_story"].transform.position).z)
				arg_409_1.actors_["10131ui_story"].transform.localEulerAngles.z = 0
				arg_409_1.actors_["10131ui_story"].transform.localEulerAngles.x = 0
				arg_409_1.actors_["10131ui_story"].transform.localEulerAngles = arg_409_1.actors_["10131ui_story"].transform.localEulerAngles
			...
			local var_412_1 = arg_409_1.actors_["1111ui_story"].transform

			if 0 < arg_409_1.time_ and arg_409_1.time_ <= 0 + arg_412_0 then
				arg_409_1.var_.moveOldPos1111ui_story = var_412_1.localPosition
			end

			local var_412_2 = 0.001

			if 0 <= arg_409_1.time_ and arg_409_1.time_ < 0 + var_412_2 then
				var_412_1.localPosition = Vector3.Lerp(arg_409_1.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (arg_409_1.time_ - 0) / var_412_2)
			...
			if 0 < arg_409_1.time_ and arg_409_1.time_ <= var_412_3 + arg_412_0 then
				...
				local var_412_5 = arg_409_1:FormatText(arg_409_1:GetWordFromCfg(322211100).content)

				arg_409_1.text_.text = var_412_5

				LuaForUtil.ClearLinePrefixSymbol(arg_409_1.text_)

				local var_412_7 = 41 <= 0 and var_412_4 or var_412_4 * (utf8.len(var_412_5) / 41)

				if (41 <= 0 and var_412_4 or var_412_4 * (utf8.len(var_412_5) / 41)) > 0 and var_412_4 < var_412_7 then
	...
	Play322211101 = function(arg_413_0, arg_413_1)
		...
		function arg_413_1.onSingleLineUpdate_(arg_416_0)
			if 0 < arg_413_1.time_ and arg_413_1.time_ <= 0 + arg_416_0 then
				arg_413_1.var_.moveOldPos10131ui_story = arg_413_1.actors_["10131ui_story"].transform.localPosition
			end

			local var_416_0 = 0.001

			if 0 <= arg_413_1.time_ and arg_413_1.time_ < 0 + var_416_0 then
				arg_413_1.actors_["10131ui_story"].transform.localPosition = Vector3.Lerp(arg_413_1.var_.moveOldPos10131ui_story, Vector3.New(0.05, -0.96, -5.8), (arg_413_1.time_ - 0) / var_416_0)
				arg_413_1.actors_["10131ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_413_1.actors_["10131ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_413_1.actors_["10131ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_413_1.actors_["10131ui_story"].transform.position).z)
				arg_413_1.actors_["10131ui_story"].transform.localEulerAngles.z = 0
				arg_413_1.actors_["10131ui_story"].transform.localEulerAngles.x = 0
				arg_413_1.actors_["10131ui_story"].transform.localEulerAngles = arg_413_1.actors_["10131ui_story"].transform.localEulerAngles
			end

			if arg_413_1.time_ >= 0 + var_416_0 and arg_413_1.time_ < 0 + var_416_0 + arg_416_0 then
				arg_413_1.actors_["10131ui_story"].transform.localPosition = Vector3.New(0.05, -0.96, -5.8)
				arg_413_1.actors_["10131ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_413_1.actors_["10131ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_413_1.actors_["10131ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_413_1.actors_["10131ui_story"].transform.position).z)
				arg_413_1.actors_["10131ui_story"].transform.localEulerAngles.z = 0
				arg_413_1.actors_["10131ui_story"].transform.localEulerAngles.x = 0
				arg_413_1.actors_["10131ui_story"].transform.localEulerAngles = arg_413_1.actors_["10131ui_story"].transform.localEulerAngles
			...
			local var_416_1 = arg_413_1.actors_["10131ui_story"]

			if 0 < arg_413_1.time_ and arg_413_1.time_ <= 0 + arg_416_0 and not isNil(var_416_1) and arg_413_1.var_.characterEffect10131ui_story == nil then
				arg_413_1.var_.characterEffect10131ui_story = var_416_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_416_2 = 0.200000002980232

			if 0 <= arg_413_1.time_ and arg_413_1.time_ < 0 + var_416_2 and not isNil(var_416_1) then
				if arg_413_1.var_.characterEffect10131ui_story and not isNil(var_416_1) then
					arg_413_1.var_.characterEffect10131ui_story.fillFlat = false
				end
			end

			if arg_413_1.time_ >= 0 + var_416_2 and arg_413_1.time_ < 0 + var_416_2 + arg_416_0 and not isNil(var_416_1) and arg_413_1.var_.characterEffect10131ui_story then
				arg_413_1.var_.characterEffect10131ui_story.fillFlat = false
			end
			...
			if 0 < arg_413_1.time_ and arg_413_1.time_ <= var_416_4 + arg_416_0 then
				...
				arg_413_1.leftNameTxt_.text = arg_413_1:FormatText(StoryNameCfg[1366].name)
				...
				local var_416_6 = arg_413_1:GetWordFromCfg(322211101)
				...
				if manager.audio:GetVoiceLength("story_v_out_322211", "322211101", "story_v_out_322211.awb") ~= 0 then
					local var_416_10 = manager.audio:GetVoiceLength("story_v_out_322211", "322211101", "story_v_out_322211.awb") / 1000
					...
					if var_416_6.prefab_name ~= "" and arg_413_1.actors_[var_416_6.prefab_name] ~= nil then
						local var_416_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_413_1.actors_[var_416_6.prefab_name].transform, "story_v_out_322211", "322211101", "story_v_out_322211.awb")

						arg_413_1:RecordAudio("322211101", var_416_11)
						arg_413_1:RecordAudio("322211101", var_416_11)
					else
