	...
	Play320171007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 2 < arg_29_1.time_ and arg_29_1.time_ <= 2 + arg_32_0 then
				...
				for iter_32_6, iter_32_7 in ipairs((var_32_29.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_32_7.transform.localScale = Vector3.New(iter_32_7.transform.localScale.x / var_32_31 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_32_7.transform.localScale.y / var_32_31, iter_32_7.transform.localScale.z)
				end
			end
			...
			if 3.7 < arg_29_1.time_ and arg_29_1.time_ <= var_32_33 + arg_32_0 then
				...
				local var_32_36 = arg_29_1:GetWordFromCfg(320171007)
				...
				local var_32_39 = 14 <= 0 and var_32_34 or var_32_34 * (utf8.len(var_32_37) / 14)

				if (14 <= 0 and var_32_34 or var_32_34 * (utf8.len(var_32_37) / 14)) > 0 and var_32_34 < var_32_39 then
				...
				if manager.audio:GetVoiceLength("story_v_out_320171", "320171007", "story_v_out_320171.awb") ~= 0 then
					local var_32_40 = manager.audio:GetVoiceLength("story_v_out_320171", "320171007", "story_v_out_320171.awb") / 1000
					...
					if var_32_36.prefab_name ~= "" and arg_29_1.actors_[var_32_36.prefab_name] ~= nil then
						local var_32_41 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_36.prefab_name].transform, "story_v_out_320171", "320171007", "story_v_out_320171.awb")

						arg_29_1:RecordAudio("320171007", var_32_41)
						arg_29_1:RecordAudio("320171007", var_32_41)
					else
	...
	Play320171027 = function(arg_113_0, arg_113_1)
		...
		function arg_113_1.onSingleLineUpdate_(arg_116_0)
			...
			if 2 < arg_113_1.time_ and arg_113_1.time_ <= 2 + arg_116_0 then
				...
				for iter_116_2, iter_116_3 in ipairs((var_116_23.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_116_3.transform.localScale = Vector3.New(iter_116_3.transform.localScale.x / var_116_25 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_116_3.transform.localScale.y / var_116_25, iter_116_3.transform.localScale.z)
				end
			end
			...
			local var_116_27 = 3.999999999999
			local var_116_28 = 1.275

			if 3.999999999999 < arg_113_1.time_ and arg_113_1.time_ <= var_116_27 + arg_116_0 then
				...
				local var_116_29 = LeanTween.value(arg_113_1.dialog_, 0, 1, 0.3)

				var_116_29:setOnUpdate(LuaHelper.FloatAction(function(arg_119_0)
					arg_113_1.dialogCg_.alpha = arg_119_0
				end))
				var_116_29:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_113_1.dialog_)
					var_116_29:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_116_30 = arg_113_1:FormatText(arg_113_1:GetWordFromCfg(320171027).content)

				arg_113_1.text_.text = var_116_30

				LuaForUtil.ClearLinePrefixSymbol(arg_113_1.text_)

				local var_116_32 = 51 <= 0 and var_116_28 or var_116_28 * (utf8.len(var_116_30) / 51)

				if (51 <= 0 and var_116_28 or var_116_28 * (utf8.len(var_116_30) / 51)) > 0 and var_116_28 < var_116_32 then
					arg_113_1.talkMaxDuration = var_116_32
					var_116_27 = var_116_27 + 0.3

					if var_116_32 + var_116_27 > arg_113_1.duration_ then
						arg_113_1.duration_ = var_116_32 + var_116_27
					end
				end
			...
			local var_116_33 = var_116_27 + 0.3
			local var_116_34 = math.max(var_116_28, arg_113_1.talkMaxDuration)

			if var_116_27 + 0.3 <= arg_113_1.time_ and arg_113_1.time_ < var_116_33 + var_116_34 then
				arg_113_1.typewritter.percent = (arg_113_1.time_ - var_116_33) / var_116_34
