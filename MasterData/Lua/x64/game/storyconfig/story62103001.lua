return {
	Play62103001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				local var_4_17 = arg_1_1:GetWordFromCfg(62103001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62103", "62103001", "story_v_chess_62103.awb") ~= 0 then
					local var_4_21 = manager.audio:GetVoiceLength("story_v_chess_62103", "62103001", "story_v_chess_62103.awb") / 1000
					...
					if var_4_17.prefab_name ~= "" and arg_1_1.actors_[var_4_17.prefab_name] ~= nil then
						local var_4_22 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_17.prefab_name].transform, "story_v_chess_62103", "62103001", "story_v_chess_62103.awb")

						arg_1_1:RecordAudio("62103001", var_4_22)
						arg_1_1:RecordAudio("62103001", var_4_22)
					else
	...
	Play62103002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= 0 + arg_12_0 then
				...
				local var_12_1 = arg_9_1:GetWordFromCfg(62103002)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62103", "62103002", "story_v_chess_62103.awb") ~= 0 then
					local var_12_5 = manager.audio:GetVoiceLength("story_v_chess_62103", "62103002", "story_v_chess_62103.awb") / 1000
					...
					if var_12_1.prefab_name ~= "" and arg_9_1.actors_[var_12_1.prefab_name] ~= nil then
						local var_12_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_1.prefab_name].transform, "story_v_chess_62103", "62103002", "story_v_chess_62103.awb")

						arg_9_1:RecordAudio("62103002", var_12_6)
						arg_9_1:RecordAudio("62103002", var_12_6)
					else
	...
	Play62103003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_10 = arg_13_1:GetWordFromCfg(62103003)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62103", "62103003", "story_v_chess_62103.awb") ~= 0 then
					local var_16_14 = manager.audio:GetVoiceLength("story_v_chess_62103", "62103003", "story_v_chess_62103.awb") / 1000
					...
					if var_16_10.prefab_name ~= "" and arg_13_1.actors_[var_16_10.prefab_name] ~= nil then
						local var_16_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_10.prefab_name].transform, "story_v_chess_62103", "62103003", "story_v_chess_62103.awb")

						arg_13_1:RecordAudio("62103003", var_16_15)
						arg_13_1:RecordAudio("62103003", var_16_15)
					else
	...
	Play62103004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:FormatText(arg_17_1:GetWordFromCfg(62103004).content)
	...
	Play62103005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_3 + arg_24_0 then
				...
				local var_24_5 = arg_21_1:GetWordFromCfg(62103005)
				...
				local var_24_8 = 31 <= 0 and var_24_4 or var_24_4 * (utf8.len(var_24_6) / 31)

				if (31 <= 0 and var_24_4 or var_24_4 * (utf8.len(var_24_6) / 31)) > 0 and var_24_4 < var_24_8 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62103", "62103005", "story_v_chess_62103.awb") ~= 0 then
					local var_24_9 = manager.audio:GetVoiceLength("story_v_chess_62103", "62103005", "story_v_chess_62103.awb") / 1000
					...
					if var_24_5.prefab_name ~= "" and arg_21_1.actors_[var_24_5.prefab_name] ~= nil then
						local var_24_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_5.prefab_name].transform, "story_v_chess_62103", "62103005", "story_v_chess_62103.awb")

						arg_21_1:RecordAudio("62103005", var_24_10)
						arg_21_1:RecordAudio("62103005", var_24_10)
					else
	...
	Play62103006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			if arg_25_1.actors_["1111_1"] == nil then
				local var_28_0 = Object.Instantiate(arg_25_1.imageGo_, arg_25_1.canvasGo_.transform)

				var_28_0.transform:SetSiblingIndex(1)

				var_28_0.name = "1111_1"

				local var_28_1 = var_28_0:GetComponent(typeof(Image))

				var_28_1.sprite = getSpriteWithoutAtlas("TextureConfig/Character/Portrait/" .. "1111_1")

				var_28_1:SetNativeSize()

				var_28_0.transform.localPosition = Vector3.New(0, 100000, 0)
				arg_25_1.actors_["1111_1"] = var_28_0
			end

			local var_28_2 = arg_25_1.actors_["1111_1"]

			if 0 < arg_25_1.time_ and arg_25_1.time_ <= 0 + arg_28_0 and not isNil(var_28_2) then
				local var_28_3 = var_28_2:GetComponent("Image")

				if var_28_3 then
					arg_25_1.var_.highlightMatValue1111_1 = var_28_3
				end
			end

			local var_28_4 = 0.2

			if 0 <= arg_25_1.time_ and arg_25_1.time_ < 0 + var_28_4 and not isNil(var_28_2) then
				if arg_25_1.var_.highlightMatValue1111_1 then
					local var_28_5 = Mathf.Lerp(1, 0.5, (arg_25_1.time_ - 0) / var_28_4)

					arg_25_1.var_.highlightMatValue1111_1.color.r = var_28_5
					arg_25_1.var_.highlightMatValue1111_1.color.g = var_28_5
					arg_25_1.var_.highlightMatValue1111_1.color.b = var_28_5
					arg_25_1.var_.highlightMatValue1111_1.color = arg_25_1.var_.highlightMatValue1111_1.color
				end
			end

			if arg_25_1.time_ >= 0 + var_28_4 and arg_25_1.time_ < 0 + var_28_4 + arg_28_0 and not isNil(var_28_2) and arg_25_1.var_.highlightMatValue1111_1 then
				arg_25_1.var_.highlightMatValue1111_1.color.r = 0.5
				arg_25_1.var_.highlightMatValue1111_1.color.g = 0.5
				arg_25_1.var_.highlightMatValue1111_1.color.b = 0.5
				arg_25_1.var_.highlightMatValue1111_1.color = arg_25_1.var_.highlightMatValue1111_1.color
			end
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_6 + arg_28_0 then
				...
				local var_28_8 = arg_25_1:FormatText(arg_25_1:GetWordFromCfg(62103006).content)

				arg_25_1.text_.text = var_28_8

				LuaForUtil.ClearLinePrefixSymbol(arg_25_1.text_)

				local var_28_10 = 21 <= 0 and var_28_7 or var_28_7 * (utf8.len(var_28_8) / 21)

				if (21 <= 0 and var_28_7 or var_28_7 * (utf8.len(var_28_8) / 21)) > 0 and var_28_7 < var_28_10 then
