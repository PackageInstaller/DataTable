return {
	Play120131001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_14 = "1069ui_story"

			if arg_1_1.actors_["1069ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1069ui_story"))) then
				local var_4_15 = Object.Instantiate(Asset.Load("Char/" .. "1069ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_18 = arg_1_1.actors_["1069ui_story"].transform

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 then
				arg_1_1.var_.moveOldPos1069ui_story = var_4_18.localPosition
			end

			local var_4_19 = 0.001

			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_19 then
				var_4_18.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1069ui_story, Vector3.New(0.7, -1, -6), (arg_1_1.time_ - 2) / var_4_19)
			...
			if arg_1_1.time_ >= 2 + var_4_19 and arg_1_1.time_ < 2 + var_4_19 + arg_4_0 then
				var_4_18.localPosition = Vector3.New(0.7, -1, -6)
				var_4_18.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_4_18.position).x, (manager.ui.mainCamera.transform.position - var_4_18.position).y, (manager.ui.mainCamera.transform.position - var_4_18.position).z)
				var_4_18.localEulerAngles.z = 0
				var_4_18.localEulerAngles.x = 0
				var_4_18.localEulerAngles = var_4_18.localEulerAngles
			...
			local var_4_20 = arg_1_1.actors_["1075ui_story"]

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_20) and arg_1_1.var_.characterEffect1075ui_story == nil then
				arg_1_1.var_.characterEffect1075ui_story = var_4_20:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_21 = 0.2

			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_21 and not isNil(var_4_20) then
				if arg_1_1.var_.characterEffect1075ui_story and not isNil(var_4_20) then
					arg_1_1.var_.characterEffect1075ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 2 + var_4_21 and arg_1_1.time_ < 2 + var_4_21 + arg_4_0 and not isNil(var_4_20) and arg_1_1.var_.characterEffect1075ui_story then
				arg_1_1.var_.characterEffect1075ui_story.fillFlat = false
			end

			local var_4_23 = arg_1_1.actors_["1069ui_story"]

			if 2 < arg_1_1.time_ and arg_1_1.time_ <= 2 + arg_4_0 and not isNil(var_4_23) and arg_1_1.var_.characterEffect1069ui_story == nil then
				arg_1_1.var_.characterEffect1069ui_story = var_4_23:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_24 = 0.2

			if 2 <= arg_1_1.time_ and arg_1_1.time_ < 2 + var_4_24 and not isNil(var_4_23) then
				if arg_1_1.var_.characterEffect1069ui_story and not isNil(var_4_23) then
					arg_1_1.var_.characterEffect1069ui_story.fillFlat = true
					arg_1_1.var_.characterEffect1069ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_1_1.time_ - 2) / var_4_24)
				end
			end

			if arg_1_1.time_ >= 2 + var_4_24 and arg_1_1.time_ < 2 + var_4_24 + arg_4_0 and not isNil(var_4_23) and arg_1_1.var_.characterEffect1069ui_story then
				arg_1_1.var_.characterEffect1069ui_story.fillFlat = true
				arg_1_1.var_.characterEffect1069ui_story.fillRatio = 0.5
			end
			...
			if 0.3 < arg_1_1.time_ and arg_1_1.time_ <= 0.3 + arg_4_0 then
				...
				local var_4_30 = manager.audio:GetAudioName("bgm_story_v0_battleground", "bgm_story_v0_battleground")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_31 + arg_4_0 then
				...
				local var_4_34 = arg_1_1:GetWordFromCfg(120131001)
				...
				local var_4_37 = 35 <= 0 and var_4_32 or var_4_32 * (utf8.len(var_4_35) / 35)

				if (35 <= 0 and var_4_32 or var_4_32 * (utf8.len(var_4_35) / 35)) > 0 and var_4_32 < var_4_37 then
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131001", "story_v_out_120131.awb") ~= 0 then
					local var_4_38 = manager.audio:GetVoiceLength("story_v_out_120131", "120131001", "story_v_out_120131.awb") / 1000
					...
					if var_4_34.prefab_name ~= "" and arg_1_1.actors_[var_4_34.prefab_name] ~= nil then
						local var_4_39 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_34.prefab_name].transform, "story_v_out_120131", "120131001", "story_v_out_120131.awb")

						arg_1_1:RecordAudio("120131001", var_4_39)
						arg_1_1:RecordAudio("120131001", var_4_39)
					else
	...
	Play120131002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				...
				local var_12_2 = arg_9_1:GetWordFromCfg(120131002)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131002", "story_v_out_120131.awb") ~= 0 then
					local var_12_6 = manager.audio:GetVoiceLength("story_v_out_120131", "120131002", "story_v_out_120131.awb") / 1000
					...
					if var_12_2.prefab_name ~= "" and arg_9_1.actors_[var_12_2.prefab_name] ~= nil then
						local var_12_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_2.prefab_name].transform, "story_v_out_120131", "120131002", "story_v_out_120131.awb")

						arg_9_1:RecordAudio("120131002", var_12_7)
						arg_9_1:RecordAudio("120131002", var_12_7)
					else
	...
	Play120131003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_4 + arg_16_0 then
				...
				local var_16_6 = arg_13_1:GetWordFromCfg(120131003)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131003", "story_v_out_120131.awb") ~= 0 then
					local var_16_10 = manager.audio:GetVoiceLength("story_v_out_120131", "120131003", "story_v_out_120131.awb") / 1000
					...
					if var_16_6.prefab_name ~= "" and arg_13_1.actors_[var_16_6.prefab_name] ~= nil then
						local var_16_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_6.prefab_name].transform, "story_v_out_120131", "120131003", "story_v_out_120131.awb")

						arg_13_1:RecordAudio("120131003", var_16_11)
						arg_13_1:RecordAudio("120131003", var_16_11)
					else
	...
	Play120131004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(arg_17_1.actors_["1069ui_story"]) and arg_17_1.var_.characterEffect1069ui_story == nil then
				arg_17_1.var_.characterEffect1069ui_story = arg_17_1.actors_["1069ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_0 = 0.2

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_0 and not isNil(arg_17_1.actors_["1069ui_story"]) then
				if arg_17_1.var_.characterEffect1069ui_story and not isNil(arg_17_1.actors_["1069ui_story"]) then
					arg_17_1.var_.characterEffect1069ui_story.fillFlat = true
					arg_17_1.var_.characterEffect1069ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_17_1.time_ - 0) / var_20_0)
				end
			end

			if arg_17_1.time_ >= 0 + var_20_0 and arg_17_1.time_ < 0 + var_20_0 + arg_20_0 and not isNil(arg_17_1.actors_["1069ui_story"]) and arg_17_1.var_.characterEffect1069ui_story then
				arg_17_1.var_.characterEffect1069ui_story.fillFlat = true
				arg_17_1.var_.characterEffect1069ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_4 + arg_20_0 then
				...
				local var_20_6 = arg_17_1:GetWordFromCfg(120131004)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131004", "story_v_out_120131.awb") ~= 0 then
					local var_20_10 = manager.audio:GetVoiceLength("story_v_out_120131", "120131004", "story_v_out_120131.awb") / 1000
					...
					if var_20_6.prefab_name ~= "" and arg_17_1.actors_[var_20_6.prefab_name] ~= nil then
						local var_20_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_6.prefab_name].transform, "story_v_out_120131", "120131004", "story_v_out_120131.awb")

						arg_17_1:RecordAudio("120131004", var_20_11)
						arg_17_1:RecordAudio("120131004", var_20_11)
					else
	...
	Play120131005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			local var_24_2 = arg_21_1.actors_["1075ui_story"]

			if 0 < arg_21_1.time_ and arg_21_1.time_ <= 0 + arg_24_0 and not isNil(var_24_2) and arg_21_1.var_.characterEffect1075ui_story == nil then
				arg_21_1.var_.characterEffect1075ui_story = var_24_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_24_3 = 0.2

			if 0 <= arg_21_1.time_ and arg_21_1.time_ < 0 + var_24_3 and not isNil(var_24_2) then
				if arg_21_1.var_.characterEffect1075ui_story and not isNil(var_24_2) then
					arg_21_1.var_.characterEffect1075ui_story.fillFlat = true
					arg_21_1.var_.characterEffect1075ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_21_1.time_ - 0) / var_24_3)
				end
			end

			if arg_21_1.time_ >= 0 + var_24_3 and arg_21_1.time_ < 0 + var_24_3 + arg_24_0 and not isNil(var_24_2) and arg_21_1.var_.characterEffect1075ui_story then
				arg_21_1.var_.characterEffect1075ui_story.fillFlat = true
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_4 + arg_24_0 then
				...
				local var_24_6 = arg_21_1:GetWordFromCfg(120131005)
				...
				local var_24_9 = 17 <= 0 and var_24_5 or var_24_5 * (utf8.len(var_24_7) / 17)

				if (17 <= 0 and var_24_5 or var_24_5 * (utf8.len(var_24_7) / 17)) > 0 and var_24_5 < var_24_9 then
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131005", "story_v_out_120131.awb") ~= 0 then
					local var_24_10 = manager.audio:GetVoiceLength("story_v_out_120131", "120131005", "story_v_out_120131.awb") / 1000
					...
					if var_24_6.prefab_name ~= "" and arg_21_1.actors_[var_24_6.prefab_name] ~= nil then
						local var_24_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_6.prefab_name].transform, "story_v_out_120131", "120131005", "story_v_out_120131.awb")

						arg_21_1:RecordAudio("120131005", var_24_11)
						arg_21_1:RecordAudio("120131005", var_24_11)
					else
	...
	Play120131006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_2 = arg_25_1:GetWordFromCfg(120131006)
				...
				local var_28_5 = 15 <= 0 and var_28_1 or var_28_1 * (utf8.len(var_28_3) / 15)

				if (15 <= 0 and var_28_1 or var_28_1 * (utf8.len(var_28_3) / 15)) > 0 and var_28_1 < var_28_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131006", "story_v_out_120131.awb") ~= 0 then
					local var_28_6 = manager.audio:GetVoiceLength("story_v_out_120131", "120131006", "story_v_out_120131.awb") / 1000
					...
					if var_28_2.prefab_name ~= "" and arg_25_1.actors_[var_28_2.prefab_name] ~= nil then
						local var_28_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_2.prefab_name].transform, "story_v_out_120131", "120131006", "story_v_out_120131.awb")

						arg_25_1:RecordAudio("120131006", var_28_7)
						arg_25_1:RecordAudio("120131006", var_28_7)
					else
	...
	Play120131007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_4 + arg_32_0 then
				...
				local var_32_6 = arg_29_1:GetWordFromCfg(120131007)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131007", "story_v_out_120131.awb") ~= 0 then
					local var_32_10 = manager.audio:GetVoiceLength("story_v_out_120131", "120131007", "story_v_out_120131.awb") / 1000
					...
					if var_32_6.prefab_name ~= "" and arg_29_1.actors_[var_32_6.prefab_name] ~= nil then
						local var_32_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_6.prefab_name].transform, "story_v_out_120131", "120131007", "story_v_out_120131.awb")

						arg_29_1:RecordAudio("120131007", var_32_11)
						arg_29_1:RecordAudio("120131007", var_32_11)
					else
	...
	Play120131008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			local var_36_2 = arg_33_1.actors_["1075ui_story"]

			if 0 < arg_33_1.time_ and arg_33_1.time_ <= 0 + arg_36_0 and not isNil(var_36_2) and arg_33_1.var_.characterEffect1075ui_story == nil then
				arg_33_1.var_.characterEffect1075ui_story = var_36_2:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_36_3 = 0.2

			if 0 <= arg_33_1.time_ and arg_33_1.time_ < 0 + var_36_3 and not isNil(var_36_2) then
				if arg_33_1.var_.characterEffect1075ui_story and not isNil(var_36_2) then
					arg_33_1.var_.characterEffect1075ui_story.fillFlat = true
					arg_33_1.var_.characterEffect1075ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_33_1.time_ - 0) / var_36_3)
				end
			end

			if arg_33_1.time_ >= 0 + var_36_3 and arg_33_1.time_ < 0 + var_36_3 + arg_36_0 and not isNil(var_36_2) and arg_33_1.var_.characterEffect1075ui_story then
				arg_33_1.var_.characterEffect1075ui_story.fillFlat = true
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_4 + arg_36_0 then
				...
				local var_36_6 = arg_33_1:GetWordFromCfg(120131008)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131008", "story_v_out_120131.awb") ~= 0 then
					local var_36_10 = manager.audio:GetVoiceLength("story_v_out_120131", "120131008", "story_v_out_120131.awb") / 1000
					...
					if var_36_6.prefab_name ~= "" and arg_33_1.actors_[var_36_6.prefab_name] ~= nil then
						local var_36_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_6.prefab_name].transform, "story_v_out_120131", "120131008", "story_v_out_120131.awb")

						arg_33_1:RecordAudio("120131008", var_36_11)
						arg_33_1:RecordAudio("120131008", var_36_11)
					else
	...
	Play120131009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_4 + arg_40_0 then
				...
				local var_40_6 = arg_37_1:GetWordFromCfg(120131009)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131009", "story_v_out_120131.awb") ~= 0 then
					local var_40_10 = manager.audio:GetVoiceLength("story_v_out_120131", "120131009", "story_v_out_120131.awb") / 1000
					...
					if var_40_6.prefab_name ~= "" and arg_37_1.actors_[var_40_6.prefab_name] ~= nil then
						local var_40_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_37_1.actors_[var_40_6.prefab_name].transform, "story_v_out_120131", "120131009", "story_v_out_120131.awb")

						arg_37_1:RecordAudio("120131009", var_40_11)
						arg_37_1:RecordAudio("120131009", var_40_11)
					else
	...
	Play120131010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_0 + arg_44_0 then
				...
				local var_44_2 = arg_41_1:GetWordFromCfg(120131010)
				...
				local var_44_5 = 21 <= 0 and var_44_1 or var_44_1 * (utf8.len(var_44_3) / 21)

				if (21 <= 0 and var_44_1 or var_44_1 * (utf8.len(var_44_3) / 21)) > 0 and var_44_1 < var_44_5 then
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131010", "story_v_out_120131.awb") ~= 0 then
					local var_44_6 = manager.audio:GetVoiceLength("story_v_out_120131", "120131010", "story_v_out_120131.awb") / 1000
					...
					if var_44_2.prefab_name ~= "" and arg_41_1.actors_[var_44_2.prefab_name] ~= nil then
						local var_44_7 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_2.prefab_name].transform, "story_v_out_120131", "120131010", "story_v_out_120131.awb")

						arg_41_1:RecordAudio("120131010", var_44_7)
						arg_41_1:RecordAudio("120131010", var_44_7)
					else
	...
	Play120131011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= 0 + arg_48_0 then
				arg_45_1.var_.moveOldPos1069ui_story = arg_45_1.actors_["1069ui_story"].transform.localPosition
			end

			local var_48_0 = 0.001

			if 0 <= arg_45_1.time_ and arg_45_1.time_ < 0 + var_48_0 then
				arg_45_1.actors_["1069ui_story"].transform.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1069ui_story, Vector3.New(0, 100, 0), (arg_45_1.time_ - 0) / var_48_0)
				arg_45_1.actors_["1069ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["1069ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1069ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1069ui_story"].transform.position).z)
				arg_45_1.actors_["1069ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["1069ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["1069ui_story"].transform.localEulerAngles = arg_45_1.actors_["1069ui_story"].transform.localEulerAngles
			end

			if arg_45_1.time_ >= 0 + var_48_0 and arg_45_1.time_ < 0 + var_48_0 + arg_48_0 then
				arg_45_1.actors_["1069ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_45_1.actors_["1069ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_45_1.actors_["1069ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1069ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_45_1.actors_["1069ui_story"].transform.position).z)
				arg_45_1.actors_["1069ui_story"].transform.localEulerAngles.z = 0
				arg_45_1.actors_["1069ui_story"].transform.localEulerAngles.x = 0
				arg_45_1.actors_["1069ui_story"].transform.localEulerAngles = arg_45_1.actors_["1069ui_story"].transform.localEulerAngles
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_3 + arg_48_0 then
				...
				local var_48_5 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(120131011).content)
	...
	Play120131012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_jianbing01", "")
			end
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_1 + arg_52_0 then
				...
				local var_52_3 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(120131012).content)
	...
	Play120131013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= 0 + arg_56_0 then
				arg_53_1:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_jianbing02", "")
			end
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_4 + arg_56_0 then
				...
				arg_53_1.leftNameTxt_.text = arg_53_1:FormatText(StoryNameCfg[378].name)
				...
				local var_56_6 = arg_53_1:GetWordFromCfg(120131013)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131013", "story_v_out_120131.awb") ~= 0 then
					local var_56_10 = manager.audio:GetVoiceLength("story_v_out_120131", "120131013", "story_v_out_120131.awb") / 1000
					...
					if var_56_6.prefab_name ~= "" and arg_53_1.actors_[var_56_6.prefab_name] ~= nil then
						local var_56_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_6.prefab_name].transform, "story_v_out_120131", "120131013", "story_v_out_120131.awb")

						arg_53_1:RecordAudio("120131013", var_56_11)
						arg_53_1:RecordAudio("120131013", var_56_11)
					else
	...
	Play120131014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			local var_60_7 = arg_57_1.bgs_.J03f.transform

			if 0 < arg_57_1.time_ and arg_57_1.time_ <= 0 + arg_60_0 then
				arg_57_1.var_.moveOldPosJ03f = var_60_7.localPosition
			end

			local var_60_8 = 3.5

			if 0 <= arg_57_1.time_ and arg_57_1.time_ < 0 + var_60_8 then
				var_60_7.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPosJ03f, Vector3.New(0, 1, 9.5), (arg_57_1.time_ - 0) / var_60_8)
			end

			if arg_57_1.time_ >= 0 + var_60_8 and arg_57_1.time_ < 0 + var_60_8 + arg_60_0 then
				var_60_7.localPosition = Vector3.New(0, 1, 9.5)
			end
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_9 + arg_60_0 then
				...
				local var_60_11 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(120131014).content)

				arg_57_1.text_.text = var_60_11

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_13 = 48 <= 0 and var_60_10 or var_60_10 * (utf8.len(var_60_11) / 48)

				if (48 <= 0 and var_60_10 or var_60_10 * (utf8.len(var_60_11) / 48)) > 0 and var_60_10 < var_60_13 then
	...
	Play120131015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= 0 + arg_64_0 then
				...
				local var_64_1 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(120131015).content)
	...
	Play120131016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 and not isNil(arg_65_1.actors_["1069ui_story"]) and arg_65_1.var_.characterEffect1069ui_story == nil then
				arg_65_1.var_.characterEffect1069ui_story = arg_65_1.actors_["1069ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_68_0 = 0.2

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_0 and not isNil(arg_65_1.actors_["1069ui_story"]) then
				if arg_65_1.var_.characterEffect1069ui_story and not isNil(arg_65_1.actors_["1069ui_story"]) then
					arg_65_1.var_.characterEffect1069ui_story.fillFlat = false
				end
			end

			if arg_65_1.time_ >= 0 + var_68_0 and arg_65_1.time_ < 0 + var_68_0 + arg_68_0 and not isNil(arg_65_1.actors_["1069ui_story"]) and arg_65_1.var_.characterEffect1069ui_story then
				arg_65_1.var_.characterEffect1069ui_story.fillFlat = false
			end
			...
			local var_68_2 = arg_65_1.actors_["1069ui_story"].transform

			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				arg_65_1.var_.moveOldPos1069ui_story = var_68_2.localPosition
			end

			local var_68_3 = 0.001

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_3 then
				var_68_2.localPosition = Vector3.Lerp(arg_65_1.var_.moveOldPos1069ui_story, Vector3.New(-0.7, -1, -6), (arg_65_1.time_ - 0) / var_68_3)
			...
			if arg_65_1.time_ >= 0 + var_68_3 and arg_65_1.time_ < 0 + var_68_3 + arg_68_0 then
				var_68_2.localPosition = Vector3.New(-0.7, -1, -6)
				var_68_2.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_68_2.position).x, (manager.ui.mainCamera.transform.position - var_68_2.position).y, (manager.ui.mainCamera.transform.position - var_68_2.position).z)
				var_68_2.localEulerAngles.z = 0
				var_68_2.localEulerAngles.x = 0
				var_68_2.localEulerAngles = var_68_2.localEulerAngles
			...
			local var_68_4 = arg_65_1.actors_["1075ui_story"].transform

			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				arg_65_1.var_.moveOldPos1075ui_story = var_68_4.localPosition
			end

			local var_68_5 = 0.001

			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_5 then
				var_68_4.localPosition = Vector3.Lerp(arg_65_1.var_.moveOldPos1075ui_story, Vector3.New(0.7, -1.055, -6.16), (arg_65_1.time_ - 0) / var_68_5)
			...
			if arg_65_1.time_ >= 0 + var_68_5 and arg_65_1.time_ < 0 + var_68_5 + arg_68_0 then
				var_68_4.localPosition = Vector3.New(0.7, -1.055, -6.16)
				var_68_4.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_68_4.position).x, (manager.ui.mainCamera.transform.position - var_68_4.position).y, (manager.ui.mainCamera.transform.position - var_68_4.position).z)
				var_68_4.localEulerAngles.z = 0
				var_68_4.localEulerAngles.x = 0
				var_68_4.localEulerAngles = var_68_4.localEulerAngles
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 and not isNil(var_68_6) and arg_65_1.var_.characterEffect1075ui_story == nil then
				arg_65_1.var_.characterEffect1075ui_story = var_68_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_68_7 = 0.0166666666666667
			...
			if 0 <= arg_65_1.time_ and arg_65_1.time_ < 0 + var_68_7 and not isNil(var_68_6) then
				if arg_65_1.var_.characterEffect1075ui_story and not isNil(var_68_6) then
					...
					arg_65_1.var_.characterEffect1075ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_65_1.time_ - 0) / var_68_7)
				end
			end

			if arg_65_1.time_ >= 0 + var_68_7 and arg_65_1.time_ < 0 + var_68_7 + arg_68_0 and not isNil(var_68_6) and arg_65_1.var_.characterEffect1075ui_story then
				arg_65_1.var_.characterEffect1075ui_story.fillFlat = true
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= var_68_8 + arg_68_0 then
				...
				local var_68_10 = arg_65_1:GetWordFromCfg(120131016)
				...
				local var_68_13 = 22 <= 0 and var_68_9 or var_68_9 * (utf8.len(var_68_11) / 22)

				if (22 <= 0 and var_68_9 or var_68_9 * (utf8.len(var_68_11) / 22)) > 0 and var_68_9 < var_68_13 then
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131016", "story_v_out_120131.awb") ~= 0 then
					local var_68_14 = manager.audio:GetVoiceLength("story_v_out_120131", "120131016", "story_v_out_120131.awb") / 1000
					...
					if var_68_10.prefab_name ~= "" and arg_65_1.actors_[var_68_10.prefab_name] ~= nil then
						local var_68_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_65_1.actors_[var_68_10.prefab_name].transform, "story_v_out_120131", "120131016", "story_v_out_120131.awb")

						arg_65_1:RecordAudio("120131016", var_68_15)
						arg_65_1:RecordAudio("120131016", var_68_15)
					else
	...
	Play120131017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 and not isNil(arg_69_1.actors_["1069ui_story"]) and arg_69_1.var_.characterEffect1069ui_story == nil then
				arg_69_1.var_.characterEffect1069ui_story = arg_69_1.actors_["1069ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_72_0 = 0.2

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_0 and not isNil(arg_69_1.actors_["1069ui_story"]) then
				if arg_69_1.var_.characterEffect1069ui_story and not isNil(arg_69_1.actors_["1069ui_story"]) then
					arg_69_1.var_.characterEffect1069ui_story.fillFlat = true
					arg_69_1.var_.characterEffect1069ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_69_1.time_ - 0) / var_72_0)
				end
			end

			if arg_69_1.time_ >= 0 + var_72_0 and arg_69_1.time_ < 0 + var_72_0 + arg_72_0 and not isNil(arg_69_1.actors_["1069ui_story"]) and arg_69_1.var_.characterEffect1069ui_story then
				arg_69_1.var_.characterEffect1069ui_story.fillFlat = true
				arg_69_1.var_.characterEffect1069ui_story.fillRatio = 0.5
			end

			local var_72_1 = arg_69_1.actors_["1075ui_story"]

			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 and not isNil(var_72_1) and arg_69_1.var_.characterEffect1075ui_story == nil then
				arg_69_1.var_.characterEffect1075ui_story = var_72_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_72_2 = 0.2

			if 0 <= arg_69_1.time_ and arg_69_1.time_ < 0 + var_72_2 and not isNil(var_72_1) then
				if arg_69_1.var_.characterEffect1075ui_story and not isNil(var_72_1) then
					arg_69_1.var_.characterEffect1075ui_story.fillFlat = false
				end
			end

			if arg_69_1.time_ >= 0 + var_72_2 and arg_69_1.time_ < 0 + var_72_2 + arg_72_0 and not isNil(var_72_1) and arg_69_1.var_.characterEffect1075ui_story then
				arg_69_1.var_.characterEffect1075ui_story.fillFlat = false
			end
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= var_72_4 + arg_72_0 then
				...
				local var_72_6 = arg_69_1:GetWordFromCfg(120131017)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131017", "story_v_out_120131.awb") ~= 0 then
					local var_72_10 = manager.audio:GetVoiceLength("story_v_out_120131", "120131017", "story_v_out_120131.awb") / 1000
					...
					if var_72_6.prefab_name ~= "" and arg_69_1.actors_[var_72_6.prefab_name] ~= nil then
						local var_72_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_69_1.actors_[var_72_6.prefab_name].transform, "story_v_out_120131", "120131017", "story_v_out_120131.awb")

						arg_69_1:RecordAudio("120131017", var_72_11)
						arg_69_1:RecordAudio("120131017", var_72_11)
					else
	...
	Play120131018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				arg_73_1:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_mountainbreak", "")
			end

			local var_76_1 = arg_73_1.actors_["1069ui_story"].transform

			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				arg_73_1.var_.moveOldPos1069ui_story = var_76_1.localPosition
			end

			local var_76_2 = 0.001

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_2 then
				var_76_1.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPos1069ui_story, Vector3.New(0, 100, 0), (arg_73_1.time_ - 0) / var_76_2)
			...
			local var_76_3 = arg_73_1.actors_["1075ui_story"].transform

			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				arg_73_1.var_.moveOldPos1075ui_story = var_76_3.localPosition
			end

			local var_76_4 = 0.001

			if 0 <= arg_73_1.time_ and arg_73_1.time_ < 0 + var_76_4 then
				var_76_3.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPos1075ui_story, Vector3.New(0, 100, 0), (arg_73_1.time_ - 0) / var_76_4)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_5 + arg_76_0 then
				...
				local var_76_7 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(120131018).content)
	...
	Play120131019 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= 0 + arg_80_0 then
				...
				local var_80_1 = arg_77_1:GetWordFromCfg(120131019)
				...
				if manager.audio:GetVoiceLength("story_v_out_120131", "120131019", "story_v_out_120131.awb") ~= 0 then
					local var_80_5 = manager.audio:GetVoiceLength("story_v_out_120131", "120131019", "story_v_out_120131.awb") / 1000
					...
					if var_80_1.prefab_name ~= "" and arg_77_1.actors_[var_80_1.prefab_name] ~= nil then
						local var_80_6 = LuaForUtil.PlayVoiceWithCriLipsync(arg_77_1.actors_[var_80_1.prefab_name].transform, "story_v_out_120131", "120131019", "story_v_out_120131.awb")

						arg_77_1:RecordAudio("120131019", var_80_6)
						arg_77_1:RecordAudio("120131019", var_80_6)
					else
	...
	Play120131020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 <= arg_81_1.time_ and arg_81_1.time_ < 0 + var_84_0 then
				...
				var_84_1.a = Mathf.Lerp(1, 0, (arg_81_1.time_ - 0) / var_84_0)
			...
			if 2 < arg_81_1.time_ and arg_81_1.time_ <= var_84_8 + arg_84_0 then
				...
				local var_84_11 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(120131020).content)

				arg_81_1.text_.text = var_84_11

				LuaForUtil.ClearLinePrefixSymbol(arg_81_1.text_)

				local var_84_13 = 31 <= 0 and var_84_9 or var_84_9 * (utf8.len(var_84_11) / 31)

				if (31 <= 0 and var_84_9 or var_84_9 * (utf8.len(var_84_11) / 31)) > 0 and var_84_9 < var_84_13 then
	...
	Play120131021 = function(arg_87_0, arg_87_1)
		...
		function arg_87_1.onSingleLineUpdate_(arg_90_0)
			...
			if 0 < arg_87_1.time_ and arg_87_1.time_ <= 0 + arg_90_0 then
				...
				local var_90_1 = arg_87_1:FormatText(arg_87_1:GetWordFromCfg(120131021).content)
