	...
	Play321382001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0.4 < arg_1_1.time_ and arg_1_1.time_ <= 0.4 + arg_4_0 then
				...
				local var_4_18 = manager.audio:GetAudioName("bgm_activity_4_0_story_quake_daily", "bgm_activity_4_0_story_quake_daily")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_20 + arg_4_0 then
				...
				local var_4_23 = arg_1_1:GetWordFromCfg(321382001)
				...
				if manager.audio:GetVoiceLength("story_v_out_321382", "321382001", "story_v_out_321382.awb") ~= 0 then
					local var_4_27 = manager.audio:GetVoiceLength("story_v_out_321382", "321382001", "story_v_out_321382.awb") / 1000
					...
					if var_4_23.prefab_name ~= "" and arg_1_1.actors_[var_4_23.prefab_name] ~= nil then
						local var_4_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_23.prefab_name].transform, "story_v_out_321382", "321382001", "story_v_out_321382.awb")

						arg_1_1:RecordAudio("321382001", var_4_28)
						arg_1_1:RecordAudio("321382001", var_4_28)
					else
