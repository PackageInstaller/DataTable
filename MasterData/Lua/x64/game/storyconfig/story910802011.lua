	...
	Play910810001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_18 + arg_4_0 then
				...
				local var_4_21 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910810001).content)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				...
				for iter_10_0 = 0, arg_7_1.actors_["1070"].transform.childCount - 1 do
					...
					if var_10_0.name == "split_6" or not string.find(var_10_0.name, "split") then
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_5 + arg_10_0 then
				...
				local var_10_7 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910810002).content)

				arg_7_1.text_.text = var_10_7

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_9 = 7 <= 0 and var_10_6 or var_10_6 * (utf8.len(var_10_7) / 7)

				if (7 <= 0 and var_10_6 or var_10_6 * (utf8.len(var_10_7) / 7)) > 0 and var_10_6 < var_10_9 then
	...
	Play910810003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_5 + arg_14_0 then
				...
				local var_14_7 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910810003).content)
	...
	Play910810004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				arg_15_1.leftNameTxt_.text = arg_15_1:FormatText(StoryNameCfg[623].name)
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910810004).content)

				arg_15_1.text_.text = var_18_7

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_9 = 11 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 11)

				if (11 <= 0 and var_18_6 or var_18_6 * (utf8.len(var_18_7) / 11)) > 0 and var_18_6 < var_18_9 then
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				for iter_22_0 = 0, arg_19_1.actors_["1070"].transform.childCount - 1 do
					...
					if var_22_0.name == "split_2" or not string.find(var_22_0.name, "split") then
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_5 + arg_22_0 then
				...
				local var_22_7 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910810005).content)
	...
	Play910810006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910810006).content)

				arg_23_1.text_.text = var_26_7

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_9 = 10 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 10)

				if (10 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 10)) > 0 and var_26_6 < var_26_9 then
	...
	Play910810007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910810007).content)

				arg_27_1.text_.text = var_30_7

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_9 = 32 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 32)

				if (32 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 32)) > 0 and var_30_6 < var_30_9 then
	...
	Play910810008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910810008).content)

				arg_31_1.text_.text = var_34_7

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_9 = 9 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 9)

				if (9 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 9)) > 0 and var_34_6 < var_34_9 then
	...
	Play910810009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_5 + arg_38_0 then
				...
				local var_38_7 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910810009).content)

				arg_35_1.text_.text = var_38_7

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_9 = 30 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 30)

				if (30 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 30)) > 0 and var_38_6 < var_38_9 then
	...
	Play910810010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910810010).content)

				arg_39_1.text_.text = var_42_7

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_9 = 23 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 23)

				if (23 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 23)) > 0 and var_42_6 < var_42_9 then
	...
	Play910810011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_5 + arg_46_0 then
				...
				local var_46_7 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910810011).content)

				arg_43_1.text_.text = var_46_7

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_9 = 17 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 17)

				if (17 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 17)) > 0 and var_46_6 < var_46_9 then
	...
	Play910810012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_5 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910810012).content)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= 0 + arg_54_0 then
				...
				for iter_54_0 = 0, arg_51_1.actors_["1070"].transform.childCount - 1 do
					...
					if var_54_0.name == "split_9" or not string.find(var_54_0.name, "split") then
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_5 + arg_54_0 then
				...
				local var_54_7 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910810013).content)

				arg_51_1.text_.text = var_54_7

				LuaForUtil.ClearLinePrefixSymbol(arg_51_1.text_)

				local var_54_9 = 16 <= 0 and var_54_6 or var_54_6 * (utf8.len(var_54_7) / 16)

				if (16 <= 0 and var_54_6 or var_54_6 * (utf8.len(var_54_7) / 16)) > 0 and var_54_6 < var_54_9 then
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= 0 + arg_58_0 then
				...
				for iter_58_0 = 0, arg_55_1.actors_["1070"].transform.childCount - 1 do
					...
					if var_58_0.name == "split_9" or not string.find(var_58_0.name, "split") then
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_5 + arg_58_0 then
				...
				local var_58_7 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910810014).content)

				arg_55_1.text_.text = var_58_7

				LuaForUtil.ClearLinePrefixSymbol(arg_55_1.text_)

				local var_58_9 = 22 <= 0 and var_58_6 or var_58_6 * (utf8.len(var_58_7) / 22)

				if (22 <= 0 and var_58_6 or var_58_6 * (utf8.len(var_58_7) / 22)) > 0 and var_58_6 < var_58_9 then
	...
	Play910810015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_6 + arg_62_0 then
				...
				local var_62_8 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(910810015).content)

				arg_59_1.text_.text = var_62_8

				LuaForUtil.ClearLinePrefixSymbol(arg_59_1.text_)

				local var_62_10 = 16 <= 0 and var_62_7 or var_62_7 * (utf8.len(var_62_8) / 16)

				if (16 <= 0 and var_62_7 or var_62_7 * (utf8.len(var_62_8) / 16)) > 0 and var_62_7 < var_62_10 then
