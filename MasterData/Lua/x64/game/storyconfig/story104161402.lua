	...
	Play416142001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_19 + arg_4_0 then
				...
				local var_4_22 = arg_1_1:GetWordFromCfg(416142001)
				...
				if manager.audio:GetVoiceLength("story_v_out_416142", "416142001", "story_v_out_416142.awb") ~= 0 then
					local var_4_26 = manager.audio:GetVoiceLength("story_v_out_416142", "416142001", "story_v_out_416142.awb") / 1000
					...
					if var_4_22.prefab_name ~= "" and arg_1_1.actors_[var_4_22.prefab_name] ~= nil then
						local var_4_27 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_22.prefab_name].transform, "story_v_out_416142", "416142001", "story_v_out_416142.awb")

						arg_1_1:RecordAudio("416142001", var_4_27)
						arg_1_1:RecordAudio("416142001", var_4_27)
					else
	...
	Play416142010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= 0 + arg_44_0 then
				...
				for iter_44_5, iter_44_6 in ipairs((var_44_19.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_44_6.transform.localScale = Vector3.New(iter_44_6.transform.localScale.x / var_44_21 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_44_6.transform.localScale.y / var_44_21, iter_44_6.transform.localScale.z)
				end
			end
			...
			local var_44_24 = 0.9
			local var_44_25 = 1.65

			if 0.9 < arg_41_1.time_ and arg_41_1.time_ <= var_44_24 + arg_44_0 then
				...
				local var_44_27 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(416142010).content)

				arg_41_1.text_.text = var_44_27

				LuaForUtil.ClearLinePrefixSymbol(arg_41_1.text_)

				local var_44_29 = 66 <= 0 and var_44_25 or var_44_25 * (utf8.len(var_44_27) / 66)

				if (66 <= 0 and var_44_25 or var_44_25 * (utf8.len(var_44_27) / 66)) > 0 and var_44_25 < var_44_29 then
					arg_41_1.talkMaxDuration = var_44_29
					var_44_24 = var_44_24 + 0.3

					if var_44_29 + var_44_24 > arg_41_1.duration_ then
						arg_41_1.duration_ = var_44_29 + var_44_24
					end
				end
			...
			local var_44_30 = var_44_24 + 0.3
			local var_44_31 = math.max(var_44_25, arg_41_1.talkMaxDuration)

			if var_44_24 + 0.3 <= arg_41_1.time_ and arg_41_1.time_ < var_44_30 + var_44_31 then
	...
	Play416142019 = function(arg_83_0, arg_83_1)
		...
		function arg_83_1.onSingleLineUpdate_(arg_86_0)
			...
			if 0 < arg_83_1.time_ and arg_83_1.time_ <= 0 + arg_86_0 then
				...
				for iter_86_6, iter_86_7 in ipairs((var_86_8.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_86_7.transform.localScale = Vector3.New(iter_86_7.transform.localScale.x / var_86_10 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_86_7.transform.localScale.y / var_86_10, iter_86_7.transform.localScale.z)
				end
			end
			...
			if 0 < arg_83_1.time_ and arg_83_1.time_ <= var_86_13 + arg_86_0 then
				arg_83_1.allBtn_.enabled = false
			end

			if arg_83_1.time_ >= var_86_13 + 0.833333333333333 and arg_83_1.time_ < var_86_13 + 0.833333333333333 + arg_86_0 then
			...
			local var_86_15 = 0.533333333333333
			local var_86_16 = 1.5

			if 0.533333333333333 < arg_83_1.time_ and arg_83_1.time_ <= var_86_15 + arg_86_0 then
				...
				local var_86_18 = arg_83_1:FormatText(arg_83_1:GetWordFromCfg(416142019).content)

				arg_83_1.text_.text = var_86_18

				LuaForUtil.ClearLinePrefixSymbol(arg_83_1.text_)

				local var_86_20 = 60 <= 0 and var_86_16 or var_86_16 * (utf8.len(var_86_18) / 60)

				if (60 <= 0 and var_86_16 or var_86_16 * (utf8.len(var_86_18) / 60)) > 0 and var_86_16 < var_86_20 then
	...
	Play416142027 = function(arg_119_0, arg_119_1)
		...
		function arg_119_1.onSingleLineUpdate_(arg_122_0)
			...
			if 1.334 < arg_119_1.time_ and arg_119_1.time_ <= 1.334 + arg_122_0 then
				...
				for iter_122_4, iter_122_5 in ipairs((var_122_19.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_122_5.transform.localScale = Vector3.New(iter_122_5.transform.localScale.x / var_122_21 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_122_5.transform.localScale.y / var_122_21, iter_122_5.transform.localScale.z)
				end
			end
			...
			local var_122_24 = 3.06666666666667
			local var_122_25 = 1.025

			if 3.06666666666667 < arg_119_1.time_ and arg_119_1.time_ <= var_122_24 + arg_122_0 then
				...
				local var_122_26 = LeanTween.value(arg_119_1.dialog_, 0, 1, 0.3)

				var_122_26:setOnUpdate(LuaHelper.FloatAction(function(arg_123_0)
					arg_119_1.dialogCg_.alpha = arg_123_0
				end))
				var_122_26:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_119_1.dialog_)
					var_122_26:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_122_27 = arg_119_1:FormatText(arg_119_1:GetWordFromCfg(416142027).content)

				arg_119_1.text_.text = var_122_27

				LuaForUtil.ClearLinePrefixSymbol(arg_119_1.text_)

				local var_122_29 = 41 <= 0 and var_122_25 or var_122_25 * (utf8.len(var_122_27) / 41)

				if (41 <= 0 and var_122_25 or var_122_25 * (utf8.len(var_122_27) / 41)) > 0 and var_122_25 < var_122_29 then
					arg_119_1.talkMaxDuration = var_122_29
					var_122_24 = var_122_24 + 0.3

					if var_122_29 + var_122_24 > arg_119_1.duration_ then
						arg_119_1.duration_ = var_122_29 + var_122_24
					end
				end
			...
			local var_122_30 = var_122_24 + 0.3
			local var_122_31 = math.max(var_122_25, arg_119_1.talkMaxDuration)

			if var_122_24 + 0.3 <= arg_119_1.time_ and arg_119_1.time_ < var_122_30 + var_122_31 then
