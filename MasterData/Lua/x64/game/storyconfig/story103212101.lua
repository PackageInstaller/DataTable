	...
	Play321211053 = function(arg_218_0, arg_218_1)
		...
		function arg_218_1.onSingleLineUpdate_(arg_221_0)
			...
			if 0 < arg_218_1.time_ and arg_218_1.time_ <= 0 + arg_221_0 then
				...
				for iter_221_0, iter_221_1 in ipairs((var_221_4.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_221_1.transform.localScale = Vector3.New(iter_221_1.transform.localScale.x / var_221_6 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_221_1.transform.localScale.y / var_221_6, iter_221_1.transform.localScale.z)
				end
			end

			if 0 < arg_218_1.time_ and arg_218_1.time_ <= 0 + arg_221_0 then
				local var_221_8 = arg_218_1.bgs_.L15g
				...
				var_221_8.transform.localEulerAngles = Vector3(0, 0, 0)

				local var_221_9 = var_221_8:GetComponent("SpriteRenderer")

				if var_221_9 and var_221_9.sprite then
					local var_221_10 = 2 * (var_221_8.transform.localPosition - manager.ui.mainCamera.transform.localPosition).z * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

					var_221_8.transform.localScale = Vector3.New(var_221_10 / var_221_9.sprite.bounds.size.y < var_221_10 * manager.ui.mainCameraCom_.aspect / var_221_9.sprite.bounds.size.x and var_221_10 * manager.ui.mainCameraCom_.aspect / var_221_9.sprite.bounds.size.x or var_221_10 / var_221_9.sprite.bounds.size.y, var_221_10 / var_221_9.sprite.bounds.size.y < var_221_10 * manager.ui.mainCameraCom_.aspect / var_221_9.sprite.bounds.size.x and var_221_10 * manager.ui.mainCameraCom_.aspect / var_221_9.sprite.bounds.size.x or var_221_10 / var_221_9.sprite.bounds.size.y, 0)
				end
			...
			local var_221_11 = arg_218_1.actors_["1011ui_story"].transform

			if 0 < arg_218_1.time_ and arg_218_1.time_ <= 0 + arg_221_0 then
				arg_218_1.var_.moveOldPos1011ui_story = var_221_11.localPosition
			end

			local var_221_12 = 0.001

			if 0 <= arg_218_1.time_ and arg_218_1.time_ < 0 + var_221_12 then
				var_221_11.localPosition = Vector3.Lerp(arg_218_1.var_.moveOldPos1011ui_story, Vector3.New(0, 100, 0), (arg_218_1.time_ - 0) / var_221_12)
				var_221_11.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_221_11.position).x, (manager.ui.mainCamera.transform.position - var_221_11.position).y, (manager.ui.mainCamera.transform.position - var_221_11.position).z)
				var_221_11.localEulerAngles.z = 0
				var_221_11.localEulerAngles.x = 0
				var_221_11.localEulerAngles = var_221_11.localEulerAngles
			end

			if arg_218_1.time_ >= 0 + var_221_12 and arg_218_1.time_ < 0 + var_221_12 + arg_221_0 then
				var_221_11.localPosition = Vector3.New(0, 100, 0)
				var_221_11.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_221_11.position).x, (manager.ui.mainCamera.transform.position - var_221_11.position).y, (manager.ui.mainCamera.transform.position - var_221_11.position).z)
				var_221_11.localEulerAngles.z = 0
				var_221_11.localEulerAngles.x = 0
				var_221_11.localEulerAngles = var_221_11.localEulerAngles
			...
			if 0 < arg_218_1.time_ and arg_218_1.time_ <= var_221_13 + arg_221_0 then
				...
				local var_221_15 = arg_218_1:FormatText(arg_218_1:GetWordFromCfg(321211053).content)

				arg_218_1.text_.text = var_221_15

				LuaForUtil.ClearLinePrefixSymbol(arg_218_1.text_)

				local var_221_17 = 38 <= 0 and var_221_14 or var_221_14 * (utf8.len(var_221_15) / 38)

				if (38 <= 0 and var_221_14 or var_221_14 * (utf8.len(var_221_15) / 38)) > 0 and var_221_14 < var_221_17 then
					arg_218_1.talkMaxDuration = var_221_17

					if var_221_17 + var_221_13 > arg_218_1.duration_ then
						arg_218_1.duration_ = var_221_17 + var_221_13
					end
				end
			...
			local var_221_18 = math.max(var_221_14, arg_218_1.talkMaxDuration)

			if var_221_13 <= arg_218_1.time_ and arg_218_1.time_ < var_221_13 + var_221_18 then
				arg_218_1.typewritter.percent = (arg_218_1.time_ - var_221_13) / var_221_18

				arg_218_1.typewritter:SetDirty()
			end

			if arg_218_1.time_ >= var_221_13 + var_221_18 and arg_218_1.time_ < var_221_13 + var_221_18 + arg_221_0 then
