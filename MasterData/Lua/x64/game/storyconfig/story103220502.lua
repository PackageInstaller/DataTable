	...
	Play322052016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if 0 < arg_65_1.time_ and arg_65_1.time_ <= 0 + arg_68_0 then
				...
				for iter_68_0, iter_68_1 in ipairs((var_68_6.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_68_1.transform.localScale = Vector3.New(iter_68_1.transform.localScale.x / var_68_8 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_68_1.transform.localScale.y / var_68_8, iter_68_1.transform.localScale.z)
				end
			end
			...
			local var_68_11 = 0.249999999999
			local var_68_12 = 1.35

			if 0.249999999999 < arg_65_1.time_ and arg_65_1.time_ <= var_68_11 + arg_68_0 then
				...
				local var_68_14 = arg_65_1:FormatText(arg_65_1:GetWordFromCfg(322052016).content)

				arg_65_1.text_.text = var_68_14

				LuaForUtil.ClearLinePrefixSymbol(arg_65_1.text_)

				local var_68_16 = 54 <= 0 and var_68_12 or var_68_12 * (utf8.len(var_68_14) / 54)

				if (54 <= 0 and var_68_12 or var_68_12 * (utf8.len(var_68_14) / 54)) > 0 and var_68_12 < var_68_16 then
