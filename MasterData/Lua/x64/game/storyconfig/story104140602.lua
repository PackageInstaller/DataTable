return {
	Play414062001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 1.73333333333333 <= arg_1_1.time_ and arg_1_1.time_ < 1.73333333333333 + var_4_13 then
				var_4_12.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2078ui_story, Vector3.New(0, -1.28, -5.6), (arg_1_1.time_ - 1.73333333333333) / var_4_13)
			...
			if 1.73333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 1.73333333333333 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.characterEffect2078ui_story == nil then
			...
			if arg_1_1.time_ >= 1.73333333333333 + var_4_15 and arg_1_1.time_ < 1.73333333333333 + var_4_15 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.characterEffect2078ui_story then
				arg_1_1.var_.characterEffect2078ui_story.fillFlat = false
			end
			...
			local var_4_17 = 1.73333333333333
			local var_4_18 = 0.525

			if 1.73333333333333 < arg_1_1.time_ and arg_1_1.time_ <= var_4_17 + arg_4_0 then
				...
				local var_4_20 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414062001).content)

				arg_1_1.text_.text = var_4_20

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_22 = 21 <= 0 and var_4_18 or var_4_18 * (utf8.len(var_4_20) / 21)

				if (21 <= 0 and var_4_18 or var_4_18 * (utf8.len(var_4_20) / 21)) > 0 and var_4_18 < var_4_22 then
	...
	Play414062002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 and not isNil(arg_7_1.actors_["2078ui_story"]) and arg_7_1.var_.characterEffect2078ui_story == nil then
				arg_7_1.var_.characterEffect2078ui_story = arg_7_1.actors_["2078ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_10_0 = 0.200000002980232

			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_0 and not isNil(arg_7_1.actors_["2078ui_story"]) then
				if arg_7_1.var_.characterEffect2078ui_story and not isNil(arg_7_1.actors_["2078ui_story"]) then
					arg_7_1.var_.characterEffect2078ui_story.fillFlat = true
					arg_7_1.var_.characterEffect2078ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_7_1.time_ - 0) / var_10_0)
				end
			end

			if arg_7_1.time_ >= 0 + var_10_0 and arg_7_1.time_ < 0 + var_10_0 + arg_10_0 and not isNil(arg_7_1.actors_["2078ui_story"]) and arg_7_1.var_.characterEffect2078ui_story then
				arg_7_1.var_.characterEffect2078ui_story.fillFlat = true
				arg_7_1.var_.characterEffect2078ui_story.fillRatio = 0.5
			end

			local var_10_1 = 0
			local var_10_2 = 0.175
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				...
				local var_10_3 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(414062002).content)

				arg_7_1.text_.text = var_10_3

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_5 = 7 <= 0 and var_10_2 or var_10_2 * (utf8.len(var_10_3) / 7)

				if (7 <= 0 and var_10_2 or var_10_2 * (utf8.len(var_10_3) / 7)) > 0 and var_10_2 < var_10_5 then
	...
	Play414062003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			if arg_11_1.actors_["1095ui_story"] == nil and not isNil((Asset.Load("Char/" .. "1095ui_story"))) then
				local var_14_0 = Object.Instantiate(Asset.Load("Char/" .. "1095ui_story"), arg_11_1.stage_.transform)

				var_14_0.name = "1095ui_story"
				var_14_0.transform.localPosition = Vector3.New(0, 100, 0)
				arg_11_1.actors_["1095ui_story"] = var_14_0
				...
				arg_11_1.var_["1095ui_story" .. "Animator"] = var_14_1.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_11_1.var_["1095ui_story" .. "Animator"].applyRootMotion = true
				arg_11_1.var_["1095ui_story" .. "LipSync"] = var_14_1.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_14_3 = arg_11_1.actors_["1095ui_story"]

			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 and not isNil(var_14_3) and arg_11_1.var_.characterEffect1095ui_story == nil then
				arg_11_1.var_.characterEffect1095ui_story = var_14_3:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_14_4 = 0.200000002980232

			if 0 <= arg_11_1.time_ and arg_11_1.time_ < 0 + var_14_4 and not isNil(var_14_3) then
				if arg_11_1.var_.characterEffect1095ui_story and not isNil(var_14_3) then
					arg_11_1.var_.characterEffect1095ui_story.fillFlat = false
				end
			end

			if arg_11_1.time_ >= 0 + var_14_4 and arg_11_1.time_ < 0 + var_14_4 + arg_14_0 and not isNil(var_14_3) and arg_11_1.var_.characterEffect1095ui_story then
				arg_11_1.var_.characterEffect1095ui_story.fillFlat = false
			end
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_6 + arg_14_0 then
				...
				arg_11_1.leftNameTxt_.text = arg_11_1:FormatText(StoryNameCfg[688].name)
				...
				local var_14_8 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(414062003).content)

				arg_11_1.text_.text = var_14_8

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_10 = 6 <= 0 and var_14_7 or var_14_7 * (utf8.len(var_14_8) / 6)

				if (6 <= 0 and var_14_7 or var_14_7 * (utf8.len(var_14_8) / 6)) > 0 and var_14_7 < var_14_10 then
	...
	Play414062004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 then
				...
				local var_18_3 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(414062004).content)

				arg_15_1.text_.text = var_18_3

				LuaForUtil.ClearLinePrefixSymbol(arg_15_1.text_)

				local var_18_5 = 10 <= 0 and var_18_2 or var_18_2 * (utf8.len(var_18_3) / 10)

				if (10 <= 0 and var_18_2 or var_18_2 * (utf8.len(var_18_3) / 10)) > 0 and var_18_2 < var_18_5 then
	...
	Play414062005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				arg_19_1.var_.moveOldPos2078ui_story = arg_19_1.actors_["2078ui_story"].transform.localPosition
			end

			local var_22_0 = 0.001

			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_0 then
				arg_19_1.actors_["2078ui_story"].transform.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos2078ui_story, Vector3.New(0, -1.28, -5.6), (arg_19_1.time_ - 0) / var_22_0)
				arg_19_1.actors_["2078ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_19_1.actors_["2078ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["2078ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["2078ui_story"].transform.position).z)
				arg_19_1.actors_["2078ui_story"].transform.localEulerAngles.z = 0
				arg_19_1.actors_["2078ui_story"].transform.localEulerAngles.x = 0
				arg_19_1.actors_["2078ui_story"].transform.localEulerAngles = arg_19_1.actors_["2078ui_story"].transform.localEulerAngles
			end

			if arg_19_1.time_ >= 0 + var_22_0 and arg_19_1.time_ < 0 + var_22_0 + arg_22_0 then
				arg_19_1.actors_["2078ui_story"].transform.localPosition = Vector3.New(0, -1.28, -5.6)
				arg_19_1.actors_["2078ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_19_1.actors_["2078ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["2078ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_19_1.actors_["2078ui_story"].transform.position).z)
				arg_19_1.actors_["2078ui_story"].transform.localEulerAngles.z = 0
				arg_19_1.actors_["2078ui_story"].transform.localEulerAngles.x = 0
				arg_19_1.actors_["2078ui_story"].transform.localEulerAngles = arg_19_1.actors_["2078ui_story"].transform.localEulerAngles
			...
			local var_22_1 = arg_19_1.actors_["2078ui_story"]

			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 and not isNil(var_22_1) and arg_19_1.var_.characterEffect2078ui_story == nil then
				arg_19_1.var_.characterEffect2078ui_story = var_22_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_22_2 = 0.200000002980232

			if 0 <= arg_19_1.time_ and arg_19_1.time_ < 0 + var_22_2 and not isNil(var_22_1) then
				if arg_19_1.var_.characterEffect2078ui_story and not isNil(var_22_1) then
					arg_19_1.var_.characterEffect2078ui_story.fillFlat = false
				end
			end

			if arg_19_1.time_ >= 0 + var_22_2 and arg_19_1.time_ < 0 + var_22_2 + arg_22_0 and not isNil(var_22_1) and arg_19_1.var_.characterEffect2078ui_story then
				arg_19_1.var_.characterEffect2078ui_story.fillFlat = false
			end
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_4 + arg_22_0 then
				...
				arg_19_1.leftNameTxt_.text = arg_19_1:FormatText(StoryNameCfg[688].name)
				...
				local var_22_6 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(414062005).content)

				arg_19_1.text_.text = var_22_6

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_8 = 27 <= 0 and var_22_5 or var_22_5 * (utf8.len(var_22_6) / 27)

				if (27 <= 0 and var_22_5 or var_22_5 * (utf8.len(var_22_6) / 27)) > 0 and var_22_5 < var_22_8 then
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_0 and not isNil(arg_23_1.actors_["2078ui_story"]) then
				if arg_23_1.var_.characterEffect2078ui_story and not isNil(arg_23_1.actors_["2078ui_story"]) then
					...
					arg_23_1.var_.characterEffect2078ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_23_1.time_ - 0) / var_26_0)
				end
			end
			...
			if arg_23_1.time_ >= 0 + var_26_0 and arg_23_1.time_ < 0 + var_26_0 + arg_26_0 and not isNil(arg_23_1.actors_["2078ui_story"]) and arg_23_1.var_.characterEffect2078ui_story then
				arg_23_1.var_.characterEffect2078ui_story.fillFlat = true
				arg_23_1.var_.characterEffect2078ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				...
				local var_26_3 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(414062006).content)

				arg_23_1.text_.text = var_26_3

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_5 = 22 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 22)

				if (22 <= 0 and var_26_2 or var_26_2 * (utf8.len(var_26_3) / 22)) > 0 and var_26_2 < var_26_5 then
	...
	Play414062007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 then
				arg_27_1.var_.moveOldPos2078ui_story = arg_27_1.actors_["2078ui_story"].transform.localPosition
			end

			local var_30_0 = 0.001

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_0 then
				arg_27_1.actors_["2078ui_story"].transform.localPosition = Vector3.Lerp(arg_27_1.var_.moveOldPos2078ui_story, Vector3.New(0, -1.28, -5.6), (arg_27_1.time_ - 0) / var_30_0)
				arg_27_1.actors_["2078ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_27_1.actors_["2078ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["2078ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["2078ui_story"].transform.position).z)
				arg_27_1.actors_["2078ui_story"].transform.localEulerAngles.z = 0
				arg_27_1.actors_["2078ui_story"].transform.localEulerAngles.x = 0
				arg_27_1.actors_["2078ui_story"].transform.localEulerAngles = arg_27_1.actors_["2078ui_story"].transform.localEulerAngles
			end

			if arg_27_1.time_ >= 0 + var_30_0 and arg_27_1.time_ < 0 + var_30_0 + arg_30_0 then
				arg_27_1.actors_["2078ui_story"].transform.localPosition = Vector3.New(0, -1.28, -5.6)
				arg_27_1.actors_["2078ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_27_1.actors_["2078ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["2078ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_27_1.actors_["2078ui_story"].transform.position).z)
				arg_27_1.actors_["2078ui_story"].transform.localEulerAngles.z = 0
				arg_27_1.actors_["2078ui_story"].transform.localEulerAngles.x = 0
				arg_27_1.actors_["2078ui_story"].transform.localEulerAngles = arg_27_1.actors_["2078ui_story"].transform.localEulerAngles
			...
			local var_30_1 = arg_27_1.actors_["2078ui_story"]

			if 0 < arg_27_1.time_ and arg_27_1.time_ <= 0 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect2078ui_story == nil then
				arg_27_1.var_.characterEffect2078ui_story = var_30_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_30_2 = 0.200000002980232

			if 0 <= arg_27_1.time_ and arg_27_1.time_ < 0 + var_30_2 and not isNil(var_30_1) then
				if arg_27_1.var_.characterEffect2078ui_story and not isNil(var_30_1) then
					arg_27_1.var_.characterEffect2078ui_story.fillFlat = false
				end
			end

			if arg_27_1.time_ >= 0 + var_30_2 and arg_27_1.time_ < 0 + var_30_2 + arg_30_0 and not isNil(var_30_1) and arg_27_1.var_.characterEffect2078ui_story then
				arg_27_1.var_.characterEffect2078ui_story.fillFlat = false
			end
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_4 + arg_30_0 then
				...
				arg_27_1.leftNameTxt_.text = arg_27_1:FormatText(StoryNameCfg[688].name)
				...
				local var_30_6 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(414062007).content)

				arg_27_1.text_.text = var_30_6

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_8 = 13 <= 0 and var_30_5 or var_30_5 * (utf8.len(var_30_6) / 13)

				if (13 <= 0 and var_30_5 or var_30_5 * (utf8.len(var_30_6) / 13)) > 0 and var_30_5 < var_30_8 then
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 <= arg_31_1.time_ and arg_31_1.time_ < 0 + var_34_0 and not isNil(arg_31_1.actors_["2078ui_story"]) then
				if arg_31_1.var_.characterEffect2078ui_story and not isNil(arg_31_1.actors_["2078ui_story"]) then
					...
					arg_31_1.var_.characterEffect2078ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_31_1.time_ - 0) / var_34_0)
				end
			end
			...
			if arg_31_1.time_ >= 0 + var_34_0 and arg_31_1.time_ < 0 + var_34_0 + arg_34_0 and not isNil(arg_31_1.actors_["2078ui_story"]) and arg_31_1.var_.characterEffect2078ui_story then
				arg_31_1.var_.characterEffect2078ui_story.fillFlat = true
				arg_31_1.var_.characterEffect2078ui_story.fillRatio = 0.5
			end

			local var_34_1 = 0
			local var_34_2 = 0.425
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_1 + arg_34_0 then
				...
				local var_34_3 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(414062008).content)

				arg_31_1.text_.text = var_34_3

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_5 = 17 <= 0 and var_34_2 or var_34_2 * (utf8.len(var_34_3) / 17)

				if (17 <= 0 and var_34_2 or var_34_2 * (utf8.len(var_34_3) / 17)) > 0 and var_34_2 < var_34_5 then
	...
	Play414062009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				arg_35_1.var_.moveOldPos2078ui_story = arg_35_1.actors_["2078ui_story"].transform.localPosition
			end

			local var_38_0 = 0.001

			if 0 <= arg_35_1.time_ and arg_35_1.time_ < 0 + var_38_0 then
				arg_35_1.actors_["2078ui_story"].transform.localPosition = Vector3.Lerp(arg_35_1.var_.moveOldPos2078ui_story, Vector3.New(0, -1.28, -5.6), (arg_35_1.time_ - 0) / var_38_0)
				arg_35_1.actors_["2078ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_35_1.actors_["2078ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["2078ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["2078ui_story"].transform.position).z)
				arg_35_1.actors_["2078ui_story"].transform.localEulerAngles.z = 0
				arg_35_1.actors_["2078ui_story"].transform.localEulerAngles.x = 0
				arg_35_1.actors_["2078ui_story"].transform.localEulerAngles = arg_35_1.actors_["2078ui_story"].transform.localEulerAngles
			end

			if arg_35_1.time_ >= 0 + var_38_0 and arg_35_1.time_ < 0 + var_38_0 + arg_38_0 then
				arg_35_1.actors_["2078ui_story"].transform.localPosition = Vector3.New(0, -1.28, -5.6)
				arg_35_1.actors_["2078ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_35_1.actors_["2078ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["2078ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_35_1.actors_["2078ui_story"].transform.position).z)
				arg_35_1.actors_["2078ui_story"].transform.localEulerAngles.z = 0
				arg_35_1.actors_["2078ui_story"].transform.localEulerAngles.x = 0
				arg_35_1.actors_["2078ui_story"].transform.localEulerAngles = arg_35_1.actors_["2078ui_story"].transform.localEulerAngles
			...
			local var_38_1 = arg_35_1.actors_["2078ui_story"]

			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 and not isNil(var_38_1) and arg_35_1.var_.characterEffect2078ui_story == nil then
				arg_35_1.var_.characterEffect2078ui_story = var_38_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_38_2 = 0.200000002980232

			if 0 <= arg_35_1.time_ and arg_35_1.time_ < 0 + var_38_2 and not isNil(var_38_1) then
				if arg_35_1.var_.characterEffect2078ui_story and not isNil(var_38_1) then
					arg_35_1.var_.characterEffect2078ui_story.fillFlat = false
				end
			end

			if arg_35_1.time_ >= 0 + var_38_2 and arg_35_1.time_ < 0 + var_38_2 + arg_38_0 and not isNil(var_38_1) and arg_35_1.var_.characterEffect2078ui_story then
				arg_35_1.var_.characterEffect2078ui_story.fillFlat = false
			end
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_4 + arg_38_0 then
				...
				arg_35_1.leftNameTxt_.text = arg_35_1:FormatText(StoryNameCfg[688].name)
				...
				local var_38_6 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(414062009).content)

				arg_35_1.text_.text = var_38_6

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_8 = 16 <= 0 and var_38_5 or var_38_5 * (utf8.len(var_38_6) / 16)

				if (16 <= 0 and var_38_5 or var_38_5 * (utf8.len(var_38_6) / 16)) > 0 and var_38_5 < var_38_8 then
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 <= arg_39_1.time_ and arg_39_1.time_ < 0 + var_42_0 and not isNil(arg_39_1.actors_["2078ui_story"]) then
				if arg_39_1.var_.characterEffect2078ui_story and not isNil(arg_39_1.actors_["2078ui_story"]) then
					...
					arg_39_1.var_.characterEffect2078ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_39_1.time_ - 0) / var_42_0)
				end
			end
			...
			if arg_39_1.time_ >= 0 + var_42_0 and arg_39_1.time_ < 0 + var_42_0 + arg_42_0 and not isNil(arg_39_1.actors_["2078ui_story"]) and arg_39_1.var_.characterEffect2078ui_story then
				arg_39_1.var_.characterEffect2078ui_story.fillFlat = true
				arg_39_1.var_.characterEffect2078ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_1 + arg_42_0 then
				...
				local var_42_3 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(414062010).content)
