	...
	Play62104001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_14 + arg_4_0 then
				...
				local var_4_17 = arg_1_1:GetWordFromCfg(62104001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62104", "62104001", "story_v_chess_62104.awb") ~= 0 then
					local var_4_21 = manager.audio:GetVoiceLength("story_v_chess_62104", "62104001", "story_v_chess_62104.awb") / 1000
					...
					if var_4_17.prefab_name ~= "" and arg_1_1.actors_[var_4_17.prefab_name] ~= nil then
						local var_4_22 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_17.prefab_name].transform, "story_v_chess_62104", "62104001", "story_v_chess_62104.awb")

						arg_1_1:RecordAudio("62104001", var_4_22)
						arg_1_1:RecordAudio("62104001", var_4_22)
					else
	...
	Play62104002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if 0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_8 + arg_12_0 then
				...
				local var_12_10 = arg_9_1:GetWordFromCfg(62104002)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62104", "62104002", "story_v_chess_62104.awb") ~= 0 then
					local var_12_14 = manager.audio:GetVoiceLength("story_v_chess_62104", "62104002", "story_v_chess_62104.awb") / 1000
					...
					if var_12_10.prefab_name ~= "" and arg_9_1.actors_[var_12_10.prefab_name] ~= nil then
						local var_12_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_10.prefab_name].transform, "story_v_chess_62104", "62104002", "story_v_chess_62104.awb")

						arg_9_1:RecordAudio("62104002", var_12_15)
						arg_9_1:RecordAudio("62104002", var_12_15)
					else
	...
	Play62104003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if 0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_1 + arg_16_0 then
				...
				local var_16_3 = arg_13_1:FormatText(arg_13_1:GetWordFromCfg(62104003).content)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_4 and not isNil(var_20_2) then
				if arg_17_1.var_.highlightMatValue1111_1 then
					...
					arg_17_1.var_.highlightMatValue1111_1.color.r = var_20_5
					arg_17_1.var_.highlightMatValue1111_1.color.g = var_20_5
					arg_17_1.var_.highlightMatValue1111_1.color.b = var_20_5
					arg_17_1.var_.highlightMatValue1111_1.color = arg_17_1.var_.highlightMatValue1111_1.color
				end
			end

			if arg_17_1.time_ >= 0 + var_20_4 and arg_17_1.time_ < 0 + var_20_4 + arg_20_0 and not isNil(var_20_2) and arg_17_1.var_.highlightMatValue1111_1 then
				var_20_2.transform:SetSiblingIndex(1)

				arg_17_1.var_.highlightMatValue1111_1.color.r = 1
				arg_17_1.var_.highlightMatValue1111_1.color.g = 1
				arg_17_1.var_.highlightMatValue1111_1.color.b = 1
				arg_17_1.var_.highlightMatValue1111_1.color = arg_17_1.var_.highlightMatValue1111_1.color
			end
			...
			local var_20_6 = arg_17_1.actors_["1111ui_story"]

			if 0 < arg_17_1.time_ and arg_17_1.time_ <= 0 + arg_20_0 and not isNil(var_20_6) and arg_17_1.var_.characterEffect1111ui_story == nil then
				arg_17_1.var_.characterEffect1111ui_story = var_20_6:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_20_7 = 0.2

			if 0 <= arg_17_1.time_ and arg_17_1.time_ < 0 + var_20_7 and not isNil(var_20_6) then
				if arg_17_1.var_.characterEffect1111ui_story and not isNil(var_20_6) then
					arg_17_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_17_1.time_ >= 0 + var_20_7 and arg_17_1.time_ < 0 + var_20_7 + arg_20_0 and not isNil(var_20_6) and arg_17_1.var_.characterEffect1111ui_story then
				arg_17_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if 0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_9 + arg_20_0 then
				...
				local var_20_11 = arg_17_1:GetWordFromCfg(62104004)
				...
				local var_20_14 = 29 <= 0 and var_20_10 or var_20_10 * (utf8.len(var_20_12) / 29)

				if (29 <= 0 and var_20_10 or var_20_10 * (utf8.len(var_20_12) / 29)) > 0 and var_20_10 < var_20_14 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62104", "62104004", "story_v_chess_62104.awb") ~= 0 then
					local var_20_15 = manager.audio:GetVoiceLength("story_v_chess_62104", "62104004", "story_v_chess_62104.awb") / 1000
					...
					if var_20_11.prefab_name ~= "" and arg_17_1.actors_[var_20_11.prefab_name] ~= nil then
						local var_20_16 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_11.prefab_name].transform, "story_v_chess_62104", "62104004", "story_v_chess_62104.awb")

						arg_17_1:RecordAudio("62104004", var_20_16)
						arg_17_1:RecordAudio("62104004", var_20_16)
					else
	...
	Play62104005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if 0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_1 + arg_24_0 then
				...
				local var_24_3 = arg_21_1:FormatText(arg_21_1:GetWordFromCfg(62104005).content)
	...
	Play62104006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if 0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_3 + arg_28_0 then
				...
				local var_28_5 = arg_25_1:GetWordFromCfg(62104006)
				...
				local var_28_8 = 18 <= 0 and var_28_4 or var_28_4 * (utf8.len(var_28_6) / 18)

				if (18 <= 0 and var_28_4 or var_28_4 * (utf8.len(var_28_6) / 18)) > 0 and var_28_4 < var_28_8 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62104", "62104006", "story_v_chess_62104.awb") ~= 0 then
					local var_28_9 = manager.audio:GetVoiceLength("story_v_chess_62104", "62104006", "story_v_chess_62104.awb") / 1000
					...
					if var_28_5.prefab_name ~= "" and arg_25_1.actors_[var_28_5.prefab_name] ~= nil then
						local var_28_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_5.prefab_name].transform, "story_v_chess_62104", "62104006", "story_v_chess_62104.awb")

						arg_25_1:RecordAudio("62104006", var_28_10)
						arg_25_1:RecordAudio("62104006", var_28_10)
					else
	...
	Play62104007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if 0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:FormatText(arg_29_1:GetWordFromCfg(62104007).content)
	...
	Play62104008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if 0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_3 + arg_36_0 then
				...
				local var_36_5 = arg_33_1:GetWordFromCfg(62104008)
				...
				local var_36_8 = 18 <= 0 and var_36_4 or var_36_4 * (utf8.len(var_36_6) / 18)

				if (18 <= 0 and var_36_4 or var_36_4 * (utf8.len(var_36_6) / 18)) > 0 and var_36_4 < var_36_8 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62104", "62104008", "story_v_chess_62104.awb") ~= 0 then
					local var_36_9 = manager.audio:GetVoiceLength("story_v_chess_62104", "62104008", "story_v_chess_62104.awb") / 1000
					...
					if var_36_5.prefab_name ~= "" and arg_33_1.actors_[var_36_5.prefab_name] ~= nil then
						local var_36_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_5.prefab_name].transform, "story_v_chess_62104", "62104008", "story_v_chess_62104.awb")

						arg_33_1:RecordAudio("62104008", var_36_10)
						arg_33_1:RecordAudio("62104008", var_36_10)
					else
	...
	Play62104009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_1 + arg_40_0 then
				...
				local var_40_3 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(62104009).content)
