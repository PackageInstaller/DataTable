	...
	Play417051045 = function(arg_186_0, arg_186_1)
		...
		function arg_186_1.onSingleLineUpdate_(arg_189_0)
			if 0 < arg_186_1.time_ and arg_186_1.time_ <= 0 + arg_189_0 then
				...
				for iter_189_0, iter_189_1 in ipairs((var_189_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_189_1.transform.localScale = Vector3.New(iter_189_1.transform.localScale.x / var_189_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_189_1.transform.localScale.y / var_189_2, iter_189_1.transform.localScale.z)
				end
			end
			...
			if arg_186_1.time_ >= var_189_4 + 1.6 and arg_186_1.time_ < var_189_4 + 1.6 + arg_189_0 then
			...
			local var_189_6 = 1.6
			local var_189_7 = 1.375

			if 1.6 < arg_186_1.time_ and arg_186_1.time_ <= var_189_6 + arg_189_0 then
				...
				local var_189_8 = LeanTween.value(arg_186_1.dialog_, 0, 1, 0.3)

				var_189_8:setOnUpdate(LuaHelper.FloatAction(function(arg_190_0)
					arg_186_1.dialogCg_.alpha = arg_190_0
				end))
				var_189_8:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_186_1.dialog_)
					var_189_8:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_189_9 = arg_186_1:FormatText(arg_186_1:GetWordFromCfg(417051045).content)

				arg_186_1.text_.text = var_189_9

				LuaForUtil.ClearLinePrefixSymbol(arg_186_1.text_)

				local var_189_11 = 55 <= 0 and var_189_7 or var_189_7 * (utf8.len(var_189_9) / 55)

				if (55 <= 0 and var_189_7 or var_189_7 * (utf8.len(var_189_9) / 55)) > 0 and var_189_7 < var_189_11 then
					arg_186_1.talkMaxDuration = var_189_11
					var_189_6 = var_189_6 + 0.3
			...
			local var_189_12 = var_189_6 + 0.3
			local var_189_13 = math.max(var_189_7, arg_186_1.talkMaxDuration)

			if var_189_6 + 0.3 <= arg_186_1.time_ and arg_186_1.time_ < var_189_12 + var_189_13 then
				arg_186_1.typewritter.percent = (arg_186_1.time_ - var_189_12) / var_189_13
