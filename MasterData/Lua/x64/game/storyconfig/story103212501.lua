	...
	Play321251001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				...
				for iter_4_2, iter_4_3 in ipairs((var_4_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_4_3.transform.localScale = Vector3.New(iter_4_3.transform.localScale.x / var_4_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_4_3.transform.localScale.y / var_4_15, iter_4_3.transform.localScale.z)
				end
			end
			...
			if 0.533333333333333 < arg_1_1.time_ and arg_1_1.time_ <= 0.533333333333333 + arg_4_0 then
				...
				local var_4_22 = manager.audio:GetAudioName("bgm_activity_4_0_story_osiris_room", "bgm_activity_4_0_story_osiris_room")
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_25 + arg_4_0 then
				...
				local var_4_28 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(321251001).content)

				arg_1_1.text_.text = var_4_28

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_30 = 25 <= 0 and var_4_26 or var_4_26 * (utf8.len(var_4_28) / 25)

				if (25 <= 0 and var_4_26 or var_4_26 * (utf8.len(var_4_28) / 25)) > 0 and var_4_26 < var_4_30 then
	...
	Play321251077 = function(arg_325_0, arg_325_1)
		...
		function arg_325_1.onSingleLineUpdate_(arg_328_0)
			...
			if 60.8333333333333 < arg_325_1.time_ and arg_325_1.time_ <= 60.8333333333333 + arg_328_0 then
				...
				for iter_328_4, iter_328_5 in ipairs((var_328_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_328_5.transform.localScale = Vector3.New(iter_328_5.transform.localScale.x / var_328_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_328_5.transform.localScale.y / var_328_15, iter_328_5.transform.localScale.z)
				end
			end
			...
			local var_328_18 = arg_325_1.bgs_.MS2114.transform

			if 60.8333333333333 < arg_325_1.time_ and arg_325_1.time_ <= 60.8333333333333 + arg_328_0 then
				arg_325_1.var_.moveOldPosMS2114 = var_328_18.localPosition
			end

			local var_328_19 = 0.1

			if 60.8333333333333 <= arg_325_1.time_ and arg_325_1.time_ < 60.8333333333333 + var_328_19 then
				var_328_18.localPosition = Vector3.Lerp(arg_325_1.var_.moveOldPosMS2114, Vector3.New(0, 1, 9.5), (arg_325_1.time_ - 60.8333333333333) / var_328_19)
			end

			if arg_325_1.time_ >= 60.8333333333333 + var_328_19 and arg_325_1.time_ < 60.8333333333333 + var_328_19 + arg_328_0 then
				var_328_18.localPosition = Vector3.New(0, 1, 9.5)
			end

			local var_328_20 = arg_325_1.bgs_.MS2114.transform

			if 60.9333333333333 < arg_325_1.time_ and arg_325_1.time_ <= 60.9333333333333 + arg_328_0 then
				arg_325_1.var_.moveOldPosMS2114 = var_328_20.localPosition
			end

			local var_328_21 = 4.5

			if 60.9333333333333 <= arg_325_1.time_ and arg_325_1.time_ < 60.9333333333333 + var_328_21 then
				var_328_20.localPosition = Vector3.Lerp(arg_325_1.var_.moveOldPosMS2114, Vector3.New(0, 1, 10), (arg_325_1.time_ - 60.9333333333333) / var_328_21)
			end

			if arg_325_1.time_ >= 60.9333333333333 + var_328_21 and arg_325_1.time_ < 60.9333333333333 + var_328_21 + arg_328_0 then
				var_328_20.localPosition = Vector3.New(0, 1, 10)
			end

			if 60.8333333333333 < arg_325_1.time_ and arg_325_1.time_ <= 60.8333333333333 + arg_328_0 then
				local var_328_22 = arg_325_1.var_.effectchongsheng2

				if not arg_325_1.var_.effectchongsheng2 then
					var_328_22 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_suduxian02_in_keep"), manager.ui.mainCamera.transform)
					var_328_22.name = "chongsheng2"
					arg_325_1.var_.effectchongsheng2 = var_328_22
				else
					var_328_22.transform:SetParent(var_328_9000)
				end

				var_328_22.transform.localPosition = Vector3.New(0, 0, 0)
				var_328_22.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			local var_328_25 = 60.5

			if 60.5 < arg_325_1.time_ and arg_325_1.time_ <= var_328_25 + arg_328_0 then
				arg_325_1.allBtn_.enabled = false
			end

			if arg_325_1.time_ >= var_328_25 + 2.46666666666667 and arg_325_1.time_ < var_328_25 + 2.46666666666667 + arg_328_0 then
				arg_325_1.allBtn_.enabled = true
			end

			local var_328_26 = 60.1

			if 60.1 < arg_325_1.time_ and arg_325_1.time_ <= var_328_26 + arg_328_0 then
				arg_325_1.mask_.enabled = true
				arg_325_1.mask_.raycastTarget = true
			...
			local var_328_27 = 0.833333333333329

			if var_328_26 <= arg_325_1.time_ and arg_325_1.time_ < var_328_26 + var_328_27 then
				local var_328_28 = Color.New(0, 0, 0)

				var_328_28.a = Mathf.Lerp(1, 0, (arg_325_1.time_ - var_328_26) / var_328_27)
			...
			if 0 < arg_325_1.time_ and arg_325_1.time_ <= var_328_30 + arg_328_0 then
				...
				manager.video:Play("SofdecAsset/story/story_1032125.usm", function(arg_329_0)
					arg_325_1.time_ = var_328_30 + 60.4483333335569
			...
			local var_328_31 = 60.4583333333333
			...
			if 60.4583333333333 < arg_325_1.time_ and arg_325_1.time_ <= var_328_32 + arg_328_0 then
			...
			local var_328_33 = 0.474999999999994
			...
			if 0 < arg_325_1.time_ and arg_325_1.time_ <= var_328_34 + arg_328_0 then
			...
			local var_328_35 = 0
			local var_328_36 = 0.034000001847744
			local var_328_37, var_328_38 = arg_325_1:GetPercentByPara(arg_325_1:FormatText(arg_325_1:GetWordFromCfg(102).content), 1)

			if var_328_34 < arg_325_1.time_ and arg_325_1.time_ <= var_328_34 + arg_328_0 then
				arg_325_1.talkMaxDuration = 0

				local var_328_39 = var_328_35 <= 0 and var_328_36 or var_328_36 * ((var_328_38 - arg_325_1.typewritterCharCountI18N) / var_328_35)

				if (var_328_35 <= 0 and var_328_36 or var_328_36 * ((var_328_38 - arg_325_1.typewritterCharCountI18N) / var_328_35)) > 0 and var_328_36 < var_328_39 then
					arg_325_1.talkMaxDuration = var_328_39

					if var_328_39 + var_328_34 > arg_325_1.duration_ then
						arg_325_1.duration_ = var_328_39 + var_328_34
					end
				end
			end

			local var_328_40 = math.max(0.034000001847744, arg_325_1.talkMaxDuration)

			if var_328_34 <= arg_325_1.time_ and arg_325_1.time_ < var_328_34 + var_328_40 then
				arg_325_1.fswtw_.percent = Mathf.Lerp(arg_325_1.var_.oldValueTypewriter, var_328_37, (arg_325_1.time_ - var_328_34) / var_328_40)
				arg_325_1.fswt_:GetComponent("Text").color = Color(1, 1, 1)

				arg_325_1.fswtw_:SetDirty()
			end

			if arg_325_1.time_ >= var_328_34 + var_328_40 and arg_325_1.time_ < var_328_34 + var_328_40 + arg_328_0 then
				arg_325_1.fswtw_.percent = var_328_37

				arg_325_1.fswtw_:SetDirty()
				arg_325_1:ShowNextGo(true)

				arg_325_1.typewritterCharCountI18N = var_328_38
			end

			local var_328_41 = 0.034000001847744

			if 0.034000001847744 < arg_325_1.time_ and arg_325_1.time_ <= var_328_41 + arg_328_0 then
				arg_325_1.var_.oldValueTypewriter = arg_325_1.fswtw_.percent
			...
			local var_328_42 = 0
			local var_328_43 = 0.599333331485624
			local var_328_44, var_328_45 = arg_325_1:GetPercentByPara(arg_325_1:FormatText(arg_325_1:GetWordFromCfg(102).content), 1)

			if var_328_41 < arg_325_1.time_ and arg_325_1.time_ <= var_328_41 + arg_328_0 then
				arg_325_1.talkMaxDuration = 0

				local var_328_46 = var_328_42 <= 0 and var_328_43 or var_328_43 * ((var_328_45 - arg_325_1.typewritterCharCountI18N) / var_328_42)

				if (var_328_42 <= 0 and var_328_43 or var_328_43 * ((var_328_45 - arg_325_1.typewritterCharCountI18N) / var_328_42)) > 0 and var_328_43 < var_328_46 then
					arg_325_1.talkMaxDuration = var_328_46

					if var_328_46 + var_328_41 > arg_325_1.duration_ then
						arg_325_1.duration_ = var_328_46 + var_328_41
					end
				end
			end

			local var_328_47 = math.max(0.599333331485624, arg_325_1.talkMaxDuration)

			if var_328_41 <= arg_325_1.time_ and arg_325_1.time_ < var_328_41 + var_328_47 then
				arg_325_1.fswtw_.percent = Mathf.Lerp(arg_325_1.var_.oldValueTypewriter, var_328_44, (arg_325_1.time_ - var_328_41) / var_328_47)
				arg_325_1.fswt_:GetComponent("Text").color = Color(1, 1, 1)

				arg_325_1.fswtw_:SetDirty()
			end

			if arg_325_1.time_ >= var_328_41 + var_328_47 and arg_325_1.time_ < var_328_41 + var_328_47 + arg_328_0 then
				arg_325_1.fswtw_.percent = var_328_44

				arg_325_1.fswtw_:SetDirty()
				arg_325_1:ShowNextGo(true)

				arg_325_1.typewritterCharCountI18N = var_328_45
			end
			...
			if 0 < arg_325_1.time_ and arg_325_1.time_ <= 0 + arg_328_0 then
				...
				local var_328_50 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_325_1.bgmTxt_.text ~= var_328_50 and arg_325_1.bgmTxt_.text ~= "" then
						if arg_325_1.bgmTxt2_.text ~= "" then
							arg_325_1.bgmTxt_.text = arg_325_1.bgmTxt2_.text
						end

						arg_325_1.bgmTxt2_.text = var_328_50

						arg_325_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_325_1.bgmTxt_.text = var_328_50
						arg_325_1.bgmTxt2_.text = var_328_50
					end
			...
			if 60.8333333333333 < arg_325_1.time_ and arg_325_1.time_ <= 60.8333333333333 + arg_328_0 then
				...
				local var_328_53 = manager.audio:GetAudioName("bgm_activity_4_0_story_osiris_room", "bgm_activity_4_0_story_osiris_room")

				if "" ~= "" then
					if arg_325_1.bgmTxt_.text ~= var_328_53 and arg_325_1.bgmTxt_.text ~= "" then
						if arg_325_1.bgmTxt2_.text ~= "" then
							arg_325_1.bgmTxt_.text = arg_325_1.bgmTxt2_.text
						end

						arg_325_1.bgmTxt2_.text = var_328_53

						arg_325_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_325_1.bgmTxt_.text = var_328_53
						arg_325_1.bgmTxt2_.text = var_328_53
					end
			...
			local var_328_54 = 62.5340000018477
			local var_328_55 = 0.725

			if 62.5340000018477 < arg_325_1.time_ and arg_325_1.time_ <= var_328_54 + arg_328_0 then
				arg_325_1.talkMaxDuration = 0
				...
				local var_328_56 = LeanTween.value(arg_325_1.dialog_, 0, 1, 0.3)

				var_328_56:setOnUpdate(LuaHelper.FloatAction(function(arg_333_0)
					arg_325_1.dialogCg_.alpha = arg_333_0
				end))
				var_328_56:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_325_1.dialog_)
					var_328_56:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_328_57 = arg_325_1:GetWordFromCfg(321251077)
				local var_328_58 = arg_325_1:FormatText(var_328_57.content)

				arg_325_1.text_.text = var_328_58

				LuaForUtil.ClearLinePrefixSymbol(arg_325_1.text_)

				local var_328_60 = 29 <= 0 and var_328_55 or var_328_55 * (utf8.len(var_328_58) / 29)

				if (29 <= 0 and var_328_55 or var_328_55 * (utf8.len(var_328_58) / 29)) > 0 and var_328_55 < var_328_60 then
					arg_325_1.talkMaxDuration = var_328_60
					var_328_54 = var_328_54 + 0.3

					if var_328_60 + var_328_54 > arg_325_1.duration_ then
						arg_325_1.duration_ = var_328_60 + var_328_54
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_321251", "321251077", "story_v_out_321251.awb") ~= 0 then
					local var_328_61 = manager.audio:GetVoiceLength("story_v_out_321251", "321251077", "story_v_out_321251.awb") / 1000

					if var_328_61 + var_328_54 > arg_325_1.duration_ then
						arg_325_1.duration_ = var_328_61 + var_328_54
					end

					if var_328_57.prefab_name ~= "" and arg_325_1.actors_[var_328_57.prefab_name] ~= nil then
						local var_328_62 = LuaForUtil.PlayVoiceWithCriLipsync(arg_325_1.actors_[var_328_57.prefab_name].transform, "story_v_out_321251", "321251077", "story_v_out_321251.awb")

						arg_325_1:RecordAudio("321251077", var_328_62)
						arg_325_1:RecordAudio("321251077", var_328_62)
					else
			...
			local var_328_63 = var_328_54 + 0.3
			local var_328_64 = math.max(var_328_55, arg_325_1.talkMaxDuration)

			if var_328_54 + 0.3 <= arg_325_1.time_ and arg_325_1.time_ < var_328_63 + var_328_64 then
