return {
	Play414401001 = function(arg_1_0, arg_1_1)
		arg_1_1.time_ = 0
		arg_1_1.frameCnt_ = 0
		arg_1_1.state_ = "playing"
		arg_1_1.curTalkId_ = 414401001
		arg_1_1.duration_ = 7
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_9 = "104902ui_story"

			if arg_1_1.actors_["104902ui_story"] == nil and not isNil((Asset.Load("Char/" .. "104902ui_story"))) then
				local var_4_10 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_13 = arg_1_1.actors_["104902ui_story"].transform

			if 1.86666666666667 < arg_1_1.time_ and arg_1_1.time_ <= 1.86666666666667 + arg_4_0 then
				arg_1_1.var_.moveOldPos104902ui_story = var_4_13.localPosition
			end

			local var_4_14 = 0.001

			if 1.86666666666667 <= arg_1_1.time_ and arg_1_1.time_ < 1.86666666666667 + var_4_14 then
				var_4_13.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_1_1.time_ - 1.86666666666667) / var_4_14)
			...
			local var_4_15 = arg_1_1.actors_["104902ui_story"]

			if 1.86666666666667 < arg_1_1.time_ and arg_1_1.time_ <= 1.86666666666667 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect104902ui_story == nil then
				arg_1_1.var_.characterEffect104902ui_story = var_4_15:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_4_16 = 0.200000002980232

			if 1.86666666666667 <= arg_1_1.time_ and arg_1_1.time_ < 1.86666666666667 + var_4_16 and not isNil(var_4_15) then
				if arg_1_1.var_.characterEffect104902ui_story and not isNil(var_4_15) then
					arg_1_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= 1.86666666666667 + var_4_16 and arg_1_1.time_ < 1.86666666666667 + var_4_16 + arg_4_0 and not isNil(var_4_15) and arg_1_1.var_.characterEffect104902ui_story then
				arg_1_1.var_.characterEffect104902ui_story.fillFlat = false
			end

			if 1.86666666666667 < arg_1_1.time_ and arg_1_1.time_ <= 1.86666666666667 + arg_4_0 then
				arg_1_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1301cva")
			end

			if 1.86666666666667 < arg_1_1.time_ and arg_1_1.time_ <= 1.86666666666667 + arg_4_0 then
				arg_1_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action8_1")
			end

			if 0 < arg_1_1.time_ and arg_1_1.time_ <= 0 + arg_4_0 then
				arg_1_1:AudioAction("play", "effect", "se_story_side_1039", "se_story_1039_water", "")
			end
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_19 + arg_4_0 then
				...
				local var_4_22 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(414401001).content)

				arg_1_1.text_.text = var_4_22

				LuaForUtil.ClearLinePrefixSymbol(arg_1_1.text_)

				local var_4_24 = 4 <= 0 and var_4_20 or var_4_20 * (utf8.len(var_4_22) / 4)

				if (4 <= 0 and var_4_20 or var_4_20 * (utf8.len(var_4_22) / 4)) > 0 and var_4_20 < var_4_24 then
	...
	Play414401002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 414401002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.playNext_(arg_9_0)
			if arg_9_0 == 1 then
				arg_7_0:Play414401003(arg_7_1)
			end
		end

		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 then
				arg_7_1.var_.moveOldPos104902ui_story = arg_7_1.actors_["104902ui_story"].transform.localPosition
			end

			local var_10_0 = 0.001

			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_0 then
				arg_7_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos104902ui_story, Vector3.New(0, 100, 0), (arg_7_1.time_ - 0) / var_10_0)
				arg_7_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_7_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_7_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_7_1.actors_["104902ui_story"].transform.position).z)
				arg_7_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_7_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_7_1.actors_["104902ui_story"].transform.localEulerAngles = arg_7_1.actors_["104902ui_story"].transform.localEulerAngles
			end

			if arg_7_1.time_ >= 0 + var_10_0 and arg_7_1.time_ < 0 + var_10_0 + arg_10_0 then
				arg_7_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_7_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_7_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_7_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_7_1.actors_["104902ui_story"].transform.position).z)
				arg_7_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_7_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_7_1.actors_["104902ui_story"].transform.localEulerAngles = arg_7_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			local var_10_1 = arg_7_1.actors_["104902ui_story"]

			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 and not isNil(var_10_1) and arg_7_1.var_.characterEffect104902ui_story == nil then
				arg_7_1.var_.characterEffect104902ui_story = var_10_1:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_10_2 = 0.200000002980232

			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_2 and not isNil(var_10_1) then
				if arg_7_1.var_.characterEffect104902ui_story and not isNil(var_10_1) then
					arg_7_1.var_.characterEffect104902ui_story.fillFlat = true
					arg_7_1.var_.characterEffect104902ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_7_1.time_ - 0) / var_10_2)
				end
			end

			if arg_7_1.time_ >= 0 + var_10_2 and arg_7_1.time_ < 0 + var_10_2 + arg_10_0 and not isNil(var_10_1) and arg_7_1.var_.characterEffect104902ui_story then
				arg_7_1.var_.characterEffect104902ui_story.fillFlat = true
				arg_7_1.var_.characterEffect104902ui_story.fillRatio = 0.5
			end
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_3 + arg_10_0 then
				...
				local var_10_5 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(414401002).content)

				arg_7_1.text_.text = var_10_5

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_7 = 56 <= 0 and var_10_4 or var_10_4 * (utf8.len(var_10_5) / 56)

				if (56 <= 0 and var_10_4 or var_10_4 * (utf8.len(var_10_5) / 56)) > 0 and var_10_4 < var_10_7 then
	...
	Play414401003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 414401003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play414401004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= 0 + arg_14_0 then
				...
				local var_14_1 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(414401003).content)
	...
	Play414401004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 414401004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play414401005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= 0 + arg_18_0 then
				...
				local var_18_1 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(414401004).content)
	...
	Play414401005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 414401005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play414401006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= 0 + arg_22_0 then
				...
				local var_22_1 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(414401005).content)
	...
	Play414401006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 414401006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play414401007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 <= arg_23_1.time_ and arg_23_1.time_ < 0 + var_26_0 then
				arg_23_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_23_1.var_.moveOldPos104902ui_story, Vector3.New(0, -1.2, -6), (arg_23_1.time_ - 0) / var_26_0)
			...
			if arg_23_1.time_ >= 0 + var_26_0 and arg_23_1.time_ < 0 + var_26_0 + arg_26_0 then
				arg_23_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, -1.2, -6)
				arg_23_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_23_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_23_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_23_1.actors_["104902ui_story"].transform.position).z)
				arg_23_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_23_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_23_1.actors_["104902ui_story"].transform.localEulerAngles = arg_23_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				arg_23_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface2201cva")
			end

			if 0 < arg_23_1.time_ and arg_23_1.time_ <= 0 + arg_26_0 then
				arg_23_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action8_2")
			end
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_4 + arg_26_0 then
				...
				local var_26_6 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(414401006).content)

				arg_23_1.text_.text = var_26_6

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_8 = 16 <= 0 and var_26_5 or var_26_5 * (utf8.len(var_26_6) / 16)

				if (16 <= 0 and var_26_5 or var_26_5 * (utf8.len(var_26_6) / 16)) > 0 and var_26_5 < var_26_8 then
	...
	Play414401007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 414401007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play414401008(arg_27_1)
			end
		end
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_1 + arg_30_0 then
				...
				local var_30_3 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(414401007).content)
	...
	Play414401008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 414401008
		arg_31_1.duration_ = 8.07
		...
		function arg_31_1.playNext_(arg_33_0)
			if arg_33_0 == 1 then
				arg_31_0:Play414401009(arg_31_1)
			end
		end

		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			if 1.30900000184774 < arg_31_1.time_ and arg_31_1.time_ <= 1.30900000184774 + arg_34_0 then
				local var_34_0 = arg_31_1.bgs_.H07f

				arg_31_1.bgs_.H07f.transform.localPosition = Vector3.New(0, 0, 10) + Vector3.New(manager.ui.mainCamera.transform.localPosition.x, manager.ui.mainCamera.transform.localPosition.y, 0)
			...
			local var_34_8 = 1.275

			if 1.275 < arg_31_1.time_ and arg_31_1.time_ <= var_34_8 + arg_34_0 then
				arg_31_1.mask_.enabled = true
				arg_31_1.mask_.raycastTarget = true
			...
			local var_34_12 = arg_31_1.actors_["104902ui_story"].transform

			if 1.275 < arg_31_1.time_ and arg_31_1.time_ <= 1.275 + arg_34_0 then
				arg_31_1.var_.moveOldPos104902ui_story = var_34_12.localPosition
			end

			local var_34_13 = 0.001

			if 1.275 <= arg_31_1.time_ and arg_31_1.time_ < 1.275 + var_34_13 then
				var_34_12.localPosition = Vector3.Lerp(arg_31_1.var_.moveOldPos104902ui_story, Vector3.New(0, 100, 0), (arg_31_1.time_ - 1.275) / var_34_13)
				var_34_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_34_12.position).x, (manager.ui.mainCamera.transform.position - var_34_12.position).y, (manager.ui.mainCamera.transform.position - var_34_12.position).z)
				var_34_12.localEulerAngles.z = 0
				var_34_12.localEulerAngles.x = 0
				var_34_12.localEulerAngles = var_34_12.localEulerAngles
			end

			if arg_31_1.time_ >= 1.275 + var_34_13 and arg_31_1.time_ < 1.275 + var_34_13 + arg_34_0 then
				var_34_12.localPosition = Vector3.New(0, 100, 0)
				var_34_12.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_34_12.position).x, (manager.ui.mainCamera.transform.position - var_34_12.position).y, (manager.ui.mainCamera.transform.position - var_34_12.position).z)
				var_34_12.localEulerAngles.z = 0
				var_34_12.localEulerAngles.x = 0
				var_34_12.localEulerAngles = var_34_12.localEulerAngles
			...
			local var_34_14 = 3.06666666666667
			local var_34_15 = 1.275

			if 3.06666666666667 < arg_31_1.time_ and arg_31_1.time_ <= var_34_14 + arg_34_0 then
				...
				local var_34_16 = LeanTween.value(arg_31_1.dialog_, 0, 1, 0.3)

				var_34_16:setOnUpdate(LuaHelper.FloatAction(function(arg_35_0)
					arg_31_1.dialogCg_.alpha = arg_35_0
				end))
				var_34_16:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_31_1.dialog_)
					var_34_16:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_34_17 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(414401008).content)

				arg_31_1.text_.text = var_34_17

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_19 = 51 <= 0 and var_34_15 or var_34_15 * (utf8.len(var_34_17) / 51)

				if (51 <= 0 and var_34_15 or var_34_15 * (utf8.len(var_34_17) / 51)) > 0 and var_34_15 < var_34_19 then
					arg_31_1.talkMaxDuration = var_34_19
					var_34_14 = var_34_14 + 0.3
			...
			local var_34_20 = var_34_14 + 0.3
			local var_34_21 = math.max(var_34_15, arg_31_1.talkMaxDuration)

			if var_34_14 + 0.3 <= arg_31_1.time_ and arg_31_1.time_ < var_34_20 + var_34_21 then
	...
	Play414401009 = function(arg_37_0, arg_37_1)
		arg_37_1.time_ = 0
		arg_37_1.frameCnt_ = 0
		arg_37_1.state_ = "playing"
		arg_37_1.curTalkId_ = 414401009
		...
		function arg_37_1.playNext_(arg_39_0)
			if arg_39_0 == 1 then
				arg_37_0:Play414401010(arg_37_1)
			end
		end
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				arg_37_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0102cva")
			end

			if 0 < arg_37_1.time_ and arg_37_1.time_ <= 0 + arg_40_0 then
				arg_37_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action2_1")
			end
			...
			if 0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_4 + arg_40_0 then
				...
				local var_40_6 = arg_37_1:FormatText(arg_37_1:GetWordFromCfg(414401009).content)

				arg_37_1.text_.text = var_40_6

				LuaForUtil.ClearLinePrefixSymbol(arg_37_1.text_)

				local var_40_8 = 8 <= 0 and var_40_5 or var_40_5 * (utf8.len(var_40_6) / 8)

				if (8 <= 0 and var_40_5 or var_40_5 * (utf8.len(var_40_6) / 8)) > 0 and var_40_5 < var_40_8 then
	...
	Play414401010 = function(arg_41_0, arg_41_1)
		arg_41_1.time_ = 0
		arg_41_1.frameCnt_ = 0
		arg_41_1.state_ = "playing"
		arg_41_1.curTalkId_ = 414401010
		...
		function arg_41_1.playNext_(arg_43_0)
			if arg_43_0 == 1 then
				arg_41_0:Play414401011(arg_41_1)
			end
		end
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if 0 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				...
				local var_44_3 = arg_41_1:FormatText(arg_41_1:GetWordFromCfg(414401010).content)
	...
	Play414401011 = function(arg_45_0, arg_45_1)
		arg_45_1.time_ = 0
		arg_45_1.frameCnt_ = 0
		arg_45_1.state_ = "playing"
		arg_45_1.curTalkId_ = 414401011
		...
		function arg_45_1.playNext_(arg_47_0)
			if arg_47_0 == 1 then
				arg_45_0:Play414401012(arg_45_1)
			end
		end
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if 0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_2 + arg_48_0 then
				...
				local var_48_4 = arg_45_1:FormatText(arg_45_1:GetWordFromCfg(414401011).content)

				arg_45_1.text_.text = var_48_4

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_6 = 15 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 15)

				if (15 <= 0 and var_48_3 or var_48_3 * (utf8.len(var_48_4) / 15)) > 0 and var_48_3 < var_48_6 then
	...
	Play414401012 = function(arg_49_0, arg_49_1)
		arg_49_1.time_ = 0
		arg_49_1.frameCnt_ = 0
		arg_49_1.state_ = "playing"
		arg_49_1.curTalkId_ = 414401012
		...
		function arg_49_1.playNext_(arg_51_0)
			if arg_51_0 == 1 then
				arg_49_0:Play414401013(arg_49_1)
			end
		end

		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1101cva")
			end

			if 0 < arg_49_1.time_ and arg_49_1.time_ <= 0 + arg_52_0 then
				arg_49_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action2_2")
			end
			...
			if 0 < arg_49_1.time_ and arg_49_1.time_ <= var_52_0 + arg_52_0 then
				...
				local var_52_2 = arg_49_1:FormatText(arg_49_1:GetWordFromCfg(414401012).content)

				arg_49_1.text_.text = var_52_2

				LuaForUtil.ClearLinePrefixSymbol(arg_49_1.text_)

				local var_52_4 = 13 <= 0 and var_52_1 or var_52_1 * (utf8.len(var_52_2) / 13)

				if (13 <= 0 and var_52_1 or var_52_1 * (utf8.len(var_52_2) / 13)) > 0 and var_52_1 < var_52_4 then
	...
	Play414401013 = function(arg_53_0, arg_53_1)
		arg_53_1.time_ = 0
		arg_53_1.frameCnt_ = 0
		arg_53_1.state_ = "playing"
		arg_53_1.curTalkId_ = 414401013
		...
		function arg_53_1.playNext_(arg_55_0)
			if arg_55_0 == 1 then
				arg_53_0:Play414401014(arg_53_1)
			end
		end
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if 0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_1 + arg_56_0 then
				...
				local var_56_3 = arg_53_1:FormatText(arg_53_1:GetWordFromCfg(414401013).content)

				arg_53_1.text_.text = var_56_3

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_5 = 15 <= 0 and var_56_2 or var_56_2 * (utf8.len(var_56_3) / 15)

				if (15 <= 0 and var_56_2 or var_56_2 * (utf8.len(var_56_3) / 15)) > 0 and var_56_2 < var_56_5 then
	...
	Play414401014 = function(arg_57_0, arg_57_1)
		arg_57_1.time_ = 0
		arg_57_1.frameCnt_ = 0
		arg_57_1.state_ = "playing"
		arg_57_1.curTalkId_ = 414401014
		...
		function arg_57_1.playNext_(arg_59_0)
			if arg_59_0 == 1 then
				arg_57_0:Play414401015(arg_57_1)
			end
		end
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if 0 < arg_57_1.time_ and arg_57_1.time_ <= var_60_2 + arg_60_0 then
				...
				local var_60_4 = arg_57_1:FormatText(arg_57_1:GetWordFromCfg(414401014).content)

				arg_57_1.text_.text = var_60_4

				LuaForUtil.ClearLinePrefixSymbol(arg_57_1.text_)

				local var_60_6 = 21 <= 0 and var_60_3 or var_60_3 * (utf8.len(var_60_4) / 21)

				if (21 <= 0 and var_60_3 or var_60_3 * (utf8.len(var_60_4) / 21)) > 0 and var_60_3 < var_60_6 then
	...
	Play414401015 = function(arg_61_0, arg_61_1)
		arg_61_1.time_ = 0
		arg_61_1.frameCnt_ = 0
		arg_61_1.state_ = "playing"
		arg_61_1.curTalkId_ = 414401015
		...
		function arg_61_1.playNext_(arg_63_0)
			if arg_63_0 == 1 then
				arg_61_0:Play414401016(arg_61_1)
			end
		end
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if 0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_1 + arg_64_0 then
				...
				local var_64_3 = arg_61_1:FormatText(arg_61_1:GetWordFromCfg(414401015).content)
	...
	Play414401016 = function(arg_65_0, arg_65_1)
		arg_65_1.time_ = 0
		arg_65_1.frameCnt_ = 0
		arg_65_1.state_ = "playing"
		arg_65_1.curTalkId_ = 414401016
		...
		function arg_65_1.onSingleLineFinish_()
			...
			arg_65_1.choices_[1].txt.text = arg_65_1:FormatText(StoryChoiceCfg[920].name)
			arg_65_1.choices_[2].txt.text = arg_65_1:FormatText(StoryChoiceCfg[921].name)
		end

		function arg_65_1.playNext_(arg_67_0)
			if arg_67_0 == 1 then
				arg_65_0:Play414401017(arg_65_1)
			end
			...
			arg_65_1:RecordChoiceLog(414401016, 920, 921)
		end
	...
	Play414401017 = function(arg_69_0, arg_69_1)
		arg_69_1.time_ = 0
		arg_69_1.frameCnt_ = 0
		arg_69_1.state_ = "playing"
		arg_69_1.curTalkId_ = 414401017
		...
		function arg_69_1.playNext_(arg_71_0)
			if arg_71_0 == 1 then
				arg_69_0:Play414401019(arg_69_1)
			end
		end
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if 0 < arg_69_1.time_ and arg_69_1.time_ <= 0 + arg_72_0 then
				...
				local var_72_1 = arg_69_1:FormatText(arg_69_1:GetWordFromCfg(414401017).content)

				arg_69_1.text_.text = var_72_1

				LuaForUtil.ClearLinePrefixSymbol(arg_69_1.text_)

				local var_72_3 = 33 <= 0 and var_72_0 or var_72_0 * (utf8.len(var_72_1) / 33)

				if (33 <= 0 and var_72_0 or var_72_0 * (utf8.len(var_72_1) / 33)) > 0 and var_72_0 < var_72_3 then
	...
	Play414401019 = function(arg_73_0, arg_73_1)
		arg_73_1.time_ = 0
		arg_73_1.frameCnt_ = 0
		arg_73_1.state_ = "playing"
		arg_73_1.curTalkId_ = 414401019
		...
		function arg_73_1.playNext_(arg_75_0)
			if arg_75_0 == 1 then
				arg_73_0:Play414401020(arg_73_1)
			end
		end
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				arg_73_1:PlayTimeline("104902ui_story", "StoryTimeline/CharAction/story104902/story104902action/104902action4_1")
			end
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= var_76_4 + arg_76_0 then
				...
				local var_76_6 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(414401019).content)

				arg_73_1.text_.text = var_76_6

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_8 = 9 <= 0 and var_76_5 or var_76_5 * (utf8.len(var_76_6) / 9)

				if (9 <= 0 and var_76_5 or var_76_5 * (utf8.len(var_76_6) / 9)) > 0 and var_76_5 < var_76_8 then
	...
	Play414401020 = function(arg_77_0, arg_77_1)
		arg_77_1.time_ = 0
		arg_77_1.frameCnt_ = 0
		arg_77_1.state_ = "playing"
		arg_77_1.curTalkId_ = 414401020
		...
		function arg_77_1.playNext_(arg_79_0)
			if arg_79_0 == 1 then
				arg_77_0:Play414401021(arg_77_1)
			end
		end
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_0 then
				arg_77_1.actors_["104902ui_story"].transform.localPosition = Vector3.Lerp(arg_77_1.var_.moveOldPos104902ui_story, Vector3.New(0, 100, 0), (arg_77_1.time_ - 0) / var_80_0)
			...
			if arg_77_1.time_ >= 0 + var_80_0 and arg_77_1.time_ < 0 + var_80_0 + arg_80_0 then
				arg_77_1.actors_["104902ui_story"].transform.localPosition = Vector3.New(0, 100, 0)
				arg_77_1.actors_["104902ui_story"].transform.forward = Vector3.New((manager.ui.mainCamera.transform.position - arg_77_1.actors_["104902ui_story"].transform.position).x, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["104902ui_story"].transform.position).y, (manager.ui.mainCamera.transform.position - arg_77_1.actors_["104902ui_story"].transform.position).z)
				arg_77_1.actors_["104902ui_story"].transform.localEulerAngles.z = 0
				arg_77_1.actors_["104902ui_story"].transform.localEulerAngles.x = 0
				arg_77_1.actors_["104902ui_story"].transform.localEulerAngles = arg_77_1.actors_["104902ui_story"].transform.localEulerAngles
			...
			if 0 <= arg_77_1.time_ and arg_77_1.time_ < 0 + var_80_2 and not isNil(var_80_1) then
				if arg_77_1.var_.characterEffect104902ui_story and not isNil(var_80_1) then
					...
					arg_77_1.var_.characterEffect104902ui_story.fillRatio = Mathf.Lerp(0, 0.5, (arg_77_1.time_ - 0) / var_80_2)
				end
			end
			...
			if 0 < arg_77_1.time_ and arg_77_1.time_ <= var_80_3 + arg_80_0 then
				...
				local var_80_5 = arg_77_1:FormatText(arg_77_1:GetWordFromCfg(414401020).content)
	...
	Play414401021 = function(arg_81_0, arg_81_1)
		arg_81_1.time_ = 0
		arg_81_1.frameCnt_ = 0
		arg_81_1.state_ = "playing"
		arg_81_1.curTalkId_ = 414401021
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if 0 < arg_81_1.time_ and arg_81_1.time_ <= 0 + arg_84_0 then
				...
				local var_84_1 = arg_81_1:FormatText(arg_81_1:GetWordFromCfg(414401021).content)
	...
	Play414401018 = function(arg_85_0, arg_85_1)
		arg_85_1.time_ = 0
		arg_85_1.frameCnt_ = 0
		arg_85_1.state_ = "playing"
		arg_85_1.curTalkId_ = 414401018
		...
		function arg_85_1.playNext_(arg_87_0)
			if arg_87_0 == 1 then
				arg_85_0:Play414401019(arg_85_1)
			end
		end
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if 0 < arg_85_1.time_ and arg_85_1.time_ <= 0 + arg_88_0 then
				...
				local var_88_1 = arg_85_1:FormatText(arg_85_1:GetWordFromCfg(414401018).content)
