	...
	Play321091034 = function(arg_139_0, arg_139_1)
		...
		function arg_139_1.onSingleLineUpdate_(arg_142_0)
			if 1.4 < arg_139_1.time_ and arg_139_1.time_ <= 1.4 + arg_142_0 then
				...
				for iter_142_0, iter_142_1 in ipairs((var_142_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_142_1.transform.localScale = Vector3.New(iter_142_1.transform.localScale.x / var_142_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_142_1.transform.localScale.y / var_142_2, iter_142_1.transform.localScale.z)
				end
			end
			...
			if arg_139_1.time_ >= var_142_5 + 1.88333333333333 and arg_139_1.time_ < var_142_5 + 1.88333333333333 + arg_142_0 then
			...
			if 0 < arg_139_1.time_ and arg_139_1.time_ <= var_142_7 + arg_142_0 then
				...
				local var_142_9 = arg_139_1:GetWordFromCfg(321091034)
				...
				if manager.audio:GetVoiceLength("story_v_out_321091", "321091034", "story_v_out_321091.awb") ~= 0 then
					local var_142_13 = manager.audio:GetVoiceLength("story_v_out_321091", "321091034", "story_v_out_321091.awb") / 1000
					...
					if var_142_9.prefab_name ~= "" and arg_139_1.actors_[var_142_9.prefab_name] ~= nil then
						local var_142_14 = LuaForUtil.PlayVoiceWithCriLipsync(arg_139_1.actors_[var_142_9.prefab_name].transform, "story_v_out_321091", "321091034", "story_v_out_321091.awb")

						arg_139_1:RecordAudio("321091034", var_142_14)
						arg_139_1:RecordAudio("321091034", var_142_14)
					else
	...
	Play321091074 = function(arg_312_0, arg_312_1)
		...
		function arg_312_1.onSingleLineUpdate_(arg_315_0)
			...
			if 0.3 < arg_312_1.time_ and arg_312_1.time_ <= 0.3 + arg_315_0 then
				...
				for iter_315_0, iter_315_1 in ipairs((var_315_4.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_315_1.transform.localScale = Vector3.New(iter_315_1.transform.localScale.x / var_315_6 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_315_1.transform.localScale.y / var_315_6, iter_315_1.transform.localScale.z)
				end
			end

			local var_315_8 = manager.ui.mainCamera.transform

			if 0 < arg_312_1.time_ and arg_312_1.time_ <= 0 + arg_315_0 then
				arg_312_1.var_.shakeOldPos = var_315_8.localPosition
			end

			local var_315_9 = 0.8

			if 0 <= arg_312_1.time_ and arg_312_1.time_ < 0 + var_315_9 then
				local var_315_10, var_315_11 = math.modf((arg_312_1.time_ - 0) / 0.066)

				var_315_8.localPosition = Vector3.New(var_315_11 * 0.13, var_315_11 * 0.13, var_315_11 * 0.13) + arg_312_1.var_.shakeOldPos
			end

			if arg_312_1.time_ >= 0 + var_315_9 and arg_312_1.time_ < 0 + var_315_9 + arg_315_0 then
				var_315_8.localPosition = arg_312_1.var_.shakeOldPos
			end

			local var_315_12 = 0

			if 0 < arg_312_1.time_ and arg_312_1.time_ <= var_315_12 + arg_315_0 then
				arg_312_1.allBtn_.enabled = false
			end

			if arg_312_1.time_ >= var_315_12 + 1.56666666666667 and arg_312_1.time_ < var_315_12 + 1.56666666666667 + arg_315_0 then
			...
			local var_315_14 = 1.20000000298023
			local var_315_15 = 1.425

			if 1.20000000298023 < arg_312_1.time_ and arg_312_1.time_ <= var_315_14 + arg_315_0 then
				...
				local var_315_16 = LeanTween.value(arg_312_1.dialog_, 0, 1, 0.3)

				var_315_16:setOnUpdate(LuaHelper.FloatAction(function(arg_316_0)
					arg_312_1.dialogCg_.alpha = arg_316_0
				end))
				var_315_16:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_312_1.dialog_)
					var_315_16:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_315_17 = arg_312_1:FormatText(arg_312_1:GetWordFromCfg(321091074).content)

				arg_312_1.text_.text = var_315_17

				LuaForUtil.ClearLinePrefixSymbol(arg_312_1.text_)

				local var_315_19 = 57 <= 0 and var_315_15 or var_315_15 * (utf8.len(var_315_17) / 57)

				if (57 <= 0 and var_315_15 or var_315_15 * (utf8.len(var_315_17) / 57)) > 0 and var_315_15 < var_315_19 then
					arg_312_1.talkMaxDuration = var_315_19
					var_315_14 = var_315_14 + 0.3

					if var_315_19 + var_315_14 > arg_312_1.duration_ then
						arg_312_1.duration_ = var_315_19 + var_315_14
					end
				end
			...
			local var_315_20 = var_315_14 + 0.3
			local var_315_21 = math.max(var_315_15, arg_312_1.talkMaxDuration)

			if var_315_14 + 0.3 <= arg_312_1.time_ and arg_312_1.time_ < var_315_20 + var_315_21 then
				arg_312_1.typewritter.percent = (arg_312_1.time_ - var_315_20) / var_315_21
	...
	Play321091078 = function(arg_330_0, arg_330_1)
		...
		function arg_330_1.onSingleLineUpdate_(arg_333_0)
			...
			if 0 < arg_330_1.time_ and arg_330_1.time_ <= 0 + arg_333_0 then
				...
				for iter_333_0, iter_333_1 in ipairs((var_333_5.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_333_1.transform.localScale = Vector3.New(iter_333_1.transform.localScale.x / var_333_7 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_333_1.transform.localScale.y / var_333_7, iter_333_1.transform.localScale.z)
				end
			end

			if 0.133333333333333 < arg_330_1.time_ and arg_330_1.time_ <= 0.133333333333333 + arg_333_0 then
				local var_333_9 = arg_330_1.var_.effect115

				if not arg_330_1.var_.effect115 then
					var_333_9 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_ripple"), manager.ui.mainCamera.transform)
					var_333_9.name = "115"
					arg_330_1.var_.effect115 = var_333_9
				else
					var_333_9.transform:SetParent(var_333_9000)
				end

				var_333_9.transform.localPosition = Vector3.New(0.06, 0, -0.86)
				var_333_9.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_333_11 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_333_2, iter_333_3 in ipairs((var_333_9.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_333_3.transform.localScale = Vector3.New(iter_333_3.transform.localScale.x / var_333_11 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_333_3.transform.localScale.y / var_333_11, iter_333_3.transform.localScale.z)
				end
			end

			if 0.333333333333333 < arg_330_1.time_ and arg_330_1.time_ <= 0.333333333333333 + arg_333_0 then
				local var_333_13 = arg_330_1.var_.effect117

				if not arg_330_1.var_.effect117 then
					var_333_13 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_ripple"), manager.ui.mainCamera.transform)
					var_333_13.name = "117"
					arg_330_1.var_.effect117 = var_333_13
				else
					var_333_13.transform:SetParent(var_333_9001)
				end

				var_333_13.transform.localPosition = Vector3.New(1.21, 0, -0.86)
				var_333_13.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_333_15 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_333_4, iter_333_5 in ipairs((var_333_13.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_333_5.transform.localScale = Vector3.New(iter_333_5.transform.localScale.x / var_333_15 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_333_5.transform.localScale.y / var_333_15, iter_333_5.transform.localScale.z)
				end
			end

			local var_333_17 = 0

			if 0 < arg_330_1.time_ and arg_330_1.time_ <= var_333_17 + arg_333_0 then
				arg_330_1.allBtn_.enabled = false
			end

			if arg_330_1.time_ >= var_333_17 + 1.63333333333333 and arg_330_1.time_ < var_333_17 + 1.63333333333333 + arg_333_0 then
			...
			local var_333_19 = arg_330_1.actors_["10130ui_story"].transform

			if 0 < arg_330_1.time_ and arg_330_1.time_ <= 0 + arg_333_0 then
				arg_330_1.var_.moveOldPos10130ui_story = var_333_19.localPosition
			end

			local var_333_20 = 0.001

			if 0 <= arg_330_1.time_ and arg_330_1.time_ < 0 + var_333_20 then
				var_333_19.localPosition = Vector3.Lerp(arg_330_1.var_.moveOldPos10130ui_story, Vector3.New(0, 100, 0), (arg_330_1.time_ - 0) / var_333_20)
				var_333_19.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_333_19.position).x, (manager.ui.mainCamera.transform.position - var_333_19.position).y, (manager.ui.mainCamera.transform.position - var_333_19.position).z)
				var_333_19.localEulerAngles.z = 0
				var_333_19.localEulerAngles.x = 0
				var_333_19.localEulerAngles = var_333_19.localEulerAngles
			end

			if arg_330_1.time_ >= 0 + var_333_20 and arg_330_1.time_ < 0 + var_333_20 + arg_333_0 then
				var_333_19.localPosition = Vector3.New(0, 100, 0)
				var_333_19.forward = Vector3.New((manager.ui.mainCamera.transform.position - var_333_19.position).x, (manager.ui.mainCamera.transform.position - var_333_19.position).y, (manager.ui.mainCamera.transform.position - var_333_19.position).z)
				var_333_19.localEulerAngles.z = 0
				var_333_19.localEulerAngles.x = 0
				var_333_19.localEulerAngles = var_333_19.localEulerAngles
			...
			local var_333_21 = 1.06666666666667
			local var_333_22 = 1.225

			if 1.06666666666667 < arg_330_1.time_ and arg_330_1.time_ <= var_333_21 + arg_333_0 then
				...
				local var_333_23 = LeanTween.value(arg_330_1.dialog_, 0, 1, 0.3)

				var_333_23:setOnUpdate(LuaHelper.FloatAction(function(arg_334_0)
					arg_330_1.dialogCg_.alpha = arg_334_0
				end))
				var_333_23:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_330_1.dialog_)
					var_333_23:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_333_24 = arg_330_1:FormatText(arg_330_1:GetWordFromCfg(321091078).content)

				arg_330_1.text_.text = var_333_24

				LuaForUtil.ClearLinePrefixSymbol(arg_330_1.text_)

				local var_333_26 = 49 <= 0 and var_333_22 or var_333_22 * (utf8.len(var_333_24) / 49)

				if (49 <= 0 and var_333_22 or var_333_22 * (utf8.len(var_333_24) / 49)) > 0 and var_333_22 < var_333_26 then
					arg_330_1.talkMaxDuration = var_333_26
					var_333_21 = var_333_21 + 0.3

					if var_333_26 + var_333_21 > arg_330_1.duration_ then
						arg_330_1.duration_ = var_333_26 + var_333_21
					end
				end
			...
			local var_333_27 = var_333_21 + 0.3
			local var_333_28 = math.max(var_333_22, arg_330_1.talkMaxDuration)

			if var_333_21 + 0.3 <= arg_330_1.time_ and arg_330_1.time_ < var_333_27 + var_333_28 then
				arg_330_1.typewritter.percent = (arg_330_1.time_ - var_333_27) / var_333_28

				arg_330_1.typewritter:SetDirty()
			end

			if arg_330_1.time_ >= var_333_27 + var_333_28 and arg_330_1.time_ < var_333_27 + var_333_28 + arg_333_0 then
	...
	Play321091079 = function(arg_336_0, arg_336_1)
		...
		function arg_336_1.onSingleLineUpdate_(arg_339_0)
			...
			if 0.133333333333333 < arg_336_1.time_ and arg_336_1.time_ <= 0.133333333333333 + arg_339_0 then
				...
				for iter_339_0, iter_339_1 in ipairs((var_339_3.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_339_1.transform.localScale = Vector3.New(iter_339_1.transform.localScale.x / var_339_5 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_339_1.transform.localScale.y / var_339_5, iter_339_1.transform.localScale.z)
				end
			end
			...
			if arg_336_1.time_ >= var_339_7 + 0.433333333333333 and arg_336_1.time_ < var_339_7 + 0.433333333333333 + arg_339_0 then
			...
			local var_339_9 = 0.333333333333333
			local var_339_10 = 1.55

			if 0.333333333333333 < arg_336_1.time_ and arg_336_1.time_ <= var_339_9 + arg_339_0 then
				...
				local var_339_11 = LeanTween.value(arg_336_1.dialog_, 0, 1, 0.3)

				var_339_11:setOnUpdate(LuaHelper.FloatAction(function(arg_340_0)
					arg_336_1.dialogCg_.alpha = arg_340_0
				end))
				var_339_11:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_336_1.dialog_)
					var_339_11:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_339_12 = arg_336_1:FormatText(arg_336_1:GetWordFromCfg(321091079).content)

				arg_336_1.text_.text = var_339_12

				LuaForUtil.ClearLinePrefixSymbol(arg_336_1.text_)

				local var_339_14 = 62 <= 0 and var_339_10 or var_339_10 * (utf8.len(var_339_12) / 62)

				if (62 <= 0 and var_339_10 or var_339_10 * (utf8.len(var_339_12) / 62)) > 0 and var_339_10 < var_339_14 then
					arg_336_1.talkMaxDuration = var_339_14
					var_339_9 = var_339_9 + 0.3

					if var_339_14 + var_339_9 > arg_336_1.duration_ then
						arg_336_1.duration_ = var_339_14 + var_339_9
					end
				end
			...
			local var_339_15 = var_339_9 + 0.3
			local var_339_16 = math.max(var_339_10, arg_336_1.talkMaxDuration)

			if var_339_9 + 0.3 <= arg_336_1.time_ and arg_336_1.time_ < var_339_15 + var_339_16 then
				arg_336_1.typewritter.percent = (arg_336_1.time_ - var_339_15) / var_339_16

				arg_336_1.typewritter:SetDirty()
			end

			if arg_336_1.time_ >= var_339_15 + var_339_16 and arg_336_1.time_ < var_339_15 + var_339_16 + arg_339_0 then
