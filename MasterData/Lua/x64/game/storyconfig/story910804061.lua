return {
	Play910833001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if 2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_9 + arg_4_0 then
				...
				local var_4_12 = arg_1_1:FormatText(arg_1_1:GetWordFromCfg(910833001).content)
	...
	Play910833002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			if arg_7_1.actors_["1084"] == nil then
				local var_10_0 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1084")
			...
			if 0 <= arg_7_1.time_ and arg_7_1.time_ < 0 + var_10_4 then
				var_10_2.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos1084, Vector3.New(0, -350, -180), (arg_7_1.time_ - 0) / var_10_4)
			end
			...
			local var_10_5 = arg_7_1.actors_["1084"]

			if 0 < arg_7_1.time_ and arg_7_1.time_ <= 0 + arg_10_0 and not isNil(var_10_5) and arg_7_1.var_.actorSpriteComps1084 == nil then
				arg_7_1.var_.actorSpriteComps1084 = var_10_5:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_7_1.time_ >= 0 + var_10_6 and arg_7_1.time_ < 0 + var_10_6 + arg_10_0 and not isNil(var_10_5) and arg_7_1.var_.actorSpriteComps1084 then
			...
			if 0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 then
				...
				local var_10_10 = arg_7_1:FormatText(arg_7_1:GetWordFromCfg(910833002).content)

				arg_7_1.text_.text = var_10_10

				LuaForUtil.ClearLinePrefixSymbol(arg_7_1.text_)

				local var_10_12 = 32 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 32)

				if (32 <= 0 and var_10_9 or var_10_9 * (utf8.len(var_10_10) / 32)) > 0 and var_10_9 < var_10_12 then
	...
	Play910833003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if 0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_5 + arg_14_0 then
				...
				local var_14_7 = arg_11_1:FormatText(arg_11_1:GetWordFromCfg(910833003).content)

				arg_11_1.text_.text = var_14_7

				LuaForUtil.ClearLinePrefixSymbol(arg_11_1.text_)

				local var_14_9 = 17 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 17)

				if (17 <= 0 and var_14_6 or var_14_6 * (utf8.len(var_14_7) / 17)) > 0 and var_14_6 < var_14_9 then
	...
	Play910833004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if 0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_5 + arg_18_0 then
				...
				local var_18_7 = arg_15_1:FormatText(arg_15_1:GetWordFromCfg(910833004).content)
	...
	Play910833005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if 0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_5 + arg_22_0 then
				...
				local var_22_7 = arg_19_1:FormatText(arg_19_1:GetWordFromCfg(910833005).content)

				arg_19_1.text_.text = var_22_7

				LuaForUtil.ClearLinePrefixSymbol(arg_19_1.text_)

				local var_22_9 = 4 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 4)

				if (4 <= 0 and var_22_6 or var_22_6 * (utf8.len(var_22_7) / 4)) > 0 and var_22_6 < var_22_9 then
	...
	Play910833006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if 0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_5 + arg_26_0 then
				...
				local var_26_7 = arg_23_1:FormatText(arg_23_1:GetWordFromCfg(910833006).content)

				arg_23_1.text_.text = var_26_7

				LuaForUtil.ClearLinePrefixSymbol(arg_23_1.text_)

				local var_26_9 = 52 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 52)

				if (52 <= 0 and var_26_6 or var_26_6 * (utf8.len(var_26_7) / 52)) > 0 and var_26_6 < var_26_9 then
	...
	Play910833007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if 0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_5 + arg_30_0 then
				...
				local var_30_7 = arg_27_1:FormatText(arg_27_1:GetWordFromCfg(910833007).content)

				arg_27_1.text_.text = var_30_7

				LuaForUtil.ClearLinePrefixSymbol(arg_27_1.text_)

				local var_30_9 = 41 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 41)

				if (41 <= 0 and var_30_6 or var_30_6 * (utf8.len(var_30_7) / 41)) > 0 and var_30_6 < var_30_9 then
	...
	Play910833008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if 0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_7 = arg_31_1:FormatText(arg_31_1:GetWordFromCfg(910833008).content)

				arg_31_1.text_.text = var_34_7

				LuaForUtil.ClearLinePrefixSymbol(arg_31_1.text_)

				local var_34_9 = 24 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 24)

				if (24 <= 0 and var_34_6 or var_34_6 * (utf8.len(var_34_7) / 24)) > 0 and var_34_6 < var_34_9 then
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= 0 + arg_38_0 then
				...
				for iter_38_0 = 0, arg_35_1.actors_["1084"].transform.childCount - 1 do
					...
					if var_38_0.name == "split_1_1" or not string.find(var_38_0.name, "split") then
			...
			if 0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_5 + arg_38_0 then
				...
				local var_38_7 = arg_35_1:FormatText(arg_35_1:GetWordFromCfg(910833009).content)

				arg_35_1.text_.text = var_38_7

				LuaForUtil.ClearLinePrefixSymbol(arg_35_1.text_)

				local var_38_9 = 23 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 23)

				if (23 <= 0 and var_38_6 or var_38_6 * (utf8.len(var_38_7) / 23)) > 0 and var_38_6 < var_38_9 then
	...
	Play910833010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if 0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_5 + arg_42_0 then
				...
				local var_42_7 = arg_39_1:FormatText(arg_39_1:GetWordFromCfg(910833010).content)

				arg_39_1.text_.text = var_42_7

				LuaForUtil.ClearLinePrefixSymbol(arg_39_1.text_)

				local var_42_9 = 16 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 16)

				if (16 <= 0 and var_42_6 or var_42_6 * (utf8.len(var_42_7) / 16)) > 0 and var_42_6 < var_42_9 then
	...
	Play910833011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if 0 < arg_43_1.time_ and arg_43_1.time_ <= var_46_5 + arg_46_0 then
				...
				local var_46_7 = arg_43_1:FormatText(arg_43_1:GetWordFromCfg(910833011).content)

				arg_43_1.text_.text = var_46_7

				LuaForUtil.ClearLinePrefixSymbol(arg_43_1.text_)

				local var_46_9 = 26 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 26)

				if (26 <= 0 and var_46_6 or var_46_6 * (utf8.len(var_46_7) / 26)) > 0 and var_46_6 < var_46_9 then
	...
	Play910833012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if 0 < arg_47_1.time_ and arg_47_1.time_ <= var_50_5 + arg_50_0 then
				...
				local var_50_7 = arg_47_1:FormatText(arg_47_1:GetWordFromCfg(910833012).content)

				arg_47_1.text_.text = var_50_7

				LuaForUtil.ClearLinePrefixSymbol(arg_47_1.text_)

				local var_50_9 = 47 <= 0 and var_50_6 or var_50_6 * (utf8.len(var_50_7) / 47)

				if (47 <= 0 and var_50_6 or var_50_6 * (utf8.len(var_50_7) / 47)) > 0 and var_50_6 < var_50_9 then
	...
	Play910833013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if 0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_5 + arg_54_0 then
				...
				local var_54_7 = arg_51_1:FormatText(arg_51_1:GetWordFromCfg(910833013).content)
	...
	Play910833014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if 0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_5 + arg_58_0 then
				...
				local var_58_7 = arg_55_1:FormatText(arg_55_1:GetWordFromCfg(910833014).content)

				arg_55_1.text_.text = var_58_7

				LuaForUtil.ClearLinePrefixSymbol(arg_55_1.text_)

				local var_58_9 = 18 <= 0 and var_58_6 or var_58_6 * (utf8.len(var_58_7) / 18)

				if (18 <= 0 and var_58_6 or var_58_6 * (utf8.len(var_58_7) / 18)) > 0 and var_58_6 < var_58_9 then
	...
	Play910833015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if 0 < arg_59_1.time_ and arg_59_1.time_ <= var_62_5 + arg_62_0 then
				...
				local var_62_7 = arg_59_1:FormatText(arg_59_1:GetWordFromCfg(910833015).content)

				arg_59_1.text_.text = var_62_7

				LuaForUtil.ClearLinePrefixSymbol(arg_59_1.text_)

				local var_62_9 = 22 <= 0 and var_62_6 or var_62_6 * (utf8.len(var_62_7) / 22)

				if (22 <= 0 and var_62_6 or var_62_6 * (utf8.len(var_62_7) / 22)) > 0 and var_62_6 < var_62_9 then
	...
	Play910833016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if 0 < arg_63_1.time_ and arg_63_1.time_ <= var_66_5 + arg_66_0 then
				...
				local var_66_7 = arg_63_1:FormatText(arg_63_1:GetWordFromCfg(910833016).content)

				arg_63_1.text_.text = var_66_7

				LuaForUtil.ClearLinePrefixSymbol(arg_63_1.text_)

				local var_66_9 = 30 <= 0 and var_66_6 or var_66_6 * (utf8.len(var_66_7) / 30)

				if (30 <= 0 and var_66_6 or var_66_6 * (utf8.len(var_66_7) / 30)) > 0 and var_66_6 < var_66_9 then
	...
	Play910833017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if 0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_5 + arg_70_0 then
				...
				local var_70_7 = arg_67_1:FormatText(arg_67_1:GetWordFromCfg(910833017).content)

				arg_67_1.text_.text = var_70_7

				LuaForUtil.ClearLinePrefixSymbol(arg_67_1.text_)

				local var_70_9 = 5 <= 0 and var_70_6 or var_70_6 * (utf8.len(var_70_7) / 5)

				if (5 <= 0 and var_70_6 or var_70_6 * (utf8.len(var_70_7) / 5)) > 0 and var_70_6 < var_70_9 then
	...
	Play910833018 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if 0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_5 + arg_74_0 then
				...
				local var_74_7 = arg_71_1:FormatText(arg_71_1:GetWordFromCfg(910833018).content)

				arg_71_1.text_.text = var_74_7

				LuaForUtil.ClearLinePrefixSymbol(arg_71_1.text_)

				local var_74_9 = 34 <= 0 and var_74_6 or var_74_6 * (utf8.len(var_74_7) / 34)

				if (34 <= 0 and var_74_6 or var_74_6 * (utf8.len(var_74_7) / 34)) > 0 and var_74_6 < var_74_9 then
	...
	Play910833019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			if 0 < arg_75_1.time_ and arg_75_1.time_ <= 0 + arg_78_0 and not isNil(arg_75_1.actors_["1084"]) and arg_75_1.var_.actorSpriteComps1084 == nil then
				arg_75_1.var_.actorSpriteComps1084 = arg_75_1.actors_["1084"]:GetComponentsInChildren(typeof(Image), true)
			end

			local var_78_0 = 0.034

			if 0 <= arg_75_1.time_ and arg_75_1.time_ < 0 + var_78_0 and not isNil(arg_75_1.actors_["1084"]) then
			...
			if arg_75_1.time_ >= 0 + var_78_0 and arg_75_1.time_ < 0 + var_78_0 + arg_78_0 and not isNil(arg_75_1.actors_["1084"]) and arg_75_1.var_.actorSpriteComps1084 then
			...
			local var_78_2 = arg_75_1.actors_["1084"].transform

			if 0 < arg_75_1.time_ and arg_75_1.time_ <= 0 + arg_78_0 then
				arg_75_1.var_.moveOldPos1084 = var_78_2.localPosition
			...
			if 0 <= arg_75_1.time_ and arg_75_1.time_ < 0 + var_78_4 then
				var_78_2.localPosition = Vector3.Lerp(arg_75_1.var_.moveOldPos1084, Vector3.New(0, -350, -180), (arg_75_1.time_ - 0) / var_78_4)
			end
			...
			if 0 < arg_75_1.time_ and arg_75_1.time_ <= var_78_6 + arg_78_0 then
				...
				local var_78_8 = arg_75_1:FormatText(arg_75_1:GetWordFromCfg(910833019).content)

				arg_75_1.text_.text = var_78_8

				LuaForUtil.ClearLinePrefixSymbol(arg_75_1.text_)

				local var_78_10 = 8 <= 0 and var_78_7 or var_78_7 * (utf8.len(var_78_8) / 8)

				if (8 <= 0 and var_78_7 or var_78_7 * (utf8.len(var_78_8) / 8)) > 0 and var_78_7 < var_78_10 then
