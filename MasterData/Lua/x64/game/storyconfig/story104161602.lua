	...
	Play416162018 = function(arg_73_0, arg_73_1)
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				...
				for iter_76_7, iter_76_8 in ipairs((var_76_19.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_76_8.transform.localScale = Vector3.New(iter_76_8.transform.localScale.x / var_76_21 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_76_8.transform.localScale.y / var_76_21, iter_76_8.transform.localScale.z)
				end
			end
			...
			local var_76_24 = arg_73_1.bgs_.SS1607.transform

			if 1.05 < arg_73_1.time_ and arg_73_1.time_ <= 1.05 + arg_76_0 then
				arg_73_1.var_.moveOldPosSS1607 = var_76_24.localPosition
			end

			local var_76_25 = 0.001

			if 1.05 <= arg_73_1.time_ and arg_73_1.time_ < 1.05 + var_76_25 then
				var_76_24.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPosSS1607, Vector3.New(0, 1, 8.4), (arg_73_1.time_ - 1.05) / var_76_25)
			end

			if arg_73_1.time_ >= 1.05 + var_76_25 and arg_73_1.time_ < 1.05 + var_76_25 + arg_76_0 then
				var_76_24.localPosition = Vector3.New(0, 1, 8.4)
			end

			local var_76_26 = arg_73_1.bgs_.SS1607.transform

			if 1.06666666666667 < arg_73_1.time_ and arg_73_1.time_ <= 1.06666666666667 + arg_76_0 then
				arg_73_1.var_.moveOldPosSS1607 = var_76_26.localPosition
			end

			local var_76_27 = 2.8

			if 1.06666666666667 <= arg_73_1.time_ and arg_73_1.time_ < 1.06666666666667 + var_76_27 then
				var_76_26.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPosSS1607, Vector3.New(0, 1, 6.8), (arg_73_1.time_ - 1.06666666666667) / var_76_27)
			end

			if arg_73_1.time_ >= 1.06666666666667 + var_76_27 and arg_73_1.time_ < 1.06666666666667 + var_76_27 + arg_76_0 then
				var_76_26.localPosition = Vector3.New(0, 1, 6.8)
			end

			if 1.06666666666667 < arg_73_1.time_ and arg_73_1.time_ <= 1.06666666666667 + arg_76_0 then
				local var_76_28 = arg_73_1.var_.effect112

				if not arg_73_1.var_.effect112 then
					var_76_28 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_mist_in"), manager.ui.mainCamera.transform)
					var_76_28.name = "112"
					arg_73_1.var_.effect112 = var_76_28
				else
					var_76_28.transform:SetParent(var_76_9000)
				end

				var_76_28.transform.localPosition = Vector3.New(0, 0, 0)
				var_76_28.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_76_30 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad)

				for iter_76_9, iter_76_10 in ipairs((var_76_28.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_76_10.transform.localScale = Vector3.New(iter_76_10.transform.localScale.x / var_76_30 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_76_10.transform.localScale.y / var_76_30, iter_76_10.transform.localScale.z)
				end
			end
			...
			if 0 < arg_73_1.time_ and arg_73_1.time_ <= 0 + arg_76_0 then
				...
				local var_76_34 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if "" ~= "" then
					if arg_73_1.bgmTxt_.text ~= var_76_34 and arg_73_1.bgmTxt_.text ~= "" then
						if arg_73_1.bgmTxt2_.text ~= "" then
							arg_73_1.bgmTxt_.text = arg_73_1.bgmTxt2_.text
						end

						arg_73_1.bgmTxt2_.text = var_76_34

						arg_73_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_73_1.bgmTxt_.text = var_76_34
						arg_73_1.bgmTxt2_.text = var_76_34
					end
			...
			if 1.05 < arg_73_1.time_ and arg_73_1.time_ <= 1.05 + arg_76_0 then
				...
				local var_76_37 = manager.audio:GetAudioName("bgm_activity_3_8_story_tide_battle", "bgm_activity_3_8_story_tide_battle")

				if "" ~= "" then
					if arg_73_1.bgmTxt_.text ~= var_76_37 and arg_73_1.bgmTxt_.text ~= "" then
						if arg_73_1.bgmTxt2_.text ~= "" then
							arg_73_1.bgmTxt_.text = arg_73_1.bgmTxt2_.text
						end

						arg_73_1.bgmTxt2_.text = var_76_37

						arg_73_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_73_1.bgmTxt_.text = var_76_37
						arg_73_1.bgmTxt2_.text = var_76_37
					end
			...
			local var_76_39 = 3.6
			local var_76_40 = 0.633333333333333

			if 3.6 < arg_73_1.time_ and arg_73_1.time_ <= var_76_39 + arg_76_0 then
				...
				var_76_41:setOnUpdate(LuaHelper.FloatAction(function(arg_79_0)
				...
				local var_76_42 = arg_73_1:FormatText(arg_73_1:GetWordFromCfg(416162018).content)

				arg_73_1.text_.text = var_76_42

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_44 = 55 <= 0 and var_76_40 or var_76_40 * (utf8.len(var_76_42) / 55)

				if (55 <= 0 and var_76_40 or var_76_40 * (utf8.len(var_76_42) / 55)) > 0 and var_76_40 < var_76_44 then
					arg_73_1.talkMaxDuration = var_76_44
					var_76_39 = var_76_39 + 0.3

					if var_76_44 + var_76_39 > arg_73_1.duration_ then
						arg_73_1.duration_ = var_76_44 + var_76_39
					end
				end
			...
			local var_76_45 = var_76_39 + 0.3
			local var_76_46 = math.max(var_76_40, arg_73_1.talkMaxDuration)

			if var_76_39 + 0.3 <= arg_73_1.time_ and arg_73_1.time_ < var_76_45 + var_76_46 then
