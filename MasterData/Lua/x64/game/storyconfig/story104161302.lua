	...
	Play416132048 = function(arg_201_0, arg_201_1)
		...
		function arg_201_1.onSingleLineUpdate_(arg_204_0)
			if 0 < arg_201_1.time_ and arg_201_1.time_ <= 0 + arg_204_0 then
				...
				for iter_204_0, iter_204_1 in ipairs((var_204_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_204_1.transform.localScale = Vector3.New(iter_204_1.transform.localScale.x / var_204_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_204_1.transform.localScale.y / var_204_2, iter_204_1.transform.localScale.z)
				end
			end
			...
			if 1 < arg_201_1.time_ and arg_201_1.time_ <= var_204_5 + arg_204_0 then
				...
				local var_204_7 = LeanTween.value(arg_201_1.dialog_, 0, 1, 0.3)

				var_204_7:setOnUpdate(LuaHelper.FloatAction(function(arg_205_0)
					arg_201_1.dialogCg_.alpha = arg_205_0
				end))
				var_204_7:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_201_1.dialog_)
					var_204_7:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_204_8 = arg_201_1:FormatText(arg_201_1:GetWordFromCfg(416132048).content)

				arg_201_1.text_.text = var_204_8

				LuaForUtil.ClearLinePrefixSymbol(arg_201_1.text_)

				local var_204_10 = 80 <= 0 and var_204_6 or var_204_6 * (utf8.len(var_204_8) / 80)

				if (80 <= 0 and var_204_6 or var_204_6 * (utf8.len(var_204_8) / 80)) > 0 and var_204_6 < var_204_10 then
					arg_201_1.talkMaxDuration = var_204_10
					var_204_5 = var_204_5 + 0.3
			...
			local var_204_11 = var_204_5 + 0.3
			local var_204_12 = math.max(var_204_6, arg_201_1.talkMaxDuration)

			if var_204_5 + 0.3 <= arg_201_1.time_ and arg_201_1.time_ < var_204_11 + var_204_12 then
				arg_201_1.typewritter.percent = (arg_201_1.time_ - var_204_11) / var_204_12
	...
	Play416132055 = function(arg_233_0, arg_233_1)
		...
		function arg_233_1.onSingleLineUpdate_(arg_236_0)
			if 0.133333333333333 < arg_233_1.time_ and arg_233_1.time_ <= 0.133333333333333 + arg_236_0 then
				...
				for iter_236_0, iter_236_1 in ipairs((var_236_0.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_236_1.transform.localScale = Vector3.New(iter_236_1.transform.localScale.x / var_236_2 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_236_1.transform.localScale.y / var_236_2, iter_236_1.transform.localScale.z)
				end
			end
			...
			local var_236_5 = manager.ui.mainCamera.transform

			if 0 < arg_233_1.time_ and arg_233_1.time_ <= 0 + arg_236_0 then
				arg_233_1.var_.shakeOldPos = var_236_5.localPosition
			end

			local var_236_6 = 0.466666666666667

			if 0 <= arg_233_1.time_ and arg_233_1.time_ < 0 + var_236_6 then
				local var_236_7, var_236_8 = math.modf((arg_233_1.time_ - 0) / 0.066)

				var_236_5.localPosition = Vector3.New(var_236_8 * 0.13, var_236_8 * 0.13, var_236_8 * 0.13) + arg_233_1.var_.shakeOldPos
			end

			if arg_233_1.time_ >= 0 + var_236_6 and arg_233_1.time_ < 0 + var_236_6 + arg_236_0 then
				var_236_5.localPosition = arg_233_1.var_.shakeOldPos
			end
			...
			if 0.6 < arg_233_1.time_ and arg_233_1.time_ <= var_236_10 + arg_236_0 then
				...
				local var_236_13 = arg_233_1:FormatText(arg_233_1:GetWordFromCfg(416132055).content)

				arg_233_1.text_.text = var_236_13

				LuaForUtil.ClearLinePrefixSymbol(arg_233_1.text_)

				local var_236_15 = 35 <= 0 and var_236_11 or var_236_11 * (utf8.len(var_236_13) / 35)

				if (35 <= 0 and var_236_11 or var_236_11 * (utf8.len(var_236_13) / 35)) > 0 and var_236_11 < var_236_15 then
