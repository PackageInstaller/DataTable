	...
	Play322281047 = function(arg_194_0, arg_194_1)
		...
		function arg_194_1.onSingleLineUpdate_(arg_197_0)
			...
			if 0.366666666666667 < arg_194_1.time_ and arg_194_1.time_ <= 0.366666666666667 + arg_197_0 then
				...
				for iter_197_0, iter_197_1 in ipairs((var_197_1.transform:GetComponentsInChildren(typeof(Transform), true):ToTable())) do
					iter_197_1.transform.localScale = Vector3.New(iter_197_1.transform.localScale.x / var_197_3 * ((1.7777777777777777 < manager.ui.mainCameraCom_.aspect or nil) and 2 * 15 * Mathf.Tan(manager.ui.mainCameraCom_.fieldOfView * 0.5 * Mathf.Deg2Rad) * manager.ui.mainCameraCom_.aspect / (2 * 15 * Mathf.Tan(15 * Mathf.Deg2Rad) * 1.7777777777777777)), iter_197_1.transform.localScale.y / var_197_3, iter_197_1.transform.localScale.z)
				end
			end

			local var_197_5 = arg_194_1.bgs_.L01f.transform

			if 0.366666666666667 < arg_194_1.time_ and arg_194_1.time_ <= 0.366666666666667 + arg_197_0 then
				arg_194_1.var_.moveOldPosL01f = var_197_5.localPosition
			end

			local var_197_6 = 0.833333333333333

			if 0.366666666666667 <= arg_194_1.time_ and arg_194_1.time_ < 0.366666666666667 + var_197_6 then
				var_197_5.localPosition = Vector3.Lerp(arg_194_1.var_.moveOldPosL01f, Vector3.New(0, 1, 8), (arg_194_1.time_ - 0.366666666666667) / var_197_6)
			end

			if arg_194_1.time_ >= 0.366666666666667 + var_197_6 and arg_194_1.time_ < 0.366666666666667 + var_197_6 + arg_197_0 then
				var_197_5.localPosition = Vector3.New(0, 1, 8)
			end

			local var_197_7 = 0

			if 0 < arg_194_1.time_ and arg_194_1.time_ <= var_197_7 + arg_197_0 then
				arg_194_1.allBtn_.enabled = false
			end

			if arg_194_1.time_ >= var_197_7 + 2.13333333333333 and arg_194_1.time_ < var_197_7 + 2.13333333333333 + arg_197_0 then
			...
			if 1 < arg_194_1.time_ and arg_194_1.time_ <= var_197_8 + arg_197_0 then
				...
				local var_197_10 = LeanTween.value(arg_194_1.dialog_, 0, 1, 0.3)

				var_197_10:setOnUpdate(LuaHelper.FloatAction(function(arg_198_0)
					arg_194_1.dialogCg_.alpha = arg_198_0
				end))
				var_197_10:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_194_1.dialog_)
					var_197_10:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_197_11 = arg_194_1:FormatText(arg_194_1:GetWordFromCfg(322281047).content)

				arg_194_1.text_.text = var_197_11

				LuaForUtil.ClearLinePrefixSymbol(arg_194_1.text_)

				local var_197_13 = 56 <= 0 and var_197_9 or var_197_9 * (utf8.len(var_197_11) / 56)

				if (56 <= 0 and var_197_9 or var_197_9 * (utf8.len(var_197_11) / 56)) > 0 and var_197_9 < var_197_13 then
					arg_194_1.talkMaxDuration = var_197_13
					var_197_8 = var_197_8 + 0.3
			...
			local var_197_14 = var_197_8 + 0.3
			local var_197_15 = math.max(var_197_9, arg_194_1.talkMaxDuration)

			if var_197_8 + 0.3 <= arg_194_1.time_ and arg_194_1.time_ < var_197_14 + var_197_15 then
				arg_194_1.typewritter.percent = (arg_194_1.time_ - var_197_14) / var_197_15
