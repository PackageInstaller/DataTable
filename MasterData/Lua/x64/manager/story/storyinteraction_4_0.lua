...
function StoryAction_4_0:InitUI()
	...
	local var_3_1 = var_3_0.transform:Find("StoryAction_4_0/photomask/photo"):GetComponent(typeof(Image))

	var_3_0.transform:Find("StoryAction_4_0/photomask/Image"):GetComponent(typeof(CanvasGroup)).alpha = 1
	...
	self.tweenList = {}
	var_3_1.sprite = pureGetSpriteWithoutAtlas(self.param.path)
