...
function WindowBarMgr:OnClickCurrencyBar()
	...
	if var_47_0 < var_47_2 then
		...
		local var_47_4 = CurrencyData:GetLastFatigueRecoverTime() == 0 and var_47_3 or var_47_3 - (manager.time:GetServerTime() - CurrencyData:GetLastFatigueRecoverTime()) % var_47_3
