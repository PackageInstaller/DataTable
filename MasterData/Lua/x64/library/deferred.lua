...
function var_0_0:new()
	if var_0_7(self) then
		local var_20_0 = var_0_0.new()

		var_0_0.async = nil

		local var_20_1, var_20_2 = pcall(self, var_20_0)

		if not var_20_1 then
			var_20_0:reject(var_20_2)
		end

		var_0_0.async = var_0_0.async
	...
	var_20_3 = {
		...
		next = function(arg_21_0, arg_21_1, arg_21_2)
			...
			if var_20_3.state == var_0_5 then
				var_21_0:resolve(var_20_3.value)
			elseif var_20_3.state == var_0_6 then
				var_21_0:reject(var_20_3.value)
			else
				table.insert(var_20_3.queue, var_21_0)
			end
	...
	var_20_3 = setmetatable(nil, var_0_1)

	if var_0_7(self.extend) then
		self.extend(var_20_3)
	end

	return var_20_3
end

function var_0_0:all()
	...
	for iter_22_0 = 1, #self do
		self[iter_22_0]:next(var_22_4(iter_22_0, true), var_22_4(iter_22_0, false))
	end
