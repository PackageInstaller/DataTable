...
return {
	...
	index = function(self, arg_7_1)
		return self[arg_7_1]
	end,
	pointAtCircle = function(self, arg_8_1, arg_8_2)
		local var_8_0 = Vector3.Normalize((Vector3.New(self.x - arg_8_1.x, self.y - arg_8_1.y, self.z - arg_8_1.z)))
