...
function var_0_0.funcs.flatten(arg_33_0)
	...
	for iter_33_0 in var_0_0.iter(arg_33_0) do
		if type(iter_33_0) == "table" then
			var_0_0.funcs.each(var_0_0.funcs.flatten(iter_33_0), function(arg_34_0)
...
function var_0_0.funcs:is_equal(arg_44_1, arg_44_2)
	local var_44_0 = type(self)
	...
	if var_44_0 ~= "table" then
		return self == arg_44_1
	end

	local var_44_1 = getmetatable(self)
	...
	for iter_44_0, iter_44_1 in pairs(self) do
		if arg_44_1[iter_44_0] == nil or not var_0_0.funcs.is_equal(iter_44_1, arg_44_1[iter_44_0], arg_44_2) then
			return false
		end
	end

	for iter_44_2, iter_44_3 in pairs(arg_44_1) do
		if self[iter_44_2] == nil then
			return false
		end
	end
