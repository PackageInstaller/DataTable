local actionTypes = require("library/redux/utils/actionTypes")
local isPlainTable = require("library/redux/utils/isPlainTable")

local function var_0_2(arg_1_0, arg_1_1)
	return string.format("    Given %s, reducer \"%s\" returned nil.\n    To ignore an action, you must explicitly return the previous state.", arg_1_1 and arg_1_1.type and string.format("action \"%s\"", tostring(arg_1_1 and arg_1_1.type)) or "an action", arg_1_0)
end
...
local function var_0_3(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local var_2_1 = arg_2_2 and arg_2_2.type == actionTypes.INIT and "preloadedState argument passed to createStore" or "previous state received by the reducer"

	if #var_2_0 == 0 then
		return "        Store does not have a valid reducer. Make sure the argument passed\n        to combineReducers is an object whose values are reducers."
	end

	if not isPlainTable(arg_2_0) then
	...
	if arg_2_2 and arg_2_2.type == actionTypes.REPLACE then
		return
	end
...
return function(arg_4_0)
	...
	return function(arg_5_0, arg_5_1)
		...
		for iter_5_0, iter_5_1 in pairs(var_4_0) do
			local var_5_3 = iter_5_1(arg_5_0[iter_5_0], arg_5_1)

			if var_5_3 == nil then
				error((var_0_2(iter_5_0, arg_5_1)))
			end

			var_5_2[iter_5_0] = var_5_3
			var_5_1 = var_5_1 or var_5_3 ~= arg_5_0[iter_5_0]
		end
