...
local function var_0_2(arg_1_0, arg_1_1, arg_1_2)
	...
	local function var_1_6(arg_6_0)
		if not isPlainTable(arg_6_0) then
		...
		for iter_6_0, iter_6_1 in ipairs(var_1_2) do
	...
	return {
		...
		replaceReducer = function(arg_8_0)
