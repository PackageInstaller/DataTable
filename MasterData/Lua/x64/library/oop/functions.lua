...
function dump_stack(arg_2_0)
	return string.format("%s%s%s", string.format("<a href=\"%s\" line=\"%d\">", var_0_1(arg_2_0.short_src), arg_2_0.currentline), string.format("[%s:%s:%d]", arg_2_0.short_src, arg_2_0.name or "?", arg_2_0.currentline), "</a>")
end
...
function nullable(arg_4_0, ...)
	...
	for iter_4_0 = 1, select("#", ...) do
		if arg_4_0 == nil or var_4_0[iter_4_0] == nil then
			return nil
		end

		arg_4_0 = arg_4_0[var_4_0[iter_4_0]]
	end
...
if nullable(debugger, "enabled") then
	...
	function print(arg_6_0, ...)
		...
		Debug.Log(var_0_2(dump_msg(debug.getinfo(2), var_6_1), 2, var_0_3))
	end

	function printf(arg_7_0, ...)
		Debug.Log(var_0_2(dump_msg(debug.getinfo(2), string.format(arg_7_0, ...)), 2, var_0_3))
	end
else
...
function table:indexof(arg_17_1, arg_17_2)
	for iter_17_0 = arg_17_2 or 1, #self do
		if self[iter_17_0] == arg_17_1 then
			return iter_17_0
		end
	end
...
function table:removebyvalue(arg_19_1, arg_19_2)
	local var_19_0 = 0
	local var_19_1 = 1

	while var_19_1 <= #self do
		if self[var_19_1] == arg_19_1 then
			table.remove(self, var_19_1)
...
function table:deepMerge(arg_25_1)
	if type(arg_25_1) == "table" then
		for iter_25_0, iter_25_1 in pairs(arg_25_1) do
			if self[iter_25_0] then
				table.deepMerge(self[iter_25_0], iter_25_1)
			else
...
function handler2layerArg1(arg_44_0, arg_44_1, arg_44_2)
	return function(arg_45_0, ...)
		...
		local var_45_1 = arg_44_1(arg_44_0, (table.remove(var_45_0, 1)))

		if var_45_1 then
			return var_45_1[arg_44_2](var_45_1, unpack(var_45_0))
		end
	end
end
	...
	local function var_47_1(arg_48_0, arg_48_1, arg_48_2)
		...
		for iter_48_0, iter_48_1 in var_0_10(arg_48_0) do
			...
			elseif var_0_9(iter_48_1) == "table" then
				var_47_0[iter_48_1] = arg_48_2 .. "." .. var_48_1

				var_0_7(var_48_0, "+" .. var_48_1 .. var_47_1(iter_48_1, arg_48_1 .. (var_0_12(arg_48_0, iter_48_0) and "|" or " ") .. var_0_8(" ", #var_48_1), arg_48_2 .. "." .. var_48_1))
			else
	...
	local function var_54_0(arg_55_0)
		...
		for iter_55_0, iter_55_1 in var_0_10(arg_55_0) do
			if var_0_9(iter_55_1) == "table" then
				...
				var_55_0 = var_0_9(iter_55_1) == "string" and var_55_0 .. "\"" .. var_0_11(iter_55_1) .. "\"," or var_55_0 .. var_0_11(iter_55_1) .. ","
			end
		end

		if string.sub(var_55_0, -1, -1) == "," then
			var_55_0 = string.sub(var_55_0, 1, -2)
		end
	...
	local function var_56_1(arg_57_0)
		...
		for iter_57_0, iter_57_1 in var_0_10(arg_57_0) do
			if var_0_9(iter_57_1) == "table" then
				...
				var_57_0 = var_0_9(iter_57_1) == "string" and var_57_0 .. "\"" .. var_0_11(iter_57_1) .. "\"," or var_57_0 .. var_0_11(iter_57_1) .. ","
			end
		end
...
local function var_0_13(arg_58_0, arg_58_1)
	...
	if arg_58_0[arg_58_1] then
		return arg_58_1, arg_58_0[arg_58_1]
	end
end
