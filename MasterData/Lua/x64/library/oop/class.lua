...
function partialClass(arg_8_0, arg_8_1, arg_8_2)
	...
	if not arg_8_2 then
		...
		var_8_0 = _G[arg_8_0] or class(arg_8_0, arg_8_1)
	end
...
function tracebackex()
	local var_14_0 = 2
	local var_14_1 = "" .. "stack traceback:\n"

	while true do
		local var_14_2 = debug.getinfo(var_14_0, "Sln")

		if not var_14_2 then
			break
		end

		var_14_1 = var_14_2.what == "C" and var_14_1 .. tostring(var_14_0) .. "\tC function\n" or var_14_1 .. string.format("\t[%s]:%d in function `%s`\n", var_14_2.short_src, var_14_2.currentline, (not var_14_2.name or nil) and "")
		var_14_0 = var_14_0 + 1
	end
