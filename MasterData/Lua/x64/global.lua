...
function randomMN(arg_8_0, arg_8_1)
	...
	var_8_1 = type(arg_8_0) == "table" and arg_8_0 or type(arg_8_0) == "number" and seq(arg_8_0) or var_8_1
...
function parsedData(arg_9_0)
	...
	for iter_9_0, iter_9_1 in pairs((string.split(arg_9_0, ";"))) do
		table.insert(var_9_0, string.split(iter_9_1, ","))
	end
