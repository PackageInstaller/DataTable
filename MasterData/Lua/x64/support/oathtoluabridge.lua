...
function var_0_0:SetCaptureSwitch(arg_4_1)
	var_0_4[WeddingCaptureSwitchCfg[arg_4_1].switchType] = arg_4_1

	OathLuaBridge.ChangeCapturePose(WeddingCaptureSwitchCfg[arg_4_1].switchType, WeddingCaptureSwitchCfg[arg_4_1].switchName)

	if WeddingCaptureSwitchCfg[arg_4_1].switchType == OathConst.OATH_CAPTURE_FILTER_TYPE.Action then
		self:SetCaptureSwitch((OathTools.GetDefalutSetting(WeddingCaptureSwitchCfg[arg_4_1].character, OathConst.OATH_CAPTURE_FILTER_TYPE.Face)))
	end
...
function var_0_0.OathCheckIsMeetOath(arg_20_0)
	...
	for iter_20_0, iter_20_1 in ipairs(WeddingCfg[arg_20_0].condition) do
...
function var_0_0.OathRecordSDK(arg_22_0, arg_22_1, arg_22_2)
	...
	var_22_0 = arg_22_1 and string.format("[%s]", var_22_0) or {}

	local var_22_1 = "activity_sys_act"
	local var_22_2 = {
		sys_id = ViewConst.SYSTEM_ID.OATH_SYSTEM,
		hero_id = OathToLuaBridge:GetOathHeroID(),
	...
	var_22_2.use_seconds = arg_22_2 and math.floor(arg_22_2 + 0.5) or 0

	SDKTools.SendMessageToSDK(var_22_1, var_22_2)
end
