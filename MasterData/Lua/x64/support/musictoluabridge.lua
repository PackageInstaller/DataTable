...
function var_0_0.SetUpMusic()
	...
	if var_1_1 < 4 then
		...
		var_1_3 = MusicData:GetTrackPathType() == MusicConst.MusicTrackType.Vertical
	end

	if MusicData:GetTrackPathType() == MusicConst.MusicTrackType.Constant_Slope then
	...
	local var_1_4 = GameObject.Find("movie")

	if var_1_4 then
		var_1_4:GetComponent("SpriteRenderer").sprite = pureGetSpriteWithoutAtlas("TextureConfig/Music/Music_bg/" .. ActivityMusicCfg[var_1_0].icon)
	end
end
