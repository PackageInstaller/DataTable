...
function IsConditionAchieved(arg_25_0, arg_25_1)
	...
	elseif var_25_0.type == 1011 or var_25_0.type == 5002 then
		local var_25_7 = BattleStageData:GetStageData()[var_25_0.params[1]]

		var_25_2 = var_25_7 and var_25_7.clear_times > 0 and 1 or 0
		var_25_3 = 1
		var_25_1 = 1 <= var_25_2
	elseif var_25_0.type == 1012 then
		local var_25_8 = ArchiveData:GetArchive((HeroTools.GetHeroOntologyID(arg_25_1.heroId))).lv

		var_25_1 = var_25_3 <= var_25_8
		var_25_2 = var_25_8
	elseif var_25_0.type == 1013 then
		local var_25_9 = HeroTools.GetHeroOntologyID(arg_25_1.heroId)

		var_25_2 = ArchiveData:GetArchive(var_25_9).gift_list[HeroRecordCfg[var_25_9].gift_like_id1[1]] or 0
	...
	elseif var_25_0.type == 1015 then
		local var_25_10 = HeroData:GetHeroData(var_25_0.params[1])

		var_25_2 = var_25_10 and var_25_10.level or 0
		var_25_3 = var_25_0.params[2]
		var_25_1 = var_25_0.params[2] <= var_25_2
	elseif var_25_0.type == 1016 then
		local var_25_11 = ArchiveData:GetArchive((HeroTools.GetHeroOntologyID(arg_25_1.heroId))).lv
	...
	elseif var_25_0.type == 1019 then
		local var_25_12 = ArchiveData:GetTrustLevel(arg_25_1.heroId)
	...
	elseif var_25_0.type == 5001 then
		local var_25_14 = HeroTools.GetHeroOntologyID(var_25_0.params[1])

		for iter_25_2, iter_25_3 in ipairs(HeroRecordCfg[var_25_14].plot_id) do
			if not ArchiveData:IsStoryRead(var_25_14, iter_25_3) then
				return false
			end
		end
	...
	elseif var_25_0.type == 8023 then
		local var_25_15 = DormData:GetHeroTemplateInfo(arg_25_1.heroId)

		var_25_2 = var_25_15 and (var_25_15:GetHeroTotalFeedTime() or 0) or 0
		var_25_1 = var_25_3 <= var_25_2
	...
	elseif var_25_0.type == 11502 then
		...
		return var_25_17, var_25_2, 1
	elseif var_25_0.type == 11802 then
		local var_25_18 = QWorldQuestData:GetMainQuestData(var_25_0.params[1])

		if var_25_18 and var_25_18.status == QWorldQuestConst.MAIN_QUEST_STATUS.FINISH then
			return true, 1, 1
		else
			return false, 0, 1
		end
	...
	elseif var_25_0.type == 11902 then
		local var_25_19 = TetrisGameData:GetStageInfoByStageID(var_25_0.params[2][1][1])

		if var_25_19 and var_25_19.isClear == true and var_25_0.params[2][1][2] <= var_25_19.topScore then
			return true
		else
			return false
		end
	elseif var_25_0.type == 11903 then
		local var_25_20 = TetrisGameData:GetStageInfoByStageID(var_25_0.params[2])

		if var_25_20 and var_25_20.isClear == true and TetrisGameTools:IsUseSkillClear(var_25_0.params[2], var_25_0.params[3]) then
			return true
		else
			return false
		end
	...
	elseif var_25_0.type == 12003 then
		local var_25_21 = var_25_0.params[2]
		local var_25_22 = 0
		...
		for iter_25_8, iter_25_9 in ipairs((ChallengeRogueTeamData:GetHeroTeamProxy():GetHeroIDList())) do
			if iter_25_9 ~= 0 then
				if HeroCfg[iter_25_9].ATK_attribute[1] == var_25_0.params[1] or HeroCfg[iter_25_9].ATK_attribute[1] == HeroConst.HERO_ATTACK_TYPE.RANDOM then
					var_25_22 = var_25_22 + 1
				end
			end
		end

		return var_25_21 <= var_25_22
	...
	elseif var_25_0.type == 12201 then
		local var_25_24 = var_25_0.params[2] or nil
		...
		if var_25_1 == false and var_25_24 then
			local var_25_25 = ItemTools.getItemNum(var_25_24)

			if var_25_25 and var_25_25 > 0 then
				var_25_2 = 1
				var_25_1 = true
			end
		end
	...
	elseif var_25_0.type == 12605 then
		local var_25_27 = ChapterV2MapTools.GetMapTimestamp(var_25_0.params[1])

		var_25_2 = (var_25_0.params[2] <= var_25_27 or var_25_27 <= var_25_0.params[3]) and 1 or 0
		var_25_3 = 1
		var_25_1 = 1 <= var_25_2
	...
	elseif var_25_0.type == 330001 then
		local var_25_28 = var_25_0.params[2] or 1

		var_25_2 = ItemTools.getItemNum(var_25_0.params[1])
		var_25_3 = var_25_28
		var_25_1 = var_25_28 <= var_25_2
	elseif var_25_0.type == 330002 then
		local var_25_29 = var_25_0.params[2] or 0

		var_25_2 = OathCollectionContentData:GetOathLevel(var_25_0.params[1])
		var_25_3 = var_25_29
		var_25_1 = var_25_29 <= var_25_2
	elseif var_25_0.type == 330003 then
		local var_25_30 = HeroTools.GetHeroIsUnlock(var_25_0.params[1])

		var_25_2 = var_25_30 and 1 or 0
		var_25_3 = 1
		var_25_1 = var_25_30 or var_25_1
	end
