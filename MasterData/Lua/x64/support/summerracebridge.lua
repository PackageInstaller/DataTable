...
local function var_0_16(arg_2_0)
	local var_2_0, var_2_1 = pcall(cjson.decode, arg_2_0)
...
function var_0_0:GetState()
	return self.state_ or var_0_11
end
...
function var_0_0:LeavePlay(arg_9_1)
	if SummerRaceLuaBridge == nil or SummerRaceLuaBridge.ExitScene == nil then
		return false
	end

	local var_9_0 = self:GetState()

	if var_9_0 == var_0_12 or var_9_0 == var_0_14 then
		return false
	end

	self:SetState(var_0_14)

	local var_9_1 = SummerRaceLuaBridge.ExitScene(LuaHelper.VoidAction(function()
		self:SetState(var_0_11)
