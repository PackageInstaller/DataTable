...
local function var_0_4(arg_4_0)
	...
	local var_4_1 = assert(io.open(arg_4_0, "rb"))

	for iter_4_0 in var_4_1:lines() do
		if string.sub(iter_4_0, 1, 2) ~= "--" then
			local var_4_2, var_4_3, var_4_4, var_4_5, var_4_6 = string.find(iter_4_0, "(.+)\t(.*)\t(%d+)")

			if var_4_4 then
				var_4_0.m_cObjectReferenceCount[var_4_4] = var_4_6
				var_4_0.m_cObjectAddressToName[var_4_4] = var_4_5
			end
		end
	end
...
local function var_0_5(arg_5_0, arg_5_1)
	...
	var_5_0.m_cObjectAliasName = {}
	var_5_0.m_cObjectAccessTag = var_5_2
...
local function var_0_6(arg_6_0, arg_6_1, arg_6_2)
	...
	if var_6_3 == "table" then
		...
		if var_6_1[arg_6_1] then
			var_6_1[arg_6_1] = var_6_1[arg_6_1] + 1 or 1
		end
	...
	elseif var_6_3 == "function" then
		...
		for iter_6_2 = 1, var_6_9.nups do
			local var_6_10, var_6_11 = debug.getupvalue(arg_6_1, iter_6_2)
			local var_6_12 = type(var_6_11)

			if var_6_12 == "table" then
				var_0_6(arg_6_0 .. ".[ups:table:" .. var_6_10 .. "]", var_6_11, arg_6_2)
			elseif var_6_12 == "function" then
				var_0_6(arg_6_0 .. ".[ups:function:" .. var_6_10 .. "]", var_6_11, arg_6_2)
			elseif var_6_12 == "thread" then
				var_0_6(arg_6_0 .. ".[ups:thread:" .. var_6_10 .. "]", var_6_11, arg_6_2)
			elseif var_6_12 == "userdata" then
				var_0_6(arg_6_0 .. ".[ups:userdata:" .. var_6_10 .. "]", var_6_11, arg_6_2)
			end
		end

		if debug.getfenv then
			local var_6_13 = debug.getfenv(arg_6_1)

			if var_6_13 then
				var_0_6(arg_6_0 .. ".[function:environment]", var_6_13, arg_6_2)
			end
		end
	elseif var_6_3 == "thread" then
		...
		if debug.getfenv then
			local var_6_14 = debug.getfenv(arg_6_1)

			if var_6_14 then
				var_0_6(arg_6_0 .. ".[thread:environment]", var_6_14, arg_6_2)
			end
		end

		local var_6_15 = getmetatable(arg_6_1)

		if var_6_15 then
			var_0_6(arg_6_0 .. ".[thread:metatable]", var_6_15, arg_6_2)
		end
	elseif var_6_3 == "userdata" then
		...
		if debug.getfenv then
			local var_6_16 = debug.getfenv(arg_6_1)

			if var_6_16 then
				var_0_6(arg_6_0 .. ".[userdata:environment]", var_6_16, arg_6_2)
			end
		end

		local var_6_17 = getmetatable(arg_6_1)

		if var_6_17 then
			var_0_6(arg_6_0 .. ".[userdata:metatable]", var_6_17, arg_6_2)
		end
...
local function var_0_7(arg_7_0, arg_7_1, arg_7_2)
	...
	if var_7_4 == "table" then
		...
		for iter_7_0, iter_7_1 in pairs(arg_7_1) do
			...
			elseif var_7_9 == "function" then
				...
				if not var_7_5 then
					var_0_7(arg_7_0 .. ".[table:key.function" .. ("{line:" .. tostring(var_7_10.linedefined) .. "@file:" .. var_7_10.short_src .. "}") .. "]", iter_7_0, arg_7_2)
				end
	...
	elseif var_7_4 == "function" then
		local var_7_11 = debug.getinfo(arg_7_1, "Su")
		local var_7_12 = arg_7_0 .. "[line:" .. tostring(var_7_11.linedefined) .. "@file:" .. var_7_11.short_src .. "]"

		if var_7_1[arg_7_1] and not var_7_2[var_7_12] then
			var_7_2[var_7_12] = true
		end
		...
		for iter_7_2 = 1, var_7_11.nups do
			local var_7_13, var_7_14 = debug.getupvalue(arg_7_1, iter_7_2)
			local var_7_15 = type(var_7_14)

			if var_7_15 == "table" then
				var_0_7(arg_7_0 .. ".[ups:" .. var_0_2(var_7_14) .. ":" .. var_7_13 .. "]", var_7_14, arg_7_2)
			elseif var_7_15 == "function" then
				local var_7_16 = debug.getinfo(var_7_14, "Su")

				var_0_7(arg_7_0 .. ".[ups:function:" .. var_7_13 .. ("{line:" .. tostring(var_7_16.linedefined) .. "@file:" .. var_7_16.short_src .. "}") .. "]", var_7_14, arg_7_2)
			elseif var_7_15 == "thread" then
				var_0_7(arg_7_0 .. ".[ups:thread:" .. var_7_13 .. "]", var_7_14, arg_7_2)
			elseif var_7_15 == "userdata" then
				var_0_7(arg_7_0 .. ".[ups:userdata:" .. var_7_13 .. "]", var_7_14, arg_7_2)
			end
		end

		if debug.getfenv then
			local var_7_17 = debug.getfenv(arg_7_1)

			if var_7_17 then
				var_0_7(arg_7_0 .. ".[function:environment]", var_7_17, arg_7_2)
			end
		end
	elseif var_7_4 == "thread" then
		...
		if debug.getfenv then
			local var_7_18 = debug.getfenv(arg_7_1)

			if var_7_18 then
				var_0_7(arg_7_0 .. ".[thread:environment]", var_7_18, arg_7_2)
			end
		end

		local var_7_19 = getmetatable(arg_7_1)

		if var_7_19 then
			var_0_7(arg_7_0 .. ".[thread:metatable]", var_7_19, arg_7_2)
		end
	elseif var_7_4 == "userdata" then
		...
		if debug.getfenv then
			local var_7_20 = debug.getfenv(arg_7_1)

			if var_7_20 then
				var_0_7(arg_7_0 .. ".[userdata:environment]", var_7_20, arg_7_2)
			end
		end

		local var_7_21 = getmetatable(arg_7_1)

		if var_7_21 then
			var_0_7(arg_7_0 .. ".[userdata:metatable]", var_7_21, arg_7_2)
		end
...
local function var_0_8(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5, arg_8_6)
	...
	if arg_8_5 then
		var_8_1 = arg_8_5.m_cObjectReferenceCount or nil
	...
	for iter_8_0 in pairs(arg_8_6.m_cObjectReferenceCount) do
		var_8_6 = var_8_6 + 1
	...
	if var_8_7 then
		...
		var_8_11 = (not arg_8_1 or string.len(arg_8_1) == 0) and (arg_8_5 and (var_0_0.m_bComparedMemoryRefFileAddTime and var_8_11 .. "-[" .. var_8_0 .. "].txt" or var_8_11 .. ".txt") or var_0_0.m_bAllMemoryRefFileAddTime and var_8_11 .. "-[" .. var_8_0 .. "].txt" or var_8_11 .. ".txt") or arg_8_5 and (var_0_0.m_bComparedMemoryRefFileAddTime and var_8_11 .. "-[" .. var_8_0 .. "]-[" .. arg_8_1 .. "].txt" or var_8_11 .. "-[" .. arg_8_1 .. "].txt") or var_0_0.m_bAllMemoryRefFileAddTime and var_8_11 .. "-[" .. var_8_0 .. "]-[" .. arg_8_1 .. "].txt" or var_8_11 .. "-[" .. arg_8_1 .. "].txt"
	...
	for iter_8_1, iter_8_2 in ipairs(var_8_5) do
		if not arg_8_5 or not var_8_1[iter_8_2] then
			if arg_8_2 > 0 then
				if iter_8_1 <= arg_8_2 then
					if type(iter_8_2) == "string" then
						...
						if not arg_8_5 then
							if var_8_15 ~= nil then
								if var_8_16 == nil then
									var_8_13("string: \"" .. string.gsub(var_8_14, "([\n\r])", "\\n") .. "\"\t" .. var_8_4[iter_8_2] .. "\t" .. tostring(var_8_3[iter_8_2]) .. "\n")
			...
			elseif type(iter_8_2) == "string" then
				...
				if not arg_8_5 then
					if var_8_19 ~= nil then
						if var_8_20 == nil then
							var_8_13("string: \"" .. string.gsub(var_8_18, "([\n\r])", "\\n") .. "\"\t" .. var_8_4[iter_8_2] .. "\t" .. tostring(var_8_3[iter_8_2]) .. "\n")
...
local function var_0_9(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	local var_11_1 = arg_11_0 and string.len(arg_11_0) > 0
	local var_11_2
	local var_11_3 = print

	if var_11_1 then
		local var_11_4 = string.sub(arg_11_0, -1)

		if var_11_4 ~= "/" and var_11_4 ~= "\\" then
			arg_11_0 = arg_11_0 .. "/"
		end

		local var_11_5 = arg_11_0 .. "LuaMemRefInfo-Single"

		var_11_5 = (not arg_11_1 or string.len(arg_11_1) == 0) and (var_0_0.m_bSingleMemoryRefFileAddTime and var_11_5 .. "-[" .. var_11_0 .. "].txt" or var_11_5 .. ".txt") or var_0_0.m_bSingleMemoryRefFileAddTime and var_11_5 .. "-[" .. var_11_0 .. "]-[" .. arg_11_1 .. "].txt" or var_11_5 .. "-[" .. arg_11_1 .. "].txt"

		local var_11_6 = assert(io.open(var_11_5, "w"))

		var_11_2 = var_11_6
		var_11_3 = var_11_6.write
	end

	local function var_11_7(arg_12_0)
		if var_11_2 then
			var_11_3(var_11_2, arg_12_0)
		else
			var_11_3(arg_12_0)
		end
	end
	...
	var_11_7("--------------------------------------------------------\n")
	var_11_7("-- Collect single object memory reference at line:" .. tostring(arg_11_3.m_nCurrentLine) .. "@file:" .. arg_11_3.m_strShortSrc .. "\n")
	var_11_7("--------------------------------------------------------\n")

	local var_11_8 = 0

	for iter_11_0 in pairs(arg_11_3.m_cObjectAliasName) do
		var_11_8 = var_11_8 + 1
	end

	var_11_7("-- For Object: " .. arg_11_3.m_strAddressName .. " (" .. arg_11_3.m_strObjectName .. "), have " .. tostring(var_11_8) .. " reference in total.\n")
	var_11_7("--------------------------------------------------------\n")

	for iter_11_1, iter_11_2 in pairs(arg_11_3.m_cObjectAliasName) do
		var_11_7(tostring(iter_11_1) .. "\n")
	end
...
function var_0_10.m_cMethods.DumpMemorySnapshot(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
...
function var_0_10.m_cMethods.DumpMemorySnapshotCompared(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4)
	var_0_8(arg_16_0, arg_16_1, arg_16_2, nil, nil, arg_16_3, arg_16_4)
end

function var_0_10.m_cMethods.DumpMemorySnapshotComparedFile(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4)
	var_0_8(arg_17_0, arg_17_1, arg_17_2, nil, nil, var_0_4(arg_17_3), (var_0_4(arg_17_4)))
end

function var_0_10.m_cMethods.DumpMemorySnapshotSingleObject(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4)
...
var_0_10.m_cHelpers.FormatDateTimeNow = var_0_1
var_0_10.m_cHelpers.GetOriginalToStringResult = var_0_2
var_0_10.m_cBases.CreateObjectReferenceInfoContainer = var_0_3
var_0_10.m_cBases.CreateObjectReferenceInfoContainerFromFile = var_0_4
var_0_10.m_cBases.CreateSingleObjectReferenceInfoContainer = var_0_5
var_0_10.m_cBases.CollectObjectReferenceInMemory = var_0_6
var_0_10.m_cBases.CollectSingleObjectReferenceInMemory = var_0_7
var_0_10.m_cBases.OutputMemorySnapshot = var_0_8
var_0_10.m_cBases.OutputMemorySnapshotSingleObject = var_0_9

function var_0_10.m_cBases.OutputFilteredResult(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	if arg_13_3 then
		...
		local var_13_14 = assert(io.open(var_13_13 .. "-Filter-" .. (arg_13_2 and "I" or "E") .. "-[" .. arg_13_1 .. "].txt", "w"))

		var_13_9 = var_13_14
		var_13_10 = var_13_14.write
	end

	local function var_13_15(arg_14_0)
		if var_13_9 then
