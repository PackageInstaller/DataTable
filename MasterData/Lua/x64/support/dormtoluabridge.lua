...
function OnEnterDormScene(arg_4_0)
	...
	Dorm.DormEntityManager.EnablePlayerInput = DormData:GetCurrectSceneID() < DormConst.DORM_VISIT_ROOM_MIN
	...
	if BackHomeCfg[var_4_0].type == DormConst.BACKHOME_TYPE.PublicDorm or BackHomeCfg[var_4_0].type == DormConst.BACKHOME_TYPE.PrivateDorm then
...
function Dorm.OnClickFurniture(arg_6_0, arg_6_1, arg_6_2)
	JumpTools.OpenPageByJump("/furnitureEdit", {
		...
		itemId = arg_6_0,
		furEntityID = arg_6_1,
		furSuitEid = (arg_6_2 and arg_6_2 >= 0 or nil) and arg_6_2
	})
end
