...
function M:on_enter()
  self:add_npc_by_pos_key(1, 300100306, "M3", 0, 0, "M3", 0, 0, 4, 1)
  self:add_npc_by_pos_key(1, 300100306, "A2", 0, 0, "A2", 0, 0, 4, 1)
  self:add_npc_by_pos_key(1, 300100206, "M4", 0, 0, "M3", 0, 0, 4, 1)
  self:add_npc_by_pos_key(1, 300100206, "A3", 0, 0, "A2", 0, 0, 4, 1)
  self:add_npc_by_pos_key(1, 300100206, "tp2", 0, 0, "tp4", 0, 0, 4, 1)
  ...
  self:set_route_status(18, 15, true)
