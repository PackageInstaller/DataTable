...
function M:on_enter()
  ...
  self:fight_end(true)
  self.book = self:add_functional_npc(2, "book3", "center", {npc_id = 101301})
  self:add_functional_npc(2, "book1", "center", {npc_id = 101305})
  self:add_functional_npc(2, "book2", "center", {npc_id = 101306})
  self:add_functional_npc(2, "book4", "center", {npc_id = 101307})
  self:add_functional_npc(2, "book5", "center", {npc_id = 101308})
  self:add_functional_npc(2, "book6", "center", {npc_id = 101309})
  self:add_functional_npc(2, "book7", "center", {npc_id = 101310})
  self:add_functional_npc(2, "book8", "center", {npc_id = 101311})
...
function M:on_func_npc_interact_end(func_npc_id)
  if func_npc_id == self.book then
    self:trigger_fight_story(10130001)
  end
end
