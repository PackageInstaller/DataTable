...
function M:on_enter()
  self:set_route_status(39, 30, false)
  self:set_route_status(30, 31, true)
  ...
  if self:is_pass_room() then
    ...
    self:set_scene_camera(102)
    self:add_monster()
    self:set_scene_tips(1021002, 1, {})
    self:timer_call_out("AA", function()
      self:set_scene_tips(1021016, 1, {})
    end, 4.1)
  end
end
