...
function M:on_enter()
  self:set_route_status(7, 6, false)
  self:complete_task(102102)
  self:set_scene_tips(1021021, 1, {})
  self:timer_call_out("12", function()
    self:set_scene_tips(1021022, 1, {})
  end, 3.1)
  self:timer_call_out("23", function()
    self:set_scene_tips(1021023, 1, {})
  end, 6.1)
  self:timer_call_out("34", function()
    self:set_scene_tips(1021024, 1, {})
  end, 9.1)
  self:timer_call_out("45", function()
    self:set_scene_tips(1021025, 1, {})
  end, 12.1)
  ...
  for i = count, 1, -1 do
    ...
    if monster == npc then
      ...
      if 0 == #self.monster_list and not self:is_pass_room() and 1 == self.wave then
        self.wave = 2
        self:add_monster2()
        self:set_scene_tips(1021026, 1, {})
        Log.Info(Global.hero, "tips_id 1021026")
        self:timer_call_out("AC", function()
          self:set_scene_tips(1021027, 1, {})
          Log.Info(Global.hero, "tips_id 1021027")
        end, 3.1)
        self:timer_call_out("BD", function()
          self:set_scene_tips(1021028, 1, {})
          Log.Info(Global.hero, "tips_id 1021028")
        end, 8.1)
      end
      if 0 == #self.monster_list and not self:is_pass_room() then
        self:play_story(100102042)
      end
    end
  end
end
