...
function M:on_enter()
  self:set_route_status(6, 7, true)
  self:set_route_status(6, 5, false)
  self:set_route_status(6, 20, false)
  self:cast_magic(Global.hero, Global.hero, 4032098, 99)
  self:set_scene_tips(1021019, 1, {})
  self:timer_call_out(nil, function()
    self:set_scene_tips(1021020, 1, {})
  end, 4.1)
