...
function M:teach_guide3()
  ...
  g:add_step():listen("on_input", function(input_id)
    ...
    if 1999301 == magic_id then
      enter_guide(5040)
    end
  end):listen("on_touch_up", function(output_id, iscancel, input_time)
    if 15 == output_id and input_time >= 0.5 then
      set_skill_state(g:step_index() - 1, true)
      set_ui_object_visible("fight", "Btn_skill1", false)
      self:to_next_step()
    else
...
function M:teach_guide4()
  ...
  g:add_step(function()
    request_teach_scene_create_monster("monster_group2")
    g:wait_create_monster("monster_group2", function()
