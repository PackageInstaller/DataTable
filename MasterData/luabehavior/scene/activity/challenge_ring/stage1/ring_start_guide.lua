...
function M:on_enter()
  ...
  if not self.is_add_npc then
    self:add_functional_npc(6, "center", "center", {npc_id = 50000})
    self:add_functional_npc(8, "tp2", "center", {npc_id = 90001})
  ...
  self.looknpc = self:add_npc_by_pos_key(1, 3001024, "center", 0, 0, "center", 0, 0, 2, self.normal_level)
  self:cast_magic(self.looknpc, self.looknpc, 4031014, 1)
