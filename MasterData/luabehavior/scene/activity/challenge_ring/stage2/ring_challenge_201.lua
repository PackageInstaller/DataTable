...
function M:on_npc_show_end(id, type)
  ...
  for index = 1, 4 do
    self:cast_magic(self.monster[1], self.monster[1], cast_magic_id[index], 1)
    self:cast_magic(self.monster[2], self.monster[2], cast_magic_id[index], 1)
    self:cast_magic(self.monster[3], self.monster[3], cast_magic_id[index], 1)
    self:cast_magic(self.monster[4], self.monster[4], cast_magic_id[index], 1)
  end
end
