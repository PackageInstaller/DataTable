...
function M:add_monster()
  self:set_sync_var("T3002008_movedir", 1)
  self:set_sync_var("T3002008_movetimer", 12)
  ...
  local x1, y1 = self:get_scene_map_pos_postion("P1")
  self:lookat_position(self.tt1, x1, y1, true)
end
