...
function M:on_enter()
  ...
  if 1 == self.random_id then
    self:set_sync_var("T3002008_movedir", 2)
    self:set_sync_var("T3002008_movetimer", 13.5)
  else
    self:set_sync_var("T3002008_movedir", 1)
    self:set_sync_var("T3002008_movetimer", 4.5)
  end
...
function M:add_monster()
  ...
  local x1, y1 = self:get_scene_map_pos_postion("P2")
