...
function M:teach_guide1()
  ...
  g:add_step(function()
    self.monster1 = add_npc_by_pos_key(1, 20106001, "center", 0, 0, "tp3", 0, 0, 4, 99)
...
function M:teach_guide2()
  ...
  g:add_step(function(back_form)
    if back_form then
      restart_skill_teach(101411)
    else
      start_skill_teach(101411)
      set_scene_tips(61402, true, {})
    end
    set_ui_object_visible("fight", "Btn_skill1", true)
...
function M:teach_guide4()
  ...
  g:add_step(function()
    ...
    self.monster2 = add_npc_by_pos_key(1, 201021, "center", 0, 0, "tp3", 0, 0, 4, 99)
    set_ui_object_visible("fight", "MainEnemyBloodList", false)
    self:to_next_step(1)
  end)
  g:add_step(function(back_form)
    if back_form then
      restart_skill_teach(101406)
    else
      start_skill_teach(101406)
      set_scene_tips(61403, true, {})
      set_ui_object_visible("fight", "Btn_skill1", true)
