...
function M:on_enter()
  ...
  elseif not self:is_pass_room() then
    ...
    self:lookat_position(Global.hero, x, y, true)
    self:actvie_obstacle("AW1", "wall", true)
    self.monster3 = self:add_npc_by_pos_key(1, 201031, "M1", 0, 0, "center", 0, 0, 4, self.normal_level)
    self.monster4 = self:add_npc_by_pos_key(1, 201031, "M2", 0, 0, "center", 0, 0, 4, self.normal_level)
    self.monster5 = self:add_npc_by_pos_key(1, 201034, "M3", 0, 0, "center", 0, 0, 4, self.normal_level)
    self.monster6 = self:add_npc_by_pos_key(1, 201034, "M4", 0, 0, "center", 0, 0, 4, self.normal_level)
    self.monster7 = self:add_npc_by_pos_key(1, 201034, "M5", 0, 0, "center", 0, 0, 4, self.normal_level)
  end
end
