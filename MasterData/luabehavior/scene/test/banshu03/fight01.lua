...
function M:on_enter()
  self:add_npc_by_pos_key(1, 300100105, "M3", 0, 0, "M3", 0, 0, 4, 1)
  self:add_npc_by_pos_key(1, 300100306, "A2", 0, 0, "A2", 0, 0, 4, 1)
  self:add_npc_by_pos_key(1, 300100206, "M5", 0, 0, "A2", 0, 0, 4, 1)
  self:add_npc_by_pos_key(1, 300100206, "A4", 0, 0, "M3", 0, 0, 4, 1)
  self:add_npc_by_pos_key(1, 300100306, "A5", 0, 0, "A5", 0, 0, 4, 1)
...
function M:on_enter_area(npc, area)
  ...
  if area.Key == "M1" and 1 == self.add_monster_tag then
    self:add_npc_by_pos_key(1, 300100206, "M1", 0, 0, "tp4", 0, 0, 4, 1)
    self:add_monster()
  ...
  if area.Key == "M3" then
    self:remove_area("M3")
    self:set_sceneobj_visible("scene_timeline1_3_zhuzi1", true)
  end
  if area.Key == "M4" then
    self:remove_area("M4")
    self:set_sceneobj_visible("scene_timeline1_3_zhuzi2", true)
  end
end
