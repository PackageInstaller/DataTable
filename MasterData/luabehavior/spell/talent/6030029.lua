...
function M:before_heal(npc, target, magic_id)
  ...
  if 5001001 == magic_id or 5001002 == magic_id or 5001003 == magic_id or 5001004 == magic_id then
    ...
    self.before_sharft = now_hp / now_max_hp
  end
end
...
function M:after_heal(npc, target, magic_id, heal_val)
  ...
  cast_magic(self.npc, self.npc, 6031064, final)
  cast_magic(self.npc, self.npc, 6031065, final)
  cast_magic(self.npc, self.npc, 6031066, final)
end
