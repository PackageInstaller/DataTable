...
function M:_init()
  ...
  self.feinamina = get_come_on_hero()
  self.feinamina_pos = get_npc_pos(self.feinamina)
...
function M:teach_guide1()
  ...
  g:add_step(function()
    ...
    cast_magic(self.feinamina, self.feinamina, 102695, 1)
    set_ui_object_visible("fight", "Btn_skill5", true)
    set_ui_object_visible("fight", "JoystickContent", true)
    set_ui_object_visible("fight", "Btn_skill4", true)
    set_ui_object_visible("fight", "Btn_skill1", true)
  ...
  g:add_step(function()
    start_skill_teach(102601)
    enter_guide(100102602)
    self:to_next_step()
  end)
  g:add_step():listen("on_finish_guide", function(guide_id)
  ...
  g:add_step():listen("on_finish_guide", function(guide_id)
    ...
    self:to_next_step(1.9)
  end)
  g:add_step(function()
    enter_guide(100102605)
    self:to_next_step()
  end)
  g:add_step():listen("on_finish_guide", function(guide_id)
    self:to_next_step()
  ...
  g:add_step(function()
    enter_guide(100102607)
    cast_magic(self.feinamina, self.feinamina, 102672, 1)
    self:to_next_step()
  end)
  g:add_step():listen("on_finish_guide", function(guide_id)
    self:to_next_step()
  ...
  g:add_step(function()
    start_skill_teach(102602)
    enter_guide(100102609)
    set_ui_object_visible("fight", "Btn_skill4", true)
    self:to_next_step()
  end)
  g:add_step():listen("on_finish_guide", function(guide_id)
  ...
  g:add_step(function(back_form)
    if back_form then
      ...
      cast_magic(self.feinamina, self.feinamina, 102696, 1)
      cast_magic(self.feinamina, self.feinamina, 102672, 1)
      restart_skill_teach(102603)
      enter_guide(100102610)
    else
      set_ui_object_visible("fight", "Btn_skill5", true)
      start_skill_teach(102603)
      enter_guide(100102610)
    end
    self:to_next_step()
  end)
  g:add_step(function()
    self:guide_timeout(999, function()
      set_skill_state(1, false)
      self:back_to_step(back_step, 2)
    end)
  ...
  g:add_step(function()
    ...
    if 100102636 == skill_id or 100102637 == skill_id then
      set_skill_state(2, true)
      self:cancel_guide_timeout()
      self:to_next_step()
    elseif g:step_elapse() > 2 or 100102637 ~= skill_id and 100102636 ~= skill_id then
      self:cancel_guide_timeout()
      set_skill_state(2, false)
      self:back_to_step(back_step, 2)
    end
...
function M:teach_guide2()
  ...
  flash_to_pos(self.feinamina, self.feinamina_pos.x, self.feinamina_pos.z, self.feinamina_pos.y)
  cast_magic(self.feinamina, self.feinamina, 102673, 1)
  g:add_step(function()
    set_ui_object_visible("fight", "Btn_skill4", true)
    set_ui_object_visible("fight", "JoystickContent", false)
    set_ui_object_visible("fight", "Btn_skill5", false)
  ...
  g:add_step(function(back_form)
    if back_form then
      ...
      restart_skill_teach(102604)
      remove_missile_by_id(10010260102, self.feinamina, true)
      remove_missile_by_id(10010260204, self.feinamina, true)
      remove_missile_by_id(10010260206, self.feinamina)
      remove_missile_by_id(10010260303, self.feinamina)
      remove_missile_by_id(10010260304, self.feinamina)
      remove_missile_by_id(10010260305, self.feinamina)
      remove_missile_by_id(10010260401, self.feinamina)
      remove_missile_by_id(10010260404, self.feinamina)
      remove_missile_by_id(10010260405, self.feinamina)
    else
      self.monster2 = add_npc_by_pos_key(1, 20101502, "bornpoint", -2, 2, "tp3", 0, 0, 4, 1)
      self.monster2_pos = get_npc_pos(self.monster2)
      flash_to_pos(self.feinamina, self.feinamina_pos.x, self.feinamina_pos.z, self.feinamina_pos.y)
      lookat_npc(self.feinamina, self.monster2, 1)
      cast_magic(self.monster2, self.monster2, 4032905, 1)
      start_skill_teach(102604)
    end
    flash_to_pos(self.feinamina, self.feinamina_pos.x, self.feinamina_pos.z, self.feinamina_pos.y)
    lookat_npc(self.feinamina, self.monster2, 1)
    self:to_next_step()
  ...
  g:add_step():listen("on_skill_begin", function(npc, skill_id, skill_type)
    if 100102601 == skill_id then
      set_skill_state(1, true)
      self:cancel_guide_timeout()
      self:to_next_step()
    elseif g:step_elapse() > 2 or 100102601 ~= skill_id then
      self:cancel_guide_timeout()
      set_skill_state(1, false)
  ...
  g:add_step(function()
    ...
    if 100102602 == skill_id then
      set_skill_state(2, true)
      self:cancel_guide_timeout()
      self:to_next_step()
    elseif g:step_elapse() > 2 or 100102602 ~= skill_id then
      self:cancel_guide_timeout()
      set_skill_state(2, false)
      self:back_to_step(4, 1)
    end
  ...
  g:add_step(function()
    ...
    if 100102603 == skill_id then
      set_skill_state(3, true)
      self:cancel_guide_timeout()
      self:to_next_step(0.9)
    elseif g:step_elapse() > 2 or 100102603 ~= skill_id then
      self:cancel_guide_timeout()
      set_skill_state(3, false)
      self:back_to_step(4, 1)
    end
  ...
  end):listen("on_finish_guide", function(npc, skill_id, skill_type)
    set_skill_state(4, true)
    self:cancel_guide_timeout()
    self:to_next_guide("guide3", 3)
  end)
  g:start()
end
...
function M:teach_guide3()
  ...
  g:add_step(function()
    enter_guide(100102614)
    start_skill_teach(102605)
    self:to_next_step()
  end)
  g:add_step():listen("on_finish_guide", function(guide_id)
    set_skill_state(1, true)
    ...
    cast_magic(self.monster1, self.monster1, 10001001, 1)
    cast_magic(self.feinamina, self.feinamina, 10001006)
  end)
  g:start()
end
...
function M:teach_guide4()
  ...
  g:add_step(function()
    set_ui_object_visible("fight", "Btn_skill7", true)
    start_skill_teach(102606)
    enter_guide(100102616)
    self:to_next_step()
  end)
  g:add_step():listen("on_finish_guide", function(guide_id)
    set_ui_object_visible("fight", "Btn_skill7", false)
...
function M:add_energy()
  local characeter_energy = get_npc_attr(self.feinamina, 2)
  if characeter_energy <= 200 then
    cast_magic(self.feinamina, self.feinamina, 4032991, 1)
  end
end
...
function M:on_frame()
  Base.on_frame(self)
  self:add_energy()
  if not self.init_guide and not check_npc_status(self.feinamina, 1) then
