...
function M:teach_guide1()
  ...
  g:add_step(function(back_form)
    if back_form then
      ...
      restart_skill_teach(100912)
    else
      cast_magic(self.npc, self.npc, 4032175, 1)
      cast_magic(self.npc, self.npc, 4032176, 1)
      start_skill_teach(100912)
    end
    set_scene_tips(60935, true, {})
    set_ui_object_visible("fight", "Btn_skill1", false)
  ...
  g:add_step(function()
    show_skill_teach_tips(100904, true)
...
function M:on_frame()
  ...
  if self.init_guide and get_npc_attr(self.npc, 3) < 90 then
    cast_magic(self.npc, self.npc, 4032992, 0)
  end
