...
function M:_init(npc)
  ...
  cast_magic(npc, npc, 40104402, 0)
  if self.hero_one then
    cast_magic(self.hero_one, self.hero_one, 40104402, 0)
  end
  if self.hero_two then
    cast_magic(self.hero_two, self.hero_two, 40104402, 0)
  end
end
...
function M:on_frame()
  if get_sync_var("104501_speed_up") then
    ...
    abort_magic_by_id(self.npc, 40104402)
    if self.hero_one then
      abort_magic_by_id(self.hero_one, 40104402)
    end
    if self.hero_two then
      abort_magic_by_id(self.hero_two, 40104402)
    end
  end
end
