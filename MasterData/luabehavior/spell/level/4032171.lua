...
function M:teach_guide1()
  ...
  g:add_step(function(back_form)
    if back_form then
      restart_skill_teach(101701)
    else
      start_skill_teach(101701)
      set_scene_tips(61701, true, {})
    end
  ...
  local function func_skill_begin(npc, skill_id, skill_type)
    local target_skill_id = 100101700 + g:step_index() - 2
...
function M:teach_guide2()
  ...
  g:add_step(function(back_form)
    if back_form then
      restart_skill_teach(101702)
    else
      start_skill_teach(101702)
      set_scene_tips(61702, true, {})
    end
    set_ui_object_visible("fight", "JoystickContent", true)
    set_ui_object_visible("fight", "Btn_skill1", true)
    cast_magic(self.npc, self.npc, 4032114, 1)
    abort_magic_by_id(self.npc, 1017997)
    self:to_next_step()
  end)
...
function M:teach_guide3()
  ...
  g:add_step(function()
    ...
    start_skill_teach(101703)
    set_scene_tips(61704, true, {})
  ...
  g:add_step(function()
    set_scene_tips(61704, false, {})
    show_skill_teach_tips(101701, true)
...
function M:on_skill_teach_tips_close(tips_id)
  if 101701 == tips_id then
    set_scene_tips(801019, true, {})
    set_scene_tips(61705, true, {})
  end
end
