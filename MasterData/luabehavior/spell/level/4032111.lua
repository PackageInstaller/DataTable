...
function M:teach_guide1()
  ...
  g:add_step(function(back_form)
    if back_form then
      cast_magic(self.npc, self.npc, 4032115, 1)
      cast_magic(self.npc, self.npc, 4032116, 1)
      restart_skill_teach(101101)
    else
      cast_magic(self.npc, self.npc, 4032115, 1)
      cast_magic(self.npc, self.npc, 4032116, 1)
      start_skill_teach(101101)
      set_scene_tips(61101, true, {})
    end
  ...
  local function func_skill_begin(npc, skill_id, skill_type)
    local target_skill_id = 100101100 + g:step_index() - 2
...
function M:teach_guide2()
  ...
  g:add_step(function()
    self.monster1 = add_npc_by_pos_key(1, 20106016, "center", 0, 1, "tp3", 0, 0, 4, 99)
    lookat_npc(self.monster1, self.npc)
    set_sync_var("in_daze", 1)
    set_sync_var("close_counterattack", 1)
    self:to_next_step(1.5)
  end)
  g:add_step(function(back_form)
    if back_form then
      restart_skill_teach(101102)
    else
      start_skill_teach(101102)
      set_scene_tips(61102, true, {})
    end
    set_ui_object_visible("fight", "JoystickContent", true)
    set_ui_object_visible("fight", "Btn_skill1", true)
    self:to_next_step()
  ...
  g:add_step():listen("on_input", function(input_id)
    ...
    if 15 == output_id and input_time >= 0.5 and not iscancel then
      ...
      set_skill_state(1, false)
      set_ui_object_visible("fight", "Btn_skill1", false)
      self:back_to_step(5, 1)
    end
  end)
  g:add_step(function()
    set_scene_tips(61103, false, {})
    remove_npc(self.monster1)
    set_ui_object_visible("fight", "Btn_skill1", false)
    self:to_next_step(1)
  end)
...
function M:teach_guide3()
  ...
  g:add_step(function()
    remove_npc(self.monster1)
    self.monster2 = add_npc_by_pos_key(1, 20102802, "center", 0, 1, "tp3", 0, 0, 4, 99)
    lookat_npc(self.monster2, self.npc)
    set_sync_var("in_daze", 0)
    start_skill_teach(101103)
    set_scene_tips(61104, true, {})
  ...
  g:add_step(function()
    set_scene_tips(61104, false, {})
    show_skill_teach_tips(101101, true)
...
function M:on_skill_teach_tips_close(tips_id)
  if 101101 == tips_id then
    set_scene_tips(801019, true, {})
    set_scene_tips(61105, true, {})
  end
end
