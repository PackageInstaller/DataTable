...
function M:teach_guide1()
  ...
  local function func_skill_begin(npc, skill_id, skill_type)
    local target_skill_id = 100101500 + g:step_index() - 2
...
function M:teach_guide3()
  ...
  g:add_step(function()
    ...
    start_skill_teach(101503)
    set_scene_tips(61504, true, {})
  ...
  g:add_step(function()
    ...
    show_skill_teach_tips(101501, true)
...
function M:on_skill_teach_tips_close(tips_id)
  if 101501 == tips_id then
    set_scene_tips(801019, true, {})
    set_scene_tips(61505, true, {})
  end
end
...
function M:on_frame()
  Base.on_frame(self)
  self:add_energy()
  if not self.init_guide and get_npc_status(self.npc) and not check_npc_status(self.npc, 1) then
    if self.delay_frame < 0 then
      self.init_guide = true
      self:teach_guide1()
    else
      self.delay_frame = self.delay_frame - 1
    end
  end
...
function M:on_skill_begin(npc, skill_id, skill_type)
  ...
  if 100101591 == skill_id then
    self.npc_pos = get_npc_pos(self.npc)
    CommonRole.do_after(self, function()
      set_npc_pos(self.npc, self.npc_pos)
    end, 4)
  end
end
