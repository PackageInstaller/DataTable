...
function M:teach_guide1()
  ...
  g:add_step(function()
    self.monster1 = add_npc_by_pos_key(1, 20101502, "M7", 0, 0, "tp3", 0, 0, 4, 99)
    ...
    cast_magic(self.npc, self.npc, 4032175, 0)
    self:to_next_step(2)
  end)
  g:add_step(function(back_form)
    if back_form then
      ...
      restart_skill_teach(101006)
    else
      cast_magic(self.npc, self.npc, 4032175, 1)
      cast_magic(self.npc, self.npc, 4032176, 1)
      start_skill_teach(101006)
    end
    set_scene_tips(61016, true, {})
  ...
  g:add_step(function()
    show_skill_teach_tips(101003, true)
