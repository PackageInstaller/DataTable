...
function M:_init()
  ...
  self.skill02 = {
    ...
    0,
    3,
    get_skill_cfg(20101602).CastTime,
    get_skill_cfg(20101602).AfterTime,
    0
  }
  self.skill01 = {
    20101601,
    ...
    0,
    11,
    get_skill_cfg(20101601).CastTime,
    get_skill_cfg(20101601).AfterTime,
    0
  }
  self.start_time = 2
  self.monster_type = 2
...
function M:on_start()
  self.skill01[4] = math.random(7, 8)
end
