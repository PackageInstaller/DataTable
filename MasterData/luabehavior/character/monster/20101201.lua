...
function monster._init(monster, npc)
  ...
  monster.states.surMove.maxTime = 2
  ...
  do
    ...
    function skill01.finish(skill01)
      ...
      local self = skill01.monster
      random = math.random(100)
      skill01.monster.Rotate_counter = skill01.monster.Rotate_counter + 1
      if self.target and check_npc_distance(self.npc, self.target, 2, false) then
        plus = 20
      else
        plus = 0
      end
