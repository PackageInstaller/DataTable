...
function M:_init()
  ...
  self.skill01 = {
    ...
    0,
    2,
    get_skill_cfg(20102001).CastTime,
    get_skill_cfg(20102001).AfterTime,
    0
  }
  self.Hatred_Range = 10
  self.Entter_Attack_Range = 6
  self.stun_timer = 0
...
function M:Enter_Attack()
  local dis1 = check_npc_distance(self.npc, self.target, self.skill01[5], true)
