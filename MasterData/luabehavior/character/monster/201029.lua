...
function M:_init()
  ...
  self.skill02 = {
    ...
    0,
    3,
    get_skill_cfg(20102902).CastTime,
    get_skill_cfg(20102902).AfterTime,
    0
  }
  self.skill01 = {
    20102901,
    ...
    4,
    10,
    get_skill_cfg(20102901).CastTime,
    get_skill_cfg(20102901).AfterTime,
    0
  }
  self.monster_type = 2
  self.wander = {
...
function M:skill_main_logic()
  ...
  if not self:cast_skill(self.skill01) and not self:cast_skill(self.skill02) and check_npc_distance(self.npc, self.target, self.wander[1], true) then
    return
  end
end
