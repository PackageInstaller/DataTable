...
function monster._init(monster, npc)
  ...
  do
    ...
    function born.start()
      ...
      cast_missile3(monster.npc, nil, nil, nil, 202051010601, 1)
    end
    ...
    function born.tickTrans(born)
      ...
      if monster.born_hit == true or check_magic(monster.npc, 201051010204) then
...
function monster.on_self_missile_end_pos(monster, pos_x, pos_z, missile_cfg, missile, is_break)
  if missile_cfg.Id == 202051010601 then
    monster.born_hit = true
  end
end
