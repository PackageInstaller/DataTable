...
function M:_init()
  ...
  self.Skill01 = {
    ...
    0,
    3.5,
    get_skill_cfg(20100401).CastTime,
    get_skill_cfg(20100401).AfterTime
  }
  self.Skill02 = {
    20100403,
    4,
    ...
    2.5,
    5,
    get_skill_cfg(20100403).CastTime,
    get_skill_cfg(20100403).AfterTime
  }
  self.target = nil
  self.wander = {
    3,
...
function M:Skill_main_logic()
  ...
  if not self:cast_skill(self.Skill01) and not self:cast_skill(self.Skill02) then
    return
  end
end
