...
function M:_init(npc)
  ...
  self.skill01 = {
    ...
    0,
    3,
    get_skill_cfg(2010350302).CastTime,
    get_skill_cfg(2010350302).AfterTime,
    0
  }
  self.skill02 = {
    2020350601,
    ...
    3,
    7,
    get_skill_cfg(2010350301).CastTime,
    get_skill_cfg(2010350301).AfterTime,
    0
  }
  self.control = 0
  self.wander = {
...
function M:skill_main_logic()
  ...
  if not check_npc_distance(self.npc, self.target, self.skill01[4], false) and check_npc_distance(self.npc, self.target, self.skill01[5], false) and now_time >= self.skill01[3] then
    ...
    self.control = 99
  elseif not check_npc_distance(self.npc, self.target, self.skill02[4], false) and check_npc_distance(self.npc, self.target, self.skill02[5], false) and now_time >= self.skill02[3] then
    lookat_npc(self.npc, self.target, false)
    abort_skill(self.npc)
