...
function monster._init(monster, npc)
  ...
  do
    ...
    _ENV.meleeAtk(_ENV.skill03, _ENV.skill01, _ENV.skill02)
  ...
  do
    ...
    function power_end.start(power_end)
      ...
      for _, value in pairs(list_monster) do
        ...
        value:get_behavior().go_mad(monster)
      end
  ...
  function monster.states.gotTarget.tick(gotTarget)
    ...
    self.buff = search_npc(self.npc, 2, 8, nil, false, true, 20103701, 2)
  end
end
...
function monster.go_mad(monster)
  ...
  monster.states.skill03.cd = 6
  monster.states.skill01.cd = 3
  monster.wander.maxDis = 3
  local _ENV = monster.states
  _ENV.freeAtk(_ENV.skill03, _ENV.Power_Up)
