...
function M:on_frame()
  if get_sync_var("20352") then
    set_sync_var("20352", false)
    self:start_switch_scene_effect(self.switch_effect_cfg4_2, true)
  end
  if get_sync_var("20353") then
    set_sync_var("20353", false)
    self:start_switch_scene_effect(self.switch_effect_cfg4_2, true)
  end
  if get_sync_var("203522") then
    set_sync_var("203522", false)
    self:start_switch_scene_effect(self.switch_effect_cfg4_2, false)
  end
  if get_sync_var("203533") then
    set_sync_var("203533", false)
    self:start_switch_scene_effect(self.switch_effect_cfg4_2, false)
  end
end
...
function M:on_magic_begin(npc, target, magic_id)
  ...
  if 1999132 == magic_id and self.is3 then
    self:clear_timer()
