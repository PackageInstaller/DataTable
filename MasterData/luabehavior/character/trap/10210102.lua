...
function M:on_skill_hit(npc, skill_id, hit_target, hit_type, missile_cfg, missile)
  if hit_target == self.npc and missile_cfg.Id == 30010390201 then
    set_sceneobj_visible_save_state("/Root/Change_/Change_bright/Level_1/T1-TL/timeline_n0228", true, true)
    set_sync_var("break2", true)
...
function M:on_timeline_end(timeline_name)
  if "/Root/Change_/Change_bright/Level_1/T1-TL/timeline_n0228" == timeline_name then
    set_scene_tips(100185, false, {})
    remove_npc(self.npc)
  end
end
