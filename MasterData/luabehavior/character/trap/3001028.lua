...
function M:_init()
  ...
  self.skill01 = {
    ...
    0,
    0,
    get_skill_cfg(300102801).CastTime,
    get_skill_cfg(300102801).AfterTime
  }
  self.pos = {
    [1] = {x = 0, z = 0}
  }
...
function M:cast_skill(skill_instant_ID)
  ...
  if 300102801 == skill_instant_ID[1] then
...
function M:on_skill_hit(npc, skill_id, hit_target, hit_type, missile_cfg, missile)
  ...
  if missile_cfg.Id == 31010030401 then
    cast_magic(self.npc, self.npc, 4031023, 5)
  end
end
