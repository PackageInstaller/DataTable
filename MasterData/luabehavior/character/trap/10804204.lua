...
function monster._init(monster, npc)
  ...
  do
    ...
    function talk.tickTrans(talk)
      print("人看" .. tostring(monster.currentFaceIndex))
      ...
      print("看" .. tostring(monster.faceTarget[monster.currentFaceIndex]) .. "," .. tostring(monster.faceTarget[monster.currentFaceIndex].x) .. "," .. tostring(monster.faceTarget[monster.currentFaceIndex].z))
