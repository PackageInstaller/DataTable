-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/event.lua
...
function _event:Add(func, obj)
	...
	func = self.keepSafe and xfunctor(func, obj) or functor(func, obj)
