-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/jit/bcsave.lua
...
local function bclist(input, output)
	...
	require("jit.bc"):dump(savefile(output, "w"), true)
end
