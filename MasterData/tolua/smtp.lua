-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/socket/smtp.lua
...
local function send_multipart(mesgt)
	...
	local headers = lower_headers((not mesgt.headers or nil) and {})
...
local function adjust_headers(mesgt)
	...
	lower.date = lower.date or os.date("!%a, %d %b %Y %H:%M:%S ") .. ((not mesgt.zone or nil) and _M.ZONE)
