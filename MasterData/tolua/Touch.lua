-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/UnityEngine/Touch.lua
...
function Touch.GetMask(...)
	...
	for i = 1, #arg do
		if not TouchBits[arg[i]] then
			if TouchBits[arg[i]] ~= 0 then
				value = value + TouchBits[arg[i]]
			end
		end
	end
