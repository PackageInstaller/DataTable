-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/UnityEngine/RaycastHit.lua
...
function RaycastHit.GetMask(...)
	...
	for i = 1, #arg do
		if not RaycastBits[arg[i]] then
			if RaycastBits[arg[i]] ~= 0 then
				value = value + RaycastBits[arg[i]]
			end
		end
	end
