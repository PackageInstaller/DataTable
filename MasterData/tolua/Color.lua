-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/UnityEngine/Color.lua
...
local function RGBToHSVHelper(offset, dominantcolor, colorone, colortwo)
	...
	if V ~= 0 then
		local num2 = V - (colortwo < colorone and colortwo or colorone)
		local H = 0
		local S = 0
