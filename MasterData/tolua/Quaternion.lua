-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/UnityEngine/Quaternion.lua
...
function Quaternion.LookRotation(forward, up)
	...
	if t > 0 then
		...
		local s = 0.5 / sqrt(t)
		local ret = _new((up.z - forward.y) * s, (forward.x - right.z) * s, (right.y - up.x) * s, s * t)
