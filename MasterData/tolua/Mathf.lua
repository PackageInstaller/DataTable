-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/UnityEngine/Mathf.lua
...
function Mathf.SmoothDamp(current, target, currentVelocity, smoothTime, maxSpeed, deltaTime)
	...
	if current < num5 == (num5 < num8) then
		num8 = num5
		currentVelocity = (num5 - num5) / deltaTime
	end
