-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/ToLua/Lua/jit/dump.lua
...
local function dump_mcode(tr)
	...
	disass = disass or require("jit.dis_" .. jit.arch)
...
local function formatk(tr, idx, sn)
	...
	if tn == "number" then
		s = band(sn or 0, 196608) ~= 0 and (band(sn, 131072) ~= 0 and "contpc" or "ftsz") or k == 6755399441055744 and "bias" or format(k > 0 and k < 0x0.1000000000000p-1022 and "%+a" or "%+.14g", k)
...
local function dumpon(opt, outfile)
	...
	if m.b then
		...
		bcline = bcline or require("jit.bc").line
	end
