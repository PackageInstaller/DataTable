...
local var_0_2 = g.core.const.ConstMgr.WaitGameConst
local var_0_3 = g.core.config.game_eliminate_res_info
local WaitGameCompPool = require("upgrade.waitGame.comp.WaitGameCompPool")
local WaitGameContainerComp = class("WaitGameContainerComp", require("app.fairyGUI.upgrade.UI_WaitGameContainerComp"))

function WaitGameContainerComp:ctor()
	self._row = 6
	self._col = 7
	self._colorNum = 5
	self._resGroup = 4
	...
	self._gemCellPool = WaitGameCompPool.new("GemCellPool")
...
function WaitGameContainerComp:updateWithInfo()
	self._colorNum = 5
	self._gemColorArr = self:_getRandomColorArr(self._resGroup, self._colorNum)
...
function WaitGameContainerComp:_onTouchBegin(arg_3_1)
...
function WaitGameContainerComp:_onTouchMove(arg_4_1)
	if not self._playing then
		return
	elseif self._moving then
		return
...
function WaitGameContainerComp:_onTouchEnd(arg_5_1)
...
function WaitGameContainerComp:_touchStone(arg_6_1)
	...
	if self._choseRowCol then
		...
		if var_6_4 == var_6_1 and var_6_3 == var_6_0 then
			...
			local var_6_5 = var_0_2.MoveDir.NONE

			if var_6_3 == var_6_0 then
				if var_6_1 - var_6_4 == -1 then
					var_6_5 = var_0_2.MoveDir.LEFT
				elseif var_6_1 - var_6_4 == 1 then
					var_6_5 = var_0_2.MoveDir.RIGHT
				end
			elseif var_6_4 == var_6_1 then
				if var_6_0 - var_6_3 == -1 then
					var_6_5 = var_0_2.MoveDir.UP
				elseif var_6_0 - var_6_3 == 1 then
					var_6_5 = var_0_2.MoveDir.DOWN
				end
			end

			if var_6_5 == var_0_2.MoveDir.NONE then
				self._choseRowCol = {
					row = var_6_0,
					col = var_6_1
				}
...
function WaitGameContainerComp:_moveStone(arg_7_1)
	local var_7_0, var_7_1 = self:_posToRowCol(self._preTouchPos)
	local var_7_2 = var_0_2.MoveDir.NONE

	if math.abs(arg_7_1.x - self._preTouchPos.x) >= math.abs(arg_7_1.y - self._preTouchPos.y) then
		if arg_7_1.x - self._preTouchPos.x > var_0_2.TOUCH_MOVE and var_7_1 < self._col then
			var_7_2 = var_0_2.MoveDir.RIGHT
		elseif arg_7_1.x - self._preTouchPos.x < -var_0_2.TOUCH_MOVE and var_7_1 > 1 then
			var_7_2 = var_0_2.MoveDir.LEFT
		end
	elseif arg_7_1.y - self._preTouchPos.y > var_0_2.TOUCH_MOVE and var_7_0 < self._row then
		var_7_2 = var_0_2.MoveDir.DOWN
	elseif arg_7_1.y - self._preTouchPos.y < -var_0_2.TOUCH_MOVE and var_7_0 > 1 then
		var_7_2 = var_0_2.MoveDir.UP
	end

	if var_7_2 ~= var_0_2.MoveDir.NONE then
		self._choseRowCol = nil
		self._inTouch = false
...
function WaitGameContainerComp:_unTouchStone(arg_8_1)
	if not arg_8_1 then
		return
	end
...
function WaitGameContainerComp:_initGemBgCell()
	local var_9_0 = WaitGameCompPool.new("GemBgCellPool")
	...
	for iter_9_4 = 1, self._row do
		...
		for iter_9_5 = 1, self._col do
			...
			if not var_9_1 then
				var_9_1 = fgui.UIPackage:createObject(var_0_2.PKG_NAME, "WaitGameBgCell")
...
function WaitGameContainerComp:onStartGame()
...
function WaitGameContainerComp:onGameOver()
	self._playing = false
...
function WaitGameContainerComp:_addGemCell(arg_12_1)
	for iter_12_0, iter_12_1 in ipairs(arg_12_1) do
		local var_12_0 = self._gemCellPool:get()

		if not var_12_0 then
			var_12_0 = fgui.UIPackage:createObject(var_0_2.PKG_NAME, "WaitGameCell")
...
function WaitGameContainerComp:_verticalMoveAni(arg_13_1, arg_13_2)
	self._moving = true
...
function WaitGameContainerComp:_doMove(arg_15_1, arg_15_2, arg_15_3)
	local var_15_0 = arg_15_1
	local var_15_1 = arg_15_2

	if arg_15_3 == var_0_2.MoveDir.UP then
		var_15_0 = var_15_0 - 1
	elseif arg_15_3 == var_0_2.MoveDir.DOWN then
		var_15_0 = var_15_0 + 1
	else
		var_15_1 = arg_15_3 == var_0_2.MoveDir.LEFT and var_15_1 - 1 or var_15_1 + 1
	end
...
function WaitGameContainerComp:_exchangeGemCell(arg_17_1, arg_17_2, arg_17_3)
	self._moving = true
	...
	if arg_17_2 then
		var_0_1:playSound(var_0_0.Sound.GEM_ELI_SWITCH_BACK)
	else
		var_0_1:playSound(var_0_0.Sound.GEM_ELI_SWITCH)
	end
end

function WaitGameContainerComp:_removeAllGem()
...
function WaitGameContainerComp:_rowColToPos(arg_20_1, arg_20_2)
	return cc.p((var_0_2.GRID_WIDTH + var_0_2.GRID_SPACE) * (arg_20_2 - 1), (var_0_2.GRID_WIDTH + var_0_2.GRID_SPACE) * (arg_20_1 - 1))
end

function WaitGameContainerComp:_posToRowCol(arg_21_1)
	return math.floor(arg_21_1.y / (var_0_2.GRID_WIDTH + var_0_2.GRID_SPACE)) + 1, math.floor(arg_21_1.x / (var_0_2.GRID_WIDTH + var_0_2.GRID_SPACE)) + 1
end

function WaitGameContainerComp:_getGemColor(arg_22_1, arg_22_2)
	...
	return var_0_2.INVALID_GEM_COLOR
end

function WaitGameContainerComp:_fillEmptySpace()
	local var_23_0 = {}
	local var_23_1 = {}
...
function WaitGameContainerComp:_eliSameGem(arg_24_1)
	...
	if #arg_24_1 == 0 then
		...
		var_0_1:playSound(var_0_0.Sound.GEM_ELI_ELIMINATE)
	end
end

function WaitGameContainerComp:_eliGemWithRowCol(arg_26_1, arg_26_2)
...
function WaitGameContainerComp:_getEliIdx2DArr()
	self._removeMarkArr = {}

	local var_27_0 = {}

	for iter_27_0 = 1, self._row do
		for iter_27_1, iter_27_2 in ipairs((self:_getGemIdx2DArrHorSameColor(iter_27_0, var_0_2.MIN_ELI_NUM))) do
			table.insertto(var_27_0, iter_27_2)
		end
	end

	for iter_27_3 = 1, self._col do
		for iter_27_4, iter_27_5 in ipairs((self:_getGemIdx2DArrVerSameColor(iter_27_3, var_0_2.MIN_ELI_NUM))) do
...
function WaitGameContainerComp:_getGemIdx2DArrHorSameColor(arg_28_1, arg_28_2)
	local var_28_0 = {}
	...
	for iter_28_0 = 1, self._col do
		...
		if iter_28_0 == self._col then
			if self._gemCellDict[arg_28_1][iter_28_0] and self._gemCellDict[arg_28_1][iter_28_0]:getGemColor() == var_0_2.INVALID_GEM_COLOR then
		...
		elseif self._gemCellDict[arg_28_1][iter_28_0] then
			...
			if var_28_3 ~= var_0_2.INVALID_GEM_COLOR then
				var_28_1(arg_28_1, var_28_2, iter_28_0)
			...
			var_28_2 = iter_28_0
			var_28_4 = var_0_2.INVALID_GEM_COLOR
		end
	end
...
function WaitGameContainerComp:_getGemIdx2DArrVerSameColor(arg_30_1, arg_30_2)
	local var_30_0 = {}
	...
	for iter_30_0 = 1, self._row do
		...
		if iter_30_0 == self._row then
			if self._gemCellDict[iter_30_0][arg_30_1] and self._gemCellDict[iter_30_0][arg_30_1]:getGemColor() == var_0_2.INVALID_GEM_COLOR then
		...
		elseif self._gemCellDict[iter_30_0][arg_30_1] then
			...
			if var_30_3 ~= var_0_2.INVALID_GEM_COLOR then
				var_30_1(arg_30_1, var_30_2, iter_30_0)
			...
			var_30_2 = iter_30_0
			var_30_4 = var_0_2.INVALID_GEM_COLOR
		end
	end
...
function WaitGameContainerComp:_divideGroup(arg_32_1, arg_32_2, arg_32_3)
...
function WaitGameContainerComp:getOneRandomGemColor()
	return self._gemColorArr[math.random(self._colorNum)] or self._gemColorArr[1]
end

function WaitGameContainerComp:getExceptRandomGemColor(arg_34_1)
...
function WaitGameContainerComp:_getEnterAniList()
	local var_35_0 = {}
	local var_35_1 = {}
...
function WaitGameContainerComp:_indexToRowCol(arg_36_1)
	local var_36_0 = 1
	local var_36_1 = 1
...
function WaitGameContainerComp:_rowColToIndex(arg_37_1, arg_37_2)
...
function WaitGameContainerComp:_getTouchRect(arg_38_1, arg_38_2)
	return cc.rect(var_0_2.GRID_SPACE, var_0_2.GRID_SPACE, var_0_2.GRID_WIDTH * arg_38_2 + var_0_2.GRID_SPACE * (arg_38_2 - 1), var_0_2.GRID_WIDTH * arg_38_1 + var_0_2.GRID_SPACE * (arg_38_1 - 1))
end

function WaitGameContainerComp:_resetGemCells()
	self:_removeAllGem()
	...
	for iter_40_0 = 1, self._row do
		for iter_40_1 = 1, self._col do
			...
			if var_40_0 ~= var_0_2.INVALID_GEM_COLOR then
				...
				if iter_40_0 <= self._row - var_0_2.MIN_ELI_NUM + 1 then
					local var_40_3 = self:_getGemColor(iter_40_0 + 1, iter_40_1)
					local var_40_4 = self:_getGemColor(iter_40_0 + 2, iter_40_1)

					if var_40_3 ~= var_0_2.INVALID_GEM_COLOR and var_40_4 ~= var_0_2.INVALID_GEM_COLOR then
...
function WaitGameContainerComp:_isThereSameColorAround(arg_41_1, arg_41_2, arg_41_3, arg_41_4)
	if self:_getGemColor(arg_41_2, arg_41_3) == arg_41_1 then
		return true
	end

	for iter_41_0, iter_41_1 in ipairs(arg_41_4) do
		local var_41_0 = var_0_2.INVALID_GEM_COLOR

		if iter_41_1 == var_0_2.MoveDir.UP then
			var_41_0 = self:_getGemColor(arg_41_2 - 1, arg_41_3)
		elseif iter_41_1 == var_0_2.MoveDir.DOWN then
			var_41_0 = self:_getGemColor(arg_41_2 + 1, arg_41_3)
		elseif iter_41_1 == var_0_2.MoveDir.LEFT then
			var_41_0 = self:_getGemColor(arg_41_2, arg_41_3 - 1)
		elseif iter_41_1 == var_0_2.MoveDir.RIGHT then
			var_41_0 = self:_getGemColor(arg_41_2, arg_41_3 + 1)
		end
...
function WaitGameContainerComp:_getRandomColorArr(arg_42_1, arg_42_2)
	local var_42_0 = {}
	local var_42_1 = var_0_3.match("res_group", arg_42_1)
