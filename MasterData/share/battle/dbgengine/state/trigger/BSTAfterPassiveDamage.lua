...
local BSTAfterPassiveDamage, Super = System.NewClass("BSTAfterPassiveDamage", BattleStateTriggerServer)

function BSTAfterPassiveDamage:OnBeDamage(eventData)
  ...
  if eventData.damageType ~= bc.DamageType.Passive then
    return
  end
