...
function gs_15:OnGridBattleStart(role)
  self:StartCreatGrid()
end

function gs_15:OnArriveAction(x, y)
  return LuaSkillCtrl:CallCreateEfcGrid(x, y, 15)
end

function gs_15:StartCreatGrid()
...
function gs_15:OnFindEmptyGridAndSetEfc()
...
function gs_15:OnGridEnterRole(role)
...
function gs_15:OnGridBattleEnd(role)
  self.growGrid = nil
  base.OnGridBattleEnd(self, role)
end

function gs_15:LuaDispose()
  self.growGrid = nil
...
function gs_15:OnGridBeCorvered(role)
  self.growGrid = nil
  if self.timer ~= nil then
    self.timer:Stop()
    self.timer = nil
...
function gs_15:OnGridUncorver(role)
  if role ~= nil then
