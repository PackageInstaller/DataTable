...
local bs_2123000 = class("bs_2123000", bs_1)
local base = bs_1
bs_2123000.config = {
  action1 = 1001,
  action2 = 1001,
...
bs_2123000.config = setmetatable(bs_2123000.config, {
  __index = base.config
})

function bs_2123000:ctor()
end

function bs_2123000:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_2123000_1", 1, self.OnAfterBattleStart)
  self.totalTime = 1800
...
function bs_2123000:RealPlaySkill(target, data)
...
function bs_2123000:OnAttackTrigger(target, data, atkSpeedRatio, atkActionId, atkTriggerFrame)
...
function bs_2123000:OnAttackTrigger2(target, data, atkSpeedRatio, atkActionId, atkTriggerFrame)
  if data.audioId3 ~= nil then
    LuaSkillCtrl:PlayAuSource(self.caster, data.audioId3)
  end
  if LuaSkillCtrl:IsAbleAttackTarget(self.caster, target, self.caster.attackRange, true) then
...
function bs_2123000:CalcAtkActionSpeed2(atkInterval, atkId)
...
function bs_2123000:GetTotalAtkActionFrames2(atkId)
...
function bs_2123000:GetAtkTriggerFrame2(atkId, atkInterval)
  local srcId = self.caster.resSrcId
  if srcId == 0 then
    return 0
  end
...
function bs_2123000:OnCasterDie()
