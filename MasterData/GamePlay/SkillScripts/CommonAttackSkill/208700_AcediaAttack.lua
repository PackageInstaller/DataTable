...
bs_208700.config = setmetatable(bs_208700.config, {
  __index = base.config
})

function bs_208700:ctor()
end

function bs_208700:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_208700:RealPlaySkill(target, data)
...
function bs_208700:OnAttackTrigger(target, data, atkSpeedRatio, atkActionId, atkTriggerFrame, roll_attack)
  if roll_attack then
...
function bs_208700:OnCasterDie()
