...
bs_2109000.config = setmetatable(bs_2109000.config, {
  __index = base.config
})

function bs_2109000:ctor()
end

function bs_2109000:InitSkill(isMidwaySkill)
...
function bs_2109000:PlaySkill(passdata)
...
function bs_2109000:OnAttackTrigger11(target)
...
function bs_2109000:OnBreakSkill(role)
...
function bs_2109000:OnCasterDie()
...
function bs_2109000:LuaDispose()
