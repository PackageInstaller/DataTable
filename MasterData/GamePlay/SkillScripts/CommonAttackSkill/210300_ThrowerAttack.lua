...
local bs_210300 = class("bs_210300", bs_1)
local base = bs_1
bs_210300.config = {
  effectId_trail = 210302,
  effectId_start1 = 210300,
  effectId_start2 = 210301,
  effectId_skill = 210305,
  aoe = {
    effect_shape = 3,
    aoe_select_code = 5,
    aoe_range = 1
  ...
  effectId_start1_skill = 210309,
  effectId_start2_skill = 210309,
  audioId1 = 369,
  audioId2 = 371
}
bs_210300.config = setmetatable(bs_210300.config, {
  __index = base.config
})

function bs_210300:ctor()
end

function bs_210300:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_210300:RealPlaySkill(target, data)
...
function bs_210300:OnAttackTrigger(target, data, atkSpeedRatio, atkActionId)
  if self.caster.recordTable.attack == 1 then
...
function bs_210300:SkillEventFunc(configData, effect, eventId, target)
  if eventId == eBattleEffectEvent.Trigger then
    ...
    if self.caster.recordTable.attack == 2 then
      local arg = self.caster.recordTable.arg2
    end
...
function bs_210300:OnCasterDie()
