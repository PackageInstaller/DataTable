...
bs_2094000.config = setmetatable(bs_2094000.config, {
  __index = base.config
})

function bs_2094000:ctor()
end

function bs_2094000:InitSkill(isMidwaySkill)
...
function bs_2094000:OnCasterDie()
