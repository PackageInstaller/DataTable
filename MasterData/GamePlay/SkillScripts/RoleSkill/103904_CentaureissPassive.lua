...
bs_103904.config = {
  ...
  HurtConfig = 2,
  effectId_hit = 103907,
  buff_resistance = 103902
}

function bs_103904:ctor()
end

function bs_103904:InitSkill(isMidwaySkill)
...
function bs_103904:OnAfterHurt(sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
function bs_103904:OnAfterAddBuff(buff, target)
...
function bs_103904:OnCasterDie()
