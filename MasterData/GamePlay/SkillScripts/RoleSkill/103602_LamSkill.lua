...
function bs_103602:ctor()
end

function bs_103602:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_103602:PlaySkill(data)
...
function bs_103602:OnAttackTrigger(target, data)
...
function bs_103602:OnCallback(num, target, data)
...
function bs_103602:OnCasterDie()
