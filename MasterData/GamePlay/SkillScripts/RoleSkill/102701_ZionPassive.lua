...
function bs_102701:ctor()
end

function bs_102701:InitSkill(isMidwaySkill)
...
function bs_102701:OnAfterHurt(sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
function bs_102701:OnSetHurt(context)
...
function bs_102701:OnCasterDie()
