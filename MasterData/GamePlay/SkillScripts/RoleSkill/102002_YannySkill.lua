...
function bs_102002:InitSkill(isMidwaySkill)
...
function bs_102002:BindHookObj()
...
function bs_102002:OnBattleStart()
  if LuaSkillCtrl.IsInTDBattle and LuaSkillCtrl.cluaSkillCtrl ~= nil then
    return
  end
  self:PlaySkill()
...
function bs_102002:PlaySkill(data)
...
function bs_102002:OnFlyHook(targetPos, time)
...
function bs_102002:OnHooKGetRole(role, backGrid, duration)
...
function bs_102002:OnHookEnd(targetRole)
...
function bs_102002:ResetActionState()
...
function bs_102002:DisAbleToHook()
  return self.caster.recordTable.completedFirstHook
end

function bs_102002:OnCasterDie()
...
function bs_102002:BeforeEndBattle()
  self:ResetActionState()
end

function bs_102002:OnSkillRemove()
  self.weaponChildren = nil
  self.weaponRoot = nil
  self.casterRoot = nil
  self:ResetActionState()
...
function bs_102002:OnBreakSkill(role)
  self:ResetActionState()
  if self.targetRole ~= nil then
...
function bs_102002:OnRoleDie(killer, role)
