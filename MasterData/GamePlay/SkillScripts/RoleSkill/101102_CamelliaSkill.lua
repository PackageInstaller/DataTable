...
function bs_101102:ctor()
end

function bs_101102:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.BeforeBattleEnd, "bs_101102_3", 1, self.BeforeEndBattle)
end

function bs_101102:PlaySkill(data)
...
function bs_101102:OnAttackTrigger(data)
...
function bs_101102:BeforeEndBattle()
  if self.loopaudio ~= nil then
    LuaSkillCtrl:StopAudioByBack(self.loopaudio)
    self.loopaudio = nil
  end
...
function bs_101102:OnBreakSkill(role)
...
function bs_101102:OnCasterDie()
