...
function bs_101502:ctor()
end

function bs_101502:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_101502:PlaySkill(data)
...
function bs_101502:OnAttackTrigger(data)
...
function bs_101502:SkillEventFunc(effect, eventId, target)
...
function bs_101502:OnBreakSkill(role)
...
function bs_101502:OnCasterDie()
