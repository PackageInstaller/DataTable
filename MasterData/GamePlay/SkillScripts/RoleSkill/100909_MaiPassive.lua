local bs_100909 = class("bs_100909", LuaSkillBase)
...
function bs_100909:ctor()
end

function bs_100909:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddAfterAddBuffTrigger("bs_100909_03", 1, self.OnAfterAddBuff, nil, nil, nil, nil, self.config.buffIdAwake)
  self.MapBorder = LuaSkillCtrl:GetMapBorder()
end

function bs_100909:OnAfterAddBuff(buff)
...
function bs_100909:OnCasterDie()
