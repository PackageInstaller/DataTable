...
function bs_103202:ctor()
end

function bs_103202:InitSkill(isMidwaySkill)
...
function bs_103202:PlaySkill(data)
...
function bs_103202:OnActionCallBack()
  ...
  LuaSkillCtrl:StartTimer(nil, self.arglist[2] + 6 + self.arglist[1] * 5, function()
    self:OnSkillDamageEnd()
  end)
end

function bs_103202:OnEffectTrigger(time, effect, eventId, target)
...
function bs_103202:OnCollisionEnter(time, target, collider, index, entity)
...
function bs_103202:OnCasterDie()
