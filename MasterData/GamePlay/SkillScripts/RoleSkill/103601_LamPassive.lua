...
bs_103601.config = {weaponLv = 0}

function bs_103601:ctor()
end

function bs_103601:InitSkill(isMidwaySkill)
...
function bs_103601:OnCasterAttributeChange()
...
function bs_103601:OnCasterDie()
