...
function bs_102602:ctor()
end

function bs_102602:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_102602:PlaySkill(data)
...
function bs_102602:OnAttackTrigger()
  ...
  if LuaSkillCtrl:GetCasterSkinId(self.caster) ~= 302606 then
    ...
    LuaSkillCtrl:CallBuff(self, self.caster, self.config.buffId_23202, 1, self.arglist[1])
  end
...
function bs_102602:Onskillheal()
...
function bs_102602:OnBreakSkill(role)
...
function bs_102602:OnCasterDie()
