...
function bs_104302:ctor()
end

function bs_104302:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self.TargetCount = 0
end

function bs_104302:PlaySkill(data)
...
function bs_104302:OnAttackTrigger(selectTarget, selectTargetPos)
...
function bs_104302:OnColliderEnter(forwardDir, selectTargetPos, collider, index, entity)
  local angle = 0
  ...
  if 0 < entity.intensity and entity.attackRange > self.arglist[3] and entity.belongNum == eBattleRoleBelong.enemy and entity.recordTable.Demiurge ~= true then
...
function bs_104302:OnCasterDie()
