...
function bs_101604:ctor()
end

function bs_101604:InitSkill(isMidwaySkill)
...
function bs_101604:OnAfterHurt(sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
function bs_101604:OnAfterPlaySkill(skill, role)
  if role == self.caster and skill.isNormalSkill then
    LuaSkillCtrl:CallBuff(self, self.caster, self.config.buffId_speed, 1)
  end
end

function bs_101604:OnBuffDie(buff, target, removeType)
...
function bs_101604:OnCollisionEnter(collider, index, entity)
...
function bs_101604:OnCasterDie()
  base.OnCasterDie(self)
end

function bs_101604:LuaDispose()
