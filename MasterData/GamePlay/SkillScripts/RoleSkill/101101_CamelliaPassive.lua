...
function bs_101101:ctor()
end

function bs_101101:InitSkill(isMidwaySkill)
  self.timeattack = 0
  self.time = 0
...
function bs_101101:OnAfterPlaySkill(skill, role)
...
function bs_101101:OnCasterAttributeChange()
...
function bs_101101:OnCasterDie()
