...
function bs_100302:ctor()
end

function bs_100302:InitSkill(isMidwaySkill)
...
function bs_100302:PlaySkill(data)
...
function bs_100302:OnAttackTrigger(target)
...
function bs_100302:OnAfterAddBuff(buff, target)
...
function bs_100302:OnBeforBuffDispel(target, context)
...
function bs_100302:OnCasterDie()
