...
bs_100102.config = {
  ...
  effectId_line = 100105,
  effectId_trail = 100106,
  effectId_hit = 100107,
  selectId = 24,
  selectRange = 10,
  skill_time = 12,
...
function bs_100102:ctor()
end

function bs_100102:InitSkill(isMidwaySkill)
end

function bs_100102:PlaySkill(data)
...
function bs_100102:OnAttackTrigger(target, data)
  self:RealPlaySkill(nil, target, 1)
end

function bs_100102:RealPlaySkill(sender, target, healId)
  if sender == nil then
...
function bs_100102:SkillEventFunc(healId, effect, eventId, target)
