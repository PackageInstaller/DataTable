...
function bs_1066:ctor()
end

function bs_1066:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddAfterHurtTrigger("bs_1066_2", 1, self.OnAfterHurt, self.caster)
end

function bs_1066:OnAfterHurt(sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
