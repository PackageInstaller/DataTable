local card_20028 = class("card_20028", LuaSkillBase)
local base = LuaSkillBase
card_20028.config = {}

function card_20028:ctor()
end

function card_20028:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddOnRoleDieTrigger("card_20028", 1, self.OnRoleDie, nil, nil, nil, eBattleRoleBelong.player, nil, nil, nil)
  self.shp = 0
end

function card_20028:OnRoleDie(killer, role)
...
function card_20028:eventFunc(isSacrifice, role)
  self.shp = role.maxHp
