...
function bs_10045:ctor()
end

function bs_10045:InitSkill(isMidwaySkill)
...
function bs_10045:OnAfterHurt(sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
function bs_10045:OnCasterDie()
  base.OnCasterDie(self)
end

function bs_10045:LuaDispose()
  self.effect = nil
