local bs_70051 = class("bs_70051", LuaSkillBase)
local base = LuaSkillBase
bs_70051.config = {timeDuration = 15, buffId = 1283}

function bs_70051:ctor()
end

function bs_70051:InitSkill(isMidwaySkill)
  ...
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_70051_1", 1, self.OnAfterBattleStart)
end

function bs_70051:OnAfterBattleStart()
  LuaSkillCtrl:CallBuff(self, self.caster, self.config.buffId, 1, nil, true)
end

function bs_70051:OnArriveAction()
...
function bs_70051:TimeUp()
  LuaSkillCtrl:BattleFailButContionueEP()
end

function bs_70051:PlaySkill(data)
end

function bs_70051:OnCasterDie()
