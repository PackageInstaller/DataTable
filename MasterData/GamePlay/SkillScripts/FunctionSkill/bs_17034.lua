local bs_17034 = class("bs_17034", LuaSkillBase)
...
function bs_17034:ctor()
end

function bs_17034:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddOnRoleDieTrigger("bs_17034_1", 1, self.OnRoleDie, nil, nil, nil, eBattleRoleBelong.enemy)
  self.typenum = 1
end

function bs_17034:OnRoleDie(killer, role, killSkill)
...
function bs_17034:SkillEventFunc(effect, eventId, target)
