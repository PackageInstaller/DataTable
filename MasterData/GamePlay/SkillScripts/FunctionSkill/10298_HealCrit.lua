...
function bs_10298:ctor()
end

function bs_10298:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddAfterHealTrigger("bs_10298_5", 1, self.OnAfterHeal, self.caster)
end

function bs_10298:OnAfterHeal(sender, target, skill, heal, isStealHeal, isCrit, isTriggerSet)
