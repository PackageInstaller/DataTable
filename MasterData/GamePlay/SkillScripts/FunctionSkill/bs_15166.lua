local bs_15166 = class("bs_15166", LuaSkillBase)
local base = LuaSkillBase
bs_15166.config = {effect = 12095, buffId_1 = 2137}

function bs_15166:ctor()
end

function bs_15166:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_15166", 1, self.AfterBattleStart)
  self.grid = nil
  self.timer = nil
end

function bs_15166:AfterBattleStart()
...
function bs_15166:checkLocation()
