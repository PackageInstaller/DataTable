local bs_17064 = class("bs_17064", LuaSkillBase)
...
function bs_17064:ctor()
end

function bs_17064:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_17064_1", 1, self.OnAfterBattleStart)
  self:AddOnRoleDieTrigger("bs_17064_2", 1, self.OnRoleDie, nil, nil, nil, self.caster.belongNum)
...
function bs_17064:OnRoleDie(killer, role)
...
function bs_17064:CallSelectExecute(role)
  if role == nil then
    return
  end
