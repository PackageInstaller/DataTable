local bs_17045 = class("bs_17045", LuaSkillBase)
...
function bs_17045:ctor()
end

function bs_17045:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddOnRoleDieTrigger("bs_17045_1", 1, self.OnRoleDie, nil, nil, nil, eBattleRoleBelong.enemy)
  self.typenum = 3
end

function bs_17045:OnRoleDie(killer, role, killSkill)
  if role.belongNum == eBattleRoleBelong.enemy and LuaSkillCtrl:CallRange(1, 1000) <= self.arglist[3] then
    LuaSkillCtrl:CallEffect(role, self.config.effectdoorId, self, nil, role)
...
function bs_17045:SkillEventFunc(effect, eventId, target)
