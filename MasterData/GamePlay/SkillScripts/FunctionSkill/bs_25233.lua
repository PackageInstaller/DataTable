local bs_25233 = class("bs_25233", LuaSkillBase)
local base = LuaSkillBase
bs_25233.config = {buffId = 2117, buffId1 = 2127}

function bs_25233:ctor()
end

function bs_25233:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddLuaTrigger(eSkillLuaTrigger.OnRealSummonerCaster, self.OnRealSummonerCaster)
  self:AddOnRoleDieTrigger("bs_25233_2", 2, self.ReCallBuff)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_25233_1", 1, self.ReCallBuff)
end

function bs_25233:OnRealSummonerCaster(role)
