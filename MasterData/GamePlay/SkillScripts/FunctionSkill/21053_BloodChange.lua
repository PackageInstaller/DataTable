local bs_21053 = class("bs_21053", LuaSkillBase)
local base = LuaSkillBase
bs_21053.config = {}

function bs_21053:ctor()
end

function bs_21053:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_21053_1", 1, self.OnAfterBattleStart)
  self.Timer = nil
end

function bs_21053:OnAfterBattleStart()
