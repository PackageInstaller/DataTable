...
function bs_1017022:ctor()
end

function bs_1017022:InitSkill(isMidwaySkill)
...
function bs_1017022:PlaySkill(data)
...
function bs_1017022:SetBookActive(index)
...
function bs_1017022:SetBookDisActive(index)
  local bookArray = self.caster.recordTable.books
  if bookArray == nil then
    return
  end
...
function bs_1017022:OnAttackTrigger(target)
...
function bs_1017022:End(target)
...
function bs_1017022:OnSkillRemove()
  base.OnSkillRemove(self)
end

function bs_1017022:OnCasterDie()
  base.OnCasterDie(self)
end

function bs_1017022:LuaDispose()
