...
bs_1043012.config = {
  buff_ReduceDef = 10430101,
  buff_IncreaseDef = 10430201,
  buff_ReduceMagicRes = 10430301,
  buff_IncreaseMagicRes = 10430401,
  effectId_Suck = 104307
}

function bs_1043012:ctor()
end

function bs_1043012:InitSkill(isMidwaySkill)
...
function bs_1043012:OnSetHurt(context)
...
function bs_1043012:OnBuffDie(buff, target, removeType)
...
function bs_1043012:OnAfterPlaySkill(skill, role)
...
function bs_1043012:OnCasterDie()
  base.OnCasterDie(self)
end

function bs_1043012:LuaDispose()
