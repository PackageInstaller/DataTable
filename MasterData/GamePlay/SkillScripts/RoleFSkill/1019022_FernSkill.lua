...
function bs_1019022:ctor()
end

function bs_1019022:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_1019022:PlaySkill(data)
...
function bs_1019022:OnAttackTrigger(target)
...
function bs_1019022:SkillEventFunc(effect, eventId, target)
...
function bs_1019022:OnCasterDie()
