...
bs_1033022.config = {
  ...
  selectId_skill = 45,
  buffId_tab = 10330201,
  effectId_start = 103305,
  audioId1 = 103304,
  buffId_170 = 170
}

function bs_1033022:ctor()
end

function bs_1033022:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_1033022:PlaySkill(data)
...
function bs_1033022:OnActionCallBack(targetList)
...
function bs_1033022:OnBreakSkill(role)
...
function bs_1033022:OnCasterDie()
