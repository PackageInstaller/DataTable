local bs_1035022 = class("bs_1035022", LuaSkillBase)
...
function bs_1035022:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.BuffDie, "bs_1035022_buffDie", 1, self.OnBuffDie)
end

function bs_1035022:PlaySkill(data)
...
function bs_1035022:ActionCallBack(targets)
...
function bs_1035022:CheckCasterAliveAndRemoveTrigger()
  self.__checkBuffAlive = true
...
function bs_1035022:OnBuffDie(buff, target, removeType)
...
function bs_1035022:OnCasterDie()
