...
function bs_1016012:ctor()
end

function bs_1016012:InitSkill(isMidwaySkill)
...
function bs_1016012:OnAfterHurt(sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
function bs_1016012:OnBuffDie(buff, target, removeType)
...
function bs_1016012:OnCollisionEnter(collider, index, entity)
...
function bs_1016012:OnCasterDie()
