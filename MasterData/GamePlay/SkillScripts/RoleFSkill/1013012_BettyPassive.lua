...
function bs_1013012:ctor()
end

function bs_1013012:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddAfterHurtTrigger("bs_1013012_3", 1, self.OnAfterHurt, self.caster)
end

function bs_1013012:OnAfterHurt(sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
function bs_1013012:OnCasterDie()
