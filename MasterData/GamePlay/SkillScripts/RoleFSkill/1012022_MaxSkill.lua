...
function bs_1012022:ctor()
end

function bs_1012022:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_1012022:PlaySkill(data)
...
function bs_1012022:OnActionCallBack(target, grid)
...
function bs_1012022:RealPlaySkill(ballSkillData, skillEmission)
...
function bs_1012022:PlaySkillEnd(ballSkillData, skillEmission)
  self:KillEffectBall(ballSkillData.effectBall)
  skillEmission:EndAndDisposeEmission()
end

function bs_1012022:KillEffectBall(effectBall)
...
function bs_1012022:OnCollision(ballSkillData, collider, index, entity)
...
function bs_1012022:OnRemoveArrive(ballSkillData, collider, entity)
...
function bs_1012022:OnEmissionArrive(skillEmission)
...
function bs_1012022:OnCasterDie()
