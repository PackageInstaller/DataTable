local bs_1023022 = class("bs_1023022", LuaSkillBase)
...
bs_1023022.config = {
  ...
  action1 = 1002,
  buffId_willowpic = 10290101,
  buffId_Defup = 10230101,
  actionId = 1002,
  action_speed = 1,
  skill_time = 15,
  start_time = 14,
...
function bs_1023022:ctor()
end

function bs_1023022:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self.effect = {}
  self.realTarget = nil
end

function bs_1023022:PlaySkill(data)
...
function bs_1023022:OnAttackTrigger(target)
  LuaSkillCtrl:CallEffectWithArg(target, self.config.effectId_LineEnd, self, false, false, self.SkillEventFunc, target)
end

function bs_1023022:SkillEventFunc(target_role, effect, eventId, target)
...
function bs_1023022:OnCasterDie()
