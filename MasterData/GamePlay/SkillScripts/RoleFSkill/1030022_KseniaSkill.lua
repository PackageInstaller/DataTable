...
function bs_1030022:ctor()
end

function bs_1030022:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_1030022:PlaySkill(data)
...
function bs_1030022:OnActionCallBack(role)
  LuaSkillCtrl:CallEffect(role, self.config.effectId_trail, self, self.OnEffectTrigger)
end

function bs_1030022:OnEffectTrigger(effect, eventId, target)
...
function bs_1030022:OnCasterDie()
