local bs_1040022 = class("bs_1040022", LuaSkillBase)
...
function bs_1040022:ctor()
end

function bs_1040022:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self.caster.recordTable.skill_open = false
end

function bs_1040022:PlaySkill(data)
...
function bs_1040022:OnAttackTrigger()
...
function bs_1040022:SkillEventFunc(effect, eventId, target)
...
function bs_1040022:OnBreakSkill(role)
...
function bs_1040022:OnCasterDie()
