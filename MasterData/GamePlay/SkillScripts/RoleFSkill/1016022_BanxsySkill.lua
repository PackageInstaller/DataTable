local bs_1016022 = class("bs_1016022", LuaSkillBase)
local base = LuaSkillBase
bs_1016022.config = {
  buffId_Paint = 10160101,
  buffId_170 = 170,
  superBuffId = 27101,
  effectId = 101604,
  aoe_config = {
...
function bs_1016022:ctor()
end

function bs_1016022:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self.caster.recordTable.arg2 = self.arglist[2]
end

function bs_1016022:PlaySkill(data)
...
function bs_1016022:realRlaySkill(realTargetRole)
...
function bs_1016022:OnAttackTrigger(target)
  LuaSkillCtrl:CallEffect(target, self.config.effectId, self, self.SkillEventFunc)
end

function bs_1016022:CheckAndGetTargetRole()
...
function bs_1016022:AnalysisSelectRoles(realTargetRole, roles)
...
function bs_1016022:PhaseMove(realTargetRole)
...
function bs_1016022:SkillEventFunc(effect, eventId, target)
...
function bs_1016022:OnCasterDie()
