...
function bs_999999:ctor()
end

function bs_999999:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.BeforeBattleEnd, "bs_999999", 1, self.BeforeEndBattle)
end

function bs_999999:CallBack()
...
function bs_999999:PlaySkill(data)
...
function bs_999999:BeforeEndBattle()
end

function bs_999999:OnCasterDie()
  LuaSkillCtrl:DispelBuff(self.caster, self.config.buffID_1158, 0)
...
function bs_999999:OnBreakSkill(role)
  if self.effect ~= nil then
    self.effect:Die()
    self.effect = nil
  end
