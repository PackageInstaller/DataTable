...
function bs_300001:ctor()
end

function bs_300001:InitSkill(isMidwaySkill)
...
function bs_300001:OnAfterHurt(sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
function bs_300001:OnBeforePlaySkill(role, context)
...
function bs_300001:OnAttackTrigger(target)
  self.skillCount = 1
...
function bs_300001:OnCasterDie()
  base.OnCasterDie(self)
end

function bs_300001:LuaDispose()
