...
function bs_60002:ctor()
end

function bs_60002:InitSkill(isMidwaySkill)
...
function bs_60002:OnAfterBattleStart()
...
function bs_60002:OnAfterAddBuff(buff, target)
