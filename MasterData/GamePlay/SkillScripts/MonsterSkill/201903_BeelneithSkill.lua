...
function bs_201903:ctor()
end

function bs_201903:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_201903:PlaySkill(data)
  self.realTime = 0
  self:RealPlaySkill()
end

function bs_201903:RealPlaySkill()
...
function bs_201903:OnActionCallBack(target)
  ...
  if target == nil or target:IsUnSelect(self.caster) then
...
function bs_201903:OnCollision(collider, index, entity)
...
function bs_201903:OnEmissionArrive(targetgrid, lasttarget, skillEmission)
  self.realTime = self.realTime + 1
  self:OnOver()
end

function bs_201903:OnOver()
  ...
  if self.caster.recordTable["20046_root4arg1"] ~= nil then
    ...
    LuaSkillCtrl:HurtResult(self, skillResult, self.config.hurt_config, {
      self.caster.recordTable["20046_root4arg1"]
    }, false)
...
function bs_201903:OnCasterDie()
