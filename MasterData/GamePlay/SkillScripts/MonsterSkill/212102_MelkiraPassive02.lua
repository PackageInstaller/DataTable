local bs_212102 = class("bs_212102", LuaSkillBase)
...
function bs_212102:ctor()
end

function bs_212102:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddOnRoleDieTrigger("bs_212102_2", 1, self.OnRoleDie, nil, nil, nil, self.caster.belongNum)
  self.table = {}
  self.effectTable = {}
...
function bs_212102:PlaySkill(data)
...
function bs_212102:OnAttackTrigger()
...
function bs_212102:OnRoleDie(killer, role)
...
function bs_212102:OnBreakSkill(role)
...
function bs_212102:EndSkillAndCallNext()
  self.onCastSkill = false
...
function bs_212102:OnCasterDie()
