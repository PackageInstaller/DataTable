local bs_201802 = class("bs_201802", LuaSkillBase)
...
function bs_201802:ctor()
end

function bs_201802:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_201802_1", 1, self.OnAfterBattleStart)
end

function bs_201802:OnAfterBattleStart()
  ...
  self.caster.recordTable["201802_SummonTime"] = 0
  LuaSkillCtrl:CallBuff(self, self.caster, self.config.buffId, 1, nil, true)
end

function bs_201802:CallBack()
...
function bs_201802:OnMoveAttackTrigger(gridData)
...
function bs_201802:CallBack1(x, y)
  ...
  if self.caster.recordTable["201802_SummonTime"] < self.config.maxSummonNum then
  ...
  if 1 < self.caster.hp then
    ...
    self.caster.recordTable["201802_SummonTime"] = self.caster.recordTable["201802_SummonTime"] + 1
  end
end

function bs_201802:OnCasterDie()
