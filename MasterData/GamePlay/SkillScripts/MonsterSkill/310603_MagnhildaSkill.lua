...
bs_310603.config = {
  effectId_attack = 10490302,
  effectId_hit1 = 10490402,
  effectId_hit2 = 10490502,
  effectId_hit3 = 10490602,
...
function bs_310603:ctor()
end

function bs_310603:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.BeforeAddBuff, "bs_310603_7", 1, self.OnBeforeAddBuff)
end

function bs_310603:PlaySkill(data)
...
function bs_310603:OnAttackTrigger(target)
...
function bs_310603:OnBeforeAddBuff(target, context)
...
function bs_310603:OnCasterDie()
  base.OnCasterDie(self)
end

function bs_310603:LuaDispose()
