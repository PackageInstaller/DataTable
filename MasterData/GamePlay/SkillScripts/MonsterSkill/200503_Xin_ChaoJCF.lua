...
function bs_200503:ctor()
end

function bs_200503:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddSetHurtTrigger("bs_200503_1", 100, self.OnSetHurt, nil, self.caster)
end

function bs_200503:PlaySkill(data)
...
function bs_200503:OnSetHurt(context)
...
function bs_200503:OnAttackTrigger(target, data)
...
function bs_200503:OnCasterDie()
  base.OnCasterDie(self)
end

function bs_200503:LuaDispose()
