local bs_50025 = class("bs_50025", LuaSkillBase)
...
function bs_50025:ctor()
end

function bs_50025:InitSkill(isMidwaySkill)
...
function bs_50025:OnArriveAction()
...
function bs_50025:OnSkillRemove()
...
function bs_50025:OnRoleSplash(role, grid)
