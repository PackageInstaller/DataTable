local bs_212801 = class("bs_212801", LuaSkillBase)
...
function bs_212801:ctor()
end

function bs_212801:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_212801", 1, self.OnAfterBattleStart)
end

function bs_212801:OnAfterBattleStart()
...
function bs_212801:OnLoopDamage()
    ...
    if LuaSkillCtrl.IsInBrotatoBattle then
      ...
      if 0 < targetList.Count then
        for i = targetList.Count - 1, 0, -1 do
          ...
          local damage = (self.arglist[2] + flag * self.arglist[3]) * skill_intensity // 1000
...
function bs_212801:OnCasterDie()
