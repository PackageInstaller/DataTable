...
function bs_50013:ctor()
end

function bs_50013:InitSkill(isMidwaySkill)
...
function bs_50013:OnArriveAction()
...
function bs_50013:OnSkillRemove()
...
function bs_50013:OnRoleSplash(role, grid)
