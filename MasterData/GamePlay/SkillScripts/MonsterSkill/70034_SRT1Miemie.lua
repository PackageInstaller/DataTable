...
function bs_70034:ctor()
end

function bs_70034:InitSkill(isMidwaySkill)
...
function bs_70034:OnHpSubCost(curHp, TargetValue)
...
function bs_70034:OnAfterBattleStart()
  self:OnSummon()
end

function bs_70034:OnSummon()
