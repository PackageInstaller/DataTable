local bs_7016 = class("bs_7016", LuaSkillBase)
...
function bs_7016:ctor()
end

function bs_7016:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
  local arriveCallBack = BindCallback(self, self.OnArriveAction)
  self.timer = LuaSkillCtrl:StartTimer(nil, self.arglist[1], arriveCallBack, self, -1)
end

function bs_7016:OnArriveAction()
...
function bs_7016:OnSkillRemove()
