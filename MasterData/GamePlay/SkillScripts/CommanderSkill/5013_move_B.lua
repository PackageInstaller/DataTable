...
function bs_5013:InitSkill(isMidwaySkill)
  base.InitSkill(self, isMidwaySkill)
end

function bs_5013:PlaySkill(data, selectTargetCoord, selectRoles)
...
function bs_5013:CallSelectExecute(role)
