local M = BaseClass("ChapterStarRedPointChecker", require("DataCenter.RedPoint.BaseRedPointChecker"))
...
function M:OnLoadChapter()
    local hasAward = MissionDataMgr:GetInstance():IsRoleChapterStarReward(self.m_chapterId)
