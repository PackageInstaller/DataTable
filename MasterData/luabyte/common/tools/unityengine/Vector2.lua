...
_getter.up 		= function() return setmetatable({x = 0, y = 1}, Vector2) end
_getter.right	= function() return setmetatable({x = 1, y = 0}, Vector2) end
_getter.zero	= function() return setmetatable({x = 0, y = 0}, Vector2) end
_getter.one		= function() return setmetatable({x = 1, y = 1}, Vector2) end
