-- 七日签到
local UISignCtrl = BaseClass("UISignCtrl", BaseUICtrl)
local M = UISignCtrl
local HOURS5 = 18000
...
function M:_RewardAnimCallBack(award)
    local activityLogins = ConfigHelper.GetCfgsByLua("activityLogin", {id=self.m_CurNum, activityId=self.activityId})
