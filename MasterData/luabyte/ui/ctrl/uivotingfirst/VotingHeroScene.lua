local VotingHeroScene = BaseClass("VotingHeroScene", Singleton)
local M = VotingHeroScene
...
function M:_OnLoadComplete(ctrl)
    ...
    -- local cam = CS.MainSceneCameraController.Instance.m_mianCamera
    -- if cam then
...
function M:OnDispose()
    ...
    if self._scene then
        GameUtil.DestroyGo(self._scene.gameObject)
