...
local DormPuzzleShopItemCtrl = BaseClass("DormPuzzleShopItemCtrl", CircularScrollViewItem)
local M = DormPuzzleShopItemCtrl
...
function M:UpdateItem(data)
    ...
    self._view.slip:SetActive(data.canBuyNum > 0)
end
