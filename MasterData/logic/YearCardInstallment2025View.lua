-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/yearcard/view/yearcard2025/main/YearCardInstallment2025View.lua

module("logic.extensions.yearcard.view.yearcard2025.main.YearCardInstallment2025View", package.seeall)

local YearCardInstallment2025View = class("YearCardInstallment2025View", ViewComponent)

function YearCardInstallment2025View:ctor()
	YearCardInstallment2025View.super.ctor(self)
end

function YearCardInstallment2025View:buildUI()
	YearCardInstallment2025View.super.buildUI(self)
...
function YearCardInstallment2025View:bindEvents()
	YearCardInstallment2025View.super.bindEvents(self)
	self._btnClose:AddClickListener(self.close, self)
end

function YearCardInstallment2025View:unbindEvents()
	YearCardInstallment2025View.super.unbindEvents(self)
...
function YearCardInstallment2025View:onEnter()
	YearCardInstallment2025View.super.onEnter(self)
...
function YearCardInstallment2025View:onExit()
	YearCardInstallment2025View.super.onExit(self)
	GlobalDispatcher:removeListener(GlobalNotify.AnnuityInfoChange, self._refreshView, self)
end

function YearCardInstallment2025View:_onClickBuyGift(id)
	YearCardController.instance:payGiftId(self._curActId, id)
end

function YearCardInstallment2025View:_refreshView()
	self:_buildCells()
...
function YearCardInstallment2025View:_getGiftCfgs()
	local list = {}
...
function YearCardInstallment2025View:_getTotalGiftCfg()
	return YearCardConfig.instance:getNewTotalGiftCfg(self._curActId)
end

function YearCardInstallment2025View:_buildCells()
...
return YearCardInstallment2025View
