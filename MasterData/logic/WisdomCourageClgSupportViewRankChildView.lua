-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/commontabrank/view/wisdomcourageclg/WisdomCourageClgSupportViewRankChildView.lua

module("logic.extensions.commontabrank.view.wisdomcourageclg.WisdomCourageClgSupportViewRankChildView", package.seeall)

local WisdomCourageClgSupportViewRankChildView = class("WisdomCourageClgSupportViewRankChildView", ViewComponent)

function WisdomCourageClgSupportViewRankChildView:buildUI()
	WisdomCourageClgSupportViewRankChildView.super.buildUI(self)
...
function WisdomCourageClgSupportViewRankChildView:bindEvents()
	WisdomCourageClgSupportViewRankChildView.super.bindEvents(self)
end

function WisdomCourageClgSupportViewRankChildView:unbindEvents()
	WisdomCourageClgSupportViewRankChildView.super.unbindEvents(self)
end

function WisdomCourageClgSupportViewRankChildView:onEnter()
	WisdomCourageClgSupportViewRankChildView.super.onEnter(self)
	...
	self.addGEvent(self, GlobalNotify.HandlePM_WisdomCourageClgSupportRankInfoRes, self._handleMsgRes, self)
	WisdomCourageClgController.instance:sendPM_WisdomCourageClgSupportRankInfoReq(self._activityId)
end

function WisdomCourageClgSupportViewRankChildView:onExit()
	WisdomCourageClgSupportViewRankChildView.super.onExit(self)
	self._rankScrollList:dispose()
	self._myPrizeScrollList:dispose()
end

function WisdomCourageClgSupportViewRankChildView:_handleMsgRes(msg)
...
function WisdomCourageClgSupportViewRankChildView:_onUpdate()
...
function WisdomCourageClgSupportViewRankChildView:_getPrizesByRank(rank)
	local data = WisdomCourageClgConfig.instance:getSupportRankPrizeData(self._activityId, rank)
...
function WisdomCourageClgSupportViewRankChildView:_updateRankCell(view, cell, info, tag)
	...
	local txtPetNum = goutil.findChildTextComponent(mainGo, "txtPetNum")
	local txtPassStage = goutil.findChildTextComponent(mainGo, "txtPassStage")
	...
	txtPassStage.text = WisdomCourageClgConfig.instance:getSupportMaxStageCount(self._activityId)
...
function WisdomCourageClgSupportViewRankChildView:_clearRankCell(cell)
	local mainGo = cell.gameObject
	local headRoot = goutil.findChild(mainGo, "headRoot")
...
function WisdomCourageClgSupportViewRankChildView:_updateItemCell(view, cell, prizeStr, tag)
	local mainGo = cell.gameObject

	MaterialMgr.setCellByCfg(prizeStr, mainGo)
end

function WisdomCourageClgSupportViewRankChildView:_clearItemCell(cell)
	local mainGo = cell.gameObject

	MaterialMgr.resetAll(mainGo)
end

function WisdomCourageClgSupportViewRankChildView:_updateMyPrizeItemCell(view, cell, prizeStr, tag)
	local mainGo = cell.gameObject

	MaterialMgr.setCellByCfg(prizeStr, mainGo)
end

function WisdomCourageClgSupportViewRankChildView:_clearMyPrizeItemCell(cell)
	local mainGo = cell.gameObject

	MaterialMgr.resetAll(mainGo)
end

return WisdomCourageClgSupportViewRankChildView
