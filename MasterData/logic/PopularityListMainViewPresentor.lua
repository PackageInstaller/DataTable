-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/popularitylist/view/PopularityListMainViewPresentor.lua
...
function PopularityListMainViewPresentor:dependWhatResources()
	return {
		"ui/views/popularitylist/popularitylistmainview.prefab"
	}
end

function PopularityListMainViewPresentor:buildViews()
	return {
		PopularityListMainView.New()
	}
end
