-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xiaonuoassistant/view/cell/AssistCell3.lua

module("logic.extensions.xiaonuoassistant.view.cell.AssistCell3", package.seeall)

local AssistCell3 = class("AssistCell3", BaseAssistCell)

function AssistCell3:ctor(luaComponentContainer)
	AssistCell3.super.ctor(self, luaComponentContainer)
...
function AssistCell3:init(data)
	AssistCell3.super.init(self, data)
...
function AssistCell3:reset()
	self._btn1:RemoveClickListener()
end

function AssistCell3:_selectAll()
	self._data:setCellSelect(self._data.selectIndex1, true)
	self:_setBtnIsOn1(true)
end

function AssistCell3:_cancelAll()
	return
end

function AssistCell3:_onClickBtn1()
...
function AssistCell3:_setBtnIsOn1(isOn)
