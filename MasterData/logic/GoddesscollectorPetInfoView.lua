-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/goddesscollector/view/GoddesscollectorPetInfoView.lua

module("logic.extensions.goddesscollector.view.GoddesscollectorPetInfoView", package.seeall)

local GoddesscollectorPetInfoView = class("GoddesscollectorPetInfoView", ViewComponent)
local STACK_LIST = {
...
function GoddesscollectorPetInfoView:_getPath()
	return {
		cellPath = "Cell",
		viewPath = "ScrollView"
	}
...
function GoddesscollectorPetInfoView:ctor()
	GoddesscollectorPetInfoView.super.ctor(self)
end

function GoddesscollectorPetInfoView:buildUI()
	GoddesscollectorPetInfoView.super.buildUI(self)
...
function GoddesscollectorPetInfoView:bindEvents()
	GoddesscollectorPetInfoView.super.bindEvents(self)
...
function GoddesscollectorPetInfoView:unbindEvents()
	GoddesscollectorPetInfoView.super.unbindEvents(self)
...
function GoddesscollectorPetInfoView:destroyUI()
	GoddesscollectorPetInfoView.super.destroyUI(self)
end

function GoddesscollectorPetInfoView:onEnter()
	GoddesscollectorPetInfoView.super.onEnter(self)

	local params = self:getOpenParam() or {}

	self.raceId = checknumber(params[1].skinId)
...
function GoddesscollectorPetInfoView:onEnterFinished()
	GoddesscollectorPetInfoView.super.onEnterFinished(self)
end

function GoddesscollectorPetInfoView:onExit()
	GoddesscollectorPetInfoView.super.onExit(self)
	self:_stopEffect()
...
function GoddesscollectorPetInfoView:_onGcTime()
...
function GoddesscollectorPetInfoView:onExitFinished()
	GoddesscollectorPetInfoView.super.onExitFinished(self)
end

function GoddesscollectorPetInfoView:_onClickClose()
	self:close()
end

function GoddesscollectorPetInfoView:_refresh()
...
function GoddesscollectorPetInfoView:_refreshTabView()
...
function GoddesscollectorPetInfoView:_setAttribute()
...
function GoddesscollectorPetInfoView:refreshJob(cfg)
...
function GoddesscollectorPetInfoView:centerOnIndex(idx, isSpring, isLeft)
	idx = checknumber(idx)
...
function GoddesscollectorPetInfoView:_updateCell(idx, cell)
...
function GoddesscollectorPetInfoView:_onClickCell()
...
function GoddesscollectorPetInfoView:_onClickSwitch(tabIndex)
...
function GoddesscollectorPetInfoView:_onClickSwitchPet(isLeft)
	if self._isTweening then
		return
	end
...
function GoddesscollectorPetInfoView:_updateSwitchBtnStatus()
	return
end

function GoddesscollectorPetInfoView:_onClickToGet()
...
function GoddesscollectorPetInfoView:_setIsCollectStatus()
...
function GoddesscollectorPetInfoView:_onClickVideo()
	PetbookController.instance:previewBattle(self.raceId, self._skinId)
end

function GoddesscollectorPetInfoView:_onClickZoom()
	UIStateManager.instance:push(ViewName.PetDrawing, self.raceId)
end

function GoddesscollectorPetInfoView:_onClickSwitchDrawing()
	self._isLihui = not self._isLihui

	self:centerOnIndex(self._curIndex, false)
end

function GoddesscollectorPetInfoView:_onClickVoice()
...
function GoddesscollectorPetInfoView:_onCloseCVviewCallback(hover)
...
function GoddesscollectorPetInfoView:_updateRedpoint()
	goutil.setActive(self._attrRedPoint, HandbookController.instance:getIfCanActiveOrUpgrade(self.raceId))
end

function GoddesscollectorPetInfoView:_showEffect(raceId)
	self:_stopEffect()
...
function GoddesscollectorPetInfoView:_stopEffect()
	for i = 1, 4 do
...
function GoddesscollectorPetInfoView:_onClickBtnTips()
...
function GoddesscollectorPetInfoView:_onClickBtnTipClickMask()
	GameUtil.SetActive(self._btnTipsCol, false)
end

return GoddesscollectorPetInfoView
