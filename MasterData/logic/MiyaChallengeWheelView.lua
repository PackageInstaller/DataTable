-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/miyachallenge/view/MiyaChallengeWheelView.lua

module("logic.extensions.miyachallenge.view.MiyaChallengeWheelView", package.seeall)

local MiyaChallengeWheelView = class("MiyaChallengeWheelView", ViewComponent)

function MiyaChallengeWheelView:ctor()
	MiyaChallengeWheelView.super.ctor(self)
...
function MiyaChallengeWheelView:buildUI()
	MiyaChallengeWheelView.super.buildUI(self)
...
function MiyaChallengeWheelView:bindEvents()
	MiyaChallengeWheelView.super.buildUI(self)
...
function MiyaChallengeWheelView:unbindEvents()
	MiyaChallengeWheelView.super.unbindEvents(self)
	GameUtil.rmClickHandler(self._btnStart)
	GameUtil.rmClickHandler(self._btnRule)
	GameUtil.rmClickHandler(self._btnClose)
end

function MiyaChallengeWheelView:onEnter()
	MiyaChallengeWheelView.super.onEnter(self)
	...
	if MiyaChallengeModel.instance:getExchangeBuff() then
		UIStateManager.instance:push(ViewName.MiyaChallengeSelectView)
	end

	self:_setBlurBg()
end

function MiyaChallengeWheelView:onExit()
	MiyaChallengeWheelView.super.onExit(self)
...
function MiyaChallengeWheelView:_refreshView()
	self._ignoreArrow = {}
	...
	for i = 1, self._wheelData.short.chipCount do
		...
		self._shortPoints[i].txtNum.color = Color.white
...
function MiyaChallengeWheelView:_onClickStart()
...
function MiyaChallengeWheelView:_onClickClose()
...
function MiyaChallengeWheelView:_onClickRule()
	UIStateManager.instance:push(ViewName.MiyaChallengeRuleView)
end

function MiyaChallengeWheelView:_checkLongRotation()
...
function MiyaChallengeWheelView:_checkMidRotation()
...
function MiyaChallengeWheelView:_checkShortRotation()
...
function MiyaChallengeWheelView:_checkWheelEnd()
...
function MiyaChallengeWheelView:_wheelEnd()
	GameUtil.SetActive(self._tipGo, true)
...
function MiyaChallengeWheelView:_PM_MiyaChallengeBuyAndRandomRes()
	for i = 1, self._wheelData.long.chipCount do
		GameUtil.SetActive(self._longPoints[i].imgActivate, false)
		GameUtil.SetActive(self._longPoints[i].lastRes, false)
...
function MiyaChallengeWheelView:_PM_MiyaChallengeChoiceRes()
...
function MiyaChallengeWheelView:_setBlurBg()
...
function MiyaChallengeWheelView:_removeBlurBg()
	StaticBluredHook.instance:stop()
	self._blurBg:Release()
end

function MiyaChallengeWheelView:_onCaptureScreenFinish()
	StaticBluredHook.instance:stop()
end

return MiyaChallengeWheelView
