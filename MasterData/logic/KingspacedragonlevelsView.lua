-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/kingspacedragon/view/KingspacedragonlevelsView.lua

module("logic.extensions.kingspacedragon.view.KingspacedragonlevelsView", package.seeall)

local KingspacedragonlevelsView = class("KingspacedragonlevelsView", ViewComponent)

KingspacedragonlevelsView.OpType = {
	["*"] = 2,
	["/"] = 3,
	["+"] = 0,
	[">"] = 8,
...
function KingspacedragonlevelsView:ctor()
	KingspacedragonlevelsView.super.ctor(self)
end

function KingspacedragonlevelsView:unbindEvents()
	KingspacedragonlevelsView.super.unbindEvents(self)
	self._closeButton:RemoveClickListener()
	self._rewardBtn:RemoveClickListener()
	self._btnTip:RemoveClickListener()
end

function KingspacedragonlevelsView:bindEvents()
	KingspacedragonlevelsView.super.bindEvents(self)
	self._closeButton:AddClickListener(self.close, self)
	self._rewardBtn:AddClickListener(self._onClickReward, self)
	self._btnTip:AddClickListener(self._onClickTip, self)
end

function KingspacedragonlevelsView:buildUI()
	KingspacedragonlevelsView.super.buildUI(self)
...
function KingspacedragonlevelsView:onExit()
	KingspacedragonlevelsView.super.onExit(self)
...
function KingspacedragonlevelsView:onEnter()
	KingspacedragonlevelsView.super.onEnter(self)
...
function KingspacedragonlevelsView:_onClickTip()
	UIStateManager.instance:push(ViewName.RulesView, KingspacedragonConfig.instance:getRuleKey(self._activityId, "ruleKeyLevels"))
end

function KingspacedragonlevelsView:_onClickReward()
	UIStateManager.instance:push(ViewName.KingspacedragonpopView, self._activityId)
end

function KingspacedragonlevelsView:_updateUI()
...
function KingspacedragonlevelsView:_updateDesc()
	...
	if not KingspacedragonlevelsView.OpType[self._stageCfg.opType] then
		local op1 = 0

		self._imgSysbol1:SetState(op1)

		if not KingspacedragonlevelsView.OpType[self._stageCfg.compareType] then
			local op2 = 0
...
function KingspacedragonlevelsView:_updateFmts()
...
function KingspacedragonlevelsView:_setTeamInfo(cell, teamId, creepsMasterId, ctype)
...
function KingspacedragonlevelsView:_checkConfirm()
	local needConfirm = KingspacedragonController.instance:needConfirm()

	if needConfirm then
		UIStateManager.instance:push(ViewName.KingspacedragonchangetipView)
	end
end

function KingspacedragonlevelsView:_setRewardIcon()
...
function KingspacedragonlevelsView:_hideAoqiGodNodes()
	self._isAoqiGodProcessType = ActivityDefineController.instance:isAoqiGodProcessType(self._activityId)

	goutil.setActive(self._rewardBtn.gameObject, not self._isAoqiGodProcessType)
end

return KingspacedragonlevelsView
