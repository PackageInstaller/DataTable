-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/season/view/item/SeasonItemChatNormal.lua

module("logic.extensions.season.view.item.SeasonItemChatNormal", package.seeall)

local SeasonItemChatNormal = class("SeasonItemChatNormal", ItemChatNormal)

function SeasonItemChatNormal:_buildTextContent()
