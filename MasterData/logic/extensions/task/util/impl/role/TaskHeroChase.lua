-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/role/TaskHeroChase.lua

module("logic.extensions.task.util.impl.role.TaskHeroChase", package.seeall)

local M = class("TaskHeroChase")
