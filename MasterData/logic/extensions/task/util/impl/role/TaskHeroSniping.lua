-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/role/TaskHeroSniping.lua

module("logic.extensions.task.util.impl.role.TaskHeroSniping", package.seeall)

local M = class("TaskHeroSniping")
