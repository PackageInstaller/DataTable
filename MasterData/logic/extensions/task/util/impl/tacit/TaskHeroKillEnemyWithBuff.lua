-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroKillEnemyWithBuff.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroKillEnemyWithBuff", package.seeall)

local M = class("TaskHeroKillEnemyWithBuff")
