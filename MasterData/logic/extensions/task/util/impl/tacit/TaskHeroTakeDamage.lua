-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroTakeDamage.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroTakeDamage", package.seeall)

local M = class("TaskHeroTakeDamage")
