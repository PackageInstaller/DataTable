-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroReleaseStrengthenMoveSkill.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroReleaseStrengthenMoveSkill", package.seeall)

local M = class("TaskHeroReleaseStrengthenMoveSkill")
