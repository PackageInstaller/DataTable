-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroMakeCure.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroMakeCure", package.seeall)

local M = class("TaskHeroMakeCure")
