-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroKillEnemyInRound.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroKillEnemyInRound", package.seeall)

local M = class("TaskHeroKillEnemyInRound")
...
function M:parseContent(code, desc, param, heroId)
	...
	local killCount = tonumber(paramArray[1])
	...
	tempStr = string.gsub(tempStr, "#1#", killCount)
