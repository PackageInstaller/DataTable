-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroAddBuffId.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroAddBuffId", package.seeall)

local M = class("TaskHeroAddBuff")
