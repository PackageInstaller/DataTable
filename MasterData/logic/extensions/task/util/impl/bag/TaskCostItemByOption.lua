-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/bag/TaskCostItemByOption.lua

module("logic.extensions.task.util.impl.bag.TaskCostItemByOption", package.seeall)

local M = class("TaskCostItemByOption")
