-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/monument/TaskMoveWithSkill.lua

module("logic.extensions.task.util.impl.monument.TaskMoveWithSkill", package.seeall)

local M = class("TaskMoveWithSkill")
