-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/store/TaskGetMoney.lua

module("logic.extensions.task.util.impl.store.TaskGetMoney", package.seeall)

local M = class("TaskGetMoney")
