-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/tooltips/view/ToolTipsSimpleViewPresentor.lua

module("logic.extensions.tooltips.view.ToolTipsSimpleViewPresentor", package.seeall)

local M = class("ToolTipsSimpleViewPresentor", ViewPresentor)
