-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/charactersystem/view/CharacterMainSystemSubViewBase.lua

module("logic.extensions.charactersystem.view.CharacterMainSystemSubViewBase", package.seeall)

local M = class("CharacterMainSystemSubViewBase", DynamicFragmentView)
