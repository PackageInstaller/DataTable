-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/specialtraining/scene/SpecialTrainingFlow.lua

module("logic.extensions.specialtraining.scene.SpecialTrainingFlow", package.seeall)

local M = class("SpecialTrainingFlow", DefaultSceneFlow)

function M:_registerComponents()
	M.super._registerComponents(self)
	self:_addComponent("resMgr", SpecialTrainingResMgr)
	self:_addComponent("viewMgr", SpecialTrainingViewMgr)
end
