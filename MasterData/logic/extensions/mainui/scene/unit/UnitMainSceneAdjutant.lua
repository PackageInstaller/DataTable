-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/mainui/scene/unit/UnitMainSceneAdjutant.lua

module("logic.extensions.mainui.scene.unit.UnitMainSceneAdjutant", package.seeall)

local M = class("UnitMainSceneAdjutant", ReusableUnitBase)
