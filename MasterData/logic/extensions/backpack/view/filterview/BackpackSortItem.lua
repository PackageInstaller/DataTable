-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/backpack/view/filterview/BackpackSortItem.lua

module("logic.extensions.backpack.view.filterview.BackpackSortItem", package.seeall)

local M = class("BackpackSortItem")
