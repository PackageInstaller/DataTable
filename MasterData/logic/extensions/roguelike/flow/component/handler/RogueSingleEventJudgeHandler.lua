-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/roguelike/flow/component/handler/RogueSingleEventJudgeHandler.lua

module("logic.extensions.roguelike.flow.component.handler.RogueSingleEventJudgeHandler", package.seeall)

local M = class("RogueSingleEventJudgeHandler", IRogueJudgeHandler)
local PATTERN = RoguelikeConst.DICE_PATTERN

function M:getExtraResult()
	local result
	local bigSuccess = RoguelikeConfig.instance:getConstByName("SingleEventBigSuccess").numValue
	local bigFail = 0
