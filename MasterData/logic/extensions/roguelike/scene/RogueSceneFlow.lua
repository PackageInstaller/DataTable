-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/roguelike/scene/RogueSceneFlow.lua

module("logic.extensions.roguelike.scene.RogueSceneFlow", package.seeall)

local M = class("RogueSceneFlow", DefaultSceneFlow)

function M:_registerComponents()
	M.super._registerComponents(self)
	self:_addComponent("resMgr", RogueResourceMgr)
	self:_addComponent("viewMgr", RogueViewMgr)
end
