-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/roguelike/unit/impl/RogueMapRole.lua

module("logic.extensions.roguelike.unit.impl.RogueMapRole", package.seeall)

local M = class("RogueMapRole", RogueUnitBase)
...
function M:_initComponents()
	...
	self:_addComponent("bubble", RogueUnitCompBubble)
end
