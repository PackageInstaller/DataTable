-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/friend/view/item/FriendItemChatNormal.lua

module("logic.extensions.friend.view.item.FriendItemChatNormal", package.seeall)

local FriendItemChatNormal = class("FriendItemChatNormal", ItemChatNormal)

function FriendItemChatNormal:_buildTextContent()
