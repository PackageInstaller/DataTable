-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/yearcard/view/yearcard2026/main/YearCardMain2026View.lua

module("logic.extensions.yearcard.view.yearcard2026.main.YearCardMain2026View", package.seeall)

local YearCardMain2026View = class("YearCardMain2026View", YearCardMain2022View)

function YearCardMain2026View:buildUI()
...
function YearCardMain2026View:_getTagByData(data, idx)
	if data.leaf == 1 then
		return 1
	else
		return 2
...
function YearCardMain2026View:_getCellSize(view, idx)
...
function YearCardMain2026View:_clearTagCell(cell)
	return
end

function YearCardMain2026View:_updateTagCell(view, cell, tabData, tag)
	if tag == 1 then
...
function YearCardMain2026View:_updateRootCell(view, cell, data, tag)
...
function YearCardMain2026View:_updateLeafCell(view, cell, data, tag)
	GameUtil.addClickHandler(cell, GameUtil.handler(self._onClickCell, self, data.root, data.leaf))
...
function YearCardMain2026View:_reloadList()
	YearCardMain2026View.super._reloadList(self)
...
function YearCardMain2026View:_onClickTip()
	UIStateManager.instance:push(ViewName.RulesView, "yearcardRule2026")
end

function YearCardMain2026View:onEnter()
	YearCardMain2026View.super.onEnter(self)
	ImpressionStickersController.instance:sendPM_Annuity2025ChangeRankInfoReq()
end

return YearCardMain2026View
