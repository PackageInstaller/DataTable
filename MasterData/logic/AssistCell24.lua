-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xiaonuoassistant/view/cell/AssistCell24.lua

module("logic.extensions.xiaonuoassistant.view.cell.AssistCell24", package.seeall)

local AssistCell24 = class("AssistCell24", BaseAssistCell)

function AssistCell24:ctor(luaComponentContainer)
	AssistCell24.super.ctor(self, luaComponentContainer)
...
function AssistCell24:init(data)
	AssistCell24.super.init(self, data)
...
function AssistCell24:reset()
	self._btn1:RemoveClickListener()
end

function AssistCell24:_selectAll()
	self._data:setCellSelect(self._data.selectIndex1, true)
	self:_setBtnIsOn1(true)
end

function AssistCell24:_cancelAll()
	return
end

function AssistCell24:_onClickBtn1()
...
function AssistCell24:_setBtnIsOn1(isOn)
