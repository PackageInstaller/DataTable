-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/martialcontest/view/MartialContestDeFmtExView.lua

module("logic.extensions.martialcontest.view.MartialContestDeFmtExView", package.seeall)

local MartialContestDeFmtExView = class("MartialContestDeFmtExView", ViewComponent)

function MartialContestDeFmtExView:ctor()
	MartialContestDeFmtExView.super.ctor(self)
end

function MartialContestDeFmtExView:unbindEvents()
	MartialContestDeFmtExView.super.unbindEvents(self)
...
function MartialContestDeFmtExView:bindEvents()
	MartialContestDeFmtExView.super.bindEvents(self)
...
function MartialContestDeFmtExView:buildUI()
	MartialContestDeFmtExView.super.buildUI(self)
	...
	self._btnEquip = self:getGo("equipInfo/btnEquip")
	self._btnUnload = self:getGo("equipInfo/btnUnload")
end

function MartialContestDeFmtExView:onExit()
	MartialContestDeFmtExView.super.onExit(self)
end

function MartialContestDeFmtExView:onEnter()
	MartialContestDeFmtExView.super.onEnter(self)
	...
	self._txtTips.text = self._enterStepId == MartialContestEnum.Qualify_Step_Id and "在比武争锋战区积分赛时，将以此阵应对他人挑战，<color=#CD7800>勿忘装备功法秘籍</color>" or self._enterStepId == MartialContestEnum.Score_Match_Step_Id and "在比武争锋全服晋级赛时，将以此阵应对他人挑战，<color=#CD7800>勿忘装备功法秘籍</color>" or self._enterStepId == MartialContestEnum.Entertainment_Step_Id and "在比武争锋娱乐赛时，将以此阵应对他人挑战，<color=#CD7800>勿忘装备功法秘籍</color>" or ""
...
function MartialContestDeFmtExView:_refreshView()
...
function MartialContestDeFmtExView:_updateEquipCell(view, cell, data, tag)
...
function MartialContestDeFmtExView:_clearEquipCell(cell)
	local go = cell.gameObject

	GameUtil.rmClickHandler(go)
end

function MartialContestDeFmtExView:_onDragCellStart(startContainer, cell)
...
function MartialContestDeFmtExView:_onDragCellEnd(startContainer, cell, endContainer)
...
function MartialContestDeFmtExView:_onCloneDragObj(table, cell)
...
function MartialContestDeFmtExView:_onClickEquipChange()
...
function MartialContestDeFmtExView:_onClickEquip()
	UIStateManager.instance:push(ViewName.MartialContestEquipView, self.customFmtMo.activityId)
end

function MartialContestDeFmtExView:_onClickPosEquip(index)
...
function MartialContestDeFmtExView:_onClickUnload()
...
function MartialContestDeFmtExView:_onFormationChanged()
	self.customFmtMo:refreshCurEquipState()
	self:_refreshView()
end

return MartialContestDeFmtExView
