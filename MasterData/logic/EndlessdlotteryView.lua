-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/infinitefuture/view/EndlessdlotteryView.lua

module("logic.extensions.infinitefuture.view.EndlessdlotteryView", package.seeall)

local EndlessdlotteryView = class("EndlessdlotteryView", TableViewComponent)

function EndlessdlotteryView:ctor()
	EndlessdlotteryView.super.ctor(self)

	self._curActId = 112005
	self._middleItemList = nil
	self._curViewDatas = nil
end

function EndlessdlotteryView:bindEvents()
	EndlessdlotteryView.super.bindEvents(self)
	...
	self._petVerifyBtn:AddClickListener(function()
		PetAwakenVerificationController.instance:gotoPetAwakenByKey("endlessdragonview")
	end, self)
...
function EndlessdlotteryView:unbindEvents()
	EndlessdlotteryView.super.unbindEvents(self)
...
function EndlessdlotteryView:onExit()
	EndlessdlotteryView.super.onExit(self)
	...
	PetAwakenVerificationController.instance:unRegRedAboutPetAwken(self._petVerifyBtnRed)
end

function EndlessdlotteryView:destroyUI()
	EndlessdlotteryView.super.destroyUI(self)
...
function EndlessdlotteryView:buildUI()
	EndlessdlotteryView.super.buildUI(self)
	...
	self._petVerifyBtnRed = goutil.findChild(viewDownGo, "btnPetVerify/imgRed")
...
function EndlessdlotteryView:onCLickWish()
	local actType = math.floor(self._curActId / 1000)
...
function EndlessdlotteryView:onEnter()
	EndlessdlotteryView.super.onEnter(self)
	...
	if actCfg == nil then
		printError("sr---超神龙召唤      EndlessdlotteryView:onEnter()    获取配置为空！")
		self:close()
	...
	DragonController.instance:csGodLotteryGetInfoReq(self._curActId, DragonController.DragonActType.Endless)
	PetAwakenVerificationController.instance:regRedAboutPetAwken(self._petVerifyBtnRed, "endlessdragonview")
end

function EndlessdlotteryView:_updateLotteryShow(str, param)
	self._baseInfo = DragonModel.instance:getDragonBaseInfo(DragonController.DragonActType.Endless)
...
function EndlessdlotteryView:_updateRewardNode()
...
function EndlessdlotteryView:_cellSize()
	return 224, 32
end

function EndlessdlotteryView:_updateCell(view, cell, data)
