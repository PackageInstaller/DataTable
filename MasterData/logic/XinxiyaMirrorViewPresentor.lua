-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xinxiyamirror/view/XinxiyaMirrorViewPresentor.lua

module("logic.extensions.xinxiyamirror.view.SunranBattleViewPresentor", package.seeall)
...
function SunranBattleViewPresentor:dependWhatResources()
	return {
		"ui/views/xinxiyamirror/xinxiyamirrorview.prefab"
	}
end

function SunranBattleViewPresentor:buildViews()
	return {
		XinxiyaMirrorView.New()
	}
end
