-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/peaktournament/view/eliminator/tab/space/TabPTEliSixteenSpaceView.lua

module("logic.extensions.peaktournament.view.eliminator.tab.space.TabPTEliSixteenSpaceView", package.seeall)

local TabPTEliSixteenSpaceView = class("TabPTEliSixteenSpaceView", TabPTEliBaseSpaceView)

function TabPTEliSixteenSpaceView:_getEliRoundIdList()
	return {
		4,
		5
	}
...
function TabPTEliSixteenSpaceView:_getGroupCount()
	return 4
end

function TabPTEliSixteenSpaceView:_updateThroneColUI()
...
function TabPTEliSixteenSpaceView:_clearThroneColUI()
	local mainGo = goutil.findChild(self.mainGO, "contentCol/throneCol/throneCell")
	local headIcon = goutil.findChild(mainGo, "headcell/headIcon")
...
return TabPTEliSixteenSpaceView
