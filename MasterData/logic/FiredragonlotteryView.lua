-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/infinitefuture/view/FiredragonlotteryView.lua

module("logic.extensions.infinitefuture.view.FiredragonlotteryView", package.seeall)

local FiredragonlotteryView = class("FiredragonlotteryView", TableViewComponent)

function FiredragonlotteryView:ctor()
	FiredragonlotteryView.super.ctor(self)

	self._curActId = checknumber(InfinitefutureConfig.instance:getCommonCfg("activity_luck_draw"))
	self._curDragonType = DragonController.DragonActType.FireDragon
	self._middleItemList = nil
	self._curViewDatas = nil
end

function FiredragonlotteryView:bindEvents()
	FiredragonlotteryView.super.bindEvents(self)
...
function FiredragonlotteryView:unbindEvents()
	FiredragonlotteryView.super.unbindEvents(self)
...
function FiredragonlotteryView:onExit()
	FiredragonlotteryView.super.onExit(self)
...
function FiredragonlotteryView:destroyUI()
	FiredragonlotteryView.super.destroyUI(self)
...
function FiredragonlotteryView:buildUI()
	FiredragonlotteryView.super.buildUI(self)
...
function FiredragonlotteryView:onCLickWish()
	local actType = math.floor(self._curActId / 1000)
...
function FiredragonlotteryView:onEnter()
	FiredragonlotteryView.super.onEnter(self)
	...
	if actCfg == nil then
		printError("sr---超神龙召唤      FiredragonlotteryView:onEnter()    获取配置为空！")
		self:close()

		return
	end

	DragonController.instance.openActType = self._curDragonType
...
function FiredragonlotteryView:_updateLotteryShow(str, param)
...
function FiredragonlotteryView:_updateRewardNode()
...
function FiredragonlotteryView:_cellSize()
	return 224, 32
end

function FiredragonlotteryView:_updateCell(view, cell, data)
