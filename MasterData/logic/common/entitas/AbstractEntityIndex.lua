-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/common/entitas/AbstractEntityIndex.lua

module("logic.common.entitas.AbstractEntityIndex", package.seeall)

local function ignore_param()
	return
end
...
function M:ctor(comp_type, group, ...)
	...
	function self.on_entity_added(...)
		return self._on_entity_added(self, ...)
	end

	function self.on_entity_removed(...)
		return self._on_entity_removed(self, ...)
	end

	function self.on_entity_update(...)
		return self._on_entity_added(self, ...)
	end
