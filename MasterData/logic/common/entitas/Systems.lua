-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/common/entitas/Systems.lua

module("logic.common.entitas.Systems", package.seeall)
...
function M:execute()
	for _, system in pairs(self._execute_systems) do
		if not system._execute then
			print("system没有_execute方法", system.__cname)
