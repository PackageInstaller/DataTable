-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xingjiang/view/XjlotteryView.lua

module("logic.extensions.xingjiang.view.XjlotteryView", package.seeall)

local XjlotteryView = class("XjlotteryView", TableViewComponent)

function XjlotteryView:ctor()
	XjlotteryView.super.ctor(self)

	self._curActId = 112004
	self._middleItemList = nil
	self._curViewDatas = nil
end

function XjlotteryView:bindEvents()
	XjlotteryView.super.bindEvents(self)
...
function XjlotteryView:unbindEvents()
	XjlotteryView.super.unbindEvents(self)
...
function XjlotteryView:onExit()
	XjlotteryView.super.onExit(self)
...
function XjlotteryView:destroyUI()
	XjlotteryView.super.destroyUI(self)
...
function XjlotteryView:buildUI()
	XjlotteryView.super.buildUI(self)
...
function XjlotteryView:onCLickWish()
	local actType = math.floor(self._curActId / 1000)
...
function XjlotteryView:onEnter()
	XjlotteryView.super.onEnter(self)
	...
	if actCfg == nil then
		printError("sr---超神龙召唤      XjlotteryView:onEnter()    获取配置为空！")
		self:close()
	...
	DragonController.instance:csGodLotteryGetInfoReq(self._curActId, DragonController.DragonActType.Xj)
end

function XjlotteryView:_updateLotteryShow(str, param)
	self._baseInfo = DragonModel.instance:getDragonBaseInfo(DragonController.DragonActType.Xj)
...
function XjlotteryView:_updateRewardNode()
...
function XjlotteryView:_cellSize()
	return 224, 32
end

function XjlotteryView:_updateCell(view, cell, data)
