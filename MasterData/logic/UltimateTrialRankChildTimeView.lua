-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/ultimatetrial/view/UltimateTrialRankChildTimeView.lua

module("logic.extensions.ultimatetrial.view.UltimateTrialRankChildTimeView", package.seeall)

local UltimateTrialRankChildTimeView = class("UltimateTrialRankChildTimeView", ViewComponent)

function UltimateTrialRankChildTimeView:buildUI()
	UltimateTrialRankChildTimeView.super.buildUI(self)
...
function UltimateTrialRankChildTimeView:bindEvents()
	UltimateTrialRankChildTimeView.super.bindEvents(self)
end

function UltimateTrialRankChildTimeView:unbindEvents()
	UltimateTrialRankChildTimeView.super.unbindEvents(self)
end

function UltimateTrialRankChildTimeView:onEnter()
	UltimateTrialRankChildTimeView.super.onEnter(self)
	...
	self.addGEvent(self, GlobalNotify.HandlePM_UltimateTrialGetTimeRankViewRes, self._handleMsgRes, self)
	UltimateTrialController.instance:sendPM_UltimateTrialGetTimeRankViewReq(self._activityId, self._clgActId)
end

function UltimateTrialRankChildTimeView:onExit()
	UltimateTrialRankChildTimeView.super.onExit(self)
	self._rankScrollList:dispose()
	self._myPrizeScrollList:dispose()
end

function UltimateTrialRankChildTimeView:_handleMsgRes(msg)
...
function UltimateTrialRankChildTimeView:_getPrizesByRank(rank)
	local data = UltimateTrialConfig.instance:getTimeRankPrizeData(self._activityId, self._clgActId, rank)

	return data and data.prize
end

function UltimateTrialRankChildTimeView:_onUpdate()
...
function UltimateTrialRankChildTimeView:_updateRankCell(view, cell, info, tag)
...
function UltimateTrialRankChildTimeView:_clearRankCell(cell)
	local mainGo = cell.gameObject
	local headRoot = goutil.findChild(mainGo, "headRoot")
...
function UltimateTrialRankChildTimeView:_updateItemCell(view, cell, prizeStr, tag)
	local mainGo = cell.gameObject

	MaterialMgr.setCellByCfg(prizeStr, mainGo)
end

function UltimateTrialRankChildTimeView:_clearItemCell(cell)
	local mainGo = cell.gameObject

	MaterialMgr.resetAll(mainGo)
end

function UltimateTrialRankChildTimeView:_updateMyPrizeItemCell(view, cell, prizeStr, tag)
	local mainGo = cell.gameObject

	MaterialMgr.setCellByCfg(prizeStr, mainGo)
end

function UltimateTrialRankChildTimeView:_clearMyPrizeItemCell(cell)
	local mainGo = cell.gameObject

	MaterialMgr.resetAll(mainGo)
end

return UltimateTrialRankChildTimeView
