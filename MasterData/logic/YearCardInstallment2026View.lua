-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/yearcard/view/yearcard2026/main/YearCardInstallment2026View.lua

module("logic.extensions.yearcard.view.yearcard2026.main.YearCardInstallment2026View", package.seeall)

local YearCardInstallment2026View = class("YearCardInstallment2026View", ViewComponent)

function YearCardInstallment2026View:ctor()
	YearCardInstallment2026View.super.ctor(self)
end

function YearCardInstallment2026View:buildUI()
	YearCardInstallment2026View.super.buildUI(self)
...
function YearCardInstallment2026View:bindEvents()
	YearCardInstallment2026View.super.bindEvents(self)
	self._btnClose:AddClickListener(self.close, self)
end

function YearCardInstallment2026View:unbindEvents()
	YearCardInstallment2026View.super.unbindEvents(self)
...
function YearCardInstallment2026View:onEnter()
	YearCardInstallment2026View.super.onEnter(self)
...
function YearCardInstallment2026View:onExit()
	YearCardInstallment2026View.super.onExit(self)
	GlobalDispatcher:removeListener(GlobalNotify.AnnuityInfoChange, self._refreshView, self)
end

function YearCardInstallment2026View:_onClickBuyGift(id)
	YearCardController.instance:payGiftId(self._curActId, id)
end

function YearCardInstallment2026View:_refreshView()
	self:_buildCells()
...
function YearCardInstallment2026View:_getGiftCfgs()
	local list = {}
...
function YearCardInstallment2026View:_getTotalGiftCfg()
	return YearCardConfig.instance:getNewTotalGiftCfg(self._curActId)
end

function YearCardInstallment2026View:_buildCells()
...
return YearCardInstallment2026View
