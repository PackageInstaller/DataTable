-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/dragonxiuer/view/copy/YushenBossView.lua

module("logic.extensions.dragonxiuer.view.YushenBossView", package.seeall)

local YushenBossView = class("YushenBossView", ViewComponent)

function YushenBossView:ctor()
	YushenBossView.super.ctor(self)
end

function YushenBossView:unbindEvents()
	YushenBossView.super.unbindEvents(self)
	GameUtil.rmClickHandler(self._btnClose)
	GameUtil.rmClickHandler(self._btnChallenge)
end

function YushenBossView:bindEvents()
	YushenBossView.super.bindEvents(self)
	GameUtil.addClickHandler(self._btnClose, self.close, self)
	GameUtil.addClickHandler(self._btnChallenge, self._onClickChallenge, self)
end

function YushenBossView:buildUI()
	YushenBossView.super.buildUI(self)
...
function YushenBossView:onExit()
	YushenBossView.super.onExit(self)
end

function YushenBossView:onEnter()
	YushenBossView.super.onEnter(self)
	...
	if DragonXiuerController.instance:isNeedNotifyReset() == true then
		UIStateManager.instance:push(ViewName.YushenBossFailView)
	end
...
function YushenBossView:_refreshView()
	local bossCfgInfo = {}
...
function YushenBossView:_onClickChallenge()
