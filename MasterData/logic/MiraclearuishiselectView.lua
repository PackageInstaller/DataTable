-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xiunuobrotherhood/view/copy/MiraclearuishiselectView.lua

module("logic.extensions.xiunuobrotherhood.view.copy.MiraclearuishiselectView", package.seeall)

local MiraclearuishiselectView = class("MiraclearuishiselectView", XiuNuoBrotherhoodSelectView)

function MiraclearuishiselectView:ctor()
	self._gameViewName = ViewName.MiraclearuishigameView
end

function MiraclearuishiselectView:_onClickStart(stageId)
...
return MiraclearuishiselectView
