-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/suppressgame/view/game/bury/CopyBuryGameMainView.lua

module("logic.extensions.suppressgame.view.game.bury.CopyBuryGameMainView", package.seeall)

local CopyBuryGameMainView = class("CopyBuryGameMainView", ViewComponent)
local rightScorePer, wrongScorePer

function CopyBuryGameMainView:unbindEvents()
	CopyBuryGameMainView.super.unbindEvents(self)
	self._closeButton:RemoveClickListener()
end

function CopyBuryGameMainView:bindEvents()
	CopyBuryGameMainView.super.bindEvents(self)
	self._closeButton:AddClickListener(self._onClickClose, self)
end

function CopyBuryGameMainView:onExit()
	CopyBuryGameMainView.super.onExit(self)
...
function CopyBuryGameMainView:buildUI()
	CopyBuryGameMainView.super.buildUI(self)
...
function CopyBuryGameMainView:onEnter()
	CopyBuryGameMainView.super.onEnter(self)

	self._activityId = 50002
...
function CopyBuryGameMainView:_onEggFinish(prizeNum)
...
function CopyBuryGameMainView:onEnterFinished()
	CopyBuryGameMainView.super.onEnterFinished(self)
...
function CopyBuryGameMainView:_removePit(posId)
...
function CopyBuryGameMainView:_onBuryPitSuccess(pitType, x, y, z, x1, y1, z1)
...
function CopyBuryGameMainView:_updateUI()
	self._txtCombo:SetText(self._comboNum)

	self._txtScore.text = self._curScore
end

function CopyBuryGameMainView:_createPit(data)
...
function CopyBuryGameMainView:_findFreePit()
...
function CopyBuryGameMainView:_findFreePosId()
	local t = {}
...
function CopyBuryGameMainView:_insertPitsToQueue()
	self._queue = {}
...
function CopyBuryGameMainView:_randomGetNum(weights)
...
function CopyBuryGameMainView:_startCountDown()
	self:_startGameRes()
	self:_startGame()
end

function CopyBuryGameMainView:_initGame()
...
function CopyBuryGameMainView:_startGameRes()
...
function CopyBuryGameMainView:_startGame()
...
function CopyBuryGameMainView:_realStartGame()
	settimer(0, self._onTicking, self)
	self:_onTicking()
end

function CopyBuryGameMainView:_endGame()
	self._isInGame = false
...
function CopyBuryGameMainView:_onClickClose()
...
function CopyBuryGameMainView:_calcuRightNum()
	local rightNum = 0
	local wrongNum = 0
...
function CopyBuryGameMainView:_pauseGame()
...
function CopyBuryGameMainView:_resumeGame()
...
function CopyBuryGameMainView:_checkEgg()
	if self._egged then
		return
	end
...
function CopyBuryGameMainView:_openEggView()
	self:_pauseGame()
...
function CopyBuryGameMainView:_onEndGameRes()
	SuppressGameController.instance:_endGameHandle(self._curScore)
end

return CopyBuryGameMainView
