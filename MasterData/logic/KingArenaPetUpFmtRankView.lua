-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/kingarena/view/rank/KingArenaPetUpFmtRankView.lua

module("logic.extensions.kingarena.view.rank.KingArenaPetUpFmtRankView", package.seeall)

local KingArenaPetUpFmtRankView = class("KingArenaPetUpFmtRankView", ViewComponent)

function KingArenaPetUpFmtRankView:buildUI()
	KingArenaPetUpFmtRankView.super.buildUI(self)
...
function KingArenaPetUpFmtRankView:bindEvents()
	KingArenaPetUpFmtRankView.super.bindEvents(self)
end

function KingArenaPetUpFmtRankView:unbindEvents()
	KingArenaPetUpFmtRankView.super.unbindEvents(self)
end

function KingArenaPetUpFmtRankView:onEnter()
	KingArenaPetUpFmtRankView.super.onEnter(self)

	self._rankType = KingArenaEnum.RankType_Pet_One
...
function KingArenaPetUpFmtRankView:onExit()
	KingArenaPetUpFmtRankView.super.onExit(self)
	self._dropdownComp:RemoveOnValueChanged()
	self._dropdownComp:ClearOptions()
	self._rankScrollerList:dispose()
end

function KingArenaPetUpFmtRankView:_sendGetInfoReq()
...
function KingArenaPetUpFmtRankView:_getCurSide()
	local value = self._dropdownComp:GetValue()

	return KingArenaEnum.RankSideList[value + 1]
end

function KingArenaPetUpFmtRankView:_handlePM_KingArenaPetRankViewRes(msg)
...
function KingArenaPetUpFmtRankView:_onUpdate()
...
function KingArenaPetUpFmtRankView:_updateRankCell(view, cell, info, tag)
...
function KingArenaPetUpFmtRankView:_clearRankCell(cell)
	local mainGo = cell.gameObject
	local head = goutil.findChild(mainGo, "head")
...
return KingArenaPetUpFmtRankView
