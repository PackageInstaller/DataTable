-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xiaonuoassistant/view/cell/AssistCell9.lua

module("logic.extensions.xiaonuoassistant.view.cell.AssistCell9", package.seeall)

local AssistCell9 = class("AssistCell9", BaseAssistCell)

function AssistCell9:ctor(luaComponentContainer)
	AssistCell9.super.ctor(self, luaComponentContainer)
...
function AssistCell9:init(data)
	AssistCell9.super.init(self, data)
...
function AssistCell9:_selectAll()
...
function AssistCell9:_cancelAll()
	return
end

function AssistCell9:_onClickBtn1()
...
function AssistCell9:_onClickBtn2()
...
function AssistCell9:_onClickBtn3()
...
function AssistCell9:_onClickBtn4()
...
function AssistCell9:_setBtnIsOn1(isOn)
	goutil.setActive(self._markbtn1, isOn)
end

function AssistCell9:_setBtnIsOn2(isOn)
	goutil.setActive(self._markbtn2, isOn)
end

function AssistCell9:_setBtnIsOn3(isOn)
	goutil.setActive(self._markbtn3, isOn)
end

function AssistCell9:_setBtnIsOn4(isOn)
