-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/commontabrank/view/goddesscompetition/GoddessCompetitionActivityChildRankView.lua

module("logic.extensions.commontabrank.view.goddesscompetition.GoddessCompetitionActivityChildRankView", package.seeall)

local GoddessCompetitionActivityChildRankView = class("GoddessCompetitionActivityChildRankView", ViewComponent)

function GoddessCompetitionActivityChildRankView:buildUI()
	GoddessCompetitionActivityChildRankView.super.buildUI(self)
...
function GoddessCompetitionActivityChildRankView:bindEvents()
	GoddessCompetitionActivityChildRankView.super.bindEvents(self)
end

function GoddessCompetitionActivityChildRankView:unbindEvents()
	GoddessCompetitionActivityChildRankView.super.unbindEvents(self)
end

function GoddessCompetitionActivityChildRankView:onEnter()
	GoddessCompetitionActivityChildRankView.super.onEnter(self)
	...
	GoddessCompetitionController.instance:getAllGoddessRank(self._activityId, -1)
end

function GoddessCompetitionActivityChildRankView:onExit()
	GoddessCompetitionActivityChildRankView.super.onExit(self)
	self._rankScrollList:dispose()
	self._myPrizeScrollList:dispose()
end

function GoddessCompetitionActivityChildRankView:_handleMsgRes(msg)
...
function GoddessCompetitionActivityChildRankView:_getPrizesByRank(rank)
	local data = GoddessCompetitionConfig.instance:getActivityRankPrizeCfgByRank(self._activityId, rank)

	return data and data.prize
end

function GoddessCompetitionActivityChildRankView:_onUpdate()
...
function GoddessCompetitionActivityChildRankView:_updateRankCell(view, cell, info, tag)
...
function GoddessCompetitionActivityChildRankView:_clearRankCell(cell)
	local mainGo = cell.gameObject
	local headRoot = goutil.findChild(mainGo, "headRoot")
...
function GoddessCompetitionActivityChildRankView:_updateItemCell(view, cell, prizeStr, tag)
	local mainGo = cell.gameObject

	MaterialMgr.setCellByCfg(prizeStr, mainGo)
end

function GoddessCompetitionActivityChildRankView:_clearItemCell(cell)
	local mainGo = cell.gameObject

	MaterialMgr.resetAll(mainGo)
end

function GoddessCompetitionActivityChildRankView:_updateMyPrizeItemCell(view, cell, prizeStr, tag)
	local mainGo = cell.gameObject

	MaterialMgr.setCellByCfg(prizeStr, mainGo)
end

function GoddessCompetitionActivityChildRankView:_clearMyPrizeItemCell(cell)
	local mainGo = cell.gameObject

	MaterialMgr.resetAll(mainGo)
end

return GoddessCompetitionActivityChildRankView
