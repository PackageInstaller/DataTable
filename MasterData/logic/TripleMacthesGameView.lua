-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/triplemacthesgame/view/TripleMacthesGameView.lua

module("logic.extensions.triplemacthesgame.view.TripleMacthesGameView", package.seeall)

local TripleMacthesGameView = class("TripleMacthesGameView", ViewComponent)

TripleMacthesGameView.IceIndex = -2

function TripleMacthesGameView:ctor()
	TripleMacthesGameView.super.ctor(self)
...
function TripleMacthesGameView:bindEvents()
	return
end

function TripleMacthesGameView:unbindEvents()
	return
end

function TripleMacthesGameView:addGlobalEvent()
...
function TripleMacthesGameView:rmGlobalEvent()
...
function TripleMacthesGameView:buildUI()
...
function TripleMacthesGameView:destroyUI()
	return
end

function TripleMacthesGameView:onEnter()
	self:addGlobalEvent()
...
function TripleMacthesGameView:onEnterFinished()
	return
end

function TripleMacthesGameView:onExit()
	self:rmGlobalEvent()
...
function TripleMacthesGameView:onExitFinished()
...
function TripleMacthesGameView:_initView()
	self:initGame()
end

function TripleMacthesGameView:_onCustomInputCallback()
	GameUtil.SetActive(self._tips, false)
end

function TripleMacthesGameView:onHelpClick()
	GameUtil.SetActive(self._tips, true)
end

function TripleMacthesGameView:_onClickClose()
...
function TripleMacthesGameView:_getCellResPath(sxGameCellMO)
	return sxGameCellMO:getCellRes()
end

function TripleMacthesGameView:genarateCell(type, rssPath, cellDat)
...
function TripleMacthesGameView:_removeAllCell()
	local size = TripleMacthesGameModel.instance:getGameMapSize()
...
function TripleMacthesGameView:_swapCell(back)
...
function TripleMacthesGameView:_removeCell()
	...
	speicalIce:ForEach(function(info, index)
		...
		self._specialCell[info.specialType][targetCell][TripleMacthesGameView.IceIndex] = self._specialCell[info.specialType][targetCell][TripleMacthesGameView.IceIndex] or {}

		table.insert(self._specialCell[info.specialType][targetCell][TripleMacthesGameView.IceIndex], cell)
	end)
	...
	if self._specialCell[SxGameCellType.Fly] then
		for formCell, toCells in pairs(self._specialCell[SxGameCellType.Fly]) do
			...
			for i, toCell in ipairs(toCells[TripleMacthesGameView.IceIndex] or {}) do
				_removeCellCount = _removeCellCount + 1
...
function TripleMacthesGameView:_fallDown()
	TripleMacthesGameModel.instance:removeAction()
...
function TripleMacthesGameView:_waitFallDown()
	local size = TripleMacthesGameModel.instance:getGameMapSize()
...
function TripleMacthesGameView:_waitOffsetDown()
	local size = TripleMacthesGameModel.instance:getGameMapSize()
	local move = false
...
function TripleMacthesGameView:_fallDownFinish()
	self:checkEmptyCell()
	settimer(0.4, self._checkContinue, self, false)
	self:_refreshGift()
end

function TripleMacthesGameView:_checkSpecial()
...
function TripleMacthesGameView:_checkCellFallDown(i)
	local size = TripleMacthesGameModel.instance:getGameMapSize()
...
function TripleMacthesGameView:_checkCellOffsetDown(i)
	local size = TripleMacthesGameModel.instance:getGameMapSize()
	local isMove = false
...
function TripleMacthesGameView:_checkSupplyCell(i)
	local size = TripleMacthesGameModel.instance:getGameMapSize()
	local from_y, count = -1, 0
	local blockIdx = 0
...
function TripleMacthesGameView:_supplyCell(x, from_y, num)
...
function TripleMacthesGameView:checkEmptyCell()
	local size = TripleMacthesGameModel.instance:getGameMapSize()
...
function TripleMacthesGameView:_refreshGift()
	return
end

function TripleMacthesGameView:_checkContinue()
	TripleMachesGameController.instance:continueFindScore()
end

function TripleMacthesGameView:_nextStep()
	TripleMacthesGameModel.instance:reduceStep()
end

function TripleMacthesGameView:_onNormalEffect(cellGo, callback, type, specialType)
...
function TripleMacthesGameView:_onSpecialEffect(operateMo, callback)
	if operateMo then
...
function TripleMacthesGameView:_onFlyEffect(formCell, toCell, callback)
	function disposeFunc(obj)
		goutil.destroy(obj)
	end
...
function TripleMacthesGameView:_onRainbowEffect(formCell, toCell, callback)
	function disposeFunc(obj)
		goutil.destroy(obj)
	end
...
function TripleMacthesGameView:_checkGameOverByStep()
	return
end

function TripleMacthesGameView:_onCombo()
...
function TripleMacthesGameView:testCell()
	for i = 1, 8 do
		local str = " "
...
function TripleMacthesGameView:_onSxCellSel()
	local actions = TripleMacthesGameModel.instance:getActions()
...
function TripleMacthesGameView:_onSxCellDeSel(x, y)
...
function TripleMacthesGameView:removeAllSelEffect()
	local size = TripleMacthesGameModel.instance:getGameMapSize()
...
function TripleMacthesGameView:_removeAllSpecial()
...
function TripleMacthesGameView:_getActivityId()
	printError("_getActivityId获取活动Id")
end

function TripleMacthesGameView:_getStageId()
	printError("_getStageId获取关卡id")
end

function TripleMacthesGameView:initGame()
...
function TripleMacthesGameView:_resetMap()
	local size = TripleMacthesGameModel.instance:getGameMapSize()
