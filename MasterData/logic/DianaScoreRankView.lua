-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/lailisi/view/diana/DianaScoreRankView.lua

module("logic.extensions.lailisi.view.diana.DianaScoreRankView", package.seeall)

local DianaScoreRankView = class("DianaScoreRankView", ViewComponent)

function DianaScoreRankView:ctor()
	DianaScoreRankView.super.ctor(self)
end

function DianaScoreRankView:unbindEvents()
	DianaScoreRankView.super.unbindEvents(self)
	self._closeBtn:RemoveClickListener()
end

function DianaScoreRankView:bindEvents()
	DianaScoreRankView.super.bindEvents(self)
	self._closeBtn:AddClickListener(function()
		self:close()
	end, self)
end

function DianaScoreRankView:onExit()
	DianaScoreRankView.super.onExit(self)
	GlobalDispatcher:removeListener(GlobalNotify.LailisiRank, self._updateRank, self)
end

function DianaScoreRankView:buildUI()
	DianaScoreRankView.super.buildUI(self)
...
function DianaScoreRankView:onEnter()
	DianaScoreRankView.super.onEnter(self)
	GlobalDispatcher:addListener(GlobalNotify.LailisiRank, self._updateRank, self)
	LailisiController.instance:sendPM_ActorGainDamageRankReq(165022)

	self._tipTxt.text = LailisiConfig.instance:getCommonCfg("challenge_rank_y")
end

function DianaScoreRankView:_updateRank()
...
function DianaScoreRankView:_updateRankInfo(view, cell, data)
	if data == nil then
		return
	end
...
function DianaScoreRankView:_clearItemCell()
	return
end

function DianaScoreRankView:onHeadClick(userId, imgIcon)
	print("onHeadClick")
	FriendController.instance:showInfoView(userId, imgIcon)
end

return DianaScoreRankView
