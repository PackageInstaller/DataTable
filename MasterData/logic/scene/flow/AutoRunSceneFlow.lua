-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/scene/flow/AutoRunSceneFlow.lua

module("logic.scene.flow.AutoRunSceneFlow", package.seeall)

local M = class("AutoRunSceneFlow", DefaultSceneFlow)
