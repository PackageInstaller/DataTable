-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/domainadventure/view/rank/DomAdvEliteFightRankView.lua

module("logic.extensions.tourarena.view.DomAdvEliteFightRankView", package.seeall)

local DomAdvEliteFightRankView = class("DomAdvEliteFightRankView", ViewComponent)

function DomAdvEliteFightRankView:buildUI()
	DomAdvEliteFightRankView.super.buildUI(self)
...
function DomAdvEliteFightRankView:bindEvents()
	DomAdvEliteFightRankView.super.bindEvents(self)
	GameUtil.addClickHandler(self._btnClose, self.close, self)
end

function DomAdvEliteFightRankView:unbindEvents()
	DomAdvEliteFightRankView.super.unbindEvents(self)
	GameUtil.rmClickHandler(self._btnClose)
end

function DomAdvEliteFightRankView:onEnter()
	DomAdvEliteFightRankView.super.onEnter(self)
...
function DomAdvEliteFightRankView:onExit()
	DomAdvEliteFightRankView.super.onExit(self)
	self._rankScrollList:dispose()
	self._myPrizeScrollList:dispose()
end

function DomAdvEliteFightRankView:_handlePM_DomainAdventureRankViewRes(msg)
	self._rankMsg = msg
...
function DomAdvEliteFightRankView:_getPrizesByRank(rank)
	local prize
...
function DomAdvEliteFightRankView:_onUpdate()
...
function DomAdvEliteFightRankView:_updateRankCell(view, cell, info, tag)
...
function DomAdvEliteFightRankView:_clearRankCell(cell)
	local mainGo = cell.gameObject
	local head = goutil.findChild(mainGo, "head")
...
function DomAdvEliteFightRankView:_updateItemCell(view, cell, prizeStr, tag)
	local mainGo = cell.gameObject

	MaterialMgr.setCellByCfg(prizeStr, mainGo)
end

function DomAdvEliteFightRankView:_clearItemCell(cell)
	local mainGo = cell.gameObject

	MaterialMgr.resetAll(mainGo)
end

function DomAdvEliteFightRankView:_updateMyPrizeItemCell(view, cell, prizeStr, tag)
	local mainGo = cell.gameObject

	MaterialMgr.setCellByCfg(prizeStr, mainGo)
end

function DomAdvEliteFightRankView:_clearMyPrizeItemCell(cell)
	local mainGo = cell.gameObject

	MaterialMgr.resetAll(mainGo)
end

return DomAdvEliteFightRankView
