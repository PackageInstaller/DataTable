-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/season/view/teamcampshow/SeasonTeamElvenHallView.lua

module("logic.extensions.season.view.teamcampshow.SeasonTeamElvenHallView", package.seeall)

local SeasonTeamElvenHallView = class("SeasonTeamElvenHallView", ViewComponent)

function SeasonTeamElvenHallView:ctor()
	SeasonTeamElvenHallView.super.ctor(self)
end

function SeasonTeamElvenHallView:unbindEvents()
	SeasonTeamElvenHallView.super.unbindEvents(self)
...
function SeasonTeamElvenHallView:bindEvents()
	SeasonTeamElvenHallView.super.bindEvents(self)
...
function SeasonTeamElvenHallView:buildUI()
	SeasonTeamElvenHallView.super.buildUI(self)
...
function SeasonTeamElvenHallView:onExit()
	SeasonTeamElvenHallView.super.onExit(self)
...
function SeasonTeamElvenHallView:onEnter()
	SeasonTeamElvenHallView.super.onEnter(self)
	...
	SeasonController.instance:sendGetHirePetInfo(self._teammateId)
	GameUtil.SetActive(self._petList, false)
	GameUtil.SetActive(self._btnTip, false)
end

function SeasonTeamElvenHallView:onRefreshUI()
	local list = {}
...
function SeasonTeamElvenHallView:clearCell(cell)
	local con = goutil.findChild(cell, "con")

	MaterialMgr.resetAll(con)
end

function SeasonTeamElvenHallView:_updateCell(view, cell, data, tag)
	local con = goutil.findChild(cell, "con")
...
function SeasonTeamElvenHallView:_onDragBegin(eventData, data)
	self:showDragPet(data)
end

function SeasonTeamElvenHallView:_onDragMove(eventData, data)
	self.dragPetGo.transform.position = uGuiUtil.GetTouchWorldPosition()
end

function SeasonTeamElvenHallView:_onDragEnd(eventData, data)
	self:hideDragPet(data)
end

function SeasonTeamElvenHallView:showDragPet(petMo, dropGo)
	self:hideDragPet()
...
function SeasonTeamElvenHallView:hideDragPet()
...
function SeasonTeamElvenHallView:_OnDropLeftCell(go, eventData, idx)
...
function SeasonTeamElvenHallView:sendHirePet(idx, mo)
	local petDefineId = mo.petId

	SeasonController.instance:sendHirePetByIdx(idx, petDefineId)
end

function SeasonTeamElvenHallView:updateCellByOtherInfo(cell, data)
...
function SeasonTeamElvenHallView:onClickPetCell(petMo, cell)
	local goOrPos

	CommonTipsMgr.instance:showBuddyHirePetTips(petMo, BuddyhiredetailView.TYPE_HIRE_INFO, goOrPos, nil)
end

function SeasonTeamElvenHallView:updateFilterData(starList, jobList, rareList)
	self:_RefreshPetList()
end

function SeasonTeamElvenHallView:_RefreshPetList(force)
	self._curViewDatas = {}
...
function SeasonTeamElvenHallView:onFilter(petMo)
...
function SeasonTeamElvenHallView:_isMatch(cfg, rare, skinId)
	return PetFilterMgr.instance:checkIsMatch(PetFilterMgr.TYPE_SEASON_HIRE, cfg, rare, skinId)
end

function SeasonTeamElvenHallView:_OnSearchTextChanged()
...
function SeasonTeamElvenHallView:_getPosAndSizeDelta(go)
...
function SeasonTeamElvenHallView:_onClickFilter()
...
function SeasonTeamElvenHallView:onClearSearchClick()
	self._inputSearch.input.text = ""
end

function SeasonTeamElvenHallView:_onClickTip()
	UIStateManager.instance:open(ViewName.RulesView, "SpiritHall_rule")
end

return SeasonTeamElvenHallView
