-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/jiehuangchallenge/view/JieHuangChallengeLevelView.lua

module("logic.extensions.jiehuangchallenge.view.JieHuangChallengeLevelView", package.seeall)

local JieHuangChallengeLevelView = class("JieHuangChallengeLevelView", ViewComponent)

function JieHuangChallengeLevelView:ctor()
	JieHuangChallengeLevelView.super.ctor(self)
end

function JieHuangChallengeLevelView:buildUI()
	JieHuangChallengeLevelView.super.buildUI(self)
	...
	self._panEffectGo = self:getGo("panEffect")
	...
	self._shortArrow = self:getGo("empty/pan/arrowShort")
...
function JieHuangChallengeLevelView:bindEvents()
	JieHuangChallengeLevelView.super.buildUI(self)
...
function JieHuangChallengeLevelView:unbindEvents()
	JieHuangChallengeLevelView.super.unbindEvents(self)
...
function JieHuangChallengeLevelView:onEnter()
	JieHuangChallengeLevelView.super.onEnter(self)
	...
	self._clockEff = UIEffectManager.instance:playEffect(self, "20230825/jiehuangtiaozhan/fx_ui_jiehuangtiaozhan_lunpan2.prefab", nil, 0, 0, true)

	self._clockEff:setParent(self._clockEffectGo.transform)
	self._clockEff:setLocalPos(0, 0, 0)
	self._clockEff:setScale(1)

	self._panEff = UIEffectManager.instance:playEffect(self, "20230825/jiehuangtiaozhan/fx_ui_jiehuangtiaozhan_lunpan1.prefab", nil, 0, 0, true)

	self._panEff:setParent(self._panEffectGo.transform)
	self._panEff:setLocalPos(0, 0, 0)
	self._panEff:setScale(1)
...
function JieHuangChallengeLevelView:onExit()
	JieHuangChallengeLevelView.super.onExit(self)
	...
	UIEffectManager.instance:stopEffect(self._clockEff)
	UIEffectManager.instance:stopEffect(self._panEff)
	self._stageTable:dispose()
	self._prizeTabel:dispose()
end

function JieHuangChallengeLevelView:_refreshView()
	...
	if self._haveLevel == false then
		...
		GameUtil.SetActive(self._clockEffectGo, false)
		GameUtil.SetActive(self._panEffectGo, true)
		GameUtil.SetActive(self._pan, true)
		GameUtil.SetActive(self._levels, false)
		GameUtil.SetActive(self._stageInfo, false)
...
function JieHuangChallengeLevelView:_refreshInfoView()
	local stageInfo
	...
	if MiyaChallengeModel.instance:getExchangeBuff() then
		UIStateManager.instance:push(ViewName.JieHuangChallengeSelectView, self.activityId, self._selectBigStage, MiyaChallengeModel.instance:getStageSelect(self._selectBigStage))
	end
...
function JieHuangChallengeLevelView:_updateStageCell(view, cell, data, tag)
...
function JieHuangChallengeLevelView:_clearStageCell(cell)
	local go = cell.gameObject
	local btn = GameUtil.asBtn(go)
...
function JieHuangChallengeLevelView:_updatePrizeCell(view, cell, data, tag)
	local go = cell.gameObject

	MaterialMgr.setCellByCfg(data, go)
end

function JieHuangChallengeLevelView:_clearPrizeCell(cell)
	local go = cell.gameObject

	MaterialMgr.resetAll(go)
end

function JieHuangChallengeLevelView:_firstEnter()
	function completeEnd()
		if self._haveLevel == true and self._selectBigStage ~= 0 then
			self:_onClickBigStage(self._selectBigStage)
		else
			GameUtil.SetActive(self._empty, true)
			GameUtil.SetActive(self._clockEffectGo, true)
			GameUtil.SetActive(self._panEffectGo, false)
...
function JieHuangChallengeLevelView:_showInfo()
...
function JieHuangChallengeLevelView:_onClickBigStage(bigStage)
	removetimer(self._firstEnter, self)
	self:_showInfo()
...
function JieHuangChallengeLevelView:_onClickClose()
	if self._haveLevel == false then
		self:close()
...
function JieHuangChallengeLevelView:_onClickRule()
	UIStateManager.instance:open(ViewName.RulesView, self._activityCfg.ruleKey)
end

function JieHuangChallengeLevelView:_onClickStart()
	if MiyaChallengeModel.instance:getExchangeBuff() then
		UIStateManager.instance:push(ViewName.JieHuangChallengeSelectView, self.activityId, self._selectBigStage, MiyaChallengeModel.instance:getStageSelect(self._selectBigStage))
	...
	if MiyaChallengeModel.instance:getBuff() then
		...
		UIStateManager.instance:push(ViewName.JieHuangChallengeWheelView)
	end
end

function JieHuangChallengeLevelView:_onClickReload()
	if MiyaChallengeModel.instance:getExchangeBuff() then
		UIStateManager.instance:push(ViewName.JieHuangChallengeSelectView, self.activityId, self._selectBigStage, MiyaChallengeModel.instance:getStageSelect(self._selectBigStage))
...
function JieHuangChallengeLevelView:_onClickReward()
	UIStateManager.instance:push(ViewName.JieHuangChallengeRewardView)
end

function JieHuangChallengeLevelView:_onClockTime()
...
function JieHuangChallengeLevelView:_moveArrow()
	self._longArrow.transform:Rotate(0, 0, 1)
	self._midArrow.transform:Rotate(0, 0, 2)
	self._shortArrow.transform:Rotate(0, 0, 3)
end

return JieHuangChallengeLevelView
