-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/config/t_lang_launcher_tips.lua

module("logic.config.t_lang_launcher_tips", package.seeall)
...
local t_lang_launcher_tips = {}

t_lang_launcher_tips.dataList = dataList
...
for i, v in ipairs(dataList) do
	t_lang_launcher_tips[v[1]] = v

	setmetatable(v, mt)
end

return t_lang_launcher_tips
