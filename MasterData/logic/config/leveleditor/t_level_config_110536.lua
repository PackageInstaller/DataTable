-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/config/leveleditor/t_level_config_110536.lua

module("logic.config.leveleditor.t_level_config_110536", package.seeall)
