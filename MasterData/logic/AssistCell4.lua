-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xiaonuoassistant/view/cell/AssistCell4.lua

module("logic.extensions.xiaonuoassistant.view.cell.AssistCell4", package.seeall)

local AssistCell4 = class("AssistCell4", BaseAssistCell)

function AssistCell4:ctor(luaComponentContainer)
	AssistCell4.super.ctor(self, luaComponentContainer)
...
function AssistCell4:init(data)
	AssistCell4.super.init(self, data)
...
function AssistCell4:reset()
	self._btn1:RemoveClickListener()
end

function AssistCell4:_selectAll()
	self._data:setCellSelect(self._data.selectIndex1, true)
	self:_setBtnIsOn1(true)
end

function AssistCell4:_cancelAll()
	return
end

function AssistCell4:_onClickBtn1()
...
function AssistCell4:_setBtnIsOn1(isOn)
