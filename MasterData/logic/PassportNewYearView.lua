-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/passport/view/PassportNewYearView.lua

module("logic.extensions.passport.view.PassportNewYearView", package.seeall)

local PassportNewYearView = class("PassportNewYearView", ViewComponent)

function PassportNewYearView:buildUI()
	PassportNewYearView.super.buildUI(self)
...
function PassportNewYearView:bindEvents()
	PassportNewYearView.super.bindEvents(self)
...
function PassportNewYearView:unbindEvents()
	PassportNewYearView.super.unbindEvents(self)
...
function PassportNewYearView:onEnter()
	PassportNewYearView.super.onEnter(self)

	self._passPortFuncId = 12
	...
	RedPointController.instance:regRedPoint(self._rdTask, RedPointModel.ID_PASSPORT_NEWYEAR_TASK)
...
function PassportNewYearView:onExit()
	PassportNewYearView.super.onExit(self)
...
function PassportNewYearView:_refreshView()
...
function PassportNewYearView:_refreshPayBtn()
	goutil.setActive(self._goPay, not self._curData.hasPay)
end

function PassportNewYearView:_refreshOneKey()
...
function PassportNewYearView:_resetActTimePart()
	removetimer(self._onCountDonw, self)
	goutil.setActive(self._timeTips, false)
end

function PassportNewYearView:_setActTimePart()
	self:_resetActTimePart()
	self:_onCountDonw()
...
function PassportNewYearView:_onCountDonw()
...
function PassportNewYearView:_getCurDataList()
	local dataList = {}
...
function PassportNewYearView:_updateCell(view, goCell, data)
...
function PassportNewYearView:_clearCell(goCell)
	local cell = {}
...
function PassportNewYearView:_refreshShowCell(dataId)
...
function PassportNewYearView:_onClickHelp()
	ViewMgr.instance:open(ViewName.RulesView, self._curData.funcCfg.rule)
end

function PassportNewYearView:_onClickGoTo()
	UIStateManager.instance:push(ViewName.PassportNewYearTaskView, self._curData.actId)
end

function PassportNewYearView:_onClickOneKey()
...
function PassportNewYearView:_playCellEff(go)
	if not go then
		return
	end
...
function PassportNewYearView:_removeCellEff(go)
	if not go then
		return
	end
...
function PassportNewYearView:_onClickPay()
...
function PassportNewYearView:_onClickGetExtra()
...
function PassportNewYearView:_onClickRuleExtra()
	UIStateManager.instance:push(ViewName.RulesView, "passportwpextraprize")
end

return PassportNewYearView
