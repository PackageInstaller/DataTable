-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xiaonuoassistant/view/cell/AssistCell6.lua

module("logic.extensions.xiaonuoassistant.view.cell.AssistCell6", package.seeall)

local AssistCell6 = class("AssistCell6", BaseAssistCell)

function AssistCell6:ctor(luaComponentContainer)
	AssistCell6.super.ctor(self, luaComponentContainer)
...
function AssistCell6:init(data)
	AssistCell6.super.init(self, data)
...
function AssistCell6:reset()
	self._btn1:RemoveClickListener()
end

function AssistCell6:_selectAll()
	self._data:setCellSelect(self._data.selectIndex1, true)
	self:_setBtnIsOn1(true)
end

function AssistCell6:_cancelAll()
	return
end

function AssistCell6:_onClickBtn1()
...
function AssistCell6:_setBtnIsOn1(isOn)
