-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/operationsummary/view/dragonancestor/DragonAncestorSummaryView.lua

module("logic.extensions.operationsummary.view.dragonancestor.DragonAncestorSummaryView", package.seeall)

local DragonAncestorSummaryView = class("DragonAncestorSummaryView", ActivityGrandSummaryView)

DragonAncestorSummaryView.StoryKey = "DragonAncestorSummaryView_PlayStory"

function DragonAncestorSummaryView:_getSumActivityId()
...
function DragonAncestorSummaryView:buildUI()
	DragonAncestorSummaryView.super.buildUI(self)

	self._btnShowCol = goutil.findChild(self.mainGO, "btnShowCol")
	self._tweenPool = {}
end

function DragonAncestorSummaryView:bindEvents()
	DragonAncestorSummaryView.super.bindEvents(self)
end

function DragonAncestorSummaryView:unbindEvents()
	DragonAncestorSummaryView.super.unbindEvents(self)
end

function DragonAncestorSummaryView:onEnter()
	DragonAncestorSummaryView.super.onEnter(self)
...
function DragonAncestorSummaryView:onExit()
	DragonAncestorSummaryView.super.onExit(self)
	self:clearShowAnim()
	self:clearBtnShowCol()
end

function DragonAncestorSummaryView:onUpdateUI()
	DragonAncestorSummaryView.super.onUpdateUI(self)
	self:updateBtnShowCol()
end

function DragonAncestorSummaryView:CreatActivity()
	DragonAncestorSummaryView.super.CreatActivity(self)
...
function DragonAncestorSummaryView:getPoolKey(cellName)
	return cellName .. "_cell"
end

function DragonAncestorSummaryView:updateActivity()
	DragonAncestorSummaryView.super.updateActivity(self)
...
function DragonAncestorSummaryView:updateBtnShowCol()
	local parent = self._btnShowCol.transform
...
function DragonAncestorSummaryView:clearBtnShowCol()
	local parent = self._btnShowCol.transform
...
function DragonAncestorSummaryView:onClickBtnShow(go)
...
function DragonAncestorSummaryView:playeCellsShowAnim()
	removetimer(self.updateTime, self)
	settimer(0.1, self.updateTime, self, true)
end

function DragonAncestorSummaryView:updateTime()
	local doNum = 0
...
function DragonAncestorSummaryView:doScaleAnim(go, scale, callBack)
...
function DragonAncestorSummaryView:clearAnimByGo(go)
	if self._tweenPool[go] then
		self._tweenPool[go]:Kill(true)
	end
end

function DragonAncestorSummaryView:clearShowAnim()
	removetimer(self.updateTime, self)
...
function DragonAncestorSummaryView:_playStory(key, id)
...
return DragonAncestorSummaryView
