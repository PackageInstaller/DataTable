-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/xinxiyamirror/view/XinxiyaListViewPresentor.lua

module("logic.extensions.xinxiyamirror.view.SunranResultViewPresentor", package.seeall)
...
function SunranResultViewPresentor:dependWhatResources()
	return {
		"ui/views/xinxiyamirror/xinxiyalistview.prefab"
	}
end
