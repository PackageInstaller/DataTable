-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/annualfuben/view/AnnualFubenDamageRankView.lua

module("logic.extensions.annualfuben.view.AnnualFubenDamageRankView", package.seeall)

local AnnualFubenDamageRankView = class("AnnualFubenDamageRankView", ViewComponent)

function AnnualFubenDamageRankView:ctor()
	AnnualFubenDamageRankView.super.ctor(self)
end

function AnnualFubenDamageRankView:unbindEvents()
	AnnualFubenDamageRankView.super.unbindEvents(self)
	GameUtil.rmClickHandler(self._btnClose)
end

function AnnualFubenDamageRankView:bindEvents()
	AnnualFubenDamageRankView.super.bindEvents(self)
	GameUtil.addClickHandler(self._btnClose, self.close, self)
end

function AnnualFubenDamageRankView:buildUI()
	AnnualFubenDamageRankView.super.buildUI(self)
...
function AnnualFubenDamageRankView:onExit()
	AnnualFubenDamageRankView.super.onExit(self)
...
function AnnualFubenDamageRankView:onEnter()
	AnnualFubenDamageRankView.super.onEnter(self)
	self.addGEvent(self, GlobalNotify.PM_AnnualFubenRankInfoRes, self._refreshView, self)

	self._itemTableListDir = {}
	self._activityId = checknumber(self:getFirstParam())

	AnnualFubenAgent.instance:sendPM_AnnualFubenBossRankInfoReq(self._activityId)
end

function AnnualFubenDamageRankView:_refreshView()
	...
	if not rankInfo.rankInfos then
		...
		local rankPrizeCfgs = AnnualFubenConfig.instance:getBossRankPrizeCfgs(self._activityId)
		...
		self._txtMyStep.text = AnnualFubenModel.instance:getHistoryBossDamge(self._activityId)
	end
end

function AnnualFubenDamageRankView:_updateRankCell(view, cell, data, tag)
...
function AnnualFubenDamageRankView:_clearRankCell(cell)
	local go = cell.gameObject
	local imgIcon = goutil.findChild(go, "imgHeadIcon")
...
function AnnualFubenDamageRankView:_updateItemCell(view, cell, data, tag)
	local go = cell.gameObject
...
function AnnualFubenDamageRankView:_clearItemCell(cell)
	local go = cell.gameObject

	MaterialMgr.resetAll(go)
end

return AnnualFubenDamageRankView
