-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/entrance/view/EntranceAdmitCertificateViewPresentor.lua
...
function EntrancecertificateViewPresentor:buildViews()
	return {
		EntranceAdmitCertificateView.New()
	}
end
