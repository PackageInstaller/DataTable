-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/moonking/view/MoonKingBattleView.lua

module("logic.extensions.moonking.view.MoonKingBattleView", package.seeall)

local MoonKingBattleView = class("MoonKingBattleView", ViewComponent)

function MoonKingBattleView:ctor()
	MoonKingBattleView.super.ctor(self)
...
function MoonKingBattleView:bindEvents()
	MoonKingBattleView.super.bindEvents(self)
...
function MoonKingBattleView:unbindEvents()
	MoonKingBattleView.super.unbindEvents(self)
...
function MoonKingBattleView:onExit()
	MoonKingBattleView.super.onExit(self)
...
function MoonKingBattleView:destroyUI()
	MoonKingBattleView.super.destroyUI(self)
...
function MoonKingBattleView:buildUI()
	MoonKingBattleView.super.buildUI(self)
...
function MoonKingBattleView:registCallbacks()
...
function MoonKingBattleView:_MoshiInView()
...
function MoonKingBattleView:_MoshiAtIndex(view, index)
	local cell
...
function MoonKingBattleView:_OnMoshiCellUpdate(view, cell)
...
function MoonKingBattleView:_RewardInView()
...
function MoonKingBattleView:_RewardAtIndex(view, index)
	local cell
	local cell = view:DequeueCell()
...
function MoonKingBattleView:_OnRewardCellUpdate(view, cell)
	local index = cell.index
	local data = self._curRewardDatas[index + 1]
...
function MoonKingBattleView:onEnter()
	MoonKingBattleView.super.onEnter(self)
	...
	if curChallId <= 0 then
		curChallId = MoonKingModel.instance.challengeId
	end

	MoonKingModel.instance:setMoonkingChooseBuff()

	local str = string.format("MoonkingViewRed_%s_%s", curChallId, LoginModel.instance.userId)
...
function MoonKingBattleView:_showActivityTimer()
...
function MoonKingBattleView:_calculationSurplusTime()
...
function MoonKingBattleView:_updataBattleViewInfo(challId, isPrize)
...
function MoonKingBattleView:_updateMoshiCell(view, cell, data)
...
function MoonKingBattleView:_showChoiseStageInfo(index)
...
function MoonKingBattleView:_updateRewardCell(view, cell, data)
...
function MoonKingBattleView:_updateShowProgressBar()
	if self._curRewardDatas then
		if not #self._curRewardDatas then
			local count = 0
...
function MoonKingBattleView:_onClickNanduBtn()
