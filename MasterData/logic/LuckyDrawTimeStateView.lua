-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logic/extensions/luckydraw/view/LuckyDrawTimeStateView.lua

module("logic.extensions.luckydraw.view.LuckyDrawTimeStateView", package.seeall)

local LuckyDrawTimeStateView = class("LuckyDrawTimeStateView", ViewComponent)

function LuckyDrawTimeStateView:buildUI()
	LuckyDrawTimeStateView.super.buildUI(self)
	...
	self._rare = self:getGo("petInfo/imgRare"):GetComponent("UIImageSpriteChange")
...
function LuckyDrawTimeStateView:onEnter()
	LuckyDrawTimeStateView.super.onEnter(self)
...
function LuckyDrawTimeStateView:dealWithActIdAndRDId()
...
function LuckyDrawTimeStateView:onExit()
	LuckyDrawTimeStateView.super.onExit(self)
...
function LuckyDrawTimeStateView:bindEvents()
	LuckyDrawTimeStateView.super.bindEvents(self)
...
function LuckyDrawTimeStateView:unbindEvents()
	LuckyDrawTimeStateView.super.unbindEvents(self)
...
function LuckyDrawTimeStateView:_onClickTip()
	UIStateManager.instance:push(ViewName.RulesView, "luckydrawtimestaterule")
end

function LuckyDrawTimeStateView:_onClickTipMin()
	UIStateManager.instance:push(ViewName.RulesView, "luckydrawtimestateminrule")
end

function LuckyDrawTimeStateView:_onClickStart()
...
function LuckyDrawTimeStateView:_onClickPrizeCell(id)
...
function LuckyDrawTimeStateView:_onClickInfo()
...
function LuckyDrawTimeStateView:_onClickSkill()
	if self._showSkinCfg then
		PetbookController.instance:previewBattle(self._showSkinCfg.raceId, self._showSkinCfg.skinId)
	end
end

function LuckyDrawTimeStateView:_onClickMark()
	FloatWordMgr.instance:show("抽奖中，请稍等")
end

function LuckyDrawTimeStateView:_setViewByCfg()
	...
	if self._actCommonCfg then
		if not self._actCommonCfg.mainEffPath then
			...
			self._showSkinCfg = self._actCommonCfg.skinIds and PetSkinConfig.instance:getPetSkinCfg(self._actCommonCfg.skinIds[1])
			...
			if skinCfg then
				...
				self._rare:SetState(skinCfg.quality)
			end
		end
	end
end

function LuckyDrawTimeStateView:_setPrizeCellsByCfg()
...
function LuckyDrawTimeStateView:_setProgressTipsByCfg()
...
function LuckyDrawTimeStateView:_setCostMatByCfg()
	if self._actCommonCfg then
...
function LuckyDrawTimeStateView:_setCountTimerByCfg()
...
function LuckyDrawTimeStateView:_timerCountDown()
...
function LuckyDrawTimeStateView:_updateViewByData()
...
function LuckyDrawTimeStateView:_setProgressInfo()
...
function LuckyDrawTimeStateView:_setGaintPrizeState()
...
function LuckyDrawTimeStateView:_setRankInfo()
	removetimer(self._showNewRank, self)
...
function LuckyDrawTimeStateView:_showNewRank()
...
function LuckyDrawTimeStateView:getCurTotalCostNum(time)
...
function LuckyDrawTimeStateView:_startDrawAni(prizeIds)
...
function LuckyDrawTimeStateView:_endDrawAni()
...
function LuckyDrawTimeStateView:_rorateEff()
...
function LuckyDrawTimeStateView:_rorateEffNext()
	local lastSelectId = self._curSelectId
...
function LuckyDrawTimeStateView:_createEff(effPath, effParent, effKey, isLoop)
...
function LuckyDrawTimeStateView:_removeAllEffect()
...
function LuckyDrawTimeStateView:_removeEffect(key)
	if self._exictEffs then
		if self._exictEffs then
