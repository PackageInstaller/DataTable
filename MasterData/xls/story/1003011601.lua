...
return
{
  ...
  Steps = {
    ...
    },
    {
      ...
      WorldDicId = -1,
      Background = {
        Image = "ExStoryBg1_06_5b",
        BgScale = 1.0,
        InsertAnimList = empty,
        LocationName = "天文台前",
        LocationNameLanguageId = "1003011601_51",
        ExtraBgScale = 1.0
      },
      Talking = {
        Level = 2,
