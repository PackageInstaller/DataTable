  ...
  Steps = {
    ...
    },
    {
      ...
      Sound = {
        ...
        SoundDatas = {
          {
            Sound = "scene_ambience_rain_yard",
            SoundVolume = 1.0,
            ShowSound = true,
            Show = empty,
            Hide = empty,
