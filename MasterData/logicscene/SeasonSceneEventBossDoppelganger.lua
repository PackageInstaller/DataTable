-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logicscene/scene/unit/component/season/events/SeasonSceneEventBossDoppelganger.lua

module("logicscene.scene.unit.component.season.events.SeasonSceneEventBossDoppelganger", package.seeall)

local SeasonSceneEventBossDoppelganger = class("SeasonSceneEventBossDoppelganger", SeasonSceneEventChallengeImpl)

function SeasonSceneEventBossDoppelganger:_getModelResPath()
...
function SeasonSceneEventBossDoppelganger:handleBossPhaseChange(prePhaseId, curPhaseId)
...
function SeasonSceneEventBossDoppelganger:setPlayedDoppelgangerAppear()
	self._preparePlayDoppelgangerAppear = false

	self._unit:setVisible(true)
end

function SeasonSceneEventBossDoppelganger:setPlayedBossAppear()
	self._preparePlayDoppelgangerDisappear = false

	self:onDeactive()
end

function SeasonSceneEventBossDoppelganger:_onModelLoadedFinish()
	SeasonSceneEventBossDoppelganger.super._onModelLoadedFinish(self)
...
function SeasonSceneEventBossDoppelganger:_needShowModel()
	...
	return bossMo.phaseId == doppelgangerPhaseId
end

return SeasonSceneEventBossDoppelganger
