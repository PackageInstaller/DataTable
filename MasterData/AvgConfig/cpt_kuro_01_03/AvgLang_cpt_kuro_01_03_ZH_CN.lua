local AvgLang_cpt_kuro_01_03_ZH_CN = {
  [10] = "此时，直播间里的观众们正在交谈。",
  ...
  [100] = "<color=orange>书咖智能体1</color>\n在数据比较全面的形象中，做得到和做不到的人的比例约为一比八十。<|>\n<color=orange>KTV智能体1</color>\n差得也太多了吧，一个分区的智能体里只有一个啊！<|>\n<color=orange>书咖智能体1</color>\n这种人被称之为主角。<|>\n<color=orange>KTV智能体1</color>\n也就是说，卡萝就是这样的主角？",
  [140] = "<color=yellow>管理员</color>\n如果是的话，那就糟糕了。<|>\n<color=orange>KTV智能体1</color>\n啊，管理员发言了。为什么这么说？",
  [160] = "<color=yellow>管理员</color>\n卡萝来到伯班克之后开始直播自己和净化者战斗的过程，为伯班克带来了活力。<|>\n<color=yellow>管理员</color>\n但没有哪个节目会如此顺利。所有剧情的展开都一定会伴随着波折。",
  [180] = "而我们现在不是在录制节目，一旦顺风顺水的她遇到波折的话……"
}
return AvgLang_cpt_kuro_01_03_ZH_CN
