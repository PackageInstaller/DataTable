...
function __REMOVE_LOCAL_CACHE__()
	local var_4_0 = uf.UpgradeManager:getInstance()
	local var_4_1 = var_0_2:getWritablePath()

	var_0_2:removeDirectory((var_4_0:getUpgradeFolder()))
	var_0_2:removeFile(var_4_0 .. "userdata/upgrade_config.json")
	var_0_2:removeDirectory(var_4_1 .. "upgradelang/")
	var_0_2:removeFile(var_4_1 .. "userdata/multilingual.json")
end
