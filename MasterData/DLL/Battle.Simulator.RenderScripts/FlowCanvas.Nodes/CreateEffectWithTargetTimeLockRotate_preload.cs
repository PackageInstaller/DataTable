...
[Name("创建特效(自动回收,锁旋转)_preload", 0)]
[Category("Render/函数")]
[Description("创建特效,填写挂点路径,时长为特效持续时间,自动回收;\n路径为:从Effect开始,例如:Effect/Hero/1037/fx_1037_skill1_1;\n挂点名称:gua_Hit;\n时长单位为:秒")]
public class CreateEffectWithTargetTimeLockRotate_preload : EffectCreateBaseNode
{
	...
	protected override void RegisterPorts()
	{
		...
		AddFlowInput("", delegate(Flow f)
		{
			...
			if (!(null == agent) && !(agent.ComponentTimeline == null))
			{
				...
				EffectController effectController = agent.ComponentTimeline.PlayCommonEffect(_effectPathInput.value, pParentFullPath, Vector3.zero, scale, Vector3.zero, transform.forward, isAttachInput.value, pIsLoop: false, pNeedManager: false, 0f, timeInput.value, pUsePosition: false, Vector3.zero, rotateInput.value);
