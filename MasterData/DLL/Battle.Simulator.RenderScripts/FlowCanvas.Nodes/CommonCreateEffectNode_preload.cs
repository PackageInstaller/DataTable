...
public class CommonCreateEffectNode_preload : EffectCreateBaseNode
{
	...
	protected override void RegisterPorts()
	{
		...
		FlowOutput doneOutput = AddFlowOutput("特效结束调用");
