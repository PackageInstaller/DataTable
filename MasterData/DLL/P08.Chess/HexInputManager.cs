...
public class HexInputManager : MonoBehaviour
{
	...
	public static HexInputManager _instance;
	...
	private GameObject clickTmpGameObject;

	public static HexInputManager Instance => _instance;
	...
	private void Update()
	{
		...
		if (Input.touchCount == 2)
		{
			...
			if (num2 != 0f)
			{
				HexCameraManager.Instance.AddYAxis(num2);
			}
			if (uIPassEvent != null)
			{
