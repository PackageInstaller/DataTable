...
[Serializable]
[DisplayName("场景后处理")]
public class StoryScenePostEffectNode : PlayableAsset
{
	...
	{
		ScriptPlayable<StoryScenePostEffectNodeBehaviour> scriptPlayable = ScriptPlayable<StoryScenePostEffectNodeBehaviour>.Create(graph);
