...
[Serializable]
[DisplayName("DLC配置/Animator混合轨道(Animancer)")]
[TrackClipType(typeof(AnimancerPlayClipNode), false)]
[TrackBindingType(typeof(Animator))]
[TrackColor(0.39f, 0.2f, 0.53f)]
public class AnimancerPlayClipTrack : TrackAsset
{
	...
	{
		if (clip.asset is AnimancerPlayClipNode animancerPlayClipNode)
		{
			Animator binding = GetBinding((go != null) ? go.GetComponent<PlayableDirector>() : null);
			animancerPlayClipNode.animator = binding;
		}
