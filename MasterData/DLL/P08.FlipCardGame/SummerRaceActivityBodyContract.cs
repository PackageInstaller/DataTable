...
[Serializable]
public sealed class SummerRaceActivityBodyContract
{
	...
	public SummerRaceActivityWheelContract[] Wheels = Array.Empty<SummerRaceActivityWheelContract>();

	public SummerRaceActivityMountPointContract[] MountPoints = Array.Empty<SummerRaceActivityMountPointContract>();
