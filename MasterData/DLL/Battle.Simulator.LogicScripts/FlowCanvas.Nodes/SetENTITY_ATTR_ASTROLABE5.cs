...
[Description("设置星盘5号位")]
public class SetENTITY_ATTR_ASTROLABE5 : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2027, value, 0L, 0L);
		}
	}
}
