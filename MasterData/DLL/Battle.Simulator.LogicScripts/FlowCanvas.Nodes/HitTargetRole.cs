...
[Category("Common/事件")]
[Description("指定角色被命中")]
public class HitTargetRole : EventNode
{
	...
	protected override void RegisterPorts()
	{
		...
		_entityIDInput = AddValueInput<int>("实体类型ID", "RoleID");
	}
	...
	{
		SimEntity entityWithEntityID = base.mSimContext.GetEntityWithEntityID(triggerEvent.mTargetID);
		if (entityWithEntityID != null && entityWithEntityID.ENTITY_CONFIG_ID == _entityIDInput.value)
		{
