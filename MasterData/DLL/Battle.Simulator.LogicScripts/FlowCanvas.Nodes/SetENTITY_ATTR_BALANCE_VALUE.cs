...
[Description("设置平衡值")]
public class SetENTITY_ATTR_BALANCE_VALUE : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2019, value, 0L, 0L);
		}
	}
}
