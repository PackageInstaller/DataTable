...
[Name("设置移动速度加成(千分比)(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置移动速度加成(千分比)")]
public class SetENTITY_ATTR_MOVE_SPEED : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2006, value, 0L, 0L);
		}
	}
}
