...
[Description("设置机制值")]
public class SetENTITY_ATTR_POWER_VALUE : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2017, value, 0L, 0L);
		}
	}
}
