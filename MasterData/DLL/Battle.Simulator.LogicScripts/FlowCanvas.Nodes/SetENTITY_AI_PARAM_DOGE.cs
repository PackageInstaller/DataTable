...
[Name("设置AI参数-闪避(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置AI参数-闪避")]
public class SetENTITY_AI_PARAM_DOGE : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2217, value, 0L, 0L);
		}
	}
}
