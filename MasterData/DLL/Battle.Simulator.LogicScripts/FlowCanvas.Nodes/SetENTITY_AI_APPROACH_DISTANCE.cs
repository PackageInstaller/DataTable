...
[Name("设置AI接近时的距离(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置AI接近时的距离")]
public class SetENTITY_AI_APPROACH_DISTANCE : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2202, value, 0L, 0L);
		}
	}
}
