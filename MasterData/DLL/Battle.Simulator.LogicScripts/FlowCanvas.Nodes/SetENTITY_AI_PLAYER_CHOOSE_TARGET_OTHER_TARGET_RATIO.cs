...
[Name("设置玩家方选目标其他人目标系数(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置玩家方选目标其他人目标系数")]
public class SetENTITY_AI_PLAYER_CHOOSE_TARGET_OTHER_TARGET_RATIO : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2211, value, 0L, 0L);
		}
	}
}
