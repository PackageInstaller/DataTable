...
[Description("设置!护盾值")]
public class SetENTITY_ATTR_SHIELD : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2178, value, 0L, 0L);
		}
	}
}
