...
[Name("抛掷物接触逻辑", 0)]
[Category("Logic/抛掷物")]
[Description("处理抛掷物接触逻辑")]
public class ThrownEventProcessCollision : EventNode
{
	...
	public override void OnGraphStarted()
	{
		...
		simInterface.mThrownProcessCollisionCheck = (Action<int, int>)Delegate.Combine(simInterface.mThrownProcessCollisionCheck, new Action<int, int>(ThrownCollisionCheckHandler));
	}
	...
	public void ThrownCollisionCheckHandler(int thrownID, int abilityID)
	{
		mThrownID = thrownID;
