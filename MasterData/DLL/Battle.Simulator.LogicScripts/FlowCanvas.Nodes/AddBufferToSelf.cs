...
[ExposeAsDefinition]
public class AddBufferToSelf : FlowControlNode
{
	private int mBuffID;
	...
	protected override void RegisterPorts()
	{
		...
		ValueInput<int> p1 = AddValueInput<int>("实体ID", "添加者");
		...
		{
			if (Invoke(p1.GetValue(), p1.GetValue(), p3.GetValue(), p4.GetValue(), p5.GetValue(), p6.GetValue(), p7.GetValue(), p13.GetValue(), p14.GetValue(), p15.GetValue(), p16.GetValue(), p17.GetValue(), p18.GetValue()))
			{
				trueOut.Call(f);
			}
			else
