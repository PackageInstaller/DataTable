...
[Name("实体初始化AI完成事件", 0)]
[Category("Logic/事件")]
[Description("实体初始化ai完成事件, 会在实体创建之后的一帧触发，不做筛选")]
public class EntityInitAIFinishedEvent : EventNode
{
	...
	private void OnEntityInitFinishedEventHandler(int id)
	{
		...
		if (entityWithEntityID != null && entityWithEntityID.hasEntityConfig && entityWithEntityID.hasEntityAIThink)
		{
			entityID = id;
			Flow f = new Flow
			{
