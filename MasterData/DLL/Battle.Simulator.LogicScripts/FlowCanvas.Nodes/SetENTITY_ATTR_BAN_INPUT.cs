...
[Description("设置禁用输入")]
public class SetENTITY_ATTR_BAN_INPUT : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2010, value, 0L, 0L);
		}
	}
}
