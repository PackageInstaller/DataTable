...
public sealed class IntArray : IMessage<IntArray>, IMessage, IEquatable<IntArray>, IDeepCloneable<IntArray>
{
	private static readonly MessageParser<IntArray> _parser = new MessageParser<IntArray>(() => new IntArray());
	...
	[DebuggerNonUserCode]
	public static MessageParser<IntArray> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => ConfigReflection.Descriptor.MessageTypes[0];
