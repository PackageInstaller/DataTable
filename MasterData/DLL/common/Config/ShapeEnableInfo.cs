...
public sealed class ShapeEnableInfo : IMessage<ShapeEnableInfo>, IMessage, IEquatable<ShapeEnableInfo>, IDeepCloneable<ShapeEnableInfo>
{
	private static readonly MessageParser<ShapeEnableInfo> _parser = new MessageParser<ShapeEnableInfo>(() => new ShapeEnableInfo());
	...
	public const int IsEnableFieldNumber = 4;

	private bool isEnable_;

	[DebuggerNonUserCode]
	public static MessageParser<ShapeEnableInfo> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => ConfigReflection.Descriptor.MessageTypes[53];
	...
	[DebuggerNonUserCode]
	public ShapeEnableInfo(ShapeEnableInfo other)
		: this()
	{
		iD_ = other.iD_;
		start_ = other.start_;
