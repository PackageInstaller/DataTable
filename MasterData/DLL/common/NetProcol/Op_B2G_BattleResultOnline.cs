...
[Message(138)]
public sealed class Op_B2G_BattleResultOnline : IMessage<Op_B2G_BattleResultOnline>, IMessage, IEquatable<Op_B2G_BattleResultOnline>, IDeepCloneable<Op_B2G_BattleResultOnline>
{
	private static readonly MessageParser<Op_B2G_BattleResultOnline> _parser = new MessageParser<Op_B2G_BattleResultOnline>(() => new Op_B2G_BattleResultOnline());
	...
	[DebuggerNonUserCode]
	public static MessageParser<Op_B2G_BattleResultOnline> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => NetprotoReflection.Descriptor.MessageTypes[43];
	...
	[DebuggerNonUserCode]
	public Op_B2G_BattleResultOnline()
	{
	}

	[DebuggerNonUserCode]
	public Op_B2G_BattleResultOnline(Op_B2G_BattleResultOnline other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	public Op_B2G_BattleResultOnline Clone()
	{
		return new Op_B2G_BattleResultOnline(this);
	}

	[DebuggerNonUserCode]
	public override bool Equals(object other)
	{
		return Equals(other as Op_B2G_BattleResultOnline);
	}

	[DebuggerNonUserCode]
	public bool Equals(Op_B2G_BattleResultOnline other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	public void MergeFrom(Op_B2G_BattleResultOnline other)
	{
		if (other == null)
		{
			return;
