...
public class CriAtomSourceWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(CriAtomSource), typeof(CriMonoBehaviour));
		...
		L.RegVar("cueSheet", get_cueSheet, set_cueSheet);
	...
	private static int CriInternalUpdate(IntPtr L)
	{
		try
		{
			...
			((CriAtomSource)ToLua.CheckObject<CriAtomSource>(L, 1)).CriInternalUpdate();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int CriInternalLateUpdate(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((CriAtomSource)ToLua.CheckObject<CriAtomSource>(L, 1)).CriInternalLateUpdate();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int Play(IntPtr L)
	{
		try
		{
			...
			case 1:
			{
				CriAtomExPlayback v2 = ((CriAtomSource)ToLua.CheckObject<CriAtomSource>(L, 1)).Play();
			...
			case 2:
				...
				{
					CriAtomSource obj = (CriAtomSource)ToLua.CheckObject<CriAtomSource>(L, 1);
			...
			{
				CriAtomSource obj2 = (CriAtomSource)ToLua.CheckObject<CriAtomSource>(L, 1);
				int cueId = (int)LuaDLL.lua_tonumber(L, 2);
				CriAtomExPlayback v3 = obj2.Play(cueId);
				ToLua.PushValue(L, v3);
				return 1;
			}
			return LuaDLL.luaL_throw(L, "invalid arguments to method: CriAtomSource.Play");
		}
		catch (Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	private static int Stop(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((CriAtomSource)ToLua.CheckObject<CriAtomSource>(L, 1)).Stop();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int IsPaused(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			bool value = ((CriAtomSource)ToLua.CheckObject<CriAtomSource>(L, 1)).IsPaused();
	...
	private static int SetAisacControl(IntPtr L)
	{
		try
		{
			...
			return LuaDLL.luaL_throw(L, "invalid arguments to method: CriAtomSource.SetAisacControl");
		}
		catch (Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	private static int get_player(IntPtr L)
	{
		...
		try
		{
			...
			CriAtomExPlayer player = ((CriAtomSource)obj).player;
	...
	private static int get_source(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			CriAtomEx3dSource source = ((CriAtomSource)obj).source;
	...
	private static int get_playOnStart(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			bool playOnStart = ((CriAtomSource)obj).playOnStart;
	...
	private static int get_cueName(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			string cueName = ((CriAtomSource)obj).cueName;
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int get_cueSheet(IntPtr L)
	{
		object obj = null;
		try
		{
			obj = ToLua.ToObject(L, 1);
			string cueSheet = ((CriAtomSource)obj).cueSheet;
			LuaDLL.lua_pushstring(L, cueSheet);
			return 1;
		}
		catch (Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index cueSheet on a nil value");
		}
	}
	...
	private static int get_use3dPositioning(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			bool use3dPositioning = ((CriAtomSource)obj).use3dPositioning;
	...
	private static int get_freezeOrientation(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			bool freezeOrientation = ((CriAtomSource)obj).freezeOrientation;
	...
	private static int get_use3dRandomization(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			bool use3dRandomization = ((CriAtomSource)obj).use3dRandomization;
	...
	private static int get_randomPositionListMaxLength(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			uint randomPositionListMaxLength = ((CriAtomSource)obj).randomPositionListMaxLength;
	...
	private static int get_region3d(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			CriAtomRegion region3d = ((CriAtomSource)obj).region3d;
	...
	private static int get_listener(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			CriAtomListener listener = ((CriAtomSource)obj).listener;
	...
	private static int get_regionOnStart(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			CriAtomRegion regionOnStart = ((CriAtomSource)obj).regionOnStart;
	...
	private static int get_listenerOnStart(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			CriAtomListener listenerOnStart = ((CriAtomSource)obj).listenerOnStart;
	...
	private static int get_loop(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			bool loop = ((CriAtomSource)obj).loop;
	...
	private static int get_volume(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			float volume = ((CriAtomSource)obj).volume;
	...
	private static int get_pitch(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			float pitch = ((CriAtomSource)obj).pitch;
	...
	private static int get_pan3dAngle(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			float pan3dAngle = ((CriAtomSource)obj).pan3dAngle;
	...
	private static int get_pan3dDistance(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			float pan3dDistance = ((CriAtomSource)obj).pan3dDistance;
	...
	private static int get_startTime(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			int startTime = ((CriAtomSource)obj).startTime;
	...
	private static int get_time(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			long time = ((CriAtomSource)obj).time;
	...
	private static int get_status(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			CriAtomSourceBase.Status status = ((CriAtomSource)obj).status;
			ToLua.Push(L, status);
			return 1;
		}
		catch (Exception e)
	...
	private static int get_attenuationDistanceSetting(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			bool attenuationDistanceSetting = ((CriAtomSource)obj).attenuationDistanceSetting;
	...
	private static int get_androidUseLowLatencyVoicePool(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			bool androidUseLowLatencyVoicePool = ((CriAtomSource)obj).androidUseLowLatencyVoicePool;
	...
	private static int set_playOnStart(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			CriAtomSource obj2 = (CriAtomSource)obj;
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int set_cueSheet(IntPtr L)
	{
		object obj = null;
		try
		{
