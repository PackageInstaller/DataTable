...
public class UnityEngine_UI_VerticalLayoutGroupWrap
{
	...
	{
		L.BeginClass(typeof(VerticalLayoutGroup), typeof(HorizontalOrVerticalLayoutGroup));
	...
	private static int CalculateLayoutInputHorizontal(IntPtr L)
	{
		try
		{
			...
			((VerticalLayoutGroup)ToLua.CheckObject<VerticalLayoutGroup>(L, 1)).CalculateLayoutInputHorizontal();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int CalculateLayoutInputVertical(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((VerticalLayoutGroup)ToLua.CheckObject<VerticalLayoutGroup>(L, 1)).CalculateLayoutInputVertical();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int SetLayoutHorizontal(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((VerticalLayoutGroup)ToLua.CheckObject<VerticalLayoutGroup>(L, 1)).SetLayoutHorizontal();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int SetLayoutVertical(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((VerticalLayoutGroup)ToLua.CheckObject<VerticalLayoutGroup>(L, 1)).SetLayoutVertical();
			return 0;
		}
		catch (Exception e)
		{
