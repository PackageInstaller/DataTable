...
public class NiuQuGlitch1 : MonoBehaviour, IMaterialModifier
{
	private class ShaderID
	{
		...
		public static readonly int _AlphaStrength = Shader.PropertyToID("_AlphaStrength");
	}
	...
	[Range(0f, 1f)]
	public float _AlphaStrength = 1f;
	...
	internal void UpdateMaterial()
	{
		if (!(_material == null))
		{
			...
			_material.SetFloat(ShaderID._BlurSize, _BlurSize);
			...
			_material.SetFloat(ShaderID._AlphaStrength, _AlphaStrength);
