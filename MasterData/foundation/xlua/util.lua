...
local function async_to_sync(async_func, callback_pos)
  return function(...)
    ...
    return unpack, rets, coroutine.yield()
  end
end
...
local function auto_id_map()
  ...
  function xlua.hotfix(cs, field, func)
    ...
    if map_info_of_type then
      ...
      do return org_hotfix, cs, field end
      return org_hotfix, cs, field, func, pairs(tbl)
    end
  end
end
...
local function hotfix_ex(cs, field, func)
  ...
  local function func_after(...)
    ...
    do return unpack end
    return unpack, ret, field, func_after
  end
...
local function createdelegate(delegate_cls, obj, impl_cls, method_name, parameter_type_list)
  ...
  do return CS.System.Delegate.CreateDelegate, typeof(delegate_cls), obj end
  return CS.System.Delegate.CreateDelegate, typeof(delegate_cls), obj, m, parameter_type_list, nil
end
