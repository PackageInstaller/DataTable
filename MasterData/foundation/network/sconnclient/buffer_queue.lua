...
local function pack_data(data, header_len, endian)
  ...
  do return string.pack, fmt, len end
...
function mt:look(nbytes)
  ...
  if head and nbytes > 0 and nbytes <= size then
    ...
    do return table.concat, buff, "", 1 end
    return table.concat, buff, "", 1, index, 1, sub
  end
  return false
end
