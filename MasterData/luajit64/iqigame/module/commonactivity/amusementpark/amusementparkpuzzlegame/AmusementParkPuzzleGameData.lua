-- chunkname: @IQIGame\\Module\\CommonActivity\\AmusementPark\\AmusementParkPuzzleGame\\AmusementParkPuzzleGameData.lua
...
local AmusementParkPuzzleMapTileData = require("IQIGame.Module.CommonActivity.AmusementPark.AmusementParkPuzzleGame.AmusementParkPuzzleMapTileData")
...
function m:CreateTiles()
	...
	for line = 1, self.maxLine do
		for column = 1, self.maxColumn do
			...
			local tileData = AmusementParkPuzzleMapTileData.New(index, line, column, 0)
