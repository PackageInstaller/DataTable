-- chunkname: @IQIGame\\UIExternalApi\\HorizontalRPGBossRewardUIApi.lua

HorizontalRPGBossRewardUIApi = BaseLangApi:Extend()

function HorizontalRPGBossRewardUIApi:Init()
...
function HorizontalRPGBossRewardUIApi:GetTextNoRank()
	return self:GetCfgText(1213066)
end

function HorizontalRPGBossRewardUIApi:GetTextMsg()
	return self:GetCfgText(3100601)
end

function HorizontalRPGBossRewardUIApi:GetTextRewardTitle()
	return self:GetCfgText(1213077)
end

function HorizontalRPGBossRewardUIApi:GetTextTitle()
	return self:GetCfgText(1213001)
end

function HorizontalRPGBossRewardUIApi:GetTextRewardIndex(num1, num2, type)
...
function HorizontalRPGBossRewardUIApi:GetMazeBossRankIconPath(rank, mySelf, type)
	if type == 1 then
		if rank < 11 then
...
function HorizontalRPGBossRewardUIApi:GetRankRewardIconPath(num1, num2, type)
	if type == 1 then
		if num1 == 4 then
			return self:GetResUrl(2700101)
		elseif num1 == 11 then
...
HorizontalRPGBossRewardUIApi:Init()
