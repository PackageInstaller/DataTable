-- chunkname: @IQIGame\\UI\\ExploreHall\\PlotChallenge\\PlotChallengeBossRewardCell.lua
...
function m:SetData(data, index)
	self.cfgPlotChallengeBossReward = data
...
function m:Update(index)
	...
	UGUIUtil.SetText(self.RankingText, PlotChallengeBossRewardUIApi:GetString("TextRewardIndex", self.cfgPlotChallengeBossReward.RankLowerLimit, self.cfgPlotChallengeBossReward.RankUpperLimit, self.cfgPlotChallengeBossReward.RankType))

	if not isShowImgNum then
		local path = PlotChallengeBossRewardUIApi:GetString("RankRewardIconPath", self.cfgPlotChallengeBossReward.RankLowerLimit, self.cfgPlotChallengeBossReward.RankUpperLimit, self.cfgPlotChallengeBossReward.RankType)
	...
	for i = 1, #self.cfgPlotChallengeBossReward.Reward, 2 do
		local itemId = self.cfgPlotChallengeBossReward.Reward[i]
		local itemNum = self.cfgPlotChallengeBossReward.Reward[i + 1]
