-- chunkname: @IQIGame\\UI\\Chapter\\MonsterItemCell_new.lua
...
function m:SetData(bossData, func, index)
	...
	UGUIUtil.SetText(self.RecommendLv, m:GetRecommendLvFormatText(self.CfgData.Level))
	self:SetSubItem()
end

function m:GetRecommendLvFormatText(level)
	return string.format(CfgUtil.GetCfgTipsTextWithID(2100009), level)
end
