...
local var_0_9 = {
	father_node_2 = 11,
	advance_cost_value = 14,
	father_node_1 = 10,
	node_type = 5,
	node_stage = 6,
	advance_cost_type = 13,
	node_icon = 3,
	level_max = 17,
	basic_talent_2 = 23,
	cultivate_affect_develop_value = 20,
	basic_talent_3 = 24,
	cultivate_talent_type = 28,
	talent_name = 21,
	cultivate_affect_initial_value = 19,
	cultivate_talent_key = 29,
	cultivate_talent_3 = 27,
	node_name = 2,
	advance_id = 4,
	cultivate_talent_value = 30,
	cultivate_talent_1 = 25,
	stage_max = 8,
	level_group = 16,
	father_node_3 = 12,
	advance_cost_size = 15,
	condition_des = 31,
	cultivate_talent_2 = 26,
	cultivate_affect_type = 18,
	node_quality = 7,
	id = 1,
	orientation = 9,
	basic_talent_1 = 22,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_tree_node_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.tree_node_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.tree_node_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.tree_node_info_data"] = nil
		package.loaded["app.core.config.cfg.tree_node_info_key"] = nil
	end
end
