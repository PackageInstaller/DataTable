...
local var_0_9 = {
	...
	pet_6 = 34,
	monster_4 = 8,
	combo_recover_round = 26,
	combo_damage_add = 27,
	boss_hp = 14,
	id = 1,
	monster_3 = 7,
	pet_1 = 29,
	combo_recover_action = 25,
	fight = 3,
	combo_damage_dec = 28,
	pet_3 = 31,
	initial_combo = 23,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_monster_team_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.monster_team_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.monster_team_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.monster_team_info_data"] = nil
		package.loaded["app.core.config.cfg.monster_team_info_key"] = nil
	end
end
