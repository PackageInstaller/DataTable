...
local var_0_9 = {
	...
	seen_directions = 4,
	function_value = 7,
	attribute_value_2 = 12,
	activation_text = 5,
	drop = 8,
	attribute_value_1 = 10,
	prepose_id = 3,
	attribute_value_3 = 14,
	id = 1,
	attribute_type_4 = 15,
	tab_type = 2,
	attribute_value_4 = 16
}
local var_0_10 = {
	seen_directions = 1,
	activation_text = 2
...
local var_0_11 = {
	...
	1,
	0,
	"238_1_seen_directions",
	"238_1_activation_text",
	4,
	0,
	0,
	0,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_scroll_stage_growth_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.scroll_stage_growth_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.scroll_stage_growth_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.scroll_stage_growth_info_data"] = nil
		package.loaded["app.core.config.cfg.scroll_stage_growth_info_key"] = nil
	end
end
