...
local var_0_8
local var_0_9 = {
	replace_reward_type = 32,
	name = 3,
	month_card_score = 28,
	gold_gift = 17,
	guild_alliance_box_size = 35,
	name_pic = 8,
	vip_exp = 14,
	extra_gift_type_1 = 22,
	recharge_type = 7,
	gold_recharge = 16,
	money = 11,
	extra_gift_type = 19,
	extra_gift_size_1 = 24,
	icon = 9,
	limit_num = 15,
	product_id = 5,
	extra_gift_size = 21,
	...
	extra_gift_value = 20,
	days = 25,
	extra_gift_value_1 = 23,
	replace_reward_value = 33,
	des = 30,
	gold_days = 26,
	replace_type = 31,
	gm = 29
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_recharge_info_kr")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.recharge_info_kr_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.recharge_info_kr_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.recharge_info_kr_data"] = nil
		package.loaded["app.core.config.cfg.recharge_info_kr_key"] = nil
	end
end
