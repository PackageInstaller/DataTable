...
local var_0_8
local var_0_9 = {
	four_suit_passive = 18,
	talent_name_2 = 12,
	level = 5,
	four_suit_talent_2 = 14,
	talent_name_1 = 6,
	four_suit_talent_4 = 16,
	four_suit_talent_1 = 13,
	two_suit_talent_2 = 8,
	four_suit_talent_3 = 15,
	two_suit_talent_4 = 10,
	suit_stage = 3,
	four_suit_talent_5 = 17,
	two_suit_talent_3 = 9,
	two_suit_talent_5 = 11,
	next_suit_stage = 4,
	suit_id = 2,
	id = 1,
	two_suit_talent_1 = 7
...
local var_0_11 = {
	...
	0,
	0,
	"824_50000_talent_name_1",
	47001,
	0,
	0,
	0,
	0,
	"824_50000_talent_name_2",
	47006,
	0,
	0,
	0,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_equipment_suit_stage_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.equipment_suit_stage_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.equipment_suit_stage_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.equipment_suit_stage_info_data"] = nil
		package.loaded["app.core.config.cfg.equipment_suit_stage_info_key"] = nil
	end
end
