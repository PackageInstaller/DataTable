...
local var_0_9 = {
	week = 3,
	name = 4,
	week_clear_value_2 = 19,
	week_clear_size_2 = 20,
	dungeon_1 = 10,
	title = 8,
	pic = 5,
	week_clear_type_2 = 18,
	week_clear_value_3 = 22,
	dungeon_2 = 11,
	week_clear_size_3 = 23,
	level = 9,
	dungeon_3 = 12,
	week_clear_type_3 = 21,
	week_clear_size_1 = 17,
	next_id = 2,
	week_clear_value_1 = 16,
	week_clear_type_1 = 15,
	dungeon_4 = 13,
	if_show = 14,
	y = 7,
	id = 1,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_guild_dungeon_chapter_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.guild_dungeon_chapter_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.guild_dungeon_chapter_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.guild_dungeon_chapter_info_data"] = nil
		package.loaded["app.core.config.cfg.guild_dungeon_chapter_info_key"] = nil
	end
end
