...
local var_0_9 = {
	...
	affect_value2 = 19,
	star_limit = 4,
	advance_affect_type3 = 11,
	advance_affect_type1 = 7,
	affect_value3 = 22,
	advance_affect_value3 = 12,
	casting_develop = 6,
	icon = 3,
	stage_1 = 14,
	level = 2,
	stage_4 = 23,
	affect_value4 = 25,
	advance_affect_type2 = 9,
	affect_type4 = 24,
	advance_affect_value2 = 10,
	cost_experience = 5,
	affect_type2 = 18,
	affect_type3 = 21,
	id = 1,
	advance_affect_value1 = 8
}
local var_0_10 = {}
local var_0_11 = {
	1001,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_casting_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.casting_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.casting_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.casting_info_data"] = nil
		package.loaded["app.core.config.cfg.casting_info_key"] = nil
	end
end
