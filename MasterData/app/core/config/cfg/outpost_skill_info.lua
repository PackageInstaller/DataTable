...
local var_0_8
local var_0_9 = {
	buff_time_value_1 = 29,
	buff_target_value_1 = 26,
	description = 5,
	icon = 3,
	buff_1 = 24,
	skill_affect_prob_1 = 11,
	skill_affect_type_2 = 18,
	skill_type = 6,
	formula_1_value_1 = 13,
	skill_CD = 7,
	formula_1_value_3 = 15,
	buff_time_type_2 = 34,
	buff_time_value_2 = 35,
	buff_target_2 = 31,
	formula_2_value_1 = 21,
	level = 4,
	buff_prop_1 = 27,
	skill_affect_type_1 = 10,
	skill_range_value_1 = 9,
	buff_time_type_1 = 28,
	formula_2 = 20,
	buff_target_value_2 = 32,
	id = 1,
	formula_2_value_3 = 23,
	formula_1_value_2 = 14,
	formula_1 = 12,
...
local var_0_11 = {
	1,
	"1072_4000301_curtain_name",
	4000302,
	1,
	"1072_4000301_description",
	2,
	10000,
	1,
	0,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_outpost_skill_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.outpost_skill_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.outpost_skill_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.outpost_skill_info_data"] = nil
		package.loaded["app.core.config.cfg.outpost_skill_info_key"] = nil
	end
end
