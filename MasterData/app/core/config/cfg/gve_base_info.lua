...
local var_0_9 = {
	...
	equip_limit_max = 22,
	type = 2,
	monster_1_equip_lv = 10,
	drop_3_weights = 28,
	recover_time = 29,
	monster_2_equip_lv = 11,
	pic = 9,
	addition_mat = 17,
	unlock_value = 7,
	id = 1,
	battle_stage = 33,
	battle_rating_id_2 = 31,
	base_name = 4,
	drop_2 = 25,
	monster_3_equip_lv = 12,
	base_level = 5,
	drop_2_weights = 26,
	low_coin_rate = 18,
	base_type = 3,
	...
	if_ruins = 8,
	drop_1_weights = 24,
	battle_rating_id_3 = 32,
	equip_mat_rate = 15,
	battle_rating_id_1 = 30
}
local var_0_10 = {
	base_name = 1
}
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_gve_base_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.gve_base_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.gve_base_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.gve_base_info_data"] = nil
		package.loaded["app.core.config.cfg.gve_base_info_key"] = nil
	end
end
