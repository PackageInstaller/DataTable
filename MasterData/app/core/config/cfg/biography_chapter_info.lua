...
local var_0_9 = {
	...
	time = 9,
	stage_map = 6,
	mission_chain_branch_6 = 20,
	mission_chain_branch_9 = 23,
	story = 10,
	mission_chain_branch_8 = 22,
	mission_chain_branch_4 = 18,
	if_open = 3,
	mission_chain_branch_1 = 15,
	mission_chain_branch_10 = 24,
	dungeon_chapter_open = 4,
	scroll_num = 27,
	branch_reward = 26,
	branch_target = 25,
	mission_chain_main = 14,
	chapter_clear = 11,
	mission_chain_branch_5 = 19,
	finish_award_type = 28,
	music = 7,
	finish_award_value = 29,
	mission_chain_branch_3 = 17,
	finish_award_size = 30,
	land_id = 5,
	base_id = 12,
	id = 1,
	mission_chain_branch_2 = 16,
	mission_chain_branch_7 = 21
}
local var_0_10 = {
	chapter_clear = 2,
	name = 1
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_biography_chapter_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.biography_chapter_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.biography_chapter_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.biography_chapter_info_data"] = nil
		package.loaded["app.core.config.cfg.biography_chapter_info_key"] = nil
	end
end
