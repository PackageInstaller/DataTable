...
local var_0_9 = {
	description = 3,
	trigger_prob = 8,
	passive_effect_type = 9,
	buff_time_type = 13,
	passive_effect_value = 10,
	name = 2,
	passive_range = 11,
	trigger_type = 6,
	skill_range_value = 12,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_outpost_passive_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.outpost_passive_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.outpost_passive_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.outpost_passive_info_data"] = nil
		package.loaded["app.core.config.cfg.outpost_passive_info_key"] = nil
	end
end
