...
local var_0_11 = {
	...
	"1086_400030_lines_8",
	"1086_400030_lines_9",
	"1086_400030_lines_10",
	"1086_400030_lines_11",
	"1086_400030_lines_12",
	"1086_400030_lines_13",
	"1086_400030_lines_14",
	"1086_600060_lines_15",
	"1086_400030_lines_16",
	"1086_400030_lines_17",
	"1086_400030_lines_18",
	"1086_400030_lines_19",
	"1086_400030_lines_20",
	"1086_400030_lines_21"
}
local var_0_12 = 23
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_outpost_knight_line_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.outpost_knight_line_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.outpost_knight_line_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.outpost_knight_line_info_data"] = nil
		package.loaded["app.core.config.cfg.outpost_knight_line_info_key"] = nil
	end
end
