...
local var_0_10 = {
	common_id = 9,
	name = 2,
	develop_damage_add = 23,
	passive_skill_1 = 26,
	initial_energy = 13,
	magic_id = 33,
	if_immune_control = 34,
	is_element_leader = 36,
	army_skill_id = 37,
	energy_value_2 = 17,
	energy_type_2 = 16,
	develop_magical_defence = 22,
	star = 6,
	advance_id = 4,
	talent_skill_id = 12,
	develop_physical_defence = 21,
	passive_skill_5 = 30,
	id = 1,
	passive_skill_3 = 28,
	energy_value_1 = 15,
	develop_damage_dec = 24,
	passive_skill_4 = 29,
	energy_skill_id = 11,
	attack_type = 8,
	if_lock = 31,
...
local var_0_14 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_10[arg_1_1], "cannot find " .. arg_1_1 .. " in record_monster_info_2")
...
local var_0_17 = ...
local var_0_19, var_0_20 = pcall(require, string.sub(var_0_17, 1, string.len(var_0_17) - string.len("monster_info_2")) .. "monster_info_3")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.monster_info_2_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.monster_info_2_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.monster_info_2_data"] = nil
		package.loaded["app.core.config.cfg.monster_info_2_key"] = nil
		var_0_9 = nil
