...
local var_0_9 = {
	...
	state_value = 14,
	push_group = 2,
	times_limit_period = 16,
	role_level_top = 6,
	condition_value_2 = 11,
	condition_type_1 = 7,
	bubble_txt = 19,
	state_type = 13,
	condition_value_1 = 8,
	pic_knight = 18,
	server_limit_bottom = 3,
	gift_group = 17,
	role_level_bottom = 5,
	condition_period_2 = 12,
	condition_type_2 = 10,
	server_limit_top = 4,
	id = 1,
	condition_period_1 = 9
}
local var_0_10 = {
	bubble_txt = 1
}
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_push_gift_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.push_gift_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.push_gift_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.push_gift_info_data"] = nil
		package.loaded["app.core.config.cfg.push_gift_info_key"] = nil
	end
end
