...
local var_0_8
local var_0_9 = {
	disappear_sound_res = 10,
	position_y = 3,
	effect_res = 5,
	position_x = 2,
	passive_skill_id_2 = 8,
	disappear_skill_id = 11,
	passive_skill_id_1 = 7,
	disappear_effect_res = 9,
	touch_effect_res = 4,
	id = 1,
	order = 6
}
...
local var_0_11 = {
	...
	24,
	"0",
	"effect_battle_rongyandixing",
	"0",
	0,
	0,
	"effect_battle_rongyandixingxiaoshi",
	"Battle_Book7_Hit2",
	0
}
local var_0_12 = 11
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_battle_scene_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.battle_scene_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.battle_scene_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.battle_scene_info_data"] = nil
		package.loaded["app.core.config.cfg.battle_scene_info_key"] = nil
	end
end
