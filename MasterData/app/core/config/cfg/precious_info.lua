...
local var_0_9 = {
	...
	gm = 12,
	next_star_id = 11,
	return_fragment_num = 9,
	star_talent_4 = 22,
	base_attack = 15,
	next_star_num = 10,
	base_magical_defence = 17,
	star_talent_6 = 24,
	star_talent_3 = 21,
	star_talent_1 = 19,
	quality = 4,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_precious_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.precious_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.precious_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.precious_info_data"] = nil
		package.loaded["app.core.config.cfg.precious_info_key"] = nil
	end
end
