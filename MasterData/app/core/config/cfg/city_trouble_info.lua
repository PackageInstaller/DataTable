...
local var_0_11 = {
	...
	123001,
	124001,
	"西凉军残部冲入城中烧杀劫掠，城中百姓哭号哀叫，四散奔跑，城池进入暴动状态！",
	"汉中暴乱啦，快去找友军支援！",
	"暴乱了！快来人呀！",
	"1",
	"2",
	"好友率军击溃西凉军残部，安抚百姓，平息了暴动，你获得了#reward#。",
	"感谢将军派出军队平定动乱",
	"effect_city_trouble_1",
	"effect_city_trouble_end_1"
}
local var_0_12 = 15
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_city_trouble_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.city_trouble_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.city_trouble_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.city_trouble_info_data"] = nil
		package.loaded["app.core.config.cfg.city_trouble_info_key"] = nil
	end
end
