...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_battle_quality_counter_info")
...
function var_0_7.get(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	return var_0_7.indexOf(var_0_7._getKey()[arg_9_0 .. "_" .. arg_9_1 .. "_" .. arg_9_2 .. "_" .. arg_9_3])
end
...
function var_0_7.set(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5)
	local var_11_0 = var_0_7._getKey()[arg_11_0 .. "_" .. arg_11_1 .. "_" .. arg_11_2 .. "_" .. arg_11_3]

	if not var_11_0 then
		error("Key not found: " .. arg_11_0 .. "_" .. arg_11_1 .. "_" .. arg_11_2 .. "_" .. arg_11_3)
	end

	local var_11_1 = var_0_7.indexOf(var_11_0).toObject()

	var_11_1[arg_11_4] = arg_11_5
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.battle_quality_counter_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.battle_quality_counter_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.battle_quality_counter_info_data"] = nil
		package.loaded["app.core.config.cfg.battle_quality_counter_info_key"] = nil
	end
end
