...
local var_0_9 = {
	...
	reward_type_2 = 10,
	reward_size_min_1 = 7,
	reward_size_min_3 = 17,
	reward_size_min_2 = 12,
	probability_1 = 9,
	reward_value_4 = 21,
	reward_size_max_2 = 13,
	reward_size_min_4 = 22,
	reward_size_max_3 = 18,
	reward_value_2 = 11,
	reward_type_3 = 15,
	reward_size_max_4 = 23,
	level = 3,
	probability_4 = 24,
	name = 26,
	reward_value_3 = 16,
	fixed_reward_type = 27,
	fixed_reward_value = 28,
	fixed_reward_size = 29,
	next_level = 4,
	reward_size_max_1 = 8,
	res = 25,
	probability_3 = 19,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_richman_construct_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.richman_construct_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.richman_construct_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.richman_construct_info_data"] = nil
		package.loaded["app.core.config.cfg.richman_construct_info_key"] = nil
	end
end
