...
local var_0_9 = {
	...
	name = 2,
	shop_not_enough = 25,
	jigsaw_final_reward_purple_color = 19,
	jigsaw_draw_number_color = 18,
	jigsaw_white_font_color = 22,
	pic = 28,
	jigsaw_name = 17,
	interface_jigsaw = 33,
	recruited_value = 8,
	current_session_number_color = 16,
	jigsaw = 10,
	recruited_type = 7,
	shop_money_type = 3,
	recruited_size = 9,
	...
	shop_name = 23,
	biz_color = 26,
	jigsaw_share_font_color = 20,
	file_type = 11,
	theater_reward_name_color = 13,
	jigsaw_draw_card_font_color = 21,
	floor_name = 12,
	item_type = 5,
	pack_name = 27,
	main_color = 31,
	theater_current_session_color = 15,
	item_value = 6,
	shop_item_color = 24,
	entry_button = 32,
	theater_receive_color = 14
}
local var_0_10 = {
	name = 1,
	jigsaw_share_font_color = 11,
	file_type = 2,
	jigsaw_final_reward_purple_color = 10,
	jigsaw_name = 8,
	biz_color = 17,
	pack_name = 18,
	theater_reward_name_color = 4,
	main_color = 19,
	jigsaw_draw_card_font_color = 12,
	current_session_number_color = 7,
	floor_name = 3,
	jigsaw_draw_number_color = 9,
	shop_not_enough = 16,
	theater_current_session_color = 6,
	jigsaw_white_font_color = 13,
	shop_item_color = 15,
	entry_button = 20,
	shop_name = 14,
	theater_receive_color = 5
}
local var_0_11 = {
	1,
	"957_1_name",
	...
	"957_1_file_type",
	"957_1_floor_name",
	"957_1_theater_reward_name_color",
	"957_1_theater_receive_color",
	"957_1_theater_receive_color",
	"957_1_current_session_number_color",
	"957_1_jigsaw_name",
	"957_1_jigsaw_draw_number_color",
	"957_1_jigsaw_final_reward_purple_color",
	"957_1_jigsaw_share_font_color",
	"957_1_jigsaw_draw_card_font_color",
	"957_1_jigsaw_white_font_color",
	"957_1_shop_name",
	"957_1_shop_item_color",
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_anniversary_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.anniversary_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.anniversary_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.anniversary_info_data"] = nil
		package.loaded["app.core.config.cfg.anniversary_info_key"] = nil
	end
end
