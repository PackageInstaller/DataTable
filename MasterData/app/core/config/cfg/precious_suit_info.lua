...
local var_0_8
local var_0_9 = {
	base_physical_defence = 17,
	name = 5,
	precious_id_4 = 14,
	group_name = 10,
	quality = 7,
	next_star_id = 4,
	talent_skill_id_1 = 20,
	base_magical_defence = 18,
	talent_skill_id_3 = 22,
	talent_skill_id_0 = 19,
	talent_skill_id_4 = 23,
	talent_skill_id_7 = 26,
	talent_skill_id_6 = 25,
	icon = 6,
	star = 3,
	base_attack = 16,
	suit_group = 2,
	precious_id_1 = 11,
	talent_skill_id_5 = 24,
	passive_skill_id = 27,
	group = 9,
	talent_skill_id_2 = 21,
	brief_des = 28,
	precious_id_2 = 12,
	put = 8,
	id = 1,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_precious_suit_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.precious_suit_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.precious_suit_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.precious_suit_info_data"] = nil
		package.loaded["app.core.config.cfg.precious_suit_info_key"] = nil
	end
end
