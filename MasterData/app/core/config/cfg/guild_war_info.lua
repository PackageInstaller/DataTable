...
local var_0_8
local var_0_9 = {
	king_third_reward = 12,
	king_first_reward = 10,
	test_award_req = 19,
	elite_third_reward = 18,
	map_id = 5,
	season_award_req = 21,
	elite_first_reward = 16,
	monster_team_ID = 9,
	master_second_reward = 14,
	end_time_1 = 2,
	mvp_reward = 6,
	basic_reward = 7,
	battle_award_req = 20,
	end_time_3 = 4,
	elite_second_reward = 17,
	king_second_reward = 11,
	end_time_2 = 3,
	challenge_reward = 8,
	id = 1,
	master_first_reward = 13,
	master_third_reward = 15
}
local var_0_10 = {}
local var_0_11 = {
	101,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_guild_war_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.guild_war_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.guild_war_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.guild_war_info_data"] = nil
		package.loaded["app.core.config.cfg.guild_war_info_key"] = nil
	end
end
