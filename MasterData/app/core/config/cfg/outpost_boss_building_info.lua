...
local var_0_9 = {
	...
	unlock_type_2 = 6,
	unlock_type_1 = 3,
	level_upgrade_type_1 = 10,
	boss_id = 13,
	level_upgrade_size_1 = 12,
	level_upgrade_value_1 = 11,
	unlock_value_1 = 5,
	scale = 14,
	unlock_key_1 = 4,
	id = 1,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_outpost_boss_building_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.outpost_boss_building_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.outpost_boss_building_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.outpost_boss_building_info_data"] = nil
		package.loaded["app.core.config.cfg.outpost_boss_building_info_key"] = nil
	end
end
