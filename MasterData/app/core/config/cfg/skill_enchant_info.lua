...
local var_0_9
local var_0_10 = {
	formula_2_value_1_step = 21,
	skill_quality = 4,
	buff_prop_1 = 28,
	formula_1_value_1_step = 11,
	formula_2_value_2_step = 23,
	buff_prop_formula_2 = 36,
	skill_affect_type_2 = 17,
	description = 2,
	formula_1_value_1 = 10,
	formula_1 = 9,
	id = 1,
	formula_1_value_2_step = 13,
	buff_time_1 = 31,
	buff_target_value_1 = 27,
	buff_1 = 25,
	buff_target_2 = 33,
	split_description_2 = 3,
	formula_2_value_1 = 20,
	buff_prop_formula_2_value_1 = 37,
	buff_prop_formula_1_value_1 = 30,
	skill_affect_type_1 = 7,
	skill_range_value_1 = 6,
	formula_2 = 19,
	buff_target_value_2 = 34,
	formula_1_value_3 = 14,
	formula_2_value_3 = 24,
	formula_1_value_2 = 12,
	skill_affect_prob_1 = 8,
	skill_range_value_2 = 16,
	buff_prop_2 = 35,
	formula_2_value_2 = 22,
	buff_2 = 32,
	skill_affect_prob_2 = 18,
	buff_time_2 = 38,
	buff_prop_formula_1 = 29,
	skill_range_1 = 5,
	skill_range_2 = 15,
	buff_target_1 = 26
}
...
local var_0_14 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_10[arg_1_1], "cannot find " .. arg_1_1 .. " in record_skill_enchant_info")
...
local var_0_17 = ...
local var_0_19, var_0_20 = pcall(require, string.sub(var_0_17, 1, string.len(var_0_17) - string.len("skill_enchant_info")) .. "skill_enchant_info_2")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.skill_enchant_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.skill_enchant_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.skill_enchant_info_data"] = nil
		package.loaded["app.core.config.cfg.skill_enchant_info_key"] = nil
		var_0_9 = nil
