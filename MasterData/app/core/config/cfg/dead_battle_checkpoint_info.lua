...
local var_0_9 = {
	...
	monster_id_1 = 9,
	battle_stage = 21,
	succuba_battle_close = 22,
	monster_res_2 = 3,
	battle_quality_magnification = 23,
	monster_name_3 = 7,
	monster_name = 5,
	monster_fight_1 = 12,
	monster_fight_2 = 16,
	...
	monster_res = 2,
	id = 1,
	battle_parameter_magnification = 24
}
local var_0_10 = {
	monster_name = 1,
	monster_name_3 = 3,
...
local var_0_11 = {
	...
	701140,
	"16_22_monster_name",
	"16_48_monster_name_2",
	"16_51_monster_name_3",
	6,
	70001,
	100001,
	1,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_dead_battle_checkpoint_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.dead_battle_checkpoint_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.dead_battle_checkpoint_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.dead_battle_checkpoint_info_data"] = nil
		package.loaded["app.core.config.cfg.dead_battle_checkpoint_info_key"] = nil
	end
end
