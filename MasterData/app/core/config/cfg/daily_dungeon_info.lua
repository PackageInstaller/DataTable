...
local var_0_9 = {
	...
	dungeon_num = 7,
	show_type = 29,
	reward_type_value_6 = 23,
	reward_type_value_4 = 19,
	monster_icon = 9,
	reward_type_5 = 20,
	cost_type_value = 5,
	reward_type_6 = 22,
	reward_type_value_3 = 17,
	reward_type_3 = 16,
	reward_description = 24,
	monster_1 = 25,
	reward_type_value_1 = 13,
	reward_type_value_2 = 15,
	time = 8,
	monster_2 = 26,
	name = 2,
	cost_type = 4,
	privilege_guide_id = 28,
	daily_dungeon_type = 3,
	reward_type_value_5 = 21,
	cost_num = 6,
	background = 10,
	show_value = 30,
	id = 1,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_daily_dungeon_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.daily_dungeon_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.daily_dungeon_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.daily_dungeon_info_data"] = nil
		package.loaded["app.core.config.cfg.daily_dungeon_info_key"] = nil
	end
end
