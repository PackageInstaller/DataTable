...
local var_0_8
local var_0_9 = {
	limit_reward_type_4 = 19,
	limit_reward_value_4 = 20,
	construct_3 = 8,
	limit_reward_size_1 = 12,
	map_id = 2,
	limit_reward_value_2 = 14,
	limit_reward_type_3 = 16,
	limit_reward_value_3 = 17,
	limit_reward_type_2 = 13,
	construct_2 = 7,
	limit_reward_type_5 = 22,
	construct_1 = 6,
	limit_reward_size_4 = 21,
	exp = 4,
	limit_reward_value_5 = 23,
	level = 3,
	limit_reward_size_5 = 24,
	limit_reward_type_1 = 10,
	group = 5,
	limit_reward_size_3 = 18,
	limit_reward_value_1 = 11,
	id = 1,
	construct_4 = 9,
	limit_reward_size_2 = 15
}
local var_0_10 = {}
local var_0_11 = {
	1,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_richman_map_level_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.richman_map_level_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.richman_map_level_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.richman_map_level_info_data"] = nil
		package.loaded["app.core.config.cfg.richman_map_level_info_key"] = nil
	end
end
