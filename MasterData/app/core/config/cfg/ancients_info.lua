...
local var_0_8
local var_0_9 = {
	initial_fight_time = 10,
	guess_reward_value = 12,
	task_group = 4,
	knockout_rank = 6,
	name = 2,
	guess_reward_type = 11,
	rank_group = 5,
	active_item = 8,
	fight_item = 9,
	show_day = 17,
	ancients_pet_group = 3,
	score_game_day = 14,
	exp_item = 7,
	final_game_day = 16,
	final_team_day = 15,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_ancients_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.ancients_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.ancients_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.ancients_info_data"] = nil
		package.loaded["app.core.config.cfg.ancients_info_key"] = nil
	end
end
