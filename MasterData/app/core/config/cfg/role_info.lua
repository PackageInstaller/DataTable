...
local var_0_8
local var_0_9 = {
	pet_bag_num_client = 8,
	show_function_3 = 25,
	pet_bag_num = 9,
	chief_arena_money = 14,
	treasure_bag_num_client = 6,
	pet_equipment_bag_num = 11,
	equipment_bag_num = 5,
	arena_turn = 13,
	chief_arena_point = 17,
	stronger_route_1 = 26,
	pet_equipment_bag_num_client = 10,
	rebel_monster_type = 22,
	show_function_1 = 23,
	contend_money = 18,
	show_function_2 = 24,
	level = 1,
	...
	treasure_bag_num = 7,
	stronger_route_3 = 28,
	chief_arena_prestige = 16,
	rebel_type = 21,
	level_up_exp = 2,
	arena_money = 12,
	friend_limit = 20,
	equipment_bag_num_client = 4,
	chief_arena_turn = 15,
	vote_silver = 30,
	role_get_exp = 3
}
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_role_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.role_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.role_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.role_info_data"] = nil
		package.loaded["app.core.config.cfg.role_info_key"] = nil
	end
end
