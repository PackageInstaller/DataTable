...
local var_0_11 = {
	...
	"1",
	"1",
	"汉中是由蜀地通往中原的门户，冬无严寒、夏无酷暑，不失为世外桃源。此处盛产经验书简与体力丹，更有机会结识姜维、张飞、庞统、黄忠等蜀国名将。",
	"主公，待末将带回美酒佳酿和主公举杯畅饮。",
	"末将巡逻完毕，汉中民康物阜，请主公收下百姓心意。",
	"主公派遣的武将出色地完成了巡逻工作，获得了丰厚的奖励。",
	"101"
}
local var_0_12 = 19
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_city_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.city_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.city_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.city_info_data"] = nil
		package.loaded["app.core.config.cfg.city_info_key"] = nil
	end
end
