...
local var_0_9 = {
	...
	reward_type_3 = 13,
	reward_size_3 = 15,
	extra_reward_value_1 = 29,
	extra_reward_size_2 = 33,
	rank_type = 3,
	reward_value_2 = 11,
	extra_reward_size_3 = 36,
	reward_size_5 = 21,
	extra_reward_value_2 = 32,
	reward_value_3 = 14,
	reward_size_2 = 12,
	id = 1,
	extra_reward_value_3 = 35,
	extra_reward_type_1 = 28,
	reward_value_6 = 23,
	extra_reward_type_2 = 31,
	reward_value_1 = 8,
	rank_value = 4,
	reward_type_5 = 19,
	reward_value_7 = 26,
	...
	reward_size_6 = 24,
	group_id = 2,
	extra_reward_size_1 = 30,
	reward_size_1 = 9,
	reward_value_4 = 17,
	extra_reward_type_3 = 34,
	reward_value_5 = 20,
	reward_type_4 = 16
}
local var_0_10 = {}
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_new_slg_rank_reward_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.new_slg_rank_reward_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.new_slg_rank_reward_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.new_slg_rank_reward_info_data"] = nil
		package.loaded["app.core.config.cfg.new_slg_rank_reward_info_key"] = nil
	end
end
