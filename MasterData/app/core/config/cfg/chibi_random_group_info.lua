...
local var_0_8
local var_0_9 = {
	event_random_time_7 = 9,
	event_random_time_5 = 7,
	event_random_time_9 = 11,
	event_random_time_6 = 8,
	event_random_time_10 = 12,
	event_random_time_3 = 5,
	event_random_time_12 = 14,
	event_random_time_4 = 6,
	event_random_time_11 = 13,
	event_random_time_1 = 3,
	event_random_time_13 = 15,
	event_random_time_2 = 4,
	id = 1,
	num_random = 2,
	event_random_time_8 = 10
}
local var_0_10 = {}
local var_0_11 = {
	1,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_chibi_random_group_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.chibi_random_group_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.chibi_random_group_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.chibi_random_group_info_data"] = nil
		package.loaded["app.core.config.cfg.chibi_random_group_info_key"] = nil
	end
end
