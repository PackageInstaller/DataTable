...
local var_0_9
local var_0_10 = {
	formula_1_value_1_step = 12,
	buff_prop_1 = 29,
	skill_quality = 5,
	formula_2_value_2_step = 24,
	formula_2_value_1_step = 22,
	buff_prop_formula_2 = 37,
	description = 2,
	formula_1 = 10,
	formula_1_value_1 = 11,
	id = 1,
	formula_1_value_2_step = 14,
	buff_2 = 33,
	buff_time_1 = 32,
	buff_target_value_1 = 28,
	buff_1 = 26,
	buff_target_2 = 34,
	split_description_2 = 4,
	formula_2_value_1 = 21,
	buff_prop_formula_2_value_1 = 38,
	buff_prop_formula_1_value_1 = 31,
	skill_affect_type_1 = 8,
	skill_range_value_1 = 7,
	formula_2 = 20,
	buff_target_value_2 = 35,
	formula_1_value_3 = 15,
	formula_2_value_3 = 25,
	formula_1_value_2 = 13,
	skill_affect_prob_1 = 9,
	skill_range_value_2 = 17,
	buff_prop_2 = 36,
	formula_2_value_2 = 23,
	brief_description = 3,
	skill_affect_type_2 = 18,
	skill_affect_prob_2 = 19,
	buff_time_2 = 39,
	buff_prop_formula_1 = 30,
	skill_range_1 = 6,
	skill_range_2 = 16,
	buff_target_1 = 27
}
...
local var_0_14 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_10[arg_1_1], "cannot find " .. arg_1_1 .. " in record_skill_enchant_info_os")
...
local var_0_17 = ...
local var_0_19, var_0_20 = pcall(require, string.sub(var_0_17, 1, string.len(var_0_17) - string.len("skill_enchant_info_os")) .. "skill_enchant_info_2")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.skill_enchant_info_os_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.skill_enchant_info_os_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.skill_enchant_info_os_data"] = nil
		package.loaded["app.core.config.cfg.skill_enchant_info_os_key"] = nil
		var_0_9 = nil
