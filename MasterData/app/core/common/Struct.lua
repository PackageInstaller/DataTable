	...
	pack = function(self)
		...
		for iter_1_0 = 1, self:len() do
			...
			elseif var_1_3 == "c" then
				local var_1_13 = self:sub(iter_1_0 + 1)
				local var_1_14 = var_1_13:match("%d+")
				local var_1_15 = tonumber(var_1_14)

				if var_1_13 > 0 then
					local var_1_16 = tostring(table.remove(var_1_1, 1))

					if var_1_15 - var_1_16:len() > 0 then
						var_1_16 = table.concat({
							var_1_16,
							(string.rep(" ", var_1_15 - var_1_16:len()))
						})
					end

					table.insert(var_1_0, var_1_16:sub(1, var_1_15))
				end

				iter_1_0 = iter_1_0 + var_1_14:len()
			end
		end
