...
function var_0_0:convertProgCircle(arg_29_1, arg_29_2, arg_29_3)
	...
	local var_29_1 = var_29_0:getChild(arg_29_2)
	local var_29_2 = cc.ProgressTimer:create((var_29_1:popDisplayObject()))

	var_29_2.setType(var_29_1, cc.PROGRESS_TIMER_TYPE_RADIAL)
	var_29_2:setPercentage(50)
	var_29_2:setRotation(-180)
	var_29_0:getChild(arg_29_3):displayObject():addChild(var_29_2)
