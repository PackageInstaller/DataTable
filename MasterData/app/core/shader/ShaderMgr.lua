...
function ShaderMgr:_shadowCallback(arg_6_1, arg_6_2)
	...
	local var_6_1 = var_6_0:getWinSize()
	local var_6_2 = cc.GLProgramState:getOrCreateWithGLProgramName(arg_6_2)

	var_6_2.setUniformFloat(var_6_0, "dir_x", 1 / var_6_1.width)
	var_6_2:setUniformFloat("dir_y", 1 / var_6_1.height)
	var_6_2:setUniformFloat("strength", 3)
	var_6_2:setUniformVec3("shadow_color", cc.vec3(0.9, 0.87, 0.52))
	var_6_2:setUniformInt("range", 12)
end

function ShaderMgr:_shadowGlowCallback(arg_7_1, arg_7_2)
	local var_7_0 = cc.Director:getInstance()
	local var_7_1 = var_7_0:getWinSize()
	local var_7_2 = cc.GLProgramState:getOrCreateWithGLProgramName(arg_7_2)

	var_7_2.setUniformFloat(var_7_0, "dir_x", 1 / var_7_1.width)
	var_7_2:setUniformFloat("dir_y", 1 / var_7_1.height)
	var_7_2:setUniformVec3("shadow_color", cc.vec3(0.9, 0.87, 0.52))
	var_7_2:setUniformInt("range", 12)
end
