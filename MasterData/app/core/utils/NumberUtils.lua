...
function var_0_0.transTextNumFormation(arg_22_0)
	...
	if type(arg_22_0) == "number" and arg_22_0 >= math.pow(10, 14) then
		...
		if MultilingualMgr.calcElem then
			for iter_22_0, iter_22_1 in ipairs(g.core.model.User.translateData:getTranslateLangNum((MultilingualMgr:getUseLang())).calcElem) do
	...
	return (string.gsub(arg_22_0, "%d+%.?%d*", function(arg_24_0)
		...
		if var_24_0 then
			...
			if MultilingualMgr.calcElem then
				for iter_24_0, iter_24_1 in ipairs(g.core.model.User.translateData:getTranslateLangNum((MultilingualMgr:getUseLang())).calcElem) do
