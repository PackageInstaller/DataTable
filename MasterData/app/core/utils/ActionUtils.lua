local var_0_0 = {
	...
	playFloatAction = function(self, arg_2_1, arg_2_2, arg_2_3)
		...
		local var_2_0 = fgui.FMoveTo:create(arg_2_2 / 2, {
			x = arg_2_3.x,
			y = arg_2_3.y - arg_2_1
		})

		self:stopAllFGActions()
		self:runFGAction((fgui.FRepeatForever:create((fgui.FSequence:create(var_2_0, fgui.FMoveTo:create(arg_2_2 / 2, {
			x = arg_2_3.x,
			y = arg_2_3.y + arg_2_1
		}))))))
	end,
...
local function var_0_1(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5)
	...
	local var_8_1 = CCMoveBy:create(0.1, ccp(arg_8_2 and 0 or -arg_8_4, (arg_8_2 or nil) and (-arg_8_4 or 0)))
	local var_8_2 = CCArray:create()

	var_8_2:addObject(var_8_0)
	var_8_2:addObject((CCEaseIn:create(var_8_1, 0.1)))
