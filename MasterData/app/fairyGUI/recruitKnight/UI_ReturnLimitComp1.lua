...
var_0_0.URL = "ui://c64rm38yi65612uytot"

function var_0_0:__ctor()
	self.m_tipKnightLoader2 = self:getChild("tipKnightLoader2")
	self.m_tipKnightLoader1 = self:getChild("tipKnightLoader1")
	self.m_tipKnightLoader3 = self:getChild("tipKnightLoader3")
