...
local SpiritHelpTowerHard = class("SpiritHelpTowerHard", require("app.view.module.spiritHelp.view.helps.SpiritHelpDoingBase"))

function SpiritHelpTowerHard:initData()
...
function SpiritHelpTowerHard:getAwardText(arg_2_1)
	local var_2_0 = {}
	...
	for iter_2_0, iter_2_1 in ipairs(self._getContents) do
		...
		if not var_2_3 then
			...
			var_2_6 = var_2_0
			var_2_7 = g.core.lang:get(308001 + iter_2_1.stage_type - 5)
		end
...
function SpiritHelpTowerHard:refreshState()
	self._isTip = false

	local var_3_0 = true

	for iter_3_0, iter_3_1 in pairs(var_0_1.STAGE_TYPE_HARD) do
...
function SpiritHelpTowerHard:doing()
	for iter_4_0, iter_4_1 in pairs(var_0_1.STAGE_TYPE_HARD) do
...
function SpiritHelpTowerHard:_onRcvAllBlitz(arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	for iter_6_2, iter_6_3 in pairs(var_0_1.STAGE_TYPE_HARD) do
...
function SpiritHelpTowerHard:addCurDoAward(arg_7_1)
...
function SpiritHelpTowerHard:getCurDoingAward()
	local var_8_0 = {}
