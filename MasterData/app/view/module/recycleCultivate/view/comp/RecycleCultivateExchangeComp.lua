...
function RecycleCultivateExchangeComp:updateExchangeShow()
	...
	local var_13_0 = self.m_tabList:getSelectedIndex() + 1
	local var_13_1 = self._groupInfo[var_13_0]

	self._isLimitBan = self._groupInfo[var_13_0].ban_type ~= RecycleCultivateConst.RECYCLE_BAN_TYPE.NONE
	self._changeList = var_0_1:getRecycleDetailGroupInfo(var_13_1.group)
	self._exchangeCache = {}
	...
	local var_13_2 = g.core.model.User.bagData

	table.sort(self._changeList, function(arg_14_0, arg_14_1)
		local var_14_0 = var_13_2:getOwnNum(arg_14_0.original_type, arg_14_0.original_value) >= arg_14_0.original_size

		if var_14_0 ~= (var_13_2:getOwnNum(arg_14_1.original_type, arg_14_1.original_value) >= arg_14_1.original_size) then
			return var_14_0
		end
	...
	if var_13_1.ban_type == RecycleCultivateConst.RECYCLE_BAN_TYPE.NONE then
		self.m_convertNumTxt:setText("")
		self.m_isCanExchangeController:setSelectedIndex(0)
	else
		local var_13_3 = var_0_1:getGroupBanInfo(var_13_1.group).canExchangeNum

		self.m_convertNumTxt:setText(g.core.lang:get(430706 + var_13_1.ban_type, {
			num = var_13_3
		}))
		self.m_isCanExchangeController:setSelectedIndex(var_13_3 > 0 and 0 or 1)
	end
