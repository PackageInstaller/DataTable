local ThemeAnubisBioVoteItemComp = class("ThemeAnubisBioVoteItemComp", require("app.fairyGUI.themeBio.UI_ThemeAnubisBioVoteItemComp"))

function ThemeAnubisBioVoteItemComp:ctor()
	self._info = nil
	self._state = nil
	self._unlockStr = nil
...
function ThemeAnubisBioVoteItemComp:updateVoteItem(arg_2_1)
	arg_2_1 = arg_2_1 or {}
...
function ThemeAnubisBioVoteItemComp:_onClickItem()
	...
	if self._info then
		self:dispatchCompEvent("ThemeAnubisBioVoteItemComp_onClickItem", {
			info = self._info,
...
function ThemeAnubisBioVoteItemComp:_getVoteState()
	return
end

return ThemeAnubisBioVoteItemComp
