...
local ThemeAnubisBioVoteGameStage = class("ThemeAnubisBioVoteGameStage", require("app.fairyGUI.themeBio.UI_ThemeAnubisBioVoteGameStage"), function()
	return fgui.GComponent:create({
		pkgPath = "ui/themeBio/themeBio",
		isFullScreen = true,
		pkgName = "themeBio",
		resName = var_0_14.THEME_BIO_GAME_STAGE[({
			...
		})[1].themeValue]
	})
end)

function ThemeAnubisBioVoteGameStage:ctor(arg_2_1)
...
function ThemeAnubisBioVoteGameStage:onLoad()
	self:_initRegister()
...
function ThemeAnubisBioVoteGameStage:_scheduleOnceCall()
	self:newScheduleOnce(function()
		self:_taskFinishAwardSummary()
	end)
end

function ThemeAnubisBioVoteGameStage:_addBgMusic()
	self._bgMusic = nil
...
function ThemeAnubisBioVoteGameStage:onUnload()
...
function ThemeAnubisBioVoteGameStage:receiveCompEvent(arg_8_1, arg_8_2)
...
function ThemeAnubisBioVoteGameStage:initStage()
	self:_initMapWorld()
	self:_initStageData()
	self:_initStageUI()
...
function ThemeAnubisBioVoteGameStage:_playMainActionStart()
...
function ThemeAnubisBioVoteGameStage:_playMainInfoStart()
...
function ThemeAnubisBioVoteGameStage:_playMainFlowStart()
	self:_setHudUIShow(true)
end

function ThemeAnubisBioVoteGameStage:_playMainFlowEnd()
	self:newScheduleOnce(function()
		g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	end)
end

function ThemeAnubisBioVoteGameStage:_checkChapterFinish(arg_15_1)
...
function ThemeAnubisBioVoteGameStage:_playMainInfoEnd()
	if self._refChapterInfo then
...
function ThemeAnubisBioVoteGameStage:_checkFirstChapter()
...
function ThemeAnubisBioVoteGameStage:getMapWorld()
	return self._mapWorld
end

function ThemeAnubisBioVoteGameStage:getMapGround()
	return self._mapWorld:getMapGround()
end

function ThemeAnubisBioVoteGameStage:talkTrigger(arg_20_1)
...
function ThemeAnubisBioVoteGameStage:setAutoSearchPath(arg_22_1)
	self.m_autoComp:setVisible(arg_22_1)
end

function ThemeAnubisBioVoteGameStage:pickupStop()
	self.m_pickupComp:setVisible(false)
	self.m_pickupComp:stopAllFGActions()
end

function ThemeAnubisBioVoteGameStage:saveStayCoord(arg_24_1)
...
function ThemeAnubisBioVoteGameStage:getStayCoord()
	return self._themeBioStorage["stay_" .. self._chapterId]
end

function ThemeAnubisBioVoteGameStage:setHeadArrow(arg_26_1, arg_26_2, arg_26_3)
	self.m_headBtn:setVisible(arg_26_1)
end

function ThemeAnubisBioVoteGameStage:_loadSnowMovie(arg_27_1)
...
function ThemeAnubisBioVoteGameStage:_delayCreateMovie()
...
function ThemeAnubisBioVoteGameStage:_onCriSpriteEvent()
...
function ThemeAnubisBioVoteGameStage:_initMapWorld()
	self._mapWorld = ThemeBioGameWorld.new(self, self._worldId, self._activeThemeValue)

	self.m_worldHold:addNode(self._mapWorld)
end

function ThemeAnubisBioVoteGameStage:_initStageData()
	self:_deserializeBio()
end

function ThemeAnubisBioVoteGameStage:_initStageUI()
...
function ThemeAnubisBioVoteGameStage:_initRegister()
...
function ThemeAnubisBioVoteGameStage:_setHudUIShow(arg_36_1)
	if arg_36_1 then
...
function ThemeAnubisBioVoteGameStage:_refreshVoteBtn()
...
function ThemeAnubisBioVoteGameStage:_pickupStart(arg_38_1, arg_38_2, arg_38_3)
	self.m_pickupComp:stopAllFGActions()
...
function ThemeAnubisBioVoteGameStage:_serializeBio()
	g.core.common.Storage:save("theme_biography.json", self._themeBioStorage)
end

function ThemeAnubisBioVoteGameStage:_deserializeBio()
...
function ThemeAnubisBioVoteGameStage:_showBubbleOrStory(arg_42_1)
	local var_42_0 = {}
...
function ThemeAnubisBioVoteGameStage:_executeMission(arg_43_1)
...
function ThemeAnubisBioVoteGameStage:_onMissionStoryEnd(arg_44_1)
...
function ThemeAnubisBioVoteGameStage:_onTriggerMission(arg_45_1, arg_45_2, arg_45_3, arg_45_4)
...
function ThemeAnubisBioVoteGameStage:_processMissionBattle(arg_46_1, arg_46_2, arg_46_3, arg_46_4)
	if arg_46_2 ~= 1 then
		var_0_11:send_C2S_ThemeBiography_ExecuteMission({
			act_id = self._activeThemeValue,
			id = arg_46_1.id
...
function ThemeAnubisBioVoteGameStage:_processMissionEvent(arg_47_1, arg_47_2, arg_47_3, arg_47_4)
	self._refCurMission = nil
...
function ThemeAnubisBioVoteGameStage:_processMissionOther(arg_48_1, arg_48_2, arg_48_3, arg_48_4)
	var_0_11:send_C2S_ThemeBiography_ExecuteMission({
		act_id = self._activeThemeValue,
		id = arg_48_1.id
	})
...
function ThemeAnubisBioVoteGameStage:_beginBattleJump(arg_49_1, arg_49_2, arg_49_3)
...
function ThemeAnubisBioVoteGameStage:_showAwardAction(arg_50_1)
	self:getMapWorld():refreshEntityState(self._refChapterInfo)
...
function ThemeAnubisBioVoteGameStage:_onShowAwardCall(arg_52_1)
...
function ThemeAnubisBioVoteGameStage:_afterCompletedTask(arg_53_1, arg_53_2)
...
function ThemeAnubisBioVoteGameStage:_showMissionCostTip(arg_54_1)
	local var_54_0 = {}
...
function ThemeAnubisBioVoteGameStage:_playTaskCompleteAni(arg_55_1, arg_55_2)
...
function ThemeAnubisBioVoteGameStage:_taskFinishAwardSummary(arg_56_1)
...
function ThemeAnubisBioVoteGameStage:checkExitBtnShow(arg_57_1)
...
function ThemeAnubisBioVoteGameStage:_showCompletedAward(arg_58_1, arg_58_2, arg_58_3)
	g.core.module.ModuleManager:awardSummary(arg_58_1, true, nil, nil, handler(self, self._checkVotePop))
end

function ThemeAnubisBioVoteGameStage:_isNeedStory(arg_59_1)
...
function ThemeAnubisBioVoteGameStage:_executeStory(arg_60_1, arg_60_2)
...
function ThemeAnubisBioVoteGameStage:_onEventStoryEnd(arg_61_1)
...
function ThemeAnubisBioVoteGameStage:_getMissionTarget(arg_63_1, arg_63_2)
	local var_63_0
...
function ThemeAnubisBioVoteGameStage:_onSearchPathTarget(arg_64_1, arg_64_2)
...
function ThemeAnubisBioVoteGameStage:_onCompletedTask(arg_65_1, arg_65_2)
	self:_afterCompletedTask(arg_65_2.id, arg_65_2.awards)
end

function ThemeAnubisBioVoteGameStage:_onSetHudUIShow(arg_66_1, arg_66_2)
	self:_setHudUIShow(arg_66_2)
end

function ThemeAnubisBioVoteGameStage:_onJumpMainRoleClick()
	self._mapWorld:jump2MainRole()
	self:setHeadArrow(false)
end

function ThemeAnubisBioVoteGameStage:_onClickExitBtn()
	g.core.module.ModuleManager:popModule()
end

function ThemeAnubisBioVoteGameStage:_onThemePVGetInfo(arg_69_1, arg_69_2, arg_69_3, arg_69_4)
...
function ThemeAnubisBioVoteGameStage:_onModuleExit(arg_70_1, arg_70_2, arg_70_3)
...
function ThemeAnubisBioVoteGameStage:_onBioReviewClick()
	g.core.network.GameNetProxy:send_C2S_ThemePV_GetInfo({})
end

function ThemeAnubisBioVoteGameStage:_onBioBagClick()
	g.core.module.ModuleManager:pushPopup(require("app.view.module.themeBio.view.vote.ThemeAnubisBioVoteClueLayer").new({
		themeValue = self._activeThemeValue,
		chapterId = self._chapterId
	}), {
		tag = "ClueLayer",
...
function ThemeAnubisBioVoteGameStage:_onBioVoteClick()
...
function ThemeAnubisBioVoteGameStage:_onNetExecuteMission(arg_74_1, arg_74_2, arg_74_3)
...
function ThemeAnubisBioVoteGameStage:_onPopTaskFinish(arg_75_1, arg_75_2)
	self:_onTriggerMission(arg_75_2.mission, 0, false, arg_75_2.touchItem)
end

function ThemeAnubisBioVoteGameStage:_onPublishLastTaskFinish(arg_76_1, arg_76_2)
	self:_executeStory({
		id = arg_76_2.storyId
	})
end

function ThemeAnubisBioVoteGameStage:refreshTargetVector()
	local var_77_9000
...
function ThemeAnubisBioVoteGameStage:_checkChainState()
...
function ThemeAnubisBioVoteGameStage:isNextMissionTarget(arg_79_1)
...
function ThemeAnubisBioVoteGameStage:_executeInteractOperation(arg_80_1, arg_80_2)
...
function ThemeAnubisBioVoteGameStage:_showMissionFinishTips(arg_81_1)
	if arg_81_1 then
...
function ThemeAnubisBioVoteGameStage:_onCrossDayUpdate()
...
function ThemeAnubisBioVoteGameStage:_checkVoteTargetPop()
	if self._needShowTargetPop then
		self._needShowTargetPop = false

		self:getMapWorld():stopWalkRole()

		return g.core.module.ModuleManager:pushPopup(require("app.view.module.themeBio.view.vote.pop.anubis.ThemeAnubisBioVoteTargetPop").new({
...
function ThemeAnubisBioVoteGameStage:_checkJump2VoteLayer()
...
function ThemeAnubisBioVoteGameStage:_checkVotePop()
	if self._needShowTargetPop then
		self:runFGAction((fgui.FSequence:create({
			fgui.FDelayTime:create(1),
			fgui.FCallFunc:create(function()
...
return ThemeAnubisBioVoteGameStage
