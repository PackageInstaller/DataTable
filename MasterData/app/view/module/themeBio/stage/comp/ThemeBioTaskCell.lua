...
local ThemeBioTaskCell = class("ThemeBioTaskCell", require("app.fairyGUI.themeBio.UI_ThemeBioTaskCell"))

function ThemeBioTaskCell:ctor()
	self._tmpAwardArr = nil

	self:_initRegisterUI()
end

function ThemeBioTaskCell:_initRegisterUI()
...
function ThemeBioTaskCell:_onRenderAwardList(arg_3_1, arg_3_2)
...
function ThemeBioTaskCell:_onTaskGotoClick()
...
function ThemeBioTaskCell:updateData(arg_5_1, arg_5_2)
	local var_5_0 = var_0_0:getThemeData(arg_5_2):getThemeBioData():getMission(arg_5_1)
