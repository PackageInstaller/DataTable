...
local SevenDaysSpecialIntegralAwardCell = class("SevenDaysSpecialIntegralAwardCell", require("app.fairyGUI.sevenDaysActivity.UI_SevenDaysSpecialIntegralAwardCell"))

function SevenDaysSpecialIntegralAwardCell:ctor()
...
function SevenDaysSpecialIntegralAwardCell:_initIntegralIcon(arg_2_1)
...
function SevenDaysSpecialIntegralAwardCell:_onClickIcon()
...
function SevenDaysSpecialIntegralAwardCell:updateCell(arg_4_1, arg_4_2)
	...
	self.m_topController:setSelectedIndex(arg_4_2 and 1 or 0)
...
return SevenDaysSpecialIntegralAwardCell
