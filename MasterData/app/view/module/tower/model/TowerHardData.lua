...
local var_0_3 = g.core.config.tower_skip_info
local var_0_4 = g.core.config.tower_reward_info
...
local var_0_9 = g.core.const.ConstMgr.TowerConst.STAGE_TYPE_HARD
local var_0_10 = g.core.const.ConstMgr.RankAwardConst
local var_0_11 = g.core.const.ConstMgr.PARAMETER_CONST
local var_0_12 = g.core.common.ServerTime
local var_0_13 = g.core.model.User
local RankAward = require("app.core.common.RankAward")
local var_0_15 = g.core.const.ConstMgr
local var_0_16 = g.core.model.User.mulFormationData
local TowerCommon = require("app.view.module.tower.const.TowerCommon")
local TowerHardData = class("TowerHardData")

function TowerHardData:ctor()
	self:initData()
end

function TowerHardData:initData()
	...
	self._hangupOnceTime = var_0_2.get(var_0_11.TOWER_FIGHT_HARD_HANGUP_ONCE_TIME).parameter
	self._hangupMaxTime = var_0_2.get(var_0_11.TOWER_FIGHT_HARD_HANGUP_MAX_TIME).parameter
	self._hangupParameterTime = var_0_2.get(var_0_11.TOWER_FIGHT_HARD_HANGUP_ACCELERATE).parameter

	self:initStageInfo()
end

function TowerHardData:onGetInfoInitData()
	self._isInitGetInfo = false
	self._challengeIsWin = false
	self._buffStageList = nil
	self._rankRewardList = {}
...
function TowerHardData:resetData()
	self._rankList = {}
	self._selfRanks = {}
end

function TowerHardData:initJsonData()
	self._curUserKnightIdsInStageList = {}
	...
	for iter_5_2, iter_5_3 in pairs(g.core.common.Storage:load(var_0_8.HARD_SUB_TOWER_JSON_NAME, true) or {}) do
		self._subTowerMaxStageJsonData[tonumber(iter_5_2)] = iter_5_3
	end
end

function TowerHardData:setFormationData(arg_6_1, arg_6_2, arg_6_3)
	self._curUserKnightIdsInStageList[arg_6_1 .. "_" .. arg_6_2] = arg_6_3
end

function TowerHardData:saveFormationJsonData()
...
function TowerHardData:_checkIsChangeFormationInJson()
	...
	for iter_8_0, iter_8_1 in pairs(self._oldJsonFormationData) do
		if type(iter_8_1) == "table" then
			for iter_8_2 = 1, var_0_5.LINEUP_MAX do
...
function TowerHardData:getCurUserKnightIds(arg_9_1, arg_9_2)
	return clone(self._curUserKnightIdsInStageList[arg_9_1 .. "_" .. arg_9_2] or {})
end

function TowerHardData:getIsSelectPopFormation()
	return self._isSelectNotPopFormation
end

function TowerHardData:setIsSelectPopFormation(arg_11_1)
	self._isSelectNotPopFormation = arg_11_1 == true
end

function TowerHardData:checkIsNeedPopFormation(arg_12_1)
	if not self._isSelectNotPopFormation then
		return true
	end

	local var_12_0 = TowerCommon:getMultiTeamType(arg_12_1)
	local var_12_1, var_12_2 = self:getCurTowerIdByType(arg_12_1)

	for iter_12_0 = 1, var_0_0.get(var_12_2).enemy_num do
		if not var_0_16:getFormationStruct(var_12_0, iter_12_0):hasAnyGoodsLineUp(g.core.common.Goods.TYPE_KNIGHT) then
			return true
		end
	end
...
function TowerHardData:getFormationPos(arg_13_1)
	...
	for iter_13_0, iter_13_1 in pairs({}) do
		for iter_13_2 = 1, var_0_5.LINEUP_MAX do
...
function TowerHardData:saveSubTowerJsonData(arg_14_1)
	for iter_14_0 = var_0_9.JIAO_GUO, var_0_9.LI_JIN do
		self._subTowerMaxStageJsonData[iter_14_0] = self:getCurTowerIdByType(iter_14_0)
	end

	g.core.common.Storage:save(var_0_8.HARD_SUB_TOWER_JSON_NAME, self._subTowerMaxStageJsonData, true)
end

function TowerHardData:getLineNeedLightBySubTower()
	local var_15_0 = {}

	for iter_15_0 = var_0_9.JIAO_GUO, var_0_9.LI_JIN do
...
function TowerHardData:onsS2CTowerGetInfo(arg_16_1)
	...
	if var_16_0 then
		for iter_16_0, iter_16_1 in ipairs(var_16_0) do
			if iter_16_1.user_stage then
				self._passTowerHardData[iter_16_1.user_stage.type] = iter_16_1.user_stage
			end
	...
	for iter_16_2, iter_16_3 in pairs(arg_16_1.can_award_ids or {}) do
		local var_16_1 = var_0_4.fetch(iter_16_3)
...
function TowerHardData:getIsInitGetInfo()
	return self._isInitGetInfo
end

function TowerHardData:getIsFirstPassByStageAndId(arg_18_1, arg_18_2)
	return arg_18_2 <= (self._towerMaxPassRewardIdMap[arg_18_1] or 0)
end

function TowerHardData:getFirstPassMaxId(arg_19_1)
	return self._towerMaxPassRewardIdMap[arg_19_1] or 0
end

function TowerHardData:_initCapacityData()
	self._capacityData = {}

	for iter_20_0, iter_20_1 in pairs(var_0_9) do
		self._capacityData[iter_20_1] = self:getStageRewardList(self:getCurTowerIdByType(iter_20_1), false)
	end
end

function TowerHardData:getCapacityData()
...
function TowerHardData:getCapacityAddListData(arg_22_1)
	if self._capacityData == nil then
		self:_initCapacityData()
	end
...
function TowerHardData:getCapacityAddListDataById(arg_23_1, arg_23_2)
...
function TowerHardData:onsS2CChallengeStageFinish(arg_24_1)
	...
	if not self._passTowerHardData[var_24_1] then
		self._passTowerHardData[var_24_1] = var_24_2
	else
		for iter_24_0, iter_24_1 in pairs(var_24_2) do
			self._passTowerHardData[var_24_1][iter_24_0] = iter_24_1
		end
	end

	if arg_24_1.is_win then
		if var_24_1 == var_0_9.MAIN and not self:getMainTowerIsOpen() then
...
function TowerHardData:onsS2CFirstPassAward(arg_25_1)
	if arg_25_1 then
		self._firstPassAwardGetIds[arg_25_1.id] = true
	end
end

function TowerHardData:onsS2COneKeyFirstPassAward(arg_26_1)
	for iter_26_0, iter_26_1 in pairs(arg_26_1.ids or {}) do
		self._firstPassAwardGetIds[iter_26_1] = true
	end
end

function TowerHardData:onsS2CHangupAward(arg_27_1)
	self._hangupStartTime = var_0_12:getTime()
	self._serverHangUpReward = {}
end

function TowerHardData:onsS2CFastRolling(arg_28_1)
	...
	if arg_28_1.stage then
		...
		if not self._passTowerHardData[var_28_0] then
			self._passTowerHardData[var_28_0] = var_28_2
		else
			for iter_28_0, iter_28_1 in pairs(var_28_2) do
				self._passTowerHardData[var_28_0][iter_28_0] = iter_28_1
			end
		end
	end
...
function TowerHardData:onsS2COneKeyChallenge(arg_29_1)
	if arg_29_1.stage then
		...
		if not self._passTowerHardData[arg_29_1.stage.type] then
			self._passTowerHardData[arg_29_1.stage.type] = var_29_1
		else
			for iter_29_0, iter_29_1 in pairs(var_29_1) do
				self._passTowerHardData[arg_29_1.stage.type][iter_29_0] = iter_29_1
			end
		end
	end
end

function TowerHardData:convertCapacityAward(arg_30_1, arg_30_2)
	local var_30_0 = {}
	local var_30_1 = {}
	local var_30_2 = math.min(var_0_12:getTime(), self._hangupEndTime)
	...
	for iter_30_0, iter_30_1 in pairs(arg_30_1) do
		...
		if arg_30_2 ~= nil then
			...
			local var_30_4 = self._passTowerHardData[iter_30_0]

			var_30_3 = self._passTowerHardData[iter_30_0] and var_30_4.open_time > 0 and var_30_2 - math.max(var_30_4.open_time, self._hangupStartTime) or 0
		end

		for iter_30_2, iter_30_3 in pairs(iter_30_1) do
			local var_30_5 = math.floor(iter_30_3.size * var_30_3 / self._hangupOnceTime)

			if var_30_5 > 0 then
				if var_30_1[iter_30_3.type .. "_" .. iter_30_3.value] then
					var_30_0[var_30_1[iter_30_3.type .. "_" .. iter_30_3.value]].size = var_30_0[var_30_1[iter_30_3.type .. "_" .. iter_30_3.value]].size + var_30_5
				else
					...
					var_30_1[iter_30_3.type .. "_" .. iter_30_3.value] = #var_30_0
				end
			end
		end
	end
...
function TowerHardData:_checkIsAddItem(arg_31_1, arg_31_2)
...
function TowerHardData:getCurTowerIdByType(arg_32_1)
	local var_32_1 = (self._passTowerHardData[arg_32_1] or {}).id or 0
...
function TowerHardData:initStageInfo()
	local var_33_0 = {}
	local var_33_1 = {}
	...
	for iter_33_0 = 1, var_0_0.getLength() do
		...
		if var_33_2.play_type == var_0_8.TOWER_DIFFICULTY.HARD then
...
function TowerHardData:_initBuffInfo()
	local var_34_0 = {}
...
function TowerHardData:getTowerBuffInfo(arg_36_1)
...
function TowerHardData:getMainTowerIsOpen()
	local var_37_0 = self:getCurTowerIdByType(var_0_9.MAIN)
	local var_37_1
	local var_37_2 = 0
	local var_37_3 = 0

	if var_37_0 <= 0 then
		var_37_1 = var_0_0.get(self._towerStageInfo[var_0_9.MAIN].startId)
		var_37_3 = 0
	...
	if var_37_1.require_type == var_0_8.STAGE_REQUIRE_TYPE.NONE then
		var_37_5 = true
	elseif var_37_1.require_type == var_0_8.STAGE_REQUIRE_TYPE.ALL or var_37_1.require_type == var_0_8.STAGE_REQUIRE_TYPE.HARD_ALL then
...
function TowerHardData:getTotalSubTower()
	local var_38_0 = 0

	for iter_38_0 = var_0_9.JIAO_GUO, var_0_9.LI_JIN do
...
function TowerHardData:getParamDataByType(arg_39_1)
...
function TowerHardData:getSubTowerIsOpen(arg_40_1)
	if not next(self._towerParamsData) then
		self:_initTowerParams()
	end

	local var_40_0 = self._towerParamsData[arg_40_1] or {}
	local var_40_1 = var_0_12:getWeekDay()
	...
	local var_40_3 = var_0_12:getTime()
	local var_40_4 = 0
...
function TowerHardData:debugGetSubTowerIsOpen(arg_41_1)
	if arg_41_1 == var_0_8.STAGE_TYPE_HARD.MAIN then
	...
	local var_41_1 = var_0_12:getWeekDay()
	...
	local var_41_3 = var_0_12:getTime()
	local var_41_4 = 0
...
function TowerHardData:isGMOpenByType(arg_42_1)
	return false
end

function TowerHardData:_initTowerParams()
...
function TowerHardData:_initTowerSkipMap()
	self._towerSkipMap = {}

	for iter_44_0 = 1, var_0_3.getLength() do
		local var_44_0 = var_0_3.indexOf(iter_44_0)

		self._towerSkipMap[var_44_0.play_type] = self._towerSkipMap[var_44_0.play_type] or {}

		table.insert(self._towerSkipMap[var_44_0.play_type], var_44_0)
	end
end

function TowerHardData:isPassBattleById(arg_45_1)
	if not self._towerSkipMap then
		self:_initTowerSkipMap()
	end

	local var_45_0 = var_0_13:getFightValue()
	local var_45_1 = var_0_0.fetch(arg_45_1)

	if var_45_1 == nil then
		return false
	end

	if var_45_1.if_speedup == 0 then
		return false
	end

	if var_45_1.if_node == 1 then
		var_45_1 = var_0_0.fetch(var_45_1.next_stage)
	...
	local var_45_2 = self._towerSkipMap[2]

	if not self._towerSkipMap[2] then
		return false
	end
	...
	for iter_45_0, iter_45_1 in ipairs(var_45_2) do
		if var_45_1.stage_order >= iter_45_1.tower_min and var_45_1.stage_order <= iter_45_1.tower_max then
			var_45_3 = iter_45_1.value
		end
	end

	return var_45_0 >= ((self._displayVersion == 1 or nil) and (var_45_1.fight or var_45_1["fight_" .. self._displayVersion])) * (var_45_3 / 1000)
end

function TowerHardData:getSubTowerMaxCount(arg_46_1)
...
function TowerHardData:getStageRewardList(arg_47_1, arg_47_2)
...
function TowerHardData:resRankList(arg_48_1)
...
function TowerHardData:getRankListByStageType(arg_49_1)
	return self._rankList[arg_49_1]
end

function TowerHardData:getMySelfRank(arg_50_1)
	return self._selfRanks[arg_50_1] or 0
end

function TowerHardData:getRankRewardListByStageType(arg_51_1)
	if self._rankRewardList[arg_51_1] ~= nil then
		return self._rankRewardList[arg_51_1]
	end

	local var_51_0 = RankAward:getRankAwardArray(var_0_10["TOWER_HARD_" .. arg_51_1])
...
function TowerHardData:canGetHangupReward()
	if next(self._serverHangUpReward) then
		return true
	end

	local var_62_1 = var_0_12:getTime()

	for iter_62_0, iter_62_1 in pairs((self:getCapacityData())) do
		for iter_62_2, iter_62_3 in pairs(iter_62_1) do
			if math.floor(iter_62_3.size * ((self._passTowerHardData[iter_62_0] and self._passTowerHardData[iter_62_0].open_time > 0 or nil) and math.min(var_62_1, self._hangupEndTime) - self._passTowerHardData[iter_62_0].open_time) / self._hangupOnceTime) > 0 then
				return true
			end
		end
	end
...
function TowerHardData:getCurRealHangupTimeAndProgress()
	if self._hangupStartTime == 0 then
		return 0, 0
	end

	local var_63_0 = math.min(var_0_12:getTime() - self._hangupStartTime, self._hangupMaxTime)

	return var_63_0, var_63_0 / self._hangupMaxTime
end

function TowerHardData:getHangupTimeData()
	return self._hangupStartTime, self._hangupEndTime
end

function TowerHardData:getQuickHangupReward()
...
function TowerHardData:getChallengeIsWin()
	self._challengeIsWin = false

	return self._challengeIsWin
end

function TowerHardData:isShowAutoBtn(arg_68_1)
	...
	if var_0_7:getLeftCount(var_0_6.PLAY_TYPE["TOWER_HARD_CHALLENGE_COUNT_" .. arg_68_1]) <= 0 then
		return false
	end
...
function TowerHardData:isSpiritHelpShow(arg_69_1)
	...
	if var_0_7:getLeftCount(var_0_6.PLAY_TYPE["TOWER_HARD_CHALLENGE_COUNT_" .. arg_69_1]) <= 0 then
		return false
	end
	...
	local var_69_3 = var_0_13:getFightValue()
	...
	for iter_69_0, iter_69_1 in ipairs(self._towerSkipMap[2] or {}) do
...
function TowerHardData:setDisplayVersion(arg_70_1)
	self._displayVersion = arg_70_1
end

function TowerHardData:getDisplayVersion()
	return self._displayVersion
end

function TowerHardData:setMonsterVersion(arg_72_1)
	self._monsterVersion = arg_72_1
end

function TowerHardData:getSwitchMonsterTeamId(arg_73_1)
...
function TowerHardData:hasHangupRewardRed()
	local var_74_0, var_74_1 = self:getCurRealHangupTimeAndProgress()

	return var_74_1 >= 0.5
end

function TowerHardData:hasFirstPassRewardRed(arg_75_1)
...
function TowerHardData:hasRedPointByFreeCount()
	if self._hangupStartTime ~= 0 then
	...
	if var_0_7:getLeftCount(var_0_15.ShopConst.PLAY_TYPE.TOWER_HARD_ACCELERATE_COUNT) > 0 then
		return true
	end
...
function TowerHardData:updateRedData(arg_77_1)
	...
	for iter_77_0, iter_77_1 in ipairs(arg_77_1.user_stages or {}) do
		if iter_77_1.type then
			self._passTowerHardData[iter_77_1.type] = iter_77_1
		end
	end
end

return TowerHardData
