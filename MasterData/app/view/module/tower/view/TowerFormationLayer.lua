...
function TowerFormationLayer:_dragLineupKnight(arg_20_1)
	...
	if self._knightPosIds[self._starPos] > 0 then
		local var_20_0 = fgui.DragDropManager:getInstance()

		var_20_0:startDrag("common/ui_cocos/lineUp/pic_touming.png", nil, (arg_20_1:getInput():getTouchId()))

		local var_20_1 = BattleKnight.new({
			breath = true,
			scale = 1.2,
			base = true,
		...
		var_20_1:setScale(1.2)
		var_20_1:setName("knight")
		var_20_0:getAgent():displayObject():addChild(var_20_1)
		var_20_1:setPosition(50, 0)
