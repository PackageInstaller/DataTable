...
local var_0_3 = g.core.model.User.towerData
...
local TowerCollectionPlatformPop = class("TowerCollectionPlatformPop", require("app.fairyGUI.tower.UI_TowerCollectionPlatformPop"), function()
	return fgui.GComponent:create({
		resName = "TowerCollectionPlatformPop",
...
function TowerCollectionPlatformPop:ctor()
	self._addItemList = {}

	self:initView()
end

function TowerCollectionPlatformPop:initView()
	...
	self.m_tipTxt:setText(var_0_8:get(308026, {
		num = math.floor(var_0_1.get(var_0_7.PARAMETER_CONST.TOWER_FIGHT_HANGUP_ACCELERATE).parameter / 3600)
	}))
end

function TowerCollectionPlatformPop:_onClickAccelerateBtn()
	...
	if not var_0_2:getResetCost(var_0_7.ShopConst.PLAY_TYPE.TOWER_ACCELERATE_COUNT) then
		var_0_6:tip(g.core.lang:get(308027))

		return
	end

	local var_4_0 = var_0_7.ShopConst.PLAY_TYPE.TOWER_ACCELERATE_COUNT

	if var_0_2:getLeftCount(var_0_7.ShopConst.PLAY_TYPE.TOWER_ACCELERATE_COUNT) > 0 then
...
function TowerCollectionPlatformPop:_onClickGetAwardBtn()
...
function TowerCollectionPlatformPop:_onRendererAddItemList(arg_6_1, arg_6_2)
	arg_6_2:update(self._addItemList[arg_6_1 + 1], false)
end

function TowerCollectionPlatformPop:_onRendererRewardItemList(arg_7_1, arg_7_2)
...
function TowerCollectionPlatformPop:onLoad()
...
function TowerCollectionPlatformPop:_updateHangupTime()
	self.m_curTime:setText(var_0_5:secondToHMSString((var_0_3:getCurRealHangupTimeAndProgress())))
end

function TowerCollectionPlatformPop:_onRecHangUpReward(arg_10_1, arg_10_2, arg_10_3)
	self:updateView()
end

function TowerCollectionPlatformPop:_onRcvBuyPlayNum(arg_11_1, arg_11_2, arg_11_3)
	if var_0_2:getLeftCount(var_0_7.ShopConst.PLAY_TYPE.TOWER_ACCELERATE_COUNT) > 0 then
		g.core.network.GameNetProxy:send_C2S_Tower_HangupQuickAward({
			count = 1
		})
...
function TowerCollectionPlatformPop:_onRcvQuickReward(arg_12_1, arg_12_2, arg_12_3)
	if arg_12_3 then
...
function TowerCollectionPlatformPop:updateView()
	self:updateCapacity()
...
function TowerCollectionPlatformPop:updateAccelerateView()
	local var_14_0 = var_0_0.get(var_0_7.ShopConst.PLAY_TYPE.TOWER_ACCELERATE_COUNT)
	local var_14_1 = var_0_2:getLeftCount(var_0_7.ShopConst.PLAY_TYPE.TOWER_ACCELERATE_COUNT)
	local var_14_2 = var_0_2:getPlayBuyCount(var_0_7.ShopConst.PLAY_TYPE.TOWER_ACCELERATE_COUNT)
...
function TowerCollectionPlatformPop:updateRewardList()
...
function TowerCollectionPlatformPop:updateCapacity()
	self._addItemList = {}
...
function TowerCollectionPlatformPop:onUnload()
...
return TowerCollectionPlatformPop
