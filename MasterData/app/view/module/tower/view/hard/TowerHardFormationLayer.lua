...
function TowerHardFormationLayer:_dragLineupKnight(arg_32_1)
	...
	if self._knightPosIds[self._starPos] > 0 then
		local var_32_0 = fgui.DragDropManager:getInstance()

		var_32_0:startDrag("common/ui_cocos/lineUp/pic_touming.png", nil, (arg_32_1:getInput():getTouchId()))

		local var_32_1 = BattleKnight.new({
			breath = true,
			scale = 1.2,
			base = true,
		...
		var_32_1:setName("knight")
		var_32_0:getAgent():displayObject():addChild(var_32_1)
		var_32_1:setPosition(50, 0)
