...
function EchoLabCollectInfoComp:updateView(arg_3_1)
	...
	if not self._cardStruct:isActive() then
		...
		if self._cardStruct:canActive() then
			...
			local var_3_18 = g.core.model.User.echoLabData:getCollectData()
			local var_3_19 = var_3_18:getBuildInfo(var_3_17.compose_belong):getDailyActiveInfo(var_3_17.cards_type).activeMaxCount

			var_3_15 = g.core.lang:get(408528, {
				name = g.core.lang:get(408700 + var_3_16),
				color = var_3_18.activeCount < var_3_19 and "#24bd81" or "#f44e4e",
				num = var_3_19 - var_3_18.activeCount,
				max = var_3_19
			})
		else
	...
	elseif not self._cardStruct:isMaxGrade() then
		local var_3_20 = self._cardStruct:getUpgradeInfo()
		local var_3_21 = var_3_20.target
		local var_3_22 = var_3_20.cur
		local var_3_23 = "#24bd81"

		if var_3_20.target <= var_3_20.cur then
...
function EchoLabCollectInfoComp:_onConfirmBtnClick()
	if self.m_stateController:getSelectedIndex() == 1 then
		...
		local var_4_1 = g.core.model.User.echoLabData:getCollectData()

		if var_4_1.activeCount >= var_4_1:getBuildInfo(var_4_0.compose_belong):getDailyActiveInfo(var_4_0.cards_type).activeMaxCount then
