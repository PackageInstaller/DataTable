...
function EchoLabTreeScrollComp:onClickIcon(arg_2_1, arg_2_2)
	...
	if var_2_2 then
		...
		if arg_2_2 then
			...
			local var_2_7 = display.width - var_2_6 - var_2_3:getNextLineWidth()

			if var_2_7 <= var_2_4 then
...
function EchoLabTreeScrollComp:checkCompIsClick(arg_12_1, arg_12_2)
	for iter_12_0, iter_12_1 in pairs(self._curShowIconDict) do
		for iter_12_2, iter_12_3 in pairs(iter_12_1) do
			local var_12_0 = iter_12_3.comp:displayObject()

			if var_12_0 <= -iter_12_3.comp:getWidth() or arg_12_2 <= var_12_0:convertToWorldSpace(cc.p(0, 0)).x then
				break
			end
