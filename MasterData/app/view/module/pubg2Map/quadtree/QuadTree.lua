...
local function var_0_1(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5, arg_1_6)
	local var_1_0 = table.remove(var_0_0) or require("app.view.module.pubg2Map.quadtree.QuadNode").new()
...
function QuadTree:ctor(arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5, arg_3_6)
	...
	self.root = var_0_1(arg_3_1, arg_3_2, arg_3_3, arg_3_4, 0, arg_3_5, arg_3_6)
	self._dirtyRenderObject = {}
end

function QuadTree:addDirty(arg_4_1)
	table.insert(self._dirtyRenderObject, arg_4_1)
end

function QuadTree:refreshRender()
	local var_5_0 = false

	for iter_5_0, iter_5_1 in ipairs(self._dirtyRenderObject) do
...
function QuadTree:queryRange(arg_7_1, arg_7_2, arg_7_3)
	...
	QuadTree.recursiveQueryRange(self.root, arg_7_1, arg_7_2, arg_7_3 * arg_7_3, var_0_1(arg_7_1 - arg_7_3 * 0.5, arg_7_2 - arg_7_3 * 0.5, arg_7_3, arg_7_3, 0, self.root.capacity, self.root.maxDepth), var_7_0, var_7_1)
...
function QuadTree:queryRect(arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	local var_8_0 = {}
	local var_8_1 = {}
	local var_8_2 = var_0_1(arg_8_1, arg_8_2, arg_8_3, arg_8_4, 0, self.root.capacity, self.root.maxDepth)
...
function QuadTree:remove(arg_9_1)
	...
	for iter_9_0, iter_9_1 in ipairs(arg_9_1.node.entities) do
		if iter_9_1.oid == arg_9_1.oid then
			table.remove(var_9_0.entities, iter_9_0)
...
function QuadTree:updateDependencies(arg_11_1)
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_1.renderDependenciesAfter) do
	...
	for iter_11_2, iter_11_3 in ipairs((self:queryRect(arg_11_1.x - arg_11_1.renderDependWidth * 0.5, arg_11_1.y - arg_11_1.renderDependHeight * 0.5, arg_11_1.renderDependWidth, arg_11_1.renderDependHeight))) do
		if iter_11_3.oid ~= arg_11_1.oid then
			if QuadTree.shouldOcclude(arg_11_1, iter_11_3) then
				...
				table.insert(arg_11_1.renderDependenciesAfter, iter_11_3)
			end
		end
	end
end
...
function QuadTree:debugLog()
	...
	local function var_16_1(arg_17_0, arg_17_1)
		...
		if arg_17_0.children then
			for iter_17_0, iter_17_1 in ipairs(arg_17_0.children) do
		...
		elseif #arg_17_0.entities > 0 then
			...
			for iter_17_2, iter_17_3 in ipairs(arg_17_0.entities) do
				var_16_0 = var_16_0 .. string.rep("| ", arg_17_1 + 2) .. "Entity OID: " .. iter_17_3.oid .. " Type: " .. iter_17_3._type .. " Position: (" .. iter_17_3.x .. ", " .. iter_17_3.y .. ")\n"
			end
		end
	end
...
function QuadTree:recursiveInsert(arg_20_1)
	if self.children then
		for iter_20_0, iter_20_1 in ipairs(self.children) do
	...
	table.insert(self.entities, arg_20_1)
	...
	if #self.entities > self.capacity and self.depth < self.maxDepth then
		if not self.children then
			...
			table.insert(self.children, var_0_1(self.x, self.y, self.width / 2, self.height / 2, self.depth + 1, self.capacity, self.maxDepth))
			table.insert(self.children, var_0_1(self.x + self.width / 2, self.y, self.width / 2, self.height / 2, self.depth + 1, self.capacity, self.maxDepth))
			table.insert(self.children, var_0_1(self.x, self.y + self.height / 2, self.width / 2, self.height / 2, self.depth + 1, self.capacity, self.maxDepth))
			table.insert(self.children, var_0_1(self.x + self.width / 2, self.y + self.height / 2, self.width / 2, self.height / 2, self.depth + 1, self.capacity, self.maxDepth))
		end

		for iter_20_2, iter_20_3 in ipairs(self.entities) do
			for iter_20_4, iter_20_5 in ipairs(self.children) do
...
function QuadTree:recursiveQueryRange(arg_22_1, arg_22_2, arg_22_3, arg_22_4, arg_22_5, arg_22_6)
	...
	if self.children then
		for iter_22_0, iter_22_1 in ipairs(self.children) do
			QuadTree.recursiveQueryRange(iter_22_1, arg_22_1, arg_22_2, arg_22_3, arg_22_4, arg_22_5, arg_22_6)
		end
	else
		for iter_22_2, iter_22_3 in ipairs(self.entities) do
			if not iter_22_3:isClear() then
				if arg_22_3 >= (iter_22_3.x - arg_22_1) * (iter_22_3.x - arg_22_1) + (iter_22_3.y - arg_22_2) * (iter_22_3.y - arg_22_2) then
					table.insert(arg_22_5, iter_22_3)
...
function QuadTree:tryMery()
	...
	for iter_23_0, iter_23_1 in ipairs(self.children) do
		var_23_0 = var_23_0 + #iter_23_1.entities
	end

	if var_23_0 <= self.capacity then
		for iter_23_2, iter_23_3 in ipairs(self.children) do
			for iter_23_4, iter_23_5 in ipairs(iter_23_3.entities) do
				table.insert(self.entities, iter_23_5)
		...
		for iter_23_6, iter_23_7 in ipairs(self.children) do
