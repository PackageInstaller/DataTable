...
local Pubg2SettingMapGround = class("Pubg2SettingMapGround", function()
	return cc.Node:create()
end)

function Pubg2SettingMapGround:ctor(arg_2_1)
...
function Pubg2SettingMapGround:initGround()
	self:_initTiledMap()

	var_0_0.map.MAP_DEBUG_GRID = true
...
function Pubg2SettingMapGround:getMapWorld()
	return self._fatherWorld
end

function Pubg2SettingMapGround:getMapStage()
	return self._fatherWorld:getMapStage()
end

function Pubg2SettingMapGround:getMapWidth()
	return self._MAP_WIDTH
end

function Pubg2SettingMapGround:getMapHeight()
	return self._MAP_HEIGHT
end

function Pubg2SettingMapGround:getHalfTileH()
	return self._MAP_TILE_HH
end

function Pubg2SettingMapGround:coordToPixel(arg_9_1, arg_9_2)
	return (arg_9_1 - arg_9_2) * self._MAP_TILE_HW, -(arg_9_1 + arg_9_2) * self._MAP_TILE_HH
end

function Pubg2SettingMapGround:pixelToCoord(arg_10_1, arg_10_2)
...
function Pubg2SettingMapGround:checkCoordInvalid(arg_11_1, arg_11_2)
...
function Pubg2SettingMapGround:doBasePath()
	return g.core.common.Path:getPubgBasePath()
end

function Pubg2SettingMapGround:_doTiledLayer()
	return {
		"ground"
	}
end

function Pubg2SettingMapGround:doAttachNode()
	return {
		"ground"
	}
end

function Pubg2SettingMapGround:_initTiledMap()
...
function Pubg2SettingMapGround:_updateTiledLayerPos(arg_16_1)
...
function Pubg2SettingMapGround:_initDebugGrid()
...
function Pubg2SettingMapGround:_initDebugGridText()
