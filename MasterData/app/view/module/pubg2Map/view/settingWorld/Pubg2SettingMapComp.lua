...
function Pubg2SettingMapComp:setStage(arg_12_1)
	...
	local var_12_0 = self:getMapWorld()
	local var_12_1 = var_12_0:getMapGround()

	self.m_floorComp:loadConfig(1, var_12_1:getMapWidth(), (self:getMapWorld().getMapGround(var_12_1).getMapHeight(var_12_0)))

	local var_12_2 = self:getFloorComp()
	local var_12_3 = var_12_2:getMyCompPos()

	self:getMapWorld().setFollowCenter(var_12_2, cc.p(var_12_3.x, -var_12_3.y))
end
...
function Pubg2SettingMapComp:tickMapUpdate(arg_22_1)
	if self._stage then
		...
		if arg_22_1 then
			local var_22_0 = self:getFloorComp()
			local var_22_1 = var_22_0:getMyCompPos()

			self:getMapWorld().setFollowCenter(var_22_0, cc.p(var_22_1.x, -var_22_1.y))
		end
