...
function GveFormationKnightComp:updateMonster(arg_5_1, arg_5_2, arg_5_3)
	...
	if arg_5_1.isBossInfo then
		...
		local var_5_2 = var_0_5:getGveData()

		if var_5_2 <= 0 then
			self.m_hasMaskController:setSelectedIndex(1)
		end

		self.m_hpBar:setValue((var_5_2:getBossData(var_5_0.id):getHpByIndexAndPos(var_5_1, self._pos)))
	else
		...
		if var_5_4 then
			...
			local var_5_5 = var_0_5:getGveData()
			local var_5_6 = var_5_5:getCurGridBaseData(arg_5_2, arg_5_3).hp
			local var_5_7 = ((not var_5_5 or nil) and {})[self._pos] or 1000

			self.m_hpBar:setValue(var_5_7)
			...
			local var_5_8 = var_0_4.get(var_5_4.res_id)

			self.m_knightIcon:setIcon(var_0_6:getKnightPicRes(var_5_8.painted_id))

			local var_5_9 = var_0_2.fetch(var_5_3["artifact_id_" .. self._pos])

			if var_5_9 then
				local var_5_10 = var_0_6:getArtifactFormationImg(var_5_9.res_id)

				self.m_artifactIcon:setIcon(var_5_10)
				self.m_artifactIcon1:setIcon(var_5_10)
				self.m_artifactStarText:setText(var_5_9.star)
			...
			self.m_knightTypeController:setSelectedIndex(var_0_8.NONE)
			self.m_qualityController:setSelectedIndex(var_5_8.quality)
		else
