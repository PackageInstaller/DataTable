...
function GveFormationPresetBottomComp:_dragLineupPet(arg_6_1)
	...
	if var_6_2 and var_6_2 > 0 then
		...
		local var_6_3 = fgui.DragDropManager:getInstance()
		local var_6_4 = var_6_3:getAgent():getComponent()

		if var_6_3 then
			var_6_4:bindLua("app.view.module.gve.view.gveFormation.comp.GveFormationPetIcon")
			var_6_4:updatePetFormatIcon((var_0_1:getPetBySid(var_6_2)))
		end
...
function GveFormationPresetBottomComp:_dragLineupSuccuba(arg_8_1)
	...
	if var_8_2 and var_8_2 > 0 then
		...
		local var_8_3 = fgui.DragDropManager:getInstance()
		local var_8_4 = var_8_3:getAgent():getComponent()

		if var_8_3 then
			var_8_4:bindLua("app.view.module.gve.view.gveFormation.comp.GveFormationSuccubaIconComp")
			var_8_4:updateSuccubaIcon((g.core.model.User.succubaData:getSuccubaBySid(var_8_2)))
