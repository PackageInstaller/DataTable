...
local MysteryMonsterTaskCell = class("MysteryMonsterTaskCell", require("app.fairyGUI.mystery.UI_MysteryMonsterTaskCell"))

function MysteryMonsterTaskCell:ctor()
...
function MysteryMonsterTaskCell:_onRewardItemRender(arg_2_1, arg_2_2)
	arg_2_2:updateIcon(self.awards[arg_2_1 + 1])
end

function MysteryMonsterTaskCell:updateCell(arg_3_1, arg_3_2, arg_3_3)
...
function MysteryMonsterTaskCell:_updateTaskState()
...
function MysteryMonsterTaskCell:_getTaskAwards()
	local var_5_0 = {}
...
function MysteryMonsterTaskCell:_onClickGetBtn()
	if self._taskState == var_0_1.TASK_STATE.CAN_AWARD then
...
function MysteryMonsterTaskCell:_onClickGoBtn()
