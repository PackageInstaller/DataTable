...
function CrossServerArenaBattlePrepareLayer:_onDragLineupKnight(arg_21_1)
	...
	if var_21_0 > 0 then
		local var_21_1 = fgui.DragDropManager:getInstance()

		var_21_1:startDrag("common/ui_cocos/lineUp/pic_touming.png", nil, (arg_21_1:getInput():getTouchId()))

		local var_21_2 = BattleKnight.new({
			breath = true,
			scale = 1.2,
			base = true,
		...
		var_21_2:setName(var_0_14)
		var_21_1:getAgent():displayObject():addChild(var_21_2)
		var_21_2:setPosition(50, 0)
	end
end
