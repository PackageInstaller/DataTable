...
function PubgRecoverPop:_onUpdateRecover()
	local var_5_0 = self._mapData:getMyUser()
	local var_5_1 = var_5_0:getRecoverTime() - var_0_0:getTime()

	if var_5_0 > 0 then
		if var_5_1 <= 3 then
			self.m_recoverTimeController:setSelectedIndex(var_5_1)
		else
			self.m_recoverTimeController:setSelectedIndex(0)
		end

		self.m_recoverTimeText:setText(var_5_1)
	else
