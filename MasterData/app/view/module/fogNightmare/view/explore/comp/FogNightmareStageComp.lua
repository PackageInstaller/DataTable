...
function FogNightmareStageComp:_reqChallenge()
	local var_50_0 = var_0_2:getTowerData():getFloorStruct((var_0_2:getTowerData():getCurrentFloorNum())):getSelectedStage()[1]

	var_50_0:setSelectWave(self._selectWaveIdx + 1)

	self._waveType = var_50_0:getAllWave()[self._selectWaveIdx + 1]:getType()
...
function FogNightmareStageComp:_onChallengeBegin(arg_52_1, arg_52_2, arg_52_3, arg_52_4)
	...
	if not var_52_3:isAutoPlay() and var_0_2:getFormationData().getStageSkipChallenge(var_52_3) and g.core.module.ModuleManager:getCurModule().display:getName() ~= "FogNightmareExploreFormationPop" then
		g.core.battle.BattleShowResult:enableAll()
		g.core.battle.BattleProxy:fastBattle(arg_52_4.battle_id)
