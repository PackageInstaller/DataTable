...
function ShopPlayComp:ctor()
	...
	local var_1_1 = var_1_0:getSafeAreaRect()
	local var_1_2 = self.m_lastTimeTxt:getPosition()

	self.m_descTxt:setPosition(var_1_0.x - var_1_1.x, self.m_descTxt:getPosition().y)
	self.m_lastTimeTxt:setPosition(var_1_2.x - var_1_1.x, var_1_2.y)
