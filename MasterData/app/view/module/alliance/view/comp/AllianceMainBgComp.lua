...
function AllianceMainBgComp:_onClickMove(arg_5_1)
	...
	local var_5_1 = cc.p(var_5_0.x, display.height - var_5_0:getTouch():getLocation().y)

	self:moveKnight(self._myKnight, (cc.p(var_5_1.x + self._scrollPanel:getPosX(), var_5_1.y + self._scrollPanel:getPosY())))
