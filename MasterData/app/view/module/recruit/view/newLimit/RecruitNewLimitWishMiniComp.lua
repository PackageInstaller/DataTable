local RecruitWishMiniComp = class("RecruitWishMiniComp", require("app.fairyGUI.recruitKnight.UI_RecruitNewLimitWishMiniComp"))
...
function RecruitWishMiniComp:updateComp(arg_2_1, arg_2_2, arg_2_3)
	...
	self.m_wishIcon:updateItem(self._wishInfos[1], 1, g.core.const.ConstMgr.RecruitConst.RECRUIT_TYPE.NEW_LIMIT_KNIGHT_RECRUIT)
