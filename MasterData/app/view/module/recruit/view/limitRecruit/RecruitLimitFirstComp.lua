...
local RecruitLimitFirstComp = class("RecruitLimitFirstComp", require("app.fairyGUI.recruitKnight.UI_RecruitLimitFirstComp"), RecruitLimitCompBase)

function RecruitLimitFirstComp:ctor()
	if not self._initSubComps then
		RecruitLimitCompBase.bindClassRef(self, RecruitLimitFirstComp)
...
function RecruitLimitFirstComp:_initOtherUI()
	if self.m_giftBtn then
...
function RecruitLimitFirstComp:_checkThemeActivityOpen()
...
function RecruitLimitFirstComp:_onClickGiftBtn()
