...
local RecruitLimitSnowMountainComp = class("RecruitLimitSnowMountainComp", require("app.fairyGUI.recruitKnight.UI_RecruitLimitSnowMountainComp"), RecruitLimitCompBase)

function RecruitLimitSnowMountainComp:ctor()
	if not self._initSubComps then
		RecruitLimitCompBase.bindClassRef(self, RecruitLimitSnowMountainComp)
...
function RecruitLimitSnowMountainComp:_initOtherUI()
	if self.m_giftBtn then
...
function RecruitLimitSnowMountainComp:_checkThemeActivityOpen()
...
function RecruitLimitSnowMountainComp:_onClickGiftBtn()
...
return RecruitLimitSnowMountainComp
