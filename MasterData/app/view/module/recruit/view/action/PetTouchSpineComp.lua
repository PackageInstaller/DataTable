...
function PetTouchSpineComp:_onTouchMove(arg_6_1)
	...
	local var_6_0 = arg_6_1:getInput():getTouch():getLocation()
	local var_6_1 = math.floor(-(var_6_0.y - self._touchPos.y) / var_0_3)

	if math.abs(var_6_1) >= 1 then
		self:_setSpineFrame(self._curFrame + var_6_1)

		self._touchPos = var_6_0
	end
end
