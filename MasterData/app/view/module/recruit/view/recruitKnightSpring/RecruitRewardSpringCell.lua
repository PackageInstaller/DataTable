local RecruitRewardSpringCell = class("RecruitRewardSpringCell", require("app.fairyGUI.recruitKnightSpring.UI_RecruitRewardSpringCell"))
local var_0_1 = g.core.common.Goods
local var_0_4 = g.core.const.ConstMgr.QUALITY_TYPE
local var_0_5 = g.core.config.knight_info

function RecruitRewardSpringCell:ctor()
	self._count = 0
end

function RecruitRewardSpringCell:updateView(arg_2_1, arg_2_2)
	if not arg_2_1 then
		return
	end
	...
	self.m_qualityBg:setURL(g.core.common.Path:getRecruitRewardCellLeftQualityLine(var_2_1.quality, "recruitKnightSpring"))
...
function RecruitRewardSpringCell:showRewardChangeAnim()
...
function RecruitRewardSpringCell:_changeToFrag(arg_4_1, arg_4_2)
	if arg_4_1.type == "complete" then
		-- block empty
	end
end

function RecruitRewardSpringCell:_getNameStr(arg_5_1)
...
function RecruitRewardSpringCell:_playKnightEffect()
	local var_6_0 = {
		isLoop = true
	}
...
function RecruitRewardSpringCell:_playFragmentEffect()
	local var_7_0 = {
		isLoop = false
	}
