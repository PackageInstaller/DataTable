...
local RecruitUniteTokenShowPop = class("RecruitUniteTokenShowPop", require("app.fairyGUI.recruitUniteToken.UI_RecruitUniteTokenShowPop"), function()
	return fgui.GComponent:create({
		resName = "RecruitUniteTokenShowPop",
		pkgPath = "ui/recruitUniteToken/recruitUniteToken",
		pkgName = "recruitUniteToken"
	})
end)

function RecruitUniteTokenShowPop:ctor(arg_2_1)
...
function RecruitUniteTokenShowPop:_onSkipClick(arg_3_1)
...
function RecruitUniteTokenShowPop:receiveCompEvent(arg_4_1)
	local var_4_0 = {
		...
	}
...
function RecruitUniteTokenShowPop:playOpenFinish(arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	local var_5_0 = ({
		{
			"nsr_1",
			"ssr_1"
...
function RecruitUniteTokenShowPop:_onShowFinish()
		...
		frontShow = {
			{
				...
				func = function()
					local var_7_0 = require("app.view.module.recruit.view.uniteToken.RecruitUniteTokenRewardPop").new(var_6_0)
...
return RecruitUniteTokenShowPop
