...
function GuildWarCityComp:onClickFinish(arg_6_1, arg_6_2)
	if self:isStrategyChoosePopDisplayed() then
		local var_6_0 = arg_6_2:getInput()
		local var_6_1 = var_6_0:getTouch():getLocation()

		if self.m_strategyBtn_0:containPoint(var_6_0) or self.m_strategyBtn_1:containPoint(var_6_1) or self.m_strategyBtn_2:containPoint(var_6_1) then
			-- block empty
		else
			self.m_showChooseController:setSelectedIndex(0)
		end
