...
function HLTrainSelectKnightComp:_getSortRule()
	return function(arg_16_0, arg_16_1)
		...
		local var_16_4 = var_0_1:isKnightDispatched(var_16_0)
		local var_16_5 = var_0_1:isKnightDispatched(var_16_1)

		if var_16_4 ~= var_16_5 then
			return var_16_5
		end

		local var_16_6 = var_0_2:isKnightCheckIn(var_16_0)
		local var_16_7 = var_0_2:isKnightCheckIn(var_16_1)

		if var_16_6 ~= var_16_7 then
			return var_16_7
		end

		local var_16_8 = arg_16_0:getHomeLandTalent()
		local var_16_9 = arg_16_1:getHomeLandTalent()
		...
		local var_16_10 = arg_16_0:getQuality()
		local var_16_11 = arg_16_1:getQuality()

		if var_16_10 ~= var_16_11 then
			return var_16_11 < var_16_10
		end

		local var_16_12 = arg_16_0:getStarLv()
		local var_16_13 = arg_16_1:getStarLv()

		if var_16_12 == var_16_13 then
			return var_16_1 < var_16_0
		else
			return var_16_13 < var_16_12
		end
	end
end
