...
function StormMainLayer:getAngleAndAreaId(arg_40_1)
	...
	local var_40_3, var_40_4 = self:getMapWorld().getTargetAngelFromScreenCenter(self:getMapGround():convertToNodeSpace(display.center), (cc.pNormalize((cc.pSub(cc.p(var_40_1 - 100, var_40_2 + 100), var_40_9000)))))
