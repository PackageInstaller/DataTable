local SpireFormationLayer = class("SpireFormationLayer", require("app.fairyGUI.spire.UI_SpireFormationLayer"), function()
	return fgui.GComponent:create({
		resName = "SpireFormationLayer",
...
function SpireFormationLayer:ctor(arg_2_1)
...
function SpireFormationLayer:_initView()
	self.m_saveBtn:addClickListener(handler(self, self._onSaveBtnClicked))
	self:addBg("bg/spire/bg_shmc_biandui.jpg", true, nil, 1)
	self.m_tabBtn:updateView(1, self._formationType)
end

function SpireFormationLayer:onLoad()
...
function SpireFormationLayer:_onSaveBtnClicked()
...
function SpireFormationLayer:_doSaveFormation()
...
function SpireFormationLayer:_updateFormationView()
	self.m_teamFormationComp:updateComp(self._formationType, self._formationIndex)
end

function SpireFormationLayer:_onSaveSucc(arg_8_1, arg_8_2, arg_8_3)
...
function SpireFormationLayer:_onCrossDayUpdate()
