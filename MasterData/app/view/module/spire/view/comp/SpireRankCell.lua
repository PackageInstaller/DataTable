local SpireRankCell = class("SpireRankCell", require("app.fairyGUI.spire.UI_SpireRankCell"))

function SpireRankCell:ctor()
	return
end

function SpireRankCell:updateCell(arg_2_1, arg_2_2)
