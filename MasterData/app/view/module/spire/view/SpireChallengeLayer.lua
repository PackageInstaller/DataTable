...
function SpireChallengeLayer:_onShowBossPopUp(arg_45_1)
	local var_45_0 = self._tower:getCurFloor():getBossStage()

	g.core.module.ModuleManager:pushPopup(require("app.view.module.spire.view.pop.SpireBossTransformationPop"):new(arg_45_1), {
		touchDisappear = false,
		hideContinue = true
	})
end
