...
function CultivatePassCardCell:updatePassCardCell(arg_4_1, arg_4_2, arg_4_3)
	...
	local var_4_0 = var_0_1:getCultivateData(arg_4_3)
	local var_4_1 = var_4_0:getPassCardData():getLevel()
	...
	local var_4_2 = CultivateConst.PASS_CARE_PAY_STATE.UN_ACTIVE

	self.m_freeItem:updateItemState(0)

	local var_4_3 = g.core.config.cultivate_activity_display_info.get(arg_4_3)

	self.m_lineGraph1:setColor(cc.c3b(CultivateConst.hexToRgb(var_4_3.color_line)))
	self.m_lineGraph2:setColor(cc.c3b(CultivateConst.hexToRgb(var_4_3.color_line)))

	if var_4_1 >= arg_4_1.lvCfg.level then
		...
		var_4_2 = arg_4_1.payNum >= arg_4_1.lvCfg.buy_num and CultivateConst.PASS_CARE_PAY_STATE.ALL_BUY or CultivateConst.PASS_CARE_PAY_STATE.ACTIVE
	...
	local var_4_4 = g.core.model.User.rechargeData:getRechargeInfoByTypeAndPrice(28, arg_4_1.lvCfg.money)
	local var_4_5 = ""

	if var_4_4 then
		var_4_5 = var_4_4.moneyUnit .. var_4_4.realMoney
	end

	self._rechargeInfo = var_4_4

	self.m_rewardBtn:updatePassCardBtn(arg_4_3, var_4_2, var_4_5)
	self.m_freeItem:updateCultivatePassItem(arg_4_1.freeDrop[1], arg_4_3)

	self._rewardItems = arg_4_1.payDrop
	self._activeState = var_4_2
