...
function KnightAttrTip:receiveCompEvent(arg_5_1, arg_5_2)
	if arg_5_1 == "KnightAttrExpandClick" then
		local var_5_0 = self:getView():displayObject():convertToNodeSpace(arg_5_2.pos)
		local var_5_1

		if self:getView():getSize().height - 30 >= var_5_0.y + self.m_attrExpandComp:getSize().height then
			var_5_1 = var_5_0
		end

		self:_showAttrsExpandComp(arg_5_2.type, (var_5_1 or nil) and (var_5_1.y or nil))
	end
end
