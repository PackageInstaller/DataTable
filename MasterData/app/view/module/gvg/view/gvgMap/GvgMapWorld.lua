...
function GvgMapWorld:_initMoveRange()
	...
	local var_24_2 = var_24_1:getFixOffY()

	self._minMoveX = -var_24_1
	self._maxMoveX = self:getMapGround():getMapWidth() / 2 - display.width / 2
	self._minMoveY = -(-var_24_2 + var_24_0 / 2) - (var_24_0 / 2 - display.height / 2)
	self._maxMoveY = -(-var_24_2 + var_24_0 / 2) + (var_24_0 / 2 - display.height / 2)
end
