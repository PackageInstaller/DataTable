...
function BlazingArenaFormationComp:_onPetCompDragStart(arg_17_1)
	...
	if var_17_0:isEmpty() then
		...
		local var_17_2 = arg_17_1:getInput()
		local var_17_3 = fgui.DragDropManager:getInstance()

		var_17_3.startDrag(var_17_2, var_17_0:getResourceURL(), var_17_1, (var_17_2:getTouchId()))

		local var_17_4 = var_17_3:getAgent()
		local var_17_5 = var_17_4:getComponent()

		var_17_5:bindLua("app.view.base.component.BaseMulTeamFormationPetComp")
		var_17_5:becomeTo(var_17_0)
		var_17_4:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onPetCompDragEnd), var_0_5)
	end
end
...
function BlazingArenaFormationComp:_onUniteTokenCompDragStart(arg_20_1)
	...
	if var_20_0:isEmpty() then
		...
		local var_20_2 = arg_20_1:getInput()
		local var_20_3 = fgui.DragDropManager:getInstance()

		var_20_3.startDrag(var_20_2, var_20_0:getResourceURL(), var_20_1, (var_20_2:getTouchId()))

		local var_20_4 = var_20_3:getAgent()
		local var_20_5 = var_20_4:getComponent()

		var_20_5:bindLua("app.view.base.component.BaseMulTeamFormationUniteTokenComp")
		var_20_5:becomeTo(var_20_0)
		var_20_4:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onUniteTokenCompDragEnd), var_0_5)
	end
end
...
function BlazingArenaFormationComp:_onSuccubaCompDragStart(arg_23_1)
	...
	if var_23_0:isEmpty() then
		...
		local var_23_2 = arg_23_1:getInput()
		local var_23_3 = fgui.DragDropManager:getInstance()

		var_23_3.startDrag(var_23_2, var_23_0:getResourceURL(), var_23_1, (var_23_2:getTouchId()))

		local var_23_4 = var_23_3:getAgent()
		local var_23_5 = var_23_4:getComponent()

		var_23_5:bindLua("app.view.base.component.BaseMulTeamFormationSuccubaComp")
		var_23_5:becomeTo(var_23_0)
		var_23_4:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onSuccubaCompDragEnd), var_0_5)
	end
end
