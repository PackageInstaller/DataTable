...
local BattleResultTurnCardAwardComp = class("BattleResultTurnCardAwardComp", require("app.fairyGUI.battleResult.UI_BattleResultTurnCardAwardComp"))

function BattleResultTurnCardAwardComp:ctor()
	self._awardCells = {}
	self._dropParams = {}
	self._isPlayed = {}
...
function BattleResultTurnCardAwardComp:_onListAwardRenderer(arg_2_1, arg_2_2)
	local var_2_0
...
function BattleResultTurnCardAwardComp:update(arg_3_1)
	...
	local var_3_0 = var_0_0:getThemeData(arg_3_1.themeValue):getTurnCardData()

	self.m_removeScoreTxt:setText(var_3_0:getScoreNum())
	self.m_timeScoreTxt:setText(var_3_0:getTimeScoreNum())
...
function BattleResultTurnCardAwardComp:_onTransAward()
...
function BattleResultTurnCardAwardComp:play()
...
function BattleResultTurnCardAwardComp:_checkNoAwardText()
	if self.m_noAwardTxt then
		self.m_noAwardTxt:setText((g.core.lang:get(405800)))
	end
end

return BattleResultTurnCardAwardComp
