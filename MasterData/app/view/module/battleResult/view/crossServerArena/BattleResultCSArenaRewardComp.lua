...
function BattleResultArenaRewardComp:_onListAwardRenderer(arg_2_1, arg_2_2)
	...
	local var_2_3 = g.core.model.User.crossServerArenaData:getGuildRate()
	local var_2_4 = var_2_3 > 0 and self:_isGuildSkill(var_2_0)

	arg_2_2:getChild("additionGroup"):setVisible(var_2_4)

	if var_2_4 then
		arg_2_2:getChild("additionTxt"):setText("+" .. var_2_3 / 10 .. "%")
	end
end
