...
local BattleResultGemAwardComp = class("BattleResultGemAwardComp", require("app.fairyGUI.battleResult.UI_BattleResultGemAwardComp"))

function BattleResultGemAwardComp:ctor()
	self._awardCells = {}
	self._dropParams = {}
	self._isPlayed = {}
...
function BattleResultGemAwardComp:_onListAwardRenderer(arg_2_1, arg_2_2)
	local var_2_0
...
function BattleResultGemAwardComp:update(arg_3_1)
	...
	local var_3_0 = var_0_0:getThemeData(arg_3_1.themeValue):getGemEliminateData()

	self.m_removeScoreTxt:setText(var_3_0:getTotalEliScore())
	self.m_combScoreTxt:setText(var_3_0:getTotalComboScore())
	self.m_combNumTxt:setText(var_3_0:getMaxComboNum())

	local var_3_1 = arg_3_1.maxScore or 0

	if var_3_1 == 0 then
		self.m_historyScoreTxt:setText(arg_3_1.score)
	else
		self.m_historyScoreTxt:setText(var_3_1)
	end

	if arg_3_1.myRank and arg_3_1.phase then
		local var_3_2 = arg_3_1.myRank
		local var_3_3 = arg_3_1.phase
		...
		local var_3_4 = var_3_0:getHistoryMyRank(var_3_3)

		if var_3_4 and var_3_4 < var_3_2 then
			self.m_upImg:setVisible(true)
			self.m_upValue:setText(var_3_2 - var_3_4)
...
function BattleResultGemAwardComp:_onTransAward()
...
function BattleResultGemAwardComp:play()
...
function BattleResultGemAwardComp:_checkNoAwardText()
	if self.m_noAwardTxt then
		self.m_noAwardTxt:setText((g.core.lang:get(405800)))
	end
end

return BattleResultGemAwardComp
