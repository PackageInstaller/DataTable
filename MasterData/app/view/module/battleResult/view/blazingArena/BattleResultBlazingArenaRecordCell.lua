...
local BattleResultBlazingArenaRecordCell = class("BattleResultBlazingArenaRecordCell", require("app.fairyGUI.battleResult.UI_BattleResultBlazingArenaRecordCell"))

function BattleResultBlazingArenaRecordCell:ctor()
...
function BattleResultBlazingArenaRecordCell:updateCell(arg_2_1)
	if not arg_2_1 then
		return
	end
...
function BattleResultBlazingArenaRecordCell:_onRenderMyTeamList(arg_3_1, arg_3_2)
...
function BattleResultBlazingArenaRecordCell:_onRenderRivalTeamList(arg_4_1, arg_4_2)
	local var_4_0

	if self._rivalTeamList.knights[arg_4_1 + 1] and self._rivalTeamList.knights[arg_4_1 + 1] ~= 0 then
		var_4_0 = self:_getKnightStructByBaseId(self._rivalTeamList.knights[arg_4_1 + 1])
	end
...
function BattleResultBlazingArenaRecordCell:_getKnightStructByBaseId(arg_5_1)
	local var_5_0
...
return BattleResultBlazingArenaRecordCell
