...
local DebugOneKeyTower = class("DebugOneKeyTower", require("app.view.module.debug.oneKeyComp.oneKey.DebugOneKeyBase"))

function DebugOneKeyTower:initData()
	self._oneKeyName = "一键异质探索"
...
function DebugOneKeyTower:doOneKey()
...
function DebugOneKeyTower:_onS2CGetInfo(arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	self._isGetInfo = true

	return "信息更新中"
end

function DebugOneKeyTower:_onRecHangUpReward(arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	return "领取生产平台挂机奖励成功"
end

function DebugOneKeyTower:_onRecQuickHangUpReward(arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	return "加速领取奖励成功"
end

function DebugOneKeyTower:_onRecFirstPassReward(arg_10_1, arg_10_2, arg_10_3, arg_10_4)
	return "一键领取首通奖励成功"
end

function DebugOneKeyTower:getFirstPassIds()
	local var_11_0 = {}

	for iter_11_0, iter_11_1 in pairs(var_0_1.STAGE_TYPE) do
		for iter_11_2, iter_11_3 in pairs((var_0_5:getTowerCanAwardIdsByType(iter_11_1))) do
			if not var_0_5:getFirstPassAwardIsGetById(iter_11_3) and var_0_5:getIsFirstPassByStageAndId(iter_11_1, var_0_0.get(iter_11_3).require_value) then
				...
				if #var_11_0 >= var_0_1.FIRST_PASS_LIST_MAX_COUNT then
					return var_11_0
				end
			end
		end
...
function DebugOneKeyTower:canQuickGetAward()
	if var_0_3:getLeftCount(var_0_2.PLAY_TYPE.TOWER_ACCELERATE_COUNT) > 0 and table.nums((var_0_5:getQuickHangupReward())) > 0 then
		return true
	end
