...
function EquipMagicalSuitStageUpComp:update(arg_2_1)
	...
	while var_0_2.hasKey(var_2_0 .. var_2_4) do
		if var_2_2[var_2_0 .. var_2_4] > 0 then
			local var_2_5 = var_0_3.get(var_2_2[var_2_0 .. var_2_4])

			while var_0_3.hasKey("affect_type_" .. 1) do
				if var_2_5["affect_type_" .. 1] > 0 and var_2_5["affect_value_" .. 1] > 0 then
					var_2_3[var_2_5["affect_type_" .. 1]] = var_2_3[var_2_5["affect_type_" .. 1]] or 0
					var_2_3[var_2_5["affect_type_" .. 1]] = var_2_3[var_2_5["affect_type_" .. 1]] + var_2_5["affect_value_" .. 1]
				end
			end
		end
