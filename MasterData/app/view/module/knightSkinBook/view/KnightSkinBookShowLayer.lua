...
function KnightSkinBookShowLayer:_onSliderChange()
	...
	local var_20_1 = self.m_slider:getValue()

	if self._isSpineSelected then
		self.m_knightSpineComp:setScale(var_20_0 * (var_20_1 / self._sliderRate * self._changeInterval + self._minScale))
	else
		self.m_knightPicComp:setScale(var_20_0 * (var_20_1 / self._sliderRate * self._changeInterval + self._minScale))
	end
end
