...
local GemEliminateTipsLinePop = class("GemEliminateTipsLinePop", require("app.fairyGUI.summerThemeGame.UI_GemEliminateTipsLinePop"), function()
	return fgui.GComponent:create({
		resName = "GemEliminateTipsLinePop",
		pkgPath = "ui/summerThemeGame/summerThemeGame",
		pkgName = "summerThemeGame"
	}, ...)
end)

function GemEliminateTipsLinePop:ctor(arg_2_1)
...
function GemEliminateTipsLinePop:init(arg_3_1)
	local var_3_0
...
function GemEliminateTipsLinePop:updateTips()
...
function GemEliminateTipsLinePop:_endCountDown()
	self.m_isCountDownController:setSelectedIndex(0)
	self:updateTips()
end

function GemEliminateTipsLinePop:_onDelayClose()
...
return GemEliminateTipsLinePop
