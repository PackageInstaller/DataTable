...
function ExplorationMainLayer:updateTipIcon()
	local var_13_0 = self.m_mapComp:getMapWorld()
	local var_13_1 = var_13_0:convertToNodeSpace({
		x = display.cx,
		y = display.cy
	})
	local var_13_2 = var_0_5:getMapData().getMainRoleCoordinate(var_13_0)
	local var_13_3 = self.m_mapComp:getScale()

	self.m_tipPosComp:updateCompAngleAndPos(cc.p(self.m_mapComp:getMapWorld():getMapGround():coordToPixel(var_13_2.x, var_13_2.y)), var_13_1, var_13_3)

	local var_13_4 = var_0_5:getMapData():getMirrorCoordinate()

	self.m_mirrorDirBtn:updateCompAngleAndPos(cc.p(self.m_mapComp:getMapWorld():getMapGround():coordToPixel(var_13_4.x, var_13_4.y)), var_13_1, var_13_3)

	local var_13_5 = self.m_mapComp:getMapWorld()
	local var_13_6 = var_13_5:getMapGround()
	local var_13_7 = cc.size(var_13_6:getFixOFF())

	self.m_miniMapComp:updateMiniComp(var_13_1, cc.size(self.m_mapComp:getMapWorld().getMapGround(var_13_6).getMapWidth(var_13_5), self.m_mapComp:getMapWorld():getMapGround():getMapHeight()), var_13_3)
end
...
function ExplorationMainLayer:_checkTipsGuide2()
	...
	local var_31_0
	local var_31_1 = var_0_5:getMapData()
	local var_31_2 = var_0_5:getMapData().getRoomStructByCoordinate(var_31_1:getMainRoleCoordinate(), cc.p(var_31_1.x, ExplorationMapCommon:getRoomCoordinateAndCoordinateByGlobalCoordinate().y))
...
function ExplorationMainLayer:_guideMoveToFirstMonster()
	local var_37_0 = var_0_5:getMapData()
	local var_37_1 = var_0_5:getMapData().getRoomStructByCoordinate(var_37_0:getMainRoleCoordinate(), cc.p(var_37_0.x, ExplorationMapCommon:getRoomCoordinateAndCoordinateByGlobalCoordinate().y))
...
function ExplorationMainLayer:_guideMoveToShop()
	local var_38_0 = var_0_5:getMapData()
	local var_38_1 = var_0_5:getMapData().getRoomStructByCoordinate(var_38_0:getMainRoleCoordinate(), cc.p(var_38_0.x, ExplorationMapCommon:getRoomCoordinateAndCoordinateByGlobalCoordinate().y))
