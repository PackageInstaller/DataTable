...
local ExplorationFormationLineupUniteTokenCell = class("ExplorationFormationLineupUniteTokenCell", require("app.fairyGUI.exploration.UI_ExplorationFormationLineupUniteTokenCell"))

function ExplorationFormationLineupUniteTokenCell:ctor()
	self._formationData = var_0_2:getFormationData()

	self.getSharedTrans(self, "enter_right", "CommonShortCellList", self)
end

function ExplorationFormationLineupUniteTokenCell:updateCell(arg_2_1, arg_2_2)
...
return ExplorationFormationLineupUniteTokenCell
