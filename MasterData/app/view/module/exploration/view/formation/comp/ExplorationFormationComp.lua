...
function ExplorationFormationComp:_onPetCompDragStart(arg_7_1)
	...
	if var_7_0:isEmpty() then
		...
		var_7_5:bindLua("app.view.module.exploration.view.formation.comp.ExplorationFormationPetComp")
...
function ExplorationFormationComp:_onSuccubaCompDragStart(arg_10_1)
	...
	if var_10_0:isEmpty() then
		...
		local var_10_2 = arg_10_1:getInput()
		local var_10_3 = fgui.DragDropManager:getInstance()

		var_10_3.startDrag(var_10_2, var_10_0:getResourceURL(), var_10_1, (var_10_2:getTouchId()))

		local var_10_4 = var_10_3:getAgent()
		local var_10_5 = var_10_4:getComponent()

		var_10_5:bindLua("app.view.module.exploration.view.formation.comp.ExplorationFormationSuccubaIconComp")
		var_10_5:becomeTo(var_10_0)
		var_10_4:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onSuccubaCompDragEnd), var_0_2)
	end
end
...
function ExplorationFormationComp:_onUniteTokenCompDragStart(arg_14_1)
	...
	if var_14_0:isEmpty() then
		...
		local var_14_2 = arg_14_1:getInput()
		local var_14_3 = fgui.DragDropManager:getInstance()

		var_14_3.startDrag(var_14_2, var_14_0:getResourceURL(), var_14_1, (var_14_2:getTouchId()))

		local var_14_4 = var_14_3:getAgent()
		local var_14_5 = var_14_4:getComponent()

		var_14_5:bindLua("app.view.module.exploration.view.formation.comp.ExplorationFormationUniteTokenComp")
		var_14_5:becomeTo(var_14_0)
		var_14_4:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onUniteTokenCompDragEnd), var_0_2)
	end
end
