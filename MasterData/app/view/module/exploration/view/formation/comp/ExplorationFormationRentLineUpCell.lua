...
local ExplorationFormationRentLineUpCell = class("ExplorationFormationRentLineUpCell", require("app.fairyGUI.exploration.UI_ExplorationFormationRentLineUpCell"), function()
...
function ExplorationFormationRentLineUpCell:ctor()
...
function ExplorationFormationRentLineUpCell:updateComp(arg_3_1)
...
return ExplorationFormationRentLineUpCell
