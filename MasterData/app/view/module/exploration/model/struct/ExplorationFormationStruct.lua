local ExplorationFormationStruct = class("ExplorationFormationStruct", require("app.view.module.lineUp.model.FormationStruct"))

function ExplorationFormationStruct:ctor(arg_1_1, arg_1_2)
...
function ExplorationFormationStruct:setSvrData(arg_2_1, arg_2_2)
	if arg_2_2 then
		arg_2_1 = arg_2_1 or {}

		local var_2_0 = g.core.model.User.explorationData:getFormationData()
		...
		for iter_2_6 in ipairs(var_2_9) do
...
function ExplorationFormationStruct:_changeStationPos(arg_3_1, arg_3_2, arg_3_3)
...
function ExplorationFormationStruct:lineupKnight(arg_4_1, arg_4_2)
	...
	if self:isSidValid(arg_4_2) then
		if self:isKnightLineUp(arg_4_2) then
			...
			if self:isStationPosLineupArtifact(arg_4_1) then
				local var_4_2 = g.core.model.User.explorationData:getFormationData()

				if not g.core.model.User.explorationData:getFormationData():getArtifactByServerId(var_4_2):checkWearKnight(var_4_2:getKnightByServerId(arg_4_2):getAdvanceId()) then
					self:takeOffArtifact((self:getArtifactSid(arg_4_1)))
				end
			end
		end
	else
...
function ExplorationFormationStruct:getKnightStationPos(arg_5_1)
	local var_5_0 = g.core.model.User.explorationData:getFormationData():getKnightByServerId(arg_5_1)
...
function ExplorationFormationStruct:getArtifactStationPos(arg_6_1)
	local var_6_0 = g.core.model.User.explorationData:getFormationData():getArtifactByServerId(arg_6_1)
...
function ExplorationFormationStruct:getUniteTokenStationPos(arg_7_1)
	local var_7_0 = g.core.model.User.explorationData:getFormationData():getUniteTokenByServerId(arg_7_1)
...
function ExplorationFormationStruct:getPetStationPos(arg_8_1)
	local var_8_0 = g.core.model.User.explorationData:getFormationData():getPetByServerId(arg_8_1)
...
function ExplorationFormationStruct:getKnightDict()
	local var_9_0 = g.core.model.User.explorationData:getFormationData()
	local var_9_1 = {}
...
function ExplorationFormationStruct:isKnightLineUp(arg_10_1)
	local var_10_0 = g.core.model.User.explorationData:getFormationData():getKnightByServerId(arg_10_1)
...
function ExplorationFormationStruct:getArtifactDict()
	local var_11_0 = g.core.model.User.explorationData:getFormationData()
	local var_11_1 = {}
...
function ExplorationFormationStruct:isArtifactLineUp(arg_12_1)
	local var_12_0 = g.core.model.User.explorationData:getFormationData():getArtifactByServerId(arg_12_1)
...
function ExplorationFormationStruct:getPetDict()
	local var_13_0 = g.core.model.User.explorationData:getFormationData()
	local var_13_1 = {}
...
function ExplorationFormationStruct:isPetLineUp(arg_14_1)
	local var_14_0 = g.core.model.User.explorationData:getFormationData():getPetByServerId(arg_14_1)
...
function ExplorationFormationStruct:getUniteTokenDict()
	local var_15_0 = g.core.model.User.explorationData:getFormationData()
	local var_15_1 = {}
...
function ExplorationFormationStruct:isUniteTokenLineUp(arg_16_1)
	local var_16_0 = g.core.model.User.explorationData:getFormationData():getUniteTokenByServerId(arg_16_1)
...
function ExplorationFormationStruct:isUsingKnight(arg_17_1)
	return self:isPositionValid((self.super.getKnightStationPos(self, arg_17_1)))
end

function ExplorationFormationStruct:isUsingArtifact(arg_18_1)
	return self:isPositionValid((self.super.getArtifactStationPos(self, arg_18_1)))
end

function ExplorationFormationStruct:isUsingPet(arg_19_1)
	return self:isPositionValid((self.super.getPetStationPos(self, arg_19_1)))
end

function ExplorationFormationStruct:isUsingUniteToken(arg_20_1)
	return self:isPositionValid((self.super.getUniteTokenStationPos(self, arg_20_1)))
end

function ExplorationFormationStruct:isUsingSuccuba(arg_21_1)
	return self:isPositionValid((self.super.getSuccubaStationPos(self, arg_21_1)))
end

return ExplorationFormationStruct
