...
local ThemeThirdBossRankScoreCell = class("ThemeThirdBossRankScoreCell", require("app.fairyGUI.summerThemeThirdBoss.UI_ThemeThirdBossRankScoreCell"))

function ThemeThirdBossRankScoreCell:ctor(arg_1_1)
	self.getSharedTrans(self, "enter_up", "CommonLongCellList", self)
end

function ThemeThirdBossRankScoreCell:refreshRankCell(arg_2_1, arg_2_2, arg_2_3)
...
return ThemeThirdBossRankScoreCell
