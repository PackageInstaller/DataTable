...
function ThemeThirdBossTalentScrollComp:onClickIcon(arg_8_1, arg_8_2)
	...
	if var_8_2 then
		...
		if arg_8_2 then
			...
			local var_8_7 = display.width - var_8_6 - var_8_3:getNextLineWidth()

			if var_8_7 <= var_8_4 then
...
function ThemeThirdBossTalentScrollComp:checkCompIsClick(arg_12_1, arg_12_2)
	for iter_12_0, iter_12_1 in pairs(self._curShowIconDict) do
		local var_12_0 = iter_12_1.iconComp:displayObject()

		if var_12_0 >= -iter_12_1.iconComp:getWidth() and var_12_0:convertToWorldSpace(cc.p(0, 0)).x <= arg_12_2 and iter_12_1.iconComp:containPoint(arg_12_1) then
