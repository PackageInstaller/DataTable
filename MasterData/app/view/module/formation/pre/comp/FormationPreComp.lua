...
function FormationPreComp:_dragLineupKnight(arg_22_1)
	...
	if var_22_0 > 0 then
		local var_22_1 = fgui.DragDropManager:getInstance()

		var_22_1:startDrag("common/ui_cocos/lineUp/pic_touming.png", nil, (arg_22_1:getInput():getTouchId()))

		local var_22_2 = BattleKnight.new({
			breath = true,
			scale = 1.2,
			base = true,
		...
		var_22_2:setName(var_0_11)
		var_22_1:getAgent():displayObject():addChild(var_22_2)
		var_22_2:setPosition(50, 0)
