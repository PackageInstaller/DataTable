...
function FormationMainComp:_dragLineupKnight(arg_16_1)
	...
	if var_16_0 > 0 then
		local var_16_1 = fgui.DragDropManager:getInstance()

		var_16_1:startDrag("common/ui_cocos/lineUp/pic_touming.png", nil, (arg_16_1:getInput():getTouchId()))

		local var_16_2 = BattleKnight.new({
			breath = true,
			scale = 1.2,
			base = true,
		...
		var_16_2:setScale(1.2)
		var_16_2:setName(var_0_11)
		var_16_1:getAgent():displayObject():addChild(var_16_2)
		var_16_2:setPosition(50, 0)
