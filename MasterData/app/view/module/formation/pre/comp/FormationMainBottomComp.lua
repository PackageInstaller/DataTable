...
function FormationMainBottomComp:_dragLineupPet(arg_21_1)
	...
	if var_21_2 then
		...
		local var_21_4 = var_21_3:getAgent():getComponent()

		if var_21_3 then
			fgui.UIPackage.iterObject(var_21_4)
			fgui.UIPackage.bindUIComponent(var_21_4, "app.view.module.formation.pre.comp.FormationPrePetIcon", var_21_4:getParent())
			var_21_4:updatePetFormatIcon(var_21_2)
		end
...
function FormationMainBottomComp:_dragLineupSuccuba(arg_23_1)
	...
	if var_23_2 then
		...
		local var_23_4 = var_23_3:getAgent():getComponent()

		if var_23_3 then
			fgui.UIPackage.iterObject(var_23_4)
			fgui.UIPackage.bindUIComponent(var_23_4, "app.view.module.formation.pre.comp.FormationSuccubaIconComp", var_23_4:getParent())
			var_23_4:updateSuccubaIcon(var_23_2)
		end
