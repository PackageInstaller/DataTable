...
function FormationPreBottomComp:_dragLineupPet(arg_29_1)
	...
	if var_29_2 and var_29_2 > 0 then
		...
		local var_29_3 = fgui.DragDropManager:getInstance()
		local var_29_4 = var_29_3:getAgent():getComponent()

		if var_29_3 then
			fgui.UIPackage.iterObject(var_29_4)
			fgui.UIPackage.bindUIComponent(var_29_4, "app.view.module.formation.pre.comp.FormationPrePetIcon", var_29_4:getParent())
			var_29_4:updatePetFormatIcon(var_0_8:getPetBySid(var_29_2))
		end
...
function FormationPreBottomComp:_dragLineupSuccuba(arg_31_1)
	...
	if var_31_2 ~= 0 then
		...
		local var_31_4 = fgui.DragDropManager:getInstance()
		local var_31_5 = var_31_4:getAgent():getComponent()

		if var_31_4 then
			fgui.UIPackage.iterObject(var_31_5)
			fgui.UIPackage.bindUIComponent(var_31_5, "app.view.module.formation.pre.comp.FormationSuccubaIconComp", var_31_5:getParent())
			var_31_5:updateSuccubaIcon(var_31_3)
		end
