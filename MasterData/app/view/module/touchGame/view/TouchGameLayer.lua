...
function TouchGameLayer:_showSpineScale(arg_21_1)
	...
	if var_21_0 then
		local var_21_1 = self.m_knightHolder:displayObject()
		local var_21_2 = var_21_1:convertToNodeSpace(arg_21_1)
		local var_21_3 = cc.p(var_21_1.x - var_21_2.x, cc.p(var_0_0 * var_21_2.x, var_0_0 * var_21_2.y).y - var_21_2.y)
