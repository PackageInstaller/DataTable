...
function CommanderWorldData:checkActivityOpen(arg_71_1)
	...
	if var_0_9:getOpenDays() >= self._serverOpenDays then
		::label_71_0::

		var_71_0 = var_0_9:getTime() < self._acticityCloseTime
	end
...
function CommanderWorldData:isNeedPopTip()
	...
	if var_83_0 == var_0_8.STAGE.CROSSSERVICE or var_83_0 == var_0_8.STAGE.LOCALSERVICE then
		if g.core.model.User:getGuildId() > 0 then
			return false
		end
	end
