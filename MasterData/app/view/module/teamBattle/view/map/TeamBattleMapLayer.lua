...
function TeamBattleMapLayer:_checkMainVisible()
	local var_11_0 = var_0_2:getMapData():getPlayerStruct()
	local var_11_1 = var_0_2:getMapData():getRoomStructByRoomId(var_11_0:getRoomId())
	local var_11_2 = var_11_1:getCfg()

	self.m_mapComp:getFloorComp():setCurCheckPos(var_11_2.room_x, var_11_2.room_y)
	self.m_mapComp:getMapWorld():moveLastCenter()

	if not var_0_2:getMapData():checkRoomIsEnter(var_11_1) then
		local var_11_3 = var_0_2:getMapData():getPlayerVisibleArea(var_11_0)
...
function TeamBattleMapLayer:_onOtherRoleEnter(arg_26_1, arg_26_2, arg_26_3, arg_26_4)
	if arg_26_4.user then
		if arg_26_4.user.user_id == g.core.model.User:getId() then
			local var_26_0 = var_0_2:getMapData()

			self.m_mapComp:getMapWorld():setCurRoom(var_26_0.room_x, var_26_0:getMineRoom():getCfg().room_y)
...
function TeamBattleMapLayer:updateTipIcon()
	local var_27_0 = self.m_mapComp:getMapWorld()
	local var_27_1 = var_0_2:getMapData().getRoleCoordinate(var_27_0)

	self.m_tipPosComp:updateCompAngleAndPos(cc.p(self.m_mapComp:getMapWorld():getMapGround():coordToPixel(var_27_1.x, var_27_1.y)), var_27_0:convertToNodeSpace({
		x = display.cx,
		y = display.cy
