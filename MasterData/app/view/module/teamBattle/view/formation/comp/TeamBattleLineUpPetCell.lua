...
local TeamBattleLineUpPetCell = class("TeamBattleLineUpPetCell", require("app.fairyGUI.teamBattle.UI_TeamBattleLineUpPetCell"))

function TeamBattleLineUpPetCell:ctor()
...
function TeamBattleLineUpPetCell:updateCell(arg_2_1, arg_2_2)
...
return TeamBattleLineUpPetCell
