...
function KnightFavoData:_sortKnight()
	...
	table.sort(self._knightInfoList, function(arg_13_0, arg_13_1)
		local var_13_0 = arg_13_0:getBaseKnightInfo()
		local var_13_1 = var_13_0:getFormationPos()
		local var_13_2 = arg_13_1:getBaseKnightInfo().getFormationPos(var_13_0)
		...
		local var_13_3 = arg_13_0:getBaseKnightInfo()
		local var_13_4 = var_13_3:getFavoLevel()
		local var_13_5 = arg_13_1:getBaseKnightInfo().getFavoLevel(var_13_3)

		if var_13_4 ~= var_13_5 then
			return var_13_5 < var_13_4
		end

		local var_13_6 = arg_13_0:getBaseKnightInfo()
		local var_13_7 = var_13_6:getQuality()
		local var_13_8 = arg_13_1:getBaseKnightInfo().getQuality(var_13_6)

		if var_13_7 ~= var_13_8 then
			return var_13_8 < var_13_7
		end

		local var_13_9 = arg_13_0:getBaseKnightInfo()
		local var_13_10 = var_13_9:getStarLv()
		local var_13_11 = arg_13_1:getBaseKnightInfo().getStarLv(var_13_9)

		if var_13_10 ~= var_13_11 then
			return var_13_11 < var_13_10
		end

		local var_13_12 = arg_13_0:getBaseKnightInfo()
		local var_13_13 = var_12_0[var_13_12:getAdvanceId()]
		local var_13_14 = var_12_0[arg_13_1:getBaseKnightInfo().getAdvanceId(var_13_12)]

		if var_13_13 ~= var_13_14 then
			return var_13_14 < var_13_13
		end
	end)
end
