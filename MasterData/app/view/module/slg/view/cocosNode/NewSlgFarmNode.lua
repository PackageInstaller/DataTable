...
function NewSlgFarmNode:_updateCountDown()
	...
	local var_11_1 = g.core.model.User.newSlgData:getNewSlgParamsValueById(192)

	if var_11_1 + self._data.protectTime - var_11_0 > 0 then
		self._txtProtectTime:setString(g.core.common.ServerTime:secondToHMSString(var_11_1 + self._data.protectTime - var_11_0))
