...
local RichmanTurnCardGameRightComp = class("RichmanTurnCardGameRightComp", require("app.fairyGUI.richman.UI_RichmanTurnCardGameRightComp"))

function RichmanTurnCardGameRightComp:ctor()
	self._curTurnIndex = 1

	self:_initView()
end

function RichmanTurnCardGameRightComp:_initView()
...
function RichmanTurnCardGameRightComp:_onClickCard(arg_3_1)
...
function RichmanTurnCardGameRightComp:onLoad()
	self._cardSequence = var_0_0:getGameData():getCardSequence()
end

return RichmanTurnCardGameRightComp
