...
local RichmanRedPacketRainLayer = class("RichmanRedPacketRainLayer", require("app.fairyGUI.richman.UI_RichmanRedPacketRainLayer"), function()
	return fgui.GComponent:create({
		resName = "RichmanRedPacketRainLayer",
...
function RichmanRedPacketRainLayer:ctor(arg_2_1)
	self._uniqueId = arg_2_1.unique_id
	self._eventCfg = var_0_1.get(arg_2_1.id)
	self._gameId = self._eventCfg.event_value1
	self._redPacketPool = NodePool.new(self.m_redPacketHolder, "richman", "RichmanRedPacketRainCell", 30)
...
function RichmanRedPacketRainLayer:_initView()
	self.m_bgDi:setURL("bg/richman/bg_dfw_game3.jpg")
	self.m_topMaskComp:setIcon("bg/richman/bg_dfw_game3.jpg")
...
function RichmanRedPacketRainLayer:_playRedPacketRain()
...
function RichmanRedPacketRainLayer:_createNewRedPacket()
...
function RichmanRedPacketRainLayer:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
end

function RichmanRedPacketRainLayer:_onClickRedPacket(arg_8_1)
...
function RichmanRedPacketRainLayer:_onClickBigRedPacket(arg_10_1)
...
function RichmanRedPacketRainLayer:_showBonus(arg_12_1, arg_12_2)
	local var_12_0 = fgui.UIPackage:createObject("richman", "RichmanRedPacketRainBonusCell")
...
function RichmanRedPacketRainLayer:_checkRedPacketOnScreen()
...
function RichmanRedPacketRainLayer:_sendC2SExplorationPackageGameOver()
...
function RichmanRedPacketRainLayer:_startCountdown()
...
function RichmanRedPacketRainLayer:_stopCountdown()
...
function RichmanRedPacketRainLayer:_onPause()
	self:_stopCountdown()
...
function RichmanRedPacketRainLayer:_stopAllAction()
	for iter_18_0, iter_18_1 in pairs(self._redPacketCells) do
		iter_18_1:stopAllFGActions()
	end
end

function RichmanRedPacketRainLayer:_startAllAction()
	for iter_19_0, iter_19_1 in pairs(self._redPacketCells) do
		iter_19_1:playMoveAnim()
	end
end

function RichmanRedPacketRainLayer:onLoad()
	g.core.event.EventManager:addEventListener(g.core.event.enum.EVENT_NET_S2C_RICH_MAN_EVENTPROCESS, handler(self, self.onExplorationProcess), self)
...
function RichmanRedPacketRainLayer:onGameStageFinish()
	var_0_5:tip(g.core.lang:get(426006))
	var_0_5:switchModuleIntelligent(g.view.entrance.HOME)
end

function RichmanRedPacketRainLayer:onUnload()
	if self._rainHandler then
		self:cancelSchedule(self._rainHandler)
...
function RichmanRedPacketRainLayer:explorationGameStart()
	self._isStart = true

	var_0_5:pushPopup(require("app.view.module.richman.view.game.RichmanRedPacketRainCountDownPop").new({
...
function RichmanRedPacketRainLayer:onExplorationProcess(arg_24_1, arg_24_2, arg_24_3, arg_24_4)
	if arg_24_4 and arg_24_4.awards then
		local var_24_0 = g.core.utils.Tools.mergeAwardList(arg_24_4.awards)

		self:newScheduleOnce(function()
			var_0_5:awardSummary(var_24_0, nil, nil, g.core.lang:get(300001), handler(self, self._onClose))
		end, 1)
	else
		self:_onClose()
	end
...
return RichmanRedPacketRainLayer
