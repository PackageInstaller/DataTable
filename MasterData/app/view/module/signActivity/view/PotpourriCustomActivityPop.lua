...
local PotpourriCustomActivityPop = class("PotpourriCustomActivityPop", require("app.fairyGUI.signActivity.UI_PotpourriCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "PotpourriCustomActivityPop",
		pkgPath = "ui/signActivity/signActivity",
		pkgName = "signActivity"
	})
end)

function PotpourriCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.POTPOURRI_SIGN_ACTIVITY
...
function PotpourriCustomActivityPop:onLoad()
...
function PotpourriCustomActivityPop:_updateMainView()
...
function PotpourriCustomActivityPop:_updateTimeText()
...
function PotpourriCustomActivityPop:_checkAutoSignAward()
...
function PotpourriCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function PotpourriCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function PotpourriCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function PotpourriCustomActivityPop:homeLayerAutoPopup()
...
return PotpourriCustomActivityPop
