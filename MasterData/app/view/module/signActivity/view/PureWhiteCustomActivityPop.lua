...
local PureWhiteCustomActivityPop = class("PureWhiteCustomActivityPop", require("app.fairyGUI.signActivity.UI_PureWhiteCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "PureWhiteCustomActivityPop",
		pkgPath = "ui/signActivity/signActivity",
		pkgName = "signActivity"
	})
end)

function PureWhiteCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.PUREWHITE_SIGN_ACTIVITY
...
function PureWhiteCustomActivityPop:onLoad()
...
function PureWhiteCustomActivityPop:_updateMainView()
...
function PureWhiteCustomActivityPop:_updateTimeText()
...
function PureWhiteCustomActivityPop:_checkAutoSignAward()
...
function PureWhiteCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function PureWhiteCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function PureWhiteCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function PureWhiteCustomActivityPop:homeLayerAutoPopup()
...
return PureWhiteCustomActivityPop
