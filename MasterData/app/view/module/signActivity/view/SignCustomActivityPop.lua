...
local SignCustomActivityPop = class("SignCustomActivityPop", require("app.fairyGUI.signActivity.UI_SignCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "SignCustomActivityPop",
...
function SignCustomActivityPop:ctor(arg_2_1)
	...
	self._groupId = 0
	self._functionId = var_0_2.SIGN_CUSTOM_ACTIVITY
...
function SignCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
