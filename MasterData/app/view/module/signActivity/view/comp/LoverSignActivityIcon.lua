...
local LoverSignActivityIcon = class("LoverSignActivityIcon", require("app.fairyGUI.signActivity.UI_LoverSignActivityIcon"))

function LoverSignActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function LoverSignActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function LoverSignActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function LoverSignActivityIcon:_updateStateCtrl()
...
function LoverSignActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return LoverSignActivityIcon
