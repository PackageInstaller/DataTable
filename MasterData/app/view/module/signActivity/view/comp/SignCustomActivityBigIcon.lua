...
local SignCustomActivityBigIcon = class("SignCustomActivityBigIcon", require("app.fairyGUI.signActivity.UI_SignCustomActivityBigIcon"))

function SignCustomActivityBigIcon:ctor()
	self._subId = 0
	self._info = nil
	self._goods = nil
...
function SignCustomActivityBigIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._subId = arg_2_2
	self._info = arg_2_1
...
function SignCustomActivityBigIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function SignCustomActivityBigIcon:_updateStateCtrl()
...
function SignCustomActivityBigIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return SignCustomActivityBigIcon
