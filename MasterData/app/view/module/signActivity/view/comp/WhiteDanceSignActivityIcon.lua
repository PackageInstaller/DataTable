...
local WhiteDanceSignActivityIcon = class("WhiteDanceSignActivityIcon", require("app.fairyGUI.signActivity.UI_WhiteDanceSignActivityIcon"))

function WhiteDanceSignActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function WhiteDanceSignActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function WhiteDanceSignActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function WhiteDanceSignActivityIcon:_updateStateCtrl()
...
function WhiteDanceSignActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return WhiteDanceSignActivityIcon
