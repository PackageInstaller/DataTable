...
local RoseNightCustomActivityPop = class("RoseNightCustomActivityPop", require("app.fairyGUI.signActivity.UI_RoseNightCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "RoseNightCustomActivityPop",
		pkgPath = "ui/signActivity/signActivity",
		pkgName = "signActivity"
	})
end)

function RoseNightCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.ROSE_NIGHT_SIGN_ACTIVITY
...
function RoseNightCustomActivityPop:onLoad()
...
function RoseNightCustomActivityPop:_updateMainView()
...
function RoseNightCustomActivityPop:_updateTimeText()
...
function RoseNightCustomActivityPop:_checkAutoSignAward()
...
function RoseNightCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function RoseNightCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function RoseNightCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function RoseNightCustomActivityPop:homeLayerAutoPopup()
...
return RoseNightCustomActivityPop
