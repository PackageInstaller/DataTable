...
local WhiteDanceCustomActivityPop = class("WhiteDanceCustomActivityPop", require("app.fairyGUI.signActivity.UI_WhiteDanceCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "WhiteDanceCustomActivityPop",
		pkgPath = "ui/signActivity/signActivity",
		pkgName = "signActivity"
	})
end)

function WhiteDanceCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.WHITEDANCE_SIGN_ACTIVITY
...
function WhiteDanceCustomActivityPop:onLoad()
...
function WhiteDanceCustomActivityPop:_updateMainView()
...
function WhiteDanceCustomActivityPop:_updateTimeText()
...
function WhiteDanceCustomActivityPop:_checkAutoSignAward()
...
function WhiteDanceCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function WhiteDanceCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function WhiteDanceCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function WhiteDanceCustomActivityPop:homeLayerAutoPopup()
...
function WhiteDanceCustomActivityPop:_playEffect()
...
return WhiteDanceCustomActivityPop
