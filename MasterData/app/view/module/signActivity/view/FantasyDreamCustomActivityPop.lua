...
local FantasyDreamCustomActivityPop = class("FantasyDreamCustomActivityPop", require("app.fairyGUI.signActivity.UI_FantasyDreamCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "FantasyDreamCustomActivityPop",
		pkgPath = "ui/signActivity/signActivity",
		pkgName = "signActivity"
	})
end)

function FantasyDreamCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.FANTASYDREAM_SIGN_ACTIVITY
...
function FantasyDreamCustomActivityPop:onLoad()
...
function FantasyDreamCustomActivityPop:_updateMainView()
...
function FantasyDreamCustomActivityPop:_updateTimeText()
...
function FantasyDreamCustomActivityPop:_checkAutoSignAward()
...
function FantasyDreamCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function FantasyDreamCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function FantasyDreamCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function FantasyDreamCustomActivityPop:homeLayerAutoPopup()
...
return FantasyDreamCustomActivityPop
