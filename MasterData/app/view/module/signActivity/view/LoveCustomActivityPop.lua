...
local LoveCustomActivityPop = class("LoveCustomActivityPop", require("app.fairyGUI.signActivity.UI_LoveCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "LoveCustomActivityPop",
		pkgPath = "ui/signActivity/signActivity",
		pkgName = "signActivity"
	})
end)

function LoveCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.LOVE_SIGN_ACTIVITY
...
function LoveCustomActivityPop:onLoad()
...
function LoveCustomActivityPop:_updateMainView()
...
function LoveCustomActivityPop:_updateTimeText()
...
function LoveCustomActivityPop:_checkAutoSignAward()
...
function LoveCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function LoveCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function LoveCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function LoveCustomActivityPop:homeLayerAutoPopup()
...
function LoveCustomActivityPop:_playEffect()
