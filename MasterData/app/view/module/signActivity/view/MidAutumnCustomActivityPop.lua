...
local MidAutumnCustomActivityPop = class("MidAutumnCustomActivityPop", require("app.fairyGUI.signActivity.UI_MidAutumnCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "MidAutumnCustomActivityPop",
		pkgPath = "ui/signActivity/signActivity",
		pkgName = "signActivity"
	})
end)

function MidAutumnCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.MIDAUTUMN_SIGN_ACTIVITY
...
function MidAutumnCustomActivityPop:onLoad()
...
function MidAutumnCustomActivityPop:_updateMainView()
...
function MidAutumnCustomActivityPop:_updateTimeText()
...
function MidAutumnCustomActivityPop:_checkAutoSignAward()
...
function MidAutumnCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function MidAutumnCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function MidAutumnCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function MidAutumnCustomActivityPop:homeLayerAutoPopup()
...
return MidAutumnCustomActivityPop
