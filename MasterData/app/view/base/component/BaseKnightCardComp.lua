local BaseKnightCardComp = class("BaseKnightCardComp", require("app.fairyGUI.base_new.UI_BaseKnightCardComp"))
...
function BaseKnightCardComp:ctor(arg_1_1)
...
function BaseKnightCardComp:updateCell(arg_2_1, arg_2_2, arg_2_3)
	if not arg_2_1 then
		return
	end
...
function BaseKnightCardComp:_onClick()
...
function BaseKnightCardComp:setReborn()
	self.m_redPointComp:setVisible(false)
end

return BaseKnightCardComp
