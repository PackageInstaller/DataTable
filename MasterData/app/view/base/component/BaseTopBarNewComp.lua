...
function BaseTopBarNewComp:_updatePushGiftCountDown()
	...
	if var_41_0 then
		...
		if var_41_0.create_time + var_41_1.gift_time_limit - var_41_2 > 0 then
			self.m_pushGiftBtn:getChild("timeTxt"):setVisible(true)
			self.m_pushGiftBtn:getChild("timeTxt"):setText((g.core.common.ServerTime:_secondToString(var_41_0.create_time + var_41_1.gift_time_limit - var_41_2)))
		else
			self:_cancelPushGiftSchedule()
		end
	else
