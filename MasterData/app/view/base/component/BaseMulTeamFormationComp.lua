...
function BaseMulTeamFormationComp:_onPetCompDragStart(arg_18_1)
	...
	if var_18_0:isEmpty() then
		...
		local var_18_2 = arg_18_1:getInput()
		local var_18_3 = fgui.DragDropManager:getInstance()

		var_18_3.startDrag(var_18_2, var_18_0:getResourceURL(), var_18_1, (var_18_2:getTouchId()))

		local var_18_4 = var_18_3:getAgent()
		local var_18_5 = var_18_4:getComponent()

		var_18_5:bindLua("app.view.base.component.BaseMulTeamFormationPetComp")
		var_18_5:becomeTo(var_18_0)
		var_18_4:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onPetCompDragEnd), var_0_5)
	end
end
...
function BaseMulTeamFormationComp:_onUniteTokenCompDragStart(arg_21_1)
	...
	if var_21_0:isEmpty() then
		...
		local var_21_2 = arg_21_1:getInput()
		local var_21_3 = fgui.DragDropManager:getInstance()

		var_21_3.startDrag(var_21_2, var_21_0:getResourceURL(), var_21_1, (var_21_2:getTouchId()))

		local var_21_4 = var_21_3:getAgent()
		local var_21_5 = var_21_4:getComponent()

		var_21_5:bindLua("app.view.base.component.BaseMulTeamFormationUniteTokenComp")
		var_21_5:becomeTo(var_21_0)
		var_21_4:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onUniteTokenCompDragEnd), var_0_5)
	end
end
...
function BaseMulTeamFormationComp:_onSuccubaCompDragStart(arg_24_1)
	...
	if var_24_0:isEmpty() then
		...
		local var_24_2 = arg_24_1:getInput()
		local var_24_3 = fgui.DragDropManager:getInstance()

		var_24_3.startDrag(var_24_2, var_24_0:getResourceURL(), var_24_1, (var_24_2:getTouchId()))

		local var_24_4 = var_24_3:getAgent()
		local var_24_5 = var_24_4:getComponent()

		var_24_5:bindLua("app.view.base.component.BaseMulTeamFormationSuccubaComp")
		var_24_5:becomeTo(var_24_0)
		var_24_4:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onSuccubaCompDragEnd), var_0_5)
	end
end
