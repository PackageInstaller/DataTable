...
lx.define_class("bomb_logic", function(arg_1_0)
...
function var_0_0.create(arg_4_0)
	local var_4_0 = var_0_1.class("bomb_logic", gamecore.object_logic_base:inherit())

	var_4_0._battle_event = var_0_2.battle_event_type.bomb
	var_4_0._owner = nil
