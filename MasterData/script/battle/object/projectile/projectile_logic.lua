...
lx.define_class("projectile_logic", function(arg_1_0)
...
function var_0_0.create(arg_4_0)
	local var_4_0 = var_0_1.class("projectile_logic", var_0_3:inherit())

	var_4_0._battle_event = var_0_2.battle_event_type.projectile
	var_4_0._owner = nil
