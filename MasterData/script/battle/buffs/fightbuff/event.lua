...
function var_0_0.extend_method(arg_1_0)
	...
	function arg_1_0:__on_func_enemy_ship_night_fight(arg_26_1, arg_26_2, arg_26_3, arg_26_4)
		...
		for iter_26_0, iter_26_1 in pairs((self._battle_obj_mgr:get_ships_by_side(var_0_3.obj_side.enemy))) do
			local var_26_2 = iter_26_1:get_ship_type()

			if var_26_2 == var_0_3.ship_type_rule.aircraft_carrier.value or var_26_2 == var_0_3.ship_type_rule.light_aircraft_carrier.value or var_26_2 == var_0_3.ship_type_rule.seaplane_tender.value then
				table.insert(var_26_1, iter_26_1:getID())
			end
		end
	...
	function arg_1_0:__on_func_every_enemy_ship_add_attr(arg_30_1, arg_30_2, arg_30_3, arg_30_4)
		...
		arg_30_3:get_attribute().change_final_be_damage = arg_30_3:get_attribute().change_final_be_damage or 0
		arg_30_3:get_attribute().change_final_be_damage = (1 + arg_30_3:get_attribute().change_final_be_damage) * (1 - arg_30_1.num * var_30_0 / 100) - 1
	end

	function arg_1_0:__on_func_enemy_flag_ship_add_attr(arg_31_1, arg_31_2, arg_31_3, arg_31_4)
		...
		if self._battle_obj_mgr:get_flag_ship(arg_31_3:get_side()):get_is_alive() then
