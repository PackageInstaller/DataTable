...
function var_0_0.extend_method(arg_1_0)
	function arg_1_0:__on_func_score_attr_add_num(arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
		...
		if arg_2_1.cid then
			for iter_2_0, iter_2_1 in pairs(arg_2_1.cid) do
				if arg_2_2:get_cid() == iter_2_1 then
					self:__update_ship_attr_by_effect(arg_2_1, false, false, arg_2_2)
				end
			end
		elseif not arg_2_1.cid then
			self:__update_ship_attr_by_effect(arg_2_1, false, false, arg_2_2)
		end
	end

	function arg_1_0:__on_func_score_attr_add_percent(arg_3_1, arg_3_2, arg_3_3, arg_3_4)
		...
		if arg_3_1.cid then
			for iter_3_0, iter_3_1 in pairs(arg_3_1.cid) do
				if arg_3_2:get_cid() == iter_3_1 then
					self:__update_ship_attr_by_effect(arg_3_1, true, false, arg_3_2)
				end
			end
		elseif not arg_3_1.cid then
			self:__update_ship_attr_by_effect(arg_3_1, true, false, arg_3_2)
		end
	end

	function arg_1_0:__on_func_score_attack_stage_add_damage(arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5)
		...
		local var_4_1 = self:__get_ship_hit_state_by_effect(arg_4_1, arg_4_2)

		if arg_4_1.cid then
			for iter_4_2, iter_4_3 in pairs(var_4_1) do
				for iter_4_4, iter_4_5 in pairs(arg_4_1.cid) do
					if arg_4_2:get_cid() == iter_4_5 then
						local var_4_2 = self._battle_obj_mgr:findObject(iter_4_3)

						if not var_4_2:get_attribute().is_increase_this_side_ship_power then
							var_4_2:get_attribute().change_final_damage = var_4_2:get_attribute().change_final_damage or 0
							var_4_2:get_attribute().change_final_damage = (1 + var_4_2:get_attribute().change_final_damage) * (1 + arg_4_1.num / 100) - 1
						end

						var_4_2:get_attribute().is_increase_this_side_ship_power = true
					end
				end
			end
		elseif not arg_4_1.cid then
			for iter_4_6, iter_4_7 in pairs(var_4_1) do
				local var_4_4 = self._battle_obj_mgr:findObject(iter_4_7)

				if not var_4_4:get_attribute().is_increase_this_side_ship_power then
					var_4_4:get_attribute().change_final_damage = var_4_4:get_attribute().change_final_damage or 0
					var_4_4:get_attribute().change_final_damage = (1 + var_4_4:get_attribute().change_final_damage) * (1 + arg_4_1.num / 100) - 1
				end

				var_4_4:get_attribute().is_increase_this_side_ship_power = true
			end
		end
	end

	function arg_1_0:__on_func_score_attacked_stage_reduce_damage_percent(arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5)
		...
		local var_5_1 = self:__get_ship_hit_state_by_effect(arg_5_1, arg_5_3, arg_5_5)

		if arg_5_1.cid then
			for iter_5_2, iter_5_3 in pairs(var_5_1) do
				for iter_5_4, iter_5_5 in pairs(arg_5_1.cid) do
					if arg_5_2:get_cid() == iter_5_5 then
						local var_5_2 = self._battle_obj_mgr:findObject(iter_5_3)

						if not var_5_2:get_attribute().is_reduce_this_ship_damage then
							var_5_2:get_attribute().change_final_be_damage = var_5_2:get_attribute().change_final_be_damage or 0
							var_5_2:get_attribute().change_final_be_damage = (1 + var_5_2:get_attribute().change_final_be_damage) * (1 - arg_5_1.num / 100) - 1
						end

						var_5_2:get_attribute().is_increase_this_side_ship_power = true
					end
				end
			end
		elseif not arg_5_1.cid then
			for iter_5_6, iter_5_7 in pairs(var_5_1) do
				local var_5_4 = self._battle_obj_mgr:findObject(iter_5_7)

				if not var_5_4:get_attribute().is_reduce_this_ship_damage then
					var_5_4:get_attribute().change_final_be_damage = var_5_4:get_attribute().change_final_be_damage or 0
					var_5_4:get_attribute().change_final_be_damage = (1 + var_5_4:get_attribute().change_final_be_damage) * (1 - arg_5_1.num / 100) - 1
				end

				var_5_4:get_attribute().is_increase_this_side_ship_power = true
			end
		end
	end

	function arg_1_0:__on_func_score_attack_stage_wihtout_hurt(arg_6_1, arg_6_2, arg_6_3, arg_6_4, arg_6_5)
		...
		local var_6_1 = self:__get_ship_hit_state_by_effect(arg_6_1, arg_6_2)

		if arg_6_1.cid then
			for iter_6_2, iter_6_3 in pairs(var_6_1) do
				for iter_6_4, iter_6_5 in pairs(arg_6_1.cid) do
					if arg_6_2:get_cid() == iter_6_5 then
						self._battle_obj_mgr:findObject(iter_6_3):set_battle_damage_state(true)
					end
				end
			end
		elseif not arg_6_1.cid then
			for iter_6_6, iter_6_7 in pairs(var_6_1) do
				self._battle_obj_mgr:findObject(iter_6_7):set_battle_damage_state(true)
			end
		end
	end

	function arg_1_0:__on_func_score_attack_stage_wihtout_bullet(arg_7_1, arg_7_2, arg_7_3, arg_7_4, arg_7_5)
		...
		local var_7_1 = self:__get_ship_hit_state_by_effect(arg_7_1, arg_7_2)

		if arg_7_1.cid then
			for iter_7_2, iter_7_3 in pairs(var_7_1) do
				for iter_7_4, iter_7_5 in pairs(arg_7_1.cid) do
					if arg_7_2:get_cid() == iter_7_5 then
						self._battle_obj_mgr:findObject(iter_7_3):get_attribute().without_bullet_correct = 1
					end
				end
			end
		elseif not arg_7_1.cid then
			for iter_7_6, iter_7_7 in pairs(var_7_1) do
				self._battle_obj_mgr:findObject(iter_7_7):get_attribute().without_bullet_correct = 1
			end
		end
	end

	function arg_1_0:__on_func_score_attack_infallible(arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5)
		...
		local var_8_1 = self:__get_ship_hit_state_by_effect(arg_8_1, arg_8_2)

		if arg_8_1.cid then
			for iter_8_2, iter_8_3 in pairs(var_8_1) do
				for iter_8_4, iter_8_5 in pairs(arg_8_1.cid) do
					if arg_8_2:get_cid() == iter_8_5 then
						self._battle_obj_mgr:findObject(iter_8_3):set_ignore_miss(true)
					end
				end
			end
		elseif not arg_8_1.cid then
			for iter_8_6, iter_8_7 in pairs(var_8_1) do
				self._battle_obj_mgr:findObject(iter_8_7):set_ignore_miss(true)
			end
		end
	end

	function arg_1_0:__on_func_score_open_torpedo(arg_9_1, arg_9_2, arg_9_3, arg_9_4)
		...
		local var_9_0 = self:__get_ship_hit_state_by_effect(arg_9_1, arg_9_2)

		if arg_9_1.cid then
			for iter_9_0, iter_9_1 in pairs(var_9_0) do
				for iter_9_2, iter_9_3 in pairs(arg_9_1.cid) do
					if arg_9_2:get_cid() == iter_9_3 then
						self._battle_obj_mgr:findObject(iter_9_1):set_unlock_open_torpedo_attack(true)
					end
				end
			end
		elseif not arg_9_1.cid then
			for iter_9_4, iter_9_5 in pairs(var_9_0) do
				self._battle_obj_mgr:findObject(iter_9_5):set_unlock_open_torpedo_attack(true)
			end
		end
	end
		...
		for iter_11_2, iter_11_3 in pairs(var_11_0) do
			if var_11_1 then
				if self:__get_ship_data_by_countrys(iter_11_3, var_11_1) and self:__get_ship_data_by_screen(iter_11_3, var_11_2, var_11_3, var_11_4) then
					var_0_5:update_target_attr(iter_11_3, var_0_1.skil_attribute_type[arg_11_1.num4], var_11_5, arg_11_2)
				end
