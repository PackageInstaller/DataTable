...
local var_0_4 = gameconfig.pve_eighth_buff_config
local var_0_5 = gameconfig.pve_eighth_enemy_buff_config
local var_0_6 = gameenum.battle_type

lx.define_class("eighth_buffs_logic", function(arg_1_0)
	...
	function arg_1_0.__init(arg_5_0, arg_5_1, arg_5_2)
		if not arg_5_1 or type(arg_5_1) ~= "number" then
			return
		end

		arg_5_0._buff_type = arg_5_2

		if arg_5_2 == "eighth_buff" then
			arg_5_0._buff_data = arg_5_1 > 100000 and var_0_4.find_object_by_id(arg_5_1) or var_0_5.find_object_by_id(arg_5_1)
		end

		if arg_5_2 == "eighth_node_buff" then
			arg_5_0._buff_data = {
				effect = arg_5_1
			}
		end
	...
	function arg_1_0:do_buff_logic(arg_6_1, arg_6_2, arg_6_3)
		if self._buff_type == "eighth_buff" then
			self:__on_eighth_buffs_func(arg_6_1, arg_6_2, arg_6_3)
		end

		if self._buff_type == "eighth_node_buff" then
			self:__on_eighth_buffs_func(arg_6_1, arg_6_2, arg_6_3)
		end
	end

	function arg_1_0:__on_eighth_buffs_func(arg_7_1, arg_7_2, arg_7_3)
		if not self._buff_data or not self._buff_data.effect then
			return
		end

		for iter_7_0, iter_7_1 in pairs(self._buff_data.effect) do
			local var_7_0 = var_0_2("__on_func_%s", (self:__get_eighth_buff_func_name(iter_7_1.type)))
	...
	function arg_1_0.__get_eighth_buff_func_name(arg_8_0, arg_8_1)
		for iter_8_0, iter_8_1 in pairs(var_0_6.eighth_buff_type) do
...
function var_0_0.create(arg_10_0)
	local var_10_0 = var_0_1.class("eighth_buffs_logic", var_0_3:inherit())
