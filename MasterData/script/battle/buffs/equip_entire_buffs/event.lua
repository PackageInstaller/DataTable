...
function var_0_0.extend_method(arg_1_0)
	function arg_1_0.__on_func_equip_entire_buffs_air_down(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
		if arg_2_4 == "init_attr" then
			return
		end

		if arg_2_2:get_side() == var_0_1.obj_side.player then
			return
		end
		...
		if arg_2_1.equip_cid then
			if not arg_2_3:get_attribute().down_air_by_player then
				arg_2_3:get_attribute().down_air_by_player = {
					num = -var_2_1,
					effect_type = var_0_1.equip_special_effect_type.reduce_enemy_aircraft_hit
				}
			else
				arg_2_3:get_attribute().down_air_by_player.num = arg_2_3:get_attribute().down_air_by_player.num - var_2_1
			end
		end
	end
