...
lx.define_class("equip_entire_buffs_enemy_logic", function(arg_1_0)
	...
	function arg_1_0:do_buff_logic(arg_4_1, arg_4_2, arg_4_3, arg_4_4)
		self:__on_equip_entire_enemy_buff_func(arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	end

	function arg_1_0:__on_equip_entire_enemy_buff_func(arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	function arg_1_0.__get_equip_entire_buff_func_name(arg_6_0, arg_6_1)
		for iter_6_0, iter_6_1 in pairs(var_0_6.equip_entire_buffs_enemy_type) do
...
function var_0_0.create(arg_7_0)
	return (var_0_1.class("equip_entire_buffs_enemy_logic", var_0_5:inherit()))
end
