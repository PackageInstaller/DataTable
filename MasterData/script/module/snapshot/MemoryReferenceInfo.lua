	...
	if var_6_3 == "table" then
		...
		if var_6_6 then
			...
			if var_6_7 then
				if var_6_7 == "k" then
					var_6_4 = true
				elseif var_6_7 == "v" then
					var_6_5 = true
				elseif var_6_7 == "kv" then
					var_6_4 = true
					var_6_5 = true
				end
			end
		...
		for iter_6_0, iter_6_1 in pairs(arg_6_1) do
			...
			elseif var_6_8 == "userdata" then
				...
				var_0_6(arg_6_0 .. "." .. iter_6_0, iter_6_1, arg_6_2)
			end
		end
...
local function var_0_7(arg_7_0, arg_7_1, arg_7_2)
	...
	if var_7_4 == "table" then
		...
		for iter_7_0, iter_7_1 in pairs(arg_7_1) do
			...
			elseif var_7_9 == "function" then
				if not var_7_5 then
					var_0_7(arg_7_0 .. ".[table:key.function]", iter_7_0, arg_7_2)
				end
			...
			elseif var_7_9 == "userdata" then
				...
				var_0_7(arg_7_0 .. "." .. iter_7_0, iter_7_1, arg_7_2)
			end
		end
	...
	elseif var_7_4 == "function" then
		local var_7_10 = debug.getinfo(arg_7_1, "Su")
		local var_7_11 = arg_7_0 .. "[line:" .. tostring(var_7_10.linedefined) .. "@file:" .. var_7_10.short_src .. "]"

		if var_7_1[arg_7_1] and not var_7_2[var_7_11] then
			var_7_2[var_7_11] = true
		end
		...
		for iter_7_2 = 1, var_7_10.nups do
			local var_7_12, var_7_13 = debug.getupvalue(arg_7_1, iter_7_2)
			local var_7_14 = type(var_7_13)

			if var_7_14 == "table" then
				var_0_7(arg_7_0 .. ".[ups:table:" .. var_7_12 .. "]", var_7_13, arg_7_2)
			elseif var_7_14 == "function" then
				var_0_7(arg_7_0 .. ".[ups:function:" .. var_7_12 .. "]", var_7_13, arg_7_2)
			elseif var_7_14 == "thread" then
				var_0_7(arg_7_0 .. ".[ups:thread:" .. var_7_12 .. "]", var_7_13, arg_7_2)
			elseif var_7_14 == "userdata" then
				var_0_7(arg_7_0 .. ".[ups:userdata:" .. var_7_12 .. "]", var_7_13, arg_7_2)
			end
		end

		if debug.getfenv then
			local var_7_15 = debug.getfenv(arg_7_1)

			if var_7_15 then
				var_0_7(arg_7_0 .. ".[function:environment]", var_7_15, arg_7_2)
			end
		end
	elseif var_7_4 == "thread" then
		...
		if debug.getfenv then
			local var_7_16 = debug.getfenv(arg_7_1)

			if var_7_16 then
				var_0_7(arg_7_0 .. ".[thread:environment]", var_7_16, arg_7_2)
			end
		end

		local var_7_17 = getmetatable(arg_7_1)

		if var_7_17 then
			var_0_7(arg_7_0 .. ".[thread:metatable]", var_7_17, arg_7_2)
		end
	elseif var_7_4 == "userdata" then
		...
		if debug.getfenv then
			...
			if var_7_18 then
				var_0_7(arg_7_0 .. ".[userdata:environment]", var_7_18, arg_7_2)
			end
		end
		...
		if var_7_19 then
			var_0_7(arg_7_0 .. ".[userdata:metatable]", var_7_19, arg_7_2)
		end
...
local function var_0_9(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	for iter_11_1 in pairs(arg_11_3.m_cObjectAliasName) do
		if arg_11_2 > 0 then
			if arg_11_2 >= i then
				var_11_7(iter_11_1 .. "\n")
			end
