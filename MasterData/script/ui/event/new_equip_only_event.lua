...
function var_0_0.extend_method(arg_1_0)
	...
	function arg_1_0:__onClick_back_btn()
		...
		if self._skin_data and self._enter_type ~= var_0_3.enter_get_ship_type.mail_skin_award then
			...
			var_3_1:show((self._ship_data or nil) and string.format(var_0_2:getNowLang("skin_replace_desc"), self._ship_data.title), function()
				...
				local var_5_3 = var_0_1:createInstance("change_skin_panel")

				var_5_3:show(self._skin_data, var_5_2)

				local var_5_4 = var_5_3._panel:GetComponent("Canvas")

				var_5_4.sortingOrder = var_5_4.sortingOrder + 200
		...
		if self._is_new_ship and self._enter_type ~= var_0_3.enter_get_ship_type.abyss_combine_panel then
			...
			elseif var_0_5:get_ship_lock_state(self._data.id) == false then
				local var_3_5 = var_0_1:createInstance("msgbox")

				var_3_5._control.main.close.gameObject:SetActive(false)
				var_3_5:show(var_0_2:getNowLang("shiplockbody"), function()
					...
					var_3_5._control.main.close.gameObject:SetActive(true)
				end, function()
		...
		elseif self._is_new_equipment and self._enter_type ~= var_0_3.enter_get_ship_type.abyss_combine_panel then
			...
			elseif self._control.new_equip.lock_toggle.lock_state.gameObject.activeSelf == false then
				...
				var_3_6:show(var_0_2:getNowLang("equipment_lock"), function()
					self:_play_into_se(var_0_3:get_audio_url(var_0_3.common_icon.music_path, var_0_3.open))
		...
		if self._enter_type == var_0_3.enter_get_ship_type.mall_shop then
			local var_3_7 = var_0_1:getInstance("ship_detail")

			if var_3_7 then
				var_3_7:reset_current_panel(true)
			end
		end
		...
		if not self._skin_data then
			local var_3_8 = var_0_1:getInstance("new_equip_only")

			return
		end

		local var_3_9 = var_0_11.find_object_by_cid(self._skin_data.cid)

		if not var_3_9 then
			return
		end

		if var_3_9.bgm == 0 then
			return
		end

		var_0_1:createInstance("reward_tip"):show_get_music(var_3_9.bgm)
	end
	...
	function arg_1_0:__onClick_new_ship_lock_toggle_lock_state()
		...
		self._control.new_ship.lock_toggle.unlocklock_state:SetActive(true)
	end
	...
	function arg_1_0:__onClick_new_ship_lock_toggle_unlocklock_state()
		...
		self._control.new_ship.lock_toggle.lock_state:SetActive(true)
	...
	function arg_1_0:__set_guide_data()
		if (self._enter_type == var_0_3.enter_get_ship_type.sign_and_task or self._enter_type == var_0_3.enter_get_ship_type.other or self._enter_type == var_0_3.enter_get_ship_type.dock_building) and var_0_5:get_guide_state() then
			local var_25_0 = var_0_1:getInstance("guide_panel")

			if var_25_0:get_next_step() ~= var_0_3.guide_const_id.ten_group.zero then
				var_25_0:reset_guide_panel()
			end
		end
	end
end
