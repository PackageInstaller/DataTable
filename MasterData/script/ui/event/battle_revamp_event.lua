...
local var_0_9 = gamecore.BattleRevampManager
...
function var_0_0.extend_method(arg_1_0)
	function arg_1_0:__onClick_popup_combat_continue_frame_nightwarleft()
		...
		if self._fight_type == var_0_12.battle_type.event_story then
			self:hide_night_war_tip()
			var_0_9:handleBattleScene("night_attack_step", {
				damage_control_num = 0
			})
		else
			local var_2_0 = var_0_8:createInstance("loading")
	...
	function arg_1_0:__onClick_popup_combat_continue_frame_nightwarright()
		self:_play_into_se(var_0_12:get_audio_url(var_0_12.common_icon.music_path, var_0_12.back))

		local var_3_0 = var_0_9:get_battle_result()
		local var_3_1 = var_0_9:get_battle_damage_report()

		var_0_9:exit(function(arg_4_0)
			if self._fight_type == gameenum.battle_type.fight_type.plot_main then
				self:enter_plot_event(arg_4_0, var_3_0)
			else
				local var_4_0 = var_0_8:createInstance("loading")
				...
				self:write_battle_damage_info(var_3_1)
			end
		end)
	end
	...
	function arg_1_0.__onClick_popup_combat_continue_frame_damagecontrol_buy(arg_6_0)
		if var_0_11:get_guide_state() then
			return
		end

		local var_6_0 = var_0_3.find_object_by_id(var_0_12.shop_damage_control_cid)
		local var_6_1 = var_0_8:createInstance("shop_bounced")
		...
		local var_6_2 = var_6_1._panel:GetComponent("Canvas")

		var_6_2.sortingOrder = var_6_2.sortingOrder + 1
	end

	function arg_1_0.__onClick_support_root_bg_mask(arg_7_0)
		return
	end
	...
	function arg_1_0:__onClick_skip()
		...
		local var_12_0 = var_0_9:get_battle_result()
		local var_12_1 = var_0_9:get_battle_damage_report()

		var_0_9:exit(function(arg_13_0)
			if self._fight_type == gameenum.battle_type.fight_type.plot_main then
				self:enter_plot_event(arg_13_0, var_12_0)
			else
				var_0_11:req_QuitNightBattleReq()
				var_0_11:req_BattleFinishReq()
				self:write_battle_damage_info(var_12_1)
			end
		end)
	end
	...
	function arg_1_0.write_battle_damage_info(arg_17_0, arg_17_1)
		...
		if not app:isPC() then
			...
			var_17_0 = io.open(app:getSystem():getWritePath() .. "battlereport", "wb")
		end

		var_17_0:write(var_0_1.json_format(arg_17_1) .. "\n" .. var_0_2(var_0_11:get_battle_data().record))
		var_17_0:close()
	end
