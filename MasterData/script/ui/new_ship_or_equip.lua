...
gamecore.UILoader:define("new_ship_or_equip", function(arg_1_0)
	function arg_1_0:show(arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
		...
		if arg_2_3 then
			...
			elseif self._enter_type == var_0_6.enter_get_ship_type.spoils_shop or self._enter_type == var_0_6.enter_get_ship_type.combats_shop or self._enter_type == var_0_6.enter_get_ship_type.up_award or self._enter_type == var_0_6.enter_get_ship_type.salvage_award or self._enter_type == var_0_6.enter_get_ship_type.seven_big_map or self._enter_type == var_0_6.enter_get_ship_type.seven_treasure_find then
				...
				if var_0_2:getInstance("strike_awardbox") then
			...
			elseif self._enter_type == var_0_6.enter_get_ship_type.abyss_panel then
				self:_play_audio(var_0_6:get_audio_url(var_0_6.common_icon.music_path, var_0_6.get_item), false)
				self:__init_panel_sopit(arg_2_2)
				self._control.lock_toggle:SetActive(false)
		...
		if self._enter_type == var_0_6.enter_get_ship_type.ship_detail then
			...
			self._control.lock_toggle.lock_state:GetComponent("Button").enabled = false
			self._control.lock_toggle.unlocklock_state:GetComponent("Button").enabled = false
			self._control.lock_toggle.ship_detail_btn:GetComponent("Button").enabled = false
		end
	...
	function arg_1_0:_set_sp_scene_order(arg_3_1)
		...
		local var_3_1 = var_0_2:getInstance("voucher_shop")
	...
	function arg_1_0:set_ship_info(arg_9_1)
		...
		if self._enter_type == var_0_6.enter_get_ship_type.remake or self._enter_type == var_0_6.enter_get_ship_type.abyss_get_awards then
			...
			if self._is_new_ship then
				...
				self._control.lock_toggle.lock_state:SetActive(var_0_3:get_ship_lock_state(self._data.id))
				self._control.lock_toggle.unlocklock_state:SetActive(not var_0_3:get_ship_lock_state(self._data.id))
			else
				self._control.lock_toggle.lock_state:SetActive(var_0_3:get_ship_lock_state(self._data.id))
				self._control.lock_toggle.unlocklock_state:SetActive(not var_0_3:get_ship_lock_state(self._data.id))
			end
		elseif self._enter_type == var_0_6.enter_get_ship_type.dock_building or self._enter_type == var_0_6.enter_get_ship_type.mail_ship_award or self._enter_type == var_0_6.enter_get_ship_type.sign_and_task or self._enter_type == var_0_6.enter_get_ship_type.up_award or self._enter_type == var_0_6.enter_get_ship_type.salvage_award or self._enter_type == var_0_6.enter_get_ship_type.spoils_shop or self._enter_type == var_0_6.enter_get_ship_type.seven_big_map or self._enter_type == var_0_6.enter_get_ship_type.other then
			self._control.lock_toggle:SetActive(true)
		...
		if self._enter_type ~= var_0_6.enter_get_ship_type.dock_building and self._is_new_ship then
			var_0_11:show(var_0_1:getNowLang("errorcode-320"))
		end
	...
	function arg_1_0:show_btns(arg_15_1)
		if self._enter_type == var_0_6.enter_get_ship_type.ship_detail then
			self._control.lock_toggle.lock_state:SetActive(arg_15_1)
			self._control.lock_toggle.unlocklock_state:SetActive(not arg_15_1)
		...
		self._control.lock_toggle.ship_detail_btn:SetActive(arg_15_1)

		if self._data_list and next(self._data_list) and self._enter_type ~= var_0_6.enter_get_ship_type.salvage_award then
			if #self._data_list > 1 then
				if self._data_list[1].id > 10000000 and self._data_list[1].id % 100 == 21 then
					self._control.lock_toggle:SetActive(false)
				end
			elseif self._data_list.id then
				if tonumber(self._data_list.id) > 10000000 and tonumber(self._data_list.id % 100) == 21 then
					self._control.lock_toggle:SetActive(false)
				end
			elseif self._data_list[1] and self._data_list[1].id > 10000000 and self._data_list[1].id % 100 == 21 then
				self._control.lock_toggle:SetActive(false)
			end
		end

		if var_0_2:getInstance("strike_awardbox") then
			self._control.lock_toggle.ship_detail_btn:SetActive(false)
		end
	end

	function arg_1_0:show_abyss_btns(arg_16_1)
		self._control.lock_toggle.lock_state:SetActive(arg_16_1)
		self._control.lock_toggle.unlocklock_state:SetActive(not arg_16_1)
		self._control.lock_toggle.ship_detail_btn:SetActive(false)
	...
	function arg_1_0:__check_layer()
		...
		if var_23_2 then
			...
			var_23_4 = var_0_2:getInstance("strike_awardbox")
		end
		...
		if var_23_4 then
			self._panel.transform:GetComponent("Canvas").sortingOrder = var_23_4._panel.transform:GetComponent("Canvas").sortingOrder + 2
		end
	end
	...
	function arg_1_0:__show_next()
		...
		elseif var_25_17.type == var_0_6.reward_type.equipment then
			...
			self._control.lock_toggle.gameObject:SetActive(false)
	...
	function arg_1_0:__check_abyss_new_ship()
		self:setVisible(false)
	...
	function arg_1_0:__set_contents_in_skill_select(arg_33_1)
		...
		self._control.lock_toggle.ship_detail_btn:SetActive(arg_33_1)
		self._control.new_ship.ship_info:SetActive(arg_33_1)
		self._control.new_ship.ship_dialog:SetActive(arg_33_1)
		self._control.lock_toggle:SetActive(arg_33_1)
...
function var_0_0.create(arg_46_0)
	local var_46_0 = var_0_2:class("new_ship_or_equip")
