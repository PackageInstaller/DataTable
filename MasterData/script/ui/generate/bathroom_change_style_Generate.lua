				...
				list = {
					...
					style_switch = {
						...
						list = {
							...
							style_2_btn = {
								path = "bg/style_switch/style_2_btn",
								list = {
									bath_image_2 = {
										path = "bg/style_switch/style_2_btn/bath_image_2",
										list = {},
										component = {
											"UnityEngine.RectTransform",
											"UnityEngine.CanvasRenderer",
									...
									bg_unselected = {
										path = "bg/style_switch/style_2_btn/bg_unselected",
										list = {
											captainstyle3 = {
												path = "bg/style_switch/style_2_btn/bg_unselected/captainstyle3",
												list = {},
												component = {
													"UnityEngine.RectTransform",
													"UnityEngine.CanvasRenderer",
									...
									bg = {
										path = "bg/style_switch/style_2_btn/bg",
										list = {
											captainstyle3_selected = {
												path = "bg/style_switch/style_2_btn/bg/captainstyle3_selected",
												list = {},
												component = {
													"UnityEngine.RectTransform",
													"UnityEngine.CanvasRenderer",
