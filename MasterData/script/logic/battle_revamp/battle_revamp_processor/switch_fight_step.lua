...
local var_0_5 = gamecore.BattleRevampManager
...
function var_0_0.extend_method(arg_1_0)
	...
	function arg_1_0:on_night_war()
		...
		if not self._is_night_war then
			self:change_night_bg()
		else
			var_61_0 = 500
		end
		...
		local var_61_1 = self._battlefield._battle_report.night_attack
		...
		self:delay(var_61_0, function()
			self:process_night_attack(var_61_1, 1)
		end)
	end
	...
	function arg_1_0.write_battle_damage_info(arg_68_0, arg_68_1)
		...
		if not arg_68_1 then
			...
			var_68_0 = io.open(app:getSystem():getWritePath() .. "battlereport", "wb")
		end

		var_68_0:write(var_0_1.json_format(arg_68_1) .. var_0_2(var_0_4:get_battle_data().record))
		var_68_0:close()
	end
