...
local var_0_4 = lx.split
local var_0_5 = gamecore.battle_revamp_processor

lx.define_class("BattleRevampManager", function(arg_1_0)
	function arg_1_0:start()
		...
		self._battle_processor = var_0_5:create()
	...
	function arg_1_0:loadRecord(arg_3_1, arg_3_2)
		if self._battlefield and not arg_3_1 then
			return
		end
		...
		if self._battlefield and arg_3_1 then
			var_3_1 = self._battlefield._damage_result
			var_3_2 = self._battlefield._battle_result
			var_3_3 = self._battlefield._index
		end
		...
		self._battlefield.is_test = false
		self._battlefield.can_go_night = false

		local var_3_4 = var_3_0[1].param.seed

		if arg_3_1 then
			self._battlefield.is_test = true
			self._battlefield.can_go_night = arg_3_2
			self._battlefield._damage_result = var_3_1
			self._battlefield._battle_result = var_3_2
			self._battlefield._index = var_3_3

			local var_3_5 = var_0_4(var_3_0[1].param.seed, "-")

			var_3_4 = tostring(tonumber(var_3_5[1]) + arg_3_1) .. "-" .. tostring(tonumber(var_3_5[2]) + arg_3_1)
		end

		if var_3_0 then
			self._battlefield:initBattleField({
				BattleRandom = var_3_4,
...
return function()
	local var_24_0 = var_0_0.class("BattleRevampManager")
