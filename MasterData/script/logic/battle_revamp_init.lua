...
local function var_0_1(arg_1_0, arg_1_1)
	...
	for iter_1_10, iter_1_11 in pairs({
		{
			path = "battle_revamp.BattleRevampManager",
			name = "BattleRevampManager"
		}
	}) do
