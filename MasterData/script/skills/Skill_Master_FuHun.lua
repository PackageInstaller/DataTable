-- chunkname: @/tmp/or_skill/lua_compile/Skill_Master_FuHun.lua
...
if not _M.__all__ then
	...
	_M.__all__.Sk_Master_FuHun_Attack = {
	...
	_M.__all__.Sk_Master_FuHun_Action1 = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
	...
	_M.__all__.Sk_Master_FuHun_Action2 = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
	...
	_M.__all__.Sk_Master_FuHun_Action3 = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
	...
	_M.__all__.Sk_Master_FuHun_Passive = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
