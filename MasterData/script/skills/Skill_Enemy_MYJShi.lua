-- chunkname: @/tmp/or_skill/lua_compile/Skill_Enemy_MYJShi.lua
...
if not _M.__all__ then
	...
	_M.__all__.Skill_Enemy_MYJShi_Normal = {
	...
	_M.__all__.Skill_Enemy_MYJShi_Skill = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
			...
			exec["@time"]({
				...
				_env.units = global.Slice(_env, global.SortBy(_env, global.FriendUnits(_env), "<", global.UnitPropGetter(_env, "hpRatio")), 1, 2)
	...
	_M.__all__.Skill_Enemy_MYJShi_Passive = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
