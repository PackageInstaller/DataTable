-- chunkname: @/tmp/or_skill/lua_compile/Skill_ZTXCun.lua
...
if not _M.__all__ then
	...
	_M.__all__.Skill_ZTXCun_Normal = {
	...
	_M.__all__.Skill_ZTXCun_Unique = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
	...
	_M.__all__.Skill_ZTXCun_Passive = {
		__new__ = function(prototype, externs, global)
			return
		end,
	...
	_M.__all__.Skill_ZTXCun_Proud_EX = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
	...
	_M.__all__.Skill_ZTXCun_Unique_EX = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
	...
	_M.__all__.Skill_ZTXCun_Passive_EX = {
		__new__ = function(prototype, externs, global)
			return
		end,
		passive1 = function(_env, externs)
		...
		passive2 = function(_env, externs)
			...
			exec["@time"]({
				...
				if global.MARKED(_env, "WARRIOR")(_env, _env.unit) then
					this.num = #global.AllUnits(_env, global.MARKED(_env, "WARRIOR"))

					local m = global.Min(_env, this.num, this.maxnum)

					for _, unit in global.__iter__(global.AllUnits(_env, global.MARKED(_env, "WARRIOR"))) do
