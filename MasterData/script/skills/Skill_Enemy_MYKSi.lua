-- chunkname: @/tmp/or_skill/lua_compile/Skill_Enemy_MYKSi.lua
...
if not _M.__all__ then
	...
	_M.__all__.Skill_Enemy_MYKSi_Normal = {
	...
	_M.__all__.Skill_Enemy_MYKSi_Skill = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
	...
	_M.__all__.Skill_Enemy_MYKSi_Passive = {
		__new__ = function(prototype, externs, global)
			return
		end,
		main = function(_env, externs)
