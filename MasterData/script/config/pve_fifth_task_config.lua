...
function var_0_0.find_object_by_pve_level_id_id(arg_5_0, arg_5_1)
	if not var_0_1.primary_pve_level_id_id[arg_5_0] then
		return nil
	end

	local var_5_0 = var_0_1.primary_pve_level_id_id[arg_5_0][arg_5_1]

	if not var_0_1.primary_pve_level_id_id[arg_5_0][arg_5_1] then
		return nil
	end
...
function var_0_0.get_id_set_by_pve_level_id(arg_6_0)
	return var_0_1.primary_pve_level_id_id[arg_6_0]
end
