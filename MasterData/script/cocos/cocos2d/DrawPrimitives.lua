-- chunkname: @/tmp/or_script/lua_compile/cocos/cocos2d/DrawPrimitives.lua
...
function ccDrawCircleScale(center, radius, angle, segments, drawLineToCenter, scaleX, scaleY)
	...
	local function initBuffer()
		...
		for i = 1, segments + 1 do
			...
			vertices[i * 2 - 1] = radius * math.cos(rads + angle) * scaleX + center.x
			vertices[i * 2] = radius * math.sin(rads + angle) * scaleY + center.y
		end
