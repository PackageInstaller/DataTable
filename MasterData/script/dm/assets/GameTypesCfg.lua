-- chunkname: @/tmp/or_script/lua_compile/dm/assets/GameTypesCfg.lua
...
CurrencyIdKind = {
	...
	kCrystal = "IR_Crystal",
	kDiamondDrawSU = "IM_DiamondDrawSU",
	...
	kDiamondDrawEx = "IM_DiamondDrawEX",
	kActivityBakingRePower = "IR_BakingStamina_Re",
	kDiamondDrawSP = "IM_DiamondDrawSP",
	...
	kTECH = "IR_TECH",
	kAcitvityZuoHeRePowerRePower = "IR_ZuoHeAcitvityStamina_3rd",
...
ExploreTypeCfgInfo = {}
ExploreTypeCfgInfo.blockGridSize = cc.size(10, 10)
ExploreTypeCfgInfo.mapSize = cc.size(9600, 9600)
...
PowerConfigMap = {
	...
	[CurrencyIdKind.kAcitvityZuoHeRePowerRePower] = {
		all = "Act_ZuoHe_Power_RecAll",
		perMin = "Act_ZuoHe_Power_RecPerMin",
		next = "Act_ZuoHe_Power_RecNext",
		func = "getPowerByCurrencyId",
...
KShopPushPackageKind = {
	KPush_Talent = "Push_MasterStage_Exp",
	KPush_Draw = "Push_Draw",
	KPush_Gold = "Push_Gold",
	KPush_Crystal = "Push_Crystal",
	KPush_Exp = "Push_Exp"
}
KShopPushPackageScene = {
	KMaster = "Master",
	KHeroStarUp = "HeroStarUp",
	KWifeGrow = "WifeGrow",
	KEquip = "Equip",
	KARENA_FAIL = "ARENA_FAIL",
	KHeroLevelUp = "HeroLevelUp",
	KDrawCard = "DrawCard",
	KSTAGE_FAIL = "STAGE_FAIL"
}
KPushPackageAnimName = {
	Sliver = "MTZMEShi",
	Gold = "SP_ALPo",
	Normal = "XLai"
}
