-- chunkname: @/tmp/or_script/lua_compile/dm/debug/debugBox/DebugBoxMainIndex.lua
...
function DebugBoxMainIndex:getMainIndex()
	return {
		{
			"抢新娘",
			{
...
function DebugBoxMainIndex:getSubIndex()
	local subIndex = {
		{
			"加道具",
			"AddGoodsDV"
		...
		{
			"重置八神开启次数",
			"ClubBashenResetOpenNum"
		},
		{
			"重置八神重开次数",
			"ClubBashenResetReopenNum"
		},
		{
			"重置八神服务器发奖状态",
			"ClubBashenResetState"
		},
		{
			"八神排行榜假数据",
			"ClubBashenRankData"
