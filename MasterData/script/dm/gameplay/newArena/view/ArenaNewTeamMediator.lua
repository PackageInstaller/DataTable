-- chunkname: @/tmp/or_script/lua_compile/dm/gameplay/newArena/view/ArenaNewTeamMediator.lua
...
function ArenaNewTeamMediator:onEnterBattle()
	...
	self._arenaNewSystem:requestBeginBattle(self._rivalTeamIndex, false, callback)
end
