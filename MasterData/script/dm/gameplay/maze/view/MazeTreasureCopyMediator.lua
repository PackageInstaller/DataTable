-- chunkname: @/tmp/or_script/lua_compile/dm/gameplay/maze/view/MazeTreasureCopyMediator.lua
...
function MazeTreasureCopyMediator:mapEventListeners()
	self.mapEventListener(self, self:getEventDispatcher(), EVT_MAZE_TREASURE_COPY, self, self.updateViews)
end
