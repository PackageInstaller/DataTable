-- chunkname: @/tmp/or_script/lua_compile/dm/gameplay/leadStageArena/view/LeadStageArenaTeamMediator.lua
...
function LeadStageArenaTeamMediator:enterWithData(data)
	...
	if data.teamIndex then
		self._teamIndex = data.teamIndex or 1
	end
