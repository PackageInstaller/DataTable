-- chunkname: @/tmp/or_script/lua_compile/dm/gameplay/stage/view/component/commonStageMap/ChapterTwoCell.lua

ChapterTwoCell = class("ChapterTwoCell", ChapterBase)

local kBtnHandlers = {}

function ChapterTwoCell:initialize(data)
...
function ChapterTwoCell:update(stageType, redPointTab)
	...
	self:initChapterPanel(self._chapter1, "M02", callFunc)
	...
	self:initChapterPanel(self._chapter2, "M03", callFunc)
...
function ChapterTwoCell:onScroll(offX)
...
function ChapterTwoCell:initView()
	self:initWidget()
	self:initAnim()
end

function ChapterTwoCell:initWidget()
...
function ChapterTwoCell:initAnim()
...
function ChapterTwoCell:setupGuideAnim()
