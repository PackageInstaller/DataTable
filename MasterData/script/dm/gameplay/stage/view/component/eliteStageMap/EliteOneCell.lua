-- chunkname: @/tmp/or_script/lua_compile/dm/gameplay/stage/view/component/eliteStageMap/EliteOneCell.lua
...
function EliteOneCell:onScroll(offX)
	local percentOfChapter

	self._chapter:setPosition(cc.p(self._chapterRawX + (offX < -1050 and 1 or -(offX / 1050)) * 380, self._chapterRawY))
end
