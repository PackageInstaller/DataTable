-- chunkname: @/tmp/or_script/lua_compile/dm/gameplay/stage/view/component/eliteStageMap/EliteEightCell.lua

EliteEightCell = class("EliteEightCell", ChapterBase)

local kBtnHandlers = {}

function EliteEightCell:initialize(data)
...
function EliteEightCell:update(stageType, redPointTab)
	...
	self:initChapterPanel(self._chapter1, "E14", callFunc)
	...
	self:initChapterPanel(self._chapter2, "E15", callFunc)
...
function EliteEightCell:initView()
	self:initWidget()
	self:initAnim()
end

function EliteEightCell:onScroll(offX)
	return
end

function EliteEightCell:initWidget()
...
function EliteEightCell:initAnim()
