-- chunkname: @/tmp/or_script/lua_compile/dm/gameplay/stage/controller/StageSystem.lua
...
function StageSystem:enterBattle(pointId, playerData, mapData, enemyBuff)
	...
	if not pointConfig.Background then
		...
		var_119_2.hpShow = self:getInjector():getInstance(SettingSystem):getSettingModel():getHpShowSetting()
		var_119_2.effectShow = self:getInjector():getInstance(SettingSystem):getSettingModel():getEffectShowSetting()
		var_119_2.battleSuppress = BattleDataHelper:getBattleSuppress()
		var_119_2.passiveSkill = battlePassiveSkill
		var_119_2.unlockMasterSkill = self:getInjector():getInstance(SystemKeeper):isUnlock("Master_BattleSkill")
		var_119_2.finishWaitTime = BattleDataHelper:getBattleFinishWaitTime(battleType)
		var_119_2.changeMaxNum = ConfigReader:getDataByNameIdAndKey("BlockPoint", pointId, "BossRound") or 1

		local var_119_3 = {}
		local var_119_4 = {}

		var_119_4.visible = speedOpenSta and self:getInjector():getInstance(SystemKeeper):canShow("BattleSpeed")
		var_119_4.lock = not unlockSpeed
		var_119_4.tip = tipsSpeed
		var_119_4.speedConfig = battleSpeed_Actual
		var_119_4.speedShowConfig = battleSpeed_Display
		var_119_4.timeScale = timeScale
		var_119_3.speed = var_119_4
		var_119_3.skip = {
			visible = false
		}
		...
		var_119_5.visible = self:getInjector():getInstance(SystemKeeper):canShow("AutoFight")
		var_119_5.state = (not unlock or nil) and false
		var_119_5.lock = not systemKeeper:isUnlock("AutoFight")
		var_119_3.auto = var_119_5
		var_119_3.pause = {
			visible = true
		}
		...
		var_119_6.visible = self:getInjector():getInstance(SystemKeeper):canShow("Button_CombateDominating")
		var_119_6.lock = not self:getInjector():getInstance(SystemKeeper):isUnlock("Button_CombateDominating")
		var_119_3.restraint = var_119_6
		var_119_2.btnsShow = var_119_3
		var_119_1.viewConfig = var_119_2
		var_119_1.loadingType = loadingType

		local data = var_119_1
...
function StageSystem:enterHeroStoryBattle(pointId, mapId, playerData)
	...
	if not pointConfig.Background then
		...
		var_137_1.hpShow = self:getInjector():getInstance(SettingSystem):getSettingModel():getHpShowSetting()
		var_137_1.effectShow = self:getInjector():getInstance(SettingSystem):getSettingModel():getEffectShowSetting()
		var_137_1.battleSuppress = BattleDataHelper:getBattleSuppress()
		var_137_1.passiveSkill = battlePassiveSkill
		var_137_1.unlockMasterSkill = self:getInjector():getInstance(SystemKeeper):isUnlock("Master_BattleSkill")
		var_137_1.finishWaitTime = BattleDataHelper:getBattleFinishWaitTime("herostory_battle")

		local var_137_2 = {}
		local var_137_3 = {}

		var_137_3.visible = speedOpenSta and self:getInjector():getInstance(SystemKeeper):canShow("BattleSpeed")
		var_137_3.lock = not unlockSpeed
		var_137_3.tip = tipsSpeed
		var_137_3.speedConfig = battleSpeed_Actual
		var_137_3.speedShowConfig = battleSpeed_Display
		var_137_3.timeScale = timeScale
		var_137_2.speed = var_137_3
		var_137_2.skip = {
			visible = false
		}
		...
		var_137_4.visible = self:getInjector():getInstance(SystemKeeper):canShow("AutoFight")
		var_137_4.state = isAuto
		var_137_4.lock = not systemKeeper:isUnlock("AutoFight")
		var_137_2.auto = var_137_4
		var_137_2.pause = {
			visible = true
		}
		...
		var_137_5.visible = self:getInjector():getInstance(SystemKeeper):canShow("Button_CombateDominating")
		var_137_5.lock = not self:getInjector():getInstance(SystemKeeper):isUnlock("Button_CombateDominating")
		var_137_2.restraint = var_137_5
		var_137_1.btnsShow = var_137_2
		var_137_0.viewConfig = var_137_1
		var_137_0.loadingType = loadingType

		local data = var_137_0
...
function StageSystem:requestSPChangeTeam(data, callback, blockUI, params)
	self._stageService:requestSPChangeTeam(data, function(response)
		if response.resCode == GS_SUCCESS and (not params or not params or params.ignoreTip or true) then
