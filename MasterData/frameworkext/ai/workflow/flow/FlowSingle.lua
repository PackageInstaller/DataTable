...
local var_0_0 = class("FlowSingle", FlowBase)
...
function var_0_0.onInterrupt(arg_4_0)
	var_0_0.super.onInterrupt(arg_4_0)

	if arg_4_0._child.status == WorkStatus.Running then
		arg_4_0._child:onInterrupt()
	end
end

function var_0_0.onChildDone(arg_5_0, arg_5_1)
	arg_5_0:onDone(arg_5_1.result)
end
