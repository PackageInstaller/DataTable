...
function Color.IntArray2Color(IntArray)
  if IntArray == nil or type(IntArray) ~= "table" then
    error("can't convet int array to color")
    return Color.red
  end
  local color = Color.New((IntArray[1] or 0) / 255, (IntArray[2] or 0) / 255, (IntArray[3] or 0) / 255, (IntArray[4] or 255) / 255)
  return color
end
...
Color._commonTemp = Color.New()

function Color.Temp(r, g, b, a)
  Color._commonTemp:Set(r, g, b, a)
  return Color._commonTemp
end
...
function _getter.maxColorComponent(c)
