  ...
  local function val2str(t, name, indent, insref, path, plainindex, level)
    ...
    if ttype == "table" then
      ...
      for n, key in ipairs(o) do
        ...
        if not ((not opts.valignore or not opts.valignore[value]) and (not opts.keyallow or opts.keyallow[key])) or opts.keyignore and opts.keyignore[key] or opts.valtypeignore and opts.valtypeignore[type(value)] or sparse and value == nil then
