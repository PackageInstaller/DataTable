local flyChessBuildSelectLayer = class("flyChessBuildSelectLayer", (require("view.Layer.BaseUILayer")))
...
var_0_8[5] = "dice_again.png"
var_0_8[6] = "forward_small.png"
var_0_8[7] = "forward_big.png"
var_0_8[8] = "add_explore.png"

function flyChessBuildSelectLayer:ctor()
	flyChessBuildSelectLayer.super.ctor(self)
	self:setAutoAdapt(true)
end

function flyChessBuildSelectLayer:create(arg_2_1)
	self.activityId = arg_2_1.activityId
	self.ResPath = "activity_flyChess_" .. self.activityId .. "/"

	local var_2_0 = flyChessBuildSelectLayer.new()
...
function flyChessBuildSelectLayer:onEnter()
	flyChessBuildSelectLayer.super.onEnter(self)
end

function flyChessBuildSelectLayer:onExit()
	flyChessBuildSelectLayer.super.onExit(self)
end

function flyChessBuildSelectLayer:init(arg_5_1)
...
function flyChessBuildSelectLayer:initLayer(arg_6_1)
	...
	local var_6_2 = {
		cc.p(var_6_1:size().w / 2 - 150, var_6_1:size().h / 2 + 100 + -50),
		cc.p(var_6_1:size().w / 2 + 150, var_6_1:size().h / 2 + 100 + -50),
		cc.p(var_6_1:size().w / 2 - 150, var_6_1:size().h / 2 - 100 + -50),
		cc.p(var_6_1:size().w / 2 + 150, var_6_1:size().h / 2 - 100 + -50)
	}
	...
	for iter_6_0 = 1, #var_6_2 do
		...
		var_6_5:_addEvent(function()
			...
			self.build_grid_type = var_6_3[iter_6_0]
		end)
		TempWidget:CreateTempImg(self.ResPath .. var_0_8[var_6_3[iter_6_0]], var_6_5):align(cc.p(0.5, 0.5), var_6_5:size().w / 2, var_6_5:size().h / 2)
...
function flyChessBuildSelectLayer:initListener(arg_9_1)
	...
	self._selectBtn:_addEvent(function()
		...
		if arg_9_1.callback then
			arg_9_1.callback(self.build_grid_type)
		end
...
function flyChessBuildSelectLayer:updateLayer()
	return
end

function flyChessBuildSelectLayer:updateRed()
	return
end

function flyChessBuildSelectLayer:updateSelected(arg_14_1)
...
return flyChessBuildSelectLayer
