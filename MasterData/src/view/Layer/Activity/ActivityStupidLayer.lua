ActivityStupidLayer = class("ActivityStupidLayer", function()
	return cc.Layer:create()
end)

function ActivityStupidLayer.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityStupidLayer.new()
...
function ActivityStupidLayer:init(arg_3_1)
...
function ActivityStupidLayer:initTiwstLayer()
	...
	local var_5_0 = self.rootPanel:getChildByName("Bottom_bg"):getChildByName("Panel_num_bg")
...
function ActivityStupidLayer:initUI()
	self.curtwistDate = {}
	...
	twist_manager:get_foolsday_twist_status(function(arg_7_0)
		...
		for iter_7_0, iter_7_1 in pairs(arg_7_0) do
			...
			self.twist_type_to_index[iter_7_1.twisttype] = iter_7_0

			if self.initTwisType and self.initTwisType == iter_7_1.twisttype then
				self.curTwistIndex = iter_7_0
			end
		end
	end)
end

function ActivityStupidLayer:initTitle()
	require("view.Sprite.TitleSprite")

	self.titleSprite = TitleSprite:create("ActivityStupidLayer/title.png", 2, "ActivityStupidLayer/title_bg.png")

	self.titleSprite:setPosition(cc.p(0, GameDisplay.getUiScreenSize().height - 56))
	self.rootLayer:addChild(self.titleSprite)
	self.titleSprite.title:setTouchEnabled(true)
	self.titleSprite.title:addTouchEventListener(function(arg_10_0, arg_10_1)
	...
	local var_9_0 = ccui.ImageView:create("ActivityStupidLayer/img_fools.png", var_0_1)

	var_9_0:setPosition(cc.p(540, 28))
	self.titleSprite:addChild(var_9_0)

	self.toolsNum = cc.Label:createWithTTF("0", FONT_NAME, 24)

	self.toolsNum:setPosition(cc.p(100, 30))
	var_9_0:addChild(self.toolsNum)
	var_9_0:setTouchEnabled(true)
	var_9_0:addTouchEventListener(function(arg_11_0, arg_11_1)
...
function ActivityStupidLayer:updateToolsNum()
	self.toolsNum:setString((item_manager:getItemNumber(108001001)))
end

function ActivityStupidLayer:initBottomList()
	self.rootpanel = ccui.ImageView:create("mainScenebg/activity/branch108/stupid_bg.jpg")

	self.rootpanel:setAnchorPoint(cc.p(0.5, 1))
	self.rootpanel:setPosition(cc.p(320, GameDisplay.getUiScreenSize().height - GameDisplay.fix_y))
	self.rootpanel:setName("bottom_bg")
	self:addChild(self.rootpanel)

	self.bottomList = ccui.ImageView:create("ActivityStupidLayer/bottom_bg.png", var_0_1)

	self.bottomList:setPosition(cc.p(0, -145))
	self.bottomList:setAnchorPoint(cc.p(0, 0))
	self.rootLayer:addChild(self.bottomList)

	local var_13_0 = cc.Label:createWithTTF("50", FONT_NAME, 22)

	var_13_0:setColor(cc.c3b(255, 222, 0))
	var_13_0:setPosition(cc.p(360, 163))
	self.bottomList:addChild(var_13_0)

	local var_13_1 = ccui.Button:create("ActivityStupidLayer/btn_return.png", nil, "ActivityStupidLayer/btn_return.png", var_0_1)

	var_13_1:setPosition(cc.p(100, 235))
	self.bottomList:addChild(var_13_1)
	...
	local var_13_2 = ccui.Button:create("ActivityStupidLayer/twist_once.png", nil, "ActivityStupidLayer/twist_once.png", var_0_1)

	var_13_2:setPosition(cc.p(280, 280))
	self.bottomList:addChild(var_13_2)
	var_13_2:addTouchEventListener(function(arg_15_0, arg_15_1)
		...
		self:twist_one_result(108, function()
			self.isCanChangeTwist = true
		end)
	end)

	self.oneBnt = var_13_2

	local var_13_3 = ccui.ImageView:create("ActivityStupidLayer/cost_50.png", var_0_1)

	var_13_3:setPosition(cc.p(var_13_2:getPositionX(), var_13_2:getPositionY() - 70))
	self.bottomList:addChild(var_13_3)

	local var_13_4 = ccui.Button:create("ActivityStupidLayer/twist_wen.png", nil, "ActivityStupidLayer/twist_wen.png", var_0_1)

	var_13_4:setPosition(cc.p(510, 285))
	self.bottomList:addChild(var_13_4)
	var_13_4:addTouchEventListener(function(arg_17_0, arg_17_1)
		...
		if playermodel.twistTenPop then
			LayerManager:pushInLayer("PopDoLayer", {
				labels = global_deepCopy(L_TWIST_TEN_POP[6800602]),
				surecallback = function()
					self:twist_ten_result(108, var_17_0)
				end,
	...
	self.tenBnt = var_13_4

	local var_13_5 = ccui.ImageView:create("ActivityStupidLayer/cost_500.png", var_0_1)

	var_13_5:setPosition(cc.p(var_13_4:getPositionX(), var_13_4:getPositionY() - 75))
	self.bottomList:addChild(var_13_5)
end

function ActivityStupidLayer:initOtherUI()
	local var_21_0 = ccui.Button:create("ActivityStupidLayer/btn_dugou.png", nil, "ActivityStupidLayer/btn_dugou.png", var_0_1)

	var_21_0:setPosition(cc.p(180, self.bottomList:getPositionY() + 450))
	...
	var_21_0:addTouchEventListener(function(arg_22_0, arg_22_1)
		...
		self:showTwistEggDrops(108, arg_22_0)
	end)

	local var_21_1 = ccui.Button:create("ActivityStupidLayer/btn_gift.png", nil, "ActivityStupidLayer/btn_gift.png", var_0_1)

	var_21_1:setPosition(cc.p(580, self.titleSprite:getPositionY() - 175))
	var_21_1:setName("btn_gift")
	self.rootLayer:addChild(var_21_1)

	self.share_di = ccui.Button:create("ActivityStupidLayer/btn_share.png", nil, "ActivityStupidLayer/btn_share.png", var_0_1)

	self.share_di:setPosition(cc.p(580, self.titleSprite:getPositionY() - 50))
	self.share_di:setVisible(false)
	self.rootLayer:addChild(self.share_di)
	...
	local function var_21_2()
		local var_23_0 = RoleDefault:getInstance():getIntegerForKey("shareReddotTime", 0)

		if var_23_0 and time_check_manager:getCurTime() < var_23_0 then
			return
		end

		global_add_alert_tag(self.share_di, {
			x = self.share_di:getContentSize().width / 2 + 40,
			y = self.share_di:getContentSize().height / 2 + 55
		})
	end
	...
	local function var_21_3()
		...
		self.share_di:addTouchEventListener(function(arg_25_0, arg_25_1)
			...
			local var_25_0 = arg_25_0:getChildByName("reddot")

			if var_25_0 then
				var_25_0:setVisible(false)
			end

			local var_25_1 = os.date("*t", (time_check_manager:getCurTime()))
			local var_25_2 = RoleDefault:getInstance():setIntegerForKey("shareReddotTime", (os.time({
				hour = 23,
				min = 59,
				sec = 59,
				year = var_25_1.year,
				month = var_25_1.month,
				day = var_25_1.day
			})))
		end)
	end

	share_manager:get_activity_share_data(18, function(arg_26_0, arg_26_1)
		if arg_26_0 == 1 then
			if config.packagechannel == "feiyu" then
				if arg_26_1.url:find(".jpg$") or arg_26_1.url:find(".png$") then
					local var_26_0 = FeiyuManager.getSDKVersion and FeiyuManager.getSDKVersion() or nil

					if var_26_0 and tonumber(var_26_0) >= 2 then
						var_21_3()
					end
				else
					var_21_3()
...
function ActivityStupidLayer:updatebuyGiftBtn()
	self.rootLayer:getChildByName("btn_gift"):addTouchEventListener(function(arg_28_0, arg_28_1)
		...
		var_28_0.layerName = "MarketLayer"
		var_28_0.initparam = {
			singleMarket = "1-10801",
			returnLayer = "ActivityStupidLayer"
		}
...
function ActivityStupidLayer.getActivityShopitem(arg_29_0)
	activity_manager:getActivityObj(108):get_activity_shopitem(function(arg_30_0, arg_30_1)
		arg_29_0.shopitem = arg_30_1

		arg_29_0:updatebuyGiftBtn()
	end)
end

function ActivityStupidLayer:showShopPop()
	...
	var_31_0:setPosition(cc.p(cc.Director:getInstance():getVisibleSize().width / 2, cc.Director:getInstance():getVisibleSize().height / 2 - GameDisplay.fix_y))
	var_31_0:setBackGroundColorType(ccui.LayoutBackGroundColorType.solid)
	var_31_0:setBackGroundColor(cc.c3b(0, 0, 0))
	var_31_0:setBackGroundColorOpacity(180)
	self:addChild(var_31_0, 10)

	local var_31_1 = ccui.ImageView:create("mainScenebg/market/" .. item_data[self.shopitem.itemtype].image_id .. ".png")

	var_31_1:setPosition(cc.p(var_31_0:getContentSize().width / 2, var_31_0:getContentSize().height / 2))
	var_31_0:addChild(var_31_1)

	local var_31_2 = ccui.Layout:create()

	var_31_2:setContentSize(cc.size(var_31_1:getContentSize().width, 30))
	var_31_2:setAnchorPoint(cc.p(0.5, 0.5))
	var_31_2:setPosition(cc.p(var_31_1:getContentSize().width / 2, -var_31_2:getContentSize().height / 2))
	var_31_2:setBackGroundColorType(ccui.LayoutBackGroundColorType.solid)
	var_31_2:setBackGroundColor(cc.c3b(0, 0, 0))
	var_31_2:setBackGroundColorOpacity(220)
	var_31_1:addChild(var_31_2, 10)

	local var_31_3 = cc.Label:createWithTTF(item_data[self.shopitem.itemtype].name, FONT_DES, 22)

	var_31_3:setPosition(cc.p(var_31_2:getContentSize().width / 2, var_31_2:getContentSize().height / 2))
	var_31_2:addChild(var_31_3)

	local var_31_4 = ccui.ImageView:create("public/currency/UI_battleEnd_diamond.png", var_0_1)

	var_31_4:setPositionX(var_31_1:getContentSize().width / 2 - 20)
	var_31_4:setPositionY(-150)
	var_31_1:addChild(var_31_4)

	local var_31_5 = cc.Label:createWithTTF(self.shopitem.discount, FONT_DES, 23)

	var_31_5:setAnchorPoint(cc.p(0, 0.5))
	var_31_5:setPositionX(var_31_4:getPositionX() + var_31_4:getContentSize().width / 2 + 5)
	var_31_5:setPositionY(var_31_4:getPositionY())
	var_31_1:addChild(var_31_5)

	local var_31_6 = ccui.Button:create("public/button/public_button_big_y.png", nil, "public/button/public_button_big_y.png", var_0_1)
	local var_31_7 = cc.Label:createWithTTF(L_BUTTON_TEXT.Buy, FONT_BUTTON, 26)

	var_31_7:setColor(cc.c3b(12, 12, 12))
	var_31_6:setScale9Enabled(true)
	var_31_6:setCapInsets(cc.rect(90, 30, 20, 20))
	var_31_6:setContentSize(cc.size(500, var_31_6:getContentSize().height))
	var_31_6:setPosition(cc.p(var_31_1:getContentSize().width / 2, -100))
	var_31_7:setPosition(cc.p(var_31_6:getContentSize().width / 2, var_31_6:getContentSize().height / 2))
	var_31_6:addChild(var_31_7)
	var_31_1:addChild(var_31_6)
	var_31_6:addTouchEventListener(function(arg_32_0, arg_32_1)
		if arg_32_1 ~= ccui.TouchEventType.ended then
			return
		end

		self:ShopSlider(arg_32_0, arg_32_1, function()
			var_31_1:runAction(cc.Sequence:create(cc.ScaleTo:create(0.2, 1, 0), cc.CallFunc:create(function()
				var_31_0:runAction(cc.RemoveSelf:create())
			end)))
		end)
	end)
	var_31_1:setScaleY(0)
	var_31_1:runAction(cc.ScaleTo:create(0.2, 1))
	var_31_0:addTouchEventListener(function(arg_35_0, arg_35_1)
		var_31_1:runAction(cc.Sequence:create(cc.ScaleTo:create(0.2, 1, 0), cc.CallFunc:create(function()
			var_31_0:runAction(cc.RemoveSelf:create())
		end)))
	end)
...
function ActivityStupidLayer:ShopSlider(arg_37_1, arg_37_2, arg_37_3)
	if arg_37_2 ~= ccui.TouchEventType.ended then
		return
	end

	arg_37_1:setTouchEnabled(false)
	shop_manager:shop_buy(shop_data[self.shopitem.shopid].shop_type, self.shopitem.shopid, function(arg_38_0)
		if arg_38_0 == 1 then
...
function ActivityStupidLayer.openGift(arg_39_0, arg_39_1)
	network:rpc("use_gift_bag", {
		...
		if arg_40_0.result == 1 then
			...
			item_manager:deleteItem(arg_39_1, 1)
			global_gain(arg_40_0)
			arg_39_0:updateToolsNum()
		else
...
function ActivityStupidLayer:twistcost(arg_41_1, arg_41_2)
	local var_41_0 = self.twist_type_to_index[arg_41_2]
	local var_41_1 = self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype

	if arg_41_1 == var_0_26 then
		self:updateTwistCount(arg_41_2, 1)

		if arg_41_2 == var_0_28 then
			self.freetime = self.freetime - 1
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].dailyfreeforone and self.curtwistDate[self.twist_type_to_index[arg_41_2]].dailyfreeforone > 0 then
			self.curtwistDate[self.twist_type_to_index[arg_41_2]].dailyfreeforone = self.curtwistDate[self.twist_type_to_index[arg_41_2]].dailyfreeforone - 1
			var_41_1 = var_0_29
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].totalfreeforone and self.curtwistDate[self.twist_type_to_index[arg_41_2]].totalfreeforone > 0 then
			self.curtwistDate[self.twist_type_to_index[arg_41_2]].totalfreeforone = self.curtwistDate[self.twist_type_to_index[arg_41_2]].totalfreeforone - 1
			var_41_1 = var_0_29
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype > 2 then
			item_manager:deleteItem(self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype, self.curtwistDate[self.twist_type_to_index[arg_41_2]].costone)
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype == var_0_30 then
			playermodel.gold = playermodel.gold - self.curtwistDate[var_41_0].costone

			global_update_gold_stone_diamond(playermodel.gold)
			AnalyticManager.twistCostSuccess(self.curtwistDate[var_41_0].costone)
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype == var_0_31 then
			playermodel.diamond = playermodel.diamond - self.curtwistDate[var_41_0].costone

			global_update_gold_stone_diamond(nil, nil, 1)
			AnalyticManager.twistCostSuccess(nil, self.curtwistDate[var_41_0].costone, 1)
		end

		AnalyticManager.twist_one_success({
			twisttype = arg_41_2,
			cost_type = var_41_1,
			cost_num = var_41_1 == var_0_29 and 1 or self.curtwistDate[var_41_0].costone
		})
	...
	elseif arg_41_1 == var_0_27 then
		self:updateTwistCount(arg_41_2, 10)

		if arg_41_2 == var_0_28 then
			self.freetime = self.freetime - 10
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].dailyfreeforten and self.curtwistDate[self.twist_type_to_index[arg_41_2]].dailyfreeforten > 0 then
			self.curtwistDate[self.twist_type_to_index[arg_41_2]].dailyfreeforten = self.curtwistDate[self.twist_type_to_index[arg_41_2]].dailyfreeforten - 1
			var_41_1 = var_0_29
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].totalfreeforten and self.curtwistDate[self.twist_type_to_index[arg_41_2]].totalfreeforten > 0 then
			self.curtwistDate[self.twist_type_to_index[arg_41_2]].totalfreeforten = self.curtwistDate[self.twist_type_to_index[arg_41_2]].totalfreeforten - 1
			var_41_1 = var_0_29
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype > 2 then
			item_manager:deleteItem(self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype, self.curtwistDate[self.twist_type_to_index[arg_41_2]].costten)
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype == var_0_30 then
			playermodel.gold = playermodel.gold - self.curtwistDate[var_41_0].costten

			global_update_gold_stone_diamond(playermodel.gold)
			AnalyticManager.twistCostSuccess(self.curtwistDate[var_41_0].costten)
		elseif self.curtwistDate[self.twist_type_to_index[arg_41_2]].costtype == var_0_31 then
			playermodel.diamond = playermodel.diamond - self.curtwistDate[var_41_0].costten

			global_update_gold_stone_diamond(nil, nil, 1)
			AnalyticManager.twistCostSuccess(nil, self.curtwistDate[var_41_0].costten, 10)
		end

		AnalyticManager.twist_ten_success({
			twisttype = arg_41_2,
			cost_type = var_41_1,
			cost_num = var_41_1 == var_0_29 and 1 or self.curtwistDate[var_41_0].costten
		})
...
function ActivityStupidLayer.updateCostInfo(arg_42_0)
	return
end

local var_0_33 = "mainScenebg/bg.jpg"
local var_0_34 = "mainScenebg/resultbg.jpg"
local var_0_35 = "spine/ui/twist/twist"
local var_0_36 = "spine/ui/twist/fangkuai"
local var_0_38 = cc.size(514, 815)
local var_0_42 = {
...
local function var_0_46()
	local var_43_0 = ccui.ImageView:create(var_0_42[1], var_0_1)
...
local function var_0_54(arg_50_0, arg_50_1)
	...
	if not var_50_0 then
		...
		var_50_0:setPosition(var_0_53[arg_50_1])
...
local function var_0_56(arg_51_0, arg_51_1)
	...
	if not var_51_0 then
		...
		var_51_0:setPosition(var_0_55[arg_51_1])
...
local function var_0_58(arg_52_0, arg_52_1)
	...
	if not var_52_0 then
		...
		var_52_0:setPosition(var_0_57[arg_52_1])
...
local var_0_59 = {
	[kITEM_HERO] = function(arg_53_0, arg_53_1)
		...
		var_53_4:loadTexture(var_0_42[var_53_5], var_0_1)
		...
		var_53_6:loadTexture(ATTRICONPATH[global_get_model_attr(servant_data[item_data[arg_53_1.dropid].servant].modelid)], var_0_1)
		...
		arg_53_0.resultAni:play(var_0_44[var_53_5][1], false)
		arg_53_0.resultAni:addAnimation(var_0_44[var_53_5][2])
		...
		if arg_53_0.lastTwistBlackCard == BLACK_CARD then
			var_53_9:loadTexture("TwistEgg/panel_blackcard_bg2.png", var_0_1)
			...
			var_53_9:loadTexture("TwistEgg/panel_blackcard_sp_bg2.png", var_0_1)
	...
	[kITEM_HORCRUX] = function(arg_58_0, arg_58_1)
		...
		var_58_2:loadTexture(var_0_42[var_58_3], var_0_1)
		...
		var_58_4:loadTexture(ATTRICONPATH[global_get_model_attr(horcrux_manager:getHorcruxModel(arg_58_1.entityid))], var_0_1)
		...
		for iter_58_0 = 1, 2 do
			var_58_9[iter_58_0] = var_0_54(arg_58_0, iter_58_0)
			var_58_10[iter_58_0] = var_0_56(arg_58_0, iter_58_0)
			var_58_11[iter_58_0] = var_0_58(arg_58_0, iter_58_0)

			if var_58_8[iter_58_0] then
				local var_58_12 = var_58_8[iter_58_0]

				var_58_9[iter_58_0]:loadTexture((total_skill_data[var_58_8[iter_58_0]].icon or nil) and ("skill_new/skill/" .. total_skill_data[var_58_12].icon .. ".png" or "public/rolebg/skill_frame_bg.png"), var_0_1)
				...
				var_58_9[iter_58_0]:loadTexture("public/rolebg/skill_frame_bg.png", var_0_1)
		...
		arg_58_0.resultAni:play(var_0_45[var_58_3][1] .. var_58_13, false)

		if var_58_13 == 1 then
			var_58_13 = ""
		end

		arg_58_0.resultAni:addAnimation(var_0_45[var_58_3][2] .. var_58_13)
...
local function var_0_60(arg_68_0)
...
function ActivityStupidLayer:show_twist_result(arg_71_1, arg_71_2, arg_71_3, arg_71_4)
...
local function var_0_63(arg_73_0)
...
local function var_0_64(arg_74_0)
...
local function var_0_65(arg_75_0)
	if item_data[arg_75_0].bag_item_type == kITEM_HERO then
		print(arg_75_0, item_data[arg_75_0].servant)
...
function ActivityStupidLayer:startTwistResultAni(arg_76_1, arg_76_2, arg_76_3, arg_76_4)
	self:cleanTwistRectPanel()
	self.resultBg:setTexture(var_0_34)
	...
	local function var_76_1(arg_77_0)
		...
		if not var_77_0 then
			var_77_0 = L2Skeleton:create(var_0_36 .. ".json", var_0_36 .. ".atlas", nil, true)
	...
	local function var_76_2(arg_78_0)
		return (item_data[arg_78_0].bag_item_type == kITEM_HERO and "role_" or "") .. (var_0_65(arg_78_0) and "red" or var_0_63(arg_78_0) and "orange" or var_0_64(arg_78_0) and "purple" or "blue")
	end
...
function ActivityStupidLayer:showTwistItemsInfoAni(arg_82_1, arg_82_2, arg_82_3, arg_82_4)
	self.resultBg:setTexture(var_0_33)
	...
	local var_82_0 = (function()
		return coroutine.create(function()
			for iter_84_0 = 1, #arg_82_2 do
				var_0_59(item_data[arg_82_2[iter_84_0].dropid].bag_item_type, self, arg_82_2[iter_84_0])
...
local var_0_68 = "TwistEgg/shine_frame.png"
local var_0_69 = "TwistEgg/purple_frame.png"
local var_0_70 = "TwistEgg/red_frame.png"
local var_0_71 = {
...
local var_0_72 = {
	[kITEM_HERO] = function(arg_87_0, arg_87_1)
		...
		local var_87_2 = ccui.ImageView:create(var_0_67[var_87_1], var_0_1)
		...
		local var_87_6 = ccui.ImageView:create(var_0_42[var_87_5], var_0_1)
		...
		local var_87_7 = ccui.ImageView:create(ATTRICONPATH[var_87_1], var_0_1)
		...
		if arg_87_0.dropnum > 2 then
			...
			local var_87_12 = ccui.ImageView:create("TwistEgg/light_img.png", var_0_1)
		...
		if var_87_13 then
			for iter_87_0 = 1, 2 do
				local var_87_14 = ccui.ImageView:create(var_87_13, var_0_1)
	...
	[kITEM_HORCRUX] = function(arg_89_0)
		...
		local var_89_4 = ccui.ImageView:create(var_0_67[var_89_3], var_0_1)
		...
		local var_89_8 = ccui.ImageView:create(var_0_42[var_89_7], var_0_1)
		...
		local var_89_9 = ccui.ImageView:create(ATTRICONPATH[var_89_3], var_0_1)
		...
		for iter_89_0 = 1, horcrux_manager:getHorcruxStarLevel(arg_89_0.entityid) do
			local var_89_10 = ccui.ImageView:create(var_0_43[1], var_0_1)
		...
		if var_89_7 > 2 then
			for iter_89_1 = 1, 2 do
				...
				if var_89_7 > 3 then
					var_89_11 = ccui.ImageView:create(var_0_68, var_0_1) or ccui.ImageView:create(var_0_69, var_0_1)
				end
	...
	[kITEM_DRAWING] = function(arg_90_0)
		local var_90_0 = ccui.ImageView:create(var_0_66[item_data[arg_90_0.dropid].equip_quality], var_0_1)
	...
	[kITEM_HORCRUX_DRAWING] = function(arg_91_0)
		local var_91_0 = ccui.ImageView:create(var_0_66[item_data[arg_91_0.dropid].equip_quality], var_0_1)
...
setmetatable(var_0_72, {
	__index = function(arg_92_0, arg_92_1)
		return function(arg_93_0)
			local var_93_0 = item_data[arg_93_0.dropid].equip_quality
			local var_93_1 = ccui.ImageView:create(var_0_66[item_data[arg_93_0.dropid].equip_quality], var_0_1)
...
function ActivityStupidLayer:showTwistFinalResult(arg_95_1, arg_95_2, arg_95_3, arg_95_4)
	self.skipBnt:setVisible(false)
	...
	local function var_95_1(arg_96_0)
		...
		if not var_96_0 then
			var_96_0 = L2Skeleton:create(var_0_36 .. ".json", var_0_36 .. ".atlas", nil, true)
	...
	local function var_95_2()
		return coroutine.create(function()
			for iter_98_0 = 1, #arg_95_2 do
				...
				local var_98_6 = var_0_72(item_data[arg_95_2[iter_98_0].dropid].bag_item_type, arg_95_2[iter_98_0], self.twistBlackCard)
				...
				if var_0_65(var_98_8) then
					var_98_0:play("red-out", false)
				elseif var_0_63(var_98_8) then
					var_98_0:play("orange-out", false)
				elseif var_0_64(var_98_8) then
			...
			if arg_95_4 and arg_95_4 > 0 then
				...
				if self.lastTwistBlackCard == BLACK_CARD then
					self.twistingRectPanel:getChildByName("blackcardinfo"):loadTexture("TwistEgg/panel_blackcard_bg1.png", var_0_1)
					...
					self.twistingRectPanel:getChildByName("blackcardinfo"):loadTexture("TwistEgg/panel_blackcard_sp_bg1.png", var_0_1)
...
function ActivityStupidLayer:initShowResultPanel()
	self.skipBnt:setPositionY(self.skipBnt:getPositionY() - GameDisplay.fix_y)

	self.resultTouchEnabled = false
	self.resultBg = cc.Sprite:create(var_0_33)
	...
	self.resultAni = L2Skeleton:create(var_0_35 .. ".json", var_0_35 .. ".atlas", nil, true)
	...
	local var_105_0 = ccui.ImageView:create("TwistEgg/panel_blackcard_bg2.png", var_0_1)
	...
	local var_105_2 = ccui.ImageView:create("TwistEgg/panel_blackcard_bg1.png", var_0_1)
	...
	self.twistSureBtn = ccui.Button:create(var_0_71[1], var_0_71[2], var_0_71[1], var_0_1)
...
function ActivityStupidLayer:cleanTwistRectPanel()
	self.resultTouchEnabled = false
...
function ActivityStupidLayer:cleanShowResultPanelEvent()
	self.resultTouchEnabled = false
...
function ActivityStupidLayer.twist_one_result(arg_110_0, arg_110_1, arg_110_2)
	...
	network:rpc("add_twistegg_items", {
		...
		if arg_111_0.result == 1 then
			...
			arg_110_0:twistcost(var_0_26, arg_110_1, arg_111_0.twist_remain_count)
...
function ActivityStupidLayer.updateByBlackCard(arg_112_0)
	return
end

function ActivityStupidLayer.twist_ten_result(arg_113_0, arg_113_1, arg_113_2)
	autopop_manager:pauseAchievementPop()
	...
	network:rpc("add_twistegg_items_for_ten", {
		...
		if arg_114_0.result == 1 then
			...
			arg_113_0:twistcost(var_0_27, arg_113_1, arg_114_0.twist_remain_count)
		...
		elseif arg_114_0.result == 2 then
			arg_113_0:lackofcost(var_0_27, arg_113_1)
...
function ActivityStupidLayer:updateTwistCount(arg_115_1, arg_115_2)
...
function ActivityStupidLayer:twistcost(arg_116_1, arg_116_2, arg_116_3)
	...
	if arg_116_1 == var_0_26 then
		self:updateTwistCount(arg_116_2, 1)

		if arg_116_2 == var_0_28 then
			self.freetime = self.freetime - 1
		...
		elseif self.curtwistDate[self.twist_type_to_index[arg_116_2]].costtype == var_0_30 then
		...
		elseif self.curtwistDate[self.twist_type_to_index[arg_116_2]].costtype == var_0_31 then
		...
		AnalyticManager.twist_one_success({
			twisttype = arg_116_2,
			cost_type = var_116_1,
			cost_num = var_116_1 == var_0_29 and 1 or self.curtwistDate[var_116_0].costone
		})
	...
	elseif arg_116_1 == var_0_27 then
		...
		AnalyticManager.twist_ten_success({
			twisttype = arg_116_2,
			cost_type = var_116_1,
			cost_num = var_116_1 == var_0_29 and 1 or self.curtwistDate[var_116_0].costten
		})
	...
	if arg_116_3 then
		self:showTwistRemainCountLabel(arg_116_3)
	end

	self:updateCostInfo(arg_116_2)
...
function ActivityStupidLayer:lackofcost(arg_117_1, arg_117_2)
	...
	elseif var_117_0 == var_0_30 then
...
local function var_0_73(arg_121_0, arg_121_1, arg_121_2)
	local var_121_0 = {
		type_tbl = {}
	}
...
local function var_0_74(arg_122_0)
	local var_122_0 = {
		type_tbl = {}
	}

	for iter_122_0, iter_122_1 in pairs(arg_122_0) do
		if servant_data[item_data[iter_122_1].servant].roll_rarity == 5 then
			if not var_122_0[2] then
				var_122_0[2] = {
					attribute = 2,
					content = {}
				}
				var_122_0.type_tbl[2] = L_PLAYER_DATA_TYPE.Girls .. "-" .. L_SPECIAL_TYPE
			end

			table.insert(var_122_0[2].content, {
				itemid = iter_122_1
			})
		else
			if not var_122_0[1] then
				var_122_0[1] = {
					attribute = 1,
					content = {}
				}
				var_122_0.type_tbl[1] = L_PLAYER_DATA_TYPE.Girls
			end

			table.insert(var_122_0[1].content, {
				itemid = iter_122_1
			})
		end
	end
...
local function var_0_75(arg_123_0)
	local var_123_0 = {
		type_tbl = {}
	}
...
function ActivityStupidLayer.showTwistEggDrops(arg_125_0, arg_125_1, arg_125_2)
	twist_manager:set_twist_status(function(arg_126_0)
		local var_126_0 = {}
		local var_126_1 = {}
		local var_126_2 = {}
		...
		for iter_126_1, iter_126_2 in pairs(arg_126_0) do
			if iter_126_2.twisttype == arg_125_1 then
				...
				if iter_126_2.twisttype == 4 or iter_126_2.twisttype == 108 then
					var_126_0 = var_0_75(var_126_4)
					var_126_1 = var_0_73(drop_words_data[iter_126_2.twisttype], "type(%d+)_words(%d+)", "words_type(%d+)")
				else
					var_126_0 = var_0_74(var_126_4)
					var_126_1 = var_0_73(drop_words_data[iter_126_2.twisttype], "type(%d+)_words(%d+)", "words_type(%d+)")
				end
			end
		end
...
function ActivityStupidLayer:updateGoldPanel()
	if self.curtwistDate[self.curTwistIndex] and self.curtwistDate[self.curTwistIndex].costtype == 1 then
		-- block empty
	end
end

function ActivityStupidLayer:checkIsHaveFreeTimes(arg_130_1, arg_130_2)
...
function ActivityStupidLayer:checkBntsAlert(arg_131_1)
...
function ActivityStupidLayer:initGotoMarketBtn()
...
function ActivityStupidLayer.onGetNewHead(arg_137_0, arg_137_1, arg_137_2)
...
function ActivityStupidLayer.get_naive_stat(arg_141_0, arg_141_1, arg_141_2)
...
function ActivityStupidLayer:updateNaiveTwist(arg_142_1, arg_142_2)
	local bit = require("bit")
