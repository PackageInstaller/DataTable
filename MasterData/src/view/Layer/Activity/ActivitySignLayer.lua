ActivitySignLayer = class("ActivitySignLayer", function()
...
function ActivitySignLayer.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivitySignLayer.new()

	require("controller.texture_manager"):loadPopLayerTextures({
		"Activity_DaKaActivity"
	})
	var_2_0:init(arg_2_1)
	var_2_0:setName("ActivitySignLayer")

	return var_2_0
end

function ActivitySignLayer:init(arg_3_1)
	var_0_5 = true
	self.callback = arg_3_1.callback

	self:registerScriptHandler(function(arg_4_0)
		if arg_4_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivitySignLayer")
	...
	self.rootLayer = ccs.GUIReader:getInstance():widgetFromJsonFile(config._DEBUG and "Activity_Sign.json" or "Activity_Sign.ExportJson")
	...
	self.button_sure:addTouchEventListener(function(arg_6_0, arg_6_1)
		...
		self.activitySingCallback(function(arg_7_0)
			if arg_7_0 == 1 then
				self:activitySign()
...
function ActivitySignLayer:isCheckSignIn()
	local var_8_0 = false
...
local function var_0_7(arg_9_0)
	...
	if config._DEBUG then
		var_9_0 = cc.Sprite:create("Activity_DaKaActivity/item_bg.png") or cc.Sprite:createWithSpriteFrameName("Activity_DaKaActivity/item_bg.png")
	end

	var_9_0:setAnchorPoint(cc.p(0.5, 0.5))
	var_9_0:setScale(arg_9_0:getContentSize().width * 0.95 / var_9_0:getContentSize().width)
	var_9_0:setPosition(cc.p(arg_9_0:getContentSize().width / 2, arg_9_0:getContentSize().height / 2 + 2))
	arg_9_0:addChild(var_9_0)
end

function ActivitySignLayer:createSignBg()
	self.sign_bg:loadTexture("mainScenebg/activity/" .. self.otherData.path .. "/sign_bg.png")
	self.sign_bg:setPosition(cc.p(280, 585))
end

function ActivitySignLayer:createLimitTime()
	local var_11_0 = cc.Label:createWithTTF("", FONT_DES, 22)

	var_11_0:setAnchorPoint(cc.p(1, 0))
	var_11_0:setPosition(cc.p(540, 16))
	...
	if self.activityId == 2 then
		var_11_0:setVisible(false)
	end
end

function ActivitySignLayer.registerActivityEventListener(arg_12_0)
	activity_manager:registerEventListener("ActivitySignLayer", activity_manager.activityEventId.EXIT_FORM_PURCHASE_LAYER, function(arg_13_0)
...
function ActivitySignLayer:createAwards()
...
function ActivitySignLayer:getAwards()
...
function ActivitySignLayer:activitySign()
...
function ActivitySignLayer:exitCallback()
	LayerManager:removePopLayer(self.__queueindex)
end

function ActivitySignLayer:showAwardsDetails(arg_25_1, arg_25_2)
...
function ActivitySignLayer.fullScreen(arg_26_0, arg_26_1)
...
function ActivitySignLayer:exit()
	self:exitCallback()
end
