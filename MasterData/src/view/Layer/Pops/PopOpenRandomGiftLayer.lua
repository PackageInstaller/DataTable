PopOpenRandomGiftLayer = class("PopOpenRandomGiftLayer", function()
...
function PopOpenRandomGiftLayer.create(arg_2_0, arg_2_1)
	local var_2_0 = PopOpenRandomGiftLayer.new()
...
function PopOpenRandomGiftLayer:init(arg_3_1)
	self.extheight = 100
...
function PopOpenRandomGiftLayer:initUI(...)
	...
	self.sureBtn:setVisible(self.opentyp ~= var_0_10)
...
function PopOpenRandomGiftLayer:updateUI(...)
	local var_8_0
	...
	self.detailLabel:setString(L_RANDOM_LAYER_DES)
...
function PopOpenRandomGiftLayer:initData(...)
	self.dataList = {}
	self.curSelect = 1
	self.maxSelect = item_manager:getItemNumber(self.itemid)

	assert(item_data[self.itemid].mode_id, "itemid:" .. self.itemid .. "没有配置mode_id")

	local var_9_0 = drop_manager:getAllDropsNotMerge(item_data[self.itemid].mode_id)

	self.dataList = var_9_0

	print(dump(var_9_0))
end

function PopOpenRandomGiftLayer.getSurebtnHandler(arg_10_0, ...)
	return function(arg_11_0, arg_11_1)
		...
		network:rpc("use_gift_bag", {
			entityid = arg_10_0.itemid,
			num = arg_10_0.curSelect
		}, function(arg_12_0)
			if arg_12_0.result == 1 then
				item_manager:deleteItem(arg_10_0.itemid, num)
			...
			if item_manager:getItemNumber(arg_10_0.itemid) < 1 or arg_10_0.opentyp ~= var_0_9 then
				arg_10_0:exit()
			end
...
function PopOpenRandomGiftLayer.createSp(arg_13_0, ...)
	...
	var_13_1:addTouchEventListener(function(arg_14_0, arg_14_1)
		...
		if math.abs(arg_14_0:getTouchBeganPosition().y - arg_14_0:getTouchEndPosition().y) > 20 then
			return
		end
	...
	var_13_2:addTouchEventListener(function(arg_15_0, arg_15_1)
		...
		if math.abs(arg_15_0:getTouchBeganPosition().y - arg_15_0:getTouchEndPosition().y) > 20 then
			return
		end
	...
	function var_13_0:update(arg_16_1)
		...
		elseif arg_13_0.dataList[arg_16_1] then
			var_16_0 = arg_13_0.dataList[arg_16_1].dropid
			var_16_1 = arg_13_0.dataList[arg_16_1].dropNum
			var_16_2 = arg_13_0.dataList[arg_16_1].item_attr
		end
...
function PopOpenRandomGiftLayer:createTableView()
	self.listPanel = cc.TableView:create(cc.size(var_0_11, var_0_12))
	...
	self.listPanel:setPosition(cc.p(var_0_13, var_0_14))
	...
	self.listPanel:registerScriptHandler(function(arg_19_0, arg_19_1)
		...
		if not var_19_0 then
			...
			for iter_19_0 = 1, var_0_18 do
				local var_19_1 = self:createSp()

				var_19_1:setScale(var_0_19)
				var_19_1:setName("sp_" .. iter_19_0)
				var_19_1:setPosition(var_0_17[iter_19_0])
				var_19_0:addChild(var_19_1)
			end
		end

		for iter_19_1 = 1, var_0_18 do
			local var_19_2 = var_19_0:getChildByName("sp_" .. iter_19_1)

			if self.dataList[arg_19_1 * var_0_18 + iter_19_1] then
				var_19_2:setVisible(true)
				var_19_2:update(arg_19_1 * var_0_18 + iter_19_1)
			else
...
function PopOpenRandomGiftLayer:initBg(arg_22_1)
...
function PopOpenRandomGiftLayer:initProgress(...)
...
function PopOpenRandomGiftLayer:exit()
	self.hideActions.shrinkVertical(self, function()
		if self.exitcallback then
			self.exitcallback(0)
		end
