...
local ActivityMainLayer_576 = class("ActivityMainLayer_576", function(...)
...
function ActivityMainLayer_576:create(arg_2_1)
	local var_2_0 = ActivityMainLayer_576.new(arg_2_1)
...
function ActivityMainLayer_576:init(arg_3_1)
	self.rootLayer = ccui.Layout:create()

	self:addChild(self.rootLayer)
end

function ActivityMainLayer_576:playInEffect()
	return
end

function ActivityMainLayer_576:initOther(arg_5_1)
...
function ActivityMainLayer_576:initTwistChosee()
	...
	self.bg = ccui.ImageView:create("activitiesRes/activity576/main/twistChoseeBg_1.png")

	self.bg:setTouchEnabled(true)
	self.bg:setPosition(cc.p(320, 520 + GameDisplay.fix_y))
	self.twistChoseeLayer:addChild(self.bg)

	self.btn1 = ccui.Button:create("activitiesRes/activity576/main/twistChoseebtn1_1.png", nil, "activitiesRes/activity576/main/twistChoseebtn1_1.png")
	...
	self.btn1:addTouchEventListener(function(arg_10_0, arg_10_1)
		...
		var_10_1.jump_to_system = self.selectType == var_0_14 and 1800649 or 1800628

		var_10_0(var_10_1)
	end)

	self.btn2 = ccui.Button:create("activitiesRes/activity576/main/twistChoseebtn1_2.png", nil, "activitiesRes/activity576/main/twistChoseebtn1_2.png")
	...
	self.btn2:addTouchEventListener(function(arg_11_0, arg_11_1)
		...
		if global_get_time_by_date("2023-12-21 00:00:00") > time_check_manager:getCurTime() then
			global_ShowBlockWords("12月21日热更新后开启")
		...
		var_11_1.jump_to_system = self.selectType == var_0_14 and 1800665 or 1800665

		var_11_0(var_11_1)
	end)
end

function ActivityMainLayer_576:updateTwistChosee()
	self.bg:loadTexture("activitiesRes/activity576/main/twistChoseeBg_" .. self.selectType .. ".png")
	self.btn1:loadTextures("activitiesRes/activity576/main/twistChoseebtn" .. self.selectType .. "_1.png", nil, "activitiesRes/activity576/main/twistChoseebtn" .. self.selectType .. "_1.png")
	self.btn2:loadTextures("activitiesRes/activity576/main/twistChoseebtn" .. self.selectType .. "_2.png", nil, "activitiesRes/activity576/main/twistChoseebtn" .. self.selectType .. "_2.png")
