ActivityLevel_180 = class("ActivityLevel_180", function()
...
function ActivityLevel_180.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityLevel_180.new()
...
function ActivityLevel_180:init(arg_3_1)
	...
	activity_manager:get_activity_level_info(180)
	self:registerScriptHandler(function(arg_4_0)
		if arg_4_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivityLevel_180")
		end
	end)
end

function ActivityLevel_180.registerActivityEventListener(arg_5_0)
	activity_manager:registerEventListener("ActivityLevel_180", activity_manager.activityEventId.ACTIVITY_LEVEL_INFO_UPDATE, function(arg_6_0)
		arg_5_0:upDateUI(arg_6_0)
	end)
end

function ActivityLevel_180:initUI()
	self:initBtnReturn()
	self:initTitle()
	self:initPanelBook()
	self:initPanelBuff()
...
function ActivityLevel_180:initBtnReturn()
	...
	var_8_0:addTouchEventListener(function(arg_10_0, arg_10_1)
		...
		if arg_10_1 ~= ccui.TouchEventType.ended then
			...
			var_10_0 = {
				surecallback = function()
					activity_manager:add_activity_level_time(180)
				end
			}
			var_10_1 = {
		...
		var_10_1.des = string.format(L_ACTIVITY_ADV_2, (activity_manager:get_activity_level_buy_time_cost(180)))
...
function ActivityLevel_180:initTitle()
	...
	self.btnDetail:addTouchEventListener(function(arg_13_0, arg_13_1)
		...
		LayerManager:pushInLayer("PopActivityDetail", {
			key = "ActivityLevel_180"
		})
	end)
end

function ActivityLevel_180:initPanelBook()
	...
	var_14_0:addTouchEventListener(function(arg_15_0, arg_15_1)
		...
		assert(activity_main_conf[180], "activityMainConf 没填 " .. 180)
...
function ActivityLevel_180:initPanelBuff()
...
function ActivityLevel_180:upDateUI(arg_18_1)
	self.lblFightNum:setString(L_ACTIVITY_LEVEL_NUM .. arg_18_1.less_fight .. "/6")
	self.lblFightNum:setFontSize(26)

	local var_18_0, var_18_1, var_18_2 = activity_manager:get_cur_activity_technology(180)

	self.lblCurnum:setString(item_manager:getItemNumber(18002001))
	...
	for iter_18_0 = 1, 7 do
		...
		if iter_18_0 > arg_18_1.cur_level then
			var_18_3:loadTextures("ActivityLevel_180/level_lock.png", nil, "ActivityLevel_180/level_lock.png", var_0_4)
		else
			var_18_3:loadTextures("ActivityLevel_180/level.png", nil, "ActivityLevel_180/level.png", var_0_4)
		end
		...
		var_18_3:addTouchEventListener(function(arg_19_0, arg_19_1)
			...
			RoleDefault:getInstance():setIntegerForKey("AdventureEnterIndex", 1800)
