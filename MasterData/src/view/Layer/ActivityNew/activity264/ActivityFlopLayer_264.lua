ActivityFlopLayer_291 = class("ActivityFlopLayer_291", function()
...
function ActivityFlopLayer_291.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_291.new()
...
function ActivityFlopLayer_291:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_291:updateChampionTipLabel()
...
function ActivityFlopLayer_291:fullScreen()
...
function ActivityFlopLayer_291:initOther()
...
function ActivityFlopLayer_291.updateSkin(arg_8_0, arg_8_1, arg_8_2)
	return
end
