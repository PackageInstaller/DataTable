ActivityLevel_205 = class("ActivityLevel_205", function()
...
function ActivityLevel_205.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityLevel_205.new()
...
function ActivityLevel_205:init(arg_3_1)
	self.rootLayer = ccs.GUIReader:getInstance():widgetFromJsonFile(config._DEBUG and "ActivityLevel_180.json" or "ActivityLevel_180.ExportJson")

	self:addChild(self.rootLayer)
	self:initUI()
	self:registerActivityEventListener()
	activity_manager:get_activity_level_info(199)
	self:registerScriptHandler(function(arg_4_0)
		if arg_4_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivityLevel_205")
		end
	end)
end

function ActivityLevel_205.registerActivityEventListener(arg_5_0)
	activity_manager:registerEventListener("ActivityLevel_205", activity_manager.activityEventId.ACTIVITY_LEVEL_INFO_UPDATE, function(arg_6_0)
		arg_5_0:upDateUI(arg_6_0)
	end)
end

function ActivityLevel_205:initUI()
	self:initBtnReturn()
	self:initTitle()
	self:initPanelBook()
	self:initPanelBuff()
...
function ActivityLevel_205:initBtnReturn()
	...
	var_8_0:addTouchEventListener(function(arg_10_0, arg_10_1)
		...
		if arg_10_1 ~= ccui.TouchEventType.ended then
			...
			var_10_0 = {
				surecallback = function()
					activity_manager:add_activity_level_time(199)
				end
			}
			var_10_1 = {
		...
		var_10_1.des = string.format(L_ACTIVITY_ADV_2, (activity_manager:get_activity_level_buy_time_cost(199)))
		var_10_0.labels = var_10_1

		LayerManager:pushInLayer("PopDoLayer", var_10_0)
	end)
	ccui.Helper:seekWidgetByName(self.rootLayer, "role"):loadTexture("ActivityLevel_205/role.png", var_0_4)
end

function ActivityLevel_205:initTitle()
	...
	self.btnDetail:addTouchEventListener(function(arg_13_0, arg_13_1)
		...
		LayerManager:pushInLayer("PopActivityDetail", {
			key = "ActivityLevel_205"
		})
	end)
end

function ActivityLevel_205:initPanelBook()
	local var_14_0 = self.rootLayer:getChildByName("panel_book")

	self.lblCurnum = var_14_0:getChildByName("lbl_num")

	var_14_0:setTouchEnabled(true)
	var_14_0:setPositionY(var_14_0:getPositionY() - GameDisplay.fix_y)
	var_14_0:loadTexture("ActivityLevel_205/btn_book.png", var_0_4)
	var_14_0:addTouchEventListener(function(arg_15_0, arg_15_1)
		...
		assert(activity_main_conf[199], "activityMainConf 没填 " .. 199)
		assert(activity_main_conf[var_15_0].into_shop, "activityMainConf " .. var_15_0 .. " 没填into_shop")

		if string.find(activity_main_conf[var_15_0].into_shop, ",") then
			for iter_15_0, iter_15_1 in pairs(split(activity_main_conf[var_15_0].into_shop, ",")) do
		...
		do
			var_15_1[1] = "1-" .. tonumber(activity_main_conf[var_15_0].into_shop) % 1500000
			var_15_2 = {
...
function ActivityLevel_205:upDateUI(arg_18_1)
	self.lblFightNum:setString(L_ACTIVITY_LEVEL_NUM .. arg_18_1.less_fight .. "/6")
	self.lblFightNum:setFontSize(26)

	local var_18_0, var_18_1, var_18_2 = activity_manager:get_cur_activity_technology(199)

	self.lblCurnum:setString(item_manager:getItemNumber(19902001))
	...
	for iter_18_0 = 1, 7 do
		...
		if iter_18_0 > arg_18_1.cur_level then
			var_18_3:loadTextures("ActivityLevel_205/level_lock.png", nil, "ActivityLevel_205/level_lock.png", var_0_4)
		else
			var_18_3:loadTextures("ActivityLevel_205/level.png", nil, "ActivityLevel_205/level.png", var_0_4)
		end
		...
		var_18_3:addTouchEventListener(function(arg_19_0, arg_19_1)
			...
			RoleDefault:getInstance():setIntegerForKey("AdventureEnterIndex", 1990)
