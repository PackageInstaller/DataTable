ActivityFlopLayer_227 = class("ActivityFlopLayer_227", function()
...
function ActivityFlopLayer_227.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_227.new()
...
function ActivityFlopLayer_227:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_227:initDrawBg()
...
function ActivityFlopLayer_227:updateChampionTipLabel()
	if not self.itemShade:getChildByName("tip") then
		...
		var_5_0:setName("tip")
		var_5_0:setPosition(cc.p(5, self.itemShade:getContentSize().height / 2))
		self.itemShade:addChild(var_5_0)
	end
end

function ActivityFlopLayer_227:fullScreen()
...
function ActivityFlopLayer_227:initOther()
...
function ActivityFlopLayer_227.updateSkin(arg_9_0, arg_9_1, arg_9_2)
	return
end
