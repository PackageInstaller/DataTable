ActivityFlopLayer_217 = class("ActivityFlopLayer_217", function()
...
function ActivityFlopLayer_217.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_217.new()
...
function ActivityFlopLayer_217:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_217:initDrawBg()
...
function ActivityFlopLayer_217:updateChampionTipLabel()
...
function ActivityFlopLayer_217:fullScreen()
...
function ActivityFlopLayer_217:initOther()
...
function ActivityFlopLayer_217.updateSkin(arg_9_0, arg_9_1, arg_9_2)
	return
end
