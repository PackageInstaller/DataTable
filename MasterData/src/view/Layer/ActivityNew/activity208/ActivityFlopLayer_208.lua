ActivityFlopLayer_208 = class("ActivityFlopLayer_208", function()
...
function ActivityFlopLayer_208.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_208.new()
...
function ActivityFlopLayer_208:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_208:initDrawBg()
	local var_4_0 = ccui.ImageView:create(self.texturePath .. "champion_bg1.png", var_0_5)

	var_4_0:setAnchorPoint(cc.p(0.5, 0))
	var_4_0:setPosition(cc.p(self.rootLayer:getContentSize().width / 2 - 200, 790))
...
function ActivityFlopLayer_208:updateChampionTipLabel()
...
function ActivityFlopLayer_208:fullScreen()
	...
	self.Title:setPositionY(self.bigRole:getPositionY() - self.bigRole:getContentSize().height / 2 + 220)
...
function ActivityFlopLayer_208:initOther()
...
function ActivityFlopLayer_208.updateSkin(arg_9_0, arg_9_1, arg_9_2)
	return
end
