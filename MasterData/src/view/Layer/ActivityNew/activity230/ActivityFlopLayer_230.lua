ActivityFlopLayer_230 = class("ActivityFlopLayer_230", function()
...
function ActivityFlopLayer_230.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_230.new()
...
function ActivityFlopLayer_230:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_230:initDrawBg()
...
function ActivityFlopLayer_230:updateChampionTipLabel()
...
function ActivityFlopLayer_230:fullScreen()
...
function ActivityFlopLayer_230:initOther()
...
function ActivityFlopLayer_230.updateSkin(arg_9_0, arg_9_1, arg_9_2)
	return
end
