local ActivityMainLayer_170 = class("ActivityMainLayer_170", function(...)
...
function ActivityMainLayer_170:create(arg_2_1)
	local var_2_0 = ActivityMainLayer_170.new(arg_2_1)
...
function ActivityMainLayer_170:init(arg_3_1)
	self.rootLayer = ccui.Layout:create()

	self:addChild(self.rootLayer)
end

function ActivityMainLayer_170:initOther()
