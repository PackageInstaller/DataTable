local ActivityMainLayer_202 = class("ActivityMainLayer_202", function(...)
...
function ActivityMainLayer_202:create(arg_2_1)
	local var_2_0 = ActivityMainLayer_202.new(arg_2_1)
...
function ActivityMainLayer_202:init(arg_3_1)
	self.rootLayer = ccui.Layout:create()

	self:addChild(self.rootLayer)
end

function ActivityMainLayer_202:initOther()
