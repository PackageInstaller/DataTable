ActivityLevel_199 = class("ActivityLevel_199", function()
...
function ActivityLevel_199.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityLevel_199.new()
...
function ActivityLevel_199:init(arg_3_1)
	...
	self:registerScriptHandler(function(arg_4_0)
		if arg_4_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivityLevel_199")
		end
	end)
end

function ActivityLevel_199.registerActivityEventListener(arg_5_0)
	activity_manager:registerEventListener("ActivityLevel_199", activity_manager.activityEventId.ACTIVITY_LEVEL_INFO_UPDATE, function(arg_6_0)
		arg_5_0:upDateUI(arg_6_0)
	end)
end

function ActivityLevel_199:initUI()
	self:initBtnReturn()
	self:initTitle()
	self:initPanelBook()
	self:initPanelBuff()
...
function ActivityLevel_199:initBtnReturn()
	...
	ccui.Helper:seekWidgetByName(self.rootLayer, "role"):loadTexture("ActivityLevel_199/role.png", var_0_4)
end

function ActivityLevel_199:initTitle()
	...
	self.btnDetail:addTouchEventListener(function(arg_13_0, arg_13_1)
		...
		LayerManager:pushInLayer("PopActivityDetail", {
			key = "ActivityLevel_199"
		})
	end)
end

function ActivityLevel_199:initPanelBook()
	...
	var_14_0:loadTexture("ActivityLevel_199/btn_book.png", var_0_4)
...
function ActivityLevel_199:upDateUI(arg_18_1)
	...
	for iter_18_0 = 1, 7 do
		...
		if iter_18_0 > arg_18_1.cur_level then
			var_18_3:loadTextures("ActivityLevel_199/level_lock.png", nil, "ActivityLevel_199/level_lock.png", var_0_4)
		else
			var_18_3:loadTextures("ActivityLevel_199/level.png", nil, "ActivityLevel_199/level.png", var_0_4)
		end
