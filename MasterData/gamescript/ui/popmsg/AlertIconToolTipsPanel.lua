...
local AlertIconToolTipsPanel, Super = System.NewClass("AlertIconToolTipsPanel", UIBasePanel)
AlertIconToolTipsPanel.uiResCls = UI_Common_Popup_Tips_6Resource
local MAXHEIGHT = 720
local MINHEIGHT = 90

function AlertIconToolTipsPanel:ctor(data, rootGameObject, isSchoolEffectTip)
  Super.ctor(self)
  self.data = data
...
function AlertIconToolTipsPanel:OnBind(binder)
  self.binder = binder
  ...
  binder:SetActive(self.ui.DescView, false)
...
function AlertIconToolTipsPanel:ResetPos()
...
function AlertIconToolTipsPanel:SetRendered(isRendered)
...
function AlertIconToolTipsPanel:AdjustPosition()
...
function AlertIconToolTipsPanel:GetRootPosition()
...
function AlertIconToolTipsPanel:_AdjustByWorldPosition()
...
function AlertIconToolTipsPanel:Close()
  Super.Close(self)
end

return AlertIconToolTipsPanel
