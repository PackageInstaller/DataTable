local BackTrackAwardPreviewUtil = {}

function BackTrackAwardPreviewUtil.BackTrackAwakerLv(awakerData)
  local itemList = {}
  ...
  for i = 1, #requireItemList, 2 do
    ...
    local changeData = BackTrackAwardPreviewUtil.GetItemDataByTransform(itemId, cnt)
    table.insert(itemList, changeData)
  end
  return itemList
end

function BackTrackAwardPreviewUtil.BackTrackAwakerBreakthrough(awakerData)
  local itemList = {}
  local awakerId = awakerData.tid
  ...
  for i = 1, star do
    ...
    local changeData = BackTrackAwardPreviewUtil.GetItemDataByTransform(mtrlCostToNextStar.id, mtrlCostToNextStar.count)
    table.insert(itemList, changeData)
  end
  return itemList
end

function BackTrackAwardPreviewUtil.BackTrackAwakerPotency(awakerData)
end

function BackTrackAwardPreviewUtil.GetItemDataByTransform(itemId, cnt)
  local ratio = 1
...
return BackTrackAwardPreviewUtil
