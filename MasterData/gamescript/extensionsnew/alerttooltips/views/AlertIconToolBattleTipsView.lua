local AlertIconToolBattleTipsView, Super = NewClass("AlertIconToolBattleTipsView", BaseView)
AlertIconToolBattleTipsView.uiResCls = UI_Common_Popup_Tips_6Resource

function AlertIconToolBattleTipsView:ctor(data, rootGameObject, isSchoolEffectTip)
  Super.ctor(self)
  self.data = data
...
function AlertIconToolBattleTipsView:SetRendered(isRendered)
...
function AlertIconToolBattleTipsView:_SetTipsContent()
...
function AlertIconToolBattleTipsView:_ResetPos()
