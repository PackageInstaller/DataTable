-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/aounity-framework/Scripts/Lua/bootstrap/core/string.lua
...
function string.formatnumberthousands(num)
	...
	repeat
		local var_20_0, var_20_1 = string.gsub(formatted, "^(-?%d+)(%d%d%d)", "%1,%2")
