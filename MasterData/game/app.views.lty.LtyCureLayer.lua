...
local LtyCureLayer = class("LtyCureLayer", UIBase)

function LtyCureLayer:ctor(params)
  UIBase.ctor(self, uiData, params)
end

function LtyCureLayer:init(params)
...
function LtyCureLayer:initHeroInfo()
...
function LtyCureLayer:initCost()
...
function LtyCureLayer:getCureCost(num)
  local cureCount = game.role.cureCount
...
function LtyCureLayer:showData()
  self:initCost()
end
