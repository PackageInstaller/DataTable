...
local logicalData = {}
local TopBar = class("TopBar", UIBase)

function TopBar:ctor(params)
  UIBase.ctor(self, uiData, params)
end

function TopBar:init(params)
...
function TopBar:showSkin()
  ...
  local nodeBg = "ui/global/top_bar_bg.png"
  local systemBg = "ui/global/system_bg.png"
  local sysBtnRes = "ui/global/system.png"
  if game.role.homeBgTag == 6 then
    nodeBg = "ui/home/lty/top_bar_bg.png"
    systemBg = "ui/home/lty/system_bg.png"
    sysBtnRes = "ui/home/lty/system.png"
  elseif game.role.homeBgTag == 42 then
    nodeBg = "ui/home/fouryear/top_bar_bg.png"
    systemBg = "ui/home/fouryear/system_bg.png"
    sysBtnRes = "ui/home/fouryear/system.png"
  end
  self.nodeBg:setTexture(nodeBg)
  self.systemBg:setTexture(systemBg)
  self.sysBtn:loadTextureNormal(sysBtnRes, ccui.TextureResType.localType)
  self.sysBtn:loadTexturePressed(sysBtnRes, ccui.TextureResType.localType)
  self:showPendants()
end

function TopBar:showPendants()
...
function TopBar:setDiamond(value)
...
function TopBar:moveOut(skipTopAngle)
...
function TopBar:moveIn(skipTopAngle)
...
function TopBar:getBackBtn()
  return self.backBtn
end

function TopBar:showAnimation(sign, time, delay, skipTopAngle)
  time = time or 0.5
  delay = delay or 0
  if sign then
    UIHelper.MoveToDown({
...
function TopBar:hideElements(elements)
...
function TopBar:showElements(elements)
  for _, name in ipairs(elements) do
...
function TopBar:show(type, text, showBg)
  ...
  self.xPos = type == 3 and 784 or 650
  if UIHelper.isiPhoneX() then
