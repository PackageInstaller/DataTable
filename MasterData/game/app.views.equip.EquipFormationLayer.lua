...
local EquipFormationLayer = class("EquipFormationLayer", UIBase)

function EquipFormationLayer:ctor(params)
  UIBase.ctor(self, uiData, params)
end

function EquipFormationLayer:init(params)
...
function EquipFormationLayer:showBtns()
...
function EquipFormationLayer:showInfo()
  for _, data in pairs(self.card) do
    data.card:showEquips()
  end
end

function EquipFormationLayer:cardAnimation(card, slot)
  card:hide()
  local node = self["cardNode" .. slot]
