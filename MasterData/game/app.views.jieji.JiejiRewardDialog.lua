...
local uiData = {
  csbFile = "ui/jieji/JiejiRewardDialog.csb",
  mask = true,
  maskClick = true,
  popup = true,
  widgets = {
...
function JiejiRewardDialog:createCell(id, count)
  ...
  local str = string.format("<div shadow=0,-2,0.5,%s outline=1,%s >%s</div>", color_inactive, color_inactive, itemData.name .. "*" .. count)
  MRichText.new({
    text = str,
    size = 16,
