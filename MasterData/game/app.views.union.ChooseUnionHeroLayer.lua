...
local ChooseUnionHeroLayer = class("ChooseUnionHeroLayer", UIBase)

function ChooseUnionHeroLayer:ctor(params)
  UIBase.ctor(self, uiData, params)
end

function ChooseUnionHeroLayer:init(params)
  ...
  self.chooseList = {}
  self.unChooseList = {}
  self.formatInfo = json.decode(game.role.activityStatus["89"].formatInfo or {})
  for i = 2, 3 do
...
function ChooseUnionHeroLayer:refreshContent()
...
function ChooseUnionHeroLayer:loadPage(topRow, buttomRow)
...
function ChooseUnionHeroLayer:loadList(row)
...
function ChooseUnionHeroLayer:createCard(curRow, heroId, index)
  local card
  if heroId == 0 then
...
function ChooseUnionHeroLayer:choose(heroId, card)
  if not self.multiChoose then
...
function ChooseUnionHeroLayer:checkFormationSlot()
...
function ChooseUnionHeroLayer:calculateFormatSlot()
...
function ChooseUnionHeroLayer:checkFormationSameHero(heroId)
  for index, data in ipairs(self.formatList) do
...
function ChooseUnionHeroLayer:checkChangeCountFull()
  return table.nums(self.chooseList) >= self.max
end

function ChooseUnionHeroLayer:findSlotById(heroId)
  for index, data in ipairs(self.formatList) do
...
function ChooseUnionHeroLayer:setFilter(params)
  params = params or {}
