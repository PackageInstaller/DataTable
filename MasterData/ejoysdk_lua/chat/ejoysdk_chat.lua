...
function M.close()
  ...
  is_login_succ = false
  M.re_send_id = {}
  chat_base.close(CONSTANTS.CHAT_ERROR_CODES.CODE_MANUAL_CLOSE)
end
...
function M.set_session_attrs(session_attrs)
  do return chat_base.set_session_attrs, server.DESTINATION.PLAYER end
  return chat_base.set_session_attrs, server.DESTINATION.PLAYER, session_attrs
end
...
function CHAT_HANDLERS.info_offline(msg)
  ...
  is_login_succ = false
  chat_base.close(CONSTANTS.CHAT_ERROR_CODES.CODE_RPC_INFO_OFFLINE)
