...
function M:set_session_attr(session_attrs)
  do return self.impl.set_session_attr, self.impl end
  return self.impl.set_session_attr, self.impl, session_attrs
end

function M:send_images(session_id, picker_params, compress_params, image_process_fail_cb)
  self.impl:send_images(session_id, picker_params, compress_params, image_process_fail_cb)
end
