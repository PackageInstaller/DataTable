...
M.SERVICE = {
  ...
  GET_ACCOUNT_USERINFO = "account.get.userInfo",
  HAS_TARGET_ACCOUNT = "user.has.targetAccount",
  VALIDATE_LOGIN_AUTH_CODE = "app.validate.loginAuthCode",
  GET_LOGIN_AUTH_CODE = "app.gen.authCode.byToken"
}
M.SERVICE_TYPE = {
...
M.SERVICE_TYPE_MAPPING = {
  ...
  [M.SERVICE.GET_ACCOUNT_USERINFO] = M.SERVICE_TYPE.ACCOUNT_CENTER,
  [M.SERVICE.HAS_TARGET_ACCOUNT] = M.SERVICE_TYPE.ACCOUNT_CENTER,
  [M.SERVICE.VALIDATE_LOGIN_AUTH_CODE] = M.SERVICE_TYPE.ACCOUNT_CENTER,
  [M.SERVICE.GET_LOGIN_AUTH_CODE] = M.SERVICE_TYPE.ACCOUNT_CENTER,
