...
local pairs, type = pairs, _ENV.type
...
if _VERSION == "Lua 5.1" then
  ...
  f_string_esc_pat = "[\000-\031\"\\]"
end
local _ENV

local function newencoder()
  local v, nullv, i, builder, visited
  ...
  local function f_number(n)
    if n > tiny and n < huge then
  ...
  local f_string_subst = {
    ...
    __index = function(_, c)
      do return format, "\\u00%02X", byte(c) end
  ...
  function doencode(v)
    ...
    do return dispatcher[type(v)] end
