...
local logout_listener, user_id, auto_login, noone_meta_config, had_h5_login_result
...
local function show_h5_login()
  ...
  E.WebView.open(url, {
    ...
    if UTILS.STR.is_empty(user_id) or nil == had_h5_login_result then
