...
function M.openURLUpdateApp(url, opts)
  if _ejoysdk.os() == "harmonyos" then
    opts = opts or {}
    local harmony_need_go_market_delay
    if opts.harmony_need_go_market_delay == nil then
      harmony_need_go_market_delay = true
    else
      harmony_need_go_market_delay = opts.harmony_need_go_market_delay
    end
    E.LOG.debug(TAG, "openURLUpdateApp harmony_need_go_market_delay : " .. tostring(harmony_need_go_market_delay))
    if harmony_need_go_market_delay then
