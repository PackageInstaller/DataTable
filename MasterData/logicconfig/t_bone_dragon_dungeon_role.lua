-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logicconfig/config/t_bone_dragon_dungeon_role.lua

module("logicconfig.config.t_bone_dragon_dungeon_role", package.seeall)
...
local t_bone_dragon_dungeon_role = {
	[490001] = {
		dataList[1],
		dataList[2],
		dataList[3]
...
t_bone_dragon_dungeon_role.dataList = dataList
...
return t_bone_dragon_dungeon_role
