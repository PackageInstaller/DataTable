-- chunkname: @C:/GitLab-Runner/builds/sTUwNpCg/0/aqmobile/aqmobile-client/UnityProj/Assets/Scripts/Lua/logicconfig/config/t_saintknight_tian_common.lua

module("logicconfig.config.t_saintknight_tian_common", package.seeall)
...
local t_saintknight_tian_common = {
...
t_saintknight_tian_common.dataList = dataList
...
return t_saintknight_tian_common
