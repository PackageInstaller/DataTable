...
---------------------------------------------
-- 技能基类
Skill103301302 = oo.class(SkillBase)
function Skill103301302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill103301302:DoSkill(caster, target, data)
	-- 11004
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11004], caster, target, data, 0.25,4)
end
-- 行动结束2
function Skill103301302:OnActionOver2(caster, target, data)
	-- 8060
