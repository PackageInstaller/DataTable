...
---------------------------------------------
-- 技能基类
Buffer710230201 = oo.class(BuffBase)
function Buffer710230201:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动开始
function Buffer710230201:OnActionBegin(caster, target)
	-- 8160
...
-- 伤害前
function Buffer710230201:OnBefourHurt(caster, target)
	-- 710230212
	self:tFunc_710230212_710230213(caster, target)
	self:tFunc_710230212_710230214(caster, target)
end
-- 创建时
function Buffer710230201:OnCreate(caster, target)
	-- 710230201
	self:AddAttrPercent(BufferEffect[710230201], self.caster, self.card, nil, "attack",0.1)
	-- 710230206
	self:AddAttrPercent(BufferEffect[710230206], self.caster, self.creater, nil, "attack",0.1)
end
function Buffer710230201:tFunc_710230212_710230213(caster, target)
	-- 8060
...
function Buffer710230201:tFunc_710230212_710230214(caster, target)
	-- 8160
	if SkillJudger:IsCasterBuff(self, self.caster, target, true) then
	else
		return
