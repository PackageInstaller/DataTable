...
---------------------------------------------
-- 技能基类
Buffer304200214 = oo.class(BuffBase)
function Buffer304200214:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束2
function Buffer304200214:OnActionOver2(caster, target)
	-- 8063
	...
	-- 304200214
	self:OwnerAddBuff(BufferEffect[304200214], self.caster, self.card, nil, 304200204)
	-- 304200216
