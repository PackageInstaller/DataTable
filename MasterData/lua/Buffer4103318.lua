...
---------------------------------------------
-- 技能基类
Buffer4103318 = oo.class(BuffBase)
function Buffer4103318:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 创建时
function Buffer4103318:OnCreate(caster, target)
	-- 4103328
	...
	-- 4103324
	self:AddHp(BufferEffect[4103324], self.caster, self.card, nil, -math.floor(dmg10330*0.5))
	-- 4103329
