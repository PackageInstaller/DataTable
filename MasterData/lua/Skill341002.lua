...
---------------------------------------------
-- 技能基类
Skill341002 = oo.class(SkillBase)
function Skill341002:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill341002:OnActionOver(caster, target, data)
	-- 8061
...
-- 行动开始
function Skill341002:OnActionBegin(caster, target, data)
	-- 8060
	...
	-- 341003
	self:AddTempAttrPercent(SkillEffect[341003], caster, self.card, data, "attack",(count990+1)*0.02*math.floor(count817/300))
end
