...
---------------------------------------------
-- 技能基类
Buffer2165 = oo.class(BuffBase)
function Buffer2165:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer2165:OnRemoveBuff(caster, target)
	-- 8063
...
-- 创建时
function Buffer2165:OnCreate(caster, target)
	-- 2119
