...
---------------------------------------------
-- 技能基类
Buffer702400203 = oo.class(BuffBase)
function Buffer702400203:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer702400203:OnActionOver(caster, target)
	-- 8063
	...
	-- 702400202
	self:OwnerHitAddBuff(BufferEffect[702400202], self.caster, self.caster, nil, 1500+c77*200,3005,1)
	-- 8478
...
-- 创建时
function Buffer702400203:OnCreate(caster, target)
	-- 4903
