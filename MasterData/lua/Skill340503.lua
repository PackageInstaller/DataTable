...
---------------------------------------------
-- 技能基类
Skill340503 = oo.class(SkillBase)
function Skill340503:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill340503:OnRoundOver(caster, target, data)
	-- 8062
	...
	if self:Rand(6000) then
		self:AddHp(SkillEffect[340503], caster, self.card, data, -math.floor(0.2*count20))
		-- 8062
		if SkillJudger:CasterIsTeammate(self, caster, target, true) then
		else
			return
		...
		for i,target in ipairs(targets) do
			self:CallOwnerSkill(SkillEffect[340509], caster, target, data, 780500100+count796)
		end
	end
end
