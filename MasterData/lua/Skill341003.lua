...
---------------------------------------------
-- 技能基类
Skill341003 = oo.class(SkillBase)
function Skill341003:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill341003:OnActionOver(caster, target, data)
	-- 8061
...
-- 行动开始
function Skill341003:OnActionBegin(caster, target, data)
	-- 8060
	...
	-- 341004
	self:AddTempAttrPercent(SkillEffect[341004], caster, self.card, data, "attack",(count990+1)*0.03*math.floor(count817/300))
end
