...
---------------------------------------------
-- 技能基类
Skill6300028 = oo.class(SkillBase)
function Skill6300028:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill6300028:OnRoundOver(caster, target, data)
	-- 907800607
	...
	-- 6300028
	self:AddBuff(SkillEffect[6300028], caster, self.card, data, 6300028)
end
