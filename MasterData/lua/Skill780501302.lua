...
-- 行动结束
function Skill780501302:OnActionOver(caster, target, data)
	-- 8200
	...
	-- 780501307
	self:AddBuff(SkillEffect[780501307], caster, target, data, 780500302)
	-- 8794
...
-- 伤害后
function Skill780501302:OnAfterHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
