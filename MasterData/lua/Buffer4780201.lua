...
---------------------------------------------
-- 技能基类
Buffer4780201 = oo.class(BuffBase)
function Buffer4780201:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 伤害前
function Buffer4780201:OnBefourHurt(caster, target)
	-- 4780221
	self:tFunc_4780221_4780223(caster, target)
	self:tFunc_4780221_4780225(caster, target)
end
-- 创建时
function Buffer4780201:OnCreate(caster, target)
	-- 8771
	local c771 = SkillApi:GetAttr(self, self.caster, target or self.owner,3,"crit")
	-- 4780201
	self:AddAttr(BufferEffect[4780201], self.caster, self.card, nil, "attack",math.floor(c771*100*4))
	-- 8771
	local c771 = SkillApi:GetAttr(self, self.caster, target or self.owner,3,"crit")
	-- 4780211
	self:AddAttr(BufferEffect[4780211], self.caster, self.creater, nil, "attack",math.floor(c771*100*4))
end
function Buffer4780201:tFunc_4780221_4780225(caster, target)
	-- 8060
...
function Buffer4780201:tFunc_4780221_4780223(caster, target)
	-- 8160
