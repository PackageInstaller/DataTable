...
---------------------------------------------
-- 技能基类
Skill341004 = oo.class(SkillBase)
function Skill341004:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill341004:OnActionOver(caster, target, data)
	-- 8061
...
-- 行动开始
function Skill341004:OnActionBegin(caster, target, data)
	-- 8060
	...
	-- 341005
	self:AddTempAttrPercent(SkillEffect[341005], caster, self.card, data, "attack",(count990+1)*0.04*math.floor(count817/300))
end
