...
function Buffer4780205:OnCreate(caster, target)
	...
	-- 4780205
	self:AddAttr(BufferEffect[4780205], self.caster, self.card, nil, "attack",math.floor(c771*100*8))
	-- 8771
	local c771 = SkillApi:GetAttr(self, self.caster, target or self.owner,3,"crit")
	-- 4780215
	self:AddAttr(BufferEffect[4780215], self.caster, self.creater, nil, "attack",math.floor(c771*100*8))
end
