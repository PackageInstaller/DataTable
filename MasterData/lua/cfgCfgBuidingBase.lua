...
,["explanation"]="根據前哨基地既有設施改造的合成工廠，可將低級材料合成為更高效的材料。升級解鎖更高級物品合成所需的基礎條件。",["offsetPos"]={-1.5,8.19,-11.22}
,["hpCosts"]={{10001,1,2}
}
,["initOpen"]=true,["needAbilitys"]={8001,9001,9002,15002,15003,15004,15005,15006,25001}
,["name"]="合成工廠",["frontUIPos"]={2.17,9.71,0}
...
,["icon"]="building1001",["explanation"]="碎星探索行動的總指揮部，是基地內所有建築的基礎設置和運算核心。升級可派遣更多隊員進入其中協作。",["offsetPos"]={2.65,10,-14.14}
,["hpCosts"]={{10001,1,2}
}
,["initOpen"]=true,["needAbilitys"]={1001,1002,2001,8001,9001,9002,25001,28001}
,["name"]="行星指揮部",["frontUIPos"]={-7.24,8.64,0}
...
,["explanation"]="安置在礦產豐富的地方，通過開採可定時獲得特定的原料，特定原料可用於升級基地和交易，升級可提高採集效率。",["offsetPos"]={-11.17,9.93,-10.2}
,["hpCosts"]={{10001,1,2}
}
...
,["name"]="挖掘礦場",["frontUIPos"]={-0.87,9.26,0}
...
,["name_en"]="DORMITORY",["explanation"]="可自由佈置宿舍，增加宿舍的舒適度，提升宿舍內入駐隊員的心情恢復速度。",["openType"]=1,["type"]=10,["startFov"]=35,["offsetRot"]={35,135,0}
...
,["initOpen"]=true,["needAbilitys"]={},["icon"]="building1005",["name"]="心理輔導室",["buildSort"]=12,["frontUIPos"]={5.45,4.9,-11.06}
...
,["explanation"]="利用碎星當地的NOVA結晶產生的能量，高效的轉換為基地所需的電力，升級可提高轉換效率。",["offsetPos"]={-12.77,9.93,-7.52}
,["hpCosts"]={{10001,1,2}
}
,["initOpen"]=false,["needAbilitys"]={8001,9001,9002,14001,14002,25001}
,["name"]="能源發電站",["frontUIPos"]={10.91,3,-4.07}
...
,["explanation"]="可使用特定原料交易自己所需的物品，升級可獲得更多的交易訂單。",["offsetPos"]={14,15,-7.6}
,["hpCosts"]={{10001,1,2}
}
...
,["explanation"]="可把低階晶片研發為高階晶片，分解晶片可獲得研發所需的材料，升級可開啟更多的研發槽位。",["offsetPos"]={-9.47,16.67,-10.46}
,["hpCosts"]={{10001,1,2}
}
,["initOpen"]=false,["needAbilitys"]={8001,9001,9002,10001,24002,25001,26001,26002,26003,26004,26005,27001}
,["name"]="研發中心",["frontUIPos"]={2.67,7.18,0}
