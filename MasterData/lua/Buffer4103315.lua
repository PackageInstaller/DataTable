...
---------------------------------------------
-- 技能基类
Buffer4103315 = oo.class(BuffBase)
function Buffer4103315:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer4103315:OnActionOver(caster, target)
	-- 8160
...
-- 创建时
function Buffer4103315:OnCreate(caster, target)
	-- 8415
	...
	local c806 = SkillApi:GetCount(self, self.caster, target or self.owner,3,4103305+c804)
	-- 4103314
	self:AddAttr(BufferEffect[4103314], self.caster, self.creater, nil, "attack",math.floor(c15*math.min(c806,5)*0.05))
	-- 4103319
	self:AddAttr(BufferEffect[4103319], self.caster, self.card, nil, "attack",-math.floor(c15*math.min(c806,5)*0.05))
	-- 8804
	local c804 = SkillApi:SkillLevel(self, self.caster, target or self.owner,4,41033)
	-- 8806
	local c806 = SkillApi:GetCount(self, self.caster, target or self.owner,3,4103305+c804)
	...
	-- 4103333
	self:AddBuffCount(BufferEffect[4103333], self.caster, self.card, nil, 4103305+c804,1,999)
end
