...
---------------------------------------------
-- 技能基类
Skill341005 = oo.class(SkillBase)
function Skill341005:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill341005:OnActionOver(caster, target, data)
	-- 8061
...
-- 行动开始
function Skill341005:OnActionBegin(caster, target, data)
	-- 8060
	...
	-- 341006
	self:AddTempAttrPercent(SkillEffect[341006], caster, self.card, data, "attack",(count990+1)*0.05*math.floor(count817/300))
end
