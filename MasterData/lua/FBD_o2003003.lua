...
{effect="cast1_eff",effect_pack="o20030",time=3500,type=0,pos_ref={ref_type=6}}
},
[1310282141]={
...
{effect="cast0_hit",effect_pack="o20030",time=6000,type=0,pos_ref={ref_type=1,offset_row=-250}},
{effect="cast0_eff",effect_pack="o20030",time=3500,type=0,pos_ref={ref_type=6},path_target={ref_type=1}},
{time=3500,type=0,cue_sheet="cv/Pyrock.acb",cue_name="Pyrock_09",cue_feature=1}
},
[-1183793042]={
{effect="enter",effect_pack="o20030",time=3500,type=0,pos_ref={ref_type=6}}
},
[-1328923786]={
{time=3500,type=0}
}
