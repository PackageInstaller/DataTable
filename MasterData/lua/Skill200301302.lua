...
---------------------------------------------
-- 技能基类
Skill200301302 = oo.class(SkillBase)
function Skill200301302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill200301302:DoSkill(caster, target, data)
	-- 12003
...
-- 行动开始
function Skill200301302:OnActionBegin(caster, target, data)
	-- 8200
...
-- 行动结束
function Skill200301302:OnActionOver(caster, target, data)
	-- 8200
	if SkillJudger:IsCurrSkill(self, caster, target, true) then
	else
		return
...
-- 行动结束2
function Skill200301302:OnActionOver2(caster, target, data)
	-- 8200
	if SkillJudger:IsCurrSkill(self, caster, target, true) then
	else
		return
...
-- 攻击开始
function Skill200301302:OnAttackBegin(caster, target, data)
	-- 8777
	local count777 = SkillApi:SkillLevel(self, caster, target,3,42003)
	-- 8782
	...
	local count777 = SkillApi:SkillLevel(self, caster, target,3,42003)
	-- 200301304
	self:AddBuffCount(SkillEffect[200301304], caster, target, data, 4200305+count777,count782,10)
	-- 200301308
