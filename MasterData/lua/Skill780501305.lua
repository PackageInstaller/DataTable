...
---------------------------------------------
-- 技能基类
Skill780501305 = oo.class(SkillBase)
function Skill780501305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill780501305:DoSkill(caster, target, data)
	-- 12006
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12006], caster, target, data, 0.167,6)
end
-- 行动结束
function Skill780501305:OnActionOver(caster, target, data)
	-- 8200
	...
	-- 780501310
	self:AddBuff(SkillEffect[780501310], caster, target, data, 780500305)
	-- 8794
...
-- 伤害后
function Skill780501305:OnAfterHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
