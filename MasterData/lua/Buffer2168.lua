...
---------------------------------------------
-- 技能基类
Buffer2168 = oo.class(BuffBase)
function Buffer2168:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer2168:OnRemoveBuff(caster, target)
	-- 8446
...
-- 创建时
function Buffer2168:OnCreate(caster, target)
	-- 2128
	self:AddShield(BufferEffect[2128], self.caster, target or self.owner, nil,1,0.36)
end
