...
---------------------------------------------
-- 技能基类
Buffer4103314 = oo.class(BuffBase)
function Buffer4103314:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer4103314:OnActionOver(caster, target)
	-- 8160
...
-- 创建时
function Buffer4103314:OnCreate(caster, target)
	-- 8415
	...
	local c806 = SkillApi:GetCount(self, self.caster, target or self.owner,3,4103305+c804)
	-- 4103313
	self:AddAttr(BufferEffect[4103313], self.caster, self.creater, nil, "attack",math.floor(c15*math.min(c806,5)*0.04))
	-- 4103318
	self:AddAttr(BufferEffect[4103318], self.caster, self.card, nil, "attack",-math.floor(c15*math.min(c806,5)*0.04))
	-- 8804
	local c804 = SkillApi:SkillLevel(self, self.caster, target or self.owner,4,41033)
	-- 8806
	local c806 = SkillApi:GetCount(self, self.caster, target or self.owner,3,4103305+c804)
	...
	-- 4103332
	self:AddBuffCount(BufferEffect[4103332], self.caster, self.card, nil, 4103305+c804,1,999)
end
