...
function Skill4942002:OnActionOver2(caster, target, data)
	...
	-- 4704032
	self:AddHp(SkillEffect[4704032], self.card, caster, data, math.floor(-count633*0.10))
	-- 8958
	...
	-- 4704037
	self:AddHp(SkillEffect[4704037], self.card, caster, data, math.floor(-count633*3))
end
