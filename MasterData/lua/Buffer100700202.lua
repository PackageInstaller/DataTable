...
---------------------------------------------
-- 技能基类
Buffer100700202 = oo.class(BuffBase)
function Buffer100700202:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer100700202:OnActionOver(caster, target)
	-- 8063
	...
	-- 100700202
	self:AddValue(BufferEffect[100700202], self.caster, self.card, nil, "dmg10070",0.11*c14)
end
-- 创建时
function Buffer100700202:OnCreate(caster, target)
	-- 8418
