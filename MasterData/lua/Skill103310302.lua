...
---------------------------------------------
-- 技能基类
Skill103310302 = oo.class(SkillBase)
function Skill103310302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill103310302:DoSkill(caster, target, data)
	-- 13051
...
-- 攻击结束
function Skill103310302:OnAttackOver(caster, target, data)
	-- 8060
