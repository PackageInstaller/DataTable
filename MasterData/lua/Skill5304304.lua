...
---------------------------------------------
-- 技能基类
Skill5304304 = oo.class(SkillBase)
function Skill5304304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill5304304:OnActionOver(caster, target, data)
	-- 8062
	...
	-- 5304312
	self:OwnerAddBuff(SkillEffect[5304312], caster, caster, data, 5304302)
end
-- 行动开始
function Skill5304304:OnActionBegin(caster, target, data)
	-- 5304308
	self:tFunc_5304308_5304303(caster, target, data)
	self:tFunc_5304308_5304307(caster, target, data)
end
-- 加buff时
function Skill5304304:OnAddBuff(caster, target, data, buffer)
	-- 8062
	if SkillJudger:CasterIsTeammate(self, caster, target, true) then
	else
		return
	...
	-- 5304302
	self:OwnerAddBuff(SkillEffect[5304302], caster, caster, data, 5304302)
end
-- 伤害前
function Skill5304304:OnBefourHurt(caster, target, data)
	-- 5304315
	self:tFunc_5304315_5304316(caster, target, data)
	self:tFunc_5304315_5304317(caster, target, data)
end
function Skill5304304:tFunc_5304315_5304317(caster, target, data)
	-- 8233
...
function Skill5304304:tFunc_5304308_5304307(caster, target, data)
	-- 8061
...
function Skill5304304:tFunc_5304315_5304316(caster, target, data)
	-- 8063
...
function Skill5304304:tFunc_5304308_5304303(caster, target, data)
	-- 8060
