...
---------------------------------------------
-- 技能基类
Skill103301303 = oo.class(SkillBase)
function Skill103301303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill103301303:DoSkill(caster, target, data)
	-- 11004
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11004], caster, target, data, 0.25,4)
end
-- 行动结束2
function Skill103301303:OnActionOver2(caster, target, data)
	-- 8060
