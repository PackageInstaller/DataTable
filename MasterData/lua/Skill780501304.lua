...
-- 行动结束
function Skill780501304:OnActionOver(caster, target, data)
	-- 8200
	...
	-- 780501309
	self:AddBuff(SkillEffect[780501309], caster, target, data, 780500304)
	-- 8794
...
-- 伤害后
function Skill780501304:OnAfterHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
