...
---------------------------------------------
-- 技能基类
Buffer103400304 = oo.class(BuffBase)
function Buffer103400304:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer103400304:OnRoundBegin(caster, target)
	-- 8798
...
-- 移除buff时
function Buffer103400304:OnRemoveBuff(caster, target)
	-- 103400307
	self:DelBufferTypeForce(BufferEffect[103400307], self.caster, self.card, nil, 103400306)
end
-- 创建时
function Buffer103400304:OnCreate(caster, target)
	-- 103400304
	self:AddAttr(BufferEffect[103400304], self.caster, self.card, nil, "bedamage",-0.2)
	-- 8798
	local c798 = SkillApi:SkillLevel(self, self.caster, target or self.owner,4,41034)
	-- 8800
	local c800 = SkillApi:GetCount(self, self.caster, target or self.owner,3,4103400+c798)
