...
{effect="cast2_eff",time=21000,type=0,pos_ref={ref_type=6}}
},
[-686817241]={
{time=4000,type=0,cue_sheet="cv/Osiris.acb",cue_name="Osiris_10",cue_feature=1},
{effect="cast1_buff2",delay=1500,time=4000,type=0,pos_ref={ref_type=15}},
{effect="cast1_buff1",time=4000,type=0,pos_ref={ref_type=6}},
