...
---------------------------------------------
-- 技能基类
Skill950210401 = oo.class(SkillBase)
function Skill950210401:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill950210401:DoSkill(caster, target, data)
	-- 12006
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12006], caster, target, data, 0.167,6)
end
-- 攻击结束
function Skill950210401:OnAttackOver(caster, target, data)
	-- 8060
...
-- 攻击结束2
function Skill950210401:OnAttackOver2(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
