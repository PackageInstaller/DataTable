...
---------------------------------------------
-- 技能基类
Skill340502 = oo.class(SkillBase)
function Skill340502:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill340502:OnRoundOver(caster, target, data)
	-- 8062
	...
	if self:Rand(5000) then
		self:AddHp(SkillEffect[340502], caster, self.card, data, -math.floor(0.2*count20))
		-- 8062
		if SkillJudger:CasterIsTeammate(self, caster, target, true) then
		else
			return
		...
		for i,target in ipairs(targets) do
			self:CallOwnerSkill(SkillEffect[340508], caster, target, data, 780500100+count796)
		end
	end
end
