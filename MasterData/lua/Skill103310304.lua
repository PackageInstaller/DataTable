...
---------------------------------------------
-- 技能基类
Skill103310304 = oo.class(SkillBase)
function Skill103310304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill103310304:DoSkill(caster, target, data)
	-- 13051
...
-- 攻击结束
function Skill103310304:OnAttackOver(caster, target, data)
	-- 8060
