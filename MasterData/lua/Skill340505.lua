...
---------------------------------------------
-- 技能基类
Skill340505 = oo.class(SkillBase)
function Skill340505:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill340505:OnRoundOver(caster, target, data)
	-- 8062
	...
	if self:Rand(8000) then
		self:AddHp(SkillEffect[340505], caster, self.card, data, -math.floor(0.2*count20))
		-- 8062
		if SkillJudger:CasterIsTeammate(self, caster, target, true) then
		else
			return
		...
		for i,target in ipairs(targets) do
			self:CallOwnerSkill(SkillEffect[340511], caster, target, data, 780500100+count796)
		end
	end
end
