...
---------------------------------------------
-- 技能基类
Buffer55001273 = oo.class(BuffBase)
function Buffer55001273:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer55001273:OnRemoveBuff(caster, target)
	-- 3405
...
-- 伤害前
function Buffer55001273:OnBefourHurt(caster, target)
	-- 8063
...
-- 创建时
function Buffer55001273:OnCreate(caster, target)
	-- 3404
	self:MissSurface(BufferEffect[3404], self.caster, self.card, nil, 10000)
end
-- 攻击结束
function Buffer55001273:OnAttackOver(caster, target)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, self.caster, target, true) then
	else
		return
