...
---------------------------------------------
-- 技能基类
Skill6300030 = oo.class(SkillBase)
function Skill6300030:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill6300030:OnRoundOver(caster, target, data)
	-- 907800607
	...
	-- 6300030
	self:AddBuff(SkillEffect[6300030], caster, self.card, data, 6300030)
end
