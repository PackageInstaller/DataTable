...
---------------------------------------------
-- 技能基类
Skill913900202 = oo.class(SkillBase)
function Skill913900202:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill913900202:DoSkill(caster, target, data)
	-- 12003
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12003], caster, target, data, 0.333,3)
end
-- 伤害前
function Skill913900202:OnBefourHurt(caster, target, data)
	-- 8060
