...
local Text_MonsterIntent = readonly({
  ...
  ["MonsterIntent_怪物意图攻击和削弱_TipId"] = {
    Text = "Will deal {s1} DMG to your team and apply negative effects."
  },
  ...
  ["MonsterIntent_怪物意图攻击和强化_TipId"] = {
    Text = "Deal {s1} DMG to your team and apply Enhance."
  },
  ["MonsterIntent_怪物意图攻击和防御_Name"] = {
    Text = "Strike&Defense"
  },
  ["MonsterIntent_怪物意图攻击和防御_TipId"] = {
    Text = "Will deal {s1} DMG to your team and gain Shield."
  },
  ...
  ["MonsterIntent_怪物意图防御和削弱_TipId"] = {
    Text = "Will gain Shield and inflict debuffs on your team."
  },
