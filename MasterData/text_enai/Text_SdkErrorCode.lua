...
local Text_SdkErrorCode = readonly({
  ...
  SdkErrorCode_67988_Content = {
    Text = "Network connection error. Please try restarting the game or check the network."
  },
  ...
  SdkErrorCode_68024_Content = {
    Text = "No network connection. Please check the network and try again."
  },
  ...
  SdkErrorCode_68159_Content = {
    Text = "File download error. Please check the remaining space on the device."
  },
  ...
  SdkErrorCode_68199_Content = {
    Text = "Network interruption. Please check your network."
  },
  ...
  SdkErrorCode_68268_Content = {
    Text = "Poor network connection. Please check your internet or restart the game and try again."
  },
