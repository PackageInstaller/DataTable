TipContent = {
  ...
  exploration_jump = 162,
  exploration_Store_Sell = 256,
  exploration_Store_SellSuc = 257,
  exploration_Upgrade_UpgradeTimesInsufficient = 258,
  exploration_Upgrade_UpgradeItemInsufficient = 762,
  ...
  Oasis_ArenaUnLock = 5019,
  Oasis_LittleManArenaUnLock = 5020,
  ...
  Shop_BuyNumLimit = 294,
  Shop_PriceChange = 295,
  Shop_fragPriceDes = 296,
  Shop_OutOfDate = 14027,
  ...
  LevelUp_Limit = 143,
  CurFormationContainDisadvantage = 157,
  SctLevelBuffNodeTitle = 158,
  Dungeon_RestartSameStage = 160,
  Item_NotReach = 165,
  HardAVG_Tip = 166,
  NormalAVG_Tip = 174,
  OaisaAreaUnlock = 167,
  ...
  Ltr_PoolExpired = 300,
  Sector_IsExploringOtherSector2DailyAndWeekly = 390,
  ...
  NavigationBtnForceLocked = 170,
  NameNotChange = 176,
  CST_unlockTipLevel = 180,
  ...
  EndLessUnfinishedTips = 373,
  EndLessRepetitionTips = 374,
  ...
  Factory_BuildingNotBuilt = 507,
  Factory_AlreadyHaveOrder = 508,
  Factory_BeyoundOrderTime = 509,
  Factory_ConfirmDeleteOrder = 510,
  Friendship_SkillUpgrade_MatInsufficient = 520,
  Friendship_SkillUpgrade_LevelInsufficient = 521,
  UserInfo_CopyUIDDone = 540,
  Hero_FullRank = 550,
  SKIN_DEFAULT_DES = 551,
  Frag_MergeFrageInsufficient = 553,
  not_get_gateinfo = 10001,
  ATH_HasRefactor = 163,
  ATH_ConfirmCancelRefactor = 164,
  ATH_Dungeon_Area_Extra_Msg = 3001,
  ATH_Dungeon_All_Area_Extra_Msg = 3002,
  PlotDungeon_DungeonLocked = 3003,
  ultimateSkillUpgrade = 601,
  hero_skill_disable2UpgradeOb = 619,
  Formation_OnlyHaveASupportHero = 630,
  Overload_Tip = 700,
  Overload_Atn_Buff_Tip = 701,
  Overload_Hp_Buff_Tip = 702,
  Overload_Time_Tip = 703,
  Overload_Buff_Tip = 704,
  SkillSelectUnavailableTips = 706,
  Jump_TargetFuncLocked = 800,
  Recomme_Confirm = 380,
  Recomme_Forbid = 381,
  Recomme_Empty = 382,
  Recomme_Fail = 383,
  Recomme_Sample = 384,
  Recomme_SuccessAll = 385,
  Recomme_SuccessPart = 386,
  Recomme_ChipEmpty = 387,
  CampFetter_AchieveTempChip = 1100,
  CampFetter_ActiveCD1 = 1101,
  CampFetter_ActiveCD2 = 1102,
  CampFetter_ActiveCD3 = 1103,
  CampFetter_ActiveCD4 = 1104,
  LockTip_Endless = 151,
  LockTip_EndlessLevel = 152,
  LockTip_Sector = 153,
  DifficultyName_1 = 154,
  DifficultyName_2 = 155,
  DifficultyName_3 = 156,
  PotentialForbidTip = 159,
  ChipReplaceAll = 292,
  ChipReplaceNotCount = 293,
  MailDataInfo = 902,
  WCCCInterst = 906,
  CstFixed = 919,
  notSelecedKeyCard = 920,
  HeroInformation_notHaveVoice = 930,
  MeetMaxStageRoleCountInTD = 951,
  CampTip_Other = 990,
  PlotDungeon_ReplayPersicaria = 3004,
  PlotDungeon_ReplayFullFrage = 3005,
  WearhouseOpenAthPackageFull = 4006,
  WeeklyDebuffIntro = 6001,
  ChatSwitchChannel = 6014,
  ChatChannelFull = 6015,
  ChatInputIsEmpty = 6016,
  ChatSendCD = 6017,
  ChatemojiReplace = 6018,
  ChatNoNewMessage = 6019,
  Friend_DeleteAlert = 6021,
  Friend_AddSuccessNotice = 6022,
  Friend_AddFailure = 6023,
  Friend_FriendListIsFull = 6024,
  Friend_NumFull = 6025,
  Friend_AppExpire = 6027,
  Friend_SearchFail = 6029,
  Support_CanNotUseSameSupport = 6031,
  Frined_AddToBlacklist = 6104,
  Friend_FriendInBlackList = 6105,
  Friend_RemoveFromBlacklist = 6106,
  Friend_BlacklistLimit = 6107,
  Report_LimitTimes = 6108,
  Report_ReasonHasShieldWord = 6109,
  Report_Success = 6110,
  ComebackEntryText = 7410,
  ComebackLiteEntryText = 7411,
  MaintainNotice = 8201,
  TimeName_hour = 8202,
  TimeName_min = 8203,
  TimeName_second = 8204,
  WarChess_TeamDefaultName = 8508,
  WarChess_TeamNumLessThen = 8515,
  WarChess_CanNotDeploy = 8518,
  WarChess_InFrontOfCannon = 8522,
  selfSelect_heroFrag_Title = 8901,
  selfSelect_heroFrag_SubTitle = 8902,
  selfSelect_heroFrag_NoHeroTip = 8903,
  WeeklyChallenge_DailyChallengeScoreRequire = 9111,
  WeeklyChallenge_DailyChallengeTip = 9112,
  PayPriceUnit = 10007,
  PaidItemNotEnoughTip = 10009,
  RecommandShopPayPriceUnit = 10014,
  AutoDecompose = 18001,
  FairyNameTooLong = 22008
}
