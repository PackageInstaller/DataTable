module("framework.datastruct.SinglyLinkedList", package.seeall)
...
local var_0_0 = {
	...
	remove = function(arg_8_0, arg_8_1)
		if arg_8_1 > -1 and arg_8_1 < arg_8_0._size then
			...
			elseif arg_8_1 == arg_8_0._size - 1 then
				var_8_1 = arg_8_0._head

				while var_8_1.node_next ~= arg_8_0._tail do
					var_8_1 = var_8_1.node_next
				end

				arg_8_0._tail = var_8_1
				arg_8_0._tail.node_next = nil
			else
				while var_8_2 < arg_8_1 do
					var_8_1 = var_8_0
					var_8_0 = var_8_0.node_next
					var_8_2 = var_8_2 + 1
				end

				var_8_1.node_next = var_8_0.node_next
			end
	...
	remove_by_data = function(arg_9_0, arg_9_1)
		...
		while var_9_0.node_next ~= nil do
