_class("SeasonMazeSceneLayerMaterial", SeasonMazeSceneLayerBase)
SeasonMazeSceneLayerMaterial = SeasonMazeSceneLayerMaterial

function SeasonMazeSceneLayerMaterial:Constructor(sceneRoot)
  self._flag = {}
...
function SeasonMazeSceneLayerMaterial:Dispose()
  table.clear(self._materials)
  table.clear(self._renderers)
end

function SeasonMazeSceneLayerMaterial:UnLock(zoneMask, zoneID2Animation)
end

function SeasonMazeSceneLayerMaterial:_CacheMaterial()
...
function SeasonMazeSceneLayerMaterial:_GetMaterialType(name)
...
function SeasonMazeSceneLayerMaterial:GetMapMaterial(gameObject)
  if gameObject then
