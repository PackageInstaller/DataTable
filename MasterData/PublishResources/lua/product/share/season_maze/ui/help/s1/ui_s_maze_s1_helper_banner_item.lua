_class("UISMazeS1HelperBannerItem", UICustomWidget)
UISMazeS1HelperBannerItem = UISMazeS1HelperBannerItem

function UISMazeS1HelperBannerItem:OnShow()
end

function UISMazeS1HelperBannerItem:OnHide()
end

function UISMazeS1HelperBannerItem:SetData(cfg, callbcak, begindrag, drag, enddrag)
  self._cfg = cfg
...
function UISMazeS1HelperBannerItem:BtnOnClick()
end

function UISMazeS1HelperBannerItem:Dispose()
  self._cfg = nil
  self._callback = nil
  self._icon = nil
end
