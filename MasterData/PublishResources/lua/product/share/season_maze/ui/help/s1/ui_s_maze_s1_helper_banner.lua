...
function UISMazeS1HelperBanner:InitWidget()
  ...
  self._cellWidget1 = cellGen1:SpawnObject("UISMazeS1HelperBannerItem")
  local cellGen2 = self:GetUIComponent("UISelectObjectPath", "CellArea2")
  self._cellWidget2 = cellGen2:SpawnObject("UISMazeS1HelperBannerItem")
...
function UISMazeS1HelperBanner:InitScrollView(pageIdx)
  ...
  self._currIdx = self:GetCurrIdx(pageIdx)
