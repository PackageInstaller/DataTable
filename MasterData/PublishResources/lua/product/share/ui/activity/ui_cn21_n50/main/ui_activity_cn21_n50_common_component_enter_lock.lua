_class("UIActivityCN21N50CommonComponentEnterLock", UICustomWidget)
UIActivityCN21N50CommonComponentEnterLock = UIActivityCN21N50CommonComponentEnterLock
...
function UIActivityCN21N50CommonComponentEnterLock:OnShow()
  self:_AttachEvents()
  self._isOpen = true
end

function UIActivityCN21N50CommonComponentEnterLock:OnHide()
  self:_DetachEvents()
  self._isOpen = false
  self._timeEvent = UIActivityHelper.CancelTimerEvent(self._timeEvent)
end

function UIActivityCN21N50CommonComponentEnterLock:SetNew(widgetName, checkNewFunc)
  self._widgetName_New = widgetName
  self._checkNewFunc = checkNewFunc
end

function UIActivityCN21N50CommonComponentEnterLock:SetRed(widgetName, checkRedFunc)
  self._widgetName_Red = widgetName
  self._checkRedFunc = checkRedFunc
end

function UIActivityCN21N50CommonComponentEnterLock:SetRedCount(widgetName, widgetNameText, checkRedFunc)
  self._widgetName_RedCount = widgetName
  self._widgetName_RedCountText = widgetNameText
  self._checkRedFunc = checkRedFunc
end

function UIActivityCN21N50CommonComponentEnterLock:SetNew_RedDotModule(widgetName, newdotType)
  self._widgetName_New = widgetName
  self._newdotType = newdotType
end

function UIActivityCN21N50CommonComponentEnterLock:SetRed_RedDotModule(widgetName, reddotType)
  self._widgetName_Red = widgetName
  self._reddotType = reddotType
end

function UIActivityCN21N50CommonComponentEnterLock:SetLockStateCallback(lockWithTimeCallback, lockCallback, closedCallback)
  self._lockWithTimeCallback = lockWithTimeCallback
  self._lockCallback = lockCallback
  self._closedCallback = closedCallback
end

function UIActivityCN21N50CommonComponentEnterLock:SetActivityCommonRemainingTime(widgetName, descId, endTime, customTimeStr, tickCallback, stopCallback)
  local obj = UIWidgetHelper.SpawnObject(self, widgetName, "UIActivityCommonRemainingTimeTmp")
...
function UIActivityCN21N50CommonComponentEnterLock:SetWidgetNameGroup(widgetNameGroup)
  self._stateObj = UIWidgetHelper.GetObjGroupByWidgetName(self, widgetNameGroup)
end

function UIActivityCN21N50CommonComponentEnterLock:SetData(campaign, componentId, uiCallback)
...
function UIActivityCN21N50CommonComponentEnterLock:_SetTimerForUpdate()
...
function UIActivityCN21N50CommonComponentEnterLock:_Refresh()
...
function UIActivityCN21N50CommonComponentEnterLock:_CheckState()
  local component = self._component
  if not component then
    Log.info("UIActivityCN21N50CommonComponentEnterLock:_CheckState() component == nil")
...
function UIActivityCN21N50CommonComponentEnterLock:_ReloadCampaignInfo_ChangeState()
  local lockName = "UIActivityCN21N50CommonComponentEnterLock:_ReloadCampaignInfo_ChangeState()"
  self:Lock(lockName)
...
function UIActivityCN21N50CommonComponentEnterLock:_ChangeState()
  local state = self:_CheckState()
...
function UIActivityCN21N50CommonComponentEnterLock:GetBtnGameObject()
...
function UIActivityCN21N50CommonComponentEnterLock:BtnOnClick()
  Log.info("UIActivityCN21N50CommonComponentEnterLock:BtnOnClick")
...
function UIActivityCN21N50CommonComponentEnterLock:_AttachEvents()
  self:AttachEvent(GameEventType.CampaignComponentStepChange, self._OnComponentStepChange)
  self:AttachEvent(GameEventType.QuestUpdate, self._OnQuestUpdate)
end

function UIActivityCN21N50CommonComponentEnterLock:_DetachEvents()
  self:DetachEvent(GameEventType.CampaignComponentStepChange, self._OnComponentStepChange)
  self:DetachEvent(GameEventType.QuestUpdate, self._OnQuestUpdate)
end

function UIActivityCN21N50CommonComponentEnterLock:_OnComponentStepChange(campaign_id, component_id, component_step)
  if self._campaign and self._campaign._id == campaign_id then
    self:_CheckPoint()
  end
end

function UIActivityCN21N50CommonComponentEnterLock:_OnQuestUpdate()
  self:_CheckPoint()
end

function UIActivityCN21N50CommonComponentEnterLock:_CheckPoint()
...
function UIActivityCN21N50CommonComponentEnterLock:_CheckPoint_RedDotModule()
  GameGlobal.TaskManager():StartTask(function(TT)
    local checkList = {}
