_class("UIActivityCN22N51CommonComponentEnterLock", UICustomWidget)
UIActivityCN22N51CommonComponentEnterLock = UIActivityCN22N51CommonComponentEnterLock
...
function UIActivityCN22N51CommonComponentEnterLock:OnShow()
  self:_AttachEvents()
  self._isOpen = true
end

function UIActivityCN22N51CommonComponentEnterLock:OnHide()
  self:_DetachEvents()
  self._isOpen = false
  self._timeEvent = UIActivityHelper.CancelTimerEvent(self._timeEvent)
end

function UIActivityCN22N51CommonComponentEnterLock:SetNew(widgetName, checkNewFunc)
  self._widgetName_New = widgetName
  self._checkNewFunc = checkNewFunc
end

function UIActivityCN22N51CommonComponentEnterLock:SetRed(widgetName, checkRedFunc)
  self._widgetName_Red = widgetName
  self._checkRedFunc = checkRedFunc
end

function UIActivityCN22N51CommonComponentEnterLock:SetRedCount(widgetName, widgetNameText, checkRedFunc)
  self._widgetName_RedCount = widgetName
  self._widgetName_RedCountText = widgetNameText
  self._checkRedFunc = checkRedFunc
end

function UIActivityCN22N51CommonComponentEnterLock:SetNew_RedDotModule(widgetName, newdotType)
  self._widgetName_New = widgetName
  self._newdotType = newdotType
end

function UIActivityCN22N51CommonComponentEnterLock:SetRed_RedDotModule(widgetName, reddotType)
  self._widgetName_Red = widgetName
  self._reddotType = reddotType
end

function UIActivityCN22N51CommonComponentEnterLock:SetLockStateCallback(lockWithTimeCallback, lockCallback, closedCallback)
  self._lockWithTimeCallback = lockWithTimeCallback
  self._lockCallback = lockCallback
  self._closedCallback = closedCallback
end

function UIActivityCN22N51CommonComponentEnterLock:SetActivityCommonRemainingTime(widgetName, descId, endTime, customTimeStr, tickCallback, stopCallback)
...
function UIActivityCN22N51CommonComponentEnterLock:SetWidgetNameGroup(widgetNameGroup)
  self._stateObj = UIWidgetHelper.GetObjGroupByWidgetName(self, widgetNameGroup)
end

function UIActivityCN22N51CommonComponentEnterLock:SetData(campaign, componentId, uiCallback)
...
function UIActivityCN22N51CommonComponentEnterLock:_SetTimerForUpdate()
...
function UIActivityCN22N51CommonComponentEnterLock:_Refresh()
...
function UIActivityCN22N51CommonComponentEnterLock:_CheckState()
  local component = self._component
  if not component then
    Log.info("UIActivityCN22N51CommonComponentEnterLock:_CheckState() component == nil")
...
function UIActivityCN22N51CommonComponentEnterLock:_ReloadCampaignInfo_ChangeState()
  local lockName = "UIActivityCN22N51CommonComponentEnterLock:_ReloadCampaignInfo_ChangeState()"
  self:Lock(lockName)
...
function UIActivityCN22N51CommonComponentEnterLock:_ChangeState()
  local state = self:_CheckState()
...
function UIActivityCN22N51CommonComponentEnterLock:GetBtnGameObject()
...
function UIActivityCN22N51CommonComponentEnterLock:BtnOnClick()
  Log.info("UIActivityCN22N51CommonComponentEnterLock:BtnOnClick")
...
function UIActivityCN22N51CommonComponentEnterLock:_AttachEvents()
  self:AttachEvent(GameEventType.CampaignComponentStepChange, self._OnComponentStepChange)
  self:AttachEvent(GameEventType.QuestUpdate, self._OnQuestUpdate)
end

function UIActivityCN22N51CommonComponentEnterLock:_DetachEvents()
  self:DetachEvent(GameEventType.CampaignComponentStepChange, self._OnComponentStepChange)
  self:DetachEvent(GameEventType.QuestUpdate, self._OnQuestUpdate)
end

function UIActivityCN22N51CommonComponentEnterLock:_OnComponentStepChange(campaign_id, component_id, component_step)
  if self._campaign and self._campaign._id == campaign_id then
    self:_CheckPoint()
  end
end

function UIActivityCN22N51CommonComponentEnterLock:_OnQuestUpdate()
  self:_CheckPoint()
end

function UIActivityCN22N51CommonComponentEnterLock:_CheckPoint()
...
function UIActivityCN22N51CommonComponentEnterLock:_CheckPoint_RedDotModule()
  GameGlobal.TaskManager():StartTask(function(TT)
    local checkList = {}
