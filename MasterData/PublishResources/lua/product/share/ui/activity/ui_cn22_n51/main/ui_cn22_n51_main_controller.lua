...
_class("UICN22N51MainController", UIShareController)
UICN22N51MainController = UICN22N51MainController

function UICN22N51MainController:_SetCommonTopButton()
  local shareComponent = UICN22N51Helper.GetComponent(self._campaign, "share")
...
function UICN22N51MainController:_Back()
  if self:Manager():CurUIStateType() == UIStateType.UICN22N51MainController then
...
function UICN22N51MainController:_HideUI()
...
function UICN22N51MainController:_ShowUI()
...
function UICN22N51MainController:_SetRemainingTime(widgetName, descId, endTime, tickCallback, stopCallback)
  local obj = UIWidgetHelper.SpawnObject(self, widgetName, "UIActivityCommonRemainingTime")
  obj:SetAdvanceText(descId)
  obj:SetData(endTime, tickCallback, stopCallback)
end

function UICN22N51MainController:_SetSpine()
  ...
  if cfg then
    ...
    if spineAnim then
      local lineComInfo = self._campaign:GetComponentInfo(UICN22N51Helper.GetComponentId("line"))
...
function UICN22N51MainController:_SetImgRT(imgRT)
  if imgRT ~= nil then
...
function UICN22N51MainController:_CheckGuide()
  GameGlobal.EventDispatcher():Dispatch(GameEventType.GuideOpenUI, GuideOpenUI.UICN22N51MainController)
end

function UICN22N51MainController:_PlayAnim(idx, callback)
  local tb = {
    ["in"] = {
      animName = "uieff_UICN22N51MainController_in",
      duration = 1000
    },
    in2 = {
      animName = "uieff_UICN22N51MainController_out",
      duration = 680
    },
    hide = {
      animName = "uieff_UICN22N51MainController_hide",
      duration = 500
    },
    show = {
      animName = "uieff_UICN22N51MainController_show",
      duration = 500
    }
  }
  if tb[idx] ~= nil then
    UIWidgetHelper.PlayAnimation(self, "UICanvas", tb[idx].animName, tb[idx].duration, callback)
  elseif callback ~= nil then
    callback()
  end
end

function UICN22N51MainController:LoadDataOnEnter(TT, res, uiParams)
  local campaignType = UICN22N51Helper.GetCampaignType()
  local componentIds = {}
  self._campaign = UIActivityHelper.LoadDataOnEnter(TT, res, campaignType, componentIds)
  UICN22N51Helper.LocalDB_Set("main", "New")
...
function UICN22N51MainController:OnShow(uiParams)
...
function UICN22N51MainController:OnHide()
  self:_DetachEvents()
end

function UICN22N51MainController:_Refresh()
  UICN22N51Helper.SetBattlePassBtn(self, "_battlePassBtn", self._bp_campaign)
  self._exchangeObj = UICN22N51Helper.SetExchangeBtn(self, "_exchangeBtn", self._campaign)
  self:_SetLoginBtn()
  self:_SetLineBtn()
  self:_SetBlackBtn()
end

function UICN22N51MainController:_UpdateRemainingTime()
  local svrTimeModule = GameGlobal.GetModule(SvrTimeModule)
  local curTime = math.floor(svrTimeModule:GetServerTime() * 0.001)
  local exchangeItemComponent = UICN22N51Helper.GetComponentInfo(self._campaign, "exchange")
  local endTime = exchangeItemComponent.m_close_time
  local stamp = endTime - curTime
  if 0 < stamp then
    self:_SetRemainingTime("_time", "str_cn21_n50_shop_close_time_tips", endTime)
    return
  end
end

function UICN22N51MainController:_SetLoginBtn()
  local name = "login"
  ...
  local function newCallback()
    local new = UICN22N51Helper.CalcNew_Component(self._campaign, name)
    return new
  end
  ...
  local function redCallback()
    local red = UICN22N51Helper.CalcRed_Component(self._campaign, name)
    return red
  end
...
function UICN22N51MainController:_SetLineBtn()
  local name = "line"
  local cmptId = UICN22N51Helper.GetComponentId(name)
  local component = UICN22N51Helper.GetComponent(self._campaign, name)
  ...
  self._lineObj:SetActivityCommonRemainingTime("_time_unlock", "str_cn22_n51_remain_time_in_activity", closeTime, true)
  local tb = {
    {"state_lock"},
    {"state_lock"},
    {
  ...
  local state = UIStateType.UICN22N51LineController
  
  local function clickCallback()
    UICN22N51Helper.LocalDB_Set(name, "New")
    local lineKey = UICN22N51Helper._LocalDB_GetKey(name, "Red")
...
function UICN22N51MainController:_SetBlackBtn()
  local name = "black"
  local cmptId = UICN22N51Helper.GetComponentId(name)
  local component = UICN22N51Helper.GetComponent(self._campaign, name)
  ...
  local stamp = endTime - curTime
  local lineComponentInfo = UICN22N51Helper.GetComponentInfo(self._campaign, "line")
  ...
  local closeTime = component and component:GetComponentInfo().m_close_time or 0
  self._hardObj:SetActivityCommonRemainingTime("_time_unlock", "str_cn21_n50_remain_time_in_activity", closeTime, false)
  ...
  local state = UIStateType.UICN22N51HardLevel
  
  local function clickCallback()
    UICN22N51Helper.LocalDB_Set(name, "New")
    local blackKey = UICN22N51Helper._LocalDB_GetKey(name, "Red")
...
function UICN22N51MainController:IntroBtnOnClick(go)
  self:ShowDialog("UIIntroLoader", "UICN22N51Intro")
end

function UICN22N51MainController:ShowBtnOnClick()
  self:_ShowUI()
end

function UICN22N51MainController:_AttachEvents()
...
function UICN22N51MainController:_DetachEvents()
...
function UICN22N51MainController:_AfterUILayerChanged()
...
function UICN22N51MainController:_CheckActivityClose(id)
...
function UICN22N51MainController:_OnItemChanged(id)
  self:_Refresh()
end
