_class("UICN22N51LineMapNode", UICustomWidget)
UICN22N51LineMapNode = UICN22N51LineMapNode

function UICN22N51LineMapNode:OnShow(uiParams)
...
function UICN22N51LineMapNode:Destroy()
  self._matReq = UIWidgetHelper.DisposeLocalizedTMPMaterial(self._matReq)
end

function UICN22N51LineMapNode:SetStarSp(normapStar, normalNoStar, bossStar, bossNoStar)
...
function UICN22N51LineMapNode:SetData(lineCfg, passInfo, cb)
...
function UICN22N51LineMapNode:_SetState(state)
...
function UICN22N51LineMapNode:_SetRectTransform(lineCfg)
...
function UICN22N51LineMapNode:_SetName(state, text)
  local tb = {
    "name",
    "boss_name",
    "story_name"
...
function UICN22N51LineMapNode:_SetStar(passInfo)
...
function UICN22N51LineMapNode:_SetPlay(passInfo)
...
function UICN22N51LineMapNode:BtnOnClick(go)
