...
_class("UICNUIActivityCN18N47IntroType1Widget", UIIntroType1Widget)
UICNUIActivityCN18N47IntroType1Widget = UICNUIActivityCN18N47IntroType1Widget

function UICNUIActivityCN18N47IntroType1Widget:_PlayAnimation(animName, duration, callback)
...
function UICNUIActivityCN18N47IntroType1Widget:CloseDialog()
  self._uiView:CloseDialogWithAnimation()
end

function UICNUIActivityCN18N47IntroType1Widget:SetData(uiView, cfgId)
  self._uiView = uiView
  self._cfg = Cfg.cfg_intro_loader_type_1[cfgId]
  if not self._cfg then
    Log.exception("UICNUIActivityCN18N47IntroType1Widget:SetData() cfg_intro_loader_type_1[", cfgId, "] error")
    self:CloseDialog()
    return
  end
  self:_SetTitle()
...
function UICNUIActivityCN18N47IntroType1Widget:_SetTitle()
...
function UICNUIActivityCN18N47IntroType1Widget:_SetSubTitle()
...
function UICNUIActivityCN18N47IntroType1Widget:_SetIntro()
...
function UICNUIActivityCN18N47IntroType1Widget:_CalcLen(keyHead)
  local n = 0
  while true do
    n = n + 1
...
function UICNUIActivityCN18N47IntroType1Widget:CloseBtnOnClick(go)
