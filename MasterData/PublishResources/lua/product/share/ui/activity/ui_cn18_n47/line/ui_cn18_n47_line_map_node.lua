_class("UICN18N47LineMapNode", UICustomWidget)
UICN18N47LineMapNode = UICN18N47LineMapNode

function UICN18N47LineMapNode:OnShow(uiParams)
...
function UICN18N47LineMapNode:Destroy()
  self._matReq = UIWidgetHelper.DisposeLocalizedTMPMaterial(self._matReq)
end

function UICN18N47LineMapNode:SetStarSp(normapStar, normalNoStar, bossStar, bossNoStar)
...
function UICN18N47LineMapNode:SetData(lineCfg, passInfo, cb)
...
function UICN18N47LineMapNode:_SetState(state)
...
function UICN18N47LineMapNode:_SetRectTransform(lineCfg)
...
function UICN18N47LineMapNode:_SetName(state, text)
  local tb = {
    "name",
    "boss_name",
    "story_name"
...
function UICN18N47LineMapNode:_SetStar(passInfo)
...
function UICN18N47LineMapNode:_SetPlay(passInfo)
...
function UICN18N47LineMapNode:BtnOnClick(go)
