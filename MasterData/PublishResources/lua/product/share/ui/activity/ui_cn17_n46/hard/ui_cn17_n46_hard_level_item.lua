_class("UICN17N46HardLevelItem", UICustomWidget)
UICN17N46HardLevelItem = UICN17N46HardLevelItem

function UICN17N46HardLevelItem:Constructor(uiview)
  self._view = uiview
  self:OnShow()
end

function UICN17N46HardLevelItem:OnShow()
  ...
  self._rewardTop = self._view:GetUIComponent("Image", "RewardTop")
end

function UICN17N46HardLevelItem:OnHide()
end

function UICN17N46HardLevelItem:SetData(idx, cfg, passInfo, cur, atlas)
  if idx < cur then
    ...
    self._rewardTop.gameObject:SetActive(false)
  elseif cur < idx then
    self._pass.gameObject:SetActive(false)
    self._closeCanvasGroup.alpha = 1
    self._rewardTop.gameObject:SetActive(true)
  else
...
function UICN17N46HardLevelItem:LocalPosition()
  return self._localPos
end

function UICN17N46HardLevelItem:Anim_Pass()
  self._anim:Play("uieff_UIN28HardLevel_Finish")
end

function UICN17N46HardLevelItem:Anim_Open()
end

function UICN17N46HardLevelItem:SetActive(bShow)
