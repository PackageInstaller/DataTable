_class("UICN17N46LineMapLine", UICustomWidget)
UICN17N46LineMapLine = UICN17N46LineMapLine

function UICN17N46LineMapLine:OnShow()
  self._rect = self:GetUIComponent("RectTransform", "shape")
end

function UICN17N46LineMapLine:OnHide()
end

function UICN17N46LineMapLine:Flush(from, to)
