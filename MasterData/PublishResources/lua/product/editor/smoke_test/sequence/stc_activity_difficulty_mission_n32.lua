local difficultyMissionSequence = {
  ...
  [15] = {
    Type = "GM_PassMultiLineCampMission",
    Next = {16},
    Data = {110503206, 5321016}
  },
  [16] = {
    Type = "GM_PassLineCampMission",
    Next = {20},
    Data = {110500503, 5322004}
  },
  [20] = {
    Type = "DifficultyMissionActivity_GM_PassAll",
    Next = {40},
    Data = {}
  },
  [40] = {
  ...
  [52] = {
    Type = "DifficultyMission_BuildTeamN32",
    Next = {
      60,
      500,
      510
