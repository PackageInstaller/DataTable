__TestCaseSequence_ElementalEightPets = {
  [1] = {
  ...
  [20] = {
    Type = "EightPets_GM_PassCampMission",
    Next = {30}
  },
  [30] = {
    Type = "EightPets_BuildTeam",
    Next = {
      40,
      500,
      510
...
return __TestCaseSequence_ElementalEightPets
