...
_class("SailingMission_BuildTeam", Common_AsyncBase)
SailingMission_BuildTeam = SailingMission_BuildTeam

function SailingMission_BuildTeam:Constructor(_, teamIndex)
  self._teamIndex = teamIndex or TestConst.MissionTeamIndex
end

function SailingMission_BuildTeam:TaskFunc(TT, result)
  ...
  local layerId = runData:GetLayerID()
  local missionId = runData:GetMissionID()
  for i = 1, 3 do
    local updateFormationResult = sailingMissionModule:HandleChangeFormation(TT, layerId, missionId, petPstIds)
