...
_class("GoldbergEvent_EnterBattle", Common_AsyncBase)
GoldbergEvent_EnterBattle = GoldbergEvent_EnterBattle

function GoldbergEvent_EnterBattle:TaskFunc(TT, status)
