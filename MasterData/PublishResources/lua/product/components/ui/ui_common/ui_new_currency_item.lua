_class("UINewCurrencyItem", UICustomWidget)
UINewCurrencyItem = UINewCurrencyItem

function UINewCurrencyItem:OnShow()
  ...
  self.btnPanelGO = self:GetGameObject("btnPanel")
...
function UINewCurrencyItem:OnHide()
  self:RemoveListener()
end

function UINewCurrencyItem:AddListener()
...
function UINewCurrencyItem:RemoveListener()
...
function UINewCurrencyItem:OnItemCountChange()
  self:RefreshTxt()
end

function UINewCurrencyItem:GetTypeId()
  return self._typeId
end

function UINewCurrencyItem:SetAsShortForm(isShortForm)
  self._shortForm = isShortForm
end

function UINewCurrencyItem:SetData(typeId, iconClick, hideAddBtn)
  self._typeId = typeId
...
function UINewCurrencyItem:ShowSwitch(show)
  if self.switchGO then
    self.switchGO:SetActive(false)
  end
end

function UINewCurrencyItem:ShowOpen(open)
  if open then
...
function UINewCurrencyItem:SetAddCallBack(addCallBack)
  self._addCallBack = addCallBack
end

function UINewCurrencyItem:SetBgCallBack(bgCallBack)
  self._bgCallBack = bgCallBack
end

function UINewCurrencyItem:SetSwitchCallBack(switchCallBack)
  self._switchCallBack = switchCallBack
end

function UINewCurrencyItem:RefreshTxtTransform()
...
function UINewCurrencyItem:RefreshTxt()
  local countStr
...
function UINewCurrencyItem:SetText(str)
  self.txt:SetText(str)
end

function UINewCurrencyItem:RefreshBg()
  if not self._hideAddBtn and (self._typeId == RoleAssetID.RoleAssetFirefly or self._typeId == RoleAssetID.RoleAssetDiamond or self._typeId == RoleAssetID.RoleAssetGlow or self._typeId == RoleAssetID.RoleAssetPhyPoint or self._typeId == RoleAssetID.RoleAssetAtom or self._typeId == RoleAssetID.RoleAssetFurnitureCoin or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkin or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkinGL or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkinKR or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkinKL_Re or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkinBLH or self._typeId == RoleAssetID.RoleAssetDrawCard100 or self._typeId == RoleAssetID.RoleAssetDrawCard101 or self._typeId == RoleAssetID.RoleAssetGold or self._typeId == RoleAssetID.RoleAssetXingZuan or self._typeId == RoleAssetID.RoleAssetHuiYao or self._typeId == 3000266 or self._typeId == 3000342 or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkinQT2 or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkinQT3 or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkinBLH_ReRe or self._typeId == RoleAssetID.RoleAssetDrawCardSeniorSkinPLM_Re or self._typeId == RoleAssetID.RoleAssetHongPiao or self._typeId == 3000365) then
...
function UINewCurrencyItem:SetBtnActive(bActive)
  self.btnGO:SetActive(bActive)
  self.btnPanelGO:SetActive(bActive)
end

function UINewCurrencyItem:CloseAddBtn()
  self._hideAddBtn = true
  self:RefreshBg()
end

function UINewCurrencyItem:btnOnClick(go)
  if self._typeId == RoleAssetID.RoleAssetDiamond then
    local mShop = self:GetModule(ShopModule)
...
function UINewCurrencyItem:IconOnClick()
...
function UINewCurrencyItem:bgOnClick()
  if self._bgCallBack then
    self._bgCallBack(self._typeId)
  end
end

function UINewCurrencyItem:btnopenOnClick()
  if self._switchCallBack then
    self._switchCallBack()
  end
end

function UINewCurrencyItem:ShowRollingAnim(deltaCount, duration)
end

function UINewCurrencyItem:GetUIText()
  return self.txt
end
