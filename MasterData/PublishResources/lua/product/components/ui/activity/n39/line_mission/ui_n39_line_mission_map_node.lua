_class("UIN39LineMissionMapNode", UICustomWidget)
UIN39LineMissionMapNode = UIN39LineMissionMapNode

function UIN39LineMissionMapNode:OnShow(uiParams)
  self._rectTransform = self:GetGameObject():GetComponent("RectTransform")
end

function UIN39LineMissionMapNode:Destroy()
  self._matReq = UIWidgetHelper.DisposeLocalizedTMPMaterial(self._matReq)
end

function UIN39LineMissionMapNode:SetData(lineCfg, passInfo, cb)
...
function UIN39LineMissionMapNode:_SetRectTransform(lineCfg)
...
function UIN39LineMissionMapNode:_SetName(state, text)
  local tb = {
    "name_normal",
    "name_boss",
    "name_plot"
...
function UIN39LineMissionMapNode:_SetName_TMP(state, text)
  local tb = {
    "name_normal",
    "name_boss",
    "name_plot"
  ...
  local tb2 = {
    "uieff_uin39_line_normal.mat",
    "uieff_uin39_line_boss.mat",
    "uieff_uin39_line_plot.mat"
  }
...
function UIN39LineMissionMapNode:_SetState(state)
  ...
  do return end
  local atlasName = "UIN39.spriteatlas"
  local spriteName1 = state == 2 and "n39_xxg_star03" or "n39_xxg_star01"
  local spriteName2 = state == 2 and "n39_xxg_star04" or "n39_xxg_star02"
  local tbStar = {
    "Star1",
    "Star2",
    "Star3"
  ...
  local spriteName3 = state == 2 and "n39_xxg_di07" or "n39_xxg_di06"
  UIWidgetHelper.SetImageSprite(self, "name_bg", atlasName, spriteName3)
end

function UIN39LineMissionMapNode:_SetStar(passInfo)
...
function UIN39LineMissionMapNode:BtnOnClick(go)
