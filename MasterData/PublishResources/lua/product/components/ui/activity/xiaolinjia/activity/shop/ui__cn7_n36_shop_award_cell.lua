_class("UICN7N36ShopAwardCell", UICustomWidget)
UICN7N36ShopAwardCell = UICN7N36ShopAwardCell

function UICN7N36ShopAwardCell:OnShow(uiParams)
  self._atlas = self:GetAsset("XiaoLinJia.spriteatlas", LoadType.SpriteAtlas)
  self:_GetComponents()
end

function UICN7N36ShopAwardCell:_GetComponents()
...
function UICN7N36ShopAwardCell:InitData(data, itemInfoCallback, showBlackMask, delayTime)
  self._data = data
...
function UICN7N36ShopAwardCell:_FillUi()
...
function UICN7N36ShopAwardCell:OnHide()
  UnityEngine.Object.Destroy(self.itemIconRawImg.material)
end

function UICN7N36ShopAwardCell:ItemIconOnClick(go)
  if self._itemInfoCallback then
    self._itemInfoCallback(self._data)
  end
end

function UICN7N36ShopAwardCell:NormalBgOnClick(go)
  if self._itemInfoCallback then
    self._itemInfoCallback(self._data)
  end
end

function UICN7N36ShopAwardCell:SpecialBgOnClick(go)
  if self._itemInfoCallback then
    self._itemInfoCallback(self._data)
  end
end

function UICN7N36ShopAwardCell:SetStencil()
