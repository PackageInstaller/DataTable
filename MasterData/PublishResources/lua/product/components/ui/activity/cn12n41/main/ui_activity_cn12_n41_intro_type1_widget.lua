...
_class("UIActivityCN12N41IntroType1Widget", UIIntroType1Widget)
UIActivityCN12N41IntroType1Widget = UIActivityCN12N41IntroType1Widget

function UIActivityCN12N41IntroType1Widget:_PlayAnimation(animName, duration, callback)
...
function UIActivityCN12N41IntroType1Widget:CloseDialog()
  self._uiView:CloseDialogWithAnimation()
end

function UIActivityCN12N41IntroType1Widget:SetData(uiView, cfgId)
  self._uiView = uiView
  self._cfg = Cfg.cfg_intro_loader_type_1[cfgId]
  if not self._cfg then
    Log.exception("UIActivityCN12N41IntroType1Widget:SetData() cfg_intro_loader_type_1[", cfgId, "] error")
    self:CloseDialog()
    return
  end
  self:_SetTitle()
...
function UIActivityCN12N41IntroType1Widget:_SetTitle()
...
function UIActivityCN12N41IntroType1Widget:_SetSubTitle()
...
function UIActivityCN12N41IntroType1Widget:_SetIntro()
...
function UIActivityCN12N41IntroType1Widget:_CalcLen(keyHead)
  local n = 0
  while true do
    n = n + 1
...
function UIActivityCN12N41IntroType1Widget:CloseBtnOnClick(go)
