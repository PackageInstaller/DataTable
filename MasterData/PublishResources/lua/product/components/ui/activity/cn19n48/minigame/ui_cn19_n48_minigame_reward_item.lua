_class("UICN19N48MiniGameRewardItem", UICustomWidget)
UICN19N48MiniGameRewardItem = UICN19N48MiniGameRewardItem

function UICN19N48MiniGameRewardItem:OnShow(uiParams)
  self:_GetComponents()
end

function UICN19N48MiniGameRewardItem:_GetComponents()
  self._uiItem = self:GetUIComponent("UISelectObjectPath", "uiitem")
  self._lock = self:GetGameObject("Lock")
end

function UICN19N48MiniGameRewardItem:SetData(data, scoretype, missioninfo, callback)
...
function UICN19N48MiniGameRewardItem:_OnValue()
...
function UICN19N48MiniGameRewardItem:RefreshUIInfo(missioninfo)
  self._missionInfo = missioninfo
...
function UICN19N48MiniGameRewardItem:ShowTips(go)
