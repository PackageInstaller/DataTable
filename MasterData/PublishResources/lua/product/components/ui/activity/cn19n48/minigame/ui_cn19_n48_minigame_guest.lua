_class("UICN19N48MiniGameGuest", UICustomWidget)
UICN19N48MiniGameGuest = UICN19N48MiniGameGuest

function UICN19N48MiniGameGuest:Constructor()
  self._inited = false
end

function UICN19N48MiniGameGuest:OnShow(uiParams)
  self:_GetComponents()
end

function UICN19N48MiniGameGuest:_GetComponents()
...
function UICN19N48MiniGameGuest:SetActive(active)
  self.view.gameObject:SetActive(active)
end

function UICN19N48MiniGameGuest:SetData(id)
  self.id = id
...
function UICN19N48MiniGameGuest:Happy(orderform, mood)
...
function UICN19N48MiniGameGuest:PlayAnimation(mood)
