...
function UIActivityN11LineMissionController_Review:LoadDataOnEnter(TT, res, uiParams)
  ...
  self._campaign:LoadCampaignInfo(TT, res, self._campaignType, self._componentId_LineMission, self._componentId_LineMissionReviewProcess)
...
function UIActivityN11LineMissionController_Review:OnShow(uiParams)
  ...
  UIActivityN11LineMissionController_Review.SLeval = 111111
  UIActivityN11LineMissionController_Review.Passed = 888
...
function UIActivityN11LineMissionController_Review:_EnterStage(stageId, worldPos)
  ...
  self:ShowDialog("UIActivityLevelStageNew", stageId, self._line_info.m_pass_mission_info[stageId], self._line_component, autoFightShow, nil, true, true, nil, nil, nil, true)
end
