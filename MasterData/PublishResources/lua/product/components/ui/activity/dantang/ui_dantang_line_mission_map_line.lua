_class("UIDantangLineMissionMapLine", UICustomWidget)
UIDantangLineMissionMapLine = UIDantangLineMissionMapLine

function UIDantangLineMissionMapLine:OnShow()
  self._rect = self:GetUIComponent("RectTransform", "shape")
end

function UIDantangLineMissionMapLine:OnHide()
end

function UIDantangLineMissionMapLine:Flush(from, to)
