_class("UISeasonShowAwardsItemS2", UICustomWidget)
UISeasonShowAwardsItemS2 = UISeasonShowAwardsItemS2
local maxNumCount = 5

function UISeasonShowAwardsItemS2:OnShow(uiParams)
  ...
  self.uiItem = sop:SpawnObject("UISeasonItemS2")
end

function UISeasonShowAwardsItemS2:SetData(itemInfo, index, clickCallback, nameColor, tweenIdx, beforeTime)
...
function UISeasonShowAwardsItemS2:_PlayAnim()
  self._anim:Play("uieff_UIGetItemControllerItem")
end

function UISeasonShowAwardsItemS2:GetIndex()
  return self._index
end

function UISeasonShowAwardsItemS2:OnHide()
  if self._tweenEvent then
    GameGlobal.Timer():CancelEvent(self._tweenEvent)
    self._tweenEvent = nil
  end
...
function UISeasonShowAwardsItemS2:FormatItemCount(count)
