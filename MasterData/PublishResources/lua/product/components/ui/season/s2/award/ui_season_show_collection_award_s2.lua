_class("UISeasonShowCollectionAwardS2", UIController)
UISeasonShowCollectionAwardS2 = UISeasonShowCollectionAwardS2

function UISeasonShowCollectionAwardS2:GetComponents()
...
function UISeasonShowCollectionAwardS2:OnShow(uiParams)
  self._closeCallback = uiParams[2]
  self:GetComponents()
  local item_module = GameGlobal.GetModule(ItemModule)
  local roleAsset
  if not uiParams[1] then
    Log.fatal("###[UISeasonShowCollectionAwardS2] uiParams[1] is nil !")
  end
...
function UISeasonShowCollectionAwardS2:FlushItem(itemData)
...
function UISeasonShowCollectionAwardS2:CreateData(roleAsset)
...
function UISeasonShowCollectionAwardS2:ClosePanel()
  self:CloseDialog()
end

function UISeasonShowCollectionAwardS2:OnHide()
  if self._closeCallback then
    self._closeCallback()
  end
end

function UISeasonShowCollectionAwardS2:IconBgOnClick(go)
end

function UISeasonShowCollectionAwardS2:BgOnClick(go)
  self:ClosePanel()
end

local modf = math.modf

function UISeasonShowCollectionAwardS2:_FormatItemCount(itemCount)
  return HelperProxy:GetInstance():FormatItemCount(itemCount)
end

function UISeasonShowCollectionAwardS2:CloseBtnOnClick(go)
  self:ClosePanel()
end

function UISeasonShowCollectionAwardS2:ShowTips(itemId, pos)
