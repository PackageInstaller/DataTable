_class("UIS7HelperBanner", UICustomWidget)
UIS7HelperBanner = UIS7HelperBanner

function UIS7HelperBanner:OnShow()
  self:InitWidget()
end

function UIS7HelperBanner:OnHide()
...
function UIS7HelperBanner:SetData(tabIndex)
  if tabIndex then
...
function UIS7HelperBanner:InitWidget()
  ...
  self._cellWidget1 = cellGen1:SpawnObject("UIS7HelperBannerItem")
  local cellGen2 = self:GetUIComponent("UISelectObjectPath", "CellArea2")
  self._cellWidget2 = cellGen2:SpawnObject("UIS7HelperBannerItem")
...
function UIS7HelperBanner:ScrollToIndex(tarIdx)
...
function UIS7HelperBanner:ImageLeftOnClick(go)
...
function UIS7HelperBanner:ImageRightOnClick(go)
  AudioHelperController.PlayUISoundAutoRelease(CriAudioIDConst.SoundDefaultClick)
  if self._count <= 1 then
    return
  end
...
function UIS7HelperBanner:InitScrollView()
...
function UIS7HelperBanner:_RefreshArrowBtn()
  local showLeft = true
...
function UIS7HelperBanner:_MatchOpenTime(cfgTab)
...
function UIS7HelperBanner:_CreateScrollData()
  self._carouselTab = {}
...
function UIS7HelperBanner:_CreateScrollItem()
  self._grid = self:GetUIComponent("UISelectObjectPath", "grid")
  self._grid:SpawnObjects("UIS7HelperBannerIdxItem", self._count)
...
function UIS7HelperBanner:_SetScrollCellData(cellWidget, dataIndex)
...
function UIS7HelperBanner:_CreateScrollEvent()
  do return end
...
function UIS7HelperBanner:_SetCellForNormal()
...
function UIS7HelperBanner:_SetCellForAnim()
  self._cellArea1Go:SetActive(true)
...
function UIS7HelperBanner:OnUpdate(deltaTimeMS)
  if self._isScrollReady and self._count <= 1 then
    return
  end
end

function UIS7HelperBanner:_PlayScrollAnim(bDown)
  self._cellCanvas1.alpha = 1
