_class("UISeasonStageAwardItemS7", UICustomWidget)
UISeasonStageAwardItemS7 = UISeasonStageAwardItemS7

function UISeasonStageAwardItemS7:OnShow()
  self._trans = self:GetGameObject()
  self:GetComponents()
end

function UISeasonStageAwardItemS7:GetComponents()
  self._trans = self:GetGameObject()
...
function UISeasonStageAwardItemS7:Flush(v, levelDiff)
  if not v then
    return
  end
  self._v = v
...
function UISeasonStageAwardItemS7:SetIcon(name, itemId)
...
function UISeasonStageAwardItemS7:ShowIcon(show, itemId)
  self._iconGO:SetActive(show)
  self:SetIconOffset(itemId)
end

function UISeasonStageAwardItemS7:SetIconOffset(itemId)
...
function UISeasonStageAwardItemS7:_IsPet(id)
  local cfg = Cfg.cfg_pet({ID = id})
  return cfg and true or false
end

function UISeasonStageAwardItemS7:SetQuality(quality)
  if quality <= 0 then
    quality = 1
  end
...
function UISeasonStageAwardItemS7:ShowQuality(show)
  self._qualityGO:SetActive(show)
end

function UISeasonStageAwardItemS7:SetText1(text, showNumber)
  if text ~= nil then
    local show = false
...
function UISeasonStageAwardItemS7:ShowText1(show)
  self._text1GO:SetActive(show)
  self:SetOffset(show)
end

function UISeasonStageAwardItemS7:SetOffset(showText1)
end

function UISeasonStageAwardItemS7:SetAwardText(awardText, color)
  self._awardTxt:SetText(awardText)
  self._awardTxt.color = color
end

function UISeasonStageAwardItemS7:SetTypeBg(typeBgName)
end

function UISeasonStageAwardItemS7:SetTypeMainBg(typeBgName)
end

function UISeasonStageAwardItemS7:SetTopAward()
  self:SetTopText(self._topTextStr)
end

function UISeasonStageAwardItemS7:SetTopText(text)
...
function UISeasonStageAwardItemS7:ShowTopText(show)
  self._topGo:SetActive(show)
end

function UISeasonStageAwardItemS7:SetAct()
...
function UISeasonStageAwardItemS7:ShowText(show)
  self._actGo:SetActive(show)
end

function UISeasonStageAwardItemS7:BtnOnClick(go)
...
function UISeasonStageAwardItemS7:PlayAnim(totalDelay)
...
function UISeasonStageAwardItemS7:_PlayInAnim()
  if self._anim then
...
function UISeasonStageAwardItemS7:OnHide()
  if self._animTimer then
    GameGlobal.Timer():CancelEvent(self._animTimer)
    self._animTimer = nil
  end
...
function UISeasonStageAwardItemS7:SetWaitAnim()
  if self._rootGo then
