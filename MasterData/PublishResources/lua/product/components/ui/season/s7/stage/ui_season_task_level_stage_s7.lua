_class("UISeasonTaskLevelStageS7", UIController)
UISeasonTaskLevelStageS7 = UISeasonTaskLevelStageS7

function UISeasonTaskLevelStageS7:LoadDataOnEnter(TT, res)
...
function UISeasonTaskLevelStageS7:OnShow(uiParams)
...
function UISeasonTaskLevelStageS7:_GetComponents()
...
function UISeasonTaskLevelStageS7:RefreshPanelBg()
...
function UISeasonTaskLevelStageS7:RefreshPanelText()
  if self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
...
function UISeasonTaskLevelStageS7:_OnValue()
...
function UISeasonTaskLevelStageS7:BtnFightOnClick(go)
...
function UISeasonTaskLevelStageS7:ShowTips(itemId, pos)
  self._tips:SetData(itemId, pos)
end

function UISeasonTaskLevelStageS7:BgOnClick()
  self:Close()
end

function UISeasonTaskLevelStageS7:InitChapterName()
...
function UISeasonTaskLevelStageS7:InitEnemys()
  self:_InitEnemy()
  self:_RefreshEnemyArea()
end

function UISeasonTaskLevelStageS7:_InitEnemy()
...
function UISeasonTaskLevelStageS7:_RefreshEnemyArea()
  self._enemyNormalGo = self:GetGameObject("enemy_normal")
  self._enemyNormalGo:SetActive(true)
end

function UISeasonTaskLevelStageS7:RefreshRecommendLv()
...
function UISeasonTaskLevelStageS7:Close()
  self:_CloseDialogWithAnim()
end

function UISeasonTaskLevelStageS7:_CloseDialogWithAnim(callback)
...
function UISeasonTaskLevelStageS7:_Resume()
...
function UISeasonTaskLevelStageS7:BattleInfoPanelBtnOnClick()
  self._curPanel = UISeasonLevelStagePanelMode.BattleInfo
  self:RefreshPanelShow()
  self:RefreshPanelBg()
  self:RefreshPanelText()
...
function UISeasonTaskLevelStageS7:AwardsPanelBtnOnClick()
...
function UISeasonTaskLevelStageS7:_ShowMainUI(show)
