_class("UISeasonMainOvalTipS7", Object)
UISeasonMainOvalTipS7 = UISeasonMainOvalTipS7

function UISeasonMainOvalTipS7:Constructor(seasonID, req, onClick)
  ...
  self._atlas = UIResourceManager.GetAsset("UIS7Main.spriteatlas", LoadType.SpriteAtlas, self._name2Asset)
end

function UISeasonMainOvalTipS7:TargetWorldPos()
...
function UISeasonMainOvalTipS7:Show()
  self._isIn = false
  local show = true
...
function UISeasonMainOvalTipS7:Hide()
  self._isIn = true
  self._gameObject:SetActive(false)
end

function UISeasonMainOvalTipS7:Delete()
  self._req = nil
...
function UISeasonMainOvalTipS7:GetReq()
  return self._req
end

function UISeasonMainOvalTipS7:Dispose()
  self._req:Dispose()
  self:Delete()
end

function UISeasonMainOvalTipS7:IsInOval()
  return self._isIn
end

function UISeasonMainOvalTipS7:Sync(pos, rot)
  self._rectTransform.anchoredPosition = pos
  self._arrowRect.localRotation = rot
end

function UISeasonMainOvalTipS7:Type()
  return self._type
end

function UISeasonMainOvalTipS7:Target()
  return self._target
end

function UISeasonMainOvalTipS7:IconOnClick()
  self._onClick(self)
end

function UISeasonMainOvalTipS7:ArrowIconOnClick()
  self._onClick(self)
end

function UISeasonMainOvalTipS7:ResetTarget(target, type)
  self._uiView:SetShow(false, self)
  self._uiView:SetShow(true, self)
  self._type = type
...
function UISeasonMainOvalTipS7:GetCanShowDistance(cameraSize)
...
function UISeasonMainOvalTipS7:_RefreshIcon()
  if self._type == UISeasonOvalTipType.Player then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S7_map_arrowhead_yellow")
  ...
  elseif self._type == UISeasonOvalTipType.Mission then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S7_map_arrowhead_red")
  elseif self._type == UISeasonOvalTipType.Daily then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S7_map_arrowhead_green")
  elseif self._type == UISeasonOvalTipType.Box then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S7_map_arrowhead_blue")
  elseif self._type == UISeasonOvalTipType.Task then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S7_map_icon33")
  end
end

function UISeasonMainOvalTipS7:_RefreshIconBackTrack()
  if self._type == UISeasonOvalTipType.Player then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S7_map_arrowhead_yellow")
