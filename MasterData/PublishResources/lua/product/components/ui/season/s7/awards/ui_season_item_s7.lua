_class("UISeasonItemS7", UICustomWidget)
UISeasonItemS7 = UISeasonItemS7

function UISeasonItemS7:Constructor()
  self.mRole = GameGlobal.GetModule(RoleModule)
  self.colorTxtCount = Color.white
end

function UISeasonItemS7:OnShow()
...
function UISeasonItemS7:OnHide()
  self.imgIcon:DestoryLastImage()
end

function UISeasonItemS7:Flush(roleAsset, funcClick, notShowTips)
...
function UISeasonItemS7:SetFin(show)
  self:GetGameObject("_fin"):SetActive(show)
end

function UISeasonItemS7:FormatCount(count)
...
function UISeasonItemS7:TxtCountRedIfNotEnough(cost)
...
function UISeasonItemS7:SetNotShowTips(notShowTips)
  self._notShowTips = notShowTips
end

function UISeasonItemS7:BtnOnClick(go)
...
function UISeasonItemS7:GetBtn()
  return self.bgGo
end

function UISeasonItemS7:SetRect(scale)
