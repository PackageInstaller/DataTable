_class("UISeasonTaskLevelStageS3", UIController)
UISeasonTaskLevelStageS3 = UISeasonTaskLevelStageS3

function UISeasonTaskLevelStageS3:LoadDataOnEnter(TT, res)
...
function UISeasonTaskLevelStageS3:OnShow(uiParams)
...
function UISeasonTaskLevelStageS3:_GetComponents()
...
function UISeasonTaskLevelStageS3:RefreshPanelBg()
...
function UISeasonTaskLevelStageS3:RefreshPanelText()
  if self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
...
function UISeasonTaskLevelStageS3:_OnValue()
...
function UISeasonTaskLevelStageS3:BtnFightOnClick(go)
...
function UISeasonTaskLevelStageS3:ShowTips(itemId, pos)
  self._tips:SetData(itemId, pos)
end

function UISeasonTaskLevelStageS3:BgOnClick()
  self:Close()
end

function UISeasonTaskLevelStageS3:InitChapterName()
...
function UISeasonTaskLevelStageS3:InitEnemys()
  self:_InitEnemy()
  self:_RefreshEnemyArea()
end

function UISeasonTaskLevelStageS3:_InitEnemy()
...
function UISeasonTaskLevelStageS3:_RefreshEnemyArea()
  self._enemyNormalGo = self:GetGameObject("enemy_normal")
  self._enemyNormalGo:SetActive(true)
end

function UISeasonTaskLevelStageS3:RefreshRecommendLv()
...
function UISeasonTaskLevelStageS3:Close()
  self:_CloseDialogWithAnim()
end

function UISeasonTaskLevelStageS3:_CloseDialogWithAnim(callback)
...
function UISeasonTaskLevelStageS3:_Resume()
...
function UISeasonTaskLevelStageS3:BattleInfoPanelBtnOnClick()
  self._curPanel = UISeasonLevelStagePanelMode.BattleInfo
  self:RefreshPanelShow()
  self:RefreshPanelBg()
  self:RefreshPanelText()
...
function UISeasonTaskLevelStageS3:AwardsPanelBtnOnClick()
...
function UISeasonTaskLevelStageS3:_ShowMainUI(show)
