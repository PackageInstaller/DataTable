_class("UISeasonBuffMainAreaS3", UICustomWidget)
UISeasonBuffMainAreaS3 = UISeasonBuffMainAreaS3

function UISeasonBuffMainAreaS3:OnShow(uiParams)
...
function UISeasonBuffMainAreaS3:DetailBtnOnClick()
...
function UISeasonBuffMainAreaS3:SetData(obj)
  self._seasonObj = obj
  self._progressCells = self.progressCellsGen:SpawnObject("UISeasonBuffProgressCellsS3")
  self:RefreshInfo()
end

function UISeasonBuffMainAreaS3:RefreshInfo()
