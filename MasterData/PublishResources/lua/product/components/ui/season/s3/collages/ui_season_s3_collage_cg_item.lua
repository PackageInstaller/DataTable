_class("UISeasonS3CollageCGItem", UICustomWidget)
UISeasonS3CollageCGItem = UISeasonS3CollageCGItem

function UISeasonS3CollageCGItem:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonS3CollageCGItem:InitWidget()
...
function UISeasonS3CollageCGItem:SetData(data, onClick)
  self._data = data
...
function UISeasonS3CollageCGItem:SetNew(new)
  self.new:SetActive(new)
end

function UISeasonS3CollageCGItem:RootOnClick(go)
  self._onClick(self._data)
end

function UISeasonS3CollageCGItem:ResetShareState()
...
function UISeasonS3CollageCGItem:PlayExitAnim()
end
