_class("UIWidgetSeasonResultRewardS3", UICustomWidget)
UIWidgetSeasonResultRewardS3 = UIWidgetSeasonResultRewardS3

function UIWidgetSeasonResultRewardS3:OnShow()
  self._trans = self:GetGameObject()
  self._itemID = nil
  local sop = self:GetUIComponent("UISelectObjectPath", "uiitem")
  self.uiItem = sop:SpawnObject("UISeasonResultItemS3")
...
function UIWidgetSeasonResultRewardS3:SetShotEffStartTime()
  self.effStartTime = 750
end

function UIWidgetSeasonResultRewardS3:Init(count, iconID, threeStar, returnPrism, firstPass, extAward, doubleExtAward, activityAward, returnHelpAward)
...
function UIWidgetSeasonResultRewardS3:GetNormalTxt()
...
function UIWidgetSeasonResultRewardS3:HasItem(dataList)
...
function UIWidgetSeasonResultRewardS3:BGOnClick(go)
  GameGlobal.GameRecorder():RecordAction(GameRecordAction.UIInput, {
    ui = "UIWidgetSeasonResultRewardS3",
    input = "BGOnClick",
    args = {}
  })
...
function UIWidgetSeasonResultRewardS3:SetLevelDiff(levelDiff)
  ...
  local atlasName = "UIS3Stage.spriteatlas"
