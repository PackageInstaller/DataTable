_class("UISeasonActionPointTipS3", UIController)
UISeasonActionPointTipS3 = UISeasonActionPointTipS3

function UISeasonActionPointTipS3:LoadDataOnEnter(TT, res)
  res:SetSucc(true)
end

function UISeasonActionPointTipS3:OnShow(uiParams)
  self:InitWidget()
  self._cpt = uiParams[1]
  local pos = uiParams[2]
  self.root.anchoredPosition = pos + Vector2(-10, 30)
...
function UISeasonActionPointTipS3:OnHide()
  if self._timer then
...
function UISeasonActionPointTipS3:InitWidget()
...
function UISeasonActionPointTipS3:BgOnClick(go)
  self:CloseDialog()
end

function UISeasonActionPointTipS3:_Countdown()
...
function UISeasonActionPointTipS3:_ReqFlush(TT)
