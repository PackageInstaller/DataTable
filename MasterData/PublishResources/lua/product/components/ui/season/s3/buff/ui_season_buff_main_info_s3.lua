_class("UISeasonBuffMainInfoS3", UIController)
UISeasonBuffMainInfoS3 = UISeasonBuffMainInfoS3

function UISeasonBuffMainInfoS3:OnShow(uiParams)
...
function UISeasonBuffMainInfoS3:InitInfo()
  ...
  self._progressCells = self.progressCellsGen:SpawnObject("UISeasonBuffProgressCellsS3")
  self._progressCells:SetData(self._curProgress, self._curMaxProgress)
end

function UISeasonBuffMainInfoS3:RefreshContent()
...
function UISeasonBuffMainInfoS3:BgOnClick()
  self:CloseDialog()
end

function UISeasonBuffMainInfoS3:CloseBtnOnClick()
  self:CloseDialog()
end

function UISeasonBuffMainInfoS3:NextBtnOnClick()
...
function UISeasonBuffMainInfoS3:PrevBtnOnClick()
  self.nextBtnGo:SetActive(true)
  self.prevBtnGo:SetActive(false)
  self._curShowContentLevel = self._curShowContentLevel - 1
  self:RefreshContent()
...
function UISeasonBuffMainInfoS3:HelpOnClick()
  GameGlobal.UIStateManager():ShowDialog("UISeasonBuffMainTipsS3")
end
