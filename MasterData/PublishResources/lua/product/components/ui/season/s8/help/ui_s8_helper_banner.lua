_class("UIS8HelperBanner", UICustomWidget)
UIS8HelperBanner = UIS8HelperBanner

function UIS8HelperBanner:OnShow()
  self:InitWidget()
end

function UIS8HelperBanner:OnHide()
...
function UIS8HelperBanner:SetData(tabIndex)
  if tabIndex then
...
function UIS8HelperBanner:InitWidget()
  ...
  self._cellWidget1 = cellGen1:SpawnObject("UIS8HelperBannerItem")
  local cellGen2 = self:GetUIComponent("UISelectObjectPath", "CellArea2")
  self._cellWidget2 = cellGen2:SpawnObject("UIS8HelperBannerItem")
...
function UIS8HelperBanner:ScrollToIndex(tarIdx)
...
function UIS8HelperBanner:ImageLeftOnClick(go)
...
function UIS8HelperBanner:ImageRightOnClick(go)
  AudioHelperController.PlayUISoundAutoRelease(CriAudioIDConst.SoundDefaultClick)
  if self._count <= 1 then
    return
  end
...
function UIS8HelperBanner:InitScrollView()
...
function UIS8HelperBanner:_RefreshArrowBtn()
  local showLeft = true
...
function UIS8HelperBanner:_MatchOpenTime(cfgTab)
...
function UIS8HelperBanner:_CreateScrollData()
  self._carouselTab = {}
...
function UIS8HelperBanner:_CreateScrollItem()
  self._grid = self:GetUIComponent("UISelectObjectPath", "grid")
  self._grid:SpawnObjects("UIS8HelperBannerIdxItem", self._count)
...
function UIS8HelperBanner:_SetScrollCellData(cellWidget, dataIndex)
...
function UIS8HelperBanner:_CreateScrollEvent()
  do return end
...
function UIS8HelperBanner:_SetCellForNormal()
...
function UIS8HelperBanner:_SetCellForAnim()
  self._cellArea1Go:SetActive(true)
...
function UIS8HelperBanner:OnUpdate(deltaTimeMS)
  if self._isScrollReady and self._count <= 1 then
    return
  end
end

function UIS8HelperBanner:_PlayScrollAnim(bDown)
  self._cellCanvas1.alpha = 1
