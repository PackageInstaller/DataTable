_class("UISeasonTaskLevelStageS8", UIController)
UISeasonTaskLevelStageS8 = UISeasonTaskLevelStageS8

function UISeasonTaskLevelStageS8:LoadDataOnEnter(TT, res)
...
function UISeasonTaskLevelStageS8:OnShow(uiParams)
...
function UISeasonTaskLevelStageS8:_GetComponents()
...
function UISeasonTaskLevelStageS8:RefreshPanelBg()
...
function UISeasonTaskLevelStageS8:RefreshPanelText()
  if self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
...
function UISeasonTaskLevelStageS8:_OnValue()
...
function UISeasonTaskLevelStageS8:BtnFightOnClick(go)
...
function UISeasonTaskLevelStageS8:ShowTips(itemId, pos)
  self._tips:SetData(itemId, pos)
end

function UISeasonTaskLevelStageS8:BgOnClick()
  self:Close()
end

function UISeasonTaskLevelStageS8:InitChapterName()
...
function UISeasonTaskLevelStageS8:InitEnemys()
  self:_InitEnemy()
  self:_RefreshEnemyArea()
end

function UISeasonTaskLevelStageS8:_InitEnemy()
...
function UISeasonTaskLevelStageS8:_RefreshEnemyArea()
  self._enemyNormalGo = self:GetGameObject("enemy_normal")
  self._enemyNormalGo:SetActive(true)
end

function UISeasonTaskLevelStageS8:RefreshRecommendLv()
...
function UISeasonTaskLevelStageS8:Close()
  self:_CloseDialogWithAnim()
end

function UISeasonTaskLevelStageS8:_CloseDialogWithAnim(callback)
...
function UISeasonTaskLevelStageS8:_Resume()
...
function UISeasonTaskLevelStageS8:BattleInfoPanelBtnOnClick()
  self._curPanel = UISeasonLevelStagePanelMode.BattleInfo
  self:RefreshPanelShow()
  self:RefreshPanelBg()
  self:RefreshPanelText()
...
function UISeasonTaskLevelStageS8:AwardsPanelBtnOnClick()
...
function UISeasonTaskLevelStageS8:_ShowMainUI(show)
