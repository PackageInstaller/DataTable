_class("UIS5HelperBanner", UICustomWidget)
UIS5HelperBanner = UIS5HelperBanner

function UIS5HelperBanner:OnShow()
  self:InitWidget()
end

function UIS5HelperBanner:OnHide()
...
function UIS5HelperBanner:SetData(tabIndex)
  if tabIndex then
...
function UIS5HelperBanner:InitWidget()
  ...
  self._cellWidget1 = cellGen1:SpawnObject("UIS5HelperBannerItem")
  local cellGen2 = self:GetUIComponent("UISelectObjectPath", "CellArea2")
  self._cellWidget2 = cellGen2:SpawnObject("UIS5HelperBannerItem")
...
function UIS5HelperBanner:ScrollToIndex(tarIdx)
...
function UIS5HelperBanner:ImageLeftOnClick(go)
...
function UIS5HelperBanner:ImageRightOnClick(go)
  AudioHelperController.PlayUISoundAutoRelease(CriAudioIDConst.SoundDefaultClick)
  if self._count <= 1 then
    return
  end
...
function UIS5HelperBanner:InitScrollView()
...
function UIS5HelperBanner:_RefreshArrowBtn()
  local showLeft = true
...
function UIS5HelperBanner:_MatchOpenTime(cfgTab)
...
function UIS5HelperBanner:_CreateScrollData()
  self._carouselTab = {}
...
function UIS5HelperBanner:_CreateScrollItem()
  self._grid = self:GetUIComponent("UISelectObjectPath", "grid")
  self._grid:SpawnObjects("UIS5HelperBannerIdxItem", self._count)
...
function UIS5HelperBanner:_SetScrollCellData(cellWidget, dataIndex)
...
function UIS5HelperBanner:_CreateScrollEvent()
  do return end
...
function UIS5HelperBanner:_SetCellForNormal()
...
function UIS5HelperBanner:_SetCellForAnim()
  self._cellArea1Go:SetActive(true)
...
function UIS5HelperBanner:OnUpdate(deltaTimeMS)
  if self._isScrollReady and self._count <= 1 then
    return
  end
end

function UIS5HelperBanner:_PlayScrollAnim(bDown)
  self._cellCanvas1.alpha = 1
