_class("UISeasonBuffLevelUpS5", UIController)
UISeasonBuffLevelUpS5 = UISeasonBuffLevelUpS5

function UISeasonBuffLevelUpS5:LoadDataOnEnter(TT, res, uiParams)
...
function UISeasonBuffLevelUpS5:OnShow(uiParams)
...
function UISeasonBuffLevelUpS5:OnUpdate(deltaTimeMS)
...
function UISeasonBuffLevelUpS5:FullScreenBtnOnClick(go)
