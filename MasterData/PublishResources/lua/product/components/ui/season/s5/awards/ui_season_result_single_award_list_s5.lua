_class("UISeasonResultSingleAwardListS5", UICustomWidget)
UISeasonResultSingleAwardListS5 = UISeasonResultSingleAwardListS5

function UISeasonResultSingleAwardListS5:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonResultSingleAwardListS5:InitWidget()
...
function UISeasonResultSingleAwardListS5:OnHide()
end

function UISeasonResultSingleAwardListS5:SetData(awardsTb)
  self._taskIDList = {}
  ...
  self._awardsGen:SpawnObjects("UIWidgetSeasonResultRewardS5", count)
