_class("UIS5HelperBannerItem", UICustomWidget)
UIS5HelperBannerItem = UIS5HelperBannerItem

function UIS5HelperBannerItem:OnShow()
end

function UIS5HelperBannerItem:OnHide()
end

function UIS5HelperBannerItem:SetData(cfg, callbcak, begindrag, drag, enddrag)
  self._cfg = cfg
...
function UIS5HelperBannerItem:BtnOnClick()
end

function UIS5HelperBannerItem:Dispose()
  self._cfg = nil
  self._callback = nil
  self._icon = nil
end
