_class("UIS4QuestContent", UICustomWidget)
UIS4QuestContent = UIS4QuestContent

function UIS4QuestContent:Constructor()
  self._scrollViewInit = false
end

function UIS4QuestContent:CloseDialogWithAnim(callback)
  self:_PlayAnim("out", callback)
end

function UIS4QuestContent:OnShow(uiParams)
...
function UIS4QuestContent:OnHide()
  self:_Detach()
end

function UIS4QuestContent:SetData(params)
  ...
  local rawName = self._isQuestController and "exp_s4_rw_character01" or "exp_s4_rw_character01"
  UIWidgetHelper.SetRawImage(self, "drawing", rawName)
  self:_Refresh(true)
  self:_SetGoBtn()
...
function UIS4QuestContent:_Refresh(isFirst)
  self:_DynamicSv(isFirst)
  self:_SetClaimAllBtn()
end

function UIS4QuestContent:_PlayAnim(type, callback)
  local tb = {
    ["in"] = {
...
function UIS4QuestContent:_SetGoBtn()
  ...
  local obj = UIWidgetHelper.SpawnObject(self, widgetName, "UIS4Title")
end

function UIS4QuestContent:_SetClaimAllBtn()
  local isShow = self._component:HasQuestCanClaim(self._cellDatas)
  self:GetGameObject("ClaimAllBtn"):SetActive(isShow)
end

function UIS4QuestContent:_SetCellListData()
...
function UIS4QuestContent:_DynamicSv(isFirst)
...
function UIS4QuestContent:DynamicSvInfo(scrollView, index)
...
function UIS4QuestContent:_Attach()
  self:AttachEvent(GameEventType.OnUIGetItemCloseInQuest, self.OnUIGetItemCloseInQuest)
end

function UIS4QuestContent:_Detach()
  self:DetachEvent(GameEventType.OnUIGetItemCloseInQuest, self.OnUIGetItemCloseInQuest)
end

function UIS4QuestContent:OnUIGetItemCloseInQuest()
...
function UIS4QuestContent:SetResponseEvent(val)
