_class("UISeasonResultSingleAwardListS4", UICustomWidget)
UISeasonResultSingleAwardListS4 = UISeasonResultSingleAwardListS4

function UISeasonResultSingleAwardListS4:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonResultSingleAwardListS4:InitWidget()
...
function UISeasonResultSingleAwardListS4:OnHide()
end

function UISeasonResultSingleAwardListS4:SetData(awardsTb)
  self._taskIDList = {}
  ...
  self._awardsGen:SpawnObjects("UIWidgetSeasonResultRewardS4", count)
