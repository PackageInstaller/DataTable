_class("UIS4HelperController", UIController)
UIS4HelperController = UIS4HelperController

function UIS4HelperController:OnShow(uiParams)
  local tabIndex = 1
...
function UIS4HelperController:OnHide()
end

function UIS4HelperController:InitWidget(tabIndex)
...
function UIS4HelperController:AddListener()
end

function UIS4HelperController:_InitBanner(tabIndex)
  local bannerGen = self:GetUIComponent("UISelectObjectPath", "BannerRoot")
  self._bannerWidget = bannerGen:SpawnObject("UIS4HelperBanner")
  self._bannerWidget:SetData(tabIndex)
end

function UIS4HelperController:OnUpdate(deltaTimeMS)
  if self._bannerWidget then
    self._bannerWidget:OnUpdate(deltaTimeMS)
  end
end

function UIS4HelperController:_InitTabList(tabIndex)
  ...
  self._tabPool:SpawnObjects("UIS4HelperTab", tabCount)
...
function UIS4HelperController:OnTabClick(tabId)
