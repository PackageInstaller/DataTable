_class("UISeasonBuffMainTipsS4", UIController)
UISeasonBuffMainTipsS4 = UISeasonBuffMainTipsS4

function UISeasonBuffMainTipsS4:OnShow(uiParams)
...
function UISeasonBuffMainTipsS4:CloseOnClick()
