_class("UISeasonBuffLevelUpS4", UIController)
UISeasonBuffLevelUpS4 = UISeasonBuffLevelUpS4

function UISeasonBuffLevelUpS4:LoadDataOnEnter(TT, res, uiParams)
...
function UISeasonBuffLevelUpS4:OnShow(uiParams)
...
function UISeasonBuffLevelUpS4:OnUpdate(deltaTimeMS)
...
function UISeasonBuffLevelUpS4:FullScreenBtnOnClick(go)
