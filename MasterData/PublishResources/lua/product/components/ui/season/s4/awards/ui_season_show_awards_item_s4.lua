_class("UISeasonShowAwardsItemS4", UICustomWidget)
UISeasonShowAwardsItemS4 = UISeasonShowAwardsItemS4
local maxNumCount = 5

function UISeasonShowAwardsItemS4:OnShow(uiParams)
  ...
  self.uiItem = sop:SpawnObject("UISeasonItemS4")
end

function UISeasonShowAwardsItemS4:SetData(itemInfo, index, clickCallback, nameColor, tweenIdx, beforeTime)
...
function UISeasonShowAwardsItemS4:_PlayAnim()
  self._anim:Play("uieff_UIGetItemControllerItem")
end

function UISeasonShowAwardsItemS4:GetIndex()
  return self._index
end

function UISeasonShowAwardsItemS4:OnHide()
  if self._tweenEvent then
    GameGlobal.Timer():CancelEvent(self._tweenEvent)
    self._tweenEvent = nil
  end
...
function UISeasonShowAwardsItemS4:FormatItemCount(count)
