...
function UISeasonMainOvalArea:AddTarget(target, type)
  ...
  local tip = UISeasonMainOvalTip:New(self._seasonID, prefab, function(tip)
...
function UISeasonMainOvalArea:_LoadPrefab()
...
function UISeasonMainOvalArea:_RefreshPlayer()
...
function UISeasonMainOvalArea:_OnModeChanged()
  self:_RefreshMainLevelTarget()
  self:_RefreshDailyLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshPlayer()
...
function UISeasonMainOvalArea:_RefreshTask()
  local oldTips = {}
  for _, tip in pairs(self._tips) do
