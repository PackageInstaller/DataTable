...
function UISeasonLevelStage:LoadDataOnEnter(TT, res)
end
...
function UISeasonLevelStage:AutoFightBtnOnClick()
  if self._autoBtnEnable then
    ...
    self:ShowDialog("UISerialAutoFightOption", MatchType.MT_Season, id, power, nil, unlock, nil, campParams, nil)
  else
...
function UISeasonLevelStage:RefreshPanelText()
  if self._missionDiff == UISeasonLevelDiff.Normal then
    if self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
      self._awardsPanelBtnText.color = Color(0.4196078431372549, 0.2627450980392157, 0.11764705882352941, 1)
      self._battleInfoPanelBtnText = Color(0.43529411764705883, 0.37254901960784315, 0.24313725490196078, 1)
    else
      self._awardsPanelBtnText.color = Color(0.43529411764705883, 0.37254901960784315, 0.24313725490196078, 1)
      self._battleInfoPanelBtnText = Color(0.4196078431372549, 0.2627450980392157, 0.11764705882352941, 1)
    end
  elseif self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
    self._awardsPanelBtnText.color = Color(0.4196078431372549, 0.2627450980392157, 0.11764705882352941, 1)
    self._battleInfoPanelBtnText = Color(0.4235294117647059, 0.27058823529411763, 0.2, 1)
  else
    self._awardsPanelBtnText.color = Color(0.4235294117647059, 0.27058823529411763, 0.2, 1)
    self._battleInfoPanelBtnText = Color(0.4196078431372549, 0.2627450980392157, 0.11764705882352941, 1)
  end
end
...
function UISeasonLevelStage:_TryFixStory(TT)
  local normalMissionID = self._diffMissonIdMap[UISeasonLevelDiff.Normal]
...
function UISeasonLevelStage:_ReqFinishStory(TT, id, type)
