_class("UISeasonBuffLevelUpS6", UIController)
UISeasonBuffLevelUpS6 = UISeasonBuffLevelUpS6

function UISeasonBuffLevelUpS6:LoadDataOnEnter(TT, res, uiParams)
...
function UISeasonBuffLevelUpS6:OnShow(uiParams)
...
function UISeasonBuffLevelUpS6:OnUpdate(deltaTimeMS)
...
function UISeasonBuffLevelUpS6:FullScreenBtnOnClick(go)
