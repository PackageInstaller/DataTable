_class("UISeasonMainLevelListS6", UICustomWidget)
UISeasonMainLevelListS6 = UISeasonMainLevelListS6

function UISeasonMainLevelListS6:OnShow(uiParams)
  self._active = true
  self:InitWidget()
  self:_SetShow(false)
...
function UISeasonMainLevelListS6:OnHide()
  self._active = false
...
function UISeasonMainLevelListS6:InitWidget()
...
function UISeasonMainLevelListS6:SetData(obj)
  self._seasonObj = obj
end

function UISeasonMainLevelListS6:_Init()
...
function UISeasonMainLevelListS6:_BeforeStoryPlay()
  self._levelBtn:SetActive(true)
  self:_SetShow(false)
  self._levelBtnGroup.alpha = 1
end

function UISeasonMainLevelListS6:_OnDiffChanged(diff, onEnter)
...
function UISeasonMainLevelListS6:_OnClickLevelItem(data)
...
function UISeasonMainLevelListS6:_SetShow(show)
  self._isShown = show
...
function UISeasonMainLevelListS6:LevelBtnOnClick()
  self:StartTask(function(TT)
    self:Lock("uieff_UISeasonMainLevelListS6_DetailIn")
    self._levelBtn:SetActive(true)
    self._anim:Play("uieff_UISeasonMainLevelListS6")
    self:_SetShow(true)
    YIELD(TT, 725)
    self:UnLock("uieff_UISeasonMainLevelListS6_DetailIn")
  end, self)
end

function UISeasonMainLevelListS6:CloseBtnOnClick()
  self:StartTask(function(TT)
    self:Lock("uieff_UISeasonMainLevelListS6_end")
    self._levelBtn:SetActive(true)
    self._anim:Play("uieff_UISeasonMainLevelListS6_out")
    YIELD(TT, 725)
    self:_SetShow(false)
    self:UnLock("uieff_UISeasonMainLevelListS6_end")
  end, self)
end

function UISeasonMainLevelListS6:_Refresh()
  ...
  self._levelWidgets = self.content:SpawnObjects("UISeasonMainLevelListItemS6", #self._levels)
...
function UISeasonMainLevelListS6:DiffOnClick()
  local diff
  if self._curDiff == UISeasonLevelDiff.Normal then
...
function UISeasonMainLevelListS6:_ScrollTo(index, onEnter)
...
function UISeasonMainLevelListS6:_OnEnterAnim(TT, index)
  self:Lock("UISeasonMainLevelListS6_OnEnterAnim")
  ...
  self:UnLock("UISeasonMainLevelListS6_OnEnterAnim")
end

function UISeasonMainLevelListS6:_OnSwitchDiffAnim(TT, index)
  self:Lock("UISeasonMainLevelListS6_OnSwitchDiffAnim")
  local showCount = 6
  local from, to
  if showCount >= #self._levels then
    from = 1
  ...
  self:UnLock("UISeasonMainLevelListS6_OnSwitchDiffAnim")
end

function UISeasonMainLevelListS6:PlayEnterAnim()
end
