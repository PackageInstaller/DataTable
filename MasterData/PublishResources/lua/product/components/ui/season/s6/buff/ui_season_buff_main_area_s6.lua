_class("UISeasonBuffMainAreaS6", UICustomWidget)
UISeasonBuffMainAreaS6 = UISeasonBuffMainAreaS6

function UISeasonBuffMainAreaS6:OnShow(uiParams)
...
function UISeasonBuffMainAreaS6:DetailBtnOnClick()
...
function UISeasonBuffMainAreaS6:SetData(obj)
  self._seasonObj = obj
  self._progressCells = self.progressCellsGen:SpawnObject("UISeasonBuffProgressCellsS6")
  self:RefreshInfo()
end

function UISeasonBuffMainAreaS6:RefreshInfo()
