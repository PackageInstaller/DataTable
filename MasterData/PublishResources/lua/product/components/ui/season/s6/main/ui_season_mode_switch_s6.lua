_class("UISeasonModeSwitchS6", UICustomWidget)
UISeasonModeSwitchS6 = UISeasonModeSwitchS6

function UISeasonModeSwitchS6:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonModeSwitchS6:OnHide()
...
function UISeasonModeSwitchS6:InitWidget()
...
function UISeasonModeSwitchS6:SetData(seasonObj)
...
function UISeasonModeSwitchS6:BtnMode1OnClick(go)
  self:_SwitchTo(SeasonMapMode.Mode1)
end

function UISeasonModeSwitchS6:BtnMode2OnClick(go)
  self:_SwitchTo(SeasonMapMode.Mode2)
end

function UISeasonModeSwitchS6:BtnSwitchOnClick(go)
  local mode
...
function UISeasonModeSwitchS6:Switch2Modle2(finishCb)
  self:_SwitchTo(SeasonMapMode.Mode2, finishCb)
end

function UISeasonModeSwitchS6:_SwitchTo(mode, finishCb)
...
function UISeasonModeSwitchS6:_CheckModeValid(mode)
...
function UISeasonModeSwitchS6:_Switch(TT, mode, finishCb)
  self:Lock("UISeasonModeSwitchS6:SwitchMode")
  self._anim:Stop()
  ...
  YIELD(TT, 1000)
  self:UnLock("UISeasonModeSwitchS6:SwitchMode")
  if finishCb then
    finishCb()
  end
end

function UISeasonModeSwitchS6:_RefreshBtn(mode)
  if mode == SeasonMapMode.Mode1 then
...
function UISeasonModeSwitchS6:_OnModeChanged()
  self._curMode = self._mapManager:Mode()
  self:_RefreshBtn(self._curMode)
end

function UISeasonModeSwitchS6:_OnEventPointProgressChange()
  self._canSwitch = true
  self._root:SetActive(self._canSwitch)
end
