...
function Vector2:PosIndex()
  return self.x * 100 + self.y
end

function Vector2:IntegerStr()
  return string.format("(%d,%d)", self.x, self.y)
end

function Vector2.Pos2Index(pos)
  return math.floor(pos.x) * 100 + math.floor(pos.y)
end

function Vector2.Index2Pos(idx)
  return Vector2(idx // 100, idx % 100)
end
