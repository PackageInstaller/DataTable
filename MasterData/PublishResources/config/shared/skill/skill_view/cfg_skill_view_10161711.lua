...
local config = {
  {
    ...
    0,
    {
      " PlayCasterEffectHolder,effHolderType=Idle,isShow=0; PlayCasterAnimation,animName = Atk; PlayCasterBindEffect,effectID=280; Wait,waitTime=1000; DataSelectDamage,damageIndex = 1; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=283,turnToTarget=1,deathClear=0,label=doAgain; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=doAgain; PlaySummonTrap,trapID=10161711,effectID=741; Wait,waitTime=1500; "
    }
  },
  {
    2,
