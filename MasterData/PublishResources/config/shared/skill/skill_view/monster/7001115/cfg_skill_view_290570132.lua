...
local config = {
  ...
  },
  {
    ...
    4360,
    {
      " DataSelectDamage,damageIndex = 1; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=290570112,turnToTarget=1,deathClear=0,label=doAgain; Wait,waitTime=300; PlaySummonTrap,trapID=70011152; Wait,waitTime=1000;"
    }
  }
}
