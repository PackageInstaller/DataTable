...
local config = {
  {
    ...
    0,
    {
      " PlayAudio,audioID = 29095014,audioType=1; PlayCasterMaterialAnim,animName=eff_2909501_01_skill01; PlayCasterAnimation,animName=Skill2_2; PlayCasterBindEffect,effectID=290950103; Wait,waitTime=2800; "
    }
  },
  {
    2,
