...
local config = {
  ...
  },
  {
    ...
    2550,
    {
      " PlayVoice,voiceID=290600107; DataSelectDamage,damageIndex = 1; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=0,turnToTarget=1,deathClear=0,label=doAgain; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=doAgain; Wait,waitTime = 2000; "
    }
  },
  {
    5,
    ...
    0,
    {
      " PlayCasterBindEffect,effectID=290600101; PlayCasterAnimation,animName =skill03; DataSelectBuff,buffIndex=1; PlayAddBuffView,buffID=292600105,label=go2; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=go2; Wait,waitTime=1000; PlayVoice,voiceID=290600114; "
    }
  }
}
