...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 160223103,audioType=1; PlayCasterBindEffect,effectID=160223105; PlayCasterBindEffect,effectID=160223106; Wait,waitTime=6000; "
    }
  },
  {
    2,
