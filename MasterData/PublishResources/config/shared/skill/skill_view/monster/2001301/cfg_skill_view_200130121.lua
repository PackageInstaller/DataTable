...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=20013017,label=doAgain1; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain1; "
    }
  },
  {
    5,
    ...
    0,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=20013016,label=doAgain; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain; "
    }
  }
}
