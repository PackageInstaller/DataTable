...
local config = {
  ...
  },
  {
    ...
    500,
    {
      " PlayCasterRenderState,renderState=1; PlayCasterAnimation,animName=Skill03_a; PlayCasterBindEffect,effectID=882; PlayAudio,audioID = 5005,audioType=1; Wait,waitTime=2167; PlayCasterBindEffect,effectID=883; PlayCasterBindEffect,effectID=972; PlayCasterAddBuff,buffID=30072; Wait,waitTime=300; "
    }
  }
}
