...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayAudio,audioID=6254,audioType=1; PlayCasterAnimation,animName=Skill01; PlayCasterBindEffect,effectID=290490105; Wait,waitTime=500; DataSelectDamage,damageIndex = 1; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=0,turnToTarget=1,deathClear=0,label=doAgain; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=doAgain; Wait,waitTime=500; DataSelectBuff,buffIndex=1; PlayAddBuffView,buffID=PARAM.buffID1,label=buffLoop; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=buffLoop; Wait,waitTime=200; "
    }
  },
  {
    3,
    ...
    0,
    {
      " DataSelectBuff,buffIndex=1; PlayAddBuffView,buffID=PARAM.buffID2,label=buffLoopp; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=buffLoopp; Wait,waitTime=200; "
    }
  }
}
