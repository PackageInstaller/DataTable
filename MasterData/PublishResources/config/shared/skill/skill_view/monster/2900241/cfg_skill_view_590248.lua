...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = Skill03; PlayAudio,audioID = 6046,audioType=1; PlayCasterBindEffect,effectID=755; "
    }
  },
  {
    2,
    ...
    0,
    {
      " PlayCasterBindEffect,effectID=754; "
    }
  },
  {
    3,
