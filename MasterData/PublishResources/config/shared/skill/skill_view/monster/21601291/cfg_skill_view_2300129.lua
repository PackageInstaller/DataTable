...
local config = {
  {
    ...
    0,
    {
      " PlayTurnToPickUpDirection; PlayCasterAnimation,animName=AtkUlt; PlayAudio,audioID = 2358,audioType=1; PlayCasterBindEffect,effectID=3092; Wait,waitTime=3500; "
    },
    {"", "0.5,-0.5"}
  },
  {
