...
local config = {
  ...
  },
  {
    ...
    1300,
    {
      " Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID3,gridPosX=7,gridPosY=7,gridDirX=0,gridDirY=-1; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID3,gridPosX=6,gridPosY=6,gridDirX=0,gridDirY=-1; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID3,gridPosX=5,gridPosY=5,gridDirX=0,gridDirY=-1; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID3,gridPosX=4,gridPosY=4,gridDirX=0,gridDirY=-1; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID3,gridPosX=3,gridPosY=3,gridDirX=0,gridDirY=-1; Wait,waitTime=100; Wait,waitTime=100; "
    }
  },
  {
    3,
