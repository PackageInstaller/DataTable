...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName=Skill03; PlayCasterBindEffect,effectID = 2443; PlayCameraEffect,effectID = 2445; PlayCasterBindEffect,effectID = 2446; PlayAudio,audioID = 2282; Wait,waitTime=3333; PlayCasterVisible,visible=0; Wait,waitTime=1666; PlayCasterVisible,visible=1; PlayCasterAnimation,animName=Skill04; PlayCasterBindEffect,effectID = 2447; PlayCasterBindEffect,effectID = 2448; Wait,waitTime=2200; "
    }
  },
  {
    3,
  ...
  },
  {
    ...
    5800,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffEffectType =29044016,label=buffAgain; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=buffAgain; "
    }
  }
}
