...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName=AtkUlt; PlayAudio,audioID = 3028,audioType=1; PlayCasterBindEffect,effectID=1110; DataSelectScopeGridRange,effectType=4; DataSortScopeGridRange,sortType=3; DataSelectScopeGridRangeIndex,index=1; PlayGridRangeConvert,dataSource=4,isRotate=1,label=playRangeEffect; DataSelectNextScopeGridRange,label=selectNextGridRange; Jump,condition=CheckCurrentScopeGridRangeIndexValid,goto=playRangeEffect; Wait,waitTime=1600; PlaySummonTrap,trapID=2239; PlaySummonTrap,trapID=22392; PlaySummonTrap,trapID=22393; PlaySummonTrap,trapID=22394; DataSelectResult,effectType=79,index=1; PlayDestroyTrap; PlayTargetAddBuff,buffID=5822353; Wait,waitTime=2700; "
    }
  }
}
