...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 160177403,audioType=1; PlayCasterBindEffect,effectID = 160177301; PlayCasterBindEffect,effectID = 160177107; Wait,waitTime = 2500; DataSelectDamage,damageIndex = 1; PlayTargetBeHitEffect,hitEffectID=160177303,label=hitAgain; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=hitAgain; "
    }
  },
  {
    2,
