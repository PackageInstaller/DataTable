...
local config = {
  {
    ...
    0,
    {
      " PlayAudio,audioID = 2620,audioType=1; PlayCasterAnimation,animName = AtkChain; PlayCasterBindEffect,effectID=150193108; PlayCasterBindEffect,effectID=150193110; "
    }
  },
  {
    2,
