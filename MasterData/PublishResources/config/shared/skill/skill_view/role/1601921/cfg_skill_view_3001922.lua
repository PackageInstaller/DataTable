...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayAudio,audioID = 2637,audioType=1; PlayCasterAnimation,animName = AtkUlt; PlayTurnToPickUpPosDirection,pickUpIndex=1; Wait,waitTime=4700; "
    }
  },
  {
    3,
  ...
  },
  {
    ...
    2500,
    {
      " PlayEffectAtPickUpIndexGrid,effectID=160192105,pickUpIndex=1; DataSelectDamage,damageIndex = 1; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=0,turnToTarget=1,deathClear=0,label=doAgain; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=doAgain; "
    }
  },
  {
    8,
