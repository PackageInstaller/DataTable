...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 2241,audioType=1; PlayCasterBindEffect,effectID=2304; "
    }
  },
  {
    2,
