...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 2546,audioType=1; PlayCasterBindEffect,effectID=140169105; PlayCasterBindEffect,effectID=140169107; Wait,waitTime=2500; "
    }
  },
  {
    2,
