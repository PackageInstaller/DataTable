...
local config = {
  ...
  },
  {
    ...
    900,
    {
      " PlayFlyEffectCasterToTarget,flyEffectID = 1055,flyTime = 150,flyTrace = 1,originalBoneName= Bone070,targetPos= EffectSlot; "
    }
  },
  {
    5,
    ...
    1050,
    {
      " PlaySelectCenterGridEffect,effectID=503,intervalTime=0; Wait,waitTime=1150; PlaySelectCenterGridEffect,effectID=50301,intervalTime=0; "
    }
  },
  {
    6,
