...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayCasterBindEffect,effectID=13700; PlayAudio,audioID = 2024,audioType=1; "
    },
    {"", "1,0"}
  },
  {
