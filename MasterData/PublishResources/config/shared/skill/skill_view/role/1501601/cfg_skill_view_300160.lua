...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkUlt; PlayAudio,audioID = 2486,audioType=1; PlayCasterBindEffect,effectID=3722; PlayCasterBindEffect,effectID=3724; Wait,waitTime=300; PlaySelectCenterGridEffect,effectID=3723,intervalTime=0; Wait,waitTime=3000; "
    }
  },
  {
    3,
