...
local config = {
  ...
  },
  {
    ...
    2800,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=410137,label=doAgain; PlayAudio,audioID = 2380,audioType=1; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain; "
    }
  }
}
