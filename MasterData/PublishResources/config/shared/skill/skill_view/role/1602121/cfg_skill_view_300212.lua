...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayAudio,audioID = 160212103,audioType=1; ScreenShotSetTestureForAnton,effectID=160212107,duration=5300,block=0; PlayGridDark,darkType=0; PlayHUDVisible,visible=0; PlayTeamHUDVisible,visible=0; UiBattleVisible,visible=0; PlayCasterAnimation,animName = AtkUlt; Wait,waitTime=6400; PlayHUDVisible,visible=1; UiBattleVisible,visible=1; PlayTeamHUDVisible,visible=1; Wait,waitTime=3000; PlayGridDark,darkType=1; "
    }
  },
  {
    3,
