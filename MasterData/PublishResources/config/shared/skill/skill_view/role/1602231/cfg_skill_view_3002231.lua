...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayGridDark,darkType=0; PlayAudio,audioID = 160223104,audioType=1; PlayCasterAnimation,animName = AtkUlt; PlayCasterBindEffect,effectID =160223101; Wait,waitTime=700; PlayChenNiGridEffect,effectID=160223102; Wait,waitTime=3100; PlayGridDark,darkType=1; Wait,waitTime=1500; "
    }
  },
  {
    3,
