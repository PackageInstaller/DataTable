...
local config = {
  ...
  },
  {
    ...
    3550,
    {
      " PlayCasterToPickupDirTrajectory,effectID=3005,flySpeed=100, degressiveCount=5, directionType=1, destroyEffectID=3006, effectReduceSize=0.2,hideGO1Name=1/mesh,hideGO2Name=1/par,hideGO2WaitTime=1200,outBoardCount=5,destroyKnifeWaitTime=1200; PlayCasterToPickupDirTrajectory,effectID=3005,flySpeed=100, degressiveCount=5, directionType=4, destroyEffectID=3006, effectReduceSize=0.2,hideGO1Name=1/mesh,hideGO2Name=1/par,hideGO2WaitTime=1500,outBoardCount=5,destroyKnifeWaitTime=1200; PlayCasterToPickupDirTrajectory,effectID=3005,flySpeed=100, degressiveCount=5, directionType=5, destroyEffectID=3006, effectReduceSize=0.2,hideGO1Name=1/mesh,hideGO2Name=1/par,hideGO2WaitTime=1500,outBoardCount=5,destroyKnifeWaitTime=1200; "
    }
  },
  {
    5,
