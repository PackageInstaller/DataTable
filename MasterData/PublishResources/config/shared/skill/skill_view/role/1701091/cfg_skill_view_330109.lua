...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayTurnToPickUpPosDirection,pickUpIndex=1; PlayCasterAnimation,animName=AtkUlt; PlayCasterBindEffect,effectID = 2410; PlayAudio,audioID = 2279; Wait,waitTime=2000; PlayCasterAnimation,animName=AtkUlt2; Wait,waitTime=1000; "
    }
  },
  {
    3,
