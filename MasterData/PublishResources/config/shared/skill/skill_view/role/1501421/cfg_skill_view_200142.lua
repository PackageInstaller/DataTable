...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 2410,audioType=1; PlayCasterBindEffect,effectID=3328; "
    }
  },
  {
    2,
