...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkUlt_Basic; PlayCasterBindEffect,effectID=3293; PlayAudio,audioID = 2407,audioType=1; Wait,waitTime=4800; "
    }
  },
  {
    3,
