...
local config = {
  ...
  },
  {
    ...
    2150,
    {
      " DataSelectBuff,buffIndex=1; Jump,condition=CheckBuffIndexValid,result=0,goto=phaseEnd; DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=4001624,label=doAgain; PlayTargetAddBuff,buffID=4001625; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain; "
    }
  }
}
