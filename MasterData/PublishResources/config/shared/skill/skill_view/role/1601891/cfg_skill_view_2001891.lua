...
local config = {
  {
    ...
    0,
    {
      " PlayCasterBindEffect,effectID=160189103; PlayCasterBindEffect,effectID=160189104; PlayCasterAnimation,animName=AtkChain; PlayAudio,audioID = 2604,audioType=1; Wait,waitTime=4000; "
    }
  },
  {
    2,
