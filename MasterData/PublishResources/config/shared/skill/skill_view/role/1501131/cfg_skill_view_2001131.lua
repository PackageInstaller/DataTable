...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 2312,audioType=1; PlayCasterBindEffect,effectID=2624; "
    },
    {"", "0,-1"}
  },
  {
