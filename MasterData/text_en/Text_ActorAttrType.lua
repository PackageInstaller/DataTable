...
For a team in the <Blue:Aequor> Realm, for every 1 point of Realm Mastery, after releasing an Exalt, there is a <Blue:0.25%> chance to gain an additional stack of Tentacle Gathering (if probability exceeds 100%, multiple stacks can be obtained). When switching to "Still Sea," the shield gained +<Blue:0.01%> of Max HP, and Tentacle attacks triggered by Active DMG in "Raging Waves" increase Tentacle DMG by <Blue:0.02%>.
For a team in the <Blue:Caro> Realm, for every 1 point of Realm Mastery, the first time you trigger Devour each turn, you gain Shield of <Blue:0.01%> of Max HP and <Blue:0.005%> of Temporary STR (increases with lost HP, up to 100%).
For a team in the <Blue:Ultra> Realm, for every 1 point of Realm Mastery, at turn start, there is a <Blue:0.125%> chance to gain 1 "Insight" (if probability exceeds 100%, multiple can be obtained).]]
  ...
  ActorAttrType_18139_AttributeDesc = {
    Text = "When a Command or Rouse Card is played, each point of Arithmetica consumed grants {s1} Keyflare. As this attribute increases, the additional Keyflare gained will gradually decay."
  },
