...
local Text_RelicConfig = readonly({
  ...
  RelicConfig_100401_BattleDesc = {
    Text = "Gain [Arg1]% of the HP lost as Crimson Furnace when losing HP."
  },
  ...
  RelicConfig_100402_BattleDesc = {
    Text = "Upon picking up, inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <VulnerabilityIconKeywords:Vulnerable> on all enemies. The Base DMG dealt by all Awakeners +[Arg2]%."
  },
...
Of course, this is nothing for a master thief]]
  ...
  RelicConfig_100405_BattleDesc = {
    Text = "Upon picking up, inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <WeaknessIconKeywords:Weakness> to all enemies. The Base DMG dealt by all Awakeners +[Arg2]%."
  },
...
At the start of turn, if not all rituals are completed, suffer <SacrificeKeyWord:Sacrifice> equal to 10% Max HP. Place 1 "<DerivativeCardKeywords_119:Divine Dedication>" into hand, max hold 1.]]
  ...
  RelicConfig_121689_BattleDesc = {
    Text = "Increase Final DMG by 250%. Each time damage is dealt, this bonus -50% (up to 5 times), while Shield Generation +10%. Resets every turn."
  },
  ...
  RelicConfig_121692_BattleDesc = {
    Text = "Effects of <RetaliateIconKeywords:Counter>, <IntoxicationIconKeywords:Poison>, Shield, and HP Recovery generated by all Awakeners +50%. At the end of the turn, gain Temporary <RetaliateIconKeywords:Counter> equal to 500% of the current Shield."
  },
  ...
  RelicConfig_121694_BattleDesc = {
    Text = "At turn start, all Awakeners gain 25 Aliemus and draw a <DerivativeCardKeywords_4:Insight> into their hand. After unleashing \"Exalt\" 4 times, remove the <Seal:Sealed> status from all Awakeners and grant them 50 Aliemus."
  },
  ...
  RelicConfig_121695_BattleDesc = {
    Text = "At the start of the battle, gain [Arg4] <PowerIconKeywords:STR>, and increase the Keyflare Cap by 100%. The Keyflare gained per point of Arithmetica consumed +100%. After using Keyflare Rouse or unleashing Posse, gain Temporary <PowerIconKeywords:STR> equal to 20% of the current <PowerIconKeywords:STR> and grant all Awakeners 20 Aliemus."
  },
  ...
  RelicConfig_122629_BattleDesc = {
    Text = "There will be double the Awakener cards in the Draw Pile. After playing a card, when the number of cards goes under [Arg1] for the first time this turn, draw [Arg2] <plural value=\"[Arg2]\" singular=\"card\" plural=\"cards\">."
  },
...
For each [Arg3] "Strike" played within 1 turn, gain [Arg4] Temporary <PowerIconKeywords:STR>; after playing [Arg5] "Strike" cards, draw [Arg6] <plural value="[Arg6]" singular="card" plural="cards"> and gain [Arg7] Arithmetica; after playing [Arg8] "Strike" cards, all Awakeners gain [Arg9] Aliemus.]]
  },
...
For each [Arg3] "Strike" played within 1 turn, gain [Arg4] Temporary <PowerIconKeywords:STR>; after playing [Arg5] "Strike" cards, draw [Arg6] <plural value="[Arg6]" singular="card" plural="cards"> and gain [Arg7] Arithmetica; after playing [Arg8] "Strike" cards, all Awakeners gain [Arg9] Aliemus.]]
  ...
  RelicConfig_123724_BattleDesc = {
    Text = "At turn start, Mouchette gains [Arg1] Aliemus and generates 1 Temporary Strike with an Arithmetica Cost of 0. Each time \"Dramatic Encounter\" is triggered, increase the Base DMG and Strike DMG increase effect of \"Shining☆Tornado\" by [Arg2]％ for this battle."
  },
  ...
  RelicConfig_125488_BattleDesc = {
    Text = "All Awakeners gain [Arg1] Aliemus the first time they play a Command Card each turn. After playing 4 Command Cards belonging to different Awakeners in one turn, inflict [Arg2]% of team's Max HP as <IntoxicationIconKeywords:Poison> on all enemies."
  },
  ...
  RelicConfig_126673_BattleDesc = {
    Text = "Hand Limit +3. Record the first 3 Non-Derived Command Cards played each turn, and at the start of the turn 3 turns later, reduce their Arithmetica Cost by 1 and add copies with <DepleteIconKeywords:Exhaust> to hand."
  },
...
<OrangeQuality:Dimensional Gift>: Gain 1 random Dimensional Image Relic at the start of exploration. Hand Limit +2.
<OrangeQuality:Blessed Ritual>: Rewards for defeating Phase 1 and Phase 2 Bosses are replaced with a choice of 3 Blessed Relics.
<RedQuality:Transit Fatigue>: All HP recovery effects -50% in battle. When "Burial" is selected at "Faded Bones," the effect changes to restore 25% Max HP.
<RedQuality:Motion Vertigo>: All Awakeners start battle with 50% less current Aliemus and Keyflare.
<RedQuality:Evernight Rail>: All Awakeners gain +50% to their Base Aliemus and Keyflare Cap at the start of exploration.]]
  },
...
"Bad guy! Bite him!"]]
  ...
  RelicConfig_131178_BattleDesc = {
    Text = "At battle start, shuffle a \"<DerivativeCardKeywords_134:Forbidden Truth>\" into the deck. Draw +[Arg1] each turn. After playing a Command Card, randomly grant <ErosionColorInkKeywords:Perception Warp> to [Arg2] Command Cards each in the hand, Draw Pile, and Discard Pile that do not already have <ErosionColorInkKeywords:Perception Warp>."
  },
  RelicConfig_131178_Desc = {
    Text = "At the start of battle, Shuffle a \"<DerivativeCardKeywords_134:Forbidden Truth>\" into the deck. Draw +[Arg1] each turn. After playing a Command Card, randomly grant <ErosionColorInkKeywords:Perception Warp> to 2 Command Cards in the opponent's hand."
  },
...
Finely crafted and gleaming, they once embodied the friendship of two children.]]
  ...
  RelicConfig_13745_BattleDesc = {
    Text = "The Recommended Realm's buff effect +50%, and your Lucky Orison Rate doubles when the level starts."
  },
  RelicConfig_13745_Desc = {
    Text = "The Realm's recommended bonus effect +50%, and your Lucky Orison Rate doubles at the start of the level."
  },
...
Stay still; they prefer quiet exhibits.]]
  ...
  RelicConfig_13759_BattleDesc = {
    Text = "When releasing Exalt, for each instance of DMG dealt by enemies, apply [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison>"
  },
  RelicConfig_13759_Desc = {
    Text = "When releasing Exalt, for each instance of incoming DMG from enemies, Inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison>"
  },
...
The collector was captivated by its beautiful fluorescence, admiring it day and night, until he eventually withered away and became one of its kind.]]
  ...
  RelicConfig_13771_BattleDesc = {
    Text = "All Awakener's Keyflare Regen +30. After releasing the Posse, shuffle 3 <DerivativeCardKeywords_4:\"Insight\"> into your deck."
  },
  ...
  RelicConfig_13773_BattleDesc = {
    Text = "For every 1 instance of Active DMG dealt, inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <BleedingIconKeywords:Bleed> on self and [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of <BleedingIconKeywords:Bleed> on the target. For each enemy killed, dispel the <BleedingIconKeywords:Bleed> state from self."
  },
  ...
  RelicConfig_13786_Desc = {
    Text = "After releasing Exalt, Gain [Arg1] in Temporary <PowerIconKeywords:STR>."
  },
...
Of course, this is nothing for a master thief]]
  ...
  RelicConfig_13787_BattleDesc = {
    Text = "At turn start, deal [Arg1] <FixedDamage:Pure DMG> to a random enemy. After playing \"Strike\" 7 times in this battle, the DMG dealt will change to [Arg2]. After playing \"Strike\" 21 times, instantly deal [Arg3] <FixedDamage:Pure DMG> to all enemies."
  },
...
The handwriting at the beginning is neat and tidy, but gradually becomes messy and chaotic.]]
  ...
  RelicConfig_13798_BattleDesc = {
    Text = "At battle start, all Symptom Cards gain <NothingnessIconKeywords:Fleeting>, and for each Symptom Card in deck, gain [Arg1] <PowerIconKeywords:STR>."
  },
...
It is said that the renowned violinist Eric has a particular fondness for it.]]
  ...
  RelicConfig_13804_BattleDesc = {
    Text = "Gain [Arg1] Shield at the end of your turn. If your Shield is 0 or a multiple of 3, gain [Arg2] <PowerIconKeywords:STR>."
  },
  ...
  RelicConfig_13806_BattleDesc = {
    Text = "Gain [Arg1] Temporary <PowerIconKeywords:STR> when drawing a Symptom Card. For each Cursed Relic you have, your Crit. Rate and Crit. DMG increase by 10%."
  },
...
Opening it does not guarantee it belongs to a true doctor.]]
  ...
  RelicConfig_13811_BattleDesc = {
    Text = "Every 3rd time \"Strike\" is played, deal [Arg1] <FixedDamage:Pure DMG> to all enemies. The corresponding Awakener gains 15 Aliemus."
  },
  ...
  RelicConfig_13813_BattleDesc = {
    Text = "At the start of the battle, the current HP of elite and boss enemies -20%."
  },
...
Ding, ding, it's hungry, you know.]]
  ...
  RelicConfig_13820_BattleDesc = {
    Text = "Whenever a Symptom Card is gained, Max HP +[Arg1]."
  },
  ...
  RelicConfig_13824_BattleDesc = {
    Text = "At turn start, <DeathResistanceIconKeywords:Death Resistance> +10% (each time Death Resistance triggers in this stage, the gained Death Resistance is halved). When <DeathResistanceIconKeywords:Death Resistance> is above 100%, <ProficientInRealmsIconKeywords:Realm Mastery> +100."
  },
  ...
  RelicConfig_13830_Desc = {
    Text = "When causing HP Recovery, also grant [Arg1] Shield. After the start of the 3rd turn, gain [Arg2] <AlertIconKeywords:Alert>."
  },
...
It has been incorporated into the university's collection since the Flood.]]
  ...
  RelicConfig_13832_BattleDesc = {
    Text = "Enter the Ultra Round to remove <WeaknessIconKeywords:Weakness> and <FragileIconKeywords:Fragile> state from self, and inflict <WeaknessIconKeywords:Weakness> and <VulnerabilityIconKeywords:Vulnerable> state to all enemies for 3 turns. This turn, all Awakener Final DMG +15%."
  },
  ...
  RelicConfig_13833_BattleDesc = {
    Text = "For every 1 DMG instance dealt, apply [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison> to the target. If the number of triggers accumulates to 25 within this battle, immediately trigger <IntoxicationIconKeywords:Poison> for all enemies."
  },
  RelicConfig_13833_Desc = {
    Text = "For every 1 DMG instance dealt, Inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison> to the target. If the number of triggers accumulates to 25 times within this battle, trigger immediately <IntoxicationIconKeywords:Poison> for all enemies."
  },
  ...
  RelicConfig_13834_BattleDesc = {
    Text = "Every 5th time Shield is gained, also gain <RetaliateIconKeywords:Counter>, with the Counter value equal to [Arg1]% of the Shield gained."
  },
  ...
  RelicConfig_13841_BattleDesc = {
    Text = "All \"Strike\" Crit. DMG +20%. When the battle begins, add 1 <DerivativeCardKeywords_40:\"Fleeting Beauty\"> to hand."
  },
...
The top hat winked as if ready to emerge.]]
  ...
  RelicConfig_13855_BattleDesc = {
    Text = "At turn start and whenever HP is recovered, gain [Arg1] <RetaliateIconKeywords:Counter>. Can occur up to 3 times per turn. When the limit is reached, trigger 100% <RetaliateIconKeywords:Counter> against all enemies."
  },
...
Now, it can no longer be played.]]
  ...
  RelicConfig_13869_BattleDesc = {
    Text = "<ProficientInRealmsIconKeywords:Realm Mastery> +100. Every time Active DMG is dealt, Temporary Tentacle DMG +[Arg1]; every time Tentacle DMG is dealt, gain [Arg2] Shield. This effect can trigger a maximum of 6 times per turn."
  },
  RelicConfig_13869_Desc = {
    Text = "<ProficientInRealmsIconKeywords:Realm Mastery> boosts by 100. Every time an Active DMG is dealt, Temporary Tentacle DMG +[Arg1]; every time a Tentacle DMG is dealt, Gain [Arg2] Shield. This effect can occur a maximum of 6 times per turn."
  },
...
One piece floated down from high above and landed in the girl's palm.]]
  ...
  RelicConfig_13875_BattleDesc = {
    Text = "After playing \"Strike\" and \"Defense,\" the corresponding Awakener gains 35 Aliemus. However, their Arithmetica Cost +1."
  },
  RelicConfig_13875_Desc = {
    Text = "After playing \"Strike\" and \"Defense,\" the corresponding Awakeners gain 35 Aliemus. However, their Arithmetica Cost +1."
  },
  ...
  RelicConfig_13877_BattleDesc = {
    Text = "After gaining the 2nd Shield each turn, gain [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <RetaliateIconKeywords:Counter>. After gaining the 4th Shield each turn, trigger 100% <RetaliateIconKeywords:Counter> against all enemies."
  },
  ...
  RelicConfig_13880_BattleDesc = {
    Text = "Gain [Arg1] Shield when dealing Active DMG. Gain [Arg2] Temporary <PowerIconKeywords:STR> when restoring HP."
  },
  ...
  RelicConfig_13884_BattleDesc = {
    Text = "\"Strike\" inflicts [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison> on all enemies."
  },
...
The handwriting at the beginning is neat and tidy, but gradually becomes messy and chaotic.]]
  ...
  RelicConfig_13893_Desc = {
    Text = "Every 4th time Shield is gained, restore HP equal to 50% of the Shield."
  },
  ...
  RelicConfig_13899_BattleDesc = {
    Text = "At turn start, <ProficientInRealmsIconKeywords:Realm Mastery> +50. When not in a debuff, <ProficientInRealmsIconKeywords:Realm Mastery> increases to 150."
  },
  ...
  RelicConfig_13900_BattleDesc = {
    Text = "After using \"Exalt,\" all cards' Arithmetica Cost -1."
  },
  ...
  RelicConfig_13902_BattleDesc = {
    Text = "At turn start, gain [Arg2] Shield. At turn end, deal <FixedDamage:Pure DMG> equal to [Arg1]% of your current Shield to a random enemy. The DMG effect is doubled in Boss Battles."
  },
  RelicConfig_13902_Desc = {
    Text = "At turn start, gain [Arg2] Shield. At turn end, deal <FixedDamage:Pure DMG> to a random enemy equal to [Arg1]% of your current Shield. In Boss Battle, the DMG is doubled."
  },
  ...
  RelicConfig_13905_BattleDesc = {
    Text = "After the battle starts, gain [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of <RetaliateIconKeywords:Counter>. Play \"Defense\" to gain [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <RetaliateIconKeywords:Counter>."
  },
...
Since then, it has been able to summon flames.]]
  ...
  RelicConfig_13919_BattleDesc = {
    Text = "<ProficientInRealmsIconKeywords:Realm Mastery> +50. When picked up, choose a Relic and change it to a random one."
  },
  RelicConfig_13919_Desc = {
    Text = "<ProficientInRealmsIconKeywords:Realm Mastery> +50. When picked up, choose a Relic and change it to a random Relic."
  },
  ...
  RelicConfig_13920_BattleDesc = {
    Text = "The caused Weakness effect +5%. When applying <WeaknessIconKeywords:Weakness>, temporarily steal [Arg1] <PowerIconKeywords:STR> from the target."
  },
  ...
  RelicConfig_13921_BattleDesc = {
    Text = "When picked, choose 2 Command Cards to Delete and Gain [Arg1] <PowerIconKeywords:STR>."
  },
  RelicConfig_13921_Desc = {
    Text = "When picked, choose 2 Command Cards to Delete, Gain [Arg1] <PowerIconKeywords:STR>."
  },
  ...
  RelicConfig_13929_BattleDesc = {
    Text = "Every time you lose HP, gain [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <RetaliateIconKeywords:Counter>. If this is the 3rd trigger in a single turn, trigger 100% <RetaliateIconKeywords:Counter> against all enemies."
  },
  ...
  RelicConfig_13930_BattleDesc = {
    Text = "At turn end, for each card in hand, apply [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison> to all enemies."
  },
  RelicConfig_13930_Desc = {
    Text = "At turn end, for each card in hand, inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison> on all enemies."
  },
  ...
  RelicConfig_13931_BattleDesc = {
    Text = "Gain [Arg1] <PowerIconKeywords:STR> when picked up. Whenever a <DerivativeCardKeywords_2:\"Embryo\"> is fused, gain [Arg2] Temporary <PowerIconKeywords:STR>."
  },
  ...
  RelicConfig_13941_BattleDesc = {
    Text = "\"Strike\" restores [Arg1] HP and reduces own <IntoxicationIconKeywords:Poison> by [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\">."
  },
  RelicConfig_13941_Desc = {
    Text = "\"Strike\" restores [Arg1] HP and reduces self <IntoxicationIconKeywords:Poison> by [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\">."
  },
  ...
  RelicConfig_139929_BattleDesc = {
    Text = "At turn start, Saya gains [Arg1] Aliemus. For every 100 Aliemus consumed by Saya's Exalt, an additional generated \"Skill\" card takes effect 1 additional time."
  },
  RelicConfig_139929_Desc = {
    Text = "At turn start, Saya gains [Arg1] Aliemus. For every 100 Aliemus consumed by Saya's Exalt, an additional generated \"Skill\" card takes effect 1 additional time."
  },
  RelicConfig_139929_Name = {
    Text = "<OrangeQuality:Dimensional Image: Saya>"
  },
  RelicConfig_140276_BattleDesc = {
    Text = [[
<OrangeQuality:Backwater>: At the Start of each turn, for every 1% Max HP lost, Final DMG is Temporarily Boosted by 5%. If Death Resistance was triggered last turn, this Effect is doubled. 
<RedQuality:Supreme>: All enemies' Max HP is Boosted by 300%.]]
  },
...
<RedQuality:Supreme>: All enemies' Max HP is Boosted by 300%.]]
  ...
  RelicConfig_140276_Name = {
    Text = "<RedQuality:Dimension Pendulum-Duel>"
  },
  RelicConfig_140277_BattleDesc = {
    Text = [[
<OrangeQuality:Multiply>: The first time each Awakener plays a "Skill" each turn, generate 2 Temporary Base Copies of it. When a Command Card with an Arithmetica Cost of 0 or 1 is played, all Awakeners gain 5 Aliemus.
 <RedQuality:Bastion>: When a card with a Default Arithmetica Cost of 3 or more is played, all enemies gain Shield equal to 20% of their Max HP.]]
  },
...
<OrangeQuality:Multiply>: The first time each Awakener plays a "Skill" each turn, generate 2 Temporary Base Copies of it. When a Command Card with an Arithmetica Cost of 0 or 1 is played, all Awakeners gain 5 Aliemus.
 <RedQuality:Bastion>: When a card with a Default Arithmetica Cost of 3 or more is played, all enemies gain Shield equal to 20% of their Max HP.]]
  ...
  RelicConfig_140277_Name = {
    Text = "<RedQuality:Dimension Pendulum-Alert>"
  },
  RelicConfig_140278_BattleDesc = {
    Text = "<OrangeQuality:Rebirth>: Shield gained and Healing Effects +25%. When recovering HP or gaining Shield, for every 1% of Max HP recovered or Shielded, gain 10% Temporary DMG Amplification.\n <RedQuality:Whisper>: Each turn, gain STR▼ equal to 10% of Max HP."
  },
  RelicConfig_140278_Desc = {
    Text = "<OrangeQuality:Rebirth>: Shield gained and Healing Effects +25%. When recovering HP or gaining Shield, for every 1% of Max HP recovered or Shielded, gain 10% Temporary DMG Amplification.\n <RedQuality:Whisper>: Each turn, gain STR▼ equal to 10% of Max HP."
  },
  RelicConfig_140278_Name = {
    Text = "<RedQuality:Dimension Pendulum-Scare>"
  },
  RelicConfig_140279_BattleDesc = {
    Text = [[
<OrangeQuality:Dawn>: All Awakeners' Base Aliemus reduced by 30. The first Exalt Unleashed each turn gains 200% Final DMG bonus, 100% Shield and Healing bonus. After Unleashing Exalt 5 times, choose 1 Awakener to Rouse, and Refresh the Exalt amplification Effect.
 <RedQuality:Depletion>: Base Keyflare +200%]]
  },
...
<OrangeQuality:Dawn>: All Awakeners' Base Aliemus reduced by 30. The first Exalt Unleashed each turn gains 200% Final DMG bonus, 100% Shield and Healing bonus. After Unleashing Exalt 5 times, choose 1 Awakener to Rouse, and Refresh the Exalt amplification Effect.
 <RedQuality:Depletion>: Base Keyflare +200%]]
  ...
  RelicConfig_140279_Name = {
    Text = "<RedQuality:Dimension Pendulum-Voodoo>"
  },
  RelicConfig_140280_BattleDesc = {
    Text = [[
<OrangeQuality:Awaken>: After unleashing Exalt for the first time each turn, reset that Awakener's Exalt cooldown and grant them 50 Aliemus, generating temporary copies of all "Skills" with an Arithmetica Cost of 0.
<RedQuality:Seal>: After unleashing Exalt for the first time each turn, seal other Awakeners.]]
  },
...
<RedQuality:Seal>: After unleashing Exalt for the first time each turn, seal other Awakeners.]]
  ...
  RelicConfig_140281_BattleDesc = {
    Text = [[
<OrangeQuality:Echo>: At the start of your turn, Draw the 3 Command Cards with the highest Arithmetica from your Draw Pile. The first Command Card played each turn takes effect twice.
<RedQuality:Daze>: After playing a Command Card, discard all other Command Cards with an Arithmetica Cost equal to or higher than it.]]
  },
...
<RedQuality:Daze>: After playing a Command Card, discard all other Command Cards with an Arithmetica Cost equal to or higher than it.]]
  ...
  RelicConfig_140281_Name = {
    Text = "<RedQuality:Dimension Pendulum-Confuse>"
  },
  RelicConfig_140282_BattleDesc = {
    Text = [[
<OrangeQuality:Might>: All Awakeners' <PowerIconKeywords:Strength> is +50%. Gain [Arg2] Temporary <PowerIconKeywords:Strength> for each instance of DMG dealt.
<RedQuality:Formless>: At the Start of battle, all enemies gain 50 stacks of <ParcloseIconKeywords:Barrier>.]]
  },
...
<RedQuality:Formless>: At the Start of battle, all enemies gain 50 stacks of <ParcloseIconKeywords:Barrier>.]]
  ...
  RelicConfig_140282_Name = {
    Text = "<RedQuality:Dimension Pendulum-Lurk>"
  },
  RelicConfig_140840_BattleDesc = {
    Text = [[
Hand Limit +1. At battle start, generate 1 "<DerivativeCardKeywords_148:Gauntward>" and place it in hand. 
When any Awakener's "Basic Strike" is played, "<DerivativeCardKeywords_148:Gauntward>" Arithmetica Cost -1, inflict [Arg1] Corrosion on all enemies. 
When any Awakener's "Basic Defense" is played, gain [Arg2] STR, and the Final DMG and STR generation of "<DerivativeCardKeywords_148:Gauntward>" +[Arg3]% next time it is played.]]
  },
...
When any Awakener's "Basic Defense" is played, gain [Arg2] STR, and the Final DMG and STR generation of "<DerivativeCardKeywords_148:Gauntward>" +[Arg3]% next time it is played.]]
  ...
  RelicConfig_140840_Name = {
    Text = "The Futile Travail"
  },
  RelicConfig_140840_StoryDesc = {
    Text = "The futile man fears change, fears things slipping beyond his grasp; and in the deepest part of him, he fears loss with a frantic, hysterical dread. He blows the whistle again and again, hoping its sound will let him control everything, yet he can hold on to nothing."
  },
  RelicConfig_143665_BattleDesc = {
    Text = "Pontos gains [Arg1] Aliemus at turn start. When picked up, generate 3 Permanent \"Gaunt\" cards at the start of next battle. Pontos gains 3 Aliemus after playing a \"Gaunt\"."
  },
  RelicConfig_143665_Desc = {
    Text = "Pontos gains [Arg1] Aliemus at turn start. When picked up, generate 3 Permanent \"Gaunt\" cards at the start of next battle. Pontos gains 3 Aliemus after playing a \"Gaunt\"."
  },
  RelicConfig_143665_Name = {
    Text = "<OrangeQuality:Dimensional Image: Pontos>"
  },
  RelicConfig_145438_BattleDesc = {
    Text = "At turn start, gain [Arg1] Aliemus. After releasing \"Mundus Severance\", perform Pursuit: \"Netherblade\" at the start of next turn: Deal DMG equal to 400% Lotan: Cetarchon's ATK to all enemies. This Pursuit benefits from the DMG Bonus that \"Mundus Severance\" enjoys through \"Great Blade: Whale Fall\" and counts as a \"Strike\"."
  },
  RelicConfig_145438_Desc = {
    Text = "At turn start, gain [Arg1] Aliemus. After releasing \"Mundus Severance\", perform Pursuit: \"Netherblade\" at the start of next turn: Deal DMG equal to 400% Lotan: Cetarchon's ATK to all enemies. This Pursuit benefits from the DMG Bonus that \"Mundus Severance\" enjoys through \"Great Blade: Whale Fall\" and counts as a \"Strike\"."
  },
  RelicConfig_145438_Name = {
    Text = "<OrangeQuality:Dimensional Image: Lotan: Cetarchon>"
  },
  RelicConfig_146128_BattleDesc = {
    Text = "Hand Limit +1. At the start of combat or after playing \"<DerivativeCardKeywords_157:Bone of Blades>\", place 1 \"<DerivativeCardKeywords_155:Bone of Fury>\" into hand and shuffle 1 \"<DerivativeCardKeywords_156:Bone of Agony>\" into Draw Pile. If \"<DerivativeCardKeywords_155:Bone of Fury>\" and \"<DerivativeCardKeywords_156:Bone of Agony>\" are both played in the same turn, combine these two cards into \"<DerivativeCardKeywords_157:Bone of Blades>\" and place it into hand."
  },
  RelicConfig_146128_Desc = {
    Text = "Hand Limit +1. At the start of combat or after playing \"<DerivativeCardKeywords_157:Bone of Blades>\", place 1 \"<DerivativeCardKeywords_155:Bone of Fury>\" into hand and shuffle 1 \"<DerivativeCardKeywords_156:Bone of Agony>\" into Draw Pile. If \"<DerivativeCardKeywords_155:Bone of Fury>\" and \"<DerivativeCardKeywords_156:Bone of Agony>\" are both played in the same turn, combine these two cards into \"<DerivativeCardKeywords_157:Bone of Blades>\" and place it into hand."
  },
  RelicConfig_146128_Name = {
    Text = "Armor of Whalebone"
  },
  RelicConfig_146128_StoryDesc = {
    Text = "The bones of Leviathan shield Its chosen, rendering them invincible and immortal."
  },
  ...
  RelicConfig_147665_BattleDesc = {
    Text = "Arithmetica Limit and draws per turn +1. At the start of your turn, <FaxianKeywords:Discover> 3 \"<Caroboo_Tips:Pistoles de Marie>\"—only one is Real. Picking the Real one grants its positive effect and dispels 1 random debuff, and resets this card's bonus. Picking a Fake one inflicts its negative effect, and your next Discover gains +1 Real option with doubled effects."
  },
  ...
  RelicConfig_147665_StoryDesc = {
    Text = "Sweet and precious... or is it?"
  },
  RelicConfig_148525_BattleDesc = {
    Text = "At the start of the turn, Oath-Bound · Ogier gains [Arg1] Aliemus, and \"Dark Surge\" no longer reduces the number of draws."
  },
  RelicConfig_148525_Desc = {
    Text = "At the start of the turn, Oath-Bound · Ogier gains [Arg1] Aliemus, and \"Dark Surge\" no longer reduces the number of draws."
  },
  RelicConfig_148525_Name = {
    Text = "<OrangeQuality:Dimensional Image · Oath-Bound · Ogier>"
  },
  RelicConfig_149665_BattleDesc = {
    Text = [[
The current terrain counts as "Icefield."
In Hyperborea: After the Draw Phase, apply 1 stack of <SlowIconKeywords:Stagnation> and <RetainIconKeywords:Retain> to the 2 unfrozen Command Cards with the highest Arithmetica Cost in hand. When any Command Card has at least 3 stacks of <SlowIconKeywords:Stagnation>, remove its <SlowIconKeywords:Stagnation> and <RetainIconKeywords:Retain> (obtained from this battle), Freeze it, and apply 25 stacks of <TempPowerKeywords2:Enhance>.]]
  },
...
In Hyperborea: After the Draw Phase, apply 1 stack of <SlowIconKeywords:Stagnation> and <RetainIconKeywords:Retain> to the 2 unfrozen Command Cards with the highest Arithmetica Cost in hand. When any Command Card has at least 3 stacks of <SlowIconKeywords:Stagnation>, remove its <SlowIconKeywords:Stagnation> and <RetainIconKeywords:Retain> (obtained from this battle), Freeze it, and apply 25 stacks of <TempPowerKeywords2:Enhance>.]]
  ...
  RelicConfig_149665_Name = {
    Text = "<OrangeQuality:Crystal Globe>"
  },
  RelicConfig_149665_StoryDesc = {
    Text = [[
It does not bring the cold.
It merely reminds the earth that winter never left.]]
  },
  ...
  RelicConfig_20166_Desc = {
    Text = "<ProficientInRealmsIconKeywords:Realm Mastery> +100. Place the first card played each turn from the Discard Pile back into hand. At the start of an Ultra Round, the Hand Limit for that turn +5 and your hand is duplicated, the duplicates gain <NothingnessIconKeywords:Fleeting> and <DepleteIconKeywords:Exhaust>."
  },
  ...
  RelicConfig_20169_BattleDesc = {
    Text = "<ProficientInRealmsIconKeywords:Realm Mastery> +100. Each card played, <EmbryoFusionIconKeywords:Embryo Fusion> +10; when HP is below 25%, the increase becomes 20%. This effect can trigger a maximum of 10 times per turn."
  },
...
Stay still; they prefer quiet exhibits.]]
  ...
  RelicConfig_20174_BattleDesc = {
    Text = "Upon pickup, Team DMG Amplification x150%. At turn start, deal [Arg1] <FixedDamage:Pure DMG> to a random enemy. For each Posse used in this battle, increase the DMG dealt by [Arg2]. This DMG bonus enjoys Team DMG Amplification bonus."
  },
  ...
  RelicConfig_20175_BattleDesc = {
    Text = "The <WeaknessIconKeywords:Weakness> effect +8%, and the <VulnerabilityIconKeywords:Vulnerable> effect +25%. When applying <WeaknessIconKeywords:Weakness> or <VulnerabilityIconKeywords:Vulnerable>, temporarily steal [Arg1] <PowerIconKeywords:STR> from the target."
  },
  ...
  RelicConfig_20178_BattleDesc = {
    Text = "Each time you deal 1 instance of Active DMG, gain 3 Aliemus and inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison> to the Target. If the number of triggers reaches 25 within this battle, immediately inflict <IntoxicationIconKeywords:Poison> on all Enemy targets."
  },
  RelicConfig_20178_Desc = {
    Text = "Each time you deal 1 instance of Active DMG, gain 3 Aliemus and Inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison> to the Target. If the number of triggers reaches 25 times within this battle, immediately Inflict <IntoxicationIconKeywords:Poison> on all Enemy targets."
  },
...
Since then, it has been able to summon flames.]]
  ...
  RelicConfig_35139_BattleDesc = {
    Text = "Upon pickup, increase the team's DMG Amplification by 30%. Every 4th instance of DMG dealt will be a Critical Hit, and Crit. DMG +50%. If the hit results in a kill, gain 5 Black Sigil."
  },
  ...
  RelicConfig_44192_BattleDesc = {
    Text = "At turn start, all Awakeners gain 20 Aliemus. When picked up, Max HP -50%."
  },
  ...
  RelicConfig_44594_BattleDesc = {
    Text = "Every 2 turns, double the Active and Tentacle DMG all enemies receive in that turn. However, after releasing Exalt in that turn, seal all Awakeners for 1 turn and make self Vulnerable."
  },
...
Separated from the torso, it has been tainted by sin.]]
  ...
  RelicConfig_44597_BattleDesc = {
    Text = "For every instance of Active DMG dealt, apply [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <BleedingIconKeywords:Bleed> to self and [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of <BleedingIconKeywords:Bleed> to the target."
  },
  RelicConfig_44597_Desc = {
    Text = "For every Active DMG instance, Inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <BleedingIconKeywords:Bleed> to self and [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of <BleedingIconKeywords:Bleed> to the DMG target."
  },
  ...
  RelicConfig_44603_BattleDesc = {
    Text = "Increase Hand Limit by 5 and draw 6 cards At battle start. At turn end, discard all Symptom Cards and State Cards in hand, retain other cards, but draw 2 fewer cards each turn."
  },
  RelicConfig_44603_Desc = {
    Text = "Increase Hand Limit by 5 and draw 6 cards At battle start. At turn end, discard all Symptom Cards and State Cards in hand, keeping other cards, but draw 2 fewer cards each turn."
  },
  ...
  RelicConfig_44654_BattleDesc = {
    Text = "Max Arithmetica +4. Add 4 copies of <DerivativeCardKeywords_4:Insight> to the Draw Pile each time you reset your deck."
  },
  ...
  RelicConfig_44656_BattleDesc = {
    Text = "Relic Capacity +[Arg1], \"D-Mark\" refreshes +1. After the battle, gain 125 Black Sigil. When picking up, you can choose to delete up to 6 Symptom Cards."
  },
  ...
  RelicConfig_44659_BattleDesc = {
    Text = "For each instance of Active DMG dealt, restore [Arg1] HP and apply [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of <BleedingIconKeywords:Bleed> to the target."
  },
  RelicConfig_44659_Desc = {
    Text = "For each Active DMG dealt, restore [Arg1] HP and Inflict [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of <BleedingIconKeywords:Bleed> to the target."
  },
  ...
  RelicConfig_44660_BattleDesc = {
    Text = "Increase hand limit by 5 and replenish hand to the limit At battle start. Draw 1 additional card at turn start, and discard all Symptom Cards and State Cards at turn end while retaining other cards."
  },
  RelicConfig_44660_Desc = {
    Text = "Increase hand limit by 5 and replenish hand to the limit At battle start. Draw 1 extra card at turn start, and discard all Symptom Cards and State Cards at turn end while keeping other cards."
  },
...
Even though it has separated from the body, its footprints have spread across the world.]]
  ...
  RelicConfig_44664_BattleDesc = {
    Text = "Gain [Arg1] <PowerIconKeywords:STR> permanently after picking it up. Whenever DMG is dealt, heal [Arg2] HP, with a maximum of 6 triggers per turn."
  },
  RelicConfig_44664_Desc = {
    Text = "Upon picking it up, permanently Gain [Arg1] <PowerIconKeywords:STR>. Whenever DMG is dealt, heal for [Arg2] HP, with a maximum of 6 triggers per turn."
  },
  ...
  RelicConfig_51687_BattleDesc = {
    Text = "After playing a Command Card that is not \"Strike\" or \"Defense,\" if the card is not a Derived Card, the corresponding Awakener gains 15 Aliemus, triggering up to 5 times per Turn. On the first trigger of each Turn, the played card will also be returned to hand."
  },
  ...
  RelicConfig_51689_BattleDesc = {
    Text = "At battle start, shuffle 3 random Symptom Cards into your deck. At turn start, draw 1 card. Playing each Symptom Card grants 2 Arithmetica. Discarding each Symptom Card grants all Awakeners 5 Aliemus, up to 5 times per turn."
  },
...
Stay still; they prefer quiet exhibits.]]
  ...
  RelicConfig_56355_BattleDesc = {
    Text = "Hand Limit +2, draw 1 card at the start of your turn. After the battle, gain [Arg1] <plural value=\"[Arg1]\" singular=\"layer\" plural=\"layers\"> of \"Ink,\" and when \"Ink\" reaches 2 stacks, it will be consumed to choose 1 \"Imagery\" to place into your deck."
  },
  RelicConfig_56355_Desc = {
    Text = "Hand Limit +2, draw 1 card at turn start. After the battle, gain [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of \"Ink,\" and when \"Ink\" reaches 2 stacks, it will be exhausted to choose 1 \"Image\" to place into the deck."
  },
  ...
  RelicConfig_57732_BattleDesc = {
    Text = "All Awakener's Crit. Rate +15%. The final result of Ryker and dice random effects +1."
  },
  RelicConfig_57732_Desc = {
    Text = "All Awakeners' Crit. Rate +15%. The final result of Ryker and dice random effects +1."
  },
  ...
  RelicConfig_57733_Desc = {
    Text = "At the start of each turn and when Ryker or the dice's random effect is triggered, gain 100 Keyflare and 4% Crit. DMG, up to 50% Crit. DMG. Removed at the end of the battle."
  },
...
Gaze at it for more than five seconds, and you will summon @2.]]
  ...
  RelicConfig_57735_Desc = {
    Text = "At the start of each turn and when Ryker or the dice's random effect is triggered, gain 50 Keyflare and 2% Crit. DMG, up to 30% Crit. DMG. Removed at the end of the battle."
  },
...
Gaze at it for more than five seconds, and you will summon @2.]]
  ...
  RelicConfig_57737_BattleDesc = {
    Text = "All Awakeners' Crit. Rate +10%. The random effects of Ryker and the dice cannot be the lowest value."
  },
  RelicConfig_57737_Desc = {
    Text = "All Awakeners' Crit. Rate +10%. The random effects of Ryker and dice cannot be the lowest value."
  },
  ...
  RelicConfig_58872_Desc = {
    Text = "At battle start, increase the Arithmetica Limit by 1 and Rouse all Awakeners. For the next 5 turns, At turn start, gain a Relic from \"Rusty Lancet, Modern Axle, Our Home, Eerie Hook, Chrono Pendulum: Trance\"."
  },
...
Stay still; they prefer quiet exhibits.]]
  ...
  RelicConfig_60723_Desc = {
    Text = "Max Arithmetica +1. Draw an additional card at turn start and gain 1 \"Symphony of Harmony\". If 3 Command Cards with the same Arithmetica are played consecutively, all Awakeners gain 20 Aliemus. The reset count is reset at turn start and after triggering."
  },
...
A slender conductor's baton, yet possesses strength greater than a crowbar.
 ...
 Conducting notes, conducting soul, conducting fate.]]
  ...
  RelicConfig_60724_BattleDesc = {
    Text = "At battle start, gain \"Vulnerable\" Orison and \"Burst\" Orison along with their Adv.versions, and choose an Orison to place on a card."
  },
  RelicConfig_60724_Desc = {
    Text = "At battle start, gain \"Vulnerable\" Orison and \"Burst\" Orison and their Adv. Orisons, choose an Orison on a card."
  },
...
May the Silver Key light your path, Mythag's Keeper.]]
  ...
  RelicConfig_60727_BattleDesc = {
    Text = "At battle start, gain \"Bastion\" Orison and \"Finesse\" Orison and their Adv. Orisons, choose an Orison on a card."
  },
  RelicConfig_60727_Desc = {
    Text = "At battle start, gain \"Bastion\" Orison and \"Finesse\" Orison and their Adv. Orisons, and choose an Orison on a card."
  },
...
<D05EX_Relic:With your help, no one from the Expedition Team survived, and you indifferently gained the greatest benefit for yourself. But was it all really worth it?>]]
  ...
  RelicConfig_67690_BattleDesc = {
    Text = "At turn start, all Awakeners gain 25 Aliemus. When picked up, Max HP +1.5 times."
  },
  ...
  RelicConfig_68654_BattleDesc = {
    Text = "At battle start, Rouse all Awakener, place <DerivativeCardKeywords_88:\"Twilight: Utopian Veil\"> into hand, increase the team's hand limit by +2, and increase the Keyflare storage limit by +100%. After releasing the Posse, all Awakeners' Crit. DMG and Temporary Crit. Rate +[Arg1]%, receive Shield equal to 20% of their Max HP, and draw cards until the hand reaches the limit."
  },
  RelicConfig_68654_Desc = {
    Text = "At battle start, Rouse all Awakeners, draw <DerivativeCardKeywords_88:\"Twilight: Utopian Veil\"> into hand, increase the team's hand limit by +2, and increase the Keyflare storage limit by +100%. After releasing the Posse, all Awakeners' Crit. DMG and Temporary Crit. Rate +[Arg1]%, receive Shield equal to 20% of their Max HP, and draw cards until the hand limit is reached."
  },
  ...
  RelicConfig_68657_BattleDesc = {
    Text = "At battle start, Rouse all Awakeners, place <DerivativeCardKeywords_87:\"Twilight: The Envoy's Verdict\"> into hand, and double the team's DMG Amplification. The Weakness effect inflicted by you increases from 25% to 50%. At the end of each turn, gain Shield equal to [Arg1]% of Max HP and deal <FixedDamage:Pure DMG> equal to [Arg2] x Shield to all enemies."
  },
  ...
  RelicConfig_68886_BattleDesc = {
    Text = "Tawil's DMG, Shield, and Healing +50%. At the start of combat, Tawil gains 120 Aliemus."
  },
  ...
  RelicConfig_70700_BattleDesc = {
    Text = "All Awakeners' Base DMG +[Arg1]%."
  },
  RelicConfig_70700_Desc = {
    Text = "The Base DMG dealt by all Awakeners +[Arg1]%."
  },
...
Finely crafted and gleaming, they once embodied the friendship of two children.]]
  ...
  RelicConfig_70709_BattleDesc = {
    Text = "After entering the Ultra Round, the first Non-Derived Command Card played activates an additional [Arg1] <plural value=\"[Arg1]\" singular=\"time\" plural=\"times\">."
  },
  ...
  RelicConfig_70715_BattleDesc = {
    Text = "After using Keyflare Rouse, draw [Arg1] <plural value=\"[Arg1]\" singular=\"card\" plural=\"cards\"> and gain [Arg2] Keyflare."
  },
...
It is now empty, containing nothing.]]
  ...
  RelicConfig_70717_BattleDesc = {
    Text = "At turn start, draw [Arg1] <plural value=\"[Arg1]\" singular=\"card\" plural=\"cards\">."
  },
  ...
  RelicConfig_70718_BattleDesc = {
    Text = "After releasing \"Exalt,\" all enemies take [Arg1] <FixedDamage:Pure DMG> and trigger [Arg2]% <IntoxicationIconKeywords:Poison>."
  },
  RelicConfig_70718_Desc = {
    Text = "After releasing \"Exalt, \" all enemies take 1 instance of <FixedDamage:Pure DMG> equal to [Arg2]% of team's Max HP and trigger [Arg2]% <IntoxicationIconKeywords:Poison>."
  },
...
The collector was captivated by its beautiful fluorescence, admiring it day and night, until he eventually withered away and became one of its kind.]]
  ...
  RelicConfig_70724_BattleDesc = {
    Text = "Gain [Arg1] <PowerIconKeywords:STR> when the battle begins."
  },
  ...
  RelicConfig_70725_BattleDesc = {
    Text = "After the battle starts, apply [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <WeaknessIconKeywords:Weakness> to all enemies, with the effect doubled in Boss Battles. All Awakeners' Base DMG is +[Arg2]%."
  },
  RelicConfig_70725_Desc = {
    Text = "After the battle starts, Inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <WeaknessIconKeywords:Weakness> to all enemies, with the effect doubled in Boss Battles. All Awakeners' Base DMG is +[Arg2]%."
  },
  ...
  RelicConfig_70731_BattleDesc = {
    Text = "When attacked by an enemy, deal [Arg1] <FixedDamage:Pure DMG> to them. This DMG enjoys [Arg2]% <RetaliateIconKeywords:Counter> bonus. Each enemy can trigger this effect up to 1 time per turn."
  },
  RelicConfig_70731_Desc = {
    Text = "When attacked by an enemy, deal <FixedDamage:Pure DMG> equal to [Arg3]% of team's Max HP. This DMG enjoys a [Arg2]% <RetaliateIconKeywords:Counter> bonus. Each enemy can trigger this effect up to 1 time per turn."
  },
  ...
  RelicConfig_70737_BattleDesc = {
    Text = "After playing a card, if the number of cards in hand is less than or equal to [Arg1], draw [Arg2] <plural value=\"[Arg2]\" singular=\"card\" plural=\"cards\">. This effect can trigger up to [Arg3] <plural value=\"[Arg3]\" singular=\"time\" plural=\"times\"> per turn."
  },
  ...
  RelicConfig_70745_BattleDesc = {
    Text = "Gain [Arg1] <RetaliateIconKeywords:Counter> at the start of battle. Effects are doubled in Boss Battles."
  },
  ...
  RelicConfig_70753_BattleDesc = {
    Text = "After the battle starts, apply [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <VulnerabilityIconKeywords:Vulnerable> to all enemies, with the effect doubled in Boss Battles. All Awakeners' Base DMG is +[Arg2]%."
  },
  RelicConfig_70753_Desc = {
    Text = "After the battle starts, Inflict [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <VulnerabilityIconKeywords:Vulnerable> to all enemies, with the effect doubled in Boss Battles. All Awakener base DMG is +[Arg2]%."
  },
  ...
  RelicConfig_70757_BattleDesc = {
    Text = "Use the Raging Waves stance to immediately activate all Tentacle attacks on enemies [Arg1] <plural value=\"[Arg1]\" singular=\"time\" plural=\"times\">, with a 3-turn cooldown."
  },
  RelicConfig_70757_Desc = {
    Text = "Activate all Tentacle attacks on enemies immediately using the Raging Waves stance [Arg1] <plural value=\"[Arg1]\" singular=\"time\" plural=\"times\">, with a 3-turn cooldown."
  },
...
The collector was captivated by its beautiful fluorescence, admiring it day and night, until he eventually withered away and became one of its kind.]]
  ...
  RelicConfig_71195_BattleDesc = {
    Text = "At turn start, Ramona: Timeworn gains [Arg1] Aliemus. The first time \"Loop\" is triggered each turn, gain [Arg2] Keyflare and [Arg3] <plural value=\"[Arg3]\" singular=\"stack\" plural=\"stacks\"> of \"Negentropy\"."
  },
  ...
  RelicConfig_71197_BattleDesc = {
    Text = "At turn start, Ramona gains [Arg1] Aliemus. For every [Arg2]rd Command Card played, that Command Card takes effect 1 additional time and gains [Arg3] Keyflare."
  },
  ...
  RelicConfig_71230_BattleDesc = {
    Text = "At turn start, Leigh gains [Arg1] Aliemus. Whenever she loses HP, she gains [Arg2] STR, up to [Arg3] <plural value=\"[Arg3]\" singular=\"time\" plural=\"times\"> per battle. After stacking [Arg3] <plural value=\"[Arg3]\" singular=\"time\" plural=\"times\">, the Base Arithmetica Cost of \"Pain and Pleasure\" -2, and the DMG count +1."
  },
  ...
  RelicConfig_71231_BattleDesc = {
    Text = "At turn start, Aurita gains [Arg1] Aliemus. The DMG count of \"Gland Division\" +[Arg2], and after playing Aurita's \"Defense,\" 1 \"Gland Division\" is added to hand."
  },
  ...
  RelicConfig_71232_BattleDesc = {
    Text = "At turn start, Tinct gains [Arg1] Aliemus. After triggering a Leap with Tinct's Command Card, return it to hand and reduce its Arithmetica Cost by 1 before playing. This effect can occur a maximum of [Arg2] <plural value=\"[Arg2]\" singular=\"time\" plural=\"times\"> per turn."
  },
  RelicConfig_71232_Desc = {
    Text = "At turn start, Tinct gains [Arg1] Aliemus. After triggering a Leap with Tinct's Command Card, return it to hand and reduce its Arithmetica Cost by 1. This effect can occur a maximum of [Arg2] <plural value=\"[Arg2]\" singular=\"time\" plural=\"times\"> per turn."
  },
  ...
  RelicConfig_71236_BattleDesc = {
    Text = "At turn start, Daffodil gains [Arg1] Aliemus and 1 \"Insight\" card. The STR gained from \"Heterogeneous Tides\" +[Arg2]%, and each card played permanently increases it further by [Arg3]% for this exploration, up to [Arg4]%."
  },
  ...
  RelicConfig_71237_BattleDesc = {
    Text = "At turn start, Wanda gains [Arg1] Aliemus and [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of \"Dreamlure\". If this is an Ultra Round, additionally put 1 Temporary \"Spine Needle Chains\" and \"Keeper of the Lost\" into hand, and cause Wanda's next Command Card to take effect 2 times."
  },
  ...
  RelicConfig_71239_BattleDesc = {
    Text = "At turn start, \"24\" gains [Arg1] Aliemus. At turn start, if \"24\" is in the \"Depressed Persona\" state at turn start, she gains an additional [Arg2] Aliemus; if in the \"Manic Persona\" state, her Temporary Crit. Rate and Temporary Crit. DMG +[Arg2]%."
  },
  ...
  RelicConfig_71244_BattleDesc = {
    Text = "At turn start, Sorel gains [Arg1] Aliemus. For each instance of DMG dealt by Sorel, Embryo Fusion +[Arg2], up to [Arg3] <plural value=\"[Arg3]\" singular=\"time\" plural=\"times\"> per turn. After triggering 10 times, Sorel's Final DMG in this battle +[Arg4]%."
  },
  ...
  RelicConfig_71246_BattleDesc = {
    Text = "At turn start, Alva gains [Arg1] Aliemus. Within 1 turn, after playing the [Arg2]nd \"Defense\" card, place a \"Precision Slash\" with Exhaust into hand; after playing the [Arg3]nd \"Strike\" card, place a \"Combat Stance\" with Exhaust into hand."
  },
  ...
  RelicConfig_71249_BattleDesc = {
    Text = "At turn start, Ryker gains [Arg1] Aliemus. The result of the first dice roll each turn is always maxed out."
  },
  ...
  RelicConfig_71251_BattleDesc = {
    Text = "At turn start, Winkle gains [Arg1] Aliemus. Each time another Awakeners unleashes Exalt, Winkle gains [Arg2] Aliemus, and the Arithmetica Cost of \"Psyche Reforged\" in hand -[Arg3]."
  },
  ...
  RelicConfig_71253_BattleDesc = {
    Text = "At turn start, Faint gains [Arg1] Aliemus. Faint's Shield Generation, Counter, and HP recovery +[Arg2]%. Each time Death Resistance is triggered, this effect +[Arg3]% for the current exploration, up to [Arg4] <plural value=\"[Arg4]\" singular=\"time\" plural=\"times\">."
  },
  RelicConfig_71253_Desc = {
    Text = "At turn start, Faint gains [Arg1] Aliemus. Faint's Shield, Counter, and HP recovery effects +[Arg2]%. Each time Death Resistance is triggered, this effect +[Arg3]% for the current exploration, up to [Arg4] <plural value=\"[Arg4]\" singular=\"time\" plural=\"times\">."
  },
  RelicConfig_71253_Name = {
    Text = "<OrangeQuality:Dimensional Image: Faint>"
  },
  RelicConfig_71254_BattleDesc = {
    Text = "At turn start, Tawil gains [Arg1] Aliemus. If [Arg2] of Tawil's Command Cards are played in one turn, add 1 <DerivativeCardKeywords_67:<DerivativeCardKeywords_67:\"Silver Key Dawn\">> to hand. Cooldown: [Arg3] <plural value=\"[Arg3]\" singular=\"turn\" plural=\"turns\">."
  },
  ...
  RelicConfig_71255_BattleDesc = {
    Text = "At turn start, Hameln gains [Arg1] Aliemus. The Base Arithmetica Cost of \"Soul Overture\" -[Arg2], and the Base DMG count is +[Arg3]."
  },
  ...
  RelicConfig_71256_BattleDesc = {
    Text = "At turn start, Horla gains [Arg1] Aliemus. At the start of the battle, gain [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of \"Metaphor\" for all emotions, increasing the \"Metaphor\" effect by 50%."
  },
  ...
  RelicConfig_71258_BattleDesc = {
    Text = "At turn start, Uvhash gains [Arg1] Aliemus. Uvhash's Base Aliemus -[Arg2], which further -5 every time he releases Exalt. He can release Exalt [Arg3] <plural value=\"[Arg3]\" singular=\"time\" plural=\"times\"> per turn."
  },
  ...
  RelicConfig_71259_BattleDesc = {
    Text = "At turn start, Aigis gains [Arg1] Aliemus. When Aigis deals DMG to enemies with Vulnerable, she also steals [Arg2] Temporary STR, up to [Arg3] <plural value=\"[Arg3]\" singular=\"time\" plural=\"times\"> per turn."
  },
  ...
  RelicConfig_71260_Desc = {
    Text = "At turn start, Thais gains [Arg1] Aliemus. After playing [Arg2] Command Cards in one turn, Thais gains 1 \"Scion of Purity\" and [Arg3] Temporary STR, with a cooldown of [Arg4] <plural value=\"[Arg4]\" singular=\"turn\" plural=\"turns\">."
  },
  ...
  RelicConfig_71263_BattleDesc = {
    Text = "At turn start, Lily gains [Arg1] Aliemus. Lily's Endure limit +100%, and when releasing \"Undying Flower Upon Slime\" or \"Strike to Protect,\" Lily restores HP equal to 8% of the \"Endure\" stacks."
  },
  ...
  RelicConfig_71264_BattleDesc = {
    Text = "At turn start, Karen gains [Arg1] Aliemus. Playing \"Silent Fealty\" will return double the consumed Arithmetica, with a cooldown of [Arg2] <plural value=\"[Arg2]\" singular=\"turn\" plural=\"turns\">."
  },
  RelicConfig_71264_Desc = {
    Text = "At turn start, Karen gains [Arg1] Aliemus. Playing \"Silent Fealty\" will return double the exhausted Arithmetica, with a cooldown of [Arg2] <plural value=\"[Arg2]\" singular=\"turn\" plural=\"turns\">."
  },
  ...
  RelicConfig_71266_BattleDesc = {
    Text = "At turn start, Caecus gains [Arg1] Aliemus. When Caecus gains Shield, he regains [Arg2]% of the Shield amount as HP."
  },
  ...
  RelicConfig_71267_BattleDesc = {
    Text = "At turn start, Nymphaea gains [Arg1] Aliemus. After playing Nymphaea's \"Strike,\" the Poison dealt by \"Nymphaea\" in this battle +[Arg2]%. After playing Nymphaea's \"Defense,\" it triggers [Arg3]% Poison to all enemies. Each effect can take place at most once per turn."
  },
  ...
  RelicConfig_71269_BattleDesc = {
    Text = "At turn start, Goliath gains [Arg1] Aliemus. If Goliath deals DMG [Arg2] <plural value=\"[Arg2]\" singular=\"time\" plural=\"times\"> within 1 turn, the DMG dealt by Goliath in this battle enjoys an additional 1× STR bonus with a 3-turn cooldown."
  },
  RelicConfig_71269_Desc = {
    Text = "At turn start, Goliath gains [Arg1] Aliemus. If Goliath deals DMG [Arg2] <plural value=\"[Arg2]\" singular=\"time\" plural=\"times\"> within 1 turn, the DMG dealt by Goliath in this battle enjoys an additional 1× STR bonus, with a cooldown of 3 turns."
  },
...
"Taboo Trade" has 4 Arithmetica Cost, Retain, Prepare, & Exhaust, and has 3 custom effects. Playing "Strike," "Defense," or "Skill" Command Cards will enhance its 1st, 2nd, or 3rd effects respectively.]]
  ...
  RelicConfig_78665_BattleDesc = {
    Text = "At turn start, draw [Arg1] fewer cards. Gain 1 Arithmetica for each card played that cost >= [Arg2] Arithmetica, up to [Arg3] <plural value=\"[Arg3]\" singular=\"time\" plural=\"times\"> per turn."
  },
  RelicConfig_78665_Desc = {
    Text = "At turn start, draw [Arg1] less cards. Gain 1 Arithmetica for each card played with Arithmetica Cost >= [Arg2], triggering up to [Arg3] <plural value=\"[Arg3]\" singular=\"time\" plural=\"times\"> per turn."
  },
...
Ding, ding, it's hungry, you know.]]
  ...
  RelicConfig_78666_Desc = {
    Text = "At turn start, gain [Arg1] Counter. After using Exalt [Arg2] <plural value=\"[Arg2]\" singular=\"time\" plural=\"times\"> in one turn, remove [Arg3]% Permanent Counter, and gain [Arg4]% of the removed amount as Temporary Counter. Cooldown: [Arg5] <plural value=\"[Arg5]\" singular=\"turn\" plural=\"turns\">."
  },
...
Even though it has separated from the body, its footprints have spread across the world.]]
  ...
  RelicConfig_78667_BattleDesc = {
    Text = "After the draw phase, draw [Arg1] <plural value=\"[Arg1]\" singular=\"additional card\" plural=\"additional cards\">. and choose [Arg2] <plural value=\"[Arg2]\" singular=\"card\" plural=\"cards\"> from your hand to discard."
  },
...
The top hat winked as if ready to emerge.]]
  ...
  RelicConfig_78669_BattleDesc = {
    Text = "Gain [Arg1] STR At battle start. At turn start, for every [Arg2] permanent STR, gain [Arg3] Temporary STR, up to [Arg4] Temporary STR, and lose Shield equals to half of the Temporary STR gained by that Relic at turn end."
  },
  RelicConfig_78669_Desc = {
    Text = "Gain [Arg1] STR At battle start. At turn start, for each [Arg2] Permanent STR, gain [Arg3] Temporary STR, up to [Arg4] Temporary STR, and lose Shield equals to half of the Temporary STR gained by that Relic at turn end."
  },
  ...
  RelicConfig_78671_BattleDesc = {
    Text = "At turn start, Embryo Fusion +[Arg1]. \"Embryo\" cards will be discarded at turn end."
  },
...
"Into an incredibly delicious dessert."]]
  ...
  RelicConfig_80340_BattleDesc = {
    Text = "At turn start, Clementine gains [Arg1] Aliemus. The number of times Clementine's Command Cards deal DMG, generate Shield, recover HP, gain Aliemus, and gain Keyflare +1."
  },
...
Each time you lose 10% of your initial Max HP, gain 1 stack of "Moored Off," max 10 stacks. "Moored Off" enhances the effects of "Harbored Rest".]]
  ...
  RelicConfig_84113_BattleDesc = {
    Text = "At turn start, Caraboo gains [Arg1] Aliemus. Caraboo's <DerivativeCardKeywords_152:Blessing> cards offers 1 more option upon being <FaxianKeywords:Discovered>. Caraboo's Exalt inflicts <Corrosion:Corrosion> stacks equal to the amount of DMG dealt."
  },
  RelicConfig_84113_Desc = {
    Text = "At turn start, Caraboo gains [Arg1] Aliemus. Caraboo's <DerivativeCardKeywords_152:Blessing> cards offers 1 more option upon being <FaxianKeywords:Discovered>. Caraboo's Exalt inflicts <Corrosion:Corrosion> stacks equal to the amount of DMG dealt."
  },
  RelicConfig_84113_Name = {
    Text = "<OrangeQuality:Dimensional Image: Caraboo>"
  },
  ...
  RelicConfig_84121_BattleDesc = {
    Text = "At the start of each turn, Arachne gains <Energy:[Arg1]> Aliemus. When Arachne's Basic Strike or Basic Defense are played, she performs her Pursuit: \"Infinite Threads.\" These 2 effects can trigger up to once each turn respectively, and do not consume <SilkKeywords:Weaver>."
  },
  RelicConfig_84121_Desc = {
    Text = "At the start of each turn, Arachne gains <Energy:[Arg1]> Aliemus. When Arachne's Basic Strike or Basic Defense are played, she performs her Pursuit: \"Infinite Threads.\" These 2 effects can trigger up to once each turn respectively, and do not consume <SilkKeywords:Weaver>."
  },
  RelicConfig_84121_Name = {
    Text = "<OrangeQuality:Dimensional Image: Arachne>"
  },
  RelicConfig_84122_BattleDesc = {
    Text = "At turn start, Tulu gains [Arg1] Aliemus. Tulu's Aliemus Cost -[Arg2], and after releasing Exalt, instantly generate [Arg3] Temporary Tentacles."
  },
  RelicConfig_84122_Desc = {
    Text = "At turn start, Tulu gains [Arg1] Aliemus. The Aliemus Cost for Tulu -[Arg2], and after releasing Exalt, it instantly generates [Arg3] Temporary Tentacles."
  },
  ...
  RelicConfig_84124_BattleDesc = {
    Text = "At turn start, Hameln gains [Arg1] Aliemus. The Arithmetica Cost of \"Soul Overture\" -[Arg2], and the Base DMG count is +[Arg3]."
  },
  ...
  RelicConfig_84127_BattleDesc = {
    Text = "At turn start, Corposant gains [Arg1] Aliemus and 1 Temporary Tentacle. Whenever Death Resistance is triggered, Corposant gains [Arg2] Aliemus, and places 1 \"Lightning Retribution\" with 0 Arithmetica Cost and Exhaust into hand."
  },
  ...
  RelicConfig_89252_BattleDesc = {
    Text = [[
Arithmetica Limit increased by 1, draw 1 extra card per turn, and at the start of the battle, gain [Arg1] <plural value="[Arg1]" singular="stack" plural="stacks"> of "Fateful Cage" count.
...
Each stack of "Fateful Cage" reduces all Awakeners' Aliemus by [Arg2]%, and with each Exalt release, decrease 1 stack of "Fateful Cage." After all "Fateful Cages" are removed, all Awakeners gain [Arg3] Aliemus, gaining "Unyielding Heart": all Awakeners' Aliemus +[Arg4]%, and Exalt can be released twice per turn.]]
  ...
  RelicConfig_89645_BattleDesc = {
    Text = [[
Hand Limit +2, after Exalt, Temporary Final DMG +10%.
...
At the beginning of the turn, if there is no "Soul Devour," place it in hand. If "Fullness" reaches 10, it will be transformed into "Memory Resonance".]]
  ...
  RelicConfig_95976_BattleDesc = {
    Text = "At turn start, Doresain gains [Arg1] Aliemus and [Arg2] STR. When Doresain consumes a \"Corpse,\" he gains Temporary STR equal to 20% of Doresain's Permanent STR."
  },
  ...
  RelicConfig_97346_BattleDesc = {
    Text = "All Awakeners' Crit. Rate +30%. At the start of odd-numbered turns, all enemies lose 25% of their current HP. When team's HP percentage is lower than the enemy's, Final DMG+50%; when team's HP percentage is higher than the enemy's, gain 35 Aliemus after using Exalt."
  },
  ...
  RelicConfig_97347_BattleDesc = {
    Text = "Max Arithmetica +2. Unconsumed Arithmetica can be retained until the next turn. If more than 2 Arithmetica is retained, all Awakeners gain 20 Aliemus at the start of the next turn; if more than 4 Arithmetica is retained, the base damage dealt in the next turn +100%."
  },
...
At each turn start, gain 1 "<PrimaryColor:Color>" and randomly apply "<ColorInkKeywords:Paintover>" to 2 Command Cards. Playing a "<ColorInkKeywords:Paintover>" card grants 1 "<PrimaryColor:Color>" in sequence. 
...
If there are 3 different "<PrimaryColor:Color>" recorded on "<DerivativeCardKeywords_116:Palette>," immediately deal 5% Max HP damage to all enemies and clear "<DerivativeCardKeywords_116:Palette>".]]
  ...
  RelicConfig_98274_Desc = {
    Text = [[
Hand Limit +1. Gain "<DerivativeCardKeywords_116:Palette>" at the start of the battle. 
At the start of your turn, gain 1 "<PrimaryColor:Color>" and randomly apply <ColorInkKeywords:Paintover> to 2 Command Cards. Playing a <ColorInkKeywords:Paintover>-marked card grants 1 "<PrimaryColor:Color>" in sequence. 
...
If there are 3 different "<PrimaryColor:Color>" recorded on the "<DerivativeCardKeywords_116:Palette>," immediately deal 5% Max HP damage to all enemies and clear the "<DerivativeCardKeywords_116:Palette>".]]
  ...
  RelicConfig_98367_BattleDesc = {
    Text = "All Awakeners' base effects for HP Recovery and Shield are +[Arg1]%."
  },
  ...
  RelicConfig_98369_BattleDesc = {
    Text = "After using Keyflare Rouse, grant Retain and Prepare to the [Arg1] <plural value=\"[Arg1]\" singular=\"card\" plural=\"cards\"> with the highest Arithmetica in your hand before the next play, and gain [Arg2] Keyflare."
  },
  ...
  RelicConfig_98372_BattleDesc = {
    Text = "At turn end, if Keyflare is full, consumes [Arg1] Keyflare to add a <DerivativeCardKeywords_129:\"Silver Key Gleam\"> to hand."
  },
  ...
  RelicConfig_98374_Desc = {
    Text = "After the first \"Posse\" in each turn, apply [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <IntoxicationIconKeywords:Poison> to all enemies and gain [Arg2] <plural value=\"[Arg2]\" singular=\"stack\" plural=\"stacks\"> of <RetaliateIconKeywords:Counter>."
  },
  ...
  RelicConfig_98375_BattleDesc = {
    Text = "At turn end, if Keyflare is full, consumes [Arg1] Keyflare to put a <DerivativeCardKeywords_67:\"Silver Key Dawn\"> into hand."
  },
  ...
  RelicConfig_98382_Desc = {
    Text = "After the battle starts, gain [Arg1] <ProficientInRealmsIconKeywords:Realm Mastery>. Draw [Arg2] <plural value=\"[Arg2]\" singular=\"card\" plural=\"cards\"> at the start of odd turns, and gain [Arg2] Arithmetica at the start of even turns."
  },
...
Opening it does not guarantee it belongs to a true doctor.]]
  ...
  RelicConfig_98387_Desc = {
    Text = "Battle starts by inflicting [Arg1] <plural value=\"[Arg1]\" singular=\"stack\" plural=\"stacks\"> of <WeaknessIconKeywords:Weakness> and <VulnerabilityIconKeywords:Vulnerable> on all enemies. This effect will also trigger after \"Annihilation,\" but has a 3 turn cooldown."
  },
...
It is said that the renowned violinist Eric has a particular fondness for it.]]
  ...
  RelicConfig_98395_Desc = {
    Text = "Gain [Arg1]% DMG Amplification At battle start. Deal Active DMG and inflict [Arg2] <IntoxicationIconKeywords:Poison> on all enemies, triggering up to 5 times per turn."
  },
...
As time passed, when Miss Dexter found it again, its gears were loose, the music off-key, but it still kept spinning.]]
  ...
  RelicConfig_98411_BattleDesc = {
    Text = "At the start of the turn, if Keyflare is greater than [Arg1], consume [Arg1] Keyflare to put 1 <DerivativeCardKeywords_115:\"Adv. Insight\"> into hand."
  },
  ...
  RelicConfig_98418_BattleDesc = {
    Text = "At the start of the battle, gain [Arg1]% DMG Amplification. After the first application of Poison each turn, draw [Arg2] <plural value=\"[Arg2]\" singular=\"card\" plural=\"cards\">."
  },
  RelicConfig_98418_Desc = {
    Text = "Gain [Arg1]% DMG Amplification at the start of the battle. After applying <IntoxicationIconKeywords:Poison> for the first time each turn, draw [Arg2] <plural value=\"[Arg2]\" singular=\"card\" plural=\"cards\">."
  },
