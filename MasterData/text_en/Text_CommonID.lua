...
local Text_CommonID = readonly({
  ...
  CommonID_Card_Fraud_Desc = {Text = "Fraud"},
  ...
  CommonID_ClickToQuit_Desc = {Text = "Exit"},
  CommonID_ClickToView_Desc = {Text = "View"},
  CommonID_Click_Desc = {Text = "Proceed"},
  ...
  CommonID_Modify_Desc = {Text = "Edit"},
  ...
  CommonID_Redeem_Desc = {Text = "Redeem"},
  ...
  CommonID_Repair_Desc = {Text = "Repair"},
  ...
  CommonID_TranslationLabel_Desc = {
    Text = "Translation Progress Marker"
  },
