...
local Text_Tutorial = readonly({
  ...
  Tutorial_148475_Desc_1 = {
    Text = "Once the Awakener's Affinity reaches <TutorialHighlight:Lv20>, you can obtain the exclusive <TutorialHighlight:Scintilla>."
  },
  Tutorial_148475_Desc_2 = {
    Text = "<TutorialHighlight:Scintilla> is proof that you and your Awakener are \"Sacred Union.\""
  },
  Tutorial_148475_Desc_3 = {
    Text = "Now, this Awakener's Command Cards will be showcased with a special presentation in battle, and can be displayed to other Keepers in social settings."
  },
  ...
  Tutorial_17807_Desc_1 = {
    Text = "Provides multiple attributes for the Awakener. Special effects are triggered when forming a <TutorialHighlight:set>. There are 6 parts, each with different <TutorialHighlight:main attributes>. Crit. Rate and Crit. DMG appear in parts I, II, and III; Aliemus Regen Level and Keyflare Regen Level appear in parts I, IV, and V; Realm Mastery and Sigil Yield appear in parts II, IV, and VI; DMG Amplification and Death Resistance appear in parts III, V, and VI."
  },
  ...
  Tutorial_17808_Desc_2 = {
    Text = "Phantasmal Dive typically updates its season every 28 days. Clearing Phantasmal Dive once during a season allows you to participate in the <TutorialHighlight:Season Ranking>. At the end of the season, rankings will be finalized and ranking rewards will be sent via mailbox."
  },
  ...
  Tutorial_17809_Desc_1 = {
    Text = "You can obtain <TutorialHighlight:Relic> through Events and D-Marks. These Relics can enhance team's combat abilities. Skilled Keepers often select more suitable <TutorialHighlight:Relic> based on their team's needs."
  },
  ...
  Tutorial_17811_Desc_1 = {
    Text = "Targets in the <TutorialHighlight:Poisoned> state take damage equal to the number of <TutorialHighlight:Poison> stacks at turn end. <TutorialHighlight:Poison> damage <TutorialHighlight:cannot crit>."
  },
  ...
  Tutorial_17820_Desc_1 = {
    Text = "Targets in the <TutorialHighlight:Fragile> state have their Shield Generation reduced by 25%, and 1 stack of <TutorialHighlight:Fragile> is removed at turn end. If team is in a <TutorialHighlight:Fragile> state, be sure to remove the <TutorialHighlight:Fragile> state before attempting to defend, or adjust your strategy to focus on aggressive offense this turn."
  },
  ...
  Tutorial_17822_Desc_1 = {
    Text = [[
Targets in the <TutorialHighlight:Bleed> state take damage equal to the <TutorialHighlight:Bleed> stacks at turn end, then <TutorialHighlight:remove the Bleed state>.
<TutorialHighlight:HP Recovery> removes an amount of Bleed stacks equal to <TutorialHighlight:twice the Healing amount>. Bleed damage <TutorialHighlight:cannot crit>.]]
  ...
  Tutorial_17826_Desc_1 = {
    Text = "When team is under the <TutorialHighlight:Aliemus Seal> status, Exalt cannot be used. Use Exalt before the enemy is about to inflict <TutorialHighlight:Aliemus Seal> to avoid wasting Aliemus."
  },
  ...
  Tutorial_17830_Desc_1 = {
    Text = "Targets in the <TutorialHighlight:Weakness> state deal 25% less damage, and 1 stack of <TutorialHighlight:Weakness> is automatically removed at turn end. If team is in the <TutorialHighlight:Weakness> state, remember to try removing the <TutorialHighlight:Weakness> state before attacking, or change the strategy to focus on full defense this turn."
  },
  Tutorial_17830_Title_1 = {Text = "Weakness"},
  Tutorial_17831_Desc_1 = {
    Text = "Defeating enemies in <TutorialHighlight:Verboten Covenant> grants <TutorialHighlight:Covenants> that enhance Awakener abilities. New <TutorialHighlight:Verboten Covenant> stages unlock upon completing each chapter. Covenants can also be redeemed in the shop."
  },
  ...
  Tutorial_17837_Desc_1 = {
    Text = "When the <TutorialHighlight:Embryo Fusion> reaches its limit, you will gain 1 <TutorialHighlight:\"Embryo\">. Unleashing Exalt consumes <TutorialHighlight:\"Embryo\"> to trigger a powerful <TutorialHighlight:Devour> Effect. Therefore, try to Unleash Exalt when you have <TutorialHighlight:\"Embryo\"> in hand; otherwise, you won't be able to bring out the full potential of the Caro team."
  },
  Tutorial_17837_Desc_2 = {
    Text = "After each battle, 5% of Max HP Recovery is accumulated into the Crimson Furnace. If there are unused <TutorialHighlight:Embryo>, each Embryo also contributes 5% of Max HP Recovery to the Furnace. The Crimson Furnace can be used to restore the party's HP, and can be converted into healing once per turn. The Keeper must carefully plan when to use the Crimson Furnace to turn the tide of battle."
  },
  Tutorial_17837_Title_1 = {Text = "Caro"},
  Tutorial_17838_Desc_1 = {
    Text = "At the Junction, you can choose to restore 50% of team's lost HP or Awaken 1 Awakener. Choose HP Recovery when team's HP is low; otherwise, choose to Rouse an Awakener."
  },
  Tutorial_17838_Title_1 = {Text = "Junction"},
  Tutorial_17839_Desc_1 = {
    Text = "A facility for consuming Black Sigils to enhance team. It typically offers one slot for an Orison, one for a Silver Relic, and one for a Golden Relic. If no desired items are available, click <TutorialHighlight:Refresh>, and D-Marks will generate new options."
  },
  ...
  Tutorial_17842_Desc_2 = {
    Text = "In the D-Mark node, you can consume <TutorialHighlight:Black Sigil> to purchase Orisons and Relics, or awaken Awakeners. Before the Final Battle, be sure to spend all Black Sigils to enhance team."
  },
  ...
  Tutorial_20768_Desc_1 = {
    Text = "When an Awakener consumes Arithmetica by playing Command Cards or Rouse Card, they gain <TutorialHighlight:Keyflare>. The <TutorialHighlight:Keyflare Regen> attribute increases the amount of <TutorialHighlight:Keyflare> gained."
  },
  ...
  Tutorial_20772_Desc_1 = {
    Text = "When Keyflare reaches <TutorialHighlight:1000>, <TutorialHighlight:Posse> is available. Posse can be unleashed twice per turn. During the second unleashing, 1 out of 3 random Posse can be selected, and the chosen Posse cannot be reused during this investigation. Selecting the appropriate Posse for team during lineup can make the investigation process smoother."
  },
  Tutorial_20772_Title_1 = {Text = "Posse"},
  Tutorial_20773_Desc_1 = {
    Text = "Consuming the same <TutorialHighlight:Wheel of Destiny> for Ascension enhances its attributes and special abilities. When Ascended 1 to 3 times, the Wheel of Destiny's effects strengthen; when Ascended 4 to 15 times, its attributes improve. Click the \"Next Stage\" button on the Ascension interface to preview post-Ascension changes."
  },
  ...
  Tutorial_54390_Desc_2 = {
    Text = "The following belongs to <TutorialHighlight:Positive State> (click to see details): <TauntKeywords:Taunt>, <PVPPowerIconKeywords:STR>, <EnergyStorageKeywords:Charge>, <PVPProtectiveKeywords:Barrier>, <PVPRetaliateIconKeywords:Counter>, <ReinforceKeywords:Fortress>, <StrengthenKeywords:Enhance>."
  },
  ...
  Tutorial_54392_Desc_2 = {
    Text = "During each season, there will be <TutorialHighlight:Seasonal Missions>. Complete Seasonal Missions to claim rich rewards. Seasonal Missions will reset when the season refreshes."
  },
