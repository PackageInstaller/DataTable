local var_0_0 = {}
local var_0_1 = {
	"data.choosegift.choose_gift_basic_data",
	"data.choosegift.choose_gift_double12_data",
	"data.choosegift.choose_gift_spring20_data",
	"data.umaru.choose_gift_umaru_data"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("choosegift_data id is nil: " .. arg_1_1)
		end
