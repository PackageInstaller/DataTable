return {
	...
	btnLevel = {
		zorder = 31,
		path = "btn_level.png",
		pos = cc.p(154, 302 - GameDisplay.fix_y),
	...
	btnShop = {
		zorder = 35,
		path = "btn_shop.png",
		pos = cc.p(125, 140 - GameDisplay.fix_y),
		reddotpos = cc.p(300, 64)
	},
	btnReturn = {
		zorder = 31,
	...
	btnTotalTask = {
		...
		pos = cc.p(140, 220 - GameDisplay.fix_y),
	...
	btnExplore = {
		...
		pos = cc.p(194, 386 - GameDisplay.fix_y),
		reddotpos = cc.p(220, 60)
	},
	btnRecharge = {
		zorder = 31,
		path = "btn_recharge.png",
		pos = cc.p(487, 195 - GameDisplay.fix_y)
	},
	btnRoleinfo = {
		zorder = 31,
