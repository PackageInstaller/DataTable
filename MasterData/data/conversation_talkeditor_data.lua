local var_0_0 = {}
local var_0_1 = {
	"data.activity_conversation_20220501_data",
	"data.activity_conversation_2022summer_data",
	"data.activity_conversation_tap_data",
	"data.activity_conversation_zhuxian19_data",
	"data.conversation_default_data",
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("conversation_talkeditor_data id is nil: " .. arg_1_1)
		end
