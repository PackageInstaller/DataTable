local var_0_0 = {}
local var_0_1 = {
	"data.explore_plot_class_data",
	"data.main_plot_class_data",
	"data.main_plot_class_talk_level_data",
	"data.randomplot_class_data"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("plot_class_data id is nil: " .. arg_1_1)
		end
