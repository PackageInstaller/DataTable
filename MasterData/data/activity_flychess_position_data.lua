local var_0_0 = {}
local var_0_1 = {
	"data.activity_flychess_position_755_data",
	"data.activity_flychess_position_786_data",
	"data.activity_flychess_position_837_data",
	"data.activity_flychess_position_855_data",
	"data.activity_flychess_position_892_data"
}
...
setmetatable(var_0_0, {
	__index = function(arg_1_0, arg_1_1)
		if arg_1_1 then
			print("activity_flychess_position_data id is nil: " .. arg_1_1)
		end
