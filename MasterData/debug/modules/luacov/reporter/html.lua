-- chunkname: @E:/AntMan/AntMan_Android_pub1/Assets/Code/.LuaCode/Debug\\Modules\\luacov\\reporter\\html.lua

local luacov_reporter = require("Debug/Modules/luacov.reporter")
local reporter = {}
...
do
	...
	local template = require("Debug/Modules/luacov.reporter.html.template")
	...
	local function read_asset(name)
		local f, open_err = io.open("./Assets/Code/.LuaCode/" .. dir .. dir_sep .. name, "rb")
...
do
	...
	local function coverage_to_css_class(hits, missed)
		...
		cssClass = coverageNum < 40 and "danger" or coverageNum < 60 and "warning" or coverageNum < 75 and "success-low" or coverageNum < 90 and "success-medium" or "success-high"
