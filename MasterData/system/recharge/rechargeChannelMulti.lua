-- chunkname: @E:/AntMan/AntMan_Android_pub1/Assets/Code/.LuaCode/System\\Recharge\\rechargeChannelMulti.lua

local RechargeChannelBase = require("System/Recharge/RechargeChannelBase")
local rechargeChannelMulti = Class("rechargeChannelMulti", RechargeChannelBase, true)
...
function rechargeChannelMulti:ctor()
	self._receiptUrlTail = nil
end

function rechargeChannelMulti:genSDKDataFromOrder(product_id, orderid, channel_account, svr_nodeid, extendInfo, gift_type)
	local sdkOrder = rechargeChannelMulti.super.genSDKDataFromOrder(self, product_id, orderid, channel_account, svr_nodeid, extendInfo, gift_type)
