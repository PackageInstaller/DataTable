...
function VersionActivityFixedTaskItem:addEventListeners()
	...
	self.addEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivityFixedDungeonEvent.OnClickAllTaskFinish, self._OnClickAllTaskFinish, self)
end
...
function VersionActivityFixedTaskItem:removeEventListeners()
	...
	self.removeEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivityFixedDungeonEvent.OnClickAllTaskFinish, self._OnClickAllTaskFinish, self)
end
