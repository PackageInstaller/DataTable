-- chunkname: @modules/versionactivitybase/fixed/dungeon/view/map/VersionActivityFixedDungeonMapEpisodeItem.lua

module("modules.versionactivitybase.fixed.dungeon.view.map.VersionActivityFixedDungeonMapEpisodeItem", package.seeall)

local VersionActivityFixedDungeonMapEpisodeItem = class("VersionActivityFixedDungeonMapEpisodeItem", BaseChildView)

function VersionActivityFixedDungeonMapEpisodeItem:onInitView()
...
function VersionActivityFixedDungeonMapEpisodeItem:addEvents()
...
function VersionActivityFixedDungeonMapEpisodeItem:removeEvents()
...
function VersionActivityFixedDungeonMapEpisodeItem:onClick()
	if self.isLock then
...
function VersionActivityFixedDungeonMapEpisodeItem:_editableInitView()
...
function VersionActivityFixedDungeonMapEpisodeItem:_showEye()
...
function VersionActivityFixedDungeonMapEpisodeItem:initViewParam()
	self._contentTransform = self.viewParam[1]
	self._layout = self.viewParam[2]
	self._mapSceneView = self.viewContainer.mapScene
end

function VersionActivityFixedDungeonMapEpisodeItem:onUpdateParam()
	self:initViewParam()
	self:_showAllElementTipView()
end

function VersionActivityFixedDungeonMapEpisodeItem:onOpen()
	self:initViewParam()
end

function VersionActivityFixedDungeonMapEpisodeItem:getMapAllElementList()
...
function VersionActivityFixedDungeonMapEpisodeItem:_hideAllElementTip()
	gohelper.setActive(self._gotipcontent, false)
end

function VersionActivityFixedDungeonMapEpisodeItem:refresh(config, dungeonMo)
	self._config = config
...
function VersionActivityFixedDungeonMapEpisodeItem:refreshUI()
...
function VersionActivityFixedDungeonMapEpisodeItem:refreshLock()
	self.isLock = self:checkLock()

	gohelper.setActive(self.goLock, self:checkLock())
end

function VersionActivityFixedDungeonMapEpisodeItem:initElementIdList()
...
function VersionActivityFixedDungeonMapEpisodeItem:clearElementIdList()
	self.elementIdList = nil
end

function VersionActivityFixedDungeonMapEpisodeItem:checkLock()
...
function VersionActivityFixedDungeonMapEpisodeItem:refreshStar()
...
function VersionActivityFixedDungeonMapEpisodeItem:refreshFlag()
	gohelper.setActive(self._goflag, false)
end

function VersionActivityFixedDungeonMapEpisodeItem:refreshUnlockContent()
	if self.pass then
...
function VersionActivityFixedDungeonMapEpisodeItem:refreshHardModeStar()
...
function VersionActivityFixedDungeonMapEpisodeItem:refreshStoryModeStar()
	local starItem
...
function VersionActivityFixedDungeonMapEpisodeItem:refreshEpisodeStar(starItem, episodeId)
...
function VersionActivityFixedDungeonMapEpisodeItem:refreshFocusStatus()
	gohelper.setActive(self.goSelected, self._config.id == self.activityDungeonMo.episodeId)
end

function VersionActivityFixedDungeonMapEpisodeItem:beginShowRewardView()
	self.beginReward = true
end

function VersionActivityFixedDungeonMapEpisodeItem:endShowRewardView()
...
function VersionActivityFixedDungeonMapEpisodeItem:calculatePosInContent()
...
function VersionActivityFixedDungeonMapEpisodeItem:setImage(image, light, episodeId)
...
function VersionActivityFixedDungeonMapEpisodeItem:updateSelectStatus(selectedItem, ignoreAni)
...
function VersionActivityFixedDungeonMapEpisodeItem:onRemoveElement(elementId)
...
function VersionActivityFixedDungeonMapEpisodeItem:playUnLockAnimation()
	local animator = self.goLock:GetComponent(typeof(UnityEngine.Animator))

	animator.enabled = true
end

function VersionActivityFixedDungeonMapEpisodeItem:playAnimation(animationName)
...
function VersionActivityFixedDungeonMapEpisodeItem:getEpisodeId()
	return self._config and self._config.id
end

function VersionActivityFixedDungeonMapEpisodeItem:createStarItem(goStar)
...
function VersionActivityFixedDungeonMapEpisodeItem:onClose()
	TaskDispatcher.cancelTask(self._hideAllElementTip, self)
end

function VersionActivityFixedDungeonMapEpisodeItem:onDestroyView()
	self.goClick:RemoveClickListener()
end

return VersionActivityFixedDungeonMapEpisodeItem
