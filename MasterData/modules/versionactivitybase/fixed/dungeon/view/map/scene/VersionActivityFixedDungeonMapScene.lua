...
function VersionActivityFixedDungeonMapScene:addEvents()
	...
	self.addEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivityFixedDungeonEvent.FocusElement, self.onFocusElement, self)
	self.addEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivityFixedDungeonEvent.ManualClickElement, self.manualClickElement, self)
...
function VersionActivityFixedDungeonMapScene:removeEvents()
	...
	self.removeEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivityFixedDungeonEvent.FocusElement, self.onFocusElement, self)
	self.removeEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivityFixedDungeonEvent.ManualClickElement, self.manualClickElement, self)
