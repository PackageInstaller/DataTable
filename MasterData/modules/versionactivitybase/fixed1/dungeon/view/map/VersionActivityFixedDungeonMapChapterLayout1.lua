-- chunkname: @modules/versionactivitybase/fixed1/dungeon/view/map/VersionActivityFixedDungeonMapChapterLayout1.lua

module("modules.versionactivitybase.fixed1.dungeon.view.map.VersionActivityFixedDungeonMapChapterLayout1", package.seeall)

local VersionActivityFixedDungeonMapChapterLayout1 = class("VersionActivityFixedDungeonMapChapterLayout1", VersionActivityFixedDungeonMapChapterLayout)

function VersionActivityFixedDungeonMapChapterLayout1:_editableInitView()
	VersionActivityFixedDungeonMapChapterLayout1.super._editableInitView(self)

	self._episodeSPContainerItemList = self:getUserDataTb_()
	self.episodeItemSpPath = self.viewContainer:getSetting().otherRes.spItem
end

function VersionActivityFixedDungeonMapChapterLayout1:refreshEpisodeNodes()
...
function VersionActivityFixedDungeonMapChapterLayout1:getEpisodeContainerItem(index)
...
function VersionActivityFixedDungeonMapChapterLayout1:getSPEpisodeContainerItem(index)
...
function VersionActivityFixedDungeonMapChapterLayout1:onClose()
	VersionActivityFixedDungeonMapChapterLayout1.super.onClose(self)
...
return VersionActivityFixedDungeonMapChapterLayout1
