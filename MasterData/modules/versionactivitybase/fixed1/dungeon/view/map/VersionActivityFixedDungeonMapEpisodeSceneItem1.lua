-- chunkname: @modules/versionactivitybase/fixed1/dungeon/view/map/VersionActivityFixedDungeonMapEpisodeSceneItem1.lua

module("modules.versionactivitybase.fixed1.dungeon.view.map.VersionActivityFixedDungeonMapEpisodeSceneItem1", package.seeall)

local VersionActivityFixedDungeonMapEpisodeSceneItem1 = class("VersionActivityFixedDungeonMapEpisodeSceneItem1", BaseChildView)

function VersionActivityFixedDungeonMapEpisodeSceneItem1:onInitView()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:addEvents()
	...
	self.addEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivityFixedDungeonEvent1.CameraSizeChange, self._onCameraSizeChange, self)
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:removeEvents()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:_onCameraSizeChange()
	self._uiFollower = self._uiFollower or self.viewGO:GetComponent(typeof(ZProj.UIFollower))

	self._uiFollower:ForceUpdate()
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:onClick()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:_editableInitView()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:_showEye()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:initViewParam()
	self._contentTransform = self.viewParam[1]
	self._layout = self.viewParam[2]
	self._mapSceneView = self.viewContainer.mapScene
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:onUpdateParam()
	self:initViewParam()
	self:_showAllElementTipView()
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:onOpen()
	self:initViewParam()
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:getMapAllElementList()
	return (VersionActivityFixedDungeonModel.instance:getElementCoList(self._map.id))
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:_showAllElementTipView()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:_hideAllElementTip()
	gohelper.setActive(self._gotipcontent, false)
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:refresh(config, dungeonMo)
	self._config = config
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshUI()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshLock()
	self.isLock = self:checkLock()

	gohelper.setActive(self.goLock, self:checkLock())
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:initElementIdList()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:clearElementIdList()
	self.elementIdList = nil
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:checkLock()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshStar()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshFlag()
	gohelper.setActive(self._goflag, false)
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshUnlockContent()
	if self.pass then
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshHardModeStar()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshStoryModeStar()
	local starItem
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshEpisodeStar(starItem, episodeId)
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:refreshFocusStatus()
	gohelper.setActive(self.goSelected, self._config.id == self.activityDungeonMo.episodeId)
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:beginShowRewardView()
	self.beginReward = true
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:endShowRewardView()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:calculatePosInContent()
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:setImage(image, light, episodeId)
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:getMaxWidth()
	return self._maxWidth
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:updateSelectStatus(selectedItem, ignoreAni)
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:onRemoveElement(elementId)
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:playUnLockAnimation()
	local animator = self.goLock:GetComponent(typeof(UnityEngine.Animator))

	animator.enabled = true
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:playAnimation(animationName)
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:getEpisodeId()
	return self._config and self._config.id
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:createStarItem(goStar)
...
function VersionActivityFixedDungeonMapEpisodeSceneItem1:onClose()
	TaskDispatcher.cancelTask(self._hideAllElementTip, self)
end

function VersionActivityFixedDungeonMapEpisodeSceneItem1:onDestroyView()
	self.goClick:RemoveClickListener()
end

return VersionActivityFixedDungeonMapEpisodeSceneItem1
