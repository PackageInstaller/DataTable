...
function V3a6YaMiSkillView:addEvents()
	...
	self.addEventCb(self, V3a6YaMiController.instance, V3a6YaMiEvent.onSelectSkillHero, self._onSelectSkillHero, self)
end

function V3a6YaMiSkillView:removeEvents()
	self._btnmask:RemoveClickListener()
	self.removeEventCb(self, V3a6YaMiController.instance, V3a6YaMiEvent.onSelectSkillHero, self._onSelectSkillHero, self)
end
