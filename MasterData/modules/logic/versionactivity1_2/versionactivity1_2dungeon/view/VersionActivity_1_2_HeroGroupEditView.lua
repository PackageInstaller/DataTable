...
function VersionActivity_1_2_HeroGroupEditView:_btncharacterOnClick()
	if self._heroMO then
		local heroMoList = self._isShowQuickEdit and HeroGroupQuickEditListModel.instance:getList() or HeroGroupEditListModel.instance:getList()
		local newList = {}
...
function VersionActivity_1_2_HeroGroupEditView:_saveCurGroupInfo()
	...
	if Activity104Model.instance:isSeasonChapter() then
		...
		extraData.groupIndex = Activity104Model.instance:getSeasonCurSnapshotSubId(actId)
