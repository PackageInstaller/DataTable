-- chunkname: @modules/logic/versionactivity3_5/enter/view/subview/VersionActivity3_5LamonaEnterView.lua

module("modules.logic.versionactivity3_5.enter.view.subview.VersionActivity3_5LamonaEnterView", package.seeall)

local VersionActivity3_5LamonaEnterView = class("VersionActivity3_5LamonaEnterView", VersionActivityEnterBaseSubView)

function VersionActivity3_5LamonaEnterView:onInitView()
...
function VersionActivity3_5LamonaEnterView:addEvents()
...
function VersionActivity3_5LamonaEnterView:removeEvents()
...
function VersionActivity3_5LamonaEnterView:_btnEnterOnClick()
...
function VersionActivity3_5LamonaEnterView:_enterLevelView()
	LamonaController.instance:enterEpisodeLevelView()
end

function VersionActivity3_5LamonaEnterView:_btnLockOnClick()
...
function VersionActivity3_5LamonaEnterView:_btnTrialOnClick()
...
function VersionActivity3_5LamonaEnterView:_btnitemOnClick()
	return
end

function VersionActivity3_5LamonaEnterView:_editableInitView()
	self._animator = self.viewGO:GetComponent(gohelper.Type_Animator)
end

function VersionActivity3_5LamonaEnterView:onOpen()
...
function VersionActivity3_5LamonaEnterView:_refreshTime()
...
function VersionActivity3_5LamonaEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity3_5LamonaEnterView:onDestroyView()
	return
end

return VersionActivity3_5LamonaEnterView
