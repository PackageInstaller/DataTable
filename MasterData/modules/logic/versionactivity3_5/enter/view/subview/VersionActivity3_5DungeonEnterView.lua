-- chunkname: @modules/logic/versionactivity3_5/enter/view/subview/VersionActivity3_5DungeonEnterView.lua

module("modules.logic.versionactivity3_5.enter.view.subview.VersionActivity3_5DungeonEnterView", package.seeall)

local VersionActivity3_5DungeonEnterView = class("VersionActivity3_5DungeonEnterView", VersionActivityFixedDungeonEnterView)

function VersionActivity3_5DungeonEnterView:onInitView()
...
function VersionActivity3_5DungeonEnterView:addEvents()
	VersionActivity3_5DungeonEnterView.super.addEvents(self)
...
function VersionActivity3_5DungeonEnterView:removeEvents()
	VersionActivity3_5DungeonEnterView.super.removeEvents(self)
...
function VersionActivity3_5DungeonEnterView:_editableInitView()
	VersionActivity3_5DungeonEnterView.super._editableInitView(self)
...
function VersionActivity3_5DungeonEnterView:onDestroyView()
	VersionActivity3_5DungeonEnterView.super.onDestroyView(self)
...
function VersionActivity3_5DungeonEnterView:_btnBoardOnClick()
	CommandStationController.instance:openCommandStationPaperView()
end

function VersionActivity3_5DungeonEnterView:onOpenFinish()
	self._videoPath = VersionActivity3_5Enum.EnterLoopVideoName
...
function VersionActivity3_5DungeonEnterView:_onVideoStart()
	TaskDispatcher.cancelTask(self._onVideoStart, self)
...
function VersionActivity3_5DungeonEnterView:onPlayVideoDone()
...
function VersionActivity3_5DungeonEnterView:_setVideoAsLastSibling()
	local container = ViewMgr.instance:getContainer(ViewName.FullScreenVideoView)
...
function VersionActivity3_5DungeonEnterView:playLogoAnim(animName)
...
function VersionActivity3_5DungeonEnterView:refreshUI()
	VersionActivity3_5DungeonEnterView.super.refreshUI(self)
	self:refreshPaperCount()
end

function VersionActivity3_5DungeonEnterView:_onGetTaskBonus()
	CommandStationRpc.instance:sendGetCommandPostInfoRequest()
end

function VersionActivity3_5DungeonEnterView:refreshPaperCount()
	local finishCount = 0
	local totalCount = 0
...
return VersionActivity3_5DungeonEnterView
