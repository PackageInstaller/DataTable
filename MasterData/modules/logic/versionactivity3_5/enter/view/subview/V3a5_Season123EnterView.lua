-- chunkname: @modules/logic/versionactivity3_5/enter/view/subview/V3a5_Season123EnterView.lua

module("modules.logic.versionactivity3_5.enter.view.subview.V3a5_Season123EnterView", package.seeall)

local V3a5_Season123EnterView = class("V3a5_Season123EnterView", BaseView)

function V3a5_Season123EnterView:onInitView()
...
function V3a5_Season123EnterView:addEvents()
...
function V3a5_Season123EnterView:removeEvents()
...
function V3a5_Season123EnterView:_btnNormalOnClick()
...
function V3a5_Season123EnterView:_btnLockedOnClick()
...
function V3a5_Season123EnterView:_btnStoreOnClick()
	Season123Controller.instance:openSeasonStoreView(self.actId)
end

function V3a5_Season123EnterView:_editableInitView()
...
function V3a5_Season123EnterView:onUpdateParam()
	return
end

function V3a5_Season123EnterView:onOpen()
...
function V3a5_Season123EnterView:refreshUI()
...
function V3a5_Season123EnterView:refreshDesc()
...
function V3a5_Season123EnterView:refreshStoreCoin()
...
function V3a5_Season123EnterView:refreshEnterBtn()
	local status, toastId, toastParam = ActivityHelper.getActivityStatusAndToast(self.actId)
...
function V3a5_Season123EnterView:refreshRemainTime()
	self:refreshMainTime()
	self:refreshStoreTime()
end

function V3a5_Season123EnterView:refreshMainTime()
...
function V3a5_Season123EnterView:refreshStoreTime()
...
function V3a5_Season123EnterView:onClose()
	TaskDispatcher.cancelTask(self.refreshRemainTime, self)
end

function V3a5_Season123EnterView:onDestroyView()
	self.animComp:destroy()
end

return V3a5_Season123EnterView
