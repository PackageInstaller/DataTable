-- chunkname: @modules/logic/versionactivity3_5/enter/view/subview/VersionActivity3_5LorentzEnterView.lua

module("modules.logic.versionactivity3_5.enter.view.subview.VersionActivity3_5LorentzEnterView", package.seeall)

local VersionActivity3_5LorentzEnterView = class("VersionActivity3_5LorentzEnterView", VersionActivityEnterBaseSubView)

function VersionActivity3_5LorentzEnterView:onInitView()
...
function VersionActivity3_5LorentzEnterView:addEvents()
...
function VersionActivity3_5LorentzEnterView:removeEvents()
...
function VersionActivity3_5LorentzEnterView:_editableInitView()
...
function VersionActivity3_5LorentzEnterView:onOpen()
...
function VersionActivity3_5LorentzEnterView:_enterGame()
	...
	if string.nilorempty(condition) then
		LorentzController.instance:enterLevelView()
	else
...
function VersionActivity3_5LorentzEnterView:_clickLock()
...
function VersionActivity3_5LorentzEnterView:_btnitemOnClick()
	return
end

function VersionActivity3_5LorentzEnterView:_btnTrialOnClick()
...
function VersionActivity3_5LorentzEnterView:everySecondCall()
	self:_refreshTime()
end

function VersionActivity3_5LorentzEnterView:_refreshTime()
...
function VersionActivity3_5LorentzEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity3_5LorentzEnterView:onDestroyView()
	return
end

return VersionActivity3_5LorentzEnterView
