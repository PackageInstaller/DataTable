-- chunkname: @modules/logic/versionactivity3_5/dungeon/view/map/scene/VersionActivity3_5DungeonMapSceneElements.lua

module("modules.logic.versionactivity3_5.dungeon.view.map.scene.VersionActivity3_5DungeonMapSceneElements", package.seeall)

local VersionActivity3_5DungeonMapSceneElements = class("VersionActivity3_5DungeonMapSceneElements", VersionActivityFixedDungeonMapSceneElements)

function VersionActivity3_5DungeonMapSceneElements:_editableInitView()
	VersionActivity3_5DungeonMapSceneElements.super._editableInitView(self)
...
function VersionActivity3_5DungeonMapSceneElements:recycleAllElements()
...
function VersionActivity3_5DungeonMapSceneElements:_addElement(elementConfig)
...
function VersionActivity3_5DungeonMapSceneElements:showElements()
	...
	if self._showMap then
		local var_4_0 = VersionActivity3_5DungeonMapSceneElements.getAllElementCoList()

		if not var_4_0 then
			var_4_0 = VersionActivityFixedDungeonModel.instance:getElementCoList(self._mapCfg.id)

			local elementCoList = var_4_0
...
function VersionActivity3_5DungeonMapSceneElements.getAllElementCoList()
...
function VersionActivity3_5DungeonMapSceneElements:loadSceneFinish(param)
	VersionActivity3_5DungeonMapSceneElements.super.loadSceneFinish(self, param)

	local elementRoot = self._elementRoot

	transformhelper.setLocalPos(elementRoot.transform, 0, 0, ViewMgr.instance:isOpen(ViewName.VersionActivity3_5DungeonMapLevelView) and 1000 or 0)
end

return VersionActivity3_5DungeonMapSceneElements
