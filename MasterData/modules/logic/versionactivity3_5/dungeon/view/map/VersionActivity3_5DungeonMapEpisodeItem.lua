-- chunkname: @modules/logic/versionactivity3_5/dungeon/view/map/VersionActivity3_5DungeonMapEpisodeItem.lua

module("modules.logic.versionactivity3_5.dungeon.view.map.VersionActivity3_5DungeonMapEpisodeItem", package.seeall)

local VersionActivity3_5DungeonMapEpisodeItem = class("VersionActivity3_5DungeonMapEpisodeItem", VersionActivityFixedDungeonMapEpisodeItem)

function VersionActivity3_5DungeonMapEpisodeItem:addEvents()
	VersionActivity3_5DungeonMapEpisodeItem.super.addEvents(self)
	self.addEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivity3_5DungeonEvent.V3a2ClickEpisodeItem, self._onV3a2ClickEpisodeItem, self)
end

function VersionActivity3_5DungeonMapEpisodeItem:_onV3a2ClickEpisodeItem(episodeId)
	if episodeId == self._config.id then
		self:onClick()
	end
end

function VersionActivity3_5DungeonMapEpisodeItem:_showAllElementTipView()
...
return VersionActivity3_5DungeonMapEpisodeItem
