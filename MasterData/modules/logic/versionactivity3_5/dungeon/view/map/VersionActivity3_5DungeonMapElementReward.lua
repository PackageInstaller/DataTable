-- chunkname: @modules/logic/versionactivity3_5/dungeon/view/map/VersionActivity3_5DungeonMapElementReward.lua

module("modules.logic.versionactivity3_5.dungeon.view.map.VersionActivity3_5DungeonMapElementReward", package.seeall)

local VersionActivity3_5DungeonMapElementReward = class("VersionActivity3_5DungeonMapElementReward", DungeonMapElementReward)

function VersionActivity3_5DungeonMapElementReward:_OnRemoveElement(id)
	...
	if config.fragment > 0 then
		...
		elseif config.type == DungeonEnum.ElementType.SpStory then
			...
			self._lastViewName = config.type == DungeonEnum.ElementType.Investigate and ViewName.InvestigateTipsView or ViewName.VersionActivity3_5DungeonFragmentInfoView
		end
...
return VersionActivity3_5DungeonMapElementReward
