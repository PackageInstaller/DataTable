-- chunkname: @modules/logic/versionactivity3_5/dungeon/view/map/VersionActivity3_5DungeonMapEpisodeSceneView.lua

module("modules.logic.versionactivity3_5.dungeon.view.map.VersionActivity3_5DungeonMapEpisodeSceneView", package.seeall)

local VersionActivity3_5DungeonMapEpisodeSceneView = class("VersionActivity3_5DungeonMapEpisodeSceneView", BaseView)

function VersionActivity3_5DungeonMapEpisodeSceneView:onInitView()
...
function VersionActivity3_5DungeonMapEpisodeSceneView:getSceneNode(name)
...
function VersionActivity3_5DungeonMapEpisodeSceneView:_addFollower(go, config, index)
...
function VersionActivity3_5DungeonMapEpisodeSceneView:loadSceneFinish(param)
...
function VersionActivity3_5DungeonMapEpisodeSceneView:onModeChange()
	self:_updateMapEpisodeList()
end

function VersionActivity3_5DungeonMapEpisodeSceneView:onOpen()
	self:_updateMapEpisodeList()
end

function VersionActivity3_5DungeonMapEpisodeSceneView:_updateMapEpisodeList()
	...
	for _, config in ipairs(episodeList) do
		...
		if dungeonMo then
			local extraConfig = VersionActivity3_5DungeonConfig.instance:getChapterMap(config.id)
...
function VersionActivity3_5DungeonMapEpisodeSceneView:getEpisodeContainerItem(index)
	...
	local episodeItem = VersionActivity3_5DungeonMapEpisodeSceneItem.New()
...
function VersionActivity3_5DungeonMapEpisodeSceneView:getSPEpisodeContainerItem(index)
...
function VersionActivity3_5DungeonMapEpisodeSceneView:onClose()
...
return VersionActivity3_5DungeonMapEpisodeSceneView
