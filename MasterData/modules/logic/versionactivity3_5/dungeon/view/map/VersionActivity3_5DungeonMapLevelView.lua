-- chunkname: @modules/logic/versionactivity3_5/dungeon/view/map/VersionActivity3_5DungeonMapLevelView.lua

module("modules.logic.versionactivity3_5.dungeon.view.map.VersionActivity3_5DungeonMapLevelView", package.seeall)

local VersionActivity3_5DungeonMapLevelView = class("VersionActivity3_5DungeonMapLevelView", VersionActivityFixedDungeonMapLevelView)

function VersionActivity3_5DungeonMapLevelView:onInitView()
	VersionActivity3_5DungeonMapLevelView.super.onInitView(self)
...
function VersionActivity3_5DungeonMapLevelView:addEvents()
	VersionActivity3_5DungeonMapLevelView.super.addEvents(self)
	self._btnleft:AddClickListener(self._btnleftOnClick, self)
	self._btnright:AddClickListener(self._btnrightOnClick, self)
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function VersionActivity3_5DungeonMapLevelView:removeEvents()
	VersionActivity3_5DungeonMapLevelView.super.removeEvents(self)
	self._btnleft:RemoveClickListener()
	self._btnright:RemoveClickListener()
	self._btnclose:RemoveClickListener()
end

function VersionActivity3_5DungeonMapLevelView:_btnleftOnClick()
	...
	if index then
		...
		if config then
			VersionActivityFixedDungeonController.instance:dispatchEvent(VersionActivity3_5DungeonEvent.V3a2ClickEpisodeItem, config.id)
		end
	end
end

function VersionActivity3_5DungeonMapLevelView:_btnrightOnClick()
	local index = self:_getEposdeIndex()
...
function VersionActivity3_5DungeonMapLevelView:_btncloseOnClick()
	self:closeThis()
end

function VersionActivity3_5DungeonMapLevelView:_updateNavBtns()
...
function VersionActivity3_5DungeonMapLevelView:_getEposdeIndex()
	...
	for i, v in ipairs(list) do
		...
		if v.id == ((self.originEpisodeConfig.chapterId == VersionActivity3_5DungeonEnum.DungeonChapterId.Hard or nil) and self.originEpisodeId) then
			index = i
		end
...
function VersionActivity3_5DungeonMapLevelView:_getEpisodeList()
	if self._episodeList then
		return self._episodeList
	end

	if self.originEpisodeConfig.chapterId == VersionActivity3_5DungeonEnum.DungeonChapterId.Hard then
		local list = {}
	...
	if not storyEpisodeConfig then
		logError("VersionActivity3_5DungeonMapLevelView:_getEpisodeList storyEpisodeConfig is nil")
...
function VersionActivity3_5DungeonMapLevelView:onOpen()
	VersionActivity3_5DungeonMapLevelView.super.onOpen(self)
	self:_updateMapInfo(self.originEpisodeId)
	self:_updateNavBtns()
end

function VersionActivity3_5DungeonMapLevelView:initViewParam()
	VersionActivity3_5DungeonMapLevelView.super.initViewParam(self)

	self.index = VersionActivityFixedDungeonConfig.instance:getEpisodeIndex(self.originEpisodeId)
end

function VersionActivity3_5DungeonMapLevelView:_updateMapInfo(episodeId)
	local storyEpisodeConfig = VersionActivityFixedDungeonConfig.instance:getStoryEpisodeCo(episodeId)
...
return VersionActivity3_5DungeonMapLevelView
