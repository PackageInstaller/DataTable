-- chunkname: @modules/logic/versionactivity2_0/dungeon/view/map/VersionActivity2_0DungeonMapEpisodeView.lua

module("modules.logic.versionactivity2_0.dungeon.view.map.VersionActivity2_0DungeonMapEpisodeView", package.seeall)

local VersionActivity2_0DungeonMapEpisodeView = class("VersionActivity2_0DungeonMapEpisodeView", BaseView)
...
function VersionActivity2_0DungeonMapEpisodeView:onInitView()
...
function VersionActivity2_0DungeonMapEpisodeView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnClickElement, self.hideUI, self)
	self.addEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnHideInteractUI, self.showUI, self)
	self.addEventCb(self, Activity161Controller.instance, Activity161Event.CloseGraffitiEnterView, self.showUI, self)
...
function VersionActivity2_0DungeonMapEpisodeView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnClickElement, self.hideUI, self)
	self.removeEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnHideInteractUI, self.showUI, self)
	self.removeEventCb(self, Activity161Controller.instance, Activity161Event.CloseGraffitiEnterView, self.showUI, self)
	self.removeEventCb(self, DungeonController.instance, DungeonEvent.OnUpdateDungeonInfo, self._onUpdateDungeonInfo, self)
...
function VersionActivity2_0DungeonMapEpisodeView:_editableInitView()
...
function VersionActivity2_0DungeonMapEpisodeView:onUpdateParam()
	self:refreshModeNode()
	self.chapterLayout:refreshEpisodeNodes()
	self:playOnOpenAnimation()
end

function VersionActivity2_0DungeonMapEpisodeView:onOpen()
	self:initChapterEpisodes()
	self:refreshModeNode()
	TaskDispatcher.runRepeat(self.refreshModeLockText, self, TimeUtil.OneMinuteSecond)
end

function VersionActivity2_0DungeonMapEpisodeView:onOpenFinish()
	self:playUnlockAnimation(true)
end

function VersionActivity2_0DungeonMapEpisodeView:refreshModeNode()
...
function VersionActivity2_0DungeonMapEpisodeView:initChapterEpisodes()
...
function VersionActivity2_0DungeonMapEpisodeView:onLoadLayoutFinish()
...
function VersionActivity2_0DungeonMapEpisodeView:refreshModeLockText()
	local openTimeStamp = VersionActivityConfig.instance:getAct113DungeonChapterOpenTimeStamp(VersionActivity2_0DungeonEnum.DungeonChapterId.Hard)
	...
	if serverTime < openTimeStamp then
		...
		if isOpen then
			...
			self._txtHardModeUnlockTime.text = string.format(luaLang("versionactivity1_3_hardlocktip"), "FT-" .. episodeIndexWithSP)
...
function VersionActivity2_0DungeonMapEpisodeView:onModeChange()
	self:refreshModeNode()
	self.chapterLayout:playAnimation("switch")
	self.chapterLayout:refreshEpisodeNodes()
end

function VersionActivity2_0DungeonMapEpisodeView:showUI()
...
function VersionActivity2_0DungeonMapEpisodeView:setLayoutVisible(isShow)
	...
	self._episodeListTweenId = ZProj.TweenHelper.DOAnchorPosY(layoutTrans, (isShow or nil) and self.chapterLayout.defaultY, LAYOUT_TWEEN_TIME)
end

function VersionActivity2_0DungeonMapEpisodeView:_onUpdateDungeonInfo()
...
function VersionActivity2_0DungeonMapEpisodeView:_onCloseViewFinish(viewName)
...
function VersionActivity2_0DungeonMapEpisodeView:dailyRefresh()
	self:refreshModeNode()
	self:playUnlockAnimation()
end

function VersionActivity2_0DungeonMapEpisodeView:btnStoryModeClick()
	self:changeEpisodeMode(VersionActivityDungeonBaseEnum.DungeonMode.Story)
end

function VersionActivity2_0DungeonMapEpisodeView:btnHardModeClick()
...
function VersionActivity2_0DungeonMapEpisodeView:checkHardModeIsOpen()
	local dungeonActId = VersionActivity2_0Enum.ActivityId.Dungeon

	return VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapterAndGetToast(dungeonActId)
end

function VersionActivity2_0DungeonMapEpisodeView:changeEpisodeMode(mode)
...
function VersionActivity2_0DungeonMapEpisodeView:directChangeMode()
	self.activityDungeonMo:changeMode(self.activityDungeonMo.mode)
end

function VersionActivity2_0DungeonMapEpisodeView:_onDragBeginHandler()
	self._audioScroll:onDragBegin()
end

function VersionActivity2_0DungeonMapEpisodeView:_onDragEndHandler()
	self._audioScroll:onDragEnd()
end

function VersionActivity2_0DungeonMapEpisodeView:_onClickDownHandler()
	self._audioScroll:onClickDown()
end

function VersionActivity2_0DungeonMapEpisodeView:playOnOpenAnimation()
...
function VersionActivity2_0DungeonMapEpisodeView:playUnlockAnimation(needDone)
	...
	if isNeedPlayHardModeUnlockAnim then
		local prefsKey = VersionActivity2_0DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim

		VersionActivity2_0DungeonController.instance:savePlayerPrefs(prefsKey, HAVE_PLAYED)
...
function VersionActivity2_0DungeonMapEpisodeView:IsNeedPlayHardModeUnlockAnimation()
	local isNeedPlay = false
	local prefsKey = VersionActivity2_0DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim
	local value = VersionActivity2_0DungeonController.instance:getPlayerPrefs(prefsKey, NOT_PLAYED)
...
function VersionActivity2_0DungeonMapEpisodeView:_unlockAniDone()
	local dungeonActId = VersionActivity2_0Enum.ActivityId.Dungeon
	local isOpen = VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapter(dungeonActId)
...
function VersionActivity2_0DungeonMapEpisodeView:onDestroyView()
...
return VersionActivity2_0DungeonMapEpisodeView
