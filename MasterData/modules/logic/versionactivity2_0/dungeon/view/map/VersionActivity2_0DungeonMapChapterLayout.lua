-- chunkname: @modules/logic/versionactivity2_0/dungeon/view/map/VersionActivity2_0DungeonMapChapterLayout.lua

module("modules.logic.versionactivity2_0.dungeon.view.map.VersionActivity2_0DungeonMapChapterLayout", package.seeall)

local VersionActivity2_0DungeonMapChapterLayout = class("VersionActivity2_0DungeonMapChapterLayout", BaseChildView)
local CHAPTER_KEY = "default"
local RIGHT_OFFSET_X = 600
local CONST_DUNGEON_NORMAL_DELTA_X = 100
local TWEEN_TIME = 0.26

function VersionActivity2_0DungeonMapChapterLayout:onInitView()
...
function VersionActivity2_0DungeonMapChapterLayout:addEvents()
...
function VersionActivity2_0DungeonMapChapterLayout:removeEvents()
...
function VersionActivity2_0DungeonMapChapterLayout:_onOpenView(viewName)
...
function VersionActivity2_0DungeonMapChapterLayout:_onCloseView(viewName)
	if viewName == ViewName.VersionActivity2_0DungeonMapLevelView then
...
function VersionActivity2_0DungeonMapChapterLayout:onActivityDungeonMoChange()
	self:updateFocusStatus()
	self:setFocusEpisodeId(self.activityDungeonMo.episodeId, true)
end

function VersionActivity2_0DungeonMapChapterLayout:updateFocusStatus()
	for _, episodeItem in pairs(self._episodeItemDict) do
		episodeItem:refreshFocusStatus()
	end
end

function VersionActivity2_0DungeonMapChapterLayout:_onGamepadKeyUp(key)
	local viewNameList = ViewMgr.instance:getOpenViewNameList()
	local topView = viewNameList[#viewNameList]

	if topView ~= ViewName.VersionActivity2_0DungeonMapView and topView ~= ViewName.VersionActivity2_0DungeonMapLevelView then
		return
	end
...
function VersionActivity2_0DungeonMapChapterLayout:_onChangeFocusEpisodeItem(item)
	if GamepadController.instance:isOpen() then
...
function VersionActivity2_0DungeonMapChapterLayout:_editableInitView()
	self._focusIndex = 0
	...
	if ViewMgr.instance:isOpening(ViewName.VersionActivity2_0DungeonMapLevelView) then
		self._timelineAnimation:Play("timeline_mask")
	end
end

function VersionActivity2_0DungeonMapChapterLayout:onUpdateParam()
	return
end

function VersionActivity2_0DungeonMapChapterLayout:onOpen()
	return
end

function VersionActivity2_0DungeonMapChapterLayout:refreshEpisodeNodes()
	self._episodeItemDict = self:getUserDataTb_()
...
function VersionActivity2_0DungeonMapChapterLayout:getEpisodeContainerItem(index)
...
function VersionActivity2_0DungeonMapChapterLayout:setFocusEpisodeId(episodeId, tween)
...
function VersionActivity2_0DungeonMapChapterLayout:setFocusItem(focusItemGo, tween)
...
function VersionActivity2_0DungeonMapChapterLayout:setFocusEpisodeItem(item, tween)
...
function VersionActivity2_0DungeonMapChapterLayout:setSelectEpisodeItem(episodeItem)
...
function VersionActivity2_0DungeonMapChapterLayout:playAnimation(aniName)
	self.animator:Play(aniName, 0, 0)
end

function VersionActivity2_0DungeonMapChapterLayout:playEpisodeItemAnimation(aniName)
...
function VersionActivity2_0DungeonMapChapterLayout:setSelectEpisodeId(episodeId, skipAni)
...
function VersionActivity2_0DungeonMapChapterLayout:isSelectedEpisodeRightEpisode(episodeItem)
	local result = false
...
function VersionActivity2_0DungeonMapChapterLayout:onClose()
	for i, v in pairs(self._episodeContainerItemList) do
		v.episodeItem:destroyView()
	end
end

function VersionActivity2_0DungeonMapChapterLayout:onDestroyView()
	return
end

return VersionActivity2_0DungeonMapChapterLayout
