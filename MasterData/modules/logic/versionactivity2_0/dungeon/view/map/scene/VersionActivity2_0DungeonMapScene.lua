...
function VersionActivity2_0DungeonMapScene:addEvents()
	...
	self.addEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.FocusElement, self.onFocusElement, self)
	self.addEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.ManualClickElement, self.manualClickElement, self)
...
function VersionActivity2_0DungeonMapScene:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.FocusElement, self.onFocusElement, self)
	self.removeEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.ManualClickElement, self.manualClickElement, self)
