...
function VersionActivity2_0DungeonMapSceneElements:addEvents()
	...
	self.addEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
...
function VersionActivity2_0DungeonMapSceneElements:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
