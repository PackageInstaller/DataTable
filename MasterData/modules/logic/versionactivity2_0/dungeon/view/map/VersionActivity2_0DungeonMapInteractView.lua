...
function VersionActivity2_0DungeonMapInteractView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_0DungeonMapInteractView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnClickElement, self.showInteractUI, self)
