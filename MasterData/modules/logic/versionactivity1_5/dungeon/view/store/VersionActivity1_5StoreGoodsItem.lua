-- chunkname: @modules/logic/versionactivity1_5/dungeon/view/store/VersionActivity1_5StoreGoodsItem.lua

module("modules.logic.versionactivity1_5.dungeon.view.store.VersionActivity1_5StoreGoodsItem", package.seeall)

local VersionActivity1_5StoreGoodsItem = class("VersionActivity1_5StoreGoodsItem", UserDataDispose)

function VersionActivity1_5StoreGoodsItem:onInitView(go)
	self:__onInit()
...
function VersionActivity1_5StoreGoodsItem:onClick()
	...
	ViewMgr.instance:openView(ViewName.VersionActivity1_5NormalStoreGoodsView, self.storeGoodsCo)
end

function VersionActivity1_5StoreGoodsItem:updateInfo(storeGoodsCo)
	...
	UISpriteSetMgr.instance:setV1a5DungeonStoreSprite(self.imageRare, "v1a5_store_quality_" .. rare)
	...
	self.txtName = rare >= MaterialEnum.ItemRareR and gohelper.findChildText(self.go, "txt_name" .. rare) or gohelper.findChildText(self.go, "txt_name")
...
function VersionActivity1_5StoreGoodsItem:refreshRemainBuyCount()
	if self.storeGoodsCo.maxBuyCount == 0 then
		...
		self.remainBuyCount = self.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity1_5Enum.ActivityId.DungeonStore, self.storeGoodsCo.id)
...
function VersionActivity1_5StoreGoodsItem:refreshTag()
...
function VersionActivity1_5StoreGoodsItem:getItemTypeIdQuantity(coStr)
	local attribute = string.splitToNumber(coStr, "#")

	return attribute[1], attribute[2], attribute[3]
end

function VersionActivity1_5StoreGoodsItem:hide()
	gohelper.setActive(self.go, false)
end

function VersionActivity1_5StoreGoodsItem:onDestroy()
...
return VersionActivity1_5StoreGoodsItem
