-- chunkname: @modules/logic/versionactivity3_7/enter/view/subview/V3a7_Wmz_EnterView.lua

module("modules.logic.versionactivity3_7.enter.view.subview.V3a7_Wmz_EnterView", package.seeall)

local V3a7_Wmz_EnterView = class("V3a7_Wmz_EnterView", BaseView)

function V3a7_Wmz_EnterView:onInitView()
...
function V3a7_Wmz_EnterView:addEvents()
...
function V3a7_Wmz_EnterView:removeEvents()
...
function V3a7_Wmz_EnterView:_btnitemOnClick()
	return
end

function V3a7_Wmz_EnterView:_btnEnterOnClick()
	self:_enterGame()
end

function V3a7_Wmz_EnterView:_btnLockedOnClick()
...
function V3a7_Wmz_EnterView:_editableInitView()
	self.actId = self.viewContainer.activityId
	RoleActivityEnum.LevelView[self.actId] = ViewName.V3a7_Wmz_LevelView
...
function V3a7_Wmz_EnterView:onOpen()
	...
	self.addEventCb(self, ActivityController.instance, ActivityEvent.RefreshActivityState, self._onActStatusChange, self)
end

function V3a7_Wmz_EnterView:_enterGame()
...
function V3a7_Wmz_EnterView:onDestroyView()
	TaskDispatcher.cancelTask(self._refreshTime, self)
	self.animComp:destroy()
end

function V3a7_Wmz_EnterView:_freshLockStatus()
...
function V3a7_Wmz_EnterView:_onActStatusChange()
	self:_freshLockStatus()
end

function V3a7_Wmz_EnterView:_clickLock()
...
function V3a7_Wmz_EnterView:_btnTrialOnClick()
...
function V3a7_Wmz_EnterView:_refreshTime()
...
function V3a7_Wmz_EnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function V3a7_Wmz_EnterView:_showLeftTime()
	self._txtLimitTime.text = ActivityHelper.getActivityRemainTimeStr(self.actId)
end

return V3a7_Wmz_EnterView
