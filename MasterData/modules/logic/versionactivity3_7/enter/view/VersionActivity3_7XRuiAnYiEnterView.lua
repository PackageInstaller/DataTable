-- chunkname: @modules/logic/versionactivity3_7/enter/view/VersionActivity3_7XRuiAnYiEnterView.lua

module("modules.logic.versionactivity3_7.enter.view.VersionActivity3_7XRuiAnYiEnterView", package.seeall)

local VersionActivity3_7XRuiAnYiEnterView = class("VersionActivity3_7XRuiAnYiEnterView", VersionActivityEnterBaseSubView)

function VersionActivity3_7XRuiAnYiEnterView:onInitView()
...
function VersionActivity3_7XRuiAnYiEnterView:addEvents()
...
function VersionActivity3_7XRuiAnYiEnterView:removeEvents()
...
function VersionActivity3_7XRuiAnYiEnterView:_editableInitView()
...
function VersionActivity3_7XRuiAnYiEnterView:onOpen()
...
function VersionActivity3_7XRuiAnYiEnterView:_enterGame()
	...
	if string.nilorempty(condition) then
		XRuiAnYiController.instance:enterLevelView()
	else
...
function VersionActivity3_7XRuiAnYiEnterView:_clickLock()
...
function VersionActivity3_7XRuiAnYiEnterView:_btnitemOnClick()
	return
end

function VersionActivity3_7XRuiAnYiEnterView:_btnTrialOnClick()
...
function VersionActivity3_7XRuiAnYiEnterView:everySecondCall()
	self:_refreshTime()
end

function VersionActivity3_7XRuiAnYiEnterView:_refreshTime()
...
function VersionActivity3_7XRuiAnYiEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity3_7XRuiAnYiEnterView:onDestroyView()
	return
end

return VersionActivity3_7XRuiAnYiEnterView
