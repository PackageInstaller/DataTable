...
function ActWeilaLevelView:onOpen()
	self.addEventCb(self, ActWeilaController.instance, ActWeilaEvent.StoryItemClick, self.OnStoryItemClick, self)
	self.addEventCb(self, ActWeilaController.instance, ActWeilaEvent.FightItemClick, self.OnFightItemClick, self)
	self.addEventCb(self, ActWeilaController.instance, ActWeilaEvent.TabSwitch, self.OnTabSwitch, self)
...
function ActWeilaLevelView:_initStageItems()
	...
	for i = 1, #storyConfigList do
		...
		self.storyItemList[i] = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGo, WeilaStoryItem, self)
	...
	for i = 1, #fightConfigList / 2 do
		...
		self.fightItemList[i] = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGo, WeilaFightItem, self)
