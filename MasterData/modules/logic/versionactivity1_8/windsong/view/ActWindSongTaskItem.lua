...
function ActWindSongTaskItem:_editableAddEvents()
	self.addEventCb(self, ActWindSongController.instance, ActWindSongEvent.OneClickClaimReward, self._onOneClickClaimReward, self)
end

function ActWindSongTaskItem:_editableRemoveEvents()
	self.removeEventCb(self, ActWindSongController.instance, ActWindSongEvent.OneClickClaimReward, self._onOneClickClaimReward, self)
end
