-- chunkname: @modules/logic/versionactivity1_8/enter/view/subview/V1a8_Season123EnterView.lua

module("modules.logic.versionactivity1_8.enter.view.subview.V1a8_Season123EnterView", package.seeall)

local V1a8_Season123EnterView = class("V1a8_Season123EnterView", BaseView)

function V1a8_Season123EnterView:onInitView()
...
function V1a8_Season123EnterView:addEvents()
...
function V1a8_Season123EnterView:removeEvents()
...
function V1a8_Season123EnterView:_btnNormalOnClick()
...
function V1a8_Season123EnterView:_btnLockedOnClick()
...
function V1a8_Season123EnterView:_btnStoreOnClick()
	Season123Controller.instance:openSeasonStoreView(self.actId)
end

function V1a8_Season123EnterView:_editableInitView()
...
function V1a8_Season123EnterView:onUpdateParam()
	return
end

function V1a8_Season123EnterView:onOpen()
	self.animComp:playOpenAnim()

	self.actId = VersionActivity1_8Enum.ActivityId.Season
...
function V1a8_Season123EnterView:refreshUI()
...
function V1a8_Season123EnterView:refreshDesc()
...
function V1a8_Season123EnterView:refreshStoreCoin()
...
function V1a8_Season123EnterView:refreshEnterBtn()
	local status, toastId, toastParam = ActivityHelper.getActivityStatusAndToast(self.actId)
...
function V1a8_Season123EnterView:refreshRemainTime()
	self:refreshMainTime()
	self:refreshStoreTime()
end

function V1a8_Season123EnterView:refreshMainTime()
...
function V1a8_Season123EnterView:refreshStoreTime()
...
function V1a8_Season123EnterView:onClose()
	TaskDispatcher.cancelTask(self.refreshRemainTime, self)
end

function V1a8_Season123EnterView:onDestroyView()
	self.animComp:destroy()
end

return V1a8_Season123EnterView
