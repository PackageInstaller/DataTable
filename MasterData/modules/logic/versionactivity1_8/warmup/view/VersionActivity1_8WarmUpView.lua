...
function VersionActivity1_8WarmUpView:addEvents()
	...
	self.addEventCb(self, Activity125Controller.instance, Activity125Event.OnClickFile, self._refreshWrongChannel, self)
...
function VersionActivity1_8WarmUpView:removeEvents()
	...
	self.removeEventCb(self, Activity125Controller.instance, Activity125Event.OnClickFile, self._refreshWrongChannel, self)
...
function VersionActivity1_8WarmUpView:playDesc()
	...
	self._playEpisodeDesc(self, self.desctime, self._onPlayEpisodeDescFinished, self)
...
function VersionActivity1_8WarmUpView:_refreshWrongChannel()
	...
	self._txtWrongChannel.text = curLvl == 1 and clickFilePrefs == 0 and luaLang("justreport_firsttips") or luaLang("justreport_secondtips")
end
