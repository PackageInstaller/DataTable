-- chunkname: @modules/logic/versionactivity3_3/enter/view/subview/VersionActivity3_3IgorEnterView.lua

module("modules.logic.versionactivity3_3.enter.view.subview.VersionActivity3_3IgorEnterView", package.seeall)

local VersionActivity3_3IgorEnterView = class("VersionActivity3_3IgorEnterView", VersionActivityEnterBaseSubView)

function VersionActivity3_3IgorEnterView:onInitView()
...
function VersionActivity3_3IgorEnterView:addEvents()
...
function VersionActivity3_3IgorEnterView:removeEvents()
...
function VersionActivity3_3IgorEnterView:_editableInitView()
	self._animator = self.viewGO:GetComponent(gohelper.Type_Animator)
end

function VersionActivity3_3IgorEnterView:onOpen()
...
function VersionActivity3_3IgorEnterView:_enterGame()
...
function VersionActivity3_3IgorEnterView:enterLevelView()
	IgorController.instance:enterEpisodeLevelView(self.actId)
end

function VersionActivity3_3IgorEnterView:_clickLock()
...
function VersionActivity3_3IgorEnterView:_btnitemOnClick()
	return
end

function VersionActivity3_3IgorEnterView:_btnTrialOnClick()
...
function VersionActivity3_3IgorEnterView:everySecondCall()
	self:_refreshTime()
end

function VersionActivity3_3IgorEnterView:_refreshTime()
...
function VersionActivity3_3IgorEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity3_3IgorEnterView:onDestroyView()
	return
end

return VersionActivity3_3IgorEnterView
