-- chunkname: @modules/logic/versionactivity3_3/enter/view/subview/VersionActivity3_3MarshaEnterView.lua

module("modules.logic.versionactivity3_3.enter.view.subview.VersionActivity3_3MarshaEnterView", package.seeall)

local VersionActivity3_3MarshaEnterView = class("VersionActivity3_3MarshaEnterView", VersionActivityEnterBaseSubView)

function VersionActivity3_3MarshaEnterView:onInitView()
...
function VersionActivity3_3MarshaEnterView:addEvents()
...
function VersionActivity3_3MarshaEnterView:removeEvents()
...
function VersionActivity3_3MarshaEnterView:_editableInitView()
...
function VersionActivity3_3MarshaEnterView:onOpen()
...
function VersionActivity3_3MarshaEnterView:_enterGame()
	...
	if string.nilorempty(condition) then
		MarshaController.instance:enterLevelView()
	else
...
function VersionActivity3_3MarshaEnterView:_clickLock()
...
function VersionActivity3_3MarshaEnterView:_btnitemOnClick()
	return
end

function VersionActivity3_3MarshaEnterView:_btnTrialOnClick()
...
function VersionActivity3_3MarshaEnterView:everySecondCall()
	self:_refreshTime()
end

function VersionActivity3_3MarshaEnterView:_refreshTime()
...
function VersionActivity3_3MarshaEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity3_3MarshaEnterView:onDestroyView()
	return
end

return VersionActivity3_3MarshaEnterView
