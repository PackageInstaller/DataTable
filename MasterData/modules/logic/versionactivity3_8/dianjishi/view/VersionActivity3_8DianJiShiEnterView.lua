-- chunkname: @modules/logic/versionactivity3_8/dianjishi/view/VersionActivity3_8DianJiShiEnterView.lua

module("modules.logic.versionactivity3_8.dianjishi.view.VersionActivity3_8DianJiShiEnterView", package.seeall)

local VersionActivity3_8DianJiShiEnterView = class("VersionActivity3_8DianJiShiEnterView", VersionActivityEnterBaseSubView)

function VersionActivity3_8DianJiShiEnterView:onInitView()
...
function VersionActivity3_8DianJiShiEnterView:addEvents()
...
function VersionActivity3_8DianJiShiEnterView:removeEvents()
...
function VersionActivity3_8DianJiShiEnterView:_editableInitView()
...
function VersionActivity3_8DianJiShiEnterView:onOpen()
...
function VersionActivity3_8DianJiShiEnterView:_enterGame()
	...
	if string.nilorempty(condition) then
		DianJiShiLevelController.instance:enterLevelView()
	else
...
function VersionActivity3_8DianJiShiEnterView:_clickLock()
...
function VersionActivity3_8DianJiShiEnterView:_btnitemOnClick()
	return
end

function VersionActivity3_8DianJiShiEnterView:_btnTrialOnClick()
...
function VersionActivity3_8DianJiShiEnterView:everySecondCall()
	self:_refreshTime()
end

function VersionActivity3_8DianJiShiEnterView:_refreshTime()
...
function VersionActivity3_8DianJiShiEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity3_8DianJiShiEnterView:onDestroyView()
	return
end

return VersionActivity3_8DianJiShiEnterView
