...
function VersionActivity3_8EnterViewTabItem2:afterSetData()
	...
	self.redDotIcon = RedDotController.instance:addRedDot(self.goRedDot, self.activityCo.redDotId, (VersionActivity3_8Enum.CharacterActId[self.actId] or nil) and (self.actId or self.redDotUid))
