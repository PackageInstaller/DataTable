-- chunkname: @modules/logic/versionactivity3_0/karong/view/comp/KaRongTaskItem.lua

module("modules.logic.versionactivity3_0.karong.view.comp.KaRongTaskItem", package.seeall)

local KaRongTaskItem = class("KaRongTaskItem", ListScrollCellExtend)

function KaRongTaskItem:onInitView()
...
function KaRongTaskItem:addEvents()
...
function KaRongTaskItem:_btnfinishbgOnClick()
...
function KaRongTaskItem:_editableRemoveEvents()
...
function KaRongTaskItem:_onOneClickClaimReward()
...
function KaRongTaskItem:getAnimator()
	return self._animator
end

function KaRongTaskItem:onUpdateMO(mo)
...
function KaRongTaskItem:_moveByRankDiff(rankDiff)
...
function KaRongTaskItem:_refreshUI()
...
function KaRongTaskItem:_onItemShow(cell_component, data, index)
...
function KaRongTaskItem:onDestroyView()
	if self._rankDiffMoveId then
		ZProj.TweenHelper.KillById(self._rankDiffMoveId)
