-- chunkname: @modules/logic/versionactivity3_2/enter/view/subview/VersionActivity3_2BeiLiErEnterView.lua

module("modules.logic.versionactivity3_2.enter.view.subview.VersionActivity3_2BeiLiErEnterView", package.seeall)

local VersionActivity3_2BeiLiErEnterView = class("VersionActivity3_2BeiLiErEnterView", VersionActivityEnterBaseSubView)

function VersionActivity3_2BeiLiErEnterView:onInitView()
...
function VersionActivity3_2BeiLiErEnterView:addEvents()
...
function VersionActivity3_2BeiLiErEnterView:removeEvents()
...
function VersionActivity3_2BeiLiErEnterView:_editableInitView()
...
function VersionActivity3_2BeiLiErEnterView:onOpen()
...
function VersionActivity3_2BeiLiErEnterView:_enterGame()
	...
	if string.nilorempty(condition) then
		BeiLiErController.instance:enterLevelView()
	else
...
function VersionActivity3_2BeiLiErEnterView:_clickLock()
...
function VersionActivity3_2BeiLiErEnterView:_btnitemOnClick()
	return
end

function VersionActivity3_2BeiLiErEnterView:_btnTrialOnClick()
...
function VersionActivity3_2BeiLiErEnterView:everySecondCall()
	self:_refreshTime()
end

function VersionActivity3_2BeiLiErEnterView:_refreshTime()
...
function VersionActivity3_2BeiLiErEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity3_2BeiLiErEnterView:onDestroyView()
	return
end

return VersionActivity3_2BeiLiErEnterView
