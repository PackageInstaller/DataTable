-- chunkname: @modules/logic/season/view1_3/Season1_3EquipView.lua

module("modules.logic.season.view1_3.Season1_3EquipView", package.seeall)

local Season1_3EquipView = class("Season1_3EquipView", BaseView)

function Season1_3EquipView:onInitView()
...
function Season1_3EquipView:addEvents()
...
function Season1_3EquipView:removeEvents()
	self._btnequip:RemoveClickListener()
	self._btnopenhandbook:RemoveClickListener()
end

function Season1_3EquipView:_editableInitView()
...
function Season1_3EquipView:onDestroyView()
...
function Season1_3EquipView:onOpen()
...
function Season1_3EquipView:onClose()
	return
end

function Season1_3EquipView:refreshUI()
...
function Season1_3EquipView:handleEquipUpdate()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season1_3EquipView:refreshSlots()
...
function Season1_3EquipView:refreshSlot(slotIndex)
...
Season1_3EquipView.MaxUISlot = 2

function Season1_3EquipView:refreshDescGroup()
	for slot = 1, Season1_3EquipView.MaxUISlot do
...
function Season1_3EquipView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season1_3EquipView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season1_3EquipView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season1_3EquipView:getOrCreatePropText(index, descItem)
...
function Season1_3EquipView:getOrCreateSkillText(index, descItem)
...
function Season1_3EquipView:getOrCreateSlot(slotIndex)
...
function Season1_3EquipView:getOrCreateSlotIcon(slotItem)
...
function Season1_3EquipView:getOrCreateDesc(index)
...
function Season1_3EquipView:onClickSlot(slotIndex)
	if Activity104EquipItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season1_3EquipView:handleSaveSucc()
...
function Season1_3EquipView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season1_3EquipView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season1_3EquipView:handleEquipCardChanged(param)
...
function Season1_3EquipView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season1_3EquipView:_btnequipOnClick()
