-- chunkname: @modules/logic/season/view1_3/Season1_3StoreItem.lua

module("modules.logic.season.view1_3.Season1_3StoreItem", package.seeall)

local Season1_3StoreItem = class("Season1_3StoreItem", UserDataDispose)

function Season1_3StoreItem:ctor(go)
	self:__onInit()
...
function Season1_3StoreItem:onClick()
...
function Season1_3StoreItem:setData(data)
	self.data = data
...
function Season1_3StoreItem:refreshRemainBuyCount()
...
function Season1_3StoreItem:refreshTag()
...
function Season1_3StoreItem:getItemTypeIdQuantity(coStr)
	local attribute = string.splitToNumber(coStr, "#")

	return attribute[1], attribute[2], attribute[3]
end

function Season1_3StoreItem:destory()
