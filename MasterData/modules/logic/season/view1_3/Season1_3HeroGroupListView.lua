-- chunkname: @modules/logic/season/view1_3/Season1_3HeroGroupListView.lua

module("modules.logic.season.view1_3.Season1_3HeroGroupListView", package.seeall)

local Season1_3HeroGroupListView = class("Season1_3HeroGroupListView", BaseView)

function Season1_3HeroGroupListView:onInitView()
...
function Season1_3HeroGroupListView:_editableInitView()
	...
	for i = 1, 4 do
		...
		local item = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGO, Season1_3HeroGroupHeroItem, self)
...
function Season1_3HeroGroupListView:addEvents()
...
function Season1_3HeroGroupListView:removeEvents()
...
function Season1_3HeroGroupListView:onOpen()
	self._isOpen = true
...
function Season1_3HeroGroupListView:_playOpenAnimation()
...
function Season1_3HeroGroupListView:_checkRestrictHero()
...
function Season1_3HeroGroupListView:_removeRestrictHero()
...
function Season1_3HeroGroupListView:_onHeroGroupExit()
	...
	ViewMgr.instance:closeView(ViewName.Season1_3HeroGroupFightView, false, false)
end

function Season1_3HeroGroupListView:_closeTweenFinish(index)
...
function Season1_3HeroGroupListView:canDrag(param, isWrap)
...
function Season1_3HeroGroupListView:_onBeginDrag(param, pointerEventData)
...
function Season1_3HeroGroupListView:_onDrag(param, pointerEventData)
	if not self:canDrag(param) then
...
function Season1_3HeroGroupListView:_onEndDrag(param, pointerEventData)
	if not self:canDrag(param) then
		return
	end
...
function Season1_3HeroGroupListView:_setHeroItemPos(heroItem, index, tween, callback, callbackObj)
	local posTr = self.heroPosTrList[index]
...
function Season1_3HeroGroupListView:_tweenToPos(heroItem, anchorPos)
...
function Season1_3HeroGroupListView:_setDragEnabled(isEnabled)
	for i, drag in ipairs(self._heroItemDrag) do
		drag.enabled = isEnabled
	end
end

function Season1_3HeroGroupListView:_updateHeroList()
	for i, heroItem in ipairs(self._heroItemList) do
...
function Season1_3HeroGroupListView:_onSnapshotSaveSucc()
	self:_updateHeroList()
...
function Season1_3HeroGroupListView:_calcIndex(position)
	for i = 1, 4 do
...
function Season1_3HeroGroupListView:onDestroyView()
...
function Season1_3HeroGroupListView:_onScreenSizeChange()
	for i = 1, ModuleEnum.MaxHeroCountInGroup do
		local heroItem = self._heroItemList[i]
...
function Season1_3HeroGroupListView:getHeroItemList()
	return self._heroItemList
end

return Season1_3HeroGroupListView
