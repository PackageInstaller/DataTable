-- chunkname: @modules/logic/season/view1_3/Season1_3EquipSelfChoiceView.lua

module("modules.logic.season.view1_3.Season1_3EquipSelfChoiceView", package.seeall)

local Season1_3EquipSelfChoiceView = class("Season1_3EquipSelfChoiceView", BaseView)

function Season1_3EquipSelfChoiceView:onInitView()
...
function Season1_3EquipSelfChoiceView:addEvents()
...
function Season1_3EquipSelfChoiceView:removeEvents()
...
function Season1_3EquipSelfChoiceView:_btnclose1OnClick()
	return
end

function Season1_3EquipSelfChoiceView:_btnokOnClick()
	Activity104EquipSelfChoiceController.instance:sendSelectCard(self.handleSendChoice, self)
end

function Season1_3EquipSelfChoiceView:_btncloseOnClick()
	self:closeThis()
end

function Season1_3EquipSelfChoiceView:_editableInitView()
	self._simagebg1:LoadImage(ResUrl.getCommonIcon("bg_leftdown"))
	self._simagebg2:LoadImage(ResUrl.getCommonIcon("bg_rightup"))
end

function Season1_3EquipSelfChoiceView:onDestroyView()
	self._simagebg1:UnLoadImage()
	self._simagebg2:UnLoadImage()
	Activity104EquipSelfChoiceController.instance:onCloseView()
end

function Season1_3EquipSelfChoiceView:onOpen()
...
function Season1_3EquipSelfChoiceView:selectSelfChoiceCard(itemId)
...
function Season1_3EquipSelfChoiceView:getOrCreateSkillText(index)
...
function Season1_3EquipSelfChoiceView:onClose()
	TaskDispatcher.cancelTask(self.closeThis, self)
end

function Season1_3EquipSelfChoiceView:delayClose()
	TaskDispatcher.runDelay(self.closeThis, self, 0.001)
end

function Season1_3EquipSelfChoiceView:handleSendChoice(cmd, resultCode, msg)
...
return Season1_3EquipSelfChoiceView
