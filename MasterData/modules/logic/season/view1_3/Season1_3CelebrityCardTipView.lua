-- chunkname: @modules/logic/season/view1_3/Season1_3CelebrityCardTipView.lua

module("modules.logic.season.view1_3.Season1_3CelebrityCardTipView", package.seeall)

local Season1_3CelebrityCardTipView = class("Season1_3CelebrityCardTipView", BaseView)

function Season1_3CelebrityCardTipView:onInitView()
...
function Season1_3CelebrityCardTipView:addEvents()
...
function Season1_3CelebrityCardTipView:removeEvents()
...
function Season1_3CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season1_3CelebrityCardTipView:onClickGMAdd(count)
...
function Season1_3CelebrityCardTipView:_btninputOnClick()
...
function Season1_3CelebrityCardTipView:_editableInitView()
...
function Season1_3CelebrityCardTipView:onDestroyView()
...
function Season1_3CelebrityCardTipView:onOpen()
...
function Season1_3CelebrityCardTipView:onClose()
	return
end

function Season1_3CelebrityCardTipView:refreshUI()
...
function Season1_3CelebrityCardTipView:refreshQuantity()
...
function Season1_3CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season1_3CelebrityCardTipView:refreshSkills()
...
function Season1_3CelebrityCardTipView:checkCreateIcon()
...
function Season1_3CelebrityCardTipView:getOrCreatePropText(index)
...
function Season1_3CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season1_3CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season1_3CelebrityCardTipView
