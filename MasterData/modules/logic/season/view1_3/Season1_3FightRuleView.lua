-- chunkname: @modules/logic/season/view1_3/Season1_3FightRuleView.lua

module("modules.logic.season.view1_3.Season1_3FightRuleView", package.seeall)

local Season1_3FightRuleView = class("Season1_3FightRuleView", BaseView)

function Season1_3FightRuleView:onInitView()
...
function Season1_3FightRuleView:addEvents()
	return
end

function Season1_3FightRuleView:removeEvents()
	return
end

function Season1_3FightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function Season1_3FightRuleView:onOpen()
	self:refreshRule()
end

function Season1_3FightRuleView:refreshRule()
	local dataList = Season1_3FightRuleView.getRuleList() or {}
...
function Season1_3FightRuleView:createItem(index)
	local item = {}
...
function Season1_3FightRuleView:updateItem(item, data)
...
function Season1_3FightRuleView:destroyItem(item)
	return
end

function Season1_3FightRuleView.getRuleList()
...
function Season1_3FightRuleView:setDecorateVisible(isVisible)
...
function Season1_3FightRuleView:onClose()
	return
end

function Season1_3FightRuleView:onDestroyView()
