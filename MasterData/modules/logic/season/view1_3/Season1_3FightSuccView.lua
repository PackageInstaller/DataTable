-- chunkname: @modules/logic/season/view1_3/Season1_3FightSuccView.lua

module("modules.logic.season.view1_3.Season1_3FightSuccView", package.seeall)

local Season1_3FightSuccView = class("Season1_3FightSuccView", FightSuccView)

function Season1_3FightSuccView:onInitView()
...
function Season1_3FightSuccView:addEvents()
...
function Season1_3FightSuccView:removeEvents()
...
function Season1_3FightSuccView:_editableInitView()
	self._click = gohelper.getClick(self.viewGO)
end

function Season1_3FightSuccView:_onClickClose()
	if self._showEquipCard then
		return
	end

	Season1_3FightSuccView.super._onClickClose(self)
end

function Season1_3FightSuccView:onOpen()
	Season1_3FightSuccView.super.onOpen(self)
	gohelper.setActive(self._bonusItemContainer, false)
	self:_dealGetCard()
	self:_showGoal()
end

function Season1_3FightSuccView:_dealGetCard()
	local reward_list = {}
...
function Season1_3FightSuccView:_loadBonusItems()
	return
end

function Season1_3FightSuccView:_showGetCardView()
...
function Season1_3FightSuccView:_onTipsClose()
	self:_showRewardPart()
	self:_showPlayerLevelUpView()
end

function Season1_3FightSuccView:_showRewardPart()
	self._showEquipCard = nil

	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
	gohelper.setActive(self._bonusItemContainer, true)
	Season1_3FightSuccView.super._loadBonusItems(self)
end

function Season1_3FightSuccView:_onCloseViewFinish(viewName)
...
function Season1_3FightSuccView:_showChoiceCardView()
...
function Season1_3FightSuccView:_addItem(material)
...
function Season1_3FightSuccView:_setFbName(episodeCO)
...
function Season1_3FightSuccView:_showGoal()
...
function Season1_3FightSuccView:_checkTypeDetails()
	return
end

function Season1_3FightSuccView:_hideGoDemand()
	return
end

function Season1_3FightSuccView:onClose()
	...
	Season1_3FightSuccView.super.onClose(self)
end

function Season1_3FightSuccView:onDestroyView()
	Season1_3FightSuccView.super.onDestroyView(self)
end

return Season1_3FightSuccView
