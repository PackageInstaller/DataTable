-- chunkname: @modules/logic/season/view1_3/Season1_3HeroGroupFightViewRule.lua

module("modules.logic.season.view1_3.Season1_3HeroGroupFightViewRule", package.seeall)

local Season1_3HeroGroupFightViewRule = class("Season1_3HeroGroupFightViewRule", BaseView)

function Season1_3HeroGroupFightViewRule:onInitView()
	...
	self._btnenemy = gohelper.findChildButtonWithAudio(self.viewGO, "#go_container/infocontain/enemycontain/enemyList/#btn_enemy")
	...
	self._goTask = gohelper.findChild(self.viewGO, "#go_container/infocontain/#go_task")
	self._txtTask = gohelper.findChildText(self.viewGO, "#go_container/infocontain/#go_task/#go_taskitem/#txt_task")
...
function Season1_3HeroGroupFightViewRule:addEvents()
...
function Season1_3HeroGroupFightViewRule:removeEvents()
...
function Season1_3HeroGroupFightViewRule:_btncloseruleOnClick()
...
function Season1_3HeroGroupFightViewRule:_btnadditionRuleOnClick()
...
function Season1_3HeroGroupFightViewRule:_btnenemyOnClick()
	EnemyInfoController.instance:openEnemyInfoViewByBattleId(HeroGroupModel.instance.battleId)
end

function Season1_3HeroGroupFightViewRule:_btnAdditionRuleDetailOnClick()
...
function Season1_3HeroGroupFightViewRule:_editableInitView()
...
function Season1_3HeroGroupFightViewRule:onOpen()
	self.addEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._recommendCareer, self)
	self:_refreshUI()
end

function Season1_3HeroGroupFightViewRule:_refreshUI()
	self:_refreshRules()
...
function Season1_3HeroGroupFightViewRule:_refreshTask()
...
function Season1_3HeroGroupFightViewRule:_refreshRules()
	...
	if isRetail then
		...
		self._txtruleinfo.text = retailMo.advancedId and retailMo.advancedId ~= 0 and lua_condition.configDict[retailMo.advancedId].desc or ""
	end
end

function Season1_3HeroGroupFightViewRule:_refreshAddition()
	local episodeId = HeroGroupModel.instance.episodeId
...
function Season1_3HeroGroupFightViewRule:_addRuleItem(ruleCo, targetId)
...
function Season1_3HeroGroupFightViewRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season1_3HeroGroupFightViewRule:_refreshEnemy()
	...
	self._txtrecommendlevel.text = #enemyBossList > 0 and HeroConfig.instance:getCommonLevelDisplay(level) or #enemyList > 0 and HeroConfig.instance:getCommonLevelDisplay(level) or ""
end

function Season1_3HeroGroupFightViewRule:_recommendCareer()
...
function Season1_3HeroGroupFightViewRule:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season1_3HeroGroupFightViewRule:_onEnemyItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")
...
function Season1_3HeroGroupFightViewRule:onClose()
	self.removeEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._recommendCareer, self)
end

function Season1_3HeroGroupFightViewRule:onDestroyView()
	return
end

return Season1_3HeroGroupFightViewRule
