-- chunkname: @modules/logic/season/view3_0/Season3_0HeroGroupFightView.lua

module("modules.logic.season.view3_0.Season3_0HeroGroupFightView", package.seeall)

local Season3_0HeroGroupFightView = class("Season3_0HeroGroupFightView", BaseView)

function Season3_0HeroGroupFightView:onInitView()
...
function Season3_0HeroGroupFightView:addEvents()
...
function Season3_0HeroGroupFightView:removeEvents()
...
function Season3_0HeroGroupFightView:_setTrialNumTips()
	local _, battleCO = Season3_0HeroGroupFightView._getEpisodeConfigAndBattleConfig()
	local tips = {}
...
function Season3_0HeroGroupFightView:_onTouch()
...
function Season3_0HeroGroupFightView:_setTrialTipsTxt(obj, data, index)
	gohelper.findChildTextMesh(obj, "desc").text = data
end

function Season3_0HeroGroupFightView:_switchTrialTips()
...
function Season3_0HeroGroupFightView:_btnrecommendOnClick()
...
function Season3_0HeroGroupFightView:_btnclothOnClock()
...
function Season3_0HeroGroupFightView:_btnrestrainOnClick()
	ViewMgr.instance:openView(ViewName.HeroGroupCareerTipView)
end

function Season3_0HeroGroupFightView:_btnstartseasonOnClick()
	self:_onClickStart()
end

function Season3_0HeroGroupFightView:_btnseasonreplayOnClick()
	self:_onClickReplay()
end

function Season3_0HeroGroupFightView:_btnseasonsupercardOnClick()
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season3_0HeroGroupFightView:_groupDropValueChanged(value)
...
function Season3_0HeroGroupFightView:_editableInitView()
...
function Season3_0HeroGroupFightView:onOpen()
...
function Season3_0HeroGroupFightView:_initComponent()
...
function Season3_0HeroGroupFightView:_initData()
	...
	NavigateMgr.instance:addEscape(ViewName.Season3_0HeroGroupFightView, self._onEscapeBtnClick, self)
...
function Season3_0HeroGroupFightView:_addEvents()
...
function Season3_0HeroGroupFightView:_checkReplay()
...
function Season3_0HeroGroupFightView:_receiveRecommend(cmd, resultCode, msg)
...
function Season3_0HeroGroupFightView:_switchSnapshotSubId()
	self:_refreshMainCard()
end

function Season3_0HeroGroupFightView:_refreshMainCard()
	...
	if unlock then
		...
		if act104EquipId ~= 0 then
			if not self._superCardItem then
				self._superCardItem = Season3_0CelebrityCardItem.New()
...
function Season3_0HeroGroupFightView:_checkDropArrow()
...
function Season3_0HeroGroupFightView:_onClickReplay()
...
function Season3_0HeroGroupFightView:_switchReplayGroup(lastRelayMode)
...
function Season3_0HeroGroupFightView:_haveRecord()
	if not OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.FightReplay) then
		return false
	end
...
function Season3_0HeroGroupFightView:_updateReplayHeroGroupList()
...
function Season3_0HeroGroupFightView:_switchReplayMul()
	self._txtreplaycount.text = self._replayMode and luaLang("multiple") .. self._multiplication or ""
end

function Season3_0HeroGroupFightView:_heroMoveForward(heroId)
	HeroGroupEditListModel.instance:setMoveHeroId(tonumber(heroId))
end

function Season3_0HeroGroupFightView:isReplayMode()
	return self._replayMode
end

function Season3_0HeroGroupFightView:_onCurrencyChange(changeIds)
...
function Season3_0HeroGroupFightView:onClose()
	AudioMgr.instance:trigger(AudioEnum.UI.Stop_HeroNormalVoc)
	self:_removeEvents()
...
function Season3_0HeroGroupFightView:_removeEvents()
...
function Season3_0HeroGroupFightView:_refreshReplay()
...
function Season3_0HeroGroupFightView:_refreshCloth()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
	...
	gohelper.setActive(self._btncloth.gameObject, Season3_0HeroGroupFightView.showCloth())
end

function Season3_0HeroGroupFightView:_checkEquipClothSkill()
...
function Season3_0HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season3_0HeroGroupFightView.showCloth()
	...
	local episodeCO, battleCO = Season3_0HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season3_0HeroGroupFightView:_onModifyHeroGroup()
	self:_refreshCloth()
	self:_refreshMainCard()
end

function Season3_0HeroGroupFightView:_onModifySnapshot()
	self:_refreshCloth()
	self:_refreshMainCard()
end

function Season3_0HeroGroupFightView:_onClickHeroGroupItem(id)
	TaskDispatcher.cancelTask(self.openHeroGroupEditView, self)
...
function Season3_0HeroGroupFightView:openHeroGroupEditView()
	ViewMgr.instance:openView(ViewName.HeroGroupEditView, self._param)
end

function Season3_0HeroGroupFightView:_checkFirstPosHasEquip()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
...
function Season3_0HeroGroupFightView:_showGuideDragEffect(param)
	if self._dragEffectLoader then
		self._dragEffectLoader:dispose()
...
function Season3_0HeroGroupFightView:_onClickStart()
...
function Season3_0HeroGroupFightView:_enterFight()
...
function Season3_0HeroGroupFightView:_onUseRecommendGroup()
	if self._replayMode then
		self._replayMode = false
		self._multiplication = 1
...
function Season3_0HeroGroupFightView:_refreshBtns()
	local showDrop = not self._replayMode and self:_noAidHero()

	gohelper.setActive(self._dropseasonherogroup.gameObject, showDrop)
end

function Season3_0HeroGroupFightView:_onGetFightRecordGroupReply(fightGroupMO)
	self.removeEventCb(self, FightController.instance, FightEvent.RespGetFightRecordGroupReply, self._onGetFightRecordGroupReply, self)
...
function Season3_0HeroGroupFightView:_updateReplayHeroGroup()
	HeroGroupModel.instance:setReplayParam(self._replayFightGroupMO)
	HeroGroupController.instance:dispatchEvent(HeroGroupEvent.SelectHeroGroup, self._replayFightGroupMO.id)
	self:_refreshCloth()
	self:_refreshMainCard()
...
function Season3_0HeroGroupFightView:_playHeroGroupExitEffect()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
end

function Season3_0HeroGroupFightView:_playCloseHeroGroupAnimation()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
...
function Season3_0HeroGroupFightView:_closeHeroContainAnim()
	if self._heroContainAnim then
		self._heroContainAnim.enabled = false
	end
end

function Season3_0HeroGroupFightView:onDestroyView()
...
function Season3_0HeroGroupFightView:_noAidHero()
...
return Season3_0HeroGroupFightView
