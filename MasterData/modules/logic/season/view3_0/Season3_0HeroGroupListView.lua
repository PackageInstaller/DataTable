-- chunkname: @modules/logic/season/view3_0/Season3_0HeroGroupListView.lua

module("modules.logic.season.view3_0.Season3_0HeroGroupListView", package.seeall)

local Season3_0HeroGroupListView = class("Season3_0HeroGroupListView", BaseView)

function Season3_0HeroGroupListView:onInitView()
...
function Season3_0HeroGroupListView:_editableInitView()
	...
	for i = 1, 4 do
		...
		local item = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGO, Season3_0HeroGroupHeroItem, self)
...
function Season3_0HeroGroupListView:addEvents()
...
function Season3_0HeroGroupListView:removeEvents()
...
function Season3_0HeroGroupListView:onOpen()
	self._isOpen = true
...
function Season3_0HeroGroupListView:_playOpenAnimation()
...
function Season3_0HeroGroupListView:_checkRestrictHero()
...
function Season3_0HeroGroupListView:_removeRestrictHero()
...
function Season3_0HeroGroupListView:_onHeroGroupExit()
	...
	ViewMgr.instance:closeView(ViewName.Season3_0HeroGroupFightView, false, false)
end

function Season3_0HeroGroupListView:_closeTweenFinish(index)
...
function Season3_0HeroGroupListView:canDrag(param, isWrap)
...
function Season3_0HeroGroupListView:_onBeginDrag(param, pointerEventData)
...
function Season3_0HeroGroupListView:_onDrag(param, pointerEventData)
	if not self:canDrag(param) then
...
function Season3_0HeroGroupListView:_onEndDrag(param, pointerEventData)
	if not self:canDrag(param) then
		return
	end
...
function Season3_0HeroGroupListView:_setHeroItemPos(heroItem, index, tween, callback, callbackObj)
	local posTr = self.heroPosTrList[index]
...
function Season3_0HeroGroupListView:_tweenToPos(heroItem, anchorPos)
...
function Season3_0HeroGroupListView:_setDragEnabled(isEnabled)
	for i, drag in ipairs(self._heroItemDrag) do
		drag.enabled = isEnabled
	end
end

function Season3_0HeroGroupListView:_updateHeroList()
	for i, heroItem in ipairs(self._heroItemList) do
...
function Season3_0HeroGroupListView:_onSnapshotSaveSucc()
	self:_updateHeroList()
...
function Season3_0HeroGroupListView:_calcIndex(position)
	for i = 1, 4 do
...
function Season3_0HeroGroupListView:onDestroyView()
...
function Season3_0HeroGroupListView:_onScreenSizeChange()
	for i = 1, ModuleEnum.MaxHeroCountInGroup do
		local heroItem = self._heroItemList[i]
...
function Season3_0HeroGroupListView:getHeroItemList()
	return self._heroItemList
end

return Season3_0HeroGroupListView
