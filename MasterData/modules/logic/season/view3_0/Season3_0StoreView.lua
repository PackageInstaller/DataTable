-- chunkname: @modules/logic/season/view3_0/Season3_0StoreView.lua

module("modules.logic.season.view3_0.Season3_0StoreView", package.seeall)

local Season3_0StoreView = class("Season3_0StoreView", BaseView)

function Season3_0StoreView:onInitView()
...
function Season3_0StoreView:addEvents()
	return
end

function Season3_0StoreView:removeEvents()
	return
end

function Season3_0StoreView:_editableInitView()
...
function Season3_0StoreView:onUpdateParam()
	return
end

function Season3_0StoreView:onOpen()
...
function Season3_0StoreView:_onGet107GoodsInfo(actId)
...
function Season3_0StoreView:_onBuyGoodsSuccess(actId)
	if actId ~= self.actId then
		return
	end
...
function Season3_0StoreView:updateView()
	self:refreshStoreContent()
end

function Season3_0StoreView:refreshStoreContent()
...
function Season3_0StoreView.sortGoods(goodCo1, goodCo2)
...
function Season3_0StoreView:getItemGo(index)
...
function Season3_0StoreView:refreshTime()
...
function Season3_0StoreView:onClose()
...
function Season3_0StoreView:onDestroyView()
