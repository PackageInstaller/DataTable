-- chunkname: @modules/logic/season/view3_0/Season3_0FightSuccView.lua

module("modules.logic.season.view3_0.Season3_0FightSuccView", package.seeall)

local Season3_0FightSuccView = class("Season3_0FightSuccView", FightSuccView)

function Season3_0FightSuccView:onInitView()
...
function Season3_0FightSuccView:addEvents()
...
function Season3_0FightSuccView:removeEvents()
...
function Season3_0FightSuccView:_editableInitView()
	self._click = gohelper.getClick(self.viewGO)
end

function Season3_0FightSuccView:_onClickClose()
	if self._showEquipCard then
		return
	end

	Season3_0FightSuccView.super._onClickClose(self)
end

function Season3_0FightSuccView:onOpen()
	Season3_0FightSuccView.super.onOpen(self)
	gohelper.setActive(self._bonusItemContainer, false)
	self:_dealGetCard()
	self:_showGoal()
end

function Season3_0FightSuccView:_dealGetCard()
	local reward_list = {}
...
function Season3_0FightSuccView:_loadBonusItems()
	return
end

function Season3_0FightSuccView:_showGetCardView()
...
function Season3_0FightSuccView:_onTipsClose()
	self:_showRewardPart()
	self:_showPlayerLevelUpView()
end

function Season3_0FightSuccView:_showRewardPart()
	self._showEquipCard = nil

	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
	gohelper.setActive(self._bonusItemContainer, true)
	Season3_0FightSuccView.super._loadBonusItems(self)
end

function Season3_0FightSuccView:_onCloseViewFinish(viewName)
...
function Season3_0FightSuccView:_showChoiceCardView()
	if self._choiceCards and #self._choiceCards > 0 then
		...
		if cardUid then
			...
			Activity104Controller.instance:openSeasonEquipSelectChoiceView(param, true)
...
function Season3_0FightSuccView:_addItem(material)
...
function Season3_0FightSuccView:_setFbName(episodeCO)
...
function Season3_0FightSuccView:_showGoal()
...
function Season3_0FightSuccView:_checkTypeDetails()
	return
end

function Season3_0FightSuccView:_hideGoDemand()
	return
end

function Season3_0FightSuccView:onClose()
	...
	Season3_0FightSuccView.super.onClose(self)
end

function Season3_0FightSuccView:onDestroyView()
	Season3_0FightSuccView.super.onDestroyView(self)
end

return Season3_0FightSuccView
