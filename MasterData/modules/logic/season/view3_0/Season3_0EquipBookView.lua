-- chunkname: @modules/logic/season/view3_0/Season3_0EquipBookView.lua

module("modules.logic.season.view3_0.Season3_0EquipBookView", package.seeall)

local Season3_0EquipBookView = class("Season3_0EquipBookView", BaseView)

function Season3_0EquipBookView:onInitView()
...
function Season3_0EquipBookView:addEvents()
...
function Season3_0EquipBookView:removeEvents()
	self._btnexchange:RemoveClickListener()
	self.removeEventCb(self, Activity104EquipBookController.instance, Activity104Event.OnBookUpdateNotify, self.refreshUI, self)
	self.removeEventCb(self, Activity104EquipBookController.instance, Activity104Event.OnBookChangeSelectNotify, self.onChangeSelectCard, self)
end

function Season3_0EquipBookView:_btnexchangeOnClick()
...
function Season3_0EquipBookView:_editableInitView()
...
function Season3_0EquipBookView:onDestroyView()
...
function Season3_0EquipBookView:onOpen()
	local actId = Activity104Model.instance:getCurSeasonId()
...
function Season3_0EquipBookView:onClose()
	return
end

function Season3_0EquipBookView:refreshUI()
	self:refreshDesc()
	self:refreshIcon()
end

function Season3_0EquipBookView:refreshDesc()
...
function Season3_0EquipBookView:refreshIcon()
...
function Season3_0EquipBookView:refreshProps(itemCfg)
	local processedSet = {}
	local isDirty = false
...
function Season3_0EquipBookView:refreshSkills(itemCfg)
...
function Season3_0EquipBookView:getOrCreatePropText(index)
...
function Season3_0EquipBookView:getOrCreateSkillText(index)
...
function Season3_0EquipBookView:updateSkillText(item, skillStr, colorStr)
...
function Season3_0EquipBookView:setSkillClickCallBack(effId, clickPosition)
...
function Season3_0EquipBookView:checkCreateIcon()
	if not self._icon then
		local go = self._gocarditem

		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season3_0CelebrityCardEquip)
	end
end

function Season3_0EquipBookView:onChangeSelectCard()
	self._animatorCard:Play("switch", 0, 0)
end

function Season3_0EquipBookView:onSwitchCardAnim()
	self:refreshUI()
end

return Season3_0EquipBookView
