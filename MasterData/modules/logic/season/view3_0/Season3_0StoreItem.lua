-- chunkname: @modules/logic/season/view3_0/Season3_0StoreItem.lua

module("modules.logic.season.view3_0.Season3_0StoreItem", package.seeall)

local Season3_0StoreItem = class("Season3_0StoreItem", UserDataDispose)

function Season3_0StoreItem:ctor(go)
	self:__onInit()
...
function Season3_0StoreItem:onClick()
...
function Season3_0StoreItem:setData(data)
	self.data = data
...
function Season3_0StoreItem:refreshRemainBuyCount()
...
function Season3_0StoreItem:refreshTag()
...
function Season3_0StoreItem:getItemTypeIdQuantity(coStr)
	local attribute = string.splitToNumber(coStr, "#")

	return attribute[1], attribute[2], attribute[3]
end

function Season3_0StoreItem:destory()
