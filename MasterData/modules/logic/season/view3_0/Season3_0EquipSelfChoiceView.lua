-- chunkname: @modules/logic/season/view3_0/Season3_0EquipSelfChoiceView.lua

module("modules.logic.season.view3_0.Season3_0EquipSelfChoiceView", package.seeall)

local Season3_0EquipSelfChoiceView = class("Season3_0EquipSelfChoiceView", BaseView)

function Season3_0EquipSelfChoiceView:onInitView()
...
function Season3_0EquipSelfChoiceView:addEvents()
	...
	self.addEventCb(self, Activity104Controller.instance, Activity104Event.SelectSelfChoiceCard, self.selectSelfChoiceCard, self)
end

function Season3_0EquipSelfChoiceView:removeEvents()
	self._btnclose1:RemoveClickListener()
	self._btnok:RemoveClickListener()
	self._btnclose:RemoveClickListener()
	self.removeEventCb(self, Activity104Controller.instance, Activity104Event.SelectSelfChoiceCard, self.selectSelfChoiceCard, self)
end

function Season3_0EquipSelfChoiceView:_btnclose1OnClick()
	return
end

function Season3_0EquipSelfChoiceView:_btnokOnClick()
	Activity104EquipSelfChoiceController.instance:sendSelectCard(self.handleSendChoice, self)
end

function Season3_0EquipSelfChoiceView:_btncloseOnClick()
	self:closeThis()
end

function Season3_0EquipSelfChoiceView:_editableInitView()
	self._simagebg1:LoadImage(ResUrl.getCommonIcon("bg_leftdown"))
	self._simagebg2:LoadImage(ResUrl.getCommonIcon("bg_rightup"))
end

function Season3_0EquipSelfChoiceView:onDestroyView()
	self._simagebg1:UnLoadImage()
	self._simagebg2:UnLoadImage()
	Activity104EquipSelfChoiceController.instance:onCloseView()
end

function Season3_0EquipSelfChoiceView:onOpen()
...
function Season3_0EquipSelfChoiceView:selectSelfChoiceCard(itemId)
...
function Season3_0EquipSelfChoiceView:getOrCreateSkillText(index)
...
function Season3_0EquipSelfChoiceView:onClose()
	TaskDispatcher.cancelTask(self.closeThis, self)
end

function Season3_0EquipSelfChoiceView:delayClose()
	TaskDispatcher.runDelay(self.closeThis, self, 0.001)
end

function Season3_0EquipSelfChoiceView:handleSendChoice(cmd, resultCode, msg)
...
return Season3_0EquipSelfChoiceView
