-- chunkname: @modules/logic/season/view3_0/Season3_0HeroGroupFightViewRule.lua

module("modules.logic.season.view3_0.Season3_0HeroGroupFightViewRule", package.seeall)

local Season3_0HeroGroupFightViewRule = class("Season3_0HeroGroupFightViewRule", BaseView)

function Season3_0HeroGroupFightViewRule:onInitView()
...
function Season3_0HeroGroupFightViewRule:addEvents()
...
function Season3_0HeroGroupFightViewRule:removeEvents()
...
function Season3_0HeroGroupFightViewRule:_btncloseruleOnClick()
...
function Season3_0HeroGroupFightViewRule:_btnadditionRuleOnClick()
	self._ruleItemClick = self._goruledesc.activeSelf

	gohelper.setActive(self._goruledesc, true)
end

function Season3_0HeroGroupFightViewRule:_btnenemyOnClick()
	EnemyInfoController.instance:openEnemyInfoViewByBattleId(HeroGroupModel.instance.battleId)
end

function Season3_0HeroGroupFightViewRule:_btnAdditionRuleDetailOnClick()
...
function Season3_0HeroGroupFightViewRule:_editableInitView()
...
function Season3_0HeroGroupFightViewRule:_refreshTask()
...
function Season3_0HeroGroupFightViewRule:_refreshRules()
...
function Season3_0HeroGroupFightViewRule:_refreshAddition()
	local episodeId = HeroGroupModel.instance.episodeId
...
function Season3_0HeroGroupFightViewRule:_addRuleItem(ruleCo, targetId)
...
function Season3_0HeroGroupFightViewRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season3_0HeroGroupFightViewRule:_refreshEnemy()
	...
	elseif episodeConfig.type == DungeonEnum.EpisodeType.SeasonRetail then
		local co = SeasonConfig.instance:getSeasonRetailEpisodeCo(Activity104Model.instance:getCurSeasonId(), episodeId)

		level = co and co.level or 0
...
function Season3_0HeroGroupFightViewRule:_recommendCareer()
...
function Season3_0HeroGroupFightViewRule:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season3_0HeroGroupFightViewRule:_onEnemyItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")
...
function Season3_0HeroGroupFightViewRule:onClose()
	self.removeEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._recommendCareer, self)
end

function Season3_0HeroGroupFightViewRule:onDestroyView()
	return
end

return Season3_0HeroGroupFightViewRule
