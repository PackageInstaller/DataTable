-- chunkname: @modules/logic/season/view3_0/Season3_0CelebrityCardTipView.lua

module("modules.logic.season.view3_0.Season3_0CelebrityCardTipView", package.seeall)

local Season3_0CelebrityCardTipView = class("Season3_0CelebrityCardTipView", BaseView)

function Season3_0CelebrityCardTipView:onInitView()
...
function Season3_0CelebrityCardTipView:addEvents()
...
function Season3_0CelebrityCardTipView:removeEvents()
...
function Season3_0CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season3_0CelebrityCardTipView:onClickGMAdd(count)
...
function Season3_0CelebrityCardTipView:_btninputOnClick()
...
function Season3_0CelebrityCardTipView:_editableInitView()
...
function Season3_0CelebrityCardTipView:onDestroyView()
...
function Season3_0CelebrityCardTipView:onOpen()
...
function Season3_0CelebrityCardTipView:onClose()
	return
end

function Season3_0CelebrityCardTipView:refreshUI()
...
function Season3_0CelebrityCardTipView:refreshQuantity()
...
function Season3_0CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season3_0CelebrityCardTipView:refreshSkills()
	...
	for index, skillStr in ipairs(skillList) do
		...
		local skillDesc = HeroSkillModel.instance:skillDesToSpot(skillStr)

		item.txtDesc.text = SkillHelper.addLink(skillDesc)
...
function Season3_0CelebrityCardTipView:checkCreateIcon()
...
function Season3_0CelebrityCardTipView:getOrCreatePropText(index)
...
function Season3_0CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season3_0CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season3_0CelebrityCardTipView
