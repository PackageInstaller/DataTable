-- chunkname: @modules/logic/season/view3_0/Season3_0EquipHeroView.lua

module("modules.logic.season.view3_0.Season3_0EquipHeroView", package.seeall)

local Season3_0EquipHeroView = class("Season3_0EquipHeroView", BaseView)

function Season3_0EquipHeroView:onInitView()
...
function Season3_0EquipHeroView:addEvents()
...
function Season3_0EquipHeroView:onDestroyView()
...
function Season3_0EquipHeroView:onOpen()
...
function Season3_0EquipHeroView:onClose()
	return
end

function Season3_0EquipHeroView:refreshUI()
...
function Season3_0EquipHeroView:handleEquipUpdate()
	self:refreshDescGroup()
	self:refreshSlots()
end

function Season3_0EquipHeroView:refreshSlots()
	for slotIndex = 1, Activity104EquipItemListModel.HeroMaxPos do
		self:refreshSlot(slotIndex)
	end
end

function Season3_0EquipHeroView:refreshSlot(slotIndex)
...
function Season3_0EquipHeroView:refreshDescGroup()
...
function Season3_0EquipHeroView:refreshDesc(descItem, itemUid)
	if itemUid == Activity104EquipItemListModel.EmptyUid then
...
function Season3_0EquipHeroView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season3_0EquipHeroView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season3_0EquipHeroView:getOrCreatePropText(index, descItem)
...
function Season3_0EquipHeroView:getOrCreateSkillText(index, descItem)
...
function Season3_0EquipHeroView:getOrCreateSlot(slotIndex)
...
function Season3_0EquipHeroView:getOrCreateSlotIcon(slotItem)
	...
	if not icon then
		...
		icon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season3_0CelebrityCardEquip)
		slotItem.icon = icon
	end
...
function Season3_0EquipHeroView:getOrCreateDesc()
...
function Season3_0EquipHeroView:handleSaveSucc(snapshotId)
...
function Season3_0EquipHeroView:handleSwitchAnimFrame()
	logNormal("refresh by switch anim frame")
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season3_0EquipHeroView:handleEquipCardChanged(param)
	self._animator:Play("switch", 0, 0)
end

function Season3_0EquipHeroView:_btnequipOnClick()
