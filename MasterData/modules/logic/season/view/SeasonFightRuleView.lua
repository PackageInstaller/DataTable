-- chunkname: @modules/logic/season/view/SeasonFightRuleView.lua

module("modules.logic.season.view.SeasonFightRuleView", package.seeall)

local SeasonFightRuleView = class("SeasonFightRuleView", BaseView)

function SeasonFightRuleView:onInitView()
...
function SeasonFightRuleView:addEvents()
	return
end

function SeasonFightRuleView:removeEvents()
	return
end

function SeasonFightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function SeasonFightRuleView:onOpen()
	self:refreshRule()
end

function SeasonFightRuleView:refreshRule()
	local dataList = SeasonFightRuleView.getRuleList() or {}
...
function SeasonFightRuleView:createItem(index)
	local item = {}
...
function SeasonFightRuleView:updateItem(item, data)
...
function SeasonFightRuleView:destroyItem(item)
	return
end

function SeasonFightRuleView.getRuleList()
...
function SeasonFightRuleView:setDecorateVisible(isVisible)
...
function SeasonFightRuleView:onClose()
	return
end

function SeasonFightRuleView:onDestroyView()
