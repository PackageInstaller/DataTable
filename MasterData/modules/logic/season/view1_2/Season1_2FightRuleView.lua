-- chunkname: @modules/logic/season/view1_2/Season1_2FightRuleView.lua

module("modules.logic.season.view1_2.Season1_2FightRuleView", package.seeall)

local Season1_2FightRuleView = class("Season1_2FightRuleView", BaseView)

function Season1_2FightRuleView:onInitView()
...
function Season1_2FightRuleView:addEvents()
	return
end

function Season1_2FightRuleView:removeEvents()
	return
end

function Season1_2FightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function Season1_2FightRuleView:onOpen()
	self:refreshRule()
end

function Season1_2FightRuleView:refreshRule()
	local dataList = Season1_2FightRuleView.getRuleList() or {}
...
function Season1_2FightRuleView:createItem(index)
	local item = {}
...
function Season1_2FightRuleView:updateItem(item, data)
...
function Season1_2FightRuleView:destroyItem(item)
	return
end

function Season1_2FightRuleView.getRuleList()
...
function Season1_2FightRuleView:setDecorateVisible(isVisible)
...
function Season1_2FightRuleView:onClose()
	return
end

function Season1_2FightRuleView:onDestroyView()
