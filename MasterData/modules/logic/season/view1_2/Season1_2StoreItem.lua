-- chunkname: @modules/logic/season/view1_2/Season1_2StoreItem.lua

module("modules.logic.season.view1_2.Season1_2StoreItem", package.seeall)

local Season1_2StoreItem = class("Season1_2StoreItem", UserDataDispose)

function Season1_2StoreItem:ctor(go)
	self:__onInit()
...
function Season1_2StoreItem:onClick()
...
function Season1_2StoreItem:setData(data)
	self.data = data
...
function Season1_2StoreItem:refreshRemainBuyCount()
...
function Season1_2StoreItem:refreshTag()
...
function Season1_2StoreItem:getItemTypeIdQuantity(coStr)
	local attribute = string.splitToNumber(coStr, "#")

	return attribute[1], attribute[2], attribute[3]
end

function Season1_2StoreItem:destory()
