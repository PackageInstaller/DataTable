-- chunkname: @modules/logic/season/view1_2/Season1_2EquipSelfChoiceView.lua

module("modules.logic.season.view1_2.Season1_2EquipSelfChoiceView", package.seeall)

local Season1_2EquipSelfChoiceView = class("Season1_2EquipSelfChoiceView", BaseView)

function Season1_2EquipSelfChoiceView:onInitView()
...
function Season1_2EquipSelfChoiceView:addEvents()
...
function Season1_2EquipSelfChoiceView:removeEvents()
...
function Season1_2EquipSelfChoiceView:_btnclose1OnClick()
	return
end

function Season1_2EquipSelfChoiceView:_btnokOnClick()
	Activity104EquipSelfChoiceController.instance:sendSelectCard(self.handleSendChoice, self)
end

function Season1_2EquipSelfChoiceView:_btncloseOnClick()
	self:closeThis()
end

function Season1_2EquipSelfChoiceView:_editableInitView()
	self._simagebg1:LoadImage(ResUrl.getCommonIcon("bg_leftdown"))
	self._simagebg2:LoadImage(ResUrl.getCommonIcon("bg_rightup"))
end

function Season1_2EquipSelfChoiceView:onDestroyView()
	self._simagebg1:UnLoadImage()
	self._simagebg2:UnLoadImage()
	Activity104EquipSelfChoiceController.instance:onCloseView()
end

function Season1_2EquipSelfChoiceView:onOpen()
...
function Season1_2EquipSelfChoiceView:selectSelfChoiceCard(itemId)
...
function Season1_2EquipSelfChoiceView:getOrCreateSkillText(index)
...
function Season1_2EquipSelfChoiceView:onClose()
	TaskDispatcher.cancelTask(self.closeThis, self)
end

function Season1_2EquipSelfChoiceView:delayClose()
	TaskDispatcher.runDelay(self.closeThis, self, 0.001)
end

function Season1_2EquipSelfChoiceView:handleSendChoice(cmd, resultCode, msg)
...
return Season1_2EquipSelfChoiceView
