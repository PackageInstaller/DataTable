-- chunkname: @modules/logic/season/view1_2/Season1_2SpecialMarketView.lua

module("modules.logic.season.view1_2.Season1_2SpecialMarketView", package.seeall)

local Season1_2SpecialMarketView = class("Season1_2SpecialMarketView", BaseView)

function Season1_2SpecialMarketView:onInitView()
...
function Season1_2SpecialMarketView:addEvents()
...
function Season1_2SpecialMarketView:removeEvents()
...
function Season1_2SpecialMarketView:_onBattleReply(msg)
	Activity104Model.instance:onStartAct104BattleReply(msg)
end

function Season1_2SpecialMarketView:_btnlvstartOnClick()
	gohelper.setActive(self._goinfo, true)
	gohelper.setActive(self._golevel, false)
	self:_refreshInfo()
end

function Season1_2SpecialMarketView:_btnlastOnClick()
...
function Season1_2SpecialMarketView:_btnnextOnClick()
...
function Season1_2SpecialMarketView:_btnstartOnClick()
...
function Season1_2SpecialMarketView:_btnclickOnClick()
	return
end

function Season1_2SpecialMarketView:_editableInitView()
...
function Season1_2SpecialMarketView:onUpdateParam()
	return
end

function Season1_2SpecialMarketView:onOpen()
...
function Season1_2SpecialMarketView:onClose()
	self.removeEventCb(self, Activity104Controller.instance, Activity104Event.SwitchSpecialEpisode, self._onSwitchEpisode, self)
end

function Season1_2SpecialMarketView:_onSwitchEpisode(layer)
	self._layer = layer

	self:_refreshLevel()
end

function Season1_2SpecialMarketView:_refreshLevel()
	...
	for i = 1, maxSpecialLayer do
		if not self._showLvItems[i] then
			...
			self._showLvItems[i] = Season1_2SpecialMarketShowLevelItem.New()
	...
	self._simageleveldecorate:LoadImage(ResUrl.getV1A2SeasonIcon("icon/" .. spEpisodeCo.icon .. ".png"))
end

function Season1_2SpecialMarketView:_refreshInfo()
	local spEpisodeCo = SeasonConfig.instance:getSeasonSpecialCo(Activity104Model.instance:getCurSeasonId(), self._layer)
	...
	self._simagestageicon:LoadImage(ResUrl.getV1A2SeasonIcon(string.format("icon/ct_%s.png", spEpisodeCo.icon)))
...
function Season1_2SpecialMarketView:createRewardItem(index)
...
function Season1_2SpecialMarketView:refreshRewardItem(item, itemCo)
	if not itemCo then
...
function Season1_2SpecialMarketView:updateLeftDesc()
...
function Season1_2SpecialMarketView:createLeftDescItem(index)
	local item = self:getUserDataTb_()
...
function Season1_2SpecialMarketView:updateLeftDescItem(item, co)
	if not co then
		gohelper.setActive(item.go, false)
...
function Season1_2SpecialMarketView:moveToCurDesc()
...
function Season1_2SpecialMarketView:onDestroyView()
	TaskDispatcher.cancelTask(self.moveToCurDesc, self)
...
return Season1_2SpecialMarketView
