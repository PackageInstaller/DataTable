-- chunkname: @modules/logic/season/view1_2/Season1_2CelebrityCardTipView.lua

module("modules.logic.season.view1_2.Season1_2CelebrityCardTipView", package.seeall)

local Season1_2CelebrityCardTipView = class("Season1_2CelebrityCardTipView", BaseView)

function Season1_2CelebrityCardTipView:onInitView()
...
function Season1_2CelebrityCardTipView:addEvents()
...
function Season1_2CelebrityCardTipView:removeEvents()
...
function Season1_2CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season1_2CelebrityCardTipView:onClickGMAdd(count)
...
function Season1_2CelebrityCardTipView:_btninputOnClick()
...
function Season1_2CelebrityCardTipView:_editableInitView()
...
function Season1_2CelebrityCardTipView:onDestroyView()
...
function Season1_2CelebrityCardTipView:onOpen()
...
function Season1_2CelebrityCardTipView:onClose()
	return
end

function Season1_2CelebrityCardTipView:refreshUI()
...
function Season1_2CelebrityCardTipView:refreshQuantity()
	if self.viewParam.needQuantity then
		gohelper.setActive(self._goquantity, true)

		local numStr

		self._txthadnumber.text = formatLuaLang("materialtipview_itemquantity", self.viewParam.fakeQuantity and tostring(self.viewParam.fakeQuantity) or self._activityId and tostring(GameUtil.numberDisplay(SeasonEquipMetaUtils.getEquipCount(self._activityId, self._itemId))) or tostring(SeasonEquipMetaUtils.getCurSeasonEquipCount(self._itemId)))
	else
		gohelper.setActive(self._goquantity, false)
	end
end

function Season1_2CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season1_2CelebrityCardTipView:refreshSkills()
...
function Season1_2CelebrityCardTipView:checkCreateIcon()
...
function Season1_2CelebrityCardTipView:getOrCreatePropText(index)
...
function Season1_2CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season1_2CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season1_2CelebrityCardTipView
