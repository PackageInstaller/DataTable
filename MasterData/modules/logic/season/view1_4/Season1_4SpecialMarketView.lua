-- chunkname: @modules/logic/season/view1_4/Season1_4SpecialMarketView.lua

module("modules.logic.season.view1_4.Season1_4SpecialMarketView", package.seeall)

local Season1_4SpecialMarketView = class("Season1_4SpecialMarketView", BaseView)

function Season1_4SpecialMarketView:onInitView()
...
function Season1_4SpecialMarketView:addEvents()
...
function Season1_4SpecialMarketView:removeEvents()
...
function Season1_4SpecialMarketView:_onBattleReply(msg)
	Activity104Model.instance:onStartAct104BattleReply(msg)
end

function Season1_4SpecialMarketView:_btnlvstartOnClick()
	gohelper.setActive(self._goinfo, true)
	gohelper.setActive(self._golevel, false)
	self:_refreshInfo()
end

function Season1_4SpecialMarketView:_btnlastOnClick()
...
function Season1_4SpecialMarketView:_btnnextOnClick()
...
function Season1_4SpecialMarketView:_btnstartOnClick()
...
function Season1_4SpecialMarketView:_btnclickOnClick()
	return
end

function Season1_4SpecialMarketView:_editableInitView()
...
function Season1_4SpecialMarketView:onUpdateParam()
	return
end

function Season1_4SpecialMarketView:onOpen()
...
function Season1_4SpecialMarketView:onClose()
	self.removeEventCb(self, Activity104Controller.instance, Activity104Event.SwitchSpecialEpisode, self._onSwitchEpisode, self)
end

function Season1_4SpecialMarketView:_onSwitchEpisode(layer)
	self._layer = layer

	self:_refreshLevel()
end

function Season1_4SpecialMarketView:_refreshLevel()
	...
	for i = 1, maxSpecialLayer do
		if not self._showLvItems[i] then
			...
			self._showLvItems[i] = Season1_4SpecialMarketShowLevelItem.New()
...
function Season1_4SpecialMarketView:_refreshInfo()
	local spEpisodeCo = SeasonConfig.instance:getSeasonSpecialCo(Activity104Model.instance:getCurSeasonId(), self._layer)
...
function Season1_4SpecialMarketView:createRewardItem(index)
...
function Season1_4SpecialMarketView:refreshRewardItem(item, itemCo)
	if not itemCo then
...
function Season1_4SpecialMarketView:updateLeftDesc()
...
function Season1_4SpecialMarketView:createLeftDescItem(index)
	local item = self:getUserDataTb_()
...
function Season1_4SpecialMarketView:updateLeftDescItem(item, co)
	if not co then
		gohelper.setActive(item.go, false)
...
function Season1_4SpecialMarketView:moveToCurDesc()
...
function Season1_4SpecialMarketView:onDestroyView()
	TaskDispatcher.cancelTask(self.moveToCurDesc, self)
...
return Season1_4SpecialMarketView
