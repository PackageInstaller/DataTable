-- chunkname: @modules/logic/season/view1_4/Season1_4SumView.lua

module("modules.logic.season.view1_4.Season1_4SumView", package.seeall)

local Season1_4SumView = class("Season1_4SumView", BaseView)

function Season1_4SumView:onInitView()
...
function Season1_4SumView:_editableInitView()
...
function Season1_4SumView:_onClickClose()
	if self.inMail then
...
function Season1_4SumView:showReviewView(isSwitch)
	self.inMail = false
...
function Season1_4SumView:refreshChapter(index, data, dataCount)
...
function Season1_4SumView:refreshCard(index, equipId)
	...
	if not item.cardItem then
		item.cardItem = Season1_4CelebrityCardItem.New()
...
function Season1_4SumView:hideMail()
	gohelper.setActive(self.mailRoot, false)
end

function Season1_4SumView:onDestroyView()
