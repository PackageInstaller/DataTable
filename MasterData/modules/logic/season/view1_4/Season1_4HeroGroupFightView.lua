-- chunkname: @modules/logic/season/view1_4/Season1_4HeroGroupFightView.lua

module("modules.logic.season.view1_4.Season1_4HeroGroupFightView", package.seeall)

local Season1_4HeroGroupFightView = class("Season1_4HeroGroupFightView", BaseView)

function Season1_4HeroGroupFightView:onInitView()
...
function Season1_4HeroGroupFightView:addEvents()
...
function Season1_4HeroGroupFightView:removeEvents()
...
function Season1_4HeroGroupFightView:_setTrialNumTips()
	local _, battleCO = Season1_4HeroGroupFightView._getEpisodeConfigAndBattleConfig()
	local tips = {}
...
function Season1_4HeroGroupFightView:_onTouch()
...
function Season1_4HeroGroupFightView:_setTrialTipsTxt(obj, data, index)
	gohelper.findChildTextMesh(obj, "desc").text = data
end

function Season1_4HeroGroupFightView:_switchTrialTips()
...
function Season1_4HeroGroupFightView:_btnrecommendOnClick()
...
function Season1_4HeroGroupFightView:_btnclothOnClock()
...
function Season1_4HeroGroupFightView:_btnrestrainOnClick()
	ViewMgr.instance:openView(ViewName.HeroGroupCareerTipView)
end

function Season1_4HeroGroupFightView:_btnstartseasonOnClick()
	for i = 1, 10 do
		self:_onClickStart()
	end
end

function Season1_4HeroGroupFightView:_btnseasonreplayOnClick()
	self:_onClickReplay()
end

function Season1_4HeroGroupFightView:_btnseasonsupercardOnClick()
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season1_4HeroGroupFightView:_groupDropValueChanged(value)
...
function Season1_4HeroGroupFightView:_editableInitView()
...
function Season1_4HeroGroupFightView:onOpen()
...
function Season1_4HeroGroupFightView:_initComponent()
...
function Season1_4HeroGroupFightView:_initData()
	...
	NavigateMgr.instance:addEscape(ViewName.Season1_4HeroGroupFightView, self._onEscapeBtnClick, self)
...
function Season1_4HeroGroupFightView:_addEvents()
...
function Season1_4HeroGroupFightView:_checkReplay()
...
function Season1_4HeroGroupFightView:_receiveRecommend(cmd, resultCode, msg)
...
function Season1_4HeroGroupFightView:_switchSnapshotSubId()
	self:_refreshMainCard()
end

function Season1_4HeroGroupFightView:_refreshMainCard()
	...
	if unlock then
		...
		if act104EquipId ~= 0 then
			if not self._superCardItem then
				self._superCardItem = Season1_4CelebrityCardItem.New()
...
function Season1_4HeroGroupFightView:_checkDropArrow()
...
function Season1_4HeroGroupFightView:_onClickReplay()
...
function Season1_4HeroGroupFightView:_switchReplayGroup(lastRelayMode)
...
function Season1_4HeroGroupFightView:_haveRecord()
	if not OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.FightReplay) then
		return false
	end
...
function Season1_4HeroGroupFightView:_updateReplayHeroGroupList()
...
function Season1_4HeroGroupFightView:_switchReplayMul()
	self._txtreplaycount.text = self._replayMode and luaLang("multiple") .. self._multiplication or ""
end

function Season1_4HeroGroupFightView:_heroMoveForward(heroId)
	HeroGroupEditListModel.instance:setMoveHeroId(tonumber(heroId))
end

function Season1_4HeroGroupFightView:isReplayMode()
	return self._replayMode
end

function Season1_4HeroGroupFightView:_onCurrencyChange(changeIds)
...
function Season1_4HeroGroupFightView:onClose()
	AudioMgr.instance:trigger(AudioEnum.UI.Stop_HeroNormalVoc)
	self:_removeEvents()
...
function Season1_4HeroGroupFightView:_removeEvents()
...
function Season1_4HeroGroupFightView:_refreshReplay()
...
function Season1_4HeroGroupFightView:_refreshCloth()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
	...
	gohelper.setActive(self._btncloth.gameObject, Season1_4HeroGroupFightView.showCloth())
end

function Season1_4HeroGroupFightView:_checkEquipClothSkill()
...
function Season1_4HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season1_4HeroGroupFightView.showCloth()
	...
	local episodeCO, battleCO = Season1_4HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season1_4HeroGroupFightView:_onModifyHeroGroup()
	self:_refreshCloth()
	self:_refreshMainCard()
end

function Season1_4HeroGroupFightView:_onModifySnapshot()
	self:_refreshCloth()
	self:_refreshMainCard()
end

function Season1_4HeroGroupFightView:_onClickHeroGroupItem(id)
	TaskDispatcher.cancelTask(self.openHeroGroupEditView, self)
...
function Season1_4HeroGroupFightView:openHeroGroupEditView()
	ViewMgr.instance:openView(ViewName.HeroGroupEditView, self._param)
end

function Season1_4HeroGroupFightView:_checkFirstPosHasEquip()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
...
function Season1_4HeroGroupFightView:_showGuideDragEffect(param)
	if self._dragEffectLoader then
		self._dragEffectLoader:dispose()
...
function Season1_4HeroGroupFightView:_onClickStart()
...
function Season1_4HeroGroupFightView:_enterFight()
...
function Season1_4HeroGroupFightView:_onUseRecommendGroup()
	if self._replayMode then
		self._replayMode = false
		self._multiplication = 1
...
function Season1_4HeroGroupFightView:_refreshBtns()
	local showDrop = not self._replayMode and self:_noAidHero()

	gohelper.setActive(self._dropseasonherogroup.gameObject, showDrop)
end

function Season1_4HeroGroupFightView:_onGetFightRecordGroupReply(fightGroupMO)
	self.removeEventCb(self, FightController.instance, FightEvent.RespGetFightRecordGroupReply, self._onGetFightRecordGroupReply, self)
...
function Season1_4HeroGroupFightView:_updateReplayHeroGroup()
	HeroGroupModel.instance:setReplayParam(self._replayFightGroupMO)
	HeroGroupController.instance:dispatchEvent(HeroGroupEvent.SelectHeroGroup, self._replayFightGroupMO.id)
	self:_refreshCloth()
	self:_refreshMainCard()
...
function Season1_4HeroGroupFightView:_playHeroGroupExitEffect()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
end

function Season1_4HeroGroupFightView:_playCloseHeroGroupAnimation()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
...
function Season1_4HeroGroupFightView:_closeHeroContainAnim()
	if self._heroContainAnim then
		self._heroContainAnim.enabled = false
	end
end

function Season1_4HeroGroupFightView:onDestroyView()
...
function Season1_4HeroGroupFightView:_noAidHero()
...
return Season1_4HeroGroupFightView
