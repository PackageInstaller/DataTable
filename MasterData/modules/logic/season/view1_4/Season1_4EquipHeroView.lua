-- chunkname: @modules/logic/season/view1_4/Season1_4EquipHeroView.lua

module("modules.logic.season.view1_4.Season1_4EquipHeroView", package.seeall)

local Season1_4EquipHeroView = class("Season1_4EquipHeroView", BaseView)

function Season1_4EquipHeroView:onInitView()
...
function Season1_4EquipHeroView:addEvents()
...
function Season1_4EquipHeroView:onDestroyView()
...
function Season1_4EquipHeroView:onOpen()
...
function Season1_4EquipHeroView:onClose()
	return
end

function Season1_4EquipHeroView:refreshUI()
...
function Season1_4EquipHeroView:handleEquipUpdate()
	self:refreshDescGroup()
	self:refreshSlots()
end

function Season1_4EquipHeroView:refreshSlots()
	for slotIndex = 1, Activity104EquipItemListModel.HeroMaxPos do
		self:refreshSlot(slotIndex)
	end
end

function Season1_4EquipHeroView:refreshSlot(slotIndex)
...
function Season1_4EquipHeroView:refreshDescGroup()
...
function Season1_4EquipHeroView:refreshDesc(descItem, itemUid)
	if itemUid == Activity104EquipItemListModel.EmptyUid then
...
function Season1_4EquipHeroView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season1_4EquipHeroView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season1_4EquipHeroView:getOrCreatePropText(index, descItem)
...
function Season1_4EquipHeroView:getOrCreateSkillText(index, descItem)
...
function Season1_4EquipHeroView:getOrCreateSlot(slotIndex)
...
function Season1_4EquipHeroView:getOrCreateSlotIcon(slotItem)
...
function Season1_4EquipHeroView:getOrCreateDesc()
...
function Season1_4EquipHeroView:handleSaveSucc(snapshotId)
...
function Season1_4EquipHeroView:handleSwitchAnimFrame()
	logNormal("refresh by switch anim frame")
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season1_4EquipHeroView:handleEquipCardChanged(param)
	self._animator:Play("switch", 0, 0)
end

function Season1_4EquipHeroView:_btnequipOnClick()
