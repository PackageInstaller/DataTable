-- chunkname: @modules/logic/season/view1_4/Season1_4StoreItem.lua

module("modules.logic.season.view1_4.Season1_4StoreItem", package.seeall)

local Season1_4StoreItem = class("Season1_4StoreItem", UserDataDispose)

function Season1_4StoreItem:ctor(go)
	self:__onInit()
...
function Season1_4StoreItem:onClick()
...
function Season1_4StoreItem:setData(data)
	self.data = data
...
function Season1_4StoreItem:refreshRemainBuyCount()
...
function Season1_4StoreItem:refreshTag()
...
function Season1_4StoreItem:getItemTypeIdQuantity(coStr)
	local attribute = string.splitToNumber(coStr, "#")

	return attribute[1], attribute[2], attribute[3]
end

function Season1_4StoreItem:destory()
