-- chunkname: @modules/logic/season/view1_4/Season1_4EquipSpineView.lua

module("modules.logic.season.view1_4.Season1_4EquipSpineView", package.seeall)

local Season1_4EquipSpineView = class("Season1_4EquipSpineView", BaseView)

function Season1_4EquipSpineView:onInitView()
...
function Season1_4EquipSpineView:addEvents()
	return
end

function Season1_4EquipSpineView:removeEvents()
	return
end

function Season1_4EquipSpineView:_editableInitView()
	self._uiSpine = GuiModelAgent.Create(self._gospine, true)

	self:createSpine()
end

function Season1_4EquipSpineView:onDestroyView()
...
function Season1_4EquipSpineView:onOpen()
	self:refreshHeroSkin()
end

function Season1_4EquipSpineView:onClose()
	if self._uiSpine then
		self._uiSpine:setModelVisible(false)
	end
end

function Season1_4EquipSpineView:createSpine(skinConfig)
	if skinConfig then
		self._uiSpine:useRT()
...
function Season1_4EquipSpineView:refreshHeroSkin()
...
function Season1_4EquipSpineView:onSpineLoaded()
	self._spineLoaded = true

	self._uiSpine:setUIMask(true)
end

return Season1_4EquipSpineView
