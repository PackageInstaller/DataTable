-- chunkname: @modules/logic/season/view1_6/Season1_6StoreItem.lua

module("modules.logic.season.view1_6.Season1_6StoreItem", package.seeall)

local Season1_6StoreItem = class("Season1_6StoreItem", UserDataDispose)

function Season1_6StoreItem:ctor(go)
	self:__onInit()
...
function Season1_6StoreItem:onClick()
...
function Season1_6StoreItem:setData(data)
	self.data = data
...
function Season1_6StoreItem:refreshRemainBuyCount()
...
function Season1_6StoreItem:refreshTag()
...
function Season1_6StoreItem:getItemTypeIdQuantity(coStr)
	local attribute = string.splitToNumber(coStr, "#")

	return attribute[1], attribute[2], attribute[3]
end

function Season1_6StoreItem:destory()
