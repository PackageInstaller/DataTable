-- chunkname: @modules/logic/season/view1_6/Season1_6HeroFightViewLevel.lua

module("modules.logic.season.view1_6.Season1_6HeroFightViewLevel", package.seeall)

local Season1_6HeroFightViewLevel = class("Season1_6HeroFightViewLevel", BaseView)

function Season1_6HeroFightViewLevel:onInitView()
...
function Season1_6HeroFightViewLevel:addEvents()
	return
end

function Season1_6HeroFightViewLevel:removeEvents()
	return
end

function Season1_6HeroFightViewLevel:_editableInitView()
	self._monsterGroupItemList = {}
end

function Season1_6HeroFightViewLevel:_refreshUI()
...
function Season1_6HeroFightViewLevel:_refreshTarget()
...
function Season1_6HeroFightViewLevel:_initStars()
...
function Season1_6HeroFightViewLevel:_showStar(episodeInfo, advancedConditionText, passNormal, passAdvanced, passUltra)
	self:_initStars()
...
function Season1_6HeroFightViewLevel:_setStar(image, light, double)
...
function Season1_6HeroFightViewLevel:onOpen()
	self:_refreshUI()
end

function Season1_6HeroFightViewLevel:onClose()
	return
end

function Season1_6HeroFightViewLevel:onDestroyView()
	return
end

return Season1_6HeroFightViewLevel
