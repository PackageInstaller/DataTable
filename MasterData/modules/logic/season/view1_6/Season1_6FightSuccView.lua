-- chunkname: @modules/logic/season/view1_6/Season1_6FightSuccView.lua

module("modules.logic.season.view1_6.Season1_6FightSuccView", package.seeall)

local Season1_6FightSuccView = class("Season1_6FightSuccView", FightSuccView)

function Season1_6FightSuccView:onInitView()
...
function Season1_6FightSuccView:addEvents()
...
function Season1_6FightSuccView:removeEvents()
...
function Season1_6FightSuccView:_editableInitView()
	self._click = gohelper.getClick(self.viewGO)
end

function Season1_6FightSuccView:_onClickClose()
	if self._showEquipCard then
		return
	end

	Season1_6FightSuccView.super._onClickClose(self)
end

function Season1_6FightSuccView:onOpen()
	Season1_6FightSuccView.super.onOpen(self)
	gohelper.setActive(self._bonusItemContainer, false)
	self:_dealGetCard()
	self:_showGoal()
end

function Season1_6FightSuccView:_dealGetCard()
	local reward_list = {}
...
function Season1_6FightSuccView:_loadBonusItems()
	return
end

function Season1_6FightSuccView:_showGetCardView()
...
function Season1_6FightSuccView:_onTipsClose()
	self:_showRewardPart()
	self:_showPlayerLevelUpView()
end

function Season1_6FightSuccView:_showRewardPart()
	self._showEquipCard = nil

	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
	gohelper.setActive(self._bonusItemContainer, true)
	Season1_6FightSuccView.super._loadBonusItems(self)
end

function Season1_6FightSuccView:_onCloseViewFinish(viewName)
...
function Season1_6FightSuccView:_showChoiceCardView()
...
function Season1_6FightSuccView:_addItem(material)
...
function Season1_6FightSuccView:_setFbName(episodeCO)
...
function Season1_6FightSuccView:_showGoal()
...
function Season1_6FightSuccView:_checkTypeDetails()
	return
end

function Season1_6FightSuccView:_hideGoDemand()
	return
end

function Season1_6FightSuccView:onClose()
	...
	Season1_6FightSuccView.super.onClose(self)
end

function Season1_6FightSuccView:onDestroyView()
	Season1_6FightSuccView.super.onDestroyView(self)
end

return Season1_6FightSuccView
