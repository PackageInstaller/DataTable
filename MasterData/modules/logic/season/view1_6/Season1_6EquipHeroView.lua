-- chunkname: @modules/logic/season/view1_6/Season1_6EquipHeroView.lua

module("modules.logic.season.view1_6.Season1_6EquipHeroView", package.seeall)

local Season1_6EquipHeroView = class("Season1_6EquipHeroView", BaseView)

function Season1_6EquipHeroView:onInitView()
...
function Season1_6EquipHeroView:addEvents()
...
function Season1_6EquipHeroView:onDestroyView()
...
function Season1_6EquipHeroView:onOpen()
...
function Season1_6EquipHeroView:onClose()
	return
end

function Season1_6EquipHeroView:refreshUI()
...
function Season1_6EquipHeroView:handleEquipUpdate()
	self:refreshDescGroup()
	self:refreshSlots()
end

function Season1_6EquipHeroView:refreshSlots()
	for slotIndex = 1, Activity104EquipItemListModel.HeroMaxPos do
		self:refreshSlot(slotIndex)
	end
end

function Season1_6EquipHeroView:refreshSlot(slotIndex)
...
function Season1_6EquipHeroView:refreshDescGroup()
...
function Season1_6EquipHeroView:refreshDesc(descItem, itemUid)
	if itemUid == Activity104EquipItemListModel.EmptyUid then
...
function Season1_6EquipHeroView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season1_6EquipHeroView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season1_6EquipHeroView:getOrCreatePropText(index, descItem)
...
function Season1_6EquipHeroView:getOrCreateSkillText(index, descItem)
...
function Season1_6EquipHeroView:getOrCreateSlot(slotIndex)
...
function Season1_6EquipHeroView:getOrCreateSlotIcon(slotItem)
...
function Season1_6EquipHeroView:getOrCreateDesc()
...
function Season1_6EquipHeroView:handleSaveSucc(snapshotId)
...
function Season1_6EquipHeroView:handleSwitchAnimFrame()
	logNormal("refresh by switch anim frame")
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season1_6EquipHeroView:handleEquipCardChanged(param)
	self._animator:Play("switch", 0, 0)
end

function Season1_6EquipHeroView:_btnequipOnClick()
