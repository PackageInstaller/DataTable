-- chunkname: @modules/logic/season/view1_6/Season1_6SpecialMarketView.lua

module("modules.logic.season.view1_6.Season1_6SpecialMarketView", package.seeall)

local Season1_6SpecialMarketView = class("Season1_6SpecialMarketView", BaseView)

function Season1_6SpecialMarketView:onInitView()
...
function Season1_6SpecialMarketView:addEvents()
...
function Season1_6SpecialMarketView:removeEvents()
...
function Season1_6SpecialMarketView:_onBattleReply(msg)
	Activity104Model.instance:onStartAct104BattleReply(msg)
end

function Season1_6SpecialMarketView:_btnlvstartOnClick()
	gohelper.setActive(self._goinfo, true)
	gohelper.setActive(self._golevel, false)
	self:_refreshInfo()
end

function Season1_6SpecialMarketView:_btnlastOnClick()
...
function Season1_6SpecialMarketView:_btnnextOnClick()
...
function Season1_6SpecialMarketView:_btnstartOnClick()
...
function Season1_6SpecialMarketView:_btnclickOnClick()
	return
end

function Season1_6SpecialMarketView:_editableInitView()
...
function Season1_6SpecialMarketView:onUpdateParam()
	return
end

function Season1_6SpecialMarketView:onOpen()
...
function Season1_6SpecialMarketView:onClose()
	self.removeEventCb(self, Activity104Controller.instance, Activity104Event.SwitchSpecialEpisode, self._onSwitchEpisode, self)
end

function Season1_6SpecialMarketView:_onSwitchEpisode(layer)
	self._layer = layer

	self:_refreshLevel()
end

function Season1_6SpecialMarketView:_refreshLevel()
	...
	for i = 1, maxSpecialLayer do
		if not self._showLvItems[i] then
			...
			self._showLvItems[i] = Season1_6SpecialMarketShowLevelItem.New()
...
function Season1_6SpecialMarketView:_refreshInfo()
	local spEpisodeCo = SeasonConfig.instance:getSeasonSpecialCo(Activity104Model.instance:getCurSeasonId(), self._layer)
...
function Season1_6SpecialMarketView:createRewardItem(index)
...
function Season1_6SpecialMarketView:refreshRewardItem(item, itemCo)
	if not itemCo then
...
function Season1_6SpecialMarketView:updateLeftDesc()
...
function Season1_6SpecialMarketView:createLeftDescItem(index)
	local item = self:getUserDataTb_()
...
function Season1_6SpecialMarketView:updateLeftDescItem(item, co)
	if not co then
		gohelper.setActive(item.go, false)
...
function Season1_6SpecialMarketView:moveToCurDesc()
...
function Season1_6SpecialMarketView:onDestroyView()
	TaskDispatcher.cancelTask(self.moveToCurDesc, self)
...
return Season1_6SpecialMarketView
