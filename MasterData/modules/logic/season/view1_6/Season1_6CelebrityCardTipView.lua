-- chunkname: @modules/logic/season/view1_6/Season1_6CelebrityCardTipView.lua

module("modules.logic.season.view1_6.Season1_6CelebrityCardTipView", package.seeall)

local Season1_6CelebrityCardTipView = class("Season1_6CelebrityCardTipView", BaseView)

function Season1_6CelebrityCardTipView:onInitView()
...
function Season1_6CelebrityCardTipView:addEvents()
...
function Season1_6CelebrityCardTipView:removeEvents()
...
function Season1_6CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season1_6CelebrityCardTipView:onClickGMAdd(count)
...
function Season1_6CelebrityCardTipView:_btninputOnClick()
...
function Season1_6CelebrityCardTipView:_editableInitView()
...
function Season1_6CelebrityCardTipView:onDestroyView()
...
function Season1_6CelebrityCardTipView:onOpen()
...
function Season1_6CelebrityCardTipView:onClose()
	return
end

function Season1_6CelebrityCardTipView:refreshUI()
...
function Season1_6CelebrityCardTipView:refreshQuantity()
...
function Season1_6CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season1_6CelebrityCardTipView:refreshSkills()
...
function Season1_6CelebrityCardTipView:checkCreateIcon()
...
function Season1_6CelebrityCardTipView:getOrCreatePropText(index)
...
function Season1_6CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season1_6CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season1_6CelebrityCardTipView
