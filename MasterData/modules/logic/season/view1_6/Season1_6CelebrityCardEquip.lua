-- chunkname: @modules/logic/season/view1_6/Season1_6CelebrityCardEquip.lua

module("modules.logic.season.view1_6.Season1_6CelebrityCardEquip", package.seeall)

local Season1_6CelebrityCardEquip = class("Season1_6CelebrityCardEquip", LuaCompBase)

function Season1_6CelebrityCardEquip:init(go)
	Season1_6CelebrityCardEquip.super.init(self, go)
...
Season1_6CelebrityCardEquip.MaxRare = 5

function Season1_6CelebrityCardEquip:_editableInitView()
	self._rareGoMap = {}

	for i = 1, Season1_6CelebrityCardEquip.MaxRare do
...
function Season1_6CelebrityCardEquip:onDestroy()
	self:disposeUI()
end

function Season1_6CelebrityCardEquip:checkInitBtnClick()
...
function Season1_6CelebrityCardEquip:checkInitLongPress()
...
function Season1_6CelebrityCardEquip:disposeUI()
...
function Season1_6CelebrityCardEquip:updateData(itemId)
	self.itemId = itemId

	self:refreshUI()
end

function Season1_6CelebrityCardEquip:createRareMap(go)
...
function Season1_6CelebrityCardEquip:refreshUI()
...
function Season1_6CelebrityCardEquip:refreshSelfChoice()
...
function Season1_6CelebrityCardEquip:refreshIcon()
	if self._curSelectedItem then
...
function Season1_6CelebrityCardEquip:refreshFlag()
	if not self.itemId then
		return
	end
...
function Season1_6CelebrityCardEquip:setFlagUIPos(targetPosX, targetPosY)
...
function Season1_6CelebrityCardEquip:setFlagUIScale(targetScale)
...
function Season1_6CelebrityCardEquip:handleIconLoaded()
	if not self._isDisposed then
		local item = self._curSelectedItem
...
function Season1_6CelebrityCardEquip:setColorDark(enable)
	self._darkMaskColor = enable and "#7b7b7b" or "#ffffff"

	self:refreshIcon()
end

function Season1_6CelebrityCardEquip:setShowTag(enable)
	self._showTag = enable

	self:refreshFlag()
end

function Season1_6CelebrityCardEquip:setShowProbability(enable)
	self._showProbability = enable

	self:refreshFlag()
end

function Season1_6CelebrityCardEquip:setShowNewFlag(enable)
	self._showNewFlag = enable

	self:refreshFlag()
end

function Season1_6CelebrityCardEquip:setShowNewFlag2(enable)
	self._showNewFlag2 = enable

	self:refreshFlag()
end

function Season1_6CelebrityCardEquip:setClickCall(clickCall, clickCallObj, param)
...
function Season1_6CelebrityCardEquip:setLongPressCall(longPressCall, longPressCallObj, param)
