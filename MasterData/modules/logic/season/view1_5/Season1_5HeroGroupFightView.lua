-- chunkname: @modules/logic/season/view1_5/Season1_5HeroGroupFightView.lua

module("modules.logic.season.view1_5.Season1_5HeroGroupFightView", package.seeall)

local Season1_5HeroGroupFightView = class("Season1_5HeroGroupFightView", BaseView)

function Season1_5HeroGroupFightView:onInitView()
...
function Season1_5HeroGroupFightView:addEvents()
...
function Season1_5HeroGroupFightView:removeEvents()
...
function Season1_5HeroGroupFightView:_setTrialNumTips()
	local _, battleCO = Season1_5HeroGroupFightView._getEpisodeConfigAndBattleConfig()
	local tips = {}
...
function Season1_5HeroGroupFightView:_onTouch()
...
function Season1_5HeroGroupFightView:_setTrialTipsTxt(obj, data, index)
	gohelper.findChildTextMesh(obj, "desc").text = data
end

function Season1_5HeroGroupFightView:_switchTrialTips()
...
function Season1_5HeroGroupFightView:_btnrecommendOnClick()
...
function Season1_5HeroGroupFightView:_btnclothOnClock()
...
function Season1_5HeroGroupFightView:_btnrestrainOnClick()
	ViewMgr.instance:openView(ViewName.HeroGroupCareerTipView)
end

function Season1_5HeroGroupFightView:_btnstartseasonOnClick()
	self:_onClickStart()
end

function Season1_5HeroGroupFightView:_btnseasonreplayOnClick()
	self:_onClickReplay()
end

function Season1_5HeroGroupFightView:_btnseasonsupercardOnClick()
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season1_5HeroGroupFightView:_groupDropValueChanged(value)
...
function Season1_5HeroGroupFightView:_editableInitView()
...
function Season1_5HeroGroupFightView:onOpen()
...
function Season1_5HeroGroupFightView:_initComponent()
...
function Season1_5HeroGroupFightView:_initData()
	...
	NavigateMgr.instance:addEscape(ViewName.Season1_5HeroGroupFightView, self._onEscapeBtnClick, self)
...
function Season1_5HeroGroupFightView:_addEvents()
...
function Season1_5HeroGroupFightView:_checkReplay()
...
function Season1_5HeroGroupFightView:_receiveRecommend(cmd, resultCode, msg)
...
function Season1_5HeroGroupFightView:_switchSnapshotSubId()
	self:_refreshMainCard()
end

function Season1_5HeroGroupFightView:_refreshMainCard()
	...
	if unlock then
		...
		if act104EquipId ~= 0 then
			if not self._superCardItem then
				self._superCardItem = Season1_5CelebrityCardItem.New()
...
function Season1_5HeroGroupFightView:_checkDropArrow()
...
function Season1_5HeroGroupFightView:_onClickReplay()
...
function Season1_5HeroGroupFightView:_switchReplayGroup(lastRelayMode)
...
function Season1_5HeroGroupFightView:_haveRecord()
	if not OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.FightReplay) then
		return false
	end
...
function Season1_5HeroGroupFightView:_updateReplayHeroGroupList()
...
function Season1_5HeroGroupFightView:_switchReplayMul()
	self._txtreplaycount.text = self._replayMode and luaLang("multiple") .. self._multiplication or ""
end

function Season1_5HeroGroupFightView:_heroMoveForward(heroId)
	HeroGroupEditListModel.instance:setMoveHeroId(tonumber(heroId))
end

function Season1_5HeroGroupFightView:isReplayMode()
	return self._replayMode
end

function Season1_5HeroGroupFightView:_onCurrencyChange(changeIds)
...
function Season1_5HeroGroupFightView:onClose()
	AudioMgr.instance:trigger(AudioEnum.UI.Stop_HeroNormalVoc)
	self:_removeEvents()
...
function Season1_5HeroGroupFightView:_removeEvents()
...
function Season1_5HeroGroupFightView:_refreshReplay()
...
function Season1_5HeroGroupFightView:_refreshCloth()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
	...
	gohelper.setActive(self._btncloth.gameObject, Season1_5HeroGroupFightView.showCloth())
end

function Season1_5HeroGroupFightView:_checkEquipClothSkill()
...
function Season1_5HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season1_5HeroGroupFightView.showCloth()
	...
	local episodeCO, battleCO = Season1_5HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season1_5HeroGroupFightView:_onModifyHeroGroup()
	self:_refreshCloth()
	self:_refreshMainCard()
end

function Season1_5HeroGroupFightView:_onModifySnapshot()
	self:_refreshCloth()
	self:_refreshMainCard()
end

function Season1_5HeroGroupFightView:_onClickHeroGroupItem(id)
	TaskDispatcher.cancelTask(self.openHeroGroupEditView, self)
...
function Season1_5HeroGroupFightView:openHeroGroupEditView()
	ViewMgr.instance:openView(ViewName.HeroGroupEditView, self._param)
end

function Season1_5HeroGroupFightView:_checkFirstPosHasEquip()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
...
function Season1_5HeroGroupFightView:_showGuideDragEffect(param)
	if self._dragEffectLoader then
		self._dragEffectLoader:dispose()
...
function Season1_5HeroGroupFightView:_onClickStart()
...
function Season1_5HeroGroupFightView:_enterFight()
...
function Season1_5HeroGroupFightView:_onUseRecommendGroup()
	if self._replayMode then
		self._replayMode = false
		self._multiplication = 1
...
function Season1_5HeroGroupFightView:_refreshBtns()
	local showDrop = not self._replayMode and self:_noAidHero()

	gohelper.setActive(self._dropseasonherogroup.gameObject, showDrop)
end

function Season1_5HeroGroupFightView:_onGetFightRecordGroupReply(fightGroupMO)
	self.removeEventCb(self, FightController.instance, FightEvent.RespGetFightRecordGroupReply, self._onGetFightRecordGroupReply, self)
...
function Season1_5HeroGroupFightView:_updateReplayHeroGroup()
	HeroGroupModel.instance:setReplayParam(self._replayFightGroupMO)
	HeroGroupController.instance:dispatchEvent(HeroGroupEvent.SelectHeroGroup, self._replayFightGroupMO.id)
	self:_refreshCloth()
	self:_refreshMainCard()
...
function Season1_5HeroGroupFightView:_playHeroGroupExitEffect()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
end

function Season1_5HeroGroupFightView:_playCloseHeroGroupAnimation()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
...
function Season1_5HeroGroupFightView:_closeHeroContainAnim()
	if self._heroContainAnim then
		self._heroContainAnim.enabled = false
	end
end

function Season1_5HeroGroupFightView:onDestroyView()
...
function Season1_5HeroGroupFightView:_noAidHero()
...
return Season1_5HeroGroupFightView
