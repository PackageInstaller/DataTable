-- chunkname: @modules/logic/season/view1_5/Season1_5StoreView.lua

module("modules.logic.season.view1_5.Season1_5StoreView", package.seeall)

local Season1_5StoreView = class("Season1_5StoreView", BaseView)

function Season1_5StoreView:onInitView()
...
function Season1_5StoreView:addEvents()
	return
end

function Season1_5StoreView:removeEvents()
	return
end

function Season1_5StoreView:_editableInitView()
...
function Season1_5StoreView:onUpdateParam()
	return
end

function Season1_5StoreView:onOpen()
...
function Season1_5StoreView:_onGet107GoodsInfo(actId)
...
function Season1_5StoreView:_onBuyGoodsSuccess(actId)
	if actId ~= self.actId then
		return
	end
...
function Season1_5StoreView:updateView()
	self:refreshStoreContent()
end

function Season1_5StoreView:refreshStoreContent()
...
function Season1_5StoreView.sortGoods(goodCo1, goodCo2)
...
function Season1_5StoreView:getItemGo(index)
...
function Season1_5StoreView:refreshTime()
...
function Season1_5StoreView:onClose()
...
function Season1_5StoreView:onDestroyView()
