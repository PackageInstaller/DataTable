-- chunkname: @modules/logic/season/view1_5/Season1_5SettlementHeroItem.lua

module("modules.logic.season.view1_5.Season1_5SettlementHeroItem", package.seeall)

local Season1_5SettlementHeroItem = class("Season1_5SettlementHeroItem", BaseViewExtended)

function Season1_5SettlementHeroItem:onInitView()
...
function Season1_5SettlementHeroItem:addEvents()
	return
end

function Season1_5SettlementHeroItem:removeEvents()
	return
end

function Season1_5SettlementHeroItem:onRefreshViewParam(is_replay, hero, equip, equip_104, replay_data, trail)
...
function Season1_5SettlementHeroItem:onOpen()
...
function Season1_5SettlementHeroItem:_showNormalData()
	if self._trail then
...
function Season1_5SettlementHeroItem:_showTrailHeroIcon(trail)
	if not trail then
		return
	end
...
function Season1_5SettlementHeroItem:_showHeroIcon(heroId, skinId)
...
function Season1_5SettlementHeroItem:_showEquipIcon(equip_id)
...
function Season1_5SettlementHeroItem:_showEquip104(index, uid, totalEquipCount, equipId)
	if equipId == 0 then
		return
	end
	...
	if totalEquipCount <= 1 then
		if not self._gosingle then
			...
			self:openSubView(Season1_5CelebrityCardGetItem, Season1_5CelebrityCardItem.AssetPath, parentTran, uid, nil, equipId)
		end
	end
end

function Season1_5SettlementHeroItem:_showReplayData()
...
function Season1_5SettlementHeroItem:_refreshEquipPos()
	return
end

function Season1_5SettlementHeroItem:onClose()
	return
end

function Season1_5SettlementHeroItem:onDestroyView()
	self._simageheroicon:UnLoadImage()
end

return Season1_5SettlementHeroItem
