-- chunkname: @modules/logic/season/view1_5/Season1_5EquipView.lua

module("modules.logic.season.view1_5.Season1_5EquipView", package.seeall)

local Season1_5EquipView = class("Season1_5EquipView", BaseView)

function Season1_5EquipView:onInitView()
...
function Season1_5EquipView:addEvents()
...
function Season1_5EquipView:removeEvents()
	self._btnequip:RemoveClickListener()
	self._btnopenhandbook:RemoveClickListener()
end

function Season1_5EquipView:_editableInitView()
...
function Season1_5EquipView:onDestroyView()
...
function Season1_5EquipView:onOpen()
...
function Season1_5EquipView:onClose()
	return
end

function Season1_5EquipView:refreshUI()
...
function Season1_5EquipView:handleEquipUpdate()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season1_5EquipView:refreshSlots()
...
function Season1_5EquipView:refreshSlot(slotIndex)
...
Season1_5EquipView.MaxUISlot = 2

function Season1_5EquipView:refreshDescGroup()
	for slot = 1, Season1_5EquipView.MaxUISlot do
...
function Season1_5EquipView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season1_5EquipView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season1_5EquipView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season1_5EquipView:getOrCreatePropText(index, descItem)
...
function Season1_5EquipView:getOrCreateSkillText(index, descItem)
...
function Season1_5EquipView:getOrCreateSlot(slotIndex)
...
function Season1_5EquipView:getOrCreateSlotIcon(slotItem)
...
function Season1_5EquipView:getOrCreateDesc(index)
...
function Season1_5EquipView:onClickSlot(slotIndex)
	if Activity104EquipItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season1_5EquipView:handleSaveSucc()
...
function Season1_5EquipView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season1_5EquipView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season1_5EquipView:handleEquipCardChanged(param)
...
function Season1_5EquipView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season1_5EquipView:_btnequipOnClick()
