-- chunkname: @modules/logic/season/view1_5/Season1_5HeroFightViewLevel.lua

module("modules.logic.season.view1_5.Season1_5HeroFightViewLevel", package.seeall)

local Season1_5HeroFightViewLevel = class("Season1_5HeroFightViewLevel", BaseView)

function Season1_5HeroFightViewLevel:onInitView()
...
function Season1_5HeroFightViewLevel:addEvents()
	return
end

function Season1_5HeroFightViewLevel:removeEvents()
	return
end

function Season1_5HeroFightViewLevel:_editableInitView()
	self._monsterGroupItemList = {}
end

function Season1_5HeroFightViewLevel:_refreshUI()
...
function Season1_5HeroFightViewLevel:_refreshTarget()
...
function Season1_5HeroFightViewLevel:_initStars()
...
function Season1_5HeroFightViewLevel:_showStar(episodeInfo, advancedConditionText, passNormal, passAdvanced, passUltra)
	self:_initStars()
...
function Season1_5HeroFightViewLevel:_setStar(image, light, double)
...
function Season1_5HeroFightViewLevel:onOpen()
	self:_refreshUI()
end

function Season1_5HeroFightViewLevel:onClose()
	return
end

function Season1_5HeroFightViewLevel:onDestroyView()
	return
end

return Season1_5HeroFightViewLevel
