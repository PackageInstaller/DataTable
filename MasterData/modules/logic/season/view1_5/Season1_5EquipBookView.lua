-- chunkname: @modules/logic/season/view1_5/Season1_5EquipBookView.lua

module("modules.logic.season.view1_5.Season1_5EquipBookView", package.seeall)

local Season1_5EquipBookView = class("Season1_5EquipBookView", BaseView)

function Season1_5EquipBookView:onInitView()
...
function Season1_5EquipBookView:addEvents()
	self._btnexchange:AddClickListener(self._btnexchangeOnClick, self)
end

function Season1_5EquipBookView:removeEvents()
	self._btnexchange:RemoveClickListener()
end

function Season1_5EquipBookView:_btnexchangeOnClick()
	local actId = Activity104Model.instance:getCurSeasonId()

	ViewMgr.instance:openView(ViewName.Season1_5EquipComposeView, {
		actId = actId
	})
end

function Season1_5EquipBookView:_editableInitView()
...
function Season1_5EquipBookView:onDestroyView()
...
function Season1_5EquipBookView:onOpen()
	local actId = Activity104Model.instance:getCurSeasonId()
...
function Season1_5EquipBookView:onClose()
	return
end

function Season1_5EquipBookView:refreshUI()
	self:refreshDesc()
	self:refreshIcon()
end

function Season1_5EquipBookView:refreshDesc()
...
function Season1_5EquipBookView:refreshIcon()
...
function Season1_5EquipBookView:refreshProps(itemCfg)
	local processedSet = {}
	local isDirty = false
...
function Season1_5EquipBookView:refreshSkills(itemCfg)
...
function Season1_5EquipBookView:getOrCreatePropText(index)
...
function Season1_5EquipBookView:getOrCreateSkillText(index)
...
function Season1_5EquipBookView:checkCreateIcon()
...
function Season1_5EquipBookView:onChangeSelectCard()
	self._animatorCard:Play("switch", 0, 0)
end

function Season1_5EquipBookView:onSwitchCardAnim()
	self:refreshUI()
end

return Season1_5EquipBookView
