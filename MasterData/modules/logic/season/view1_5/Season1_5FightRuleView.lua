-- chunkname: @modules/logic/season/view1_5/Season1_5FightRuleView.lua

module("modules.logic.season.view1_5.Season1_5FightRuleView", package.seeall)

local Season1_5FightRuleView = class("Season1_5FightRuleView", BaseView)

function Season1_5FightRuleView:onInitView()
...
function Season1_5FightRuleView:addEvents()
	return
end

function Season1_5FightRuleView:removeEvents()
	return
end

function Season1_5FightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function Season1_5FightRuleView:onOpen()
	self:refreshRule()
end

function Season1_5FightRuleView:refreshRule()
	local dataList = Season1_5FightRuleView.getRuleList() or {}
...
function Season1_5FightRuleView:createItem(index)
	local item = {}
...
function Season1_5FightRuleView:updateItem(item, data)
...
function Season1_5FightRuleView:destroyItem(item)
	return
end

function Season1_5FightRuleView.getRuleList()
...
function Season1_5FightRuleView:setDecorateVisible(isVisible)
...
function Season1_5FightRuleView:onClose()
	return
end

function Season1_5FightRuleView:onDestroyView()
