-- chunkname: @modules/logic/season/view1_5/Season1_5CelebrityCardTipView.lua

module("modules.logic.season.view1_5.Season1_5CelebrityCardTipView", package.seeall)

local Season1_5CelebrityCardTipView = class("Season1_5CelebrityCardTipView", BaseView)

function Season1_5CelebrityCardTipView:onInitView()
...
function Season1_5CelebrityCardTipView:addEvents()
...
function Season1_5CelebrityCardTipView:removeEvents()
...
function Season1_5CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season1_5CelebrityCardTipView:onClickGMAdd(count)
...
function Season1_5CelebrityCardTipView:_btninputOnClick()
...
function Season1_5CelebrityCardTipView:_editableInitView()
...
function Season1_5CelebrityCardTipView:onDestroyView()
...
function Season1_5CelebrityCardTipView:onOpen()
...
function Season1_5CelebrityCardTipView:onClose()
	return
end

function Season1_5CelebrityCardTipView:refreshUI()
...
function Season1_5CelebrityCardTipView:refreshQuantity()
...
function Season1_5CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season1_5CelebrityCardTipView:refreshSkills()
...
function Season1_5CelebrityCardTipView:checkCreateIcon()
	if not self._icon then
		local path = self.viewContainer:getSetting().otherRes[1]
		local go = self:getResInst(path, self._gocard, "icon")

		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season1_5CelebrityCardEquip)
	end
end

function Season1_5CelebrityCardTipView:getOrCreatePropText(index)
...
function Season1_5CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season1_5CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season1_5CelebrityCardTipView
