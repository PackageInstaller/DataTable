-- chunkname: @modules/logic/season/view1_5/Season1_5FightCardItem.lua

module("modules.logic.season.view1_5.Season1_5FightCardItem", package.seeall)

local Season1_5FightCardItem = class("Season1_5FightCardItem", UserDataDispose)

function Season1_5FightCardItem:ctor(go)
	self:__onInit()
...
Season1_5FightCardItem.MainRoleItemMinHeight = 390
Season1_5FightCardItem.NormalRoleItemMinHeight = 315
Season1_5FightCardItem.RoleCardPos = {
	Vector2(-16.5, 0.5),
	Vector2(-16.5, 0.5),
	Vector2(-16.5, -6.5),
	Vector2(-16.5, -17),
...
function Season1_5FightCardItem:setData(data)
	if not data then
	...
	if self.isMainRole then
		self.layoutElement.minHeight = Season1_5FightCardItem.MainRoleItemMinHeight or Season1_5FightCardItem.NormalRoleItemMinHeight
	end
...
function Season1_5FightCardItem:_setName()
	if self.isMainRole then
...
function Season1_5FightCardItem:_setHead()
...
function Season1_5FightCardItem:_setCard(equipId)
	if not self.cardItem then
		self.cardItem = Season1_5CelebrityCardItem.New()
	...
	local targetCardPos = Season1_5FightCardItem.RoleCardPos[tonumber(rare)] or Vector2(0, 0)

	recthelper.setAnchor(self.goCardPos.transform, targetCardPos.x, targetCardPos.y)
end

function Season1_5FightCardItem:_setDesc(equipId)
...
function Season1_5FightCardItem:createDescItem(index)
	local item = {}
...
function Season1_5FightCardItem:updateDescItem(item, skillStr)
...
function Season1_5FightCardItem:destroyDescItem(item)
	return
end

function Season1_5FightCardItem:destroy()
