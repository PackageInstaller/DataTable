-- chunkname: @modules/logic/activity/view/V2a7_Labor_SignItem.lua

module("modules.logic.activity.view.V2a7_Labor_SignItem", package.seeall)

local V2a7_Labor_SignItem = class("V2a7_Labor_SignItem", Activity101SignViewItemBase)

function V2a7_Labor_SignItem:onInitView()
...
function V2a7_Labor_SignItem:addEvents()
	return
end

function V2a7_Labor_SignItem:removeEvents()
	return
end
...
function V2a7_Labor_SignItem:_editableInitView()
...
function V2a7_Labor_SignItem:_onItemClick()
...
function V2a7_Labor_SignItem:_refreshRewardItem(item, itemCo)
