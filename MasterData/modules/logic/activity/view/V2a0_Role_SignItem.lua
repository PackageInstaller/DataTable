-- chunkname: @modules/logic/activity/view/V2a0_Role_SignItem.lua

module("modules.logic.activity.view.V2a0_Role_SignItem", package.seeall)

local V2a0_Role_SignItem = class("V2a0_Role_SignItem", Activity101SignViewItemBase)

function V2a0_Role_SignItem:onInitView()
...
function V2a0_Role_SignItem:addEvents()
	return
end

function V2a0_Role_SignItem:removeEvents()
	return
end
...
function V2a0_Role_SignItem:_editableInitView()
