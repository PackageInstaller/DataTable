-- chunkname: @modules/logic/activity/view/V1a6_Spring_SignItem.lua

module("modules.logic.activity.view.V1a6_Spring_SignItem", package.seeall)

local V1a6_Spring_SignItem = class("V1a6_Spring_SignItem", Activity101SignViewItemBase)

function V1a6_Spring_SignItem:onInitView()
	...
	self._goKelinqu = gohelper.findChild(self.viewGO, "Root/#go_SelectedBG/#go_Kelinqu")
...
function V1a6_Spring_SignItem:addEvents()
	return
end

function V1a6_Spring_SignItem:removeEvents()
	return
end
...
function V1a6_Spring_SignItem:_editableInitView()
