-- chunkname: @modules/logic/activity/view/Role_SignItem.lua

module("modules.logic.activity.view.Role_SignItem", package.seeall)

local Role_SignItem = class("Role_SignItem", Activity101SignViewItemBase)

function Role_SignItem:onInitView()
...
function Role_SignItem:addEvents()
	return
end

function Role_SignItem:removeEvents()
	return
end
...
function Role_SignItem:_editableInitView()
