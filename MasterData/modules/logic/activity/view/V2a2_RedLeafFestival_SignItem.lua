-- chunkname: @modules/logic/activity/view/V2a2_RedLeafFestival_SignItem.lua

module("modules.logic.activity.view.V2a2_RedLeafFestival_SignItem", package.seeall)

local V2a2_RedLeafFestival_SignItem = class("V2a2_RedLeafFestival_SignItem", Activity101SignViewItemBase)

function V2a2_RedLeafFestival_SignItem:onInitView()
...
function V2a2_RedLeafFestival_SignItem:addEvents()
	return
end

function V2a2_RedLeafFestival_SignItem:removeEvents()
	return
end
...
function V2a2_RedLeafFestival_SignItem:_editableInitView()
...
function V2a2_RedLeafFestival_SignItem:_onItemClick()
...
function V2a2_RedLeafFestival_SignItem:_refreshRewardItem(item, itemCo)
...
return V2a2_RedLeafFestival_SignItem
