-- chunkname: @modules/logic/activity/view/V1a4_Role_SignItem.lua

module("modules.logic.activity.view.V1a4_Role_SignItem", package.seeall)

local V1a4_Role_SignItem = class("V1a4_Role_SignItem", Activity101SignViewItemBase)

function V1a4_Role_SignItem:onInitView()
...
function V1a4_Role_SignItem:addEvents()
	return
end

function V1a4_Role_SignItem:removeEvents()
	return
end
...
function V1a4_Role_SignItem:_editableInitView()
