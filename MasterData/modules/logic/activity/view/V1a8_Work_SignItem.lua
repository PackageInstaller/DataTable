-- chunkname: @modules/logic/activity/view/V1a8_Work_SignItem.lua

module("modules.logic.activity.view.V1a8_Work_SignItem", package.seeall)

local V1a8_Work_SignItem = class("V1a8_Work_SignItem", Activity101SignViewItemBase)

function V1a8_Work_SignItem:onInitView()
...
function V1a8_Work_SignItem:addEvents()
	return
end

function V1a8_Work_SignItem:removeEvents()
	return
end
...
function V1a8_Work_SignItem:_editableInitView()
