-- chunkname: @modules/logic/activity/view/V2a0_SummerSign_SignItem.lua

module("modules.logic.activity.view.V2a0_SummerSign_SignItem", package.seeall)

local V2a0_SummerSign_SignItem = class("V2a0_SummerSign_SignItem", Activity101SignViewItemBase)

function V2a0_SummerSign_SignItem:onInitView()
...
function V2a0_SummerSign_SignItem:addEvents()
	return
end

function V2a0_SummerSign_SignItem:removeEvents()
	return
end
...
function V2a0_SummerSign_SignItem:_editableInitView()
...
function V2a0_SummerSign_SignItem:_refreshRewardItem(item, itemCo)
	item:setMOValue(itemCo[1], itemCo[2], itemCo[3])
	item:setCountFontSize(36)
...
return V2a0_SummerSign_SignItem
