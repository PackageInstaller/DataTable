-- chunkname: @modules/logic/activity/view/V1a9_AnniversarySign_SignItem.lua

module("modules.logic.activity.view.V1a9_AnniversarySign_SignItem", package.seeall)

local V1a9_AnniversarySign_SignItem = class("V1a9_AnniversarySign_SignItem", Activity101SignViewItemBase)

function V1a9_AnniversarySign_SignItem:onInitView()
	...
	self._goIcon3 = gohelper.findChild(self.viewGO, "Root/Item/#go_item2/#go_Icon3")
...
function V1a9_AnniversarySign_SignItem:addEvents()
	return
end

function V1a9_AnniversarySign_SignItem:removeEvents()
	return
end
...
function V1a9_AnniversarySign_SignItem:_editableInitView()
...
function V1a9_AnniversarySign_SignItem:onRefresh()
	...
	if index < 10 then
		self._txtDay.text = "0" .. index or index
	end
...
return V1a9_AnniversarySign_SignItem
