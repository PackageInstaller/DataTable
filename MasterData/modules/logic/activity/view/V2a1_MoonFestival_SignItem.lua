-- chunkname: @modules/logic/activity/view/V2a1_MoonFestival_SignItem.lua

module("modules.logic.activity.view.V2a1_MoonFestival_SignItem", package.seeall)

local V2a1_MoonFestival_SignItem = class("V2a1_MoonFestival_SignItem", Activity101SignViewItemBase)

function V2a1_MoonFestival_SignItem:onInitView()
...
function V2a1_MoonFestival_SignItem:addEvents()
	return
end

function V2a1_MoonFestival_SignItem:removeEvents()
	return
end
...
function V2a1_MoonFestival_SignItem:_editableInitView()
	self:_setActive_kelingquGo(false)
...
function V2a1_MoonFestival_SignItem:onRefresh()
	...
	for i = 1, rewardCount do
		...
		item:setCountTxtSize(35)
		item:SetCountBgHeight(22.72)
	end
...
function V2a1_MoonFestival_SignItem:_onItemClick()
...
function V2a1_MoonFestival_SignItem:_refreshRewardItem(item, itemCo)
...
return V2a1_MoonFestival_SignItem
