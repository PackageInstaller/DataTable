-- chunkname: @modules/logic/versionactivity1_9/lucy/view/ActLucyTaskItem.lua

module("modules.logic.versionactivity1_9.lucy.view.ActLucyTaskItem", package.seeall)

local ActLucyTaskItem = class("ActLucyTaskItem", ListScrollCellExtend)

function ActLucyTaskItem:onInitView()
...
function ActLucyTaskItem:addEvents()
...
function ActLucyTaskItem:_btnfinishbgOnClick()
...
function ActLucyTaskItem:_editableRemoveEvents()
...
function ActLucyTaskItem:_onOneClickClaimReward()
...
function ActLucyTaskItem:getAnimator()
	return self._animator
end

function ActLucyTaskItem:onUpdateMO(mo)
...
function ActLucyTaskItem:_moveByRankDiff(rankDiff)
...
function ActLucyTaskItem:_refreshUI()
...
function ActLucyTaskItem:_onItemShow(cell_component, data, index)
...
function ActLucyTaskItem:onDestroyView()
	if self._rankDiffMoveId then
		ZProj.TweenHelper.KillById(self._rankDiffMoveId)
