-- chunkname: @modules/logic/assist/view/PickAssistViewContainer.lua

module("modules.logic.assist.view.PickAssistViewContainer", package.seeall)
...
function PickAssistViewContainer:instantiateListScrollView()
	...
	for i = 1, 15 do
		animationDelayTimes[i] = math.ceil((i - 1) % 6) * 0.03 + self.viewOpenAnimTime
	end
