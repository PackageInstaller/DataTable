-- chunkname: @modules/logic/assist/model/PickAssistHeroMO.lua

module("modules.logic.assist.model.PickAssistHeroMO", package.seeall)
...
function PickAssistHeroMO:setHeroInfo(info)
	...
	self.roleBadgeIds = info.roleBadgeIds
end
...
function PickAssistHeroMO:getCareer()
	...
	return (self.heroMO and self.heroMO.config or nil) and self.heroMO.config.career
end
