-- chunkname: @modules/logic/versionactivity2_5/dungeon/view/map/scene/VersionActivity2_5DungeonMapSceneElements.lua

module("modules.logic.versionactivity2_5.dungeon.view.map.scene.VersionActivity2_5DungeonMapSceneElements", package.seeall)

local VersionActivity2_5DungeonMapSceneElements = class("VersionActivity2_5DungeonMapSceneElements", BaseView)
local FOCUS_TIME = 0.5
local WAIT_TIME = 0.5

function VersionActivity2_5DungeonMapSceneElements:onInitView()
...
function VersionActivity2_5DungeonMapSceneElements:addEvents()
	...
	self.addEventCb(self, DungeonController.instance, DungeonMapElementEvent.OnDisposeOldMap, self.onDisposeOldMap, self)
	...
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
...
function VersionActivity2_5DungeonMapSceneElements:removeEvents()
	...
	self.removeEventCb(self, DungeonController.instance, DungeonMapElementEvent.OnDisposeOldMap, self.onDisposeOldMap, self)
	...
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
...
function VersionActivity2_5DungeonMapSceneElements:_editableInitView()
...
function VersionActivity2_5DungeonMapSceneElements:onOpen()
	return
end

function VersionActivity2_5DungeonMapSceneElements:onGamepadKeyDown(key)
	...
	for i = 0, maxIndex do
		...
		local comp = MonoHelper.getLuaComFromGo(hitInfo.transform.parent.gameObject, VersionActivity2_5DungeonMapElement)
...
function VersionActivity2_5DungeonMapSceneElements:onBeginDragMap()
	self._clickDown = false
end

function VersionActivity2_5DungeonMapSceneElements:onCreateMapRootGoDone(sceneRoot)
...
function VersionActivity2_5DungeonMapSceneElements:loadSceneFinish(param)
...
function VersionActivity2_5DungeonMapSceneElements:manualClickElement(id)
...
function VersionActivity2_5DungeonMapSceneElements:setMouseElementDown(elementComp)
	self.mouseDownElement = elementComp
end

function VersionActivity2_5DungeonMapSceneElements:getElementComp(elementId)
	return self._elementCompDict[elementId]
end

function VersionActivity2_5DungeonMapSceneElements:onClickElement(elementId)
	self:hideAllElements()
end

function VersionActivity2_5DungeonMapSceneElements:hideAllElements()
...
function VersionActivity2_5DungeonMapSceneElements:onHideInteractUI()
	self:showAllElements()
end

function VersionActivity2_5DungeonMapSceneElements:showAllElements()
	for _, elementComp in pairs(self._elementCompDict) do
...
function VersionActivity2_5DungeonMapSceneElements:_updateElementArrow()
	for _, v in pairs(self._elementCompDict) do
		self:_updateArrow(v)
	end
end

function VersionActivity2_5DungeonMapSceneElements:beginShowRewardView()
	self._showRewardView = true
end

function VersionActivity2_5DungeonMapSceneElements:endShowRewardView()
...
function VersionActivity2_5DungeonMapSceneElements:onRemoveElement(id)
...
function VersionActivity2_5DungeonMapSceneElements:_removeElement(id)
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.OnRemoveElement, elementComp)
end

function VersionActivity2_5DungeonMapSceneElements:showNewElements()
	...
	for _, elementId in ipairs(newElements) do
		...
		local isBelongCurMap = VersionActivity2_5DungeonConfig.instance:checkElementBelongMapId(elementCo, self._mapCfg.id)
...
function VersionActivity2_5DungeonMapSceneElements:_showElementAnim(animElements, normalElements)
	if not animElements or #animElements <= 0 then
		VersionActivity2_5DungeonMapSceneElements._addAnimElementDone({
			self,
			normalElements
		})
	...
	for _, id in ipairs(animElements) do
		self._showSequence:addWork(FunctionWork.New(VersionActivity2_5DungeonMapSceneElements._doFocusElement, {
			self,
			id
		}))
		self._showSequence:addWork(TimerWork.New(FOCUS_TIME))
		self._showSequence:addWork(FunctionWork.New(VersionActivity2_5DungeonMapSceneElements._doAddElement, {
			self,
			id
		}))
		self._showSequence:addWork(TimerWork.New(WAIT_TIME))
	...
	self._showSequence:addWork(FunctionWork.New(VersionActivity2_5DungeonMapSceneElements._addAnimElementDone, {
		self,
		normalElements
	}))
	...
	UIBlockMgr.instance:startBlock(VersionActivity2_5DungeonEnum.BlockKey.FocusNewElement)
end

function VersionActivity2_5DungeonMapSceneElements._doFocusElement(params)
	local elementId = params[2]

	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.FocusElement, elementId, true)
end

function VersionActivity2_5DungeonMapSceneElements._doAddElement(params)
...
function VersionActivity2_5DungeonMapSceneElements._addAnimElementDone(params)
	local self = params[1]
...
function VersionActivity2_5DungeonMapSceneElements:_addElementById(id)
	local config = lua_chapter_map_element.configDict[id]

	self:_addElement(config)
end

function VersionActivity2_5DungeonMapSceneElements:_addElement(elementConfig)
	...
	if elementComp then
		...
		elementComp = MonoHelper.addLuaComOnceToGo(go, VersionActivity2_5DungeonMapElement, {
			elementConfig,
			self
		})
	end
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.OnAddOneElement, elementComp)
end

function VersionActivity2_5DungeonMapSceneElements:showElements()
	...
	local newElements = DungeonMapModel.instance:getNewElements()
	local elementCoList = VersionActivity2_5DungeonModel.instance:getElementCoList(self._mapCfg.id)
...
function VersionActivity2_5DungeonMapSceneElements:recycleAllElements()
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.OnRecycleAllElement)
end

function VersionActivity2_5DungeonMapSceneElements:_arrowClick(elementId)
	self.mouseDownElement = nil

	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_element_arrow_click)
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.FocusElement, elementId)
end

function VersionActivity2_5DungeonMapSceneElements:_updateArrow(elementComp)
...
function VersionActivity2_5DungeonMapSceneElements:onClickUp()
...
function VersionActivity2_5DungeonMapSceneElements:onClickDown()
	self._clickDown = true
end

function VersionActivity2_5DungeonMapSceneElements:setInitClickElement(elementId)
	self._initClickElementId = elementId
end

function VersionActivity2_5DungeonMapSceneElements:clearElements()
	if self._elementCompDict then
		for _, v in pairs(self._elementCompDict) do
			v:onDestroy()
		end
...
function VersionActivity2_5DungeonMapSceneElements:onChangeMap()
	self.hadEverySecondTask = false
...
function VersionActivity2_5DungeonMapSceneElements:_stopShowSequence()
	if self._showSequence then
		...
		UIBlockMgr.instance:endBlock(VersionActivity2_5DungeonEnum.BlockKey.FocusNewElement)
	end
end

function VersionActivity2_5DungeonMapSceneElements:onDisposeScene()
	self:clearElements()
	self:_stopShowSequence()
...
function VersionActivity2_5DungeonMapSceneElements:onDisposeOldMap(viewName)
	self:recycleAllElements()
...
function VersionActivity2_5DungeonMapSceneElements:onClose()
	return
end

function VersionActivity2_5DungeonMapSceneElements:onDestroyView()
	self:clearElements()
	DungeonMapModel.instance:clearNewElements()
	self:_stopShowSequence()
...
return VersionActivity2_5DungeonMapSceneElements
