-- chunkname: @modules/logic/versionactivity2_5/dungeon/view/map/scene/VersionActivity2_5DungeonMapScene.lua

module("modules.logic.versionactivity2_5.dungeon.view.map.scene.VersionActivity2_5DungeonMapScene", package.seeall)

local VersionActivity2_5DungeonMapScene = class("VersionActivity2_5DungeonMapScene", BaseView)

function VersionActivity2_5DungeonMapScene:onInitView()
...
function VersionActivity2_5DungeonMapScene:addEvents()
	...
	self.addEventCb(self, GameGlobalMgr.instance, GameStateEvent.OnScreenResize, self._onScreenResize, self)
	...
	self.addEventCb(self, VersionActivityDungeonBaseController.instance, VersionActivityDungeonEvent.OnActivityDungeonMoChange, self.onActivityDungeonMoChange, self)
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, self.onClickElement, self)
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.FocusElement, self.onFocusElement, self)
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.ManualClickElement, self.manualClickElement, self)
	self.addEventCb(self, DungeonController.instance, DungeonMapElementEvent.OnRecheckElement, self._onRecheckElement, self)
...
function VersionActivity2_5DungeonMapScene:removeEvents()
	...
	self.removeEventCb(self, GameGlobalMgr.instance, GameStateEvent.OnScreenResize, self._onScreenResize, self)
	...
	self.removeEventCb(self, VersionActivityDungeonBaseController.instance, VersionActivityDungeonEvent.OnActivityDungeonMoChange, self.onActivityDungeonMoChange, self)
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, self.onClickElement, self)
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.FocusElement, self.onFocusElement, self)
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.ManualClickElement, self.manualClickElement, self)
	self.removeEventCb(self, DungeonController.instance, DungeonMapElementEvent.OnRecheckElement, self._onRecheckElement, self)
...
function VersionActivity2_5DungeonMapScene:_onOpenView(viewName)
...
function VersionActivity2_5DungeonMapScene:_onCloseView(viewName)
	if viewName == ViewName.StoryView then
		self:loadMap()
	end
end

function VersionActivity2_5DungeonMapScene:_onScreenResize()
	if self._sceneGo then
		local camera = CameraMgr.instance:getMainCamera()
		local scale = GameUtil.getAdapterScale()

		camera.orthographicSize = VersionActivity2_5DungeonEnum.DungeonMapCameraSize * scale

		self:_initScene()
	end
end

function VersionActivity2_5DungeonMapScene:onModeChange()
	self:refreshMap()
end

function VersionActivity2_5DungeonMapScene:onActivityDungeonMoChange()
	local needTween = VersionActivity2_5DungeonModel.instance:getMapNeedTweenState()

	self:refreshMap(needTween)
end

function VersionActivity2_5DungeonMapScene:onClickElement(elementComp)
...
function VersionActivity2_5DungeonMapScene:focusElementByCo(elementCo)
	local pos = string.splitToNumber(elementCo.pos, "#")

	if not -pos[2] then
		local x, y = -pos[1] or 0, 0
...
function VersionActivity2_5DungeonMapScene:onFocusElement(elementId, isForce)
	local elementComp = self.mapSceneElementsView:getElementComp(elementId)

	if elementComp or isForce then
		local config = elementComp and elementComp:getConfig() or DungeonConfig.instance:getChapterMapElement(elementId)
...
function VersionActivity2_5DungeonMapScene:changeToElementEpisode(elementId)
...
function VersionActivity2_5DungeonMapScene:manualClickElement(elementId)
	local elementComp = self.mapSceneElementsView:getElementComp(elementId)
...
function VersionActivity2_5DungeonMapScene:_onDragBegin(param, pointerEventData)
...
function VersionActivity2_5DungeonMapScene:_onDrag(param, pointerEventData)
...
function VersionActivity2_5DungeonMapScene:_onDragEnd(param, pointerEventData)
	self._dragBeginPos = nil
end

function VersionActivity2_5DungeonMapScene:getDragWorldPos(pointerEventData)
	local mainCamera = CameraMgr.instance:getMainCamera()
	local refPos = self._gofullscreen.transform.position

	return (SLFramework.UGUI.RectTrHelper.ScreenPosToWorldPos(pointerEventData.position, mainCamera, refPos))
end

function VersionActivity2_5DungeonMapScene:_editableInitView()
...
function VersionActivity2_5DungeonMapScene:_initMapRootNode()
	self._sceneRoot = UnityEngine.GameObject.New(VersionActivity2_5DungeonEnum.SceneRootName)
...
function VersionActivity2_5DungeonMapScene:onUpdateParam()
	self:refreshMap()
end

function VersionActivity2_5DungeonMapScene:onOpen()
	MainCameraMgr.instance:addView(self.viewName, self._initCamera, nil, self)
	self:refreshMap()
end

function VersionActivity2_5DungeonMapScene:_initCamera()
	local camera = CameraMgr.instance:getMainCamera()
...
function VersionActivity2_5DungeonMapScene:refreshMap(needTween, mapCfg)
	self._mapCfg = mapCfg or VersionActivity2_5DungeonConfig.instance:getEpisodeMapConfig(self.activityDungeonMo.episodeId)
...
function VersionActivity2_5DungeonMapScene:_initElements()
	DungeonController.instance:dispatchEvent(DungeonMapElementEvent.OnInitElements)
end

function VersionActivity2_5DungeonMapScene:loadMap()
...
function VersionActivity2_5DungeonMapScene:buildLoadRes(allResPath, mapCfg)
...
function VersionActivity2_5DungeonMapScene:_loadSceneFinish()
...
function VersionActivity2_5DungeonMapScene:_initScene()
	...
	local canvasGo
	local scale = GameUtil.getAdapterScale()
	local worldcorners = (scale ~= 1 and ViewMgr.instance:getUILayer(UILayerName.Hud) or ViewMgr.instance:getUIRoot()).transform:GetWorldCorners()
	local uiCamera = CameraMgr.instance:getUICamera()

	if uiCamera then
		if not uiCamera.orthographicSize then
			local uiCameraSize = 5
			local cameraSizeRate = VersionActivity2_5DungeonEnum.DungeonMapCameraSize / uiCameraSize
...
function VersionActivity2_5DungeonMapScene:_setMapPos()
...
function VersionActivity2_5DungeonMapScene:_addMapLight()
...
function VersionActivity2_5DungeonMapScene:_addMapAudio()
...
function VersionActivity2_5DungeonMapScene:_focusUnfinishStoryElement()
	local elementCo = VersionActivity2_5DungeonModel.instance:checkAndGetUnfinishStoryElementCo(self._mapCfg.id)

	if elementCo then
		VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.FocusElement, elementCo.id)
	end
end

function VersionActivity2_5DungeonMapScene:tweenSetScenePos(targetPos, srcPos)
...
function VersionActivity2_5DungeonMapScene:getTargetPos(targetPos)
...
function VersionActivity2_5DungeonMapScene:tweenFrameCallback(value)
...
function VersionActivity2_5DungeonMapScene:tweenFinishCallback()
	self._tempVector:Set(self._tweenTargetPosX, self._tweenTargetPosY, 0)
	self:directSetScenePos(self._tempVector)
end

function VersionActivity2_5DungeonMapScene:directSetScenePos(targetPos)
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.OnMapPosChanged, self._scenePos, self.needTween)
	self:_updateElementArrow()
end

function VersionActivity2_5DungeonMapScene:_updateElementArrow()
	DungeonController.instance:dispatchEvent(DungeonMapElementEvent.OnUpdateElementArrow)
end

function VersionActivity2_5DungeonMapScene:setVisible(isVisible)
...
function VersionActivity2_5DungeonMapScene:getSceneGo()
	return self._sceneGo
end

function VersionActivity2_5DungeonMapScene:onClose()
	self:killTween()
	self:_resetCamera()
end

function VersionActivity2_5DungeonMapScene:killTween()
	if self.tweenId then
		ZProj.TweenHelper.KillById(self.tweenId)
	end
end

function VersionActivity2_5DungeonMapScene:_resetCamera()
	local camera = CameraMgr.instance:getMainCamera()
...
function VersionActivity2_5DungeonMapScene:_onRecheckElement(elementId, isGM)
	local elementCo = lua_chapter_map_element.configDict[elementId]

	if not self.viewParam.chapterId then
		...
		if not DungeonController.instance:isNeedRecheckInteractive(elementCo) then
			DungeonController.instance:onRecheckElement(elementId, self.viewParam.chapterId)
		...
		DungeonController.instance:onRecheckElement(elementId, self.viewParam.chapterId, item, pos, isGM)
	end
end

function VersionActivity2_5DungeonMapScene:onDestroyView()
...
function VersionActivity2_5DungeonMapScene:disposeOldMap()
	self._oldScenePos = self._sceneTrans and self._scenePos or nil
...
function VersionActivity2_5DungeonMapScene:_disposeScene()
...
return VersionActivity2_5DungeonMapScene
