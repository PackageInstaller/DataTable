-- chunkname: @modules/logic/versionactivity2_5/dungeon/view/map/VersionActivity2_5DungeonMapEpisodeView.lua

module("modules.logic.versionactivity2_5.dungeon.view.map.VersionActivity2_5DungeonMapEpisodeView", package.seeall)

local VersionActivity2_5DungeonMapEpisodeView = class("VersionActivity2_5DungeonMapEpisodeView", BaseView)
...
function VersionActivity2_5DungeonMapEpisodeView:onInitView()
...
function VersionActivity2_5DungeonMapEpisodeView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, self.hideUI, self)
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_5DungeonMapEpisodeView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, self.hideUI, self)
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_5DungeonMapEpisodeView:_editableInitView()
...
function VersionActivity2_5DungeonMapEpisodeView:onUpdateParam()
	self:refreshModeNode()
	self.chapterLayout:refreshEpisodeNodes()
	self:playOnOpenAnimation()
end

function VersionActivity2_5DungeonMapEpisodeView:onOpen()
	self:initChapterEpisodes()
	self:refreshModeNode()
	TaskDispatcher.runRepeat(self.refreshModeLockText, self, TimeUtil.OneMinuteSecond)
end

function VersionActivity2_5DungeonMapEpisodeView:onOpenFinish()
	self:playUnlockAnimation(true)
end

function VersionActivity2_5DungeonMapEpisodeView:refreshModeNode()
...
function VersionActivity2_5DungeonMapEpisodeView:initChapterEpisodes()
...
function VersionActivity2_5DungeonMapEpisodeView:onLoadLayoutFinish()
...
function VersionActivity2_5DungeonMapEpisodeView:refreshModeLockText()
	local openTimeStamp = VersionActivityConfig.instance:getAct113DungeonChapterOpenTimeStamp(VersionActivity2_5DungeonEnum.DungeonChapterId.Hard)
...
function VersionActivity2_5DungeonMapEpisodeView:onModeChange()
	self:refreshModeNode()
	self.chapterLayout:playAnimation("switch")
	self.chapterLayout:refreshEpisodeNodes()
end

function VersionActivity2_5DungeonMapEpisodeView:showUI()
	self:setLayoutVisible(true)
end

function VersionActivity2_5DungeonMapEpisodeView:hideUI()
	self:setLayoutVisible(false)
end

function VersionActivity2_5DungeonMapEpisodeView:_onRecheckInteractive(isShow)
	if isShow then
		self:showUI()
	else
		self:hideUI()
...
function VersionActivity2_5DungeonMapEpisodeView:setLayoutVisible(isShow)
...
function VersionActivity2_5DungeonMapEpisodeView:_onUpdateDungeonInfo()
...
function VersionActivity2_5DungeonMapEpisodeView:_onCloseViewFinish(viewName)
...
function VersionActivity2_5DungeonMapEpisodeView:dailyRefresh()
	self:refreshModeNode()
	self:playUnlockAnimation()
end

function VersionActivity2_5DungeonMapEpisodeView:btnStoryModeClick()
	self:changeEpisodeMode(VersionActivityDungeonBaseEnum.DungeonMode.Story)
end

function VersionActivity2_5DungeonMapEpisodeView:btnHardModeClick()
...
function VersionActivity2_5DungeonMapEpisodeView:checkHardModeIsOpen()
	local dungeonActId = VersionActivity2_5Enum.ActivityId.Dungeon

	return VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapterAndGetToast(dungeonActId)
end

function VersionActivity2_5DungeonMapEpisodeView:changeEpisodeMode(mode)
...
function VersionActivity2_5DungeonMapEpisodeView:directChangeMode()
	self.activityDungeonMo:changeMode(self.activityDungeonMo.mode)
end

function VersionActivity2_5DungeonMapEpisodeView:_onDragBeginHandler()
	self._audioScroll:onDragBegin()
end

function VersionActivity2_5DungeonMapEpisodeView:_onDragEndHandler()
	self._audioScroll:onDragEnd()
end

function VersionActivity2_5DungeonMapEpisodeView:_onClickDownHandler()
	self._audioScroll:onClickDown()
end

function VersionActivity2_5DungeonMapEpisodeView:playOnOpenAnimation()
...
function VersionActivity2_5DungeonMapEpisodeView:playUnlockAnimation(needDone)
	...
	if isNeedPlayHardModeUnlockAnim then
		local prefsKey = VersionActivity2_5DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim

		VersionActivity2_5DungeonController.instance:savePlayerPrefs(prefsKey, HAVE_PLAYED)
...
function VersionActivity2_5DungeonMapEpisodeView:IsNeedPlayHardModeUnlockAnimation()
	local isNeedPlay = false
	local prefsKey = VersionActivity2_5DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim
	local value = VersionActivity2_5DungeonController.instance:getPlayerPrefs(prefsKey, NOT_PLAYED)
...
function VersionActivity2_5DungeonMapEpisodeView:_unlockAniDone()
	local dungeonActId = VersionActivity2_5Enum.ActivityId.Dungeon
	local isOpen = VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapter(dungeonActId)
...
function VersionActivity2_5DungeonMapEpisodeView:onDestroyView()
...
return VersionActivity2_5DungeonMapEpisodeView
