...
function VersionActivity2_5DungeonMapInteractView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_5DungeonMapInteractView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, self.showInteractUI, self)
