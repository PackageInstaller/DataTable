...
function VersionActivity2_5DungeonMapView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.showBtnUI, self)
...
function VersionActivity2_5DungeonMapView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.showBtnUI, self)
