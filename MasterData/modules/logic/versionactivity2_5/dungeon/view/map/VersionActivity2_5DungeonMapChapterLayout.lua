-- chunkname: @modules/logic/versionactivity2_5/dungeon/view/map/VersionActivity2_5DungeonMapChapterLayout.lua

module("modules.logic.versionactivity2_5.dungeon.view.map.VersionActivity2_5DungeonMapChapterLayout", package.seeall)

local VersionActivity2_5DungeonMapChapterLayout = class("VersionActivity2_5DungeonMapChapterLayout", BaseChildView)
local CHAPTER_KEY = "default"
local RIGHT_OFFSET_X = 600
local CONST_DUNGEON_NORMAL_DELTA_X = 100
local TWEEN_TIME = 0.26

function VersionActivity2_5DungeonMapChapterLayout:onInitView()
...
function VersionActivity2_5DungeonMapChapterLayout:addEvents()
	...
	self.addEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.GuideShowElement, self._GuideShowElement, self)
...
function VersionActivity2_5DungeonMapChapterLayout:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.GuideShowElement, self._GuideShowElement, self)
end

function VersionActivity2_5DungeonMapChapterLayout:_onOpenView(viewName)
...
function VersionActivity2_5DungeonMapChapterLayout:_onCloseView(viewName)
	if viewName == ViewName.VersionActivity2_5DungeonMapLevelView then
...
function VersionActivity2_5DungeonMapChapterLayout:onActivityDungeonMoChange()
	self:updateFocusStatus()
	self:setFocusEpisodeId(self.activityDungeonMo.episodeId, true)
end

function VersionActivity2_5DungeonMapChapterLayout:updateFocusStatus()
	for _, episodeItem in pairs(self._episodeItemDict) do
		episodeItem:refreshFocusStatus()
	end
end

function VersionActivity2_5DungeonMapChapterLayout:_onGamepadKeyUp(key)
	local viewNameList = ViewMgr.instance:getOpenViewNameList()
	local topView = viewNameList[#viewNameList]

	if topView ~= ViewName.VersionActivity2_5DungeonMapView and topView ~= ViewName.VersionActivity2_5DungeonMapLevelView then
		return
	end
...
function VersionActivity2_5DungeonMapChapterLayout:_onChangeFocusEpisodeItem(item)
	if GamepadController.instance:isOpen() then
...
function VersionActivity2_5DungeonMapChapterLayout:_editableInitView()
	self._focusIndex = 0
...
function VersionActivity2_5DungeonMapChapterLayout:onUpdateParam()
	return
end

function VersionActivity2_5DungeonMapChapterLayout:onOpen()
	return
end

function VersionActivity2_5DungeonMapChapterLayout:refreshEpisodeNodes()
	self._episodeItemDict = self:getUserDataTb_()
...
function VersionActivity2_5DungeonMapChapterLayout:getEpisodeContainerItem(index)
...
function VersionActivity2_5DungeonMapChapterLayout:setFocusEpisodeId(episodeId, tween)
...
function VersionActivity2_5DungeonMapChapterLayout:setFocusItem(focusItemGo, tween)
...
function VersionActivity2_5DungeonMapChapterLayout:setFocusEpisodeItem(item, tween)
...
function VersionActivity2_5DungeonMapChapterLayout:setSelectEpisodeItem(episodeItem)
...
function VersionActivity2_5DungeonMapChapterLayout:playAnimation(aniName)
	self.animator:Play(aniName, 0, 0)
end

function VersionActivity2_5DungeonMapChapterLayout:playEpisodeItemAnimation(aniName)
...
function VersionActivity2_5DungeonMapChapterLayout:setSelectEpisodeId(episodeId, skipAni)
...
function VersionActivity2_5DungeonMapChapterLayout:isSelectedEpisodeRightEpisode(episodeItem)
	local result = false
...
function VersionActivity2_5DungeonMapChapterLayout:_GuideShowElement(elementId)
	...
	if elementCo then
		...
		VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.FocusElement, id)
	end
end

function VersionActivity2_5DungeonMapChapterLayout:onClose()
	for i, v in pairs(self._episodeContainerItemList) do
		v.episodeItem:destroyView()
	end
end

function VersionActivity2_5DungeonMapChapterLayout:onDestroyView()
	return
end

return VersionActivity2_5DungeonMapChapterLayout
