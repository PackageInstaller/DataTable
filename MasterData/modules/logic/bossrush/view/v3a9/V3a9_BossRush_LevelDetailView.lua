...
function V3a9_BossRush_LevelDetailView:addEvents()
	...
	self.addEventCb(self, V3a9_BossRushController.instance, V3a9_BossRushEvent.onRefreshV3a9ModeTeamInfo, self._refreshHeros, self)
...
function V3a9_BossRush_LevelDetailView:removeEvents()
	...
	self.removeEventCb(self, V3a9_BossRushController.instance, V3a9_BossRushEvent.onRefreshV3a9ModeTeamInfo, self._refreshHeros, self)
...
function V3a9_BossRush_LevelDetailView:refreshScore()
	...
	if stageMo then
		if not stageMo.latestPoint then
