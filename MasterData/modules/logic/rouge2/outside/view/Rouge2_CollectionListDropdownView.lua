-- chunkname: @modules/logic/rouge2/outside/view/Rouge2_CollectionListDropdownView.lua

module("modules.logic.rouge2.outside.view.Rouge2_CollectionListDropdownView", package.seeall)

local Rouge2_CollectionListDropdownView = class("Rouge2_CollectionListDropdownView", BaseView)

function Rouge2_CollectionListDropdownView:onInitView()
...
function Rouge2_CollectionListDropdownView:addEvents()
...
function Rouge2_CollectionListDropdownView:removeEvents()
...
function Rouge2_CollectionListDropdownView:_btnunequip1OnClick()
...
function Rouge2_CollectionListDropdownView:_btnunequip2OnClick()
...
function Rouge2_CollectionListDropdownView:_btnunequip3OnClick()
...
function Rouge2_CollectionListDropdownView:_btnblockOnClick()
...
function Rouge2_CollectionListDropdownView:_btnhole1OnClick()
	self:_clickholeBtn(1)
end

function Rouge2_CollectionListDropdownView:_btnhole2OnClick()
	self:_clickholeBtn(2)
end

function Rouge2_CollectionListDropdownView:_btnhole3OnClick()
	self:_clickholeBtn(3)
end

function Rouge2_CollectionListDropdownView:_clickholeBtn(index)
	if self._clickHoleIndex then
		self:_btnblockOnClick()
...
function Rouge2_CollectionListDropdownView:getHoleMoList()
	return self._holeMoList
end

function Rouge2_CollectionListDropdownView:_editableInitView()
	...
	self.addEventCb(self, RougeController.instance, RougeEvent.OnClickCollectionListItem, self._onClickCollectionListItem, self, LuaEventSystem.High)
	self.addEventCb(self, RougeController.instance, RougeEvent.OnClickCollectionDropItem, self._onClickCollectionDropItem, self)
end

function Rouge2_CollectionListDropdownView:_onClickCollectionDropItem(mo)
...
function Rouge2_CollectionListDropdownView:_updateHoles(skipRefresh)
...
function Rouge2_CollectionListDropdownView:_onClickCollectionListItem()
...
function Rouge2_CollectionListDropdownView:_onRefresh()
...
function Rouge2_CollectionListDropdownView:_setHoleVisible(index, visible)
	local go = self["_btnhole" .. index]

	gohelper.setActive(go, visible)
end

function Rouge2_CollectionListDropdownView:onClose()
	gohelper.setActive(self._scrollviewGo, false)
	gohelper.setActive(self._btnblock, false)
end

function Rouge2_CollectionListDropdownView:onDestroyView()
	TaskDispatcher.cancelTask(self._onRefresh, self)
end

return Rouge2_CollectionListDropdownView
