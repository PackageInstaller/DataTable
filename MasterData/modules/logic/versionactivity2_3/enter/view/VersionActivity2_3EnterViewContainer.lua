-- chunkname: @modules/logic/versionactivity2_3/enter/view/VersionActivity2_3EnterViewContainer.lua

module("modules.logic.versionactivity2_3.enter.view.VersionActivity2_3EnterViewContainer", package.seeall)

local VersionActivity2_3EnterViewContainer = class("VersionActivity2_3EnterViewContainer", BaseViewContainer)

function VersionActivity2_3EnterViewContainer:buildViews()
	return {
...
function VersionActivity2_3EnterViewContainer:buildTabViews(tabContainerId)
	...
	elseif tabContainerId == 2 then
		...
		multiView[#multiView + 1] = VersionActivity2_3DungeonEnterView.New()
		multiView[#multiView + 1] = VersionActivity2_3Act174EnterView.New()
		multiView[#multiView + 1] = VersionActivity2_3DuDuGuEnterView.New()
		multiView[#multiView + 1] = VersionActivity2_3ZhiXinQuanErEnterView.New()
		multiView[#multiView + 1] = V2a3_Season123EnterView.New()
...
function VersionActivity2_3EnterViewContainer:selectActTab(jumpTabId, actId)
	self.activityId = actId

	self:dispatchEvent(ViewEvent.ToSwitchTab, 2, jumpTabId)
end

function VersionActivity2_3EnterViewContainer:onContainerInit()
...
function VersionActivity2_3EnterViewContainer:onContainerClose()
...
function VersionActivity2_3EnterViewContainer:getIsFirstPlaySubViewAnim()
	return self.isFirstPlaySubViewAnim
end

function VersionActivity2_3EnterViewContainer:markPlayedSubViewAnim()
	self.isFirstPlaySubViewAnim = false
end

return VersionActivity2_3EnterViewContainer
