-- chunkname: @modules/logic/versionactivity2_3/enter/view/subview/V2a3_Season123EnterView.lua

module("modules.logic.versionactivity2_3.enter.view.subview.V2a3_Season123EnterView", package.seeall)

local V2a3_Season123EnterView = class("V2a3_Season123EnterView", BaseView)

function V2a3_Season123EnterView:onInitView()
...
function V2a3_Season123EnterView:addEvents()
...
function V2a3_Season123EnterView:removeEvents()
...
function V2a3_Season123EnterView:_btnNormalOnClick()
...
function V2a3_Season123EnterView:_btnLockedOnClick()
...
function V2a3_Season123EnterView:_btnStoreOnClick()
	Season123Controller.instance:openSeasonStoreView(self.actId)
end

function V2a3_Season123EnterView:_editableInitView()
...
function V2a3_Season123EnterView:onUpdateParam()
	return
end

function V2a3_Season123EnterView:onOpen()
	self.animComp:playOpenAnim()

	self.actId = VersionActivity2_3Enum.ActivityId.Season
...
function V2a3_Season123EnterView:refreshUI()
...
function V2a3_Season123EnterView:refreshDesc()
...
function V2a3_Season123EnterView:refreshStoreCoin()
...
function V2a3_Season123EnterView:refreshEnterBtn()
	local status, toastId, toastParam = ActivityHelper.getActivityStatusAndToast(self.actId)
...
function V2a3_Season123EnterView:refreshRemainTime()
	self:refreshMainTime()
	self:refreshStoreTime()
end

function V2a3_Season123EnterView:refreshMainTime()
...
function V2a3_Season123EnterView:refreshStoreTime()
...
function V2a3_Season123EnterView:onClose()
	TaskDispatcher.cancelTask(self.refreshRemainTime, self)
end

function V2a3_Season123EnterView:onDestroyView()
	self.animComp:destroy()
end

return V2a3_Season123EnterView
