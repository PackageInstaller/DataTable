...
function VersionActivity2_3DungeonMapEpisodeView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnClickElement, self.hideUI, self)
	self.addEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_3DungeonMapEpisodeView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnClickElement, self.hideUI, self)
	self.removeEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_3DungeonMapEpisodeView:_onRecheckInteractive(isShow)
	if isShow then
		self:showUI()
	else
		self:hideUI()
