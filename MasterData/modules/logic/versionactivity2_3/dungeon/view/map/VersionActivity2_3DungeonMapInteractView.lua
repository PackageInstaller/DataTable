...
function VersionActivity2_3DungeonMapInteractView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_3DungeonMapInteractView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnClickElement, self.showInteractUI, self)
