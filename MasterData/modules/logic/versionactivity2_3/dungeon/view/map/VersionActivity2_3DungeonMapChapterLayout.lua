-- chunkname: @modules/logic/versionactivity2_3/dungeon/view/map/VersionActivity2_3DungeonMapChapterLayout.lua

module("modules.logic.versionactivity2_3.dungeon.view.map.VersionActivity2_3DungeonMapChapterLayout", package.seeall)

local VersionActivity2_3DungeonMapChapterLayout = class("VersionActivity2_3DungeonMapChapterLayout", BaseChildView)
local CHAPTER_KEY = "default"
local RIGHT_OFFSET_X = 600
local CONST_DUNGEON_NORMAL_DELTA_X = 100
local TWEEN_TIME = 0.26

function VersionActivity2_3DungeonMapChapterLayout:onInitView()
...
function VersionActivity2_3DungeonMapChapterLayout:addEvents()
	...
	self.addEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.GuideShowElement, self._GuideShowElement, self)

	if GamepadController.instance:isOpen() then
		self.addEventCb(self, GamepadController.instance, GamepadEvent.KeyUp, self._onGamepadKeyUp, self)
		self.addEventCb(self, DungeonController.instance, DungeonEvent.OnChangeFocusEpisodeItem, self._onChangeFocusEpisodeItem, self)
	end
end

function VersionActivity2_3DungeonMapChapterLayout:removeEvents()
	...
	self.removeEventCb(self, GamepadController.instance, GamepadEvent.KeyUp, self._onGamepadKeyUp, self)
	self.removeEventCb(self, DungeonController.instance, DungeonEvent.OnChangeFocusEpisodeItem, self._onChangeFocusEpisodeItem, self)
	self.removeEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.GuideShowElement, self._GuideShowElement, self)
end

function VersionActivity2_3DungeonMapChapterLayout:_onOpenView(viewName)
...
function VersionActivity2_3DungeonMapChapterLayout:_onCloseView(viewName)
	if viewName == ViewName.VersionActivity2_3DungeonMapLevelView then
...
function VersionActivity2_3DungeonMapChapterLayout:onActivityDungeonMoChange()
	self:updateFocusStatus()
	self:setFocusEpisodeId(self.activityDungeonMo.episodeId, true)
end

function VersionActivity2_3DungeonMapChapterLayout:updateFocusStatus()
	for _, episodeItem in pairs(self._episodeItemDict) do
		episodeItem:refreshFocusStatus()
	end
end

function VersionActivity2_3DungeonMapChapterLayout:_onGamepadKeyUp(key)
	local viewNameList = ViewMgr.instance:getOpenViewNameList()
	local topView = viewNameList[#viewNameList]

	if topView ~= ViewName.VersionActivity2_3DungeonMapView and topView ~= ViewName.VersionActivity2_3DungeonMapLevelView then
		return
	end
...
function VersionActivity2_3DungeonMapChapterLayout:_onChangeFocusEpisodeItem(item)
	if GamepadController.instance:isOpen() then
...
function VersionActivity2_3DungeonMapChapterLayout:_editableInitView()
	self._focusIndex = 0
	...
	if ViewMgr.instance:isOpening(ViewName.VersionActivity2_3DungeonMapLevelView) then
		self._timelineAnimation:Play("timeline_mask")
	end
end

function VersionActivity2_3DungeonMapChapterLayout:onUpdateParam()
	return
end

function VersionActivity2_3DungeonMapChapterLayout:onOpen()
	return
end

function VersionActivity2_3DungeonMapChapterLayout:refreshEpisodeNodes()
	self._episodeItemDict = self:getUserDataTb_()
...
function VersionActivity2_3DungeonMapChapterLayout:getEpisodeContainerItem(index)
...
function VersionActivity2_3DungeonMapChapterLayout:setFocusEpisodeId(episodeId, tween)
...
function VersionActivity2_3DungeonMapChapterLayout:setFocusItem(focusItemGo, tween)
...
function VersionActivity2_3DungeonMapChapterLayout:setFocusEpisodeItem(item, tween)
	local offsetX = -item.scrollContentPosX + self._constDungeonNormalPosX

	if tween then
		if not DungeonMapModel.instance.focusEpisodeTweenDuration then
			DungeonMapModel.instance.focusEpisodeTweenDuration = nil

			ZProj.TweenHelper.DOAnchorPosX(self.contentTransform, offsetX, DungeonMapModel.instance.focusEpisodeTweenDuration)
		end
	else
		recthelper.setAnchorX(self.contentTransform, offsetX)
	end
...
function VersionActivity2_3DungeonMapChapterLayout:setSelectEpisodeItem(episodeItem)
...
function VersionActivity2_3DungeonMapChapterLayout:playAnimation(aniName)
	self.animator:Play(aniName, 0, 0)
end

function VersionActivity2_3DungeonMapChapterLayout:playEpisodeItemAnimation(aniName)
...
function VersionActivity2_3DungeonMapChapterLayout:setSelectEpisodeId(episodeId, skipAni)
...
function VersionActivity2_3DungeonMapChapterLayout:isSelectedEpisodeRightEpisode(episodeItem)
	local result = false
...
function VersionActivity2_3DungeonMapChapterLayout:_GuideShowElement(elementId)
	...
	if elementCo then
		...
		VersionActivity2_3DungeonController.instance:dispatchEvent(VersionActivity2_3DungeonEvent.FocusElement, id)
	end
end

function VersionActivity2_3DungeonMapChapterLayout:onClose()
	for i, v in pairs(self._episodeContainerItemList) do
		v.episodeItem:destroyView()
	end
end

function VersionActivity2_3DungeonMapChapterLayout:onDestroyView()
	return
end

return VersionActivity2_3DungeonMapChapterLayout
