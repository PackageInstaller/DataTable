-- chunkname: @modules/logic/versionactivity2_3/dungeon/view/map/VersionActivity2_3DungeonMapEpisodeItem.lua

module("modules.logic.versionactivity2_3.dungeon.view.map.VersionActivity2_3DungeonMapEpisodeItem", package.seeall)

local VersionActivity2_3DungeonMapEpisodeItem = class("VersionActivity2_3DungeonMapEpisodeItem", BaseChildView)

function VersionActivity2_3DungeonMapEpisodeItem:onInitView()
...
function VersionActivity2_3DungeonMapEpisodeItem:addEvents()
...
function VersionActivity2_3DungeonMapEpisodeItem:removeEvents()
...
function VersionActivity2_3DungeonMapEpisodeItem:onClick()
	if self.isLock then
	...
	local viewContainer = ViewMgr.instance:getContainer(ViewName.VersionActivity2_3DungeonMapLevelView)
...
function VersionActivity2_3DungeonMapEpisodeItem:_editableInitView()
...
function VersionActivity2_3DungeonMapEpisodeItem:_showEye()
	...
	local isHard = self._config.chapterId == VersionActivity2_3DungeonEnum.DungeonChapterId.Hard

	gohelper.setActive(self._gonormaleye, not isHard)
	gohelper.setActive(self._gohardeye, isHard)
end

function VersionActivity2_3DungeonMapEpisodeItem:initViewParam()
	self._contentTransform = self.viewParam[1]
	self._layout = self.viewParam[2]
	self._mapSceneView = self.viewContainer.mapScene
end

function VersionActivity2_3DungeonMapEpisodeItem:onUpdateParam()
	self:initViewParam()
	self:_showAllElementTipView()
end

function VersionActivity2_3DungeonMapEpisodeItem:onOpen()
	self:initViewParam()
end

function VersionActivity2_3DungeonMapEpisodeItem:getMapAllElementList()
	return (VersionActivity2_3DungeonModel.instance:getElementCoList(self._map.id))
end

function VersionActivity2_3DungeonMapEpisodeItem:_showAllElementTipView()
	if not self._map or self._config.chapterId == VersionActivity2_3DungeonEnum.DungeonChapterId.Hard then
	...
	local finishElementCoList, mapAllElementList = VersionActivity2_3DungeonModel.instance:getElementCoListWithFinish(self._map.id)
...
function VersionActivity2_3DungeonMapEpisodeItem:_hideAllElementTip()
	gohelper.setActive(self._gotipcontent, false)
end

function VersionActivity2_3DungeonMapEpisodeItem:refresh(config, dungeonMo)
	self._config = config
	...
	self._map = VersionActivity2_3DungeonConfig.instance:getEpisodeMapConfig(self._config.id)
...
function VersionActivity2_3DungeonMapEpisodeItem:refreshUI()
...
function VersionActivity2_3DungeonMapEpisodeItem:refreshLock()
	self.isLock = self:checkLock()

	gohelper.setActive(self.goLock, self:checkLock())
end

function VersionActivity2_3DungeonMapEpisodeItem:initElementIdList()
...
function VersionActivity2_3DungeonMapEpisodeItem:clearElementIdList()
	self.elementIdList = nil
end

function VersionActivity2_3DungeonMapEpisodeItem:checkLock()
...
function VersionActivity2_3DungeonMapEpisodeItem:refreshStar()
...
function VersionActivity2_3DungeonMapEpisodeItem:refreshFlag()
	gohelper.setActive(self._goflag, false)
end

function VersionActivity2_3DungeonMapEpisodeItem:refreshUnlockContent()
	if self.pass then
...
function VersionActivity2_3DungeonMapEpisodeItem:refreshHardModeStar()
...
function VersionActivity2_3DungeonMapEpisodeItem:refreshStoryModeStar()
	local starItem
...
function VersionActivity2_3DungeonMapEpisodeItem:refreshEpisodeStar(starItem, episodeId)
...
function VersionActivity2_3DungeonMapEpisodeItem:refreshFocusStatus()
	gohelper.setActive(self.goSelected, self._config.id == self.activityDungeonMo.episodeId)
end

function VersionActivity2_3DungeonMapEpisodeItem:beginShowRewardView()
	self.beginReward = true
end

function VersionActivity2_3DungeonMapEpisodeItem:endShowRewardView()
...
function VersionActivity2_3DungeonMapEpisodeItem:calculatePosInContent()
	...
	self._maxWidth = math.max(halfWidth * 2, VersionActivity2_3DungeonEnum.EpisodeItemMinWidth) + 30
...
function VersionActivity2_3DungeonMapEpisodeItem:setImage(image, light, episodeId)
	local episodeConfig = DungeonConfig.instance:getEpisodeCO(episodeId)
	local starType = VersionActivity2_3DungeonEnum.EpisodeStarType[episodeConfig.chapterId]

	if light then
		if not starType.light then
			local lightStateIcon = starType.empty

			UISpriteSetMgr.instance:setV2a3DungeonSprite(image, lightStateIcon)
		end
	end
end

function VersionActivity2_3DungeonMapEpisodeItem:getMaxWidth()
	return self._maxWidth
end

function VersionActivity2_3DungeonMapEpisodeItem:updateSelectStatus(selectedItem, ignoreAni)
...
function VersionActivity2_3DungeonMapEpisodeItem:onRemoveElement(elementId)
...
function VersionActivity2_3DungeonMapEpisodeItem:playUnLockAnimation()
	local animator = self.goLock:GetComponent(typeof(UnityEngine.Animator))

	animator.enabled = true
end

function VersionActivity2_3DungeonMapEpisodeItem:playAnimation(animationName)
...
function VersionActivity2_3DungeonMapEpisodeItem:getEpisodeId()
	return self._config and self._config.id
end

function VersionActivity2_3DungeonMapEpisodeItem:createStarItem(goStar)
...
function VersionActivity2_3DungeonMapEpisodeItem:onClose()
	TaskDispatcher.cancelTask(self._hideAllElementTip, self)
end

function VersionActivity2_3DungeonMapEpisodeItem:onDestroyView()
	self.goClick:RemoveClickListener()
end

return VersionActivity2_3DungeonMapEpisodeItem
