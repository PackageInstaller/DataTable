...
function VersionActivity2_3DungeonMapScene:addEvents()
	...
	self.addEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.FocusElement, self.onFocusElement, self)
	self.addEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.ManualClickElement, self.manualClickElement, self)
...
function VersionActivity2_3DungeonMapScene:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.FocusElement, self.onFocusElement, self)
	self.removeEventCb(self, VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.ManualClickElement, self.manualClickElement, self)
...
function VersionActivity2_3DungeonMapScene:_onRecheckElement(elementId, isGM)
