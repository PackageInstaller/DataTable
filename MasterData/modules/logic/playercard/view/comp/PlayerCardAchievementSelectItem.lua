...
function PlayerCardAchievementSelectItem:_btngroupselectOnClick()
	...
	AudioMgr.instance:trigger((isSelected or nil) and (AudioEnum.UI.play_ui_hero_card_click or AudioEnum.UI.play_ui_hero_card_gone))
end
...
function PlayerCardAchievementSelectItem:_playAnim()
	...
	if self._mo.groupId ~= 0 then
		if not PlayerCardAchievementSelectItem.OneScreenItemCountInGroup then
			local maxCanPlayAnimItemCount = PlayerCardAchievementSelectItem.OneScreenItemCountInSingle
