...
function PlayerCardAchievementSelectListModel.sortAchievement(a, b)
	...
	elseif aIsSelected and bIsSelected then
		...
		if isGroup then
			if not PlayerCardAchievementSelectListModel.instance.groupSelectList then
				local sortList = PlayerCardAchievementSelectListModel.instance.singleSelectList
