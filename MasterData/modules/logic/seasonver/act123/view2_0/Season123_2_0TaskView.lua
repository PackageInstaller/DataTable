-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0TaskView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0TaskView", package.seeall)

local Season123_2_0TaskView = class("Season123_2_0TaskView", BaseView)

function Season123_2_0TaskView:onInitView()
...
function Season123_2_0TaskView:addEvents()
...
function Season123_2_0TaskView:removeEvents()
...
Season123_2_0TaskView.TaskMaskTime = 0.65
Season123_2_0TaskView.TaskGetAnimTime = 0.567
Season123_2_0TaskView.StageMapItemCount = 6
Season123_2_0TaskView.moveDistance = 50

function Season123_2_0TaskView:_btnrewardOnClick()
	self.curTaskType = Activity123Enum.TaskRewardViewType

	self:refreshUI()
end

function Season123_2_0TaskView:_btntaskOnClick()
	self.curTaskType = Activity123Enum.TaskNormalType

	self:refreshUI()
end

function Season123_2_0TaskView:_btnArrowDownOnClick()
	self.curStage = Mathf.Min(self.curStage + 1, Season123_2_0TaskView.StageMapItemCount)
...
function Season123_2_0TaskView:_btnArrowUpOnClick()
...
function Season123_2_0TaskView:_onScrollDragBegin(param, eventData)
	self.scrollStartPos = eventData.position
end

function Season123_2_0TaskView:_onScrollDragEnd(param, eventData)
	local moveOffset = eventData.position - self.scrollStartPos
	local canMove = Mathf.Abs(moveOffset.y) - Season123_2_0TaskView.moveDistance >= 0
...
function Season123_2_0TaskView:_editableInitView()
	...
	self._taskAnimRemoveItem:setMoveAnimationTime(Season123_2_0TaskView.TaskMaskTime - Season123_2_0TaskView.TaskGetAnimTime)
...
function Season123_2_0TaskView:onOpen()
...
function Season123_2_0TaskView:refreshUI()
...
function Season123_2_0TaskView:refreshRedDot()
...
function Season123_2_0TaskView:refreshArrowRedDot()
	...
	local downIndex = Mathf.Min(self.curStage + 1, Season123_2_0TaskView.StageMapItemCount)
...
function Season123_2_0TaskView:refreshArrowUI()
	gohelper.setActive(self._btnarrowdown.gameObject, self.curStage < Season123_2_0TaskView.StageMapItemCount)
	gohelper.setActive(self._btnarrowtop.gameObject, self.curStage > 1)
	self:refreshArrowRedDot()
end

function Season123_2_0TaskView:_playGetRewardFinishAnim(index)
	if index then
		self.removeIndexTab = {
			index
		}
	...
	TaskDispatcher.runDelay(self.delayPlayFinishAnim, self, Season123_2_0TaskView.TaskGetAnimTime)
end

function Season123_2_0TaskView:delayPlayFinishAnim()
	self._taskAnimRemoveItem:removeByIndexs(self.removeIndexTab)
end

function Season123_2_0TaskView:endEnterAnimBlock()
	UIBlockMgr.instance:endBlock("playEnterSeason123_2_0TaskViewAnim")
end

function Season123_2_0TaskView:createStageMapItem()
	for index = 1, Season123_2_0TaskView.StageMapItemCount do
		...
		if not stageMapItem then
			...
			stageMapItem.item = MonoHelper.addNoUpdateLuaComOnceToGo(stageMapItem.itemGO, Season123_2_0TaskMapItem, {
				stage = index,
				actId = self.actId
			})
...
function Season123_2_0TaskView:moveScrollPos()
	self.curStage = Season123TaskModel.instance.curStage
...
function Season123_2_0TaskView:onClose()
