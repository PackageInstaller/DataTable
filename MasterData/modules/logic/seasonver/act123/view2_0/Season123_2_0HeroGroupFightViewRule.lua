-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0HeroGroupFightViewRule.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0HeroGroupFightViewRule", package.seeall)

local Season123_2_0HeroGroupFightViewRule = class("Season123_2_0HeroGroupFightViewRule", BaseView)

function Season123_2_0HeroGroupFightViewRule:onInitView()
...
function Season123_2_0HeroGroupFightViewRule:addEvents()
...
function Season123_2_0HeroGroupFightViewRule:removeEvents()
...
function Season123_2_0HeroGroupFightViewRule:_btncloseruleOnClick()
...
function Season123_2_0HeroGroupFightViewRule:_btnadditionRuleOnClick()
...
function Season123_2_0HeroGroupFightViewRule:_btnenemyOnClick()
...
function Season123_2_0HeroGroupFightViewRule:_btnAdditionRuleDetailOnClick()
...
function Season123_2_0HeroGroupFightViewRule:_editableInitView()
...
function Season123_2_0HeroGroupFightViewRule:_refreshRules()
...
function Season123_2_0HeroGroupFightViewRule:_refreshAddition()
	local episodeId = HeroGroupModel.instance.episodeId
...
function Season123_2_0HeroGroupFightViewRule:_addRuleItem(ruleCo, targetId)
...
function Season123_2_0HeroGroupFightViewRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season123_2_0HeroGroupFightViewRule:_refreshEnemy()
...
function Season123_2_0HeroGroupFightViewRule:_recommendCareer()
...
function Season123_2_0HeroGroupFightViewRule:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_2_0HeroGroupFightViewRule:_onEnemyItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")
...
function Season123_2_0HeroGroupFightViewRule:onClose()
	self.removeEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._recommendCareer, self)
end

function Season123_2_0HeroGroupFightViewRule:onDestroyView()
	return
end

return Season123_2_0HeroGroupFightViewRule
