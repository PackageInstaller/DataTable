-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0BatchDecomposeView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0BatchDecomposeView", package.seeall)

local Season123_2_0BatchDecomposeView = class("Season123_2_0BatchDecomposeView", BaseView)

function Season123_2_0BatchDecomposeView:onInitView()
...
function Season123_2_0BatchDecomposeView:addEvents()
	...
	self.addEventCb(self, Season123EquipBookController.instance, Season123Event.OnResetBatchDecomposeView, self.resetDataUI, self)
	self.addEventCb(self, Season123EquipBookController.instance, Season123Event.OnDecomposeItemSelect, self.onDecomposeItemClick, self)
	self.addEventCb(self, Season123EquipBookController.instance, Season123Event.OnItemChange, self.refreshUI, self)
end

function Season123_2_0BatchDecomposeView:removeEvents()
	...
	self.removeEventCb(self, Season123EquipBookController.instance, Season123Event.OnResetBatchDecomposeView, self.resetDataUI, self)
	self.removeEventCb(self, Season123EquipBookController.instance, Season123Event.OnDecomposeItemSelect, self.onDecomposeItemClick, self)
	self.removeEventCb(self, Season123EquipBookController.instance, Season123Event.OnItemChange, self.refreshUI, self)
end

Season123_2_0BatchDecomposeView.maxOverCount = 4

function Season123_2_0BatchDecomposeView:_btnrarerankOnClick()
...
function Season123_2_0BatchDecomposeView:_btnfilterOnClick()
	ViewMgr.instance:openView(ViewName.Season123_2_0DecomposeFilterView)
end

function Season123_2_0BatchDecomposeView:_btnfastaddOnClick()
...
function Season123_2_0BatchDecomposeView:_btnclearOnClick()
	Season123EquipBookController.instance:clearItemSelectState()
	self:resetDataUI()
end

function Season123_2_0BatchDecomposeView:_btndecomposeOnClick()
...
function Season123_2_0BatchDecomposeView:showDecomposeTip()
	...
	local getCoinStr = string.format("<color=#AB5220>%s%s</color>", totalCount, coinConfig.name)
...
function Season123_2_0BatchDecomposeView:decomposeYesCallBack()
...
function Season123_2_0BatchDecomposeView:sendDecomposeRequest()
...
function Season123_2_0BatchDecomposeView:_dropFilterOnClick()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Common_Click)
end

function Season123_2_0BatchDecomposeView:_editableInitView()
...
function Season123_2_0BatchDecomposeView:onOpen()
...
function Season123_2_0BatchDecomposeView:initDropFilter()
	...
	for i = 1, Season123_2_0BatchDecomposeView.maxOverCount do
...
function Season123_2_0BatchDecomposeView:refreshUI()
	local coinConfig = CurrencyConfig.instance:getCurrencyCo(self.coinId)
...
function Season123_2_0BatchDecomposeView:initCoinItem()
...
function Season123_2_0BatchDecomposeView:onDecomposeItemClick()
	self._countAnim:Play("vx_count", 0, 0)
	AudioMgr.instance:trigger(AudioEnum.Season123.play_ui_checkpoint_light_up)
	self:refreshUI()
end

function Season123_2_0BatchDecomposeView:resetDataUI()
...
function Season123_2_0BatchDecomposeView:getDecomposeCoin()
...
function Season123_2_0BatchDecomposeView:dropFilterValueChanged(index)
	Season123DecomposeModel.instance:setCurOverPartSelectIndex(index)
end

function Season123_2_0BatchDecomposeView:onDropListShow()
	transformhelper.setLocalScale(self._arrowTrans, 1, -1, 1)
end

function Season123_2_0BatchDecomposeView:onDropListHide()
	transformhelper.setLocalScale(self._arrowTrans, 1, 1, 1)
end

function Season123_2_0BatchDecomposeView:onClose()
	Season123DecomposeModel.instance._itemStartAnimTime = nil
end

function Season123_2_0BatchDecomposeView:onDestroyView()
...
return Season123_2_0BatchDecomposeView
