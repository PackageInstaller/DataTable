-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0RetailView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0RetailView", package.seeall)

local Season123_2_0RetailView = class("Season123_2_0RetailView", BaseView)

function Season123_2_0RetailView:onInitView()
...
function Season123_2_0RetailView:addEvents()
...
function Season123_2_0RetailView:onOpen()
...
function Season123_2_0RetailView:onClose()
	return
end

function Season123_2_0RetailView:refreshUI()
	self:refreshInfo()
...
function Season123_2_0RetailView:refreshInfo()
...
function Season123_2_0RetailView:initIconUI()
...
function Season123_2_0RetailView:refreshRecommendLv()
...
function Season123_2_0RetailView:refreshRewards()
...
function Season123_2_0RetailView:refreshCardPackageUI()
...
function Season123_2_0RetailView:getOrCreateRewardItem(index)
...
function Season123_2_0RetailView:refreshTicket()
...
function Season123_2_0RetailView:handleItemChanged()
	self:refreshCardPackageUI()
	self:refreshTicket()
end

function Season123_2_0RetailView:_btncelebrityOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

function Season123_2_0RetailView:_btncardsOnClick()
	Season123Controller.instance:openSeasonCardPackageView({
		actId = self.viewParam.actId
	})
end

function Season123_2_0RetailView:onClickIcon(index)
...
function Season123_2_0RetailView:_btnstartOnClick()
	Season123RetailController.instance:enterRetailFightScene()
end

return Season123_2_0RetailView
