-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EnemyRule.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EnemyRule", package.seeall)

local Season123_2_0EnemyRule = class("Season123_2_0EnemyRule", BaseView)

function Season123_2_0EnemyRule:onInitView()
...
function Season123_2_0EnemyRule:addEvents()
...
function Season123_2_0EnemyRule:removeEvents()
	self._btnadditionRuleclick:RemoveClickListener()
	self._btncloserule:RemoveClickListener()
end

function Season123_2_0EnemyRule:_btncloseruleOnClick()
...
function Season123_2_0EnemyRule:_btnadditionRuleOnClick()
	self._ruleItemClick = self._goruledesc.activeSelf

	gohelper.setActive(self._goruledesc, true)
end

function Season123_2_0EnemyRule:_editableInitView()
...
function Season123_2_0EnemyRule:_addRuleItem(ruleCo, targetId)
...
function Season123_2_0EnemyRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season123_2_0EnemyRule:_clear()
...
function Season123_2_0EnemyRule:onDestroyView()
	self:_clear()
end

return Season123_2_0EnemyRule
