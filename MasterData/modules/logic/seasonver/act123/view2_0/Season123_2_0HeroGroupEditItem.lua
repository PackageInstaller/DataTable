-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0HeroGroupEditItem.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0HeroGroupEditItem", package.seeall)

local Season123_2_0HeroGroupEditItem = class("Season123_2_0HeroGroupEditItem", ListScrollCell)

function Season123_2_0HeroGroupEditItem:init(go)
...
function Season123_2_0HeroGroupEditItem:_initObj(go)
...
function Season123_2_0HeroGroupEditItem:addEventListeners()
...
function Season123_2_0HeroGroupEditItem:removeEventListeners()
	return
end

function Season123_2_0HeroGroupEditItem:_onSkinChanged()
	self._heroItem:updateHero()
end

function Season123_2_0HeroGroupEditItem:_onAttributeChanged(level, heroId)
	self._heroItem:setLevel(level, heroId)
end

function Season123_2_0HeroGroupEditItem:setAdventureBuff(buffId)
	self._heroItem:setAdventureBuff(buffId)
end

function Season123_2_0HeroGroupEditItem:updateLimitStatus()
...
function Season123_2_0HeroGroupEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_2_0HeroGroupEditItem:refreshHp()
...
function Season123_2_0HeroGroupEditItem:refreshDead()
	if Season123HeroGroupModel.instance:isEpisodeSeason123() then
		local isDead = false
		local actId = Season123HeroGroupEditModel.instance.activityId
		local stage = Season123HeroGroupEditModel.instance.stage
...
function Season123_2_0HeroGroupEditItem:onSelect(select)
...
function Season123_2_0HeroGroupEditItem:_onItemClick()
...
function Season123_2_0HeroGroupEditItem:checkRestrict(heroUid)
...
function Season123_2_0HeroGroupEditItem:checkHpZero(heroUid)
	local actId = Season123HeroGroupEditModel.instance.activityId
	local stage = Season123HeroGroupEditModel.instance.stage
	local layer = Season123HeroGroupEditModel.instance.layer
...
function Season123_2_0HeroGroupEditItem:enableDeselect(enable)
	self._enableDeselect = enable
end

function Season123_2_0HeroGroupEditItem:setHp(hpRate)
...
function Season123_2_0HeroGroupEditItem:onDestroy()
	return
end

function Season123_2_0HeroGroupEditItem:getAnimator()
	return self._animator
end

return Season123_2_0HeroGroupEditItem
