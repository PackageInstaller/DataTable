-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0DecomposeFilterView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0DecomposeFilterView", package.seeall)

local Season123_2_0DecomposeFilterView = class("Season123_2_0DecomposeFilterView", BaseView)

function Season123_2_0DecomposeFilterView:onInitView()
...
function Season123_2_0DecomposeFilterView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
	self._btnreset:AddClickListener(self._btnresetOnClick, self)
	self._btnconfirm:AddClickListener(self._btnconfirmOnClick, self)
end

function Season123_2_0DecomposeFilterView:removeEvents()
	self._btnclose:RemoveClickListener()
	self._btnreset:RemoveClickListener()
	self._btnconfirm:RemoveClickListener()
end

function Season123_2_0DecomposeFilterView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_0DecomposeFilterView:_btnresetOnClick()
...
function Season123_2_0DecomposeFilterView:_btnconfirmOnClick()
...
function Season123_2_0DecomposeFilterView:_editableInitView()
...
function Season123_2_0DecomposeFilterView:onOpen()
	self:createRareItem()
	self:createTagItem()
	self:refreshUI()
end

function Season123_2_0DecomposeFilterView:refreshUI()
	self:refreshRareSelectUI()
	self:refreshTagSelectUI()
end

function Season123_2_0DecomposeFilterView:refreshRareSelectUI()
...
function Season123_2_0DecomposeFilterView:refreshTagSelectUI()
...
function Season123_2_0DecomposeFilterView:createRareItem()
	for i = 5, 1, -1 do
...
function Season123_2_0DecomposeFilterView:rareItemOnClick(rare)
...
function Season123_2_0DecomposeFilterView:setRareSelectState(itemRare)
	self.rareSelectTab[itemRare] = not self.rareSelectTab[itemRare]
end

function Season123_2_0DecomposeFilterView:createTagItem()
...
function Season123_2_0DecomposeFilterView:tagItemSort(tagConfig)
	local tagConfigData = {}
...
function Season123_2_0DecomposeFilterView:tagItemShow(obj, data, index)
	local tagItem = {}
...
function Season123_2_0DecomposeFilterView:tagItemOnClick(data)
	local tagId = data.id
...
function Season123_2_0DecomposeFilterView:setTagSelectState(tagId)
	self.tagSelectTab[tagId] = not self.tagSelectTab[tagId]
end

function Season123_2_0DecomposeFilterView:onClose()
	return
end

function Season123_2_0DecomposeFilterView:onDestroyView()
...
return Season123_2_0DecomposeFilterView
