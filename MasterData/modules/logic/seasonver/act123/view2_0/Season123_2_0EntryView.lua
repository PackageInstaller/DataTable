-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EntryView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EntryView", package.seeall)

local Season123_2_0EntryView = class("Season123_2_0EntryView", BaseView)

function Season123_2_0EntryView:onInitView()
...
function Season123_2_0EntryView:addEvents()
...
function Season123_2_0EntryView:removeEvents()
...
function Season123_2_0EntryView:_editableInitView()
	self._entryList = {}
	self._centerItem = nil
end

function Season123_2_0EntryView:onDestroyView()
...
function Season123_2_0EntryView:onOpen()
...
function Season123_2_0EntryView:onClose()
...
function Season123_2_0EntryView:checkFirstOpenOverview()
...
function Season123_2_0EntryView:checkSceneIsLoaded()
	return
end

function Season123_2_0EntryView:refreshUI()
...
function Season123_2_0EntryView:refreshCenter()
	if self._centerItem then
...
function Season123_2_0EntryView:refreshPageBtn()
...
function Season123_2_0EntryView:refreshCardPackageUI()
...
function Season123_2_0EntryView:refreshUTTURetailTicket()
...
function Season123_2_0EntryView:refreshStoreCoin()
...
function Season123_2_0EntryView:refreshRemainTime()
	local actMO = ActivityModel.instance:getActMO(self.viewParam.actId)
...
function Season123_2_0EntryView:handleGetActInfo(actId)
	if self.viewParam.actId == actId then
		self:refreshUI()
	end
end

function Season123_2_0EntryView:handleOtherViewAutoOpened()
	self._anim:Play(Season123_2_0EntryView.Anim.Close)
end

function Season123_2_0EntryView:handleItemChanged()
	self:refreshUTTURetailTicket()
	self:refreshStoreCoin()
end

function Season123_2_0EntryView:handleSceneLoaded()
	self:checkSceneLoaded()
end

function Season123_2_0EntryView:handleStageFinishWithoutStory()
	if self._anim then
		self._anim:Play(Season123_2_0EntryView.Anim.Switch, 0, 0)
	end
end

function Season123_2_0EntryView:checkSceneLoaded()
	if self._isCenterInited then
		return
	end

	local sceneRoot = CameraMgr.instance:getSceneRoot()
	local sceneGO = gohelper.findChild(sceneRoot, "Season123_2_0EntryScene/scene")

	if sceneGO then
		gohelper.setActive(self._goentranceitem, true)

		self._centerItem = Season123_2_0EntryItem.New()
...
function Season123_2_0EntryView:_btnprevOnClick()
	UIBlockMgrExtend.instance:setNeedCircleMv(false)
	UIBlockMgr.instance:startBlock("switchStage")
	self._animExcessive:Play(Season123_2_0EntryView.Anim.Hard)
...
function Season123_2_0EntryView:_btnnextOnClick()
	UIBlockMgrExtend.instance:setNeedCircleMv(false)
	UIBlockMgr.instance:startBlock("switchStage")
	self._animExcessive:Play(Season123_2_0EntryView.Anim.Story)
	AudioMgr.instance:trigger(AudioEnum.UI.season123_stage_switch)
...
function Season123_2_0EntryView:_btnStoreOnClick()
	Season123Controller.instance:openSeasonStoreView(self.viewParam.actId)
end

function Season123_2_0EntryView:_btnStoryOnClick()
	Season123Controller.instance:openSeasonStoryView({
		actId = self.viewParam.actId
	})
end

function Season123_2_0EntryView:_btnEquipBookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

function Season123_2_0EntryView:_btnOverviewOnClick()
	Season123Controller.instance:openSeasonOverview({
		actId = self.viewParam.actId
	})
end

function Season123_2_0EntryView:_btnAchievementOnClick()
	Season123Controller.instance:openSeasonTaskView({
		actId = self.viewParam.actId
	})
end

function Season123_2_0EntryView:_btnCardPackageOnClick()
	Season123Controller.instance:openSeasonCardPackageView({
		actId = self.viewParam.actId
	})
end

function Season123_2_0EntryView:_btnRetailOnClick()
...
function Season123_2_0EntryView:_enterRetailView()
	Season123Controller.instance:openSeasonRetail({
		actId = self.viewParam.actId
	})
end

function Season123_2_0EntryView:_btnTrialOnClick()
	Season123EntryController.instance:enterTrailFightScene()
end

function Season123_2_0EntryView:onCloseView(viewName)
	if viewName == ViewName.Season123_2_0EpisodeListView then
		self._anim:Play(Season123_2_0EntryView.Anim.Switch1, 0, 0)
	end

	if viewName == ViewName.Season123_2_0RetailView then
		self._anim:Play(Season123_2_0EntryView.Anim.Switch, 0, 0)
	end

	if viewName == ViewName.Season123_2_0StoryPagePopView then
		self._anim:Play(Season123_2_0EntryView.Anim.Switch, 0, 0)
		TaskDispatcher.runDelay(self._autoClickNext, self, 0.5)
	end
end

function Season123_2_0EntryView:_switchStage()
	Season123EntryController.instance:switchStage(self.isNext)

	self.isNext = nil
end

function Season123_2_0EntryView:_endBlock()
	UIBlockMgr.instance:endBlock("switchStage")
	UIBlockMgrExtend.instance:setNeedCircleMv(true)
end

function Season123_2_0EntryView:initRedDot()
...
function Season123_2_0EntryView:checkHasReadUnlockStory()
	Season123Controller.instance:checkHasReadUnlockStory(self.viewParam.actId)
end

function Season123_2_0EntryView:_autoClickNext()
