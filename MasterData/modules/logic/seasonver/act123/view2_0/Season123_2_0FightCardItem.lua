-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0FightCardItem.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0FightCardItem", package.seeall)

local Season123_2_0FightCardItem = class("Season123_2_0FightCardItem", UserDataDispose)

function Season123_2_0FightCardItem:ctor(go)
	self:__onInit()
...
Season123_2_0FightCardItem.MainRoleItemMinHeight = 390
Season123_2_0FightCardItem.NormalRoleItemMinHeight = 315
Season123_2_0FightCardItem.RoleCardPos = {
	Vector2(-16.5, 0.5),
	Vector2(-16.5, 0.5),
	Vector2(-16.5, -6.5),
	Vector2(-16.5, -17),
...
function Season123_2_0FightCardItem:setData(data)
	if not data then
	...
	if self.isMainRole then
		self.layoutElement.minHeight = Season123_2_0FightCardItem.MainRoleItemMinHeight or Season123_2_0FightCardItem.NormalRoleItemMinHeight
	end
...
function Season123_2_0FightCardItem:_setName()
	if self.isMainRole then
...
function Season123_2_0FightCardItem:_setHead()
...
function Season123_2_0FightCardItem:getHeroMO()
...
function Season123_2_0FightCardItem:_setCard(equipId)
	if not self.cardItem then
		self.cardItem = Season123_2_0CelebrityCardItem.New()
	...
	local targetCardPos = Season123_2_0FightCardItem.RoleCardPos[tonumber(rare)] or Vector2(0, 0)

	recthelper.setAnchor(self.goCardPos.transform, targetCardPos.x, targetCardPos.y)
end

function Season123_2_0FightCardItem:_setDesc(equipId)
...
function Season123_2_0FightCardItem:createDescItem(index)
	local item = {}
...
function Season123_2_0FightCardItem:updateDescItem(item, skillStr)
...
function Season123_2_0FightCardItem:destroyDescItem(item)
	return
end

function Season123_2_0FightCardItem:destroy()
...
return Season123_2_0FightCardItem
