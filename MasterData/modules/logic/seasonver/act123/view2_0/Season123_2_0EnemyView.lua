-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EnemyView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EnemyView", package.seeall)

local Season123_2_0EnemyView = class("Season123_2_0EnemyView", BaseView)

function Season123_2_0EnemyView:onInitView()
...
function Season123_2_0EnemyView:addEvents()
...
function Season123_2_0EnemyView:removeEvents()
...
function Season123_2_0EnemyView:_editableInitView()
...
function Season123_2_0EnemyView:onDestroyView()
...
function Season123_2_0EnemyView:onOpen()
	self.addEventCb(self, Season123Controller.instance, Season123Event.EnemyDetailSwitchTab, self.refreshUI, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.EnemyDetailSelectEnemy, self.handleClickMonster, self)
	Season123EnemyController.instance:onOpenView(self.viewParam.actId, self.viewParam.stage, self.viewParam.layer)
	self:refreshUI()
end

function Season123_2_0EnemyView:onClose()
	self.removeEventCb(self, Season123Controller.instance, Season123Event.EnemyDetailSwitchTab, self.refreshUI, self)
	self.removeEventCb(self, Season123Controller.instance, Season123Event.EnemyDetailSelectEnemy, self.handleClickMonster, self)
end

function Season123_2_0EnemyView:handleClickMonster()
	self:refreshMonsterSelect()
	self:refreshEnemyInfo()
end

function Season123_2_0EnemyView:_onClickClosePassiveView()
	gohelper.setActive(self._gobuffpassiveview, false)

	self.isopenpassiveview = false
end

function Season123_2_0EnemyView:refreshUI()
...
function Season123_2_0EnemyView:getOrCreateGroupItem(i)
...
function Season123_2_0EnemyView:refreshEnemyGroup(i, monsterGroupIds, enemyGroupItemTable)
	local isBoss = false
...
function Season123_2_0EnemyView:getOrCreateEnemyItem(itemGroup, groupIndex, itemIndex)
...
function Season123_2_0EnemyView:onClickMonsterIcon(clickInfo)
...
function Season123_2_0EnemyView:refreshEnemyItem(enemyItemTable, monsterId, groupIndex)
	local monsterConfig = lua_monster.configDict[monsterId]
	local skinConfig = FightConfig.instance:getSkinCO(monsterConfig.skinId)
...
function Season123_2_0EnemyView:refreshMonsterSelect()
	local monsterGroupIds = Season123EnemyModel.instance:getCurrentBattleGroupIds()
...
function Season123_2_0EnemyView:refreshEnemyInfo()
...
function Season123_2_0EnemyView:_refreshSpeicalSkillIcon(monsterConfig)
...
function Season123_2_0EnemyView:_onBuffPassiveSkillClick()
...
function Season123_2_0EnemyView:_setPassiveSkillTip(skillgo, skillInfo)
...
function Season123_2_0EnemyView:_refreshPassiveSkill(monsterConfig, groupIndex)
...
function Season123_2_0EnemyView:_refreshSkill(monsterConfig)
	local skillIds = {}
...
function Season123_2_0EnemyView:_refreshSuper(monsterConfig)
...
function Season123_2_0EnemyView:createSuperItem()
...
function Season123_2_0EnemyView:_refreshAttribute(monsterConfig)
...
function Season123_2_0EnemyView:_onMonsterAttrItemShow(obj, data, index)
...
function Season123_2_0EnemyView:_onClickShowAttribute()
