-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0HeroGroupListView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0HeroGroupListView", package.seeall)

local Season123_2_0HeroGroupListView = class("Season123_2_0HeroGroupListView", BaseView)

function Season123_2_0HeroGroupListView:onInitView()
...
function Season123_2_0HeroGroupListView:_editableInitView()
	self._heroItemList = {}
	...
	for i = 1, 4 do
		...
		local item = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGO, Season123_2_0HeroGroupHeroItem, self)
...
function Season123_2_0HeroGroupListView:addEvents()
...
function Season123_2_0HeroGroupListView:removeEvents()
...
function Season123_2_0HeroGroupListView:onOpen()
	self._isOpen = true
...
function Season123_2_0HeroGroupListView:_playOpenAnimation()
...
function Season123_2_0HeroGroupListView:_checkRestrictHero()
...
function Season123_2_0HeroGroupListView:_removeRestrictHero()
...
function Season123_2_0HeroGroupListView:_onHeroGroupExit()
...
function Season123_2_0HeroGroupListView:_closeTweenFinish(index)
...
function Season123_2_0HeroGroupListView:canDrag(param, isWrap)
...
function Season123_2_0HeroGroupListView:_onBeginDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_2_0HeroGroupListView:_onDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_2_0HeroGroupListView:_onEndDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
	...
	if not canMoveTar or not canMoveSrc then
		...
		if not canMoveTar then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, posStrTar)
		end

		if not canMoveSrc then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, posStrSrc)
		end
...
function Season123_2_0HeroGroupListView:_setHeroItemPos(heroItem, index, tween, callback, callbackObj)
	local posTr = self.heroPosTrList[index]
...
function Season123_2_0HeroGroupListView:_tweenToPos(heroItem, anchorPos)
...
function Season123_2_0HeroGroupListView:_setDragEnabled(isEnabled)
	for i, drag in ipairs(self._heroItemDrag) do
		drag.enabled = isEnabled
	end
end

function Season123_2_0HeroGroupListView:_updateHeroList()
	for i, heroItem in ipairs(self._heroItemList) do
		local mo
...
function Season123_2_0HeroGroupListView:_onSnapshotSaveSucc()
	self:_updateHeroList()
...
function Season123_2_0HeroGroupListView:_calcIndex(position)
	for i = 1, 4 do
...
function Season123_2_0HeroGroupListView:onDestroyView()
...
function Season123_2_0HeroGroupListView:_onScreenSizeChange()
	for i = 1, ModuleEnum.MaxHeroCountInGroup do
		local heroItem = self._heroItemList[i]
...
function Season123_2_0HeroGroupListView:getHeroItemList()
	return self._heroItemList
end

return Season123_2_0HeroGroupListView
