-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0CardPackageView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0CardPackageView", package.seeall)

local Season123_2_0CardPackageView = class("Season123_2_0CardPackageView", BaseView)

function Season123_2_0CardPackageView:onInitView()
...
function Season123_2_0CardPackageView:addEvents()
...
function Season123_2_0CardPackageView:removeEvents()
...
Season123_2_0CardPackageView.hideCardPackageTime = 0.33

function Season123_2_0CardPackageView:_btnopenPackageOnClick()
	self:openCardPackage()
end

function Season123_2_0CardPackageView:_btnopenOnePackageOnClick()
	self:openCardPackage()
end

function Season123_2_0CardPackageView:_btnopenAllPackageOnClick()
...
function Season123_2_0CardPackageView:_onDragBegin(param, pointerEventData)
	self._startPos = pointerEventData.position.x
end

function Season123_2_0CardPackageView:_onDragEnd(param, pointerEventData)
...
function Season123_2_0CardPackageView:_btnskipOnClick()
...
function Season123_2_0CardPackageView:_btnquitOnClick()
	self:closeThis()
end

function Season123_2_0CardPackageView:_btnopenNextOnClick()
	self:openCardPackage()
end

function Season123_2_0CardPackageView:_editableInitView()
...
function Season123_2_0CardPackageView:onOpen()
...
function Season123_2_0CardPackageView:refreshCardPackageUI()
...
function Season123_2_0CardPackageView:showWaitingOpenView()
...
function Season123_2_0CardPackageView:playOpenCardAnim()
	self:refreshCardPackageUI()
...
function Season123_2_0CardPackageView:showCardGetView()
	self:refreshCardGetUI()
	TaskDispatcher.runDelay(self.hideCardPackageView, self, Season123_2_0CardPackageView.hideCardPackageTime)
...
function Season123_2_0CardPackageView:hideCardPackageView()
	gohelper.setActive(self._gocardpackage, false)

	self.hasClickSkip = false
end

function Season123_2_0CardPackageView:refreshCardGetUI()
...
function Season123_2_0CardPackageView:refreshScrollPos()
...
function Season123_2_0CardPackageView:openCardPackage()
	if self.hasClickOpen then
		return
	end
...
function Season123_2_0CardPackageView:stopOpenCardPackageAudio()
...
function Season123_2_0CardPackageView:onClose()
	TaskDispatcher.cancelTask(self.hideCardPackageView, self)
	self:stopOpenCardPackageAudio()
end

function Season123_2_0CardPackageView:onDestroyView()
	Season123CardPackageModel.instance:release()
end

return Season123_2_0CardPackageView
