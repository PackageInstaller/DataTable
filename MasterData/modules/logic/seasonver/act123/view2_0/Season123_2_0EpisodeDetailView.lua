-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EpisodeDetailView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EpisodeDetailView", package.seeall)

local Season123_2_0EpisodeDetailView = class("Season123_2_0EpisodeDetailView", BaseView)

function Season123_2_0EpisodeDetailView:onInitView()
...
function Season123_2_0EpisodeDetailView:addEvents()
...
function Season123_2_0EpisodeDetailView:removeEvents()
...
function Season123_2_0EpisodeDetailView:_editableInitView()
...
function Season123_2_0EpisodeDetailView:onDestroyView()
...
function Season123_2_0EpisodeDetailView:onOpen()
...
function Season123_2_0EpisodeDetailView:onOpenFinish()
...
function Season123_2_0EpisodeDetailView:onClose()
	TaskDispatcher.cancelTask(self._delayShowInfo, self)
end

function Season123_2_0EpisodeDetailView:handleDetailSwitchLayer(param)
...
function Season123_2_0EpisodeDetailView:_delayShowInfo()
	self:_showInfo()
end

function Season123_2_0EpisodeDetailView:refreshShowInfo()
	self:_showInfo()
end

function Season123_2_0EpisodeDetailView:_btnstartOnClick()
...
function Season123_2_0EpisodeDetailView:resetData()
	self._showLvItems = {}
...
function Season123_2_0EpisodeDetailView:noAudioShowInfoByOpen()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_leimi_theft_open)
	gohelper.setActive(self._goinfo, true)
	self:_showInfo()
end

function Season123_2_0EpisodeDetailView:_showInfo()
	self:_setInfo()
	self:_setParts()
	self:_setButton()
	self:_setResetInfo()
...
function Season123_2_0EpisodeDetailView:_setButton()
...
function Season123_2_0EpisodeDetailView:_setResetInfo()
	local needShowReset = Season123EpisodeDetailController.instance:isStageNeedClean() or Season123EpisodeDetailController.instance:isNextLayersNeedClean()
...
Season123_2_0EpisodeDetailView.NomalStageTagPos = Vector2(46.3, 2.7)
Season123_2_0EpisodeDetailView.NewStageTagPos = Vector2(4.37, 2.7)

function Season123_2_0EpisodeDetailView:_setInfo()
	local actId = Season123EpisodeDetailModel.instance.activityId
	local stage = Season123EpisodeDetailModel.instance.stage
	local layer = Season123EpisodeDetailModel.instance.layer
	...
	if isNewStage then
		if not Season123_2_0EpisodeDetailView.NewStageTagPos then
			local targetStageTagPos = Season123_2_0EpisodeDetailView.NomalStageTagPos
...
function Season123_2_0EpisodeDetailView:refreshEquipCardItem()
	...
	if episodeCo.firstPassEquipId and episodeCo.firstPassEquipId > 0 then
		...
		if not self._rewardItems[1].itemIcon then
			self._rewardItems[1].itemIcon = Season123_2_0CelebrityCardItem.New()
...
function Season123_2_0EpisodeDetailView:createRewardItem(index)
...
function Season123_2_0EpisodeDetailView:refreshRewardItem(item, itemInfo)
...
function Season123_2_0EpisodeDetailView:_setParts()
	local actId = Season123EpisodeDetailModel.instance.activityId
	local stage = Season123EpisodeDetailModel.instance.stage
	local layer = Season123EpisodeDetailModel.instance.layer
	local episodeCo = Season123Config.instance:getSeasonEpisodeCo(actId, stage, layer)
...
Season123_2_0EpisodeDetailView.UnLockStageItemAlpha = 1
Season123_2_0EpisodeDetailView.LockStageItemAlpha = 0.3

function Season123_2_0EpisodeDetailView:_showPartStarGroupItem(starGroup)
	if starGroup < 7 then
		...
		for i = 1, 6 do
			...
			if i <= starGroup then
				self._partStageItems[i].canvasgroup.alpha = Season123_2_0EpisodeDetailView.UnLockStageItemAlpha or Season123_2_0EpisodeDetailView.LockStageItemAlpha
			end
		end
	else
		for i = 1, 7 do
...
function Season123_2_0EpisodeDetailView:_btnlastOnClick()
...
function Season123_2_0EpisodeDetailView:_btnnextOnClick()
...
function Season123_2_0EpisodeDetailView:_btnresetOnClick()
...
return Season123_2_0EpisodeDetailView
