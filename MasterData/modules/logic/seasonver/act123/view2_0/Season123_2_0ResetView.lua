-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0ResetView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0ResetView", package.seeall)

local Season123_2_0ResetView = class("Season123_2_0ResetView", BaseView)

function Season123_2_0ResetView:onInitView()
...
function Season123_2_0ResetView:addEvents()
	self._btnreset:AddClickListener(self._btnresetOnClick, self)
end

function Season123_2_0ResetView:removeEvents()
	self._btnreset:RemoveClickListener()
end

function Season123_2_0ResetView:_editableInitView()
	self._heroItems = {}
	self._episodeItems = {}
...
function Season123_2_0ResetView:onDestroyView()
...
function Season123_2_0ResetView:onOpen()
...
function Season123_2_0ResetView:onClose()
	return
end

function Season123_2_0ResetView:refreshUI()
	self:refreshStatus()
	self:refreshStage()
...
function Season123_2_0ResetView:refreshStatus()
...
function Season123_2_0ResetView:refreshStage()
...
function Season123_2_0ResetView:refreshEpisodeItems()
...
function Season123_2_0ResetView:refreshEpisodeItem(index, data)
...
function Season123_2_0ResetView:refreshSingleItemFinished(index, item, data)
...
function Season123_2_0ResetView:refreshHeroItems()
...
function Season123_2_0ResetView:refreshHero(item, data)
	if not data then
...
function Season123_2_0ResetView:refreshHeroHp(item, data)
	if not data then
...
function Season123_2_0ResetView:createStageItem()
...
function Season123_2_0ResetView:getOrCreateEpisodeItem(index)
...
function Season123_2_0ResetView:getOrCreateHeroItem(index)
...
function Season123_2_0ResetView:delayInitScrollAudio()
	self._audioScroll = MonoHelper.addLuaComOnceToGo(self._goscrollchapter, Season123_2_0ResetViewAudio, self._scrollchapter)
...
function Season123_2_0ResetView:onDragAudioBegin()
	self._audioScroll:onDragBegin()
end

function Season123_2_0ResetView:onDragAudioEnd()
	self._audioScroll:onDragEnd()
end

function Season123_2_0ResetView:onClickAudioDown()
	self._audioScroll:onClickDown()
end

function Season123_2_0ResetView:onClickStageItem()
...
function Season123_2_0ResetView:onClickEpisodeItem(index)
...
function Season123_2_0ResetView:_btnresetOnClick()
	Season123ResetController.instance:tryReset()
end

return Season123_2_0ResetView
