-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0TaskMapItem.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0TaskMapItem", package.seeall)

local Season123_2_0TaskMapItem = class("Season123_2_0TaskMapItem", LuaCompBase)

function Season123_2_0TaskMapItem:ctor(param)
	self.param = param
end

function Season123_2_0TaskMapItem:init(go)
	self:__onInit()
...
function Season123_2_0TaskMapItem:addEventListeners()
	self.addEventCb(self, Season123Controller.instance, Season123Event.clickTaskMapItem, self.setScale, self)
end

function Season123_2_0TaskMapItem:removeEventListeners()
	self.removeEventCb(self, Season123Controller.instance, Season123Event.clickTaskMapItem, self.setScale, self)
end

function Season123_2_0TaskMapItem:onMapItemClick()
...
function Season123_2_0TaskMapItem:refreshUI()
...
function Season123_2_0TaskMapItem:setScale()
	if Season123TaskModel.instance.curStage == self.stage then
...
function Season123_2_0TaskMapItem:onDestroy()
	self:__onDispose()
...
return Season123_2_0TaskMapItem
