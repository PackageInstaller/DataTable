-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0FightSuccView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0FightSuccView", package.seeall)

local Season123_2_0FightSuccView = class("Season123_2_0FightSuccView", FightSuccView)

function Season123_2_0FightSuccView:onInitView()
...
function Season123_2_0FightSuccView:addEvents()
...
function Season123_2_0FightSuccView:removeEvents()
...
function Season123_2_0FightSuccView:_editableInitView()
	self._click = gohelper.getClick(self.viewGO)
end

function Season123_2_0FightSuccView:_onClickClose()
	if self._showEquipCard then
		return
	end

	Season123_2_0FightSuccView.super._onClickClose(self)
end

function Season123_2_0FightSuccView:onOpen()
	Season123_2_0FightSuccView.super.onOpen(self)
...
function Season123_2_0FightSuccView:_dealGetCard()
	local reward_list = {}
...
function Season123_2_0FightSuccView:_loadBonusItems()
	return
end

function Season123_2_0FightSuccView:_showGetCardView()
...
function Season123_2_0FightSuccView:_onTipsClose()
	self:_showRewardPart()
	self:_showPlayerLevelUpView()
end

function Season123_2_0FightSuccView:_showRewardPart()
	self._showEquipCard = nil

	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
	gohelper.setActive(self._bonusItemContainer, true)
	Season123_2_0FightSuccView.super._loadBonusItems(self)
end

function Season123_2_0FightSuccView:_onCloseViewFinish(viewName)
	local getViewName = ViewName.Season123_2_0CelebrityCardGetView
...
function Season123_2_0FightSuccView:_addItem(material)
...
function Season123_2_0FightSuccView:_setFbName(episodeCO)
	self._txtFbName.text = episodeCO.name
	self._txtFbNameEn.text = episodeCO.name_En
end

function Season123_2_0FightSuccView:_showGoal()
	gohelper.setActive(self._goallist, false)
end

function Season123_2_0FightSuccView:_checkTypeDetails()
	return
end

function Season123_2_0FightSuccView:_hideGoDemand()
	return
end

function Season123_2_0FightSuccView:onClose()
	...
	Season123_2_0FightSuccView.super.onClose(self)
end

function Season123_2_0FightSuccView:onDestroyView()
	Season123_2_0FightSuccView.super.onDestroyView(self)
end

return Season123_2_0FightSuccView
