-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0StoryPagePopView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0StoryPagePopView", package.seeall)

local Season123_2_0StoryPagePopView = class("Season123_2_0StoryPagePopView", BaseView)

function Season123_2_0StoryPagePopView:onInitView()
...
function Season123_2_0StoryPagePopView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_0StoryPagePopView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_2_0StoryPagePopView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_0StoryPagePopView:_editableInitView()
	self.transScrollDesc = self._scrolldesc.gameObject:GetComponent(gohelper.Type_RectTransform)
end

function Season123_2_0StoryPagePopView:onUpdateParam()
	return
end

function Season123_2_0StoryPagePopView:onOpen()
...
function Season123_2_0StoryPagePopView:refreshDetailPageUI()
...
Season123_2_0StoryPagePopView.scrollDescHeight = 650
Season123_2_0StoryPagePopView.maxDescSpacing = 41
Season123_2_0StoryPagePopView.minDescSpacing = 35
Season123_2_0StoryPagePopView.minDescFontSize = 27

function Season123_2_0StoryPagePopView:fitScrollHeight()
	...
	recthelper.setHeight(self.transScrollDesc, Season123_2_0StoryPagePopView.scrollDescHeight - heightOffset)
	TaskDispatcher.cancelTask(self.setDescSpacing, self)
	TaskDispatcher.runDelay(self.setDescSpacing, self, 0.01)
end

function Season123_2_0StoryPagePopView:setDescSpacing()
	self._txtdesc.lineSpacing = Mathf.Lerp(Season123_2_0StoryPagePopView.maxDescSpacing, Season123_2_0StoryPagePopView.minDescSpacing, self._txtdesc.fontSize - Season123_2_0StoryPagePopView.minDescFontSize)
end

function Season123_2_0StoryPagePopView:onClose()
	Season123Controller.instance:dispatchEvent(Season123Event.GuideEntryOtherViewClose)
	TaskDispatcher.cancelTask(self.setDescSpacing, self)
end

function Season123_2_0StoryPagePopView:onDestroyView()
	self._simagePolaroid:UnLoadImage()
end

return Season123_2_0StoryPagePopView
