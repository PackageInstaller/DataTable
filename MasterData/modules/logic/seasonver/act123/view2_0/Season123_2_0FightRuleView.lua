-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0FightRuleView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0FightRuleView", package.seeall)

local Season123_2_0FightRuleView = class("Season123_2_0FightRuleView", BaseView)

function Season123_2_0FightRuleView:onInitView()
...
function Season123_2_0FightRuleView:addEvents()
	return
end

function Season123_2_0FightRuleView:removeEvents()
	return
end

function Season123_2_0FightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function Season123_2_0FightRuleView:onOpen()
	self:refreshRule()
end

function Season123_2_0FightRuleView:refreshRule()
	local dataList = Season123_2_0FightRuleView.getRuleList() or {}
...
function Season123_2_0FightRuleView:createItem(index)
	local item = {}
...
function Season123_2_0FightRuleView:updateItem(item, data)
...
function Season123_2_0FightRuleView:destroyItem(item)
	return
end

function Season123_2_0FightRuleView.getRuleList()
...
function Season123_2_0FightRuleView:setDecorateVisible(isVisible)
...
function Season123_2_0FightRuleView:onClose()
	return
end

function Season123_2_0FightRuleView:onDestroyView()
...
return Season123_2_0FightRuleView
