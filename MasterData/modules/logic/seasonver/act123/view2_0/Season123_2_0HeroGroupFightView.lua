-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0HeroGroupFightView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0HeroGroupFightView", package.seeall)

local Season123_2_0HeroGroupFightView = class("Season123_2_0HeroGroupFightView", BaseView)

function Season123_2_0HeroGroupFightView:onInitView()
...
function Season123_2_0HeroGroupFightView:addEvents()
...
function Season123_2_0HeroGroupFightView:removeEvents()
...
function Season123_2_0HeroGroupFightView:_btnrecommendOnClick()
...
function Season123_2_0HeroGroupFightView:_btnclothOnClock()
...
function Season123_2_0HeroGroupFightView:_btnrestrainOnClick()
	ViewMgr.instance:openView(ViewName.HeroGroupCareerTipView)
end

Season123_2_0HeroGroupFightView.UIBlock_SeasonFight = "UIBlock_SeasonFight"

function Season123_2_0HeroGroupFightView:_btnstartseasonOnClick()
	if not self._blockStart then
		...
		UIBlockMgr.instance:startBlock(Season123_2_0HeroGroupFightView.UIBlock_SeasonFight)
	end
end

function Season123_2_0HeroGroupFightView:_btnseasonreplayOnClick()
	self:_onClickReplay()
end

function Season123_2_0HeroGroupFightView:_groupDropValueChanged(value)
...
function Season123_2_0HeroGroupFightView:_editableInitView()
	self:_initComponent()
	self:_initData()
	self:_addEvents()
end

function Season123_2_0HeroGroupFightView:onDestroyView()
	...
	UIBlockMgr.instance:endBlock(Season123_2_0HeroGroupFightView.UIBlock_SeasonFight)
end

function Season123_2_0HeroGroupFightView:onOpen()
...
function Season123_2_0HeroGroupFightView:_initComponent()
...
function Season123_2_0HeroGroupFightView:_initData()
...
function Season123_2_0HeroGroupFightView:_initDataOnOpen()
	if Season123HeroGroupModel.instance:isEpisodeSeason123() then
...
function Season123_2_0HeroGroupFightView:_addEvents()
...
function Season123_2_0HeroGroupFightView:_checkReplay()
...
function Season123_2_0HeroGroupFightView:initSeason123FightGroupDrop()
	local list = {}
...
function Season123_2_0HeroGroupFightView:_receiveRecommend(cmd, resultCode, msg)
...
function Season123_2_0HeroGroupFightView:_onClickReplay()
...
function Season123_2_0HeroGroupFightView:_switchReplayGroup(lastReplayMode)
	self:_refreshTips()
...
function Season123_2_0HeroGroupFightView:_refreshTips()
	return
end

function Season123_2_0HeroGroupFightView:_updateReplayHeroGroupList()
...
function Season123_2_0HeroGroupFightView:_switchReplayMul()
	self._txtreplaycount.text = self._replayMode and luaLang("multiple") .. Season123HeroGroupModel.instance.multiplication or ""
end

function Season123_2_0HeroGroupFightView:_heroMoveForward(heroId)
	HeroGroupEditListModel.instance:setMoveHeroId(tonumber(heroId))
end

function Season123_2_0HeroGroupFightView:handleStartFightFailed()
	self._blockStart = false

	UIBlockMgr.instance:endBlock(Season123_2_0HeroGroupFightView.UIBlock_SeasonFight)
end

function Season123_2_0HeroGroupFightView:isReplayMode()
	return self._replayMode
end

function Season123_2_0HeroGroupFightView:_onCurrencyChange(changeIds)
...
function Season123_2_0HeroGroupFightView:onClose()
	AudioMgr.instance:trigger(AudioEnum.UI.Stop_HeroNormalVoc)
	self:_removeEvents()
...
function Season123_2_0HeroGroupFightView:_removeEvents()
...
function Season123_2_0HeroGroupFightView:_refreshReplay()
...
function Season123_2_0HeroGroupFightView:_refreshCloth()
	...
	gohelper.setActive(self._btncloth.gameObject, Season123_2_0HeroGroupFightView.showCloth())
end

function Season123_2_0HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season123_2_0HeroGroupFightView.showCloth()
	...
	local episodeCO, battleCO = Season123_2_0HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season123_2_0HeroGroupFightView:_onModifyHeroGroup()
	self:_refreshCloth()
end

function Season123_2_0HeroGroupFightView:_onModifySnapshot()
	self:_refreshCloth()
end

function Season123_2_0HeroGroupFightView:_onClickHeroGroupItem(id)
...
function Season123_2_0HeroGroupFightView:_checkFirstPosHasEquip()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
...
function Season123_2_0HeroGroupFightView:_showGuideDragEffect(param)
	if self._dragEffectLoader then
		self._dragEffectLoader:dispose()
...
function Season123_2_0HeroGroupFightView:_onClickStart()
...
function Season123_2_0HeroGroupFightView:_enterFight()
	local result = false
...
function Season123_2_0HeroGroupFightView:_onUseRecommendGroup()
	if self._replayMode then
		self._replayMode = false
...
function Season123_2_0HeroGroupFightView:_refreshBtns()
...
function Season123_2_0HeroGroupFightView:_onGetFightRecordGroupReply(fightGroupMO)
	self.removeEventCb(self, FightController.instance, FightEvent.RespGetFightRecordGroupReply, self._onGetFightRecordGroupReply, self)
...
function Season123_2_0HeroGroupFightView:_updateReplayHeroGroup()
	HeroGroupModel.instance:setReplayParam(self._replayFightGroupMO)
	HeroGroupController.instance:dispatchEvent(HeroGroupEvent.SelectHeroGroup, self._replayFightGroupMO.id)
	self:_refreshCloth()
	gohelper.setActive(self._goherogroupcontain, false)
...
function Season123_2_0HeroGroupFightView:_playHeroGroupExitEffect()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
end

function Season123_2_0HeroGroupFightView:_playCloseHeroGroupAnimation()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
...
function Season123_2_0HeroGroupFightView:_closeHeroContainAnim()
	if self._heroContainAnim then
		self._heroContainAnim.enabled = false
	end
end

return Season123_2_0HeroGroupFightView
