-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EnemyTabList.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EnemyTabList", package.seeall)

local Season123_2_0EnemyTabList = class("Season123_2_0EnemyTabList", BaseView)

function Season123_2_0EnemyTabList:onInitView()
...
function Season123_2_0EnemyTabList:_editableInitView()
	self._simagebattlelistbg:LoadImage(ResUrl.getWeekWalkBg("bg_zuodi.png"))

	self._tabItems = {}
end

function Season123_2_0EnemyTabList:onDestroyView()
...
function Season123_2_0EnemyTabList:onOpen()
	self.addEventCb(self, Season123Controller.instance, Season123Event.EnemyDetailSwitchTab, self.refreshSelect, self)
	self:refreshUI()
end

function Season123_2_0EnemyTabList:refreshUI()
	self:refreshItems()
	self:refreshSelect()
end

function Season123_2_0EnemyTabList:refreshItems()
...
function Season123_2_0EnemyTabList:getOrCreateTabItem(index)
...
function Season123_2_0EnemyTabList:onClickTab(index)
	Season123EnemyController.instance:switchTab(index)
end

function Season123_2_0EnemyTabList:refreshSelect()
	local battleIds = Season123EnemyModel.instance:getBattleIds()
...
return Season123_2_0EnemyTabList
