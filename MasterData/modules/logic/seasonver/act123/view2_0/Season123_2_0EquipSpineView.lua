-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EquipSpineView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EquipSpineView", package.seeall)

local Season123_2_0EquipSpineView = class("Season123_2_0EquipSpineView", BaseView)

function Season123_2_0EquipSpineView:onInitView()
...
function Season123_2_0EquipSpineView:addEvents()
	return
end

function Season123_2_0EquipSpineView:removeEvents()
	return
end

function Season123_2_0EquipSpineView:_editableInitView()
	self._uiSpine = GuiModelAgent.Create(self._gospine, true)

	self:createSpine()
end

function Season123_2_0EquipSpineView:onDestroyView()
...
function Season123_2_0EquipSpineView:onOpen()
	self:refreshHeroSkin()
end

function Season123_2_0EquipSpineView:onClose()
	if self._uiSpine then
		self._uiSpine:setModelVisible(false)
	end
end

function Season123_2_0EquipSpineView:createSpine(skinConfig)
	if skinConfig then
		self._uiSpine:useRT()
...
function Season123_2_0EquipSpineView:refreshHeroSkin()
...
function Season123_2_0EquipSpineView:onSpineLoaded()
	self._spineLoaded = true

	self._uiSpine:setUIMask(true)
end

return Season123_2_0EquipSpineView
