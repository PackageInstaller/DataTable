-- chunkname: @modules/logic/seasonver/act123/view2_0/component/Season123_2_0EntryCamera.lua

module("modules.logic.seasonver.act123.view2_0.component.Season123_2_0EntryCamera", package.seeall)

local Season123_2_0EntryCamera = class("Season123_2_0EntryCamera", UserDataDispose)

function Season123_2_0EntryCamera:init()
	self:__onInit()
	self:initCamera()
end

function Season123_2_0EntryCamera:dispose()
	self:killTween()
	self:__onDispose()
	MainCameraMgr.instance:addView(ViewName.Season123_2_0EntryView, nil, nil, nil)
end

function Season123_2_0EntryCamera:initCamera()
	...
	MainCameraMgr.instance:addView(ViewName.Season123_2_0EntryView, self.onScreenResize, self.resetCamera, self)
	self:onScreenResize()
end

function Season123_2_0EntryCamera:onScreenResize()
	self:killTween()
...
function Season123_2_0EntryCamera:setScaleWithoutTween(scale)
	local camera = CameraMgr.instance:getMainCamera()
...
function Season123_2_0EntryCamera:tweenToScale(targetScale, time, callback, callbackObj)
	self:killTween()
...
function Season123_2_0EntryCamera:killTween()
...
function Season123_2_0EntryCamera:onTweenSizeUpdate(value)
	local camera = CameraMgr.instance:getMainCamera()
...
function Season123_2_0EntryCamera:onTweenFinish()
...
function Season123_2_0EntryCamera:getCurrentOrthographicSize()
	local scale = GameUtil.getAdapterScale(true)

	return self._seasonSize * scale * self._seasonScale
end

return Season123_2_0EntryCamera
