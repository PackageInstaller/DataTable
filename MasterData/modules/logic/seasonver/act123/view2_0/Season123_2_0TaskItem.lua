-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0TaskItem.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0TaskItem", package.seeall)

local Season123_2_0TaskItem = class("Season123_2_0TaskItem", ListScrollCell)

Season123_2_0TaskItem.BlockKey = "Season123_2_0TaskItemAni"

function Season123_2_0TaskItem:init(go)
	self._viewGO = go
...
function Season123_2_0TaskItem:addEventListeners()
...
function Season123_2_0TaskItem:initTotal()
	self._btnGetTotal = gohelper.findChildButtonWithAudio(self._goTotal, "#btn_getall")
end

Season123_2_0TaskItem.TaskMaskTime = 0.65
Season123_2_0TaskItem.ColumnCount = 1
Season123_2_0TaskItem.AnimRowCount = 7
Season123_2_0TaskItem.OpenAnimTime = 0.06
Season123_2_0TaskItem.OpenAnimStartTime = 0

function Season123_2_0TaskItem:onUpdateMO(mo)
	if mo == nil then
		return
	end
...
function Season123_2_0TaskItem:endPlayOpenAnim()
...
function Season123_2_0TaskItem:checkPlayAnim()
...
function Season123_2_0TaskItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_2_0TaskItem:refreshNormal()
...
function Season123_2_0TaskItem:refreshReward()
...
function Season123_2_0TaskItem:createRewardItem(index)
...
function Season123_2_0TaskItem:refreshRewardItem(item, data)
	if not data then
	...
	if data.equipId then
		...
		if not item.equipIcon then
			item.equipIcon = Season123_2_0CelebrityCardItem.New()
...
function Season123_2_0TaskItem:getAnimator()
	return self._ani
end

function Season123_2_0TaskItem:destroyRewardItem(item)
...
function Season123_2_0TaskItem:refreshDesc()
	local config = self.mo.config
...
function Season123_2_0TaskItem:refreshProgress()
...
function Season123_2_0TaskItem:refreshState()
...
function Season123_2_0TaskItem:onClickGoto()
...
function Season123_2_0TaskItem:onClickReceive()
	...
	UIBlockMgr.instance:startBlock(Season123_2_0TaskItem.BlockKey)
	Season123Controller.instance:dispatchEvent(Season123Event.OnTaskRewardGetFinish, self._index)
	TaskDispatcher.runDelay(self._onPlayActAniFinished, self, Season123_2_0TaskItem.TaskMaskTime)
end

function Season123_2_0TaskItem:_onPlayActAniFinished()
	...
	UIBlockMgr.instance:endBlock(Season123_2_0TaskItem.BlockKey)
end

function Season123_2_0TaskItem:onClickGetTotal()
	self:onClickReceive()
end

function Season123_2_0TaskItem:onDestroy()
	TaskDispatcher.cancelTask(self._onPlayActAniFinished, self)
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
