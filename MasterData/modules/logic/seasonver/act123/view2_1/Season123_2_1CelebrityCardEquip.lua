-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1CelebrityCardEquip.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1CelebrityCardEquip", package.seeall)

local Season123_2_1CelebrityCardEquip = class("Season123_2_1CelebrityCardEquip", LuaCompBase)

function Season123_2_1CelebrityCardEquip:init(go)
	Season123_2_1CelebrityCardEquip.super.init(self, go)
...
Season123_2_1CelebrityCardEquip.MaxRare = 6
Season123_2_1CelebrityCardEquip.MaxLimitCount = 2

function Season123_2_1CelebrityCardEquip:_editableInitView()
	self._rareGoMap = {}

	for i = 1, Season123_2_1CelebrityCardEquip.MaxRare do
...
function Season123_2_1CelebrityCardEquip:onDestroy()
	self:disposeUI()
end

function Season123_2_1CelebrityCardEquip:checkInitBtnClick()
...
function Season123_2_1CelebrityCardEquip:checkInitLongPress()
...
function Season123_2_1CelebrityCardEquip:disposeUI()
...
function Season123_2_1CelebrityCardEquip:updateData(itemId)
	self.itemId = itemId

	self:refreshUI()
end

function Season123_2_1CelebrityCardEquip:createRareMap(go)
...
function Season123_2_1CelebrityCardEquip:refreshUI()
...
function Season123_2_1CelebrityCardEquip:refreshSelfChoice()
...
function Season123_2_1CelebrityCardEquip:refreshIcon()
	if self._curSelectedItem then
...
function Season123_2_1CelebrityCardEquip:refreshFlag()
	if not self.itemId then
		return
	end
...
function Season123_2_1CelebrityCardEquip:refreshIndexLimit()
	...
	gohelper.setActive(self._golimit2, #indexLimitList == Season123_2_1CelebrityCardEquip.MaxLimitCount)
end

function Season123_2_1CelebrityCardEquip:setIndexLimitShowState(state)
	self._showIndexLimit = state

	self:refreshIndexLimit()
end

function Season123_2_1CelebrityCardEquip:setFlagUIPos(targetPosX, targetPosY)
...
function Season123_2_1CelebrityCardEquip:setFlagUIScale(targetScale)
...
function Season123_2_1CelebrityCardEquip:handleIconLoaded()
	if not self._isDisposed then
		local item = self._curSelectedItem
...
function Season123_2_1CelebrityCardEquip:setColorDark(enable)
	self._darkMaskColor = enable and "#7b7b7b" or "#ffffff"

	self:refreshIcon()
end

function Season123_2_1CelebrityCardEquip:setShowTag(enable)
	self._showTag = enable

	self:refreshFlag()
end

function Season123_2_1CelebrityCardEquip:setShowProbability(enable)
	self._showProbability = enable

	self:refreshFlag()
end

function Season123_2_1CelebrityCardEquip:setShowNewFlag(enable)
	self._showNewFlag = enable

	self:refreshFlag()
end

function Season123_2_1CelebrityCardEquip:setShowNewFlag2(enable)
	self._showNewFlag2 = enable

	self:refreshFlag()
end

function Season123_2_1CelebrityCardEquip:setClickCall(clickCall, clickCallObj, param)
...
function Season123_2_1CelebrityCardEquip:setLongPressCall(longPressCall, longPressCallObj, param)
