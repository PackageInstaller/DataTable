-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1CelebrityCardTipView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1CelebrityCardTipView", package.seeall)

local Season123_2_1CelebrityCardTipView = class("Season123_2_1CelebrityCardTipView", BaseView)

function Season123_2_1CelebrityCardTipView:onInitView()
...
function Season123_2_1CelebrityCardTipView:addEvents()
...
function Season123_2_1CelebrityCardTipView:removeEvents()
...
function Season123_2_1CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_1CelebrityCardTipView:onClickGMAdd(count)
...
function Season123_2_1CelebrityCardTipView:_btninputOnClick()
...
function Season123_2_1CelebrityCardTipView:_editableInitView()
...
function Season123_2_1CelebrityCardTipView:onDestroyView()
...
function Season123_2_1CelebrityCardTipView:onOpen()
...
function Season123_2_1CelebrityCardTipView:onClose()
	return
end

function Season123_2_1CelebrityCardTipView:refreshUI()
...
function Season123_2_1CelebrityCardTipView:refreshQuantity()
	if self.viewParam.needQuantity then
		gohelper.setActive(self._goquantity, true)

		local numStr

		self._txthadnumber.text = formatLuaLang("materialtipview_itemquantity", self.viewParam.fakeQuantity and tostring(self.viewParam.fakeQuantity) or self._activityId and tostring(GameUtil.numberDisplay(Season123EquipMetaUtils.getEquipCount(self._activityId, self._itemId))) or tostring(Season123EquipMetaUtils.getCurSeasonEquipCount(self._itemId)))
	else
		gohelper.setActive(self._goquantity, false)
	end
end

function Season123_2_1CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season123_2_1CelebrityCardTipView:refreshSkills()
...
function Season123_2_1CelebrityCardTipView:checkCreateIcon()
...
function Season123_2_1CelebrityCardTipView:getOrCreatePropText(index)
...
function Season123_2_1CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season123_2_1CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season123_2_1CelebrityCardTipView
