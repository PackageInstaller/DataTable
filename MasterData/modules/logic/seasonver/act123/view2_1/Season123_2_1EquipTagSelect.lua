-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EquipTagSelect.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EquipTagSelect", package.seeall)

local Season123_2_1EquipTagSelect = class("Season123_2_1EquipTagSelect", BaseView)

function Season123_2_1EquipTagSelect:onInitView()
	if self._editableInitView then
		self:_editableInitView()
	end
end

function Season123_2_1EquipTagSelect:addEvents()
	return
end

function Season123_2_1EquipTagSelect:removeEvents()
	return
end

function Season123_2_1EquipTagSelect:init(ctrl, dropListPath, defaultColor)
	self._controller = ctrl
	self._dropListPath = dropListPath
	self._defaultColor = defaultColor or "#cac8c5"
end

function Season123_2_1EquipTagSelect:_editableInitView()
...
function Season123_2_1EquipTagSelect:onDestroyView()
...
function Season123_2_1EquipTagSelect:onOpen()
...
function Season123_2_1EquipTagSelect:onClose()
	return
end

function Season123_2_1EquipTagSelect:handleClickTag()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Common_Click)
end

function Season123_2_1EquipTagSelect:handleDropValueChanged(index)
...
function Season123_2_1EquipTagSelect:refreshSelected()
...
return Season123_2_1EquipTagSelect
