-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1HeroGroupMainCardView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1HeroGroupMainCardView", package.seeall)

local Season123_2_1HeroGroupMainCardView = class("Season123_2_1HeroGroupMainCardView", BaseView)

function Season123_2_1HeroGroupMainCardView:onInitView()
...
function Season123_2_1HeroGroupMainCardView:addEvents()
	return
end

function Season123_2_1HeroGroupMainCardView:removeEvents()
	return
end

function Season123_2_1HeroGroupMainCardView:_editableInitView()
...
function Season123_2_1HeroGroupMainCardView:onDestroyView()
...
function Season123_2_1HeroGroupMainCardView:onOpen()
...
function Season123_2_1HeroGroupMainCardView:onClose()
	return
end

function Season123_2_1HeroGroupMainCardView:refreshMainCards()
	for slot = 1, Activity123Enum.MainCardNum do
		self:_refreshMainCard(slot)
	end
end

function Season123_2_1HeroGroupMainCardView:_refreshMainCard(slot)
	...
	if act104EquipId and act104EquipId ~= 0 then
		if not cardItem then
			cardItem = Season123_2_1CelebrityCardItem.New()
...
function Season123_2_1HeroGroupMainCardView:_btnseasonsupercardOnClick(slot)
...
return Season123_2_1HeroGroupMainCardView
