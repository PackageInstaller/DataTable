-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1TaskMapItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1TaskMapItem", package.seeall)

local Season123_2_1TaskMapItem = class("Season123_2_1TaskMapItem", LuaCompBase)

function Season123_2_1TaskMapItem:ctor(param)
	self.param = param
end

function Season123_2_1TaskMapItem:init(go)
	self:__onInit()
...
function Season123_2_1TaskMapItem:refreshUI()
...
function Season123_2_1TaskMapItem:setScale()
	if Season123TaskModel.instance.curStage == self.stage then
...
function Season123_2_1TaskMapItem:onDestroy()
	self:__onDispose()
...
return Season123_2_1TaskMapItem
