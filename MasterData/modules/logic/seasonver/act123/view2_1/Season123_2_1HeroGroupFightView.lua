-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1HeroGroupFightView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1HeroGroupFightView", package.seeall)

local Season123_2_1HeroGroupFightView = class("Season123_2_1HeroGroupFightView", BaseView)

function Season123_2_1HeroGroupFightView:onInitView()
...
function Season123_2_1HeroGroupFightView:addEvents()
...
function Season123_2_1HeroGroupFightView:removeEvents()
...
function Season123_2_1HeroGroupFightView:_btnrecommendOnClick()
...
function Season123_2_1HeroGroupFightView:_btnclothOnClock()
...
function Season123_2_1HeroGroupFightView:_btnrestrainOnClick()
	ViewMgr.instance:openView(ViewName.HeroGroupCareerTipView)
end

Season123_2_1HeroGroupFightView.UIBlock_SeasonFight = "UIBlock_SeasonFight"

function Season123_2_1HeroGroupFightView:_btnstartseasonOnClick()
	if not self._blockStart then
		...
		UIBlockMgr.instance:startBlock(Season123_2_1HeroGroupFightView.UIBlock_SeasonFight)
	end
end

function Season123_2_1HeroGroupFightView:_btnseasonreplayOnClick()
	self:_onClickReplay()
end

function Season123_2_1HeroGroupFightView:_groupDropValueChanged(value)
...
function Season123_2_1HeroGroupFightView:_editableInitView()
	self:_initComponent()
	self:_initData()
	self:_addEvents()
end

function Season123_2_1HeroGroupFightView:onDestroyView()
	...
	UIBlockMgr.instance:endBlock(Season123_2_1HeroGroupFightView.UIBlock_SeasonFight)
end

function Season123_2_1HeroGroupFightView:onOpen()
...
function Season123_2_1HeroGroupFightView:_initComponent()
...
function Season123_2_1HeroGroupFightView:_initData()
...
function Season123_2_1HeroGroupFightView:_initDataOnOpen()
	if Season123HeroGroupModel.instance:isEpisodeSeason123() then
...
function Season123_2_1HeroGroupFightView:_addEvents()
...
function Season123_2_1HeroGroupFightView:_checkReplay()
...
function Season123_2_1HeroGroupFightView:initSeason123FightGroupDrop()
	local list = {}
...
function Season123_2_1HeroGroupFightView:_receiveRecommend(cmd, resultCode, msg)
...
function Season123_2_1HeroGroupFightView:_onClickReplay()
...
function Season123_2_1HeroGroupFightView:_switchReplayGroup(lastReplayMode)
	self:_refreshTips()
...
function Season123_2_1HeroGroupFightView:_refreshTips()
	return
end

function Season123_2_1HeroGroupFightView:_updateReplayHeroGroupList()
...
function Season123_2_1HeroGroupFightView:_switchReplayMul()
	self._txtreplaycount.text = self._replayMode and luaLang("multiple") .. Season123HeroGroupModel.instance.multiplication or ""
end

function Season123_2_1HeroGroupFightView:_heroMoveForward(heroId)
	HeroGroupEditListModel.instance:setMoveHeroId(tonumber(heroId))
end

function Season123_2_1HeroGroupFightView:handleStartFightFailed()
	self._blockStart = false

	UIBlockMgr.instance:endBlock(Season123_2_1HeroGroupFightView.UIBlock_SeasonFight)
end

function Season123_2_1HeroGroupFightView:isReplayMode()
	return self._replayMode
end

function Season123_2_1HeroGroupFightView:_onCurrencyChange(changeIds)
...
function Season123_2_1HeroGroupFightView:onClose()
	AudioMgr.instance:trigger(AudioEnum.UI.Stop_HeroNormalVoc)
	self:_removeEvents()
...
function Season123_2_1HeroGroupFightView:_removeEvents()
...
function Season123_2_1HeroGroupFightView:_refreshReplay()
...
function Season123_2_1HeroGroupFightView:_refreshCloth()
	...
	gohelper.setActive(self._btncloth.gameObject, Season123_2_1HeroGroupFightView.showCloth())
end

function Season123_2_1HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season123_2_1HeroGroupFightView.showCloth()
	...
	local episodeCO, battleCO = Season123_2_1HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season123_2_1HeroGroupFightView:_onModifyHeroGroup()
	self:_refreshCloth()
end

function Season123_2_1HeroGroupFightView:_onModifySnapshot()
	self:_refreshCloth()
end

function Season123_2_1HeroGroupFightView:_onClickHeroGroupItem(id)
...
function Season123_2_1HeroGroupFightView:_checkFirstPosHasEquip()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
...
function Season123_2_1HeroGroupFightView:_showGuideDragEffect(param)
	if self._dragEffectLoader then
		self._dragEffectLoader:dispose()
...
function Season123_2_1HeroGroupFightView:_onClickStart()
...
function Season123_2_1HeroGroupFightView:_enterFight()
	local result = false
...
function Season123_2_1HeroGroupFightView:_onUseRecommendGroup()
	if self._replayMode then
		self._replayMode = false
...
function Season123_2_1HeroGroupFightView:_refreshBtns()
...
function Season123_2_1HeroGroupFightView:_onGetFightRecordGroupReply(fightGroupMO)
	self.removeEventCb(self, FightController.instance, FightEvent.RespGetFightRecordGroupReply, self._onGetFightRecordGroupReply, self)
...
function Season123_2_1HeroGroupFightView:_updateReplayHeroGroup()
	HeroGroupModel.instance:setReplayParam(self._replayFightGroupMO)
	HeroGroupController.instance:dispatchEvent(HeroGroupEvent.SelectHeroGroup, self._replayFightGroupMO.id)
	self:_refreshCloth()
	gohelper.setActive(self._goherogroupcontain, false)
...
function Season123_2_1HeroGroupFightView:_playHeroGroupExitEffect()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
end

function Season123_2_1HeroGroupFightView:_playCloseHeroGroupAnimation()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
...
function Season123_2_1HeroGroupFightView:_closeHeroContainAnim()
	if self._heroContainAnim then
		self._heroContainAnim.enabled = false
	end
end

return Season123_2_1HeroGroupFightView
