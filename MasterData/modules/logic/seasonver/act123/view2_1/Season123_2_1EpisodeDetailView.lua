-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EpisodeDetailView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EpisodeDetailView", package.seeall)

local Season123_2_1EpisodeDetailView = class("Season123_2_1EpisodeDetailView", BaseView)

function Season123_2_1EpisodeDetailView:onInitView()
...
function Season123_2_1EpisodeDetailView:addEvents()
...
function Season123_2_1EpisodeDetailView:removeEvents()
...
function Season123_2_1EpisodeDetailView:_editableInitView()
...
function Season123_2_1EpisodeDetailView:onDestroyView()
...
function Season123_2_1EpisodeDetailView:onOpen()
	self.addEventCb(self, Season123Controller.instance, Season123Event.DetailSwitchLayer, self.handleDetailSwitchLayer, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.RefreshDetailView, self.refreshShowInfo, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.ResetStageFinished, self.closeThis, self)
...
function Season123_2_1EpisodeDetailView:onOpenFinish()
...
function Season123_2_1EpisodeDetailView:onClose()
	TaskDispatcher.cancelTask(self._delayShowInfo, self)
end

function Season123_2_1EpisodeDetailView:handleDetailSwitchLayer(param)
...
function Season123_2_1EpisodeDetailView:_delayShowInfo()
	self:_showInfo()
end

function Season123_2_1EpisodeDetailView:refreshShowInfo()
	self:_showInfo()
end

function Season123_2_1EpisodeDetailView:_btnstartOnClick()
...
function Season123_2_1EpisodeDetailView:resetData()
	self._showLvItems = {}
...
function Season123_2_1EpisodeDetailView:noAudioShowInfoByOpen()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_leimi_theft_open)
	gohelper.setActive(self._goinfo, true)
	self:_showInfo()
end

function Season123_2_1EpisodeDetailView:_showInfo()
	self:_setInfo()
	self:_setParts()
	self:_setButton()
	self:_setResetInfo()
...
function Season123_2_1EpisodeDetailView:_setButton()
...
function Season123_2_1EpisodeDetailView:_setResetInfo()
	local needShowReset = Season123EpisodeDetailController.instance:isStageNeedClean() or Season123EpisodeDetailController.instance:isNextLayersNeedClean()
...
Season123_2_1EpisodeDetailView.NomalStageTagPos = Vector2(46.3, 2.7)
Season123_2_1EpisodeDetailView.NewStageTagPos = Vector2(4.37, 2.7)

function Season123_2_1EpisodeDetailView:_setInfo()
	local actId = Season123EpisodeDetailModel.instance.activityId
	local stage = Season123EpisodeDetailModel.instance.stage
	local layer = Season123EpisodeDetailModel.instance.layer
	...
	if isNewStage then
		if not Season123_2_1EpisodeDetailView.NewStageTagPos then
			local targetStageTagPos = Season123_2_1EpisodeDetailView.NomalStageTagPos
...
function Season123_2_1EpisodeDetailView:refreshEquipCardItem()
	...
	if episodeCo.firstPassEquipId and episodeCo.firstPassEquipId > 0 then
		...
		if not self._rewardItems[1].itemIcon then
			self._rewardItems[1].itemIcon = Season123_2_1CelebrityCardItem.New()
...
function Season123_2_1EpisodeDetailView:createRewardItem(index)
...
function Season123_2_1EpisodeDetailView:refreshRewardItem(item, itemInfo)
...
function Season123_2_1EpisodeDetailView:_setParts()
	local actId = Season123EpisodeDetailModel.instance.activityId
	local stage = Season123EpisodeDetailModel.instance.stage
	local layer = Season123EpisodeDetailModel.instance.layer
	local episodeCo = Season123Config.instance:getSeasonEpisodeCo(actId, stage, layer)
...
Season123_2_1EpisodeDetailView.UnLockStageItemAlpha = 1
Season123_2_1EpisodeDetailView.LockStageItemAlpha = 0.3

function Season123_2_1EpisodeDetailView:_showPartStarGroupItem(starGroup)
	if starGroup < 7 then
		...
		for i = 1, 6 do
			...
			if i <= starGroup then
				self._partStageItems[i].canvasgroup.alpha = Season123_2_1EpisodeDetailView.UnLockStageItemAlpha or Season123_2_1EpisodeDetailView.LockStageItemAlpha
			end
		end
	else
		for i = 1, 7 do
...
function Season123_2_1EpisodeDetailView:_btnlastOnClick()
...
function Season123_2_1EpisodeDetailView:_btnnextOnClick()
...
function Season123_2_1EpisodeDetailView:_btnresetOnClick()
...
return Season123_2_1EpisodeDetailView
