-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1BatchDecomposeView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1BatchDecomposeView", package.seeall)

local Season123_2_1BatchDecomposeView = class("Season123_2_1BatchDecomposeView", BaseView)

function Season123_2_1BatchDecomposeView:onInitView()
...
function Season123_2_1BatchDecomposeView:addEvents()
...
function Season123_2_1BatchDecomposeView:removeEvents()
...
Season123_2_1BatchDecomposeView.maxOverCount = 4

function Season123_2_1BatchDecomposeView:_btnrarerankOnClick()
...
function Season123_2_1BatchDecomposeView:_btnfilterOnClick()
	ViewMgr.instance:openView(ViewName.Season123_2_1DecomposeFilterView)
end

function Season123_2_1BatchDecomposeView:_btnfastaddOnClick()
...
function Season123_2_1BatchDecomposeView:_btnclearOnClick()
	Season123EquipBookController.instance:clearItemSelectState()
	self:resetDataUI()
end

function Season123_2_1BatchDecomposeView:_btndecomposeOnClick()
...
function Season123_2_1BatchDecomposeView:showDecomposeTip()
...
function Season123_2_1BatchDecomposeView:decomposeYesCallBack()
...
function Season123_2_1BatchDecomposeView:sendDecomposeRequest()
...
function Season123_2_1BatchDecomposeView:_dropFilterOnClick()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Common_Click)
end

function Season123_2_1BatchDecomposeView:_editableInitView()
...
function Season123_2_1BatchDecomposeView:onOpen()
...
function Season123_2_1BatchDecomposeView:initDropFilter()
	...
	for i = 1, Season123_2_1BatchDecomposeView.maxOverCount do
...
function Season123_2_1BatchDecomposeView:refreshUI()
	local coinConfig = CurrencyConfig.instance:getCurrencyCo(self.coinId)
...
function Season123_2_1BatchDecomposeView:initCoinItem()
...
function Season123_2_1BatchDecomposeView:onDecomposeItemClick()
	self._countAnim:Play("vx_count", 0, 0)
	AudioMgr.instance:trigger(AudioEnum.Season123.play_ui_checkpoint_light_up)
	self:refreshUI()
end

function Season123_2_1BatchDecomposeView:resetDataUI()
...
function Season123_2_1BatchDecomposeView:getDecomposeCoin()
...
function Season123_2_1BatchDecomposeView:dropFilterValueChanged(index)
	Season123DecomposeModel.instance:setCurOverPartSelectIndex(index)
end

function Season123_2_1BatchDecomposeView:onDropListShow()
	transformhelper.setLocalScale(self._arrowTrans, 1, -1, 1)
end

function Season123_2_1BatchDecomposeView:onDropListHide()
	transformhelper.setLocalScale(self._arrowTrans, 1, 1, 1)
end

function Season123_2_1BatchDecomposeView:onClose()
	Season123DecomposeModel.instance._itemStartAnimTime = nil
end

function Season123_2_1BatchDecomposeView:onDestroyView()
...
return Season123_2_1BatchDecomposeView
