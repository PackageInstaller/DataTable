-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1FightCardItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1FightCardItem", package.seeall)

local Season123_2_1FightCardItem = class("Season123_2_1FightCardItem", UserDataDispose)

function Season123_2_1FightCardItem:ctor(go)
	self:__onInit()
...
Season123_2_1FightCardItem.MainRoleItemMinHeight = 390
Season123_2_1FightCardItem.NormalRoleItemMinHeight = 315
Season123_2_1FightCardItem.RoleCardPos = {
	Vector2(-16.5, 0.5),
	Vector2(-16.5, 0.5),
	Vector2(-16.5, -6.5),
	Vector2(-16.5, -17),
...
function Season123_2_1FightCardItem:setData(data)
	if not data then
	...
	if self.isMainRole then
		self.layoutElement.minHeight = Season123_2_1FightCardItem.MainRoleItemMinHeight or Season123_2_1FightCardItem.NormalRoleItemMinHeight
	end
...
function Season123_2_1FightCardItem:_setName()
	if self.isMainRole then
...
function Season123_2_1FightCardItem:_setHead()
...
function Season123_2_1FightCardItem:getHeroMO()
...
function Season123_2_1FightCardItem:_setCard(equipId)
	if not self.cardItem then
		self.cardItem = Season123_2_1CelebrityCardItem.New()
	...
	local targetCardPos = Season123_2_1FightCardItem.RoleCardPos[tonumber(rare)] or Vector2(0, 0)

	recthelper.setAnchor(self.goCardPos.transform, targetCardPos.x, targetCardPos.y)
end

function Season123_2_1FightCardItem:_setDesc(equipId)
...
function Season123_2_1FightCardItem:createDescItem(index)
	local item = {}
...
function Season123_2_1FightCardItem:updateDescItem(item, skillStr)
...
function Season123_2_1FightCardItem:destroyDescItem(item)
	return
end

function Season123_2_1FightCardItem:destroy()
...
return Season123_2_1FightCardItem
