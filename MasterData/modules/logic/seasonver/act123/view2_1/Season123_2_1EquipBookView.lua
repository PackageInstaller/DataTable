-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EquipBookView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EquipBookView", package.seeall)

local Season123_2_1EquipBookView = class("Season123_2_1EquipBookView", BaseView)

function Season123_2_1EquipBookView:onInitView()
...
function Season123_2_1EquipBookView:addEvents()
...
function Season123_2_1EquipBookView:removeEvents()
...
Season123_2_1EquipBookView.defaultDescColor = "#cac8c5"

function Season123_2_1EquipBookView:_btncomposeOnClick()
...
function Season123_2_1EquipBookView:sendComposeRequest()
...
function Season123_2_1EquipBookView:_btndecomposeOnClick()
	...
	ViewMgr.instance:openView(ViewName.Season123_2_1DecomposeView, param)
end

function Season123_2_1EquipBookView:_btnbatchDecomposeOnClick()
...
function Season123_2_1EquipBookView:_btnskipEffectOnClick()
...
function Season123_2_1EquipBookView:_editableInitView()
	...
	self.colorStr = Season123_2_1EquipBookView.defaultDescColor

	self:hideEffect()
	gohelper.setActive(self._btnskipEffect.gameObject, false)
end

function Season123_2_1EquipBookView:onOpen()
...
function Season123_2_1EquipBookView:onSwitchCardAnim()
	self:refreshUI()
end

function Season123_2_1EquipBookView:refreshEquipBook()
	self._scrollcardlist.verticalNormalizedPosition = 1

	self:refreshUI()
end

function Season123_2_1EquipBookView:refreshUI()
...
function Season123_2_1EquipBookView:refreshCardDesc()
...
function Season123_2_1EquipBookView:refreshCardItem(itemConfig)
...
function Season123_2_1EquipBookView:cardDescItemShow(obj, data, index)
	obj.name = "desc" .. index
...
function Season123_2_1EquipBookView:setSkillClickCallBack(effId, clickPosition)
...
function Season123_2_1EquipBookView:refreshIcon()
	if not self._icon then
		local go = self._gocarditem

		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_2_1CelebrityCardEquip)
	end
...
function Season123_2_1EquipBookView:refreshBtn()
	local equipItemCount = self:getItemCount()
...
function Season123_2_1EquipBookView:isMainCardOverCount()
	if self.itemId then
...
function Season123_2_1EquipBookView:canCompose()
	if not self.itemId then
		return false
	end
...
function Season123_2_1EquipBookView:getItemCount()
	local itemMap = Season123Model.instance:getAllItemMo(self.actId)

	return GameUtil.getTabLen(itemMap)
end

function Season123_2_1EquipBookView:onChangeSelectCard()
	self._animatorCard:Play("switch", 0, 0)
	self:hideEffect()
end

function Season123_2_1EquipBookView:doDecompose(decomposeList)
...
function Season123_2_1EquipBookView:sendDecomposeEquipRequest()
...
function Season123_2_1EquipBookView:showDecomposeEffect()
...
function Season123_2_1EquipBookView:showComposeEffect()
...
function Season123_2_1EquipBookView:hideEffect()
	gohelper.setActive(self._godecomposeEffect, false)
	gohelper.setActive(self._gocomposeEffect, false)
end

function Season123_2_1EquipBookView:onClose()
	TaskDispatcher.cancelTask(self.sendComposeRequest, self)
	TaskDispatcher.cancelTask(self.sendDecomposeEquipRequest, self)
...
function Season123_2_1EquipBookView:onDestroyView()
...
return Season123_2_1EquipBookView
