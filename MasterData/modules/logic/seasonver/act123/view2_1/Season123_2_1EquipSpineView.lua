-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EquipSpineView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EquipSpineView", package.seeall)

local Season123_2_1EquipSpineView = class("Season123_2_1EquipSpineView", BaseView)

function Season123_2_1EquipSpineView:onInitView()
...
function Season123_2_1EquipSpineView:addEvents()
	return
end

function Season123_2_1EquipSpineView:removeEvents()
	return
end

function Season123_2_1EquipSpineView:_editableInitView()
	self._uiSpine = GuiModelAgent.Create(self._gospine, true)

	self:createSpine()
end

function Season123_2_1EquipSpineView:onDestroyView()
...
function Season123_2_1EquipSpineView:onOpen()
	self:refreshHeroSkin()
end

function Season123_2_1EquipSpineView:onClose()
	if self._uiSpine then
		self._uiSpine:setModelVisible(false)
	end
end

function Season123_2_1EquipSpineView:createSpine(skinConfig)
	if skinConfig then
		self._uiSpine:useRT()
...
function Season123_2_1EquipSpineView:refreshHeroSkin()
...
function Season123_2_1EquipSpineView:onSpineLoaded()
	self._spineLoaded = true

	self._uiSpine:setUIMask(true)
end

return Season123_2_1EquipSpineView
