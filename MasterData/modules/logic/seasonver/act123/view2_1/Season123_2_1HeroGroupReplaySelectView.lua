-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1HeroGroupReplaySelectView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1HeroGroupReplaySelectView", package.seeall)

local Season123_2_1HeroGroupReplaySelectView = class("Season123_2_1HeroGroupReplaySelectView", BaseView)

function Season123_2_1HeroGroupReplaySelectView:onInitView()
...
function Season123_2_1HeroGroupReplaySelectView:addEvents()
...
function Season123_2_1HeroGroupReplaySelectView:removeEvents()
	self._btnmultispeed:RemoveClickListener()
	self._btnclosemult:RemoveClickListener()
end

function Season123_2_1HeroGroupReplaySelectView:_editableInitView()
...
function Season123_2_1HeroGroupReplaySelectView:onDestroyView()
	return
end

function Season123_2_1HeroGroupReplaySelectView:onOpen()
	self:initCostIcon()
	self:initMultiGroup()
	self:refreshSelection()
end

function Season123_2_1HeroGroupReplaySelectView:onClose()
	return
end

Season123_2_1HeroGroupReplaySelectView.ItemHeight = 92

function Season123_2_1HeroGroupReplaySelectView:initMultiGroup()
	...
	recthelper.setHeight(self.rectdropbg, Season123_2_1HeroGroupReplaySelectView.ItemHeight * maxTimes)
end

function Season123_2_1HeroGroupReplaySelectView:initMultSpeedItem(go, multispeed, maxTimes)
...
function Season123_2_1HeroGroupReplaySelectView:initCostIcon()
...
function Season123_2_1HeroGroupReplaySelectView:refreshMulti()
...
function Season123_2_1HeroGroupReplaySelectView:onClickSetSpeed(speed)
...
function Season123_2_1HeroGroupReplaySelectView:setMultSpeed(speed)
...
function Season123_2_1HeroGroupReplaySelectView:refreshSelection()
...
function Season123_2_1HeroGroupReplaySelectView:_btnmultispeedOnClick()
	self._isMultiOpen = not self._isMultiOpen

	self:refreshMulti()
end

function Season123_2_1HeroGroupReplaySelectView:_btnclosemultOnClick()
	self._isMultiOpen = false

	self:refreshMulti()
end

return Season123_2_1HeroGroupReplaySelectView
