-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1HeroGroupEditViewContainer.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1HeroGroupEditViewContainer", package.seeall)

local Season123_2_1HeroGroupEditViewContainer = class("Season123_2_1HeroGroupEditViewContainer", BaseViewContainer)

function Season123_2_1HeroGroupEditViewContainer:buildViews()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "#go_rolecontainer/#scroll_card"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[1]
	scrollParam.cellClass = Season123_2_1HeroGroupEditItem
	...
	for i = 1, 15 do
		animationDelayTimes[i] = math.ceil((i - 1) % 5) * 0.03
	end

	return {
		Season123_2_1HeroGroupEditView.New(),
...
function Season123_2_1HeroGroupEditViewContainer:getQuickEditScroll()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "#go_rolecontainer/#scroll_quickedit"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[2]
	scrollParam.cellClass = Season123_2_1HeroGroupQuickEditItem
	scrollParam.scrollDir = ScrollEnum.ScrollDirV
	scrollParam.lineCount = 5
	scrollParam.cellWidth = 200
	scrollParam.cellHeight = 472
...
function Season123_2_1HeroGroupEditViewContainer:buildTabViews(tabContainerId)
...
function Season123_2_1HeroGroupEditViewContainer:onContainerOpenFinish()
	self._navigateButtonView:resetOnCloseViewAudio(AudioEnum.HeroGroupUI.Play_UI_Team_Close)
end

function Season123_2_1HeroGroupEditViewContainer:_overrideClose()
...
function Season123_2_1HeroGroupEditViewContainer:_setHomeBtnVisible(isVisible)
...
return Season123_2_1HeroGroupEditViewContainer
