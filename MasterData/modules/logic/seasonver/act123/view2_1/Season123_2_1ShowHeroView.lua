-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1ShowHeroView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1ShowHeroView", package.seeall)

local Season123_2_1ShowHeroView = class("Season123_2_1ShowHeroView", BaseView)

function Season123_2_1ShowHeroView:onInitView()
...
function Season123_2_1ShowHeroView:addEvents()
...
function Season123_2_1ShowHeroView:removeEvents()
...
function Season123_2_1ShowHeroView:_editableInitView()
	self._heroItems = {}
end

function Season123_2_1ShowHeroView:onDestroyView()
...
function Season123_2_1ShowHeroView:onOpen()
...
function Season123_2_1ShowHeroView:onClose()
	if self._heroItems then
		for index, item in pairs(self._heroItems) do
...
function Season123_2_1ShowHeroView:getOrCreateItem(index)
	local item = self._heroItems[index]

	if not item then
		item = self:getUserDataTb_()
		item.go = gohelper.cloneInPlace(self._goitem, "item_" .. tostring(index))
		item.component = Season123_2_1ShowHeroItem.New()
...
function Season123_2_1ShowHeroView:_btndetailsOnClick()
...
function Season123_2_1ShowHeroView:_btnresetOnClick()
	Season123ShowHeroController.instance:openReset()
end

function Season123_2_1ShowHeroView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_1ShowHeroView:handleEnterStageSuccess()
...
return Season123_2_1ShowHeroView
