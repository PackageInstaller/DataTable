-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1RetailView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1RetailView", package.seeall)

local Season123_2_1RetailView = class("Season123_2_1RetailView", BaseView)

function Season123_2_1RetailView:onInitView()
...
function Season123_2_1RetailView:addEvents()
...
function Season123_2_1RetailView:onOpen()
...
function Season123_2_1RetailView:onClose()
	return
end

function Season123_2_1RetailView:refreshUI()
	self:refreshInfo()
...
function Season123_2_1RetailView:refreshInfo()
...
function Season123_2_1RetailView:initIconUI()
...
function Season123_2_1RetailView:refreshRecommendLv()
...
function Season123_2_1RetailView:refreshRewards()
...
function Season123_2_1RetailView:refreshCardPackageUI()
...
function Season123_2_1RetailView:getOrCreateRewardItem(index)
...
function Season123_2_1RetailView:refreshTicket()
...
function Season123_2_1RetailView:handleItemChanged()
	self:refreshCardPackageUI()
	self:refreshTicket()
end

function Season123_2_1RetailView:_btncelebrityOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

function Season123_2_1RetailView:_btncardsOnClick()
	Season123Controller.instance:openSeasonCardPackageView({
		actId = self.viewParam.actId
	})
end

function Season123_2_1RetailView:onClickIcon(index)
...
function Season123_2_1RetailView:_btnstartOnClick()
	Season123RetailController.instance:enterRetailFightScene()
end

return Season123_2_1RetailView
