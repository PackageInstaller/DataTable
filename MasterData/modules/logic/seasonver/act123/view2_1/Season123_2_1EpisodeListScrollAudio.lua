-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EpisodeListScrollAudio.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EpisodeListScrollAudio", package.seeall)

local Season123_2_1EpisodeListScrollAudio = class("Season123_2_1EpisodeListScrollAudio", LuaCompBase)

function Season123_2_1EpisodeListScrollAudio:ctor(param)
	self.scroll = param
...
function Season123_2_1EpisodeListScrollAudio:onDragBegin()
	self._isDraging = true
...
function Season123_2_1EpisodeListScrollAudio:onDragEnd()
	self:onUpdate()

	self._isDraging = false
end

function Season123_2_1EpisodeListScrollAudio:onClickDown()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_start)
end

function Season123_2_1EpisodeListScrollAudio:onUpdate()
...
function Season123_2_1EpisodeListScrollAudio:_onValueChangeSampleOffset(y)
...
function Season123_2_1EpisodeListScrollAudio:_onUpdateRTPCSpeed(y)
...
function Season123_2_1EpisodeListScrollAudio:_onValueChangeForStartOrStop(y)
...
function Season123_2_1EpisodeListScrollAudio:_onValueChangeCheckReplay(y)
...
function Season123_2_1EpisodeListScrollAudio:_resetPlayingStatus(y)
	self._isScrollPlaying = false
	self._scrollingPlayY = y
end

function Season123_2_1EpisodeListScrollAudio:dispose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_end)
...
function Season123_2_1EpisodeListScrollAudio:onDestroy()
	self.scroll = nil
end

return Season123_2_1EpisodeListScrollAudio
