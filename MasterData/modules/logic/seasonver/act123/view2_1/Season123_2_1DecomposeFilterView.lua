-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1DecomposeFilterView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1DecomposeFilterView", package.seeall)

local Season123_2_1DecomposeFilterView = class("Season123_2_1DecomposeFilterView", BaseView)

function Season123_2_1DecomposeFilterView:onInitView()
...
function Season123_2_1DecomposeFilterView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
	self._btnreset:AddClickListener(self._btnresetOnClick, self)
	self._btnconfirm:AddClickListener(self._btnconfirmOnClick, self)
end

function Season123_2_1DecomposeFilterView:removeEvents()
	self._btnclose:RemoveClickListener()
	self._btnreset:RemoveClickListener()
	self._btnconfirm:RemoveClickListener()
end

function Season123_2_1DecomposeFilterView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_1DecomposeFilterView:_btnresetOnClick()
...
function Season123_2_1DecomposeFilterView:_btnconfirmOnClick()
...
function Season123_2_1DecomposeFilterView:_editableInitView()
...
function Season123_2_1DecomposeFilterView:onOpen()
	self:createRareItem()
	self:createTagItem()
	self:refreshUI()
end

function Season123_2_1DecomposeFilterView:refreshUI()
	self:refreshRareSelectUI()
	self:refreshTagSelectUI()
end

function Season123_2_1DecomposeFilterView:refreshRareSelectUI()
...
function Season123_2_1DecomposeFilterView:refreshTagSelectUI()
...
function Season123_2_1DecomposeFilterView:createRareItem()
	for i = 5, 1, -1 do
...
function Season123_2_1DecomposeFilterView:rareItemOnClick(rare)
...
function Season123_2_1DecomposeFilterView:setRareSelectState(itemRare)
	self.rareSelectTab[itemRare] = not self.rareSelectTab[itemRare]
end

function Season123_2_1DecomposeFilterView:createTagItem()
...
function Season123_2_1DecomposeFilterView:tagItemSort(tagConfig)
	local tagConfigData = {}
...
function Season123_2_1DecomposeFilterView:tagItemShow(obj, data, index)
	local tagItem = {}
...
function Season123_2_1DecomposeFilterView:tagItemOnClick(data)
	local tagId = data.id
...
function Season123_2_1DecomposeFilterView:setTagSelectState(tagId)
	self.tagSelectTab[tagId] = not self.tagSelectTab[tagId]
end

function Season123_2_1DecomposeFilterView:onClose()
	return
end

function Season123_2_1DecomposeFilterView:onDestroyView()
...
return Season123_2_1DecomposeFilterView
