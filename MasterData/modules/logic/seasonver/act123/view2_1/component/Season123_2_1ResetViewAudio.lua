-- chunkname: @modules/logic/seasonver/act123/view2_1/component/Season123_2_1ResetViewAudio.lua

module("modules.logic.seasonver.act123.view2_1.component.Season123_2_1ResetViewAudio", package.seeall)

local Season123_2_1ResetViewAudio = class("Season123_2_1ResetViewAudio", LuaCompBase)

function Season123_2_1ResetViewAudio:ctor(param)
	self.scroll = param
...
function Season123_2_1ResetViewAudio:onDragBegin()
	self._isDraging = true
...
function Season123_2_1ResetViewAudio:onDragEnd()
	self:onUpdate()

	self._isDraging = false
end

function Season123_2_1ResetViewAudio:onClickDown()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_start)
end

function Season123_2_1ResetViewAudio:onUpdate()
...
function Season123_2_1ResetViewAudio:_onValueChangeSampleOffset(x)
...
function Season123_2_1ResetViewAudio:_onUpdateRTPCSpeed(x)
...
function Season123_2_1ResetViewAudio:_onValueChangeForStartOrStop(x)
...
function Season123_2_1ResetViewAudio:_onValueChangeCheckReplay(x)
...
function Season123_2_1ResetViewAudio:_resetPlayingStatus(x)
	self._isScrollPlaying = false
	self._scrollingPlayX = x
end

function Season123_2_1ResetViewAudio:dispose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_end)
...
function Season123_2_1ResetViewAudio:onDestroy()
	self.scroll = nil
end

return Season123_2_1ResetViewAudio
