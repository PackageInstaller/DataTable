-- chunkname: @modules/logic/seasonver/act123/view2_1/component/Season123_2_1EntryDrag.lua

module("modules.logic.seasonver.act123.view2_1.component.Season123_2_1EntryDrag", package.seeall)

local Season123_2_1EntryDrag = class("Season123_2_1EntryDrag", UserDataDispose)

function Season123_2_1EntryDrag:init(goFullScreen, tfScene)
	self:__onInit()
...
function Season123_2_1EntryDrag:dispose()
	if self._drag then
...
function Season123_2_1EntryDrag:initBound()
...
function Season123_2_1EntryDrag:onDragBegin(param, pointerEventData)
...
function Season123_2_1EntryDrag:onDragEnd(param, pointerEventData)
	self._dragBeginPos = nil
	self._beginDragPos = nil
end

function Season123_2_1EntryDrag:onDrag(param, pointerEventData)
...
function Season123_2_1EntryDrag:drag(deltaPos)
...
function Season123_2_1EntryDrag:setScenePosDrag(targetPos)
...
function Season123_2_1EntryDrag:setScenePosTween(targetPos, tweenTime, callback, callbackObj)
...
function Season123_2_1EntryDrag:fixTargetPos(targetPos)
...
function Season123_2_1EntryDrag:localMoveDone()
	self._tweenId = nil
end

function Season123_2_1EntryDrag:vectorAdd(v1, v2)
...
function Season123_2_1EntryDrag:getTempPos()
	return self._tempVector
end

function Season123_2_1EntryDrag:killTween()
...
function Season123_2_1EntryDrag:setDragEnabled(value)
	self._dragEnabled = value
end

function Season123_2_1EntryDrag:getDragWorldPos(pointerEventData)
...
function Season123_2_1EntryDrag:handleScreenResize()
	self:initBound()
