-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1DecomposeItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1DecomposeItem", package.seeall)

local Season123_2_1DecomposeItem = class("Season123_2_1DecomposeItem", ListScrollCellExtend)

function Season123_2_1DecomposeItem:init(go)
	Season123_2_1DecomposeItem.super.init(self, go)
...
function Season123_2_1DecomposeItem:addEventListeners()
...
function Season123_2_1DecomposeItem:removeEventListeners()
...
function Season123_2_1DecomposeItem:onUpdateMO(mo)
	self._mo = mo
...
Season123_2_1DecomposeItem.AnimRowCount = 4
Season123_2_1DecomposeItem.OpenAnimTime = 0.06
Season123_2_1DecomposeItem.OpenAnimStartTime = 0.05

function Season123_2_1DecomposeItem:refreshUI()
...
function Season123_2_1DecomposeItem:refreshEquipedHero(heroUid)
...
function Season123_2_1DecomposeItem:checkPlayAnim()
...
function Season123_2_1DecomposeItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_2_1DecomposeItem:checkCreateIcon()
...
function Season123_2_1DecomposeItem:onClickSelf()
...
function Season123_2_1DecomposeItem:showDecomposeEffect()
...
function Season123_2_1DecomposeItem:hideDecomposeEffect()
	gohelper.setActive(self._goDecomposeEffect, false)
end

function Season123_2_1DecomposeItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
...
return Season123_2_1DecomposeItem
