-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1PickHeroView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1PickHeroView", package.seeall)

local Season123_2_1PickHeroView = class("Season123_2_1PickHeroView", BaseView)

function Season123_2_1PickHeroView:onInitView()
...
function Season123_2_1PickHeroView:addEvents()
	self._btnconfirm:AddClickListener(self._btnconfirmOnClick, self)
	self._btncancel:AddClickListener(self._btncancelOnClick, self)
end

function Season123_2_1PickHeroView:removeEvents()
	self._btnconfirm:RemoveClickListener()
	self._btncancel:RemoveClickListener()
end

function Season123_2_1PickHeroView:_btnconfirmOnClick()
	Season123PickHeroController.instance:pickOver()
	self:closeThis()
end

function Season123_2_1PickHeroView:_btncancelOnClick()
	self:closeThis()
end

function Season123_2_1PickHeroView:_editableInitView()
...
function Season123_2_1PickHeroView:onClose()
	return
end

function Season123_2_1PickHeroView:refreshUI()
...
return Season123_2_1PickHeroView
