-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EnemyView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EnemyView", package.seeall)

local Season123_2_1EnemyView = class("Season123_2_1EnemyView", BaseView)

function Season123_2_1EnemyView:onInitView()
...
function Season123_2_1EnemyView:addEvents()
...
function Season123_2_1EnemyView:removeEvents()
...
function Season123_2_1EnemyView:_editableInitView()
...
function Season123_2_1EnemyView:onDestroyView()
...
function Season123_2_1EnemyView:onOpen()
...
function Season123_2_1EnemyView:onClose()
...
function Season123_2_1EnemyView:handleClickMonster()
	self:refreshMonsterSelect()
	self:refreshEnemyInfo()
end

function Season123_2_1EnemyView:_onClickClosePassiveView()
	gohelper.setActive(self._gobuffpassiveview, false)

	self.isopenpassiveview = false
end

function Season123_2_1EnemyView:refreshUI()
...
function Season123_2_1EnemyView:getOrCreateGroupItem(i)
...
function Season123_2_1EnemyView:refreshEnemyGroup(i, monsterGroupIds, enemyGroupItemTable)
	local isBoss = false
...
function Season123_2_1EnemyView:getOrCreateEnemyItem(itemGroup, groupIndex, itemIndex)
...
function Season123_2_1EnemyView:onClickMonsterIcon(clickInfo)
...
function Season123_2_1EnemyView:refreshEnemyItem(enemyItemTable, monsterId, groupIndex)
	local monsterConfig = lua_monster.configDict[monsterId]
	local skinConfig = FightConfig.instance:getSkinCO(monsterConfig.skinId)
...
function Season123_2_1EnemyView:refreshMonsterSelect()
	local monsterGroupIds = Season123EnemyModel.instance:getCurrentBattleGroupIds()
...
function Season123_2_1EnemyView:refreshEnemyInfo()
...
function Season123_2_1EnemyView:_refreshSpeicalSkillIcon(monsterConfig)
...
function Season123_2_1EnemyView:_onBuffPassiveSkillClick()
...
function Season123_2_1EnemyView:_setPassiveSkillTip(skillgo, skillInfo)
...
function Season123_2_1EnemyView:_refreshPassiveSkill(monsterConfig, groupIndex)
...
function Season123_2_1EnemyView:_refreshSkill(monsterConfig)
	local skillIds = {}
...
function Season123_2_1EnemyView:_refreshSuper(monsterConfig)
...
function Season123_2_1EnemyView:createSuperItem()
...
function Season123_2_1EnemyView:_refreshAttribute(monsterConfig)
...
function Season123_2_1EnemyView:_onMonsterAttrItemShow(obj, data, index)
...
function Season123_2_1EnemyView:_onClickShowAttribute()
