-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1PickHeroEntryView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1PickHeroEntryView", package.seeall)

local Season123_2_1PickHeroEntryView = class("Season123_2_1PickHeroEntryView", BaseView)

function Season123_2_1PickHeroEntryView:onInitView()
...
function Season123_2_1PickHeroEntryView:addEvents()
...
function Season123_2_1PickHeroEntryView:removeEvents()
...
function Season123_2_1PickHeroEntryView:_editableInitView()
	self._heroItems = {}
	self._careerItems = {}
end

function Season123_2_1PickHeroEntryView:onDestroyView()
...
function Season123_2_1PickHeroEntryView:onOpen()
	...
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successDressUpSkin, self.refreshUI, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.PickEntryRefresh, self.refreshUI, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.EnterStageSuccess, self.handleEnterStageSuccess, self)
...
function Season123_2_1PickHeroEntryView:onClose()
	return
end

function Season123_2_1PickHeroEntryView:refreshUI()
	self:refreshItems()
	self:refreshButton()
...
function Season123_2_1PickHeroEntryView:refreshButton()
...
function Season123_2_1PickHeroEntryView:refreshItems()
...
function Season123_2_1PickHeroEntryView:getOrCreateItem(index)
	local item = self._heroItems[index]

	if not item then
		item = self:getUserDataTb_()
		item.go = gohelper.cloneInPlace(self._goitem, "item_" .. tostring(index))
		item.component = Season123_2_1PickHeroEntryItem.New()
...
function Season123_2_1PickHeroEntryView:refreshRecommendCareer()
...
function Season123_2_1PickHeroEntryView:getOrCreateCareer(index)
...
function Season123_2_1PickHeroEntryView:refreshRecommendTag()
...
function Season123_2_1PickHeroEntryView:tagItemShow(obj, data, index)
	local tagItemGO = obj
...
function Season123_2_1PickHeroEntryView:refreshRecommendUI()
	local careers = Season123Config.instance:getRecommendCareers(Season123PickHeroEntryModel.instance.activityId, Season123PickHeroEntryModel.instance.stage)
	local tagCoList = Season123Config.instance:getRecommendTagCoList(Season123PickHeroEntryModel.instance.activityId, Season123PickHeroEntryModel.instance.stage)
...
function Season123_2_1PickHeroEntryView:_btnstartOnClick()
	Season123PickHeroEntryController.instance:sendEnterStage()
end

function Season123_2_1PickHeroEntryView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_1PickHeroEntryView:_btndetailsOnClick()
...
function Season123_2_1PickHeroEntryView:handleEnterStageSuccess()
	...
	if finishCall then
		self.viewParam.finishCall(finishCallObj)
	end
end

return Season123_2_1PickHeroEntryView
