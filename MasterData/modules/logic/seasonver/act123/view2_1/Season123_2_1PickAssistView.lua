-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1PickAssistView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1PickAssistView", package.seeall)

local Season123_2_1PickAssistView = class("Season123_2_1PickAssistView", BaseView)

function Season123_2_1PickAssistView:onInitView()
...
function Season123_2_1PickAssistView:addEvents()
...
function Season123_2_1PickAssistView:removeEvents()
...
function Season123_2_1PickAssistView:onBeforeRefreshAssistList()
...
function Season123_2_1PickAssistView:_btnrefreshOnClick()
	Season123PickAssistController.instance:manualRefreshList()
end

function Season123_2_1PickAssistView:_onHeroDetailClick()
...
function Season123_2_1PickAssistView:_btnconfirmOnClick()
	Season123PickAssistController.instance:pickOver()
	self:closeThis()
end

function Season123_2_1PickAssistView:_btnCareerFilterOnClick(career)
...
function Season123_2_1PickAssistView:_editableInitView()
	self:_setFilterBtn()
end

function Season123_2_1PickAssistView:_setFilterBtn()
...
function Season123_2_1PickAssistView:_onInitFilterBtn(obj, careerValue, index)
...
function Season123_2_1PickAssistView:onOpen()
...
function Season123_2_1PickAssistView:showRecommendCareer()
...
function Season123_2_1PickAssistView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_2_1PickAssistView:refreshUI()
	self:refreshCD()
	self:refreshCareerFilterItems()
	self:refreshIsEmpty()
...
function Season123_2_1PickAssistView:refreshCD()
	self._simageprogress.fillAmount = Season123PickAssistController.instance:getRefreshCDRate()
end

function Season123_2_1PickAssistView:refreshCareerFilterItems()
...
function Season123_2_1PickAssistView:refreshIsEmpty()
...
function Season123_2_1PickAssistView:refreshBtnDetail()
	local selectedMO = Season123PickAssistListModel.instance:getSelectedMO()

	gohelper.setActive(self._godetail, selectedMO)
end

function Season123_2_1PickAssistView:onClose()
	TaskDispatcher.cancelTask(self.refreshCD, self)
end

function Season123_2_1PickAssistView:onDestroyView()
	self:disposeCareerItems()
	Season123PickAssistController.instance:onCloseView()
end

function Season123_2_1PickAssistView:disposeCareerItems()
...
return Season123_2_1PickAssistView
