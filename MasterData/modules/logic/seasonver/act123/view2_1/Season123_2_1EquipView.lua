-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EquipView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EquipView", package.seeall)

local Season123_2_1EquipView = class("Season123_2_1EquipView", BaseView)

function Season123_2_1EquipView:onInitView()
...
function Season123_2_1EquipView:addEvents()
...
function Season123_2_1EquipView:removeEvents()
	self._btnequip:RemoveClickListener()
	self._btnopenhandbook:RemoveClickListener()
end

function Season123_2_1EquipView:_editableInitView()
...
function Season123_2_1EquipView:onDestroyView()
...
function Season123_2_1EquipView:onOpen()
...
function Season123_2_1EquipView:onClose()
	return
end

function Season123_2_1EquipView:refreshUI()
...
function Season123_2_1EquipView:handleEquipUpdate()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_2_1EquipView:refreshSlots()
...
function Season123_2_1EquipView:refreshSlot(slotIndex)
...
Season123_2_1EquipView.MaxUISlot = 2

function Season123_2_1EquipView:refreshDescGroup()
	for slot = 1, Season123_2_1EquipView.MaxUISlot do
...
function Season123_2_1EquipView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season123_2_1EquipView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season123_2_1EquipView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season123_2_1EquipView:setSkillClickCallBack(effId, clickPosition)
...
function Season123_2_1EquipView:getOrCreatePropText(index, descItem)
...
function Season123_2_1EquipView:getOrCreateSkillText(index, descItem)
...
function Season123_2_1EquipView:getOrCreateSlot(slotIndex)
...
function Season123_2_1EquipView:getOrCreateSlotIcon(slotItem)
...
function Season123_2_1EquipView:getOrCreateDesc(index)
...
function Season123_2_1EquipView:onClickSlot(slotIndex)
	if Season123EquipItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season123_2_1EquipView:handleSaveSucc()
...
function Season123_2_1EquipView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_2_1EquipView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season123_2_1EquipView:handleEquipCardChanged(param)
...
function Season123_2_1EquipView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season123_2_1EquipView:_btnequipOnClick()
...
function Season123_2_1EquipView:_btnhandbookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

return Season123_2_1EquipView
