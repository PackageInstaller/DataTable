-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3TaskMapItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3TaskMapItem", package.seeall)

local Season123_2_3TaskMapItem = class("Season123_2_3TaskMapItem", LuaCompBase)

function Season123_2_3TaskMapItem:ctor(param)
	self.param = param
end

function Season123_2_3TaskMapItem:init(go)
	self:__onInit()
...
function Season123_2_3TaskMapItem:refreshUI()
...
function Season123_2_3TaskMapItem:setScale()
	if Season123TaskModel.instance.curStage == self.stage then
...
function Season123_2_3TaskMapItem:onDestroy()
	self:__onDispose()
...
return Season123_2_3TaskMapItem
