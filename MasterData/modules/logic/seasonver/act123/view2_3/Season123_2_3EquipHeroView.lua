-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EquipHeroView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EquipHeroView", package.seeall)

local Season123_2_3EquipHeroView = class("Season123_2_3EquipHeroView", BaseView)

function Season123_2_3EquipHeroView:onInitView()
...
function Season123_2_3EquipHeroView:addEvents()
...
function Season123_2_3EquipHeroView:onDestroyView()
...
function Season123_2_3EquipHeroView:onOpen()
...
function Season123_2_3EquipHeroView:onClose()
	return
end

function Season123_2_3EquipHeroView:refreshUI()
...
function Season123_2_3EquipHeroView:handleEquipUpdate()
	self:refreshDescGroup()
	self:refreshSlots()
end

function Season123_2_3EquipHeroView:refreshSlots()
	for slotIndex = 1, Activity123Enum.MainCardNum do
		self:refreshSlot(slotIndex)
	end
end

function Season123_2_3EquipHeroView:refreshSlot(slotIndex)
...
Season123_2_3EquipHeroView.MaxUISlot = 2

function Season123_2_3EquipHeroView:refreshDescGroup()
	for slot = 1, Season123_2_3EquipHeroView.MaxUISlot do
...
function Season123_2_3EquipHeroView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season123_2_3EquipHeroView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season123_2_3EquipHeroView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season123_2_3EquipHeroView:setSkillClickCallBack(effId, clickPosition)
...
function Season123_2_3EquipHeroView:getOrCreatePropText(index, descItem)
...
function Season123_2_3EquipHeroView:getOrCreateSkillText(index, descItem)
...
function Season123_2_3EquipHeroView:getOrCreateSlot(slotIndex)
...
function Season123_2_3EquipHeroView:getOrCreateSlotIcon(slotItem)
...
function Season123_2_3EquipHeroView:getOrCreateDesc(index)
...
function Season123_2_3EquipHeroView:onClickSlot(slotIndex)
	if Season123EquipHeroItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season123_2_3EquipHeroView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_2_3EquipHeroView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season123_2_3EquipHeroView:handleEquipCardChanged(param)
...
function Season123_2_3EquipHeroView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season123_2_3EquipHeroView:handleSaveSucc()
...
function Season123_2_3EquipHeroView:_btnequipOnClick()
...
function Season123_2_3EquipHeroView:_btnhandbookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

return Season123_2_3EquipHeroView
