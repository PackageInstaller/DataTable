-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3PickHeroDetailView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3PickHeroDetailView", package.seeall)

local Season123_2_3PickHeroDetailView = class("Season123_2_3PickHeroDetailView", BaseView)

function Season123_2_3PickHeroDetailView:onInitView()
...
function Season123_2_3PickHeroDetailView:addEvents()
...
function Season123_2_3PickHeroDetailView:removeEvents()
...
function Season123_2_3PickHeroDetailView:_editableInitView()
	self._careerGOs = {}
...
function Season123_2_3PickHeroDetailView:onDestroyView()
...
function Season123_2_3PickHeroDetailView:onOpen()
	self.addEventCb(self, Season123Controller.instance, Season123Event.PickViewRefresh, self.refreshUI, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroRankUp, self.refreshHeroListByFilter, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroLevelUp, self.refreshHeroListByFilter, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroExSkillUp, self.refreshHeroListByFilter, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successDressUpSkin, self.refreshHeroListByFilter, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroRankUp, self.refreshUI, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroLevelUp, self.refreshUI, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroExSkillUp, self.refreshUI, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroTalentUp, self.refreshUI, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroExSkillUp, self.refreshUI, self)
...
function Season123_2_3PickHeroDetailView:onClose()
	return
end

function Season123_2_3PickHeroDetailView:initStatus()
	for i = 1, 6 do
...
function Season123_2_3PickHeroDetailView:refreshUI()
...
function Season123_2_3PickHeroDetailView:_refreshMainInfo()
	if self._heroMO then
...
function Season123_2_3PickHeroDetailView:_refreshAttribute()
	if self._heroMO then
...
function Season123_2_3PickHeroDetailView:_refreshPassiveSkill()
...
function Season123_2_3PickHeroDetailView:_refreshSkill()
	self._skillContainer:onUpdateMO(self._heroMO and self._heroMO.heroId, false, self._heroMO)
end

function Season123_2_3PickHeroDetailView:_refreshBtnIcon()
...
function Season123_2_3PickHeroDetailView:_btnattributeOnClick()
	if self._heroMO then
		local info = {}
...
function Season123_2_3PickHeroDetailView:_btncharacterOnClick()
	if self._heroMO then
		if not Season123PickHeroModel.instance.heroMOList then
			...
			CharacterController.instance:openCharacterView(self._heroMO, Season123PickHeroModel.instance.heroMOList)
		end
	end
end

function Season123_2_3PickHeroDetailView:_btnpassiveskillOnClick()
	if not self._heroMO then
		return
	end
...
function Season123_2_3PickHeroDetailView:_refreshFilterView()
	for i = 1, 2 do
...
function Season123_2_3PickHeroDetailView:refreshHeroListByFilter()
	local dmgs = {}
...
function Season123_2_3PickHeroDetailView:_onAttributeChanged(level, heroId)
	CharacterModel.instance:setFakeLevel(heroId, level)
end

function Season123_2_3PickHeroDetailView:_showCharacterRankUpView(func)
	func()
end

function Season123_2_3PickHeroDetailView:_attrBtnOnClick(i)
	self._selectAttrs[i] = not self._selectAttrs[i]

	self:_refreshFilterView()
end

function Season123_2_3PickHeroDetailView:_dmgBtnOnClick(i)
...
function Season123_2_3PickHeroDetailView:_locationBtnOnClick(i)
	self._selectLocations[i] = not self._selectLocations[i]

	self:_refreshFilterView()
end

function Season123_2_3PickHeroDetailView:_showRecommendCareer()
	local recommended = Season123Config.instance:getRecommendCareers(Season123PickHeroEntryModel.instance.activityId, Season123PickHeroEntryModel.instance.stage)

	if recommended then
		gohelper.CreateObjList(self, self._onRecommendCareerItemShow, recommended, self._goattrlist, self._goattritem)
	end

	self._txtrecommendAttrDesc.text = recommended and luaLang("herogroupeditview_recommend") or luaLang("herogroupeditview_notrecommend")

	gohelper.setActive(self._goattrlist, recommended)
end

function Season123_2_3PickHeroDetailView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_2_3PickHeroDetailView:_btncloseFilterViewOnClick()
...
function Season123_2_3PickHeroDetailView:_btnclassifyOnClick()
	gohelper.setActive(self._gosearchfilter, true)
	self:_refreshFilterView()
end

function Season123_2_3PickHeroDetailView:_btnresetOnClick()
	for i = 1, 6 do
		self._selectAttrs[i] = false
	end
...
function Season123_2_3PickHeroDetailView:_btnokOnClick()
	gohelper.setActive(self._gosearchfilter, false)
