-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3FightRuleView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3FightRuleView", package.seeall)

local Season123_2_3FightRuleView = class("Season123_2_3FightRuleView", BaseView)

function Season123_2_3FightRuleView:onInitView()
...
function Season123_2_3FightRuleView:addEvents()
	return
end

function Season123_2_3FightRuleView:removeEvents()
	return
end

function Season123_2_3FightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function Season123_2_3FightRuleView:onOpen()
	self:refreshRule()
end

function Season123_2_3FightRuleView:refreshRule()
	local dataList = Season123_2_3FightRuleView.getRuleList() or {}
...
function Season123_2_3FightRuleView:createItem(index)
	local item = {}
...
function Season123_2_3FightRuleView:updateItem(item, data)
...
function Season123_2_3FightRuleView:destroyItem(item)
	return
end

function Season123_2_3FightRuleView.getRuleList()
...
function Season123_2_3FightRuleView:setDecorateVisible(isVisible)
...
function Season123_2_3FightRuleView:onClose()
	return
end

function Season123_2_3FightRuleView:onDestroyView()
...
return Season123_2_3FightRuleView
