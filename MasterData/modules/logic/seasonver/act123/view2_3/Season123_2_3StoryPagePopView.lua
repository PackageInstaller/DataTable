-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3StoryPagePopView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3StoryPagePopView", package.seeall)

local Season123_2_3StoryPagePopView = class("Season123_2_3StoryPagePopView", BaseView)

function Season123_2_3StoryPagePopView:onInitView()
...
function Season123_2_3StoryPagePopView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_3StoryPagePopView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_2_3StoryPagePopView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_3StoryPagePopView:_editableInitView()
	self.transScrollDesc = self._scrolldesc.gameObject:GetComponent(gohelper.Type_RectTransform)
end

function Season123_2_3StoryPagePopView:onUpdateParam()
	return
end

function Season123_2_3StoryPagePopView:onOpen()
...
function Season123_2_3StoryPagePopView:refreshDetailPageUI()
...
Season123_2_3StoryPagePopView.scrollDescHeight = 650
Season123_2_3StoryPagePopView.maxDescSpacing = 41
Season123_2_3StoryPagePopView.minDescSpacing = 35
Season123_2_3StoryPagePopView.minDescFontSize = 27

function Season123_2_3StoryPagePopView:fitScrollHeight()
	...
	recthelper.setHeight(self.transScrollDesc, Season123_2_3StoryPagePopView.scrollDescHeight - heightOffset)
	TaskDispatcher.cancelTask(self.setDescSpacing, self)
	TaskDispatcher.runDelay(self.setDescSpacing, self, 0.01)
end

function Season123_2_3StoryPagePopView:setDescSpacing()
	self._txtdesc.lineSpacing = Mathf.Lerp(Season123_2_3StoryPagePopView.maxDescSpacing, Season123_2_3StoryPagePopView.minDescSpacing, self._txtdesc.fontSize - Season123_2_3StoryPagePopView.minDescFontSize)
end

function Season123_2_3StoryPagePopView:onClose()
	Season123Controller.instance:dispatchEvent(Season123Event.GuideEntryOtherViewClose)
	TaskDispatcher.cancelTask(self.setDescSpacing, self)
end

function Season123_2_3StoryPagePopView:onDestroyView()
	self._simagePolaroid:UnLoadImage()
end

return Season123_2_3StoryPagePopView
