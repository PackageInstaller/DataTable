-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EnemyTabList.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EnemyTabList", package.seeall)

local Season123_2_3EnemyTabList = class("Season123_2_3EnemyTabList", BaseView)

function Season123_2_3EnemyTabList:onInitView()
...
function Season123_2_3EnemyTabList:_editableInitView()
	self._simagebattlelistbg:LoadImage(ResUrl.getWeekWalkBg("bg_zuodi.png"))

	self._tabItems = {}
end

function Season123_2_3EnemyTabList:onDestroyView()
...
function Season123_2_3EnemyTabList:onOpen()
	self.addEventCb(self, Season123Controller.instance, Season123Event.EnemyDetailSwitchTab, self.refreshSelect, self)
	self:refreshUI()
end

function Season123_2_3EnemyTabList:refreshUI()
	self:refreshItems()
	self:refreshSelect()
end

function Season123_2_3EnemyTabList:refreshItems()
...
function Season123_2_3EnemyTabList:getOrCreateTabItem(index)
...
function Season123_2_3EnemyTabList:onClickTab(index)
	Season123EnemyController.instance:switchTab(index)
end

function Season123_2_3EnemyTabList:refreshSelect()
	local battleIds = Season123EnemyModel.instance:getBattleIds()
...
return Season123_2_3EnemyTabList
