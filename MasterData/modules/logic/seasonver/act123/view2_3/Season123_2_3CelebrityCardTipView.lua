-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3CelebrityCardTipView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3CelebrityCardTipView", package.seeall)

local Season123_2_3CelebrityCardTipView = class("Season123_2_3CelebrityCardTipView", BaseView)

function Season123_2_3CelebrityCardTipView:onInitView()
...
function Season123_2_3CelebrityCardTipView:addEvents()
...
function Season123_2_3CelebrityCardTipView:removeEvents()
...
function Season123_2_3CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_3CelebrityCardTipView:onClickGMAdd(count)
...
function Season123_2_3CelebrityCardTipView:_btninputOnClick()
...
function Season123_2_3CelebrityCardTipView:_editableInitView()
...
function Season123_2_3CelebrityCardTipView:onDestroyView()
...
function Season123_2_3CelebrityCardTipView:onOpen()
...
function Season123_2_3CelebrityCardTipView:onClose()
	return
end

function Season123_2_3CelebrityCardTipView:refreshUI()
...
function Season123_2_3CelebrityCardTipView:refreshQuantity()
...
function Season123_2_3CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season123_2_3CelebrityCardTipView:refreshSkills()
...
function Season123_2_3CelebrityCardTipView:checkCreateIcon()
...
function Season123_2_3CelebrityCardTipView:getOrCreatePropText(index)
...
function Season123_2_3CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season123_2_3CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season123_2_3CelebrityCardTipView
