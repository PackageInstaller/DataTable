-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3StoryView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3StoryView", package.seeall)

local Season123_2_3StoryView = class("Season123_2_3StoryView", BaseView)

function Season123_2_3StoryView:onInitView()
...
function Season123_2_3StoryView:addEvents()
...
function Season123_2_3StoryView:removeEvents()
...
function Season123_2_3StoryView:_btnLeftOnClick()
...
function Season123_2_3StoryView:_btnRightOnClick()
...
function Season123_2_3StoryView:_editableInitView()
...
function Season123_2_3StoryView:onOpen()
...
function Season123_2_3StoryView:refreshUI()
...
function Season123_2_3StoryView:initCoverPageUI()
...
function Season123_2_3StoryView:refreshDetailPageUI()
...
function Season123_2_3StoryView:createCoverItem()
	...
	for storyId, storyConfig in pairs(allStoryConfig) do
		...
		if not coverItem then
			...
			coverItem.item = MonoHelper.addNoUpdateLuaComOnceToGo(coverItem.go, Season123_2_3StoryCoverItem, {
				actId = self.actId,
				storyId = storyId,
...
function Season123_2_3StoryView:refreshUnlockState()
...
function Season123_2_3StoryView:setStrToBool(unlockStateStr)
...
function Season123_2_3StoryView:onCoverItemClick(param)
	self.curPageIndex = param.storyId

	self:showSwitchPageAnim("todetail")
end

function Season123_2_3StoryView:showSwitchPageAnim(animName)
...
function Season123_2_3StoryView:refreshPage()
	UIBlockMgr.instance:endBlock("playSwitchPageAnim")
	self:refreshUI()
end

Season123_2_3StoryView.scrollDescHeight = 650
Season123_2_3StoryView.maxDescSpacing = 41
Season123_2_3StoryView.minDescSpacing = 35
Season123_2_3StoryView.minDescFontSize = 27

function Season123_2_3StoryView:fitScrollHeight()
	...
	recthelper.setHeight(self.transScrollDesc, Season123_2_3StoryView.scrollDescHeight - heightOffset)
...
function Season123_2_3StoryView:setDescSpacing()
	local fontSize = self._txtdesc.fontSize

	self._txtdesc.lineSpacing = Mathf.Lerp(Season123_2_3StoryView.maxDescSpacing, Season123_2_3StoryView.minDescSpacing, self._txtdesc.fontSize - Season123_2_3StoryView.minDescFontSize)
	self._txtdesc.enableAutoSizing = false
	self._txtdesc.fontSize = fontSize
end

function Season123_2_3StoryView:onClose()
	self:saveUnlockState()
...
function Season123_2_3StoryView:onDestroyView()
	self._simageCover:UnLoadImage()
	self._simagePolaroid:UnLoadImage()
end

return Season123_2_3StoryView
