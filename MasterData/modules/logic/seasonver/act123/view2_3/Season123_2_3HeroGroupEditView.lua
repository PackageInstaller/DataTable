-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3HeroGroupEditView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3HeroGroupEditView", package.seeall)

local Season123_2_3HeroGroupEditView = class("Season123_2_3HeroGroupEditView", BaseView)

function Season123_2_3HeroGroupEditView:onInitView()
...
function Season123_2_3HeroGroupEditView:addEvents()
...
function Season123_2_3HeroGroupEditView:removeEvents()
...
function Season123_2_3HeroGroupEditView:_btncloseFilterViewOnClick()
...
function Season123_2_3HeroGroupEditView:_btnclassifyOnClick()
	gohelper.setActive(self._gosearchfilter, true)
	self:_refreshFilterView()
end

function Season123_2_3HeroGroupEditView:_btnresetOnClick()
	for i = 1, 6 do
...
function Season123_2_3HeroGroupEditView:_btnokOnClick()
	gohelper.setActive(self._gosearchfilter, false)
...
function Season123_2_3HeroGroupEditView:_btnpassiveskillOnClick()
...
function Season123_2_3HeroGroupEditView:_btnconfirmOnClick()
...
function Season123_2_3HeroGroupEditView:_btncancelOnClick()
	self:closeThis()
end

function Season123_2_3HeroGroupEditView:_btncharacterOnClick()
	if self._heroMO then
		local heroMoList = {}
...
function Season123_2_3HeroGroupEditView:_btnattributeOnClick()
	if self._heroMO then
...
function Season123_2_3HeroGroupEditView:_btnexskillrankOnClick()
	local x, y = transformhelper.getLocalPos(self._goScrollContent.transform)
...
function Season123_2_3HeroGroupEditView:_btnlvrankOnClick()
	local x, y = transformhelper.getLocalPos(self._goScrollContent.transform)
...
function Season123_2_3HeroGroupEditView:_btnrarerankOnClick()
	local x, y = transformhelper.getLocalPos(self._goScrollContent.transform)
...
function Season123_2_3HeroGroupEditView:_btnquickeditOnClick()
...
function Season123_2_3HeroGroupEditView:_attrBtnOnClick(i)
	self._selectAttrs[i] = not self._selectAttrs[i]

	self:_refreshFilterView()
end

function Season123_2_3HeroGroupEditView:_dmgBtnOnClick(i)
...
function Season123_2_3HeroGroupEditView:_locationBtnOnClick(i)
	self._selectLocations[i] = not self._selectLocations[i]

	self:_refreshFilterView()
end

function Season123_2_3HeroGroupEditView:_onHeroItemClick(heroMO)
	self._heroMO = heroMO

	self:_refreshCharacterInfo()
end

function Season123_2_3HeroGroupEditView:_refreshCharacterInfo()
	if self._heroMO then
...
function Season123_2_3HeroGroupEditView:_refreshMainInfo()
	if self._heroMO then
...
function Season123_2_3HeroGroupEditView:_refreshAttribute()
	if self._heroMO then
...
function Season123_2_3HeroGroupEditView:_refreshPassiveSkill()
	if not self._heroMO then
		return
	end
...
function Season123_2_3HeroGroupEditView:_refreshSkill()
	self._skillContainer:onUpdateMO(self._heroMO and self._heroMO.heroId, false, self._heroMO)
end

function Season123_2_3HeroGroupEditView:_refreshBtnIcon()
...
function Season123_2_3HeroGroupEditView:_refreshFilterView()
	for i = 1, 2 do
...
function Season123_2_3HeroGroupEditView:_updateHeroList()
	local dmgs = {}
...
function Season123_2_3HeroGroupEditView:replaceSelectHeroDefaultEquip()
...
function Season123_2_3HeroGroupEditView:_saveCurGroupInfo()
...
function Season123_2_3HeroGroupEditView:_saveQuickGroupInfo()
...
function Season123_2_3HeroGroupEditView:_onAttributeChanged(level, heroId)
	CharacterModel.instance:setFakeLevel(heroId, level)
end

function Season123_2_3HeroGroupEditView:_normalEditHasChange()
	return true
end

function Season123_2_3HeroGroupEditView:_refreshEditMode()
...
function Season123_2_3HeroGroupEditView:_refreshCurScrollBySort()
	if self._isShowQuickEdit then
		if Season123HeroGroupQuickEditModel.instance:getIsDirty() then
			self:_saveQuickGroupInfo()
		end
...
function Season123_2_3HeroGroupEditView:_onGroupModify()
	if self._isShowQuickEdit then
		Season123HeroGroupQuickEditModel.instance:copyQuickEditCardList()
	else
...
function Season123_2_3HeroGroupEditView:_editableInitView()
...
function Season123_2_3HeroGroupEditView:onOpen()
...
function Season123_2_3HeroGroupEditView:onClose()
...
function Season123_2_3HeroGroupEditView:_onOpenView(viewName)
...
function Season123_2_3HeroGroupEditView:_onCloseView(viewName)
...
function Season123_2_3HeroGroupEditView:_delyStopBgm()
	self._isStopBgm = false

	AudioMgr.instance:trigger(AudioEnum.Bgm.Pause_FightingMusic)
end

function Season123_2_3HeroGroupEditView:_showCharacterRankUpView(func)
	func()
end

function Season123_2_3HeroGroupEditView:onDestroyView()
...
function Season123_2_3HeroGroupEditView:_showRecommendCareer()
...
function Season123_2_3HeroGroupEditView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

return Season123_2_3HeroGroupEditView
