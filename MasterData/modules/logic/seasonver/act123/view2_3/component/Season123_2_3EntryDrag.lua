-- chunkname: @modules/logic/seasonver/act123/view2_3/component/Season123_2_3EntryDrag.lua

module("modules.logic.seasonver.act123.view2_3.component.Season123_2_3EntryDrag", package.seeall)

local Season123_2_3EntryDrag = class("Season123_2_3EntryDrag", UserDataDispose)

function Season123_2_3EntryDrag:init(goFullScreen, tfScene)
	self:__onInit()
...
function Season123_2_3EntryDrag:dispose()
	if self._drag then
...
function Season123_2_3EntryDrag:initBound()
...
function Season123_2_3EntryDrag:onDragBegin(param, pointerEventData)
...
function Season123_2_3EntryDrag:onDragEnd(param, pointerEventData)
	self._dragBeginPos = nil
	self._beginDragPos = nil
end

function Season123_2_3EntryDrag:onDrag(param, pointerEventData)
...
function Season123_2_3EntryDrag:drag(deltaPos)
...
function Season123_2_3EntryDrag:setScenePosDrag(targetPos)
...
function Season123_2_3EntryDrag:setScenePosTween(targetPos, tweenTime, callback, callbackObj)
...
function Season123_2_3EntryDrag:fixTargetPos(targetPos)
...
function Season123_2_3EntryDrag:localMoveDone()
	self._tweenId = nil
end

function Season123_2_3EntryDrag:vectorAdd(v1, v2)
...
function Season123_2_3EntryDrag:getTempPos()
	return self._tempVector
end

function Season123_2_3EntryDrag:killTween()
...
function Season123_2_3EntryDrag:setDragEnabled(value)
	self._dragEnabled = value
end

function Season123_2_3EntryDrag:getDragWorldPos(pointerEventData)
...
function Season123_2_3EntryDrag:handleScreenResize()
	self:initBound()
