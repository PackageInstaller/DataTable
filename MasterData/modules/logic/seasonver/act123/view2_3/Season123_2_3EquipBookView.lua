-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EquipBookView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EquipBookView", package.seeall)

local Season123_2_3EquipBookView = class("Season123_2_3EquipBookView", BaseView)

function Season123_2_3EquipBookView:onInitView()
...
function Season123_2_3EquipBookView:addEvents()
...
function Season123_2_3EquipBookView:removeEvents()
...
Season123_2_3EquipBookView.defaultDescColor = "#cac8c5"

function Season123_2_3EquipBookView:_btncomposeOnClick()
...
function Season123_2_3EquipBookView:sendComposeRequest()
...
function Season123_2_3EquipBookView:_btndecomposeOnClick()
	...
	ViewMgr.instance:openView(ViewName.Season123_2_3DecomposeView, param)
end

function Season123_2_3EquipBookView:_btnbatchDecomposeOnClick()
...
function Season123_2_3EquipBookView:_btnskipEffectOnClick()
...
function Season123_2_3EquipBookView:_editableInitView()
	...
	self.colorStr = Season123_2_3EquipBookView.defaultDescColor

	self:hideEffect()
	gohelper.setActive(self._btnskipEffect.gameObject, false)
end

function Season123_2_3EquipBookView:onOpen()
...
function Season123_2_3EquipBookView:onSwitchCardAnim()
	self:refreshUI()
end

function Season123_2_3EquipBookView:refreshEquipBook()
	self._scrollcardlist.verticalNormalizedPosition = 1

	self:refreshUI()
end

function Season123_2_3EquipBookView:refreshUI()
...
function Season123_2_3EquipBookView:refreshCardDesc()
...
function Season123_2_3EquipBookView:refreshCardItem(itemConfig)
...
function Season123_2_3EquipBookView:cardDescItemShow(obj, data, index)
	obj.name = "desc" .. index
...
function Season123_2_3EquipBookView:setSkillClickCallBack(effId, clickPosition)
...
function Season123_2_3EquipBookView:refreshIcon()
	if not self._icon then
		local go = self._gocarditem

		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_2_3CelebrityCardEquip)
	end
...
function Season123_2_3EquipBookView:refreshBtn()
	local equipItemCount = self:getItemCount()
...
function Season123_2_3EquipBookView:isMainCardOverCount()
	if self.itemId then
...
function Season123_2_3EquipBookView:canCompose()
	if not self.itemId then
		return false
	end
...
function Season123_2_3EquipBookView:getItemCount()
	local itemMap = Season123Model.instance:getAllItemMo(self.actId)

	return GameUtil.getTabLen(itemMap)
end

function Season123_2_3EquipBookView:onChangeSelectCard()
	self._animatorCard:Play("switch", 0, 0)
	self:hideEffect()
end

function Season123_2_3EquipBookView:doDecompose(decomposeList)
...
function Season123_2_3EquipBookView:sendDecomposeEquipRequest()
...
function Season123_2_3EquipBookView:showDecomposeEffect()
...
function Season123_2_3EquipBookView:showComposeEffect()
...
function Season123_2_3EquipBookView:hideEffect()
	gohelper.setActive(self._godecomposeEffect, false)
	gohelper.setActive(self._gocomposeEffect, false)
end

function Season123_2_3EquipBookView:onClose()
	TaskDispatcher.cancelTask(self.sendComposeRequest, self)
	TaskDispatcher.cancelTask(self.sendDecomposeEquipRequest, self)
...
function Season123_2_3EquipBookView:onDestroyView()
...
return Season123_2_3EquipBookView
