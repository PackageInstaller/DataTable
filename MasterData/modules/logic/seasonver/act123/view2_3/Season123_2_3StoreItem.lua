-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3StoreItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3StoreItem", package.seeall)

local Season123_2_3StoreItem = class("Season123_2_3StoreItem", ListScrollCell)

function Season123_2_3StoreItem:init(go)
	self.go = go
...
function Season123_2_3StoreItem:onClick()
...
function Season123_2_3StoreItem:onUpdateMO(data)
	self.data = data
...
function Season123_2_3StoreItem:refreshRemainBuyCount()
...
function Season123_2_3StoreItem:refreshTag()
