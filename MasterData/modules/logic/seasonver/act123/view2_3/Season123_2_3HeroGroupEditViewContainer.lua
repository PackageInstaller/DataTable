-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3HeroGroupEditViewContainer.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3HeroGroupEditViewContainer", package.seeall)

local Season123_2_3HeroGroupEditViewContainer = class("Season123_2_3HeroGroupEditViewContainer", BaseViewContainer)

function Season123_2_3HeroGroupEditViewContainer:buildViews()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "#go_rolecontainer/#scroll_card"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[1]
	scrollParam.cellClass = Season123_2_3HeroGroupEditItem
	...
	return {
		Season123_2_3HeroGroupEditView.New(),
...
function Season123_2_3HeroGroupEditViewContainer:getQuickEditScroll()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "#go_rolecontainer/#scroll_quickedit"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[2]
	scrollParam.cellClass = Season123_2_3HeroGroupQuickEditItem
	scrollParam.scrollDir = ScrollEnum.ScrollDirV
	scrollParam.lineCount = 5
	scrollParam.cellWidth = 200
	scrollParam.cellHeight = 472
...
function Season123_2_3HeroGroupEditViewContainer:buildTabViews(tabContainerId)
...
function Season123_2_3HeroGroupEditViewContainer:onContainerOpenFinish()
	self._navigateButtonView:resetOnCloseViewAudio(AudioEnum.HeroGroupUI.Play_UI_Team_Close)
end

function Season123_2_3HeroGroupEditViewContainer:_overrideClose()
...
function Season123_2_3HeroGroupEditViewContainer:_setHomeBtnVisible(isVisible)
...
return Season123_2_3HeroGroupEditViewContainer
