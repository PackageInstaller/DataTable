-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3DecomposeItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3DecomposeItem", package.seeall)

local Season123_2_3DecomposeItem = class("Season123_2_3DecomposeItem", ListScrollCellExtend)

function Season123_2_3DecomposeItem:init(go)
	Season123_2_3DecomposeItem.super.init(self, go)
...
function Season123_2_3DecomposeItem:addEventListeners()
...
function Season123_2_3DecomposeItem:removeEventListeners()
...
function Season123_2_3DecomposeItem:onUpdateMO(mo)
	self._mo = mo
...
Season123_2_3DecomposeItem.AnimRowCount = 4
Season123_2_3DecomposeItem.OpenAnimTime = 0.06
Season123_2_3DecomposeItem.OpenAnimStartTime = 0.05

function Season123_2_3DecomposeItem:refreshUI()
...
function Season123_2_3DecomposeItem:refreshEquipedHero(heroUid)
...
function Season123_2_3DecomposeItem:checkPlayAnim()
...
function Season123_2_3DecomposeItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_2_3DecomposeItem:checkCreateIcon()
...
function Season123_2_3DecomposeItem:onClickSelf()
...
function Season123_2_3DecomposeItem:showDecomposeEffect()
...
function Season123_2_3DecomposeItem:hideDecomposeEffect()
	gohelper.setActive(self._goDecomposeEffect, false)
end

function Season123_2_3DecomposeItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
...
return Season123_2_3DecomposeItem
