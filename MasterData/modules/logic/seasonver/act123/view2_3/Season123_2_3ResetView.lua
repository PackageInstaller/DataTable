-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3ResetView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3ResetView", package.seeall)

local Season123_2_3ResetView = class("Season123_2_3ResetView", BaseView)

function Season123_2_3ResetView:onInitView()
...
function Season123_2_3ResetView:addEvents()
	self._btnreset:AddClickListener(self._btnresetOnClick, self)
end

function Season123_2_3ResetView:removeEvents()
	self._btnreset:RemoveClickListener()
end

function Season123_2_3ResetView:_editableInitView()
	self._heroItems = {}
	self._episodeItems = {}
...
function Season123_2_3ResetView:onDestroyView()
...
function Season123_2_3ResetView:onOpen()
	self.addEventCb(self, Season123Controller.instance, Season123Event.RefreshResetView, self.refreshUI, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.OnResetSucc, self.closeThis, self)
...
function Season123_2_3ResetView:onClose()
	return
end

function Season123_2_3ResetView:refreshUI()
	self:refreshStatus()
	self:refreshStage()
...
function Season123_2_3ResetView:refreshStatus()
...
function Season123_2_3ResetView:refreshStage()
...
function Season123_2_3ResetView:refreshEpisodeItems()
...
function Season123_2_3ResetView:refreshEpisodeItem(index, data)
...
function Season123_2_3ResetView:refreshSingleItemFinished(index, item, data)
...
function Season123_2_3ResetView:refreshHeroItems()
...
function Season123_2_3ResetView:refreshHero(item, data)
	if not data then
...
function Season123_2_3ResetView:refreshHeroHp(item, data)
	if not data then
...
function Season123_2_3ResetView:createStageItem()
...
function Season123_2_3ResetView:getOrCreateEpisodeItem(index)
...
function Season123_2_3ResetView:getOrCreateHeroItem(index)
...
function Season123_2_3ResetView:delayInitScrollAudio()
	self._audioScroll = MonoHelper.addLuaComOnceToGo(self._goscrollchapter, Season123_2_3ResetViewAudio, self._scrollchapter)
...
function Season123_2_3ResetView:onDragAudioBegin()
	self._audioScroll:onDragBegin()
end

function Season123_2_3ResetView:onDragAudioEnd()
	self._audioScroll:onDragEnd()
end

function Season123_2_3ResetView:onClickAudioDown()
	self._audioScroll:onClickDown()
end

function Season123_2_3ResetView:onClickStageItem()
...
function Season123_2_3ResetView:onClickEpisodeItem(index)
...
function Season123_2_3ResetView:_btnresetOnClick()
	Season123ResetController.instance:tryReset()
end

return Season123_2_3ResetView
