-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EpisodeRewardView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EpisodeRewardView", package.seeall)

local Season123_2_3EpisodeRewardView = class("Season123_2_3EpisodeRewardView", BaseView)

function Season123_2_3EpisodeRewardView:onInitView()
...
function Season123_2_3EpisodeRewardView:addEvents()
...
function Season123_2_3EpisodeRewardView:removeEvents()
...
function Season123_2_3EpisodeRewardView:_btnCloseOnClick()
	self:resetView()
end

function Season123_2_3EpisodeRewardView:_editableInitView()
...
function Season123_2_3EpisodeRewardView:onOpen()
	self.actId = self.viewParam.actId
	self.stage = self.viewParam.stage
	self.targetNumList = {}
end

function Season123_2_3EpisodeRewardView:refreshUI()
...
function Season123_2_3EpisodeRewardView:createAndRefreshRewardItem()
	gohelper.CreateObjList(self, self.rewardItemShow, self.itemList, self._gorewardContent, self._gorewardItem)
end

function Season123_2_3EpisodeRewardView:rewardItemShow(obj, data, index)
...
function Season123_2_3EpisodeRewardView:onItemGetClick()
...
function Season123_2_3EpisodeRewardView:refreshProgressBar()
...
function Season123_2_3EpisodeRewardView:initTargetNumList()
...
function Season123_2_3EpisodeRewardView:refreshScrollPos()
	local itemWidth = 240
	local itemSpaceH = 36
...
function Season123_2_3EpisodeRewardView:getCurCanGetIndex()
...
function Season123_2_3EpisodeRewardView:resetView()
	gohelper.setActive(self._goRwards, false)
end

function Season123_2_3EpisodeRewardView:onClose()
	return
end

function Season123_2_3EpisodeRewardView:onDestroyView()
...
return Season123_2_3EpisodeRewardView
