-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EpisodeListScrollAudio.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EpisodeListScrollAudio", package.seeall)

local Season123_2_3EpisodeListScrollAudio = class("Season123_2_3EpisodeListScrollAudio", LuaCompBase)

function Season123_2_3EpisodeListScrollAudio:ctor(param)
	self.scroll = param
...
function Season123_2_3EpisodeListScrollAudio:onDragBegin()
	self._isDraging = true
...
function Season123_2_3EpisodeListScrollAudio:onDragEnd()
	self:onUpdate()

	self._isDraging = false
end

function Season123_2_3EpisodeListScrollAudio:onClickDown()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_start)
end

function Season123_2_3EpisodeListScrollAudio:onUpdate()
...
function Season123_2_3EpisodeListScrollAudio:_onValueChangeSampleOffset(y)
...
function Season123_2_3EpisodeListScrollAudio:_onUpdateRTPCSpeed(y)
...
function Season123_2_3EpisodeListScrollAudio:_onValueChangeForStartOrStop(y)
...
function Season123_2_3EpisodeListScrollAudio:_onValueChangeCheckReplay(y)
...
function Season123_2_3EpisodeListScrollAudio:_resetPlayingStatus(y)
	self._isScrollPlaying = false
	self._scrollingPlayY = y
end

function Season123_2_3EpisodeListScrollAudio:dispose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_end)
...
function Season123_2_3EpisodeListScrollAudio:onDestroy()
	self.scroll = nil
end

return Season123_2_3EpisodeListScrollAudio
