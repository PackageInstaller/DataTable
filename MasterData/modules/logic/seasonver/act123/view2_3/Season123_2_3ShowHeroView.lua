-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3ShowHeroView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3ShowHeroView", package.seeall)

local Season123_2_3ShowHeroView = class("Season123_2_3ShowHeroView", BaseView)

function Season123_2_3ShowHeroView:onInitView()
...
function Season123_2_3ShowHeroView:addEvents()
...
function Season123_2_3ShowHeroView:removeEvents()
...
function Season123_2_3ShowHeroView:_editableInitView()
	self._heroItems = {}
end

function Season123_2_3ShowHeroView:onDestroyView()
...
function Season123_2_3ShowHeroView:onOpen()
...
function Season123_2_3ShowHeroView:onClose()
	if self._heroItems then
		for index, item in pairs(self._heroItems) do
...
function Season123_2_3ShowHeroView:getOrCreateItem(index)
	local item = self._heroItems[index]

	if not item then
		item = self:getUserDataTb_()
		item.go = gohelper.cloneInPlace(self._goitem, "item_" .. tostring(index))
		item.component = Season123_2_3ShowHeroItem.New()
...
function Season123_2_3ShowHeroView:_btndetailsOnClick()
...
function Season123_2_3ShowHeroView:_btnresetOnClick()
	Season123ShowHeroController.instance:openReset()
end

function Season123_2_3ShowHeroView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_3ShowHeroView:handleEnterStageSuccess()
...
return Season123_2_3ShowHeroView
