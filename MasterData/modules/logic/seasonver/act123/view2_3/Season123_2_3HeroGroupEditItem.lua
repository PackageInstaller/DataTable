-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3HeroGroupEditItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3HeroGroupEditItem", package.seeall)

local Season123_2_3HeroGroupEditItem = class("Season123_2_3HeroGroupEditItem", ListScrollCell)

function Season123_2_3HeroGroupEditItem:init(go)
...
function Season123_2_3HeroGroupEditItem:_initObj(go)
...
function Season123_2_3HeroGroupEditItem:addEventListeners()
	self.addEventCb(self, CharacterController.instance, CharacterEvent.levelUpAttribute, self._onAttributeChanged, self)
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successDressUpSkin, self._onSkinChanged, self)
end

function Season123_2_3HeroGroupEditItem:removeEventListeners()
	return
end

function Season123_2_3HeroGroupEditItem:_onSkinChanged()
	self._heroItem:updateHero()
end

function Season123_2_3HeroGroupEditItem:_onAttributeChanged(level, heroId)
	self._heroItem:setLevel(level, heroId)
end

function Season123_2_3HeroGroupEditItem:setAdventureBuff(buffId)
	self._heroItem:setAdventureBuff(buffId)
end

function Season123_2_3HeroGroupEditItem:updateLimitStatus()
...
function Season123_2_3HeroGroupEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_2_3HeroGroupEditItem:refreshHp()
...
function Season123_2_3HeroGroupEditItem:refreshDead()
	if Season123HeroGroupModel.instance:isEpisodeSeason123() then
		local isDead = false
		local actId = Season123HeroGroupEditModel.instance.activityId
		local stage = Season123HeroGroupEditModel.instance.stage
...
function Season123_2_3HeroGroupEditItem:onSelect(select)
...
function Season123_2_3HeroGroupEditItem:_onItemClick()
...
function Season123_2_3HeroGroupEditItem:checkRestrict(heroUid)
...
function Season123_2_3HeroGroupEditItem:checkHpZero(heroUid)
	local actId = Season123HeroGroupEditModel.instance.activityId
	local stage = Season123HeroGroupEditModel.instance.stage
	local layer = Season123HeroGroupEditModel.instance.layer
...
function Season123_2_3HeroGroupEditItem:enableDeselect(enable)
	self._enableDeselect = enable
end

function Season123_2_3HeroGroupEditItem:setHp(hpRate)
...
function Season123_2_3HeroGroupEditItem:onDestroy()
	return
end

function Season123_2_3HeroGroupEditItem:getAnimator()
	return self._animator
end

return Season123_2_3HeroGroupEditItem
