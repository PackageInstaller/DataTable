-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3TaskItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3TaskItem", package.seeall)

local Season123_2_3TaskItem = class("Season123_2_3TaskItem", ListScrollCell)

Season123_2_3TaskItem.BlockKey = "Season123_2_3TaskItemAni"

function Season123_2_3TaskItem:init(go)
	self._viewGO = go
...
function Season123_2_3TaskItem:addEventListeners()
...
function Season123_2_3TaskItem:initTotal()
	self._btnGetTotal = gohelper.findChildButtonWithAudio(self._goTotal, "#btn_getall")
end

Season123_2_3TaskItem.TaskMaskTime = 0.65
Season123_2_3TaskItem.ColumnCount = 1
Season123_2_3TaskItem.AnimRowCount = 7
Season123_2_3TaskItem.OpenAnimTime = 0.06
Season123_2_3TaskItem.OpenAnimStartTime = 0

function Season123_2_3TaskItem:onUpdateMO(mo)
	if mo == nil then
		return
	end
...
function Season123_2_3TaskItem:endPlayOpenAnim()
...
function Season123_2_3TaskItem:checkPlayAnim()
...
function Season123_2_3TaskItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_2_3TaskItem:refreshNormal()
...
function Season123_2_3TaskItem:refreshReward()
...
function Season123_2_3TaskItem:createRewardItem(index)
...
function Season123_2_3TaskItem:refreshRewardItem(item, data)
	if not data then
	...
	if data.equipId then
		...
		if not item.equipIcon then
			item.equipIcon = Season123_2_3CelebrityCardItem.New()
...
function Season123_2_3TaskItem:getAnimator()
	return self._ani
end

function Season123_2_3TaskItem:destroyRewardItem(item)
...
function Season123_2_3TaskItem:refreshDesc()
	local config = self.mo.config
...
function Season123_2_3TaskItem:refreshProgress()
	self._txtCurCount.text = self.mo.progress
	self._txtMaxCount.text = self.mo.config.maxProgress
...
function Season123_2_3TaskItem:refreshState()
...
function Season123_2_3TaskItem:onClickGoto()
...
function Season123_2_3TaskItem:onClickReceive()
	...
	UIBlockMgr.instance:startBlock(Season123_2_3TaskItem.BlockKey)
	Season123Controller.instance:dispatchEvent(Season123Event.OnTaskRewardGetFinish, self._index)
	TaskDispatcher.runDelay(self._onPlayActAniFinished, self, Season123_2_3TaskItem.TaskMaskTime)
end

function Season123_2_3TaskItem:_onPlayActAniFinished()
	...
	UIBlockMgr.instance:endBlock(Season123_2_3TaskItem.BlockKey)
end

function Season123_2_3TaskItem:onClickGetTotal()
	self:onClickReceive()
end

function Season123_2_3TaskItem:onDestroy()
	TaskDispatcher.cancelTask(self._onPlayActAniFinished, self)
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
