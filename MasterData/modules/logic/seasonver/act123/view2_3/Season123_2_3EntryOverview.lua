-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EntryOverview.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EntryOverview", package.seeall)

local Season123_2_3EntryOverview = class("Season123_2_3EntryOverview", BaseView)

function Season123_2_3EntryOverview:onInitView()
...
function Season123_2_3EntryOverview:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_3EntryOverview:removeEvents()
	self._btnclose:RemoveClickListener()
end

Season123_2_3EntryOverview.UI_Item_Count = 6

function Season123_2_3EntryOverview:_editableInitView()
	self._entryList = {}

	self:initItems()
end

function Season123_2_3EntryOverview:onDestroyView()
...
function Season123_2_3EntryOverview:onOpen()
...
function Season123_2_3EntryOverview:onClose()
	return
end

function Season123_2_3EntryOverview:refreshUI()
	self:refreshItems()
end

function Season123_2_3EntryOverview:refreshItems()
	local actId = Season123EntryOverviewModel.instance:getActId()
	local stageCOList = Season123Config.instance:getStageCos(actId)

	if stageCOList then
		for index = 1, Season123_2_3EntryOverview.UI_Item_Count do
...
function Season123_2_3EntryOverview:refreshItem(item, stageCO, stageMO)
	local actId = Season123EntryOverviewModel.instance:getActId()
...
function Season123_2_3EntryOverview:refreshProgress(item, stageCO, stageMO)
...
function Season123_2_3EntryOverview:refreshUnlockStatus(item, stageCO, stageMO)
	local rs, reason, value = Season123ProgressUtils.isStageUnlock(self.viewParam.actId, stageCO.stage)
...
function Season123_2_3EntryOverview:initItems()
	for i = 1, Season123_2_3EntryOverview.UI_Item_Count do
...
function Season123_2_3EntryOverview:handleGetActInfo(actId)
	if self.viewParam.actId == actId then
		self:refreshUI()
	end
end

function Season123_2_3EntryOverview:onClickIndex(index)
...
function Season123_2_3EntryOverview:_btncloseOnClick()
	self._viewAnimator:Play(UIAnimationName.Close, 0, 0)
	TaskDispatcher.runDelay(self._closeCallback, self, 0.17)
end

function Season123_2_3EntryOverview:_closeCallback()
	self:closeThis()
end

function Season123_2_3EntryOverview:_playUnlockAnim()
	local actId = Season123EntryOverviewModel.instance:getActId()
	local stageCOList = Season123Config.instance:getStageCos(actId)
...
return Season123_2_3EntryOverview
