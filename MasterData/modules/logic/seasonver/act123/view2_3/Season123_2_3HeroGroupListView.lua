-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3HeroGroupListView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3HeroGroupListView", package.seeall)

local Season123_2_3HeroGroupListView = class("Season123_2_3HeroGroupListView", BaseView)

function Season123_2_3HeroGroupListView:onInitView()
...
function Season123_2_3HeroGroupListView:_editableInitView()
	self._heroItemList = {}
	...
	for i = 1, 4 do
		...
		local item = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGO, Season123_2_3HeroGroupHeroItem, self)
...
function Season123_2_3HeroGroupListView:addEvents()
...
function Season123_2_3HeroGroupListView:removeEvents()
...
function Season123_2_3HeroGroupListView:onOpen()
	self._isOpen = true
...
function Season123_2_3HeroGroupListView:_playOpenAnimation()
...
function Season123_2_3HeroGroupListView:_checkRestrictHero()
...
function Season123_2_3HeroGroupListView:_removeRestrictHero()
...
function Season123_2_3HeroGroupListView:_onHeroGroupExit()
...
function Season123_2_3HeroGroupListView:_closeTweenFinish(index)
...
function Season123_2_3HeroGroupListView:canDrag(param, isWrap)
...
function Season123_2_3HeroGroupListView:_onBeginDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_2_3HeroGroupListView:_onDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_2_3HeroGroupListView:_onEndDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
	...
	if not canMoveTar or not canMoveSrc then
		...
		if not canMoveTar then
			GameFacade.showToast(Season123_2_3EquipItem.Toast_Pos_Wrong, posStrTar)
		end

		if not canMoveSrc then
			GameFacade.showToast(Season123_2_3EquipItem.Toast_Pos_Wrong, posStrSrc)
		end
...
function Season123_2_3HeroGroupListView:_setHeroItemPos(heroItem, index, tween, callback, callbackObj)
	local posTr = self.heroPosTrList[index]
...
function Season123_2_3HeroGroupListView:_tweenToPos(heroItem, anchorPos)
...
function Season123_2_3HeroGroupListView:_setDragEnabled(isEnabled)
	for i, drag in ipairs(self._heroItemDrag) do
		drag.enabled = isEnabled
	end
end

function Season123_2_3HeroGroupListView:_updateHeroList()
	for i, heroItem in ipairs(self._heroItemList) do
		local mo
...
function Season123_2_3HeroGroupListView:_onSnapshotSaveSucc()
	self:_updateHeroList()
...
function Season123_2_3HeroGroupListView:_calcIndex(position)
	for i = 1, 4 do
...
function Season123_2_3HeroGroupListView:onDestroyView()
...
function Season123_2_3HeroGroupListView:_onScreenSizeChange()
	for i = 1, ModuleEnum.MaxHeroCountInGroup do
		local heroItem = self._heroItemList[i]
...
function Season123_2_3HeroGroupListView:getHeroItemList()
	return self._heroItemList
end

return Season123_2_3HeroGroupListView
