-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3HeroGroupMainCardView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3HeroGroupMainCardView", package.seeall)

local Season123_2_3HeroGroupMainCardView = class("Season123_2_3HeroGroupMainCardView", BaseView)

function Season123_2_3HeroGroupMainCardView:onInitView()
...
function Season123_2_3HeroGroupMainCardView:addEvents()
	return
end

function Season123_2_3HeroGroupMainCardView:removeEvents()
	return
end

function Season123_2_3HeroGroupMainCardView:_editableInitView()
...
function Season123_2_3HeroGroupMainCardView:onDestroyView()
...
function Season123_2_3HeroGroupMainCardView:onOpen()
	self.addEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self.refreshMainCards, self)
	self.addEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnSnapshotSaveSucc, self.refreshMainCards, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.HeroGroupIndexChanged, self.refreshMainCards, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.RecordRspMainCardRefresh, self.refreshMainCards, self)
	self:refreshMainCards()
end

function Season123_2_3HeroGroupMainCardView:onClose()
	return
end

function Season123_2_3HeroGroupMainCardView:refreshMainCards()
	for slot = 1, Activity123Enum.MainCardNum do
		self:_refreshMainCard(slot)
	end
end

function Season123_2_3HeroGroupMainCardView:_refreshMainCard(slot)
	...
	if act104EquipId and act104EquipId ~= 0 then
		if not cardItem then
			cardItem = Season123_2_3CelebrityCardItem.New()
...
function Season123_2_3HeroGroupMainCardView:_btnseasonsupercardOnClick(slot)
...
return Season123_2_3HeroGroupMainCardView
