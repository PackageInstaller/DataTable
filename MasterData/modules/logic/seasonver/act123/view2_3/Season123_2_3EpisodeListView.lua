-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EpisodeListView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EpisodeListView", package.seeall)

local Season123_2_3EpisodeListView = class("Season123_2_3EpisodeListView", BaseView)

function Season123_2_3EpisodeListView:onInitView()
...
function Season123_2_3EpisodeListView:addEvents()
...
function Season123_2_3EpisodeListView:removeEvents()
...
function Season123_2_3EpisodeListView:_editableInitView()
	self._stageItems = {}
...
function Season123_2_3EpisodeListView:onDestroyView()
	...
	UIBlockMgr.instance:endBlock(Season123_2_3EpisodeListView.SCROLL_ANIM_BLOCK_KEY)
...
function Season123_2_3EpisodeListView:onOpen()
...
function Season123_2_3EpisodeListView:onClose()
	return
end

function Season123_2_3EpisodeListView:refreshUI()
...
function Season123_2_3EpisodeListView:refreshStageList()
	local layerDatas = Season123EpisodeListModel.instance:getList()
	local processSet = {}
...
function Season123_2_3EpisodeListView:getOrCreateLayerItem(index)
...
function Season123_2_3EpisodeListView:refreshSingleItem(index, item, data)
...
function Season123_2_3EpisodeListView:refreshSingleItemLock(index, item, data)
...
function Season123_2_3EpisodeListView:refreshSingleItemFinished(index, item, data)
	local isUnlock = Season123EpisodeListModel.instance:isEpisodeUnlock(data.cfg.layer)
...
function Season123_2_3EpisodeListView:refreshCenter()
	if self._centerItem then
		self._centerItem:refreshUI()
	end
end

function Season123_2_3EpisodeListView:initCenter()
	self._centerItem = Season123_2_3EpisodeListCenter.New()

	self._centerItem:init(self._goentranceitem)
	self._centerItem:initData(self.viewParam.actId, self.viewParam.stage)
end

Season123_2_3EpisodeListView.OutOfBoundOffset = 280
Season123_2_3EpisodeListView.DelayEnterEpisodeTime = 0.2
Season123_2_3EpisodeListView.SCROLL_ANIM_BLOCK_KEY = "Season123_2_3EpisodeListView_scrollanim"

function Season123_2_3EpisodeListView:playScrollAnim(index)
	UIBlockMgr.instance:startBlock(Season123_2_3EpisodeListView.SCROLL_ANIM_BLOCK_KEY)
	...
	if deltaY > Season123_2_3EpisodeListView.OutOfBoundOffset then
		self._tweenIdScroll = ZProj.TweenHelper.DOAnchorPosY(self._rectScroll, targetY + Season123_2_3EpisodeListView.OutOfBoundOffset, Season123_2_3EpisodeListView.DelayEnterEpisodeTime, self.handlePlayScrollAnimCompleted, self)
	elseif deltaY < -Season123_2_3EpisodeListView.OutOfBoundOffset then
		self._tweenIdScroll = ZProj.TweenHelper.DOAnchorPosY(self._rectScroll, targetY - Season123_2_3EpisodeListView.OutOfBoundOffset, Season123_2_3EpisodeListView.DelayEnterEpisodeTime, self.handlePlayScrollAnimCompleted, self)
	else
		self._viewAnimator:Play(UIAnimationName.Close, 0, 0)
		TaskDispatcher.runDelay(self.handlePlayScrollAnimCompleted, self, Season123_2_3EpisodeListView.DelayEnterEpisodeTime)
	end
end

function Season123_2_3EpisodeListView:handlePlayScrollAnimCompleted()
...
function Season123_2_3EpisodeListView:getScrollToIndexY(index)
...
function Season123_2_3EpisodeListView:onItemClick(index)
...
function Season123_2_3EpisodeListView:_btnheroesOnClick()
	local actId = self.viewParam.actId
...
function Season123_2_3EpisodeListView:_btnresetOnClick()
...
function Season123_2_3EpisodeListView:_btndetailsOnClick()
...
function Season123_2_3EpisodeListView:_btntiprewardOnClick()
...
function Season123_2_3EpisodeListView:_btnadditionruleDetailOnClick()
...
function Season123_2_3EpisodeListView:_btnMaskOnClick()
	self.viewContainer:_overrideCloseFunc()
end

function Season123_2_3EpisodeListView:OnDotChange()
...
function Season123_2_3EpisodeListView:onCloseView(viewName)
	if viewName == ViewName.Season123_2_3EpisodeDetailView then
		self:refreshStageList()
		self._viewAnimator:Play(UIAnimationName.Open, 0, 0)
	end
end

function Season123_2_3EpisodeListView:delayAddScrollAudio()
	self._audioScroll = MonoHelper.addLuaComOnceToGo(self._goscrollstory, Season123_2_3EpisodeListScrollAudio, self._scrollStory)
...
function Season123_2_3EpisodeListView:_onDragBegin()
	self._audioScroll:onDragBegin()
end

function Season123_2_3EpisodeListView:_onDragEnd()
	self._audioScroll:onDragEnd()
end

function Season123_2_3EpisodeListView:_onClickDown()
	self._audioScroll:onClickDown()
end

return Season123_2_3EpisodeListView
