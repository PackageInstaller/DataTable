-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EquipTagSelect.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EquipTagSelect", package.seeall)

local Season123_2_3EquipTagSelect = class("Season123_2_3EquipTagSelect", BaseView)

function Season123_2_3EquipTagSelect:onInitView()
	if self._editableInitView then
		self:_editableInitView()
	end
end

function Season123_2_3EquipTagSelect:addEvents()
	return
end

function Season123_2_3EquipTagSelect:removeEvents()
	return
end

function Season123_2_3EquipTagSelect:init(ctrl, dropListPath, defaultColor)
	self._controller = ctrl
	self._dropListPath = dropListPath
	self._defaultColor = defaultColor or "#cac8c5"
end

function Season123_2_3EquipTagSelect:_editableInitView()
...
function Season123_2_3EquipTagSelect:onDestroyView()
...
function Season123_2_3EquipTagSelect:onOpen()
...
function Season123_2_3EquipTagSelect:onClose()
	return
end

function Season123_2_3EquipTagSelect:handleClickTag()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Common_Click)
end

function Season123_2_3EquipTagSelect:handleDropValueChanged(index)
...
function Season123_2_3EquipTagSelect:refreshSelected()
...
return Season123_2_3EquipTagSelect
