-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3SettlementHeroItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3SettlementHeroItem", package.seeall)

local Season123_2_3SettlementHeroItem = class("Season123_2_3SettlementHeroItem", BaseViewExtended)

function Season123_2_3SettlementHeroItem:onInitView()
...
function Season123_2_3SettlementHeroItem:addEvents()
	return
end

function Season123_2_3SettlementHeroItem:removeEvents()
	return
end

function Season123_2_3SettlementHeroItem:onRefreshViewParam(is_replay, hero, equip, equip_104, replay_data, trail)
...
function Season123_2_3SettlementHeroItem:onOpen()
...
function Season123_2_3SettlementHeroItem:_showNormalData()
	if self._trail then
...
function Season123_2_3SettlementHeroItem:_showTrailHeroIcon(trail)
	if not trail then
		return
	end
...
function Season123_2_3SettlementHeroItem:_showHeroIcon(heroId, skinId)
...
function Season123_2_3SettlementHeroItem:checkAssist(heroUid, heroMO)
	if not heroMO then
...
function Season123_2_3SettlementHeroItem:_showEquipIcon(equip_id)
...
function Season123_2_3SettlementHeroItem:_showEquip123(index, uid, totalEquipCount, equipId)
	if equipId == 0 then
		return
	end
	...
	if totalEquipCount <= 1 then
		if not self._gosingle then
			...
			self:openSubView(Season123_2_3CelebrityCardGetItem, Season123_2_3CelebrityCardItem.AssetPath, parentTran, uid, nil, equipId)
		end
	end
end

function Season123_2_3SettlementHeroItem:_showReplayData()
...
function Season123_2_3SettlementHeroItem:_refreshEquipPos()
	return
end

function Season123_2_3SettlementHeroItem:onClose()
	return
end

function Season123_2_3SettlementHeroItem:onDestroyView()
	self._simageheroicon:UnLoadImage()
end

return Season123_2_3SettlementHeroItem
