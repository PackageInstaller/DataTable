-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5StoreItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5StoreItem", package.seeall)

local Season123_3_5StoreItem = class("Season123_3_5StoreItem", ListScrollCell)

function Season123_3_5StoreItem:init(go)
	self.go = go
...
function Season123_3_5StoreItem:onClick()
...
function Season123_3_5StoreItem:onUpdateMO(data)
	self.data = data
...
function Season123_3_5StoreItem:refreshRemainBuyCount()
...
function Season123_3_5StoreItem:refreshTag()
