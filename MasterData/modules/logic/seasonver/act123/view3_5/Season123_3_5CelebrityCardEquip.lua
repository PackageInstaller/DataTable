-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5CelebrityCardEquip.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5CelebrityCardEquip", package.seeall)

local Season123_3_5CelebrityCardEquip = class("Season123_3_5CelebrityCardEquip", LuaCompBase)

function Season123_3_5CelebrityCardEquip:init(go)
	Season123_3_5CelebrityCardEquip.super.init(self, go)
...
Season123_3_5CelebrityCardEquip.MaxRare = 6
Season123_3_5CelebrityCardEquip.MaxLimitCount = 2

function Season123_3_5CelebrityCardEquip:_editableInitView()
	self._rareGoMap = {}

	for i = 1, Season123_3_5CelebrityCardEquip.MaxRare do
...
function Season123_3_5CelebrityCardEquip:onDestroy()
	self:disposeUI()
end

function Season123_3_5CelebrityCardEquip:checkInitBtnClick()
...
function Season123_3_5CelebrityCardEquip:checkInitLongPress()
...
function Season123_3_5CelebrityCardEquip:disposeUI()
...
function Season123_3_5CelebrityCardEquip:updateData(itemId)
	self.itemId = itemId

	self:refreshUI()
end

function Season123_3_5CelebrityCardEquip:createRareMap(go)
...
function Season123_3_5CelebrityCardEquip:refreshUI()
...
function Season123_3_5CelebrityCardEquip:refreshSelfChoice()
...
function Season123_3_5CelebrityCardEquip:refreshIcon()
	if self._curSelectedItem then
...
function Season123_3_5CelebrityCardEquip:refreshFlag()
	if not self.itemId then
		return
	end
...
function Season123_3_5CelebrityCardEquip:refreshIndexLimit()
	...
	gohelper.setActive(self._golimit2, #indexLimitList == Season123_3_5CelebrityCardEquip.MaxLimitCount)
end

function Season123_3_5CelebrityCardEquip:setIndexLimitShowState(state)
	self._showIndexLimit = state

	self:refreshIndexLimit()
end

function Season123_3_5CelebrityCardEquip:setFlagUIPos(targetPosX, targetPosY)
...
function Season123_3_5CelebrityCardEquip:setFlagUIScale(targetScale)
...
function Season123_3_5CelebrityCardEquip:handleIconLoaded()
	if not self._isDisposed then
		local item = self._curSelectedItem
...
function Season123_3_5CelebrityCardEquip:setColorDark(enable)
	self._darkMaskColor = enable and "#7b7b7b" or "#ffffff"

	self:refreshIcon()
end

function Season123_3_5CelebrityCardEquip:setShowTag(enable)
	self._showTag = enable

	self:refreshFlag()
end

function Season123_3_5CelebrityCardEquip:setShowProbability(enable)
	self._showProbability = enable

	self:refreshFlag()
end

function Season123_3_5CelebrityCardEquip:setShowNewFlag(enable)
	self._showNewFlag = enable

	self:refreshFlag()
end

function Season123_3_5CelebrityCardEquip:setShowNewFlag2(enable)
	self._showNewFlag2 = enable

	self:refreshFlag()
end

function Season123_3_5CelebrityCardEquip:setClickCall(clickCall, clickCallObj, param)
...
function Season123_3_5CelebrityCardEquip:setLongPressCall(longPressCall, longPressCallObj, param)
