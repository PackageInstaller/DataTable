-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5TaskMapItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5TaskMapItem", package.seeall)

local Season123_3_5TaskMapItem = class("Season123_3_5TaskMapItem", LuaCompBase)

function Season123_3_5TaskMapItem:ctor(param)
	self.param = param
end

function Season123_3_5TaskMapItem:init(go)
	self:__onInit()
...
function Season123_3_5TaskMapItem:refreshUI()
...
function Season123_3_5TaskMapItem:setScale()
	if Season123TaskModel.instance.curStage == self.stage then
...
function Season123_3_5TaskMapItem:onDestroy()
	self:__onDispose()
...
return Season123_3_5TaskMapItem
