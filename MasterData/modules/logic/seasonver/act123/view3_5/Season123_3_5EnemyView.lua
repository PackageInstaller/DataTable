-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5EnemyView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5EnemyView", package.seeall)

local Season123_3_5EnemyView = class("Season123_3_5EnemyView", BaseView)

function Season123_3_5EnemyView:onInitView()
...
function Season123_3_5EnemyView:addEvents()
...
function Season123_3_5EnemyView:removeEvents()
...
function Season123_3_5EnemyView:_editableInitView()
...
function Season123_3_5EnemyView:onDestroyView()
...
function Season123_3_5EnemyView:onOpen()
...
function Season123_3_5EnemyView:onClose()
...
function Season123_3_5EnemyView:handleClickMonster()
	self:refreshMonsterSelect()
	self:refreshEnemyInfo()
end

function Season123_3_5EnemyView:_onClickClosePassiveView()
	gohelper.setActive(self._gobuffpassiveview, false)

	self.isopenpassiveview = false
end

function Season123_3_5EnemyView:refreshUI()
...
function Season123_3_5EnemyView:getOrCreateGroupItem(i)
...
function Season123_3_5EnemyView:refreshEnemyGroup(i, monsterGroupIds, enemyGroupItemTable)
	local isBoss = false
...
function Season123_3_5EnemyView:getOrCreateEnemyItem(itemGroup, groupIndex, itemIndex)
...
function Season123_3_5EnemyView:onClickMonsterIcon(clickInfo)
...
function Season123_3_5EnemyView:refreshEnemyItem(enemyItemTable, monsterId, groupIndex)
	local monsterConfig = lua_monster.configDict[monsterId]
	local skinConfig = FightConfig.instance:getSkinCO(monsterConfig.skinId)
...
function Season123_3_5EnemyView:refreshMonsterSelect()
	local monsterGroupIds = Season123EnemyModel.instance:getCurrentBattleGroupIds()
...
function Season123_3_5EnemyView:refreshEnemyInfo()
...
function Season123_3_5EnemyView:_refreshSpeicalSkillIcon(monsterConfig)
...
function Season123_3_5EnemyView:_onBuffPassiveSkillClick()
...
function Season123_3_5EnemyView:_setPassiveSkillTip(skillgo, skillInfo)
...
function Season123_3_5EnemyView:_refreshPassiveSkill(monsterConfig, groupIndex)
...
function Season123_3_5EnemyView:_refreshSkill(monsterConfig)
	local skillIds = {}
...
function Season123_3_5EnemyView:_refreshSuper(monsterConfig)
...
function Season123_3_5EnemyView:createSuperItem()
...
function Season123_3_5EnemyView:_refreshAttribute(monsterConfig)
...
function Season123_3_5EnemyView:_onMonsterAttrItemShow(obj, data, index)
...
function Season123_3_5EnemyView:_onClickShowAttribute()
