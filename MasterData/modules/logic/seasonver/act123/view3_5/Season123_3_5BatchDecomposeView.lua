-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5BatchDecomposeView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5BatchDecomposeView", package.seeall)

local Season123_3_5BatchDecomposeView = class("Season123_3_5BatchDecomposeView", BaseView)

function Season123_3_5BatchDecomposeView:onInitView()
...
function Season123_3_5BatchDecomposeView:addEvents()
...
function Season123_3_5BatchDecomposeView:removeEvents()
...
Season123_3_5BatchDecomposeView.maxOverCount = 4

function Season123_3_5BatchDecomposeView:_btnrarerankOnClick()
...
function Season123_3_5BatchDecomposeView:_btnfilterOnClick()
	ViewMgr.instance:openView(ViewName.Season123_3_5DecomposeFilterView)
end

function Season123_3_5BatchDecomposeView:_btnfastaddOnClick()
...
function Season123_3_5BatchDecomposeView:_btnclearOnClick()
	Season123EquipBookController.instance:clearItemSelectState()
	self:resetDataUI()
end

function Season123_3_5BatchDecomposeView:_btndecomposeOnClick()
...
function Season123_3_5BatchDecomposeView:showDecomposeTip()
...
function Season123_3_5BatchDecomposeView:decomposeYesCallBack()
...
function Season123_3_5BatchDecomposeView:sendDecomposeRequest()
...
function Season123_3_5BatchDecomposeView:_dropFilterOnClick()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Common_Click)
end

function Season123_3_5BatchDecomposeView:_editableInitView()
...
function Season123_3_5BatchDecomposeView:onOpen()
...
function Season123_3_5BatchDecomposeView:initDropFilter()
	...
	for i = 1, Season123_3_5BatchDecomposeView.maxOverCount do
...
function Season123_3_5BatchDecomposeView:refreshUI()
	local coinConfig = CurrencyConfig.instance:getCurrencyCo(self.coinId)
...
function Season123_3_5BatchDecomposeView:initCoinItem()
...
function Season123_3_5BatchDecomposeView:onDecomposeItemClick()
	self._countAnim:Play("vx_count", 0, 0)
	AudioMgr.instance:trigger(AudioEnum.Season123.play_ui_checkpoint_light_up)
	self:refreshUI()
end

function Season123_3_5BatchDecomposeView:resetDataUI()
...
function Season123_3_5BatchDecomposeView:getDecomposeCoin()
...
function Season123_3_5BatchDecomposeView:dropFilterValueChanged(index)
	Season123DecomposeModel.instance:setCurOverPartSelectIndex(index)
end

function Season123_3_5BatchDecomposeView:onDropListShow()
	transformhelper.setLocalScale(self._arrowTrans, 1, -1, 1)
end

function Season123_3_5BatchDecomposeView:onDropListHide()
	transformhelper.setLocalScale(self._arrowTrans, 1, 1, 1)
end

function Season123_3_5BatchDecomposeView:onClose()
	Season123DecomposeModel.instance._itemStartAnimTime = nil
end

function Season123_3_5BatchDecomposeView:onDestroyView()
...
return Season123_3_5BatchDecomposeView
