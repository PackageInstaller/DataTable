-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5FightRuleView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5FightRuleView", package.seeall)

local Season123_3_5FightRuleView = class("Season123_3_5FightRuleView", BaseView)

function Season123_3_5FightRuleView:onInitView()
...
function Season123_3_5FightRuleView:addEvents()
	return
end

function Season123_3_5FightRuleView:removeEvents()
	return
end

function Season123_3_5FightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function Season123_3_5FightRuleView:onOpen()
	self:refreshRule()
end

function Season123_3_5FightRuleView:refreshRule()
	local dataList = Season123_3_5FightRuleView.getRuleList() or {}
...
function Season123_3_5FightRuleView:createItem(index)
	local item = {}
...
function Season123_3_5FightRuleView:updateItem(item, data)
...
function Season123_3_5FightRuleView:destroyItem(item)
	return
end

function Season123_3_5FightRuleView.getRuleList()
...
function Season123_3_5FightRuleView:setDecorateVisible(isVisible)
...
function Season123_3_5FightRuleView:onClose()
	return
end

function Season123_3_5FightRuleView:onDestroyView()
...
return Season123_3_5FightRuleView
