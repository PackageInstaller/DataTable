-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5EnemyTabList.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5EnemyTabList", package.seeall)

local Season123_3_5EnemyTabList = class("Season123_3_5EnemyTabList", BaseView)

function Season123_3_5EnemyTabList:onInitView()
...
function Season123_3_5EnemyTabList:_editableInitView()
	self._simagebattlelistbg:LoadImage(ResUrl.getWeekWalkBg("bg_zuodi.png"))

	self._tabItems = {}
end

function Season123_3_5EnemyTabList:onDestroyView()
...
function Season123_3_5EnemyTabList:onOpen()
	self.addEventCb(self, Season123Controller.instance, Season123Event.EnemyDetailSwitchTab, self.refreshSelect, self)
	self:refreshUI()
end

function Season123_3_5EnemyTabList:refreshUI()
	self:refreshItems()
	self:refreshSelect()
end

function Season123_3_5EnemyTabList:refreshItems()
...
function Season123_3_5EnemyTabList:getOrCreateTabItem(index)
...
function Season123_3_5EnemyTabList:onClickTab(index)
	Season123EnemyController.instance:switchTab(index)
end

function Season123_3_5EnemyTabList:refreshSelect()
	local battleIds = Season123EnemyModel.instance:getBattleIds()
...
return Season123_3_5EnemyTabList
