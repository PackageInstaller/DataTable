-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5DecomposeFilterView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5DecomposeFilterView", package.seeall)

local Season123_3_5DecomposeFilterView = class("Season123_3_5DecomposeFilterView", BaseView)

function Season123_3_5DecomposeFilterView:onInitView()
...
function Season123_3_5DecomposeFilterView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
	self._btnreset:AddClickListener(self._btnresetOnClick, self)
	self._btnconfirm:AddClickListener(self._btnconfirmOnClick, self)
end

function Season123_3_5DecomposeFilterView:removeEvents()
	self._btnclose:RemoveClickListener()
	self._btnreset:RemoveClickListener()
	self._btnconfirm:RemoveClickListener()
end

function Season123_3_5DecomposeFilterView:_btncloseOnClick()
	self:closeThis()
end

function Season123_3_5DecomposeFilterView:_btnresetOnClick()
...
function Season123_3_5DecomposeFilterView:_btnconfirmOnClick()
...
function Season123_3_5DecomposeFilterView:_editableInitView()
...
function Season123_3_5DecomposeFilterView:onOpen()
	self:createRareItem()
	self:createTagItem()
	self:refreshUI()
end

function Season123_3_5DecomposeFilterView:refreshUI()
	self:refreshRareSelectUI()
	self:refreshTagSelectUI()
end

function Season123_3_5DecomposeFilterView:refreshRareSelectUI()
...
function Season123_3_5DecomposeFilterView:refreshTagSelectUI()
...
function Season123_3_5DecomposeFilterView:createRareItem()
	for i = 5, 1, -1 do
...
function Season123_3_5DecomposeFilterView:rareItemOnClick(rare)
...
function Season123_3_5DecomposeFilterView:setRareSelectState(itemRare)
	self.rareSelectTab[itemRare] = not self.rareSelectTab[itemRare]
end

function Season123_3_5DecomposeFilterView:createTagItem()
...
function Season123_3_5DecomposeFilterView:tagItemSort(tagConfig)
	local tagConfigData = {}
...
function Season123_3_5DecomposeFilterView:tagItemShow(obj, data, index)
	local tagItem = {}
...
function Season123_3_5DecomposeFilterView:tagItemOnClick(data)
	local tagId = data.id
...
function Season123_3_5DecomposeFilterView:setTagSelectState(tagId)
	self.tagSelectTab[tagId] = not self.tagSelectTab[tagId]
end

function Season123_3_5DecomposeFilterView:onClose()
	return
end

function Season123_3_5DecomposeFilterView:onDestroyView()
...
return Season123_3_5DecomposeFilterView
