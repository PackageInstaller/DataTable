-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5EpisodeRewardView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5EpisodeRewardView", package.seeall)

local Season123_3_5EpisodeRewardView = class("Season123_3_5EpisodeRewardView", BaseView)

function Season123_3_5EpisodeRewardView:onInitView()
...
function Season123_3_5EpisodeRewardView:addEvents()
...
function Season123_3_5EpisodeRewardView:removeEvents()
...
function Season123_3_5EpisodeRewardView:_btnCloseOnClick()
	self:resetView()
end

function Season123_3_5EpisodeRewardView:_editableInitView()
...
function Season123_3_5EpisodeRewardView:onOpen()
	self.actId = self.viewParam.actId
	self.stage = self.viewParam.stage
	self.targetNumList = {}
end

function Season123_3_5EpisodeRewardView:refreshUI()
...
function Season123_3_5EpisodeRewardView:createAndRefreshRewardItem()
	gohelper.CreateObjList(self, self.rewardItemShow, self.itemList, self._gorewardContent, self._gorewardItem)
end

function Season123_3_5EpisodeRewardView:rewardItemShow(obj, data, index)
...
function Season123_3_5EpisodeRewardView:onItemGetClick()
...
function Season123_3_5EpisodeRewardView:refreshProgressBar()
...
function Season123_3_5EpisodeRewardView:initTargetNumList()
...
function Season123_3_5EpisodeRewardView:refreshScrollPos()
	local itemWidth = 240
	local itemSpaceH = 36
...
function Season123_3_5EpisodeRewardView:getCurCanGetIndex()
...
function Season123_3_5EpisodeRewardView:resetView()
	gohelper.setActive(self._goRwards, false)
end

function Season123_3_5EpisodeRewardView:onClose()
	return
end

function Season123_3_5EpisodeRewardView:onDestroyView()
...
return Season123_3_5EpisodeRewardView
