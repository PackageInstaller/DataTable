-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5FightSuccView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5FightSuccView", package.seeall)

local Season123_3_5FightSuccView = class("Season123_3_5FightSuccView", FightSuccView)

function Season123_3_5FightSuccView:onInitView()
...
function Season123_3_5FightSuccView:addEvents()
...
function Season123_3_5FightSuccView:removeEvents()
...
function Season123_3_5FightSuccView:_editableInitView()
	self._click = gohelper.getClick(self.viewGO)
end

function Season123_3_5FightSuccView:_onClickClose()
	if self._showEquipCard then
		return
	end

	Season123_3_5FightSuccView.super._onClickClose(self)
end

function Season123_3_5FightSuccView:onOpen()
	Season123_3_5FightSuccView.super.onOpen(self)
...
function Season123_3_5FightSuccView:_dealGetCard()
	local reward_list = {}
...
function Season123_3_5FightSuccView:_loadBonusItems()
	return
end

function Season123_3_5FightSuccView:_showGetCardView()
...
function Season123_3_5FightSuccView:_onTipsClose()
	self:_showRewardPart()
	self:_showPlayerLevelUpView()
end

function Season123_3_5FightSuccView:_showRewardPart()
	self._showEquipCard = nil

	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
	gohelper.setActive(self._bonusItemContainer, true)
	Season123_3_5FightSuccView.super._loadBonusItems(self)
end

function Season123_3_5FightSuccView:_onCloseViewFinish(viewName)
...
function Season123_3_5FightSuccView:_addItem(material)
	...
	if material.materilType == MaterialEnum.MaterialType.Season123EquipCard then
		...
		self._equipCards = self._equipCards or {}
...
function Season123_3_5FightSuccView:_setFbName(episodeCO)
	self._txtFbName.text = episodeCO.name
	self._txtFbNameEn.text = episodeCO.name_En
end

function Season123_3_5FightSuccView:_showGoal()
	gohelper.setActive(self._goallist, false)
end

function Season123_3_5FightSuccView:_checkTypeDetails()
	return
end

function Season123_3_5FightSuccView:_hideGoDemand()
	return
end

function Season123_3_5FightSuccView:onClose()
	...
	Season123_3_5FightSuccView.super.onClose(self)
end

function Season123_3_5FightSuccView:onDestroyView()
	Season123_3_5FightSuccView.super.onDestroyView(self)
end

return Season123_3_5FightSuccView
