-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5RecordWindowItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5RecordWindowItem", package.seeall)

local Season123_3_5RecordWindowItem = class("Season123_3_5RecordWindowItem", LuaCompBase)
local NotBestRecordMoveY = 6

function Season123_3_5RecordWindowItem:init(go)
	self.go = go
...
function Season123_3_5RecordWindowItem:addEventListeners()
	self._btndetails:AddClickListener(self._btndetailsOnClick, self)
end

function Season123_3_5RecordWindowItem:removeEventListeners()
	self._btndetails:RemoveClickListener()
end

function Season123_3_5RecordWindowItem:_btndetailsOnClick()
...
function Season123_3_5RecordWindowItem:onLoad(delayOpenAnimTime, isPlayOpen)
...
function Season123_3_5RecordWindowItem:_delayActive()
...
function Season123_3_5RecordWindowItem:onUpdateMO(mo)
	self.mo = mo
...
function Season123_3_5RecordWindowItem:playAnimation(animName)
...
function Season123_3_5RecordWindowItem:_onHeroItemLoad(obj, heroData, index)
...
function Season123_3_5RecordWindowItem:onDestroy()
	TaskDispatcher.cancelTask(self._delayActive, self)

	self._isPlayOpen = false
end

return Season123_3_5RecordWindowItem
