-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5EquipTagSelect.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5EquipTagSelect", package.seeall)

local Season123_3_5EquipTagSelect = class("Season123_3_5EquipTagSelect", BaseView)

function Season123_3_5EquipTagSelect:onInitView()
	if self._editableInitView then
		self:_editableInitView()
	end
end

function Season123_3_5EquipTagSelect:addEvents()
	return
end

function Season123_3_5EquipTagSelect:removeEvents()
	return
end

function Season123_3_5EquipTagSelect:init(ctrl, dropListPath, defaultColor)
	self._controller = ctrl
	self._dropListPath = dropListPath
	self._defaultColor = defaultColor or "#cac8c5"
end

function Season123_3_5EquipTagSelect:_editableInitView()
...
function Season123_3_5EquipTagSelect:onDestroyView()
...
function Season123_3_5EquipTagSelect:onOpen()
...
function Season123_3_5EquipTagSelect:onClose()
	return
end

function Season123_3_5EquipTagSelect:handleClickTag()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Common_Click)
end

function Season123_3_5EquipTagSelect:handleDropValueChanged(index)
...
function Season123_3_5EquipTagSelect:refreshSelected()
...
return Season123_3_5EquipTagSelect
