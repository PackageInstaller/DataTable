-- chunkname: @modules/logic/seasonver/act123/view3_5/component/Season123_3_5ResetViewAudio.lua

module("modules.logic.seasonver.act123.view3_5.component.Season123_3_5ResetViewAudio", package.seeall)

local Season123_3_5ResetViewAudio = class("Season123_3_5ResetViewAudio", LuaCompBase)

function Season123_3_5ResetViewAudio:ctor(param)
	self.scroll = param
	self._contentWidth = self.scroll.content and recthelper.getWidth(self.scroll.content) or recthelper.getWidth(self.scroll.transform)
...
function Season123_3_5ResetViewAudio:onDragBegin()
	self._isDraging = true
...
function Season123_3_5ResetViewAudio:onDragEnd()
	self:onUpdate()

	self._isDraging = false
end

function Season123_3_5ResetViewAudio:onClickDown()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_start)
end

function Season123_3_5ResetViewAudio:onUpdate()
	if self.scroll and not self._isDisposed then
		local curX = recthelper.getAnchorX(self.scroll.content) * self._pixelOffsetMoveFactor
...
function Season123_3_5ResetViewAudio:_onValueChangeSampleOffset(x)
...
function Season123_3_5ResetViewAudio:_onUpdateRTPCSpeed(x)
...
function Season123_3_5ResetViewAudio:_onValueChangeForStartOrStop(x)
...
function Season123_3_5ResetViewAudio:_onValueChangeCheckReplay(x)
...
function Season123_3_5ResetViewAudio:_resetPlayingStatus(x)
	self._isScrollPlaying = false
	self._scrollingPlayX = x
end

function Season123_3_5ResetViewAudio:dispose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_end)
...
function Season123_3_5ResetViewAudio:onDestroy()
	self.scroll = nil
end

return Season123_3_5ResetViewAudio
