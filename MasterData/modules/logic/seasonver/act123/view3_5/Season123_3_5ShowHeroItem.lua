-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5ShowHeroItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5ShowHeroItem", package.seeall)

local Season123_3_5ShowHeroItem = class("Season123_3_5ShowHeroItem", UserDataDispose)

function Season123_3_5ShowHeroItem:ctor()
	self:__onInit()
end

function Season123_3_5ShowHeroItem:dispose()
	self:removeEvents()
	self:__onDispose()
end

function Season123_3_5ShowHeroItem:init(viewGO)
	self.viewGO = gohelper.findChild(viewGO, "root")

	self:initComponent()
end

Season123_3_5ShowHeroItem.exSkillFillAmount = {
	0.2,
	0.4,
	0.6,
	0.79,
...
Season123_3_5ShowHeroItem.MaxRare = 5

function Season123_3_5ShowHeroItem:initComponent()
	...
	local maxRank = HeroConfig.instance:getMaxRank(Season123_3_5ShowHeroItem.MaxRare)
...
function Season123_3_5ShowHeroItem:initData(index)
	self._index = index
...
function Season123_3_5ShowHeroItem:removeEvents()
	self._btnclick:RemoveClickListener()
end

function Season123_3_5ShowHeroItem:onClose()
...
function Season123_3_5ShowHeroItem:refreshUI()
	...
	if mo then
		...
		if not skinConfig then
			logError("Season123_3_5ShowHeroItem.refreshUI error, skinCfg is nil, id:" .. tostring(mo.heroMO.skin))
...
function Season123_3_5ShowHeroItem:refreshRare(heroMO)
	for rare = 1, #self._rareList do
		gohelper.setActive(self._rareList[rare], rare <= heroMO.config.rare + 1)
	end
end

function Season123_3_5ShowHeroItem:refreshRank(heroMO)
...
function Season123_3_5ShowHeroItem:refreshExSkill(heroMO)
...
function Season123_3_5ShowHeroItem:refreshHp(mo)
...
function Season123_3_5ShowHeroItem:onClickSelf()
...
function Season123_3_5ShowHeroItem:OpenAnim()
...
function Season123_3_5ShowHeroItem:playOpenAnim()
...
return Season123_3_5ShowHeroItem
