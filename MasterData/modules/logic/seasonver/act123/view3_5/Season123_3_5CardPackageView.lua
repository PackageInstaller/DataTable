-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5CardPackageView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5CardPackageView", package.seeall)

local Season123_3_5CardPackageView = class("Season123_3_5CardPackageView", BaseView)

function Season123_3_5CardPackageView:onInitView()
...
function Season123_3_5CardPackageView:addEvents()
...
function Season123_3_5CardPackageView:removeEvents()
...
Season123_3_5CardPackageView.hideCardPackageTime = 0.33

function Season123_3_5CardPackageView:_btnopenPackageOnClick()
	self:openCardPackage()
end

function Season123_3_5CardPackageView:_btnopenOnePackageOnClick()
	self:openCardPackage()
end

function Season123_3_5CardPackageView:_btnopenAllPackageOnClick()
...
function Season123_3_5CardPackageView:_onDragBegin(param, pointerEventData)
	self._startPos = pointerEventData.position.x
end

function Season123_3_5CardPackageView:_onDragEnd(param, pointerEventData)
...
function Season123_3_5CardPackageView:_btnskipOnClick()
...
function Season123_3_5CardPackageView:_btnquitOnClick()
	self:closeThis()
end

function Season123_3_5CardPackageView:_btnopenNextOnClick()
	self:openCardPackage()
end

function Season123_3_5CardPackageView:_editableInitView()
...
function Season123_3_5CardPackageView:onOpen()
...
function Season123_3_5CardPackageView:refreshCardPackageUI()
...
function Season123_3_5CardPackageView:showWaitingOpenView()
...
function Season123_3_5CardPackageView:playOpenCardAnim()
	self:refreshCardPackageUI()
...
function Season123_3_5CardPackageView:showCardGetView()
	self:refreshCardGetUI()
	TaskDispatcher.runDelay(self.hideCardPackageView, self, Season123_3_5CardPackageView.hideCardPackageTime)
...
function Season123_3_5CardPackageView:hideCardPackageView()
	gohelper.setActive(self._gocardpackage, false)

	self.hasClickSkip = false
end

function Season123_3_5CardPackageView:refreshCardGetUI()
...
function Season123_3_5CardPackageView:refreshScrollPos()
...
function Season123_3_5CardPackageView:openCardPackage()
	if self.hasClickOpen then
		return
	end
...
function Season123_3_5CardPackageView:stopOpenCardPackageAudio()
...
function Season123_3_5CardPackageView:onClose()
	TaskDispatcher.cancelTask(self.hideCardPackageView, self)
	self:stopOpenCardPackageAudio()
end

function Season123_3_5CardPackageView:onDestroyView()
	Season123CardPackageModel.instance:release()
end

return Season123_3_5CardPackageView
