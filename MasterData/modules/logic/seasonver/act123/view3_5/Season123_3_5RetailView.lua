-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5RetailView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5RetailView", package.seeall)

local Season123_3_5RetailView = class("Season123_3_5RetailView", BaseView)

function Season123_3_5RetailView:onInitView()
...
function Season123_3_5RetailView:addEvents()
...
function Season123_3_5RetailView:onOpen()
...
function Season123_3_5RetailView:onClose()
	return
end

function Season123_3_5RetailView:refreshUI()
	self:refreshInfo()
...
function Season123_3_5RetailView:refreshInfo()
...
function Season123_3_5RetailView:initIconUI()
...
function Season123_3_5RetailView:refreshRecommendLv()
...
function Season123_3_5RetailView:refreshRewards()
...
function Season123_3_5RetailView:refreshCardPackageUI()
...
function Season123_3_5RetailView:getOrCreateRewardItem(index)
...
function Season123_3_5RetailView:refreshTicket()
...
function Season123_3_5RetailView:handleItemChanged()
	self:refreshCardPackageUI()
	self:refreshTicket()
end

function Season123_3_5RetailView:_btncelebrityOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

function Season123_3_5RetailView:_btncardsOnClick()
	Season123Controller.instance:openSeasonCardPackageView({
		actId = self.viewParam.actId
	})
end

function Season123_3_5RetailView:onClickIcon(index)
...
function Season123_3_5RetailView:_btnstartOnClick()
	Season123RetailController.instance:enterRetailFightScene()
end

return Season123_3_5RetailView
