-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5PickHeroEntryView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5PickHeroEntryView", package.seeall)

local Season123_3_5PickHeroEntryView = class("Season123_3_5PickHeroEntryView", BaseView)

function Season123_3_5PickHeroEntryView:onInitView()
...
function Season123_3_5PickHeroEntryView:addEvents()
...
function Season123_3_5PickHeroEntryView:removeEvents()
...
function Season123_3_5PickHeroEntryView:_editableInitView()
	self._heroItems = {}
	self._careerItems = {}
end

function Season123_3_5PickHeroEntryView:onDestroyView()
...
function Season123_3_5PickHeroEntryView:onOpen()
...
function Season123_3_5PickHeroEntryView:onClose()
	return
end

function Season123_3_5PickHeroEntryView:refreshUI()
	self:refreshItems()
	self:refreshButton()
...
function Season123_3_5PickHeroEntryView:refreshButton()
...
function Season123_3_5PickHeroEntryView:refreshItems()
...
function Season123_3_5PickHeroEntryView:getOrCreateItem(index)
	local item = self._heroItems[index]

	if not item then
		item = self:getUserDataTb_()
		item.go = gohelper.cloneInPlace(self._goitem, "item_" .. tostring(index))
		item.component = Season123_3_5PickHeroEntryItem.New()
...
function Season123_3_5PickHeroEntryView:refreshRecommendCareer()
...
function Season123_3_5PickHeroEntryView:getOrCreateCareer(index)
...
function Season123_3_5PickHeroEntryView:refreshRecommendTag()
...
function Season123_3_5PickHeroEntryView:tagItemShow(obj, data, index)
	local tagItemGO = obj
...
function Season123_3_5PickHeroEntryView:refreshRecommendUI()
	local careers = Season123Config.instance:getRecommendCareers(Season123PickHeroEntryModel.instance.activityId, Season123PickHeroEntryModel.instance.stage)
	local tagCoList = Season123Config.instance:getRecommendTagCoList(Season123PickHeroEntryModel.instance.activityId, Season123PickHeroEntryModel.instance.stage)
...
function Season123_3_5PickHeroEntryView:_btnstartOnClick()
	Season123PickHeroEntryController.instance:sendEnterStage()
end

function Season123_3_5PickHeroEntryView:_btncloseOnClick()
	self:closeThis()
end

function Season123_3_5PickHeroEntryView:_btndetailsOnClick()
...
function Season123_3_5PickHeroEntryView:handleEnterStageSuccess()
...
return Season123_3_5PickHeroEntryView
