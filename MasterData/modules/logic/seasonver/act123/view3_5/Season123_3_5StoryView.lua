-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5StoryView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5StoryView", package.seeall)

local Season123_3_5StoryView = class("Season123_3_5StoryView", BaseView)

function Season123_3_5StoryView:onInitView()
...
function Season123_3_5StoryView:addEvents()
...
function Season123_3_5StoryView:removeEvents()
...
function Season123_3_5StoryView:_btnLeftOnClick()
...
function Season123_3_5StoryView:_btnRightOnClick()
...
function Season123_3_5StoryView:_editableInitView()
...
function Season123_3_5StoryView:onOpen()
...
function Season123_3_5StoryView:refreshUI()
...
function Season123_3_5StoryView:initCoverPageUI()
...
function Season123_3_5StoryView:refreshDetailPageUI()
...
function Season123_3_5StoryView:createCoverItem()
	...
	for storyId, storyConfig in pairs(allStoryConfig) do
		...
		if not coverItem then
			...
			coverItem.item = MonoHelper.addNoUpdateLuaComOnceToGo(coverItem.go, Season123_3_5StoryCoverItem, {
				actId = self.actId,
				storyId = storyId,
...
function Season123_3_5StoryView:refreshUnlockState()
...
function Season123_3_5StoryView:setStrToBool(unlockStateStr)
...
function Season123_3_5StoryView:onCoverItemClick(param)
	self.curPageIndex = param.storyId

	self:showSwitchPageAnim("todetail")
end

function Season123_3_5StoryView:showSwitchPageAnim(animName)
...
function Season123_3_5StoryView:refreshPage()
	UIBlockMgr.instance:endBlock("playSwitchPageAnim")
	self:refreshUI()
end

Season123_3_5StoryView.scrollDescHeight = 650
Season123_3_5StoryView.maxDescSpacing = 41
Season123_3_5StoryView.minDescSpacing = 35
Season123_3_5StoryView.minDescFontSize = 27

function Season123_3_5StoryView:fitScrollHeight()
	...
	recthelper.setHeight(self.transScrollDesc, Season123_3_5StoryView.scrollDescHeight - heightOffset)
...
function Season123_3_5StoryView:setDescSpacing()
	local fontSize = self._txtdesc.fontSize

	self._txtdesc.lineSpacing = Mathf.Lerp(Season123_3_5StoryView.maxDescSpacing, Season123_3_5StoryView.minDescSpacing, self._txtdesc.fontSize - Season123_3_5StoryView.minDescFontSize)
	self._txtdesc.enableAutoSizing = false
	self._txtdesc.fontSize = fontSize
end

function Season123_3_5StoryView:onClose()
	self:saveUnlockState()
...
function Season123_3_5StoryView:onDestroyView()
	self._simageCover:UnLoadImage()
	self._simagePolaroid:UnLoadImage()
end

return Season123_3_5StoryView
