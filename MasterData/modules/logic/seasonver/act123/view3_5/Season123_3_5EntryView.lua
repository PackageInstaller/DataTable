-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5EntryView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5EntryView", package.seeall)

local Season123_3_5EntryView = class("Season123_3_5EntryView", BaseView)

function Season123_3_5EntryView:onInitView()
...
function Season123_3_5EntryView:addEvents()
...
function Season123_3_5EntryView:removeEvents()
...
function Season123_3_5EntryView:_editableInitView()
	self._entryList = {}
	self._centerItem = nil
end

function Season123_3_5EntryView:onDestroyView()
...
function Season123_3_5EntryView:onOpen()
	AudioMgr.instance:trigger(AudioEnum.Season123.play_fight_ui_uttu_enter)
...
function Season123_3_5EntryView:onClose()
...
function Season123_3_5EntryView:checkSceneIsLoaded()
	return
end

function Season123_3_5EntryView:refreshUI()
...
function Season123_3_5EntryView:refreshPageBtn()
...
function Season123_3_5EntryView:refreshCardPackageUI()
...
function Season123_3_5EntryView:refreshUTTURetailTicket()
...
function Season123_3_5EntryView:refreshStoreCoin()
...
function Season123_3_5EntryView:refreshRemainTime()
	local actMO = ActivityModel.instance:getActMO(self.viewParam.actId)
...
function Season123_3_5EntryView:handleGetActInfo(actId)
	if self.viewParam.actId == actId then
		self:refreshUI()
	end
end

function Season123_3_5EntryView:handleOtherViewAutoOpened()
	self._anim:Play(Season123_3_5EntryView.Anim.Close)
end

function Season123_3_5EntryView:handleItemChanged()
	self:refreshUTTURetailTicket()
	self:refreshStoreCoin()
end

function Season123_3_5EntryView:handleSceneLoaded()
	self:checkSceneLoaded()
end

function Season123_3_5EntryView:handleStageFinishWithoutStory(isFirstPass)
	if self._anim then
...
function Season123_3_5EntryView:checkSceneLoaded()
	if self._isCenterInited then
		return
	end

	local sceneRoot = CameraMgr.instance:getSceneRoot()
	local sceneGO = gohelper.findChild(sceneRoot, "Season123_3_5EntryScene/scene")

	if sceneGO then
		gohelper.setActive(self._goentranceitem, true)

		self._centerItem = Season123_3_5EntryItem.New()
...
function Season123_3_5EntryView:_btnprevOnClick()
	UIBlockMgrExtend.instance:setNeedCircleMv(false)
	UIBlockMgr.instance:startBlock("switchStage")
	self._animExcessive:Play(Season123_3_5EntryView.Anim.Hard)
...
function Season123_3_5EntryView:_btnnextOnClick()
	UIBlockMgrExtend.instance:setNeedCircleMv(false)
	UIBlockMgr.instance:startBlock("switchStage")
	self._animExcessive:Play(Season123_3_5EntryView.Anim.Story)
	AudioMgr.instance:trigger(AudioEnum.UI.season123_stage_switch)
...
function Season123_3_5EntryView:_btnStoreOnClick()
	Season123Controller.instance:openSeasonStoreView(self.viewParam.actId)
end

function Season123_3_5EntryView:_btnStoryOnClick()
	Season123Controller.instance:openSeasonStoryView({
		actId = self.viewParam.actId
	})
end

function Season123_3_5EntryView:_btnEquipBookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

function Season123_3_5EntryView:_btnOverviewOnClick()
	Season123Controller.instance:openSeasonOverview({
		actId = self.viewParam.actId
	})
end

function Season123_3_5EntryView:_btnAchievementOnClick()
	Season123Controller.instance:openSeasonTaskView({
		actId = self.viewParam.actId
	})
end

function Season123_3_5EntryView:_btnCardPackageOnClick()
	Season123Controller.instance:openSeasonCardPackageView({
		actId = self.viewParam.actId
	})
end

function Season123_3_5EntryView:_btnRetailOnClick()
...
function Season123_3_5EntryView:_enterRetailView()
	Season123Controller.instance:openSeasonRetail({
		actId = self.viewParam.actId
	})
end

function Season123_3_5EntryView:_btnTrialOnClick()
	Season123EntryController.instance:enterTrailFightScene()
end

function Season123_3_5EntryView:onCloseView(viewName)
	if viewName == ViewName.Season123_3_5EpisodeListView then
		self._anim:Play(Season123_3_5EntryView.Anim.Switch1, 0, 0)
	end
...
function Season123_3_5EntryView:checkHasReadUnlockStory()
	Season123Controller.instance:checkHasReadUnlockStory(self.viewParam.actId)
end

function Season123_3_5EntryView:_autoClickNext()
