-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5HeroGroupListView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5HeroGroupListView", package.seeall)

local Season123_3_5HeroGroupListView = class("Season123_3_5HeroGroupListView", BaseView)

function Season123_3_5HeroGroupListView:onInitView()
...
function Season123_3_5HeroGroupListView:_editableInitView()
	self._heroItemList = {}
	...
	for i = 1, 4 do
		...
		local item = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGO, Season123_3_5HeroGroupHeroItem, self)
...
function Season123_3_5HeroGroupListView:addEvents()
	...
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successHeroTalentUp, self._updateHeroList, self)
	...
	self.addEventCb(self, CharacterController.instance, CharacterEvent.successDressUpSkin, self._updateHeroList, self)
	self.addEventCb(self, HeroGroupController.instance, HeroGroupEvent.SelectHeroGroup, self._updateHeroList, self)
	self.addEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._updateHeroList, self)
	self.addEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnSnapshotSaveSucc, self._updateHeroList, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.HeroGroupIndexChanged, self._onSnapshotSaveSucc, self)
	self.addEventCb(self, GameGlobalMgr.instance, GameStateEvent.OnScreenResize, self._onScreenSizeChange, self)
end

function Season123_3_5HeroGroupListView:removeEvents()
	...
	self.removeEventCb(self, CharacterController.instance, CharacterEvent.successHeroTalentUp, self._updateHeroList, self)
	...
	self.removeEventCb(self, CharacterController.instance, CharacterEvent.successDressUpSkin, self._updateHeroList, self)
	self.removeEventCb(self, HeroGroupController.instance, HeroGroupEvent.SelectHeroGroup, self._updateHeroList, self)
	self.removeEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._updateHeroList, self)
	self.removeEventCb(self, HeroGroupController.instance, HeroGroupEvent.OnSnapshotSaveSucc, self._updateHeroList, self)
	self.removeEventCb(self, Season123Controller.instance, Season123Event.HeroGroupIndexChanged, self._onSnapshotSaveSucc, self)
	self.removeEventCb(self, GameGlobalMgr.instance, GameStateEvent.OnScreenResize, self._onScreenSizeChange, self)
end

function Season123_3_5HeroGroupListView:onOpen()
	self._isOpen = true
...
function Season123_3_5HeroGroupListView:_playOpenAnimation()
...
function Season123_3_5HeroGroupListView:_checkRestrictSeasonEquip()
	...
	local model = Season123HeroGroupModel.instance
	local actId = model.activityId
	local stage = model.stage
	local layer = model.layer

	Season123EquipController.instance:checkHeroGroupCardExistInEpisode(curGroupMO, actId, stage, layer)
end

function Season123_3_5HeroGroupListView:_checkRestrictHero()
...
function Season123_3_5HeroGroupListView:_removeRestrictHero()
...
function Season123_3_5HeroGroupListView:_onHeroGroupExit()
...
function Season123_3_5HeroGroupListView:_closeTweenFinish(index)
...
function Season123_3_5HeroGroupListView:canDrag(param, isWrap)
...
function Season123_3_5HeroGroupListView:_onBeginDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_3_5HeroGroupListView:_onDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_3_5HeroGroupListView:_onEndDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
	...
	if dragToIndex <= 0 then
		self._setHeroItemPos(self, heroItem, index, true, completeDragFunc, self)
	...
	if not canMoveTar or not canMoveSrc then
		...
		if not canMoveTar then
			GameFacade.showToast(Season123_3_5EquipItem.Toast_Pos_Wrong, posStrTar)
		end

		if not canMoveSrc then
			GameFacade.showToast(Season123_3_5EquipItem.Toast_Pos_Wrong, posStrSrc)
		end
...
function Season123_3_5HeroGroupListView:_setHeroItemPos(heroItem, index, tween, callback, callbackObj)
	local posTr = self.heroPosTrList[index]
...
function Season123_3_5HeroGroupListView:_tweenToPos(heroItem, anchorPos)
...
function Season123_3_5HeroGroupListView:_setDragEnabled(isEnabled)
	for i, drag in ipairs(self._heroItemDrag) do
		drag.enabled = isEnabled
	end
end

function Season123_3_5HeroGroupListView:_updateHeroList()
	for i, heroItem in ipairs(self._heroItemList) do
...
function Season123_3_5HeroGroupListView:onDestroyView()
...
function Season123_3_5HeroGroupListView:_onScreenSizeChange()
	for i = 1, ModuleEnum.MaxHeroCountInGroup do
		local heroItem = self._heroItemList[i]
...
function Season123_3_5HeroGroupListView:getHeroItemList()
	return self._heroItemList
end

return Season123_3_5HeroGroupListView
