-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5PickAssistView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5PickAssistView", package.seeall)

local Season123_3_5PickAssistView = class("Season123_3_5PickAssistView", BaseView)

function Season123_3_5PickAssistView:onInitView()
...
function Season123_3_5PickAssistView:addEvents()
...
function Season123_3_5PickAssistView:removeEvents()
...
function Season123_3_5PickAssistView:onBeforeRefreshAssistList()
...
function Season123_3_5PickAssistView:_btnrefreshOnClick()
	Season123PickAssistController.instance:manualRefreshList()
end

function Season123_3_5PickAssistView:_onHeroDetailClick()
...
function Season123_3_5PickAssistView:_btnconfirmOnClick()
	Season123PickAssistController.instance:pickOver()
	self:closeThis()
end

function Season123_3_5PickAssistView:_btnCareerFilterOnClick(career)
...
function Season123_3_5PickAssistView:_editableInitView()
	self:_setFilterBtn()
end

function Season123_3_5PickAssistView:_setFilterBtn()
...
function Season123_3_5PickAssistView:_onInitFilterBtn(obj, careerValue, index)
...
function Season123_3_5PickAssistView:onOpen()
...
function Season123_3_5PickAssistView:showRecommendCareer()
...
function Season123_3_5PickAssistView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_3_5PickAssistView:refreshUI()
	self:refreshCD()
	self:refreshCareerFilterItems()
	self:refreshIsEmpty()
...
function Season123_3_5PickAssistView:refreshCD()
	self._simageprogress.fillAmount = Season123PickAssistController.instance:getRefreshCDRate()
end

function Season123_3_5PickAssistView:refreshCareerFilterItems()
...
function Season123_3_5PickAssistView:refreshIsEmpty()
...
function Season123_3_5PickAssistView:refreshBtnDetail()
	local selectedMO = Season123PickAssistListModel.instance:getSelectedMO()

	gohelper.setActive(self._godetail, selectedMO)
end

function Season123_3_5PickAssistView:onClose()
	TaskDispatcher.cancelTask(self.refreshCD, self)
end

function Season123_3_5PickAssistView:onDestroyView()
	self:disposeCareerItems()
	Season123PickAssistController.instance:onCloseView()
end

function Season123_3_5PickAssistView:disposeCareerItems()
...
return Season123_3_5PickAssistView
