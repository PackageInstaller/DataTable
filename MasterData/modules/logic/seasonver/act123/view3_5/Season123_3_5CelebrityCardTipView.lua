-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5CelebrityCardTipView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5CelebrityCardTipView", package.seeall)

local Season123_3_5CelebrityCardTipView = class("Season123_3_5CelebrityCardTipView", BaseView)

function Season123_3_5CelebrityCardTipView:onInitView()
...
function Season123_3_5CelebrityCardTipView:addEvents()
...
function Season123_3_5CelebrityCardTipView:removeEvents()
...
function Season123_3_5CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season123_3_5CelebrityCardTipView:onClickGMAdd(count)
...
function Season123_3_5CelebrityCardTipView:_btninputOnClick()
...
function Season123_3_5CelebrityCardTipView:_editableInitView()
...
function Season123_3_5CelebrityCardTipView:onDestroyView()
...
function Season123_3_5CelebrityCardTipView:onOpen()
...
function Season123_3_5CelebrityCardTipView:onClose()
	return
end

function Season123_3_5CelebrityCardTipView:refreshUI()
...
function Season123_3_5CelebrityCardTipView:refreshQuantity()
...
function Season123_3_5CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season123_3_5CelebrityCardTipView:refreshSkills()
...
function Season123_3_5CelebrityCardTipView:getOrCreatePropText(index)
...
function Season123_3_5CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season123_3_5CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season123_3_5CelebrityCardTipView
