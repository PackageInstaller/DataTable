-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5HeroGroupReplaySelectView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5HeroGroupReplaySelectView", package.seeall)

local Season123_3_5HeroGroupReplaySelectView = class("Season123_3_5HeroGroupReplaySelectView", BaseView)

function Season123_3_5HeroGroupReplaySelectView:onInitView()
...
function Season123_3_5HeroGroupReplaySelectView:addEvents()
...
function Season123_3_5HeroGroupReplaySelectView:removeEvents()
	self._btnmultispeed:RemoveClickListener()
	self._btnclosemult:RemoveClickListener()
end

function Season123_3_5HeroGroupReplaySelectView:_editableInitView()
...
function Season123_3_5HeroGroupReplaySelectView:onDestroyView()
	return
end

function Season123_3_5HeroGroupReplaySelectView:onOpen()
	self:initCostIcon()
	self:initMultiGroup()
	self:refreshSelection()
end

function Season123_3_5HeroGroupReplaySelectView:onClose()
	return
end

Season123_3_5HeroGroupReplaySelectView.ItemHeight = 92

function Season123_3_5HeroGroupReplaySelectView:initMultiGroup()
	...
	recthelper.setHeight(self.rectdropbg, Season123_3_5HeroGroupReplaySelectView.ItemHeight * maxTimes)
end

function Season123_3_5HeroGroupReplaySelectView:initMultSpeedItem(go, multispeed, maxTimes)
	if not self._multSpeedItems[multispeed] then
		...
		self.addClickCb(self, gohelper.getClick(go), self.onClickSetSpeed, self, multispeed)
...
function Season123_3_5HeroGroupReplaySelectView:initCostIcon()
...
function Season123_3_5HeroGroupReplaySelectView:refreshMulti()
...
function Season123_3_5HeroGroupReplaySelectView:onClickSetSpeed(speed)
...
function Season123_3_5HeroGroupReplaySelectView:setMultSpeed(speed)
...
function Season123_3_5HeroGroupReplaySelectView:refreshSelection()
	...
	for i = 1, self.maxMultiplicationTimes do
		...
		if item then
			if speed == i then
				item.txtnum.color = selectColor or unSelectColor
			end
...
function Season123_3_5HeroGroupReplaySelectView:_btnmultispeedOnClick()
	self._isMultiOpen = not self._isMultiOpen

	self:refreshMulti()
end

function Season123_3_5HeroGroupReplaySelectView:_btnclosemultOnClick()
	self._isMultiOpen = false

	self:refreshMulti()
end

return Season123_3_5HeroGroupReplaySelectView
