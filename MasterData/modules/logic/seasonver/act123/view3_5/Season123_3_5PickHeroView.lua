-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5PickHeroView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5PickHeroView", package.seeall)

local Season123_3_5PickHeroView = class("Season123_3_5PickHeroView", BaseView)

function Season123_3_5PickHeroView:onInitView()
...
function Season123_3_5PickHeroView:addEvents()
	self._btnconfirm:AddClickListener(self._btnconfirmOnClick, self)
	self._btncancel:AddClickListener(self._btncancelOnClick, self)
end

function Season123_3_5PickHeroView:removeEvents()
	self._btnconfirm:RemoveClickListener()
	self._btncancel:RemoveClickListener()
end

function Season123_3_5PickHeroView:_btnconfirmOnClick()
	Season123PickHeroController.instance:pickOver()
	self:closeThis()
end

function Season123_3_5PickHeroView:_btncancelOnClick()
	self:closeThis()
end

function Season123_3_5PickHeroView:_editableInitView()
...
function Season123_3_5PickHeroView:onClose()
	return
end

function Season123_3_5PickHeroView:refreshUI()
...
return Season123_3_5PickHeroView
