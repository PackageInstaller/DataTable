-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5HeroGroupEditView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5HeroGroupEditView", package.seeall)

local Season123_3_5HeroGroupEditView = class("Season123_3_5HeroGroupEditView", BaseView)

function Season123_3_5HeroGroupEditView:onInitView()
...
function Season123_3_5HeroGroupEditView:addEvents()
...
function Season123_3_5HeroGroupEditView:removeEvents()
...
function Season123_3_5HeroGroupEditView:_btnclassifyOnClick()
	local param = {
...
function Season123_3_5HeroGroupEditView:_btnpassiveskillOnClick()
...
function Season123_3_5HeroGroupEditView:_btnconfirmOnClick()
	...
	if self._heroMO then
		...
		if self._heroMO:isTrial() and not HeroSingleGroupModel.instance:isInGroup(self._heroMO.uid) and (singleGroupMO:isEmpty() or not singleGroupMO.trial) and Season123HeroGroupEditModel.instance:isTrialLimit() then
...
function Season123_3_5HeroGroupEditView:_btncancelOnClick()
	self:closeThis()
end

function Season123_3_5HeroGroupEditView:_btncharacterOnClick()
	if self._heroMO then
		local heroMoList = {}

		heroMoList = self._isShowQuickEdit and Season123HeroGroupQuickEditModel.instance:getList() or Season123HeroGroupEditModel.instance:getList()
...
function Season123_3_5HeroGroupEditView:_btnattributeOnClick()
	if self._heroMO then
...
function Season123_3_5HeroGroupEditView:_btnexskillrankOnClick()
...
function Season123_3_5HeroGroupEditView:_btnlvrankOnClick()
	local x, y = transformhelper.getLocalPos(self._goScrollContent.transform)
...
function Season123_3_5HeroGroupEditView:_btnrarerankOnClick()
	local x, y = transformhelper.getLocalPos(self._goScrollContent.transform)
...
function Season123_3_5HeroGroupEditView:_btnquickeditOnClick()
...
function Season123_3_5HeroGroupEditView:_onHeroItemClick(heroMO)
	self._heroMO = heroMO

	self:_refreshCharacterInfo()
end

function Season123_3_5HeroGroupEditView:_refreshCharacterInfo()
	if self._heroMO then
...
function Season123_3_5HeroGroupEditView:_refreshMainInfo()
	if self._heroMO then
...
function Season123_3_5HeroGroupEditView:_refreshAttribute()
	if self._heroMO then
...
function Season123_3_5HeroGroupEditView:_refreshPassiveSkill()
	if not self._heroMO then
		return
	end
...
function Season123_3_5HeroGroupEditView:_refreshSkill()
	self._skillContainer:onUpdateMO(self._heroMO and self._heroMO.heroId, false, self._heroMO)
end

function Season123_3_5HeroGroupEditView:_refreshBtnIcon()
...
function Season123_3_5HeroGroupEditView:_onFilterList(param)
...
function Season123_3_5HeroGroupEditView:_updateHeroList()
	self:_refreshBtnIcon()
...
function Season123_3_5HeroGroupEditView:replaceSelectHeroDefaultEquip()
...
function Season123_3_5HeroGroupEditView:_saveCurGroupInfo()
...
function Season123_3_5HeroGroupEditView:_saveQuickGroupInfo()
	if Season123HeroGroupQuickEditModel.instance:getIsDirty() then
		...
		if HeroSingleGroupModel.instance:isTemp() then
			HeroSingleGroupModel.instance:setHeroList(newHeroUids)
			HeroGroupModel.instance:replaceSingleGroup()
...
function Season123_3_5HeroGroupEditView:_onAttributeChanged(level, heroId)
	CharacterModel.instance:setFakeLevel(heroId, level)
end

function Season123_3_5HeroGroupEditView:_normalEditHasChange()
	return true
end

function Season123_3_5HeroGroupEditView:_refreshEditMode()
...
function Season123_3_5HeroGroupEditView:_refreshCurScrollBySort()
	if self._isShowQuickEdit then
		if Season123HeroGroupQuickEditModel.instance:getIsDirty() then
			self:_saveQuickGroupInfo()
		end
...
function Season123_3_5HeroGroupEditView:_onGroupModify()
	if self._isShowQuickEdit then
		Season123HeroGroupQuickEditModel.instance:copyQuickEditCardList()
	else
...
function Season123_3_5HeroGroupEditView:_editableInitView()
...
function Season123_3_5HeroGroupEditView:onOpen()
	...
	self.addEventCb(self, CharacterController.instance, CharacterEvent.FilterBackpack, self._onFilterList, self)
...
function Season123_3_5HeroGroupEditView:onClose()
	...
	self.removeEventCb(self, CharacterController.instance, CharacterEvent.FilterBackpack, self._onFilterList, self)
...
function Season123_3_5HeroGroupEditView:_onOpenView(viewName)
...
function Season123_3_5HeroGroupEditView:_onCloseView(viewName)
...
function Season123_3_5HeroGroupEditView:_delyStopBgm()
	self._isStopBgm = false

	AudioMgr.instance:trigger(AudioEnum.Bgm.Pause_FightingMusic)
end

function Season123_3_5HeroGroupEditView:_showCharacterRankUpView(func)
	func()
end

function Season123_3_5HeroGroupEditView:onDestroyView()
...
function Season123_3_5HeroGroupEditView:_showRecommendCareer()
...
function Season123_3_5HeroGroupEditView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

return Season123_3_5HeroGroupEditView
