-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9HeroGroupListView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9HeroGroupListView", package.seeall)

local Season123_1_9HeroGroupListView = class("Season123_1_9HeroGroupListView", BaseView)

function Season123_1_9HeroGroupListView:onInitView()
...
function Season123_1_9HeroGroupListView:_editableInitView()
	self._heroItemList = {}
	...
	for i = 1, 4 do
		...
		local item = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGO, Season123_1_9HeroGroupHeroItem, self)
...
function Season123_1_9HeroGroupListView:addEvents()
...
function Season123_1_9HeroGroupListView:removeEvents()
...
function Season123_1_9HeroGroupListView:onOpen()
	self._isOpen = true
...
function Season123_1_9HeroGroupListView:_playOpenAnimation()
...
function Season123_1_9HeroGroupListView:_checkRestrictHero()
...
function Season123_1_9HeroGroupListView:_removeRestrictHero()
...
function Season123_1_9HeroGroupListView:_onHeroGroupExit()
...
function Season123_1_9HeroGroupListView:_closeTweenFinish(index)
...
function Season123_1_9HeroGroupListView:canDrag(param, isWrap)
...
function Season123_1_9HeroGroupListView:_onBeginDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_1_9HeroGroupListView:_onDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_1_9HeroGroupListView:_onEndDrag(param, pointerEventData)
	if HeroGroupModel.instance:getCurGroupMO().isReplay then
		return
	end
...
function Season123_1_9HeroGroupListView:_setHeroItemPos(heroItem, index, tween, callback, callbackObj)
	local posTr = self.heroPosTrList[index]
...
function Season123_1_9HeroGroupListView:_tweenToPos(heroItem, anchorPos)
...
function Season123_1_9HeroGroupListView:_setDragEnabled(isEnabled)
	for i, drag in ipairs(self._heroItemDrag) do
		drag.enabled = isEnabled
	end
end

function Season123_1_9HeroGroupListView:_updateHeroList()
	for i, heroItem in ipairs(self._heroItemList) do
		local mo
...
function Season123_1_9HeroGroupListView:_onSnapshotSaveSucc()
	self:_updateHeroList()
...
function Season123_1_9HeroGroupListView:_calcIndex(position)
	for i = 1, 4 do
...
function Season123_1_9HeroGroupListView:onDestroyView()
...
function Season123_1_9HeroGroupListView:_onScreenSizeChange()
	for i = 1, ModuleEnum.MaxHeroCountInGroup do
		local heroItem = self._heroItemList[i]
...
function Season123_1_9HeroGroupListView:getHeroItemList()
	return self._heroItemList
end

return Season123_1_9HeroGroupListView
