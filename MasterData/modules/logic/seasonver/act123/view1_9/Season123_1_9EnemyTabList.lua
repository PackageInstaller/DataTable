-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EnemyTabList.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EnemyTabList", package.seeall)

local Season123_1_9EnemyTabList = class("Season123_1_9EnemyTabList", BaseView)

function Season123_1_9EnemyTabList:onInitView()
...
function Season123_1_9EnemyTabList:_editableInitView()
	self._simagebattlelistbg:LoadImage(ResUrl.getWeekWalkBg("bg_zuodi.png"))

	self._tabItems = {}
end

function Season123_1_9EnemyTabList:onDestroyView()
...
function Season123_1_9EnemyTabList:onOpen()
	self.addEventCb(self, Season123Controller.instance, Season123Event.EnemyDetailSwitchTab, self.refreshSelect, self)
	self:refreshUI()
end

function Season123_1_9EnemyTabList:refreshUI()
	self:refreshItems()
	self:refreshSelect()
end

function Season123_1_9EnemyTabList:refreshItems()
...
function Season123_1_9EnemyTabList:getOrCreateTabItem(index)
	...
	if not item then
		...
		for index = 1, item.starCount do
			...
			item["imageStar" .. index] = child:GetComponentInChildren(gohelper.Type_Image)
		end
...
function Season123_1_9EnemyTabList:onClickTab(index)
	Season123EnemyController.instance:switchTab(index)
end

function Season123_1_9EnemyTabList:refreshSelect()
	local battleIds = Season123EnemyModel.instance:getBattleIds()
...
return Season123_1_9EnemyTabList
