-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9TaskMapItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9TaskMapItem", package.seeall)

local Season123_1_9TaskMapItem = class("Season123_1_9TaskMapItem", LuaCompBase)

function Season123_1_9TaskMapItem:ctor(param)
	self.param = param
end

function Season123_1_9TaskMapItem:init(go)
	self:__onInit()
...
function Season123_1_9TaskMapItem:refreshUI()
...
function Season123_1_9TaskMapItem:setScale()
	if Season123TaskModel.instance.curStage == self.stage then
...
function Season123_1_9TaskMapItem:onDestroy()
	self:__onDispose()
...
return Season123_1_9TaskMapItem
