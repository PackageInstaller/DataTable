-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EpisodeListView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EpisodeListView", package.seeall)

local Season123_1_9EpisodeListView = class("Season123_1_9EpisodeListView", BaseView)

function Season123_1_9EpisodeListView:onInitView()
...
function Season123_1_9EpisodeListView:addEvents()
...
function Season123_1_9EpisodeListView:removeEvents()
...
function Season123_1_9EpisodeListView:_editableInitView()
	self._stageItems = {}
...
function Season123_1_9EpisodeListView:onDestroyView()
	...
	UIBlockMgr.instance:endBlock(Season123_1_9EpisodeListView.SCROLL_ANIM_BLOCK_KEY)
...
function Season123_1_9EpisodeListView:onOpen()
...
function Season123_1_9EpisodeListView:onClose()
	return
end

function Season123_1_9EpisodeListView:refreshUI()
...
function Season123_1_9EpisodeListView:refreshStageList()
	local layerDatas = Season123EpisodeListModel.instance:getList()
	local processSet = {}
...
function Season123_1_9EpisodeListView:getOrCreateLayerItem(index)
...
function Season123_1_9EpisodeListView:refreshSingleItem(index, item, data)
...
function Season123_1_9EpisodeListView:refreshSingleItemLock(index, item, data)
...
function Season123_1_9EpisodeListView:refreshSingleItemFinished(index, item, data)
	local isUnlock = Season123EpisodeListModel.instance:isEpisodeUnlock(data.cfg.layer)
...
function Season123_1_9EpisodeListView:refreshCenter()
	if self._centerItem then
		self._centerItem:refreshUI()
	end
end

function Season123_1_9EpisodeListView:initCenter()
	self._centerItem = Season123_1_9EpisodeListCenter.New()

	self._centerItem:init(self._goentranceitem)
	self._centerItem:initData(self.viewParam.actId, self.viewParam.stage)
end

Season123_1_9EpisodeListView.OutOfBoundOffset = 280
Season123_1_9EpisodeListView.DelayEnterEpisodeTime = 0.2
Season123_1_9EpisodeListView.SCROLL_ANIM_BLOCK_KEY = "Season123_1_9EpisodeListView_scrollanim"

function Season123_1_9EpisodeListView:playScrollAnim(index)
	UIBlockMgr.instance:startBlock(Season123_1_9EpisodeListView.SCROLL_ANIM_BLOCK_KEY)
	...
	if deltaY > Season123_1_9EpisodeListView.OutOfBoundOffset then
		self._tweenIdScroll = ZProj.TweenHelper.DOAnchorPosY(self._rectScroll, targetY + Season123_1_9EpisodeListView.OutOfBoundOffset, Season123_1_9EpisodeListView.DelayEnterEpisodeTime, self.handlePlayScrollAnimCompleted, self)
	elseif deltaY < -Season123_1_9EpisodeListView.OutOfBoundOffset then
		self._tweenIdScroll = ZProj.TweenHelper.DOAnchorPosY(self._rectScroll, targetY - Season123_1_9EpisodeListView.OutOfBoundOffset, Season123_1_9EpisodeListView.DelayEnterEpisodeTime, self.handlePlayScrollAnimCompleted, self)
	else
		self._viewAnimator:Play(UIAnimationName.Close, 0, 0)
		TaskDispatcher.runDelay(self.handlePlayScrollAnimCompleted, self, Season123_1_9EpisodeListView.DelayEnterEpisodeTime)
	end
end

function Season123_1_9EpisodeListView:handlePlayScrollAnimCompleted()
...
function Season123_1_9EpisodeListView:getScrollToIndexY(index)
...
function Season123_1_9EpisodeListView:onItemClick(index)
...
function Season123_1_9EpisodeListView:_btnheroesOnClick()
	local actId = self.viewParam.actId
...
function Season123_1_9EpisodeListView:_btnresetOnClick()
...
function Season123_1_9EpisodeListView:_btndetailsOnClick()
...
function Season123_1_9EpisodeListView:_btntiprewardOnClick()
...
function Season123_1_9EpisodeListView:_btnadditionruleDetailOnClick()
...
function Season123_1_9EpisodeListView:_btnMaskOnClick()
	self.viewContainer:_overrideCloseFunc()
end

function Season123_1_9EpisodeListView:OnDotChange()
...
function Season123_1_9EpisodeListView:onCloseView(viewName)
	if viewName == ViewName.Season123_1_9EpisodeDetailView then
		self:refreshStageList()
		self._viewAnimator:Play(UIAnimationName.Open, 0, 0)
	end
end

function Season123_1_9EpisodeListView:delayAddScrollAudio()
	self._audioScroll = MonoHelper.addLuaComOnceToGo(self._goscrollstory, Season123_1_9EpisodeListScrollAudio, self._scrollStory)
...
function Season123_1_9EpisodeListView:_onDragBegin()
	self._audioScroll:onDragBegin()
end

function Season123_1_9EpisodeListView:_onDragEnd()
	self._audioScroll:onDragEnd()
end

function Season123_1_9EpisodeListView:_onClickDown()
	self._audioScroll:onClickDown()
end

return Season123_1_9EpisodeListView
