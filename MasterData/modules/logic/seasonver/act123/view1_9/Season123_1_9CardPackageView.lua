-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9CardPackageView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9CardPackageView", package.seeall)

local Season123_1_9CardPackageView = class("Season123_1_9CardPackageView", BaseView)

function Season123_1_9CardPackageView:onInitView()
...
function Season123_1_9CardPackageView:addEvents()
	...
	self.addEventCb(self, Season123Controller.instance, Season123Event.OnCardPackageOpen, self.showWaitingOpenView, self)
end

function Season123_1_9CardPackageView:removeEvents()
	...
	self.removeEventCb(self, Season123Controller.instance, Season123Event.OnCardPackageOpen, self.showWaitingOpenView, self)
end

Season123_1_9CardPackageView.hideCardPackageTime = 0.33

function Season123_1_9CardPackageView:_btnopenPackageOnClick()
	self:openCardPackage()
end

function Season123_1_9CardPackageView:_btnopenOnePackageOnClick()
	self:openCardPackage()
end

function Season123_1_9CardPackageView:_btnopenAllPackageOnClick()
...
function Season123_1_9CardPackageView:_onDragBegin(param, pointerEventData)
	self._startPos = pointerEventData.position.x
end

function Season123_1_9CardPackageView:_onDragEnd(param, pointerEventData)
...
function Season123_1_9CardPackageView:_btnskipOnClick()
...
function Season123_1_9CardPackageView:_btnquitOnClick()
	self:closeThis()
end

function Season123_1_9CardPackageView:_btnopenNextOnClick()
	self:openCardPackage()
end

function Season123_1_9CardPackageView:_editableInitView()
...
function Season123_1_9CardPackageView:onOpen()
...
function Season123_1_9CardPackageView:refreshCardPackageUI()
...
function Season123_1_9CardPackageView:showWaitingOpenView()
...
function Season123_1_9CardPackageView:playOpenCardAnim()
	self:refreshCardPackageUI()
...
function Season123_1_9CardPackageView:showCardGetView()
	self:refreshCardGetUI()
	TaskDispatcher.runDelay(self.hideCardPackageView, self, Season123_1_9CardPackageView.hideCardPackageTime)
...
function Season123_1_9CardPackageView:hideCardPackageView()
	gohelper.setActive(self._gocardpackage, false)

	self.hasClickSkip = false
end

function Season123_1_9CardPackageView:refreshCardGetUI()
...
function Season123_1_9CardPackageView:refreshScrollPos()
...
function Season123_1_9CardPackageView:openCardPackage()
	if self.hasClickOpen then
		return
	end
...
function Season123_1_9CardPackageView:stopOpenCardPackageAudio()
...
function Season123_1_9CardPackageView:onClose()
	TaskDispatcher.cancelTask(self.hideCardPackageView, self)
	self:stopOpenCardPackageAudio()
end

function Season123_1_9CardPackageView:onDestroyView()
	Season123CardPackageModel.instance:release()
end

return Season123_1_9CardPackageView
