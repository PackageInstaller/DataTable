-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EnemyRule.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EnemyRule", package.seeall)

local Season123_1_9EnemyRule = class("Season123_1_9EnemyRule", BaseView)

function Season123_1_9EnemyRule:onInitView()
...
function Season123_1_9EnemyRule:addEvents()
...
function Season123_1_9EnemyRule:removeEvents()
	self._btnadditionRuleclick:RemoveClickListener()
	self._btncloserule:RemoveClickListener()
end

function Season123_1_9EnemyRule:_btncloseruleOnClick()
...
function Season123_1_9EnemyRule:_btnadditionRuleOnClick()
	self._ruleItemClick = self._goruledesc.activeSelf

	gohelper.setActive(self._goruledesc, true)
end

function Season123_1_9EnemyRule:_editableInitView()
...
function Season123_1_9EnemyRule:_addRuleItem(ruleCo, targetId)
...
function Season123_1_9EnemyRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season123_1_9EnemyRule:_clear()
...
function Season123_1_9EnemyRule:onDestroyView()
	self:_clear()
end

return Season123_1_9EnemyRule
