-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9TaskItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9TaskItem", package.seeall)

local Season123_1_9TaskItem = class("Season123_1_9TaskItem", ListScrollCell)

Season123_1_9TaskItem.BlockKey = "Season123_1_9TaskItemAni"

function Season123_1_9TaskItem:init(go)
	self._viewGO = go
...
function Season123_1_9TaskItem:addEventListeners()
...
function Season123_1_9TaskItem:initTotal()
	self._btnGetTotal = gohelper.findChildButtonWithAudio(self._goTotal, "#btn_getall")
end

Season123_1_9TaskItem.TaskMaskTime = 0.65
Season123_1_9TaskItem.ColumnCount = 1
Season123_1_9TaskItem.AnimRowCount = 7
Season123_1_9TaskItem.OpenAnimTime = 0.06
Season123_1_9TaskItem.OpenAnimStartTime = 0

function Season123_1_9TaskItem:onUpdateMO(mo)
	if mo == nil then
		return
	end
...
function Season123_1_9TaskItem:endPlayOpenAnim()
...
function Season123_1_9TaskItem:checkPlayAnim()
...
function Season123_1_9TaskItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_1_9TaskItem:refreshNormal()
...
function Season123_1_9TaskItem:refreshReward()
...
function Season123_1_9TaskItem:createRewardItem(index)
...
function Season123_1_9TaskItem:refreshRewardItem(item, data)
	if not data then
	...
	if data.equipId then
		...
		if not item.equipIcon then
			item.equipIcon = Season123_1_9CelebrityCardItem.New()
...
function Season123_1_9TaskItem:getAnimator()
	return self._ani
end

function Season123_1_9TaskItem:destroyRewardItem(item)
...
function Season123_1_9TaskItem:refreshDesc()
	local config = self.mo.config
...
function Season123_1_9TaskItem:refreshProgress()
...
function Season123_1_9TaskItem:refreshState()
...
function Season123_1_9TaskItem:onClickGoto()
...
function Season123_1_9TaskItem:onClickReceive()
	...
	UIBlockMgr.instance:startBlock(Season123_1_9TaskItem.BlockKey)
	Season123Controller.instance:dispatchEvent(Season123Event.OnTaskRewardGetFinish, self._index)
	TaskDispatcher.runDelay(self._onPlayActAniFinished, self, Season123_1_9TaskItem.TaskMaskTime)
end

function Season123_1_9TaskItem:_onPlayActAniFinished()
	...
	UIBlockMgr.instance:endBlock(Season123_1_9TaskItem.BlockKey)
end

function Season123_1_9TaskItem:onClickGetTotal()
	self:onClickReceive()
end

function Season123_1_9TaskItem:onDestroy()
	TaskDispatcher.cancelTask(self._onPlayActAniFinished, self)
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
