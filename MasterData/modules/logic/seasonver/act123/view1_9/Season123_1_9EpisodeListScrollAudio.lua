-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EpisodeListScrollAudio.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EpisodeListScrollAudio", package.seeall)

local Season123_1_9EpisodeListScrollAudio = class("Season123_1_9EpisodeListScrollAudio", LuaCompBase)

function Season123_1_9EpisodeListScrollAudio:ctor(param)
	self.scroll = param
...
function Season123_1_9EpisodeListScrollAudio:onDragBegin()
	self._isDraging = true
...
function Season123_1_9EpisodeListScrollAudio:onDragEnd()
	self:onUpdate()

	self._isDraging = false
end

function Season123_1_9EpisodeListScrollAudio:onClickDown()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_start)
end

function Season123_1_9EpisodeListScrollAudio:onUpdate()
...
function Season123_1_9EpisodeListScrollAudio:_onValueChangeSampleOffset(y)
...
function Season123_1_9EpisodeListScrollAudio:_onUpdateRTPCSpeed(y)
...
function Season123_1_9EpisodeListScrollAudio:_onValueChangeForStartOrStop(y)
...
function Season123_1_9EpisodeListScrollAudio:_onValueChangeCheckReplay(y)
...
function Season123_1_9EpisodeListScrollAudio:_resetPlayingStatus(y)
	self._isScrollPlaying = false
	self._scrollingPlayY = y
end

function Season123_1_9EpisodeListScrollAudio:dispose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_end)
...
function Season123_1_9EpisodeListScrollAudio:onDestroy()
	self.scroll = nil
end

return Season123_1_9EpisodeListScrollAudio
