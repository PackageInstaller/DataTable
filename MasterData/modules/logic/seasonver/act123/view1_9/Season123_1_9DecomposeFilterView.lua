-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9DecomposeFilterView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9DecomposeFilterView", package.seeall)

local Season123_1_9DecomposeFilterView = class("Season123_1_9DecomposeFilterView", BaseView)

function Season123_1_9DecomposeFilterView:onInitView()
...
function Season123_1_9DecomposeFilterView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
	self._btnreset:AddClickListener(self._btnresetOnClick, self)
	self._btnconfirm:AddClickListener(self._btnconfirmOnClick, self)
end

function Season123_1_9DecomposeFilterView:removeEvents()
	self._btnclose:RemoveClickListener()
	self._btnreset:RemoveClickListener()
	self._btnconfirm:RemoveClickListener()
end

function Season123_1_9DecomposeFilterView:_btncloseOnClick()
	self:closeThis()
end

function Season123_1_9DecomposeFilterView:_btnresetOnClick()
...
function Season123_1_9DecomposeFilterView:_btnconfirmOnClick()
...
function Season123_1_9DecomposeFilterView:_editableInitView()
...
function Season123_1_9DecomposeFilterView:onOpen()
	self:createRareItem()
	self:createTagItem()
	self:refreshUI()
end

function Season123_1_9DecomposeFilterView:refreshUI()
	self:refreshRareSelectUI()
	self:refreshTagSelectUI()
end

function Season123_1_9DecomposeFilterView:refreshRareSelectUI()
...
function Season123_1_9DecomposeFilterView:refreshTagSelectUI()
...
function Season123_1_9DecomposeFilterView:createRareItem()
	for i = 5, 1, -1 do
...
function Season123_1_9DecomposeFilterView:rareItemOnClick(rare)
...
function Season123_1_9DecomposeFilterView:setRareSelectState(itemRare)
	self.rareSelectTab[itemRare] = not self.rareSelectTab[itemRare]
end

function Season123_1_9DecomposeFilterView:createTagItem()
...
function Season123_1_9DecomposeFilterView:tagItemSort(tagConfig)
	local tagConfigData = {}
...
function Season123_1_9DecomposeFilterView:tagItemShow(obj, data, index)
	local tagItem = {}
...
function Season123_1_9DecomposeFilterView:tagItemOnClick(data)
	local tagId = data.id
...
function Season123_1_9DecomposeFilterView:setTagSelectState(tagId)
	self.tagSelectTab[tagId] = not self.tagSelectTab[tagId]
end

function Season123_1_9DecomposeFilterView:onClose()
	return
end

function Season123_1_9DecomposeFilterView:onDestroyView()
...
return Season123_1_9DecomposeFilterView
