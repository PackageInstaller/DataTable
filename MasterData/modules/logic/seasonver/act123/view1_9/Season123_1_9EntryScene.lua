-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EntryScene.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EntryScene", package.seeall)

local Season123_1_9EntryScene = class("Season123_1_9EntryScene", BaseView)

function Season123_1_9EntryScene:onInitView()
...
function Season123_1_9EntryScene:addEvents()
	return
end

function Season123_1_9EntryScene:removeEvents()
	return
end

function Season123_1_9EntryScene:_editableInitView()
	self._cameraHelper = Season123_1_9EntryCamera.New()

	self._cameraHelper:init()

	self._loadHelper = Season123_1_9EntryLoadScene.New()
...
function Season123_1_9EntryScene:onDestroyView()
...
function Season123_1_9EntryScene:onOpen()
...
function Season123_1_9EntryScene:onClose()
	return
end

function Season123_1_9EntryScene:onSceneResLoaded(sceneGo)
	...
	self._dragHelper = Season123_1_9EntryDrag.New()
...
function Season123_1_9EntryScene:handleLocateToStage(param)
...
function Season123_1_9EntryScene:refreshStage(isOpen)
...
function Season123_1_9EntryScene:refreshRetail(retailId)
...
function Season123_1_9EntryScene:refreshRetailStatus()
...
function Season123_1_9EntryScene:handleFocusPos(posX, posY)
	if not self._sceneBgGo then
		return
	end
...
function Season123_1_9EntryScene:handleReleaseFocusPos()
	self._cameraHelper:tweenToScale(1, SeasonEntryEnum.FocusTweenTime)
end

function Season123_1_9EntryScene:handleSetRetailScene(isVisible)
	self._isRetailVisible = isVisible

	self:refreshRetailStatus()
end

function Season123_1_9EntryScene:handleSwitchRetailScene(retailId)
...
function Season123_1_9EntryScene:handleRetailObjLoaded(loadIndex)
...
function Season123_1_9EntryScene:tryFocusOnRetailObj()
	if self._retailId and self._retailFocusId == nil then
		local index, _ = Season123EntryModel.getRandomRetailRes(self._retailSceneId)
...
function Season123_1_9EntryScene:enterEpiosdeList(isEnter)
	local stage = Season123EntryModel.instance:getCurrentStage()
...
function Season123_1_9EntryScene:playCloseAnim()
	local stage = Season123EntryModel.instance:getCurrentStage()

	self._loadHelper:playAnim(stage, Activity123Enum.StageSceneAnim.Close)
end

return Season123_1_9EntryScene
