-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9HeroGroupFightView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9HeroGroupFightView", package.seeall)

local Season123_1_9HeroGroupFightView = class("Season123_1_9HeroGroupFightView", BaseView)

function Season123_1_9HeroGroupFightView:onInitView()
...
function Season123_1_9HeroGroupFightView:addEvents()
...
function Season123_1_9HeroGroupFightView:removeEvents()
...
function Season123_1_9HeroGroupFightView:_btnrecommendOnClick()
...
function Season123_1_9HeroGroupFightView:_btnclothOnClock()
...
function Season123_1_9HeroGroupFightView:_btnrestrainOnClick()
	ViewMgr.instance:openView(ViewName.HeroGroupCareerTipView)
end

Season123_1_9HeroGroupFightView.UIBlock_SeasonFight = "UIBlock_SeasonFight"

function Season123_1_9HeroGroupFightView:_btnstartseasonOnClick()
	if not self._blockStart then
		self:_onClickStart()

		self._blockStart = true

		UIBlockMgr.instance:startBlock(Season123_1_9HeroGroupFightView.UIBlock_SeasonFight)
	end
end

function Season123_1_9HeroGroupFightView:_btnseasonreplayOnClick()
	self:_onClickReplay()
end

function Season123_1_9HeroGroupFightView:_groupDropValueChanged(value)
...
function Season123_1_9HeroGroupFightView:_editableInitView()
	self:_initComponent()
	self:_initData()
	self:_addEvents()
end

function Season123_1_9HeroGroupFightView:onDestroyView()
	...
	UIBlockMgr.instance:endBlock(Season123_1_9HeroGroupFightView.UIBlock_SeasonFight)
end

function Season123_1_9HeroGroupFightView:onOpen()
...
function Season123_1_9HeroGroupFightView:_initComponent()
...
function Season123_1_9HeroGroupFightView:_initData()
...
function Season123_1_9HeroGroupFightView:_initDataOnOpen()
	if Season123HeroGroupModel.instance:isEpisodeSeason123() then
...
function Season123_1_9HeroGroupFightView:_addEvents()
	...
	self.addEventCb(self, Season123Controller.instance, Season123Event.HeroGroupIndexChanged, self._onModifySnapshot, self)
	...
	self.addEventCb(self, Season123Controller.instance, Season123Event.StartFightFailed, self.handleStartFightFailed, self)
end

function Season123_1_9HeroGroupFightView:_checkReplay()
...
function Season123_1_9HeroGroupFightView:initSeason123FightGroupDrop()
	local list = {}

	list = Season123HeroGroupModel.instance:isEpisodeSeason123() and {
...
function Season123_1_9HeroGroupFightView:_receiveRecommend(cmd, resultCode, msg)
...
function Season123_1_9HeroGroupFightView:_onClickReplay()
...
function Season123_1_9HeroGroupFightView:_switchReplayGroup(lastReplayMode)
	self:_refreshTips()
...
function Season123_1_9HeroGroupFightView:_refreshTips()
	return
end

function Season123_1_9HeroGroupFightView:_updateReplayHeroGroupList()
...
function Season123_1_9HeroGroupFightView:_switchReplayMul()
	self._txtreplaycount.text = self._replayMode and luaLang("multiple") .. Season123HeroGroupModel.instance.multiplication or ""
end

function Season123_1_9HeroGroupFightView:_heroMoveForward(heroId)
	HeroGroupEditListModel.instance:setMoveHeroId(tonumber(heroId))
end

function Season123_1_9HeroGroupFightView:handleStartFightFailed()
	self._blockStart = false

	UIBlockMgr.instance:endBlock(Season123_1_9HeroGroupFightView.UIBlock_SeasonFight)
end

function Season123_1_9HeroGroupFightView:isReplayMode()
	return self._replayMode
end

function Season123_1_9HeroGroupFightView:_onCurrencyChange(changeIds)
...
function Season123_1_9HeroGroupFightView:onClose()
	AudioMgr.instance:trigger(AudioEnum.UI.Stop_HeroNormalVoc)
	self:_removeEvents()
...
function Season123_1_9HeroGroupFightView:_removeEvents()
...
function Season123_1_9HeroGroupFightView:_refreshReplay()
...
function Season123_1_9HeroGroupFightView:_refreshCloth()
	...
	gohelper.setActive(self._btncloth.gameObject, Season123_1_9HeroGroupFightView.showCloth())
end

function Season123_1_9HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season123_1_9HeroGroupFightView.showCloth()
	...
	local episodeCO, battleCO = Season123_1_9HeroGroupFightView._getEpisodeConfigAndBattleConfig()
...
function Season123_1_9HeroGroupFightView:_onModifyHeroGroup()
	self:_refreshCloth()
end

function Season123_1_9HeroGroupFightView:_onModifySnapshot()
	self:_refreshCloth()
end

function Season123_1_9HeroGroupFightView:_onClickHeroGroupItem(id)
...
function Season123_1_9HeroGroupFightView:_checkFirstPosHasEquip()
	local curGroupMO = HeroGroupModel.instance:getCurGroupMO()
...
function Season123_1_9HeroGroupFightView:_showGuideDragEffect(param)
	if self._dragEffectLoader then
		self._dragEffectLoader:dispose()
...
function Season123_1_9HeroGroupFightView:_onClickStart()
...
function Season123_1_9HeroGroupFightView:_enterFight()
...
function Season123_1_9HeroGroupFightView:_onUseRecommendGroup()
	if self._replayMode then
		self._replayMode = false
...
function Season123_1_9HeroGroupFightView:_refreshBtns()
...
function Season123_1_9HeroGroupFightView:_onGetFightRecordGroupReply(fightGroupMO)
	self.removeEventCb(self, FightController.instance, FightEvent.RespGetFightRecordGroupReply, self._onGetFightRecordGroupReply, self)
...
function Season123_1_9HeroGroupFightView:_updateReplayHeroGroup()
	HeroGroupModel.instance:setReplayParam(self._replayFightGroupMO)
	HeroGroupController.instance:dispatchEvent(HeroGroupEvent.SelectHeroGroup, self._replayFightGroupMO.id)
	self:_refreshCloth()
	gohelper.setActive(self._goherogroupcontain, false)
...
function Season123_1_9HeroGroupFightView:_playHeroGroupExitEffect()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
end

function Season123_1_9HeroGroupFightView:_playCloseHeroGroupAnimation()
	self._anim:Play("close", 0, 0)
	self._btnContainAnim:Play("close", 0, 0)
...
function Season123_1_9HeroGroupFightView:_closeHeroContainAnim()
	if self._heroContainAnim then
		self._heroContainAnim.enabled = false
	end
end

return Season123_1_9HeroGroupFightView
