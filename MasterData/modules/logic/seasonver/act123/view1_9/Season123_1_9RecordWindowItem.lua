-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9RecordWindowItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9RecordWindowItem", package.seeall)

local Season123_1_9RecordWindowItem = class("Season123_1_9RecordWindowItem", LuaCompBase)
local NotBestRecordMoveY = 6

function Season123_1_9RecordWindowItem:init(go)
	self.go = go
...
function Season123_1_9RecordWindowItem:addEventListeners()
	self._btndetails:AddClickListener(self._btndetailsOnClick, self)
end

function Season123_1_9RecordWindowItem:removeEventListeners()
	self._btndetails:RemoveClickListener()
end

function Season123_1_9RecordWindowItem:_btndetailsOnClick()
...
function Season123_1_9RecordWindowItem:onLoad(delayOpenAnimTime, isPlayOpen)
...
function Season123_1_9RecordWindowItem:_delayActive()
...
function Season123_1_9RecordWindowItem:onUpdateMO(mo)
	self.mo = mo
...
function Season123_1_9RecordWindowItem:playAnimation(animName)
...
function Season123_1_9RecordWindowItem:_onHeroItemLoad(obj, heroData, index)
...
function Season123_1_9RecordWindowItem:onDestroy()
	TaskDispatcher.cancelTask(self._delayActive, self)

	self._isPlayOpen = false
end

return Season123_1_9RecordWindowItem
