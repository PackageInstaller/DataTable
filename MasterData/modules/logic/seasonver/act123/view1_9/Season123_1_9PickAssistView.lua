-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9PickAssistView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9PickAssistView", package.seeall)

local Season123_1_9PickAssistView = class("Season123_1_9PickAssistView", BaseView)

function Season123_1_9PickAssistView:onInitView()
...
function Season123_1_9PickAssistView:addEvents()
	...
	self.addEventCb(self, Season123Controller.instance, Season123Event.BeforeRefreshAssistList, self.onBeforeRefreshAssistList, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.SetCareer, self.refreshIsEmpty, self)
	self.addEventCb(self, Season123Controller.instance, Season123Event.RefreshSelectAssistHero, self.refreshBtnDetail, self)
end

function Season123_1_9PickAssistView:removeEvents()
	self._btnrefresh:RemoveClickListener()
	self._btndetail:RemoveClickListener()
	self._btnconfirm:RemoveClickListener()
	self.addEventCb(self, Season123Controller.instance, Season123Event.BeforeRefreshAssistList, self.onBeforeRefreshAssistList, self)
	self.removeEventCb(self, Season123Controller.instance, Season123Event.SetCareer, self.refreshIsEmpty, self)
	self.removeEventCb(self, Season123Controller.instance, Season123Event.RefreshSelectAssistHero, self.refreshBtnDetail, self)
end

function Season123_1_9PickAssistView:onBeforeRefreshAssistList()
...
function Season123_1_9PickAssistView:_btnrefreshOnClick()
	Season123PickAssistController.instance:manualRefreshList()
end

function Season123_1_9PickAssistView:_onHeroDetailClick()
...
function Season123_1_9PickAssistView:_btnconfirmOnClick()
	Season123PickAssistController.instance:pickOver()
	self:closeThis()
end

function Season123_1_9PickAssistView:_btnCareerFilterOnClick(career)
...
function Season123_1_9PickAssistView:_editableInitView()
	self:_setFilterBtn()
end

function Season123_1_9PickAssistView:_setFilterBtn()
...
function Season123_1_9PickAssistView:_onInitFilterBtn(obj, careerValue, index)
...
function Season123_1_9PickAssistView:onOpen()
...
function Season123_1_9PickAssistView:showRecommendCareer()
	...
	self._txtrecommendAttrDesc.text = hasRecommendCareers and luaLang("herogroupeditview_recommend") or luaLang("herogroupeditview_notrecommend")
...
function Season123_1_9PickAssistView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_1_9PickAssistView:refreshUI()
	self:refreshCD()
	self:refreshCareerFilterItems()
	self:refreshIsEmpty()
...
function Season123_1_9PickAssistView:refreshCD()
	self._simageprogress.fillAmount = Season123PickAssistController.instance:getRefreshCDRate()
end

function Season123_1_9PickAssistView:refreshCareerFilterItems()
...
function Season123_1_9PickAssistView:refreshIsEmpty()
...
function Season123_1_9PickAssistView:refreshBtnDetail()
	local selectedMO = Season123PickAssistListModel.instance:getSelectedMO()

	gohelper.setActive(self._godetail, selectedMO)
end

function Season123_1_9PickAssistView:onClose()
	TaskDispatcher.cancelTask(self.refreshCD, self)
end

function Season123_1_9PickAssistView:onDestroyView()
	self:disposeCareerItems()
	Season123PickAssistController.instance:onCloseView()
end

function Season123_1_9PickAssistView:disposeCareerItems()
...
return Season123_1_9PickAssistView
