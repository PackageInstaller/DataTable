-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EntryOverview.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EntryOverview", package.seeall)

local Season123_1_9EntryOverview = class("Season123_1_9EntryOverview", BaseView)

function Season123_1_9EntryOverview:onInitView()
...
function Season123_1_9EntryOverview:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_1_9EntryOverview:removeEvents()
	self._btnclose:RemoveClickListener()
end

Season123_1_9EntryOverview.UI_Item_Count = 6

function Season123_1_9EntryOverview:_editableInitView()
	self._entryList = {}

	self:initItems()
end

function Season123_1_9EntryOverview:onDestroyView()
...
function Season123_1_9EntryOverview:onOpen()
...
function Season123_1_9EntryOverview:onClose()
	return
end

function Season123_1_9EntryOverview:refreshUI()
	self:refreshItems()
end

function Season123_1_9EntryOverview:refreshItems()
	local actId = Season123EntryOverviewModel.instance:getActId()
	local stageCOList = Season123Config.instance:getStageCos(actId)

	if stageCOList then
		for index = 1, Season123_1_9EntryOverview.UI_Item_Count do
...
function Season123_1_9EntryOverview:refreshItem(item, stageCO, stageMO)
	local actId = Season123EntryOverviewModel.instance:getActId()
...
function Season123_1_9EntryOverview:refreshProgress(item, stageCO, stageMO)
...
function Season123_1_9EntryOverview:refreshUnlockStatus(item, stageCO, stageMO)
	local rs, reason, value = Season123ProgressUtils.isStageUnlock(self.viewParam.actId, stageCO.stage)
...
function Season123_1_9EntryOverview:initItems()
	for i = 1, Season123_1_9EntryOverview.UI_Item_Count do
...
function Season123_1_9EntryOverview:handleGetActInfo(actId)
	if self.viewParam.actId == actId then
		self:refreshUI()
	end
end

function Season123_1_9EntryOverview:onClickIndex(index)
...
function Season123_1_9EntryOverview:_btncloseOnClick()
	self._viewAnimator:Play(UIAnimationName.Close, 0, 0)
	TaskDispatcher.runDelay(self._closeCallback, self, 0.17)
end

function Season123_1_9EntryOverview:_closeCallback()
	self:closeThis()
end

function Season123_1_9EntryOverview:_playUnlockAnim()
	local actId = Season123EntryOverviewModel.instance:getActId()
	local stageCOList = Season123Config.instance:getStageCos(actId)
...
return Season123_1_9EntryOverview
