-- chunkname: @modules/logic/seasonver/act123/view1_9/component/Season123_1_9ResetViewAudio.lua

module("modules.logic.seasonver.act123.view1_9.component.Season123_1_9ResetViewAudio", package.seeall)

local Season123_1_9ResetViewAudio = class("Season123_1_9ResetViewAudio", LuaCompBase)

function Season123_1_9ResetViewAudio:ctor(param)
	self.scroll = param
...
function Season123_1_9ResetViewAudio:onDragBegin()
	self._isDraging = true
...
function Season123_1_9ResetViewAudio:onDragEnd()
	self:onUpdate()

	self._isDraging = false
end

function Season123_1_9ResetViewAudio:onClickDown()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_start)
end

function Season123_1_9ResetViewAudio:onUpdate()
...
function Season123_1_9ResetViewAudio:_onValueChangeSampleOffset(x)
...
function Season123_1_9ResetViewAudio:_onUpdateRTPCSpeed(x)
...
function Season123_1_9ResetViewAudio:_onValueChangeForStartOrStop(x)
...
function Season123_1_9ResetViewAudio:_onValueChangeCheckReplay(x)
...
function Season123_1_9ResetViewAudio:_resetPlayingStatus(x)
	self._isScrollPlaying = false
	self._scrollingPlayX = x
end

function Season123_1_9ResetViewAudio:dispose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_end)
...
function Season123_1_9ResetViewAudio:onDestroy()
	self.scroll = nil
end

return Season123_1_9ResetViewAudio
