-- chunkname: @modules/logic/seasonver/act123/view1_9/component/Season123_1_9EntryDrag.lua

module("modules.logic.seasonver.act123.view1_9.component.Season123_1_9EntryDrag", package.seeall)

local Season123_1_9EntryDrag = class("Season123_1_9EntryDrag", UserDataDispose)

function Season123_1_9EntryDrag:init(goFullScreen, tfScene)
	self:__onInit()
	...
	self.addEventCb(self, GameGlobalMgr.instance, GameStateEvent.OnScreenResize, self.handleScreenResize, self)
end

function Season123_1_9EntryDrag:dispose()
	if self._drag then
...
function Season123_1_9EntryDrag:initBound()
	local sizeGo = gohelper.findChild(self._sceneGo, "root/m_s15_size")
...
function Season123_1_9EntryDrag:onDragBegin(param, pointerEventData)
...
function Season123_1_9EntryDrag:onDragEnd(param, pointerEventData)
	self._dragBeginPos = nil
	self._beginDragPos = nil
end

function Season123_1_9EntryDrag:onDrag(param, pointerEventData)
...
function Season123_1_9EntryDrag:drag(deltaPos)
...
function Season123_1_9EntryDrag:setScenePosDrag(targetPos)
...
function Season123_1_9EntryDrag:setScenePosTween(targetPos, tweenTime, callback, callbackObj)
...
function Season123_1_9EntryDrag:fixTargetPos(targetPos)
...
function Season123_1_9EntryDrag:localMoveDone()
	self._tweenId = nil
end

function Season123_1_9EntryDrag:vectorAdd(v1, v2)
...
function Season123_1_9EntryDrag:getTempPos()
	return self._tempVector
end

function Season123_1_9EntryDrag:killTween()
...
function Season123_1_9EntryDrag:setDragEnabled(value)
	self._dragEnabled = value
end

function Season123_1_9EntryDrag:getDragWorldPos(pointerEventData)
...
function Season123_1_9EntryDrag:handleScreenResize()
	self:initBound()
