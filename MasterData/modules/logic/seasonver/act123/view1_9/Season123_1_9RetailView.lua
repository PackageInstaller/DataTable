-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9RetailView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9RetailView", package.seeall)

local Season123_1_9RetailView = class("Season123_1_9RetailView", BaseView)

function Season123_1_9RetailView:onInitView()
...
function Season123_1_9RetailView:addEvents()
...
function Season123_1_9RetailView:onOpen()
...
function Season123_1_9RetailView:onClose()
	return
end

function Season123_1_9RetailView:refreshUI()
	self:refreshInfo()
...
function Season123_1_9RetailView:refreshInfo()
...
function Season123_1_9RetailView:initIconUI()
...
function Season123_1_9RetailView:refreshRecommendLv()
	local recommendLevel = Season123RetailModel.instance:getRecommentLevel()

	self._txtenemylevelnum.text = recommendLevel and HeroConfig.instance:getLevelDisplayVariant(recommendLevel) or luaLang("common_none")
end

function Season123_1_9RetailView:refreshRewards()
...
function Season123_1_9RetailView:refreshCardPackageUI()
...
function Season123_1_9RetailView:getOrCreateRewardItem(index)
...
function Season123_1_9RetailView:refreshTicket()
...
function Season123_1_9RetailView:handleItemChanged()
	self:refreshCardPackageUI()
	self:refreshTicket()
end

function Season123_1_9RetailView:_btncelebrityOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

function Season123_1_9RetailView:_btncardsOnClick()
	Season123Controller.instance:openSeasonCardPackageView({
		actId = self.viewParam.actId
	})
end

function Season123_1_9RetailView:onClickIcon(index)
...
function Season123_1_9RetailView:_btnstartOnClick()
	Season123RetailController.instance:enterRetailFightScene()
end

return Season123_1_9RetailView
