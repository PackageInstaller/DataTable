-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9StoreItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9StoreItem", package.seeall)

local Season123_1_9StoreItem = class("Season123_1_9StoreItem", ListScrollCell)

function Season123_1_9StoreItem:init(go)
	self.go = go
...
function Season123_1_9StoreItem:onClick()
...
function Season123_1_9StoreItem:onUpdateMO(data)
	self.data = data
...
function Season123_1_9StoreItem:refreshRemainBuyCount()
...
function Season123_1_9StoreItem:refreshTag()
