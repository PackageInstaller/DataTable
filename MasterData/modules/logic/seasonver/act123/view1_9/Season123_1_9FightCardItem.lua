-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9FightCardItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9FightCardItem", package.seeall)

local Season123_1_9FightCardItem = class("Season123_1_9FightCardItem", UserDataDispose)

function Season123_1_9FightCardItem:ctor(go)
	self:__onInit()
...
Season123_1_9FightCardItem.MainRoleItemMinHeight = 390
Season123_1_9FightCardItem.NormalRoleItemMinHeight = 315
Season123_1_9FightCardItem.RoleCardPos = {
	Vector2(-16.5, 0.5),
	Vector2(-16.5, 0.5),
	Vector2(-16.5, -6.5),
	Vector2(-16.5, -17),
...
function Season123_1_9FightCardItem:setData(data)
	if not data then
	...
	if self.isMainRole then
		self.layoutElement.minHeight = Season123_1_9FightCardItem.MainRoleItemMinHeight or Season123_1_9FightCardItem.NormalRoleItemMinHeight
	end
...
function Season123_1_9FightCardItem:_setName()
	if self.isMainRole then
...
function Season123_1_9FightCardItem:_setHead()
...
function Season123_1_9FightCardItem:getHeroMO()
...
function Season123_1_9FightCardItem:_setCard(equipId)
	if not self.cardItem then
		self.cardItem = Season123_1_9CelebrityCardItem.New()
	...
	local targetCardPos = Season123_1_9FightCardItem.RoleCardPos[tonumber(rare)] or Vector2(0, 0)

	recthelper.setAnchor(self.goCardPos.transform, targetCardPos.x, targetCardPos.y)
end

function Season123_1_9FightCardItem:_setDesc(equipId)
...
function Season123_1_9FightCardItem:createDescItem(index)
	local item = {}
...
function Season123_1_9FightCardItem:updateDescItem(item, skillStr)
...
function Season123_1_9FightCardItem:destroyDescItem(item)
	return
end

function Season123_1_9FightCardItem:destroy()
...
return Season123_1_9FightCardItem
