-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9ResetView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9ResetView", package.seeall)

local Season123_1_9ResetView = class("Season123_1_9ResetView", BaseView)

function Season123_1_9ResetView:onInitView()
...
function Season123_1_9ResetView:addEvents()
	self._btnreset:AddClickListener(self._btnresetOnClick, self)
end

function Season123_1_9ResetView:removeEvents()
	self._btnreset:RemoveClickListener()
end

function Season123_1_9ResetView:_editableInitView()
	self._heroItems = {}
	self._episodeItems = {}
...
function Season123_1_9ResetView:onDestroyView()
...
function Season123_1_9ResetView:onOpen()
...
function Season123_1_9ResetView:onClose()
	return
end

function Season123_1_9ResetView:refreshUI()
	self:refreshStatus()
	self:refreshStage()
...
function Season123_1_9ResetView:refreshStatus()
...
function Season123_1_9ResetView:refreshStage()
...
function Season123_1_9ResetView:refreshEpisodeItems()
...
function Season123_1_9ResetView:refreshEpisodeItem(index, data)
...
function Season123_1_9ResetView:refreshSingleItemFinished(index, item, data)
...
function Season123_1_9ResetView:refreshHeroItems()
...
function Season123_1_9ResetView:refreshHero(item, data)
	if not data then
...
function Season123_1_9ResetView:refreshHeroHp(item, data)
	if not data then
...
function Season123_1_9ResetView:createStageItem()
...
function Season123_1_9ResetView:getOrCreateEpisodeItem(index)
...
function Season123_1_9ResetView:getOrCreateHeroItem(index)
...
function Season123_1_9ResetView:delayInitScrollAudio()
	self._audioScroll = MonoHelper.addLuaComOnceToGo(self._goscrollchapter, Season123_1_9ResetViewAudio, self._scrollchapter)
...
function Season123_1_9ResetView:onDragAudioBegin()
	self._audioScroll:onDragBegin()
end

function Season123_1_9ResetView:onDragAudioEnd()
	self._audioScroll:onDragEnd()
end

function Season123_1_9ResetView:onClickAudioDown()
	self._audioScroll:onClickDown()
end

function Season123_1_9ResetView:onClickStageItem()
...
function Season123_1_9ResetView:onClickEpisodeItem(index)
...
function Season123_1_9ResetView:_btnresetOnClick()
	Season123ResetController.instance:tryReset()
end

return Season123_1_9ResetView
