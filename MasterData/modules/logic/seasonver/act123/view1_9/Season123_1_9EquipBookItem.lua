-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EquipBookItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EquipBookItem", package.seeall)

local Season123_1_9EquipBookItem = class("Season123_1_9EquipBookItem", ListScrollCellExtend)

function Season123_1_9EquipBookItem:init(go)
	Season123_1_9EquipBookItem.super.init(self, go)
...
Season123_1_9EquipBookItem.ColumnCount = 6
Season123_1_9EquipBookItem.AnimRowCount = 4
Season123_1_9EquipBookItem.OpenAnimTime = 0.06
Season123_1_9EquipBookItem.OpenAnimStartTime = 0.05

function Season123_1_9EquipBookItem:refreshUI()
...
function Season123_1_9EquipBookItem:checkPlayAnim()
...
function Season123_1_9EquipBookItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_1_9EquipBookItem:checkCreateIcon()
...
function Season123_1_9EquipBookItem:onClickSelf()
	if self._mo then
		Season123EquipBookController.instance:changeSelect(self._mo.id)
	end
end

function Season123_1_9EquipBookItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
...
return Season123_1_9EquipBookItem
