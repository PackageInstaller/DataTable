-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9HeroGroupReplaySelectView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9HeroGroupReplaySelectView", package.seeall)

local Season123_1_9HeroGroupReplaySelectView = class("Season123_1_9HeroGroupReplaySelectView", BaseView)

function Season123_1_9HeroGroupReplaySelectView:onInitView()
...
function Season123_1_9HeroGroupReplaySelectView:addEvents()
...
function Season123_1_9HeroGroupReplaySelectView:removeEvents()
	self._btnmultispeed:RemoveClickListener()
	self._btnclosemult:RemoveClickListener()
end

function Season123_1_9HeroGroupReplaySelectView:_editableInitView()
...
function Season123_1_9HeroGroupReplaySelectView:onDestroyView()
	return
end

function Season123_1_9HeroGroupReplaySelectView:onOpen()
	self:initCostIcon()
	self:initMultiGroup()
	self:refreshSelection()
end

function Season123_1_9HeroGroupReplaySelectView:onClose()
	return
end

Season123_1_9HeroGroupReplaySelectView.ItemHeight = 92

function Season123_1_9HeroGroupReplaySelectView:initMultiGroup()
	...
	recthelper.setHeight(self.rectdropbg, Season123_1_9HeroGroupReplaySelectView.ItemHeight * maxTimes)
end

function Season123_1_9HeroGroupReplaySelectView:initMultSpeedItem(go, multispeed, maxTimes)
...
function Season123_1_9HeroGroupReplaySelectView:initCostIcon()
...
function Season123_1_9HeroGroupReplaySelectView:refreshMulti()
...
function Season123_1_9HeroGroupReplaySelectView:onClickSetSpeed(speed)
...
function Season123_1_9HeroGroupReplaySelectView:setMultSpeed(speed)
...
function Season123_1_9HeroGroupReplaySelectView:refreshSelection()
...
function Season123_1_9HeroGroupReplaySelectView:_btnmultispeedOnClick()
	self._isMultiOpen = not self._isMultiOpen

	self:refreshMulti()
end

function Season123_1_9HeroGroupReplaySelectView:_btnclosemultOnClick()
	self._isMultiOpen = false

	self:refreshMulti()
end

return Season123_1_9HeroGroupReplaySelectView
