-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9DecomposeItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9DecomposeItem", package.seeall)

local Season123_1_9DecomposeItem = class("Season123_1_9DecomposeItem", ListScrollCellExtend)

function Season123_1_9DecomposeItem:init(go)
	Season123_1_9DecomposeItem.super.init(self, go)
...
function Season123_1_9DecomposeItem:addEventListeners()
...
function Season123_1_9DecomposeItem:removeEventListeners()
...
function Season123_1_9DecomposeItem:onUpdateMO(mo)
	self._mo = mo
...
Season123_1_9DecomposeItem.AnimRowCount = 4
Season123_1_9DecomposeItem.OpenAnimTime = 0.06
Season123_1_9DecomposeItem.OpenAnimStartTime = 0.05

function Season123_1_9DecomposeItem:refreshUI()
...
function Season123_1_9DecomposeItem:refreshEquipedHero(heroUid)
...
function Season123_1_9DecomposeItem:checkPlayAnim()
...
function Season123_1_9DecomposeItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_1_9DecomposeItem:checkCreateIcon()
...
function Season123_1_9DecomposeItem:onClickSelf()
...
function Season123_1_9DecomposeItem:showDecomposeEffect()
...
function Season123_1_9DecomposeItem:hideDecomposeEffect()
	gohelper.setActive(self._goDecomposeEffect, false)
end

function Season123_1_9DecomposeItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
...
return Season123_1_9DecomposeItem
