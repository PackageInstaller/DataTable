-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9TaskView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9TaskView", package.seeall)

local Season123_1_9TaskView = class("Season123_1_9TaskView", BaseView)

function Season123_1_9TaskView:onInitView()
...
function Season123_1_9TaskView:addEvents()
...
function Season123_1_9TaskView:removeEvents()
...
Season123_1_9TaskView.TaskMaskTime = 0.65
Season123_1_9TaskView.TaskGetAnimTime = 0.567
Season123_1_9TaskView.StageMapItemCount = 6
Season123_1_9TaskView.moveDistance = 50

function Season123_1_9TaskView:_btnrewardOnClick()
	self.curTaskType = Activity123Enum.TaskRewardViewType

	self:refreshUI()
end

function Season123_1_9TaskView:_btntaskOnClick()
	self.curTaskType = Activity123Enum.TaskNormalType

	self:refreshUI()
end

function Season123_1_9TaskView:_btnArrowDownOnClick()
	self.curStage = Mathf.Min(self.curStage + 1, Season123_1_9TaskView.StageMapItemCount)
...
function Season123_1_9TaskView:_btnArrowUpOnClick()
...
function Season123_1_9TaskView:_onScrollDragBegin(param, eventData)
	self.scrollStartPos = eventData.position
end

function Season123_1_9TaskView:_onScrollDragEnd(param, eventData)
	local moveOffset = eventData.position - self.scrollStartPos
	local canMove = Mathf.Abs(moveOffset.y) - Season123_1_9TaskView.moveDistance >= 0
...
function Season123_1_9TaskView:_editableInitView()
	...
	self._taskAnimRemoveItem:setMoveAnimationTime(Season123_1_9TaskView.TaskMaskTime - Season123_1_9TaskView.TaskGetAnimTime)
...
function Season123_1_9TaskView:onOpen()
	...
	UIBlockMgr.instance:startBlock("playEnterSeason123_1_9TaskViewAnim")
	TaskDispatcher.runDelay(self.endEnterAnimBlock, self, 0.8)
	AudioMgr.instance:trigger(AudioEnum.UI.Act1_6DungeonEnterTaskView)
end

function Season123_1_9TaskView:refreshUI()
...
function Season123_1_9TaskView:refreshRedDot()
...
function Season123_1_9TaskView:refreshArrowRedDot()
	...
	local downIndex = Mathf.Min(self.curStage + 1, Season123_1_9TaskView.StageMapItemCount)
...
function Season123_1_9TaskView:refreshArrowUI()
	gohelper.setActive(self._btnarrowdown.gameObject, self.curStage < Season123_1_9TaskView.StageMapItemCount)
	gohelper.setActive(self._btnarrowtop.gameObject, self.curStage > 1)
	self:refreshArrowRedDot()
end

function Season123_1_9TaskView:_playGetRewardFinishAnim(index)
	if index then
		self.removeIndexTab = {
			index
		}
	...
	TaskDispatcher.runDelay(self.delayPlayFinishAnim, self, Season123_1_9TaskView.TaskGetAnimTime)
end

function Season123_1_9TaskView:delayPlayFinishAnim()
	self._taskAnimRemoveItem:removeByIndexs(self.removeIndexTab)
end

function Season123_1_9TaskView:endEnterAnimBlock()
	UIBlockMgr.instance:endBlock("playEnterSeason123_1_9TaskViewAnim")
end

function Season123_1_9TaskView:createStageMapItem()
	for index = 1, Season123_1_9TaskView.StageMapItemCount do
		...
		if not stageMapItem then
			...
			stageMapItem.item = MonoHelper.addNoUpdateLuaComOnceToGo(stageMapItem.itemGO, Season123_1_9TaskMapItem, {
				stage = index,
				actId = self.actId
			})
...
function Season123_1_9TaskView:moveScrollPos()
	self.curStage = Season123TaskModel.instance.curStage
...
function Season123_1_9TaskView:onClose()
