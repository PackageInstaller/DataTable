-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EpisodeListView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EpisodeListView", package.seeall)

local Season123_1_8EpisodeListView = class("Season123_1_8EpisodeListView", BaseView)

function Season123_1_8EpisodeListView:onInitView()
...
function Season123_1_8EpisodeListView:addEvents()
...
function Season123_1_8EpisodeListView:removeEvents()
...
function Season123_1_8EpisodeListView:_editableInitView()
	self._stageItems = {}
...
function Season123_1_8EpisodeListView:onDestroyView()
	...
	UIBlockMgr.instance:endBlock(Season123_1_8EpisodeListView.SCROLL_ANIM_BLOCK_KEY)
...
function Season123_1_8EpisodeListView:onOpen()
...
function Season123_1_8EpisodeListView:onClose()
	return
end

function Season123_1_8EpisodeListView:refreshUI()
...
function Season123_1_8EpisodeListView:refreshStageList()
	local layerDatas = Season123EpisodeListModel.instance:getList()
	local processSet = {}
...
function Season123_1_8EpisodeListView:getOrCreateLayerItem(index)
...
function Season123_1_8EpisodeListView:refreshSingleItem(index, item, data)
...
function Season123_1_8EpisodeListView:refreshSingleItemLock(index, item, data)
...
function Season123_1_8EpisodeListView:refreshSingleItemFinished(index, item, data)
	local isUnlock = Season123EpisodeListModel.instance:isEpisodeUnlock(data.cfg.layer)
...
function Season123_1_8EpisodeListView:refreshCenter()
	if self._centerItem then
		self._centerItem:refreshUI()
	end
end

function Season123_1_8EpisodeListView:initCenter()
	self._centerItem = Season123_1_8EpisodeListCenter.New()

	self._centerItem:init(self._goentranceitem)
	self._centerItem:initData(self.viewParam.actId, self.viewParam.stage)
end

Season123_1_8EpisodeListView.OutOfBoundOffset = 280
Season123_1_8EpisodeListView.DelayEnterEpisodeTime = 0.2
Season123_1_8EpisodeListView.SCROLL_ANIM_BLOCK_KEY = "Season123_1_8EpisodeListView_scrollanim"

function Season123_1_8EpisodeListView:playScrollAnim(index)
	UIBlockMgr.instance:startBlock(Season123_1_8EpisodeListView.SCROLL_ANIM_BLOCK_KEY)
	...
	if deltaY > Season123_1_8EpisodeListView.OutOfBoundOffset then
		self._tweenIdScroll = ZProj.TweenHelper.DOAnchorPosY(self._rectScroll, targetY + Season123_1_8EpisodeListView.OutOfBoundOffset, Season123_1_8EpisodeListView.DelayEnterEpisodeTime, self.handlePlayScrollAnimCompleted, self)
	elseif deltaY < -Season123_1_8EpisodeListView.OutOfBoundOffset then
		self._tweenIdScroll = ZProj.TweenHelper.DOAnchorPosY(self._rectScroll, targetY - Season123_1_8EpisodeListView.OutOfBoundOffset, Season123_1_8EpisodeListView.DelayEnterEpisodeTime, self.handlePlayScrollAnimCompleted, self)
	else
		self._viewAnimator:Play(UIAnimationName.Close, 0, 0)
		TaskDispatcher.runDelay(self.handlePlayScrollAnimCompleted, self, Season123_1_8EpisodeListView.DelayEnterEpisodeTime)
	end
end

function Season123_1_8EpisodeListView:handlePlayScrollAnimCompleted()
...
function Season123_1_8EpisodeListView:getScrollToIndexY(index)
...
function Season123_1_8EpisodeListView:onItemClick(index)
...
function Season123_1_8EpisodeListView:_btnheroesOnClick()
	local actId = self.viewParam.actId
...
function Season123_1_8EpisodeListView:_btnresetOnClick()
...
function Season123_1_8EpisodeListView:_btndetailsOnClick()
...
function Season123_1_8EpisodeListView:_btntiprewardOnClick()
...
function Season123_1_8EpisodeListView:_btnadditionruleDetailOnClick()
...
function Season123_1_8EpisodeListView:_btnMaskOnClick()
	self.viewContainer:_overrideCloseFunc()
end

function Season123_1_8EpisodeListView:OnDotChange()
...
function Season123_1_8EpisodeListView:onCloseView(viewName)
	if viewName == ViewName.Season123_1_8EpisodeDetailView then
		self:refreshStageList()
		self._viewAnimator:Play(UIAnimationName.Open, 0, 0)
	end
end

function Season123_1_8EpisodeListView:delayAddScrollAudio()
	self._audioScroll = MonoHelper.addLuaComOnceToGo(self._goscrollstory, Season123_1_8EpisodeListScrollAudio, self._scrollStory)
...
function Season123_1_8EpisodeListView:_onDragBegin()
	self._audioScroll:onDragBegin()
end

function Season123_1_8EpisodeListView:_onDragEnd()
	self._audioScroll:onDragEnd()
end

function Season123_1_8EpisodeListView:_onClickDown()
	self._audioScroll:onClickDown()
end

return Season123_1_8EpisodeListView
