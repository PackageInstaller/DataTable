-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8ShowHeroItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8ShowHeroItem", package.seeall)

local Season123_1_8ShowHeroItem = class("Season123_1_8ShowHeroItem", UserDataDispose)

function Season123_1_8ShowHeroItem:ctor()
	self:__onInit()
end

function Season123_1_8ShowHeroItem:dispose()
	self:removeEvents()
	self:__onDispose()
end

function Season123_1_8ShowHeroItem:init(viewGO)
	self.viewGO = gohelper.findChild(viewGO, "root")

	self:initComponent()
end

Season123_1_8ShowHeroItem.exSkillFillAmount = {
	0.2,
	0.4,
	0.6,
	0.79,
...
Season123_1_8ShowHeroItem.MaxRare = 5

function Season123_1_8ShowHeroItem:initComponent()
	...
	local maxRank = HeroConfig.instance:getMaxRank(Season123_1_8ShowHeroItem.MaxRare)
...
function Season123_1_8ShowHeroItem:initData(index)
	self._index = index
...
function Season123_1_8ShowHeroItem:removeEvents()
	self._btnclick:RemoveClickListener()
end

function Season123_1_8ShowHeroItem:onClose()
...
function Season123_1_8ShowHeroItem:refreshUI()
	...
	if mo then
		...
		if not skinConfig then
			logError("Season123_1_8ShowHeroItem.refreshUI error, skinCfg is nil, id:" .. tostring(mo.heroMO.skin))
...
function Season123_1_8ShowHeroItem:refreshRare(heroMO)
	for rare = 1, #self._rareList do
		gohelper.setActive(self._rareList[rare], rare <= heroMO.config.rare + 1)
	end
end

function Season123_1_8ShowHeroItem:refreshRank(heroMO)
...
function Season123_1_8ShowHeroItem:refreshExSkill(heroMO)
...
function Season123_1_8ShowHeroItem:refreshHp(mo)
...
function Season123_1_8ShowHeroItem:onClickSelf()
	...
	CharacterController.instance:openCharacterView(mo.heroMO, {})
end

function Season123_1_8ShowHeroItem:OpenAnim()
...
function Season123_1_8ShowHeroItem:playOpenAnim()
...
return Season123_1_8ShowHeroItem
