-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8CelebrityCardTipView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8CelebrityCardTipView", package.seeall)

local Season123_1_8CelebrityCardTipView = class("Season123_1_8CelebrityCardTipView", BaseView)

function Season123_1_8CelebrityCardTipView:onInitView()
...
function Season123_1_8CelebrityCardTipView:addEvents()
...
function Season123_1_8CelebrityCardTipView:removeEvents()
...
function Season123_1_8CelebrityCardTipView:_btncloseOnClick()
	self:closeThis()
end

function Season123_1_8CelebrityCardTipView:onClickGMAdd(count)
...
function Season123_1_8CelebrityCardTipView:_btninputOnClick()
...
function Season123_1_8CelebrityCardTipView:_editableInitView()
...
function Season123_1_8CelebrityCardTipView:onDestroyView()
...
function Season123_1_8CelebrityCardTipView:onOpen()
...
function Season123_1_8CelebrityCardTipView:onClose()
	return
end

function Season123_1_8CelebrityCardTipView:refreshUI()
...
function Season123_1_8CelebrityCardTipView:refreshQuantity()
...
function Season123_1_8CelebrityCardTipView:refreshProps()
	local isDirty = false
...
function Season123_1_8CelebrityCardTipView:refreshSkills()
...
function Season123_1_8CelebrityCardTipView:checkCreateIcon()
	if not self._icon then
		local path = self.viewContainer:getSetting().otherRes[1]
		local go = self:getResInst(path, self._gocard, "icon")

		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_1_8CelebrityCardEquip)
	end
end

function Season123_1_8CelebrityCardTipView:getOrCreatePropText(index)
...
function Season123_1_8CelebrityCardTipView:getOrCreateSkillText(index)
...
function Season123_1_8CelebrityCardTipView:onClickModalMask()
	self:closeThis()
end

return Season123_1_8CelebrityCardTipView
