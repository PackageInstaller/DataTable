-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EnemyRule.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EnemyRule", package.seeall)

local Season123_1_8EnemyRule = class("Season123_1_8EnemyRule", BaseView)

function Season123_1_8EnemyRule:onInitView()
...
function Season123_1_8EnemyRule:addEvents()
...
function Season123_1_8EnemyRule:removeEvents()
	self._btnadditionRuleclick:RemoveClickListener()
	self._btncloserule:RemoveClickListener()
end

function Season123_1_8EnemyRule:_btncloseruleOnClick()
...
function Season123_1_8EnemyRule:_btnadditionRuleOnClick()
	self._ruleItemClick = self._goruledesc.activeSelf

	gohelper.setActive(self._goruledesc, true)
end

function Season123_1_8EnemyRule:_editableInitView()
...
function Season123_1_8EnemyRule:_addRuleItem(ruleCo, targetId)
...
function Season123_1_8EnemyRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season123_1_8EnemyRule:_clear()
...
function Season123_1_8EnemyRule:onDestroyView()
	self:_clear()
end

return Season123_1_8EnemyRule
