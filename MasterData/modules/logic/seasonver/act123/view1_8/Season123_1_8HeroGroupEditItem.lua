-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8HeroGroupEditItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8HeroGroupEditItem", package.seeall)

local Season123_1_8HeroGroupEditItem = class("Season123_1_8HeroGroupEditItem", ListScrollCell)

function Season123_1_8HeroGroupEditItem:init(go)
...
function Season123_1_8HeroGroupEditItem:_initObj(go)
...
function Season123_1_8HeroGroupEditItem:addEventListeners()
...
function Season123_1_8HeroGroupEditItem:removeEventListeners()
	return
end

function Season123_1_8HeroGroupEditItem:_onSkinChanged()
	self._heroItem:updateHero()
end

function Season123_1_8HeroGroupEditItem:_onAttributeChanged(level, heroId)
	self._heroItem:setLevel(level, heroId)
end

function Season123_1_8HeroGroupEditItem:setAdventureBuff(buffId)
	self._heroItem:setAdventureBuff(buffId)
end

function Season123_1_8HeroGroupEditItem:updateLimitStatus()
...
function Season123_1_8HeroGroupEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_1_8HeroGroupEditItem:refreshHp()
...
function Season123_1_8HeroGroupEditItem:refreshDead()
	if Season123HeroGroupModel.instance:isEpisodeSeason123() then
		local isDead = false
		local actId = Season123HeroGroupEditModel.instance.activityId
		local stage = Season123HeroGroupEditModel.instance.stage
...
function Season123_1_8HeroGroupEditItem:onSelect(select)
...
function Season123_1_8HeroGroupEditItem:_onItemClick()
...
function Season123_1_8HeroGroupEditItem:checkRestrict(heroUid)
...
function Season123_1_8HeroGroupEditItem:checkHpZero(heroUid)
	local actId = Season123HeroGroupEditModel.instance.activityId
	local stage = Season123HeroGroupEditModel.instance.stage
	local layer = Season123HeroGroupEditModel.instance.layer
...
function Season123_1_8HeroGroupEditItem:enableDeselect(enable)
	self._enableDeselect = enable
end

function Season123_1_8HeroGroupEditItem:setHp(hpRate)
...
function Season123_1_8HeroGroupEditItem:onDestroy()
	return
end

function Season123_1_8HeroGroupEditItem:getAnimator()
	return self._animator
end

return Season123_1_8HeroGroupEditItem
