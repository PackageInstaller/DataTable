-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EquipView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EquipView", package.seeall)

local Season123_1_8EquipView = class("Season123_1_8EquipView", BaseView)

function Season123_1_8EquipView:onInitView()
...
function Season123_1_8EquipView:addEvents()
...
function Season123_1_8EquipView:removeEvents()
	self._btnequip:RemoveClickListener()
	self._btnopenhandbook:RemoveClickListener()
end

function Season123_1_8EquipView:_editableInitView()
...
function Season123_1_8EquipView:onDestroyView()
...
function Season123_1_8EquipView:onOpen()
...
function Season123_1_8EquipView:onClose()
	return
end

function Season123_1_8EquipView:refreshUI()
...
function Season123_1_8EquipView:handleEquipUpdate()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_1_8EquipView:refreshSlots()
...
function Season123_1_8EquipView:refreshSlot(slotIndex)
...
Season123_1_8EquipView.MaxUISlot = 2

function Season123_1_8EquipView:refreshDescGroup()
	for slot = 1, Season123_1_8EquipView.MaxUISlot do
...
function Season123_1_8EquipView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season123_1_8EquipView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season123_1_8EquipView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season123_1_8EquipView:getOrCreatePropText(index, descItem)
...
function Season123_1_8EquipView:getOrCreateSkillText(index, descItem)
...
function Season123_1_8EquipView:getOrCreateSlot(slotIndex)
...
function Season123_1_8EquipView:getOrCreateSlotIcon(slotItem)
...
function Season123_1_8EquipView:getOrCreateDesc(index)
...
function Season123_1_8EquipView:onClickSlot(slotIndex)
	if Season123EquipItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season123_1_8EquipView:handleSaveSucc()
...
function Season123_1_8EquipView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_1_8EquipView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season123_1_8EquipView:handleEquipCardChanged(param)
...
function Season123_1_8EquipView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season123_1_8EquipView:_btnequipOnClick()
...
function Season123_1_8EquipView:_btnhandbookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

return Season123_1_8EquipView
