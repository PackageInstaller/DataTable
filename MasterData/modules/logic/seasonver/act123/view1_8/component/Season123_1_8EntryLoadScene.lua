-- chunkname: @modules/logic/seasonver/act123/view1_8/component/Season123_1_8EntryLoadScene.lua

module("modules.logic.seasonver.act123.view1_8.component.Season123_1_8EntryLoadScene", package.seeall)

local Season123_1_8EntryLoadScene = class("Season123_1_8EntryLoadScene", UserDataDispose)

function Season123_1_8EntryLoadScene:init()
	self:__onInit()
...
function Season123_1_8EntryLoadScene:dispose()
	self:__onDispose()
	self:releaseRes()
end

function Season123_1_8EntryLoadScene:createSceneRoot()
	local mainTrans = CameraMgr.instance:getMainCameraTrs().parent
	local sceneRoot = CameraMgr.instance:getSceneRoot()

	self._sceneRoot = UnityEngine.GameObject.New("Season123_1_8EntryScene")
...
function Season123_1_8EntryLoadScene:disposeSceneRoot()
...
Season123_1_8EntryLoadScene.BLOCK_LOAD_RES_KEY = "Season123_1_8EntrySceneLoadRes"

function Season123_1_8EntryLoadScene:loadRes(callback, callbackObj)
	self._callback = callback
	self._callbackObj = callbackObj

	UIBlockMgr.instance:startBlock(Season123_1_8EntryLoadScene.BLOCK_LOAD_RES_KEY)
...
function Season123_1_8EntryLoadScene:releaseRes()
	...
	UIBlockMgr.instance:endBlock(Season123_1_8EntryLoadScene.BLOCK_LOAD_RES_KEY)
...
function Season123_1_8EntryLoadScene:getSceneBackgroundUrl()
...
function Season123_1_8EntryLoadScene:onLoadResCompleted(loader)
...
function Season123_1_8EntryLoadScene:showStageRes(targetStage, isOpen)
...
function Season123_1_8EntryLoadScene:hideAllStage()
	for stageId, containerGO in pairs(self._containerDict) do
		gohelper.setActive(containerGO, false)
	end
end

function Season123_1_8EntryLoadScene:showRetailRes(retailSceneId)
...
function Season123_1_8EntryLoadScene:hideAllRetail()
	for index, containerGO in pairs(self._retailContainerDict) do
		gohelper.setActive(containerGO, false)
	end
end

function Season123_1_8EntryLoadScene:createPrefabInst(stage, stageCO, isOpen)
...
function Season123_1_8EntryLoadScene:loadCallback(inst)
...
function Season123_1_8EntryLoadScene:createRetailPrefabInst(retailSceneId)
...
function Season123_1_8EntryLoadScene:onLoadRetailCompleted(loader)
...
function Season123_1_8EntryLoadScene:getIndexByRetailInst(loader)
...
function Season123_1_8EntryLoadScene:getRetailPosByIndex(index)
	return self._retailPosXDict[index], self._retailPosYDict[index]
end

function Season123_1_8EntryLoadScene:playAnim(stage, animName)
...
function Season123_1_8EntryLoadScene:tweenStage(stage, isEnter)
...
function Season123_1_8EntryLoadScene:getSceneFolderPath()
...
function Season123_1_8EntryLoadScene:getDefaultBackgroundPrefab()
	if not Season123EntryModel.instance.activityId then
		local actId = Season123Model.instance:getCurSeasonId()
		local version = Activity123Enum.SeasonResourcePrefix[actId]
...
return Season123_1_8EntryLoadScene
