-- chunkname: @modules/logic/seasonver/act123/view1_8/component/Season123_1_8EntryDrag.lua

module("modules.logic.seasonver.act123.view1_8.component.Season123_1_8EntryDrag", package.seeall)

local Season123_1_8EntryDrag = class("Season123_1_8EntryDrag", UserDataDispose)

function Season123_1_8EntryDrag:init(goFullScreen, tfScene)
	self:__onInit()
...
function Season123_1_8EntryDrag:dispose()
	if self._drag then
...
function Season123_1_8EntryDrag:initBound()
...
function Season123_1_8EntryDrag:onDragBegin(param, pointerEventData)
...
function Season123_1_8EntryDrag:onDragEnd(param, pointerEventData)
	self._dragBeginPos = nil
	self._beginDragPos = nil
end

function Season123_1_8EntryDrag:onDrag(param, pointerEventData)
...
function Season123_1_8EntryDrag:drag(deltaPos)
...
function Season123_1_8EntryDrag:setScenePosDrag(targetPos)
...
function Season123_1_8EntryDrag:setScenePosTween(targetPos, tweenTime, callback, callbackObj)
...
function Season123_1_8EntryDrag:fixTargetPos(targetPos)
...
function Season123_1_8EntryDrag:localMoveDone()
	self._tweenId = nil
end

function Season123_1_8EntryDrag:vectorAdd(v1, v2)
...
function Season123_1_8EntryDrag:getTempPos()
	return self._tempVector
end

function Season123_1_8EntryDrag:killTween()
...
function Season123_1_8EntryDrag:setDragEnabled(value)
	self._dragEnabled = value
end

function Season123_1_8EntryDrag:getDragWorldPos(pointerEventData)
...
function Season123_1_8EntryDrag:handleScreenResize()
	self:initBound()
