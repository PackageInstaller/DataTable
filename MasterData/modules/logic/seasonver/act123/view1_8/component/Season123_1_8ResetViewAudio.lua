-- chunkname: @modules/logic/seasonver/act123/view1_8/component/Season123_1_8ResetViewAudio.lua

module("modules.logic.seasonver.act123.view1_8.component.Season123_1_8ResetViewAudio", package.seeall)

local Season123_1_8ResetViewAudio = class("Season123_1_8ResetViewAudio", LuaCompBase)

function Season123_1_8ResetViewAudio:ctor(param)
	self.scroll = param
...
function Season123_1_8ResetViewAudio:onDragBegin()
	self._isDraging = true
...
function Season123_1_8ResetViewAudio:onDragEnd()
	self:onUpdate()

	self._isDraging = false
end

function Season123_1_8ResetViewAudio:onClickDown()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_start)
end

function Season123_1_8ResetViewAudio:onUpdate()
...
function Season123_1_8ResetViewAudio:_onValueChangeSampleOffset(x)
...
function Season123_1_8ResetViewAudio:_onUpdateRTPCSpeed(x)
...
function Season123_1_8ResetViewAudio:_onValueChangeForStartOrStop(x)
...
function Season123_1_8ResetViewAudio:_onValueChangeCheckReplay(x)
...
function Season123_1_8ResetViewAudio:_resetPlayingStatus(x)
	self._isScrollPlaying = false
	self._scrollingPlayX = x
end

function Season123_1_8ResetViewAudio:dispose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_end)
...
function Season123_1_8ResetViewAudio:onDestroy()
	self.scroll = nil
end

return Season123_1_8ResetViewAudio
