-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8CardPackageView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8CardPackageView", package.seeall)

local Season123_1_8CardPackageView = class("Season123_1_8CardPackageView", BaseView)

function Season123_1_8CardPackageView:onInitView()
...
function Season123_1_8CardPackageView:addEvents()
...
function Season123_1_8CardPackageView:removeEvents()
...
Season123_1_8CardPackageView.hideCardPackageTime = 0.33

function Season123_1_8CardPackageView:_btnopenPackageOnClick()
	self:openCardPackage()
end

function Season123_1_8CardPackageView:_btnopenOnePackageOnClick()
	self:openCardPackage()
end

function Season123_1_8CardPackageView:_btnopenAllPackageOnClick()
...
function Season123_1_8CardPackageView:_onDragBegin(param, pointerEventData)
	self._startPos = pointerEventData.position.x
end

function Season123_1_8CardPackageView:_onDragEnd(param, pointerEventData)
...
function Season123_1_8CardPackageView:_btnskipOnClick()
...
function Season123_1_8CardPackageView:_btnquitOnClick()
	self:closeThis()
end

function Season123_1_8CardPackageView:_btnopenNextOnClick()
	self:openCardPackage()
end

function Season123_1_8CardPackageView:_editableInitView()
...
function Season123_1_8CardPackageView:onOpen()
...
function Season123_1_8CardPackageView:refreshCardPackageUI()
...
function Season123_1_8CardPackageView:showWaitingOpenView()
...
function Season123_1_8CardPackageView:playOpenCardAnim()
	self:refreshCardPackageUI()
...
function Season123_1_8CardPackageView:showCardGetView()
	self:refreshCardGetUI()
	TaskDispatcher.runDelay(self.hideCardPackageView, self, Season123_1_8CardPackageView.hideCardPackageTime)
...
function Season123_1_8CardPackageView:hideCardPackageView()
	gohelper.setActive(self._gocardpackage, false)

	self.hasClickSkip = false
end

function Season123_1_8CardPackageView:refreshCardGetUI()
...
function Season123_1_8CardPackageView:refreshScrollPos()
...
function Season123_1_8CardPackageView:openCardPackage()
	if self.hasClickOpen then
		return
	end
...
function Season123_1_8CardPackageView:stopOpenCardPackageAudio()
...
function Season123_1_8CardPackageView:onClose()
	TaskDispatcher.cancelTask(self.hideCardPackageView, self)
	self:stopOpenCardPackageAudio()
end

function Season123_1_8CardPackageView:onDestroyView()
	Season123CardPackageModel.instance:release()
end

return Season123_1_8CardPackageView
