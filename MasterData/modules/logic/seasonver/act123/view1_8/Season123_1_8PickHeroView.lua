-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8PickHeroView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8PickHeroView", package.seeall)

local Season123_1_8PickHeroView = class("Season123_1_8PickHeroView", BaseView)

function Season123_1_8PickHeroView:onInitView()
...
function Season123_1_8PickHeroView:addEvents()
	self._btnconfirm:AddClickListener(self._btnconfirmOnClick, self)
	self._btncancel:AddClickListener(self._btncancelOnClick, self)
end

function Season123_1_8PickHeroView:removeEvents()
	self._btnconfirm:RemoveClickListener()
	self._btncancel:RemoveClickListener()
end

function Season123_1_8PickHeroView:_btnconfirmOnClick()
	Season123PickHeroController.instance:pickOver()
	self:closeThis()
end

function Season123_1_8PickHeroView:_btncancelOnClick()
	self:closeThis()
end

function Season123_1_8PickHeroView:_editableInitView()
...
function Season123_1_8PickHeroView:onClose()
	return
end

function Season123_1_8PickHeroView:refreshUI()
...
return Season123_1_8PickHeroView
