-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8PickAssistView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8PickAssistView", package.seeall)

local Season123_1_8PickAssistView = class("Season123_1_8PickAssistView", BaseView)

function Season123_1_8PickAssistView:onInitView()
...
function Season123_1_8PickAssistView:addEvents()
...
function Season123_1_8PickAssistView:removeEvents()
...
function Season123_1_8PickAssistView:onBeforeRefreshAssistList()
...
function Season123_1_8PickAssistView:_btnrefreshOnClick()
	Season123PickAssistController.instance:manualRefreshList()
end

function Season123_1_8PickAssistView:_onHeroDetailClick()
...
function Season123_1_8PickAssistView:_btnconfirmOnClick()
	Season123PickAssistController.instance:pickOver()
	self:closeThis()
end

function Season123_1_8PickAssistView:_btnCareerFilterOnClick(career)
...
function Season123_1_8PickAssistView:_editableInitView()
	self:_setFilterBtn()
end

function Season123_1_8PickAssistView:_setFilterBtn()
...
function Season123_1_8PickAssistView:_onInitFilterBtn(obj, careerValue, index)
...
function Season123_1_8PickAssistView:onOpen()
...
function Season123_1_8PickAssistView:showRecommendCareer()
...
function Season123_1_8PickAssistView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_1_8PickAssistView:refreshUI()
	self:refreshCD()
	self:refreshCareerFilterItems()
	self:refreshIsEmpty()
...
function Season123_1_8PickAssistView:refreshCD()
	self._simageprogress.fillAmount = Season123PickAssistController.instance:getRefreshCDRate()
end

function Season123_1_8PickAssistView:refreshCareerFilterItems()
...
function Season123_1_8PickAssistView:refreshIsEmpty()
...
function Season123_1_8PickAssistView:refreshBtnDetail()
	local selectedMO = Season123PickAssistListModel.instance:getSelectedMO()

	gohelper.setActive(self._godetail, selectedMO)
end

function Season123_1_8PickAssistView:onClose()
	TaskDispatcher.cancelTask(self.refreshCD, self)
end

function Season123_1_8PickAssistView:onDestroyView()
	self:disposeCareerItems()
	Season123PickAssistController.instance:onCloseView()
end

function Season123_1_8PickAssistView:disposeCareerItems()
...
return Season123_1_8PickAssistView
