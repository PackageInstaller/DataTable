-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8SettlementView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8SettlementView", package.seeall)

local Season123_1_8SettlementView = class("Season123_1_8SettlementView", BaseViewExtended)

function Season123_1_8SettlementView:onInitView()
...
function Season123_1_8SettlementView:addEvents()
...
function Season123_1_8SettlementView:removeEvents()
...
function Season123_1_8SettlementView:_btnstatOnClick()
	ViewMgr.instance:openView(ViewName.FightStatView)
end

function Season123_1_8SettlementView:_showSettlement()
...
function Season123_1_8SettlementView:_onRewardShow()
	self:_showSettlementReward()
end

function Season123_1_8SettlementView:_dailyShowHero()
	self._heroIndex = 0
...
function Season123_1_8SettlementView:_showHeroItem()
	self._heroIndex = self._heroIndex + 1

	gohelper.setActive(self._heroList[self._heroIndex].viewGO, true)
end

function Season123_1_8SettlementView:_showGetCardView()
	if self.equip_cards then
		self._showTipsFlow = FlowSequence.New()

		self._showTipsFlow:addWork(Season123_1_8SettlementTipsWork.New())
...
function Season123_1_8SettlementView:_onShowTipsFlowDone()
	self.equip_cards = nil
end

function Season123_1_8SettlementView:_checkNewRecord()
...
function Season123_1_8SettlementView:_onCoverDungeonRecordReply(isCover)
...
function Season123_1_8SettlementView:_detectCoverRecord()
...
function Season123_1_8SettlementView:_onBtnCoverRecordClick()
	DungeonRpc.instance:sendCoverDungeonRecordRequest(true)
end

function Season123_1_8SettlementView:_detectAddFriend()
...
function Season123_1_8SettlementView:_onBtnConfirmFriendClick()
	if not FightResultModel.instance.assistUserId then
		local assistUserId = 0
...
function Season123_1_8SettlementView:_onAddAssistFriendReply()
	gohelper.setActive(self._gofriendpart, false)
end

function Season123_1_8SettlementView:_editableInitView()
...
function Season123_1_8SettlementView:_btncloseOnClick()
...
function Season123_1_8SettlementView:onOpen()
	self._startTime = Time.realtimeSinceStartup
...
function Season123_1_8SettlementView:_refreshRound()
...
function Season123_1_8SettlementView:_showSettlementReward()
...
function Season123_1_8SettlementView:_onRewardItemShow(obj, data, index)
	local itemIconGO = gohelper.findChild(obj, "go_prop")
	local receiveGO = gohelper.findChild(obj, "go_receive")

	if data.materilType == MaterialEnum.MaterialType.Season123EquipCard then
		local cardItem = Season123_1_8CelebrityCardItem.New()
...
function Season123_1_8SettlementView:getCurEpisodeRewards()
	local actId = self._battleContext.actId
	local stage = self._battleContext.stage
	local layer = self._battleContext.layer
...
function Season123_1_8SettlementView:_onHeroItemLoaded()
	self._heroList = {}
					...
					if trailDict[i] then
						...
						if trialCo then
							...
							if equip123_dic[hero_uid] then
								...
								local heroItem = self:openSubView(Season123_1_8SettlementHeroItem, self._hero_obj_list[i], nil, is_replay, nil, equip, equip_104, nil, trailDict[i])
						...
						local heroItem = self:openSubView(Season123_1_8SettlementHeroItem, self._hero_obj_list[i], nil, is_replay, hero_uid, equip, equip_104)
...
function Season123_1_8SettlementView:setMainPosCardItemByUid(index, equipUid)
	...
	if not seasonMO.unlockIndexSet[slotIndex] then
		...
		if equipUid and equipUid ~= "0" then
			...
			self:openSubView(Season123_1_8CelebrityCardGetItem, Season123_1_8CelebrityCardItem.AssetPath, goPos, equipUid, true)
		else
...
function Season123_1_8SettlementView:_refreshHeroItemPos()
...
function Season123_1_8SettlementView:_onGetFightRecordGroupReply(fightGroupMO)
	for i = 1, 4 do
		...
		local heroItem = self:openSubView(Season123_1_8SettlementHeroItem, obj, nil, true, hero, equip, equip_104, replay_data)
...
function Season123_1_8SettlementView:setMainPosCardItemById(index, mainEquip)
	local equipId
	...
	if not seasonMO.unlockIndexSet[slotIndex] then
		...
		if equipId and equipId ~= 0 then
			gohelper.setActive(goEmpty, false)
			gohelper.setActive(goPos, true)
			self:openSubView(Season123_1_8CelebrityCardGetItem, Season123_1_8CelebrityCardItem.AssetPath, goPos, nil, nil, equipId)
		else
			gohelper.setActive(goEmpty, true)
			gohelper.setActive(goPos, false)
		end
...
function Season123_1_8SettlementView:_delayClosetip()
	gohelper.setActive(self._gofightsucc, false)
	self:_showSettlement()
end

function Season123_1_8SettlementView:onClose()
...
return Season123_1_8SettlementView
