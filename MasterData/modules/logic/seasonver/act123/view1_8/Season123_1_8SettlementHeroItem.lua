-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8SettlementHeroItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8SettlementHeroItem", package.seeall)

local Season123_1_8SettlementHeroItem = class("Season123_1_8SettlementHeroItem", BaseViewExtended)

function Season123_1_8SettlementHeroItem:onInitView()
...
function Season123_1_8SettlementHeroItem:addEvents()
	return
end

function Season123_1_8SettlementHeroItem:removeEvents()
	return
end

function Season123_1_8SettlementHeroItem:onRefreshViewParam(is_replay, hero, equip, equip_104, replay_data, trail)
...
function Season123_1_8SettlementHeroItem:onOpen()
...
function Season123_1_8SettlementHeroItem:_showNormalData()
	if self._trail then
...
function Season123_1_8SettlementHeroItem:_showTrailHeroIcon(trail)
	if not trail then
		return
	end
...
function Season123_1_8SettlementHeroItem:_showHeroIcon(heroId, skinId)
...
function Season123_1_8SettlementHeroItem:checkAssist(heroUid, heroMO)
	if not heroMO then
...
function Season123_1_8SettlementHeroItem:_showEquipIcon(equip_id)
...
function Season123_1_8SettlementHeroItem:_showEquip123(index, uid, totalEquipCount, equipId)
	if equipId == 0 then
		return
	end
	...
	if totalEquipCount <= 1 then
		if not self._gosingle then
			...
			self:openSubView(Season123_1_8CelebrityCardGetItem, Season123_1_8CelebrityCardItem.AssetPath, parentTran, uid, nil, equipId)
		end
	end
end

function Season123_1_8SettlementHeroItem:_showReplayData()
...
function Season123_1_8SettlementHeroItem:_refreshEquipPos()
	return
end

function Season123_1_8SettlementHeroItem:onClose()
	return
end

function Season123_1_8SettlementHeroItem:onDestroyView()
	self._simageheroicon:UnLoadImage()
end

return Season123_1_8SettlementHeroItem
