-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8TaskItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8TaskItem", package.seeall)

local Season123_1_8TaskItem = class("Season123_1_8TaskItem", ListScrollCell)

Season123_1_8TaskItem.BlockKey = "Season123_1_8TaskItemAni"

function Season123_1_8TaskItem:init(go)
	self._viewGO = go
...
function Season123_1_8TaskItem:addEventListeners()
...
function Season123_1_8TaskItem:initTotal()
	self._btnGetTotal = gohelper.findChildButtonWithAudio(self._goTotal, "#btn_getall")
end

Season123_1_8TaskItem.TaskMaskTime = 0.65
Season123_1_8TaskItem.ColumnCount = 1
Season123_1_8TaskItem.AnimRowCount = 7
Season123_1_8TaskItem.OpenAnimTime = 0.06
Season123_1_8TaskItem.OpenAnimStartTime = 0

function Season123_1_8TaskItem:onUpdateMO(mo)
	if mo == nil then
		return
	end
...
function Season123_1_8TaskItem:endPlayOpenAnim()
...
function Season123_1_8TaskItem:checkPlayAnim()
...
function Season123_1_8TaskItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_1_8TaskItem:refreshNormal()
...
function Season123_1_8TaskItem:refreshReward()
...
function Season123_1_8TaskItem:createRewardItem(index)
...
function Season123_1_8TaskItem:refreshRewardItem(item, data)
	if not data then
	...
	if data.equipId then
		...
		if not item.equipIcon then
			item.equipIcon = Season123_1_8CelebrityCardItem.New()
...
function Season123_1_8TaskItem:getAnimator()
	return self._ani
end

function Season123_1_8TaskItem:destroyRewardItem(item)
...
function Season123_1_8TaskItem:refreshDesc()
	local config = self.mo.config
...
function Season123_1_8TaskItem:refreshProgress()
...
function Season123_1_8TaskItem:refreshState()
...
function Season123_1_8TaskItem:onClickGoto()
...
function Season123_1_8TaskItem:onClickReceive()
	...
	UIBlockMgr.instance:startBlock(Season123_1_8TaskItem.BlockKey)
	Season123Controller.instance:dispatchEvent(Season123Event.OnTaskRewardGetFinish, self._index)
	TaskDispatcher.runDelay(self._onPlayActAniFinished, self, Season123_1_8TaskItem.TaskMaskTime)
end

function Season123_1_8TaskItem:_onPlayActAniFinished()
	...
	UIBlockMgr.instance:endBlock(Season123_1_8TaskItem.BlockKey)
end

function Season123_1_8TaskItem:onClickGetTotal()
	self:onClickReceive()
end

function Season123_1_8TaskItem:onDestroy()
	TaskDispatcher.cancelTask(self._onPlayActAniFinished, self)
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
