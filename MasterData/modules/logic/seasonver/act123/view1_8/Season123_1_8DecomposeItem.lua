-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8DecomposeItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8DecomposeItem", package.seeall)

local Season123_1_8DecomposeItem = class("Season123_1_8DecomposeItem", ListScrollCellExtend)

function Season123_1_8DecomposeItem:init(go)
	Season123_1_8DecomposeItem.super.init(self, go)
...
function Season123_1_8DecomposeItem:addEventListeners()
...
function Season123_1_8DecomposeItem:removeEventListeners()
...
function Season123_1_8DecomposeItem:onUpdateMO(mo)
	self._mo = mo
...
Season123_1_8DecomposeItem.AnimRowCount = 4
Season123_1_8DecomposeItem.OpenAnimTime = 0.06
Season123_1_8DecomposeItem.OpenAnimStartTime = 0.05

function Season123_1_8DecomposeItem:refreshUI()
...
function Season123_1_8DecomposeItem:refreshEquipedHero(heroUid)
...
function Season123_1_8DecomposeItem:checkPlayAnim()
...
function Season123_1_8DecomposeItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_1_8DecomposeItem:checkCreateIcon()
...
function Season123_1_8DecomposeItem:onClickSelf()
...
function Season123_1_8DecomposeItem:showDecomposeEffect()
...
function Season123_1_8DecomposeItem:hideDecomposeEffect()
	gohelper.setActive(self._goDecomposeEffect, false)
end

function Season123_1_8DecomposeItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
...
return Season123_1_8DecomposeItem
