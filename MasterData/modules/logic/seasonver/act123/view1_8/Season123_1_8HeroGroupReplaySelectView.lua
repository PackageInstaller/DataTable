-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8HeroGroupReplaySelectView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8HeroGroupReplaySelectView", package.seeall)

local Season123_1_8HeroGroupReplaySelectView = class("Season123_1_8HeroGroupReplaySelectView", BaseView)

function Season123_1_8HeroGroupReplaySelectView:onInitView()
...
function Season123_1_8HeroGroupReplaySelectView:addEvents()
...
function Season123_1_8HeroGroupReplaySelectView:removeEvents()
	self._btnmultispeed:RemoveClickListener()
	self._btnclosemult:RemoveClickListener()
end

function Season123_1_8HeroGroupReplaySelectView:_editableInitView()
...
function Season123_1_8HeroGroupReplaySelectView:onDestroyView()
	return
end

function Season123_1_8HeroGroupReplaySelectView:onOpen()
	self:initCostIcon()
	self:initMultiGroup()
	self:refreshSelection()
end

function Season123_1_8HeroGroupReplaySelectView:onClose()
	return
end

Season123_1_8HeroGroupReplaySelectView.ItemHeight = 92

function Season123_1_8HeroGroupReplaySelectView:initMultiGroup()
	...
	recthelper.setHeight(self.rectdropbg, Season123_1_8HeroGroupReplaySelectView.ItemHeight * maxTimes)
end

function Season123_1_8HeroGroupReplaySelectView:initMultSpeedItem(go, multispeed, maxTimes)
...
function Season123_1_8HeroGroupReplaySelectView:initCostIcon()
...
function Season123_1_8HeroGroupReplaySelectView:refreshMulti()
...
function Season123_1_8HeroGroupReplaySelectView:onClickSetSpeed(speed)
...
function Season123_1_8HeroGroupReplaySelectView:setMultSpeed(speed)
...
function Season123_1_8HeroGroupReplaySelectView:refreshSelection()
...
function Season123_1_8HeroGroupReplaySelectView:_btnmultispeedOnClick()
	self._isMultiOpen = not self._isMultiOpen

	self:refreshMulti()
end

function Season123_1_8HeroGroupReplaySelectView:_btnclosemultOnClick()
	self._isMultiOpen = false

	self:refreshMulti()
end

return Season123_1_8HeroGroupReplaySelectView
