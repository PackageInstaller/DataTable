-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8ResetView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8ResetView", package.seeall)

local Season123_1_8ResetView = class("Season123_1_8ResetView", BaseView)

function Season123_1_8ResetView:onInitView()
...
function Season123_1_8ResetView:addEvents()
	self._btnreset:AddClickListener(self._btnresetOnClick, self)
end

function Season123_1_8ResetView:removeEvents()
	self._btnreset:RemoveClickListener()
end

function Season123_1_8ResetView:_editableInitView()
	self._heroItems = {}
	self._episodeItems = {}
...
function Season123_1_8ResetView:onDestroyView()
...
function Season123_1_8ResetView:onOpen()
...
function Season123_1_8ResetView:onClose()
	return
end

function Season123_1_8ResetView:refreshUI()
	self:refreshStatus()
	self:refreshStage()
...
function Season123_1_8ResetView:refreshStatus()
...
function Season123_1_8ResetView:refreshStage()
...
function Season123_1_8ResetView:refreshEpisodeItems()
...
function Season123_1_8ResetView:refreshEpisodeItem(index, data)
...
function Season123_1_8ResetView:refreshSingleItemFinished(index, item, data)
...
function Season123_1_8ResetView:refreshHeroItems()
...
function Season123_1_8ResetView:refreshHero(item, data)
	if not data then
...
function Season123_1_8ResetView:refreshHeroHp(item, data)
	if not data then
...
function Season123_1_8ResetView:createStageItem()
...
function Season123_1_8ResetView:getOrCreateEpisodeItem(index)
...
function Season123_1_8ResetView:getOrCreateHeroItem(index)
...
function Season123_1_8ResetView:delayInitScrollAudio()
	self._audioScroll = MonoHelper.addLuaComOnceToGo(self._goscrollchapter, Season123_1_8ResetViewAudio, self._scrollchapter)
...
function Season123_1_8ResetView:onDragAudioBegin()
	self._audioScroll:onDragBegin()
end

function Season123_1_8ResetView:onDragAudioEnd()
	self._audioScroll:onDragEnd()
end

function Season123_1_8ResetView:onClickAudioDown()
	self._audioScroll:onClickDown()
end

function Season123_1_8ResetView:onClickStageItem()
...
function Season123_1_8ResetView:onClickEpisodeItem(index)
...
function Season123_1_8ResetView:_btnresetOnClick()
	Season123ResetController.instance:tryReset()
end

return Season123_1_8ResetView
