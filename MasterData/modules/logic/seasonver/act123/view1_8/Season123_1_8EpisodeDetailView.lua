-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EpisodeDetailView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EpisodeDetailView", package.seeall)

local Season123_1_8EpisodeDetailView = class("Season123_1_8EpisodeDetailView", BaseView)

function Season123_1_8EpisodeDetailView:onInitView()
...
function Season123_1_8EpisodeDetailView:addEvents()
...
function Season123_1_8EpisodeDetailView:removeEvents()
...
function Season123_1_8EpisodeDetailView:_editableInitView()
...
function Season123_1_8EpisodeDetailView:onDestroyView()
...
function Season123_1_8EpisodeDetailView:onOpen()
...
function Season123_1_8EpisodeDetailView:onOpenFinish()
...
function Season123_1_8EpisodeDetailView:onClose()
	TaskDispatcher.cancelTask(self._delayShowInfo, self)
end

function Season123_1_8EpisodeDetailView:handleDetailSwitchLayer(param)
...
function Season123_1_8EpisodeDetailView:_delayShowInfo()
	self:_showInfo()
end

function Season123_1_8EpisodeDetailView:refreshShowInfo()
	self:_showInfo()
end

function Season123_1_8EpisodeDetailView:_btnstartOnClick()
...
function Season123_1_8EpisodeDetailView:resetData()
	self._showLvItems = {}
...
function Season123_1_8EpisodeDetailView:noAudioShowInfoByOpen()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_leimi_theft_open)
	gohelper.setActive(self._goinfo, true)
	self:_showInfo()
end

function Season123_1_8EpisodeDetailView:_showInfo()
	self:_setInfo()
	self:_setParts()
	self:_setButton()
	self:_setResetInfo()
...
function Season123_1_8EpisodeDetailView:_setButton()
...
function Season123_1_8EpisodeDetailView:_setResetInfo()
	local needShowReset = Season123EpisodeDetailController.instance:isStageNeedClean() or Season123EpisodeDetailController.instance:isNextLayersNeedClean()
...
Season123_1_8EpisodeDetailView.NomalStageTagPos = Vector2(46.3, 2.7)
Season123_1_8EpisodeDetailView.NewStageTagPos = Vector2(4.37, 2.7)

function Season123_1_8EpisodeDetailView:_setInfo()
	local actId = Season123EpisodeDetailModel.instance.activityId
	local stage = Season123EpisodeDetailModel.instance.stage
	local layer = Season123EpisodeDetailModel.instance.layer
	...
	if isNewStage then
		if not Season123_1_8EpisodeDetailView.NewStageTagPos then
			local targetStageTagPos = Season123_1_8EpisodeDetailView.NomalStageTagPos
...
function Season123_1_8EpisodeDetailView:refreshEquipCardItem()
	...
	if episodeCo.firstPassEquipId and episodeCo.firstPassEquipId > 0 then
		...
		if not self._rewardItems[1].itemIcon then
			self._rewardItems[1].itemIcon = Season123_1_8CelebrityCardItem.New()
...
function Season123_1_8EpisodeDetailView:createRewardItem(index)
...
function Season123_1_8EpisodeDetailView:refreshRewardItem(item, itemInfo)
...
function Season123_1_8EpisodeDetailView:_setParts()
	local actId = Season123EpisodeDetailModel.instance.activityId
	local stage = Season123EpisodeDetailModel.instance.stage
	local layer = Season123EpisodeDetailModel.instance.layer
	local episodeCo = Season123Config.instance:getSeasonEpisodeCo(actId, stage, layer)
...
Season123_1_8EpisodeDetailView.UnLockStageItemAlpha = 1
Season123_1_8EpisodeDetailView.LockStageItemAlpha = 0.3

function Season123_1_8EpisodeDetailView:_showPartStarGroupItem(starGroup)
	if starGroup < 7 then
		...
		for i = 1, 6 do
			...
			if i <= starGroup then
				self._partStageItems[i].canvasgroup.alpha = Season123_1_8EpisodeDetailView.UnLockStageItemAlpha or Season123_1_8EpisodeDetailView.LockStageItemAlpha
			end
		end
	else
		for i = 1, 7 do
...
function Season123_1_8EpisodeDetailView:_btnlastOnClick()
...
function Season123_1_8EpisodeDetailView:_btnnextOnClick()
...
function Season123_1_8EpisodeDetailView:_btnresetOnClick()
...
return Season123_1_8EpisodeDetailView
