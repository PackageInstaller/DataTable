-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8ShowHeroView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8ShowHeroView", package.seeall)

local Season123_1_8ShowHeroView = class("Season123_1_8ShowHeroView", BaseView)

function Season123_1_8ShowHeroView:onInitView()
...
function Season123_1_8ShowHeroView:addEvents()
...
function Season123_1_8ShowHeroView:removeEvents()
...
function Season123_1_8ShowHeroView:_editableInitView()
	self._heroItems = {}
end

function Season123_1_8ShowHeroView:onDestroyView()
...
function Season123_1_8ShowHeroView:onOpen()
...
function Season123_1_8ShowHeroView:onClose()
	if self._heroItems then
		for index, item in pairs(self._heroItems) do
...
function Season123_1_8ShowHeroView:getOrCreateItem(index)
	local item = self._heroItems[index]

	if not item then
		item = self:getUserDataTb_()
		item.go = gohelper.cloneInPlace(self._goitem, "item_" .. tostring(index))
		item.component = Season123_1_8ShowHeroItem.New()
...
function Season123_1_8ShowHeroView:_btndetailsOnClick()
...
function Season123_1_8ShowHeroView:_btnresetOnClick()
	Season123ShowHeroController.instance:openReset()
end

function Season123_1_8ShowHeroView:_btncloseOnClick()
	self:closeThis()
end

function Season123_1_8ShowHeroView:handleEnterStageSuccess()
...
return Season123_1_8ShowHeroView
