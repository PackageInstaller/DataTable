-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EpisodeRewardView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EpisodeRewardView", package.seeall)

local Season123_1_8EpisodeRewardView = class("Season123_1_8EpisodeRewardView", BaseView)

function Season123_1_8EpisodeRewardView:onInitView()
...
function Season123_1_8EpisodeRewardView:addEvents()
...
function Season123_1_8EpisodeRewardView:removeEvents()
...
function Season123_1_8EpisodeRewardView:_btnCloseOnClick()
	self:resetView()
end

function Season123_1_8EpisodeRewardView:_editableInitView()
...
function Season123_1_8EpisodeRewardView:onOpen()
	self.actId = self.viewParam.actId
	self.stage = self.viewParam.stage
	self.targetNumList = {}
end

function Season123_1_8EpisodeRewardView:refreshUI()
...
function Season123_1_8EpisodeRewardView:createAndRefreshRewardItem()
	gohelper.CreateObjList(self, self.rewardItemShow, self.itemList, self._gorewardContent, self._gorewardItem)
end

function Season123_1_8EpisodeRewardView:rewardItemShow(obj, data, index)
...
function Season123_1_8EpisodeRewardView:onItemGetClick()
...
function Season123_1_8EpisodeRewardView:refreshProgressBar()
...
function Season123_1_8EpisodeRewardView:initTargetNumList()
...
function Season123_1_8EpisodeRewardView:refreshScrollPos()
	local itemWidth = 240
	local itemSpaceH = 36
...
function Season123_1_8EpisodeRewardView:getCurCanGetIndex()
...
function Season123_1_8EpisodeRewardView:resetView()
	gohelper.setActive(self._goRwards, false)
end

function Season123_1_8EpisodeRewardView:onClose()
	return
end

function Season123_1_8EpisodeRewardView:onDestroyView()
...
return Season123_1_8EpisodeRewardView
