-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8StoreItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8StoreItem", package.seeall)

local Season123_1_8StoreItem = class("Season123_1_8StoreItem", ListScrollCell)

function Season123_1_8StoreItem:init(go)
	self.go = go
...
function Season123_1_8StoreItem:onClick()
...
function Season123_1_8StoreItem:onUpdateMO(data)
	self.data = data
...
function Season123_1_8StoreItem:refreshRemainBuyCount()
...
function Season123_1_8StoreItem:refreshTag()
