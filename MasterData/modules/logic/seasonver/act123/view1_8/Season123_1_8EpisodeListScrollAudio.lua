-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EpisodeListScrollAudio.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EpisodeListScrollAudio", package.seeall)

local Season123_1_8EpisodeListScrollAudio = class("Season123_1_8EpisodeListScrollAudio", LuaCompBase)

function Season123_1_8EpisodeListScrollAudio:ctor(param)
	self.scroll = param
...
function Season123_1_8EpisodeListScrollAudio:onDragBegin()
	self._isDraging = true
...
function Season123_1_8EpisodeListScrollAudio:onDragEnd()
	self:onUpdate()

	self._isDraging = false
end

function Season123_1_8EpisodeListScrollAudio:onClickDown()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_start)
end

function Season123_1_8EpisodeListScrollAudio:onUpdate()
...
function Season123_1_8EpisodeListScrollAudio:_onValueChangeSampleOffset(y)
...
function Season123_1_8EpisodeListScrollAudio:_onUpdateRTPCSpeed(y)
...
function Season123_1_8EpisodeListScrollAudio:_onValueChangeForStartOrStop(y)
...
function Season123_1_8EpisodeListScrollAudio:_onValueChangeCheckReplay(y)
...
function Season123_1_8EpisodeListScrollAudio:_resetPlayingStatus(y)
	self._isScrollPlaying = false
	self._scrollingPlayY = y
end

function Season123_1_8EpisodeListScrollAudio:dispose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_checkpoint_chain_end)
...
function Season123_1_8EpisodeListScrollAudio:onDestroy()
	self.scroll = nil
end

return Season123_1_8EpisodeListScrollAudio
