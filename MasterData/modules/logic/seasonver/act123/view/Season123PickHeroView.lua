-- chunkname: @modules/logic/seasonver/act123/view/Season123PickHeroView.lua

module("modules.logic.seasonver.act123.view.Season123PickHeroView", package.seeall)

local Season123PickHeroView = class("Season123PickHeroView", BaseView)

function Season123PickHeroView:onInitView()
...
function Season123PickHeroView:addEvents()
	self._btnconfirm:AddClickListener(self._btnconfirmOnClick, self)
	self._btncancel:AddClickListener(self._btncancelOnClick, self)
end

function Season123PickHeroView:removeEvents()
	self._btnconfirm:RemoveClickListener()
	self._btncancel:RemoveClickListener()
end

function Season123PickHeroView:_btnconfirmOnClick()
	Season123PickHeroController.instance:pickOver()
	self:closeThis()
end

function Season123PickHeroView:_btncancelOnClick()
	self:closeThis()
end

function Season123PickHeroView:_editableInitView()
...
function Season123PickHeroView:onClose()
	return
end

function Season123PickHeroView:refreshUI()
