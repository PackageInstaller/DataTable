-- chunkname: @modules/logic/seasonver/act123/view/Season123EnemyView.lua

module("modules.logic.seasonver.act123.view.Season123EnemyView", package.seeall)

local Season123EnemyView = class("Season123EnemyView", BaseView)

function Season123EnemyView:onInitView()
...
function Season123EnemyView:addEvents()
...
function Season123EnemyView:removeEvents()
...
function Season123EnemyView:_editableInitView()
...
function Season123EnemyView:onDestroyView()
...
function Season123EnemyView:onOpen()
...
function Season123EnemyView:onClose()
...
function Season123EnemyView:handleClickMonster()
	self:refreshMonsterSelect()
	self:refreshEnemyInfo()
end

function Season123EnemyView:_onClickClosePassiveView()
	gohelper.setActive(self._gobuffpassiveview, false)

	self.isopenpassiveview = false
end

function Season123EnemyView:refreshUI()
...
function Season123EnemyView:getOrCreateGroupItem(i)
...
function Season123EnemyView:refreshEnemyGroup(i, monsterGroupIds, enemyGroupItemTable)
	local isBoss = false
...
function Season123EnemyView:getOrCreateEnemyItem(itemGroup, groupIndex, itemIndex)
...
function Season123EnemyView:onClickMonsterIcon(clickInfo)
...
function Season123EnemyView:refreshEnemyItem(enemyItemTable, monsterId, groupIndex)
	local monsterConfig = lua_monster.configDict[monsterId]
	local skinConfig = FightConfig.instance:getSkinCO(monsterConfig.skinId)
...
function Season123EnemyView:refreshMonsterSelect()
	local monsterGroupIds = Season123EnemyModel.instance:getCurrentBattleGroupIds()
...
function Season123EnemyView:refreshEnemyInfo()
...
function Season123EnemyView:_refreshSpeicalSkillIcon(monsterConfig)
...
function Season123EnemyView:_onBuffPassiveSkillClick()
...
function Season123EnemyView:_setPassiveSkillTip(skillgo, skillInfo)
...
function Season123EnemyView:_refreshPassiveSkill(monsterConfig, groupIndex)
...
function Season123EnemyView:_refreshSkill(monsterConfig)
	local skillIds = {}
...
function Season123EnemyView:_refreshSuper(monsterConfig)
...
function Season123EnemyView:createSuperItem()
...
function Season123EnemyView:_refreshAttribute(monsterConfig)
...
function Season123EnemyView:_onMonsterAttrItemShow(obj, data, index)
...
function Season123EnemyView:_onClickShowAttribute()
