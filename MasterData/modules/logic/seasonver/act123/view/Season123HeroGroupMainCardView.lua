-- chunkname: @modules/logic/seasonver/act123/view/Season123HeroGroupMainCardView.lua

module("modules.logic.seasonver.act123.view.Season123HeroGroupMainCardView", package.seeall)

local Season123HeroGroupMainCardView = class("Season123HeroGroupMainCardView", BaseView)

function Season123HeroGroupMainCardView:onInitView()
...
function Season123HeroGroupMainCardView:addEvents()
	return
end

function Season123HeroGroupMainCardView:removeEvents()
	return
end

function Season123HeroGroupMainCardView:_editableInitView()
...
function Season123HeroGroupMainCardView:onDestroyView()
...
function Season123HeroGroupMainCardView:onOpen()
...
function Season123HeroGroupMainCardView:onClose()
	return
end

function Season123HeroGroupMainCardView:refreshMainCards()
	for slot = 1, Activity123Enum.MainCardNum do
		self:_refreshMainCard(slot)
	end
end

function Season123HeroGroupMainCardView:_refreshMainCard(slot)
	...
	if act104EquipId and act104EquipId ~= 0 then
		if not cardItem then
			cardItem = Season123CelebrityCardItem.New()
...
function Season123HeroGroupMainCardView:_btnseasonsupercardOnClick(slot)
...
return Season123HeroGroupMainCardView
