-- chunkname: @modules/logic/seasonver/act123/view/Season123PickAssistView.lua

module("modules.logic.seasonver.act123.view.Season123PickAssistView", package.seeall)

local Season123PickAssistView = class("Season123PickAssistView", BaseView)

function Season123PickAssistView:onInitView()
...
function Season123PickAssistView:addEvents()
...
function Season123PickAssistView:removeEvents()
...
function Season123PickAssistView:onBeforeRefreshAssistList()
...
function Season123PickAssistView:_btnrefreshOnClick()
	Season123PickAssistController.instance:manualRefreshList()
end

function Season123PickAssistView:_onHeroDetailClick()
...
function Season123PickAssistView:_btnconfirmOnClick()
	Season123PickAssistController.instance:pickOver()
	self:closeThis()
end

function Season123PickAssistView:_btnCareerFilterOnClick(career)
...
function Season123PickAssistView:_editableInitView()
	self:_setFilterBtn()
end

function Season123PickAssistView:_setFilterBtn()
...
function Season123PickAssistView:_onInitFilterBtn(obj, careerValue, index)
...
function Season123PickAssistView:onOpen()
...
function Season123PickAssistView:showRecommendCareer()
...
function Season123PickAssistView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123PickAssistView:refreshUI()
	self:refreshCD()
	self:refreshCareerFilterItems()
	self:refreshIsEmpty()
...
function Season123PickAssistView:refreshCD()
	self._simageprogress.fillAmount = Season123PickAssistController.instance:getRefreshCDRate()
end

function Season123PickAssistView:refreshCareerFilterItems()
...
function Season123PickAssistView:refreshIsEmpty()
...
function Season123PickAssistView:refreshBtnDetail()
	local selectedMO = Season123PickAssistListModel.instance:getSelectedMO()

	gohelper.setActive(self._godetail, selectedMO)
end

function Season123PickAssistView:onClose()
	TaskDispatcher.cancelTask(self.refreshCD, self)
end

function Season123PickAssistView:onDestroyView()
	self:disposeCareerItems()
	Season123PickAssistController.instance:onCloseView()
end

function Season123PickAssistView:disposeCareerItems()
...
return Season123PickAssistView
