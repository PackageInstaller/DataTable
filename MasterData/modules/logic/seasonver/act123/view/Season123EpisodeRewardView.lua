-- chunkname: @modules/logic/seasonver/act123/view/Season123EpisodeRewardView.lua

module("modules.logic.seasonver.act123.view.Season123EpisodeRewardView", package.seeall)

local Season123EpisodeRewardView = class("Season123EpisodeRewardView", BaseView)

function Season123EpisodeRewardView:onInitView()
...
function Season123EpisodeRewardView:addEvents()
...
function Season123EpisodeRewardView:removeEvents()
...
function Season123EpisodeRewardView:_btnCloseOnClick()
	self:resetView()
end

function Season123EpisodeRewardView:_editableInitView()
...
function Season123EpisodeRewardView:onOpen()
	self.actId = self.viewParam.actId
	self.stage = self.viewParam.stage
	self.targetNumList = {}
end

function Season123EpisodeRewardView:refreshUI()
...
function Season123EpisodeRewardView:createAndRefreshRewardItem()
	gohelper.CreateObjList(self, self.rewardItemShow, self.itemList, self._gorewardContent, self._gorewardItem)
end

function Season123EpisodeRewardView:rewardItemShow(obj, data, index)
...
function Season123EpisodeRewardView:onItemGetClick()
...
function Season123EpisodeRewardView:refreshProgressBar()
...
function Season123EpisodeRewardView:initTargetNumList()
...
function Season123EpisodeRewardView:refreshScrollPos()
	local itemWidth = 240
	local itemSpaceH = 36
...
function Season123EpisodeRewardView:getCurCanGetIndex()
...
function Season123EpisodeRewardView:resetView()
	gohelper.setActive(self._goRwards, false)
end

function Season123EpisodeRewardView:onClose()
	return
end

function Season123EpisodeRewardView:onDestroyView()
...
return Season123EpisodeRewardView
