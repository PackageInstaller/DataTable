-- chunkname: @modules/logic/seasonver/act123/view/Season123HeroGroupEditItem.lua

module("modules.logic.seasonver.act123.view.Season123HeroGroupEditItem", package.seeall)

local Season123HeroGroupEditItem = class("Season123HeroGroupEditItem", ListScrollCell)

function Season123HeroGroupEditItem:init(go)
...
function Season123HeroGroupEditItem:_initObj(go)
...
function Season123HeroGroupEditItem:addEventListeners()
...
function Season123HeroGroupEditItem:removeEventListeners()
	return
end

function Season123HeroGroupEditItem:_onSkinChanged()
	self._heroItem:updateHero()
end

function Season123HeroGroupEditItem:_onAttributeChanged(level, heroId)
	self._heroItem:setLevel(level, heroId)
end

function Season123HeroGroupEditItem:setAdventureBuff(buffId)
	self._heroItem:setAdventureBuff(buffId)
end

function Season123HeroGroupEditItem:updateLimitStatus()
...
function Season123HeroGroupEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123HeroGroupEditItem:refreshHp()
...
function Season123HeroGroupEditItem:refreshDead()
	if Season123HeroGroupModel.instance:isEpisodeSeason123() then
		local isDead = false
		local actId = Season123HeroGroupEditModel.instance.activityId
		local stage = Season123HeroGroupEditModel.instance.stage
...
function Season123HeroGroupEditItem:onSelect(select)
...
function Season123HeroGroupEditItem:_onItemClick()
...
function Season123HeroGroupEditItem:checkRestrict(heroUid)
...
function Season123HeroGroupEditItem:checkHpZero(heroUid)
	local actId = Season123HeroGroupEditModel.instance.activityId
	local stage = Season123HeroGroupEditModel.instance.stage
	local layer = Season123HeroGroupEditModel.instance.layer
...
function Season123HeroGroupEditItem:enableDeselect(enable)
	self._enableDeselect = enable
end

function Season123HeroGroupEditItem:setHp(hpRate)
...
function Season123HeroGroupEditItem:onDestroy()
	return
end

function Season123HeroGroupEditItem:getAnimator()
	return self._animator
end

return Season123HeroGroupEditItem
