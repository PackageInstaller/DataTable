-- chunkname: @modules/logic/seasonver/act123/view/Season123RetailView.lua

module("modules.logic.seasonver.act123.view.Season123RetailView", package.seeall)

local Season123RetailView = class("Season123RetailView", BaseView)

function Season123RetailView:onInitView()
...
function Season123RetailView:addEvents()
...
function Season123RetailView:onOpen()
...
function Season123RetailView:onClose()
	return
end

function Season123RetailView:refreshUI()
	self:refreshInfo()
...
function Season123RetailView:refreshInfo()
...
function Season123RetailView:initIconUI()
...
function Season123RetailView:refreshRecommendLv()
...
function Season123RetailView:refreshRewards()
...
function Season123RetailView:refreshCardPackageUI()
...
function Season123RetailView:getOrCreateRewardItem(index)
...
function Season123RetailView:refreshTicket()
...
function Season123RetailView:handleItemChanged()
	self:refreshCardPackageUI()
	self:refreshTicket()
end

function Season123RetailView:_btncelebrityOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

function Season123RetailView:_btncardsOnClick()
	Season123Controller.instance:openSeasonCardPackageView({
		actId = self.viewParam.actId
	})
end

function Season123RetailView:onClickIcon(index)
...
function Season123RetailView:_btnstartOnClick()
	Season123RetailController.instance:enterRetailFightScene()
end

return Season123RetailView
