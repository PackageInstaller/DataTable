-- chunkname: @modules/logic/seasonver/act123/view/Season123EnemyRule.lua

module("modules.logic.seasonver.act123.view.Season123EnemyRule", package.seeall)

local Season123EnemyRule = class("Season123EnemyRule", BaseView)

function Season123EnemyRule:onInitView()
...
function Season123EnemyRule:addEvents()
...
function Season123EnemyRule:removeEvents()
	self._btnadditionRuleclick:RemoveClickListener()
	self._btncloserule:RemoveClickListener()
end

function Season123EnemyRule:_btncloseruleOnClick()
...
function Season123EnemyRule:_btnadditionRuleOnClick()
	self._ruleItemClick = self._goruledesc.activeSelf

	gohelper.setActive(self._goruledesc, true)
end

function Season123EnemyRule:_editableInitView()
...
function Season123EnemyRule:_addRuleItem(ruleCo, targetId)
...
function Season123EnemyRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season123EnemyRule:_clear()
...
function Season123EnemyRule:onDestroyView()
	self:_clear()
end

return Season123EnemyRule
