-- chunkname: @modules/logic/seasonver/act123/view/Season123HeroGroupReplaySelectView.lua

module("modules.logic.seasonver.act123.view.Season123HeroGroupReplaySelectView", package.seeall)

local Season123HeroGroupReplaySelectView = class("Season123HeroGroupReplaySelectView", BaseView)

function Season123HeroGroupReplaySelectView:onInitView()
...
function Season123HeroGroupReplaySelectView:addEvents()
...
function Season123HeroGroupReplaySelectView:removeEvents()
	self._btnmultispeed:RemoveClickListener()
	self._btnclosemult:RemoveClickListener()
end

function Season123HeroGroupReplaySelectView:_editableInitView()
...
function Season123HeroGroupReplaySelectView:onDestroyView()
	return
end

function Season123HeroGroupReplaySelectView:onOpen()
	self:initCostIcon()
	self:initMultiGroup()
	self:refreshSelection()
end

function Season123HeroGroupReplaySelectView:onClose()
	return
end

Season123HeroGroupReplaySelectView.ItemHeight = 92

function Season123HeroGroupReplaySelectView:initMultiGroup()
	...
	recthelper.setHeight(self.rectdropbg, Season123HeroGroupReplaySelectView.ItemHeight * maxTimes)
end

function Season123HeroGroupReplaySelectView:initMultSpeedItem(go, multispeed, maxTimes)
...
function Season123HeroGroupReplaySelectView:initCostIcon()
...
function Season123HeroGroupReplaySelectView:refreshMulti()
...
function Season123HeroGroupReplaySelectView:onClickSetSpeed(speed)
...
function Season123HeroGroupReplaySelectView:setMultSpeed(speed)
...
function Season123HeroGroupReplaySelectView:refreshSelection()
...
function Season123HeroGroupReplaySelectView:_btnmultispeedOnClick()
	self._isMultiOpen = not self._isMultiOpen

	self:refreshMulti()
end

function Season123HeroGroupReplaySelectView:_btnclosemultOnClick()
	self._isMultiOpen = false

	self:refreshMulti()
end

return Season123HeroGroupReplaySelectView
