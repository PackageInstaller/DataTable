-- chunkname: @modules/logic/seasonver/act123/view/Season123ShowHeroView.lua

module("modules.logic.seasonver.act123.view.Season123ShowHeroView", package.seeall)

local Season123ShowHeroView = class("Season123ShowHeroView", BaseView)

function Season123ShowHeroView:onInitView()
...
function Season123ShowHeroView:addEvents()
...
function Season123ShowHeroView:removeEvents()
...
function Season123ShowHeroView:_editableInitView()
	self._heroItems = {}
end

function Season123ShowHeroView:onDestroyView()
...
function Season123ShowHeroView:onOpen()
...
function Season123ShowHeroView:onClose()
	if self._heroItems then
		for index, item in pairs(self._heroItems) do
...
function Season123ShowHeroView:_btndetailsOnClick()
...
function Season123ShowHeroView:_btnresetOnClick()
	Season123ShowHeroController.instance:openReset()
end

function Season123ShowHeroView:_btncloseOnClick()
	self:closeThis()
end

function Season123ShowHeroView:handleEnterStageSuccess()
