-- chunkname: @modules/logic/seasonver/act123/view/component/Season123EntryDrag.lua

module("modules.logic.seasonver.act123.view.component.Season123EntryDrag", package.seeall)

local Season123EntryDrag = class("Season123EntryDrag", UserDataDispose)

function Season123EntryDrag:init(goFullScreen, tfScene)
	self:__onInit()
...
function Season123EntryDrag:dispose()
	if self._drag then
...
function Season123EntryDrag:initBound()
...
function Season123EntryDrag:onDragBegin(param, pointerEventData)
...
function Season123EntryDrag:onDragEnd(param, pointerEventData)
	self._dragBeginPos = nil
	self._beginDragPos = nil
end

function Season123EntryDrag:onDrag(param, pointerEventData)
...
function Season123EntryDrag:drag(deltaPos)
...
function Season123EntryDrag:setScenePosDrag(targetPos)
...
function Season123EntryDrag:setScenePosTween(targetPos, tweenTime, callback, callbackObj)
...
function Season123EntryDrag:fixTargetPos(targetPos)
...
function Season123EntryDrag:localMoveDone()
	self._tweenId = nil
end

function Season123EntryDrag:vectorAdd(v1, v2)
...
function Season123EntryDrag:getTempPos()
	return self._tempVector
end

function Season123EntryDrag:killTween()
...
function Season123EntryDrag:setDragEnabled(value)
	self._dragEnabled = value
end

function Season123EntryDrag:getDragWorldPos(pointerEventData)
...
function Season123EntryDrag:handleScreenResize()
	self:initBound()
