-- chunkname: @modules/logic/seasonver/act123/view/Season123PickHeroEntryView.lua

module("modules.logic.seasonver.act123.view.Season123PickHeroEntryView", package.seeall)

local Season123PickHeroEntryView = class("Season123PickHeroEntryView", BaseView)

function Season123PickHeroEntryView:onInitView()
...
function Season123PickHeroEntryView:addEvents()
...
function Season123PickHeroEntryView:removeEvents()
...
function Season123PickHeroEntryView:_editableInitView()
	self._heroItems = {}
	self._careerItems = {}
end

function Season123PickHeroEntryView:onDestroyView()
...
function Season123PickHeroEntryView:onOpen()
...
function Season123PickHeroEntryView:onClose()
	return
end

function Season123PickHeroEntryView:refreshUI()
	self:refreshItems()
	self:refreshButton()
	self:refreshRecommendCareer()
end

function Season123PickHeroEntryView:refreshButton()
...
function Season123PickHeroEntryView:refreshItems()
...
function Season123PickHeroEntryView:getOrCreateItem(index)
	local item = self._heroItems[index]

	if not item then
		item = self:getUserDataTb_()
		item.go = gohelper.cloneInPlace(self._goitem, "item_" .. tostring(index))
		item.component = Season123PickHeroEntryItem.New()
...
function Season123PickHeroEntryView:refreshRecommendCareer()
...
function Season123PickHeroEntryView:getOrCreateCareer(index)
...
function Season123PickHeroEntryView:_btnstartOnClick()
	Season123PickHeroEntryController.instance:sendEnterStage()
end

function Season123PickHeroEntryView:_btncloseOnClick()
	self:closeThis()
end

function Season123PickHeroEntryView:_btndetailsOnClick()
...
function Season123PickHeroEntryView:handleEnterStageSuccess()
...
return Season123PickHeroEntryView
