-- chunkname: @modules/logic/store/view/decorate/DecorateStoreSkinListItem.lua

module("modules.logic.store.view.decorate.DecorateStoreSkinListItem", package.seeall)
...
function DecorateStoreSkinListItem:addEventListeners()
	self.addClickCb(self, self.btnClick, self.onClickItem, self)
end
