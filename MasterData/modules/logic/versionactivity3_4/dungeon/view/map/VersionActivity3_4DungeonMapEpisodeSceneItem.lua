-- chunkname: @modules/logic/versionactivity3_4/dungeon/view/map/VersionActivity3_4DungeonMapEpisodeSceneItem.lua

module("modules.logic.versionactivity3_4.dungeon.view.map.VersionActivity3_4DungeonMapEpisodeSceneItem", package.seeall)

local VersionActivity3_4DungeonMapEpisodeSceneItem = class("VersionActivity3_4DungeonMapEpisodeSceneItem", BaseChildView)

function VersionActivity3_4DungeonMapEpisodeSceneItem:onInitView()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:addEvents()
	...
	self.addEventCb(self, VersionActivityFixedDungeonController.instance, VersionActivity3_4DungeonEvent.V3a2CameraSizeChange, self._onCameraSizeChange, self)
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:removeEvents()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:_onCameraSizeChange()
	self._uiFollower = self._uiFollower or self.viewGO:GetComponent(typeof(ZProj.UIFollower))

	self._uiFollower:ForceUpdate()
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:onClick()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:_editableInitView()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:_showEye()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:initViewParam()
	self._contentTransform = self.viewParam[1]
	self._layout = self.viewParam[2]
	self._mapSceneView = self.viewContainer.mapScene
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:onUpdateParam()
	self:initViewParam()
	self:_showAllElementTipView()
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:onOpen()
	self:initViewParam()
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:getMapAllElementList()
	return (VersionActivityFixedDungeonModel.instance:getElementCoList(self._map.id))
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:_showAllElementTipView()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:_hideAllElementTip()
	gohelper.setActive(self._gotipcontent, false)
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:refresh(config, dungeonMo)
	self._config = config
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshUI()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshLock()
	self.isLock = self:checkLock()

	gohelper.setActive(self.goLock, self:checkLock())
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:initElementIdList()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:clearElementIdList()
	self.elementIdList = nil
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:checkLock()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshStar()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshFlag()
	gohelper.setActive(self._goflag, false)
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshUnlockContent()
	if self.pass then
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshHardModeStar()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshStoryModeStar()
	local starItem
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshEpisodeStar(starItem, episodeId)
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:refreshFocusStatus()
	gohelper.setActive(self.goSelected, self._config.id == self.activityDungeonMo.episodeId)
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:beginShowRewardView()
	self.beginReward = true
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:endShowRewardView()
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:calculatePosInContent()
	...
	if self.elementItemList then
		if not (#self.elementItemList * 20) then
			...
			if self.starItemList then
				if not #self.starItemList then
					local starCount = 1
					local starWidth = starCount * 70 + 80 - nameWidth - elementWidth
					local oversize = math.max(starWidth, halfWidth2)

					if oversize > 0 then
						if not (halfWidth1 + oversize) then
							local width = halfWidth1
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:setImage(image, light, episodeId)
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:getMaxWidth()
	return self._maxWidth
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:updateSelectStatus(selectedItem, ignoreAni)
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:onRemoveElement(elementId)
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:playUnLockAnimation()
	local animator = self.goLock:GetComponent(typeof(UnityEngine.Animator))

	animator.enabled = true
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:playAnimation(animationName)
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:getEpisodeId()
	return self._config and self._config.id
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:createStarItem(goStar)
...
function VersionActivity3_4DungeonMapEpisodeSceneItem:onClose()
	TaskDispatcher.cancelTask(self._hideAllElementTip, self)
end

function VersionActivity3_4DungeonMapEpisodeSceneItem:onDestroyView()
	self.goClick:RemoveClickListener()
end

return VersionActivity3_4DungeonMapEpisodeSceneItem
