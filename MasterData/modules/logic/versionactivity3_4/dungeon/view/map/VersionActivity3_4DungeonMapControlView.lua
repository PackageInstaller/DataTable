...
function VersionActivity3_4DungeonMapControlView:_updateTimeline(isOpenMapLevelView)
	...
	if showMapEpisodeList then
		VersionActivity3_4DungeonEnum.DungeonMapCameraSize = zoomInCameraSize or normalCameraSize
	end
...
function VersionActivity3_4DungeonMapControlView:_tweenCameraSize()
	...
	self.tweenId = ZProj.TweenHelper.DOTweenFloat(currentCameraSize, targetCameraSize, (ViewMgr.instance:isOpen(ViewName.VersionActivity3_4DungeonMapLevelView) or nil) and fastTweenTime, self.tweenFrameCallback, self.tweenFinishCallback, self)
end
