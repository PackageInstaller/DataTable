-- chunkname: @modules/logic/versionactivity3_4/dungeon/view/map/VersionActivity3_4DungeonMapElementReward.lua

module("modules.logic.versionactivity3_4.dungeon.view.map.VersionActivity3_4DungeonMapElementReward", package.seeall)

local VersionActivity3_4DungeonMapElementReward = class("VersionActivity3_4DungeonMapElementReward", DungeonMapElementReward)

function VersionActivity3_4DungeonMapElementReward:_OnRemoveElement(id)
	...
	if config.fragment > 0 then
		...
		elseif config.type == DungeonEnum.ElementType.SpStory then
			...
			self._lastViewName = config.type == DungeonEnum.ElementType.Investigate and ViewName.InvestigateTipsView or ViewName.VersionActivity3_4DungeonFragmentInfoView
		end
...
return VersionActivity3_4DungeonMapElementReward
