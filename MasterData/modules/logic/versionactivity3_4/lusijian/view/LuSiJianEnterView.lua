-- chunkname: @modules/logic/versionactivity3_4/lusijian/view/LuSiJianEnterView.lua

module("modules.logic.versionactivity3_4.lusijian.view.LuSiJianEnterView", package.seeall)

local LuSiJianEnterView = class("LuSiJianEnterView", BaseView)

function LuSiJianEnterView:onInitView()
...
function LuSiJianEnterView:addEvents()
...
function LuSiJianEnterView:removeEvents()
...
function LuSiJianEnterView:_editableInitView()
...
function LuSiJianEnterView:onOpen()
...
function LuSiJianEnterView:_enterGame()
	...
	if string.nilorempty(condition) then
		LuSiJianController.instance:enterLevelView()
	else
...
function LuSiJianEnterView:_clickLock()
...
function LuSiJianEnterView:_btnitemOnClick()
	return
end

function LuSiJianEnterView:_btnTrialOnClick()
...
function LuSiJianEnterView:everySecondCall()
	self:_refreshTime()
end

function LuSiJianEnterView:_refreshTime()
...
function LuSiJianEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function LuSiJianEnterView:onDestroyView()
	return
end

return LuSiJianEnterView
