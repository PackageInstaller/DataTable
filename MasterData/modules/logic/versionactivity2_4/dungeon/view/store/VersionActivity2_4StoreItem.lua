-- chunkname: @modules/logic/versionactivity2_4/dungeon/view/store/VersionActivity2_4StoreItem.lua

module("modules.logic.versionactivity2_4.dungeon.view.store.VersionActivity2_4StoreItem", package.seeall)

local VersionActivity2_4StoreItem = class("VersionActivity2_4StoreItem", UserDataDispose)
...
function VersionActivity2_4StoreItem:onInitView(go)
	self:__onInit()
...
function VersionActivity2_4StoreItem:onBuyGoodsSuccess()
	self:sortGoodsCoList()
	self:refreshGoods()
end

function VersionActivity2_4StoreItem:updateInfo(groupId, groupGoodsCoList)
...
function VersionActivity2_4StoreItem:sortGoodsCoList()
	table.sort(self.groupGoodsCoList, sortGoods)
end

function VersionActivity2_4StoreItem:refreshTag()
	if self.gotag then
		return
	end
...
function VersionActivity2_4StoreItem:refreshTagClip(scrollStore)
...
function VersionActivity2_4StoreItem:refreshGoods()
	local goodsItem
	...
	for index, goodsCo in ipairs(self.groupGoodsCoList) do
		...
		if not self.goodsItemList[index] then
			...
			goodsItem = VersionActivity2_4StoreGoodsItem.New()
...
function VersionActivity2_4StoreItem:getHeight()
	return recthelper.getHeight(self.go.transform)
end

function VersionActivity2_4StoreItem:onDestroy()
...
return VersionActivity2_4StoreItem
