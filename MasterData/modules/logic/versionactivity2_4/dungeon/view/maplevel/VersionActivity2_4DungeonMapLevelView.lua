...
function VersionActivity2_4DungeonMapLevelView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_4SudokuController.instance, VersionActivity2_4DungeonEvent.SudokuCompleted, self._onSudokuCompleted, self)
...
function VersionActivity2_4DungeonMapLevelView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_4SudokuController.instance, VersionActivity2_4DungeonEvent.SudokuCompleted, self._onSudokuCompleted, self)
...
function VersionActivity2_4DungeonMapLevelView:refreshEpisodeTextInfo()
	...
	local targetConfig = chapterCo.id == VersionActivity2_4DungeonEnum.DungeonChapterId.Story and self.showEpisodeCo or VersionActivity2_4DungeonConfig.instance:getStoryEpisodeCo(self.showEpisodeCo.id)
