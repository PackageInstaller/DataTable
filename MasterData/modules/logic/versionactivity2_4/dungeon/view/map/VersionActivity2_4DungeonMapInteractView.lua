...
function VersionActivity2_4DungeonMapInteractView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_4DungeonMapInteractView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, self.showInteractUI, self)
