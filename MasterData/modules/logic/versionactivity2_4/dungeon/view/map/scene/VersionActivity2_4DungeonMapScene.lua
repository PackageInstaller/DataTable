...
function VersionActivity2_4DungeonMapScene:addEvents()
	...
	self.addEventCb(self, VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.FocusElement, self.onFocusElement, self)
	self.addEventCb(self, VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.ManualClickElement, self.manualClickElement, self)
...
function VersionActivity2_4DungeonMapScene:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.FocusElement, self.onFocusElement, self)
	self.removeEventCb(self, VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.ManualClickElement, self.manualClickElement, self)
