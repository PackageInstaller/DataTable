-- chunkname: @modules/logic/versionactivity2_4/dungeon/view/map/VersionActivity2_4DungeonMapChapterLayout.lua

module("modules.logic.versionactivity2_4.dungeon.view.map.VersionActivity2_4DungeonMapChapterLayout", package.seeall)

local VersionActivity2_4DungeonMapChapterLayout = class("VersionActivity2_4DungeonMapChapterLayout", BaseChildView)
local CHAPTER_KEY = "default"
local RIGHT_OFFSET_X = 600
local CONST_DUNGEON_NORMAL_DELTA_X = 100
local TWEEN_TIME = 0.26

function VersionActivity2_4DungeonMapChapterLayout:onInitView()
...
function VersionActivity2_4DungeonMapChapterLayout:addEvents()
	...
	self.addEventCb(self, VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.GuideShowElement, self._GuideShowElement, self)
...
function VersionActivity2_4DungeonMapChapterLayout:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.GuideShowElement, self._GuideShowElement, self)
end

function VersionActivity2_4DungeonMapChapterLayout:_onOpenView(viewName)
...
function VersionActivity2_4DungeonMapChapterLayout:_onCloseView(viewName)
	if viewName == ViewName.VersionActivity2_4DungeonMapLevelView then
...
function VersionActivity2_4DungeonMapChapterLayout:onActivityDungeonMoChange()
	self:updateFocusStatus()
	self:setFocusEpisodeId(self.activityDungeonMo.episodeId, true)
end

function VersionActivity2_4DungeonMapChapterLayout:updateFocusStatus()
	for _, episodeItem in pairs(self._episodeItemDict) do
		episodeItem:refreshFocusStatus()
	end
end

function VersionActivity2_4DungeonMapChapterLayout:_onGamepadKeyUp(key)
	local viewNameList = ViewMgr.instance:getOpenViewNameList()
	local topView = viewNameList[#viewNameList]

	if topView ~= ViewName.VersionActivity2_4DungeonMapView and topView ~= ViewName.VersionActivity2_4DungeonMapLevelView then
		return
	end
...
function VersionActivity2_4DungeonMapChapterLayout:_onChangeFocusEpisodeItem(item)
	if GamepadController.instance:isOpen() then
...
function VersionActivity2_4DungeonMapChapterLayout:_editableInitView()
	self._focusIndex = 0
...
function VersionActivity2_4DungeonMapChapterLayout:onUpdateParam()
	return
end

function VersionActivity2_4DungeonMapChapterLayout:onOpen()
	return
end

function VersionActivity2_4DungeonMapChapterLayout:refreshEpisodeNodes()
	self._episodeItemDict = self:getUserDataTb_()
...
function VersionActivity2_4DungeonMapChapterLayout:getEpisodeContainerItem(index)
...
function VersionActivity2_4DungeonMapChapterLayout:setFocusEpisodeId(episodeId, tween)
...
function VersionActivity2_4DungeonMapChapterLayout:setFocusItem(focusItemGo, tween)
...
function VersionActivity2_4DungeonMapChapterLayout:setFocusEpisodeItem(item, tween)
...
function VersionActivity2_4DungeonMapChapterLayout:setSelectEpisodeItem(episodeItem)
...
function VersionActivity2_4DungeonMapChapterLayout:playAnimation(aniName)
	self.animator:Play(aniName, 0, 0)
end

function VersionActivity2_4DungeonMapChapterLayout:playEpisodeItemAnimation(aniName)
...
function VersionActivity2_4DungeonMapChapterLayout:setSelectEpisodeId(episodeId, skipAni)
...
function VersionActivity2_4DungeonMapChapterLayout:isSelectedEpisodeRightEpisode(episodeItem)
	local result = false
...
function VersionActivity2_4DungeonMapChapterLayout:_GuideShowElement(elementId)
	...
	if elementCo then
		...
		VersionActivity2_4DungeonController.instance:dispatchEvent(VersionActivity2_4DungeonEvent.FocusElement, id)
	end
end

function VersionActivity2_4DungeonMapChapterLayout:onClose()
	for i, v in pairs(self._episodeContainerItemList) do
		v.episodeItem:destroyView()
	end
end

function VersionActivity2_4DungeonMapChapterLayout:onDestroyView()
	return
end

return VersionActivity2_4DungeonMapChapterLayout
