-- chunkname: @modules/logic/versionactivity2_4/enter/view/subview/VersionActivity2_4RougeEnterView.lua

module("modules.logic.versionactivity2_4.enter.view.subview.VersionActivity2_4RougeEnterView", package.seeall)

local VersionActivity2_4RougeEnterView = class("VersionActivity2_4RougeEnterView", BaseView)

function VersionActivity2_4RougeEnterView:onInitView()
...
function VersionActivity2_4RougeEnterView:addEvents()
...
function VersionActivity2_4RougeEnterView:removeEvents()
...
function VersionActivity2_4RougeEnterView:_btnEnterOnClick()
	RougeController.instance:openRougeMainView()
end

function VersionActivity2_4RougeEnterView:_btnRewardOnClick()
	RougeController.instance:openRougeRewardView()
end

function VersionActivity2_4RougeEnterView:_btnLockOnClick()
	local toastId, toastParamList = OpenHelper.getToastIdAndParam(self.config.openId)

	GameFacade.showToastWithTableParam(toastId, toastParamList)
end

function VersionActivity2_4RougeEnterView:_editableInitView()
	self.animComp = VersionActivitySubAnimatorComp.get(self.viewGO, self)
end

function VersionActivity2_4RougeEnterView:onOpen()
...
function VersionActivity2_4RougeEnterView:refreshLock()
...
function VersionActivity2_4RougeEnterView:refreshReward()
...
function VersionActivity2_4RougeEnterView:onDestroyView()
	self.animComp:destroy()
end

return VersionActivity2_4RougeEnterView
