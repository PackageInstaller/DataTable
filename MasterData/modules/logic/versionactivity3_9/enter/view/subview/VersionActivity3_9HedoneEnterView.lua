-- chunkname: @modules/logic/versionactivity3_9/enter/view/subview/VersionActivity3_9HedoneEnterView.lua

module("modules.logic.versionactivity3_9.enter.view.subview.VersionActivity3_9HedoneEnterView", package.seeall)

local VersionActivity3_9HedoneEnterView = class("VersionActivity3_9HedoneEnterView", VersionActivityEnterBaseSubView)

function VersionActivity3_9HedoneEnterView:onInitView()
...
function VersionActivity3_9HedoneEnterView:addEvents()
...
function VersionActivity3_9HedoneEnterView:removeEvents()
...
function VersionActivity3_9HedoneEnterView:_btnEnterOnClick()
...
function VersionActivity3_9HedoneEnterView:_enterLevelView()
	HedoneController.instance:enterEpisodeLevelView()
end

function VersionActivity3_9HedoneEnterView:_btnLockOnClick()
...
function VersionActivity3_9HedoneEnterView:_btnTrialOnClick()
...
function VersionActivity3_9HedoneEnterView:_btnitemOnClick()
	return
end

function VersionActivity3_9HedoneEnterView:_editableInitView()
	self._animator = self.viewGO:GetComponent(gohelper.Type_Animator)
end

function VersionActivity3_9HedoneEnterView:onOpen()
...
function VersionActivity3_9HedoneEnterView:_refreshTime()
...
function VersionActivity3_9HedoneEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity3_9HedoneEnterView:onDestroyView()
	return
end

return VersionActivity3_9HedoneEnterView
