...
function ActMarcusLevelView:onOpen()
	self.addEventCb(self, ActMarcusController.instance, ActMarcusEvent.StoryItemClick, self.OnStoryItemClick, self)
	self.addEventCb(self, ActMarcusController.instance, ActMarcusEvent.FightItemClick, self.OnFightItemClick, self)
	self.addEventCb(self, ActMarcusController.instance, ActMarcusEvent.TabSwitch, self.OnTabSwitch, self)
...
function ActMarcusLevelView:_initStageItems()
	...
	for i = 1, #storyConfigList do
		...
		self.storyItemList[i] = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGo, MarcusStoryItem, self)
	...
	for i = 1, #fightConfigList / 2 do
		...
		self.fightItemList[i] = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGo, MarcusFightItem, self)
