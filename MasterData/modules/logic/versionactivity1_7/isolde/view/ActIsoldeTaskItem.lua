...
function ActIsoldeTaskItem:_editableAddEvents()
	self.addEventCb(self, ActIsoldeController.instance, ActIsoldeEvent.OneClickClaimReward, self._onOneClickClaimReward, self)
end

function ActIsoldeTaskItem:_editableRemoveEvents()
	self.removeEventCb(self, ActIsoldeController.instance, ActIsoldeEvent.OneClickClaimReward, self._onOneClickClaimReward, self)
end
