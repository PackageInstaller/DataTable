-- chunkname: @modules/logic/warmup/v3a8/view/V3a8_WarmUp_rewarditem.lua

module("modules.logic.warmup.v3a8.view.V3a8_WarmUp_rewarditem", package.seeall)

local V3a8_WarmUp_rewarditem = class("V3a8_WarmUp_rewarditem", RougeSimpleItemBase)

function V3a8_WarmUp_rewarditem:onInitView()
	if self._editableInitView then
		self:_editableInitView()
	end
end

function V3a8_WarmUp_rewarditem:addEvents()
	return
end

function V3a8_WarmUp_rewarditem:removeEvents()
	return
end

function V3a8_WarmUp_rewarditem:ctor(ctorParam)
	V3a8_WarmUp_rewarditem.super.ctor(self, ctorParam)
end

function V3a8_WarmUp_rewarditem:onDestroyView()
	V3a8_WarmUp_rewarditem.super.onDestroyView(self)
end

function V3a8_WarmUp_rewarditem:_editableInitView()
	V3a8_WarmUp_rewarditem.super._editableInitView(self)
	...
	self:_setActive_hasget(false)
end

function V3a8_WarmUp_rewarditem:onSelect(isSelect)
	gohelper.setActive(self._goDateSelected, isSelect)
	gohelper.setActive(self._txtDateUnSelectedGo, not isSelect)
end

function V3a8_WarmUp_rewarditem:_getRLOC(episodeId)
	return self:_assetGetViewContainer():getRLOC(episodeId)
end

function V3a8_WarmUp_rewarditem:_getCurSelectedEpisode()
	return self:_assetGetViewContainer():getCurSelectedEpisode()
end

function V3a8_WarmUp_rewarditem:_isWaitingPlayHasGetAnim()
	return self:_assetGetViewContainer():isWaitingPlayHasGetAnim()
end

function V3a8_WarmUp_rewarditem:setData(mo)
	self._mo = mo
...
function V3a8_WarmUp_rewarditem:playAnim_hasget(isIdle)
	if isIdle then
...
function V3a8_WarmUp_rewarditem:_set_Received()
	self._hasgetAnim:Play(kHasGetAnim, 0, 1)
end

function V3a8_WarmUp_rewarditem:_setActive_canget(isActive)
	gohelper.setActive(self._gocanget, isActive)
end

function V3a8_WarmUp_rewarditem:_setActive_hasget(isActive)
	gohelper.setActive(self._go_hasget, isActive)
end

return V3a8_WarmUp_rewarditem
