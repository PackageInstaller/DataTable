-- chunkname: @modules/logic/versionactivity2_1/enter/view/VersionActivity2_1EnterView.lua

module("modules.logic.versionactivity2_1.enter.view.VersionActivity2_1EnterView", package.seeall)

local VersionActivity2_1EnterView = class("VersionActivity2_1EnterView", VersionActivityEnterBaseViewWithListNew)

function VersionActivity2_1EnterView:_editableInitView()
	...
	self:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.First, self._gotabitem1, VersionActivity2_1EnterViewTabItem1)
	self:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.Second, self._gotabitem2, VersionActivity2_1EnterViewTabItem2)
...
function VersionActivity2_1EnterView:childAddEvents()
...
function VersionActivity2_1EnterView:childRemoveEvents()
...
function VersionActivity2_1EnterView:_btnreplayOnClick()
...
function VersionActivity2_1EnterView:onOpen()
	VersionActivity2_1EnterView.super.onOpen(self)

	if self.curActId == VersionActivity2_1Enum.ActivityId.Dungeon then
...
function VersionActivity2_1EnterView:_btnachievementpreviewOnClick()
...
function VersionActivity2_1EnterView:_onTabScrollChange()
	...
	for _, tabItem in ipairs(self.activityTabItemList) do
		if tabItem:isShowRedDot() then
			local anchorY = -tabItem:getAnchorY() + VersionActivity2_1Enum.RedDotOffsetY
...
function VersionActivity2_1EnterView:refreshRedDot()
	self:_onTabScrollChange()
end

function VersionActivity2_1EnterView:refreshBtnVisible(isOnOpen)
	local showReplay = VersionActivity2_1EnterHelper.GetIsShowReplayBtn(self.curActId)
	local showAchieve = VersionActivity2_1EnterHelper.GetIsShowAchievementBtn(self.curActId)
...
return VersionActivity2_1EnterView
