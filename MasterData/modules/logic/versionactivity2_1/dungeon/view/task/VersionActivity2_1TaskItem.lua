...
function VersionActivity2_1TaskItem:addEvents()
	...
	self.addEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickAllTaskFinish, self._OnClickAllTaskFinish, self)
end
...
function VersionActivity2_1TaskItem:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickAllTaskFinish, self._OnClickAllTaskFinish, self)
end
