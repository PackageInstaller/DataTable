...
function VersionActivity2_1DungeonMapEpisodeView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickElement, self.hideUI, self)
	self.addEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_1DungeonMapEpisodeView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickElement, self.hideUI, self)
	self.removeEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, self.showUI, self)
