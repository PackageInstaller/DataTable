...
function VersionActivity2_1DungeonMapInteractView:addEvents()
	...
	self.addEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_1DungeonMapInteractView:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_1DungeonMapInteractView:onRecheck(elementCo)
	if self._show then
		return
	end
