...
function VersionActivity2_1DungeonMapScene:addEvents()
	...
	self.addEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.FocusElement, self.onFocusElement, self)
	self.addEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.ManualClickElement, self.manualClickElement, self)
...
function VersionActivity2_1DungeonMapScene:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.FocusElement, self.onFocusElement, self)
	self.removeEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.ManualClickElement, self.manualClickElement, self)
