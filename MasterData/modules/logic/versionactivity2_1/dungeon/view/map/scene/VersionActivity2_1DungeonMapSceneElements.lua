-- chunkname: @modules/logic/versionactivity2_1/dungeon/view/map/scene/VersionActivity2_1DungeonMapSceneElements.lua

module("modules.logic.versionactivity2_1.dungeon.view.map.scene.VersionActivity2_1DungeonMapSceneElements", package.seeall)

local VersionActivity2_1DungeonMapSceneElements = class("VersionActivity2_1DungeonMapSceneElements", BaseView)
local FOCUS_TIME = 0.5
local WAIT_TIME = 0.5

function VersionActivity2_1DungeonMapSceneElements:onInitView()
...
function VersionActivity2_1DungeonMapSceneElements:addEvents()
	...
	self.addEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickElement, self.onClickElement, self)
	self.addEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
...
function VersionActivity2_1DungeonMapSceneElements:removeEvents()
	...
	self.removeEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickElement, self.onClickElement, self)
	self.removeEventCb(self, VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
...
function VersionActivity2_1DungeonMapSceneElements:_editableInitView()
...
function VersionActivity2_1DungeonMapSceneElements:onOpen()
	return
end

function VersionActivity2_1DungeonMapSceneElements:onGamepadKeyDown(key)
	...
	for i = 0, maxIndex do
		...
		local comp = MonoHelper.getLuaComFromGo(hitInfo.transform.parent.gameObject, VersionActivity2_1DungeonMapElement)
...
function VersionActivity2_1DungeonMapSceneElements:onBeginDragMap()
	self._clickDown = false
end

function VersionActivity2_1DungeonMapSceneElements:onCreateMapRootGoDone(sceneRoot)
...
function VersionActivity2_1DungeonMapSceneElements:loadSceneFinish(param)
...
function VersionActivity2_1DungeonMapSceneElements:manualClickElement(id)
...
function VersionActivity2_1DungeonMapSceneElements:setMouseElementDown(elementComp)
	self.mouseDownElement = elementComp
end

function VersionActivity2_1DungeonMapSceneElements:getElementComp(elementId)
	return self._elementCompDict[elementId]
end

function VersionActivity2_1DungeonMapSceneElements:onClickElement(elementId)
	self:hideAllElements()
end

function VersionActivity2_1DungeonMapSceneElements:hideAllElements()
...
function VersionActivity2_1DungeonMapSceneElements:onHideInteractUI()
	self:showAllElements()
end

function VersionActivity2_1DungeonMapSceneElements:showAllElements()
	for _, elementComp in pairs(self._elementCompDict) do
...
function VersionActivity2_1DungeonMapSceneElements:_updateElementArrow()
	for _, v in pairs(self._elementCompDict) do
		self:_updateArrow(v)
	end
end

function VersionActivity2_1DungeonMapSceneElements:beginShowRewardView()
	self._showRewardView = true
end

function VersionActivity2_1DungeonMapSceneElements:endShowRewardView()
...
function VersionActivity2_1DungeonMapSceneElements:onRemoveElement(id)
...
function VersionActivity2_1DungeonMapSceneElements:_removeElement(id)
	...
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnRemoveElement, elementComp)
end

function VersionActivity2_1DungeonMapSceneElements:showNewElements()
	...
	for _, elementId in ipairs(newElements) do
		...
		local isBelongCurMap = VersionActivity2_1DungeonConfig.instance:checkElementBelongMapId(elementCo, self._mapCfg.id)
...
function VersionActivity2_1DungeonMapSceneElements:_showElementAnim(animElements, normalElements)
	if not animElements or #animElements <= 0 then
		VersionActivity2_1DungeonMapSceneElements._addAnimElementDone({
			self,
			normalElements
		})
	...
	for _, id in ipairs(animElements) do
		self._showSequence:addWork(FunctionWork.New(VersionActivity2_1DungeonMapSceneElements._doFocusElement, {
			self,
			id
		}))
		self._showSequence:addWork(TimerWork.New(FOCUS_TIME))
		self._showSequence:addWork(FunctionWork.New(VersionActivity2_1DungeonMapSceneElements._doAddElement, {
			self,
			id
		}))
		self._showSequence:addWork(TimerWork.New(WAIT_TIME))
	...
	self._showSequence:addWork(FunctionWork.New(VersionActivity2_1DungeonMapSceneElements._addAnimElementDone, {
		self,
		normalElements
	}))
	...
	UIBlockMgr.instance:startBlock(VersionActivity2_1DungeonEnum.BlockKey.FocusNewElement)
end

function VersionActivity2_1DungeonMapSceneElements._doFocusElement(params)
	local elementId = params[2]

	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.FocusElement, elementId, true)
end

function VersionActivity2_1DungeonMapSceneElements._doAddElement(params)
...
function VersionActivity2_1DungeonMapSceneElements._addAnimElementDone(params)
	local self = params[1]
...
function VersionActivity2_1DungeonMapSceneElements:_addElementById(id)
	local config = lua_chapter_map_element.configDict[id]

	self:_addElement(config)
end

function VersionActivity2_1DungeonMapSceneElements:_addElement(elementConfig)
	...
	if elementComp then
		...
		elementComp = MonoHelper.addLuaComOnceToGo(go, VersionActivity2_1DungeonMapElement, {
			elementConfig,
			self
		})
	end
	...
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnAddOneElement, elementComp)
end

function VersionActivity2_1DungeonMapSceneElements:showElements()
	...
	local newElements = DungeonMapModel.instance:getNewElements()
	local elementCoList = VersionActivity2_1DungeonModel.instance:getElementCoList(self._mapCfg.id)
...
function VersionActivity2_1DungeonMapSceneElements:recycleAllElements()
	...
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnRecycleAllElement)
end

function VersionActivity2_1DungeonMapSceneElements:_arrowClick(elementId)
	self.mouseDownElement = nil

	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_element_arrow_click)
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.FocusElement, elementId)
end

function VersionActivity2_1DungeonMapSceneElements:_updateArrow(elementComp)
...
function VersionActivity2_1DungeonMapSceneElements:onClickUp()
...
function VersionActivity2_1DungeonMapSceneElements:onClickDown()
	self._clickDown = true
end

function VersionActivity2_1DungeonMapSceneElements:setInitClickElement(elementId)
	self._initClickElementId = elementId
end

function VersionActivity2_1DungeonMapSceneElements:clearElements()
	if self._elementCompDict then
		for _, v in pairs(self._elementCompDict) do
			v:onDestroy()
		end
...
function VersionActivity2_1DungeonMapSceneElements:onChangeMap()
	self.hadEverySecondTask = false
...
function VersionActivity2_1DungeonMapSceneElements:_stopShowSequence()
	if self._showSequence then
		...
		UIBlockMgr.instance:endBlock(VersionActivity2_1DungeonEnum.BlockKey.FocusNewElement)
	end
end

function VersionActivity2_1DungeonMapSceneElements:onDisposeScene()
	self:clearElements()
	self:_stopShowSequence()
...
function VersionActivity2_1DungeonMapSceneElements:onDisposeOldMap(viewName)
	self:recycleAllElements()
...
function VersionActivity2_1DungeonMapSceneElements:onClose()
	return
end

function VersionActivity2_1DungeonMapSceneElements:onDestroyView()
	self:clearElements()
	DungeonMapModel.instance:clearNewElements()
	self:_stopShowSequence()
...
return VersionActivity2_1DungeonMapSceneElements
