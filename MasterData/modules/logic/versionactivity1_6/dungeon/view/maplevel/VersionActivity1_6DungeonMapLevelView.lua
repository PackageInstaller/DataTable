...
function VersionActivity1_6DungeonMapLevelView:refreshEpisodeTextInfo()
	...
	local targetConfig = chapterCo.id == VersionActivity1_6DungeonEnum.DungeonChapterId.Story and self.showEpisodeCo or VersionActivity1_6DungeonController.instance:getStoryEpisodeCo(self.showEpisodeCo.id)
...
function VersionActivity1_6DungeonMapLevelView:refreshStartBtn()
	...
	local var_45_0 = DungeonModel.instance:hasPassLevelAndStory(self.originEpisodeConfig.id)

	if var_45_0 then
		var_45_0 = self.storyIdList and #self.storyIdList > 0
	end

	gohelper.setActive(self._btnreplayStory.gameObject, var_45_0)
