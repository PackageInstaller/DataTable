-- chunkname: @modules/logic/versionactivity1_6/dungeon/view/map/VersionActivity1_6DungeonMapElement.lua

module("modules.logic.versionactivity1_6.dungeon.view.map.VersionActivity1_6DungeonMapElement", package.seeall)

local VersionActivity1_6DungeonMapElement = class("VersionActivity1_6DungeonMapElement", LuaCompBase)

function VersionActivity1_6DungeonMapElement:ctor(param)
	self._config = param[1]
	self._sceneElements = param[2]
end

function VersionActivity1_6DungeonMapElement:getElementId()
	return self._config.id
end

function VersionActivity1_6DungeonMapElement:hide()
	gohelper.setActive(self._go, false)
end

function VersionActivity1_6DungeonMapElement:show()
	gohelper.setActive(self._go, true)
end

function VersionActivity1_6DungeonMapElement:init(go)
	self._go = go
...
function VersionActivity1_6DungeonMapElement:_onResLoaded()
...
function VersionActivity1_6DungeonMapElement:createMainPrefab()
...
function VersionActivity1_6DungeonMapElement:createEffectPrefab(effectPath, offset)
...
function VersionActivity1_6DungeonMapElement:updatePos()
...
function VersionActivity1_6DungeonMapElement:getTransform()
	return self._transform
end

function VersionActivity1_6DungeonMapElement:getElementPos()
...
function VersionActivity1_6DungeonMapElement:getConfig()
	return self._config
end

function VersionActivity1_6DungeonMapElement:_onClickDown()
	self._sceneElements:setMouseElementDown(self)
end

function VersionActivity1_6DungeonMapElement:onClick()
	VersionActivity1_6DungeonController.instance:dispatchEvent(VersionActivity1_6DungeonEvent.OnClickElement, self)
end

function VersionActivity1_6DungeonMapElement:showElement()
	self:playEffectAnim("wenhao_a_001_in")
end

function VersionActivity1_6DungeonMapElement:hideElement()
	self:playEffectAnim("wenhao_a_001_out")
end

function VersionActivity1_6DungeonMapElement:playEffectAnim(name)
...
function VersionActivity1_6DungeonMapElement:_effectAnimDone()
	logNormal("effect anim done")
end

function VersionActivity1_6DungeonMapElement.addBoxColliderListener(go, callback, callbackTarget)
...
function VersionActivity1_6DungeonMapElement:isValid()
	return not gohelper.isNil(self._go)
end

function VersionActivity1_6DungeonMapElement:setFinish()
...
function VersionActivity1_6DungeonMapElement:onFinishAnimDone()
	self:onDestroy()
end

function VersionActivity1_6DungeonMapElement:autoPopInteractView()
...
function VersionActivity1_6DungeonMapElement:tryHideSelf()
	if VersionActivity1_5DungeonModel.instance:checkIsShowInteractView() then
		self:hideElement()
	end
end

function VersionActivity1_6DungeonMapElement:onDestroy()
	gohelper.setActive(self._go, true)
...
return VersionActivity1_6DungeonMapElement
