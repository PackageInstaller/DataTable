...
function ActGeTianLevelView:onOpen()
	self.addEventCb(self, ActGeTianController.instance, ActGeTianEvent.StoryItemClick, self.OnStoryItemClick, self)
	self.addEventCb(self, ActGeTianController.instance, ActGeTianEvent.FightItemClick, self.OnFightItemClick, self)
	self.addEventCb(self, ActGeTianController.instance, ActGeTianEvent.TabSwitch, self.OnTabSwitch, self)
...
function ActGeTianLevelView:_initStageItems()
	...
	for i = 1, #storyConfigList do
		...
		self.storyItemList[i] = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGo, GeTianStoryItem, self)
	...
	for i = 1, #fightConfigList / 2 do
		...
		self.fightItemList[i] = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGo, GeTianFightItem, self)
