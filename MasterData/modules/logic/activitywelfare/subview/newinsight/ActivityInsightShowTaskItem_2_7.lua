-- chunkname: @modules/logic/activitywelfare/subview/newinsight/ActivityInsightShowTaskItem_2_7.lua

module("modules.logic.activitywelfare.subview.newinsight.ActivityInsightShowTaskItem_2_7", package.seeall)

local ActivityInsightShowTaskItem_2_7 = class("ActivityInsightShowTaskItem_2_7", LuaCompBase)

function ActivityInsightShowTaskItem_2_7:init(go, index)
	self.go = go
	self._index = index
...
function ActivityInsightShowTaskItem_2_7:addEvents()
...
function ActivityInsightShowTaskItem_2_7:removeEvents()
	self._btngoto:RemoveClickListener()
	self._btncanget:RemoveClickListener()
	self._btnuse:RemoveClickListener()
end

function ActivityInsightShowTaskItem_2_7:_btngotoOnClick()
	if self._config.jumpId > 0 then
		GameFacade.jump(self._config.jumpId)
	end
end

function ActivityInsightShowTaskItem_2_7:_btncangetOnClick()
...
function ActivityInsightShowTaskItem_2_7:setTask(taskId)
	self._taskId = taskId

	self:refresh()
end

function ActivityInsightShowTaskItem_2_7:refresh()
...
function ActivityInsightShowTaskItem_2_7:_refreshBtns()
...
function ActivityInsightShowTaskItem_2_7:_refreshTaskRewards()
...
function ActivityInsightShowTaskItem_2_7:destroy()
	self:removeEvents()
end

return ActivityInsightShowTaskItem_2_7
