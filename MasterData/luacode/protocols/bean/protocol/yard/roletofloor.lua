...
local RoleToFloor = dataclass("RoleToFloor")
RoleToFloor.floorId = 0

function RoleToFloor:Ctor()
  self.roles = {}
end

function RoleToFloor:Marshal(buffer)
...
function RoleToFloor:Unmarshal(buffer)
  local ret = true
