...
local BossPanelData = dataclass("BossPanelData")
BossPanelData.passTime = 0
BossPanelData.power = 0
BossPanelData.times = 0

function BossPanelData:Ctor()
  self.roleIdList = {}
  self.roleLvList = {}
  self.roleBreakList = {}
  self.roleSkinList = {}
...
function BossPanelData:Marshal(buffer)
...
function BossPanelData:Unmarshal(buffer)
  local ret = true
