...
local christmasevent = dataclass("christmasevent")
christmasevent.construction = 0

function christmasevent:Ctor()
  self.events = {}
  self.autoExplore = {}
end

function christmasevent:Marshal(buffer)
...
function christmasevent:Unmarshal(buffer)
  local ret = true
