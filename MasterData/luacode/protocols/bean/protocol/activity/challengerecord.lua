...
local ChallengeRecord = dataclass("ChallengeRecord")
ChallengeRecord.score = 0
ChallengeRecord.time = 0
ChallengeRecord.TRAIN = 0
ChallengeRecord.WEEK = 1
ChallengeRecord.DAILY = 2
ChallengeRecord.SEASON = 3

function ChallengeRecord:Ctor()
  self.roleIdList = {}
  self.roleLvList = {}
  self.roleBreakList = {}
  self.roleSkinList = {}
...
function ChallengeRecord:Marshal(buffer)
...
function ChallengeRecord:Unmarshal(buffer)
  local ret = true
