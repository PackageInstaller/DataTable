...
local loverevent = dataclass("loverevent")
loverevent.construction = 0

function loverevent:Ctor()
  self.events = {}
  self.autoExplore = {}
end

function loverevent:Marshal(buffer)
...
function loverevent:Unmarshal(buffer)
  local ret = true
