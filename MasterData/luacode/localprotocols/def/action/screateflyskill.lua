...
function SCreateFlySkill:Ctor(client)
end

function SCreateFlySkill:Marshal(data)
...
function SCreateFlySkill:Unmarshal(data)
...
function SCreateFlySkill:CheckVariable()
