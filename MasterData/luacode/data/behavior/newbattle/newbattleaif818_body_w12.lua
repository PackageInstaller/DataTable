...
local function Createnewbattleaif818_body_w12(behavior)
  ...
  local node11 = Agent.SummonMonster.Create(behavior, 2, 29, 66623)
...
return Createnewbattleaif818_body_w12
