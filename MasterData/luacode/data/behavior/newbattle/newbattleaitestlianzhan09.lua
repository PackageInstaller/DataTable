...
local function CreateNewBattleAItestLianzhan09(behavior)
  ...
  local node10 = Agent.SummonMonster.Create(behavior, 2, 21, 66036)
  node9:SetTask(node10)
  local node11 = LoopUntil.Create(behavior, 1, true)
  local node12 = Agent.SummonMonster.Create(behavior, 2, 29, 66035)
  ...
  local node18 = Agent.SummonMonster.Create(behavior, 2, 29, 66037)
...
return CreateNewBattleAItestLianzhan09
