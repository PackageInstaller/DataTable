...
local function CreateNewBattleAI63cs(behavior)
  ...
  local node7 = Agent.MonsterWithoutBuff.Create(behavior, 60, -1, 20279)
  ...
  local node11 = Agent.MonsterWithoutBuff.Create(behavior, 60, -1, 20279)
  local node12 = Agent.MonsterWithoutBuff.Create(behavior, -1, 0, 20283)
