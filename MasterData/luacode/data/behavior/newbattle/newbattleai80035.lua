...
local function CreateNewBattleAI80035(behavior)
  ...
  local node7 = Agent.UseSkill.Create(behavior, 201454)
  node6:SetTask(node7)
  node4:AddTask(node5)
  node4:AddTask(node6)
  ...
  local node11 = Agent.UseSkill.Create(behavior, 201455)
  ...
  local node15 = Agent.UseSkill.Create(behavior, 201456)
  ...
  local node19 = Agent.UseSkill.Create(behavior, 201457)
