...
local function Createnewbattleaif409(behavior)
  ...
  local node11 = Agent.SummonMonsterType.Create(behavior, 2, 21, 410, 0)
  node10:SetTask(node11)
  local node12 = LoopUntil.Create(behavior, 1, true)
  local node13 = Agent.SummonMonsterType.Create(behavior, 2, 25, 410, 0)
