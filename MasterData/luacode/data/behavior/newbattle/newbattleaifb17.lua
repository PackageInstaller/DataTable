...
local function CreateNewBattleAIfb17(behavior)
  ...
  local node11 = Agent.MonsterSkillIsInCD.Create(behavior, 201360)
  local node12 = Agent.UseSkill.Create(behavior, 6004106)
  ...
  local node15 = Agent.MonsterSkillIsInCD.Create(behavior, 10004)
  local node16 = Agent.UseSkill.Create(behavior, 10004)
