...
local function CreateNewBattleAI50(behavior)
  ...
  local node11 = Agent.SummonMonsterType.Create(behavior, 2, 21, 51, 0)
  node10:SetTask(node11)
  local node12 = LoopUntil.Create(behavior, 1, true)
  local node13 = Agent.SummonMonsterType.Create(behavior, 2, 25, 51, 0)
