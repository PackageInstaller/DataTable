...
local function CreateNewBattleAIfb06(behavior)
  ...
  local node6 = Agent.MonsterSkillIsInCD.Create(behavior, 201348)
  local node7 = Agent.UseSkill.Create(behavior, 6047101)
  local node8 = Agent.ClearSkillCurrentTime.Create(behavior, 201348)
  node5:AddTask(node6)
  node5:AddTask(node7)
  node5:AddTask(node8)
  local node9 = Sequence.Create()
  local node10 = Agent.MonsterSkillIsInCD.Create(behavior, 201352)
  local node11 = Agent.UseSkill.Create(behavior, 6047201)
  ...
  local node14 = Agent.MonsterSkillIsInCD.Create(behavior, 10047)
  local node15 = Agent.UseSkill.Create(behavior, 10047)
