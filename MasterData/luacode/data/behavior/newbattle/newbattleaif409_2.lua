...
local function Createnewbattleaif409_2(behavior)
  ...
  local node5 = Agent.MonsterSkillIsInCD.Create(behavior, 201075)
  local node6 = Agent.UseSkill.Create(behavior, 201075)
  node2:AddTask(node3)
  node2:AddTask(node4)
  node2:AddTask(node5)
  node2:AddTask(node6)
  ...
  local node11 = Agent.SummonMonsterType.Create(behavior, 2, 29, 410, 0)
  node10:SetTask(node11)
  local node12 = LoopUntil.Create(behavior, 1, true)
  local node13 = Agent.SummonMonsterType.Create(behavior, 2, 33, 410, 0)
...
return Createnewbattleaif409_2
