...
local function CreateNewBattleAISummerLianzhan16(behavior)
  ...
  local node5 = Agent.SummonMonster.Create(behavior, 2, 29, 66198)
  node4:SetTask(node5)
...
return CreateNewBattleAISummerLianzhan16
