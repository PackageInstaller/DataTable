...
local function CreateNewBattleAItestLianzhan05(behavior)
  ...
  local node5 = Agent.SummonMonster.Create(behavior, 2, 21, 66016)
  node4:SetTask(node5)
  local node6 = LoopUntil.Create(behavior, 1, true)
  local node7 = Agent.SummonMonster.Create(behavior, 2, 29, 66018)
  node6:SetTask(node7)
  ...
  local node13 = Agent.SummonMonster.Create(behavior, 2, 29, 66017)
...
return CreateNewBattleAItestLianzhan05
