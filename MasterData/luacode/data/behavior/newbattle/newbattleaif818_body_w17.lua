...
local function Createnewbattleaif818_body_w17(behavior)
  ...
  local node11 = Agent.SummonMonster.Create(behavior, 2, 29, 66628)
...
return Createnewbattleaif818_body_w17
