...
local function Createnewbattleaif214_2(behavior)
  ...
  local node11 = Agent.SummonMonsterType.Create(behavior, 2, 29, 22, 0)
  node10:SetTask(node11)
  local node12 = LoopUntil.Create(behavior, 1, true)
  local node13 = Agent.SummonMonsterType.Create(behavior, 2, 33, 22, 0)
...
return Createnewbattleaif214_2
