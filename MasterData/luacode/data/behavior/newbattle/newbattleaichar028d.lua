...
local function CreateNewBattleAIchar028d(behavior)
  ...
  local node6 = Agent.SkillToMaster.Create(behavior, 201359)
  node5:SetTask(node6)
  node2:AddTask(node3)
  node2:AddTask(node5)
  ...
  local node11 = Agent.MonsterSkillIsInCD.Create(behavior, 6022301)
  local node12 = Agent.UseSkill.Create(behavior, 6022301)
  node10:AddTask(node11)
  node10:AddTask(node12)
  local node13 = Sequence.Create()
  local node14 = Agent.MonsterSkillIsInCD.Create(behavior, 19022)
  local node15 = Agent.UseSkill.Create(behavior, 19022)
...
return CreateNewBattleAIchar028d
