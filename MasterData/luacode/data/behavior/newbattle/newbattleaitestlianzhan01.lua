...
local function CreateNewBattleAItestLianzhan01(behavior)
  ...
  local node5 = Agent.SummonMonster.Create(behavior, 2, 21, 66012)
  node4:SetTask(node5)
  local node6 = LoopUntil.Create(behavior, 1, true)
  local node7 = Agent.SummonMonster.Create(behavior, 2, 29, 66013)
  node6:SetTask(node7)
  ...
  local node13 = Agent.SummonMonster.Create(behavior, 2, 25, 66014)
...
return CreateNewBattleAItestLianzhan01
