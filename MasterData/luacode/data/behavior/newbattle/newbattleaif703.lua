...
local function Createnewbattleaif703(behavior)
  ...
  local node7 = Agent.UseSkill.Create(behavior, 201530)
  node6:SetTask(node7)
  node4:AddTask(node5)
  node4:AddTask(node6)
  local node8 = Sequence.Create()
  local node9 = Agent.MonsterHpPercentSection.Create(behavior, 0, 0, 50)
  local node10 = LoopUntil.Create(behavior, 1, true)
  local node11 = Agent.UseSkill.Create(behavior, 201529)
  node10:SetTask(node11)
  node8:AddTask(node9)
  node8:AddTask(node10)
  local node12 = Sequence.Create()
  local node13 = Agent.MonsterSkillIsInCD.Create(behavior, 201528)
  local node14 = Agent.UseSkill.Create(behavior, 201528)
  local node15 = Agent.ClearSkillCurrentTime.Create(behavior, 201527)
  node12:AddTask(node13)
  node12:AddTask(node14)
  node12:AddTask(node15)
  local node16 = Sequence.Create()
  local node17 = Agent.MonsterSkillIsInCD.Create(behavior, 201527)
  local node18 = Agent.UseSkill.Create(behavior, 201527)
