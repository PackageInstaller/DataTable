...
local function CreateNewBattleAITest32_1(behavior)
  ...
  local node9 = Agent.MonsterSkillIsInCD.Create(behavior, 201652)
  local node10 = Agent.UseSkill.Create(behavior, 201652)
  node8:AddTask(node9)
  node8:AddTask(node10)
  local node11 = Sequence.Create()
  local node12 = Agent.MonsterSkillIsInCD.Create(behavior, 201653)
  local node13 = Agent.UseSkill.Create(behavior, 201653)
  local node14 = Agent.ClearSkillCurrentTime.Create(behavior, 201652)
...
return CreateNewBattleAITest32_1
