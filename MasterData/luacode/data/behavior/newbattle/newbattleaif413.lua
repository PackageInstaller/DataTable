...
local function Createnewbattleaif413(behavior)
  ...
  local node5 = Agent.MonsterInBattle.Create(behavior, 415, -1)
  local node6 = IfElse.Create()
  local node7 = Agent.MonsterWithoutBuff.Create(behavior, 415, -1, 20000)
  local node8 = Selector.Create()
  local node9 = LoopUntil.Create(behavior, 1, true)
  local node10 = Agent.UseSkill.Create(behavior, 201098)
  node9:SetTask(node10)
  local node11 = Sequence.Create()
  local node12 = Agent.MonsterSkillIsInCD.Create(behavior, 201097)
  local node13 = Agent.UseSkill.Create(behavior, 201097)
  ...
  local node18 = Agent.MonsterSkillIsInCD.Create(behavior, 201097)
  local node19 = Agent.UseSkill.Create(behavior, 201097)
  ...
  local node21 = Agent.MonsterSkillIsInCD.Create(behavior, 201097)
  local node22 = Agent.UseSkill.Create(behavior, 201097)
