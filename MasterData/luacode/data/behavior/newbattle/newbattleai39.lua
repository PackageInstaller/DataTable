...
local function CreateNewBattleAI39(behavior)
  ...
  local node8 = Agent.MonsterSkillIsInCD.Create(behavior, 201069)
  local node9 = Agent.UseSkill.Create(behavior, 201069)
  node7:AddTask(node8)
  node7:AddTask(node9)
