...
local function CreateNewBattleAIfb11(behavior)
  ...
  local node8 = Agent.ClearSkillCurrentTime.Create(behavior, 201352)
  node5:AddTask(node6)
  node5:AddTask(node7)
  node5:AddTask(node8)
  ...
  local node13 = Agent.ClearSkillCurrentTime.Create(behavior, 201354)
  node9:AddTask(node10)
  node9:AddTask(node11)
  node9:AddTask(node12)
  node9:AddTask(node13)
  local node14 = Sequence.Create()
  local node15 = Agent.MonsterSkillIsInCD.Create(behavior, 10016)
  local node16 = Agent.UseSkill.Create(behavior, 10016)
