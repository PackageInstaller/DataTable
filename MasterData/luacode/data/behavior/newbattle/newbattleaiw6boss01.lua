...
local function Createnewbattleaiw6boss01(behavior)
  ...
  local node6 = Agent.BattlePause.Create(behavior, 3, "W3_Battle_day2_boss")
  node5:SetTask(node6)
  node3:AddTask(node4)
  node3:AddTask(node5)
  ...
  local node10 = Agent.SummonMonster.Create(behavior, 2, 32, 20245)
  ...
  local node12 = Noop.Create()
  local node13 = Noop.Create()
...
return Createnewbattleaiw6boss01
