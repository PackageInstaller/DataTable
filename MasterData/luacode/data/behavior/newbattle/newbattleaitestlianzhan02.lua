...
local function CreateNewBattleAItestLianzhan02(behavior)
  ...
  local node5 = Agent.SummonMonster.Create(behavior, 2, 21, 66002)
  node4:SetTask(node5)
  local node6 = LoopUntil.Create(behavior, 1, true)
  local node7 = Agent.SummonMonster.Create(behavior, 2, 33, 66003)
  node6:SetTask(node7)
  local node8 = LoopUntil.Create(behavior, 1, true)
  local node9 = Agent.SummonMonster.Create(behavior, 2, 25, 66002)
  node8:SetTask(node9)
...
return CreateNewBattleAItestLianzhan02
