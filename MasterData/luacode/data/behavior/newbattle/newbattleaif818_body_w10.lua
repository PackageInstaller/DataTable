...
local function Createnewbattleaif818_body_w10(behavior)
  ...
  local node11 = Agent.SummonMonster.Create(behavior, 2, 29, 66621)
...
return Createnewbattleaif818_body_w10
