...
local function CreateNewBattleAITest16(behavior)
  local data = behavior._data
  local node1 = Selector.Create()
  local node2 = Sequence.Create()
  local node3 = Agent.MonsterHasBuff.Create(behavior, 0, 20254)
  local node4 = LoopUntil.Create(behavior, 1, true)
  local node5 = Agent.SummonMonsterType.Create(behavior, 2, 20, 417, 0)
  node4:SetTask(node5)
  node2:AddTask(node3)
  node2:AddTask(node4)
  ...
  local node10 = Agent.UseSkill.Create(behavior, 201145)
...
return CreateNewBattleAITest16
