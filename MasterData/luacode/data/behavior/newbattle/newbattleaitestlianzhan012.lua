...
local function CreateNewBattleAItestLianzhan012(behavior)
  ...
  local node10 = Agent.SummonMonster.Create(behavior, 2, 25, 66047)
  node9:SetTask(node10)
  local node11 = LoopUntil.Create(behavior, 1, true)
  local node12 = Agent.SummonMonster.Create(behavior, 2, 33, 66046)
  ...
  local node18 = Agent.SummonMonster.Create(behavior, 2, 33, 66045)
...
return CreateNewBattleAItestLianzhan012
