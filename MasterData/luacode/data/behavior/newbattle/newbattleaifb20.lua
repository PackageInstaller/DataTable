...
local function CreateNewBattleAIfb20(behavior)
  ...
  local node7 = Agent.UseSkill.Create(behavior, 6043101)
  ...
  local node11 = Agent.UseSkill.Create(behavior, 6043201)
  local node12 = Agent.ClearSkillCurrentTime.Create(behavior, 201360)
  node9:AddTask(node10)
  node9:AddTask(node11)
  node9:AddTask(node12)
  local node13 = Sequence.Create()
  local node14 = Agent.MonsterSkillIsInCD.Create(behavior, 10043)
  local node15 = Agent.UseSkill.Create(behavior, 10043)
