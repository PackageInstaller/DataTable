...
local function Createnewbattleaif507(behavior)
  ...
  local node8 = Agent.UseSkill.Create(behavior, 201425)
  node7:SetTask(node8)
  node5:AddTask(node6)
  node5:AddTask(node7)
  local node9 = Sequence.Create()
  local node10 = Agent.MonsterSkillIsInCD.Create(behavior, 201423)
  local node11 = Agent.MonsterWithoutBuff.Create(behavior, -1, 0, 20766)
  local node12 = Agent.UseSkill.Create(behavior, 201423)
  node9:AddTask(node10)
  node9:AddTask(node11)
  node9:AddTask(node12)
  local node13 = Sequence.Create()
  local node14 = Agent.MonsterSkillIsInCD.Create(behavior, 201424)
  local node15 = Agent.MonsterHasBuff.Create(behavior, 0, 20766)
  local node16 = Agent.UseSkill.Create(behavior, 201424)
