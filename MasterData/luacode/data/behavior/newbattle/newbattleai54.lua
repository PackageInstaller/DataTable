...
local function CreateNewBattleAI54(behavior)
  ...
  local node5 = Agent.MonsterInBattle.Create(behavior, 55, -1)
  local node6 = IfElse.Create()
  local node7 = Agent.MonsterWithoutBuff.Create(behavior, 55, -1, 20000)
