...
local function CreateNewBattleAIfb22(behavior)
  ...
  local node7 = Agent.UseSkill.Create(behavior, 6008101)
  ...
  local node11 = Agent.UseSkill.Create(behavior, 6008201)
  ...
  local node14 = Agent.MonsterSkillIsInCD.Create(behavior, 10008)
  local node15 = Agent.UseSkill.Create(behavior, 10008)
