...
local function CreateNewBattleAItestLianzhan010(behavior)
  ...
  local node10 = Agent.SummonMonster.Create(behavior, 2, 21, 66038)
  node9:SetTask(node10)
  local node11 = LoopUntil.Create(behavior, 1, true)
  local node12 = Agent.SummonMonster.Create(behavior, 2, 25, 66038)
  node11:SetTask(node12)
  local node13 = LoopUntil.Create(behavior, 1, true)
  local node14 = Agent.SummonMonster.Create(behavior, 2, 29, 66038)
  ...
  local node20 = Agent.SummonMonster.Create(behavior, 2, 21, 66038)
  node19:SetTask(node20)
  local node21 = LoopUntil.Create(behavior, 1, true)
  local node22 = Agent.SummonMonster.Create(behavior, 2, 29, 66039)
  node21:SetTask(node22)
  local node23 = Agent.RunAway.Create(behavior, "Hide")
...
return CreateNewBattleAItestLianzhan010
