...
local function CreateNewBattleAIskillfb03(behavior)
  ...
  local node11 = Agent.UseSkill.Create(behavior, 201471)
  node8:AddTask(node9)
  node8:AddTask(node11)
  local node12 = Agent.UseSkill.Create(behavior, 201470)
...
return CreateNewBattleAIskillfb03
