...
local function CreateNewBattleAItestLianzhan07(behavior)
  ...
  local node10 = Agent.SummonMonster.Create(behavior, 2, 21, 66030)
  node9:SetTask(node10)
  local node11 = LoopUntil.Create(behavior, 1, true)
  local node12 = Agent.SummonMonster.Create(behavior, 2, 33, 66031)
  node11:SetTask(node12)
  local node13 = LoopUntil.Create(behavior, 1, true)
  local node14 = Agent.SummonMonster.Create(behavior, 2, 25, 66030)
...
return CreateNewBattleAItestLianzhan07
