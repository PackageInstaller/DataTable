...
local function CreateNewBattleAIfb18(behavior)
  ...
  local node7 = Agent.UseSkill.Create(behavior, 6052101)
  ...
  local node11 = Agent.UseSkill.Create(behavior, 6052201)
  ...
  local node14 = Agent.MonsterSkillIsInCD.Create(behavior, 10052)
  local node15 = Agent.UseSkill.Create(behavior, 10052)
