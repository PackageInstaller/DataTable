...
local function CreateNewBattleAITest36(behavior)
  ...
  local node10 = Agent.MonsterSkillIsInCD.Create(behavior, 201646)
  local node11 = Agent.UseSkill.Create(behavior, 201646)
  node7:AddTask(node8)
  node7:AddTask(node9)
...
return CreateNewBattleAITest36
