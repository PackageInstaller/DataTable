...
local function CreateNewBattleAIfb19(behavior)
  ...
  local node7 = Agent.UseSkill.Create(behavior, 6041101)
  ...
  local node11 = Agent.UseSkill.Create(behavior, 6041201)
  ...
  local node14 = Agent.MonsterSkillIsInCD.Create(behavior, 10041)
  local node15 = Agent.UseSkill.Create(behavior, 10041)
