...
local function CreateNewBattleAI80034(behavior)
  ...
  local node7 = Agent.UseSkill.Create(behavior, 201450)
  node6:SetTask(node7)
  node4:AddTask(node5)
  node4:AddTask(node6)
  ...
  local node11 = Agent.UseSkill.Create(behavior, 201451)
  ...
  local node15 = Agent.UseSkill.Create(behavior, 201452)
  node14:SetTask(node15)
  node12:AddTask(node13)
  node12:AddTask(node14)
  local node16 = Sequence.Create()
  local node17 = Agent.TimeCycle.Create(behavior, 480)
  local node18 = LoopUntil.Create(behavior, 1, true)
  local node19 = Agent.UseSkill.Create(behavior, 201453)
