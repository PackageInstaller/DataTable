...
local NationDaySignActivityTabCell = class("NationDaySignActivityTabCell", Dialog)
NationDaySignActivityTabCell.AssetBundleName = "ui/layouts.welfare"
NationDaySignActivityTabCell.AssetName = "SignActivityShiyi"

function NationDaySignActivityTabCell:Ctor(...)
  NationDaySignActivityTabCell.super.Ctor(self, ...)
  self._init = false
  self._itemList = {}
...
function NationDaySignActivityTabCell:OnCreate()
...
function NationDaySignActivityTabCell:OnDestroy()
...
function NationDaySignActivityTabCell:RefreshTabCell(activityId, refresh, refreshByProtocol)
  local tag
...
function NationDaySignActivityTabCell:OnCellClick(index)
...
function NationDaySignActivityTabCell:GetCanGetFirstIndex()
...
function NationDaySignActivityTabCell:RefreshTime()
...
function NationDaySignActivityTabCell:OnAnimationStateExit(handle, stateName, normalizedTime)
  if stateName == "SignActivty" then
    PlayEnableReceiveEffect(self)
  end
end

function NationDaySignActivityTabCell:OnEffectEnd(index, window, effectHandler)
...
return NationDaySignActivityTabCell
