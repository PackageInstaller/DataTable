...
function MonthSignCell:Ctor(...)
  MonthSignCell.super.Ctor(self, ...)
end

function MonthSignCell:OnCreate()
...
function MonthSignCell:OnDestroy()
end

function MonthSignCell:RefreshCell(data)
  self._title:SetText(NekoData.BehaviorManager.BM_Message:GetString(1911, {
    data.record.cumulativeDays
  }))
...
function MonthSignCell:OnGetBtnClicked()
...
function MonthSignCell:OnItemCellClicked()
