...
local BeforeChristmasSignActivityTabCell = class("BeforeChristmasSignActivityTabCell", Dialog)
BeforeChristmasSignActivityTabCell.AssetBundleName = "ui/layouts.welfare"
BeforeChristmasSignActivityTabCell.AssetName = "SignActivityFrontChristmas"

function BeforeChristmasSignActivityTabCell:Ctor(...)
  BeforeChristmasSignActivityTabCell.super.Ctor(self, ...)
  self._init = false
  self._itemList = {}
...
function BeforeChristmasSignActivityTabCell:OnCreate()
...
function BeforeChristmasSignActivityTabCell:OnDestroy()
...
function BeforeChristmasSignActivityTabCell:RefreshTabCell(activityId, refresh, refreshByProtocol)
  local tag
...
function BeforeChristmasSignActivityTabCell:OnCellClick(index)
...
function BeforeChristmasSignActivityTabCell:GetCanGetFirstIndex()
...
function BeforeChristmasSignActivityTabCell:RefreshTime()
...
function BeforeChristmasSignActivityTabCell:OnAnimationStateExit(handle, stateName, normalizedTime)
  if stateName == "SignActivty" then
    PlayEnableReceiveEffect(self)
  end
end

function BeforeChristmasSignActivityTabCell:OnEffectEnd(index, window, effectHandler)
...
return BeforeChristmasSignActivityTabCell
