...
function GrowGiftItemCell:Ctor(...)
  GrowGiftItemCell.super.Ctor(self, ...)
end

function GrowGiftItemCell:OnCreate()
...
function GrowGiftItemCell:OnDestroy()
end

function GrowGiftItemCell:RefreshCell(data)
...
function GrowGiftItemCell:OnCellClicked()
