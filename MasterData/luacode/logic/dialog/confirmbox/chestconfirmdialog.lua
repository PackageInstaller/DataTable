...
function ChestConfirmDialog:Ctor(...)
...
function ChestConfirmDialog:OnCreate()
...
function ChestConfirmDialog:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function ChestConfirmDialog:Refresh()
...
function ChestConfirmDialog:PushDialogSetting(id, yesfunc, yesargs, nofunc, noargs)
  local message = {}
  message.id = id
...
function ChestConfirmDialog:LoadData(data)
  self._messageStacks = data
  self:Refresh()
end

function ChestConfirmDialog:OnBackBtnClicked()
...
function ChestConfirmDialog:OnClickConfirmBtn()
...
function ChestConfirmDialog:GetCurMessageId()
