...
function DelayedSecondConfirmDialog:Ctor(...)
...
function DelayedSecondConfirmDialog:OnCreate()
...
function DelayedSecondConfirmDialog:OnDestroy()
  if self._task then
...
function DelayedSecondConfirmDialog:Refresh()
...
function DelayedSecondConfirmDialog:PushDialogSetting(id, parameter, yesfunc, yesargs, nofunc, noargs)
  local message = {}
  message.id = id
...
function DelayedSecondConfirmDialog:OnBackBtnClicked()
...
function DelayedSecondConfirmDialog:OnClickConfirmBtn()
