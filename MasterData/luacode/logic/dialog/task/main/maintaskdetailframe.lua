...
function MainTaskDetailFrame:Ctor(...)
  MainTaskDetailFrame.super.Ctor(self, ...)
  self._groupName = "Cell"
end

function MainTaskDetailFrame:OnCreate()
...
function MainTaskDetailFrame:OnDestroy()
...
function MainTaskDetailFrame:RefreshCell(data, delegate)
  self._cellData = data
...
function MainTaskDetailFrame:RefreshProgress()
...
function MainTaskDetailFrame:OnCommitClick()
...
function MainTaskDetailFrame:OnGoButtonClick()
  NekoData.BehaviorManager.BM_Task:HandleTask(self._cellData:GetID())
end

function MainTaskDetailFrame:NumberOfCell(helper)
  return #self._cellData:GetAwards()
end

function MainTaskDetailFrame:CellAtIndex(helper, index)
  return "task.taskawardcell"
end

function MainTaskDetailFrame:DataAtIndex(helper, index)
