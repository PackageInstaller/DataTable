...
function GuildChatLeftCell:Ctor(...)
  GuildChatLeftCell.super.Ctor(self, ...)
end

function GuildChatLeftCell:OnCreate()
...
function GuildChatLeftCell:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function GuildChatLeftCell:RefreshCell(data)
...
function GuildChatLeftCell:OnPhotoClicked()
...
function GuildChatLeftCell:OnTextClicked()
  self._reportBtn:SetActive(true)
end

function GuildChatLeftCell:OnReportBtnClicked()
  local data = {
    reportid = self._data.baseUserData.userId,
    nickname = self._data.baseUserData.userName,
    content = self._data.msg,
    time = self._data.sendTime // 1000,
    type = 3
  }
...
function GuildChatLeftCell:OnEveryWhereClick(args)
