...
function GuildChatLeftImageCell:Ctor(...)
  GuildChatLeftImageCell.super.Ctor(self, ...)
end

function GuildChatLeftImageCell:OnCreate()
...
function GuildChatLeftImageCell:RefreshCell(data)
...
function GuildChatLeftImageCell:OnPhotoClicked()
