...
function GuildChatRightCell:Ctor(...)
  GuildChatRightCell.super.Ctor(self, ...)
end

function GuildChatRightCell:OnCreate()
...
function GuildChatRightCell:RefreshCell(data)
...
function GuildChatRightCell:OnPhotoClicked()
