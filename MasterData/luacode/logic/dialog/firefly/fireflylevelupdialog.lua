...
function FireflyLevelUpDialog:Ctor(...)
...
function FireflyLevelUpDialog:OnCreate()
...
function FireflyLevelUpDialog:OnDestroy()
...
function FireflyLevelUpDialog:Init()
...
function FireflyLevelUpDialog:NumberOfCell()
  return #self._items
end

function FireflyLevelUpDialog:CellAtIndex()
  return "magictree.buildinglevelupitemcell"
end

function FireflyLevelUpDialog:DataAtIndex(frame, index)
  return self._items[index]
end

function FireflyLevelUpDialog:OnBackBtnClicked()
  self:Destroy()
end

function FireflyLevelUpDialog:OnConfirmBtnClicked()
