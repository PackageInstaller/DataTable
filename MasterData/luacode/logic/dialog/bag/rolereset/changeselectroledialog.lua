...
function ChangeSelectRoleDialog:Ctor(...)
...
function ChangeSelectRoleDialog:OnCreate()
...
function ChangeSelectRoleDialog:OnDestroy()
...
function ChangeSelectRoleDialog:Refresh()
  self:ScreeningAndSorting()
end

function ChangeSelectRoleDialog:OnRefresh(notification)
  self:Refresh()
  self:RefreshDownPanel()
end

function ChangeSelectRoleDialog:RefreshFashion()
  self:OnRefresh()
end
...
function ChangeSelectRoleDialog:OnSkillUnlock()
  RefreshSkillPanel(self)
end

function ChangeSelectRoleDialog:OnUniqueEquipLevelUp(notification)
...
function ChangeSelectRoleDialog:RefreshDownPanel()
...
function ChangeSelectRoleDialog:SetFilterCondition(condition)
...
function ChangeSelectRoleDialog:Init(data)
...
function ChangeSelectRoleDialog:OnSkill1Clicked()
...
function ChangeSelectRoleDialog:OnSkill2Clicked()
...
function ChangeSelectRoleDialog:OnCellLongPress()
...
function ChangeSelectRoleDialog:OnConfirmBtnClicked()
...
function ChangeSelectRoleDialog:SetSelectedID(str, roleKey)
...
function ChangeSelectRoleDialog:GetNumByRoleId(id)
  local count = 0
...
function ChangeSelectRoleDialog:ScreeningAndSorting()
...
function ChangeSelectRoleDialog:OnFilterBtnClick()
...
function ChangeSelectRoleDialog:OnLevelBtnClick()
  if not self._filterDlg then
    LogError("[Dialog]: ", "Common filter dlg create error")
    return
  end
...
function ChangeSelectRoleDialog:OnSortBtnClick()
...
function ChangeSelectRoleDialog:OnLockBtnClick()
...
function ChangeSelectRoleDialog:SetSortCriteriaNameId(nameId)
...
function ChangeSelectRoleDialog:SetScreeningConditions(screeningConditions)
  self._screeningConditions = screeningConditions
  self:ScreeningAndSorting()
end

function ChangeSelectRoleDialog:NumberOfCell(frame)
  return #self._listByConditions
end

function ChangeSelectRoleDialog:CellAtIndex(frame)
  return "bag.rolereset.changeselectrolecell"
end

function ChangeSelectRoleDialog:DataAtIndex(frame, index)
  return self._listByConditions[index]
end

function ChangeSelectRoleDialog:OnCurPosChange(frame, proportion)
...
function ChangeSelectRoleDialog:OnBackBtnClicked()
  self:Destroy()
end

function ChangeSelectRoleDialog:OnMenuBtnClicked()
  DialogManager.CreateSingletonDialog("fastmenu.fastmenudialog")
end

function ChangeSelectRoleDialog:ReturnRoleList()
  local roleList = {}
...
function ChangeSelectRoleDialog:SetSupportVocationTable(supportVocationTable)
...
function ChangeSelectRoleDialog:SendCUpdateUISortType()
end
