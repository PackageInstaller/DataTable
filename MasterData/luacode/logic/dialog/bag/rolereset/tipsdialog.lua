...
local TopToBottom = 4
local TipDialog = class("TipDialog", Dialog)
TipDialog.AssetBundleName = "ui/layouts.bag"
TipDialog.AssetName = "RoleRestartMainTips"

function TipDialog:Ctor(...)
  TipDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function TipDialog:OnCreate()
...
function TipDialog:SetStaticRes()
  self._title:SetText(TextManager.GetText(701832))
end

function TipDialog:OnDestroy()
end

function TipDialog:OnBackBtnClicked()
  self:Destroy()
end

function TipDialog:SetData(textID)
...
function TipDialog:OnCurPosChange(frame, proportion)
