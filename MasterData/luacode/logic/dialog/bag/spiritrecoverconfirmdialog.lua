...
function SpiritRecoverConfirmDialog:Ctor(...)
  SpiritRecoverConfirmDialog.super.Ctor(self, ...)
  self._groupName = "SecondConfirm"
end

function SpiritRecoverConfirmDialog:OnCreate()
...
function SpiritRecoverConfirmDialog:Refresh(data, name, deltime)
...
function SpiritRecoverConfirmDialog:OnBackBtnClicked()
  self:Destroy()
end

function SpiritRecoverConfirmDialog:OnConfirmBtnClicked()
