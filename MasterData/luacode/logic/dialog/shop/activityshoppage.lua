...
function ActivityShopPage:Ctor(...)
...
function ActivityShopPage:OnCreate()
...
function ActivityShopPage:OnDestroy()
...
function ActivityShopPage:RefreshCell(data)
  self._data = data
...
function ActivityShopPage:NumberOfCell(frame)
...
function ActivityShopPage:CellAtIndex(frame, index)
  if frame == self._groupBtnFrame then
...
function ActivityShopPage:DataAtIndex(frame, index)
  if frame == self._groupBtnFrame then
...
function ActivityShopPage:OnGroupBtnClicked(id)
  self._delegate:OnGroupBtnClicked(id)
end

function ActivityShopPage:OnCurPosChange(frame, proportion)
...
function ActivityShopPage:OnEvent(eventName, arg)
...
function ActivityShopPage:CountDown()
...
function ActivityShopPage:PlayTabShowAnimation()
