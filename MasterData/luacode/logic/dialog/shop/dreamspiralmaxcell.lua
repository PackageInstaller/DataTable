...
function DreamSpiralMaxCell:Ctor(...)
  DreamSpiralMaxCell.super.Ctor(self, ...)
end

function DreamSpiralMaxCell:OnCreate()
...
function DreamSpiralMaxCell:OnDestroy()
end

function DreamSpiralMaxCell:RefreshCell(data)
  self._data = data
...
function DreamSpiralMaxCell:OnCellClicked()
