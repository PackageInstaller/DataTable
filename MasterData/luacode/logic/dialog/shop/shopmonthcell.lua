...
function ShopMonthCell:Ctor(...)
  ShopMonthCell.super.Ctor(self, ...)
end

function ShopMonthCell:OnCreate()
...
function ShopMonthCell:OnDestroy()
end

function ShopMonthCell:RefreshCell(data)
  self._data = data
...
function ShopMonthCell:RefreshTime()
  ...
  elseif self._data.iteminfo.goodType == 17 then
...
function ShopMonthCell:OnEvent(eventName, arg)
...
function ShopMonthCell:OnCellClicked()
...
function ShopMonthCell:ShowRedDot()
