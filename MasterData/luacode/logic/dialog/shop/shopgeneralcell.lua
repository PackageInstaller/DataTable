...
function ShopGeneralCell:Ctor(...)
  ShopGeneralCell.super.Ctor(self, ...)
end

function ShopGeneralCell:OnCreate()
...
function ShopGeneralCell:OnDestroy()
end

function ShopGeneralCell:RefreshCell(data)
  self._data = data
  ...
  if not (data.iteminfo.beginTime and data.iteminfo.endTime) or data.iteminfo.beginTime == 0 or data.iteminfo.endTime == 0 then
...
function ShopGeneralCell:OnCellClicked()
...
function ShopGeneralCell:OnEvent(eventName, arg)
