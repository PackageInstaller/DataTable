...
function EquipBoxBuyDialog:Ctor(...)
...
function EquipBoxBuyDialog:OnCreate()
...
function EquipBoxBuyDialog:OnDestroy()
  self._frame:Destroy()
...
function EquipBoxBuyDialog:InitData(data)
  self._shopID = 16
  self._data = data
...
function EquipBoxBuyDialog:OnBuyBtnClicked()
...
function EquipBoxBuyDialog:OnDetailBtnClicked()
...
function EquipBoxBuyDialog:OnBackBtnClicked(args)
  self:Destroy()
end

function EquipBoxBuyDialog:OnMenuBtnClicked()
  DialogManager.CreateSingletonDialog("fastmenu.fastmenudialog")
end

function EquipBoxBuyDialog:OnBuyEquipChest(notification)
...
function EquipBoxBuyDialog:NumberOfCell(frame)
...
function EquipBoxBuyDialog:CellAtIndex(frame, index)
  if frame == self._topGroupFrame then
...
function EquipBoxBuyDialog:DataAtIndex(frame, index)
  if frame == self._topGroupFrame then
...
function EquipBoxBuyDialog:CountDown()
...
function EquipBoxBuyDialog:RefreshTopGroundFrame()
  self._topGroupFrame:ReloadAllCell()
end
