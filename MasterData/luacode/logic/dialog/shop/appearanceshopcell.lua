...
local RoleTypeId = 27
local AppearancesShopCell = class("AppearancesShopCell", Dialog)
AppearancesShopCell.AssetBundleName = "ui/layouts.baseshop"
AppearancesShopCell.AssetName = "AppearanceShopShopCell"

function AppearancesShopCell:Ctor(...)
  AppearancesShopCell.super.Ctor(self, ...)
end

function AppearancesShopCell:OnCreate()
...
function AppearancesShopCell:OnDestroy()
end

function AppearancesShopCell:RefreshCell(data)
  self._data = data
...
function AppearancesShopCell:OnCellClicked()
...
function AppearancesShopCell:OnEvent(eventName, arg)
