...
function DreamSpiralUnlockDialog:Refresh(moneyType)
  ...
  if Live2DManager.CanUse() and shapeRecord.live2DPrefabName ~= "" and shapeRecord.live2DPrefabName ~= nil and shapeRecord.live2DAssetBundleName ~= "" and shapeRecord.live2DAssetBundleName ~= nil then
