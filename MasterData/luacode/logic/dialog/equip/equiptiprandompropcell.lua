...
function EquipTipRandomPropCell:Ctor(...)
  EquipTipRandomPropCell.super.Ctor(self, ...)
end

function EquipTipRandomPropCell:OnCreate()
...
function EquipTipRandomPropCell:OnDestroy()
end

function EquipTipRandomPropCell:RefreshCell(data)
