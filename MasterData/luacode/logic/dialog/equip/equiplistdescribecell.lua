...
function EquipListDescribeCell:Ctor(...)
  EquipListDescribeCell.super.Ctor(self, ...)
end

function EquipListDescribeCell:OnCreate()
...
function EquipListDescribeCell:OnDestroy()
end

function EquipListDescribeCell:RefreshCell(data)
