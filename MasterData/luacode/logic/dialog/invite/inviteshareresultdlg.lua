...
InviteShareDialog.AssetBundleName = "ui/layouts.invite"
InviteShareDialog.AssetName = "InviteShareFullScreen"
...
function InviteShareDialog:Init(showShareInfo, invideCode, shared)
  if showShareInfo then
    ...
    local record = CShareReward:GetRecorder(3)
