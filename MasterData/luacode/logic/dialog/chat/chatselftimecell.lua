...
function ChatSelfTimeCell:Ctor(...)
...
function ChatSelfTimeCell:OnCreate()
...
function ChatSelfTimeCell:OnDestroy()
end

function ChatSelfTimeCell:RefreshCell(data)
...
function ChatSelfTimeCell:OnBeginLongPress(args)
