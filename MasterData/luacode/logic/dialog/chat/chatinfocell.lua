...
function ChatInfoCell:OnCreate()
...
function ChatInfoCell:OnDestroy()
end

function ChatInfoCell:RefreshCell(data)
...
function ChatInfoCell:OnBeginLongPress(args)
...
function ChatInfoCell:OnIconClicked()
