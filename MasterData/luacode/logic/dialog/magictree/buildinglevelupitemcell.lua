...
function BuildingLevelUpItemCell:Ctor(...)
  BuildingLevelUpItemCell.super.Ctor(self, ...)
end

function BuildingLevelUpItemCell:OnCreate()
...
function BuildingLevelUpItemCell:OnDestroy()
end

function BuildingLevelUpItemCell:RefreshCell(data)
...
function BuildingLevelUpItemCell:OnCellClicked()
...
function BuildingLevelUpItemCell:OnEvent(eventName, arg)
