...
function CharactorInfoDetailDialog:Ctor(...)
  CharactorInfoDetailDialog.super.Ctor(self, ...)
  self._groupName = "Modal"
end

function CharactorInfoDetailDialog:OnCreate(root)
...
function CharactorInfoDetailDialog:OnDestroy()
end

function CharactorInfoDetailDialog:OnBackBtnClicked()
  DialogManager.DestroySingletonDialog("battleeditor.charactorinfodetaildialog")
end

function CharactorInfoDetailDialog:RefreshRoleInfoDetail(id)
  ...
  local imageRecord = CImagePathTable:GetRecorder(shapeRecord.lihuiID) or DataCommon.DefaultImageAsset
