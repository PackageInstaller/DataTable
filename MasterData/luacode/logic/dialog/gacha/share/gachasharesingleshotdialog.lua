...
function GachaShareSingleShotDialog:Ctor(...)
  GachaShareSingleShotDialog.super.Ctor(self, ...)
  self._groupName = "Modal"
end

function GachaShareSingleShotDialog:OnCreate()
...
function GachaShareSingleShotDialog:OnDestroy()
  if self._timer then
...
function GachaShareSingleShotDialog:SetData(card)
  self._card = card
  self:Refresh()
end

function GachaShareSingleShotDialog:Refresh()
...
function GachaShareSingleShotDialog:SetEffect()
...
function GachaShareSingleShotDialog:OnAnimationEnter(handle, stateName, normalizedTime)
  if stateName == "GachaSSR" or stateName == "GachaSR" or stateName == "GachaR" or stateName == "GachaUR" or stateName == "GachaEX" then
    self:OnShareClick()
  end
end

function GachaShareSingleShotDialog:OnShareClick(args)
...
function GachaShareSingleShotDialog:NumberOfCell(frame, index)
  return #self._itemList
end

function GachaShareSingleShotDialog:CellAtIndex(frame, index)
  return "gacha.gachagetcarditemcell"
end

function GachaShareSingleShotDialog:DataAtIndex(frame, index)
