...
function TwoCardCell:GetCellName(data)
  local rarity = data.role:GetRarityId()
  return cellList[rarity]
end

function TwoCardCell:RefreshCell(data)
  self._data = data
...
function TwoCardCell:CheckRoleInfo(args)
  self._delegate:CheckRoleInfo(args)
end

function TwoCardCell:OnEvent(name, args)
