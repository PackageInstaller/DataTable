...
function CharacterElementInfoDialog:Ctor(...)
  CharacterElementInfoDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function CharacterElementInfoDialog:OnCreate()
...
function CharacterElementInfoDialog:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function CharacterElementInfoDialog:SetData(roleId)
  ...
  imgRecord = CImagePathTable:GetRecorder(elementRecord.image) or DataCommon.DefaultImageAsset
...
function CharacterElementInfoDialog:OnGlobalPointerDown(args)
...
function CharacterElementInfoDialog:OnBackBtnClicked()
  self:Destroy()
end
