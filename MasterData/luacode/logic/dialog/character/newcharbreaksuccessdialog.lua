...
function NewCharBreakSuccessDialog:Ctor(...)
...
function NewCharBreakSuccessDialog:OnCreate()
...
function NewCharBreakSuccessDialog:OnDestroy()
...
function NewCharBreakSuccessDialog:SetData(data)
...
function NewCharBreakSuccessDialog:SetLive2D(role, fashionData)
...
function NewCharBreakSuccessDialog:OnEffectEnd()
  if self._effectHandler then
    self._effectHandler = nil
  end
...
function NewCharBreakSuccessDialog:SetLines(linesTextID, animationID)
  if self._L2DHandler then
...
function NewCharBreakSuccessDialog:OnBackBtnClicked()
...
function NewCharBreakSuccessDialog:Skip()
...
function NewCharBreakSuccessDialog:ShowResult()
...
function NewCharBreakSuccessDialog:OnUpdate(notification)
