...
function LevelUpMsgTipDialog:Ctor(...)
...
function LevelUpMsgTipDialog:OnCreate()
end

function LevelUpMsgTipDialog:OnDestroy()
...
function LevelUpMsgTipDialog:OnRefresh()
...
function LevelUpMsgTipDialog:AddMessageTip(msg)
  local msgCell = {}
...
function LevelUpMsgTipDialog:OnBackBtnClicked()
