...
local EquipSuitTipsSuitSkillCell = class("EquipSuitTipsSuitSkillCell", Dialog)
EquipSuitTipsSuitSkillCell.AssetBundleName = "ui/layouts.basecharacterinfo"
EquipSuitTipsSuitSkillCell.AssetName = "EquipSuitTipsCell2"
local StrTextID = {
  [1] = 1494,
  [2] = 1495,
  [3] = 1496
...
function EquipSuitTipsSuitSkillCell:Ctor(...)
  EquipSuitTipsSuitSkillCell.super.Ctor(self, ...)
end

function EquipSuitTipsSuitSkillCell:OnCreate()
  self._text = self:GetChild("Txt1")
...
function EquipSuitTipsSuitSkillCell:OnDestroy()
end

function EquipSuitTipsSuitSkillCell:RefreshCell(data)
  local color
...
return EquipSuitTipsSuitSkillCell
