...
local RelationRegion1Dialog = class("RelationRegion1Dialog", Dialog)
RelationRegion1Dialog.AssetBundleName = "ui/layouts.tujiannew"
RelationRegion1Dialog.AssetName = "RelationRegion1"

function RelationRegion1Dialog:Ctor(...)
  RelationRegion1Dialog.super.Ctor(self, ...)
...
function RelationRegion1Dialog:OnCreate()
  ...
  self._teamBtn5 = self:GetChild("TeamBtn5")
  ...
  self._teamBtn5:Subscribe_PointerClickEvent(function()
    self:OnBtnClicked(5)
  end, self)
...
function RelationRegion1Dialog:OnDestroy()
  self._deleget:OnEnable()
  self._handBookSceneController:SetCameraAnimatorState(0)
end

function RelationRegion1Dialog:Init(deleget, dialogIndex)
  self._deleget = deleget
  self._dialogIndex = dialogIndex
end

function RelationRegion1Dialog:OnBtnClicked(index)
...
function RelationRegion1Dialog:OnAnimationStateExit(handler, stateName, normalizedTime)
...
function RelationRegion1Dialog:OnEnable()
  self._animator:SetInteger("state", 1)
end

function RelationRegion1Dialog:ToBookList()
  self._deleget:ToBookList()
  self:Destroy()
end

function RelationRegion1Dialog:OnBackBtnClicked()
  self:Destroy()
end

return RelationRegion1Dialog
