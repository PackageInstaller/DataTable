...
function NpcDetailInfoDialog:Ctor(...)
...
function NpcDetailInfoDialog:OnCreate()
...
function NpcDetailInfoDialog:OnDestroy()
  self._pageHelper:Destroy()
end

function NpcDetailInfoDialog:Init(npcid)
...
function NpcDetailInfoDialog:Refresh(npcid, roleid)
...
function NpcDetailInfoDialog:OnGroupClick(index)
  self._pageHelper:ToPage(index)
end

function NpcDetailInfoDialog:DidToPage(helper, index)
...
function NpcDetailInfoDialog:CellAtIndex(helper, index)
  if index == 1 then
...
function NpcDetailInfoDialog:OnViewBtnClick(...)
  self:GetRootWindow():SetAnimatorInteger("state", 1)
  self._fullShow = true
end

function NpcDetailInfoDialog:OnBackBtnClicked()
...
function NpcDetailInfoDialog:OnMenuBtnClicked()
  DialogManager.CreateSingletonDialog("fastmenu.fastmenudialog")
end

function NpcDetailInfoDialog:OnRoleEvaluationBtnClicked()
...
function NpcDetailInfoDialog:OnLeftArrowClick()
  if self._pos == 1 then
    self._pos = #self._npcList
  else
...
function NpcDetailInfoDialog:OnRightArrowClick()
...
function NpcDetailInfoDialog:OnCutoverBtnClick()
