...
function EquipBookWordDescribeCell:Ctor(...)
  EquipBookWordDescribeCell.super.Ctor(self, ...)
end

function EquipBookWordDescribeCell:OnCreate()
...
function EquipBookWordDescribeCell:OnDestroy()
end

function EquipBookWordDescribeCell:RefreshCell(data)
