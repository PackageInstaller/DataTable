...
local RelationRegion4Dialog = class("RelationRegion4Dialog", Dialog)
RelationRegion4Dialog.AssetBundleName = "ui/layouts.tujiannew"
RelationRegion4Dialog.AssetName = "RelationRegion4"

function RelationRegion4Dialog:Ctor(...)
  RelationRegion4Dialog.super.Ctor(self, ...)
...
function RelationRegion4Dialog:OnCreate()
...
function RelationRegion4Dialog:OnDestroy()
  self._deleget:OnEnable()
  self._handBookSceneController:SetCameraAnimatorState(0)
end

function RelationRegion4Dialog:Init(deleget, dialogIndex)
  self._deleget = deleget
  self._dialogIndex = dialogIndex
end

function RelationRegion4Dialog:OnBtnClicked(index)
...
function RelationRegion4Dialog:OnAnimationStateExit(handler, stateName, normalizedTime)
...
function RelationRegion4Dialog:OnEnable()
  self._animator:SetInteger("state", 1)
end

function RelationRegion4Dialog:ToBookList()
  self._deleget:ToBookList()
  self:Destroy()
end

function RelationRegion4Dialog:OnBackBtnClicked()
  self:Destroy()
end

return RelationRegion4Dialog
