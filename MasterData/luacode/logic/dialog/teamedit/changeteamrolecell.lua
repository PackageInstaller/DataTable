...
function ChangeTeamRoleCell:Ctor(...)
  ChangeTeamRoleCell.super.Ctor(self, ...)
  self._sameTag = false
end

function ChangeTeamRoleCell:OnCreate()
...
function ChangeTeamRoleCell:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function ChangeTeamRoleCell:RefreshCell(data)
...
function ChangeTeamRoleCell:IsSameWithTeamRoles()
...
function ChangeTeamRoleCell:OnCellClicked()
...
function ChangeTeamRoleCell:OnEvent(eventName, arg)
