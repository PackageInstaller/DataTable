...
function UndecidedRoadTeamEditDialog:Ctor(...)
...
function UndecidedRoadTeamEditDialog:OnCreate()
...
function UndecidedRoadTeamEditDialog:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
  UIBackManager.SetUIBackShow(false)
end

function UndecidedRoadTeamEditDialog:SetCopyInfo(copyType, id, additionalData, supportVocationTable)
...
function UndecidedRoadTeamEditDialog:SetSupportVocationTable(supportVocationTable)
  if supportVocationTable and 0 < #supportVocationTable then
...
function UndecidedRoadTeamEditDialog:DestroyModal(dialog)
end

function UndecidedRoadTeamEditDialog:OnRefreshSpirit(notification)
  self._spirit = notification.userInfo.spirit
end

function UndecidedRoadTeamEditDialog:OnRefreshCurrency()
end

function UndecidedRoadTeamEditDialog:RefreshFashion()
...
function UndecidedRoadTeamEditDialog:CheckTeamRationalForBeginTask()
...
function UndecidedRoadTeamEditDialog:OnRefreshTeam(notification)
  self:LoadLocalData()
...
function UndecidedRoadTeamEditDialog:OnRefresh(notification)
  self:LoadLocalData()
  self:Refresh(self._teamId)
end

function UndecidedRoadTeamEditDialog:LoadLocalData()
...
function UndecidedRoadTeamEditDialog:Refresh(teamId)
...
function UndecidedRoadTeamEditDialog:CheckIfTeamRational()
...
function UndecidedRoadTeamEditDialog:RefreshTeamElementInfo()
...
function UndecidedRoadTeamEditDialog:OnEnterDungeon()
...
function UndecidedRoadTeamEditDialog:OnBtn1Clicked()
...
function UndecidedRoadTeamEditDialog:OnBtn4Clicked()
...
function UndecidedRoadTeamEditDialog:BeginTaskBtnClicked()
  local tag = false
  ...
  elseif self._copyType == "UndecidedRoad" then
    ...
    csend:Send()
  elseif self._copyType == "ChristmasBoss" then
...
function UndecidedRoadTeamEditDialog:OnTeamClicked(index)
  for i, v in ipairs(self._teamBtn) do
    if v.editBtn then
      v.editBtn:SetActive(false)
    end
...
function UndecidedRoadTeamEditDialog:OnTeamNameEditClicked()
...
function UndecidedRoadTeamEditDialog:ReturnRoleList()
  local roleList = {}
  for _, v in ipairs(self._curTeamRoles) do
    if v.roleKey ~= 0 then
...
function UndecidedRoadTeamEditDialog:OnBackBtnClicked()
  self:Destroy()
end

function UndecidedRoadTeamEditDialog:OnMenuBtnClicked()
  DialogManager.CreateSingletonDialog("fastmenu.fastmenudialog")
end

function UndecidedRoadTeamEditDialog:OnCharPosLockClicked(posIndex)
  NekoData.BehaviorManager.BM_Message:SendMessageById(100244)
end

function UndecidedRoadTeamEditDialog:OnCharPosClicked(posIndex)
...
function UndecidedRoadTeamEditDialog:OnCharCellBeginDrag(screenPosition, data)
  self._draging = true
...
function UndecidedRoadTeamEditDialog:OnCharCellDrag(screenPosition, data)
...
function UndecidedRoadTeamEditDialog:OnCharCellEndDrag(screenPosition, data)
  self._draging = false
...
function UndecidedRoadTeamEditDialog:OnSwitchPositionBtnClicked()
  if self._inSwitchPositionState then
...
function UndecidedRoadTeamEditDialog:OnAutoTeamBtnClicked()
...
function UndecidedRoadTeamEditDialog:OnElementBtnClicked()
