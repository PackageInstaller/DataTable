...
function CheckRoleSkillTipsDialog:Ctor(...)
  CheckRoleSkillTipsDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
  self._data = {}
end

function CheckRoleSkillTipsDialog:OnCreate()
...
function CheckRoleSkillTipsDialog:OnDestroy()
  self._frame:Destroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function CheckRoleSkillTipsDialog:Init(data)
  self._data = {}
...
function CheckRoleSkillTipsDialog:ShouldLengthChange()
  return true
end

function CheckRoleSkillTipsDialog:SetSkillTipsPosition(cell_width, cell_height, cellScreenPosition)
  self._backWidth, self._backHeight = self._back:GetRectSize()
  local newPos = {}
...
function CheckRoleSkillTipsDialog:NumberOfCell(frame, index)
  return #self._data
end

function CheckRoleSkillTipsDialog:CellAtIndex(frame, index)
  return "mainline.bossrush.checkotherroleskilltipscell"
end

function CheckRoleSkillTipsDialog:DataAtIndex(frame, index)
  return self._data[index]
end

function CheckRoleSkillTipsDialog:OnGlobalPointerDown(args)
...
function CheckRoleSkillTipsDialog:OnBackBtnClicked()
  self:Destroy()
end
