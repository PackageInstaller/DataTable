...
function ChooseSupportRoleCell:Ctor(...)
  ChooseSupportRoleCell.super.Ctor(self, ...)
end

function ChooseSupportRoleCell:OnCreate()
...
function ChooseSupportRoleCell:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function ChooseSupportRoleCell:RefreshCell(data)
...
function ChooseSupportRoleCell:OnCellClicked()
