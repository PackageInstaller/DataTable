...
function IdentityTabCell:Ctor(...)
  IdentityTabCell.super.Ctor(self, ...)
end

function IdentityTabCell:OnCreate()
...
function IdentityTabCell:OnDestroy()
end

function IdentityTabCell:RefreshTabCell()
...
function IdentityTabCell:OnPhoneBindBtnClicked()
...
function IdentityTabCell:OnMailboxBindBtnClicked()
...
function IdentityTabCell:OnCodeBtnClicked()
  DialogManager.CreateSingletonDialog("systemsetting.code.codedialog")
end

function IdentityTabCell:OnServiceClick()
