...
function TowerItemAccountDialog:Ctor(...)
...
function TowerItemAccountDialog:OnCreate()
  self._width, self._height = self:GetRootWindow():GetRectSize()
end

function TowerItemAccountDialog:OnDestroy()
...
function TowerItemAccountDialog:SetData(protocol)
  local itemAccounts = {}
...
function TowerItemAccountDialog:ProcessData()
  local itemCell = {}
...
function TowerItemAccountDialog:OnRefresh()
  if #self._cellInfo == 0 then
    if #self._dataList == 0 then
      self:Destroy()
    end
