...
function DetailWorkingCell:Ctor(...)
  DetailWorkingCell.super.Ctor(self, ...)
  self._getItems = {}
end

function DetailWorkingCell:OnCreate()
  ...
  self._width, self._height = self._rolePanel:GetRectSize()
  self._anchoredx, self._anchoredy = self._rolePanel:GetAnchoredPosition()
...
function DetailWorkingCell:OnDestroy()
  self._roleFrame:Destroy()
  self._itemFrame:Destroy()
end

function DetailWorkingCell:ChangeCellPosition()
...
function DetailWorkingCell:RefreshCell(data)
  self._data = data
...
function DetailWorkingCell:RefreshTimeState()
...
function DetailWorkingCell:OnGetBtnClicked()
...
function DetailWorkingCell:OnFinishBtnClicked()
...
function DetailWorkingCell:OnRolePanelClicked()
end

function DetailWorkingCell:NumberOfCell(frame)
...
function DetailWorkingCell:CellAtIndex(frame, index)
  if frame == self._roleFrame then
...
function DetailWorkingCell:DataAtIndex(frame, index)
  if frame == self._roleFrame then
...
function DetailWorkingCell:OnEvent(eventName, arg)
  if eventName == "RefreshTimeState" and self._data.taskState ~= SlotStateEnum.DEADLINE then
    self:RefreshTimeState()
  end
end

function DetailWorkingCell:OnIBtnClicked()
