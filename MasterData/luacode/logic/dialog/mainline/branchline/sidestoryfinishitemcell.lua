...
function SideStoryFinishItemCell:Ctor(...)
  SideStoryFinishItemCell.super.Ctor(self, ...)
end

function SideStoryFinishItemCell:OnCreate()
...
function SideStoryFinishItemCell:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function SideStoryFinishItemCell:RefreshCell(data)
...
function SideStoryFinishItemCell:OnCellClicked(args)
  local tipsDialog
