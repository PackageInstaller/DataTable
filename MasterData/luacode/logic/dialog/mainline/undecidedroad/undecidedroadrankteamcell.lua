...
function UndecidedRoadRankTeamRoleCell:Ctor(...)
  UndecidedRoadRankTeamRoleCell.super.Ctor(self, ...)
  self._handler = 0
end

function UndecidedRoadRankTeamRoleCell:OnCreate()
...
function UndecidedRoadRankTeamRoleCell:OnDestroy()
end

function UndecidedRoadRankTeamRoleCell:RefreshCell(data)
...
function UndecidedRoadRankTeamRoleCell:OnCellClicked()
