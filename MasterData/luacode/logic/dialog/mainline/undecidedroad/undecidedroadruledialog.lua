...
function UndecidedRoadRuleDialog:Ctor(...)
  UndecidedRoadRuleDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function UndecidedRoadRuleDialog:OnCreate()
...
function UndecidedRoadRuleDialog:Init()
...
function UndecidedRoadRuleDialog:OnDestroy()
end

function UndecidedRoadRuleDialog:OnBackBtnClicked()
  self:Destroy()
end
