...
function OfflinePvpAccountDialog:Ctor(...)
  OfflinePvpAccountDialog.super.Ctor(self, ...)
  self._groupName = "Modal"
  self._data = {}
end

function OfflinePvpAccountDialog:OnCreate()
...
function OfflinePvpAccountDialog:OnDestroy()
  self._itemFrame:Destroy()
end

function OfflinePvpAccountDialog:Init(data)
  self._data = {}
  ...
  local titleStr, imgRecord, imgRecord1, imgRecord2
  if data.victory == 1 then
...
function OfflinePvpAccountDialog:NumberOfCell(frame)
  return #self._data
end

function OfflinePvpAccountDialog:CellAtIndex(frame, index)
  return "mainline.offlinepvp.offlinepvpaccountcell"
end

function OfflinePvpAccountDialog:DataAtIndex(frame, index)
  return self._data[index]
end

function OfflinePvpAccountDialog:OnGoOnBtnClicked()
...
function OfflinePvpAccountDialog:OnBackBtnClicked()
  self:Destroy()
end

function OfflinePvpAccountDialog:OnMenuBtnClicked()
