...
TipDialog.AssetBundleName = "ui/layouts.dispatchbattle"
TipDialog.AssetName = "DispatchBattleTips"
...
function TipDialog:SetData(textID, titleTxtid)
  self._text:SetText(TextManager.GetText(textID))
  self._title:SetText(TextManager.GetText(titleTxtid))
