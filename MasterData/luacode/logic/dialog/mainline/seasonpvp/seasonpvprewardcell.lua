...
local SeasonPvpRewardCell = class("SeasonPvpRewardCell", Dialog)
SeasonPvpRewardCell.AssetBundleName = "ui/layouts.seasonpvp"
SeasonPvpRewardCell.AssetName = "SeasonPVPRewardCell"

function SeasonPvpRewardCell:Ctor(...)
  SeasonPvpRewardCell.super.Ctor(self, ...)
end

function SeasonPvpRewardCell:OnCreate()
...
function SeasonPvpRewardCell:OnDestroy()
end

function SeasonPvpRewardCell:RefreshCell(data)
