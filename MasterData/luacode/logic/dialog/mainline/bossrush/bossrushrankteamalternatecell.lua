...
function BossRushRankTeamAlternateCell:Ctor(...)
  BossRushRankTeamAlternateCell.super.Ctor(self, ...)
end

function BossRushRankTeamAlternateCell:OnCreate()
...
function BossRushRankTeamAlternateCell:OnDestroy()
end

function BossRushRankTeamAlternateCell:RefreshCell(data)
...
function BossRushRankTeamAlternateCell:OnCellClicked()
