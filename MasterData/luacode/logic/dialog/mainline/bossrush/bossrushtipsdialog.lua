...
function BossRushTipsDialog:Ctor(...)
  BossRushTipsDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function BossRushTipsDialog:OnCreate()
...
function BossRushTipsDialog:OnDestroy()
end

function BossRushTipsDialog:OnBackBtnClicked()
  self:Destroy()
end

function BossRushTipsDialog:SetData(titleTextID, contentTextID)
...
function BossRushTipsDialog:OnCurPosChange(frame, proportion)
