...
function MainLineDialogCell:Ctor(...)
  MainLineDialogCell.super.Ctor(self, ...)
  self._world1GuideEffectHandler = nil
end

function MainLineDialogCell:OnCreate()
  self._worldBtn = {}
  for i = 1, 2 do
    self._worldBtn[i] = {
      whole = self:GetChild("Frame/World" .. i),
      lockImg = self:GetChild("Frame/World" .. i .. "/MapGrey"),
      unlockImg = self:GetChild("Frame/World" .. i .. "/Map"),
      namePanel = self:GetChild("Frame/World" .. i .. "/WorldName"),
      nameTxt = self:GetChild("Frame/World" .. i .. "/WorldName/Name"),
      describe = self:GetChild("Frame/World" .. i .. "/WorldName/Detail"),
      chapter = self:GetChild("Frame/World" .. i .. "/WorldName/Chapter"),
      lock = self:GetChild("Frame/World" .. i .. "/Lock"),
      new = self:GetChild("Frame/World" .. i .. "/New"),
      reddot = self:GetChild("Frame/World" .. i .. "/RedDot")
    }
  end
  self._worldBtn[3] = {
    whole = self:GetChild("Frame/Break1"),
    lockImg = self:GetChild("Frame/Break1/MapGrey"),
    unlockImg = self:GetChild("Frame/Break1/Map"),
    namePanel = self:GetChild("Frame/Break1/WorldName"),
    nameTxt = self:GetChild("Frame/Break1/WorldName/Name"),
    describe = self:GetChild("Frame/Break1/WorldName/Detail"),
    chapter = self:GetChild("Frame/Break1/WorldName/Chapter"),
    lock = self:GetChild("Frame/Break1/Lock"),
    new = self:GetChild("Frame/Break1/New"),
    title = self:GetChild("Frame/Break1/Title"),
    reddot = self:GetChild("Frame/Break1/RedDot")
  }
  self._worldBtn[4] = {
    whole = self:GetChild("Frame/World3"),
    lockImg = self:GetChild("Frame/World3/MapGrey"),
    unlockImg = self:GetChild("Frame/World3/Map"),
    namePanel = self:GetChild("Frame/World3/WorldName"),
    nameTxt = self:GetChild("Frame/World3/WorldName/Name"),
    describe = self:GetChild("Frame/World3/WorldName/Detail"),
    chapter = self:GetChild("Frame/World3/WorldName/Chapter"),
    lock = self:GetChild("Frame/World3/Lock"),
    new = self:GetChild("Frame/World3/New"),
    reddot = self:GetChild("Frame/World3/RedDot")
  }
...
function MainLineDialogCell:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function MainLineDialogCell:RefreshCell(data)
  self._data = {}
...
local function ProcessUnlockClick(self, i)
...
local function ProcessLockClick(self, i)
end

function MainLineDialogCell:OnWorld1UnlockClicked()
  ProcessUnlockClick(self, 1)
end

function MainLineDialogCell:OnWorld1LockClicked()
  ProcessLockClick(1)
end

function MainLineDialogCell:OnWorld2UnlockClicked()
  ProcessUnlockClick(self, 2)
end

function MainLineDialogCell:OnWorld2LockClicked()
  ProcessLockClick(2)
end

function MainLineDialogCell:OnWorld3UnlockClicked()
  ProcessUnlockClick(self, 3)
end

function MainLineDialogCell:OnWorld3LockClicked()
  ProcessLockClick(3)
end

function MainLineDialogCell:OnWorld4UnlockClicked()
  ProcessUnlockClick(self, 4)
end

function MainLineDialogCell:OnWorld4LockClicked()
  ProcessLockClick(4)
end

function MainLineDialogCell:OnEvent(eventName, arg)
