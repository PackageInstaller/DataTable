...
function GuildBossTipsDialog:Ctor(...)
  GuildBossTipsDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function GuildBossTipsDialog:OnCreate()
...
function GuildBossTipsDialog:OnDestroy()
end

function GuildBossTipsDialog:OnBackBtnClicked()
  self:Destroy()
end

function GuildBossTipsDialog:SetData(contentTextID)
...
function GuildBossTipsDialog:OnCurPosChange(frame, proportion)
