...
function GuildBossInfoCell:Ctor(...)
  GuildBossInfoCell.super.Ctor(self, ...)
  self._groupName = "Cell"
end

function GuildBossInfoCell:OnCreate()
...
function GuildBossInfoCell:OnDestroy()
end

function GuildBossInfoCell:RefreshCell()
  ...
  if self._cellData.serverData.state == 0 then
    ...
    self._finishImage:SetActive(false)
  elseif self._cellData.serverData.state == 1 then
    ...
    self._battleBtn:SetActive(true)
    self._finishImage:SetActive(false)
  elseif self._cellData.serverData.state == 2 then
...
function GuildBossInfoCell:OnBattleBtnClicked()
  if self._cellData.serverData.state == 0 then
