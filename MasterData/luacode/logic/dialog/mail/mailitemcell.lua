...
function MailItemCell:Ctor(...)
  MailItemCell.super.Ctor(self, ...)
end

function MailItemCell:OnCreate()
...
function MailItemCell:OnDestroy()
end

function MailItemCell:RefreshCell(data)
...
function MailItemCell:OnCellClicked(args, luawindow)
