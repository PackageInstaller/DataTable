...
function AprilFoolsTowerShopGoodsCell:Ctor(...)
  AprilFoolsTowerShopGoodsCell.super.Ctor(self, ...)
end

function AprilFoolsTowerShopGoodsCell:OnCreate()
...
function AprilFoolsTowerShopGoodsCell:OnDestroy()
end

function AprilFoolsTowerShopGoodsCell:RefreshCell(data)
  self._data = data
...
function AprilFoolsTowerShopGoodsCell:OnCellClicked()
  if self._data.iteminfo.goodRemain ~= 0 then
