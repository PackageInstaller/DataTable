...
function AprilFoolsDayTipsDialog:Ctor(...)
  AprilFoolsDayTipsDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function AprilFoolsDayTipsDialog:OnCreate()
...
function AprilFoolsDayTipsDialog:SetStaticRes()
  self._title:SetText(TextManager.GetText(CStringRes:GetRecorder(1761).msgTextID))
end

function AprilFoolsDayTipsDialog:OnDestroy()
end

function AprilFoolsDayTipsDialog:OnBackBtnClicked()
  self:Destroy()
end

function AprilFoolsDayTipsDialog:SetData(textID, titleTextID)
...
function AprilFoolsDayTipsDialog:OnCurPosChange(frame, proportion)
