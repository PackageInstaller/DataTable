...
function AprilFoolsTowerBattleDialog:Ctor(...)
...
function AprilFoolsTowerBattleDialog:OnCreate()
...
function AprilFoolsTowerBattleDialog:OnDestroy()
...
function AprilFoolsTowerBattleDialog:SetData(serverResult, data)
...
function AprilFoolsTowerBattleDialog:OnAnimationStateExit(handle, stateName, normalizedTime)
...
function AprilFoolsTowerBattleDialog:OnPrefabModelAnimationStateExit(handle, stateName, normalizedTime)
...
function AprilFoolsTowerBattleDialog:OnInjuryNumAnimationStateExit(index, handle, stateName, normalizedTime)
...
function AprilFoolsTowerBattleDialog:OnSkipBtnClicked()
  self:Quit()
end

function AprilFoolsTowerBattleDialog:Act()
...
function AprilFoolsTowerBattleDialog:MakeBattleOpList()
  self._opList = {}
  local removeList = {}
  local leftV
  while true do
...
function AprilFoolsTowerBattleDialog:Quit()
...
function AprilFoolsTowerBattleDialog:RealQuit()
  LuaNotificationCenter.PostNotification(Common.n_AprilFoolsClientBattleProcessOver, self, nil)
  self:Destroy()
end

function AprilFoolsTowerBattleDialog:OnDialogWillDestroy(notification)
