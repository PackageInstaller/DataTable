...
function CallRankCellHelper:Ctor(rootElement, single)
...
function CallRankCellHelper:OnDestroy()
  LuaNotificationCenter.RemoveObserver(self)
end

function CallRankCellHelper:RefreshCell(data)
  ...
  if self._data.localData then
    ...
    for index, _ in ipairs(self._cellItem) do
      ...
      elseif self._data.localData.rankRewardId[index - startIndex + 1] > 0 then
...
function CallRankCellHelper:OnCellClick(index)
...
function CallRankCellHelper:OnHeadPhotoClicked()
