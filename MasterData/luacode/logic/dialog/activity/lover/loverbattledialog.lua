...
function LoverBattleDialog:Ctor(...)
  LoverBattleDialog.super.Ctor(self, ...)
  self._groupName = "Modal"
end

function LoverBattleDialog:OnCreate()
...
function LoverBattleDialog:OnDestroy()
  if self._frame then
    self._frame:Destroy()
  end
...
function LoverBattleDialog:SetData(data)
...
function LoverBattleDialog:OnButtonGroupClick(index)
  self._index = index
...
function LoverBattleDialog:OnGoBtnClicked()
  if self._battleRecorder.spirit > NekoData.BehaviorManager.BM_Currency:GetCurrencyNum(DataCommon.SpiritID) then
...
function LoverBattleDialog:OnAutoBtnClicked()
...
function LoverBattleDialog:OnEveryWhereClick(args)
...
function LoverBattleDialog:NumberOfCell(frame)
...
function LoverBattleDialog:CellAtIndex(frame, index)
  if frame == self._buttonFrame then
...
function LoverBattleDialog:DataAtIndex(frame, index)
  if frame == self._buttonFrame then
...
function LoverBattleDialog:OnSUpdateLoverConstruction(notification)
...
function LoverBattleDialog:OnTipsBtnClicked()
...
function LoverBattleDialog:OnBackBtnClicked()
  self:Destroy()
end
