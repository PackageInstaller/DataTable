...
function LoverBattleItemCell:Ctor(...)
  LoverBattleItemCell.super.Ctor(self, ...)
end

function LoverBattleItemCell:OnCreate()
...
function LoverBattleItemCell:OnDestroy()
end

function LoverBattleItemCell:RefreshCell(data)
...
function LoverBattleItemCell:OnCellClicked()
