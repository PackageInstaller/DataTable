local ShopGoodsCellHelper = require("logic.dialog.activity.dragonboatfestival.shopgoodscellhelper")
local ShopGoodsCell = class("ShopGoodsCell", Dialog)
ShopGoodsCell.AssetBundleName = "ui/layouts.activityspringouting"
ShopGoodsCell.AssetName = "ActivitySpringOutingShopCell"
