...
ShopMainPage.AssetBundleName = "ui/layouts.activitystar2"
ShopMainPage.AssetName = "ActivityStar2OtherShop"
...
function ShopMainPage:OnCreate()
  ...
  self:GetChild("Back/EndTimeBack/EndTime"):SetText(NekoData.BehaviorManager.BM_Message:GetString(2130))
...
function ShopMainPage:CellAtIndex(frame, index)
  if frame == self._goodsFrame then
    return "activity.starmirage1package.shopgoodscell"
  end
end
