...
ShopGoodsCell.AssetBundleName = "ui/layouts.activity1yearanniversary"
ShopGoodsCell.AssetName = "Activity1YearOtherShopCell"
local SkinTypeId = 91
...
function ShopGoodsCell:RefreshCell(data)
  ...
  if self._data.isrmt == 0 then
    ...
    if self._skinId then
      self._fashionBtn:SetActive(not DataCommon.Anniversary.KeepFashionBtnHide and true)
...
function ShopGoodsCell:OnFashionBtnClicked()
  DialogManager.CreateSingletonDialog("activity.anniversarypackage.skinlistdialog"):RefreshList()
end
