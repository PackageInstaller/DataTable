...
LevelCell.AssetBundleName = "ui/layouts.activitystar2"
LevelCell.AssetName = "ActivityStar2Cell"

function LevelCell:Ctor(...)
  LevelCell.super.Ctor(self, ...)
  self._bm = NekoData.BehaviorManager.BM_StarMirageCopy
end
...
function LevelCell:SetData(delegate, data)
  ...
  if self._bm:IsPlayGuideClickEffect() and self._levelId == self._bm:GetFirstLevelId() then
