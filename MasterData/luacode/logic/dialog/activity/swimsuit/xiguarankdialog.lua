...
function XiGuaRankDialog:OnCreate()
  ...
  self._selfBack = {
    [1] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Back1"),
    [2] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Back2"),
    [3] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Back3")
  }
  ...
  self._selfRank = {
    [1] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/Rank1"),
    [2] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/Rank2"),
    [3] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/Rank3")
  }
  ...
  self._selfRole = {
    [1] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/CharBack3/Char"),
    [2] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/CharBack2/Char"),
    [3] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/CharBack1/Char")
  }
  self._selfRoleBack = {
    [1] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/CharBack3"),
    [2] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/CharBack2"),
    [3] = self:GetChild("Char/ActivitySummerXiGuaRankCell/Panel/CharBack1")
  }
...
function XiGuaRankDialog:OnDestroy()
  self._bossFrame:Destroy()
  self._playerFrame:Destroy()
end

function XiGuaRankDialog:SetData(data)
...
function XiGuaRankDialog:RefreshBossData()
...
function XiGuaRankDialog:OnSwaterMelonChallengeRanking(protocol)
  local index
...
function XiGuaRankDialog:RefreshPersonRankData(selectIndex)
...
function XiGuaRankDialog:RefreshTotalRankData(selectIndex)
...
function XiGuaRankDialog:OneBossCellSelect(index)
...
function XiGuaRankDialog:OnePalyerCellClicked(rankDataIndex, fatherClick)
...
function XiGuaRankDialog:OnSelfRankPanel()
...
function XiGuaRankDialog:NumberOfCell(frame, index)
  if frame == self._bossFrame then
    return #self._bossData
  elseif frame == self._playerFrame then
    return #self._totalRankData[self._selectedBossCellIndex]
  end
end

function XiGuaRankDialog:CellAtIndex(frame, index)
  if frame == self._bossFrame then
...
function XiGuaRankDialog:DataAtIndex(frame, index)
  if frame == self._bossFrame then
    return {
      index = index,
      data = self._bossData[index]
    }
  elseif frame == self._playerFrame then
    return {
      index = index,
      data = self._totalRankData[self._selectedBossCellIndex][index]
    }
  end
end

function XiGuaRankDialog:OnBackBtnClicked()
  self:Destroy()
end

function XiGuaRankDialog:OnMenuBtnClicked()
  DialogManager.CreateSingletonDialog("fastmenu.fastmenudialog")
end

function XiGuaRankDialog:OnCurPosChange(frame, proportion)
