...
Sheet2.AssetBundleName = "ui/layouts.activitysummer"
Sheet2.AssetName = "ActivitySummerOtherShop"
...
function Sheet2:OnCreate()
  ...
  self._endTime:SetText(NekoData.BehaviorManager.BM_Message:GetString(2141))
end
...
function Sheet2:RefreshShopInfo()
  ...
  if #goodsData ~= 3 then
    LogErrorFormat("Summer.Sheet2.SetData", "The shop goods length error! | %d", #goodsData)
    return
  end
...
function Sheet2:CellAtIndex(frame, index)
  return "activity.swimsuit.shopgoodscell1"
end
...
function Sheet2:OnTipsBtnClicked()
  NekoData.BehaviorManager.BM_Message:OpenInstructionsTipDialog(13)
end
