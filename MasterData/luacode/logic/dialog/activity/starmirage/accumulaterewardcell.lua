...
AccumulateRewardCell.AssetBundleName = "ui/layouts.activitystar"
AccumulateRewardCell.AssetName = "ActivityStarAccountCell"
...
function AccumulateRewardCell:RefreshCell(data)
  ...
  local curNum = NekoData.BehaviorManager.BM_Activity:GetManager(DataCommon.StarMirageManagerID):GetAccumulatePointsById(record.collecttype)
