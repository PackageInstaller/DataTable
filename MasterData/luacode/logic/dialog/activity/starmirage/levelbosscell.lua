...
LevelBossCell.AssetBundleName = "ui/layouts.activitystar"
LevelBossCell.AssetName = "ActivityStarCellBoss"

function LevelBossCell:Ctor(...)
  LevelBossCell.super.Ctor(self, ...)
end

function LevelBossCell:OnCreate()
  self:GetRootWindow():Subscribe_PointerClickEvent(self.OnCellClicked, self)
end

function LevelBossCell:OnDestroy()
end

function LevelBossCell:SetData(delegate, data)
...
function LevelBossCell:OnCellClicked()
  self._delegate:SelectLevelById(self._levelId)
end

function LevelBossCell:OnEvent(eventName)
...
function LevelBossCell:PlayAnimation()
