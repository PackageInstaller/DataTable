...
function RankCell:RefreshCell(data)
  ...
  self._difficultyTxt:SetText(NekoData.BehaviorManager.BM_Game:GetBossRushDifficultyColorStr(data.bossPanelData.times, self._delegate._delegate._typeData.difficultyColorStrType))
...
function RankCell:OnTeamClicked()
  DialogManager.CreateSingletonDialog("activity.starmirage.rankteaminfodialog"):InitDataInfo(self._delegate._delegate._typeData.difficultyColorStrType, self._cellData, self._delegate._delegate._tabType)
end
