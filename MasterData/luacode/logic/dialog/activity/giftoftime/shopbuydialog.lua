...
local ItemGiftBuyDialog = class("ItemGiftBuyDialog", Dialog)
ItemGiftBuyDialog.AssetBundleName = "ui/layouts.baseshop"
ItemGiftBuyDialog.AssetName = "ItemPackBuy"

function ItemGiftBuyDialog:Ctor(...)
  ItemGiftBuyDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function ItemGiftBuyDialog:OnCreate()
...
function ItemGiftBuyDialog:OnDestroy()
  self._cellFrame:Destroy()
end

function ItemGiftBuyDialog:SetData(iteminfo, shopid)
  self._itemInfo = iteminfo
  self._shopID = shopid
  local good = CPackage:GetRecorder(self._itemInfo.goodId)
...
function ItemGiftBuyDialog:NumberOfCell(frame)
  return #self._itemInfo.itemId
end

function ItemGiftBuyDialog:CellAtIndex(frame, index)
  return "shop.dailygiftbuycell"
end

function ItemGiftBuyDialog:DataAtIndex(frame, index)
  local data = {}
...
function ItemGiftBuyDialog:OnBuyBtnClicked()
...
function ItemGiftBuyDialog:OnRoleBtnClicked()
  local roleIdList = {}
...
function ItemGiftBuyDialog:OnDialogClicked(args)
...
function ItemGiftBuyDialog:OnBackBtnClicked()
