...
function KillBossPageMonsterCell:Ctor(...)
...
function KillBossPageMonsterCell:OnCreate()
  self._battleUI = {}
...
function KillBossPageMonsterCell:OnDestroy()
end

function KillBossPageMonsterCell:RefreshCell(data)
  self._data = data
  ...
  self._LvText:SetText(NekoData.BehaviorManager.BM_Message:GetString(1287, {
    data.lv
  }))
  ...
  elseif data.id == curChallengingId then
    self._type_N:SetActive(false)
...
function KillBossPageMonsterCell:OnItemClicked()
