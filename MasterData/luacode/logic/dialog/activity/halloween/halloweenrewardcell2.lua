...
function HalloweenRewardCell2:Ctor(...)
  HalloweenRewardCell2.super.Ctor(self, ...)
end

function HalloweenRewardCell2:OnCreate()
...
function HalloweenRewardCell2:RefreshCell(data)
  self._data = data
  ...
  self._numBack2:SetActive(self._data.canGet or self._data.isGet)
  self._lineLight:SetActive(self._data.canGet or self._data.isGet)
...
function HalloweenRewardCell2:OnItemCellClicked()
