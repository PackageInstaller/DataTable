...
function HalloweenRewardCell1:Ctor(...)
  HalloweenRewardCell1.super.Ctor(self, ...)
end

function HalloweenRewardCell1:OnCreate()
...
function HalloweenRewardCell1:RefreshCell(data)
  self._data = data
...
function HalloweenRewardCell1:OnItemCellClicked()
