...
local TopToBottom = 4
local HalloweenTipsDialog = class("HalloweenTipsDialog", Dialog)
HalloweenTipsDialog.AssetBundleName = "ui/layouts.activityhalloween"
HalloweenTipsDialog.AssetName = "HalloweenTips"

function HalloweenTipsDialog:Ctor(...)
  HalloweenTipsDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function HalloweenTipsDialog:OnCreate()
...
function HalloweenTipsDialog:SetStaticRes()
  self._title:SetText(TextManager.GetText(CStringRes:GetRecorder(1636).msgTextID))
end

function HalloweenTipsDialog:OnDestroy()
end

function HalloweenTipsDialog:OnBackBtnClicked()
  self:Destroy()
end

function HalloweenTipsDialog:SetData(textID)
...
function HalloweenTipsDialog:OnCurPosChange(frame, proportion)
