...
function ChristmasPart2CommonBattleChangeTeamDialog:Ctor(...)
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnCreate()
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnDestroy()
...
function ChristmasPart2CommonBattleChangeTeamDialog:Refresh()
  self:ScreeningAndSorting()
end

function ChristmasPart2CommonBattleChangeTeamDialog:OnRefresh(notification)
  self:Refresh()
  self:RefreshDownPanel()
end

function ChristmasPart2CommonBattleChangeTeamDialog:RefreshFashion()
  self:OnRefresh()
end
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnSkillUnlock()
  RefreshSkillPanel(self)
end

function ChristmasPart2CommonBattleChangeTeamDialog:OnUniqueEquipLevelUp(notification)
...
function ChristmasPart2CommonBattleChangeTeamDialog:RefreshDownPanel()
...
function ChristmasPart2CommonBattleChangeTeamDialog:SetFilterCondition(condition)
...
function ChristmasPart2CommonBattleChangeTeamDialog:Init(curTeam, curStationInfo)
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnSkill1Clicked()
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnSkill2Clicked()
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnCellLongPress()
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnConfirmBtnClicked()
...
function ChristmasPart2CommonBattleChangeTeamDialog:ConfirmFunction()
...
function ChristmasPart2CommonBattleChangeTeamDialog:SetSelectedID(str, roleKey)
...
function ChristmasPart2CommonBattleChangeTeamDialog:GetNumByRoleId(id)
  local count = 0
...
function ChristmasPart2CommonBattleChangeTeamDialog:ScreeningAndSorting()
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnFilterBtnClick()
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnLevelBtnClick()
  if not self._filterDlg then
    LogError("[Dialog]: ", "Common filter dlg create error")
    return
  end
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnSortBtnClick()
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnLockBtnClick()
...
function ChristmasPart2CommonBattleChangeTeamDialog:SetSortCriteriaNameId(nameId)
...
function ChristmasPart2CommonBattleChangeTeamDialog:SetScreeningConditions(screeningConditions)
  self._screeningConditions = screeningConditions
  self:ScreeningAndSorting()
end

function ChristmasPart2CommonBattleChangeTeamDialog:NumberOfCell(frame)
  return #self._listByConditions
end

function ChristmasPart2CommonBattleChangeTeamDialog:CellAtIndex(frame)
  return "activity.christmas.christmaspart2commonbattlechangeteamrolecell"
end

function ChristmasPart2CommonBattleChangeTeamDialog:DataAtIndex(frame, index)
  return self._listByConditions[index]
end

function ChristmasPart2CommonBattleChangeTeamDialog:OnCurPosChange(frame, proportion)
...
function ChristmasPart2CommonBattleChangeTeamDialog:OnBackBtnClicked()
  self:Destroy()
end

function ChristmasPart2CommonBattleChangeTeamDialog:OnMenuBtnClicked()
  DialogManager.CreateSingletonDialog("fastmenu.fastmenudialog")
end

function ChristmasPart2CommonBattleChangeTeamDialog:ReturnRoleList()
  local roleList = {}
...
function ChristmasPart2CommonBattleChangeTeamDialog:SetSupportVocationTable(supportVocationTable)
...
function ChristmasPart2CommonBattleChangeTeamDialog:SendCUpdateUISortType()
