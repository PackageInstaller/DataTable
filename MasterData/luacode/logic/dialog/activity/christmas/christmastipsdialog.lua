...
local TopToBottom = 4
local ChristmasTipsDialog = class("ChristmasTipsDialog", Dialog)
ChristmasTipsDialog.AssetBundleName = "ui/layouts.activitychristmas"
ChristmasTipsDialog.AssetName = "ActivityChristmasTips"

function ChristmasTipsDialog:Ctor(...)
  ChristmasTipsDialog.super.Ctor(self, ...)
  self._groupName = "Tip"
end

function ChristmasTipsDialog:OnCreate()
...
function ChristmasTipsDialog:SetStaticRes()
  self._title:SetText(TextManager.GetText(CStringRes:GetRecorder(1636).msgTextID))
end

function ChristmasTipsDialog:OnDestroy()
end

function ChristmasTipsDialog:OnBackBtnClicked()
  self:Destroy()
end

function ChristmasTipsDialog:SetData(textID)
...
function ChristmasTipsDialog:OnCurPosChange(frame, proportion)
