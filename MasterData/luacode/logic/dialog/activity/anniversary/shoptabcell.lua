...
ShopTabCell.AssetBundleName = "ui/layouts.activity1yearanniversary"
ShopTabCell.AssetName = "Activity1YearAnniversaryShopFrame"
...
function ShopTabCell:CellAtIndex(frame, index)
  return "activity.anniversary.shopitemcell"
end
