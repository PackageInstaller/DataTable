...
function RoleEvaluationMeCell:Ctor(...)
  RoleEvaluationMeCell.super.Ctor(self, ...)
end

function RoleEvaluationMeCell:OnCreate()
...
function RoleEvaluationMeCell:OnDestroy()
end

function RoleEvaluationMeCell:RefreshCell(data)
...
function RoleEvaluationMeCell:OnCloseBtnClicked()
...
function RoleEvaluationMeCell:OnThumbUpBtnClicked()
...
function RoleEvaluationMeCell:OnClickHeadPhoto()
