...
function ResultItemCell:Ctor(...)
  ResultItemCell.super.Ctor(self, ...)
end

function ResultItemCell:OnCreate()
...
function ResultItemCell:OnDestroy()
end

function ResultItemCell:RefreshCell(data)
...
function ResultItemCell:OnCellClicked()
  local tipsDialog
