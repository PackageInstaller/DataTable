...
function MsgTipFrameDialog:Ctor(...)
...
function MsgTipFrameDialog:OnCreate()
  self._width, self._height = self:GetRootWindow():GetRectSize()
end

function MsgTipFrameDialog:OnDestroy()
...
function MsgTipFrameDialog:OnRefresh()
...
function MsgTipFrameDialog:AddMessageTip(msg)
  local msgCell = {}
...
function MsgTipFrameDialog:OnBackBtnClicked()
