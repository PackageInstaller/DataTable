...
function BattleDetailDialog:Ctor(...)
...
function BattleDetailDialog:OnCreate()
...
function BattleDetailDialog:OnDestroy()
...
function BattleDetailDialog:SetData()
...
function BattleDetailDialog:RefreshData(changeCamp)
  local datalist = {}
  local data = {}
...
function BattleDetailDialog:OnLeftCampToggleClicked()
...
function BattleDetailDialog:OnRightCampToggleClicked()
...
function BattleDetailDialog:OnBackBtnClicked()
  self:Destroy()
end

function BattleDetailDialog:NumberOfCell(frame, index)
...
function BattleDetailDialog:CellAtIndex(frame, index)
  if frame == self._charFrame then
...
function BattleDetailDialog:DataAtIndex(frame, index)
  if frame == self._charFrame then
    if index == 1 then
...
function BattleDetailDialog:OnCurPosChange(frame, proportion)
