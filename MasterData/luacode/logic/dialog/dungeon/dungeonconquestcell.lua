...
function DungeonConquestCell:Ctor(...)
  DungeonConquestCell.super.Ctor(self, ...)
end

function DungeonConquestCell:OnCreate()
...
function DungeonConquestCell:OnDestroy()
end

function DungeonConquestCell:RefreshCell(data)
  ...
  if self._item:GetItemAttr() then
    ...
    if data.way == Way.BOX then
      ...
      str = TextManager.GetText(str)
    elseif data.way == Way.BATTLE then
      str = CStringRes:GetRecorder(1116).msgTextID
      str = TextManager.GetText(str)
    elseif data.way == Way.TASK then
      str = CStringRes:GetRecorder(1118).msgTextID
      str = TextManager.GetText(str)
    elseif data.way == Way.GROUND then
...
function DungeonConquestCell:OnCellClicked(args, luawindow)
