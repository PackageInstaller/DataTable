...
function DungeonAccountCell:Ctor(...)
  DungeonAccountCell.super.Ctor(self, ...)
end

function DungeonAccountCell:OnCreate()
...
function DungeonAccountCell:OnDestroy()
end

function DungeonAccountCell:RefreshCell(data)
...
function DungeonAccountCell:OnCellClick(args)
...
function DungeonAccountCell:OnEvent(eventName, arg)
  if eventName == "SetItemSelectedState" then
    self._select:SetActive(self:GetRootWindow():GetUserData() == arg)
  end
end

function DungeonAccountCell:ChangeCellSelected(notification)
