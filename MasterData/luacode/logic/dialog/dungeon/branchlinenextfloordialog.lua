...
function BranchLineNextFloorDialog:Ctor(...)
  BranchLineNextFloorDialog.super.Ctor(self, ...)
  self._groupName = "Modal"
end

function BranchLineNextFloorDialog:OnCreate()
...
function BranchLineNextFloorDialog:OnDestroy()
  self._dotFrame:Destroy()
  LuaNotificationCenter.RemoveObserver(self)
  UIBackManager.SetUIBackShow(false)
end

function BranchLineNextFloorDialog:Init(data)
...
function BranchLineNextFloorDialog:Refresh()
  self:Init(self._data)
end

function BranchLineNextFloorDialog:SetLive2D(shapeid)
...
function BranchLineNextFloorDialog:SetDotData(stageData)
  self._cellData = {}
...
function BranchLineNextFloorDialog:NumberOfCell(frame)
  return #self._cellData
end

function BranchLineNextFloorDialog:CellAtIndex(frame, index)
...
function BranchLineNextFloorDialog:DataAtIndex(frame, index)
  return self._cellData[index]
end

function BranchLineNextFloorDialog:RefreshSpirit(notification)
...
function BranchLineNextFloorDialog:OnGoBtnClicked()
...
function BranchLineNextFloorDialog:OnResetBtnClicked()
...
function BranchLineNextFloorDialog:OnAddVITBtnClicked()
  NekoData.BehaviorManager.BM_Currency:RequestOpenAddCurrencyDlg(DataCommon.SpiritID)
end

function BranchLineNextFloorDialog:OnBackBtnClicked()
...
function BranchLineNextFloorDialog:OnMenuBtnClicked()
  DialogManager.CreateSingletonDialog("fastmenu.fastmenudialog")
end

function BranchLineNextFloorDialog:HaveSpiritItemSoonExpire()
...
function BranchLineNextFloorDialog:SetSpiritRedDot()
  self._vitRedDot:SetActive(self:HaveSpiritItemSoonExpire())
end

function BranchLineNextFloorDialog:OnItemClicked()
