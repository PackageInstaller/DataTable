...
function UIBackManager.Clear()
  UIBackManager._global_count = 0
  UIBackManager._color_list = {}
  UIBackManager._active = false
end

function UIBackManager.SetUIBackShow(flag)
...
function UIBackManager.SetUIModalBackColor(color)
...
function UIBackManager.SwitchToNext()
...
function UIBackManager.IsActive()
...
function UIBackManager.SetActive(flag)
