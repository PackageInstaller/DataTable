local UISpring24Interactive = class("UISpring24Interactive", UIBaseWindow)
local base = UIBaseWindow
local CS_ResLoader = CS.ResLoader
local UINInteractiveItem = require("Game.ActivitySpring24.UI.Interactive.UINSpring24InteractiveItem")
local ActLbUtil = require("Game.ActivityLobby.ActLbUtil")

function UISpring24Interactive:OnInit()
  self._resLoader = CS_ResLoader.Create()
end

function UISpring24Interactive:InitSpring24Interactive(entityDic)
...
function UISpring24Interactive:_OnLoadedEntityPrefab(prefabGo)
...
function UISpring24Interactive:UpdateInteractive()
  ...
  for i, entity in pairs(self._entityDic) do
    ...
    local canInteract = intrctData:IsLbIntrctUnlock()
...
function UISpring24Interactive:OnShow()
  base.OnShow(self)
  self:UpdateInteractive()
end

function UISpring24Interactive:OnDelete()
