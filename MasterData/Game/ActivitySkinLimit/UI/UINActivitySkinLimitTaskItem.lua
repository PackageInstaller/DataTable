local UINActivitySkinLimitTaskItem = class("UINActivitySkinLimitTaskItem", UIBaseNode)
local base = UIBaseNode
local UINBaseItemWithReceived = require("Game.CommonUI.Item.UINBaseItemWithReceived")

function UINActivitySkinLimitTaskItem:OnInit()
...
function UINActivitySkinLimitTaskItem:InitSkinLimitTaskItem(taskData, getCallback, gotoCallback)
  ...
  self:RefreshSkinLimitTaskItem()
end

function UINActivitySkinLimitTaskItem:RefreshSkinLimitTaskItem()
...
function UINActivitySkinLimitTaskItem:GetEnvTaskId()
  return self._taskData.id
end

function UINActivitySkinLimitTaskItem:OnClickReceive()
  if self._getCallback ~= nil then
    self._getCallback(self._taskData)
  end
end

function UINActivitySkinLimitTaskItem:OnClickJump()
  if self._gotoCallback ~= nil then
    self._gotoCallback(self._taskData)
  end
end

return UINActivitySkinLimitTaskItem
