...
function UINHalloweenBounsItemEmptyElement:InitBounsItem(commonRewardBpData, level, rewardFunc)
  ...
  self._item:InitBounsItem(commonRewardBpData, level, rewardFunc)
