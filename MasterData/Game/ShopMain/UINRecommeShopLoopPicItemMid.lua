...
function UINRecommeShopLoopPicItemMid:OnInit()
...
function UINRecommeShopLoopPicItemMid:RecShopLoopPicInit(resloader)
  self.resloader = resloader
end

function UINRecommeShopLoopPicItemMid:RefreshRecShopLoopPicItem(bannerCfgList)
...
function UINRecommeShopLoopPicItemMid:LoopBanner(index)
