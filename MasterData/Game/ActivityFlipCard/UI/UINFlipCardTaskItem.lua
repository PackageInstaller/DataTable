local UINFlipCardTaskItem = class("UINFlipCardTaskItem", UIBaseNode)
local base = UIBaseNode
local UINBaseItemWithReceived = require("Game.CommonUI.Item.UINBaseItemWithReceived")

function UINFlipCardTaskItem:OnInit()
...
function UINFlipCardTaskItem:InitFlipCardTaskItem(taskData, getCallback, gotoCallback)
  ...
  self:RefreshFlipCardTaskItem()
end

function UINFlipCardTaskItem:RefreshFlipCardTaskItem()
...
function UINFlipCardTaskItem:GetEnvTaskId()
  return self._taskData.id
end

function UINFlipCardTaskItem:OnClickReceive()
  if self._getCallback ~= nil then
    self._getCallback(self._taskData)
  end
end

function UINFlipCardTaskItem:OnClickJump()
  if self._gotoCallback ~= nil then
    self._gotoCallback(self._taskData)
  end
end

return UINFlipCardTaskItem
