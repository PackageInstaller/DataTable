-- chunkname: @E:/AntMan/AntMan_Android_pub1/Assets/Code/.LuaCode/UI\\Common\\Tips\\HeroSkillSingleTips.lua
...
local strClassName = "HeroSkillSingleTips"
local HeroSkillSingleTips = Class(strClassName, UIControls.Child)

function HeroSkillSingleTips:ctor()
	self:initUI()
end

function HeroSkillSingleTips:initUI()
	self.txtSkillName = UIControls.Label(self, "TextTitle")
	self.txtSkillDes = UIControls.Label(self, "TextDes")
	self.txtSkillPropName = UIControls.Label(self, "TextNum/TextTitle")
	self.txtSkillPropValue = UIControls.Label(self, "TextNum")
	self.txtSkillPropValue2 = UIControls.Label(self, "TextNum2")
	self.imgPassive = UIControls.Image(self, "TextNum/TextTitle/Image")
	self.txtCondition = UIControls.Label(self, "TextCondition")
	self.txtLvUpCondition = UIControls.Label(self, "TextLvUpTitle/TextLvUpCondition")
	self.txtLvUpTitle = UIControls.Panel(self, "TextLvUpTitle")
	self.imgBg = UIControls.Image(self, "Bg")
	self.imgLine = UIControls.Image(self, "ImgLine")
	self.panelEmpty = UIControls.Panel(self, "EmptyPanel")
	self.lvUpAttrList = {}

	for i = 2, 3 do
		local lvUpPanel = UIControls.Panel(self, "LvUpAttr" .. i)
		local txtlvUpAttr = UIControls.Label(self, "LvUpAttr" .. i .. "/TextAttr")
		local txtlv = UIControls.Label(self, "LvUpAttr" .. i .. "/TextLv")
	...
	self.panelSpecDesc = UIControls.Panel(self, "SpeAttrPanel")
	self.panelSpecDesc1 = UIControls.Panel(self, "SpeAttrPanel/SpeAttr1")
	self.titleSpecDesc1 = UIControls.Label(self, "SpeAttrPanel/SpeAttr1/BgTitle/TextTitle")
	self.descSpecDesc1 = UIControls.Label(self, "SpeAttrPanel/SpeAttr1/TextAttr")
	self.panelSpecDesc2 = UIControls.Panel(self, "SpeAttrPanel/SpeAttr2")
	self.titleSpecDesc2 = UIControls.Label(self, "SpeAttrPanel/SpeAttr2/BgTitle/TextTitle")
	self.descSpecDesc2 = UIControls.Label(self, "SpeAttrPanel/SpeAttr2/TextAttr")
	self.panelRelic = UIControls.Panel(self, "RelicPanel")
	self.txtRelicName = UIControls.Label(self, "RelicPanel/TextTitle")
	self.txtRelicDes = UIControls.Label(self, "RelicPanel/Text")
	self.selfPanel = UIControls.Panel(self, "")
	self.scrollSkillList = UIControls.ScrollView(self, "ScrollView")
end

function HeroSkillSingleTips:hideLevelUpPanel()
...
function HeroSkillSingleTips:setSkill(grid)
	...
	if not self.skillGrid then
		self.skillGrid = UIControls.HeroSkillGridChild(self, "GridPanel", "System/Hero/GridHeroSkill", 0, 0, true)
	end
...
function HeroSkillSingleTips:setSkillBySkill(skill, hero)
	local fakeGrid = {}
