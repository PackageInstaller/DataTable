ActivityRouletteLayer_209 = class("ActivityRouletteLayer_209", function()
...
function ActivityRouletteLayer_209.create(arg_2_0)
	local var_2_0 = ActivityRouletteLayer_209.new()
...
function ActivityRouletteLayer_209:initBottomList()
...
function ActivityRouletteLayer_209:setUIPosition()
	self.slotMachineSprite.hasLbl:setVisible(false)
end
