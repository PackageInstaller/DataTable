ActivityFlopLayer_433 = class("ActivityFlopLayer_433", function()
...
function ActivityFlopLayer_433.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_433.new()
...
function ActivityFlopLayer_433:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_433:updateChampionTipLabel()
...
function ActivityFlopLayer_433:fullScreen()
...
function ActivityFlopLayer_433:initOther()
...
function ActivityFlopLayer_433.updateSkin(arg_8_0, arg_8_1, arg_8_2)
	return
end
