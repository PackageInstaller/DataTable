ActivityFlopLayer_196 = class("ActivityFlopLayer_196", function()
...
function ActivityFlopLayer_196.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivityFlopLayer_196.new()
...
function ActivityFlopLayer_196:initDynaticPara(arg_3_1)
...
function ActivityFlopLayer_196:initDrawBg()
	local var_4_0 = ccui.ImageView:create(self.texturePath .. "champion_bg1.png", var_0_5)

	var_4_0:setAnchorPoint(cc.p(0.5, 0))
	var_4_0:setPosition(cc.p(self.rootLayer:getContentSize().width / 2 - 200, 840))
...
function ActivityFlopLayer_196:updateChampionTipLabel()
	if not self.itemShade:getChildByName("tip") then
		local var_5_0 = cc.Label:createWithTTF(L_FLOP_CHAMPION_TIP, FONT_BUTTON, 20)

		var_5_0:setAnchorPoint(cc.p(0, 0.5))
		var_5_0:setColor(cc.c3b(255, 255, 255))
		var_5_0:setName("tip")
		var_5_0:setPosition(cc.p(5, self.itemShade:getContentSize().height / 2 - 2))
		self.itemShade:addChild(var_5_0)
	end
end

function ActivityFlopLayer_196:fullScreen()
	self.championBg:setPositionY(self.championBg:getPositionY() + GameDisplay.fix_y * 0.8)
	self.drawBg:setPositionY(self.championBg:getPositionY() - 20)
	self.bigRole:setPositionY(GameDisplay.height)
	self.Title:setPositionY(self.bigRole:getPositionY() - self.bigRole:getContentSize().height / 2 + 200)
...
function ActivityFlopLayer_196:initOther()
...
function ActivityFlopLayer_196.updateSkin(arg_9_0, arg_9_1, arg_9_2)
	return
end
