local ActivityMainLayer_148 = class("ActivityMainLayer_148", function(...)
	return ActivityMainLayerBaseLayer:create(...)
end)
local activity_manager = require("controller.activity_manager")
local explore_manager = require("controller.explore_manager")

function ActivityMainLayer_148:create(arg_2_1)
	local var_2_0 = ActivityMainLayer_148.new(arg_2_1)
...
function ActivityMainLayer_148:init(arg_3_1)
	self.rootLayer = ccui.Layout:create()

	self:addChild(self.rootLayer)
end

function ActivityMainLayer_148:initOther()
	return
end

function ActivityMainLayer_148:playOutEffect(arg_5_1)
...
function ActivityMainLayer_148:playInEffect(arg_8_1)
