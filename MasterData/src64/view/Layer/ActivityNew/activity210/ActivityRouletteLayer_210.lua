ActivityRouletteLayer_210 = class("ActivityRouletteLayer_210", function()
...
function ActivityRouletteLayer_210.create(arg_2_0)
	local var_2_0 = ActivityRouletteLayer_210.new()
...
function ActivityRouletteLayer_210:initBottomList()
...
function ActivityRouletteLayer_210:initTitle()
	...
	var_7_0:setPosition(cc.p(320, GameDisplay.height - 80 - (GameDisplay.height - 1136) * 0.18))
	...
	self.timeLbl:setPosition(cc.p(436, var_7_0:getPositionY() - 105))
	self.timeLbl:setColor(cc.c3b(255, 255, 255))
