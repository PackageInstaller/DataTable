ActivityRouletteLayer_186 = class("ActivityRouletteLayer_186", function()
...
function ActivityRouletteLayer_186.create(arg_2_0)
	local var_2_0 = ActivityRouletteLayer_186.new()
...
function ActivityRouletteLayer_186:initBottomList()
