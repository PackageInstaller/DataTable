ActivitySignLayer_121_1 = class("ActivitySignLayer_121_1", function()
...
function ActivitySignLayer_121_1.create(arg_2_0, arg_2_1)
	local var_2_0 = ActivitySignLayer_121_1.new()

	require("controller.texture_manager"):loadPopLayerTextures({
		"Activity_Marry"
	})
	var_2_0:init(arg_2_1)
	var_2_0:setName("ActivitySignLayer_121_1")

	return var_2_0
end

function ActivitySignLayer_121_1:init(arg_3_1)
	var_0_5 = true
	...
	self.rootLayer = ccs.GUIReader:getInstance():widgetFromJsonFile(config._DEBUG and "Activity_Marry_Sign.json" or "Activity_Marry_Sign.ExportJson")
	...
	for iter_3_0, iter_3_1 in pairs((require("data.activity_sign_data"))) do
		if iter_3_1.sign_id == "121-1" then
			var_3_0 = var_3_0 + 1
		end
	end
	...
	self:registerScriptHandler(function(arg_7_0)
		if arg_7_0 == "exit" then
			activity_manager:releaseEventListenerByName("ActivitySignLayer_121_1")
...
function ActivitySignLayer_121_1:isCheckSignIn()
	local var_8_0 = false
...
local function var_0_7(arg_9_0)
	...
	if config._DEBUG then
		var_9_0 = cc.Sprite:create("Activity_Marry/item_bg.png") or cc.Sprite:createWithSpriteFrameName("Activity_Marry/item_bg.png")
	end
...
function ActivitySignLayer_121_1:createSignBg()
	self.sign_bg:loadTexture("mainScenebg/activity/" .. self.otherData.path .. "/sign_bg.png")
	self.sign_bg:setPosition(cc.p(306, 535))
	self.image_bg:loadTexture("mainScenebg/activity/" .. self.otherData.path .. "/sign_iamge_bg.png")
end

function ActivitySignLayer_121_1:createLimitTime()
...
function ActivitySignLayer_121_1.registerActivityEventListener(arg_12_0)
	activity_manager:registerEventListener("ActivitySignLayer_121_1", activity_manager.activityEventId.EXIT_FORM_PURCHASE_LAYER, function(arg_13_0)
...
function ActivitySignLayer_121_1:createAwards()
...
function ActivitySignLayer_121_1:getAwards()
...
function ActivitySignLayer_121_1:activitySign()
...
function ActivitySignLayer_121_1:exitCallback()
	LayerManager:removePopLayer(self.__queueindex)
end

function ActivitySignLayer_121_1:showAwardsDetails(arg_25_1, arg_25_2)
...
function ActivitySignLayer_121_1.fullScreen(arg_26_0, arg_26_1)
...
function ActivitySignLayer_121_1:exit()
	self:exitCallback()
end
