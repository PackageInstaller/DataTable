SlotMachineSprite = class("SlotMachineSprite", function()
...
function SlotMachineSprite.create(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
	local var_2_0 = SlotMachineSprite.new()
...
function SlotMachineSprite:init(arg_3_1, arg_3_2, arg_3_3, arg_3_4)
...
function SlotMachineSprite:registerActivityEventListener()
	activity_manager:registerEventListener("SlotMachineSprite_" .. self._activityId, activity_manager.activityEventId.ROULETTE_INFO_UPDATE, function(arg_6_0)
		self.dataList = activity_manager:getRouletteItemData(self._activityId)
	...
	activity_manager:registerEventListener("SlotMachineSprite_" .. self._activityId, activity_manager.activityEventId.ROULETTE_FOR_ONE, function(arg_7_0)
		...
		self:playToIndex((self:getItemIndex(arg_7_0.originalItem, arg_7_0.originalNum)))
	...
	activity_manager:registerEventListener("SlotMachineSprite_" .. self._activityId, activity_manager.activityEventId.ROULETTE_FOR_FIVE, function(arg_8_0)
		...
		self:playToIndex((self:getItemIndex(var_8_0.itemid, var_8_0.itemcount)))
...
function SlotMachineSprite:initDrawParam(arg_9_1, arg_9_2, arg_9_3)
...
function SlotMachineSprite:initUI()
	self.cells = {}
...
function SlotMachineSprite.initRewardSprite(arg_17_0, arg_17_1)
...
function SlotMachineSprite:is_sp_reward(arg_19_1, arg_19_2)
	local var_19_0 = self:getItemIndex(arg_19_1.itemid, arg_19_2)
...
function SlotMachineSprite:updateRewardSprite(arg_20_1, arg_20_2, arg_20_3, arg_20_4)
	...
	self.rewardSprites[arg_20_1]:getChildByName("spriteani"):setVisible(self:is_sp_reward(arg_20_2, arg_20_3))

	self.rewardSprites[arg_20_1].itemid = arg_20_2.itemid

	local var_20_1 = self:getItemIndex(arg_20_4, arg_20_3)
	...
	if self.dataList[var_20_1].item_attr then
		...
		for iter_20_3 = 1, 6 do
			self.rewardSprites[arg_20_1]:getChildByName("sp" .. iter_20_3):setVisible(false)
		end
	end
end

function SlotMachineSprite:getCellIndex(arg_21_1, arg_21_2)
	if arg_21_2 == 1 then
		return arg_21_1
...
function SlotMachineSprite:initSlotMachineCell(arg_22_1)
	...
	for iter_22_0 = 1, 6 do
		...
		var_22_1:setScale(0.8)
		var_22_1:setName("sp" .. iter_22_0)
		var_22_1:setVisible(false)
		var_22_1:setPosition(var_22_2, (iter_22_0 - 1) * 21 + 20)
...
function SlotMachineSprite:updateCellItem()
	for iter_23_0 = 1, #self.cells do
		...
		local var_23_5 = self.cells[iter_23_0]:getChildByName("mask")
		...
		var_23_5:setVisible(self.dataList[iter_23_0].is_empty == true)
	...
	local var_23_6 = activity_manager:getRouletteShowModel(self._activityId)

	self.modelTitle:setVisible(var_23_6 ~= nil)
	...
	local var_23_7, var_23_8 = activity_manager:getRouletteNums(self._activityId)

	self.hasLbl:setString(string.format(L_ROULETTE_NUM, var_23_8))

	self.needPlayEffect = false
end

function SlotMachineSprite:playJoinEffect()
...
function SlotMachineSprite:playToIndex(arg_27_1, arg_27_2, arg_27_3, arg_27_4)
		...
		if self.updatetween:update(arg_28_0) then
			...
			if self.originalItem and next(self.originalItem) then
				...
				self:runAction(cc.Sequence:create(cc.DelayTime:create(0.5), cc.CallFunc:create(function()
					self:shortPlayToIndex(self:getItemIndex(var_28_0.itemid, var_28_0.itemcount))
				end)))
			else
				self.isplay = false
			end
...
function SlotMachineSprite:shortPlayToIndex(arg_30_1)
		...
		if var_30_3:update(arg_31_0) then
			...
			if self.originalItem and next(self.originalItem) then
				...
				self:runAction(cc.Sequence:create(cc.DelayTime:create(0.6), cc.CallFunc:create(function()
					self:shortPlayToIndex(self:getItemIndex(var_31_0.itemid, var_31_0.itemcount))
				end)))
			else
				self.isplay = false
			end
...
function SlotMachineSprite:playToCell(arg_33_1)
	if arg_33_1 < 0 then
...
function SlotMachineSprite:getItemIndex(arg_34_1, arg_34_2)
	local var_34_0 = {}
...
function SlotMachineSprite:updateRewardPanel(arg_35_1)
	for iter_35_0, iter_35_1 in ipairs(arg_35_1.items) do
		if iter_35_0 > #arg_35_1.originalItems then
			return
		end

		self:updateRewardSprite(iter_35_0, iter_35_1, arg_35_1.originalItems[iter_35_0].itemcount, arg_35_1.originalItems[iter_35_0].itemid)
	end
end

function SlotMachineSprite:showRewardByIndex(arg_36_1)
...
function SlotMachineSprite:clearLastEffect()
...
function SlotMachineSprite.updateAlert(arg_38_0)
	return
end

function SlotMachineSprite:skip()
