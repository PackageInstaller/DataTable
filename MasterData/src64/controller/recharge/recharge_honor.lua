...
function var_0_0.doPayment(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	...
	print("PayInfo: ", var_3_0.productid, var_3_0.name, var_3_0.rmb * 100, var_3_0.des, "CNY", arg_3_2, json.encode(var_3_1))
	SDKManager.doPay(var_3_0.productid, var_3_0.name, var_3_0.rmb * 100, var_3_0.des, "CNY", arg_3_2, json.encode(var_3_1))
end
