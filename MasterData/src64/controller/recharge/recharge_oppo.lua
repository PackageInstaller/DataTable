...
function var_0_0.doPayment(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	...
	print("PayInfo: ", arg_3_2, json.encode(var_3_1), tostring(var_3_0.rmb * 100), var_3_0.name, var_3_0.des, arg_3_3)
	SDKManager.doPay(arg_3_2, json.encode(var_3_1), tostring(var_3_0.rmb * 100), var_3_0.name, var_3_0.des, arg_3_3)
end
