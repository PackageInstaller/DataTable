...
function var_0_0.doPayment(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5, arg_3_6)
	...
	print("PayInfo: ", arg_3_2, var_3_0.rmb * 100, var_3_0.productid, var_3_0.name, arg_3_6)
	SDKManager.pay(arg_3_2, var_3_0.rmb * 100, var_3_0.productid, var_3_0.name, arg_3_6)
end
