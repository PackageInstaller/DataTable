...
function var_0_0.doPayment(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	...
	print("PayInfo: ", playermodel.playerid, var_3_0.rmb * 100, var_3_0.productid, var_3_0.name)
	SDKManager.doPay(playermodel.playerid, var_3_0.rmb * 100, var_3_0.productid, var_3_0.name)
end
