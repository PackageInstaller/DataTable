return {
	init = function(arg_1_0)
		SDKManager.registerLoginHandler(function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
			print("Vivo Login Callback: ", arg_2_0, arg_2_2, arg_2_1, arg_2_3)
			...
			if arg_2_0 == 0 then
				if account_manager.loginRequestingHandler then
					...
					account_manager.loginRequestingHandler(1, arg_2_2, arg_2_3)
				end
		...
		SDKManager.registerLogoutHandler(function(arg_3_0)
			print("Vivo Logout Callback: ", arg_3_0)
			global_restart_game()
		end)
	end,
	...
	onLoginSuccess = function(arg_5_0)
		...
		SDKManager:reportLoginResult("0", "")
		SDKManager:reportRoleInfo(playermodel.userid, playermodel.level, playermodel.nickname, "1", "1")
		SDKManager:queryMissOrderResult(function(arg_6_0)
			return
		end)
	end
}
