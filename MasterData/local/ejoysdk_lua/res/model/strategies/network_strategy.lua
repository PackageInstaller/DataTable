...
local function check_strategy_state(lis, strategy)
  ...
  E.LOG.debug(TAG, "check_strategy_state with strategy:" .. tostring(strategy) .. ", m_current_is_mobile_network:" .. tostring(m_current_is_mobile_network) .. ", available:" .. tostring(is_network_available()) .. ", staisfied:" .. tostring(staisfied))
  return staisfied
end

local function on_network_change_handler()
  E.LOG.debug(TAG, "on_network_change_handler, available:" .. tostring(is_network_available()) .. ", mobile:" .. tostring(is_mobile_network()) .. ", m_current_is_mobile_network:" .. tostring(m_current_is_mobile_network))
