...
local review_product_code, public_product_code, qz_product_code, qz_startup_enable_app_update
...
function M.update_startup_game_origin_params(params)
  gm_origin_params = params or {}
end

function M.get_startup_game_origin_params()
  return gm_origin_params
end
