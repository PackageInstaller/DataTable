...
local function _get_res_update_info(namespace, res_key, local_res_version)
  ...
  E.LOG.debug(TAG, "get res update info: ns: " .. tostring(namespace) .. ", rk: " .. tostring(res_key) .. ", local_res_version is " .. tostring(local_res_version))
  E.LOG.debug(TAG, update_infos_cache)
