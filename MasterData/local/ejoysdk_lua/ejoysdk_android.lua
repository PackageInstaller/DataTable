...
function Sysinfo.open_url(url, params)
  ...
  return M.invoke, IVK_SYSINFO_OPEN_URL, params, {scheme_url = url}, nil
end
...
function _Private.is_support_tap_appreviews()
  ...
  local CONFIG = require("ejoysdk_lua.ejoysdk_config")
  if CONFIG.has_vendor_config("tapupdate") then
    local VC = require("ejoysdk_lua.ejoysdk_version_check")
    local tapupdate_ver = M.Sdkinfo.getSDKVersionName("TAP_UPDATE")
    _Private._is_support_tap_appreviews = VC.compare_versions(tapupdate_ver, "4.5.3.8") >= 0
