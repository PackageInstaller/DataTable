...
local BADGE_ANNS_READ_V2 = E.LazyKeyStore:New("EJOYSDK_BADGE_ANNS_READ_V2", false, true, false)
local ANNS_CACHE_MODEL = E.LazyKeyStore:New("EJOYSDK_ANNS_CACHE_MODEL", false, true, false)
local ann_data_map = {
  ann_version = 0,
  tpl_version = 0,
  version_id = "",
...
local function reset_ann_data_map()
  ...
  badge_anns_map = {}
  ANNS_CACHE_MODEL:set(UTIL.deepcopy(ann_data_map))
  BADGE_ANNS_READ_V2:set(UTIL.deepcopy(badge_anns_map))
end
...
function M.consume(template_id, ann_id, cb)
  ...
  BADGE_ANNS_READ_V2:set(badge_anns_map)
  cb(true)
end
...
function M.init(_opt)
  ...
  inited = true
  badge_anns_map = BADGE_ANNS_READ_V2:get() or {}
  ann_data_map = ANNS_CACHE_MODEL:get() or ann_data_map
  _opt = _opt or {}
