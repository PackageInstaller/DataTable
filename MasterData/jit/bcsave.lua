...
local function var_0_17(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	var_12_7.sect[3].size = var_12_5(#var_12_0 + 2)
...
local function var_0_21(arg_22_0, arg_22_1, arg_22_2)
	local var_22_0 = var_0_5(arg_22_0)

	require("jit.bc").dump(var_22_0, var_0_6(arg_22_1, "w"), true, arg_22_2)
end
...
local function var_0_23(...)
	...
	while var_24_1 <= #var_24_0 do
		local var_24_5 = var_24_0[var_24_1]

		if type(var_24_5) == "string" and string.sub(var_24_5, 1, 1) == "-" and var_24_5 ~= "-" then
			...
			for iter_24_0 = 2, #var_24_5 do
				local var_24_6 = string.sub(var_24_5, iter_24_0, iter_24_0)

				if var_24_6 == "l" then
					var_24_2 = true
				elseif var_24_6 == "L" then
					var_24_2 = true
					var_24_3 = true
				elseif var_24_6 == "s" then
					var_24_4.strip = true
				elseif var_24_6 == "g" then
					var_24_4.strip = false
				else
					if var_24_0[var_24_1] == nil or iter_24_0 ~= #var_24_5 then
						var_0_3()
					end
					...
					elseif var_24_6 == "n" then
						var_24_4.modname = var_0_12(table.remove(var_24_0, var_24_1))
					elseif var_24_6 == "t" then
						var_24_4.type = var_0_10(table.remove(var_24_0, var_24_1), var_0_7, "file type")
					elseif var_24_6 == "a" then
						var_24_4.arch = var_0_10(table.remove(var_24_0, var_24_1), var_0_8, "architecture")
					elseif var_24_6 == "o" then
						var_24_4.os = var_0_10(table.remove(var_24_0, var_24_1), var_0_9, "OS name")
					else
						var_0_3()
					end
				end
	...
	if var_24_2 then
		...
		var_0_21(var_24_0[1], var_24_0[2] or "-", var_24_3)
	else
		if #var_24_0 ~= 2 then
			var_0_3()
		end

		var_0_22(var_24_4, var_24_0[1], var_24_0[2])
	end
end
