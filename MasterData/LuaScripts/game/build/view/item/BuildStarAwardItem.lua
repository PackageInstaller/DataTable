-- @FileName:   LinklinkStarAwardItem.lua
-- @Description:   描述
-- @Author: ZDH
-- @Date:   2024-12-03 17:26:02
-- @Copyright:   (LY) 2024 锚点降临
module('build.BuildStarAwardItem', Class.impl('lib.component.BaseItemRender'))

-- 星级奖励列表项，展示奖励道具、领取状态和当前星级进度
...
function onGetAward(self)
    GameDispatcher:dispatchEvent(EventName.REQ_MOLE_RECEIVE_STAR, {self.data.config.id})
end
