module("hero.HeroStarUpScrollItem", Class.impl("lib.component.BaseItemRender"))
...
function __onClickHeadHandler(self, args)
	...
	if(hero.HeroUseCodeManager:getIsCanUse(heroVo.id, true))then
		hero.HeroStarManager:dispatchEvent(hero.HeroStarManager.HERO_STARUP_MATERIAL_SELECT, heroVo)
	end
end
