--[[ 
-----------------------------------------------------
@filename       : FormationApostlesController
@Description    : 使徒之战2
...
module("formation.FormationApostlesController", Class.impl("game.formation.normal.controller.FormationController"))

---------------------------------------------------------------固定需要-----------------------------------------------------------------
function getManager(self)
    return formation.FormationApostlesManager
end
...
function __openFormationPanel(self)
    if self.m_heroFormationPanel == nil then
        self.m_heroFormationPanel = formation.FormationApostlesPanel.new()
...
function __onOpenFormationHeroSelectPanelHandler(self, args)
    if self.mFormationHeroSelectPanel == nil then
        self.mFormationHeroSelectPanel = formation.FormationApostlesHeroSelectPanel.new()
