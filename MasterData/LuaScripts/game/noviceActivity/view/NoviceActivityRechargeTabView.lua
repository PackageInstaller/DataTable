...
module('noviceActivity.NoviceActivityRechargeTabView', Class.impl(TabSubView))

--对应的ui文件
UIRes = UrlManager:getUIPrefabPath("noviceActivity/NoviceActivityRechargeTabView.prefab")
...
function configUI(self)
    ...
    self.mLyScroller:SetItemRender(noviceActivity.NoviceActivityAccRechargeItem)
end
...
function initViewText(self)
    self.mTxtRechargeDes.text = _TT(121014,noviceActivity.NoviceActivityManager:getRechargeNum())
...
function updateView(self)
    ...
    local curActivityOverTime = noviceActivity.NoviceActivityManager:getNoviceActivityRechargeEndTime()
...
function updateList(self,isInit)
    ...
    local list = noviceActivity.NoviceActivityManager:getRechargeList()
