-- @FileName:   BulleDupPanel.lua
-- @Description:   大西瓜关卡
-- @Copyright:   (LY) 2023 雷焰网络
module('bulle.BulleDupPanel', Class.impl(View))

-- 对应的ui文件
UIRes = UrlManager:getUIPrefabPath("bulle/BulleDupPanel.prefab")
...
function updateView(self, args, noShow)
    ...
    local his = bulle.BulleManager:getDupPassStar(self.m_DupConfigVo.id)
...
function onClickClose(self)
    ...
    GameDispatcher:dispatchEvent(EventName.CLOSE_BULLE_DUP_PANEL)
end

function onFight(self)
    local activity_id = activity.ActivityId.Bulle
