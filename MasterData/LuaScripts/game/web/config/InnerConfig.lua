return {
    ...
    -- 获取指定服或推荐服（没有选服界面）
    ["recommand_server_info"] = "https://server_manager_api_dev.leiyangame.com/ApiServer/pfRecommendSrvList/g/12",
    ...
    -------------------------------------------------- web_gms_api_dev --------------------------------------------------
    -- 渠道cdn资源更新类型
    ["check_channel_update_type"] = "https://web_gms_api_dev.leiyangame.com/Api/ClientServer/checkChannelAllUpdate/g/12",
    -- 通用参数统计
    ["generic_args_url"] = "https://web_gms_api_dev.leiyangame.com/ClientServer/genericArgs/g/12",

    -- 获取服务器列表
    -- ["server_list"] = "https://web_gms_api_dev.leiyangame.com/ApiServer/getPfSrvList/g/3",
    -- 获取登录公告多栏目
    ["bulletin_list_url"] = "https://web_gms_api_dev.leiyangame.com/Api/Bulletin/getLoginBulletins/g/12",
    -- 上报步骤统计
    ["report_step_url"] = "https://web_gms_api_dev.leiyangame.com/Api/ClientServer/loginStepLogs/g/12",
    -- -- 上报步骤加载时长统计
    -- ["report_step_loading_time_url"] = "",
    -- bug统计
    ["bug_url"] = "https://web_gms_api_dev.leiyangame.com/Api/ClientServer/clientBugLogs/g/12",
    -- 获取QQ客服
    ["qq_service_url"] = "https://web_gms_api_dev.leiyangame.com/Bulletin/getCustomerServiceQq/g/12",
    -- -- 获取VIP客服
    -- ["vip_service_url"] = "",
    
    -- 获取IP地址
    ["get_ip"] = "https://web_gms_api_dev.leiyangame.com/Api/IpInfo/getClientIP/g/12",
    ...
    ["player_info_url"] = "",
    -- 请求订单充值
    ["recharge_order_url"] = "https://sdk_app_dev.leiyangame.com/Pay/order/g/12/pf/",
