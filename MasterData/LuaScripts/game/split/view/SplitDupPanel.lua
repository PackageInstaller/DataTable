-- @FileName:   SplitDupPanel.lua
-- @Description:   大西瓜关卡
-- @Copyright:   (LY) 2023 雷焰网络
module('split.SplitDupPanel', Class.impl(View))

-- 对应的ui文件
UIRes = UrlManager:getUIPrefabPath("split/SplitDupPanel.prefab")
...
function updateView(self, args, noShow)
    ...
    local his = split.SplitManager:getDupPassStar(self.m_DupConfigVo.id)
...
function onFight(self)
    local activity_id = activity.ActivityId.Split
