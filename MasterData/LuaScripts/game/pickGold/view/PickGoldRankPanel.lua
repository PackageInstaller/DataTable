--[[ 
-----------------------------------------------------
@filename       : PickGoldRankPanel
@Description    : 2048积分排行榜
@copyright      : (LY) 2023 雷焰网络
-----------------------------------------------------
]]
module("game.pickGold.view.PickGoldRankPanel", Class.impl(View))

UIRes = UrlManager:getUIPrefabPath("pickGold/PickGoldRankPanel.prefab")
...
function configUI(self)
    ...
    self.mScroller:SetItemRender(pickGold.PickGoldRankItem)
...
function active(self)
    super.active(self)
    GameDispatcher:dispatchEvent(EventName.REQ_RANK_DATA, { type = rank.RankConst.PICKGOLD })
...
function updateView(self)
    local rankData = rank.RankManager:getRankInfoVo(rank.RankConst.PICKGOLD)
