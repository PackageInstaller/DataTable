...
--- *s2c* 刮刮乐面板 24510
SC_SCRATCH_CARD_PANEL =
{
    24510, 
    {"cur_grade", "int8", "当前轮次"}, 
    {"cur_times", "int8", "累计抽奖次数"}, 
    {"show_card_list", pt_scratch_card_show, "已领取的累计抽奖奖励", "repeated"},
}
...
SC_SCRATCH_CARD =
{
    24512, 
    {"pos", "int8", "位置"}, 
    {"show_card_list", pt_scratch_card_show, "新刮的位置及其奖励", "repeated"}, 
    {"result", "int8", "结果，1：成功 0：失败"},
}
 
--- *c2s* 刮刮乐-刷新 24513
CS_SCRATCH_CARD_NEXT_GRADE =
{
    24513,
}
 
--- *s2c* 作战储备-体力-面板 24520
SC_COMBAT_PREPARE_STRENGTH_PANEL =
{
    24520, 
    {"end_time", "int32", "结束时间戳"}, 
    {"act_state", "int8", "活动状态"}, 
    {"day", "int16", "活动天数"}, 
    {"reward_list", "int16", "已领取列表Id", "repeated"},
}
 
--- *c2s* 领取-作战储备-体力奖励 24521
CS_COMBAT_PREPARE_STRENGTH_GAIN =
{
    24521, 
...
--- *c2s* 领取周年活动任务目标奖励 24584
CS_CELE_ACTIVITY_TASK2_TARGET_GAIN =
{
    24584,
}
 
--- *s2c* 领取周年活动任务目标奖励 24585
...
--- *s2c* 每日累充面板 24590
SC_DAY_ACC_PAY_PANEL =
{
    24590, 
    {"day_acc_pay_lit", pt_day_acc_pay, "累充数据", "repeated"}, 
    {"today_pay", "int32", "今日充值金额"},
}
 
--- *c2s* 周年活动任务领取任务奖励 24591
CS_DAY_ACC_PAY_GAIN_AWARD =
{
    24591, 
    {"gear", "int8", "档位"}, 
    {"day", "int8", "第几天天"},
...
--- *s2c* 周年活动任务领取任务奖励 24592
SC_DAY_ACC_PAY_GAIN_AWARD =
{
    24592, 
    {"result", "int8", "结果，1：成功 0：失败"},
}
