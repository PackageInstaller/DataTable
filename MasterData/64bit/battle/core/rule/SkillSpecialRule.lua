	...
	elseif self.trigger_type == 100090 then
		return function(arg_113_0, arg_113_1)
			...
			for iter_113_0, iter_113_1 in ipairs(arg_113_1) do
				...
				if arg_10_3.serialId == iter_113_1.victim.serialId and iter_113_1.victim.identity == arg_10_2 and (var_113_1.buff_type == var_0_5.TYPE.ACT_LIMIT or var_113_1.buff_type == var_0_5.TYPE.SKILL_CHOOSE) and arg_10_3:getBuffCount(var_0_5.COUNT_TYPE.CONTROL) > 1 then
					return true
				end
			end
