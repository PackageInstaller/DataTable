...
var_0_0.URL = "ui://9j4hqll0kyxea2o"

function var_0_0:__ctor()
	self.m_touchArea = self:getChild("touchArea")
	self.m_rewardBg = self:getChild("rewardBg")
	self.m_bigRewardLoader = self:getChild("bigRewardLoader")
	self.m_atmosLoader = self:getChild("atmosLoader")
	self.m_zsWordLoader1 = self:getChild("zsWordLoader1")
	self.m_zsWordLoader4 = self:getChild("zsWordLoader4")
	self.m_nameLoader = self:getChild("nameLoader")
	self.m_descTxt = self:getChild("descTxt")
	self.m_zsNumberLoader = self:getChild("zsNumberLoader")
	self.m_lineLoader = self:getChild("lineLoader")
	self.m_clock = self:getChild("clock")
