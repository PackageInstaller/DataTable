...
var_0_0.URL = "ui://kvb3znepef8n1emigao"

function var_0_0:__ctor()
	self.m_bottomContentController = self:getController("bottomContent")
	self.m_isHideSuccubaController = self:getController("isHideSuccuba")
	...
	self.m_leaderGainComp = self:getChild("leaderGainComp")
	self.m_readFormationBtn = self:getChild("readFormationBtn")
