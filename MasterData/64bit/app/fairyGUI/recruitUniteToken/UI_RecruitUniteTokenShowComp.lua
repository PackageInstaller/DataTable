...
var_0_0.URL = "ui://3jnmvl3psro6gic26"

function var_0_0:__ctor()
	self.m_typeController = self:getController("type")
	self.m_bg = self:getChild("bg")
	self.m_effBg = self:getChild("effBg")
	self.m_circleBg3 = self:getChild("circleBg3")
	self.m_circleBg4 = self:getChild("circleBg4")
	self.m_circleBg1 = self:getChild("circleBg1")
	self.m_circleBg2 = self:getChild("circleBg2")
