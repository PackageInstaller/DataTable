...
function var_0_0:__ctor()
	...
	self.m_rewardItem12 = self:getChild("rewardItem12")
	self.m_rewardItem11 = self:getChild("rewardItem11")
	...
	self.m_rewardItem13 = self:getChild("rewardItem13")
	self.m_rewardItem14 = self:getChild("rewardItem14")
