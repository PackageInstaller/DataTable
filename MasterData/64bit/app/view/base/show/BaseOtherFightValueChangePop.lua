local BaseOtherFightValueChangePop = class("BaseOtherFightValueChangePop", require("app.fairyGUI.base_new.UI_BaseOtherFightValueChangePop"), function()
	return fgui.GComponent:create({
		resName = "BaseOtherFightValueChangePop",
		pkgName = "base_new",
...
function BaseOtherFightValueChangePop:ctor(arg_2_1)
	...
	self.m_fightTxt:setText(arg_2_1.title)
	self.m_fightValueTxt:setText(arg_2_1.preValue - self._changeValue)
