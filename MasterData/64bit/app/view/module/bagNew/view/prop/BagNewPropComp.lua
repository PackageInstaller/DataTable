...
function BagNewPropComp:_sortItemsData(arg_18_1)
	...
	table.sort(arg_18_1, function(arg_19_0, arg_19_1)
		...
		if var_19_2.limited_time ~= 0 or var_19_4 ~= 0 then
			if var_19_2.limited_time ~= 0 then
				if var_0_3:getLeftSeconds(var_19_2.limited_time or var_19_4) <= var_18_5 then
					var_19_0 = true
				end

				if var_19_3.limited_time ~= 0 or var_19_5 ~= 0 then
					if var_19_3.limited_time ~= 0 then
						if var_19_0 ~= ((var_0_3:getLeftSeconds(var_19_3.limited_time or var_19_5) <= var_18_5 or nil) and true) then
							return var_19_0
						end
