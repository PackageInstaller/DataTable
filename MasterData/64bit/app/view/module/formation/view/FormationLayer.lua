...
function FormationLayer:_dragLineupKnight(arg_12_1)
	...
	if self._knightData[self._starPos] > 0 then
		...
		local var_12_1 = fgui.DragDropManager:getInstance()

		var_12_1.startDrag(var_12_0, "common/ui_cocos/lineUp/pic_touming.png", nil, (var_12_0:getTouchId()))

		local var_12_2 = BattleKnight.new({
			scale = 1.2,
			breath = true,
			base = true,
		...
		var_12_2:setScale(1.2)
		var_12_2:setName("knight")
		var_12_1:getAgent():displayObject():addChild(var_12_2)
		var_12_2:setPosition(50, 0)
