...
function WindowsDebugNode:_parabolaTest()
	...
	local var_5_1 = display.newLayer(cc.c4b(255, 0, 0), cc.size(100, 100))

	var_5_1:setVisible(true)
	self:addChild(var_5_1, 1000)

	local var_5_2 = self:_createParabola(0.4, cc.p(0, 0), cc.p(400, 0), 100, 30)
	local var_5_3 = cc.MoveTo:create(0.5, cc.p(0, 100))

	var_5_1:runAction((cc.MoveBy:create(0.5, cc.p(0, 100))))
end
