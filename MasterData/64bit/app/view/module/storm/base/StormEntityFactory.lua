...
local StormMapVisualImage = require("app.view.module.storm.base.StormMapVisualImage")
...
local StormEntityFactory = class("StormEntityFactory", (require("app.core.ksmap.entity.EntityFactory")))

function StormEntityFactory:createEntity()
	return self.type == MapConst.RESTYPE.KNIGHT and StormMainRole.new(self) or StormMapItem.new(self, "bio")
end

function StormEntityFactory:createVisual(arg_2_1, arg_2_2, arg_2_3)
	return self == MapConst.RESTYPE.IMAGE and StormMapVisualImage.new(arg_2_1, "bio", arg_2_2, arg_2_3) or self == MapConst.RESTYPE.SPINE and MapVisualEffect.new(arg_2_1) or self == MapConst.RESTYPE.EMPTY_SPACE and MapVisualEmptySpace.new() or StormRoleVirtual.new(arg_2_1)
end
