local AkiraThemeBioChapterComp = class("AkiraThemeBioChapterComp", require("app.fairyGUI.themeBio.UI_AkiraThemeBioChapterComp"))
...
function AkiraThemeBioChapterComp:ctor()
	self._info = nil
	self._chapterId = nil
...
function AkiraThemeBioChapterComp:updateData(arg_2_1, arg_2_2)
...
function AkiraThemeBioChapterComp:_changeAnimateMode(arg_3_1)
...
function AkiraThemeBioChapterComp:playAnimateUnlock(arg_4_1)
	return
end

function AkiraThemeBioChapterComp:_checkUnlock(arg_5_1)
	if not arg_5_1 then
		return
	end
...
function AkiraThemeBioChapterComp:_onOpenBioMapClick()
...
function AkiraThemeBioChapterComp:checkPlayedPassEffect()
...
return AkiraThemeBioChapterComp
