...
function ThemeBioVoteGameStage:refreshTargetVector()
	...
	if var_77_1 then
		...
		local var_77_7, var_77_8 = self:getMapWorld():getTargetAngelFromScreenCenter((cc.pNormalize((cc.pSub(cc.p(var_77_5 - 100, var_77_6 + 100), (self:getMapGround():convertToNodeSpace(display.center)))))))
