...
local ThemeBioGameStage = class("ThemeBioGameStage", require("app.fairyGUI.themeBio.UI_ThemeBioGameStage"), function()
...
function ThemeBioGameStage:ctor(arg_2_1)
...
function ThemeBioGameStage:onLoad()
	self:_initRegister()
...
function ThemeBioGameStage:_addBgMusic()
	self._bgMusic = nil
...
function ThemeBioGameStage:onUnload()
...
function ThemeBioGameStage:receiveCompEvent(arg_6_1, arg_6_2)
	if arg_6_1 == "EVENT_STORY_END" then
		self:_onEventStoryEnd(arg_6_2)
	elseif arg_6_1 == "UI_EVENT_CLOSE_MAIN_INFO_END" then
...
function ThemeBioGameStage:initStage()
	self:_initMapWorld()
	self:_initStageData()
	self:_initStageUI()
...
function ThemeBioGameStage:_setMapCanTouchable()
	self.m_touchMap:setTouchable(true)
end

function ThemeBioGameStage:_playMainActionStart()
...
function ThemeBioGameStage:_playMainInfoStart()
...
function ThemeBioGameStage:_playMainFlowStart()
	self:_setHudUIShow(true)
end

function ThemeBioGameStage:_playMainFlowEnd()
	self:newScheduleOnce(function()
		g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	end)
end

function ThemeBioGameStage:_checkChapterFinish(arg_14_1)
...
function ThemeBioGameStage:_playScrollAwardShow()
	self:_playMainInfoEnd()
end

function ThemeBioGameStage:_playMainInfoEnd()
	g.core.module.ModuleManager:pushPopup(require("app.view.module.themeBio.view.ThemeBioChapterEndPop").new({
		chapterInfo = self._refChapterInfo,
		themeValue = self._activeThemeValue,
		callFunc = handler(self, self._playMainFlowEnd)
	}), {
		withoutAni = true
	})
end

function ThemeBioGameStage:_checkFirstChapter()
...
function ThemeBioGameStage:getMapWorld()
	return self._mapWorld
end

function ThemeBioGameStage:getMapGround()
	return self._mapWorld:getMapGround()
end

function ThemeBioGameStage:talkTrigger(arg_20_1)
	...
	if not arg_20_1:getIsInteractEntity() then
		...
		for iter_20_0, iter_20_1 in ipairs(var_20_1) do
			...
			if var_20_5.type == 4 and var_20_4.isLast then
				...
				if not var_20_6 or not var_20_6.finish or not ((var_20_5.type == 1 and not var_20_4.finish and var_20_4.unlock or nil) and false) then
					break
				end
...
function ThemeBioGameStage:setAutoSearchPath(arg_22_1)
	self.m_autoComp:setVisible(arg_22_1)
end

function ThemeBioGameStage:pickupStop()
	self.m_pickupComp:setVisible(false)
	self.m_pickupComp:stopAllFGActions()
end

function ThemeBioGameStage:saveStayCoord(arg_24_1)
...
function ThemeBioGameStage:getStayCoord()
	return self._themeBioStorage["stay_" .. self._chapterId]
end

function ThemeBioGameStage:setHeadArrow(arg_26_1, arg_26_2, arg_26_3)
	self.m_headBtn:setVisible(arg_26_1)
end

function ThemeBioGameStage:_loadSnowMovie(arg_27_1)
...
function ThemeBioGameStage:_delayCreateMovie()
...
function ThemeBioGameStage:_onCriSpriteEvent()
...
function ThemeBioGameStage:_initRegister()
...
function ThemeBioGameStage:_setHudUIShow(arg_36_1)
	if arg_36_1 then
...
function ThemeBioGameStage:_pickupStart(arg_37_1, arg_37_2, arg_37_3)
	self.m_pickupComp:stopAllFGActions()
...
function ThemeBioGameStage:_serializeBio()
	g.core.common.Storage:save("theme_biography.json", self._themeBioStorage)
end

function ThemeBioGameStage:_deserializeBio()
...
function ThemeBioGameStage:_showBubbleOrStory(arg_41_1)
	local var_41_0 = {}
...
function ThemeBioGameStage:_executeMission(arg_42_1)
...
function ThemeBioGameStage:_onMissionStoryEnd(arg_43_1)
...
function ThemeBioGameStage:_onTriggerMission(arg_44_1, arg_44_2, arg_44_3, arg_44_4)
...
function ThemeBioGameStage:_processMissionBattle(arg_45_1, arg_45_2, arg_45_3, arg_45_4)
	if arg_45_2 ~= 1 then
		var_0_10:send_C2S_ThemeBiography_ExecuteMission({
			act_id = self._activeThemeValue,
			id = arg_45_1.id
...
function ThemeBioGameStage:_processMissionEvent(arg_46_1, arg_46_2, arg_46_3, arg_46_4)
	self._refCurMission = nil
...
function ThemeBioGameStage:_processMissionOther(arg_47_1, arg_47_2, arg_47_3, arg_47_4)
	var_0_10:send_C2S_ThemeBiography_ExecuteMission({
		act_id = self._activeThemeValue,
		id = arg_47_1.id
	})
...
function ThemeBioGameStage:_beginBattleJump(arg_48_1, arg_48_2, arg_48_3)
...
function ThemeBioGameStage:_showAwardAction(arg_49_1)
	self:getMapWorld():refreshEntityState(self._refChapterInfo)
...
function ThemeBioGameStage:_onShowAwardCall(arg_51_1)
...
function ThemeBioGameStage:_afterCompletedTask(arg_52_1, arg_52_2)
...
function ThemeBioGameStage:_showMissionCostTip(arg_53_1)
	local var_53_0 = {}
...
function ThemeBioGameStage:_playTaskCompleteAni(arg_54_1, arg_54_2)
...
function ThemeBioGameStage:checkExitBtnShow(arg_55_1)
...
function ThemeBioGameStage:_showCompletedAward(arg_56_1, arg_56_2, arg_56_3)
	g.core.module.ModuleManager:awardSummary(arg_56_1)
end

function ThemeBioGameStage:_isNeedStory(arg_57_1)
...
function ThemeBioGameStage:_executeStory(arg_58_1, arg_58_2)
...
function ThemeBioGameStage:_onEventStoryEnd(arg_59_1)
...
function ThemeBioGameStage:_getMissionTarget(arg_61_1, arg_61_2)
	local var_61_0
...
function ThemeBioGameStage:_onSearchPathTarget(arg_62_1, arg_62_2)
...
function ThemeBioGameStage:_onCompletedTask(arg_63_1, arg_63_2)
	self:_afterCompletedTask(arg_63_2.id, arg_63_2.awards)
end

function ThemeBioGameStage:_onSetHudUIShow(arg_64_1, arg_64_2)
	self:_setHudUIShow(arg_64_2)
end

function ThemeBioGameStage:_onJumpMainRoleClick()
	self._mapWorld:jump2MainRole()
	self:setHeadArrow(false)
end

function ThemeBioGameStage:_onClickExitBtn()
	g.core.module.ModuleManager:popModule()
end

function ThemeBioGameStage:_onBioBagClick()
	self:addPopup((require("app.view.module.themeBio.view.ThemeBioPropPop").new(self._chapterId)))
end

function ThemeBioGameStage:_onNetExecuteMission(arg_68_1, arg_68_2, arg_68_3)
...
function ThemeBioGameStage:_onPopTaskFinish(arg_69_1, arg_69_2)
	self:_onTriggerMission(arg_69_2.mission, 0, false, arg_69_2.touchItem)
end

function ThemeBioGameStage:_onPublishLastTaskFinish(arg_70_1, arg_70_2)
	self:_executeStory({
		id = arg_70_2.storyId
	})
end

function ThemeBioGameStage:refreshTargetVector()
	...
	if var_71_1 then
		...
		local var_71_7, var_71_8 = self:getMapWorld():getTargetAngelFromScreenCenter((cc.pNormalize((cc.pSub(cc.p(var_71_5 - 100, var_71_6 + 100), (self:getMapGround():convertToNodeSpace(display.center)))))))

		self.m_directionComp:updateDirectionByAngle(var_71_7, var_71_8, var_71_0)
	end
end

function ThemeBioGameStage:_checkChainState()
...
function ThemeBioGameStage:isNextMissionTarget(arg_73_1)
...
function ThemeBioGameStage:_executeInteractOperation(arg_74_1, arg_74_2)
...
function ThemeBioGameStage:_showMissionFinishTips(arg_75_1)
	if arg_75_1 then
...
function ThemeBioGameStage:_onCrossDayUpdate()
...
function ThemeBioGameStage:_afterAwardCall()
	self:newScheduleOnce(function()
