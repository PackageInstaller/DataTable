...
function HomePassComp:_updatePushCountDown()
	...
	if var_31_0 then
		...
		local var_31_2 = var_31_0.create_time + var_31_1.gift_time_limit - g.core.common.ServerTime:getTime()

		if var_31_2 > 0 then
			self.m_pushGiftBtn:getChild("timeTxt"):setVisible(true)
			self.m_pushGiftBtn:getChild("timeTxt"):setText((g.core.common.ServerTime:_secondToString(var_31_2)))
		else
