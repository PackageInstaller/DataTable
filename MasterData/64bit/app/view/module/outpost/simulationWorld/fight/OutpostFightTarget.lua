...
return {
	...
	findTarget2 = function(self, arg_2_1, arg_2_2)
		...
		local var_2_1 = arg_2_1.world:getVirtualMap():queryRangeEntities(arg_2_1.x, arg_2_1.y, (self:getAttr():getAttackMaxRange()))
		local var_2_2 = {}
	...
	findTarget4 = function(self, arg_5_1, arg_5_2)
		...
		local var_5_1 = self.world:getVirtualMap():queryRangeEntities(self.x, self.y, (self:getAttr():getAttackMaxRange()))
		local var_5_2 = {}
