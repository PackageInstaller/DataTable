...
local OutpostMonsterAtkFsm = class("OutpostMonsterAtkFsm", require("app.core.fsm.KSComFSM"))

function OutpostMonsterAtkFsm:ctor()
	OutpostMonsterAtkFsm.super.ctor(self)
end

function OutpostMonsterAtkFsm:_doStartupEntrance()
	self:transitionTo((require("app.core.fsm.KSComTransition").new({
		tid = var_0_0.FsmState.ReadyingAtk
	})))
end

function OutpostMonsterAtkFsm:_doInitAllStates()
	...
	local var_3_10 = self:_getTran("MoveTransition", {
		isTarget = false,
		entity = self._ownerObj
	})
	local var_3_11 = self:_getTran("HpTransition", {
		isRate = false,
		checkValue = 0,
		isLower = true,
		entity = self._ownerObj
	...
	var_3_6:addTransitionState(var_3_8, var_3_2)
	var_3_5:addTransitionState(var_3_8, var_3_2)
	var_3_4:addTransitionState(var_3_8, var_3_2)
	var_3_3:addTransitionState(var_3_9, var_3_0)
	var_3_2:addTransitionState(var_3_9, var_3_0)
	var_3_1:addTransitionState(var_3_9, var_3_0)
	var_3_3:addTransitionState(var_3_10, var_3_1)
	var_3_2:addTransitionState(var_3_10, var_3_1)
	var_3_6:addTransitionState(var_3_11, var_3_3)
	var_3_0:addTransitionState(var_3_11, var_3_3)
	var_3_1:addTransitionState(var_3_11, var_3_3)
	var_3_4:addTransitionState(var_3_11, var_3_3)
	var_3_5:addTransitionState(var_3_11, var_3_3)
	var_3_2:addTransitionState(var_3_11, var_3_3)
...
function OutpostMonsterAtkFsm:_getTran(arg_4_1, arg_4_2)
	return self:addTransition(require(var_0_2 .. arg_4_1).new(arg_4_2))
end

function OutpostMonsterAtkFsm:_getState(arg_5_1)
...
function OutpostMonsterAtkFsm:_getCommonState(arg_6_1)
