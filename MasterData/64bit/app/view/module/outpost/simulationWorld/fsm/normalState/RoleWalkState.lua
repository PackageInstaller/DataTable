...
local RoleWalkState = class("RoleWalkState", require("app.view.module.outpost.simulationWorld.fsm.baseState.OutpostBaseState"))

function RoleWalkState:onCreate()
	self._stUUID = var_0_2.FsmState.WALK
end

function RoleWalkState:onInitState()
...
function RoleWalkState:doBeforeEntering()
	local var_3_0 = self._map:getGridByMapType((self._entity:getMapType()))
...
function RoleWalkState:pathFind(arg_4_1)
...
function RoleWalkState:onTickUpdate(arg_6_1)
...
function RoleWalkState:doBeforeLeaving()
	self._entity:setMovePos(nil)
	self:stopTask()
end

return RoleWalkState
