...
function OutpostMapWorld:_initMoveRange()
	...
	local var_22_1 = var_22_0:getMapHeight()
	local var_22_2 = self:getMapGround():getHalfTileH()

	self._minMoveX = -var_22_0
	self._maxMoveX = self:getMapGround():getMapWidth() / 2 - display.width / 2 - display.height
	self._minMoveY = var_22_1 / 2 - var_22_2 - self._maxMoveX / 2
	self._maxMoveY = var_22_1 / 2 - var_22_2 + self._maxMoveX / 2
end
