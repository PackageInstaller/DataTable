...
local OutpostMapTouch = class("OutpostMapTouch", require("app.core.ksmap.touch.MapTouch"))

function OutpostMapTouch:ctor(arg_1_1)
	OutpostMapTouch.super.ctor(self, arg_1_1)

	self._lastOffGL = nil
end

function OutpostMapTouch:onMatchBegan(arg_2_1)
	if not arg_2_1 then
		return false
	end
...
function OutpostMapTouch:onMatchMoved(arg_3_1)
...
function OutpostMapTouch:onMatchEnded(arg_4_1)
...
function OutpostMapTouch:onMatchClicked(arg_5_1)
	self:getMapWorld():onSingleClick((arg_5_1:getLocation()))
end

return OutpostMapTouch
