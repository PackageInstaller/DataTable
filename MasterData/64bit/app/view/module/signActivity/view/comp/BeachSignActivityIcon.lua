...
local BeachSignActivityIcon = class("BeachSignActivityIcon", require("app.fairyGUI.signActivity.UI_BeachSignActivityIcon"))

function BeachSignActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function BeachSignActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function BeachSignActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function BeachSignActivityIcon:_updateStateCtrl()
...
function BeachSignActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return BeachSignActivityIcon
