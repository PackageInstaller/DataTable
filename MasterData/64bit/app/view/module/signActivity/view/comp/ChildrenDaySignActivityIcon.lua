...
local ChildrenDaySignActivityIcon = class("ChildrenDaySignActivityIcon", require("app.fairyGUI.signActivity.UI_ChildrenDaySignActivityIcon"))

function ChildrenDaySignActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function ChildrenDaySignActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function ChildrenDaySignActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function ChildrenDaySignActivityIcon:_updateStateCtrl()
...
function ChildrenDaySignActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return ChildrenDaySignActivityIcon
