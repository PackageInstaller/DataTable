...
local PotpourriSignActivityIcon = class("PotpourriSignActivityIcon", require("app.fairyGUI.signActivity.UI_PotpourriSignActivityIcon"))

function PotpourriSignActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function PotpourriSignActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function PotpourriSignActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function PotpourriSignActivityIcon:_updateStateCtrl()
...
function PotpourriSignActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return PotpourriSignActivityIcon
