...
local SignCustomActivityIcon = class("SignCustomActivityIcon", require("app.fairyGUI.signActivity.UI_SignCustomActivityIcon"))

function SignCustomActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function SignCustomActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function SignCustomActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function SignCustomActivityIcon:_updateStateCtrl()
...
function SignCustomActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return SignCustomActivityIcon
