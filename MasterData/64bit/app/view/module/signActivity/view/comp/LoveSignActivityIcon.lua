...
local LoveSignActivityIcon = class("LoveSignActivityIcon", require("app.fairyGUI.signActivity.UI_LoveSignActivityIcon"))

function LoveSignActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function LoveSignActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function LoveSignActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function LoveSignActivityIcon:_updateStateCtrl()
...
function LoveSignActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return LoveSignActivityIcon
