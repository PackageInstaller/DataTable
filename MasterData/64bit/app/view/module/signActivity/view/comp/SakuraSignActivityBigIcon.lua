...
local SakuraSignActivityBigIcon = class("SakuraSignActivityBigIcon", require("app.fairyGUI.signActivity.UI_SakuraSignActivityBigIcon"))

function SakuraSignActivityBigIcon:ctor()
	self._subId = 0
	self._info = nil
	self._goods = nil
...
function SakuraSignActivityBigIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._subId = arg_2_2
	self._info = arg_2_1
...
function SakuraSignActivityBigIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function SakuraSignActivityBigIcon:_updateStateCtrl()
...
function SakuraSignActivityBigIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return SakuraSignActivityBigIcon
