...
local MagpieSignActivityIcon = class("MagpieSignActivityIcon", require("app.fairyGUI.signActivity.UI_MagpieSignActivityIcon"))

function MagpieSignActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function MagpieSignActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function MagpieSignActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function MagpieSignActivityIcon:_updateStateCtrl()
...
function MagpieSignActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return MagpieSignActivityIcon
