...
local FlowingLightCustomActivityPop = class("FlowingLightCustomActivityPop", require("app.fairyGUI.signActivity.UI_FlowingLightCustomActivityPop"), function()
	return fgui.GComponent:create({
		pkgName = "signActivity",
		pkgPath = "ui/signActivity/signActivity",
		resName = "FlowingLightCustomActivityPop"
	})
end)

function FlowingLightCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.FLOWLIGHT_SIGN_ACTIVITY
...
function FlowingLightCustomActivityPop:onLoad()
...
function FlowingLightCustomActivityPop:_updateMainView()
...
function FlowingLightCustomActivityPop:_updateTimeText()
...
function FlowingLightCustomActivityPop:_checkAutoSignAward()
...
function FlowingLightCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function FlowingLightCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function FlowingLightCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function FlowingLightCustomActivityPop:homeLayerAutoPopup()
...
return FlowingLightCustomActivityPop
