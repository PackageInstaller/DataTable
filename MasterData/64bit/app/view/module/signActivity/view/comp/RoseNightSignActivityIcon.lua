...
local RoseNightSignActivityIcon = class("RoseNightSignActivityIcon", require("app.fairyGUI.signActivity.UI_RoseNightSignActivityIcon"))

function RoseNightSignActivityIcon:ctor()
	self._subId = 0
	self._goods = nil
...
function RoseNightSignActivityIcon:updateDayIcon(arg_2_1, arg_2_2)
	self._info = arg_2_1
	self._subId = arg_2_2
...
function RoseNightSignActivityIcon:playSignedEffect(arg_3_1)
	self:_updateStateCtrl()
...
function RoseNightSignActivityIcon:_updateStateCtrl()
...
function RoseNightSignActivityIcon:_onClick()
	if self._goods then
		g.core.common.GlobalFunc.pushInfoPop(self._goods)
	end
end

return RoseNightSignActivityIcon
