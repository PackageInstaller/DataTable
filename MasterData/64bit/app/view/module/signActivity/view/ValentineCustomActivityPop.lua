...
local ValentineCustomActivityPop = class("ValentineCustomActivityPop", require("app.fairyGUI.signActivity.UI_ValentineCustomActivityPop"), function()
	return fgui.GComponent:create({
		pkgName = "signActivity",
		pkgPath = "ui/signActivity/signActivity",
		resName = "ValentineCustomActivityPop"
	})
end)

function ValentineCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.VALENTINE_SIGN_ACTIVITY
...
function ValentineCustomActivityPop:onLoad()
...
function ValentineCustomActivityPop:_updateMainView()
...
function ValentineCustomActivityPop:_updateTimeText()
...
function ValentineCustomActivityPop:_checkAutoSignAward()
...
function ValentineCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function ValentineCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function ValentineCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function ValentineCustomActivityPop:homeLayerAutoPopup()
...
function ValentineCustomActivityPop:_playEffect()
...
return ValentineCustomActivityPop
