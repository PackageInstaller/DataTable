...
local LindellCustomActivityPop = class("LindellCustomActivityPop", require("app.fairyGUI.signActivity.UI_LindellCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "LindellCustomActivityPop",
		pkgName = "signActivity",
		pkgPath = "ui/signActivity/signActivity"
	})
end)

function LindellCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.LINDELL_SIGN_ACTIVITY
...
function LindellCustomActivityPop:onLoad()
...
function LindellCustomActivityPop:_updateMainView()
...
function LindellCustomActivityPop:_updateTimeText()
...
function LindellCustomActivityPop:_checkAutoSignAward()
...
function LindellCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function LindellCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function LindellCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function LindellCustomActivityPop:homeLayerAutoPopup()
...
function LindellCustomActivityPop:_playEffect()
	return
end

return LindellCustomActivityPop
