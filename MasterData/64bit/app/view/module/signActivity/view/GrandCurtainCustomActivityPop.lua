...
local GrandCurtainCustomActivityPop = class("GrandCurtainCustomActivityPop", require("app.fairyGUI.signActivity.UI_GrandCurtainCustomActivityPop"), function()
	return fgui.GComponent:create({
		pkgName = "signActivity",
		pkgPath = "ui/signActivity/signActivity",
		resName = "GrandCurtainCustomActivityPop"
	})
end)

function GrandCurtainCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.GRANDCURTAIN_SIGN_ACTIVITY

	self:showAtCenter()
	self:setSize(display.width, display.height)
	self.m_roleLoader:setURL("pic/signActivity/bg_3signly_juese4.png")
...
function GrandCurtainCustomActivityPop:onLoad()
...
function GrandCurtainCustomActivityPop:_updateMainView()
...
function GrandCurtainCustomActivityPop:_updateTimeText()
...
function GrandCurtainCustomActivityPop:_checkAutoSignAward()
...
function GrandCurtainCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function GrandCurtainCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function GrandCurtainCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function GrandCurtainCustomActivityPop:homeLayerAutoPopup()
...
return GrandCurtainCustomActivityPop
