...
local LeviaCustomActivityPop = class("LeviaCustomActivityPop", require("app.fairyGUI.signActivity.UI_LeviaCustomActivityPop"), function()
...
function LeviaCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.LEVIA_SIGN_ACTIVITY
...
function LeviaCustomActivityPop:onLoad()
...
function LeviaCustomActivityPop:_updateMainView()
...
function LeviaCustomActivityPop:_updateTimeText()
...
function LeviaCustomActivityPop:_checkAutoSignAward()
...
function LeviaCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function LeviaCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function LeviaCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function LeviaCustomActivityPop:homeLayerAutoPopup()
...
function LeviaCustomActivityPop:_playEffect()
