...
local ChristmasGiftCustomActivityPop = class("ChristmasGiftCustomActivityPop", require("app.fairyGUI.signActivity.UI_ChristmasGiftCustomActivityPop"), function()
	return fgui.GComponent:create({
		pkgName = "signActivity",
		pkgPath = "ui/signActivity/signActivity",
		resName = "ChristmasGiftCustomActivityPop"
	})
end)

function ChristmasGiftCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.CHRIS_GIFT_SIGN_ACTIVITY
...
function ChristmasGiftCustomActivityPop:onLoad()
...
function ChristmasGiftCustomActivityPop:_updateMainView()
...
function ChristmasGiftCustomActivityPop:_updateTimeText()
...
function ChristmasGiftCustomActivityPop:_checkAutoSignAward()
...
function ChristmasGiftCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function ChristmasGiftCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function ChristmasGiftCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function ChristmasGiftCustomActivityPop:homeLayerAutoPopup()
...
return ChristmasGiftCustomActivityPop
