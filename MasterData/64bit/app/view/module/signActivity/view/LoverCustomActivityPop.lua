...
local LoverCustomActivityPop = class("LoverCustomActivityPop", require("app.fairyGUI.signActivity.UI_LoverCustomActivityPop"), function()
	return fgui.GComponent:create({
		pkgName = "signActivity",
		pkgPath = "ui/signActivity/signActivity",
		resName = "LoverCustomActivityPop"
	})
end)

function LoverCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.LOVER_SIGN_ACTIVITY
...
function LoverCustomActivityPop:onLoad()
...
function LoverCustomActivityPop:_updateMainView()
...
function LoverCustomActivityPop:_updateTimeText()
...
function LoverCustomActivityPop:_checkAutoSignAward()
...
function LoverCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function LoverCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function LoverCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function LoverCustomActivityPop:homeLayerAutoPopup()
