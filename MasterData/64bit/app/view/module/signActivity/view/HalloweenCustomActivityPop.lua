...
local HalloweenCustomActivityPop = class("HalloweenCustomActivityPop", require("app.fairyGUI.signActivity.UI_HalloweenCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "HalloweenCustomActivityPop",
		pkgName = "signActivity",
		pkgPath = "ui/signActivity/signActivity"
	})
end)

function HalloweenCustomActivityPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.HALLOWEEN_SIGN_ACTIVITY
...
function HalloweenCustomActivityPop:onLoad()
...
function HalloweenCustomActivityPop:_updateMainView()
...
function HalloweenCustomActivityPop:_updateTimeText()
...
function HalloweenCustomActivityPop:_checkAutoSignAward()
...
function HalloweenCustomActivityPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function HalloweenCustomActivityPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function HalloweenCustomActivityPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function HalloweenCustomActivityPop:homeLayerAutoPopup()
...
function HalloweenCustomActivityPop:_playEffect()
...
return HalloweenCustomActivityPop
