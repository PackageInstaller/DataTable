...
local LeviaCustomActivityEUPop = class("LeviaCustomActivityEUPop", require("app.fairyGUI.signActivity.UI_LeviaCustomActivityPop"), function()
	return fgui.GComponent:create({
		resName = "LeviaCustomActivityPop",
		pkgPath = "ui/signActivity/signActivity",
		pkgName = "signActivity"
	})
end)

function LeviaCustomActivityEUPop:ctor(arg_2_1)
	if arg_2_1 and arg_2_1.endcall then
		self._closeCallBack = arg_2_1.endcall
	end

	self._groupId = 0
	self._functionId = var_0_2.LEVIA_SIGN_ACTIVITY_EU
...
function LeviaCustomActivityEUPop:onLoad()
...
function LeviaCustomActivityEUPop:_updateMainView()
...
function LeviaCustomActivityEUPop:_updateTimeText()
...
function LeviaCustomActivityEUPop:_checkAutoSignAward()
...
function LeviaCustomActivityEUPop:_onS2CGMActivityLoginGetAward(arg_7_1, arg_7_2, arg_7_3)
...
function LeviaCustomActivityEUPop:_onClickClose()
	self.m_backTransition:play(handler(self, self._onClose))
end

function LeviaCustomActivityEUPop:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
	self:homeLayerAutoPopup()
end

function LeviaCustomActivityEUPop:homeLayerAutoPopup()
...
function LeviaCustomActivityEUPop:_playEffect()
...
return LeviaCustomActivityEUPop
