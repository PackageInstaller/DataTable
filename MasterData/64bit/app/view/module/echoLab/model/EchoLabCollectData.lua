...
function EchoLabCollectData:sortOneCardList(arg_14_1)
	...
	local var_14_1 = g.core.model.User.echoLabData:getCollectData():getBuildInfoByCardType(var_14_0):getDailyActiveInfo(var_14_0)
	local var_14_2 = var_14_1.activeCount < var_14_1.activeMaxCount
