...
local NewYearWishItemIcon = class("NewYearWishItemIcon", require("app.fairyGUI.newYearWish.UI_NewYearWishItemIcon"))

function NewYearWishItemIcon:ctor()
	self._item = nil

	self:addClickListener(handler(self, self._onItemsClick))
end

function NewYearWishItemIcon:_onItemsClick()
	if self._item then
...
function NewYearWishItemIcon:updateCell(arg_3_1, arg_3_2)
	self._item = nil
