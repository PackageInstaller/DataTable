local AncientsBattleDetailTurnCell = class("AncientsBattleDetailTurnCell", require("app.fairyGUI.ancients.UI_AncientsBattleDetailTurnCell"))
...
function var_0_0:updateCell(arg_2_1)
	...
	self.m_show_BgController:setSelectedIndex(var_2_1 % 2 == 0 and 1 or 0)
