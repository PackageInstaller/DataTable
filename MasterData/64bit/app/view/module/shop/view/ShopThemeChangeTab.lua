...
local ShopThemeChangeTab = class("ShopThemeChangeTab", require("app.fairyGUI.shop.UI_ShopThemeChangeTab"))

function ShopThemeChangeTab:ctor()
	self._themeVal = 0
end

function ShopThemeChangeTab:setSelected(arg_2_1)
	self.m_isSelectController:setSelectedIndex(arg_2_1 and 1 or 0)
end

function ShopThemeChangeTab:updateTabCell(arg_3_1)
