local ShopExplorationPlayComp = class("ShopExplorationPlayComp", require("app.fairyGUI.shop.UI_ShopExplorationPlayComp"))
local var_0_1 = g.core.model.User.shopData

function ShopExplorationPlayComp:ctor()
	self._info = nil
...
function ShopExplorationPlayComp:_onItemListRender(arg_2_1, arg_2_2)
...
function ShopExplorationPlayComp:_onTabListRenderer(arg_3_1, arg_3_2)
...
function ShopExplorationPlayComp:_onChangeTab()
...
function ShopExplorationPlayComp:updateComp(arg_5_1)
	if arg_5_1 then
...
function ShopExplorationPlayComp:onLoad()
...
function ShopExplorationPlayComp:_updateItemListData(arg_7_1)
	if self._info then
		local var_7_0 = {}

		var_7_0 = arg_7_1 and var_0_1:getThemeInfo(self._info.shop_type, arg_7_1, true) or var_0_1:getThemeInfo(self._info.shop_type, self._info.shop_first, true)
...
function ShopExplorationPlayComp:_updateCurShowItemListData()
	if self._info then
...
function ShopExplorationPlayComp:_updateItemList()
...
function ShopExplorationPlayComp:_onShop(arg_10_1, arg_10_2, arg_10_3, arg_10_4)
...
function ShopExplorationPlayComp:_onRcvItemUse(arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	if self:isVisible() then
		g.core.module.ModuleManager:awardSummary(arg_11_4.awards)
	end
end

function ShopExplorationPlayComp:_onCrossDay()
	if self._info.shop_first == 1 and self:isVisible() then
		self:_updateItemListData()
	end
end

return ShopExplorationPlayComp
