...
local shopActivityReturnGiftPop = class("shopActivityReturnGiftPop", require("app.fairyGUI.shop.UI_shopActivityReturnGiftPop"), function()
	return fgui.GComponent:create({
		pkgName = "shop",
		resName = "shopActivityReturnGiftPop",
		pkgPath = "ui/shop/shop"
	}, ...)
end)

function shopActivityReturnGiftPop:ctor(arg_2_1)
	self:showAtCenter()
...
function shopActivityReturnGiftPop:_updateView()
	self._giftList = var_0_1:getGiftListByShopTypeValue(var_0_0.SHOP_TYPE.GIFT, var_0_0.SHOP_GIFT_VALUE.ACTIVITY_RETURN, handler(self, self._filterActivityGift)) or {}
...
function shopActivityReturnGiftPop:onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
end

function shopActivityReturnGiftPop:_filterActivityGift(arg_5_1)
	return self._actId == arg_5_1.activity_id
end

function shopActivityReturnGiftPop:_onRenderGiftList(arg_6_1, arg_6_2)
	if self._giftList and self._giftList[arg_6_1 + 1] then
		arg_6_2:updateCell(self._giftList[arg_6_1 + 1], true)
	end
end

function shopActivityReturnGiftPop:onLoad()
...
function shopActivityReturnGiftPop:_recvChargeInfo(arg_8_1, arg_8_2, arg_8_3, arg_8_4)
...
function shopActivityReturnGiftPop:_recvGetRecharge(arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	if self:_isActivityReturnOpen() then
		self:_updateView()
	else
		var_0_3:tip(g.core.lang:get(1005))
		var_0_3:switchModuleIntelligent(g.view.entrance.HOME)
...
function shopActivityReturnGiftPop:_onCrossDayUpdate()
	if not self:_isActivityReturnOpen() then
		var_0_3:tip(g.core.lang:get(1005))
		var_0_3:switchModuleIntelligent(g.view.entrance.HOME)
...
function shopActivityReturnGiftPop:_isActivityReturnOpen()
	return var_0_4:isActivityOpen(self._actId)
end

return shopActivityReturnGiftPop
