...
function TreeTalentComp:updateAttr()
	if self._nodeType == var_0_1.NODE_TYPE.SMALL then
		...
		elseif self._nodeStruct:isMaxLevel() then
			...
			local var_9_14 = self._nodeStruct:getLevel() + self.m_subAddComp:getCurNum()
			...
			local var_9_15, var_9_16 = next((self._nodeStruct:getLevelAttrDict()))
			local var_9_17, var_9_18 = g.core.lang:getAttr(var_9_15, var_9_16, true)
			local var_9_19, var_9_20 = next((self._nodeStruct:getLevelAttrDict(var_9_14)))
			local var_9_21, var_9_22 = g.core.lang:getAttr(var_9_19, var_9_20, true)
	...
	elseif self._nodeType == var_0_1.NODE_TYPE.BIG then
		local var_9_23 = self._nodeStruct:getNextStageInfo() or self._nodeStruct:getInfo()

		self.m_extraName:setText(self._nodeStruct:getBigTalentAttrStr(var_9_23, false))
		self.m_attrDesc:setText(self._nodeStruct:getBigTalentAttrStr(var_9_23, true))
	elseif self._nodeType == var_0_1.NODE_TYPE.CENTER then
		local var_9_24 = self._nodeStruct:getNextStageInfo()
		local var_9_25 = not var_9_24 and self._nodeStruct:getBonusInfo() or self._nodeStruct:getBonusInfo(var_9_24.node_stage)

		self.m_extraName:setText(var_9_25.basic_des)
		self.m_attrDesc:setText(var_9_25.extra_des)
	end
end
