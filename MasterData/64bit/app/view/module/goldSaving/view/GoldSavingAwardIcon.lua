...
local GoldSavingAwardIcon = class("GoldSavingAwardIcon", require("app.fairyGUI.goldSaving.UI_GoldSavingAwardIcon"), BaseIconComp)

function GoldSavingAwardIcon:ctor()
	GoldSavingAwardIcon._bindMethods(self)
...
function GoldSavingAwardIcon:_bindMethods()
	local var_2_0
	...
	for iter_2_0, iter_2_1 in ipairs((rawget(rawget(GoldSavingAwardIcon, "__index"), "__supers"))) do
		var_2_0 = GoldSavingAwardIcon._addClassMethodsToMethodList(self, iter_2_1, var_2_0)
	end

	for iter_2_2, iter_2_3 in pairs((GoldSavingAwardIcon._addClassMethodsToMethodList(self, GoldSavingAwardIcon, var_2_0))) do
...
function GoldSavingAwardIcon:_addClassMethodsToMethodList(arg_4_1, arg_4_2)
	local var_4_0 = {
		super = true,
		__supers = true,
		__cname = true,
...
function GoldSavingAwardIcon:_addTouchFunc()
	self:addClickListener(handler(self, self._onClickIcon))
end

function GoldSavingAwardIcon:_onClickIcon()
	if self._touchFunc then
		-- block empty
	end
end

function GoldSavingAwardIcon:_bindAllUIAndControllers()
...
function GoldSavingAwardIcon:_changeControllers()
	local var_8_0 = {}
...
function GoldSavingAwardIcon:setShowInfoEnable(arg_9_1)
	local var_9_0 = {}
...
function GoldSavingAwardIcon:initControllers(arg_10_1)
...
function GoldSavingAwardIcon:_getIconUrl(arg_11_1)
	local var_11_0
...
function GoldSavingAwardIcon:_updateDetailUI()
...
function GoldSavingAwardIcon:setIconName(arg_13_1)
...
function GoldSavingAwardIcon:setNameRow(arg_14_1)
...
function GoldSavingAwardIcon:setQuality(arg_15_1, arg_15_2)
	return
end

function GoldSavingAwardIcon:setAdvanceLevel(arg_16_1)
...
function GoldSavingAwardIcon:setStar(arg_17_1)
...
function GoldSavingAwardIcon:setLevelTxt(arg_18_1)
	return
end

function GoldSavingAwardIcon:setEmpty()
