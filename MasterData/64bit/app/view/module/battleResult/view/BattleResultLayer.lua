...
function BattleResultLayer:_reset()
	local var_17_0 = g.core.model.User.fogNightmareData:getTowerData()
	local var_17_1 = var_17_0:getCurrentFloorNum()
	local var_17_2 = g.core.model.User.fogNightmareData:getTowerData():getFloorStruct(var_17_1):getSelectedStage()[1]

	g.core.network.GameNetProxy:send_C2S_Fog_Back({
		type = 2,
		floor = var_17_1,
		stage = var_17_2.getStageId(var_17_0),
		wave = var_17_2:getSelectWave()
	})
end
