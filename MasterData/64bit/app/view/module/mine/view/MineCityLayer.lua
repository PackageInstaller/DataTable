...
function MineCityLayer:_updateView()
	...
	local var_8_5 = g.core.model.User.mineData:getOwnCity() == self._cityInfo.id
	...
	self.m_typeController:setSelectedIndex(var_8_5 and (self._isCapital and 1 or 0) or self._isCapital and 3 or 2)
end
