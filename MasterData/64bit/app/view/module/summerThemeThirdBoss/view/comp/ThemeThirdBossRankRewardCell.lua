local ThemeThirdBossRankRewardCell = class("ThemeThirdBossRankRewardCell", require("app.fairyGUI.summerThemeThirdBoss.UI_ThemeThirdBossRankRewardCell"))

function ThemeThirdBossRankRewardCell:ctor(arg_1_1)
	self._tmpRankAwardArr = nil

	self:_initRankReward()
end

function ThemeThirdBossRankRewardCell:refreshRankCell(arg_2_1, arg_2_2, arg_2_3)
...
function ThemeThirdBossRankRewardCell:_initRankReward()
	self.m_awardList:setVirtual()
	self.m_awardList:setItemRenderer(handler(self, self._onRenderAwardList))
end

function ThemeThirdBossRankRewardCell:_onRenderAwardList(arg_4_1, arg_4_2)
...
return ThemeThirdBossRankRewardCell
