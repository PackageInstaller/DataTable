...
local ActivityWishpoolLinkComp = class("ActivityWishpoolLinkComp", require("app.fairyGUI.activity.UI_ActivityWishpoolLinkComp"))

function ActivityWishpoolLinkComp:updateItemByInfo(arg_1_1)
...
return ActivityWishpoolLinkComp
