...
function PubgGirdAirDrop:updateUserLeftTime()
	...
	local var_4_0 = (self._airDrop:getUserDict()[self._myId] or 0) + self._airDrop:getAirCfg().time - g.core.common.ServerTime:getTime()
	...
	if var_4_0 > 0 then
		...
		self.m_leftProgress:setValue(var_4_0)
	else
