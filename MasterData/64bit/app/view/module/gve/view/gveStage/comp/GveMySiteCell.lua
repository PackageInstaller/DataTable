...
function GveMySiteCell:updateGveSiteCell(arg_8_1)
	...
	if arg_8_1.empty then
		...
		if arg_8_1.gridData then
			...
			local var_8_5 = math.floor(3600 / var_8_0.equip_mat_time * var_8_0.equip_mat_rate * 100) / 100
			local var_8_6 = var_0_0:getCurArmyAddProduct()

			if var_8_1 and var_8_1 ~= 0 or var_8_6 ~= 1 then
				local var_8_7 = 0

				if var_8_1 ~= 0 then
					var_8_7 = var_8_5 * var_8_0.addition_mat * 0.001
				end

				if var_8_6 ~= 0 then
					var_8_7 = var_8_7 + math.floor((var_8_7 + var_8_5) * var_8_6 * 100) / 100
				end

				var_8_5 = var_8_5 .. "[color=#24bd81](+" .. var_8_7 .. ")[/color]"
			end

			self.m_productNameTxt:setText((g.core.lang:get(309171, var_8_4)))
			self.m_productTxt:setText(g.core.lang:get(309108, {
				size = var_8_5
			}))
		end

		local var_8_8 = var_0_1:getGiveUpTime(self._data.cfg.x, self._data.cfg.y)
