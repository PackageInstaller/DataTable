...
function GveFormationBottomComp:_dragLineupPet(arg_7_1)
	...
	if var_7_2 then
		...
		local var_7_3 = fgui.DragDropManager:getInstance():getAgent():getComponent()

		if var_7_3 then
			var_7_3:bindLua("app.view.module.gve.view.gveFormation.comp.GveFormationPetIcon")
			var_7_3:updatePetFormatIcon(self._formationData:getPetByPos(var_7_1))
		end
...
function GveFormationBottomComp:_dragLineupSuccuba(arg_9_1)
	...
	if var_9_2 then
		...
		local var_9_3 = fgui.DragDropManager:getInstance():getAgent():getComponent()

		if var_9_3 then
			var_9_3:bindLua("app.view.module.gve.view.gveFormation.comp.GveFormationSuccubaIconComp")
			var_9_3:updateSuccubaIcon(self._formationData:getSuccubaPos(var_9_1))
		end
