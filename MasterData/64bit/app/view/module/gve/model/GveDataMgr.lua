...
function GveDataMgr:getCurArmyAddProduct()
	local var_68_0 = 0
	local var_68_1 = self:getGveBagData():getAllTargetJobSkillCfg(var_0_4.GVE_HALIDOM_BRANCH.ARMY_BRANCH)[1]
	...
	local var_68_2 = self:getAllUpLvUserNum(var_0_4.GVE_HALIDOM_BRANCH.ARMY_BRANCH, var_68_1.needLv)
...
function GveDataMgr:getKnightActionNeedTime(arg_88_1)
	local var_88_0 = self:getGveFormationData()
	local var_88_1 = self:getGveFormationData()
	local var_88_2 = self:getGveBaseCfg()
	local var_88_4 = var_88_1 - var_88_0:getKnightActionByPos(arg_88_1)

	return (var_88_4 > 0 or nil) and (math.ceil(var_88_4 / var_88_2.action_rate) - 1) * var_88_2.action_time + math.max(0, var_88_2.action_time - (var_0_1:getTime() - var_88_1:getActionReplyTime()))
end
