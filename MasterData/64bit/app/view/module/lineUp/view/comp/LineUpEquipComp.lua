...
function LineUpEquipComp:_playTreasureEffect(arg_6_1, arg_6_2)
	...
	local var_6_4 = var_6_3 == var_0_4.UR and "eff_ui_treasure128_down" or "eff_ui_treasure128_downMR"

	if not self._qualityEffectIcon[arg_6_1][var_6_3 == var_0_4.UR and "eff_ui_treasure128_down" or "eff_ui_treasure128_downMR"] then
		self._qualityEffectIcon[arg_6_1][var_6_4] = var_6_0:addEffectSpine({
			anim = "play",
			isLoop = true,
			scale = 0.8,
			name = var_6_4
	...
	self._qualityEffectIcon[arg_6_1][var_6_4]:setVisible(true)
