...
function FogNightmareExploreLoadPop:_onLoadBtnClicked()
	local var_6_0 = g.core.model.User.fogNightmareData:getTowerData()
	local var_6_1 = g.core.model.User.fogNightmareData:getTowerData():getCurFloorStruct():getSelectedStage()
	local var_6_2

	if not var_6_0 or #var_6_1 < 1 then
		do return end

		var_6_2 = {
			type = 1,
			floor = var_6_0:getCurrentFloorNum()
		}
	end

	var_6_2.stage = var_6_1[1]:getStageId()

	g.core.network.GameNetProxy:send_C2S_Fog_Back(var_6_2)
