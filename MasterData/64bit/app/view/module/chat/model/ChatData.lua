...
function ChatData:checkShareInfo(arg_94_1)
	if arg_94_1.share then
		...
		elseif arg_94_1.share.share_type == 15 then
			...
			local var_94_12 = g.core.config.chat_invite_info.get(arg_94_1.invite_id)

			arg_94_1.content = string.gsub(var_94_12.content_1, "#name#", arg_94_1.user.name)
			arg_94_1.title = var_94_12.content_2
		elseif arg_94_1.share.share_type == var_0_4.SHARE_TYPE.TYPE_ID_20 then
			...
			local var_94_14 = arg_94_1.param1 and tonumber(arg_94_1.param1) or 0

			arg_94_1.content = string.gsub(var_94_13.content_1, "#battle_name#", var_94_14 > 0 and g.core.config.group_battle_map_info.get(var_94_14).name or g.core.model.User.teamPvpData:getMapInfo().name)
			arg_94_1.title = var_94_13.content_2
		elseif arg_94_1.share.share_type == var_0_4.SHARE_TYPE.TYPE_ID_21 then
			local var_94_16 = g.core.config.chat_invite_info.get(arg_94_1.invite_id)

			arg_94_1.content = string.gsub(string.gsub(var_94_16.content_1, "#name#", arg_94_1.user.name), "#num#", arg_94_1.param1)
			arg_94_1.title = var_94_16.content_2
		elseif arg_94_1.share.share_type == var_0_4.SHARE_TYPE.TYPE_ID_22 then
			local var_94_18 = string.split(arg_94_1.param2 or "", ";")
			local var_94_19 = g.core.config.chat_invite_info.get(arg_94_1.invite_id)

			arg_94_1.content = string.gsub(string.gsub(var_94_19.content_1, "#name#", var_94_18[3]), "#num#", var_94_18[2])
			arg_94_1.title = var_94_19.content_2
		elseif arg_94_1.share.share_type == var_0_4.SHARE_TYPE.TYPE_ID_23 then
			...
			arg_94_1.content = string.gsub(var_94_20.content_1, "#name#", arg_94_1.user.alliance_name or "")
		elseif arg_94_1.share.share_type == var_0_4.SHARE_TYPE.TYPE_ID_24 then
			...
			local var_94_22 = string.split(arg_94_1.param2, ";")

			if arg_94_1.invite_id == 48 or arg_94_1.invite_id == 49 then
				local var_94_23 = g.core.config.new_slg_boss_info.get(tonumber(var_94_22[1]))

				arg_94_1.title = var_94_21.content_2
				arg_94_1.content = string.gsub(string.gsub(var_94_21.content_1, "#name#", var_94_23.name), "#level#", var_94_23.level)
			elseif arg_94_1.invite_id >= 50 and arg_94_1.invite_id <= 55 then
				arg_94_1.title = var_94_21.content_2
				arg_94_1.content = g.core.lang:getByString(var_94_21.content_1, {
					X = tonumber(var_94_22[1]),
					Y = tonumber(var_94_22[2]),
					level = var_94_22[3],
					name = var_94_22[4]
				})
			end
		elseif arg_94_1.share.share_type == var_0_4.SHARE_TYPE.TYPE_ID_25 then
			local var_94_25 = string.split(arg_94_1.param2 or "", ";")
			local var_94_26 = g.core.config.chat_invite_info.get(arg_94_1.invite_id)

			arg_94_1.title = var_94_26.content_2

			local var_94_27 = g.core.config.item_info.fetch((tonumber(var_94_25[2])))

			arg_94_1.content = string.gsub(var_94_26.content_1, "#name#", (var_94_27 or nil) and (var_94_27.name or ""))
		elseif arg_94_1.share.share_type == var_0_4.SHARE_TYPE.TYPE_ID_26 then
			local var_94_28 = g.core.config.chat_invite_info.get(arg_94_1.invite_id)

			arg_94_1.title = var_94_28.content_2
			arg_94_1.content = string.gsub(var_94_28.content_1, "#name#", arg_94_1.teamId or "")
		end
	end
end
