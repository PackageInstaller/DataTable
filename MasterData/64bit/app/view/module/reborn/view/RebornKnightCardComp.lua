local RebornKnightCardComp = class("RebornKnightCardComp", require("app.fairyGUI.reborn.UI_BaseKnightCardComp"))
...
function RebornKnightCardComp:ctor(arg_1_1)
...
function RebornKnightCardComp:updateCell(arg_2_1, arg_2_2, arg_2_3)
	if not arg_2_1 then
		return
	end
...
function RebornKnightCardComp:_onClick()
...
function RebornKnightCardComp:setReborn()
	self.m_redPointComp:setVisible(false)
end

return RebornKnightCardComp
