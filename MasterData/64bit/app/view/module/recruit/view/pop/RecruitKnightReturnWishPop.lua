...
local RecruitKnightReturnWishPop = class("RecruitKnightReturnWishPop", require("app.fairyGUI.recruitKnight.UI_RecruitKnightReturnWishPop"), function()
	return fgui.GComponent:create({
		pkgName = "recruitKnight",
		resName = "RecruitKnightReturnWishPop",
...
function RecruitKnightReturnWishPop:_updateOtherUI()
	...
	if var_3_0:getRecruitType() == g.core.const.ConstMgr.RecruitConst.RECRUIT_TYPE.RECRUIT_RETURN_KNIGHT then
		self.m_percentComp:setTitle(g.core.lang:get(108720))
	...
	self.m_tipText:setText(g.core.lang:get(108722))
