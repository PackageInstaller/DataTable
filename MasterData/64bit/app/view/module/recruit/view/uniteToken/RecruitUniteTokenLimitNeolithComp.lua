...
local RecruitUniteTokenLimitPoisonComp = class("RecruitUniteTokenLimitPoisonComp", require("app.fairyGUI.recruitUniteToken.UI_RecruitUniteTokenLimitNeolithComp"), RecruitLimitCompBase)
