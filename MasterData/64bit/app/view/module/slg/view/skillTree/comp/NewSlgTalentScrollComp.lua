...
function NewSlgTalentScrollComp:onClickIcon(arg_9_1, arg_9_2)
	...
	if var_9_2 then
		...
		if arg_9_2 then
			...
			local var_9_7 = display.width - var_9_4 - var_9_3:getNextLineWidth()
...
function NewSlgTalentScrollComp:checkCompIsClick(arg_13_1, arg_13_2)
	for iter_13_0, iter_13_1 in pairs(self._curShowIconDict) do
		local var_13_0 = iter_13_1.iconComp:displayObject():convertToWorldSpace(cc.p(0, 0)).x

		if var_13_0 >= -iter_13_1.iconComp:getWidth() and var_13_0 <= arg_13_2 and iter_13_1.iconComp:containPoint(arg_13_1) then
