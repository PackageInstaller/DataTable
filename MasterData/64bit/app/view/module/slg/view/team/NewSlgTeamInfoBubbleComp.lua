...
function NewSlgTeamInfoBubbleComp:_onUpdate()
	...
	local var_13_0 = self._endTime - g.core.common.ServerTime:getTime()

	if var_13_0 >= 0 then
		self._txtMovePro:setText((g.core.common.ServerTime:getActivityLeftTime(var_13_0)))
		self._compMovePro:setValue(var_13_0)
