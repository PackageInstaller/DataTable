local TowerRewardCell = class("TowerRewardCell", require("app.fairyGUI.tower.UI_TowerRewardCell"))

function TowerRewardCell:ctor()
...
function TowerRewardCell:_onRenderAwardList(arg_2_1, arg_2_2)
...
function TowerRewardCell:update(arg_3_1)
	local var_3_0

	if arg_3_1 then
		var_3_0 = arg_3_1.data or {}
