...
local TowerFirstPassCell = class("TowerFirstPassCell", require("app.fairyGUI.tower.UI_TowerFirstPassCell"))

function TowerFirstPassCell:ctor()
	self._rewardList = {}
	self._id = 0
...
function TowerFirstPassCell:_onGetReward()
...
function TowerFirstPassCell:_onRenderList(arg_3_1, arg_3_2)
	self._rewardList[arg_3_1 + 1].scaleIndex = 3

	arg_3_2:updateIcon(self._rewardList[arg_3_1 + 1])
end

function TowerFirstPassCell:update(arg_4_1)
	local var_4_0
