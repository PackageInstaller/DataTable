...
local var_0_7 = 258
local var_0_8 = 5
local TowerRankRewardPop = class("TowerRankRewardPop", require("app.fairyGUI.tower.UI_TowerRankRewardPop"), function()
	return fgui.GComponent:create({
		pkgName = "tower",
		isFullScreen = true,
		pkgPath = "ui/tower/tower",
		resName = "TowerRankRewardPop"
	}, ...)
end)
local var_0_10 = {
	FIRST_PASS = 2,
...
local var_0_11 = {
	{
		stageType = g.core.const.ConstMgr.TowerConst.STAGE_TYPE.MAIN,
		rankProtoEnum = g.core.network.proto.TOWER_MAIN
	},
	{
		stageType = g.core.const.ConstMgr.TowerConst.STAGE_TYPE.JIAO_GUO,
		rankProtoEnum = g.core.network.proto.TOWER_EMPIRE
	},
	{
		stageType = g.core.const.ConstMgr.TowerConst.STAGE_TYPE.LIN_DONG,
		rankProtoEnum = g.core.network.proto.TOWER_BIFROST
	},
	{
		stageType = g.core.const.ConstMgr.TowerConst.STAGE_TYPE.DONG_XI,
		rankProtoEnum = g.core.network.proto.TOWER_EASTRISE
	},
	{
		stageType = g.core.const.ConstMgr.TowerConst.STAGE_TYPE.LI_JIN,
		rankProtoEnum = g.core.network.proto.TOWER_NEBU
	}
}

function TowerRankRewardPop:ctor(arg_2_1)
	self._listData = {}
	self._curList = nil
	self._curTabIndex = var_0_10.RANK
	self._curStageType = arg_2_1 or var_0_3.TowerConst.STAGE_TYPE.MAIN
	self._redPoints = {}
	self._firstPassData = {}
	...
	self._towerStartId = {
		[var_0_5.STAGE_TYPE.MAIN] = var_0_1.get(6).parameter,
		[var_0_5.STAGE_TYPE.JIAO_GUO] = var_0_1.get(7).parameter,
		[var_0_5.STAGE_TYPE.LIN_DONG] = var_0_1.get(8).parameter,
		[var_0_5.STAGE_TYPE.DONG_XI] = var_0_1.get(9).parameter,
		[var_0_5.STAGE_TYPE.LI_JIN] = var_0_1.get(10).parameter
	}
	self._canGetIdList = {}
...
function TowerRankRewardPop:onLoad()
	...
	self.m_tabList:setSelectedIndex(self._curStageType - 1)
...
function TowerRankRewardPop:_onGetInfo()
	self._listData = {}
	self._firstPassData = {}
...
function TowerRankRewardPop:_initView()
...
function TowerRankRewardPop:_onClickTabList()
...
function TowerRankRewardPop:_onShowListChanged()
...
function TowerRankRewardPop:updateView()
...
function TowerRankRewardPop:updateOneKeyBtn(arg_9_1)
...
function TowerRankRewardPop:updateRed()
	for iter_10_0, iter_10_1 in pairs(self._redPoints) do
		g.core.event.EventManager:dispatchEvent(g.core.event.enum.EVENT_REFRESH_RED_POINT, false, {
			redPointComp = self._redPoints[iter_10_0],
			customData = {
				stageType = var_0_11[iter_10_0].stageType
			}
		})
	end
end

function TowerRankRewardPop:_getList(arg_11_1, arg_11_2)
...
function TowerRankRewardPop:_onRendererRankList(arg_12_1, arg_12_2)
...
function TowerRankRewardPop:_onRendererRewardList(arg_13_1, arg_13_2)
...
function TowerRankRewardPop:_onRendererFirstPassList(arg_14_1, arg_14_2)
...
function TowerRankRewardPop:_onsS2CFirstPassAward(arg_15_1, arg_15_2, arg_15_3)
	if arg_15_3 then
...
function TowerRankRewardPop:_onsS2COneKeyFirstPassAward(arg_16_1, arg_16_2, arg_16_3)
	if arg_16_3 then
		...
		var_0_6:pushPopup(require("app.view.module.tower.view.TowerOneKeyGetFirstRewardPop").new(var_16_1, handler(self, self.updateView)), {
			ignoreTouch = false,
...
function TowerRankRewardPop:_onS2CGetFirstPassInfo(arg_17_1, arg_17_2, arg_17_3)
	if arg_17_3 then
		local var_17_0 = {}
...
function TowerRankRewardPop:getFirstPassData(arg_18_1)
...
function TowerRankRewardPop:_getPassRankWeight(arg_20_1)
	local var_20_0 = 100
...
function TowerRankRewardPop:getShowFirstPassIds(arg_21_1)
	local var_21_0 = {}
	local var_21_1 = {}
...
function TowerRankRewardPop:_onClickOneKeyGetBtn()
...
function TowerRankRewardPop:onUnload()
	self._listData = {}
	self._firstPassData = {}
	self._isUnload = true
