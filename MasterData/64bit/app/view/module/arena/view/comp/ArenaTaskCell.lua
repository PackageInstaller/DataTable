...
local ArenaTaskCell = class("ArenaTaskCell", require("app.fairyGUI.arena.UI_ArenaTaskCell"))

function ArenaTaskCell:ctor()
	self._taskData = nil
	self._awardList = {}
...
function ArenaTaskCell:updateCell(arg_5_1)
	if not arg_5_1 then
		return
	end
...
function ArenaTaskCell:_onGetAwardClick()
