...
function ArenaRecordLayer:ctor(arg_2_1)
	...
	self._isInit = false
	self._curTab = var_0_0.RECORD_TYPE.WHOLE
	self._recordList = {}
...
function ArenaRecordLayer:onLoad()
	g.core.event.EventManager:addEventListener(g.core.event.enum.EVENT_NET_S2C_ARENA_CHALLENGERECORD, self._onArenaRecord, self)
...
function ArenaRecordLayer:_onArenaRecord(arg_9_1, arg_9_2, arg_9_3)
