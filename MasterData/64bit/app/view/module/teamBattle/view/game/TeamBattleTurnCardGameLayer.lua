...
local TeamBattleTurnCardGameLayer = class("TeamBattleTurnCardGameLayer", require("app.fairyGUI.teamBattle.UI_TeamBattleTurnCardGameLayer"), function()
	return fgui.GComponent:create({
		pkgPath = "ui/teamBattle/teamBattle",
		resName = "TeamBattleTurnCardGameLayer",
		pkgName = "teamBattle",
		isFullScreen = true
	}, ...)
end)

function TeamBattleTurnCardGameLayer:ctor(arg_2_1)
...
function TeamBattleTurnCardGameLayer:_initData()
...
function TeamBattleTurnCardGameLayer:_initView()
...
function TeamBattleTurnCardGameLayer:onLoad()
...
function TeamBattleTurnCardGameLayer:onGameStageFinish()
	g.core.module.ModuleManager:tip(g.core.lang:get(420691))
	g.core.module.ModuleManager:switchModuleIntelligent(g.view.entrance.HOME)
end

function TeamBattleTurnCardGameLayer:onTeamBattlePlayGame(arg_7_1, arg_7_2, arg_7_3, arg_7_4)
...
function TeamBattleTurnCardGameLayer:receiveCompEvent(arg_8_1, arg_8_2)
...
function TeamBattleTurnCardGameLayer:_onFinishAnim()
...
function TeamBattleTurnCardGameLayer:_onClose()
	g.core.module.ModuleManager:onlyPopSelfByDisplay(self)
end

function TeamBattleTurnCardGameLayer:_getNextIconIndexByType(arg_13_1)
...
return TeamBattleTurnCardGameLayer
