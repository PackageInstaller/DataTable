...
function TeamBattleFormationComp:_onPetCompDragStart(arg_7_1)
	...
	if var_7_0:isEmpty() then
		...
		var_7_4:bindLua("app.view.module.teamBattle.view.formation.comp.TeamBattleFormationPetComp")
...
function TeamBattleFormationComp:_onUniteTokenCompDragStart(arg_11_1)
	...
	if var_11_0:isEmpty() then
		...
		local var_11_2 = fgui.DragDropManager:getInstance()

		var_11_2:startDrag(var_11_0:getResourceURL(), var_11_1, (arg_11_1:getInput():getTouchId()))

		local var_11_3 = var_11_2:getAgent()
		local var_11_4 = var_11_3:getComponent()

		var_11_4:bindLua("app.view.module.teamBattle.view.formation.comp.TeamBattleFormationUniteTokenComp")
		var_11_4:becomeTo(var_11_0)
		var_11_3:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onUniteTokenCompDragEnd), var_0_2)
	end
end
...
function TeamBattleFormationComp:_onSuccubaCompDragStart(arg_13_1)
	...
	if var_13_0:isEmpty() then
		...
		var_13_2:startDrag(var_13_0:getResourceURL(), var_13_1, (arg_13_1:getInput():getTouchId()))

		local var_13_3 = var_13_2:getAgent()
		local var_13_4 = var_13_3:getComponent()

		var_13_4:bindLua("app.view.module.teamBattle.view.formation.comp.TeamBattleFormationSuccubaComp")
		var_13_4:becomeTo(var_13_0)
		var_13_3:addEventListener(fgui.UIEventType.DragEnd, handler(self, self._onSuccubaCompDragEnd), var_0_2)
	end
end
