...
local TeamBattleLineupArtifactCell = class("TeamBattleLineupArtifactCell", require("app.fairyGUI.teamBattle.UI_TeamBattleLineupArtifactCell"))

function TeamBattleLineupArtifactCell:ctor()
...
function TeamBattleLineupArtifactCell:updateCell(arg_2_1, arg_2_2)
...
function TeamBattleLineupArtifactCell:_playLinkEnterAnim()
	self.m_idleEffectDown:removeAllEffect()
	self.m_idleEffectUp:removeAllEffect()
...
return TeamBattleLineupArtifactCell
