...
function BlazingArenaBattlePrepareLayer:_onDragLineupKnight(arg_20_1)
	...
	if var_20_0 > 0 then
		local var_20_1 = arg_20_1:getInput()
		local var_20_2 = fgui.DragDropManager:getInstance()

		var_20_2.startDrag(var_20_1, "common/ui_cocos/lineUp/pic_touming.png", nil, (var_20_1:getTouchId()))

		local var_20_3 = BattleKnight.new({
			breath = true,
			base = true,
			scale = 1.2,
		...
		var_20_3:setScale(1.2)
		var_20_3:setName(var_0_13)
		var_20_2:getAgent():displayObject():addChild(var_20_3)
		var_20_3:setPosition(50, 0)
	end
end
