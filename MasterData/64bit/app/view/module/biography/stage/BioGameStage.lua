...
function BioGameStage:refreshTargetVector()
	...
	if var_76_1 then
		...
		local var_76_7, var_76_8 = self:getMapWorld():getTargetAngelFromScreenCenter((cc.pNormalize((cc.pSub(cc.p(var_76_5 - 100, var_76_6 + 100), (self:getMapGround():convertToNodeSpace(display.center)))))))
