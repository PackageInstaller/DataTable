local RedCliffStageMatchUpgradeFailCell = class("RedCliffStageMatchUpgradeFailCell", require("app.fairyGUI.redCliff.UI_RedCliffStageMatchUpgradeFailCell"))

function RedCliffStageMatchUpgradeFailCell:ctor()
	self._finalUser = nil
end

function RedCliffStageMatchUpgradeFailCell:updateFailCell(arg_2_1, arg_2_2, arg_2_3)
...
return RedCliffStageMatchUpgradeFailCell
