...
function RedCliffMapWorld:_initMoveRange()
	local var_15_0 = self:getMapGround()
	local var_15_1 = var_15_0:getMapHeight()
	local var_15_2 = self:getMapGround():getHalfTileH()

	self._minMoveX = -var_15_0
	self._maxMoveX = self:getMapGround():getMapWidth() / 2 - display.width + 150
	self._minMoveY = var_15_1 / 2 - var_15_2 - self._maxMoveX / 2
	self._maxMoveY = var_15_1 / 2 - var_15_2 + self._maxMoveX / 2
end
