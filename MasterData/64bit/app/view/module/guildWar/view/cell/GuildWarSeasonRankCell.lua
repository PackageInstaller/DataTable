local GuildWarSeasonRankCell = class("GuildWarSeasonRankCell", require("app.fairyGUI.guildWar.UI_GuildWarSeasonRankCell"))

function GuildWarSeasonRankCell:ctor()
...
function GuildWarSeasonRankCell:_onRenderAwardList(arg_2_1, arg_2_2)
...
function GuildWarSeasonRankCell:update(arg_3_1)
	local var_3_0
	...
	local var_3_2 = g.core.model.User.snapShotCacheData:getSnapShot(g.core.const.ConstMgr.SnapShotCacheConst.SNAP_SHOT_KEY.GUILD, var_3_0.id or var_3_0.guildId)
	...
	if arg_3_1.rewardData then
		self._rewardList = arg_3_1.rewardData.data
