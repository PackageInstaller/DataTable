...
local WeeklyCompetitionGiftCell = class("WeeklyCompetitionGiftCell", require("app.fairyGUI.weeklyCompetition.UI_WeeklyCompetitionGiftCell"))

function WeeklyCompetitionGiftCell:ctor()
	self._info = nil
	self._curInfo = nil
	self._isEnough = true
	self._canBuy = false
...
function WeeklyCompetitionGiftCell:_onBtnClick()
	if self._canBuy then
...
function WeeklyCompetitionGiftCell:updateCell(arg_6_1)
	if not arg_6_1 then
...
function WeeklyCompetitionGiftCell:_startDailyTimer()
	self._dailyTimer = self._dailyTimer or self:newSchedule(handler(self, self._onDailyTimeUpdate, 1))
end

function WeeklyCompetitionGiftCell:_stopDailyTimer()
...
function WeeklyCompetitionGiftCell:_onDailyTimeUpdate()
...
return WeeklyCompetitionGiftCell
