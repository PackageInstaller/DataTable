...
local ElderUseBuyPop = class("ElderUseBuyPop", require("app.fairyGUI.elderBoss.UI_ElderUseBuyPop"), function()
	return fgui.GComponent:create({
		pkgPath = "ui/elderBoss/elderBoss",
		resName = "ElderUseBuyPop",
		pkgName = "elderBoss"
	})
end)

function ElderUseBuyPop:ctor(arg_2_1)
	self._hasPop = false
...
function ElderUseBuyPop:onLoad()
...
function ElderUseBuyPop:_updateMaxBuyNum()
	self._maxBuyNum = self:_getBuyMaxNum(self._shopScoreInf)
...
function ElderUseBuyPop:_onClickBtn()
...
function ElderUseBuyPop:_onClickUseBtn()
...
function ElderUseBuyPop:_onClickBuyUseBtn()
...
function ElderUseBuyPop:_onTabChanged()
...
function ElderUseBuyPop:_onRcvShopping(arg_9_1, arg_9_2, arg_9_3)
...
function ElderUseBuyPop:_onRcvItemUse(arg_10_1, arg_10_2, arg_10_3)
...
function ElderUseBuyPop:_initView()
...
function ElderUseBuyPop:_addUIEventListeners()
...
function ElderUseBuyPop:_getConvertNameRate(arg_13_1)
	local var_13_0 = ""
	local var_13_1 = 0
...
function ElderUseBuyPop:_initAddNumComp()
	local var_14_0 = {
		max = 1,
		min = 1,
		cur = 1,
...
function ElderUseBuyPop:getMaxUseCount()
	if self._useBuyGoodsInf.type == var_0_9.TYPE_ITEM and self._useBuyGoodsInf.value == var_0_9.ITEM.TYPE_STAMINA_PILL then
...
function ElderUseBuyPop:_isPurchaseLimitTxtShow()
...
function ElderUseBuyPop:_onNumChanged(arg_17_1)
...
function ElderUseBuyPop:_updateTimesItemNum(arg_18_1)
	self.m_addTimesTxt:setText(g.core.lang:get(106002, {
		num = self._convertRate * arg_18_1
	}))
end

function ElderUseBuyPop:_isBuyLimit()
	return checkbool(self._limitLeft)
end

function ElderUseBuyPop:_getBuyMaxNum(arg_20_1)
...
function ElderUseBuyPop:_updateCurrencyComps(arg_21_1)
...
function ElderUseBuyPop:_getReachMaxAddTip(arg_22_1)
	if self._type == var_0_1.USE then
