...
function DailyReportPart:_onTouchMove(arg_14_1)
	...
	if self._startPosX and self._panelNum > 0 then
		local var_14_0 = arg_14_1:getInput():getTouch():getLocationInView().x

		if math.abs(var_14_0 - self._startPosX) > 20 then
			local var_14_1 = self.m_selectIndexController:getSelectedIndex() + (var_14_0 > self._startPosX and -1 or 1)
