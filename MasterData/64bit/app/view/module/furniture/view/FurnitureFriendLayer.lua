...
function FurnitureFriendLayer:_onTouchMove(arg_19_1)
	if not self._dragStart then
		...
		local var_19_1 = var_19_0:getTouch():getDelta()

		self.m_roomComp:setPosition(KsMath.rangeIn(var_19_0.x + var_19_1.x, 0, self._offXRange), (KsMath.rangeIn(self.m_roomComp:getPosition().y - var_19_1.y, 0, self._offYRange)))
