local KnightSkillDescTip = class("KnightSkillDescTip", require("app.fairyGUI.tip.UI_KnightSkillDescTip"), function()
	return fgui.GComponent:create({
		pkgName = "tip",
		pkgPath = "ui/tip/tip",
		resName = "KnightSkillDescTip"
	})
end)

function KnightSkillDescTip:ctor(arg_2_1)
	self._data = arg_2_1

	self:getView():center(true)
end

function KnightSkillDescTip:onLoad()
	self:updateView(self._data)
end

function KnightSkillDescTip:updateView(arg_4_1)
	...
	elseif var_4_1.skill_type == 17 then
