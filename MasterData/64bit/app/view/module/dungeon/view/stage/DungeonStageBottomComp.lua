...
function DungeonStageBottomComp:_onItemRenderer(arg_6_1, arg_6_2)
	...
	local var_6_0 = var_0_2:getLastUnlockChapter()
	local var_6_1 = var_0_2:getLastUnlockStageId()

	if self._chapterId == var_6_0 then
		if var_6_1 > 0 and var_6_1 == self._stageList[arg_6_1 + 1] then
