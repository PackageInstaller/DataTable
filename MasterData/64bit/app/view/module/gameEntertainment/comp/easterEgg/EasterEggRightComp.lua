...
local EasterEggRightComp = class("EasterEggRightComp", require("app.fairyGUI.gameEntertainment.UI_EasterEggRightComp"))

function EasterEggRightComp:ctor()
...
function EasterEggRightComp:updateContent(arg_2_1)
	self._data = arg_2_1
...
function EasterEggRightComp:_updateShow()
...
function EasterEggRightComp:_updateLeftCompAndBtn()
...
function EasterEggRightComp:_onGameListItemRenderer(arg_5_1, arg_5_2)
	arg_5_2:updateItem(self._easterEggList[arg_5_1 + 1])
end

function EasterEggRightComp:_onGameListClickItem(arg_6_1, arg_6_2)
...
function EasterEggRightComp:_onBeginBtnClick()
	local var_7_0
