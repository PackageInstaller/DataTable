...
local ExplorationFormationPetComp = class("ExplorationFormationPetComp", require("app.fairyGUI.exploration.UI_ExplorationFormationPetComp"))

function ExplorationFormationPetComp:ctor()
	self._stationPos = 0
...
function ExplorationFormationPetComp:setFormationType(arg_2_1)
	self._formationType = arg_2_1
end

function ExplorationFormationPetComp:updateComp(arg_3_1, arg_3_2, arg_3_3)
...
function ExplorationFormationPetComp:becomeTo(arg_4_1)
	self:updateComp(arg_4_1:getStationPos(), arg_4_1:getSid(), self._mulIndex)
end

function ExplorationFormationPetComp:isEmpty()
	return self._sid == 0
end

function ExplorationFormationPetComp:getStationPos()
	return self._stationPos
end

function ExplorationFormationPetComp:getSid()
	return self._sid
end

function ExplorationFormationPetComp:onDragStart()
	self._dragging = true
...
function ExplorationFormationPetComp:onDragEnd()
...
return ExplorationFormationPetComp
