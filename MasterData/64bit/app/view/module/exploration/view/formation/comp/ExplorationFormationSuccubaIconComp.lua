...
local ExplorationFormationSuccubaIconComp = class("ExplorationFormationSuccubaIconComp", require("app.fairyGUI.exploration.UI_ExplorationFormationSuccubaIconComp"))

function ExplorationFormationSuccubaIconComp:ctor()
	self._pos = 0
...
function ExplorationFormationSuccubaIconComp:updateComp(arg_2_1, arg_2_2, arg_2_3)
	local var_2_0
...
function ExplorationFormationSuccubaIconComp:setStationPos(arg_3_1)
	self._pos = arg_3_1
end

function ExplorationFormationSuccubaIconComp:getStationPos()
	return self._pos
end

function ExplorationFormationSuccubaIconComp:setIsLock(arg_5_1, arg_5_2, arg_5_3)
	self._unLock = not arg_5_1
	self._unLockTip = arg_5_3
end

function ExplorationFormationSuccubaIconComp:onDragStart()
	self._isDrag = true

	self.m_succubaIcon:setAlpha(0.5)
end

function ExplorationFormationSuccubaIconComp:onDragEnd()
...
function ExplorationFormationSuccubaIconComp:_onClick()
...
function ExplorationFormationSuccubaIconComp:setClickAddCall(arg_10_1)
	self._clickAddCall = arg_10_1
end

function ExplorationFormationSuccubaIconComp:setIsOtherStyle(arg_11_1)
...
function ExplorationFormationSuccubaIconComp:isOther()
	return self._isOther
end

function ExplorationFormationSuccubaIconComp:checkRedPoint()
	g.core.event.EventManager:dispatchEvent(g.core.event.enum.EVENT_REFRESH_RED_POINT, false, {
		redPointComp = self.m_redPointComp,
		customData = {
			pos = self._pos
...
function ExplorationFormationSuccubaIconComp:getSuccubaSid()
	return self._succubaStruct and self._succubaStruct:getSid() or 0
end

function ExplorationFormationSuccubaIconComp:isEmpty()
	return self.m_isEmptyController:getSelectedIndex() == 1
end

function ExplorationFormationSuccubaIconComp:becomeTo(arg_16_1)
	self:updateComp(arg_16_1:getStationPos(), arg_16_1:getSuccubaSid(), self._mulIndex)
end

return ExplorationFormationSuccubaIconComp
