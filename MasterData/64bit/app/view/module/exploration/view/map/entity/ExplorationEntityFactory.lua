...
local ExplorationEntityFactory = class("ExplorationEntityFactory", (require("app.core.ksmap.entity.EntityFactory")))

function ExplorationEntityFactory:createEntity()
	return self.type == MapConst.RESTYPE.KNIGHT and StormMainRole.new(self) or StormMapItem.new(self, "bio")
end

function ExplorationEntityFactory:createVisual(arg_2_1, arg_2_2, arg_2_3)
