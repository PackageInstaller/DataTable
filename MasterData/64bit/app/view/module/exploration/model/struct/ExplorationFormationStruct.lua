	...
	if self:isSidValid(arg_4_2) then
		if self:isKnightLineUp(arg_4_2) then
			...
			if self:isStationPosLineupArtifact(arg_4_1) then
				...
				if not g.core.model.User.explorationData:getFormationData():getArtifactByServerId(var_4_2):checkWearKnight(g.core.model.User.explorationData:getFormationData():getKnightByServerId(arg_4_2):getAdvanceId()) then
