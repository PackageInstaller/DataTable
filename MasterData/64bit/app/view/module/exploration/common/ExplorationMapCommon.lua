...
function var_0_2:getGlobalCoordinateByRoomAndRoomCoordinate(arg_6_1)
	local var_6_0, var_6_1 = self:getRoomCoordinate()

	return var_0_2.getGlobalCoordinateByRoomPosAndRoomCoordinate(var_6_0, var_6_1, arg_6_1)
end

function var_0_2.getGlobalCoordinateByRoomPosAndRoomCoordinate(arg_7_0, arg_7_1, arg_7_2)
	return (arg_7_0 - 1) * 9 + arg_7_2.x, (arg_7_1 - 1) * 9 + arg_7_2.y
end

function var_0_2:getRoomCoordinateAndCoordinateByGlobalCoordinate()
	local var_8_0 = cc.p(0, 0)

	var_8_0.x = math.ceil((self.x + 1) / var_0_1.width)
	var_8_0.y = math.ceil((self.y + 1) / var_0_1.height)

	local var_8_1 = cc.p(0, 0)

	var_8_1.x = self.x - (var_8_0.x - 1) * var_0_1.width
	var_8_1.y = self.y - (var_8_0.y - 1) * var_0_1.height
