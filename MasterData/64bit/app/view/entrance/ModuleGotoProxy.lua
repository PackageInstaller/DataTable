...
function ModuleGotoProxy:_getModule(arg_26_1)
	...
	elseif arg_26_1.route_type == ModuleEntrance.TEAM_BATTLE_READY_LAYER.routeType then
		if g.core.model.User.teamBattleData:isActivityOpen() then
			...
			local var_26_11 = g.core.model.User.teamBattleData:getFormationData():getAllKnightList()
			local var_26_12 = g.core.model.User.teamBattleData:getTeamUpData():getMyTeam()

			if var_26_12 and var_26_12.ready and #var_26_11 > 0 and g.core.model.User.teamBattleData:getCurStage() == 2 then
