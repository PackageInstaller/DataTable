...
local var_0_9 = {
	...
	cost_type = 48,
	cost_money = 47,
	place_4_affect_value_4 = 46,
	place_4_affect_type_4 = 45,
	place_4_affect_value_3 = 44,
	place_4_affect_type_3 = 43,
	place_4_affect_value_2 = 42,
	place_4_affect_type_2 = 41,
	place_4_affect_value_1 = 40,
	place_4_affect_type_1 = 39,
	name = 5,
	place_3_affect_type_4 = 37,
	place_3_affect_value_3 = 36,
	place_3_affect_type_3 = 35,
	place_3_affect_value_2 = 34,
	place_3_affect_type_2 = 33,
	place_3_affect_value_1 = 32,
	place_3_affect_type_1 = 31,
	place_2_affect_value_4 = 30,
	place_2_affect_type_4 = 29,
	place_2_affect_value_3 = 28,
	place_2_affect_type_3 = 27,
	place_2_affect_value_2 = 26,
	place_2_affect_type_2 = 25,
	place_2_affect_value_1 = 24,
	place_2_affect_type_1 = 23,
	place_1_affect_value_4 = 22,
	place_1_affect_type_4 = 21,
	place_1_affect_value_3 = 20,
	place_1_affect_type_3 = 19,
	place_1_affect_value_2 = 18,
	place_1_affect_type_2 = 17,
	place_1_affect_value_1 = 16,
	place_1_affect_type_1 = 15,
	num_4 = 14,
	place_4 = 13,
	num_3 = 12,
	place_3 = 11,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_knight_advance_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.knight_advance_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.knight_advance_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.knight_advance_info_data"] = nil
		package.loaded["app.core.config.cfg.knight_advance_info_key"] = nil
	end
end
