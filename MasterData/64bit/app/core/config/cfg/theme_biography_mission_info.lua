...
local var_0_9 = {
	...
	cost = 31,
	reward_first = 30,
	mission_finish_tip = 29,
	finish_story = 28,
	trigger_story = 27,
	finish_talk = 26,
	triggerable_talk = 25,
	not_triggerable_talk = 24,
	conceal = 23,
	preset_value_5 = 22,
	preset_type_5 = 21,
	resource_name = 7,
	...
	id = 1,
	description = 33,
	unlock_seen_value = 12,
	unlock_seen_type = 11,
	if_converstion_panel = 10,
	flip = 9,
	mission_resource = 8,
	type = 2
}
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_theme_biography_mission_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.theme_biography_mission_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.theme_biography_mission_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.theme_biography_mission_info_data"] = nil
		package.loaded["app.core.config.cfg.theme_biography_mission_info_key"] = nil
	end
end
