...
local var_0_8
local var_0_9 = {
	outpost_attack_hit = 8,
	outpost_attack_shoot = 7,
	elemental_5 = 6,
	elemental_4 = 5,
	elemental_3 = 4,
	elemental_2 = 3,
	elemental_1 = 2,
	id = 1,
	outpost_skill_start = 11,
	outpost_skill_hit = 10,
	outpost_skill_shoot = 9
}
local var_0_10 = {}
local var_0_11 = {
	1,
	...
	1000,
	1000,
	"outpost_attack_shoot_water",
	"outpost_attack_hit_water",
	"outpost_skill_shoot_water",
	"outpost_skill_hit_water",
	"outpost_skill_start_water"
}
local var_0_12 = 11
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_outpost_knight_elemental_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.outpost_knight_elemental_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.outpost_knight_elemental_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.outpost_knight_elemental_info_data"] = nil
		package.loaded["app.core.config.cfg.outpost_knight_elemental_info_key"] = nil
	end
end
