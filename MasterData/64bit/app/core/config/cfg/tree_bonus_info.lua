...
local var_0_9 = {
	...
	icon = 3,
	id = 1,
	extra_skill_type_3 = 23,
	extra_skill_value_2 = 22,
	name = 2,
	extra_skill_value_3 = 24,
	extra_skill_type_4 = 25,
	extra_skill_value_4 = 26,
	extra_skill_type_2 = 21,
	extra_skill_value_1 = 20,
	extra_skill_type_1 = 19,
	basic_skill_value_4 = 18,
	basic_skill_type_4 = 17,
	basic_skill_value_3 = 16,
	basic_skill_type_3 = 15,
	basic_skill_value_2 = 14,
	basic_skill_type_2 = 13,
	basic_skill_value_1 = 12,
	basic_skill_type_1 = 11,
	extra_num_max = 10,
	extra_value = 9,
	extra_key = 8,
	extra_type = 7,
	extra_condition_des = 6
}
local var_0_10 = {
	extra_des = 3,
	basic_des = 2,
	name = 1,
	extra_condition_des = 4
}
local var_0_11 = {
	101,
	"768_101_name",
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_tree_bonus_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.tree_bonus_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.tree_bonus_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.tree_bonus_info_data"] = nil
		package.loaded["app.core.config.cfg.tree_bonus_info_key"] = nil
	end
end
