...
local var_0_9 = {
	...
	passive_skill_1 = 46,
	passive_skill = 45,
	monster_combo_damage_dec = 44,
	monster_combo_damage_add = 43,
	monster_knight_damage_dec = 42,
	monster_knight_damage_add = 41,
	develop_damage_dec = 40,
	develop_damage_add = 39,
	develop_magical_defence = 38,
	develop_physical_defence = 37,
	develop_attack = 36,
	develop_hp = 35,
	anti_faint = 34,
	anti_reduce_anger = 33,
	anger_recover = 32,
	initial_anger = 31,
	block_damage_dec = 30,
	crit_damage_add = 29,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_guide_monster_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.guide_monster_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.guide_monster_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.guide_monster_info_data"] = nil
		package.loaded["app.core.config.cfg.guide_monster_info_key"] = nil
	end
end
