...
local var_0_8
local var_0_9 = {
	advance_affect_value1 = 7,
	advance_affect_type1 = 6,
	cost = 5,
	level = 2,
	id = 1,
	exp = 4,
	talent_skill = 12,
	name = 3,
	advance_affect_value3 = 11,
	advance_affect_type3 = 10,
	advance_affect_value2 = 9,
	advance_affect_type2 = 8
}
local var_0_10 = {}
local var_0_11 = {
	601,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_equipment_resonance_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.equipment_resonance_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.equipment_resonance_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.equipment_resonance_info_data"] = nil
		package.loaded["app.core.config.cfg.equipment_resonance_info_key"] = nil
	end
end
