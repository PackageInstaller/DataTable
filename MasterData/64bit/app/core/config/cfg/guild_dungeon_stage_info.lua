...
local var_0_8
local var_0_9 = {
	attack_award_size_2 = 18,
	mvp_award_type_1 = 19,
	final_award = 29,
	guild_exp = 28,
	mvp_award_size_3 = 27,
	mvp_award_value_3 = 26,
	mvp_award_type_3 = 25,
	mvp_award_size_2 = 24,
	mvp_award_value_2 = 23,
	mvp_award_type_2 = 22,
	mvp_award_size_1 = 21,
	attack_award_value_2 = 17,
	attack_award_type_2 = 16,
	attack_award_size_1 = 15,
	attack_award_value_1 = 14,
	attack_award_type_1 = 13,
	if_show = 12,
	description = 11,
	monster_image_2 = 10,
	monster_image = 9,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_guild_dungeon_stage_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.guild_dungeon_stage_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.guild_dungeon_stage_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.guild_dungeon_stage_info_data"] = nil
		package.loaded["app.core.config.cfg.guild_dungeon_stage_info_key"] = nil
	end
end
