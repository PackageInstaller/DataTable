...
local var_0_9 = {
	...
	id = 1,
	initial_energy = 12,
	army_passive_skill_id_1 = 37,
	army_skill_id = 36,
	is_element_leader = 35,
	if_ghost = 34,
	if_immune_control = 33,
	magic_id = 32,
	artifact_id = 31,
	if_lock = 30,
	passive_skill_5 = 29,
	...
	passive_skill_1 = 25,
	passive_skill = 24,
	develop_damage_dec = 23,
	develop_damage_add = 22,
	develop_magical_defence = 21,
	develop_physical_defence = 20,
	develop_attack = 19,
	develop_hp = 18,
	initial_hp = 17,
	energy_value_2 = 16,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_monster_info")
...
local var_0_16 = ...
local var_0_18, var_0_19 = pcall(require, string.sub(var_0_16, 1, string.len(var_0_16) - string.len("monster_info")) .. "monster_info_2")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.monster_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.monster_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.monster_info_data"] = nil
		package.loaded["app.core.config.cfg.monster_info_key"] = nil
