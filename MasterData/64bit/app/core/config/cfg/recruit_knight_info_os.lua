...
local var_0_9
local var_0_10 = {
	up_content_value_2 = 22,
	up_content_type_2 = 21,
	up_content_value = 20,
	up_content_type = 19,
	twenty_summon_cost = 18,
	ten_summon_cost = 17,
	single_summon_cost = 16,
	pack10_id = 15,
	pack9_id = 14,
	pack8_id = 13,
	pack7_id = 12,
	...
	reward_group = 30,
	activity_id = 29,
	gacha_display_quality = 28,
	wish_rule_id = 27,
	ten_quality_limit_replace = 26,
	ten_quality_limit_num = 25,
	ten_quality_limit = 24,
	up_pro = 23
}
local var_0_11 = {}
local var_0_12 = {
...
local var_0_14 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_10[arg_1_1], "cannot find " .. arg_1_1 .. " in record_recruit_knight_info_os")
...
local var_0_17 = ...
local var_0_19, var_0_20 = pcall(require, string.sub(var_0_17, 1, string.len(var_0_17) - string.len("recruit_knight_info_os")) .. "recruit_knight_info_2")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.recruit_knight_info_os_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.recruit_knight_info_os_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.recruit_knight_info_os_data"] = nil
		package.loaded["app.core.config.cfg.recruit_knight_info_os_key"] = nil
		var_0_9 = nil
