...
local var_0_9 = {
	main_skill_icon = 10,
	job = 9,
	main_skill_unlock_level = 8,
	main_skill_param_5 = 7,
	main_skill_param_4 = 6,
	main_skill_param_3 = 5,
	main_skill_param_2 = 4,
	main_skill_param_1 = 3,
	main_skill_type = 2,
	id = 1,
	main_skill_message = 16,
	main_skill_grid_icon = 15,
	main_skill_txt_2 = 14,
	main_skill_txt = 13,
	main_skill_desc = 12,
	main_skill_name = 11
...
local var_0_11 = {
	...
	1,
	1,
	"565_1_main_skill_name",
	"565_1_main_skill_desc",
	"565_1_main_skill_txt",
	"565_1_main_skill_txt_2",
	"0",
	"565_1_main_skill_txt_2"
}
local var_0_12 = 16
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_gve_equipment_skill_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.gve_equipment_skill_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.gve_equipment_skill_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.gve_equipment_skill_info_data"] = nil
		package.loaded["app.core.config.cfg.gve_equipment_skill_info_key"] = nil
	end
end
