...
local var_0_8
local var_0_9 = {
	female_active_skill_id_2 = 37,
	male_active_skill_id_2 = 36,
	enhance_level_1 = 35,
	passive_skill_id_1_4 = 34,
	passive_skill_id_1_3 = 33,
	passive_skill_id_1_2 = 32,
	passive_skill_id_1_1 = 31,
	female_active_ultimate_id_1 = 30,
	rare = 7,
	quality = 6,
	male_active_skill_id_1 = 27,
	common_id = 26,
	female_common_id = 25,
	male_common_id = 24,
	energy_value_2 = 23,
	...
	advance_code = 9,
	potential = 8,
	male_active_ultimate_id_1 = 29,
	female_active_skill_id_1 = 28,
	dress_icon = 5,
	woman_res_id = 4,
	man_res_id = 3,
	put = 2,
	id = 1,
	spine_interface_size = 78,
	zoom_size = 77,
	wing_hide = 76,
	game_type = 75,
	remind_size = 74,
	female_personality_talk_4 = 73,
	female_personality_talk_3 = 72,
	female_personality_talk_2 = 71,
	male_personality_talk_4 = 70,
	male_personality_talk_3 = 69,
	male_personality_talk_2 = 68,
	gm = 67,
	compose_id = 66,
	convert_size = 65,
	convert_value = 64,
	convert_type = 63,
	enhance_level_4 = 62,
	passive_skill_id_4_4 = 61,
	passive_skill_id_4_3 = 60,
	passive_skill_id_4_2 = 59,
	passive_skill_id_4_1 = 58,
	female_active_ultimate_id_4 = 57,
	male_active_ultimate_id_4 = 56,
	female_active_skill_id_4 = 55,
	male_active_skill_id_4 = 54,
	enhance_level_3 = 53,
	passive_skill_id_3_4 = 52,
	passive_skill_id_3_3 = 51,
	passive_skill_id_3_2 = 50,
	passive_skill_id_3_1 = 49,
	female_active_ultimate_id_3 = 48,
	male_active_ultimate_id_3 = 47,
	female_active_skill_id_3 = 46,
	male_active_skill_id_3 = 45,
	enhance_level_2 = 44,
	passive_skill_id_2_4 = 43,
	passive_skill_id_2_3 = 42,
	passive_skill_id_2_2 = 41,
	passive_skill_id_2_1 = 40,
	female_active_ultimate_id_2 = 39,
	male_active_ultimate_id_2 = 38
}
local var_0_10 = {}
local var_0_11 = {
	100,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_dress_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.dress_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.dress_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.dress_info_data"] = nil
		package.loaded["app.core.config.cfg.dress_info_key"] = nil
	end
end
