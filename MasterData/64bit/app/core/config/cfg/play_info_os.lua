...
local var_0_10 = {
	...
	full_screen_down = 25,
	full_screen_up = 24,
	unite_skill_ourbuff_effects = 23,
	unite_skill_drawing = 22,
	splash = 21,
	background = 20,
	camara_effect = 19,
	trajectory = 18,
...
local var_0_14 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_10[arg_1_1], "cannot find " .. arg_1_1 .. " in record_play_info_os")
...
local var_0_17 = ...
local var_0_19, var_0_20 = pcall(require, string.sub(var_0_17, 1, string.len(var_0_17) - string.len("play_info_os")) .. "play_info_2")
...
function var_0_7.get(arg_10_0, arg_10_1, arg_10_2)
	if not var_0_7._getKey()[arg_10_0 .. "_" .. arg_10_1 .. "_" .. arg_10_2] then
		if var_0_21 then
			return var_0_21.get(arg_10_0, arg_10_1, arg_10_2)
		end

		return nil
	end

	return var_0_7.indexOf(var_0_7._getKey()[arg_10_0 .. "_" .. arg_10_1 .. "_" .. arg_10_2])
end
...
function var_0_7.set(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	local var_12_0 = var_0_7._getKey()[arg_12_0 .. "_" .. arg_12_1 .. "_" .. arg_12_2]

	if not var_12_0 then
		if var_0_21 then
			var_0_21.set(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)

			return
		end

		error("Key not found: " .. arg_12_0 .. "_" .. arg_12_1 .. "_" .. arg_12_2)
	end
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.play_info_os_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.play_info_os_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.play_info_os_data"] = nil
		package.loaded["app.core.config.cfg.play_info_os_key"] = nil
		var_0_9 = nil
