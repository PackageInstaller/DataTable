...
local var_0_8
local var_0_9 = {
	privilege_value_2 = 11,
	privilege_effect_2 = 10,
	reward_drop_2 = 9,
	privilege_icon_1 = 8,
	privilege_value_1 = 7,
	privilege_effect_1 = 6,
	reward_drop_1 = 5,
	prize_type = 4,
	level = 3,
	order = 2,
	id = 1,
	privilege_icon_3 = 16,
	privilege_value_3 = 15,
	privilege_effect_3 = 14,
	reward_drop_3 = 13,
	privilege_icon_2 = 12
}
local var_0_10 = {}
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_server_pass_reward_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.server_pass_reward_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.server_pass_reward_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.server_pass_reward_info_data"] = nil
		package.loaded["app.core.config.cfg.server_pass_reward_info_key"] = nil
	end
end
