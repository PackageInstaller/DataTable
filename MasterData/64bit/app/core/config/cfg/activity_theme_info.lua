...
local var_0_9 = {
	...
	integral_award = 10,
	integral_ratio = 9,
	auto_monster_group = 8,
	auto_monster_type = 7,
	boss_time = 6,
	boss_id = 5,
	extra_drop = 4,
	id = 1,
	attribute_compress = 45,
	activity_passcard = 44,
	talent_group = 43,
	biography_id_5 = 42,
	biography_id_4 = 41,
	biography_id_3 = 40,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_activity_theme_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.activity_theme_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.activity_theme_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.activity_theme_info_data"] = nil
		package.loaded["app.core.config.cfg.activity_theme_info_key"] = nil
	end
end
