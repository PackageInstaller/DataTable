...
local var_0_9 = {
	...
	id = 1,
	price = 11,
	attribute_value_4 = 21,
	gm = 27,
	main_skill_type_3 = 26,
	main_skill_type_2 = 25,
	main_skill_type_1 = 24,
	attribute_value_5 = 23,
	attribute_type_5 = 22,
	name = 2,
	attribute_type_4 = 20,
	attribute_value_3 = 19,
	attribute_type_3 = 18,
	attribute_value_2 = 17,
	attribute_type_2 = 16,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_gve_equipment_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.gve_equipment_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.gve_equipment_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.gve_equipment_info_data"] = nil
		package.loaded["app.core.config.cfg.gve_equipment_info_key"] = nil
	end
end
