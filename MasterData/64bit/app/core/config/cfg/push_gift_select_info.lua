...
local var_0_9 = {
	gift_id = 9,
	weight = 8,
	limit_recharge_today = 7,
	limit_recharge_yesterday = 6,
	limit_recharge_3 = 5,
	limit_recharge_7 = 4,
	limit_recharge_30 = 3,
	gift_group = 2,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_push_gift_select_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.push_gift_select_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.push_gift_select_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.push_gift_select_info_data"] = nil
		package.loaded["app.core.config.cfg.push_gift_select_info_key"] = nil
	end
end
