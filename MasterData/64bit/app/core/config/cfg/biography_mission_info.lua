...
local var_0_9 = {
	...
	reward_first = 33,
	reward_drop = 32,
	mission_finish_tip = 31,
	finish_story = 30,
	trigger_story = 29,
	finish_talk = 28,
	triggerable_talk = 27,
	not_triggerable_talk = 26,
	attempts = 25,
	repeatable = 24,
	conceal = 23,
	preset_value_5 = 22,
...
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_biography_mission_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.biography_mission_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.biography_mission_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.biography_mission_info_data"] = nil
		package.loaded["app.core.config.cfg.biography_mission_info_key"] = nil
	end
end
