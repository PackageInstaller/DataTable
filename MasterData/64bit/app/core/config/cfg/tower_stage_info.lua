...
local var_0_9 = {
	...
	reward_value1 = 18,
	reward_type1 = 17,
	monster_team_type = 16,
	monster_team_id_3 = 15,
	monster_team_id_2 = 14,
	monster_team_id = 13,
	enemy_num = 12,
	fight_3 = 11,
	fight_2 = 10,
...
local var_0_11 = {
	...
	0,
	0,
	"460_12000001_details",
	"460_12000001_details_2"
}
local var_0_12 = 47
local var_0_13 = {
	__index = function(self, arg_1_1)
		...
		if arg_1_1 == "toObject" then
			...
			assert(var_0_9[arg_1_1], "cannot find " .. arg_1_1 .. " in record_tower_stage_info")
...
function var_0_7._getData()
	if not var_0_7._originData then
		var_0_7._originData = loadCfg("core.config.cfg.tower_stage_info_data")
...
function var_0_7._getKey()
	if not var_0_8 then
		var_0_8 = loadCfg("core.config.cfg.tower_stage_info_key")
...
function var_0_7.checkDataClear()
	if var_0_7._lastUseTime > 0 and os.time() - var_0_7._lastUseTime > g.core.const.ConstMgr.BASE_CONST.CONFIG_CHECK_DATA_DELTA then
		...
		package.loaded["app.core.config.cfg.tower_stage_info_data"] = nil
		package.loaded["app.core.config.cfg.tower_stage_info_key"] = nil
	end
end
