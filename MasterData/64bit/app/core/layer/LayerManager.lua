...
function LayerManager:addDebugBtn()
	local var_2_0 = fgui.UIPackage:createObject("base_new", "BaseDebugBtn")

	var_2_0:setPosition(cc.Director:getInstance():getSafeAreaRect().x, 0)
	var_2_0:setSortingOrder(100)
	var_2_0:addClickListener(function()
		...
		var_2_0:setOpacity(0)
	end)
	self._groot:addChild(var_2_0)
end
