...
function var_0_4:initLangSearchPath()
	local var_1_0 = json.decodeFileIfExists(cc.FileUtils:getInstance():getWritablePath() .. "userdata/multilingual.json")
	...
	local var_1_1 = "res/language/" .. var_1_0[var_0_0] .. "/"

	cc.FileUtils:getInstance():addSearchPath("res/language/" .. var_1_0[var_0_0] .. "/", true)
	cc.FileUtils:getInstance():addSearchPath((cc.FileUtils:getInstance():getWritablePath() .. "upgradelang/") .. var_1_1, true)
	self:addFanHeXieFolderPath()
end

function var_0_4.addFanHeXieFolderPath(arg_2_0)
	local var_2_0 = cc.FileUtils:getInstance():getWritablePath() .. "highquality/"

	cc.FileUtils:getInstance():createDirectory(var_2_0)
	cc.FileUtils:getInstance():addSearchPath(var_2_0 .. "res/", true)
	cc.FileUtils:getInstance():addSearchPath(var_2_0 .. "res/common/", true)
	cc.FileUtils:getInstance():addSearchPath(var_2_0, true)
end

function var_0_4:uploadFanHeXiePoint()
	local var_3_0 = cc.FileUtils:getInstance():getWritablePath() .. "highquality/"

	if self._checkFHX then
		if not cc.FileUtils:getInstance():isDirectoryExist(var_3_0 .. "res/common/") then
			if cc.FileUtils:getInstance():isDirectoryExist(var_3_0 .. "knight_spine/") then
