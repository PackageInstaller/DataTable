...
function var_0_0.bigNumberToString(arg_4_0, arg_4_1)
	if type(arg_4_1) == "number" and arg_4_1 >= math.pow(10, 14) then
		local var_4_0 = g.core.model.User.translateData:getTranslateLangNum((require("app.core.lang.MultilingualMgr"):getUseLang()))

		if var_4_0.calcElem then
			for iter_4_0, iter_4_1 in ipairs(var_4_0.calcElem) do
