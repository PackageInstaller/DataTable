...
function MapWorld:_initMoveRange()
	local var_35_0 = self:getMapGround()
	local var_35_1 = var_35_0:getMapHeight()
	local var_35_2 = self:getMapGround():getHalfTileH()

	self._minMoveX = -var_35_0
	self._maxMoveX = self:getMapGround():getMapWidth() / 2 - display.width / 2 - display.height
	self._minMoveY = var_35_1 / 2 - var_35_2 - self._maxMoveX / 2
	self._maxMoveY = var_35_1 / 2 - var_35_2 + self._maxMoveX / 2
end
