...
function BaseMapNode:_isShowArrowComp(arg_54_1)
	...
	if not cc.rectContainsPoint(cc.rect(0, 0, var_54_0.width, var_54_0.height), arg_54_1) then
		local var_54_1 = cc.Director:getInstance():getSafeAreaRect()
		local var_54_2 = self._compArrow:localToGlobal(cc.p(0, 0))

		return true, math.radian2angle((cc.pToAngleSelf(cc.pSub(cc.p(var_54_2.x, var_54_2.y), arg_54_1)))) + 90, cc.p(var_54_2.x, var_54_2.y)
	else
		return false
	end
end
