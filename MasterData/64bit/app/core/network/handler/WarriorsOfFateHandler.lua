...
return {
	on_S2C_MainGrowth_GetInfo = function(arg_1_0, arg_1_1, arg_1_2)
		if ProtoHandler:onMsgProcess(arg_1_1, arg_1_2) then
			g.core.model.User.warriorsOfFateData:updateInfo(arg_1_2)
	...
	on_S2C_MainGrowth_Activate = function(arg_2_0, arg_2_1, arg_2_2)
		if ProtoHandler:onMsgProcess(arg_2_1, arg_2_2) then
			g.core.model.User.warriorsOfFateData:updateInfo(arg_2_2)
	...
	on_S2C_Scroll_Info = function(arg_3_0, arg_3_1, arg_3_2)
		if ProtoHandler:onMsgProcess(arg_3_1, arg_3_2) then
			g.core.model.User.warriorsOfFateData:onScrollInfo(arg_3_2)
	...
	on_S2C_Scroll_Activate = function(arg_4_0, arg_4_1, arg_4_2)
		if ProtoHandler:onMsgProcess(arg_4_1, arg_4_2) then
			g.core.model.User.warriorsOfFateData:onScrollActivate(arg_4_2)
