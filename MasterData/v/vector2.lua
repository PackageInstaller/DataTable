...
local max = math.max
---@class UnityEngine.Vector2:Vector2
---@field x number
---@field y number
local Vector2 = {}
---@class Vector2
local get = {Vector2 = Vector2}
...
get.down 	= function() return setmetatable({x = 0, y = -1}, Vector2) end
get.left	= function() return setmetatable({x = -1, y = 0}, Vector2) end
