...
local activity_hero_ui_config = {
  ...
  [19] = {
    activity_id = 19,
    background_res = "CharDunKimieBG",
    background_skin = 307502,
    challenge_icon = "UI_CharDunKimieChallengeIcon",
    frame_color = {
      173,
      13,
      24
    },
    main_down_res = "CharDunKimieDown",
    main_down_size = {2600, 36},
    main_stage_icon = "UI_CharDunKimieMianStoryIcon",
    main_top_res = "CharDunKimieUp",
    main_top_size = {2600, 323},
    mission_panel_name = 22907,
    quest_skin = 307501,
    reward_panel_name = 36930
  },
  [20] = {
    activity_id = 20,
    animation_prefab = "UI_CharDunAnimationPenumbra",
    background_res = "CharDunPenumbraBG",
    background_skin = 307902,
    challenge_icon = "UI_CharDunPenumbraChallengeIcon",
    frame_color = {
      170,
      45,
      11
    },
    main_down_res = "CharDunPenumbraDown",
    main_down_size = {2600, 637},
    main_stage_icon = "UI_CharDunPenumbraMianStoryIcon",
    main_top_res = "CharDunPenumbraUp",
    main_top_size = {2600, 19},
    mission_panel_name = 367126,
    quest_skin = 307901,
    reward_panel_name = 344273
  },
  [21] = {
    activity_id = 21,
    animation_prefab = "UI_CharDunAnimationBonneville",
    background_skin = 308202,
    challenge_icon = "UI_CharDunBonnevilleChallengeIcon",
    frame_color = {
      148,
      1,
      0
    },
    main_down_res = "CharDunBonnevilleDown",
    main_down_size = __rt_4,
    main_stage_icon = "UI_CharDunBonnevilleMianStoryIcon",
    main_top_res = "CharDunBonnevilleUp",
    main_top_size = {2600, 123},
    mission_panel_name = 226154,
    quest_skin = 308201,
    reward_panel_name = 396136
  }
}
local __default_values = {
  activity_id = 10,
  animation_prefab = "",
  background_res = "CharDunBonnevilleBG",
