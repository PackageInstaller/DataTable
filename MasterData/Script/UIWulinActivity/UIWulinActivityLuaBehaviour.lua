...
local ViewFunction = require("UIWulinActivity/UIWulinActivityViewFunction")
...
local Luabehaviour = {
  ...
  deserialize = function(initParams)
    ...
    View.Group_Bg.Img_Icon:SetSprite(GetResPath(88300319))
    View.Group_Join.Group_Card.Img_:SetSprite(GetResPath(88300337))
