local View = require("UIActivityRechargeMist/UIActivityRechargeMistView")
local DataModel = require("UIActivityRechargeMist/UIActivityRechargeMistDataModel")
...
function Controller:InitView()
  if next(DataModel.rewardsList) ~= nil then
    ...
    View.Img_Title:SetSprite(GetResPath(88300282))
    View.Img_T:SetSprite(GetResPath(88300275))
  end
end
...
function Controller:SetElement(element, elementIndex)
  ...
  element.Img_Received:SetActive(data.isGot)
  element.Img_Btm02:SetActive(data.isRed)
  element.Img_Red:SetActive(data.isRed)
end
