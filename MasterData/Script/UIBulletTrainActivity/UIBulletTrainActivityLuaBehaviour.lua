local View = require("UIBulletTrainActivity/UIBulletTrainActivityView")
local DataModel = require("UIBulletTrainActivity/UIBulletTrainActivityDataModel")
local ViewFunction = require("UIBulletTrainActivity/UIBulletTrainActivityViewFunction")
local Controller = require("UIBulletTrainActivity/UIBulletTrainActivityController")
local param
local Luabehaviour = {
  serialize = function()
    return param
  ...
  deserialize = function(initParams)
    ...
    View.Group_Bg.Img_Icon:SetSprite(GetResPath(88300302))
    ...
    if not DataModel.isJoin then
      ...
      View.Group_Join.Group_Store.Txt_Num:SetText(PlayerData:GetGoodsById(11400942).num or 0)
    end
  end,
  awake = function()
  end,
