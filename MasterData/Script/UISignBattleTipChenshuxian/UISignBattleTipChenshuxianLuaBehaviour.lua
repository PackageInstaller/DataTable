local View = require("UISignBattleTipChenshuxian/UISignBattleTipChenshuxianView")
local DataModel = require("UISignBattleTipChenshuxian/UISignBattleTipChenshuxianDataModel")
local ViewFunction = require("UISignBattleTipChenshuxian/UISignBattleTipChenshuxianViewFunction")
local Luabehaviour = {
  serialize = function()
  end,
  deserialize = function(initParams)
    if initParams then
      ...
      local newTips = PlayerData:GetPlayerPrefs("int", "ActivityTip" .. DataModel.activityId .. DataModel.index) == 0
      if newTips then
    ...
    View.Video_Main:Play("Video/CV_Japanese/SignBattle/PV_Chenshuxian/PV_Chenshuxian")
