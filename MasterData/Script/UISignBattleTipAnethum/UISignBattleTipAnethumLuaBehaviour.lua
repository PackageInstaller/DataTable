local View = require("UISignBattleTipAnethum/UISignBattleTipAnethumView")
local DataModel = require("UISignBattleTipAnethum/UISignBattleTipAnethumDataModel")
local ViewFunction = require("UISignBattleTipAnethum/UISignBattleTipAnethumViewFunction")
local Luabehaviour = {
  serialize = function()
  end,
  deserialize = function(initParams)
    ...
    ChangeSkinUtil.InitUICaptainSpineSkin(View.SpineAnimation_Player, "dorm_stand")
  end,
  awake = function()
  end,
  start = function()
