local View = require("UISignBattleTipIkara/UISignBattleTipIkaraView")
local DataModel = require("UISignBattleTipIkara/UISignBattleTipIkaraDataModel")
local ViewFunction = require("UISignBattleTipIkara/UISignBattleTipIkaraViewFunction")
local Luabehaviour = {
  serialize = function()
  end,
  deserialize = function(initParams)
    ...
    View.Video_Main:Play("Video/SignBattle/PV_Ikara")
