local View = require("UIFlameLevel/UIFlameLevelView")
local DataModel = require("UIFlameLevel/UIFlameLevelDataModel")
local ViewFunction = require("UIFlameLevel/UIFlameLevelViewFunction")
local Controller = require("UIFlameLevel/UIFlameLevelController")
local Luabehaviour = {
  serialize = function()
    local t = {}
  ...
  ondestroy = function()
    ...
    PlayerData:SetPlayerPrefs("int", "FlameLevelPos", DataModel.curPos)
    DataModel.toPlayFirstPassAnim = false
  end,
  enable = function()
  end,
