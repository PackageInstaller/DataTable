...
local ViewFunction = {
  SignBattleLevelMeiqi_ScrollGrid_Map_SetGrid = function(element, elementIndex)
    Controller:SetElement(element, elementIndex)
  end,
  SignBattleLevelMeiqi_ScrollGrid_Map_Group_Level_Group_Level_Group_Current_Btn_Level_Click = function(btn, str)
    Controller:OpenRightPage(tonumber(str))
  end,
  SignBattleLevelMeiqi_Group_SpLevelDetails_Btn_Close_Click = function(btn, str)
    Controller:CloseChoose()
  end,
  SignBattleLevelMeiqi_Group_SpLevelDetails_ScrollGrid_Reward_SetGrid = function(element, elementIndex)
  ...
  SignBattleLevelMeiqi_Group_SpLevelDetails_ScrollGrid_Reward_Group_Item_Group_Item_Btn_Item_Click = function(btn, str)
    if str == nil then
      return
    end
    CommonTips.OpenPreRewardDetailTips(str, nil, true)
  end,
  SignBattleLevelMeiqi_Group_SpLevelDetails_Btn_Fight_Click = function(btn, str)
    Controller:TryBattle()
  end,
  SignBattleLevelMeiqi_Group_CommonTopLeft_Btn_Return_Click = function(btn, str)
  ...
  SignBattleLevelMeiqi_Group_CommonTopLeft_Btn_Home_Click = function(btn, str)
    Controller:CloseChoose()
    UIManager:GoHome()
  end,
  SignBattleLevelMeiqi_Group_CommonTopLeft_Btn_Menu_Click = function(btn, str)
  end,
  SignBattleLevelMeiqi_Group_CommonTopLeft_Btn_Help_Click = function(btn, str)
  end,
  SignBattleLevelMeiqi_Btn_Gacha_Click = function(btn, str)
    local t = {}
