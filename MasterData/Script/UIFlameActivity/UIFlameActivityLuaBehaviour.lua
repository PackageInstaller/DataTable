local View = require("UIFlameActivity/UIFlameActivityView")
local DataModel = require("UIFlameActivity/UIFlameActivityDataModel")
local ViewFunction = require("UIFlameActivity/UIFlameActivityViewFunction")
local Controller = require("UIFlameActivity/UIFlameActivityController")
local param
local Luabehaviour = {
  serialize = function()
    return param
  ...
  deserialize = function(initParams)
    ...
    View.Group_Bg.Img_Icon:SetSprite(GetResPath(88300308))
    ...
    if not DataModel.isJoin then
      ...
      View.Group_Join.Group_Store.Txt_Num:SetText(PlayerData:GetGoodsById(11400974).num or 0)
    end
  end,
  awake = function()
  end,
