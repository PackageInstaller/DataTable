...
local ViewFunction = {
  FlameActivity_Group_NotJoin_Group_Preview_ScrollGrid_Reward_SetGrid = function(element, elementIndex)
  ...
  FlameActivity_Group_NotJoin_Group_Preview_ScrollGrid_Reward_Group_Item_Group_Item_Btn_Item_Click = function(btn, str)
    local id = tonumber(str)
    CommonTips.OpenPreRewardDetailTips(id)
  end,
  FlameActivity_Group_NotJoin_Group_Add_Btn__Click = function(btn, str)
  ...
  FlameActivity_Group_Join_Group_Quest_Btn__Click = function(btn, str)
    local parms = {}
    parms.activityId = DataModel.activityId
    UIManager:Open("UI/Activity/Flame/FlameMission", Json.encode(parms))
  end,
  FlameActivity_Group_Join_Group_Store_Btn__Click = function(btn, str)
    local parms = {}
    parms.activityId = DataModel.activityId
    parms.shopId = DataModel.shopId
    Net:SendProto("shop.info", function(json)
      UIManager:Open("UI/Activity/Flame/FlameStore", Json.encode(parms))
    end)
  end,
  FlameActivity_Group_Join_Group_Card_Btn__Click = function(btn, str)
  ...
  FlameActivity_Group_Join_Group_Skip_Btn__Click = function(btn, str)
  ...
  FlameActivity_Group_Join_Group_Rank_Btn__Click = function(btn, str)
  ...
  FlameActivity_Group_Join_Group_Level_Group_Can_Btn__Click = function(btn, str)
    ...
    UIManager:Open("UI/Activity/Flame/FlameLevel")
  end,
  FlameActivity_Group_Join_Group_Level_Group_Skin_Btn__Click = function(btn, str)
    if not DataModel.levelQuestIsComplete then
      local questName = PlayerData:GetFactoryData(DataModel.levelQuestId).name
      CommonTips.OpenTips(string.format(GetText(80607102), questName))
      return
  ...
  FlameActivity_Group_Join_Group_Level_Group_SignBattle_Btn_SignBattle_Click = function(btn, str)
    if not DataModel.levelQuestIsComplete then
      local questName = PlayerData:GetFactoryData(DataModel.levelQuestId).name
      CommonTips.OpenTips(string.format(GetText(80607102), questName))
      return
  ...
  FlameActivity_Group_Join_Btn_Gacha_Click = function(btn, str)
    local ca = PlayerData:GetFactoryData(DataModel.activityId)
  ...
  FlameActivity_Btn_Help_Click = function(btn, str)
    CommonTips.OpenHelp(DataModel.helpId)
  end,
  FlameActivity_Btn_Video_Click = function(btn, str)
    UIManager:Open("UI/Activity/ActivitySignBattle/SignBattleTipShana")
  end
}
return ViewFunction
