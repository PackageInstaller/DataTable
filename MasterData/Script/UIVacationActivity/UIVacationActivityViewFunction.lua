...
local ViewFunction = {
  VacationActivity_Group_NotJoin_Group_Preview_ScrollGrid_Reward_SetGrid = function(element, elementIndex)
  ...
  VacationActivity_Group_NotJoin_Group_Preview_ScrollGrid_Reward_Group_Item_Group_Item_Btn_Item_Click = function(btn, str)
    local id = tonumber(str)
    CommonTips.OpenPreRewardDetailTips(id)
  end,
  VacationActivity_Group_NotJoin_Group_Add_Btn__Click = function(btn, str)
  ...
  VacationActivity_Group_Join_Group_Quest_Btn__Click = function(btn, str)
    local parms = {}
    parms.activityId = DataModel.activityId
    UIManager:Open("UI/Activity/Vacation/VacationMission", Json.encode(parms))
  end,
  VacationActivity_Group_Join_Group_Store_Btn__Click = function(btn, str)
    local parms = {}
    parms.activityId = DataModel.activityId
    parms.shopId = DataModel.shopId
    Net:SendProto("shop.info", function(json)
      UIManager:Open("UI/Activity/Vacation/VacationStore", Json.encode(parms))
    end)
  end,
  VacationActivity_Group_Join_Group_Card_Btn__Click = function(btn, str)
  end,
  VacationActivity_Group_Join_Group_Skip_Btn__Click = function(btn, str)
  ...
  VacationActivity_Group_Join_Group_Rank_Btn__Click = function(btn, str)
  ...
  VacationActivity_Group_Join_Group_Level_Group_Can_Btn__Click = function(btn, str)
    ...
    UIManager:Open("UI/Activity/Vacation/VacationLevel")
  end,
  VacationActivity_Group_Join_Group_Level_Group_Skin_Btn__Click = function(btn, str)
    if not DataModel.levelQuestIsComplete then
      local questName = PlayerData:GetFactoryData(DataModel.levelQuestId).name
      CommonTips.OpenTips(string.format(GetText(80607102), questName))
      return
  ...
  VacationActivity_Group_Join_Group_Level_Group_SignBattle_Btn_SignBattle_Click = function(btn, str)
    if not DataModel.levelQuestIsComplete then
      local questName = PlayerData:GetFactoryData(DataModel.levelQuestId).name
      CommonTips.OpenTips(string.format(GetText(80607102), questName))
      return
  ...
  VacationActivity_Group_Join_Btn_Gacha_Click = function(btn, str)
    local ca = PlayerData:GetFactoryData(DataModel.activityId)
  ...
  VacationActivity_Btn_Help_Click = function(btn, str)
    CommonTips.OpenHelp(DataModel.helpId)
  end,
  VacationActivity_Btn_Video_Click = function(btn, str)
    UIManager:Open("UI/Activity/ActivitySignBattle/SignBattleTipTeresa")
  end
}
return ViewFunction
