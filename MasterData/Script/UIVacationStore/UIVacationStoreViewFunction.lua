local View = require("UIVacationStore/UIVacationStoreView")
local DataModel = require("UIVacationStore/UIVacationStoreDataModel")
local CommonItem = require("Common/BtnItem")
local NPCDialog = require("Common/NPCDialog")
local ViewFunction = {
  VacationStore_Group_NPC_Btn_Chat_Click = function(btn, str)
    NPCDialog.SetNPCTextByEnum(View.Group_NPC, DataModel.NPCDialogEnum.talkText)
  end,
  VacationStore_Group_Right_NewScrollGrid_CommodityList_SetGrid = function(element, elementIndex)
    ...
    local color = canBuy and "#040404" or "#AF2B2B"
    Btn_Item.Group_Money.Txt_Price:SetColor(color)
  end,
  VacationStore_Group_Right_NewScrollGrid_CommodityList_Group_Item_Btn_Item_Click = function(btn, str)
  ...
  VacationStore_Group_Right_NewScrollGrid_CommodityList_Group_Item_Btn_Item_Group_Item_Btn_Item_Click = function(btn, str)
  end,
  VacationStore_Group_TopRight_Btn__Click = function(btn, str)
  end,
  VacationStore_StaticGrid_Coin_SetGrid = function(element, elementIndex)
    if not element or not elementIndex then
      return
    end
  ...
  VacationStore_StaticGrid_Coin_Group_TopRight_Btn__Click = function(btn, str)
  ...
  VacationStore_Group_CommonTopLeft_Btn_Return_Click = function(btn, str)
    UIManager:GoBack()
  end,
  VacationStore_Group_CommonTopLeft_Btn_Home_Click = function(btn, str)
    UIManager:GoHome()
  end,
  VacationStore_Group_CommonTopLeft_Btn_Menu_Click = function(btn, str)
  end,
  VacationStore_Group_CommonTopLeft_Btn_Help_Click = function(btn, str)
  end
}
return ViewFunction
