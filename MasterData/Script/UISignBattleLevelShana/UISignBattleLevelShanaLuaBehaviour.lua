...
local ViewFunction = require("UISignBattleLevelShana/UISignBattleLevelShanaViewFunction")
local Luabehaviour = {
  serialize = function()
    local params = {}
  ...
  deserialize = function(initParams)
    ...
    Net:SendProto("activity.get_cs_activity", function(json)
      ...
      if data ~= nil and data.reward == true then
        View.Img_Reward.Group_On.self:SetActive(false)
        View.Img_Reward.Group_Got.self:SetActive(true)
      else
        View.Img_Reward.Group_On.self:SetActive(true)
        View.Img_Reward.Group_Got.self:SetActive(false)
      end
