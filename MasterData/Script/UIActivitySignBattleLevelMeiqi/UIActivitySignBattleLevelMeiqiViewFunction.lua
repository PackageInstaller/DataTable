local View = require("UIActivitySignBattleLevelMeiqi/UIActivitySignBattleLevelMeiqiView")
local ActivityMainController = require("UIActivityMain/UIActivityMainController")
local DataModel = require("UIActivitySignBattleLevelMeiqi/UIActivitySignBattleLevelMeiqiDataModel")
local ViewFunction = {
  ActivitySignBattleLevelMeiqi_Group_Main_Group_Reward_Btn_Reward_Click = function(btn, str)
  ...
  ActivitySignBattleLevelMeiqi_Group_Main_Btn_Video_Click = function(btn, str)
  end,
  ActivitySignBattleLevelMeiqi_Group_Main_Btn_Start_Click = function(btn, str)
  ...
  ActivitySignBattleLevelMeiqi_Group_Main_Btn_Rank_Click = function(btn, str)
    local t = {}
    t.activityId = DataModel.activityId
    UIManager:Open("UI/Activity/ActivitySignBattle/ActivitySignBattleRanking", Json.encode(t))
  end,
  ActivitySignBattleLevelMeiqi_Group_Main_Btn_Gacha_Click = function(btn, str)
    local t = {}
