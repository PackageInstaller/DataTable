...
local ViewFunction = require("UIActivitySignBattleLevelMeiqi/UIActivitySignBattleLevelMeiqiViewFunction")
local Luabehaviour = {
  serialize = function()
  ...
  deserialize = function(initParams)
    ...
    View.Group_Main.Img_Logo:SetSprite(GetResPath(88300322))
