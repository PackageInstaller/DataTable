local View = require("UIActivityRecharge/UIActivityRechargeView")
local DataModel = require("UIActivityRecharge/UIActivityRechargeDataModel")
...
function Controller:InitView()
  if next(DataModel.rewardsList) ~= nil then
    ...
    View.Img_Title:SetSprite(GetResPath(88300273))
  end
end
...
function Controller:SetElement(element, elementIndex)
  ...
  if elementIndex < 8 then
    element.Img_Received:SetSprite(GetResPath(88300277))
    element.Img_AmountBtm:SetSprite(GetResPath(88300274))
  else
    element.Img_Received:SetSprite(GetResPath(88300278))
    element.Img_AmountBtm:SetSprite(GetResPath(88300276))
    element.Img_:SetSprite(GetResPath(88300279))
  end
end
