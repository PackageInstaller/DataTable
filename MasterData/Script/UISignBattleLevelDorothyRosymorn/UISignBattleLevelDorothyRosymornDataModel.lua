...
function DataModel:Init(id)
  ...
  DataModel.imgPath = "UI/Activity/ActivitySignBattle/Images_DorothyRosymorn/index_"
  DataModel.imgPathFinish = "UI/Activity/ActivitySignBattle/Images_DorothyRosymorn/index_"
end
