...
local Controller = require("UISignBattleLevelDorothyRosymorn/UISignBattleLevelDorothyRosymornController")
local ViewFunction = require("UISignBattleLevelDorothyRosymorn/UISignBattleLevelDorothyRosymornViewFunction")
local Luabehaviour = {
  serialize = function()
    local params = {}
