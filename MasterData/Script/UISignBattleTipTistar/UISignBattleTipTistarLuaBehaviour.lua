local View = require("UISignBattleTipTistar/UISignBattleTipTistarView")
local DataModel = require("UISignBattleTipTistar/UISignBattleTipTistarDataModel")
local ViewFunction = require("UISignBattleTipTistar/UISignBattleTipTistarViewFunction")
local Luabehaviour = {
  serialize = function()
  end,
  deserialize = function(initParams)
    ...
    View.Video_Main:Play("Video/CV_Japanese/SignBattle/PV_Tistar")
