local View = require("UIBattle_EquipmentDay/UIBattle_EquipmentDayView")
local DataModel = require("UIBattle_EquipmentDay/UIBattle_EquipmentDayDataModel")
local Controller = {}
...
function Controller:startBattle()
  ...
  local function doSquad()
    ...
    PlayerData.BattleCallBackPage = "UI/Chapter/Battle_Material/Battle_EquipmentDay"
  ...
  if not row.isEnemyLvEquilsPlayer and row.recomGrade + row.extraLevelOffset * (levelDifficulty - 1) - PlayerData:GetPlayerLevel() >= 5 then
    ...
    checkTipParam.checkTipKey = "BattleEquipmentDayTip"
