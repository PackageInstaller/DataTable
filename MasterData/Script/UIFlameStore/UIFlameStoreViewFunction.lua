local View = require("UIFlameStore/UIFlameStoreView")
local DataModel = require("UIFlameStore/UIFlameStoreDataModel")
local CommonItem = require("Common/BtnItem")
local NPCDialog = require("Common/NPCDialog")
local ViewFunction = {
  FlameStore_Group_NPC_Btn_Chat_Click = function(btn, str)
    NPCDialog.SetNPCTextByEnum(View.Group_NPC, DataModel.NPCDialogEnum.talkText)
  end,
  FlameStore_Group_Right_NewScrollGrid_CommodityList_SetGrid = function(element, elementIndex)
    ...
    local color = canBuy and "#FFFCCE" or "#FF3232"
    Btn_Item.Group_Money.Txt_Price:SetColor(color)
  end,
  FlameStore_Group_Right_NewScrollGrid_CommodityList_Group_Item_Btn_Item_Click = function(btn, str)
  ...
  FlameStore_Group_Right_NewScrollGrid_CommodityList_Group_Item_Btn_Item_Group_Item_Btn_Item_Click = function(btn, str)
  end,
  FlameStore_Group_TopRight_Btn__Click = function(btn, str)
  end,
  FlameStore_StaticGrid_Coin_SetGrid = function(element, elementIndex)
    if not element or not elementIndex then
      return
    end
  ...
  FlameStore_StaticGrid_Coin_Group_TopRight_Btn__Click = function(btn, str)
  ...
  FlameStore_Group_CommonTopLeft_Btn_Return_Click = function(btn, str)
    UIManager:GoBack()
  end,
  FlameStore_Group_CommonTopLeft_Btn_Home_Click = function(btn, str)
    UIManager:GoHome()
  end,
  FlameStore_Group_CommonTopLeft_Btn_Menu_Click = function(btn, str)
  end,
  FlameStore_Group_CommonTopLeft_Btn_Help_Click = function(btn, str)
  end
}
return ViewFunction
