...
local ViewFunction = require("UIActivitySignBattleLevelRuby/UIActivitySignBattleLevelRubyViewFunction")
local Luabehaviour = {
  serialize = function()
  ...
  deserialize = function(initParams)
    ...
    View.Group_Main.Img_Logo:SetSprite(GetResPath(88300314))
