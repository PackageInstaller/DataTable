...
local ViewFunction = {
  Battle_Material_Group_Right_Btn_Start_Click = function(btn, str)
    Controller:startBattle()
  end,
  Battle_Material_Group_CommonTopLeft_Btn_Return_Click = function(btn, str)
  ...
  Battle_Material_Group_CommonTopLeft_Btn_Home_Click = function(btn, str)
    UIManager:GoHome()
  end,
  Battle_Material_Group_CommonTopLeft_Btn_Menu_Click = function(btn, str)
  end,
  Battle_Material_Group_CommonTopLeft_Btn_Help_Click = function(btn, str)
  end,
  Battle_Material_Group_Level_StaticGrid_Level_SetGrid = function(element, elementIndex)
    Controller:SetElementDifficulty(element, elementIndex)
  end,
  Battle_Material_Group_Level_StaticGrid_Level_Group_Item_Btn_Selected_Click = function(btn, str)
    Controller:SelectDifficulty(tonumber(str))
  end,
  Battle_Material_Group_Right_Group_Reward_ScrollGrid_Item_SetGrid = function(element, elementIndex)
  ...
  Battle_Material_Group_Right_Group_Reward_ScrollGrid_Item_Group_Item_Group_Item_Btn_Item_Click = function(btn, str)
    local itemId = tonumber(str)
    CommonTips.OpenPreRewardDetailTips(itemId)
  end,
  Battle_Material_Group_Level_Group_Item_Btn_Selected_Click = function(btn, str)
  end,
  Battle_Material_Group_Right_Group_Skip_Btn_Skip_Click = function(btn, str)
    Controller:ClickSkipWin()
  end,
  Battle_Material_Group_Right_Group_Skip_Btn_Start_Click = function(btn, str)
    Controller:startBattle()
  end
}
return ViewFunction
