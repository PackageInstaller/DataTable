local View = require("UISignBattleTipHelena/UISignBattleTipHelenaView")
local DataModel = require("UISignBattleTipHelena/UISignBattleTipHelenaDataModel")
local ViewFunction = require("UISignBattleTipHelena/UISignBattleTipHelenaViewFunction")
local Luabehaviour = {
  serialize = function()
  end,
  deserialize = function(initParams)
    ...
    UIMainUIController.StopPosterGirlAudioSource()
    if GameSetting.fromRes == "CN" then
      View.Video_Main:Play("Video/SignBattle/PV_Helena")
    else
      View.Video_Main:Play("Video/CV_Japanese/SignBattle/PV_Helena")
    end
