local Team_Abyss = {
  ...
  Group_Level = {
    ...
    Group_Role = {
      self = nil,
      Group_Off = {self = nil, Img_Bg = nil},
      Group_On = {self = nil, Spine_Role = nil},
      Btn_Click = {self = nil, Txt_ = nil}
    },
    StaticGrid_Level = {
      self = nil,
      grid = {
        ...
        Group_Boss = {
          self = nil,
          Img_Mask = {self = nil, Spine_Head = nil}
        },
        Img_Bg2 = nil,
        Btn_Select = nil,
        Btn_Detail = {
        ...
        Txt_Index = nil,
        Txt_Target = nil,
        Group_Off = {self = nil, Img_Mask = nil},
        Img_Captain = nil,
        Btn_Auto = {self = nil, Txt_ = nil}
      }
    },
    Btn_Check = {
      self = nil,
