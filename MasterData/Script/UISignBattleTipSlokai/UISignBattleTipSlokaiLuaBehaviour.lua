local View = require("UISignBattleTipSlokai/UISignBattleTipSlokaiView")
local DataModel = require("UISignBattleTipSlokai/UISignBattleTipSlokaiDataModel")
local ViewFunction = require("UISignBattleTipSlokai/UISignBattleTipSlokaiViewFunction")
local Luabehaviour = {
  serialize = function()
  end,
  deserialize = function(initParams)
    ...
    View.Video_Main:Play("Video/SignBattle/PV_Slokai")
