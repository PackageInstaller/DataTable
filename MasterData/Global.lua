...
CloseCustomBename = ConfigData.game_config.closeCustomBename
...
UserMsgCenter = require("Framework.Common.Messenger").New()
MsgCenter:BindSubBroadcast(UserMsgCenter)
require("Game.GlobalConfig.UIGlobalDefine")
...
CommonUIUtil = require("Game.CommonUI.CommonUIUtil")
require("Framework.DeepLink.DeepLinkManager")
...
require("Game.WarChess.WarChessManager")
require("Game.WarChessSeason.WarChessSeasonManager")
...
require("Game.Common.GameGlobalUtil")
...
GlobalConditionListener = require("Game.Common.CheckCondition.ConditonListener.GlobalConditionListener")
PlayerClickCollectManager = require("Game.PlayerClickCollect.PlayerClickCollectManager").New()
HotResDecryptManager = require("Game.Res.HotResDecrypt.HotResDecryptManager")
