...
local ATTR_BUDDY_KEY = "ATTR_BUDDY_KEY"
...
function ui:ui_finish_load()
  ...
  self:set_button("AttrDetil", function()
    UIMgr:get_ui("char_attr_detail"):ui_show(self.v_buddy_id)
  end)
  ...
  RedPointMgr:bind_redpoint(self, self.v_uiobjects.RedCharUp, RedEnum.CHAR_UP_BTN)
  RedPointMgr:bind_redpoint(self, self.v_uiobjects.RedCharBreak, RedEnum.CHAR_BREAK_BTN)
...
function ui:ui_on_show()
  self:bind_auto_mq(Const.MSG_BUDDY_DATA_UPDATE, self.refresh_self, self)
...
function ui:refresh_self()
  self:refresh(self.v_buddy_id)
end

function ui:refresh(buddy_id)
  self.v_buddy_id = buddy_id
  local buddy_info = CharacterMgr:get_buddy_by_id(buddy_id)
  self.v_level_ui:set_enable(true, self.v_buddy_id, buddy_info)
  self.v_level_ui:refresh_level_ui(self.v_buddy_id, buddy_info)
...
function ui:update_buddy_advance_info()
  ...
  local buddy_cfg = ShareRes.create("buddy.buddy", buddy_info.id)
...
function ui:update_attr_list()
  ...
  local puzzle_add_attrs = PuzzleMgr:get_puzzle_attrs_by_data(buddy_info.puzzle_graph)
...
function ui:refresh_buddy_break_info()
  ...
  self.v_uiobjects.BtnPreview.gameObject:SetActive(false)
end
