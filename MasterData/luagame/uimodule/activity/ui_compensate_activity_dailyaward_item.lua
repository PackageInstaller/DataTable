...
function ui:set_award_item(obj, item_icon_path, item_quality_path, item_num)
  ...
  if 0 == daily_state.can_gain_day then
    item_num_txt.text = item_num * daily_state.gained_day
  else
    item_num_txt.text = item_num * daily_state.can_gain_day
  end
end
