...
function ui:ui_finish_load()
  ...
  self.v_capture_system_data = CaptureMgr:get_capture_system_data()
...
function ui:refresh()
  ...
  local rt = CaptureMgr:get_capture_rt(self.v_capture_system_data.PovID[self.v_cur_select_index])
...
function ui:on_click_delete_btn()
  ...
  CaptureMgr:remove_capture(pov_index)
  self:refresh()
end
