...
local uiData = {
  csbFile = "ui/home/ScrollShowLayer_2.csb",
  widgets = {
    center = "center",
    btn = "center/kuang",
    node = "center/node",
...
local ScrollShowLayer_2 = class("ScrollShowLayer_2", UIBase)

function ScrollShowLayer_2:ctor(params)
  UIBase.ctor(self, uiData, params)
end

function ScrollShowLayer_2:init(params)
...
function ScrollShowLayer_2:showData(params)
  self.curIndex = 1
  self.showCsv = {}
  self.funcs = {}
  self.auto = true
...
function ScrollShowLayer_2:initPanel()
...
function ScrollShowLayer_2:resumeAnimat()
...
function ScrollShowLayer_2:initSelectedPoint(dir)
  if self.max == 0 then
    return
  end
  dir = dir or 1
...
function ScrollShowLayer_2:onTouchBegan(sender)
...
function ScrollShowLayer_2:onTouchMoved(sender)
...
function ScrollShowLayer_2:onTouchEnded(sender)
  if self.max == 0 then
    return
  end
...
function ScrollShowLayer_2:onTouchCancelled(sender)
  self:onTouchEnded(sender)
end

function ScrollShowLayer_2:getKuang()
  return self.btn
end

function ScrollShowLayer_2:close()
  self.btn:stopAllActions()
end

return ScrollShowLayer_2
