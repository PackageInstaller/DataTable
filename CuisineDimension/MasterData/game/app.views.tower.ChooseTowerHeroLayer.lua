...
local ChooseTowerHeroLayer = class("ChooseTowerHeroLayer", UIBase)

function ChooseTowerHeroLayer:ctor(params)
  UIBase.ctor(self, uiData, params)
end

function ChooseTowerHeroLayer:init(params)
  ...
  self.chooseList = {}
  self.unChooseList = {}
  self.herosInfo = json.decode(game.role.towerData.herosInfo)
...
function ChooseTowerHeroLayer:refreshContent()
  ...
  for index, hero in pairs(heros) do
    ...
    elseif self.herosInfo[tostring(hero.id)] then
      table.insert(temp, 1, hero.id)
    else
      table.insert(self.heros, hero.id)
    end
  end
  for _, heroId in ipairs(temp) do
    table.insert(self.heros, 1, heroId)
  end
...
function ChooseTowerHeroLayer:loadPage(topRow, buttomRow)
...
function ChooseTowerHeroLayer:loadList(row)
...
function ChooseTowerHeroLayer:createCard(curRow, heroId, index)
  local card
  if heroId == 0 then
...
function ChooseTowerHeroLayer:choose(heroId, card)
  if not self.multiChoose then
...
function ChooseTowerHeroLayer:checkFormationSlot()
...
function ChooseTowerHeroLayer:calculateFormatSlot()
...
function ChooseTowerHeroLayer:checkFormationSameHero(heroId)
  for index, data in ipairs(self.formatList) do
...
function ChooseTowerHeroLayer:checkChangeCountFull()
...
function ChooseTowerHeroLayer:findSlotById(heroId)
  for index, data in ipairs(self.formatList) do
...
function ChooseTowerHeroLayer:setFilter(params)
  params = params or {}
