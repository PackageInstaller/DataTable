-- chunkname: @IQIGame\\UI\\UserInfo\\UserInfo_SkinView.lua
...
function SkinView:__OnCloseBtnClickHandler()
	EventDispatcher.Dispatch(EventID.ShowUserInfoSkinView, false)
end
...
function SkinView:__OnSkinDisplaySelected(skinCid)
	PlayerModule.SetKanBan(skinCid)
	EventDispatcher.Dispatch(EventID.ShowUserInfoSkinView, false, skinCid)
end
