-- chunkname: @IQIGame\\UI\\SummerActivity\\SummerActivityTaskUI_taskItem.lua

local SummerActivityTaskUI_taskItem = {}

function SummerActivityTaskUI_taskItem.New(go, mainView)
	local o = Clone(SummerActivityTaskUI_taskItem)
...
function SummerActivityTaskUI_taskItem:Initialize(go, mainView)
...
function SummerActivityTaskUI_taskItem:InitComponent()
	return
end

function SummerActivityTaskUI_taskItem:InitDelegate()
...
function SummerActivityTaskUI_taskItem:AddListener()
...
function SummerActivityTaskUI_taskItem:RemoveListener()
...
function SummerActivityTaskUI_taskItem:OnClickButtonGoTo()
	local cfgTask = CfgUtil.GetTaskCfgWithID(self.data.cid)

	JumpModule.Jump(cfgTask.JumpType)
end

function SummerActivityTaskUI_taskItem:OnClickGetBtn()
	TaskSystemModule.SubmitTask({
		self.data.cid
	})
end

function SummerActivityTaskUI_taskItem:Show()
	LuaUtility.SetGameObjectShow(self.gameObject, true)
end

function SummerActivityTaskUI_taskItem:Hide()
	LuaUtility.SetGameObjectShow(self.gameObject, false)
end

function SummerActivityTaskUI_taskItem:Refresh(Data)
	self.data = Data
	...
	LuaUtility.SetText(self.textCurrent, self.data.schedule)
	LuaUtility.SetText(self.textTotal, self.data.needSchedule)
	self:RefreshPreviewAwardData(cfgTask.ActionParam)
end

function SummerActivityTaskUI_taskItem:RefreshPreviewAwardData(ActionParam)
...
function SummerActivityTaskUI_taskItem:OnDestroy()
	self:RemoveListener()
...
return SummerActivityTaskUI_taskItem
