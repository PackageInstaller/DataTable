...
local function var_0_2(arg_4_0)
	...
	if arg_4_0:sub(#arg_4_0, #arg_4_0) == "\\" then
	...
	for iter_5_0, iter_5_1 in pairs(arg_5_0) do
		...
		for iter_5_2 = 0, var_5_0.Count - 1 do
			...
			if var_5_2 ~= nil then
				...
				local var_5_3 = string.gsub(string.sub(var_5_1, #iter_5_1 + 2, #var_5_1 - 4), "\\", ".")

				var_0_0.LuaPathToSysPath[var_5_3] = SysPath
...
;({}).InitFakeTable = function()
	...
	local function var_6_5(arg_11_0)
		var_0_0.RequireMap[arg_11_0] = var_0_0.RequireMap[arg_11_0] or var_6_1()
...
;({}).AddFileFromHUList = function()
	...
	for iter_28_0, iter_28_1 in pairs((require(var_0_0.UpdateListFile))) do
...
;({}).BuildNewCode = function(arg_30_0, arg_30_1)
	io.input(arg_30_0)
	...
	local var_30_1 = loadstring(("--[[" .. arg_30_1 .. "]] ") .. var_30_0)
	...
	if not var_30_1 then
		...
		setfenv(var_30_1, var_0_0.FakeENV)
...
;({}).Travel_G = function()
	...
	;(function(arg_33_0)
		...
		elseif type(arg_33_0) == "table" then
			var_0(debug.getmetatable(arg_33_0))
			...
			for iter_33_9, iter_33_10 in ipairs({}) do
				arg_33_0[var_0_0.ChangedFuncList[iter_33_10][2]] = arg_33_0[var_0_0.ChangedFuncList[iter_33_10][1]]
				arg_33_0[var_0_0.ChangedFuncList[iter_33_10][1]] = nil
			end
		end
	...
	local var_32_1 = debug.getregistry()
	...
	for iter_32_0, iter_32_1 in ipairs(var_0_0.ChangedFuncList) do
		for iter_32_2, iter_32_3 in pairs(var_32_1) do
			if iter_32_3 == iter_32_1[1] then
				var_32_1[iter_32_2] = iter_32_1[2]
			end
		end
	end
...
;({}).ReplaceOld = function(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4)
...
;({}).HotUpdateCode = function(arg_35_0, arg_35_1)
	if package.loaded[arg_35_0] ~= nil then
		var_0_0.VisitedSig = {}
		var_0_0.ChangedFuncList = {}

		local var_35_0, var_35_1 = var_0_0.BuildNewCode(arg_35_1, arg_35_0)

		if var_35_0 then
			var_0_0.NotifyFunc("update module " .. arg_35_0)
			var_0_0.ReplaceOld(package.loaded[arg_35_0], var_35_1, arg_35_0, "Main", "")

			for iter_35_0, iter_35_1 in pairs(var_0_0.RequireMap) do
				var_0_0.ReplaceOld(package.loaded[iter_35_0], iter_35_1, iter_35_0, "Main_require", "")
			end
...
;({}).ResetENV = function(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	local var_36_0 = {}
	...
	;(function(arg_37_0, arg_37_1)
		...
		elseif type(arg_37_0) == "table" then
			...
			for iter_37_0, iter_37_1 in pairs(arg_37_0) do
				var_0(iter_37_0, tostring(iter_37_0) .. "__key", " HU.ResetENV ", arg_36_3 .. "    ")
				var_0(iter_37_1, tostring(iter_37_0), " HU.ResetENV ", arg_36_3 .. "    ")
			end
		end
...
;({}).UpdateUpvalue = function(arg_39_0, arg_39_1, arg_39_2, arg_39_3, arg_39_4)
	var_0_0.DebugNofity(arg_39_4 .. "HU.UpdateUpvalue", arg_39_2, "  from:" .. arg_39_3)

	for iter_39_0 = 1, math.huge do
		local var_39_0, var_39_1 = debug.getupvalue(arg_39_0, iter_39_0)
	...
	for iter_39_1 = 1, math.huge do
		local var_39_2, var_39_3 = debug.getupvalue(arg_39_1, iter_39_1)
		...
		if ({})[var_39_2] then
			if type(({})[var_39_2]) ~= type(var_39_3) then
				debug.setupvalue(arg_39_1, iter_39_1, ({})[var_39_2])
			elseif type(({})[var_39_2]) == "function" then
				var_0_0.UpdateOneFunction(({})[var_39_2], var_39_3, var_39_2, nil, "HU.UpdateUpvalue", arg_39_4 .. "    ")
			elseif type(({})[var_39_2]) == "table" then
				var_0_0.UpdateAllFunction(({})[var_39_2], var_39_3, var_39_2, "HU.UpdateUpvalue", arg_39_4 .. "    ")
				debug.setupvalue(arg_39_1, iter_39_1, ({})[var_39_2])
			else
				debug.setupvalue(arg_39_1, iter_39_1, ({})[var_39_2])
			end
		else
			var_0_0.ResetENV(var_39_3, var_39_2, "HU.UpdateUpvalue", arg_39_4 .. "    ")
		end
	end

	return
end
;({}).UpdateOneFunction = function(arg_40_0, arg_40_1, arg_40_2, arg_40_3, arg_40_4, arg_40_5)
...
;({}).UpdateAllFunction = function(arg_41_0, arg_41_1, arg_41_2, arg_41_3, arg_41_4)
	...
	for iter_41_0, iter_41_1 in pairs(arg_41_1) do
		if type(iter_41_1) == type(arg_41_0[iter_41_0]) then
			if type(iter_41_1) == "function" then
				var_0_0.UpdateOneFunction(arg_41_0[iter_41_0], iter_41_1, iter_41_0, arg_41_0, "HU.UpdateAllFunction", arg_41_4 .. "    ")
			elseif type(iter_41_1) == "table" then
				var_0_0.UpdateAllFunction(arg_41_0[iter_41_0], iter_41_1, iter_41_0, "HU.UpdateAllFunction", arg_41_4 .. "    ")
			end
		elseif arg_41_0[iter_41_0] == nil and type(iter_41_1) == "function" and pcall(setfenv, iter_41_1, var_0_0.ENV) then
			arg_41_0[iter_41_0] = iter_41_1
		end
	end

	local var_41_1 = debug.getmetatable(arg_41_0)

	if type(var_41_1) == "table" and type(var_0_0.MetaMap[arg_41_1]) == "table" then
		var_0_0.UpdateAllFunction(var_41_1, var_0_0.MetaMap[arg_41_1], arg_41_2 .. "'s Meta", "HU.UpdateAllFunction", arg_41_4 .. "    ")
	end
