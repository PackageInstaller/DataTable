...
function var_0.MVC.Facade.AddDataProxy(arg_2_0, arg_2_1)
	...
	if arg_2_1.__name ~= nil then
		...
		if var_4(arg_2_1.__name) ~= "string" then
			var_2_0 = false
		else
			var_2_0 = true
		end
...
function var_0.MVC.Facade.GetProxyByName(arg_5_0, arg_5_1)
	...
	var_1_10002(var_1_10004(arg_5_1) == "string", arg_5_0.__name .. ".GetProxyByName: expect a string value")
...
function var_0.MVC.Facade.GetMediatorByName(arg_6_0, arg_6_1)
	...
	var_1_10002(var_1_10004(arg_6_1) == "string", arg_6_0.__name .. ".GetMediatorByName: expect a string value")
...
function var_0.MVC.Facade.GetCommandByName(arg_7_0, arg_7_1)
	...
	var_1_10002(var_1_10004(arg_7_1) == "string", arg_7_0.__name .. ".GetCommandByName: expect a string value")
...
function var_0.MVC.Facade.calcUpdate(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10002(arg_22_0._proxyList) do
...
function var_0.MVC.Facade.aiUpdate(arg_23_0)
	...
	var_23_1(var_23_0, var_5.GetCombatTime(var_23_2))
