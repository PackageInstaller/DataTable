...
local var_0_3 = uint64
local var_0_4 = type
local var_0_5 = require("pb")
local var_0_6 = require("wire_format")
...
function _VarintSize64(arg_3_0)
	...
	if var_0_4(arg_3_0) == "number" then
		var_3_1 = arg_3_0
	else
		var_3_1, var_3_0 = var_0_3.new(arg_3_0):tonum2()
	end
...
function _SignedVarintSize64(arg_4_0)
	...
	if var_0_4(arg_4_0) == "number" then
		var_4_2 = arg_4_0
...
function _TagSize(arg_5_0)
	return _VarintSize(var_0_6.PackTag(arg_5_0, 0))
end
	...
	return function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_2 then
			...
			return function(arg_8_0)
				...
				for iter_8_0, iter_8_1 in var_0_1(arg_8_0) do
	...
	return function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_2 then
			...
			return function(arg_13_0)
				...
				for iter_13_0, iter_13_1 in var_0_1(arg_13_0) do
		...
		elseif arg_12_1 then
			return function(arg_14_0)
				...
				for iter_14_0, iter_14_1 in var_0_1(arg_14_0) do
	...
	return function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_2 then
			...
			return function(arg_18_0)
				return #arg_18_0 * arg_16_0 + var_17_1(#arg_18_0 * arg_16_0) + var_17_0
			end
...
SInt32Sizer = _ModifiedSizer(_VarintSize, var_0_6.ZigZagEncode32)
SInt64Sizer = _ModifiedSizer(_VarintSize64, var_0_6.ZigZagEncode32)
...
function StringSizer(arg_21_0, arg_21_1, arg_21_2)
	...
	var_0_2(not arg_21_2)

	if arg_21_1 then
		return function(arg_22_0)
			local var_22_0 = var_21_0 * #arg_22_0

			for iter_22_0, iter_22_1 in var_0_1(arg_22_0) do
				var_22_0 = var_22_0 + var_21_1(#iter_22_1) + #iter_22_1
			end
		...
		return function(arg_23_0)
			return var_21_0 + var_21_1(#arg_23_0) + #arg_23_0
		end
	end
...
function BytesSizer(arg_24_0, arg_24_1, arg_24_2)
	...
	var_0_2(not arg_24_2)

	if arg_24_1 then
		return function(arg_25_0)
			local var_25_0 = var_24_0 * #arg_25_0

			for iter_25_0, iter_25_1 in var_0_1(arg_25_0) do
				var_25_0 = var_25_0 + var_24_1(#iter_25_1) + #iter_25_1
			end
		...
		return function(arg_26_0)
			return var_24_0 + var_24_1(#arg_26_0) + #arg_26_0
		end
	end
...
function MessageSizer(arg_27_0, arg_27_1, arg_27_2)
	...
	var_0_2(not arg_27_2)

	if arg_27_1 then
		return function(arg_28_0)
			local var_28_0 = var_27_0 * #arg_28_0

			for iter_28_0, iter_28_1 in var_0_1(arg_28_0) do
				local var_28_1 = iter_28_1:ByteSize()
				local var_28_2 = var_28_0 + var_27_1(var_28_1)

				var_28_0 = var_28_2 + var_28_1
			end
...
local var_0_7 = var_0_5.varint_encoder
local var_0_8 = var_0_5.signed_varint_encoder

function _VarintBytes(arg_30_0)
	local var_30_0 = {}

	var_0_8(function(arg_31_0)
		var_30_0[#var_30_0 + 1] = arg_31_0

		return
	end, arg_30_0)

	return var_0_0.concat({})
end

function TagBytes(arg_32_0, arg_32_1)
	return _VarintBytes(var_0_6.PackTag(arg_32_0, arg_32_1))
end

function _SimpleEncoder(arg_33_0, arg_33_1, arg_33_2)
	return function(arg_34_0, arg_34_1, arg_34_2)
		if arg_34_2 then
			local var_34_0 = TagBytes(arg_34_0, var_0_6.WIRETYPE_LENGTH_DELIMITED)
			local var_34_1 = var_0_7
			...
			return function(arg_35_0, arg_35_1)
				...
				for iter_35_0, iter_35_1 in var_0_1(arg_35_1) do
		...
		elseif arg_34_1 then
			...
			return function(arg_36_0, arg_36_1)
				for iter_36_0, iter_36_1 in var_0_1(arg_36_1) do
					arg_36_0(var_34_2)
...
function _ModifiedEncoder(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	return function(arg_39_0, arg_39_1, arg_39_2)
		if arg_39_2 then
			local var_39_0 = TagBytes(arg_39_0, var_0_6.WIRETYPE_LENGTH_DELIMITED)
			local var_39_1 = var_0_7
			...
			return function(arg_40_0, arg_40_1)
				...
				for iter_40_0, iter_40_1 in var_0_1(arg_40_1) do
					var_40_0 = var_40_0 + arg_38_2(arg_38_3(iter_40_1))
				end

				var_39_1(arg_40_0, var_40_0)

				for iter_40_2, iter_40_3 in var_0_1(arg_40_1) do
		...
		elseif arg_39_1 then
			...
			return function(arg_41_0, arg_41_1)
				for iter_41_0, iter_41_1 in var_0_1(arg_41_1) do
					arg_41_0(var_39_2)
...
function _StructPackEncoder(arg_43_0, arg_43_1, arg_43_2)
	return function(arg_44_0, arg_44_1, arg_44_2)
		local var_44_0 = var_0_5.struct_pack

		if arg_44_2 then
			local var_44_1 = TagBytes(arg_44_0, var_0_6.WIRETYPE_LENGTH_DELIMITED)
			local var_44_2 = var_0_7

			return function(arg_45_0, arg_45_1)
				arg_45_0(var_44_1)
				var_44_2(arg_45_0, #arg_45_1 * arg_43_1)

				for iter_45_0, iter_45_1 in var_0_1(arg_45_1) do
		...
		elseif arg_44_1 then
			...
			return function(arg_46_0, arg_46_1)
				for iter_46_0, iter_46_1 in var_0_1(arg_46_1) do
					arg_46_0(var_44_3)
...
Int32Encoder = _SimpleEncoder(var_0_6.WIRETYPE_VARINT, var_0_5.signed_varint_encoder, _SignedVarintSize)
Int64Encoder = _SimpleEncoder(var_0_6.WIRETYPE_VARINT, var_0_5.signed_varint_encoder64, _SignedVarintSize64)
EnumEncoder = Int32Encoder
UInt32Encoder = _SimpleEncoder(var_0_6.WIRETYPE_VARINT, var_0_5.varint_encoder, _VarintSize)
UInt64Encoder = _SimpleEncoder(var_0_6.WIRETYPE_VARINT, var_0_5.varint_encoder64, _VarintSize64)
SInt32Encoder = _ModifiedEncoder(var_0_6.WIRETYPE_VARINT, var_0_5.varint_encoder, _VarintSize, var_0_6.ZigZagEncode32)
SInt64Encoder = _ModifiedEncoder(var_0_6.WIRETYPE_VARINT, var_0_5.varint_encoder64, _VarintSize64, var_0_6.ZigZagEncode64)
Fixed32Encoder = _StructPackEncoder(var_0_6.WIRETYPE_FIXED32, 4, string.byte("I"))
Fixed64Encoder = _StructPackEncoder(var_0_6.WIRETYPE_FIXED64, 8, string.byte("Q"))
SFixed32Encoder = _StructPackEncoder(var_0_6.WIRETYPE_FIXED32, 4, string.byte("i"))
SFixed64Encoder = _StructPackEncoder(var_0_6.WIRETYPE_FIXED64, 8, string.byte("q"))
FloatEncoder = _StructPackEncoder(var_0_6.WIRETYPE_FIXED32, 4, string.byte("f"))
DoubleEncoder = _StructPackEncoder(var_0_6.WIRETYPE_FIXED64, 8, string.byte("d"))
...
function BoolEncoder(arg_48_0, arg_48_1, arg_48_2)
	...
	if arg_48_2 then
		local var_48_2 = TagBytes(arg_48_0, var_0_6.WIRETYPE_LENGTH_DELIMITED)
		local var_48_3 = var_0_7

		return function(arg_49_0, arg_49_1)
			arg_49_0(var_48_2)
			var_48_3(arg_49_0, #arg_49_1)

			for iter_49_0, iter_49_1 in var_0_1(arg_49_1) do
				if iter_49_1 then
					arg_49_0(var_48_1)
				else
					arg_49_0(var_48_0)
	...
	elseif arg_48_1 then
		local var_48_4 = TagBytes(arg_48_0, var_0_6.WIRETYPE_VARINT)

		return function(arg_50_0, arg_50_1)
			for iter_50_0, iter_50_1 in var_0_1(arg_50_1) do
				arg_50_0(var_48_4)
		...
		local var_48_5 = TagBytes(arg_48_0, var_0_6.WIRETYPE_VARINT)
...
function StringEncoder(arg_52_0, arg_52_1, arg_52_2)
	local var_52_0 = TagBytes(arg_52_0, var_0_6.WIRETYPE_LENGTH_DELIMITED)
	local var_52_1 = var_0_7

	var_0_2(not arg_52_2)

	if arg_52_1 then
		return function(arg_53_0, arg_53_1)
			for iter_53_0, iter_53_1 in var_0_1(arg_53_1) do
				arg_53_0(var_52_0)
...
function BytesEncoder(arg_55_0, arg_55_1, arg_55_2)
	local var_55_0 = TagBytes(arg_55_0, var_0_6.WIRETYPE_LENGTH_DELIMITED)
	local var_55_1 = var_0_7

	var_0_2(not arg_55_2)

	if arg_55_1 then
		return function(arg_56_0, arg_56_1)
			for iter_56_0, iter_56_1 in var_0_1(arg_56_1) do
				arg_56_0(var_55_0)
...
function MessageEncoder(arg_58_0, arg_58_1, arg_58_2)
	local var_58_0 = TagBytes(arg_58_0, var_0_6.WIRETYPE_LENGTH_DELIMITED)
	local var_58_1 = var_0_7

	var_0_2(not arg_58_2)

	if arg_58_1 then
		return function(arg_59_0, arg_59_1)
			for iter_59_0, iter_59_1 in var_0_1(arg_59_1) do
				arg_59_0(var_58_0)
