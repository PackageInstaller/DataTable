...
local var_0_1 = var_0_10007("wire_format")
	...
	return function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_2 then
			...
			return function(arg_8_0)
				...
				return var_8_0 + var_2_10004(var_8_0) + var_7_0
			end
		elseif arg_7_1 then
	...
	return function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_2 then
			...
			return function(arg_13_0)
				...
				return var_13_0 + var_2_10004(var_13_0) + var_12_0
			end
	...
	return function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_2 then
			...
			return function(arg_18_0)
				return #arg_18_0 * arg_16_0 + var_2_10004(var_1) + var_17_0
			end
...
_SignedVarintSize = var_10

local var_0_17 = var_8(var_10)

_SimpleSizer = Int32Sizer
_SignedVarintSize64 = var_10

local var_0_18 = var_8(var_10)

Int32Sizer = Int64Sizer
_SimpleSizer = EnumSizer
_VarintSize = var_10

local var_0_19 = var_8(var_10)

_SimpleSizer = UInt32Sizer
_VarintSize64 = var_10

local var_0_20 = var_8(var_10)

_ModifiedSizer = UInt64Sizer
_VarintSize = var_10

local var_0_21 = var_8(var_10, var_0_1.ZigZagEncode32)

_ModifiedSizer = SInt32Sizer
_VarintSize64 = var_10

local var_0_22 = var_8(var_10, var_0_1.ZigZagEncode32)
	...
	if arg_21_1 then
		return function(arg_22_0)
			...
			for iter_22_0, iter_22_1 in var_0_10002(arg_22_0) do
				...
				var_22_0 = var_22_0 + var_1_10004(var_22_1) + var_22_1
			end
		...
		return function(arg_23_0)
			...
			return var_21_0 + var_1_10004(var_23_0) + var_23_0
		end
	end
	...
	if arg_24_1 then
		return function(arg_25_0)
			...
			for iter_25_0, iter_25_1 in var_0_10002(arg_25_0) do
				...
				var_25_0 = var_25_0 + var_1_10004(var_25_1) + var_25_1
			end
		...
		return function(arg_26_0)
			...
			return var_24_0 + var_1_10004(var_26_0) + var_26_0
		end
	end
	...
	if arg_27_1 then
		return function(arg_28_0)
			...
			for iter_28_0, iter_28_1 in var_0_10002(arg_28_0) do
				...
				var_28_0 = var_28_0 + var_1_10004(var_28_1) + var_28_1
			end
		...
		return function(arg_29_0)
			...
			return var_27_0 + var_1_10004(var_29_0) + var_29_0
		end
	end
...
_SignedVarintSize = var_0_10016

local var_0_48 = var_12(var_0_46, var_0_47, var_0_10016)
...
_SignedVarintSize64 = var_0_10016

local var_0_51 = var_12(var_0_49, var_0_50, var_0_10016)
...
_VarintSize = var_0_10016

local var_0_54 = var_12(var_0_52, var_0_53, var_0_10016)
...
_VarintSize64 = var_0_10016

local var_0_57 = var_12(var_0_55, var_0_56, var_0_10016)
...
local var_0_60 = var_12(var_0_58, var_0_59, var_0_10016, var_0_1.ZigZagEncode32)
...
local var_0_63 = var_12(var_0_61, var_0_62, var_0_10016, var_0_1.ZigZagEncode64)
