...
function print_r(arg_10_0)
	if var_0_4(arg_10_0) ~= "table" then
		var_0_0("root is not table")
	...
	var_0_0((function(arg_11_0, arg_11_1, arg_11_2)
		for iter_11_0, iter_11_1 in var_0_5(arg_11_0) do
			local var_11_0 = var_0_6(iter_11_0)

			if var_10_0[iter_11_1] then
				var_0_2({}, "+" .. var_11_0 .. " {" .. var_10_0[iter_11_1] .. "}")
			elseif var_0_4(iter_11_1) == "table" then
				local var_11_1 = arg_11_2 .. "." .. var_11_0

				var_10_0[iter_11_1] = arg_11_2 .. "." .. var_11_0

				var_0_2({}, "+" .. var_11_0 .. var_0(iter_11_1, arg_11_1 .. (var_0_7(arg_11_0, iter_11_0) and "|" or " ") .. var_0_3(" ", #var_11_0), var_11_1))
			else
				var_0_2({}, "+" .. var_11_0 .. " [" .. var_0_6(iter_11_1) .. "]")
			end
		end
