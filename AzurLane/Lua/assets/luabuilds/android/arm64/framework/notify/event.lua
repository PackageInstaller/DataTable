		...
		for iter_9_1 in var_6.get_iterator(var_9_1) do
			...
			if iter_9_0.blocked_handlers[iter_9_1] == 0 then
				if arg_9_1.accumulator then
					...
					local var_9_4 = arg_9_1.event_name

					unpackEx = var_1_10015

					var_9_2(var_9_3(var_9_4, var_1_10015(arg_9_1.args)))
				else
					local var_9_5 = iter_9_1
					local var_9_6 = arg_9_1.event_name

					unpackEx = var_1_10013

					var_9_5(var_9_6, var_1_10013(arg_9_1.args))
				end
			end
		end
	end
