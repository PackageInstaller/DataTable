...
local var_0_1 = var_0_10001("StateMachine", var_0_0)
...
function var_0_1.onRegister(arg_2_0)
	if arg_2_0.initial ~= nil then
		...
		var_2_1(var_2_0, var_2_2, var_1_10005)
	end
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	if arg_8_1:getName() == var_0_1.ACTION then
		...
		local var_8_1 = arg_8_1.getType(var_8_0)
		local var_8_2 = arg_8_0:getCurrentState()

		if var_4.getTarget(var_8_2, var_8_1) ~= nil then
			if arg_8_0.states[var_4] ~= nil then
				arg_8_0:transitionTo(var_8_0, arg_8_1:getBody())
			else
				print = var_8_2

				var_8_2("state not found, target: " .. var_4)
			end
		else
			print = var_8_0

			var_8_0("target not found, action: " .. var_8_1)
		end
