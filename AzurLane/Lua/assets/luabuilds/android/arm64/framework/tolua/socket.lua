...
function var_0_3.connect4(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	return var_0.connect(arg_1_0, arg_1_1, arg_1_2, arg_1_3, "inet")
end

function var_0_3.connect6(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	return var_0.connect(arg_2_0, arg_2_1, arg_2_2, arg_2_3, "inet6")
end

function var_0_3.bind(arg_3_0, arg_3_1, arg_3_2)
	if arg_3_0 == "*" then
		arg_3_0 = "0.0.0.0"
	end
...
var_0_3.try = var_0_3.newtry()

function var_0_3.choose(arg_4_0)
...
;({})["close-when-done"] = function(arg_6_0)
...
;({}).default = ({})["keep-open"]
var_0_3.sink = var_0_3.choose({})
;({})["by-length"] = function(arg_14_0, arg_14_1)
	return var_0_0.setmetatable({
		getfd = function()
		...
		__call = function()
			...
			local var_17_0, var_17_1 = arg_14_0:receive((var_0_2.min(var_0.BLOCKSIZE, arg_14_1)))

			if var_17_1 then
				return nil, var_17_1
			end

			arg_14_1 = arg_14_1 - var_0_1.len(var_17_0)

			return var_17_0
		end
	})
end
;({})["until-closed"] = function(arg_18_0)
	local var_18_0
	...
	return var_0_0.setmetatable({
		...
		__call = function()
			...
			local var_21_0, var_21_1, var_21_2 = arg_18_0:receive(var_0.BLOCKSIZE)
