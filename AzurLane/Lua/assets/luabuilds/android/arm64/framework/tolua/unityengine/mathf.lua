...
function Mathf.SmoothDamp(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4, arg_16_5)
	...
	local var_16_1 = var_0_3.Clamp(arg_16_0 - arg_16_1, -(arg_16_4 * arg_16_3), arg_16_4 * arg_16_3)

	arg_16_1 = arg_16_0 - var_16_1

	local var_16_2 = (arg_16_2 + 2 / arg_16_3 * var_16_1) * arg_16_5

	arg_16_2 = (arg_16_2 - 2 / arg_16_3 * ((arg_16_2 + 2 / arg_16_3 * var_16_1) * arg_16_5)) * (1 / (1 + 2 / arg_16_3 * arg_16_5 + 0.48 * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5) + 0.235 * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5)))

	local var_16_3 = arg_16_0 - var_16_1 + (var_16_1 + var_16_2) * (1 / (1 + 2 / arg_16_3 * arg_16_5 + 0.48 * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5) + 0.235 * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5)))

	if arg_16_0 < arg_16_1 == (arg_16_1 < arg_16_0 - var_16_1 + (var_16_1 + var_16_2) * (1 / (1 + 2 / arg_16_3 * arg_16_5 + 0.48 * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5) + 0.235 * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5) * (2 / arg_16_3 * arg_16_5)))) then
		var_16_3 = var_16_0
		arg_16_2 = (var_16_0 - var_16_0) / arg_16_5
	end
...
function Mathf.HorizontalAngle(arg_19_0)
...
function Mathf.MultiRandom(arg_21_0, arg_21_1)
	for iter_21_0, iter_21_1 in ipairs(arg_21_0) do
		table.insert({}, iter_21_0)
	end

	arg_21_1 = var_0_0.min(#arg_21_0, arg_21_1)

	while arg_21_1 > 0 do
		table.insert({}, arg_21_0[table.remove({}, (var_0_0.random(#{})))])
