...
local function var_0_3(arg_2_0, arg_2_1, arg_2_2)
	...
	elseif var_2_3 < 0 then
		...
		for iter_2_1, iter_2_2 in var_9(arg_2_0) do
			...
			var_1_10014(var_2_6, var_17.format(var_2_7, var_0_2(iter_2_1, var_2_2, arg_2_2), var_0_2(iter_2_2, var_2_2, arg_2_2)))
		...
		if var_3(arg_3_0) ~= "number" then
			...
			if var_3(arg_3_0) == "boolean" then
				...
				if var_3(arg_3_0) == "table" then
					...
					return var_3_1 .. var_1_10004(arg_3_0) .. ">\""
				end
			end
...
local function var_0_4(arg_4_0)
	...
	if arg_4_0 == nil then
		...
		var_1_10003, var_4_2 = var_1_10003.open(arg_4_0, "rb")
		...
		if var_1_10003 == nil then
			...
			local var_4_4 = "Unable to read '%s': %s"

			var_1_10003(var_5.format(var_4_4, arg_4_0, var_4_3))
		end
	end

	local var_4_5 = var_4_0:read("*a")
	...
	if var_4_5 == nil then
		...
		var_1_10003("Failed to read " .. arg_4_0)
	end
...
local function var_0_5(arg_5_0, arg_5_1)
	...
	if arg_5_0 == nil then
		...
		if var_5_2 == nil then
			...
			var_5_2(var_6.format(var_5_5, arg_5_0, var_5_4))
		end
	end
...
local function var_0_6(arg_6_0, arg_6_1)
	...
	if var_6_0 ~= var_1_10003(arg_6_1) then
		return false
	end
	...
	for iter_6_0, iter_6_1 in var_5(arg_6_0) do
...
local function var_0_10(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	local function var_8_0(arg_9_0, arg_9_1, arg_9_2)
		...
		var_2_10004(var_6.format(var_9_1, arg_9_0, var_0_2(arg_9_2, false)))
	...
	unpack = var_1_10010
	var_8_1[1] = var_1_10007(var_8_2, var_1_10010(arg_8_2))
	table = var_7
	...
	var_10(var_12.format(var_8_6, var_0_8, arg_8_0, var_8_5[var_8_4]))
...
local function var_0_11(arg_10_0)
	local function var_10_0(arg_11_0, arg_11_1, arg_11_2)
		...
		if var_2_10003(arg_11_0) == "string" and #arg_11_0 > 0 then
			print = var_3
	...
	for iter_10_0, iter_10_1 in var_1_10002(arg_10_0) do
		if iter_10_1[4] == nil then
			...
			var_10_1(var_1_10009(iter_10_1))
		else
			local var_10_2 = var_0_10

			unpack = var_1_10009

			var_10_2(var_1_10009(iter_10_1))
		end
	end
