...
;({
	...
	var_1_0(var_4.check(var_1_1, "2.."))

	local var_1_2 = arg_1_0.try
	local var_1_3 = arg_1_0.tp

	var_1_2(var_4.command(var_1_3, "EHLO", arg_1_1 or var_0_9.DOMAIN))
	...
	return var_1_4(var_1_5, var_1_6(var_7.check(var_1_7, "2..")))
end
...
function var_11.__index.mail(arg_2_0, arg_2_1)
	...
	var_2_0(var_4.command(var_2_1, "MAIL", "FROM:" .. arg_2_1))

	local var_2_2 = arg_2_0.try
	local var_2_3 = arg_2_0.tp

	return var_2_2(var_4.check(var_2_3, "2.."))
end
...
function var_11.__index.rcpt(arg_3_0, arg_3_1)
	...
	var_3_0(var_4.command(var_3_1, "RCPT", "TO:" .. arg_3_1))

	local var_3_2 = arg_3_0.try
	local var_3_3 = arg_3_0.tp

	return var_3_2(var_4.check(var_3_3, "2.."))
end
...
function var_11.__index.quit(arg_5_0)
	...
	var_5_0(var_3.command(var_5_1, "QUIT"))

	local var_5_2 = arg_5_0.try
	local var_5_3 = arg_5_0.tp

	return var_5_2(var_3.check(var_5_3, "2.."))
end
...
function var_11.__index.plain(arg_8_0, arg_8_1, arg_8_2)
	...
	var_8_1(var_6.command(var_8_2, "AUTH", var_8_0))

	local var_8_3 = arg_8_0.try
	local var_8_4 = arg_8_0.tp

	return var_8_3(var_6.check(var_8_4, "2.."))
end
