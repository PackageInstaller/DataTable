...
function string.split(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in function()
		...
		var_0_2.insert({}, var_0_1.sub(arg_1_0, var_1_0, iter_1_0 - 1))

		var_1_0 = iter_1_1 + 1
	end

	var_0_2.insert({}, var_0_1.sub(arg_1_0, var_1_0))
...
function import(arg_3_0, arg_3_1)
	...
	while true do
		if var_0_1.byte(arg_3_0, 1) ~= 46 then
			var_3_1 = var_0_1.sub(arg_3_0, 1)
...
function reimport(arg_4_0)
	package.loaded[arg_4_0] = nil
	package.preload[arg_4_0] = nil
