...
local var_0_3 = TouchBits
local var_0_4 = {}
local var_0_5 = tolua.initget({})

;({}).__index = function(arg_1_0, arg_1_1)
	local var_1_0 = var_0_1(var_0_4, arg_1_1)

	if var_1_0 == nil then
		var_1_0 = var_0_1(var_0_5, arg_1_1)
...
;({}).New = function(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5, arg_2_6)
	return var_0_2({
...
;({}).Init = function(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5, arg_3_6, arg_3_7)
...
;({}).GetMask = function(...)
	...
	for iter_5_0 = 1, #var_5_0 do
		local var_5_2 = var_0_3[var_5_0[iter_5_0]] or 0
