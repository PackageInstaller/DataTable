...
local var_0_3 = require("pb")
local var_0_4 = require("protobuf.wire_format")
...
function _TagSize(arg_3_0)
	return _VarintSize(var_0_4.PackTag(arg_3_0, 0))
end
	...
	return function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_2 then
			...
			return function(arg_11_0)
				...
				for iter_11_0, iter_11_1 in var_0_1(arg_11_0) do
		...
		elseif arg_10_1 then
			return function(arg_12_0)
				...
				for iter_12_0, iter_12_1 in var_0_1(arg_12_0) do
	...
	return function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_2 then
			...
			return function(arg_16_0)
				return #arg_16_0 * arg_14_0 + var_15_1(#arg_16_0 * arg_14_0) + var_15_0
			end
...
Int64Sizer = _SimpleSizer(var_0_3.signed_varint_size)
EnumSizer = Int32Sizer
UInt32Sizer = _SimpleSizer(_VarintSize)
UInt64Sizer = _SimpleSizer(var_0_3.varint_size)
SInt32Sizer = _ModifiedSizer(_SignedVarintSize, var_0_4.ZigZagEncode32)
...
function StringSizer(arg_19_0, arg_19_1, arg_19_2)
	...
	var_0_2(not arg_19_2)

	if arg_19_1 then
		return function(arg_20_0)
			local var_20_0 = var_19_0 * #arg_20_0

			for iter_20_0, iter_20_1 in var_0_1(arg_20_0) do
				var_20_0 = var_20_0 + var_19_1(#iter_20_1) + #iter_20_1
			end
		...
		return function(arg_21_0)
			return var_19_0 + var_19_1(#arg_21_0) + #arg_21_0
		end
	end
...
function BytesSizer(arg_22_0, arg_22_1, arg_22_2)
	...
	var_0_2(not arg_22_2)

	if arg_22_1 then
		return function(arg_23_0)
			local var_23_0 = var_22_0 * #arg_23_0

			for iter_23_0, iter_23_1 in var_0_1(arg_23_0) do
				var_23_0 = var_23_0 + var_22_1(#iter_23_1) + #iter_23_1
			end
		...
		return function(arg_24_0)
			return var_22_0 + var_22_1(#arg_24_0) + #arg_24_0
		end
	end
...
function MessageSizer(arg_25_0, arg_25_1, arg_25_2)
	...
	var_0_2(not arg_25_2)

	if arg_25_1 then
		return function(arg_26_0)
			local var_26_0 = var_25_0 * #arg_26_0

			for iter_26_0, iter_26_1 in var_0_1(arg_26_0) do
				local var_26_1 = iter_26_1:ByteSize()
				local var_26_2 = var_26_0 + var_25_1(var_26_1)

				var_26_0 = var_26_2 + var_26_1
			end
...
local var_0_5 = var_0_3.varint_encoder
local var_0_6 = var_0_3.signed_varint_encoder

function _VarintBytes(arg_28_0)
	local var_28_0 = {}

	var_0_6(function(arg_29_0)
...
function TagBytes(arg_30_0, arg_30_1)
	return _VarintBytes(var_0_4.PackTag(arg_30_0, arg_30_1))
end

function _SimpleEncoder(arg_31_0, arg_31_1, arg_31_2)
	return function(arg_32_0, arg_32_1, arg_32_2)
		if arg_32_2 then
			local var_32_0 = TagBytes(arg_32_0, var_0_4.WIRETYPE_LENGTH_DELIMITED)
			local var_32_1 = var_0_5
			...
			return function(arg_33_0, arg_33_1)
				...
				for iter_33_0, iter_33_1 in var_0_1(arg_33_1) do
		...
		elseif arg_32_1 then
			...
			return function(arg_34_0, arg_34_1)
				for iter_34_0, iter_34_1 in var_0_1(arg_34_1) do
					arg_34_0(var_32_2)
...
function _ModifiedEncoder(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	return function(arg_37_0, arg_37_1, arg_37_2)
		if arg_37_2 then
			local var_37_0 = TagBytes(arg_37_0, var_0_4.WIRETYPE_LENGTH_DELIMITED)
			local var_37_1 = var_0_5
			...
			return function(arg_38_0, arg_38_1)
				...
				for iter_38_0, iter_38_1 in var_0_1(arg_38_1) do
					var_38_0 = var_38_0 + arg_36_2(arg_36_3(iter_38_1))
				end

				var_37_1(arg_38_0, var_38_0)

				for iter_38_2, iter_38_3 in var_0_1(arg_38_1) do
		...
		elseif arg_37_1 then
			...
			return function(arg_39_0, arg_39_1)
				for iter_39_0, iter_39_1 in var_0_1(arg_39_1) do
					arg_39_0(var_37_2)
...
function _StructPackEncoder(arg_41_0, arg_41_1, arg_41_2)
	return function(arg_42_0, arg_42_1, arg_42_2)
		local var_42_0 = var_0_3.struct_pack

		if arg_42_2 then
			local var_42_1 = TagBytes(arg_42_0, var_0_4.WIRETYPE_LENGTH_DELIMITED)
			local var_42_2 = var_0_5

			return function(arg_43_0, arg_43_1)
				arg_43_0(var_42_1)
				var_42_2(arg_43_0, #arg_43_1 * arg_41_1)

				for iter_43_0, iter_43_1 in var_0_1(arg_43_1) do
		...
		elseif arg_42_1 then
			...
			return function(arg_44_0, arg_44_1)
				for iter_44_0, iter_44_1 in var_0_1(arg_44_1) do
					arg_44_0(var_42_3)
...
Int32Encoder = _SimpleEncoder(var_0_4.WIRETYPE_VARINT, var_0_3.signed_varint_encoder, _SignedVarintSize)
Int64Encoder = _SimpleEncoder(var_0_4.WIRETYPE_VARINT, var_0_3.signed_varint_encoder64, _SignedVarintSize)
EnumEncoder = Int32Encoder
UInt32Encoder = _SimpleEncoder(var_0_4.WIRETYPE_VARINT, var_0_3.varint_encoder, _VarintSize)
UInt64Encoder = _SimpleEncoder(var_0_4.WIRETYPE_VARINT, var_0_3.varint_encoder64, _VarintSize)
SInt32Encoder = _ModifiedEncoder(var_0_4.WIRETYPE_VARINT, var_0_3.varint_encoder, _VarintSize, var_0_4.ZigZagEncode32)
SInt64Encoder = _ModifiedEncoder(var_0_4.WIRETYPE_VARINT, var_0_3.varint_encoder64, _VarintSize, var_0_4.ZigZagEncode64)
Fixed32Encoder = _StructPackEncoder(var_0_4.WIRETYPE_FIXED32, 4, string.byte("I"))
Fixed64Encoder = _StructPackEncoder(var_0_4.WIRETYPE_FIXED64, 8, string.byte("Q"))
SFixed32Encoder = _StructPackEncoder(var_0_4.WIRETYPE_FIXED32, 4, string.byte("i"))
SFixed64Encoder = _StructPackEncoder(var_0_4.WIRETYPE_FIXED64, 8, string.byte("q"))
FloatEncoder = _StructPackEncoder(var_0_4.WIRETYPE_FIXED32, 4, string.byte("f"))
DoubleEncoder = _StructPackEncoder(var_0_4.WIRETYPE_FIXED64, 8, string.byte("d"))
...
function BoolEncoder(arg_46_0, arg_46_1, arg_46_2)
	...
	if arg_46_2 then
		local var_46_2 = TagBytes(arg_46_0, var_0_4.WIRETYPE_LENGTH_DELIMITED)
		local var_46_3 = var_0_5

		return function(arg_47_0, arg_47_1)
			arg_47_0(var_46_2)
			var_46_3(arg_47_0, #arg_47_1)

			for iter_47_0, iter_47_1 in var_0_1(arg_47_1) do
				if iter_47_1 then
					arg_47_0(var_46_1)
				else
					arg_47_0(var_46_0)
	...
	elseif arg_46_1 then
		local var_46_4 = TagBytes(arg_46_0, var_0_4.WIRETYPE_VARINT)

		return function(arg_48_0, arg_48_1)
			for iter_48_0, iter_48_1 in var_0_1(arg_48_1) do
				arg_48_0(var_46_4)
		...
		local var_46_5 = TagBytes(arg_46_0, var_0_4.WIRETYPE_VARINT)
...
function StringEncoder(arg_50_0, arg_50_1, arg_50_2)
	local var_50_0 = TagBytes(arg_50_0, var_0_4.WIRETYPE_LENGTH_DELIMITED)
	local var_50_1 = var_0_5

	var_0_2(not arg_50_2)

	if arg_50_1 then
		return function(arg_51_0, arg_51_1)
			for iter_51_0, iter_51_1 in var_0_1(arg_51_1) do
				arg_51_0(var_50_0)
...
function BytesEncoder(arg_53_0, arg_53_1, arg_53_2)
	local var_53_0 = TagBytes(arg_53_0, var_0_4.WIRETYPE_LENGTH_DELIMITED)
	local var_53_1 = var_0_5

	var_0_2(not arg_53_2)

	if arg_53_1 then
		return function(arg_54_0, arg_54_1)
			for iter_54_0, iter_54_1 in var_0_1(arg_54_1) do
				arg_54_0(var_53_0)
...
function MessageEncoder(arg_56_0, arg_56_1, arg_56_2)
	local var_56_0 = TagBytes(arg_56_0, var_0_4.WIRETYPE_LENGTH_DELIMITED)
	local var_56_1 = var_0_5

	var_0_2(not arg_56_2)

	if arg_56_1 then
		return function(arg_57_0, arg_57_1)
			for iter_57_0, iter_57_1 in var_0_1(arg_57_1) do
				arg_57_0(var_56_0)
