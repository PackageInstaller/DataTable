...
function var_0_1.GenCommodity(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	local var_5_2 = arg_5_0.getConfig(var_5_1, "shop_id")
	local var_5_3 = var_0_4(var_5_0)

	Goods = var_5_1

	local var_5_4 = var_5_1.Create({
		id = var_5_2
	}, var_5_3)
	local var_5_5 = var_0_5(var_5_0, arg_5_0:getConfig("shop_id"), arg_5_1, arg_5_2)

	var_5_4:updateBuyCount(var_5_5)

	if not var_5_4:isChargeType() then
		local var_5_6 = var_0_6(var_5_0, var_5_4:getConfig("group"), arg_5_3)

		var_5_4:updateGroupCount(var_5_6)
	end
...
function var_0_1.InTime(arg_13_0)
	...
	return var_2.inTime(var_13_1, var_13_0)
end
...
function var_0_1.IsMonthCardAndCantPurchase(arg_19_0)
	...
	if arg_19_0.IsMonthCard(var_19_0) then
		...
		if var_19_3(var_19_2, var_1_10005.MONTH) then
