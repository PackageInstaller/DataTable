...
function var_0_1.InitLevelConfig(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1(var_1_10003.activity_mall_level.all) do
		pg = var_1_10006
...
function var_0_1.GetUnlockStoryIds(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_1_10003(arg_7_0:GetReachLevelIds()) do
		local var_7_2 = var_7_1[iter_7_1].unlock_param

		table = var_1_10009
		var_7_0 = var_1_10009.mergeArray(var_7_0, var_7_2.story_id, true)
	end
...
function var_0_1.GetIdByLevel(arg_10_0)
	...
	return var_10_0(var_1_10003.activity_mall_level.all, function(arg_11_0)
		pg = var_2_10001
