...
function var_0_1.Ctor(arg_7_0, arg_7_1)
	...
	if arg_7_0.getConfig(var_7_1, "skin_type") == var_0_1.SKIN_TYPE_TB then
		NewEducateHelper = var_2

		local var_7_2 = var_2.GetShipNameBySecId

		NewEducateHelper = var_7_1
		arg_7_0.shipName = var_7_2(var_7_1.GetSecIdBySkinId(arg_7_0.id))
	else
		local var_7_3 = arg_7_0:getConfig("ship_group")

		ShipGroup = var_3

		local var_7_4

		if not var_3.getDefaultShipConfig(var_7_3) or not var_3.name then
			var_7_4 = ""
		end
...
function var_0_1.getRemainTime(arg_12_0)
	local var_12_0 = arg_12_0:getExpireTime()
...
function var_0_1.IsMatchKey(arg_17_0, arg_17_1)
	...
	string = var_1_10004
	arg_17_1 = var_17_0(var_1_10004.gsub(arg_17_1, "%.", "%%."))
	string = var_2

	local var_17_1 = var_2.lower

	string = var_4
	arg_17_1 = var_17_1(var_4.gsub(arg_17_1, "%-", "%%-"))
	string = var_2
	...
	if not var_17_2(var_4.lower(arg_17_0.shipName), arg_17_1) then
		string = var_17_3
		var_17_3 = var_17_3.find
		string = var_4
		var_17_3 = var_17_3(var_4.lower(arg_17_0.skinName), arg_17_1)
	end
...
function var_0_1.ToShip(arg_18_0)
	...
	if var_1_10002.getDefaultShipConfig(var_18_1) then
		Ship = var_18_0
...
function var_0_1.GetDefaultShipConfig(arg_19_0)
	...
	return (var_1_10002.getDefaultShipConfig(var_19_0))
end
...
function var_0_1.CantUse(arg_28_0)
	...
	local var_28_2 = arg_28_0.IsProposeSkin(var_28_1)
	local var_28_3 = arg_28_0
	local var_28_4 = arg_28_0.getConfig(var_28_3, "ship_group")

	getProxy = var_28_1
	BayProxy = var_6

	local var_28_5 = var_28_1(var_6)
	local var_28_6 = var_4._ExistGroupShip(var_28_5, var_28_4, var_28_0, var_28_2)

	getProxy = var_28_3
	CollectionProxy = var_7

	local var_28_7 = var_28_3(var_7).shipGroups[var_28_4] == nil

	return not var_28_6 or var_28_7
end

function var_0_1.OwnShip(arg_29_0)
	local var_29_0 = arg_29_0:IsTransSkin()
	local var_29_1 = arg_29_0
	local var_29_2 = arg_29_0.IsProposeSkin(var_29_1)
	local var_29_3 = arg_29_0:getConfig("ship_group")

	getProxy = var_29_1
	BayProxy = var_6

	local var_29_4 = var_29_1(var_6)

	return (var_4._ExistGroupShip(var_29_4, var_29_3, var_29_0, var_29_2))
end
...
function var_0_1.ExistShip(arg_34_0)
	...
	local var_34_2 = var_1_10002.ship_data_statistics

	tonumber = var_34_0

	return var_34_2[var_34_0(var_34_1 .. 1)] ~= nil
end
...
function var_0_1.CanShare(arg_40_0)
	...
	local function var_40_3()
		...
		local var_42_2 = var_2_10001(var_3)
		local var_42_3 = var_1.getRawData(var_42_2)

		pairs = var_42_0

		for iter_42_0, iter_42_1 in var_42_0(var_42_3) do
...
function var_0_1.CanUseShareSkinForShip(arg_45_0, arg_45_1)
	...
	local var_45_1 = var_1_10003.New({
		id = arg_45_1
	})
	local var_45_2 = false
	local var_45_3 = var_45_1
	local var_45_4 = var_45_1.CanShare(var_45_3)
	local var_45_5 = var_45_1:IsProposeSkin()

	if var_45_4 and var_45_5 and arg_45_0.propose then
		var_45_2 = true
	elseif var_45_4 and not var_45_5 then
		math = var_45_3
		var_45_2 = var_45_3.floor(arg_45_0:getIntimacy() / 100) >= arg_45_0:GetNoProposeIntimacyMax()
	end
...
function var_0_1.GetRewardList(arg_47_0)
	...
	if not arg_47_0.ExistReward(var_47_0) then
		return {}
	end

	pg = var_1

	local var_47_1 = var_1.ship_skin_reward[arg_47_0.configId]
	local var_47_2 = {}

	pairs = var_47_0

	for iter_47_0, iter_47_1 in var_47_0(var_47_1.reward) do
		table = var_1_10008

		var_1_10008.insert(var_47_2, {
			type = iter_47_1[1],
			id = iter_47_1[2],
			count = iter_47_1[3]
		})
...
function var_0_1.GetShareGroupIds(arg_50_0)
	...
	if not var_1_10002.ship_data_group.get_id_list_by_group_type[var_50_0] or not var_2[1] then
		var_50_1 = nil
	end
	...
	local var_50_3 = var_1_10005.to_array
	...
	if var_50_1 then
		...
		if not var_1_10007.ship_data_group[var_50_1].share_group_id then
			var_50_4 = {}
		end
...
function var_0_1.GetAllChangeSkinIds(arg_51_0)
	...
	for iter_51_0 = 1, 10 do
		...
		if not var_1_10009.contains(var_51_1, var_51_3) then
			table = var_1_10009

			var_1_10009.insert(var_51_1, var_51_3)
		end
...
function var_0_1.GetStoreChangeSkinId(arg_62_0, arg_62_1)
	...
	if var_1_10005.GetInt(var_62_2, 0) == 0 then
		return nil
	else
		return var_5
	end
...
function var_0_1.SetStoreChangeSkinId(arg_63_0, arg_63_1)
	...
	ShipPhantom = var_1_10003

	local var_63_1, var_63_2 = var_1_10003.UnpackMark(arg_63_1)
...
function var_0_1.GetStoreChangeSkinPrefsName(...)
	...
	return var_64_0(var_64_1, var_1_10003.concat({
		...
	}, "_"))
end
