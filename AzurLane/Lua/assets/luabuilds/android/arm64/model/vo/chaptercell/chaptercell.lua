...
function var_0_1.GetWeatherFlagList(arg_4_0)
	...
	local var_4_0 = var_1_10001.filter
	local var_4_1 = arg_4_0
	local var_4_2 = var_4_0(arg_4_0.GetFlagList(var_4_1), function(arg_5_0)
		tobool = var_2_10001
		pg = var_2_10003

		return var_2_10001(var_2_10003.weather_data_template[arg_5_0])
	end)

	if not arg_4_0:IsVisible() then
		table = var_2

		local var_4_3 = var_2.insert
		local var_4_4 = var_4_2

		ChapterConst = var_4_1

		var_4_3(var_4_4, var_4_1.FlagWeatherFogVisible)
	end
...
function var_0_1.LineAround(arg_12_0, arg_12_1, arg_12_2)
	...
	for iter_12_0 = -arg_12_2, arg_12_2 do
		for iter_12_1 = -arg_12_2, arg_12_2 do
			...
			if var_1_10012 + var_1_10013.abs(iter_12_1) <= arg_12_2 then
				table = var_1_10012
		...
		if arg_13_1 then
			...
			if false then
				...
				if var_13_0(arg_13_1) == "number" then
					...
					arg_13_0.forbiddenDirections = var_13_1(var_13_2, var_1_10005.ForbiddenAll)
				end
			end
...
function var_0_1.UpdateVisible(arg_16_0, arg_16_1, arg_16_2)
	...
	if arg_16_2 then
		...
		var_1_10004.insert(arg_16_0.visible, arg_16_1)
	else
		table = var_1_10004

		var_1_10004.removebyvalue(arg_16_0.visible, arg_16_1)
	end
