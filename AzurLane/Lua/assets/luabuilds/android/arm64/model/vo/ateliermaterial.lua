...
function var_0_1.GetBuffs(arg_11_0)
	...
	return var_1_10002(var_11_0) == "table" and var_11_0 or nil
end
...
function var_0_1.GetBaseCircleTransform(arg_16_0)
	...
	return var_1_10002(var_16_0) == "table" and var_16_0 or var_0_2
end
...
function var_0_1.GetNormalCircleTransform(arg_17_0)
	...
	return var_1_10002(var_17_0) == "table" and var_17_0 or var_0_2
end
...
function var_0_1.UpdateRyzaItem(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_3 = var_1_10006(arg_19_0, "icon_bg")

	GetSpriteFromAtlas = var_19_1

	var_1_10004(var_19_3, var_19_1("weaponframes", "bg" .. var_19_2))

	setFrame = var_1_10004
	findTF = var_19_3

	var_1_10004(var_19_3(arg_19_0, "icon_bg/frame"), var_19_2)

	findTF = var_1_10004

	local var_19_4 = var_1_10004(arg_19_0, "icon_bg/icon")
