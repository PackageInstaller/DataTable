...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	for iter_1_0, iter_1_1 in var_1_10004(var_1_3) do
...
function var_0_1.BuildUnlockDesc(arg_2_0)
	...
	local var_2_2 = var_1_10003.dorm3d_ins_unlock[var_2].text
...
function var_0_1.MarkReply(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_4 = arg_10_0:BuildPlayerComment(arg_10_1, arg_10_2, var_10_3)

	table = var_10_2

	var_10_2.insert(arg_10_0.replyedList, var_10_4)
...
function var_0_1.BuildReplyedList(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in var_1_10004(arg_12_1) do
		...
		for iter_12_2, iter_12_3 in var_1_10009(iter_12_1) do
			...
			var_1_10015.insert(var_12_0, var_12_2)
		end
	end

	local var_12_3 = arg_12_0
	local var_12_4 = arg_12_0.getConfig(var_12_3, "npc_discuss")

	InstagramComment3Dorm = var_5

	local var_12_5 = var_5.BuildNpcReplayList(var_12_4, arg_12_0.time)

	ipairs = var_12_3

	for iter_12_4, iter_12_5 in var_12_3(var_12_5) do
		table = var_1_10011
	...
	for iter_13_0, iter_13_1 in var_1_10004(arg_13_0:getConfig("discuss")) do
		if not arg_13_1[iter_13_1] then
			...
			for iter_13_2, iter_13_3 in var_1_10010(var_13_2.message) do
				...
				local var_13_4 = arg_13_0:BuildPlayerComment(iter_13_1, iter_13_2, var_1_10015)

				table = var_13_3

				var_13_3.insert(var_13_0, var_13_4)
			end
		end
	end
...
function var_0_1.GetText(arg_18_0)
	...
	local var_18_2 = var_1_10002.dorm3d_ins_language[var_18_1].value

	HXSet = var_18_0

	return (var_18_0.hxLan(var_18_2))
end
