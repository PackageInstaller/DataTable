...
function var_0_1.GetScale(arg_8_0, arg_8_1)
	...
	return var_1_10003(var_8_0[1], var_8_0[2], 1)
end
...
function var_0_1.GetAwardProgress(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_4(var_1) do
...
function var_0_1.readyToAchieve(arg_14_0)
	...
	if not var_14_1(var_14_0, var_1_10004.ACTIVITY_TYPE_VIRTUAL_BAG) or var_1:isEnd() then
		return false
	end

	local var_14_2 = arg_14_0:getConfig("config_data")

	ipairs = var_14_0

	for iter_14_0, iter_14_1 in var_14_0(var_14_2) do
