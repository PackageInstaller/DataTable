...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_2(arg_1_0:GetDrawConfig("reward_list")) do
		...
		local var_1_0, var_1_1 = var_1_0(iter_1_1)
		local var_1_2 = arg_1_0.storeDic

		var_1_2[var_1_0] = var_1_1
		pg = var_1_2

		local var_1_3 = var_1_2.island_draw_reward[var_1_0].rarity
		local var_1_4 = arg_1_0.rarityDic
		local var_1_5

		if not arg_1_0.rarityDic[var_1_3] then
			var_1_5 = {}
		end
		...
		var_1_4.insert(arg_1_0.rarityDic[var_1_3], var_1_0)
	end
...
function var_0_1.GetList(arg_6_0)
	...
	for iter_6_2, iter_6_3 in var_3(var_6_2) do
		...
		for iter_6_4 = var_1_10008, var_1_10009(var_6_1[iter_6_3], 0) + 1, -1 do
			table = var_6_3

			local var_6_3 = var_6_3.insert
			...
			var_1_10016 = var_1_10016(var_6_1[iter_6_3], 0)
			defaultValue = var_1_10017
			var_1_10016 = var_1_10016 + var_1_10017(arg_6_0.countDic[iter_6_3], 0) < iter_6_4
			var_6_5[2] = var_1_10016
...
function var_0_1.CheckList(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in var_1_10004(arg_7_0.rarityDic[4]) do
		...
		var_7_0[iter_7_1] = var_1_10009 - var_1_10010(arg_7_0.countDic[iter_7_1], 0)
...
function var_0_1.GetRankList(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in var_1_10003(arg_14_0:GetRarityIds(arg_14_1)) do
		...
		for iter_14_2 = var_8(arg_14_0.storeDic[iter_14_1], 0), 1, -1 do
			table = var_1_10012
			...
			defaultValue = var_1_10016
			var_1_10016 = var_1_10016(arg_14_0.countDic[iter_14_1], 0) < iter_14_2
			var_14_2[2] = var_1_10016
...
function var_0_1.GetTimesLeft(arg_15_0, arg_15_1)
	if arg_15_1 then
		...
		if not arg_15_0.GetRarityIds(var_1_10004, arg_15_1) then
			underscore = var_1_10002
			var_1_10002 = var_1_10002.map(arg_15_0:GetDrawConfig("reward_list"), function(arg_16_0)
				return arg_16_0[1]
			end)
		end
		...
		for iter_15_0, iter_15_1 in var_1_10004(var_1_10002) do
			...
			defaultValue = var_1_10010
			var_15_0 = var_1_10009 - var_1_10010(arg_15_0.countDic[iter_15_1], 0)
		end
	...
	for iter_17_0, iter_17_1 in var_2(arg_17_1) do
		...
		if var_17_0.island_draw_reward[iter_17_1].rarity == 4 then
			if #arg_17_0.data1_list == 0 or arg_17_0.data1_list[1] == iter_17_1 then
				...
				local var_17_2 = var_10.format
				local var_17_3 = "error SList drop %d in %s"
				local var_17_4 = iter_17_1

				PrintTable = var_1_10014

				var_7(var_17_1, var_17_2(var_17_3, var_17_4, var_1_10014(arg_17_0.data1_list)))
			end
		end
	end
...
function var_0_1.GetCountAwards(arg_19_0)
	...
	for iter_19_2, iter_19_3 in var_3(arg_19_0:GetDrawConfig("reward_acc")) do
		...
		local var_19_2, var_19_3 = var_19_2(iter_19_3)
		...
		for iter_19_4 = 1, var_19_3 do
			...
			var_1_10018 = var_1_10018(var_19_0[var_19_2], 0) < iter_19_4
			var_19_5[2] = var_1_10018

			var_1_10014(var_19_4, var_19_5)
		end
	end
...
function var_0_1.CanCountAward(arg_21_0, arg_21_1)
	...
	if not arg_21_0.GetNextCountAwardTimes(var_21_0) or var_2 > arg_21_0.data2 then
		return false
	end
	...
	for iter_21_0, iter_21_1 in var_21_0(arg_21_0.data2_list) do
	...
	for iter_21_2, iter_21_3 in var_4(arg_21_0:GetDrawConfig("reward_acc")) do
		...
		local var_21_2, var_21_3 = var_21_2(iter_21_3)

		if arg_21_1 == var_21_2 and var_21_1 + var_21_3 > 0 then
			return true
		end
	end
...
function var_0_1.GetShowRankList(arg_22_0, arg_22_1)
	...
	for iter_22_0, iter_22_1 in var_1_10003(arg_22_0:GetRankList(arg_22_1)) do
		...
		local var_22_1, var_22_2 = var_22_1(iter_22_1)

		pg = var_10

		local var_22_3 = var_10.island_draw_reward[var_22_1]

		noEmptyStr = var_1_10011

		if var_1_10011(var_22_3.show) then
			table = var_1_10011

			var_1_10011.insert(var_22_0, var_22_1)
		end
	end
...
function var_0_1.GetLastItemCount(arg_23_0, arg_23_1)
	...
	return var_23_0 - var_1_10003(arg_23_0.countDic[arg_23_1], 0)
end
