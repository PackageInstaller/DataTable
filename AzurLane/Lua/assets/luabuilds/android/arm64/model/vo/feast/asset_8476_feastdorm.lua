...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("model.vo.Dorm.Dorm"))
...
function var_0_1.GetInvitedFeastShipList(arg_3_0)
	...
	local var_3_1 = arg_3_0.GetInvitedFeastShips(var_3_0)
	local var_3_2 = {}
	...
	for iter_3_0, iter_3_1 in var_3_0(var_3_1) do
		...
		var_1_10008.insert(var_3_2, iter_3_1)
	end

	table = var_3

	var_3.sort(var_3_2, function(arg_4_0, arg_4_1)
...
function var_0_1.GetPutFurnitureList(arg_13_0, arg_13_1)
	...
	FeastThemeTemplate = var_1_10004

	local var_13_2 = var_1_10004.New
	local var_13_3 = {
		id = -1
	}
	local var_13_4
	...
	if not var_13_2(var_13_3, 1, arg_13_0:GetMapSize()) or not var_4:GetAllFurniture() then
		var_13_5 = {}
	end

	pairs = var_13_3

	for iter_13_0, iter_13_1 in var_13_3(var_13_5) do
		table = var_1_10011
	...
	local var_13_6 = var_6.sort
	local var_13_7 = var_13_0

	BackyardThemeFurniture = iter_13_0

	var_13_6(var_13_7, iter_13_0._LoadWeight)
