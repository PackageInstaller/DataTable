...
function var_0_1.Flush(arg_3_0, arg_3_1, arg_3_2)
	...
	arg_3_0:UpdateMyFleets(var_3_3)
	...
	for iter_3_6, iter_3_7 in var_5(arg_3_1.attr_acc_list) do
		var_3_5[iter_3_7.key] = iter_3_7.value
	end

	local var_3_6 = arg_3_0:getConfig("event_attr_acc_effect")

	ipairs = var_6

	for iter_3_8, iter_3_9 in var_6(var_3_6) do
		local var_3_7

		if not var_3_5[iter_3_9[1]] then
			var_3_7 = 0
		end
	...
	for iter_3_10, iter_3_11 in var_7(arg_3_1.attr_count_list) do
		var_3_8[iter_3_11.key] = iter_3_11.value
	end

	local var_3_9 = arg_3_0:getConfig("event_attr_count_effect")

	ipairs = var_8

	for iter_3_12, iter_3_13 in var_8(var_3_9) do
		if not var_3_8[iter_3_13[1]] then
			iter_3_5 = 0
		end

		var_1_10014 = arg_3_0.attrCntList
		var_1_10014[iter_3_13[1]] = {
			value = iter_3_5,
			total = iter_3_13[2],
			goal = iter_3_13[3],
			score = iter_3_13[4]
	...
	for iter_3_14, iter_3_15 in var_8(arg_3_1.eventnodes) do
		...
		var_1_10014.insert(arg_3_0.nodes, iter_3_5)

		if iter_3_5:GetLog() then
			table = var_15

			var_15.insert(arg_3_0.nodeLogs, var_1_10014)
		end
	end
...
function var_0_1.GetRemainingTime(arg_7_0)
	local var_7_0 = arg_7_0:GetTotalTimeCost()

	pg = var_1_10002

	local var_7_1 = var_1_10002.TimeMgr.GetInstance()

	return var_7_0 - (var_2.GetServerTime(var_7_1) - arg_7_0:GetStartTime())
end
...
function var_0_1.CanFormation(arg_13_0)
	...
	if var_13_0 == var_1_10002.MISSION_MAX_FLEET_CNT then
		return false
	end
	...
	local var_13_1 = arg_13_0:GetNextFormationTime()

	pg = var_2

	local var_13_2 = var_2.TimeMgr.GetInstance()

	return var_13_1 - var_2.GetServerTime(var_13_2) <= 0, var_2
end
...
function var_0_1.GetNextFormationTime(arg_14_0)
	...
	if var_1_10006.detect(var_14_4, function(arg_16_0)
...
function var_0_1.IsMaxFleetCnt(arg_22_0)
	local var_22_0 = arg_22_0:GetFleetCnt()

	GuildConst = var_1_10002

	return var_22_0 == var_1_10002.MISSION_MAX_FLEET_CNT
end
...
function var_0_1.GetProgress(arg_42_0)
	...
	if arg_42_0.GetTotalTimeCost(var_42_0) > 0 then
...
function var_0_1.GetLogs(arg_44_0)
	...
	if arg_44_0.GetMyFlagShip(var_44_0) then
		...
		local var_44_1 = var_1_10002(var_1_10004)
		local var_44_2 = var_2.getShipById(var_44_1, var_1)

		_ = var_44_0

		do return var_44_0.map(arg_44_0.nodeLogs, function(arg_45_0)
			string = var_2_10001
			...
			return var_45_0(var_45_1, var_45_2, var_45_3 .. var_6.getName(var_45_4) .. "</color>")
		end) end
		return
	end
...
function var_0_1.CalcMyEffect(arg_49_0)
	...
	return var_49_3((20 + var_6.pow(var_49_1, 0.7)) * (1 + var_49_2 / (var_49_2 + 12500)))
end
...
function var_0_1.GetOtherShips(arg_57_0)
	...
	for iter_57_0, iter_57_1 in var_57_0(arg_57_0.ships) do
		local var_57_3 = var_57_1

		if var_57_1.getMemberById(var_57_3, iter_57_1.userId) then
			local var_57_4

			if iter_57_1.skin == 0 then
				pg = var_57_3
				var_57_4 = var_57_3.ship_data_statistics[iter_57_1.configId].skin_id
			end

			table = var_57_3

			local var_57_5 = var_57_3.insert
			local var_57_6 = var_57_2
			local var_57_7 = {
			...
			var_57_7.name = var_57_8

			var_57_5(var_57_6, var_57_7)
		end
	end
...
function var_0_1.MatchNation(arg_64_0, arg_64_1)
	if arg_64_0:IsEliteType() then
		...
		return var_1_10003.contains(var_64_0, arg_64_1.nation)
	end
...
function var_0_1.MatchShipType(arg_65_0, arg_65_1)
	if arg_65_0:IsEliteType() then
		...
		return var_1_10003.contains(var_65_0, arg_65_1.type)
	end
