...
local var_0_2 = var_0_10001.commander_ability_group
...
function var_0_1.getAttrsAddition(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10003(var_1_10005.PROPERTIES) do
		ipairs = var_1_10008

		for iter_8_2, iter_8_3 in var_1_10008(arg_8_0:getConfig("add")) do
			CommanderConst = var_13

			if var_13.TALENT_ADDITION_NUMBER == iter_8_3[1] then
				...
				if var_13.TALENT_ADDITION_RATIO == iter_8_3[1] and iter_8_3[4] == iter_8_0 then
					var_8_1[iter_8_1] = {
						value = iter_8_3[5],
						nation = iter_8_3[2],
						shiptype = iter_8_3[3]
...
function var_0_1.getBuffsAddition(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_1_10002(arg_9_0:getConfig("add")) do
		...
		if var_7.TALENT_ADDITION_BUFF == iter_9_1[1] then
			table = var_7

			var_7.insert(var_9_0, iter_9_1[4])
		end
	end
...
function var_0_1.getDestoryExpValue(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1_10003(var_10_1) do
		local var_10_2 = iter_10_1[1]

		CommanderConst = var_1_10009

		if var_10_2 == var_1_10009.TALENT_ADDITION_NUMBER then
			local var_10_3 = iter_10_1[4]

			CommanderConst = var_1_10009

			if var_10_3 == var_1_10009.DESTROY_ATTR_ID then
...
function var_0_1.getDestoryExpRetio(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1_10003(var_11_1) do
		...
		if var_11_2 == var_1_10009.TALENT_ADDITION_RATIO then
			local var_11_3 = iter_11_1[4]

			CommanderConst = var_1_10009

			if var_11_3 == var_1_10009.DESTROY_ATTR_ID then
...
function var_0_1.getDesc(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10003(var_12_1) do
		...
		if iter_12_1[3] then
			CommanderConst = var_12_3

			do
				local var_12_3

				if not var_12_3.TALENT_ADDITION_RATIO then
					CommanderConst = var_12_3
					var_12_3 = var_12_3.TALENT_ADDITION_NUMBER
				end

				var_12_2.type = var_12_3
				var_12_0[var_8] = var_12_2
			end
