...
function var_0_1.checkBattleTimeInBossAct(arg_12_0)
	...
	var_1_10001(var_12_0 == var_1_10004.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2)

	if arg_12_0:isEnd() then
		return false
	end

	local var_12_1 = arg_12_0.bossConfig
	local var_12_2 = var_1.GetBattleTime(var_12_1)

	pg = var_1_10002

	local var_12_3 = var_1_10002.TimeMgr.GetInstance()

	return var_2.inTime(var_12_3, var_12_2)
end
