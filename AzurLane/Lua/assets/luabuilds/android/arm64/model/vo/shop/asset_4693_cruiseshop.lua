...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	for iter_1_0, iter_1_1 in var_1_2(arg_1_0.genres) do
		...
		if var_1_10009.shop_template.get_id_list_by_genre[iter_1_1] then
			...
			for iter_1_2, iter_1_3 in var_1_10011(var_1_10009) do
				...
				local var_1_5 = var_1_10010.inTime

				pg = var_1_10019

				if var_1_5(var_1_4, var_1_10019.shop_template[iter_1_3].time) then
					table = var_16

					var_16.insert(var_1_3, iter_1_3)
				end
			end
		end
	end
	...
	for iter_1_4, iter_1_5 in var_5(arg_1_1) do
		var_1_6[iter_1_5.shop_id] = iter_1_5.pay_count
	end
	...
	for iter_1_6, iter_1_7 in var_6(arg_1_2) do
		var_1_7[iter_1_7.shop_id] = iter_1_7.pay_count
	end
	...
	for iter_1_8, iter_1_9 in var_6(var_1_3) do
		...
		if not var_1_6[iter_1_9] then
			var_1_8 = 0
		end

		pg = var_1_10012

		if not var_1_7[var_1_10012.shop_template[iter_1_9].group] then
			var_1_10012 = 0
		end

		local var_1_9 = arg_1_0.goods
		...
		Goods = var_1_10017
		var_1_9[iter_1_9] = iter_1_2(var_1_10, var_1_10017.TYPE_CRUISE)
	end
...
function var_0_1.GetRemainEquipSkinCnt(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_1_10001(arg_2_0.goods) do
		local var_2_0 = iter_2_1:getConfig("genre")

		ShopArgs = var_1_10007

		if var_2_0 == var_1_10007.CruiseGearSkin then
