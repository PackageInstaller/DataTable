...
function var_0_1.UpdateData(arg_4_0, arg_4_1)
	...
	local var_4_8 = var_1_10007(arg_4_0.id)
	local var_4_9 = "Count:"

	tostring = var_9

	local var_4_10 = var_9(arg_4_0.count)
	local var_4_11 = "UsedTime:"

	tostring = var_11

	local var_4_12 = var_11(arg_4_0.usedtime)
	local var_4_13 = "Ultimate:"

	tostring = var_13

	var_4_4(var_4_6, var_4_7, var_4_8, var_4_9, var_4_10, var_4_11, var_4_12, var_4_13, var_13(arg_4_0.ultimate))

	return
end

function var_0_1.CheckInTime(arg_6_0)
	if arg_6_0:getConfig("act_id") ~= nil then
		pg = var_1_10002

		if var_1_10002.activity_template[var_1] then
			local var_6_0 = var_2.time

			pg = var_4

			local var_6_1 = var_4.TimeMgr.GetInstance()

			return (var_4.inTime(var_6_1, var_6_0))
		end
	else
		return true
	end
