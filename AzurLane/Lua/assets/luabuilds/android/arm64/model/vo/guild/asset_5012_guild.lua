...
local var_0_3 = var_0_0.guild_operation_template
local var_0_4 = true
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_2, iter_1_3 in var_2(var_1_1) do
		...
		var_1_10008.insert(arg_1_0.logInfo, var_1_10007)
	end
	...
	for iter_1_4, iter_1_5 in var_2(var_0_3.all) do
		...
		GuildEvent = var_1_10010

		var_1_10007(var_1_2, var_1_10010.New({
			id = iter_1_5
		}))
	end
...
function var_0_1.setRefreshCaptialTime(arg_23_0)
	...
	arg_23_0.refreshCaptialTime = var_23_1 + var_1_10002.REFRESH_CAPITAL_TIME
...
function var_0_1.setRefreshWeeklyTaskProgressTime(arg_25_0)
	...
	GuildConst = var_1_10002
	arg_25_0.weeklyTaskNextRefreshTime = var_25_1 + var_1_10002.WEEKLY_TASK_PROGRESS_REFRESH_TIME
...
function var_0_1.getSupplyConsume(arg_34_0)
	...
	local var_34_0 = var_1_10001.guildset.guild_award_consume.key_value
	local var_34_1 = arg_34_0
	local var_34_2 = arg_34_0.getSupplyDuration(var_34_1)
	local var_34_3 = var_34_0

	math = var_34_1

	local var_34_4 = var_34_1.ceil(var_34_2 / 0)
end
...
function var_0_1.getSupplyCnt(arg_37_0)
	...
	local var_37_4 = arg_37_0.getSupplyStartTime(var_37_3)

	if arg_37_0.benefitTime == 0 or arg_37_0.benefitTime < var_37_4 then
		math = var_4
		var_37_0 = var_4.ceil((var_37_2 - var_37_4) / 0)
	else
		math = var_4

		local var_37_5 = var_4.max(0, var_37_2 - arg_37_0.benefitTime)

		math = var_37_3
		var_37_0 = var_37_3.floor(var_37_5 / 0)
	end

	local var_37_6 = arg_37_0
	local var_37_7 = arg_37_0.getMemberById

	getProxy = var_1_10007
	PlayerProxy = var_1_10009

	local var_37_8 = var_1_10007(var_1_10009)
	local var_37_9 = var_37_7(var_37_6, var_7.getRawData(var_37_8).id)
	local var_37_10 = var_4.GetJoinZeroTime(var_37_9)
	local var_37_11

	if arg_37_0.lastBenefitFinishTime > 0 and arg_37_0.lastBenefitFinishTime > arg_37_0.benefitTime and var_37_10 <= arg_37_0.lastBenefitFinishTime then
		var_37_11 = arg_37_0.benefitTime <= 0 and var_37_10 or arg_37_0.benefitTime
		math = var_7
		var_37_0 = var_7.ceil((arg_37_0.lastBenefitFinishTime - var_37_11) / 0) + var_37_0
	end

	math = var_37_11

	local var_37_12 = var_37_11.min
	local var_37_13 = var_37_0

	GuildConst = var_37_8

	return var_37_12(var_37_13, var_37_8.MAX_SUPPLY_CNT)
end
...
function var_0_1.getSupplyLeftCnt(arg_40_0)
	...
	return var_1_10002.floor((arg_40_0.benefitFinishTime - var_40_1) / 0)
end
...
function var_0_1.getSupplyStartTime(arg_42_0)
	...
	local var_42_3 = var_1_10005(var_1_10007)
	local var_42_4 = var_42_2(var_42_1, var_5.getRawData(var_42_3).id)
...
function var_0_1.getSelectableWeeklyTasks(arg_45_0)
	...
	if var_1_10002.IsAdministrator(arg_45_0:getSelfDuty()) then
		...
		for iter_45_0, iter_45_1 in var_1_10003(var_45_1.all) do
			...
			var_1_10009.insert(var_45_0, var_1_10008)
		end
	end
...
function var_0_1.shouldRequestCapitalLog(arg_46_0)
	...
	if var_46_1 > var_46_0.REQUEST_LOG_TIME then
		return true
	end
...
function var_0_1.getSortMemberWithoutSelf(arg_71_0)
	...
	local var_71_1 = var_1_10002(var_1_10004)
	local var_71_2 = var_2.getRawData(var_71_1).id

	pairs = var_1_10003

	for iter_71_0, iter_71_1 in var_1_10003(arg_71_0.member) do
...
function var_0_1.getEnableDuty(arg_101_0, arg_101_1, arg_101_2)
	...
	if arg_101_1 == var_1_10004.DUTY_COMMANDER then
		if arg_101_0:getAssistantMaxCount() == arg_101_0:getAssistantCount() then
...
function var_0_1.warpChatInfo(arg_102_0, arg_102_1)
	...
	if var_4.New(arg_102_1.player) then
		...
		var_6(var_102_3, "palyer duty has not been found" .. var_4.id)
		var_4:setDuty(var_102_3)

		local var_102_4

		string = var_102_2

		local var_102_5 = var_102_2.gsub
		local var_102_6 = var_102_1

		ChatConst = var_10

		var_102_5(var_102_6, var_10.EmojiCodeMatch, function(arg_103_0)
			tonumber = var_2_10001
			var_102_4 = var_2_10001(arg_103_0)
		...
		if var_102_4 then
			...
			if var_102_5.emoji_template[var_102_4] then
				var_102_1 = var_102_5.desc
			else
				var_102_4 = nil
			end
		end
		...
		local var_102_7 = var_102_5.New

		ChatConst = var_102_6

		return (var_102_7(var_102_6.ChannelGuild, {
			player = var_4,
			content = var_102_1,
			emojiId = var_102_4,
...
function var_0_1.GetOfficePainting(arg_105_0)
	...
	if var_105_0 == var_1_10002.FACTION_TYPE_BLHX then
		return "guild_office_blue"
	else
		GuildConst = var_2

		if var_105_0 == var_2.FACTION_TYPE_CSZZ then
...
function var_0_1.ShouldWeeklyTaskTip(arg_107_0)
	...
	GuildTask = var_1_10002

	if var_1_10002.STATE_EMPTY == var_107_1 then
		::label_107_0::

		GuildMember = var_107_0
		var_107_0 = var_107_0.IsAdministrator(arg_107_0:getSelfDuty())
	end
...
function var_0_1.ShouldShowSupplyTip(arg_111_0)
	local function var_111_0()
		...
		local var_112_0 = var_2_10000(var_2_10002)
...
function var_0_1.GetAllAssaultShip(arg_114_0)
	...
	for iter_114_0, iter_114_1 in var_1_10002(arg_114_0.member) do
		local var_114_1 = iter_114_1
		local var_114_2 = iter_114_1.GetAssaultFleet(var_114_1)
		local var_114_3 = var_7.GetShipList(var_114_2)

		ipairs = var_114_1

		for iter_114_2, iter_114_3 in var_114_1(var_114_3) do
			table = var_1_10014
...
function var_0_1.GetRecomForBossEvent(arg_115_0, arg_115_1, arg_115_2, arg_115_3)
	...
	for iter_115_0, iter_115_1 in var_1_10005(arg_115_0.member) do
		...
		if not var_1_10010.contains(arg_115_3, iter_115_1.id) then
			local var_115_1 = iter_115_1
			local var_115_2 = iter_115_1.GetAssaultFleet(var_115_1)

			if var_1_10010.GetStrongestShip(var_115_2, arg_115_1) then
				table = var_115_1
	...
	local var_115_3 = var_5.slice
	local var_115_4 = var_115_0
	local var_115_5 = 1

	math = iter_115_1

	return var_115_3(var_115_4, var_115_5, iter_115_1.min(arg_115_2, #var_115_0))
end
...
function var_0_1.GetMemberShips(arg_117_0, arg_117_1)
	...
	local var_117_2 = var_1_10004(var_1_10006)
	...
	for iter_117_0, iter_117_1 in var_117_2(arg_117_0.member) do
		local var_117_5 = iter_117_1

		var_1_10011 = iter_117_1.GetShip(var_117_5)
		var_1_10011.isCommander = iter_117_1:IsCommander()
...
function var_0_1.GetMissionAndAssultFleetShips(arg_120_0)
	...
	if arg_120_0.GetActiveEvent(var_120_1) then
		...
		if not var_2.IsExpired(var_1_10005) then
			var_1_10005 = var_2
			var_1_10003 = var_2.GetJoinShips(var_1_10005)
			ipairs = var_120_1

			for iter_120_0, iter_120_1 in var_120_1(var_1_10003) do
				table = var_1_10009
	...
	local var_120_2 = var_1_10003(var_1_10005)
	...
	local var_120_6 = var_4
	local var_120_7 = var_4.GetExternalAssaultFleet(var_120_6)
	local var_120_8 = var_120_5:GetShipList()

	pairs = var_120_6

	for iter_120_2, iter_120_3 in var_120_6(var_120_8) do
	...
	local var_120_9 = var_120_7:GetShipList()

	pairs = var_9

	for iter_120_4, iter_120_5 in var_9(var_120_9) do
		GuildAssaultFleet = var_1_10014
		var_1_10014 = var_1_10014.GetRealId(iter_120_5.id)
		table = var_1_10015

		var_1_10015.insert(var_120_0, var_1_10014)
	end
...
function var_0_1.GetBossMissionShips(arg_121_0)
	local var_121_0 = {}
	local var_121_1 = arg_121_0

	if arg_121_0.GetActiveEvent(var_121_1) and not var_2:IsExpired() then
		local var_121_2 = var_2:GetBossShipIds()
