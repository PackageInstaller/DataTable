...
local var_0_2 = var_0_10001.activity_series_enemy

pg = var_0_0

local var_0_3 = var_0_0.extraenemy_template
...
function var_0_1.IsPlayerUnlock(arg_25_0, arg_25_1)
	...
	if #arg_25_0.GetPreSeriesId(var_25_0) == 0 or var_2[1] == 0 then
		return true
	else
		var_25_1 = true
		ipairs = var_25_0

		for iter_25_0, iter_25_1 in var_25_0(var_2) do
...
function var_0_1.IsUnlock(arg_26_0, arg_26_1)
	...
	if #arg_26_0.GetPreSeriesId(var_26_0) == 0 or var_2[1] == 0 then
		return true
	else
		var_26_1 = true
		ipairs = var_26_0

		for iter_26_0, iter_26_1 in var_26_0(var_2) do
...
function var_0_1.GetActivitySeriesID(arg_33_0, arg_33_1)
	...
	if not arg_33_1 then
		...
		local var_33_0 = var_33_1(var_1_10004)
...
function var_0_1.StaticCalculateFleetIds(arg_49_0, arg_49_1)
	...
	return var_49_0(var_4.range(arg_49_1 + 1), function(arg_50_0)
