...
function var_0_1.canPurchase(arg_3_0)
	...
	if var_3_0 == var_1_10002.TYPE_MILITARY then
		do return arg_3_0:getBuyCount() == 0 end
	...
	if var_3_1 ~= var_2.TYPE_GIFT_PACKAGE then
		local var_3_2 = arg_3_0.type

		Goods = var_3_5

		if var_3_2 ~= var_3_5.TYPE_SKIN then
			local var_3_3 = arg_3_0.type

			Goods = var_3_5

			if var_3_3 ~= var_3_5.TYPE_WORLD then
				do
					...
					if var_3_4 == var_3_5.TYPE_NEW_SERVER then
						var_3_5 = arg_3_0:getLimitCount() <= 0 or arg_3_0:getBuyCount() < var_1

						return var_3_5
					else
						local var_3_6 = arg_3_0.type

						Goods = var_3_5

						if var_3_6 == var_3_5.TYPE_CRUISE then
...
function var_0_1.GetDiscountEndTime(arg_5_0)
	...
	local var_5_1, var_5_2 = var_1_10002(var_5_0)
	local var_5_3 = var_5_2[1]

	unpack = var_1_10005

	local var_5_4, var_5_5, var_5_6 = var_1_10005(var_5_3)

	pg = var_1_10008

	local var_5_7 = var_1_10008.TimeMgr.GetInstance()

	return (var_8.Table2ServerTime(var_5_7, {
		year = var_5_4,
		month = var_5_5,
		day = var_5_6,
		hour = var_5_2[2][1],
...
function var_0_1.IsGroupSale(arg_6_0)
	...
	local var_6_2 = arg_6_0.getConfig(var_6_1, "limit_args2")[1]
	local var_6_3 = arg_6_0.type

	Goods = var_6_1

	return var_6_3 == var_6_1.TYPE_MILITARY and var_6_0 and var_6_2[1] == "purchase"
end
...
function var_0_1.IsItemDiscountType(arg_14_0)
	local var_14_0 = arg_14_0:getConfig("genre")

	ShopArgs = var_1_10002

	local var_14_1

	if var_14_0 == var_1_10002.SkinShop then
		SkinCouponActivity = var_14_0
		var_14_1 = var_14_0.StaticExistActivityAndCoupon(arg_14_0.id)
	else
		var_14_1 = false
	end
...
function var_0_1.GetVoucherIdList(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10003(var_18_2) do
...
function var_0_1.getLimitCount(arg_19_0)
	...
	if not arg_19_0:getConfig("limit_args") then
		var_19_0 = {}
	end
...
function var_0_1.getLevelLimit(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10002(var_22_0) do
		type = var_1_10007
...
function var_0_1.getDropInfo(arg_24_0)
	...
	local var_24_0 = var_1_10001(arg_24_0:getConfig("effect_args"), {
		...
		if var_31_1 == var_2_10001.WorldCollection then
			local var_31_2 = {}
			...
			if var_31_6 == var_1.CruiseSkin then
				local var_31_7 = {}
				...
				if var_31_11 == var_1.CruiseGearSkin then
					local var_31_12 = {}
	...
	return var_1_10002.New(var_24_0)
end
...
function var_0_1.GetDropList(arg_32_0)
	...
	if var_1_10003(var_32_1) == "table" then
		ipairs = var_3
...
function var_0_1.GetLimitDesc(arg_34_0)
	...
	if arg_34_0.getConfig(var_34_2, "group_limit") > 0 then
		local var_34_3

		if not arg_34_0:getConfig("group_type") then
			var_34_3 = 0
		end
...
function var_0_1.GetGiftList(arg_35_0)
	local var_35_0 = arg_35_0:getConfig("genre")

	ShopArgs = var_1_10002

	if var_35_0 == var_1_10002.SkinShop then
		local var_35_1 = arg_35_0:getSkinId()

		ShipSkin = var_2

		local var_35_2 = var_2.New({
			id = var_35_1
		})

		return var_2.GetRewardList(var_35_2)
	else
...
function var_0_1.GetPackageTag(arg_36_0)
	local var_36_0 = arg_36_0:getConfig("genre")

	ShopArgs = var_1_10002

	if var_36_0 ~= var_1_10002.GiftPackage or arg_36_0:getConfig("package_tag_open") == 0 then
		return ""
	else
...
function var_0_1.isTip(arg_37_0)
	if arg_37_0:isGiftPackage() or arg_37_0:isActGiftPackage() then
		...
		if var_5.GetInt(var_37_1, 0) ~= var_37_2 then
			...
			if var_5.contains(var_37_3[1], arg_37_0.id) then
				return true
			end
		end
