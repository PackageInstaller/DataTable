...
function var_0_1.getProgress(arg_16_0)
	if arg_16_0:isComplexTrophy() then
		...
		for iter_16_0, iter_16_1 in var_1_10002(arg_16_0.subTrophyList) do
		...
		local var_16_2 = arg_16_0:getConfig("target_num")

		return
	else
		local var_16_3 = arg_16_0.progress
		local var_16_4 = arg_16_0:getConfig("target_num")
