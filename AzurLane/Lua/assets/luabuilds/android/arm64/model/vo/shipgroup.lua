...
function var_0_1.GetGroupConfig(arg_1_0)
	...
	if var_1_10001(var_1_10003.ship_data_group.get_id_list_by_group_type[arg_1_0], {
		1
	}) then
		pg = var_1_10002
		...
		if not var_1_10002.ship_data_group[var_1] then
			var_1_0 = nil
		end
...
function var_0_1.IsBluePrintGroup(arg_4_0)
	...
	return var_1_10001(var_1_10003.ship_data_blueprint[arg_4_0])
end
...
function var_0_1.IsMetaGroup(arg_5_0)
	...
	return var_1_10001(var_1_10003.ship_strengthen_meta[arg_5_0])
end
...
function var_0_1.getState(arg_7_0, arg_7_1, arg_7_2)
	if var_0_1.ENABLE_SKIP_TO_CHAPTER then
		...
		if arg_7_1 then
			...
			local var_7_2 = var_1_10005(var_7)
			local var_7_3
...
function var_0_1.getShipType(arg_17_0, arg_17_1)
	...
	if arg_17_1 and arg_17_0.trans then
		...
		if var_3.getTransformShipId(arg_17_0.shipConfig.id) then
			pg = var_1_10004
			var_17_0 = var_1_10004.ship_data_statistics[var_3].type
		end
	end
...
function var_0_1.getShipConfigId(arg_18_0, arg_18_1)
	...
	if arg_18_1 and arg_18_0.trans then
		...
		if var_3.getTransformShipId(arg_18_0.shipConfig.id) then
			pg = var_1_10004
			var_18_0 = var_1_10004.ship_data_statistics[var_3].id
		end
	end
...
function var_0_1.GetDisplayableSkinList(arg_20_0)
	...
	local function var_20_1(arg_21_0)
		...
		if var_21_0 ~= var_2_10002.SKIN_TYPE_OLD then
			...
			if var_21_1 == var_2.SKIN_TYPE_NOT_HAVE_HIDE then
				...
				local var_21_2 = var_21_1(var_2_10003)
	...
	for iter_20_0, iter_20_1 in var_1_10004(var_1_10006.ship_skin_template.all) do
		pg = var_1_10009
		...
		if var_1_10009.ship_skin_template[iter_20_1].ship_group == arg_20_0 and var_1_10009.no_showing ~= "1" and not var_20_1(var_1_10009) and var_20_2(var_1_10009.id) then
			...
			var_1_10010.insert(var_20_0, var_1_10009)
		end
	end
	...
	for iter_20_2 = #var_20_0, 1, -1 do
		...
		if var_1_10009.GetChangeSkinGroupId(var_20_3.id) then
			...
			if var_1_10010.GetChangeSkinIndex(var_20_3.id) ~= 1 then
				table = var_11
...
function var_0_1.getDefaultSkin(arg_23_0)
	...
	return var_23_0(var_23_1, var_1_10004.SKIN_TYPE_DEFAULT)
end
...
function var_0_1.getProposeSkin(arg_24_0)
	...
	return var_24_0(var_24_1, var_1_10004.SKIN_TYPE_PROPOSE)
end
...
function var_0_1.GetNationTxt(arg_32_0)
	...
	return var_32_1 .. var_32_2 .. var_4.Nation2Name(var_32_0)
end
...
function var_0_1.VoiceReplayCodition(arg_33_0, arg_33_1)
	...
	if arg_33_0.isBluePrintGroup(var_33_2) then
		...
		var_1_10005(var_33_4, "blueprint can not be nil >>" .. arg_33_0.id)

		var_1_10007 = var_33_4

		local var_33_5 = var_33_4.getUnlockVoices(var_1_10007)

		table = var_33_3

		if not var_33_3.contains(var_33_5, arg_33_1.key) then
			local var_33_6 = var_33_4
			local var_33_7 = var_33_4.getUnlockLevel(var_33_6, arg_33_1.key)

			if 0 < var_33_7 then
				var_1_10007 = false
				i18n = var_33_6

				local var_33_8 = var_33_6("ship_profile_voice_locked_design", var_33_7)
	...
	if arg_33_0.isMetaGroup(var_33_9) then
		getProxy = var_4
		BayProxy = var_33_9

		local var_33_10 = var_4(var_33_9)

		var_1_10007 = var_4.getMetaShipByGroupId(var_33_10, arg_33_0.id)

		local var_33_11 = var_4.getMetaCharacter(var_1_10007)
		local var_33_12 = var_5.getUnlockedVoiceList(var_33_11)

		table = var_1_10007

		if not var_1_10007.contains(var_33_12, arg_33_1.key) then
			local var_33_13 = var_5

			if var_5.getUnlockVoiceRepairPercent(var_33_13, arg_33_1.key) > 0 then
				local var_33_14 = false

				i18n = var_33_13

				local var_33_15 = var_33_13("ship_profile_voice_locked_meta", var_1_10007)
	...
	if arg_33_1.unlock_condition[1] == var_0_1.CONDITION_INTIMACY then
		if arg_33_0.maxIntimacy < arg_33_1.unlock_condition[2] then
			...
			local var_33_16 = "ship_profile_voice_locked_intimacy"

			math = var_1_10007
			var_33_1 = var_4(var_33_16, var_1_10007.floor(arg_33_1.unlock_condition[2] / 100))
		end
...
function var_0_1.IsXIdol(arg_41_0)
	local var_41_0 = arg_41_0:getNation()

	Nation = var_1_10002

	return var_41_0 == var_1_10002.IDOL_LINK
end
