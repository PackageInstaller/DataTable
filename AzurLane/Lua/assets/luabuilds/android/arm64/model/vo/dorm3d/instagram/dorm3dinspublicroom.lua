...
function var_0_1.GetWelcomeCharList(arg_1_0)
	...
	if var_2.getRoom(var_1_1, arg_1_0.id) then
		...
		if not var_3.select(var_1_0, function(arg_3_0)
		...
		local var_1_3 = var_1_1.map(var_1_0, function(arg_4_0)
			_ = var_2_10001
			...
			return var_4_0(var_2_10003.dorm3d_rooms.all, function(arg_5_0)
				pg = var_3_10001
...
function var_0_1.GetCard(arg_7_0)
	...
	return var_7_0(var_7_1, var_1_10004.lower(arg_7_0:GetConfig("assets_prefix")))
end
