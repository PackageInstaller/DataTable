...
function var_0_1.BuildFromActivity(arg_7_0)
	arg_7_0.unlock = (function()
		...
		if var_0.GetLockLimit(var_8_0) and var_0[1] == 1 then
			...
			local var_8_1 = var_1(var_2_10003)
			local var_8_2 = var_1.getActivityByType

			ActivityConst = var_2_10004

			local var_8_3 = var_8_2(var_8_1, var_2_10004.ACTIVITY_TYPE_BUILDING_BUFF_2)
	...
	local var_7_2 = var_7_1(var_7_0, var_1_10005.ACTIVITY_TYPE_WORKBENCH)
