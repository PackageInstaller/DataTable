...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_3(var_5)
	local var_1_3 = var_3.getActivityById(var_1_2, arg_1_0.activityId)
	local var_1_4 = {}

	ipairs = var_1_2

	for iter_1_2, iter_1_3 in var_1_2(var_1_3:getConfig("config_data")) do
...
function var_0_1.GetPtId(arg_2_0)
	...
	return var_2_0.newserver_shop_template[var_2_2[1]].resource_type
end
...
function var_0_1.IsOpenPhase(arg_8_0, arg_8_1)
	...
	local var_8_1 = arg_8_0:GetStartTime() + var_8_0

	pg = var_1_10004

	local var_8_2 = var_1_10004.TimeMgr.GetInstance()

	return var_8_1 <= var_4.GetServerTime(var_8_2)
end
