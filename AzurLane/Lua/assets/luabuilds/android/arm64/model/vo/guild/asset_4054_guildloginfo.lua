...
function var_0_1.getConent(arg_2_0)
	...
	elseif arg_2_0.cmd == var_0_1.CMD_TYPE_SET_DUTY then
		i18n = var_3
		...
		return var_3(var_2_3, var_2_4, var_1_10007.dutyId2Name(arg_2_0.arg1)), var_2_0
	...
	elseif arg_2_0.cmd == var_0_1.CMD_TYPE_GET_SHIP then
		...
		local var_2_7 = var_5.New

		var_1_10007 = {}
		PublicArg = var_1_10008
		var_1_10007.type = var_1_10008.TypePlayerName
		var_1_10007.string = arg_2_0.name
		var_2_6[1] = var_2_7(var_1_10007)
		PublicArg = var_5
		...
		var_1_10007 = {}
		PublicArg = var_8
		var_1_10007.type = var_8.TypeShipId
		var_1_10007.int = arg_2_0.arg1
		var_2_6[2] = var_2_8(var_1_10007)
	...
	elseif arg_2_0.cmd == var_0_1.CMD_TYPE_FACILITY_CONTRIBUTION then
		...
		local var_2_9 = var_3("word_contribution")

		Item = var_4

		local var_2_10 = var_4.New
		local var_2_11 = {}

		id2ItemId = var_1_10007
		var_2_11.id = var_1_10007(arg_2_0.arg0[2])

		local var_2_12 = var_2_10(var_2_11)
		local var_2_13 = arg_2_0.arg0[1] .. var_2_12:getConfig("name")

		i18n = var_6

		local var_2_14 = var_6("guild_facility_get_gold", arg_2_0.arg0[3])

		return arg_2_0.name .. arg_2_0:getDuty(), var_2_2, var_2_9, var_2_13, var_2_14
	elseif arg_2_0.cmd == var_0_1.CMD_TYPE_FACILITY_CONSUME then
		i18n = var_3

		local var_2_15 = var_3("word_consume")
		local var_2_16 = arg_2_0.arg0[1]

		i18n = var_5

		local var_2_17 = var_2_16 .. var_5("word_guild_res")
		local var_2_18 = ""

		if arg_2_0.arg0[2] then
			GuildFacility = var_6

			local var_2_19 = var_6.New({
				id = arg_2_0.arg0[2]
			})
			local var_2_20 = var_6.getConfig(var_2_19, "name")

			i18n = var_8
			var_2_18 = var_8("guild_facility_upgrade", var_2_20, arg_2_0.arg0[3])
		end

		return arg_2_0.name .. arg_2_0:getDuty(), var_2_2, var_2_15, var_2_17, var_2_18
	end
