...
DROP_TYPE_SPWEAPON = var_0_10001
var_0_1.type = var_0_10001
...
function var_0_1.GetSkillInfo(arg_30_0)
	...
	if not arg_30_0:GetShipId() or var_2 == 0 then
		var_1.descTrigger = true
	end
...
function var_0_1.GetUpgradableSkillInfo(arg_31_0)
	...
	if var_31_0 then
		...
		local var_31_4 = var_1_10005(var_1_10007)
...
function var_0_1.GetActiveUpgradableSkillList(arg_32_0, arg_32_1)
	...
	for iter_32_0, iter_32_1 in var_1_10003(arg_32_1:getSkillList()) do
		...
		local var_32_2, var_32_3 = arg_32_0.RemapSkillId(var_32_1, iter_32_1)

		if var_32_3 then
			table = var_32_1

			var_32_1.insert(var_32_0, {
				mapSkillID = var_32_2,
	...
	local var_32_4 = var_3.ship_data_template[arg_32_1.configId].hide_buff_list

	ipairs = var_4

	for iter_32_2, iter_32_3 in var_4(var_32_4) do
		local var_32_5 = arg_32_0
		local var_32_6, var_32_7 = arg_32_0.RemapSkillId(var_32_5, iter_32_3)

		if var_32_7 then
			table = var_32_5

			var_32_5.insert(var_32_0, {
				mapSkillID = var_32_6,
...
function var_0_1.GetPropertiesInfo(arg_43_0)
	...
	var_1_10003.insert(var_43_0.attrs, {
...
function var_0_1.GetWearableShipTypes(arg_44_0)
	if arg_44_0:getConfig("usability") and #var_1 > 0 then
		return var_1
	end

	pg = var_1_10002

	return var_1_10002.spweapon_type[arg_44_0:GetType()].ship_type
end
...
function var_0_1.GetUpgradeConfig(arg_46_0)
	...
	return var_1_10002.spweapon_upgrade[var_46_0]
end
...
function var_0_1.CalculateHistoryPt(arg_48_0, arg_48_1)
	...
	return (var_1_10003.reduce(arg_48_1, var_48_0, function(arg_50_0, arg_50_1)
