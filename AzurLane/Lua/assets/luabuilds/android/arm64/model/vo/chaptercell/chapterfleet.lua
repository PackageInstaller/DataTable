...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	if arg_1_1.fleet_id then
		...
		if var_3.getFleetById(var_1_1, arg_1_1.fleet_id) then
			local var_1_2 = var_3

			if not var_3.GetName(var_1_2) then
				Fleet = var_1_10004
				var_1_10004 = var_1_10004.DEFAULT_NAME[arg_1_1.fleet_id]
			end

			arg_1_0.name = var_1_10004

			local var_1_3

			if not arg_1_0.name then
				Fleet = var_1_3
				var_1_3 = var_1_3.DEFAULT_NAME[arg_1_0.id]
			end

			arg_1_0.name = var_1_3
			...
			var_1_2.each(arg_1_1.box_strategy_list, function(arg_2_0)
				var_1_4[arg_2_0.id] = arg_2_0.count
			...
			var_6.each(arg_1_1.ship_strategy_list, function(arg_3_0)
				var_1_5[arg_3_0.id] = arg_3_0.count
			...
			if not var_6.detect(var_1_6, function(arg_5_0)
				pg = var_2_10001
				...
				var_6.insert(var_1_6, arg_1_0:getFormationStg())
			end

			arg_1_0.stgPicked = var_1_4
			arg_1_0.stgUsed = var_1_5
			arg_1_0.stgIds = var_1_6
			arg_1_0.line = {
				row = arg_1_1.pos.row,
...
function var_0_1.UpdateVisible(arg_7_0)
	...
	if var_7_0 == var_1_10002.Normal then
		local var_7_1 = arg_7_0.chapter

		var_1.UpdateCellsVisible(var_7_1, arg_7_0)
	end
...
function var_0_1.GetVisibleRange(arg_9_0, arg_9_1)
	...
	local var_9_1, var_9_2 = arg_9_0.GetFogVisibleLV(var_9_0)

	underscore = var_9_0

	return var_9_0.map(var_9_2.vision_range, function(arg_10_0)
		unpack = var_2_10001
...
function var_0_1.fetchShipVO(arg_11_0, arg_11_1)
	...
	if arg_11_0.npcShipList[arg_11_1] then
		...
		local var_11_1 = var_3(var_1_10005)
...
function var_0_1.updateCommanders(arg_15_0, arg_15_1)
	...
	local var_15_0 = var_2(var_1_10004)
...
function var_0_1.flushShips(arg_27_0)
	...
	if not var_1.getFleetById(var_27_0, arg_27_0.fleetId) or var_2.name == "" or not var_2.name then
		...
		if not var_1_10003.DEFAULT_NAME[arg_27_0.fleetId] then
			Fleet = var_1_10003
			var_1_10003 = var_1_10003.DEFAULT_NAME[arg_27_0.id]
		end
	end

	arg_27_0.name = var_1_10003
	_ = var_1_10003

	local var_27_1 = var_1_10003.keys(arg_27_0.ships)

	ipairs = var_27_0

	for iter_27_0, iter_27_1 in var_27_0(var_27_1) do
	...
	var_27_3(arg_27_0[iter_27_0.Vanguard], function(arg_28_0)
	...
	var_27_5(arg_27_0[var_8.Main], function(arg_29_0)
	...
	var_27_7(arg_27_0[var_9.Submarine], function(arg_30_0)
...
function var_0_1.getShips(arg_33_0, arg_33_1)
	...
	if var_33_1 == var_1_10004.Normal then
		table = var_33_2
		var_33_2 = var_33_2.insertto

		local var_33_3 = var_33_0

		var_1_10009 = arg_33_0
		var_1_10007 = arg_33_0.getShipsByTeam
		TeamType = var_1_10010

		var_33_2(var_33_3, var_1_10007(var_1_10009, var_1_10010.Main, arg_33_1))
		...
		var_33_2(var_33_4, var_1_10007(var_1_10009, var_1_10010.Vanguard, arg_33_1))
	else
		FleetType = var_33_2

		local var_33_5

		if var_33_1 == var_33_2.Submarine then
			table = var_33_5
			var_33_5 = var_33_5.insertto
			...
			var_33_5(var_33_6, var_1_10007(var_1_10009, var_1_10010.Submarine, arg_33_1))
		else
			FleetType = var_33_5

			if var_33_1 == var_33_5.Support then
				ipairs = var_4

				local var_33_7 = {}

				TeamType = var_1_10007
				var_33_7[1] = var_1_10007.Main
				TeamType = var_7
				var_33_7[2] = var_7.Vanguard
				TeamType = var_7
				var_33_7[3] = var_7.Submarine

				for iter_33_0, iter_33_1 in var_4(var_33_7) do
					table = var_1_10009
...
function var_0_1.isValid(arg_41_0)
	...
	if var_41_0 == var_1_10002.Normal then
		_ = var_41_1
		var_41_1 = var_41_1.any
		TeamType = var_1_10004

		if var_41_1(arg_41_0[var_1_10004.Vanguard], function(arg_42_0)
			return arg_42_0.hpRant > 0
		end) then
			_ = var_41_1
			var_41_1 = var_41_1.any
			TeamType = var_1_10004
			var_41_1 = var_41_1(arg_41_0[var_1_10004.Main], function(arg_43_0)
		...
		if var_41_0 == var_41_1.Submarine then
			_ = var_41_2
			var_41_2 = var_41_2.any
			TeamType = var_1_10004

			return var_41_2(arg_41_0[var_1_10004.Submarine], function(arg_44_0)
				return arg_44_0.hpRant > 0
			end)
		else
			FleetType = var_41_2

			if var_41_0 == var_41_2.Support then
				return true
			end
		end
	end
...
function var_0_1.getCost(arg_45_0)
	...
	var_1_10004.each(var_45_2, function(arg_46_0)
...
function var_0_1.getInvestSums(arg_47_0, arg_47_1)
	local function var_47_0(arg_48_0, arg_48_1)
		...
		local var_48_3 = var_48_1(var_48_0, var_5.getCommanders(var_48_2))

		AttributeType = var_2_10003

		local var_48_4 = arg_48_0 + var_48_3[var_2_10003.Air]

		AttributeType = var_48_0

		return var_48_4 + var_48_3[var_48_0.Dodge]
	end
	...
	return var_1_10004.pow(var_47_1, 0.6666666666666666)
end
...
function var_0_1.getDodgeSums(arg_49_0)
	local function var_49_0(arg_50_0, arg_50_1)
		...
		local var_50_3 = var_50_1(var_50_0, var_5.getCommanders(var_50_2))

		AttributeType = var_2_10003

		return arg_50_0 + var_50_3[var_2_10003.Dodge]
	end
	...
	return var_1_10003.pow(var_49_1, 0.6666666666666666)
end
...
function var_0_1.getAntiAircraftSums(arg_51_0)
	local function var_51_0(arg_52_0, arg_52_1)
		...
		local var_52_3 = var_52_1(var_52_0, var_5.getCommanders(var_52_2))

		AttributeType = var_2_10003

		return arg_52_0 + var_52_3[var_2_10003.AntiAircraft]
	end
...
function var_0_1.getAirSums(arg_53_0, arg_53_1)
	local function var_53_0(arg_54_0, arg_54_1)
		...
		local var_54_3 = var_54_1(var_54_0, var_5.getCommanders(var_54_2))

		AttributeType = var_2_10003

		return arg_54_0 + var_54_3[var_2_10003.Air]
	end
...
function var_0_1.getShipAmmo(arg_55_0)
	local var_55_0 = 0
	local var_55_1 = arg_55_0:getFleetType()

	FleetType = var_1_10003

	if var_55_1 == var_1_10003.Normal then
		pairs = var_55_1

		for iter_55_0, iter_55_1 in var_55_1(arg_55_0.ships) do
			math = var_1_10007
			var_55_0 = var_1_10007.max(var_55_0, iter_55_1:getShipAmmo())
		end
	else
		local var_55_2 = arg_55_0:getFleetType()

		FleetType = var_3

		if var_55_2 == var_3.Submarine then
			pairs = var_55_2

			for iter_55_2, iter_55_3 in var_55_2(arg_55_0.ships) do
				var_55_0 = var_55_0 + iter_55_3:getShipAmmo()
			end
		else
			local var_55_3 = arg_55_0:getFleetType()

			FleetType = var_3

			if var_55_3 == var_3.Support then
				var_55_0 = 0
			end
		end
	end
...
function var_0_1.getShipIds(arg_60_0)
	...
	if var_60_1 == var_1_10003.Normal then
		_ = var_60_2
		var_60_2 = var_60_2.each
		TeamType = var_1_10005

		var_60_2(arg_60_0[var_1_10005.Main], function(arg_61_0)
			table = var_2_10001
		...
		var_60_2(arg_60_0[var_1_10005.Vanguard], function(arg_62_0)
			table = var_2_10001
		...
		if var_60_1 == var_60_2.Submarine then
			_ = var_60_3
			var_60_3 = var_60_3.each
			TeamType = var_1_10005

			var_60_3(arg_60_0[var_1_10005.Submarine], function(arg_63_0)
				table = var_2_10001
			...
			if var_60_1 == var_60_3.Support then
				pairs = var_3
...
function var_0_1.containsSameKind(arg_64_0, arg_64_1)
	...
	if arg_64_1 then
		...
		_ = var_1_10004
		var_64_0 = var_64_0(var_1_10004.values(arg_64_0.ships), function(arg_65_0)
...
function var_0_1.getSpeed(arg_67_0)
	...
	if not var_67_1(var_67_0, var_1_10004.TypeMoveSpeed) then
		var_67_2 = 0
	end

	math = var_1_10002

	return var_1_10002.max(arg_67_0.baseSpeed + var_67_2 - arg_67_0.slowSpeedFactor, 1)
end
...
function var_0_1.calcBaseSpeed(arg_68_0)
	...
	local var_68_1 = var_1_10002.reduce(var_68_0, 0, function(arg_69_0, arg_69_1)
		local var_69_0 = arg_69_1:getProperties()

		AttributeType = var_2_10003

		return arg_69_0 + var_69_0[var_2_10003.Speed]
	...
	if var_68_4 == var_6.Normal then
		pg = var_6
		var_68_2 = var_6.gameset.chapter_move_speed_1.key_value
		pg = var_6
		var_68_3 = var_6.gameset.chapter_move_speed_2.key_value
	else
		FleetType = var_6

		if var_68_4 == var_6.Submarine then
			pg = var_6
			var_68_2 = var_6.gameset.submarine_move_speed_1.key_value
			pg = var_6
			var_68_3 = var_6.gameset.submarine_move_speed_2.key_value
		else
			FleetType = var_6

			if var_68_4 == var_6.Support then
				pg = var_6
				var_68_2 = var_6.gameset.chapter_move_speed_1.key_value
				pg = var_6
				var_68_3 = var_6.gameset.chapter_move_speed_2.key_value
...
function var_0_1.getStrategies(arg_71_0)
	...
	for iter_71_0, iter_71_1 in var_1_10002(arg_71_0.stgPicked) do
		local var_71_1

		if not var_71_0[iter_71_0] then
			var_71_1 = 0
		end
	...
	for iter_71_2, iter_71_3 in var_2(arg_71_0.stgUsed) do
		if var_71_0[iter_71_2] then
			math = var_7
			var_71_0[iter_71_2] = var_7.max(0, var_71_0[iter_71_2] - iter_71_3)
		end
	end
	...
	for iter_71_4, iter_71_5 in var_2(var_4.StrategyPresents) do
		local var_71_2

		if not var_71_0[iter_71_5] then
			var_71_2 = 0
		end

		var_71_0[iter_71_5] = var_71_2
	end
	...
	for iter_71_6, iter_71_7 in var_3(var_71_0) do
		table = var_1_10008

		var_1_10008.insert(var_71_3, {
			id = iter_71_6,
			count = iter_71_7
		})
	end
	...
	return var_3.sort(var_71_3, function(arg_72_0, arg_72_1)
...
function var_0_1.getOwnStrategies(arg_73_0)
	...
	var_1_10003.each(var_73_2, function(arg_74_0)
		local var_74_0 = arg_74_0:getConfig("strategy_list")

		_ = var_2_10002

		var_2_10002.each(var_74_0, function(arg_75_0)
	...
	if var_73_4(var_73_3, var_6.TypeStrategy) then
		_ = var_73_1

		var_73_1.each(var_3, function(arg_76_0)
...
function var_0_1.GetStrategyCount(arg_79_0, arg_79_1)
	...
	if not var_1_10003.detect(var_79_0, function(arg_80_0)
...
function var_0_1.canUseStrategy(arg_82_0, arg_82_1)
	...
	if var_82_0 == var_1_10004.StgTypeForm then
		if arg_82_0:getFormationStg() == var_2.id then
			pg = var_3

			local var_82_1 = var_3.TipsMgr.GetInstance()
			local var_82_2 = var_3.ShowTips

			i18n = var_1_10006

			var_82_2(var_82_1, var_1_10006("level_scene_formation_active_already"))
	...
	if var_82_3 ~= var_4.StgTypeConsume then
		do
			...
			if var_82_4 == var_4.StgTypeBindSupportConsume then
				if arg_82_1.count <= 0 then
					...
					local var_82_5 = var_3.TipsMgr.GetInstance()
					local var_82_6 = var_3.ShowTips

					i18n = var_1_10006

					var_82_6(var_82_5, var_1_10006("level_scene_not_enough"))
				...
				if var_82_7 == var_4.StrategyRepair then
					_ = var_82_7
					...
					if var_82_7.all(arg_82_0:getShips(true), function(arg_83_0)
						...
						var_82_9(var_82_8, var_6("level_scene_full_hp"))
...
function var_0_1.canClearTorpedo(arg_87_0)
	...
	local var_87_2 = var_87_1(var_87_0, var_1_10004.Vanguard, true)

	_ = var_1_10002

	return var_1_10002.any(var_87_2, function(arg_88_0)
...
function var_0_1.getHuntingRange(arg_89_0, arg_89_1)
	local var_89_0 = arg_89_0:getFleetType()

	FleetType = var_1_10003

	if var_89_0 ~= var_1_10003.Submarine then
		assert = var_89_0
	...
	local var_89_1 = arg_89_1 or arg_89_0.startPos
	local var_89_2 = arg_89_0
	local var_89_3 = arg_89_0.getShipsByTeam

	TeamType = var_1_10006

	local var_89_4 = var_89_3(var_89_2, var_1_10006.Submarine, true)[1]
	local var_89_5 = arg_89_0
	local var_89_6 = arg_89_0.triggerSkill

	FleetSkill = var_7

	local var_89_7

	if not var_89_6(var_89_5, var_7.TypeHuntingLv) then
		var_89_7 = 0
	end

	local var_89_8 = var_89_4:getHuntingRange(var_89_4:getHuntingLv() + var_89_7)

	_ = var_89_5

	return (var_89_5.map(var_89_8, function(arg_90_0)
		return {
			row = var_89_1.row + arg_90_0[1],
			column = var_89_1.column + arg_90_0[2]
		}
	end))
end
...
function var_0_1.getSummonCost(arg_93_0)
	...
	return var_1_10002.reduce(var_93_0, 0, function(arg_94_0, arg_94_1)
...
function var_0_1.getMapAura(arg_95_0)
	...
	for iter_95_0, iter_95_1 in var_1_10002(arg_95_0.ships) do
		...
		for iter_95_2, iter_95_3 in var_1_10008(var_95_1) do
			table = var_1_10013
...
function var_0_1.getMapAid(arg_96_0)
	...
	for iter_96_0, iter_96_1 in var_1_10002(arg_96_0.ships) do
		...
		for iter_96_2, iter_96_3 in var_1_10008(var_96_1) do
			local var_96_2
			...
			var_1_10014.insert(var_96_2, iter_96_3)
...
function var_0_1.updateCommanderSkills(arg_97_0)
	...
	for iter_97_0, iter_97_1 in var_1_10002(var_97_0) do
		_ = var_1_10007
		...
		var_1_10007.each(iter_97_1:getSkills(), function(arg_98_0)
			...
			var_2_10001.each(arg_98_0:getTacticSkill(), function(arg_99_0)
				...
				local var_99_2 = var_3_10004.New

				FleetSkill = var_3_10006

				var_99_0(var_99_1, var_99_2(var_3_10006.SystemCommanderNeko, arg_99_0))
...
function var_0_1.findCommanderBySkillId(arg_106_0, arg_106_1)
	...
	for iter_106_0, iter_106_1 in var_1_10003(var_106_0) do
		_ = var_1_10008
...
function var_0_1.getFleetAirDominanceValue(arg_109_0)
	...
	for iter_109_0, iter_109_1 in var_1_10002(arg_109_0:getShips(false)) do
		calcAirDominanceValue = var_7
		var_109_0 = var_109_0 + var_7(iter_109_1, arg_109_0:getCommanders())
	end
...
function var_0_1.StaticTransformChapterFleet2Fleet(arg_110_0, arg_110_1)
	...
	local var_110_3 = var_110_0(var_110_2(var_110_1, var_1_10007.Vanguard, arg_110_1), "id")

	table = var_1_10003

	local var_110_4 = var_1_10003.insertto
	local var_110_5 = var_110_3

	_ = var_110_1

	local var_110_6 = var_110_1.pluck
	local var_110_7 = arg_110_0
	local var_110_8 = arg_110_0.getShipsByTeam

	TeamType = var_1_10011

	var_110_4(var_110_5, var_110_6(var_110_8(var_110_7, var_1_10011.Main, arg_110_1), "id"))

	local var_110_9 = {}

	pairs = var_4

	for iter_110_0, iter_110_1 in var_4(arg_110_0.commanders) do
		table = var_9
	...
	FleetType = iter_110_0
	var_110_11.fleetType = iter_110_0.Normal
