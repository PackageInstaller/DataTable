...
function var_0_1.GetExpireSoonTipFlag(arg_10_0)
	...
	return var_1_10002.GetInt(var_10_1 .. "_dorm3dGiftExpireSoonTip_" .. arg_10_0, 0)
end
...
function var_0_1.SetExpireSoonTipFlag(arg_11_0)
	...
	var_2.SetInt(var_11_2 .. "_dorm3dGiftExpireSoonTip_" .. arg_11_0, 1)
...
function var_0_1.GetShopID(arg_12_0)
	...
	local var_12_1 = var_1_10002(var_4)
	local var_12_2 = var_2.GetGiftShopCount(var_12_1, arg_12_0.configId)
	...
	for iter_12_0 = 1, #var_12_0 - 1 do
		...
		if not var_1_10008.shop_template[var_12_3].limit_args[1] and var_1_10008.group_type == 0 then
			return var_12_3
		elseif var_9 and (var_9[1] == "dailycount" or var_9[1] == "count") then
			if var_12_2 < var_9[3] then
				return var_12_3
			end
		elseif var_1_10008.group_type == 2 then
			if var_12_2 < var_1_10008.group_limit then
				return var_12_3
			end
		else
			return var_12_3
...
function var_0_1.CheckBuyLimit(arg_13_0)
	...
	local var_13_2 = var_1_10002.shop_template[var_13_1]

	getProxy = var_13_0
	ApartmentProxy = var_1_10005

	local var_13_3 = var_13_0(var_1_10005)
	...
	if var_13_2.limit_args then
		...
		if var_13_3(var_13_5) == "table" and (var_13_5[1] == "dailycount" or var_13_5[1] == "count") and var_13_4 >= var_13_5[3] then
			return false
		end
	end
...
function var_0_1.NeedViewTip(arg_14_0)
	...
	return var_1_10003.any(var_14_1, function(arg_15_0)
		if arg_15_0 == 0 then
			return
		end
...
function var_0_1.GetViewedFlag(arg_18_0)
	...
	return var_1_10002.GetInt(var_18_1 .. "_dorm3dGiftViewed_" .. arg_18_0, 0)
end
...
function var_0_1.SetViewedFlag(arg_19_0)
	...
	var_2.SetInt(var_19_2 .. "_dorm3dGiftViewed_" .. arg_19_0, 1)
