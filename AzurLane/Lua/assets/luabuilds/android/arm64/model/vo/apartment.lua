...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_1 = var_2.insert
	local var_1_2 = arg_1_0.skinList
	local var_1_3 = arg_1_0

	var_1_1(var_1_2, arg_1_0.getConfig(var_1_3, "skin_model"))
	...
	for iter_1_0, iter_1_1 in var_1_1(var_1_4) do
		table = var_1_3

		var_1_3.insert(arg_1_0.skinList, iter_1_1)
	end
	...
	for iter_1_2, iter_1_3 in var_2(var_1_5) do
		...
		var_1_3.insert(arg_1_0.hiddenInfo, {
			skin_id = iter_1_3.id,
			hidden_parts = {}
		})
		...
		for iter_1_4, iter_1_5 in var_1_3(var_1_6) do
			table = var_1_10012
	...
	for iter_1_6, iter_1_7 in var_2(var_1_7) do
	...
	for iter_1_8, iter_1_9 in var_2(var_1_8) do
...
function var_0_1.GetSkinModelID(arg_14_0, arg_14_1)
	...
	if arg_14_1 and arg_14_1 ~= "" then
		...
		local var_14_1 = var_1_10003.detect

		pg = var_5

		local var_14_2

		if not var_5.dorm3d_resource.get_id_list_by_ship_group[arg_14_0.configId] then
			var_14_2 = {}
		end

		var_14_0 = var_14_1(var_14_2, function(arg_15_0)
			table = var_2_10001
			...
			return var_15_0(var_2_10003.dorm3d_resource[arg_15_0].tags, arg_14_1)
		end)
	end
...
function var_0_1.GetSetCallCd(arg_17_0)
	if arg_17_0.setCallCd then
		...
		local var_17_0 = var_1.TimeMgr.GetInstance()
		local var_17_1 = var_1.GetServerTime(var_17_0)

		if arg_17_0.setCallCd <= var_17_1 then
			return 0
		end

		local var_17_2 = arg_17_0.setCallCd

		pg = var_1_10002

		local var_17_3 = var_1_10002.TimeMgr.GetInstance()

		return var_17_2 - var_2.GetServerTime(var_17_3)
	end
end
...
function var_0_1.GetHiddenParts(arg_18_0, arg_18_1)
	...
	if not var_1_10002.detect(arg_18_0.hiddenInfo, function(arg_19_0)
		...
		if var_1_10003.GetInt(var_0_1.GetSetSkinKey(arg_18_1), 0) == 0 then
...
function var_0_1.SetHiddenParts(arg_22_0, arg_22_1, arg_22_2)
	...
	if not var_3.detect(arg_22_0.hiddenInfo, function(arg_23_0)
		...
		var_1_10004.insert(arg_22_0.hiddenInfo, {
			skin_id = arg_22_1,
...
function var_0_1.getTalkingList(arg_24_0, arg_24_1)
	...
	if not var_1_10004.dorm3d_dialogue_group.get_id_list_by_char_id[arg_24_0.configId] then
		var_24_1 = {}
	end
...
var_0_1.ENTER_TALK_TYPE_DIC = {
	[101] = function(arg_27_0, arg_27_1)
		...
		local var_27_1 = var_1_10003.TimeMgr.GetInstance()
	...
	[102] = function(arg_28_0, arg_28_1)
		...
		return var_1_10002.any(arg_28_0, function(arg_29_0)
			...
			local var_29_0 = var_2_10001(var_2_10003)
...
function var_0_1.getEnterTalking(arg_32_0, arg_32_1)
	...
	for iter_32_0, iter_32_1 in var_1_10003(arg_32_0:getTalkingList({
		...
		local var_32_1 = var_32_1.dorm3d_dialogue_group[iter_32_1]

		switch = var_32_2

		if var_32_2(var_32_1.type, var_0_1.ENTER_TALK_TYPE_DIC, function(arg_33_0)
			return false
		end, var_32_1.trigger_config, arg_32_0.configId) then
			if var_32_0 then
				local var_32_2 = var_32_1.type

				pg = var_1_10010

				if var_32_2 < var_1_10010.dorm3d_dialogue_group[var_32_0[1]].type then
					var_32_0 = {
						iter_32_1
					}
				else
					var_32_2 = var_32_1.type
					pg = var_1_10010

					if var_32_2 == var_1_10010.dorm3d_dialogue_group[var_32_0[1]].type then
						table = var_32_2

						var_32_2.insert(var_32_0, iter_32_1)
					end
				end
			end
		end
...
function var_0_1.filterUnlockTalkList(arg_43_0, arg_43_1)
	...
	return var_1_10002.filter(arg_43_1, function(arg_44_0)
		...
		return var_44_0(var_2_10003.dorm3d_dialogue_group[arg_44_0].unlock)
	end)
end
...
function var_0_1.getIconTip(arg_45_0, arg_45_1)
	...
	if #arg_45_0.getForceEnterTalking(var_45_0, arg_45_1) > 0 then
		return "main"
	else
		getProxy = var_2
		ApartmentProxy = var_45_0

		local var_45_1 = var_2(var_45_0)
...
function var_0_1.CheckAllCollectionTrack()
	...
	local var_48_0 = var_1_10000(var_1_10002)
	...
	for iter_48_0, iter_48_1 in var_48_0(var_1_10004.dorm3d_recall.all) do
		pg = var_1_10007
		...
		if var_48_2[var_1_10009.dorm3d_dialogue_group[var_1_10008].char_id] == nil then
			...
			if not var_10.getApartment(var_1_10012, var_1_10009) then
				var_48_3 = false
			end
	...
	local var_48_4 = var_2(var_4).shopCount

	ipairs = var_3
	pg = iter_48_0

	for iter_48_2, iter_48_3 in var_3(iter_48_0.dorm3d_shop_template.all) do
		pg = var_1_10008
	...
	local var_48_5 = var_3(var_5)
	local var_48_6 = var_3.getRawData(var_48_5).id

	PlayerPrefs = var_4

	if var_4.GetInt("APARTMENT_ALL_COLLECTION:" .. var_48_6, 0) < var_48_1 then
		PlayerPrefs = var_4
		...
		var_48_8(var_48_7, var_7.BuildAllCollection(20002, var_48_1))
	end
