...
local var_0_2 = var_0_10001.activity_random_award_item
...
function var_0_1.enoughResForUsage(arg_4_0, arg_4_1)
	...
	local var_4_1 = arg_4_0.getComsume(var_4_0).type

	DROP_TYPE_RESOURCE = var_4_0

	if var_4_1 == var_4_0 then
		getProxy = var_4_1
		PlayerProxy = var_1_10005
		var_1_10005 = var_4_1(var_1_10005)

		local var_4_2 = var_3.getData(var_1_10005)

		if var_3.getResById(var_4_2, var_2.id) < var_2.count * arg_4_1 then
			return false
		end
	else
		local var_4_3 = var_2.type

		DROP_TYPE_ITEM = var_4_0

		if var_4_3 == var_4_0 then
			getProxy = var_4_3
			BagProxy = var_1_10005

			local var_4_4 = var_4_3(var_1_10005)

			if var_3.getItemCountById(var_4_4, var_2.id) < var_2.count * arg_4_1 then
				return false
			end
		end
	end
...
function var_0_1.getItemCount(arg_5_0)
	...
	return var_1_10002.reduce(var_5_0, 0, function(arg_6_0, arg_6_1)
...
function var_0_1.getFetchCount(arg_8_0)
	...
	return var_8_0(var_1_10003.values(arg_8_0.awards), 0, function(arg_9_0, arg_9_1)
...
function var_0_1.filterItems(arg_11_0, arg_11_1)
	...
	local var_11_2 = var_1_10003.select(arg_11_0:getConfig("item_list"), function(arg_12_0)
		if arg_11_1 then
			table = var_1
	...
	return (var_11_0.map(var_11_2, function(arg_13_0)
...
function var_0_1.getTempleNewChar(arg_17_0, arg_17_1)
	if not arg_17_0.charAwardDisplayData then
		...
		for iter_17_0, iter_17_1 in var_2(var_1_10004.guardian_template.all) do
			pg = var_1_10007

			if var_1_10007.guardian_template[iter_17_1].guardian_gain_pool == arg_17_0.configId then
				var_1_10008 = arg_17_0:getCharLotteryCount(iter_17_1)
				table = var_1_10009

				var_1_10009.insert(arg_17_0.charAwardDisplayData, {
					iter_17_1,
					var_1_10008
				})
			end
	...
	local var_17_0 = {}
	local var_17_1 = arg_17_0:getFetchCount()

	for iter_17_2 = arg_17_1 + 1, var_17_1 do
		ipairs = var_1_10008
		...
		for iter_17_3, iter_17_4 in var_1_10008(arg_17_0.charAwardDisplayData) do
			if iter_17_4[2] == iter_17_2 then
				...
				var_13.insert(var_17_0, iter_17_4[1])
			end
		end
	end
...
function var_0_1.getGuardianGot(arg_19_0, arg_19_1)
	...
	if var_19_0 == var_4.guardian_type_lottery then
		...
		local var_19_1 = arg_19_0.getFetchCount(var_1_10005)
		local var_19_2

		var_19_2 = var_2.guardian_gain[2] <= var_19_1
		math = var_19_3
		var_19_3 = var_19_3.max(var_2.guardian_gain[2] - arg_19_0:getFetchCount(), 0)

		return
	else
		local var_19_4 = var_2.type

		ActivityItemPool = var_19_3

		if var_19_4 == var_19_3.guardian_type_lock then
...
function var_0_1.GetAllGuardianIds(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10004(var_1_10006.guardian_template.all) do
		pg = var_1_10009
		...
		if var_1_10010.contains(var_20_2, var_1_10009.guardian_gain_pool) then
			...
			var_1_10011.insert(var_20_1, var_1_10010)
		end
	end
...
function var_0_1.GetAllGuardianIdsStatus(arg_21_0)
	...
	ActivityConst = var_21_1

	if var_21_3 ~= var_21_1.ACTIVITY_TYPE_LOTTERY then
		return {}
	end
	...
	for iter_21_0, iter_21_1 in var_1_10007(var_21_7) do
		var_1_10012 = var_21_2:getAwardInfos()[iter_21_1]
	...
	for iter_21_2, iter_21_3 in var_7(var_9.guardian_template.all) do
		pg = var_1_10012
		...
		if var_1_10013.contains(var_21_7, var_1_10012.guardian_gain_pool) then
			...
			if var_21_6[var_1_10012.guardian_gain_pool] then
				local var_21_8 = var_14
				local var_21_9, var_21_10 = var_14.getGuardianGot(var_21_8, var_1_10013)

				if var_21_9 then
					table = var_21_8

					var_21_8.insert(var_21_4, var_1_10013)
				else
					table = var_21_8

					var_21_8.insert(var_21_5, {
						var_1_10013,
						var_21_10
					})
				end
...
function var_0_1.GetGuardianLastCount(arg_22_0, arg_22_1)
	...
	ActivityConst = var_22_1

	if var_22_3 ~= var_22_1.ACTIVITY_TYPE_LOTTERY then
		return {}
	end
	...
	local var_22_5 = var_22_2:getAwardInfos()[var_22_4]

	ActivityItemPool = var_6

	local var_22_6 = var_6.CreateItemPool(var_22_4, var_22_5, nil, 1)

	return var_6.getGuardianGot(var_22_6, arg_22_1)
end
...
function var_0_1.GetTempleRedTip(arg_24_0, arg_24_1)
	...
	local var_24_0 = var_1_10003(var_1_10005)
	...
	local var_24_1 = var_1_10004(var_6)
	local var_24_2 = var_4.getData(var_24_1)

	pg = var_24_0

	local var_24_3 = var_24_0.activity_template[arg_24_0].config_data
	local var_24_4 = 0
	local var_24_5 = 0
	...
	for iter_24_0, iter_24_1 in var_1_10008(var_24_3) do
		...
		math = var_1_10016
		var_1_10016 = var_1_10016.max

		local var_24_9 = var_24_4

		math = var_1_10019
		var_24_4 = var_1_10016(var_24_9, var_1_10019.floor(var_24_8 / var_24_6))
		var_1_10016 = var_3:getAwardInfos()[iter_24_1]
		ActivityItemPool = var_24_7

		local var_24_10 = var_24_7.CreateItemPool(iter_24_1, var_1_10016, nil, 1)

		var_24_5 = var_24_5 + var_17.getleftItemCount(var_24_10)
	end
	...
	if var_2.config_client.red_tip_time then
		...
		local var_24_12 = var_10.TimeMgr.GetInstance()

		return var_10.GetServerTime(var_24_12) - var_24_11 > 0 and var_24_4 > 1
	end
