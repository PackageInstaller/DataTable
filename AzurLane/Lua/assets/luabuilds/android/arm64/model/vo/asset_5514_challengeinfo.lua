...
function var_0_1.checkRecord(arg_3_0, arg_3_1)
	...
	local var_3_1 = arg_3_1.getMode(var_3_0)
	local var_3_2 = arg_3_1
	local var_3_3 = arg_3_1.getScore(var_3_2)

	ChallengeProxy = var_3_0

	if var_3_1 == var_3_0.MODE_CASUAL then
		math = var_4
		arg_3_0._activityMaxScore = var_4.max(var_3_3, arg_3_0._activityMaxScore)
		math = var_4
		arg_3_0._seasonMaxScore = var_4.max(var_3_3, arg_3_0._seasonMaxScore)
	end

	local var_3_4 = arg_3_1:getLevel() - 1

	math = var_3_2
	arg_3_0._activityMaxLevel = var_3_2.max(var_3_4, arg_3_0._activityMaxLevel)
	math = var_5
