...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".Dorm3dInsRoom"))
...
function var_0_1.GetFurnitureNum(arg_3_0)
	...
	return #var_1_10002.keys(var_1:GetFurnitures())
end
...
function var_0_1.GetLastVisit(arg_6_0)
	...
	if var_6_1 == 0 then
		...
		return var_6_0("dorm3d_privatechat_no_visit_time")
	end

	math = var_6_0

	local var_6_2 = var_6_0.floor

	pg = var_1_10005

	local var_6_3 = var_1_10005.TimeMgr.GetInstance()

	if var_6_2((var_5.GetServerTime(var_6_3) - var_6_1) / 0) == 0 then
		i18n = var_6_4
...
function var_0_1.GetCard(arg_8_0)
	...
	return var_1_10002.format("dorm3dselect/apartment_skin_%d", var_8_1)
end
...
function var_0_1.GetInsContent(arg_12_0)
	...
	if arg_12_0.IsDownloaded(var_12_0) then
		...
		if var_1.AnyInstagramShouldTip(var_12_1, arg_12_0.groupId) then
			local var_12_2 = true

			i18n = var_1_10002
			var_1_10002 = var_1_10002("dorm3d_privatechat_new_topics", arg_12_0:GetConfig("room"))
	...
	do
		...
		local var_12_4 = var_1_10002("dorm3d_privatechat_nonew_topics")
...
function var_0_1.GetPhoneContent(arg_13_0)
	...
	if arg_13_0.IsDownloaded(var_13_0) then
		...
		if var_1.ShoudTipPhoneById(var_13_1, arg_13_0.groupId) then
			local var_13_2 = true

			i18n = var_1_10002
			var_1_10002 = var_1_10002("dorm3d_privatechat_new_calls")
	...
	do
		...
		local var_13_4 = var_1_10002("dorm3d_privatechat_nonew_calls")
...
function var_0_1.GetChatContent(arg_14_0)
	...
	if arg_14_0.IsDownloaded(var_14_0) then
		...
		local var_14_1 = var_1(var_14_0)

		if var_1.ShouldShowShipTip(var_14_1, arg_14_0.groupId) then
			local var_14_2 = true

			i18n = var_1_10002
			var_1_10002 = var_1_10002("dorm3d_privatechat_nonew_messages")
	...
	do
		...
		local var_14_4 = var_1_10002("dorm3d_privatechat_new_messages")
