...
function var_0_1.ReduceClean(arg_21_0)
	...
	local var_21_2 = arg_21_0.getConfig(var_21_1, "flower")[2]
	local var_21_3 = arg_21_0:GetCatteries()

	pairs = var_21_1

	for iter_21_0, iter_21_1 in var_21_1(var_21_3) do
		if iter_21_1:IsDirty() then
			arg_21_0.clean = arg_21_0.clean - var_21_2
...
function var_0_1.GetCleanLevel(arg_22_0)
	...
	local var_22_1 = arg_22_0.getConfig(var_22_0, "flower")[3]
	local var_22_2 = 0
...
function var_0_1.AnyCatteryCanUse(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1_10001(arg_29_0:GetCatteries()) do
		...
		if var_29_0 == var_1_10007.STATE_EMPTY then
			return true
		end
	end
...
function var_0_1.ShouldSettleCattery(arg_34_0)
	...
	for iter_34_0, iter_34_1 in var_1_10002(var_34_0) do
