...
function var_0_1.GetTargetSlotID(arg_9_0)
	...
	var_1_10002(var_9_0, "Missing Target Slot Dorm3dFurniture ID: " .. arg_9_0:GetConfigID())
...
function var_0_1.InShopTime(arg_16_0)
	...
	local var_16_1 = var_1_10002.shop_template[var_1]
...
function var_0_1.GetEndTime(arg_17_0)
	...
	local var_17_1 = var_1_10002.shop_template[var_1]

	assert = var_17_0

	var_17_0(var_17_1, "Missing shopCfg " .. (var_1 or "NIL"))
	...
	local var_17_2 = var_1_10004.TimeMgr.GetInstance()
...
function var_0_1.NeedViewTip(arg_18_0)
	if arg_18_0 then
		...
		var_1_10001[1] = var_1_10002.getRoom(var_18_0, arg_18_0)
		...
		if not var_1_10001 then
			...
			var_1_10001 = var_1_10001(var_1_10003(var_1_10005).roomData)
		end
...
function var_0_1.NeedViewTipByFurnitureId(arg_21_0)
	local function var_21_0(arg_22_0)
		...
		local var_22_1 = var_2_10002(var_2_10004)

		return var_2.getRoom(var_22_1, var_22_0) and var_2:HasFurniture(arg_22_0)
	end
...
function var_0_1.GetViewedFlag(arg_23_0)
	...
	return var_1_10002.GetInt(var_23_1 .. "_dorm3dFurnitureViewed_" .. arg_23_0, 0)
end
...
function var_0_1.SetViewedFlag(arg_24_0)
	...
	local var_24_1 = var_24_0(var_3)
	local var_24_2 = var_1.getRawData(var_24_1).id

	PlayerPrefs = var_2

	var_2.SetInt(var_24_2 .. "_dorm3dFurnitureViewed_" .. arg_24_0, 1)
...
function var_0_1.IsTimelimitShopTip(arg_25_0)
	if arg_25_0 then
		...
		var_1_10001[1] = var_1_10002.getRoom(var_25_0, arg_25_0)
...
function var_0_1.RecordLastTimelimitShopFurniture()
	...
	local var_28_2 = var_1_10001.GetInt(var_28_1 .. "_dorm3dTimelimitFurniture", 0)
	...
	local var_28_4 = var_28_3(var_1_10005(var_1_10007).roomData)
...
function var_0_1.IsOnceTimelimitShopTip()
	...
	local var_31_2 = var_1_10001.GetInt(var_31_1 .. "_dorm3dTimelimitFurniture", 0)

	underscore = var_31_0

	local var_31_3 = var_31_0.values

	getProxy = var_4
	ApartmentProxy = var_1_10006

	local var_31_4 = var_31_3(var_4(var_1_10006).roomData)
	...
	return var_3.any(var_31_4, function(arg_32_0)
		...
		if not var_2_10002.dorm3d_furniture_template.get_id_list_by_room_id[arg_32_0:GetConfigID()] then
			var_32_1 = {}
		end

		_ = var_3

		return var_3.any(var_32_1, function(arg_33_0)
			...
			if var_1.GetEndTime(var_33_0) > 0 then
				if var_1:InShopTime() then
					_ = var_33_1
					var_33_1 = not var_33_1.detect(var_32_0, function(arg_34_0)
