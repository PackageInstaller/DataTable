...
function var_0_1.getName(arg_3_0)
	...
	if not arg_3_0:getConfig("name") and not var_3_1:getConfig("name") then
		var_3_2 = ""
	end
...
function var_0_1.getConsumeDesc(arg_5_0)
	...
	local var_5_2 = arg_5_0.getConfig(var_5_1, "use_item")
	local var_5_3 = arg_5_0
	local var_5_4 = arg_5_0.getConfig(var_5_3, "number_1")

	Item = var_5_1

	local var_5_5 = var_5_1.New({
		id = var_5_2
	})

	i18n = var_5_3

	return var_5_3("commander_build_pool_tip", var_5_5:getConfig("name"), var_5_4)
end
...
function var_0_1.getItemCount(arg_7_0)
	...
	return var_2.getItemCountById(var_7_1, var_7_0)
end
