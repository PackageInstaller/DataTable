...
function var_0_1.isResurrectionRace(arg_3_0)
	local var_3_0 = arg_3_0:getConfig("type")

	VoteConst = var_1_10002

	return var_3_0 == var_1_10002.RACE_TYPE_RESURGENCE
end
...
function var_0_1.isFinalsRace(arg_4_0)
	...
	return var_4_0 == var_1_10002.RACE_TYPE_FINAL
end

function var_0_1.IsPrevResurrectionRace(arg_5_0)
	local var_5_0 = arg_5_0:getConfig("type")

	VoteConst = var_1_10002

	return var_5_0 == var_1_10002.RACE_TYPE_PRE_RESURGENCE
end

function var_0_1.IsFunRace(arg_6_0)
	local var_6_0 = arg_6_0:getConfig("type")

	VoteConst = var_1_10002

	return var_6_0 == var_1_10002.RACE_TYPE_FUN
end
...
function var_0_1.GetRankMark(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1_10004(var_10_2) do
		...
		if var_1_10011.activity_vote[var_10_3] then
			local var_10_5 = var_1_10011.type

			VoteConst = var_1_10013

			if var_10_5 ~= var_1_10013.RACE_TYPE_RESURGENCE then
				local var_10_6 = var_1_10011.type

				VoteConst = var_1_10013

				if var_10_6 == var_1_10013.RACE_TYPE_PRE_RESURGENCE then
					var_10_1 = #var_10_4
...
function var_0_1.updateRankMap(arg_15_0)
	if arg_15_0:IsOpening() then
		...
		var_1_10002.sort(arg_15_0.list, function(arg_16_0, arg_16_1)
...
function var_0_1.GetStage(arg_18_0)
	...
	local var_18_2 = arg_18_0.getConfig(var_18_1, "time_vote_client")
	local var_18_3 = arg_18_0:getConfig("time_show")

	pg = var_18_1

	local var_18_4 = var_18_1.TimeMgr.GetInstance()
	...
	if var_4.inTime(var_18_4, var_18_0) then
		...
		if var_4.inTime(var_18_5, var_18_2) then
...
function var_0_1.GetTimeDesc(arg_21_0, arg_21_1)
	...
	if arg_21_1 == 1 then
		...
		if not var_1_10003("word_maintain") then
			var_1_10003 = "("
			string = var_4
			var_1_10003 = var_1_10003 .. var_4.format("%02u:%02u", arg_21_0[1][2][1], arg_21_0[1][2][2]) .. ")"
		end

		local var_21_1 = " ~ "
		local var_21_2 = arg_21_0[2][1][1]
		local var_21_3 = "."
		local var_21_4 = arg_21_0[2][1][2]
		local var_21_5 = "."
		local var_21_6 = arg_21_0[2][1][3]
		local var_21_7 = "("

		string = var_1_10011

		return var_21_0 .. var_1_10003 .. var_21_1 .. var_21_2 .. var_21_3 .. var_21_4 .. var_21_5 .. var_21_6 .. var_21_7 .. var_1_10011.format("%02u:%02u", arg_21_0[2][2][1], arg_21_0[2][2][2]) .. ")"
	end
end
...
function var_0_1.GetTimeDesc2(arg_22_0, arg_22_1)
	...
	if arg_22_1 == 1 then
		...
		if not (var_1_10003 .. var_4("word_maintain") .. "</size>") then
			var_1_10003 = "("
			string = var_4
			var_1_10003 = var_1_10003 .. var_4.format("<size=18>%02u:%02u</size>", arg_22_0[1][2][1], arg_22_0[1][2][2]) .. ")"
		end

		local var_22_1 = " ~ "
		local var_22_2 = arg_22_0[2][1][1]
		local var_22_3 = "."
		local var_22_4 = arg_22_0[2][1][2]
		local var_22_5 = "."
		local var_22_6 = arg_22_0[2][1][3]
		local var_22_7 = "<size=18>("

		string = var_1_10011

		local var_22_8 = var_22_0 .. var_1_10003 .. var_22_1 .. var_22_2 .. var_22_3 .. var_22_4 .. var_22_5 .. var_22_6 .. var_22_7 .. var_1_10011.format("%02u:%02u", arg_22_0[2][2][1], arg_22_0[2][2][2]) .. ")</size>"

		return "<size=21>" .. var_22_8 .. "</size>"
	end
end
