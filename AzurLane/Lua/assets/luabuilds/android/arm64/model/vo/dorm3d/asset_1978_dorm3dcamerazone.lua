...
function var_0_1.Ctor(arg_2_0, arg_2_1)
	...
	arg_2_0.specialAnims = var_2.map(arg_2_0:GetSpecialFurnitureIDList(), function(arg_4_0)
		...
		var_4_1.anims = var_4_2(var_5.GetSpecialAnimIDListByFurnitureID(var_4_3, var_4_0), function(arg_5_0)
...
function var_0_1.GetAllSpecialList(arg_11_0, arg_11_1)
	...
	for iter_11_0, iter_11_1 in var_1_10003(var_1_10005.dorm3d_camera_anim_template.get_id_list_by_furniture_id) do
		...
		if iter_11_0 ~= 0 and var_1_10008(iter_11_0) and not arg_11_0.specialFurnitureDic[iter_11_0] then
			...
			for iter_11_2, iter_11_3 in var_1_10010(iter_11_1) do
				table = var_1_10015
				var_1_10015 = var_1_10015.insert

				local var_11_2 = var_11_1

				Dorm3dCameraAnim = var_1_10018

				var_1_10015(var_11_2, var_1_10018.New({
					configId = iter_11_3
				}))
			end
