...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	pg = var_1_10003
	arg_1_0.storyList = var_1_10003.activity_template[var_1_0].config_client.story
	pg = var_3
	...
	arg_1_0.totalGold = 0
	arg_1_0.settleGold = var_1_1
	ipairs = var_1_1

	for iter_1_0, iter_1_1 in var_1_1(arg_1_1.date1_key_value_list) do
		if iter_1_1.key == 1 then
			...
			for iter_1_2, iter_1_3 in var_8(iter_1_1.value_list) do
				...
				local var_1_2 = var_1_10013.New(iter_1_3.key, iter_1_3.value)

				if var_1_10013.GetLevel(var_1_2) ~= 0 or arg_1_0.data2 >= var_1_10013:GetNeedTownLv() then
...
function var_0_1.UpdateTime(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10002(arg_13_0.slotData) do
...
function var_0_1.GetUnlockStoryCnt(arg_15_0)
	...
	return var_15_0(var_1_10003.flatten(arg_15_0.storyList), 0, function(arg_16_0, arg_16_1)
		pg = var_2_10002
...
function var_0_1.OnUpgradeTown(arg_19_0, arg_19_1)
	...
	local var_19_1 = arg_19_0.levelCfg
	local var_19_2 = arg_19_0

	for iter_19_0, iter_19_1 in var_3(var_19_1[arg_19_0.GetTownLevel(var_19_2)].unlock_work[1]) do
		TownWorkplace = var_19_2
		var_19_2 = var_19_2.New(iter_19_1, arg_19_1)
		arg_19_0.placeData[var_19_2:GetGroup()] = var_19_2
	end
...
function var_0_1.ResetAllPlace(arg_20_0, arg_20_1)
	...
	for iter_20_0, iter_20_1 in var_1_10003(arg_20_0.placeData) do
		...
		math = var_1_10009
		var_20_0 = var_20_0 + var_1_10009.floor(var_20_1 * (1 + arg_20_0.buffFactor))
	end
...
function var_0_1.OnUpgradePlace(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_3 = arg_22_0.placeData

	TownWorkplace = var_22_1
	var_22_3[var_22_0] = var_22_1.New(var_4:GetNextId(), arg_22_2)

	arg_22_0:UpdateTotalGold(arg_22_2)

	local var_22_4 = var_4:GetType()

	TownWorkplace = var_7

	if var_22_4 == var_7.TYPE.RATIO then
...
function var_0_1.IsOverGold(arg_32_0, arg_32_1)
	...
	if arg_32_0.totalGold + var_32_0 <= arg_32_0:GetLimitGold() then
		...
		local var_32_2 = arg_32_0.GetLimitGold(var_32_1) - (arg_32_0.totalGold + var_32_0)
		local var_32_3 = true

		math = var_32_1

		local var_32_4 = var_32_1.floor(var_32_2 / 1000)
...
function var_0_1.getVitemNumber(arg_36_0, arg_36_1)
	...
	var_1_10002(var_1_10004.item_virtual_data_statistics[arg_36_1].link_id == arg_36_0.id)
...
function var_0_1.subVitemNumber(arg_37_0, arg_37_1, arg_37_2)
	...
	var_1_10003(var_1_10005.item_virtual_data_statistics[arg_37_1].link_id == arg_37_0.id)
...
function var_0_1.GoldToShow(arg_40_0)
	...
	if arg_40_0 / 1000 >= var_0_1.Billion then
		...
		local var_40_2 = var_40_1 - #var_1_10003(var_1_10005.floor(var_40_0))
	...
	elseif arg_40_0 >= var_0_1.Million then
		...
		local var_40_5 = var_40_4 - #var_1_10003(var_1_10005.floor(var_40_3))
	...
	elseif arg_40_0 >= var_0_1.Thousand then
		...
		local var_40_8 = var_40_7 - #var_1_10003(var_1_10005.floor(var_40_6))
