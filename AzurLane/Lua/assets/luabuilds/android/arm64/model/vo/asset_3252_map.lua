...
function var_0_1.isUnlock(arg_3_0)
	...
	if var_1.getRawData(var_3_0).level < arg_3_0:getConfig("level_limit") then
		...
		i18n = var_3_2
		var_3_2 = var_3_2("levelScene_chapter_unlock_tip", arg_3_0:getConfig("level_limit"))
	...
	elseif arg_3_0:isActivity() then
		...
		if arg_3_0.isRemaster(var_3_3) then
			...
			if arg_3_0.isAnyChapterUnlocked(var_3_3) then
				...
				var_3_4 = false
				i18n = var_3_2
				var_3_2 = var_3_2("battle_levelScene_lock")
			...
			if not var_2.getActivityById(var_3_5, arg_3_0:getConfig("on_activity")) or var_2:isEnd() then
				var_3_2 = false
				i18n = var_3_5

				local var_3_6 = var_3_5("common_activity_end")
				...
				var_3_2, var_3_8 = arg_3_0.isAnyChapterUnlocked(var_3_7, true)
				...
				if var_3_2 then
					...
					if var_3_8 then
						var_3_7 = false
						i18n = var_3_9
						var_3_9 = var_3_9("battle_levelScene_close")

						return
					else
						ChapterConst = var_3_7

						if var_3_7.IsAtelierMap(arg_3_0) and arg_3_0:isHardMap() then
							local var_3_10 = false

							i18n = var_3_9
							var_3_9 = var_3_9("battle_levelScene_ryza_lock")
							...
							local var_3_12 = var_3_9("battle_levelScene_lock")
		...
		local var_3_13 = arg_3_0:getMapType()

		Map = var_3_2

		local var_3_15

		if var_3_13 == var_3_2.SCENARIO then
			if arg_3_0:isAnyChapterUnlocked(false) then
				...
				i18n = var_3_15
				var_3_15 = var_3_15("battle_levelScene_lock")

				return
			end
		else
			local var_3_16 = arg_3_0:getMapType()

			Map = var_3_15

			if var_3_16 == var_3_15.ELITE then
				if arg_3_0:isEliteEnabled() then
					...
					local var_3_18 = var_3("battle_levelScene_hard_lock")
...
function var_0_1.getChapters(arg_11_0)
	...
	return var_1_10001.filter(arg_11_0:GetChapterItems(), function(arg_12_0)
		...
		return var_2_10001(var_12_0, var_2_10004)
	end)
end
...
function var_0_1.getChapterTimeLimit(arg_16_0)
	...
	if arg_16_0.isActivity(var_16_0) then
		var_16_0 = arg_16_0

		if arg_16_0.isRemaster(var_16_0) then
			return 0
		end

		pg = var_1

		local var_16_1 = var_1.TimeMgr.GetInstance()
		local var_16_2 = 0

		ipairs = var_16_0

		for iter_16_0, iter_16_1 in var_16_0(arg_16_0:getChapters()) do
			pg = var_1_10008

			if var_1_10008.activity_template[iter_16_1:GetBindActID()] and var_1_10008.time and #var_1_10008.time == 3 then
				local var_16_3 = var_16_1:parseTimeFromConfig(var_1_10008.time[2]) - var_16_1:GetServerTime()
				...
				if 0 < var_16_3 then
					if var_16_2 == 0 then
						...
						math = var_10
						var_16_2 = var_10.min(var_16_2, var_16_3)
					end
				end
			end
		end
...
function var_0_1.isClearForActivity(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10002(var_18_0) do
...
function var_0_1.isEliteEnabled(arg_19_0)
	...
	if arg_19_0.getMapType(var_19_1) == var_0_1.ELITE then
		getProxy = var_2
		ChapterProxy = var_19_1

		local var_19_2 = var_2(var_19_1)

		var_19_0 = var_2.getMapById(var_19_2, arg_19_0:getBindMapId())
	else
		var_19_0 = arg_19_0
	end
	...
	if var_19_0:isAllChaptersClear() then
		var_19_3 = var_19_0:isAllChaptersAchieve()
	end
...
function var_0_1.GetRearChaptersOfRemaster(arg_29_0)
	...
	local var_29_2 = var_29_1(var_1_10004.GetChapterIds(arg_29_0), {}, function(arg_30_0, arg_30_1)
	...
	var_4.Foreach(var_29_2, function(arg_31_0, arg_31_1)
		...
		local var_31_1 = var_2_10003.filter(arg_31_1, function(arg_33_0)
			local var_33_0
		...
		var_31_2(var_31_3, var_2_10007.max(var_31_1))
...
function var_0_1.isActivity(arg_34_0)
	...
	if var_34_0 == var_1_10002.EVENT then
	...
	if var_34_0 ~= var_2.ACTIVITY_EASY then
		Map = var_2

		if var_34_0 ~= var_2.ACTIVITY_HARD then
			Map = var_2

			if var_34_0 == var_2.ACT_EXTRA then
				return true, true
			else
				return false
			end
...
function var_0_1.isHardMap(arg_35_0)
	...
	if var_35_0 ~= var_1_10002.ELITE then
		Map = var_2

		if var_35_0 ~= var_2.ACTIVITY_HARD then
			var_35_1 = false
...
function var_0_1.isActExtra(arg_36_0)
	local var_36_0 = arg_36_0:getMapType()

	Map = var_1_10002

	return var_36_0 == var_1_10002.ACT_EXTRA
end

function var_0_1.isEscort(arg_37_0)
	local var_37_0 = arg_37_0:getMapType()

	Map = var_1_10002

	return var_37_0 == var_1_10002.ESCORT
end

function var_0_1.isSkirmish(arg_38_0)
	local var_38_0 = arg_38_0:getMapType()

	Map = var_1_10002

	return var_38_0 == var_1_10002.SKIRMISH
end
...
function var_0_1.isNormalMap(arg_39_0)
	...
	return var_39_0(var_1_10003.NORMAL_MAP, arg_39_0:getMapType())
end
