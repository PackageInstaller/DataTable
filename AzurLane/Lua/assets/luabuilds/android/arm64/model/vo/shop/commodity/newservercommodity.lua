...
function var_0_1.IsOpening(arg_12_0, arg_12_1)
	...
	local var_12_2 = arg_12_1 + arg_12_0.getConfig(var_12_1, "unlock_time")

	pg = var_12_1

	local var_12_3 = var_12_1.TimeMgr.GetInstance()

	if not (var_12_2 <= var_5.GetServerTime(var_12_3)) then
		pg = var_12_3

		local var_12_4 = var_12_3.TimeMgr.GetInstance()
		local var_12_5, var_12_6, var_12_7, var_12_8 = var_7.parseTimeFrom(var_12_4, var_12_2 - var_5)

		var_12_0.day = var_12_5
		var_12_0.hour = var_12_6
	end
...
function var_0_1.CheckTimeLimit(arg_18_0)
	...
	local var_18_4 = arg_18_0.getConfig(var_18_3, "type")
	local var_18_5 = arg_18_0
	local var_18_6 = arg_18_0.getConfig(var_18_5, "goods")[1]

	Item = var_18_3

	local var_18_7 = var_18_3.getConfigData(var_18_6)

	DROP_TYPE_VITEM = var_18_5

	if var_18_4 == var_18_5 and var_18_7.virtual_type == 22 then
		var_18_0 = true
		var_18_2 = true
		getProxy = var_7
		ActivityProxy = var_1_10009

		local var_18_8 = var_7(var_1_10009)

		if var_7.getActivityById(var_18_8, var_18_7.link_id) and not var_8:isEnd() then
			var_18_1 = true
		end
	end
