...
local function var_0_2(arg_1_0)
	...
	if not var_0_1 then
		...
		var_1_0[var_1_10002] = function(arg_4_0)
			...
			var_2_10002(var_4_1 == var_2_10005.TypeFull)
	...
	var_1_0(arg_1_0.type, var_0_1, function(arg_5_0)
		...
		if var_2_10002 < var_5_0 then
			...
			local var_5_1 = var_5_0(var_2_10003)

			var_5_0 = var_5_0.getActivityById
			pg = var_2_10004

			if var_5_0(var_5_1, var_2_10004.activity_drop_type[arg_5_0.type].activity_id) then
				var_2_10004 = var_5_0

				if not var_5_0.isEnd(var_2_10004) then
					if arg_5_0.count > 0 then
						var_2_10004 = var_5_0

						var_5_0.addVitemNumber(var_2_10004, arg_5_0.id, arg_5_0.count)
					elseif arg_5_0.count < 0 then
						var_2_10004 = var_5_0

						var_5_0.subVitemNumber(var_2_10004, arg_5_0.id, -arg_5_0.count)
					end
				end
			end
			...
			var_2.updateActivity(var_2_10004, var_5_0)
		else
			assert = var_5_0
			...
			local var_5_3 = var_2_10004.format
			local var_5_4 = "without drop_type_%d owner logic from id_%d"

			type = var_2_10007

			var_5_0(var_5_2, var_5_3(var_5_4, var_2_10007, arg_5_0.id))
		end
...
function var_0_0.addTranDrop(arg_8_0, arg_8_1)
		...
		if var_8_3 == var_1_10010 then
			...
			if var_8_3.isMetaShipByConfigID(iter_8_3.id) then
				...
				if not var_9.isMetaShipNeedToTrans(iter_8_3.id) then
					...
					local var_8_4 = var_9(var_11)

					var_9.setMetaIDMark(var_8_4, iter_8_3.id)
				end
			end
		end
	end
	...
	for iter_8_4, iter_8_5 in var_5(arg_8_0) do
		local var_8_6 = iter_8_5
		local var_8_7, var_8_8 = iter_8_5.DropTrans(var_8_6, var_8_2, arg_8_1)

		if var_8_7 then
			var_8_6 = var_8_7.type
			DROP_TYPE_TIMESTAMP = var_13

			if var_8_6 ~= var_13 then
				table = var_8_6

				var_8_6.insert(var_8_5, var_8_7)

				pg = var_8_6

				local var_8_9 = var_8_6.m02

				var_8_6 = var_8_6.sendNotification
				GAME = var_1_10015

				var_8_6(var_8_9, var_1_10015.ADD_ITEM, var_8_7)
			end
		end
		...
		if var_8_8 then
			...
			local var_8_10 = var_8_6.m02
			local var_8_11 = var_12.sendNotification

			GAME = var_1_10015

			var_8_11(var_8_10, var_1_10015.ADD_ITEM, var_8_8)
		end
	end
...
function var_0_0.MergePassItemDrop(arg_10_0)
	if not var_0_7 then
		...
		var_10_3.PassItemOrder = var_1_10002(var_0_7, {
			__index = function(arg_11_0, arg_11_1)
				unpack = var_2_10002
				underscore = var_2_10004

				local var_11_0 = var_2_10004.map

				string = var_2_10006

				local var_11_1, var_11_2 = var_2_10002(var_11_0(var_2_10006.split(arg_11_1, "_"), function(arg_12_0)
	...
	local var_10_5 = var_1_10002.sort
	local var_10_6 = var_10_4

	CompareFuncs = iter_10_1

	var_10_5(var_10_6, iter_10_1({
		function(arg_13_0)
...
function var_0_0.CheckResForShopping(arg_15_0, arg_15_1)
	...
	if var_15_2 == var_1_10005 then
		...
		var_1_10006 = var_15_2(var_1_10006)

		local var_15_3 = var_4.getRawData(var_1_10006)
		...
		if var_15_4 == var_1_10005 then
			...
			local var_15_5 = var_15_4(var_1_10006)
...
function var_0_0.ConsumeResForShopping(arg_16_0, arg_16_1)
	...
	if var_16_1 == var_1_10004 then
		...
		var_1_10005 = var_16_1(var_1_10005)

		local var_16_2 = var_3.getData(var_1_10005)
		...
		id2res = var_1_10008
		var_16_3[var_1_10008(arg_16_0.id)] = var_16_0
		...
		if var_16_5 == var_1_10004 then
			...
			local var_16_6 = var_16_5(var_1_10005)
...
function var_0_0.GetTranAwards(arg_17_0, arg_17_1)
	...
	for iter_17_0, iter_17_1 in var_1_10004(var_17_0) do
		...
		if var_17_2 == var_1_10010 then
			...
			if not var_1_10010.getShipGroup(var_1_10012, var_17_3.group_type) then
				Ship = var_1_10011
				...
				if var_1_10011.inUnlockTip(iter_17_1.id) then
					...
					var_1_10011(var_17_4, var_1_10014("collection_award_ship", var_17_3.name))
				end
			end
		end
	end
...
function var_0_0.CanDropItem(arg_19_0)
	...
	if var_19_1(var_19_0, var_1_10005.UTAWARERU_ACTIVITY_PT_ID) and not var_2:isEnd() then
		var_1_10003 = var_2:getConfig("config_client").pt_id
		_ = var_19_0

		local var_19_2 = var_19_0.detect
		local var_19_3 = var_1
		local var_19_4 = var_1.getActivitiesByType

		ActivityConst = var_1_10009

		local var_19_5 = var_19_2(var_19_4(var_19_3, var_1_10009.ACTIVITY_TYPE_PT_RANK), function(arg_20_0)
			return arg_20_0:getConfig("config_id") == var_1_10003
		end)
		local var_19_6 = var_4.getData1(var_19_5)

		if 1500 <= var_19_6 then
			local var_19_7 = var_19_6 - 1500

			_ = var_5

			local var_19_8 = var_5.detect(arg_19_0, function(arg_21_0)
				local var_21_0 = arg_21_0.type

				DROP_TYPE_RESOURCE = var_2_10002

				return var_21_0 == var_2_10002 and arg_21_0.id == var_1_10003
			end)

			_ = var_19_5
			arg_19_0 = var_19_5.filter(arg_19_0, function(arg_22_0)
				local var_22_0 = arg_22_0.type

				DROP_TYPE_RESOURCE = var_2_10002

				return var_22_0 ~= var_2_10002 or arg_22_0.id ~= var_1_10003
			end)

			if var_19_8 and var_19_7 < var_19_8.count then
				var_19_8.count = var_19_8.count - var_19_7
				table = var_6

				var_6.insert(arg_19_0, var_19_8)
			end
		end
	end
	...
	return var_1_10003.getCount(arg_19_0) > 0
end
...
function var_0_0.CheckMedalAllCollectionTrack()
	...
	local var_25_0, var_25_1 = var_1_10000(var_1_10002("live_streaming26_data2")[2])
	local var_25_2 = 0

	getProxy = var_1_10003
	PlayerProxy = var_1_10005

	local var_25_3 = var_1_10003(var_1_10005)
	local var_25_4 = var_3.getRawData(var_25_3)

	pairs = var_4
	pg = var_1_10006

	for iter_25_0, iter_25_1 in var_4(var_1_10006.activity_medal_template.get_id_list_by_group) do
		math = var_1_10009
	...
	local var_25_6 = var_4(var_6)
	local var_25_7 = var_4.getRawData(var_25_6).id

	PlayerPrefs = var_5

	if var_5.GetInt("MEDAL_ALL_COLLECTION:" .. var_25_7, 0) < var_25_2 then
		PlayerPrefs = var_5
		...
		var_25_9(var_25_8, var_8.BuildAllCollection(20001, var_25_2))
	end
...
function var_0_0.UpdateLinkActivity(arg_26_0)
	...
	local var_26_4 = var_26_1(var_26_3(var_26_2, var_1_10007.ACTIVITY_TYPE_LINK_COLLECT), function(arg_27_0)
		return not arg_27_0:isEnd()
	end)

	ipairs = var_1_10003

	for iter_26_0, iter_26_1 in var_1_10003(var_26_4) do
		pg = var_1_10008
