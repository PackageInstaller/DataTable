...
function var_0_1.UpdateDrop(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_3 = var_1_10006(arg_8_0, "icon_bg")

	GetSpriteFromAtlas = var_8_1

	var_1_10004(var_8_3, var_8_1("weaponframes", "bg" .. var_8_2))

	setFrame = var_1_10004
	findTF = var_8_3

	var_1_10004(var_8_3(arg_8_0, "icon_bg/frame"), var_8_2)

	findTF = var_1_10004

	local var_8_4 = var_1_10004(arg_8_0, "icon_bg/icon")
