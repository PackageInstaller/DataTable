...
function var_0_1.GetUnlock(arg_4_0)
	...
	local var_4_2 = var_1_10003(var_5)
	local var_4_3 = var_3.getActivityByType

	ActivityConst = var_1_10006

	if var_4_3(var_4_2, var_1_10006.ACTIVITY_TYPE_BUILDING_BUFF_2) then
		local var_4_4 = var_3
		local var_4_5

		if not var_3.GetTotalBuildingLevel(var_4_4) then
			var_4_5 = 0
		end
		...
		ActivityTaskProxy = var_1_10010

		local var_4_7 = var_1_10008(var_1_10010)

		for iter_4_0, iter_4_1 in var_4_4(var_8.getFinishTasks(var_4_7)) do
			var_4_6[iter_4_1:GetConfigID()] = true
		end

		local var_4_8

		if var_4_1[1] <= var_4_5 then
			underscore = var_4_8

			if var_4_8.all(var_4_1[2], function(arg_5_0)
...
function var_0_1.ChangeVisual(arg_8_0)
	...
	if arg_8_0:getConfig("node_change") ~= 0 then
		getProxy = var_1_10002
		SixthAnniversaryIslandProxy = var_4

		local var_8_0 = var_1_10002(var_4)
		local var_8_1 = var_2.GetNode(var_8_0, var_1)

		var_8_2 = var_2.IsUnlock(var_8_1)
	else
		var_8_2 = false
	end
...
function var_0_1.RedDotHint(arg_16_0)
	...
	return var_1_10001(arg_16_0:getConfig("type"), {
		...
		[5] = function()
			...
			if not var_0_1.markDic then
				var_18_1 = {
					...
					flowerfield = function()
						...
						local var_22_0 = var_3_10000(var_3_10002)
						local var_22_1 = var_0.getActivityByType

						ActivityConst = var_3_10003

						local var_22_2 = var_22_1(var_22_0, var_3_10003.ACTIVITY_TYPE_FLOWER_FIELD)

						Activity = var_3_10001

						return var_3_10001.IsActivityReady(var_22_2)
					end,
					hotspringtask = function()
						getProxy = var_3_10000
						ActivityProxy = var_3_10002

						local var_23_0 = var_3_10000(var_3_10002)
						local var_23_1 = var_0.getActivityByType

						ActivityConst = var_3_10003

						local var_23_2 = var_23_1(var_23_0, var_3_10003.ACTIVITY_TYPE_HOTSPRING_2)

						Activity = var_3_10001

						return var_3_10001.IsActivityReady(var_23_2)
					end
				}
			end
			...
			return var_18_0(var_2.getConfig(var_18_2, "params")[1], var_0_1.markDic, function()
				return false
			end)
		end
	}, function()
