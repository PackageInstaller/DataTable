...
function var_0_1.GetSameFurnitureCnt(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in var_1_10004(var_3_1) do
...
function var_0_1.WarpPutInfo2BackYardFurnitrue(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0, iter_6_1 in var_1_10003(arg_6_2 or {}) do
		...
		BackyardThemeFurniture = iter_6_2

		local var_6_2 = iter_6_2.New

		var_1_10014 = {}
		tonumber = var_1_10015
		var_1_10014.id = var_1_10015(iter_6_1.id)

		if not iter_6_1.configId then
			tonumber = var_1_10015
			var_1_10015 = var_1_10015(iter_6_1.id)
		end

		var_1_10014.configId = var_1_10015
		var_1_10014.position = {
			x = iter_6_1.x,
			y = iter_6_1.y
		}
		var_1_10014.dir = iter_6_1.dir
		var_1_10014.child = var_6_0
		tonumber = var_1_10015
		var_1_10014.parent = var_1_10015(iter_6_1.parent)
		var_1_10014.floor = arg_6_1

		var_1_10009(var_6_1, var_6_2(var_1_10014))
	end
...
function var_0_1.IsSelfUsage(arg_9_0)
	...
	return var_9_0 == var_1_10002.THEME_TEMPLATE_USAGE_TYPE_SELF
end
...
function var_0_1.ExistLocalImage(arg_22_0)
	local function var_22_0()
		...
		local var_23_1 = var_2_10001.GetMd5(var_23_0)
...
function var_0_1.GetWarpFurnitures(arg_37_0)
	...
	for iter_37_0, iter_37_1 in var_1_10003(var_37_1) do
		table = var_1_10008
...
function var_0_1.IsOccupyed(arg_39_0, arg_39_1, arg_39_2)
	...
	for iter_39_0, iter_39_1 in var_1_10004(var_39_0) do
	...
	for iter_40_2, iter_40_3 in iter_40_0(var_40_2) do
		if var_40_1[iter_40_3.id] then
			...
			if var_1_10014(iter_40_3.parent) ~= 0 then
				...
				var_1_10014(var_40_5, iter_40_4(iter_40_3.parent))
...
function var_0_1.OwnThemeTemplateFurniture(arg_41_0)
	...
	for iter_41_0, iter_41_1 in var_41_1(arg_41_0:GetFurnitureCnt()) do
...
function var_0_1.MatchSearchKey(arg_43_0, arg_43_1)
	if not arg_43_1 or arg_43_1 == "" then
		...
		local function var_43_0(arg_44_0)
			...
			local var_44_2 = var_2_10002.lower(var_44_1)
		...
		local function var_43_1(arg_45_0)
			...
			local var_45_2 = var_2_10002.lower(var_45_1)
