...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	for iter_1_0, iter_1_1 in pairs(arg_1_0.genres) do
		if pg.shop_template.get_id_list_by_genre[iter_1_1] then
			...
			for iter_1_2, iter_1_3 in ipairs(pg.shop_template.get_id_list_by_genre[iter_1_1]) do
				if var_1_0:inTime(pg.shop_template[iter_1_3].time) then
	...
	for iter_1_4, iter_1_5 in ipairs(arg_1_1) do
		({})[iter_1_5.shop_id] = iter_1_5.pay_count
	end

	for iter_1_6, iter_1_7 in ipairs(arg_1_2) do
		({})[iter_1_7.shop_id] = iter_1_7.pay_count
	end

	arg_1_0.goods = {}

	for iter_1_8, iter_1_9 in ipairs({}) do
		local var_1_1 = ({})[iter_1_9]

		if not ({})[iter_1_9] then
			var_1_1 = 0
		end

		local var_1_2 = ({})[pg.shop_template[iter_1_9].group]

		if not ({})[pg.shop_template[iter_1_9].group] then
			var_1_2 = 0
		end
