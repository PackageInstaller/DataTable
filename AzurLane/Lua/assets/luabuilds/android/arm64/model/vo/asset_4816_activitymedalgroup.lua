...
function var_0_1.GetMedalGroupStateByID(arg_6_0)
	...
	elseif var_2 == 0 then
		...
		for iter_6_0, iter_6_1 in var_1_10004(var_1.activity_link) do
			...
			if var_1_10010.getActivityById(var_1_10012, var_6_1) and not var_1_10010:isEnd() then
				var_6_0 = true
...
function var_0_1.GetMedalGroupActivityConfig(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10001(arg_8_0:getConfig("activity_link")) do
		...
		if var_1_10007.getActivityById(var_1_10009, var_8_0) and not var_1_10007:isEnd() then
			return iter_8_1
		end
	end
...
function var_0_1.showTip(arg_15_0)
	pg = var_1_10001

	local var_15_0

	if not var_1_10001.activity_medal_group[arg_15_0] or not var_1.activity_link then
		var_15_0 = {}
	end
	...
	for iter_15_0, iter_15_1 in var_1_10004(var_15_0) do
		...
		if var_1_10010.getActivityById(var_1_10012, var_15_2) and not var_1_10010:isEnd() then
	...
	for iter_15_2, iter_15_3 in iter_15_1(var_15_1) do
		local var_15_7

		if not var_15_3:getTaskById(iter_15_3) then
			var_15_7 = var_15_3:getFinishTaskById(iter_15_3)
		end

		if var_15_7 then
			if var_15_7:getTaskStatus() == 1 then
				var_15_5 = var_15_5 + 1
				var_15_4 = var_15_4 + 1
