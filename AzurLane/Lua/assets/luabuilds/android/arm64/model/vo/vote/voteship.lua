...
function var_0_1.GenConfigId(arg_2_0, arg_2_1)
	for iter_2_0 = 4, 1, -1 do
		...
		if var_1_10007.ship_data_statistics[var_1_10006] then
			return var_1_10006
		end
	end
...
function var_0_1.getPainting(arg_8_0)
	...
	return var_1_10002.ship_skin_template[var_8_0].painting
end
...
function var_0_1.GetDesc(arg_9_0)
	...
	local var_9_1 = var_1_10002.RawGetWord
	local var_9_2 = var_9_0

	ShipWordHelper = var_1_10005

	return var_9_1(var_9_2, var_1_10005.WORD_TYPE_PROFILE)
end
...
function var_0_1.getShipTypeName(arg_11_0)
	if arg_11_0:IsFunRace() then
		...
		return var_1_10002.ship_data_by_type[var_11_0].type_name
	end
...
function var_0_1.IsMatchSearchKey(arg_15_0, arg_15_1)
	...
	string = var_1_10004
	arg_15_1 = var_15_0(var_1_10004.gsub(arg_15_1, "%.", "%%."))
	string = var_2
	...
	return var_15_1(var_4.lower(arg_15_0:getShipName()), arg_15_1)
end
