...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	local function var_1_1(arg_2_0)
		local var_2_0 = arg_2_0:getTeamType()

		TeamType = var_2_10002

		if var_2_0 == var_2_10002.Vanguard then
			table = var_2_0

			var_2_0.insert(arg_1_0.vanguardShips, arg_2_0)
		else
			local var_2_1 = arg_2_0:getTeamType()

			TeamType = var_2

			if var_2_1 == var_2.Main then
				table = var_2_1

				var_2_1.insert(arg_1_0.mainShips, arg_2_0)
			end
		end
	...
	for iter_1_0, iter_1_1 in var_1_10003(arg_1_1.vanguard_ship_list) do
