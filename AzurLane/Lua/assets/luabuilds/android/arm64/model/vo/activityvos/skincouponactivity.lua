...
function var_0_1.ShouldTipUsage(arg_6_0)
	local function var_6_0()
		...
		if var_2_10001.GetInt(arg_6_0.id .. "_SkinCouponActivity_Tip" .. var_7_1, 0) <= 0 then
			return true
		end
		...
		if var_1 < var_2.GetServerTime(var_7_2) then
			...
			local var_7_3 = var_3.TimeMgr.GetInstance()
...
function var_0_1.SaveTipTime(arg_8_0)
	...
	var_8_0.SetInt(arg_8_0.id .. "_SkinCouponActivity_Tip" .. var_8_3, var_8_1)
...
function var_0_1.IncludeShop(arg_9_0, arg_9_1)
	...
	return var_1_10003.contains(var_9_0, arg_9_1)
end
...
function var_0_1.GetItemConfig(arg_15_0)
	...
	if not var_1_10002.getConfigData(var_15_0) then
		var_15_1 = {}
	end
...
function var_0_1.GetItemName(arg_16_0)
	...
	if not var_1_10002.getConfigData(var_16_0) or not var_2.name then
		var_16_1 = ""
	end
...
function var_0_1.GetOwnCount(arg_18_0)
	...
	return #var_1_10002.filter(var_18_0, function(arg_20_0)
...
function var_0_1.GetSkinCouponActivities(arg_22_0)
	...
	local var_22_1 = var_1_10004.activity_template.get_id_list_by_type

	ActivityConst = var_1_10005

	local var_22_2

	if not var_22_1[var_1_10005.ACTIVITY_TYPE_SKIN_COUPON] then
		var_22_2 = {}
	end
	...
	for iter_22_0, iter_22_1 in var_1_10002(var_22_2) do
		...
		if var_1_10007.RawGetActivityById(var_1_10009, iter_22_1) and not var_1_10007:isEnd() and (not arg_22_0 or var_1_10007:IncludeShop(arg_22_0)) then
			table = var_8

			var_8.insert(var_22_0, var_1_10007)
		end
	end
...
function var_0_1.GetSkinCouponActFromEncoreAct(arg_26_0)
	...
	local var_26_3 = var_1_10002(var_4)
...
function var_0_1.GetSkinCouponEncoreActivities(arg_27_0)
	...
	local var_27_1 = var_1_10004.activity_template.get_id_list_by_type

	ActivityConst = var_1_10005

	local var_27_2

	if not var_27_1[var_1_10005.ACTIVITY_TYPE_SKIN_COUPON_COUNTING] then
		var_27_2 = {}
	end
	...
	for iter_27_0, iter_27_1 in var_1_10002(var_27_2) do
		...
		if var_1_10007.RawGetActivityById(var_1_10009, iter_27_1) and not var_1_10007:isEnd() then
			if arg_27_0 then
				table = var_8

				if var_8.contains(var_1_10007:getConfig("config_data")[2], arg_27_0) then
					table = var_8
...
function var_0_1.UseSkinCoupon(arg_30_0)
	...
	if not var_1.getActivityById(var_30_0, arg_30_0) then
		pg = var_1_10002
		var_30_1 = var_1_10002.TipsMgr.GetInstance()

		local var_30_2 = var_2.ShowTips

		i18n = var_1_10005

		var_30_2(var_30_1, var_1_10005("common_activity_end"))
