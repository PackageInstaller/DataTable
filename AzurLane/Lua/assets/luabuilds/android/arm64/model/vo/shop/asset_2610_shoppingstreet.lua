...
function var_0_1.getRiseShopId(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_1_10002(var_1_10004.shop_template.all) do
		pg = var_1_10007
...
function var_0_1.Ctor(arg_2_0, arg_2_1)
	...
	local var_2_0 = var_2(var_1_10004)
	local var_2_1 = var_2.getActivityByType

	ActivityConst = var_1_10005

	local var_2_2 = var_2_1(var_2_0, var_1_10005.ACTIVITY_TYPE_SHOP_DISCOUNT) and not var_2:isEnd()

	ipairs = var_2_0

	for iter_2_0, iter_2_1 in var_2_0(arg_2_1.goods_list) do
		Goods = var_1_10009
		var_1_10009 = var_1_10009.Create

		local var_2_3 = iter_2_1

		Goods = var_1_10012
		var_1_10009 = var_1_10009(var_2_3, var_1_10012.TYPE_SHOPSTREET)
		var_1_10009.activityDiscount = var_2_2
		table = var_1_10010

		var_1_10010.insert(arg_2_0.goods, var_1_10009)
	end
...
function var_0_1.levelUp(arg_16_0)
	...
	local var_16_1 = arg_16_0.bindConfigTable(var_16_0)
	local var_16_2 = arg_16_0.level

	math = var_16_0
	arg_16_0.level = var_16_0.min(arg_16_0.level + 1, #var_16_1.all)

	if var_16_2 == arg_16_0.level then
		warning = var_3
...
function var_0_1.setLevelUpTime(arg_17_0)
	...
	pg = var_1_10004
	arg_17_0.levelUpTime = var_1_10002(var_1_10004.navalacademy_shoppingstreet_template, arg_17_0.level).levelUpTime + var_17_1
