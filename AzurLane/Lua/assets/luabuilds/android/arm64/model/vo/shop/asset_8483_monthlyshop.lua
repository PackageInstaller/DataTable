...
function var_0_1.getRestDays(arg_6_0)
	...
	local var_6_2 = var_1
	local var_6_3 = var_6_1(var_6_0, var_1.GetServerTime(var_6_2), "*t")

	Clone = var_1_10003

	local var_6_4 = var_1_10003(var_6_3)

	var_6_4.month = arg_6_0.id

	if var_6_4.month >= 12 then
		var_6_4.month = 0
		var_6_4.year = var_6_4.year + 1
	end

	var_6_4.month = var_6_4.month + 1
	var_6_4.day = 0
	os = var_4

	local var_6_5 = var_4.date
	local var_6_6 = "%d"

	os = var_6_2

	local var_6_7 = var_6_5(var_6_6, var_6_2.time(var_6_4)) - var_6_3.day + 1

	math = var_6_6

	return (var_6_6.max(var_6_7, 1))
end
...
function var_0_1.GetRestTime(arg_7_0)
	...
	local var_7_2 = var_1_10003(var_7_1)
	...
	local var_7_3 = var_4.time(var_7_2) - var_1:GetServerTime()

	math = var_6

	return (var_6.max(var_7_3, 0))
end
	...
	var_3.sort(var_8_0, function(arg_10_0, arg_10_1)
		...
		local function var_10_5(arg_11_0)
			...
			if arg_11_0:isSham() then
				...
				DROP_TYPE_SHIP = var_3_10005

				if var_11_2(var_11_1, var_3_10005) then
