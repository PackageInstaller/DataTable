...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.remainCnt = arg_1_0.GetOriginalCnt(var_1_0) - arg_1_0.usedCnt
	getProxy = var_3
	EducateProxy = var_1_0

	local var_1_1 = var_3(var_1_0)

	arg_1_0.curTime = var_3.GetCurTime(var_1_1)
...
function var_0_1.initRefreshTime(arg_4_0)
	if arg_4_0:IsEventType() and arg_4_0:IsCountLimit() then
		...
		var_1_10004.insert(arg_4_0.refreshWeeks, var_4_0)
	...
	if var_1_10001.IsShowNature() then
		...
		return var_1.select(arg_21_0:getConfig("result_display"), function(arg_22_0)
			...
			if var_22_0 == var_2_10002.DROP_TYPE_ATTR then
				...
				local var_22_1 = var_22_0(var_2_10003)
