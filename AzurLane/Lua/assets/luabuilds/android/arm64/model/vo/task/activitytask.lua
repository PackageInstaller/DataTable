...
function var_0_1.getProgress(arg_6_0)
	...
	if arg_6_0:isActivitySubmit() then
		...
		local var_6_2 = var_2(arg_6_0.getConfig(var_6_1, "target_id"))

		tonumber = var_1_10003

		local var_6_3 = arg_6_0

		var_1_10003 = var_1_10003(arg_6_0.getConfig(var_6_3, "target_id_2"))
		pg = var_4
		...
		local var_6_5 = var_1_10005(var_6_3)

		if var_1_10005.getActivityById(var_6_5, var_6_4) then
			var_6_0 = var_1_10005:getVitemNumber(var_1_10003)
		else
			warning = var_6_1

			var_6_1("找不到活动数据中物品得的数量")
		...
		if arg_6_0.type == 6 then
			...
			TASK_SUB_TYPE_PT = var_1_10003

			if var_6_6 == var_1_10003 then
				tonumber = var_6_6

				local var_6_7 = var_6_6(arg_6_0:getConfig("target_id_2"))

				getProxy = var_1_10003
				ActivityProxy = var_1_10005

				local var_6_8 = var_1_10003(var_1_10005)

				if var_3.getActivityById(var_6_8, var_6_7) then
					var_6_0 = var_3.data1 or 0
				else
					warning = var_4

					var_4("找不到活动数据中物品得的数量", arg_6_0.id)
...
function var_0_1.isNew(arg_17_0)
	...
	local var_17_0 = arg_17_0.actType

	ActivityConst = var_1_10002

	if var_17_0 == var_1_10002.ACTIVITY_TYPE_TASK_RYZA then
		if arg_17_0.groupIndex ~= 1 then
			PlayerPrefs = var_1

			local var_17_1 = var_1.GetInt
			local var_17_2 = "ryza_task_"

			getProxy = var_1_10004
			PlayerProxy = var_1_10006

			local var_17_3 = var_1_10004(var_1_10006)

			if var_17_1(var_17_2 .. var_4.getRawData(var_17_3).id .. "_" .. arg_17_0.id) ~= 1 then
				return true
			end
		end
...
function var_0_1.changeNew(arg_18_0)
	...
	if var_18_0 == var_1_10002.ACTIVITY_TYPE_TASK_RYZA and arg_18_0.groupIndex ~= 1 then
		...
		local var_18_3 = var_1_10004(var_1_10006)

		if var_18_1(var_18_2 .. var_4.getRawData(var_18_3).id .. "_" .. arg_18_0.id) ~= 1 then
			PlayerPrefs = var_1
			...
			local var_18_6 = var_4(var_6)

			var_18_4(var_18_5 .. var_4.getRawData(var_18_6).id .. "_" .. arg_18_0.id, 1)
		end
	end
