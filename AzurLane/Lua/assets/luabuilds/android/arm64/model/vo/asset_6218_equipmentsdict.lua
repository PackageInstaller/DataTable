...
function var_0_0.Ctor(arg_1_0)
	...
	for iter_1_0, iter_1_1 in var_1_10003(var_1_2) do
		...
		CreateShell = var_1_10011

		var_1_5(var_1_6, var_1_10011(iter_1_1))
	end
	...
	local var_1_7 = var_5(iter_1_1)

	for iter_1_2, iter_1_3 in var_3(var_5.GetEquipsInShipsRaw(var_1_7)) do
...
function var_0_0.GetEquipTraceBack(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	for iter_5_0, iter_5_1 in var_6(var_5) do
		...
		if var_1_10014.any(var_1_10013, function(arg_6_0)
			...
			var_1_10014.insert(arg_5_3, var_5_1)
		elseif var_1_10011 == 0 then
			assert = var_1_10014

			var_1_10014(false, "ERROR Source Equip ID 0")
			...
			var_1_10014[1] = var_5_2(var_5_3, var_1_10018)
			var_5_1.candicates = var_1_10014
			table = var_1_10014
...
function var_0_0.RemoveEquipment(arg_11_0, arg_11_1)
	...
	if not arg_11_0:FindTheEquip(arg_11_1) then
		return
	end

	table = var_1_10004

	var_1_10004.remove(var_11_0[arg_11_1.id], var_3)
