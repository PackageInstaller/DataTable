...
function var_0_1.GetPreorderTip(arg_2_0)
	...
	local var_2_6 = var_2_2.TimeMgr.GetInstance()
	...
	local var_2_7 = var_2_4(var_8)
	local var_2_8 = var_6.getRawData(var_2_7).id

	pg = var_2_6

	local var_2_9 = var_2_6.TimeMgr.GetInstance()
	local var_2_10 = var_7.STimeDescC

	pg = var_1_10010

	local var_2_11 = var_1_10010.TimeMgr.GetInstance()
	local var_2_12 = var_2_10(var_2_9, var_10.GetServerTime(var_2_11), "%Y/%m/%d")

	PlayerPrefs = var_2_7

	local var_2_13 = var_2_7.GetString

	string = var_10

	return var_2_13(var_10.format("AUCTION_GAME_PREORDER_%s_%s", var_2_8, arg_2_0.id)) ~= var_2_12
end
...
function var_0_1.SetPreorderTip(arg_3_0)
	...
	local var_3_3 = var_3_0.TimeMgr.GetInstance()
	local var_3_4 = var_4.STimeDescC

	pg = var_1_10007

	local var_3_5 = var_1_10007.TimeMgr.GetInstance()
	local var_3_6 = var_3_4(var_3_3, var_7.GetServerTime(var_3_5), "%Y/%m/%d")

	PlayerPrefs = var_3_1

	local var_3_7 = var_3_1.SetString

	string = var_7

	var_3_7(var_7.format("AUCTION_GAME_PREORDER_%s_%s", var_3_2, arg_3_0.id), var_3_6)
...
function var_0_1.GetOpenPreorderTip(arg_4_0)
	...
	local var_4_2 = var_1:GetPreorderTimestamp()

	pg = var_4_0

	local var_4_3 = var_4_0.TimeMgr.GetInstance()
	local var_4_4 = var_4.GetServerTime(var_4_3)

	if var_4_1 == 1 and var_4_2 <= var_4_4 then
		return true
	end
...
function var_0_1.GetTaskTip(arg_5_0)
	...
	local var_5_1 = var_1_10002(var_4)

	return var_2.getActivityById(var_5_1, var_5_0) and var_2:readyToAchieve()
end
...
function var_0_1.GetAllLocationTip(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10001(var_1_10003.auction_session.all) do
		pg = var_1_10006
...
function var_0_1.GetLocationTip(arg_7_0, arg_7_1)
	...
	local var_7_3 = var_1_10004.GetInt

	string = var_1_10006

	if var_7_3(var_1_10006.format("AUCTION_GAME_LOCATION_%s_%s_%s", var_7_2, arg_7_0.id, arg_7_1), 0) == 0 then
...
function var_0_1.SetLocationTip(arg_8_0, arg_8_1)
	...
	local var_8_2 = var_1_10003.SetInt

	string = var_1_10005

	var_8_2(var_1_10005.format("AUCTION_GAME_LOCATION_%s_%s_%s", var_8_1, arg_8_0.id, arg_8_1), 1)
...
function var_0_1.GetReliefTip(arg_9_0)
	...
	local var_9_0 = var_1_10001(var_1_10003).gold
