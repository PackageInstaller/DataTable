...
function var_0_0.Ctor(arg_1_0)
	...
	for iter_1_0, iter_1_1 in var_1_10002(var_1_0) do
		...
		local var_1_1 = var_1_10007
		local var_1_2 = var_1_10007.GetType(var_1_1)
		local var_1_3 = {}

		EducateSpecialEvent = var_1_1
		var_1_3[var_1_1.TYPE_PLAN] = function()
			table = var_2_10000
		...
		EducateSpecialEvent = var_12
		var_1_3[var_12.TYPE_SITE] = function()
			table = var_2_10000
		...
		EducateSpecialEvent = var_12
		var_1_3[var_12.TYPE_BUBBLE_MIND] = function()
			table = var_2_10000
		...
		EducateSpecialEvent = var_12
		var_1_3[var_12.TYPE_BUBBLE_DISCOUNT] = function()
			table = var_2_10000
...
function var_0_0.SetUp(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_6_1(var_1_10004)
...
function var_0_0.GetHomeSpecEvents(arg_10_0)
	...
	local var_10_4 = var_1_10003.IsSystemUnlock

	EducateConst = var_1_10005

	if var_10_4(var_1_10005.SYSTEM_FAVOR_AND_MIND) then
		table = var_10_2

		local var_10_5

		if not var_10_2.mergeArray(arg_10_0.mindBubbleSpecEvents, arg_10_0.discountBubbleSpecEvents) then
			var_10_5 = arg_10_0.discountBubbleSpecEvents
		end

		underscore = var_5

		return (var_5.select(var_10_5, function(arg_11_0)
...
function var_0_0.GetSiteSpecEvents(arg_12_0, arg_12_1)
	...
	return (var_1_10004.select(arg_12_0.siteSpecEvents, function(arg_13_0)
