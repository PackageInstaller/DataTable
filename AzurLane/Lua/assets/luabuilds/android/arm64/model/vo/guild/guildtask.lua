...
function var_0_1.isRemind(arg_14_0, arg_14_1)
	local var_14_0 = arg_14_0:getConfig("warning_time")[arg_14_1]

	pg = var_1_10003

	local var_14_1 = var_1_10003.TimeMgr.GetInstance()

	return var_14_0 >= var_3.GetServerWeek(var_14_1)
end
...
function var_0_1.PrivateBeFinished(arg_20_0)
	...
	if var_20_0 == arg_20_0.getState(var_20_1) then
		local var_20_2 = arg_20_0:GetPresonTaskId()

		getProxy = var_2
		TaskProxy = var_20_1

		local var_20_3 = var_2(var_20_1)
		local var_20_4

		if not var_2.getTaskById(var_20_3, var_20_2) then
			var_20_4 = var_2:getFinishTaskById(var_20_2)
		end

		local var_20_5

		if var_20_4 and var_20_4:isFinish() then
			var_20_5 = not var_20_4:isReceive()
		end
...
function var_0_1.SamePrivateTaskType(arg_21_0, arg_21_1)
	...
	local var_21_2 = var_1_10003.task_data_template[var_21_1].sub_type

	_ = var_21_0

	return var_21_0.any(arg_21_1, function(arg_22_0)
