...
function var_0_1.GetLasterUpdateTime(arg_2_0)
	...
	;(function(arg_3_0)
		...
		if arg_3_0 <= var_1.GetServerTime(var_3_0) then
			...
			var_2_10002.insert(var_2_0, arg_3_0)
		end

		return
	end)(arg_2_0.time)

	local var_2_1 = arg_2_0:GetAllReplys()
...
function var_0_1.AnyReplyTimeOut(arg_10_0)
	...
	if not var_1_10002.any(var_10_0, function(arg_11_0)
		return arg_11_0:TimeOutAndTxtIsEmpty()
	end) then
		var_10_1 = arg_10_0:TimeOutAndTxtIsEmpty()
	end
...
function var_0_1.HasReply(arg_20_0)
	...
	if var_1_10002.any(var_20_0, function(arg_21_0)
...
function var_0_1.GetContent(arg_22_0)
	...
	local var_22_1 = arg_22_0.GetName(var_22_0)

	if arg_22_0.isRoot then
		string = var_2

		return var_2.format("<color=#000000FF>%s.</color>%s", var_22_1, arg_22_0.text)
	else
		local var_22_2 = arg_22_0:GetParentCommentName()

		string = var_22_0

		return var_22_0.format("<color=#000000FF>%s.</color>%s", var_22_1, arg_22_0.text)
	end
...
function var_0_1.GetReplyCnt(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1_10003(var_23_1) do
