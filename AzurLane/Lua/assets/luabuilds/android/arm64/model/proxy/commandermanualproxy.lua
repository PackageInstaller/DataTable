...
function var_0_0.register(arg_1_0)
	arg_1_0:on(22300, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.handbooks) do
			({})[iter_2_1.id] = iter_2_1
		end

		for iter_2_2, iter_2_3 in ipairs(pg.tutorial_handbook_task.all) do
			local var_2_1 = ({})[iter_2_3] and CommanderManualPage.New(({})[iter_2_3], arg_1_0.topFinishedTaskIds, true) or CommanderManualPage.New({
				pt = 0,
				award = 0,
				id = iter_2_3,
				finished_task_ids = {}
			...
			table.insert(arg_1_0.commanderManualPages, var_2_1)
		end
...
function var_0_0.ShouldShowTipByType(arg_14_0, arg_14_1)
	for iter_14_0, iter_14_1 in ipairs((arg_14_0:GetPagesByType(arg_14_1))) do
...
function var_0_0.IsTopPageComplete(arg_16_0, arg_16_1)
	for iter_16_0, iter_16_1 in ipairs((arg_16_0:GetPagesByType(arg_16_1))) do
...
function var_0_0.TaskProgressAdd(arg_17_0, arg_17_1, arg_17_2)
	...
	for iter_17_2, iter_17_3 in ipairs({}) do
		local var_17_0 = getProxy(TaskProxy):getTaskById(iter_17_3)

		if var_17_0 and var_17_0:getTaskStatus() == 0 then
