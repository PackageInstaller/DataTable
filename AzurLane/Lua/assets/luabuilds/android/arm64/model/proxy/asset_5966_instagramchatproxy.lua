...
local var_0_2 = var_0_10001.activity_ins_chat_group
...
function var_0_1.ActivateTopics(arg_11_0, arg_11_1)
	...
	local var_11_2 = var_1_10005.ACT_INSTAGRAM_CHAT
	local var_11_3 = {}

	ActivityConst = var_1_10007
	var_11_3.operation = var_1_10007.INSTAGRAM_CHAT_ACTIVATE_TOPIC
...
function var_0_1.UpdateTopicDisplayWordList(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	if arg_13_0:GetTopicById(arg_13_1) then
		table = var_1_10005
...
function var_0_1.GetNotActiveTopicIds(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10002(arg_15_0.chatList) do
		ipairs = var_1_10007
			...
			if iter_15_3.active then
				for iter_15_4 = #var_15_0, 1, -1 do
					if var_15_0[iter_15_4] == iter_15_3.topicId then
						...
						var_16.remove(var_15_0, iter_15_4)
					end
				end
			end
		end
