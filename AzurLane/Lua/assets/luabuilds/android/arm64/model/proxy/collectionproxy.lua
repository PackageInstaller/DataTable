	...
	arg_1_0:on(17002, function(arg_3_0)
		...
		for iter_3_0, iter_3_1 in var_2_10001(arg_3_0.progress_list) do
			...
			if arg_1_0.trophy[var_3_1] then
				...
				local var_3_5 = arg_1_0.trophy[var_3_1]

				if var_8.canClaimed(var_3_5) then
					var_3_0 = true
				end
			end
			...
			if var_3_0 then
				...
				var_8.dispatchClaimRemind(var_3_6, var_3_1)
			end
		end

		local var_3_7 = arg_1_0

		var_1.hiddenTrophyAutoClaim(var_3_7)

		local var_3_8 = arg_1_0

		var_1.updateTrophy(var_3_8)
...
function var_0_1.updateAward(arg_9_0, arg_9_1, arg_9_2)
	...
	var_9_1(var_9_0, var_9_2, var_1_10007(arg_9_0.awards))
...
function var_0_1.getCollectionRate(arg_16_0)
	...
	local var_16_1 = arg_16_0.getCollectionCount(var_16_0)
	local var_16_2 = arg_16_0:getCollectionTotal()

	string = var_16_0

	return var_16_0.format("%0.3f", var_16_1 / var_16_2), var_16_1, var_16_2
end
...
function var_0_1.getCollectionCount(arg_17_0)
	...
	return var_17_0(var_1_10003.values(arg_17_0.shipGroups), 0, function(arg_18_0, arg_18_1)
		Nation = var_2_10002
...
function var_0_1.getCollectionTotal(arg_19_0)
	...
	local var_19_1 = var_19_0(var_1_10003.ship_data_group.all, 0, function(arg_20_0, arg_20_1)
		pg = var_2_10002
		...
		return arg_20_0 + (var_2_10004.IsLinkType(var_20_1.nationality) and 0 or 1)
	end)

	pg = var_1_10002

	return var_19_1 + #var_1_10002.ship_data_trans.all
end
...
function var_0_1.getLinkCollectionCount(arg_21_0)
	...
	return var_21_0(var_1_10003.values(arg_21_0.shipGroups), 0, function(arg_22_0, arg_22_1)
		Nation = var_2_10002
...
function var_0_1.flushCollection(arg_23_0, arg_23_1)
	...
	local var_23_1 = arg_23_0.getShipGroup(var_23_0, arg_23_1.groupId)
	local var_23_2

	if not var_23_1 then
		ShipGroup = var_23_0
		var_23_1 = var_23_0.New({
			heart_flag = 0,
			heart_count = 0,
			lv_max = 1,
			id = arg_23_1.groupId,
		...
		OPEN_TEC_TREE_SYSTEM = var_23_0

		if var_23_0 then
			table = var_23_0
			var_23_0 = var_23_0.indexof
			pg = var_1_10006

			if var_23_0(var_1_10006.fleet_tech_ship_template.all, arg_23_1.groupId, 1) then
				var_23_2 = true
			end
		end
	else
		...
		if var_23_0 then
			...
			if var_23_0(var_1_10006.fleet_tech_ship_template.all, arg_23_1.groupId, 1) then
				var_23_0 = var_23_1.star

				local var_23_3 = arg_23_1
				local var_23_4

				if var_23_0 < arg_23_1.getStar(var_23_3) then
					var_23_4 = arg_23_1
					var_23_0 = arg_23_1.getStar(var_23_4)
					pg = var_5

					if var_23_0 == var_5.fleet_tech_ship_template[arg_23_1.groupId].max_star then
						var_23_2 = true
						pg = var_23_0
						var_23_0 = var_23_0.fleet_tech_ship_template[arg_23_1.groupId].pt_upgrage
						pg = var_5
						...
						var_23_5(var_23_3, var_8.ToastMgr.TYPE_TECPOINT, {
							point = var_23_0
						})
					end
				end

				if var_23_1.maxLV < arg_23_1.level then
					var_23_0 = arg_23_1.level
					TechnologyConst = var_5

					if var_23_0 == var_5.SHIP_LEVEL_FOR_BUFF then
						var_23_2 = true
						pg = var_23_0
						var_23_0 = var_23_0.fleet_tech_ship_template[arg_23_1.groupId].pt_level
						ShipType = var_5
						...
						local var_23_8 = var_23_4.fleet_tech_ship_template[arg_23_1.groupId].add_level_attr
						...
						var_23_11(var_23_10, var_1_10011.ToastMgr.TYPE_TECPOINT, {
							point = var_23_0,
							typeList = var_23_7,
							attr = var_23_8,
							value = var_23_9
		...
		math = var_23_0
		var_23_1.star = var_23_0.max(var_23_1.star, arg_23_1:getStar())
		math = var_4
		var_23_1.maxIntimacy = var_4.max(var_23_1.maxIntimacy, arg_23_1.intimacy)
		math = var_4
		var_23_1.married = var_4.max(var_23_1.married, arg_23_1.propose and 1 or 0)
		math = var_4
		var_23_1.maxLV = var_4.max(var_23_1.maxLV, arg_23_1.level)
	end

	local var_23_12 = arg_23_0

	arg_23_0.updateShipGroup(var_23_12, var_23_1)
...
function var_0_1.getTrophys(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_1_10002(arg_27_0.trophy) do
		iter_27_1:clearNew()
	end
...
function var_0_1.hiddenTrophyAutoClaim(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1_10001(arg_29_0.trophy) do
		local var_29_0 = iter_29_1:getHideType()

		Trophy = var_1_10007

		if var_29_0 ~= var_1_10007.ALWAYS_SHOW then
			local var_29_1 = iter_29_1:getHideType()

			Trophy = var_1_10007

			if var_29_1 ~= var_1_10007.COMING_SOON and iter_29_1:canClaimed() and not iter_29_1:isClaimed() then
				local var_29_2 = arg_29_0
				local var_29_3 = arg_29_0.sendNotification

				GAME = var_1_10009

				var_29_3(var_29_2, var_1_10009.TROPHY_CLAIM, {
					trophyID = iter_29_0
				})
			end
		end
...
function var_0_1.unclaimTrophyCount(arg_30_0)
	...
	for iter_30_0, iter_30_1 in var_1_10002(arg_30_0.trophy) do
		local var_30_1 = iter_30_1:getHideType()

		Trophy = var_1_10008

		if var_30_1 == var_1_10008.ALWAYS_SHOW and iter_30_1:canClaimed() and not iter_30_1:isClaimed() then
			var_30_0 = var_30_0 + 1
		end
	end
...
function var_0_1.updateTrophy(arg_31_0)
	...
	var_31_1(var_31_0, var_31_2, var_1_10005(arg_31_0.trophy))
...
function var_0_1.dispatchClaimRemind(arg_32_0, arg_32_1)
	...
	var_32_1(var_32_0, var_1_10005.ToastMgr.TYPE_TROPHY, {
		id = arg_32_1
	})
...
function var_0_1.bindComplexTrophy(arg_33_0)
	...
	for iter_33_0, iter_33_1 in var_1_10001(arg_33_0.trophyGroup) do
		...
		for iter_33_2, iter_33_3 in var_1_10007(var_33_0) do
			if iter_33_3:isComplexTrophy() then
				...
				for iter_33_4, iter_33_5 in var_12(iter_33_3:getTargetID()) do
					...
					if not arg_33_0.trophy[iter_33_5] then
						Trophy = var_33_1
						var_33_1 = var_33_1.generateDummyTrophy(iter_33_5)
					end
	...
	for iter_34_0, iter_34_1 in var_1_10002(var_34_0.all) do
		...
		if var_34_1 == var_1_10009.ALWAYS_SHOW then
			...
			if not arg_34_0.trophyGroup[var_34_2] then
				...
				TrophyGroup = var_10
				var_1_10009[var_34_2] = var_10.New(var_34_2)
			end
