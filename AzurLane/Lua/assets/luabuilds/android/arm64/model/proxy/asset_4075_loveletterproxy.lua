...
function var_0_1.SetGroupList(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_2(arg_2_1.medal_list) do
		...
		local var_2_1 = arg_2_0.data[iter_2_1.group_id]

		arg_2_0.levelAll = var_1_10007 + var_8.GetDisplayLevel(var_2_1)
	end

	ipairs = var_2

	for iter_2_2, iter_2_3 in var_2(arg_2_1.letter_list) do
		local var_2_2 = arg_2_0:GetGroupData(iter_2_3.group_id)

		var_1_10007.SetUnlockLetters(var_2_2, iter_2_3.letter_id_list)
	end
...
function var_0_1.GetLoveLetterItemDic(arg_8_0)
	if not var_0_1.letterItemDic then
		...
		for iter_8_0, iter_8_1 in var_8_0(var_1_10003.lover_letter_content.all) do
			pg = var_1_10006
			...
			if not var_1_10007.lover_character_template[var_1_10006.ship_group] then
				...
				for iter_8_2, iter_8_3 in var_1_10007(var_1_10006.love_item) do
					ipairs = var_1_10012
					table = var_1_10014
					var_1_10014 = var_1_10014.insertto
					...
					for iter_8_4, iter_8_5 in var_1_10012(var_1_10014(var_8_1, var_17.lover_character_template[var_1_10006.ship_group].relate_group_id)) do
						ipairs = var_17

						for iter_8_6, iter_8_7 in var_17({
							0,
							iter_8_5
						}) do
...
function var_0_1.CanRealizeGift(arg_9_0)
	...
	local var_9_2 = var_2.GetAllLoveLetterItem(var_9_1)
	local var_9_3 = {}
	...
	for iter_9_0, iter_9_1 in var_9_1(var_9_2) do
		...
		var_1_10009, var_9_4 = var_1_10009(iter_9_1)
		underscore = var_11

		local var_9_5 = var_11.values(var_9_0[var_1_10009 .. "_" .. (var_9_4 or 0)])[1]
		local var_9_6 = var_1_10009 .. "_" .. var_9_5

		defaultValue = var_13
		var_9_3[var_9_6] = var_13(var_9_3[var_9_6], 0) + 1
	end
	...
	for iter_9_2, iter_9_3 in var_5(arg_9_0.giftRecord) do
		...
		local var_9_8 = var_10.values(var_9_0[iter_9_3.item_id .. "_" .. iter_9_3.group_id])[1]
		local var_9_9 = iter_9_3.item_id .. "_" .. var_9_8

		defaultValue = var_12
		var_9_3[var_9_9] = var_12(var_9_3[var_9_9], 0) - 1
	end

	if var_9_7 and #var_9_2 > 0 then
		return var_9_2
	end

	pairs = var_5

	for iter_9_4, iter_9_5 in var_5(var_9_3) do
		if iter_9_5 > 0 then
			return var_9_2
		end
	end
...
function var_0_1.UpdateRealizeGift(arg_10_0, arg_10_1)
	...
	for iter_10_2, iter_10_3 in var_6(arg_10_0.giftRecord) do
		...
		if not var_10_0[iter_10_3.item_id .. "_" .. iter_10_3.group_id] then
			...
			if not var_10_7.lover_character_template[iter_10_3.group_id] or not iter_10_3.group_id then
				...
				pg = var_15
				var_10_6 = var_10_7(var_15.lover_character_template.all, function(arg_11_0)
					...
					return var_11_0(var_2_10003.lover_character_template[arg_11_0].relate_group_id, function(arg_12_0)
	...
	LoveLetterProxy = iter_10_10

	var_10_16(var_10_15, iter_10_10.UPDATE_LOVE_LETTER)
...
function var_0_1.GetAllLevelNextAwardIndex(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1_10001(var_1_10003.lover_reward.all) do
...
function var_0_1.GetAllLevelAwardDisplayIndex(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10002(var_1_10004.lover_reward.all) do
		var_18_0 = iter_18_0
		pg = var_1_10007
...
function var_0_1.GetAllLevelProgress(arg_19_0)
	if not arg_19_0:GetAllLevelNextAwardIndex() then
		do return 0, 0 end
	...
	local var_19_0 = var_1_10002.lover_reward.all
	...
	if 1 < var_1 then
		...
		do
			...
			if not var_3.lover_reward[var_19_0[var_1 - 1]].total_level then
				var_19_1 = 0
			end

			local var_19_2 = arg_19_0.levelAll - var_19_1

			pg = var_1_10005

			return var_19_2, var_1_10005.lover_reward[var_19_0[var_1]].total_level - var_19_1
		end
...
function var_0_1.GetAllLevelNextAward(arg_20_0)
	...
	if not arg_20_0:GetAllLevelNextAwardIndex() then
		var_20_1 = #var_20_0
	end
	...
	local var_20_3 = var_1_10003.map

	pg = var_1_10005

	return var_20_3(var_1_10005.lover_reward[var_20_2].show_reward, function(arg_21_0)
		Drop = var_2_10001
...
function var_0_1.GetAllLevelReadyReward(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1_10003(var_1_10005.lover_reward.all) do
		pg = var_1_10008
...
function var_0_1.GetDisplayLetterList(arg_28_0)
	...
	CompareFuncs = iter_28_0

	var_28_1(var_28_2, iter_28_0({
		function(arg_29_0)
	...
	return var_3.map(var_28_0, function(arg_32_0)
		local var_32_0
...
function var_0_1.GetRecordGiftLetters(arg_33_0, arg_33_1)
	...
	local var_33_2, var_33_3 = arg_33_0.GetLoveLetterItemDic(var_33_1)

	ipairs = var_33_1

	for iter_33_0, iter_33_1 in var_33_1(arg_33_0.giftRecord) do
		if not var_33_2[iter_33_1.item_id .. "_" .. iter_33_1.group_id] then
			-- block empty
		else
			underscore = var_10

			if var_10.values(var_33_2[iter_33_1.item_id .. "_" .. iter_33_1.group_id])[1] == arg_33_1 then
				table = var_11

				var_11.insert(var_33_0, var_33_3[arg_33_1 .. "_" .. iter_33_1.year])
			end
		end
	end
...
function var_0_1.IsTipUnlockLetter(arg_37_0)
	...
	for iter_37_0, iter_37_1 in var_1_10001(arg_37_0.data) do
		...
		for iter_37_2, iter_37_3 in var_1_10006(var_1_10008.lover_letter_content.get_id_list_by_ship_group[iter_37_0]) do
...
function var_0_1.GetSystemData(arg_38_0, arg_38_1)
	if not arg_38_0.data then
		...
		var_38_1(var_38_0, var_1_10005.GET_ALL_LOVE_LETTER_DATA, {
			callback = arg_38_1
		})
	else
		arg_38_1()
