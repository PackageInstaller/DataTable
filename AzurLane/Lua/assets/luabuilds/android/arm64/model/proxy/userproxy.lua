...
function var_0_1.setLastLogin(arg_2_0, arg_2_1)
	...
	var_1_10002(var_1_10004(var_2_0, var_1_10007), "should be an instance of User")
...
function var_0_1.getLastLoginUser()
	...
	local var_3_0 = var_1_10000(var_1_10002.GetString("user.type"))

	PlayerPrefs = var_1_10001

	local var_3_1 = var_1_10001.GetString("user.arg1")
...
function var_0_1.SetDefaultGateway(arg_9_0)
	...
	if not var_9_0[var_1_10002] then
		...
		local var_9_3 = var_1_10005.GATEWAY_HOST

		NetConst = var_1_10006

		local var_9_4 = var_1_10006.GATEWAY_PORT

		NetConst = var_1_10007

		local var_9_5 = var_1_10007.PROXY_GATEWAY_HOST

		NetConst = var_1_10008
		var_9_1[var_1_10002] = var_9_2(var_9_3, var_9_4, var_9_5, var_1_10008.PROXY_GATEWAY_PORT)
	end
...
function var_0_1.GetCacheGatewayFlag(arg_13_0, arg_13_1)
	if not arg_13_0.cachePlatform then
		...
		PLATFORM = var_5
		arg_13_0.cachePlatform = var_13_0(var_13_1, var_5)
	end
...
function var_0_1.SaveCacheGatewayFlag(arg_16_0, arg_16_1)
	...
	if var_16_0(var_16_1, var_5) ~= arg_16_0.cachePlatform then
		PlayerPrefs = var_3
