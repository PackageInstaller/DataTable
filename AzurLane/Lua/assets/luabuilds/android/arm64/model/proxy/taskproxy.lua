...
function var_0_1.timeCall(arg_12_0)
	...
	var_12_0[var_1_10002.DayCall] = function(arg_13_0)
		...
		var_13_1(var_13_0, var_2_10004.ACCEPT_ACTIVITY_TASK)
		...
		var_13_3(var_13_2, var_4.ZERO_HOUR_OP_DONE)
...
function var_0_1.initTaskInfo(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	for iter_14_0, iter_14_1 in var_1_10004(arg_14_1) do
		...
		if var_1_10009.getConfigTable(var_14_0) ~= nil then
			...
			i18n = var_1_10013
			var_1_10013 = var_1_10013("task_notfound_error")
			tostring = var_1_10014

			var_14_3(var_14_2, var_1_10013 .. var_1_10014(iter_14_1.id))
			...
			var_14_4(var_14_5 .. var_1_10013(iter_14_1.id))
		end
	end
	...
	if arg_14_3 and #arg_14_3 > 0 then
		...
		for iter_14_2, iter_14_3 in var_4(arg_14_3) do
			...
			if var_1_10009.getConfigTable(var_14_6) ~= nil then
				...
				var_14_9(var_14_8, var_1_10013 .. var_1_10014(iter_14_3.id))
				...
				var_14_10(var_14_11 .. var_1_10013(iter_14_3.id))
			end
		end
	end
...
function var_0_1.clearTimeOut(arg_20_0)
	...
	for iter_20_0 = #arg_20_0.datas, 1, -1 do
		...
		if var_7.isActivityTask(var_20_2) then
			...
			if not var_1_10009.getActivityById(var_1_10011, var_20_4) or var_1_10009:isEnd() then
				table = var_20_3

				var_20_3.insert(var_20_1, var_7)
...
function var_0_1.addTask(arg_25_0, arg_25_1)
	...
	var_1_10002(var_1_10004(var_25_0, var_1_10007), "should be an instance of Task")
	...
	if arg_25_1:getConfigTable() == nil then
		...
		local var_25_3 = var_5("task_notfound_error")

		tostring = var_25_0

		var_25_2(var_25_1, var_25_3 .. var_25_0(arg_25_1.id))
		...
		var_25_4(var_25_5 .. var_5(arg_25_1.id))
...
function var_0_1.updateTask(arg_26_0, arg_26_1)
	...
	var_1_10002(var_1_10004(var_26_0, var_1_10007), "should be an instance of Task")
...
function var_0_1.getCanReceiveCount(arg_32_0)
	...
	for iter_32_0, iter_32_1 in var_1_10002(arg_32_0.data) do
		if iter_32_1:ShowOnTaskScene() and iter_32_1:isFinish() and iter_32_1:isReceive() == false then
			...
			for iter_32_2, iter_32_3 in var_1_10008(var_32_1) do
				unpack = var_1_10013

				local var_32_2, var_32_3

				var_1_10013, var_32_2, var_32_3 = var_1_10013(iter_32_3)
				...
				if not var_1_10016 then
					...
					if var_1_10013 == var_1_10016 then
						...
						if var_1_10016.getConfigData(var_32_2).virtual_type == 20 then
							pg = var_1_10016
							var_1_10016 = var_1_10016.gameset.urpt_chapter_max.description[1]
							LOCK_UR_SHIP = var_1_10017

							if not var_1_10017 then
								getProxy = var_1_10017
								BagProxy = var_1_10019
								var_1_10019 = var_1_10017(var_1_10019)

								if not var_1_10017.GetLimitCntById(var_1_10019, var_1_10016) then
									var_1_10017 = 0
								end
								...
								if not var_18 then
									...
									if not var_18.gameset.urpt_chapter_max.description[2] then
										var_32_4 = 0
									end

									if var_1_10017 + var_32_3 - var_32_4 > 0 then
										var_32_0 = var_32_0 - 1
									end
								end
							end
	...
	local var_32_5 = arg_32_0:GetWeekTaskProgressInfo()

	if var_2.CanUpgrade(var_32_5) then
		var_32_0 = var_32_0 + 1
	end
...
function var_0_1.removeTask(arg_34_0, arg_34_1)
	...
	var_1_10002(var_1_10004(var_34_0, var_1_10007), "should be an instance of Task")
...
function var_0_1.deleteTask(arg_36_0, arg_36_1)
	...
	var_1_10002(var_1_10004(var_36_0, var_1_10007), "should be an instance of Task")
...
function var_0_1.dealMingshiTouchFlag(arg_39_0, arg_39_1)
	...
	mingshiActivityId = var_1_10005

	if not var_39_1(var_39_0, var_1_10005) or var_2:isEnd() then
		return
	end

	local var_39_2 = var_2
	local var_39_3 = var_2.getConfig(var_39_2, "config_id")
	local var_39_4 = var_2:getConfig("config_data")[1]

	pg = var_39_2

	local var_39_5 = var_39_2.MsgboxMgr.GetInstance()
	...
	i18n = var_1_10009
	var_39_7.content = var_1_10009("mingshi_task_tip_" .. arg_39_1)
	...
	if arg_39_0:getTaskById(var_39_4) and var_5:getTaskStatus() < 1 then
		...
		local var_39_10 = var_9.ACTIVITY_OPERATION
		local var_39_11 = {
			cmd = 2
		}

		mingshiActivityId = var_11
		var_39_11.activity_id = var_11
...
function var_0_1.mingshiTouchFlagEnabled(arg_40_0)
	...
	if not var_40_1(var_40_0, var_1_10004) or var_1:isEnd() then
		return
	end

	tonumber = var_1_10002

	local var_40_2 = var_1_10002(var_1:getConfig("config_id"))

	tonumber = var_40_0

	local var_40_3 = var_40_0(var_1:getConfig("config_data")[1])
...
function var_0_1.getAcademyTask(arg_41_0, arg_41_1)
	...
	local var_41_2 = var_41_1(var_41_0, var_1_10006.ACTIVITY_TYPE_TASK_LIST)

	_ = var_1_10004

	if var_1_10004.detect(var_41_2, function(arg_42_0)
...
function var_0_1.isFinishPrevTasks(arg_43_0, arg_43_1)
	...
	if var_2.getConfig(var_43_0, "open_need") then
		...
		if var_4(var_3) == "table" and #var_3 > 0 then
			_ = var_4
...
function var_0_1.isReceiveTasks(arg_45_0, arg_45_1)
	...
	return var_1_10002.all(arg_45_1, function(arg_46_0)
		...
		return var_1.getFinishTaskById(var_46_0, arg_46_0) and var_1:isReceive()
	end)
end
...
function var_0_1.checkAutoSubmitTask(arg_48_0, arg_48_1)
	if arg_48_1:getConfig("auto_commit") == 1 and arg_48_1:isFinish() and not arg_48_1:getAutoSubmit() then
		...
		var_48_1(var_48_0, var_5.SUBMIT_TASK, arg_48_1.id, function(arg_49_0)
			if arg_49_0 then
