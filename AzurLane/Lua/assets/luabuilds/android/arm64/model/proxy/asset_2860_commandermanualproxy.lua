...
function var_0_1.register(arg_1_0)
	arg_1_0:on(22300, function(arg_2_0)
		...
		for iter_2_2, iter_2_3 in var_2(var_4.tutorial_handbook_task.all) do
			pg = var_2_10007
...
function var_0_1.UnlockTaskSubmitCall(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in var_1_10003(var_1_10005.tutorial_handbook.all) do
		pg = var_1_10008
...
function var_0_1.AddPageTaskDone(arg_11_0, arg_11_1)
	...
	for iter_11_0, iter_11_1 in var_1_10002(arg_11_0.commanderManualPages) do
		...
		if var_11_0 ~= 0 then
			...
			var_1_10008(var_11_1, iter_11_2.COMMANDER_MANUAL_OP_DONE, {
...
function var_0_1.TaskProgressAdd(arg_17_0, arg_17_1, arg_17_2)
	...
	for iter_17_0, iter_17_1 in var_1_10004(var_1_10006.task_data_template.all) do
		pg = var_1_10009

		local var_17_1 = var_1_10009.task_data_template[iter_17_1].type

		Task = var_1_10011

		if var_17_1 == var_1_10011.TYPE_COMMANDER_MANUAL and var_1_10009.sub_type == arg_17_1 then
			table = var_10

			var_10.insert(var_17_0, iter_17_1)
		end
	end
	...
	for iter_17_2, iter_17_3 in var_4(var_17_0) do
		...
		if var_1_10009.getTaskById(var_1_10011, iter_17_3) and var_1_10009:getTaskStatus() == 0 then
			local var_17_2 = arg_17_0
			local var_17_3 = arg_17_0.sendNotification

			GAME = var_1_10013

			var_17_3(var_17_2, var_1_10013.MINI_GAME_TASK_PROGRESS_UPDATE, {
				taskId = iter_17_3,
