...
function var_0_1.updateMail(arg_4_0, arg_4_1)
	...
	var_1_10002(var_1_10004(var_4_0, var_1_10007), "should be an instance of Mail")
...
function var_0_1.updateCollectionMail(arg_7_0, arg_7_1)
	...
	BaseMail = var_1_10007

	var_1_10002(var_1_10004(var_7_0, var_1_10007), "should be an instance of BaseMail")
...
function var_0_1.GetNewIndex(arg_18_0)
	...
	SINGLE_MAIL_REQUIRE_SIZE = var_4

	local var_18_2 = var_18_0(var_18_1, var_4)
...
function var_0_1.GetNextIndex(arg_19_0)
	...
	local var_19_2 = var_19_0(var_19_1, var_4)
...
function var_0_1.AddNewMails(arg_20_0, arg_20_1)
	...
	underscore = iter_20_0
	arg_20_0.ids = var_20_2(var_20_3, iter_20_0.map(arg_20_1, function(arg_21_0)
		return arg_21_0.id
	end))
...
function var_0_1.AddNextMails(arg_22_0, arg_22_1)
	...
	underscore = var_4
	arg_22_0.ids = var_22_0(var_4.map(arg_22_1, function(arg_23_0)
		return arg_23_0.id
	end), arg_22_0.ids)
...
function var_0_1.AddCollectionMails(arg_28_0, arg_28_1)
	...
	underscore = iter_28_0
	arg_28_0.collectionIds = var_28_0(var_28_1, iter_28_0.map(arg_28_1, function(arg_29_0)
		return arg_29_0.id
	end))
	...
	for iter_34_0, iter_34_1 in var_1_10003(arg_34_1) do
		if not arg_34_0.data[iter_34_1].attachFlag then
			...
			for iter_34_2, iter_34_3 in var_9(var_8.attachments) do
				...
				var_1_10014(var_34_1, var_1_10017(iter_34_3))
			end
		end
	end
