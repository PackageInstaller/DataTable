...
function var_0_1.initData(arg_2_0)
	...
	var_2_2.dateValue = var_1_10002.Data_All_Value
	GalleryConst = var_2
...
function var_0_1.checkPicFileState(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10003(var_1_10005.gallery_config.all) do
		pg = var_1_10008
...
function var_0_1.checkMusicFileState(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10003(var_1_10005.music_collect_config.all) do
		pg = var_1_10008
...
function var_0_1.getPicExistStateByID(arg_7_0, arg_7_1)
	if not arg_7_1 then
		...
		var_1_10002(var_7_0 .. var_1_10005(arg_7_1))
	end
...
function var_0_1.getMusicExistStateByID(arg_8_0, arg_8_1)
	if not arg_8_1 then
		...
		var_1_10002(var_8_0 .. var_1_10005(arg_8_1))
	end
...
function var_0_1.getSinglePicConfigByID(arg_9_0, arg_9_1)
	...
	if var_1_10002.gallery_config[arg_9_1] then
		...
		var_1_10003(var_9_0, var_9_1 .. var_1_10007(arg_9_1))
	end
...
function var_0_1.getSingleMusicConfigByID(arg_10_0, arg_10_1)
	...
	if var_1_10002.music_collect_config[arg_10_1] then
		...
		var_1_10003(var_10_0, var_10_1 .. var_1_10007(arg_10_1))
	end
...
function var_0_1.isPicNeedUnlockByID(arg_15_0, arg_15_1)
	...
	local var_15_1 = arg_15_0.getPicUnlockMaterialByID(var_15_0, arg_15_1)

	if arg_15_0:getSinglePicConfigByID(arg_15_1) then
		if var_3.unlock_level[1] == 1 and var_15_0[2] == 0 then
			if #var_15_1 == 0 then
				return false
			else
				return true
		...
		var_15_0(false, "不存在的插画ID:" .. arg_15_1)
	end
...
function var_0_1.isMusicNeedUnlockByID(arg_16_0, arg_16_1)
	...
	local var_16_1 = arg_16_0.getMusicUnlockMaterialByID(var_16_0, arg_16_1)

	if arg_16_0:getSingleMusicConfigByID(arg_16_1) then
		if var_3.unlock_level[1] == 1 and var_16_0[2] == 0 then
			if #var_16_1 == 0 then
				return false
			else
				return true
		...
		var_16_0(false, "不存在的音乐ID:" .. arg_16_1)
	end
...
function var_0_1.getPicUnlockMaterialByID(arg_17_0, arg_17_1)
	if arg_17_0:getSinglePicConfigByID(arg_17_1) then
		var_1_10003 = var_2.unlock_cost

		local var_17_0 = {}

		ipairs = var_5

		for iter_17_0, iter_17_1 in var_5(var_1_10003) do
			local var_17_1 = {
				type = iter_17_1[1],
				id = iter_17_1[2],
				count = iter_17_1[3]
		...
		var_1_10003(false, "不存在的插画ID:" .. arg_17_1)
	end
...
function var_0_1.getMusicUnlockMaterialByID(arg_18_0, arg_18_1)
	if arg_18_0:getSingleMusicConfigByID(arg_18_1) then
		var_1_10003 = var_2.unlock_cost
		...
		for iter_18_0, iter_18_1 in var_5(var_1_10003) do
			local var_18_1 = {
				type = iter_18_1[1],
				id = iter_18_1[2],
				count = iter_18_1[3]
		...
		var_1_10003(false, "不存在的音乐ID:" .. arg_18_1)
	end
...
function var_0_1.getPicUnlockTipTextByID(arg_21_0, arg_21_1)
	if arg_21_0:getSinglePicConfigByID(arg_21_1) then
		return var_2.illustrate
	else
		assert = var_1_10003

		var_1_10003(false, "不存在的插画ID:" .. arg_21_1)
	end
...
function var_0_1.getMusicUnlockTipTextByID(arg_22_0, arg_22_1)
	if arg_22_0:getSingleMusicConfigByID(arg_22_1) then
		return var_2.illustrate
	else
		assert = var_1_10003

		var_1_10003(false, "不存在的音乐ID:" .. arg_22_1)
	end
...
function var_0_1.initMangaReadIDList(arg_28_0, arg_28_1)
	...
	for iter_28_0, iter_28_1 in var_2(arg_28_1) do
		for iter_28_2 = 1, 32 do
			...
			bit = var_1_10014
			var_1_10011 = var_1_10011(var_28_0, var_1_10014.lshift(1, iter_28_2 - 1)) ~= 0
...
function var_0_1.initMangaLikeIDList(arg_32_0, arg_32_1)
	...
	for iter_32_0, iter_32_1 in var_2(arg_32_1) do
		for iter_32_2 = 1, 32 do
			...
			bit = var_1_10014
			var_1_10011 = var_1_10011(var_32_0, var_1_10014.lshift(1, iter_32_2 - 1)) ~= 0
...
function var_0_1.getAlbumMusicList(arg_49_0, arg_49_1)
	if arg_49_1 == "favor" then
		...
		if not var_1_10005.music_collect_config.get_id_list_by_album_id[var_49_1] then
			var_49_3 = {}
		end
...
function var_0_1.isGalleryHaveNewRes(arg_51_0)
	...
	if var_51_0 < var_1_10002.Version then
		return true
	else
		return false
	end
...
function var_0_1.isMusicHaveNewRes(arg_52_0)
	...
	if var_52_0 < var_1_10002.Version then
		return true
	else
		return false
	end
...
function var_0_1.isMangaHaveNewRes(arg_53_0)
	...
	if var_53_0 < var_1_10002.Version then
		return true
	else
		return false
	end
