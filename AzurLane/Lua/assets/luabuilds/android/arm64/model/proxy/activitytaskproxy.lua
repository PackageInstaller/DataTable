...
function var_0_1.initActList(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if arg_3_3 and #arg_3_3 > 0 then
		...
		for iter_3_2, iter_3_3 in var_6(arg_3_3) do
			...
			var_1_10012.insert(var_3_1, var_3_3)
		end
	end
...
function var_0_1.finishActTask(arg_4_0, arg_4_1, arg_4_2)
	...
	if not var_4_1(var_1_10007.act_task_onece_type, var_4_0) then
		return
	end
	...
	for iter_7_0, iter_7_1 in var_1_10003(arg_7_2) do
		for iter_7_2 = 1, #arg_7_0.actTasks do
			if arg_7_0.actTasks[iter_7_2].actId == arg_7_1 then
				...
				local var_7_0 = arg_7_0:createTask(arg_7_1, iter_7_1)

				table = var_14

				var_14.insert(var_12, var_7_0)
			end
		end
	end
...
function var_0_1.checkAutoSubmit(arg_8_0)
	...
	for iter_8_0 = 1, #arg_8_0.actTasks do
		...
		if #var_8_2 > 0 then
			...
			var_1_10008(var_8_3, iter_8_1.SUBMIT_ACTIVITY_TASK, {
				act_id = var_8_0,
				task_ids = var_8_2
			})
		end
...
function var_0_1.getFinishTaskById(arg_11_0, arg_11_1)
	...
	for iter_11_0, iter_11_1 in var_1_10002(arg_11_0.actTasks) do
		if iter_11_1.actId == arg_11_1 then
			...
			var_1_10008.each(var_11_0, function(arg_12_0)
				arg_12_0:setOver()
...
function var_0_1.getFinishTasksByActId(arg_13_0, arg_13_1)
	...
	local var_13_1 = var_2:GetFinishedTaskIds()

	_ = var_13_0

	return var_13_0.map(var_13_1, function(arg_14_0)
...
function var_0_1.getTaskVOsByActId(arg_17_0, arg_17_1)
	...
	var_1_10003.insertto(var_17_0, arg_17_0:getFinishTasksByActId(arg_17_1))
...
function var_0_1.getFinishTasks(arg_21_0)
	...
	local var_21_3 = var_21_0.each

	_ = var_1_10005

	var_21_3(var_1_10005.map(var_21_1, function(arg_22_0)
...
function var_0_1.GetActivityTasks(arg_24_0, arg_24_1)
	...
	local var_24_2 = arg_24_0.getFinishTaskById(var_24_1, arg_24_1)
	local var_24_3 = {}

	_ = var_24_1

	var_24_1.each(var_24_0, function(arg_25_0)
		var_24_3[arg_25_0.id] = arg_25_0
	...
	var_5.each(var_24_2, function(arg_26_0)
		var_24_3[arg_26_0.id] = arg_26_0
