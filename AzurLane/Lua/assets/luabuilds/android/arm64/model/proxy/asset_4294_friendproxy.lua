...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(50104, function(arg_5_0)
		...
		local var_5_1 = var_2_10003.ChannelFriend
		local var_5_2 = {}

		Player = var_2_10005
		var_5_2.player = var_2_10005.New(arg_5_0.msg.player)
...
function var_0_1.addChatMsg(arg_12_0, arg_12_1, arg_12_2)
	...
	var_1_10003(var_1_10005(var_12_0, var_1_10008), "should be an instance of ChatMsg")
	...
	if arg_12_0.data[arg_12_1] then
		...
		local var_12_4 = var_6.gsub
		local var_12_5 = var_12_2

		ChatConst = var_1_10009

		var_12_4(var_12_5, var_1_10009.EmojiCodeMatch, function(arg_13_0)
		...
		var_12_0.insert(var_12_6.cacheMsgs, arg_12_2)
...
function var_0_1.setBlackList(arg_19_0, arg_19_1)
	...
	var_19_1(var_19_0, var_19_2, var_1_10006(arg_19_1))
...
function var_0_1.addIntoBlackList(arg_23_0, arg_23_1)
	if arg_23_0.blackList then
		...
		var_23_1(var_23_0, var_23_2, var_1_10006(arg_23_1))
	end
