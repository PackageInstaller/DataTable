...
function var_0_1.getActivityIdsByType(arg_12_0, arg_12_1)
	...
	return var_12_0(var_1_10004.activity_task_permanent.all, function(arg_13_0)
...
function var_0_1.getDoingActivityById(arg_15_0, arg_15_1, arg_15_2)
	if arg_15_0:getDoingActivityId(arg_15_1, arg_15_2) then
		getProxy = var_1_10004
		ActivityProxy = var_6

		local var_15_0 = var_1_10004(var_6)
		local var_15_1

		if not var_4.getActivityById(var_15_0, var_3) then
			var_15_1 = nil
		end
