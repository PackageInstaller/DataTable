...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(63315, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in var_2_10002(arg_2_0.arg1) do
	...
	arg_1_0:on(63316, function(arg_3_0)
		...
		for iter_3_0, iter_3_1 in var_2_10004(arg_3_0.skill_info_list) do
			...
			pg = var_2_10016
			var_2_10016 = var_2_10016.gameset.meta_skill_exp_max.key_value

			local var_3_13 = var_3_12:getMetaSkillLevelBySkillID(var_3_3)
			local var_3_14 = var_2_10016 <= var_3_6
			local var_3_15 = var_3_13 < var_3_4

			if var_3_14 or var_3_15 then
				pg = var_20

				local var_3_16 = var_20.ToastMgr.GetInstance()
				local var_3_17 = var_20.ShowToast

				pg = var_2_10023

				var_3_17(var_3_16, var_2_10023.ToastMgr.TYPE_META, {
					metaShipVO = var_3_12,
					newDayExp = var_3_6,
					addDayExp = var_3_7,
					curSkillID = var_3_3,
					newSkillLevel = var_3_4,
					oldSkillLevel = var_3_13
				})
			end
			...
			local var_3_19 = var_20(var_3_18)

			var_20.updateShip(var_3_19, var_3_12)
		end
...
function var_0_1.setMetaTacticsInfo(arg_10_0, arg_10_1)
	...
	if var_1_10003.New(arg_10_1) then
		var_1_10004 = arg_10_0.metaTacticsInfoTable
		var_1_10004[var_10_1] = var_3

		var_3:printInfo()
	else
		errorMessage = var_1_10004

		var_1_10004("Creat MetaTacticsInfo Fail!")
	end
...
function var_0_1.requestMetaTacticsInfo(arg_14_0, arg_14_1, arg_14_2)
	...
	if not arg_14_1 then
		...
		local var_14_0 = var_14_1(var_1_10005)
	...
	if arg_14_2 then
		...
		var_14_3(var_14_2, var_1_10007.TACTICS_EXP_META_INFO_REQUEST, {
			idList = var_14_1
		})
	elseif not arg_14_0.metaTacticsInfoTable then
		...
		var_14_5(var_14_4, var_1_10007.TACTICS_EXP_META_INFO_REQUEST, {
			idList = var_14_1
		})
	end
...
function var_0_1.getMetaTacticsInfoOnEnd(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10004(var_18_1) do
		...
		if var_18_3:isAnyLearning() then
			var_18_5 = var_18_4:isAnyLearning()
		end

		getProxy = var_1_10013
		BayProxy = var_1_10015
		var_1_10015 = var_1_10013(var_1_10015)
		var_1_10015 = var_1_10013.getShipById(var_1_10015, var_9)
		var_1_10013 = var_1_10013.isAllMetaSkillLevelMax(var_1_10015)
		...
		if var_18_5 and not var_1_10013 and not var_18_6 then
			var_1_10015 = var_18_3.curSkillID

			local var_18_7 = var_18_3.curDayExp - var_18_4.curDayExp

			getProxy = var_17
			BayProxy = var_1_10019
			var_1_10019 = var_17(var_1_10019)
			var_1_10019 = var_17.getShipById(var_1_10019, var_9)

			local var_18_8 = var_17.isSkillLevelMax(var_1_10019, var_1_10015)
			local var_18_9 = var_18_7 > 0 and var_18_8
			local var_18_10 = var_18_3

			var_1_10019 = var_18_3.isExpMaxPerDay(var_18_10)

			local var_18_11 = var_18_4.curDayExp

			pg = var_18_10

			local var_18_12 = var_18_11 / var_18_10.gameset.meta_skill_exp_max.key_value
			local var_18_13 = var_18_3.curDayExp

			pg = var_1_10022

			local var_18_14 = var_18_13 / var_1_10022.gameset.meta_skill_exp_max.key_value
			...
			if 0 < var_18_7 then
				...
				var_1_10022.insert(var_18_0, {
					...
					isUpLevel = var_18_9,
					isMaxLevel = var_18_8,
					isExpMax = var_1_10019,
					progressOld = var_18_12,
					progressNew = var_18_14
				})
			end
		end
	end
...
function var_0_1.setLastMetaSkillExpInfo(arg_24_0, arg_24_1, arg_24_2)
	...
	pg = var_1_10019
	var_24_15.progress = var_24_4 / var_1_10019.gameset.meta_skill_exp_max.key_value
