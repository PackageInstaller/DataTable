...
function var_0_1.initData(arg_5_0, arg_5_1)
	...
	var_5_1(var_5_0, var_1_10005.EDUCATE_GET_ENDINGS)
...
function var_0_1.GetSelectInfo(arg_7_0)
	...
	local var_7_1 = var_3("word_month")

	i18n = var_1_10004

	local var_7_2 = var_7_0 .. var_7_1 .. var_1_10004("word_which_week", arg_7_0.curTime.week)
	local var_7_3 = {}
...
function var_0_1.initOptions(arg_11_0, arg_11_1)
	...
	for iter_11_2, iter_11_3 in var_3(var_5.child_site_option.all) do
...
function var_0_1.initVirtualStage(arg_21_0)
	...
	if var_21_2 ~= 0 then
		...
		if var_21_1.child_target_set[var_21_2].stage == var_21_4 + 1 then
...
function var_0_1.Reset(arg_24_0, arg_24_1)
	...
	var_24_2(var_24_1, var_1_10005.EDUCATE_REQUEST, {
		callback = arg_24_1
	})
...
function var_0_1.Refresh(arg_25_0, arg_25_1)
	...
	var_25_2(var_25_1, var_1_10005.EDUCATE_REQUEST, {
		callback = arg_25_1
	})
...
function var_0_1.ReduceResForPlans(arg_32_0)
	...
	var_32_4(var_32_3, var_1_10006.RES_MONEY_ID, -var_32_1)
	...
	var_32_6(var_32_5, var_6.RES_MOOD_ID, -var_32_2)
...
function var_0_1.AddExtraAttr(arg_36_0, arg_36_1)
	...
	var_36_1(var_36_0, var_36_2, var_6.getConfig(var_36_3, "attr_2_add"))
...
function var_0_1.AddEnding(arg_45_0, arg_45_1, arg_45_2)
	...
	for iter_45_0, iter_45_1 in var_1_10004(arg_45_2) do
		table = var_1_10009
...
function var_0_1.GetEndingResult(arg_48_0)
	...
	local var_48_1 = var_48_0(var_1_10003.child_ending.all, function(arg_49_0)
		pg = var_2_10001
	...
	var_1_10002(#var_48_1 > 0, "not matching ending")
...
function var_0_1.AddBuff(arg_52_0, arg_52_1)
	if arg_52_0.buffData[arg_52_1] then
		local var_52_0 = arg_52_0.buffData[arg_52_1]

		var_2.ResetEndTime(var_52_0)
	else
		local var_52_1 = arg_52_0.buffData

		EducateBuff = var_1_10003
		var_52_1[arg_52_1] = var_1_10003.New({
			id = arg_52_1
		})
	end
...
function var_0_1.RefreshOptions(arg_58_0)
	...
	for iter_58_0, iter_58_1 in var_1_10002(arg_58_0.siteOptionData) do
...
function var_0_1.GetShowSiteIds(arg_59_0)
	...
	return var_59_0(var_1_10003.child_site.all, function(arg_60_0)
		pg = var_2_10001
		...
		if var_2_10001.child_site[arg_60_0].type == 1 then
			...
			var_60_3 = var_60_0(var_60_1, var_5.IsFirstGame(var_60_2))
		else
			var_60_3 = false
		end
...
function var_0_1.GetOptionsBySiteId(arg_61_0, arg_61_1)
	...
	var_1_10007.each(var_61_4, function(arg_64_0)
...
function var_0_1.AddItem(arg_69_0, arg_69_1, arg_69_2)
	if arg_69_0.itemData[arg_69_1] then
		local var_69_0 = arg_69_0.itemData[arg_69_1]

		var_3.AddCount(var_69_0, arg_69_2)
	else
		local var_69_1 = arg_69_0.itemData

		EducateItem = var_1_10004
		var_69_1[arg_69_1] = var_1_10004.New({
			id = arg_69_1,
			num = arg_69_2
		})
	end
...
function var_0_1.AddPolaroid(arg_76_0, arg_76_1)
	...
	var_76_1(var_1_10004.NEW_POLAROID)
...
function var_0_1.CanGetPolaroidById(arg_81_0, arg_81_1)
	...
	local var_81_4 = var_81_0.child_polaroid[arg_81_1]

	table = var_81_2

	if var_81_2.contains(var_81_4.stage, var_81_1) then
...
function var_0_1.GetPolaroidGroupCnt(arg_82_0)
	...
	for iter_82_0, iter_82_1 in var_1_10003(var_1_10005.child_polaroid.get_id_list_by_group) do
...
function var_0_1.AddMemory(arg_84_0, arg_84_1)
	...
	var_84_0(var_4.NEW_MEMORY, arg_84_1)
...
function var_0_1.initUnlockSecretary(arg_88_0, arg_88_1)
	...
	arg_88_0.unlockSecretaryTaskId = (function()
		...
		for iter_89_0, iter_89_1 in var_2_10000(var_2_10002.secretary_special_ship.all) do
			pg = var_2_10005
	...
	for iter_88_0, iter_88_1 in var_3(var_1_10005.secretary_special_ship.all) do
		pg = var_1_10008
...
function var_0_1.CheckNewSecretaryTip(arg_92_0)
	local var_92_0 = arg_92_0:GetPolaroidGroupCnt()

	table = var_1_10002

	if var_1_10002.contains(arg_92_0.unlcokTipByPolaroidCnt, var_92_0) then
...
function var_0_1.updateSecretaryIDs(arg_94_0, arg_94_1)
	...
	if arg_94_1 then
		...
		var_94_0 = var_1_10003(var_1_10005.GetAllUnlockSecretaryIds())
	end

	arg_94_0.unlockSecretaryIds = {}

	local var_94_1 = arg_94_0
	local var_94_2, var_94_3 = arg_94_0.GetPolaroidGroupCnt(var_94_1)

	ipairs = var_94_1
	pg = var_1_10007

	for iter_94_0, iter_94_1 in var_94_1(var_1_10007.secretary_special_ship.get_id_list_by_tb_id[0]) do
		pg = var_1_10010
		...
		var_94_5[var_1_10016.SECRETARY_UNLCOK_TYPE_DEFAULT] = function()
		...
		EducateConst = var_1_10016
		var_94_5[var_1_10016.SECRETARY_UNLCOK_TYPE_POLAROID] = function()
		...
		EducateConst = var_1_10016
		var_94_5[var_1_10016.SECRETARY_UNLCOK_TYPE_ENDING] = function()
		...
		EducateConst = var_1_10016
		var_94_5[var_1_10016.SECRETARY_UNLCOK_TYPE_SHOP] = function()
			if var_1_10011[1] then
				getProxy = var_0
				ShipSkinProxy = var_2_10002

				local var_98_0 = var_0(var_2_10002)
		...
		EducateConst = var_1_10016
		var_94_5[var_1_10016.SECRETARY_UNLCOK_TYPE_STORY] = function()
			return
		end
	...
	if arg_94_1 then
		...
		local var_94_6 = var_5(var_7)

		var_5.UpdateEducateCharTip(var_94_6, var_94_0)
	end
...
function var_0_1.GetEducateGroupList(arg_100_0)
	...
	for iter_100_0, iter_100_1 in var_1_10002(var_1_10004.secretary_special_ship.get_id_list_by_group) do
		table = var_1_10007
		var_1_10007 = var_1_10007.insert

		local var_100_1 = var_100_0

		EducateCharGroup = var_1_10010

		var_1_10007(var_100_1, var_1_10010.New(iter_100_0))
	end
