...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("model.proxy.NetProxy"))
...
local function var_0_2(arg_2_0, arg_2_1, arg_2_2)
	...
	var_2_1(var_2_0, var_1_10006.GET_FEAST_DATA, {
...
local function var_0_3(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_3 = arg_3_0:RandomShips(var_3_2, var_3_0)

	_ = var_3_1

	local var_3_4 = var_3_1.map(var_3_3, function(arg_4_0)
		return arg_4_0.id
	end)
	...
	local var_3_7 = var_1_10012.FEAST_OP
	local var_3_8 = {
		activityId = arg_3_1.id
	}

	FeastDorm = var_14
	var_3_8.cmd = var_14.OP_RANDOM_SHIPS
	var_3_8.argList = var_3_4
	var_3_8.callback = arg_3_2

	var_3_6(var_3_5, var_3_7, var_3_8)
...
function var_0_1.RequestData(arg_5_0, arg_5_1)
	...
	if not var_5_1(var_5_0, var_1_10005.ACTIVITY_TYPE_FEAST) or var_2:isEnd() then
		arg_5_1()
...
function var_0_1.GetConsumeList(arg_10_0)
	...
	local var_10_2 = var_10_1(var_10_0, var_1_10004.ACTIVITY_TYPE_FEAST)
	local var_10_3
	...
	local var_10_5 = var_5.activity_partyinvitation_template[var_10_4].invitationID[2]
...
local function var_0_4(arg_11_0)
	...
	local var_11_1 = var_11_0(var_1_10003.ship_data_group.all, function(arg_12_0)
		pg = var_2_10001
	...
	for iter_11_0, iter_11_1 in var_4(var_11_1) do
		pg = var_1_10009
		...
		if arg_11_0[var_1_10009.ship_data_group[iter_11_1].group_type] then
			...
			var_1_10011(var_11_4, var_1_10014.New({
...
local function var_0_5(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	for iter_13_2, iter_13_3 in iter_13_0(var_13_0) do
		...
		for iter_13_4, iter_13_5 in var_1_10014(var_1_10013) do
...
function var_0_1.RandomShips(arg_14_0, arg_14_1, arg_14_2)
	...
	for iter_14_2, iter_14_3 in var_6(var_14_3) do
		table = var_1_10011
	...
	for iter_14_4, iter_14_5 in var_1_10011(var_14_8) do
		table = var_1_10016
...
function var_0_1.AddRefreshTimer(arg_15_0)
	...
	local var_15_2 = var_1_10002() - var_15_1
	...
	arg_15_0.timer = var_1_10004.New(function()
		...
		if var_16_2(var_16_1, var_2_10003.ACTIVITY_TYPE_FEAST) and not var_0:isEnd() then
...
function var_0_1.GetBuffList(arg_20_0)
	...
	if not var_20_1(var_20_0, var_1_10004.FEAST_PT_ACT) or var_1:isEnd() then
		return {}
	end
...
function var_0_1.GetTaskList(arg_21_0)
	...
	local var_21_2 = var_21_1(var_21_0, var_1_10004.FEAST_TASK_ACT)

	assert = var_1_10002

	var_1_10002(var_21_2)
	...
	local var_21_4 = var_21_0(var_1_10005)

	ipairs = var_4

	for iter_21_0, iter_21_1 in var_4(var_21_2:getConfig("config_data")) do
		local var_21_5

		if not var_21_4:getTaskById(iter_21_1) then
			var_21_5 = var_21_4:getFinishTaskById(iter_21_1)
		end

		if var_21_5 then
			table = var_1_10010

			var_1_10010.insert(var_21_3, iter_21_1)
		end
	end
...
function var_0_1.GetPtActData(arg_22_0)
	...
	local var_22_2 = var_22_1(var_22_0, var_1_10004.FEAST_PT_ACT)

	assert = var_1_10002

	var_1_10002(var_22_2)

	ActivityPtData = var_1_10002

	return (var_1_10002.New(var_22_2))
end
...
function var_0_1.GetSubmittedTaskStories(arg_23_0)
	...
	if not var_23_1(var_23_0, var_1_10004.ACTIVITY_TYPE_FEAST) or var_1:isEnd() then
		return {}
	end
	...
	for iter_23_0, iter_23_1 in var_5(var_23_3) do
...
function var_0_1.ShouldTipFeastTask(arg_25_0)
	...
	for iter_25_0, iter_25_1 in var_1_10003(var_25_1) do
...
function var_0_1.ShouldTipInvitation(arg_27_0)
	...
	local var_27_2 = var_27_1(var_27_0, var_1_10004.ACTIVITY_TYPE_VIRTUAL_BAG)
	local var_27_3, var_27_4 = arg_27_0:GetConsumeList()
	local var_27_5 = var_27_2:getVitemNumber(var_27_3)
	local var_27_6 = var_27_2
	local var_27_7 = var_27_2.getVitemNumber(var_27_6, var_27_4)
	local var_27_8 = arg_27_0.data
	local var_27_9 = var_6.GetInvitedFeastShipList(var_27_8)

	ipairs = var_27_6

	for iter_27_0, iter_27_1 in var_27_6(var_27_9) do
		if not iter_27_1:GotGift() and var_27_7 > 0 or not iter_27_1:GotTicket() and var_27_5 > 0 then
			return true
		end
	end
...
function var_0_1.ShouldTip(arg_28_0)
	...
	if var_28_1(var_28_0, var_1_10004.FEAST_TASK_ACT) then
		...
		local var_28_3 = var_1_10002(var_28_2)
		local var_28_4 = var_2.getActivityById

		ActivityConst = var_1_10005

		if var_28_4(var_28_3, var_1_10005.FEAST_PT_ACT) then
			...
			local var_28_6 = var_28_0(var_28_5)
			local var_28_7 = var_3.getActivityByType

			ActivityConst = var_1_10006

			if not var_28_7(var_28_6, var_1_10006.ACTIVITY_TYPE_VIRTUAL_BAG) or var_3:isEnd() then
				return false
			end
			...
			for iter_28_0, iter_28_1 in var_28_6(var_28_9) do
...
function var_0_1.HandleTaskStories(arg_29_0, arg_29_1, arg_29_2)
	...
	if arg_29_0.GetSubmittedTaskStories(var_29_0) then
		...
		if var_1_10004.getCount(var_3) == 0 then
			if arg_29_2 then
				arg_29_2()
			end
