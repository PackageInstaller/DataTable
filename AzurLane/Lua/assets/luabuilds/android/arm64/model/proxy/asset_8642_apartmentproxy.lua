...
function var_0_1.timeCall(arg_5_0)
	...
	var_5_0[var_1_10002.DayCall] = function(arg_6_0, arg_6_1)
		...
		getDorm3dGameset = var_2_10003
		var_6_2.stamina = var_2_10003("daily_vigor_max")[1]
...
function var_0_1.InitGiftDaily(arg_7_0)
	...
	var_7_1(var_7_0, var_1_10004.GET_CHARGE_LIST, {
		callback = function()
			ipairs = var_2_10000
			pg = var_2_10002

			for iter_8_0, iter_8_1 in var_2_10000(var_2_10002.dorm3d_gift.all) do
				pg = var_2_10005
				...
				if #var_2_10005.dorm3d_gift[iter_8_1].shop_id > 0 then
					...
					if var_6.shop_template[var_2_10005.shop_id[1]].group ~= 0 then
						...
						ShopsProxy = var_2_10011
						var_2_10011 = var_2_10009(var_2_10011)
						var_8_0[var_8_1] = var_2_10009.GetGroupPayCount(var_2_10011, var_6)
					end
				end
			end
...
function var_0_1.triggerFavor(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	if arg_13_0.stamina >= var_13_1.is_daily_max and not var_13_0:isMaxFavor() then
		...
		math = var_8
		var_13_2 = var_8.min(var_13_1.num * arg_13_3, var_13_0:getMaxFavor() - var_13_0.favor)
	end

	arg_13_0.stamina = arg_13_0.stamina - var_13_3
	var_13_0.favor = var_13_0.favor + var_13_2

	local var_13_4 = var_13_0.triggerCountDic

	var_13_4[arg_13_2] = var_13_0.triggerCountDic[arg_13_2] + 1
	pg = var_13_4

	local var_13_5 = var_13_4.m02
	local var_13_6 = var_8.sendNotification

	GAME = var_1_10011

	local var_13_7 = var_1_10011.APARTMENT_TRACK

	Dorm3dTrackCommand = var_1_10012

	local var_13_8 = var_1_10012.BuildDataFavor
	local var_13_9 = arg_13_1
	local var_13_10 = var_13_2
	local var_13_11 = var_13_0.favor
	local var_13_12 = var_13_1.type

	table = var_1_10018

	var_13_6(var_13_5, var_13_7, var_13_8(var_13_9, var_13_10, var_13_11, var_13_12, var_1_10018.CastToString(var_13_1.param)))
...
function var_0_1.GetRoomInviteList(arg_39_0)
	...
	local var_39_1 = var_1_10003.split

	PlayerPrefs = var_1_10005

	local var_39_2 = var_1_10005.GetString

	string = var_1_10007

	return var_39_0(var_39_1(var_39_2(var_1_10007.format("room%d_invite_list", arg_39_0), ""), "|"), function(arg_40_0)
...
function var_0_1.SetRoomInviteList(arg_41_0, arg_41_1, arg_41_2, arg_41_3)
	...
	local var_41_3 = var_7.SetString

	string = var_1_10009

	local var_41_4 = var_1_10009.format("room%d_invite_list", arg_41_1)

	table = var_1_10010

	var_41_3(var_41_4, var_1_10010.concat(arg_41_2, "|"))
	arg_41_0:sendNotification(var_0_1.UPDATE_ROOM_INVITE_LIST, {
		roomId = arg_41_1,
		groupIds = arg_41_2,
		addIds = var_41_1,
		removeIds = var_41_2,
	...
	local var_41_5 = var_0_1.GetSlideInviteList()

	underscore = var_8

	if #var_8.filter(var_41_5, function(arg_42_0)
		table = var_2_10001
...
function var_0_1.GetSlideInviteList()
	...
	local var_43_1 = var_1_10002.split

	PlayerPrefs = var_1_10004

	local var_43_2

	if not var_43_0(var_43_1(var_1_10004.GetString("slide_invite_list", ""), "|"), function(arg_44_0)
		tonumber = var_2_10001
...
function var_0_1.SetSlideInviteList(arg_45_0, arg_45_1, arg_45_2)
	...
	local var_45_3 = var_6.SetString
	local var_45_4 = "slide_invite_list"

	table = var_1_10009

	var_45_3(var_45_4, var_1_10009.concat(arg_45_1, "|"))
...
function var_0_1.CheckUnlockConfig(arg_48_0)
	...
	local var_48_1 = {
		function(arg_49_0, arg_49_1, arg_49_2)
			...
			local var_49_0 = var_2_10003(var_2_10005)
			...
			if var_3.getApartment(var_49_0, arg_49_1) and arg_49_2 <= var_3.level then
				...
				local var_49_2 = var_49_0("apartment_level_unenough", arg_49_2)
		...
		function(arg_50_0, arg_50_1)
			...
			local var_50_0 = var_2_10002(var_2_10004)
			local var_50_1 = var_2.getRoom

			pg = var_2_10005

			if var_50_1(var_50_0, var_2_10005.dorm3d_furniture_template[arg_50_1].room_id) then
				underscore = var_2_10003

				if var_2_10003.any(var_2.furnitures, function(arg_51_0)
			...
			do
				...
				local var_50_3 = var_50_0.format("without dorm furniture:%d", arg_50_1)
		...
		function(arg_52_0, arg_52_1)
			...
			local var_52_0 = var_2_10002(var_2_10004)
			...
			if var_2.isGiveGiftDone(var_52_0, arg_52_1) then
				...
				local var_52_2 = var_2_10003.format("gift:%d didn't had given", arg_52_1)
		...
		function(arg_53_0, arg_53_1)
			...
			local var_53_0 = var_2_10002(var_2_10004)
			...
			do
				...
				local var_53_3 = var_53_0.format("ship:%d was not married", arg_53_1)
		...
		function(arg_54_0, arg_54_1, arg_54_2)
			...
			local var_54_0 = var_2_10003(var_2_10005)
			local var_54_1

			var_54_1 = var_3.getRoom(var_54_0, arg_54_1) and var_3.unlockCharacter[arg_54_2]
			i18n = var_54_0

			local var_54_2 = var_54_0("dorm3d_skin_locked")
		end,
		function(arg_55_0, arg_55_1, arg_55_2)
			getProxy = var_2_10003
			ApartmentProxy = var_2_10005

			local var_55_0 = var_2_10003(var_2_10005)
			...
			if var_3.getApartment(var_55_0, arg_55_2) then
				...
				local var_55_1 = var_2_10004.detect(var_3.skinList, function(arg_56_0)
			...
			local var_55_2 = var_55_0("dorm3d_skin_locked")
		end
	}
	...
	return var_1_10001(var_48_0, var_48_1, var_48_2, var_1_10006(arg_48_0))
end
...
function var_0_1.PendingRandom(arg_58_0, arg_58_1)
	...
	for iter_58_0, iter_58_1 in var_1_10003(arg_58_1) do
		...
		if var_1_10008(var_1_10010.dorm3d_rooms[arg_58_0].character_welcome, function(arg_59_0)
			return arg_59_0[1] == iter_58_1
		end) then
			local var_58_1 = var_1_10008[2]

			math = var_1_10010

			if var_1_10010.random() * 16 < var_58_1 then
				var_58_0[iter_58_1] = {}
			end
		end
	end
	...
	if not var_5.dorm3d_welcome.get_id_list_by_room_id[arg_58_0] then
		var_58_2 = {}
	end

	for iter_58_2, iter_58_3 in var_3(var_58_2) do
		pg = var_1_10008
	...
	for iter_58_4, iter_58_5 in var_4(var_58_0) do
		...
		for iter_58_6, iter_58_7 in var_1_10011(iter_58_5) do
			pg = iter_58_9
			var_58_5 = var_58_5 + iter_58_9.dorm3d_welcome[iter_58_7].weight
		end

		math = var_1_10011
		var_1_10011 = var_1_10011.random() * var_58_5
		ipairs = var_12

		for iter_58_8, iter_58_9 in var_12(iter_58_5) do
			pg = var_1_10017

			if var_1_10011 < var_58_4 + var_1_10017.dorm3d_welcome[iter_58_9].weight then
...
function var_0_1.RefreshGiftDailyTip()
	...
	for iter_60_0, iter_60_1 in var_1_10000(var_1_10002.dorm3d_shop_template.all) do
		pg = var_1_10005
		...
		if var_1_10006.shop_template[var_1_10005.shop_id[1]].group ~= 0 then
			...
			local var_60_0 = var_7.getRawData(var_1_10009).id
			...
			local var_60_2 = var_11.TimeMgr.GetInstance()

			var_1_10008(var_60_1, var_11.GetServerTime(var_60_2))
		end
	end
...
function var_0_1.CheckAllRoomInviteAll(arg_62_0)
	...
	for iter_62_0, iter_62_1 in var_1_10001(var_1_10003.dorm3d_rooms.all) do
		if iter_62_1 ~= 5 then
