...
function var_0_1.timeCall(arg_4_0)
	...
	var_4_0[var_1_10002.DayCall] = function(arg_5_0, arg_5_1)
		...
		if var_3.getMiniShop(var_5_2) and var_3:checkShopFlash() then
			...
			var_5_4(var_5_3, var_2_10007.MINI_GAME_SHOP_FLUSH)
		end
...
function var_0_1.setShopStreet(arg_6_0, arg_6_1)
	...
	Clone = var_1_10007
	var_6_3.shopStreet = var_1_10007(arg_6_0.shopStreet)
...
function var_0_1.addMeritorousShop(arg_10_0, arg_10_1)
	...
	var_10_1(var_10_0, var_10_2, var_1_10006(arg_10_1))
...
function var_0_1.GetNormalByID(arg_16_0, arg_16_1)
	...
	if not arg_16_0.normalList[arg_16_1] then
		...
		Goods = var_1_10005
		var_16_0 = var_16_0(var_16_1, var_1_10005.TYPE_GIFT_PACKAGE)
	end
...
function var_0_1.setFirstChargeList(arg_29_0, arg_29_1)
	...
	var_29_1(var_29_0, var_29_2, var_1_10006(arg_29_1))
...
function var_0_1.setChargedList(arg_31_0, arg_31_1)
	...
	var_31_1(var_31_0, var_31_2, var_1_10006(arg_31_1))
...
function var_0_1.chargeFailed(arg_33_0, arg_33_1, arg_33_2)
	if not arg_33_0.timers[arg_33_1] then
		...
		Timer = var_1_10004
		var_33_1[arg_33_1] = var_1_10004.New(function()
...
function var_0_1.addWaitTimer(arg_36_0)
	...
	arg_36_0.waitBiliTimer = var_1.New(function()
		...
		i18n = var_2_10004
		var_37_3.content = var_2_10004("charge_time_out")
...
function var_0_1.setGuildShop(arg_39_0, arg_39_1)
	...
	GuildShop = var_1_10007

	var_1_10002(var_1_10004(var_39_0, var_1_10007), "shop should instance of GuildShop")
...
function var_0_1.updateGuildShop(arg_41_0, arg_41_1, arg_41_2)
	...
	GuildShop = var_1_10008

	var_1_10003(var_1_10005(var_41_0, var_1_10008), "shop should instance of GuildShop")
...
function var_0_1.GetRecommendCommodities(arg_64_0)
	...
	local var_64_3 = arg_64_0.GetNormalGroupList(var_64_2)

	if not var_64_0 or not var_64_1 or not var_64_3 then
		return {}
	end
	...
	for iter_64_0, iter_64_1 in var_64_2(var_1_10007.recommend_shop.all) do
		pg = var_1_10010
		var_1_10010 = var_1_10010.recommend_shop[iter_64_1].time
		pg = var_1_10011

		local var_64_5 = var_1_10011.TimeMgr.GetInstance()

		if var_1_10011.inTime(var_64_5, var_1_10010) then
			RecommendCommodity = var_1_10011

			local var_64_6 = var_1_10011.New({
				id = iter_64_1,
				chargedList = var_64_0,
				normalList = var_64_1,
				normalGroupList = var_64_3
			})

			if var_1_10011.CanShow(var_64_6) then
				table = var_12

				var_12.insert(var_64_4, var_1_10011)
			end
		end
	end
	...
	var_5.sort(var_64_4, function(arg_65_0, arg_65_1)
...
function var_0_1.SpecialBannerBlockCheck(arg_68_0, arg_68_1)
	...
	local var_68_0, var_68_1 = var_1_10002(var_1_10004("levellimit_shopbanner"))
	local var_68_2
...
function var_0_1.GiftPackageRedDotTip(arg_69_0, arg_69_1, arg_69_2)
	...
	if arg_69_0:ShouldRefreshChargeList() then
		...
		var_4.insert(var_69_0, function(arg_70_0)
			...
			var_70_1(var_70_0, var_2_10004.GET_CHARGE_LIST, {
				callback = arg_70_0
			})
	...
	var_4(var_69_0, function()
		...
		local var_71_2 = var_71_0(var_2.GetAllShowGiftPackages(var_71_1, arg_69_2), function(arg_72_0)
			return arg_72_0:isTip()
		end)

		ipairs = var_2_10001

		for iter_71_0, iter_71_1 in var_2_10001(arg_69_1) do
...
function var_0_1.GetAllShowGiftPackages(arg_73_0, arg_73_1)
	...
	local var_73_2 = var_1_10003.getAllRefluxPackID()

	getProxy = var_4
	PlayerProxy = var_73_0

	local var_73_3 = var_4(var_73_0)
	local var_73_4 = var_4.getRawData(var_73_3)

	pg = var_1_10005

	local var_73_5 = var_1_10005.pay_data_display

	pairs = var_73_3

	for iter_73_0, iter_73_1 in var_73_3(var_73_5.all) do
		table = var_1_10011
		...
		if not var_1_10011.contains(var_73_2, iter_73_1) then
			...
			if arg_73_1 == nil or var_73_8 == arg_73_1 then
				...
				if var_73_6 ~= var_1_10014.ITEM_BOX then
					Goods = var_1_10014

					if var_73_6 == var_1_10014.PASS_ITEM then
						Goods = var_1_10014
						var_1_10014 = var_1_10014.Create
						...
						Goods = var_1_10017
						var_1_10014 = var_1_10014(var_73_9, var_1_10017.TYPE_CHARGE)
						var_1_10017 = arg_73_0

						if arg_73_0.filterLimitTypeGoods(var_1_10017, var_1_10014, var_73_4) then
							table = var_15

							var_15.insert(var_73_1, var_1_10014)
						end
					end
				end
			end
	...
	local var_73_10 = var_8.shop_template.get_id_list_by_genre

	ShopArgs = iter_73_0

	local var_73_11

	if not var_73_10[iter_73_0.GiftPackage] then
		var_73_11 = {}
	end

	for iter_73_2, iter_73_3 in var_6(var_73_11) do
		pg = var_1_10011

		local var_73_12 = var_1_10011.shop_template[iter_73_3].akashi_pick
		local var_73_13 = 0 < var_73_12

		if arg_73_1 == nil or var_73_13 == arg_73_1 then
			table = var_13

			if not var_13.contains(var_73_2, iter_73_3) then
				Goods = var_13

				local var_73_14 = var_13.Create
				local var_73_15 = {
					shop_id = iter_73_3
				}
				...
				local var_73_16 = var_73_14(var_73_15, var_16.TYPE_GIFT_PACKAGE)

				table = var_1_10014

				var_1_10014.insert(var_73_1, var_73_16)
			end
		end
	end
	...
	local var_73_17 = var_8.shop_template.get_id_list_by_genre

	ShopArgs = iter_73_2

	local var_73_18

	if not var_73_17[iter_73_2.GiftActPackage] then
		var_73_18 = {}
	end

	for iter_73_4, iter_73_5 in var_6(var_73_18) do
		pg = var_1_10011

		local var_73_19 = var_1_10011.shop_template[iter_73_5].akashi_pick
		local var_73_20 = 0 < var_73_19

		if arg_73_1 == nil or var_73_20 == arg_73_1 then
			table = var_13

			if not var_13.contains(var_73_2, iter_73_5) then
				Goods = var_13

				local var_73_21 = var_13.Create
				local var_73_22 = {
					shop_id = iter_73_5
				}
				...
				local var_73_23 = var_73_21(var_73_22, var_16.TYPE_GIFT_PACKAGE_ACT)

				table = var_1_10014

				var_1_10014.insert(var_73_1, var_73_23)
			end
		end
	end
	...
	for iter_73_6, iter_73_7 in var_8(var_73_1) do
		if iter_73_7:isChargeType() then
			...
			local var_73_26 = var_13.getBuyCount(arg_73_0.chargeList, iter_73_7.id)

			iter_73_7:updateBuyCount(var_73_26)

			if iter_73_7:canPurchase() and iter_73_7:inTime() then
				table = var_14

				var_14.insert(var_73_24, iter_73_7)
			end
		elseif not iter_73_7:isLevelLimit(var_73_4.level, true) then
			ChargeConst = var_13

			local var_73_27 = var_13.getBuyCount(arg_73_0.normalList, iter_73_7.id)

			iter_73_7:updateBuyCount(var_73_27)
			...
			local var_73_29 = false
			local var_73_30

			if 0 < var_73_28 then
				var_73_30 = iter_73_7:getConfig("group_limit")
				ChargeConst = var_17

				local var_73_31 = var_17.getGroupLimit(arg_73_0.normalGroupList, var_73_28)

				iter_73_7:updateGroupCount(var_73_31)

				var_73_29 = var_73_30 > 0 and var_73_30 <= var_73_31
			end

			pg = var_73_30

			local var_73_32 = var_73_30.TimeMgr.GetInstance()
			local var_73_33, var_73_34 = var_16.inTime(var_73_32, iter_73_7:getConfig("time"))

			if var_73_34 then
				table = var_73_32

				var_73_32.insert(var_73_25, iter_73_7)
			end

			if var_73_33 and iter_73_7:canPurchase() and not var_73_29 then
				table = var_18

				var_18.insert(var_73_24, iter_73_7)
			end
		end
	end

	return var_73_24, var_73_25
end
	...
	return var_1_10004(var_74_0, {
		[3] = function()
			...
			if var_0.getConfig(var_75_0, "limit_arg") == 0 then
				...
				for iter_75_0, iter_75_1 in var_3(var_5.getSameLimitGroupTecGoods(var_75_5)) do
		...
		[5] = function()
			...
			if var_0.getConfig(var_76_0, "limit_arg") == 0 then
				...
				for iter_76_0, iter_76_1 in var_0(var_2.getSameLimitGroupTecGoods(var_76_2)) do
