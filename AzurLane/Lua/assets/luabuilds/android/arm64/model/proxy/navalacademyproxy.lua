...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(22001, function(arg_2_0)
		...
		var_2.SetUpgradeTimeStamp(var_2_3, arg_2_0.gold_well_lv_up_time)

		local var_2_4 = arg_1_0

		var_2_4._goldVO = var_2
		ClassResourceField = var_2_4

		local var_2_5 = var_2_4.New()

		var_3.SetLevel(var_2_5, arg_2_0.class_lv)
		var_3:SetUpgradeTimeStamp(arg_2_0.class_lv_up_time)

		arg_1_0._classVO = var_3

		local var_2_6 = arg_1_0.course

		var_4.update(var_2_6, arg_2_0.class)

		local var_2_7 = {}

		ipairs = var_2_3

		for iter_2_0, iter_2_1 in var_2_3(arg_2_0.skill_class_list) do
			Student = var_2_10010
			var_2_7[var_2_10010.New(iter_2_1).id] = var_2_10010
		end
		...
		var_2_8.skillClassNum = var_2_9

		local var_2_10 = arg_1_0

		var_5.setStudents(var_2_10, var_2_7)

		pg = var_5

		local var_2_11 = var_5.ShipFlagMgr.GetInstance()

		var_5.UpdateFlagShips(var_2_11, "inClass")

		local var_2_12 = arg_1_0

		var_5.CheckResFields(var_2_12)
		...
		var_2_13.dailyFinsihCnt = var_2_14
...
function var_0_1.timeCall(arg_4_0)
	...
	var_4_0[var_1_10002.DayCall] = function(arg_5_0)
		...
		var_5_2(var_5_1, var_4.CLASS_FORCE_UPDATE)
...
function var_0_1.GetRecentShips(arg_6_0)
	...
	if 0 < var_6_0 then
		for iter_6_0 = #arg_6_0.recentShips, 1, -1 do
			...
			if var_1_10006.RawGetShipById(var_1_10008, var_6_1) then
				_ = var_1_10007

				if var_1_10007.all(var_1_10006:getSkillList(), function(arg_7_0)
	...
	local var_6_4 = var_2.GetString("NavTacticsRecentShipId" .. var_6_3)

	string = var_6_2

	local var_6_5 = var_6_2.split(var_6_4, "#")
	...
	for iter_6_1, iter_6_2 in var_4(var_6_5) do
		...
		if 0 < var_1_10009 then
			...
			if var_10.RawGetShipById(var_1_10012, var_1_10009) then
				table = var_11

				if not var_11.contains(arg_6_0.recentShips, var_1_10009) then
					_ = var_11

					if var_11.any(var_10:getSkillList(), function(arg_8_0)
						ShipSkill = var_2_10001
						...
						var_11.insert(arg_6_0.recentShips, var_1_10009)
					end
				end
			end
		end
...
function var_0_1.SaveRecentShip(arg_9_0, arg_9_1)
	...
	if not var_1_10002.contains(arg_9_0.recentShips, arg_9_1) then
		...
		local var_9_1 = var_3(var_5)
		local var_9_2 = var_3.getRawData(var_9_1).id

		PlayerPrefs = var_4

		var_4.SetString("NavTacticsRecentShipId" .. var_9_2, var_9_0)
...
function var_0_1.addStudent(arg_20_0, arg_20_1)
	...
	var_20_3(var_20_2, var_20_4, var_1_10006(arg_20_1))
...
function var_0_1.StartUpGradeSuccess(arg_30_0, arg_30_1)
	...
	local var_30_3 = var_1_10007.TimeMgr.GetInstance()

	var_30_2(var_30_1, var_7.GetServerTime(var_30_3) + var_30_0)
...
function var_0_1.AddResFieldListener(arg_31_0, arg_31_1)
	...
	if var_31_0 - var_3.GetServerTime(var_31_1) > 0 then
		...
		local var_31_3 = arg_31_1.GetUpgradeType(var_31_2)

		if arg_31_0.timers[var_31_3] then
			local var_31_4 = arg_31_0.timers[var_31_3]

			var_4.Stop(var_31_4)

			arg_31_0.timers[var_31_3] = nil
		end

		local var_31_5 = arg_31_0.timers

		Timer = var_31_2
		var_31_5[var_31_3] = var_31_2.New(function()
			local var_32_0 = arg_31_0

			var_0.UpgradeFinish(var_32_0)

			local var_32_1 = arg_31_0.timers[var_31_3]
		...
		local var_31_6 = arg_31_0.timers[var_31_3]

		var_4.Start(var_31_6)
	end
...
function var_0_1.UpgradeFinish(arg_33_0)
	...
	if var_1.GetDuration(var_33_0) then
		...
		if var_1.GetDuration(var_33_1) <= 0 then
			...
			var_33_7(var_33_6, var_5.GetLevel(var_33_8) + 1)
	...
	if var_1.GetDuration(var_33_14) then
		...
		if var_1.GetDuration(var_33_15) <= 0 then
			...
			var_33_21(var_33_20, var_5.GetLevel(var_33_22) + 1)
	...
	if var_1.GetDuration(var_33_28) then
		...
		if var_1.GetDuration(var_33_29) <= 0 then
			...
			var_33_43(var_33_42, var_7.GetLevel(var_33_44) + 1)
...
function var_0_1.AddCourseProficiency(arg_35_0, arg_35_1)
	...
	local var_35_3 = var_35_0:GetProficiency()

	math = var_35_1

	local var_35_4 = var_35_3 + var_35_1.floor(arg_35_1 * var_35_2 * 0.01)

	math = var_6

	local var_35_5 = var_6.min(var_35_4, var_3:GetMaxProficiency())

	var_35_0:SetProficiency(var_35_5)
...
function var_0_1.fillStudens(arg_36_0, arg_36_1)
	...
	if arg_36_0._timeStamp then
		...
		if not arg_36_0._studentsFiller then
			...
			local var_36_4 = var_5(var_7)
			local var_36_5 = var_5.getGroups(var_36_4)

			getProxy = var_7
			BayProxy = var_1_10009

			local var_36_6 = var_7(var_1_10009)

			getProxy = var_36_4
			ShipSkinProxy = var_1_10010
			var_1_10011 = var_36_4(var_1_10010)

			local var_36_7 = var_8.getSkinList(var_1_10011)
			local var_36_8 = {}
			...
			while var_36_3 > 0 and 0 < var_1_10011 do
				...
				local var_36_9 = var_36_5[var_36_8[var_12.random(#var_36_8)]]
				local var_36_10 = 10000000000 + (var_13 * 10 + 1)
				...
				for iter_36_4, iter_36_5 in var_1_10021(var_1_10017) do
					local var_36_14 = iter_36_5.skin_type

					ShipSkin = var_1_10027

					if var_36_14 ~= var_1_10027.SKIN_TYPE_DEFAULT then
						table = var_1_10027

						if not var_1_10027.contains(var_36_7, iter_36_5.id) then
							ShipSkin = var_1_10027

							if var_36_14 ~= var_1_10027.SKIN_TYPE_REMAKE or not var_36_9.trans then
								ShipSkin = var_1_10027

								if var_36_14 == var_1_10027.SKIN_TYPE_PROPOSE and var_36_9.married == 1 then
									var_36_13[#var_36_13 + 1] = iter_36_5.id
								end

								math = var_1_10027
								var_36_12 = var_36_13[var_1_10027.random(#var_36_13)]
							end
						end
					end
				end
		...
		for iter_36_6, iter_36_7 in var_5(arg_36_0._studentsFiller) do
			local var_36_15 = #arg_36_1 + 1

			Ship = var_1_10011
			arg_36_1[var_36_15] = var_1_10011.New(iter_36_7)
		end
...
function var_0_1.IsShowTip(arg_37_0)
	...
	if var_1_10001(var_1_10003) then
		...
		if var_1.getData(var_1_10004) then
			var_1_10004 = arg_37_0

			if arg_37_0.isResourceFieldUpgradeConditionSatisfy(var_1_10004) then
				return true
			end
		end
	end
	...
	if var_1_10002(var_1_10004) and var_2:getShopStreet() and var_1_10003:isUpdateGoods() then
		return true
	end
	...
	for iter_37_0, iter_37_1 in var_1_10004(arg_37_0.students) do
		var_1_10011 = iter_37_1

		if iter_37_1.getFinishTime(var_1_10011) <= var_37_1 then
			return true
		end
	end
	...
	local var_37_4 = var_6(iter_37_1)

	_ = var_37_2

	local var_37_5 = var_37_2.any

	getProxy = var_1_10009
	ActivityProxy = var_1_10011

	local var_37_6 = var_1_10009(var_1_10011)
	local var_37_7 = var_9.getActivitiesByType

	ActivityConst = var_1_10012

	if var_37_5(var_37_7(var_37_6, var_1_10012.ACTIVITY_TYPE_TASK_LIST), function(arg_38_0)
...
function var_0_1.getDailyFinishCnt(arg_39_0)
	...
	local var_39_1 = var_1_10003.GetBuffsByActivityType

	ActivityConst = var_1_10005

	if var_39_0(var_39_1(var_1_10005.ACTIVITY_TYPE_BUFF), function(arg_40_0)
		...
		if not var_1_10002(var_1:getConfig("benefit_effect")) then
			var_39_2 = 0
		end
