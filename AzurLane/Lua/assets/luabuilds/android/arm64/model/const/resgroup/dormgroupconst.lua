...
function var_0_0.CalcDormListSize(arg_3_0)
	...
	local var_3_1 = var_1_10002.CalcSizeWithFileArr(var_0_0.DormGroupName, var_3_0)
...
function var_0_0.DormDownload(arg_5_0)
	...
	if var_0_0.IsDormNeedCheck() then
		...
		IsUsingWifi = var_1_10004

		local var_5_4 = var_1_10004()
			...
			if var_5_5 then
				...
				if 0 < var_5_6 then
					...
					var_9.insert(var_5_0, function(arg_6_0)
						...
						MSGBOX_TYPE_FILE_DOWNLOAD = var_2_10005
						var_6_2.type = var_2_10005
						string = var_2_10005

						local var_6_3 = var_2_10005.format

						i18n = var_2_10007
						var_6_2.content = var_6_3(var_2_10007("file_down_msgbox", var_5_7))
...
function var_0_0.ExtraDownload(arg_9_0)
	...
	if #var_2.fileNameList > 0 then
		...
		local function var_9_3(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5)
			...
			local var_10_0 = var_2_10006(var_2_10008(arg_10_3))

			tonumber = var_2_10007
			tostring = var_2_10009

			local var_10_1 = var_2_10007(var_2_10009(arg_10_4))
		...
		local function var_9_5(arg_12_0, arg_12_1)
			...
			local var_12_2 = var_2_10005.APARTMENT_TRACK

			Dorm3dTrackCommand = var_2_10006

			var_12_1(var_12_0, var_12_2, var_2_10006.BuildDataDownload(var_0_0.DormDownloadLock.roomId, arg_12_0 and 1 or 2))
			...
			if arg_12_0 then
				...
				local var_12_5 = var_12_0.MsgboxMgr.GetInstance()
				...
				i18n = var_8
				var_12_7.content = var_8("file_down_mgr_error", "", "")
...
function var_0_0.GetDownloadResourceDic()
	if not var_0_2 then
		...
		for iter_17_0, iter_17_1 in var_0(var_1_10002.dorm3d_rooms.all) do
			pg = var_1_10005
	...
	ipairs = var_1_10001
	DormGroupConst = iter_17_0

	for iter_17_2, iter_17_3 in var_1_10001(iter_17_0.GetDownloadList()) do
		...
		for iter_17_4, iter_17_5 in var_1_10007(var_0_1) do
			...
			if var_17_3 then
				...
				local var_17_5 = var_17_4(var_1_10016.sub(iter_17_3, var_17_3 + 1), "/")[1]
...
function var_0_0.GetFilePathList(arg_18_0)
	...
	var_3(var_18_4, var_6(var_18_0))

	local var_18_5 = {}

	System = var_1_10004

	local var_18_6 = var_1_10004.IO.Directory

	ReflectionHelp = var_18_4

	local var_18_7 = var_18_4.RefGetField

	typeof = var_1_10007

	local var_18_8 = var_18_7(var_1_10007("System.IO.SearchOption"), "AllDirectories", nil)
	...
	var_6(var_18_9, var_9(var_18_6.Exists(var_18_0)))
	...
	if var_18_6.Exists(var_18_0) then
		...
		for iter_18_0, iter_18_1 in var_7(var_18_11) do
	...
	var_18_11(var_18_13, var_9(var_18_5[1]))
	...
	var_18_11(var_18_14, var_9(var_18_5[#var_18_5]))
...
function var_0_0.DelDir(arg_19_0)
	...
	if 0 < var_19_0 then
		...
		local var_19_2 = var_19_1(var_1_10005(var_1_10007.String), var_19_0)
