...
function var_0_0.CalcPaintingListSize(arg_3_0)
	...
	local var_3_1 = var_1_10002.CalcSizeWithFileArr(var_0_0.PaintingGroupName, var_3_0)
...
function var_0_0.GetPaintingNameListInLogin()
	...
	if var_1_10002(var_1_10004) then
		var_1_10005 = var_2
		var_1_10003 = var_2.GetOwnAndShareSkins(var_1_10005)
		pairs = var_1_10004
	...
	if var_1_10003(var_1_10005) then
		var_1_10006 = var_3
		var_1_10004 = var_3.getGroups(var_1_10006)
		pairs = var_1_10005
...
function var_0_0.GetPaintingNameListForTec()
	...
	for iter_11_0, iter_11_1 in var_1_10001(var_1_10003.ship_data_blueprint.all) do
	...
	for iter_12_0 = 1, #arg_12_0 do
		...
		if var_12_1 == var_1_10008 then
			...
			if var_12_1 == var_1_10008 then
				...
				var_1_10008 = var_1_10008.getShipById(var_1_10010, var_6.id)
...
function var_0_0.GetPaintingNameListByShipVO(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10004(var_13_2) do
		var_0_0.AddPaintingNameBySkinID(var_13_0, iter_13_1.id)
	end

	local var_13_3 = var_2:GetShareSkinsForShip(arg_13_0)

	ipairs = var_5

	for iter_13_2, iter_13_3 in var_5(var_13_3) do
...
function var_0_0.GetPaintingNameListForMallAct(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1_10002(var_1_10004.activity_mall_custom_order.all) do
		local var_14_1 = var_0_0.AddPaintingNameBySkinID
		local var_14_2 = var_14_0

		pg = var_1_10010

		var_14_1(var_14_2, var_1_10010.activity_mall_custom_order[iter_14_1].char)
	end
			...
			if not var_15_4 and var_15_5 then
				...
				if 0 < var_15_6 then
					...
					var_9.insert(var_15_0, function(arg_16_0)
						...
						local var_16_3 = var_2_10005.format

						i18n = var_2_10007
						var_16_2.content = var_16_3(var_2_10007("file_down_msgbox", var_15_7))
