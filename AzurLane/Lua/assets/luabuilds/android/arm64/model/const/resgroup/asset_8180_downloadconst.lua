...
function var_0_1.VerifyFile(arg_2_0)
	...
	return var_1_10002.VerifyFile(var_2_0, arg_2_0)
end
...
function var_0_1.IsNeedCheck()
	...
	local var_3_3 = var_1_10002.IsAllGroupVerLastest()

	GroupHelper = var_3_1

	local var_3_4 = var_3_1.IsAnyGroupWaitToUpdate()
	...
	if var_0_1.IsNeedCheck() then
		...
		if 0 < var_6_7 then
			...
			if var_6_5 then
				...
				var_10.insert(var_6_0, function(arg_7_0)
					pg = var_2_10001
					...
					local var_7_3 = var_2_10005.format

					i18n = var_2_10007
					var_7_2.content = var_7_3(var_2_10007("file_down_msgbox", var_6_9))
