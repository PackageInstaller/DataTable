...
YSNormalTool = var_0_10002

local var_0_1 = var_0_10002.BrightnessTool
...
function var_1.SetDelayTask(arg_4_0)
	...
	arg_4_0.task = var_1.New(function()
		...
		var_5_0(var_2_10002.min(var_0.DarkModeBrightness, arg_4_0.originalBrightnessValue))
...
function var_1.EnterManualMode(arg_7_0)
	...
	var_7_0(var_1_10004.min(var_0.DarkModeBrightness, var_1))
...
function var_1.RequestPremission(arg_11_0, arg_11_1)
	...
	if arg_11_1 then
		...
		local var_11_0 = var_2.New(function()
			...
			var_12_0(var_2.IsPermissionGranted(var_12_1))
...
function var_1.SetScreenNeverSleep(arg_13_0, arg_13_1)
	...
	if var_1_10002(arg_13_1) then
		if arg_13_0.sleepTimeOutCounter == 0 then
			Screen = var_2
			SleepTimeout = var_1_10003
			var_2.sleepTimeout = var_1_10003.NeverSleep
		end
		...
		if arg_13_0.sleepTimeOutCounter == 0 then
			Screen = var_2
			SleepTimeout = var_1_10003
			var_2.sleepTimeout = var_1_10003.SystemSetting
		end
	end
