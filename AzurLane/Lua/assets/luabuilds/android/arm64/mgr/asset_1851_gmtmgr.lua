...
function var_0_1.initUI(arg_3_0, arg_3_1)
	if arg_3_0._go == nil then
		...
		var_2.GetUI(var_3_0, "GMTUI", true, function(arg_4_0)
			...
			findTF = var_2_10002
			var_4_1._textTf = var_2_10002(arg_3_0._go, "ad/text")
			GameObject = var_4_1
			...
			var_4_4._animator = var_3(var_4_5, var_6(var_2_10008))
...
function var_0_1.showTip(arg_8_0)
	...
	local var_8_3 = arg_8_0._subTime

	if arg_8_0._repeatTime < var_8_3 then
		local var_8_4 = arg_8_0._animator

		var_2.SetTrigger(var_8_4, "once")
	elseif not arg_8_0._triggerStop then
		arg_8_0._triggerStop = true

		local var_8_5 = arg_8_0._animator

		var_2.SetTrigger(var_8_5, "repeat")
	end

	local var_8_6 = arg_8_0:getTimeTip()

	setText = var_3

	var_3(arg_8_0._textTf, var_8_6)

	return
end

function var_0_1.getTimeTip(arg_9_0)
	local var_9_0 = arg_9_0._subTime
	...
	if 0 < var_9_0 then
		...
		if 0 < var_9_0 then
			...
			i18n = var_1_10006
			var_9_3 = var_9_4 .. var_1_10006("word_hour")
		elseif 0 < var_9_1 then
			tostring = var_9_4
			var_9_4 = var_9_4(var_9_1)
			i18n = var_1_10006
			var_9_3 = var_9_4 .. var_1_10006("word_minute")
		else
			tostring = var_9_4
			var_9_4 = var_9_4(var_9_2)
			i18n = var_1_10006
			var_9_3 = var_9_4 .. var_1_10006("word_second")
		end
