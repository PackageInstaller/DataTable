...
function var_0_1.CheckNewVersion(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_1 = arg_8_2.GetGuideIndex(var_8_0, true)
	local var_8_2 = arg_8_2:GetGuideIndex(false)

	print = var_8_0

	var_8_0("guild index:", var_8_1, var_8_2)
...
function var_0_1.doGuideStep(arg_16_0, arg_16_1, arg_16_2)
	if arg_16_0.stepConfig.condition then
		...
		local var_16_4 = arg_16_0.stepConfig.segment
		local var_16_5 = arg_16_0
		local var_16_6 = var_16_4[arg_16_0.getSegmentIndex(var_16_5)][1]
		local var_16_7 = var_3[2]

		assert = var_16_5

		var_16_5(var_16_7, "protocol can not be nil")

		local var_16_8 = {
			function(arg_18_0)
				local var_18_0 = arg_16_0.guideMgr

				var_1.Play(var_18_0, var_16_6, arg_16_1.code, arg_18_0, function()
					...
					var_2.Record(var_20_0, arg_16_0.currIndex, arg_20_0, arg_20_1, var_16_6)
			...
			function(arg_21_0)
				...
				if var_2_10001.any(arg_16_0.protocols, function(arg_22_0)
					return arg_22_0.protocol == var_16_7
				end) then
					arg_21_0()
...
function var_0_1.Record(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
	...
	local var_26_2 = var_26_0.GameTrackerMgr.GetInstance()
	local var_26_3 = var_7.Record

	GameTrackerBuilder = var_1_10010

	var_26_3(var_26_2, var_1_10010.BuildGuide(arg_26_0:IsNewVersion(), arg_26_1, arg_26_2, var_26_1, arg_26_4))
...
function var_0_1.checkCondition(arg_28_0, arg_28_1)
	...
	if var_28_0.condition.arg[1] == var_0_6 then
		...
		var_1_10010 = arg_28_0

		local var_28_5

		var_28_5, var_1_10009 = arg_28_0.checkPtotocol(var_1_10010, var_28_4, arg_28_1)
		var_28_1 = var_1_10009
		var_28_2 = var_28_5
	elseif var_6[1] == var_0_7 then
		getProxy = var_28_4
		PlayerProxy = var_1_10009
		var_1_10009 = var_28_4(var_1_10009)
		var_28_4 = var_28_4.getRawData(var_1_10009)
		getProxy = var_8
		BayProxy = var_1_10010

		local var_28_6 = var_8(var_1_10010)
		local var_28_7 = var_8.getShipById(var_28_6, var_28_4.character)
		local var_28_8

		var_1_10009, var_28_8 = var_28_0.condition.func(var_28_7)
		var_28_1 = var_28_8
		var_28_2 = var_1_10009
		var_1_10009 = arg_28_0.stepConfig
		var_1_10009.condition = nil
	elseif var_6[1] == var_0_8 then
		var_28_4 = var_28_0.condition.func
		NewServerCarnivalScene = var_1_10009

		local var_28_9

		var_28_4, var_28_9 = var_28_4(var_1_10009.isShow())
		var_28_1 = var_28_9
		var_28_2 = var_28_4
...
function var_0_1.updateIndex(arg_32_0, arg_32_1, arg_32_2)
	...
	local var_32_1 = var_1_10004.m02
	local var_32_2 = var_4.sendNotification

	GAME = var_1_10007

	var_32_2(var_32_1, var_1_10007.UPDATE_GUIDE_INDEX, {
...
function var_0_1.canPlay(arg_36_0, arg_36_1)
	...
	if not var_3.contains(var_36_0.view, arg_36_1.view) then
		log = var_3

		var_3("view is erro", arg_36_0.currIndex, arg_36_1.view, var_36_0.view[1], var_36_0.view[2])
