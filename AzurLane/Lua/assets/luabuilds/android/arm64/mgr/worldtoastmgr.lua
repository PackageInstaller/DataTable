...
function var_0_1.Init(arg_1_0, arg_1_1)
	...
	var_1_10002("ui", "WorldTaskFloatUI", function(arg_2_0)
		...
		var_2_2(var_2_1, var_4.UIMgr.GetInstance().OverlayToast, false)
...
function var_0_1.StartToast(arg_4_0)
	...
	var_1_10002(var_4.Find(var_4_1, "accept_info"), not var_4_0.isSubmitDone)

	setActive = var_1_10002

	local var_4_2 = arg_4_0._tf

	var_1_10002(var_4.Find(var_4_2, "submit_info"), var_4_0.isSubmitDone)
	...
	var_3(var_4_4, var_4_5, var_7.Find(var_4_6, "type_icon"), true)

	setText = var_3

	local var_4_7 = arg_4_0._tf
	local var_4_8 = var_5.Find(var_4_7, "desc")

	setColorStr = var_4_5
	shortenString = var_8

	local var_4_9 = var_8(var_4_3.config.name, 12)
	...
	if var_4_0.isSubmitDone then
		...
		var_3(var_4_8, var_4_5(var_4_9, var_9))

		local var_4_10 = {}

		table = var_4

		var_4.insert(var_4_10, function(arg_5_0)
			...
			System = var_5
			var_5_0.twId = var_5_2(var_5_1, var_5.Action(arg_5_0))
		...
		var_4.insert(var_4_10, function(arg_6_0)
			...
			System = var_5
			var_6_0.twId = var_6_3(var_6_2, var_5.Action(arg_6_0))
