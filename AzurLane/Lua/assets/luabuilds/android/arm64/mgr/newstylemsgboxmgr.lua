...
function var_0_1.CommonSetting(arg_12_0, arg_12_1)
	...
	local var_12_0 = arg_12_1.title or i18n("words_information")

	setText(arg_12_0._tf:Find("window/top/title"), var_12_0)
	...
	local var_12_1 = arg_12_1.btnList or {
		{
	...
	local var_12_2 = arg_12_0._tf:Find("window/bottom/button_container")

	eachChild(var_12_2, function(arg_19_0)
	...
	for iter_12_0, iter_12_1 in ipairs(var_12_1) do
		local var_12_3 = var_12_2:Find(iter_12_1.type)

		if var_12_3:GetSiblingIndex() < var_12_2.childCount - iter_12_0 + 1 then
			var_12_3:SetAsLastSibling()
			setActive(var_12_3, true)
		else
			var_12_3 = cloneTplTo(var_12_3, var_12_2, var_12_3.name)
		end

		setText(var_12_3:Find("Text"), iter_12_1.name)

		local var_12_6 = iter_12_1.sound or SFX_CONFIRM
...
function var_0_1.DisplaySetting(arg_22_0, arg_22_1, arg_22_2)
	switch(arg_22_1, {
		...
		[var_0_1.TYPE_COMMON_HELP] = function(arg_27_0)
			...
			var_27_1:make(function(arg_28_0, arg_28_1, arg_28_2)
				...
				if arg_28_0 == UIItemList.EventUpdate then
					...
					local var_28_0 = arg_27_0.helps[arg_28_1].info and SwitchSpecialChar(arg_27_0.helps[arg_28_1].info, true) or ""

					setTextInNewStyleBox(arg_28_2:Find("Text"), HXSet.hxLan(var_28_0))
				end
		...
		[var_0_1.TYPE_COMMON_DROP] = function(arg_29_0)
			...
			if var_29_7 then
				...
				onButton(arg_22_0, var_29_8:Find("play"), function()
					...
					local var_31_2 = var_0_0.NewStyleMsgboxMgr.TYPE_SHIP_PREVIEW
					local var_31_3 = {
						shipVO = Ship.New({
							id = var_0.ship_config_id,
							configId = var_0.ship_config_id,
							skin_id = var_0.ship_skin_id
						})
					}

					var_31_3.weaponIds = var_0.ship_skin_id == 0 and Clone(var_0.weapon_ids) or {}

					if var_0.ship_skin_id == 0 then
						var_31_3.equipSkinId = var_29_0.id or 0
			...
			local var_29_9 = arg_29_0.drop.type == DROP_TYPE_COMBAT_UI_STYLE
			local var_29_10 = var_29_1:Find("extra_info/combat_skin")

			setActive(var_29_10, arg_29_0.drop.type == DROP_TYPE_COMBAT_UI_STYLE)
			setActive(var_29_1:Find("left/placeholder"), var_29_9)

			if var_29_9 then
				local var_29_11 = var_0_0.item_data_battleui[arg_29_0.drop.id].rare_display
				local var_29_12 = UIItemList.New(var_29_1:Find("extra_info/combat_skin/elementList"), var_29_1:Find("extra_info/combat_skin/elementList/main"))

				var_29_12:make(function(arg_32_0, arg_32_1, arg_32_2)
					if arg_32_0 == UIItemList.EventUpdate then
						GetImageSpriteFromAtlasAsync("ui/combatskinrare", CombatSkinConst.TYPE_ICON_NAME[var_29_11[arg_32_1 + 1]], arg_32_2:Find("icon"), true)
						setScrollText(arg_32_2:Find("TextMask/Text"), i18n("battleui_display" .. var_29_11[arg_32_1 + 1]))
					end

					return
				end)
				var_29_12:align(#var_0_0.item_data_battleui[arg_29_0.drop.id].rare_display)
				onButton(arg_22_0, var_29_10:Find("play"), function()
		...
		[var_0_1.TYPE_COMMON_ITEMS] = function(arg_35_0)
			...
			local var_35_1 = arg_35_0.content or ""

			setTextInNewStyleBox(var_35_0:Find("info/Text"), var_35_1)
			...
			UIItemList.StaticAlign(var_35_3, var_35_3:Find("item"), #arg_35_0.items, function(arg_36_0, arg_36_1, arg_36_2)
				...
				if arg_36_0 == UIItemList.EventUpdate then
					local var_36_0 = var_0[arg_36_1]

					updateDrop(arg_36_2:Find("IconTpl"), var_0[arg_36_1], {
						anonymous = var_0[arg_36_1].anonymous,
						hideName = var_0[arg_36_1].hideName
					})
					...
					if arg_35_0.showOwn then
						setText(arg_36_2:Find("own/Text"), i18n("equip_skin_detail_count") .. var_0[arg_36_1]:getOwnedCount())
					end
		...
		[var_0_1.TYPE_COMMON_SHOPPING] = function(arg_43_0)
			...
			arg_22_0:InitRichText((var_43_0:Find("info/desc/Text")))

			local var_43_1 = arg_22_0._tf:Find("window/bottom/button_container/btn_shopping/price/Text")
			local var_43_2 = arg_22_0._tf:Find("window/bottom/count")
			local var_43_3 = PageUtil.New(var_43_2:Find("reduce"), var_43_2:Find("increase"), var_43_2:Find("max"), var_43_2:Find("Text"))
			local var_43_4 = arg_43_0.price
			local var_43_5 = arg_43_0.numUpdate
			local var_43_6 = arg_43_0.addNum or 1
			local var_43_7 = arg_43_0.maxNum or -1
			local var_43_8 = arg_43_0.defaultNum or 1

			var_43_3:setNumUpdate(function(arg_44_0)
				if var_43_5 ~= nil then
					var_43_5(var_0, arg_44_0)
				end

				setText(var_43_1, "x" .. arg_44_0 * var_43_4)

				return
			end)
			var_43_3:setAddNum(var_43_6)
			var_43_3:setMaxNum(var_43_7)
			var_43_3:setDefaultNum(var_43_8)
		...
		[var_0_1.TYPE_LOVE_LETTER_LEVEL_REWARD] = function(arg_45_0)
			...
			local var_45_2 = var_45_0:GetAllLevelRewardMarkDic()
			local var_45_3 = arg_22_0._tf:Find("window/middle/view/content")

			UIItemList.StaticAlign(var_45_3, var_45_3:Find("tpl"), math.max(#underscore.first(var_0_0.lover_reward.all, var_45_0:GetAllLevelAwardDisplayIndex()), 3), function(arg_46_0, arg_46_1, arg_46_2)
				arg_46_1 = arg_46_1 + 1

				if arg_46_0 == UIItemList.EventUpdate then
					local var_46_0 = var_0[arg_46_1]

					setActive(arg_46_2:Find("on"), var_0[arg_46_1])
					...
					setActive(arg_46_2:Find("active_bg"), not var_45_2[var_46_0] and var_45_1 >= var_46_1.total_level)
					setActive(arg_46_2:Find("lock"), var_45_1 < var_46_1.total_level)
					setText(arg_46_2:Find("mark/Text"), var_46_1.total_level)
					UIItemList.StaticAlign(arg_46_2:Find("awards"), arg_46_2:Find("awards/tpl"), #underscore.map(var_46_1.show_reward, function(arg_47_0)
						return Drop.Create(arg_47_0)
					end), function(arg_48_0, arg_48_1, arg_48_2)
						arg_48_1 = arg_48_1 + 1

						if arg_46_0 == UIItemList.EventUpdate then
							updateDrop(arg_48_2:Find("mask/IconTpl"), var_0[arg_48_1])
							onButton(arg_22_0, arg_48_2, function()
								arg_22_0:emit(BaseUI.ON_DROP, var_0)

								return
							end, SFX_PANEL)
							setActive(arg_48_2:Find("got"), var_45_2[var_46_0])
						end
			...
			local var_45_4 = var_45_0:GetAllLevelNextAwardIndex()

			if var_45_4 then
				scrollToIndex(var_45_3, var_45_4)
			else
				scrollToBottom(var_45_3)
			end
...
function var_0_1.InitRichText(arg_50_0, arg_50_1)
	local var_50_0 = arg_50_1:GetComponent("RichText")

	for iter_50_0, iter_50_1 in pairs(arg_50_0.richTextSprites) do
...
function var_0_1.emit(arg_51_0, arg_51_1, ...)
	arg_51_0.analogyMediator = arg_51_0.analogyMediator or {
	...
	return ContextMediator.CommonBindDic[arg_51_1](arg_51_0.analogyMediator, arg_51_1, ...)
end

function var_0_1.closeView(arg_54_0)
	arg_54_0:hide()
