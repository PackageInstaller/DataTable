...
function var_0_0.ShouldReplacePlayer(arg_7_0)
	...
	return var_7_0(var_7_1, var_1_10004.PLAYER) > 0
end
...
function var_0_0.ShouldReplaceTb(arg_8_0)
	...
	return var_8_0(var_8_1, var_1_10004.TB) > 0
end
...
function var_0_0.ShouldReplaceDorm(arg_9_0)
	...
	return var_9_0(var_9_1, var_1_10004.DORM) > 0
end
...
function var_0_0.ReplacePlayerName(arg_10_0, arg_10_1)
	...
	if var_1_10002(var_1_10004) then
		...
		if not var_2.getRawData(var_1_10004) then
			return arg_10_1
		end
		...
		return (var_1_10003.gsub(arg_10_1, "{playername}", var_10_2))
	end
end
...
function var_0_0.ReplaceTbName(arg_11_0, arg_11_1)
	...
	if var_2.IsReView(var_11_0) then
		...
		return var_11_1(var_11_0, var_11_2, var_1_10006("child_story_name"))
	end
	...
	if var_11_1(var_11_0) then
		...
		local var_11_3 = var_2(var_11_0)
		local var_11_4

		if not var_2.GetCurChar(var_11_3) then
			getProxy = var_11_4
			EducateProxy = var_11_3
			var_11_3 = var_11_4(var_11_3)

			local var_11_5

			var_11_4, var_11_5 = var_11_4.GetStoryInfo(var_11_3)
			string = var_11_3
			arg_11_1 = var_11_3.gsub(arg_11_1, "{tb}", var_11_5)
		else
			getProxy = var_11_4
			NewEducateProxy = var_11_3

			local var_11_6 = var_11_4(var_11_3)
			local var_11_7, var_11_8 = var_2.GetStoryInfo(var_11_6)

			string = var_11_6
			arg_11_1 = var_11_6.gsub(arg_11_1, "{tb}", var_11_8)
		end
...
function var_0_0.ReplaceDormName(arg_12_0, arg_12_1)
	...
	local var_12_0 = var_2(var_1_10004)
	local var_12_1

	if not var_2.getApartment(var_12_0, arg_12_0.actorName) or not var_2:GetCallName() then
		var_12_1 = arg_12_0.actorName
	end

	string = var_12_0

	return (var_12_0.gsub(arg_12_1, "{dorm3d}", var_12_1))
end
...
function var_0_0.GetPathByString(arg_31_0, arg_31_1, arg_31_2)
	...
	local var_31_3 = var_1_10005(-var_31_2.x * 0.5, var_31_2.y * 0.5, 0)

	Vector3 = var_31_1

	local var_31_4 = var_31_1(var_31_2.x * 0.5, var_31_2.y * 0.5, 0)
...
function var_0_0.GenMoveNode(arg_32_0, arg_32_1)
	...
	if var_1_10003(arg_32_1.path) == "table" then
		...
		for iter_32_0, iter_32_1 in var_3(arg_32_1.path) do
			...
			var_1_10008(var_32_1, var_1_10011(iter_32_1[1], iter_32_1[2], 0))
		end
	else
		type = var_3
...
function var_0_0.GetMovableNode(arg_33_0)
	...
	for iter_33_0, iter_33_1 in var_1_10002(var_33_1) do
		local var_33_2 = arg_33_0:GenMoveNode(iter_33_1)

		table = var_1_10008

		var_1_10008.insert(var_33_0, var_33_2)
	end
...
function var_0_0.IsGlobalFlagHit(arg_37_0)
	...
	for iter_37_0, iter_37_1 in var_1_10005(var_37_3) do
...
function var_0_0.IsDialogueMode(arg_46_0)
	local var_46_0 = arg_46_0:GetMode()

	Story = var_1_10002

	return var_46_0 == var_1_10002.MODE_DIALOGUE
end
...
function var_0_0.GetResList(arg_75_0)
	...
	if arg_75_0.GetBgName(var_75_1) then
		...
		var_1_10003.insert(var_75_0, var_2)
	end

	if arg_75_0.GetSubBg and arg_75_0:GetSubBg() then
		table = var_75_1

		var_75_1.insert(var_75_0, var_3)
	end

	_ = var_3

	local var_75_2 = var_3.map(var_75_0, function(arg_76_0)
		return "bg/" .. arg_76_0
	end)
	local var_75_3 = {}
	local var_75_4, var_75_5, var_75_6 = arg_75_0:GetBgmData()

	if var_75_4 then
		table = var_1_10008

		var_1_10008.insert(var_75_3, var_75_4)
	end
	...
	var_1_10009.each(var_75_3, function(arg_77_0)
		table = var_2_10001

		var_2_10001.insert(var_75_7, "cue/" .. arg_77_0 .. ".b")

		table = var_1

		var_1.insert(var_75_7, "cue/bgm-" .. arg_77_0 .. ".b")
	...
	if arg_75_0:ShouldPlaySoundEffect() then
		local var_75_9 = arg_75_0
		local var_75_10

		var_75_10, var_75_11 = arg_75_0.GetSoundeffect(var_75_9)

		if var_75_10 then
			table = var_75_9

			var_75_9.insert(var_75_8, var_75_10)
		end
	end
	...
	var_75_11.each(var_75_8, function(arg_78_0)
		pg = var_2_10001
		...
		if var_1.CheckFModeEvent(var_78_0, arg_78_0, function()
			...
			var_2_10002.insert(var_75_12, "cue/" .. var_1 .. ".b")
		end
	...
	if arg_75_0:ShouldPlayVoice() then
		...
		var_75_15, var_75_16 = arg_75_0.GetVoice(var_75_14)

		if var_75_15 then
			table = var_75_14

			var_75_14.insert(var_75_13, var_75_15)
		end
	end
	...
	var_75_16.each(var_75_13, function(arg_81_0)
		pg = var_2_10001
		...
		if var_1.CheckFModeEvent(var_81_0, arg_81_0, function()
			...
			var_2_10002.insert(var_75_17, "cue/" .. var_1 .. ".b")
		end
	...
	local var_75_18 = {}
	local var_75_19 = arg_75_0
	local var_75_20 = arg_75_0.GetEffects(var_75_19)

	_ = var_15

	var_15.each(var_75_20, function(arg_84_0)
		local var_84_0 = arg_84_0.name

		table = var_2_10002

		var_2_10002.insert(var_75_18, var_84_0)
	...
	var_75_19.each(var_75_18, function(arg_85_0)
		table = var_2_10001

		var_2_10001.insert(var_75_21, "ui/" .. arg_85_0)

		table = var_1

		var_1.insert(var_75_21, "effect/" .. arg_85_0)
	...
	if arg_75_0:ExistIcon() and arg_75_0:GetIconData() and var_17.image then
		table = var_18

		var_18.insert(var_75_22, var_17.image)
	end

	local var_75_23 = {}

	StoryRecorder = var_18

	local var_75_24 = var_18.New()

	var_18.Add(var_75_24, arg_75_0)

	local var_75_25 = var_18:GetContentList()

	_ = var_1_10020

	var_1_10020.each(var_75_25, function(arg_86_0)
	...
	return (var_20.MergeLuaArr(var_75_2, var_75_7, var_75_12, var_75_17, var_75_21, var_75_22, var_75_23))
end
