...
function var_0_0.ShouldReplaceCar2026(arg_10_0)
	...
	return var_10_0(var_10_1, var_1_10004.CAR2026) > 0
end
...
function var_0_0.ReplacePlayerName(arg_11_0, arg_11_1)
	...
	if var_1_10002(var_1_10004) then
		...
		local var_11_0 = var_2(var_1_10004)
		local var_11_1 = var_2.getRawData(var_11_0)
		local var_11_2 = var_2.GetName(var_11_1)

		string = var_1_10003

		return (var_1_10003.gsub(arg_11_1, "{playername}", var_11_2))
	end
end
...
function var_0_0.ReplaceTbName(arg_12_0, arg_12_1)
	...
	if var_2.IsReView(var_12_0) then
		...
		return var_12_1(var_12_0, var_12_2, var_1_10006("child_story_name"))
	end
	...
	if var_12_1(var_12_0) then
		...
		local var_12_3 = var_2(var_12_0)
		local var_12_4

		if not var_2.GetCurChar(var_12_3) then
			getProxy = var_12_4
			EducateProxy = var_12_3
			var_12_3 = var_12_4(var_12_3)

			local var_12_5

			var_12_4, var_12_5 = var_12_4.GetStoryInfo(var_12_3)
			string = var_12_3
			arg_12_1 = var_12_3.gsub(arg_12_1, "{tb}", var_12_5)
		else
			getProxy = var_12_4
			NewEducateProxy = var_12_3

			local var_12_6 = var_12_4(var_12_3)
			local var_12_7, var_12_8 = var_2.GetStoryInfo(var_12_6)

			string = var_12_6
			arg_12_1 = var_12_6.gsub(arg_12_1, "{tb}", var_12_8)
		end
...
function var_0_0.ReplaceDormName(arg_13_0, arg_13_1)
	...
	if not var_2.getApartment(var_13_0, arg_13_0.actorName) or not var_2:GetCallName() then
		var_13_1 = arg_13_0.actorName
	end

	string = var_13_0

	return (var_13_0.gsub(arg_13_1, "{dorm3d}", var_13_1))
end
...
function var_0_0.ReplaceCar2026Name(arg_14_0, arg_14_1)
	...
	local var_14_2 = var_14_1(var_14_0, var_1_10006.ACTIVITY_TYPE_MONOPOLY)
	local var_14_3 = ""

	getProxy = var_14_0
	PlayerProxy = var_1_10007

	if var_14_0(var_1_10007) then
		getProxy = var_14_6
		PlayerProxy = var_1_10007

		local var_14_4 = var_14_6(var_1_10007)
...
function var_0_0.GetPathByString(arg_33_0, arg_33_1, arg_33_2)
	...
	local var_33_3 = var_1_10005(-var_33_2.x * 0.5, var_33_2.y * 0.5, 0)

	Vector3 = var_33_1

	local var_33_4 = var_33_1(var_33_2.x * 0.5, var_33_2.y * 0.5, 0)
...
function var_0_0.GenMoveNode(arg_34_0, arg_34_1)
	...
	if var_1_10003(arg_34_1.path) == "table" then
		...
		for iter_34_0, iter_34_1 in var_3(arg_34_1.path) do
			...
			var_1_10008(var_34_1, var_1_10011(iter_34_1[1], iter_34_1[2], 0))
		end
	else
		type = var_3
...
function var_0_0.GetMovableNode(arg_35_0)
	...
	for iter_35_0, iter_35_1 in var_1_10002(var_35_1) do
		local var_35_2 = arg_35_0:GenMoveNode(iter_35_1)

		table = var_1_10008

		var_1_10008.insert(var_35_0, var_35_2)
	end
...
function var_0_0.IsGlobalFlagHit(arg_39_0)
	...
	for iter_39_0, iter_39_1 in var_1_10005(var_39_3) do
...
function var_0_0.IsDialogueMode(arg_48_0)
	local var_48_0 = arg_48_0:GetMode()

	Story = var_1_10002

	return var_48_0 == var_1_10002.MODE_DIALOGUE
end
...
function var_0_0.GetResList(arg_77_0)
	...
	if arg_77_0.GetBgName(var_77_1) then
		...
		var_1_10003.insert(var_77_0, var_2)
	end

	if arg_77_0.GetSubBg and arg_77_0:GetSubBg() then
		table = var_77_1

		var_77_1.insert(var_77_0, var_3)
	end

	_ = var_3

	local var_77_2 = var_3.map(var_77_0, function(arg_78_0)
		return "bg/" .. arg_78_0
	end)
	local var_77_3 = {}
	local var_77_4, var_77_5, var_77_6 = arg_77_0:GetBgmData()

	if var_77_4 then
		table = var_1_10008

		var_1_10008.insert(var_77_3, var_77_4)
	end
	...
	var_1_10009.each(var_77_3, function(arg_79_0)
		table = var_2_10001

		var_2_10001.insert(var_77_7, "cue/" .. arg_79_0 .. ".b")

		table = var_1

		var_1.insert(var_77_7, "cue/bgm-" .. arg_79_0 .. ".b")
	...
	if arg_77_0:ShouldPlaySoundEffect() then
		local var_77_9 = arg_77_0
		local var_77_10

		var_77_10, var_77_11 = arg_77_0.GetSoundeffect(var_77_9)

		if var_77_10 then
			table = var_77_9

			var_77_9.insert(var_77_8, var_77_10)
		end
	end
	...
	var_77_11.each(var_77_8, function(arg_80_0)
		pg = var_2_10001
		...
		if var_1.CheckFModeEvent(var_80_0, arg_80_0, function()
			...
			var_2_10002.insert(var_77_12, "cue/" .. var_1 .. ".b")
		end
	...
	if arg_77_0:ShouldPlayVoice() then
		...
		var_77_15, var_77_16 = arg_77_0.GetVoice(var_77_14)

		if var_77_15 then
			table = var_77_14

			var_77_14.insert(var_77_13, var_77_15)
		end
	end
	...
	var_77_16.each(var_77_13, function(arg_83_0)
		pg = var_2_10001
		...
		if var_1.CheckFModeEvent(var_83_0, arg_83_0, function()
			...
			var_2_10002.insert(var_77_17, "cue/" .. var_1 .. ".b")
		end
	...
	local var_77_18 = {}
	local var_77_19 = arg_77_0
	local var_77_20 = arg_77_0.GetEffects(var_77_19)

	_ = var_15

	var_15.each(var_77_20, function(arg_86_0)
		local var_86_0 = arg_86_0.name

		table = var_2_10002

		var_2_10002.insert(var_77_18, var_86_0)
	...
	var_77_19.each(var_77_18, function(arg_87_0)
		table = var_2_10001

		var_2_10001.insert(var_77_21, "ui/" .. arg_87_0)

		table = var_1

		var_1.insert(var_77_21, "effect/" .. arg_87_0)
	...
	if arg_77_0:ExistIcon() and arg_77_0:GetIconData() and var_17.image then
		table = var_18

		var_18.insert(var_77_22, var_17.image)
	end
	...
	local var_77_24 = var_18.New()

	var_18.Add(var_77_24, arg_77_0)

	local var_77_25 = var_18:GetContentList()

	_ = var_1_10020

	var_1_10020.each(var_77_25, function(arg_88_0)
	...
	return (var_20.MergeLuaArr(var_77_2, var_77_7, var_77_12, var_77_17, var_77_21, var_77_22, var_77_23))
end
