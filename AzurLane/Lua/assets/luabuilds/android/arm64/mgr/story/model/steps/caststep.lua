...
function var_0_1.DataToLayout(arg_3_0, arg_3_1)
	...
	elseif arg_3_1[1] == var_0_4 then
		...
		for iter_3_0 = 1, #var_3_4 do
			...
			local var_3_7 = var_1_10010.hxLan(var_3_6)

			table = var_1_10010

			var_1_10010.insert(var_3_3, var_3_7)
		end
...
function var_0_1.GetLayout(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10002(var_4_1) do
		local var_4_2 = arg_4_0:DataToLayout(iter_4_1)

		table = var_1_10008

		var_1_10008.insert(var_4_0, var_4_2)
	end
