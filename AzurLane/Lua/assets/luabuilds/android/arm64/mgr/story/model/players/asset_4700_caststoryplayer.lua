...
function var_0_1.SetLayout(arg_7_0, arg_7_1, arg_7_2)
	...
	typeof = var_1_10007
	VerticalLayoutGroup = var_1_10009
	var_7_2(var_7_1, var_1_10007(var_1_10009)).spacing = var_7_0

	local var_7_3 = arg_7_1:GetLayout()

	pairs = var_7_1

	for iter_7_0, iter_7_1 in var_7_1(var_7_3) do
		local var_7_4 = arg_7_0.tpls[iter_7_1.type]

		cloneTplTo = var_12

		local var_7_5 = var_12(var_7_4, arg_7_0.layoutContainer)
		local var_7_6 = "InitLayoutForType" .. iter_7_1.type

		assert = var_14

		var_14(arg_7_0[var_7_6], "need function >>>" .. var_7_6)
		arg_7_0[var_7_6](arg_7_0, var_7_5, iter_7_1)
	end
...
function var_0_1.InitLayoutForType2(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_3 = var_9_2(var_9_1, var_7(var_1_10009))
	...
	local var_9_6 = var_9_5(var_9_4, var_1_10008(var_1_10010))
...
function var_0_1.InitLayoutForType3(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_4 = var_10_3(var_10_2, var_1_10008(var_1_10010))
	...
	local var_10_8 = var_1_10009.New(arg_10_1, arg_10_1:Find("1"))
	...
	var_9.make(var_10_8, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			local var_11_2 = var_11_1(var_11_0, var_2_10006(var_2_10008))

			COLOR_WHITE = var_2_10004
			...
			if var_11_3 then
				...
				do
					...
					if not var_11_4.MiddleRight then
						TextAnchor = var_11_4
						var_11_4 = var_11_4.MiddleLeft
					end

					var_11_2.alignment = var_11_4

					if var_11_3 then
						var_2_10004 = arg_10_2.evenColumnColor
					end
				end
				...
				var_11_2.text = var_11_3(var_10_0[arg_11_1 + 1], var_2_10004)
...
function var_0_1.StartAnimation(arg_13_0, arg_13_1, arg_13_2)
	...
	var_4(var_13_1, var_13_2, var_13_3, var_1_10009)
