...
function var_0_1.Play(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	local var_10_0 = var_1_10005.NewStoryMgr.GetInstance()

	var_5.AddRecord(var_10_0, var_4)
	...
	if var_5 and var_4:IsImport() then
		...
		local var_10_2 = var_7.NewStoryMgr.GetInstance()

		if not var_7.IsReView(var_10_2) then
			var_10_1 = true
	...
	local var_10_4 = arg_10_1.GetTriggerDelayTime(var_10_3)
	...
	local var_10_5 = arg_10_1:GetPrevStep(arg_10_2)
		...
		function(arg_11_0)
			...
			var_1({
				function(arg_12_0)
					...
					var_1.Reset(var_12_0, var_0, var_10_5, arg_12_0)
		...
		function(arg_17_0)
			...
			var_1({
				function(arg_18_0)
					...
					var_1.OnInit(var_18_0, var_0, var_10_5, arg_18_0)
				...
				function(arg_20_0)
					...
					var_1.OnEnter(var_20_0, var_0, var_10_5, arg_20_0)
