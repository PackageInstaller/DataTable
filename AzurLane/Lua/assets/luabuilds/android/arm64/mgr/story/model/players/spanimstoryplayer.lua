...
function var_0_1.OnReset(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_1 = var_1_10005.NewStoryMgr.GetInstance().autoBtn
...
function var_0_1.GetSpine(arg_5_0, arg_5_1, arg_5_2)
	...
	arg_5_0.spineChar = var_1_10004.New()

	local var_5_1 = arg_5_0.spineChar

	var_4.SetPaint(var_5_1, var_5_0)

	local var_5_2 = arg_5_0.spineChar

	var_4.Load(var_5_2, true, function(arg_6_0)
