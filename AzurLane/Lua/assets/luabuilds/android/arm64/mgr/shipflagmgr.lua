...
function pg.ShipFlagMgr.Init(arg_1_0, arg_1_1)
	arg_1_0.flagDic = {}
	arg_1_0.extraInfo = {}
...
local var_0_1 = {
	...
	inElite = function()
		...
		local var_5_1 = getProxy(ActivityProxy)

		if not var_5_0.mapEliteFleetCache then
			return {}, {}
		end

		for iter_5_0, iter_5_1 in pairs(var_5_0.mapEliteFleetCache) do
			local var_5_2 = checkExist(ChapterProxy.FormationToChapters[iter_5_0], {
				1
			})
			local var_5_3 = var_5_2 and var_0_0.chapter_template[var_5_2].map

			if not (var_5_2 and var_0_0.chapter_template[var_5_2].map) then
				-- block empty
			else
				local var_5_4 = var_0_0.expedition_data_by_map[var_5_3].on_activity or 0

				if var_5_4 == 0 or checkExist(var_5_1:getActivityById(var_5_4), {
					"isEnd"
				}) == false then
					local var_5_5 = {}
		...
		return _.flatten(_.values({})), {}
	end,
	inSupport = function()
		local var_6_0 = getProxy(ChapterProxy)
		local var_6_1 = getProxy(ActivityProxy)

		if not var_6_0.mapEliteFleetCache then
			return {}, {}
		end

		for iter_6_0, iter_6_1 in pairs(var_6_0.mapEliteFleetCache) do
			local var_6_2 = checkExist(ChapterProxy.FormationToChapters[iter_6_0], {
				1
			})
			local var_6_3 = var_6_2 and var_0_0.chapter_template[var_6_2].map

			if not (var_6_2 and var_0_0.chapter_template[var_6_2].map) then
				-- block empty
			else
				local var_6_4 = var_0_0.expedition_data_by_map[var_6_3].on_activity or 0

				if var_6_4 == 0 or checkExist(var_6_1:getActivityById(var_6_4), {
					"isEnd"
				}) == false then
					local var_6_5 = {}
	...
	inActivity = function()
		for iter_7_0, iter_7_1 in pairs(getProxy(FleetProxy):getActivityFleets()) do
			({})[iter_7_0] = _.flatten(_.map(_.values(iter_7_1), function(arg_8_0)
...
function pg.ShipFlagMgr.MarkShipsFlag(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
...
function pg.ShipFlagMgr.GetShipFlag(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
...
function pg.ShipFlagMgr.FilterShips(arg_28_0, arg_28_1, arg_28_2)
...
function pg.ShipFlagMgr.UpdateFlagShips(arg_29_0, arg_29_1)
	arg_29_0.flagDic[arg_29_1] = {}

	arg_29_0:MarkShipsFlag(arg_29_1, var_0_1[arg_29_1]())

	return
end

function pg.ShipFlagMgr.ClearShipsFlag(arg_30_0, arg_30_1)
	arg_30_0.flagDic[arg_30_1] = {}

	return
end

function pg.ShipFlagMgr.DebugPrint(arg_31_0, arg_31_1)
