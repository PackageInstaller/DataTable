...
local function var_0_3(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	local var_5_0 = var_1_10006(arg_5_2) == "table"
	local var_5_1 = "节点信息解析错误:"

	tostring = var_8

	var_1_10004(var_5_0, var_5_1 .. var_8(arg_5_2))
	...
	if var_4 == true then
		var_1_10005 = var_0_1.NodeBase.Guide.New(arg_5_1)

		arg_5_3:Add(var_1_10005)
		...
		for iter_5_0, iter_5_1 in var_6(arg_5_2) do
			...
			var_1_10005:AddFollow(var_5_3, var_5_4)
			var_0_3(arg_5_0, var_5_4, iter_5_1, var_5_3)
		end
	else
		ipairs = var_1_10005

		for iter_5_2, iter_5_3 in var_1_10005(arg_5_2) do
