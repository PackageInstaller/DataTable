...
function var_0_1.InitConfig(arg_2_0)
	...
	if var_1_10001 == var_1_10002 then
		...
		local var_2_0 = var_1_10001.SdkMgr.GetInstance()

		var_1_10002 = var_1_10001.GetChannelUID(var_2_0) == "cps" or var_1_10001 == "yun" or var_1_10001 == "0"
		getProxy = var_2_0
		UserProxy = var_1_10005

		local var_2_1 = var_2_0(var_1_10005)
		local var_2_2 = var_3.GetCacheGatewayInServerLogined(var_2_1)

		PLATFORM_IPHONEPLAYER = var_1_10004

		if var_2_2 == var_1_10004 then
			var_1_10004 = "dorm_ios/"
			var_1_10004 = FOLDERNAME
		elseif var_1_10002 then
			var_1_10004 = "dorm_bili/"
			var_1_10004 = FOLDERNAME
		else
			var_1_10004 = "dorm_uo/"
			var_1_10004 = FOLDERNAME
		...
		local var_2_3 = "FOLDERNAME: "

		FOLDERNAME = var_1_10007

		var_1_10004(var_2_3, var_1_10007)
	else
		PLATFORM_CODE = var_1_10001
		...
		if var_1_10001 == var_1_10002 then
			...
			if var_1_10001 == var_1_10002 then
				...
				if var_1_10001 == var_1_10002 then
					...
					if var_1_10001 == var_1_10002 then
						local var_2_4 = ""
						local var_2_5 = OSS_STS_URL
						local var_2_6 = "ap-northeast-1"
						local var_2_7 = OSS_ENDPOINT
						local var_2_8 = "blhx-dorm-jp"
						local var_2_9 = OSSBUCKETNAME
						local var_2_10 = "dorm_jp/"
						local var_2_11 = FOLDERNAME
					end
				end
			end
		end
...
function var_0_1.InitClinet(arg_4_0, arg_4_1)
	...
	var_4_3(var_4_2, var_1_10007.GET_OSS_ARGS, {
		mode = var_4_0,
		callback = var_4_1
	})
...
function var_0_1.UpdateLoad(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	FOLDERNAME = var_1_10009

	var_6_1(var_6_0, var_6_2, var_1_10009 .. arg_6_1, arg_6_2, arg_6_3)
...
function var_0_1.AsynUpdateLoad(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	var_7_1(var_7_0, var_7_2, var_1_10009 .. arg_7_1, arg_7_2, arg_7_3)
...
function var_0_1.DeleteObject(arg_8_0, arg_8_1, arg_8_2)
	...
	var_8_1(var_8_0, var_8_2, var_1_10008 .. arg_8_1, arg_8_2)
...
function var_0_1.GetSprite(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6)
	...
	FOLDERNAME = var_1_10012

	var_9_1(var_9_0, var_9_2, var_1_10012 .. arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6)
...
function var_0_1.GetTexture2D(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5, arg_10_6)
	...
	if not arg_10_0.instance then
		...
		local var_10_1 = var_1_10008.Texture2D.New
		local var_10_2 = arg_10_4
		local var_10_3 = arg_10_5

		TextureFormat = var_1_10012

		local var_10_4 = var_10_1(var_10_2, var_10_3, var_1_10012.ARGB32, false)

		Tex2DExtension = var_9

		var_9.LoadImage(var_10_4, var_10_0)
	...
	var_10_6(var_10_5, var_10_7, var_1_10012 .. arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5, arg_10_6)
