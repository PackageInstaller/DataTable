...
function var_0_1.loadSigns(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_1 = arg_5_1.GetSignList(var_5_0)
	local var_5_2 = {}
	...
	for iter_5_0, iter_5_1 in var_5_0(var_5_1) do
		...
		var_1_10010.insert(var_5_2, function(arg_6_0)
...
function var_0_1.LoadSignRes(arg_8_0, arg_8_1, arg_8_2)
	...
	var_3.Load(var_8_0, arg_8_1.signName, function(arg_9_0)
		if arg_8_1.atlasName and arg_8_1.fileName then
			...
			var_2_10002(var_4(arg_9_0, "shadow"), var_9_0, true)
		end
...
function var_0_1.InitSign(arg_10_0, arg_10_1, arg_10_2)
	...
	GuideShowSignStep = var_1_10004

	if var_10_0 == var_1_10004.SIGN_TYPE_2 then
		arg_10_0:UpdateSign2(arg_10_1, arg_10_2)
	else
		GuideShowSignStep = var_4

		if var_10_0 == var_4.SIGN_TYPE_3 then
...
function var_0_1.UpdateSign2(arg_11_0, arg_11_1, arg_11_2)
	...
	if arg_11_1:ShouldClick() then
		...
		arg_11_0.SearchUI(var_1_10008, var_11_2, function(arg_12_0)
			IsNil = var_2_10001
	...
	local var_11_4 = var_11_2(var_11_3, var_1_10008(var_1_10010)).onLongPressed
