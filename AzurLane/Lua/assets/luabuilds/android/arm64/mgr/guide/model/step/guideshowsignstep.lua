...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_3(var_2.signList) do
		...
		if not var_1_1 then
			...
			Vector3 = var_1_10015
			var_1_10015 = var_1_10015(0, 0, 0)
		end

		var_1_5.pos = var_1_10015
...
function var_0_1.GenClickData(arg_2_0, arg_2_1)
	...
	local var_2_1 = arg_2_0.GenSearchData(var_2_0, arg_2_1)
	local var_2_2
	...
	Vector2 = var_2_0
	var_2_1.sizeDeltaPlus = var_2_0(var_2_2[1], var_2_2[2])
