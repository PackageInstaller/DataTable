...
function var_0_1.OnExecution(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_1 = arg_1_1.GetHideNodes(var_1_0)
	local var_1_2 = {}
	...
	for iter_1_0, iter_1_1 in var_1_0(var_1_1) do
		...
		var_1_10010.insert(var_1_2, function(arg_2_0)
			...
			var_1.SearchWithoutDelay(var_2_0, iter_1_1, function(arg_3_0)
				...
				defaultValue = var_3_10006

				var_3_2(var_3_1, var_3_3, var_3_4, var_3_10006(iter_1_1.type, var_0_2))
				arg_2_0()
...
function var_0_1.SetActive(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	elseif arg_4_3 == var_0_3 then
		...
		local var_4_1 = var_4(var_4_0, var_1_10007(var_1_10009))
