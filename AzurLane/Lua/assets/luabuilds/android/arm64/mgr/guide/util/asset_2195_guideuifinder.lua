...
local function var_0_1(arg_6_0, arg_6_1)
	...
	for iter_6_0 = 0, arg_6_0.childCount - 1 do
		...
		local var_6_2 = arg_6_0.GetChild(var_6_1, iter_6_0)
		local var_6_3 = var_7.GetComponent

		typeof = var_1_10011
		LayoutElement = var_1_10013

		local var_6_4 = var_6_3(var_6_2, var_1_10011(var_1_10013))
		...
		if not var_6_1(var_7) then
			...
			if var_9(var_7).activeInHierarchy and (not var_6_4 or not var_6_4.ignoreLayout) then
				table = var_9
...
local function var_0_2(arg_7_0)
	...
	if var_1_10002.match(var_7_0, "/CombatUI%(Clone%)/") then
		...
		local var_7_2 = var_1_10003.Battle.BattleState.GetCombatSkinKey()
...
local function var_0_3(arg_8_0)
	if var_0_2(arg_8_0) ~= nil then
		...
		for iter_8_0, iter_8_1 in var_1_10002(arg_8_0.conditionData) do
