...
local function var_0_11(arg_3_0)
	...
	return var_1_10002.New(var_3_0)
end
...
function var_0_1.Init(arg_4_0, arg_4_1)
	...
	var_2("ui", "NewGuideUI", function(arg_5_0)
		...
		var_5_2(var_5_1, var_4.UIMgr.GetInstance().OverlayToast, false)

		local var_5_3 = arg_4_0

		GuideUIFinder = var_2
		var_5_3.uiFinder = var_2.New(arg_4_0._tf)
		...
		var_5_4.uiDuplicator = var_5_5(var_4.Find(var_5_6, "target"))
		...
		var_5_7.uiLoader = var_5_8(var_4.Find(var_5_9, "target"))
		...
		var_5_10.uiFloatCollctor = var_5_11(var_4.Find(var_5_12, "target"))
		...
		local var_5_15 = var_5_1.DIALOGUE_BLUE
		...
		local var_5_19 = var_4.Find(var_5_18, "BG/close_btn")

		typeof = var_5
		UILongPressTrigger = var_7
		var_5_17.uiLongPress = var_2(var_5_19, var_5(var_7))
...
function var_0_1.PlayScript(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5)
	...
	for iter_9_0, iter_9_1 in var_1_10007(arg_9_1:GetStepsWithCode(arg_9_2)) do
		local var_9_1 = iter_9_0

		table = var_1_10013

		var_1_10013.insert(var_9_0, function(arg_10_0)
...
function var_0_1.OnStart(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10004.START_GUIDE)
...
function var_0_1.Clear(arg_21_0)
	...
	var_21_2(var_21_1, iter_21_0.END_GUIDE)
