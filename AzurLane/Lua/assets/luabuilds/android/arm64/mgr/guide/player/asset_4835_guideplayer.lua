...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.bgCg = var_1_1(var_1_0, var_5(var_1_10007))
...
local function var_0_1(arg_15_0, arg_15_1)
	...
	local var_15_2 = var_15_1(var_15_0, var_1_10005(var_1_10007))

	IsNil = var_1_10003

	local var_15_3

	if not var_1_10003(var_15_2.sprite) then
...
function var_0_0.WaitUntilSceneEnter(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_1 = var_1_10004.NewGuideMgr.GetInstance()

	if var_4.ExistScene(var_23_1, var_23_0) then
		arg_23_2()
	else
...
function var_0_0.ShowDialogueWindow(arg_27_0, arg_27_1, arg_27_2)
	...
	local var_27_2 = arg_27_1.GetDialogueType(var_27_1)

	if not arg_27_0.dialogueWindows[var_27_2] then
		table = var_27_1

		var_27_1.insert(var_27_0, function(arg_28_0)
			local var_28_0 = arg_27_0

			var_1.LoadDialogueWindow(var_28_0, var_27_2, arg_28_0)
	...
	var_27_1.insert(var_27_0, function(arg_29_0)
		local var_29_0 = arg_27_0.dialogueWindows[var_27_2]
...
function var_0_0.UpdateDialogue(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	var_1_10005(arg_30_2:Find("content"), var_30_0.text)
	...
	local var_30_2 = arg_30_2.Find(var_30_1, "hand")

	IsNil = var_6

	if not var_6(var_30_2) then
		var_30_2.localPosition = var_30_0.handPosition
		var_30_2.eulerAngles = var_30_0.handAngle
	end
	...
	if var_30_0.counsellor then
		...
		var_30_1({
			...
			function(arg_32_0)
				...
				Vector3 = var_2_10003
				var_32_0.localPosition = var_32_1 + var_2_10003(var_0.position.x, var_0.position.y, 0)
				Vector3 = var_2
		...
		for iter_30_0, iter_30_1 in var_30_1(arg_30_0.counsellors) do
...
local function var_0_2(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	if var_39_0 == var_1_10005.HIGH_TYPE_GAMEOBJECT then
		local var_39_1 = arg_39_0.uiDuplicator
		...
		if var_39_2 == var_5.HIGH_TYPE_LINE then
			...
			local var_39_9 = var_1_10010(var_39_5.x, var_39_5.y, 0)

			Vector3 = var_1_10011
			var_39_8.position = var_39_9 + var_1_10011(var_39_3.x, var_39_3.y, 0)
			Vector2 = var_10
			var_39_8.size = var_10(var_39_3.width, var_39_3.height)
...
function var_0_0.RegisterEvent(arg_45_0, arg_45_1, arg_45_2)
	...
	local function var_45_3()
		...
		if var_0.ShouldGoScene(var_46_0) then
			...
			local var_46_3 = var_2_10003.GO_SCENE

			SCENE = var_2_10004

			var_46_2(var_46_1, var_46_3, var_2_10004[arg_45_1.sceneName])
			arg_45_2()
		else
			...
			if var_0.ShouldTriggerOtherTarget(var_46_4) then
				...
				var_46_6(var_46_5, var_3.GetOtherTriggerTarget(var_46_7), function(arg_47_0)
	...
	var_3(var_45_1, var_45_2, var_45_3, var_1_10008)
