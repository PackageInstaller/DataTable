...
function var_0_1.ShowTips(arg_4_0, arg_4_1)
	...
	SFX_UI_TIP = var_1_10005

	var_4_1(var_4_0, var_1_10005)
	...
	var_4(var_4_5, var_7.Find(var_4_6, "content/icon"), true)

	setText = var_4

	local var_4_7 = var_4_3.transform

	var_4(var_6.Find(var_4_7, "content/name"), var_4_4.name)

	setText = var_4

	local var_4_8 = var_4_3.transform
	local var_4_9 = var_6.Find(var_4_8, "content/label")

	i18n = var_7

	var_4(var_4_9, var_7("trophy_achieved"))

	local var_4_10 = var_4_3.transform
	local var_4_11 = var_4.Find(var_4_10, "content")

	Vector3 = var_5
	var_4_11.localPosition = var_5(-850, 0, 0)
	...
	;(function(arg_5_0)
		...
		var_5_0(var_2_10003(var_4_11), -275, 0.5)
		...
		local var_5_2 = var_5_1(var_3(var_4_11), -850, 0.5)
		local var_5_3 = var_1.setDelay(var_5_2, 5)
		local var_5_4 = var_1.setOnComplete

		System = var_4

		var_5_4(var_5_3, var_4.Action(function()
			Destroy = var_3_10000
