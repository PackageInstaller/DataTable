...
function var_0_1.Init(arg_1_0, arg_1_1)
	...
	arg_1_0.baseParent = var_1_10002(var_1_10004.Find("UICamera/Canvas"))
	...
	local var_1_3 = var_1_1(var_1_2, var_5(var_7))
	...
	typeof = var_6
	GraphicRaycaster = var_8

	var_3(var_1_4, var_6(var_8))
	...
	typeof = var_6
	Camera = var_8
	arg_1_0.lvCamera = var_3(var_1_5, var_6(var_8))
	tf = var_3
	...
	typeof = var_6
	Canvas = var_8
	var_1_7(var_1_8, var_6(var_8)).sortingOrder = 5000
	arg_1_0.adaptPool = {}
	rtf = var_3
	GameObject = var_1_8

	local var_1_9 = var_3(var_1_8.Find("OverlayCamera/Overlay"))
	...
	if not arg_8_2.blurCamList then
		if not arg_8_2.globalBlur then
			...
			if var_8_5 then
				...
				LayerWeightConst = var_1_10006
				var_1_10006 = var_1_10006.TYPE_DIC[var_8_5]
			end

			var_1_10004(var_1_10006)
			...
			local var_8_8 = var_1_10007.format
			local var_8_9 = "ui:%s 加入了ui层级管理\n%s"
			local var_8_10 = arg_8_1.name

			PrintTable = var_1_10011

			var_8_7(var_8_6, var_8_8(var_8_9, var_8_10, var_1_10011(arg_8_2)))

			local var_8_11 = arg_8_0:DelList(arg_8_1)

			table = var_1_10005

			var_1_10005.insert(arg_8_0.storeUIs, arg_8_2)
...
function var_0_1.DelFromOverlay(arg_9_0, arg_9_1, arg_9_2)
	...
	var_9_1(var_9_0, var_1_10006.format("ui:%s 退出了ui层级管理", arg_9_1.name))
...
function var_0_1.SortStoreUIs(arg_11_0)
	...
	var_11_2(var_11_1, var_4(arg_11_0.storeUIs))
	arg_11_0:Log("-----------------------------------------")
	...
	for iter_14_0 = #arg_14_0.storeUIs, 1, -1 do
		...
		if not var_14_0 then
			...
			if not var_14_11 and not var_14_16 then
				...
				LayerWeightConst = var_1_10030
				var_14_18[var_1_10030.UI_TYPE_SUB] = function()
					if var_1_10024 then
						if var_14_7 then
				...
				LayerWeightConst = var_1_10030
				var_14_18[var_1_10030.UI_TYPE_SYSTEM] = function()
...
function var_0_1.GetAdaptObj(arg_20_0, arg_20_1)
	...
	if #arg_20_0.adaptPool > 0 then
		...
		local var_20_4 = var_1_10007(var_1_10009)

		typeof = var_1_10008
		NotchAdapt = var_1_10010
		var_20_1 = var_20_2(var_20_3, var_20_4, var_1_10008(var_1_10010)).transform
	end
...
function var_0_1.CheckRecycleAdaptObj(arg_21_0, arg_21_1, arg_21_2)
	...
	if arg_21_2 ~= nil then
		...
		var_1_10004(arg_21_1, arg_21_2, false)
	end
	...
	if var_21_0 ~= nil then
		if #arg_21_0.adaptPool < 4 then
			...
			var_4.insert(arg_21_0.adaptPool, var_21_0)

			SetParent = var_4

			var_4(var_21_0, arg_21_0.OverlayAdapt, false)

			var_21_0.name = var_0_1.RECYCLE_ADAPT_TAG
			SetActive = var_4

			var_4(var_21_0, false)
		else
			Destroy = var_4
