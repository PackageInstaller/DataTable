...
function var_0_1.SetIKStatus(arg_13_0, arg_13_1)
	...
	var_1_10002.Foreach(arg_13_1, function(arg_14_0, arg_14_1)
		...
		typeof = var_6
		RootMotion = var_2_10008

		local var_14_4 = var_14_3(var_14_2, var_6(var_2_10008.FinalIK.IKExecutionOrder))
		local var_14_5 = {}

		table = var_14_2

		var_14_2.IpairsCArray(var_14_4.IKComponents, function(arg_15_0, arg_15_1)
		...
		local var_14_10 = arg_14_1:GetSubTargets()

		table = var_14_8

		var_14_8.Foreach(var_14_10, function(arg_17_0, arg_17_1)
...
function var_0_1.Update(arg_19_0)
	(function()
		...
		local var_20_2 = var_20_1(var_20_0, var_2_10004.zero)
		local var_20_3 = var_0:PointToNormalized(arg_19_0.ikHandler.targetScreenOffset) - var_20_2

		_ = var_20_0

		var_20_0.each(arg_19_0.ikHandler.subPlanes, function(arg_21_0)
			local var_21_0 = arg_21_0.target
			local var_21_1 = arg_21_0.planeData

			var_21_0.position = var_0_1.GetPostionByRatio(var_21_1, var_20_3)
...
function var_0_1.OnDragBegin(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	var_1_10005("ENABLEIK", var_4:GetControllerPath())

	local var_22_0 = var_4
	local var_22_1 = var_4.GetControllerPath(var_22_0)
	local var_22_2 = arg_22_0.ladyIKRoot
	local var_22_3 = var_6.Find(var_22_2, var_22_1)
	local var_22_4 = var_6.GetComponent

	typeof = var_9
	RootMotion = var_1_10011

	local var_22_5 = var_22_4(var_22_3, var_9(var_1_10011.FinalIK.IKExecutionOrder))

	pg = var_22_0

	local var_22_6 = var_22_0.UIMgr.GetInstance().uiCamera
	local var_22_7 = var_7.Find(var_22_6, "Canvas").rect

	Vector2 = var_22_6

	local var_22_8 = var_22_6.New
	local var_22_9 = arg_22_2.x

	Screen = var_1_10012

	local var_22_10 = var_22_9 / var_1_10012.width * var_22_7.width
	local var_22_11 = arg_22_2.y

	Screen = var_1_10013
	arg_22_2 = var_22_8(var_22_10, var_22_11 / var_1_10013.height * var_22_7.height)
	...
	if not arg_22_0.holdingStatus[var_4] then
		var_22_12.rect = var_4:GetControlRect()

		local var_22_13 = var_4:GetActionType()

		Dorm3dIK = var_22_10

		if var_22_13 ~= var_22_10.ACTION_TRIGGER.RELEASE_ON_TARGET then
			Dorm3dIK = var_11

			if var_22_13 == var_11.ACTION_TRIGGER.TOUCH_TARGET then
				var_22_12.triggerRect = var_4:GetActionRect()
			end

			var_22_12.originScreenPosition = arg_22_2
			tf = var_11

			local var_22_14 = var_11(var_22_5)
			...
			local var_22_17 = var_4:GetSubTargets()

			_ = var_14

			var_14.each(var_22_17, function(arg_24_0)
				...
				local var_24_7 = var_24_4(var_24_6(var_24_5, var_2_10009(var_2_10011.MeshCollider)))

				var_24_7.origin = arg_22_0.ladyBoneMaps[arg_24_0.name].position

				local var_24_8 = var_22_12.rect

				Vector2 = var_2_10007

				local var_24_9 = var_2_10007.New(var_24_8.center.x / var_24_8.width, var_24_8.center.y / var_24_8.height)
			...
			var_22_12.subPlanes = var_22_16
			setActive = var_14

			var_14(var_22_5, true)

			if false then
				var_22_13 = arg_22_2 - arg_22_0.holdingStatus[var_4].ikHandler.screenPosition
				var_22_12.originScreenPosition = var_22_12.originScreenPosition + var_22_13
				arg_22_0.holdingStatus[var_4] = nil
			end

			arg_22_0.ikHandler = var_22_12
			existCall = var_22_13

			var_22_13(arg_22_0.onIKLayerActive, var_22_12)
...
function var_0_1.HandleBodyDrag(arg_25_0, arg_25_1)
	...
	local var_25_3 = var_25_1.New
	local var_25_4 = arg_25_1.x

	Screen = var_1_10008

	local var_25_5 = var_25_4 / var_1_10008.width * var_25_2.width
	local var_25_6 = arg_25_1.y

	Screen = var_1_10009
	var_25_0.screenPosition = var_25_3(var_25_5, var_25_6 / var_1_10009.height * var_25_2.height)
	...
	local var_25_11, var_25_12

	if var_25_0.triggerRect then
		var_25_11 = var_25_0.triggerRect
		var_25_12 = var_9.Contains(var_25_11, var_25_7)
	end

	if not var_25_10 then
		local var_25_13 = var_25_8:GetActionType()

		Dorm3dIK = var_25_11

		if var_25_13 == var_25_11.ACTION_TRIGGER.TOUCH_TARGET and var_25_12 then
	...
	local function var_25_14()
		...
		for iter_26_0 = 1, 4 do
			SegmentUtil = var_26_7

			local var_26_7 = var_26_7.GetCrossPoint
			local var_26_8 = var_26_1
			local var_26_9 = var_26_0

			unpack = var_2_10011

			local var_26_10

			var_26_7, var_26_10 = var_26_7(var_26_8, var_26_9, var_2_10011(var_26_2[iter_26_0]))
	...
	local var_25_15 = arg_25_0.ikHandler

	var_25_15.targetScreenOffset = var_25_14()
	existCall = var_25_15

	var_25_15(arg_25_0.onIKLayerDrag, arg_25_0.ikHandler)
...
function var_0_1.ReleaseDrag(arg_27_0)
	...
	local var_27_1
	local var_27_2 = var_27_0:GetActionType()

	Dorm3dIK = var_1_10005

	if var_27_2 == var_1_10005.ACTION_TRIGGER.RELEASE then
		var_27_1 = true
	else
		Dorm3dIK = var_5

		if var_27_2 == var_5.ACTION_TRIGGER.RELEASE_ON_TARGET then
			local var_27_3 = var_1.screenPosition - var_1.originScreenPosition

			if var_1.triggerRect then
				local var_27_4 = var_1.triggerRect

				if var_7.Contains(var_27_4, var_27_3) then
					var_27_1 = true
				end
			end
		end
...
function var_0_1.ResetIK(arg_32_0, arg_32_1)
	...
	local var_32_0 = var_2
	local var_32_1 = var_2.GetControllerPath(var_32_0)
	local var_32_2 = arg_32_0.ladyIKRoot
	local var_32_3 = var_4.Find(var_32_2, var_32_1)
	local var_32_4 = var_4.GetComponent

	typeof = var_7
	RootMotion = var_1_10009

	local var_32_5 = var_32_4(var_32_3, var_7(var_1_10009.FinalIK.IKExecutionOrder))

	setActive = var_32_0

	var_32_0(var_32_5, false)

	local var_32_6 = arg_32_0.cacheIKInfos[var_2].solvers
	local var_32_7 = arg_32_0.cacheIKInfos[var_2].weights

	table = var_7

	var_7.Foreach(var_32_6, function(arg_34_0, arg_34_1)
		arg_34_1.IKPositionWeight = var_32_7[arg_34_0]
	...
	if arg_32_0.moveTimer then
		local var_32_8 = arg_32_0.moveTimer
...
function var_0_1.ResetIKLayers(arg_35_0, arg_35_1)
	...
	var_1_10003.each(arg_35_1 or {}, function(arg_36_0)
		...
		local var_36_1 = arg_36_0.GetControllerPath(var_36_0)
		local var_36_3

		if arg_35_0.ladyIKRoot then
			local var_36_2 = arg_35_0.ladyIKRoot

			var_36_3 = var_2.Find(var_36_2, var_36_1)
		end

		if var_36_3 then
			IsNil = var_36_0

			if not var_36_0(var_36_3) then
				setActive = var_3

				var_3(var_36_3, false)
			end
		end

		if arg_35_0.cacheIKInfos[arg_36_0] then
			local var_36_4 = var_3.solvers
			local var_36_5 = var_3.weights

			table = var_2_10006

			var_2_10006.Foreach(var_36_4, function(arg_37_0, arg_37_1)
				arg_37_1.IKPositionWeight = var_36_5[arg_37_0]
...
function var_0_1.ResetActiveIKs(arg_40_0)
	...
	var_40_0(var_40_1, var_1_10004.keys(arg_40_0.holdingStatus))
...
function var_0_1.PlayIKAction(arg_41_0, arg_41_1)
	...
	var_1_10002(var_41_0, var_5.GetControllerPath(var_41_1))
	...
	var_1_10002({
		function(arg_42_0)
			...
			var_42_0(var_42_1, var_2_10004.keys(arg_41_0.holdingStatus))
			...
			var_42_3(var_42_2, var_4.GetActionRevertTime(var_42_4), arg_42_0)
...
function var_0_1.PlayIKMove(arg_44_0, arg_44_1, arg_44_2, arg_44_3, arg_44_4, arg_44_5, arg_44_6)
	...
	if not var_7.detect(arg_44_0.readyIKLayers, function(arg_45_0)
		...
		existCall = var_1_10008

		var_1_10008(arg_44_6)
	...
	var_1_10008("PLAY IKMOVE", var_7:GetControllerPath())
	...
	local function var_44_6()
		if arg_44_0.ikHandler then
			...
			local var_46_6 = var_46_3(var_46_4, var_46_5 - var_2_10004.time) / arg_44_5
			...
			local var_46_8 = var_46_4.UIMgr.GetInstance().uiCamera
			local var_46_9 = var_2.Find(var_46_8, "Canvas").rect

			Vector2 = var_46_8

			local var_46_10 = var_46_8.New
			local var_46_11 = var_46_7.x / var_46_9.width

			Screen = var_7

			local var_46_12 = var_46_11 * var_7.width
			local var_46_13 = var_46_7.y / var_46_9.height

			Screen = var_8

			local var_46_14 = var_46_10(var_46_12, var_46_13 * var_8.height)
	...
	FrameTimer = var_12
	arg_44_0.moveTimer = var_12.New(var_44_6, 1, -1)
