...
function var_0_1.Init(arg_1_0, arg_1_1)
	...
	var_1_10002("ui", "RepairUI", function(arg_2_0)
		...
		typeof = var_5
		Text = var_2_10007
		var_2_1.contentTxt = var_2_4(var_2_3, var_5(var_2_10007))
		...
		local var_2_19 = var_4.Find(var_2_18, "window/buttons")
		local var_2_20 = arg_1_0._tf

		var_2_16.uiItemList = var_2_17(var_2_19, var_5.Find(var_2_20, "window/buttons/custom_button_1"))
		setText = var_2_16

		local var_2_21 = arg_1_0._tf
		local var_2_22 = var_3.Find(var_2_21, "window/top/title")

		i18n = var_2_19

		var_2_16(var_2_22, var_2_19("msgbox_repair_title"))
		arg_1_1()
...
function var_0_1.InitDefaultResBtn(arg_3_0)
	...
	function var_3_0.onCallback()
		...
		if var_4_0(var_2_10002.persistentDataPath .. "/hashes.csv") then
			BundleWizard = var_0
...
function var_0_1.InitL2dBtn(arg_5_0)
	...
	function var_5_0.onCallback()
		...
		if var_6_0(var_2_10002.persistentDataPath .. "/hashes-live2d.csv") then
			BundleWizard = var_0
...
function var_0_1.InitPaintingBtn(arg_7_0)
	...
	function var_7_0.onCallback()
		...
		if var_8_0(var_2_10002.persistentDataPath .. "/hashes-painting.csv") then
			BundleWizard = var_0
...
function var_0_1.InitCipherBtn(arg_9_0)
	...
	function var_9_0.onCallback()
		...
		if var_10_0(var_2_10002.persistentDataPath .. "/hashes-cipher.csv") then
			BundleWizard = var_0
...
function var_0_1.InitCvBtn(arg_11_0)
	...
	function var_11_0.onCallback()
		...
		if var_12_0(var_2_10002.persistentDataPath .. "/hashes-cv.csv") then
			BundleWizard = var_0
...
function var_0_1.Show(arg_14_0, arg_14_1)
	...
	var_2.make(var_14_2, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			var_4(var_15_1, var_15_2, var_15_3, var_9)
		end
	...
	i18n = var_1_10003
	var_14_4.text = var_1_10003("resource_verify_warn")
	onButton = var_14_4
	...
	var_14_4(var_14_5, var_14_6, var_14_7, var_1_10007)
	...
	var_14_4(var_14_8, var_14_9, var_14_10, var_1_10007)
