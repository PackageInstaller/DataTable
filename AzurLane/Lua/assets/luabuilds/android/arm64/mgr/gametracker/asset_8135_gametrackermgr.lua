...
function var_0_1.Send(arg_7_0)
	...
	var_7_2(var_7_1, var_1_10004.GAME_TRACK, {
...
function var_0_1.Cache(arg_9_0)
	...
	var_5.SetString(var_0_6 .. var_9_5, var_9_2)
...
function var_0_1.ClearCache(arg_11_0)
	...
	var_1_10002.SetString(var_0_6 .. var_11_1, "")
...
function var_0_1.FetchCache(arg_12_0)
	...
	if not var_1_10002.GetString(var_0_6 .. var_12_1, "") or var_2 == "" then
		return
	end
