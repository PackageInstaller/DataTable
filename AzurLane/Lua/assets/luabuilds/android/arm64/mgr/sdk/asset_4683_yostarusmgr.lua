...
function var_0_0.CheckGoogleSimulator()
	...
	if var_1_10000.GATEWAY_PORT == 50001 then
		NetConst = var_0
...
function var_0_0.CheckRelease()
	...
	if var_1_10000.GATEWAY_PORT == 80 then
		...
		if var_0.GATEWAY_HOST ~= "blhxusgate.yo-star.com" then
			var_5_0 = false
		else
			var_5_0 = true
		end
...
function var_0_0.YoStarGoLogin(arg_17_0)
	...
	local var_17_2 = var_1_10004.GO_SCENE

	SCENE = var_1_10005

	var_17_1(var_17_0, var_17_2, var_1_10005.LOGIN, {
...
;(function()
	...
	function var_0_0.Pay(arg_25_0, arg_25_1, arg_25_2)
		if var_0_0.GetIsPlatform() then
			...
			Time = var_2_10004
			var_25_1.OnYoStarPaying = var_2_10004.realtimeSinceStartup
	...
	function var_0_0.RoleInfoUpload()
		if var_0_0.GetIsPlatform() then
			...
			local var_28_2 = var_2_10002(var_2_10004)
			local var_28_3 = var_2.getData(var_28_2)

			getProxy = var_2_10004
			ServerProxy = var_2_10006

			local var_28_4 = var_2_10004(var_2_10006)
			local var_28_5 = var_4.getLastServer(var_28_4, var_28_3.uid)

			tostring = var_2_10006

			local var_28_6 = var_2_10006(var_28_5.id .. " - " .. var_28_5.name)

			tostring = var_28_4

			local var_28_7 = var_28_4(var_28_1.id)
	...
	function var_0_0.ShowSurvey(arg_29_0, arg_29_1)
		if var_0_0.GetIsPlatform() then
			...
			local var_29_0 = var_2(var_2_10004)
			...
			var_29_3(var_29_2, var_29_4, var_2_10008(var_29_1.id), arg_29_1)
		end
	...
	function var_0_0.QueryErrorMsg(arg_38_0)
		if var_0_0.GetIsPlatform() then
			...
			return var_1.QueryErrorMsg(var_38_0)
		end
...
;(function()
	...
	local function var_46_2(arg_48_0)
		...
		if var_0_0.YoStarRetCodeHandler(arg_48_0) then
			...
			local var_48_2 = var_2_10002.m02
			local var_48_3 = var_2.sendNotification

			GAME = var_2_10005

			var_48_3(var_48_2, var_2_10005.PLATFORM_LOGIN_DONE, {
				user = var_48_1
			})
		end
	...
	local function var_46_4(arg_49_0)
		if var_0_0.YoStarRetCodeHandler(arg_49_0) then
			...
			var_49_1(var_49_0, var_2_10004.LOGOUT, {
				code = 0
			})
		end
	...
	local function var_46_6(arg_50_0)
		...
		if var_0_0.YoStarRetCodeHandler(arg_50_0) then
			...
			var_50_3(var_50_2, var_2_10004.CHARGE_CONFIRM, {
			...
			var_50_6(var_50_5, var_2_10004.CHARGE_FAILED, {
				payId = arg_50_0.EXTRA_DATA
			})
		end
	...
	local function var_46_12(arg_53_0)
		if var_0_0.YoStarRetCodeHandler(arg_53_0) then
			...
			var_53_1(var_53_0, var_2_10004.LOGOUT, {
				code = 0
			})
		end
	...
	if arg_63_0.R_CODE == 0 then
		...
		if var_0_0.QueryErrorMsg(var_1) then
			...
			if var_1_10004.len(var_3) > 0 then
				...
				local var_63_1 = var_1_10004.TipsMgr.GetInstance()

				var_1_10004.ShowTips(var_63_1, var_3)
		...
		local var_63_2 = var_1_10004.TipsMgr.GetInstance()
