...
function var_0_0.AiriBuy(arg_12_0, arg_12_1, arg_12_2)
	...
	if arg_12_1 == "audit" then
		...
		var_12_2(var_12_1, var_12_3, var_1_10007.BuyServerTag.audit, arg_12_2)
	elseif arg_12_1 == "preAudit" then
		...
		var_12_5(var_12_4, var_12_6, var_1_10007.BuyServerTag.preAudit, arg_12_2)
	elseif arg_12_1 == "production" then
		...
		var_12_8(var_12_7, var_12_9, var_1_10007.BuyServerTag.production, arg_12_2)
	elseif arg_12_1 == "test" then
		...
		var_12_11(var_12_10, var_12_12, var_1_10007.BuyServerTag.test, arg_12_2)
	end
...
function var_0_0.LinkSocial(arg_13_0, arg_13_1, arg_13_2)
	...
	if arg_13_0 == var_13_1 then
		...
		var_13_1(var_13_0, var_1_10006.LoginPlatform.FACEBOOK)
	else
		...
		if arg_13_0 == var_13_1 then
			...
			var_13_1(var_13_2, var_1_10006.LoginPlatform.TWITTER)
		else
			...
			if arg_13_0 == var_13_1 then
				...
				var_13_1(var_13_3, var_1_10006.LoginPlatform.YOSTAR, arg_13_1, arg_13_2)
			else
				...
				if arg_13_0 == var_13_1 then
					...
					var_13_1(var_13_4, var_1_10006.LoginPlatform.APPLE)
				else
					...
					if arg_13_0 == var_13_1 then
						...
						var_13_6(var_13_5, var_1_10006.LoginPlatform.AMAZON)
					end
				end
			end
		end
...
function var_0_0.UnlinkSocial(arg_14_0)
	...
	if arg_14_0 == var_14_1 then
		...
		var_14_1(var_14_0, var_1_10004.LoginPlatform.FACEBOOK)
	else
		...
		if arg_14_0 == var_14_1 then
			...
			var_14_1(var_14_2, var_1_10004.LoginPlatform.TWITTER)
		else
			...
			if arg_14_0 == var_14_1 then
				...
				var_14_1(var_14_3, var_1_10004.LoginPlatform.APPLE)
			else
				...
				if arg_14_0 == var_14_1 then
					...
					var_14_1(var_14_4, var_1_10004.LoginPlatform.AMAZON)
				else
					...
					if arg_14_0 == var_14_1 then
						...
						var_14_6(var_14_5, var_1_10004.LoginPlatform.GOOGLEPLAY)
					end
				end
			end
		end
...
function var_0_0.IsSocialLink(arg_15_0)
	...
	if arg_15_0 == var_15_1 then
		...
		return var_15_1(var_15_0, var_1_10004.LoginPlatform.FACEBOOK)
	else
		...
		if arg_15_0 == var_15_1 then
			...
			return var_15_1(var_15_2, var_1_10004.LoginPlatform.TWITTER)
		else
			...
			if arg_15_0 == var_15_1 then
				...
				return var_15_1(var_15_3, var_1_10004.LoginPlatform.YOSTAR)
			else
				...
				if arg_15_0 == var_15_1 then
					...
					return var_15_1(var_15_4, var_1_10004.LoginPlatform.APPLE)
				else
					...
					if arg_15_0 == var_15_1 then
						...
						return var_15_1(var_15_5, var_1_10004.LoginPlatform.AMAZON)
					else
						...
						if arg_15_0 == var_15_1 then
							...
							return var_15_7(var_15_6, var_1_10004.LoginPlatform.GOOGLEPLAY)
						end
					end
				end
			end
...
function var_0_0.ShowSurvey(arg_30_0, arg_30_1)
	if var_0_0.GetIsPlatform() then
		...
		var_30_3(var_30_2, var_30_4, var_1_10008(var_30_1.id), arg_30_1)
	end
...
local function var_0_22(arg_43_0)
	...
	local var_43_2 = var_1_10004.GO_SCENE

	SCENE = var_1_10005

	var_43_1(var_43_0, var_43_2, var_1_10005.LOGIN, {
...
local function var_0_24(arg_44_0)
	...
	local function var_44_1()
		...
		PLATFORM_YOSTARJP = var_2_10003
		var_45_1.arg1 = var_2_10003
		...
		local var_45_3 = var_2_10001.m02
		local var_45_4 = var_1.sendNotification

		GAME = var_2_10004

		var_45_4(var_45_3, var_2_10004.PLATFORM_LOGIN_DONE, {
			user = var_45_2
		})
	...
	if var_0_0.AiriResultCodeHandler(arg_44_0.R_CODE) then
		...
		if var_4.ToInt(var_44_2) == 9 then
			...
			local var_44_3 = var_44_4.TimeMgr.GetInstance()

			var_44_4 = var_44_4.GetServerTime(var_44_3)
			tonumber = var_44_2
			string = var_1_10008

			local var_44_5 = var_1_10008.sub
			local var_44_6 = arg_44_0.R_DELETETIME
			local var_44_7 = 1

			string = var_1_10012

			if var_44_4 < var_44_2(var_44_5(var_44_6, var_44_7, var_1_10012.len(arg_44_0.R_DELETETIME) - 3)) then
				pg = var_44_3

				local var_44_8 = var_44_3.TimeMgr.GetInstance()
				local var_44_9 = var_7.CTimeDescC(var_44_8, var_6, "%Y-%m-%d %H:%M:%S")

				pg = var_8

				local var_44_10 = var_8.MsgboxMgr.GetInstance()
				local var_44_11 = var_8.ShowMsgBox
				local var_44_12 = {
					modal = true
				}

				i18n = var_12
				var_44_12.content = var_12("box_account_reborn_content", var_44_9)

				function var_44_12.onYes()
					var_0_0.AccountReborn()

					return
				end

				var_44_11(var_44_10, var_44_12)
			end
		else
			originalPrint = var_44_4

			var_44_4("AiriLogin failed")
		end
	end
...
local function var_0_26(arg_48_0)
	...
	if var_0_0.AiriResultCodeHandler(arg_48_0.R_CODE) then
		...
		var_48_2(var_48_1, var_1_10004.ON_GET_TRANSCODE, {
...
local function var_0_28(arg_49_0)
	...
	if var_0_0.AiriResultCodeHandler(arg_49_0.R_CODE) then
		...
		var_49_3(var_49_2, var_1_10004.CHARGE_CONFIRM, {
		...
		var_49_6(var_49_5, var_1_10004.CHARGE_FAILED, {
			payId = arg_49_0.EXTRADATA
		})
	end
...
local function var_0_30(arg_50_0)
	...
	if var_0_0.AiriResultCodeHandler(arg_50_0.R_CODE) then
		...
		var_50_2(var_50_1, var_1_10004("set_birth_success"))
	end
...
local function var_0_32(arg_51_0)
	...
	if var_0_0.AiriResultCodeHandler(arg_51_0.R_CODE) then
		...
		var_51_1(var_51_0, var_1_10004.ON_SOCIAL_LINKED)
	end
...
local function var_0_34(arg_52_0)
	...
	if var_0_0.AiriResultCodeHandler(arg_52_0.R_CODE) then
		...
		var_52_1(var_52_0, var_1_10004.ON_SOCIAL_UNLINKED)
...
local function var_0_36(arg_53_0)
	...
	if var_0_0.AiriResultCodeHandler(arg_53_0.R_CODE) then
		...
		i18n = var_1_10005
		var_53_3.content = var_1_10005("verification_code_req_tip2")
...
local function var_0_40(arg_55_0, arg_55_1, arg_55_2, arg_55_3, arg_55_4)
	...
	if var_0_0.AiriResultCodeHandler(var_55_1) then
		...
		local var_55_2 = var_8.sub
		local var_55_3 = arg_55_3
		local var_55_4 = 1

		string = var_1_10012

		local var_55_5 = var_6(var_55_2(var_55_3, var_55_4, var_1_10012.len(arg_55_3) - 3))

		pg = var_55_0

		local var_55_6 = var_55_0.TimeMgr.GetInstance()
		local var_55_7 = var_7.CTimeDescC(var_55_6, var_55_5, "%Y-%m-%d %H:%M:%S")

		pg = var_8

		local var_55_8 = var_8.MsgboxMgr.GetInstance()
		...
		i18n = var_12
		var_55_10.content = var_12("box_account_del_success_content", var_55_7)
		...
		function var_55_10.onYes()
			...
			var_57_1(var_57_0, var_2_10003.LOGOUT, {
				code = 0
			})
		...
		function var_55_10.onClose()
			...
			var_58_1(var_58_0, var_2_10003.LOGOUT, {
				code = 0
			})
...
local function var_0_42(arg_59_0, arg_59_1)
	...
	if var_0_0.AiriResultCodeHandler(var_59_1) then
		...
		var_59_3(var_59_2, var_1_10006("tip_account_del_reborn"))
	end
...
local function var_0_44(arg_61_0, arg_61_1)
	...
	if var_0_0.AiriResultCodeHandler(var_61_0) then
		...
		var_61_2(var_61_1, var_1_10006("new_airi_error_code_0"))
	end
...
function var_0_0.AiriResultCodeHandler(arg_64_0)
	...
	if var_64_0 == 0 then
		...
		if var_64_4(var_64_3, var_64_5, var_1_10008.LanguageType.MSG_JP) then
			string = var_1_10005
			...
			if 0 < var_1_10005 then
				...
				local var_64_6 = var_1_10005.TipsMgr.GetInstance()

				var_1_10005.ShowTips(var_64_6, var_4)
		...
		local var_64_7 = var_1_10005("new_airi_error_code_" .. var_64_0)

		string = var_64_3

		local var_64_9

		if var_64_3.find(var_64_7, "UndefinedLanguage") then
			pg = var_64_9
			...
			var_64_9(var_64_8, var_9("new_airi_error_code_other") .. var_64_1)
		else
			pg = var_64_9
...
function var_0_0.AiriPGSResultCodeHandler(arg_65_0, arg_65_1)
	...
	local var_65_1 = "AiriPGSResultCodeHandler"

	tostring = var_1_10006

	var_1_10003(var_65_1, var_1_10006(var_65_0))

	if var_65_0 == 100201 then
		pg = var_1_10003

		local var_65_2 = var_1_10003.MsgboxMgr.GetInstance()
		...
		i18n = var_1_10007
		var_65_3.content = var_1_10007("pgs_login_binding_exist2")

		function var_65_3.onYes()
			var_0_0.ConfirmLinkGooglePlayGame()

			return
		end

		var_1_10003(var_65_2, var_65_3)

		return true
	elseif var_65_0 == 100202 then
		pg = var_1_10003

		local var_65_4 = var_1_10003.MsgboxMgr.GetInstance()
		...
		i18n = var_1_10007
		var_65_5.content = var_1_10007("pgs_login_binding_exist1")

		function var_65_5.onYes()
			var_0_0.ConfirmLinkGooglePlayGame()

			return
		end

		var_1_10003(var_65_4, var_65_5)

		return true
	elseif var_65_0 == 100203 then
		pg = var_1_10003

		local var_65_6 = var_1_10003.MsgboxMgr.GetInstance()
		...
		i18n = var_1_10007
		var_65_7.content = var_1_10007("pgs_login_binding_exist3")
	...
	elseif var_65_0 == 100206 then
		...
		local var_65_8 = var_1_10003.MsgboxMgr.GetInstance()
		...
		i18n = var_1_10007
		var_65_9.content = var_1_10007("pgs_login_tip")

		function var_65_9.onYes()
			pg = var_2_10000
			...
			var_69_1(var_69_0, var_2_10003.ON_SOCIAL_LINKED)

			return
		end

		function var_65_9.onClose()
			pg = var_2_10000
			...
			var_70_1(var_70_0, var_2_10003.ON_SOCIAL_LINKED)

			return
		end

		var_1_10003(var_65_8, var_65_9)

		return true
	elseif var_65_0 == 100214 then
		pg = var_1_10003

		local var_65_10 = var_1_10003.MsgboxMgr.GetInstance()
		local var_65_11 = var_3.ShowMsgBox
		local var_65_12 = {}

		i18n = var_1_10007
		var_65_12.content = var_1_10007("pgs_unbind_tip2")

		function var_65_12.onYes()
			var_0_0.ConfirmUnLinkGooglePlayGame()

			return
		end

		var_65_11(var_65_10, var_65_12)
...
function var_0_0.AiriYoStarPassMigrateHandler(arg_72_0)
	...
	if var_72_1(var_72_2, var_5.ToInt(var_72_3)) and arg_72_0.SHOW_MIGRATE_PAGE == 1 then
