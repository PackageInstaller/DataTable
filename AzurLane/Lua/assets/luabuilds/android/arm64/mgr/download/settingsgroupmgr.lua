...
function pg.SettingsGroupMgr.GetState(arg_5_0, arg_5_1)
	if arg_5_0.infoDict[arg_5_1] == nil then
		return var_0_0.State.None
	else
		return arg_5_0.infoDict[arg_5_1].state
	end

	return
end

function pg.SettingsGroupMgr.GetCountProgress(arg_6_0, arg_6_1)
	if arg_6_0.infoDict[arg_6_1] == nil then
		return 0, 0
	else
		return arg_6_0.infoDict[arg_6_1].curCount, arg_6_0.infoDict[arg_6_1].totalCount
	end
...
function pg.SettingsGroupMgr.beforeStart(arg_8_0, arg_8_1)
	local var_8_0 = arg_8_0.infoDict[arg_8_1]

	if arg_8_0.infoDict[arg_8_1] == nil then
		var_8_0 = {}
		arg_8_0.infoDict[arg_8_1] = {}
	end
...
function pg.SettingsGroupMgr.onProgress(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	local var_9_0 = arg_9_0.infoDict[arg_9_1]

	if arg_9_0.infoDict[arg_9_1] == nil then
		var_9_0 = {}
		arg_9_0.infoDict[arg_9_1] = {}
	end
...
function pg.SettingsGroupMgr.onFinish(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	local var_10_0 = arg_10_0.infoDict[arg_10_1]

	if arg_10_0.infoDict[arg_10_1] == nil then
		var_10_0 = {}
		arg_10_0.infoDict[arg_10_1] = {}
	end
