...
function pg.ConnectionMgr.Connect(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
...
function pg.ConnectionMgr.ConnectByProxy(arg_3_0)
...
function pg.ConnectionMgr.ConnectByDomain(arg_4_0, arg_4_1, arg_4_2)
	arg_4_0:Connect(LuaHelper.getHostByDomain(arg_4_1), DEFAULT_PORT, arg_4_2)

	return
end

function pg.ConnectionMgr.Reconnect(arg_5_0, arg_5_1)
	...
	arg_5_0:Connect(arg_5_0:GetLastHost(), arg_5_0:GetLastPort(), function()
		...
		local var_6_1 = getProxy(UserProxy):getData()
		...
		var_6_4.device_id = var_0_0.SdkMgr.GetInstance():GetDeviceId()

		var_6_3(var_0_4, 10022, var_6_4, 10023, function(arg_7_0)
...
function pg.ConnectionMgr.onData(arg_10_0)
...
function pg.ConnectionMgr.Disconnect(arg_20_0)
...
function pg.ConnectionMgr.resetHBTimer(arg_25_0)
