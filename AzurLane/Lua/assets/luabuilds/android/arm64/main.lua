...
typeof = var_3
var_0_21.skinWeights = var_0_22(var_3("UnityEngine.SkinWeights"), "Unlimited", nil)
tf = var_0_21
GameObject = var_2

local var_0_23 = var_0_21(var_2.Find("EventSystem"))
local var_0_24 = var_0.GetComponent

typeof = var_3
EventSystem = var_5

local var_0_25 = var_0_24(var_0_23, var_3(var_5))
...
if var_0_25 then
	function var_0_25()
		...
		local var_2_2 = var_2_1(var_2, 0.5, -1, 1)
	...
	if not (var_0_25 < 48) then
		...
		if var_0_25 == var_1 then
			...
			if var_0_25 == 8 then
				...
				local var_0_26 = var_0_25.SdkMgr.GetInstance()
		...
		local var_0_30 = var_3.Inst.timestamp

		VersionMgr = var_4

		local var_0_31 = var_4.Inst.monday0oclockTimestamp

		VersionMgr = var_5

		var_0_29(var_0_28, var_0_30, var_0_31, var_5.Inst.realStartUpTimeWhenSetServerTime)
		...
		local function var_0_33(arg_3_0)
			...
			var_1_10001(var_3_0 .. var_1_10004(arg_3_0))
			...
			if arg_3_0 then
				...
				var_3_2(var_3_1, var_4.PAUSE_BATTLE)
			...
			var_3_7(var_3_6, var_4.ON_APPLICATION_PAUSE, arg_3_0)
		...
		local function var_0_35()
			...
			if var_0.Battle.BattleState.GetInstance() and var_0:GetState() == var_0.BATTLE_STATE_FIGHT and not var_0:IsPause() then
				...
				local var_4_6 = var_1_10001.m02

				var_1_10001 = var_1_10001.sendNotification
				GAME = var_1_10004

				var_1_10001(var_4_6, var_1_10004.PAUSE_BATTLE)
			...
			if not var_1_10001.UIMgr.GetInstance()._loadPanel or var_1:LoadingRetainCount() ~= 0 then
				return
			end
			...
			if var_3.MsgboxMgr.GetInstance() then
				...
				var_1_10006 = var_3
				var_4_8 = var_3.getMsgBoxOb(var_1_10006)
			end

			pg = var_4_7

			if var_4_7.NewStoryMgr.GetInstance() and var_5:IsRunning() then
				if var_4_8 and var_4_8.activeSelf then
					...
					var_1_10006(var_4_9, var_1_10009)
			...
			if not var_4_11(var_4_10, var_1_10010.__cname) then
				return
			end

			if not var_7:getCurrentContext() then
				return
			end

			pg = var_4_10

			if var_4_10.ShareMgr.GetInstance().go then
				isActive = var_10

				if var_10(var_9.go) then
					pg = var_10

					local var_4_12 = var_10.CriMgr.GetInstance()
					local var_4_13 = var_10.PlaySoundEffect_V3

					SFX_CANCEL = var_1_10013

					var_4_13(var_4_12, var_1_10013)

					triggerButton = var_4_13

					local var_4_14 = var_9.panel

					var_4_13(var_12.Find(var_4_14, "main/top/btnBack"))

					return
				end
			end

			local var_4_15 = var_8:retriveLastChild()

			if not var_6:retrieveMediator(var_4_15.mediator.__cname) or not var_10.viewComponent then
				return
			end

			local var_4_16 = var_10.viewComponent._tf.parent
			local var_4_17 = var_11._tf
			local var_4_18 = var_13.GetSiblingIndex(var_4_17)
			local var_4_19 = -1
			local var_4_20

			if var_4_8 and var_4_8.activeSelf then
				var_4_20 = var_4_8.transform.parent

				local var_4_21 = var_4_8.transform

				var_4_19 = var_1_10016.GetSiblingIndex(var_4_21)
			end

			pg = var_1_10016

			local var_4_22 = var_1_10016.playerResUI

			if var_16.checkBackPressed(var_4_22) then
				return
			end

			if var_4_16 == var_4_20 and var_4_19 < var_4_18 then
				var_4_22 = var_11

				var_11.onBackPressed(var_4_22)
			...
			if var_4_8 and var_4_8.activeSelf then
				pg = var_4_23
				var_4_22 = var_4_23.CriMgr.GetInstance()
				var_4_23 = var_4_23.PlaySoundEffect_V3
				SFX_CANCEL = var_1_10019

				var_4_23(var_4_22, var_1_10019)

				triggerButton = var_4_23

				var_4_23(var_3._closeBtn)
			...
			if var_4_23(var_4_22.NewStyleMsgboxMgr.GetInstance(), {
				"_tf"
			}) then
				isActive = var_1_10017

				if var_1_10017(var_16) then
					pg = var_1_10017

					local var_4_24 = var_1_10017.NewStyleMsgboxMgr.GetInstance()

					var_1_10017.Hide(var_4_24)

					return
				end
			end

			nowWorld = var_1_10017

			if var_1_10017() then
				local var_4_25 = var_17.staminaMgr

				if var_18.IsShowing(var_4_25) then
					local var_4_26 = var_17.staminaMgr

					var_18.Hide(var_4_26)
		...
		local function var_0_39()
			...
			if not var_1_10000(var_1_10002.MsgboxMgr.GetInstance()._go) then
				pg = var_0
				...
				i18n = var_1_10004
				var_6_2.content = var_1_10004("confirm_app_exit")
		...
		local function var_0_42(arg_9_0)
			...
			var_3.HybridCLRTool.HybridCLRHelper.LoadPatchDLL(var_9_0, var_9_1)
		...
		var_5({
			...
			var_1(var_46_1 .. var_1_10004.clock() - var_0_45)
			...
			if not var_1_10002(var_46_3) then
				Object = var_2
			...
			pg = var_2
			pm = var_3
			var_2.m02 = var_3.Facade.getInstance("m02")
			pg = var_2
			...
			local var_46_9 = var_5.STARTUP

			StartupCommand = var_1_10006

			var_46_8(var_46_7, var_46_9, var_1_10006)
			...
			pg = var_46_11
			PlayerResUI = var_3
			var_46_11.playerResUI = var_3.New()
			pg = var_46_11
			...
			var_2.AddDebugButton(var_46_13, "Device Info", function()
				...
				SystemInfo = var_2_10003

				var_2_10000(var_47_0 .. var_2_10003.graphicsDeviceVendorID)
				...
				var_0(var_47_1 .. var_3.processorCount)
				...
				var_0(var_47_2 .. var_3.graphicsMemorySize)
				...
				var_0(var_47_3 .. var_3.systemMemorySize)
				...
				var_0(var_47_4 .. var_3.processorFrequency)
