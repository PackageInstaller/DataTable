		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_1_0)
					...
					local var_1_1 = var_1_10004.sin(var_1_0) * 2
					local var_1_2 = 0.75

					math = var_6

					return var_1_10002(var_1_1, var_1_2, var_6.cos(var_1_0) * 2)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_3_0)
					...
					local var_3_1 = var_1_10004.sin(var_3_0) * 2
					local var_3_2 = 0.75

					math = var_6

					return var_1_10002(var_3_1, var_3_2, var_6.cos(var_3_0) * 2)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_5_0)
					...
					local var_5_1 = var_1_10004.sin(var_5_0) * 2
					local var_5_2 = 0.75

					math = var_6

					return var_1_10002(var_5_1, var_5_2, var_6.cos(var_5_0) * 2)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_7_0)
					...
					local var_7_1 = var_1_10004.sin(var_7_0) * 2
					local var_7_2 = 0.75

					math = var_6

					return var_1_10002(var_7_1, var_7_2, var_6.cos(var_7_0) * 2)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_9_0)
					...
					local var_9_1 = var_1_10004.sin(var_9_0) * 2
					local var_9_2 = 0.75

					math = var_6

					return var_1_10002(var_9_1, var_9_2, var_6.cos(var_9_0) * 2)
				end,
