		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_3_0)
					return Vector3(math.sin(arg_3_0 * 3 + 1.256) * 5, 0.75, math.cos(arg_3_0 * 3 + 1.256) * 5)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_5_0)
					return Vector3(math.sin(arg_5_0 * 3 + 2.512) * 5, 0.75, math.cos(arg_5_0 * 3 + 2.512) * 5)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_7_0)
					return Vector3(math.sin(arg_7_0 * 3 - 1.256) * 5, 0.75, math.cos(arg_7_0 * 3 - 1.256) * 5)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_9_0)
					return Vector3(math.sin(arg_9_0 * 3 - 2.512) * 5, 0.75, math.cos(arg_9_0 * 3 - 2.512) * 5)
				end,
