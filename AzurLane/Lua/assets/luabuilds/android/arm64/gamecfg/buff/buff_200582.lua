	...
	effect_list = {
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_2_0)
					...
					return var_1_10001(var_2_0, arg_2_0 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST - 90 + 10, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_4_0)
					...
					return var_1_10001(var_4_0, arg_4_0 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST - 18 + 10, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_6_0)
					...
					return var_1_10001(var_6_0, arg_6_0 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 54 + 10, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_8_0)
					...
					return var_1_10001(var_8_0, arg_8_0 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST - 162 + 10, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_10_0)
					...
					return var_1_10001(var_10_0, arg_10_0 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 126 + 10, 0)
				end
			}
		}
	}
