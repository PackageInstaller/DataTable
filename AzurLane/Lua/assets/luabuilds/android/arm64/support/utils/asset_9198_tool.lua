...
function var_0.Tool.Distances(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	local var_7_11 = var_1_10012.sqrt

	math = var_1_10014

	local var_7_12 = var_1_10014.pow

	math = var_1_10016

	local var_7_13 = var_7_12(var_1_10016.sin(var_7_8 / 2), 2)

	math = var_1_10015

	local var_7_14 = var_1_10015.cos(var_7_1)

	math = var_16

	local var_7_15 = var_7_14 * var_16.cos(var_7_3)

	math = var_16

	local var_7_16 = var_16.pow

	math = var_18

	return 2 * var_7_10(var_7_11(var_7_13 + var_7_15 * var_7_16(var_18.sin(var_7_9 / 2), 2))) * 6378.137
end
