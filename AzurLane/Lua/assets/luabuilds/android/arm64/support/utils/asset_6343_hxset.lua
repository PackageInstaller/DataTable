...
function var_0.init()
	...
	for iter_1_0, iter_1_1 in var_1_10000(var_1_10002.name_code.all) do
		pg = var_1_10005
...
function var_0.calcLocalizationUse()
	...
	if var_1_10000 == var_1_10001 then
		...
		if var_0.codeMode and not var_2_1:IsSameDay(var_2_5, var_2_1:GetServerTime()) then
			pg = var_5

			local var_2_6 = var_5.m02
			local var_2_7 = var_5.sendNotification

			GAME = var_8

			local var_2_8 = var_8.CHEATER_MARK
			local var_2_9 = {}

			CC_TYPE_99 = var_1_10010
			var_2_9.reason = var_1_10010

			var_2_7(var_2_6, var_2_8, var_2_9)

			PlayerPrefs = var_2_7

			var_2_7.SetInt(var_2_4, var_2_1:GetServerTime())
		end

		local var_2_10 = "localization_time_2_" .. var_2_3

		PlayerPrefs = var_6

		local var_2_11 = var_6.GetInt(var_2_10, 0)

		if var_0.antiSkinMode and not var_2_1:IsSameDay(var_2_11, var_2_1:GetServerTime()) then
			pg = var_7

			local var_2_12 = var_7.m02
			local var_2_13 = var_7.sendNotification

			GAME = var_10

			local var_2_14 = var_10.CHEATER_MARK
			local var_2_15 = {}

			CC_TYPE_100 = var_1_10012
			var_2_15.reason = var_1_10012

			var_2_13(var_2_12, var_2_14, var_2_15)

			PlayerPrefs = var_2_13

			var_2_13.SetInt(var_2_10, var_2_1:GetServerTime())
		end
	end
...
function var_0.update()
	...
	var_5.fleet_tech_ship_class = var_1_10006({}, {
	...
	if var_0.isHx() then
		...
		if var_3.find(arg_20_0, "live2d") then
			...
			if arg_20_2 then
				...
				if var_1_10004.l2dhx[var_20_0] then
					return arg_20_0 .. "_hx"
				end
			else
				...
				if var_20_0(arg_20_0 .. "_hx") then
					...
					if var_1_10004.l2dhx[var_20_1] then
						return arg_20_0 .. "_hx"
					end
				end
			end
