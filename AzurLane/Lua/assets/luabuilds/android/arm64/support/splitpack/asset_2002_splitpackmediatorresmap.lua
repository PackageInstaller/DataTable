...
function var_0_1.GetUIPreloadList(arg_2_0)
	...
	return (var_1_10003.map(var_2_1, function(arg_3_0)
		return "ui/" .. arg_3_0
	end))
end
...
function var_0_1.LogicMap.BattleScene(arg_10_0)
	...
	if var_10_6 == var_1_10009 then
		checkExist = var_10_6
		pg = var_1_10010

		local var_10_7

		if not var_10_6(var_1_10010.world_expedition_data[var_10_3.stageId], {
			"bgm"
		}) then
			var_10_7 = ""
		end
...
function var_0_1.LogicMap.NewPlayerScene(arg_11_0)
	...
	var_1_10007.each(var_11_5, function(arg_12_0)
		...
		var_2_10002.each(var_12_0.buff_list_display, function(arg_13_0)
			...
			var_3_10002.insert(var_11_3, "skillicon/" .. var_13_0.icon)
		...
		var_4.insert(var_11_4, "char/" .. var_12_2)
...
function var_0_1.LogicMap.SkillInfoLayer(arg_14_0)
	...
	var_1_10007.insert(var_14_2, "skillicon/" .. var_14_4.icon)
