...
function pg.IPAddress.Ctor(arg_1_0)
	arg_1_0:ConvertIPRange()

	arg_1_0.requestUrl = var_0_0
...
function pg.IPAddress.ConvertIPRange(arg_5_0)
...
function pg.IPAddress.CheckExportIP(arg_6_0)
...
function pg.IPAddress.GetExportIPString(arg_7_0)
	return arg_7_0.exportIP
end

function pg.IPAddress.GetLocalIP(arg_8_0)
	arg_8_0.localIP = ReflectionHelp.RefGetProperty(typeof("UnityEngine.NetworkPlayer"), "ipAddress", (ReflectionHelp.RefGetProperty(typeof("UnityEngine.Network"), "player")))

	return arg_8_0.localIP
end

function pg.IPAddress.IsSpecialIP(arg_9_0)
