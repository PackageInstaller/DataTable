...
local function var_0_18(arg_4_0)
	...
	PERMISSION_GRANTED = var_1_10004

	var_4_1(var_4_0, var_1_10004, arg_4_0)
...
local function var_0_20(arg_5_0)
	...
	PERMISSION_NEVER_REMIND = var_1_10004

	var_5_1(var_5_0, var_1_10004, arg_5_0)
...
local function var_0_22(arg_6_0)
	...
	PERMISSION_REJECT = var_1_10004

	var_6_1(var_6_0, var_1_10004, arg_6_0)
...
local function var_0_28(arg_7_0)
	if arg_7_0 == "true" then
		...
		IOS_AV_AUTH_GRANTED = var_1_10004

		var_1_10001(var_7_0, var_1_10004)
	elseif arg_7_0 == "false" then
		...
		IOS_AV_AUTH_REJECTED = var_1_10004

		var_7_2(var_7_1, var_1_10004)
	end
...
local function var_0_30()
	...
	if var_8_1 == var_1_10001 then
		CheckPermissionGranted = var_1_10001
		ANDROID_CAMERA_PERMISSION = var_1_10003

		return var_1_10001(var_1_10003)
	else
		...
		if var_8_1 == var_1_10001 then
			...
			local var_8_2 = var_1_10001.Inst
...
local function var_0_32()
	...
	if var_9_1 == var_1_10001 then
		pg = var_1_10001

		local var_9_2 = var_1_10001.MsgboxMgr.GetInstance()

		var_1_10001 = var_1_10001.ShowMsgBox

		local var_9_3 = {}

		i18n = var_1_10005
		var_9_3.content = var_1_10005("apply_permission_camera_tip1")
		...
		function var_9_3.onYes()
			...
			ANDROID_CAMERA_PERMISSION = var_2_10003
			var_10_0[1] = var_2_10003
		...
		if var_9_1 == var_1_10001 then
			...
			local var_9_4 = var_1_10001.Inst
