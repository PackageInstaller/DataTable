...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.comDirector = var_1_1(var_1_0, var_1_10006(var_1_10008.Playables.PlayableDirector))
	GetComponent = var_3
	...
	if var_3(var_1_2, var_6(var_8)) then
		arg_1_0:SetSpeed(1)
	else
	...
	if not arg_1_2 then
		...
		var_1_10004 = var_1_10004.RefGetField
		typeof = var_6
		var_1_10004 = var_1_10004(var_6("UnityEngine.Playables.DirectorWrapMode"), "Hold", nil)
	end

	var_1_6.extrapolationMode = var_1_10004
