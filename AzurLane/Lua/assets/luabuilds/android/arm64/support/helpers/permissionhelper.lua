	...
	if var_0.IsAndroid() or var_0.IsIOS() then
		...
		if var_0.IsAndroid() then
			...
			if var_3.OtherTool.GetAndroidBuildVersion() < var_0.Android10SDKLevel then
				...
				YSNormalTool = var_1_10006

				var_3_1(var_3_2, var_1_10006.PermissionTool.Photo)
			end
		end
		...
		var_1_10004.PermissionTool.RequestMultiPermission(var_3_0, var_3_3)
	elseif arg_3_0 then
		arg_3_0()
	end
	...
	if var_0.IsAndroid() or var_0.IsIOS() then
		...
		if var_0.IsAndroid() then
			...
			if var_3.OtherTool.GetAndroidBuildVersion() < var_0.Android10SDKLevel then
				...
				var_6_1(var_6_2, var_1_10006.PermissionTool.Photo)
			end
		end
		...
		var_1_10004.PermissionTool.RequestMultiPermission(var_6_0, var_6_3)
	elseif arg_6_0 then
		arg_6_0()
	end
