...
function var_0_0.POP(arg_7_0, arg_7_1)
	if arg_7_1 then
		...
		if not arg_7_0.GetInedex(var_1_10004, arg_7_1) then
			var_7_0 = 1
		end
		...
		if var_7_0 == arg_7_0.length then
			...
			var_1_10004 = arg_7_0.array
			var_7_1[var_7_0], var_1_10004[arg_7_0.length] = arg_7_0.array[arg_7_0.length], arg_7_0.array[var_7_0]
			var_7_1 = arg_7_0.values
			var_1_10004 = arg_7_0.values
			var_7_1[var_7_0], var_1_10004[arg_7_0.length] = arg_7_0.values[arg_7_0.length], arg_7_0.values[var_7_0]
			arg_7_0.length = arg_7_0.length - 1
		...
		local var_7_3 = var_1_10004.remove(arg_7_0.values)
	end
end
