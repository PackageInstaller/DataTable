	...
	if arg_2_1 then
		...
		var_2_0({
			function(arg_3_0)
				...
				ResourceMgr = var_2_10003

				local var_3_1 = var_2_10003.Inst
				local var_3_2 = var_3_0(var_3.GetAllDependencies(var_3_1, arg_2_0.path))

				parallelAsync = var_2_10002
				underscore = var_2_10004

				var_2_10002(var_2_10004.map(var_3_2, function(arg_4_0)
		...
		if arg_2_2 then
			...
			local var_2_1 = var_6.Inst

			var_2_0 = var_2_0(var_6.GetAllDependencies(var_2_1, arg_2_0.path))
			ipairs = var_1_10005

			for iter_2_0, iter_2_1 in var_1_10005(var_2_0) do
				table = var_1_10010
				var_1_10010 = var_1_10010.insert

				local var_2_2 = arg_2_0.abs

				AssetBundleHelper = var_1_10013

				var_1_10010(var_2_2, var_1_10013.LoadAssetBundle(iter_2_1, arg_2_1, false, nil))
			end
		end
...
function var_1.LoadAssetAsync(arg_10_0, arg_10_1, arg_10_2, arg_10_3, ...)
	...
	return var_10_2(var_10_1, var_10_3, var_10_4, var_10_5, var_1_10010.Events.UnityAction_UnityEngine_Object(arg_10_3), ...)
end
...
function var_1.GetAllAssetNames(arg_11_0)
	...
	return var_11_0(var_3.GetAllAssetNames(var_11_1))
end
