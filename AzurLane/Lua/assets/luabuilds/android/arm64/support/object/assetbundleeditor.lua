...
function var_1.LoadAssetAsync(arg_4_0, arg_4_1, arg_4_2, arg_4_3, ...)
	...
	return var_4_1(var_4_0, var_4_2, var_4_3, var_4_4, var_1_10010.Events.UnityAction_UnityEngine_Object(arg_4_3), ...)
end
...
function var_1.GetAllAssetNames(arg_5_0)
	...
	local var_5_1 = var_1_10003.RefCallMethod

	typeof = var_1_10005
	ResourceMgr = var_1_10007

	local var_5_2 = var_1_10005(var_1_10007)
	local var_5_3 = "GetAssetBundleAllAssetNames"

	ResourceMgr = var_1_10007

	local var_5_4 = var_1_10007.Inst
	local var_5_5 = {}

	typeof = var_1_10009
	var_5_5[1] = var_1_10009("System.String")
