...
function PaintingfilteConst.GetStandardTimeConfig(arg_1_0)
	local var_1_0 = {}
...
function PaintingfilteConst.IsTwoTimeCross(arg_4_0, arg_4_1)
	local var_4_0 = pg.TimeMgr.GetInstance()

	if var_4_0:parseTimeFromConfig(arg_4_0[2]) <= var_4_0:parseTimeFromConfig(arg_4_1[1]) or var_4_0:parseTimeFromConfig(arg_4_1[2]) <= var_4_0:parseTimeFromConfig(arg_4_0[1]) then
		return false
	else
		return true
	end
...
function PaintingfilteConst.IsPoolWeightConfigMatch(arg_11_0, arg_11_1)
...
function PaintingfilteConst.GetActPoolIndexList()
	for iter_13_0, iter_13_1 in ipairs((var_0_0.GetBuildActIDList())) do
		if not table.contains({}, pg.activity_template[iter_13_1].config_id) then
			table.insert({}, pg.activity_template[iter_13_1].config_id)
		end
	end
...
function PaintingfilteConst.GetShipConfigIDListByPoolList(arg_14_0)
	for iter_14_0, iter_14_1 in pairs(pg.ship_data_create) do
		if var_0_0.IsPoolWeightConfigMatch(iter_14_1.weight_group, arg_14_0) and not table.contains({}, iter_14_0) then
			table.insert({}, iter_14_0)
		end
	end
...
function PaintingfilteConst.GetActID2MemoryMap()
	for iter_16_0, iter_16_1 in ipairs(pg.memory_group.all) do
		if pg.memory_group[iter_16_1].link_event and pg.memory_group[iter_16_1].link_event > 0 then
			if not ({})[pg.memory_group[iter_16_1].link_event] then
				({})[pg.memory_group[iter_16_1].link_event] = {}
			end

			for iter_16_2, iter_16_3 in ipairs(pg.memory_group[iter_16_1].memories) do
				if not table.contains(({})[pg.memory_group[iter_16_1].link_event], iter_16_3) then
					table.insert(({})[pg.memory_group[iter_16_1].link_event], iter_16_3)
				end
			end
		end
	end
		...
		for iter_19_2, iter_19_3 in ipairs((var_0_0.GetBuildActIDList())) do
			if pg.ship_data_create_exchange[iter_19_3] then
				for iter_19_4, iter_19_5 in ipairs(pg.ship_data_create_exchange[iter_19_3].exchange_ship_id) do
					if not table.contains({}, iter_19_5) then
						table.insert({}, iter_19_5)
					end
				end
			end
		end
...
function PaintingfilteConst.GetNPCShipConfigIDList()
	for iter_20_0, iter_20_1 in ipairs(getGameset("act_npc_ship_id")[2]) do
		if var_0_0.IsActMatchTime(iter_20_1) then
			table.insert({}, pg.task_data_template[pg.activity_template[iter_20_1].config_data[1]].award_display[1][2])
		end
	end
...
function PaintingfilteConst.GetNormalShopSkinIDList()
	for iter_22_0, iter_22_1 in ipairs(pg.shop_template.get_id_list_by_genre[ShopArgs.SkinShop]) do
		if var_0_0.IsNormalShopMatch(iter_22_1) then
			local var_22_0 = var_0_0.GetSkinIDFromNormalShopID(iter_22_1)

			if not table.contains({}, var_22_0) then
				table.insert({}, var_22_0)
			end

			if ShipSkin.IsChangeSkin(var_22_0) then
				for iter_22_2, iter_22_3 in ipairs((ShipSkin.GetAllChangeSkinIds(var_22_0))) do
					if not table.contains({}, iter_22_3) then
...
function PaintingfilteConst.GetActShopSkinIDList()
	for iter_24_0, iter_24_1 in ipairs(pg.activity_shop_extra.get_id_list_by_commodity_type[DROP_TYPE_SKIN]) do
		if var_0_0.IsActShopMatch(iter_24_1) then
			local var_24_0 = var_0_0.GetSkinIDFromActShopID(iter_24_1)

			if not table.contains({}, var_24_0) then
				table.insert({}, var_24_0)
			end

			if ShipSkin.IsChangeSkin(var_24_0) then
				for iter_24_2, iter_24_3 in ipairs((ShipSkin.GetAllChangeSkinIds(var_24_0))) do
					if not table.contains({}, iter_24_3) then
...
function SpecialFilteForChange()
	...
	if pg.painting_filte_config.current_act_pool == 1 then
		(function(arg_30_0)
			...
			return
		end)((PaintingfilteConst.GetActPoolShipConfigIDList()))
	end
	...
	;(function(arg_30_0)
		...
		return
	end)((PaintingfilteConst.GetConstPoolShipConfigIDList()))
	;(function(arg_30_0)
		for iter_30_0, iter_30_1 in ipairs(arg_30_0) do
			var_0_3(var_29_0, iter_30_1)
		end
		...
		return
	end)((PaintingfilteConst.GetLightPoolBlueDestroyerShipConfigIDList()))
	;(function(arg_30_0)
		for iter_30_0, iter_30_1 in ipairs(arg_30_0) do
			var_0_3(var_29_0, iter_30_1)
		end
		...
		return
	end)((PaintingfilteConst.GetNPCShipConfigIDList()))
	;(function(arg_30_0)
		for iter_30_0, iter_30_1 in ipairs(arg_30_0) do
			var_0_3(var_29_0, iter_30_1)
		end
		...
		return
	end)((PaintingfilteConst.GetCreateExchangeShipConfigIDList()))

	if pg.painting_filte_config.current_sale_skin == 1 then
		local var_29_1 = PaintingfilteConst.GetNormalShopSkinIDList()

		warning("normalShopSkinIDList:" .. #var_29_1)
		;(function(arg_31_0)
		...
		local var_29_2 = PaintingfilteConst.GetActShopSkinIDList()

		warning("actShopSkinIDList:" .. #var_29_2)
		;(function(arg_31_0)
			for iter_31_0, iter_31_1 in ipairs(arg_31_0) do
				var_0_4(var_29_0, iter_31_1)
			end
	...
	for iter_29_0, iter_29_1 in ipairs(pg.secretary_special_ship.all) do
		var_0_1({}, pg.secretary_special_ship[iter_29_1].prefab)
	end
	...
	for iter_36_0, iter_36_1 in ipairs(pg.activity_template.all) do
		if var_36_0[iter_36_1] and PaintingfilteConst.IsActMatchTime(iter_36_1) then
			for iter_36_2, iter_36_3 in ipairs(var_36_0[iter_36_1]) do
				table.insert({}, iter_36_3)
			end
		end
	end

	for iter_36_4, iter_36_5 in ipairs({}) do
		for iter_36_6, iter_36_7 in ipairs(pg.memory_template[iter_36_5].unlock_pre) do
			table.insert({}, iter_36_7)
		end
	end

	return pg.NewStoryMgr.GetInstance():GetStoryPaintingsByNameList({})
end
	...
	for iter_37_0, iter_37_1 in ipairs(pg.activity_template.all) do
		if PaintingfilteConst.IsActMatchTime(iter_37_1) and pg.activity_template[iter_37_1].config_client and type(pg.activity_template[iter_37_1].config_client) == "table" and pg.activity_template[iter_37_1].config_client.painting then
			if type(pg.activity_template[iter_37_1].config_client.painting) == "string" then
				table.insert({}, pg.activity_template[iter_37_1].config_client.painting)
			end
