...
;(function()
	pg.base.child2_site_display[1] = {
		...
		type = 3,
		banner = "map_event_166",
		bg = "",
		title = "生活体验",
		desc = "可以消耗行动力获得金钱",
		event_title = "site_work_name",
		character = 1,
		id = 1,
		icon = "",
		position = {
	...
	pg.base.child2_site_display[3] = {
		...
		type = 2,
		banner = "site_travel_1",
		bg = "",
		title = "商店",
		desc = "商店",
		event_title = "site_shop_name",
		character = 1,
		id = 3,
		icon = "",
		position = {
	...
	pg.base.child2_site_display[6] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "独角兽正站在树下，低着头似乎在思考着什么。\n\n（独角兽的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 6,
		icon = "dujiaoshou",
	...
	pg.base.child2_site_display[10] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "海天坐在公园的长椅上，手拿纸笔，时而凝望飘落的花瓣，时而写下几笔。\n\n（海天的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 10,
		icon = "haitian",
	...
	pg.base.child2_site_display[14] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "安克雷奇正坐在地上，认真地摆弄着一堆彩色卡纸，时不时露出开心的笑容。\n\n（安克雷奇的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 14,
		icon = "ankeleiqi",
	...
	pg.base.child2_site_display[18] = {
		...
		bg = "red",
		title = "拜访",
		desc = "{namecode:491}正坐在咖啡店里，一边吃着精致的甜点一边刷着手机，时不时露出狡黠的笑容。\n\n（{namecode:491}的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 18,
		icon = "yade",
	...
	pg.base.child2_site_display[19] = {
		...
		bg = "red",
		title = "拜访",
		desc = "遇到{namecode:491}的时候，她正靠在树下认真看书，要去聊聊吗？\n\n（{namecode:491}的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 19,
		icon = "yade",
	...
	pg.base.child2_site_display[20] = {
		...
		bg = "red",
		title = "拜访",
		desc = "{namecode:491}正在研究什么有趣的事情，看起来心情不错的样子，要去聊聊吗？\n\n（{namecode:491}的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 20,
		icon = "yade",
	...
	pg.base.child2_site_display[22] = {
		...
		bg = "red",
		title = "拜访",
		desc = "在小镇的围墙边，凶猛正专注地用喷漆在墙上创作着她的“艺术”。\n\n（凶猛的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 22,
		icon = "xiongmeng",
	...
	pg.base.child2_site_display[23] = {
		...
		bg = "red",
		title = "拜访",
		desc = "凶猛正站在她完成的涂鸦墙前，一边吃着零食一边得意地欣赏自己的作品。\n\n（凶猛的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 23,
		icon = "xiongmeng",
	...
	pg.base.child2_site_display[26] = {
		...
		bg = "red",
		title = "拜访",
		desc = "{namecode:439}正在美食街提供的烘焙厨房里专注地调配着什么，时不时露出意味深长的微笑。\n\n（{namecode:439}的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 26,
		icon = "luoen",
	...
	pg.base.child2_site_display[27] = {
		...
		bg = "red",
		title = "拜访",
		desc = "{namecode:439}正在农场里喂食小动物，脸上带着令人捉摸不透的微笑。\n\n（{namecode:439}的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 27,
		icon = "luoen",
	...
	pg.base.child2_site_display[28] = {
		...
		bg = "red",
		title = "拜访",
		desc = "{namecode:439}正在修剪花园里的玫瑰，脸上挂着温柔的笑容。\n\n（{namecode:439}的某些特质似乎可以影响娜比娅的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 1,
		id = 28,
		icon = "luoen",
	...
	pg.base.child2_site_display[4140] = {
		...
		event_icon = "site_ending",
		type = 5,
		banner = "map_event_604",
		bg = "",
		title = "随机事件",
		desc = "娜比娅的脚步在电影院门前不由自主地停了下来……",
		event_title = "site_event_name",
		character = 1,
		id = 4140,
		icon = "",
	...
	pg.base.child2_site_display[4141] = {
		...
		event_icon = "site_ending",
		type = 5,
		banner = "map_event_118",
		bg = "",
		title = "随机事件",
		desc = "废弃园区里，一片空旷的水泥场地诉说着往日的喧嚣……",
		event_title = "site_event_name",
		character = 1,
		id = 4141,
		icon = "",
	...
	pg.base.child2_site_display[4143] = {
		...
		bg = "",
		title = "随机事件",
		desc = "书店的心理学区一如既往地安静，书架上一排排书籍仿佛在等待着有缘人的翻阅……",
		event_title = "site_event_name",
		character = 1,
		id = 4143,
		icon = "",
	...
	pg.base.child2_site_display[4144] = {
		...
		bg = "",
		title = "随机事件",
		desc = "夕阳为公园镀上一层温暖的橘色，长椅静静地见证着生命中那些重要的决定……",
		event_title = "site_event_name",
		character = 1,
		id = 4144,
		icon = "",
...
;(function()
	...
	pg.base.child2_site_display[201] = {
		...
		bg = "red",
		title = "拜访",
		desc = "{namecode:199}正悠闲地坐在公园长椅上，露出充满自信的笑容。\n\n（{namecode:199}的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 201,
		icon = "xinzexi",
	...
	pg.base.child2_site_display[202] = {
		...
		bg = "red",
		title = "拜访",
		desc = "{namecode:199}正在检查装备，看起来十分愉悦。 \n\n（{namecode:199}的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 202,
		icon = "xinzexi",
	...
	pg.base.child2_site_display[203] = {
		...
		bg = "red",
		title = "拜访",
		desc = "在海边遇到了{namecode:199}，要去和她聊聊吗？\n\n（{namecode:199}的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 203,
		icon = "xinzexi",
	...
	pg.base.child2_site_display[205] = {
		...
		bg = "red",
		title = "拜访",
		desc = "七省正在花园里，细心地为一株郁金香调整支撑杆。\n\n（七省的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 205,
		icon = "qisheng",
	...
	pg.base.child2_site_display[207] = {
		...
		bg = "red",
		title = "拜访",
		desc = "在暖房里看到七省正在记录植物生长数据，要去找她聊天吗？\n\n（七省的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 207,
		icon = "qisheng",
	...
	pg.base.child2_site_display[209] = {
		...
		bg = "red",
		title = "拜访",
		desc = "塔什干正在阴凉处，漫不经心地抛玩着一颗水果糖。\n\n（塔什干的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 209,
		icon = "tashigan",
	...
	pg.base.child2_site_display[211] = {
		...
		bg = "red",
		title = "拜访",
		desc = "在图书室的角落看到塔什干正在翻看图画书，要去和她聊聊吗？\n\n（塔什干的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 211,
		icon = "tashigan",
...
;(function()
	pg.base.child2_site_display[213] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "天狼星正站在一面玻璃前，专注地整理着女仆装的袖口。\n\n（天狼星的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 213,
		icon = "tianlangxing",
	...
	pg.base.child2_site_display[215] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "看到天狼星在走廊尽头安静地执行巡逻任务，要去找她聊聊吗？\n\n（天狼星的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 215,
		icon = "tianlangxing",
	...
	pg.base.child2_site_display[217] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "重剑正在休息室里，笨拙地练习折叠一件制服。\n\n（重剑的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 217,
		icon = "zhongjian",
	...
	pg.base.child2_site_display[221] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "{namecode:50}正站在办公室的白板前，专注地调整着下周的训练计划表。\n\n（{namecode:50}的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 221,
		icon = "nengdai",
	...
	pg.base.child2_site_display[222] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "{namecode:50}正在资料室整理作战记录，按照日期仔细归档。\n\n（{namecode:50}的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 222,
		icon = "nengdai",
	...
	pg.base.child2_site_display[223] = {
		...
		bg = "blue",
		title = "拜访",
		desc = "看到{namecode:50}在会议室准备演习简报，要去和她聊聊吗？\n\n（{namecode:50}的某些特质似乎可以影响艾普洛的性格...要不要前去拜访呢?）",
		event_title = "",
		character = 2,
		id = 223,
		icon = "nengdai",
...
;(function()
	...
	pg.base.child2_site_display[3228901] = {
		...
		bg = "",
		title = "随机事件",
		desc = "午后的琴行外，橱窗里的三角钢琴静立如一位缄默的淑女，于无声中散发着优雅……",
		event_title = "site_event_name",
		character = 2,
		id = 3228901,
		icon = "",
	...
	pg.base.child2_site_display[3229101] = {
		...
		bg = "",
		title = "随机事件",
		desc = "社区文化节的节目单被张贴在公告栏上，艾普洛的名字也在其中……",
		event_title = "site_event_name",
		character = 2,
		id = 3229101,
		icon = "",
	...
	pg.base.child2_site_display[17] = {
		...
		bg = "",
		title = "随机事件",
		desc = "自然科学教室的储物柜最上层，躺着一本鲜少被翻阅的厚重科普书……",
		event_title = "site_event_name",
		character = 2,
		id = 3229201,
		icon = "",
