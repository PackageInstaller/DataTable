...
;(function()
	...
	var_1_0[1] = {
		...
		group = 1,
		pic = "jiulou_xiao",
		desc = "酒楼招牌高悬，这里既是满足味蕾的胜地，也是交换见闻、共庆佳节的绝佳场所。",
		act_id = 50434,
		id = 1,
		level = 0,
		upgrade = {
	...
	var_1_16[21] = {
		...
		group = 2,
		pic = "cangku_xiao",
		desc = "用以存放物资的仓库。厚重的门扉时常紧闭，鲜有人知晓，这其中别有洞天……",
		act_id = 50434,
		id = 21,
		level = 1,
		upgrade = {
	...
	var_1_31[36] = {
		...
		group = 3,
		pic = "lvshe_xiao",
		desc = "山水秀美的休憩之所，厢房内素帷静垂、烛影温存，专为旅人提供一处温暖惬意的天地。",
		act_id = 50434,
		id = 36,
		level = 0,
		upgrade = {
	...
	var_1_41[51] = {
		...
		group = 4,
		pic = "loutai_xiao",
		desc = "临近池塘的精巧楼阁，闲时可以来这里赏观四时景色，别有雅趣。",
		act_id = 50434,
		id = 51,
		level = 0,
		upgrade = {
	...
	var_1_57[71] = {
		...
		group = 5,
		pic = "chitang_xiao",
		desc = "一方开阔澄澈的塘水。风过柳梢时，常有锦鲤跃波而起，仿佛在与桥上穿梭的人影嬉戏。",
		act_id = 50434,
		id = 71,
		level = 0,
		upgrade = {
	...
	var_1_73[91] = {
		...
		group = 6,
		pic = "shulin_xiao",
		desc = "一处精心营造的园林景致，嶙峋的假山与繁茂的花木相映成趣。",
		act_id = 50434,
		id = 91,
		level = 0,
		upgrade = {
