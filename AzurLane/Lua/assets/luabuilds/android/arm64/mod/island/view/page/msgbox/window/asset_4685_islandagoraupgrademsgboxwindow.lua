...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_1 = var_3.Find(var_2_0, "confirm/Text")

	i18n = var_1_10004

	var_1(var_2_1, var_1_10004("island_agora_extend"))

	setText = var_1

	local var_2_2 = arg_2_0._tf
	local var_2_3 = var_3.Find(var_2_2, "condition/title/Text")

	i18n = var_4

	var_1(var_2_3, var_4("island_agora_extend_consume"))

	setText = var_1

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_3.Find(var_2_4, "capacity/Text")

	i18n = var_4

	var_1(var_2_5, var_4("island_agora_extend_capacity"))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.dropCntTxt = var_2_9(var_2_8, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.oldCapacityTxt = var_2_12(var_2_11, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.newCapacityTxt = var_2_15(var_2_14, var_4(var_6))
...
function var_0_1.UpdateConsume(arg_6_0, arg_6_1, arg_6_2)
	...
	updateCustomDrop = var_1_10004

	var_1_10004(arg_6_0.dropTpl, var_6_0)

	local var_6_1 = arg_6_2
	local var_6_2 = arg_6_2.GetOwnCount(var_6_1, var_6_0.id)
	local var_6_3 = arg_6_0.dropCntTxt

	setColorStr = var_6_1
	var_6_3.text = var_6_1(var_6_2, var_6_2 >= var_6_0.count and "#FFFFFF" or "#EB5F5F") .. "/" .. var_6_0.count
