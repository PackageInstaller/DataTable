...
function var_0_1.UpdateCollectData(arg_4_0, arg_4_1, arg_4_2)
	...
	if arg_4_1.pos ~= arg_4_0.pos then
		...
		var_4_6(var_4_5, var_1_10008.COLLECT_SLOT_UNIT_REMOVE, {
			unitId = arg_4_0.pos
		})
...
function var_0_1.GetRecoverTime(arg_7_0)
	...
	local var_7_1 = var_1_10003.max

	pg = var_1_10005

	local var_7_2 = var_1_10005.TimeMgr.GetInstance()

	return (var_7_0(var_7_1(var_5.GetServerTime(var_7_2) - arg_7_0.refresh_time, 0) / arg_7_0:GetRecoverCD()))
end
...
function var_0_1.GetCanCollectTime(arg_9_0)
	...
	local var_9_0 = arg_9_0:GetRecoverTime()

	math = var_2

	return var_2.min(arg_9_0.maxTimes, var_9_0 - arg_9_0.get_num + arg_9_0.maxTimes)
end
...
function var_0_1.NotifyToLoadCollectSlotModel(arg_11_0)
	...
	IslandBuildingAgency = var_1_10005

	var_11_2(var_11_1, var_1_10005.COLLECT_SlOT_UNIT_INIT, {
