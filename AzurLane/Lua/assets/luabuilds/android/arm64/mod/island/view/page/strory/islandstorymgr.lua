...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.autoBtnImg = var_2_4(var_2_3, var_4(var_1_10006))
	...
	arg_2_0.animator = var_2_6(var_2_5, var_4(var_1_10006))
	...
	arg_2_0.aniDft = var_2_8(var_2_7, var_4(var_1_10006))
	...
	arg_2_0.canvasGroup = var_1(var_2_9, var_4(var_1_10006))
...
function var_0_1.Play(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	arg_4_0.refreshNpc = var_1_10005(arg_4_2, true)
	...
	local var_4_4 = var_4_0.New
	local var_4_5 = var_4_3
	local var_4_6 = var_4_1

	IslandStory = var_1_10010
	arg_4_0.script = var_4_4(var_4_5, var_4_6, var_1_10010.MODE_DIALOGUE)

	arg_4_0:StartScript(var_6)

	local var_4_7 = {}

	table = var_4_5

	var_4_5.insert(var_4_7, function(arg_5_0)
		local var_5_0 = arg_4_0
		local var_5_1 = var_1.WaitForViewLoaded

		_IslandCore = var_2_10004

		var_5_1(var_5_0, var_2_10004:GetView(), arg_5_0)
	...
	var_8.insert(var_4_7, function(arg_6_0)
	...
	for iter_4_0, iter_4_1 in var_8(var_6.steps) do
		...
		var_1_10013.insert(var_4_7, function(arg_7_0)
	...
	var_8.insert(var_4_7, function(arg_8_0)
	...
	var_8.insert(var_4_7, function(arg_9_0)
	...
	var_8(var_4_7, function()
		...
		if var_10_1 == var_2_10001.SIGNIN_STORY_NAME then
...
function var_0_1.StartScript(arg_14_0, arg_14_1)
	...
	var_14_3(var_14_2, var_5.STORY_UPDATE, {
		storyId = arg_14_1.id,
		callback = function()
	...
	IslandBaseScene = var_5

	local var_14_6 = var_5.LINK_CORE_EVENT

	IslandProxy = var_6

	var_14_5(var_14_4, var_14_6, var_6.STORY_START)
...
function var_0_1.RegisterSkipBtn(arg_20_0)
	...
	var_1_10001(var_20_0, var_20_1, var_20_2, var_1_10006)
...
function var_0_1.RegisterLogBtn(arg_22_0)
	...
	var_1_10001(var_22_0, var_22_1, var_22_2, var_1_10006)
...
function var_0_1.EndScript(arg_26_0, arg_26_1)
	...
	IslandBaseScene = var_1_10006

	local var_26_8 = var_1_10006.LINK_CORE_EVENT

	IslandProxy = var_1_10007

	var_26_7(var_26_6, var_26_8, var_1_10007.STORY_END, var_26_5)
