...
function var_0_4.Move(arg_7_0, arg_7_1)
	...
	if arg_7_0.gravitySpeed >= 0 then
		...
		if var_7_2 then
			...
			var_7_4, var_1_10007 = arg_7_0:CalcNotFalling()
	...
	local var_7_6 = var_7_2(var_7_5, var_1_10007.GRAVITYDIR.y * var_7_1, 0)
	...
	local var_7_9 = var_7_5(var_7_8, var_1_10009.GRAVITYDIR.y * arg_7_0.gravitySpeed, 0)
	...
	local var_7_13 = var_7_12 * var_1_10011.deltaTime + var_7_7
	local var_7_14 = arg_7_0.extraVelocity

	Time = var_1_10012

	var_7_11(var_7_10, var_7_13 + var_7_14 * var_1_10012.deltaTime)
