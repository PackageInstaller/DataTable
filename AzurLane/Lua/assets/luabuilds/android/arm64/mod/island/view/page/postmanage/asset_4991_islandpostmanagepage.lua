...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1_10001(var_2_1, var_1_10004("island_post_manage"))
	...
	var_2_4[var_2_5] = var_2_6(var_2_7, var_2_8, var_1_10008({
	...
	setmetatable = var_8
	var_2_11[var_2_12] = var_2_13(var_2_14, var_2_15, var_8({
	...
	local var_2_18 = var_4.Find(var_2_17, "prod/unsel")

	i18n = var_5

	var_2(var_2_18, var_5("island_post_produce"))

	setText = var_2

	local var_2_19 = arg_2_0.togglesTF
	local var_2_20 = var_4.Find(var_2_19, "prod/sel/content/Text")

	i18n = var_5

	var_2(var_2_20, var_5("island_post_produce"))

	setText = var_2

	local var_2_21 = arg_2_0.togglesTF
	local var_2_22 = var_4.Find(var_2_21, "rest/unsel")

	i18n = var_5

	var_2(var_2_22, var_5("island_post_operate"))

	setText = var_2

	local var_2_23 = arg_2_0.togglesTF
	local var_2_24 = var_4.Find(var_2_23, "rest/sel/content/Text")

	i18n = var_5

	var_2(var_2_24, var_5("island_post_operate"))

	setText = var_2

	local var_2_25 = arg_2_0.togglesTF
	local var_2_26 = var_4.Find(var_2_25, "collection/unsel")

	i18n = var_5

	var_2(var_2_26, var_5("island_chara_gather_tip"))

	setText = var_2

	local var_2_27 = arg_2_0.togglesTF
	local var_2_28 = var_4.Find(var_2_27, "collection/sel/content/Text")

	i18n = var_5

	var_2(var_2_28, var_5("island_chara_gather_tip"))
	...
	local var_2_32 = var_4.Find(var_2_31, "Text")

	i18n = var_5

	var_2(var_2_32, var_5("island_post_btn_set_meal"))

	setText = var_2

	local var_2_33 = arg_2_0._tf
	local var_2_34 = var_4.Find(var_2_33, "Adapt/signInBtn/Text")

	i18n = var_5

	var_2(var_2_34, var_5("island_post_btn_sign"))
...
function var_0_1.OnInit(arg_5_0)
	arg_5_0:bind(var_0_1.EVENT_SHOW_SP_EVENT_TIP, function(arg_6_0, arg_6_1, arg_6_2)
		...
		var_2_10003(var_6_0, var_2_10006.UIMgr.GetInstance().UIMain)
		...
		var_6_3.type = var_2_10007.TYPE_ISLAND_POST_EVENT
		...
		function var_6_3.onHide()
			...
			var_3_10000(var_7_0, var_3_10003.UIMgr.GetInstance().OverlayMain)
	...
	local var_5_5 = var_4.Find(var_5_4, "top/title/help")
	...
	local function var_5_6()
		...
		var_10_2.type = var_2_10004.TYPE_WHITOUT_BTN
		i18n = var_4
		var_10_2.content = var_4("island_helpbtn_commission")
	...
	local var_5_9 = var_4.Find(var_5_8, "top/back")
	...
	local var_5_13 = var_4.Find(var_5_12, "top/home")
	...
	local var_5_17 = var_4.Find(var_5_16, "Adapt/signInBtn")
	...
	local function var_5_18()
		...
		local var_13_3 = var_2_10003.SWITCH_MAP

		IslandConst = var_2_10004

		local var_13_4 = var_2_10004.AGORA_MAP_ID

		IslandConst = var_2_10005

		var_13_2(var_13_1, var_13_3, var_13_4, var_2_10005.SIGNIN_SP)
	...
	var_1(var_5_15, var_5_17, var_5_18, var_5_16)
	...
	var_1(arg_5_0.togglesTF, function(arg_14_0)
		...
		var_2_10001(var_14_0, var_14_1, var_14_2, var_2_10006)
	...
	local var_5_21 = var_4.GetAblityAgency(var_5_20)
	local var_5_22 = var_4.HasAbility

	IslandAblityAgency = var_7

	var_1(var_5_19, var_5_22(var_5_21, var_7.SET_MEAL_ID))
...
function var_0_1.AddListeners(arg_16_0)
	...
	var_16_1(var_16_0, var_1_10004.ISLAND_START_DELEGATION_DONE, arg_16_0.FlushProdPage)
	...
	var_16_3(var_16_2, var_4.ISLAND_FINISH_DELEGATION_DONE, arg_16_0.OnFlushProdPageAndShipExpDone)
	...
	var_16_5(var_16_4, var_4.ISLAND_GET_DELEGATION_AWARD_DONE, arg_16_0.OnFlushProdPageAndShipExpDone)
	...
	var_16_7(var_16_6, var_4.ISLAND_OPEN_RESTAURANT_DONE, arg_16_0.FlushRestPage)
	...
	var_16_9(var_16_8, var_4.ISLAND_CLOSE_RESTAURANT_DONE, arg_16_0.FlushRestPage)
	...
	var_16_11(var_16_10, var_4.ADD_RESTAURANT, arg_16_0.FlushRestPage)
	...
	var_16_13(var_16_12, var_4.ADD_ASSISTANT, arg_16_0.FlushRestPage)
	...
	var_16_15(var_16_14, var_4.ON_DAILY_REFRESH, arg_16_0.FlushRestPage)
	...
	var_16_17(var_16_16, var_4.ISLAND_GET_AUTO_COLLECTION_DATA_DONE, arg_16_0.OnGetCollctionData)
	...
	var_16_19(var_16_18, var_4.ISLAND_TAKE_AUTO_COLLECTION_DONE, arg_16_0.OnGetCollctionDone)
...
function var_0_1.RemoveListeners(arg_17_0)
	...
	var_17_1(var_17_0, var_1_10004.ISLAND_START_DELEGATION_DONE, arg_17_0.FlushProdPage)
	...
	var_17_3(var_17_2, var_4.ISLAND_FINISH_DELEGATION_DONE, arg_17_0.OnFlushProdPageAndShipExpDone)
	...
	var_17_5(var_17_4, var_4.ISLAND_GET_DELEGATION_AWARD_DONE, arg_17_0.OnFlushProdPageAndShipExpDone)
	...
	var_17_7(var_17_6, var_4.ISLAND_OPEN_RESTAURANT_DONE, arg_17_0.FlushRestPage)
	...
	var_17_9(var_17_8, var_4.ISLAND_CLOSE_RESTAURANT_DONE, arg_17_0.FlushRestPage)
	...
	var_17_11(var_17_10, var_4.ADD_RESTAURANT, arg_17_0.FlushRestPage)
	...
	var_17_13(var_17_12, var_4.ADD_ASSISTANT, arg_17_0.FlushRestPage)
	...
	var_17_15(var_17_14, var_4.ON_DAILY_REFRESH, arg_17_0.FlushRestPage)
	...
	var_17_17(var_17_16, var_4.ISLAND_GET_AUTO_COLLECTION_DATA_DONE, arg_17_0.OnGetCollctionData)
	...
	var_17_19(var_17_18, var_4.ISLAND_TAKE_AUTO_COLLECTION_DONE, arg_17_0.OnGetCollctionDone)
	...
	for iter_18_0, iter_18_1 in var_1_10001(arg_18_0.pages) do
		if iter_18_0 == arg_18_0.curPage then
			if arg_18_0.curPage == var_0_1.PAGE_COLLECTION then
				...
				var_18_2(var_18_1, var_1_10009.GET_AUTO_COLLECTION_DATA, 1)
			else
...
function var_0_1.OnGetCollctionData(arg_19_0, arg_19_1)
	...
	local var_19_6 = var_19_5 .. var_19_3(var_19_4)
...
function var_0_1.OnShow(arg_21_0)
	...
	local var_21_4 = var_4(var_21_2)
	local var_21_5 = var_4.GetIsland(var_21_4)
	local var_21_6 = var_4.GetSignInAgency(var_21_5)

	var_1(var_21_3, var_4.CanSignIn(var_21_6))
...
function var_0_1.FlushProdTip(arg_23_0)
	...
	var_1_10002(var_4.Find(var_23_1, "prod/unsel/tip"), var_23_0)

	setActive = var_1_10002

	local var_23_2 = arg_23_0.togglesTF

	var_1_10002(var_4.Find(var_23_2, "prod/sel/tip"), var_23_0)
...
function var_0_1.FlushRestTip(arg_24_0)
	...
	var_1_10002(var_4.Find(var_24_1, "rest/unsel/tip"), var_24_0)

	setActive = var_1_10002

	local var_24_2 = arg_24_0.togglesTF

	var_1_10002(var_4.Find(var_24_2, "rest/sel/tip"), var_24_0)
...
function var_0_1.FlushCollectionTip(arg_25_0)
	...
	var_1_10002(var_4.Find(var_25_1, "collection/unsel/tip"), var_25_0)

	setActive = var_1_10002

	local var_25_2 = arg_25_0.togglesTF

	var_1_10002(var_4.Find(var_25_2, "collection/sel/tip"), var_25_0)
