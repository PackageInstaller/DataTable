...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".IslandSceneLoader"))
...
function var_0_1.LoadProgressUI(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_10003({
		function(arg_2_0)
			...
			typeof = var_2_10007
			GameObject = var_2_10009

			local var_2_5 = var_2_10007(var_2_10009)

			UnityEngine = var_2_10008
			var_2_0.progressLoadingId = var_2_2(var_2_1, var_2_3, var_2_4, var_2_5, var_2_10008.Events.UnityAction_UnityEngine_Object(function(arg_3_0)
				...
				var_3_0.loadingInstID = var_2.EnqueueInstantiate(var_3_1, arg_3_0, function(arg_4_0)
					...
					var_4_10001(var_4_0, var_4_10004.UIMgr.GetInstance().UIMain)
...
function var_0_1.PlayFadeIn(arg_6_0, arg_6_1)
	...
	local var_6_1 = var_1_10002(var_6_0, var_5(var_1_10007))
	...
	local var_6_3 = var_6_2(var_5(arg_6_0.curtain), 0, 1, 0.5)
	local var_6_4 = var_3.setOnUpdate

	System = var_6

	local var_6_5 = var_6_4(var_6_3, var_6.Action_float(function(arg_7_0)
	...
	var_6_6(var_6_5, var_6.Action(arg_6_1))
...
function var_0_1.PlayFadeOut(arg_8_0, arg_8_1)
	...
	local var_8_1 = var_1_10002(var_8_0, var_1_10005(var_1_10007))
	...
	local var_8_3 = var_8_2(var_5(arg_8_0.curtain), 1, 0, 0.5)
	...
	var_8_6(var_8_5, var_6.Action(arg_8_1))
...
function var_0_1.Clear(arg_18_0)
	...
	if var_18_0(var_1_10003(arg_18_0.curtain)) then
		LeanTween = var_1
		...
		var_18_1(var_3(arg_18_0.curtain))
	end
