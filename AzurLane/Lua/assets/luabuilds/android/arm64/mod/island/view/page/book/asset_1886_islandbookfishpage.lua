...
function var_0_1.OnLoaded(arg_4_0)
	...
	var_1(var_4_3, var_4("island_guide_fish_min_weight"))
	...
	var_1(var_4_6, var_4("island_guide_fish_max_weight"))
...
function var_0_1.FlushRightPanel(arg_5_0)
	...
	var_5_3(var_6.Find(var_5_9, "value"), var_5_8:GetMinWeight() / 1000 .. "KG")

	setText = var_5_3

	local var_5_10 = arg_5_0.maxWeightTF

	var_5_3(var_6.Find(var_5_10, "value"), var_5_8:GetMaxWeight() / 1000 .. "KG")

	setActive = var_5_3

	local var_5_11 = arg_5_0.minWeightTF

	var_5_3(var_6.Find(var_5_11, "Image"), var_5_8:ReachMinCup())

	setActive = var_5_3

	local var_5_12 = arg_5_0.maxWeightTF

	var_5_3(var_6.Find(var_5_12, "Image"), var_5_8:ReachMaxCup())
