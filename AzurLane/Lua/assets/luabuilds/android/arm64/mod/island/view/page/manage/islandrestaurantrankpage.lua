...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_4 = var_2_3:Find("info/top/exp/name")

	i18n = var_1_10006

	var_2_1(var_2_4, var_1_10006("island_manage_need_ext"))

	setText = var_2_1

	local var_2_5 = var_2_3:Find("info/top/finished/Text")

	i18n = var_6

	var_2_1(var_2_5, var_6("island_manage_reach"))

	setText = var_2_1

	local var_2_6 = var_2_3:Find("info/bottom/content/shelf/info/name")

	i18n = var_6

	var_2_1(var_2_6, var_6("island_manage_slot"))

	setText = var_2_1

	local var_2_7 = var_2_3:Find("info/bottom/content/capacity/info/name")

	i18n = var_6

	var_2_1(var_2_7, var_6("island_manage_food_cnt"))

	setText = var_2_1

	local var_2_8 = var_2_3:Find("info/bottom/content/percent/info/name")

	i18n = var_6

	var_2_1(var_2_8, var_6("island_manage_sale_ratio"))

	setText = var_2_1

	local var_2_9 = var_2_3:Find("info/bottom/content/assistant/info/name")

	i18n = var_6

	var_2_1(var_2_9, var_6("island_manage_worker_cnt"))
...
function var_0_1.InitItem(arg_7_0, arg_7_1, arg_7_2)
	...
	var_5(var_7_0:Find("shelf/info/value"), var_3.slot_num[1])

	setText = var_5

	var_5(var_7_0:Find("capacity/info/value"), var_3.slot_num[2])

	setText = var_5

	var_5(var_7_0:Find("percent/info/value"), var_3.bonus_coefficient / 100 .. "%")

	setText = var_5

	var_5(var_7_0:Find("assistant/info/value"), var_3.assistant_num)

	setActive = var_5

	var_5(arg_7_2:Find("dot/silder"), arg_7_1 + 1 ~= #arg_7_0.rankIds)
...
function var_0_1.OnShow(arg_9_0, arg_9_1)
	...
	var_3.eachActive(var_9_8, function(arg_10_0, arg_10_1)
		...
		local var_10_2 = var_10_1(var_10_0, var_2_10005(var_2_10007))
		...
		var_10_2.insert(var_9_7, function(arg_11_0)
			...
			var_11_1(var_11_0, var_3_10004(var_3_10006)).alpha = 1
			...
			local var_11_4 = var_11_3(var_11_2, var_4(var_3_10006))
			...
			var_11_6(var_11_5, var_4.delayedCall, function()
				arg_11_0()
