...
IslandTechnology = var_0_0
var_0_2[1] = var_0_0.STATUS.RECEIVE
...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_5 = var_3.Find(var_2_4, "items")
	local var_2_6 = arg_2_0.showContent

	arg_2_0.itemUIList = var_2_3(var_2_5, var_4.Find(var_2_6, "items/tpl"))
...
function var_0_1.UpdateItem(arg_5_0, arg_5_1, arg_5_2)
	...
	var_1_10005(arg_5_2, arg_5_0:GetPositionById(var_5_1.id))

	setActive = var_1_10005

	var_1_10005(arg_5_2:Find("selected"), false)

	local var_5_2 = var_0_1.SetTechName
	local var_5_3 = arg_5_2:Find("name")
	local var_5_4 = var_5_1

	var_5_2(var_5_3, var_5_1.getConfig(var_5_4, "tech_name"))

	local var_5_5 = var_5_1
	local var_5_6 = var_5_1.GetStatus(var_5_5)

	IslandTechnology = var_5_0

	local var_5_7 = var_5_6 == var_5_0.STATUS.FINISHED

	setTextColor = var_5_5

	local var_5_8 = arg_5_2:Find("name/Text")

	Color = var_5_4

	var_5_5(var_5_8, var_5_4.NewHex(var_5_7 and "1b3650" or "ffffff"))

	setTextColor = var_5_5

	local var_5_9 = arg_5_2:Find("name/ScrollText")

	Color = var_10

	var_5_5(var_5_9, var_10.NewHex(var_5_7 and "1b3650" or "ffffff"))

	LoadImageSpriteAsync = var_5_5

	var_5_5("island/IslandTechnology/" .. var_5_1:getConfig("tech_icon"), arg_5_2:Find("icon"), true)

	setImageColor = var_5_5

	local var_5_10 = arg_5_2:Find("icon")

	Color = var_10

	var_5_5(var_5_10, var_10.NewHex(var_5_7 and "455a81" or "ffffff"))

	setActive = var_5_5

	local var_5_11 = arg_5_2:Find("icon")

	IslandTechnology = var_10

	if var_5_6 ~= var_10.STATUS.STUDYING then
		IslandTechnology = var_10

		local var_5_12

		if var_5_6 == var_10.STATUS.RECEIVE then
			var_5_12 = false
		else
			var_5_12 = true
		end

		var_5_5(var_5_11, var_5_12)

		eachChild = var_5_5

		var_5_5(arg_5_2:Find("back"), function(arg_6_0)
			setActive = var_2_10001

			var_2_10001(arg_6_0, arg_6_0.name == var_5_6)
		...
		local var_5_13 = arg_5_2:Find("back/normal")
		...
		if not var_5_7 then
			...
			var_5_5(var_5_13, var_5_14)

			eachChild = var_5_5

			var_5_5(arg_5_2:Find("front"), function(arg_7_0)
				setActive = var_2_10001

				var_2_10001(arg_7_0, arg_7_0.name == var_5_6)
			...
			local function var_5_17()
				...
				var_2_10001(arg_5_0.contextData.onItemClick, var_5_1.id, var_8_1)
			...
			var_5_5(var_5_15, var_5_16, var_5_17, var_12)
...
function var_0_1.InitTreeCS(arg_11_0, arg_11_1, arg_11_2)
	...
	for iter_11_0, iter_11_1 in var_3(arg_11_0:GetTechTreeLineData()) do
		...
		for iter_11_2, iter_11_3 in var_8(iter_11_1) do
...
function var_0_1.AutoFocus(arg_17_0)
	...
	local var_17_2 = var_1_10002.max(arg_17_0:GetPositionById(var_17_1).x - var_0_1.ELEMENT_SIZE.x / 2, 0)

	scrollTo = var_17_0

	var_17_0(arg_17_0.treeView, var_17_2 / arg_17_0.showContent.rect.width, 0)
...
function var_0_1.SetTechName(arg_22_0, arg_22_1)
	...
	local var_22_1 = arg_22_0:Find("Text")

	typeof = var_1_10006
	Text = var_8

	local var_22_2 = var_1_10003(var_22_1, var_1_10006(var_8))

	var_22_2.fontSize = var_22_0 > 8 and 28 or 32
	setActive = var_22_2

	var_22_2(arg_22_0:Find("Text"), var_22_0 <= 10)

	setActive = var_22_2

	var_22_2(arg_22_0:Find("ScrollText"), var_22_0 > 10)
