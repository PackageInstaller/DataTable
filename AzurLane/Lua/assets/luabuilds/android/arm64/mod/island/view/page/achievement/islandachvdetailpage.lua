...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_3 = var_3.Find(var_2_2, "total/Text")
	...
	var_2(var_4.Find(var_2_7, "tpl"), false)

	setText = var_2

	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_4.Find(var_2_8, "tpl/status/get/Text")

	i18n = var_5

	var_2(var_2_9, var_5("handbook_claim"))

	setText = var_2

	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_4.Find(var_2_10, "tpl/status/got/Text")

	i18n = var_5

	var_2(var_2_11, var_5("handbook_finished"))
...
function var_0_1.InitToggle(arg_8_0, arg_8_1, arg_8_2)
	...
	var_1_10005(var_8_1, var_8_2, var_8_3, var_10)
...
function var_0_1.UpdateToggle(arg_10_0, arg_10_1, arg_10_2)
	...
	for iter_10_0, iter_10_1 in var_1_10006(var_10_1) do
		...
		for iter_10_2, iter_10_3 in var_1_10012(var_10_4:GetSortAchvList()) do
			table = var_1_10017
	...
	local var_10_5 = var_6.any(var_10_2, function(arg_11_0)
		local var_11_0 = arg_11_0:GetStatus()

		IslandAchievement = var_2_10002

		return var_11_0 == var_2_10002.STATUS.GET
	end)
...
function var_0_1.AddListeners(arg_12_0)
	...
	var_12_1(var_12_0, var_1_10004.ISLAND_GET_ACHV_AWARD_DONE, arg_12_0.OnGetAchvAwardDone)
...
function var_0_1.RemoveListeners(arg_13_0)
	...
	var_13_1(var_13_0, var_1_10004.ISLAND_GET_ACHV_AWARD_DONE, arg_13_0.OnGetAchvAwardDone)
...
function var_0_1.Flush(arg_15_0)
	...
	local var_15_4 = #var_4.GetGotList(var_15_3)
	local var_15_5 = "/"
	local var_15_6 = arg_15_0.achvAgency

	var_1(var_15_2, var_15_4 .. var_15_5 .. var_6.GetTotalCnt(var_15_6))
	...
	local var_15_9 = var_3.Find

	tostring = var_6

	var_1(var_15_9(var_15_8, var_6(arg_15_0.showType)), true)
...
function var_0_1.FlushDetail(arg_16_0)
	...
	arg_16_0.showAchvList = var_1.map(arg_16_0.showGroupIds, function(arg_17_0)
		...
		local var_17_3 = var_17_0.select(var_17_2, function(arg_18_0)
			local var_18_1

			if arg_18_0:IsHideType() then
				local var_18_0 = arg_18_0:GetStatus()

				IslandAchievement = var_3_10002

				if var_18_0 ~= var_3_10002.STATUS.GET then
					var_18_1 = false
		...
		if not var_17_1.detect(var_17_3, function(arg_19_0)
			local var_19_0 = arg_19_0:GetStatus()

			IslandAchievement = var_3_10002

			return var_19_0 ~= var_3_10002.STATUS.GOT
		end) then
	...
	var_16_0(var_16_1, var_4({
		function(arg_20_0)
			local var_20_0 = arg_20_0:GetStatus()

			IslandAchievement = var_2_10002

			return var_20_0 == var_2_10002.STATUS.GET and 0 or 1
		end,
		function(arg_21_0)
			local var_21_0 = arg_21_0:GetStatus()

			IslandAchievement = var_2_10002

			return var_21_0 == var_2_10002.STATUS.GOT and 1 or 0
		end,
		function(arg_22_0)
			return arg_22_0.id
		end
...
function var_0_1.OnInitItem(arg_23_0, arg_23_1)
	...
	local function var_23_4()
		...
		local var_24_2 = var_24_1(var_24_0, var_2_10003(var_2_10005))
		...
		var_24_4(var_24_3, var_3.GET_ACHIEVEMENT_AWARD, {
			var_23_0.achv.id
		})
	...
	var_23_1(var_23_2, var_23_3, var_23_4, var_1_10008)
...
function var_0_1.OnGetAchvAwardDone(arg_26_0, arg_26_1)
	...
	var_1_10004({
		...
		local var_29_1 = var_2_10001(var_2_10003)
		...
		local var_29_5 = #var_3.GetGotList(var_29_4)
		local var_29_6 = "/"
		local var_29_7 = arg_26_0.achvAgency

		var_29_0(var_29_3, var_29_5 .. var_29_6 .. var_5.GetTotalCnt(var_29_7))
