...
function var_0_0.WorldPosition2LocalPosition(arg_2_0, arg_2_1)
	...
	local var_2_4 = var_2_0.ViewportToScreenPoint(var_2_3, var_2_2)
	local var_2_5 = arg_2_0:GetComponent("RectTransform")

	LuaHelper = var_2_3

	return (var_2_3.ScreenToLocal(var_2_5, var_2_4, var_2_0))
end
...
function var_0_0.GetNavPath(arg_4_0, arg_4_1)
	...
	local var_4_1 = var_1_10002(var_4_0, var_1_10005(var_1_10007.AI.NavMeshAgent))
...
function var_0_0.GetRandomPointInSector(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	local var_6_3 = var_6_2 + var_9.Random.value * (2 * var_7)
	...
	local var_6_8 = var_1_10015.cos(var_6_4)
	local var_6_9 = 0

	math = var_17

	return arg_6_0 + var_6_7(var_6_8, var_6_9, var_17.sin(var_6_4)) * var_6_6
end
...
function var_0_0.GetPointOffset(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_2 % 2 == 0 then
		...
		return arg_7_0 + var_7_0 * var_1_10004.ceil(arg_7_2 * 0.5)
	else
		Vector3 = var_7_0
		...
		return arg_7_0 - var_7_1 * var_1_10004.ceil(arg_7_2 * 0.5)
	end
...
function var_0_0.GetUnReHexPoints(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_5 = var_1_10008.insert
	local var_9_6 = var_9_2

	Vector2 = var_1_10011

	var_9_5(var_9_6, var_1_10011(0, var_9_1))
	...
	var_9_7(var_9_8, var_11(-var_9_0, var_9_4))
	...
	var_9_9(var_9_10, var_11(-var_9_0, -var_9_4))
	...
	var_9_11(var_9_12, var_11(0, -var_9_1))
	...
	var_9_13(var_9_14, var_11(var_9_0, -var_9_4))
	...
	var_9_15(var_9_16, var_11(var_9_0, var_9_4))
...
function var_0_0.Vetor3Table2Array(arg_10_0)
	...
	local var_10_1 = var_10_0(var_1_10003(var_1_10005.Vector3), #arg_10_0)
...
function var_0_0.GetSurroundPoints(arg_13_0)
	...
	var_13_1(var_13_2, var_5(arg_13_0.x * -1, arg_13_0.y, arg_13_0.z * -1))
	...
	var_13_3(var_13_4, var_5(arg_13_0.x, arg_13_0.y, arg_13_0.z * -1))
	...
	var_13_5(var_13_6, var_5(arg_13_0.x * -1, arg_13_0.y, arg_13_0.z))
...
function var_0_0.GetRandomSurroundPoints(arg_14_0)
	...
	local var_14_2 = var_6.Cos(var_14_1) * var_14_0

	Mathf = var_1_10007

	local var_14_3 = var_4(var_14_2, var_1_10007.Sin(var_14_1) * var_14_0)

	Vector3 = var_5

	return var_5(var_14_3.x, arg_14_0.y, var_14_3.y)
end
...
function var_0_0.GetCanReachOptPoint(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4, arg_18_5)
	...
	var_7.sort(var_6, function(arg_19_0, arg_19_1)
		...
		return var_19_0 < var_2_10003.Distance(arg_19_1, arg_18_4)
	end)
