...
function var_0_1.InitFutureTasks(arg_2_0, arg_2_1)
	...
	for iter_2_2, iter_2_3 in var_2(arg_2_1) do
		...
		if not arg_2_0.CheckMutex(var_1_10009, iter_2_3.task_id) then
	...
	for iter_2_4, iter_2_5 in var_2(var_4.GetPermanentTypes()) do
		pg = var_1_10007
		...
		var_1_10009.each(var_1_10008, function(arg_4_0)
...
function var_0_1.BuildObjectTaskHudData(arg_5_0)
	...
	local var_5_1 = var_1_10003.keys(arg_5_0.tasks)

	underscore = var_1_10004

	local var_5_2 = var_5_0(var_5_1, var_1_10004.keys(arg_5_0.futureTasks))

	IslandObjectTaskHudHelper = var_1_10002

	var_1_10002.BuildData(var_5_2)
...
function var_0_1.CheckMutex(arg_6_0, arg_6_1)
	...
	return var_1_10003.any(var_2, function(arg_7_0)
...
function var_0_1.IsShowInTaskUI(arg_16_0, arg_16_1)
	...
	if var_16_1 == var_1_10003.SEASON then
		return false
	end
	...
	local var_16_4 = var_16_0.all(var_16_3, function(arg_17_0)
		local var_17_0 = arg_16_0

		return var_1.IsFinishTask(var_17_0, arg_17_0)
	end)

	IslandTaskType = var_16_2

	if var_16_1 == var_16_2.HIDE then
...
function var_0_1.GetPriorityTraceTaskId(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1_10002(arg_26_0.tasks) do
		...
		if not var_1_10007(var_1_10009.EXCLUED_TRACK_TYPES, iter_26_1:GetType()) then
			var_1_10009 = arg_26_0

			if arg_26_0.IsShowInTaskUI(var_1_10009, iter_26_1) then
				table = var_1_10007
	...
	CompareFuncs = iter_26_0

	var_26_1(var_26_2, iter_26_0({
		function(arg_27_0)
...
function var_0_1.GetPriorityMainTraceTaskId(arg_30_0)
	...
	for iter_30_0, iter_30_1 in var_1_10001(arg_30_0.tasks) do
		local var_30_0 = iter_30_1:GetType()

		IslandTaskType = var_1_10007

		if var_30_0 == var_1_10007.MAIN then
			return iter_30_1.id
		end
	end
...
function var_0_1.UpdateTask(arg_32_0, arg_32_1)
	...
	if arg_32_1:IsFinish() and arg_32_1:IsSubmitImmediately() then
		...
		var_32_2(var_32_1, var_5.ISLAND_SUBMIT_TASK, {
			taskId = arg_32_1.id
		})
	end
...
function var_0_1.GetDiffTargetIdsByTypeAndParam(arg_33_0, arg_33_1, arg_33_2)
	...
	for iter_33_0, iter_33_1 in var_1_10004(arg_33_0.tasks) do
		local var_33_1 = iter_33_1:GetTargetIdByTypeAndParam(arg_33_1, arg_33_2)

		table = var_1_10010
		var_33_0 = var_1_10010.mergeArray(var_33_0, var_33_1, true)
	end
...
function var_0_1.ExistDailyTask(arg_35_0)
	...
	for iter_35_0, iter_35_1 in var_1_10001(arg_35_0.tasks) do
		local var_35_0 = iter_35_1:GetShowType()

		IslandTaskType = var_1_10007

		if var_35_0 == var_1_10007.DAILY then
			return true
		end
	end
...
function var_0_1.UpdatePerDay(arg_39_0)
	...
	var_39_2(var_39_1, var_1_10004.ISLAND_GET_RANDOM_REFRESH_TASK)
...
function var_0_1.TryAcceptAutoTasks(arg_42_0, arg_42_1)
	...
	if #var_42_0 > 0 then
		...
		var_42_2(var_42_1, iter_42_0.ISLAND_ACCEPT_TASK, {
			taskIds = var_42_0,
			callback = arg_42_1
		})
	else
	...
	for iter_43_0, iter_43_1 in var_1_10003(arg_43_0.tasks) do
		if iter_43_1:IsFinish() and iter_43_1:IsSubmitImmediately() then
			...
			var_8.insert(var_43_0, function(arg_44_0)
				...
				var_44_1(var_44_0, var_2_10004.ISLAND_SUBMIT_TASK, {
					taskId = iter_43_1.id,
					callback = arg_44_0
				})
...
function var_0_1.TryAutoTrackTask(arg_46_0)
	...
	if arg_46_0.GetPriorityTraceTaskId(var_46_0) then
		...
		local var_46_1 = var_1_10002.m02
		local var_46_2 = var_2.sendNotification

		GAME = var_1_10005

		local var_46_3 = var_1_10005.ISLAND_SET_TRACE_TASK

		var_1_10006 = {
			traceId = var_1
		}
		IslandTaskTrackCard = var_1_10007
		var_1_10006.type = var_1_10007.TYPES.OTHER

		var_46_2(var_46_1, var_46_3, var_1_10006)
	end

	if arg_46_0:GetPriorityMainTraceTaskId() then
		pg = var_46_0

		local var_46_4 = var_46_0.m02
		local var_46_5 = var_3.sendNotification

		GAME = var_1_10006

		local var_46_6 = var_1_10006.ISLAND_SET_TRACE_TASK
		local var_46_7 = {
			traceId = var_2
		}

		IslandTaskTrackCard = var_1_10008
		var_46_7.type = var_1_10008.TYPES.MAIN

		var_46_5(var_46_4, var_46_6, var_46_7)
	end
