...
function var_0_1.OnAttach(arg_1_0, arg_1_1)
	...
	arg_1_0.animator = var_1_1(var_1_0, var_5(var_1_10007.Animator))
	bindComponent = var_2
	...
	typeof = var_5
	UnityEngine = var_7
	arg_1_0.decorationAnimator = var_1_3(var_1_2, var_5(var_7.Animator))
	setActive = var_2
...
function var_0_1.InitBombId(arg_4_0, arg_4_1)
	...
	for iter_4_0 = 1, 6 do
		...
		var_1_10008(arg_4_0[var_4_2 .. var_1_10011(iter_4_0)], var_4_1)
	end
...
function var_0_1.InitRotationBySeat(arg_7_0, arg_7_1)
	...
	var_7_2.localEulerAngles = var_5(var_7_3, var_8.seatRotatonY[arg_7_1], 0)
...
function var_0_1.OnShoot(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5)
	if arg_8_1 and arg_8_4 == 1 then
		...
		var_6.SetTrigger(var_8_0, "open")

		local var_8_1 = arg_8_0.decorationAnimator

		var_6.SetTrigger(var_8_1, "open")

		arg_8_0.shootOpenTime = 0

		arg_8_0:InitRotationBySeat(arg_8_2)

		local var_8_2 = arg_8_0:GetPrevIds(6, arg_8_3, arg_8_4 - 1)

		var_1_10009 = arg_8_0

		arg_8_0.InitBombId(var_1_10009, var_8_2)
	end
	...
	if arg_8_0.hasBombCount == 1 then
		...
		local var_8_3 = arg_8_0.turntabletf

		Vector3 = var_1_10007
		var_8_3.localEulerAngles = var_1_10007(0, 0, 0)
		...
		local var_8_4 = arg_8_0.curBombId - 1 == 0 and 6 or var_8_4
		local var_8_5 = -60 * (var_8_4 - 1)
		local var_8_6 = arg_8_0.turntabletf

		Vector3 = var_1_10009
		var_8_6.localEulerAngles = var_1_10009(0, var_8_5, 0)
		IslandCheaterTavernConst = var_8_6
		arg_8_0.rotateDuration = var_8_6.afterTurnTime
	...
	if arg_9_0.isRotating then
		...
		if var_9_4 >= 1 then
			...
			if arg_9_0.gotShoot then
				...
				var_5(arg_9_0[var_9_8 .. var_8(arg_9_0.curBombId)], true)
	...
	if arg_9_0.trunToNextBomb then
		...
		if var_9_10 >= 1 then
			...
			if arg_9_0.gotShoot then
				...
				var_5(arg_9_0[var_9_15 .. var_8(arg_9_0.curBombId)], true)
