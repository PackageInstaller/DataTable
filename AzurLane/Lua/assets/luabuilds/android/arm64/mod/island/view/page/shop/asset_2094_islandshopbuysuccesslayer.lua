...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "awards")
	local var_2_3 = arg_2_0._tf

	arg_2_0.awardList = var_2_0(var_2_2, var_4.Find(var_2_3, "awards/item"))
	setText = var_1

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_3.Find(var_2_4, "tip/text")

	i18n = var_4

	var_1(var_2_5, var_4("island_3Dshop_close"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_4.Find(var_3_1, "award_window")
	...
	local var_3_6 = var_4.Find(var_3_5, "tip")
...
function var_0_1.SetUp(arg_6_0, arg_6_1)
	...
	var_2.make(var_6_0, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			local var_7_2 = arg_7_2.Find(var_7_1, "split")
			local var_7_3 = var_7_0.type

			VIRTUAL_DROP_TYPE_ISLAND_SEASON_PT = var_7_1

			var_4(var_7_2, var_7_3 == var_7_1)
		end
...
function var_0_1.OnShow(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_4 = var_1_10004.sort
	local var_8_5 = var_8_3

	CompareFuncs = var_1_10007

	var_8_4(var_8_5, var_1_10007({
		function(arg_9_0)
