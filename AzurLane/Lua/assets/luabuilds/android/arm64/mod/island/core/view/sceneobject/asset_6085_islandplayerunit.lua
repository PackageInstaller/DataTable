...
local var_0_4 = var_3(var_0_3, var_0_10006(".IslandNavigableUnit"))
local var_0_5 = 5
local var_0_6 = 150
...
local var_0_11 = var_0_10(var_0_10011.lshift(1, var_0_9))
local var_0_12 = {
	LoadToolHandle = 2,
	JumpHandle = 1,
	NoMoveAndWork = 3,
...
function var_0_4.OnAttach(arg_1_0, arg_1_1)
	...
	arg_1_0.animator = var_1_4(var_1_3, var_5(var_1_10007))
	...
	arg_1_0.characterController = var_1_6(var_1_5, var_5(var_1_10007))
	...
	arg_1_0.characterHandleController = var_1_8(var_1_7, var_5(var_1_10007))
	pg = var_2
...
function var_0_4.Move(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_5.SPEED_FLAG_HASH, arg_12_0.speed)
	...
	if arg_12_0.gravitySpeed >= 0 then
		...
		if var_12_4 then
			...
			var_12_6, var_1_10007 = arg_12_0:CalcNotFalling()

			if var_12_6 then
				arg_12_0.gravitySpeed = 0
				var_12_3 = var_1_10007
			else
	...
	var_12_8(var_12_7, var_1_10007.GROUD_FLAG, arg_12_0.onGroud)
	...
	local var_12_10 = var_12_8(var_12_9, var_7.GRAVITYDIR.y * var_12_3, 0)
	...
	local var_12_13 = var_12_9(var_12_12, var_1_10009.GRAVITYDIR.y * arg_12_0.gravitySpeed, 0)
	...
	local var_12_17 = var_12_16 * var_1_10011.deltaTime + var_12_11
	local var_12_18 = arg_12_0.extraVelocity

	Time = var_1_10012

	var_12_15(var_12_14, var_12_17 + var_12_18 * var_1_10012.deltaTime)
...
function var_0_4.PositionTween(arg_13_0, arg_13_1)
	if arg_13_0._positionTweenCom ~= nil then
		...
		local var_13_6 = var_13_3(var_13_4, var_13_5, var_1_10008.one)
		...
		if arg_13_0._positionTweenCom.elapse >= arg_13_0._positionTweenCom.duration - 0.001 then
			...
			local var_13_8 = var_6.Dot

			Vector3 = var_8
			arg_13_0.gravitySpeed = var_13_8(var_8(0, -1, 0), var_13_7) / arg_13_1
...
function var_0_4.CalcGrounded(arg_14_0)
	...
	local var_14_3, var_14_4 = var_14_0(var_14_1, var_14_2, var_1_10005.down, nil, 2 * arg_14_0.characterController.skinWidth + (0.5 * arg_14_0.characterController.height - arg_14_0.characterController.radius), var_0_11)
...
function var_0_4.CalcNotFalling(arg_15_0)
	...
	local var_15_3, var_15_4 = var_15_0(var_15_1, var_15_2, var_1_10005.down, nil, 0.3 + 2 * arg_15_0.characterController.skinWidth + (0.5 * arg_15_0.characterController.height - arg_15_0.characterController.radius), var_0_11)
...
function var_0_4.StandOnWorldObject(arg_16_0)
	...
	local var_16_3, var_16_4 = var_16_0(var_16_1, var_16_2, var_1_10005.down, nil, 0.3 + 2 * arg_16_0.characterController.skinWidth + (0.5 * arg_16_0.characterController.height - arg_16_0.characterController.radius), var_0_11)
	...
	if var_16_3 then
		...
		typeof = var_6
		WorldObjectItem = var_8

		if var_16_6(var_16_5, var_6(var_8)) then
			return true
		end
	end
...
function var_0_4.Sit(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_2 = var_4.LookRotation
	local var_17_3 = arg_17_2

	Vector3 = var_1_10007

	local var_17_4 = var_17_2(var_17_3, var_1_10007.New(0, 1, 0))
	...
	var_17_6(var_17_5, var_1_10008.SIT_HASH, true)
...
function var_0_4.MoveHandle(arg_18_0, arg_18_1, arg_18_2)
	...
	if arg_18_0.isSitting and arg_18_0.prevStandPosition then
		...
		var_18_1(var_18_0, var_1_10006.SIT_HASH, false)
	...
	if arg_18_0.animator then
		...
		var_18_3(var_18_2, var_1_10006.INPUT_MAGNITUDE, arg_18_2)
	end
...
function var_0_4.StopMoveHandle(arg_19_0)
	...
	var_19_1(var_19_0, var_1_10004.SPEED_FLAG_HASH, 0)
	...
	var_19_3(var_19_2, var_4.INPUT_MAGNITUDE, 0)
...
function var_0_4.StopMoveHandleByInput(arg_20_0)
	...
	var_20_1(var_20_0, var_1_10004.SPEED_FLAG_HASH, 0)
	...
	var_20_3(var_20_2, var_4.INPUT_MAGNITUDE, 0)
...
function var_0_4.JumpHandle(arg_21_0)
	...
	if arg_21_0:CheckCanJump() then
		...
		var_21_1(var_21_0, var_1_10004.JUMP_FLAG)
	end
...
function var_0_4.WorkHandle(arg_22_0, arg_22_1, arg_22_2)
	...
	if arg_22_2 then
		...
		local var_22_2 = var_22_0 - arg_22_0.GetCurrentPosition(var_22_1)
		local var_22_3 = var_0_0(var_22_2.x, 0, var_22_2.z).normalized

		Quaternion = var_22_1
		arg_22_0.targetRotation = var_22_1.LookRotation(var_22_3)
	end

	local var_22_4 = arg_22_0.animator

	var_3.SetTrigger(var_22_4, arg_22_1)
...
function var_0_4.DeviceStateHandle(arg_23_0, arg_23_1)
	...
	if arg_23_1 then
		...
		var_23_3(var_23_2, var_1_10005.DEVICE_SHOW_FLAG)
		...
		var_23_5(var_23_4, var_1_10005.UN_DEVICE_SHOW_FLAG)
	else
		...
		var_23_7(var_23_6, var_1_10005.UN_DEVICE_SHOW_FLAG)
	end
...
function var_0_4.LoadInteractiveTool(arg_26_0, arg_26_1)
	...
	if arg_26_0.objTfList[arg_26_0.currentToolId] then
		...
		var_26_1(var_26_2, var_6.UIHidden)
	...
	local var_26_5 = var_26_2.Instantiate(var_26_4)
	...
	local var_26_9 = var_26_6(var_26_7, var_26_8, var_1_10010(var_1_10012))
	...
	var_7(var_26_10, var_10(var_1_10012)).runtimeAnimatorController = var_26_9
	setParent = var_26_7

	var_26_7(arg_26_0.objTfList[arg_26_0.currentToolId], arg_26_0._tf)

	pg = var_26_7

	local var_26_11 = var_26_7.ViewUtils.SetLayer
	local var_26_12 = arg_26_0.objTfList[arg_26_0.currentToolId]

	Layer = var_11

	var_26_11(var_26_12, var_11.UIHidden)
...
function var_0_4.AttackHandle(arg_30_0, arg_30_1)
	...
	arg_30_0.delayAttackTimer = var_2.New(function()
		if arg_30_0.unitData then
			...
			var_31_1(var_31_0, var_2_10003.Take_Plant_Attact, {
...
function var_0_4.StateEnterFixHandle(arg_33_0, arg_33_1, arg_33_2)
	...
	if arg_33_1 == var_0_12.LoadToolHandle and var_33_0 and arg_33_0.objTfList[var_33_0] then
		...
		var_33_1(var_33_2, var_1_10007.Default)
	end
...
function var_0_4.StateExitFixHandle(arg_34_0, arg_34_1, arg_34_2)
	...
	if arg_34_1 == var_0_12.LoadToolHandle and var_34_0 and arg_34_0.objTfList[var_34_0] then
		...
		var_34_1(var_34_2, var_1_10007.UIHidden)
	end
...
function var_0_4.InitFarmCheckWorldObject(arg_37_0)
	...
	for iter_37_0, iter_37_1 in var_1(var_37_1) do
		...
		if not var_1_10008.island_production_farm.get_id_list_by_place_id[iter_37_1] then
			var_1_10008 = {}
		end

		for iter_37_2, iter_37_3 in var_1_10006(var_1_10008) do
			pg = var_1_10011
...
function var_0_4.Detectionobject(arg_40_0)
	...
	if not arg_40_0.IsSpecialMap(var_40_0) or not arg_40_0.isSelfIsland then
		return
	end
	...
	local function var_40_2(arg_41_0)
		...
		local var_41_8 = var_41_6(var_41_7, var_2_10010.min(var_41_3, var_41_0 + var_41_2))

		math = var_2_10008

		local var_41_9 = var_2_10008.max
		local var_41_10 = var_41_1 - var_41_2

		math = var_2_10011

		local var_41_11 = var_41_9(var_41_10, var_2_10011.min(var_41_4, var_41_1 + var_41_2))
	...
	for iter_40_0, iter_40_1 in var_40_0(arg_40_0.detectionList) do
		local var_40_3 = arg_40_0.view
		local var_40_4 = var_8.GetUnitModuleWithType

		IslandConst = var_1_10011
		var_1_10011 = var_40_4(var_40_3, var_1_10011.UNIT_LIST_OBJ, iter_40_1.id)

		if var_8.CanCheckByPlayer(var_1_10011) and var_40_2(iter_40_1) then
			table = var_9

			var_9.insert(var_40_1, iter_40_1)
		end
	end

	local function var_40_5(arg_42_0, arg_42_1, arg_42_2)
		return (arg_42_2.x - arg_42_0.x) * (arg_42_1.y - arg_42_0.y) - (arg_42_2.y - arg_42_0.y) * (arg_42_1.x - arg_42_0.x)
	end

	local function var_40_6(arg_43_0, arg_43_1, arg_43_2)
		Mathf = var_2_10003
	...
	local function var_40_7(arg_44_0, arg_44_1)
	...
	local function var_40_8(arg_45_0, arg_45_1, arg_45_2, arg_45_3)
		local var_45_0 = var_40_5(arg_45_2, arg_45_3, arg_45_0)
		local var_45_1 = var_40_5(arg_45_2, arg_45_3, arg_45_1)
		local var_45_2 = var_40_5(arg_45_0, arg_45_1, arg_45_2)
		local var_45_3 = var_40_5(arg_45_0, arg_45_1, arg_45_3)
		...
		if var_45_0 == 0 and var_40_6(arg_45_2, arg_45_3, arg_45_0) then
			return true
		end

		if var_45_1 == 0 and var_40_6(arg_45_2, arg_45_3, arg_45_1) then
			return true
		end

		if var_45_2 == 0 and var_40_6(arg_45_0, arg_45_1, arg_45_2) then
			return true
		end

		if var_45_3 == 0 and var_40_6(arg_45_0, arg_45_1, arg_45_3) then
			return true
		end
	...
	local function var_40_9(arg_46_0, arg_46_1)
		local var_46_0 = {}
		...
		local var_46_3 = var_2_10005.Sin(var_46_1)
	...
	local function var_40_10(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
		local var_47_0 = var_40_9(arg_47_0, arg_47_1)

		for iter_47_0 = 0, 3 do
			local var_47_1 = var_47_0[iter_47_0]
			local var_47_2 = var_47_0[(iter_47_0 + 1) % 4]

			if var_40_8(arg_47_2, arg_47_3, var_47_1, var_47_2) then
				return true
			end
		end

		if var_40_7(arg_47_2, var_47_0) or var_40_7(arg_47_3, var_47_0) then
			return true
		end
	...
	local function var_40_11(arg_48_0, arg_48_1, arg_48_2)
		...
		local var_48_15 = var_2_10020.Cos

		Mathf = var_2_10022

		local var_48_16 = var_48_14 * var_48_15(15 * var_2_10022.Deg2Rad)
		local var_48_17 = var_0_5

		Mathf = var_2_10021

		local var_48_18 = var_2_10021.Sin

		Mathf = var_2_10023

		local var_48_19 = var_48_9(var_48_10, var_48_11, var_48_12, var_48_13(var_48_16, var_48_17 * var_48_18(15 * var_2_10023.Deg2Rad)))

		return var_48_8 <= var_48_7 or var_48_19
	end

	local function var_40_12(arg_49_0)
		...
		local var_49_3 = var_40_11
		local var_49_4 = var_49_0
		local var_49_5 = arg_40_0

		return var_49_3(var_49_4, var_6.Vector3ToVector2(var_49_5, arg_40_0._tf.right), var_49_2)
	end
	...
	for iter_40_2, iter_40_3 in var_1_10012(var_40_1) do
		if var_40_12(iter_40_3) then
			table = var_1_10017

			var_1_10017.insert(var_40_13, iter_40_3)
		end
	end
	...
	if var_40_14 ~= 0 then
		...
		var_1_10017 = arg_40_0
		var_1_10017 = arg_40_0.Vector3ToVector2(var_1_10017, arg_40_0._tf.position) + var_0_13 + arg_40_0:Vector3ToVector2(arg_40_0._tf.forward) * 2
		...
		for iter_40_4, iter_40_5 in var_1_10020(var_40_13) do
			local var_40_18 = var_0_1(iter_40_5.position[1], iter_40_5.position[3]) - var_1_10017

			if var_26.Magnitude(var_40_18) < var_40_17 then
				var_40_17 = var_26
				var_40_16 = iter_40_5
			end
		end
		...
		if var_40_16 then
			...
			if var_20 ~= arg_40_0.nearId then
				...
				arg_40_0.nearItem = var_40_16
				var_40_15 = true
			end
		end
	end

	if var_40_14 ~= arg_40_0.lastCrossCount or var_40_15 then
		arg_40_0.lastCrossCount = var_40_14
		...
		if var_40_14 == 0 then
			...
			var_1_10017 = var_1_10017.HIDE_UNIT_HUD_OP
			...
			var_40_22.id = var_1_10019(arg_40_0.nearId)
			IslandConst = var_1_10019
			var_40_22.type = var_1_10019.UNIT_LIST_OBJ

			var_40_21(var_40_20, var_1_10017, var_40_22)
			...
			local var_40_25 = var_1_10017.SHOW_UNIT_HUD_OP
			local var_40_26 = {
				isHighLightControl = true
			}

			tonumber = var_1_10019
			var_40_26.id = var_1_10019(arg_40_0.nearId)
			IslandOpView = var_19
			var_40_26.operationType = var_19.OperationType.Plant
			IslandConst = var_19
			var_40_26.type = var_19.UNIT_LIST_OBJ
...
function var_0_4.LastGroundedPosition(arg_54_0)
	...
	if not arg_54_0.onGroud then
		...
		local var_54_3 = var_1_10005.down
		local var_54_4

		math = var_1_10007

		local var_54_5, var_54_6 = var_54_1(var_54_2, var_54_3, var_54_4, var_1_10007.huge, var_0_11)
...
function var_0_4.CheckCanJump(arg_55_0)
	...
	local var_55_2, var_55_3 = var_55_0(var_55_1, var_4.down, nil, 2, var_0_11)
...
function var_0_4.SetActiveByLayer(arg_58_0, arg_58_1)
	if arg_58_1 then
		...
		var_1_10002(var_58_0, var_1_10005.Default)
	else
		pg = var_1_10002
		...
		var_58_1(var_58_2, var_1_10005.UIHidden)
	end
...
function var_0_4.OnChangeDress(arg_60_0, arg_60_1, arg_60_2)
	...
	local var_60_1 = var_1_10004(var_1_10006)
	...
	for iter_60_0, iter_60_1 in var_60_2(arg_60_1) do
