...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not arg_1_1.getBody(var_1_0).pt then
		var_1_1 = 0
	end
	...
	var_4.Send(var_1_2, 21022, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_10004 = var_1.GetSeason(var_2_2)

			var_1.AddGotPtAwardList(var_2_10004, var_1_1)
			...
			var_2_5(var_2_4, var_2_10006.ISLAND_GET_SEASON_PT_AWARD_DONE, {
				dropData = var_2_3
			})
		else
			pg = var_1
