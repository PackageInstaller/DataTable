...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("Mod.Island.IslandDispatcher"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	if not var_1_8(var_1_7, var_5.MOVE_TASK_ID) then
		local var_1_9 = arg_1_0
		local var_1_10 = arg_1_0.SetSpawnPointId

		pg = var_5

		var_1_10(var_1_9, var_5.island_set.initial_spawn_point.key_value_int)
	end
...
function var_0_1.GetName(arg_28_0)
	if arg_28_0.name == "" then
		...
		return var_1_10002("island_default_name", var_28_1)
	else
...
function var_0_1.GetUpgradeAwardsByLevel(arg_40_0, arg_40_1)
	...
	var_1_10003(var_40_1)

	local var_40_2 = {}

	ipairs = var_40_0

	for iter_40_0, iter_40_1 in var_40_0(var_40_1.island_level_award) do
		table = var_1_10009
...
function var_0_1.CanAddProsperity(arg_43_0)
	...
	return var_1_10002.island_prosperity[var_43_0].prosperity > arg_43_0.prosperity
end
...
function var_0_1.GetTargetProsperityByLevel(arg_46_0, arg_46_1)
	...
	var_1_10002(var_1_10004.island_prosperity[arg_46_1])
...
function var_0_1.GetTargetProsperity(arg_47_0)
	...
	for iter_47_0, iter_47_1 in var_1_10003(var_1_10005.island_prosperity.all) do
		if var_47_1 < arg_47_0:GetTargetProsperityByLevel(iter_47_1) then
			return var_8
		end
	end
...
function var_0_1.GetProsperityLevel(arg_48_0)
	...
	for iter_48_0, iter_48_1 in var_1_10002(var_1_10004.island_prosperity.all) do
...
function var_0_1.AnyProsperityAwardCanGet(arg_50_0)
	...
	for iter_50_0, iter_50_1 in var_1_10001(var_1_10003.island_prosperity.all) do
