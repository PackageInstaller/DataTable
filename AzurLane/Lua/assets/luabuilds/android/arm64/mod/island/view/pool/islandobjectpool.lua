...
function var_0_0.Load(arg_7_0, arg_7_1)
	...
	arg_7_0.loadingId = var_7_1(var_7_0, var_7_2, var_7_3, var_7_4, var_1_10008.Events.UnityAction_UnityEngine_Object(function(arg_8_0)
		assert = var_2_10001
...
function var_0_0.NewItemAsyn(arg_10_0, arg_10_1)
	...
	var_1_10003.insert(arg_10_0.insIdList, var_10_1)
...
function var_0_0.DequeueAsyn(arg_12_0, arg_12_1)
	...
	if 0 < var_12_0 then
		...
		local var_12_1 = var_12_0.remove(arg_12_0.items, 1)

		UIUtil = var_3

		if var_3.IsGameObject(var_12_1) then
			arg_12_0:ActiveOrDisactiveItem(var_12_1, true)
		end
