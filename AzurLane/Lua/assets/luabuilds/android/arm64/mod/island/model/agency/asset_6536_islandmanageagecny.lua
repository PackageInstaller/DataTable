...
function var_0_1.UnlockNewAssistant(arg_11_0, arg_11_1)
	...
	var_1_10003(var_11_1, var_1_10006.format("未解锁%d餐厅,提前解锁了%d餐厅岗位", var_11_0, arg_11_1))
...
function var_0_1.GetTipInfos(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1_10004(var_1_10006.island_set.post_manage_operate.key_value_varchar) do
		if arg_14_0.restaurants[iter_14_1] then
			local var_14_3 = var_9:GetStatus()

			IslandRestaurant = var_1_10011

			if var_14_3 == var_1_10011.STATUS.CLOSE then
				var_14_0 = var_14_0 + 1
			else
				IslandRestaurant = var_1_10011

				if var_14_3 == var_1_10011.STATUS.PREPARE then
					var_14_1 = var_14_1 + #var_9:GetAssistants()
				else
					IslandRestaurant = var_1_10011

					if var_14_3 == var_1_10011.STATUS.OPENING then
						table = var_1_10011

						var_1_10011.insert(var_14_2, var_9:GetEndTime())
					end
				end
			end
		end
