...
function var_0_1.ExistHandCollection(arg_3_0)
	...
	IslandProductConst = var_3_1
	var_3_3[1] = var_3_1.MinePlaceId
	IslandProductConst = var_4
	var_3_3[2] = var_4.FellingPlaceId
	ipairs = var_4

	for iter_3_0, iter_3_1 in var_4(var_3_3) do
		if var_3_2:GetBuilding(iter_3_1) then
			local var_3_4 = var_9
			local var_3_5

			if not var_9.GetBuildingCollectData(var_3_4) then
				var_3_5 = nil
			end

			if var_3_5 then
				local var_3_6 = var_3_5:GetCollectSlotDatasDic()

				pairs = var_3_4

				for iter_3_2, iter_3_3 in var_3_4(var_3_6) do
...
function var_0_1.ExistGather(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10002(arg_4_0.gatherDataList) do
...
function var_0_1.OnInit(arg_6_0)
	...
	var_1_10001(arg_6_0, arg_6_0.uiSelectConfirm, function()
		...
		i18n = var_2_10004
		var_7_2.content = var_2_10004("collect_chapter_is_activation")
		...
		function var_7_2.onYes(arg_8_0, arg_8_1)
			...
			if var_2.CheckHasCollectData(var_8_0, arg_8_0) == false then
				...
				var_8_2(var_8_1, var_5("island_chara_gather_no_target"))
		...
		IslandMsgBox = var_4
		var_7_2.type = var_4.TYPE_COMMON_AUTO_CONFIRM
	...
	var_1(var_6_2, var_4("island_chara_gather_range"))
	...
	var_1(var_6_3, var_4("island_chara_gather_start"))
...
function var_0_1.InitShipItem(arg_12_0, arg_12_1, arg_12_2)
	...
	var_1_10004(arg_12_0, arg_12_2:Find("unlock/btn"), function()
		...
		var_13_5.attrType = var_2_10007.COLLECT_KEY
...
function var_0_1.UpdateShipItem(arg_16_0, arg_16_1, arg_16_2)
	...
	var_4(arg_16_2.Find(var_16_2, "unlock"), not var_16_1)
	...
	local var_16_4 = arg_16_0.selectShips[var_16_3] ~= nil and true or false

	setActive = var_7

	var_7(arg_16_2:Find("unlock/ship"), var_16_4)

	setActive = var_7

	var_7(arg_16_2:Find("unlock/add"), not var_16_4)
	...
	local var_16_5 = var_7.StaticGetPrefab(var_5)

	LoadImageSpriteAsync = var_16_2

	var_16_2("squareicon/" .. var_16_5, arg_16_2:Find("unlock/ship/mask/icon"))

	if not arg_16_0.expAddlist[var_16_3] then
		setActive = var_9
	...
	local var_16_6 = arg_16_2:Find("unlock/ship/exp/addExp")

	string = var_12

	var_9(var_16_6, var_12.format("EXP+%d", var_8))
...
function var_0_1.Flush(arg_20_0)
	...
	var_1_10001(var_20_0, var_20_1 == var_1_10005.SelectType.None)
	...
	var_1_10001(var_20_2, var_20_3 ~= var_5.SelectType.None)
	...
	var_1_10001(var_20_4, var_20_5 ~= var_5.SelectType.None)
	arg_20_0:RefreshData()

	local var_20_6 = arg_20_0.curType

	IslandAutoCollectHelper = var_1_10002

	if var_20_6 ~= var_1_10002.SelectType.None then
		setActive = var_20_6

		local var_20_7 = arg_20_0.uiConfirmBtn.transform

		var_20_6(var_3.Find(var_20_7, "blue"), arg_20_0.cheackEnough)

		setActive = var_20_6

		local var_20_8 = arg_20_0.uiConfirmBtn.transform

		var_20_6(var_3.Find(var_20_8, "gray"), not arg_20_0.cheackEnough)
		...
		if arg_20_0.cheackEnough then
			...
			var_1(arg_20_0, arg_20_0.uiConfirmBtn, function()
				...
				var_21_2(var_21_1, iter_21_0.ISLAND_TAKE_AUTO_COLLECTION, {
	...
	local var_20_9 = arg_20_0.uiShipList

	var_1.align(var_20_9, var_0_2)

	local var_20_10 = arg_20_0.uiTipList
	local var_20_11 = var_1.align

	IslandAutoCollectHelper = var_4

	var_20_11(var_20_10, #var_4.CostTipList)
	...
	if var_22_3 ~= var_1_10005.SelectType.HandCollection then
		...
		if var_22_4 == var_5.SelectType.Both then
			...
			for iter_22_0, iter_22_1 in var_22_6(var_22_5) do
				...
				if var_22_9 then
					local var_22_11 = var_22_9:GetCollectSlotDatasDic()

					pairs = var_1_10016

					for iter_22_2, iter_22_3 in var_1_10016(var_22_11) do
						if iter_22_3:GetCanCollectTimeStamps() == 0 and arg_22_0:CheckIsDefauotSlot(iter_22_1, iter_22_3.id) then
							table = var_1_10022

							var_1_10022.insert(arg_22_0.autoCostList, {
		...
		local var_22_12 = arg_22_0.curType

		IslandAutoCollectHelper = var_5

		if var_22_12 ~= var_5.SelectType.Gather then
			var_22_12 = arg_22_0.curType
			IslandAutoCollectHelper = var_5

			if var_22_12 == var_5.SelectType.Both then
				pg = var_22_12

				local var_22_13 = var_22_12.TimeMgr.GetInstance()

				var_22_12 = var_22_12.GetServerTime(var_22_13)
				ipairs = var_5

				for iter_22_4, iter_22_5 in var_5(arg_22_0.gatherDataList) do
					if iter_22_5.state == 0 or iter_22_5.state == 1 and iter_22_5.refresh_time < var_22_12 then
						pg = var_10

						local var_22_14 = var_10.island_wild_gather[iter_22_5.id]

						table = var_11

						var_11.insert(arg_22_0.autoCostList, {
							energyCost = var_22_14.auto_parameters[2],
							coinCost = var_22_14.auto_parameters[1],
							expAdd = var_22_14.auto_parameters[3]
						})
					end
				end
			end
			...
			for iter_22_6, iter_22_7 in var_22_12(arg_22_0.autoCostList) do
...
function var_0_1.RefreshData(arg_25_0)
	...
	elseif arg_25_0:GetShipCount() == 0 then
		...
		var_25_5 = arg_25_0:GetGatherReducePercent()
		math = var_7

		local var_25_6 = var_7.floor(var_25_0 * (1 - var_25_5 * 0.01))
		local var_25_7 = 0
		...
		for iter_25_0 = 1, 3 do
			if arg_25_0.selectShips[iter_25_0] then
				...
				local var_25_8 = var_1_10014.GetIsland(var_1_10016)
				local var_25_9 = var_1_10014.GetCharacterAgency(var_25_8)
				local var_25_10 = var_15.GetShipById(var_25_9, var_13)
				local var_25_11 = var_1_10016.GetCurrentEnergy(var_25_10)
				local var_25_12 = 0

				if var_25_11 <= var_25_6 then
					var_25_12 = var_25_11
				else
					var_25_12 = var_25_6
				end

				var_25_6 = var_25_6 - var_25_12
				var_25_7 = var_25_7 + var_25_11

				local var_25_13 = var_25_12 / var_1 * var_25_2
				local var_25_14 = arg_25_0.expAddlist

				math = var_1_10021
				var_25_14[iter_25_0] = var_1_10021.floor(var_25_13)
			end
		end

		local var_25_15

		if not (var_1 <= var_25_7) or not var_0_4 then
			var_25_15 = var_0_3
		end

		string = var_11
		var_25_3 = var_11.format("<color=%s>%d</color>/%d(-%d%%)", var_25_15, var_25_7, var_1, var_25_5)
		getProxy = var_11
		IslandProxy = var_13

		local var_25_16 = var_11(var_13)
		local var_25_17 = var_11.GetIsland(var_25_16)
		local var_25_18 = var_11.GetInventoryAgency(var_25_17)
		local var_25_19

		if not var_11.GetItemById(var_25_18, 1) or not var_12:GetCount() then
			var_25_19 = 0
		end

		local var_25_20

		if not (var_25_1 <= var_25_19) or not var_0_4 then
			var_25_20 = var_0_3
		end

		string = var_16
		var_25_4 = var_16.format("<color=%s>%d</color>/%d", var_25_20, var_25_1, var_25_19)
...
function var_0_1.Show(arg_31_0, arg_31_1)
	...
	for iter_31_0, iter_31_1 in var_2(arg_31_1.gather_list) do
		...
		IslandWildGatherData = var_1_10010

		var_1_10007(var_31_0, var_1_10010.New(iter_31_1))
	end
