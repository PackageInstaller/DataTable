...
function var_0_1.OnStart(arg_2_0)
	if arg_2_0.behaviourTreeOwner then
		...
		var_2_0[1] = var_1_10002.FarmlandPlaceId
		...
		IslandProductConst = var_2_1

		if var_2_3 == var_2_1.MinePlaceId then
			return
		end
...
function var_0_1.ExecuteDelegation(arg_4_0, arg_4_1)
	...
	local var_4_6 = var_4_2.Collections.Generic.List_IslandUnitNode()

	if var_4_3 then
		IslandUnitNode = var_4_4
		var_4_4 = var_4_4.New()
		var_4_4.unitId = var_4_1
		IslandConst = var_7
		var_4_4.unitType = var_7.UNIT_LIST_DELEGATION
	...
	for iter_4_0, iter_4_1 in var_4_4(var_4_5) do
	...
	if arg_4_1.nextIn then
		local var_4_7 = arg_4_0.behaviourTreeOwner

		var_6.SendEvent(var_4_7, "system_unit_add_nextIn", var_4_6, nil)
	else
		local var_4_8 = arg_4_0.behaviourTreeOwner

		var_6.SendEvent(var_4_8, "system_unit_add", var_4_6, nil)
	end
...
function var_0_1.OnUpdate(arg_6_0)
	...
	typeof = var_1_10004
	ParadoxNotion = var_1_10006

	if not var_6_2(var_6_1, var_1_10004(var_1_10006.Services.EventRouter)) then
		return
	end

	table = var_2

	local var_6_3 = var_2.remove(arg_6_0.scheduleList, 1)
