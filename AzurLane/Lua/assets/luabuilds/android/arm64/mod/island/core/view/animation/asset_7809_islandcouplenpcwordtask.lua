...
function var_0_1.CollectWords(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0, iter_6_1 in var_1_10004(var_1_10006.island_couple_word.all) do
		pg = var_1_10009
...
function var_0_1.CheckShipCouple(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_2 = var_7_1(var_7_0, var_1_10006.UNIT_LIST_FOLLOW, arg_7_2)
	local var_7_3 = var_3.GetDataVO(var_7_2)
	local var_7_4 = var_4.GetShipId(var_7_3)

	_ = var_7_0

	return var_7_0.any(arg_7_1, function(arg_8_0)
...
function var_0_1.PlayStory(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_2 = arg_13_0.WarpStory(var_13_1, arg_13_1, var_13_0)
	local var_13_3 = arg_13_0:GetView()
	local var_13_4 = var_5.GetAllUnits(var_13_3)

	IslandStory = var_13_1

	local var_13_5 = var_13_1.New
	local var_13_6 = var_13_2
	local var_13_7 = var_13_4

	IslandStory = var_1_10010

	local var_13_8 = var_13_5(var_13_6, var_13_7, var_1_10010.MODE_BUBBLE)

	if not arg_13_0:IsVaildStory(var_13_8) then
		arg_13_2()

		return
	end

	arg_13_0:FullMembers(var_13_8)

	local var_13_9 = arg_13_0
	local var_13_10 = arg_13_0.NotifiyCore

	ISLAND_EVT = var_10

	var_13_10(var_13_9, var_10.RAW_PLAY_BUBBLE, {
		info = var_13_2,
		callback = function()
			arg_13_0.members = {}
	...
	arg_13_0.currPlayStory = var_13_2
...
function var_0_1.FullMembers(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in var_1_10002(arg_15_1.steps) do
		...
		var_1_10008.insert(arg_15_0.members, var_15_0.id)
	end
...
function var_0_1.WarpStory(arg_17_0, arg_17_1, arg_17_2)
	...
	for iter_17_2, iter_17_3 in var_6(var_17_2) do
		...
		var_17_4[3] = var_1_10015.UNIT_LIST_FOLLOW
...
function var_0_1.StopBubbule(arg_21_0)
	...
	local var_21_2 = var_1_10004.RAW_STOP_BUBBLE
	local var_21_3 = {}

	Clone = var_1_10006
	var_21_3.info = var_1_10006(arg_21_0.currPlayStory)
