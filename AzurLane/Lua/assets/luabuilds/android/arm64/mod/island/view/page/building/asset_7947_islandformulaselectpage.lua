...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_22 = var_3.Find(var_2_21, "process")
	local var_2_23 = arg_2_0.extraProduct

	arg_2_0.extraProductList = var_2_20(var_2_22, var_4.Find(var_2_23, "process/item"))
	UIItemList = var_1

	local var_2_24 = var_1.New
	local var_2_25 = arg_2_0._tf
	local var_2_26 = var_3.Find(var_2_25, "formulaView/content")
	local var_2_27 = arg_2_0._tf

	arg_2_0.uiList = var_2_24(var_2_26, var_4.Find(var_2_27, "formulaView/content/tpl"))
	UIItemList = var_1

	local var_2_28 = var_1.New
	local var_2_29 = arg_2_0._tf
	local var_2_30 = var_3.Find(var_2_29, "rightInfo/formula/needItem/content")
	local var_2_31 = arg_2_0._tf

	arg_2_0.costuiList = var_2_28(var_2_30, var_4.Find(var_2_31, "rightInfo/formula/needItem/content/IslandItemTpl"))
	setText = var_1

	local var_2_32 = arg_2_0._tf
	local var_2_33 = var_3.Find(var_2_32, "top/title/Text")

	i18n = var_4

	var_1(var_2_33, var_4("island_select_product"))

	setText = var_1

	local var_2_34 = arg_2_0.formulaItem
	local var_2_35 = var_3.Find(var_2_34, "tips")

	i18n = var_4

	var_1(var_2_35, var_4("island_production_count"))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.skillName = var_2_45(var_2_44, var_4(var_6))
	...
	typeof = var_4
	Animation = var_6
	arg_2_0.animationPlayer = var_2_52(var_2_51, var_4(var_6))
...
function var_0_1.AddListeners(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10004.ISLAND_SHOP_OP_DONE, arg_3_0.RefreshCurrentSelectFormula)
...
function var_0_1.RemoveListeners(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10004.ISLAND_SHOP_OP_DONE, arg_4_0.RefreshCurrentSelectFormula)
...
function var_0_1.OnInit(arg_5_0)
	...
	local var_5_2 = var_4.Find(var_5_1, "top/title/help")
	...
	local function var_5_3()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.island_help_commission.tip
	...
	var_1_10001(var_5_10, var_5_11, var_5_12, var_5_1)
	...
	var_1_10001(var_5_13, var_5_14, var_5_15, var_5_1)
	...
	local function var_5_18()
		...
		var_12_2.type = var_2_10004.TYPE_SHIP_SKILL

		local var_12_3 = arg_5_0.selectedShip

		var_12_2.skill = var_4.GetSkill(var_12_3)
	...
	var_1_10001(var_5_16, var_5_17, var_5_18, var_5_1)
...
function var_0_1.InitFormulaItem(arg_16_0, arg_16_1, arg_16_2)
	...
	var_1_10003(var_16_0, var_16_1, var_16_2, var_1_10008)
...
function var_0_1.UpdateFormulaItem(arg_19_0, arg_19_1, arg_19_2)
	...
	if not var_19_3.GetItemById(var_19_6, var_19_5) or not var_8:GetCount() then
		var_19_7 = 0
	end
	...
	local var_19_9 = var_1_10013.New
	local var_19_10 = {}

	DROP_TYPE_ISLAND_ITEM = var_1_10016
	var_19_10.type = var_1_10016
	...
	local var_19_11 = arg_19_2:Find("icon_bg/count_bg/count")

	i18n = var_13

	var_19_6(var_19_11, var_13("island_production_hold", var_19_7))
...
function var_0_1.RefreshCurrentSelectFormula(arg_24_0)
	...
	var_24_2.type = var_1_10005
	var_24_2.id = var_24_0

	local var_24_3 = var_24_1(var_24_2)
	local var_24_4 = var_2.getConfigTable(var_24_3).rarity

	IslandItemRarity = var_24_2

	local var_24_5 = var_24_2.Rarity2FrameName(var_24_4)
	local var_24_6 = var_2:getConfigTable().icon

	onButton = var_6

	var_6(arg_24_0, arg_24_0.currentformulaIcon, function()
		local var_25_0 = arg_24_0
		local var_25_1 = var_0.ShowMsgBox
		local var_25_2 = {}

		i18n = var_2_10004
		var_25_2.title = var_2_10004("island_word_desc")
		IslandMsgBox = var_4
		var_25_2.type = var_4.TYPE_COMMON_DROP_DESCRIBE
	...
	local var_24_7 = "island/islandframe"
	local var_24_8 = var_24_5
	local var_24_9 = arg_24_0.currentformulaIcon

	var_6(var_24_7, var_24_8, var_10.Find(var_24_9, "icon_bg"))

	GetImageSpriteFromAtlasAsync = var_6

	local var_24_10 = "island/" .. var_24_6
	local var_24_11 = ""
	local var_24_12 = arg_24_0.currentformulaIcon

	var_6(var_24_10, var_24_11, var_10.Find(var_24_12, "icon_bg/icon"))
...
function var_0_1.GetAniExtraGainByConfigName(arg_26_0, arg_26_1)
	...
	local var_26_2 = var_26_1(var_1_10005)
	...
	for iter_26_0, iter_26_1 in var_26_5(var_26_7) do
		pg = var_1_10011
...
function var_0_1.RefreshCost(arg_27_0)
	...
	local var_27_0 = var_1(var_1_10003)
	local var_27_1 = var_1.GetIsland(var_27_0)
	local var_27_2 = var_1.GetInventoryAgency(var_27_1)
	local var_27_3 = arg_27_0:GetAniExtraGainByConfigName("efficiency_cost")

	ipairs = var_27_1

	for iter_27_0, iter_27_1 in var_27_1(arg_27_0.formulaCfg.commission_cost) do
		local var_27_4 = iter_27_1[1]

		if var_27_2:GetItemById(var_27_4) then
			local var_27_5 = var_9
			local var_27_6

			if not var_9.GetCount(var_27_5) then
				var_27_6 = 0
			end
			...
			local var_27_8 = var_27_5.New
			local var_27_9 = {
				count = 0
			}

			DROP_TYPE_ISLAND_ITEM = var_1_10015
			var_27_9.type = var_1_10015
			var_27_9.id = iter_27_1[1]
			var_27_9.itemCount = var_27_6
			var_27_9.costCount = iter_27_1[2] * var_27_7
			var_27_9.extraCostCount = var_27_3 * var_27_7

			local var_27_10 = var_27_8(var_27_9)

			table = var_1_10013

			var_1_10013.insert(arg_27_0.commission_Cost_List, var_27_10)
		end
	end

	local var_27_11 = arg_27_0.costuiList

	var_3.align(var_27_11, #arg_27_0.commission_Cost_List)
...
function var_0_1.CheckCanAddMaxTimes(arg_28_0)
	...
	local var_28_4 = arg_28_0:GetAniExtraGainByConfigName("efficiency_cost")

	ipairs = var_1_10004

	for iter_28_0, iter_28_1 in var_1_10004(arg_28_0.formulaCfg.commission_cost) do
		local var_28_5 = iter_28_1[1]

		if var_28_2:GetItemById(var_28_5) then
			local var_28_6 = var_10
			local var_28_7

			if not var_10.GetCount(var_28_6) then
				var_28_7 = 0
			end

			local var_28_8 = iter_28_1[2] + var_28_4

			math = var_28_6

			local var_28_9 = var_28_6.min
			local var_28_10 = var_28_3

			math = var_1_10016
			var_28_3 = var_28_9(var_28_10, var_1_10016.floor(var_28_7 / var_28_8))
		end
	end

	local var_28_11 = arg_28_0:GetOneFormulaEnergyCost()

	math = var_5

	local var_28_12 = var_5.min

	math = iter_28_0

	local var_28_13 = iter_28_0.floor
	local var_28_14 = arg_28_0.selectedShip

	return (var_28_12(var_28_13(var_9.GetCurrentEnergy(var_28_14) / var_28_11), var_28_3))
end
...
function var_0_1.RefreshCanStart(arg_29_0)
	...
	local function var_29_2()
		...
		if var_32_1.island_production_slot[arg_29_0.slotId].exclusion_slot ~= "" or not {} then
	...
	if var_29_0() and var_29_1() then
		...
		local function var_29_5()
			if arg_29_0.addDelegateFormula then
				...
				getProxy = var_33_0
				IslandProxy = var_2_10002
				var_2_10002 = var_33_0(var_2_10002)
				var_2_10002 = var_0.GetIsland(var_2_10002)
				var_2_10002 = var_0.GetBuildingAgency(var_2_10002)
				var_2_10003 = var_0.GetBuilding(var_2_10002, arg_29_0.placeId)

				if var_0.GetDelegationSlotData(var_2_10003, arg_29_0.slotId) and not var_1:GetSlotRoleData() then
					pg = var_2_10002

					local var_33_1 = var_2_10002.TipsMgr.GetInstance()

					var_2_10002 = var_2_10002.ShowTips
					i18n = var_2_10005

					var_2_10002(var_33_1, var_2_10005("island_additional_production_tip2"))
			...
			if arg_29_0.formulaToActivityDic[arg_29_0.selectFormulaId] then
				...
				if not var_1.getActivityById(var_2_10003, var_0) or var_1:isEnd() then
					pg = var_2_10002

					local var_33_2 = var_2_10002.TipsMgr.GetInstance()
					local var_33_3 = var_2.ShowTips

					i18n = var_2_10005

					var_33_3(var_33_2, var_2_10005("island_activity_expired"))

					return
				end
			end

			local var_33_4, var_33_5 = var_29_2()

			if var_33_4 then
				local var_33_6 = arg_29_0

				var_2_10003 = var_2_10003.ShowMsgBox

				local var_33_7 = {}

				IslandMsgBox = var_2_10007
				var_33_7.type = var_2_10007.TYPE_COMMON
				i18n = var_2_10007
				var_33_7.content = var_2_10007("island_production_manually_cancel")

				function var_33_7.onYes()
					pg = var_3_10000
					...
					var_34_1(var_34_0, var_3_10003.ISLAND_STOP_HANDLE_PLANT_HALFWAY, {
					...
					if arg_29_0.addDelegateFormula then
						...
						var_34_6(var_34_5, var_5.ADD_DELEGATION, arg_29_0.placeId, arg_29_0.slotId, var_34_4, var_34_3)
					else
				...
				function var_33_7.onNo()
					return
				end

				var_2_10003(var_33_6, var_33_7)
			...
			local var_33_9 = var_3.GetAniExtraGainByConfigName(var_33_8, "efficiency_cost")
			local var_33_10

			if arg_29_0.addDelegateFormula then
				var_33_10 = arg_29_0.curSelectCount - arg_29_0.addDelegateFormulaTimes
				var_2_10007 = arg_29_0

				local var_33_11 = var_5.emit

				IslandMediator = var_2_10008

				var_33_11(var_2_10007, var_2_10008.ADD_DELEGATION, arg_29_0.placeId, arg_29_0.slotId, var_33_10, var_33_9)
			else
				local var_33_12 = arg_29_0

				var_33_10 = var_33_10.emit
				IslandMediator = var_2_10007

				var_33_10(var_33_12, var_2_10007.START_DELEGATION, arg_29_0.placeId, arg_29_0.slotId, arg_29_0.selectedShipId, arg_29_0.selectFormulaId, arg_29_0.curSelectCount, var_33_9)
			end

			existCall = var_33_10

			var_33_10(arg_29_0.confirmFunc)

			local var_33_13 = arg_29_0

			var_4.Hide(var_33_13)
		...
		var_4(var_29_3, var_29_4, var_29_5, var_1_10009)
	else
		setActive = var_4
		...
		local function var_29_8()
			...
			var_36_1(var_36_0, var_2_10003("island_production_cost_notenough"))
		...
		var_4(var_29_6, var_29_7, var_29_8, var_1_10009)
	end
...
function var_0_1.OnShow(arg_37_0, arg_37_1)
	...
	if arg_37_0.addDelegateFormulaTimes then
		...
		local var_37_0 = arg_37_0.addDelegateFormulaTimes / var_1_10003 * 352.6
		local var_37_1 = arg_37_0.barLimit

		Vector2 = var_1_10006
		var_37_1.sizeDelta = var_1_10006(var_37_0, 22)
		setActive = var_37_1

		var_37_1(arg_37_0.addCountTips, true)
	else
		setActive = var_2
	...
	if arg_37_0.addDelegateFormulaTimes then
		...
		if not var_37_2("island_additional_production_tip1") then
			i18n = var_37_2
			var_37_2 = var_37_2("island_production_start")
		end

		setText = var_1_10003

		local var_37_3 = arg_37_0.sureBtn

		var_1_10003(var_5.Find(var_37_3, "adapt/time/Text"), var_37_2)

		pg = var_1_10003
		arg_37_0.slotId = var_1_10003.island_production_commission[arg_37_0.commissionId].slot
		pg = var_3
		arg_37_0.placeId = var_3.island_production_slot[arg_37_0.slotId].place
		getProxy = var_3
		IslandProxy = var_5

		local var_37_4 = var_3(var_5)
		local var_37_5 = var_3.GetIsland(var_37_4)
		local var_37_6 = var_3.GetCharacterAgency(var_37_5)

		arg_37_0.selectedShip = var_4.GetShipById(var_37_6, arg_37_0.selectedShipId)
		...
		if #arg_37_0.formulaList > 0 then
			...
			arg_37_0:OnSelectFormulaIndex(var_37_7)
			...
			var_6(function()
				...
				local var_38_4 = var_3.min((var_37_7 - 1) * var_38_3, var_38_1)

				setAnchoredPosition = var_38_2
			...
			local var_37_8 = arg_37_0.uiList

			var_5.align(var_37_8, #arg_37_0.formulaList)
...
function var_0_1.RefreshShip(arg_39_0)
	...
	var_1_10002("SquareIcon/" .. var_39_0, "", arg_39_0.selectShipIcon)
	...
	var_1_10002(var_39_1, var_5.GetName(var_39_2))
	...
	local var_39_4 = var_5.format
	local var_39_5 = "-Lv.%d"
	local var_39_6 = arg_39_0.selectedShip

	var_1_10002(var_39_3, var_39_4(var_39_5, var_8.GetLevel(var_39_6)))
	...
	var_39_7(arg_39_0.skillInUse, var_39_9)

	setActive = var_39_7

	var_39_7(arg_39_0.skillUnUse, not var_39_9)
	...
	string = var_39_8
	var_39_10.text = var_39_8.format("%s - %s", var_2:GetName(), "Lv." .. var_2:GetLevel() .. "")
...
function var_0_1.RefreshShipEnergy(arg_40_0)
	...
	arg_40_0.eneryTimer = var_4.New(function()
		...
		var_41_0(arg_40_0.energyBarTf, 0, 1, (var_41_1 - var_40_1) / var_41_3)

		setSlider = var_41_0

		var_41_0(arg_40_0.energyBarUseTf, 0, 1, var_41_1 / var_41_3)
		...
		var_41_0(var_41_4, var_5.format("%d-<color=#f7c35f>%d</color>/%d", var_41_1, var_40_1, var_41_3))
...
function var_0_1.InitUnlockedFormulaList(arg_42_0)
	...
	local var_42_0 = var_1(var_1_10003)
	...
	if not var_1_10004.island_production_slot[arg_42_0.slotId].activity_formula then
		var_42_3 = {}
	end

	for iter_42_0, iter_42_1 in var_1_10002(var_42_3) do
		...
		if var_1_10009.getActivityById(var_1_10011, var_1_10007) then
			var_1_10012 = var_1_10009

			if not var_1_10009.isEnd(var_1_10012) then
				ipairs = var_1_10010
				var_1_10012 = var_1_10008 or {}

				for iter_42_2, iter_42_3 in var_1_10010(var_1_10012) do
					pg = var_1_10015
					var_1_10015 = var_1_10015.island_formula[iter_42_3].unlock_type == 0

					if var_1_10015 or var_42_2:IsUnlockFormuate(iter_42_3) then
						table = var_1_10017
	...
	if not var_4.island_production_slot[arg_42_0.slotId].formula then
		var_42_4 = {}
	end

	for iter_42_4, iter_42_5 in var_2(var_42_4) do
		pg = var_1_10007
		...
		if var_1_10008 then
			...
			IslandProxy = iter_42_2
			iter_42_2 = var_1_10011(iter_42_2)
			iter_42_2 = var_1_10011.GetIsland(iter_42_2)
			iter_42_2 = var_1_10011.GetBuildingAgency(iter_42_2)
			var_1_10011 = var_1_10011.GetFormulaNums(iter_42_2)
			ipairs = var_1_10012

			for iter_42_6, iter_42_7 in var_1_10012(var_1_10010) do
				local var_42_6 = iter_42_7[1]
				local var_42_7 = iter_42_7[2]

				if not var_1_10011[var_42_6] or var_42_7 > var_1_10011[var_42_6] then
					var_42_5 = false
		...
		if not var_1_10007 then
			...
			var_1_10012 = var_42_2

			if not var_42_2.IsUnlockFormuate(var_1_10012, iter_42_5) then
				var_1_10010 = var_1_10008 and var_42_5
			end
		end
...
function var_0_1.RefreshCurSelectCount(arg_43_0)
	...
	var_1_10002(var_43_1, var_1_10005(var_43_0))
	...
	var_1_10003(arg_43_0.addCountTips, "+" .. var_43_2)

	setSlider = var_1_10003

	var_1_10003(arg_43_0.curCountNumSlider, 1, arg_43_0.productMaxTime, arg_43_0.curSelectCount)
	...
	local var_43_6 = var_7.Find(var_43_5, "icon_bg/product_count_bg/product_count")
	local var_43_7 = var_43_3

	i18n = var_43_5

	var_5(var_43_6, var_43_7 .. var_43_5("island_production_tip"))
	...
	if 0 < var_43_11 then
		...
		local var_43_17 = var_1_10014.TimeMgr.GetInstance()

		var_43_13 = var_43_14(var_43_15, var_43_16, var_14.DescCDTime(var_43_17, var_43_11))
	end
...
function var_0_1.RefreshExtraProduct(arg_44_0)
	...
	local var_44_6 = var_5.New
	local var_44_7 = {
		count = 0
	}

	DROP_TYPE_ISLAND_ITEM = var_1_10008
	var_44_7.type = var_1_10008
	...
	var_1_10006(arg_44_0, arg_44_0.extraProductIcon, function()
		local var_45_0 = arg_44_0
		local var_45_1 = var_0.ShowMsgBox
		local var_45_2 = {}

		i18n = var_2_10004
		var_45_2.title = var_2_10004("island_word_desc")
		IslandMsgBox = var_4
		var_45_2.type = var_4.TYPE_COMMON_DROP_DESCRIBE
	...
	var_1_10006("island/" .. var_44_5.icon, "", arg_44_0.extraProductIcon)
	...
	var_8(var_44_11, var_44_12 .. var_1_10012("island_production_tip"))
...
function var_0_1.CacaluteProductTime(arg_46_0)
	...
	IslandProductTimeHelper = var_1_10004

	return var_1_10004.CalculateTimeToProductFormula(arg_46_0.selectedShipId, arg_46_0.selectFormulaId, var_46_0, arg_46_0.placeId, arg_46_0.slotId), var_46_2 * var_46_0
end
...
function var_0_1.GetAttrGrade(arg_48_0, arg_48_1)
	...
	for iter_48_0, iter_48_1 in var_3(var_1_10005.island_chara_att.all) do
		pg = var_1_10008
...
function var_0_1.GetOneFormulaEnergyCost(arg_50_0)
	...
	IslandProductCostHelper = var_1_10004

	local var_50_2 = var_50_0(var_50_1 * (1 - var_1_10004.GetReducePercentInPlace(arg_50_0.selectedShipId, arg_50_0.placeId)))

	math = var_1_10002

	return (var_1_10002.max(var_50_2, 1))
end
