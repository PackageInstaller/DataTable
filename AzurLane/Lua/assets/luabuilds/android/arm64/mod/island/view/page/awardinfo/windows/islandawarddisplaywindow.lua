...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_5 = var_3.Find(var_2_4, "frame/Board/Content/award/content")
	local var_2_6 = arg_2_0._tf

	arg_2_0.uiitemList = var_2_3(var_2_5, var_4.Find(var_2_6, "frame/Board/Content/award/content/tpl"))
	setText = var_1
	...
	var_1(var_2_8, var_4("island_click_close"))
	...
	typeof = var_4
	Animation = var_6
	arg_2_0.animator = var_2_10(var_2_9, var_4(var_6))
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_2_0.aniDft = var_2_12(var_2_11, var_4(var_6))
...
function var_0_1.Show(arg_5_0, arg_5_1)
	...
	var_5_0.text = var_1_10003(var_5_1, var_5_2)
...
function var_0_1.OnUpdateItem(arg_6_0, arg_6_1, arg_6_2)
	...
	var_5(var_7(var_6_0, "icon_bg/count_bg/count"), "x" .. var_6_1.count)
...
function var_0_1.UpdateAwards(arg_7_0, arg_7_1)
	...
	var_3(var_5.Find(var_7_2, "frame/Board/Content/award_scroll"), var_7_1)

	setActive = var_3

	local var_7_3 = arg_7_0._tf

	var_3(var_5.Find(var_7_3, "frame/Board/Content/award"), not var_7_1)
	...
	if var_7_1 then
		...
		var_3.make(var_7_5, function(arg_8_0, arg_8_1, arg_8_2)
			...
			if arg_8_0 == var_2_10003.EventUpdate then
				...
				var_4(var_6(arg_8_2, "icon_bg/count_bg/count"), "x" .. var_8_0.count)
			end
