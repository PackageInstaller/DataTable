...
function var_0_0.Build(arg_2_0, arg_2_1, arg_2_2)
	...
	var_1_10004(arg_2_0.unitListType)
	...
	var_2_0({
		...
		function(arg_5_0)
			...
			var_1.LoadTimeline(var_5_0, var_2_2, var_2_1, arg_2_1, arg_5_0)
		...
		function(arg_6_0)
			...
			var_1.LoadOtherPart(var_6_0, var_2_2, var_2_1, arg_2_1, arg_6_0)
		...
		var_0.AddTypeAndID(var_7_0, var_2_2, var_2_1)

		local var_7_1 = arg_2_0

		var_0.AddComponents(var_7_1, var_2_2, arg_2_1)

		local var_7_2 = arg_2_0

		var_0.SetTag(var_7_2, var_2_2)

		local var_7_3 = var_2_1

		var_0.Init(var_7_3, var_2_2, arg_2_0)
