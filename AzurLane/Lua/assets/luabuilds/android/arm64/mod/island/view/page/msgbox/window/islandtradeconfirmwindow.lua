...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.count = var_2_11(var_2_10, var_4(var_1_10006))
	...
	local var_2_18 = var_3.Find(var_2_17, "itemList/Viewport/Content")
	local var_2_19 = arg_2_0.panel

	arg_2_0.bottomItemList = var_2_16(var_2_18, var_4.Find(var_2_19, "itemList/Viewport/Content/IslandItemTpl"))
	...
	typeof = var_4
	Text = var_2_19
	arg_2_0.consumeCount = var_2_24(var_2_23, var_4(var_2_19))
	setText = var_1

	local var_2_25 = arg_2_0._tf
	local var_2_26 = var_3.Find(var_2_25, "panel/getDesc")

	i18n = var_4

	var_1(var_2_26, var_4("island_3Dshop_buy_tip0"))
...
function var_0_1.OnInit(arg_3_0)
	...
	var_1_10001(var_3_6, var_3_7, var_3_8, var_3_9, var_3_10, var_3_11, var_3_12, var_1_10010)
	...
	var_1_10001(var_3_13, var_3_14, var_3_15, var_3_16, var_3_17, var_3_18, var_3_19, var_1_10010)
	...
	var_1_10001(var_3_20, var_3_21, var_3_22, var_3_23, var_3_24, var_3_25, var_3_26, var_1_10010)
	...
	var_1_10001(var_3_27, var_3_28, var_3_29, var_3_30, var_3_31, var_3_32, var_3_33, var_1_10010)
	...
	var_1.make(var_3_34, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			if var_10_2 == var_2_10006.TRADE_PURCHASE then
				setText = var_10_2
	...
	local function var_3_37()
		if arg_3_0.curCount <= 0 then
			...
			if var_11_0 == var_2_10002.TRADE_PURCHASE then
				pg = var_11_0
				var_2_10003 = var_11_0.TipsMgr.GetInstance()

				local var_11_1 = var_1.ShowTips

				i18n = var_2_10004

				var_11_1(var_2_10003, var_2_10004("island_trade_cnt_inadequate"))
			else
				local var_11_2 = var_0.mode

				IslandConst = var_2

				if var_11_2 == var_2.TRADE_SELL then
					pg = var_11_2
					var_2_10003 = var_11_2.TipsMgr.GetInstance()

					local var_11_3 = var_1.ShowTips

					i18n = var_2_10004

					var_11_3(var_2_10003, var_2_10004("island_trade_sell_failed_label"))
				end
			end
		...
		if arg_3_0.settings.maxCnt < var_11_4 then
			...
			if var_11_5 == var_1.TRADE_PURCHASE then
				...
				var_11_5(var_11_6, var_2_10003("island_trade_purchase_failed_label"))
			else
				settings = var_11_5
				...
				if var_11_7 == var_1.TRADE_SELL then
					pg = var_11_7
					...
					var_11_9(var_11_8, var_2_10003("island_trade_sell_failed_label2"))
				end
			end
...
function var_0_1.OnShow(arg_12_0)
	...
	var_12_3.id = var_1_10005.PEARL_ID

	local var_12_4 = var_12_2(var_12_3)

	IslandItem = var_1_10003

	local var_12_5 = var_1_10003.New
	local var_12_6 = {}

	IslandItem = var_1_10006
	var_12_6.id = var_1_10006.GOLD_ID

	local var_12_7 = var_12_5(var_12_6)
	local var_12_8 = var_1.mode

	IslandConst = var_12_6

	if var_12_8 == var_12_6.TRADE_PURCHASE then
		setText = var_12_8

		local var_12_9 = arg_12_0._tf
		local var_12_10 = var_6.Find(var_12_9, "panel/title")

		i18n = var_1_10007

		var_12_8(var_12_10, var_1_10007("island_trade_purchase_sub_label"))

		setText = var_12_8

		local var_12_11 = arg_12_0._tf
		local var_12_12 = var_6.Find(var_12_11, "panel/buyBtn/text")

		i18n = var_1_10007

		var_12_8(var_12_12, var_1_10007("island_trade_purchase_sub_label"))
		...
		if var_12_8 == var_5.TRADE_SELL then
			setText = var_12_8

			local var_12_13 = arg_12_0._tf
			local var_12_14 = var_6.Find(var_12_13, "panel/title")

			i18n = var_1_10007

			var_12_8(var_12_14, var_1_10007("island_trade_sell_sub_label"))

			setText = var_12_8

			local var_12_15 = arg_12_0._tf
			local var_12_16 = var_6.Find(var_12_15, "panel/buyBtn/text")

			i18n = var_7

			var_12_8(var_12_16, var_7("island_trade_sell_sub_label"))
...
function var_0_1.UpdateCount(arg_13_0, arg_13_1)
	...
	math = var_1_10005
	arg_13_0.curCount = var_13_0(var_13_1, var_1_10005.max(0, arg_13_1))
