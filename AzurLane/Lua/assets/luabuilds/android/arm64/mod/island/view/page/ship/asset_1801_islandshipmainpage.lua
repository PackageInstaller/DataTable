...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_23 = var_3.Find(var_2_22, "top/title/Text")

	i18n = var_4

	var_1(var_2_23, var_4("island_chara_totalname"))

	setText = var_1

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_3.Find(var_2_24, "top/title/Text/en")

	i18n = var_4

	var_1(var_2_25, var_4("island_chara_totalname_en"))
...
function var_0_1.AddListeners(arg_6_0)
	...
	IslandShipMainPage = var_4

	var_6_1(var_6_0, var_4.SELECT_SHIP, arg_6_0.OnSelectShip)
	...
	var_6_3(var_6_2, var_4.ADD_SHIP, arg_6_0.OnAddShip)
	...
	var_6_5(var_6_4, var_4.ISLAND_UPGRADE_SKILL_DONE, arg_6_0.OnSkillUpgrade)
...
function var_0_1.RemoveListeners(arg_7_0)
	...
	var_7_1(var_7_0, var_4.SELECT_SHIP, arg_7_0.OnSelectShip)
	...
	var_7_3(var_7_2, var_4.ADD_SHIP, arg_7_0.OnAddShip)
	...
	var_7_5(var_7_4, var_4.ISLAND_UPGRADE_SKILL_DONE, arg_7_0.OnSkillUpgrade)
...
function var_0_1.OnInit(arg_14_0)
	...
	local var_14_2 = var_4.Find(var_14_1, "top/title/help")
	...
	local function var_14_3()
		...
		pg = var_2_10004
		var_15_2.helps = var_2_10004.gametip.island_help_character_info.tip
	...
	var_1_10001(var_14_7, var_14_8, var_14_9, var_14_1)
	...
	local function var_14_12()
		...
		IslandDockPage = var_2_10003

		local var_19_2 = arg_14_0

		var_19_1(var_19_0, var_2_10003, var_4.GetNeedHideUnlockShipFlag(var_19_2))
	...
	var_1_10001(var_14_10, var_14_11, var_14_12, var_14_1)
	...
	for iter_14_0, iter_14_1 in var_1_10001(arg_14_0.toggles) do
		...
		var_14_1(var_14_13, var_14_14, var_14_15, var_1_10011)
	end
...
function var_0_1.UpdateUnlockView(arg_38_0, arg_38_1)
	...
	i18n = var_1_10007
	var_38_3.content = var_1_10007("island_open_ship_tip")
	...
	function var_38_3.onYes()
		...
		local var_39_3 = var_2_10003.SWITCH_MAP

		IslandConst = var_2_10004

		local var_39_4 = var_2_10004.LABORATORY_MAP_ID

		IslandConst = var_2_10005

		var_39_2(var_39_1, var_39_3, var_39_4, var_2_10005.LETTEROFINVITATION_SP)
...
function var_0_1.SetObjInitRotaion(arg_45_0, arg_45_1)
	...
	var_45_0, GetOrAddComponent = arg_45_0:GetSmoothRotateObject(), var_1_10003
	typeof = var_1_10006
	SmoothRotateObject = var_1_10008

	local var_45_1 = var_1_10003(var_45_0, var_1_10006(var_1_10008))

	var_45_1.rotationSpeed = 5
	ReflectionHelp = var_4

	local var_45_2 = var_4.RefSetProperty

	typeof = var_6
	SmoothRotateObject = var_1_10008

	var_45_2(var_6(var_1_10008), "targetRotation", var_45_1, arg_45_1)

	if arg_45_0.timer then
		local var_45_3 = arg_45_0.timer
