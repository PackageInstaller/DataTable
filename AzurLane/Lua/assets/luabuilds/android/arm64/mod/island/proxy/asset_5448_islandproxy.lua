...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(21216, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in var_2_10002(arg_2_0.visitor_list) do
...
function var_0_1.AddChatMsg(arg_3_0, arg_3_1, arg_3_2)
	...
	var_3_2(var_3_1, var_6.CHAT_MSG_UPDATE, {
		islandId = arg_3_1,
		msg = arg_3_2
	})
...
function var_0_1.ShouldTip(arg_8_0)
	local function var_8_0()
		...
		return var_0.GetIsland(var_9_0) and var_0:CanLevelUp()
	end

	local function var_8_1()
		local var_10_0 = arg_8_0

		return var_0.GetIsland(var_10_0) and var_0:AnyProsperityAwardCanGet()
	end
...
function var_0_1.UpdateGiftTagCache(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	if arg_16_0:GetGiftTagInfoCache(arg_16_1) then
		var_4:Flush(arg_16_2, arg_16_3)
	else
		IslandGiftTagInfo = var_1_10005

		local var_16_0 = var_1_10005.New({
			key = arg_16_1,
			value1 = arg_16_3,
			value2 = arg_16_2
		})

		arg_16_0:AddGiftTagInfoCache(var_16_0)
	end
