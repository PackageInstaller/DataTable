	...
	},
	{
		...
		condition = function()
			...
			if var_7_3 then
				...
				IslandTechnology = var_7_2

				if var_7_6 ~= var_7_2.STATUS.LOCK then
					IslandTechnology = var_7_2

					if var_7_6 ~= var_7_2.STATUS.UNLOCK then
						IslandTechnology = var_7_2

						if var_7_6 ~= var_7_2.STATUS.NORMAL then
							var_7_2 = false
...
function var_0_0._PlayGuide(arg_26_0, arg_26_1, arg_26_2, arg_26_3)
	...
	if arg_26_1 and arg_26_1 == var_0_0.FINISH_TYPE.ON_BEGIN then
		...
		var_26_3(var_26_2, var_7.STORY_UPDATE, {
			storyId = arg_26_0
		})
	end
	...
	if var_26_3 then
		...
		var_26_3(var_26_4, var_7.START_GUIDE)
	end
	...
	var_4.Play(var_26_5, arg_26_0, arg_26_3, function()
		...
		if var_2_10000 then
			...
			var_27_1(var_27_0, var_2_10003.END_GUIDE)
		end
		...
		if arg_26_1 and arg_26_1 == var_0_0.FINISH_TYPE.ON_END then
			...
			var_27_3(var_27_2, var_2_10003.STORY_UPDATE, {
				storyId = arg_26_0
			})
		end
...
function var_0_0.Record(arg_29_0, arg_29_1, arg_29_2)
	...
	local var_29_2 = var_29_0.GameTrackerMgr.GetInstance()
	local var_29_3 = var_5.Record

	GameTrackerBuilder = var_1_10008

	var_29_3(var_29_2, var_1_10008.BuildIslandGuide(arg_29_0, var_29_1, arg_29_2))
