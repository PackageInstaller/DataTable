...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("Mod.Island.Core.Builder.IslandGenericBuilder"))
...
function var_0_1.Build(arg_2_0, arg_2_1, arg_2_2)
	...
	var_1_10004(var_2_1, arg_2_0.root)
	...
	var_2_3:SetUnitType(arg_2_0.unitListType)
	...
	var_2_2({
		...
		function(arg_5_0)
			...
			var_5_1(var_5_0, var_5_2, var_5.GetBt(var_5_3), arg_5_0)
		...
		var_0.Init(var_6_3, var_2_4, arg_2_0)
