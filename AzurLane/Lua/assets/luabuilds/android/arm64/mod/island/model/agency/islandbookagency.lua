...
function var_0_1.OnInit(arg_1_0, arg_1_1)
	...
	for iter_1_6, iter_1_7 in var_5(var_7.island_illustrated_guide.all) do
		...
		var_1_10012 = arg_1_0:CreateClass(var_1_10010, iter_1_7)
		table = iter_1_4

		if iter_1_4.contains(var_1_1, iter_1_7) then
			local var_1_4 = var_1_10012

			iter_1_4 = var_1_10012.SetStatus
			IslandIllustration = var_16

			iter_1_4(var_1_4, var_16.STATUS.UNLOCK)
		elseif var_1_2[var_1_10010] and var_1_2[var_1_10010][var_1_3] then
			...
			iter_1_4(var_1_5, var_16.STATUS.CAN_UNLOCK)
		end

		iter_1_4 = arg_1_0.dataMap[var_1_10010]
		iter_1_4[var_1_3] = var_1_10012
	end

	arg_1_0:SetPointDatas(var_1_0.book_collects)

	local var_1_6 = arg_1_0
	local var_1_7 = arg_1_0.SetRecordDatas
	local var_1_8
	...
	for iter_1_8, iter_1_9 in var_5(var_1_6.island_collection_reward.get_id_list_by_type) do
		arg_1_0.pointAwardGotMaps[iter_1_8] = {}

		local var_1_9 = arg_1_0.pointAwardIdsMaps

		var_1_9[iter_1_8] = iter_1_9
		table = var_1_9

		local var_1_10 = var_1_9.sort

		var_1_10012 = arg_1_0.pointAwardIdsMaps[iter_1_8]
		CompareFuncs = iter_1_4

		var_1_10(var_1_10012, iter_1_4({
			function(arg_2_0)
				pg = var_2_10001
	...
	local var_1_11 = var_5.island_collection_reward

	ipairs = var_6

	for iter_1_10, iter_1_11 in var_6(var_1_0.book_awards) do
		local var_1_12 = var_1_11[iter_1_11].type

		table = var_1_10012

		var_1_10012.insert(arg_1_0.pointAwardGotMaps[var_1_12], iter_1_11)
	end
...
function var_0_1.SetRecordDatas(arg_9_0, arg_9_1)
	...
	IslandIllustration = iter_9_0

	local var_9_2

	if not var_9_1[iter_9_0.TYPES.ITEM] then
		var_9_2 = {}
	end
...
function var_0_1.InitShipTypeData(arg_12_0)
	...
	if not var_12_3[var_1_10005.TYPES.CHAR] then
		var_12_4 = {}
	end

	for iter_12_0, iter_12_1 in var_1_10002(var_12_4) do
		if var_12_2:GetShipById(iter_12_1:GetLinkConfigID()) then
			local var_12_5 = iter_12_1:GetStatus()

			IslandIllustration = var_1_10008

			if var_12_5 == var_1_10008.STATUS.UNLOCK then
				iter_12_1:CheckTip()
			else
				IslandIllustration = var_1_10008

				if var_12_5 == var_1_10008.STATUS.LOCK then
					local var_12_6 = iter_12_1

					var_1_10008 = iter_12_1.SetStatus
					IslandIllustration = var_1_10011

					var_1_10008(var_12_6, var_1_10011.STATUS.CAN_UNLOCK)
				end
			end
		end
	end
...
function var_0_1.InitFishTypeData(arg_13_0)
	...
	if not var_13_3[var_1_10005.TYPES.FISH] then
		var_13_4 = {}
	end

	for iter_13_0, iter_13_1 in var_1_10002(var_13_4) do
		if var_13_2:GetFish(iter_13_1:GetLinkConfigID()) then
			local var_13_5 = iter_13_1:GetStatus()

			IslandIllustration = var_1_10008

			if var_13_5 == var_1_10008.STATUS.UNLOCK then
				iter_13_1:CheckTip()
			else
				IslandIllustration = var_1_10008

				if var_13_5 == var_1_10008.STATUS.LOCK then
					local var_13_6 = iter_13_1

					var_1_10008 = iter_13_1.SetStatus
					IslandIllustration = var_1_10011

					var_1_10008(var_13_6, var_1_10011.STATUS.CAN_UNLOCK)
				end
			end
		end
	end
...
function var_0_1.GetCurPointInfos(arg_23_0, arg_23_1)
	...
	local var_23_1 = arg_23_0.GetCurLevelPointAwardId(var_23_0, arg_23_1)
	local var_23_2 = arg_23_0:GetAllPoints(arg_23_1)

	pg = var_23_0

	return var_23_2, var_23_0.island_collection_reward[var_23_1].need_exp
end
...
function var_0_1.AddCanUnlock(arg_24_0, arg_24_1, arg_24_2)
	...
	var_24_1(var_24_0, var_1_10006.STATUS.CAN_UNLOCK)
...
function var_0_1.HandlePushData(arg_25_0, arg_25_1)
	...
	for iter_25_0, iter_25_1 in var_1_10003(arg_25_1) do
		if arg_25_0.dataMap[var_25_0][iter_25_1.id] then
			local var_25_1 = var_8:GetStatus()

			IslandIllustration = var_1_10010

			if var_25_1 == var_1_10010.STATUS.LOCK then
...
function var_0_1.AddUnlock(arg_26_0, arg_26_1)
	...
	for iter_26_0, iter_26_1 in var_1_10002(arg_26_1) do
		...
		IslandIllustration = var_1_10012

		var_26_2(var_26_1, var_1_10012.STATUS.UNLOCK)
...
function var_0_1.OnAddNewShip(arg_29_0, arg_29_1)
	...
	if var_29_0[var_1_10003.TYPES.CHAR][arg_29_1] then
		...
		var_29_2(var_29_1, var_1_10006.STATUS.CAN_UNLOCK)
	end
...
function var_0_1.OnFishingEnd(arg_31_0, arg_31_1)
	...
	if var_31_2[var_3.TYPES.FISH][arg_31_1] then
		local var_31_3 = var_2:GetStatus()

		IslandIllustration = var_1_10004

		if var_31_3 == var_1_10004.STATUS.LOCK then
			local var_31_4 = arg_31_0
			local var_31_5 = arg_31_0.AddCanUnlock

			IslandIllustration = var_1_10007

			var_31_5(var_31_4, var_1_10007.TYPES.FISH, arg_31_1)
		end
	...
	for iter_32_0, iter_32_1 in var_1_10002(arg_32_1) do
		...
		if iter_32_1 == var_1_10007.TYPES.FISH then
			...
			if var_1_10007.IsUnlock("book_fish") then
				...
				if not arg_32_0.IsGotAllPointAward(var_32_1, iter_32_1) and var_32_0 <= var_1_10007 then
					return true
				end
