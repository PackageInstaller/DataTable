...
function var_0_1.InitHudHeight(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10002(var_1_10004.island_set.information_hud_height.key_value_varchar[1]) do
...
function var_0_1.UpdateHudDisplay(arg_9_0)
	...
	if arg_9_0.hudInfo.hudState then
		...
		var_1_10002(arg_9_0.timeTF, true)
...
function var_0_1.UpdateTime(arg_11_0, arg_11_1)
	...
	if arg_11_1.stateEndTime then
		...
		if 0 < var_11_2 then
			...
			var_3(var_11_3, var_6.DescCDTime(var_11_4, var_11_2))
		end
	end
...
function var_0_1.LateUpdate(arg_13_0)
	...
	local var_13_1 = var_13_0 + var_1_10002(0, arg_13_0.height, 0)
