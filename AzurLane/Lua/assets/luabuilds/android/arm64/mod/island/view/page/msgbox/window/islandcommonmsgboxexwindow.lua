...
local var_0_0 = "IslandCommonMsgboxEXWindow"
...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_1_10004
	Text = var_1_10006
	arg_2_0.titleTxt = var_2_1(var_2_0, var_1_10004(var_1_10006))

	local var_2_2 = arg_2_0.rtContext

	arg_2_0.contentTxt = var_1.GetComponent(var_2_2, "RichText")

	local var_2_3 = arg_2_0.rtCancelText
	local var_2_4 = var_1.GetComponent

	typeof = var_4
	Text = var_1_10006
	arg_2_0.cancelTxt = var_2_4(var_2_3, var_4(var_1_10006))

	local var_2_5 = arg_2_0.rtConfirmText
	local var_2_6 = var_1.GetComponent

	typeof = var_4
	Text = var_1_10006
	arg_2_0.confirmTxt = var_2_6(var_2_5, var_4(var_1_10006))
...
function var_0_1.OnShow(arg_7_0)
	...
	local var_7_5 = arg_7_0.contentTxt
	local var_7_6

	if not var_1.alignment then
		TextAnchor = var_7_6
		var_7_6 = var_7_6.MiddleCenter
	end

	var_7_5.alignment = var_7_6
