...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("..IslandASynLoadSubView"))
...
function var_0_1.FirstFlush(arg_4_0)
	...
	local var_4_3 = var_3.Find(var_4_2, "top/channels")
	local var_4_4 = arg_4_0._tf

	arg_4_0.uiChannelList = var_4_1(var_4_3, var_4.Find(var_4_4, "top/channels/tpl"))
	...
	typeof = var_4
	Text = var_4_4
	arg_4_0.sendChanncelTxt = var_4_8(var_4_7, var_4(var_4_4))
	...
	typeof = var_4
	Text = var_4_4
	arg_4_0.roomNumTxt = var_4_11(var_4_10, var_4(var_4_4))
	...
	typeof = var_4
	InputField = var_4_4
	arg_4_0.inputField = var_4_18(var_4_17, var_4(var_4_4))
	UIItemList = var_1

	local var_4_19 = var_1.New
	local var_4_20 = arg_4_0._tf
	local var_4_21 = var_3.Find(var_4_20, "send_panel/channel_sel_panel")
	local var_4_22 = arg_4_0._tf

	arg_4_0.uiSendChanncelList = var_4_19(var_4_21, var_4.Find(var_4_22, "send_panel/channel_sel_panel/tpl"))
...
function var_0_1.RegisterEvent(arg_5_0)
	...
	local function var_5_5()
		local var_8_0 = {
			emojiIconCallback = function(arg_9_0)
				...
				var_9_0.text = var_9_1 .. var_9_2(var_3_10005.EmojiIconCode, "code", arg_9_0)
			...
			callback = function(arg_10_0)
				...
				IslandBaseMediator = var_4

				local var_10_2 = var_4.SEND_CHAT
				local var_10_3 = arg_5_0.sendChannelValue

				string = var_3_10006

				local var_10_4 = var_3_10006.gsub

				ChatConst = var_3_10008

				var_10_1(var_10_0, var_10_2, var_10_3, var_10_4(var_3_10008.EmojiCode, "code", arg_10_0))
	...
	local function var_5_8()
		...
		var_11_2(var_11_1, var_4.SEND_CHAT, arg_5_0.sendChannelValue, var_11_0)
...
function var_0_1.OnSettingEnd(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	if arg_15_0.chatRoomId ~= arg_15_3 then
		...
		var_15_1(var_15_0, var_1_10007.CHANGE_CHAT_ROOM, arg_15_3)
	end
...
function var_0_1.InitRoomNum(arg_16_0)
	...
	if var_16_1 == 0 then
		...
		if not var_16_0("common_not_enter_room") then
			var_16_3 = var_16_1
		end
		...
		if arg_18_0 == var_2_10003.EventUpdate then
			...
			local function var_18_3()
				...
				if var_19_0 == var_3_10001.CHANNEL_GUILD then
					...
					local var_19_1 = var_19_0(var_3_10002)
			...
			var_4(var_18_1, var_18_2, var_18_3, var_2_10009)
			...
			local var_18_5 = arg_18_2:Find("Text")

			setColorStr = var_18_3

			var_2_10005(var_18_5, var_18_3(var_18_4, var_18_0 == arg_17_0.sendChannelValue and "#5ccaff" or "#ffffff"))
		end
	...
	var_2.eachActive(var_25_1, function(arg_26_0, arg_26_1)
		...
		if not (var_26_0 == var_4.CHANNEL_ALL) or not var_26_2 then
			...
			if not var_4 and not var_26_2 then
				...
				var_2_10006(arg_26_1.Find(var_26_3, "sel"), var_2_10005)

				IslandChatConst = var_2_10006

				local var_26_4 = var_2_10006.CHANNEL2CN(var_26_0)

				setText = var_2_10007

				local var_26_5 = arg_26_1:Find("Text")

				setColorStr = var_26_3

				var_2_10007(var_26_5, var_26_3(var_26_4, var_2_10005 and "#393a3c" or "#FFFFFF"))
...
function var_0_1.InitChatMsg(arg_30_0, arg_30_1)
	...
	IslandChatConst = var_1_10005

	if var_30_1(var_30_0, var_1_10005.CHANNEL_WORLD) then
		getProxy = var_2
		ChatProxy = var_30_0
		...
		_ = var_1_10003
		var_1_10003 = var_1_10003.each
		var_1_10007 = var_30_2

		var_1_10003(var_30_2.getRawData(var_1_10007), function(arg_31_0)
	...
	local var_30_4 = arg_30_0.MatchChannel

	IslandChatConst = var_5

	local var_30_5

	if var_30_4(var_30_3, var_5.CHANNEL_GUILD) then
		getProxy = var_2
		GuildProxy = var_30_3
		var_30_5 = var_2(var_30_3)

		if var_2.getRawData(var_30_5) then
			_ = var_1_10003
			var_1_10003 = var_1_10003.each
			var_1_10007 = var_2

			var_1_10003(var_2.getChatMsgs(var_1_10007), function(arg_32_0)
	...
	local var_30_7 = arg_30_0.MatchChannel

	IslandChatConst = var_30_5

	if var_30_7(var_30_6, var_30_5.CHANNEL_FRIEND) then
		getProxy = var_2
		FriendProxy = var_30_6

		local var_30_8 = var_2(var_30_6)

		_ = var_1_10003
		var_1_10003 = var_1_10003.each
		var_1_10007 = var_30_8

		var_1_10003(var_30_8.getCacheMsgList(var_1_10007), function(arg_33_0)
	...
	local var_30_10 = arg_30_0.MatchChannel

	IslandChatConst = var_5

	local var_30_12

	if var_30_10(var_30_9, var_5.CHANNEL_ISLAND) then
		local var_30_11 = arg_30_0:GetView()

		var_30_12 = var_30_12.GetIsland(var_30_11)
		_ = var_1_10003

		local var_30_13 = var_1_10003.each

		getProxy = var_5
		IslandProxy = var_1_10007

		local var_30_14 = var_5(var_1_10007)

		var_30_13(var_5.GetChatMsgList(var_30_14, var_30_12.id), function(arg_34_0)
	...
	var_30_12.sort(arg_30_0.displays, function(arg_35_0, arg_35_1)
		return arg_35_0.timestamp < arg_35_1.timestamp
	end)

	local var_30_15 = arg_30_0.scrollrect

	var_2.SetTotalCount(var_30_15, #arg_30_0.displays, arg_30_1 and 1 or -1)
...
function var_0_1.OnInitItem(arg_36_0, arg_36_1)
	...
	var_1_10003(arg_36_0, var_36_0.otherBubble.tf, function()
		...
		IslandBaseMediator = var_2_10006
	...
	var_1_10003(var_36_1, var_6.Find(var_36_2, "chat_fram"), function()
		...
		if var_1.IsTradeLink(var_38_1) then
			...
			var_38_3(var_38_2, var_2_10004.ENTER_ISLAND, var_38_0)
		else
