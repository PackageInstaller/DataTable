...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_8.Send(var_1_5, 21511, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_3(var_2_2, iter_2_1.ISLAND_DROPMAIN_AWARD, {
				dropData = var_2_1
			})

			local var_2_4 = var_1_4
			local var_2_5 = var_3.GetBuilding(var_2_4, var_1_1)

			ipairs = var_2_10004

			for iter_2_2, iter_2_3 in var_2_10004(var_0) do
				var_2_5:UpdateHandPlantDataBySlotId({
					formula_id = 0,
					end_time = 0,
					state = 0,
					id = iter_2_3
				...
				var_9.DispatchEvent(var_2_6, var_0_1.START_HANDPLANT_AWARD_DONE, {
					build_id = var_1_1,
					area_id = iter_2_3
				})
			end
