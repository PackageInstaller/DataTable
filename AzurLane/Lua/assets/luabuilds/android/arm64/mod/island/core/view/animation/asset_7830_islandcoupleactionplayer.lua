...
function var_0_1.Stop(arg_3_0)
	...
	if arg_3_0.phase == var_0_3 and arg_3_0.playData then
		...
		var_3_2(var_3_1, var_1_10005.REMOVE_PATH_FINDER, {
			unitId = var_3_0.id,
...
function var_0_1.Play(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	local var_5_2 = var_1_10005(0, 0, 0)
...
function var_0_1.ShowOrHideCancelableBtn(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	if arg_14_3 then
		...
		var_14_4(var_14_3, var_1_10008.START_DO_COUPLE_ACTION)
	else
		...
		var_14_6(var_14_5, var_1_10008.END_DO_COUPLE_ACTION)
	end
...
function var_0_1.SendStartEvent(arg_15_0, arg_15_1, arg_15_2)
	...
	if var_15_2 then
		...
		var_15_4(var_15_3, var_1_10007.START_COUPLE_ACTION)
	end
...
function var_0_1.SendEndEvent(arg_16_0, arg_16_1, arg_16_2)
	...
	if var_16_2 then
		...
		var_16_4(var_16_3, var_1_10007.END_COUPLE_ACTION)
	end
	...
	if var_17_0 then
		...
		if not var_1_10011.GetCanReachOptPoint(arg_17_2._go.transform.position, var_17_1, arg_17_1.agent, arg_17_1._tf.position, var_17_3, 36) then
			...
			if not var_12.IsPlayer(var_17_4, arg_17_1.id) then
				...
				var_17_8(var_17_7, var_16.GEN_PATH_FINDER, {
					navData = var_17_6,
					callback = arg_17_4
				})
...
function var_0_1.OnNavigateToPointFailed(arg_18_0)
	...
	var_18_1(var_18_0, var_1_10004("island_no_position_to_reponse_action"))
...
function var_0_1.Face2Face(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	...
	var_19_0.rotation = var_1_10009.Euler(0, var_19_2.eulerAngles.y, 0)
	var_6.rotation = arg_19_1 * var_6.rotation
	isa = var_9

	local var_19_3 = arg_19_3

	IslandPlayerUnit = var_12

	if var_9(var_19_3, var_12) then
...
function var_0_1.EnableOrDisablePlayerSyn(arg_23_0, arg_23_1, arg_23_2)
	...
	IslandPlayerUnit = var_1_10006

	if var_1_10003(var_23_0, var_1_10006) then
...
function var_0_1.EnableOrDisablePlayerOp(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	if var_24_2 then
		if arg_24_3 then
			...
			typeof = var_1_10008
			InputController = var_1_10010

			local var_24_7 = var_24_6(var_24_5, var_1_10008(var_1_10010))
...
function var_0_1.EnableOrDisableUnitSyn(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	IslandVisitorUnit = var_1_10008

	if var_1_10005(var_25_1, var_1_10008) then
	...
	if var_5(var_25_2, var_1_10008) then
