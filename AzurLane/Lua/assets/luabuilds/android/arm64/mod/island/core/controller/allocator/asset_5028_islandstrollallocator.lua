...
function var_0_0.Allocator(arg_2_0, arg_2_1)
	...
	var_1_10002(not var_1_10004.contains(arg_2_0.cache, arg_2_1), "path has been used")
	...
	local var_2_0 = arg_2_0:GetWaypoints(arg_2_1)

	pg = var_1_10003

	local var_2_1 = var_1_10003.island_waypoint[var_2_0[1]].position

	return arg_2_1, var_2_1
end
