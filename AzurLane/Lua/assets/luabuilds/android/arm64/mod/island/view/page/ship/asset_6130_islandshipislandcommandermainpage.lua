...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_3 = var_3.Find(var_2_2, "adapt/left_panel/title/Text")

	i18n = var_4

	var_1(var_2_3, var_4("island_dressup_titile"))
...
function var_0_1.OnInit(arg_5_0)
	...
	local function var_5_2()
		...
		var_6_1(var_6_0, var_2_10003.ON_HOME)
	...
	local function var_5_5()
		...
		if var_0.CheckDressIsDirty(var_7_0) then
			...
			var_7_3.type = var_2_10004.TYPE_COMMON
			i18n = var_4
			var_7_3.content = var_4("island_dressup_tip_1")
...
function var_0_1.Show(arg_10_0)
	...
	local var_10_0 = var_1.island_unit_character[0]

	IslandShipDressHelperNew = var_1_10002
	arg_10_0.shipDressHelper = var_1_10002.New()

	local var_10_1 = arg_10_0.shipDressHelper

	var_2.SetShipId(var_10_1, 0)
	...
	local var_10_3 = arg_10_0.OpenPage

	IslandShipDressUpPageNew = var_5
	arg_10_0.currentChildPage = var_10_3(var_10_2, var_5, 0, false, arg_10_0.shipDressHelper, function(arg_11_0)
...
function var_0_1.SetObjInitRotaion(arg_17_0, arg_17_1)
	...
	var_17_0, GetOrAddComponent = arg_17_0:GetSmoothRotateObject(), var_1_10003
	typeof = var_1_10006
	SmoothRotateObject = var_1_10008

	local var_17_1 = var_1_10003(var_17_0, var_1_10006(var_1_10008))

	var_17_1.rotationSpeed = 5
	ReflectionHelp = var_4

	local var_17_2 = var_4.RefSetProperty

	typeof = var_6
	SmoothRotateObject = var_1_10008

	var_17_2(var_6(var_1_10008), "targetRotation", var_17_1, arg_17_1)

	if arg_17_0.timer then
		local var_17_3 = arg_17_0.timer
...
function var_0_1.CanEsc(arg_20_0)
	...
	var_20_2.type = var_1_10005.TYPE_COMMON
	i18n = var_5
	var_20_2.content = var_5("island_dressup_tip_1")
