...
function var_0_1.OnLateUpdate(arg_4_0)
	...
	if arg_4_0:GetView().player then
		ipairs = var_1_10002

		for iter_4_0, iter_4_1 in var_1_10002(arg_4_0.animationOpShowFlags) do
			local var_4_0 = arg_4_0.animationOpTpls[iter_4_1]
			local var_4_1 = arg_4_0
			local var_4_2 = arg_4_0.UnitKey2unitData(var_4_1, iter_4_1)
			local var_4_3 = arg_4_0:GetView()

			if var_9.GetUnitModuleWithType(var_4_3, var_4_2.type, var_4_2.id) then
				Vector3 = var_4_1

				local var_4_4 = var_4_1.Distance(var_1._go.transform.position, var_9._go.transform.position) <= arg_4_0.animationOpShowDistance

				setActive = var_11

				var_11(var_4_0, var_4_4)
			end
		end
	end
...
function var_0_1.UpdateTplPosition(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	Vector3 = var_6
	var_5_5.localScale = var_6(var_5_0 and -1 or 1, 1, 1)
...
function var_0_1.ShowAnimationOp(arg_6_0, arg_6_1, arg_6_2)
	...
	var_7(var_6_5, var_10.Find(var_6_6, "Image"), false)
	...
	var_7(var_9.Find(var_6_8, "effect"), false)
...
function var_0_1.UpdateAnimationOpEffect(arg_7_0, arg_7_1, arg_7_2)
	...
	var_7(var_9.Find(var_7_3, "effect"), arg_7_2)
...
function var_0_1.HideAnimationOp(arg_8_0, arg_8_1)
	...
	var_1_10003.removebyvalue(arg_8_0.animationOpShowFlags, var_8_0.key)
	...
	local var_8_1 = var_3.transform

	var_4(var_6.Find(var_8_1, "effect"), false)
