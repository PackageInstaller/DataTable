...
function var_0_1.FirstFlush(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.resultTxt = var_2_11(var_2_10, var_4(var_1_10006))
	...
	arg_2_0.cg = var_1(var_2_12, var_4(var_1_10006))
	setText = var_1

	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_3.Find(var_2_13, "escape_tip/Text")

	i18n = var_4

	var_1(var_2_14, var_4("island_fishing_tip_escape"))

	setText = var_1

	local var_2_15 = arg_2_0._tf
	local var_2_16 = var_3.Find(var_2_15, "escape_tip_1/Text")

	i18n = var_4

	var_1(var_2_16, var_4("island_fishing_tip_hooked"))

	IslandFishingPlayer = var_1

	local var_2_17 = var_1.New
	local var_2_18 = arg_2_0:GetView()
	local var_2_19 = arg_2_0

	arg_2_0.fishingPlayer = var_2_17(var_2_18, arg_2_0.GetView(var_2_19).player)
	onButton = var_1

	local var_2_20 = arg_2_0
	local var_2_21 = arg_2_0.backBtn
	...
	local function var_2_22()
		...
		i18n = var_2_10004
		var_3_3.content = var_2_10004("island_fishing_exit")
	...
	var_1(var_2_20, var_2_21, var_2_22, var_2_19)
...
function var_0_1.Flush(arg_6_0, arg_6_1, arg_6_2)
	...
	var_6_1(var_6_0, var_6_2, var_1_10007)
...
function var_0_1.StartGame(arg_7_0, arg_7_1)
	...
	var_7_1(var_7_0, var_1_10005.BuildIslandFishingEnter(arg_7_0.fishPointId))
	...
	var_7_1({
		...
		function(arg_13_0)
			...
			local var_13_2 = var_2_10004.EFFECT_ENTER

			IslandFishingEffectMgr = var_2_10005

			var_13_1(var_13_0, var_13_2, var_2_10005.EFFECT_ENTER_TIME)
		...
		function(arg_14_0)
			...
			var_14_2(var_14_1, var_2_10004.EFFECT_WAITING)
		...
		function(arg_15_0)
			...
			var_15_4(var_15_3, var_2_10004.EFFECT_HOOKED)
		...
		function(arg_16_0)
			...
			var_16_3(var_16_2, var_2_10004.EFFECT_SHAKE)
...
function var_0_1.ResetCamrea(arg_22_0)
	...
	var_22_1(var_22_0, var_1_10004.FOLLOW_CAMERA_NAME)
...
function var_0_1.CheckServerBait(arg_23_0, arg_23_1)
	...
	var_23_3(var_23_2, var_1_10007.EXCHANGE_LURE, var_2:GetBaitId(), arg_23_0.fishPointId, arg_23_1)
...
function var_0_1.GetFishFromServer(arg_24_0, arg_24_1, arg_24_2)
	...
	var_24_1(var_24_0, var_1_10006.GO_FISHING, arg_24_1, 0, function(arg_25_0, arg_25_1, arg_25_2)
...
function var_0_1.InitArgs(arg_26_0, arg_26_1, arg_26_2)
	...
	local var_26_6 = var_6:GetFishRodId()

	assert = var_26_4
	pg = var_10

	var_26_4(var_10.island_fish_rod[var_26_6], "island_fish_rod>>>>>>>>>>>>" .. var_26_6)

	pg = var_26_4
	arg_26_0.fishRodId = var_26_4.island_fish_rod[var_26_6].attachment_id
	pg = var_8
	arg_26_0.rodProfile = var_8.island_fish_rod[var_26_6].qte_effect
	...
	local var_26_7 = arg_26_0.fishingPlayer

	var_8.InitArgs(var_26_7, arg_26_0.fishPointId, arg_26_0.fishRodId, arg_26_0.fishId)
...
function var_0_1.LoadQteUI(arg_37_0, arg_37_1)
	...
	var_4({
		function(arg_38_0)
			...
			typeof = var_2_10006
			FishRodProfile = var_2_10008

			local var_38_4 = var_2_10006(var_2_10008)

			UnityEngine = var_2_10007

			local var_38_5 = var_38_1(var_38_0, var_38_2, var_38_3, var_38_4, var_2_10007.Events.UnityAction_UnityEngine_Object(function(arg_39_0)
				var_37_0 = arg_39_0
		...
		function(arg_41_0)
			...
			typeof = var_2_10006
			FishMotionProfile = var_2_10008

			local var_41_4 = var_2_10006(var_2_10008)

			UnityEngine = var_2_10007

			local var_41_5 = var_41_1(var_41_0, var_41_2, var_41_3, var_41_4, var_2_10007.Events.UnityAction_UnityEngine_Object(function(arg_42_0)
				var_37_1 = arg_42_0
		...
		function(arg_43_0)
			...
			local var_43_4 = var_2_10006(var_2_10008)

			UnityEngine = var_2_10007

			local var_43_5 = var_43_1(var_43_0, var_43_2, var_43_3, var_43_4, var_2_10007.Events.UnityAction_UnityEngine_Object(function(arg_44_0)
...
function var_0_1.OnLoadQTE(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
	...
	arg_47_0.getAnim = var_47_4(var_47_3, var_8(var_1_10010))
	...
	arg_47_0.getAnimDft = var_47_7(var_47_6, var_8(var_1_10010))
	...
	typeof = var_8
	Animation = var_1_10010
	arg_47_0.failedAnim = var_47_11(var_47_10, var_8(var_1_10010))
	...
	typeof = var_8
	DftAniEvent = var_1_10010
	arg_47_0.failedAnimDft = var_47_14(var_47_13, var_8(var_1_10010))
	...
	typeof = var_8
	Animation = var_1_10010
	arg_47_0.qteAim = var_47_16(var_47_15, var_8(var_1_10010))
	...
	typeof = var_8
	DftAniEvent = var_1_10010
	arg_47_0.qteAimDft = var_47_18(var_47_17, var_8(var_1_10010))
	...
	typeof = var_8
	IslandFishingSliderDriver = var_1_10010

	local var_47_22 = var_47_21(var_47_20, var_8(var_1_10010))
...
function var_0_1.UpdateQteLayout(arg_48_0)
	...
	Vector3 = var_48_2
	var_48_5.localPosition = var_48_2(var_48_3.x, var_48_3.y, 0)
...
function var_0_1.NotifyServerResultSuccess(arg_61_0, arg_61_1)
	...
	local var_61_2 = var_1_10005.FISHING_RESULT

	IslandConst = var_1_10006

	var_61_1(var_61_0, var_61_2, var_1_10006.FISHING_OP_SUCCESS, arg_61_0.fishPointId, arg_61_0.fishId, arg_61_0.weight, arg_61_0.cupType, arg_61_1)
...
function var_0_1.NotifyServerResultFaild(arg_62_0, arg_62_1)
	...
	local var_62_2 = var_1_10005.FISHING_RESULT

	IslandConst = var_1_10006

	var_62_1(var_62_0, var_62_2, var_1_10006.FISHING_OP_FAILD, arg_62_0.fishPointId, arg_62_0.fishId, arg_62_0.weight, arg_62_0.cupType, arg_62_1)
...
function var_0_1.NotifyServerResultCancel(arg_63_0, arg_63_1)
	...
	local var_63_2 = var_1_10005.FISHING_RESULT

	IslandConst = var_1_10006

	var_63_1(var_63_0, var_63_2, var_1_10006.FISHING_OP_CANCEL, arg_63_0.fishPointId, arg_63_0.fishId, arg_63_0.weight, arg_63_0.cupType, arg_63_1)
...
function var_0_1.BuildResultData(arg_68_0, arg_68_1)
	...
	local var_68_8 = var_1_10008.floor(arg_68_0.fishingSliderDriver.Ratio * 100)
	...
	var_68_10(var_68_9, var_1_10012.BuildIslandFishingResult(arg_68_0.fishPointId, var_68_3, var_68_4, arg_68_0.fishId, arg_68_0.fishWeight, var_68_5, var_68_6, var_68_7, var_68_8, arg_68_1))
...
function var_0_1.OnQteSuccess(arg_69_0)
	...
	var_1({
		...
		function(arg_74_0)
			...
			local var_74_2 = var_2_10004.EFFECT_LEAVE

			IslandFishingEffectMgr = var_2_10005

			var_74_1(var_74_0, var_74_2, var_2_10005.EFFECT_LEAVE_TIME)
...
function var_0_1.WaitForExit(arg_79_0, arg_79_1)
	...
	local var_79_0 = var_2.island_set.island_fishing_success_exit_time.key_value_int

	Timer = var_1_10003

	local var_79_1 = var_1_10003.New
	local var_79_2 = arg_79_1

	math = var_1_10006
	arg_79_0.exitTimer = var_79_1(var_79_2, var_1_10006.max(0.01, var_79_0), 1)

	local var_79_3 = arg_79_0.exitTimer

	var_3.Start(var_79_3)
...
function var_0_1.OnQteFailed(arg_81_0)
	...
	var_81_1(var_81_0, var_4.EFFECT_NORMAL)
...
function var_0_1.OnCancel(arg_89_0, arg_89_1)
	if arg_89_0.state == var_0_3 or arg_89_0.state == var_0_2 then
		...
		local var_89_2 = var_5.BuildIslandFishingCancel
		local var_89_3 = arg_89_0.fishPointId

		IsNil = var_1_10008

		var_89_1(var_89_0, var_89_2(var_89_3, var_1_10008(arg_89_0.qteTr) and 1 or 2))

		local var_89_4 = arg_89_0
		local var_89_5 = arg_89_0.PlayEffect

		IslandFishingEffectMgr = var_5

		var_89_5(var_89_4, var_5.EFFECT_NORMAL)
...
function var_0_1.DisplayResult(arg_94_0)
	...
	var_94_0(var_94_1, var_94_2 == var_5.CUP_STATE_MAX)
	...
	var_94_0(var_94_3, var_94_4 == var_5.CUP_STATE_MIN)
...
function var_0_1.DisableOpView(arg_95_0, arg_95_1)
	...
	var_95_2(var_95_1, var_5.ENTER_FISH_POINT)
...
function var_0_1.EnableOpView(arg_96_0)
	...
	var_96_2(var_96_1, var_1_10004.EXIT_FISH_POINT)
...
function var_0_1.Clear(arg_104_0)
	...
	var_104_1(var_104_0, var_1_10004.EFFECT_NORMAL)
	...
	local var_104_9 = var_104_7.GameTrackerMgr.GetInstance()
	local var_104_10 = var_3.Record

	GameTrackerBuilder = var_1_10006

	var_104_10(var_104_9, var_1_10006.BuildIslandFishingExit(arg_104_0.fishPointId, var_104_8))
