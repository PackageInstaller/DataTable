...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1_10001(var_2_1, var_1_10004("island_ticket_storage_title"))
	...
	typeof = var_4
	Animation = var_6
	arg_2_0.sortPanelAnim = var_2_6(var_2_5, var_4(var_6))
	...
	var_1(var_2_9, var_4("island_ticket_sort_valid"))
	...
	var_1(var_2_12, var_4("island_ticket_sort_speedup"))
...
function var_0_1.OnInit(arg_5_0)
	...
	local var_5_2 = var_4.Find(var_5_1, "frame/title/help")
	...
	local var_5_6 = var_4.Find(var_5_5, "frame/close")
	...
	local function var_5_23()
		...
		local var_12_2 = var_2.Find(var_12_1, "Text")

		i18n = var_2_10003

		var_12_0(var_12_2, var_2_10003("island_ticket_sort_valid"))
	...
	local function var_5_26()
		...
		local var_13_2 = var_2.Find(var_13_1, "Text")

		i18n = var_2_10003

		var_13_0(var_13_2, var_2_10003("island_ticket_sort_speedup"))
	...
	var_1_10001(var_5_24, var_5_25, var_5_26, var_5_9)
