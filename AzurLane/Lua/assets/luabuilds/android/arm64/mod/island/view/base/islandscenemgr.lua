...
function var_0_0.OpenPage(arg_2_0, arg_2_1, arg_2_2, ...)
	...
	if arg_2_0:IsSceneType(arg_2_1) then
		...
		if arg_2_0:IsNeedLoadingPage(arg_2_2) then
			...
			var_5.CommonSceneChange(var_2_2, "Dorm3DLoading", function(arg_3_0)
				...
				var_1.ClosePrevScenePage(var_3_0, function()
					...
					IslandSceneContext = var_3_10003

					local var_4_2 = var_3_10003.New
					local var_4_3 = arg_2_2

					unpackEx = var_3_10006

					var_4_1(var_4_0, var_4_2(var_4_3, var_3_10006(var_2_0)), true)
			...
			arg_2_0:ClosePrevScenePage(function()
				...
				IslandSceneContext = var_2_10003
				...
				var_5_1(var_5_0, var_5_2(var_5_3, var_2_10006(var_2_0)), true)
		...
		local var_2_5, var_2_6 = arg_2_0.GetContext(var_2_4, arg_2_1)

		assert = var_2_4

		var_2_4(var_2_5, arg_2_1.__cname)
		var_2_5:AddSubPage(arg_2_2, var_2_6, arg_2_1.__cname, ...)
		arg_2_0:StartPage(var_2_3, var_2_0)

		local var_2_7 = arg_2_0.scene
		local var_2_8 = var_7.emit

		ISLAND_EVT = var_10

		var_2_8(var_2_7, var_10.SUB_PAGE_OPEN, arg_2_2.__cname)
...
function var_0_0.GetPage(arg_9_0, arg_9_1)
	...
	if not var_1_10002.detect(arg_9_0.pages, function(arg_10_0)
		...
		_ = var_1_10003
		var_9_0 = var_1_10003.detect(arg_9_0.noStatePages, function(arg_11_0)
...
function var_0_0.StartPage(arg_14_0, arg_14_1, arg_14_2)
	...
	var_1_10003({
		function(arg_15_0)
			...
			unpackEx = var_2_10005

			var_15_1(var_15_0, var_15_2, var_2_10005(arg_14_2))
		...
		var_16_1(var_16_0, var_16_2, var_2_10004(arg_14_2))
...
function var_0_0.CreateScenePage(arg_17_0, arg_17_1)
	...
	if var_1_10002.detect(arg_17_0.pages, function(arg_18_0)
		...
		var_1_10003.removebyvalue(arg_17_0.pages, var_2)
	end
...
function var_0_0.CreateSubPage(arg_19_0, arg_19_1, arg_19_2)
	...
	if var_1_10003.detect(arg_19_0.subPages, function(arg_20_0)
		...
		var_1_10004.removebyvalue(arg_19_0.subPages, var_3)
	end
...
function var_0_0.DestorySubPage(arg_26_0, arg_26_1)
	if not arg_26_0:GetContext(arg_26_1) then
		return
	end

	ipairs = var_1_10003

	for iter_26_0, iter_26_1 in var_1_10003(var_2:GetSubPages()) do
...
function var_0_0.OpenPrevScenePage(arg_28_0)
	...
	if arg_28_0.stack[#arg_28_0.stack] then
		...
		if arg_28_0.GetPage(var_28_0, var_1.class) and var_2:GetLoaded() and var_2:isShowing() then
			...
			for iter_28_0, iter_28_1 in var_3(var_1:GetSubPages()) do
				if iter_28_1.__visible then
					local var_28_1 = arg_28_0:GetSubPage(iter_28_1.class)

					if var_1_10008.GetLoaded(var_28_1) then
						var_1_10008:Disable()
					end
				end
			end
			...
			local var_28_3 = arg_28_0.OpenPage
			local var_28_4 = arg_28_0.scene
			local var_28_5 = var_1.class

			unpackEx = var_1_10008

			local var_28_6 = var_28_3(var_28_2, var_28_4, var_28_5, var_1_10008(var_1:GetData()))

			ipairs = var_28_0

			for iter_28_2, iter_28_3 in var_28_0(var_1:GetSubPages()) do
				if iter_28_3.__visible then
					local var_28_7 = arg_28_0
					local var_28_8 = arg_28_0.OpenPage
					local var_28_9 = var_28_6
					local var_28_10 = iter_28_3.class

					unpackEx = var_1_10014

					var_28_8(var_28_7, var_28_9, var_28_10, var_1_10014(iter_28_3:GetData()))
				end
			end
		end
	end
...
function var_0_0.CheckAndCloseSubPage(arg_29_0, arg_29_1)
	...
	if arg_29_0.GetContext(var_29_0, arg_29_1) then
		local var_29_1 = -1

		ipairs = var_29_0

		for iter_29_0, iter_29_1 in var_29_0(var_2:GetSubPages()) do
		...
		if 0 <= var_29_1 then
			...
			for iter_29_2, iter_29_3 in var_4(var_2:GetSubPages()) do
				if var_29_1 == iter_29_3:GetLevel() and (iter_29_3:GetSubPageParentName() == arg_29_1.__cname or iter_29_3.class.__cname == arg_29_1.__cname) and arg_29_0:GetSubPage(iter_29_3.class) and var_9:GetLoaded() then
					iter_29_3.__visible = false

					local var_29_2 = arg_29_0.scene
					local var_29_3 = var_10.emit

					ISLAND_EVT = var_1_10013

					var_29_3(var_29_2, var_1_10013.SUB_PAGE_CLOSE, var_9.class.__cname)
					var_9:Disable()
				end
			end
...
function var_0_0.CheckAndCloseNoStatePage(arg_30_0, arg_30_1)
	...
	local var_30_1 = arg_30_0.GetContext(var_30_0, arg_30_1)
	local var_30_2 = false

	if var_30_1 then
		_ = var_30_0

		if var_30_0.detect(arg_30_0.noStatePages, function(arg_31_0)
			return arg_31_0.__cname == arg_30_1.__cname
		end) then
			arg_30_0:DelRecord(var_30_1)
			arg_30_0:DestroyPage(var_4, var_30_1)
...
function var_0_0.Record(arg_33_0, arg_33_1, arg_33_2)
	...
	if var_3.detect(arg_33_0.stack, function(arg_34_0)
		...
		var_1_10004.removebyvalue(arg_33_0.stack, var_3)

		table = var_1_10004

		var_1_10004.insert(arg_33_0.stack, arg_33_1)
...
function var_0_0.OnAnyPageOpen(arg_36_0, arg_36_1)
	...
	var_36_1(var_36_0, var_1_10005.ANY_PAGE_OPENED, arg_36_1)
...
function var_0_0.OnAllPageClose(arg_37_0)
	...
	var_37_1(var_37_0, var_1_10004.ALL_PAGE_CLOSED)
...
function var_0_0.Debug(arg_43_0)
	...
	local function var_43_0(arg_44_0)
		...
		return var_2_10002.concat(var_44_0, ",")
	end
	...
	local var_43_2 = var_1_10003.concat(var_43_1, "\n")
