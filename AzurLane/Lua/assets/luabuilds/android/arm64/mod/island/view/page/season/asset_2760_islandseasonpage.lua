...
function var_0_1.OnLoaded(arg_3_0)
	...
	local var_3_2 = var_3.Find(var_3_1, "top/title/Text")

	i18n = var_4

	var_1(var_3_2, var_4("island_season_title"))
	...
	setmetatable = var_8
	var_3_7[var_3_9] = var_3_10(var_3_11, var_3_12, var_8({
	...
	setmetatable = var_8
	var_3_7[var_3_13] = var_3_14(var_3_15, var_3_16, var_8({
	...
	setmetatable = var_8
	var_3_7[var_3_17] = var_3_18(var_3_19, var_3_20, var_8({
		openBuyLayer = function(arg_6_0, arg_6_1)
			local var_6_0 = arg_3_0
			local var_6_1 = var_2.OpenPage

			IslandShopItemLayer = var_2_10005

			var_6_1(var_6_0, var_2_10005, arg_6_0, arg_6_1)
	...
	setmetatable = var_8
	var_3_7[var_3_21] = var_3_22(var_3_23, var_3_24, var_8({
	...
	var_3(var_5.Find(var_3_28, var_0_1.PAGE_REVIEW), not var_2)
	...
	local var_3_31 = var_6.Find(var_3_30, "activity")

	i18n = var_3_28

	var_3_29(var_3_31, var_3_28("island_season_activity"))

	local var_3_32 = var_3
	local var_3_33 = arg_3_0.togglesTF
	local var_3_34 = var_6.Find(var_3_33, "pt")

	i18n = var_7

	var_3_32(var_3_34, var_7("island_season_pt"))

	local var_3_35 = var_3
	local var_3_36 = arg_3_0.togglesTF
	local var_3_37 = var_6.Find(var_3_36, "task")

	i18n = var_7

	var_3_35(var_3_37, var_7("island_season_task"))

	local var_3_38 = var_3
	local var_3_39 = arg_3_0.togglesTF
	local var_3_40 = var_6.Find(var_3_39, "shop")

	i18n = var_7

	var_3_38(var_3_40, var_7("island_season_shop"))

	local var_3_41 = var_3
	local var_3_42 = arg_3_0.togglesTF
	local var_3_43 = var_6.Find(var_3_42, "rank")

	i18n = var_7

	var_3_41(var_3_43, var_7("island_season_charts"))

	local var_3_44 = var_3
	local var_3_45 = arg_3_0.togglesTF
	local var_3_46 = var_6.Find(var_3_45, "review")

	i18n = var_7

	var_3_44(var_3_46, var_7("island_season_review"))
	...
	arg_3_0.playRoomPop = var_3_47(var_6.Find(var_3_48, "playRoomPop"), arg_3_0)
...
function var_0_1.Close(arg_9_0, arg_9_1)
	...
	var_9_1(var_9_0, var_1_10005.PLAY_ROOM_MATCH_STOP)
...
function var_0_1.OnInit(arg_10_0)
	...
	local var_10_7 = var_5.Find(var_10_6, "top/help")
	...
	local function var_10_8()
		...
		var_12_2.type = var_2_10004.TYPE_WHITOUT_BTN
		i18n = var_4
		var_12_2.content = var_4("island_season_help")
	...
	var_1_10002(var_10_5, var_10_7, var_10_8, var_10_6)

	eachChild = var_1_10002

	var_1_10002(arg_10_0.togglesTF, function(arg_13_0)
		...
		var_2_10001(var_13_0, var_13_1, var_13_2, var_2_10006)
...
function var_0_1.UpdateRedDot(arg_17_0, arg_17_1)
	...
	var_1_10002(arg_17_0.togglesTF, function(arg_18_0)
		if not arg_17_1 or arg_18_0.name == arg_17_1 then
			...
			local var_18_0 = arg_18_0:Find("red")

			IslandSeasonRedDotHelper = var_2_10004

			var_1(var_18_0, var_2_10004.TipTag(arg_18_0.name))
		end
...
function var_0_1.AddListeners(arg_19_0)
	...
	var_19_1(var_19_0, var_1_10004.ACTIVITY_UPDATED, arg_19_0.FlushActivityPage)

	local var_19_2 = arg_19_0
	local var_19_3 = arg_19_0.AddListener

	IslandSeasonAgency = var_4

	var_19_3(var_19_2, var_4.ADD_PT, arg_19_0.FlushPtPage)
	...
	var_19_5(var_19_4, var_4.ISLAND_GET_SEASON_PT_AWARD_DONE, arg_19_0.FlushPtPage)
	...
	var_19_7(var_19_6, var_4.ISLAND_SUBMIT_TASK_DONE, arg_19_0.OnSubmitTaskDone)
	...
	var_19_9(var_19_8, var_4.ISLAND_SUBMIT_TASK_ONE_STEP_DONE, arg_19_0.OnSubmitTaskDone)
	...
	var_19_11(var_19_10, var_4.ISLAND_SHOP_OP_DONE, arg_19_0.FlushShopPage)
	...
	var_19_13(var_19_12, var_4.ISLAND_GET_SEASON_RANK_DONE, arg_19_0.OnGetRankData)
	...
	var_19_15(var_19_14, var_4.TASK_ADDED, arg_19_0.OnTaskAdded)
	...
	var_19_17(var_19_16, var_4.TASK_UPDATED, arg_19_0.OnTaskUpdate)
	...
	var_19_19(var_19_18, var_4.TASK_REMOVED, arg_19_0.OnTaskRemove)
	...
	var_19_21(var_19_20, var_4.TASK_FINISH, arg_19_0.OnTaskFinish)
...
function var_0_1.RemoveListeners(arg_20_0)
	...
	var_20_1(var_20_0, var_1_10004.ACTIVITY_UPDATED, arg_20_0.FlushActivityPage)
	...
	var_20_3(var_20_2, var_4.ADD_PT, arg_20_0.FlushPtPage)
	...
	var_20_5(var_20_4, var_4.ISLAND_GET_SEASON_PT_AWARD_DONE, arg_20_0.FlushPtPage)
	...
	var_20_7(var_20_6, var_4.ISLAND_SUBMIT_TASK_DONE, arg_20_0.OnSubmitTaskDone)
	...
	var_20_9(var_20_8, var_4.ISLAND_SUBMIT_TASK_ONE_STEP_DONE, arg_20_0.OnSubmitTaskDone)
	...
	var_20_11(var_20_10, var_4.ISLAND_SHOP_OP_DONE, arg_20_0.FlushShopPage)
	...
	var_20_13(var_20_12, var_4.ISLAND_GET_SEASON_RANK_DONE, arg_20_0.OnGetRankData)
	...
	var_20_15(var_20_14, var_4.TASK_ADDED, arg_20_0.OnTaskAdded)
	...
	var_20_17(var_20_16, var_4.TASK_UPDATED, arg_20_0.OnTaskUpdate)
	...
	var_20_19(var_20_18, var_4.TASK_REMOVED, arg_20_0.OnTaskRemove)
	...
	var_20_21(var_20_20, var_4.TASK_FINISH, arg_20_0.OnTaskFinish)
...
function var_0_1.OnShow(arg_21_0, arg_21_1)
	...
	if arg_21_1 and arg_21_1.target_act_id then
		...
		var_3(var_5.Find(var_21_5, var_0_1.PAGE_ACTIVITY), true)
		...
		var_3(var_5.Find(var_21_7, var_0_1.PAGE_ACTIVITY), true)
	end
...
function var_0_1.FlushShopPage(arg_32_0, arg_32_1)
	...
	if var_32_1 == var_3.SHOP_BUY_COMMODITY then
		local var_32_2 = arg_32_0
		local var_32_3 = arg_32_0.OpenPage

		IslandShopBuySuccessLayer = var_5

		var_32_3(var_32_2, var_5, arg_32_1.awards)
	end
