...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_12 = var_3.Find(var_2_11, "frame/bg/starts")
	local var_2_13 = arg_2_0._tf

	arg_2_0.uiNewStart = var_2_10(var_2_12, var_4.Find(var_2_13, "frame/bg/starts/tpl"))
...
function var_0_1.Show(arg_3_0, arg_3_1)
	...
	i18n = var_1_10003
	var_3_0.text = var_1_10003("island_unlock_skill")
...
function var_0_1.UpdateBreakLevel(arg_4_0, arg_4_1)
	...
	var_3.make(var_4_1, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			var_3(var_5_0, arg_5_1 < var_6.GetBreakLevel(var_5_1))
		end
