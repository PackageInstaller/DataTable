...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1(var_2_11, var_4("island_card_no_achieve_tip"))
...
function var_0_1.OnInit(arg_5_0)
	...
	local function var_5_8()
		...
		var_8_5(var_8_4, var_2_10004.SET_CARD_ACHVS, var_8_3)
...
function var_0_1.OnUpdateItem(arg_10_0, arg_10_1, arg_10_2)
	...
	local function var_10_3()
		...
		if var_0 then
			...
			var_2_10001.removebyvalue(arg_10_0.selectedIds, var_0)
		else
			table = var_2_10001

			var_2_10001.insert(arg_10_0.selectedIds, var_0)
		end

		pairs = var_2_10001

		for iter_11_0, iter_11_1 in var_2_10001(arg_10_0.cards) do
	...
	var_5(var_10_1, var_10_2, var_10_3, var_1_10010)
