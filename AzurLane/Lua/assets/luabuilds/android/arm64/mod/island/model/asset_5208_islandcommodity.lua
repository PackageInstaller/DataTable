...
function var_0_1.GetItemsWithPt(arg_11_0)
	...
	local var_11_1 = var_1_10002(arg_11_0:GetItems())

	if 0 < var_11_0 then
		table = var_3

		local var_11_2 = var_3.insert
		...
		VIRTUAL_DROP_TYPE_ISLAND_SEASON_PT = var_1_10007
		var_11_4[1] = var_1_10007
		var_11_4[3] = var_11_0
...
function var_0_1.GetTag(arg_26_0)
	...
	if not arg_26_0:getConfig("tag") then
		var_26_0 = 0
	end

	switch = var_1_10002

	return var_1_10002(var_26_0, {
		[0] = function()
...
function var_0_1.IsTimeLimitCommodity(arg_31_0)
	local var_31_0 = arg_31_0:getConfig("time")

	type = var_1_10002

	if var_1_10002(var_31_0) == "table" then
		return true
	end
...
function var_0_1.IsCharacterInviteItemHold(arg_32_0)
	...
	local var_32_1 = var_1_10002.island_chara_template.all
	local var_32_2 = {}

	ipairs = var_1_10004
	pg = var_1_10006

	for iter_32_0, iter_32_1 in var_1_10004(var_1_10006.island_chara_template.all) do
		table = var_1_10009
		...
		var_1_10009(var_32_3, var_1_10012.island_chara_template[iter_32_1].invite_item)
	end

	if #var_32_0 == 1 then
		table = var_4

		if not var_4.contains(var_32_2, var_32_0[1][2]) then
			return false
		end

		table = var_4

		local var_32_4 = var_32_1[var_4.indexof(var_32_2, var_32_0[1][2])]

		getProxy = var_5
		IslandProxy = var_7

		local var_32_5 = var_5(var_7)
		local var_32_6 = var_5.GetIsland(var_32_5)
		local var_32_7 = var_5.GetCharacterAgency(var_32_6)

		return var_5.HasInvite(var_32_7, var_32_4)
	end
end
...
function var_0_1.GetDressType(arg_33_0)
	...
	if arg_33_0.GetItems(var_33_0)[1] then
		local var_33_1 = var_1[1][1]

		DROP_TYPE_ISLAND_DRESS = var_33_0

		if var_33_1 ~= var_33_0 then
			return nil
		end

		pg = var_33_1

		if not var_33_1.island_dress_template[var_1[1][2]] then
			return nil
		end
