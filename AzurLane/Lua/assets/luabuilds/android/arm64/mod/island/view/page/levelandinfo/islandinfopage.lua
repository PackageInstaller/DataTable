...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.levelTxt = var_2_3(var_2_2, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.expTxt = var_2_6(var_2_5, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.goldTxt = var_2_9(var_2_8, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.prosperityLevel = var_2_14(var_2_13, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.prosperityExp = var_2_17(var_2_16, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.nameTxt = var_2_21(var_2_20, var_4(var_1_10006))
	...
	local var_2_25 = var_3.Find(var_2_24, "frame/right/ships/list")
	local var_2_26 = arg_2_0._tf

	arg_2_0.uiShipList = var_2_23(var_2_25, var_4.Find(var_2_26, "frame/right/ships/list/tpl"))
	...
	local var_2_30 = var_3.Find(var_2_29, "frame/left/upgrade_preview/content/awards/list/content")
	local var_2_31 = arg_2_0._tf

	arg_2_0.upgradeAwardList = var_2_28(var_2_30, var_4.Find(var_2_31, "frame/left/upgrade_preview/content/awards/list/content/tpl"))
	UIItemList = var_1

	local var_2_32 = var_1.New
	local var_2_33 = arg_2_0._tf
	local var_2_34 = var_3.Find(var_2_33, "frame/left/upgrade_preview/content/unlock/list/content")
	local var_2_35 = arg_2_0._tf

	arg_2_0.upgradeUnlockList = var_2_32(var_2_34, var_4.Find(var_2_35, "frame/left/upgrade_preview/content/awards/list/content/tpl"))
	UIItemList = var_1

	local var_2_36 = var_1.New
	local var_2_37 = arg_2_0._tf
	local var_2_38 = var_3.Find(var_2_37, "frame/right/prosperity/objective/content")
	local var_2_39 = arg_2_0._tf

	arg_2_0.prosperityLevelList = var_2_36(var_2_38, var_4.Find(var_2_39, "frame/right/prosperity/objective/content/tpl"))
	UIItemList = var_1

	local var_2_40 = var_1.New
	local var_2_41 = arg_2_0._tf
	local var_2_42 = var_3.Find(var_2_41, "frame/right/prosperity/objective/awards")
	local var_2_43 = arg_2_0._tf

	arg_2_0.prosperityAwardList = var_2_40(var_2_42, var_4.Find(var_2_43, "frame/right/prosperity/objective/awards/tpl"))
	...
	typeof = var_4
	Text = var_2_43
	arg_2_0.goProsperityBtnTxt = var_2_48(var_2_47, var_4(var_2_43))
	setText = var_1

	local var_2_49 = arg_2_0._tf
	local var_2_50 = var_3.Find(var_2_49, "frame/left/preview/Text")

	i18n = var_4

	var_1(var_2_50, var_4("island_upgrade_preview"))

	setText = var_1

	local var_2_51 = arg_2_0._tf
	local var_2_52 = var_3.Find(var_2_51, "frame/left/objective/label_exp")

	i18n = var_4

	var_1(var_2_52, var_4("island_upgrade_exp"))

	setText = var_1

	local var_2_53 = arg_2_0._tf
	local var_2_54 = var_3.Find(var_2_53, "frame/left/objective/label_gold")

	i18n = var_4

	var_1(var_2_54, var_4("island_upgrade_res"))

	setText = var_1

	local var_2_55 = arg_2_0._tf
	local var_2_56 = var_3.Find(var_2_55, "frame/left/upgrade_preview/content/awards/label")

	i18n = var_4

	var_1(var_2_56, var_4("island_word_award"))

	setText = var_1

	local var_2_57 = arg_2_0._tf
	local var_2_58 = var_3.Find(var_2_57, "frame/left/upgrade_preview/content/unlock/label")

	i18n = var_4

	var_1(var_2_58, var_4("island_word_unlock"))

	setText = var_1

	local var_2_59 = arg_2_0._tf
	local var_2_60 = var_3.Find(var_2_59, "frame/right/prosperity/objective/get_btn/Text")

	i18n = var_4

	var_1(var_2_60, var_4("island_word_get"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_8()
		...
		IslandEditNamePage = var_2_10003
...
function var_0_1.AddListeners(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10004.ISLAND_UPGRADE_DONE, arg_8_0.OnUpgrade)
	...
	var_8_3(var_8_2, var_4.ISLAND_PROSPERITY_AWARD_DONE, arg_8_0.OnGetAward)
	...
	var_8_5(var_8_4, var_4.ISLAND_SET_NAME_DONE, arg_8_0.OnModifyName)
...
function var_0_1.RemoveListeners(arg_9_0)
	...
	var_9_1(var_9_0, var_1_10004.ISLAND_UPGRADE_DONE, arg_9_0.OnUpgrade)
	...
	var_9_3(var_9_2, var_4.ISLAND_PROSPERITY_AWARD_DONE, arg_9_0.OnGetAward)
	...
	var_9_5(var_9_4, var_4.ISLAND_SET_NAME_DONE, arg_9_0.OnModifyName)
...
function var_0_1.Show(arg_13_0)
	...
	var_13_6[1] = var_8.Find(var_13_7, "frame/right")
...
function var_0_1.UpdateLevel(arg_18_0, arg_18_1)
	...
	var_1_10006(var_18_4, var_9.Clamp01(var_18_0 / var_18_1))
...
function var_0_1.UpdateProsperity(arg_19_0, arg_19_1)
	...
	var_19_3(var_19_2, #var_6.island_prosperity.all)

	local var_19_4 = arg_19_1
	local var_19_5

	if not var_19_0[arg_19_1.GetProsperityLevel(var_19_4)] then
		var_19_5 = var_19_0[1]
	end
...
function var_0_1.UpdateProsperityCard(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	local var_21_3 = arg_21_3.GetProsperityLevel(var_21_2) == arg_21_2
	local var_21_4 = arg_21_3:GetMaxProsperityLevel()

	setActive = var_21_2

	var_21_2(arg_21_1:Find("line"), var_21_4 ~= arg_21_2)

	setActive = var_21_2

	var_21_2(arg_21_1:Find("got"), var_21_1)

	setActive = var_21_2

	var_21_2(arg_21_1:Find("get"), var_21_0)

	setActive = var_21_2

	var_21_2(arg_21_1:Find("lock"), not var_21_0 and not var_21_1 and not var_21_3)

	setActive = var_21_2

	var_21_2(arg_21_1:Find("curr"), var_21_3 and not var_21_1)
	...
	var_21_2(var_21_5, var_21_6, var_21_7, var_13)
...
function var_0_1.FlushProsperity(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	...
	local var_23_3 = arg_23_1.GetTargetProsperityByLevel(var_23_2, arg_23_2)
	local var_23_4 = arg_23_0.prosperityExp

	i18n = var_23_2
	var_23_4.text = var_23_2("island_prosperity_level_display", var_23_1 .. "/" .. var_23_3)

	local var_23_5 = arg_23_1
	local var_23_6 = arg_23_1.GetProsperityAward(var_23_5, arg_23_2)
	local var_23_7 = arg_23_0.prosperityAwardList

	var_9.make(var_23_7, function(arg_24_0, arg_24_1, arg_24_2)
		UIItemList = var_2_10003
		...
		if arg_24_0 == var_2_10003.EventUpdate then
			...
			var_2_10005(arg_24_2, var_24_1)
		end

		return
	end)

	local var_23_8 = arg_23_0.prosperityAwardList

	var_9.align(var_23_8, #var_23_6)
	...
	local var_23_9 = arg_23_0.goProsperityBtnTxt

	i18n = var_23_5
	var_23_9.text = var_23_5("island_prosperity_value_display", var_23_3)
	onButton = var_23_9

	local var_23_10 = arg_23_0
	local var_23_11 = arg_23_0.getProsperityBtn
	...
	local function var_23_12()
		...
		var_25_1(var_25_0, var_2_10003.GET_PROSPERITY_AWARD, arg_23_2)
	...
	var_23_9(var_23_10, var_23_11, var_23_12, var_14)

	GetImageSpriteFromAtlasAsync = var_23_9

	var_23_9("island/IslandProsperityIcon/" .. arg_23_2, "", arg_23_0.prosperityIcon)
...
function var_0_1.UpdateShipCard(arg_29_0, arg_29_1, arg_29_2)
	...
	if not var_29_0 then
		var_1_10004 = arg_29_2:GetPrefab()
		GetImageSpriteFromAtlasAsync = var_1_10005

		var_1_10005("SquareIcon/" .. var_1_10004, "", arg_29_1:Find("ship/mask/icon"))
	end
	...
	local function var_29_3()
		...
		var_30_1(var_30_0, var_2_10003("word_comingSoon"))
	...
	var_1_10004(var_29_1, var_29_2, var_29_3, var_9)
