...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	local var_1_7 = var_1_6.GetInventoryAgency(var_1_9000)
	local var_1_8 = var_1_5:GetBuildingAgency()

	pg.ConnectionMgr.GetInstance().Send(var_1_6, 21537, {
		build_id = var_1_0.build_id,
		area_id = var_1_0.area_id,
		add_num = var_1_0.add_num
	}, 21538, function(arg_2_0)
		if arg_2_0.result == 0 then
			local var_2_0 = var_1_8:GetBuilding(var_1_1):GetDelegationSlotData(var_1_2)
			...
			for iter_2_0, iter_2_1 in ipairs(var_2_2.commission_cost) do
				var_1_7:RemoveItem(iter_2_1[1], (iter_2_1[2] + var_1_4) * var_1_3)
			end
