...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("..AgoraController"))
...
function var_0_1.GoBackLastExitPoint(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10004.SWITCH_MAP_BY_POINT, arg_2_0.lastExitPoint)
...
function var_0_1.EnterEditMode(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10004.ENTER_EDIT)
...
function var_0_1.ExitEditMode(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10004.EXIT_EDIT)
...
function var_0_1.SetUp(arg_5_0)
	...
	local var_5_2 = var_1_10004.MAP_SIZE_UPDATE
	local var_5_3 = arg_5_0.agora

	var_5_1(var_5_0, var_5_2, var_5.GetSize(var_5_3))

	pairs = var_5_1

	local var_5_4 = arg_5_0.agora

	for iter_5_0, iter_5_1 in var_5_1(var_3.GetPlaceableList(var_5_4)) do
		local var_5_5 = arg_5_0
		local var_5_6 = arg_5_0.PlaceItem
		local var_5_7 = iter_5_1.id

		Vector2 = var_1_10010
		var_1_10010 = var_1_10010(0, 0)
		Vector3 = var_1_10011

		var_5_6(var_5_5, var_5_7, var_1_10010, var_1_10011(0, 0, 0))
	end

	local var_5_8 = arg_5_0
	local var_5_9 = arg_5_0.NotifiyAgora

	ISLAND_AGORA_EVT = iter_5_0

	var_5_9(var_5_8, iter_5_0.END_LOAD_ITEMS)
...
function var_0_1.UnPlaceItem(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10004("island_agora_function_unuse"))
...
function var_0_1.CreateAgora(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in var_1_10005({
		...
		for iter_7_2 = 1, iter_7_1.count do
			...
			AgoraFurniture = var_1_10015
			var_7_2[var_1_10015.New({
				id = var_1_10014,
	...
	local var_7_5 = var_6.clamp
	local var_7_6 = var_7_4
	local var_7_7 = 1

	IslandConst = var_1_10010

	local var_7_8 = var_7_5(var_7_6, var_7_7, #var_1_10010.AGORA_LEVEL_2_SIZE)

	IslandConst = var_7_3

	local var_7_9 = var_7_3.AGORA_LEVEL_2_SIZE[var_7_8]
	local var_7_10 = var_7_0:GetCapacity()

	Agora = var_7_7

	local var_7_11 = var_7_7.New
	local var_7_12 = {}

	Vector2 = var_1_10012
	var_7_12.size = var_1_10012(var_7_9, var_7_9)
	var_7_12.placeableList = var_7_2
	var_7_12.capacity = var_7_10
	var_7_12.themes = {}
	var_7_12.systemThemes = {}
