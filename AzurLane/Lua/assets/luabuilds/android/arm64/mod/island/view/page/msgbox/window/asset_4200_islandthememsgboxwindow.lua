...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.iconRaw = var_2_2(var_2_1, var_4(var_1_10006))
	...
	var_1(var_2_8, var_4("island_btn_label_del"))

	setText = var_1

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_3.Find(var_2_9, "confirm/Text")

	i18n = var_4

	var_1(var_2_10, var_4("island_word_place"))
...
function var_0_1.FlushIcon(arg_8_0)
	...
	AgoraTheme = var_1_10005

	if var_1_10002(var_8_1, var_1_10005) then
...
function var_0_1.LoadRawTex(arg_9_0, arg_9_1)
	...
	if not var_1_10003.FileExists(var_9_0) then
		arg_9_0:LoadImage(0)
