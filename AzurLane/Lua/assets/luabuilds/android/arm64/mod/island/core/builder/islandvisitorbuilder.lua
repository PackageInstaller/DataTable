...
function var_0_1.AddComponents(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_1 = var_3(var_4_0, var_6(var_1_10008))
	...
	var_4(var_4_2, var_7(var_1_10009))
...
function var_0_1.LoadOtherPart(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	var_1_10005({
		function(arg_6_0)
			...
			local var_6_3 = var_2_10003(var_5)
...
function var_0_1.Load(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_1 = arg_8_1.GetBehaviourTree(var_8_0)
	local var_8_2 = arg_8_1.id

	getProxy = var_8_0
	PlayerProxy = var_1_10007

	local var_8_3 = var_8_0(var_1_10007)
	local var_8_4 = var_5.getRawData(var_8_3).id == arg_8_1.islandId
	local var_8_5 = arg_8_0:GetPoolMgr()

	var_6.GetCommanderModel(var_8_5, {
		model = arg_8_1:GetAssetPath(),
		animator = arg_8_1:GetAnimator()
	}, arg_8_2, var_8_2, var_8_4, var_8_1)
