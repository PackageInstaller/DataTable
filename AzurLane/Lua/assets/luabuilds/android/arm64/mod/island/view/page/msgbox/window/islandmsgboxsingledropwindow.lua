...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_9 = var_3.Find(var_2_8, "way/Viewport/list")
	local var_2_10 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_7(var_2_9, var_4.Find(var_2_10, "way/Viewport/list/tpl"))
	...
	local var_2_13 = var_3.Find(var_2_12, "label/Text")

	i18n = var_4

	var_1(var_2_13, var_4("island_get_way"))
...
function var_0_1.OnShow(arg_3_0)
	...
	IslandDropDescribeInfo = var_3

	local var_3_1 = var_3.New(var_3_0)
...
function var_0_1.FlushMain(arg_4_0, arg_4_1)
	...
	local var_4_3 = arg_4_1.GetOwnCount(var_4_2)
	local var_4_4 = arg_4_0.ownTxt

	i18n = var_4_2

	local var_4_5 = var_4_2("island_own_cnt")

	setColorStr = var_4_1
	var_4_4.text = var_4_5 .. var_4_1(var_4_3, "#39beff")
	updateCustomDrop = var_4_4

	var_4_4(arg_4_0.itemTr, arg_4_1:GetDrop(), {
		style = "island"
	})
...
function var_0_1.FlushAcquiringWay(arg_5_0, arg_5_1)
	...
	if arg_5_1:IsTecUnlocked() then
		...
		var_1_10004.insert(var_5_1, arg_5_1:GetTecDes())

		table = var_4

		var_4.insert(var_5_0, var_5_1)
	end

	local var_5_2 = #var_5_0
	local var_5_3 = 0 < var_5_2

	setActive = var_4

	local var_5_4 = arg_5_0._tf

	var_4(var_6.Find(var_5_4, "line"), var_5_3)

	setActive = var_4

	local var_5_5 = arg_5_0._tf

	var_4(var_6.Find(var_5_5, "label"), var_5_3)

	setActive = var_4

	local var_5_6 = arg_5_0._tf

	var_4(var_6.Find(var_5_6, "way"), var_5_3)

	local var_5_7 = arg_5_0.uiItemList

	var_4.make(var_5_7, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			local var_6_1 = arg_6_2:Find("go/Text")

			i18n = var_7

			var_4(var_6_1, var_7("island_word_go"))

			onButton = var_4

			local var_6_2 = arg_5_0
			local var_6_3 = arg_6_2
			local var_6_4 = arg_6_2.Find(var_6_3, "go")
			...
			local function var_6_5()
				...
				var_7_3(var_7_2, var_5.OPEN_PAGE, var_7_0, var_0)
			...
			var_4(var_6_2, var_6_4, var_6_5, var_6_3)
