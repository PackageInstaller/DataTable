...
function var_0_1.InitData(arg_2_0, arg_2_1)
	...
	for iter_2_8, iter_2_9 in var_2(var_4.island_order_list.get_id_list_by_type[var_0_1.SHIP_ORDER_TYPE]) do
	...
	for iter_2_10, iter_2_11 in var_2(var_2_8) do
		if arg_2_0.shipSlotList[iter_2_11.id] then
			var_1_10007:Init(iter_2_11, true)
		end
	end
...
function var_0_1.GetNextAutoReloadDelegateTime(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10002(arg_12_0.shipOrderDelegateSlots) do
...
function var_0_1.GetMaxFinishCount(arg_22_0)
	...
	return var_1_10002.island_set.order_daily_limit_num.key_value_int + var_22_2
end
...
function var_0_1.GetLevel(arg_35_0)
	...
	for iter_35_0, iter_35_1 in var_1_10001(var_1_10003.island_order_favor.all) do
...
function var_0_1.GetAllCanGetAwardList(arg_41_0)
	...
	for iter_41_0, iter_41_1 in var_1_10002(var_1_10004.island_order_favor.all) do
...
function var_0_1.RecordNextCanSubmitTime(arg_43_0)
	...
	local var_43_2 = var_1_10002.TimeMgr.GetInstance()
	local var_43_3 = var_2.GetServerTime(var_43_2)

	pg = var_43_0

	local var_43_4 = var_43_0.island_set.order_complete_refresh_time.key_value_int

	PlayerPrefs = var_43_2

	var_43_2.SetInt(var_0_2 .. var_43_1, var_43_3 + var_43_4)
...
function var_0_1.CanSubmitOrder(arg_44_0)
	...
	local var_44_2 = var_1_10002.GetInt(var_0_2 .. var_44_1, 0)
...
function var_0_1.GetCacheSelectedId(arg_45_0)
	...
	return (var_1_10002.GetInt(var_0_3 .. var_45_1, 0))
end
...
function var_0_1.SetCacheSelectedId(arg_46_0, arg_46_1)
	...
	var_1_10003.SetInt(var_0_3 .. var_46_1, arg_46_1)
...
function var_0_1.GetFinishedCntByActId(arg_48_0, arg_48_1)
	...
	for iter_48_4, iter_48_5 in var_6(arg_48_0.slotList) do
		...
		IslandFirmActivityOrder = var_1_10015

		if var_1_10012(var_48_6, var_1_10015) and var_48_5:GetActivityId() == arg_48_1 then
			var_1_10012 = var_48_1[var_48_5:GetGroupId()]
			table = var_48_4

			var_48_4.sort(var_1_10012)

			table = var_13
			var_48_2 = var_48_2 + var_13.indexof(var_1_10012, var_48_5.id) - 1
		end
	end
