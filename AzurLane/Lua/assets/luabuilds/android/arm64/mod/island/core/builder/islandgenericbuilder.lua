...
function var_0_1.Load(arg_1_0, arg_1_1, arg_1_2)
	...
	var_5.insert(var_1_0, function(arg_4_0)
		...
		var_4_1(var_4_0, var_4_2, var_5.GetBehaviourTree(var_4_3), arg_4_0)
...
function var_0_1.LoadAsset(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_3 = arg_6_1.GetAssetPath(var_6_2)
	local var_6_4 = ""

	typeof = var_6_2
	GameObject = var_1_10010

	local var_6_5 = var_6_2(var_1_10010)

	UnityEngine = var_1_10009

	local var_6_6 = var_6_1(var_6_0, var_6_3, var_6_4, var_6_5, var_1_10009.Events.UnityAction_UnityEngine_Object(function(arg_7_0)
		...
		var_2_10002.insert(arg_6_0.insIdList, var_7_1)

		return
	end), true, true)

	arg_6_0:AddLoadingID(var_6_6)
...
function var_0_1.SetupBT(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	local var_9_4 = var_1_10009(var_1_10011.BehaviourTrees.BehaviourTree)

	UnityEngine = var_1_10010

	local var_9_5 = var_9_1(var_9_0, var_9_2, var_9_3, var_9_4, var_1_10010.Events.UnityAction_UnityEngine_Object(function(arg_10_0)
		assert = var_2_10001
		...
		var_2_10001(var_10_0, var_4(var_2_10006.BehaviourTrees.BehaviourTreeOwner)).graph = arg_10_0
