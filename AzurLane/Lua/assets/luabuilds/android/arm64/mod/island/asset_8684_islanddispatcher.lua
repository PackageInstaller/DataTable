...
local var_0_0 = var_0_10000("IslandDispatcher")
...
function var_0_0.AddListener(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_1_10005(arg_2_1) == "string" then
		type = var_5

		local var_2_0

		if var_5(arg_2_2) ~= "function" then
			var_2_0 = false
		else
			var_2_0 = true
		end
...
function var_0_0.ClearListener(arg_4_0, arg_4_1)
	...
	var_1_10002(var_1_10004(arg_4_1) == "string")
...
function var_0_0.DispatchEvent(arg_5_0, arg_5_1, ...)
	...
	if arg_5_0.__callbacks[arg_5_1] then
		...
		for iter_5_1 = 1, var_5_0 do
			arg_5_0.__list[iter_5_1](arg_5_1, ...)
		end
	end
