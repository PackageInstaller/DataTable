...
function var_0_0.GetShipBuffsByType(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_0) do
		...
		for iter_2_2, iter_2_3 in ipairs(var_2_1:GetUnlockShipEffectIds()) do
...
function var_0_0.GetAllShipManageBuffs(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in ipairs({
		...
		var_4_0 = table.mergeArray(var_4_0, (underscore.select(var_0_0.GetShipBuffsByType({
			arg_4_0
...
function var_0_0.GetManageSellPriceBuffs(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in ipairs({
		...
		var_6_0 = table.mergeArray(var_6_0, (underscore.select(var_0_0.GetAllBuffsByType(arg_6_0, iter_6_1), function(arg_7_0)
...
function var_0_0.GetManageSellNumBuffs(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in ipairs({
		...
		var_8_0 = table.mergeArray(var_8_0, (underscore.select(var_0_0.GetAllBuffsByType(arg_8_0, iter_8_1), function(arg_9_0)
