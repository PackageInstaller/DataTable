...
function var_0_0.GetShipBuffsByType(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_1_10003(arg_2_0) do
		...
		for iter_2_2, iter_2_3 in var_1_10008(var_10.GetUnlockShipEffectIds(var_2_1)) do
			pg = var_1_10013
			...
			if var_1_10013.island_buff_template[iter_2_3].buff_type == arg_2_1 then
				...
				IslandShipStatus = var_1_10016

				var_1_10013(var_2_2, var_1_10016.New({
					isSkill = true,
					id = iter_2_3
				}))
			end
		...
		table = var_1_10008
		var_1_10008 = var_1_10008.mergeArray

		local var_2_3 = var_2_0

		var_1_10013 = iter_2_1
		var_2_0 = var_1_10008(var_2_3, iter_2_1.GetVaildStatusByType(var_1_10013, arg_2_1))
	end
...
function var_0_0.GetAllShipManageBuffs(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in var_1_10004(var_4_0) do
		...
		table = var_1_10010
		var_4_1 = var_1_10010.mergeArray(var_4_1, var_1_10009)
	end
...
function var_0_0.GetManageSellPriceBuffs(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in var_1_10004(var_6_0) do
		...
		table = var_1_10010
		var_6_1 = var_1_10010.mergeArray(var_6_1, var_1_10009)
	end
...
function var_0_0.GetManageSellNumBuffs(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in var_1_10004(var_8_0) do
		...
		table = var_1_10010
		var_8_1 = var_1_10010.mergeArray(var_8_1, var_1_10009)
	end
...
function var_0_0.GetManageStatus(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in var_1_10004(var_10_0) do
		...
		for iter_10_2, iter_10_3 in var_1_10009(arg_10_0) do
			...
			table = var_1_10015
			var_10_1 = var_1_10015.mergeArray(var_10_1, var_1_10014)
		end
	end
