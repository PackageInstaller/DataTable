...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.EXCHANGE_LURE, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		var_2_1(var_2_0, var_2_10007.ISLAND_EXCHANGE_LURE, {
			lureId = arg_2_1,
			fishPointId = arg_2_2,
			callback = arg_2_3
		})
	...
	arg_1_0:bind(var_0_1.FISHING_RESULT, function(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5, arg_3_6)
		...
		var_3_3(var_3_2, var_2_10011.ISLAND_FISHING_REUSLT, {
			fishId = arg_3_3,
			fishPointId = arg_3_2,
			weight = arg_3_4,
			cupType = arg_3_5,
	...
	arg_1_0:bind(var_0_1.GO_FISHING, function(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
		...
		var_4_3(var_4_2, var_2_10008.ISLAND_GO_FISHING, {
			poolId = arg_4_1,
			baitId = arg_4_2,
			islandId = var_4_1.id,
			callback = arg_4_3
	...
	arg_1_0:bind(var_0_1.ENTER_ISLAND, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10005.ISLAND_ENTER, {
			id = arg_5_1
		})
	...
	arg_1_0:bind(var_0_1.TRADE_INVITATION, function(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		...
		var_6_1(var_6_0, var_2_10007.ISLAND_INVITE_TRADE, {
			list = arg_6_1,
			mapId = arg_6_2,
			price = arg_6_3
		})
	...
	arg_1_0:bind(var_0_1.REQ_TRADE_RANK, function(arg_7_0, arg_7_1)
		...
		var_7_1(var_7_0, var_2_10005.ISLAND_GET_FRIEND_TRADE_RANK, {
			callback = arg_7_1
		})
	...
	arg_1_0:bind(var_0_1.TRADE_OP, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
		...
		if not var_5.CanPurchase(var_8_2) then
			...
			var_8_4(var_8_3, var_2_10008("island_trade_price_unrefresh"))
		...
		var_8_6(var_8_5, var_2_10008.ISLAND_TRADE, {
			islandId = var_4.id,
			op = arg_8_1,
			num = arg_8_2,
			price = arg_8_3
	...
	arg_1_0:bind(var_0_1.OPEN_FRIEND_INFO, function(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
		...
		local var_9_2 = var_2_10007.FRIEND_SEARCH
		local var_9_3 = {}

		SearchFriendCommand = var_2_10009
		var_9_3.type = var_2_10009.SEARCH_TYPE_RESUME
	...
	arg_1_0:bind(var_0_1.CHANGE_CHAT_ROOM, function(arg_10_0, arg_10_1)
		...
		var_10_1(var_10_0, var_2_10005.CHANGE_CHAT_ROOM, arg_10_1)
	...
	arg_1_0:bind(var_0_1.SEND_CHAT, function(arg_11_0, arg_11_1, arg_11_2)
		...
		var_11_3(var_11_2, var_2_10007.ISLAND_SEND_CHAT, {
			channel = arg_11_1,
	...
	arg_1_0:bind(var_0_1.ANIMATION_OP, function(arg_12_0, arg_12_1, arg_12_2)
		...
		var_12_3(var_12_2, var_2_10007.ISLAND_ANIMATION_OP, {
	...
	arg_1_0:bind(var_0_1.SWITCH_MAP, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if not var_4.IsUnlockMap(var_14_2, arg_14_1) then
			...
			if arg_14_1 ~= var_4.CheaterTavernMapId then
				...
				var_14_4(var_14_3, var_7("island_lock_map_tip"))
		...
		var_14_6(var_14_5, var_7.ISLAND_ENTER_MAP, {
			islandId = var_3.id,
			mapId = arg_14_1,
			callback = function()
				pg = var_3_10000
				...
				if var_3_10000.island_world_objects[arg_14_2] then
					...
					BuildVector3 = var_3_10002

					local var_15_1 = var_3_10002(var_0.param.rotation)
	...
	arg_1_0:bind(var_0_1.RECORD_PLAYER_POS, function(arg_16_0)
		...
		local var_16_0 = var_2_10001:GetController().mapId

		_IslandCore = var_2_10002

		if not var_2_10002:GetView().player or not var_2._tf then
			return
		end

		local var_16_1, var_16_2 = var_2:LastGroundedPosition()
		local var_16_3 = arg_1_0

		var_5.RecordPlayerPosition(var_16_3, var_16_0, var_16_1, var_16_2)
...
function var_0_1.RecordPlayerPosition(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	...
	local var_17_3 = var_1_10007.ISLAND_RECORD_LAST_EXIT_POS
	local var_17_4 = {}
	local var_17_5 = arg_17_0.viewComponent

	var_17_4.islandId = var_9.GetIsland(var_17_5).id
...
function var_0_1.handleNotification(arg_19_0, arg_19_1)
	...
	if var_19_1 ~= var_19_0.NEW_MSG then
		FriendProxy = var_19_4

		if var_19_1 ~= var_19_4.FRIEND_NEW_MSG then
			GuildProxy = var_19_4

			if var_19_1 ~= var_19_4.NEW_MSG_ADDED then
				IslandProxy = var_19_4

				local var_19_4

				if var_19_1 == var_19_4.CHAT_MSG_UPDATE then
					var_1_10006 = arg_19_0.viewComponent
					var_19_4 = var_19_4.emitCore
					ISLAND_EVT = var_1_10007

					var_19_4(var_1_10006, var_1_10007.CHAT_MSG_UPDATE)

					IslandProxy = var_19_4

					if var_19_1 == var_19_4.CHAT_MSG_UPDATE then
						var_19_4 = var_19_3.islandId
						var_1_10007 = arg_19_0.viewComponent

						if var_19_4 == var_19_2.GetIsland(var_1_10007).id then
							var_1_10006 = arg_19_0.viewComponent
							var_19_4 = var_19_4.emitCore
							ISLAND_EVT = var_1_10007

							var_19_4(var_1_10006, var_1_10007.SHOW_CHAT_MSG, var_19_3.msg)
						end
					end
				else
					GAME = var_19_4
					...
					if var_19_1 == var_19_4.CHANGE_CHAT_ROOM_DONE then
						var_1_10006 = arg_19_0.viewComponent
						var_19_5 = var_19_5.emitCore
						ISLAND_EVT = var_1_10007

						var_19_5(var_1_10006, var_1_10007.CHAT_ROOM_UPDATE)
					else
						GAME = var_19_5

						if var_19_1 == var_19_5.OPEN_FRIEND_INFO_DONE then
							arg_19_0.friendInfoPosition = var_19_3
						else
							GAME = var_4

							local var_19_6

							if var_19_1 == var_4.FRIEND_SEARCH_DONE and var_19_3.list[1] then
								var_19_6 = var_19_3.type
								SearchFriendCommand = var_19_2

								if var_19_6 == var_19_2.SEARCH_TYPE_RESUME then
									var_1_10006 = arg_19_0
									var_19_6 = arg_19_0.addSubLayers
									Context = var_1_10007
									var_1_10007 = var_1_10007.New
									var_1_10009 = {}
									IslandFriendInfoLayer = var_1_10010
									var_1_10009.viewComponent = var_1_10010
									FriendInfoMediator = var_1_10010
									var_1_10009.mediator = var_1_10010
									var_1_10009.data = {
										friend = var_19_3.list[1],
										msg = arg_19_0.friendInfoMsg,
										pos = arg_19_0.friendInfoPosition
									}

									var_19_6(var_1_10006, var_1_10007(var_1_10009))
							...
							if var_19_1 == var_19_6.ON_APPLICATION_PAUSE then
								if not var_19_3 then
									_IslandCore = var_19_7

									if var_19_7 and not arg_19_0.exitProcessing then
										var_1_10006 = arg_19_0
										var_19_7 = arg_19_0.sendNotification
										GAME = var_1_10007
										var_1_10007 = var_1_10007.ISLAND_RECONNECT
										var_1_10008 = {}
										_IslandCore = var_1_10009

										local var_19_8 = var_1_10009:GetController()

										var_1_10008.islandId = var_1_10009.GetIsland(var_19_8).id

										var_19_7(var_1_10006, var_1_10007, var_1_10008)
									end
								end
							else
								GAME = var_19_7
								...
								if var_19_1 == var_19_7.ISLAND_ON_HOME then
									var_1_10006 = arg_19_0.viewComponent
									var_19_9 = var_19_9.emit
									BaseUI = var_1_10007

									var_19_9(var_1_10006, var_1_10007.ON_HOME)
								else
									GAME = var_19_9

									local var_19_10

									if var_19_1 == var_19_9.ISLAND_ON_RECONNECT then
										...
										function var_19_10()
											...
											var_0.ExitProcess(var_20_2, "", function()
												...
												var_21_1(var_21_0, var_3_10003.ISLAND_CHANGE_ENTER, var_19_3)
										...
										_IslandCore = var_19_2

										if var_19_2 then
											_IslandCore = var_19_2

											local var_19_11 = var_19_2.state

											IslandCore = var_1_10006

											if var_19_11 == var_1_10006.STATE_INIT_FINISH then
												isa = var_19_11
												_IslandCore = var_1_10007
												IslandMinigameCore = var_1_10008

												if var_19_11(var_1_10007, var_1_10008) then
													local var_19_12 = arg_19_0.viewComponent
													local var_19_13 = var_5.GetIsland(var_19_12)

													var_1_10009 = var_5.GetCheaterTavernAgency(var_19_13)

													var_6.SetIsConnecting(var_1_10009, false)
												end
										...
										arg_19_0.coreInitCallback = var_19_10
									else
										GAME = var_19_10

										local var_19_15

										if var_19_1 == var_19_10.ISLAND_SELECT_GIFT_DONE then
											local var_19_14 = arg_19_0.viewComponent

											var_19_15 = var_19_15.HandleAwardDisplay

											local var_19_16 = var_19_3.dropData
											local var_19_17 = var_19_3.callback

											IslandAwardDisplayPage = var_1_10009

											var_19_15(var_19_14, var_19_16, var_19_17, var_1_10009.TYPE_SIGN_GIFT)
										else
											GAME = var_19_15

											if var_19_1 == var_19_15.ISLAND_CORE_STATE_CHANGED then
												IslandCore = var_4

												if var_19_3 == var_4.STATE_INIT_FINISH and arg_19_0.coreInitCallback then
												...
												if var_19_1 == var_4.ISLAND_TRADE_DONE then
													local var_19_18 = arg_19_0.viewComponent

													var_4.HandleAwardDisplay(var_19_18, var_19_3.dropData, var_19_3.callback)
												else
													GAME = var_4

													local var_19_19

													if var_19_1 == var_4.PLAY_ROOM_LOAD_MINIGAME_SCENE then
														var_19_19 = var_19_3.mapId

														local var_19_20 = arg_19_0.viewComponent
														local var_19_21 = var_5.GetIsland(var_19_20)
														local var_19_22 = var_5.GetMapId(var_19_21)

														arg_19_0.isReconected = var_19_3.isReconecting

														if var_19_22 ~= var_19_19 then
															arg_19_0:LoadMiniGameScene(var_19_19)
															...
															local var_19_23 = var_7.New(function()
																pg = var_2_10000
																...
																var_22_1(var_22_0, var_2_10003.PLAY_ROOM_LOAD_SCENE_COMPLETE)

																return
															end, 2, 0)

															var_7.Start(var_19_23)
														end
													else
														GAME = var_19_19

														if var_19_1 == var_19_19.PLAY_ROOM_ALL_LOAD_OVER then
				...
				local var_19_24 = arg_19_0.viewComponent

				var_4.emit(var_19_24, var_19_1, var_19_3)
...
function var_0_1.LoadMiniGameScene(arg_23_0, arg_23_1)
	...
	IslandOpView = var_1_10007

	local var_23_4

	if not var_23_3(var_23_2, var_1_10007) or not var_4.showBalance then
		var_23_4 = 0
	end

	IslandMinigameCore = var_23_2

	local var_23_5 = var_23_2.New
	local var_23_6 = arg_23_0.viewComponent

	arg_23_0.miniGameCore = var_23_5(var_8.GetPoolMgr(var_23_6), var_2, var_23_4)
...
function var_0_1.SetUp(arg_26_0, arg_26_1)
	...
	local var_26_5 = var_26_3(var_7.GetPoolMgr(var_26_4), var_2, arg_26_1)
...
function var_0_1.UnloadScene(arg_28_0, arg_28_1)
	...
	if var_2 then
		...
		IslandMinigameCore = var_1_10005

		local var_28_1

		if var_2(var_28_0, var_1_10005) then
			_IslandCore = var_28_1
			var_28_1 = var_28_1.showBalance
			_IslandCore = var_1_10003

			var_1_10003:Dispose(arg_28_1)
			...
			if not var_28_5(var_28_4, var_1_10006) or not var_3.showBalance then
				var_28_6 = 1
			end

			_IslandCore = var_28_4

			var_28_4:Dispose(arg_28_1)
