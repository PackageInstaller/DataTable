...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".IslandBaseMonitor"))
...
function var_0_1.HandFishingStart(arg_30_0, arg_30_1)
	...
	var_30_1(var_30_0, var_1_10005.START_FISHING, {
...
function var_0_1.HandFishingStateChange(arg_31_0, arg_31_1)
	...
	var_31_1(var_31_0, var_1_10005.FISHING_STATE_CHANGE, {
...
function var_0_1.HandlePlayerData(arg_34_0, arg_34_1)
	...
	if var_34_0 == var_1_10003.PLAYER_DATA_STATE_EMPTY then
		arg_34_0:UpdatePlayerData(arg_34_1)
	else
		local var_34_1 = arg_34_1.state

		IslandConst = var_3

		if var_34_1 == var_3.PLAYER_DATA_STATE_ENTER then
			...
			if var_34_2 == var_3.PLAYER_DATA_STATE_EXIT then
...
function var_0_1.HandlePlayerEnter(arg_36_0, arg_36_1)
	...
	if not var_3.GetPlayerList(var_36_2)[var_36_0] then
		IslandPlayer = var_36_2

		local var_36_3 = var_36_2.New(arg_36_1)
		...
		if var_36_7(var_36_6, var_9.GetMapId(var_36_8)) then
...
function var_0_1.UpdatePlayerData(arg_37_0, arg_37_1)
	...
	if var_3 then
		...
		var_37_5 = var_37_3(var_37_2, var_7.GetMapId(var_37_4))
	end
...
function var_0_1.HandleTaskData(arg_39_0, arg_39_1)
	...
	for iter_39_0, iter_39_1 in var_1_10003(arg_39_1) do
		...
		var_1_10009 = var_1_10009.New(iter_39_1)

		if var_1_10008 then
			var_39_1:AddTask(var_1_10009)
		else
			var_39_1:UpdateTask(var_1_10009)
		end
	end
...
function var_0_1.HandleRandomTaskData(arg_41_0, arg_41_1)
	...
	for iter_41_0, iter_41_1 in var_41_1(var_41_4) do
		IslandTask = var_1_10009
...
function var_0_1.HandleManageData(arg_42_0, arg_42_1)
	...
	local var_42_0 = var_1_10002(var_1_10004)
...
function var_0_1.SyncStartManage(arg_43_0, arg_43_1)
	...
	IslandOpenRestaurantCommand = var_1_10009

	var_43_8(var_43_7, var_1_10009.OPEN_RESTAURANT, {
		restId = var_43_4.id,
...
function var_0_1.HandleAchievementData(arg_44_0, arg_44_1)
	...
	local var_44_0 = var_1_10002(var_1_10004)
...
function var_0_1.HandleSlotFormulaData(arg_46_0, arg_46_1)
	...
	local var_46_0 = var_1_10002(var_1_10004)
	...
	local var_46_4 = var_46_1.island_production_slot[var_46_3].place
...
function var_0_1.HandleBuildUnlockData(arg_47_0, arg_47_1)
	...
	local var_47_0 = var_1_10002(var_1_10004)
...
function var_0_1.HandleHandSlotUnlockData(arg_48_0, arg_48_1)
	...
	local var_48_0 = var_1_10002(var_1_10004)
...
function var_0_1.HandleTradeNotify(arg_50_0, arg_50_1)
	...
	local var_50_0 = var_1_10002(var_1_10004)
	local var_50_1

	if not var_2.getFriend(var_50_0, arg_50_1.island_id) or not var_2:GetName() then
		var_50_1 = ""
	end

	IslandVisitorLog = var_50_0

	local var_50_2 = var_50_0.New
	local var_50_3 = {
		id = arg_50_1.island_id
	}

	IslandConst = var_7
	var_50_3.cmd = var_7.VISITOR_LOG_CMD_TRADE
	var_50_3.name = var_50_1
	pg = var_7

	local var_50_4 = var_7.TimeMgr.GetInstance()

	var_50_3.time = var_7.GetServerTime(var_50_4)
	var_50_3.mapId = arg_50_1.map_id
	var_50_3.extraInfo = arg_50_1.price

	local var_50_5 = var_50_2(var_50_3)

	if not var_4.BuildWhitoutTime(var_50_5) or var_5 == "" then
		return
	end

	pg = var_50_3

	local var_50_6 = var_50_3.IslandVisitorNotificationMgr.GetInstance()

	var_6.Enqueue(var_50_6, var_4)
...
function var_0_1.HandleSignInNotify(arg_51_0, arg_51_1)
	if arg_51_1.cmd == 2 then
		...
		local var_51_0 = var_2(var_1_10004)
		local var_51_1

		if not var_2.getFriend(var_51_0, arg_51_1.island_id) or not var_2:GetName() then
			var_51_1 = ""
		end

		IslandVisitorLog = var_51_0

		local var_51_2 = var_51_0.New
		local var_51_3 = {
			id = arg_51_1.island_id
		}

		IslandConst = var_7
		var_51_3.cmd = var_7.VISITOR_LOG_CMD_GIFT
		var_51_3.name = var_51_1
		pg = var_7

		local var_51_4 = var_7.TimeMgr.GetInstance()

		var_51_3.time = var_7.GetServerTime(var_51_4)

		local var_51_5 = var_51_2(var_51_3)
		local var_51_7

		if arg_51_0:IsCurrentIsland(arg_51_1.island_id) then
			local var_51_6 = arg_51_0:GetIsland()

			var_51_7 = var_51_7.GetSignInAgency(var_51_6)
			getProxy = var_51_3
			PlayerProxy = var_8

			local var_51_8 = var_51_3(var_8)
			local var_51_9 = var_6.getRawData(var_51_8).id

			var_51_7:AddInviter(var_51_9)
		end

		pg = var_51_7

		local var_51_10 = var_51_7.IslandVisitorNotificationMgr.GetInstance()

		var_5.Enqueue(var_51_10, var_51_5)
	end
...
function var_0_1.HandleAbilityData(arg_54_0, arg_54_1)
	...
	local var_54_0 = var_1_10002(var_1_10004)
...
function var_0_1.SyncStartDelegation(arg_55_0, arg_55_1)
	...
	local var_55_1 = arg_55_0.GetIsland(var_55_0)
	local var_55_2 = var_2.GetBuildingAgency(var_55_1)

	pg = var_55_0

	local var_55_3 = var_55_0.island_production_slot[arg_55_1.appoint_data.id].place
	local var_55_4 = var_55_2:GetBuilding(var_55_3)

	var_6.UpdateDeleationRoleDataBySlotId(var_55_4, arg_55_1.appoint_data.id, arg_55_1.appoint_data)

	local var_55_5 = arg_55_1.appoint_data.ship_id
	local var_55_6 = arg_55_1.appoint_data.id
	local var_55_7 = arg_55_1.appoint_data.formula_id
	local var_55_8 = var_2
	local var_55_9 = var_2.DispatchEvent

	IslandStartDelegationCommand = var_1_10013

	var_55_9(var_55_8, var_1_10013.START_DELEGATION, {
		build_id = var_55_3,
		ship_id = var_55_5,
		area_id = var_55_6,
		formula_id = var_55_7
...
function var_0_1.SyncEndDelegation(arg_56_0, arg_56_1)
	...
	local var_56_1 = var_1_10003:GetBuildingAgency()
	local var_56_2 = var_3.GetBuilding(var_56_1, arg_56_0.buildId)
	local var_56_3 = arg_56_0.islandRoleDelegationData.formula_id
	local var_56_4 = arg_56_0.islandRoleDelegationData.ship_id
	local var_56_5 = arg_56_0.id

	var_56_2:UpdateDeleationRewardDataBySlotId(arg_56_0.id, {
		formula_id = var_56_3
	})
	var_56_2:UpdateDeleationRoleDataBySlotId(arg_56_0.id, nil)

	local var_56_6 = var_56_0
	local var_56_7 = var_56_0.DispatchEvent

	IslandFinishDelegationCommand = var_11

	local var_56_8 = var_11.END_DELEGATION
	local var_56_9 = {
		remainReward = true
	}

	build_id = var_1_10013
	var_56_9.build_id = var_1_10013
	var_56_9.ship_id = var_56_4
	var_56_9.area_id = var_56_5
...
function var_0_1.SyncResetSlotData(arg_57_0, arg_57_1)
	...
	local var_57_1 = arg_57_0.GetIsland(var_57_0)
	local var_57_2 = var_2.GetBuildingAgency(var_57_1)
	...
	for iter_57_0, iter_57_1 in var_57_0(arg_57_1.slot_list) do
		...
		local var_57_3 = var_1_10009.island_production_slot[iter_57_1].place
		local var_57_4 = var_57_2:GetBuilding(var_57_3)

		if var_1_10009.type == 9 or var_1_10009.type == 3 then
			if var_57_4:GetDelegationSlotData(iter_57_1) and var_12:GetSlotRoleData() then
				local var_57_5 = var_13.ship_id
				local var_57_6 = iter_57_1

				var_57_4:UpdateDeleationRoleDataBySlotId(iter_57_1, nil)

				local var_57_7 = var_2
				local var_57_8 = var_2.DispatchEvent

				IslandFinishDelegationCommand = var_19

				var_57_8(var_57_7, var_19.END_DELEGATION, {
					remainReward = false,
					build_id = var_57_3,
					ship_id = var_57_5,
					area_id = var_57_6
			...
			local var_57_9 = var_2
			local var_57_10 = var_2.DispatchEvent

			IslandBuildingAgency = var_17

			var_57_10(var_57_9, var_17.SLOT_RESET_DELEGATION_STATE_DONE, {
				build_id = var_57_3,
				area_id = iter_57_1
			})
		elseif var_1_10009.type == 1 then
			...
			local var_57_11 = var_2
			local var_57_12 = var_2.DispatchEvent

			IslandSlotHandPlantAwardCommand = var_15

			var_57_12(var_57_11, var_15.START_HANDPLANT_AWARD_DONE, {
				build_id = var_57_3,
				area_id = iter_57_1
			})
		end
...
function var_0_1.SyncStarthHandPlant(arg_58_0, arg_58_1)
	...
	local var_58_1 = arg_58_0.GetIsland(var_58_0)
	local var_58_2 = var_2.GetBuildingAgency(var_58_1)
	...
	for iter_58_0, iter_58_1 in var_58_0(arg_58_1.hand_list) do
		...
		local var_58_3 = var_1_10009.island_production_slot[iter_58_1.id].place
		local var_58_4 = var_58_2:GetBuilding(var_58_3)

		var_11.UpdateHandPlantDataBySlotId(var_58_4, iter_58_1)

		local var_58_5 = var_2
		local var_58_6 = var_2.DispatchEvent

		IslandSlotHandPlantCommand = var_15

		var_58_6(var_58_5, var_15.START_HANDPLANT_DONE, {
			build_id = var_58_3,
...
function var_0_1.ResponeAniamtion(arg_59_0, arg_59_1)
	...
	local var_59_2 = var_1_10006.LINK_CORE

	ISLAND_EVT = var_1_10007

	var_59_1(var_59_0, var_59_2, var_1_10007.RESPON_ANIMATION_OP, {
...
function var_0_1.AddChatMsg(arg_60_0, arg_60_1)
	...
	local var_60_1 = arg_60_0.GetIsland(var_60_0)
	local var_60_2 = var_2.GetVisitorAgency(var_60_1)

	getProxy = var_60_0
	PlayerProxy = var_1_10006

	local var_60_3 = var_60_0(var_1_10006)
	local var_60_4 = var_4.getRawData(var_60_3)
	local var_60_5

	if arg_60_1.user_id ~= var_60_4.id or not var_60_4 then
		::label_60_0::

		var_1_10007 = var_60_2
		var_60_5 = var_60_2.GetPlayer(var_1_10007, arg_60_1.user_id)
	end
	...
	local var_60_6 = var_6.InjectPublicMsg
	local var_60_7 = arg_60_1.content

	Clone = var_1_10009

	local var_60_8 = var_60_6(var_60_7, var_1_10009(var_60_5))

	ChatMsg = var_1_10007

	local var_60_9 = var_1_10007.New

	ChatConst = var_9

	local var_60_10 = var_60_9(var_9.ChannelIsland, var_60_8)

	getProxy = var_60_7
	IslandProxy = var_10

	local var_60_11 = var_60_7(var_10)
...
function var_0_1.UpdateActivityNpc(arg_61_0, arg_61_1)
	...
	local var_61_1 = arg_61_0.GetIsland(var_61_0)
	local var_61_2 = var_2.GetActivityNpcAgency(var_61_1)
	...
	for iter_61_0, iter_61_1 in var_61_0(arg_61_1.refresh_list) do
		...
		if var_61_4 == var_1_10011.ACTIVITY_NPC_OP_TYPE_UPDATE then
			var_61_2:UpdateNpc(var_61_3)
		else
			local var_61_5 = iter_61_1.type

			IslandConst = var_1_10011

			if var_61_5 == var_1_10011.ACTIVITY_NPC_OP_TYPE_ADD then
				var_61_2:AddNpc(var_61_3)
			else
				local var_61_6 = iter_61_1.type

				IslandConst = var_1_10011

				if var_61_6 == var_1_10011.ACTIVITY_NPC_OP_TYPE_DEL then
					var_61_2:RemoveNpc(var_61_3)
				end
			end
		end
	end
...
function var_0_1.UpdatePlayerDressupData(arg_62_0, arg_62_1)
	...
	for iter_62_0, iter_62_1 in var_62_1(arg_62_1.dress_list) do
	...
	IslandProxy = iter_62_0

	local var_62_10 = iter_62_0.LINK_CORE

	ISLAND_EVT = iter_62_1

	var_62_9(var_62_8, var_62_10, iter_62_1.CHANGE_VISTER_DRESS, {
		id = arg_62_1.user_id,
