...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.syncDataDelayedProcessor = var_1_2(var_1_3, var_1_10005.SYNC_TIME_INTERVAL * 1000, function(arg_2_0)
	...
	IslandConst = var_5
	arg_1_0.syncObjDelayedProcessor = var_1_4(var_1_5, var_5.SYNC_TIME_INTERVAL * 1000, function(arg_3_0)
	...
	IslandConst = var_5
	arg_1_0.collectClientStateTimer = var_1_6(var_1_7, var_5.SYNC_TIME_INTERVAL, -1)
...
function var_0_0.OnVisitorExit(arg_11_0, arg_11_1)
	if arg_11_0.visitorDic[arg_11_1] then
		if var_2:GetLastInteract() then
			...
			local var_11_1 = arg_11_0.GetUnit(var_11_0, var_3.type, var_3.id)

			var_4.RemoveOwner(var_11_1, arg_11_1)

			local var_11_2 = var_3.type

			IslandConst = var_11_0

			if var_11_2 == var_11_0.SYNC_TYPE_AGORA then
				arg_11_0:Op("AgoraVirtualInterActionEndSync", var_3.id, arg_11_1)
			else
				local var_11_3 = var_3.type

				IslandConst = var_6

				if var_11_3 == var_6.SYNC_TYPE_UNIT_STATIC then
...
function var_0_0.UpdateLocalPlayer(arg_12_0)
	...
	if var_2.IsLoaded(var_12_1) then
		...
		if not var_2.InTimeline(var_12_2) then
			...
			var_3.insert(var_12_0, var_12_4)
		end
	end
	...
	if #var_12_0 > 0 then
		...
		var_12_6(var_12_5, var_1_10005.ISLAND_SYNC_DATA, {
			data = var_12_0,
...
function var_0_0.UpdateVisitorSyncData(arg_15_0, arg_15_1)
	...
	if not arg_15_0.visitorDic[var_15_0] then
		...
		var_15_1(var_1_10006.format("访客不存在 id=%d", var_15_0))
...
function var_0_0.InitAgora(arg_17_0, arg_17_1)
	...
	for iter_17_0, iter_17_1 in var_1_10003(arg_17_1) do
		...
		var_17_0[iter_17_0] = var_1_10008(var_17_1, var_1_10011.SYNC_TYPE_AGORA)
	end
...
function var_0_0.InitWorldObject(arg_21_0, arg_21_1)
	...
	for iter_21_0, iter_21_1 in var_1_10003(arg_21_1) do
		...
		if var_21_1 == var_1_10009.UNIT_TYPE_ITEM_INTERACT then
			...
			var_21_0[var_21_2] = var_1_10009(var_21_3, var_1_10012.SYNC_TYPE_UNIT_STATIC)
		end
	end
			...
			if var_7:OwnerCount() > 0 then
				...
				for iter_22_2, iter_22_3 in var_8(var_7.owners) do
					if iter_22_3 ~= arg_22_0.playerId and arg_22_0.visitorDic[iter_22_3] then
						...
						if var_22_3 == var_1_10014.SYNC_TYPE_UNIT_STATIC then
							arg_22_0:Op("WorldObjectInterActionSync", iter_22_1.id, iter_22_3, iter_22_1.status, iter_22_2)
						else
							local var_22_4 = iter_22_1.type

							IslandConst = var_1_10014

							if var_22_4 == var_1_10014.SYNC_TYPE_AGORA then
				...
				local var_22_5 = iter_22_1.status

				if 0 < var_22_5 then
					local var_22_6 = iter_22_1.type

					IslandConst = var_9

					if var_22_6 == var_9.SYNC_TYPE_UNIT_STATIC then
						...
						if var_22_7 == var_9.SYNC_TYPE_AGORA then
...
function var_0_0.UpdateSyncObj(arg_25_0, arg_25_1)
	arg_25_0:OnVisitorInteract(arg_25_1, function(arg_26_0, arg_26_1)
		...
		IslandConst = var_26_0

		if var_26_2 == var_26_0.SYNC_TYPE_AGORA then
			...
			if var_26_4 == var_4.SYNC_TYPE_UNIT_STATIC then
		...
		if var_27_0 == var_2_10002.SYNC_TYPE_AGORA then
			...
			if var_27_2 == var_2.SYNC_TYPE_UNIT_STATIC then
...
function var_0_0.ControlUnit(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4, arg_33_5, arg_33_6)
	...
	var_33_2(var_33_1, var_1_10010.ISLAND_SYNC_CONTROL, {
