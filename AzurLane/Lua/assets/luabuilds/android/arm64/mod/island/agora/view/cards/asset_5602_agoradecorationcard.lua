...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.usingText = var_1_10(var_1_9, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.cntTxt = var_1_14(var_1_13, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.capcityTxt = var_1_17(var_1_16, var_5(var_1_10007))
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.rarityTr = var_1_20(var_1_19, var_5(var_1_10007))
	...
	i18n = var_1_10003
	var_1_22.text = var_1_10003("island_agora_using")
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_1 = arg_2_1.GetFirstItem(var_2_0)
	local var_2_2 = arg_2_0.nameTxt

	shortenString = var_2_0
	var_2_2.text = var_2_0(var_2_1:GetName(), 5)
	setActive = var_2_2

	var_2_2(arg_2_0.using, arg_2_1:IsUsing())
	arg_2_0:UpdateSelected(arg_2_2)

	local var_2_3 = arg_2_1:GetMaxCnt()

	arg_2_0.cntTxt.text = var_2_3 - arg_2_1:GetAvailableCnt() .. "/" .. var_2_3

	local var_2_4 = arg_2_0.capcityTxt

	var_2_4.text = var_2_1:GetCost()
	GetSpriteFromAtlas = var_2_4

	local var_2_5

	var_2_5.sprite, var_2_5 = var_2_4("ui/IslandDecorationUI_atlas", "r" .. var_2_1:GetRarity()), arg_2_0.rarityTr
	setActive = var_2_5

	var_2_5(arg_2_0.newTr, arg_2_1:IsNew())

	setActive = var_2_5

	var_2_5(arg_2_0.cntTr, not var_2_1:IsOptionalShapeType())

	setActive = var_2_5

	var_2_5(arg_2_0.canInteractionTF, var_2_1:CanInteraction())

	LoadSpriteAsync = var_2_5

	var_2_5("island/IslandFurnitureIcon/" .. var_2_1:GetIcon(), function(arg_3_0)
		IsNil = var_2_10001
...
function var_0_0.UpdateSelected(arg_4_0, arg_4_1)
	...
	var_1_10003(arg_4_0.mark, var_4_1.id == arg_4_1)
