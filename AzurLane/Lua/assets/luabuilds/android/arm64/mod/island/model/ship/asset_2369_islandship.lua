...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	var_1_9.id = arg_1_0.getConfig(var_1_10, "skill_id")
	...
	for iter_1_2, iter_1_3 in var_2(var_1_13) do
		IslandShipStatus = var_1_10
		var_1_10 = var_1_10.New(iter_1_3)
		table = var_8

		var_8.insert(arg_1_0.status, var_1_10)
	end
	...
	if not var_1_14.type then
		var_1_15 = 0
	end

	arg_1_0.state = var_1_15

	local var_1_16

	if not var_1_14.place then
		var_1_16 = 0
	end

	arg_1_0.stateId = var_1_16
...
function var_0_1.GetSkillAddRecoverSpeed(arg_19_0)
	...
	if arg_19_0.skill then
		...
		for iter_19_0, iter_19_1 in var_1_10003(var_19_2) do
			pg = var_1_10008
...
function var_0_1.GetCurrentEnergy(arg_20_0)
	...
	local var_20_2 = var_2.floor(arg_20_0.energy + (var_20_1 - arg_20_0.recorverTime) / arg_20_0.recoverSpeed)
	local var_20_3 = arg_20_0
	local var_20_4 = arg_20_0.GetSkillAddRecoverSpeed(var_20_3)

	if 0 < var_20_4 then
		math = var_4

		local var_20_5 = var_4.floor((var_20_1 - arg_20_0.recorverTime) / arg_20_0.recoverSpeed)

		math = var_20_3
		var_20_2 = var_20_2 + var_20_3.floor(var_20_5 * var_20_4 * 0.01)
	end

	local var_20_6 = arg_20_0
	local var_20_7 = arg_20_0.GetVaildStatusByType

	IslandBuffType = var_1_10007

	if #var_20_7(var_20_6, var_1_10007.SHIP_POWER_RECOVER) == 0 then
		math = var_5

		return var_5.min(arg_20_0.maxEnerey, var_20_2)
	end

	local function var_20_8(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
		math = var_2_10004
		...
		if var_21_0 < var_2_10005.min(arg_21_1, arg_21_3) then
	...
	local var_20_9 = var_4
	local var_20_10 = var_4.GetBuffEffect(var_20_9)[1] * 0.01
	local var_20_11 = var_20_8(arg_20_0.recorverTime, var_20_1, var_4:GetStartTime(), var_4:GetEndTime())

	math = var_20_9

	local var_20_12 = var_20_2 + var_20_9.floor(var_20_11 / arg_20_0.recoverSpeed * var_20_10)

	math = var_9

	return var_9.min(arg_20_0.maxEnerey, var_20_12)
end
...
function var_0_1.GetCurrentEnergyDecimal(arg_22_0)
	...
	local var_22_5 = var_22_4(var_22_3, var_1_10006.SHIP_POWER_RECOVER)
	...
	local function var_22_6(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
		...
		if var_23_0 < var_2_10005.min(arg_23_1, arg_23_3) then
...
function var_0_1.GetEnergyMaxTime(arg_24_0)
	...
	local var_24_5 = var_24_4(var_24_3, var_1_10006.SHIP_POWER_RECOVER)
	...
	if var_24_1 <= var_24_5:GetEndTime() then
		...
		return var_24_10 + var_13.floor(var_24_2 / var_8)
	end
...
function var_0_1.GetPower(arg_27_0)
	...
	local var_27_1 = arg_27_0.GetLevel(var_27_0) * 1000000
	local var_27_2 = 0

	pairs = var_27_0

	for iter_27_0, iter_27_1 in var_27_0(arg_27_0:GetAttrs()) do
		var_27_2 = var_27_2 + iter_27_1
	end
...
function var_0_1.GetEnName(arg_29_0)
	...
	return var_1_10002.island_unit_character[var_29_0].english_name
end
...
function var_0_1.GetModelUnit(arg_32_0)
	...
	if arg_32_0.cur_skin_id and arg_32_0.cur_skin_id ~= 0 then
		...
		if var_3.GetCurrentSkinColorByShipId(var_32_3, arg_32_0.id, arg_32_0.cur_skin_id) ~= 0 then
			pg = var_32_2
			var_32_0 = var_32_2.island_skin_colordiff_template[var_4].model
		end
	end
...
function var_0_1.GetModel(arg_34_0)
	...
	local var_34_1 = var_1_10002.island_unit_character[var_34_0].personal_ani

	return {
		model = var_2.model,
		animator = var_2.animator,
		personal_ani = var_34_1
	}
end
...
function var_0_1.GetModelBySkinAndColorId(arg_35_0, arg_35_1, arg_35_2)
	...
	if arg_35_1 and arg_35_1 ~= 0 then
		pg = var_1_10004
		var_35_0 = var_1_10004.island_skin_template[arg_35_1].model

		if arg_35_2 ~= 0 then
			pg = var_4
			var_35_0 = var_4.island_skin_colordiff_template[arg_35_2].model
		end
	end
...
function var_0_1.IsDelegable(arg_49_0)
	...
	if arg_49_0.GetState(var_49_0) == var_0_1.STATE_NORMAL then
		getProxy = var_1
		IslandProxy = var_49_0

		local var_49_1 = var_1(var_49_0)
		local var_49_2 = var_1.GetIsland(var_49_1)
		local var_49_3 = var_1.GetFollowerAgency(var_49_2)

		var_49_4 = not var_1.Following(var_49_3, arg_49_0.id)
	else
		var_49_4 = false
	end
...
function var_0_1.GetBreakoutMatrials(arg_56_0)
	...
	if not var_56_0[arg_56_0.GetBreakLevel(var_56_2)] then
		var_56_3 = {}
	end
	...
	for iter_56_0, iter_56_1 in var_56_2(var_56_3) do
		...
		var_56_5.type = var_1_10014
		var_56_5.id = iter_56_1[1]
		var_56_5.count = iter_56_1[2]

		var_1_10010(var_56_4, var_56_5)
	end
...
function var_0_1.InitAttrs(arg_57_0)
	...
	local var_57_1 = var_1_10002.floor(arg_57_0.level / var_57_0)
	local var_57_2 = arg_57_0.level % var_57_0
	local var_57_3 = arg_57_0:getConfig("base_att")

	ipairs = var_1_10005

	for iter_57_0, iter_57_1 in var_1_10005(var_57_3) do
		local var_57_4 = iter_57_1[1]
		local var_57_5 = iter_57_1[2]

		IslandShipAttr = var_1_10012
		var_1_10012 = var_1_10012.GetAtrrName(var_57_4)
		var_1_10013 = arg_57_0.attrs
		var_1_10013[var_1_10012] = var_57_5
	end

	local var_57_6 = arg_57_0:getConfig("growth_att")

	ipairs = var_6

	for iter_57_2, iter_57_3 in var_6(var_57_6) do
		local var_57_7 = iter_57_3[1]

		var_1_10012 = iter_57_3[2]
		IslandShipAttr = var_1_10013
		var_1_10013 = var_1_10013.GetAtrrName(var_57_7)

		local var_57_8 = 0

		for iter_57_4 = 1, var_57_1 do
			var_57_8 = var_57_8 + var_1_10012[iter_57_4] * var_57_0
		end

		if var_57_1 < #var_1_10012 then
			var_57_8 = var_57_8 + var_1_10012[var_57_1 + 1] * var_57_2
		end

		arg_57_0.attrs[var_1_10013] = arg_57_0.attrs[var_1_10013] + var_57_8
	end
	...
	for iter_57_7, iter_57_8 in var_6(arg_57_0.attrs) do
		local var_57_9 = arg_57_0.attrs

		math = var_1_10012
		var_57_9[iter_57_7] = var_1_10012.floor(iter_57_8)
	end
...
function var_0_1.GetGrowthAtt(arg_58_0)
	...
	for iter_58_0, iter_58_1 in var_1_10003(var_58_1) do
		local var_58_2 = iter_58_1[1]
		local var_58_3 = iter_58_1[2]

		IslandShipAttr = var_1_10010
		var_1_10010 = var_1_10010.GetAtrrName(var_58_2)

		local var_58_4

		if not var_58_3[arg_58_0:GetBreakLevel()] then
			var_58_4 = 0
		end

		var_58_0[var_1_10010] = var_58_4
	end
...
function var_0_1.GetAttrGradeByValue(arg_62_0, arg_62_1)
	...
	for iter_62_0, iter_62_1 in var_3(var_1_10005.island_chara_att.all) do
		pg = var_1_10008
...
function var_0_1.GetAttrGradeName(arg_64_0, arg_64_1)
	...
	return var_1_10003.island_chara_att[var_64_0].name
end
...
function var_0_1.GetAttrGradeEffect(arg_65_0, arg_65_1)
	...
	return var_1_10003.island_chara_att[var_65_0].effect
end
...
function var_0_1.ExistPotency(arg_71_0)
	...
	for iter_71_0, iter_71_1 in var_1_10001(var_1_10003.ATTRS) do
...
function var_0_1.AddExtraAttr(arg_72_0, arg_72_1, arg_72_2)
	...
	local var_72_2 = arg_72_0.GetExtraAttrValue(var_72_1, arg_72_1) + arg_72_2
	local var_72_3 = arg_72_0.extraAttrs

	math = var_72_1
	var_72_3[arg_72_1] = var_72_1.min(var_72_2, var_72_0)
...
function var_0_1.GetUpgradeExtraAttrConsume(arg_73_0, arg_73_1)
	...
	if var_73_0(var_1_10004.ATTRS, arg_73_1) <= 0 then
		return {}
	end

	local var_73_1 = arg_73_0
	local var_73_2 = arg_73_0.getConfig(var_73_1, "att_item")
	local var_73_3 = {}
	...
	if not var_73_2[var_2] then
		var_73_4 = {}
	end

	for iter_73_0, iter_73_1 in var_73_1(var_73_4) do
		table = var_1_10010
		var_1_10010 = var_1_10010.insert

		local var_73_5 = var_73_3
		local var_73_6 = {
			count = 1
		}

		DROP_TYPE_ISLAND_ITEM = var_1_10014
		var_73_6.type = var_1_10014
		var_73_6.id = iter_73_1

		var_1_10010(var_73_5, var_73_6)
	end
...
function var_0_1.IsFavoriteGift(arg_91_0, arg_91_1)
	...
	return var_1_10003.any(var_91_0, function(arg_92_0)
...
function var_0_1.AddStatus(arg_93_0, arg_93_1)
	...
	if var_1_10002.detect(arg_93_0.status, function(arg_94_0)
		...
		var_1_10003.removebyvalue(arg_93_0.status, var_2)
	end

	local var_93_0 = arg_93_0
	local var_93_1 = arg_93_0.GetVaildStatus(var_93_0)
	local var_93_2 = arg_93_1
	local var_93_3 = arg_93_1.GetDuelTypeList(var_93_2)

	_ = var_93_0

	if var_93_0.detect(var_93_1, function(arg_95_0)
		table = var_2_10001

		return var_2_10001.contains(var_93_3, arg_95_0:GetGroup())
	end) then
		table = var_93_2

		var_93_2.removebyvalue(arg_93_0.status, var_5)
	end

	local var_93_4 = arg_93_1
	local var_93_5 = arg_93_1.GetDuelIdList(var_93_4)

	_ = var_7

	if var_7.detect(var_93_1, function(arg_96_0)
		table = var_2_10001

		return var_2_10001.contains(var_93_5, arg_96_0.id)
	end) then
		table = var_93_4

		var_93_4.removebyvalue(arg_93_0.status, var_7)
	end

	pg = var_93_4

	local var_93_6 = var_93_4.GameTrackerMgr.GetInstance()
	local var_93_7 = var_8.Record

	GameTrackerBuilder = var_1_10011

	var_93_7(var_93_6, var_1_10011.BuildIslandShipAddBuff(arg_93_0.id, arg_93_1.id))

	table = var_93_7

	var_93_7.insert(arg_93_0.status, arg_93_1)
