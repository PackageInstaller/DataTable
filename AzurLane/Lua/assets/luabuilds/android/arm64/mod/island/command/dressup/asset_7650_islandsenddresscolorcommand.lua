	...
	var_7.Send(var_1_5, 21628, {
		...
		if arg_2_0.result == 0 then
			if var_1_0 == 0 then
				...
				var_2_10004 = var_2_2.GetDressUpAgency(var_2_0)

				var_2_2.AddDressColor(var_2_10004, var_1_1, var_1_2)
			end
			...
			var_2_2(var_2_1, var_2_10004.ISLAND_BUY_ROLE_DRESS_COLOR_DONE)
		else
			pg = var_2_2
