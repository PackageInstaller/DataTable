...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".IslandSelfCardLayer"))
...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	var_1_10002({
		function(arg_3_0)
			...
			var_3_1(var_3_0, var_2_10004.ISLAND_GET_CARD_DATA, {
...
function var_0_1.init(arg_6_0)
	...
	local var_6_1 = var_3.Find(var_6_0, "panel/achvs/tpl/empty/Text")

	i18n = var_1_10004

	var_1(var_6_1, var_1_10004("island_card_no_achv_other"))
...
function var_0_1.didEnter(arg_7_0)
	...
	var_1(var_7_0, var_4.Find(var_7_1, "panel/photo/like_btn"), function()
	...
	var_1(var_7_2, var_7_3, var_7_4, var_7_1)
	...
	local function var_7_7()
		...
		local var_10_2 = var_2_10003.NewStyleMsgboxMgr.TYPE_COMMON_MSGBOX
		local var_10_3 = {}

		i18n = var_2_10005
		var_10_3.contentText = var_2_10005("remove_friend_tip")

		function var_10_3.onConfirm()
			local var_11_0 = arg_7_0
			local var_11_1 = var_0.emit

			IslandOtherCardMediator = var_3_10003

			var_11_1(var_11_0, var_3_10003.REMOVE_FRIEND, arg_7_0.card.userId)
	...
	var_1(var_7_5, var_7_6, var_7_7, var_7_1)
	...
	local function var_7_10()
		if arg_7_0.card.whiteMark then
			...
			var_12_1(var_12_0, var_2_10003("island_repeat_vip"))
		...
		var_12_3(var_12_2, var_2_10003.ADD_WHITE_LIST, arg_7_0.card.userId)
	...
	var_1(var_7_8, var_7_9, var_7_10, var_7_1)
	...
	local function var_7_13()
		if arg_7_0.card.blackMark then
			...
			var_13_1(var_13_0, var_2_10003("island_repeat_blacklist"))
		...
		var_13_3(var_13_2, var_2_10003.ADD_BLACK_LIST, arg_7_0.card.userId)
	...
	var_1(var_7_11, var_7_12, var_7_13, var_7_1)
...
function var_0_1.FlushFlagTFs(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10001(arg_18_0.lableFlagLinkTFs) do
		...
		var_1_10006(var_18_0, var_9.ShowLabel(var_18_1))
	end
	...
	for iter_18_2, iter_18_3 in var_1(arg_18_0.socialFlagLinkTFs) do
		...
		var_1_10006(var_18_2, var_9.ShowSocial(var_18_3))
	end
...
function var_0_1.UpdateGrayLabel(arg_21_0, arg_21_1)
	...
	local var_21_0 = arg_21_1:Find("name")

	Color = var_5

	var_1_10002(var_21_0, var_5.NewHex("#F7F7F7"))

	setText = var_1_10002

	local var_21_1 = arg_21_1:Find("name")

	i18n = var_5

	var_1_10002(var_21_1, var_5("island_card_edit_label"))
	...
	local function var_21_4()
		if arg_21_0.card.labelMark then
			...
			var_22_1(var_22_0, var_2_10003("island_card_label_done"))
	...
	var_1_10002(var_21_2, var_21_3, var_21_4, var_7)
...
function var_0_1.GiveLike(arg_23_0)
	if arg_23_0.card.likeMark then
		...
		var_23_1(var_23_0, var_1_10004("island_card_like_done"))
	...
	var_23_3(var_23_2, var_1_10004.GIVE_CARD_LIKE, arg_23_0.card.userId)
...
function var_0_1.OnGiveLikeDone(arg_24_0)
	...
	local var_24_3 = var_24_2(var_24_1, var_4(var_1_10006))
