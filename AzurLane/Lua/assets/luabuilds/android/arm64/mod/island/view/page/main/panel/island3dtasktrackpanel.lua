...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.uiAnim = var_2_1(var_2_0, var_1_10004(var_1_10006))
	...
	arg_2_0.uiAnimEvent = var_2_3(var_2_2, var_4(var_1_10006))
	...
	local var_2_7 = var_3.Find(var_2_6, "content")
	local var_2_8 = arg_2_0.event

	IslandTaskTrackCard = var_2_6
	arg_2_0.mainTrackCard = var_2_5(var_2_7, var_2_8, var_2_6.TYPES.MAIN)
	IslandTaskTrackCard = var_1

	local var_2_9 = var_1.New
	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_3.Find(var_2_10, "other_content")
	local var_2_12 = arg_2_0.event

	IslandTaskTrackCard = var_2_10
	arg_2_0.otherTrackCard = var_2_9(var_2_11, var_2_12, var_2_10.TYPES.OTHER)
...
function var_0_1.OnInit(arg_4_0)
	...
	local function var_4_2()
		...
		if not var_5_3(var_5_2, var_2_10003.MOVE_TASK_ID) then
			return
		end
		...
		var_5_5(var_5_4, var_3.OPEN_PAGE, "Island3dTaskPage", {
			0,
			arg_4_0.mainTask.id
		})
	...
	local function var_4_5()
		...
		if not var_6_3(var_6_2, var_2_10003.MOVE_TASK_ID) then
			return
		end
		...
		var_6_5(var_6_4, var_3.OPEN_PAGE, "Island3dTaskPage", {
			0,
	...
	local var_4_7 = var_1_10002(var_4_4)
...
function var_0_1.UpdataAllTask(arg_8_0)
	...
	IslandTaskTrackCard = var_1_10004

	var_8_9(var_8_8, var_1_10004.TYPES.MAIN)
	...
	var_8_11(var_8_10, var_4.TYPES.OTHER)
...
function var_0_1.UpdateTask(arg_9_0, arg_9_1)
	...
	if arg_9_1 == var_1_10002.TYPES.MAIN then
		...
		var_1_10004 = var_2.GetTaskAgency(var_1_10004)
		arg_9_0.mainTask = var_2.GetMainTraceTask(var_1_10004)
		var_1_10004 = arg_9_0.mainTrackCard

		var_2.Update(var_1_10004, arg_9_0.mainTask, arg_9_0.unlock)
	else
...
function var_0_1.UpdateProgress(arg_10_0, arg_10_1)
	...
	if arg_10_1 == var_1_10002.TYPES.MAIN then
		...
		var_1_10004 = var_2.GetIsland(var_1_10004)
		var_1_10004 = var_2.GetTaskAgency(var_1_10004)
		arg_10_0.mainTask = var_2.GetMainTraceTask(var_1_10004)

		if arg_10_0.mainTask then
			var_1_10004 = arg_10_0.mainTrackCard

			var_2.UpdateProgress(var_1_10004, arg_10_0.mainTask)
		end
	else
		IslandTaskTrackCard = var_2
...
function var_0_1.RemoveTask(arg_11_0, arg_11_1)
	...
	var_11_3(var_11_2, var_1_10005.ON_SET_TRACE_ID, 0, arg_11_1)
