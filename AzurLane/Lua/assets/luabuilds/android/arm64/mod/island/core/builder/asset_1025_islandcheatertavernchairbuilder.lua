...
function var_0_1.Load(arg_2_0, arg_2_1, arg_2_2)
	...
	var_5.insert(var_2_0, function(arg_5_0)
		...
		var_5_1(var_5_0, var_5_2, var_5.GetBehaviourTree(var_5_3), arg_5_0)
...
function var_0_1.NestModel(arg_8_0, arg_8_1)
	...
	var_1_10004(arg_8_1.transform, var_8_1.transform, false)
...
function var_0_1.LoadOtherPart(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	local var_11_4 = var_1_10010(var_1_10012)

	UnityEngine = var_1_10011

	local var_11_5 = var_11_1(var_11_0, var_11_2, var_11_3, var_11_4, var_1_10011.Events.UnityAction_UnityEngine_Object(function(arg_12_0)
		...
		local var_12_1 = var_1.EnqueueInstantiate(var_12_0, arg_12_0, function(arg_13_0)
			...
			Vector3 = var_3_10002
			var_13_0.localPosition = var_3_10002(0, 0.05, 0)
			setParent = var_13_0
		...
		var_2_10002.insert(arg_11_0.insIdList, var_12_1)
