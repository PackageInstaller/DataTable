...
local function var_0_3(arg_9_0, arg_9_1, arg_9_2)
	...
	if not var_9_4(var_9_3, var_7(var_1_10009)) then
		return
	end

	Animator = var_5

	local var_9_5 = var_5.StringToHash(arg_9_1)
...
local function var_0_4(arg_10_0, arg_10_1, arg_10_2)
	...
	var_10_2(var_10_1, var_10_3, var_10_4, var_10_5, var_1_10010(arg_10_2))
...
local function var_0_7(arg_13_0, arg_13_1, arg_13_2)
	...
	if var_13_0 == "IslandRestaurantPage" then
		...
		if var_13_3(var_13_4, var_1_10010(var_3)) then
			var_1_10010 = var_13_2:GetManageAgency()

			local var_13_5 = var_7.GetRestaurant

			unpack = var_1_10011

			local var_13_6 = var_13_5(var_1_10010, var_1_10011(var_3))

			var_1_10011 = var_5

			local var_13_7 = var_5.ShowMsgbox
			...
			IslandMsgBox = var_13
			var_1_10012.type = var_13.TYPE_ISLAND_POST_EVENT
			var_1_10012.rest = var_13_6

			function var_1_10012.onHide()
				local var_14_0 = arg_13_1
				local var_14_1 = var_0.NotifiyIsland

				ISLAND_EX_EVT = var_2_10003

				local var_14_2 = var_2_10003.OPEN_PAGE

				_G = var_2_10004

				local var_14_3 = var_2_10004[var_13_0]

				unpack = var_5

				var_14_1(var_14_0, var_14_2, var_14_3, var_5(var_0))

				return
			end

			var_13_7(var_1_10011, var_1_10012)
	...
	do
		...
		local var_13_9 = arg_13_1.NotifiyIsland

		ISLAND_EX_EVT = var_1_10010

		local var_13_10 = var_1_10010.OPEN_PAGE

		_G = var_1_10011

		local var_13_11 = var_1_10011[var_13_0]

		unpack = var_1_10012

		var_13_9(var_13_8, var_13_10, var_13_11, var_1_10012(var_3))
	end
...
local function var_0_8(arg_15_0, arg_15_1)
	...
	local var_15_2 = var_1_10005.SWITCH_MAP

	tonumber = var_1_10006

	var_15_1(var_15_0, var_15_2, var_1_10006(arg_15_0))
...
local function var_0_10(arg_17_0, arg_17_1, arg_17_2)
	...
	var_17_2(var_17_1, var_17_3, var_17_4, var_17_5, var_1_10010(arg_17_2))
...
local function var_0_12(arg_19_0, arg_19_1)
	...
	local var_19_2 = var_1_10005.TRIGGER_TASK

	tonumber = var_1_10006

	var_19_1(var_19_0, var_19_2, var_1_10006(arg_19_0))
...
local function var_0_13(arg_20_0, arg_20_1)
	...
	local var_20_2 = var_1_10005.SUBMIT_TASK

	tonumber = var_1_10006

	var_20_1(var_20_0, var_20_2, var_1_10006(arg_20_0))
...
local function var_0_14(arg_21_0)
	...
	local var_21_2 = var_1_10004.EMIT

	IslandMediator = var_1_10005

	var_21_1(var_21_0, var_21_2, var_1_10005.SIGNIN)
...
local function var_0_15(arg_22_0)
	...
	local var_22_4 = var_1_10007.EMIT

	IslandMediator = var_1_10008

	var_22_3(var_22_2, var_22_4, var_1_10008.SELECT_GIFT, var_22_1, var_2.data.index)
...
local function var_0_16(arg_23_0)
	...
	var_23_1(var_23_0, var_1_10004.OPEN_PAGE)
...
function var_0_0.AddInteractionTaskProgress(arg_24_0, arg_24_1)
	...
	local var_24_3 = var_1_10006.ADD_TASK_PROGRESS

	IslandTaskTargetType = var_1_10007

	var_24_1(var_24_0, var_24_2, var_24_3, var_1_10007.INTERACTION, arg_24_1)
...
local function var_0_17(arg_25_0)
	...
	local var_25_2 = var_1_10004.EMIT

	IslandMediator = var_1_10005

	var_25_1(var_25_0, var_25_2, var_1_10005.GET_THEMES, function()
...
local function var_0_18(arg_27_0)
	...
	if not var_3.CanUpgrade(var_27_2) then
		...
		var_27_4(var_27_3, var_1_10006("island_agora_max_level"))
	...
	var_27_7.type = var_1_10007.TYPE_AGORA_UPGRADE
...
local function var_0_19(arg_29_0, arg_29_1)
	...
	var_29_1(var_29_0, var_1_10005.PLAY_PERFORMANCE, {
		name = arg_29_1
	})
...
local function var_0_21(arg_31_0, arg_31_1)
	...
	for iter_31_0, iter_31_1 in var_1_10004(var_1_10006.island_chara_template.all) do
		pg = var_1_10009
	...
	if var_31_1 then
		...
		IslandMediator = iter_31_0

		var_31_3(var_31_2, iter_31_0.ADD_FOLLOWER, var_31_1)
	end
