...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_1:Find("Text")

	i18n = var_5

	var_2(var_2_2, var_5("island_season_pt_hold"))

	local var_2_3 = arg_2_0._tf

	arg_2_0.getAllBtn = var_2.Find(var_2_3, "get_all")
	setText = var_2

	local var_2_4 = arg_2_0.getAllBtn
	local var_2_5 = var_4.Find(var_2_4, "Text")

	i18n = var_5

	var_2(var_2_5, var_5("island_season_pt_collectall"))

	local var_2_6 = arg_2_0._tf

	arg_2_0.blurTF = var_2.Find(var_2_6, "content")

	local var_2_7 = arg_2_0.blurTF
	local var_2_8 = var_2.Find(var_2_7, "view")

	arg_2_0.scrollCom = var_2.GetComponent(var_2_8, "LScrollRect")

	local var_2_9 = arg_2_0._tf

	arg_2_0.importantAwardTF = var_2.Find(var_2_9, "important")
...
function var_0_1.OnInit(arg_3_0)
	...
	function var_3_0.onUpdateItem(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_4_2, var_2_10006(arg_4_1))
	...
	local function var_3_3()
		...
		var_5_1(var_5_0, var_2_10003.ON_GET_SEASON_PT_AWARD, 0)
...
function var_0_1.UpdateAward(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_6 = arg_7_2.Find(var_7_5, "get")
	...
	local function var_7_7()
		...
		var_8_1(var_8_0, var_2_10003.ON_GET_SEASON_PT_AWARD, var_7_0.target)
	...
	var_6(var_7_4, var_7_6, var_7_7, var_7_5)
...
function var_0_1.Flush(arg_11_0)
	...
	var_1(var_11_2, var_4.GanGetPtAward(var_11_3))
...
function var_0_1.BuildPhaseAwardScrollPos(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1(arg_12_0.awardInfos) do
		if iter_12_1.isImportant then
			...
			var_12_5.pos = var_10.HeadIndexToValue(var_12_6, iter_12_0 - var_0_1.AWARD_SHOW_CNT) / arg_12_0.impTotalPos
