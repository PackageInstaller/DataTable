...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.cntTxt = var_2_9(var_2_8, var_4(var_1_10006))
	UIItemList = var_1

	local var_2_10 = var_1.New
	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_3.Find(var_2_11, "frame/animroot/rect/content")
	local var_2_13 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_10(var_2_12, var_4.Find(var_2_13, "frame/animroot/rect/content/tpl"))
	...
	arg_2_0.canvasGroup = var_1(var_2_14, var_4(var_2_13))
...
function var_0_1.AddListeners(arg_5_0)
	...
	IslandOrderAgency = var_1_10004

	var_5_1(var_5_0, var_1_10004.ORDER_FINISH_UPDATE, arg_5_0.OnReset)
...
function var_0_1.RemoveListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10004.ORDER_FINISH_UPDATE, arg_6_0.OnReset)
...
function var_0_1.FlushLevelInfo(arg_11_0, arg_11_1)
	...
	if arg_11_1:IsMaxLevel() then
		...
		local var_11_2 = var_3.max(1, arg_11_1:GetNextTargetExp())

		setSlider = var_11_0

		var_11_0(arg_11_0.expTr, 0, 1, var_11_1 / var_11_2)
...
function var_0_1.ScrollTo(arg_14_0, arg_14_1, arg_14_2)
	...
	var_1_10003(function()
		...
		local var_15_5 = var_15_1.abs(var_15_4.localPosition.x - var_15_2.localPosition.x)
		local var_15_6 = arg_14_0.uiItemList.container.localPosition
		local var_15_7 = arg_14_0.uiItemList.container

		Vector3 = var_6
		var_15_7.localPosition = var_6(var_15_6.x - var_15_5, var_15_6.y, 0)
...
function var_0_1.UpdateCard(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	local var_16_2 = arg_16_1.CanGetAward(var_16_1, arg_16_3) or var_16_0

	setActive = var_16_1

	var_16_1(arg_16_2:Find("got"), var_16_0)

	setActive = var_16_1

	local var_16_3 = arg_16_2

	var_16_1(arg_16_2.Find(var_16_3, "finish"), var_16_2)
	...
	local var_16_5 = arg_16_2:Find("num")

	setColorStr = var_16_3

	var_8(var_16_5, var_16_3(var_16_4, var_16_2 and "#FFFFFF" or "#979797"))
	...
	local function var_16_8()
		if var_0 and not var_16_0 then
			...
			var_17_1(var_17_0, var_2_10003.ON_GET_ORDER_EXP_AWARD, arg_16_3)
		end
	...
	var_8(var_16_6, var_16_7, var_16_8, var_13)
...
function var_0_1.UpdateAwards(arg_18_0, arg_18_1, arg_18_2)
	...
	var_18_3(var_18_2, var_8.min(2, #var_18_0))
