	...
	var_7.Send(var_2_0, 21200, {
		...
		if var_1.IsSelf(var_3_0, arg_2_1) then
			...
			if not var_2_10002 then
				SharedIsland = var_2_10002
			end

			local var_3_1 = var_2_10002.New(arg_3_0.island)
			local var_3_3
			...
			if arg_3_0.player_position then
				...
				Vector3 = var_3_3
				var_3_3 = var_3_3(arg_3_0.player_position.position.x, arg_3_0.player_position.position.y, arg_3_0.player_position.position.z)
				Vector3 = var_2_10006
				var_2_10006 = var_2_10006(arg_3_0.player_position.rotation.x, arg_3_0.player_position.rotation.y, arg_3_0.player_position.rotation.z)

				var_3_1:SetMapId(var_3_2)
				var_3_1:SetLastExitPosition(var_3_2, var_3_3, var_2_10006)
			end
			...
			if arg_2_5 then
				...
				local var_3_4 = var_4(var_2_10006)

				if var_4.GetTempPlayerPosition(var_3_4) then
					unpack = var_3_3

					local var_3_5, var_3_6

					var_3_3, var_3_5, var_3_6 = var_3_3(var_4)
					var_2_10010 = var_3_1

					var_3_1.SetMapId(var_2_10010, var_3_3)

					var_2_10010 = var_3_1

					var_3_1.SetLastExitPosition(var_2_10010, var_3_3, var_3_5, var_3_6)
				end
			end
			...
			for iter_3_0, iter_3_1 in var_3_3(arg_2_2) do
				IslandPlayer = var_2_10010
				var_2_10010 = var_2_10010.New(iter_3_1)
				var_3_7[iter_3_1.id] = var_2_10010
			end

			local var_3_8 = var_3_1:GetVisitorAgency()

			var_5.SetPlayerList(var_3_8, var_3_7)

			if var_1 then
				getProxy = var_5
				IslandProxy = var_3_8
				var_3_8 = var_5(var_3_8)

				var_5.SetIsland(var_3_8, var_3_1)
			else
				getProxy = var_5
				IslandProxy = var_3_8

				local var_3_9 = var_5(var_3_8)

				var_5.SetSharedIsland(var_3_9, var_3_1)
			end
			...
			var_5.AfterIslandInit(var_3_10)
			...
			local var_3_12 = var_5.sendNotification

			GAME = var_8

			var_3_12(var_3_11, var_8.ISLAND_ENTER_MAP, {
				islandId = arg_2_1,
...
function var_0_1.GoScene(arg_6_0, arg_6_1)
	...
	if arg_6_0:IsSelf(arg_6_1) then
		...
		var_6_1(var_6_0, var_6_2, var_1_10006.ISLAND, {
			id = arg_6_1
		})
	else
		...
		var_6_4(var_6_3, var_6_5, var_1_10006.SHARED_ISLAND, {
			id = arg_6_1
		})
	end
