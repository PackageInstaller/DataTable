...
function var_0_1.CheckChildSlotIsInWork(arg_13_0)
	...
	if var_2.GetBuilding(var_13_2, arg_13_0.buildId) then
		...
		if var_13_1.island_production_slot[arg_13_0.id].exclusion_slot ~= "" or not {} then
			var_13_3 = var_4.exclusion_slot
		end

		ipairs = var_6

		for iter_13_0, iter_13_1 in var_6(var_13_3) do
...
function var_0_1.UpdatePerSecond(arg_15_0)
	...
	if var_1.CheckDelegationIsEnd(var_15_0) then
		...
		if arg_15_0.isSelf then
			...
			var_15_1(var_15_0, var_1_10004.ISLAND_FINISH_DELEGATION, {
			...
			IslandFinishDelegationCommand = var_9

			var_15_9(var_15_8, var_9.END_DELEGATION, {
				remainReward = true,
				build_id = arg_15_0.buildId,
				ship_id = var_15_7,
				area_id = arg_15_0.id
