...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.validTimeTxt = var_1_9(var_1_8, var_5(var_1_10007))
	...
	local var_1_12 = var_4.Find(var_1_11, "Text")

	i18n = var_5

	var_2(var_1_12, var_5("island_ticket_expired"))
	...
	typeof = var_5
	Text = var_7
	arg_1_0.willExpireTxt = var_1_16(var_1_15, var_5(var_7))
...
function var_0_0.Update(arg_2_0, arg_2_1)
	...
	var_1_10002(var_2_0, var_5.getConfig(var_2_1, "name"))
	...
	var_1_10002(var_2_2, var_5.GetCount(var_2_3))
	...
	var_1_10002(var_2_4, var_5.GetFrameName(var_2_5), arg_2_0.frameTF, true)
	...
	var_1_10002(var_2_6, var_5.GetBgName(var_2_7), arg_2_0.bgTF, true)

	GetImageSpriteFromAtlasAsync = var_1_10002

	local var_2_8 = arg_2_0.ticket

	var_1_10002(var_4.GetIconName(var_2_8), "", arg_2_0.iconTF, true)
	...
	var_1_10003(arg_2_0.timePanel, not var_2_10)
	arg_2_0:UpdateTimer()
	arg_2_0:StopTimer()
...
function var_0_0.UpdateTimer(arg_5_0)
	...
	var_1_10002(arg_5_0.expiredTF, var_5_1)

	setActive = var_1_10002

	var_1_10002(arg_5_0.validTimeTF, not var_5_1)
	...
	if not var_5_1 then
		...
		if var_5_0.floor(var_5_3 / 0) >= 1 then
			local var_5_4 = arg_5_0.validTimeTxt

			i18n = var_5
			var_5_4.text = var_5("island_ticket_expired_day", var_3)
		else
			local var_5_5 = arg_5_0.validTimeTxt

			pg = var_5

			local var_5_6 = var_5.TimeMgr.GetInstance()
