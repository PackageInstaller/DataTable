...
function var_0_1.GetStoryNameList(arg_1_0)
	...
	local function var_1_1(arg_2_0, arg_2_1)
		...
		if var_2.StoryName2StoryId(var_2_0, arg_2_1) then
			...
			var_2_10003.insert(arg_2_0, var_2)
		end
...
function var_0_1.Ctor(arg_3_0, arg_3_1)
	...
	var_3_1(var_3_0, var_5.ON_SCENE_LOADED, function()
...
function var_0_1.Play(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	local var_6_1 = var_1_10005.detect(arg_6_2, function(arg_7_0)
	...
	for iter_6_0, iter_6_1 in var_7(arg_6_2) do
		...
		var_1_10012.insert(var_6_0, function(arg_8_0)
			...
			IslandFindingPathPlayer = var_2_10005

			if var_2_10002(var_8_2, var_2_10005) and var_6_1 then
				var_8_1:SetEndCallback(function()
					local var_9_0 = arg_6_0

					var_0.ClearLockNpc(var_9_0, var_6_1.unitIdList, false)
	...
	var_7(var_6_0, function()
		if not var_6_2 and var_6_1 then
			local var_10_0 = arg_6_0

			var_1.ClearLockNpc(var_10_0, var_6_1.unitIdList, true)
		end
...
function var_0_1.ClearLockNpc(arg_11_0, arg_11_1, arg_11_2)
	...
	for iter_11_0, iter_11_1 in var_1_10003(arg_11_1) do
		...
		IslandBaseScene = var_1_10011
		var_1_10011 = var_1_10011.LINK_CORE_EVENT
		IslandProxy = var_1_10012
		var_1_10012 = var_1_10012.RELEASE_NPC_REFRESH

		local var_11_2 = iter_11_1

		IslandConst = var_1_10014

		var_11_1(var_11_0, var_1_10011, var_1_10012, var_11_2, var_1_10014.UNIT_LIST_OBJ)
	end
...
function var_0_1.OnStart(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_1_10005.STORY_UPDATE, {
		storyId = arg_12_1
	})
	...
	local var_12_4 = var_5.LINK_CORE_EVENT

	IslandProxy = var_6

	var_12_3(var_12_2, var_12_4, var_6.PERFORMANCE_START)
...
function var_0_1.OnEnd(arg_13_0, arg_13_1)
	...
	local var_13_2 = var_1_10005.LINK_CORE_EVENT

	IslandProxy = var_1_10006

	var_13_1(var_13_0, var_13_2, var_1_10006.PERFORMANCE_END, arg_13_1)
...
function var_0_1.OnSceneLoaded(arg_14_0)
	...
	IslandTransferPlayer = var_1_10004

	if var_1(var_14_0, var_1_10004) then
