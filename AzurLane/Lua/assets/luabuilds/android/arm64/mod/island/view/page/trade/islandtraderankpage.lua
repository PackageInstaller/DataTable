...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_1 = var_3.Find(var_2_0, "title/Text")

	i18n = var_1_10004

	var_1_10001(var_2_1, var_1_10004("island_trade_rank_num_label"))

	setText = var_1_10001

	local var_2_2 = arg_2_0._tf
	local var_2_3 = var_3.Find(var_2_2, "title/Text_1")

	i18n = var_4

	var_1_10001(var_2_3, var_4("island_trade_rank_info_label"))

	setText = var_1_10001

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_3.Find(var_2_4, "title/Text_2")

	i18n = var_4

	var_1_10001(var_2_5, var_4("island_trade_rank_price_label"))

	setText = var_1_10001

	local var_2_6 = arg_2_0._tf
	local var_2_7 = var_3.Find(var_2_6, "tpl/main/visit/Text")

	i18n = var_4

	var_1_10001(var_2_7, var_4("island_visit_title"))

	setText = var_1_10001

	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_3.Find(var_2_8, "tpl/main/invite/Text")

	i18n = var_4

	var_1_10001(var_2_9, var_4("island_trade_invite_label"))
	...
	arg_2_0.selfRankCard = var_2_13(var_3.Find(var_2_14, "tpl"))
	arg_2_0.cards = {}
...
function var_0_1.GetDislays(arg_8_0)
	...
	if var_8_2 == var_1_10004.MODE_SELL then
		...
		var_1_10005 = var_8_2(var_1_10005)
		var_1_10005 = var_3.GetIsland(var_1_10005)
		var_1_10005 = var_3.GetTradeAgency(var_1_10005)

		local var_8_3

		var_8_3, var_8_4 = var_3.GetSellRanks(var_1_10005)
		var_8_1 = var_8_4
		var_8_0 = var_8_3
	else
		local var_8_5 = arg_8_0.mode

		IslandTradePage = var_8_4

		if var_8_5 == var_8_4.MODE_PURCHAS then
			getProxy = var_8_5
			IslandProxy = var_1_10005

			local var_8_6 = var_8_5(var_1_10005)
			local var_8_7 = var_3.GetIsland(var_8_6)
			local var_8_8 = var_3.GetTradeAgency(var_8_7)
			local var_8_9

			var_8_9, var_8_4 = var_3.GetRanks(var_8_8)
			var_8_1 = var_8_4
			var_8_0 = var_8_9
		end
	end
	...
	var_8_4.insert(var_8_10, var_8_1)
	...
	for iter_8_0, iter_8_1 in var_4(var_8_0) do
		if iter_8_1:IsVaild() then
			...
			var_9.insert(var_8_10, iter_8_1)
		end
	end

	table = var_4

	var_4.sort(var_8_10, function(arg_9_0, arg_9_1)
	...
	for iter_8_2, iter_8_3 in var_7(var_8_10) do
		if iter_8_3.value ~= var_8_12 then
			var_8_13 = var_8_13 + 1
			var_8_11[iter_8_3.value] = var_8_13
			var_8_12 = iter_8_3.value
		end
	end

	return var_8_1, var_8_10, var_8_11
end
...
function var_0_1.RequestRank(arg_10_0, arg_10_1)
	...
	var_10_1(var_10_0, var_1_10005.REQ_TRADE_RANK, arg_10_1)
...
function var_0_1.OnInitItem(arg_12_0, arg_12_1)
	...
	local function var_12_3()
		...
		var_13_1(var_13_0, var_2_10003.ENTER_ISLAND, var_12_0.id)
...
function var_0_1.UpdateSelfRank(arg_15_0, arg_15_1)
	...
	local function var_15_4()
		...
		var_16_1(var_16_0, var_2_10003.OPEN_INVITE_PAGE)
	...
	var_3(var_15_2, var_15_3, var_15_4, var_8)
