...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".IslandBookItemPage"))
...
function var_0_1.OnLoaded(arg_4_0)
	...
	local var_4_2 = var_3.Find(var_4_1, "stars")
	local var_4_3 = arg_4_0.rightTF

	arg_4_0.starList = var_4_0(var_4_2, var_4.Find(var_4_3, "stars/tpl"))
...
function var_0_1.FlushRightPanel(arg_5_0)
	...
	local var_5_2 = var_5_1 == var_1_10002.STATUS.UNLOCK
	...
	local var_5_5 = var_5_0(var_1_10005)
	...
	local var_5_10 = var_6.Find(var_5_9, "level")
	local var_5_11
	...
	var_5_3(var_5_10, var_5_11)

	setScrollTextWithSize = var_5_3

	local var_5_12 = arg_5_0.rightNameTF
	local var_5_13 = arg_5_0.rightTF
	local var_5_14 = var_7.Find(var_5_13, "scroll_name/Text")
	local var_5_15 = arg_5_0.showIllustration

	var_5_3(var_5_12, var_5_14, var_8.GetName(var_5_15), 11)
