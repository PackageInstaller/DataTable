...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.orderTxt = var_2_9(var_2_8, var_4(var_1_10006))
	...
	local var_2_12 = var_3.Find(var_2_11, "frame/title/Text")

	i18n = var_4

	var_2_10(var_2_12, var_4("island_chara_list"))
...
function var_0_1.AddListeners(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10004.ADD_SHIP, arg_5_0.OnAddShip)
...
function var_0_1.RemoveListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10004.ADD_SHIP, arg_6_0.OnAddShip)
...
function var_0_1.OnInit(arg_8_0)
	...
	local function var_8_5(arg_11_0)
		if arg_11_0 then
			...
			var_11_1(var_11_0, var_2_10004.OPEN_SHIP_INDEX, {
	...
	IslandShipIndexLayer = var_1_10002
	var_8_9.sortIndex = var_1_10002.SortLevel
...
function var_0_1.OnInitItem(arg_17_0, arg_17_1)
	...
	local function var_17_3()
		...
		var_18_2(var_18_1, var_3.SELECT_SHIP, var_17_0.configId)
	...
	var_1_10003(var_17_1, var_17_2, var_17_3, var_1_10008)
...
local function var_0_2(arg_22_0, arg_22_1)
	...
	local var_22_1 = var_22_0(var_1_10004.gsub(arg_22_1, "%.", "%%."))

	IslandShip = var_1_10003

	local var_22_2 = var_1_10003.StaticGetName(arg_22_0)
	...
	return var_22_3(var_6.lower(var_22_2), var_22_1)
end
...
local function var_0_3(arg_28_0, arg_28_1, arg_28_2)
	...
	local var_28_3 = arg_28_0.ToVShip(var_28_2, var_28_1)
	local var_28_4 = arg_28_0.characterAgency
	local var_28_5 = var_6.GetShipById(var_28_4, arg_28_1)

	ShipIndexConst = var_28_2

	if var_28_2.filterByCamp(var_28_3, arg_28_2.campIndex) then
		ShipIndexConst = var_7

		if var_7.filterByRarity(var_28_3, arg_28_2.rarityIndex) then
			IslandShipIndexLayer = var_7

			if var_7.filterByExtra(var_28_5, arg_28_2.extraIndex) then
				return true
			end
		end
	end
...
function var_0_1.GetShips(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1_10004(var_29_3) do
		if var_0_2(iter_29_1, arg_29_0.searchKey) and var_0_3(arg_29_0, iter_29_1, arg_29_0.sortData) then
			var_1_10011 = arg_29_0.characterAgency

			if var_9.GetShipById(var_1_10011, iter_29_1) then
				table = var_1_10010
	...
	CompareFuncs = iter_29_1

	var_29_5(var_29_6, iter_29_1(var_29_4))
	...
	for iter_29_2, iter_29_3 in var_29_5(var_29_1) do
		...
		var_10.insert(var_29_0, iter_29_3.configId)
	end
	...
	if arg_29_0.hideUnlockShip then
		for iter_29_4 = #var_29_0, 1, -1 do
			if var_29_0[iter_29_4] then
				...
				var_1_10012 = var_10.GetIsland(var_1_10012)
				var_1_10012 = var_10.GetCharacterAgency(var_1_10012)

				if var_10.GetShipById(var_1_10012, var_9) == nil then
					table = var_1_10011
...
function var_0_1.Hide(arg_30_0)
	...
	var_30_2(var_30_1, var_4.CLOSE_DOCK)
