...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	for iter_1_2, iter_1_3 in var_3(var_1_4) do
		...
		arg_1_0.UpdateDeleationRoleDataBySlotId(var_1_10010, iter_1_3.id, iter_1_3)
	end
	...
	for iter_1_4, iter_1_5 in var_3(var_1_5) do
		...
		arg_1_0.UpdateDeleationRewardDataBySlotId(var_1_10010, iter_1_5.id, iter_1_5)
	end
...
function var_0_1.InitSlotRoleDataByAbility(arg_8_0, arg_8_1)
	...
	if var_8_0.type == 3 then
		...
		var_1_10008 = var_8_3
		var_8_2 = var_8_3.DispatchEvent
		IslandBuildingAgency = iter_8_0

		var_8_2(var_1_10008, iter_8_0.GEN_ANIMAL_INT, {
			aniList = var_8_1,
			slotId = arg_8_1
		})
	end
	...
	if var_8_0.type == 9 then
		...
		local var_8_6 = var_8_3.DispatchEvent

		IslandBuildingAgency = var_1_10008

		var_8_6(var_8_5, var_1_10008.SLOT_DELEGATE_INIT, {
			slotId = arg_8_1
		})
	end

	local var_8_7 = arg_8_0.delegationSlotData

	IslandRoleDelegationSlot = var_8_2
	var_8_7[arg_8_1] = var_8_2.New(arg_8_0.configId, {
		id = arg_8_1,
		part_list = var_8_1,
		formula_list = {}
	}, true)
...
function var_0_1.UpdateDeleationRoleDataBySlotId(arg_11_0, arg_11_1, arg_11_2)
	if not arg_11_0:GetDelegationSlotData(arg_11_1) then
		warning = var_1_10004

		var_1_10004("下发数据有问题,下发的槽位id不是当前区域能委派的槽位,下发的槽位id为" .. arg_11_1)
...
function var_0_1.UpdateDeleationRewardDataBySlotId(arg_12_0, arg_12_1, arg_12_2)
	if not arg_12_0:GetDelegationSlotData(arg_12_1) then
		warning = var_1_10004

		var_1_10004("下发数据有问题,下发的槽位id不是当前区域能委派的槽位,下发的槽位id为" .. arg_12_1)
...
function var_0_1.UpdateHandPlantDataBySlotId(arg_15_0, arg_15_1)
	if not arg_15_0:GetHandPlantSlotData(arg_15_1.id) then
		warning = var_1_10003

		var_1_10003("下发数据有问题,下发的槽位id不是当前区域能委派的槽位,下发的槽位id为" .. arg_15_1.id)
...
function var_0_1.GetMinRoleDeleGationTime(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10002(arg_22_0.delegationSlotData) do
		if iter_22_1:GetRoleDelegateFinishTime() ~= -1 then
			if var_22_0 then
				math = var_1_10008

				if not var_1_10008.min(var_7, var_22_0) then
					::label_22_0::
...
function var_0_1.GetShipIdAndAreaIdList(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1_10002(arg_23_0.delegationSlotData) do
		if iter_23_1:GetRoleShipData() then
			table = var_1_10008

			var_1_10008.insert(var_23_0, var_7)
		end
	end
...
function var_0_1.GetDelegateingSlotAndFormulaList(arg_24_0)
	...
	for iter_24_0, iter_24_1 in var_1_10002(arg_24_0.delegationSlotData) do
		if iter_24_1:GetRoleSlotAndFormulaData() then
			table = var_1_10008

			var_1_10008.insert(var_24_0, var_7)
		end
	end
