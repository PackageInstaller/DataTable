...
function var_0_1.OnInit(arg_2_0, arg_2_1)
	...
	arg_2_0.inputController = var_2_4(var_2_3, var_5(var_1_10007))
	arg_2_0._go = arg_2_1
	...
	typeof = var_5
	Text = var_1_10007
	arg_2_0.lureIconTxt = var_2_31(var_2_30, var_5(var_1_10007))
	...
	UIItemList = var_3
	arg_2_0.uiFollowerList = var_3.New(arg_2_0.uiFollowerPanel, var_2_34)
	setActive = var_3
	...
	local function var_2_37()
		...
		var_3_1(var_3_0, var_2_10003.AREACHANGE)
	...
	var_3(var_2_35, var_2_36, var_2_37, var_1_10008)
	...
	var_3(var_2_38, var_2_39, var_2_40, var_1_10008)
	...
	local function var_2_43()
		...
		var_5_1(var_5_0, var_2_10003.OPEN_ANIMATION_OP)
	...
	var_3(var_2_41, var_2_42, var_2_43, var_1_10008)
	...
	var_3(var_2_44, var_2_45, var_2_46, var_1_10008)
...
function var_0_1.GetMorphBodyIds(arg_7_0)
	...
	if not var_7_2(var_7_1, var_1_10006.DressType.Body) then
		var_7_3 = 0
	end
...
function var_0_1.UpdateMorphBtn(arg_11_0)
	...
	var_1_10002(arg_11_0.morphBtn, var_11_0)
	...
	local var_11_2 = arg_11_0.morphBtn
	local var_11_3 = var_3.GetComponent

	typeof = var_1_10006
	UnityEngine = var_1_10008

	if var_11_3(var_11_2, var_1_10006(var_1_10008.UI.Button)) then
		var_3.interactable = var_11_1
	end

	local var_11_4 = arg_11_0.morphBtn
	local var_11_5 = var_4.Find(var_11_4, "icon_normal")
	local var_11_6 = arg_11_0.morphBtn
	local var_11_7 = var_5.Find(var_11_6, "icon_gray")

	if var_11_5 then
		setActive = var_11_4

		var_11_4(var_11_5, var_11_1)
	end

	if var_11_7 then
		setActive = var_11_4

		var_11_4(var_11_7, not var_11_1)
	end
...
function var_0_1.StartMorphFreeze(arg_12_0)
	...
	var_12_1(var_12_0, var_1_10004.DISABLE_INPUT)
...
function var_0_1.StopMorphFreeze(arg_13_0)
	...
	var_13_2(var_13_1, var_1_10004.ENABLE_INPUT)
...
function var_0_1.OnMorphBtnClick(arg_15_0)
	...
	if not arg_15_0:IsPlayerIdleForMorph() then
		...
		var_15_1(var_15_0, var_1_10004("island_morph_not_idle"))
	...
	var_15_5(var_15_4, var_1_10006.ISLAND_MORPH_FORM_CHANGE, {
...
function var_0_1.UpdateLureBtn(arg_17_0)
	...
	local var_17_3 = var_1
	local var_17_4 = var_1.GetInventoryAgency(var_17_3)
	local var_17_5 = var_4.GetOwnCount(var_17_4, var_17_2)

	setActive = var_17_3

	var_17_3(arg_17_0.lureEmptyTr, var_17_5 <= 0)

	setActive = var_17_3

	var_17_3(arg_17_0.lureIconTr, var_17_5 > 0)

	local var_17_6

	if 0 < var_17_5 then
		var_17_6 = var_4:GetItemById(var_17_2)
		GetImageSpriteFromAtlasAsync = var_17_4

		var_17_4("island/" .. var_17_6:GetIcon(), "", arg_17_0.lureIconTr)
	...
	local var_17_8 = arg_17_0.lureBtn
	...
	local function var_17_9()
		...
		IslandSelectLureOpView = var_2_10004

		local var_18_3 = var_18_2(var_18_1, var_2_10004)
	...
	var_17_6(var_17_7, var_17_8, var_17_9, var_1_10011)
...
function var_0_1.UpdateAnimationOpBtn(arg_20_0)
	...
	IslandAblityAgency = var_1_10009

	var_20_0(var_20_3, var_20_5(var_20_4, var_1_10009.ANIMATION_OP_ID))
...
function var_0_1.UpdateAnimationOpEffect(arg_22_0, arg_22_1, arg_22_2)
	...
	if var_1_10004.detect(var_22_0, function(arg_24_0)
		local var_24_2
		...
		if arg_24_0 then
			...
			IslandStrollNpcUnit = var_2_10004

			if var_24_2(var_24_0, var_2_10004) then
		...
		var_22_1 = var_6.OnlySkillActionFeedback(var_1_10008)
	end
	...
	if var_5 then
		...
		local var_22_2 = var_4.data

		var_22_3 = var_7.ExistSkillActionFeedback(var_22_2)
	end

	setActive = var_1_10008

	var_1_10008(arg_22_0.animationOpSkillEffect, var_22_1)

	setActive = var_1_10008

	var_1_10008(arg_22_0.animationOpEffect, var_5 and not var_22_1)
...
function var_0_1.ShowFollowerList(arg_26_0)
	...
	var_5.make(var_26_5, function(arg_27_0, arg_27_1, arg_27_2)
		...
		if arg_27_0 == var_2_10003.EventUpdate then
			...
			local var_27_3 = var_2_10005.StaticGetPrefab(var_27_2.configId)

			GetImageSpriteFromAtlasAsync = var_27_1

			var_27_1("island/IslandShipIcon/" .. var_27_3, "", arg_27_2:Find("icon"))
			...
			local function var_27_6()
				...
				var_28_1(var_28_0, var_3_10003.WILL_DEL_FOLLOWER, var_27_2.id)
			...
			var_27_1(var_27_4, var_27_5, var_27_6, var_2_10011)
		end
...
function var_0_1.InitOpCustumPositon(arg_33_0)
	...
	local var_33_0 = var_1_10001(var_1_10003.Find("UICamera/Canvas")).sizeDelta.x
	...
	local var_33_5 = var_5.GetFloat

	IslandSettingsConst = var_1_10007

	local var_33_6 = var_33_5(var_1_10007.ISLAND_KEY_JOYSTICK_ANCHORX, var_33_4.x)

	PlayerPrefs = var_1_10006

	local var_33_7 = var_1_10006.GetFloat

	IslandSettingsConst = var_8

	local var_33_8 = var_33_7(var_8.ISLAND_KEY_JOYSTICK_ANCHORY, var_33_4.y)
	...
	for iter_33_0, iter_33_1 in var_8(var_33_10) do
		...
		IslandSettingsConst = var_1_10016
		var_1_10014 = var_1_10014(var_1_10016.ISLAND_KEY_OPERATION_ANCHORX[iter_33_0], var_1_10013.x)
		PlayerPrefs = var_1_10015
		var_1_10015 = var_1_10015.GetFloat
		IslandSettingsConst = var_17
		var_1_10015 = var_1_10015(var_17.ISLAND_KEY_OPERATION_ANCHORY[iter_33_0], var_1_10013.y)
		Vector2 = var_1_10016
		iter_33_1.anchoredPosition = var_1_10016(var_1_10014 * var_33_1, var_1_10015 * var_33_3)
	end
...
function var_0_1.UpdateOperationButtonDisplay(arg_35_0)
	...
	if arg_35_0.operationType == var_0_1.OperationType.None then
		...
		local var_35_4 = var_35_3(var_35_2, var_4)
		...
		local var_35_7 = var_35_6(var_35_5, var_4)
	...
	local var_35_10 = var_35_9(var_35_8, var_4.UNIT_LIST_OBJ, arg_35_0.unitId)
	local var_35_12
	...
	if arg_35_0.operationType ~= var_0_1.OperationType.Fishing and not var_35_10 then
		...
		IslandSeedOpView = var_5

		local var_35_13 = var_35_12(var_35_11, var_5)
		...
		local var_35_15 = var_35_12(var_35_14, var_5)
	...
	local function var_35_16()
		...
		local function var_37_2()
			...
			IslandConst = var_3_10004

			local var_38_4 = var_38_3(var_38_2, var_3_10004.UNIT_LIST_OBJ, arg_35_0.unitId)
		...
		var_2_10000(var_37_0, var_37_1, var_37_2, var_2_10005)
	...
	var_3(arg_35_0.operationType, {
		[var_0_1.OperationType.Plant] = function()
			...
			local var_39_2 = var_39_1(var_39_0, var_2_10003.UNIT_LIST_OBJ, arg_35_0.unitId)
			local var_39_4
			...
			if var_0.CanHarvest(var_39_2) then
				...
				local function var_39_5()
					...
					var_40_2(var_40_1, var_3_10004.GAHTER_FLAG, var_0)
					...
					for iter_40_0, iter_40_1 in var_40_0(var_4.GetAreaList(var_40_4)) do
						local var_40_5 = arg_35_0.view
						local var_40_6 = var_7.GetUnitModuleWithType

						IslandConst = var_3_10010

						local var_40_7 = var_40_6(var_40_5, var_3_10010.UNIT_LIST_OBJ, iter_40_1)

						table = var_3_10008

						var_3_10008.insert(var_40_3, var_40_7.handDate.configId)
					end
					...
					var_40_9(var_40_8, iter_40_0.ISLAND_START_HANDLE_HARVEST, {
						slot_list = var_40_3
					})
				...
				var_1(var_39_3, var_39_4, var_39_5, var_2_10006)
				...
				if var_0:CanPlant() then
					IslandGuideChecker = var_39_10

					var_39_10.CheckGuide("ISLAND_GUIDE_22")

					OptionBtnDisplay = var_39_10

					var_39_10(var_0_1.OperationType.Plant)
					...
					local function var_39_7()
						...
						if not var_41_2(var_41_1, var_3_10003).selectseedItemId then
							pg = var_41_4
							...
							var_41_4(var_41_3, var_3_10003("island_production_seeds_empty"))
						...
						IslandSeedOpView = var_3_10004

						local var_41_9 = var_41_5[var_41_8(var_41_7, var_3_10004).selectseedItemId]
						...
						if not (function(arg_42_0)
							...
							local var_42_0 = var_4_10001(var_4_10003)
							local var_42_1 = var_1.GetIsland(var_42_0)
							local var_42_2 = var_1.GetInventoryAgency(var_42_1)

							ipairs = var_4_10002

							for iter_42_0, iter_42_1 in var_4_10002(arg_42_0) do
							...
							local var_41_13 = var_4.TipsMgr.GetInstance()
							local var_41_14 = var_4.ShowTips

							i18n = var_3_10007

							var_41_14(var_41_13, var_3_10007("island_production_seeds_notenough"))
						...
						for iter_41_0, iter_41_1 in var_3_10005(var_7.GetAreaList(var_41_16)) do
							local var_41_17 = arg_35_0.view
							local var_41_18 = var_10.GetUnitModuleWithType

							IslandConst = var_3_10013

							local var_41_19 = var_41_18(var_41_17, var_3_10013.UNIT_LIST_OBJ, iter_41_1)

							table = var_3_10011

							var_3_10011.insert(var_41_15, var_41_19.handDate.configId)
						end
						...
						var_41_21(var_41_20, iter_41_0.ISLAND_START_HANDLE_PLANT, {
							slot_list = var_41_15,
						...
						var_41_24(var_41_23, var_9.SOW_FLAG, var_0)
					...
					var_39_10(var_39_6, var_39_4, var_39_7, var_2_10006)

					local var_39_8 = arg_35_0
					local var_39_9 = var_39_10.GetView(var_39_8)

					var_39_10 = var_39_10.GetSubView
					IslandSeedOpView = var_39_4

					local var_39_11 = var_39_10(var_39_9, var_39_4)

					var_39_10 = var_39_10.CheckSeedEmpty(var_39_11, var_0)
					setActive = var_39_0

					var_39_0(arg_35_0.seedEmpty, var_39_10)

					setActive = var_39_0

					var_39_0(arg_35_0.seedBtn, true)

					setActive = var_39_0
					var_2_10006 = arg_35_0.seedBtn

					var_39_0(var_39_4.Find(var_2_10006, "seedItem"), not var_39_10)

					if not var_39_10 then
						onButton = var_39_0
						var_39_4 = arg_35_0

						local var_39_12 = arg_35_0.seedBtn

						function var_2_10006()
							...
							local var_43_3 = var_43_2(var_43_1, var_3_10003)
							...
							local var_43_7 = var_43_6(var_43_5, var_3)
						...
						var_39_0(var_39_4, var_39_12, var_2_10006, var_2_10007)

						var_39_4 = arg_35_0

						var_39_0.RefreshCurrentSlectSeed(var_39_4)
					end
				else
					OptionBtnDisplay = var_39_10

					var_39_10(var_0_1.OperationType.Interaction)

					onButton = var_39_10

					local var_39_13 = arg_35_0

					var_39_4 = arg_35_0.opBtn

					local function var_39_14()
						pg = var_3_10000
						...
						var_44_1(var_44_0, var_3_10003("island_production_being_planted"))
					...
					var_39_10(var_39_13, var_39_4, var_39_14, var_2_10006)

					setActive = var_39_10

					var_39_10(arg_35_0.seedBtn, false)
				end
			end

			local var_39_15 = var_0
			local var_39_16 = var_0.GetDataVO(var_39_15).slotData.configId

			pg = var_39_0

			local var_39_17 = var_39_0.island_production_slot[var_39_16].place

			IslandProductConst = var_39_15

			local var_39_18 = var_39_17 == var_39_15.FarmlandPlaceId

			setActive = var_39_4

			local var_39_19 = arg_35_0.areaChangeBtn
			...
			if var_39_18 then
				...
				local var_39_20 = var_2_10007(var_2_10009)
				local var_39_21 = var_2_10007.GetIsland(var_39_20)
				local var_39_22 = var_2_10007.GetAblityAgency(var_39_21)

				var_2_10007 = var_2_10007.IsUnlockAreaPlant(var_39_22)
			end

			var_39_4(var_39_19, var_2_10007)
		...
		[var_0_1.OperationType.WildGather] = function()
			...
			local var_46_2 = var_46_1(var_46_0, var_2_10003.UNIT_LIST_OBJ, arg_35_0.unitId)
			...
			local var_46_5 = var_46_3(var_2_10005)
			...
			if var_46_4 == var_3.GetIsland(var_46_5).id then
				...
				local function var_46_8()
					...
					var_47_2(var_47_1, var_3_10004.GAHTERD_FLAG, var_46_2)
				...
				var_3(var_46_6, var_46_7, var_46_8, var_2_10008)
			elseif var_46_2:CheckGatherCanSign() then
				...
				var_3(var_46_9, var_46_10, var_46_11, var_2_10008)
			else
				setActive = var_3
		...
		[var_0_1.OperationType.Fishing] = function()
			...
			local function var_50_3()
				...
				if var_1.GetOwnCount(var_51_6, var_51_3) <= 0 then
					...
					var_51_8(var_51_7, var_4("island_fishing_lure_empty"))
				else
					...
					if var_1.OnGrouded(var_51_10) then
						...
						IslandFishingOPView = var_4

						local var_51_13 = var_51_12(var_51_11, var_4)
			...
			var_0(var_50_1, var_50_2, var_50_3, var_2_10005)
...
function var_0_1.RefreshCurrentSlectSeed(arg_52_0)
	...
	IslandSeedOpView = var_1_10005

	if not var_52_3(var_52_2, var_1_10005).selectseedItemId then
		setActive = var_52_0

		var_52_0(var_52_1, false)
	...
	local var_52_4 = var_52_0(var_5)
	local var_52_5 = var_3.GetIsland(var_52_4)
	local var_52_6 = var_3.GetInventoryAgency(var_52_5)

	pg = var_52_2

	local var_52_7 = var_52_2.island_farm_seed[var_2]

	if not var_52_6:GetItemById(var_52_7.itemid) then
		local var_52_8

		setActive = var_6

		var_6(var_52_1, false)
	...
	var_6(var_52_1:Find("count"), var_5:GetCount())

	local var_52_9 = "island/" .. var_5:GetIcon()

	GetImageSpriteFromAtlasAsync = var_7

	var_7(var_52_9, "", var_52_1:Find("icon"))
...
function var_0_1.DisablePlayerOp(arg_57_0)
	...
	IslandInteractionView = var_4

	local var_57_2 = var_57_1(var_57_0, var_4)
	...
	IslandDistanceView = var_4

	local var_57_6 = var_57_5(var_57_4, var_4)
...
function var_0_1.EnablePlayerOp(arg_58_0)
	...
	local var_58_2 = var_58_1(var_58_0, var_4)
	...
	local var_58_6 = var_58_5(var_58_4, var_4)
...
function var_0_1.ShowOrHideMoveBtn(arg_64_0, arg_64_1, arg_64_2)
	...
	local var_64_1 = var_1_10003(var_64_0, var_1_10006(var_1_10008))
