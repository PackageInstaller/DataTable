...
function var_0_0.Enqueue(arg_4_0, arg_4_1)
	local var_4_0 = #arg_4_0.items + 1

	if arg_4_0.maxCnt < var_4_0 then
		Object = var_4_0

		var_4_0.Destroy(arg_4_1)
	else
		setParent = var_4_0

		var_4_0(arg_4_1, arg_4_0.root)

		local var_4_1 = arg_4_1.transform

		Vector3 = var_3
		var_4_1.localPosition = var_3.zero
		table = var_4_1

		var_4_1.insert(arg_4_0.items, arg_4_1)
	end
