...
function var_0_0.IsMapTip()
	...
	if var_1.GetTraceTask(var_12_2) then
		local var_12_3 = var_1:GetTraceParam()

		tonumber = var_12_2

		if var_12_2(var_12_3) then
			local var_12_4 = var_0:GetMapId()

			pg = var_5

			if var_12_4 ~= var_5.island_world_objects[var_3].mapId then
				return true
			end
		end
	end

	local var_12_5 = var_0:GetTaskAgency()

	if var_2.GetMainTraceTask(var_12_5) then
		local var_12_6 = var_2:GetTraceParam()

		tonumber = var_12_5

		if var_12_5(var_12_6) then
			local var_12_7 = var_0:GetMapId()

			pg = var_6

			if var_12_7 ~= var_6.island_world_objects[var_4].mapId then
				return true
			end
		end
	end
...
function var_0_0.IsDeviceTip()
	...
	for iter_13_0, iter_13_1 in var_1_10001(var_1_10003.island_main_btns.get_id_list_by_main_type[2]) do
		pg = var_1_10006
...
function var_0_0.IsPostProdTip()
	...
	local var_19_1 = var_1_10001(var_1_10003)
	local var_19_2 = var_1.GetIsland(var_19_1)
	local var_19_3 = var_1.GetBuildingAgency(var_19_2)

	underscore = var_1_10002

	return var_1_10002.any(var_19_0, function(arg_20_0)
		local var_20_0 = var_19_3

		return var_1.GetBuilding(var_20_0, arg_20_0) and var_1:IsPostTip()
	end)
end
...
function var_0_0.IsPostRestTip()
	...
	return var_1_10002.any(var_21_0, function(arg_22_0)
		local var_22_0 = var_21_3

		return var_1.GetRestaurant(var_22_0, arg_22_0) and var_1:IsPostTip()
	end)
end
...
function var_0_0.IsPostCollectionTip()
	...
	local var_23_3 = var_23_2 .. var_23_0(var_23_1)
	...
	local var_23_4 = var_1_10003.TimeMgr.GetInstance()
	local var_23_5 = var_3.GetServerTime(var_23_4)

	pg = var_4

	local var_23_6 = var_4.TimeMgr.GetInstance()
...
function var_0_0.IsBookTip()
	...
	var_24_4[1] = var_1_10004.TYPES.CHAR
	IslandIllustration = var_4
	var_24_4[2] = var_4.TYPES.NPC
	IslandIllustration = var_4
	var_24_4[3] = var_4.TYPES.ITEM
	IslandIllustration = var_4
	var_24_4[4] = var_4.TYPES.FISH
...
function var_0_0.IsUnlock(arg_25_0)
	...
	if not var_25_0(var_1_10003.island_main_btns.all, function(arg_26_0)
		pg = var_2_10001
	...
	local var_25_1 = var_1_10002.island_main_btns[var_1].ability_id

	getProxy = var_3
	IslandProxy = var_1_10005

	local var_25_2 = var_3(var_1_10005)
