...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_4, 21615, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_1(var_2_0, var_2_10004.BuildIslandBindDress(var_1_0, var_1_1))
			...
			var_3.SetDressIdOwned(var_2_4, var_1_1)
			...
			var_2_10004(var_2_5, var_7.ISLAND_SEND_ROLE_DRESS_DONE, {
				dress_id = var_1_1
			})
		else
			pg = var_2_1
