...
local var_0_0 = "IslandSendChatCommand"
...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	IslandChatConst = var_1_2

	if var_1_0 == var_1_2.CHANNEL_ISLAND then
		getProxy = var_9
		IslandProxy = var_1_10011

		local var_1_5 = var_9(var_1_10011)

		for iter_1_1 = #var_9.GetChatMsgList(var_1_5, var_1_1), 1, -1 do
			if var_10[iter_1_1].player.id == var_1_3.id then
...
function var_0_1.Send(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	IslandChatConst = var_6

	if arg_2_1 == var_6.CHANNEL_ISLAND then
		pg = var_6

		local var_2_2 = var_6.ConnectionMgr.GetInstance()

		var_6.Send(var_2_2, 21323, {
			island_id = arg_2_2,
			content = var_2_1
