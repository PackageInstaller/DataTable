...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.stageUIList = var_1_10004.New(var_1_7, var_1_7:Find("tpl"))
	...
	UIItemList = var_1_6
	arg_1_0.awardUIList = var_1_6.New(var_1_10, var_1_10:Find("tpl"))
...
function var_0_0.UpdateStageItem(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_2 = var_4_1(var_4_0, var_1_10006(var_1_10008))
	...
	var_1_10004("islandachievement", "achv_stage_" .. var_4_3, arg_4_2:Find("icon"))
	...
	local var_4_5 = var_5:GetStatus()

	IslandAchievement = var_7

	local var_4_6 = var_4_5 == var_7.STATUS.GOT

	setActive = var_7

	var_7(arg_4_2:Find("line/got"), var_4_6)

	setActive = var_7

	var_7(arg_4_2:Find("circle/got"), var_4_6)
...
function var_0_0.UpdateAwardItem(arg_5_0, arg_5_1, arg_5_2)
	...
	var_4(arg_5_0.parent, arg_5_2, function()
		...
		i18n = var_2_10004
		var_6_2.title = var_2_10004("island_word_desc")
		IslandMsgBox = var_4
		var_6_2.type = var_4.TYPE_COMMON_DROP_DESCRIBE
...
function var_0_0.UpdataData(arg_7_0)
	...
	var_1_10001(var_7_0, var_4.getConfig(var_7_1, "name"))
	...
	local var_7_6 = var_7_2.gsub
	local var_7_7 = arg_7_0.achv
	local var_7_8 = var_7_6(var_5.getConfig(var_7_7, "desc"), "$1", var_7_3)

	string = var_7_4

	local var_7_9 = var_7_4.gsub(var_7_8, "$2", var_7_5)
	...
	IslandAchievement = var_8

	var_5(var_7_12, var_7_11 == var_8.STATUS.GOT)
	...
	var_5(var_7_13, var_7_11 == var_8.STATUS.GET)

	IslandAchievement = var_5

	local var_7_14 = var_7_11 == var_5.STATUS.NORMAL

	setActive = var_7_10

	var_7_10(arg_7_0.goTF, var_7_14)
	...
	if var_7_14 then
		...
		var_7_10(var_8.Find(var_7_15, "Text"), var_7_3 .. "/" .. var_7_5)
	end
...
function var_0_0.Update(arg_8_0, arg_8_1)
	...
	underscore = var_8_2
	arg_8_0.stageAchvs = var_8_2.select(var_8_5:GetSortAchvList(), function(arg_9_0)
		local var_9_1
		...
		if arg_9_0:IsHideType() then
			...
			if var_9_0 ~= var_2_10002.STATUS.GET then
				var_9_1 = false
...
function var_0_0.PlayStageAnim(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_2 = var_10_1(var_10_0, var_1_10006(arg_10_1))
	local var_10_3 = var_3.GetComponent

	typeof = var_1_10007
	DftAniEvent = var_1_10009

	local var_10_4 = var_10_3(var_10_2, var_1_10007(var_1_10009))
	...
	local var_10_7 = var_10_6(var_10_5, var_8(var_1_10010))
