...
function var_0_1.GetAwardItemAndExp(arg_5_0)
	...
	if arg_5_0:GenPtAwards() then
		table = var_5

		var_5.insert(var_5_1, var_4)
	end
...
function var_0_1.GenPtAwards(arg_6_0)
	...
	if arg_6_0.getConfig(var_6_0, "season_pt_num") > 0 then
		local var_6_1 = {
			id = 0
		}

		VIRTUAL_DROP_TYPE_ISLAND_SEASON_PT = var_6_0
		var_6_1.type = var_6_0
		var_6_1.count = var_1 or 0
