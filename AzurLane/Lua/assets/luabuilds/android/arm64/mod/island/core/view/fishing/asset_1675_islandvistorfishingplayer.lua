...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".IslandFishingPlayer"))
...
function var_0_1.Play(arg_3_0)
	...
	var_1_10002({
		...
		function(arg_7_0)
			...
			local var_7_2 = var_2_10004.EFFECT_ENTER

			IslandFishingEffectMgr = var_2_10005

			var_7_1(var_7_0, var_7_2, var_2_10005.EFFECT_ENTER_TIME)
		...
		function(arg_8_0)
			...
			var_8_1(var_8_0, var_2_10004.EFFECT_WAITING)
		...
		function(arg_9_0)
			...
			var_9_1(var_9_0, var_2_10004.EFFECT_HOOKED)
		...
		function(arg_10_0)
			...
			var_10_1(var_10_0, var_2_10004.EFFECT_SHAKE)
			arg_10_0()
...
function var_0_1.OnSuccess(arg_11_0, arg_11_1)
	...
	var_1_10002({
		...
		function(arg_14_0)
			...
			local var_14_2 = var_2_10004.EFFECT_LEAVE

			IslandFishingEffectMgr = var_2_10005

			var_14_1(var_14_0, var_14_2, var_2_10005.EFFECT_LEAVE_TIME)
...
function var_0_1.WaitForExit(arg_16_0, arg_16_1)
	...
	local var_16_0 = var_2.island_set.island_fishing_success_exit_time.key_value_int

	Timer = var_1_10003

	local var_16_1 = var_1_10003.New
	local var_16_2 = arg_16_1

	math = var_1_10006
	arg_16_0.exitTimer = var_16_1(var_16_2, var_1_10006.max(0.01, var_16_0), 1)

	local var_16_3 = arg_16_0.exitTimer
...
function var_0_1.OnFailed(arg_18_0, arg_18_1)
	...
	IslandFishingEffectMgr = var_1_10005

	var_18_1(var_18_0, var_1_10005.EFFECT_NORMAL)
...
function var_0_1.OnCancel(arg_19_0, arg_19_1)
	...
	var_19_1(var_19_0, var_1_10005.EFFECT_NORMAL)
...
function var_0_1.OnDestroy(arg_20_0)
	...
	var_20_1(var_20_0, var_1_10004.EFFECT_NORMAL)
