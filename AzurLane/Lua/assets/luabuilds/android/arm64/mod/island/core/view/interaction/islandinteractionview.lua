...
function var_0_1.OnInit(arg_3_0, arg_3_1)
	...
	arg_3_0.interactionUIItemList = var_3_1(var_3_2, var_5.Find(var_3_3, "interaction"))
...
function var_0_1.UpdateInteractionBtns(arg_5_0, arg_5_1)
	...
	local var_5_3 = var_5_1(var_5.GetIsland(var_5_2), arg_5_0.interactionData.type, var_5_0)
	...
	var_4.make(var_5_4, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			var_4(var_6_0, var_6_1, var_6_2, var_2_10009)
...
function var_0_1.SetInteractionText(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_1 = arg_10_1:Find("bg/Text")

	HXSet = var_1_10006

	var_10_0(var_10_1, var_1_10006.hxLan(arg_10_2.text))

	GetSpriteFromAtlas = var_10_0

	local var_10_2 = "island/IslandInteractionBtns"

	tostring = var_6

	local var_10_3 = var_10_0(var_10_2, var_6(arg_10_2.icon))

	setImageSprite = var_4

	var_4(arg_10_1:Find("icon_type"), var_10_3, true)
...
function var_0_1.AddTimer(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_4 = var_1_10004.New(function()
		pg = var_2_10000
		...
		if var_11_3 - var_12_1 <= 0 then
			...
			var_2(var_4.Find(var_12_2, "time"), false)
			...
			local var_12_6 = var_4.Find(var_12_5, "time/Text")

			pg = var_2_10005

			local var_12_7 = var_2_10005.TimeMgr.GetInstance()

			var_2(var_12_6, var_5.DescCDTime(var_12_7, var_1))
		end
