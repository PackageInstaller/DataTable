...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	local var_1_3 = var_1_1.GetIsland(var_1_9000):GetCharacterAgency():GetShipById(var_1_0)

	if not var_1_1 then
		return
	end

	if not var_1_1.GetIsland(var_1_9000):GetCharacterAgency():GetShipById(var_1_0):CanUpgradeSkill() then
		return
	end
