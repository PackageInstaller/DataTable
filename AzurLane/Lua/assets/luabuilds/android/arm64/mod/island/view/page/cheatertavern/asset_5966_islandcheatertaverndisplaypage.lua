...
function var_0_1.GetContext(arg_8_0)
	...
	PlayRoomEntranceMediator = var_1_10004
	var_8_1.mediator = var_1_10004
	PlayRoomCheatBarEntranceScene = var_1_10004
	var_8_1.viewComponent = var_1_10004
...
function var_0_1.OnLoaded(arg_11_0)
	...
	arg_11_0.playRoomPop = var_11_0(var_3.Find(var_11_1, "playRoomPop"), arg_11_0)
...
function var_0_1.OnShow(arg_12_0)
	...
	local var_12_0 = arg_12_0.playRoomPop

	var_1.Show(var_12_0, true)

	PlayRoomTools = var_1

	local var_12_1 = var_1.SetGameTypeID

	PlayRoomConst = var_12_0

	var_12_1(var_12_0.GAME_TYPE.CHEATER_TAVERN)

	getProxy = var_12_1
	IslandProxy = var_3

	local var_12_2 = var_12_1(var_3)
	local var_12_3 = var_1.GetIsland(var_12_2)
	local var_12_4 = var_1.GetCharacterAgency(var_12_3)
	local var_12_5 = var_1.GetViewGameShipViewId

	PlayRoomTools = var_1_10005

	local var_12_6 = var_12_5(var_12_4, var_1_10005.GetGameTypeID())
	local var_12_7 = var_1:GetShipById(var_12_6)
	...
	local var_12_8 = arg_12_0.shipDressHelper

	var_4.SetShipId(var_12_8, var_12_7.configId, {}, true)

	local var_12_9 = arg_12_0
	local var_12_10 = arg_12_0.LoadCharacter
	local var_12_11 = var_12_7

	var_12_10(var_12_9, var_12_7.GetModel(var_12_11))

	setText = var_12_10

	local var_12_12 = arg_12_0.uiNameText

	getProxy = var_7
	PlayerProxy = var_12_11

	local var_12_13 = var_7(var_12_11)

	var_12_10(var_12_12, var_7.getRawData(var_12_13).name)
...
function var_0_1.SetCharterPos(arg_19_0)
	...
	IslandCameraMgr = var_19_0

	local var_19_4 = var_19_0.instance
	...
	local var_19_7 = var_19_6(var_19_5, var_1_10007(var_19_3.x, var_19_3.y, 7))
...
function var_0_1.LoadCharacter(arg_20_0, arg_20_1, arg_20_2)
	...
	local function var_20_0(arg_21_0, arg_21_1)
		...
		typeof = var_2_10005
		CharacterHandleController = var_2_10007

		var_21_1(var_21_2, var_2_10005(var_2_10007))
		...
		var_21_3(var_21_4, var_5.Character3D)
		...
		var_21_8, GetOrAddComponent = var_2.GetSmoothRotateObject(var_21_7), var_3
		typeof = var_6
		SmoothRotateObject = var_2_10008

		local var_21_9 = var_3(var_21_8, var_6(var_2_10008))
		...
		if arg_21_1 and arg_21_1 ~= "" then
			GetOrAddComponent = var_21_8

			local var_21_10 = arg_20_0.role.transform
			local var_21_11 = var_7.GetChild(var_21_10, 0)

			typeof = var_2_10008
			Animator = var_10

			local var_21_12 = var_21_8(var_21_11, var_2_10008(var_10))
...
function var_0_1.LoadCharacterScene(arg_22_0, arg_22_1)
	...
	var_22_2(var_22_1, var_22_3, var_22_4, var_1_10008.Additive, function(arg_23_0)
		if arg_23_0 == 1 then
			arg_22_1()
		end
