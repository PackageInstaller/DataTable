...
pg = var_0_10001
var_0_10001.IslandVisitorNotificationMgr = var_0_1
...
function var_0_1.Init(arg_1_0, arg_1_1)
	...
	var_2("ui", "IslandVisitorNotificationUI", function(arg_2_0)
		...
		typeof = var_5
		Text = var_2_10007
		var_2_2.contentTxt = var_2_5(var_2_4, var_5(var_2_10007))
		setActive = var_2_2
...
function var_0_1.Enqueue(arg_3_0, arg_3_1)
	...
	ISLAND_NOTIFYCATION = var_1_10004

	if var_3_0(var_1_10004, 0) <= 0 then
		return
	end
