...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	var_1_10002.StaticAlign(arg_4_0.rtTabs, arg_4_0.rtTabTpl, #var_4_0, function(arg_5_0, arg_5_1, arg_5_2)
		arg_5_1 = arg_5_1 + 1
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			local var_5_0, var_5_1 = var_3(var_4_0[arg_5_1])

			setText = var_5

			local var_5_2 = arg_5_2:Find("on/Text")

			i18n = var_2_10008

			var_5(var_5_2, var_2_10008(var_5_0))

			setText = var_5

			local var_5_3 = arg_5_2:Find("off/Text")

			i18n = var_8

			var_5(var_5_3, var_8(var_5_0))

			setActive = var_5

			var_5(arg_5_2:Find("line"), arg_5_1 < #var_4_0)
			...
			local function var_5_6(arg_6_0)
				if arg_6_0 then
					...
					local var_6_2 = var_3.Find(var_6_1, "Text")

					i18n = var_4

					var_6_0(var_6_2, var_4(var_5_1))

					eachChild = var_6_0

					local var_6_3 = arg_4_0.rtPages
					local var_6_4 = var_3.GetChild(var_6_3, arg_5_1 - 1)

					var_6_0(var_3.Find(var_6_4, "content"), function(arg_8_0, arg_8_1)
						...
						if 0 < arg_8_1 then
							...
							var_4.insert(var_8_1, function(arg_9_0)
								...
								var_9_0(var_9_1, var_4.Action(arg_9_0))
			...
			var_5(var_5_4, var_5_5, var_5_6, var_10)
	...
	local var_4_1 = arg_4_0.rtTitle
	local var_4_2 = var_4.Find(var_4_1, "level/Text")

	i18n = var_5

	var_2(var_4_2, var_5("island_spoperation_level_2509_1"))

	eachChild = var_2

	local var_4_3 = arg_4_0.rtPages

	var_2(var_4.Find(var_4_3, "page_2/content"), function(arg_11_0, arg_11_1)
		arg_11_1 = arg_11_1 + 1
		setText = var_2_10002

		local var_11_0 = arg_11_0:Find("tpl/name")

		i18n = var_2_10005

		local var_11_1 = arg_4_0

		var_2_10002(var_11_0, var_2_10005(var_7.getItemTipPrefix(var_11_1) .. arg_11_1))
