...
function var_0_1.OnLoaded(arg_3_0)
	...
	local var_3_2 = var_3_1:Find("tip")

	i18n = var_1_10005

	var_1_10002(var_3_2, var_1_10005("island_quickselect_tip"))

	arg_3_0.allBtn = var_3_1:Find("btn_all")

	local var_3_3 = arg_3_0.allBtn

	arg_3_0.allFlagTF = var_2.Find(var_3_3, "flag")
	setText = var_2
	...
	var_2(var_3_5, var_5("island_selectall"))

	arg_3_0.deleteBtn = var_3_1:Find("btn_delete")

	local var_3_6 = var_3_1:Find("view")

	arg_3_0.scrollRect = var_2.GetComponent(var_3_6, "LScrollRect")
	arg_3_0.emptyTF = var_3_1:Find("empty")

	local var_3_7 = arg_3_0._tf
	local var_3_8 = var_2.Find(var_3_7, "adapt/right")
	local var_3_9 = var_2.Find(var_3_8, "title/name")
	local var_3_10 = var_3.GetComponent

	typeof = var_6
	Text = var_1_10008
	arg_3_0.itemNameTxt = var_3_10(var_3_9, var_6(var_1_10008))
	arg_3_0.itemTF = var_2:Find("bg_item/item")
	setText = var_3

	local var_3_11 = var_2:Find("bg_count/Text")

	i18n = var_6

	var_3(var_3_11, var_6("island_exchange_own_count"))

	local var_3_12 = var_2:Find("bg_count/content/Text")
	local var_3_13 = var_3.GetComponent

	typeof = var_6
	Text = var_8
	arg_3_0.itemOwnTxt = var_3_13(var_3_12, var_6(var_8))

	local var_3_14 = var_2:Find("bg_count/content/add")
	local var_3_15 = var_3.GetComponent

	typeof = var_6
	Text = var_8
	arg_3_0.itemAddTxt = var_3_15(var_3_14, var_6(var_8))
	arg_3_0.exchangeBtn = var_2:Find("btn_exchange")
	setText = var_3

	local var_3_16 = arg_3_0.exchangeBtn
	local var_3_17 = var_5.Find(var_3_16, "Text")

	i18n = var_6

	var_3(var_3_17, var_6("island_exchange_btn_text"))

	local var_3_18 = arg_3_0._tf

	arg_3_0.blockTF = var_3.Find(var_3_18, "block")

	local var_3_19 = var_2:Find("bg_item")
	local var_3_20 = var_3.GetComponent

	typeof = var_6
	Animation = var_8
	arg_3_0.itemAnim = var_3_20(var_3_19, var_6(var_8))
	...
	typeof = var_6
	DftAniEvent = var_8
	arg_3_0.itemAnimEvent = var_3_22(var_3_21, var_6(var_8))
...
function var_0_1.OnInit(arg_4_0)
	...
	var_1(var_4_8, var_4_9, var_4_10, var_1_10006)
...
function var_0_1.SendExchangeProto(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10004.EXCHANGE_ITME, arg_14_0.exchangeItems, arg_14_0.showItemId, arg_14_0.totalAddCnt)
...
function var_0_1.Show(arg_15_0)
	...
	var_15_5[1] = var_7.Find(var_15_6, "bg")
...
function var_0_1.FlushGroup(arg_16_0, arg_16_1)
	...
	local var_16_3 = var_4(var_1_10006)
...
function var_0_1.OnInitItem(arg_19_0, arg_19_1)
	...
	var_1_10003(var_19_4, var_19_5, var_19_6, var_1_10008)

	onInputEndEdit = var_1_10003

	var_1_10003(arg_19_0, var_19_0.valueInput, function(arg_22_0)
		table = var_2_10001
	...
	var_1_10003(var_19_7, var_19_8, var_19_9, var_19_10, var_19_11, var_19_12, var_19_13, var_1_10012)
...
function var_0_1.UpdateCardSel(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_2 = var_6.max
	local var_25_3 = 0

	math = var_1_10009

	local var_25_4 = var_1_10009.min
	local var_25_5 = var_25_0
	local var_25_6 = arg_25_1.item

	var_25_1[var_3] = var_25_2(var_25_3, var_25_4(var_25_5, var_12.GetCount(var_25_6)))
...
function var_0_1.CollectDisplayItems(arg_29_0)
	...
	pg = var_1_10003
	arg_29_0.showExchangeIds = var_1_10003.island_exchange_template.get_id_list_by_group[arg_29_0.showGroupId]
	...
	for iter_29_0, iter_29_1 in var_4(arg_29_0.showExchangeIds) do
		...
		if var_29_3:GetItemById(var_29_4) then
			Clone = var_1_10011
			var_1_10011 = var_1_10011(var_10)
			var_1_10011.exchangeId = iter_29_1
			var_1_10011.targetNum = var_3[iter_29_1].target_num
			table = var_12

			var_12.insert(var_29_0, var_1_10011)
		end
	end
