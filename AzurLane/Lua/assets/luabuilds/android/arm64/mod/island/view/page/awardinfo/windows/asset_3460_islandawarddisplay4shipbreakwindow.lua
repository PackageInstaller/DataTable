...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_4 = var_3.Find(var_2_3, "frame/bg/starts")
	local var_2_5 = arg_2_0._tf

	arg_2_0.uiNewStart = var_2_2(var_2_4, var_4.Find(var_2_5, "frame/bg/starts/tpl"))
	...
	local var_2_15 = var_3.Find(var_2_14, "frame/bg/item/energy/Text")

	i18n = var_4

	var_1(var_2_15, var_4("island_ship_level_limit"))

	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_3.Find(var_2_16, "frame/bg/item/level/Text")

	i18n = var_4

	var_1(var_2_17, var_4("island_ship_energy_limit"))

	setText = var_1

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_3.Find(var_2_18, "frame/tip")

	i18n = var_4

	var_1(var_2_19, var_4("island_click_close"))
	...
	typeof = var_4
	Animation = var_6
	arg_2_0.animator = var_2_22(var_2_21, var_4(var_6))
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_2_0.aniDft = var_2_24(var_2_23, var_4(var_6))
...
function var_0_1.UpdateBreakLevel(arg_6_0, arg_6_1, arg_6_2)
	...
	var_4.make(var_6_1, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			var_3(var_7_0, arg_7_1 < var_6.GetBreakLevel(var_7_1))
		end
