...
function var_0_1.OnLaterAttach(arg_1_0, arg_1_1)
	...
	arg_1_0.agent = var_1_10002(var_1_0, var_1_10005(var_1_10007.AI.NavMeshAgent))
	...
	typeof = var_5
	Animator = var_7
	arg_1_0._animator = var_1_3(var_1_2, var_5(var_7))
	...
	arg_1_0._characterController = var_1_6(var_1_5, var_1_10006(var_1_10008.CharacterController))
	...
	if var_1_4.CollisionParam ~= "" then
		...
		local var_1_10 = var_4.RefSetProperty
		...
		var_1_10(var_1_11, var_1_12, var_1_13, var_1_10009(0, var_1_4.CollisionParam[1], 0))
		...
		local var_1_19 = var_4.RefSetProperty

		typeof = var_6

		local var_1_20 = var_6("UnityEngine.CapsuleCollider")
		local var_1_21 = "center"
		local var_1_22 = var_1_18

		Vector3 = var_1_10009

		var_1_19(var_1_20, var_1_21, var_1_22, var_1_10009(0, 0.96, 0))
		...
		var_1_24(var_6("UnityEngine.CapsuleCollider"), "height", var_1_18, 1.76)
...
function var_0_1.StopMove(arg_3_0)
	...
	if not arg_3_0.isLoading then
		...
		var_3_1(var_3_0, var_1_10004.SPEED_FLAG_HASH, 0)
	end
...
function var_0_1.NavUpdate(arg_5_0)
	...
	if not arg_5_0.isLoading then
		...
		var_5_1(var_5_0, var_4.SPEED_FLAG_HASH, arg_5_0._speed)
	end
...
function var_0_1.OnCharacterChangeDress(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	if arg_19_1 then
		...
		local function var_19_0()
			...
			var_20_0._animator = var_20_3(var_20_2, var_4(var_2_10006))
			ipairs = var_20_0

			for iter_20_0, iter_20_1 in var_20_0(var_1_10004) do
				local var_20_4 = arg_19_0._animator

				var_2_10005.Play(var_20_4, iter_20_1.shortNameHash, iter_20_0 - 1, iter_20_1.normalizedTime)
			end
			...
			local var_20_7 = var_20_6(var_20_5, iter_20_0(var_2_10005.BehaviourTrees.BehaviourTreeOwner))
		...
		var_1_10009 = var_19_2(var_19_1, var_1_10009(var_1_10011.BehaviourTrees.BehaviourTreeOwner))

		var_6.PauseBehaviour(var_1_10009)

		local var_19_3 = 0
		local var_19_4 = arg_19_0._animator

		var_1_10009 = var_8.GetCurrentAnimatorStateInfo(var_19_4, var_19_3).normalizedTime % 1
