...
function var_0_1.UpdateState(arg_8_0, arg_8_1)
	...
	var_8_3(var_8_2, var_5.ISLAND_CORE_STATE_CHANGED, arg_8_1)
...
function var_0_1.Dispose(arg_18_0, arg_18_1)
	...
	var_18_3(var_18_2, var_1_10006.BuildMapExit(arg_18_0.controller.mapId, var_18_1))
...
function var_0_1.GetViewAndController(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_4 = var_1_10006.island_map[var_20_3]

	IslandConst = var_20_2

	local var_20_6

	if var_20_3 == var_20_2.AGORA_MAP_ID then
		AgoraController = var_20_6

		local var_20_5 = var_20_6.New(arg_20_0, arg_20_1)

		var_20_6 = var_20_1.GetAgora(var_20_5)
		AgoraView = var_1_10008
		var_20_0 = var_1_10008.New(arg_20_0, var_20_6, arg_20_2)
	else
