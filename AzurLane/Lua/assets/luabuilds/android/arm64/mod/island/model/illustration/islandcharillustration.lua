...
function var_0_1.GetReachPoints(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_1 = var_1_10004.reduce(arg_1_0:getConfig("collect_star"), 0, function(arg_3_0, arg_3_1)
		local var_3_0
...
function var_0_1.CheckTip(arg_4_0)
	...
	local var_4_2 = var_2.GetIsland(var_4_1)
	local var_4_3 = var_2.GetCharacterAgency(var_4_2)

	if not var_2.GetShipById(var_4_3, var_4_0) then
		arg_4_0.isTip = false

		return
	end

	local var_4_4 = var_2:GetLevel()
	local var_4_5 = var_2:GetBreakLevel()

	arg_4_0.isTip = arg_4_0:GetReachPoints(var_4_4, var_4_5) > arg_4_0:GetPoints()
