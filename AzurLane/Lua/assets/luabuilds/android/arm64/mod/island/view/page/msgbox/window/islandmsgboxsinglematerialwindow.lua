...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".IslandMsgBoxSingleItemWindow"))
...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.ownTxt = var_2_6(var_2_5, var_4(var_1_10006))
	UIItemList = var_1

	local var_2_7 = var_1.New
	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_3.Find(var_2_8, "list")
	local var_2_10 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_7(var_2_9, var_4.Find(var_2_10, "list/tpl"))
	setText = var_1

	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_3.Find(var_2_11, "label/Text")

	i18n = var_4

	var_1(var_2_12, var_4("island_get_way"))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.priceTxt = var_2_19(var_2_18, var_4(var_6))
	...
	local var_2_21 = var_2_20 .. var_4().icon
	local var_2_22 = arg_2_0._tf

	var_1(var_2_21, var_4.Find(var_2_22, "calc/sell_btn/price/res"))

	setText = var_1

	local var_2_23 = arg_2_0._tf
	local var_2_24 = var_3.Find(var_2_23, "calc/sell_btn/Text")

	i18n = var_4

	var_1(var_2_24, var_4("island_word_convert"))
...
function var_0_1.OnShow(arg_3_0)
	...
	var_1(var_3.Find(var_3_0, "label"), false)
	...
	var_1_10002(var_3_2, var_3_3, var_3_4, var_1_10007)
	...
	var_1_10002(var_3_5, var_3_6, var_3_7, var_1_10007)
	...
	local function var_3_10()
		...
		if var_0 then
			...
			ISLAND_EX_EVT = var_2_10003

			local var_6_3 = var_2_10003.SHOW_MSG
			local var_6_4 = {}

			i18n = var_2_10005
			var_6_4.content = var_2_10005("island_season_window_transformtip")
			...
			function var_6_4.onYes()
				...
				var_7_1(var_7_0, var_3_10003.ON_CONVERT_SEASON_PT, {
					{
						id = arg_3_0.item.id,
						num = arg_3_0.value
					}
	...
	onInputEndEdit = var_1_10002

	var_1_10002(arg_3_0, arg_3_0.valueInput, function(arg_8_0)
		local var_8_0 = 0
	...
	var_3_12(var_3_11, var_5.ISLAND_CONVERT_SEASON_PT_DONE, function()
...
function var_0_1.UpdateValue(arg_11_0, arg_11_1)
	...
	local var_11_2 = var_1_10005.min
	local var_11_3 = arg_11_1
	local var_11_4 = arg_11_0.item

	arg_11_0.value = var_11_0(var_11_1, var_11_2(var_11_3, var_8.GetCount(var_11_4)))
