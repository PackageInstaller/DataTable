...
function var_0_1.Init(arg_1_0)
	...
	local var_1_2 = var_3.Find(var_1_1, "Slider")

	typeof = var_4
	Image = var_6
	arg_1_0.inviteSlider = var_1(var_1_2, var_4(var_6))
	setText = var_1
	...
	var_1(var_1_4, var_4("match_ui_matching_invitation"))
...
function var_0_1.RefreshInvite(arg_4_0)
	...
	var_1_10002(arg_4_0.invitePanel, var_4_1[1] ~= nil)
	...
	if var_4_1[1] and arg_4_0.endTime ~= var_4_1[1].timestamp then
		...
		local var_4_5 = var_1_10006.TimeMgr.GetInstance()

		var_4_4(var_4_3, var_6.GetServerTime(var_4_5), var_4_1[1].timestamp + var_4_2)
	end
...
function var_0_1.StartLeanTween(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_3 = var_5_0(var_5_1, var_5_2 / var_1_10007.gameset.match_refuseCD.key_value, 0, arg_5_2 - arg_5_1)
	local var_5_4 = var_3.setOnUpdate

	System = var_6

	local var_5_5 = var_5_4(var_5_3, var_6.Action_float(function(arg_6_0)
	...
	var_5_6(var_5_5, var_6.Action(function()
