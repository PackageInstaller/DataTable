...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.energyTipTxt = var_2_3(var_2_2, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.energyTxt = var_2_7(var_2_6, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.nameTxt = var_2_11(var_2_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.nameEnTxt = var_2_14(var_2_13, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.levelTxt = var_2_17(var_2_16, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.expTxt = var_2_20(var_2_19, var_4(var_1_10006))
	...
	local var_2_26 = var_3.Find(var_2_25, "adapt/main_panel/attr/list")
	local var_2_27 = arg_2_0._tf

	arg_2_0.uiAttrList = var_2_24(var_2_26, var_4.Find(var_2_27, "adapt/main_panel/attr/list/tpl"))
	...
	typeof = var_4
	Text = var_2_27
	arg_2_0.skillName = var_2_33(var_2_32, var_4(var_2_27))
	...
	typeof = var_4
	Text = var_2_27
	arg_2_0.skillLevel = var_2_36(var_2_35, var_4(var_2_27))
	...
	typeof = var_4
	Text = var_2_27
	arg_2_0.skillDesc = var_2_39(var_2_38, var_4(var_2_27))
	...
	local var_2_46 = var_3.Find(var_2_45, "adapt/main_panel/level/starts")
	local var_2_47 = arg_2_0._tf

	arg_2_0.breakOutList = var_2_44(var_2_46, var_4.Find(var_2_47, "adapt/main_panel/level/starts/tpl"))
	IslandShipStatusPanel = var_1

	local var_2_48 = var_1.New
	local var_2_49 = arg_2_0._tf
	local var_2_50 = var_3.Find(var_2_49, "adapt/main_panel/status")
	local var_2_51 = arg_2_0._tf

	arg_2_0.statusPanel = var_2_48(var_2_50, var_4.Find(var_2_51, "adapt/main_panel/status_empty"))
	...
	var_1(var_2_56, var_4("island_ship_energy"))

	setText = var_1

	local var_2_57 = arg_2_0.followerBtnInvite
	local var_2_58 = var_3.Find(var_2_57, "Text")

	i18n = var_4

	var_1(var_2_58, var_4("island_follow_btn_State_usable"))

	setText = var_1

	local var_2_59 = arg_2_0.followerBtnCancel
	local var_2_60 = var_3.Find(var_2_59, "Text")

	i18n = var_4

	var_1(var_2_60, var_4("island_follow_btn_State_cancel"))

	setText = var_1

	local var_2_61 = arg_2_0.followerBtnDisable
	local var_2_62 = var_3.Find(var_2_61, "Text")

	i18n = var_4

	var_1(var_2_62, var_4("island_follow_btn_State_disable"))

	setActive = var_1

	local var_2_63 = arg_2_0.followerBtnInvite

	var_1(var_3.Find(var_2_63, "Text"), false)

	setActive = var_1

	local var_2_64 = arg_2_0.followerBtnInvite

	var_1(var_3.Find(var_2_64, "Text"), true)
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_5()
		...
		IslandShipSkillUpgradePage = var_2_10003

		var_5_3(var_5_2, var_2_10003, arg_3_0.ship)
	...
	local function var_3_8()
		...
		if var_0.IsMaxLevel(var_6_0) then
			...
			IslandShipBreakoutPage = var_2_10003

			var_6_3(var_6_2, var_2_10003, arg_3_0.ship)
		else
			local var_6_4 = arg_3_0
			local var_6_5 = var_0.OpenPage

			IslandShipUpgradePage = var_2_10003

			var_6_5(var_6_4, var_2_10003, arg_3_0.ship)
		end
	...
	local function var_3_14()
		...
		IslandShipAttrUpgradePage = var_2_10003

		var_8_1(var_8_0, var_2_10003, arg_3_0.ship)
	...
	local function var_3_17()
		...
		if var_1.Following(var_9_2, arg_3_0.ship.id) then
			...
			var_9_5 = {}
			i18n = var_2_10005
			var_9_5.content = var_2_10005("island_cancel_follow_tip")
			...
			function var_9_5.onYes()
				...
				var_10_1(var_10_0, var_3_10003.WILL_DEL_FOLLOWER, arg_3_0.ship.id)
	...
	local function var_3_20()
		...
		var_11_2.type = var_2_10004.TYPE_SHIP_SKILL

		local var_11_3 = arg_3_0.ship

		var_11_2.skill = var_4.GetSkill(var_11_3)
...
function var_0_1.UpdateFollowBtn(arg_13_0, arg_13_1)
	...
	var_13_5(arg_13_0.followerBtnInvite, not var_13_3 and var_13_7)

	setActive = var_13_5

	var_13_5(arg_13_0.followerBtnCancel, var_13_3)

	local var_13_8 = not var_13_7 and not var_13_3

	setActive = var_13_6

	var_13_6(arg_13_0.followerBtnDisable, var_13_8)

	setButtonEnabled = var_13_6

	var_13_6(arg_13_0.followerBtn, not var_13_8)
...
function var_0_1.AddListeners(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10004.ISLAND_USE_SHIP_EXP_BOOK_DONE, arg_14_0.OnUseExpBook)
	...
	var_14_3(var_14_2, var_4.ISLAND_SHIP_BREAKOUT_DONE, arg_14_0.OnBreakOut)
	...
	var_14_5(var_14_4, var_4.ISLNAD_SHIP_ATTR_UPGRADE_DONE, arg_14_0.OnAttrUpgrade)
	...
	var_14_7(var_14_6, var_4.ISLAND_SHIP_SKILL_UPGRADE_DONE, arg_14_0.OnSkillUpgrade)
	...
	var_14_9(var_14_8, var_4.ISLAND_FOLLOWER_OP_DONE, arg_14_0.OnFollowOpDone)
...
function var_0_1.RemoveListeners(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10004.ISLAND_USE_SHIP_EXP_BOOK_DONE, arg_15_0.OnUseExpBook)
	...
	var_15_3(var_15_2, var_4.ISLAND_SHIP_BREAKOUT_DONE, arg_15_0.OnBreakOut)
	...
	var_15_5(var_15_4, var_4.ISLNAD_SHIP_ATTR_UPGRADE_DONE, arg_15_0.OnAttrUpgrade)
	...
	var_15_7(var_15_6, var_4.ISLAND_SHIP_SKILL_UPGRADE_DONE, arg_15_0.OnSkillUpgrade)
	...
	var_15_9(var_15_8, var_4.ISLAND_FOLLOWER_OP_DONE, arg_15_0.OnFollowOpDone)
...
function var_0_1.DisplayEnergyTip(arg_22_0)
	...
	i18n = var_1_10002
	var_22_0.text = var_1_10002("island_ship_energy_full")
...
function var_0_1.UpdateAttr(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4)
	...
	local var_33_2 = arg_33_1:Find("name")

	IslandShipAttr = var_1_10010

	var_1_10007(var_33_2, var_1_10010.ToChinese(var_33_0))

	IslandProductTimeHelper = var_1_10007

	local var_33_3 = var_1_10007.GetAttributeAddPercentByAttribute(arg_33_4.id, arg_33_3)
	local var_33_4
	local var_33_5 = 0 < var_33_3 and "#00B91E" or var_33_3 < 0 and "#FF6767" or "#393A3C"

	setTextColor = var_9

	local var_33_6 = arg_33_1:Find("value")

	Color = var_12

	var_9(var_33_6, var_12.NewHex(var_33_5))
	...
	if var_33_3 ~= 0 then
		...
		if not var_9.floor(var_33_1 * (1 + 0.01 * var_33_3)) then
			var_33_7 = var_33_1
		end

		setText = var_33_8

		var_33_8(arg_33_1:Find("value"), var_33_7)

		local var_33_8

		if var_33_3 ~= 0 then
			var_33_8 = arg_33_4:GetDisplayStatus()
			_ = var_33_6
			var_33_8 = var_33_6.select(var_33_8, function(arg_34_0)
				local var_34_0 = arg_34_0:GetBuffType()

				IslandBuffType = var_2_10002

				return var_34_0 == var_2_10002.SHIP_ATTR
			end)
			onButton = var_33_6

			local var_33_9 = arg_33_0
			local var_33_10 = arg_33_1
			...
			local function var_33_11()
				...
				IslandMsgBox = var_2_10004
				var_35_2.type = var_2_10004.TYPE_SHIP_OWN_STATUS
				i18n = var_4
				var_35_2.title = var_4("island_word_ship_buff_desc")
				var_35_2.statusList = var_33_8
			...
			var_33_6(var_33_9, var_33_10, var_33_11, var_1_10016)
		else
			removeOnButton = var_33_8

			var_33_8(arg_33_1)
		end

		local var_33_12 = arg_33_4
		local var_33_13 = arg_33_4.GetAttrGradeByValue(var_33_12, var_33_7)

		IslandShipAttr = var_33_6

		local var_33_14 = var_33_6.Grade2Img(var_33_13)

		GetImageSpriteFromAtlasAsync = var_33_12

		var_33_12("ui/IslandShipUI_atlas", var_33_14[1], arg_33_1:Find("grade"))

		GetImageSpriteFromAtlasAsync = var_33_12

		var_33_12("ui/IslandShipUI_atlas", var_33_14[2], arg_33_1:Find("grade_bg"))
...
function var_0_1.UpdateSkill(arg_36_0, arg_36_1)
	...
	var_1_10003("island/IslandSkillIcon/" .. var_36_0:GetIcon(), "", arg_36_0.skillIconImg)
	...
	var_4(arg_36_0.skillTr, var_36_1)

	setActive = var_4

	var_4(arg_36_0.skillMask, not var_36_1)

	setText = var_4

	local var_36_2 = arg_36_0.skillMaskLabel

	i18n = var_7

	var_4(var_36_2, var_7("island_need_star", arg_36_1:GetSkillUnlockLevel()))

	setActive = var_4

	var_4(arg_36_0.skillUpgradeBtn, not var_36_0:IsMaxLevel())
...
function var_0_1.UpdateStatus(arg_37_0, arg_37_1)
	...
	local var_37_1 = arg_37_1:GetDisplayStatus()

	onButton = var_1_10003

	local var_37_2 = arg_37_0
	local var_37_3 = arg_37_0.statusPanel.viewBtn
	...
	local function var_37_4()
		...
		IslandMsgBox = var_2_10004
		var_38_2.type = var_2_10004.TYPE_SHIP_OWN_STATUS
		i18n = var_4
		var_38_2.title = var_4("island_word_ship_buff_desc")
		var_38_2.statusList = var_37_1
	...
	var_1_10003(var_37_2, var_37_3, var_37_4, var_1_10008)
