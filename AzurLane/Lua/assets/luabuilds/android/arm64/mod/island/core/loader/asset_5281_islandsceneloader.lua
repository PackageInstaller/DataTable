...
function var_0_0.LoadSceneWithProgress(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_1 = var_1_10004.match(var_14_0, "[^/]+$")
	...
	var_14_3(var_14_2, var_14_4, var_14_5, var_1_10011.Additive, function(arg_15_0)
		if arg_15_0 == 1 then
...
function var_0_0.LoadNavigationMesh(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_4 = var_1_10008(var_1_10010)

	UnityEngine = var_1_10009
	arg_18_0.navMeshLoadingId = var_18_1(var_18_0, var_18_2, var_18_3, var_18_4, var_1_10009.Events.UnityAction_UnityEngine_Object(function(arg_19_0)
		assert = var_2_10001
		...
		FrameAsyncInstantiateManager = var_2_10002

		local var_19_1 = var_2_10002.Instance
...
function var_0_0.UnLoad(arg_21_0, arg_21_1)
	...
	arg_21_0.UnloadProgressUI(var_21_0)

	local var_21_1 = arg_21_0.scenePath
	local var_21_2 = arg_21_0.sceneName
	...
	local var_21_3 = var_21_0.Inst

	var_4.UnloadSceneAsync(var_21_3, var_21_1, var_21_2, function()
		return
	end)
