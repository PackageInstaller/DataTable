...
function var_0_1.InitHandPlantCfg(arg_7_0)
	...
	if not var_4.island_production_farm.get_id_list_by_place_id[arg_7_0.productPlaceId] then
		var_7_1 = {}
	end
...
function var_0_1.InitHandCollectCfg(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10001(var_1_10003.island_production_mining.all) do
		pg = var_1_10006
...
function var_0_1.GenPlaceSlotModelUnit(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in var_4(var_10_1) do
		...
		if var_1_10009.island_production_slot[iter_10_1].type == 9 then
			...
			if var_1_10011.island_production_commission[var_10_2].unlockObjid ~= 0 then
				if arg_10_0.building ~= nil then
					var_1_10015 = arg_10_0.building

					if var_13.GetDelegationSlotData(var_1_10015, iter_10_1) == nil then
						pg = var_13

						local var_10_3 = var_13.island_world_objects[var_12]

						IslandDataConvertor = var_1_10014
						var_1_10014 = var_1_10014.WorldObj2IslandUnit(var_10_3)
						table = var_1_10015

						var_1_10015.insert(arg_10_1, var_1_10014)
					end
				end
			end
		end
...
function var_0_1.GenPlaceModelUnit(arg_11_0, arg_11_1)
	...
	if not var_11_0(var_1_10004.haveModelPlaces, arg_11_0.productPlaceId) then
		return
	end

	local var_11_1 = arg_11_0.building ~= nil
	local var_11_2 = arg_11_0:GetPlaceModelUnit(var_11_1)

	table = var_4

	var_4.insert(arg_11_1, var_11_2)
...
function var_0_1.GetPlaceModelUnit(arg_13_0, arg_13_1)
	...
	local var_13_2 = var_1_10003.island_world_objects[var_13_1]

	IslandDataConvertor = var_13_0

	return var_13_0.WorldObj2IslandUnit(var_13_2)
end
...
function var_0_1.GenHandCollectSlotInSlotPlace(arg_17_0, arg_17_1)
	...
	local var_17_1 = var_2:GetCollectSlotDatasDic()

	pairs = var_17_0

	for iter_17_0, iter_17_1 in var_17_0(var_17_1) do
		if arg_17_0:GenHandCollectSlotByDataNew(iter_17_1) then
			table = var_1_10010

			var_1_10010.insert(arg_17_1, var_9)
		end
	end
...
function var_0_1.GetHandCollectSlotBySlotId(arg_18_0, arg_18_1)
	if not arg_18_0.building then
		if arg_18_0.isSelf then
			...
			var_1_10005 = var_18_1(var_1_10005)

			local var_18_1

			if not var_18_1.GetIsland(var_1_10005) then
				getProxy = var_18_1
				IslandProxy = var_1_10005

				local var_18_0 = var_18_1(var_1_10005)
...
function var_0_1.GenHandCollectSlotByDataNew(arg_19_0, arg_19_1)
	...
	if arg_19_1.GetCanCollectTimeStamps(var_19_5) == 0 or var_19_1 then
		local var_19_6 = {
			unitId = var_19_4
		}

		IslandConst = var_19_5
		var_19_6.typ = var_19_5.UNIT_TYPE_ITEM_HANDLE_COLLECT
		var_19_6.slotId = arg_19_1.configId
		pg = var_9
		...
		return (arg_19_0:CollectSlotObj2IslandUnit(var_19_7, var_19_6))
	end
...
function var_0_1.InitHandCollectSlotBySlotId(arg_20_0, arg_20_1)
	if not arg_20_0.building then
		if arg_20_0.isSelf then
			getProxy = var_20_1
			IslandProxy = var_1_10005
			var_1_10005 = var_20_1(var_1_10005)

			local var_20_1

			if not var_20_1.GetIsland(var_1_10005) then
				getProxy = var_20_1
				IslandProxy = var_1_10005

				local var_20_0 = var_20_1(var_1_10005)
...
function var_0_1.GenHandPlantSlot(arg_21_0, arg_21_1)
	...
	if not var_1_10004.island_production_farm.get_id_list_by_place_id[arg_21_0.productPlaceId] then
		var_21_0 = {}
	end
	...
	for iter_21_0, iter_21_1 in var_1_10002(var_21_0) do
		...
		if arg_21_0.building and arg_21_0.building.handSlotData[var_21_2] then
			...
			var_1_10016 = var_13
			var_21_4 = var_13.GetPlantFormulaId(var_1_10016) or nil
			...
			if var_21_4 then
				...
				if var_15.GetDelegationSlotData(var_21_5, var_1_10014) and not var_15:CanStartDelegation() then
					var_21_3 = var_1_10007.work_unit
					IslandProductConst = var_21_5
					var_1_10011 = var_21_5.ProductSlotType.RoleDelegation
		...
		var_21_6.typ = var_1_10014.UNIT_TYPE_ITEM_HANDLE_PLANTING
		var_21_6.formula_id = var_21_4
		var_21_6.slotId = var_21_2
		var_21_6.slotType = var_1_10011
		pg = var_1_10014
		...
		local var_21_7 = arg_21_0:ProductSlotObj2IslandUnit(var_1_10014, var_21_6)

		table = var_1_10016

		var_1_10016.insert(arg_21_1, var_21_7)
	end
...
function var_0_1.GenAnimalBySlot(arg_22_0, arg_22_1)
	...
	for iter_22_0, iter_22_1 in var_22_0(var_4.GetDelegationSlotDatas(var_22_1)) do
		pg = var_1_10007
		...
		pg = var_1_10009
		var_1_10009 = var_1_10009.island_production_commission[var_22_3]
		ipairs = var_22_2

		for iter_22_2, iter_22_3 in var_22_2(iter_22_1:GetPartList()) do
			pg = var_1_10015
			var_1_10015 = var_1_10015.island_ranch_animal[iter_22_3]
			pg = var_1_10016

			if not var_1_10016.island_world_objects[var_1_10009.birthplace] then
				var_1_10016 = {}
			end

			IslandCalcUtil = var_17

			local var_22_4 = var_17.GetRandomPointOnCircle

			BuildVector3 = var_1_10019

			local var_22_5 = var_22_4(var_1_10019(var_1_10016.param.position), 5)
			local var_22_6 = {
				var_22_5.x,
				var_22_5.y,
				var_22_5.z
			}
			local var_22_7 = arg_22_0:ProductAniObj2IslandUnit(var_1_10015, var_22_6)

			table = var_1_10019

			var_1_10019.insert(arg_22_1, var_22_7)
		end
	end
...
function var_0_1.GenAnimalByAnialConfig(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_2 = var_1_10004.island_production_commission[var_23_1]

	pg = var_23_0

	local var_23_3 = var_23_0.island_ranch_animal[arg_23_1]

	pg = var_6

	local var_23_4

	if not var_6.island_world_objects[var_23_2.birthplace] then
		var_23_4 = {}
	end
	...
	local var_23_6 = var_23_5(var_1_10009(var_23_4.param.position), 5)
	local var_23_7 = {
		var_23_6.x,
		var_23_6.y,
		var_23_6.z
...
function var_0_1.GenHandPlantUnitBySlotData(arg_24_0, arg_24_1, arg_24_2)
	...
	if arg_24_0.unitDic[var_24_0] then
		var_24_7.modelId = var_24_2

		local var_24_3 = var_24_7
		local var_24_4 = var_24_7.ChangeSlotType

		IslandProductConst = var_1_10010

		var_24_4(var_24_3, var_1_10010.ProductSlotType.HandPlant)
		var_24_7:StartPlantGrowthTime(arg_24_2)
	else
		local var_24_5 = {
			unitId = var_24_2
		}
		...
		var_24_5.typ = var_1_10008.UNIT_TYPE_ITEM_HANDLE_PLANTING
		var_24_5.formula_id = arg_24_2
		var_24_5.slotId = arg_24_1
		IslandProductConst = var_8
		var_24_5.slotType = var_8.ProductSlotType.HandPlant
		pg = var_8
		...
		var_24_7 = arg_24_0:ProductSlotObj2IslandUnit(var_24_6, var_24_5)
	end
...
function var_0_1.ProductSlotObj2IslandUnit(arg_27_0, arg_27_1, arg_27_2)
	...
	var_27_1.isDynamic = var_27_5 == var_1_10007.UNIT_GEN_TYPE_DYNAMIC
...
function var_0_1.CollectSlotObj2IslandUnit(arg_28_0, arg_28_1, arg_28_2)
	...
	IslandConst = var_1_10007
	var_28_1.isDynamic = var_28_5 == var_1_10007.UNIT_GEN_TYPE_DYNAMIC
...
function var_0_1.ProductAniObj2IslandUnit(arg_29_0, arg_29_1, arg_29_2)
	...
	IslandConst = var_6
	var_29_1.type = var_6.UNIT_TYPE_SYSTEM_DELEAGTION_ANIMATION
	var_29_1.name = "system_unit" .. arg_29_1.id
	var_29_1.position = arg_29_2
	Vector3 = var_6
	var_29_1.rotation = var_6.zero
	Vector3 = var_6
	var_29_1.scale = var_6.one
...
function var_0_1.GetDelegateUnitsByBuildIdAndSlotId(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	var_30_2[var_1_10009.FisheryPlaceId] = function()
...
function var_0_1.GetDelegateFishUnits(arg_34_0, arg_34_1, arg_34_2)
	...
	local var_34_3 = var_1_10005.island_production_commission[var_34_2]

	pg = var_34_1

	local var_34_4 = var_34_1.island_formula[arg_34_2].unitid[1][1]
	...
	for iter_34_0 = 1, var_34_6 do
		...
		local var_34_11 = arg_34_0:GenDelegateFishUnit(var_34_8, var_34_4, var_34_5, var_34_7)

		table = var_34_10

		var_34_10.insert(var_34_0, var_34_11)
	end
...
function var_0_1.GenDelegateFishUnit(arg_37_0, arg_37_1, arg_37_2, arg_37_3, arg_37_4)
	...
	IslandConst = var_1_10008
	var_37_1.type = var_1_10008.UNIT_TYPE_DELEGATE_FISH
	pg = var_8
	var_37_1.name = var_8.island_unit_character[arg_37_2].id
	var_37_1.position = arg_37_3.param.position
	Vector3 = var_8
	var_37_1.rotation = var_8.zero
	Vector3 = var_8
	var_37_1.scale = var_8.one
