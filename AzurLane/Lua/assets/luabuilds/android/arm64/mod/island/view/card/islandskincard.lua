...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	var_4(var_6.Find(var_2_1, "Text"), var_2_0.name)

	if var_2_0.icon ~= "" then
		GetImageSpriteFromAtlasAsync = var_4
		string = var_6

		local var_2_2 = var_6.format("island/IslandDressIcon/%s", var_2_0.icon)
		local var_2_3 = ""
		local var_2_4 = arg_2_0.tf

		var_4(var_2_2, var_2_3, var_8.Find(var_2_4, "icon"))
	end
