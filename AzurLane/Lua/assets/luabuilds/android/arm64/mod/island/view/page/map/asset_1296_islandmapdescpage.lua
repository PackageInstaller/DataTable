...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".IslandBaseMapDescPage"))
...
function var_0_1.UpdateProductionList(arg_3_0, arg_3_1)
	...
	local var_3_3 = var_1_10004.select(var_3_0, function(arg_4_0)
		local var_4_0 = var_3_2
		local var_4_1 = var_1.HasAbility

		pg = var_2_10004

		return var_4_1(var_4_0, var_2_10004.island_map_details[arg_4_0].ability_id)
	end)
...
function var_0_1.AddTimer(arg_6_0, arg_6_1, arg_6_2)
	...
	var_1_10004(var_6_0, false)

	local var_6_1 = arg_6_0

	arg_6_0.RemoveTimer(var_6_1, arg_6_2)
	...
	local var_6_2 = var_4(var_6_1)
	local var_6_3 = var_4.GetIsland(var_6_2)
	local var_6_4 = var_4.GetBuildingAgency(var_6_3)

	if var_4.GetBuilding(var_6_4, arg_6_2) then
		local var_6_5 = var_5
		local var_6_6

		if not var_5.GetMinRoleDeleGationTime(var_6_5) then
			var_6_6 = -1
		end
		...
		if var_6_6 <= var_7.GetServerTime(var_6_7) then
			...
			var_6_5(var_6_0, true)

			var_1_10010 = arg_6_0

			arg_6_0.UpdateAnyFullMark(var_1_10010)
