...
function var_0_0.CheckSubmit(arg_3_0)
	if var_0_0.objectSubmitData[arg_3_0] then
		...
		if 0 < var_3_0 then
			...
			local var_3_4 = var_3.select(var_1, function(arg_4_0)
				local var_4_0 = var_3_3

				return var_1.GetTask(var_4_0, arg_4_0) and var_1:IsFinish()
			end)
...
function var_0_0.CheckAccept(arg_5_0)
	if var_0_0.objectAcceptData[arg_5_0] then
		...
		if 0 < var_5_0 then
			...
			local var_5_1 = var_5_0(var_1_10004)
			local var_5_2 = var_2.GetIsland(var_5_1)
			local var_5_3 = var_2.GetTaskAgency(var_5_2)

			underscore = var_3

			local var_5_4 = var_3.select(var_1, function(arg_6_0)
				local var_6_0 = var_5_3

				return var_1.GetFutureTask(var_6_0, arg_6_0) and var_1:IsUnlock()
			end)
...
function var_0_0.CheckTarget(arg_7_0)
	if var_0_0.objectTargetData[arg_7_0] then
		...
		if 0 < var_7_0 then
			...
			local var_7_1 = var_7_0(var_1_10004)
			local var_7_2 = var_2.GetIsland(var_7_1)
			local var_7_3 = var_2.GetTaskAgency(var_7_2)

			underscore = var_3

			local var_7_4 = var_3.select(var_1, function(arg_8_0)
			...
			local var_7_5 = var_7_2.map(var_7_4, function(arg_9_0)
				return arg_9_0[1]
			end)
...
function var_0_0.GetHudDislayInfoByTaskId(arg_14_0)
	...
	var_14_3[var_1_10006.SHOW_MAIN] = function()
		return "hud_main", "39befe"
	end
	IslandTaskType = var_6
	var_14_3[var_6.SHOW_BRANCH] = function()
		return "hud_branch", "e67ad5"
	end
	IslandTaskType = var_6
	var_14_3[var_6.SHOW_DAILY] = function()
		return "hud_dayly", "b4a0e6"
	end
	IslandTaskType = var_6
	var_14_3[var_6.SHOW_WEEKLY] = function()
		return "hud_weekly", "7ed38f"
	end
	IslandTaskType = var_6
	var_14_3[var_6.SHOW_ACTIVITY] = function()
