...
function var_0_1.OnLoaded(arg_3_0)
	...
	arg_3_0.maskCG = var_3_3(var_3_2, var_4(var_1_10006))
...
function var_0_1.PlaySceneTimeline(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	var_1_10005(var_10_0, "island_scene_timeline >>>>" .. arg_10_1)

	IslandSceneSwitcher = var_1_10005

	local var_10_1 = var_1_10005.New()
...
function var_0_1.ReplaceTimelineRes(arg_20_0, arg_20_1, arg_20_2, arg_20_3, arg_20_4)
	...
	BuildVector3 = var_1_10007

	local var_20_2 = var_1_10007(arg_20_1[3])
...
local function var_0_5(arg_26_0, arg_26_1)
	if arg_26_1 == "Animator" then
		...
		if var_26_2(var_26_1, var_1_10006(var_1_10008)) then
			return var_3
		end
		...
		return (var_26_0(var_26_3, var_1_10007(var_1_10009)))
...
function var_0_1.ReplaceTracks(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	...
	for iter_27_0, iter_27_1 in var_1_10005(arg_27_2) do
		...
		var_13.insert(var_27_0[var_1_10010], {
			var_27_1,
			var_27_2
		})
	end
	...
	for iter_27_2, iter_27_3 in var_5(var_27_0) do
		...
		local var_27_5 = var_27_4(var_27_3, var_1_10014(var_1_10016.Playables.PlayableDirector))

		TimelineHelper = var_12
		var_1_10014 = var_12.GetTimelineTracks(var_27_5)

		local var_27_6 = var_12.ToTable(var_1_10014)
		local var_27_7 = {}

		ipairs = var_1_10014

		for iter_27_4, iter_27_5 in var_1_10014(var_27_6) do
			var_27_7[iter_27_5.name] = iter_27_5
		end
		...
		for iter_27_6, iter_27_7 in var_1_10014(iter_27_3) do
			...
			if not var_1_10019(iter_27_7[1]) or not var_27_6[var_1_10019 + 1] then
				var_27_8 = var_27_7[iter_27_7[1]]
			end

			if var_27_8 then
				TimelineHelper = var_21

				var_21.SetSceneBinding(var_27_5, var_27_8, var_0_5(arg_27_1, iter_27_7[2]))
			end
		end
	end
...
function var_0_1.ReplcaeCamTracks(arg_28_0, arg_28_1)
	...
	local var_28_2 = var_28_1(var_28_0, var_1_10006(var_1_10008.Playables.PlayableDirector), true)
	...
	for iter_28_0, iter_28_1 in var_4(var_28_3) do
		...
		for iter_28_2, iter_28_3 in var_1_10010(var_1_10009) do
			local var_28_5 = iter_28_3:GetType()

			if var_15.ToString(var_28_5) == "CinemachineTrack" then
				TimelineHelper = var_1_10016
				var_1_10016 = var_1_10016.SetSceneBinding

				local var_28_6 = iter_28_1
				local var_28_7 = iter_28_3

				IslandCameraMgr = var_1_10020

				var_1_10016(var_28_6, var_28_7, var_1_10020.instance.cinemachineBrain)
			end
		end
	end
...
function var_0_1.PlayTimeline(arg_34_0, arg_34_1, arg_34_2)
	...
	local var_34_3 = var_34_2(var_34_1, var_7(var_1_10009.Playables.PlayableDirector))

	GetOrAddComponent = var_5

	local var_34_4 = var_5(var_34_0, "DftCommonSignalReceiver")
