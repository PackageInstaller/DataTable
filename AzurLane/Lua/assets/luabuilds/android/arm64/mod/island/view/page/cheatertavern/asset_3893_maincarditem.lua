...
function var_0_0.Init(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local function var_2_0(arg_3_0)
		...
		typeof = var_4
		CheaterTavernCard = var_2_10006

		local var_3_7 = var_1(var_3_6, var_4(var_2_10006))
...
function var_0_0.InitCardView(arg_8_0)
	...
	local var_8_4 = var_8_3(var_7.abs(var_8_2))
	...
	var_7(var_8_6, var_1_10010.Euler(0, 180, var_8_5))

	local var_8_7 = arg_8_0.allCount

	IslandCheaterTavernConst = var_1_10008

	local var_8_8 = var_1_10008.cardWidth

	IslandCheaterTavernConst = var_8_6

	local var_8_9 = var_8_6.cardSpace
	...
	var_1_10015(var_8_13, var_1_10018(var_8_10, var_8_12, -var_8_0 * (var_8_1 - 1)))
	...
	var_1_10015(var_8_14, var_18(1, 1, 1))
...
function var_0_0.SetSelected(arg_9_0, arg_9_1)
	...
	if arg_9_0.isSelected then
		...
		var_2(var_9_0, var_1_10005(arg_9_0.tf.localPosition.x, arg_9_0.tf.localPosition.y + 0.02, arg_9_0.tf.localPosition.z))
		...
		var_2(var_9_1, var_1_10005(arg_9_0.tf.localPosition.x, arg_9_0.tf.localPosition.y - 0.02, arg_9_0.tf.localPosition.z))
...
function var_0_0.UpdateMoveToTable(arg_11_0)
	...
	local var_11_4 = var_1_10003.Lerp(arg_11_0.startPos, arg_11_0.endPos, var_11_3)
...
function var_0_0.UpdateFlipTableCard(arg_14_0)
	...
	local var_14_3 = var_14_1(var_14_2 / var_1_10004.FlipCardTime, 1)
