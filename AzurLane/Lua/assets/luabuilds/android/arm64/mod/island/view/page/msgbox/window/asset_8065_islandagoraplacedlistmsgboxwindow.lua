...
local function var_0_2(arg_2_0)
	...
	local var_2_4 = var_2_3(var_2_2, var_5(var_1_10007))
	...
	local var_2_8 = var_2_7(var_2_6, var_6(var_1_10008))
	...
	local var_2_12 = var_2_11(var_2_10, var_7(var_1_10009))
	...
	local var_2_16 = var_2_15(var_2_14, var_8(var_1_10010))
...
function var_0_1.OnLoaded(arg_5_0)
	...
	local var_5_1 = var_3.Find(var_5_0, "list/titles/1")

	i18n = var_1_10004

	var_1(var_5_1, var_1_10004("island_label_furniture"))

	setText = var_1

	local var_5_2 = arg_5_0._tf
	local var_5_3 = var_3.Find(var_5_2, "list/titles/2")

	i18n = var_4

	var_1(var_5_3, var_4("island_label_furniture_cnt"))

	setText = var_1

	local var_5_4 = arg_5_0._tf
	local var_5_5 = var_3.Find(var_5_4, "list/titles/3")

	i18n = var_4

	var_1(var_5_5, var_4("island_label_furniture_capacity"))
	...
	typeof = var_4
	Text = var_6
	arg_5_0.capacityTxt = var_5_8(var_5_7, var_4(var_6))
