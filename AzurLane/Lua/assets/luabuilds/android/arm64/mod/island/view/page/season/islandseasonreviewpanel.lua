...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_5
	Image = var_1_10007
	arg_2_0.titleImg = var_2_4(var_2_3, var_5(var_1_10007))
	...
	typeof = var_5
	Image = var_1_10007
	arg_2_0.seasonNumImg = var_2_7(var_2_6, var_5(var_1_10007))
	...
	var_2(var_2_9, var_5("island_season_review_miss"))

	setText = var_2

	local var_2_10 = arg_2_0.infoPanel
	local var_2_11 = var_4.Find(var_2_10, "season/title/Text")

	i18n = var_5

	var_2(var_2_11, var_5("island_season_title"))

	setText = var_2

	local var_2_12 = arg_2_0.infoPanel
	local var_2_13 = var_4.Find(var_2_12, "prod/title/Text")

	i18n = var_5

	var_2(var_2_13, var_5("island_season_review_produce"))

	setText = var_2

	local var_2_14 = arg_2_0.infoPanel
	local var_2_15 = var_4.Find(var_2_14, "relax/title/Text")

	i18n = var_5

	var_2(var_2_15, var_5("island_season_review_relax"))
	...
	for iter_2_0, iter_2_1 in var_2_17(arg_2_0.infoTFs) do
		...
		var_7(iter_2_1, function(arg_3_0)
			setText = var_2_10001
			...
			local var_3_2 = var_2_10004.KEY2NAME

			tonumber = var_3_0

			var_2_10001(var_3_1, var_3_2[var_3_0(arg_3_0.name)])
...
function var_0_1.Show(arg_5_0)
	...
	IslandSeasonPage = var_4

	local var_5_2 = var_4.UPDATE_REDDOT

	IslandSeasonPage = var_1_10005

	var_5_1(var_5_0, var_5_2, var_1_10005.PAGE_REVIEW)
...
function var_0_1.Flush(arg_7_0, arg_7_1)
	...
	var_1_10003(arg_7_0.emptyTF, not var_7_3)

	setActive = var_1_10003

	var_1_10003(arg_7_0.infoPanel, var_7_3)

	if var_7_3 then
		ipairs = var_1_10003

		for iter_7_0, iter_7_1 in var_1_10003(arg_7_0.infoTFs) do
			...
			var_1_10008(iter_7_1, function(arg_8_0)
				...
				local var_8_2 = var_4.GetRecordData

				tonumber = var_2_10007

				var_2_10001(var_8_0, var_8_2(var_8_1, var_2_10007(arg_8_0.name)))
	...
	if arg_7_0.playerRankVOs[arg_7_1] then
		...
		if var_4.canFetch(var_7_4, arg_7_0.rankType, arg_7_0.seasonId) then
			...
			IslandMediator = iter_7_1

			var_7_6(var_7_5, iter_7_1.ON_GET_SEASON_RANK, arg_7_0.rankType, arg_7_0.seasonId)
		else
			arg_7_0:UpdataIcon()
		end
		...
		var_7_8.sprite = var_5("ui/IslandSeasonTheme" .. arg_7_1 .. "_atlas", "title")
