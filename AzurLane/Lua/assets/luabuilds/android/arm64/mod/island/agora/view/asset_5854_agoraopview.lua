...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("Mod.Island.Core.View.IslandOpView"))
...
function var_0_1.OnInit(arg_2_0, arg_2_1)
	...
	arg_2_0.animator = var_2_12(var_2_11, var_5(var_1_10007))
	...
	arg_2_0.dftAniEvent = var_2_14(var_2_13, var_5(var_1_10007))
	setText = var_2

	local var_2_15 = arg_2_0.signInTip
	local var_2_16 = var_4.Find(var_2_15, "Text")

	i18n = var_5

	var_2(var_2_16, var_5("island_agora_signIn_tip"))
...
function var_0_1.UpdateSignInTip(arg_6_0)
	...
	if not var_1.IsSelfIsland(var_6_0) then
		...
		var_1_10002(var_6_3, var_5.CanSignIn(var_6_4))
	end
...
function var_0_1.InActiveDragBtn(arg_10_0)
	...
	var_1.SetEndEvent(var_10_2, function()
		...
		Vector3 = var_2_10001
		var_11_2.localPosition = var_2_10001(10000, 10000, 0)
...
function var_0_1.UpdateDragPosition(arg_12_0, arg_12_1)
	...
	local var_12_2 = var_1_10004.ScreenPosition2LocalPosition(arg_12_0.dragBtn.parent, var_12_1)
...
function var_0_1.AddDraglistener(arg_13_0, arg_13_1)
	...
	local var_13_1 = var_1_10002(var_13_0, var_1_10005(var_1_10007))
	...
	var_3(var_13_2, var_13_3, var_13_4, var_1_10008)
	...
	var_3(var_13_5, var_13_6, var_13_7, var_1_10008)
	...
	var_3(var_13_8, var_13_9, var_13_10, var_1_10008)
...
function var_0_1.RemoveDraglistener(arg_20_0)
	...
	local var_20_1 = var_1_10001(var_20_0, var_1_10004(var_1_10006))
...
function var_0_1.EnterMode(arg_21_0, arg_21_1)
	...
	if arg_21_1 == var_1_10002.MODE_OVERVIEW then
		...
		var_21_1(var_21_0, var_5.PLAYER_INPUT_INDEX)
	...
	if arg_21_1 == var_21_1.MODE_EDIT then
		...
		if arg_21_0.mode then
			do
				local var_21_2 = arg_21_0.mode

				AgoraView = var_1_10003

				if var_21_2 == var_1_10003.MODE_OVERVIEW then
					arg_21_0:TryDisablePlayerOp()
				end

				local var_21_3 = arg_21_0.inputController

				var_21_2 = var_21_2.ActivePlayerActionMap
				IslandConst = var_5

				var_21_2(var_21_3, var_5.AGORA_INPUT_INDEX)

				local var_21_4 = arg_21_0.inputController

				var_21_2.EnableAgoraLook(var_21_4)
				...
				if false then
					...
					if arg_21_1 == var_21_2.MODE_PAVE_TILE then
						local var_21_5 = arg_21_0.inputController

						var_2.DisableAgoraLook(var_21_5)
						arg_21_0:RemoveEditModeListener()
...
function var_0_1.OnEditModeClick(arg_22_0, arg_22_1)
	...
	local var_22_2 = var_1_10005.UNIT_LIST_AGORA

	IslandConst = var_1_10006

	if var_22_0(var_22_1, var_22_2, var_1_10006.LAYER_WORLDMAP3D) > 0 then
...
function var_0_1.AddEditModeListener(arg_23_0)
	...
	local var_23_1 = var_1_10001(var_23_0, var_1_10004(var_1_10006))
	local var_23_2
...
function var_0_1.RemoveEditModeListener(arg_26_0)
	...
	if var_26_1(var_26_0, var_1_10004(var_1_10006)) then
...
function var_0_1.AddPaveTileModeListener(arg_27_0)
	...
	local var_27_1 = var_1_10001(var_27_0, var_1_10004(var_1_10006))
	local var_27_2
...
function var_0_1.RemovePaveTileModeListener(arg_33_0)
	...
	if var_33_1(var_33_0, var_1_10004(var_1_10006)) then
		var_1:AddPointDownFunc(nil)
		var_1:AddPointUpFunc(nil)
