...
function var_0_1.FlushMain(arg_4_0, arg_4_1)
	...
	local var_4_2 = var_4_1(var_1_10005)
	...
	local var_4_7 = var_4_4("island_own_cnt")
...
function var_0_1.FlushAcquiringWay(arg_5_0, arg_5_1)
	...
	var_5(var_7.Find(var_5_3, "line"), var_5_2)

	setActive = var_5

	local var_5_4 = arg_5_0._tf

	var_5(var_7.Find(var_5_4, "label"), var_5_2)

	setActive = var_5

	local var_5_5 = arg_5_0._tf

	var_5(var_7.Find(var_5_5, "way"), var_5_2)
