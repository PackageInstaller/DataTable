...
function var_0_1.OnDressUpdateItem(arg_5_0, arg_5_1, arg_5_2)
	...
	if var_5.island_dress_template[var_5_1.dress_id].icon ~= "" then
		...
		var_6(var_1_10008.format("island/IslandDressIcon/%s", var_5.icon), "", var_5_0:Find("icon"))
	end
	...
	if var_5.quality ~= 0 then
		...
		var_6(var_1_10008.format("island/IslandDressIcon/%s", var_0_2[var_5.quality]), "", var_5_0:Find("frame"))
	end
	...
	GetImageSpriteFromAtlasAsync = var_1_10007

	var_1_10007("island/IslandShipIcon/" .. var_5_2, "", var_5_0:Find("shipHold/ship_icon"))
