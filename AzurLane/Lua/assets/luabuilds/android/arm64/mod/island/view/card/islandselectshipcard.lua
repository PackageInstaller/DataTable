...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	var_2(var_1_4, var_5("island_ship_no_energy"))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5, arg_2_6)
	...
	local var_2_0 = var_1_10007(var_1_10009)
	...
	var_1_10008("ShipYardIcon/" .. var_2_3, "", arg_2_0.iconTF)

	local var_2_4 = arg_2_0.ship
	local var_2_5 = var_8.GetAttr

	IslandShipAttr = var_11

	local var_2_6 = var_2_5(var_2_4, var_11.ATTRS[arg_2_0.attrType])

	IslandProductTimeHelper = var_9

	if var_9.GetAttributeAddPercentByAttribute(arg_2_2, arg_2_0.attrType) ~= 0 then
		math = var_2_4
		var_2_6 = var_2_4.floor(var_2_6 * (1 + 0.01 * var_9)) or var_2_6
	end
	...
	for iter_2_0, iter_2_1 in var_11(arg_2_0.attrTfList) do
		if iter_2_1 ~= "" then
	...
	shortenString = iter_2_1

	local var_2_13 = arg_2_0.ship

	var_12(var_2_12, iter_2_1(var_17.GetName(var_2_13), 5))
	...
	var_2_14(arg_2_0.energySliderTF, 0, 1, var_2_15 / var_2_17)

	setText = var_2_14

	var_2_14(arg_2_0.energyTF, var_2_15 .. "/" .. var_2_17)
	...
	if arg_2_6 then
		...
		for iter_2_2, iter_2_3 in var_2_16(arg_2_6) do
...
function var_0_0.UpdateFollowMask(arg_3_0)
	...
	var_1_10002(arg_3_0.followMaskTF, var_3_3)
	...
	if not var_3_3 then
		...
		var_3_6 = not var_5.IsDelegable(var_3_5)
	else
		var_3_6 = false
	end
...
function var_0_0.UpdateSelected(arg_4_0, arg_4_1)
	...
	var_1_10002(var_4_0, var_1_10005.contains(arg_4_0.selectedIds, arg_4_0.id))
...
function var_0_0.UpdateSkillEffective(arg_5_0, arg_5_1, arg_5_2)
	...
	var_1_10004(arg_5_0.skillInuse, var_5_0)

	setActive = var_1_10004

	var_1_10004(arg_5_0.skillUnuse, not var_5_0)
