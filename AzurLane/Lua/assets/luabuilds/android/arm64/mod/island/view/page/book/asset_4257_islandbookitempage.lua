...
function var_0_1.OnLoaded(arg_4_0)
	...
	local var_4_1 = var_3.Find(var_4_0, "top/title/Text")

	i18n = var_1_10004

	var_1_10001(var_4_1, var_1_10004("island_guide"))

	setText = var_1_10001

	local var_4_2 = arg_4_0._tf
	local var_4_3 = var_3.Find(var_4_2, "top/title/Text/en")

	i18n = var_4

	var_1_10001(var_4_3, var_4("island_guide_en"))
	...
	var_1(var_3.Find(var_4_5, "tpl"), false)
	...
	var_1(var_4_14, var_4("island_guide_do_active"))
	...
	local var_4_17 = var_3.Find(var_4_16, "Text")

	i18n = var_4

	var_1(var_4_17, var_4("island_guide_collectionpoint"))
	...
	setmetatable = var_4_16
	arg_4_0.awardListBox = var_4_27(var_4_28, var_4_29, var_4_16({
...
function var_0_1.OnInit(arg_8_0)
	...
	local function var_8_6()
		...
		if #var_0.GetCanUnlockIds(var_10_0) > 0 then
			...
			var_10_2(var_10_1, var_2_10004.UNLOCK_ILLUSTRATION, var_0)
		end
	...
	local function var_8_9()
		...
		local var_11_2 = var_11_1(var_11_0, var_2_10003(var_2_10005))
		...
		var_11_4(var_11_3, var_3.GET_COLLECT_POINT, arg_8_0.canGetPointIds)
	...
	local function var_8_12()
		...
		local var_12_2 = var_12_1(var_12_0, var_2_10003(var_2_10005))
	...
	var_1_10001(var_8_10, var_8_11, var_8_12, var_8_1)
	...
	local function var_8_15()
		...
		var_13_4(var_13_3, var_3.GET_POINT_AWARD, arg_8_0.curLevelId)
	...
	var_1_10001(var_8_13, var_8_14, var_8_15, var_8_1)

	onButton = var_1_10001

	local var_8_16 = arg_8_0
	local var_8_17 = arg_8_0._tf
	local var_8_18 = var_4.Find(var_8_17, "top/help")
	...
	local function var_8_19()
		...
		var_14_2.type = var_2_10004.TYPE_WHITOUT_BTN

		local var_14_3 = arg_8_0

		var_14_2.content = var_4.GetHelpTip(var_14_3)
		i18n = var_4
		var_14_2.title = var_4("island_guide_character_help")
	...
	var_1_10001(var_8_16, var_8_18, var_8_19, var_8_17)
...
function var_0_1.AddListeners(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10004.ISLAND_UNLOCK_ILLUSTRATION_DONE, arg_15_0.OnUnlockDone)
	...
	var_15_3(var_15_2, var_4.ISLAND_GET_COLLECT_POINT_DONE, arg_15_0.Flush)
	...
	var_15_5(var_15_4, var_4.ISLAND_GET_POINT_AWARD_DONE, arg_15_0.OnGetPointAwardDone)
...
function var_0_1.RemoveListeners(arg_16_0)
	...
	var_16_1(var_16_0, var_1_10004.ISLAND_UNLOCK_ILLUSTRATION_DONE, arg_16_0.OnUnlockDone)
	...
	var_16_3(var_16_2, var_4.ISLAND_GET_COLLECT_POINT_DONE, arg_16_0.Flush)
	...
	var_16_5(var_16_4, var_4.ISLAND_GET_POINT_AWARD_DONE, arg_16_0.OnGetPointAwardDone)
...
function var_0_1.OnInitItem(arg_17_0, arg_17_1)
	...
	var_17_1(var_17_2, var_17_3, var_17_4, var_1_10008)
...
function var_0_1.GetCanUnlockIds(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10002(arg_21_0.showList) do
		local var_21_1 = iter_21_1:GetStatus()

		IslandIllustration = var_1_10008

		if var_21_1 == var_1_10008.STATUS.CAN_UNLOCK then
			table = var_21_1

			var_21_1.insert(var_21_0, iter_21_1.id)
		end
	end
...
function var_0_1.Flush(arg_24_0)
	...
	var_24_3(var_24_4, var_4({
		function(arg_25_0)
			local var_25_0 = arg_25_0:GetStatus()

			IslandIllustration = var_2_10002

			return var_25_0 == var_2_10002.STATUS.CAN_UNLOCK and 0 or 1
		end,
		function(arg_26_0)
			pg = var_2_10001
...
function var_0_1.FlushRightPanel(arg_28_0)
	...
	var_1_10002(var_28_2, var_5.GetName(var_28_3))
	...
	var_1_10002(var_28_4, var_5.GetEnName(var_28_5))

	IslandIllustration = var_1_10002

	if var_28_1 == var_1_10002.STATUS.UNLOCK then
		local var_28_6 = arg_28_0.showIllustration

		if not var_28_0.GetDesc(var_28_6) then
			i18n = var_28_0
			var_28_0 = var_28_0("island_guide_lock_desc")
		end

		setText = var_28_4

		var_28_4(arg_28_0.rightDescTF, var_28_0)

		setActive = var_28_4

		local var_28_7 = arg_28_0.unlockBtn

		IslandIllustration = var_7

		var_28_4(var_28_7, var_28_1 == var_7.STATUS.CAN_UNLOCK)
...
function var_0_1.FlushOnlyItem(arg_29_0)
	local var_29_0 = arg_29_0:GetIllustrationType()

	IslandIllustration = var_1_10002

	local var_29_1 = var_29_0 == var_1_10002.TYPES.ITEM

	setActive = var_2

	var_2(arg_29_0.rightProgressTF, var_29_1)

	if var_29_1 then
		local var_29_2 = arg_29_0.showIllustration
		local var_29_3 = var_2.GetHistoryCnt(var_29_2)
		local var_29_4 = arg_29_0.showIllustration
		local var_29_5 = var_3.GetCurTarget(var_29_4)

		setText = var_29_2

		local var_29_6 = arg_29_0.rightProgressTF
		local var_29_7

		if not var_29_5 or not (var_29_3 .. "/" .. var_29_5) then
			var_29_7 = var_29_3
		end

		var_29_2(var_29_6, var_29_7)
	end
...
function var_0_1.FlushPointAwardInfos(arg_30_0)
	...
	var_2(var_30_3, var_5("island_book_collection_award_title", arg_30_0.awardConfig.level))
	...
	var_30_6(arg_30_0.gotAllPointAwardTF, var_30_8)

	setActive = var_30_6

	var_30_6(arg_30_0.getPointAwardBtn, not var_30_8 and arg_30_0.curPoint >= arg_30_0.targetPoint)

	Drop = var_30_6

	local var_30_9 = var_30_6.Create(arg_30_0.awardConfig.award_display)

	GetImageSpriteFromAtlasAsync = var_30_7

	var_30_7(var_30_9:getIcon(), "", arg_30_0.pointAwardIcon)
...
function var_0_1.FlushPointInfos(arg_31_0)
	...
	for iter_31_0, iter_31_1 in var_1(arg_31_0.showList) do
		local var_31_0 = iter_31_1:GetStatus()

		IslandIllustration = var_1_10007

		if var_31_0 == var_1_10007.STATUS.UNLOCK and iter_31_1:IsTip() then
			table = var_6
