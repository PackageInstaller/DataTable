...
function var_0_0.OnAttach(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.animator = var_1_2(var_1_1, var_6(var_1_10008))
	...
	arg_1_0.characterHandleController = var_3(var_1_3, var_6(var_1_10008))
...
function var_0_0.LoadInteractiveTool(arg_6_0, arg_6_1)
	...
	if not var_3(var_6_0) then
		...
		var_6_1(var_6_2, var_6.Character3D)
	...
	local var_6_5 = var_6_2.Instantiate(var_6_4)
	...
	local var_6_9 = var_6_6(var_6_7, var_6_8, var_1_10010(var_1_10012))
	...
	var_7(var_6_10, var_10(var_1_10012)).runtimeAnimatorController = var_6_9
	setParent = var_6_7

	var_6_7(arg_6_0.objTfList[arg_6_0.currentToolId], arg_6_0._tf)

	pg = var_6_7

	local var_6_11 = var_6_7.ViewUtils.SetLayer
	local var_6_12 = arg_6_0.objTfList[arg_6_0.currentToolId]

	Layer = var_11

	var_6_11(var_6_12, var_11.Character3D)
...
function var_0_0.StateEnterFixHandle(arg_9_0, arg_9_1, arg_9_2)
	...
	if arg_9_1 == var_0_1 and var_9_0 and arg_9_0.objTfList[var_9_0] then
		...
		var_9_1(var_9_2, var_1_10007.Character3D)
	end
...
function var_0_0.StateExitFixHandle(arg_10_0, arg_10_1, arg_10_2)
	...
	if arg_10_1 == var_0_1 and var_10_0 and arg_10_0.objTfList[var_10_0] then
		...
		var_10_1(var_10_2, var_1_10007.Default)
	end
