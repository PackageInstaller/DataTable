...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.countTxt = var_1_3(var_1_2, var_5(var_1_10007))
	findTF = var_2
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local var_2_0 = var_1_10004(var_1_10006)
	...
	var_2_6.type = var_1_10009
	var_2_6.id = arg_2_2.id
	var_2_6.count = arg_2_2:GetCount()

	local var_2_7 = var_2_5(var_2_6)

	updateCustomDrop = var_2_3

	var_2_3(arg_2_0.itemTr, var_2_7)

	setActive = var_2_3

	var_2_3(arg_2_0.countTr, true)

	setScrollText = var_2_3

	var_2_3(arg_2_0.nameTF, arg_2_2:GetName())
	...
	var_7(var_2_8, var_10.contains(var_2_4, arg_2_0.itemId))
