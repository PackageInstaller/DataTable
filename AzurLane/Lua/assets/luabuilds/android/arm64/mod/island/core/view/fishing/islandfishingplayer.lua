...
function var_0_1.PlayCastAnimation(arg_5_0, arg_5_1)
	...
	IslandFishingAnimator = var_1_10005

	var_5_1(var_5_0, var_1_10005.STATE_THROW, 0.25, arg_5_1)
...
function var_0_1.PlayHookedAnimation(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10004.STATE_HOOKED, 0.25)
...
function var_0_1.PlayMovementAnimation(arg_7_0)
	...
	var_7_1(var_7_0, var_1_10004.STATE_MOVEMENT, 0)
...
function var_0_1.PlayHookEndAnimation(arg_8_0, arg_8_1)
	...
	var_8_1(var_8_0, var_1_10005.STATE_HOOKED_5, 0.25, arg_8_1)
...
function var_0_1.PlayHookMiddleAnimation(arg_9_0)
	...
	var_9_1(var_9_0, var_1_10004.STATE_HOOKED_3, 0)
...
function var_0_1.PlayCancelAnimation(arg_10_0, arg_10_1)
	...
	var_10_1(var_10_0, var_1_10005.STATE_CANCEL, 0.25, arg_10_1)
...
function var_0_1.PlayFailAnimation(arg_11_0, arg_11_1)
	...
	var_11_1(var_11_0, var_1_10005.STATE_FAIL, 0.25, arg_11_1)
...
function var_0_1.TurnToFishPoistion(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_2 = var_12_1(var_12_0, var_1_10006.UNIT_LIST_FISH_POINT, arg_12_1)

	assert = var_1_10004

	var_1_10004(var_12_2, "unit should be exist>>>." .. arg_12_1)
...
function var_0_1.LoadFishRodModel(arg_13_0, arg_13_1)
	...
	var_3.GetFishRod(var_13_1, var_13_0.model, var_13_0.animator, function(arg_14_0)
		...
		var_14_0.fishRodAnimator = var_14_2(var_14_1, var_2_10005(var_2_10007))

		local var_14_3 = arg_14_0
		local var_14_4 = arg_14_0.GetComponent

		typeof = var_14_1
		FishingLineVerlet = var_2_10006

		if var_14_4(var_14_3, var_14_1(var_2_10006)) then
			local var_14_5 = arg_13_0.effectMgr

			var_2.SetFishHook(var_14_5, var_1.hook)
		end

		setParent = var_2

		var_2(arg_14_0, arg_13_0.player._tf)
...
function var_0_1.LoadFishModel(arg_16_0, arg_16_1)
	...
	var_4.GetFish(var_16_2, var_16_1.model, var_16_1.animator, function(arg_17_0)
		...
		typeof = var_2_10005
		Animator = var_2_10007
		var_17_0.fishAnimator = var_17_2(var_17_1, var_2_10005(var_2_10007))
		setParent = var_17_0

		local var_17_3 = arg_17_0
		local var_17_4 = arg_16_0.fishRodAnimator.gameObject.transform

		var_17_0(var_17_3, var_4.Find(var_17_4, "all/fish_bone/fish1_mount"))
		arg_16_1()
