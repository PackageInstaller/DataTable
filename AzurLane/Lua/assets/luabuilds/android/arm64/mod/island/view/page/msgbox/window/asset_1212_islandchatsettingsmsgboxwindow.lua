...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "send_channel/list")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uiSendChanncelList = var_2_0(var_2_2, var_4.Find(var_2_3, "send_channel/list/tpl"))
	UIItemList = var_1

	local var_2_4 = var_1.New
	local var_2_5 = arg_2_0._tf
	local var_2_6 = var_3.Find(var_2_5, "channels/list")
	local var_2_7 = arg_2_0._tf

	arg_2_0.uiChanncelList = var_2_4(var_2_6, var_4.Find(var_2_7, "send_channel/list/tpl"))
	...
	local var_2_10 = var_3.Find(var_2_9, "send_channel/Text")

	i18n = var_4

	var_1(var_2_10, var_4("notice_label_send"))

	setText = var_1

	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_3.Find(var_2_11, "channels/Text")

	i18n = var_4

	var_1(var_2_12, var_4("notice_label_recv"))

	setText = var_1

	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_3.Find(var_2_13, "room/Text")

	i18n = var_4

	var_1(var_2_14, var_4("notice_label_room"))

	setText = var_1

	local var_2_15 = arg_2_0._tf
	local var_2_16 = var_3.Find(var_2_15, "room/tip")

	i18n = var_4

	var_1(var_2_16, var_4("notice_label_tip"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		if arg_3_0.onYes then
			...
			var_4_1(var_4_2, var_4_3, var_2_10005(var_4_0))
		end
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			local function var_7_3()
				...
				if var_8_0 == var_3_10001.CHANNEL_GUILD then
					...
					local var_8_1 = var_8_0(var_3_10002)
			...
			var_4(var_7_1, var_7_2, var_7_3, var_2_10009)
...
function var_0_1.InitChannels(arg_9_0)
	...
	var_2.make(var_9_1, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			var_10_2(arg_10_2:Find("line"), not var_10_5 and not var_10_4)
		end
...
function var_0_1.FlushSendChannel(arg_12_0)
	...
	var_2.eachActive(var_12_1, function(arg_13_0, arg_13_1)
		...
		var_2_10004(arg_13_1.Find(var_13_1, "mark"), var_13_0)

		IslandChatConst = var_2_10004

		local var_13_2 = var_2_10004.CHANNEL2CN(var_2)

		setText = var_2_10005

		local var_13_3 = arg_13_1:Find("Text")

		setColorStr = var_13_1

		var_2_10005(var_13_3, var_13_1(var_13_2, var_13_0 and "#FFFFFF" or "#393a3c"))
	...
	var_2.eachActive(var_14_1, function(arg_15_0, arg_15_1)
		...
		if not (var_15_0 == var_4.CHANNEL_ALL) or not var_15_2 then
			...
			if not var_4 and not var_15_2 then
				...
				var_2_10006(arg_15_1.Find(var_15_3, "mark"), var_2_10005)

				IslandChatConst = var_2_10006

				local var_15_4 = var_2_10006.CHANNEL2CN(var_15_0)

				setText = var_2_10007

				local var_15_5 = arg_15_1:Find("Text")

				setColorStr = var_15_3

				var_2_10007(var_15_5, var_15_3(var_15_4, var_2_10005 and "#FFFFFF" or "#393a3c"))
...
function var_0_1.FlushRoom(arg_16_0)
	...
	var_1_10002(arg_16_0.roomInput, var_16_1)
