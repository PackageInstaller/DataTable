...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.prosperityTxt = var_2_10(var_2_9, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.prosperityLabel = var_2_13(var_2_12, var_4(var_1_10006))
	...
	var_1(var_3.Find(var_2_15, "edit"), false)
	...
	typeof = var_4
	Text = var_6
	arg_2_0.expPanelTxt = var_2_20(var_2_19, var_4(var_6))
	...
	typeof = var_4
	Animation = var_6
	arg_2_0.expAnimation = var_2_23(var_2_22, var_4(var_6))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_1(var_4_0, var_2_10003.OPEN_PAGE, "IslandSelfCardPage")
...
function var_0_1.UpdateIslandInfo(arg_7_0)
	...
	if var_7_1:CanAddProsperity() then
		arg_7_0.prosperityTxt.text = var_7_1:GetProsperity() .. "/" .. var_7_1:GetTargetProsperity()
	else
		arg_7_0.prosperityTxt.text = "MAX"
	end

	local var_7_2 = arg_7_0.prosperityLabel

	i18n = var_3
	var_7_2.text = var_3("island_prosperity_level")
...
function var_0_1.UpdateTip(arg_8_0)
	...
	var_1_10001(var_8_0, var_4.ShouldTip(var_8_1))
...
function var_0_1.ShowExp(arg_9_0)
	...
	var_9_2(var_4.Find(var_9_3, "effect"), false)
...
function var_0_1.ShowExpAdd(arg_11_0, arg_11_1, arg_11_2)
	...
	var_11_3(var_6.Find(var_11_4, "effect"), true)
