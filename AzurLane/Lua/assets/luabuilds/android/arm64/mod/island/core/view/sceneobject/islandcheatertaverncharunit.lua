...
function var_0_1.OnAttach(arg_1_0, arg_1_1)
	...
	arg_1_0.animator = var_1_2(var_1_1, var_5(var_1_10007.Animator))
...
function var_0_1.OnPlayerOut(arg_2_0, arg_2_1)
	if arg_2_1 then
		...
		var_2_0(var_2_1, var_1_10005.Default)
	end
...
function var_0_1.OnPlayerQuestion(arg_3_0)
	...
	var_3_1(var_3_2, var_1_10004.Default)
	...
	local function var_3_4()
		...
		var_4_0(var_4_1, var_2_10003.UIHidden)

		return
	end

	IslandCheaterTavernConst = var_4
	arg_3_0.questTimer = var_3_3(var_3_4, var_4.qusanimationTime, 1)
...
function var_0_1.OnPlayWinAnimation(arg_5_0)
	...
	var_5_1(var_5_2, var_1_10004.Default)
	...
	local function var_5_4()
		...
		var_6_0(var_6_1, var_2_10003.UIHidden)

		return
	end

	IslandCheaterTavernConst = var_4
	arg_5_0.winTimer = var_5_3(var_5_4, var_4.winAnimationTime, 1)
...
function var_0_1.InitDisplayState(arg_7_0)
	...
	if var_1:GetMainPlayer() then
		...
		if arg_7_0.seatId == var_2.seat then
			...
			var_7_3(var_7_4, var_1_10006.UIHidden)
		else
			pg = var_7_3
			...
			var_7_5(var_7_6, var_1_10006.Default)
		end
	end
