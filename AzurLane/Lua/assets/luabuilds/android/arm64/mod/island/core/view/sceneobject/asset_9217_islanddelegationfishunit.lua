...
local var_0_1 = var_0_10001("Framework.toLua.UnityEngine.Quaternion")
...
local var_0_3 = var_2(var_0_2, var_0_10005(".IslandSceneUnit"))

LayerMask = var_3

local var_0_4 = var_3.NameToLayer("IgnoreIslandCharacter")

bit = var_0_2

local var_0_5 = var_0_2.bnot

bit = var_0_10006

local var_0_6 = var_0_5(var_0_10006.lshift(1, var_0_4))
local var_0_7 = {
...
function var_0_3.OnAttach(arg_2_0, arg_2_1)
	...
	arg_2_0.animator = var_2_16(var_2_15, var_5(var_1_10007))
...
function var_0_3.SetFishPonds(arg_3_0, arg_3_1)
	...
	local var_3_2 = var_3_1(var_3_0, var_1_10005.UNIT_LIST_OBJ, arg_3_1)._go.transform
	local var_3_3 = var_3.GetComponent

	typeof = var_6
	FishPond = var_1_10008

	local var_3_4 = var_3_3(var_3_2, var_6(var_1_10008))
...
function var_0_3.GetRandomPoint(arg_4_0)
	...
	local var_4_5 = var_1_10005.random() * (var_4_3.x - var_4_1.x) + var_4_1.x

	math = var_6

	local var_4_6 = var_6.random() * (var_4_3.y - var_4_1.y) + var_4_1.y

	math = var_7

	return var_4_4(var_4_5, var_4_6, var_7.random() * (var_4_3.z - var_4_1.z) + var_4_1.z)
end
...
function var_0_3.Move(arg_7_0)
	...
	if var_2.normalized ~= var_0_0.zero then
		...
		local var_7_5 = arg_7_0.turnSpeed

		Time = var_1_10010
		var_7_2.rotation = var_7_3(var_7_4, var_1_10008, var_7_5 * var_1_10010.deltaTime)
	end
	...
	local var_7_7 = var_7_6 * var_7_2.Deg2Rad
...
function var_0_3.UpdateSpeed(arg_8_0)
	...
	local var_8_2 = var_8_0(var_8_1, var_1_10004.time * arg_8_0.noiseScale)

	Mathf = var_1_10002

	local var_8_3 = var_1_10002.Lerp(arg_8_0.minSpeed, arg_8_0.maxSpeed, var_8_2 * arg_8_0.noiseAmplitude)

	Mathf = var_8_1

	local var_8_4 = var_8_1.Lerp
	local var_8_5 = arg_8_0.currentSpeed
	local var_8_6 = var_8_3

	Time = var_1_10007
	arg_8_0.currentSpeed = var_8_4(var_8_5, var_8_6, var_1_10007.deltaTime * arg_8_0.speedChangeRate)
...
function var_0_3.SetNewTarget(arg_9_0)
	...
	local var_9_4 = var_9_1(var_9_2, var_9_3, var_1_10006.random())

	Mathf = var_1_10003

	local var_9_5 = var_1_10003.Lerp
	local var_9_6 = var_9_0.min.y
	local var_9_7 = var_9_0.max.y

	math = var_1_10007

	local var_9_8 = var_9_5(var_9_6, var_9_7, var_1_10007.random())

	Mathf = var_9_2

	local var_9_9 = var_9_2.Lerp
	local var_9_10 = var_9_0.min.z
	local var_9_11 = var_9_0.max.z

	math = var_1_10008

	local var_9_12 = var_9_9(var_9_10, var_9_11, var_1_10008.random())
...
function var_0_3.AvoidCollision(arg_10_0)
	...
	if var_10_4 and var_10_5 and var_10_5.collider then
		...
		Time = var_1_10016
		var_10_9.rotation = var_10_10(var_10_11, var_10_12, var_10_13 * var_1_10016.deltaTime)
...
function var_0_3.KeepInsideBounds(arg_11_0)
	...
	if not var_11_2 then
		if (arg_11_0.pond.center - var_11_1).normalized ~= var_0_0.zero then
			...
			Time = var_1_10012
			var_11_4.rotation = var_11_5(var_11_6, var_11_7, var_11_8 * var_1_10012.deltaTime)
		end
