...
function var_0_1.OnInit(arg_2_0, arg_2_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_2_0.agoraSaveCdTxt = var_2_9(var_2_8, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_2_0.capacityTxt = var_2_18(var_2_17, var_5(var_1_10007))
	...
	local var_2_24 = var_4.Find(var_2_23, "panel/main/bg/tags")
	local var_2_25 = arg_2_0._tf

	arg_2_0.tagUIItemList = var_2_22(var_2_24, var_5.Find(var_2_25, "panel/main/bg/tags/1_1"))
	...
	typeof = var_5
	Text = var_2_25
	arg_2_0.orderTxt = var_2_32(var_2_31, var_5(var_2_25))
	...
	arg_2_0.shapeSelectPanel = var_2_33(var_4.Find(var_2_34, "shapeTpl"))
	setText = var_2

	local var_2_35 = arg_2_0.agoraClearBtn
	local var_2_36 = var_4.Find(var_2_35, "Text")

	i18n = var_5

	var_2(var_2_36, var_5("island_agora_btn_label_clear"))

	setText = var_2

	local var_2_37 = arg_2_0.agoraRevertBtn
	local var_2_38 = var_4.Find(var_2_37, "Text")

	i18n = var_5

	var_2(var_2_38, var_5("island_agora_btn_label_revert"))

	setText = var_2

	local var_2_39 = arg_2_0.agoraSaveBtn
	local var_2_40 = var_4.Find(var_2_39, "Text")

	i18n = var_5

	var_2(var_2_40, var_5("island_agora_btn_label_save"))

	setText = var_2

	local var_2_41 = arg_2_0._tf
	local var_2_42 = var_4.Find(var_2_41, "top/title/Text")

	i18n = var_5

	var_2(var_2_42, var_5("island_agora_title"))

	setText = var_2

	local var_2_43 = arg_2_0._tf
	local var_2_44 = var_4.Find(var_2_43, "panel/main/bg/search/search/holder")

	i18n = var_5

	var_2(var_2_44, var_5("island_agora_label_search"))

	setText = var_2

	local var_2_45 = arg_2_0._tf
	local var_2_46 = var_4.Find(var_2_45, "panel/main/bg/theme/unsel/Text")

	i18n = var_5

	var_2(var_2_46, var_5("island_agora_label_theme"))

	setText = var_2

	local var_2_47 = arg_2_0._tf
	local var_2_48 = var_4.Find(var_2_47, "panel/main/bg/theme/sel/Text")

	i18n = var_5

	var_2(var_2_48, var_5("island_agora_label_theme"))

	setText = var_2

	local var_2_49 = arg_2_0.emptyTr
	local var_2_50 = var_4.Find(var_2_49, "empty_1/Text")

	i18n = var_5

	var_2(var_2_50, var_5("island_agora_label_empty_tip"))
	...
	typeof = var_5
	Animation = var_7
	arg_2_0.anim = var_2_52(var_2_51, var_5(var_7))
	...
	typeof = var_5
	DftAniEvent = var_7
	arg_2_0.dftAniEvent = var_2_54(var_2_53, var_5(var_7))
	...
	typeof = var_5
	Animation = var_7
	arg_2_0.panelAnim = var_2_57(var_2_56, var_5(var_7))
	arg_2_0.cards = {}
	arg_2_0.themeCards = {}
	arg_2_0.indexData = {
		tag = 1,
	...
	local var_2_60 = var_5.Find(var_2_59, "top/title/help")
	...
	local function var_2_61()
		...
		pg = var_2_10004
		var_3_2.helps = var_2_10004.gametip.island_help_renovation.tip
	...
	var_2(var_2_58, var_2_60, var_2_61, var_2_59)
...
function var_0_1.TriggerTag(arg_9_0, arg_9_1)
	...
	local var_9_1 = arg_9_0.GetView(var_9_0).agora

	if not var_3.GetPlaceableItem(var_9_1, arg_9_1) then
		return
	end

	table = var_9_0

	local var_9_2 = var_9_0.indexof

	AgoraFurnitureType = var_6

	local var_9_3 = var_9_2(var_6.PLACEMENT_TYPE, var_3:GetType())

	if 0 < var_9_3 then
		triggerToggle = var_5

		var_5(arg_9_0.toggles[var_9_3], true)
	end
...
function var_0_1.RegisterEvent(arg_12_0)
	...
	var_12_0(var_12_1, var_12_2, var_12_3, var_1_10006)
	...
	local function var_12_6()
		...
		i18n = var_2_10004
		var_18_2.content = var_2_10004("island_agora_clear_tip")
	...
	var_12_0(var_12_4, var_12_5, var_12_6, var_1_10006)
	...
	local function var_12_9()
		...
		i18n = var_2_10004
		var_20_2.content = var_2_10004("island_agora_revert_tip")
	...
	var_12_0(var_12_7, var_12_8, var_12_9, var_1_10006)
	...
	local function var_12_12()
		...
		var_22_7.type = var_2_10007.TYPE_AGORA_PLACED_LIST
	...
	var_12_0(var_12_10, var_12_11, var_12_12, var_1_10006)
	...
	local function var_12_15()
		...
		if var_0.CheckChange(var_23_2) then
			...
			var_0.PlayExitAnim(var_23_4, function()
				...
				local var_24_3 = var_3.OPEN_PAGE

				IslandShopPage = var_3_10004

				var_24_2(var_24_1, var_24_3, var_3_10004, {
					1,
					2,
					3,
					4,
	...
	var_12_0(var_12_13, var_12_14, var_12_15, var_1_10006)
	...
	var_12_0(var_12_16, var_12_17, var_12_18, var_1_10006)
	...
	var_12_0(arg_12_0, arg_12_0.searchInput, function()
		...
		var_2_10001(arg_12_0.searchClearBtn, var_27_0 ~= "")
	...
	var_12_0(var_12_19, var_12_20, var_12_21, var_1_10006)
	...
	var_12_0(var_12_22, var_12_23, var_12_24, var_1_10006)
	...
	var_12_0(var_12_25, var_12_26, var_12_27, var_1_10006)
	...
	var_1(var_12_28, var_12_29, var_12_30, var_1_10006)
	...
	var_1(var_12_31, var_12_32, var_12_33, var_1_10006)
...
function var_0_1.TrySave(arg_34_0)
	...
	if not var_1.CanEnterEditMode(var_34_1) then
		...
		var_34_4.type = var_1_10006.TYPE_AOGRA_SAVE_CD

		local var_34_5 = arg_34_0:GetView()

		var_34_4.duetime = var_6.GetController(var_34_5).editCdTime
...
function var_0_1.Save(arg_36_0)
	if arg_36_0:TrySave() then
		...
		i18n = var_1_10005
		var_36_2.content = var_1_10005("island_agora_save_or_exit_tip")
		i18n = var_5
		var_36_2.noText = var_5("island_agora_exit_and_unsave")
		i18n = var_5
		var_36_2.yesText = var_5("island_agora_exit_and_save")
...
function var_0_1.InitTags(arg_41_0)
		...
		if arg_42_0 == var_2_10003.EventUpdate then
			...
			local function var_42_3(arg_43_0)
				if arg_43_0 then
					...
					ISLAND_AGORA_EVT = var_3_10005

					var_43_1(var_43_0, var_43_2, var_3_10005.TAG_CHANGE, var_42_0)
			...
			var_4(var_42_1, var_42_2, var_42_3, var_2_10009)

			setText = var_4

			local var_42_4 = arg_42_2:Find("sel/Text")

			AgoraFurnitureType = var_42_2

			var_4(var_42_4, var_42_2.Type2CN(var_42_0))
	...
	var_41_2(var_41_1, #var_4.PLACEMENT_TYPE)
	...
	var_41_2(var_41_3, var_41_4, var_41_5, var_1_10006)
...
function var_0_1.OnInitItem4Theme(arg_45_0, arg_45_1)
	...
	local function var_45_3()
		...
		AgoraSystemTheme = var_2_10003

		if var_2_10000(var_46_0, var_2_10003) then
			IslandMsgBox = var_2_10001

			if not var_2_10001.TYPE_SYSTEM_THEME then
				IslandMsgBox = var_2_10001
				var_2_10001 = var_2_10001.TYPE_THEME
			end
	...
	var_1_10003(var_45_1, var_45_2, var_45_3, var_1_10008)
	...
	local function var_45_6()
		...
		if not var_1.GetUseableThemeId(var_49_1) then
			...
			local var_49_2 = var_49_0.TipsMgr.GetInstance()

			var_49_0 = var_49_0.ShowTips
			i18n = var_2_10005

			var_49_0(var_49_2, var_2_10005("island_agora_no_pos_place"))
		...
		var_49_0({
			...
			function()
				...
				var_51_3.type = var_3_10004.TYPE_SAVE_THEME
				var_51_3.id = var_0
	...
	var_1_10003(var_45_4, var_45_5, var_45_6, var_1_10008)
...
function var_0_1.PrepareToTakeScreenshot(arg_53_0)
	...
	var_53_1(var_53_0, var_1_10004.AGORA_CAMERA_SHOOTSCREEN_NAME)
...
function var_0_1.ShootScreen(arg_54_0, arg_54_1, arg_54_2)
	...
	var_1_10006.Rendering.HotUpdate.ScreenShooterPass.TakePhoto(var_54_0, function(arg_55_0)
		local var_55_0
		local var_55_1, var_55_2

		if arg_55_0.width < var_54_1 or arg_55_0.height < var_54_2 then
			var_55_0 = arg_55_0
		else
			var_55_1 = arg_55_0.width * 0.5 - var_54_1 * 0.5
			var_55_2 = arg_55_0.height * 0.5 - var_54_2 * 0.5

			local var_55_3 = arg_55_0:GetPixels(var_55_1, var_55_2, var_54_1, var_54_2)

			UnityEngine = var_2_10005

			local var_55_4 = var_2_10005.Texture2D.New(var_54_1, var_54_2)

			var_55_0.SetPixels(var_55_4, var_55_3)
			var_55_0:Apply()
		end

		Tex2DExtension = var_55_1

		local var_55_5 = var_55_1.EncodeToJPG(var_55_0)

		AgoraCalc = var_55_2

		local var_55_6 = var_55_2.BuildScreenShootSavePath(arg_54_1)

		PathMgr = var_4

		if var_4.FileExists(var_55_6) then
			System = var_4

			var_4.IO.File.Delete(var_55_6)
		end

		System = var_4

		var_4.IO.File.WriteAllBytes(var_55_6, var_55_5)
		arg_54_2()
...
function var_0_1.RevertTakeScreenshot(arg_56_0)
	...
	var_56_1(var_56_0, var_1_10004.AGORA_CAMERA_NAME)
...
function var_0_1.GetDisplays(arg_70_0)
	...
	for iter_70_0, iter_70_1 in var_70_0(var_70_1) do
		...
		local var_70_4 = var_70_2[iter_70_1.configId]

		var_9.AddItem(var_70_4, iter_70_1)
	end
	...
	for iter_70_2, iter_70_3 in var_5(var_70_2) do
		if iter_70_3:IsType(arg_70_0.indexData.tag) and iter_70_3:IsMatchSearch(arg_70_0.indexData.searchKey) then
			...
			var_10.insert(var_70_5, iter_70_3)
		end
	end

	local var_70_6
	local var_70_7 = arg_70_0.indexData.sortKey

	AgoraFurnitureType = var_7

	if var_70_7 == var_7.SORT_DEFAULT then
		var_70_6 = {
			function(arg_71_0)
	...
	local var_70_8 = var_70_7.sort
	local var_70_9 = var_70_5

	CompareFuncs = iter_70_3

	var_70_8(var_70_9, iter_70_3(var_70_6))
...
function var_0_1.FlushCapacity(arg_83_0)
	...
	i18n = var_83_2
	var_83_4.text = var_83_2("island_agora_capacity") .. ":<color=#a0ff9d>" .. var_83_1 .. "</color>/" .. var_83_3
...
function var_0_1.AddSaveCdTimer(arg_85_0, arg_85_1)
	...
	arg_85_0.saveCdTimer = var_85_1.New(function()
		...
		if arg_85_1 - var_86_1 <= 0 then
			...
			local var_86_3 = arg_85_0

			var_1.FlushSaveBtn(var_86_3)
		else
			local var_86_4 = arg_85_0.agoraSaveCdTxt

			pg = var_2

			local var_86_5 = var_2.TimeMgr.GetInstance()

			var_86_4.text = var_2.DescCDTimeForMinute(var_86_5, arg_85_1 - var_86_1)
		end
