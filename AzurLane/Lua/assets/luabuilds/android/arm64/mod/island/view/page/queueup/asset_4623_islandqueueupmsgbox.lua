...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1(var_2_5, var_4("island_msg_info"))

	setText = var_1

	local var_2_6 = arg_2_0._tf
	local var_2_7 = var_3.Find(var_2_6, "frame/cancel/Text")

	i18n = var_4

	var_1(var_2_7, var_4("island_cancel_queue"))
...
function var_0_1.AddTimer(arg_7_0, arg_7_1)
	...
	arg_7_0.timer = var_7_0(var_7_1, var_1_10005.QUEUE_UP_REFRESH_TIME, -1)
...
function var_0_1.Send(arg_9_0, arg_9_1)
	...
	var_2.Send(var_9_0, 21208, {
		...
		if arg_10_0.result == 0 then
			...
			var_10_2(var_10_1, var_2_10004.ISLAND_GET_DATA, {
		...
		elseif arg_10_0.result == 6 then
			...
			var_10_5(var_10_4, var_2_10004[arg_10_0.result] .. arg_10_0.result)
		end
