...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.timeTxt = var_2_3(var_2_2, var_4(var_1_10006))
	...
	local var_2_9 = var_3.Find(var_2_8, "mask/content")
	local var_2_10 = arg_2_0.bannerTF

	arg_2_0.scrollSnap = var_2_7(var_2_9, var_4.Find(var_2_10, "dots"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_6()
		...
		var_5_1(var_5_0, var_2_10003.PLAY_ROOM_MATCH_STOP)
...
function var_0_1.InitBanner(arg_8_0)
	...
	for iter_8_0 = 0, #var_1 - 1 do
		...
		SFX_MAIN = var_1_10013

		var_8(var_8_3, var_8_4, var_8_5, var_1_10013)
	end
...
function var_0_1.OnShow(arg_10_0)
	...
	var_10_1(var_10_0, var_1_10004.DEVIEE_STATE_CHANGE, true)
	...
	if var_10_1.instance then
		...
		var_10_3(var_10_2, var_4.FOCUS_CAMERA_NAME)
	end
...
function var_0_1.Flush(arg_11_0)
	...
	local var_11_1 = #arg_11_0.GetBannerDisplays(var_11_0) ~= 0

	setActive = var_11_0

	var_11_0(arg_11_0.bannerEmptyTF, not var_11_1)

	setActive = var_11_0

	var_11_0(arg_11_0.bannerTF, var_11_1)

	if var_11_1 then
		if #arg_11_0.banners ~= #var_1 then
			local var_11_2 = arg_11_0.scrollSnap

			var_3.Reset(var_11_2)
			arg_11_0:InitBanner()
		else
			local var_11_3 = arg_11_0.scrollSnap

			var_3.Resume(var_11_3)
		end
	end
...
function var_0_1.OnHide(arg_18_0)
	...
	var_18_1(var_18_0, var_1_10004.DEVIEE_STATE_CHANGE, false)
	...
	if var_18_1.instance then
		...
		var_18_3(var_18_2, var_4.FOLLOW_CAMERA_NAME)
	end
...
function var_0_1.GetBannerDisplays(arg_22_0)
	...
	local var_22_0 = var_1_10001(var_1_10003.island_banner.all)
...
function var_0_1.BannerSkip(arg_25_0, arg_25_1)
	...
	var_25_1(var_25_0, var_1_10005.BuildIslandDeviceBanner(arg_25_1.id))

	local var_25_2 = arg_25_1.type

	IslandConst = var_1_10003

	if var_25_2 == var_1_10003.BANNER_TYPE_OPEN_URL then
		...
		if var_25_3 == var_3.BANNER_TYPE_SWITCH_MAP then
			...
			arg_25_0.Hide(var_25_0)

			var_25_0 = arg_25_0

			local var_25_4 = arg_25_0.emit

			IslandBaseMediator = var_25_5
			var_25_5 = var_25_5.SWITCH_MAP
			unpack = var_1_10006

			var_25_4(var_25_0, var_25_5, var_1_10006(arg_25_1.param))
		else
			local var_25_6 = arg_25_1.type

			IslandConst = var_3

			if var_25_6 == var_3.BANNER_TYPE_OPEN_PAGE then
				var_25_0 = arg_25_0
				...
				local var_25_7 = arg_25_0.emit

				IslandMediator = var_25_5

				var_25_7(var_25_0, var_25_5.OPEN_PAGE, arg_25_1.param[1], arg_25_1.param[2])
			else
				local var_25_8 = arg_25_1.type

				IslandConst = var_3

				if var_25_8 == var_3.BANNER_TYPE_SURVEY then
					getProxy = var_25_8
					ActivityProxy = var_25_0

					local var_25_9 = var_25_8(var_25_0)
					local var_25_10, var_25_11 = var_2.isSurveyOpen(var_25_9)

					getProxy = var_25_9
					ActivityProxy = var_1_10006

					local var_25_12 = var_25_9(var_1_10006)
					local var_25_13 = var_4.isSurveyDone(var_25_12)
					...
					if var_25_10 then
						...
						if not var_25_5 then
							...
							var_25_5 = arg_25_0.emit
							IslandMediator = var_1_10008

							var_25_5(var_25_14, var_1_10008.OPEN_PAGE, arg_25_1.param[1], arg_25_1.param[2])
					...
					local var_25_15 = var_25_5.TipsMgr.GetInstance()
					local var_25_16 = var_5.ShowTips

					i18n = var_1_10008

					var_25_16(var_25_15, var_1_10008("common_activity_not_start"))
				end
			end
		end
	end
