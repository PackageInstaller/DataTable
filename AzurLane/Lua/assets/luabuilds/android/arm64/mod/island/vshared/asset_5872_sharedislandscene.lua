...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("..View.base.IslandBaseScene"))
...
function var_0_1.init(arg_3_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.levelTxt = var_3_2(var_3_1, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.nameTxt = var_3_6(var_3_5, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.prosperityTxt = var_3_9(var_3_8, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.prosperityLabel = var_3_12(var_3_11, var_4(var_1_10006))
	...
	local var_3_16 = var_3.Find(var_3_15, "Text")

	i18n = var_4

	var_1(var_3_16, var_4("island_leave"))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_4.Find(var_4_1, "top/level_panel")

	local function var_4_3()
		local var_5_0 = arg_4_0
		local var_5_1 = var_0.OpenPage

		SharedIslandOtherCardPage = var_2_10003

		local var_5_2 = arg_4_0

		var_5_1(var_5_0, var_2_10003, var_4.GetIsland(var_5_2).id)
	...
	local function var_4_6()
		...
		SharedIslandMapPage = var_2_10003
	...
	local function var_4_9()
		...
		SharedIslandMediator = var_2_10003

		var_7_1(var_7_0, var_2_10003.RETURN_SELF_ISLAND)
...
function var_0_1.UpdateIslandInfo(arg_10_0)
	...
	if var_10_0:CanAddProsperity() then
		arg_10_0.prosperityTxt.text = var_10_0:GetProsperity() .. "/" .. var_10_0:GetTargetProsperity()
	else
		arg_10_0.prosperityTxt.text = "MAX"
	end

	local var_10_1 = arg_10_0.prosperityLabel

	i18n = var_3
	var_10_1.text = var_3("island_prosperity_level")
