...
function var_0_1.GetDefaultFoundation(arg_2_0)
	...
	if var_1_10001.island_set.island_pre_placement.key_value_varchar[1] then
		...
		local var_2_2 = var_1_10004.GetUniqueId(var_2_0, 1)
...
function var_0_1.GetDefaultBuilding(arg_3_0)
	...
	if var_1_10001.island_set.island_default_building.key_value_varchar[1] then
		...
		BuildVector3 = var_1_10005

		local var_3_2 = var_3_1(var_1_10005(var_1[2]))

		AgoraCalc = var_1_10004

		local var_3_3 = var_1_10004.GetUniqueId(var_3_0, 1)
...
function var_0_1.CheckReloadFinish(arg_5_0)
	...
	if var_1.IsLoaded(var_5_1) then
		...
		var_5_3(var_5_2, var_1_10004.RELOADING_FINISH)
...
function var_0_1.SetUp(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10004.START_LOAD_ITEMS)
	...
	local var_6_4 = var_4.MAP_SIZE_UPDATE
	local var_6_5 = arg_6_0.agora

	var_6_3(var_6_2, var_6_4, var_5.GetSize(var_6_5))
	...
	if var_6_6 then
		...
		local var_6_7 = arg_6_0.PlaceItem
		local var_6_8 = var_6_6.id

		var_1_10008 = var_6_6

		local var_6_9 = var_6_6.GetPosition(var_1_10008)

		Vector3 = var_6_5

		var_6_7(var_6_4, var_6_8, var_6_9, var_6_5.zero)
	end
	...
	if not arg_6_0.placedData.building then
		var_6_4 = arg_6_0
		var_6_10 = arg_6_0.GetDefaultBuilding(var_6_4)
	end

	if var_6_10 then
		local var_6_11 = arg_6_0
		local var_6_12 = arg_6_0.PlaceItem
		local var_6_13 = var_6_10.id

		var_1_10009 = var_6_10

		local var_6_14 = var_6_10.GetPosition(var_1_10009)

		Vector3 = var_1_10008

		var_6_12(var_6_11, var_6_13, var_6_14, var_1_10008.zero)
	end
	...
	for iter_6_0, iter_6_1 in var_6_4(arg_6_0.placedData.placedlist) do
		table = var_1_10009

		var_1_10009.insert(var_6_15, function(arg_7_0)
			local var_7_0 = arg_6_0
			local var_7_1 = var_1.PlaceItem
			local var_7_2 = iter_6_1.id
			local var_7_3 = iter_6_1
			local var_7_4 = var_5.GetPosition(var_7_3)
			local var_7_5 = iter_6_1

			var_7_1(var_7_0, var_7_2, var_7_4, var_6.GetRotation(var_7_5))
	...
	var_4(var_6_15, function()
		local var_8_0 = arg_6_0
		local var_8_1 = var_0.NotifiyAgora

		ISLAND_AGORA_EVT = var_2_10003

		local var_8_2 = var_2_10003.END_LOAD_ITEMS
		local var_8_3 = var_6_10

		var_8_1(var_8_0, var_8_2, var_4.GetPosition(var_8_3))
...
function var_0_1.InitSyncMgr(arg_10_0)
	...
	var_10_1(var_10_0, var_10_2, var_5.GetAllVirtualInteractUnitData(var_10_3))
...
function var_0_1.EnterEditMode(arg_17_0)
	if not arg_17_0:CanEnterEditMode() then
		...
		var_17_1(var_17_0, var_1_10004.ENTER_EDIT_FAILED)
	...
	var_17_5(var_17_4, var_1_10004.ENTER_EDIT)
	...
	var_17_7(var_17_6, var_4.ENTER_EDIT_AGORA)
...
function var_0_1.ExitEditMode(arg_18_0)
	...
	var_18_2(var_18_1, var_1_10004.EXIT_EDIT)
	...
	var_18_4(var_18_3, var_4.EXIT_EDIT_AGORA)
...
function var_0_1.Save(arg_20_0, arg_20_1)
	...
	var_20_6(var_20_5, var_1_10008.SAVE_AGORA, var_20_2, var_20_3, var_20_4)
	...
	local var_20_9 = var_1_10006.TimeMgr.GetInstance()
...
function var_0_1.SaveTheme(arg_21_0, arg_21_1, arg_21_2)
	...
	if #var_21_1 <= 0 and #var_21_2 <= 0 and #var_21_3 <= 0 then
		...
		var_21_5(var_21_4, var_1_10009("island_agora_deco_empty"))
	...
	var_21_7(var_21_6, var_1_10009.SAVE_AGORA_THEME, {
		id = arg_21_1,
		name = arg_21_2,
		updateList = var_21_1,
		floorList = var_21_2,
...
function var_0_1.ApplyTheme(arg_22_0, arg_22_1, arg_22_2)
	if arg_22_2 then
		...
		ISLAND_AGORA_EVT = var_1_10007

		var_22_4(var_22_3, var_1_10007.START_LOAD_ITEMS)

		local var_22_5 = {}
		local var_22_6 = var_22_2:GetPlacedData()

		ipairs = var_22_3

		for iter_22_0, iter_22_1 in var_22_3(var_22_6) do
			table = var_1_10011
			...
			var_1_10011.insert(var_22_5, function(arg_23_0)
				...
				if var_1.IsFoundationType(var_23_0) then
					...
					if var_1.IsBuildingType(var_23_2) then
						...
						local var_23_8 = var_5.GetPosition(var_23_7)
						local var_23_9 = iter_22_1

						var_23_5(var_23_4, var_23_6, var_23_8, var_6.GetRotation(var_23_9))
					end
				end
		...
		local var_22_7 = var_22_2:GetFloorData()

		ipairs = var_7

		for iter_22_2, iter_22_3 in var_7(var_22_7) do
		...
		local var_22_8 = var_22_2:GetTileData()

		ipairs = var_8

		for iter_22_4, iter_22_5 in var_8(var_22_8) do
		...
		var_8(var_22_5, function()
			...
			var_26_1(var_26_0, var_2_10003.END_LOAD_ITEMS)
...
function var_0_1.DeleteTheme(arg_27_0, arg_27_1)
	...
	var_27_1(var_27_0, var_1_10005.DEL_AGORA_THEME, arg_27_1)
...
function var_0_1.ClearPlaced(arg_29_0, arg_29_1)
	if arg_29_1 then
		...
		for iter_29_0, iter_29_1 in var_1_10002(var_4.GetPlacedlist(var_29_0)) do
		...
		for iter_29_2, iter_29_3 in var_1_10002(var_4.GetPlacedlist(var_29_1)) do
...
function var_0_1.ClearFloorLayer(arg_30_0)
	...
	for iter_30_0, iter_30_1 in var_1_10001(var_3.GetFloorLayer(var_30_0)) do
		pairs = var_1_10006
...
function var_0_1.ClearTileLayer(arg_31_0)
	...
	for iter_31_0, iter_31_1 in var_1_10001(var_3.GetTileLayer(var_31_0)) do
		pairs = var_1_10006
...
function var_0_1.Revert(arg_33_0)
	...
	AgoraDataComparator = var_1_10010

	if var_33_9(var_33_10, var_1_10010.CHANGE_TYPE_PLACED) > 0 then
		...
		for iter_33_0, iter_33_1 in var_7(var_33_5) do
			...
			var_1_10012.insert(var_33_8, function(arg_34_0)
				...
				local var_34_4 = var_5.GetPosition(var_34_3)
				local var_34_5 = iter_33_1

				var_34_1(var_34_0, var_34_2, var_34_4, var_6.GetRotation(var_34_5), arg_34_0)
	...
	AgoraDataComparator = var_10

	if var_33_11(var_33_12, var_10.CHANGE_TYPE_FLOOR) > 0 then
	...
	AgoraDataComparator = iter_33_2

	if var_33_13(var_33_14, iter_33_2.CHANGE_TYPE_TILE) > 0 then
...
function var_0_1.Upgrade(arg_37_0)
	...
	var_37_1(var_37_0, var_1_10004.UPGRADE_AGORA)
...
function var_0_1.SelectItem(arg_41_0, arg_41_1)
	...
	var_41_3(var_41_2, var_1_10006.SELECTED_ITEM, arg_41_0.selectedData.id, var_41_1)
...
function var_0_1.ConfirmSelectedItem(arg_42_0)
	...
	if not var_2.IsEmptyArea(var_42_2, var_42_1) then
		...
		var_42_4(var_42_3, var_5("island_agora_pos_unavailability"))
	...
	var_42_7(var_42_6, var_1_10006.CONFIRM_SELECTED_ITEM, var_42_5)
...
function var_0_1.UnSelectedItem(arg_43_0)
	...
	var_43_2(var_43_1, var_1_10005.ITEM_CLEAR_OCCUPIED, var_43_0)
	...
	var_43_11(var_43_10, var_7.UNSELECTED_ITEM, var_43_0, var_43_8)
...
function var_0_1.BeginDragItem(arg_44_0)
	...
	var_44_3(var_44_2, var_1_10005.DRAG_ITEM_BEGIN, var_44_1)
...
function var_0_1.DragItem(arg_45_0, arg_45_1)
	...
	var_45_2(var_45_1, var_6.ClampRange(var_45_3, arg_45_1.x, arg_45_1.y, var_2))
	...
	ISLAND_AGORA_EVT = var_45_3

	var_45_8(var_45_7, var_45_3.DRAG_ITEM, arg_45_0.selectedData.id, var_45_6)
	...
	if var_5.GetItemInArea(var_45_9, var_2:GetMapType(), var_45_4) then
		...
		var_45_11(var_45_10, var_9.ITEM_OCCUPIED, var_5.id)
	else
		...
		var_45_13(var_45_12, var_9.ITEM_CLEAR_OCCUPIED, var_2.id)
	end
...
function var_0_1.EndDragItem(arg_46_0, arg_46_1)
	...
	var_46_3(var_46_2, var_6.DRAG_ITEM_END, var_46_1)
...
function var_0_1.AgoraVirtualInterAction(arg_48_0, arg_48_1, arg_48_2, arg_48_3)
	...
	if not var_4.GetEmptySlot(var_48_1) then
		...
		local var_48_2 = var_48_0.TipsMgr.GetInstance()
		local var_48_3 = var_6.ShowTips

		i18n = var_1_10009

		var_48_3(var_48_2, var_1_10009("island_agora_no_interact_point"))
	...
	local function var_48_4()
		...
		var_49_2(var_49_1, var_3.START_INTERACTION, var_0, var_0, arg_48_3)
	...
	var_48_6(var_48_5, var_1_10010.SYNC_TYPE_AGORA, arg_48_1, var_5.id, arg_48_3, function(arg_50_0)
		if arg_50_0 then
			var_48_4()
		end
...
function var_0_1.AgoraVirtualInterActionSync(arg_51_0, arg_51_1, arg_51_2, arg_51_3, arg_51_4)
	...
	ISLAND_AGORA_EVT = var_10

	var_51_4(var_51_3, var_10.START_INTERACTION, var_5, var_6, arg_51_3)
...
function var_0_1.AgoraVirtualInterActionEnd(arg_52_0, arg_52_1, arg_52_2)
	...
	local function var_52_3()
		...
		ISLAND_AGORA_EVT = var_2_10004

		var_53_3(var_53_2, var_2_10004.END_INTERACTION, var_0, var_53_0)
	...
	var_52_5(var_52_4, var_1_10009.SYNC_TYPE_AGORA, arg_52_1, var_52_2.id, function(arg_54_0)
		if arg_54_0 then
			var_52_3()
		end
...
function var_0_1.AgoraVirtualInterActionEndSync(arg_55_0, arg_55_1, arg_55_2)
	...
	local var_55_3 = var_55_0(var_55_2)
	...
	ISLAND_AGORA_EVT = var_1_10009

	var_55_5(var_55_4, var_1_10009.END_INTERACTION, var_3, var_55_3)
...
function var_0_1.AgoraVirtualInitStatus(arg_56_0, arg_56_1, arg_56_2)
	...
	var_56_2(var_56_1, var_1_10007.WORLD_OBJECT_INIT_STATUS, var_3, arg_56_2)
...
function var_0_1.PlaceItemRandonPosition(arg_57_0, arg_57_1)
	...
	if var_4.IsMaxCapacityWhenAdd(var_57_3, var_57_2) then
		...
		var_57_4(var_57_3, var_7("island_agora_max_capacity"))
	...
	if not var_57_4.GetCenterMapPos() then
		...
		local var_57_5 = var_57_1.TipsMgr.GetInstance()
		local var_57_6 = var_5.ShowTips

		i18n = var_1_10008

		var_57_6(var_57_5, var_1_10008("island_agora_no_size"))
	...
	if not var_5.FindEmptyArea4Item(var_57_7, var_4, var_2) then
		...
		local var_57_8 = var_57_3.TipsMgr.GetInstance()
		local var_57_9 = var_6.ShowTips

		i18n = var_9

		var_57_9(var_57_8, var_9("island_agora_no_size"))
	...
	var_57_11(var_57_10, var_57_12, var_57_13, var_1_10011.zero)
...
function var_0_1.RemovePlaceItem(arg_59_0, arg_59_1)
	...
	var_59_1(var_59_0, var_5.UNPLACE_ITEM)
...
function var_0_1.ReplaceBuilding(arg_61_0, arg_61_1)
	...
	local var_61_3 = var_1_10003.zero
	...
	var_61_5(var_61_4, var_61_6, var_61_7, var_1_10009.zero)
...
function var_0_1.ReplaceFoundation(arg_62_0, arg_62_1)
	...
	local var_62_3 = var_1_10003.zero
	...
	var_62_5(var_62_4, var_62_6, var_62_7, var_1_10009.zero)
...
function var_0_1.RevertPaveLayer(arg_73_0)
	...
	for iter_73_0, iter_73_1 in var_73_2(arg_73_0.toUpdateTileList) do
		pairs = var_1_10010
...
function var_0_1.AddListeners(arg_78_0)
	...
	IslandAgoraAgency = var_1_10004

	var_78_1(var_78_0, var_1_10004.AGORA_UPGRADE, arg_78_0.OnAgoraUpdate)
	...
	var_78_3(var_78_2, var_4.GIFT_CNT_UPDATE, arg_78_0.OnSignInGiftCntUpdate)
	...
	var_78_5(var_78_4, var_4.SIGN_CNT_UPDATE, arg_78_0.OnSignCntUpdate)

	local var_78_6 = arg_78_0
	local var_78_7 = arg_78_0.AddIslandListener

	IslandAgoraAgency = var_4

	var_78_7(var_78_6, var_4.ADD_THEME, arg_78_0.OnThemeAdded)
	...
	var_78_9(var_78_8, var_4.DEL_THEME, arg_78_0.OnThemeDeleted)
	...
	var_78_11(var_78_10, var_4.PLACEMENT_UPDATE, arg_78_0.OnPlacementUpdate)
	...
	var_78_13(var_78_12, var_4.ADD_FURNITURE, arg_78_0.OnFurnitureAdded)
...
function var_0_1.RemoveListeners(arg_79_0)
	...
	var_79_1(var_79_0, var_1_10004.AGORA_UPGRADE, arg_79_0.OnAgoraUpdate)
	...
	var_79_3(var_79_2, var_4.GIFT_CNT_UPDATE, arg_79_0.OnSignInGiftCntUpdate)
	...
	var_79_5(var_79_4, var_4.SIGN_CNT_UPDATE, arg_79_0.OnSignCntUpdate)
	...
	var_79_7(var_79_6, var_4.ADD_THEME, arg_79_0.OnThemeAdded)
	...
	var_79_9(var_79_8, var_4.DEL_THEME, arg_79_0.OnThemeDeleted)
	...
	var_79_11(var_79_10, var_4.PLACEMENT_UPDATE, arg_79_0.OnPlacementUpdate)
	...
	var_79_13(var_79_12, var_4.ADD_FURNITURE, arg_79_0.OnFurnitureAdded)
...
function var_0_1.ClearAllNew(arg_81_0)
	...
	for iter_81_0, iter_81_1 in var_1_10002(var_81_1) do
		iter_81_1:ClearNew()
	end
...
function var_0_1.OnFurnitureAdded(arg_82_0, arg_82_1)
	for iter_82_0 = 1, arg_82_1.count do
		...
		local var_82_0 = arg_82_0.agora

		var_8.AddPlaceable(var_82_0, var_1_10007)
	end
...
function var_0_1.OnPlacementUpdate(arg_83_0, arg_83_1)
	...
	local var_83_12, var_83_13, var_83_14 = var_83_8.GetChangePlacementList(var_83_3, var_83_11)

	ipairs = var_12

	for iter_83_0, iter_83_1 in var_12(var_83_13) do
	...
	ISLAND_AGORA_EVT = var_17

	var_83_23(var_83_22, var_17.RELOADING)
	...
	var_83_25(var_83_24, var_17.GetAllVirtualInteractUnitData(var_83_26))
...
function var_0_1.OnSignCntUpdate(arg_86_0, arg_86_1)
	...
	var_86_3(var_86_2, var_1_10006.REFRESH_INTERACTION)
	...
	var_86_5(var_86_4, var_6.SIGN_IN_CNT_UPDATE, arg_86_1)
...
function var_0_1.OnAgoraUpdate(arg_88_0, arg_88_1, arg_88_2)
	...
	var_88_2(var_88_1, var_1_10007(var_88_0, var_88_0))
...
function var_0_1.CreateAgora(arg_89_0, arg_89_1)
	...
	local var_89_1 = arg_89_1.GetAgoraAgency(var_89_0)
	local var_89_2 = {}

	ipairs = var_89_0

	for iter_89_0, iter_89_1 in var_89_0(var_89_1:GetFurnitures()) do
		for iter_89_2 = 1, iter_89_1.count do
			AgoraCalc = var_1_10013
			var_1_10013 = var_1_10013.GetUniqueId(iter_89_1.id, iter_89_2)
			AgoraFurniture = var_1_10014
			var_89_2[var_1_10014.New({
				id = var_1_10013,
	...
	local var_89_3 = var_4.New(var_89_1:GetPlacedData(), var_89_2)
	local var_89_4, var_89_5, var_89_6 = var_4.GetSeparatedPlacedData(var_89_3)
	local var_89_7 = var_4:GetFloorData()
	local var_89_8 = var_4
	local var_89_9 = var_4.GetTileData(var_89_8)
	local var_89_10 = {}

	ipairs = var_89_8

	for iter_89_3, iter_89_4 in var_89_8(var_89_1:GetThemes()) do
		AgoraTheme = var_1_10016
		var_1_10016 = var_1_10016.New(iter_89_4, var_89_2)
		table = var_1_10017

		var_1_10017.insert(var_89_10, var_1_10016)
	end
	...
	for iter_89_5, iter_89_6 in var_12(var_89_1:GetSystemThemes()) do
		AgoraSystemTheme = var_1_10017
		var_1_10017 = var_1_10017.New(iter_89_6)
		table = var_1_10018

		var_1_10018.insert(var_89_11, var_1_10017)
	end

	local var_89_12 = var_89_1
	local var_89_13 = var_89_1.GetLevel(var_89_12)

	math = var_13

	local var_89_14 = var_13.clamp
	local var_89_15 = var_89_13
	local var_89_16 = 1

	IslandConst = var_1_10017

	local var_89_17 = var_89_14(var_89_15, var_89_16, #var_1_10017.AGORA_LEVEL_2_SIZE)

	IslandConst = var_89_12

	local var_89_18 = var_89_12.AGORA_LEVEL_2_SIZE[var_89_17]
	local var_89_19 = var_89_1:GetCapacity()

	Agora = var_89_16

	local var_89_20 = var_89_16.New
	local var_89_21 = {}

	Vector2 = var_1_10019
	var_89_21.size = var_1_10019(var_89_18, var_89_18)
	var_89_21.placeableList = var_89_2
	var_89_21.capacity = var_89_19
	var_89_21.themes = var_89_10
	var_89_21.systemThemes = var_89_11

	return var_89_20(var_89_21), {
		placedlist = var_89_4,
		foundation = var_89_5,
		building = var_89_6,
		placedFloor = var_89_7,
		placedTile = var_89_9
	}
end
