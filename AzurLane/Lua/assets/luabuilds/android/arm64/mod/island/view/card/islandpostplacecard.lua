...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_4 = var_4.Find(var_1_3, "items")
	local var_1_5 = arg_1_0._tf

	arg_1_0.itemUIList = var_1_2(var_1_4, var_5.Find(var_1_5, "items/tpl"))
	...
	local var_1_9 = var_4.Find(var_1_8, "ships")
	local var_1_10 = arg_1_0._tf

	arg_1_0.shipUIList = var_1_7(var_1_9, var_5.Find(var_1_10, "ships/tpl"))
...
function var_0_0.Update(arg_4_0, arg_4_1, arg_4_2)
	...
	for iter_4_0, iter_4_1 in var_5(var_4_4) do
		...
		var_1_10011(var_4_5, var_1_10014.island_production_commission[iter_4_1].slot)
...
function var_0_0.UpdateSlot(arg_5_0, arg_5_1)
	...
	var_5_2(var_5_1, var_5_3, var_7.Find(var_5_4, var_5_0))
	...
	var_5_6(var_5_5, var_5_7, var_7.Find(var_5_8, var_5_0))
...
function var_0_0.UpdateSlotItem(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_0.buildingData then
		var_1_10005 = arg_6_0.buildingData
		var_6_0 = var_3.GetDelegationSlotData(var_1_10005, arg_6_1)
	end
	...
	if var_6_0 then
		...
		var_1_10005(arg_6_2:Find("unlock/add"), not var_6_2)

		setActive = var_1_10005

		local var_6_3 = arg_6_2

		var_1_10005(arg_6_2.Find(var_6_3, "unlock/formula"), var_6_2)

		if var_6_2 then
			pg = var_1_10005

			local var_6_4 = var_1_10005.island_formula[var_6_2].commission_product[1][1]
			...
			DROP_TYPE_ISLAND_ITEM = var_6_3
			var_6_5.type = var_6_3
			var_6_5.id = var_6_4

			local var_6_6 = var_6_1(var_6_5)

			var_6_1 = var_6_1.getConfigTable(var_6_6).icon
			LoadImageSpriteAsync = var_7

			var_7("island/" .. var_6_1, arg_6_2:Find("unlock/formula/icon"))
		end

		local var_6_7 = var_6_0:GetSlotRoleData()

		setActive = var_6_1

		var_6_1(arg_6_2:Find("unlock/formula/get"), not var_6_7)

		if var_6_7 then
			arg_6_0:AddTimer(arg_6_2, var_6_0)
		else
			local var_6_8 = arg_6_2:Find("unlock/formula/fill")

			var_6_1 = var_6_1.GetComponent
			typeof = var_9
			Image = var_11
			var_6_1 = var_6_1(var_6_8, var_9(var_11))
			var_6_1.fillAmount = 1
		end

		onButton = var_6_1

		local var_6_9 = arg_6_0
		local var_6_10 = arg_6_2
		...
		var_6_1(var_6_9, var_6_10, var_6_11, var_11)
	else
...
function var_0_0.UpdateSlotShip(arg_8_0, arg_8_1, arg_8_2)
	...
	if arg_8_0.buildingData then
		var_1_10005 = arg_8_0.buildingData
		var_8_0 = var_3.GetDelegationSlotData(var_1_10005, arg_8_1)
	end
	...
	if var_8_0 then
		...
		var_1_10005(arg_8_2:Find("unlock/add"), not var_1_10004)

		setActive = var_1_10005

		var_1_10005(arg_8_2:Find("unlock/ship"), var_1_10004)

		if var_1_10004 then
			IslandShip = var_1_10005
			var_1_10005 = var_1_10005.StaticGetPrefab(var_1_10004.ship_id)
			LoadImageSpriteAsync = var_8_1

			var_8_1("squareicon/" .. var_1_10005, arg_8_2:Find("unlock/ship/mask/icon"))
		end
		...
		var_1_10005(var_8_2, var_8_3, var_8_4, var_10)
	else
...
function var_0_0.AddTimer(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_2 = var_10_1(var_10_0, var_6(var_1_10008))
	...
	local function var_10_3()
		...
		var_0(var_2.Find(var_11_1, "unlock/formula/get"), true)
	...
	local var_10_4 = var_10_0.New(function()
		local var_12_0 = arg_10_2

		if not var_0.GetSlotRoleData(var_12_0) then
			var_10_3()
		else
			local var_12_1 = var_0:InCurrentTime()

			pg = var_12_0

			local var_12_2 = var_12_0.TimeMgr.GetInstance()
			local var_12_3 = var_2.GetServerTime(var_12_2) - var_0:InCurrentTimeStart(var_12_1)

			var_10_2.fillAmount = var_12_3 / var_0:CurrentTimeNeed(var_12_1)
		end
