...
function var_0_1.AddListeners(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10004.ISLAND_GET_DELEGATION_AWARD_DONE, arg_2_0.OnGetDelegationAwardDone)
	...
	var_2_3(var_2_2, var_4.ISLAND_FINISH_DELEGATION_DONE, arg_2_0.OnFinishDelegationDone)
	...
	var_2_5(var_2_4, var_4.ISLAND_START_DELEGATION_DONE, arg_2_0.OnDelegationStartDone)
	...
	var_2_7(var_2_6, var_4.ISLAND_USE_TICKET_DONE, arg_2_0.OnUseTicketDone)
...
function var_0_1.RemoveListeners(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10004.ISLAND_GET_DELEGATION_AWARD_DONE, arg_3_0.OnGetDelegationAwardDone)
	...
	var_3_3(var_3_2, var_4.ISLAND_FINISH_DELEGATION_DONE, arg_3_0.OnFinishDelegationDone)
	...
	var_3_5(var_3_4, var_4.ISLAND_START_DELEGATION_DONE, arg_3_0.OnDelegationStartDone)
	...
	var_3_7(var_3_6, var_4.ISLAND_USE_TICKET_DONE, arg_3_0.OnUseTicketDone)
...
function var_0_1.OnLoaded(arg_4_0)
	...
	arg_4_0.delegationList = var_4_3(var_4_4, var_4.Find(var_4_5, "tpl"))
	...
	arg_4_0.delegationTabList = var_4_8(var_4_9, var_4.Find(var_4_10, "tpl"))
	...
	arg_4_0.selectPanel = var_4_12(var_4_13, var_4_14, var_1_10005({
		alignRight = true,
		isPermanent = true,
...
function var_0_1.OnInit(arg_8_0)
	...
	local function var_8_2()
		...
		var_9_2(var_9_1, var_2_10003.FOLLOW_CAMERA_NAME)
	...
	local var_8_5 = var_4.Find(var_8_4, "top/title/help")
	...
	local function var_8_6()
		...
		pg = var_2_10004
		var_10_2.helps = var_2_10004.gametip.island_help_commission.tip
	...
	var_1(var_8_3, var_8_5, var_8_6, var_8_4)
...
function var_0_1.InitPlaceCfg(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1(var_1_10003.island_production_place.all) do
		pg = var_1_10006
...
function var_0_1.InitDelegationTabItem(arg_12_0, arg_12_1, arg_12_2)
	...
	var_1_10003(var_12_0, var_12_1, var_12_2, var_1_10008)
...
function var_0_1.InitDelegationItem(arg_14_0, arg_14_1, arg_14_2)
	...
	var_1_10003(var_14_0, var_14_1, var_14_2, var_1_10008)
...
function var_0_1.UpdateDelegationItem(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_4 = var_1_10007.island_world_objects[var_16_1.birthplace].param.rotation
	...
	var_16_7(arg_16_2.Find(var_16_8, "unselect"), false)

	local var_16_9 = arg_16_1 + 1
	local var_16_10 = arg_16_0.placeCommissionList[var_16_9]

	pg = var_12

	local var_16_11 = var_12.island_production_commission[var_16_10].slot

	getProxy = var_16_8
	IslandProxy = var_1_10016

	local var_16_12 = var_16_8(var_1_10016)
	local var_16_13 = var_14.GetIsland(var_16_12)
	local var_16_14 = var_14.GetBuildingAgency(var_16_13)
	local var_16_15 = var_15.GetBuilding(var_16_14, arg_16_0.placeId)
	local var_16_16 = var_15.GetDelegationSlotData(var_16_15, var_16_11)

	setButtonEnabled = var_16_14

	var_16_14(arg_16_2, var_16_16 ~= nil)

	local var_16_17 = arg_16_1 + 1
	local var_16_18 = arg_16_0
	local var_16_19 = arg_16_0.emitCore

	ISLAND_EVT = var_1_10021

	var_16_19(var_16_18, var_1_10021.SELECTDELEEFFECT_SHOW, var_16_17, arg_16_0.selectedIdx, var_16_3, var_16_5)
...
function var_0_1.UpdateDelegationTabItem(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_2 = var_1_10005.island_production_commission[var_20_1].slot

	getProxy = var_7
	IslandProxy = var_9

	local var_20_3 = var_7(var_9)
	...
	var_20_5(arg_20_2:Find("lock"), not var_20_7)

	setActive = var_20_5

	local var_20_8 = arg_20_2

	var_20_5(arg_20_2.Find(var_20_8, "slotName"), var_20_7)

	setButtonEnabled = var_20_5

	var_20_5(arg_20_2, var_20_7 ~= nil)

	if arg_20_0.selectedIdx == var_20_0 then
		local var_20_9 = arg_20_0.selectPanel

		var_10.ExecuteAction(var_20_9, "Flush")
	end
	...
	if not var_20_7 then
		...
		var_10(arg_20_2.Find(var_20_8, "complete "), false)

		setActive = var_10
		var_20_8 = arg_20_2

		var_10(arg_20_2.Find(var_20_8, "product_icon"), false)

		return
	end

	local var_20_10 = var_20_7:GetSlotRoleData()
	local var_20_11 = var_20_7
	local var_20_12 = var_20_7.GetSlotRewardData(var_20_11)
	local var_20_13 = var_20_10 == nil and var_20_12 ~= nil

	setActive = var_20_11

	var_20_11(arg_20_2:Find("complete "), var_20_13)

	local var_20_14

	if not var_20_10 or not var_20_10.formula_id then
		var_20_14 = nil
	end

	var_20_14 = var_20_14 or var_20_12 and var_20_12.formula_id or nil

	if var_20_14 then
		setActive = var_20_8

		var_20_8(arg_20_2:Find("product_icon"), true)

		pg = var_20_8
		var_20_8 = var_20_8.island_formula[var_20_14]
		pg = var_15

		local var_20_15 = var_15.island_item_data_template[var_20_8.item_id]

		GetImageSpriteFromAtlasAsync = var_16

		var_16("island/" .. var_20_15.icon, "", arg_20_2:Find("product_icon"))
	else
		setActive = var_20_8

		var_20_8(arg_20_2:Find("product_icon"), false)
	end
...
function var_0_1.OnShow(arg_22_0, arg_22_1, arg_22_2)
	...
	var_3(var_5.Find(var_22_1, "top/title/Text"), arg_22_0.placeCfg.name)

	setText = var_3

	local var_22_2 = arg_22_0._tf

	var_3(var_5.Find(var_22_2, "top/title/Text/en"), "PRODUCTING")
...
function var_0_1.OnHide(arg_24_0)
	...
	var_24_1(var_24_0, var_1_10004.RECYCLE_ALL_SLOTDELEEFFECT)
...
function var_0_1.OnExit(arg_25_0)
	...
	var_25_2(var_25_1, var_1_10004.FOLLOW_CAMERA_NAME)
...
function var_0_1.LoadPreconcenCharacter(arg_34_0, arg_34_1)
	...
	var_34_8(var_34_7, var_1_10010.LOAD_DELEGATE_PREVIEW_ROLE, var_34_4:GetModel(), var_34_6)
...
function var_0_1.UnloadPreconcenCharacter(arg_35_0)
	...
	var_35_1(var_35_0, var_1_10004.UN_LOAD_DELEGATE_PREVIEW_ROLE)
