...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.titleTxt = var_2_4(var_2_3, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.levelTxt = var_2_7(var_2_6, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.nextLevelTxt = var_2_10(var_2_9, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.descTxt = var_2_13(var_2_12, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.nextDescTxt = var_2_16(var_2_15, var_4(var_1_10006))
	UIItemList = var_1

	local var_2_17 = var_1.New
	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_3.Find(var_2_18, "frame_2/item_bg/items")
	local var_2_20 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_17(var_2_19, var_4.Find(var_2_20, "frame_2/item_bg/items/tpl"))
	setText = var_1

	local var_2_21 = arg_2_0._tf
	local var_2_22 = var_3.Find(var_2_21, "frame_2/sub_title/Text")

	i18n = var_4

	var_1(var_2_22, var_4("island_skill_consume_title"))
	...
	var_1(var_2_24, var_4("island_chara_up_button"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_8()
		...
		var_6_2(var_6_1, var_2_10003.SHIP_SKILL_UPGRADE, arg_3_0.ship.id)
...
function var_0_1.AddListeners(arg_7_0)
	...
	var_7_1(var_7_0, var_1_10004.ISLAND_SHIP_SKILL_UPGRADE_DONE, arg_7_0.OnSkillUpgrade)
...
function var_0_1.RemoveListeners(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10004.ISLAND_SHIP_SKILL_UPGRADE_DONE, arg_8_0.OnSkillUpgrade)
...
function var_0_1.OnShow(arg_10_0, arg_10_1)
	...
	local var_10_1 = var_1_10003(var_10_0)

	var_3.Upgrade(var_10_1)
	arg_10_0:UpdateMain(var_10_0, var_3)
...
function var_0_1.UpdateMain(arg_11_0, arg_11_1, arg_11_2)
	...
	var_3(var_11_0, not var_6.CanUpgradeSkill(var_11_1), true)
...
function var_0_1.UpdateConsume(arg_12_0, arg_12_1)
	...
	local var_12_3 = var_3.GetInventoryAgency(var_12_2)
	...
	var_4.make(var_12_4, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_2_10003.EventUpdate then
			...
			if var_13_0.count <= var_13_2 then
				...
				local var_13_4 = var_2_10005(var_13_3, var_8)

				setText = var_13_1

				var_13_1(arg_13_2:Find("icon_bg/count_bg/count"), var_13_4 .. "/" .. var_13_0.count)
