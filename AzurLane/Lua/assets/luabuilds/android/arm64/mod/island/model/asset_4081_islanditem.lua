...
function var_0_1.GetNumberOfSlotsOccupied(arg_2_0)
	...
	if arg_2_0:getConfig("group_max") == 0 then
		return 1
	else
		math = var_2

		return var_2.ceil(arg_2_0.count / var_1)
	end
...
function var_0_1.IsInvitationLetter(arg_9_0)
	...
	IslandItemUsage = var_1_10002

	return var_9_0 == var_1_10002.usage_island_invitation
end
...
function var_0_1.IsFishingProp(arg_20_0)
	...
	return var_20_0 == var_1_10002.usage_fishing
end
