...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_5.CanReplace(var_1_5) then
		pg = var_1_7
		...
		var_1_7(var_1_6, var_1_10009("island_order_cant_replace"))
	...
	var_6.Send(var_1_8, 21403, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2(var_2_1, var_2_10004.ISLAND_REPLACE_ORDER_DONE, {
				slotId = var_1_1
			})
		else
			pg = var_2_2
