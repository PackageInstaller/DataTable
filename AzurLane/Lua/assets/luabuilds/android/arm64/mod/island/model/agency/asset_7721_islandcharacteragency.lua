...
function var_0_1.OnInit(arg_1_0, arg_1_1)
	...
	for iter_1_6, iter_1_7 in var_3(arg_1_1.ship_sys.skin_list) do
		...
		for iter_1_8, iter_1_9 in var_9(iter_1_7.skin_list) do
			...
			IslandShipSkin = var_1_10017

			var_1_10014(var_1_7, var_1_10017.New(iter_1_9))
		end
	...
	for iter_1_10, iter_1_11 in var_3(var_1_8) do
		...
		IslandShipDressItem = iter_1_8

		var_1_10(var_1_11, iter_1_8.New(iter_1_11))
...
function var_0_1.CanFollowPlayer(arg_4_0, arg_4_1)
	...
	if 0 < var_4_2 then
		...
		local var_4_4 = arg_4_0.GetHost(var_4_3)

		var_4_5 = var_5.GetTaskAgency(var_4_4)
		_ = var_4_3
		var_4_1 = var_4_3.any(var_4_0, function(arg_5_0)
			local var_5_0 = var_4_5

			return var_1.GetTask(var_5_0, arg_5_0) ~= nil
		end)
	end

	local var_4_6 = var_2:GetState()

	IslandShip = var_4_5

	return var_4_6 == var_4_5.STATE_NORMAL and not var_4_1
end
...
function var_0_1.GetUnlockOrCanUnlockShipConfigIds(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10002(var_1_10004.island_chara_template.all) do
...
function var_0_1.GetUnlockOrCanUnlockShipConfigIdsContainNpc(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10002(var_1_10004.island_chara_template.all) do
	...
	CompareFuncs = iter_18_0

	var_18_1(var_18_2, iter_18_0({
		function(arg_19_0)
...
function var_0_1.AddSkin(arg_23_0, arg_23_1)
	...
	IslandShipSkin = var_1_10007

	var_23_2(var_23_3, var_1_10007.New({
		color_id = 0,
		id = arg_23_1,
		color_list = {}
	}))
...
function var_0_1.GetDressIdRealCount(arg_30_0, arg_30_1)
	...
	for iter_30_0, iter_30_1 in var_1_10003(arg_30_0.shipWearDressData) do
		ipairs = var_1_10008
...
function var_0_1.ChargeDressOnShip(arg_44_0, arg_44_1, arg_44_2)
	...
	IslandShipDressItem = var_1_10007

	var_44_1(var_44_2, var_1_10007.New({
		ship_id = arg_44_1,
		dress_id = arg_44_2
	}))
