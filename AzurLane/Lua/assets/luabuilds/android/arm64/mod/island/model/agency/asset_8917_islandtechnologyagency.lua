...
function var_0_1.OnInit(arg_1_0, arg_1_1)
	...
	for iter_1_2, iter_1_3 in var_4(var_6.island_technology_template.all) do
		...
		if var_1_10009.IsOnceType(var_1_2) then
			...
			table = var_1_10013
			var_1_10013 = var_1_10013.contains(var_1_0, iter_1_3) and 1 or 0

			var_1_4(var_1_3, var_1_10013)
		else
		...
		var_1_7[var_1_10009.GetFormulaId(var_1_10013)] = var_1_10009.id
	end
...
function var_0_1.GetAllTypeFinishCnt(arg_13_0)
	...
	return var_13_0(var_1_10003.island_technology_template.all, 0, function(arg_14_0, arg_14_1)
...
function var_0_1.GetEmptySlotId(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10002(var_0_1.GetSlotIds()) do
		...
		var_1_10008.insert(var_17_0, function(arg_18_0)
			...
			if not var_1.IsUnlock(var_18_0) then
				...
				if var_1.CanUnlock(var_18_1) then
					...
					var_18_3(var_18_2, var_2_10004.ISLAND_UNLOCK_TECH, {
						techId = iter_17_1,
						callback = arg_18_0
					})
...
function var_0_1.IsTip(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_20_2(var_20_4) do
