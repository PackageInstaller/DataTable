...
function var_0_1.ExecuteDelegation(arg_4_0, arg_4_1)
	...
	var_4_1[var_1_10006.FisheryPlaceId] = function()
...
function var_0_1.ExecuteDelegateFish(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in var_1_10005(var_6_2) do
		...
		if var_6_4(var_6_3, var_1_10013.UNIT_LIST_DELEGATE_UNIT, iter_6_1) then
			var_1_10013 = var_10

			var_10.SetFishPonds(var_1_10013, var_6_1)

			var_1_10013 = var_10

			var_10.StartFishing(var_1_10013)
		end
	end
