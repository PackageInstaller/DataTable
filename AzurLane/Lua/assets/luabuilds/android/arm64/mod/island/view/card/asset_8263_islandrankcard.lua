...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	typeof = var_7
	Text = var_1_10009
	arg_1_0.rankText = var_1_3(var_1_2, var_7(var_1_10009))
	...
	typeof = var_7
	Text = var_1_10009
	arg_1_0.nameText = var_1_8(var_1_7, var_7(var_1_10009))
	...
	typeof = var_7
	Text = var_1_10009
	arg_1_0.levelText = var_1_11(var_1_10, var_7(var_1_10009))
	...
	typeof = var_7
	Text = var_1_10009
	arg_1_0.ptText = var_1_14(var_1_13, var_7(var_1_10009))
	setText = var_4

	local var_1_15 = arg_1_0._tf
	local var_1_16 = var_6.Find(var_1_15, "island")

	i18n = var_7

	var_4(var_1_16, var_7("island_season_charts_level"))
	...
	var_4(var_1_17, var_7("island_season_charts_out"))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	var_2_8(var_2_9, var_10.Find(var_2_10, "tpl"), #var_2_7, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			var_3(arg_2_0.parent, arg_3_2, function()
				...
				i18n = var_3_10004
				var_4_2.title = var_3_10004("island_word_desc")
				IslandMsgBox = var_4
				var_4_2.type = var_4.TYPE_COMMON_DROP_DESCRIBE
