...
function var_0_1.InitRuntimeRecords(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_1_10003(var_1_10005.island_achievement.all) do
		pg = var_1_10008
		...
		if var_1_10011.contains(var_2_0, var_2_2) then
			...
			if not arg_2_0.recordDic[var_2_2][var_2_3] then
				...
				IslandAchievementHelper = var_1_10012
				var_1_10011[var_2_3] = var_1_10012.GetRuntimeData(var_2_2, var_2_3)
			end
		else
			table = var_1_10011
...
function var_0_1.BuildDataDic(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1(var_1_10003.island_achievement.get_id_list_by_group) do
		...
		for iter_3_2, iter_3_3 in var_1_10007(iter_3_1) do
			local var_3_0 = var_1_10006:GetAchvById(iter_3_3)

			table = var_1_10013

			if var_1_10013.contains(arg_3_0.gotList, iter_3_3) then
				local var_3_1 = var_3_0

				var_1_10013 = var_3_0.SetStatus
				IslandAchievement = var_16

				var_1_10013(var_3_1, var_16.STATUS.GOT)
			...
			if arg_3_0:IsCanGet(var_3_0) then
				IslandAchievement = var_3_3

				do
					local var_3_3

					if not var_3_3.STATUS.GET then
						IslandAchievement = var_3_3
						var_3_3 = var_3_3.STATUS.NORMAL
					end

					var_1_10013(var_3_2, var_3_3)
				end

				::label_3_0::

				var_1_10013 = var_3_0:GetType()

				local var_3_4 = var_3_0:GetParam()

				if not arg_3_0.achvDic[var_1_10013] then
					arg_3_0.achvDic[var_1_10013] = {}
				end

				local var_3_5

				if not arg_3_0.achvDic[var_1_10013][var_3_4] then
					var_3_5 = arg_3_0.achvDic[var_1_10013]
					var_3_5[var_3_4] = {}
				end

				table = var_3_5

				var_3_5.insert(arg_3_0.achvDic[var_1_10013][var_3_4], var_3_0)
			end
		end

		var_1_10007 = arg_3_0.groupDic
		var_1_10007[iter_3_0] = var_1_10006
	end
...
function var_0_1.UpdataAchLv(arg_8_0, arg_8_1)
	...
	local var_8_2 = arg_8_0.GetGotGroupMaxStageList(var_8_1)
	local var_8_3 = {}
	...
	for iter_8_0, iter_8_1 in var_8_1(var_8_2) do
		pg = var_1_10010
		var_8_3[var_1_10010.island_achievement[iter_8_1].group] = iter_8_1
	end
	...
	for iter_8_2, iter_8_3 in var_5(arg_8_1) do
		...
		var_1_10011.insert(var_8_0, var_8_3[var_1_10010.group])
	end
...
function var_0_1.IsCanGet(arg_10_0, arg_10_1)
	local var_10_0 = arg_10_1:GetStatus()

	IslandAchievement = var_1_10003

	if var_10_0 == var_1_10003.STATUS.GOT then
		return
	end

	local var_10_1 = arg_10_1:GetType()
	local var_10_2 = arg_10_1:GetParam()
	local var_10_3 = arg_10_1:GetNum()

	if not arg_10_0.recordDic[var_10_1] then
		return false
	end

	return arg_10_0.recordDic[var_10_1][var_10_2] and var_10_3 <= var_5
end
...
function var_0_1.CheckAchvStatus(arg_17_0, arg_17_1, arg_17_2)
	...
	for iter_17_0, iter_17_1 in var_3(arg_17_0.achvDic[arg_17_1][arg_17_2]) do
		local var_17_0 = iter_17_1:GetStatus()

		IslandAchievement = var_1_10009

		if var_17_0 == var_1_10009.STATUS.NORMAL and arg_17_0:IsCanGet(iter_17_1) then
			local var_17_1 = iter_17_1
			local var_17_2 = iter_17_1.SetStatus

			IslandAchievement = var_11

			var_17_2(var_17_1, var_11.STATUS.GET)
...
function var_0_1.IsTip(arg_19_0)
	...
	for iter_19_0, iter_19_1 in var_1_10001(arg_19_0.groupDic) do
		...
		for iter_19_2, iter_19_3 in var_1_10006(iter_19_1:GetSortAchvList()) do
			local var_19_0 = iter_19_3:GetStatus()

			IslandAchievement = var_1_10012

			if var_19_0 == var_1_10012.STATUS.GET then
				return true
			end
		end
	end
