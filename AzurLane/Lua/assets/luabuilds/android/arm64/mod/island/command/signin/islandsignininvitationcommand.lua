local var_0_0 = class("IslandSignInInvitationCommand", pm.SimpleCommand)

function var_0_0.execute(arg_1_0, arg_1_1)
	local var_1_9000
	local var_1_0 = arg_1_1:getBody().list or {}
	local var_1_1 = getProxy(IslandProxy)
	local var_1_2 = var_1_1.GetIsland(var_1_9000):GetSignInAgency()
	...
	pg.ConnectionMgr.GetInstance():Send(21312, {
		friend_list = _.select(var_1_0, function(arg_2_0)
			return not var_1_2:IsInvited(arg_2_0)
		end)
		...
		if arg_3_0.result == 0 then
			...
			arg_1_0:sendNotification(GAME.ISLAND_SIGN_IN_INVITATION_DONE)
