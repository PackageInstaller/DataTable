...
function var_0_1.OnInit(arg_3_0)
	...
	var_1_10001(var_3_0, var_1_10004("island_draw_S_order_title"))
	...
	var_1.make(var_3_4, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			var_7.detachOnCardButton(var_5_5, arg_5_2)

			if var_5_1 then
				local var_5_6 = arg_3_0

				var_7.attachOnCardButton(var_5_6, arg_5_2)
			end
		end
	...
	var_1.make(var_3_5, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			var_5(arg_6_2:Find("mark"), var_6_1)

			setText = var_5

			var_5(arg_6_2:Find("mark/Text"), arg_6_1)
		end
	...
	local function var_3_10()
		...
		local var_7_2 = var_2_10003.DRAW_AWARD_OPERATION
		local var_7_3 = {
			op = "set_list",
		...
		local var_7_4 = var_5(arg_3_0.countAwardList)
		local var_7_5 = var_5.chain(var_7_4)
		local var_7_6 = var_5.filter(var_7_5, function(arg_8_0)
			return arg_8_0[2]
		end)
		local var_7_7 = var_5.map(var_7_6, function(arg_9_0)
			return arg_9_0[1]
		end)

		var_7_3.list = var_5.value(var_7_7)
...
function var_0_1.attachOnCardButton(arg_11_0, arg_11_1)
	...
	var_11_0:AddBeginDragFunc(function()
		...
		local var_12_7 = var_0(var_12_6, var_3(var_5))
		...
		typeof = var_3
		LayoutElement = var_5
		var_12_7(var_12_8, var_3(var_5)).ignoreLayout = true
		...
		var_12_10(var_12_11, var_3(1.1, 1.1, 1), 0.3)
	...
	var_11_0:AddDragFunc(function(arg_13_0, arg_13_1)
		...
		var_13_0.x = var_13_1(var_5.change2ScrPos(var_13_2, var_11_1, arg_13_1.position).x, var_11_2[1], var_11_2[#var_11_2])
		...
		for iter_13_0, iter_13_1 in var_2_10004(var_11_2) do
	...
	var_11_0:AddDragEndFunc(function(arg_14_0, arg_14_1)
			...
			if var_14_0 then
				...
				var_15_0({
					function(arg_16_0)
						...
						local var_16_1 = var_16_0(var_4_10003.abs(arg_11_1.localPosition.x - var_11_2[arg_11_0.after]) / 200, 1) * 0.3

						LeanTween = var_4_10002

						local var_16_2 = var_4_10002.moveLocalX(arg_11_1.gameObject, var_11_2[arg_11_0.after], var_16_1)
						local var_16_3 = var_2.setEase

						LeanTweenType = var_5

						local var_16_4 = var_16_3(var_16_2, var_5.easeOutCubic)
						local var_16_5 = var_2.setOnComplete

						System = var_5

						var_16_5(var_16_4, var_5.Action(arg_16_0))
					...
					function(arg_17_0)
						...
						local var_17_2 = var_17_0(var_17_1, var_4_10004(1, 1, 1), 0.3)
						local var_17_3 = var_1.setOnComplete

						System = var_4

						var_17_3(var_17_2, var_4.Action(arg_17_0))
		...
		var_4(var_14_1, function()
			...
			typeof = var_3
			LayoutElement = var_3_10005

			local var_18_2 = var_0(var_18_1, var_3(var_3_10005))
			...
			var_18_3(var_18_4, var_18_5, var_3_10004.remove(arg_11_0.countAwardList, arg_11_0.before))
...
function var_0_1.UpdateActivity(arg_22_0, arg_22_1)
	...
	var_2(var_22_3, var_5("island_draw_S_order"))
