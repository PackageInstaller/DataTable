...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.icon = var_2_8(var_2_7, var_4(var_1_10006))
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.bigIcon = var_2_11(var_2_10, var_4(var_1_10006))
	UIItemList = var_1

	local var_2_12 = var_1.New
	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_3.Find(var_2_13, "frame/items")
	local var_2_15 = arg_2_0._tf

	arg_2_0.itemsList = var_2_12(var_2_14, var_4.Find(var_2_15, "frame/items/tpl"))
	UIItemList = var_1

	local var_2_16 = var_1.New
	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_3.Find(var_2_17, "frame/addition")
	local var_2_19 = arg_2_0._tf

	arg_2_0.additionList = var_2_16(var_2_18, var_4.Find(var_2_19, "frame/addition/tpl"))
	...
	local var_2_23 = var_3.Find(var_2_22, "title/event/Text")

	i18n = var_4

	var_1(var_2_23, var_4("island_post_event_label"))

	setText = var_1

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_3.Find(var_2_24, "frame/btns/close/Text")

	i18n = var_4

	var_1(var_2_25, var_4("island_post_event_close_label"))

	setText = var_1

	local var_2_26 = arg_2_0._tf
	local var_2_27 = var_3.Find(var_2_26, "frame/btns/open/Text")

	i18n = var_4

	var_1(var_2_27, var_4("island_post_event_open_label"))

	setText = var_1

	local var_2_28 = arg_2_0._tf
	local var_2_29 = var_3.Find(var_2_28, "frame/title/Text")

	i18n = var_4

	var_1(var_2_29, var_4("island_post_event_addition_label"))
	...
	typeof = var_4
	Animation = var_6
	arg_2_0.animation = var_2_31(var_2_30, var_4(var_6))
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_2_0.dftAniEvent = var_2_33(var_2_32, var_4(var_6))
...
function var_0_1.OnShow(arg_8_0)
	...
	pg = var_8_0
	arg_8_0.config = var_8_0.island_manage_event[var_8_2]
...
function var_0_1.UnBlurPanel(arg_11_0)
	...
	var_11_1(var_11_0, var_11_2, var_1_10005.UIMgr.GetInstance().OverlayMain)
...
function var_0_1.WarpItemInfo(arg_17_0, arg_17_1)
	...
	local var_17_2, var_17_3 = arg_17_1.GetEventInfo(var_17_1)

	getProxy = var_17_1
	IslandProxy = var_1_10007

	local var_17_4 = var_17_1(var_1_10007)
	local var_17_5 = var_5.GetIsland(var_17_4)
	local var_17_6 = var_5.GetInventoryAgency(var_17_5)

	ipairs = var_1_10006

	for iter_17_0, iter_17_1 in var_1_10006(arg_17_1:getConfig("item_id")) do
		local var_17_7

		if not var_17_6:GetItemById(iter_17_1[1]) then
			IslandItem = var_17_7
			var_17_7 = var_17_7.New({
				id = iter_17_1[1]
			})
		end

		if var_17_7 and var_17_3[var_17_7.id] then
			table = var_12

			var_12.insert(var_17_0, var_17_7)
		end
	end
...
function var_0_1.WarpAdditionInfo(arg_18_0)
	...
	i18n = var_1_10006
	var_18_3[1] = var_1_10006("island_addition_influence")
	...
	i18n = var_6
	var_18_6[1] = var_6("island_addition_sale")
