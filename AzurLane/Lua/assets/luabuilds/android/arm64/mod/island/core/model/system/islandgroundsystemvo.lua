...
function var_0_1.GetMapLeftBottomPoint(arg_5_0)
	...
	local var_5_2 = var_1_10002.GetSizeCoord(var_5_1)

	Vector2 = var_5_0

	return var_5_0(var_5_2.x, var_5_2.w)
end
...
function var_0_1.GetPosition(arg_6_0)
	...
	local var_6_2 = var_1_10002.MapPosition2WorldPosition(var_6_1)

	IslandConst = var_6_0

	local var_6_3 = var_6_2 + var_6_0.AGORA_POSITION_OFFSET
