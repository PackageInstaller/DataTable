...
function var_0_1.SetAssistants(arg_7_0, arg_7_1)
	...
	if arg_7_1 then
		...
		for iter_7_2, iter_7_3 in var_1_10003(arg_7_0:getConfig("assistant_slot")) do
			pg = var_7_3

			local var_7_3 = var_7_3.island_manage_assistant[iter_7_3].unlock_type

			if var_7_2:HasAbility(var_7_3) then
				table = var_9
...
function var_0_1.AddSales(arg_21_0)
	...
	var_21_1(var_4.RESTAURANT_SALES, arg_21_0.id, var_21_0)
...
function var_0_1.CheckUpgrade(arg_23_0)
	if arg_23_0:GetCanUpgradeExp() ~= 0 and var_1 <= arg_23_0.sales then
		...
		var_23_1(var_23_0, var_1_10005.BuildIslandRestUpgrade(arg_23_0.id, arg_23_0.level))
