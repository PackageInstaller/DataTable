...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("Mod.Island.View.page.friend.IslandSignInInvitationPage"))
...
function var_0_1.AddListeners(arg_2_0)
	...
	IslandTradegency = var_1_10004

	var_2_1(var_2_0, var_1_10004.INVITE_LIST_UPDATE, arg_2_0.OnListUpdate)
...
function var_0_1.RemoveListeners(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10004.INVITE_LIST_UPDATE, arg_3_0.OnListUpdate)
...
function var_0_1.DoInvitation(arg_6_0, arg_6_1)
	...
	if var_6_0 then
		...
		IslandBaseMediator = var_1_10008

		var_6_4(var_6_3, var_1_10008.TRADE_INVITATION, {
			arg_6_1.player.id
		}, var_6_0, var_6_2)
	end
...
function var_0_1.GetInfo(arg_7_0)
	...
	local var_7_2 = var_1_10002.AGORA_MAP_ID

	pg = var_7_0

	local var_7_3 = var_7_0.island_map[var_7_2].name
...
function var_0_1.DoShare(arg_8_0)
	...
	if var_8_0 then
		...
		local var_8_5 = var_1_10007.SEND_CHAT

		IslandChatConst = var_1_10008

		local var_8_6 = var_1_10008.CHANNEL_ISLAND

		IslandConst = var_1_10009

		var_8_4(var_8_3, var_8_5, var_8_6, var_1_10009.TRADE_SHARE_CODE .. "*" .. var_8_1 .. "*" .. var_8_2)
...
function var_0_1.OnOneKey(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_9_0(arg_9_0.displays) do
		if not var_9_1:IsInvited(iter_9_1.id) then
			table = var_1_10010

			var_1_10010.insert(var_9_2, iter_9_1.id)
		end
	end

	local var_9_3, var_9_4, var_9_5 = arg_9_0:GetInfo()
	local var_9_6 = arg_9_0
	local var_9_7 = arg_9_0.emit

	IslandBaseMediator = var_1_10010

	var_9_7(var_9_6, var_1_10010.TRADE_INVITATION, var_9_2, var_9_3, var_9_5)
