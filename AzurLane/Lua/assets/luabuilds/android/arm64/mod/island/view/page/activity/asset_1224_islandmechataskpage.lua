...
function var_0_1.OnInit(arg_1_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.timeTxt = var_1_4(var_1_3, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.descTxt = var_1_7(var_1_6, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.progressTxt = var_1_10(var_1_9, var_4(var_1_10006))
	...
	local var_1_14 = var_3.Find(var_1_13, "bg/preview/Text")

	i18n = var_4

	var_1(var_1_14, var_4("island_mecha_task_preview"))

	setText = var_1

	local var_1_15 = arg_1_0._tf
	local var_1_16 = var_3.Find(var_1_15, "bg/look_all/Text")

	i18n = var_4

	var_1(var_1_16, var_4("island_mecha_task_look_all"))
	...
	local function var_1_20()
		...
		var_2_1(var_2_0, var_2_10003.OPEN_MACHA_MODEL_PREVIEW)
	...
	local function var_1_23()
		...
		var_3_1(var_3_0, var_3_2, var_3_4, var_5.getDayIndex(var_3_5), arg_1_0.taskGroup)
...
function var_0_1.UpdateTask(arg_7_0, arg_7_1, arg_7_2)
	...
	updateCustomDrop = var_8

	var_8(var_7_1, var_7_4)
	...
	local function var_7_7()
		...
		local var_8_2 = var_2_10003.SHOW_MSG_BOX
		local var_8_3 = {}

		i18n = var_2_10005
		var_8_3.title = var_2_10005("island_word_desc")
		IslandMsgBox = var_5
		var_8_3.type = var_5.TYPE_COMMON_DROP_DESCRIBE
		var_8_3.dropData = var_7_4
	...
	var_8(var_7_5, var_7_6, var_7_7, var_1_10013)

	local var_7_8 = arg_7_2:Find("go_btn")
	local var_7_9 = arg_7_2:Find("get_btn")
	local var_7_10 = arg_7_2
	local var_7_11 = arg_7_2.Find(var_7_10, "got_btn")
	local var_7_12 = arg_7_2:Find("un_finish")

	IslandTaskActhelper = var_7_10

	local var_7_13, var_7_14, var_7_15 = var_7_10.GetIslandTaskState(var_7_2)
	...
	var_1_10015(arg_7_2:Find("progressText"), var_7_13 .. "/" .. var_7_14)

	setSlider = var_1_10015

	var_1_10015(arg_7_2:Find("progress"), 0, var_7_14, var_7_13)

	local var_7_16 = var_7_3:GetTargetList()[1]

	pg = var_1_10016

	local var_7_17 = var_1_10016.island_task_target[var_7_16.id]

	tonumber = var_17

	local var_7_18 = var_17(var_7_17.tips)

	tonumber = var_18

	local var_7_19 = var_18(var_7_17.jump_ui)
	local var_7_20 = var_7_18 or var_7_19

	setActive = var_20

	var_20(var_7_12, var_7_15 == 0 and not var_7_20)

	setActive = var_20

	var_20(var_7_8, var_7_15 == 0 and var_7_20)

	setActive = var_20

	var_20(var_7_9, var_7_15 == 1)

	setActive = var_20

	var_20(var_7_11, var_7_15 == 2)

	onButton = var_20

	local var_7_21 = arg_7_0
	local var_7_22 = var_7_8
	...
	local function var_7_23()
		...
		if var_7_19 then
			...
			var_0._SkipBtn(var_9_0, var_7_19)
		elseif var_7_18 then
			pg = var_0

			local var_9_1 = var_0.island_world_objects[var_7_18].mapId
			...
			if var_1.IsUnlock("map") then
				...
				var_1._SkipObj(var_9_2, var_7_18)
			end
		end
	...
	var_20(var_7_21, var_7_22, var_7_23, var_1_10025)

	onButton = var_20

	local var_7_24 = arg_7_0
	local var_7_25 = var_7_9
	...
	local function var_7_26()
		...
		var_10_1(var_10_0, var_2_10003.ISLAND_SUBMIT_TASK, {
			taskId = var_7_2
		})
	...
	var_20(var_7_24, var_7_25, var_7_26, var_1_10025)
...
function var_0_1.UpdateDay(arg_14_0)
	...
	i18n = var_1_10014
	var_14_5.text = var_14_6(var_14_7, var_14_8, var_14_9, var_14_10, var_14_11, var_1_10014("island_draw_time_1"))
...
function var_0_1._SkipBtn(arg_20_0, arg_20_1)
	...
	local var_20_1 = var_1_10003(var_1_10005)
	...
	if not var_3.HasAbility(var_20_3, var_20_0.ability_id) then
		...
		var_20_5(var_20_4, var_6("island_taskjump_systemnoopen_tips"))
	...
	if var_20_0.open_page ~= "" then
		...
		var_20_7(var_20_6, var_6.OPEN_PAGE, var_20_0.open_page, var_20_0.page_param)
	end
...
function var_0_1._SkipObj(arg_21_0, arg_21_1)
	...
	if not var_3.IsUnlockMap(var_21_3, var_21_0) then
		...
		var_21_5(var_21_4, var_6("island_taskjump_placenoopen_tips"))
	...
	IslandSeasonPage = var_6

	var_21_7(var_21_6, var_6.CLOSE)
	...
	local var_21_11 = var_6.SWITCH_MAP
	local var_21_12 = var_21_0

	pg = var_1_10008

	var_21_10(var_21_9, var_21_11, var_21_12, var_1_10008.island_map[var_21_0].born_object)
