...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.itemCntTxt = var_2_4(var_2_3, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.goldCntTxt = var_2_7(var_2_6, var_4(var_1_10006))
	...
	local var_2_11 = var_3.Find(var_2_10, "adapt/tags")
	local var_2_12 = arg_2_0._tf

	arg_2_0.pagesUIList = var_2_9(var_2_11, var_4.Find(var_2_12, "adapt/tags/1"))
	...
	typeof = var_4
	Text = var_2_12
	arg_2_0.limitTxt = var_2_15(var_2_14, var_4(var_2_12))

	local var_2_16 = {}
	local var_2_17 = var_0_2

	IslandTradeProductListPage = var_2_14
	var_2_16[var_2_17] = var_2_14.New(arg_2_0.pageContainer, arg_2_0.event)
...
function var_0_1.AddListeners(arg_6_0)
	...
	IslandTradegency = var_4

	var_6_1(var_6_0, var_4.WEEK_NUM_UPDATE, arg_6_0.OnWeekNumUpdate)
	...
	var_6_3(var_6_2, var_4.ISLAND_TRADE_DONE, arg_6_0.OnTradeDone)
	...
	var_6_5(var_6_4, var_4.RESET_PRICE, arg_6_0.OnReset)
...
function var_0_1.RemoveListeners(arg_7_0)
	...
	var_7_1(var_7_0, var_4.WEEK_NUM_UPDATE, arg_7_0.OnWeekNumUpdate)
	...
	var_7_3(var_7_2, var_4.ISLAND_TRADE_DONE, arg_7_0.OnTradeDone)
	...
	var_7_5(var_7_4, var_4.RESET_PRICE, arg_7_0.OnReset)
...
function var_0_1.OnReset(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10004("island_trade_reset_label"))
...
function var_0_1.OnOpenConfirmPage(arg_10_0, arg_10_1)
	...
	var_10_6.type = var_1_10010.TYPE_TRADE_CONFRIM
	...
	function var_10_6.onYes(arg_11_0)
		...
		var_11_1(var_11_0, var_2_10004.TRADE_OP, arg_10_1, arg_11_0, var_10_2)
...
function var_0_1.OnOpenInvitePage(arg_13_0)
	...
	IslandTradeInvitePage = var_1_10004
...
function var_0_1.UpdateTitle(arg_15_0, arg_15_1)
	if arg_15_1 == var_0_1.MODE_SELL then
		...
		local var_15_1 = var_4.Find(var_15_0, "adapt/toggles/tpl/shop2List/shop2Tpl/selected/name")

		i18n = var_1_10005

		var_2(var_15_1, var_1_10005("island_trade_sell_sub_label"))

		setText = var_2

		local var_15_2 = arg_15_0._tf
		local var_15_3 = var_4.Find(var_15_2, "adapt/toggles/tpl/shop1Tg/name")

		i18n = var_1_10005

		var_2(var_15_3, var_1_10005("island_trade_sell_sub_label"))

		setText = var_2

		local var_15_4 = arg_15_0._tf

		var_2(var_4.Find(var_15_4, "adapt/toggles/tpl/shop1Tg/name/en"), "SELL")

		setText = var_2

		local var_15_5 = arg_15_0._tf
		local var_15_6 = var_4.Find(var_15_5, "adapt/top/title/Text")

		i18n = var_1_10005

		var_2(var_15_6, var_1_10005("island_trade_title2"))

		setText = var_2

		local var_15_7 = arg_15_0._tf
		local var_15_8 = var_4.Find(var_15_7, "adapt/shopPage/time/Text")

		i18n = var_1_10005

		var_2(var_15_8, var_1_10005("island_trade_tip_label2"))
	elseif arg_15_1 == var_0_1.MODE_PURCHAS then
		setText = var_2

		local var_15_9 = arg_15_0._tf
		local var_15_10 = var_4.Find(var_15_9, "adapt/toggles/tpl/shop2List/shop2Tpl/selected/name")

		i18n = var_1_10005

		var_2(var_15_10, var_1_10005("island_trade_purchase_sub_label"))

		setText = var_2

		local var_15_11 = arg_15_0._tf
		local var_15_12 = var_4.Find(var_15_11, "adapt/toggles/tpl/shop1Tg/name")

		i18n = var_5

		var_2(var_15_12, var_5("island_trade_purchase_sub_label"))

		setText = var_2

		local var_15_13 = arg_15_0._tf

		var_2(var_4.Find(var_15_13, "adapt/toggles/tpl/shop1Tg/name/en"), "PURCHASE")

		setText = var_2

		local var_15_14 = arg_15_0._tf
		local var_15_15 = var_4.Find(var_15_14, "adapt/top/title/Text")

		i18n = var_5

		var_2(var_15_15, var_5("island_trade_title"))

		setText = var_2

		local var_15_16 = arg_15_0._tf
		local var_15_17 = var_4.Find(var_15_16, "adapt/shopPage/time/Text")

		i18n = var_5

		var_2(var_15_17, var_5("island_trade_tip_label"))
	end
...
function var_0_1.UpdateLabels(arg_16_0, arg_16_1)
	if arg_16_0:IsSellMode(arg_16_1) then
		i18n = var_16_0

		local var_16_0

		if not var_16_0("island_trade_sell_sub_label") then
			i18n = var_16_0
			var_16_0 = var_16_0("island_trade_purchase_sub_label")
		end
		...
		var_1_10003(var_5.Find(var_16_1, "adapt/toggles/tpl/shop1Tg/name"), var_16_0)

		setText = var_1_10003

		local var_16_2 = arg_16_0._tf

		var_1_10003(var_5.Find(var_16_2, "adapt/toggles/tpl/shop2List/shop2Tpl/selected/name"), var_16_0)
...
function var_0_1.UpdateResource(arg_17_0)
	...
	var_17_2.text = var_17_4(var_17_3, var_1_10007.PEARL_ID)
	...
	IslandItem = var_7
	var_17_5.text = var_17_7(var_17_6, var_7.GOLD_ID)
...
function var_0_1.UpdateLimit(arg_18_0)
	...
	if arg_18_0.mode == var_0_1.MODE_PURCHAS or arg_18_0:IsSelfIsland() then
		...
		local var_18_3 = var_18_1.GetWeekNumMax(var_18_2)
		local var_18_4 = arg_18_0.limitTxt

		i18n = var_18_2

		local var_18_5 = "island_trade_limit_label"

		var_1_10010 = var_18_1
		var_18_4.text = var_18_2(var_18_5, var_18_3 - var_18_1.GetWeekNum(var_1_10010) .. "/" .. var_18_3)

		if arg_18_0.mode == var_0_1.MODE_SELL then
			arg_18_0.limitTxt.text = ""
		end
	elseif arg_18_0.mode == var_0_1.MODE_SELL then
		local var_18_6 = arg_18_0:GetIsland()
		local var_18_7 = var_18_1:GetSellLimit(var_18_6.id)
		local var_18_8 = var_18_1
		local var_18_9 = var_18_1.GetSellLimitMax(var_18_8)
		local var_18_10 = arg_18_0.limitTxt

		i18n = var_18_8

		local var_18_11 = "island_trade_sell_tip_label"

		math = var_1_10010
		var_18_10.text = var_18_8(var_18_11, var_1_10010.max(0, var_18_9 - var_18_7) .. "/" .. var_18_9)
	end
...
function var_0_1.InitPageSwitcher(arg_21_0, arg_21_1)
	...
	var_3.make(var_21_1, function(arg_22_0, arg_22_1, arg_22_2)
		...
		if arg_22_0 == var_2_10003.EventUpdate then
			...
			var_2_10005(arg_22_2:Find("name"), var_22_2)

			setText = var_2_10005

			var_2_10005(arg_22_2:Find("selected/name"), var_22_2)
			...
			local var_22_5 = var_22_4(var_22_3, var_8(var_10))
			...
			var_22_1(var_22_6, var_22_7, var_22_8, var_2_10011)

			if arg_22_1 == 0 then
				triggerToggle = var_22_1

				var_22_1(arg_22_2, true)
			end
		end
