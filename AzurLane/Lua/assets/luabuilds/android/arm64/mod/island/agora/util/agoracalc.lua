...
function var_0_0.GetSizeCoord(arg_1_0)
	...
	local var_1_3 = var_1_10004.floor(var_1_0) * -1
...
function var_0_0.GetArea(arg_2_0, arg_2_1)
	...
	for iter_2_0 = var_0_0.GetSizeCoord(arg_2_1).x, var_3.z do
		for iter_2_1 = var_3.w, var_3.y do
			...
			var_1_10012(var_2_1, var_1_10015(iter_2_0, iter_2_1) + arg_2_0)
		end
	end
...
function var_0_0.GetCenterScreenPos()
	...
	return (var_4_1(var_4_0, var_1_10004.LAYER_GROUND))
end
...
function var_0_0.ScreenPostion2MapPosition(arg_5_0)
	...
	if var_5_1(var_5_0, var_5_2, var_1_10006.LAYER_GROUND) then
...
function var_0_0.WorldPosition2MapPosition(arg_6_0)
	...
	local var_6_0 = var_1_10003.floor(arg_6_0.x + 0.5)

	math = var_1_10004

	return var_1_10001(var_6_0, var_1_10004.floor(arg_6_0.z + 0.5))
end
...
function var_0_0.ScreenPosition2LocalPosition(arg_8_0, arg_8_1)
	...
	local var_8_4 = var_8_0.ViewportToScreenPoint(var_8_3, var_8_2)
	local var_8_5 = arg_8_0:GetComponent("RectTransform")

	LuaHelper = var_8_3

	return (var_8_3.ScreenToLocal(var_8_5, var_8_4, var_8_0))
end
...
function var_0_0.ScreenToHitPoint(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_4 = var_12_3(var_12_2, var_1_10008(var_12_1.x, var_12_1.y, 0))
	local var_12_5 = arg_12_0:ViewportPointToRay(var_12_4)

	IslandHelper = var_12_2

	if var_12_2.RaycastRay(var_12_5, arg_12_2).w == 1 then
		Vector3 = var_8
...
function var_0_0.GetGroundLeftBottomPoint()
	...
	local var_18_3 = var_1_10002.GetSizeCoord(var_18_2)
...
function var_0_0.GetChangePlacementList(arg_23_0, arg_23_1)
	...
	local var_23_3 = var_1_10005.select(arg_23_1, function(arg_27_0)
