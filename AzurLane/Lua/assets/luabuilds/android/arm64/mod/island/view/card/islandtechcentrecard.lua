...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_4 = var_4.Find(var_1_3, "Image/tip/Text")

	i18n = var_5

	var_2(var_1_4, var_5("island_tech_lock"))

	local var_1_5 = arg_1_0._tf
	local var_1_6 = var_2.Find(var_1_5, "items_view/content")

	UIItemList = var_1_10003
	arg_1_0.uiList = var_1_10003.New(var_1_6, var_1_6:Find("tpl"))
...
function var_0_0.UpdateItem(arg_3_0, arg_3_1, arg_3_2)
	...
	var_1_10005(arg_3_2:Find("corner/Text"), var_3_4:getConfig("tech_level"))

	LoadImageSpriteAsync = var_1_10005

	var_1_10005("island/IslandTechnology/" .. var_3_4:getConfig("tech_icon"), arg_3_2:Find("icon"), true)

	setActive = var_1_10005

	var_1_10005(arg_3_2:Find("line"), arg_3_1 + 1 ~= #arg_3_0.ids)
	...
	local var_3_7 = arg_3_2:Find("receive")

	IslandTechnology = var_9

	var_3_3(var_3_7, var_3_6 == var_9.STATUS.RECEIVE)

	setActive = var_3_3

	local var_3_8 = arg_3_2:Find("studying")

	IslandTechnology = var_9

	var_3_3(var_3_8, var_3_6 == var_9.STATUS.STUDYING)

	IslandTechnology = var_3_3

	if var_3_6 ~= var_3_3.STATUS.STUDYING then
		...
		if var_3_6 ~= var_6.STATUS.LOCK then
			...
			if var_3_6 == var_6.STATUS.NORMAL then
				...
				if var_3_4.GetFinishedCnt(var_3_8) ~= 0 then
					var_3_9 = false
				...
				setImageAlpha = var_3_5

				var_3_5(arg_3_2:Find("icon"), var_3_9 and 0.5 or 1)

				local var_3_10 = arg_3_2
				local var_3_11 = arg_3_2.GetComponent

				typeof = var_10
				Animation = var_12

				local var_3_12 = var_3_11(var_3_10, var_10(var_12))

				IslandTechnology = var_3_8

				if var_3_6 == var_3_8.STATUS.NORMAL and var_3_4:GetFinishedCnt() == 0 then
					var_3_12:Play("anim_Island_technology_tplicon_in")
				else
					IslandTechnology = var_8

					if var_3_6 == var_8.STATUS.STUDYING then
						var_3_12:Play("anim_Island_technology_tplstudy_in")
					else
						IslandTechnology = var_8

						if var_3_6 == var_8.STATUS.RECEIVE then
							var_3_12:Play("anim_Island_technology_tplreceive_in")
						else
							var_3_12:Stop()
						end
					end
				...
				var_8(var_3_13, var_3_14, var_3_15, var_1_10013)
