...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("Mod.Island.View.page.map.IslandBaseMapDescPage"))
...
function var_0_1.UpdateProductionList(arg_2_0, arg_2_1)
	...
	local var_2_3 = var_1_10004.select(var_2_0, function(arg_3_0)
		local var_3_0 = var_2_2
		local var_3_1 = var_1.HasAbility

		pg = var_2_10004

		return var_3_1(var_3_0, var_2_10004.island_map_details[arg_3_0].ability_id)
	end)
