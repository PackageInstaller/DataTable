...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_1 == 2 then
		...
		i18n = var_10
		var_1_6.content = var_10("island_rename_tip")
		...
		i18n = var_10
		var_1_9.content = var_10("island_rename_confirm", var_1_0)
...
function var_0_1.Send(arg_4_0, arg_4_1, arg_4_2)
	...
	var_3.Send(var_4_0, 21004, {
		...
		if arg_5_0.ret == 0 then
			...
			local var_5_0 = var_1(var_2_10003)

			var_2_10004 = var_1.GetIsland(var_5_0)

			if not var_1.IsNew(var_2_10004) then
				-- block empty
			end

			var_2_10004 = var_1

			var_1.SetName(var_2_10004, arg_4_1)
			...
			var_5_1(var_2_10004, var_5.ISLAND_SET_NAME_DONE, {
				name = arg_4_1
			})
		else
			pg = var_1
			...
			var_5_3(var_5_2, var_2_10004[arg_5_0.ret] .. arg_5_0.ret)
		end
