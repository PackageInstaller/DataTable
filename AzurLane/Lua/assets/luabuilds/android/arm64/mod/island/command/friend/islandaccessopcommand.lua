...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_6 == var_1_4.ACCESS_OP_ADD_WHITELIST then
		IslandConst = var_1_6
		var_1_1 = var_1_6.ACCESS_OP_SET_WHITELIST
		var_1_2 = arg_1_0:AddWhiteList(var_1_5, var_1_0.list)
	else
		var_1_6 = var_1_0.op
		IslandConst = var_7

		if var_1_6 == var_7.ACCESS_OP_DEL_WHITELIST then
			IslandConst = var_1_6
			var_1_1 = var_1_6.ACCESS_OP_SET_WHITELIST
			var_1_2 = arg_1_0:RemoveWhiteList(var_1_5, var_1_0.list)
		else
			var_1_6 = var_1_0.op
			IslandConst = var_7

			if var_1_6 == var_7.ACCESS_OP_ADD_BLACKLIST then
				IslandConst = var_1_6
				var_1_1 = var_1_6.ACCESS_OP_KICKANDBLACKLIST
				var_1_2 = arg_1_0:AddBlackList(var_1_5, var_1_0.list)
			else
				var_1_6 = var_1_0.op
				IslandConst = var_7

				if var_1_6 == var_7.ACCESS_OP_DEL_BLACKLIST then
					IslandConst = var_1_6
	...
	local var_1_7 = var_1_6.island_set.whit_list_max_cnt.key_value_int
	...
	if var_1_1 == var_7.ACCESS_OP_SET_WHITELIST then
		if var_1_7 < #var_1_2 then
			...
			var_1_9(var_1_8, var_1_10010("island_white_list_full"))
		...
		if var_1_1 == var_1_9.ACCESS_OP_SET_BLACKLIST then
			if var_1_7 < #var_1_2 then
				pg = var_1_9
				...
				var_1_9(var_1_10, var_1_10010("island_black_list_full"))
			...
			if var_1_1 == var_1_9.ACCESS_OP_KICKANDBLACKLIST and var_1_7 < #var_1_2 then
				pg = var_1_9
				...
				var_1_9(var_1_11, var_1_10010("island_black_list_full"))

				IslandConst = var_1_9
				var_1_1 = var_1_9.ACCESS_OP_KICK
			end
		end
	end
	...
	var_1_9({
		...
		var_4_1(var_4_0, var_2_10003.ISLAND_ACCESS_OP_DONE, {
			op = var_1_1,
			clientOp = var_1_0.op
		})
...
function var_0_1.CheckReSend(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	if arg_5_2 == var_1_10007.ACCESS_OP_SET_WHITELIST then
		var_5_3 = arg_5_1:GetBlackList()
		ipairs = var_1_10008

		for iter_5_0, iter_5_1 in var_1_10008(var_5_3) do
			table = var_1_10013
	...
	if arg_5_2 ~= var_5_3.ACCESS_OP_SET_BLACKLIST then
		IslandConst = var_7
		...
		if arg_5_2 == var_7.ACCESS_OP_KICKANDBLACKLIST then
			...
			for iter_5_2, iter_5_3 in var_1_10008(var_5_4) do
				table = var_1_10013
	...
	var_5.Send(var_6_0, 21302, {
		...
		if arg_7_0.result == 0 then
			...
			if var_7_0 == var_2_10002.ACCESS_OP_SET_WHITELIST then
				...
				if var_7_0 == var_2.ACCESS_OP_SET_BLACKLIST then
					...
					if var_7_0 == var_2.ACCESS_OP_KICK then
						-- block empty
					else
						var_7_0 = arg_6_2
						IslandConst = var_2
			...
			var_7_0(var_7_4, var_2_10004("island_visit_tip6"))
		else
			pg = var_7_0
			...
			var_7_6(var_7_5, var_2_10004[arg_7_0.result] .. arg_7_0.ret)
		end
