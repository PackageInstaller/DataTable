...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".AgoraPlaceableArea"))
...
function var_0_1.AddTheme(arg_7_0, arg_7_1)
	...
	var_7_1(var_7_0, var_5.THEME_UPDATE)
...
function var_0_1.DeleteTheme(arg_8_0, arg_8_1)
	...
	if var_1_10002.detect(arg_8_0.themes, function(arg_9_0)
		...
		var_1_10003.removebyvalue(arg_8_0.themes, var_2)
		...
		var_8_1(var_8_0, var_6.THEME_UPDATE)
	end
...
function var_0_1.PlaceItem(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	...
	var_23_2(var_23_1, var_9.GEN_ITEM, var_5, arg_23_4)
...
function var_0_1.UnPlaceItem(arg_24_0, arg_24_1)
	...
	var_24_2(var_24_1, var_6.REMOVE_ITEM, var_24_0)
...
function var_0_1.PlaceTile(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	var_30_2(var_30_1, var_8.FILL_TILE_CELL, var_30_0)
...
function var_0_1.UnPlaceTile(arg_31_0, arg_31_1)
	...
	var_31_1(var_31_0, var_5.CLEAR_TILE_CELL, arg_31_1)
...
function var_0_1.PlaceFloor(arg_34_0, arg_34_1, arg_34_2, arg_34_3)
	...
	var_34_2(var_34_1, var_8.FILL_FLOOR_CELL, var_34_0)
...
function var_0_1.UnPlaceFloor(arg_35_0, arg_35_1)
	...
	var_35_1(var_35_0, var_5.CLEAR_FLOOR_CELL, arg_35_1)
...
function var_0_1.AddVirtualInteractUnitData(arg_36_0, arg_36_1, arg_36_2)
	if arg_36_2:CanInteraction() then
		...
		for iter_36_0, iter_36_1 in var_3(arg_36_2:GetInteractionPoints()) do
			...
			pg = var_1_10009
			var_1_10009 = var_1_10009.island_interact_point[iter_36_1]

			local var_36_0 = arg_36_2
			local var_36_1 = arg_36_2.GetRotation(var_36_0)

			AgoraCalc = var_11

			local var_36_2 = var_11.GetAreaCenterPos(arg_36_2:GetArea())

			Vector3 = var_36_0
			unpack = var_1_10014

			local var_36_3 = var_36_0(var_1_10014(var_1_10009.offset))

			Quaternion = var_13

			local var_36_4 = var_36_2 + var_36_3 * var_13.Euler(0, var_36_1.y, 0)

			IslandConst = var_12

			local var_36_5 = var_36_4 + var_12.AGORA_POSITION_OFFSET

			IslandDataConvertor = var_12

			local var_36_6 = var_12.GenInteractUnitByAgoraFurniture({
				id = var_1_10008,
				pointId = iter_36_1,
				position = {
					var_36_5.x,
			...
			arg_36_0.virtualInteractUnitData[var_1_10008] = var_36_6

			local var_36_7 = arg_36_2
			local var_36_8 = arg_36_2.AddListener

			ISLAND_AGORA_EVT = var_16

			var_36_8(var_36_7, var_16.ITEM_POSITION_UPDATE, function(arg_37_0, arg_37_1)
				...
				local var_37_1 = var_2_10003(var_2_10005(var_1_10009.offset))
				...
				local var_37_5 = var_37_1 * var_37_2(var_37_3, var_7.GetRotation(var_37_4).y, 0)
				local var_37_6 = arg_36_0
				local var_37_7 = var_4.DispatchEvent

				ISLAND_EVT = var_7

				local var_37_8 = var_7.RESET_UNIT_POS
				local var_37_9 = var_36_6.id

				IslandConst = var_37_4

				local var_37_10 = var_37_4.UNIT_LIST_OBJ
				local var_37_11 = var_37_0 + var_37_5

				IslandConst = var_2_10011

				var_37_7(var_37_6, var_37_8, var_37_9, var_37_10, var_37_11 + var_2_10011.AGORA_POSITION_OFFSET)

				return
			end)

			local var_36_9 = arg_36_2
			local var_36_10 = arg_36_2.AddListener

			ISLAND_AGORA_EVT = var_16

			var_36_10(var_36_9, var_16.ITEM_DIR_UPDATE, function(arg_38_0, arg_38_1)
				local var_38_0 = arg_36_0
				local var_38_1 = var_2.DispatchEvent

				ISLAND_EVT = var_2_10005

				local var_38_2 = var_2_10005.RESET_UNIT_ROT
				local var_38_3 = var_36_6.id

				IslandConst = var_2_10007

				var_38_1(var_38_0, var_38_2, var_38_3, var_2_10007.UNIT_LIST_OBJ, arg_38_1)
			...
			var_36_12(var_36_11, var_16.GEN_UNIT, var_36_6)
		end
	end
...
function var_0_1.RemoveVirtualInteractUnitData(arg_39_0, arg_39_1, arg_39_2)
	if arg_39_2:CanInteraction() then
		...
		for iter_39_0, iter_39_1 in var_3(arg_39_2:GetInteractionPoints()) do
			...
			var_1_10012 = var_1_10012.RMOVE_UNIT
			IslandConst = var_1_10013

			var_39_1(var_39_0, var_1_10012, var_1_10013.UNIT_LIST_OBJ, var_1_10008)
		end
	end
