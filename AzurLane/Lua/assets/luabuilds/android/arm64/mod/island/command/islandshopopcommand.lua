...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	elseif var_1_0.operation == IslandConst.SHOP_BUY_COMMODITY then
		...
		for iter_1_0, iter_1_1 in ipairs(var_1_0.commodityList) do
			local var_1_6 = var_1_1:GetShopCommodity(iter_1_1.key, iter_1_1.value1)

			table.insert({}, var_1_6)
			table.insertto({}, var_1_6:GetItems())
			...
			local var_1_7 = Clone(var_1_6:GetResourceConsume())

			var_1_7[3] = math.ceil((100 - var_1_6:GetDiscount()) / 100 * (var_1_7[3] * iter_1_1.value2))

			local var_1_8 = false

			for iter_1_2, iter_1_3 in ipairs({}) do
				if iter_1_3[1] == var_1_7[1] and iter_1_3[2] == var_1_7[2] then
					var_1_8 = true
					iter_1_3[3] = iter_1_3[3] + var_1_7[3]
			...
			var_1_5 = 0 + pg.island_shop_goods[iter_1_1.value1].pt_award * iter_1_1.value2

			for iter_1_4, iter_1_5 in ipairs((var_1_6:GetItems())) do
			...
			local var_1_9 = GetItemsOverflowDic({})
			local var_1_10, var_1_11 = CheckOverflow(var_1_9)
			...
			if not CheckShipExpOverflow(var_1_9) then
			...
			if iter_1_9[1] == DROP_TYPE_RESOURCE then
				if iter_1_9[3] > var_1_3[id2res(iter_1_9[2])] then
					...
					elseif not ItemTipPanel.ShowItemTip(DROP_TYPE_RESOURCE, iter_1_9[2]) then
						pg.TipsMgr.GetInstance():ShowTips(i18n("buyProp_noResource_error", var_1_13))
					end
	...
	elseif var_1_0.operation == IslandConst.SHOP_REFRESH_BY_PLAYER then
		local var_1_15 = var_1_0.refreshResource
		local var_1_16 = getProxy(PlayerProxy):getData()
		local var_1_17 = var_1_0.refreshResource[3]

		if var_1_0.refreshResource[3] ~= 0 then
			if var_1_0.refreshResource[1] == DROP_TYPE_RESOURCE then
				if var_1_0.refreshResource[3] > var_1_16[id2res(var_1_0.refreshResource[2])] then
					if var_1_0.refreshResource[2] == 1 then
						GoShoppingMsgBox(i18n("switch_to_shop_tip_2", i18n("word_gold")), ChargeScene.TYPE_ITEM, {
							{
								59001,
								var_1_0.refreshResource[3] - var_1_16[id2res(var_1_0.refreshResource[2])],
