...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21617, {
		...
		if arg_2_0.result == 0 then
			pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildIslandWearDress(var_0, var_0))

			local var_2_0 = getProxy(IslandProxy)
			local var_2_1 = var_2_0.GetIsland(var_2_9000)
			local var_2_2 = var_2_1:GetCharacterAgency()
			local var_2_3 = var_2_2:GetShipById(var_0)
			local var_2_4

			if var_0 ~= var_2_3.GetCurSkinId(var_2_0) then
				var_2_4 = var_0
			end

			var_2_3:ChangeSkinId(var_0)

			local var_2_5

			if var_0 ~= var_2_2:GetSkinCurrentColor(var_2_3:GetCurSkinId()) then
				var_2_5 = var_0
			end

			var_2_2:SetSkinCurrentColor(var_0, var_0)

			local var_2_6 = {}

			for iter_2_0, iter_2_1 in ipairs(var_0) do
				var_2_2:AddDressItem(iter_2_1, 1)
				var_2_2:DischargeDressOnShip(var_0, iter_2_1)
			...
			for iter_2_2, iter_2_3 in ipairs(var_0) do
				...
				var_2_2:ChargeDressOnShip(var_0, var_2_9)
			...
			var_2_1:DispatchEvent(IslandCharacterAgency.CHANGE_CHARACTER_DRESS, var_0, var_2_10, var_2_6, var_2_7)
