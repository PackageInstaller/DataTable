...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	var_1_10002(var_1_10004(arg_1_0) .. "weatehr init")
	...
	arg_1_0.director = var_1_1(var_1_0, var_5(var_1_10007.Playables.PlayableDirector))
...
function var_0_0.Play(arg_3_0)
	...
	if var_1_10002(arg_3_0.director) then
		return
	end

	arg_3_0.director.time = var_3_0 / var_0_1

	local var_3_1 = arg_3_0.director

	var_2.Play(var_3_1)

	local var_3_2 = arg_3_0.speedComp

	var_2.SetTimelineSpeed(var_3_2, var_0_2 / var_0_1 / arg_3_0.gameDaySec)
...
function var_0_0.GetFrame(arg_5_0)
	...
	return (var_5_0.floor(var_5_1 / arg_5_0.gameDaySec * var_0_2))
end
