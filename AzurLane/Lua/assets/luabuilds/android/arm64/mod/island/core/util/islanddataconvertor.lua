...
function var_0_0.Island2SceneData(arg_1_0)
	...
	local var_1_3 = arg_1_0.GetLastExitPosition(var_1_2)
	local var_1_4 = arg_1_0:GetVisitorAgency()
	local var_1_5 = var_4.GetMapVisitorList(var_1_4)

	pg = var_1_2

	local var_1_6 = var_1_2.island_map[var_1_0]
	local var_1_7 = {}
	local var_1_8 = {}
	local var_1_9 = {}
	local var_1_10 = {}
	...
	var_0_0.SceneData2IslandUnits(var_1_7, var_1_15, var_1_5, var_1_0, var_1_1, var_1_3, arg_1_0.id)
	var_0_0.SystemData2IslandUnits(var_1_7, var_1_13, var_1_12, arg_1_0, var_1_0, var_1_11)
	var_0_0.CollectSystems(var_1_8, var_1_9, arg_1_0, var_1_0, var_1_11)
	var_0_0.CollectStrollUnits(var_1_10, arg_1_0, var_1_0)
	var_0_0.CollectFollowUnits(var_1_7, var_1_14, arg_1_0, var_1_0)

	local var_1_16 = var_0_0.CollectCamreaZoomData(var_1_0)

	return {
		mapId = var_1_0,
		unitList = var_1_7,
		sceneName = var_1_6.sceneName,
		systemList = var_1_8,
		systemUnits = var_1_9,
		strollUnits = var_1_10,
		productSystems = var_1_11,
		giftUnits = var_1_12,
		followUnits = var_1_14,
		delayInitUnits = var_1_13,
		activityUnits = var_1_15,
		camreaZoomData = var_1_16
	}
end
...
function var_0_0.Island2SceneName(arg_2_0)
	...
	return var_1_10002.island_map[var_2_0].sceneName, var_2_0, var_2.default_bgm
end
...
function var_0_0.CollectFishPointUnits(arg_5_0, arg_5_1, arg_5_2)
	...
	for iter_5_0, iter_5_1 in var_1_10003(var_1_10005.island_fish_point.all) do
		pg = var_1_10008
		...
		if var_1_10009.island_world_objects[var_1_10008.objId].mapId == arg_5_2 then
			...
			IslandFishPointVO = var_1_10013

			var_5_0(var_5_1, var_1_10013.New(iter_5_1, var_1_10008.objId))
		end
	end
...
function var_0_0.CollectBuildingSystemUnits(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	if not var_1_10006.island_production_place.get_id_list_by_map_id[arg_6_3] then
		var_6_2 = {}
	end

	ipairs = var_6_0

	for iter_6_0, iter_6_1 in var_6_0(var_6_2) do
		pg = var_1_10012
		...
		if arg_6_3 == var_1_10012.island_production_place[iter_6_1].map_id then
			...
			IslandProductSystemVO = var_1_10013
			var_1_10013 = var_1_10013.New(iter_6_1, var_1_10012, arg_6_2.id)
			ipairs = var_6_3

			for iter_6_2, iter_6_3 in var_6_3(var_1_10013:GetUnitDatas()) do
				if iter_6_3 then
			...
			var_14.insert(arg_6_4, var_1_10013)
		end
	end
...
function var_0_0.CollectOrderSystemUnits(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_1 = arg_7_1.GetOrderAgency(var_7_0)
	local var_7_2 = var_3.GetShipSlotList(var_7_1)
	...
	for iter_7_0, iter_7_1 in var_7_0(var_7_2) do
		if not iter_7_1:IsLock() and iter_7_1:GetWorldObjId() > 0 then
			...
			local var_7_3 = var_10.island_world_objects
			local var_7_4 = iter_7_1

			if var_7_3[iter_7_1.GetWorldObjId(var_7_4)] and var_10.mapId == arg_7_2 then
				local var_7_5 = {}
				local var_7_6 = var_0_0.WorldObj2IslandUnit(var_10, var_7_5)

				table = var_7_4

				var_7_4.insert(arg_7_0, var_7_6)
			end
		end
	end
...
function var_0_0.CollectSignInSystemUnits(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	if not var_1_10005.island_world_objects.get_id_list_by_mapId[arg_8_3] then
		var_8_1 = {}
	end
	...
	for iter_8_0, iter_8_1 in var_1_10007(var_8_1) do
		pg = var_1_10012

		local var_8_3 = var_1_10012.island_world_objects[iter_8_1].unitId

		if 0 < var_8_3 then
			local var_8_4 = var_1_10012.gen_type

			IslandConst = var_14

			if var_8_4 == var_14.UNIT_GEN_TYPE_GIFT then
				var_8_2 = var_8_2 + 1

				local var_8_5 = var_0_0.WorldObj2IslandUnit(var_1_10012, {
					index = var_8_2
				})

				table = var_14

				var_14.insert(arg_8_1, var_8_5)
			end
		end
	end
...
function var_0_0.CollectWildCollectInSystemUnits(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	local var_9_1 = arg_9_2.GetWildCollectAgency(var_9_0)
	local var_9_2 = var_4.GetUnitList(var_9_1)
	...
	for iter_9_0, iter_9_1 in var_9_0(var_9_2) do
		...
		local var_9_3 = var_1_10011.island_world_objects[iter_9_1.unitId].unitId

		if 0 < var_9_3 then
			local var_9_4 = var_0_0.WorldObj2IslandUnit(var_1_10011, {
				index = arg_9_2.id,
...
function var_0_0.CollectStrollUnits(arg_10_0, arg_10_1, arg_10_2)
	...
	local function var_10_3(arg_11_0, arg_11_1)
		if arg_11_0 == -1 then
			...
			return var_2_10003.detect(var_10_2, function(arg_12_0)
	...
	for iter_10_0, iter_10_1 in var_10_1(var_1_10009.island_strollnpc.all) do
		pg = var_1_10012
		...
		if var_1_10013.any(var_1_10012.mapId, function(arg_13_0)
			...
			if var_1_10013 then
				...
				local var_10_6 = var_16.insert
				local var_10_7 = arg_10_0

				IslandStrollUnitVO = var_1_10019

				var_10_6(var_10_7, var_1_10019.New(var_10_5, iter_10_1, var_10_4))
			end
		end
	end
...
function var_0_0.DistributeActionFeedbackAward4StrollUnits(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_1 = arg_14_1.GetNpcFeedbackAgency(var_14_0)
	local var_14_2 = var_3.GetNpcList(var_14_1)

	pg = var_14_0

	local var_14_3 = var_14_0.island_set.island_feedback_award_times.key_value_int - #var_14_2
	local var_14_4 = {}
	...
	for iter_14_0, iter_14_1 in var_1_10008(arg_14_0) do
		...
		if var_1_10013.island_strollnpc[iter_14_1.id].action_feedback == 1 then
			...
			if var_14.all(var_14_2, function(arg_15_0)
				return iter_14_1.id ~= arg_15_0
			end) then
				table = var_14

				var_14.insert(var_14_4, iter_14_1)
			end
		end
	end
	...
	for iter_14_2 = 1, var_14_3 do
		if var_14_4[iter_14_2] then
			math = var_1_10013

			local var_14_5 = arg_14_2[var_1_10013.random(1, #arg_14_2)]

			var_12:SetActionFeedback(var_14_5)
		end
	end
...
function var_0_0.DistributeShipSkillAward4StrollUnits(arg_16_0, arg_16_1, arg_16_2)
	...
	for iter_16_0, iter_16_1 in var_1_10004(arg_16_0) do
		local var_16_1 = iter_16_1:GetShipId()

		if var_16_0:GetShipById(var_16_1) and var_10:HasGreetingSkill() then
			local var_16_2 = var_10:GetSkill()
			local var_16_3 = var_11.CanUse4Ship
			local var_16_4 = var_10
			local var_16_5 = {}

			IslandBuffType = var_1_10017
			var_16_5[1] = var_1_10017.SHIP_POWER_RECOVER_BY_GREETING
			IslandBuffType = var_1_10017
			var_16_5[2] = var_1_10017.SHIP_AWARD_BY_GREETING

			if var_16_3(var_16_2, var_16_4, var_16_5) then
				math = var_12

				local var_16_6 = arg_16_2[var_12.random(1, #arg_16_2)]

				iter_16_1:SetSkillActionFeedback(var_16_6)
			end
		end
	end
...
function var_0_0.GetOwnActions(arg_17_0)
	...
	local var_17_2 = arg_17_0:GetActionAgency()

	_ = var_1_10003

	return (var_1_10003.select(var_17_1, function(arg_18_0)
...
function var_0_0.CollectFollowUnits(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	for iter_20_2, iter_20_3 in iter_20_0(var_20_3:GetFollowers()) do
		local var_20_4 = arg_20_2:GetCharacterAgency()
		local var_20_5 = var_13.GetShipById(var_20_4, iter_20_3)
		local var_20_6 = var_14.GetModelUnit(var_20_5)

		table = var_20_4

		local var_20_7 = var_20_4.insert
		local var_20_8 = arg_20_1

		IslandFollowerUnitVO = var_1_10019

		var_20_7(var_20_8, var_1_10019.New(var_14.id, iter_20_3, var_20_6, var_20_1, var_20_2, iter_20_2 == 1))
	end
...
function var_0_0.CollectSystems(arg_21_0, arg_21_1, arg_21_2, arg_21_3, arg_21_4)
	...
	if var_5.island_map[arg_21_3].minigame_id > 0 then
		...
		var_21_0(var_21_1, var_21_2(var_21_3, var_1_10012.SEEK_GAME_SYSTEM_ID))
	else
		...
		if arg_21_3 == var_21_0.AGORA_MAP_ID then
			...
			IslandGrassLandSystemVO = var_9

			local var_21_9 = var_9.New

			IslandConst = var_11

			var_21_7(var_21_8, var_21_9(var_11.AGORA_GRASSLAND))
		end
	end
...
function var_0_0.CollectManageSystem(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	local var_22_1 = arg_22_2.GetManageAgency(var_22_0)
	local var_22_2 = var_4.GetRestaurants(var_22_1)

	pairs = var_22_0

	for iter_22_0, iter_22_1 in var_22_0(var_22_2) do
		if iter_22_1:getConfig("map_id") == arg_22_3 then
			IslandManageSystemVO = var_11

			local var_22_3 = var_11.New(iter_22_1.id, iter_22_1)

			table = var_1_10012

			var_1_10012.insert(arg_22_0, var_22_3)

			var_1_10012 = iter_22_1:GetStatus()
			IslandRestaurant = var_13

			if var_1_10012 == var_13.STATUS.OPENING then
				ipairs = var_1_10012

				for iter_22_2, iter_22_3 in var_1_10012(var_22_3:GetUnits()) do
					table = var_1_10017
...
function var_0_0.CollectPordunctSystem(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	...
	for iter_23_0, iter_23_1 in var_9(var_1_10011.FactorytPlaces) do
		table = var_1_10014
	...
	for iter_23_2, iter_23_3 in var_9(var_23_0) do
		...
		IslandCharacterSystemVO = var_1_10015
		var_1_10015 = var_1_10015.New(iter_23_3, var_23_4, arg_23_2.id)

		local var_23_5 = var_23_1:GetBuilding(iter_23_3)
		local var_23_6 = 0

		if var_23_5 then
			local var_23_7 = var_23_5:GetShipIdAndAreaIdList()

			ipairs = var_19

			for iter_23_4, iter_23_5 in var_19(var_23_7) do
				IslandProductConst = var_1_10024

				if iter_23_3 ~= var_1_10024.MinePlaceId then
					local var_23_8 = var_1_10015

					var_1_10024 = var_1_10015.GetUnit

					local var_23_9 = iter_23_5.ship_id
					local var_23_10 = iter_23_5.area_id

					table = iter_23_9
					var_1_10024 = var_1_10024(var_23_8, var_23_9, var_23_10, iter_23_9.contains(var_23_3, iter_23_3))
					table = var_1_10025

					var_1_10025.insert(arg_23_1, var_1_10024)
				end

				var_23_6 = var_23_6 + 1
			end

			var_1_10015:SetkCurrentWorkerList(var_23_7)
		end

		var_1_10015:SetWorkerCnt(var_23_6)

		table = var_18

		var_18.insert(arg_23_0, var_1_10015)

		if var_23_4 then
			table = var_18

			local var_23_11 = var_18.contains

			IslandProductConst = var_20

			if var_23_11(var_20.havePerformPlace, iter_23_3) then
				local var_23_12

				if var_23_5 then
					var_23_12 = var_23_5:GetDelegateingSlotAndFormulaList()
					ipairs = var_19

					for iter_23_6, iter_23_7 in var_19(var_23_12) do
						var_1_10024 = var_23_4:GetDelegateUnitsByBuildIdAndSlotId(iter_23_3, iter_23_7.area_id, iter_23_7.formula_id)
						ipairs = var_1_10025

						for iter_23_8, iter_23_9 in var_1_10025(var_1_10024) do
							table = var_1_10030
						...
						if var_23_4.GetDelegateEffectsByCommissonId(var_23_13, iter_23_7.area_id) and var_23_4:GenUnitByDelegateEffectId(var_1_10025) then
							table = var_23_13

							var_23_13.insert(arg_23_1, var_26)
						end
					end
				end
				...
				var_23_12.insert(arg_23_0, var_23_4)
			end
		end
	end
...
function var_0_0.SceneData2IslandUnits(arg_25_0, arg_25_1, arg_25_2, arg_25_3, arg_25_4, arg_25_5, arg_25_6)
	...
	for iter_25_0, iter_25_1 in var_1_10008(var_25_0) do
		pg = var_1_10013
		var_1_10014 = var_1_10013.island_world_objects[iter_25_1].unitId

		if 0 < var_1_10014 then
			var_1_10014 = var_1_10013.gen_type
			IslandConst = var_15

			if var_1_10014 ~= var_15.UNIT_GEN_TYPE_STATIC then
				var_1_10014 = var_1_10013.gen_type
				IslandConst = var_15

				if var_1_10014 == var_15.UNIT_GEN_TYPE_DYNAMIC then
					var_1_10014 = var_0_0.WorldObj2IslandUnit(var_1_10013)
					table = var_15

					var_15.insert(arg_25_0, var_1_10014)

					goto label_25_0
				end

				var_1_10014 = var_1_10013.unitId

				if 0 < var_1_10014 then
					var_1_10014 = var_1_10013.gen_type
					IslandConst = var_15

					if var_1_10014 == var_15.UNIT_GEN_TYPE_ACTIVITY then
						var_1_10014 = var_0_0.WorldObj2IslandUnit(var_1_10013)
						table = var_15

						var_15.insert(arg_25_1, var_1_10014)
					end
				end
	...
	for iter_25_2, iter_25_3 in var_8(arg_25_2) do
		if iter_25_3:IsSelf() then
			local var_25_1 = var_0_0.PlayerData2IslandUnit(iter_25_3, arg_25_3, arg_25_6, arg_25_4, arg_25_5)

			table = var_1_10014

			var_1_10014.insert(arg_25_0, var_25_1)
		end
	end

	local var_25_2 = var_0_0.TakePhotoData2IslandUnit(2)

	table = var_9

	var_9.insert(arg_25_0, var_25_2)

	local var_25_3 = var_0_0.TakePhotoData2IslandUnit(3)

	table = var_10

	var_10.insert(arg_25_0, var_25_3)
...
function var_0_0.IslandCheaterTavernPlayerDataToUnit(arg_31_0)
	...
	local var_31_2 = var_3.island_world_objects[var_31_1]
	local var_31_3 = {
		id = arg_31_0.id,
...
function var_0_0.GenInteractUnitByAgoraFurniture(arg_35_0)
	...
	IslandConst = var_4
	var_35_1.type = var_4.UNIT_TYPE_VIRTUAL_INTERACT
	...
	IslandConst = var_4
	var_35_1.genType = var_4.UNIT_GEN_TYPE_SYSTEM
