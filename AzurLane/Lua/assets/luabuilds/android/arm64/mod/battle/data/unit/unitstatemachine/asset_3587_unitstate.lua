...
function var_0.Battle.UnitState.FreshActionKeyOffset(arg_2_0)
	if arg_2_0:ActionKeyOffset() then
		string = var_1_10002

		if var_1_10002.find(arg_2_0._currentAction, var_1) == nil then
			arg_2_0:SendAction(arg_2_0._currentAction .. var_1)
		end
	elseif arg_2_0._offset ~= nil then
		string = var_2

		local var_2_0 = var_2.find(arg_2_0._currentAction, arg_2_0._offset)
		local var_2_1 = arg_2_0
		local var_2_2 = arg_2_0.SendAction

		string = var_1_10006

		var_2_2(var_2_1, var_1_10006.sub(arg_2_0._currentAction, 1, var_2_0 - 1))
	end
