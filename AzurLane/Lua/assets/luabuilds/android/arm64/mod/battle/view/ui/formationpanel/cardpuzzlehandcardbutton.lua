...
function var_0_3.UpdateTotalCost(arg_3_0)
	if arg_3_0._cardInfo then
		...
		var_1(var_3_0, var_4.GetTotalCost(var_3_1))
	end
...
function var_0_3.init(arg_5_0)
	...
	for iter_5_0 = 1, 3 do
		...
		var_1_10005(var_5_4, var_8.Find(var_5_5, "card_type_" .. iter_5_0))
	end
	...
	for iter_5_1 = 0, 4 do
		...
		var_1_10005(var_5_7, var_8.Find(var_5_8, "rarity_" .. iter_5_1))
	end
...
function var_0_3.updateCardView(arg_7_0)
	...
	if arg_7_0._cardInfo then
		...
		var_7_5(var_7_0, var_4.GetTotalCost(var_7_1))
		...
		var_7_5(var_7_2, var_4.GetCardTemplate(var_7_3).name)
		...
		for iter_7_0, iter_7_1 in var_7_4(arg_7_0._cardRarityList) do
		...
		var_3(var_7_8 .. var_6.GetIconID(var_7_9), "", arg_7_0._icon)
	else
		setActive = var_7_5
