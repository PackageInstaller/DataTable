...
class = var_0_10003
var_0_2.SpellState = var_0_10003("SpellState", var_0.Battle.IUnitState)
var_0.Battle.SpellState.__name = "SpellState"

local var_0_3 = var_0.Battle.SpellState
...
function var_0_3.AddAttackState(arg_5_0, arg_5_1, arg_5_2)
	local var_5_0 = arg_5_1:GetTarget()

	if var_3.GetSpeed(var_5_0).x >= 0 then
