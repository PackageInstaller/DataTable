...
function ys.Battle.BattleBuffFixAmmo.SetArgs(arg_2_0, arg_2_1, arg_2_2)
	arg_2_0._damageRate = arg_2_0._tempData.arg_list.damage_rate

	return
end

function ys.Battle.BattleBuffFixAmmo.onAttach(arg_3_0, arg_3_1, arg_3_2)
	arg_3_0:updateAmmo(arg_3_1, arg_3_0._damageRate)

	return
end

function ys.Battle.BattleBuffFixAmmo.onRemove(arg_4_0, arg_4_1, arg_4_2)
	arg_4_0:updateAmmo(arg_4_1)

	return
end

function ys.Battle.BattleBuffFixAmmo.updateAmmo(arg_5_0, arg_5_1, arg_5_2)
