...
function var_0_3.UpdateCollideUnitList(arg_4_0, arg_4_1)
	if #arg_4_0._diveFilter ~= 0 then
		...
		while var_4_0 > 0 do
			...
			for iter_4_0, iter_4_1 in var_1_10004(arg_4_0._diveFilter) do
...
function var_0_3.updateReload(arg_10_0)
	if arg_10_0._CDstartTime then
		local var_10_0 = arg_10_0:getReloadFinishTimeStamp()

		pg = var_1_10002

		local var_10_1 = var_1_10002.TimeMgr.GetInstance()

		if var_10_0 <= var_2.GetCombatTime(var_10_1) then
