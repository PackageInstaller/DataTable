...
function var_0_2.CanDealDamage(arg_7_0)
	if not arg_7_0._nextDamageTime then
		...
		arg_7_0._nextDamageTime = var_1.GetCombatTime(var_7_0) + arg_7_0._tempData.extra_param.alert_duration

		return false
	else
		local var_7_1 = arg_7_0._nextDamageTime

		pg = var_1_10002

		local var_7_2 = var_1_10002.TimeMgr.GetInstance()

		return var_7_1 < var_2.GetCombatTime(var_7_2)
	end
