...
ys = var_0_10001
var_0_10001.Battle.BattleGateBossSingleVariable = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	SYSTEM_BOSS_SINGLE_VARIABLE = var_1_10024
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	if arg_4_0.statistics.submarineAid then
		...
		if var_10[var_4_18 + var_1_10019.MEGA_SUBMARINE_FLEET_OFFSET] then
			var_4_19 = var_17
	...
	local function var_4_23(arg_6_0)
		...
		if var_6_4 then
			...
			if arg_4_0.useVariableTicket == 1 then
				math = var_6_7
				var_5.data1 = var_6_7.max(var_5.data1 - 1, 0)
			end
		end

		local var_6_11 = {}

		SYSTEM_BOSS_SINGLE_VARIABLE = var_6_9
...
function var_0_0.GetPreloadList(arg_7_0)
	...
	local var_7_4 = var_1_10005(var_1_10007)

	getProxy = var_1_10006
	BayProxy = var_1_10008

	local var_7_5 = var_1_10006(var_1_10008)
	...
	if var_7_4:getActivityFleets()[arg_7_0.actId][arg_7_0.mainFleetId] then
		...
		for iter_7_2, iter_7_6 in var_1_10010(var_7_6) do
			table = var_1_10015
			...
			var_1_10015(var_7_7, var_7_5.getShipById(var_1_10020, iter_7_6))
		end

		local var_7_8 = var_8:buildBattleBuffList()

		ipairs = var_1_10010

		for iter_7_2, iter_7_6 in var_1_10010(var_7_8) do
			table = var_1_10015

			var_1_10015.insert(var_7_1, iter_7_6)
		end
	end

	local var_7_9 = arg_7_0.mainFleetId

	Fleet = var_1_10010

	if var_7[var_7_9 + var_1_10010.MEGA_SUBMARINE_FLEET_OFFSET] then
		local var_7_10 = var_9
		local var_7_11 = var_9.getTeamByName

		TeamType = iter_7_2

		local var_7_12 = var_7_11(var_7_10, iter_7_2.Submarine)

		ipairs = var_1_10011

		for iter_7_6, iter_7_5 in var_1_10011(var_7_12) do
			table = var_1_10016

			var_1_10016.insert(var_7_0, var_7_5:getShipById(iter_7_5))
		end

		local var_7_13 = var_9:buildBattleBuffList()

		ipairs = var_11

		for iter_7_6, iter_7_7 in var_11(var_7_13) do
			table = var_1_10016
	...
	local var_7_14, var_7_15 = var_7_3.GetPlayerShipResource(var_7_0, arg_7_0.system)

	getProxy = var_12
	ActivityProxy = iter_7_6

	local var_7_16 = var_12(iter_7_6)
	local var_7_17 = var_12.getActivityById(var_7_16, arg_7_0.actId)
	local var_7_18 = var_7_3.GetResFromBuffIDList(var_7_17:GetBuffIdsByStageId(arg_7_0.stageId))

	ipairs = var_13

	for iter_7_8, iter_7_9 in var_13(var_7_18) do
		table = var_18

		var_18.insert(var_7_14, iter_7_9)
	end

	pg = var_13

	local var_7_19 = var_13.strategy_data_template
	local var_7_20 = {}
	...
	for iter_7_10, iter_7_11 in var_15(arg_7_0.variableBuffList) do
		...
		var_1_10020.insert(var_7_20, var_7_19[iter_7_11].buff_id)
	end

	local var_7_21 = var_7_3.GetResFromBuffIDList(var_7_20)

	ipairs = var_15

	for iter_7_12, iter_7_13 in var_15(var_7_21) do
		table = var_1_10020

		var_1_10020.insert(var_7_14, iter_7_13)
	end

	local var_7_22 = var_7_3.GetCommanderBuffRes(var_7_1)

	ipairs = var_15

	for iter_7_14, iter_7_15 in var_15(var_7_22) do
		table = var_1_10020

		var_1_10020.insert(var_7_14, iter_7_15)
	end

	return var_7_14, var_7_15
end
