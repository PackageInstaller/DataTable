...
function var_0.Battle.BattleDamageRateView.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.tick_bar = var_1_2(var_1_1, var_5(var_1_10007))
...
function var_0.Battle.BattleDamageRateView.UpdateScore(arg_2_0, arg_2_1, arg_2_2)
	...
	var_1_10004.cancel(arg_2_0.tickBarOb)

	LeanTween = var_4

	local var_2_1 = var_4.value(arg_2_0.tickBarOb, arg_2_0.tick_bar.fillAmount, var_2_0, 0.5)
	local var_2_2 = var_4.setOnUpdate

	System = var_7

	var_2_2(var_2_1, var_7.Action_float(function(arg_3_0)
