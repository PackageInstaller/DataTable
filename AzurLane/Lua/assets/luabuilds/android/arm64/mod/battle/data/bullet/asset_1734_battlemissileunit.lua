...
function var_0_7.CompleteRise(arg_9_0)
	...
	local var_9_1 = arg_9_0.GetTemplate(var_9_0).extra_param.fallTime

	arg_9_0._targetPos = arg_9_0._explodePos
	math = var_2

	local var_9_2 = var_2.rad2Deg

	math = var_9_0
	arg_9_0._yAngle = var_9_2 * var_9_0.atan2(arg_9_0._explodePos.z - arg_9_0._spawnPos.z, arg_9_0._explodePos.x - arg_9_0._spawnPos.x)
	arg_9_0._verticalSpeed = -(arg_9_0._position.y / var_9_1) * var_0_8
	pg = var_2

	local var_9_3 = var_2.Tool.FilterY(arg_9_0._explodePos - arg_9_0._position)
	local var_9_4 = var_2.Magnitude(var_9_3)

	arg_9_0:ResetVelocity(var_0_5.ConvertBulletDataSpeed(var_9_4 / var_9_1 * var_0_8))
	arg_9_0:calcSpeed()
