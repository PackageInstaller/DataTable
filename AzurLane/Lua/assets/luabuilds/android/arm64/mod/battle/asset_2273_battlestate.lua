...
function var_0_3.IsAutoBotActive(arg_3_0)
	...
	if var_1_10002.GetInt("autoBotIsAcitve" .. var_3_0, 0) == 1 then
...
function var_0_3.IsAutoSubActive(arg_4_0)
	...
	return var_1_10002.GetInt("autoSubIsAcitve" .. var_4_0, 0) == 1
end
...
function var_0_3.ChatUseable(arg_5_0)
	...
	HIDE_CHAT_FLAG = var_1_10003

	local var_5_1 = not var_5_0(var_1_10003) or var_1 ~= 1
	local var_5_2 = arg_5_0
	local var_5_3 = arg_5_0.GetBattleType(var_5_2)
	local var_5_4 = arg_5_0.IsAutoBotActive(var_5_3)

	SYSTEM_DUEL = var_5_2

	local var_5_5 = var_5_3 == var_5_2

	SYSTEM_CARDPUZZLE = var_6

	local var_5_6 = var_5_3 == var_6

	return var_5_1 and (var_5_5 or var_5_4) and not var_5_6
end
...
function var_0_3.ChangeState(arg_18_0, arg_18_1)
	...
	if arg_18_1 == var_0_3.BATTLE_STATE_OPENING then
		...
		if var_1_10003(var_1_10005) then
			...
			var_18_0 = var_3.GetContinuousData
			SYSTEM_SCENARIO = var_1_10007
			var_18_0 = var_18_0(var_18_2, var_1_10007)
		end
		...
		if var_18_1 then
			if var_18_0 then
				...
				var_1_10005.ForceAutoPlay(var_18_3, var_18_1, function()
				...
				local var_18_4 = var_1_10005.NewStoryMgr.GetInstance()

				var_5.Play(var_18_4, var_18_1, function()
			...
			local var_18_5 = arg_18_0._battleCommand

			var_5.DoPrologue(var_18_5)
		end
	elseif arg_18_1 == var_0_3.BATTLE_STATE_FIGHT then
		arg_18_0:ActiveAutoComponentTimer()

		local var_18_6 = arg_18_0._dataProxy

		if not var_2.GetFleetLegal(var_18_6, var_0.Battle.BattleConfig.FRIENDLY_CODE, arg_18_0:GetBattleType()) then
			local var_18_7 = arg_18_0._battleCommand

			var_2.CalcStatistic(var_18_7)
			arg_18_0:BattleEnd()
		end
...
function var_0_3.BattleEnd(arg_23_0)
	...
	if var_1.GetStatistics(var_23_0)._battleScore >= var_0.Battle.BattleConst.BattleScore.B then
		...
		var_23_2(var_23_1, var_4.GetFriendlyCode(var_23_3))
...
function var_0_3.DoResult(arg_27_0)
	...
	var_27_2(var_27_1, var_4.GetBotActiveDuration(var_27_3))
	...
	var_27_5(var_3.GetStatistics(var_27_6))
...
function var_0_3.Stop(arg_29_0, arg_29_1)
	local var_29_0 = arg_29_0:GetBattleType()

	SYSTEM_TEST = var_1_10003

	if var_29_0 == var_1_10003 then
		local var_29_1
		...
		var_2.ShowTips(var_29_2, "interrupt")
	end

	arg_29_0:disableCommon()

	local var_29_3 = arg_29_0._baseUI

	var_2.exitBattle(var_29_3, arg_29_1)
...
function var_0_3.SetTakeoverProcess(arg_33_0, arg_33_1)
	...
	if arg_33_1.Pause ~= nil then
		...
		if var_4(arg_33_1.Pause) ~= "function" then
			var_33_0 = false
		else
			var_33_0 = true
		end
		...
		if arg_33_1.Pause ~= nil then
			...
			if var_4(arg_33_1.Resume) ~= "function" then
				var_33_1 = false
			else
				var_33_1 = true
			end
