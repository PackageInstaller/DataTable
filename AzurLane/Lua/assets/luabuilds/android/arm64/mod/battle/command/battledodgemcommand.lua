...
function var_0_3.onWillDie(arg_9_0, arg_9_1)
	...
	local var_9_3 = var_9_0.GetDeathReason(var_9_2)
	local var_9_4 = var_9_0:GetTemplate().type

	ShipType = var_9_2

	if var_9_4 == var_9_2.JinBi and var_9_3 == var_0.Battle.BattleConst.UnitDeathReason.CRUSH then
