...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0._hpBarProgress = var_1_2(var_1_1, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0._hpBarText = var_1_5(var_1_4, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0._lvText = var_1_7(var_1_6, var_5(var_1_10007))
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0._typeIcon = var_1_9(var_1_8, var_5(var_1_10007))
...
function var_0_1.SwitchTarget(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_1 = arg_5_1.GetHPRate(var_5_0)

	arg_5_0._hpBarProgress.fillAmount = var_5_1

	arg_5_0:UpdateHpText(arg_5_1)
	arg_5_0:SetIconType(arg_5_1:GetTemplate().icon_type ~= 0)

	local var_5_2 = var_0.Battle.BattleDataFunction.GetEnemyTypeDataByType
	local var_5_3 = arg_5_1
	local var_5_4 = var_5_2(arg_5_1.GetTemplate(var_5_3).type).type

	GetSpriteFromAtlas = var_5_0

	local var_5_5 = "shiptype"

	shipType2Battleprint = var_5_3

	local var_5_6 = var_5_0(var_5_5, var_5_3(var_5_4))
...
function var_0_1.UpdateHpText(arg_6_0)
	...
	local var_6_4 = var_1_10006.floor(var_6_1)
	local var_6_5 = "/"

	math = var_8
	var_6_3.text = var_1_10004(var_6_4 .. var_6_5 .. var_8.floor(var_6_2))
...
function var_0_1.UpdateHpBar(arg_7_0)
	...
	var_7_3(var_7_2, var_1_10005)

	if var_7_1 < arg_7_0._hpBarProgress.fillAmount then
		LeanTween = var_7_0

		local var_7_4 = var_7_0.value(arg_7_0._hpBar, var_2, var_7_1, 0.5)
		local var_7_5 = var_3.setOnUpdate

		System = var_6

		var_7_5(var_7_4, var_6.Action_float(function(arg_8_0)
