...
function var_0_3.UpdateShadow(arg_13_0)
	if arg_13_0._shadow then
		...
		if var_1.GetCurrentState(var_13_0) == arg_13_0._unitData.STATE_CREATE then
			...
			local var_13_3 = var_2.min
			local var_13_4 = 4

			math = var_1_10005

			local var_13_5 = var_13_3(var_13_4, var_1_10005.max(2, 4 - 4 * var_13_2.y / var_0.Battle.BattleConfig.AircraftHeight))
...
function var_0_3.AddModel(arg_17_0, arg_17_1)
	...
	arg_17_0._hpBarOffset = var_2(var_17_0, var_5.GetBoxSize(var_17_1).y, 0)
...
function var_0_3.AddHPBar(arg_19_0, arg_19_1)
	...
	typeof = var_5
	Image = var_1_10007
	arg_19_0._HPProgress = var_19_2(var_19_1, var_5(var_1_10007))
