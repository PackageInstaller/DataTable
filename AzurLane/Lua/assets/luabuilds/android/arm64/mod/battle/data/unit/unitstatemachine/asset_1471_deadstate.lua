...
class = var_0_10003
var_0_2.DeadState = var_0_10003("DeadState", var_0.Battle.IUnitState)
var_0.Battle.DeadState.__name = "DeadState"

local var_0_3 = var_0.Battle.DeadState
...
function var_0_3.OnEnd(arg_20_0, arg_20_1)
	local var_20_0 = arg_20_1:GetTarget()

	var_2.SendDeadEvent(var_20_0)
...
function var_0_3.GetActionName(arg_23_0, arg_23_1, arg_23_2)
	local var_23_0
	local var_23_1 = arg_23_1:GetTarget()
	local var_23_2 = var_4.GetOxyState(var_23_1)
	local var_23_3 = arg_23_1:ActionKeyOffset()

	if var_23_2 and var_23_2:GetCurrentDiveState() == var_0.Battle.BattleConst.OXY_STATE.DIVE then
		var_23_0 = var_0_1.DEAD_SWIM
	elseif var_23_3 ~= nil then
		var_23_0 = var_0_1.DEAD .. var_23_3
	else
