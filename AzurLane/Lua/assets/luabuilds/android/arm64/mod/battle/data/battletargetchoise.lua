...
function var_0_4.TargetEntityUnit()
	...
	for iter_4_0, iter_4_1 in var_1_10002(var_4_2) do
...
function var_0_4.TargetSpectreUnit(arg_5_0, arg_5_1, arg_5_2)
	...
	for iter_5_0, iter_5_1 in var_1_10005(var_5_2) do
...
function var_0_4.TargetTemplate(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0, iter_6_1 in var_1_10007(var_6_1) do
		...
		local var_6_5 = iter_6_1.GetTemplateID(var_6_4)
		local var_6_6 = iter_6_1:GetIFF()

		table = var_6_4

		if var_6_4.contains(var_6_0, var_6_5) and var_6_3 == var_6_6 then
...
function var_0_4.TargetNationality(arg_7_0, arg_7_1, arg_7_2)
	...
	for iter_7_0, iter_7_1 in var_1_10008(var_1_10004) do
...
function var_0_4.TargetShipType(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0, iter_8_1 in var_1_10006(var_8_0) do
		...
		if var_1_10012.contains(var_8_2, var_8_3) then
...
function var_0_4.TargetAllHelp(arg_12_0, arg_12_1, arg_12_2)
	...
	if arg_12_0 then
		...
		local var_12_4 = arg_12_0.GetIFF(var_12_3)
		local var_12_5 = arg_12_2 or var_0_4.getShipListByIFF(var_12_4)

		pairs = var_12_3

		for iter_12_0, iter_12_1 in var_12_3(var_12_5) do
			local var_12_6 = iter_12_1:GetUniqueID()

			if iter_12_1:IsAlive() and iter_12_1:GetIFF() == var_12_4 and (not var_12_1 or var_12_6 ~= var_12_2) then
...
function var_0_4.TargetHelpLeastHP(arg_13_0, arg_13_1, arg_13_2)
	...
	if arg_13_0 then
		local var_13_2 = arg_13_2 or var_0_4.getShipListByIFF(arg_13_0:GetIFF())
		local var_13_3 = 9999999999

		pairs = var_1_10007

		for iter_13_0, iter_13_1 in var_1_10007(var_13_2) do
...
function var_0_4.TargetShipTypeFriendly(arg_27_0, arg_27_1, arg_27_2)
	...
	if arg_27_0 then
		...
		for iter_27_0, iter_27_1 in var_1_10006(var_27_2) do
			...
			if var_1_10012.contains(var_27_1, var_27_3) then
...
function var_0_4.TargetAllHarm(arg_29_0, arg_29_1, arg_29_2)
	...
	local var_29_4 = var_1_10006.Battle.BattleDataProxy.GetInstance()

	if arg_29_2 then
		var_29_1 = {}
		ipairs = var_29_2

		for iter_29_0, iter_29_1 in var_29_2(arg_29_2) do
	...
	if var_29_1 then
		...
		for iter_29_2, iter_29_3 in iter_29_1(var_29_1) do
			if iter_29_3:IsAlive() and var_29_8 > iter_29_3:GetPosition().x then
				local var_29_9 = iter_29_3:GetCurrentOxyState()

				ys = var_1_10017

				if var_29_9 ~= var_1_10017.Battle.BattleConst.OXY_STATE.DIVE then
...
function var_0_4.TargetAllFoe(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_4 = var_1_10006.Battle.BattleDataProxy.GetInstance()

	if arg_30_2 then
		var_30_1 = {}
		ipairs = var_30_2

		for iter_30_0, iter_30_1 in var_30_2(arg_30_2) do
...
function var_0_4.TargetFoeUncloak(arg_31_0, arg_31_1, arg_31_2)
	...
	local var_31_4 = var_1_10006.Battle.BattleDataProxy.GetInstance()

	if arg_31_2 then
		var_31_1 = {}
		ipairs = var_31_2

		for iter_31_0, iter_31_1 in var_31_2(arg_31_2) do
	...
	if var_31_1 then
		...
		for iter_31_2, iter_31_3 in iter_31_1(var_31_1) do
			if iter_31_3:IsAlive() and var_31_8 > iter_31_3:GetPosition().x and not var_0_2.IsCloak(iter_31_3) then
				local var_31_9 = iter_31_3:GetCurrentOxyState()

				ys = var_1_10017

				if var_31_9 ~= var_1_10017.Battle.BattleConst.OXY_STATE.DIVE then
	...
	if var_41_1 == var_1_10007.Battle.BattleConst.UnitDir.RIGHT then
		...
		for iter_41_0, iter_41_1 in var_7(var_41_0) do
			if var_41_2 <= iter_41_1:GetPosition().x then
				...
				var_1_10013.insert(var_41_3, iter_41_1)
			end
		end
	else
		ys = var_7
		...
		if var_41_1 == var_7.Battle.BattleConst.UnitDir.LEFT then
			...
			for iter_41_2, iter_41_3 in var_7(var_41_0) do
				if var_41_2 >= iter_41_3:GetPosition().x then
					...
					var_1_10013.insert(var_41_3, iter_41_3)
				end
			end
		end
	end
...
function var_0_4.TargetAircraftHelp(arg_42_0)
	...
	for iter_42_0, iter_42_1 in var_1_10004(var_42_0:GetAircraftList()) do
...
function var_0_4.TargetAircraftHarm(arg_43_0)
	...
	for iter_43_0, iter_43_1 in var_1_10004(var_43_0:GetAircraftList()) do
...
function var_0_4.TargetAircraftGB(arg_44_0)
	...
	for iter_44_0, iter_44_1 in var_1_10004(var_44_0:GetAircraftList()) do
...
function var_0_4.TargetFatalDamageSrc(arg_47_0, arg_47_1, arg_47_2)
	...
	local var_47_2 = arg_47_0.GetDeathSrcID(var_47_1)
	local var_47_3 = {}

	if var_47_2 then
		pairs = var_47_1

		for iter_47_0, iter_47_1 in var_47_1(var_47_0) do
			if var_47_2 == iter_47_1:GetUniqueID() and iter_47_1:IsAlive() then
				var_47_3[#var_47_3 + 1] = iter_47_1
			end
		end
	end
...
function var_0_4.TargetAllHarmBullet(arg_48_0)
	...
	for iter_48_0, iter_48_1 in var_1_10004(var_48_0:GetBulletList()) do
...
function var_0_4.TargetAllHarmBulletByType(arg_49_0, arg_49_1)
	...
	for iter_49_0, iter_49_1 in var_1_10005(var_49_0:GetBulletList()) do
...
function var_0_4.TargetAllHarmTorpedoBullet(arg_50_0)
	...
	return var_50_0(var_50_1, var_1_10004.Battle.BattleConst.BulletType.TORPEDO)
end
...
function var_0_4.TargetFleetIndex(arg_51_0, arg_51_1)
	...
	local var_51_3 = var_1_10004.TeamPos
	local var_51_4 = arg_51_1.fleetPos
	local var_51_5 = {}
	local var_51_6 = var_51_2:GetUnitList()
	local var_51_7 = var_51_2
	local var_51_8 = var_51_2.GetScoutList(var_51_7)

	if arg_51_1.exceptCaster then
		var_51_7 = arg_51_0:GetUniqueID()
	end

	ipairs = var_51_7

	for iter_51_0, iter_51_1 in var_51_7(var_51_6) do
		local var_51_9 = iter_51_1:GetUniqueID()

		if var_9 then
			casterID = var_1_10016

			if var_51_9 == var_1_10016 then
				goto label_51_0
			end
		end
		...
		if iter_51_1 == var_51_2:GetFlagShip() then
			if var_51_4 == var_51_3.FLAG_SHIP then
				...
				var_1_10016.insert(var_51_5, iter_51_1)
			end
		elseif iter_51_1 == var_51_8[1] then
			if var_51_4 == var_51_3.LEADER then
				table = var_1_10016

				var_1_10016.insert(var_51_5, iter_51_1)
			end
		elseif #var_51_8 == 3 and iter_51_1 == var_51_8[2] then
			if var_51_4 == var_51_3.CENTER then
				table = var_1_10016

				var_1_10016.insert(var_51_5, iter_51_1)
			end
		elseif iter_51_1 == var_51_8[#var_51_8] then
	...
	local var_51_10 = var_51_2:GetSubList()

	ipairs = var_11

	for iter_51_2, iter_51_3 in var_11(var_51_6) do
		if iter_51_2 == 1 then
...
function var_0_4.TargetEnemyLeaderShip(arg_56_0, arg_56_1, arg_56_2)
	...
	local var_56_1 = var_1_10004.Battle.BattleDataProxy.GetInstance()
	local var_56_2 = var_4.GetFleetByIFF(var_56_1, var_56_0)

	return {
		var_56_2:GetLeaderShip()
	}
end
...
function var_0_4.TargetPlayerAidUnit(arg_58_0, arg_58_1)
	...
	for iter_58_0, iter_58_1 in var_58_0(var_58_1) do
		table = var_1_10009
...
function var_0_4.TargetTeam(arg_62_0, arg_62_1, arg_62_2)
	...
	local var_62_3 = var_62_0.TeamTypeIndex[arg_62_1.teamIndex]

	TeamType = var_6

	if var_62_3 == var_6.Vanguard then
		var_62_2 = var_62_1:GetScoutList()
	else
		TeamType = var_6

		if var_62_3 == var_6.Main then
			var_62_2 = var_62_1:GetMainList()
		else
			TeamType = var_6

			if var_62_3 == var_6.Submarine then
				var_62_2 = var_62_1:GetSubList()
			end
		end
	end
...
function var_0_4.TargetGroup(arg_63_0, arg_63_1, arg_63_2)
	...
	for iter_63_0, iter_63_1 in var_1_10007(var_63_1) do
		local var_63_4 = iter_63_1:GetTemplateID()

		ys = var_1_10013
		var_1_10013 = var_1_10013.Battle.BattleDataFunction.GetPlayerShipModelFromID(var_63_4).group_type

		local var_63_5 = iter_63_1:GetIFF()

		table = var_15

		if var_15.contains(var_63_0, var_1_10013) and var_63_3 == var_63_5 then
...
function var_0_4.LegalTarget(arg_64_0)
	...
	local var_64_7 = var_3
	local var_64_8 = var_3.GetUnitList(var_64_7)
	local var_64_9 = arg_64_0:GetIFF()

	pairs = var_64_7

	for iter_64_0, iter_64_1 in var_64_7(var_64_8) do
...
function var_0_4.LegalWeaponTarget(arg_65_0)
	...
	local var_65_4 = arg_65_0:GetIFF()

	pairs = var_65_2

	for iter_65_0, iter_65_1 in var_65_2(var_65_3) do
		if iter_65_1:GetIFF() ~= var_65_4 and not iter_65_1:IsSpectre() then
