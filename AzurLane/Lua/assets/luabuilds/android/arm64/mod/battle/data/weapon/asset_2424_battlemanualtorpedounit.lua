...
function var_0_2.Fire(arg_8_0, arg_8_1)
	if arg_8_1 then
		...
		if var_0.Battle.BattleTargetChoise.TargetHarmRandomByWeight(arg_8_0._host, nil, arg_8_0:GetFilteredList())[1] then
			local var_8_0 = var_2
			local var_8_1 = var_2.GetPosition(var_8_0)
			local var_8_2 = arg_8_0._host
			local var_8_3 = var_4.GetPosition(var_8_2)

			math = var_8_0

			local var_8_4 = var_8_0.rad2Deg

			math = var_8_2
			arg_8_0._botAutoAimAngle = var_8_4 * var_8_2.atan2(var_8_1.z - var_8_3.z, var_8_1.x - var_8_3.x)
		else
