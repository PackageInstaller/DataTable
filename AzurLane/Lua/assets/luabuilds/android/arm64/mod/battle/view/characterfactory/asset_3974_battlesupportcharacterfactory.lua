...
local var_0_1 = var_0_10001("BattleSupportCharacterFactory", var_0.Battle.BattleCharacterFactory)

var_0.Battle.BattleSupportCharacterFactory = var_0_1
var_0_1.__name = "BattleSupportCharacterFactory"
...
function var_0_1.MakeCharacter(arg_2_0)
	return var_0.Battle.BattleSupportCharacter.New()
end
...
function var_0_1.MakeModel(arg_3_0, arg_3_1)
	...
	local function var_3_1(arg_4_0)
		...
		local var_4_6 = arg_3_1

		var_2.UpdateDiveInvisible(var_4_6, true)

		local var_4_7 = arg_3_1

		var_2.UpdateBlindInvisible(var_4_7)
