...
function var_0_9.HandleDamageToDeath(arg_21_0)
	...
	var_21_2(var_21_1, var_1_10005.floor(-arg_21_0._currentHP), var_21_0)
...
function var_0_9.UpdateHP(arg_22_0, arg_22_1, arg_22_2)
	...
	if not var_22_2 then
		...
		if var_22_13 ~= -var_22_14.damage then
			...
			var_1_10022 = arg_22_0

			arg_22_0.TriggerBuff(var_1_10022, var_0_3.BuffEffectType.ON_SHIELD_ABSORB, var_22_14)
		end
		...
		arg_22_0.TriggerBuff(var_1_10022, var_0_3.BuffEffectType.ON_TAKE_HEALING, var_1_10019)
	...
	local var_22_16 = arg_22_0:GetMaxHP()

	math = var_1_10022

	local var_22_17 = var_22_15(var_22_16, var_1_10022.max(0, arg_22_0._currentHP + arg_22_1)) - arg_22_0._currentHP
	...
	if not var_22_2 then
		var_22_14.validDHP = var_22_17

		arg_22_0:TriggerBuff(var_0_3.BuffEffectType.ON_DAMAGE_CONCLUDE, var_22_14)
	end

	if var_22_7 and not var_22_7:EqualZero() then
		local var_22_19 = arg_22_0:GetPosition()
		local var_22_20 = arg_22_0:GetBoxSize().x
		local var_22_21 = var_22_19.x - var_22_20
		local var_22_22 = var_22_19.x + var_22_20
		local var_22_23 = var_22_7:Clone()

		Mathf = var_1_10027
		var_22_23.x = var_1_10027.Clamp(var_22_23.x, var_22_21, var_22_22)
		var_22_18.posOffset = var_22_19 - var_22_23
	end

	if not var_22_10 then
		arg_22_0:UpdateHPAction(var_22_18)
	end
...
function var_0_9.ClearWeapon(arg_103_0)
	...
	if arg_103_0._airAssistList then
		...
		for iter_103_0, iter_103_1 in var_1_10002(var_1) do
			iter_103_1:Clear()
		end
	end
...
function var_0_9.GetBeenAimedPosition(arg_108_0)
	...
	if not arg_108_0.GetCLDZCenterPosition(var_108_0) then
		return var_1
	end

	local var_108_1

	if arg_108_0:GetTemplate() then
		var_108_1 = arg_108_0:GetTemplate().aim_offset
	end
...
function var_0_9.biasAimPosition(arg_109_0, arg_109_1)
	if var_0_6.GetCurrent(arg_109_0, "aimBias") > 0 then
		...
		local var_109_2 = var_5.random() * var_109_0 - var_2
...
function var_0_9.UpdateFormationOffset(arg_111_0, arg_111_1)
	...
	var_111_1(var_111_0, var_1_10005(arg_111_1.x, arg_111_1.y, arg_111_1.z))
...
function var_0_9.SetUncontrollableSpeedWithYAngle(arg_118_0, arg_118_1, arg_118_2, arg_118_3)
	...
	local var_118_1 = var_1_10007.cos(var_118_0)
	local var_118_2 = 0

	math = var_9

	local var_118_3 = var_1_10005(var_118_1, var_118_2, var_9.sin(var_118_0))
...
function var_0_9.EnterGCD(arg_129_0, arg_129_1, arg_129_2)
	...
	local var_129_3 = var_1_10005.TimeMgr.GetInstance()
...
function var_0_9.AddBuff(arg_134_0, arg_134_1, arg_134_2)
	...
	if arg_134_0.GetBuff(var_134_2, var_134_0) then
		if arg_134_2 then
			local var_134_3
			...
			var_134_2.insert(var_134_3, arg_134_1)

			arg_134_0._buffStockList[var_134_0] = var_134_3
		else
			local var_134_4 = var_5:GetLv()
			local var_134_5 = arg_134_1:GetLv()
			local var_134_6 = var_5
			local var_134_7 = var_5.GetGroupLevel(var_134_6)
			local var_134_8 = arg_134_1:GetGroupLevel()

			math = var_134_6
			var_134_1.buff_level = var_134_6.max(var_134_4, var_134_5)

			if var_5:IsForceStack() or var_134_8 <= var_134_7 then
...
function var_0_9.ConsumeBuffStack(arg_137_0, arg_137_1, arg_137_2)
	...
	if arg_137_0.GetBuff(var_137_0, arg_137_1) then
		if not arg_137_2 then
			arg_137_0:RemoveBuff(arg_137_1)
		else
			local var_137_1 = var_3:GetStack()
...
function var_0_9.DispatchVoice(arg_159_0, arg_159_1)
	...
	local var_159_1, var_159_2, var_159_3 = var_1_10003.GetWordAndCV(arg_159_0:GetSkinID(), arg_159_1, 1, true, var_159_0)
	...
	if var_159_2 then
		...
		arg_159_0:DispatchEvent(var_0.Event.New(var_0_1.VOICE, var_159_4))
	end
...
function var_0_9.Dispose(arg_199_0)
	...
	if arg_199_0._airAssistQueue then
		local var_199_1 = arg_199_0._airAssistQueue

		var_1.Clear(var_199_1)
	...
	if arg_199_0._airAssistList then
		...
		for iter_199_0, iter_199_1 in var_1_10002(var_1) do
			var_1_10009 = iter_199_1

			iter_199_1.Dispose(var_1_10009)
		end
	end

	ipairs = var_1_10002

	for iter_199_2, iter_199_3 in var_1_10002(arg_199_0._fleetAAList) do
		var_1_10009 = iter_199_3

		iter_199_3.Dispose(var_1_10009)
	end

	ipairs = var_2

	for iter_199_4, iter_199_5 in var_2(arg_199_0._fleetRangeAAList) do
		var_1_10009 = iter_199_5

		iter_199_5.Dispose(var_1_10009)
	end

	local var_199_2 = arg_199_0._buffList

	pairs = var_3

	for iter_199_6, iter_199_7 in var_3(var_199_2) do
		iter_199_7:Dispose()
	end

	local var_199_3 = arg_199_0._buffStockList

	pairs = var_4

	for iter_199_8, iter_199_9 in var_4(var_199_3) do
		pairs = var_1_10009
