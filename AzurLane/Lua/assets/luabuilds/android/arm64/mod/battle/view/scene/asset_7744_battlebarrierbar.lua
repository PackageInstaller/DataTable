...
function var_0_2.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0._clockCG = var_1_5(var_1_4, var_5(var_1_10007))
...
function var_0_2.Shielding(arg_2_0, arg_2_1)
	...
	local var_2_2 = var_4(arg_2_0._barrierClockGO)
...
function var_0_2.Interrupt(arg_3_0)
	...
	local var_3_2 = var_3(arg_3_0._barrierClockGO)

	Vector3 = var_1_10004

	local var_3_3 = var_3_1(var_3_2, var_1_10004.New(0.1, 0.1, 1), 0.3)
	local var_3_4 = var_1.setEase

	LeanTweenType = var_4

	local var_3_5 = var_3_4(var_3_3, var_4.easeInBack)
