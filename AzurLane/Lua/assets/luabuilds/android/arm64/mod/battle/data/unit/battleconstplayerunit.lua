...
ys = var_0_10004
var_0_0.BattleConstPlayerUnit = var_0_10001(var_0_1, var_0_10004.Battle.BattlePlayerUnit)
ys = var_0_0
...
function var_0_3.setWeapon(arg_1_0, arg_1_1)
	...
	for iter_1_0 = 1, #var_1_0 do
		...
		var_1_10008(var_1_2, var_1_10011)
	end

	local var_1_3 = arg_1_0._proficiencyList
	local var_1_4 = arg_1_0._tmpData.preload_count
	...
	for iter_1_1, iter_1_2 in var_6(var_1_0) do
		...
		if iter_1_1 <= var_1_10011.WEAPON_COUNT then
			var_1_10011 = var_1_3[iter_1_1]

			local var_1_5 = var_1_4[iter_1_1]
			...
			local function var_1_6(arg_2_0, arg_2_1, arg_2_2)
				...
				for iter_2_0 = 1, var_2_0 do
					...
					if iter_2_0 <= var_1_5 and (var_2_3 == var_0_4.POINT_HIT_AND_LOCK or var_2_3 == var_0_4.MANUAL_TORPEDO or var_2_3 == var_0_4.DISPOSABLE_TORPEDO) then
	...
	local var_1_9 = arg_1_0._tmpData.fix_equip_list

	ipairs = var_8

	for iter_1_3, iter_1_4 in var_8(var_1_9) do
		if iter_1_4 and iter_1_4 ~= -1 then
			local var_1_10

			if not var_1_3[iter_1_3 + var_1_8] then
				var_1_10 = 1
			end

			arg_1_0:AddWeapon(iter_1_4, nil, nil, var_1_10, iter_1_3 + var_1_8)
		end
	end
...
function var_0_3.HideWaveFx(arg_4_0)
	...
	local var_4_2 = var_1_10004.Event.New

	ys = var_1_10006

	var_4_1(var_4_0, var_4_2(var_1_10006.Battle.BattleUnitEvent.HIDE_WAVE_FX))
...
function var_0_3.UpdateHPAction(arg_5_0, arg_5_1, ...)
	...
	if arg_5_1.dHP <= 0 then
		...
		local var_5_2 = var_5.Event.New

		ys = var_1_10007

		var_5_1(var_5_0, var_5_2(var_1_10007.Battle.BattleUnitEvent.ADD_BLINK, {
			blink = {
				blue = 1,
				peroid = 0.1,
				red = 1,
