...
function var_0_2.onRemove(arg_4_0, arg_4_1, arg_4_2)
	if arg_4_2:GetCaster() and var_3:IsAlive() then
		local var_4_0 = arg_4_0._restoreRate

		if 0 < var_4_0 and var_3 ~= arg_4_1 then
			local var_4_1 = var_3:GetAttrByName("healingRate")

			math = var_5

			if var_5.floor(arg_4_0._sumDMG * arg_4_0._restoreRate * var_4_1) ~= 0 then
				local var_4_2 = {
					isMiss = false,
					isCri = false,
					isHeal = true
