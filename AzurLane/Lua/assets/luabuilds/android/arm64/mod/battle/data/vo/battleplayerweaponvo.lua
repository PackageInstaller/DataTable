...
function var_0_4.PlayFocus(arg_4_0, arg_4_1, arg_4_2)
	...
	if arg_4_0._focusTimer then
		...
		local var_4_3 = var_3.TimeMgr.GetInstance()

		var_3.RemoveBattleTimer(var_4_3, arg_4_0._focusTimer)
	end
	...
	local var_4_5 = var_1_10004.TimeMgr.GetInstance()

	arg_4_0._focusTimer = var_4.AddBattleTimer(var_4_5, "", -1, var_0_1.CAST_CAM_ZOOM_IN_DURATION, var_4_4, true)
...
function var_0_4.refreshCD(arg_13_0)
	...
	elseif var_13_0 + var_13_1 == 0 then
		...
		local var_13_2 = arg_13_0:GetNextTimeStamp()

		pg = var_1_10004

		local var_13_3 = var_1_10004.TimeMgr.GetInstance()
		local var_13_4 = var_13_2 - var_4.GetCombatTime(var_13_3)
		local var_13_5 = arg_13_0._current

		if arg_13_0._GCD <= var_13_5 then
			arg_13_0._max = var_13_4
		else
			math = var_13_5

			local var_13_6 = var_13_5.max(arg_13_0._max, arg_13_0._GCD)

			math = var_6
			arg_13_0._max = var_6.max(var_13_6 - arg_13_0._current, var_13_4)
		end
...
function var_0_4.Deduct(arg_29_0, arg_29_1)
	...
	elseif #arg_29_0._chargingList ~= 0 then
		...
		local var_29_1 = var_1_10003.max
		local var_29_2 = arg_29_0._GCD

		pg = var_1_10006

		local var_29_3 = var_1_10006.TimeMgr.GetInstance()

		arg_29_0._max = var_29_1(var_29_2, var_29_0 - var_6.GetCombatTime(var_29_3))
...
function var_0_4.Charge(arg_31_0, arg_31_1)
	...
	if #arg_31_0._readyList == 0 then
		local var_31_1 = arg_31_0:GetNextTimeStamp()

		math = var_3

		local var_31_2 = var_3.max
		local var_31_3 = arg_31_0._GCD

		pg = var_1_10006

		local var_31_4 = var_1_10006.TimeMgr.GetInstance()

		arg_31_0._max = var_31_2(var_31_3, var_31_1 - var_6.GetCombatTime(var_31_4))
