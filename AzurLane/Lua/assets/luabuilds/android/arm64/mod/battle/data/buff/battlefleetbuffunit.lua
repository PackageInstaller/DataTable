...
function var_0_3.onTrigger(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	for iter_9_0, iter_9_1 in var_1_10005(var_4) do
		assert = var_1_10010
		type = var_1_10012
		var_1_10012 = var_1_10012(iter_9_1[arg_9_1]) == "function"

		var_1_10010(var_1_10012, "fleet buff效果的触发函数缺失,buff id:>>" .. arg_9_0._id .. "<<, trigger:>>" .. arg_9_1 .. "<<")

		var_1_10012 = iter_9_1

		if iter_9_1.IsActive(var_1_10012) then
			var_1_10012 = iter_9_1

			iter_9_1.NotActive(var_1_10012)

			var_1_10012 = iter_9_1

			iter_9_1.Trigger(var_1_10012, arg_9_1, arg_9_2, arg_9_0, arg_9_3)

			var_1_10012 = iter_9_1

			iter_9_1.SetActive(var_1_10012)
		end
	end
