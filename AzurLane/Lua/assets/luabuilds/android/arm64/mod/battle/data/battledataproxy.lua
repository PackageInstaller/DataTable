...
function var_0_9.InitBattle(arg_2_0, arg_2_1)
	...
	if var_2_3 then
		GodenFnger = var_1_10008

		if not var_1_10008 then
			var_1_10008 = var_0_2.CreateContextCalculateDamage(var_2_1)
		end

		var_2_5(var_2_4, var_1_10008)
...
function var_0_9.TirggerBattleStartBuffs(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10001(arg_6_0._fleetList) do
		...
		for iter_6_2, iter_6_3 in var_1_10015(var_6_0) do
			...
			iter_6_11(var_6_7, function(arg_7_0)
			...
			iter_6_11(var_6_8, function(arg_8_0)
			...
			if arg_6_0._battleInitData.MapAuraSkills then
				...
				for iter_6_4, iter_6_5 in iter_6_11(arg_6_0._battleInitData.MapAuraSkills) do
					local var_6_9 = var_0.Battle.BattleBuffUnit.New(iter_6_5.id, iter_6_5.level)
			...
			if arg_6_0._battleInitData.MapAidSkills then
				...
				for iter_6_6, iter_6_7 in iter_6_11(arg_6_0._battleInitData.MapAidSkills) do
					local var_6_10 = var_0.Battle.BattleBuffUnit.New(iter_6_7.id, iter_6_7.level)
			...
			if arg_6_0._currentStageData.stageBuff then
				...
				for iter_6_8, iter_6_9 in iter_6_11(arg_6_0._currentStageData.stageBuff) do
					local var_6_11 = var_0.Battle.BattleBuffUnit.New(iter_6_9.id, iter_6_9.level)
		...
		var_1_10015 = iter_6_1:GetSupportUnitList()
		ipairs = var_16

		for iter_6_10, iter_6_11 in var_16(var_1_10015) do
			...
			var_1_10021(var_6_12, function(arg_9_0)
				if var_0_5.GetSLGStrategyBuffByCombatBuffID(arg_9_0) then
					local var_9_0 = var_1.type

					ChapterConst = var_3

					if var_9_0 == var_3.AirDominanceStrategyBuffType then
...
function var_0_9.InitAllFleetUnitsWeaponCD(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1_10001(arg_10_0._fleetList) do
		...
		for iter_10_2, iter_10_3 in var_1_10007(var_10_0) do
...
function var_0_9.InitData(arg_18_0, arg_18_1)
	...
	elseif arg_18_0._expeditionTmp.map_id then
		if #arg_18_0._expeditionTmp.map_id == 1 then
			...
			for iter_18_0, iter_18_1 in var_4(var_2) do
	...
	;(function(arg_20_0)
		...
		for iter_20_0, iter_20_1 in var_2_10001(arg_20_0) do
			...
			if iter_20_1.equipment then
				...
				for iter_20_4, iter_20_9 in var_2_10008(var_20_1) do
			...
			for iter_20_6, iter_20_9 in var_2_10008(var_20_2.initList) do
				var_19_0[iter_20_6] = true
			end

			pairs = var_2_10008

			for iter_20_8, iter_20_9 in var_2_10008(var_20_2.otherList) do
...
function var_0_9.initCommanderBuff(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10002(arg_21_0) do
		...
		for iter_21_2, iter_21_3 in var_1_10009(iter_21_1[2]) do
			table = var_1_10014
...
function var_0_9.InitUserShipsData(arg_24_0, arg_24_1, arg_24_2, arg_24_3, arg_24_4)
	...
	local var_24_3 = arg_24_0.GetFleetByIFF(var_24_2, arg_24_3)

	var_5.FleetUnitSpwanFinish(var_24_3)

	local var_24_4 = arg_24_0._battleInitData.battleType

	SYSTEM_SUBMARINE_RUN = var_24_2

	if var_24_4 ~= var_24_2 then
		...
		if var_24_4 == var_24_2 then
			...
			var_5:ShiftManualSub()
		else
			var_5:SetSubUnitData(arg_24_4)
		end

		local var_24_5 = arg_24_0._battleInitData.battleType

		SYSTEM_DUEL = var_24_3

		if var_24_5 == var_24_3 then
			ipairs = var_24_5

			for iter_24_6, iter_24_7 in var_24_5(var_5:GetCloakList()) do
				local var_24_6 = iter_24_7:GetCloak()

				var_12.SetRecoverySpeed(var_24_6, 0)
			end
		end
...
function var_0_9.InitUserSupportShipsData(arg_25_0, arg_25_1, arg_25_2)
	...
	for iter_25_0, iter_25_1 in var_1_10003(arg_25_2) do
		...
		if var_1_10009(var_1_10011.BundleList.hang, var_25_0) then
			var_1_10011 = arg_25_0
			var_1_10009 = arg_25_0.SpawnSupportUnit(var_1_10011, iter_25_1, arg_25_1)
		end
	end
...
function var_0_9.GetFleetByIFF(arg_40_0, arg_40_1)
	if arg_40_0._fleetList[arg_40_1] == nil then
		...
		local var_40_1 = arg_40_0._battleInitData.battleType

		SYSTEM_CARDPUZZLE = var_4

		if var_40_1 == var_4 then
			local var_40_2 = var_40_0:AttachCardPuzzleComponent()
			local var_40_3 = {
			...
			var_40_2:InitCardPuzzleData(var_40_3)
			var_40_2:CustomConfigID(arg_40_0._battleInitData.CardPuzzleCombatID)
...
function var_0_9.updateLoop(arg_55_0, arg_55_1)
	...
	for iter_55_6, iter_55_7 in var_7(arg_55_0._aircraftList) do
		...
		local var_55_19 = iter_55_7:GetPosition().x * var_55_17

		math = var_15

		if var_55_19 > var_15.abs(var_55_18) and iter_55_7:GetSpeed().x * var_55_17 > 0 then
			iter_55_7:OutBound()
		else
			local var_55_20 = arg_55_0._cldSystem

			var_14.UpdateAircraftCld(var_55_20, iter_55_7)
		end
	...
	for iter_55_8, iter_55_9 in var_7(arg_55_0._AOEList) do
		...
		var_12.UpdateAOECld(var_55_21, iter_55_9)
		iter_55_9:Settle()
	...
	if arg_55_0.checkCld then
		...
		for iter_55_14, iter_55_15 in var_7(arg_55_0._wallList) do
			if iter_55_15:IsActive() then
				...
				var_12.UpdateWallCld(var_55_22, iter_55_15)
			end
		end
	end

	local var_55_23 = arg_55_0._battleInitData.battleType

	SYSTEM_DUEL = var_8

	if var_55_23 ~= var_8 then
		pairs = var_55_23

		for iter_55_16, iter_55_17 in var_55_23(arg_55_0._foeShipList) do
		...
		if iter_57_1 == var_0_3.WEATHER.NIGHT then
			...
			for iter_57_2, iter_57_3 in var_10(arg_57_0._unitList) do
				if not iter_57_3:GetAimBias() or var_15:GetCurrentState() ~= var_15.STATE_SUMMON_SICKNESS then
					...
					if var_57_6(var_22.BundleAntiSubmarine, iter_57_3:GetTemplate().type) then
						math = var_20
...
function var_0_9.SpawnMonster(arg_60_0, arg_60_1, arg_60_2, arg_60_3, arg_60_4, arg_60_5)
	...
	for iter_60_0, iter_60_1 in var_9(var_60_1.equipment_list) do
		table = var_1_10014
	...
	for iter_60_2, iter_60_3 in var_11(var_60_3) do
		...
		for iter_60_4 = 1, var_60_5 do
			...
			var_1_10023.insert(var_60_2, {
				id = var_1_10017[var_1_10022]
			})

			table = var_1_10023

			var_1_10023.remove(var_1_10017, var_1_10022)
		end
	end
...
function var_0_9.SpawnNPC(arg_63_0, arg_63_1, arg_63_2)
	...
	for iter_63_0, iter_63_1 in var_7(var_63_2.equipment_list) do
		table = var_1_10012
...
function var_0_9.SpawnVanguard(arg_68_0, arg_68_1, arg_68_2)
	...
	BuildVector3 = var_1_10009

	local var_68_5 = var_68_2(var_68_1, var_68_3, var_68_4, var_1_10009(var_68_0), arg_68_0._commanderBuff)
...
function var_0_9.SpawnManualSub(arg_71_0, arg_71_1, arg_71_2)
	...
	local var_71_5 = var_71_2(var_71_1, var_71_3, var_71_4, var_1_10009(var_71_0), arg_71_0._commanderBuff)
...
function var_0_9.SpawnSupportUnit(arg_72_0, arg_72_1, arg_72_2)
	...
	local var_72_2 = arg_72_0.GetFleetByIFF(var_72_1, arg_72_2)

	var_4.AppendSupportUnit(var_72_2, var_72_0)

	local var_72_3 = var_72_0:GetTemplate().type

	table = var_72_1

	local var_72_4 = var_72_1.contains

	ShipType = var_8

	if var_72_4(var_8.BundleList.qian, var_72_3) then
		local var_72_5 = var_72_0
		local var_72_6 = var_72_0.SetPosition

		Clone = var_9

		var_72_6(var_72_5, var_9(var_0_4.SubSupportUnitPosList[#var_4:GetSupportUnitList()]))
	else
		...
		var_72_8(var_72_7, var_9(var_0_4.AirSupportUnitPos))
	end
...
function var_0_9.KillUnit(arg_75_0, arg_75_1)
	...
	if var_2:GetAimBias() then
		var_1_10009 = var_2:GetAimBias()

		var_6.RemoveCrew(var_1_10009, var_2)

		var_1_10009 = var_6

		if var_6.GetCurrentState(var_1_10009) == var_6.STATE_EXPIRE then
			var_1_10009 = arg_75_0

			arg_75_0.DispatchEvent(var_1_10009, var_0.Event.New(var_0_1.REMOVE_AIM_BIAS, {
	...
	elseif var_75_2 == var_0_4.FOE_CODE then
		...
		if var_75_0 == var_0_3.UnitType.ENEMY_UNIT or var_75_0 == var_0_3.UnitType.BOSS_UNIT then
			if var_2:GetTeam() then
				var_1_10009 = var_2:GetTeam()

				var_6.RemoveUnit(var_1_10009, var_2)
			end

			local var_75_4 = var_2:GetTemplate().type

			table = var_7

			local var_75_5 = var_7.contains

			ShipType = var_1_10009

			if var_75_5(var_1_10009.SubShipType, var_75_4) then
	...
	arg_75_0:DispatchEvent(var_0.Event.New(var_0_1.REMOVE_UNIT, var_75_6))
...
function var_0_9.setShipUnitBound(arg_82_0, arg_82_1)
	...
	if arg_82_1:GetFleetVO() then
		...
		local var_82_4 = var_6.GetUnitBound(var_82_3)

		var_82_2(var_82_1, var_6.GetBound(var_82_4))
	else
...
function var_0_9.generatePlayerUnit(arg_83_0, arg_83_1, arg_83_2, arg_83_3, arg_83_4)
	...
	SYSTEM_SUBMARINE_RUN = var_10

	if var_83_4 ~= var_10 then
		SYSTEM_SUB_ROUTINE = var_10

		if var_83_4 == var_10 then
			var_83_3 = var_0_3.UnitType.SUB_UNIT
		else
			SYSTEM_AIRFIGHT = var_10

			if var_83_4 == var_10 then
				var_83_3 = var_0_3.UnitType.CONST_UNIT
			else
				SYSTEM_CARDPUZZLE = var_10
		...
		if arg_83_1.spWeapon then
			...
			var_83_9(var_13.GetLabel(var_83_10), function(arg_84_0)
...
function var_0_9.SpawnColumnArea(arg_118_0, arg_118_1, arg_118_2, arg_118_3, arg_118_4, arg_118_5, arg_118_6, arg_118_7, arg_118_8)
	...
	local var_118_1 = arg_118_0.GenerateAreaID(var_118_0)
	local var_118_2 = var_0.Battle.BattleAOEData.New(var_118_1, arg_118_2, arg_118_6, arg_118_8)

	Clone = var_118_0

	local var_118_3 = var_118_0(arg_118_3)

	var_118_2:SetPosition(var_118_3)
	var_118_2:SetRange(arg_118_4)
	var_118_2:SetAreaType(var_0_3.AreaType.COLUMN)
	var_118_2:SetLifeTime(arg_118_5)
	var_118_2:SetFieldType(arg_118_1)
	var_118_2:SetOpponentAffected(not arg_118_7)
	arg_118_0:CreateAreaOfEffect(var_118_2)
...
function var_0_9.SpawnCubeArea(arg_119_0, arg_119_1, arg_119_2, arg_119_3, arg_119_4, arg_119_5, arg_119_6, arg_119_7, arg_119_8, arg_119_9)
	...
	local var_119_1 = arg_119_0.GenerateAreaID(var_119_0)
	local var_119_2 = var_0.Battle.BattleAOEData.New(var_119_1, arg_119_2, arg_119_7, arg_119_9)

	Clone = var_119_0

	local var_119_3 = var_119_0(arg_119_3)

	var_119_2:SetPosition(var_119_3)
	var_119_2:SetWidth(arg_119_4)
	var_119_2:SetHeight(arg_119_5)
	var_119_2:SetAreaType(var_0_3.AreaType.CUBE)
	var_119_2:SetLifeTime(arg_119_6)
	var_119_2:SetFieldType(arg_119_1)
	var_119_2:SetOpponentAffected(not arg_119_8)
	arg_119_0:CreateAreaOfEffect(var_119_2)
...
function var_0_9.SpawnLastingColumnArea(arg_120_0, arg_120_1, arg_120_2, arg_120_3, arg_120_4, arg_120_5, arg_120_6, arg_120_7, arg_120_8, arg_120_9, arg_120_10, arg_120_11)
	...
	local var_120_1 = arg_120_0.GenerateAreaID(var_120_0)
	local var_120_2 = var_0.Battle.BattleLastingAOEData.New(var_120_1, arg_120_2, arg_120_6, arg_120_7, arg_120_10, arg_120_11)

	Clone = var_120_0

	local var_120_3 = var_120_0(arg_120_3)

	var_120_2:SetPosition(var_120_3)
	var_120_2:SetRange(arg_120_4)
	var_120_2:SetAreaType(var_0_3.AreaType.COLUMN)
	var_120_2:SetLifeTime(arg_120_5)
	var_120_2:SetFieldType(arg_120_1)
	var_120_2:SetOpponentAffected(not arg_120_8)
	arg_120_0:CreateAreaOfEffect(var_120_2)
	...
	if arg_120_9 and arg_120_9 ~= "" then
		...
		arg_120_0:DispatchEvent(var_0.Event.New(var_0_1.ADD_AREA, var_120_4))
	end
...
function var_0_9.SpawnLastingEllipseArea(arg_121_0, arg_121_1, arg_121_2, arg_121_3, arg_121_4, arg_121_5, arg_121_6, arg_121_7, arg_121_8, arg_121_9, arg_121_10, arg_121_11, arg_121_12)
	...
	local var_121_1 = arg_121_0.GenerateAreaID(var_121_0)
	local var_121_2 = var_0.Battle.BattleLastingAOEData.New(var_121_1, arg_121_2, arg_121_7, arg_121_8, arg_121_11, arg_121_12)

	Clone = var_121_0

	local var_121_3 = var_121_0(arg_121_3)

	var_121_2:SetPosition(var_121_3)
	var_121_2:SetWidth(arg_121_4)
	var_121_2:SetHeight(arg_121_5)
	var_121_2:SetAreaType(var_0_3.AreaType.ELLIPSE)
	var_121_2:SetLifeTime(arg_121_6)
	var_121_2:SetFieldType(arg_121_1)
	var_121_2:SetOpponentAffected(not arg_121_9)
	arg_121_0:CreateAreaOfEffect(var_121_2)
	...
	if arg_121_10 and arg_121_10 ~= "" then
		...
		arg_121_0:DispatchEvent(var_0.Event.New(var_0_1.ADD_AREA, var_121_4))
	end
...
function var_0_9.SpawnLastingCubeArea(arg_122_0, arg_122_1, arg_122_2, arg_122_3, arg_122_4, arg_122_5, arg_122_6, arg_122_7, arg_122_8, arg_122_9, arg_122_10, arg_122_11, arg_122_12)
	...
	local var_122_1 = arg_122_0.GenerateAreaID(var_122_0)
	local var_122_2 = var_0.Battle.BattleLastingAOEData.New(var_122_1, arg_122_2, arg_122_7, arg_122_8, arg_122_11, arg_122_12)

	Clone = var_122_0

	local var_122_3 = var_122_0(arg_122_3)

	var_122_2:SetPosition(var_122_3)
	var_122_2:SetWidth(arg_122_4)
	var_122_2:SetHeight(arg_122_5)
	var_122_2:SetAreaType(var_0_3.AreaType.CUBE)
	var_122_2:SetLifeTime(arg_122_6)
	var_122_2:SetFieldType(arg_122_1)
	var_122_2:SetOpponentAffected(not arg_122_9)
	arg_122_0:CreateAreaOfEffect(var_122_2)
	...
	if arg_122_10 and arg_122_10 ~= "" then
		...
		arg_122_0:DispatchEvent(var_0.Event.New(var_0_1.ADD_AREA, var_122_4))
	end
...
function var_0_9.SpawnTriggerColumnArea(arg_123_0, arg_123_1, arg_123_2, arg_123_3, arg_123_4, arg_123_5, arg_123_6, arg_123_7, arg_123_8)
	...
	local var_123_1 = arg_123_0.GenerateAreaID(var_123_0)
	local var_123_2 = var_0.Battle.BattleTriggerAOEData.New(var_123_1, arg_123_2, arg_123_8)

	Clone = var_123_0

	local var_123_3 = var_123_0(arg_123_3)

	var_123_2:SetPosition(var_123_3)
	var_123_2:SetRange(arg_123_4)
	var_123_2:SetAreaType(var_0_3.AreaType.COLUMN)
	var_123_2:SetLifeTime(arg_123_5)
	var_123_2:SetFieldType(arg_123_1)
	var_123_2:SetOpponentAffected(not arg_123_6)
	arg_123_0:CreateAreaOfEffect(var_123_2)
	...
	if arg_123_7 and arg_123_7 ~= "" then
		...
		arg_123_0:DispatchEvent(var_0.Event.New(var_0_1.ADD_AREA, var_123_4))
	end
...
function var_0_9.SpawnEnvironment(arg_135_0, arg_135_1)
	...
	local var_135_2 = var_3:GetBehaviours()

	Vector3 = var_5

	local var_135_3 = var_5(arg_135_1.coordinate[1], arg_135_1.coordinate[2], arg_135_1.coordinate[3])
	...
	if not arg_135_1.field_type then
		var_135_7 = var_0_3.BulletField.SURFACE
	end

	local var_135_8

	if not arg_135_1.IFF then
		var_135_8 = var_0_4.FOE_CODE
	end
...
function var_0_9.SubmarineStrike(arg_152_0, arg_152_1)
	...
	SYSTEM_SCENARIO_SUB_STRIKE = var_152_0

	if var_152_2 ~= var_152_0 and (var_2:GetWeaponBlock() or var_152_1:GetCurrent() < 1) then
		return
	end

	local var_152_3 = var_2:GetSubUnitData()

	ipairs = var_152_0

	for iter_152_0, iter_152_1 in var_152_0(var_152_3) do
		local var_152_4 = arg_152_0:SpawnSub(iter_152_1, arg_152_1)

		arg_152_0:InitAidUnitStatistics(var_152_4)
	end

	var_2:SubWarcry()

	local var_152_5 = var_2:GetSubList()

	ipairs = var_6

	for iter_152_2, iter_152_3 in var_6(var_152_5) do
...
function var_0_9.AddWaveFlag(arg_154_0, arg_154_1)
	...
	if var_1_10003.contains(var_154_0, arg_154_1) then
		return
	end

	table = var_3

	var_3.insert(var_154_0, arg_154_1)
...
function var_0_9.RemoveFlag(arg_155_0, arg_155_1)
	...
	if not var_1_10003.contains(var_155_0, arg_155_1) then
		return
	end

	table = var_3

	var_3.removebyvalue(var_155_0, arg_155_1)
...
function var_0_9.TriggerFinishBattle(arg_163_0)
	...
	for iter_163_0, iter_163_1 in var_1_10001(arg_163_0._fleetList) do
		...
		for iter_163_2, iter_163_3 in var_1_10007(var_163_0) do
...
function var_0_9.ChapterSupportBarrage(arg_164_0, arg_164_1, arg_164_2)
	...
	local function var_164_1(...)
		...
		for iter_165_0, iter_165_1 in var_2_10000(arg_164_0._battleInitData.SupportUnitList) do
			...
			table = var_2_10006
			var_2_10006 = var_2_10006.contains
			ShipType = var_2_10008

			if var_2_10006(var_2_10008.BundleList.qian, var_165_0) then
				var_2_10008 = arg_164_0
				var_2_10006 = var_2_10006.SpawnSupportUnit(var_2_10008, iter_165_1, arg_164_1)

				var_0_6.SetCurrent(var_2_10006, "loadSpeed", 0)
			end
		end

		pg = var_0

		local var_165_1 = var_0.TimeMgr.GetInstance()

		var_0.RemoveBattleTimer(var_165_1, var_164_0)
