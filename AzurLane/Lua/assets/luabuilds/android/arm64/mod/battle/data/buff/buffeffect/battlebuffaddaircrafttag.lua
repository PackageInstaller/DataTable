...
function var_0_2.onAircraftCreate(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	for iter_3_0, iter_3_1 in var_1_10005(arg_3_0._labelTag) do
		string = var_1_10010

		if var_1_10010.find(iter_3_1, "^[NT]_%d+$") then
			pg = var_1_10010

			local var_3_1 = var_1_10010.TipsMgr.GetInstance()

			var_1_10010.ShowTips(var_3_1, ">>BattleBuffAddAircraftTag<<不允许使用'N_'或'T_'标签")
		else
