...
function var_0_4.onInitBattle(arg_2_0)
	...
	math = var_1_10002
	arg_2_0._enhancemntP = var_1_10002.max(var_2_2 - arg_2_0._challengeConst.K, 0)
...
function var_0_4.initWaveModule(arg_3_0)
	...
	local function var_3_2()
		if arg_3_0._vertifyFail then
			...
			var_7_1(var_7_0, var_2_10003.CHEATER_MARK, {
...
function var_0_4.DoPrologue(arg_9_0)
	...
	local function var_9_1()
		...
		var_0.OpeningEffect(var_10_0, function()
			...
			local var_11_0 = var_3_10000(var_3_10002)
		...
		local var_10_6 = var_10_1.TimeMgr.GetInstance()
