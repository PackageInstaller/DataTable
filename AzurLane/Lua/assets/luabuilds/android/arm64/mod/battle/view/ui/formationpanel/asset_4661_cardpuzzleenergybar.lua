...
function var_0_3.SetCardPuzzleComponent(arg_2_0, arg_2_1)
	...
	for iter_2_0 = 1, arg_2_0._max do
		...
		local var_2_5 = var_6
		local var_2_6 = var_6.Find(var_2_5, "recover")
		local var_2_7 = {
			full = var_2_4,
			recover = var_2_6
		}
		...
		var_2_5.insert(arg_2_0._blockTFList, var_2_7)
	end

	arg_2_0._lastPoint = 0

	local var_2_8 = arg_2_0._blockTFList[arg_2_0._lastPoint + 1]

	arg_2_0:activeRecoverBlock(var_2_8)
...
function var_0_3.updateEnergyProgress(arg_4_0)
	...
	if arg_4_0._lastPoint == var_4_1 then
		if var_4_1 >= arg_4_0._max then
			...
			arg_4_0:updateRecoverBlock(var_4_2)
		end
	else
...
function var_0_3.updateEnergyPoint(arg_5_0)
	...
	var_1_10001(var_5_0, var_4.GetCurrentEnergy(var_5_1))
	...
	var_1_10001(var_5_2, var_4.GetCurrentEnergy(var_5_3))
	...
	var_1_10001(var_5_4, var_4.GetMaxEnergy(var_5_5))
...
function var_0_3.updateRecoverBlock(arg_7_0, arg_7_1)
	...
	local var_7_3 = var_7_2(var_7_1, var_1_10007(var_1_10009))
