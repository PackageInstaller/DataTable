...
function var_0_4.doCLS(arg_4_0, arg_4_1)
					...
					if not var_8.isEnterBlind(var_5_4, var_7) then
						...
						if not var_8.isOutOfAngle(var_5_5, var_7) then
							if arg_4_0._delayCLS then
								...
								local var_5_8 = var_5_5.TimeMgr.GetInstance()
	...
	local function var_4_2()
		...
		if arg_4_0._finaleFX then
			...
			var_7_2(var_7_1, var_7_3, var_4.GetPosition(var_7_4), 1)
		end
		...
		local function var_4_7(arg_8_0)
			...
			for iter_8_0, iter_8_1 in var_2_10001(arg_8_0) do
				if iter_8_1.Active then
					...
					local var_8_4 = var_8_1.floor(arg_4_0._damageDiveDMGRate[var_8_3] * var_4_6)
...
function var_0_4.cacheSectorData(arg_13_0, arg_13_1)
	...
	local var_13_1 = arg_13_1.GetIFF(var_13_0)
	local var_13_2 = arg_13_0._angle / 2

	math = var_13_0
	arg_13_0._upperEdge = var_13_0.deg2Rad * var_13_2
	arg_13_0._lowerEdge = -1 * arg_13_0._upperEdge

	if var_13_1 == var_0_2.FRIENDLY_CODE then
		arg_13_0._normalizeOffset = 0
	elseif var_13_1 == var_0_2.FOE_CODE then
		math = var_4
	...
	math = var_5
	arg_13_0._wholeCircleNormalizeOffset = var_13_3 - var_5.pi * 2

	local var_13_4 = arg_13_0._normalizeOffset

	math = var_5
	arg_13_0._negativeCircleNormalizeOffset = var_13_4 + var_5.pi * 2
...
function var_0_4.isOutOfAngle(arg_14_0, arg_14_1)
	...
	local var_14_1 = arg_14_1.GetPosition(var_14_0)
	local var_14_2 = arg_14_0._cldArea
	local var_14_3 = var_3.GetPosition(var_14_2)

	math = var_14_0

	local var_14_4

	if var_14_0.atan2(var_14_1.z - var_14_3.z, var_14_1.x - var_14_3.x) > arg_14_0._wholeCircle then
		var_14_4 = var_14_4 + arg_14_0._wholeCircleNormalizeOffset
	elseif var_14_4 < arg_14_0._negativeCircle then
		var_14_4 = var_14_4 + arg_14_0._negativeCircleNormalizeOffset
	else
		var_14_4 = var_14_4 + arg_14_0._normalizeOffset
	end

	if var_14_4 > arg_14_0._lowerEdge and var_14_4 < arg_14_0._upperEdge then
		return false
	else
		return true
	end
...
function var_0_4.isEnterBlind(arg_15_0, arg_15_1)
	...
	local var_15_1 = arg_15_1.GetPosition(var_15_0)
	local var_15_2 = arg_15_0._cldArea
	local var_15_3 = var_3.GetPosition(var_15_2)

	Vector3 = var_15_0

	return var_15_0.BattleDistance(var_15_3, var_15_1) < arg_15_0._minRange
end
...
function var_0_4.checkBulletType(arg_16_0, arg_16_1)
	if not arg_16_0._bulletType then
		...
		if var_1_10003.contains(arg_16_0._bulletType, var_16_0) then
			return true
		else
			return false
		end
