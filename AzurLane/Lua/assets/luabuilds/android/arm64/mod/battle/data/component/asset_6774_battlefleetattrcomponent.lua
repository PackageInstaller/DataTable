...
local var_0_5 = var_0_10002.Battle.BattleConfig

ys = var_3

local var_0_6 = var_3.Battle.BattleEvent
...
function var_0_3.SetCurrent(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_1 = arg_5_0.GetCurrent(var_5_0, arg_5_1)

	if var_0_5.FLEET_ATTR_CAP[arg_5_1] then
		Mathf = var_5_0
		arg_5_2 = var_5_0.Clamp(arg_5_2, 0, var_4)
	else
		math = var_5_0
		arg_5_2 = var_5_0.max(arg_5_2, 0)
	end

	arg_5_0._fleetAttrList[arg_5_1] = arg_5_2

	if var_5_1 ~= arg_5_2 then
		local var_5_2 = arg_5_2 - var_5_1
		local var_5_3 = arg_5_0._client

		var_6.FleetBuffTrigger(var_5_3, var_0_4.BuffEffectType.ON_FLEET_ATTR_UPDATE, {
			attr = arg_5_1,
			value = arg_5_2,
			delta = var_5_2
		})

		local var_5_4 = arg_5_0._client
		local var_5_5 = var_6.DispatchEvent

		ys = var_9

		var_5_5(var_5_4, var_9.Event.New(var_0_6.UPDATE_FLEET_ATTR, {
			attr = arg_5_1,
			value = arg_5_2
		}))
	end
