...
function var_0_5.onBulletHitFunc(arg_3_0, arg_3_1, arg_3_2)
	...
	if var_3_1.contains(var_0_2, arg_3_2) then
	...
	if var_3_3:GetGO() then
		if var_3_9 then
			...
			if var_15.random(0, 1) == 0 then
				var_3_17 = -1
			end

			math = var_3_15

			local var_3_18 = (var_3_15.random() - 0.5) * var_3_16.x

			Vector3 = var_17
			var_1_10019 = var_17(var_3_18, 0, var_3_16.z * var_3_17)

			local var_3_19 = var_17.Add(var_1_10019, var_3_3:GetPosition())

			pg = var_18

			local var_3_20 = var_18.EffectMgr.GetInstance()

			var_18.PlayBattleEffect(var_3_20, var_3_13, var_3_19:Add(var_3_14), true)
			var_0.Battle.PlayBattleSFX(var_4:GetMissSFX())
		else
			local var_3_21 = var_3_3
			local var_3_22 = var_3_3.AddFX
			local var_3_23 = arg_3_0

			var_3_11 = var_3_22(var_3_21, arg_3_0.GetFXID(var_3_23))

			var_0.Battle.PlayBattleSFX(var_4:GetHitSFX())

			local var_3_24 = var_3_6:GetDirection()

			var_13.x = (arg_3_0:GetPosition() - var_3_3:GetPosition()).x * var_3_24

			local var_3_25 = var_3_11.transform.localPosition
			local var_3_26 = (var_0_6 * var_3_3:GetTf().localRotation).eulerAngles.x

			math = var_3_23

			local var_3_27 = var_3_23.cos

			math = var_1_10019
			var_13.y = var_3_27(var_1_10019.deg2Rad * var_3_26) * var_13.z
			var_13.z = 0

			local var_3_28 = var_13 / var_3_3:GetInitScale()

			var_3_25:Add(var_3_28)

			var_3_11.transform.localPosition = var_3_25
		end
	end

	if var_3_11 then
		local var_3_29 = var_3_6

		if var_3_6.GetIFF(var_3_29) == var_3_0:GetFoeCode() then
...
function var_0_5.onBulletMissFunc(arg_4_0)
	...
	local var_4_5 = var_4_2.EffectMgr.GetInstance()
...
function var_0_5.MakeModel(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	if not var_7.InstBullet(var_5_2, arg_5_1:GetModleID(), function(arg_6_0)
		...
		var_5_4(var_5_3, var_11.GetObject(var_5_5))
	end
