...
function var_0_2.UpdateScale(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in var_1_10007(var_8_4) do
		ipairs = var_1_10012
		...
		for iter_8_2, iter_8_3 in var_1_10012(iter_8_1._effectList) do
			if iter_8_3:GetEffectType() == var_0_2.FX_TYPE then
				...
				if var_8_6 < var_8_5 and var_8_5 > 1 then
					var_8_0 = var_8_0 * var_8_5 / var_8_6
					var_8_6 = var_8_5
				end

				if var_8_5 < var_8_7 and var_8_5 < 1 then
					var_8_1 = var_8_1 * var_8_5 / var_8_7
					var_8_7 = var_8_5
				end

				var_8_2[var_18] = var_8_6
				var_8_3[var_18] = var_8_7
			end
		end
	end

	local var_8_8 = var_0.Battle.BattleAttr.GetCurrent(arg_8_1, "baseScale") * var_8_0 * var_8_1

	var_0.Battle.BattleAttr.SetCurrent(arg_8_1, "modelScale", var_8_8)
