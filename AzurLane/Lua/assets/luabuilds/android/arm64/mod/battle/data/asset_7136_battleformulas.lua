...
function var_0_2.GetFleetTotalHP(arg_1_0)
	...
	local var_1_2 = arg_1_0.GetUnitList(var_1_1)
	local var_1_3 = var_0.NUM0

	ipairs = var_1_1

	for iter_1_0, iter_1_1 in var_1_1(var_1_2) do
		if iter_1_1 == var_1_0 then
			var_1_3 = var_1_3 + var_0_5.GetCurrent(iter_1_1, "maxHP") * var_0.HP_CONST
		else
			var_1_3 = var_1_3 + var_0_5.GetCurrent(iter_1_1, "maxHP")
		end
	end
...
function var_0_2.CreateContextCalculateDamage(arg_11_0)
	return function(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
		...
		elseif var_12_8 == var_0_3.WeaponDamageAttr.AIR then
			...
			math = var_2_10030
			var_12_13 = var_12_13 * var_2_10030.min(var_12_3[7] / (var_12_12.antiAirPower + var_12_3[7]) + var_12_22, 1) * (var_12_0 + var_0_5.GetCurrent(arg_12_1, "injureRatioByAir") + var_0_5.GetCurrent(arg_12_0, "damageRatioByAir"))
		...
		local var_12_25 = var_2_10030.max(var_12_5.attackRating, 0)
		...
		if var_12_24 >= 1 then
			...
			local var_12_28 = var_0_5.GetCurrent(arg_12_0, var_0_15[arg_12_1:GetTemplate().type])
			local var_12_29 = var_0_5.GetCurrent(arg_12_1, "dodgeRateExtra")

			math = var_35

			local var_12_30 = var_35.max
			local var_12_31 = var_12_3[5]

			math = var_2_10038

			local var_12_32 = var_12_30(var_12_31, var_2_10038.min(var_12_0, var_12_26 + var_12_27 + var_12_28 - var_12_29))

			var_12_17 = not var_0_2.IsHappen(var_12_32 * var_12_2)
		end

		if not var_12_17 then
			local var_12_33
			local var_12_34 = var_0_5.GetCurrent(arg_12_0, "GCT") == 1 and 1 or var_0.DFT_CRIT_RATE + var_12_25 / (var_12_25 + var_12_12.dodgeRate + var_12_3[4]) + (var_12_23 + var_12_15) * var_12_3[3] + var_0_5.GetCurrent(arg_12_0, "cri") + var_0_5.GetTagAttrCri(arg_12_0, arg_12_1)

			math = var_32
			var_12_19 = var_32.random(var_0_6.RANDOM_DAMAGE_MIN, var_0_6.RANDOM_DAMAGE_MAX) + var_12_21

			if var_0_2.IsHappen(var_12_34 * var_12_2) then
				var_12_18 = true

				local var_12_35 = var_0.DFT_CRIT_EFFECT + var_0_5.GetTagAttrCriDmg(arg_12_0, arg_12_1) + var_0_5.GetCurrent(arg_12_0, "criDamage") - var_0_5.GetCurrent(arg_12_1, "criDamageResist")

				math = var_34
				var_12_16 = var_34.max(1, var_12_35)
			else
				var_12_18 = false
			end
		else
			...
			return var_12_19, var_12_36
		end

		local var_12_37 = var_0.NUM1
		local var_12_38 = var_0_5.GetCurrent(arg_12_0, "damageRatioBullet")
		local var_12_39 = var_0_5.GetTagAttr(arg_12_0, arg_12_1, arg_11_0)
		local var_12_40 = var_0_5.GetCurrent(arg_12_1, "injureRatio")
		local var_12_41
		...
		local var_12_42 = var_12_41 + var_0_5.GetCurrent(arg_12_0, var_0_6.DAMAGE_AMMO_TO_ARMOR_RATE_ENHANCE[var_12_14])
		local var_12_43 = var_0_5.GetCurrent(arg_12_0, var_0_6.DAMAGE_TO_ARMOR_RATE_ENHANCE[var_12_14])
		local var_12_44 = var_0_5.GetCurrent(arg_12_0, var_0_13[var_15.ammo_type])
		local var_12_45 = var_0_5.GetCurrent(arg_12_1, var_0_14[var_15.ammo_type])
		local var_12_46 = var_0_5.GetCurrent(arg_12_0, "comboTag")
		local var_12_47 = var_0_5.GetCurrent(arg_12_1, var_12_46)

		math = var_41

		local var_12_48 = var_41.max
		local var_12_49 = var_12_37

		math = var_2_10044

		local var_12_50 = var_2_10044.floor
		local var_12_51 = var_12_19 * var_12_13 * (var_12_37 - arg_12_2) * var_12_42 * (var_12_37 + var_12_43) * var_12_16 * (var_12_37 + var_12_38) * var_12_39 * (var_12_37 + var_12_40) * (var_12_37 + var_12_44 - var_12_45) * (var_12_37 + var_12_47)

		math = var_47

		local var_12_52 = var_47.min
		local var_12_53 = var_12_3[1]

		math = var_2_10050

		local var_12_54 = var_12_48(var_12_49, var_12_50(var_12_51 * (var_12_37 + var_12_52(var_12_53, var_2_10050.max(-var_12_3[1], var_12_15)) * var_12_3[2])))
		local var_12_55 = arg_12_1

		if arg_12_1.GetCurrentOxyState(var_12_55) == var_0_3.OXY_STATE.DIVE then
			math = var_41
			var_12_54 = var_41.floor(var_12_54 * var_15.antisub_enhancement)
		end
		...
		local var_12_57 = arg_12_0

		if arg_12_0.GetDamageEnhance(var_12_57) ~= 1 then
			math = var_12_55
			var_12_54 = var_12_55.floor(var_12_54 * var_42)
		end

		local var_12_58 = var_12_54 * var_12_12.repressReduce

		if var_12_11 ~= 0 then
			Mathf = var_43
			var_12_58 = var_12_58 * (var_43.RandomFloat(var_12_11) + 1)
		end

		local var_12_59 = var_0_5.GetCurrent(arg_12_0, "damageEnhanceProjectile")

		math = var_12_57

		local var_12_60 = var_12_57.max(0, var_12_58 + var_12_59)

		if arg_11_0 then
			var_12_60 = var_12_60 * (var_0.NUM1 + var_0_5.GetCurrent(arg_12_0, "worldBuffResistance"))
		end

		math = var_44

		local var_12_61 = var_44.floor(var_12_60)
		local var_12_62 = var_15.DMG_font[var_12_14]

		if var_12_59 < 0 then
			var_12_62 = var_0_6.BULLET_DECREASE_DMG_FONT
		end

		return var_12_61, var_12_56, var_12_62
	end
end
...
function var_0_2.CalculateFleetAntiAirTotalDamage(arg_17_0)
	...
	local var_17_1 = arg_17_0.GetCrewUnitList(var_17_0)
	local var_17_2 = 0

	pairs = var_17_0

	for iter_17_0, iter_17_1 in var_17_0(var_17_1) do
		local var_17_3 = var_0_5.GetCurrent(iter_17_0, "antiAirPower")

		ipairs = var_1_10009

		for iter_17_2, iter_17_3 in var_1_10009(iter_17_1) do
			local var_17_4 = iter_17_3
			local var_17_5 = iter_17_3.GetConvertedAtkAttr(var_17_4)
			local var_17_6 = iter_17_3:GetCorrectedDMG()

			math = var_17_4
			var_17_2 = var_17_2 + var_17_4.max(1, (var_17_3 * var_17_5 + 1) * var_17_6)
		end
	end
...
function var_0_2.CalculateRepaterAnitiAirTotalDamage(arg_18_0)
	...
	local var_18_3 = arg_18_0.GetCorrectedDMG(var_18_2)
	local var_18_4 = var_0_5.GetCurrent(var_18_0, "antiAirPower")

	math = var_18_2

	return (var_18_2.max(1, (var_18_4 * var_18_1 + 1) * var_18_3))
end

function var_0_2.RollRepeaterHitDice(arg_19_0, arg_19_1)
	local var_19_0 = arg_19_0
	local var_19_1 = arg_19_0.GetHost(var_19_0)
	local var_19_2 = var_0_5.GetCurrent(var_19_1, "antiAirPower")

	math = var_19_0

	local var_19_3 = var_19_0.max(var_0_5.GetCurrent(var_19_1, "attackRating"), 0)
	local var_19_4 = var_0_5.GetCurrent(arg_19_1, "airPower")
	local var_19_5 = var_0_5.GetCurrent(arg_19_1, "dodgeLimit")
	local var_19_6 = var_0_5.GetCurrent(arg_19_1, "dodge")
	local var_19_7 = (var_19_4 / var_0_7.const_A + var_0_7.const_B) / (var_19_2 * var_19_6 + var_8 + var_0_7.const_C)

	math = var_10

	local var_19_8 = var_10.min(var_19_5, var_19_7)

	return var_0_2.IsHappen(var_19_8 * var_0.NUM10000)
end
...
function var_0_2.CalculateDamageFromAircraftToMainShip(arg_21_0, arg_21_1)
	...
	local var_21_11 = var_21_9(var_21_10, var_1_10014.floor((var_21_2 * (var_21_8[2] + var_21_0 * var_21_8[3]) + var_21_4 * var_21_8[4]) * (var_21_3 * var_21_8[5] + var_21_8[6]) * (var_21_8[7] + (var_21_4 - var_21_5) * var_21_8[8]) * (var_21_8[9] / (var_21_1 + var_21_8[10])) * (var_21_8[11] + var_21_6) * (var_21_8[12] + var_21_7)))

	math = var_12

	return (var_12.floor(var_21_11 * var_0_5.GetCurrent(arg_21_1, "repressReduce") * var_0_5.GetCurrent(arg_21_1, "injureRatioKamikazeAir")))
end
...
function var_0_2.CalculateDamageFromShipToMainShip(arg_22_0, arg_22_1)
	...
	local var_22_9 = var_22_7(var_22_8, var_1_10012.floor(((var_22_0 + var_22_1) * var_22_6[2] + var_22_3 * var_22_6[7]) * (var_22_6[5] + var_22_5) * (var_22_2 * var_22_6[3] + var_22_6[4]) * (var_22_6[5] + (var_22_3 - var_22_4) * var_22_6[6])))

	math = var_10

	return (var_10.floor(var_22_9 * var_0_5.GetCurrent(arg_22_1, "repressReduce") * var_0_5.GetCurrent(arg_22_1, "injureRatioKamikazeShip")))
end
...
function var_0_2.CalculateDamageFromSubmarinToMainShip(arg_23_0, arg_23_1)
	...
	return (var_23_6(var_23_7, var_1_10011.floor((var_23_0 * var_23_5[2] + var_23_2 * var_23_5[3]) * (var_23_5[4] + var_23_4) * (var_23_1 * var_23_5[5] + var_23_5[6]) * (var_23_5[7] + (var_23_2 - var_23_3) * var_23_5[8]))))
end
...
function var_0_2.CaclulateMetaDotaDamage(arg_35_0, arg_35_1)
	...
	if var_1_10003(var_35_0.state) == "string" then
		return 0
	end
	...
	local var_35_7 = var_1_10010.difftime

	pg = var_1_10012

	local var_35_8 = var_1_10012.TimeMgr.GetInstance()
	local var_35_9 = var_35_6(var_35_7(var_12.GetServerTime(var_35_8), var_35_2) / 0)
	...
	local var_35_18 = var_35_16(var_35_17 * var_20.min(var_35_9 - var_35_10 + 1, var_35_11 - var_35_10))
	...
	return var_35_18 + var_35_19(var_20.floor(var_35_13 * var_35_18))
end
...
function var_0_2.WorldMapRewardAttrEnhance(arg_46_0, arg_46_1)
	...
	local var_46_9 = var_46_8(1 - var_10.clamp(var_46_5, var_46_3[3][1], var_46_3[3][2]), -var_46_4)
...
function var_0_2.WeightListRandom(arg_56_0, arg_56_1)
	...
	for iter_56_0, iter_56_1 in var_1_10003(arg_56_0) do
...
function var_0_2.RandomPosNull(arg_60_0, arg_60_1)
	...
	for iter_60_0 = 1, arg_60_1 do
		...
		for iter_60_1, iter_60_2 in var_10(var_60_2) do
			...
			if var_1_10016.SqrDistance(var_60_6, var_60_7) < var_60_1 then
				var_60_5 = false
...
function var_0_2.parseCompareUnitAttr(arg_66_0, arg_66_1, arg_66_2)
	...
	if not var_9(var_66_3) then
		var_66_6 = arg_66_1:GetAttrByName(var_66_3)
	end
	...
	if not var_10(var_66_4) then
		var_66_7 = arg_66_2:GetAttrByName(var_66_4)
	end
...
function var_0_2.parseCompareUnitTemplate(arg_67_0, arg_67_1, arg_67_2)
	...
	if not var_9(var_67_3) then
		var_67_6 = arg_67_1:GetTemplateValue(var_67_3)
	end
	...
	if not var_10(var_67_4) then
		var_67_7 = arg_67_2:GetTemplateValue(var_67_4)
	end
...
function var_0_2.parseCompareBuffAttachData(arg_68_0, arg_68_1)
	...
	local var_68_4 = var_6(var_8.sub(arg_68_0, var_68_1 + 1, #arg_68_0))
	local var_68_5 = arg_68_1:GetEffectAttachData()

	getCompareFuncByPunctuation = var_8

	return var_8(var_68_2)(var_68_5, var_68_4)
end
...
function var_0_2.parseCompare(arg_69_0, arg_69_1)
	...
	if not var_8(var_69_3) then
		var_69_6 = arg_69_1:GetCurrent(var_69_3)
	end
	...
	if not var_9(var_69_4) then
		var_69_7 = arg_69_1:GetCurrent(var_69_4)
	end
...
function var_0_2.parseFormula(arg_70_0, arg_70_1)
	...
	for iter_70_2, iter_70_3 in var_8(var_70_1) do
		...
		if not var_1_10013(var_70_0[var_70_4]) then
			var_1_10013 = arg_70_1:GetCurrent(var_70_0[var_70_4])
		end

		if iter_70_3 == "+" or iter_70_3 == "-" then
			table = var_1_10014

			var_1_10014.insert(var_70_3, var_70_5)

			var_70_5 = var_1_10013
			table = var_1_10014

			var_1_10014.insert(var_70_2, iter_70_3)
		elseif iter_70_3 == "*" or iter_70_3 == "/" then
			getArithmeticFuncByOperator = var_1_10014
			var_70_5 = var_1_10014(iter_70_3)(var_70_5, var_1_10013)
		end
	end
	...
	local var_70_6 = var_70_3[1]

	while var_70_8 < #var_70_3 do
		getArithmeticFuncByOperator = var_70_7

		local var_70_7 = var_70_7(var_70_2[var_70_8])
		local var_70_8 = var_70_8 + 1

		var_70_6 = var_70_7(var_70_6, var_70_3[var_70_8])
	end
