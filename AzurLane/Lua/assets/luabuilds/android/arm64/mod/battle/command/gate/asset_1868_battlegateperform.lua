...
ys = var_0_10001
var_0_10001.Battle.BattleGatePerform = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	if arg_1_0.mainFleetId then
		...
		local var_1_4 = var_6(var_1_10008)

		getProxy = var_1_10007
		FleetProxy = var_1_10009
		var_1_10007 = var_1_10007(var_1_10009)
		...
		local var_1_5 = var_1_10007.getFleetById(var_1_10010, arg_1_0.mainFleetId)

		var_1_10011 = var_1_4
		var_1_10009 = var_1_4.getSortShipsByFleet(var_1_10011, var_1_5)
		ipairs = var_1_10010
	...
	if arg_1_0.memory then
		...
		var_1_7(var_1_10009, var_1_10010.BEGIN_STAGE_DONE, var_1_6)
	else
		local function var_1_8(arg_2_0)
			...
			local var_2_2 = var_2_10004.STORY_UPDATE
			local var_2_3 = {}

			tostring = var_2_10006
			var_2_3.storyId = var_2_10006(var_1_0)
		...
		local var_1_10 = var_1_10009.SendRequest

		SYSTEM_PERFORM = var_1_10011

		var_1_10(var_1_10011, var_1_3, {
			var_1_0
		}, var_1_8, var_1_9)
	end
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	if arg_4_0.memory then
		...
		local var_4_2 = var_1_10005.FINISH_STAGE_DONE
		local var_4_3 = {}

		SYSTEM_PERFORM = var_1_10007
		var_4_3.system = var_1_10007
		...
		local function var_4_5(arg_5_0)
			...
			local var_5_2 = var_2_10004.FINISH_STAGE_DONE
			local var_5_3 = {}

			SYSTEM_PERFORM = var_2_10006
			var_5_3.system = var_2_10006
