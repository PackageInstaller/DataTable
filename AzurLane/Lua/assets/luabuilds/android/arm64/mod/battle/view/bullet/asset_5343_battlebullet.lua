...
function var_0_5.Update(arg_2_0, arg_2_1)
	...
	local var_2_6 = var_4.abs(arg_2_0._calcSpeed.x)

	if not (0.01 <= var_2_6) then
		math = var_2_6

		local var_2_7 = var_2_6.abs(arg_2_0._calcSpeed.z)

		if not (0.01 <= var_2_7) then
			math = var_2_7

			local var_2_8 = var_2_7.abs(arg_2_0._calcSpeed.y)

			if 0.01 <= var_2_8 then
			...
			if not (var_5.abs(arg_2_0._cacheTFPos.x - var_2_9.x) >= 0.1) then
				math = var_5

				if not (var_5.abs(arg_2_0._cacheTFPos.z - var_2_9.z) >= 0.1) then
					math = var_5

					if var_5.abs(arg_2_0._cacheTFPos.y - var_2_9.y) >= 0.1 then
						arg_2_0:UpdatePosition()
					end
...
function var_0_5.SetBulletData(arg_5_0, arg_5_1)
	...
	local var_5_2 = var_1_10005.TimeMgr.GetInstance()

	var_5_1(var_5_0, var_5.GetCombatTime(var_5_2))
...
function var_0_5.onIntercepted(arg_9_0)
	...
	local var_9_3, var_9_4 = var_9_1(var_9_0, var_4.GetTemplate(var_9_2).hit_fx)

	pg = var_9_0

	local var_9_5 = var_9_0.EffectMgr.GetInstance()
...
function var_0_5.Dispose(arg_13_0)
	if arg_13_0._rotateScript then
		...
		var_13_1(var_13_0, var_1_10004.zero)
	end
...
function var_0_5.AddModel(arg_18_0, arg_18_1)
	if arg_18_0._isTempGO and arg_18_0._go == nil then
		...
		if var_2.Find(var_18_4, "bullet") then
			...
			typeof = var_1_10006
			SpineAnim = var_1_10008

			if var_18_6(var_18_5, var_1_10006(var_1_10008)) then
				...
				local var_18_9 = var_18_8(var_18_7, var_6(var_1_10008))
		...
		if var_3.Find(var_18_10, "bullet_random") then
			...
			if var_18_12(var_18_11, var_1_10007(var_1_10009)) then
				...
				local var_18_15 = var_18_14(var_18_13, var_7(var_1_10009))

				tostring = var_18_10
				math = var_7

				local var_18_16 = var_18_10(var_7.random(3))
...
function var_0_5.SetSpawn(arg_23_0, arg_23_1)
	...
	if var_23_4 then
		...
		if var_9.GetOffsetPriority(var_23_8) then
			...
			math = var_1_10010
			var_23_7 = var_23_9 * var_1_10010.atan2(var_23_4.z - var_23_0.z, var_23_4.x - var_4.x)
		else
			math = var_23_9
			...
			math = var_1_10010
			var_23_7 = var_23_10 * var_1_10010.atan2(var_23_4.z - var_23_0.z - var_23_1, var_23_4.x - var_4.x)
		end
...
function var_0_5.getHeightAdjust(arg_24_0, arg_24_1)
	...
	if var_2.GetTemplate(var_24_0).extra_param.airdrop then
		...
		if var_2.dropOffset then
			...
			math = var_1_10007
			var_24_4 = var_24_4(var_1_10007.abs(var_2.offsetY * 2 / arg_24_0._bulletData._gravity))
