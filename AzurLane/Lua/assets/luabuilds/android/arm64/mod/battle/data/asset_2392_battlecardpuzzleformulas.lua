...
function var_0_2.CreateContextCalculateDamage(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_38 = var_1_10043.floor
	...
	local var_1_40 = var_46.min
	local var_1_41 = var_1_3[1]

	math = var_1_10049

	local var_1_42 = var_1_36(var_1_37, var_1_38(var_1_39 * (var_1_25 + var_1_40(var_1_41, var_1_10049.max(-var_1_3[1], var_1_15)) * var_1_3[2])))
	local var_1_43 = arg_1_1

	if arg_1_1.GetCurrentOxyState(var_1_43) == var_0_3.OXY_STATE.DIVE then
		math = var_40
	...
	if arg_1_0.GetDamageEnhance(var_1_45) ~= 1 then
		math = var_1_43
		var_1_42 = var_1_43.floor(var_1_42 * var_41)
	end

	local var_1_46 = var_1_42 * var_1_12.repressReduce

	if var_1_11 ~= 0 then
		Mathf = var_42
		var_1_46 = var_1_46 * (var_42.RandomFloat(var_1_11) + 1)
	end

	local var_1_47 = var_0_5.GetCurrent(arg_1_0, "damageEnhanceProjectile")

	math = var_1_45

	local var_1_48 = var_1_45.max(0, var_1_46 + var_1_47) * arg_1_0:GetWeaponCardPuzzleEnhance()

	math = var_44

	local var_1_49 = var_44.floor(var_1_48)
	local var_1_50 = var_15.DMG_font[var_1_14]

	if var_1_47 < 0 then
		var_1_50 = var_0_6.BULLET_DECREASE_DMG_FONT
	end

	return var_1_49, var_1_44, var_1_50
end
...
function var_0_2.parseCompare(arg_2_0, arg_2_1)
	...
	if not var_8(var_2_3) then
		var_2_6 = arg_2_1:GetCurrent(var_2_3)
	end
	...
	if not var_9(var_2_4) then
		var_2_7 = arg_2_1:GetCurrent(var_2_4)
	end
...
function var_0_2.parseFormula(arg_3_0, arg_3_1)
	...
	for iter_3_2, iter_3_3 in var_8(var_3_1) do
		...
		if not var_1_10013(var_3_0[var_3_4]) then
			var_1_10013 = arg_3_1:GetCurrent(var_3_0[var_3_4])
		end

		if iter_3_3 == "+" or iter_3_3 == "-" then
			table = var_1_10014

			var_1_10014.insert(var_3_3, var_3_5)

			var_3_5 = var_1_10013
			table = var_1_10014

			var_1_10014.insert(var_3_2, iter_3_3)
		elseif iter_3_3 == "*" or iter_3_3 == "/" then
			getArithmeticFuncByOperator = var_1_10014
			var_3_5 = var_1_10014(iter_3_3)(var_3_5, var_1_10013)
		end
	end
	...
	while var_3_8 < #var_3_3 do
		getArithmeticFuncByOperator = var_3_7

		local var_3_7 = var_3_7(var_3_2[var_3_8])
		local var_3_8 = var_3_8 + 1

		var_3_6 = var_3_7(var_3_6, var_3_3[var_3_8])
	end
