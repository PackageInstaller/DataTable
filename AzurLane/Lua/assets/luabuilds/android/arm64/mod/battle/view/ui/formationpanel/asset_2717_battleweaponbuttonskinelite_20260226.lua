...
function var_0_1.ConfigSkin(arg_1_0, arg_1_1)
	...
	for iter_1_0 = 1, 4 do
		...
		var_1_10006(var_1_1, var_9.Find(var_1_2, "text_" .. iter_1_0))
	end
...
function var_0_1.OnCountChange(arg_2_0)
	...
	var_1(var_2_2, var_4.GetCount(var_2_3) > 0)
...
function var_0_1.SetToCombatUIPreview(arg_3_0, arg_3_1)
	...
	if arg_3_1 ~= var_1_10002.WeaponButtonPreviewMode.UNFILLED then
		...
		var_1_10004 = var_1_10004(var_3_0, var_7(var_1_10009))
		var_1_10004.alpha = 0
		...
		typeof = var_7
		CanvasGroup = var_1_10009
		var_3_2(var_3_1, var_7(var_1_10009)).alpha = 1
...
function var_0_1.OnOverLoadChange(arg_4_0, arg_4_1)
	if arg_4_1 and arg_4_1.Data and arg_4_1.Data.postCast then
		...
		for iter_4_0, iter_4_1 in var_1_10003(arg_4_0._bookList) do
