...
math = var_14
var_0_11.TRACKER_ANGLE = var_0_12(var_14.deg2Rad * 10)
...
function var_0_11.doTrack(arg_2_0)
	...
	local var_2_1 = var_2 - arg_2_0.GetPosition(var_2_0)
	...
	local var_2_3 = var_2_0.Dot(var_2_2, var_3)
	local var_2_4 = var_2_2.z * var_3.x - var_2_2.x * var_3.z

	if var_2_3 >= var_0_11.TRACKER_ANGLE then
		return
	end

	local var_2_5 = arg_2_0
	local var_2_6 = arg_2_0.GetSpeedRatio(var_2_5)

	math = var_8

	local var_2_7 = var_8.cos(arg_2_0._cosAngularSpeed * var_2_6)

	math = var_2_5

	local var_2_8 = var_2_5.sin(arg_2_0._sinAngularSpeed * var_2_6)
	...
	local var_2_13 = arg_2_0._speed

	var_14.Set(var_2_13, var_2_11, 0, var_2_12)
...
function var_0_11.doOrbit(arg_3_0)
	...
	local var_3_2 = var_3_0(var_3.GetPosition(var_3_1))

	pg = var_1_10002

	local var_3_3 = (var_1_10002.Tool.FilterY(arg_3_0:GetPosition()) - var_3_2).magnitude
...
function var_0_11.RotateY(arg_4_0, arg_4_1)
	...
	local var_4_1 = var_1_10003.sin(arg_4_1)
	...
	if arg_37_0._host then
		...
		elseif var_3:IsAlive() then
			...
			if arg_37_0._buffTriggerFun[arg_37_1] then
				...
				for iter_37_0, iter_37_1 in var_1_10005(var_4) do
...
function var_0_11.SetSpawnPosition(arg_62_0, arg_62_1)
	...
	if arg_62_0._gravity ~= 0 then
		...
		if var_2.atan2(arg_62_0._speed.x, arg_62_0._speed.z) == 0 then
			...
			local var_62_0 = var_5.cos(var_2) * 60

			math = var_1_10006

			local var_62_1 = var_1_10003(var_62_0, var_1_10006.sin(var_2) * 60)
...
function var_0_11.GetCurrentYAngle(arg_77_0)
	...
	local var_77_1 = var_1_10002.acos(var_77_0.x)
...
function var_0_11.generateAttachBuffList(arg_83_0)
	...
	for iter_83_0, iter_83_1 in var_1_10003(arg_83_0:GetTemplate().attach_buff) do
		local var_83_2 = {
		...
		var_9.insert(var_83_0, var_83_2)
	end
...
function var_0_11.InitSpeed(arg_104_0, arg_104_1)
	...
	if arg_104_0:HasAcceleration() then
		...
		local var_104_2 = var_1_10005.cos(var_104_1)
		local var_104_3 = 0

		math = var_7
		arg_104_0._speedNormal = var_3(var_104_2, var_104_3, var_7.sin(var_104_1))
		Vector3 = var_3
...
function var_0_11.calcSpeed(arg_106_0)
	...
	local var_106_4 = var_106_2 * var_1_10006.cos(var_106_3)
	local var_106_5 = 0

	math = var_8
	arg_106_0._speed = var_4(var_106_4, var_106_5, var_106_2 * var_8.sin(var_106_3))
