...
local var_0_2 = ys.Battle.BattleDirectBulletFactory

function ys.Battle.BattleDirectBulletFactory.Ctor(arg_1_0)
	var_0_2.super.Ctor(arg_1_0)

	return
end

function ys.Battle.BattleDirectBulletFactory.CreateBullet(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
