...
function var_0_2.GetFX(arg_4_0, arg_4_1, arg_4_2)
	...
	var_1_10004.SetGOParentTF(var_4_1, arg_4_2 or arg_4_0._fxContainerTf, false)
...
function var_0_2.GetCharacterFX(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5)
	...
	if var_0_1[arg_5_1] ~= nil then
		...
		var_5_5 = var_9.offset
		Vector3 = var_1_10011
		var_5_3 = var_1_10011(var_5_5[1], var_5_5[2], var_5_5[3] + 0.02)

		if var_5_4 == -1 then
			LuaHelper = var_11

			var_11.SetGOParentGO(var_5_1, arg_5_2:GetGO(), true)
		else
			var_5_3 = var_5_3 + arg_5_2:GetFXOffsets(var_5_4)
			LuaHelper = var_1_10012

			var_1_10012.SetGOParentGO(var_5_1, arg_5_2:GetAttachPoint(), true)
		end

		if var_9.mirror and var_5_1.transform.parent.transform.lossyScale.x < 0 then
			local var_5_6 = var_5_1.transform.localScale
			local var_5_7 = var_5_1.transform

			Vector3 = var_1_10014
			var_5_7.localScale = var_1_10014(-1 * var_5_6.x, var_5_6.y, var_5_6.z)
		end
	else
		Vector3 = var_5_5
		var_5_3 = var_5_5(0, 0, 0.02)
		LuaHelper = var_10
	...
	if arg_5_2:GetSpecificFXScale()[arg_5_1] then
		var_5_8 = var_10[arg_5_1]

		local var_5_9 = var_5_1.transform.localScale
		local var_5_10 = var_5_1.transform

		Vector3 = var_1_10014
		var_5_10.localScale = var_1_10014(var_5_9.x * var_5_8, var_5_9.y * var_5_8, var_5_9.z * var_5_8)
	end

	pg = var_5_8

	local var_5_11 = var_5_8.EffectMgr.GetInstance()

	var_11.PlayBattleEffect(var_5_11, var_5_1, var_5_3, arg_5_3, arg_5_4, arg_5_5)
