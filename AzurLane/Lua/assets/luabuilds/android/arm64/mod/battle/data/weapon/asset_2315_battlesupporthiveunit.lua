...
function var_0_4.SpwanAircraft(arg_6_0, arg_6_1)
	...
	local var_6_4 = var_6_0.deg2Rad * var_6_3

	Vector3 = var_6_2
	math = var_7

	local var_6_5 = var_7.cos(var_6_4)
	local var_6_6 = 0

	math = var_9

	local var_6_7 = var_6_2(var_6_5, var_6_6, var_9.sin(var_6_4))
...
function var_0_4.GetDamageSUM(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_1_10003(var_9_1) do
		...
		for iter_9_2, iter_9_3 in var_1_10009(var_9_2) do
