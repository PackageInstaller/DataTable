...
function var_0_3.init(arg_2_0)
	...
	;(function(arg_3_0)
		...
		for iter_3_0 = 1, 3 do
			...
			var_2_10007.insert(arg_2_0._skillList[arg_3_0], {
				idle = true,
				tf = var_3_2
			})
		end
...
function var_0_3.DoSkillFloat(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_7 = var_4_6(var_4_5, var_10(var_1_10012)).sprite

	setImageSprite = var_4_2

	var_4_2(var_4_3, var_4_7, true)
	...
	local var_4_10 = var_4_9(var_4_8, var_11(var_1_10013))
...
function var_0_3.DoFusionFloat(arg_6_0, arg_6_1)
	...
	local var_6_3 = var_6_2(var_6_1, var_6(var_1_10008))
