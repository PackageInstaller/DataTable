...
function ys.Battle.BattleBuffBarrier.SetArgs(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_0 = Clone(arg_2_0._tempData.arg_list.cld_data.offset)

	if arg_2_1:GetDirection() == var_0_0.Battle.BattleConst.UnitDir.LEFT then
		var_2_0[1] = -var_2_0[1]
	end

	arg_2_0._wall = arg_2_0._dataProxy:SpawnWall(arg_2_0, function(arg_3_0)
		arg_2_0._dataProxy:HandleDamage(arg_3_0, arg_2_0._unit)
		arg_3_0:Intercepted()
		arg_2_0._dataProxy:RemoveBulletUnit(arg_3_0:GetUniqueID())

		return
	end, arg_2_0._tempData.arg_list.cld_data.box, var_2_0)
...
function ys.Battle.BattleBuffBarrier.onTakeDamage(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	if arg_5_0:damageCheck(arg_5_3) then
		arg_5_0._durability = arg_5_0._durability - arg_5_3.damage
...
function ys.Battle.BattleBuffBarrier.onAttach(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
...
function ys.Battle.BattleBuffBarrier.onRemove(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
...
function ys.Battle.BattleBuffBarrier.GetIFF(arg_8_0)
	return arg_8_0._unit:GetIFF()
end

function ys.Battle.BattleBuffBarrier.GetPosition(arg_9_0)
	return arg_9_0._centerPos
end

function ys.Battle.BattleBuffBarrier.IsWallActive(arg_10_0)
