...
ys = var_0_10001
var_0_10001.Battle.BattleGateLimitChallenge = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	local var_1_3 = var_5(var_1_10007)

	getProxy = var_1_1
	BayProxy = var_1_10008

	local var_1_4 = var_1_1(var_1_10008)

	getProxy = var_1_10007
	LimitChallengeProxy = var_1_10009
	...
	local var_1_11 = var_1_10(var_1_9, var_1_10014.CHALLENGE_FLEET_ID)
	local var_1_12 = {}
	local var_1_13 = var_1_4:getSortShipsByFleet(var_1_11)

	ipairs = var_14

	for iter_1_0, iter_1_1 in var_14(var_1_13) do
		var_1_12[#var_1_12 + 1] = iter_1_1.id
	end

	pg = var_14

	local var_1_14 = var_14.battle_cost_template[var_0_0.BattleSystem].oil_cost > 0
	local var_1_15 = 0
	local var_1_16 = 0

	if var_1_14 then
		var_1_10020 = var_1_11
		var_1_15 = var_1_11.getStartCost(var_1_10020).oil
		var_1_10020 = var_1_11
		var_1_16 = var_1_11.GetCostSum(var_1_10020).oil
	end

	if var_1_14 and var_1_2.oil < var_1_16 then
		pg = var_18
		...
		var_1_17(var_1_10020, var_1_10021("stage_beginStage_error_noResource"))
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	local var_4_1 = var_3(var_1_10005)
	...
	local var_4_10 = var_4_9(var_4_8, var_1_10013.CHALLENGE_FLEET_ID)
	local var_4_11
	...
	if arg_4_0.statistics.submarineAid then
		...
		var_4_11 = var_4_13(var_4_12, var_1_10015.CHALLENGE_SUB_FLEET_ID)
	end
	...
	;(function()
		(function(arg_6_0)
			...
			var_6_1(var_6_2, var_3_10005.values(arg_6_0.commanderIds))
			...
			var_6_3(var_6_4, var_5.getSortShipsByFleet(var_6_5, arg_6_0))
	...
	local function var_4_15(arg_7_0)
		...
		var_7_8(var_7_7, var_9.FINISH_STAGE_DONE, var_7_6)
...
function var_0_0.GetPreloadList(arg_8_0)
	...
	local var_8_8 = var_7:getFleetById(var_8_5)

	getProxy = var_8_6
	BayProxy = var_12

	local var_8_9 = var_8_6(var_12)
	...
	if var_8_7 then
		...
		for iter_8_0, iter_8_1 in var_12(var_8_10) do
			table = var_1_10017

			var_1_10017.insert(var_8_0, var_8_9:getShipById(iter_8_1))
		end
	...
	if var_8_8 then
		...
		for iter_8_2, iter_8_3 in var_12(var_8_11) do
			table = var_1_10017

			var_1_10017.insert(var_8_0, var_8_9:getShipById(iter_8_3))
		end

		ipairs = var_12

		for iter_8_4, iter_8_5 in var_12(var_8_8:buildBattleBuffList()) do
			table = var_1_10017
	...
	for iter_8_6, iter_8_7 in var_13(var_8_14) do
		table = var_1_10018

		var_1_10018.insert(var_8_12, iter_8_7)
	end

	LimitChallengeConst = var_13

	local var_8_15 = var_13.GetChallengeIDByStageID(arg_8_0.stageId)

	AcessWithinNull = var_14
	pg = iter_8_6

	if var_14(iter_8_6.expedition_constellation_challenge_template[var_8_15], "buff_id") then
		ipairs = var_15

		for iter_8_8, iter_8_9 in var_15(var_14) do
			ys = var_1_10020

			local var_8_16 = var_1_10020.Battle.BattleDataFunction.GetResFromBuff(iter_8_9.ID, iter_8_9.LV, {})

			ipairs = var_1_10020

			for iter_8_10, iter_8_11 in var_1_10020(var_8_16) do
				table = var_1_10025

				var_1_10025.insert(var_8_12, iter_8_11)
			end
		end
	end
