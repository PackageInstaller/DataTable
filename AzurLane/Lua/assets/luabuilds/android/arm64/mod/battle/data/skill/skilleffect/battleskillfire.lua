	...
	if var_2.GetType(var_9_1) ~= var_0_2.EquipmentType.INTERCEPT_AIRCRAFT then
		do
			...
			if var_2.GetType(var_9_2) == var_0_2.EquipmentType.STRIKE_AIRCRAFT then
				...
				for iter_9_0, iter_9_1 in var_2(var_4.GetATKAircraftList(var_9_3)) do
					local var_9_4 = iter_9_1:GetWeapon()

					ipairs = var_1_10008

					for iter_9_2, iter_9_3 in var_1_10008(var_9_4) do
						var_9_0 = var_9_0 + iter_9_3:GetDamageSUM()
					end
				end
			else
				local var_9_5 = arg_9_0._weapon

				var_9_0 = var_2.GetDamageSUM(var_9_5)
			end
		end
