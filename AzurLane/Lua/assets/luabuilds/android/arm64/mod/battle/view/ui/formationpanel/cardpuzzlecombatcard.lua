...
CardPuzzleCardView = var_0_10006
var_0_2.CardPuzzleCombatCard = var_0_10003(var_0_3, var_0_10006)
...
function var_0_4.UpdateView(arg_4_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_4_0._coolDownProgress = var_4_2(var_4_1, var_4(var_1_10006))
	...
	arg_4_0._canvaGroup = var_4_4(var_4_3, var_4(var_1_10006))
...
function var_0_4.MoveToRefPos(arg_14_0)
	...
	if arg_14_0._moveLerp == 1 then
		local var_14_1 = arg_14_0._pos

		var_1.Copy(var_14_1, arg_14_0._refPos)
	else
		local var_14_2 = arg_14_0._tf.localPosition

		Vector2 = var_1_10002

		local var_14_3 = var_1_10002.Lerp(var_14_2, arg_14_0._refPos, arg_14_0._moveLerp)
		local var_14_4 = arg_14_0._pos

		var_3.Copy(var_14_4, var_14_3)
	end
...
function var_0_4.UpdateTotalCost(arg_29_0)
	if arg_29_0._cardInfo then
		...
		var_1(var_29_0, var_4.GetTotalCost(var_29_1))
	end
...
function var_0_4.UpdateBoostHint(arg_30_0)
	if arg_30_0._cardInfo then
		...
		var_1(var_30_0, var_4.IsBoost(var_30_1))
	end
