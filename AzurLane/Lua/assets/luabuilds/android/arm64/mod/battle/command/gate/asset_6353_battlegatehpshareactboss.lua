...
ys = var_0_10001
var_0_10001.Battle.BattleGateHPShareActBoss = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	local var_1_4 = var_1_1.activity_event_worldboss[var_1_3]

	getProxy = var_1_2
	PlayerProxy = var_1_10008

	local var_1_5 = var_1_2(var_1_10008)

	getProxy = var_7
	BayProxy = var_1_10009

	local var_1_6 = var_7(var_1_10009)

	getProxy = var_1_10008
	FleetProxy = var_1_10010

	local var_1_7 = var_1_10008(var_1_10010)
	...
	local var_1_17 = var_1_7
	local var_1_18 = var_1_7.getActivityFleets(var_1_17)[var_1_0][var_1_16]
	local var_1_19 = var_1_6:getSortShipsByFleet(var_1_18)

	ipairs = var_1_17

	for iter_1_0, iter_1_1 in var_1_17(var_1_19) do
	...
	local var_1_23 = var_3

	if var_3.IsOilLimit(var_1_23, var_1_15) then
		local var_1_24 = var_1_22[1]

		if 0 < var_1_24 then
			math = var_1_24
			var_1_21 = var_1_24.min(var_1_21, var_1_22[1])
		end
	end

	local var_1_25 = var_1_5
	local var_1_26 = var_1_5.getData(var_1_25)

	pg = var_1_23

	local var_1_27 = var_1_23.activity_template[var_1_0]

	pg = var_1_25

	local var_1_28 = var_1_25.activity_event_worldboss[var_1_27.config_id].ticket
	local var_1_29 = var_1_5:getRawData()
	local var_1_31

	if var_27.getResource(var_1_29, var_1_28) <= 0 then
		pg = var_1_31

		local var_1_30 = var_1_31.TipsMgr.GetInstance()

		var_1_31 = var_1_31.ShowTips
		i18n = var_30

		var_1_31(var_1_30, var_30("stage_beginStage_error_noTicket"))

		return
	end

	if var_1_9 and var_1_26.oil < var_1_21 then
		pg = var_1_31

		local var_1_32 = var_1_31.TipsMgr.GetInstance()

		var_1_31 = var_1_31.ShowTips
		i18n = var_30

		var_1_31(var_1_32, var_30("stage_beginStage_error_noResource"))
	...
	local var_1_33 = var_1_31.expedition_data_template[var_1_15].dungeon_id

	ys = var_28

	local var_1_34 = var_28.Battle.BattleDataFunction.GetDungeonTmpDataByID(var_1_33).fleet_prefab

	arg_1_1.ShipVertify()

	local function var_1_35(arg_2_0)
		if var_1_9 then
		...
		local var_2_1 = var_1(var_1_28)
		local var_2_2 = var_1_26
		...
		var_2.updatePlayer(var_2_6, var_1_26)

		local var_2_7 = {
			mainFleetId = var_1_16,
			actId = var_1_0,
			prefabFleet = var_1_34,
			stageId = var_1_15
		}
		...
		var_2_9(var_2_8, iter_2_0.BEGIN_STAGE_DONE, var_2_7)

		return
	end

	local function var_1_36(arg_3_0)
	...
	local var_1_37 = var_1_10031.SendRequest

	SYSTEM_HP_SHARE_ACT_BOSS = var_1_10033

	var_1_37(var_1_10033, var_1_10, {
		var_1_15
	}, var_1_35, var_1_36)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	local var_4_6 = var_4_5(var_1_10008)
	local var_4_7 = var_6.getActivityById(var_4_6, arg_4_0.actId)
	local var_4_8 = var_6.getConfig(var_4_7, "config_id")

	pg = var_4_6

	local var_4_9 = var_4_6.activity_event_worldboss[var_4_8].use_oil_limit[arg_4_0.mainFleetId]
	...
	local function var_4_25(arg_6_0)
		...
		SYSTEM_HP_SHARE_ACT_BOSS = var_7

		var_6_6(var_7, var_6_4, var_4_13, arg_6_0.player_exp)
		...
		var_6_11(var_6_10, var_9.FINISH_STAGE_DONE, var_6_7)
