...
function var_0_1.onBulletHit(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if not arg_3_0._weaponType then
		...
		if arg_3_0._number > 0 then
			math = var_8
			var_3_2 = var_8.floor(var_3_2 * var_3_0)
		end
...
function var_0_1.onTrigger(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_0:CalcNumber(arg_6_1) > 0 then
		local var_6_0 = arg_6_1:GetAttrByName("healingRate")

		math = var_6
		var_6_1 = var_6.floor(var_6_1 * var_6_0)
	end
	...
	arg_6_1:UpdateHP(var_6_1, var_6_2)
...
function var_0_1.CalcNumber(arg_7_0, arg_7_1)
	...
	return var_7_1.floor((var_7_0 * arg_7_0._currentHPRatio + arg_7_0._maxHPNumber + arg_7_0._number + arg_7_0._castMaxHPNumber + var_7_2 * arg_7_0._castHPRatio) * var_7_4)
end
