...
function var_0_9.RemovePlayerUnit(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_1_10002(var_5_0, var_1_10005) do
...
function var_0_9.ShiftManualSub(arg_17_0)
	...
	if arg_17_0._manualSubUnit then
		...
		for iter_17_0, iter_17_1 in var_1_10003(var_17_2) do
	...
	for iter_17_8, iter_17_9 in var_4(var_17_14) do
	...
	for iter_17_10, iter_17_11 in var_5(var_17_19) do
...
function var_0_9.SubmarinBoost(arg_19_0)
	...
	var_19_1(var_19_0, var_1_10004.right, var_0_5.SR_CONFIG.BOOST_SPEED, var_0_5.SR_CONFIG.BOOST_DECAY, var_0_5.SR_CONFIG.BOOST_DURATION, var_0_5.SR_CONFIG.BOOST_DECAY_STAMP)
