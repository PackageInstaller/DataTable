...
function var_0_3.DoPrologue(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_3_10(var_3_15) do
		iter_3_1:FleetWarcry()

		local var_3_16 = iter_3_1:GetUnitList()

		ipairs = var_1_10012

		for iter_3_2, iter_3_3 in var_1_10012(var_3_16) do
			local var_3_17 = iter_3_3
			local var_3_18 = iter_3_3.GetTemplate(var_3_17).type
			local var_3_19 = var_0.Battle.BattleDataFunction.GetArenaBuffByShipType(var_3_18)

			ipairs = var_3_17

			for iter_3_4, iter_3_5 in var_3_17(var_3_19) do
	...
	for iter_3_6, iter_3_7 in var_7(var_3_25) do
	...
	if #var_2.GetUnitList(var_18_3) ~= 0 then
		...
		if #var_2.GetUnitList(var_18_4) == 0 then
			...
			if arg_18_0._failReason then
				...
				var_18_7(var_18_6, var_5.CHEATER_MARK, {
		...
		if not var_4.IsMainFleetUnit(var_18_22) and var_18_11 == 0 and var_18_13 == 0 then
			...
			for iter_18_0, iter_18_1 in var_18_23(var_18_24) do
			...
			var_18_30(var_18_29, iter_18_2("battle_duel_main_rage"))
		end
