...
local var_0_0 = singletonClass("BattleSupportCharacterFactory", ys.Battle.BattleCharacterFactory)

ys.Battle.BattleSupportCharacterFactory = var_0_0
var_0_0.__name = "BattleSupportCharacterFactory"
