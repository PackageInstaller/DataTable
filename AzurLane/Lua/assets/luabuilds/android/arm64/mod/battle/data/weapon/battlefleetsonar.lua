...
function var_0_9.flush(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10005(arg_8_0._crewUnitList) do
		if iter_8_1:GetAttrByName("sonarRange") > 0 then
			...
			local var_8_5 = iter_8_1.GetAttrByName(var_8_4, "sonarInterval")
			local var_8_6 = iter_8_1:GetAttrByName("sonarDuration")

			math = var_8_4
			var_8_1 = var_8_4.max(var_8_1, var_10)
...
function var_0_9.Detect(arg_10_0)
	...
	local var_10_1 = arg_10_0:FilterTarget()

	ipairs = var_1_10002

	for iter_10_0, iter_10_1 in var_1_10002(var_10_1) do
		iter_10_1:Detected(10)
	end

	arg_10_0._detectedList = var_10_1

	local var_10_2 = arg_10_0._fleetVO

	var_2.DispatchSonarScan(var_10_2)
