...
function ys.Battle.BattleCharacterFXContainersPool.Init(arg_2_0)
	arg_2_0._pool = {}
...
function ys.Battle.BattleCharacterFXContainersPool.Pop(arg_3_0, arg_3_1, arg_3_2)
	arg_3_2 = arg_3_2 or {
		{
			0,
			0,
	...
	if #arg_3_0._pool == 0 then
		...
		var_3_0 = arg_3_0._pool[#arg_3_0._pool]
...
function ys.Battle.BattleCharacterFXContainersPool.Push(arg_4_0, arg_4_1)
	for iter_4_0, iter_4_1 in ipairs(arg_4_1) do
		iter_4_1.transform:SetParent(arg_4_0._templateContainerTf, false)
...
function ys.Battle.BattleCharacterFXContainersPool.Clear(arg_5_0)
