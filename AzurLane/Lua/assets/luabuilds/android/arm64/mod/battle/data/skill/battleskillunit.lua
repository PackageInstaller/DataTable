...
function var_0_4.Cast(arg_4_0, arg_4_1, arg_4_2)
	...
	if arg_4_0._tempData.painting == 1 then
		if arg_4_2 then
			...
			var_4_2(var_4_1, var_7.getConfig(var_4_3, "name"), arg_4_2:getPainting())
		else
	...
	elseif var_4 == "table" then
		...
		local var_4_4, var_4_6

		var_4_4, var_4_5, var_4_6 = var_1_10005.GetWordAndCV(arg_4_0._tempData.castCV.skinID, arg_4_0._tempData.castCV.key)
		pg = var_8

		local var_4_7 = var_8.CriMgr.GetInstance()

		var_8.PlaySoundEffect_V3(var_4_7, var_4_5)
	end
	...
	for iter_4_0, iter_4_1 in var_4_5(arg_4_0._effectList) do
		...
		if iter_4_1:IsFinaleEffect() then
			...
			iter_4_1:SetFinaleCallback(var_4_9)
		end

		iter_4_1:Effect(arg_4_1, var_11, var_4_8)
	end
...
function var_0_4.IsFireSkill(arg_11_0, arg_11_1)
	...
	for iter_11_0, iter_11_1 in var_1_10004(var_11_1.effect_list) do
