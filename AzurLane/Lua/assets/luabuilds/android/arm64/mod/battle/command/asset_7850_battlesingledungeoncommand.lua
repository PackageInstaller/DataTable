...
function var_0_3.onInitBattle(arg_11_0)
	...
	var_11_2(var_11_1, var_4.GetStageInfo(var_11_3))
...
function var_0_3.initWaveModule(arg_12_0)
	...
	local function var_12_2()
		if arg_12_0._vertifyFail then
			...
			var_15_1(var_15_0, var_2_10003.CHEATER_MARK, {
...
function var_0_3.GetMaxRestHPRateBossRate(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1_10002(var_29_1) do
	...
	for iter_29_2, iter_29_3 in var_3(var_5.GetUnitList(var_29_3)) do
