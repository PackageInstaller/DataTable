...
ys = var_0_10001
var_0_10001.Battle.BattleGateSubRoutine = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	local var_1_13 = var_1_1.getShipByTeam
	local var_1_14 = var_1_11

	TeamType = var_1_10017

	local var_1_15 = var_1_13(var_1_12, var_1_14, var_1_10017.Submarine)

	ipairs = var_1_10

	for iter_1_0, iter_1_1 in var_1_10(var_1_15) do
		var_1_5[#var_1_5 + 1] = iter_1_1.id
	end

	local var_1_16 = var_1_11:getStartCost().oil
	local var_1_17 = var_1_11:GetCostSum().oil
	local var_1_18 = var_1_0:getData()

	if var_1_4 and var_1_18.oil < var_1_17 then
		pg = var_17
		...
		var_1_19(var_1_10019, var_1_10020("stage_beginStage_error_noResource"))
	...
	local function var_1_24(arg_2_0)
		...
		var_1.updatePlayer(var_2_4, var_1_18)
	...
	SYSTEM_SUB_ROUTINE = var_1_10025

	var_1_26(var_1_10025, var_1_5, {
		var_1_21
	}, var_1_24, var_1_25)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	local function var_4_11(arg_5_0)
		...
		SYSTEM_SUB_ROUTINE = var_2_10006
