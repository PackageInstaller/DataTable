...
function var_0_1.OnTotalChange(arg_5_0, arg_5_1)
	...
	if var_2.GetTotal(var_5_0) <= 0 then
		...
		var_5_3(var_5_2, var_5(var_1_10007)).alpha = 0
		...
		typeof = var_5
		Text = var_1_10007
		var_5_5(var_5_4, var_5(var_1_10007)).text = "0/0"
...
function var_0_1.OnCountChange(arg_6_0)
	...
	var_1(var_6_0, var_4.GetCount(var_6_1) > 0)
	...
	var_1(var_6_2, var_4.GetCount(var_6_3) > 0)
...
function var_0_1.StopCombatUIPreviewLoop(arg_7_0)
	if arg_7_0._skin then
		...
		var_7_0(var_1_10003(arg_7_0._skin))
	end
...
function var_0_1.ApplyCombatUIPreviewState(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	var_8_2(var_8_1, var_8(var_1_10010)).alpha = (arg_8_3 or arg_8_1 > 0) and 1 or 0
...
function var_0_1.StartCombatUIPreviewLoop(arg_9_0)
	...
	;(function()
		...
		local var_10_3 = var_10_2(var_10_1, var_3.Action_float(function(arg_11_0)
		...
		var_10_4(var_10_3, var_3.Action(function()
			...
			var_12_1(var_12_2, var_12_3, var_4.Action(function()
				...
				var_13_1(var_13_2, var_13_3, var_4.Action(function()
					...
					var_14_1(var_14_2, var_14_3, var_4.Action(function()
						var_0()
...
function var_0_1.updateProgressBar(arg_17_0)
	...
	if arg_17_0._progressInfo.GetCount then
		...
		if var_2.GetCount(var_17_4) > 0 then
			...
			var_17_6(var_17_5, var_17_7, var_6.GetMax(var_17_8))
	...
	do
		...
		var_17_10(var_17_9, var_17_11, var_6.GetMax(var_17_12))
	end
...
function var_0_1.updateProgressBG(arg_18_0, arg_18_1, arg_18_2)
	...
	if arg_18_2 and var_0_2 < arg_18_2 then
		...
		local var_18_2 = var_1_10008.min(var_4, var_1_10007 + 1)
