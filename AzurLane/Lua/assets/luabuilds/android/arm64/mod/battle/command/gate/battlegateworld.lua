...
ys = var_0_10001
var_0_10001.Battle.BattleGateWorld = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	if var_1_10003.DockOverload() then
		...
		var_1_0.TriggerAutoFight(var_1_10005, false)
	...
	local var_1_1 = var_3(var_1_10005)
	...
	if var_1_4 and var_1_20.oil < var_1_18 then
		...
		var_1_21(var_1_10020, var_1_10021("stage_beginStage_error_noResource"))
	...
	local var_1_23 = var_1_19.expedition_data_template[var_1_22].dungeon_id

	ys = var_1_10020

	local var_1_24 = var_1_10020.Battle.BattleDataFunction.GetDungeonTmpDataByID(var_1_23).fleet_prefab
	local var_1_25 = arg_1_0.hpRate
	...
	local var_1_28 = var_1_10024.SendRequest

	SYSTEM_WORLD = var_1_10026

	var_1_28(var_1_10026, var_1_5, {
		var_1_22
	}, var_1_26, var_1_27)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	if arg_4_0.statistics.submarineAid then
		...
		var_12(var_4_13, "submarine fleet not exist.")
		...
		local var_4_16 = var_4_15(var_4_14, var_15.Submarine, true)

		ipairs = var_4_12

		for iter_4_0, iter_4_1 in var_4_12(var_4_16) do
	...
	local function var_4_20(arg_5_0)
		...
		local var_5_2 = var_0
		local var_5_3 = var_0
		local var_5_4 = var_5_0(var_5_1, var_5_2, var_5.GetSubmarineFleet(var_5_3))
		...
		local var_5_9 = var_5_8 > var_5.Battle.BattleConst.BattleScore.C
		local var_5_10 = arg_4_1.GeneralPlayerCosume

		SYSTEM_WORLD = var_5_3
		...
		var_5_10(var_5_3, var_5_11, var_5_12, var_5_13, var_2_10011)
...
function var_0_0.GetPreloadList(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_6_3(var_6_5:GetShipVOs(true)) do
		table = var_12

		var_12.insert(var_6_0, iter_6_1)
	end
	...
	if var_4:GetSubAidFlag() == true then
		local var_6_8 = var_5
		local var_6_9 = var_5.GetSubmarineFleet(var_6_8)
		local var_6_10 = var_10.GetTeamShipVOs

		TeamType = var_1_10014

		local var_6_11 = var_6_10(var_6_9, var_1_10014.Submarine, false)

		ipairs = var_6_8

		for iter_6_2, iter_6_3 in var_6_8(var_6_11) do
			table = var_1_10017
		...
		local var_6_13, var_6_14 = var_5.getFleetBattleBuffs(var_6_12, var_10)

		ipairs = var_6_12

		for iter_6_4, iter_6_5 in var_6_12(var_6_13) do
			table = var_1_10019
		...
		for iter_6_6, iter_6_7 in var_14(var_6_14) do
			table = var_1_10019
	...
	local var_6_15, var_6_16 = var_6_2.GetPlayerShipResource(var_6_0, arg_6_0.system)
	local var_6_17 = var_5
	local var_6_18 = var_5.GetChapterAuraBuffs(var_6_17)
	local var_6_19 = var_5:GetChapterAidBuffs()

	pairs = var_6_17

	for iter_6_8, iter_6_9 in var_6_17(var_6_19) do
		ipairs = var_1_10019

		for iter_6_10, iter_6_11 in var_1_10019(iter_6_9) do
			table = var_1_10024

			var_1_10024.insert(var_6_18, iter_6_11)
		end
	end

	local var_6_20 = var_6_2.GetResFromBuffList(var_6_18)

	ipairs = var_14

	for iter_6_12, iter_6_13 in var_14(var_6_20) do
		table = var_1_10019

		var_1_10019.insert(var_6_15, iter_6_13)
	end

	local var_6_21 = var_5
	local var_6_22 = var_5.GetCell(var_6_21, var_6_5.row, var_6_5.column)
	local var_6_23 = var_14.GetStageEnemy(var_6_22)

	table = var_6_21

	local var_6_24 = var_6_21.mergeArray
	local var_6_25 = var_6_23:GetBattleLuaBuffs()
	local var_6_26 = var_5
	local var_6_27 = var_5.GetBattleLuaBuffs

	WorldMap = iter_6_10

	local var_6_28 = var_6_24(var_6_25, var_6_27(var_6_26, iter_6_10.FactionEnemy, var_6_23))

	ipairs = var_16

	for iter_6_14, iter_6_15 in var_16(var_6_28) do
		table = var_6_26

		var_6_26.insert(var_6_6, iter_6_15)
	end

	local var_6_29 = var_6_2.GetResFromBuffIDList(var_6_6)

	ipairs = var_16

	for iter_6_16, iter_6_17 in var_16(var_6_29) do
		table = var_6_26

		var_6_26.insert(var_6_15, iter_6_17)
	end

	local var_6_30 = var_6_2.GetCommanderBuffRes(var_6_7)

	ipairs = var_16

	for iter_6_18, iter_6_19 in var_16(var_6_30) do
		table = var_6_26

		var_6_26.insert(var_6_15, iter_6_19)
	end

	return var_6_15, var_6_16
end
