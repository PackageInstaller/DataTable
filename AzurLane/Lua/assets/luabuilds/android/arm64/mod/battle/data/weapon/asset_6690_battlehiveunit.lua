...
function var_0_4.SpwanAircraft(arg_10_0, arg_10_1)
	...
	if arg_10_0:GetStandHost() then
		var_10_1:SetAttr(arg_10_0:GetStandHost())
	end

	local var_10_2 = arg_10_0
	local var_10_3 = arg_10_0.GetBaseAngle(var_10_2) + arg_10_1

	math = var_10_0

	local var_10_4 = var_10_0.deg2Rad * var_10_3

	Vector3 = var_10_2
	math = var_7

	local var_10_5 = var_7.cos(var_10_4)
	local var_10_6 = 0

	math = var_9

	local var_10_7 = var_10_2(var_10_5, var_10_6, var_9.sin(var_10_4))
...
function var_0_4.GetDamageSUM(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_1_10003(var_16_1) do
		...
		for iter_16_2, iter_16_3 in var_1_10009(var_16_2) do
