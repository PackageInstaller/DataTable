...
function ys.Battle.BattleDataProxy.HandleBulletHit(arg_6_0, arg_6_1, arg_6_2)
	...
	arg_6_1:BuffTrigger(ys.Battle.BattleConst.BuffEffectType.ON_BULLET_COLLIDE, {
		_bullet = arg_6_1
	})
...
function ys.Battle.BattleDataProxy.HandleDamage(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	arg_7_0:DamageStatistics(var_7_1.id, arg_7_2:GetAttrByName("id"), -arg_7_2:UpdateHP(var_7_5 * -1, var_7_12))
	...
	if var_7_15 ~= var_0_3.UnitType.AIRCRAFT_UNIT and var_7_15 ~= var_0_3.UnitType.AIRFIGHTER_UNIT and var_7_15 ~= var_0_3.UnitType.FUNNEL_UNIT and var_7_15 ~= var_0_3.UnitType.UAV_UNIT then
		var_7_16 = false
	end
	...
	if arg_7_2:IsAlive() then
		...
		arg_7_0:obituary(arg_7_2, var_7_16, arg_7_1)
...
function ys.Battle.BattleDataProxy.HandleMeteoDamage(arg_8_0, arg_8_1, arg_8_2)
...
function ys.Battle.BattleDataProxy.HandleDirectDamage(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6, arg_9_7)
	local var_9_0
	local var_9_1, var_9_2
	...
	arg_9_0:DamageStatistics(var_9_0, var_9_1, -arg_9_1:UpdateHP(arg_9_2 * -1, {
		isMiss = false,
		isCri = false,
		isHeal = false,
	...
	if not var_9_2 and var_9_0 then
		arg_9_0:KillCountStatistics(var_9_0, var_9_1)
	end
	...
	if not var_9_2 then
		...
		if var_9_3 ~= var_0_3.UnitType.AIRCRAFT_UNIT and var_9_3 ~= var_0_3.UnitType.AIRFIGHTER_UNIT and var_9_3 ~= var_0_3.UnitType.FUNNEL_UNIT and var_9_3 ~= var_0_3.UnitType.UAV_UNIT then
			var_9_4 = false
		end

		arg_9_0:obituary(arg_9_1, var_9_4, arg_9_3)
	end

	return
end

function ys.Battle.BattleDataProxy.obituary(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
...
function ys.Battle.BattleDataProxy.HandleAircraftMissDamage(arg_11_0, arg_11_1, arg_11_2)
	...
	if var_11_0 then
		var_11_0:CloakExpose(arg_11_0._airExposeEX)
	end
	...
	if var_11_1 then
		...
		arg_11_0:HandleDirectDamage(var_11_1, arg_11_0._calculateDamageKamikazeAir(arg_11_1, var_11_1), arg_11_1)
	end

	return
end

function ys.Battle.BattleDataProxy.HandleShipMissDamage(arg_12_0, arg_12_1, arg_12_2)
	...
	if var_12_0 then
		var_12_0:CloakExpose(arg_12_0._shipExposeEX)
	end
	...
	if var_12_1 then
		if table.contains(ShipType.SubShipType, arg_12_1:GetTemplate().type) then
			...
			arg_12_0:HandleDirectDamage(var_12_1, var_0_2.CalculateDamageFromSubmarinToMainShip(arg_12_1, var_12_1), arg_12_1)
			...
			local var_12_2 = arg_12_0._calculateDamageKamikazeShip(arg_12_1, var_12_1)

			var_12_1:TriggerBuff(var_0_3.BuffEffectType.ON_BE_HIT, {})
			arg_12_0:HandleDirectDamage(var_12_1, var_12_2, arg_12_1)
		end
	end
...
function ys.Battle.BattleDataProxy.HandleCrashDamage(arg_13_0, arg_13_1, arg_13_2)
...
function ys.Battle.BattleDataProxy.HandleBuffPlacer(arg_14_0, arg_14_1, arg_14_2)
	...
	if var_14_0[1].type == "BattleBuffDOT" then
		...
		local var_14_3 = arg_14_0.rant or 10000
	...
	if var_14_1 then
		local var_14_4 = arg_14_0.buff_level or arg_14_0.level
		local var_14_5 = ys.Battle.BattleBuffUnit.New(arg_14_0.buff_id, var_14_4, arg_14_1)

		var_14_5:SetGroupLevel(arg_14_0.group_level)
		var_14_5:SetOrb(arg_14_1, arg_14_0.level)
		arg_14_2:AddBuff(var_14_5)
	end

	return
end

function ys.Battle.BattleDataProxy.HandleDOTPlace(arg_15_0, arg_15_1, arg_15_2)
	local var_15_0 = arg_15_1:GetAttrByName(var_0_4.DOT_CONFIG[arg_15_0.arg_list.dotType].hit)

	if var_0_2.IsHappen(arg_15_0.arg_list.ACC + arg_15_1:GetAttrByName(var_0_4.DOT_CONFIG[arg_15_0.arg_list.dotType].hit) - arg_15_2:GetAttrByName(var_0_4.DOT_CONFIG[arg_15_0.arg_list.dotType].resist)) then
		return true
	end
...
function ys.Battle.BattleDataProxy.HandleShipCrashDamageList(arg_16_0, arg_16_1, arg_16_2)
	...
	for iter_16_2, iter_16_3 in ipairs(arg_16_2) do
		if var_16_0[iter_16_3] == nil then
			local var_16_2 = pg.TimeMgr.GetInstance()

			arg_16_1:AppendHostileCld(iter_16_3, (var_16_2:AddBattleTimer("shipCld", nil, var_0_4.SHIP_CLD_INTERVAL, function()
...
function ys.Battle.BattleDataProxy.HandleWallDamage(arg_21_0, arg_21_1, arg_21_2)
	...
	arg_21_0:DamageStatistics(var_21_0, arg_21_2:GetAttrByName("id"), -arg_21_2:UpdateHP(var_21_1 * -1, {
		isHeal = false,
