...
function var_0_4.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	for iter_1_0, iter_1_1 in var_1_0(arg_1_0._tempData.effect_list) do
		...
		for iter_1_2, iter_1_3 in var_11(var_1_2) do
			local var_1_3
...
function var_0_4.Trigger(arg_19_0, arg_19_1, arg_19_2)
	...
	if not arg_19_0.GetBuffList(var_19_0) then
		var_19_1 = {}
	end
	...
	for iter_19_0, iter_19_1 in var_19_0(var_19_1) do
		if iter_19_1._triggerSearchTable[arg_19_1] ~= nil and #var_10 > 0 then
			var_19_2[#var_19_2 + 1] = iter_19_1
		end
	end

	var_0_4.sortTriggerBuff(var_19_2, arg_19_1)

	ipairs = var_5

	for iter_19_2, iter_19_3 in var_5(var_19_2) do
...
function var_0_4.DisptachSkillFloat(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	if arg_22_3.trigger ~= nil then
		...
		if var_4.contains(arg_22_3.trigger, arg_22_2) then
			...
			arg_22_1.DispatchSkillFloat(var_22_3, var_22_2, nil, var_22_0)

			local var_22_4

			if arg_22_3.castCV ~= false then
				var_22_4 = arg_22_3.castCV or "skill"
			end

			type = var_7

			if var_7(var_22_4) == "string" then
				arg_22_1:DispatchVoice(var_22_4)
			elseif var_7 == "table" then
				ShipWordHelper = var_22_3

				local var_22_5, var_22_6, var_22_7 = var_22_3.GetWordAndCV(var_22_4.skinID, var_22_4.key)

				pg = var_11

				local var_22_8 = var_11.CriMgr.GetInstance()

				var_11.PlaySoundEffect_V3(var_22_8, var_22_6)
			end

			local var_22_9

			if not arg_22_3.aniEffect then
				var_22_9 = var_0_4.DEFAULT_ANI_FX_CONFIG
			end

			local var_22_10 = {
				effect = var_22_9.effect,
				offset = var_22_9.offset
			}

			arg_22_1:DispatchEvent(var_0.Event.New(var_0.Battle.BattleUnitEvent.ADD_EFFECT, var_22_10))
		end
...
function var_0_4.onTrigger(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	for iter_24_0, iter_24_1 in var_1_10005(var_4) do
		assert = var_1_10010
		type = var_1_10012
		var_1_10012 = var_1_10012(iter_24_1[arg_24_1]) == "function"

		var_1_10010(var_1_10012, "buff效果的触发名字和触发函数不相符,buff id:>>" .. arg_24_0._id .. "<<, trigger:>>" .. arg_24_1 .. "<<")

		var_1_10012 = iter_24_1

		if iter_24_1.HaveQuota(var_1_10012) then
			var_1_10012 = iter_24_1

			if iter_24_1.IsActive(var_1_10012) then
				var_1_10012 = iter_24_1

				iter_24_1.NotActive(var_1_10012)

				var_1_10012 = iter_24_1

				iter_24_1.Trigger(var_1_10012, arg_24_1, arg_24_2, arg_24_0, arg_24_3)

				var_1_10012 = iter_24_1

				if iter_24_1.GetPopConfig(var_1_10012) then
