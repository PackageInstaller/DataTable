...
function var_0_3.doBehaviour(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10001(arg_3_0._cldUnitList) do
		...
		local var_3_2, var_3_3 = iter_3_1.GetHP(var_3_1)

		math = var_3_1

		local var_3_4 = var_3_1.max
		local var_3_5 = 0

		math = var_1_10012
		var_1_10012 = var_1_10012.floor(var_3_3 * arg_3_0._rate) + arg_3_0._damage
		math = var_13

		local var_3_6 = var_3_4(var_3_5, var_1_10012 + var_13.random(-arg_3_0._offset, arg_3_0._offset))

		var_1_10012 = iter_3_1

		iter_3_1.UpdateHP(var_1_10012, -var_3_6, var_3_0)

		var_1_10012 = iter_3_1

		if not iter_3_1.IsAlive(var_1_10012) then
