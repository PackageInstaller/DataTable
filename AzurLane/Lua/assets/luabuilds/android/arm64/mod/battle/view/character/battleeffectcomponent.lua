...
function var_0_6.addInitFX(arg_18_0, arg_18_1)
	if var_0.Battle.BattleDataFunction.GetBuffTemplate(arg_18_1).init_effect and var_2.init_effect ~= "" then
		...
		if var_2.skin_adapt then
			...
			local var_18_4 = var_7.GetUnitData(var_18_3)

			var_18_0 = var_18_1(var_18_2, var_7.GetSkinID(var_18_4))
		end
...
function var_0_6.switchLastFX(arg_20_0, arg_20_1, arg_20_2)
	...
	if var_20_1 then
		...
		local var_20_3 = arg_20_0.generateLastFX(var_20_2, var_20_0, var_20_1)
		local var_20_4
		...
		var_20_2.insert(var_20_4, var_20_3)

		arg_20_0._buffLastEffects[arg_20_1] = var_20_4
	end
...
function var_0_6.checkLastFXID(arg_21_0, arg_21_1, arg_21_2)
	...
	for iter_21_0, iter_21_1 in var_5(var_21_0.last_effect_stack_list) do
...
function var_0_6.addLastFX(arg_22_0, arg_22_1)
	if var_0.Battle.BattleDataFunction.GetBuffTemplate(arg_22_1).last_effect ~= nil and var_2.last_effect ~= "" then
		...
		local var_22_1 = arg_22_0.generateLastFX(var_22_0, var_2, var_2.last_effect)
		local var_22_2
		...
		var_22_0.insert(var_22_2, var_22_1)
...
function var_0_6.updateLastFXStackText(arg_23_0, arg_23_1)
	...
	if var_1_10005(var_23_1) ~= "string" or var_23_1 == "" then
		return
	end
...
function var_0_6.generateLastFX(arg_24_0, arg_24_1, arg_24_2)
	...
	if arg_24_1.last_effect_cld_scale or arg_24_1.last_effect_cld_angle then
		...
		for iter_24_0, iter_24_1 in var_6(var_24_3) do
		...
		if var_24_2 then
			...
			if arg_24_1.last_effect_cld_angle then
				...
				typeof = var_10
				Renderer = var_1_10012

				local var_24_10 = var_24_9(var_24_8, var_10(var_1_10012)).material
