...
function var_0_8.FilterTarget(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_14_3(var_14_1) do
...
function var_0_8.Fire(arg_18_0)
	...
	local function var_18_0(arg_19_0)
		...
		for iter_19_0, iter_19_1 in var_2_10003(arg_19_0) do
			if iter_19_1.Active and var_19_2[iter_19_1.UID] and var_8:IsVisitable() then
		...
		for iter_19_2, iter_19_3 in var_5(var_19_0) do
			...
			math = var_2_10013
			var_2_10010 = var_2_10010(var_19_5, var_2_10013.floor(var_19_3 * var_19_4[iter_19_2]))

			local var_19_6 = var_0_2.WeightListRandom(arg_18_0._weightList, arg_18_0._totalWeight)
			local var_19_7 = arg_18_0._dataProxy

			var_12.HandleDirectDamage(var_19_7, iter_19_3, var_2_10010, var_19_6)
		end
	...
	local var_18_5 = var_6.GetIFF(var_18_4)
	local var_18_6 = arg_18_0._host

	var_18_2(var_18_1, var_18_3, var_18_5, var_7.GetPosition(var_18_6), arg_18_0._range * 2, -1, var_18_0)
	...
	for iter_18_0, iter_18_1 in var_2(arg_18_0._crewUnitList) do
		...
		var_18_8(var_18_7, var_18_15.GetTemplateData(var_18_9).fire_fx, true)
	end
	...
	for iter_18_2, iter_18_3 in var_2(arg_18_0._hitFXResIDList) do
		...
		local var_18_13 = var_18_12 + var_18_15(var_18_8, 10, var_18_10)
		local var_18_14 = var_0.Battle.BattleFXPool.GetInstance()
		local var_18_15 = var_18_15.GetFX(var_18_14, iter_18_3)

		pg = var_18_11

		local var_18_16 = var_18_11.EffectMgr.GetInstance()
