...
function var_0_4.DoPrologue(arg_3_0)
	...
	local function var_3_1()
		...
		SYSTEM_SUBMARINE_RUN = var_2_10004
	...
	for iter_3_0, iter_3_1 in var_3_0(var_3_4) do
...
function var_0_4.initWaveModule(arg_7_0)
	...
	local function var_7_1()
		if arg_7_0._vertifyFail then
			...
			var_9_1(var_9_0, var_2_10003.CHEATER_MARK, {
...
function var_0_4.onWillDie(arg_15_0, arg_15_1)
	...
	local var_15_2 = var_2

	if var_2.GetIFF(var_15_2) == var_0.Battle.BattleConfig.FRIENDLY_CODE then
		local var_15_3 = arg_15_0._dataProxy

		var_5.DelScoreWhenPlayerDead(var_15_3, var_2)
	end
	...
	local var_15_4 = var_2:GetTemplate().type

	ShipType = var_15_2

	if var_15_4 == var_15_2.JinBi and var_15_1 == var_0.Battle.BattleConst.UnitDeathReason.KILLED then
