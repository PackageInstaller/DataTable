...
local var_0_2 = var_0_10002("BattleCardPuzzleSkillSetFleetAttr", var_0.Battle.BattleCardPuzzleSkillEffect)

var_0.Battle.BattleCardPuzzleSkillSetFleetAttr = var_0_2
...
function var_0_2.SkillEffectHandler(arg_2_0, arg_2_1)
	...
	var_3.UpdateAttrBySet(var_2_4, arg_2_0._attr, var_2_0)
	arg_2_0:Finale()
