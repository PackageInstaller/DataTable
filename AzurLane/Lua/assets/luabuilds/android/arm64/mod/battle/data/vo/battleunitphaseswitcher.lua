...
function ys.Battle.BattleUnitPhaseSwitcher.Ctor(arg_1_0, arg_1_1)
...
function ys.Battle.BattleUnitPhaseSwitcher.Update(arg_2_0)
	local var_2_0 = true
	local var_2_1
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_0._currentPhaseSwitchParam) do
		if iter_2_1.type == var_0_1.DURATION then
			...
			if iter_2_1.param < var_2_3:GetCombatTime() - arg_2_0._phaseStartTime then
				var_2_1 = iter_2_1.to
				iter_2_1.andFlag = false
			end
		elseif iter_2_1.type == var_0_1.POSITION_X_GREATER then
			if iter_2_1.param < arg_2_0._client:GetPosition().x then
				var_2_1 = iter_2_1.to
				iter_2_1.andFlag = false
			end
		...
		elseif iter_2_1.type == var_0_1.OXYGEN and iter_2_1.param >= arg_2_0._client:GetCuurentOxygen() then
			var_2_1 = iter_2_1.to
			iter_2_1.andFlag = false
		end
...
function ys.Battle.BattleUnitPhaseSwitcher.UpdateHP(arg_3_0, arg_3_1)
	local var_3_0 = true
	local var_3_1
...
function ys.Battle.BattleUnitPhaseSwitcher.SetTemplateData(arg_4_0, arg_4_1)
	arg_4_0._phaseList = {}
...
function ys.Battle.BattleUnitPhaseSwitcher.ForceSwitch(arg_5_0, arg_5_1)
	arg_5_0:switch(arg_5_1)

	return
end

function ys.Battle.BattleUnitPhaseSwitcher.switch(arg_6_0, arg_6_1)
	...
	if arg_6_0._phaseList[arg_6_1].removeWeapon then
	...
	if var_6_0.addBuff then
		for iter_6_6, iter_6_7 in ipairs(var_6_0.addBuff) do
			arg_6_0._client:AddBuff((var_0_0.Battle.BattleBuffUnit.New(iter_6_7, 1, arg_6_0._client)))
		end
	end
...
function ys.Battle.BattleUnitPhaseSwitcher.packagePhaseSwitchParam(arg_7_0, arg_7_1)
	...
	if var_7_0 == "table" then
		...
		while var_7_5 <= #arg_7_1.switchType do
			...
			table.insert(arg_7_0._currentPhaseSwitchParam, var_7_6)
