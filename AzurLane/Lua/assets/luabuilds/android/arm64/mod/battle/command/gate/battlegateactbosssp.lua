...
ys = var_0_10001
var_0_10001.Battle.BattleGateActBossSP = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	local var_1_3 = var_1_10004(var_6)
	...
	local var_1_6 = var_1_3(var_1_10009)
	...
	local var_1_10 = var_1_7.expedition_data_template[var_1_9].dungeon_id

	ys = var_11

	local var_1_11 = var_11.Battle.BattleDataFunction.GetDungeonTmpDataByID(var_1_10).fleet_prefab
	local var_1_12 = arg_1_0.mainFleetId
	local var_1_13 = var_1_6:getActivityFleets()[var_1_0][var_1_12]
	local var_1_14 = {}
	local var_1_15 = var_1_5:getSortShipsByFleet(var_1_13)

	ipairs = var_1_10016

	for iter_1_0, iter_1_1 in var_1_10016(var_1_15) do
		var_1_14[#var_1_14 + 1] = iter_1_1.id
	end

	pg = var_16

	local var_1_16 = var_16.battle_cost_template[var_0_0.BattleSystem].oil_cost > 0
	local var_1_17 = 0
	local var_1_18 = 0

	if var_1_16 then
		var_1_10022 = var_1_13
		var_1_17 = var_1_13.getStartCost(var_1_10022).oil
		var_1_10022 = var_1_13
		var_1_18 = var_1_13.GetCostSum(var_1_10022).oil
	end

	if var_1_4.oil < var_1_18 then
		pg = var_20
		var_1_10022 = var_20.TipsMgr.GetInstance()

		local var_1_19 = var_20.ShowTips

		i18n = var_1_10023

		var_1_19(var_1_10022, var_1_10023("stage_beginStage_error_noResource"))
	...
	local function var_1_20(arg_2_0)
		...
		var_2_10(var_2_9, iter_2_0.BEGIN_STAGE_DONE, var_2_8)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	local var_4_7 = var_4_4.activity_event_worldboss[var_4_6]
	...
	local function var_4_15(arg_6_0)
		...
		var_6_8(var_6_7, var_9.FINISH_STAGE_DONE, var_6_6)
...
function var_0_0.GetPreloadList(arg_7_0)
	...
	local var_7_2 = var_3.Battle.BattleResourceManager.GetInstance()
	...
	local var_7_5 = var_1_10005.map(var_7_4, function(arg_8_0)
	...
	for iter_7_0, iter_7_1 in var_7_3(var_7_6) do
		table = var_1_10011
