...
function var_0_12.EnergyUpdate(arg_8_0)
	...
	var_8_1(var_8_0, var_8_2, var_5.GetCurrentEnergy(var_8_3))
...
function var_0_12.InitCardPuzzleData(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in var_1_10003(var_10_2) do
		...
		var_1_10008 = iter_10_1:GetEffects()
		ipairs = var_1_10009

		for iter_10_2, iter_10_3 in var_1_10009(var_1_10008) do
			local var_10_3 = iter_10_3.type

			CardPuzzleGift = var_1_10015

			if var_10_3 == var_1_10015.EFFECT_TYPE.BATTLE_BUFF then
				ipairs = var_10_3

				for iter_10_4, iter_10_5 in var_10_3(iter_10_3.arg_list) do
					local var_10_4 = var_0.Battle.BattleFleetBuffUnit.New(iter_10_5)
					local var_10_5 = arg_10_0._fleetBuff

					var_20.AttachCardPuzzleBuff(var_10_5, var_10_4)
				end
			end
		end
	end
...
function var_0_12.PlayCard(arg_17_0, arg_17_1)
	if arg_17_0:CheckCardCastable(arg_17_1) then
		local function var_17_0()
			...
			local var_18_7 = var_4.GetCardType(var_18_6)
			local var_18_8 = arg_17_1

			var_18_5(var_18_4, var_18_7, var_5.GetCardCD(var_18_8))
...
function var_0_12.onUpdateHands(arg_59_0, arg_59_1)
	...
	for iter_59_0, iter_59_1 in var_59_0(var_59_1) do
		local var_59_3 = iter_59_1:GetLabels()

		ipairs = var_1_10010

		for iter_59_2, iter_59_3 in var_1_10010(var_59_3) do
			local var_59_4
			...
			var_59_2[iter_59_3] = var_59_4 + 1
		end
	end

	local var_59_5 = arg_59_0._fleetAttr

	var_4.SetAttr(var_59_5, "HandCount", #var_59_1)
	...
	for iter_59_4, iter_59_5 in var_4(var_59_2) do
		...
		var_9.SetAttr(var_59_6, iter_59_4 .. "LabelInHand", iter_59_5)
	end

	local var_59_7 = var_0.Event.New(var_0_3.UPDATE_FLEET_ATTR, {})

	arg_59_0:DispatchEvent(var_59_7)
