...
function var_0_2.calcSpeed(arg_2_0)
	...
	local var_2_1 = var_1_10002.max(0, arg_2_0._velocity + var_0.Battle.BattleAttr.GetCurrent(arg_2_0, "torpedoSpeedExtra")) * var_2_0
	...
	local var_2_4 = var_2_2 * var_1_10007.cos(var_2_3)
	local var_2_5 = 0

	math = var_9
	arg_2_0._speed = var_5(var_2_4, var_2_5, var_2_2 * var_9.sin(var_2_3))
