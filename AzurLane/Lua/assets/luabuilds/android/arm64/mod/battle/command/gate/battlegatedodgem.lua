...
ys = var_0_10001
var_0_10001.Battle.BattleGateDodgem = var_0_0
...
function var_0_0.Exit(arg_2_0, arg_2_1)
	...
	local var_2_3 = var_2_2(var_2_1, var_1_10006.ACTIVITY_TYPE_DODGEM)
	local var_2_4 = arg_2_1
	local var_2_5 = arg_2_1.sendNotification

	GAME = var_1_10007

	var_2_5(var_2_4, var_1_10007.ACTIVITY_OPERATION, {
		cmd = 1,
