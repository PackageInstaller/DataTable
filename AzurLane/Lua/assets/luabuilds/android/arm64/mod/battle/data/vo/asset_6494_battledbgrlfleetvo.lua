...
function var_0_9.UpdateMotion(arg_2_0)
	...
	if var_2_2(var_3.GetPos(var_2_3).x - arg_2_0._rightBound, 0) >= 0 and var_1 ~= arg_2_0._lastDist then
...
function var_0_9.NearestUnitByType(arg_12_0, arg_12_1, arg_12_2)
	...
	for iter_12_0, iter_12_1 in var_1_10005(arg_12_0._unitList) do
		...
		if var_1_10011.contains(arg_12_2, var_12_3) then
			var_1_10011 = iter_12_1:GetPosition()
			Vector3 = var_12_2

			if var_12_2.BattleDistance(var_1_10011, arg_12_1) < var_12_0 then
				var_12_0 = var_12
				var_12_1 = iter_12_1
			end
		end
...
function var_0_9.RemovePlayerUnit(arg_21_0, arg_21_1)
	...
	for iter_21_0, iter_21_1 in var_1_10003(arg_21_0._unitList) do
		if iter_21_1 ~= arg_21_1 then
			...
			var_1_10008 = iter_21_1:GetChargeList()
			ipairs = var_1_10009

			for iter_21_2, iter_21_3 in var_1_10009(var_1_10008) do
				if iter_21_3:IsAttacking() then
					local var_21_1 = arg_21_0._chargeWeaponVO

					var_14.CancelFocus(var_21_1)

					local var_21_2 = arg_21_0._chargeWeaponVO

					var_14.ResetFocus(var_21_2)
					arg_21_0:CancelChargeWeapon()
				end

				local var_21_3 = arg_21_0._chargeWeaponVO

				var_14.RemoveWeapon(var_21_3, iter_21_3)
				iter_21_3:Clear()
			end

			local var_21_4 = arg_21_0._fleetAntiAir

			var_1_10009.RemoveCrewUnit(var_21_4, arg_21_1)

			local var_21_5 = arg_21_0._fleetRangeAntiAir

			var_1_10009.RemoveCrewUnit(var_21_5, arg_21_1)

			local var_21_6 = arg_21_0._fleetStaticSonar

			var_1_10009.RemoveCrewUnit(var_21_6, arg_21_1)

			var_1_10009 = iter_21_1:GetTorpedoList()
			ipairs = var_10

			for iter_21_4, iter_21_5 in var_10(var_1_10009) do
				arg_21_0:RemoveManunalTorpedo(iter_21_5)
			end

			if iter_21_1:GetAirAssistList() then
				ipairs = var_11

				for iter_21_6, iter_21_7 in var_11(var_10) do
					local var_21_7 = arg_21_0._airAssistVO

					var_16.RemoveWeapon(var_21_7, iter_21_7)
				end
			end
		end
	end
	...
	local var_21_8 = arg_21_0._subList

	i = iter_21_12

	for iter_21_14, iter_21_15 in var_3(var_21_8, iter_21_12) do
...
function var_0_9.refreshFleetFormation(arg_57_0, arg_57_1)
	...
	if not arg_57_0._mainUnitFree then
		...
		for iter_57_0, iter_57_1 in var_4(arg_57_0._unitList) do
			...
			if not var_1_10009.contains(arg_57_0._subList, iter_57_1) then
				...
				var_57_3(var_57_2, var_1_10013(var_1_10009.x, var_1_10009.y, var_1_10009.z) + var_57_1 * (iter_57_0 - 1))
			end
		end
	end
	...
	if #arg_57_0._scoutList > 0 then
		...
		if var_4.GetCurrentState(var_57_8) ~= arg_57_0._fleetAntiAir.STATE_DISABLE then
			...
			for iter_57_4, iter_57_5 in var_5(var_57_10) do
...
function var_0_9.appendScoutUnit(arg_59_0, arg_59_1)
	...
	for iter_59_0, iter_59_1 in var_3(var_59_0) do
		local var_59_1 = arg_59_0._torpedoWeaponVO

		var_8.AppendWeapon(var_59_1, iter_59_1)
	end

	local var_59_2 = #arg_59_1:GetHiveList()
	...
	while var_59_7 < var_59_8 do
		...
		var_7.insert(var_59_9, var_59_7)
	...
	var_7.insert(var_59_9, #arg_59_0._scoutList, var_59_7)
...
function var_0_9.appendMainUnit(arg_60_0, arg_60_1)
	...
	for iter_60_0, iter_60_1 in var_3(var_60_0) do
		local var_60_1 = arg_60_0._chargeWeaponVO

		var_8.AppendWeapon(var_60_1, iter_60_1)
	end

	local var_60_2 = arg_60_1:GetTorpedoList()

	ipairs = var_4

	for iter_60_2, iter_60_3 in var_4(var_60_2) do
		var_1_10011 = arg_60_0._torpedoWeaponVO

		var_9.AppendWeapon(var_1_10011, iter_60_3)
	end

	local var_60_3 = #arg_60_1:GetHiveList()

	if 0 < var_60_3 then
		local var_60_4 = var_0_7.CreateAllInStrike(arg_60_1)

		ipairs = var_6

		for iter_60_4, iter_60_5 in var_6(var_60_4) do
			local var_60_5 = arg_60_0._airAssistVO

			var_1_10011.AppendWeapon(var_60_5, iter_60_5)
		end

		arg_60_1:SetAirAssistList(var_60_4)
	end

	local var_60_6 = arg_60_0._fleetAntiAir

	var_5.AppendCrewUnit(var_60_6, arg_60_1)

	local var_60_7 = arg_60_0._fleetRangeAntiAir

	var_5.AppendCrewUnit(var_60_7, arg_60_1)

	local var_60_8 = arg_60_0._fleetStaticSonar
	...
	for iter_60_6, iter_60_7 in var_6(arg_60_0._unitList) do
		table = var_1_10011

		var_1_10011.insert(var_60_9, iter_60_6)
	end

	arg_60_0:refreshFleetFormation(var_60_9)
...
function var_0_9.UnleashChrageWeapon(arg_69_0)
	...
	if var_1.GetCurrentWeapon(var_69_0) ~= nil and var_1:GetCurrentState() == var_1.STATE_PRECAST then
		if var_1:IsStrikeMode() then
			...
			local var_69_8 = var_1_10008.New
			local var_69_9 = var_69_3
			local var_69_10 = 0
			local var_69_11 = arg_69_0._motionVO

			var_69_5(var_69_4, var_69_6, var_69_7, var_69_8(var_69_9, var_69_10, var_12.GetPos(var_69_11).z))
		else
			var_1:CancelCharge()
		end
...
function var_0_9.CoupleEncourage(arg_80_0)
	...
	for iter_80_2, iter_80_3 in iter_80_0(var_80_0) do
		...
		for iter_80_4, iter_80_5 in var_1_10011(iter_80_3) do
			...
			if not iter_80_5[4] then
				var_80_9 = var_80_4.GROUP_ID
			end

			local var_80_10 = var_0.Battle.BattleTargetChoise.TargetAllHelp(iter_80_2)

			type = var_1_10020

			if var_1_10020(var_80_9) == "table" then
				ipairs = var_1_10020

				for iter_80_6, iter_80_7 in var_1_10020(var_80_9) do
					local var_80_11 = var_80_6(iter_80_7, var_80_7[iter_80_6])

					var_80_10 = var_0.Battle.BattleTargetChoise[var_80_5[iter_80_7]](iter_80_2, var_80_11, var_80_10)
				end
			else
				type = var_1_10020

				if var_1_10020(var_80_9) == "number" then
					var_1_10020 = var_80_6(var_80_9, var_80_7)
					var_80_10 = var_0.Battle.BattleTargetChoise[var_80_5[var_80_9]](iter_80_2, var_1_10020, var_80_10)
				end
			end
			...
			if var_80_8 <= #var_80_10 then
				...
				var_80_1[#var_80_1 + 1] = var_1_10020
			end
		end
	end
	...
	if #var_80_1 > 0 then
		...
		local var_80_12 = var_80_1[var_6.random(#var_80_1)]
		local var_80_13 = "link" .. var_80_12.linkIndex
		local var_80_14 = var_80_12.cp

		var_9.DispatchVoice(var_80_14, var_80_13)

		local var_80_15 = var_80_12.cp

		var_9.DispatchChat(var_80_15, var_80_12.content, 3, var_80_13)
	end
...
function var_0_9.ShiftManualSub(arg_89_0)
	...
	if arg_89_0._manualSubUnit then
		...
		for iter_89_0, iter_89_1 in var_1_10003(var_89_2) do
	...
	for iter_89_8, iter_89_9 in var_4(var_89_14) do
	...
	for iter_89_10, iter_89_11 in var_5(var_89_19) do
...
function var_0_9.SubmarinBoost(arg_91_0)
	...
	var_91_1(var_91_0, var_1_10004.right, var_0_5.SR_CONFIG.BOOST_SPEED, var_0_5.SR_CONFIG.BOOST_DECAY, var_0_5.SR_CONFIG.BOOST_DURATION, var_0_5.SR_CONFIG.BOOST_DECAY_STAMP)
