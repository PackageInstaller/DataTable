...
function var_0_4.fleetAttrRepeatConsume(arg_28_0, arg_28_1)
	...
	local var_28_4 = var_28_1.modf(var_28_3 / arg_28_1.value)
...
function var_0_4.repeatCountParse(arg_29_0, arg_29_1)
	...
	elseif var_2 == "string" then
		...
		local var_29_0, var_29_1 = var_1_10003.find(arg_29_1, "%p+")
...
function var_0_4.deathCauseRequire(arg_59_0, arg_59_1)
	...
	return var_1_10003.contains(arg_59_0._deathCauseRequire, var_59_0)
end
...
function var_0_4.killerWeaponRequire(arg_62_0, arg_62_1, arg_62_2, arg_62_3)
	...
	if var_1_10005.contains(arg_62_1, var_62_1) then
		return true
	end
...
function var_0_4.dhpRequire(arg_101_0, arg_101_1, arg_101_2)
	if arg_101_0._dHPGreater then
		local var_101_0 = arg_101_2 * arg_101_0._dHPGreater

		if 0 < var_101_0 then
			math = var_101_0

			local var_101_1 = var_101_0.abs(arg_101_2)

			math = var_4

			local var_101_2

			if not (var_101_1 > var_4.abs(arg_101_0._dHPGreater)) then
				var_101_2 = false
			else
				var_101_2 = true
			end

			do return var_101_2 end

			goto label_101_0

			if arg_101_0._dHPGreaterMaxHP then
				local var_101_3 = arg_101_2 * (arg_101_0._dHPGreaterMaxHP * arg_101_1)

				if 0 < var_101_3 then
					math = var_101_3

					local var_101_4 = var_101_3.abs(arg_101_2)

					math = var_5

					local var_101_5

					if not (var_101_4 > var_5.abs(var_3)) then
						var_101_5 = false
					else
						var_101_5 = true
					end
					...
					if arg_101_0._dhpSmaller then
						local var_101_6 = arg_101_2 * arg_101_0._dhpSmaller

						if 0 < var_101_6 then
							math = var_101_6

							local var_101_7 = var_101_6.abs(arg_101_2)

							math = var_4

							local var_101_8

							if not (var_101_7 < var_4.abs(arg_101_0._dhpSmaller)) then
								var_101_8 = false
							else
								var_101_8 = true
							end

							do return var_101_8 end

							goto label_101_0

							if arg_101_0._dhpSmallerMaxhp then
								local var_101_9 = arg_101_2 * (arg_101_0._dhpSmallerMaxhp * arg_101_1)

								if 0 < var_101_9 then
									math = var_101_9

									do
										local var_101_10 = var_101_9.abs(arg_101_2)

										math = var_5

										local var_101_11

										if not (var_101_10 < var_5.abs(var_3)) then
											var_101_11 = false
										else
											var_101_11 = true
										end

										do return var_101_11 end
...
function var_0_4.onAntiSubHateChain(arg_122_0, arg_122_1, arg_122_2, arg_122_3)
	...
	var_122_1(var_122_0, var_122_2, var_122_3, var_1_10009)
...
function var_0_4.getTargetList(arg_129_0, arg_129_1, arg_129_2, arg_129_3, arg_129_4)
	...
	if var_1_10006.contains(arg_129_2, "TargetDamageSource") then
		Clone = var_6
...
function var_0_4.commanderRequire(arg_130_0, arg_130_1)
	if arg_130_0._tempData.arg_list.CMDBuff_id then
		...
		local var_130_3
		local var_130_4 = arg_130_1:GetTemplate().type

		table = var_1_10006

		local var_130_5 = var_1_10006.contains

		ShipType = var_1_10008

		if var_130_5(var_1_10008.SubShipType, var_130_4) then
			var_130_3 = var_130_2
		else
			var_130_3 = var_130_1
		end
		...
		local var_130_6 = {}
		local var_130_7 = arg_130_0._tempData.arg_list.CMDBuff_id

		ipairs = var_8

		for iter_130_0, iter_130_1 in var_8(var_130_3) do
			if iter_130_1.id == var_130_7 then
				table = var_13

				var_13.insert(var_130_6, iter_130_1)
			end
		end
