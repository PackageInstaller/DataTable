...
function var_0_6.onBulletHitFunc(arg_4_0, arg_4_1, arg_4_2)
	...
	if not arg_4_1 and var_4_5 then
		var_4_0:RemoveBulletUnit(var_4:GetUniqueID())
	...
	elseif var_4_2 == var_4.STATE_FINAL_SPLIT then
		...
		local var_4_6 = var_4:GetPierceCount()
	...
	if arg_4_1 ~= nil and arg_4_2 ~= nil then
		...
		if var_4_10.GetIFF(var_4_12) == var_4_0:GetFoeCode() then
			local var_4_13 = var_4_11.transform.localRotation

			Vector3 = var_4_12
			var_13.localRotation = var_4_12(var_4_13.x, 180, var_4_13.z)
		end
	end
...
function var_0_6.bulletSplit(arg_6_0, arg_6_1)
	...
	if var_4.extra_param.FXID ~= nil then
		...
		local var_6_8 = var_6_5.EffectMgr.GetInstance()
	...
	for iter_6_0, iter_6_1 in var_9(var_6_2) do
		if arg_6_1 ~= iter_6_1.initialSplit then
			...
			local function var_6_18(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
				...
				local var_7_5 = var_7_1(var_7_0, var_7_2, var_7_3, var_7_4, var_2_10010.zero)
				...
				if var_6_17 then
					...
					local var_7_7 = var_7_0.atan2(arg_7_1, arg_7_0)

					math = var_7

					local var_7_8 = var_7.rad
					local var_7_9 = var_6_0
					local var_7_10 = var_7_7 + var_7_8(var_9.GetYAngle(var_7_9))

					math = var_9

					local var_7_11 = var_9.abs

					math = var_7_9

					local var_7_12 = var_7_11(var_7_9.cos(var_7))

					math = var_10
					arg_7_0 = var_7_6 * var_10.cos(var_7_10) * (0.5 + 0.5 * var_7_12)
					math = var_10
					arg_7_1 = var_7_6 * var_10.sin(var_7_10) * (2 - var_7_12)
				end
				...
				elseif var_6_14 == var_0_6.INHERIT_SPEED_NORMALIZE then
					var_7_14 = var_6_0
					var_7_13 = var_6.GetCurrentYAngle(var_7_14)
				end

				if var_6_16 then
					local var_7_15
					local var_7_16 = var_6_0
					local var_7_17 = var_7.GetWeapon(var_7_16)
					local var_7_18 = var_7.GetHost(var_7_17)

					type = var_7_14

					if var_7_14(var_6_16) == "table" and var_7_18 then
						local var_7_19 = iter_6_1.reaimParam
						local var_7_20

						ipairs = var_10

						for iter_7_0, iter_7_1 in var_10(var_6_16) do
							var_7_20 = var_0.Battle.BattleTargetChoise[iter_7_1](var_7_18, var_7_19, var_7_20)
						end

						var_7_15 = var_7_20[1]
					else
						var_7_15 = var_0.Battle.BattleTargetChoise.TargetHarmNearest(var_6_0)[1]
					end

					if var_7_15 == nil then
						var_4:SetRotateInfo(nil, var_7_13, arg_7_2)
					else
						var_4:SetRotateInfo(var_7_15:GetBeenAimedPosition(), var_7_13, arg_7_2)
					end
				else
					var_4:SetRotateInfo(nil, var_7_13, arg_7_2)
				end
				...
				if var_6_15 == var_0_6.INHERIT_VELOCITY_TEMPLATE then
					local var_7_21 = var_4
					local var_7_22 = var_4.ResetVelocity
					local var_7_23 = var_6_0

					var_7_22(var_7_21, var_9.GetVelocity(var_7_23))
				elseif var_6_15 == var_0_6.INHERIT_VELOCITY_CURRENT then
					local var_7_24 = var_4
					local var_7_25 = var_4.InheritSpeed
					local var_7_26 = var_6_0

					var_7_25(var_7_24, var_9.GetSpeed(var_7_26))
				end

				local var_7_27 = var_0_6.GetFactoryList()[var_4:GetTemplate().type]
				local var_7_28 = var_6.CreateBullet
				local var_7_29 = arg_6_0
				local var_7_30 = var_10.GetTf(var_7_29)
				local var_7_31 = var_4
				local var_7_32 = arg_6_0

				var_7_28(var_7_27, var_7_30, var_7_31, var_12.GetPosition(var_7_32))
			...
			local function var_6_20()
				...
				if var_0.IsAllSplitFinish(var_8_2) then
					...
					var_8_4(var_8_3, var_3.GetUniqueID(var_8_5))
				end
...
function var_0_6.MakeModel(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4)
	...
	if not var_6.InstBullet(var_10_1, arg_10_1:GetModleID(), function(arg_11_0)
		...
		var_10_3(var_10_2, var_10.GetObject(var_10_4))
	end
