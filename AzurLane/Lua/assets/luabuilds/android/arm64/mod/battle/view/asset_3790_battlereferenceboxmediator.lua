...
function var_0_4.ActiveUnitDetail(arg_5_0, arg_5_1)
	...
	if arg_5_1 and not arg_5_0._detailViewActive then
		...
		for iter_5_0, iter_5_1 in var_2(var_4.GetFleetList(var_5_0)) do
			var_1_10007 = iter_5_1:GetUnitList()
			ipairs = var_1_10008

			for iter_5_2, iter_5_3 in var_1_10008(var_1_10007) do
		...
		local var_5_1 = arg_5_0._dataProxy

		for iter_5_4, iter_5_5 in var_2(var_4.GetUnitList(var_5_1)) do
			table = var_1_10007
...
function var_0_4.Update(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10001(var_3.GetUnitList(var_6_0)) do
	...
	if arg_6_0._bulletBoxActive then
		...
		for iter_6_2, iter_6_3 in var_1(var_3.GetBulletList(var_6_1)) do
			local var_6_2
			...
			local var_6_5 = iter_6_3.GetBoxSize(var_6_4) * 2
			local var_6_6 = var_6_2.transform

			Vector3 = var_6_4
			var_6_6.localScale = var_6_4(var_6_5.x, var_6_5.y, var_6_5.z)
		end

		pairs = var_1

		local var_6_7 = arg_6_0._dataProxy

		for iter_6_4, iter_6_5 in var_1(var_3.GetWallList(var_6_7)) do
			local var_6_8

			if not arg_6_0._wallBoxList[iter_6_4] then
				var_6_8 = arg_6_0:createWallBox(iter_6_5)
			end

			var_6_8.transform.localPosition = iter_6_5:GetPosition()
		end
	end
...
function var_0_4.createBox(arg_10_0, arg_10_1)
	...
	if arg_10_1.GetBoxSize(var_10_4).range then
		local var_10_5 = arg_10_0._sceneMediator

		var_10_0 = var_6.InstantiateCharacterComponent(var_10_5, "Cylinder" .. var_10_3)
	else
		local var_10_6 = arg_10_0._sceneMediator

		var_10_0 = var_6.InstantiateCharacterComponent(var_10_6, "Cube" .. var_10_3)
		var_10_7 = var_10_7 * 2
	end

	local var_10_8 = var_10_0.transform

	var_6.SetParent(var_10_8, arg_10_0._boxContainer.transform)
	...
	if var_10_7.range then
		var_10_9 = var_10_0.transform
		Vector3 = var_10_4
		var_10_9.localScale = var_10_4(var_10_7.range * 2, var_10_7.tickness * 2, var_10_7.range * 2)
	else
		var_10_9 = var_10_0.transform
		Vector3 = var_10_4
		var_10_9.localScale = var_10_4(var_10_7.x, var_10_7.y, var_10_7.z)
	end
...
function var_0_4.createExistBoxes(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1_10001(var_3.GetUnitList(var_11_0)) do
...
function var_0_4.removeAllBoxes(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_1_10001(var_3.GetUnitList(var_16_0)) do
...
function var_0_4.createBulletBox(arg_23_0, arg_23_1)
	...
	local var_23_5 = arg_23_1.GetBoxSize(var_23_4) * 2
	local var_23_6 = var_23_0.transform

	Vector3 = var_23_4
	var_23_6.localScale = var_23_4(var_23_5.x, var_23_5.y, var_23_5.z)
	SetActive = var_23_6

	var_23_6(var_23_0, true)
