...
function ys.Battle.BattleAAMissileFactory.onBulletHitFunc(arg_2_0, arg_2_1, arg_2_2)
	...
	pg.EffectMgr.GetInstance():PlayBattleEffect(var_2_5, var_2_6:Add(arg_2_0:GetTf().localPosition), true)
...
function ys.Battle.BattleAAMissileFactory.MakeModel(arg_4_0, arg_4_1, arg_4_2)
	...
	if var_4_0:GetIFF() ~= arg_4_0:GetDataProxy():GetFriendlyCode() and var_4_1.alert_fx ~= "" then
