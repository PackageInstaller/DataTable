...
function var_0_2.SkillEffectHandler(arg_3_0)
	...
	local var_3_3 = var_1
	local var_3_4 = var_1.GetCardPileByIndex(var_3_3, arg_3_0._moveFrom)
	...
	elseif arg_3_0._moveLabel then
		...
		var_3_3 = var_3_4:Search(var_3_6)
		ipairs = var_6

		for iter_3_2, iter_3_3 in var_6(var_3_3) do
			var_3_2[arg_3_0._moveOP](var_3_2, iter_3_3)
			var_3_4:Remove(iter_3_3, arg_3_0._moveTo)
		end
	elseif arg_3_0._moveOther then
		local var_3_7 = var_3_4:GetCardList()

		ipairs = var_3_3

		for iter_3_4, iter_3_5 in var_3_3(var_3_7) do
			if iter_3_5 ~= arg_3_0._card then
				var_3_2[arg_3_0._moveOP](var_3_2, iter_3_5)
				var_3_4:Remove(iter_3_5, arg_3_0._moveTo)
			end
		end
	else
