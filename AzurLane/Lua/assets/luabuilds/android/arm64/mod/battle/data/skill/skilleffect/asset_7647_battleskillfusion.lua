...
Vector3 = var_0_10005
var_0_5[1] = var_0_10005(-10000, 0, 58)
Vector3 = var_5
...
function var_0_4.doFusion(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in var_5(var_7.PROPERTIES) do
		var_4_2[iter_4_1] = 1
	end
	...
	arg_4_1:SetPosition(var_0_4.FREEZE_POS[arg_4_1:GetIFF()])
	...
	local function var_4_8()
		...
		if var_6.IsMainFleetUnit(var_5_9) then
			...
			var_5_12(var_5_11, var_2_10009(var_5_6))
		end
		...
		local var_5_15 = var_5_13(var_5_3 * var_5_8[var_8.GetAttrByName(var_5_14, "id")])
		...
		for iter_5_0, iter_5_1 in var_6(var_4_1) do
			...
			if iter_5_1:IsMainFleetUnit() then
				...
				var_5_19(var_5_18, var_2_10014(var_5_6))
			end

			math = var_5_19

			local var_5_20 = var_5_19.floor(var_5_3 * var_5_8[iter_5_1:GetAttrByName("id")])
			local var_5_21 = var_4_3

			var_11.HandleDirectDamage(var_5_21, iter_5_1, var_5_20)

			local var_5_22 = var_4_3

			var_11.ActiveFreezeUnit(var_5_22, iter_5_1)
		end

		local var_5_23 = var_4_3

		var_6.DefusionUnit(var_5_23, var_0)

		pg = var_6

		local var_5_24 = var_6.TimeMgr.GetInstance()

		var_6.RemoveBattleTimer(var_5_24, arg_4_0._fusionTimer)
	...
	local var_4_9 = var_11.TimeMgr.GetInstance()

	arg_4_0._fusionTimer = var_11.AddBattleTimer(var_4_9, "fusionSkillTimer", 0, arg_4_0._duration, var_4_8, true)
