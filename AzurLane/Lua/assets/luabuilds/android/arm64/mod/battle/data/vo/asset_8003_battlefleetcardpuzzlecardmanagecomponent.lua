...
function var_0_10._add_(arg_8_0, arg_8_1)
	...
	var_1_10003.insert(var_8_0, arg_8_1)
...
function var_0_10._bottom_(arg_9_0, arg_9_1)
	...
	var_1_10003.insert(var_9_0, 1, arg_9_1)
...
function var_0_10._remove_(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in var_1_10003(var_10_0) do
		if arg_10_1 == iter_10_1 then
			...
			var_8.remove(var_10_0, iter_10_0)
...
function var_0_10._pop_(arg_12_0)
	...
	local var_12_1 = var_1_10002.remove(var_12_0, #var_12_0)

	var_2.SetFromPile(var_12_1, arg_12_0:GetIndexID())

	local var_12_2 = var_2
	local var_12_3 = arg_12_0:DispatchEvent(var_0.Event.New(var_0_3.UPDATE_CARDS, {
