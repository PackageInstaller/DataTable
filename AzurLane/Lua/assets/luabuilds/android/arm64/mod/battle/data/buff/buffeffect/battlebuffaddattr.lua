...
function var_0_1.UpdateAttrMul(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in var_1_10007(var_10_4) do
		ipairs = var_1_10012
		...
		for iter_10_2, iter_10_3 in var_1_10012(iter_10_1._effectList) do
			if iter_10_3:GetEffectType() == var_0_1.FX_TYPE and iter_10_3:IsSameAttr(arg_10_0._attr) then
				...
				if var_10_6 < var_10_5 and var_10_5 > 0 then
					var_10_0 = var_10_0 * (1 + var_10_5) / (1 + var_10_6)
					var_10_6 = var_10_5
				end

				if var_10_5 < var_10_7 and var_10_5 < 0 then
					var_10_1 = var_10_1 * (1 + var_10_5) / (1 + var_10_7)
					var_10_7 = var_10_5
				end

				var_10_2[var_18] = var_10_6
				var_10_3[var_18] = var_10_7
			end
		end
	end
...
function var_0_1.UpdateAttrAdd(arg_11_0, arg_11_1)
	...
	local var_11_10 = arg_11_1:GetMaxHP()

	math = var_10

	local var_11_11 = var_10.min
	local var_11_12 = var_11_10

	math = var_13

	local var_11_13 = var_11_11(var_11_12, var_11_0 + var_13.max(0, var_11_10 - var_11_1))

	arg_11_1:SetCurrentHP(var_11_13)

	if arg_11_0:CheckWeapon() then
		arg_11_1:FlushReloadingWeapon()
	end

	local var_11_14 = arg_11_1._move

	var_11.ImmuneAreaLimit(var_11_14, var_0.Battle.BattleAttr.IsImmuneAreaLimit(arg_11_1))

	local var_11_15 = arg_11_1._move

	var_11.ImmuneMaxAreaLimit(var_11_15, var_0.Battle.BattleAttr.IsImmuneMaxAreaLimit(arg_11_1))
