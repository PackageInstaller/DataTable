...
ys = var_0_10001
var_0_10001.Battle.BattleGateDebug = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	if var_2.getFleetById(var_1_0, 1) == nil or var_3:isEmpty() then
		...
		var_1_10004(var_1_1, var_1_10007("stage_beginStage_error_fleetEmpty"))

		return
	end

	PROLOGUE_DUNGEON = var_1_10004
	...
	var_1_4(var_1_3, var_1_10009.BEGIN_STAGE_DONE, var_1_2)
...
function var_0_0.GetPreloadList(arg_3_0)
	...
	local var_3_5 = var_3_1.getFleetById(var_3_4, arg_3_0.mainFleetId)
	local var_3_6 = var_3_2:getShipsByFleet(var_3_5)

	ipairs = var_3_4

	for iter_3_0, iter_3_1 in var_3_4(var_3_6) do
		table = var_1_10012
	...
	local var_3_8 = var_3_1.getFleetById(var_3_7, 11)
	local var_3_9 = var_7.getTeamByName

	TeamType = iter_3_1

	local var_3_10 = var_3_9(var_3_8, iter_3_1.Submarine)

	ipairs = var_3_7

	for iter_3_2, iter_3_3 in var_3_7(var_3_10) do
		local var_3_11 = var_3_2:getShipById(iter_3_3)

		table = var_1_10015

		var_1_10015.insert(var_3_3, var_3_11)
	end
	...
	for iter_3_6, iter_3_7 in var_13(var_3_15) do
		...
		for iter_3_8, iter_3_9 in var_1_10019(var_3_16) do
			table = var_1_10024
