...
function var_0_2.GetDivingFilterColor(arg_7_0)
	...
	return (var_1_10003.New(var_7_1.r, var_7_1.g, var_7_1.b, var_7_1.a))
end
...
function var_0_2.MakeFXContainer(arg_15_0, arg_15_1)
	...
	Vector3 = var_1_10006
	var_15_2.localEulerAngles = var_1_10006(var_15_3.x * -1, var_15_3.y, var_15_3.z)

	local var_15_4 = arg_15_1:GetUnitData()
	local var_15_5 = var_6.GetTemplate(var_15_4).fx_container
	local var_15_6 = {}

	ipairs = var_15_4

	for iter_15_0, iter_15_1 in var_15_4(var_0.Battle.BattleConst.FXContainerIndex) do
		local var_15_7 = var_15_5[iter_15_0]

		Vector3 = var_1_10014
		var_15_6[iter_15_0] = var_1_10014(var_15_7[1], var_15_7[2], var_15_7[3])
	end

	arg_15_1:AddFXOffsets(var_3, var_15_6)
...
function var_0_2.MakePopNumPool(arg_19_0, arg_19_1)
	...
	var_19_1(var_19_0, var_5.GetPopNumPool(var_19_2))
...
function var_0_2.MakeTag(arg_20_0, arg_20_1)
	...
	return (var_20_0(var_4.InstantiateCharacterComponent(var_20_1, arg_20_0.TAG_NAME), arg_20_1))
end
...
function var_0_2.MakeSkinOrbit(arg_28_0, arg_28_1)
	...
	local var_28_1 = arg_28_1.GetUnitData(var_28_0)

	if var_2.GetSkinAttachmentInfo(var_28_1) then
		ipairs = var_28_0

		for iter_28_0, iter_28_1 in var_28_0(var_3) do
			local var_28_2 = var_0.Battle.BattleDataFunction.GetEquipSkinDataFromID(iter_28_1)

			if arg_28_1:IsDoubleChar() then
				local var_28_3 = var_0.Battle.BattleResourceManager.GetInstance()
				local var_28_4 = var_10.InstOrbit(var_28_3, var_28_2.orbit_combat)
				local var_28_5 = var_0.Battle.BattleResourceManager.GetInstance()
				local var_28_6 = var_11.InstOrbit(var_28_5, var_28_2.orbit_combat)

				if var_28_2.double_char_bone and #var_12 > 0 and var_12[1] == 1 then
					arg_28_1:AddOrbit(var_28_6, var_28_2, "char2")
				end

				if var_12 and #var_12 > 0 and var_12[2] == 1 then
					arg_28_1:AddOrbit(var_28_4, var_28_2)
				end

				if var_12 and #var_12 > 0 and var_12[3] == 1 then
					arg_28_1:AddOrbit(var_28_4, var_28_2, "char1")
				end
			else
				local var_28_7 = var_0.Battle.BattleResourceManager.GetInstance()
				local var_28_8 = var_10.InstOrbit(var_28_7, var_28_2.orbit_combat)

				arg_28_1:AddOrbit(var_28_8, var_28_2)
			end
		end
	end
...
function var_0_2.RemoveCharacter(arg_29_0, arg_29_1, arg_29_2)
	...
	if var_3.GetTemplate(var_29_0).nationality then
		...
		if var_1_10004.contains(var_0_1.SWEET_DEATH_NATIONALITY, var_3) then
			goto label_29_0
		end
	end
	...
	if arg_29_2 and arg_29_2 ~= var_0.Battle.BattleConst.UnitDeathReason.KILLED then
		...
		local var_29_6 = var_29_3.EffectMgr.GetInstance()
...
function var_0_2.SwitchCharacterSpine(arg_30_0, arg_30_1, arg_30_2)
	...
	local function var_30_1(arg_31_0)
		...
		var_31_2(var_31_1, var_4.GetCamera(var_31_3))
