...
function var_0_3.SetSpawn(arg_2_0, arg_2_1)
	...
	arg_2_0._targetPos = var_2(var_4.GetExplodePostion(var_2_0))
...
function var_0_3._doStray(arg_3_0)
	...
	if arg_3_0._step > 0 and var_3_0 and not var_3_0:EqualZero() then
		...
		Vector3 = var_3_1
		arg_3_0._speed = var_3_1(var_3_0.x - var_3_2.x, 0, var_3_0.z - var_3_2.z).normalized

		local var_3_4 = arg_3_0._speed

		Vector3 = var_1_10005
		arg_3_0._speed = var_3_4 + var_1_10005(arg_3_0._speed.z * arg_3_0._count / 100, 0, -arg_3_0._speed.x * arg_3_0._count / 100)
