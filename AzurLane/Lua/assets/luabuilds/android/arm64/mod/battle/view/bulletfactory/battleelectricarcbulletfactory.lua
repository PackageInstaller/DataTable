...
function ys.Battle.BattleElectricArcBulletFactory.CreateBullet(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
	local var_2_9000
	...
	if var_2_3 then
		...
		if var_2_4 then
			local var_2_5 = arg_2_2:GetWeapon()

			arg_2_0:GetSceneMediator().AddArcEffect(var_2_5, arg_2_2:GetTemplate().modle_ID, arg_2_0:GetSceneMediator():GetCharacter(var_2_4:GetUniqueID()), var_2_0, var_2_5.GetTemplateData(var_2_9000).spawn_bound)
		end
	end
