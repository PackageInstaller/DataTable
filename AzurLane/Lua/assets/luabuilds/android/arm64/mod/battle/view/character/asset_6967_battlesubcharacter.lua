...
function var_0_4.AddArrowBar(arg_2_0, arg_2_1)
	...
	typeof = var_5
	Slider = var_1_10007
	arg_2_0._vectorOxygenSlider = var_2_2(var_2_1, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_2_0._vectorAmmoCount = var_2_5(var_2_4, var_5(var_1_10007))
...
function var_0_4.onTorpedoWeaponFire(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_1_10003(var_5.GetTorpedoList(var_5_1)) do
