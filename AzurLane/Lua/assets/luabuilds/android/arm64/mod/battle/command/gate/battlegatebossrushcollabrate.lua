...
local var_0_0 = var_0_10000("BattleGateBossRushCollabrate")

ys = var_0_10001
var_0_10001.Battle.BattleGateBossRushCollabrate = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	SYSTEM_BOSS_RUSH_COLLABRATE = var_1_10007
	...
	local function var_1_24(arg_2_0)
		...
		SYSTEM_BOSS_RUSH_COLLABRATE = var_2
	...
	SYSTEM_BOSS_RUSH_COLLABRATE = var_1_10027
...
function var_0_0.GetPreloadList(arg_8_0)
	...
	local var_8_0, var_8_1 = var_1_10001.Battle.BattleGateBossRush.GetPreloadList(arg_8_0)

	getProxy = var_3
	ActivityProxy = var_1_10005

	local var_8_2 = var_3(var_1_10005)
	local var_8_3 = var_3.getActivityById(var_8_2, arg_8_0.actId)
	local var_8_4 = var_3.GetSeriesData(var_8_3)
	local var_8_5 = var_4.getConfig(var_8_4, "aid_buff")

	if var_4:GetBossHpRate() <= var_8_5[1] then
		resMgr = var_6

		local var_8_6 = var_6.GetResFromBuffIDList({
			var_8_5[2]
		})
		...
		for iter_8_0, iter_8_1 in var_6(var_8) do
			table = var_1_10011

			var_1_10011.insert(var_8_0, iter_8_1)
		end
	end
