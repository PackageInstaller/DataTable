...
function var_0_3.doBehaviour(arg_3_0)
	...
	if not arg_3_0._moveEndTime then
		...
		if var_3_2 then
			Vector3 = var_3
			unpack = var_1_10005
			arg_3_0._destPosition = var_3(var_1_10005(var_3_2))
			arg_3_0._moveEndTime = var_3_1 + var_3_2[4]
			arg_3_0._targetIndex = arg_3_0._targetIndex + 1
		else
			local var_3_3 = arg_3_0:GenerateRandomPlayerAreaPoint()

			math = var_1_10004

			local var_3_4 = var_1_10004.random

			unpack = var_1_10006

			local var_3_5 = var_3_4(var_1_10006(arg_3_0._random_duration)) * arg_3_0._random_speed
			local var_3_6 = var_3_3 - arg_3_0._lastPosition
			local var_3_7

			if var_6.Magnitude(var_3_6) < var_3_5 then
				var_3_7 = var_6 / arg_3_0._random_speed
			else
				Vector3 = var_1_10007
				var_3_3 = var_1_10007.Lerp(arg_3_0._lastPosition, var_3_3, var_3_5 / var_6)
			end

			arg_3_0._moveEndTime = var_3_1 + var_3_7
			arg_3_0._destPosition = var_3_3
		end
	end
	...
	if var_3_1 < arg_3_0._moveEndTime then
		...
		local var_3_8 = var_2.Lerp(arg_3_0._lastPosition, arg_3_0._destPosition, (var_3_1 - arg_3_0._movebeginTime) / (arg_3_0._moveEndTime - arg_3_0._movebeginTime))
		local var_3_9 = arg_3_0._unit._aoeData

		var_3.SetPosition(var_3_9, var_3_8)
	else
		local var_3_10 = arg_3_0._unit._aoeData

		var_2.SetPosition(var_3_10, arg_3_0._destPosition)
...
function var_0_3.GenerateRandomPlayerAreaPoint(arg_4_0)
	...
	local var_4_2 = var_1_10003.random(var_4_0[2], var_4_0[1])
