...
function var_0_4.Clear(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_1(arg_2_0._beamList) do
		if iter_2_1:GetBeamState() == iter_2_1.BEAM_STATE_ATTACK then
			...
			var_2_2(var_2_1, var_9.GetUniqueID(var_2_3))
		end
...
function var_0_4.updateBeamList(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_7_0(arg_7_0._beamList) do
...
function var_0_4.createBeam(arg_8_0, arg_8_1)
	...
	local var_8_11 = var_1_10012(arg_8_0._hostPos.x + var_8_4, 0, arg_8_0._hostPos.z + var_8_5)
	...
	if arg_8_0._aimPos == nil then
		...
		arg_8_1.SetAimAngle(var_8_14, 0)
	elseif var_8_2.offset_prioritise then
		var_8_14 = arg_8_1

		arg_8_1.SetAimPosition(var_8_14, arg_8_0._aimPos, var_8_11, var_8_10)
	else
		local var_8_15
		...
		if var_8_10 == var_0_3.FRIENDLY_CODE then
			...
			math = var_8_14
			var_8_15 = var_8_16 * var_8_14.atan2(arg_8_0._aimPos.z - arg_8_0._hostPos.z, arg_8_0._aimPos.x - arg_8_0._hostPos.x)
		elseif var_8_10 == var_0_3.FOE_CODE then
			math = var_15

			local var_8_17 = var_15.rad2Deg

			math = var_8_14
			var_8_15 = var_8_17 * var_8_14.atan2(arg_8_0._hostPos.z - arg_8_0._aimPos.z, arg_8_0._hostPos.x - arg_8_0._aimPos.x)
		end

		arg_8_1:SetAimAngle(var_8_15)
	end
...
function var_0_4.doBeamDamage(arg_11_0, arg_11_1)
	...
	local var_11_1 = arg_11_0.Spawn(var_11_0, arg_11_1:GetBulletID())
	local var_11_2 = arg_11_1:GetCldUnitList()

	pairs = var_11_0

	for iter_11_0, iter_11_1 in var_11_0(var_11_2) do
		if not iter_11_1:IsAlive() or arg_11_1:GetBeamExtraParam().mainFilter == true and iter_11_1:IsMainFleetUnit() then
			...
			var_9.HandleDamage(var_11_3, var_11_1, iter_11_1)
			...
			local var_11_7 = var_11_4.EffectMgr.GetInstance()
	...
	var_4.RemoveBulletUnit(var_11_8, var_11_1:GetUniqueID())
