...
ys = var_0_10001
var_0_10001.Battle.BattleGateCooperate = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	local var_1_9 = 0
	local var_1_10 = 0
	local var_1_11 = var_1_3:getActivityFleets()[var_1_0]

	Fleet = var_1_10014

	local var_1_12 = var_1_11[var_1_10014.REGULAR_FLEET_ID]

	ipairs = var_14

	for iter_1_0, iter_1_1 in var_14(var_1_12.ships) do
		var_1_6[#var_1_6 + 1] = iter_1_1
	end

	local var_1_13 = var_1_12:getStartCost().oil
	local var_1_14 = var_1_12:GetCostSum().oil
	local var_1_15 = var_1_2:getSortShipsByFleet(var_1_12)
	local var_1_16 = var_1_1
	local var_1_17 = var_1_1.getData(var_1_16)

	if var_1_5 and var_1_17.oil < var_1_14 then
		pg = var_18
		...
		var_1_18(var_1_10020, var_1_10021("stage_beginStage_error_noResource"))
	...
	local var_1_20 = var_1_16.expedition_data_template[var_1_19].dungeon_id
	...
	local var_1_23 = var_22
	local var_1_24 = var_22.getPlayType(var_1_23)

	ChapterConst = var_1_10023

	if var_1_24 == var_1_10023.TypeExtra then
		var_1_22 = true
	end
	...
	local function var_1_25(arg_2_0)
		...
		if 0 < var_2_1 and not var_1_22 then
			...
			for iter_2_0, iter_2_1 in var_2(var_1_15) do
		...
		var_2_8(var_2_7, iter_2_1.BEGIN_STAGE_DONE, var_2_6)
	...
	BeginStageCommand = var_1_23

	local var_1_27 = var_1_23.SendRequest

	SYSTEM_HP_SHARE_ACT_BOSS = var_1_10026

	var_1_27(var_1_10026, var_1_6, {
		var_1_19
	}, var_1_25, var_1_26)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	if arg_4_0.statistics.submarineAid then
		local var_4_11 = var_4_2
		local var_4_12 = var_4_2.getActivityFleets(var_4_11)[arg_4_0.actId]

		Fleet = var_4_11

		if var_4_12[var_4_11.SUBMARINE_FLEET_ID] then
			bayProxy = var_1_10016
			var_1_10016 = var_1_10016:getSortShipsByFleet(var_15)
			ipairs = var_1_10017

			for iter_4_0, iter_4_1 in var_1_10017(var_1_10016) do
	...
	local function var_4_15(arg_5_0)
		...
		SYSTEM_HP_SHARE_ACT_BOSS = var_2_10006

		var_5_5(var_2_10006, var_5_4, var_4_10, arg_5_0.player_exp)
		...
		var_5_8(var_5_7, var_8.FINISH_STAGE_DONE, var_5_6)
