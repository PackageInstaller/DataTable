...
function var_0.Battle.BattleChargeArea.InitArea(arg_2_0)
	...
	local var_2_8 = var_1:Find("UpperEdge").transform

	Vector3 = var_6
	var_2_8.localScale = var_6(1, 1 / var_2_5.y, 1)

	local var_2_9 = var_1:Find("LowerEdge").transform

	Vector3 = var_6
	var_2_9.localScale = var_6(1, 1 / var_2_5.y, 1)
