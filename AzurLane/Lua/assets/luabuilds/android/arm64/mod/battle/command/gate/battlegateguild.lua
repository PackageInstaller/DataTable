...
ys = var_0_10001
var_0_10001.Battle.BattleGateGuild = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	if var_3.getRawData(var_1_1).oil < var_1_0 then
		...
		var_1_3(var_1_2, var_1_10007("stage_beginStage_error_noResource"))
	...
	local var_1_6 = var_4
	local var_1_7 = var_4.GetShipsSplitByUserID(var_1_6)
	local var_1_8 = {}
	...
	for iter_1_0, iter_1_1 in var_1_6(var_1_7) do
		...
		var_1_10013.insert(var_1_8, {
			ship_id = iter_1_1.shipID,
			user_id = iter_1_1.userID
		})
	end

	local var_1_9 = var_4:GetStageID()
	...
	local function var_1_10(arg_2_0)
		...
		local var_2_3 = var_2_10004.guildset.operation_boss_guild_active.key_value
		...
		var_2_6(var_2_5, var_9.BEGIN_STAGE_DONE, var_2_0)
	...
	local var_1_12 = iter_1_0.SendRequest

	SYSTEM_GUILD = var_1_10013

	var_1_12(var_1_10013, var_1_5, {
		var_1_9
	}, var_1_10, var_1_11, var_1_8)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in var_4_4(var_4_5:getCommanders()) do
		table = var_1_10014
	...
	if arg_4_0.statistics.submarineAid then
		...
		if var_6.GetSubFleet(var_4_8) then
			var_4_9 = var_10:GetShips()
			ipairs = var_4_8

			for iter_4_4, iter_4_5 in var_4_8(var_4_9) do
			...
			for iter_4_6, iter_4_7 in var_4_8(var_10:getCommanders()) do
				table = var_1_10017
	...
	for iter_4_8, iter_4_9 in var_4_8(var_4_3) do
		if var_4_10 < arg_4_0.statistics[iter_4_9.id].output then
			var_4_11 = iter_4_9.id
			var_4_10 = var_17.output
		end
	end

	local var_4_12 = var_0_0.GeneralPackage(arg_4_0, var_4_3)

	var_4_12.commander_id_list = var_4_6

	local function var_4_13(arg_5_0)
		arg_4_0.statistics.mvpShipID = var_4_11
		...
		local var_5_8 = var_0
		local var_5_9 = var_5_5(var_5_6, var_5_7, var_8.GetSubFleet(var_5_8))
		...
		var_5_10(var_5_7, var_5_11, var_5_12, var_5_13, var_2_10011)

		local var_5_14 = {}

		SYSTEM_GUILD = var_5_6
		var_5_14.system = var_5_6
	...
	var_0_0.SendRequest(arg_4_1, var_4_12, var_4_13)
...
function var_0_0.SendRequest(arg_6_0, arg_6_1, arg_6_2)
	...
	var_3.Send(var_6_0, 40003, arg_6_1, 40004, function(arg_7_0)
		...
		elseif arg_7_0.result == 20 then
			...
			i18n = var_2_10005
			var_2_10004.content = var_2_10005("guild_battle_result_boss_is_death")
			...
			function var_2_10004.onYes()
				...
				var_8_1(var_8_0, var_3_10003.QUIT_BATTLE)

				return
			end

			var_7_1(var_7_0, var_2_10004)
		elseif arg_7_0.result == 4 then
			...
			var_7_3(var_7_2, var_2_10004.QUIT_BATTLE)
		else
...
function var_0_0.GetGuildBossMission()
	...
	local var_9_3 = var_9_2:GetBossMission()
...
function var_0_0.GeneralPlayerCosume(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	local var_11_0 = var_1_10005(var_1_10007)
...
function var_0_0.GeneralPackage(arg_12_0, arg_12_1)
	...
	local var_12_7 = var_1_10009(var_1_10011)
	local var_12_8 = var_9.getRawData(var_12_7).id

	ipairs = var_1_10010

	for iter_12_0, iter_12_1 in var_1_10010(arg_12_1) do
		if arg_12_0.statistics[iter_12_1.id] then
			...
			var_1_10017 = var_1_10017.GetUserId(var_15.id)
			math = var_1_10018
			var_1_10018 = var_1_10018.floor(var_15.bp)
			math = var_19

			local var_12_10 = var_19.floor(var_15.output)

			math = var_20

			local var_12_11 = var_20.max
			local var_12_12 = 0

			math = var_1_10023

			local var_12_13 = var_12_11(var_12_12, var_1_10023.floor(var_15.damage))

			math = var_21

			local var_12_14 = var_21.floor(var_15.maxDamageOnce)

			math = var_12_12

			local var_12_15 = var_12_12.floor(var_15.gearScore)

			var_1_10023 = var_1_10017 ~= var_12_8 and var_12_2 or var_12_1
			table = var_24

			var_24.insert(var_1_10023, {
				ship_id = var_12_9,
				hp_rest = var_1_10018,
				damage_cause = var_12_10,
				damage_caused = var_12_13,
				max_damage_once = var_12_14,
				ship_gear_score = var_12_15
			})

			var_12_6 = var_12_6 + var_12_9 + var_1_10018 + var_12_10 + var_12_14
	...
	local var_12_16, var_12_17 = var_10(var_12_6, arg_12_0.token, arg_12_0.statistics._totalTime)
	local var_12_18 = {}
	...
	local var_12_19 = var_13.fmod(arg_12_0.statistics._autoCount, 2)

	math = var_14

	local var_12_20 = var_14.fmod(var_12_19 + arg_12_0.statistics._autoInit, 2)
...
function var_0_0.GetPreloadList(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_13_7(var_13_9) do
	...
	local var_13_11 = var_7
	local var_13_12 = var_7.GetSubFleet(var_13_11)
	local var_13_13 = var_10.GetShips(var_13_12)

	ipairs = var_13_11

	for iter_13_2, iter_13_3 in var_13_11(var_13_13) do
	...
	local var_13_14 = var_10:BuildBattleBuffList()

	ipairs = var_12

	for iter_13_4, iter_13_5 in var_12(var_13_14) do
		table = var_1_10017

		var_1_10017.insert(var_13_10, iter_13_5)
	end

	local var_13_15, var_13_16 = var_13_3.GetPlayerShipResource(var_13_0, arg_13_0.system)
	local var_13_17 = var_13_3.GetCommanderBuffRes(var_13_10)

	ipairs = var_14

	for iter_13_6, iter_13_7 in var_14(var_13_17) do
		table = var_1_10019

		var_1_10019.insert(var_13_15, iter_13_7)
	end

	return var_13_15, var_13_16
end
