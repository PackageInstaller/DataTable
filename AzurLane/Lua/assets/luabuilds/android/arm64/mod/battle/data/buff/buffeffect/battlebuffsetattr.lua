...
function ys.Battle.BattleBuffSetAttr.SetArgs(arg_2_0, arg_2_1, arg_2_2)
...
function ys.Battle.BattleBuffSetAttr.onAttach(arg_3_0, arg_3_1, arg_3_2)
	if arg_3_0._attr == "TargetChoise" then
		var_0_1.AddTargetSelect(arg_3_1, arg_3_0._value)
	else
		var_0_1.SetCurrent(arg_3_1, arg_3_0._attr, arg_3_0._value)
	end

	return
end

function ys.Battle.BattleBuffSetAttr.onRemove(arg_4_0, arg_4_1, arg_4_2)
	if arg_4_0._attr == "TargetChoise" then
		var_0_1.RemoveTargetSelect(arg_4_1, arg_4_0._value)
	else
		var_0_1.SetCurrent(arg_4_1, arg_4_0._attr, 0)
	end
