...
function var_0_1.MakeModel(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_6.InstFX(var_2_3, arg_2_1:GetModleID()) then
		...
		var_2_5(var_2_4, var_10.GetObject(var_2_6))
	end
	...
	local function var_2_7(arg_3_0, arg_3_1, arg_3_2)
		...
		local var_3_6 = var_2_10009.TimeMgr.GetInstance()

		if var_9.GetCombatTime(var_3_6) < var_3_5 + var_3:GetHitInterval() then
			return
		end

		local var_3_7 = var_0_1
		local var_3_8 = var_9.GetSceneMediator(var_3_7)
		local var_3_9 = var_9.GetCharacter(var_3_8, arg_3_1)
		local var_3_10 = var_9.GetUnitData(var_3_9)
		local var_3_11

		if var_9.GetCldData(var_3_10).Active then
			var_3_11 = false

			local var_3_12 = var_9:GetCurrentOxyState()

			ipairs = var_3_10

			for iter_3_0, iter_3_1 in var_3_10(var_3_2) do
			...
			if not var_3_11 then
				local var_3_13 = var_2_2

				var_12.HandleDamage(var_3_13, var_3, var_9)
			end
		end

		pg = var_3_11

		local var_3_14 = var_3_11.TimeMgr.GetInstance()

		var_3_4[arg_3_1] = var_10.GetCombatTime(var_3_14)
