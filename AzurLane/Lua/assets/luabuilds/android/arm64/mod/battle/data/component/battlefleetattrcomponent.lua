...
function ys.Battle.BattleFleetAttrComponent.Ctor(arg_1_0, arg_1_1)
...
function ys.Battle.BattleFleetAttrComponent.GetCurrent(arg_4_0, arg_4_1)
	return arg_4_0._fleetAttrList[arg_4_1] or 0
end

function ys.Battle.BattleFleetAttrComponent.SetCurrent(arg_5_0, arg_5_1, arg_5_2)
	...
	if var_5_0 ~= arg_5_2 then
		arg_5_0._client:FleetBuffTrigger(var_0_0.BuffEffectType.ON_FLEET_ATTR_UPDATE, {
			attr = arg_5_1,
			value = arg_5_2,
			delta = arg_5_2 - var_5_0
		})
		arg_5_0._client:DispatchEvent(ys.Event.New(var_0_2.UPDATE_FLEET_ATTR, {
			attr = arg_5_1,
			value = arg_5_2
		}))
	end
