...
ys = var_0_10001
var_0_10001.Battle.BattleGateSubmarine = var_0_0
...
function var_0_0.Exit(arg_2_0, arg_2_1)
	...
	local var_2_2 = var_2_1(var_2_0, var_1_10005.ACTIVITY_TYPE_SUBMARINE_RUN)
	local var_2_3 = arg_2_1
	local var_2_4 = arg_2_1.sendNotification

	GAME = var_1_10006

	var_2_4(var_2_3, var_1_10006.ACTIVITY_OPERATION, {
		cmd = 1,
