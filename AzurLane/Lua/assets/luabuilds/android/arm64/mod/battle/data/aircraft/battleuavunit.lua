...
function var_0_5.SetTemplate(arg_3_0, arg_3_1)
	...
	local var_3_0 = arg_3_1.funnel_behavior.offsetX
	local var_3_1 = arg_3_0
	local var_3_2 = var_3_0 * arg_3_0.GetIFF(var_3_1)
	local var_3_3 = arg_3_1.funnel_behavior.offsetZ
	local var_3_4 = var_0.Battle.BattleDataProxy.GetInstance()
	local var_3_5 = var_4.GetVanguardBornCoordinate(var_3_4, arg_3_0:GetIFF())

	BuildVector3 = var_3_1

	local var_3_6 = var_3_1(var_3_5)

	Vector3 = var_3_4
	arg_3_0._centerPos = var_3_6 + var_3_4(var_3_2, 0, var_3_3)
...
function var_0_5._updateHover(arg_11_0, arg_11_1)
	...
	local var_11_1 = var_1_10005.sin(var_11_0) * arg_11_0._range
	local var_11_2 = 15

	math = var_7

	local var_11_3 = var_1_10003(var_11_1, var_11_2, var_7.cos(var_11_0) * arg_11_0._range)
