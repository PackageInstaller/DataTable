...
function var_0_8.FilterTarget(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_2_3(var_2_1) do
...
function var_0_8.Fire(arg_3_0)
	local function var_3_0(arg_4_0)
		...
		for iter_4_0, iter_4_1 in var_2_10003(arg_4_0) do
		...
		while var_4_3 > 0 and #var_4_0 > 0 do
			...
			if var_4_3 - (var_4_5 + iter_4_1.random(var_0_4.AnitAirRepeaterConfig.lower_range, var_0_4.AnitAirRepeaterConfig.upper_range)) < 0 then
			...
			if not var_0_2.RollRepeaterHitDice(arg_3_0, var_5) then
				...
				var_4_7(var_4_6, var_4_8, var_4_9, var_15.GetHost(var_4_10))
			end
		end
	...
	local var_3_5 = var_6.GetIFF(var_3_4)
	local var_3_6 = arg_3_0._host

	var_3_2(var_3_1, var_3_3, var_3_5, var_7.GetPosition(var_3_6), arg_3_0._tmpData.range * 2, -1, var_3_0)
