...
function ys.Battle.BattleBuffManualTorpedoCoolDown.SetArgs(arg_2_0, arg_2_1, arg_2_2)
	arg_2_0._rant = arg_2_0._tempData.arg_list.rant or 10000

	return
end

function ys.Battle.BattleBuffManualTorpedoCoolDown.onTrigger(arg_3_0, arg_3_1)
