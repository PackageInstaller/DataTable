...
function ys.Battle.BattleBuffShiftBarrage.SetArgs(arg_2_0, arg_2_1, arg_2_2)
	arg_2_0._barrageID = arg_2_0._tempData.arg_list.barrage_id

	return
end

function ys.Battle.BattleBuffShiftBarrage.onAttach(arg_3_0, arg_3_1, arg_3_2)
	arg_3_0:shiftBarrage(arg_3_1, arg_3_0._barrageID)

	return
end

function ys.Battle.BattleBuffShiftBarrage.onRemove(arg_4_0, arg_4_1, arg_4_2)
	arg_4_0:shiftBarrage(arg_4_1)

	return
end

function ys.Battle.BattleBuffShiftBarrage.shiftBarrage(arg_5_0, arg_5_1, arg_5_2)
