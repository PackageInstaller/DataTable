...
local var_0_5 = var_6.width * -0.5

Screen = var_7
var_0_4.AIRFIGHTER_ENTER_POINT = var_4(var_0_5, var_7.height * 0.5, 15)
Vector3 = var_4
...
function var_0_4.UpdateWeapon(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10001(arg_3_0:GetWeapon()) do
		...
		table = var_1_10007
		var_1_10007 = var_1_10007.contains(arg_3_0._backwardWeaponID, var_3_0)
		...
		if var_1_10007 and var_3_1 == iter_3_1.STATE_READY and (var_3_2 == iter_3_1.STATE_ATTACK or var_3_2 == iter_3_1.STATE_OVER_HEAT) then
...
function var_0_4.changeToBackState(arg_30_0)
	...
	Vector3 = var_1_10003
	arg_30_0._pos = var_1_10003(arg_30_0._pos.x, 15, var_30_0)
...
function var_0_4._updatePosDown(arg_33_0)
	...
	math = var_1_10002
	var_33_1.y = var_1_10002.max(var_0_4.HEIGHT, arg_33_0._pos.y - arg_33_0._ySpeed)
...
function var_0_4._updatePosAttack(arg_35_0)
	...
	math = var_1_10002
	var_35_1.y = var_1_10002.max(var_0_4.HEIGHT, arg_35_0._pos.y - 0.04)
...
function var_0_4._updateBackward(arg_40_0)
	...
	math = var_1_10002
	var_40_1.y = var_1_10002.max(var_0_4.HEIGHT, arg_40_0._pos.y - 0.04)
