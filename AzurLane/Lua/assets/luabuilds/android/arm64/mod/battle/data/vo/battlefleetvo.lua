...
function var_0_8.UpdateMotion(arg_2_0)
	...
	if arg_2_0._motionReferenceUnit then
		...
		var_2_0 = var_2_3(var_4.GetPos(var_2_4).x - arg_2_0._rightBound, 0)
	end
...
function var_0_8.NearestUnitByType(arg_13_0, arg_13_1, arg_13_2)
	...
	for iter_13_0, iter_13_1 in var_1_10005(arg_13_0._unitList) do
		...
		if var_1_10011.contains(arg_13_2, var_13_3) then
			var_1_10011 = iter_13_1:GetPosition()
			Vector3 = var_13_2

			if var_13_2.BattleDistance(var_1_10011, arg_13_1) < var_13_0 then
				var_13_0 = var_12
				var_13_1 = iter_13_1
			end
		end
...
function var_0_8.GetLeftBoundDistance(arg_21_0)
	if arg_21_0._chapterType and arg_21_0._chapterType == 5 then
		...
		return var_21_0(var_3.GetPos(var_21_1).x - arg_21_0._leftBound)
	end
...
function var_0_8.RemovePlayerUnit(arg_26_0, arg_26_1, arg_26_2)
	...
	for iter_26_0, iter_26_1 in var_4(arg_26_0._unitList) do
		if iter_26_1 ~= arg_26_1 then
			...
			for iter_26_2, iter_26_3 in var_1_10010(var_26_1) do
				if iter_26_3:IsAttacking() then
					local var_26_2 = arg_26_0._chargeWeaponVO

					var_15.CancelFocus(var_26_2)

					local var_26_3 = arg_26_0._chargeWeaponVO

					var_15.ResetFocus(var_26_3)
					arg_26_0:CancelChargeWeapon()
				end

				local var_26_4 = arg_26_0._chargeWeaponVO

				var_15.RemoveWeapon(var_26_4, iter_26_3)
			...
			local var_26_5 = arg_26_0._fleetAntiAir

			var_1_10010.RemoveCrewUnit(var_26_5, arg_26_1)

			local var_26_6 = arg_26_0._fleetRangeAntiAir

			var_1_10010.RemoveCrewUnit(var_26_6, arg_26_1)

			local var_26_7 = arg_26_0._fleetStaticSonar

			var_1_10010.RemoveCrewUnit(var_26_7, arg_26_1)

			var_1_10010 = iter_26_1:GetTorpedoList()
			ipairs = var_11

			for iter_26_4, iter_26_5 in var_11(var_1_10010) do
				arg_26_0:RemoveManunalTorpedo(iter_26_5, arg_26_2)
			end

			if iter_26_1:GetAirAssistList() then
				ipairs = var_12

				for iter_26_6, iter_26_7 in var_12(var_11) do
					local var_26_8 = arg_26_0._airAssistVO

					var_17.RemoveWeapon(var_26_8, iter_26_7)
				end
			end
		end
	end
...
function var_0_8.refreshFleetFormation(arg_68_0, arg_68_1)
	...
	if not arg_68_0._mainUnitFree then
		...
		for iter_68_0, iter_68_1 in var_4(arg_68_0._unitList) do
			...
			if not var_1_10009.contains(arg_68_0._subList, iter_68_1) then
				...
				var_68_3(var_68_2, var_1_10013(var_1_10009.x, var_1_10009.y, var_1_10009.z) + var_68_1 * (iter_68_0 - 1))
			end
		end
	end
	...
	if #arg_68_0._scoutList > 0 then
		...
		if var_4.GetCurrentState(var_68_8) ~= arg_68_0._fleetAntiAir.STATE_DISABLE then
			...
			for iter_68_4, iter_68_5 in var_5(var_68_10) do
...
function var_0_8.appendScoutUnit(arg_70_0, arg_70_1)
	...
	for iter_70_0, iter_70_1 in var_3(var_70_0) do
		local var_70_1 = arg_70_0._torpedoWeaponVO

		var_8.AppendWeapon(var_70_1, iter_70_1)
	end

	local var_70_2 = #arg_70_1:GetHiveList()
	...
	while var_70_7 < var_70_8 do
		...
		var_7.insert(var_70_9, var_70_7)
	...
	var_7.insert(var_70_9, #arg_70_0._scoutList, var_70_7)
...
function var_0_8.appendMainUnit(arg_71_0, arg_71_1)
	...
	for iter_71_0, iter_71_1 in var_3(var_71_0) do
		local var_71_1 = arg_71_0._chargeWeaponVO

		var_8.AppendWeapon(var_71_1, iter_71_1)
	end

	local var_71_2 = arg_71_1:GetTorpedoList()

	ipairs = var_4

	for iter_71_2, iter_71_3 in var_4(var_71_2) do
		var_1_10011 = arg_71_0._torpedoWeaponVO

		var_9.AppendWeapon(var_1_10011, iter_71_3)
	end

	local var_71_3 = #arg_71_1:GetHiveList()

	if 0 < var_71_3 then
		local var_71_4 = var_0_7.CreateAllInStrike(arg_71_1)

		ipairs = var_6

		for iter_71_4, iter_71_5 in var_6(var_71_4) do
			local var_71_5 = arg_71_0._airAssistVO

			var_1_10011.AppendWeapon(var_71_5, iter_71_5)
		end

		arg_71_1:SetAirAssistList(var_71_4)
	end

	local var_71_6 = arg_71_0._fleetAntiAir

	var_5.AppendCrewUnit(var_71_6, arg_71_1)

	local var_71_7 = arg_71_0._fleetRangeAntiAir

	var_5.AppendCrewUnit(var_71_7, arg_71_1)

	local var_71_8 = arg_71_0._fleetStaticSonar
	...
	for iter_71_6, iter_71_7 in var_6(arg_71_0._unitList) do
		table = var_1_10011

		var_1_10011.insert(var_71_9, iter_71_6)
	end

	arg_71_0:refreshFleetFormation(var_71_9)
...
function var_0_8.UnleashChrageWeapon(arg_80_0)
	...
	if var_1.GetCurrentWeapon(var_80_0) ~= nil and var_1:GetCurrentState() == var_1.STATE_PRECAST then
		if var_1:IsStrikeMode() then
			...
			local var_80_8 = var_1_10008.New
			local var_80_9 = var_80_3
			local var_80_10 = 0
			local var_80_11 = arg_80_0._motionVO

			var_80_5(var_80_4, var_80_6, var_80_7, var_80_8(var_80_9, var_80_10, var_12.GetPos(var_80_11).z))
		else
			var_1:CancelCharge()
		end
...
function var_0_8.CoupleEncourage(arg_91_0)
	...
	for iter_91_2, iter_91_3 in iter_91_0(var_91_0) do
		...
		for iter_91_4, iter_91_5 in var_1_10011(iter_91_3) do
			...
			if not iter_91_5[4] then
				var_91_9 = var_91_4.GROUP_ID
			end

			local var_91_10 = var_0.Battle.BattleTargetChoise.TargetAllHelp(iter_91_2)

			type = var_1_10020

			if var_1_10020(var_91_9) == "table" then
				ipairs = var_1_10020

				for iter_91_6, iter_91_7 in var_1_10020(var_91_9) do
					local var_91_11 = var_91_6(iter_91_7, var_91_7[iter_91_6])

					var_91_10 = var_0.Battle.BattleTargetChoise[var_91_5[iter_91_7]](iter_91_2, var_91_11, var_91_10)
				end
			else
				type = var_1_10020

				if var_1_10020(var_91_9) == "number" then
					var_1_10020 = var_91_6(var_91_9, var_91_7)
					var_91_10 = var_0.Battle.BattleTargetChoise[var_91_5[var_91_9]](iter_91_2, var_1_10020, var_91_10)
				end
			end
			...
			if var_91_8 <= #var_91_10 then
				...
				var_91_1[#var_91_1 + 1] = var_1_10020
			end
		end
	end
	...
	if #var_91_1 > 0 then
		...
		local var_91_12 = var_91_1[var_6.random(#var_91_1)]
		local var_91_13 = "link" .. var_91_12.linkIndex
		local var_91_14 = var_91_12.cp

		var_9.DispatchVoice(var_91_14, var_91_13)

		local var_91_15 = var_91_12.cp

		var_9.DispatchChat(var_91_15, var_91_12.content, 3, var_91_13)
	end
...
function var_0_8.onUnitCloakUpdate(arg_94_0, arg_94_1)
	...
	for iter_94_0, iter_94_1 in var_1_10004(arg_94_0._unitList) do
...
function var_0_8.ShiftManualSub(arg_101_0)
	...
	if arg_101_0._manualSubUnit then
		...
		for iter_101_0, iter_101_1 in var_1_10003(var_101_2) do
	...
	for iter_101_8, iter_101_9 in var_4(var_101_14) do
	...
	for iter_101_10, iter_101_11 in var_5(var_101_19) do
...
function var_0_8.SubmarinBoost(arg_103_0)
	...
	var_103_1(var_103_0, var_1_10004.right, var_0_5.SR_CONFIG.BOOST_SPEED, var_0_5.SR_CONFIG.BOOST_DECAY, var_0_5.SR_CONFIG.BOOST_DURATION, var_0_5.SR_CONFIG.BOOST_DECAY_STAMP)
...
function var_0_8.UndoFusion(arg_126_0)
	...
	for iter_126_0, iter_126_1 in var_1_10001(arg_126_0._freezeList) do
		...
		var_1_10008 = iter_126_0

		if iter_126_0.IsMainFleetUnit(var_1_10008) then
			var_1_10008 = arg_126_0

			arg_126_0.appendFreezeMainUnit(var_1_10008, iter_126_0)
		else
			var_1_10008 = arg_126_0

			arg_126_0.activeFreezeScoutUnit(var_1_10008, iter_126_0)
		end
	end
	...
	for iter_126_2, iter_126_3 in var_2(arg_126_0._unitList) do
		if iter_126_3:GetAttrByName("hpProvideRate") ~= 0 then
			table = var_1_10008

			var_1_10008.insert(var_126_0, iter_126_3)

			local var_126_1

			var_1_10008, var_126_1 = iter_126_3:GetHP()

			local var_126_2 = var_126_1 - var_1_10008
			local var_126_3 = 0

			pairs = var_1_10012

			for iter_126_4, iter_126_5 in var_1_10012(var_7) do
				if not arg_126_0:GetFreezeShipByID(iter_126_4) then
					arg_126_0:GetShipByID(iter_126_4)
				end

				math = var_1_10018

				local var_126_4 = var_1_10018.floor(iter_126_5 * var_126_2)

				var_17:UpdateHP(var_126_4 * -1, {})
			end
		end
	end
...
function var_0_8.appendFreezeMainUnit(arg_127_0, arg_127_1)
	...
	for iter_127_0, iter_127_1 in var_3(var_127_0) do
		var_1_10010 = arg_127_0._chargeWeaponVO

		var_8.AppendFreezeWeapon(var_1_10010, iter_127_1)
	end
	...
	for iter_127_2, iter_127_3 in var_4(var_127_1) do
		local var_127_2 = arg_127_0._torpedoWeaponVO

		var_9.AppendFreezeWeapon(var_127_2, iter_127_3)
	end

	if arg_127_1:GetAirAssistList() then
		local var_127_3 = arg_127_1:GetAirAssistList()

		ipairs = var_5

		for iter_127_4, iter_127_5 in var_5(var_127_3) do
			local var_127_4 = arg_127_0._airAssistVO

			var_1_10010.AppendFreezeWeapon(var_127_4, iter_127_5)
		end
	end

	local var_127_5 = arg_127_0._fleetAntiAir

	var_4.AppendCrewUnit(var_127_5, arg_127_1)

	local var_127_6 = arg_127_0._fleetRangeAntiAir

	var_4.AppendCrewUnit(var_127_6, arg_127_1)

	local var_127_7 = arg_127_0._fleetStaticSonar

	var_4.AppendCrewUnit(var_127_7, arg_127_1)

	local var_127_8 = {}

	ipairs = var_5

	for iter_127_6, iter_127_7 in var_5(arg_127_0._unitList) do
		table = var_1_10010

		var_1_10010.insert(var_127_8, iter_127_6)
	end

	arg_127_0:refreshFleetFormation(var_127_8)
...
function var_0_8.activeFreezeScoutUnit(arg_128_0, arg_128_1)
	...
	for iter_128_0, iter_128_1 in var_3(var_128_0) do
		local var_128_1 = arg_128_0._torpedoWeaponVO

		var_8.AppendFreezeWeapon(var_128_1, iter_128_1)
	end

	if arg_128_1:GetAirAssistList() then
		local var_128_2 = arg_128_1:GetAirAssistList()

		ipairs = var_4

		for iter_128_2, iter_128_3 in var_4(var_128_2) do
			local var_128_3 = arg_128_0._airAssistVO

			var_9.AppendFreezeWeapon(var_128_3, iter_128_3)
		end
	end

	local var_128_4 = arg_128_0._fleetAntiAir

	var_3.AppendCrewUnit(var_128_4, arg_128_1)

	local var_128_5 = arg_128_0._fleetStaticSonar

	var_3.AppendCrewUnit(var_128_5, arg_128_1)

	local var_128_6 = 1
	local var_128_7 = #arg_128_0._unitList
	local var_128_8 = {}

	while var_128_6 < var_128_7 do
		table = var_6

		var_6.insert(var_128_8, var_128_6)

		var_128_6 = var_128_6 + 1
	end

	table = var_6

	var_6.insert(var_128_8, #arg_128_0._scoutList, var_128_6)
	arg_128_0:refreshFleetFormation(var_128_8)
