...
function var_0_3.DoPrologue(arg_2_0)
	...
	local function var_2_2()
		...
		if var_5_2 then
			...
			for iter_5_2, iter_5_3 in var_3(var_5_4) do
				local var_5_5 = iter_5_3:GetUnitList()
				local var_5_6 = iter_5_3
				local var_5_7 = iter_5_3.GetMainList(var_5_6)[1]

				ipairs = var_5_6

				for iter_5_4, iter_5_5 in var_5_6(var_5_5) do
					if iter_5_5 == var_5_7 then
			...
			local var_5_9 = var_4.TimeMgr.GetInstance()

			var_5_8._shiftTimer = var_4.AddBattleTimer(var_5_9, "", -1, 2, var_2_1, true)
		else
			var_2_1()
		end
