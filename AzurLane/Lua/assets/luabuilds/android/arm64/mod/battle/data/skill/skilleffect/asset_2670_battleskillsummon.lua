...
class = var_0_10004
var_0_3.BattleSkillSummon = var_0_10004("BattleSkillSummon", var_0.Battle.BattleSkillEffect)
var_0.Battle.BattleSkillSummon.__name = "BattleSkillSummon"

local var_0_4 = var_0.Battle.BattleSkillSummon
...
function var_0_4.DoDataEffectWithoutTarget(arg_2_0, arg_2_1, arg_2_2)
	arg_2_0:DoSummon(arg_2_1, arg_2_2)

	return
end

function var_0_4.DoDataEffect(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	arg_3_0:DoSummon(arg_3_1, arg_3_3)

	return
end

function var_0_4.DoSummon(arg_4_0, arg_4_1, arg_4_2)
	...
	if arg_4_1:GetUnitType() == var_0_1.UnitType.PLAYER_UNIT then
		...
		if arg_4_0._spawnData.relativeCorrdinate then
			local var_4_5 = arg_4_1:GetPosition()

			var_8.x = var_0_2.RandomPos(arg_4_0._spawnData.relativeCorrdinate).x + var_4_5.x
			var_8.y = var_8.y + var_4_5.y
			var_8.z = var_8.z + var_4_5.z

			var_4_2:SetPosition(var_8)
		end
	end
