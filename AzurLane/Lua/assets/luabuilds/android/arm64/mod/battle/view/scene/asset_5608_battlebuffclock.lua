...
function var_0_2.switchToIndex(arg_2_0, arg_2_1, arg_2_2)
	for iter_2_0 = 1, var_0_2.TYPE_INDEX do
		...
		local var_2_2 = var_2_1(var_2_0, var_1_10010(iter_2_0))

		SetActive = var_1_10008

		var_1_10008(var_2_2, arg_2_2 == iter_2_0)
	end
...
function var_0_2.Casting(arg_4_0, arg_4_1)
	...
	Vector3 = var_1_10003
	var_4_0.localScale = var_1_10003(0.1, 0.1, 1)
	...
	if arg_4_1.interrupt then
		...
		if not var_4_3(var_4_2, var_6(var_1_10008)) then
			local var_4_4 = arg_4_0._progressProtected

			var_4_3 = var_4_3.GetComponent
			typeof = var_6
			Image = var_1_10008
			var_4_3 = var_4_3(var_4_4, var_6(var_1_10008))
		end
		...
		local var_4_6 = var_5(arg_4_0._castClockGO)

		Vector3 = var_6

		local var_4_7 = var_4_5(var_4_6, var_6.New(1, 1, 1), 0.1)
		local var_4_8 = var_3.setEase

		LeanTweenType = var_6

		var_4_8(var_4_7, var_6.easeInBack)
...
function var_0_2.Interrupt(arg_5_0, arg_5_1)
	...
	var_5_0(var_1_10004(arg_5_0._danger))

	for iter_5_0 = 1, 2 do
		LeanTween = var_6

		local var_5_1 = var_6.alphaCanvas(arg_5_0._clockCG, 0.3, 0.3)
		local var_5_2 = var_6.setFrom(var_5_1, 1)

		var_6.setDelay(var_5_2, 0.3 * (iter_5_0 - 1))

		LeanTween = var_6

		local var_5_3 = var_6.alphaCanvas(arg_5_0._clockCG, 1, 0.3)

		var_6.setDelay(var_5_3, 0.3 * iter_5_0)
	end
	...
	local var_5_5 = var_4(arg_5_0._castClockGO)

	Vector3 = iter_5_0

	local var_5_6 = var_5_4(var_5_5, iter_5_0.New(0.1, 0.1, 1), 0.3)
	...
	var_5_10(var_5_9, var_5.Action(function()
