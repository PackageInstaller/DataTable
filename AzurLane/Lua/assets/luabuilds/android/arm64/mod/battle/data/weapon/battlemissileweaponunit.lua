...
function var_0_3.CalculateFixedExplodePosition(arg_1_0, arg_1_1)
	...
	return var_1_1(var_1_4.x + var_1_2, 0, 0)
end
...
function var_0_3.CalculateRandTargetPosition(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_2_1 then
		var_1_10009 = arg_2_1
		var_2_2 = arg_2_1.GetAttrByName(var_1_10009, var_2_1)
	end
...
function var_0_3.createMajorEmitter(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
	local function var_3_0(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
		...
		var_4_4(var_4_3, var_4_5, var_11.GetBaseAngle(var_4_6), arg_4_2)

		local var_4_7 = var_6
		local var_4_8 = var_6.RegisterOnTheAir
		local var_4_9 = arg_3_0

		var_4_8(var_4_7, var_10.ChoiceOntheAir(var_4_9, var_6))
...
function var_0_3.ChoiceOntheAir(arg_5_0, arg_5_1)
	return function()
		...
		var_6_10(var_6_9, var_2_10009(var_6_7, 0, var_6_8))
		...
		local var_6_12 = var_2_10007.Tool.FilterY
		local var_6_13 = arg_5_1
		local var_6_14 = var_6_12(var_6_1 - var_9.GetSpawnPosition(var_6_13))
