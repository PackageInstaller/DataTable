...
function var_0_1.InitKeys(arg_10_0, arg_10_1)
	...
	local var_10_1 = arg_10_0.GetKeys(var_10_0)
	local var_10_2 = {}
	...
	for iter_10_0, iter_10_1 in var_10_0(var_10_1) do
		...
		var_1_10009.insert(var_10_2, function(arg_11_0)
...
function var_0_1.InitKey(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	local var_12_2 = var_12_1(var_12_0, var_7(var_1_10009))

	GetSpriteFromAtlas = var_1_10005
	var_12_2.sprite = var_1_10005("ui/CourtyardLute_atlas", arg_12_2)

	var_12_2:SetNativeSize()

	local var_12_3 = arg_12_1:Find("sel")

	onButton = var_12_0

	var_12_0(arg_12_0, arg_12_1, function()
		setActive = var_2_10000

		var_2_10000(var_12_3, true)
	...
	local var_12_4 = arg_12_1:Find("animation")
	local var_12_5 = var_6.GetComponent

	typeof = var_9
	DftAniEvent = var_1_10011

	local var_12_6 = var_12_5(var_12_4, var_9(var_1_10011))

	var_6.SetEndEvent(var_12_6, function()
		setActive = var_2_10000

		var_2_10000(var_12_3, false)
...
function var_0_1.AnimationForKey(arg_17_0, arg_17_1)
	...
	local var_17_2 = var_17_1(var_17_0, var_5(var_1_10007))
...
function var_0_1.ClearAnimationForKey(arg_18_0, arg_18_1)
	...
	local var_18_2 = var_18_1(var_18_0, var_5(var_1_10007))
	...
	local var_18_5 = var_18_4(var_18_3, var_6(var_1_10008))
