...
function var_0_1.GetAssetPath(arg_2_0)
	...
	if var_2_1 == var_1_10002.OBJ_TYPE_COMMOM then
		var_2_2 = "furnitrues/"
...
function var_0_1.OnLoaded(arg_4_0, arg_4_1)
	...
	Vector2 = var_1_10003
	var_4_0.sizeDelta = var_1_10003(1888, 944)
	rtf = var_4_0
	...
	local var_4_5 = var_4(arg_4_1)

	Vector3 = var_5

	var_4_4(var_4_5, var_5(0, -280, 0))
	...
	if arg_4_0.paper then
		...
		if var_4_7 == var_3.OBJ_TYPE_SPINE then
	...
	Vector3 = var_4_10
	var_4_12.localScale = var_4_10(var_4_11, var_4_11, 1)
...
function var_0_1.InitSpine(arg_5_0, arg_5_1)
	...
	if var_5_2 then
		GetOrAddComponent = var_5_0
		tf = var_1_10006

		local var_5_3 = var_1_10006(arg_5_1)
		local var_5_4 = var_6.GetChild(var_5_3, 0)

		typeof = var_1_10007
		SpineAnimUI = var_9

		local var_5_5 = var_5_0(var_5_4, var_1_10007(var_9))
