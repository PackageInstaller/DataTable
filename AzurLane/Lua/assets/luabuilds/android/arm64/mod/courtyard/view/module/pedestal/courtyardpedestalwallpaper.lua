...
function var_0_1.OnLoaded(arg_4_0, arg_4_1)
	...
	Vector2 = var_1_10003
	var_4_0.anchorMin = var_1_10003(0.5, 1)
	rtf = var_4_0
	...
	if var_4_5 == var_3.OBJ_TYPE_COMMOM then
...
function var_0_1.InitSpine(arg_6_0, arg_6_1)
	...
	var_1_10002(var_6_0, var_1_10005(0, -10, 0))

	local var_6_1 = arg_6_0.paper
	local var_6_2, var_6_3 = var_2.GetSpineNameAndAction(var_6_1)

	if var_6_3 then
		GetOrAddComponent = var_6_1
		tf = var_1_10006

		local var_6_4 = var_1_10006(arg_6_1)
		local var_6_5 = var_6.GetChild(var_6_4, 0)

		typeof = var_7
		SpineAnimUI = var_9

		local var_6_6 = var_6_1(var_6_5, var_7(var_9))
