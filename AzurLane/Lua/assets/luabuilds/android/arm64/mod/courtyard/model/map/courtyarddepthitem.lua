...
function var_0_1.GetAreaByPosition(arg_19_0, arg_19_1)
	...
	for iter_19_0 = arg_19_1.x, arg_19_1.x + arg_19_0.sizeX - 1 do
		for iter_19_1 = arg_19_1.y, arg_19_1.y + arg_19_0.sizeY - 1 do
			...
			var_1_10011(var_19_1, var_1_10014(iter_19_0, iter_19_1))
		end
	end
...
function var_0_1._GetRotatePositions(arg_20_0, arg_20_1)
	...
	for iter_20_0 = arg_20_1.x, arg_20_1.x + var_20_0 - 1 do
		for iter_20_1 = arg_20_1.y, arg_20_1.y + var_20_1 - 1 do
			...
			var_1_10013(var_20_3, var_1_10016(iter_20_0, iter_20_1))
		end
	end
...
function var_0_1.GetAroundPositions(arg_30_0)
	...
	local var_30_1 = arg_30_0.GetPosition(var_30_0)
	local var_30_2 = {}

	Vector2 = var_30_0
	var_30_2[1] = var_30_0(var_30_1.x + 1, var_30_1.y)
	Vector2 = var_3
	var_30_2[2] = var_3(var_30_1.x, var_30_1.y + 1)
	Vector2 = var_3
	var_30_2[3] = var_3(var_30_1.x - 1, var_30_1.y)
	Vector2 = var_3
	var_30_2[4] = var_3(var_30_1.x, var_30_1.y - 1)
