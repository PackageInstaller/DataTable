...
function var_0_1.OnInit(arg_1_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.chatBubbleTxt = var_1_15(var_1_14, var_4(var_1_10006))
	...
	Vector3 = var_2
	var_1_18.localScale = var_2(2, 2, 1)
...
function var_0_1.InitMark(arg_2_0)
	...
	var_1_10001(var_2_0, var_4.IsSpecial(var_2_1))
	...
	local var_2_4 = var_2_3(var_2_2, var_4(var_2_1))
	...
	var_2_4(var_2_5, var_2_6, var_2_7, var_2_1)
...
function var_0_1.AddListeners(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10004.FEAST_SHIP_BUBBLE_CHANGE, arg_4_0.OnFeastBubbleChange)
	...
	var_4_3(var_4_2, var_4.FEAST_SHIP_CHAT_CHANGE, arg_4_0.OnFeastChatChange)
	...
	var_4_5(var_4_4, var_4.FEAST_SHIP_BUBBLE_INTERACTION, arg_4_0.OnFeastShipBubbleInterAction)
	...
	var_4_7(var_4_6, var_4.FEAST_SHIP_SHOW_EXPRESS, arg_4_0.OnFeastShipShowExpress)
...
function var_0_1.RemoveListeners(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10004.FEAST_SHIP_BUBBLE_CHANGE, arg_5_0.OnFeastBubbleChange)
	...
	var_5_3(var_5_2, var_4.FEAST_SHIP_CHAT_CHANGE, arg_5_0.OnFeastChatChange)
	...
	var_5_5(var_5_4, var_4.FEAST_SHIP_BUBBLE_INTERACTION, arg_5_0.OnFeastShipBubbleInterAction)
	...
	var_5_7(var_5_6, var_4.FEAST_SHIP_SHOW_EXPRESS, arg_5_0.OnFeastShipShowExpress)
...
function var_0_1.PlayExpressAnim(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	Vector3 = var_7
	arg_7_2 = var_4(var_7_0, var_7(1, 1, 1))
	LeanTween = var_4
	...
	local var_7_4 = var_7_3(var_7_2, var_7.easeOutBack)
	local var_7_5 = var_4.setDelay(var_7_4, arg_7_3)
	local var_7_6 = var_4.setOnComplete

	System = var_7

	var_7_6(var_7_5, var_7.Action(function()
		...
		var_8_1(var_8_0, var_8_2, var_2_10004(0, 0, 0), 2)
...
function var_0_1.OnFeastShipBubbleInterAction(arg_12_0, arg_12_1)
	...
	Vector3 = var_12_2
	var_12_4.localPosition = var_12_2(0, 100, -100)
	tf = var_12_4
...
function var_0_1.DisappearTimer(arg_14_0)
	...
	arg_14_0.disappearTimer = var_14_0(var_14_1, var_1_10004.FEAST_CHAT_TIME, 1)
