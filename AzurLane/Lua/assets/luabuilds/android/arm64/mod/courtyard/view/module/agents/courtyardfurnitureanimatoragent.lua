...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_2(arg_1_0.masks) do
		...
		local var_1_0 = iter_1_1:Find("spine")

		typeof = var_1_10010
		SpineAnimUI = var_12
		var_1_10007 = var_1_10007(var_1_0, var_1_10010(var_12))
		table = var_1_10008

		var_1_10008.insert(arg_1_0.maskSpineAnimUIs, var_1_10007)
	end

	local var_1_1 = arg_1_0._tf

	arg_1_0.spineTF = var_2.Find(var_1_1, "spine_icon")
	GetOrAddComponent = var_2

	local var_1_2 = arg_1_0.spineTF
	local var_1_3 = var_4.Find(var_1_2, "spine")

	typeof = var_5
	SpineAnimUI = var_7
	arg_1_0.spineAnimUI = var_2(var_1_3, var_5(var_7))

	local var_1_4 = arg_1_0
	local var_1_5 = arg_1_0.SetState

	CourtYardFurniture = var_5

	var_1_5(var_1_4, var_5.STATE_IDLE)
...
function var_0_1.GetNormalAnimationName(arg_5_0)
	...
	return var_5_1(var_5_0, var_1_10004.STATE_IDLE)
end
...
function var_0_1.PlayInteractioAnim(arg_9_0, arg_9_1)
	...
	var_1_10002({
		...
		var_12_1(var_12_0, var_2_10003.STATE_INTERACT)
