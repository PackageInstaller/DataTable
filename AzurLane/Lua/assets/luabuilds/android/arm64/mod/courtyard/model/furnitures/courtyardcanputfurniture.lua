...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	Vector4 = var_7
	arg_1_0.placeableArea = var_1_0(var_1_1, var_1_2, var_7(35, 35, 0, 0))
...
function var_0_1.AnyNotRotateChilds(arg_4_0)
	if #arg_4_0.childs > 0 then
		...
		return var_1.any(arg_4_0.childs, function(arg_5_0)
			...
			CourtYardFurniture = var_2_10004

			local var_5_1

			if var_2_10001(var_5_0, var_2_10004) then
...
function var_0_1.CanPutChildInPosition(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = arg_9_0.GetLevel(var_9_0) < arg_9_1:GetLevel()
	local var_9_2 = arg_9_0:AllowDepthType()

	table = var_9_0

	local var_9_3 = var_9_0.contains(var_9_2, arg_9_1:GetDeathType())
	local var_9_4 = arg_9_1:GetAreaByPosition(arg_9_2)
	local var_9_5

	if var_9_3 and var_9_1 then
		::label_9_1::

		_ = var_9_5
		var_9_5 = var_9_5.all(var_9_4, function(arg_10_0)
...
function var_0_1.Rotate(arg_16_0)
	...
	for iter_16_0 = #arg_16_0.childs, 1, -1 do
		...
		Vector2 = var_1_10014
		var_16_7[2] = var_16_1 + var_1_10014(var_16_4.y, var_16_4.x)
...
function var_0_1.ToTable(arg_19_0)
	...
	for iter_19_0, iter_19_1 in var_1_10004(arg_19_0.childs) do
