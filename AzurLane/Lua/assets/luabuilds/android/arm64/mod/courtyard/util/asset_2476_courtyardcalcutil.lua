...
function var_0_0.Screen2Local(arg_1_0, arg_1_1)
	...
	local var_1_2 = arg_1_0:GetComponent("RectTransform")

	LuaHelper = var_1_0

	return (var_1_0.ScreenToLocal(var_1_2, arg_1_1, var_1_1))
end
...
function var_0_0.Local2Map(arg_3_0)
	...
	local var_3_1 = var_1_10002.floor(arg_3_0.y / var_0_2 - arg_3_0.x / var_0_1)
...
function var_0_0.World2Local(arg_4_0, arg_4_1)
	...
	return var_1_10003(var_4_0.x, var_4_0.y, 0)
end
...
function var_0_0.local2RelativeLocal(arg_5_0, arg_5_1, arg_5_2)
	...
	return arg_5_0 + var_5_0(var_1_10005(arg_5_1, arg_5_2))
end
...
function var_0_0.TrPosition2LocalPos(arg_6_0, arg_6_1, arg_6_2)
	if arg_6_0 == arg_6_1 then
		...
		local var_6_1 = arg_6_0.TransformPoint(var_6_0, arg_6_2)
		local var_6_2 = arg_6_1:InverseTransformPoint(var_6_1)

		Vector3 = var_6_0

		return var_6_0(var_6_2.x, var_6_2.y, 0)
	end
