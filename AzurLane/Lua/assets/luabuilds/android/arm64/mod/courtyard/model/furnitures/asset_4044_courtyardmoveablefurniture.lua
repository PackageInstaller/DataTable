...
function var_0_1.Move(arg_13_0, arg_13_1)
	...
	Timer = var_1_10003
	arg_13_0.moveTimer = var_1_10003.New(function()
	...
	local var_13_1 = arg_13_0.moveTimer

	var_3.Start(var_13_1)

	local var_13_2 = arg_13_0
	local var_13_3 = arg_13_0.DispatchEvent

	CourtYardEvent = var_6

	var_13_3(var_13_2, var_6.FURNITURE_MOVE, arg_13_1)
...
function var_0_1.Rest(arg_15_0)
	...
	local var_15_1 = var_1_10002.New
	...
	math = var_1_10005
	arg_15_0.moveTimer = var_15_1(var_15_2, var_1_10005.random(10, 20), 1)
...
function var_0_1.Idle(arg_17_0)
	...
	var_17_1(var_17_0, var_4.FURNITURE_STOP_MOVE)
...
function var_0_1.Stop(arg_18_0)
	...
	var_18_1(var_18_0, var_4.FURNITURE_STOP_MOVE)
...
function var_0_1.IsSpineSlotAndExistPreheatAction(arg_21_0, arg_21_1)
	...
	CourtYardFurnitureSpineSlot = var_1_10005

	if not var_1_10002(var_21_0, var_1_10005) then
		return false
	end
...
function var_0_1.StartInteraction(arg_22_0, arg_22_1)
	if arg_22_0:IsSpineSlotAndExistPreheatAction(arg_22_1) then
		...
		CourtYardFurniture = var_5

		var_22_1(var_22_0, var_5.STATE_INTERACT)
		...
		var_22_3(var_22_2, var_5.FURNITURE_START_INTERACTION, arg_22_1)
		arg_22_0:Idle()
	else
...
function var_0_1.ClearInteraction(arg_25_0, arg_25_1)
	if arg_25_0:IsSpineSlotAndExistPreheatAction(arg_25_1) then
		...
		if #var_2.select(arg_25_0.slots, function(arg_26_0)
			...
			var_25_1(var_25_0, var_1_10006.STATE_IDLE)
			arg_25_0:Idle()
		end
		...
		var_25_3(var_25_2, var_1_10006.FURNITURE_STOP_INTERACTION, arg_25_1)
	else
