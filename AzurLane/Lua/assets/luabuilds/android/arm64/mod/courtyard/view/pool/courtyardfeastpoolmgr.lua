...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".CourtYardPoolMgr"))
...
function var_0_1.GenPool(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_4(var_1_1) do
		...
		var_1_10009.insert(var_1_0, function(arg_2_0)
			...
			local var_2_4 = var_2_10006(var_2_10008)

			UnityEngine = var_2_10007

			var_2_1(var_2_0, var_2_2, var_2_3, var_2_4, var_2_10007.Events.UnityAction_UnityEngine_Object(function(arg_3_0)
				...
				if arg_3_0 then
					...
					CourtYardConst = var_3_10009
					var_3_0[var_3_1] = var_3_2(var_3_3, var_3_4, var_3_5, var_3_6, var_3_10009.FEAST_EFFECT_TIME)
				end
