...
function var_0_1.SetAnimators(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in var_1_10005(var_4_1) do
		table = var_1_10010
...
function var_0_1.GetSubstituteAction(arg_8_0, arg_8_1, arg_8_2)
	local function var_8_0(arg_9_0)
		...
		if arg_9_0.math_mode ~= 1 or not var_9_1:GetSkinID() then
			var_9_2 = var_9_1:GetGroupID()
		end
		...
		if var_9_0.contains(arg_9_0.match, var_9_2) then
...
local function var_0_7(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_1_10005(arg_16_0.actions) do
		...
		if var_1_10012(var_16_4) == "table" then
			...
			var_14.insert(var_16_1, var_16_7)

			local var_16_8 = arg_16_0:GetUserSubstituteAction(var_16_5 or var_1_10012)

			table = var_16_6

			var_16_6.insert(var_16_2, var_16_8)

			table = var_15

			local var_16_9 = var_15.insert
			local var_16_10 = var_16_3

			tobool = var_18

			var_16_9(var_16_10, var_18(iter_16_1[2]))
		end
	end
...
function var_0_1.GetActions(arg_17_0)
	...
	if arg_17_0.preheatAction then
		...
		if var_4(arg_17_0.preheatAction) == "table" then
			...
			if var_1_10005(arg_17_0.preheatAction[1]) == "table" then
				ipairs = var_5
			...
			if var_7(var_17_6, var_1_10010) then
	...
	if arg_17_0.strategyType == var_0_5 then
		var_17_7, var_17_8, var_17_9 = var_0_6(arg_17_0)
	else
		var_17_7, var_17_8, var_17_9 = var_0_7(arg_17_0)
	end
	...
	local var_17_13 = var_17_0
	local var_17_14 = var_17_1
	local var_17_15 = arg_17_0.tailAction

	preheatOnlyHost = var_1_10013

	return var_17_10, var_17_11, var_17_12, var_17_13, var_17_14, var_17_15, var_1_10013
end
