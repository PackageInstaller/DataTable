...
function var_0_0.Init(arg_2_0)
	...
	local var_2_1 = arg_2_0.GetStoreyModule(var_2_0)
	local var_2_2
	...
	var_2_0({
		function(arg_3_0)
			...
			var_1.LoadUI(var_3_0, var_2_1.__cname, function(arg_4_0)
				var_2_2 = arg_4_0
		...
		arg_2_0.storeyModule = var_2_1.New(arg_2_0.storey, var_2_2)
		arg_2_0.isInit = true
...
function var_0_0.LoadUI(arg_8_0, arg_8_1, arg_8_2)
	...
	var_8_1(var_8_0, var_8_2, var_8_3, var_1_10008.Events.UnityAction_UnityEngine_Object(function(arg_9_0)
		local var_9_0
		local var_9_1 = arg_8_0.storey
		local var_9_2 = var_2.GetStyle(var_9_1)

		CourtYardConst = var_2_10003

		if var_9_2 == var_2_10003.STYLE_PREVIEW then
			pg = var_9_2
