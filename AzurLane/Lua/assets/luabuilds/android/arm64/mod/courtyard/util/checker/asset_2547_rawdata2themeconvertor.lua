...
local function var_0_2(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_1_10004(var_2_3) do
		...
		Vector2 = var_1_10010
		var_2_2[var_1_10009] = var_1_10010(iter_2_1.x, iter_2_1.y)
	end
	...
	tonumber = iter_2_0
	var_2_5.id = iter_2_0(arg_2_0.id)
	Vector2 = var_7
	var_2_5.position = var_7(arg_2_0.x, arg_2_0.y)
	var_2_5.dir = arg_2_0.dir
	var_2_5.child = var_2_2
	tonumber = var_7
	var_2_5.parent = var_7(arg_2_0.parent)
...
local function var_0_3(arg_3_0, arg_3_1, arg_3_2)
	...
	var_1_10003(var_1_10005.furniture_data_template[arg_3_1], arg_3_1)
...
function var_0_0.GenFurnitures(arg_6_0, arg_6_1)
	...
	for iter_6_2, iter_6_3 in var_6(var_6_3) do
		if iter_6_3:AnyChild() then
			...
			for iter_6_4, iter_6_5 in var_1_10012(iter_6_3:GetChildList()) do
				if var_0_4(var_6_3, iter_6_4, iter_6_3.configId, iter_6_3:GetPosition(), iter_6_5) then
					var_6_4[var_0_1(iter_6_4, var_17.configId, var_17.isNewStyle)] = iter_6_5
				end
			end
	...
	for iter_6_6, iter_6_7 in var_8(var_6_3) do
		if not iter_6_7:HasParent() then
			...
			var_13.insert(var_6_6, iter_6_7)
		end

		if iter_6_7:AnyChild() then
			ipairs = var_13

			for iter_6_8, iter_6_9 in var_13(var_6_5(iter_6_7)) do
				table = var_1_10018

				var_1_10018.insert(var_6_6, iter_6_9)
			end
		end
	end
	...
	for iter_6_10, iter_6_11 in var_9(var_6_6) do
		if iter_6_11:HasParent() then
			var_6_7[iter_6_11.id] = true
		end
	end

	ipairs = var_9

	for iter_6_12, iter_6_13 in var_9(var_6_6) do
		if not iter_6_13:HasParent() then
			ipairs = var_14

			for iter_6_14, iter_6_15 in var_14(iter_6_13:GetAllUniqueId()) do
				if not var_6_7[iter_6_15] then
					iter_6_13:SetUniqueId(iter_6_15)

					var_6_7[iter_6_15] = true
	...
	local function var_6_8(arg_8_0, arg_8_1, arg_8_2)
		ipairs = var_2_10003
	...
	for iter_6_20, iter_6_21 in var_11(var_6_6) do
		var_6_9[iter_6_21.id] = iter_6_21
	end

	if not var_6_2 then
		arg_6_0:CheckFurnitures(var_6_9, var_6_1)
	end
