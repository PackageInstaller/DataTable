...
function var_0_1.Reset(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_2(arg_2_1) do
		...
		Vector3 = var_2_0
		var_2_2.localScale = var_2_0(1, 1, 1)
		table = var_2_2
...
function var_0_1.UpdatePositionAndColor(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_2 = var_5.TrPosition2LocalPos
	local var_4_3 = arg_4_0.gridsTF
	local var_4_4 = arg_4_1.transform.parent

	Vector3 = var_1_10009
	var_4_1.localPosition = var_4_2(var_4_3, var_4_4, var_1_10009(var_4_0.x, var_4_0.y, 0))
	...
	typeof = var_4_4
	Image = var_1_10010
	var_4_7(var_4_6, var_4_4(var_1_10010)).color = var_4_5
...
function var_0_1.Clear(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_1_10001(arg_5_0.grids) do
		...
		local var_5_3 = iter_5_1.GetComponent

		typeof = var_9
		Image = var_11

		local var_5_4 = var_5_3(var_5_2, var_9(var_11))

		Color = var_1_10007
		var_5_4.color = var_1_10007.New(1, 1, 1, 1)

		local var_5_5 = arg_5_0:GetPool()

		var_6.Enqueue(var_5_5, iter_5_1)
	end
