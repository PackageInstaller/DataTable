...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	var_1_10004.insert(arg_1_0.jobs, var_1_1)
...
function var_0_0.Make(arg_3_0, arg_3_1)
	...
	CourtYardCanPutFurniture = var_1_10007

	if var_3_1(var_3_4, var_1_10007) then
...
function var_0_0.OnJobFinish(arg_5_0)
	...
	local var_5_0 = #arg_5_0.caches

	if 0 < var_5_0 then
		local var_5_1 = arg_5_0:GetIdleJob()
