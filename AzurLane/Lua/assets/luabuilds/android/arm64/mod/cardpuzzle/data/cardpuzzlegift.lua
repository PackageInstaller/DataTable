...
function var_0_1.GetEffects(arg_9_0)
	...
	return var_1_10002.map(var_9_0, function(arg_10_0)
		pg = var_2_10001
	...
	for iter_11_0, iter_11_1 in var_3(arg_11_0:GetEffects()) do
		if iter_11_1.type == var_0_1.EFFECT_TYPE.GLOBAL_ATTRIBUTE_BONUS then
			...
			for iter_11_2, iter_11_3 in var_8(iter_11_1.arg_list) do
				...
				if var_1_10016.contains(var_11_1, arg_11_1:getShipType()) then
					table = var_1_10016
					...
					CardPuzzleShip = var_1_10020
					var_11_5.type = var_1_10020.PROPERTIES[var_11_2]
					var_11_5.value = var_11_3

					var_1_10016(var_11_4, var_11_5)
				end
			end
		end
	end
