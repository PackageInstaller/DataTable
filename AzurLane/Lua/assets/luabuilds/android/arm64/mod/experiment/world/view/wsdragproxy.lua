...
function var_0_1.Setup(arg_1_0, arg_1_1)
	...
	arg_1_0.dragTrigger = var_1_10002(var_1_0, var_1_10005(var_1_10007))
	...
	arg_1_0.longPressTrigger = var_1_4(var_1_5, var_5(var_1_10007))
...
function var_0_1.Focus(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	var_1_10007(var_7_2, "plane not exist.")
	...
	local var_7_6 = var_10.tan

	math = var_1_10012
	var_7.y = var_7_4 - var_7_5 * var_7_6(var_1_10012.pi / 180 * var_7_0.angle)
	math = var_8
	...
	if arg_7_3 then
		...
		var_7_9.insert(var_7_8, function(arg_8_0)
			...
			if not arg_7_2 then
				...
				if 0 < var_8_0 then
					...
					System = var_5
					var_8_2.twFocusId = var_8_5(var_8_4, var_5.Action(arg_8_0)).uniqueId
		...
		var_7_9 = arg_7_0.transform
		var_7_9.localPosition = var_7
	end

	seriesAsync = var_7_9

	var_7_9(var_7_8, function()
...
function var_0_1.UpdateDrag(arg_11_0)
	...
	local var_11_6 = var_11_4 / var_11_5(var_1_10008.deg2Rad * var_11_3.fov * 0.5)
	...
	local var_11_9 = -var_1_10010.sin(var_11_7)

	math = var_1_10011

	local var_11_10 = var_7(var_11_8, var_11_9, -var_1_10011.cos(var_11_7))

	Vector3 = var_8

	local var_11_11 = var_8(var_11_3.offsetx, var_11_3.offsety, var_11_3.offsetz)

	WorldConst = var_11_8

	local var_11_12 = var_11_11 + var_11_8.DefaultMapOffset
	...
	local var_11_20 = var_11_1 + var_11_18.max(arg_11_0.leftExtend, arg_11_0.rightExtend) * 2

	math = var_14
	var_11_19.sizeDelta = var_11_16(var_11_20, var_11_2 + var_14.max(arg_11_0.topExtend, arg_11_0.bottomExtend) * 2)
	...
	var_10.AddDragFunc(var_11_22, function(arg_12_0, arg_12_1)
		...
		math = var_7
		var_12_0.y = var_12_1(var_12_2 + var_12_3 / var_7.cos(var_11_7), -arg_11_0.topExtend, arg_11_0.bottomExtend)
...
function var_0_1.GetDragExtend(arg_13_0, arg_13_1, arg_13_2)
	...
	var_1_10006(var_13_2, "plane not exist.")
	...
	local var_13_6 = var_9.tan

	math = var_1_10011

	local var_13_7 = var_13_4 - var_13_5 * var_13_6(var_1_10011.pi / 180 * var_13_0.angle)
	...
	local var_13_14 = var_13_13((var_15.MaxRow * 0.5 - var_13_8) * var_13_11.y, 0)
	...
	local var_13_16 = var_13_15((var_13_9 - var_16.MaxRow * 0.5) * var_13_11.y, 0)
...
function var_0_1.ShakePlane(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4, arg_14_5)
	...
	local var_14_1 = var_9.cos(var_14_0)

	math = var_10

	local var_14_2 = var_1_10007(var_14_1, var_10.sin(var_14_0), 0) * arg_14_1
	...
	local var_14_13 = var_17.moveLocal(arg_14_0.transform.gameObject, var_8, var_14_7)
	local var_14_14 = var_17.setDelay(var_14_13, var_14_5 + var_14_6 * arg_14_4 * 2)
	local var_14_15 = var_17.setOnComplete

	System = var_20

	local var_14_16 = var_14_15(var_14_14, var_20.Action(function()
