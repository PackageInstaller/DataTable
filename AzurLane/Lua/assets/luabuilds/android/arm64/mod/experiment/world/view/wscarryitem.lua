...
function var_0_1.Setup(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	WorldMapFleet = var_1_10007

	var_2_1(var_2_0, var_1_10007.EventUpdateLocation, arg_2_0.onUpdate)
	...
	var_2_3(var_2_2, var_7.EventUpdateOffset, arg_2_0.onUpdate)
...
function var_0_1.Dispose(arg_3_0)
	...
	WorldCarryItem = var_4

	var_3_3(var_3_2, var_4.EventUpdateOffset, arg_3_0.onUpdate)
	...
	if arg_3_0.wsMapPath then
		...
		var_3_5(var_3_4, var_4.EventArrived, arg_3_0.onMoveEnd)
...
function var_0_1.Init(arg_4_0)
	...
	var_4_5(var_4_4, var_5.GetScale(var_4_6))
				...
				if arg_5_1 ~= nil then
					...
					if arg_5_1 ~= var_7.EventUpdateLocation then
						...
						if arg_5_1 == var_7.EventUpdateOffset then
							...
							var_5_7(var_5_6, var_1_10010.LOFleet, var_5_3)
						end

						if arg_5_1 == nil then
							local var_5_8 = var_5_2:IsAvatar()
							local var_5_9 = var_5_0
							local var_5_10 = var_5_0.Find(var_5_9, "char")
							local var_5_11 = var_5_0:Find("icon")

							setActive = var_5_9

							var_5_9(var_5_10, var_5_8)

							setActive = var_5_9

							var_5_9(var_5_11, not var_5_8)

							if var_5_8 then
								local var_5_12 = arg_5_0

								var_5_9 = arg_5_0.LoadModel
								WorldConst = var_13

								var_5_9(var_5_12, var_13.ModelSpine, var_5_2.config.icon, nil, true, function()
									local var_6_0 = arg_5_0.model
									local var_6_1 = var_0.SetParent
									local var_6_2 = var_5_10

									var_6_1(var_6_0, var_3.Find(var_6_2, "ship"), false)
								...
								local var_5_14 = var_13.ModelPrefab

								WorldConst = var_1_10014

								var_5_9(var_5_13, var_5_14, var_1_10014.ResBoxPrefab .. var_5_2.config.icon, var_5_2.config.icon, true, function()
							...
							var_5_9(var_5_0:Find("buffs"), false)

							setActive = var_5_9

							var_5_9(var_5_0:Find("map_buff"), false)
						end
...
function var_0_1.FollowPath(arg_9_0, arg_9_1)
	if not arg_9_0.wsMapPath then
		...
		var_9_2(var_9_1, var_5.EventArrived, arg_9_0.onMoveEnd)
	end
	...
	var_9_3.insert(arg_9_0.followList, function()
		...
		var_10_6(var_10_5, var_6.ActionMove)
		...
		var_10_8(var_10_7, var_6.DirType2)
