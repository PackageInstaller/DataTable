...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_6 = var_3.Find(var_3_5, "pressing_award")
	local var_3_7 = arg_3_0.rtInfoPanel

	arg_3_0.awardItemList = var_3_4(var_3_6, var_4.Find(var_3_7, "pressing_award/award_tpl"))
	...
	var_1.make(var_3_8, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			local var_4_4 = arg_4_2.Find(var_4_3, "IconTpl")
			...
			var_5(var_4_2, var_4_4, var_4_5, var_4_3)

			local var_4_6 = arg_3_0.mapList[arg_3_0.destIndex]

			setActive = var_6

			var_6(arg_4_2:Find("is_pressing"), var_4_6.isPressing)

			setActive = var_6

			var_6(arg_4_2:Find("IconTpl"), not var_4_6.isPressing)
		end
	...
	local function var_3_12()
		...
		var_6_1(var_6_0, var_2_10003.SceneOp, "OpSetInMap", true)
	...
	var_1(var_3_10, var_3_11, var_3_12, var_3_7)
	...
	local function var_3_16()
		...
		if var_2.HasDangerConfirm(var_7_1.config.entrance_ui) then
			...
			var_2.insert(var_7_0, function(arg_8_0)
				...
				WorldScene = var_3_10004

				var_8_1(var_8_0, var_3_10004.SceneOp, "OpCall", function(arg_9_0)
					arg_9_0()
					...
					i18n = var_4_10005
					var_9_2.content = var_4_10005("world_map_dangerous_confirm")
		...
		var_2(var_7_0, function()
			...
			if not var_7_1.isCost then
				...
				var_3_10004 = var_10_0

				if var_10_1 > var_10_0.GetTotalStamina(var_3_10004) then
					var_10_0:Show()
			...
			do
				...
				var_10_3(var_10_2, var_3_10004.SceneOp, "OpTransport", arg_3_0.entrance, var_7_1)
			end
	...
	var_1(var_3_14, var_3_15, var_3_16, var_3_7)
	...
	var_1(var_3_19, var_3_20, var_3_21, var_3_7)
	...
	var_1(var_3_23, var_3_24, var_3_25, var_3_7)
	...
	local var_3_29 = var_4.Find(var_3_28, "bg")
	...
	var_1(var_3_27, var_3_29, var_3_30, var_3_28)
	...
	arg_3_0.toggleItemList = var_3_33(var_3_34, var_4.Find(var_3_35, "toggle"))
	...
	var_1.make(var_3_36, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			var_6(var_14_3, var_14_4, var_14_5, var_11)
...
function var_0_1.Setup(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	...
	local var_19_2 = var_19_1(var_19_0, var_1_10008(arg_19_1.config.area_pos[1], arg_19_1.config.area_pos[2]))

	setAnchoredPosition = var_1_10006

	local var_19_3 = arg_19_0.rtBasePoint
	local var_19_4 = arg_19_0._tf
	local var_19_5 = var_9.InverseTransformPoint

	GameObject = var_1_10012

	local var_19_6 = var_1_10012.Find("OverlayCamera")
	local var_19_7 = var_12.GetComponent

	typeof = var_1_10015
	Camera = var_1_10017

	local var_19_8 = var_19_7(var_19_6, var_1_10015(var_1_10017))

	var_1_10006(var_19_3, var_19_5(var_19_4, var_12.ScreenToWorldPoint(var_19_8, var_19_2)))

	nowWorld = var_1_10006

	local var_19_9 = var_1_10006()
	...
	var_7(var_9.GetChild(var_19_12, var_19_10() - 1), true)
...
function var_0_1.setColorfulImage(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	var_4(var_21_0, var_7(var_9.Find(var_21_1, arg_21_1.name .. "/" .. arg_21_2)), arg_21_3)
...
function var_0_1.UpdatePanel(arg_22_0)
	...
	local var_22_6 = var_22_1.IsMapOpen(var_22_5)
	...
	local var_22_7 = var_7("world/mapicon/" .. var_22_1.config.entrance_mapicon, "")

	setImageSprite = var_22_5

	local var_22_8 = arg_22_0.rtInfoPanel

	var_22_5(var_10.Find(var_22_8, "icon"), var_22_7)
	...
	local var_22_10 = arg_22_0.setColorfulImage
	local var_22_11 = arg_22_0.rtMarking

	var_22_10(var_22_9, var_11.Find(var_22_11, "mark_bg"), var_22_4)
	arg_22_0:setColorfulImage(arg_22_0.rtMaskMarking, var_22_4)

	local var_22_12 = arg_22_0
	local var_22_13 = arg_22_0.setColorfulImage
	local var_22_14 = arg_22_0.rtMaskMarking

	var_22_13(var_22_12, var_11.Find(var_22_14, "mark_bg"), var_22_4)

	setText = var_22_13

	local var_22_15 = arg_22_0.rtMarking

	var_22_13(var_10.Find(var_22_15, "Text"), var_22_3)

	setText = var_22_13

	local var_22_16 = arg_22_0.rtMaskMarking

	var_22_13(var_10.Find(var_22_16, "Text"), var_22_3)

	setActive = var_22_13

	local var_22_17 = arg_22_0.rtInfoPanel

	var_22_13(var_10.Find(var_22_17, "sairen"), var_22_2 == "sairen_chapter")

	setText = var_22_13

	local var_22_18 = arg_22_0.rtInfoPanel
	local var_22_19 = var_10.Find(var_22_18, "sairen/Text")

	i18n = var_11

	var_22_13(var_22_19, var_11("area_yaosai_2"))

	setText = var_22_13

	local var_22_20 = arg_22_0.rtInfoPanel
	local var_22_21 = var_10.Find(var_22_20, "danger_text")
	local var_22_22

	if not var_22_6 or not var_22_1:GetDanger() then
		var_22_22 = "?"
	end

	var_22_13(var_22_21, var_22_22)

	changeToScrollText = var_22_13

	local var_22_23 = arg_22_0.rtInfoPanel

	var_22_13(var_10.Find(var_22_23, "title/name"), var_22_1:GetName(arg_22_0.entrance))

	local var_22_24, var_22_25, var_22_26 = var_22_0:CountAchievements(arg_22_0.entrance)

	setText = var_11

	local var_22_27 = arg_22_0.rtInfoPanel

	var_11(var_13.Find(var_22_27, "title/achievement/number"), var_22_24 + var_22_25 .. "/" .. var_22_26)

	local var_22_28 = var_22_0:GetPressingAward(var_22_1.id)

	setActive = var_22_23

	local var_22_29 = arg_22_0.rtInfoPanel

	var_22_23(var_14.Find(var_22_29, "pressing_award"), var_22_28 and var_22_28.flag)

	if var_22_28 and var_22_28.flag then
		pg = var_12
		arg_22_0.awardConfig = var_12.world_event_complete[var_22_28.id].tips_icon

		local var_22_30 = arg_22_0.awardItemList

		var_13.align(var_22_30, #arg_22_0.awardConfig)
	end
	...
	local var_22_31 = var_12()
	local var_22_32 = var_12.GetAtlas(var_22_31)
	local var_22_33 = var_12.GetActiveMap(var_22_32)
	local var_22_34, var_22_35 = var_13.CkeckTransport(var_22_33)
	local var_22_36 = false

	setActive = var_17

	var_17(arg_22_0.btnBack, not var_22_36 and var_12:GetActiveEntrance() == arg_22_0.entrance and var_13 == var_22_1)

	if not var_22_36 then
		isActive = var_17
		var_22_36 = var_17(arg_22_0.btnBack)
	end

	setActive = var_17

	var_17(arg_22_0.btnEnter, not var_22_36 and var_22_34 and var_22_6 and var_12.transportDic[arg_22_0.entrance.id])

	if not var_22_36 then
		isActive = var_17
		var_22_36 = var_17(arg_22_0.btnEnter)
	end

	setText = var_17

	local var_22_37 = arg_22_0.btnLock
	local var_22_38 = var_19.Find(var_22_37, "Text")
	...
	if var_22_6 then
		...
		var_17(var_22_38, var_22_39)

		setActive = var_17

		var_17(arg_22_0.btnLock, not var_22_36 and var_22_34)

		if not var_22_36 then
			isActive = var_17
			var_22_36 = var_17(arg_22_0.btnLock)
		end

		setActive = var_17

		var_17(arg_22_0.btnReturn, not var_22_36)

		if not var_22_36 then
			isActive = var_17

			local var_22_40 = var_17(arg_22_0.btnReturn)
		end
...
function var_0_1.UpdateCost(arg_23_0)
	...
	var_1_10003(var_23_2, not var_23_0.isCost)

	nowWorld = var_1_10003

	local var_23_3 = var_1_10003().staminaMgr
	local var_23_4 = var_3.GetTotalStamina(var_23_3)
	local var_23_5 = var_23_0.config.enter_cost

	setText = var_23_3

	local var_23_6 = var_23_2:Find("Text")
	...
	if var_23_4 < var_23_5 then
		...
		var_23_3(var_23_6, var_1_10008(var_23_7, var_1_10011) .. "/" .. var_23_5)
...
function var_0_1.ShowToggleMask(arg_24_0)
	...
	var_24_2(var_24_1, var_4.Action(function()
...
function var_0_1.HideToggleMask(arg_26_0)
	...
	var_26_2(var_26_1, var_4.Action(function()
		setActive = var_2_10000
