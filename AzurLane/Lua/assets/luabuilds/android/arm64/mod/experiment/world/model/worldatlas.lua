...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	var_2(var_4.world_expedition_data_by_map[arg_1_0.id], "world_expedition_data_by_map missing: " .. arg_1_0.id)
...
function var_0_1.NewEntrance(arg_4_0, arg_4_1)
	...
	WorldEntrance = var_1_10005

	local var_4_2 = var_4_1(var_4_0, var_1_10005)
...
function var_0_1.NewMap(arg_5_0, arg_5_1)
	...
	WorldMap = var_1_10005

	local var_5_2 = var_5_1(var_5_0, var_1_10005)
...
function var_0_1.BuildEntranceDic(arg_6_0)
	...
	var_6_1(var_4.world_chapter_colormask.all, function(arg_7_0)
		pg = var_2_10001
...
function var_0_1.CheckMapActive(arg_15_0, arg_15_1)
	...
	var_1_10003(var_15_0, "map not exist: " .. arg_15_1)

	local var_15_1

	if not var_15_0.active then
		_ = var_15_1
		var_15_1 = var_15_1.any
		_ = var_5
		var_15_1 = var_15_1(var_5.values(arg_15_0:GetPartMaps(arg_15_1)), function(arg_16_0)
...
function var_0_1.UpdateTreasure(arg_25_0, arg_25_1)
	...
	if var_25_2 ~= 0 then
		local var_25_3 = var_2:FindTreasureEntrance(arg_25_1)

		pg = var_7

		if var_7.world_item_data_template[arg_25_1].usage_arg[1] == 1 then
...
function var_0_1.SetPressingMarkList(arg_26_0, arg_26_1)
	...
	var_1_10003.each(arg_26_0.pressingMapList, function(arg_28_0)
...
function var_0_1.GetPressingUnlockRecordCount(arg_35_0, arg_35_1)
	...
	local var_35_0 = var_1_10002(var_1_10004)
	local var_35_1 = var_2.getRawData(var_35_0).id

	nowWorld = var_1_10003

	local var_35_2 = var_1_10003().activateCount

	PlayerPrefs = var_35_0

	local var_35_3 = var_35_0.GetInt

	string = var_1_10006

	return var_35_3(var_1_10006.format("world_new_shop_unlock_count_in_port_%d_%d_%d", var_35_1, var_35_2, arg_35_1), -1)
end
...
function var_0_1.SetPressingUnlockRecordCount(arg_36_0, arg_36_1, arg_36_2)
	...
	local var_36_0 = var_1_10003(var_1_10005)
	local var_36_1 = var_3.getRawData(var_36_0).id

	nowWorld = var_1_10004

	local var_36_2 = var_1_10004().activateCount

	PlayerPrefs = var_36_0

	local var_36_3 = var_36_0.SetInt

	string = var_1_10007

	return var_36_3(var_1_10007.format("world_new_shop_unlock_count_in_port_%d_%d_%d", var_36_1, var_36_2, arg_36_1), arg_36_2)
end
...
function var_0_1.RemoveSairenEntrance(arg_40_0, arg_40_1)
	...
	if var_1_10002.indexof(arg_40_0.sairenEntranceList, arg_40_1.id) then
		...
		var_1_10003.remove(arg_40_0.sairenEntranceList, var_2)
...
function var_0_1.InitPortMarkNShopList(arg_46_0)
	...
	for iter_46_0, iter_46_1 in var_46_1(arg_46_0.nShopGoodsDic) do
		...
		Goods = var_1_10010
		var_1_10010 = var_1_10007(var_46_2, var_1_10010.TYPE_WORLD_NSHOP)

		local var_46_3 = var_1_10007.getConfig(var_1_10010, "port_id")
		local var_46_4 = var_1_10007:getConfig("unlock_num")

		var_1_10010 = arg_46_0:GetPressingUnlockRecordCount(var_46_3)

		if var_1_10007:canPurchase() and var_1_10010 < var_46_4 and var_46_4 <= var_46_0 then
...
function var_0_1.UpdateUnlockCountPortMark(arg_47_0)
	...
	for iter_47_0, iter_47_1 in var_2(var_47_2.keys(arg_47_0.portEntranceList)) do
		...
		if var_1_10007 ~= var_1_10008(arg_47_0.markPortDic.newGoods[iter_47_1]) then
			var_1_10007 = {}
			ipairs = var_1_10008

			for iter_47_2, iter_47_3 in var_1_10008(arg_47_0.portEntranceList[iter_47_1]) do
	...
	if var_2 then
		...
		var_47_4(var_47_3, var_47_5, iter_47_1)
	end
...
function var_0_1.UpdatePortMarkNShop(arg_48_0, arg_48_1, arg_48_2)
	...
	if var_3(arg_48_0.markPortDic.newGoods[arg_48_1]) ~= arg_48_2 then
		...
		if var_3.UsePortNShop(var_48_1) then
			...
			for iter_48_0, iter_48_1 in var_1_10004(arg_48_0.portEntranceList[arg_48_1]) do
...
function var_0_1.InitWorldNShopGoods(arg_50_0, arg_50_1)
	...
	for iter_50_0, iter_50_1 in var_2(var_1_10004.world_newshop_data.all) do
...
function var_0_1.GetEntrancePortInfo(arg_52_0, arg_52_1)
	...
	local var_52_1 = arg_52_0.GetEntrance(var_52_0, arg_52_1)
	local var_52_2 = var_2.GetPortId(var_52_1)

	nowWorld = var_52_0

	local var_52_3 = var_52_0()

	if var_4.UsePortNShop(var_52_3) then
		return arg_52_0.transportDic[var_2.id], arg_52_0.markPortDic.newGoods[var_52_2], arg_52_0.markPortDic.newGoods[var_52_2]
	else
		return arg_52_0.transportDic[var_2.id], arg_52_0.markPortDic.goods[var_52_2], arg_52_0.markPortDic.new[var_52_2]
	end
