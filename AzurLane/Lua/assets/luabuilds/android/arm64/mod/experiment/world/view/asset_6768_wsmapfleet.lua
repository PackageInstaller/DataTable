...
function var_0_1.Setup(arg_2_0, arg_2_1, arg_2_2)
	...
	var_2_3(var_2_2, var_6.EventUpdateShipOrder, arg_2_0.onUpdate)
	...
	var_2_5(var_2_4, var_6.EventUpdateBuff, arg_2_0.onUpdate)
	...
	var_2_7(var_2_6, var_6.EventUpdateDamageLevel, arg_2_0.onUpdate)
...
function var_0_1.Dispose(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10004.EventUpdateLocation, arg_3_0.onUpdate)
	...
	var_3_3(var_3_2, var_4.EventUpdateShipOrder, arg_3_0.onUpdate)
	...
	var_3_5(var_3_4, var_4.EventUpdateBuff, arg_3_0.onUpdate)
	...
	var_3_7(var_3_6, var_4.EventUpdateDamageLevel, arg_3_0.onUpdate)
...
function var_0_1.LoadSpine(arg_5_0, arg_5_1)
	...
	SpineRole = var_1_10004

	local var_5_3 = var_1_10004.New(var_5_2)
...
function var_0_1.Update(arg_8_0, arg_8_1)
	...
	if arg_8_1 ~= nil then
		...
		if arg_8_1 == var_1_10003.EventUpdateLocation and not arg_8_0.isMoving then
			...
			var_1_10006 = arg_8_0.theme
			var_1_10003.anchoredPosition3D = var_4.GetLinePosition(var_1_10006, var_8_0.row, var_8_0.column)
		end
		...
		if arg_8_1 ~= nil then
			...
			if arg_8_1 == var_1_10003.EventUpdateLocation then
				...
				var_1_10003(var_8_1, var_1_10006.LOFleet, var_8_0.row)
			...
			if arg_8_1 ~= nil then
				...
				if arg_8_1 == var_1_10003.EventUpdateShipOrder then
					...
					var_1_10003(var_8_2, var_1_10006.ModelSpine, var_8_0:GetPrefab(), nil, true, function()
						local var_10_0 = arg_8_0.model
						local var_10_1 = var_0.SetParent
						local var_10_2 = arg_8_0.transform

						var_10_1(var_10_0, var_3.Find(var_10_2, "ship"), false)
...
function var_0_1.UpdateSubmarineSupport(arg_13_0)
	...
	var_1_10003(arg_13_0.rtSub, var_13_1)

	if var_13_1 then
		setGray = var_1_10003

		var_1_10003(arg_13_0.rtSub, not var_1:GetSubAidFlag(), false)
	end
...
function var_0_1.UpdateAttaches(arg_14_0)
	...
	for iter_14_0 = #var_1.GetBuffFxList(var_14_0) + 1, #arg_14_0.attaches do
		var_1_10009 = arg_14_0.attaches[iter_14_0]

		var_1_10006.Unload(var_1_10009)
	end
	...
	for iter_14_1 = #arg_14_0.attaches + 1, #var_1 do
		...
		WSMapEffect = var_1_10009
		var_1_10006 = var_1_10006(var_14_1, var_1_10009)
		createNewGameObject = var_1_10007
		var_1_10006.transform = var_1_10007("mapEffect")
		var_1_10009 = var_1_10006.transform

		var_1_10007.SetParent(var_1_10009, arg_14_0.rtFx, false)

		var_1_10006.modelOrder = arg_14_0.modelOrder
		table = var_1_10007

		var_1_10007.insert(arg_14_0.attaches, var_1_10006)
	end
	...
	for iter_14_2 = 1, #var_1 do
		...
		var_14_3(var_14_2, var_1_10010.GetBuffEffect(var_1[iter_14_2]))
		var_6:Load()
	end
...
function var_0_1.ClearAttaches(arg_15_0)
	...
	var_1_10002:ReturnArray(arg_15_0.attaches)
...
function var_0_1.UpdateDamageLevel(arg_17_0)
	...
	for iter_17_0 = var_17_1, #var_1_10003.DamageBuffList do
		setActive = var_1_10006

		local var_17_2 = arg_17_0.rtDamage

		var_1_10006(var_8.Find(var_17_2, iter_17_0), var_17_0 == iter_17_0)
	end
...
function var_0_1.PlusMoveTurn(arg_18_0)
	...
	var_1(var_3.Find(var_18_0, "Text"), arg_18_0.moveTurnCount)
