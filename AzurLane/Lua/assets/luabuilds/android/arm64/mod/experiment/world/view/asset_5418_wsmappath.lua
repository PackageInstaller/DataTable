...
function var_0_1.MoveStep(arg_7_0)
	...
	local var_7_6 = var_7_0.GetModelAngles(var_7_5)
	local var_7_7 = arg_7_0.dirType

	WorldConst = var_7_5

	if var_7_7 == var_7_5.DirType4 then
		if var_7_3.column < var_7_2.column then
			var_7_6.z = 180
		else
			local var_7_8 = var_7_3.column

			if var_7_2.column < var_7_8 then
				var_7_6.z = 0
			elseif var_7_3.row < var_7_2.row then
				var_7_6.z = 90
			else
				local var_7_9 = var_7_3.row

				if var_7_2.row < var_7_9 then
					var_7_6.z = 270
				end
			end
		end

		var_7_0:UpdateModelAngles(var_7_6)
	else
		local var_7_10 = arg_7_0.dirType

		WorldConst = var_8

		if var_7_10 == var_8.DirType2 then
	...
	var_7_11(var_7_3.duration, "without move duration")

	LeanTween = var_7_11

	local var_7_15 = var_7_11.value(var_7_0.transform.gameObject, 0, 1, var_7_3.duration)
	local var_7_16 = var_9.setOnUpdate

	System = var_12

	local var_7_17 = var_7_16(var_7_15, var_12.Action_float(function(arg_8_0)
		Vector3 = var_2_10001
	...
	System = var_12
	arg_7_0.twId = var_7_18(var_7_17, var_12.Action(function()
		...
		if arg_7_0.step >= #var_7_1 then
			...
			var_9_1(var_9_0, var_2_10003.ActionIdle)
...
function var_0_1.FlushPaused(arg_12_0)
	...
	if arg_12_0.paused then
		...
		var_12_1(var_12_0, var_1_10004.ActionIdle)
	else
		LeanTween = var_12_1
...
function var_0_1.CalcUpOffset(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_2 = var_13_0(var_13_1 * var_6.pi)

	math = var_1_10004

	local var_13_3 = var_1_10004.clamp(var_13_2, 0, 1) * arg_13_0.upOffset
