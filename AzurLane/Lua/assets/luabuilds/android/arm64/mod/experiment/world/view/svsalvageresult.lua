...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_3.Find(var_3_1, "info/Text")

	i18n = var_4

	var_1(var_3_2, var_4("world_catsearch_help_1"))

	setText = var_1

	local var_3_3 = arg_3_0.rtPanel
	local var_3_4 = var_3.Find(var_3_3, "info/items_btn/Text")

	i18n = var_4

	var_1(var_3_4, var_4("world_catsearch_help_2"))

	onButton = var_1

	local var_3_5 = arg_3_0
	local var_3_6 = arg_3_0.rtPanel
	local var_3_7 = var_4.Find(var_3_6, "info/items_btn")
	...
	local function var_3_8()
		...
		local var_4_2 = var_2_10003.ON_DROP_LIST
		local var_4_3 = {
			item2Row = true
		}
		...
		local var_4_4 = var_2_10005.map

		pg = var_2_10007
		var_4_3.itemList = var_4_4(var_2_10007.gameset.world_catsearchdrop_show.description, function(arg_5_0)
			return {
				type = arg_5_0[1],
				id = arg_5_0[2],
				count = arg_5_0[3]
		...
		i18n = var_5
		var_4_3.content = var_5("world_catsearch_help_6")
	...
	var_1(var_3_5, var_3_7, var_3_8, var_3_6)

	onButton = var_1

	local var_3_9 = arg_3_0
	local var_3_10 = arg_3_0._tf
	local var_3_11 = var_4.Find(var_3_10, "bg")
	...
	var_1(var_3_14, var_3_15, var_3_16, var_3_10)
	...
	var_1(var_3_18, var_3_19, var_3_20, var_3_10)
	...
	local function var_3_24()
		...
		local var_9_3 = var_2_10003.SceneOp
		local var_9_4 = "OpOpenLayer"

		Context = var_2_10005

		local var_9_5 = var_2_10005.New
		local var_9_6 = {}

		WorldHelpMediator = var_2_10008
		var_9_6.mediator = var_2_10008
		WorldHelpLayer = var_2_10008
		var_9_6.viewComponent = var_2_10008
		var_9_6.data = {
			titleId = 3,
			pageId = 10
		}
	...
	var_1(var_3_22, var_3_23, var_3_24, var_3_10)
	...
	local function var_3_28()
		...
		var_10_2(var_10_1, var_2_10003.SceneOp, "OpReqCatSalvage", arg_3_0.fleetId)

		return
	end

	SFX_CONFIRM = var_3_10

	var_1(var_3_26, var_3_27, var_3_28, var_3_10)
