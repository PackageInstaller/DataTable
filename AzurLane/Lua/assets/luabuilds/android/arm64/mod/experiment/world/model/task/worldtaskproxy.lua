...
function var_0_1.Setup(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_1_10002(arg_2_1) do
		...
		if var_2_1 == var_9.STATE_RECEIVED then
...
function var_0_1.updateTask(arg_11_0, arg_11_1)
	...
	local var_11_0 = arg_11_1:getState()

	WorldTask = var_3

	if var_11_0 == var_3.STATE_RECEIVED then
...
function var_0_1.getAutoSubmitTaskVO(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10001(arg_15_0:getTasks()) do
		if iter_15_1:IsAutoSubmit() then
			local var_15_0 = iter_15_1:getState()

			WorldTask = var_1_10007

			if var_15_0 == var_1_10007.STATE_FINISHED then
				return iter_15_1
			end
		end
	end
				...
				var_1.Send(var_20_0, 5, {
					...
					if arg_21_0.result == 0 then
						...
						if arg_19_0.dailyTimer then
							local var_21_2 = arg_19_0.dailyTimer
						...
						local var_21_3 = var_2.New

						function var_3_10004()
						...
						local var_21_5 = var_3_10006.TimeMgr.GetInstance()

						var_21_0.dailyTimer = var_21_3(var_3_10004, var_21_4 - var_6.GetServerTime(var_21_5) + 1)
						...
						var_21_0(var_21_6, var_3_10004.rest(arg_21_0.task_list, 1))
					else
						pg = var_21_0
						...
						var_21_8(var_21_7, var_3_10004("", arg_21_0.result))
					end
