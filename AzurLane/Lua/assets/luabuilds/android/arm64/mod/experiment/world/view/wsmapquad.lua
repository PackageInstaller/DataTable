...
function var_0_1.Setup(arg_3_0, arg_3_1, arg_3_2)
	...
	var_3_3(var_3_2, var_6.EventAddAttachment, arg_3_0.onAddAttachment)
	...
	var_3_5(var_3_4, var_6.EventRemoveAttachment, arg_3_0.onRemoveAttachment)
	...
	var_3_7(var_3_6, var_6.EventUpdateFog, arg_3_0.onUpdate)
...
function var_0_1.Dispose(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10004.EventUpdateInFov, arg_5_0.onUpdate)
	...
	var_5_3(var_5_2, var_4.EventAddAttachment, arg_5_0.onAddAttachment)
	...
	var_5_5(var_5_4, var_4.EventRemoveAttachment, arg_5_0.onRemoveAttachment)
	...
	var_5_7(var_5_6, var_4.EventUpdateFog, arg_5_0.onUpdate)
...
function var_0_1.Init(arg_7_0)
	...
	var_7_5(var_7_4, var_6.GetSiblingIndex(var_7_6))
	...
	var_7_5(var_7_7, var_6.QuadSpriteWhite, arg_7_0.rtWalkQuad)
	arg_7_0:Update()
...
function var_0_1.OnAddAttachment(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	var_9_1(var_9_0, var_1_10007.EventUpdateFlag, arg_9_0.onUpdateAttachment)
	...
	var_9_3(var_9_2, var_7.EventUpdateData, arg_9_0.onUpdateAttachment)
	...
	var_9_5(var_9_4, var_7.EventUpdateLurk, arg_9_0.onUpdateAttachment)
...
function var_0_1.OnRemoveAttachment(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	var_10_1(var_10_0, var_1_10007.EventUpdateFlag, arg_10_0.onUpdateAttachment)
	...
	var_10_3(var_10_2, var_7.EventUpdateData, arg_10_0.onUpdateAttachment)
	...
	var_10_5(var_10_4, var_7.EventUpdateLurk, arg_10_0.onUpdateAttachment)
...
function var_0_1.OnUpdateAttachment(arg_12_0)
	...
	if var_2.GetInFOV(var_12_2) and not arg_12_0.static and var_12_1 then
		...
		if not var_12_4.InFog(var_12_3) then
			...
			var_1_10005(var_12_7, var_8.one)
			...
			local var_12_11 = var_12_10(var_12_9, var_8.easeInOutSine)
...
function var_0_1.UpdateScannerQuad(arg_13_0)
	...
	if var_1.GetInFOV(var_13_0) then
		...
		if var_13_2.GetScannerAttachment(var_13_1) then
			...
			var_1_10002(arg_13_0.rtQuad, 1)

			GetImageSpriteFromAtlasAsync = var_1_10002

			var_1_10002("world/cell/base", var_13_2, arg_13_0.rtQuad)
