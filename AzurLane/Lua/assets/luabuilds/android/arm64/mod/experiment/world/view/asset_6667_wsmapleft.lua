...
function var_0_1.Dispose(arg_2_0)
	local function var_2_0(arg_3_0)
		...
		var_3_1(var_3(arg_3_0:Find("text")))
...
function var_0_1.Init(arg_6_0)
	...
	for iter_6_0 = 0, arg_6_0.toggleList.childCount - 1 do
		...
		var_1_10006(var_6_8, var_9.GetChild(var_6_9, iter_6_0))
	end
	...
	var_2(var_6_14, var_6_15, var_6_16, var_1_10007)
	...
	var_2(var_6_17, var_6_18, var_6_19, var_1_10007)
...
function var_0_1.AddWorldListener(arg_11_0)
	...
	local var_11_1 = var_1_10003()

	var_11_0(var_3.GetNormalFleets(var_11_1), function(arg_12_0)
		local var_12_0 = arg_12_0
		local var_12_1 = arg_12_0.AddListener

		WorldMapFleet = var_2_10004

		var_12_1(var_12_0, var_2_10004.EventUpdateCatSalvage, arg_11_0.onUpdateCatSalvage)
...
function var_0_1.RemoveWorldListener(arg_13_0)
	...
	local var_13_1 = var_1_10003()

	var_13_0(var_3.GetNormalFleets(var_13_1), function(arg_14_0)
		local var_14_0 = arg_14_0
		local var_14_1 = arg_14_0.RemoveListener

		WorldMapFleet = var_2_10004

		var_14_1(var_14_0, var_2_10004.EventUpdateCatSalvage, arg_13_0.onUpdateCatSalvage)
...
function var_0_1.AddMapListener(arg_16_0)
	if arg_16_0.map then
		...
		var_16_1(var_16_0, var_1_10004.EventUpdateFIndex, arg_16_0.onUpdateSelectedFleet)
	end
...
function var_0_1.RemoveMapListener(arg_17_0)
	if arg_17_0.map then
		...
		var_17_1(var_17_0, var_1_10004.EventUpdateFIndex, arg_17_0.onUpdateSelectedFleet)
	end
...
function var_0_1.AddFleetListener(arg_18_0, arg_18_1)
	if arg_18_1 then
		...
		var_18_1(var_18_0, var_1_10005.EventUpdateShipOrder, arg_18_0.onUpdateFleetOrder)
		...
		var_18_3(var_18_2, var_5.EventUpdateBuff, arg_18_0.onUpdateFleetBar)
		...
		var_18_3.each(arg_18_1:GetShips(true), function(arg_19_0)
			...
			var_19_1(var_19_0, var_2_10004.EventHpRantChange, arg_18_0.onUpdateShipHpRate)
			...
			var_19_3(var_19_2, var_4.EventUpdateBroken, arg_18_0.onUpdateShipBroken)
...
function var_0_1.RemoveFleetListener(arg_20_0, arg_20_1)
	if arg_20_1 then
		...
		var_20_1(var_20_0, var_1_10005.EventUpdateShipOrder, arg_20_0.onUpdateFleetOrder)
		...
		var_20_3(var_20_2, var_5.EventUpdateBuff, arg_20_0.onUpdateFleetBar)
		...
		var_20_3.each(arg_20_1:GetShips(true), function(arg_21_0)
			...
			var_21_1(var_21_0, var_2_10004.EventHpRantChange, arg_20_0.onUpdateShipHpRate)
			...
			var_21_3(var_21_2, var_4.EventUpdateBroken, arg_20_0.onUpdateShipBroken)
...
function var_0_1.OnUpdateSelectedFleet(arg_22_0)
	...
	if arg_22_0.fleet ~= var_22_1 then
		...
		local var_22_6 = var_6.GetTeamShips

		TeamType = var_1_10009

		var_22_3(var_22_2, var_22_4, var_22_6(var_22_5, var_1_10009.Main, true))
		...
		local var_22_11 = var_6.GetTeamShips

		TeamType = var_9

		var_22_8(var_22_7, var_22_9, var_22_11(var_22_10, var_9.Vanguard, true))

		setImageSprite = var_22_8

		local var_22_12 = arg_22_0.rtFleetBar
		local var_22_13 = var_4.Find(var_22_12, "text_selected/x")

		getImageSprite = var_22_9

		local var_22_14 = arg_22_0.toggles[var_22_1.index]

		var_22_8(var_22_13, var_22_9(var_7.Find(var_22_14, "text_selected/x")))
...
function var_0_1.UpdateAllCatSalvage(arg_23_0)
	...
	for iter_23_1 = #var_23_1 + 1, arg_23_0.rtSalvageList.childCount do
		...
		var_1_10007(var_9.GetChild(var_23_4, iter_23_1 - 1), false)
	end
...
function var_0_1.OnUpdateCatSalvage(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_1 = arg_25_2.IsCatSalvage(var_25_0)
	local var_25_2 = arg_25_0.rtSalvageList
	local var_25_3 = var_4.GetChild(var_25_2, arg_25_2.index - 1)

	setActive = var_25_0

	var_25_0(var_25_3, var_25_1)

	if var_25_1 then
		local var_25_4 = arg_25_2
		local var_25_5 = arg_25_2.GetDisplayCommander(var_25_4)
		local var_25_6 = var_25_0.getPainting(var_25_5)

		GetImageSpriteFromAtlasAsync = var_25_4

		var_25_4("commandericon/" .. var_25_6, "", var_25_3:Find("icon"))

		setActive = var_25_4

		local var_25_7 = var_25_3:Find("rarity")

		var_1_10010 = arg_25_2:GetRarityState() > 0

		var_25_4(var_25_7, var_1_10010)

		setActive = var_25_4

		local var_25_8 = var_25_3:Find("doing")

		var_1_10010 = arg_25_2.catSalvageStep < #arg_25_2.catSalvageList

		var_25_4(var_25_8, var_1_10010)

		setSlider = var_25_4

		var_25_4(var_25_3:Find("doing/Slider"), 0, #arg_25_2.catSalvageList, arg_25_2.catSalvageStep)

		setActive = var_25_4

		local var_25_9 = var_25_3:Find("finish")

		var_1_10010 = arg_25_2.catSalvageStep == #arg_25_2.catSalvageList

		var_25_4(var_25_9, var_1_10010)
	end

	onButton = var_25_0

	local var_25_10 = arg_25_0
	local var_25_11 = var_25_3
	...
	var_25_0(var_25_10, var_25_11, var_25_12, var_1_10010)
...
function var_0_1.OnUpdateSubmarineSupport(arg_27_0)
	...
	var_1_10002(arg_27_0.rtSubBar, var_27_0:IsSubmarineSupporting())

	if var_27_0:GetSubmarineFleet() then
		local var_27_1 = var_2
		local var_27_2, var_27_3 = var_2.GetAmmo(var_27_1)

		setText = var_27_1

		var_27_1(arg_27_0.rtAmmo, var_27_2 .. "/" .. var_27_3)

		setGray = var_27_1

		var_27_1(arg_27_0.rtSubBar, var_2:GetAmmo() <= 0, true)
	end
...
function var_0_1.OnUpdateFleetOrder(arg_28_0)
	...
	local var_28_4 = var_5.GetTeamShips

	TeamType = var_1_10008

	var_28_1(var_28_0, var_28_2, var_28_4(var_28_3, var_1_10008.Main, true))
	...
	local var_28_9 = var_5.GetTeamShips

	TeamType = var_8

	var_28_6(var_28_5, var_28_7, var_28_9(var_28_8, var_8.Vanguard, true))
...
function var_0_1.GetShipObject(arg_29_0, arg_29_1)
	...
	for iter_29_0, iter_29_1 in var_3(var_29_0) do
		...
		for iter_29_2, iter_29_3 in var_1_10009(var_29_2) do
...
function var_0_1.OnUpdateShipHpRate(arg_30_0, arg_30_1, arg_30_2)
	...
	var_1_10004(var_30_0, "can not find this ship in display fleet: " .. arg_30_2.id)

	table = var_1_10004

	var_1_10004.insert(arg_30_0.delayCallFuncs[arg_30_2.id], function()
		local var_31_0 = arg_30_0

		var_0.ShipDamageDisplay(var_31_0, arg_30_2, var_30_0, true)
...
function var_0_1.OnUpdateShipBroken(arg_32_0, arg_32_1, arg_32_2)
	...
	var_1_10004(var_32_0:Find("broken"), arg_32_2:IsBroken())
...
function var_0_1.OnUpdateFleetBar(arg_33_0, arg_33_1, arg_33_2)
	...
	local var_33_1 = arg_33_0.rtFleetBar

	var_1_10004(var_6.Find(var_33_1, "watching_buff"), var_33_0)

	if var_33_0 then
		if #var_33_0.config.icon > 0 then
			GetImageSpriteFromAtlasAsync = var_4

			local var_33_2 = "world/watchingbuff/" .. var_33_0.config.icon
			local var_33_3 = ""
			local var_33_4 = arg_33_0.rtFleetBar

			var_4(var_33_2, var_33_3, var_8.Find(var_33_4, "watching_buff"))
		else
			setImageSprite = var_4

			local var_33_5 = arg_33_0.rtFleetBar

			var_4(var_6.Find(var_33_5, "watching_buff"), nil)
		end
	end
...
function var_0_1.UpdateShipList(arg_34_0, arg_34_1, arg_34_2)
	...
	var_3.make(var_34_0, function(arg_35_0, arg_35_1, arg_35_2)
		...
		if arg_35_0 == var_2_10003.EventUpdate then
			...
			var_4(var_35_1, var_2_10007.FetchShipVO(var_35_0.id))

			onButton = var_4

			local var_35_2 = arg_34_0
			local var_35_3 = arg_35_2
			local var_35_4 = arg_35_2.Find(var_35_3, "agony")
			...
			var_4(var_35_2, var_35_4, var_35_5, var_35_3)

			arg_34_0.delayCallFuncs[var_35_0.id] = {}

			local var_35_6 = arg_34_0

			var_4.ShipDamageDisplay(var_35_6, var_35_0, arg_35_2)

			GetOrAddComponent = var_4

			local var_35_7 = var_4(arg_35_2, "UILongPressTrigger").onLongPressed

			pg = var_5

			var_5.DelegateInfo.Add(arg_34_0, var_35_7)
			var_35_7:RemoveAllListeners()
			var_35_7:AddListener(function()
...
function var_0_1.ShipDamageDisplay(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	var_1_10005(var_38_0, true)

	setActive = var_1_10005

	var_1_10005(var_38_0:Find("heal"), false)

	setActive = var_1_10005

	local var_38_1 = var_38_0

	var_1_10005(var_38_0.Find(var_38_1, "normal"), false)

	local var_38_2 = arg_38_2
	local var_38_3 = arg_38_2.Find(var_38_2, "blood")

	if arg_38_3 then
		local var_38_4 = var_38_3
		local var_38_5 = var_38_3.GetComponent

		typeof = var_38_1
		Slider = var_1_10011

		local var_38_6 = var_38_5(var_38_4, var_38_1(var_1_10011)).value

		WorldConst = var_38_2

		local var_38_7 = var_38_2.FetchShipVO(arg_38_1.id)
		local var_38_8 = var_7.getShipProperties(var_38_7)

		calcFloor = var_38_4

		local var_38_9 = (arg_38_1.hpRant - var_38_6) / 16

		AttributeType = var_1_10011

		local var_38_10 = var_38_4(var_38_9 * var_38_8[var_1_10011.Durability])

		local function var_38_11(arg_39_0, arg_39_1)
			...
			var_2_10002(var_4(arg_39_0, "text"), arg_39_1)

			setTextAlpha = var_2_10002
			findTF = var_4

			var_2_10002(var_4(arg_39_0, "text"), 0)
			...
			var_39_0({
				function(arg_40_0)
					...
					var_40_1(var_40_0, var_4.Action(arg_40_0))
				...
				function(arg_41_0)
					...
					local var_41_1 = var_41_0(var_3_10003(arg_39_0, "text"), 1, 0.3)
					local var_41_2 = var_1.setOnComplete

					System = var_4

					var_41_2(var_41_1, var_4.Action(function()
						...
						local var_42_1 = var_42_0(var_4_10002(arg_39_0, "text"), 0, 0.5)
						local var_42_2 = var_0.setDelay(var_42_1, 0.4)
						local var_42_3 = var_0.setOnComplete

						System = var_3

						var_42_3(var_42_2, var_3.Action(arg_41_0))
		...
		local function var_38_12(arg_44_0)
			...
			local var_44_3 = var_44_2(var_44_1, var_5.easeInOutSine)
			...
			local var_44_6 = var_44_5(var_4(arg_44_0, "red"), 0, 0.4)
		...
		if var_38_10 > 0 then
			...
			var_38_13(var_1_10013(var_38_0, "heal"), var_38_10)
		elseif var_38_10 < 0 then
			var_38_12(arg_38_2)
			...
			var_38_14(var_13(var_38_0, "normal"), var_38_10)
		end
	end

	local var_38_15 = var_38_3:Find("fillarea/green")
	local var_38_16 = var_38_3
	local var_38_17 = var_38_3.Find(var_38_16, "fillarea/red")
	local var_38_18 = not arg_38_1:IsHpSafe()

	setActive = var_38_16

	var_38_16(var_38_15, not var_38_18)

	setActive = var_38_16

	var_38_16(var_38_17, var_38_18)

	local var_38_19 = var_38_3
	local var_38_20 = var_38_3.GetComponent

	typeof = var_12
	Slider = var_1_10014

	local var_38_21 = var_38_20(var_38_19, var_12(var_1_10014))

	var_38_21.fillRect = var_38_18 and var_38_17 or var_38_15
	setSlider = var_38_21

	var_38_21(var_38_3, 0, 10000, arg_38_1.hpRant)

	local var_38_22 = arg_38_2
	local var_38_23 = arg_38_2.Find(var_38_22, "agony")

	setActive = var_10

	var_10(var_38_23, var_38_18)

	local var_38_24 = arg_38_2:Find("broken")

	setActive = var_38_22

	var_38_22(var_38_24, arg_38_1:IsBroken())
...
function var_0_1.ShowToggleMask(arg_45_0, arg_45_1)
	...
	for iter_45_0, iter_45_1 in var_1_10004(arg_45_0.toggles) do
		...
		if var_45_4 then
			...
			local var_45_5 = var_45_4:GetWatchingBuff()

			setActive = var_12

			var_12(iter_45_1:Find("selected"), var_1_10010)

			setActive = var_12

			var_12(iter_45_1:Find("text"), not var_1_10010)

			setActive = var_12

			var_12(iter_45_1:Find("text_selected"), var_1_10010)

			setActive = var_12

			var_12(iter_45_1:Find("watching_buff"), var_45_5)

			if var_45_5 then
				if #var_45_5.config.icon > 0 then
					GetImageSpriteFromAtlasAsync = var_12

					var_12("world/watchingbuff/" .. var_45_5.config.icon, "", iter_45_1:Find("watching_buff"))
				else
					setImageSprite = var_12

					var_12(iter_45_1:Find("watching_buff"), nil)
				end
			end
			...
			var_12(var_45_6, var_45_7, var_45_8, var_17)
		end
	end
...
function var_0_1.Collpase(arg_48_0)
	...
	var_1_10001(var_48_0, not var_1_10004(arg_48_0.rtFleet))
