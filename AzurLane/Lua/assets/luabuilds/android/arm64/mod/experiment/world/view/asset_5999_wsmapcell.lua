...
function var_0_1.Setup(arg_3_0, arg_3_1, arg_3_2)
	...
	var_3_1(var_3_0, var_1_10006.EventUpdateInFov, arg_3_0.onUpdate)
	...
	var_3_3(var_3_2, var_6.EventUpdateDiscovered, arg_3_0.onUpdate)
	...
	var_3_5(var_3_4, var_6.EventUpdateFog, arg_3_0.onUpdate)
	...
	var_3_7(var_3_6, var_6.EventUpdateFogImage, arg_3_0.onUpdateFogImage)
	arg_3_0:Init()
...
function var_0_1.Dispose(arg_4_0)
	...
	var_1(var_3.Find(var_4_4, "dark_fog"))

	clearImageSprite = var_1

	local var_4_5 = arg_4_0.rtFog

	var_1(var_3.Find(var_4_5, "sairen_fog"))
	...
	var_4_7(var_4_6, var_4.EventUpdateInFov, arg_4_0.onUpdate)
	...
	var_4_9(var_4_8, var_4.EventUpdateDiscovered, arg_4_0.onUpdate)
	...
	var_4_11(var_4_10, var_4.EventUpdateFog, arg_4_0.onUpdate)
	...
	var_4_13(var_4_12, var_4.EventUpdateFogImage, arg_4_0.onUpdateFogImage)
	arg_4_0:Clear()
...
local function var_0_2(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	var_4(var_5_1, var_7(arg_5_1), true)
...
function var_0_1.Init(arg_6_0)
	...
	local var_6_3 = arg_6_0.rtAttachments

	Vector3 = var_1_10005
	var_6_3.localEulerAngles = var_1_10005(-var_6_0.angle, 0, 0)

	local var_6_4 = var_6_2

	arg_6_0.rtMask = var_6_2.Find(var_6_4, "mask")
	...
	local var_6_7 = var_8.LineCross * 2

	WorldConst = var_9
	var_6_5.sizeDelta = var_6_6 + var_6_4(var_6_7, var_9.LineCross * 2)
	...
	local var_6_11 = var_8.Find(var_6_10, "dark_fog")
	local var_6_12 = arg_6_0.wsMapResource.rtDarkFog
	local var_6_13 = var_9.Find

	WorldConst = var_1_10012

	var_6_9(var_6_11, var_6_13(var_6_12, var_1_10012.Pos2FogRes(var_6_1.row, var_6_1.column)), var_6_1, var_6_8)

	local var_6_14 = var_0_2
	local var_6_15 = arg_6_0.rtFog
	local var_6_16 = var_8.Find(var_6_15, "sairen_fog")
	local var_6_17 = arg_6_0.wsMapResource.rtSairenFog
	local var_6_18 = var_9.Find

	WorldConst = var_12

	var_6_14(var_6_16, var_6_18(var_6_17, var_12.Pos2FogRes(var_6_1.row, var_6_1.column)), var_6_1, var_6_8)
	arg_6_0:Update()
				...
				if arg_7_1 == var_1_10007.EventUpdateFog then
					...
					if var_7_0:InFog() then
						if arg_7_1 and 0 < var_7_3 then
							...
							arg_7_0.fogTimer = var_1_10007.AddInMapTimer(var_7_9, function()
								...
								var_8_0.fogUid = var_8_1(var_2_10003(var_8_2, var_2_10006(var_2_10008)), 1, var_7_4).uniqueId
					...
					elseif arg_7_1 and 0 < var_7_3 then
						...
						arg_7_0.fogTimer = var_1_10007.AddInMapTimer(var_7_11, function()
							...
							typeof = var_2_10006
							CanvasGroup = var_2_10008
							var_9_0.fogUid = var_9_1(var_2_10003(var_9_2, var_2_10006(var_2_10008)), 0, var_7_4).uniqueId
				...
				if arg_7_1 ~= nil then
					...
					if arg_7_1 ~= var_1_10007.EventUpdateInFov then
						...
						if arg_7_1 == var_7.EventUpdateDiscovered then
							...
							if var_7_0:GetInFOV() then
								if arg_7_1 and 0 < var_7_3 then
									local var_7_15 = arg_7_0.wsTimer
									...
									local var_7_16 = arg_7_0.maskTimer

									var_7.Start(var_7_16)
								else
									setImageAlpha = var_7
								...
								local var_7_17 = var_7_0.discovered and 0.3 or 0.8

								if arg_7_1 and 0 < var_7_3 then
									local var_7_18 = arg_7_0.wsTimer

									arg_7_0.maskTimer = var_1_10008.AddInMapTimer(var_7_18, function()
										local var_11_0 = arg_7_0

										LeanTween = var_2_10001
										var_11_0.maskUid = var_2_10001.alpha(arg_7_0.rtMask, var_7_17, var_7_4).uniqueId
									...
									local var_7_19 = arg_7_0.maskTimer

									var_1_10008.Start(var_7_19)
								else
									setImageAlpha = var_1_10008

									var_1_10008(arg_7_0.rtMask, var_7_17)
								end
							end
						end
...
function var_0_1.UpdateFogImage(arg_12_0)
	...
	var_1_10003(var_5.Find(var_12_2, "dark_fog"), var_12_1 and 0 or 1)

	setImageAlpha = var_1_10003

	local var_12_3 = arg_12_0.rtFog

	var_1_10003(var_5.Find(var_12_3, "sairen_fog"), var_12_1 and 1 or 0)
