...
local var_0_1 = pg.Packer

pg.Packer.ps = nil

function pg.Packer.Ctor(arg_1_0)
	arg_1_0._protocols = {}
...
function pg.Packer.Pack(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
...
function pg.Packer.Unpack(arg_3_0, arg_3_1, arg_3_2)
...
function pg.Packer.GetProtocolWithName(arg_4_0, arg_4_1)
	...
	if nil then
		local var_4_4 = var_0_0.Protocol.New(var_4_0, arg_4_1, package.loaded["p" .. string.sub(var_4_0, 1, 2) .. "_pb"])
