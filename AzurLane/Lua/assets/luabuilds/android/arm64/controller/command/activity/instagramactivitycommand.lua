...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_0.INSTAGRAM_OP_ACTIVE == var_1_1.cmd then
		pg = var_4
		...
		var_4.Send(var_1_3, 11701, {
			...
			if arg_2_0.result == 0 then
				...
				var_2.UpdateMessage(var_2_10004, var_2_0)

				var_2_10004 = var_1_2

				var_2.AddInstagramTimer(var_2_10004)
				...
				var_2_1(var_2_10004, var_5.ACT_INSTAGRAM_OP_DONE, {
					cmd = var_1_1.cmd,
					id = var_1_1.arg1
				})
					...
					var_4.Send(var_1_4, 11701, {
						...
						if arg_3_0.result == 0 then
							...
							if var_3_0.INSTAGRAM_OP_MARK_READ == var_1_1.cmd then
								...
								InstagramConst = var_3

								if var_3_1 == var_3.INSTAGRAM_TYPE.OFFICIAL_ACCOUNT then
									var_2_10004 = var_1_2
									var_3_0 = var_2.GetOfficialAccounts(var_2_10004)[var_1_1.arg1]
								else
									var_2_10004 = var_1_2
									var_3_0 = var_2.GetMessageById(var_2_10004, var_1_1.arg1)
								end

								var_3_0.isRead = true
								var_2_10004 = var_1_2

								var_2.UpdateMessage(var_2_10004, var_3_0)
							else
								ActivityConst = var_3_0
							...
							var_3_0(var_3_2, var_2_10004.ACT_INSTAGRAM_OP_DONE, {
								cmd = var_1_1.cmd,
								id = var_1_1.arg1
							})
					...
					if var_4.INSTAGRAM_OP_COMMENT == var_1_1.cmd then
						...
						var_4.Send(var_1_5, 11703, {
							...
							if arg_4_0.result == 0 then
								...
								var_2.UpdateMessage(var_2_10004, var_4_0)
								...
								var_4_1(var_2_10004, var_5.ACT_INSTAGRAM_OP_DONE, {
									cmd = var_1_1.cmd,
									id = var_1_1.arg1
								})
