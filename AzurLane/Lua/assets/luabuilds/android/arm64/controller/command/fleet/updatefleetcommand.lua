...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_10005(var_1_10007(var_1_2, var_1_10010), "should be an instance of Fleet")

	getProxy = var_1_10005
	PlayerProxy = var_7

	local var_1_3 = var_1_10005(var_7)
	...
	var_1_4.each(var_1_0.vanguardShips, function(arg_2_0)
	...
	var_9.Send(var_1_6, 12102, {
		...
		if arg_5_0.result == 0 then
			...
			var_5_0(var_5_3, var_2_10004.UPDATE_FLEET_DONE, var_1_0.id)
		else
			pg = var_5_0
			...
			var_5_5(var_5_4, var_2_10004("fleet_updateFleet", arg_5_0.result))
		end
