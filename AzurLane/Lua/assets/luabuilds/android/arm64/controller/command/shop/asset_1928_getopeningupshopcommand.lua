...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	arg_1_0.shopsProxy = var_1_0(var_1_10006)
	arg_1_0.shopList = {}
	parallelAsync = var_4
...
function var_0_1.GetMilitaryShop(arg_13_0, arg_13_1)
	...
	if not var_3.getMeritorousShop(var_13_1) then
		...
		var_1_10004.insert(var_13_0, function(arg_14_0)
			local var_14_0 = arg_13_0
			local var_14_1 = var_1.sendNotification

			GAME = var_2_10004

			var_14_1(var_14_0, var_2_10004.GET_MILITARY_SHOP, {
				callback = arg_14_0
			})
		...
		var_1_10004.insert(var_13_0, function(arg_15_0)
			arg_15_0(var_0)
	...
	var_1_10004.insert(var_13_0, function(arg_16_0, arg_16_1)
		...
		ShopConst = var_2_10005

		var_16_1(var_16_2[var_2_10005.TYPE_MILITARY_SHOP], arg_16_1)
		arg_16_0()
...
function var_0_1.GetStressShop(arg_17_0, arg_17_1)
	...
	if not var_3.getShopStreet(var_17_1) then
		...
		var_1_10004.insert(var_17_0, function(arg_18_0)
			local var_18_0 = arg_17_0
			local var_18_1 = var_1.sendNotification

			GAME = var_2_10004

			var_18_1(var_18_0, var_2_10004.GET_SHOPSTREET, {
				callback = arg_18_0
			})
		...
		var_1_10004.insert(var_17_0, function(arg_19_0)
			arg_19_0(var_0)
	...
	var_1_10004.insert(var_17_0, function(arg_20_0, arg_20_1)
		...
		var_20_1(var_20_2[var_2_10005.TYPE_SHOP_STREET], arg_20_1)
		arg_20_0()
...
function var_0_1.GetGuildShop(arg_21_0, arg_21_1)
	...
	if not var_3.getGuildShop(var_21_1) then
		...
		var_1_10004.insert(var_21_0, function(arg_22_0)
			local var_22_0 = arg_21_0
			local var_22_1 = var_1.sendNotification

			GAME = var_2_10004

			local var_22_2 = var_2_10004.GET_GUILD_SHOP
			local var_22_3 = {}

			GuildConst = var_2_10006
			var_22_3.type = var_2_10006.GET_SHOP
		...
		var_1_10004.insert(var_21_0, function(arg_23_0)
			arg_23_0(var_0)
	...
	var_1_10004.insert(var_21_0, function(arg_24_0, arg_24_1)
		...
		var_24_1(var_24_2[var_2_10005.TYPE_GUILD], arg_24_1)
		arg_24_0()
...
function var_0_1.GetShamShop(arg_25_0, arg_25_1)
	...
	LOCK_SHAM_CHAPTER = var_1_10004

	if not var_1_10004 and var_25_2 and var_25_2:isOpen() then
		table = var_1_10004

		var_1_10004.insert(var_25_0, function(arg_26_0)
			...
			ShopConst = var_2_10004

			var_26_1(var_26_2[var_2_10004.TYPE_SHAM_SHOP], var_25_2)
			arg_26_0()
...
function var_0_1.GetFragmentShop(arg_27_0, arg_27_1)
	...
	LOCK_FRAGMENT_SHOP = var_1_10004

	if not var_1_10004 and var_27_2 and var_27_2:isOpen() then
		table = var_1_10004

		var_1_10004.insert(var_27_0, function(arg_28_0)
			...
			var_28_1(var_28_2[var_2_10004.TYPE_FRAGMENT], var_27_2)
			arg_28_0()
...
function var_0_1.GetActivityShops(arg_29_0, arg_29_1)
	...
	if not var_3.getActivityShops(var_29_1) or #var_3 == 0 then
		...
		var_1_10004.insert(var_29_0, function(arg_30_0)
			...
			var_30_1(var_30_0, var_2_10004.GET_ACTIVITY_SHOP, {
				callback = arg_30_0
			})
		...
		var_1_10004.insert(var_29_0, function(arg_31_0)
			arg_31_0(var_0)
	...
	var_1_10004.insert(var_29_0, function(arg_32_0, arg_32_1)
		if arg_32_1 then
			table = var_2_10002
			...
			if 0 < var_32_0 then
				...
				for iter_32_0, iter_32_1 in var_32_1(arg_32_1) do
					...
					ShopConst = var_2_10010

					var_2_10007(var_32_2[var_2_10010.TYPE_ACTIVITY], iter_32_1)
				end

				getProxy = var_2
				ActivityProxy = var_4

				local var_32_3 = var_2(var_4)
				local var_32_4 = var_2.getRawData(var_32_3)

				table = var_3

				local var_32_5 = var_3.sort
				local var_32_6 = arg_29_0.shopList

				ShopConst = iter_32_1

				local var_32_7 = var_32_6[iter_32_1.TYPE_ACTIVITY]

				CompareFuncs = var_6

				var_32_5(var_32_7, var_6({
					function(arg_33_0)
...
function var_0_1.GetMetaShops(arg_34_0, arg_34_1)
	...
	if not var_3.GetMetaShop(var_34_1) then
		...
		var_1_10004.insert(var_34_0, function(arg_35_0)
			...
			local var_35_2 = var_35_1(var_35_0, var_2_10004.ACTIVITY_TYPE_SHOP_SELECTABLE)

			ipairs = var_2_10002

			for iter_35_0, iter_35_1 in var_2_10002(var_35_2) do
			...
			var_35_5(var_4.GetMetaShop(var_35_6))
		...
		var_1_10004.insert(var_34_0, function(arg_36_0)
			arg_36_0(var_0)
	...
	var_1_10004.insert(var_34_0, function(arg_37_0, arg_37_1)
		if arg_37_1 then
			...
			var_37_1(var_37_2[var_2_10005.TYPE_META], arg_37_1)
		end
...
function var_0_1.GetMedalShops(arg_38_0, arg_38_1)
	...
	if not var_3.GetMedalShop(var_38_1) then
		...
		var_1_10004.insert(var_38_0, function(arg_39_0)
			local var_39_0 = arg_38_0
			local var_39_1 = var_1.sendNotification

			GAME = var_2_10004

			var_39_1(var_39_0, var_2_10004.GET_MEDALSHOP, {
				callback = arg_39_0
			})
		...
		var_1_10004.insert(var_38_0, function(arg_40_0)
			arg_40_0(var_0)
	...
	var_1_10004.insert(var_38_0, function(arg_41_0, arg_41_1)
		if arg_41_1 then
			...
			var_41_1(var_41_2[var_2_10005.TYPE_MEDAL], arg_41_1)
		end
...
function var_0_1.GetMiniShops(arg_42_0, arg_42_1)
	...
	if not var_3.getMiniShop(var_42_1) then
		...
		var_1_10004.insert(var_42_0, function(arg_43_0)
			local var_43_0 = arg_42_0
			local var_43_1 = var_1.sendNotification

			GAME = var_2_10004

			var_43_1(var_43_0, var_2_10004.GET_MINI_GAME_SHOP, {
				callback = arg_43_0
			})
		...
		var_1_10004.insert(var_42_0, function(arg_44_0)
			...
			if var_1.checkShopFlash(var_44_0) then
				...
				var_44_2(var_44_1, var_2_10004.MINI_GAME_SHOP_FLUSH, {
					callback = arg_44_0
				})
			else
				arg_44_0(var_0)
	...
	var_1_10004.insert(var_42_0, function(arg_45_0, arg_45_1)
		...
		var_45_1(var_45_2[var_2_10005.TYPE_MINI_GAME], arg_45_1)
		arg_45_0()
...
function var_0_1.GetQuotaShop(arg_46_0, arg_46_1)
	...
	if not var_3.getQuotaShop(var_46_1) then
		QuotaShop = var_1_10004
		var_46_2 = var_1_10004.New()

		local var_46_3 = arg_46_0.shopsProxy

		var_1_10004.setQuotaShop(var_46_3, var_46_2)
	else
		table = var_1_10004

		var_1_10004.insert(var_46_0, function(arg_47_0)
			arg_47_0(var_46_2)
	...
	var_1_10004.insert(var_46_0, function(arg_48_0)
		...
		var_48_1(var_48_2[var_2_10004.TYPE_QUOTA], var_46_2)
		arg_48_0()
