...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_1 = arg_1_1.getBody(var_1_0).operation

	CommanderManualProxy = var_1_0

	if var_1_1 == var_1_0.GET_TASK then
		pg = var_1_1

		local var_1_2 = var_1_1.ConnectionMgr.GetInstance()

		var_3.Send(var_1_2, 22302, {
			id = var_2.pageId,
			index = var_2.index
		}, 22303, function(arg_2_0)
			if arg_2_0.result == 0 then
				getProxy = var_1
				CommanderManualProxy = var_2_10003

				local var_2_0 = var_1(var_2_10003)

				var_2_10004 = var_1.GetPageById(var_2_0, var_0.pageId)

				var_1.RemoveDoingGetTaskIndex(var_2_10004, var_0.index)
		...
		local var_1_3 = var_2.operation

		CommanderManualProxy = var_4

		if var_1_3 == var_4.GET_PT_AWARD then
			pg = var_1_3

			local var_1_4 = var_1_3.ConnectionMgr.GetInstance()

			var_3.Send(var_1_4, 22304, {
				id = var_2.pageId
				...
				if arg_3_0.result == 0 then
					...
					local var_3_0 = var_3_1(var_2_10003)
					...
					var_3_2(var_2_10004, var_2_10005.COMMANDER_MANUAL_OP_DONE, {
