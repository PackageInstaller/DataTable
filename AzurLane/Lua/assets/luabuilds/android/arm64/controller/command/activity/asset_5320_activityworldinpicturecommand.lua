...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_3(var_1_2, var_1_10006.ACTIVITY_TYPE_WORLDINPICTURE) or var_3:isEnd() then
		pg = var_1_0

		local var_1_4 = var_1_0.TipsMgr.GetInstance()

		var_1_0 = var_1_0.ShowTips
		i18n = var_1_10007

		var_1_0(var_1_4, var_1_10007("common_activity_end"))
	...
	local var_1_5 = var_1_0.ConnectionMgr.GetInstance()
	...
	if var_1_9 ~= var_1_10010.WORLDINPICTURE_OP_DRAW or not var_1_1.index then
	...
	var_1_6(var_1_5, var_1_7, var_1_8, 11203, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			if var_2_1 == var_3.WORLDINPICTURE_OP_TURN then
				var_2_1 = var_0
				...
				if var_2_1 == var_3.WORLDINPICTURE_OP_DRAW then
					var_2_1 = var_0
			...
			var_2_2(var_2_10004, var_5.WORLDIN_PICTURE_OP_DONE, {
				activity = var_0,
				cmd = var_1_1.cmd,
				arg1 = var_1_1.arg1,
				arg2 = var_1_1.arg2,
			...
			if arg_2_0.result == 3 or arg_2_0.result == 4 then
				...
				var_2_4(var_2_3, var_2_10004("common_activity_end"))
			else
				pg = var_2_4
				...
				var_2_6(var_2_5, var_2_10004("activity_op_error", arg_2_0.result))
			end
			...
			var_2_8(var_2_7, var_2_10004.WORLDIN_PICTURE_OP_ERRO, {
				cmd = var_1_1.cmd,
				auto = var_1_1.auto
			})
		end
