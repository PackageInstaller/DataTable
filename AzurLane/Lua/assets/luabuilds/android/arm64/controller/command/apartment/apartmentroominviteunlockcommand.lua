...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_10007(var_9.any(var_1_3:getConfig("character_pay"), function(arg_2_0)
		return arg_2_0 == var_1_1
	end))

	Apartment = var_1_10007

	local var_1_4 = var_1_10007.getGroupConfig
	local var_1_5 = var_1_1
	local var_1_6 = var_1_3
	local var_1_7 = var_1_4(var_1_5, var_1_3.getConfig(var_1_6, "invite_cost"))

	CommonCommodity = var_1_2
	...
	local var_1_10 = var_1_8(var_1_9, var_11.TYPE_SHOPSTREET)
	local var_1_11, var_1_12, var_1_13 = var_8.GetPrice(var_1_10)

	Drop = var_1_6

	local var_1_14 = var_1_6.New
	local var_1_15 = {}

	DROP_TYPE_RESOURCE = var_1_10015
	var_1_15.type = var_1_10015
	...
	if #{
		...
		if var_1_18.any(var_13, function(arg_3_0)
			...
			var_1_18(var_1_17, var_17("temple_consume_not_enough"))
	...
	var_14.Send(var_1_23, 28019, {
		...
		if arg_4_0.result == 0 then
			...
			var_4_2(var_4_1, iter_4_0.APARTMENT_ROOM_INVITE_UNLOCK_DONE, {
				roomId = var_1_0,
				groupId = var_1_1
			})
		else
			...
			var_4_4(var_4_3, iter_4_0[arg_4_0.result] .. arg_4_0.result)
		end
