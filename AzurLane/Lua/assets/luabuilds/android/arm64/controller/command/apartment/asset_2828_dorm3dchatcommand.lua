...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_2 == var_1_10005.APARTMENT_CHAT_REPLY then
		pg = var_1_2

		local var_1_3 = var_1_2.ConnectionMgr.GetInstance()

		var_4.Send(var_1_3, 28028, {
			type = 1,
			...
			if arg_2_0.result == 0 then
				...
				var_2_2.SetTopicReaded(var_2_0, var_1_0.topicId, 0)

				local var_2_1 = var_1_1

				var_2_2.UpdateTopicDisplayWordList(var_2_1, var_1_0.topicId, var_1_0.wordId, var_1_0.replyId)
				...
				if var_1_0.isRedPacket then
					...
					var_2_3(var_2_10004, var_5.APARTMENT_CHAT_OP_DONE, {
					...
					var_2_2(var_2_4, var_2_10004.APARTMENT_CHAT_OP_DONE, {
						operation = var_1_0.operation
					})
				end
		...
		Dorm3dChatProxy = var_5

		if var_1_4 == var_5.APARTMENT_CHAT_SET_SKIN then
			pg = var_1_4

			local var_1_5 = var_1_4.ConnectionMgr.GetInstance()

			var_4.Send(var_1_5, 28030, {
				ship_id = var_1_0.characterId,
				...
				if arg_3_0.result == 0 then
					...
					var_3_2.SetChatSkin(var_3_0, var_1_0.characterId, var_1_0.skinId)
					...
					var_3_2(var_3_1, var_2_10004.APARTMENT_CHAT_OP_DONE, {
						operation = var_1_0.operation
					})
			...
			if var_1_6 == var_5.APARTMENT_CHAT_SET_CARE then
				pg = var_1_6

				local var_1_7 = var_1_6.ConnectionMgr.GetInstance()

				var_4.Send(var_1_7, 28032, {
					ship_id = var_1_0.characterId,
					value = var_1_0.care
					...
					if arg_4_0.result == 0 then
						...
						local var_4_1 = var_4_3.GetCharacterChatById(var_4_0, var_1_0.characterId)

						var_4_3.SetCare(var_4_1, var_1_0.care)
						...
						var_4_3(var_4_2, var_2_10004.APARTMENT_CHAT_OP_DONE, {
							operation = var_1_0.operation
						})
				...
				if var_1_8 == var_5.APARTMENT_CHAT_SET_TOPIC then
					pg = var_1_8

					local var_1_9 = var_1_8.ConnectionMgr.GetInstance()

					var_4.Send(var_1_9, 28034, {
						ship_id = var_1_0.characterId,
						...
						if arg_5_0.result == 0 then
							...
							var_5_2.SetCurrentTopic(var_5_0, var_1_0.topicId)
							...
							var_5_2(var_5_1, var_2_10004.APARTMENT_CHAT_OP_DONE, {
								operation = var_1_0.operation
							})
							...
							var_5_4(var_5_3, var_2_10004[arg_5_0.result] .. arg_5_0.result)
						end
					...
					if var_1_10 == var_5.APARTMENT_CHAT_SET_READTIP then
						pg = var_1_10

						local var_1_11 = var_1_10.ConnectionMgr.GetInstance()

						var_4.Send(var_1_11, 28026, {
							type = 1,
							ship_id = var_1_0.characterId,
							...
							if arg_6_0.result == 0 then
								if var_1_0.topicIdList and #var_1_0.topicIdList > 0 then
									...
									for iter_6_0, iter_6_1 in var_6_2(var_1_0.topicIdList) do
								...
								var_6_2(var_6_1, iter_6_0.APARTMENT_CHAT_OP_DONE, {
									operation = var_1_0.operation
								})
								...
								ERROR_MESSAGE = iter_6_0

								var_6_4(var_6_3, iter_6_0[arg_6_0.result] .. arg_6_0.result)
							end
						...
						if var_1_12 == var_5.APARTMENT_CHAT_TRIGGER_EVENT then
							pg = var_1_12

							local var_1_13 = var_1_12.ConnectionMgr.GetInstance()

							var_4.Send(var_1_13, 28023, {
								...
								if arg_7_0.result == 0 then
									...
									var_7_1(var_7_0, var_2_10004[arg_7_0.result] .. arg_7_0.result)
								end
