...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_7[var_1_10009.ACTIVITY_TYPE_BUILDSHIP_1] = function()
		...
		if not var_2_0 then
			if var_2_2 then
				...
				local var_2_3 = var_2_10005("switch_to_shop_tip_1")

				ChargeScene = var_2_10006

				var_3(var_2_3, var_2_10006.TYPE_ITEM, var_2_2)
			else
				pg = var_3
	...
	local var_1_8 = var_9.ACTIVITY_TYPE_BUILDSHIP_PRAY

	ActivityConst = var_10
	var_1_7[var_1_8] = var_10.ACTIVITY_TYPE_BUILDSHIP_1
	ActivityConst = var_1_8

	local var_1_9 = var_1_8.ACTIVITY_TYPE_NEWSERVER_BUILD

	ActivityConst = var_10
	var_1_7[var_1_9] = var_10.ACTIVITY_TYPE_BUILDSHIP_1
	...
	var_1_7[var_1_9.ACTIVITY_TYPE_SHOP] = function()
		...
		local var_3_2 = var_2_10001(var_2_10003)
		...
		if var_3_1[var_3_3(var_3_4.resource_type)] < var_3_4.resource_num * var_3_5 then
			pg = var_4
			...
			var_3_7(var_3_6, var_2_10007("common_no_resource"))
		...
		if var_3_4.commodity_type == 1 then
			if var_3_4.commodity_id == 1 and var_3_1:GoldMax(var_3_4.num * var_3_5) then
				...
				local var_3_10 = var_7("gold_max_tip_title")

				i18n = var_2_10008

				var_3_9(var_3_8, var_3_10 .. var_2_10008("resource_max_tip_shop"))
			...
			if var_3_4.commodity_id == 2 and var_3_1:OilMax(var_3_4.num * var_3_5) then
				...
				local var_3_13 = var_7("oil_max_tip_title")

				i18n = var_2_10008

				var_3_12(var_3_11, var_3_13 .. var_2_10008("resource_max_tip_shop"))
	...
	ActivityConst = var_9
	var_1_7[var_9.ACTIVITY_TYPE_BUILDING_BUFF_2] = function()
	...
	ActivityConst = var_9
	var_1_7[var_9.ACTIVITY_TYPE_SKIN_FAKE_PACKAGE] = function()
	...
	ActivityConst = var_9
	var_1_7[var_9.ACTIVITY_TYPE_TIMES_FAKE_PACKAGE] = function()
	...
	if var_1_2(var_1_6, var_1_7) then
		return
	end
	...
	var_1_11(var_1_10, var_1_12, var_1_13, 11203, function(arg_7_0)
		...
		if arg_7_0.result == 0 then
			...
			var_2_10002 = var_2_10002.updateActivityData(var_7_1, var_1_1, arg_7_0, var_1_3, var_7_0)
			getProxy = var_3
			ActivityTaskProxy = var_5

			local var_7_2 = var_3(var_5)

			var_3.checkAutoSubmit(var_7_2)

			local var_7_3 = arg_1_0

			var_3.performance(var_7_3, var_1_1, arg_7_0, var_2_10002, var_7_0)
		...
		local var_7_4 = var_1_5

		ActivityConst = var_2_10002

		if var_7_4 ~= var_2_10002.ACTIVITY_TYPE_7DAYSLOGIN then
			local var_7_5 = var_1_5

			ActivityConst = var_2

			if var_7_5 ~= var_2.ACTIVITY_TYPE_PROGRESSLOGIN then
				local var_7_6 = var_1_5

				ActivityConst = var_2

				if var_7_6 ~= var_2.ACTIVITY_TYPE_MONTHSIGN then
					local var_7_7 = var_1_5

					ActivityConst = var_2

					if var_7_7 == var_2.ACTIVITY_TYPE_REFLUX then
						local var_7_8 = var_1_3

						var_7_8.autoActionForbidden = true
						getProxy = var_7_8
						ActivityProxy = var_3

						local var_7_9 = var_7_8(var_3)

						var_1.updateActivity(var_7_9, var_1_3)

						goto label_7_0
					end

					local var_7_10 = var_1_5

					ActivityConst = var_2

					if var_7_10 ~= var_2.ACTIVITY_TYPE_BUILDSHIP_1 then
						do
							local var_7_11 = var_1_5

							ActivityConst = var_2

							if var_7_11 == var_2.ACTIVITY_TYPE_NEWSERVER_BUILD then
								if arg_7_0.result == 1 then
									pg = var_1

									local var_7_12 = var_1.TipsMgr.GetInstance()
									local var_7_13 = var_1.ShowTips

									i18n = var_4

									var_7_13(var_7_12, var_4("activity_build_end_tip"))
								end
							elseif var_1_5 == 17 then
								pg = var_1

								local var_7_14 = var_1.TipsMgr.GetInstance()

								var_1.ShowTips(var_7_14, "错误!:" .. arg_7_0.result)
							else
								local var_7_15 = var_1_5

								ActivityConst = var_2

								if var_7_15 == var_2.ACTIVITY_TYPE_FRESH_TEC_CATCHUP then
									pg = var_7_15

									local var_7_16 = var_7_15.TipsMgr.GetInstance()
									local var_7_17 = var_1.ShowTips

									errorTip = var_4

									var_7_17(var_7_16, var_4("activity_op_error", arg_7_0.result))
								else
									local var_7_18 = var_1_5

									ActivityConst = var_2

									if var_7_18 == var_2.ACTIVITY_TYPE_BUILDING_BUFF then
										local var_7_19 = var_1_3
										local var_7_20 = var_1.getConfig(var_7_19, "config_client").resource_ID

										BossRushDALUpgradeView = var_2

										if var_7_20 == var_2.RES_ID then
											pg = var_7_20
											...
											var_7_22(var_7_21, var_4("DAL_upgrade_not_enough"))
										end
									else
										local var_7_24
										...
										if arg_7_0.result == 3 or arg_7_0.result == 4 then
											...
											var_7_24(var_7_23, var_4("common_activity_end"))
										else
											pg = var_7_24
											...
											var_7_26(var_7_25, var_4("activity_op_error", arg_7_0.result))
										end
									end
								end
							end
						...
						do
							...
							var_7_28(var_7_27, var_4.ACTIVITY_OPERATION_ERRO, {
...
function var_0_1.updateActivityData(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	...
	local var_8_2 = var_1_10006(var_8)
	...
	var_8_5[var_1_10012.ACTIVITY_TYPE_7DAYSLOGIN] = function()
	...
	var_8_5[var_12.ACTIVITY_TYPE_PROGRESSLOGIN] = function()
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_LEVELAWARD] = function()
		table = var_2_10000
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_STORY_AWARD] = function()
		table = var_2_10000
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_LEVELPLAN] = function()
		if arg_8_1.cmd == 1 then
			arg_8_3.data1 = true
		elseif arg_8_1.cmd == 2 then
			table = var_0
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_MONTHSIGN] = function()
		pg = var_2_10000
		...
		local var_14_2 = var_2_10001.TimeMgr.GetInstance()
		...
		if var_2.getSpecialData(var_14_4, "reMonthSignDay") ~= nil then
			...
			var_14_8.data3 = var_14_2
		else
			local var_14_9 = var_14_3.day
			local var_14_10 = day
		end

		local var_14_11 = arg_8_3
		local var_14_12 = var_2.setSpecialData

		MonthSignPage = var_5

		var_14_12(var_14_11, var_5.MILESTONE_SPECIAL_DATA, nil)

		table = var_14_12

		local var_14_13 = var_14_12.insert
		local var_14_14 = arg_8_3.data1_list

		day = var_5

		var_14_13(var_14_14, var_5)

		getProxy = var_14_13
		ActivityProxy = var_14_14

		local var_14_15 = var_14_13(var_14_14)
		local var_14_16 = var_2.getActivityByType

		ActivityConst = var_5

		local var_14_17

		if var_14_16(var_14_15, var_5.ACTIVITY_TYPE_LOGIN_RECORD) then
			var_14_17 = var_2

			if not var_2.isEnd(var_14_17) then
				var_2.data1 = var_2.data1 + 1
				var_2.data2 = var_2.data2 + 1
				math = var_14_2
				var_2.data3 = var_14_2.max(var_2.data3, var_2.data2)
				ipairs = var_14_2
				MonthSignPage = var_14_17

				for iter_14_0, iter_14_1 in var_14_2(var_14_17.MONTH_SIGN_SP_DAYS) do
					if iter_14_1 == var_2.data1 then
						local var_14_18 = arg_8_3
						local var_14_19 = var_8.setSpecialData

						MonthSignPage = var_2_10011

						var_14_19(var_14_18, var_2_10011.MILESTONE_SPECIAL_DATA, iter_14_1)
					end
				end

				getProxy = var_14_2
				ActivityProxy = var_14_17
				var_14_17 = var_14_2(var_14_17)

				var_14_2.updateActivity(var_14_17, var_2)
			end
		end
		...
		local var_14_20 = var_14_2(var_14_17)

		var_3.updateActivity(var_14_20, arg_8_3)

		return
	end
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_CHARGEAWARD] = function()
		arg_8_3.data2 = 1

		return
	end
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_BUILDSHIP_1] = function()
		pg = var_2_10000
		...
		var_16_1(var_16_0, var_2_10003, arg_8_1.arg1)
		...
		if arg_8_1.arg2 == 1 then
			...
			local var_16_3 = var_1(var_2_10003)

			var_2.data1 = var_1.getBuildFreeActivityByBuildId(var_16_3, arg_8_1.buildId).data1 - arg_8_1.arg1
			...
			var_1.removeItemById(var_2_10003, var_16_2.use_item, var_16_2.number_1 * arg_8_1.arg1)

			var_2_10003 = var_8_2

			local var_16_4 = var_1.getData(var_2_10003)
			...
			var_2.updatePlayer(var_16_5, var_1)
		end

		getProxy = var_1
		BuildShipProxy = var_2_10003

		local var_16_6 = var_1(var_2_10003)
		...
		var_16_8(var_16_7, iter_16_0.BUILD_SHIP_DONE)

		return
	end
	ActivityConst = var_12

	local var_8_6 = var_12.ACTIVITY_TYPE_BUILDSHIP_PRAY

	ActivityConst = var_13
	var_8_5[var_8_6] = var_13.ACTIVITY_TYPE_BUILDSHIP_1
	ActivityConst = var_8_6

	local var_8_7 = var_8_6.ACTIVITY_TYPE_NEWSERVER_BUILD

	ActivityConst = var_13
	var_8_5[var_8_7] = var_13.ACTIVITY_TYPE_BUILDSHIP_1
	...
	var_8_5[var_8_7.ACTIVITY_TYPE_SHOP] = function()
		...
		id2res = var_2_10009
		var_17_6[var_2_10009(var_2.resource_type)] = var_17_2
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_TASK_LIST] = function()
		if arg_8_1.cmd == 1 then
			...
			if var_18_1 and not var_18_1:isReceive() then
				...
				for iter_18_0, iter_18_1 in var_2_10003(var_18_3) do
					_ = var_2_10008
					...
					if var_2_10009.contains(var_2_10008, var_18_0) then
						var_2_10009 = arg_8_3
						var_2_10009.data3 = iter_18_0
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_TASK_RES] = function()
		if arg_8_1.cmd == 1 then
			getActivityTask = var_0
			...
			if var_19_1 and not var_19_1:isReceive() then
				...
				for iter_19_0, iter_19_1 in var_2_10003(var_19_3) do
					_ = var_2_10008
					var_2_10008 = var_2_10008.flatten({
						iter_19_1
					})
					...
					if var_2_10009.contains(var_2_10008, var_19_0) then
						var_2_10009 = arg_8_3
						var_2_10009.data3 = iter_19_0
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_PUZZLA] = function()
		...
		local var_20_1 = var_20_0(var_2_10002)
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_BB] = function()
		arg_8_3.data1 = arg_8_3.data1 + 1
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_LOTTERY] = function()
		if arg_8_1.cmd == 1 then
			...
			if var_22_2 == var_2_10004 then
				...
				local var_22_3 = var_3.getData(var_2_10005)
				...
				id2res = var_2_10008
				var_22_4[var_2_10008(var_2_10001.id)] = var_22_1
				...
				if var_22_6 == var_2_10004 then
					...
					local var_22_7 = var_22_6(var_2_10005)
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_CARD_PAIRS] = function()
		if arg_8_1.cmd == 1 then
	...
	local var_8_8 = var_12.ACTIVITY_TYPE_LINK_LINK

	ActivityConst = var_13
	var_8_5[var_8_8] = var_13.ACTIVITY_TYPE_CARD_PAIRS
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_LOTTERY_AWARD] = function()
		if arg_8_1.cmd == 1 then
			arg_8_3.data1 = arg_8_3.data1 + 1
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_DODGEM] = function()
		if arg_8_1.cmd == 1 then
			...
			local var_27_2 = var_2_10003.FINISH_STAGE_DONE
			local var_27_3 = {
			...
			SYSTEM_DODGEM = var_5
			var_27_3.system = var_5

			var_27_1(var_27_0, var_27_2, var_27_3)

			local var_27_4 = arg_8_3.data1_list

			math = var_2_10001
			var_27_4[1] = var_2_10001.max(arg_8_3.data1_list[1], arg_8_1.arg2)
		...
		elseif arg_8_1.cmd == 3 then
			local var_27_5 = arg_8_3

			defaultValue = var_2_10001
			var_27_5.data4 = var_2_10001(arg_8_3.data4, 0) + 1
		end

		return
	end
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_SUBMARINE_RUN] = function()
		if arg_8_1.cmd == 1 then
			...
			local var_28_2 = var_2_10003.FINISH_STAGE_DONE
			local var_28_3 = {
				statistics = arg_8_1.statistics,
				score = arg_8_1.statistics._battleScore
			}

			SYSTEM_SUBMARINE_RUN = var_5
			var_28_3.system = var_5

			var_28_1(var_28_0, var_28_2, var_28_3)

			local var_28_4 = arg_8_3.data1_list

			math = var_2_10001
			var_28_4[1] = var_2_10001.max(arg_8_3.data1_list[1], arg_8_1.arg2)
			arg_8_3.data2_list[1] = arg_8_2.number[1]
			arg_8_3.data2_list[2] = arg_8_2.number[2]
		elseif arg_8_1.cmd == 2 then
			arg_8_3.data2 = arg_8_2.number[1]
			...
			arg_8_3.data2_list[2] = 0
		elseif arg_8_1.cmd == 3 then
			local var_28_5 = arg_8_3

			defaultValue = var_2_10001
			var_28_5.data4 = var_2_10001(arg_8_3.data4, 0) + 1
		end

		return
	end
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_TURNTABLE] = function()
		...
		elseif arg_8_1.cmd == 1 then
			...
			local var_29_2 = var_2_10001.activity_event_turning[var_29_1].total_num
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_SHRINE] = function()
		arg_8_3.data1 = 1

		return
	end
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_RED_PACKETS] = function()
		arg_8_3.data1 = arg_8_3.data1 - 1
		...
		local var_31_1 = var_31_0(var_2_10002)
		local var_31_2 = var_0.getActivityByType

		ActivityConst = var_2_10004

		if var_31_2(var_31_1, var_2_10004.ACTIVITY_TYPE_MONOPOLY) and not var_1:isEnd() and var_1.data2_list[1] > var_1.data2_list[2] then
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_RED_PACKET_LOTTER] = function()
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_BUILDING_BUFF] = function()
		if arg_8_1.cmd == 1 then
			pg = var_0
			...
			if var_2_10001 < #var_33_0.buff then
				...
				var_2.each(var_33_0.material[var_2_10001], function(arg_34_0)
					...
					if var_34_0 == var_3_10005 then
						...
						Item = var_3_10007
						var_3_10005 = var_3_10005(var_3_10007.getConfigData(var_34_1), "link_id")
						assert = var_3_10006
						...
						if var_3_10005 < var_34_0 then
							...
							local var_34_4 = var_3_10005(var_3_10007.activity_drop_type[var_34_0], "activity_id")

							getProxy = var_3_10006
							ActivityProxy = var_8

							local var_34_5 = var_3_10006(var_8)
	...
	local var_8_9 = var_12.ACTIVITY_TYPE_BUILDING_BUFF_2

	ActivityConst = var_13
	var_8_5[var_8_9] = var_13.ACTIVITY_TYPE_BUILDING_BUFF
	...
	var_8_5[var_8_9.ACTIVITY_TYPE_BOSSSINGLE] = function()
		if arg_8_1.cmd == 2 then
			...
			local var_35_2 = var_3.FINISH_STAGE_DONE
			local var_35_3 = {
				statistics = arg_8_1.statistics,
				score = arg_8_1.statistics._battleScore
			}

			SYSTEM_REWARD_PERFORM = var_5
			var_35_3.system = var_5
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_EXPEDITION] = function()
		...
		if arg_8_1.cmd == 3 then
			...
			local var_36_2 = var_2_10003.FINISH_STAGE_DONE
			local var_36_3 = {
				statistics = arg_8_1.statistics,
				score = arg_8_1.statistics._battleScore
			}
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_AIRFIGHT_BATTLE] = function()
		if arg_8_1.cmd == 1 then
			...
			local var_37_2 = var_2_10003.FINISH_STAGE_DONE
			local var_37_3 = {
				statistics = arg_8_1.statistics,
				score = arg_8_1.statistics._battleScore
			}

			SYSTEM_AIRFIGHT = var_5
			var_37_3.system = var_5
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_SHAKE_BEADS] = function()
		if arg_8_1.cmd == 1 then
			arg_8_3.data1 = arg_8_3.data1 - 1
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_PT_OTHER] = function()
		if arg_8_1.cmd == 1 then
			arg_8_3.data2 = 1
		end
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_HOTSPRING_2] = function()
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_FIREWORK] = function()
		if arg_8_1.cmd == 1 then
			...
			id2res = var_2_10009
			var_42_11[var_2_10009(var_42_6)] = var_42_8
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_CARD_PUZZLE] = function()
		table = var_2_10000
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_ZUMA] = function()
		local var_44_0
		...
		local var_44_1 = var_44_0(var_2_10002)
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_PUZZLE_CONNECT] = function()
		getProxy = var_2_10000
		ActivityProxy = var_2_10002

		local var_45_0 = var_2_10000(var_2_10002)
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_SKIN_COUPON_COUNTING] = function()
		getProxy = var_2_10000
		ActivityProxy = var_2_10002

		local var_46_0 = var_2_10000(var_2_10002)
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_FRESH_TEC_CATCHUP] = function()
		local var_47_0
		...
		elseif arg_8_1.cmd == 3 then
			...
			var_2_10002 = var_47_0(var_2_10002)
			var_47_0 = var_47_0.removeFinishTaskById

			local var_47_1 = arg_8_3

			var_47_0(var_2_10002, var_3.getConfig(var_47_1, "config_data")[3][1][2])
		else
			assert = var_47_0
		...
		local var_47_2 = var_47_0(var_2_10002)
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_HOLIDAY_VILLA] = function()
		if arg_8_1.cmd == 1 then
			arg_8_3.data1 = 1
			...
			var_48_7(var_48_6, var_3.ACTIVITY_EXCHANGE_RESOURCES, arg_8_1.activity_id)
		elseif arg_8_1.cmd == 2 then
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_STRONGHOLD] = function()
		if arg_8_1.cmd == 1 then
			...
			local var_49_3 = var_49_2(var_49_1, var_3.ACTIVITY_TYPE_ATELIER_LINK)

			ipairs = var_2_10001

			for iter_49_0, iter_49_1 in var_2_10001(arg_8_1.consumes) do
				...
				if var_49_4 == 6 then
					...
					id2res = var_2_10013
					var_49_9[var_2_10013(var_49_4)] = var_49_5
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_SKIN_FAKE_PACKAGE] = function()
		assert = var_2_10000
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_TIMES_FAKE_PACKAGE] = function()
	...
	ActivityConst = var_12
	var_8_5[var_12.ACTIVITY_TYPE_LOVE_LETTER_UP] = function()
...
function var_0_1.performance(arg_53_0, arg_53_1, arg_53_2, arg_53_3, arg_53_4)
	...
	coroutine = var_8
	var_53_1 = var_8.create(function()
		switch = var_2_10000
		...
		ActivityConst = var_2_10004
		var_55_1[var_2_10004.ACTIVITY_TYPE_7DAYSLOGIN] = function()
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_BB] = function()
			pg = var_3_10000
			...
			var_57_2(var_57_1, var_3_10004.ACTIVITY_SHOW_BB_RESULT, {
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_LOTTERY_AWARD] = function()
			if arg_53_1.cmd == 1 then
				...
				var_58_3(var_58_2, var_3_10004.ACTIVITY_SHOW_LOTTERY_AWARD_RESULT, {
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_CARD_PAIRS] = function()
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_LINK_LINK] = function()
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_DODGEM] = function()
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_SUBMARINE_RUN] = function()
			if arg_53_1.cmd == 2 and arg_53_2.number[3] > 0 then
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_BUILDING_BUFF] = function()
			if arg_53_1.cmd == 1 then
				pg = var_0
				...
				var_63_1(var_63_0, var_3_10003("building_complete_tip"))
			end

			return
		end
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_BUILDING_BUFF_2] = function()
			if arg_53_1.cmd == 1 then
				pg = var_0
				...
				var_64_1(var_64_0, var_3_10003("building_complete_tip"))
			end

			return
		end
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_MONTHSIGN] = function()
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_SHAKE_BEADS] = function()
			if arg_53_1.cmd == 1 then
				...
				var_66_1(var_66_0, var_3_10003.ACTIVITY_SHOW_SHAKE_BEADS_RESULT, {
					number = arg_53_2.number[1],
					callback = var_53_2,
					awards = arg_53_4
				})
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_APRIL_REWARD] = function()
			if arg_53_1.cmd == 1 then
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_FIREWORK] = function()
			pg = var_3_10000
			...
			var_68_1(var_68_0, var_3_10003("activity_yanhua_tip8"))
			...
			if var_1.getConfig(var_68_4, "config_client").story then
				...
				if var_68_2(var_1) == "table" then
					ipairs = var_68_2

					for iter_68_0, iter_68_1 in var_68_2(var_1) do
		...
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_SKIN_FAKE_PACKAGE] = function()
			getProxy = var_3_10000
			ActivityProxy = var_3_10002

			local var_69_0 = var_3_10000(var_3_10002)
			...
			var_69_2(var_69_1, var_3.NOTI_UPDATE_CURRENT)

			return
		end
		ActivityConst = var_4
		var_55_1[var_4.ACTIVITY_TYPE_TIMES_FAKE_PACKAGE] = function()
			getProxy = var_3_10000
			ActivityProxy = var_3_10002

			local var_70_0 = var_3_10000(var_3_10002)
			...
			var_70_2(var_70_1, var_3.NOTI_UPDATE_CURRENT)
		...
		if #arg_53_4 > 0 then
			...
			local var_55_2 = var_0.sendNotification
			local var_55_3 = arg_53_3

			var_55_2(var_55_0, var_55_1.getNotificationMsg(var_55_3), {
		...
		if var_53_0 == 17 and arg_53_1.cmd and arg_53_1.cmd == 2 then
			pg = var_55_4
			var_55_0 = var_55_4.TipsMgr.GetInstance()
			var_55_4 = var_55_4.ShowTips
			i18n = var_55_1

			var_55_4(var_55_0, var_55_1("mingshi_get_tip"))
		end

		getProxy = var_55_4
		ActivityProxy = var_55_0

		local var_55_5 = var_55_4(var_55_0)

		var_0.updateActivity(var_55_5, arg_53_3)

		local var_55_6 = arg_53_0
		local var_55_7 = var_0.sendNotification

		ActivityProxy = var_3

		var_55_7(var_55_6, var_3.ACTIVITY_OPERATION_DONE, arg_53_1.activity_id)

		existCall = var_55_7

		var_55_7(arg_53_1.callback)
