...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_10017({
		function(arg_2_0)
			...
			local function var_2_4(arg_3_0)
				...
				for iter_3_0, iter_3_1 in var_3_10001(arg_3_0) do
					...
					if not var_3_10007.detect(var_1_13, function(arg_4_0)
						...
						var_3_10008.insert(var_1_13, var_3_10007)
					end
			...
			while true do
				...
				if var_2_3 > 0 then
					...
					local var_2_8 = var_2_7.GetRarity(var_2_10012)

					var_2_10013 = var_6

					if var_6.GetRarity(var_2_10013) < var_2_8 then
						break
					end
				end
				...
				local var_2_9 = var_2_7.GetRarity(var_2_10012)

				var_2_10013 = var_6

				if var_6.GetRarity(var_2_10013) < var_2_9 then
					var_1_10 = var_1_11
			...
			if var_2_2 == 0 and var_2_3 == 0 then
				...
				var_2_12(var_2_11, var_10("spweapon_tip_pt_no_enough"))
			...
			if var_8.getRawData(var_2_15).gold < var_1_12 then
				...
				i18n = var_2_10011
				var_2_10013 = "switch_to_shop_tip_2"
				i18n = var_2_10014

				local var_2_16 = var_2_10011(var_2_10013, var_2_10014("word_gold"))

				ChargeScene = var_2_10012

				var_9(var_2_16, var_2_10012.TYPE_ITEM, {
					{
						59001,
						var_1_12 - var_8.gold,
						var_1_12
			...
			if not var_9.all(var_1_13, function(arg_5_0)
				...
				var_2_18(var_2_17, var_12("spweapon_tip_materal_no_enough"))
			...
			if not var_2_18.all(var_1_2, function(arg_6_0)
				...
				var_2_20(var_2_19, var_12("spweapon_tip_materal_no_enough"))
			...
			if not var_2_20.all(var_1_3, function(arg_7_0)
				...
				local var_2_21 = var_9.TipsMgr.GetInstance()
				local var_2_22 = var_9.ShowTips

				i18n = var_12

				var_2_22(var_2_21, var_12("spweapon_tip_materal_no_enough"))
			...
			if var_2_10 > 0 and 0 < var_2_2 then
				...
				local var_2_23 = var_9.MsgboxMgr.GetInstance()
				local var_2_24 = var_9.ShowMsgBox
				local var_2_25 = {}

				i18n = var_2_10013
				var_2_25.content = var_2_10013("spweapon_tip_breakout_overflow", var_2_10)
		...
		function(arg_8_0)
			...
			local var_8_1 = var_2_10002.map(var_1_3, function(arg_10_0)
			...
			var_3.Send(var_8_2, 14203, {
				...
				if arg_11_0.result == 0 then
					...
					var_3_10004 = var_3.SetPt
					math = var_3_10007

					var_3_10004(var_11_2, var_3_10007.floor(var_1_9 - var_1_10))

					_ = var_3_10004

					var_3_10004.each(var_1_13, function(arg_12_0)
					...
					local var_11_4 = var_3_10004.getData(var_11_3)

					var_3_10004.consume(var_11_4, {
						gold = var_1_12
					})

					local var_11_5 = var_1_5

					var_5.updatePlayer(var_11_5, var_3_10004)
					...
					if var_11_1 then
						...
						var_11_1.UpdateSpWeapon(var_11_6, var_3)

						getProxy = var_5
						BayProxy = var_11_6
						var_11_6 = var_5(var_11_6)

						var_5.updateShip(var_11_6, var_11_1)
					else
						getProxy = var_5
						EquipmentProxy = var_11_6

						local var_11_7 = var_5(var_11_6)

						var_5.AddSpWeapon(var_11_7, var_3)
					end

					local var_11_8 = arg_1_0
					local var_11_9 = var_5.sendNotification

					GAME = var_8

					var_11_9(var_11_8, var_8.UPGRADE_SPWEAPON_DONE, var_3)
				else
					pg = var_11_0

					local var_11_10 = var_11_0.TipsMgr.GetInstance()
					local var_11_11 = var_1.ShowTips

					errorTip = var_3_10004

					var_11_11(var_11_10, var_3_10004("equipment_upgrade_erro", arg_11_0.result))
				end
