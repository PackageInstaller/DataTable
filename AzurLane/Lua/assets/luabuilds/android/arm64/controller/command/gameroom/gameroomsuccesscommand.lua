...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(26126, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_1 = var_2_0.lastTicketMax(var_2_9000)

			;({})[id2res(GameRoomProxy.coin_res_id)] = var_1_2 or 0

			getProxy(PlayerProxy).getRawData(var_2_0):consume({})
			...
			if var_2_4 < var_2_2[1].count then
				var_2_3 = var_2_4
			end
