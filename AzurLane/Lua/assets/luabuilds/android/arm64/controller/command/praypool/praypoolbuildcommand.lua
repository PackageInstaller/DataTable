...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_5.activity_id = var_1_10010.ACTIVITY_PRAY_POOL
	...
	var_1_3(var_1_2, var_1_4, var_1_5, 11203, function(arg_2_0)
		...
		if arg_2_0.result == 0 then
			...
			var_2_1(var_2_0, var_2_10004.STAGE_BUILD_SUCCESS)

			local var_2_2 = arg_1_0

			var_2_1 = var_2_1.sendNotification
			PrayPoolConst = var_2_10004
			var_2_10004 = var_2_10004.BUILD_PRAY_POOL_SUCCESS
			PrayProxy = var_2_10005

			var_2_1(var_2_2, var_2_10004, var_2_10005.STAGE_BUILD_SUCCESS)
			...
			var_2_1(var_2_3, var_2_10004("tip_pray_build_pool_success"))
		else
			pg = var_2_1
			...
			var_2_5(var_2_4, var_2_10004("tip_pray_build_pool_fail"))
		end
