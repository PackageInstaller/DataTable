...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 29019, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_3(var_2_2, var_2_10005.SYSTEM.TALENT)
			...
			var_2_6(var_2_5, var_2_10006.SYSTEM.TALENT, var_2_4)
			...
			if #arg_2_0.talents == 0 then
				...
				local var_2_11 = var_7.NEW_EDUCATE_TRACK

				NewEducateTrackCommand = var_2_10008

				local var_2_12 = var_2_10008.BuildDataTalent
				...
				var_2_10(var_2_9, var_2_11, var_2_12(var_2_13, var_2_14, var_2_15, var_2_16, var_2_17, var_2_10015.concat(arg_2_0.talents, ",")))
			end
