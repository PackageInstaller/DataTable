...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	local function var_1_2(arg_2_0)
		...
		if var_2_1 and var_0 then
			var_2_0:DeleteCollectionThemeTemplate(var_2_1.id)
		elseif var_2_1 and not var_0 then
		...
		if var_2_2 and var_0 then
			var_2_2:CancelCollection()
		elseif var_2_2 and not var_0 then
	...
	if var_1_0.isCancel then
		...
		if var_1_3:GetThemeTemplateCollectionCnt() >= BackYardConst.MAX_COLLECTION_CNT then
