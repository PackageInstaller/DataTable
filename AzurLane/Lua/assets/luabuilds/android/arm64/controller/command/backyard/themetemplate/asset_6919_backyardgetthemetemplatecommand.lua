...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_4(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10004.BACKYARD_GET_IMG_MD5, {
			type = var_1_0,
			callback = arg_3_0
		})
	...
	local function var_1_5(arg_4_0)
		...
		var_2_10001({
			...
			var_7_1(var_7_0, var_3_10003.BACKYARD_GET_THEME_TEMPLATE_DONE)
	...
	if var_1_0 == var_1_10009.THEME_TEMPLATE_TYPE_CUSTOM then
		...
		var_9.Send(var_1_6, 19105, {
			...
			if arg_8_0.result == 0 then
				...
				var_8_1(var_8_0, var_2_10004.BACKYARD_GET_THEME_TEMPLATE_DONE)
				...
				var_8_3(var_8_2, var_2_10004[arg_8_0.result] .. arg_8_0.result)
			end
		...
		if var_1_0 == var_9.THEME_TEMPLATE_TYPE_SHOP then
			...
			BackYardConst = var_14
			var_1_10.num = var_14.THEME_TEMPLATE_SHOP_REFRSH_CNT
			...
			var_1_8(var_1_7, var_1_9, var_1_10, 19118, function(arg_9_0)
				if arg_9_0.result == 0 then
					...
					var_9_1(var_9_0, var_2_10004[arg_9_0.result] .. arg_9_0.result)
				end
			...
			if var_1_0 == var_1_8.THEME_TEMPLATE_TYPE_COLLECTION then
				...
				var_9.Send(var_1_11, 19115, {
					...
					if arg_10_0.result == 0 then
						...
						var_10_1(var_10_0, var_2_10004[arg_10_0.result] .. arg_10_0.result)
					end
