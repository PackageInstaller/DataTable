...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_7:IsAutoSubmit() and var_1_7 then
		table = var_10

		var_10.insert(var_1_5, function(arg_3_0)
			pg = var_2_10001
			...
			var_3_2.type = var_2_10005
			i18n = var_2_10005
			var_3_2.content = var_2_10005("sub_item_warning")
			...
			var_3_4.count = var_7.getMaxProgress(var_3_5)
			var_3_3[1] = var_3_4
		...
		var_0.Send(var_4_0, 33207, {
			...
			if arg_5_0.result == 0 then
				function var_5_0(arg_6_0, arg_6_1, arg_6_2)
					...
					local var_6_0 = var_4_10003(var_4_10005)
					local var_6_1 = {}
					local var_6_2 = {}
					...
					for iter_6_0, iter_6_1 in var_4_10007(var_6_3) do
						table = var_4_10012

						var_4_10012.insert(var_6_1, iter_6_1)

						local var_6_4 = var_6_0
						local var_6_5 = var_6_0.getShipById(var_6_4, iter_6_1.id)
						...
						var_6_4.insert(var_6_2, var_6_6)
					end
				...
				for iter_5_0, iter_5_1 in var_3_10006(var_5_4) do
					local var_5_5 = var_5_0(iter_5_1, var_5_2, var_3_10004)
				...
				if var_1_7 then
					...
					var_5_12(var_5_11, var_5_13, var_11.getMaxProgress(var_5_14))
				end
				...
				var_5_18(var_5_17, var_3_10004("task_submitTask", arg_5_0.result))
			end
