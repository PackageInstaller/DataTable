...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	local var_1_5 = var_1_4.getData(var_1_9000)
	...
	if var_1_3 == 1 then
		for iter_1_0, iter_1_1 in ipairs((Clone(var_1_7.equipments))) do
			local var_1_10 = var_1_7.equipmentRecords[var_1_2]

			if iter_1_1 then
				var_1_10[iter_1_0] = iter_1_1.id or -1
			end
		end
