...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_3(arg_2_0)
		...
		local var_2_1 = var_2_10004.GATEWAY_HOST

		NetConst = var_2_10005

		var_2_10001(var_2_0, var_2_1, var_2_10005.GATEWAY_PORT)
	...
	if not var_1_1 then
		...
		PLATFORM = var_1_10010
	end

	local var_1_6

	if var_1_5(var_1_4, var_1_10010, var_1_0.arg2) then
		var_1_6 = var_1_1 or var_5:GetCacheGatewayFlag(var_1_0.arg2)
		var_1_10010 = var_5

		if not var_5.GetGateWayByPlatform(var_1_10010, var_1_6) then
		...
		var_1_8(var_1_7, var_1_10010.PLATFORM_LOGIN_DONE, {
			user = var_1_0
		})
	end
...
function var_0_1.GetGateWayByServer(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_2 = var_1_10006.GATEWAY_HOST

	NetConst = var_1_10007

	var_4_1(var_4_0, var_4_2, var_1_10007.GATEWAY_PORT, function()
		pg = var_2_10000
		...
		NetConst = var_5
		var_5_3.state = var_5.GatewayState
		...
		var_5_1(var_5_0, var_5_2, var_5_3, 10803, function(arg_6_0)
			...
			local var_6_3 = var_6_0.String.IsNullOrEmpty(arg_6_0.proxy_ip) and var_6_1 or arg_6_0.proxy_ip
