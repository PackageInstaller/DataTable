...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	for iter_1_4, iter_1_5 in var_7(var_1_5) do
	...
	for iter_1_8 = 1, var_1_9 do
		...
		var_1_10015.insert(var_1_10, function(arg_2_0)
			...
			var_2_1(var_2_0, var_2_10004.slice(var_1_6, (iter_1_8 - 1) * var_1_8 + 1, var_1_8), arg_2_0)
	...
	var_11(var_1_10, function()
		if #var_1_0 > 0 then
			...
			var_3_1(var_3_0, var_2_10003("random_ship_custom_mode_add_shadow_complete"))
		end
		...
		if #var_1_1 > 0 then
			...
			var_3_3(var_3_2, var_2_10003("random_ship_custom_mode_remove_shadow_complete"))
		end
		...
		var_3_5(var_3_4, var_2_10003.CHANGE_RANDOM_SHIPS_DONE)
...
function var_0_1.Send(arg_4_0, arg_4_1, arg_4_2)
	...
	var_4_3.ship_shadow_list = var_1_10008.map(arg_4_1, function(arg_5_0)
		return {
			key = arg_5_0.ship_id,
	...
	var_4_1(var_4_0, var_4_2, var_4_3, 12209, function(arg_6_0)
		if arg_6_0.result == 0 then
			...
			local var_6_0 = var_1(var_2_10003)
			...
			var_6_2(var_6_1, var_2_10004[arg_6_0.result] .. arg_6_0.result)
		end
