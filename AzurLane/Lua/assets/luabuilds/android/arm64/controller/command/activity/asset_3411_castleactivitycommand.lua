	...
	var_1_4(var_1_3, var_1_5, var_1_6, 11203, function(arg_2_0)
		...
		if arg_2_0.result == 0 then
			if var_0.cmd == 1 then
				...
				var_2_0(var_2_2, var_2_10004.CASTLE_DICE_OP_DONE, arg_2_0)
			elseif var_0.cmd == 2 then
				...
				var_2_0(var_2_4, var_2_10004.CASTLE_STORY_OP_DONE, arg_2_0)
			elseif var_0.cmd == 3 then
				...
				var_2_0(var_2_5, var_2_10004.CASTLE_FIRST_STORY_OP_DONE)
			end
		else
			pg = var_2_0
