...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if not var_1_5:getEquip(var_1_0.pos) then
	...
	pg.ConnectionMgr.GetInstance():Send(12006, {
		...
		if arg_2_0.result == 0 then
			...
			var_0:setSkinId(0)
			getProxy(EquipmentProxy):addEquipment(var_0)
			arg_1_0:sendNotification(GAME.UNEQUIP_FROM_SHIP_DONE, var_1_5)
			pg.TipsMgr.GetInstance():ShowTips(i18n("ship_unequipFromShip_ok", var_0:getConfig("name")), "red")
