...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_2:SetShips(var_1_3)

	local var_1_6 = {}

	ipairs = var_1_10008

	for iter_1_4, iter_1_5 in var_1_10008(var_1_0.furniture_id_list) do
		Furniture = var_1_10013
		var_1_10013 = var_1_10013.New(iter_1_5)
		tonumber = var_1_10014
		var_1_6[var_1_10014(var_1_10013.id)] = var_1_10013
	end

	var_1_2:SetFurnitures(var_1_6)

	local var_1_7 = 1

	BackYardConst = var_9

	for iter_1_6 = var_1_7, var_9.MAX_FLOOR_CNT do
		var_1_10014 = var_1_2

		local var_1_8 = var_1_2.SetTheme
		local var_1_9 = iter_1_6

		BackYardSelfThemeTemplate = var_1_10016

		var_1_8(var_1_10014, var_1_9, var_1_10016.New({
			id = -1,
			furniture_put_list = {}
		}, iter_1_6))
	end
	...
	for iter_1_7, iter_1_8 in var_1_7(var_1_0.furniture_put_list) do
		local var_1_10 = {}
		...
		for iter_1_9, iter_1_10 in var_1_10014(iter_1_8.furniture_put_list) do
			...
			var_21.insert(var_1_10, var_1_10020)
		end

		local var_1_12 = var_1_2

		var_1_10014 = var_1_2.SetTheme

		local var_1_13 = iter_1_8.floor

		BackYardSelfThemeTemplate = iter_1_10

		var_1_10014(var_1_12, var_1_13, iter_1_10.New({
			id = -1,
	...
	local var_1_14 = var_8(var_10)

	if var_1_1 then
		var_1_14:addDorm(var_1_2)
	else
		var_1_14.friendData = var_1_2
	end
	...
	var_1_16(var_1_15, iter_1_8.GET_BACKYARD_DATA_DONE, var_1_2)
