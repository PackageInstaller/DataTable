...
function var_0_1.loadScene(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	var_1_10005(var_1_10007(var_5_0, var_1_10010), "should be an instance of Context")

	getProxy = var_1_10005
	ContextProxy = var_7

	local var_5_1 = var_1_10005(var_7)

	pg = var_1_10006

	local var_5_2 = var_1_10006.SceneMgr.GetInstance()
	local var_5_3
	local var_5_4
	local var_5_5 = {}
	local var_5_6 = {
		...
		function(arg_12_0)
			...
			local var_12_0 = {
				function(arg_13_0)
					...
					for iter_13_0, iter_13_1 in var_3_10002(var_4.GetHierarchy(var_13_1)) do
					...
					var_2(var_4.map(var_13_0, function(arg_14_0)
				...
				function(arg_16_0)
					...
					var_1.prepare(var_16_0, arg_5_0.facade, arg_5_1, function(arg_17_0)
						...
						var_17_1(var_17_0, var_4_10004.START_LOAD_SCENE, arg_17_0)
				...
				function(arg_18_0)
					...
					var_1.prepareLayer(var_18_0, arg_5_0.facade, nil, arg_5_1, function(arg_19_0)
						...
						var_19_1(var_19_0, var_4_10004.WILL_LOAD_LAYERS, #arg_19_0)
		...
		function(arg_20_0)
			...
			var_20_2(var_20_1, var_2_10004.insertto({
				var_5_4
			}, var_5_5), arg_20_0)
	...
	seriesAsync = var_1_10012

	var_1_10012(var_5_10, function()
		...
		var_22_2(var_22_1, var_2_10003.LOAD_SCENE_DONE, arg_5_1.scene)
...
function var_0_1.loadLayer(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	var_1_10004(var_1_10006(var_23_0, var_1_10009), "should be an instance of Context")
	...
	local var_23_3 = {
		function(arg_24_0)
			...
			var_1.prepareLayer(var_24_0, arg_23_0.facade, arg_23_2, arg_23_1, function(arg_25_0)
				...
				var_25_1(var_25_0, var_3_10004.WILL_LOAD_LAYERS, #arg_25_0)
	...
	var_7(var_23_3, function()
		...
		var_27_2(var_27_1, var_2_10003.LOAD_LAYER_DONE, arg_23_1)
...
function var_0_1.LoadLayerOnTopContext(arg_28_0)
	...
	local var_28_2 = var_1_10003.m02
	local var_28_3 = var_3.sendNotification

	GAME = var_1_10006

	var_28_3(var_28_2, var_1_10006.LOAD_LAYERS, {
...
function var_0_1.RemoveLayerByMediator(arg_29_0)
	...
	if var_1.getContextByMediator(var_29_1, arg_29_0) then
		...
		local var_29_2 = var_29_0.m02
		local var_29_3 = var_3.sendNotification

		GAME = var_1_10006

		var_29_3(var_29_2, var_1_10006.REMOVE_LAYERS, {
			context = var_2
		})
