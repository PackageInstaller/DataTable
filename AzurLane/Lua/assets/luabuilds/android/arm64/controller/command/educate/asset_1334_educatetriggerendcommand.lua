...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_7.Send(var_1_4, 27008, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2(var_2_1, var_2_10004.EDUCATE_TRIGGER_END_DONE)
			...
			var_2_2.PlayGroup(var_2_3, var_1_3, function()
				...
				EducateConst = var_3_10003

				var_3_1(var_3_0, var_3_10003.AFTER_END_PERFORM, function()
					getProxy = var_4_10000
					EducateProxy = var_4_10002

					local var_4_0 = var_4_10000(var_4_10002)
			...
			var_2_5(var_2_4, var_2_10004("educate trigger end error: ", arg_2_0.result))
		end
