...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_7.commodity_type == 1 then
		...
		if var_1_7.commodity_id == 2 and var_1_4:OilMax(var_1_7.num * var_1_1) then
			...
			local var_1_15 = var_15("oil_max_tip_title")

			i18n = var_1_10016

			var_1_12(var_1_14, var_1_15 .. var_1_10016("resource_max_tip_shop"))
	...
	var_12.Send(var_1_16, 16201, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_1 = var_2.getShamShop(var_2_10004)
			...
			var_2_10004.updateShamShop(var_2_3, var_2)
			...
			var_2_10004(var_2_4, var_7.SHAM_SHOPPING_DONE, {
				awards = var_2_0,
				id = var_1_0
			})
		else
