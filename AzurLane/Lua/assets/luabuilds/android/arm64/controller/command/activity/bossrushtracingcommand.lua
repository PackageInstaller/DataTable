...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_5:GetFleets(var_1_8)[1]:isEmpty() then
		table.remove(var_1_8)
	end

	local var_1_11 = (function()
		local var_2_1
		local var_2_2
		...
		local var_2_6 = (function(arg_3_0, arg_3_1)
			local var_3_0 = 0
			...
			return var_3_0
		end)(var_1_10, var_2_2[2]) * var_2_5

		for iter_2_0 = 1, var_2_5 do
			local var_2_8 = var_1_9[iter_2_0] or var_1_9[1]

			var_2_6 = var_2_6 + var_2_4(var_2_8, var_2_2[1])
		end

		return var_2_6
	end)() + var_1_5:GetOilCost()

	if var_1_11 > getProxy(PlayerProxy):getRawData().oil then
		if not ItemTipPanel.ShowOilBuyTip(var_1_11) then
	...
	local var_1_12 = var_1_0.remasterTicketCost or BossRushChapterRemasterHelper.GetPermanentActivityTicketCost(var_1_2, var_1_0.seriesId)
	local var_1_13 = getProxy(ChapterProxy)

	if var_1_12 > 0 and var_1_12 > var_1_13.remasterTickets then
	...
	pg.ConnectionMgr.GetInstance():Send(11202, {
		...
		if arg_4_0.result == 0 then
			...
			if var_1_12 > 0 then
				var_1_13:updateRemasterTicketsNum(var_1_13.remasterTickets - var_1_12)
			end
