...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_7, 29068, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_3(var_2_2, var_2_10006.Config2Drop(var_2_1.cost))
			...
			NewEducateFSM = var_10

			var_2_9(var_2_8, var_10.SYSTEM.MAP)
			...
			local var_2_12 = var_2_11(var_2_10, var_10.SYSTEM.MAP)
			local var_2_13 = var_7.SetSiteState
			local var_2_14 = {}

			NewEducateConst = var_2_10012
			var_2_14.key = var_2_10012.SITE_STATE_TYPE.SHIP
			...
			var_2_17(var_2_16, var_12.NEW_EDUCATE_MAP_SHIP_DONE, {
				drops = var_2_15,
			...
			local var_2_20 = var_12.NEW_EDUCATE_TRACK

			NewEducateTrackCommand = var_13

			var_2_19(var_2_18, var_2_20, var_13.BuildDataSite(var_5.id, var_5:GetGameCnt(), var_5:GetRoundData().round, 3, var_1_1))
		else
			pg = var_2_0
