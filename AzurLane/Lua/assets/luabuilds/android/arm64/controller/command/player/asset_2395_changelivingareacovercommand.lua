...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	LivingAreaCoverProxy = var_1_10007
	...
	var_6.Send(var_1_3, 11030, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2(var_2_1, var_2_10004.CHANGE_LIVINGAREA_COVER_DONE)
			...
			var_2_2(var_2_3, var_2_10004, var_2_10005.BuildDataCover(var_1_0, 2))
