	...
	local function var_1_3()
		...
		var_0.Send(var_2_0, 12022, {
			...
			if arg_3_0.result == 0 then
				...
				if var_3_2 == var_3_10004.LOCK_STATE_LOCK then
					var_3_1 = "ship_updateShipLock_ok_lock"
				else
					var_3_2 = var_1_1
					Ship = var_3_10004

					if var_3_2 == var_3_10004.LOCK_STATE_UNLOCK then
				...
				for iter_3_0, iter_3_1 in var_3_2(var_1_0) do
					local var_3_3 = var_3_0:getShipById(iter_3_1)

					var_8.SetLockState(var_3_3, var_1_1)
					var_3_0:updateShip(var_8)

					local var_3_4 = arg_1_0
					local var_3_5 = var_9.sendNotification

					GAME = var_12

					var_3_5(var_3_4, var_12.UPDATE_LOCK_DONE, var_8)

					pg = var_3_5

					local var_3_6 = var_3_5.TipsMgr.GetInstance()
					local var_3_7 = var_9.ShowTips

					i18n = var_12

					var_3_7(var_3_6, var_12(var_3_1, var_8:getName()))
				end
				...
				var_3_9(var_3_8, var_3_10004("ship_updateShipLock", arg_3_0.result))
			end
