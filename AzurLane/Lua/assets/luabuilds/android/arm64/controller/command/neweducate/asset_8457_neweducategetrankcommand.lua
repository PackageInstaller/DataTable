...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_7(arg_4_0)
		...
		var_1.Send(var_4_0, 18203, {
			...
			local var_5_5 = var_5_0(var_3_10005)
	...
	var_11(var_1_8, function()
		if #var_1_5 > 0 then
			...
			var_0.HandleSamePoint(var_2_10002, var_1_1, var_1_5)
		end
		...
		var_0.setRankList(var_8_0, var_1_0, var_1_1, var_1_5)
		...
		var_8_2(var_8_1, var_4.NEW_EDUCATE_GET_RANK_DONE, {
			type = var_1_0,
			tbId = var_1_1,
			list = var_1_5,
			playerInfo = var_1_4
