...
function var_0_1.CheckAndSubmitVoteTask(arg_2_0, arg_2_1)
	...
	local var_2_2 = var_2_1(var_2_0, var_1_10005.ACTIVITY_TYPE_VOTE)

	pairs = var_1_10003

	for iter_2_0, iter_2_1 in var_1_10003(var_2_2) do
...
function var_0_1.GetCanSubmitVoteTaskList(arg_3_0, arg_3_1)
	...
	local var_3_2 = var_1_10003.activity_vote[var_3_1]

	assert = var_3_0

	var_3_0(var_3_2, arg_3_1.id .. "-" .. var_3_1)

	_ = var_3_0

	local var_3_3 = var_3_0.flatten(var_3_2.task_period)
	local var_3_4 = {}
	...
	for iter_3_0, iter_3_1 in var_6(var_3_3) do
		...
		if var_1_10011.getTaskById(var_1_10013, iter_3_1) and var_1_10011:isFinish() and not var_1_10011:isReceive() then
			table = var_12

			var_12.insert(var_3_4, var_1_10011)
		end
	end
...
function var_0_1.SubmitTaskList(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in var_2(arg_4_1) do
		...
		var_4_1(var_4_0, var_1_10010.SUBMIT_TASK, iter_4_1.id)
	end
