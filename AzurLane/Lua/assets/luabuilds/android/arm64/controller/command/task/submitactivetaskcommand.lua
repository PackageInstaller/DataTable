...
function var_0_0.execute(arg_3_0, arg_3_1)
	...
	elseif table.contains(TotalTaskProxy.normal_task_type, var_3_2) then
		for iter_3_2, iter_3_3 in ipairs(var_3_0.task_ids) do
			...
			local var_3_6 = getProxy(TaskProxy)

			if var_3_6:isSubmitting(iter_3_3) then
				-- block empty
			else
	...
	if not arg_3_0:InTaskScene() then
		local var_3_7, var_3_8 = arg_3_0:filterOverflowTaskVOList(var_3_3)
		...
		if arg_7_0.result == 0 then
			...
			if table.contains(TotalTaskProxy.avatar_task_type, arg_6_3) then
				...
				for iter_7_0, iter_7_1 in ipairs(arg_6_1.task_ids) do
					var_7_2 = var_7_2 + arg_6_0:getAwardNum(pg.activity_event_avatarframe[pg.activity_template[arg_6_1.act_id].config_id], iter_7_1)
				end
			...
			elseif table.contains(TotalTaskProxy.activity_task_type, arg_6_3) then
				...
				if arg_6_1.inIsland then
					arg_6_0:sendNotification(GAME.SUBMIT_ACTIVITY_TASK_IN_ISLAND_DONE, {
...
function var_0_0.updateTaskActivityData(arg_8_0, arg_8_1, arg_8_2)
	...
	if var_8_0 then
		...
		arg_8_0:sendNotification(ActivityProxy.ACTIVITY_UPDATED, var_8_0)
	end
...
function var_0_0.filterOverflowTaskVOList(arg_10_0, arg_10_1)
	...
	local var_10_1 = var_10_0.gold
	local var_10_2 = var_10_0.oil

	if not LOCK_UR_SHIP then
		local var_10_3 = getProxy(BagProxy):GetLimitCntById(pg.gameset.urpt_chapter_max.description[1]) or 0
		...
		for iter_10_0, iter_10_1 in pairs(arg_10_1) do
			local var_10_8 = iter_10_1:judgeOverflow(var_10_1, var_10_2, var_10_3)
...
function var_0_0.InTaskScene(arg_12_0)
	local var_12_0 = getProxy(ContextProxy):getCurrentContext().mediator

	return var_12_0 == TaskMediator
end
