...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_0 == var_0_1.SEARCH_TYPE_LIST then
		...
		var_6.Send(var_1_4, 50014, {
			...
			var_2_3(var_2_2, iter_2_0.FRIEND_SEARCH_DONE, {
				type = var_1_0,
				list = var_2_0
			})
	...
	elseif var_1_0 == var_0_1.SEARCH_TYPE_RESUME or var_1_0 == var_0_1.SEARCH_TYPE_FRIEND then
		...
		var_1_8.keyword = var_1_10011(var_1_1)
		...
		var_1_6(var_1_5, var_1_7, var_1_8, 50002, function(arg_3_0)
			...
			if arg_3_0.result == 0 then
				...
				var_3_1(var_3_2, var_2_10005.New(arg_3_0.player))
			else
				pg = var_3_1
				...
				var_3_4(var_3_3, var_2_10005("friend_searchFriend_noPlayer"))
			end
			...
			var_3_6(var_3_5, var_2_10005.FRIEND_SEARCH_DONE, {
				type = var_1_0,
				list = var_3_0
			})
