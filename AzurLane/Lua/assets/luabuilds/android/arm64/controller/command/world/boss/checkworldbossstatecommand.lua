...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_5()
		...
		for iter_2_2, iter_2_3 in var_4(var_2_3) do
	...
	var_8.Send(var_1_6, 34515, {
		...
		elseif arg_3_0.result == 1 then
			...
			var_3_1(var_3_0, var_2_10004("world_boss_none"))
		elseif arg_3_0.result == 3 then
			...
			var_3_3(var_3_2, var_2_10004("world_boss_none"))
		elseif arg_3_0.result == 6 then
			...
			var_3_5(var_3_4, var_2_10004("world_max_challenge_cnt"))
		else
			local var_3_7
			...
			if arg_3_0.result == 20 then
				...
				var_3_7(var_3_6, var_2_10004("world_boss_none"))
			else
				pg = var_3_7
