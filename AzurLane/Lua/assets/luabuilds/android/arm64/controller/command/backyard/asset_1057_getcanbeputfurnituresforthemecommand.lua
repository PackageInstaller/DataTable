...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_1_10005(var_1_10007).floor
	...
	if var_1_0:IsOccupyed(var_1_3, var_1_2) then
		...
		local var_1_6 = var_1_0.GetAllFurniture(var_1_5)
		local var_1_7 = {}

		pairs = var_1_5
		Clone = var_1_10012

		for iter_1_0, iter_1_1 in var_1_5(var_1_10012(var_1_6)) do
			table = var_1_10015

			var_1_10015.insert(var_1_7, iter_1_1)
		end

		var_0_1.SortListForPut(var_1_7)

		if var_1_1 then
			var_1_1(true, var_1_7)
		end
	end
...
function var_0_1.StoreyFurniture2ThemeFurniture(arg_4_0)
	...
	tonumber = iter_4_0
	var_4_2.id = iter_4_0(arg_4_0.id)
	...
	if not var_5(arg_4_0.parent) then
		var_4_4 = 0
	end
...
function var_0_1.GetOtherFloorHouse(arg_5_0)
	...
	local var_5_1 = var_5_0(var_1_10003(var_1_10005).floor)
...
function var_0_1.GetFurnitureInOtherFloor(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_6_0(var_6_1:GetThemeList()) do
	...
	var_1_10002.sort(arg_8_0, function(arg_9_0, arg_9_1)
		if (arg_9_0.parent ~= 0 and 1 or 0) == (arg_9_1.parent ~= 0 and 1 or 0) then
			...
			if var_9_1 == var_9_3 then
				...
				local var_9_7 = var_2_10007.getCount
				local var_9_8
