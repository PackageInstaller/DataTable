...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 26004, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_0 = var_1.getColorItems(var_2_10004)
			local var_2_1 = var_1
			local var_2_2 = var_1.getColorGroup(var_2_1, var_1_1)

			var_2_10004 = var_3.getConfig(var_2_2, "color_id_list")
			_ = var_2_1
			...
			var_2_1.each(var_1_2, function(arg_3_0)
				...
				if not var_1.canBeCustomised(var_3_1) and arg_3_0.color > 0 then
					local var_3_2 = var_2_10004[arg_3_0.color]
					local var_3_3 = var_2_0

					math = var_3_1
					var_3_3[var_3_2] = var_3_1.max(var_2_0[var_3_2] - 1, 0)
				end
			...
			var_2_5(var_2_4, var_2_10009.COLORING_CELL_DONE, {
				cells = var_1_2,
				stateChange = var_2_3
			})
		else
			...
			var_2_7(var_2_6, var_2_10004("coloring_cell", arg_2_0.result))
		end
