...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_4 = var_1_10007(var_9)
	...
	var_8.Send(var_1_5, 63214, {
		...
		if arg_2_0.result == 0 then
			...
			var_2.addShip(var_2_10004, var_2_0)

			var_2_10004 = var_1_3

			var_2.unlock(var_2_10004, var_2_0.id)

			var_2_10004 = var_0

			var_2.updateBluePrint(var_2_10004, var_1_3)

			var_2_10004 = var_1_4

			var_2.removeItemById(var_2_10004, var_1_1, 1)
			...
			var_2_1(var_2_10004, var_5.ITEM_LOCK_SHIP_BLUPRINT_DONE, {
				ship = var_2_0
			})
		else
			pg = var_2_0
			...
			var_2_3(var_2_2, var_2_10004("printblue_build_erro") .. arg_2_0.result)
		end
