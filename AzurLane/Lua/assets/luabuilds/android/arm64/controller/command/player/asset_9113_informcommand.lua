...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_6.getRawData(var_1_3).level < 20 then
		...
		var_1_5(var_1_4, var_1_10010("inform_level_limit"))
	...
	var_7.Send(var_1_6, 50111, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_1(var_2_10004, var_5("inform_sueecss"))
			...
			var_2_2(var_2_10004, var_5.INFORM_DONE)
		else
			pg = var_2_0
			...
			var_2_4(var_2_3, var_2_10004("inform_failed"))
		end
