...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_4 = var_1_10007.detect(var_1_3:getEquipCodes(), function(arg_2_0)
	...
	var_8.Send(var_1_5, 17605, {
		...
		if arg_3_0.result == 0 then
			...
			var_3_2(var_3_1, var_2_10004.EQUIP_CODE_LIKE_DONE, {
				like = true,
				shareId = var_1_1
			})
			...
			var_3_4(var_3_3, var_2_10004("equipcode_like_success"))
		else
			local var_3_5
			...
			if arg_3_0.result == 7 then
				...
				var_3_5(var_3_7, var_2_10004.EQUIP_CODE_LIKE_DONE, {
					shareId = var_1_1
				})
				...
				var_3_5(var_3_8, var_2_10004("equipcode_like_limited"))
			else
				pg = var_3_5
				...
				var_3_10(var_3_9, var_2_10004("", arg_3_0.result))
			end
		end
