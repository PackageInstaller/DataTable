...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	local function var_1_7(arg_4_0)
		pg.ConnectionMgr.GetInstance():Send(18203, {
			...
			local var_5_2 = getProxy(BayProxy).getShipById(var_5_0, var_5_1.character)
			local var_5_3 = {
				user_id = var_5_1.id,
				point = arg_5_0.point
			}

			var_5_3.name = var_5_1.name .. "|" .. getProxy(NewEducateProxy):GetCurChar():GetCallName()
			var_5_3.lv = var_5_1.level
			var_5_3.arena_rank = var_5_1.maxRank
			var_5_3.icon = var_5_2:getConfig("id")
			var_5_3.skin_id = var_5_2.skinId
			var_5_3.propose = var_5_2.propose and 1 or 0
			var_5_3.remoulded = var_5_2:isRemoulded() and 1 or 0
