...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_3 = var_7(var_1_10009)
	...
	local var_1_4 = var_1_10009.ConnectionMgr.GetInstance()
	...
	var_9.Send(var_1_4, 11202, {
		...
		if arg_2_0.result == 0 then
			...
			if not var_2_10002.contains(var_0.data1_list, var_1_0) then
				table = var_2
			...
			var_2_4(var_2_3, var_6.BLACK_WHITE_GRID_OP_DONE, {
				awards = var_2_0
			})
		else
