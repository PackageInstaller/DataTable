...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_3(var_1_2, var_1_4, var_1_5, 30019, function(arg_2_0)
		if arg_2_0.ret == 0 then
			...
			local var_2_5 = var_5.LOVE_ITEM_MAIL_REPAIR_DONE
			local var_2_6 = {}

			underscore = var_2_10007
			var_2_6.awards = var_2_10007.filter(var_2_3, function(arg_3_0)
				return not arg_3_0:isLoveLetter()
			end)

			var_2_4(var_2_10004, var_2_5, var_2_6)
		elseif arg_2_0.ret == 6 then
			...
			var_2_8(var_2_7, var_2_10004("loveletter_recover_tip5"))
		elseif arg_2_0.ret == 7 then
			...
			var_2_10(var_2_9, var_2_10004("loveletter_recover_tip3"))
		else
			local var_2_12
			...
			if arg_2_0.ret == 40 then
				...
				var_2_12(var_2_11, var_2_10004("player_harvestResource_error_fullBag"))
			else
				pg = var_2_12
				...
				var_2_14(var_2_13, var_2_10004("", arg_2_0.ret))
			end
		end
