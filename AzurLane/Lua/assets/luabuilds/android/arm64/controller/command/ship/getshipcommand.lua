...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if #var_1_10006.filter(var_1_1, function(arg_2_0)
		...
		var_1_4(var_1_3, var_9("ship_getShip_error_notFinish"))
	...
	local var_1_6 = var_1_10007(var_9)
	...
	if var_1_8 - var_1_5.getShipCount(var_1_9) <= 0 then
		...
		local var_1_10 = var_1_9("switch_to_shop_tip_noDockyard")

		openDockyardClear = var_1_10012
		gotoChargeScene = var_13
		openDockyardIntensify = var_1_10014

		var_9(var_1_10, var_1_10012, var_13, var_1_10014)

		return
	else
		underscore = var_9
		var_1_11 = var_9.slice(var_1_11, 1, var_8)
	end
	...
	var_1_7.insert(var_1_12, function(arg_3_0)
		pg = var_2_10001
		...
		var_1.Send(var_3_0, 12043, {
			...
			var_4_1(var_4.map(var_1_11, function(arg_5_0)
	...
	var_10.insert(var_1_12, function(arg_6_0, arg_6_1)
		local var_6_0 = {}
	...
	var_10(var_1_12, function()
		local var_7_0 = var_1_2
		local var_7_1 = var_0.getBuildShip(var_7_0, var_1_11[1]).type

		pg = var_2_10001

		local var_7_2 = var_2_10001.ConnectionMgr.GetInstance()
		...
		var_1.Send(var_7_2, 12025, {
			...
			for iter_8_0, iter_8_1 in var_3_10002(arg_8_0.ship_list) do
				...
				var_7.removeBuildShipByIndex(var_8_1, var_1_11[1])
				...
				var_3_10008.insert(var_8_0, var_8_2)

				if var_8_2:isMetaShip() and not var_8_2.virgin then
					Player = var_3_10008

					if var_3_10008.isMetaShipNeedToTrans(var_8_2.configId) then
						MetaCharacterConst = var_3_10008

						if var_3_10008.addReMetaTransItem(var_8_2) then
							var_8_2:setReMetaSpecialItemVO(var_3_10008)
						end
				...
				do
					...
					var_3_10008.addShip(var_8_3, var_8_2)
				end
			...
			if #var_8_0 > 0 then
				...
				var_8_6(var_8_5, iter_8_0.GET_SHIP_DONE, {
					ships = var_8_0,
					type = var_7_1
				})
			end
			...
			if arg_8_0.result == 0 then
				...
				var_8_8(var_8_7, iter_8_0("ship_getShip", arg_8_0.result))
			end
