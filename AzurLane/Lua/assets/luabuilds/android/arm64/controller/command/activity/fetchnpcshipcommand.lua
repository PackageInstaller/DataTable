...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_5.getTaskById(var_1_2, var_1_0) then
		...
		var_1_4(var_1_3, var_1_10010("task_is_not_existence", var_1_0))
	...
	if not var_6:isFinish() then
		...
		var_1_6(var_1_5, var_1_10010("task_submitTask_error_notFinish"))
	...
	var_7.Send(var_1_7, 20205, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2(var_2_10004, iter_2_0.FETCH_NPC_SHIP_DONE, {
				items = var_2_0,
				callback = var_1_1
			})
		else
			...
			var_2_4(var_2_3, var_2_10004("task_submitTask", arg_2_0.result))
		end
