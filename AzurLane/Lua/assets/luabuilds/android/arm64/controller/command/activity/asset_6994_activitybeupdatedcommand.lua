...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_1 == var_1_10005.ACTIVITY_TYPE_PT_BUFF and arg_1_0:IsLinkVoteAct(var_3) then
		...
		if var_4.CanGetAward(var_1_2) then
			...
			var_1_5(var_1_4, var_1_10009.ACT_NEW_PT, {
				cmd = 4,
...
function var_0_1.IsLinkVoteAct(arg_2_0, arg_2_1)
	...
	if var_2_1(var_2_0, var_1_10005.VOTE_ENTRANCE_ACT_ID) and not var_2:isEnd() then
