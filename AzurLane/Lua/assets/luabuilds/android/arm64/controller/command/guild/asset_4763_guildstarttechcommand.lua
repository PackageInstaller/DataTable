...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_4 then
		...
		var_1_8(var_1_7, var_1_10011("guild_no_exist"))
	...
	if not var_1_4:getTechnologyById(var_1_1) then
		...
		var_1_10(var_1_9, var_1_10012("guild_not_exist_tech"))
	...
	if not var_8:CanUpgrade() then
		...
		var_1_12(var_1_11, var_1_10012("guild_tech_is_max_level"))
	...
	if var_1_6.gold < var_1_14 then
		...
		var_1_16(var_1_15, var_1_10014("guild_tech_gold_no_enough"))
	...
	if var_1_6.guildCoin < var_1_13 then
		pg = var_1_18
		...
		var_1_18(var_1_17, var_1_10014("guild_tech_guildgold_no_enough"))
	...
	var_11.Send(var_1_19, 62015, {
		...
		if arg_2_0.result == 0 then
			...
			var_2.updatePlayer(var_2_10004, var_1_6)

			var_2_10004 = var_2_1
			var_0 = var_2_1.getTechnologyById(var_2_10004, var_1_1)
			var_2_10004 = var_0

			var_2.levelUp(var_2_10004)
			...
			var_2_2(var_2_10004, var_5.GUILD_START_TECH_DONE)
			...
			var_2_3(var_2_10004, var_5("guild_tech_upgrade_done"))
		else
			local var_2_5
			...
			if arg_2_0.result == 4305 then
				...
				var_2_5(var_2_4, var_2_10004("guild_is_frozen_when_start_tech"))
			else
				pg = var_2_5
