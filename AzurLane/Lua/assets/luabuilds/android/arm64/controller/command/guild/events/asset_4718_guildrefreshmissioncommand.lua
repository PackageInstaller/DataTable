...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_7.Send(var_1_4, 61023, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_10004 = var_3.GetMissionById(var_2_1, var_1_0)

			local var_2_2

			if not arg_2_0.event_info or var_2_2.event_id == 0 then
				GuildMission = var_2_1
				var_2_2 = var_2_1.CompleteData2FullData(arg_2_0.completed_info)
			end

			local var_2_3 = var_2_10004
			local var_2_4 = var_2_10004.Flush
			local var_2_5 = var_2_2

			GuildConst = var_2_10010

			var_2_4(var_2_3, var_2_5, var_2_10010.REFRESH_MISSION_TIME)
			...
			var_2_7(var_2_6, var_9.GUILD_REFRESH_MISSION_DONE, {
				id = var_2_10004.id
			})
			...
			var_6.UpdateFlagShips(var_2_8, "inGuildEvent")
