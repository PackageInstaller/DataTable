...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_5.isFriend(var_1_2, var_1_0) then
		...
		var_1_4(var_1_3, var_9("friend_sendFriendMsg_error_noFriend"))
	...
	var_6.Send(var_1_5, 50105, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_3 = var_2_10006.New

			ChatConst = var_2_10008

			local var_2_4 = var_2_10008.ChannelFriend
			local var_2_5 = {
			...
			local var_2_6 = var_10.TimeMgr.GetInstance()

			var_2_5.timestamp = var_10.GetServerTime(var_2_6)

			var_2_1(var_2_10004, var_2_2, var_2_3(var_2_4, var_2_5))
			...
			var_2_7(var_2_10004, var_2_2.FRIEND_SEND_MSG_DONE)
		else
			local var_2_9
			...
			if arg_2_0.result == 28 then
				...
				var_2_9(var_2_8, var_2_10004("friend_offline"))
			else
				pg = var_2_9
				...
				var_2_11(var_2_10, var_2_10004("friend_sendFriendMsg", arg_2_0.result))
			end
		end
