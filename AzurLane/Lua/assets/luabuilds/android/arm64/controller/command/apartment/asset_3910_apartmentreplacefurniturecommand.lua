...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 28007, {
		...
		if arg_3_0.result ~= 0 then
			pg = var_3_0
			var_2_10003 = var_3_0.TipsMgr.GetInstance()
			var_3_0 = var_3_0.ShowTips
			errorTip = var_2_10004

			var_3_0(var_2_10003, var_2_10004("", arg_3_0.result))

			var_2_10003 = arg_1_0
			var_3_0 = var_3_0.sendNotification
			GAME = var_4

			var_3_0(var_2_10003, var_4.APARTMENT_REPLACE_FURNITURE_ERROR)
		...
		var_3_3(var_3_2, var_4("dorm3d_furniture_save_success"))
		...
		var_3_5(var_3_4, var_4.APARTMENT_REPLACE_FURNITURE_DONE)
