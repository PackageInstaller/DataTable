...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_3 = var_2.activity_id

	if not var_1_2:getActivityById(var_1_3) or var_6:isEnd() then
		return
	end
	...
	var_1_5(var_1_4, var_1_6, var_1_7, 11203, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			var_2_10004 = var_1.getActivityById(var_2_0, var_1_3)

			local var_2_1 = var_1.GetLevelData(var_2_10004).level
			...
			var_2_10004(var_0.cmd, {
				...
				[var_0_1.CMD.INPUT_GOLD] = function()
					...
					var_6_2(var_6_1, var_3("mall_gold_input_success_tip"))
			...
			if var_2_1 ~= var_2 then
				var_1:OnUpgradeDone(var_2_1)
			end

			local var_2_2 = var_1_2

			var_2_10004.updateActivity(var_2_2, var_1)

			var_2_10004 = {}
			PlayerConst = var_2_10005
			var_2_10004 = var_2_10005.addTranDrop(arg_2_0.award_list)
			...
			local var_2_5 = var_8.ACTIVITY_MALL_OP_DONE
			local var_2_6 = {
				cmd = var_0.cmd,
				awards = var_2_10004,
				levels = {
			...
			var_2_6.completeOrderId = var_2_7
