...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_7.isEnd(var_1_8) then
		...
		TRACKING_TUTORIAL_COMPLETE_1 = var_10

		var_1_10(var_1_9, var_10)
		...
		var_1_10 = var_1_10.Tracking
		TRACKING_GUIDE_COMPLETE = var_10

		var_1_10(var_1_11, var_10)
	end
	...
	if var_7.isEnd(var_1_12) then
		...
		var_1_14(var_1_13, var_10.SERIES_GUIDE_END)
	end
