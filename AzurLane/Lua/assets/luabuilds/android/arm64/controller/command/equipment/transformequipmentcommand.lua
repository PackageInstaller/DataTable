...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_1 = arg_1_1.getBody(var_1_0).candicate

	seriesAsync = var_1_0

	var_1_0({
		function(arg_2_0)
			local var_2_0 = var_1_1.type

			DROP_TYPE_ITEM = var_2_10002

			if var_2_0 == var_2_10002 then
				pg = var_2_0
				var_2_10003 = var_2_0.MsgboxMgr.GetInstance()

				local var_2_1 = var_1.ShowMsgBox

				var_2_10004 = {}
				i18n = var_2_10005
				var_2_10004.content = var_2_10005("equipment_upgrade_feedback_compose_tip")
				var_2_10004.onYes = arg_2_0

				var_2_1(var_2_10003, var_2_10004)

				return
			else
				local var_2_2 = var_1_1.type

				DROP_TYPE_EQUIP = var_2_10002

				if var_2_2 == var_2_10002 and var_1_1.template.shipId ~= nil then
					local var_2_3 = var_1_1.template.shipId

					getProxy = var_2_10002
					BayProxy = var_2_10004

					local var_2_4 = var_2_10002(var_2_10004)
					local var_2_5 = var_2.getShipById(var_2_4, var_2_3)

					ShipStatus = var_2_10003

					local var_2_6, var_2_7 = var_2_10003.ShipStatusCheck("onModify", var_2_5)
					...
					local var_2_14 = var_1_1.template

					var_2_11.content = var_2_10009(var_2_12, var_2_13, var_13.getConfig(var_2_14, "name"))
		...
		function(arg_3_0)
			...
			local var_3_1 = var_1_1.composeCfg.id
			local var_3_2 = 1

			getProxy = var_2_10003
			BagProxy = var_2_10005

			local var_3_3 = var_2_10003(var_2_10005)

			getProxy = var_2_10004
			PlayerProxy = var_2_10006

			local var_3_4 = var_2_10004(var_2_10006)
			local var_3_5 = var_4.getData(var_3_4)

			pg = var_2_10006

			local var_3_6 = var_2_10006.compose_data_template[var_3_1]

			getProxy = var_3_4
			EquipmentProxy = var_2_10009

			local var_3_7 = var_3_4(var_2_10009)
			local var_3_8 = var_7.getCapacity(var_3_7)
			local var_3_9 = var_3_5

			if var_3_5.getMaxEquipmentBag(var_3_9) < var_3_8 + var_3_2 then
				NoPosMsgBox = var_9
				i18n = var_3_9
				var_3_9 = var_3_9("switch_to_shop_tip_noPos")
				openDestroyEquip = var_2_10012
				gotoChargeScene = var_2_10013

				var_9(var_3_9, var_2_10012, var_2_10013)
			...
			if var_3_5.gold < var_3_6.gold_num * var_3_2 then
				...
				local var_3_10 = var_3_9(var_2_10013, var_2_10014("word_gold"))

				ChargeScene = var_2_10012

				var_9(var_3_10, var_2_10012.TYPE_ITEM, {
					{
						59001,
			...
			if not var_3_3:getItemById(var_3_6.material_id) or var_9.count < var_3_6.material_num * var_3_2 then
				pg = var_3_12

				local var_3_11 = var_3_12.TipsMgr.GetInstance()

				var_3_12 = var_3_12.ShowTips
				i18n = var_2_10013

				var_3_12(var_3_11, var_2_10013("word_materal_no_enough"))
			...
			local var_3_13 = var_3_12.ConnectionMgr.GetInstance()

			var_10.Send(var_3_13, 14006, {
				id = var_3_1,
				num = var_3_2
				...
				if arg_4_0.result == 0 then
					...
					GAME = var_3_10004
					var_3_10004 = var_3_10004.COMPOSITE_EQUIPMENT_DONE

					local var_4_6 = {}

					Equipment = var_6
					var_4_6.equipment = var_6.New({
						id = var_3_6.equip_id
					})
					var_4_6.count = var_3_2
					var_4_6.composeId = var_3_1

					var_4_5(var_4_4, var_3_10004, var_4_6)
					arg_3_0({
					...
					var_4_8(var_4_7, var_3_10004("equipment_compositeEquipment", arg_4_0.result))
				end
...
function var_0_1.ExecuteEquipTransform(arg_6_0, arg_6_1)
	...
	if var_2 then
		...
		local var_6_5 = var_1_10008(var_1_10010)
		local var_6_6 = var_1_10008.getShipById(var_6_5, var_2)

		var_6_4 = var_9.getEquip(var_6_6, var_6_1)
		assert = var_1_10010

		var_1_10010(var_6_4, "can not find equipment at ship.")
	...
	if not var_6_8 then
		...
		var_6_11(var_6_10, var_1_10013("common_no_x", var_6_9))
	...
	local function var_6_14()
		...
		for iter_7_0, iter_7_1 in var_2_10002(var_6_12) do
			if iter_7_0 == "gold" then
				...
				local var_7_3 = var_7_1.getData(var_7_2)
				local var_7_4 = {}

				math = var_7_2
				var_7_4.gold = var_7_2.abs(iter_7_1)

				if iter_7_1 > 0 then
					var_7_3:consume(var_7_4)
					var_7_1:updatePlayer(var_7_3)
				elseif iter_7_1 < 0 then
					var_7_3:addResources(var_7_4)
					var_7_1:updatePlayer(var_7_3)
				end
			elseif iter_7_1 > 0 then
	...
	var_1_10019.SerialIpairsAsync(var_6_3, function(arg_9_0, arg_9_1, arg_9_2)
		...
		var_2_10003({
			...
			function(arg_11_0, arg_11_1)
				if arg_11_1.result == 0 then
					...
					local var_11_5 = var_6_12

					if not var_6_12.gold then
						var_3_10005 = 0
					end

					var_11_5.gold = var_3_10005 + var_2.coin_consume
					Equipment = var_11_5

					local var_11_6 = var_11_5.GetRevertRewardsStatic(var_6_15)

					pairs = var_3_10005

					for iter_11_2, iter_11_3 in var_3_10005(var_11_6) do
						if iter_11_2 ~= "gold" then
							local var_11_7 = var_6_12
							local var_11_8
							...
							var_11_7[iter_11_2] = var_11_8 - iter_11_3

							local var_11_9 = var_6_13
							local var_11_10
							...
							var_11_9[iter_11_2] = var_11_10 + iter_11_3
						end
					end
					...
					local var_11_11 = var_7.CanInBag(var_6_15)
					local var_11_12 = "Missing equip_data_template ID: "
					local var_11_13
					...
					var_3_10005(var_11_11, var_11_12 .. var_11_13)

					Equipment = var_3_10005

					if var_3_10005.CanInBag(var_6_15) then
						Equipment = var_3_10005

						if not var_3_10005.getConfigData(var_6_15).destory_gold then
							var_3_10005 = 0
						end
						...
						var_11_14.gold = var_11_15 - var_3_10005
						...
						var_11_16.gold = var_11_17 + var_3_10005
					end

					var_6_2 = var_6_15
					var_6_15 = var_2.target_id

					local var_11_18, var_11_19

					var_3_10005, var_11_18, var_11_19 = var_6_16()
					var_6_20 = var_11_19
					var_6_19 = var_11_18
					var_6_18 = var_3_10005

					arg_9_2()
				else
					pg = var_2

					local var_11_20 = var_2.TipsMgr.GetInstance()
					local var_11_21 = var_2.ShowTips

					ERROR_MESSAGE = var_3_10005

					var_11_21(var_11_20, var_3_10005[arg_11_1.result] .. arg_11_1.result)

					local var_11_22 = arg_6_0
					local var_11_23 = var_2.sendNotification

					GAME = var_5

					var_11_23(var_11_22, var_5.TRANSFORM_EQUIPMENT_FAIL)
				end
		...
		if not var_0 and var_6_0 then
			...
			local var_12_0 = var_0(var_2_10002)
			local var_12_1 = var_0.getShipById(var_12_0, var_6_0)

			pg = var_2_10001

			local var_12_2 = var_2_10001.TipsMgr.GetInstance()
			local var_12_3 = var_1.ShowTips

			i18n = var_2_10004
			var_2_10006 = "equipment_upgrade_equipped_unavailable"

			local var_12_4 = var_12_1:getName()
			local var_12_5 = var_6_20

			var_12_3(var_12_2, var_2_10004(var_2_10006, var_12_4, var_8.getConfig(var_12_5, "name")))
		end
		...
		local var_12_7 = arg_6_0
		local var_12_8 = var_1.sendNotification

		GAME = var_2_10004

		var_12_8(var_12_7, var_2_10004.TRANSFORM_EQUIPMENT_DONE, var_12_6)

		LoadContextCommand = var_12_8

		local var_12_9 = var_12_8.LoadLayerOnTopContext

		Context = var_12_7

		local var_12_10 = var_12_7.New
		local var_12_11 = {}

		EquipmentTransformInfoMediator = var_2_10006
		var_12_11.mediator = var_2_10006
		EquipmentTransformInfoLayer = var_2_10006
		var_12_11.viewComponent = var_2_10006
		var_12_11.data = {
			equipVO = var_6_17
		}

		function var_12_11.onRemoved()
			...
			if var_13_2(var_13_1, var_3_10005) then
				pg = var_13_0

				local var_13_3 = var_13_0.m02
				local var_13_4 = var_13_0.retrieveMediator(var_13_3, var_2.mediator.__cname)
				local var_13_5 = var_13_0.getViewComponent(var_13_4)
			...
			var_13_6({
				function(arg_14_0)
					...
					local var_14_2 = var_4_10004.ON_ACHIEVE
					local var_14_3 = {}
					local var_14_4 = {
						count = 1
					}
				...
				function(arg_16_0)
					...
					for iter_16_0, iter_16_1 in var_4_10002(var_6_13) do
						if iter_16_0 == "gold" then
							...
							DROP_TYPE_RESOURCE = var_4_10011
							var_16_2.type = var_4_10011
							res2id = var_4_10011
							var_16_2.id = var_4_10011(iter_16_0)
							...
							DROP_TYPE_ITEM = var_4_10011
							var_16_4.type = var_4_10011
					...
					local var_16_7 = iter_16_0.ON_AWARD
					local var_16_8 = {
						items = var_16_0
					}

					AwardInfoLayer = var_4_10007
					var_16_8.title = var_4_10007.TITLE.REVERT
				...
				function(arg_17_0)
					...
					var_17_1(var_17_0, var_4_10004.TRANSFORM_EQUIPMENT_AWARD_FINISHED, var_12_6)
