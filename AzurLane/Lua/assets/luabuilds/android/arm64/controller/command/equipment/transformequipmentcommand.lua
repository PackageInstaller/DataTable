...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	seriesAsync({
		function(arg_2_0)
			if var_1_0.type == DROP_TYPE_ITEM then
				...
				return
			elseif var_1_0.type == DROP_TYPE_EQUIP and var_1_0.template.shipId ~= nil then
				local var_2_0 = getProxy(BayProxy):getShipById(var_1_0.template.shipId)
				...
				pg.MsgboxMgr.GetInstance():ShowMsgBox({
					content = i18n("equipment_upgrade_feedback_equipment_consume", var_2_0:getName(), var_1_0.template:getConfig("name")),
					onYes = arg_2_0
				})
		...
		function(arg_3_0)
			if var_1_0.type == DROP_TYPE_EQUIP then
				return arg_3_0({
			...
			local var_3_0 = var_1_0.composeCfg.id
			local var_3_1 = 1
			local var_3_2 = getProxy(BagProxy)
			local var_3_3 = getProxy(PlayerProxy)
			local var_3_4 = getProxy(PlayerProxy):getData()
			local var_3_5 = pg.compose_data_template[var_1_0.composeCfg.id]
			local var_3_6 = getProxy(EquipmentProxy)

			if var_3_4:getMaxEquipmentBag() < getProxy(EquipmentProxy):getCapacity() + 1 then
				NoPosMsgBox(i18n("switch_to_shop_tip_noPos"), openDestroyEquip, gotoChargeScene)

				return
			end

			if var_3_4.gold < pg.compose_data_template[var_1_0.composeCfg.id].gold_num * 1 then
				GoShoppingMsgBox(i18n("switch_to_shop_tip_2", i18n("word_gold")), ChargeScene.TYPE_ITEM, {
					{
						59001,
						pg.compose_data_template[var_1_0.composeCfg.id].gold_num * 1 - var_3_4.gold,
						pg.compose_data_template[var_1_0.composeCfg.id].gold_num * 1
					}
				})
			...
			local var_3_7 = getProxy(BagProxy):getItemById(pg.compose_data_template[var_1_0.composeCfg.id].material_id)

			if not var_3_7 or var_3_7.count < pg.compose_data_template[var_1_0.composeCfg.id].material_num * 1 then
...
function var_0_0.ExecuteEquipTransform(arg_6_0, arg_6_1)
	...
	local function var_6_12()
		...
		if var_6_0 then
			local var_8_7 = "Ship " .. var_6_0 .. " Pos " .. var_6_2 or "ID " .. var_6_3

			var_8_4(var_8_5, var_8_6 .. var_8_7)

			local var_8_8 = var_8_3:MigrateTo(var_6_11)

			if var_8_2 then
				if not var_8_2:isForbiddenAtPos(var_8_8, var_6_2) then
					var_8_2:updateEquip(var_6_2, var_8_8)
	...
	table.SerialIpairsAsync(var_6_4, function(arg_9_0, arg_9_1, arg_9_2)
			...
			function(arg_11_0, arg_11_1)
				if arg_11_1.result == 0 then
					for iter_11_0, iter_11_1 in ipairs(pg.equip_upgrade_data[arg_9_1].material_consume) do
						local var_11_0 = var_6_8[iter_11_1[1]] or 0

						var_6_8[iter_11_1[1]] = var_11_0 + iter_11_1[2]
					end

					local var_11_1 = var_6_8.gold or 0

					var_6_8.gold = var_11_1 + pg.equip_upgrade_data[arg_9_1].coin_consume

					for iter_11_2, iter_11_3 in pairs((Equipment.GetRevertRewardsStatic(var_6_11))) do
						if iter_11_2 ~= "gold" then
							local var_11_2 = var_6_8[iter_11_2] or 0

							var_6_8[iter_11_2] = var_11_2 - iter_11_3

							local var_11_3 = var_6_9[iter_11_2] or 0

							var_6_9[iter_11_2] = var_11_3 + iter_11_3
						end
					end

					local var_11_4 = var_6_11 or "NIL"

					assert(Equipment.CanInBag(var_6_11), "Missing equip_data_template ID: " .. var_11_4)

					if Equipment.CanInBag(var_6_11) then
						local var_11_5 = Equipment.getConfigData(var_6_11).destory_gold or 0
						local var_11_6 = var_6_8
						local var_11_7 = var_6_8.gold or 0

						var_11_6.gold = var_11_7 - var_11_5

						local var_11_8 = var_6_9.gold or 0

						var_6_9.gold = var_11_8 + var_11_5
					end
		...
		arg_6_0:sendNotification(GAME.TRANSFORM_EQUIPMENT_DONE, {
			ship = var_6_14,
			equip = var_6_15,
			newEquip = var_6_16
		})
			...
			onRemoved = function()
				...
				seriesAsync({
					function(arg_14_0)
						...
						local var_14_2 = BaseUI.ON_ACHIEVE
						local var_14_3 = {}
						local var_14_4 = {
							count = 1
						}
						...
						if var_6_16 then
							var_14_4.id = var_6_16.id or 0
							var_14_4.type = DROP_TYPE_EQUIP
							var_14_3[1] = var_14_4
					...
					function(arg_17_0)
						arg_6_0:sendNotification(GAME.TRANSFORM_EQUIPMENT_AWARD_FINISHED, var_0)
