...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in ipairs(var_1_0.resultList) do
		...
		local var_1_5 = var_1_4:getTaskById(iter_1_1.id)
	...
	pg.ConnectionMgr.GetInstance():Send(20011, {
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.id_list) do
			local var_2_0 = var_1_4:getTaskById(iter_2_1)
			...
			if var_2_4 and not var_2_4:isEnd() then
				local var_2_5 = var_2_4:getConfig("config_data")[1] or {}

				if table.contains(var_2_5, var_2_0.id) then
					var_2_3:monitorTaskList(var_2_4)
				end
			end
		end

		var_1_3 = PlayerConst.addTranDrop(arg_2_0.award_list)

		if not var_1_2 then
			arg_1_0:sendNotification(GAME.SUBMIT_TASK_DONE, var_1_3, _.map(var_0, function(arg_3_0)
				return arg_3_0.id
			end))
		end
