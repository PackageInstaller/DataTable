...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_1 = arg_1_1.getBody(var_1_0).taskIds

	nowWorld = var_1_0

	local var_1_2 = var_1_0()
	local var_1_3 = var_4.GetTaskProxy(var_1_2)

	pg = var_1_10005

	local var_1_4 = var_1_10005.ConnectionMgr.GetInstance()

	var_5.Send(var_1_4, 7, {
		task_list = var_1_1
	}, 8, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			for iter_2_0, iter_2_1 in var_2_10002(arg_2_0.task_list) do
				...
				var_2_5(var_2_4, var_11.WORLD_TRIGGER_TASK_DONE, {
					task = var_2_10007
				})
			end
			...
			var_2.UpdateDailyTaskIds(var_2_10004, var_2_1)
			...
			var_2_6(var_2_10004, var_5.WORLD_TRIGGER_DAILY_TASK_DONE)
		elseif arg_2_0.result == 6 then
			...
			var_2_8(var_2_7, var_2_10004("world_task_refuse1"))
		else
			local var_2_10
			...
			if arg_2_0.result == 20 then
				...
				var_2_10(var_2_9, var_2_10004("world_sametask_tip"))
			else
				pg = var_2_10
