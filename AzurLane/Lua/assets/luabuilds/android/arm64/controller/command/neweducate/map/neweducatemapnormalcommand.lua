...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_5.CheckPriorityStystem(var_1_4) then
		...
		var_1_6(var_1_5, var_1_10008("child2_priority_tip"))
	...
	var_5.Send(var_1_7, 29062, {
		...
		if arg_2_0.result == 0 then
			...
			NewEducateHelper = var_2_10006

			var_2_3(var_2_2, var_2_10006.Config2Drop(var_2_1))
			...
			var_2_7(var_2_6, var_8.SYSTEM.MAP)
			...
			local var_2_10 = var_2_9(var_2_8, var_8.SYSTEM.MAP)
			local var_2_11 = var_5.SetSiteState
			local var_2_12 = {}

			NewEducateConst = var_2_10010
			var_2_12.key = var_2_10010.SITE_STATE_TYPE.NORMAL
			...
			var_2_15(var_2_14, var_10.NEW_EDUCATE_MAP_NORMAL_DONE, {
				drops = var_2_13,
			...
			local var_2_18 = var_10.NEW_EDUCATE_TRACK

			NewEducateTrackCommand = var_11

			var_2_17(var_2_16, var_2_18, var_11.BuildDataSite(var_3.id, var_3:GetGameCnt(), var_3:GetRoundData().round, 1, var_1_1))
		else
			pg = var_2_0
