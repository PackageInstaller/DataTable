...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_3(var_1_2, var_1_10008.ACTIVITY_TYPE_SCULPTURE) then
		local var_1_4 = var_5

		if var_5.isEnd(var_1_4) then
			pg = var_1_10006
			var_1_4 = var_1_10006.TipsMgr.GetInstance()
			var_1_10006 = var_1_10006.ShowTips
			i18n = var_1_10009

			var_1_10006(var_1_4, var_1_10009("common_activity_end"))
		...
		local var_1_5 = var_1_10006(var_1_4)
		local var_1_6 = var_6.getActivityByType

		ActivityConst = var_1_10009

		if not var_1_6(var_1_5, var_1_10009.ACTIVITY_TYPE_VIRTUAL_BAG) or var_6:isEnd() then
			pg = var_1_2
			...
			var_1_8(var_1_7, var_1_10010("common_activity_end"))
		...
		if not var_5:CanEnterState(var_1_0, var_1_1) then
			...
			var_1_10(var_1_9, var_10("common_error"))
		...
		if var_1_1 == var_1_10.STATE_UNLOCK then
			...
			if var_1_12 > var_6.getVitemNumber(var_1_13, var_1_11) then
				...
				local var_1_14 = var_10.activity_workbench_item[var_1_11].name

				pg = var_1_13

				local var_1_15 = var_1_13.TipsMgr.GetInstance()
				local var_1_16 = var_11.ShowTips

				i18n = var_1_10014

				var_1_16(var_1_15, var_1_10014("gift_act_tips", var_1_14))
		...
		var_7.Send(var_1_17, 11202, {
			...
			if arg_2_0.result == 0 then
				...
				SculptureActivity = var_3

				if var_2_1 == var_3.STATE_UNLOCK then
					var_2_10004 = var_0

					local var_2_2, var_2_3 = var_2._GetComsume(var_2_10004, var_1_0)
					local var_2_4 = var_0

					var_2_10004 = var_2_10004.getVitemNumber(var_2_4, var_2_2)

					local var_2_5 = var_0

					var_5.addVitemNumber(var_2_5, var_2_2, 0 - var_2_3)
				...
				var_2.UpdateState(var_2_10004, var_1_0, var_1_1)
				...
				var_2_7(var_2_10004, var_5.SCULPTURE_ACT_OP_DONE, {
					state = var_1_1,
					activity = var_0,
					id = var_1_0,
					awards = var_2_0
