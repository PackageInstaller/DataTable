...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_10005(var_7).FectchDropShipListFlags then
	...
	if not var_5.FectchDropShipListFlags[var_1_0] then
		...
		var_6.Send(var_1_2, 13109, {
			...
			var_2_6(var_2_5, var_2_10007.GET_CHAPTER_DROP_SHIP_LIST_DONE, {
				shipIds = var_2_4
			})
		...
		var_1_6(var_1_5, var_1_10011.GET_CHAPTER_DROP_SHIP_LIST_DONE, {
			shipIds = var_1_4
		})
	end
