...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_8 = var_9:getMapById(var_1_7:getConfig("map"))
	local var_1_9 = var_9
	local var_1_10 = var_9.GetContinuousData

	SYSTEM_SCENARIO = var_1_10015

	local var_1_11 = var_1_10(var_1_9, var_1_10015)
	local var_1_12 = var_9
	local var_1_13 = var_9.getRemasterTicketCost(var_1_12)
	local var_1_14
	...
	var_1_12({
		function(arg_2_0)
			...
			if var_1.isRemaster(var_2_0) and var_0.remasterTickets < var_1_13 then
				pg = var_1
				...
				var_2_2(var_2_1, var_2_10004("levelScene_remaster_tickets_not_enough"))
				...
				var_2_4(var_2_3, var_2_10004.TRACKING_ERROR, {
					chapter = var_1_7
				})
			...
			if var_1.isActivity(var_2_5) then
				...
				if not var_1.isRemaster(var_2_6) then
					...
					if not var_1.inActTime(var_2_7) then
						...
						var_2_9(var_2_8, var_2_10004("battle_levelScene_close"))
						...
						var_2_11(var_2_10, var_2_10004.TRACKING_ERROR, {
							chapter = var_1_7
						})
			...
			if var_1.isTriesLimit(var_2_12) then
				...
				if not var_2_13.enoughTimes2Start(var_2_12) then
					...
					if var_2_13.IsSpChapter(var_2_12) then
						...
						var_2_13(var_2_12, var_2_10004("sp_no_quota"))
					else
						pg = var_2_13
						var_2_12 = var_2_13.TipsMgr.GetInstance()
						var_2_13 = var_2_13.ShowTips
						...
						var_2_13(var_2_12, var_2_10004("common_elite_no_quota"))
					end
					...
					var_2_13(var_2_12, var_2_10004.TRACKING_ERROR, {
						chapter = var_1_7
					})
			...
			if var_2_16 == var_2_12.ELITE and not var_2_14:IsEliteEnabled() then
				pg = var_2
				...
				var_2_18(var_2_17, var_2_10005("common_elite_no_quota"))
				...
				var_2_20(var_2_19, var_2_10005.TRACKING_ERROR, {
					chapter = var_1_7
				})
			...
			if var_1_7.active then
				...
				var_2_22(var_2_21, var_2_10005("levelScene_strategying"))
				...
				var_2_24(var_2_23, var_5.TRACKING_ERROR, {
					chapter = var_1_7
				})
			...
			if var_2.isEscort(var_2_25) then
				...
				if var_2_26 >= var_3.getMaxEscortChallengeTimes(var_2_27) then
					...
					var_2_31(var_2_30, var_5.TRACKING_ERROR, {
						chapter = var_1_7
					})
		...
		function(arg_3_0)
			...
			if var_3_1 ~= var_2_10002.CustomFleet then
				arg_3_0()
			...
			if var_3_3 then
				...
				var_3_7(var_3_6, var_6.TRACKING_ERROR, {
					chapter = var_1_7
				})
		...
		function(arg_4_0)
			...
			if not var_3.isEnough(var_4_6, {
				...
				if not var_4.ShowOilBuyTip(var_4_4) then
					...
					var_4_8(var_4_7, var_7("common_no_resource"))
				end
				...
				var_4_10(var_4_9, var_7.TRACKING_ERROR, {
					chapter = var_1_7
				})
				...
				TRACKING_STRIKE_FAILD = var_7

				var_4_12(var_4_11, var_7)
		...
		function(arg_5_0)
			...
			if var_5_1 == var_2_10002.SelectFleet then
				var_5_1 = {}
				FleetType = var_5_2
				var_5_1[var_5_2.Normal] = {}
				FleetType = var_5_2
				var_5_1[var_5_2.Submarine] = {}
				FleetType = var_5_2
				var_5_2 = var_5_2.Support
				Clone = var_3

				local var_5_3 = var_1_7.eliteFleetList

				FleetType = var_2_10006
				var_5_1[var_5_2] = var_3(var_5_3[var_2_10006.Support])
				var_1_14 = var_5_1
				var_5_1 = false
				var_5_2 = ""
				ipairs = var_3
				...
				for iter_5_0, iter_5_1 in var_3(var_1_1) do
					...
					FleetProxy = var_2_10010
					var_2_10010 = var_2_10008(var_2_10010)

					local var_5_4 = var_2_10008.getFleetById(var_2_10010, iter_5_1)
					local var_5_5

					var_5_5, var_2_10010 = var_2_10008.ChangeToElite(var_5_4)
					table = var_5_4

					var_5_4.insert(var_1_14[var_2_10010], var_5_5)

					if not var_5_1 then
						var_5_1, var_5_2 = var_2_10008:GetEnergyStatus()
					end
				end
			else
				var_1_14 = var_1_7.eliteFleetList
			end

			Chapter = var_5_1
			var_1_14 = var_5_1.PackEliteFleetInfo(var_1_14)

			local var_5_6 = {}

			hasTiredState = var_5_2

			if var_5_2 then
				table = var_5_2

				var_5_2.insert(var_5_6, function(arg_6_0)
					pg = var_3_10001
			...
			var_5_2(var_5_6, arg_5_0)

			return
		end,
		function(arg_7_0)
			local var_7_0 = var_1_8
			...
			if var_1.isRemaster(var_7_0) then
				...
				local var_7_2 = var_2_10002.TimeMgr.GetInstance()

				if var_7_1 ~= var_2.CurrentSTimeDesc(var_7_2, "%Y/%m/%d") then
					if var_1_11 then
						local var_7_3 = var_1_11
						...
						if var_1.IsFirstBattle(var_7_3) then
							...
							getProxy = var_2_10008
							ChapterProxy = var_2_10010

							local var_7_8 = var_2_10008(var_2_10010)

							var_7_6.content = var_5(var_7_7, var_8.getRemasterTicketCost(var_7_8))
							...
							function var_7_6.onYes()
								...
								if var_3_10000.MsgboxMgr.GetInstance().stopRemindToggle.isOn then
									...
									local var_8_2 = var_3_10003.TimeMgr.GetInstance()

									var_8_0(var_8_1, var_3.CurrentSTimeDesc(var_8_2, "%Y/%m/%d"))
								end
		...
		function(arg_9_0)
			...
			if var_1.IsSupportSubmarineStage(var_9_0) then
				...
				local var_9_2 = #var_1.getSupportFleet(var_9_1)
				...
				if 0 < var_9_2 then
					if var_1_11 then
						...
						local var_9_3 = var_1("submarine_support_oil_consume")[1]

						pg = var_2

						local var_9_4 = var_2.MsgboxMgr.GetInstance()
						local var_9_5 = var_2.ShowMsgBox
						local var_9_6 = {}

						i18n = var_2_10006
						var_9_6.content = var_2_10006("submarine_support_oil_consume_tip", var_9_3)
						var_9_6.onYes = arg_9_0
				...
				if var_3.isCrossStoryLimit(var_10_4, var_10_3) then
					...
					if not var_3.isRemaster(var_10_5) then
						...
						if not var_3.IsPlayed(var_10_6, var_10_1) then
							...
							if var_10_2(var_10_1) and 0 < var_4 then
								getProxy = var_10_6
								ContextProxy = var_2_10007

								local var_10_7 = var_10_6(var_2_10007)

								var_10_6 = var_10_6.getContextByMediator
								LevelMediator2 = var_2_10008

								if var_10_6(var_10_7, var_2_10008) then
									var_10_6.data.pendingEnterChapterId = var_1_0
								end

								local var_10_8 = arg_1_0
								local var_10_9 = var_6.sendNotification

								GAME = var_2_10009

								local var_10_10 = var_2_10009.BEGIN_STAGE
								local var_10_11 = {}

								SYSTEM_PERFORM = var_2_10011
								var_10_11.system = var_2_10011
								var_10_11.stageId = var_4
								var_10_11.exitCallback = arg_10_0

								var_10_9(var_10_8, var_10_10, var_10_11)

								return
							else
								ChapterOpCommand = var_10_6

								local var_10_12 = var_10_6.PlayChapterStory
								local var_10_13 = var_10_1
								local var_10_14 = arg_10_0
								local var_10_15 = var_1_7
								local var_10_16

								if var_9.isLoop(var_10_15) then
									PlayerPrefs = var_10_16
									var_10_16 = var_10_16.GetInt("chapter_autofight_flag_" .. var_1_7.id, 1) == 1
								end

								var_10_12(var_10_13, var_10_14, var_10_16)
		...
		function(arg_11_0)
			if var_1_11 then
				...
				if var_11_1 > var_3.reduce(var_11_2, -1, function(arg_12_0, arg_12_1)
					...
					string = var_2_10009
					var_11_7.ver_str = var_2_10009.format("tracking Chapter %d by CO times %d", var_1_7.id, var_11_1)
...
function var_0_1.sendProto(arg_14_0)
	...
	var_8.Send(var_14_7, 13101, {
		...
		if arg_15_0.result == 0 then
			...
			local var_15_0 = var_1.getChapterById(var_2_10004, var_14_0)

			var_2_10003 = var_1:getMapById(var_15_0:getConfig("map"))
			getProxy = var_2_10004
			PlayerProxy = var_2_10006

			local var_15_1 = var_2_10004(var_2_10006)
			local var_15_2 = var_2_10004.getData(var_15_1)

			var_15_0:update(arg_15_0.current_chapter)

			var_2_10006 = var_15_0:getConfig("oil")

			if var_15_0:IsSupportSubmarineStage() and var_15_0:getChapterSupportFleet() then
				getGameset = var_7
				var_2_10006 = var_2_10006 + var_7("submarine_support_oil_consume")[1]
			end

			var_15_2:consume({
				oil = var_2_10006 * var_15_0:GetExtraCostRate()
			})

			local var_15_3 = var_2_10004

			var_2_10004.updatePlayer(var_15_3, var_15_2)
			...
			for iter_15_0, iter_15_1 in var_7(var_15_0.cells) do
			...
			for iter_15_2, iter_15_3 in var_7(var_15_0.champions) do
				ChapterConst = var_2_10012
				iter_15_3.trait = var_2_10012.TraitLurk
			end

			var_1:updateChapter(var_15_0)
			...
			SYSTEM_SCENARIO = var_10

			if var_15_6(var_15_5, var_10) then
				var_7:TryActivate()
			end
			...
			var_15_8(var_15_7, iter_15_3.TRACKING_DONE, var_15_0)
			...
			var_8.updateExtraFlag(var_15_9, var_15_0, var_15_0:getExtraFlags(), {}, true)
		...
		if arg_15_0.result == 1 then
			pg = var_15_11
			var_2_10003 = var_15_11.TipsMgr.GetInstance()
			var_15_11 = var_15_11.ShowTips
			i18n = var_2_10004

			var_15_11(var_2_10003, var_2_10004("levelScene_tracking_error_retry"))

			var_2_10003 = arg_14_0
			var_15_11 = var_15_11.sendNotification
			GAME = var_2_10004
			var_2_10004 = var_2_10004.CHAPTER_OP

			local var_15_12 = {}

			ChapterConst = var_2_10006
			var_15_12.type = var_2_10006.OpRetreat

			var_15_11(var_2_10003, var_2_10004, var_15_12)
		elseif arg_15_0.result == 3010 then
			...
			var_15_11(var_2_10003, var_2_10004("levelScene_tracking_error_3001"))
		else
			pg = var_15_11
			var_2_10003 = var_15_11.TipsMgr.GetInstance()
			var_15_11 = var_15_11.ShowTips
			...
			var_15_11(var_2_10003, var_2_10004("levelScene_tracking_erro", arg_15_0.result))
		end

		getProxy = var_15_11
		ChapterProxy = var_2_10003

		local var_15_13 = var_15_11(var_2_10003)
		...
		var_15_16(var_15_15, var_2_10006.TRACKING_ERROR, {
			chapter = var_15_14
		})
	...
	if arg_16_1 ~= "" and #arg_16_1 > 0 then
		...
		var_16_0 = var_3.all(arg_16_1, function(arg_17_0)
			if arg_17_0[1] == 1 then
				...
				local var_17_0 = var_1(var_2_10003)

				return var_1.getTaskById(var_17_0, arg_17_0[2]) and not var_2:isFinish()
			end
...
function var_0_1.CalculateSpItemMoreCostRate(arg_18_0)
	...
	local var_18_2 = var_1_10003.map

	string = var_1_10005

	local var_18_3 = var_1_10005.split

	string = var_1_10007

	local var_18_4 = var_18_2(var_18_3(var_1_10007.sub(var_18_1, 2, -2), ","), function(arg_19_0)
	...
	for iter_18_0, iter_18_1 in var_4(var_18_4) do
		...
		if var_9.benefit_buff_template[iter_18_0] then
			local var_18_5 = var_9.benefit_type

			Chapter = var_11

			if var_18_5 == var_11.OPERATION_BUFF_TYPE_COST then
				tonumber = var_18_5
				var_18_0 = var_18_0 + var_18_5(var_9.benefit_effect) * 0.01
			end
		end
	end
