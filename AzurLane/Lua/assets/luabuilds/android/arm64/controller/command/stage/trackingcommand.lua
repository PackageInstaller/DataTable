...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if not var_1_0.operationItem then
		var_1_3 = 0
	end
	...
	seriesAsync({
		...
		function(arg_5_0)
			if var_1_8:getConfig("type") == Chapter.SelectFleet then
				...
				for iter_5_0, iter_5_1 in ipairs(var_1_2) do
					local var_5_1 = getProxy(FleetProxy):getFleetById(iter_5_1)
					local var_5_2, var_5_3 = var_5_1:ChangeToElite()

					table.insert(var_1_12[var_5_3], var_5_2)
					...
					if not false then
						...
						var_5_4, var_5_5 = var_5_1:GetEnergyStatus()
					end
				end
			else
		...
		function(arg_10_0)
			...
			if var_10_0 and var_10_0 ~= "" and arg_1_0:isCrossStoryLimit((var_1_8:getConfig("enter_story_limit"))) and not var_1_9:isRemaster() then
				if not pg.NewStoryMgr.GetInstance():IsPlayed(var_10_0) then
					...
					if var_10_1 and var_10_1 > 0 then
						...
						var_10_3 = var_1_8:isLoop() and PlayerPrefs.GetInt("chapter_autofight_flag_" .. var_1_8.id, 1) == 1
					end

					ChapterOpCommand.PlayChapterStory(var_10_0, arg_10_0, var_10_3)
		...
		function(arg_11_0)
			if var_1_10 then
				...
				if var_11_0 > _.reduce({
					1,
					1,
					2
				}, -1, function(arg_12_0, arg_12_1)
...
function var_0_0.sendProto(arg_14_0)
	local var_14_1 = arg_14_0.autoFightFlag

	pg.ConnectionMgr.GetInstance():Send(13101, {
		id = arg_14_0.chapterId,
		fleet = arg_14_0.fleetDatas,
		operation_item = arg_14_0.operationItem,
		loop_flag = arg_14_0.loopFlag,
		fleet_duties = arg_14_0.dutiesKeyValue
	}, 13102, function(arg_15_0)
		if arg_15_0.result == 0 then
			local var_15_0 = getProxy(ChapterProxy)
			local var_15_1 = var_15_0:getChapterById(var_0)
			...
			if var_0 ~= 0 then
				getProxy(BagProxy):removeItemById(var_0, 1)
			end
			...
			if var_0 ~= 0 and var_14_1 then
				getProxy(ChapterProxy):SetChapterAutoFlag(var_0, true)
			end
		...
		arg_14_0:sendNotification(GAME.TRACKING_ERROR, {
			chapter = var_15_7:getChapterById(var_0)
		})
...
function var_0_0.CalculateSpItemMoreCostRate(arg_18_0)
	...
	for iter_18_0, iter_18_1 in ipairs((_.map(string.split(string.sub(Item.getConfigData(arg_18_0).usage_arg, 2, -2), ","), function(arg_19_0)
