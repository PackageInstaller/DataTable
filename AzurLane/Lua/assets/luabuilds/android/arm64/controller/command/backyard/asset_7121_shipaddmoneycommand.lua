...
local var_0_0 = "ShipAddMoneyCommand"
	...
	var_3.Send(var_1_1, 19013, {
		...
		if arg_2_0.result == 0 then
			...
			if var_2_10004 == 0 then
				...
				var_2_10(var_2_9, var_2_7("backyard_shipAddMoney_ok", var_2_1:getName(), var_2_10004))
			end
			...
			var_2_12(var_2_11, var_2_7.BACKYARD_ADD_MONEY_DONE, {
				id = var_1_0
			})
		else
			pg = var_2_1
			...
			var_2_14(var_2_13, var_2_10004("backyard_shipAddMoney", arg_2_0.result))
		end
