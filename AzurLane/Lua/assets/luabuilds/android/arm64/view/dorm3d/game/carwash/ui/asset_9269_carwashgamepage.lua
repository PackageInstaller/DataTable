...
function var_0_1.InitUI(arg_6_0)
	...
	var_1_10001(var_6_0, var_4.Find(var_6_1, "bottom/btn_shoot"), function()
		local var_7_0 = arg_6_0
		local var_7_1 = var_0.emit

		CarWashGameFlowSystem = var_2_10003

		var_7_1(var_7_0, var_2_10003.SWITCH_SHOOTING)

		setActive = var_7_1

		local var_7_2 = arg_6_0._tf

		var_7_1(var_2.Find(var_7_2, "bottom/btn_shoot/on"), arg_6_0.contextData.gameStatus.isShooting)

		setActive = var_7_1

		local var_7_3 = arg_6_0._tf

		var_7_1(var_2.Find(var_7_3, "bottom/btn_shoot/off"), not arg_6_0.contextData.gameStatus.isShooting)
	...
	local var_6_4 = var_3.Find(var_6_3, "bottom/guns")
	local var_6_5 = arg_6_0._tf

	arg_6_0.gunList = var_6_2(var_6_4, var_4.Find(var_6_5, "bottom/guns/gun1"))
	...
	var_1.make(var_6_6, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventInit then
			...
			var_3(arg_6_0, arg_8_2, function()
				...
				var_9_1(var_9_0, var_3_10003.SWITCH_GUN_TYPE, arg_8_1)
	...
	local var_6_10 = var_3.Find(var_6_9, "left/cams")
	local var_6_11 = arg_6_0._tf

	arg_6_0.camsList = var_6_8(var_6_10, var_4.Find(var_6_11, "left/cams/camTpl"))
		...
		if arg_10_0 == var_2_10003.EventInit then
			...
			var_3(arg_6_0, arg_10_2, function()
				if arg_6_0.posUnlock[arg_10_1] and arg_6_0.selectPosIndex ~= arg_10_1 then
					...
					CarWashTimelineSystem = var_3_10003

					local var_11_3 = var_3_10003.PLAY_TRANSITION
					local var_11_4 = {
						waitHold = true
					}

					CarWashTimelineSystem = var_3_10005
					var_11_4.type = var_3_10005.TRANSITION.BLACK

					function var_11_4.onHold(arg_12_0, arg_12_1)
						local var_12_0 = arg_6_0
						local var_12_1 = var_2.emit

						CarWashGameFlowSystem = var_4_10005

						var_12_1(var_12_0, var_4_10005.SWITCH_LADY_POS, arg_6_0.posConfig[arg_6_0.selectPosIndex].id)
						arg_12_0()
	...
	local var_6_16 = var_3.Find(var_6_15, "left/favor/bar_root")
	local var_6_17 = arg_6_0._tf

	arg_6_0.favorList = var_6_14(var_6_16, var_4.Find(var_6_17, "left/favor/bar_root/bar"))
	...
	var_1.make(var_6_18, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_2_10003.EventUpdate then
			...
			local var_13_3 = var_13_1(var_13_2, var_2_10009.min(arg_6_0.contextData.gameStatus.heartBeatValue - var_4, var_13_0)) / var_13_0
			...
			local var_13_6 = var_13_5(var_13_4, var_11(var_2_10013))
	...
	var_6_24(var_6_23, var_4.GAME_DURATION)

	setText = var_6_24

	local var_6_25 = arg_6_0._tf
	local var_6_26 = var_3.Find(var_6_25, "left/favor/text")

	i18n = var_4

	var_6_24(var_6_26, var_4("dorm3d_carwash_mood"))

	setText = var_6_24

	local var_6_27 = arg_6_0._tf
	local var_6_28 = var_3.Find(var_6_27, "top/clean/clean_text")

	i18n = var_4

	var_6_24(var_6_28, var_4("dorm3d_carwash_clean"))
...
function var_0_1.BindEvent(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10004.UPDATE_COUNTDOWN, function(arg_15_0, arg_15_1)
	...
	var_14_3(var_14_2, var_4.UPDATE_HEART_BEAT_VALUE, function(arg_16_0, arg_16_1)
		ipairs = var_2_10002
		...
		for iter_16_0, iter_16_1 in var_2_10002(arg_14_0.posConfig) do
			if not arg_14_0.posUnlock[iter_16_0] and iter_16_1.mood_value <= arg_16_1.newValue then
				...
				typeof = var_2_10011
				Animation = var_2_10013

				local var_16_5 = var_16_4(var_16_3, var_2_10011(var_2_10013))
	...
	var_14_5(var_14_4, var_4.UPDATE_STAINS_COUNT, function(arg_17_0, arg_17_1)
	...
	var_14_7(var_14_6, var_4.UPDATE_CURRENT_GUN_TYPE, function(arg_18_0, arg_18_1)
	...
	var_14_9(var_14_8, var_4.UPDATE_GAME_STATE, function(arg_19_0, arg_19_1)
		...
		if var_19_2 ~= var_3.GAME_STATE.PHASE_2 then
			do
...
function var_0_1.FlushCleanPersent(arg_23_0)
	...
	local var_23_1 = arg_23_0.GetCleanPersent(var_23_0)
	local var_23_2 = arg_23_0:GetRank(var_23_1)

	setText = var_23_0

	var_23_0(arg_23_0.cleanPersentText, var_23_1 .. "%")

	eachChild = var_23_0

	var_23_0(arg_23_0.cleanRank, function(arg_24_0)
