...
function var_0_1.preload(arg_7_0, arg_7_1)
	...
	var_4({
		function(arg_8_0)
			...
			local var_8_2 = var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_7_2 .. "/" .. var_7_1 .. "_scene")
			local var_8_3 = var_7_1

			LoadSceneMode = var_6

			var_8_1(var_8_0, var_8_2, var_8_3, var_6.Additive, function(arg_9_0, arg_9_1)
				arg_8_0()
		...
		function(arg_11_0)
			...
			local var_11_1 = var_2_10002.Find("AR/XR Origin/Camera Offset/Main Camera")
...
function var_0_1.LoadCharacter(arg_12_0, arg_12_1, arg_12_2)
	...
	for iter_12_0, iter_12_1 in var_1_10004(arg_12_1) do
		...
		var_1_10012 = var_12_2(var_1_10012)

		local var_12_3 = var_10.getApartment(var_1_10012, iter_12_1)
		local var_12_4 = var_10.getConfig(var_12_3, "asset_name")
		local var_12_5 = var_10

		var_1_10012 = var_10.GetSkinModelID

		local var_12_6 = arg_12_0.room

		var_1_10012 = var_1_10012(var_12_5, var_15.getConfig(var_12_6, "tag"))
		pg = var_12_3

		local var_12_7 = var_12_3.dorm3d_resource[var_1_10012].model_id
		...
		for iter_12_2, iter_12_3 in var_12_5({
			"common",
			var_12_7
		}) do
			string = var_1_10019
			var_1_10019 = var_1_10019.format("dorm3d/character/%s/res/%s", var_12_4, iter_12_3)
			checkABExist = var_1_10020

			if var_1_10020(var_1_10019) then
				table = var_1_10020

				var_1_10020.insert(var_12_0, function(arg_13_0)
		...
		var_14.insert(var_12_0, function(arg_15_0)
			...
			local var_15_0 = var_2_10001.format("dorm3d/character/%s/prefabs/%s", var_12_4, var_12_7)
...
function var_0_1.InitCharacter(arg_17_0, arg_17_1)
	...
	arg_17_0.ladyAnimator = var_17_3(var_17_2, var_5(var_1_10007))
	...
	local var_17_8 = var_17_7(var_17_6, var_5(var_1_10007), true)

	table = var_1_10003

	var_1_10003.IpairsCArray(var_17_8, function(arg_18_0, arg_18_1)
	...
	var_3.SetCommonEvent(var_17_10, function(arg_19_0)
		if arg_17_0.nowState then
			...
			if var_1.IsName(var_19_0, arg_17_0.nowState) then
				existCall = var_1
		...
		for iter_19_0, iter_19_1 in var_2_10002(arg_17_0.animCallbacks) do
			if var_19_1:IsName(iter_19_0) then
				...
				local var_19_2 = var_7.removebykey(arg_17_0.animCallbacks, iter_19_0)
		...
		if arg_19_0.stringParameter ~= "" then
			...
			var_2.OnAnimationEvent(var_19_3, arg_19_0)
		end
...
function var_0_1.HXCharacter(arg_20_0, arg_20_1)
	...
	local var_20_2 = var_20_1(var_20_0, var_5(var_1_10007))

	table = var_1_10003

	var_1_10003.IpairsCArray(var_20_2, function(arg_21_0, arg_21_1)
		...
		var_2_10004.IpairsCArray(var_21_0, function(arg_22_0, arg_22_1)
			...
			var_22_6[arg_22_0], var_22_6 = var_22_4(var_22_3, var_22_5, var_3_10009(var_3_10011), false, false), var_21_0
			warning = var_22_6
...
function var_0_1.didEnter(arg_35_0)
	...
	Dorm3dARMediator = var_1_10004

	var_35_1(var_35_0, var_1_10004.IN_ITAR_PHOTO)
...
function var_0_1.InitARPlane(arg_37_0)
	...
	var_1_10002(var_37_0, arg_37_0.ARCheck)

	GameObject = var_1_10002

	local var_37_1 = var_1_10002.Find("FakeAR")
	...
	if arg_37_0.ARCheck then
		originalPrint = var_37_4

		var_37_4("AR CHECK SUCCESS, INIT AR")

		local var_37_2 = arg_37_0.aiHelperSC

		var_37_4.Init(var_37_2)

		local var_37_3 = arg_37_0

		var_37_4 = arg_37_0.emit
		Dorm3dARMediator = var_6

		var_37_4(var_37_3, var_6.INIT_AR_PLANE)
	else
		originalPrint = var_37_4

		var_37_4("AR CHECK FAIL")
		arg_37_0:InitARFinish()
		arg_37_0:EnabledDrag()
	end

	PLATFORM = var_37_4
	PLATFORM_WINDOWSEDITOR = var_4

	if var_37_4 == var_4 then
		arg_37_0:InitARFinish()
	end
...
function var_0_1.InitARFinish(arg_39_0)
	...
	var_39_1(var_39_0, var_4.AR_INIT_FINISH)
...
function var_0_1.willExit(arg_40_0)
	...
	local var_40_3, var_40_4 = var_1_10002(var_1_10004.split(var_0_2, "|"))
	...
	var_40_6(var_40_5, var_7.lower("dorm3d/scenesres/scenes/" .. var_40_4 .. "/" .. var_40_3 .. "_scene"), var_40_3)
...
function var_0_1.findUI(arg_41_0)
	...
	local var_41_8 = var_1_10006.width

	Screen = var_1_10007

	var_1(var_41_7, var_4(var_41_8, var_1_10007.height))
	...
	arg_41_0.aiHelperSC = var_1_10002(var_41_11, "ARHelper")
...
function var_0_1.addListener(arg_42_0)
	...
	function arg_42_0.aiHelperSC.planeCountCB(arg_45_0, arg_45_1)
		if not (arg_45_0 > 0) then
			...
			var_2_10003(var_45_0, var_6("AR_plane_check"))
		elseif not arg_45_1 then
			...
			var_2_10003(var_45_1, var_6("AR_plane_long_press_to_summon"))
	...
	function arg_42_0.aiHelperSC.distanceCB(arg_46_0)
		if arg_46_0 < 0.3 then
			...
			var_46_0(var_46_1, var_4("AR_plane_distance_near"))
	...
	function arg_42_0.aiHelperSC.insPrefabFailCB()
		...
		var_47_1(var_47_0, var_2_10003("AR_plane_summon_fail_by_near"))
	...
	function arg_42_0.aiHelperSC.insPrefabSuccCB()
		...
		var_48_1(var_48_0, var_3("AR_plane_summon_success"))
...
function var_0_1.EnabledDrag(arg_49_0)
	...
	local var_49_3 = var_49_1(var_3.GetComponent(var_49_2, "RectTransform"))[2].x - var_1[0].x
	...
	var_49_2(var_49_6, var_1_10008(var_1_10010))
	...
	typeof = var_8
	PinchZoom = var_1_10010
	arg_49_0.zoom = var_49_2(var_49_7, var_8(var_1_10010))
	...
	local var_49_10 = var_49_8(var_49_9, var_8(var_1_10010))

	Vector3 = var_6

	local var_49_11 = var_6(0, 0, 0)
...
function var_0_1.Screen2Local(arg_55_0, arg_55_1)
	...
	local var_55_4 = var_55_0.ScreenToLocal(var_55_3, arg_55_1, var_55_1)

	Vector3 = var_55_2

	return var_55_2(var_55_4.x, var_55_4.y, 0)
end
