...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OPEN_CHAT, function(arg_2_0, arg_2_1)
		...
		Dorm3dChatLayer = var_2_10008
		var_2_3.viewComponent = var_2_10008
		Dorm3dChatMediator = var_2_10008
		...
		var_2_4.groupName = var_9.getGroupName(var_2_5)
	...
	arg_1_0:bind(var_0_1.OPEN_JUUS, function(arg_4_0, arg_4_1)
		...
		Dorm3dInstagramLayer = var_2_10008
		var_4_3.viewComponent = var_2_10008
		Dorm3dInstagramMediator = var_2_10008
		...
		var_4_4.groupName = var_9.getGroupName(var_4_5)
	...
	arg_1_0:bind(var_0_1.OPEN_PHONE, function(arg_6_0, arg_6_1)
		...
		Dorm3dInsPhoneLayer = var_2_10008
		var_6_3.viewComponent = var_2_10008
		Dorm3dInsPhoneMediator = var_2_10008
		...
		var_6_4.groupName = var_9.getGroupName(var_6_5)
	...
	arg_1_0:bind(var_0_1.CLOSE_PHONE, function(arg_8_0, arg_8_1)
		...
		Dorm3dInsPhoneMediator = var_2_10005
	...
	arg_1_0:bind(var_0_1.CLOSE_JUUS, function(arg_10_0)
		...
		Dorm3dInstagramMediator = var_2_10004

		var_10_1(var_10_0, var_2_10004.BACK_PRESSED)

		local var_10_2 = arg_1_0
		local var_10_3 = var_1.removeSubLayers

		Dorm3dInstagramMediator = var_4
	...
	arg_1_0:bind(var_0_1.ON_UNLOCK_DORM_ROOM, function(arg_12_0, arg_12_1)
		...
		var_12_1(var_12_0, var_2_10005.APARTMENT_ROOM_UNLOCK, {
			roomId = arg_12_1
		})
...
function var_0_1.initNotificationHandleDic(arg_15_0)
	...
	var_15_0[var_1_10002.NotifyDormDownloadStart] = function(arg_16_0, arg_16_1)
		...
		var_16_2(var_16_1, var_2_10006.DormDownloadLock.roomId, "start")
	...
	var_15_0[var_2.NotifyDormDownloadProgress] = function(arg_17_0, arg_17_1)
		...
		var_17_2(var_17_1, var_2_10006.DormDownloadLock.roomId, "loading")
