...
function var_0_1.didEnter(arg_3_0)
	...
	var_1_10001(var_3_8, var_4.Find(var_3_9, "Mask"), function()
	...
	local var_3_12 = var_4.Find(var_3_11, "Window/Close")
	...
	var_1_10001(var_3.Find(var_3_14, "Window/Title"), arg_3_0.contextData.title)

	setText = var_1_10001

	local var_3_15 = arg_3_0._tf

	var_1_10001(var_3.Find(var_3_15, "Window/Content"), arg_3_0.contextData.content)

	setText = var_1_10001

	local var_3_16 = arg_3_0._tf
	local var_3_17 = var_3.Find(var_3_16, "Window/Confirm/Text")

	i18n = var_4

	var_1_10001(var_3_17, var_4("msgbox_text_confirm"))

	setText = var_1_10001

	local var_3_18 = arg_3_0._tf
	local var_3_19 = var_3.Find(var_3_18, "Window/Cancel/Text")

	i18n = var_4

	var_1_10001(var_3_19, var_4("msgbox_text_cancel"))
