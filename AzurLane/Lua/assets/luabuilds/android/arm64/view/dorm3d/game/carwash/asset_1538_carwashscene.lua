...
function var_0_1.preload(arg_7_0, arg_7_1)
	...
	var_2({
		function(arg_8_0)
			...
			var_8_1(var_8_0, var_8_2, var_8_3, var_2_10006.Additive, function(arg_9_0, arg_9_1)
		...
		function(arg_10_0)
			...
			var_10_1(var_10_0, var_10_2, var_10_3, var_2_10006.Additive, function(arg_11_0, arg_11_1)
				arg_10_0()
...
function var_0_1.InitPage(arg_20_0)
	...
	arg_20_0.gamePage = var_20_0(var_3.Find(var_20_1, "game"), arg_20_0.event, arg_20_0.contextData)
	CarWashPhase2Page = var_1

	local var_20_2 = var_1.New
	local var_20_3 = arg_20_0._tf

	arg_20_0.phase2Page = var_20_2(var_3.Find(var_20_3, "phase2"), arg_20_0.event, arg_20_0.contextData)
	CarWashEndPage = var_1

	local var_20_4 = var_1.New
	local var_20_5 = arg_20_0._tf

	arg_20_0.endPage = var_20_4(var_3.Find(var_20_5, "end"), arg_20_0.event, arg_20_0.contextData)
...
function var_0_1.InitSceneRefs(arg_21_0)
	...
	var_1_10001(var_1_10003.Find("Camera"), false)
	...
	typeof = var_4
	Camera = var_1_10006
	arg_21_0.mainCamera = var_21_1(var_21_0, var_4(var_1_10006))
	GameObject = var_1
	...
	typeof = var_4
	Camera = var_1_10006
	arg_21_0.raycastCamera = var_21_4(var_21_3, var_4(var_1_10006))
	...
	arg_21_0.sceneRaycaster = var_21_6(var_21_5, var_4(var_1_10006.EventSystems.PhysicsRaycaster))
...
function var_0_1.didEnter(arg_22_0)
	...
	var_22_1(var_22_0, var_1_10004.START_GAME, function()
...
function var_0_1.Update(arg_28_0)
	...
	if arg_28_0.systemManager then
		...
		var_28_1(var_28_0, var_1_10004.deltaTime)
	end
