...
function var_0_0.ParseInfo(arg_1_0)
	...
	return var_1_10001(var_1_10003.split(arg_1_0, "|"))
end
...
function var_0_0.Ctor(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_2 = {
		function(arg_3_0)
			...
			local var_3_2 = var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_2_1 .. "/" .. var_2_0 .. "_scene")
			local var_3_3 = var_2_0

			LoadSceneMode = var_6

			var_3_1(var_3_0, var_3_2, var_3_3, var_6.Additive, function(arg_4_0, arg_4_1)
		...
		function(arg_5_0)
			...
			local var_5_2 = var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_2_1 .. "/" .. var_2_0 .. "_base_scene")
			local var_5_3 = var_2_0 .. "_base"

			LoadSceneMode = var_6

			var_5_1(var_5_0, var_5_2, var_5_3, var_6.Additive, arg_5_0)
...
function var_0_0.EnableSceneDisplay(arg_6_0, arg_6_1, arg_6_2)
	...
	var_1_10003(var_1_10005(arg_6_0.lastSceneRootDict[arg_6_1]) == arg_6_2)
...
function var_0_0.LoadTimelineScene(arg_9_0, arg_9_1, arg_9_2)
	...
	if not arg_9_0.cacheSceneDic[arg_9_1.name] then
		...
		var_9_2.insert(var_9_0, function(arg_12_0)
			...
			local var_12_2 = var_2_10004.lower("dorm3d/character/" .. arg_9_1.assetRootName .. "/timeline/" .. arg_9_1.name .. "/" .. arg_9_1.name .. "_scene")
			local var_12_3 = arg_9_1.name

			LoadSceneMode = var_6

			var_12_1(var_12_0, var_12_2, var_12_3, var_6.Additive, function(arg_13_0, arg_13_1)
				...
				local var_13_2 = var_13_1(var_13_0, var_6(var_3_10008))

				setActive = var_4

				var_4(var_13_2, false)
				arg_12_0()
	...
	var_9_2.insert(var_9_0, function(arg_14_0)
		...
		if var_14_0 ~= var_2_10002(arg_9_1.isCache) then
...
function var_0_0.UnloadTimelineScene(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	local var_15_1 = var_1_10005(arg_15_2)
	...
	if var_15_1 == var_6(var_15_0.isCache) then
		...
		var_15_4(var_15_3, var_1_10009.lower("dorm3d/character/scenes/" .. var_15_2 .. "/timeline/" .. arg_15_1 .. "/" .. arg_15_1 .. "_scene"), arg_15_1, function()
...
function var_0_0.ChangeArtScene(arg_17_0, arg_17_1, arg_17_2)
	...
	if var_0_0.IsSameSceneInfo(arg_17_1, arg_17_0.sceneInfo) then
		...
		var_6.insert(var_17_0, function(arg_18_0)
			...
			local var_18_2 = var_3.SetActiveScene

			SceneManager = var_2_10005

			var_18_2(var_2_10005.GetSceneByName(var_18_0))
		...
		var_8.insert(var_17_0, function(arg_21_0)
			...
			local var_21_2 = var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_17_4 .. "/" .. var_17_3 .. "_scene")
			local var_21_3 = var_17_3

			LoadSceneMode = var_6

			var_21_1(var_21_0, var_21_2, var_21_3, var_6.Additive, function(arg_22_0, arg_22_1)
	...
	if var_0_0.IsSameSceneInfo(arg_17_0.artSceneInfo, arg_17_0.sceneInfo) then
		...
		var_8.insert(var_17_0, function(arg_24_0)
			...
			var_24_1(var_24_0, var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_17_6 .. "/" .. var_17_5 .. "_scene"), var_17_5, function()
...
function var_0_0.ChangeSubScene(arg_27_0, arg_27_1, arg_27_2)
	...
	if not var_0_0.IsSameSceneInfo(arg_27_1, arg_27_0.sceneInfo) then
		...
		var_8.insert(var_27_0, function(arg_30_0)
			...
			local var_30_2 = var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_27_4 .. "/" .. var_27_5 .. "_scene")
			local var_30_3 = var_27_5

			LoadSceneMode = var_6

			var_30_1(var_30_0, var_30_2, var_30_3, var_6.Additive, arg_30_0)
	...
	if not var_0_0.IsSameSceneInfo(arg_27_0.subSceneInfo, arg_27_0.sceneInfo) then
		...
		var_8.insert(var_27_0, function(arg_31_0)
			...
			var_31_1(var_31_0, var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_27_7 .. "/" .. var_27_6 .. "_scene"), var_27_6, arg_31_0)
...
function var_0_0.Dispose(arg_33_0)
	...
	for iter_33_0, iter_33_1 in var_1_10002(arg_33_0.cacheSceneDic) do
		if iter_33_1 then
			...
			var_1_10008.insert(var_33_0, function(arg_34_0)
				...
				var_34_1(var_34_0, var_2_10004.lower("dorm3d/character/scenes/" .. var_33_1 .. "/timeline/" .. iter_33_0 .. "/" .. iter_33_0 .. "_scene"), iter_33_0, arg_34_0)
	...
	for iter_33_2, iter_33_3 in var_3(var_33_2) do
		...
		var_10.insert(var_33_0, function(arg_35_0)
			...
			var_35_1(var_35_0, var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_33_4 .. "/" .. var_33_5 .. "_scene"), var_33_5, arg_35_0)
	...
	for iter_33_4, iter_33_5 in var_4(var_33_6) do
		...
		var_11.insert(var_33_0, function(arg_36_0)
			SceneOpMgr = var_2_10001
			...
			var_36_1(var_36_0, var_2_10004.lower("dorm3d/scenesres/scenes/" .. var_33_8 .. "/" .. var_33_7 .. "_scene"), var_33_7, arg_36_0)
...
function var_0_0.IsSameSceneInfo(arg_38_0, arg_38_1)
	...
	return var_38_0 == var_1_10003.lower(arg_38_1)
end
