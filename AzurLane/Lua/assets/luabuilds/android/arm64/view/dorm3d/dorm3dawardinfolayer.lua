...
function var_0_1.init(arg_2_0)
	...
	local function var_2_3()
		...
		local var_3_2 = var_3_1(var_3_0, var_2_10003(var_2_10005))
	...
	local var_2_6 = var_2_5(var_2_4, var_2_2(var_2_1))
	...
	var_1(var_2_8, var_4("child_close_tip"))
...
function var_0_1.didEnter(arg_5_0)
	...
	var_5_0(var_5_1, var_4.Find(var_5_2, "tpl"), #arg_5_0.contextData.items, function(arg_6_0, arg_6_1, arg_6_2)
		arg_6_1 = arg_6_1 + 1
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			local function var_6_3()
				...
				var_7_1(var_7_0, var_3_10003.ON_NEW_DROP, {
					style = "dorm",
					drop = var_6_0
				})
			...
			var_2_10004(var_6_1, var_6_2, var_6_3, var_2_10009)
		end
	...
	var_1_10002.insert(var_5_3, function(arg_8_0)
		local var_8_0 = arg_5_0
		local var_8_1 = var_1.managedTween

		LeanTween = var_2_10004

		var_8_1(var_8_0, var_2_10004.delayedCall, arg_8_0, 0.33, nil)
	...
	var_2(arg_5_0.itemContainer, function(arg_9_0)
		...
		if var_2_10001(arg_9_0) then
			...
			var_1.insert(var_5_3, function(arg_10_0)
				...
				var_10_1(var_10_0, var_4.delayedCall, arg_10_0, 0.066, nil)
	...
	var_2(var_5_3, function()
		...
		var_11_1(var_11_0, var_2_10003.delayedCall, function()
...
function var_0_1.onBackPressed(arg_13_0)
	...
	var_1_10001(var_3.Find(var_13_0, "bg"))
