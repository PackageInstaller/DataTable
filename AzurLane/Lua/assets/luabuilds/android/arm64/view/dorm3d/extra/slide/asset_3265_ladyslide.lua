...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5)
	...
	arg_1_0.animator = var_1_1(var_1_0, var_1_10009(var_1_10011))
...
function var_0_0.Reset(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10004.IDLE_ANIM)
...
function var_0_0.Check(arg_6_0, arg_6_1)
	...
	SlideConst = var_1_10007
	var_6_2[var_1_10007.COMMAND_TYPE.WALK] = function()
		return var_6_0(arg_6_1.target, arg_6_0._tf)
	end
	SlideConst = var_7
	var_6_2[var_7.COMMAND_TYPE.LADDER] = function()
		return var_6_0(arg_6_1.target, arg_6_0._tf)
	end
	SlideConst = var_7
	var_6_2[var_7.COMMAND_TYPE.SLIDE] = function()
		return arg_6_1.target.position.y >= arg_6_0._tf.position.y
	end
	SlideConst = var_7
	var_6_2[var_7.COMMAND_TYPE.TELEPORT] = function()
		return true
	end
	SlideConst = var_7
	var_6_2[var_7.COMMAND_TYPE.ANIM] = function()
	...
	SlideConst = var_7
	var_6_2[var_7.COMMAND_TYPE.ANIM_MOVE_ROTATE] = function()
...
function var_0_0.UpdateState(arg_14_0, arg_14_1)
	...
	SlideConst = var_1_10007
	var_14_2[var_1_10007.COMMAND_TYPE.WALK] = function()
	...
	SlideConst = var_7
	var_14_2[var_7.COMMAND_TYPE.LADDER] = function()
	...
	SlideConst = var_7
	var_14_2[var_7.COMMAND_TYPE.SLIDE] = function()
		...
		var_17_6(var_17_5, var_17_4 * var_2_10006.deltaTime)

		return
	end
	SlideConst = var_7
	var_14_2[var_7.COMMAND_TYPE.TELEPORT] = function()
	...
	SlideConst = var_7
	var_14_2[var_7.COMMAND_TYPE.ANIM] = function()
		return
	end
	SlideConst = var_7
	var_14_2[var_7.COMMAND_TYPE.ANIM_MOVE_ROTATE] = function()
...
function var_0_0.EnterState(arg_21_0, arg_21_1, arg_21_2)
	if arg_21_2:HasEffect() then
		...
		local var_21_1, var_21_2 = arg_21_2.GetEffect(var_21_0)

		LeanTween = var_21_0

		local var_21_3 = var_21_0.delayedCall

		var_1_10007 = var_21_1
		System = var_1_10008
		arg_21_0.vfxLTId = var_21_3(var_1_10007, var_1_10008.Action(function()
			arg_21_0.onPlayVFX(var_21_2)
	...
	if arg_21_2:HasWet() then
		...
		var_21_5, var_21_6 = arg_21_2.GetWet(var_21_4)
		LeanTween = var_21_4

		local var_21_7 = var_21_4.delayedCall

		var_1_10007 = var_21_5
		System = var_1_10008
		arg_21_0.wetLTId = var_21_7(var_1_10007, var_1_10008.Action(function()
			local var_23_0 = arg_21_0

			var_0.ShowWetness(var_23_0, var_21_6)
	...
	local var_21_8 = arg_21_1
	local var_21_9 = {}

	SlideConst = var_1_10007
	var_21_9[var_1_10007.COMMAND_TYPE.WALK] = function()
		local var_24_0 = arg_21_0.ladyEnv
		local var_24_1 = var_0.PlaySingleAction

		SlideConst = var_2_10003

		local var_24_2 = var_2_10003.WALK_ANIM
		local var_24_3
		local var_24_4 = arg_21_2

		var_24_1(var_24_0, var_24_2, var_24_3, var_5.GetFadeInTime(var_24_4))
	...
	SlideConst = var_7
	var_21_9[var_7.COMMAND_TYPE.LADDER] = function()
		local var_25_0 = arg_21_0.ladyEnv
		local var_25_1 = var_0.PlaySingleAction

		SlideConst = var_2_10003

		local var_25_2 = var_2_10003.LADDER_ANIM
		local var_25_3
		local var_25_4 = arg_21_2

		var_25_1(var_25_0, var_25_2, var_25_3, var_5.GetFadeInTime(var_25_4))
		...
		if 0 < var_25_6 then
			...
			Vector3 = var_2_10006
			var_25_7.rotation = var_25_8(var_25_9, var_2_10006.up)
		end
	...
	SlideConst = var_7
	var_21_9[var_7.COMMAND_TYPE.SLIDE] = function()
		arg_21_0.ladyEnv.characterController.enabled = true
		...
		local var_26_2 = var_2_10003.SLIDE_ANIM
		local var_26_3
		local var_26_4 = arg_21_2

		var_26_1(var_26_0, var_26_2, var_26_3, var_5.GetFadeInTime(var_26_4))
		...
		if 0 < var_26_5 then
			...
			Vector3 = var_2_10006
			var_26_6.rotation = var_26_7(var_26_8, var_2_10006.up)
		end
	...
	SlideConst = var_7
	var_21_9[var_7.COMMAND_TYPE.TELEPORT] = function()
		return
	end
	SlideConst = var_7
	var_21_9[var_7.COMMAND_TYPE.ANIM] = function()
		...
		var_28_1(var_28_0, var_28_2, var_28_3, var_5.GetFadeInTime(var_28_4))

		return
	end
	SlideConst = var_7
	var_21_9[var_7.COMMAND_TYPE.ANIM_MOVE_ROTATE] = function()
		...
		var_29_1(var_29_0, var_29_2, var_29_3, var_5.GetFadeInTime(var_29_4))
...
function var_0_0.ExitState(arg_30_0, arg_30_1)
	...
	var_30_1[var_1_10006.COMMAND_TYPE.WALK] = function()
		arg_30_0.ladyEnv.characterController.enabled = false

		return
	end
	SlideConst = var_6
	var_30_1[var_6.COMMAND_TYPE.LADDER] = function()
	...
	SlideConst = var_6
	var_30_1[var_6.COMMAND_TYPE.SLIDE] = function()
		arg_30_0.ladyEnv.characterController.enabled = false
	...
	SlideConst = var_6
	var_30_1[var_6.COMMAND_TYPE.TELEPORT] = function()
		return
	end
	SlideConst = var_6
	var_30_1[var_6.COMMAND_TYPE.ANIM] = function()
		return
	end
	SlideConst = var_6
	var_30_1[var_6.COMMAND_TYPE.ANIM_MOVE_ROTATE] = function()
		return
	end
...
function var_0_0.ShowWetness(arg_37_0, arg_37_1)
	if arg_37_0.wetTimer then
		local var_37_0 = arg_37_0.wetTimer
	...
	arg_37_0.wetTimer = var_1_10003.New(function()
		...
		var_37_1 = var_37_1 + 0.016666666666666666

		local var_38_2 = var_37_1

		SlideConst = var_1

		local var_38_3 = var_38_2 / var_1.WET_FADE_IN_TIME
		...
		var_38_7(var_38_6, var_4(arg_37_0._tf), var_38_5)

		return
	end, 0.016666666666666666, -1)

	local var_37_2 = arg_37_0.wetTimer

	var_3.Start(var_37_2)
...
function var_0_0.Cancel(arg_39_0)
	...
	var_39_2(var_39_1, var_1_10004(arg_39_0._tf), 0)
