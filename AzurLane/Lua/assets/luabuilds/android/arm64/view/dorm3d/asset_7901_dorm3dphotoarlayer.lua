...
function var_0_1.init(arg_2_0)
	...
	typeof = var_4
	YSTool = var_6
	arg_2_0.ysScreenShoter = var_2_26(var_2_25, var_4(var_6.YSScreenShoter))
	setText = var_1

	local var_2_27 = arg_2_0.panelCamera
	local var_2_28 = var_3.Find(var_2_27, "Layout/DepthOfField/Title/Text")

	i18n = var_4

	var_1(var_2_28, var_4("dorm3d_photo_len"))

	setText = var_1

	local var_2_29 = arg_2_0.panelCamera
	local var_2_30 = var_3.Find(var_2_29, "Layout/DepthOfField/Switch/Title")

	i18n = var_4

	var_1(var_2_30, var_4("dorm3d_photo_depthoffield"))

	setText = var_1

	local var_2_31 = arg_2_0.panelCamera
	local var_2_32 = var_3.Find(var_2_31, "Layout/DepthOfField/DepthOfField/FocusDistance/Title")

	i18n = var_4

	var_1(var_2_32, var_4("dorm3d_photo_focusdistance"))

	setText = var_1

	local var_2_33 = arg_2_0.panelCamera
	local var_2_34 = var_3.Find(var_2_33, "Layout/DepthOfField/DepthOfField/BlurRadius/Title")

	i18n = var_4

	var_1(var_2_34, var_4("dorm3d_photo_focusstrength"))

	setText = var_1

	local var_2_35 = arg_2_0.panelCamera
	local var_2_36 = var_3.Find(var_2_35, "Layout/Paramaters/Title/Text")

	i18n = var_4

	var_1(var_2_36, var_4("dorm3d_photo_paramaters"))

	setText = var_1

	local var_2_37 = arg_2_0.panelCamera
	local var_2_38 = var_3.Find(var_2_37, "Layout/Paramaters/PostExposure/PostExposure/Title")

	i18n = var_4

	var_1(var_2_38, var_4("dorm3d_photo_postexposure"))

	setText = var_1

	local var_2_39 = arg_2_0.panelCamera
	local var_2_40 = var_3.Find(var_2_39, "Layout/Paramaters/Saturation/Saturation/Title")

	i18n = var_4

	var_1(var_2_40, var_4("dorm3d_photo_saturation"))

	setText = var_1

	local var_2_41 = arg_2_0.panelCamera
	local var_2_42 = var_3.Find(var_2_41, "Layout/Paramaters/Contrast/Contrast/Title")

	i18n = var_4

	var_1(var_2_42, var_4("dorm3d_photo_contrast"))

	setText = var_1

	local var_2_43 = arg_2_0.panelCamera
	local var_2_44 = var_3.Find(var_2_43, "Layout/Other/Title/Text")

	i18n = var_4

	var_1(var_2_44, var_4("dorm3d_photo_Others"))

	setText = var_1

	local var_2_45 = arg_2_0.panelCamera
	local var_2_46 = var_3.Find(var_2_45, "Layout/Other/HideCharacter/Title")

	i18n = var_4

	var_1(var_2_46, var_4("dorm3d_photo_hidecharacter"))

	setText = var_1

	local var_2_47 = arg_2_0.panelCamera
	local var_2_48 = var_3.Find(var_2_47, "Layout/Other/FaceCamera/Title")

	i18n = var_4

	var_1(var_2_48, var_4("dorm3d_photo_facecamera"))

	setText = var_1

	local var_2_49 = arg_2_0.panelLightning
	local var_2_50 = var_3.Find(var_2_49, "Layout/Title/Lighting/Name")

	i18n = var_4

	var_1(var_2_50, var_4("dorm3d_photo_lighting"))

	setText = var_1

	local var_2_51 = arg_2_0.panelLightning
	local var_2_52 = var_3.Find(var_2_51, "Layout/Title/Lighting/Selected")

	i18n = var_4

	var_1(var_2_52, var_4("dorm3d_photo_lighting"))

	setText = var_1

	local var_2_53 = arg_2_0.panelLightning
	local var_2_54 = var_3.Find(var_2_53, "Layout/Title/Filter/Name")

	i18n = var_4

	var_1(var_2_54, var_4("dorm3d_photo_filter"))

	setText = var_1

	local var_2_55 = arg_2_0.panelLightning
	local var_2_56 = var_3.Find(var_2_55, "Layout/Title/Filter/Selected")

	i18n = var_4

	var_1(var_2_56, var_4("dorm3d_photo_filter"))

	setText = var_1

	local var_2_57 = arg_2_0.panelLightning
	local var_2_58 = var_3.Find(var_2_57, "Layout/Lighting/Strength/Name")

	i18n = var_4

	var_1(var_2_58, var_4("dorm3d_photo_strength"))

	setText = var_1

	local var_2_59 = arg_2_0.panelAction
	local var_2_60 = var_3.Find(var_2_59, "Layout/Title/Regular/Name")

	i18n = var_4

	var_1(var_2_60, var_4("dorm3d_photo_regular_anim"))

	setText = var_1

	local var_2_61 = arg_2_0.panelAction
	local var_2_62 = var_3.Find(var_2_61, "Layout/Title/Regular/Selected")

	i18n = var_4

	var_1(var_2_62, var_4("dorm3d_photo_regular_anim"))

	setText = var_1

	local var_2_63 = arg_2_0.panelAction
	local var_2_64 = var_3.Find(var_2_63, "Layout/Title/Special/Name")

	i18n = var_4

	var_1(var_2_64, var_4("dorm3d_photo_special_anim"))

	setText = var_1

	local var_2_65 = arg_2_0.panelAction
	local var_2_66 = var_3.Find(var_2_65, "Layout/Title/Special/Selected")

	i18n = var_4

	var_1(var_2_66, var_4("dorm3d_photo_special_anim"))
...
function var_0_1.SetARLite(arg_6_0, arg_6_1)
	...
	if arg_6_0.ARCheck then
		...
		typeof = var_6
		Camera = var_1_10008
		arg_6_0.mainCamera = var_6_2(var_6_1, var_6(var_1_10008))
	else
		GameObject = var_6_2
		...
		typeof = var_6
		Camera = var_1_10008
		arg_6_0.mainCamera = var_6_4(var_6_3, var_6(var_1_10008))
	end
...
function var_0_1.onBackPressed(arg_7_0)
	...
	if arg_7_0.activeSetting then
		...
		var_1(var_3.Find(var_7_0, "Center/Settings/Back"))
...
function var_0_1.didEnter(arg_8_0)
	...
	var_1_10001(var_3.Find(var_8_0, "Center/Normal/Back"), false)

	onButton = var_1_10001

	local var_8_1 = arg_8_0
	local var_8_2 = arg_8_0._tf
	local var_8_3 = var_4.Find(var_8_2, "Center/Normal/Back")
	...
	var_1_10001(var_8_1, var_8_3, var_8_4, var_8_2)
	...
	var_1_10002(var_8_6, 0, 1, 0)

	onSlider = var_1_10002

	var_1_10002(arg_8_0, var_8_6, function(arg_10_0)
		...
		var_10_2(var_10_1, var_2_10005.SCENE_CALL, "SetPinchValue", var_10_0)
	...
	local var_8_9 = var_5.Find(var_8_8, "Center/Normal/Settings")
	...
	local function var_8_10()
		...
		var_11_0(var_2.Find(var_11_1, "Center"), "anim_dorm3d_photo_normal_out")
		...
		var_11_3(var_11_2, var_3.ACTIVE_AR_UI, false)
	...
	var_2(var_8_7, var_8_9, var_8_10, var_8_8)

	onButton = var_2

	local var_8_11 = arg_8_0
	local var_8_12 = arg_8_0._tf
	local var_8_13 = var_5.Find(var_8_12, "Center/Settings/Back")
	...
	local function var_8_14()
		...
		var_12_0(var_2.Find(var_12_1, "Center"), "anim_dorm3d_photo_normal_in")
		...
		var_12_3(var_12_2, var_3.ACTIVE_AR_UI, true)
	...
	var_2(var_8_11, var_8_13, var_8_14, var_8_12)
	...
	var_2(var_8_15, var_8_16, var_8_17, var_8_12)
	...
	local function var_8_20()
		...
		Dorm3dPhotoARMediator = var_2_10003

		var_15_1(var_15_0, var_2_10003.SCENE_CALL, "ResetPhotoCameraPosition")
	...
	var_2(var_8_18, var_8_19, var_8_20, var_8_12)
	...
	local function var_8_23()
		local function var_16_0(arg_17_0)
			...
			var_17_3(var_17_2, var_4.ACTIVE_AR_UI, arg_17_0)
		...
		if not arg_8_0.recordState then
			...
			local function var_16_2()
				...
				var_19_1(var_19_0, var_3.Action(function()
					var_0_1.SetMute(true)

					local var_20_0 = arg_8_0

					YSNormalTool = var_4_10001
					var_20_0.recordFilePath = var_4_10001.RecordTool.GenRecordFilePath()
			...
			var_2_10003({
				...
				function(arg_22_0)
					...
					if not var_1.GetInt("hadShowForVideoTipDorm", 0) or var_1 <= 0 then
						...
						i18n = var_3
						var_22_2.text = var_3("word_take_video_tip")
						onButton = var_22_2
	...
	var_2(var_8_21, var_8_22, var_8_23, var_8_12)
	...
	var_2(arg_8_0, arg_8_0.stopRecBtn, function()
		local function var_24_0(arg_25_0)
			if arg_25_0 then
				...
				if var_3_10001 == var_3_10002 then
					...
					i18n = var_3_10005
					var_25_2.content = var_3_10005("word_save_video")
					...
					function var_25_2.onYes()
						...
						var_4_10000.MediaTool.SaveVideoToAlbum(arg_8_0.recordFilePath, function(arg_28_0, arg_28_1)
							if arg_28_0 then
								...
								var_28_1(var_28_0, var_5_10005("word_save_ok"))
		...
		local function var_24_1(arg_29_0)
			...
			var_29_3(var_29_2, var_4.ACTIVE_AR_UI, arg_29_0)
		...
		if not var_24_2(var_2_10004(arg_8_0.stopRecBtn)) then
			LeanTween = var_2
	...
	local var_8_26 = var_5.Find(var_8_25, "RightTop/Film/Switch")

	local function var_8_27()
		GetOrAddComponent = var_2_10000

		local var_32_0 = arg_8_0._tf
		local var_32_1 = var_2.Find(var_32_0, "RightTop/Film")

		typeof = var_2_10003
		CanvasGroup = var_5
		var_2_10000(var_32_1, var_2_10003(var_5)).blocksRaycasts = false
		quickPlayAnimation = var_1

		local var_32_2 = arg_8_0._tf

		var_1(var_3.Find(var_32_2, "RightTop"), "anim_dorm3d_photo_FtoS")
	...
	var_2(var_8_24, var_8_26, var_8_27, var_8_25)
	...
	var_2(var_8_28, var_5.Find(var_8_29, "RightTop/Shot/Shot"), function()
		local function var_33_0(arg_34_0)
			...
			var_3_10001(var_3.Find(var_34_0, "RightTop"), arg_34_0)
			...
			local var_34_2 = var_34_1(var_3, 1)

			if 0 < var_34_2 then
				setActive = var_2
				pg = var_4

				var_2(var_4.UIMgr.GetInstance().OverlayEffect, arg_34_0)
			end
		...
		local function var_33_1(arg_35_0)
			...
			var_3_10001(var_35_0 .. var_3_10004(arg_35_0))
		...
		local function var_33_2(arg_36_0, arg_36_1)
			...
			Dorm3dPhotoARMediator = var_3_10005

			var_36_1(var_36_0, var_3_10005.SHARE_PANEL, arg_36_1, arg_36_0)
			...
			local var_36_4 = var_5.APARTMENT_TRACK

			Dorm3dTrackCommand = var_6

			local var_36_5 = var_6.BuildDataCamera
			local var_36_6 = arg_8_0.groupId
			local var_36_7 = 3
			local var_36_8 = arg_8_0.room
			local var_36_9 = var_10.GetConfigID(var_36_8)

			Dorm3dCameraAnim = var_3_10011

			local var_36_10 = var_3_10011.New({
				configId = arg_8_0.animID
			})

			var_36_3(var_36_2, var_36_4, var_36_5(var_36_6, var_36_7, var_36_9, var_11.GetStateName(var_36_10)))
	...
	local var_8_31 = var_4.Find(var_8_30, "RightTop/Film")

	typeof = var_5
	CanvasGroup = var_7
	var_2(var_8_31, var_5(var_7)).blocksRaycasts = false
	onButton = var_3

	local var_8_32 = arg_8_0
	local var_8_33 = arg_8_0._tf
	local var_8_34 = var_6.Find(var_8_33, "RightTop/Shot/Switch")

	local function var_8_35()
		GetOrAddComponent = var_2_10000

		local var_38_0 = arg_8_0._tf
		local var_38_1 = var_2.Find(var_38_0, "RightTop/Film")

		typeof = var_2_10003
		CanvasGroup = var_5
		var_2_10000(var_38_1, var_2_10003(var_5)).blocksRaycasts = true
		quickPlayAnimation = var_1

		local var_38_2 = arg_8_0._tf

		var_1(var_3.Find(var_38_2, "RightTop"), "anim_dorm3d_photo_StoF")
	...
	var_3(var_8_32, var_8_34, var_8_35, var_8_33)
	...
	local function var_8_38()
		...
		var_2_10000(var_39_0, not var_2_10003(arg_8_0.listAnimSpeed))
	...
	var_3(var_8_36, var_8_37, var_8_38, var_8_33)
	...
	local function var_8_41()
		...
		var_2_10001(arg_8_0.listZones, not var_40_0)
	...
	var_3(var_8_39, var_8_40, var_8_41, var_8_33)
	...
	var_3(arg_8_0, arg_8_0.btnAr, function()
		...
		var_42_1(var_42_0, var_2_10003.GO_AR)
	...
	var_4.Ipairs(var_8_42, function(arg_49_0, arg_49_1)
		...
		var_2_10002(var_49_0, var_49_1, var_49_2, var_2_10007)
	...
	Dorm3dPhotoARMediator = var_9

	var_8_44(var_8_43, var_9.AR_PHOTO_INITED)
...
function var_0_1.UpdateActionPanel(arg_56_0)
	...
	local function var_56_4()
		...
		var_57_0(var_57_1, var_3.GetChild(var_57_2, 0), #var_56_1, function(arg_58_0, arg_58_1, arg_58_2)
			...
			if var_58_0:GetConfigID() == arg_56_0.animID then
				tobool = var_7
				var_58_2 = var_7(arg_56_0.timerAnim)
			else
				var_58_2 = false
			end
	...
	local function var_56_5(arg_59_0, arg_59_1)
		...
		local var_59_1 = arg_59_0.GetConfigID(var_59_0)

		if arg_56_0.animID == var_59_1 then
			return
		end

		local var_59_2 = arg_56_0
		local var_59_3 = var_3.GetAnimPlayList(var_59_2, var_59_1)

		Dorm3dCameraAnim = var_59_0

		local var_59_4 = var_59_0.New({
			configId = arg_56_0.animID
		})
		local var_59_5 = var_4.GetFinishAnimID(var_59_4)

		arg_56_0.animID = var_59_1

		var_56_4()

		local var_59_6 = arg_56_0

		var_5.BlockActionPanel(var_59_6, true)

		local var_59_7 = arg_56_0

		var_59_7.animPlaying = true
		table = var_59_7

		local var_59_8 = var_59_7.indexof
		local var_59_9 = var_59_3

		_ = var_8

		local var_59_10 = (var_59_8(var_59_9, var_8.detect(var_59_3, function(arg_60_0)
			return arg_60_0:GetConfigID() == var_59_5
		end)) or 0) + 1

		_ = var_6

		local var_59_11 = var_6.rest(var_59_3, var_59_10)
		...
		local var_59_14 = var_59_13(var_59_12, var_9(var_11))

		setActive = var_59_9

		var_59_9(arg_59_1:Find("Slider"), true)
		...
		local function var_59_15()
			...
			var_3_10000(var_2.Find(var_61_0, "Selected"), true)

			setActive = var_3_10000

			local var_61_1 = arg_59_1

			var_3_10000(var_2.Find(var_61_1, "Slider"), false)
		...
		Time = var_59_17
		var_59_19.startStamp = var_59_17.time
		...
		var_59_20.timerAnim = var_59_19.New(function()
			...
			local var_63_1 = var_2.max(var_0_2, var_63_0:GetAnimTime())
			local var_63_2 = var_0.startStamp

			Time = var_4

			local var_63_3 = var_4.time

			math = var_5

			local var_63_4 = var_5.min(1, var_0.ratio + (var_63_3 - var_63_2) * arg_56_0.animSpeed / var_63_1)
			local var_63_5 = var_0.passedTime + var_63_1 * var_63_4

			var_59_14.value = var_63_5 / var_59_16
			...
			var_0.ratio = 0
			var_0.passedTime = var_0.passedTime + var_63_1
			var_0.startStamp = var_63_3
			warning = var_7
			...
			if var_0.index > #var_0.animPlayList then
				...
				local var_63_6 = arg_56_0.timerAnim
			...
			local var_63_7 = var_0.animPlayList[var_0.index]
			local var_63_8 = arg_56_0
			local var_63_9 = var_8.emit

			Dorm3dPhotoARMediator = var_3_10011

			var_63_9(var_63_8, var_3_10011.SCENE_CALL, "PlaySingleAction", var_63_7:GetStateName())
		...
		if var_59_10 == 1 then
			...
			Dorm3dPhotoARMediator = var_13

			var_59_23(var_59_22, var_13.SCENE_CALL, "SwitchAnim", var_59_21:GetStateName())
			...
			var_59_23(function()
				...
				Dorm3dPhotoARMediator = var_3_10003

				var_64_1(var_64_0, var_3_10003.SCENE_CALL, "ResetCharPos")
			...
			var_59_25(var_59_24, var_13.SCENE_CALL, "PlaySingleAction", var_59_21:GetStateName())
		end
	...
	var_5.StaticAlign(var_56_3, var_56_3:GetChild(0), #var_56_1, function(arg_65_0, arg_65_1, arg_65_2)
		...
		var_2_10004(var_6.format("Dorm3DPhoto/%s", var_65_0:GetZoneIcon()), "", arg_65_2:Find("Icon"))
...
function var_0_1.SetPhotoUIActive(arg_68_0, arg_68_1)
	...
	var_1_10002(var_4.Find(var_68_0, "RightTop"), arg_68_1)

	setActive = var_1_10002

	local var_68_1 = arg_68_0._tf

	var_1_10002(var_4.Find(var_68_1, "Center"), arg_68_1)
...
function var_0_1.GetAnimPlayList(arg_69_0, arg_69_1)
	...
	while true do
		...
		var_1_10005.insert(var_69_1, 1, var_1_10004)
...
function var_0_1.SetCamaraPinchSliderValue(arg_72_0, arg_72_1)
	...
	var_1_10003(var_72_1, 0, 1, 1 - (arg_72_1 - 0.5) / 0.5)
