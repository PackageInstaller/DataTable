...
function var_0_1.Init(arg_1_0)
	...
	arg_1_0.controller = var_1_3(var_1_2, var_4(var_1_10006))
...
function var_0_1.InitDragEvent(arg_4_0)
	...
	var_1.AddBeginDragFunc(var_4_0, function(arg_5_0, arg_5_1)
		...
		var_5_2(var_5_1, var_5.ON_BEGIN_DRAG, arg_5_0, arg_5_1)
	...
	var_1.AddDragFunc(var_4_1, function(arg_6_0, arg_6_1)
		...
		AimIKSystem = var_2_10005

		var_6_1(var_6_0, var_2_10005.ON_DRAG, arg_6_0, arg_6_1)
	...
	var_1.AddDragEndFunc(var_4_2, function(arg_7_0, arg_7_1)
		...
		var_7_2(var_7_1, var_2_10005.ON_END_DRAG, arg_7_0, arg_7_1)
...
function var_0_1.FlushHint(arg_10_0)
	...
	AimIKSystem = var_1_10005

	var_10_2(var_10_1, var_1_10005.GET_TIP_SHOW_INFO, var_10_0)

	local var_10_3 = var_10_0[1]

	UIItemList = var_1_10003

	local var_10_4 = var_1_10003.StaticAlign
	local var_10_5 = arg_10_0.tipTF
	local var_10_6 = arg_10_0.tipTF

	var_10_4(var_10_5, var_6.GetChild(var_10_6, 0), #var_10_3, function(arg_11_0, arg_11_1, arg_11_2)
		...
		LuaHelper = var_2_10006

		local var_11_1 = var_2_10006.ScreenToLocal
		local var_11_2 = arg_10_0.tipTF
		local var_11_3 = var_10_3[arg_11_1].pos

		pg = var_2_10010

		var_3(var_11_0, var_11_1(var_11_2, var_11_3, var_2_10010.UIMgr.GetInstance().uiCameraComp))
