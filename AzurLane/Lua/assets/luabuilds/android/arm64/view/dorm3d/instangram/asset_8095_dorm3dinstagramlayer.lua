...
function var_0_1.GetInstagramList(arg_2_0)
	...
	local var_2_1 = var_1_10002(var_4)
...
function var_0_1.init(arg_3_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_3_0.imageTF = var_3_10(var_3_9, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.likeCntTxt = var_3_16(var_3_15, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.pushTimeTxt = var_3_19(var_3_18, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.nameTxt = var_3_23(var_3_22, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.contentTxt = var_3_27(var_3_26, var_4(var_1_10006))
	UIItemList = var_1

	local var_3_28 = var_1.New
	local var_3_29 = arg_3_0._tf
	local var_3_30 = var_3.Find(var_3_29, "main/right_panel/center/bottom/scroll/content")
	local var_3_31 = arg_3_0._tf

	arg_3_0.commentList = var_3_28(var_3_30, var_4.Find(var_3_31, "main/right_panel/center/bottom/scroll/content/tpl"))
	...
	local var_3_36 = var_3.Find(var_3_35, "main_bg/Text")

	i18n = var_4

	var_1(var_3_36, var_4("dorm3d_privatechat_topics"))
	...
	var_1(var_3_38, var_4("dorm3d_ins_no_msg"))
...
function var_0_1.ExitDetail(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10004.ON_EXIT, arg_14_0.contextData.instagram.id)
...
function var_0_1.MarkRead(arg_15_0, arg_15_1)
	if arg_15_1 and not arg_15_1:IsRead() then
		...
		Dorm3dInstagramMediator = var_1_10005

		var_15_1(var_15_0, var_1_10005.ON_READ, arg_15_1.id)
	end
...
function var_0_1.InitDetailPage(arg_16_0)
	...
	var_16_1("Dorm3dIns/" .. var_16_0:GetPicture(), function(arg_17_0)
	...
	if var_16_0:GetBackground() and var_2 ~= "" then
		LoadSpriteAsync = var_3

		var_3("Dorm3dIns/" .. var_2, function(arg_18_0)
			setImageSprite = var_2_10001
	...
	local var_16_2 = arg_16_0.iconTF

	LoadSprite = var_1_10006

	var_3(var_16_2, var_1_10006("qicon/" .. var_16_0:GetIcon()), false)

	arg_16_0.nameTxt.text = var_16_0:GetName()

	local var_16_3 = arg_16_0.contentTxt

	var_16_3.text = var_16_0:GetText()
	onToggle = var_16_3

	local var_16_4 = arg_16_0
	local var_16_5 = arg_16_0.commentPanel

	local function var_16_6(arg_19_0)
		if arg_19_0 then
	...
	var_16_3(var_16_4, var_16_5, var_16_6, var_8)
...
function var_0_1.UpdateShareBtn(arg_20_0)
	...
	local function var_20_3()
		...
		var_21_1(var_21_0, var_2_10003.ON_SHARE, var_20_0.id)
	...
	var_1_10002(var_20_1, var_20_2, var_20_3, var_1_10007)
...
function var_0_1.UpdateLikeBtn(arg_22_0)
	...
	if not var_1:IsGood() then
		onButton = var_1_10003

		local var_22_0 = arg_22_0
		local var_22_1 = arg_22_0.likeBtn
		...
		local function var_22_2()
			...
			var_23_1(var_23_0, var_2_10003.ON_LIKE, var_0.id)
		...
		var_1_10003(var_22_0, var_22_1, var_22_2, var_1_10008)
	else
		removeOnButton = var_1_10003

		var_1_10003(arg_22_0.likeBtn)
	end

	setActive = var_1_10003

	local var_22_3 = arg_22_0.likeBtn

	var_1_10003(var_5.Find(var_22_3, "heart"), var_2)

	local var_22_4 = arg_22_0.likeBtn
	local var_22_5 = var_3.GetComponent

	typeof = var_6
	Image = var_8
	var_22_5(var_22_4, var_6(var_8)).enabled = not var_2
...
local function var_0_2(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_1 = var_1_10003(arg_25_2.GetText(var_25_0))

	setText = var_1_10004

	local var_25_2 = arg_25_1:Find("main/content")

	HXSet = var_25_0

	var_1_10004(var_25_2, var_25_0.hxLan(var_25_1))

	setText = var_1_10004

	var_1_10004(arg_25_1:Find("main/time"), arg_25_2:GetPushTime())

	isa = var_1_10004

	local var_25_3 = arg_25_2

	InstagramPlayerComment3Dorm = var_7

	if var_1_10004(var_25_3, var_7) then
		setImageSprite = var_4

		local var_25_4 = arg_25_1:Find("main/head/icon")

		GetSpriteFromAtlas = var_7

		var_4(var_25_4, var_7("ui/InstagramUI_atlas", "txdi_3"))
	else
		setImageSprite = var_4

		local var_25_5 = arg_25_1:Find("main/head/icon")

		LoadSprite = var_7

		var_4(var_25_5, var_7("qicon/" .. arg_25_2:GetIcon()), false)
	end
...
local function var_0_3(arg_26_0, arg_26_1, arg_26_2)
	...
	local var_26_2 = var_1_10004.select(var_26_1, function(arg_27_0)
		return arg_27_0:CanShow()
	end)

	UIItemList = var_26_0

	local var_26_3 = var_26_0.New(arg_26_1:Find("replys"), arg_26_1:Find("replys/sub"))
	...
	var_26_3:make(function(arg_29_0, arg_29_1, arg_29_2)
		...
		if arg_29_0 == var_2_10003.EventUpdate then
			...
			local var_29_1 = arg_29_2:Find("head/icon")

			LoadSprite = var_2_10007

			var_4(var_29_1, var_2_10007("qicon/" .. var_29_0:GetIcon()), false)

			SwitchSpecialChar = var_4

			local var_29_2 = var_29_0
			local var_29_3 = var_4(var_29_0.GetText(var_29_2))

			setText = var_2_10005

			local var_29_4 = arg_29_2:Find("content")

			HXSet = var_29_2

			var_2_10005(var_29_4, var_29_2.hxLan(var_29_3))
		end
...
local function var_0_4(arg_30_0, arg_30_1, arg_30_2)
	if arg_30_2:ExistAnyReplay() then
		onToggle = var_1_10004

		local var_30_0 = arg_30_0
		local var_30_1 = arg_30_1
		local var_30_2 = arg_30_1.Find(var_30_1, "main/bubble")
		...
		local function var_30_3(arg_31_0)
			...
			var_2_10001(var_3.Find(var_31_0, "replys"), arg_31_0)
		...
		var_1_10004(var_30_0, var_30_2, var_30_3, var_30_1)
		var_0_3(arg_30_0, arg_30_1, arg_30_2)
	else
		setActive = var_1_10004

		var_1_10004(arg_30_1:Find("replys"), false)
	end

	triggerToggle = var_1_10004

	var_1_10004(arg_30_1:Find("main/bubble"), var_3)
	...
	typeof = var_7
	Toggle = var_9
	var_30_5(var_30_4, var_7(var_9)).enabled = var_3
...
function var_0_1.UpdateCommentList(arg_32_0)
	...
	local var_32_2 = var_1_10003.select(var_32_1, function(arg_33_0)
		return arg_33_0:CanShow()
	end)

	table = var_32_0

	var_32_0.sort(var_32_2, function(arg_34_0, arg_34_1)
...
function var_0_1.OpenPlayerCommentPanel(arg_36_0)
	...
	typeof = var_1_10006
	Image = var_1_10008
	var_36_3(var_36_2, var_1_10006(var_1_10008)).enabled = true
	...
	local var_36_8 = var_36_5(var_36_6, var_6.Find(var_36_7, "option1"))
	...
	var_3.make(var_36_8, function(arg_37_0, arg_37_1, arg_37_2)
		...
		if arg_37_0 == var_2_10003.EventUpdate then
			...
			local var_37_4 = arg_37_2:Find("Text")

			HXSet = var_2_10010

			var_2_10007(var_37_4, var_2_10010.hxLan(var_37_1))

			onButton = var_2_10007

			local var_37_5 = arg_36_0
			local var_37_6 = arg_37_2

			local function var_37_7()
				local var_38_0 = arg_36_0
				local var_38_1 = var_0.emit

				Dorm3dInstagramMediator = var_3_10003

				var_38_1(var_38_0, var_3_10003.ON_DISCUSS, var_0.id, var_37_2, var_37_3)
			...
			var_2_10007(var_37_5, var_37_6, var_37_7, var_12)
		end
...
function var_0_1.ClosePlayerCommentPanel(arg_39_0)
	...
	typeof = var_1_10004
	Image = var_1_10006
	var_39_1(var_39_0, var_1_10004(var_1_10006)).enabled = false
