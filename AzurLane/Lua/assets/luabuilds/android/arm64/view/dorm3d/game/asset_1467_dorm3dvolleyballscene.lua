...
function var_0_1.preload(arg_3_0, arg_3_1)
	...
	var_3_2(var_3_1, var_6.getApartment(var_3_3, var_3_0))
	...
	var_3({
		function(arg_4_0)
			...
			local var_4_2 = var_2_10004.lower("dorm3d/scenesres/scenes/" .. arg_3_0.sceneRootName .. "/" .. arg_3_0.sceneName .. "_scene")
			local var_4_3 = arg_3_0.sceneName

			LoadSceneMode = var_6

			var_4_1(var_4_0, var_4_2, var_4_3, var_6.Additive, function(arg_5_0, arg_5_1)
		...
		function(arg_6_0)
			...
			local var_6_4 = var_2_10006.lower("dorm3d/character/" .. var_6_0 .. "/timeline/" .. var_6_1 .. "/" .. var_6_1 .. "_scene")
			local var_6_5 = var_6_1

			LoadSceneMode = var_8

			var_6_3(var_6_2, var_6_4, var_6_5, var_8.Additive, function(arg_7_0, arg_7_1)
				arg_6_0()
...
function var_0_1.init(arg_9_0)
	...
	local var_9_0 = var_1.GetTimelineMainCharacter()

	Dorm3dHxHelper = var_1_10002

	var_1_10002.ReplaceCharacterParts(var_9_0)

	Dorm3dHxHelper = var_2

	var_2.HideCharacterPart(var_9_0, nil, true)
...
function var_0_1.initUI(arg_10_0)
	...
	local var_10_3 = var_3.Find(var_10_2, "Title/Text")

	i18n = var_4

	var_1(var_10_3, var_4("dorm3d_volleyball_title"))
	...
	local var_10_11 = var_10_10(var_10_9, var_4(var_6))
	...
	var_1.SetEndEvent(var_10_11, function()
		...
		var_11_0(var_2.Find(var_11_1, "Count"), false)
		...
		var_0(var_2.Find(var_11_3, "Score"), true)
	...
	local var_10_16 = var_3.Find(var_10_15, "AgainBtn/Text")

	i18n = var_4

	var_1(var_10_16, var_4("dorm3d_minigame_again"))

	setText = var_1

	local var_10_17 = arg_10_0.resultUI
	local var_10_18 = var_3.Find(var_10_17, "CloseBtn/Text")

	i18n = var_4

	var_1(var_10_18, var_4("dorm3d_minigame_close"))
	...
	local var_10_21 = var_10_20(var_10_19, var_4(var_6))
	...
	typeof = var_5
	Text = var_1_10007
	arg_10_0.debugTimelineName = var_10_25(var_10_24, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_10_0.debugTrackName = var_10_27(var_10_26, var_5(var_1_10007))
...
function var_0_1.BindEvent(arg_14_0)
	...
	local var_14_2 = var_4.Find(var_14_1, "Title/BackBtn")
	...
	local var_14_6 = var_4.Find(var_14_5, "SkipBtn")
	...
	var_1_10001(var_14_4, var_14_6, var_14_7, var_14_5)
	...
	local function var_14_10()
		...
		Dorm3dGameMediatorTemplate = var_2_10003

		var_18_1(var_18_0, var_2_10003.TRIGGER_FAVOR, arg_14_0.apartment.configId)
	...
	var_1_10001(var_14_8, var_14_9, var_14_10, var_14_5)

	onButton = var_1_10001

	local var_14_11 = arg_14_0
	local var_14_12 = arg_14_0.resultUI
	local var_14_13 = var_4.Find(var_14_12, "AgainBtn")
	...
	var_1_10001(var_14_11, var_14_13, var_14_14, var_14_12)

	onButton = var_1_10001

	local var_14_15 = arg_14_0
	local var_14_16 = arg_14_0.resultUI
	local var_14_17 = var_4.Find(var_14_16, "CloseBtn")
	...
	SFX_CANCEL = var_14_16

	var_1_10001(var_14_15, var_14_17, var_14_18, var_14_16)
...
function var_0_1.initScene(arg_21_0)
	...
	var_1_10002.IpairsCArray(var_21_1, function(arg_22_0, arg_22_1)
		...
		elseif arg_22_1.name == "PlayerCamera" then
			...
			typeof = var_2_10006
			Camera = var_2_10008
			var_22_6.ballCameraComp = var_22_8(var_22_7, var_2_10006(var_2_10008))
			setActive = var_22_6
		...
		elseif arg_22_1.name == "TriggerPlane" then
			...
			local var_22_12 = var_22_11(var_22_10, var_2_10006(var_2_10008.MeshCollider)).sharedMesh
			local var_22_13 = arg_21_0

			Plane = var_22_10

			local var_22_14 = var_22_10.New
			local var_22_15 = var_22_12.normals[0]

			Vector3 = var_8
			var_22_13.ballCreatePlane = var_22_14(var_22_15, -var_8.Dot(var_2.position, var_22_12.normals[0]))
			tf = var_22_13
			...
			var_5(var_22_18, var_8(arg_21_0.volleyballCfg.BallQtePlane[1][1], arg_21_0.volleyballCfg.BallQtePlane[1][2], arg_21_0.volleyballCfg.BallQtePlane[1][3]))
			...
			var_5(var_22_19, var_8(arg_21_0.volleyballCfg.BallQtePlane[2][1], arg_21_0.volleyballCfg.BallQtePlane[2][2], arg_21_0.volleyballCfg.BallQtePlane[2][3]))
			...
			local var_22_22 = var_22_21(var_22_20, var_8(var_10.MeshCollider)).sharedMesh
			local var_22_23 = arg_21_0

			Plane = var_22_20

			local var_22_24 = var_22_20.New
			local var_22_25 = var_22_22.normals[0]

			Vector3 = var_10
			var_22_23.ballQtePlane = var_22_24(var_22_25, -var_10.Dot(var_22_17.position, var_22_22.normals[0]))
			tf = var_22_23
			...
			var_7(var_22_28, var_10(arg_21_0.volleyballCfg.BallMissPlane[1][1], arg_21_0.volleyballCfg.BallMissPlane[1][2], arg_21_0.volleyballCfg.BallMissPlane[1][3]))
			...
			var_7(var_22_29, var_10(arg_21_0.volleyballCfg.BallMissPlane[2][1], arg_21_0.volleyballCfg.BallMissPlane[2][2], arg_21_0.volleyballCfg.BallMissPlane[2][3]))
			...
			local var_22_32 = var_22_31(var_22_30, var_10(var_12.MeshCollider)).sharedMesh
			local var_22_33 = arg_21_0

			Plane = var_22_30

			local var_22_34 = var_22_30.New
			local var_22_35 = var_22_32.normals[0]

			Vector3 = var_12
			var_22_33.ballMissPlane = var_22_34(var_22_35, -var_12.Dot(var_22_27.position, var_22_32.normals[0]))
		end
	...
	var_4.IpairsCArray(var_21_3, function(arg_23_0, arg_23_1)
		...
		local var_23_4 = var_23_3(var_23_2, var_2_10006(var_2_10008.Playables.PlayableDirector))
		...
		local var_23_7 = var_23_6(var_23_5, var_2_10007(var_2_10009.Playables.PlayableDirector))
		local var_23_8 = var_4.ToTable(var_23_7)

		ipairs = var_23_2

		for iter_23_0, iter_23_1 in var_23_2(var_23_8) do
...
function var_0_1.InitLightSettings(arg_24_0)
	...
	local var_24_1 = var_1_10002.IpairsCArray
	...
	var_24_1(var_24_3(var_24_2, var_1_10007(var_1_10009)), function(arg_25_0, arg_25_1)
...
function var_0_1.PlayTimeline(arg_29_0, arg_29_1, arg_29_2)
	...
	var_1_10006(var_29_2, "Missing director " .. var_29_0)
	...
	var_29_4(var_29_3, var_9(var_29_2))
	...
	var_29_7.insert(var_29_5, function(arg_31_0)
		...
		local var_31_2 = var_2_10002(var_29_6, "DftCommonSignalReceiver")
...
function var_0_1.StartGame(arg_39_0)
	...
	var_39_0(var_3.Find(var_39_1, "Score"), false)
...
function var_0_1.EndOneRound(arg_55_0)
	...
	var_55_2(var_55_1, var_4.Find(var_55_3, "ScoreTpl"))

	setText = var_55_2

	local var_55_4 = arg_55_0.scoreUI

	var_55_2(var_3.Find(var_55_4, "ScoreTpl/Left/Units/new/newText"), arg_55_0.ourScore % 10)

	setText = var_55_2

	local var_55_5 = arg_55_0.scoreUI

	var_55_2(var_3.Find(var_55_5, "ScoreTpl/Right/Units/new/newText"), arg_55_0.otherScore % 10)
	...
	var_55_2(arg_55_0.roundResult, {
		[var_0_1.ROUND_RESULT.OUR_WIN] = function()
			...
			var_56_0(var_2.Find(var_56_1, "ScoreTpl/Left/Units/new/newText"), arg_55_0.ourScore % 10)
		...
		[var_0_1.ROUND_RESULT.OTHER_WIN] = function()
			...
			var_57_0(var_2.Find(var_57_1, "ScoreTpl/Right/Units/new/newText"), arg_55_0.otherScore % 10)
...
function var_0_1.EndGame(arg_60_0)
	...
	var_1({
		function(arg_61_0)
			...
			var_61_3.name = var_6.GetWeightTimeline(var_61_4, var_61_0)
		...
		var_62_2.name = var_4.GetWeightTimeline(var_62_3, "daiji")
		...
		var_62_1(var_2.Find(var_62_4, "Title/Victory"), arg_60_0.gameResult == var_0_1.GAME_RESULT.VICTORY)

		setActive = var_62_1

		local var_62_5 = arg_60_0.endUI

		var_62_1(var_2.Find(var_62_5, "Title/Defeat"), arg_60_0.gameResult == var_0_1.GAME_RESULT.DEFEAT)

		local var_62_6 = arg_60_0
		local var_62_7 = var_0.UpdateScoreTpl
		local var_62_8 = arg_60_0.endUI

		var_62_7(var_62_6, var_3.Find(var_62_8, "ScoreTpl"))
...
function var_0_1.ShowResultUI(arg_64_0, arg_64_1)
	(function()
		...
		local var_65_7 = var_2_10008.APARTMENT_TRACK

		Dorm3dTrackCommand = var_2_10009

		var_65_6(var_65_5, var_65_7, var_2_10009.BuildDataRoom(var_65_0, 8, var_65_3, var_65_4))
	...
	var_3({
		function(arg_66_0)
			...
			if arg_64_0.gameResult == var_0_1.GAME_RESULT.VICTORY then
				...
				var_66_2.name = var_5.GetWeightTimeline(var_66_3, "jiangli")
		...
		local var_68_2 = var_3.Find(var_68_1, "Panel/Text")
		...
		var_1(var_68_2, var_2_10004(var_68_3, var_7.getConfig(var_68_4, "name")))
		...
		if arg_64_1 and arg_64_1.cost > 0 then
			...
			var_1(var_3.Find(var_68_5, "Panel/Award"), true)

			setText = var_1

			local var_68_6 = arg_64_0.resultUI
			local var_68_7 = var_3.Find(var_68_6, "Panel/Award/Text")
			...
			var_1(var_68_7, var_4(var_68_8, var_7.getConfig(var_68_9, "name")))
		else
			setActive = var_1

			local var_68_10 = arg_64_0.resultUI

			var_1(var_3.Find(var_68_10, "Panel/Award"), false)
		end
...
function var_0_1.StartQTE(arg_70_0, arg_70_1)
	...
	local var_70_0 = var_4.random
	local var_70_1 = var_0_1.BallRandomDelat.Left

	Screen = var_1_10007

	local var_70_2 = var_70_0(var_70_1, var_1_10007.width - var_0_1.BallRandomDelat.Right)

	math = var_5

	local var_70_3 = var_5.random
	local var_70_4 = var_0_1.BallRandomDelat.Bottom

	Screen = var_8
	arg_70_0.randomScreenPos = var_1_10002(var_70_2, var_70_3(var_70_4, var_8.height - var_0_1.BallRandomDelat.Top))

	local var_70_5 = arg_70_0.ballCameraComp
	local var_70_6 = var_2.ScreenPointToRay(var_70_5, arg_70_0.randomScreenPos)

	math = var_1_10003
	arg_70_0.randomScale = var_1_10003.random(var_0_1.perfectScaleRandoms[1] * 10, arg_70_0.perfectScaleRandoms[2] * 10) / 10
	...
	var_70_9(var_70_10, "retPerfect plane not in view")
	...
	var_70_14(var_70_15, "qte plane not in view")
	...
	var_70_18(var_70_19, "miss plane not in view")
...
function var_0_1.StartQTEUI(arg_72_0)
	...
	var_1(var_3.Find(var_72_1, "animroot/Result"), function(arg_73_0)
	...
	var_1(var_3.Find(var_72_2, "animroot/Perfect"), {
	...
	local var_72_4 = var_4.ScreenToLocal
	local var_72_5 = arg_72_0.qteTF.parent
	local var_72_6 = arg_72_0.randomScreenPos

	pg = var_1_10008

	var_1(var_72_3, var_72_4(var_72_5, var_72_6, var_1_10008.UIMgr.GetInstance().uiCameraComp))
...
function var_0_1.EndQTE(arg_74_0, arg_74_1)
	...
	var_2(var_4.Find(var_74_0, "animroot/Result"), function(arg_75_0)
		setActive = var_2_10001
...
function var_0_1.QteHitOP(arg_78_0, arg_78_1)
	...
	var_2({
		function(arg_79_0)
			...
			var_79_2.name = var_5.GetWeightTimeline(var_79_3, "fly")
		...
		function(arg_80_0)
			...
			var_80_2.name = var_5.GetWeightTimeline(var_80_3, "jieqiu")
...
function var_0_1.QtePerfectOP(arg_81_0, arg_81_1)
	...
	var_2({
		function(arg_82_0)
			...
			var_82_2.name = var_5.GetWeightTimeline(var_82_3, "max_fly")
		...
		function(arg_83_0)
			...
			var_83_2.name = var_5.GetWeightTimeline(var_83_3, "shouji")
...
function var_0_1.GetWeightTimeline(arg_84_0, arg_84_1)
	...
	local var_84_2 = var_1_10004.random() * var_84_1
	local var_84_3 = 0
...
function var_0_1.DoTimelineRandomTrack(arg_86_0, arg_86_1)
	...
	ipairs = var_1_10003
	TimelineHelper = var_1_10005

	local var_86_1 = var_1_10005.GetTimelineTracks(arg_86_1)

	for iter_86_0, iter_86_1 in var_1_10003(var_5.ToTable(var_86_1)) do
	...
	if 0 < var_86_2 then
		...
		local var_86_3 = var_86_0[var_86_2.random(#var_86_0)]

		underscore = var_4

		var_4.each(var_86_0, function(arg_87_0)
			if arg_87_0.name == var_86_3.name then
		...
		arg_86_0.debugTrackName.text = var_86_3.name
	else
...
function var_0_1.onBackPressed(arg_90_0)
	if arg_90_0.playingFlag then
		...
		local var_90_0 = arg_90_0.gameUI

		if not var_1(var_3.Find(var_90_0, "Count")) then
			isActive = var_1
			...
			local var_90_1 = var_1.NewStyleMsgboxMgr.GetInstance()
			local var_90_2 = var_1.Show

			pg = var_1_10004

			local var_90_3 = var_1_10004.NewStyleMsgboxMgr.TYPE_MSGBOX
			local var_90_4 = {}

			i18n = var_1_10006
			var_90_4.contentText = var_1_10006("sure_exit_volleyball")

			function var_90_4.onConfirm()
			...
			var_90_2(var_90_1, var_90_3, var_90_4)
...
function var_0_1.willExit(arg_93_0)
	...
	string = var_93_0
	var_93_2.path = var_93_0.lower("dorm3d/character/" .. arg_93_0.timelineSceneRootName .. "/timeline/" .. arg_93_0.timelineSceneName .. "/" .. arg_93_0.timelineSceneName .. "_scene")
	var_93_2.name = arg_93_0.timelineSceneName
	var_93_1[1] = var_93_2

	local var_93_3 = {}

	string = var_3
	var_93_3.path = var_3.lower("dorm3d/scenesres/scenes/common/" .. arg_93_0.sceneRootName .. "/" .. arg_93_0.sceneName .. "_scene")
	var_93_3.name = arg_93_0.sceneName
	var_93_1[2] = var_93_3
	underscore = var_93_3

	local var_93_4 = var_93_3.map(var_93_1, function(arg_94_0)
	...
	var_3(var_93_4, function()
		...
		var_96_0(var_2_10002("UnityEngine.LightmapSettings"), "lightmaps", nil, nil)
