...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_DORM, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_2, var_2_10006.DORM3D_ROOM, arg_2_1)
	...
	arg_1_0:bind(var_0_1.ON_UNLOCK_DORM_ROOM, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.APARTMENT_ROOM_UNLOCK, {
			roomId = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.OPEN_ROOM_UNLOCK_WINDOW, function(arg_5_0, arg_5_1)
		...
		Dorm3dRoomUnlockWindow = var_2_10008
		var_5_3.viewComponent = var_2_10008
		Dorm3dRoomUnlockWindowMediator = var_2_10008
	...
	arg_1_0:bind(var_0_1.OPEN_INVITE_LAYER, function(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		...
		local var_6_2 = var_2_10007.New
		local var_6_3 = {}

		Dorm3dInviteLayer = var_2_10010
		var_6_3.viewComponent = var_2_10010
		Dorm3dInviteMediator = var_2_10010
		var_6_3.mediator = var_2_10010
		var_6_3.data = {
			roomId = arg_6_1,
			groupIds = arg_6_2
		}
	...
	arg_1_0:bind(var_0_1.OPEN_INS_LAYER, function(arg_7_0, arg_7_1)
		...
		Dorm3dInsMainLayer = var_2_10008
		var_7_3.viewComponent = var_2_10008
		Dorm3dInsMainMediator = var_2_10008
	...
	arg_1_0:bind(var_0_1.OPEN_SHOP_LAYER, function(arg_9_0, arg_9_1)
		...
		Dorm3dShopUI = var_2_10008
		var_9_3.viewComponent = var_2_10008
		Dorm3dShopMediator = var_2_10008
	...
	if not arg_1_0.contextData.hasEnterCheck then
		...
		var_1_1(var_1_0, var_4.SELECT_DORM_ENTER)
	end
...
function var_0_1.initNotificationHandleDic(arg_11_0)
	...
	var_11_0[var_1_10002.NotifyDormDownloadStart] = function(arg_12_0, arg_12_1)
		...
		DormGroupConst = var_2_10006

		var_12_2(var_12_1, var_2_10006.DormDownloadLock.roomId, "start")
	...
	var_11_0[var_2.NotifyDormDownloadProgress] = function(arg_13_0, arg_13_1)
		...
		var_13_2(var_13_1, var_2_10006.DormDownloadLock.roomId, "loading")
	...
	var_11_0[var_2.SUBMIT_TASK_DONE] = function(arg_18_0, arg_18_1)
		...
		local var_18_2 = arg_18_1.getType(var_18_1)[1]

		getDorm3dGameset = var_18_1

		if var_18_2 == var_18_1("drom3d_weekly_task")[1] then
			if #var_18_0 > 0 then
				...
				var_18_4(var_18_3, var_7.ON_ACHIEVE, var_18_0, function()
	...
	var_11_0[var_2.ON_DORM] = function(arg_20_0, arg_20_1)
		...
		local var_20_3 = var_2_10006.GO_SCENE

		SCENE = var_2_10007

		var_20_2(var_20_1, var_20_3, var_2_10007.DORM3D_ROOM, var_20_0)
	...
	var_11_0[var_2.APARTMENT_ROOM_INVITE_UNLOCK_DONE] = function(arg_22_0, arg_22_1)
		...
		local var_22_2 = var_2_10003(var_2_10005)
		local var_22_3 = var_3.getRawData(var_22_2).id

		PlayerPrefs = var_22_0

		var_22_0.SetInt(var_22_3 .. "_dorm3dRoomInviteSuccess_" .. var_22_1.roomId, 0)
