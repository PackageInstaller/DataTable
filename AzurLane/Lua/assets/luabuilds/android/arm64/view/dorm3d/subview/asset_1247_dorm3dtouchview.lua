...
function var_0_1.Init(arg_1_0)
	...
	var_1(var_3.Find(var_1_2, "btn_back_heartbeat"), false)
	...
	local var_1_5 = var_4.Find(var_1_4, "btn_back")
	...
	local function var_1_6()
		...
		var_2_2(var_2_1, var_2_10004.CONSUME_IK_SPECIAL_CALL, var_2_0)
		...
		if not var_2_0.consumed then
			...
			var_2_4(var_2_3, var_4.EXIT_TOUCH_MODE)
		end

		return
	end

	SFX_DORM_BACK = var_1_4
	...
	local var_1_9 = var_4.Find(var_1_8, "btn_back_heartbeat")
	...
	local function var_1_10()
		...
		var_3_1(var_3_0, var_2_10003.EXIT_HEARTBEAT_MODE)

		return
	end

	SFX_DORM_BACK = var_1_8

	var_1(var_1_7, var_1_9, var_1_10, var_1_8)
	...
	var_1_14(var_1_13, var_4.UPDATE_TOUCH_COUNT, function(arg_5_0, arg_5_1)
	...
	var_1_16(var_1_15, var_4.UPDATE_TOUCH_LEVEL, function(arg_6_0, arg_6_1)
	...
	var_1_18(var_1_17, var_4.UPDATE_TOUCH_DISPLAY, function(arg_7_0, arg_7_1, arg_7_2)
...
function var_0_1.UpdateTouchPanel(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	if arg_8_1 then
		...
		var_1_10004(var_6.Find(var_8_0, "slider/icon"), "anim_dorm3d_touch_icon")
...
function var_0_1.UpdateTouchLevel(arg_10_0, arg_10_1)
	...
	var_1_10002(var_4.Find(var_10_0, "effect_bg"), arg_10_1 == 2)

	setActive = var_1_10002

	local var_10_1 = arg_10_0.rtTouchGamePanel

	var_1_10002(var_4.Find(var_10_1, "slider/icon/beating"), arg_10_1 == 2)
	...
	if arg_10_1 == 1 then
		...
		var_1_10002(var_4.Find(var_10_2, "btn_back"), true)

		setActive = var_1_10002

		local var_10_3 = arg_10_0.rtIKUI

		var_1_10002(var_4.Find(var_10_3, "btn_back_heartbeat"), false)
		...
		var_1_10002(var_4.Find(var_10_4, "slider/icon"), "anim_dorm3d_touch_icon")
	elseif arg_10_1 == 2 then
		setActive = var_1_10002

		local var_10_5 = arg_10_0.rtIKUI

		var_1_10002(var_4.Find(var_10_5, "btn_back"), false)

		setActive = var_1_10002

		local var_10_6 = arg_10_0.rtIKUI

		var_1_10002(var_4.Find(var_10_6, "btn_back_heartbeat"), true)
		...
		var_1_10002(var_4.Find(var_10_7, "slider/icon"), "anim_dorm3d_touch_icon_1")
...
function var_0_1.UpdateTouchCount(arg_11_0, arg_11_1)
	...
	var_3(var_5.Find(var_11_1, "slider"), 0, 100, var_11_0)
