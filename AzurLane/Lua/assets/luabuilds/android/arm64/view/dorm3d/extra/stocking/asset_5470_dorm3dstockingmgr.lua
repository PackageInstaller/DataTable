...
function var_0_1.OnInit(arg_1_0)
	if arg_1_0:GetCurrentLadyEnv() then
		pairs = var_1_10002

		for iter_1_0, iter_1_1 in var_1_10002(var_1.skinIdList) do
			local var_1_0 = arg_1_0:Get("skinDict")[iter_1_1].ladyGameObject

			arg_1_0:InitDormStocking(var_1_0.transform, iter_1_1)
		end
	end
...
function var_0_1.OnHandleNotification(arg_10_0, arg_10_1, arg_10_2)
	...
	if arg_10_1 == var_1_10003.APARTMENT_REPLACE_FURNITURE_DONE then
		if not arg_10_0:GetCurrentLadyEnv() then
			return
		end

		pairs = var_1_10004

		for iter_10_0, iter_10_1 in var_1_10004(var_3.skinIdList) do
			local var_10_0 = arg_10_0:Get("skinDict")[iter_10_1].ladyGameObject

			arg_10_0:InitDormStocking(var_10_0.transform, iter_10_1)
		end
	end
...
function var_0_1.OnDrag(arg_15_0, arg_15_1, arg_15_2)
	...
	if arg_15_0.inDragStocking then
		...
		math = var_1_10004
		arg_15_0.preMin = var_1_10004.min(arg_15_0.preMin, var_15_2)
		math = var_4
	...
	var_15_5(var_15_4, var_1_10007.ON_STICK_MOVE, var_15_3)
...
function var_0_1.InitStatus(arg_22_0, arg_22_1)
	...
	typeof = var_5
	Camera = var_1_10007
	arg_22_0.mainCamera = var_22_1(var_22_0, var_5(var_1_10007))
...
function var_0_1.InitHideMode(arg_24_0)
	...
	if arg_24_0.useHideMode then
		...
		local function var_24_1(arg_25_0, arg_25_1)
			...
			local var_25_1 = var_2_10002(var_25_0, var_2_10005(var_2_10007))
...
function var_0_1.ResetLady(arg_27_0)
	...
	var_1_10002(var_27_1, "找不到角色位置点 " .. var_0_2.character_position)
...
function var_0_1.SetStockingStatus(arg_28_0, arg_28_1)
	...
	var_2({
		function(arg_29_0)
			...
			var_29_1(var_29_0, var_2_10004.SET_IK_STATE, false, arg_29_0, {
		...
		function(arg_31_0)
			...
			typeof = var_5
			Cinemachine = var_2_10007

			if var_31_5(var_31_4, var_5(var_2_10007.CinemachineFreeLook)) then
		...
		function(arg_35_0)
			...
			if arg_33_0.useHideMode then
				...
				for iter_35_0, iter_35_1 in var_1(arg_33_0.sceneStockingTFs) do
					...
					var_2_10009 = var_2_10006(var_35_0, var_2_10009(var_2_10011))

					var_2_10006.RemovePointClickFunc(var_2_10009)
				end
			end
			...
			var_35_5(var_35_4, var_4.SET_IK_CONFIG, arg_33_0.ladyEnv, arg_33_0.cacheIkStatus)
			...
			var_35_7(var_35_6, var_4.SET_IK_STATE, true)
			arg_35_0()
...
function var_0_1.GetTipShowInfo(arg_38_0, arg_38_1)
	...
	for iter_38_0, iter_38_1 in var_1_10003(var_0_2.enable_drag) do
		if iter_38_1 == 1 then
			...
			local var_38_2 = arg_38_0.Func(var_38_1, "GetScreenPosition", arg_38_0.tipDirections[iter_38_0][1].position, arg_38_0.mainCamera)
			local var_38_3 = arg_38_0:Func("GetScreenPosition", arg_38_0.tipDirections[iter_38_0][2].position, arg_38_0.mainCamera)

			table = var_38_1

			var_38_1.insert(var_38_0, {
				pos = arg_38_0:Func("GetScreenPosition", arg_38_0.tiptransforms[iter_38_0].position, arg_38_0.mainCamera),
				dir = var_38_3 - var_38_2
			})
		end
	end
...
function var_0_1.InitDormStocking(arg_40_0, arg_40_1, arg_40_2)
	...
	local var_40_1, var_40_2 = arg_40_0.IsUnlockStocking(var_40_0, arg_40_2)
	...
	local var_40_3 = var_40_0.dorm3d_resource[arg_40_2].stocking_pos
	local var_40_4, var_40_5 = var_0_1.GetStockingGeo(arg_40_1, arg_40_2)
	...
	if var_40_2 then
		...
		var_8.SetStockingPos(var_40_6, var_40_4.gameObject, var_40_3[1])

		GraphicsInterface = var_8

		local var_40_7 = var_8.Instance

		var_8.SetStockingPos(var_40_7, var_40_5.gameObject, var_40_3[2])
	else
		setActive = var_8
		...
		var_8(var_40_5, false)

		local var_40_8 = arg_40_1:Find("all/body_geo")
		local var_40_9 = var_8.GetComponent

		typeof = var_11
		SkinnedMeshRenderer = var_1_10013

		local var_40_10 = var_40_9(var_40_8, var_11(var_1_10013))

		var_8.SetBlendShapeWeight(var_40_10, 0, 0)
