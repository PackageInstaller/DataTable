...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_1 = var_3.Find(var_4_0, "BG/Scroll/Content/Unlock/Title/Text")

	i18n = var_1_10004

	var_1_10001(var_4_1, var_1_10004("word_unlock"))

	setText = var_1_10001

	local var_4_2 = arg_4_0._tf
	local var_4_3 = var_3.Find(var_4_2, "BG/Scroll/Content/Lock/Title/Text")

	i18n = var_4

	var_1_10001(var_4_3, var_4("word_lock"))

	onButton = var_1_10001

	local var_4_4 = arg_4_0
	local var_4_5 = arg_4_0._tf
	local var_4_6 = var_4.Find(var_4_5, "btn_back")
	...
	local var_4_10 = var_4.Find(var_4_9, "BG/Close")
	...
	var_1_10001(var_4_8, var_4_10, var_4_11, var_4_9)
	...
	local function var_4_14()
		if arg_4_0.contextData.isPublicRoom then
			...
			var_7_1(var_7_0, var_2_10003("dorm3d_skin_unlock"))
		...
		Dorm3dSkinSelectMediator = var_2_10003

		var_7_4(var_7_3, var_2_10003.CHANGE_SKIN, arg_4_0.contextData.groupId, arg_4_0.selectedSkinId, arg_4_0.hiddenList)
	...
	var_1_10001(var_4_12, var_4_13, var_4_14, var_4_9)
	...
	local function var_4_17()
		...
		if var_0.GetType(var_8_0) == 2 then
			local var_8_1 = var_0:GetPublicRoomId()

			getProxy = var_8_0
			ApartmentProxy = var_2_10005

			local var_8_2 = var_8_0(var_2_10005)

			if var_8_0.getRoom(var_8_2, var_8_1) then
				local var_8_3 = arg_4_0

				var_8_0 = var_8_0.emit
				Dorm3dSkinSelectMediator = var_2_10006

				var_8_0(var_8_3, var_2_10006.OPEN_ROOM_UNLOCK_WINDOW, var_8_1, arg_4_0.contextData.groupId)
			else
				...
				var_8_0(var_8_4, var_2_10006.OPEN_ROOM_UNLOCK_WINDOW, var_8_1)
			end
		elseif var_1 == 3 then
			local var_8_5 = var_0:GetShopId()

			CommonCommodity = var_8_0

			local var_8_6 = var_8_0.New
			local var_8_7 = {
				id = var_8_5
			}
			...
			local var_8_8 = var_8_6(var_8_7, var_2_10006.TYPE_SHOPSTREET)
			local var_8_9, var_8_10, var_8_11 = var_3.GetPrice(var_8_8)

			Drop = var_2_10007

			local var_8_12 = var_2_10007.New
			local var_8_13 = {}

			DROP_TYPE_RESOURCE = var_2_10010
			var_8_13.type = var_2_10010
			var_8_13.id = var_3:GetResType()
			var_8_13.count = var_8_9

			local var_8_14 = var_8_12(var_8_13)
			local var_8_15 = arg_4_0
			local var_8_16 = var_8.emit

			Dorm3dSkinSelectMediator = var_2_10011

			local var_8_17 = var_2_10011.OPEN_SHOP_WINDOW
			local var_8_18 = {
				content = {
			...
			i18n = var_13
			var_8_18.tip = var_13("dorm3d_shop_gift_tip")
			var_8_18.drop = var_0

			function var_8_18.onYes()
				local var_9_0 = arg_4_0
				local var_9_1 = var_0.emit

				GAME = var_3_10003

				var_9_1(var_9_0, var_3_10003.SHOPPING, {
					silentTip = true,
					count = 1,
					id = var_8_5
				})
			...
			var_8_16(var_8_15, var_8_17, var_8_18)
		end
	...
	var_1_10001(var_4_15, var_4_16, var_4_17, var_4_9)
...
function var_0_1.FlushSkinList(arg_10_0)
	...
	var_1_10004.each(var_10_0, function(arg_11_0)
		...
		if var_1.IsShow(var_11_0) then
			...
			if var_11_1(var_3.GetUnlock(var_11_2)) then
				table = var_1
	...
	var_1_10005.sort(var_10_1, var_10_3)
	...
	local function var_10_4(arg_13_0, arg_13_1)
		...
		var_2_10003.StaticAlign(arg_13_0, arg_13_0:GetChild(0), #var_13_0, function(arg_14_0, arg_14_1, arg_14_2)
			...
			if not arg_13_1 then
				...
				local var_14_1 = arg_14_2:Find("Lock/Bar/Text")
				local var_14_2 = arg_10_0.skinDic[var_14_0]

				var_4(var_14_1, var_7.GetUnlockText(var_14_2))
			end

			local var_14_3 = arg_10_0.loader
			local var_14_4 = var_4.GetSpriteQuiet

			string = var_7

			var_14_4(var_14_3, var_7.format("dorm3dselect/apartment_skin_%d", var_14_0), "", arg_14_2:Find("Icon"))
			...
			var_14_4(var_14_5, var_14_6, var_14_7, var_9)
	...
	var_10_4(var_8.Find(var_10_5, "BG/Scroll/Content/Unlock/List"), true)

	local var_10_6 = var_5
	local var_10_7 = arg_10_0._tf

	var_10_6(var_8.Find(var_10_7, "BG/Scroll/Content/Lock/List"), false)
...
function var_0_1.FlushBtns(arg_18_0)
	...
	var_1_10003(arg_18_0.btnChange, var_18_1)

	setActive = var_1_10003

	var_1_10003(arg_18_0.btnBuy, not var_18_1)

	if not var_18_1 then
		if not var_18_0:GetShopId() then
			return
		end

		CommonCommodity = var_4

		local var_18_2 = var_4.New
		local var_18_3 = {
			id = var_1_10003
		}
		...
		local var_18_4 = var_18_2(var_18_3, var_1_10007.TYPE_SHOPSTREET)
		local var_18_5 = var_4.GetPrice(var_18_4)

		setText = var_18_3

		var_18_3(arg_18_0.priceText, "<icon name=" .. var_4:GetResIcon() .. " w=1.1 h=1.1/> " .. var_18_5)

		local var_18_6 = var_18_0
		local var_18_7 = var_18_0.GetUnlock(var_18_6)[1]

		if var_18_0:GetRemarks() and var_7 ~= "" then
			setActive = var_18_6

			var_18_6(arg_18_0.line, false)

			setActive = var_18_6

			var_18_6(arg_18_0.desc, true)

			setText = var_18_6

			var_18_6(arg_18_0.desc, var_7)
		else
			setActive = var_18_6

			var_18_6(arg_18_0.line, true)

			setActive = var_18_6

			var_18_6(arg_18_0.desc, false)
		end
	else
		setActive = var_1_10003

		var_1_10003(arg_18_0.desc, false)

		if arg_18_0:IsSameSkin() then
			setText = var_3

			local var_18_8 = arg_18_0.btnChange
			local var_18_9 = var_5.Find(var_18_8, "text")

			i18n = var_6

			var_3(var_18_9, var_6("dorm3d_skin_already"))
		else
			setText = var_3

			local var_18_10 = arg_18_0.btnChange
			local var_18_11 = var_5.Find(var_18_10, "text")

			i18n = var_6

			var_3(var_18_11, var_6("dorm3d_skin_confirm"))
		end
	end
...
function var_0_1.FlushSkinPartOptions(arg_19_0)
	...
	arg_19_0.hiddenList = var_2(var_4.GetHiddenParts(var_19_1, arg_19_0.selectedSkinId))
	UIItemList = var_2

	local var_19_2 = var_2.StaticAlign
	local var_19_3 = arg_19_0._tf
	local var_19_4 = var_4.Find(var_19_3, "BG/parts")
	local var_19_5 = arg_19_0._tf

	var_19_2(var_19_4, var_5.Find(var_19_5, "BG/parts/tpl"), #var_19_0, function(arg_20_0, arg_20_1, arg_20_2)
		...
		if arg_20_0 == var_4.EventInit then
			...
			var_4.GetSpriteQuiet(var_20_2, "dorm3dskinpart/" .. var_20_0[2] .. "_close", "", arg_20_2:Find("close"))

			table = var_4

			local var_20_3 = var_4.contains(arg_19_0.hiddenList, var_20_0[1])

			setActive = var_2_10005

			var_2_10005(arg_20_2:Find("open"), not var_20_3)

			setActive = var_2_10005

			var_2_10005(arg_20_2:Find("close"), var_20_3)
			...
			local function var_20_6()
				...
				if var_3_10000.contains(arg_19_0.hiddenList, var_20_0[1]) then
					...
					var_3_10001.removebyvalue(arg_19_0.hiddenList, var_20_0[1])
				else
					table = var_3_10001

					var_3_10001.insert(arg_19_0.hiddenList, var_20_0[1])
				end
				...
				var_3_10001(var_3.Find(var_21_1, "open"), not var_21_0)

				setActive = var_3_10001

				local var_21_2 = arg_20_2

				var_3_10001(var_3.Find(var_21_2, "close"), var_21_0)

				Dorm3dHxHelper = var_3_10001

				var_3_10001.HideCharacterPart(arg_19_0.contextData.ladyEnv.lady, arg_19_0.hiddenList)
			...
			var_2_10005(var_20_4, var_20_5, var_20_6, var_10)
		end
...
function var_0_1.IsSameSkin(arg_22_0)
	...
	local var_22_4, var_22_5, var_22_6 = var_2.Diff(arg_22_0.hiddenList, var_22_3)
...
function var_0_1.willExit(arg_25_0)
	...
	if arg_25_0.contextData.ladyEnv.skinId ~= var_25_2 then
		...
		var_2.SwitchCharacterSkin(var_25_3, arg_25_0.contextData.groupId, var_25_2, function()
			...
			var_26_0(var_26_1, var_3.GetHiddenParts(var_26_2, var_25_2))
		...
		var_25_4(var_25_5, var_5.GetHiddenParts(var_25_6, var_25_2))
	end
