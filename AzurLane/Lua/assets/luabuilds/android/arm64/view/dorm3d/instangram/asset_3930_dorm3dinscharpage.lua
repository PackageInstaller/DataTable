...
function var_0_1.Init(arg_2_0)
	...
	var_1_10001(var_3.Find(var_2_0, "entrance"), function(arg_3_0)
		...
		local var_3_2 = arg_3_0:Find("label")

		i18n = var_2_10005

		var_3_1(var_3_2, var_2_10005("dorm3d_privatechat_" .. var_3_0))
	...
	local function var_2_3()
		...
		Dorm3dInsMainLayer = var_2_10003

		var_4_1(var_4_0, var_2_10003.OPEN_INS)
	...
	local function var_2_6()
		...
		var_5_1(var_5_0, var_2_10003.OPEN_CHAT)
	...
	local function var_2_9()
		...
		var_6_1(var_6_0, var_2_10003.OPEN_PHONE)
	...
	var_1(arg_2_0, arg_2_0.likeBtn, function()
		...
		var_7_2(var_7_3, not var_3.IsCare(var_7_4))

		local var_7_5 = arg_2_0.data
		local var_7_6 = var_0.SetCare
		local var_7_7 = arg_2_0.data

		var_7_6(var_7_5, var_3.IsCare(var_7_7) and 0 or 1)

		local var_7_8 = arg_2_0
		local var_7_9 = var_0.emit

		Dorm3dInsMainLayer = var_3

		var_7_9(var_7_8, var_3.FLUSH_LEFT)
	...
	var_1(var_3.Find(var_2_14, "info"), function(arg_8_0)
		local var_8_0 = arg_8_0.name

		setText = var_2_10002

		local var_8_1 = arg_8_0:Find("label")

		i18n = var_2_10005

		var_2_10002(var_8_1, var_2_10005("dorm3d_privatechat_" .. var_8_0))
	...
	local var_2_16 = var_3.Find(var_2_15, "block/Text")

	i18n = var_4

	var_1(var_2_16, var_4("secretary_closed"))

	setActive = var_1

	local var_2_17 = arg_2_0.tf
	local var_2_18 = var_3.Find(var_2_17, "entrance/phone")

	DORM_LOCK_INS_PHONE = var_4

	var_1(var_2_18, not var_4)

	setActive = var_1

	local var_2_19 = arg_2_0.tf
	local var_2_20 = var_3.Find(var_2_19, "block")

	DORM_LOCK_INS_PHONE = var_4

	var_1(var_2_20, var_4)
...
function var_0_1.Flush(arg_9_0, arg_9_1)
	...
	;(function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_1 then
			...
			if not var_6(arg_10_2, "#32a6e8") then
				var_10_1 = arg_10_2
			end
