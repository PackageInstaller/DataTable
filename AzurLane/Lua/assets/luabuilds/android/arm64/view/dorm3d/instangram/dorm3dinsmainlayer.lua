...
function var_0_1.init(arg_2_0)
	...
	Dorm3dInsPublicPage = var_2_1

	local var_2_4 = var_2_1.New
	local var_2_5 = arg_2_0._tf

	var_2_2[var_2_3] = var_2_4(var_5.Find(var_2_5, "main/public_page"), arg_2_0.event)
	...
	var_2_2[var_2_6] = var_2_7(var_5.Find(var_2_8, "main/char_page"), arg_2_0.event)
	...
	arg_2_0.roomItemList = var_2_10(var_2_11, var_4.Find(var_2_12, "tpl"))
	...
	arg_2_0.expandItemList = var_2_16(var_2_17, var_4.Find(var_2_18, "tpl"))
	...
	arg_2_0.selectItemList = var_2_22(var_2_23, var_4.Find(var_2_24, "tpl"))
...
function var_0_1.InitData(arg_6_0)
	...
	arg_6_0.roomDataList = var_1(var_3.GetRoomList(var_6_0))
	ipairs = var_1
...
function var_0_1.BuildSelectOptions(arg_7_0)
	...
	i18n = var_5
	var_7_2.label = var_5("dorm3d_privatechat_screen_all")
	...
	for iter_7_0, iter_7_1 in var_7_0(var_7_1.dorm3d_rooms.get_id_list_by_in_map) do
		...
		i18n = var_10
		var_7_4.label = var_10("dorm3d_privatechat_screen_" .. iter_7_0)
...
function var_0_1.FilterRoomList(arg_8_0, arg_8_1, arg_8_2)
	...
	_ = var_1_10005
	arg_8_0.roomIdList = var_8_0(var_1_10005.select(arg_8_0.roomDataList, function(arg_9_0)
		switch = var_2_10001
...
function var_0_1.ClosePrePage(arg_15_0)
	...
	var_1_10001(arg_15_0.curPage, {
		[var_0_4] = function()
			...
			var_16_1(var_16_0, var_2_10003.CLOSE_JUUS)
		...
		[var_0_5] = function()
			...
			var_17_1(var_17_0, var_2_10003.CLOSE_CHAT)
		...
		[var_0_6] = function()
			...
			var_18_1(var_18_0, var_2_10003.CLOSE_PHONE)
...
function var_0_1.didEnter(arg_20_0)
	...
	var_1_10001(var_20_3, var_4.Find(var_20_4, "left/btn_select"), function()
	...
	var_1_10001(var_20_5, var_4.Find(var_20_6, "back"), function()
	...
	var_1_10001(var_20_7, var_4.Find(var_20_8, "left/btn_expand"), function()
		setActive = var_2_10000
	...
	var_1_10001(var_20_9, var_4.Find(var_20_10, "btn_close"), function()
		setActive = var_2_10000
	...
	local function var_20_11(arg_27_0)
		...
		if not var_1.IsDownloaded(var_27_0) then
			...
			var_27_2(var_27_1, var_2_10004("dorm3d_privatechat_room_unlock"))
		else
			existCall = var_27_2
	...
	arg_20_0:bind(var_0_1.OPEN_INS, function(arg_28_0)
		var_20_11(function()
			...
			Dorm3dInsMainMediator = var_3_10003

			var_29_2(var_29_1, var_3_10003.OPEN_JUUS, arg_20_0.roomDataDic[arg_20_0.selectedId].groupId)
	...
	arg_20_0:bind(var_0_1.OPEN_CHAT, function(arg_30_0)
		var_20_11(function()
			...
			var_31_2(var_31_1, var_3_10003.OPEN_CHAT, arg_20_0.roomDataDic[arg_20_0.selectedId].groupId)
	...
	arg_20_0:bind(var_0_1.OPEN_PHONE, function(arg_32_0)
		var_20_11(function()
			...
			if var_3_10000 then
				...
				var_33_1(var_33_0, var_3_10003("dorm3d_privatechat_telephone"))
			...
			var_33_4(var_33_3, var_3_10003.OPEN_PHONE, arg_20_0.roomDataDic[arg_20_0.selectedId].groupId)
...
function var_0_1.FlushDownloadSlider(arg_46_0, arg_46_1)
	...
	if arg_46_1 == var_0_12 then
		...
		var_1_10003(arg_46_0.slider, 0, var_46_0.totalSize, var_46_0.curSize)
	end
...
function var_0_1.OnClickDownload(arg_52_0, arg_52_1)
	...
	if var_2.getRoom(var_52_0, 1) then
		...
		if not var_2.IsPlayed(var_52_1, "DORM3D_GUIDE_02") then
			...
			var_52_3(var_52_2, var_5("dorm3d_guide_tip"))

			return
		end

		local var_52_4 = arg_52_0:CheckCurrentDownloadState(arg_52_1)

		switch = var_1_10003

		var_1_10003(var_52_4, {
			[var_0_11] = function()
			...
			[var_0_10] = function()
				...
				local var_54_0 = var_2_10000(var_2_10002)
				...
				if not var_0.getRoom(var_54_0, arg_52_1) then
					...
					if var_1.GetType(var_54_1) == 1 then
						...
						Dorm3dInsMainMediator = var_2_10004

						var_54_3(var_54_2, var_2_10004.OPEN_ROOM_UNLOCK_WINDOW, arg_52_1)
					else
						...
						if var_1.GetType(var_54_4) == 2 then
							...
							var_54_6(var_54_5, var_2_10004.ON_UNLOCK_DORM_ROOM, arg_52_1)
						end
					end
				else
			...
			[var_0_12] = function()
				...
				var_55_1(var_55_0, var_2_10003("dorm3d_now_is_downloading"))
...
function var_0_1.TryDownloadResource(arg_56_0, arg_56_1, arg_56_2)
	...
	if var_1_10003.IsDownloading() then
		pg = var_56_0
		var_1_10005 = var_56_0.TipsMgr.GetInstance()
		var_56_0 = var_56_0.ShowTips
		i18n = var_1_10006

		var_56_0(var_1_10005, var_1_10006("dorm3d_now_is_downloading"))
	...
	local var_56_1 = var_56_0(var_1_10005)
		...
		var_56_3 = {
			...
			finishFunc = function(arg_57_0)
				if arg_57_0 then
					...
					var_57_1(var_57_0, var_2_10004("dorm3d_resource_download_complete"))
				end
...
function var_0_1.DeleteRoom(arg_58_0, arg_58_1)
	arg_58_0:TryDownloadResource({
		...
		local var_59_0 = var_2_10000(var_2_10002)
		...
		if var_0.isPersonalRoom(var_59_4) then
			...
			string = var_59_4
			var_59_3 = var_59_5(var_59_4.lower(var_0:getConfig("resource_name")), {
				"room",
				"apartment"
			})
		else
		...
		local var_59_6 = var_59_5.MsgboxMgr.GetInstance()
		local var_59_7 = var_3.ShowMsgBox
		local var_59_8 = {}

		i18n = var_2_10007
		var_59_8.content = var_2_10007("dorm3d_role_assets_delete", var_59_2, var_59_3)

		function var_59_8.onYes()
			...
			if var_3_10000 then
				...
				var_60_1(var_60_0, var_3_10003("common_no_open"))
			...
			if var_0.isPersonalRoom(var_60_2) then
				...
				var_60_3(var_60_2(var_3_10004.getConfig(var_60_4, "resource_name")), {
					"room",
					"apartment"
				})
			else
				...
				var_60_3(var_60_5(var_3_10004.getConfig(var_60_6, "resource_name")), {
					"room"
				})
			end
			...
			var_60_8(var_60_7, var_3_10003("dorm3d_delete_finish"))
			...
			local var_60_11 = var_3.APARTMENT_TRACK

			Dorm3dTrackCommand = var_3_10004

			var_60_10(var_60_9, var_60_11, var_3_10004.BuildDataDownload(var_0.id, 3))
