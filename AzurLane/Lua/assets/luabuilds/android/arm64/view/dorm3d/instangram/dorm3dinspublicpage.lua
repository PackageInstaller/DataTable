...
function var_0_1.Init(arg_2_0)
	...
	var_1_10001(var_3.Find(var_2_0, "info"), function(arg_3_0)
		local var_3_0 = arg_3_0.name

		setText = var_2_10002

		local var_3_1 = arg_3_0:Find("label")

		i18n = var_2_10005

		var_2_10002(var_3_1, var_2_10005("dorm3d_privatechat_" .. var_3_0))
	...
	local var_2_5 = var_3.Find(var_2_4, "invite/hint/Text")

	i18n = var_4

	var_1(var_2_5, var_4("dorm3d_privatechat_room_character"))
	...
	arg_2_0.inviteItemList = var_2_7(var_2_8, var_4.Find(var_2_9, "tpl"))
...
function var_0_1.UpdateInvite(arg_6_0, arg_6_1, arg_6_2)
	...
	getProxy = var_5
	Dorm3dInsProxy = var_1_10007

	local var_6_2 = var_5(var_1_10007)
	local var_6_3 = var_5.GetRoomById(var_6_2, var_6_1)
	local var_6_4 = var_5.GetIcon(var_6_3)

	table = var_1_10006

	local var_6_5 = not var_1_10006.contains(arg_6_0.unlockIds, var_6_0)

	GetImageSpriteFromAtlasAsync = var_6_3

	var_6_3(var_6_4, "", arg_6_2:Find("mask/icon"))

	setActive = var_6_3

	var_6_3(arg_6_2:Find("lock"), var_6_5)

	onButton = var_6_3

	var_6_3(arg_6_0, arg_6_2, function()
		if not var_6_5 then
			return
		end
		...
		if not var_0.IsDownloaded(var_7_0) then
			...
			var_7_2(var_7_1, var_2_10003("dorm3d_privatechat_room_unlock"))
		...
		if not var_0.IsPlayed(var_7_3, "DORM3D_GUIDE_06") then
			...
			var_7_5(var_7_4, var_3("dorm3d_privatechat_room_guide"))
		...
		Dorm3dInsMainMediator = var_3

		var_7_7(var_7_6, var_3.OPEN_ROOM_UNLOCK_WINDOW, arg_6_0.data.id, var_6_0)
