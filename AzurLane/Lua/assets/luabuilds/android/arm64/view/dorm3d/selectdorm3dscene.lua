...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_2, var_2_4, var_2_5, var_2_3)

	setText = var_1

	local var_2_6 = arg_2_0.rtIconTip
	local var_2_7 = var_3.Find(var_2_6, "window/btn_cancel/Text")

	i18n = var_2_4

	var_1(var_2_7, var_2_4("text_cancel"))

	onButton = var_1

	local var_2_8 = arg_2_0
	local var_2_9 = arg_2_0.rtIconTip
	local var_2_10 = var_4.Find(var_2_9, "window/btn_cancel")
	...
	local var_2_13 = var_3.Find(var_2_12, "window/btn_confirm/Text")

	i18n = var_2_10

	var_1(var_2_13, var_2_10("text_confirm"))
	...
	local var_2_16 = var_3.Find(var_2_15, "title/Text")

	i18n = var_4

	var_1(var_2_16, var_4("dorm3d_role_choose"))

	onButton = var_1

	local var_2_17 = arg_2_0
	local var_2_18 = arg_2_0.rtMain
	local var_2_19 = var_4.Find(var_2_18, "btn_back")
	...
	var_1(var_2_17, var_2_19, var_2_20, var_2_18)
	...
	arg_2_0.insBtn = var_2_21(var_3.Find(var_2_22, "btn_ins"))
	onButton = var_1
	...
	var_1(arg_2_0, arg_2_0.insBtn.root, function()
		...
		SelectDorm3DMediator = var_2_10003

		var_6_1(var_6_0, var_2_10003.OPEN_INS_LAYER, arg_2_0.insBtn.IsNewPhoneCall())
	...
	local var_2_24 = var_3.Find(var_2_23, "btn_ins")

	DORM_LOCK_INS = var_4

	var_1(var_2_24, not var_4)
	...
	local var_2_27 = var_1_10002.TimeMgr.GetInstance()
	local var_2_28 = var_2.IsSameWeek

	pg = var_2_23

	local var_2_29 = var_2_23.TimeMgr.GetInstance()
	local var_2_30 = var_5.GetServerTime(var_2_29)

	PlayerPrefs = var_6

	if not var_2_28(var_2_27, var_2_30, var_6.GetInt(var_2_26 .. "_dorm3dGiftWeekRefreshTimeStamp", 0)) then
	...
	local var_2_32 = var_4.Find(var_2_31, "btn_shop/tip")

	Dorm3dShopUI = var_2_30

	var_2(var_2_32, var_2_30.ShouldShowAllTip())
	...
	var_2(var_2_33, var_5.Find(var_2_34, "btn_shop"), function()
		local var_7_0 = arg_2_0
		local var_7_1 = var_0.emit

		SelectDorm3DMediator = var_2_10003

		var_7_1(var_7_0, var_2_10003.OPEN_SHOP_LAYER, function()
			setActive = var_3_10000

			local var_8_0 = arg_2_0.rtMain
			local var_8_1 = var_2.Find(var_8_0, "btn_shop/tip")

			Dorm3dShopUI = var_3_10003

			var_3_10000(var_8_1, var_3_10003.ShouldShowAllTip())
	...
	var_2(var_2_35, var_5.Find(var_2_36, "option/setting"), function()
		local var_9_0 = arg_2_0
		local var_9_1 = var_0.emit

		SelectDorm3DMediator = var_2_10003

		var_9_1(var_9_0, var_2_10003.OPEN_SETTING_LAYER)
	...
	var_2(var_2_37, var_5.Find(var_2_38, "option/home"), function()
		local var_10_0 = arg_2_0
		local var_10_1 = var_0.emit

		BaseUI = var_2_10003

		var_10_1(var_10_0, var_2_10003.ON_HOME)
	...
	var_2.sort(arg_2_0.floorData, function(arg_11_0, arg_11_1)
		...
		if not var_2_10002(var_2_10004.match(arg_11_0, "%d+")) then
			var_11_0 = 0
		end
		...
		if not var_2_10003(var_2_10005.match(arg_11_1, "%d+")) then
			var_11_1 = 0
		end
...
function var_0_1.didEnter(arg_12_0)
	...
	if not var_1.CheckDeviceRAMEnough() then
		...
		var_12_1(var_12_0, var_4("drom3d_memory_limit_tip"))
	end
...
function var_0_1.UpdateStamina(arg_14_0)
	...
	local var_14_1 = var_3.Find(var_14_0, "Text")

	string = var_1_10004

	local var_14_2 = var_1_10004.format
	local var_14_3 = "%d/%d"

	getProxy = var_1_10007
	ApartmentProxy = var_1_10009

	local var_14_4 = var_1_10007(var_1_10009)

	var_1_10001(var_14_1, var_14_2(var_14_3, var_7.getStamina(var_14_4)))

	setActive = var_1_10001

	local var_14_5 = arg_14_0.rtStamina
	local var_14_6 = var_3.Find(var_14_5, "vfx_ui_stamina01")

	getProxy = var_4
	ApartmentProxy = var_6

	local var_14_7 = var_4(var_6)

	var_1_10001(var_14_6, var_4.getStamina(var_14_7) > 0)
...
function var_0_1.SetFloor(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in var_3(var_5.dorm3d_rooms.get_id_list_by_in_map[arg_15_1]) do
		local var_15_1 = arg_15_0.roomDic
		local var_15_2 = var_15_0
		local var_15_3 = var_15_0.Find

		pg = var_1_10012
		var_15_1[iter_15_1] = var_15_3(var_15_2, var_1_10012.dorm3d_rooms[iter_15_1].assets_prefix)
...
function var_0_1.InitIconTrigger(arg_18_0, arg_18_1)
	...
	local var_18_2 = var_1_10006.format
	local var_18_3 = "dorm3dselect/room_icon_%s"

	string = var_1_10009

	var_1_10004(var_18_2(var_18_3, var_1_10009.lower(var_18_1)), "", var_18_0:Find("icon"))
	...
	local function var_18_6()
		...
		if var_2_10000 then
			...
			BLOCK_DORM3D_ROOMS = var_2_10002

			if var_19_0(var_2_10002, arg_18_1) then
				pg = var_0
				...
				var_19_1(var_2_10002, var_3("dorm3d_system_switch"))
		...
		if arg_18_1 ~= 1 then
			...
			var_2_10002 = var_19_2(var_2_10002)

			if var_19_2.getRoom(var_2_10002, 1) then
				pg = var_19_2
				var_2_10002 = var_19_2.NewStoryMgr.GetInstance()

				local var_19_2

				if not var_19_2.IsPlayed(var_2_10002, "DORM3D_GUIDE_02") then
					DORM_LOCK_GUIDE = var_19_2

					if not var_19_2 then
						pg = var_19_2
						var_2_10002 = var_19_2.TipsMgr.GetInstance()
						var_19_2 = var_19_2.ShowTips
						i18n = var_3

						var_19_2(var_2_10002, var_3("dorm3d_guide_tip"))
				...
				local var_19_3 = var_19_2(var_2_10002)
				...
				if var_2_10001.dorm3d_rooms[arg_18_1].type == 1 then
					if arg_18_1 ~= 4 then
						pg = var_19_7
						...
						if not var_19_7.IsPlayed(var_19_5, "DORM3D_GUIDE_06") then
							...
							if not var_19_7 then
								...
								var_19_7(var_19_6, var_2_10005("dorm3d_guide_tip2"))
					...
					if not var_19_4 then
						...
						SelectDorm3DMediator = var_2_10005

						var_19_7(var_19_8, var_2_10005.OPEN_ROOM_UNLOCK_WINDOW, arg_18_1)
					else
						...
						var_19_7.TryDownloadResource(var_19_9, {
							...
							SelectDorm3DMediator = var_4

							var_20_3(var_20_2, var_4.OPEN_INVITE_LAYER, arg_18_1, var_20_0, function()
				...
				elseif var_1 == 2 then
					if not var_19_4 then
						...
						var_19_7.TryDownloadResource(var_19_11, {
							...
							SelectDorm3DMediator = var_3_10003

							local var_22_2 = var_3_10003.ON_DORM
							local var_22_3 = {
								roomId = var_19_4.id
							}
							local var_22_4 = var_19_4

							var_22_3.groupIds = var_5.getInviteList(var_22_4)
	...
	var_1_10004(var_18_4, var_18_5, var_18_6, var_9)
...
function var_0_1.UpdateIconState(arg_23_0, arg_23_1)
	...
	if var_3.getRoom(var_23_1, arg_23_1) then
		...
		var_23_1(var_23_0:Find("icon/mask"), var_23_3 ~= "complete")

		eachChild = var_23_1

		var_23_1(var_23_0:Find("front"), function(arg_24_0)
			setActive = var_2_10001
		...
		var_23_1(var_23_3, {
			loading = function()
				...
				var_2_10001(var_3.Find(var_25_1, "front/loading/progress"), 0, var_25_0.totalSize, var_25_0.curSize)
			...
			complete = function()
				...
				var_26_0(var_26_1, var_26_3)

				if var_26_3 then
					getProxy = var_26_0
					ApartmentProxy = var_4

					local var_26_4 = var_26_0(var_4)
					local var_26_5 = var_2.getApartment
					local var_26_6 = var_0
					local var_26_7 = var_26_5(var_26_4, var_5.getPersonalGroupId(var_26_6))
					local var_26_8 = var_2.getIconTip
					local var_26_9 = var_0
					local var_26_10 = var_26_8(var_26_7, var_6.GetConfigID(var_26_9))

					eachChild = var_26_4

					var_26_4(var_26_1:Find("tip"), function(arg_27_0)
					...
					var_26_4(var_26_1:Find("favor/Text"), var_2.level)
				end
		...
		local var_23_4 = var_23_1(var_7)
		local var_23_5 = var_5.getRawData(var_23_4).id

		if arg_23_1 == 4 then
			setActive = var_23_2

			local var_23_6 = var_23_0:Find("inivite_tip")

			PlayerPrefs = var_9

			var_23_2(var_23_6, var_9.GetInt(var_23_5 .. "_dorm3dRoomInviteSuccess_" .. arg_23_1, 1) == 0)
		end
		...
		local function var_23_7()
			if var_0 then
				...
				if not var_0.isPersonalRoom(var_2_10002) then
					return false
				end
				...
				local var_28_0 = var_0(var_2_10002)
				local var_28_1 = var_0.HasShipGroupGiftExpireSoon
				local var_28_2 = var_0

				return var_28_1(var_28_0, var_3.getConfig(var_28_2, "character")[1])
			end
		end

		setActive = var_23_4

		var_23_4(var_23_0:Find("tip"), var_23_7())
...
function var_0_1.ReplaceSpecialRoomIcon(arg_31_0)
	...
	local var_31_1 = var_1_10004(var_1_10006)

	for iter_31_0, iter_31_1 in var_1_10002(var_4.getRawData(var_31_1)) do
		ipairs = var_1_10007
		...
		for iter_31_2, iter_31_3 in var_1_10007(iter_31_1:getSpecialTalking()) do
			...
			if arg_31_0.roomDic[var_1_10012] then
				...
				var_31_0[var_1_10012] = var_1_10013
				table = var_1_10013

				var_1_10013.insert(var_31_0[var_1_10012], iter_31_3)
			end
		end
	end
	...
	for iter_31_4, iter_31_5 in var_2(var_31_0) do
		...
		arg_31_0.UpdateShowIcon(var_31_2, iter_31_4, var_1_10007)

		GetImageSpriteFromAtlasAsync = var_8
		string = var_31_2

		local var_31_3 = var_31_2.format
		local var_31_4 = "dorm3dselect/room_icon_%s"

		string = var_1_10013
		var_1_10013 = var_1_10013.lower
		pg = var_1_10015

		var_8(var_31_3(var_31_4, var_1_10013(var_1_10015.dorm3d_rooms[iter_31_4].assets_prefix)), "", var_1_10007:Find("icon"))
		...
		local var_31_5 = iter_31_5[1]

		pg = var_9

		local var_31_6 = var_9.dorm3d_dialogue_group[var_31_5]

		DORM_LOCK_GUIDE = var_10

		if var_10 and var_31_5 == 26 then
			return
		end
		...
		local function var_31_8()
			...
			var_0.TryDownloadResource(var_33_0, {
				...
				var_34_1(var_34_0, var_3_10003.ON_DORM, {
					roomId = var_31_6.room_id,
					groupIds = {
						var_31_6.char_id
					},
		...
		var_10(var_31_7, var_1_10013, var_31_8, var_1_10015)
	end
	...
	var_1_10003(arg_35_2, {
		...
		loading = function()
			if arg_35_0.roomDic[arg_35_1] then
				...
				var_1(var_3.Find(var_37_1, "front/loading/progress"), 0, var_37_0.totalSize, var_37_0.curSize)
			end
...
function var_0_1.AfterRoomUnlock(arg_40_0, arg_40_1)
	...
	var_3(var_5.Find(var_40_1, "icon/mask"), function(arg_41_0)
		setActive = var_2_10001
	...
	var_40_3(var_40_4, var_6.Action(function()
		pg = var_2_10000
...
function var_0_1.ShowIconTipWindow(arg_43_0, arg_43_1, arg_43_2)
	...
	local var_43_1 = var_5.Find(var_43_0, "window")
	local var_43_2 = arg_43_0.rtIconTip

	var_1_10003(var_43_1, var_6.InverseTransformPoint(var_43_2, arg_43_2.position))

	removeAllChildren = var_1_10003

	local var_43_3 = arg_43_0.rtIconTip

	var_1_10003(var_5.Find(var_43_3, "window/icon"))
	...
	arg_43_2 = var_1_10003(var_43_4, var_6.Find(var_43_5, "window/icon"))
	...
	local var_43_11 = var_8.Find(var_43_10, "window/Text")

	i18n = var_9

	local var_43_12 = "dorm3d_role_assets_download"

	ShipGroup = var_1_10012

	var_43_7(var_43_11, var_9(var_43_12, var_1_10012.getDefaultShipNameByGroupID(var_3:getPersonalGroupId()), var_3:needDownload() and var_43_9 or "0B"))

	onButton = var_43_7

	local var_43_13 = arg_43_0
	local var_43_14 = arg_43_0.rtIconTip
	local var_43_15 = var_9.Find(var_43_14, "window/btn_confirm")
	...
	local function var_43_16()
		...
		var_44_1(var_44_0, var_2_10003.ON_UNLOCK_DORM_ROOM, arg_43_1)

		return
	end

	SFX_CONFIRM = var_43_14

	var_43_7(var_43_13, var_43_15, var_43_16, var_43_14)

	setActive = var_43_7

	var_43_7(arg_43_0.rtIconTip, true)
...
function var_0_1.TryDownloadResource(arg_46_0, arg_46_1, arg_46_2)
	...
	if var_1_10003.IsDownloading() then
		pg = var_46_0
		var_1_10005 = var_46_0.TipsMgr.GetInstance()
		var_46_0 = var_46_0.ShowTips
		i18n = var_1_10006

		var_46_0(var_1_10005, var_1_10006("dorm3d_now_is_downloading"))
	...
	local var_46_1 = var_46_0(var_1_10005)
		...
		var_46_3 = {
			...
			finishFunc = function(arg_47_0)
				if arg_47_0 then
					...
					var_47_1(var_47_0, var_2_10004("dorm3d_resource_download_complete"))
				end
...
function var_0_1.InitResBar(arg_48_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_48_0.goldMax = var_48_2(var_48_1, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_48_0.goldValue = var_48_5(var_48_4, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_48_0.oilMax = var_48_8(var_48_7, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_48_0.oilValue = var_48_11(var_48_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_48_0.gemValue = var_48_14(var_48_13, var_4(var_1_10006))
	onButton = var_1

	local var_48_15 = arg_48_0
	local var_48_16 = arg_48_0.rtRes
	local var_48_17 = var_4.Find(var_48_16, "gold")
	...
	var_1(var_48_15, var_48_17, var_48_18, var_48_16)

	onButton = var_1

	local var_48_19 = arg_48_0
	local var_48_20 = arg_48_0.rtRes
	local var_48_21 = var_4.Find(var_48_20, "oil")
	...
	var_1(var_48_19, var_48_21, var_48_22, var_48_20)

	onButton = var_1

	local var_48_23 = arg_48_0
	local var_48_24 = arg_48_0.rtRes
	local var_48_25 = var_4.Find(var_48_24, "gem")
	...
	var_1(var_48_23, var_48_25, var_48_26, var_48_24)
	arg_48_0:UpdateRes()
...
function var_0_1.UpdateRes(arg_52_0)
	...
	var_1_10002.StaticFlush(var_52_1, arg_52_0.goldMax, arg_52_0.goldValue, arg_52_0.oilMax, arg_52_0.oilValue, arg_52_0.gemValue)
...
function var_0_1.UpdateWeekTask(arg_53_0)
	...
	local var_53_1 = var_1_10002(var_1_10004)
	...
	local var_53_8 = var_53_5
	local var_53_9 = var_53_5.Find(var_53_8, "Dorm3dIconTpl")

	local function var_53_10()
		if not var_0 then
			...
			if var_0.isFinish(var_54_0) then
				...
				var_54_2(var_54_1, var_2_10003.ON_SUBMIT_TASK, var_53_0)
		...
		do
			...
			var_54_4(var_54_3, var_2_10003.ON_NEW_DROP, {
				drop = var_53_6
			})
		end
	...
	SFX_CONFIRM = var_53_8

	var_7(var_53_7, var_53_9, var_53_10, var_53_8)
	...
	local var_53_11 = arg_53_0
	local var_53_12 = arg_53_0._tf

	var_7(var_53_11, var_10.Find(var_53_12, "Main/task_done"), function()
		...
		var_2_10000(var_2.Find(var_55_0, "Main/task_done"), false)
	...
	local var_53_14 = arg_53_0.rtWeekTask

	var_7(var_53_13, var_10.Find(var_53_14, "title"), function()
		if var_0 then
			setActive = var_0
			...
			var_0(var_2.Find(var_56_0, "Main/task_done"), true)
		end
...
function var_0_1.CheckGuide(arg_57_0, arg_57_1)
	...
	return var_2(arg_57_1, {
		DORM3D_GUIDE_02 = function()
			...
			local var_58_0 = var_2_10000(var_2_10002)
			...
			if var_0.getApartment(var_58_0, 20220) and not var_0:needDownload() then
				...
				var_58_2(var_58_1, var_2_10004.STORY_UPDATE, {
					storyId = arg_57_1
				})
				...
				local var_58_5 = var_4.APARTMENT_TRACK

				Dorm3dTrackCommand = var_5

				local var_58_6 = var_5.BuildDataGuide
				local var_58_7 = 1

				pg = var_2_10008

				local var_58_8 = var_2_10008.NewStoryMgr.GetInstance()

				var_58_4(var_58_3, var_58_5, var_58_6(var_58_7, var_8.StoryName2StoryId(var_58_8, arg_57_1)))
				...
				var_1.Play(var_58_9, arg_57_1, nil, function()
					...
					local var_59_2 = var_3_10003.APARTMENT_TRACK

					Dorm3dTrackCommand = var_3_10004

					local var_59_3 = var_3_10004.BuildDataGuide
					local var_59_4 = 2

					pg = var_3_10007

					local var_59_5 = var_3_10007.NewStoryMgr.GetInstance()

					var_59_1(var_59_0, var_59_2, var_59_3(var_59_4, var_7.StoryName2StoryId(var_59_5, arg_57_1)))
		...
		DORM3D_GUIDE_06 = function()
			...
			var_60_1(var_60_0, var_2_10003.STORY_UPDATE, {
				storyId = arg_57_1
			})
			...
			local var_60_4 = var_3.APARTMENT_TRACK

			Dorm3dTrackCommand = var_4

			local var_60_5 = var_4.BuildDataGuide
			local var_60_6 = 1

			pg = var_2_10007

			local var_60_7 = var_2_10007.NewStoryMgr.GetInstance()

			var_60_3(var_60_2, var_60_4, var_60_5(var_60_6, var_7.StoryName2StoryId(var_60_7, arg_57_1)))
			...
			var_0.Play(var_60_8, arg_57_1, nil, function()
				...
				local var_61_2 = var_3_10003.APARTMENT_TRACK

				Dorm3dTrackCommand = var_3_10004

				local var_61_3 = var_3_10004.BuildDataGuide
				local var_61_4 = 2

				pg = var_3_10007

				local var_61_5 = var_3_10007.NewStoryMgr.GetInstance()

				var_61_1(var_61_0, var_61_2, var_61_3(var_61_4, var_7.StoryName2StoryId(var_61_5, arg_57_1)))
...
function var_0_1.SetMapSwitch(arg_63_0)
	...
	arg_63_0.selectedFloorId = var_1_10002.GetInt("DORM_SELECTED_FLOOR_ID" .. var_63_1, 1)
	pg = var_2
	...
	if var_2.GetCurrentGuideName(var_63_2) == "DORM3D_GUIDE_01" then
		...
		if not var_2 then
			...
			if var_63_0.GetInt("DORM_SELECTED_NEW_ROOM_FLOOR" .. var_63_1 .. var_63_3, 0) == 0 then
				table = var_63_2

				local var_63_4 = var_63_2.indexof

				var_1_10006 = arg_63_0.floorData
				pg = var_1_10007
				arg_63_0.selectedFloorId = var_63_4(var_1_10006, var_1_10007.dorm3d_rooms[var_63_3].in_map)
				PlayerPrefs = var_4
	...
	local var_63_8 = var_63_7(var_63_6, var_1_10006(var_1_10008))
	...
	local var_63_11 = var_63_10(var_63_9, var_1_10007(var_1_10009))
	...
	var_63_6(var_63_12, var_8.Find(var_63_13, "btn_switch/left"), function()
	...
	var_63_6(var_63_14, var_8.Find(var_63_15, "btn_switch/right"), function()
	...
	var_63_6(var_7.Find(var_63_16, "btn_switch/switchPanel"), false)
	...
	local var_63_20 = var_63_19(var_63_18, var_8(var_10))
	...
	local var_63_24 = var_63_23(var_63_22, var_9(var_11))
	...
	var_6.SetEndEvent(var_63_24, function()
		...
		var_2_10000(var_2.Find(var_68_0, "btn_switch/switchPanel"), false)
	...
	var_7(var_63_25, var_10.Find(var_63_26, "btn_switch/switch"), function()
		setActive = var_2_10000

		local var_69_0 = arg_63_0.rtMain

		var_2_10000(var_2.Find(var_69_0, "btn_switch/switchPanel"), true)
	...
	var_7(var_63_27, var_10.Find(var_63_28, "btn_switch/switchPanel"), function()
	...
	local var_63_31 = var_9.Find(var_63_30, "btn_switch/switchPanel/switchScrollView/Viewport/Content")
	local var_63_32 = arg_63_0.rtMain
	local var_63_33 = var_63_29(var_63_31, var_10.Find(var_63_32, "btn_switch/switchPanel/switchScrollView/Viewport/Content/floor"))
	...
	var_7.make(var_63_33, function(arg_71_0, arg_71_1, arg_71_2)
		...
		if arg_71_0 == var_2_10003.EventUpdate then
			...
			for iter_71_0 = #var_4(var_2_10006.dorm3d_rooms.get_id_list_by_in_map[var_71_0]), 1, -1 do
				pg = var_2_10009
			...
			local var_71_1 = arg_71_2:Find("name")

			i18n = var_8

			var_5(var_71_1, var_8("dorm3d_room_" .. var_71_0))

			table = var_5

			local var_71_2 = var_5.sort
			local var_71_3 = var_4

			CompareFuncs = var_8

			var_71_2(var_71_3, var_8({
				function(arg_72_0)
					getProxy = var_3_10001
					ApartmentProxy = var_3_10003

					local var_72_0 = var_3_10001(var_3_10003)
					local var_72_1
			...
			local var_71_4 = var_71_2.New(arg_71_2:Find("rooms"), arg_71_2:Find("rooms/room"))

			var_5.make(var_71_4, function(arg_74_0, arg_74_1, arg_74_2)
				...
				if arg_74_0 == var_3_10003.EventUpdate then
					...
					ApartmentProxy = var_3_10007

					local var_74_2 = var_3_10005(var_3_10007)
					...
					if var_5.getRoom(var_74_2, var_74_0) then
						...
						var_74_2(arg_74_2:Find("lock"), var_74_4 ~= "complete")

						string = var_74_2

						local var_74_5 = var_74_2.format
						local var_74_6 = "dorm3dselect/room_icon_%s"

						string = var_10

						local var_74_7 = var_74_5(var_74_6, var_10.lower(var_74_1.assets_prefix))

						GetImageSpriteFromAtlasAsync = var_74_3

						var_74_3(var_74_7, "", arg_74_2:Find("normal/mask/icon"), false)

						setText = var_74_3

						var_74_3(arg_74_2:Find("roomId"), var_74_0)
			...
			local var_71_5 = arg_63_0
			local var_71_6 = arg_71_2

			local function var_71_7()
			...
			var_6(var_71_5, var_71_6, var_71_7, var_11)
		end
...
function var_0_1.ChangeMap(arg_77_0, arg_77_1)
	...
	local var_77_0 = var_1_10002(var_1_10004)
	local var_77_1 = var_2.getRawData(var_77_0).id

	PlayerPrefs = var_1_10003

	var_1_10003.SetInt("DORM_SELECTED_FLOOR_ID" .. var_77_1, arg_77_0.selectedFloorId)
	...
	var_3(var_5.Find(var_77_2, "btn_switch/left"), arg_77_0.selectedFloorId > 1)

	setActive = var_3

	local var_77_3 = arg_77_0.rtMain

	var_3(var_5.Find(var_77_3, "btn_switch/right"), arg_77_0.selectedFloorId < #arg_77_0.floorData)

	setText = var_3

	local var_77_4 = arg_77_0.rtMain
	local var_77_5 = var_5.Find(var_77_4, "btn_switch/switch/currentName")

	i18n = var_6

	var_3(var_77_5, var_6("dorm3d_room_" .. arg_77_0.floorData[arg_77_0.selectedFloorId]))

	for iter_77_0 = 0, #arg_77_0.floorData - 1 do
		setActive = var_77_4
		var_1_10011 = arg_77_0.rtMain
		var_1_10011 = var_9.Find(var_1_10011, "btn_switch/switchPanel/switchScrollView/Viewport/Content")
		var_1_10011 = var_9.GetChild(var_1_10011, iter_77_0)

		local var_77_6 = var_9.Find(var_1_10011, "select")
		local var_77_7 = iter_77_0 + 1 == arg_77_1

		var_77_4(var_77_6, var_77_7)
	end
	...
	for iter_77_1, iter_77_2 in var_3(arg_77_0.floorData) do
		...
		pg = var_77_7
		var_77_7 = var_77_7.dorm3d_rooms.get_id_list_by_in_map[iter_77_2]
		ipairs = var_1_10011

		for iter_77_3, iter_77_4 in var_1_10011(var_77_7) do
			pg = var_1_10016

			if var_1_10016.dorm3d_rooms[iter_77_4].is_common == 0 then
				var_77_9[iter_77_4] = false
				getProxy = var_1_10016
				ApartmentProxy = var_1_10018
				var_1_10018 = var_1_10016(var_1_10018)

				local var_77_10

				if not var_1_10016.getRoom(var_1_10018, iter_77_4) or not var_1_10016:getState() then
					var_77_10 = "lock"
				end

				if var_77_10 == "complete" then
					...
					if var_1_10016.isPersonalRoom(var_77_11) then
						...
						local var_77_12 = var_1_10018(var_77_11)
						local var_77_13 = var_1_10018.getApartment(var_77_12, var_1_10016:getPersonalGroupId())

						if var_1_10018.getIconTip(var_77_13, var_1_10016:GetConfigID()) then
							var_77_8 = true
							var_77_9[iter_77_4] = true
						end
					end
				end

				if var_77_10 == "complete" and not var_1_10016:isPersonalRoom() then
					PlayerPrefs = var_1_10018
					var_1_10018 = var_1_10018.GetInt(var_77_1 .. "_dorm3dRoomInviteSuccess_" .. iter_77_4, 1) == 0
					var_77_9[iter_77_4] = var_1_10018
				end
			end
		end
		...
		var_1_10011.insert(arg_77_0.floorTipFlag, var_77_8)

		table = var_1_10011

		var_1_10011.insert(arg_77_0.floorRoomTipFlag, var_77_9)
	end
	...
	if arg_77_0.selectedFloorId > 1 then
		...
		var_3(var_5.Find(var_77_14, "btn_switch/left/tip"), arg_77_0.floorTipFlag[arg_77_0.selectedFloorId - 1])
	end
	...
	if arg_77_0.selectedFloorId < #arg_77_0.floorData then
		...
		var_3(var_5.Find(var_77_15, "btn_switch/right/tip"), arg_77_0.floorTipFlag[arg_77_0.selectedFloorId + 1])
	end

	setActive = var_3

	local var_77_16 = arg_77_0.rtMain
	local var_77_17 = var_5.Find(var_77_16, "btn_switch/switch/tip")

	table = iter_77_1

	var_3(var_77_17, iter_77_1.contains(arg_77_0.floorTipFlag, true))
	...
	for iter_77_5 = var_77_18, var_4.Find(var_77_19, "btn_switch/switchPanel/switchScrollView/Viewport/Content").childCount - 1 do
		...
		for iter_77_6 = 0, var_77_22:Find("rooms").childCount - 1 do
			...
			local var_77_27 = var_77_26(var_77_25, var_16(var_1_10018)).text

			setActive = var_77_23
			var_1_10018 = var_12

			local var_77_28 = var_12.Find(var_1_10018, "normal/tip")
			local var_77_29 = arg_77_0.floorRoomTipFlag[iter_77_5 + 1]

			tonumber = var_1_10018

			var_77_23(var_77_28, var_77_29[var_1_10018(var_77_27)])
		end
	end
