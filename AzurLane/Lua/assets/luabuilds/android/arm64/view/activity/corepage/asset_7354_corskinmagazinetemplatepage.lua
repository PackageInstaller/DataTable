...
function var_0_1.UpdateDrop(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_4(arg_9_0.taskList) do
		...
		var_9_7[iter_9_1] = var_9(var_11.getFinishTaskById(var_9_8, iter_9_1))
	end
	...
	var_5(var_7.Find(var_9_10, "got"), var_9_9)

	setActive = var_5

	local var_9_11 = arg_9_0.awardTf

	var_5(var_7.Find(var_9_11, "get"), arg_9_0.remainCnt > 0 and not var_9_9)
