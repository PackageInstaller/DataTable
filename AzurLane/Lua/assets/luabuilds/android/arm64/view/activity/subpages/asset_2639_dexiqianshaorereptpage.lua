...
local var_0_0 = "DeXiQianShaoReRePtPage"
...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.bar = var_1.Find(var_1_8, "AD/item/bar")

	local var_1_9 = arg_1_0._tf

	arg_1_0.cur = var_1.Find(var_1_9, "AD/item/step")

	local var_1_10 = arg_1_0._tf

	arg_1_0.target = var_1.Find(var_1_10, "AD/item/progress")

	local var_1_11 = arg_1_0._tf

	arg_1_0.gotTag = var_1.Find(var_1_11, "AD/item/got")
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	if not var_2_10(var_3.Find(var_2_11, "Text")) then
		setText = var_1
		...
		var_1(var_2_13, var_4("avatarframe_got"))
	end
