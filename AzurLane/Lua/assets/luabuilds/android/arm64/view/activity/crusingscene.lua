...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	local var_2_3 = var_1_10003.GetInstance()
	local var_2_4 = {}

	table = var_5

	var_5.insert(var_2_4, function(arg_3_0)
		pg = var_2_10001
		...
		var_2.GetPrefab(var_3_1, "crusingmap/" .. var_3_0, "", true, function(arg_4_0)
			...
			CrusingMapInfo = var_3_10003
			var_4_1.PhaseFrame, var_4_2.AllFrameCount = var_3_10003.GetPhaseFrame(var_3_0)
	...
	var_5.insert(var_2_4, function(arg_5_0)
		...
		var_5_1(var_5_0, var_2_10004.battlepass_event_pt[var_2_2.id].spine_name, true, function(arg_6_0)
	...
	var_5(var_2_4, function()
		...
		var_2_10000(var_7_0, var_3.Find(var_7_1, "icon/model"))

		local var_7_2 = arg_2_0.rtModel

		Vector3 = var_2_10001
		var_7_2.localScale = var_2_10001.one
...
function var_0_1.init(arg_8_0)
	...
	arg_8_0.comScroll = var_1(var_3.Find(var_8_7, "view/content"), "LScrollRect")
	...
	function arg_8_0.comScroll.onUpdateItem(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_2_10005(arg_9_1), arg_8_0.awardList[arg_9_0 + 1])
...
function var_0_1.didEnter(arg_10_0)
	...
	local function var_10_5()
		...
		if arg_10_0.phase < #arg_10_0.awardList then
			...
			var_12_1(var_12_0, var_2_10003.EVENT_OPEN_TASK)
		else
			pg = var_12_1
			...
			var_12_3(var_12_2, var_2_10003("battlepass_complete"))
		end
		...
		if #var_0.GetCrusingUnreceiveAward(var_13_0) > 0 then
			...
			if var_2.checkLimitMax(var_13_2, var_0) then
				...
				var_2.insert(var_13_1, function(arg_14_0)
					...
					i18n = var_3_10005
					var_14_2.content = var_3_10005("player_expResource_mail_fullBag")
			...
			var_2(var_13_1, function()
				...
				CrusingMediator = var_3_10003

				var_15_1(var_15_0, var_3_10003.EVENT_GET_AWARD_ALL)
		...
		if #var_0.GetCrusingUnreceiveAward(var_17_0) > 0 then
			...
			if var_2.checkLimitMax(var_17_2, var_0) then
				...
				var_2.insert(var_17_1, function(arg_18_0)
					...
					i18n = var_3_10005
					var_18_2.content = var_3_10005("player_expResource_mail_fullBag")
			...
			var_2(var_17_1, function()
				...
				var_19_1(var_19_0, var_3_10003.EVENT_GET_AWARD_ALL)
	...
	local function var_10_17()
		...
		pg = var_2_10007
		var_20_2.helps = var_2_10004(var_20_3 .. var_2_10007.battlepass_event_pt[arg_10_0.activity.id].map_name)
	...
	local function var_10_18(arg_21_0)
		...
		var_2(var_21_1, var_5(var_2_10007), false)

		arg_21_0.name = "map_tpl"
		SetAction = var_2

		local var_21_2 = var_21_0.rtIcon
		local var_21_3 = var_4.Find(var_21_2, "model")

		var_2(var_4.GetChild(var_21_3, 0), "normal")
	...
	while #arg_10_0.maps < 3 do
		...
		var_10_19(var_10_20, var_10_21(var_1_10007(var_1_10009(arg_10_0.rtMap))))
	end
	...
	for iter_10_0, iter_10_1 in var_2(arg_10_0.maps) do
		...
		local var_10_22 = iter_10_1.rtLine
		local var_10_23 = arg_10_0.scrollMap

		var_1_10007(var_10_22, var_10.Find(var_10_23, "bg"), true)
	end

	GetComponent = var_2

	local var_10_24 = var_2(arg_10_0.textTip, "RichText")
	local var_10_25 = var_2.AddSprite
	local var_10_26 = "pt"

	GetSpriteFromAtlas = iter_10_1
	Drop = var_1_10008

	local var_10_27 = var_1_10008.New
	local var_10_28 = {}

	DROP_TYPE_VITEM = var_1_10011
	var_10_28.type = var_1_10011
	var_10_28.id = arg_10_0.ptId

	local var_10_29 = var_10_27(var_10_28)

	var_10_25(var_10_24, var_10_26, iter_10_1(var_8.getIcon(var_10_29), ""))

	setText = var_10_25

	local var_10_30 = arg_10_0.textTip

	i18n = var_10_26

	local var_10_31 = "battlepass_main_tip_"

	pg = var_8

	var_10_25(var_10_30, var_10_26(var_10_31 .. var_8.battlepass_event_pt[arg_10_0.activity.id].map_name))

	local var_10_32 = arg_10_0.activity.stopTime

	pg = var_3

	local var_10_33 = var_3.TimeMgr.GetInstance()
	local var_10_34 = var_10_32 - var_3.GetServerTime(var_10_33)

	setText = var_3

	local var_10_35 = arg_10_0.textDay

	i18n = var_6

	local var_10_36 = "battlepass_main_time"

	math = var_9

	local var_10_37 = var_9.floor(var_10_34 / 0)

	math = var_10_29

	var_3(var_10_35, var_6(var_10_36, var_10_37, var_10_29.floor(var_10_34 % 0 / 16)))

	GetComponent = var_3

	local var_10_38 = arg_10_0.scrollMap

	typeof = var_6
	ScrollRect = var_10_36

	local var_10_39 = var_3(var_10_38, var_6(var_10_36)).content.rect.width
	local var_10_40 = var_3.viewport.rect.width
	local var_10_41 = var_10_39 / 3 / (var_10_39 - var_10_40)

	onScroll = var_10_36

	var_10_36(arg_10_0, arg_10_0.scrollMap, function(arg_22_0)
		if arg_22_0.x < 0.1 then
			local var_22_0 = var_0.velocity
			local var_22_1 = var_0.normalizedPosition

			var_22_1.x = arg_22_0.x + var_10_41
		...
		elseif arg_22_0.x > 0.9 then
			...
			var_22_3.x = arg_22_0.x - var_10_41
	...
	if arg_10_0.phase == 0 then
		...
		var_8.ScrollTo(var_10_42, 0)
	elseif arg_10_0.phase == #arg_10_0.awardList then
		local var_10_43 = arg_10_0.comScroll

		var_8.ScrollTo(var_10_43, 1)
	else
		local var_10_44 = arg_10_0.comScroll
		local var_10_45 = var_8.ScrollTo

		math = var_11

		var_10_45(var_10_44, var_11.clamp(arg_10_0.phasePos[arg_10_0.phase], 0, 1))
	end

	local var_10_46 = arg_10_0

	arg_10_0.updateMapStatus(var_10_46)

	LoadImageSpriteAtlasAsync = var_8
	Drop = var_10_46

	local var_10_47 = var_10_46.New
	local var_10_48 = {}

	DROP_TYPE_VITEM = var_1_10013
	var_10_48.type = var_1_10013
	var_10_48.id = arg_10_0.ptId

	local var_10_49 = var_10_47(var_10_48)
	local var_10_50 = var_10.getIcon(var_10_49)
	local var_10_51 = ""
	local var_10_52 = arg_10_0.sliderPt

	var_8(var_10_50, var_10_51, var_12.Find(var_10_52, "Text/icon"), true)
...
function var_0_1.willExit(arg_24_0)
	...
	for iter_24_2, iter_24_3 in var_4(arg_24_0.maps) do
		...
		local var_24_6 = var_15.Find(var_24_5, "model")

		var_1_10009(var_24_3, var_24_4, var_13(var_15.GetChild(var_24_6, 0)))
		...
		var_1_10009(var_24_7, var_24_8, var_24_9, var_1_10014(iter_24_3._tf))
	end
...
function var_0_1.updateAwardInfo(arg_27_0, arg_27_1, arg_27_2)
	...
	var_1_10005(arg_27_1:Find("award"), var_27_1)

	setActive = var_1_10005

	var_1_10005(arg_27_1:Find("award/get"), var_27_0 and not arg_27_0.awardDic[arg_27_2.pt])

	setActive = var_1_10005

	var_1_10005(arg_27_1:Find("award/got"), arg_27_0.awardDic[arg_27_2.pt])

	setActive = var_1_10005

	var_1_10005(arg_27_1:Find("award/mask"), arg_27_0.awardDic[arg_27_2.pt])

	onButton = var_1_10005

	local var_27_2 = arg_27_0
	local var_27_3 = arg_27_1
	local var_27_4 = arg_27_1.Find(var_27_3, "award")
	...
	SFX_CONFIRM = var_27_3

	var_1_10005(var_27_2, var_27_4, var_27_5, var_27_3)

	Drop = var_1_10005

	local var_27_6 = var_1_10005.Create(arg_27_2.award_pay)

	updateDrop = var_6

	var_6(arg_27_1:Find("award_pay"), var_27_6)
	...
	local var_27_7 = arg_27_1:Find("award_pay/get")
	local var_27_8

	if arg_27_0.isPay then
		var_27_8 = var_27_0 and not arg_27_0.awardPayDic[arg_27_2.pt]
	end

	var_6(var_27_7, var_27_8)
	...
	local var_27_11 = arg_27_1.Find(var_27_10, "award_pay")

	local function var_27_12()
		local var_29_0 = arg_27_0

		var_0.emit(var_29_0, var_0_1.ON_DROP, var_27_6)

		return
	end

	SFX_CONFIRM = var_27_10

	var_6(var_27_9, var_27_11, var_27_12, var_27_10)
...
function var_0_1.updateAwardPanel(arg_30_0)
	...
	if arg_30_0.phase < #arg_30_0.awardList then
		...
		var_4(var_6.Find(var_30_3, "Text"), var_30_1 .. "/" .. var_30_2)
	else
		setSlider = var_30_0
		...
		var_30_0(var_3.Find(var_30_4, "Text"), "MAX")
	end
	...
	var_2(var_4.Find(var_30_9, "text_image_3"), not arg_30_0.isPay)
...
function var_0_1.updateMapStatus(arg_31_0)
	...
	for iter_31_0, iter_31_1 in var_1_10001(arg_31_0.maps) do
		...
		var_1_10008(iter_31_1.rtLine, function(arg_32_0)
				...
				elseif var_32_0 < var_31_0 then
					...
					if 0 < var_32_1 then
						repeat
							...
							var_32_1(var_2_10004.remove(var_31_1), false)
			...
			var_3(arg_32_0, not var_32_2, false)

			setImageAlpha = var_3

			var_3(arg_32_0, var_32_2 and 1 or 0.9)

			isActive = var_3

			if var_3(arg_32_0) then
				local var_32_3
				...
				local function var_32_4(arg_33_0, arg_33_1)
					...
					if var_3_10002(arg_33_0) then
						setImageSprite = var_3_10003

						var_3_10003(arg_33_1, var_2)
					end

					eachChild = var_3_10003

					var_3_10003(arg_33_0, function(arg_34_0)
						local var_34_0 = var_32_4
						local var_34_1 = arg_34_0
						local var_34_2 = arg_33_1

						var_34_0(var_34_1, var_4.Find(var_34_2, arg_34_0.name))
				...
				var_5(arg_32_0, function(arg_35_0)
					local var_35_0 = var_32_4
					local var_35_1 = var_32_6

					var_35_0(var_3.Find(var_35_1, arg_35_0.name), arg_35_0)
...
function var_0_1.updateMapWay(arg_36_0)
	...
	local var_36_1 = var_36_0(var_1_10003.format("crusing_%d_phase_display", arg_36_0.activity.id), 0)

	PlayerPrefs = var_1_10002

	local var_36_2 = var_1_10002.SetInt

	string = var_4

	var_36_2(var_4.format("crusing_%d_phase_display", arg_36_0.activity.id), arg_36_0.phase)

	ipairs = var_36_2

	for iter_36_0, iter_36_1 in var_36_2(arg_36_0.maps) do
		GetComponent = var_36_4
		...
		local var_36_4 = var_36_4(var_36_3, var_1_10010(var_1_10012))

		if var_36_1 < arg_36_0.phase then
			local var_36_5 = arg_36_0.PhaseFrame[var_36_1]
			local var_36_6 = arg_36_0.PhaseFrame[arg_36_0.phase]

			var_36_4.speed = var_0_1.PlaySpeed
			var_1_10012 = var_36_4

			var_36_4.Play(var_1_10012, "empty")

			var_1_10012 = var_36_4

			var_36_4.Play(var_1_10012, "mix", 0, var_36_5 / arg_36_0.AllFrameCount)

			var_1_10012 = iter_36_1.rtIcon
			var_1_10010 = var_1_10010.Find(var_1_10012, "model").childCount

			if 0 < var_1_10010 then
				SetAction = var_1_10010

				local var_36_7 = iter_36_1.rtIcon
				local var_36_8 = var_1_10012.Find(var_36_7, "model")

				var_1_10010(var_1_10012.GetChild(var_36_8, 0), "move")
			end

			var_1_10010 = nil
			LeanTween = var_11

			local var_36_9 = var_11.delayedCall
			local var_36_10 = (var_36_6 - var_36_5) / var_0_1.FrameSpeed / var_0_1.PlaySpeed

			System = var_14
			var_1_10010 = var_36_9(var_36_10, var_14.Action(function()
				var_36_4.speed = 0
				...
				local var_37_1 = var_36_4

				var_0.Play(var_37_1, "mix", 0, var_36_6 / arg_36_0.AllFrameCount)
				...
				if var_0.Find(var_37_2, "model").childCount > 0 then
					...
					local var_37_4 = var_2.Find(var_37_3, "model")

					var_0(var_2.GetChild(var_37_4, 0), "normal")
				end
			...
			var_36_4.speed = 0
			var_1_10010 = var_36_4

			var_36_4.Play(var_1_10010, "empty")

			var_1_10010 = var_36_4

			var_36_4.Play(var_1_10010, "mix", 0, arg_36_0.PhaseFrame[arg_36_0.phase] / arg_36_0.AllFrameCount)
		end
	end
...
function var_0_1.buildPhaseAwardScrollPos(arg_38_0)
	...
	for iter_38_0 = 1, #arg_38_0.awardList - 1 do
		...
		var_1_10005(var_38_0, var_8.HeadIndexToValue(var_38_1, iter_38_0 - 1))
	end
		...
		if var_41_1 == var_1_10009 then
			if iter_41_1.id == 1 then
				if var_41_0:GoldMax(iter_41_1.count) then
					...
					local var_41_2 = var_8.TipsMgr.GetInstance()
					local var_41_3 = var_8.ShowTips

					i18n = var_1_10011

					var_41_3(var_41_2, var_1_10011("gold_max_tip_title"))
			...
			elseif iter_41_1.id == 2 and var_41_0:OilMax(iter_41_1.count) then
				...
				local var_41_4 = var_8.TipsMgr.GetInstance()
				local var_41_5 = var_8.ShowTips

				i18n = var_1_10011

				var_41_5(var_41_4, var_1_10011("oil_max_tip_title"))

				return true
			end
		else
			local var_41_6 = iter_41_1.type

			DROP_TYPE_ITEM = var_1_10009

			if var_41_6 == var_1_10009 then
				Item = var_41_6
				var_1_10009 = var_41_6.getConfigData(iter_41_1.id).type
				Item = var_10

				if var_1_10009 == var_10.EXP_BOOK_TYPE then
					getProxy = var_1_10009
					BagProxy = var_1_10011
					var_1_10011 = var_1_10009(var_1_10011)

					if var_1_10009.getItemCountById(var_1_10011, iter_41_1.id) + iter_41_1.count > var_8.max_num then
						return true
					end
				end
			end
...
function var_0_1.openBuyPanel(arg_42_0)
	...
	local var_42_1 = var_1_10002.Create
	local var_42_2 = {
		shop_id = var_42_0
	}
	...
	local var_42_3 = var_42_1(var_42_2, var_1_10005.TYPE_CHARGE)
	local var_42_4 = var_2.getConfig(var_42_3, "tag")
	local var_42_5 = var_2:GetExtraServiceItem()
	local var_42_6 = var_2:GetExtraDrop()
	local var_42_7
	local var_42_8
	local var_42_9
	...
	local var_42_10 = var_1_10009("battlepass_pay_tip")
	local var_42_11 = {
		isChargeType = true,
		commodity = var_2,
		...
		onYes = function()
			...
			if var_2_10000.isNeedSetBirth() then
				...
				var_43_1(var_43_0, var_2_10003.EVENT_OPEN_BIRTHDAY)
			else
				pg = var_43_1
				...
				var_43_3(var_43_2, var_2_10003.CHARGE_OPERATION, {
					shopId = var_0.id
				})
			end
	...
	local var_42_12 = arg_42_0
	local var_42_13 = arg_42_0.emit

	CrusingMediator = var_13

	var_42_13(var_42_12, var_13.EVENT_GO_CHARGE, var_42_11)
...
function var_0_1.getPassID(arg_44_0)
	...
	if var_44_1(var_44_0, var_1_10005.ACTIVITY_TYPE_PT_CRUSING) then
