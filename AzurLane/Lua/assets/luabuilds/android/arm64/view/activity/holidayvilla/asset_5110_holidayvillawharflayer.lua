...
local var_0_2 = var_0_10001.activity_holiday_trans
...
function var_0_1.init(arg_2_0)
	...
	local var_2_7 = var_3.Find(var_2_6, "frame/nameBg/name")

	i18n = var_4

	var_1(var_2_7, var_4("holiday_tip_trans_tip"))

	setText = var_1

	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_3.Find(var_2_8, "frame/resDesc")

	i18n = var_4

	var_1(var_2_9, var_4("holiday_tip_trans_get"))
...
function var_0_1.InitData(arg_6_0)
	...
	arg_6_0.activityProxy = var_1(var_1_10003)
	getProxy = var_1
...
function var_0_1.Show(arg_8_0)
	...
	var_2(var_8_9, var_5.getVitemNumber(var_8_10, 66006))

	local var_8_11 = true

	ipairs = var_3

	for iter_8_0, iter_8_1 in var_3(arg_8_0.transTaskIds) do
	...
	if not var_8_11 then
		...
		local var_8_14 = var_5.Find(var_8_13, "frame/desc")

		i18n = iter_8_0

		var_3(var_8_14, iter_8_0("holiday_tip_trans_desc1"))
		arg_8_0:SetTransList(1)
	else
		setText = var_3

		local var_8_15 = arg_8_0._tf
		local var_8_16 = var_5.Find(var_8_15, "frame/desc")

		i18n = iter_8_0

		var_3(var_8_16, iter_8_0("holiday_tip_trans_desc2"))
...
function var_0_1.SetTransList(arg_9_0, arg_9_1)
	...
	var_9_4(var_9_1, arg_9_1 == 1)

	setActive = var_9_4

	var_9_4(var_9_3, arg_9_1 == 1)

	setActive = var_9_4

	var_9_4(var_9_5, arg_9_1 == 1)

	setActive = var_9_4

	var_9_4(var_9_7, arg_9_1 == 2)
...
function var_0_1.SetTransport(arg_10_0, arg_10_1, arg_10_2)
	...
	var_10_0(arg_10_1:Find("resConsume"), var_10_2)

	Clone = var_10_0

	local var_10_3 = var_10_0(arg_10_2.award)

	ipairs = var_10_1

	for iter_10_0, iter_10_1 in var_10_1(var_10_3) do
		table = var_1_10011
	...
	local var_10_5 = arg_10_0.SetRes
	local var_10_6 = arg_10_1

	var_10_5(var_10_4, arg_10_1.Find(var_10_6, "awards"), var_10_3)
	...
	local function var_10_9()
		...
		if var_0.getVitemNumber(var_11_0, 66006) < var_10_2 then
			...
			var_11_2(var_11_1, var_2_10004("holiday_tip_trans_not"))
		...
		HolidayVillaWharfMediator = var_2_10004

		var_11_4(var_11_3, var_2_10004.ON_TASK_SUBMIT_ONESTEP, arg_10_0.taskActivityId, {
	...
	var_10_5(var_10_7, var_10_8, var_10_9, var_10_6)
...
function var_0_1.SetRes(arg_12_0, arg_12_1, arg_12_2)
	...
	for iter_12_1, iter_12_2 in var_3(arg_12_2) do
		...
		for iter_12_3 = 0, arg_12_1.childCount - 1 do
			...
			local var_12_3 = arg_12_1.GetChild(var_12_2, iter_12_3).name

			tostring = var_12_2

			if var_12_3 == var_12_2(var_12_0) then
				setActive = var_12_3

				var_12_3(var_14, true)

				setText = var_12_3

				var_12_3(var_14:Find("Text"), var_12_1)
			end
		end
	end
...
function var_0_1.ShowCompletePage(arg_13_0)
	...
	var_1(var_3.Find(var_13_1, "ani"), "normal" .. arg_13_0.doingTransCfg.id, false)

	setText = var_1

	local var_13_2 = arg_13_0.transportCompletePage

	var_1(var_3.Find(var_13_2, "desc/Text"), arg_13_0.doingTransCfg.result_desc)

	setActive = var_1

	local var_13_3 = arg_13_0.transportCompletePage

	var_1(var_3.Find(var_13_3, "desc/triangle"), false)

	GetOrAddComponent = var_1

	local var_13_4 = arg_13_0.transportCompletePage
	local var_13_5 = var_3.Find(var_13_4, "desc/Text")

	typeof = var_4
	Typewriter = var_6

	local var_13_6 = var_1(var_13_5, var_4(var_6))
	...
	function var_1.endFunc()
		...
		var_2_10000(var_2.Find(var_14_0, "desc/triangle"), true)
	...
	local var_13_9 = var_5.Find(var_13_8, "bg")
	...
	local function var_13_10()
		...
		if not arg_13_0.hasShowedAwards and #arg_13_0.awards > 0 then
			...
			var_15_2(var_15_1, var_3.ON_ACHIEVE, arg_13_0.awards)
		end
	...
	var_2(var_13_7, var_13_9, var_13_10, var_13_8)

	onButton = var_2

	local var_13_11 = arg_13_0
	local var_13_12 = arg_13_0.transportCompletePage
	local var_13_13 = var_5.Find(var_13_12, "desc")
	...
	local function var_13_14()
		...
		if not arg_13_0.hasShowedAwards and #arg_13_0.awards > 0 then
			...
			var_16_2(var_16_1, var_3.ON_ACHIEVE, arg_13_0.awards)
		end

		return
	end

	SFX_CANCEL = var_13_12

	var_2(var_13_11, var_13_13, var_13_14, var_13_12)
...
function var_0_1.onBackPressed(arg_19_0)
	...
	if var_1_10001(arg_19_0.transportCompletePage) then
		...
		if not arg_19_0.hasShowedAwards and #arg_19_0.awards > 0 then
			...
			var_19_2(var_19_1, var_4.ON_ACHIEVE, arg_19_0.awards)
		end
