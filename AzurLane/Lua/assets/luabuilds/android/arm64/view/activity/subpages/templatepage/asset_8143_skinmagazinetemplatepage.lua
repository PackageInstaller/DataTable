...
local var_0_0 = "SkinMagazineTemplatePage"
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	var_1(var_4_2, var_1_10004(arg_4_0.TIP_KEY))
	...
	for iter_4_1 = 1, arg_4_0.items.childCount do
		...
		if iter_4_1 ~= arg_4_0.index or not arg_4_0.EXPAND_WIDTH then
			var_4_9 = arg_4_0.CLOSE_WIDTH
		end
...
function var_0_1.SelectItem(arg_7_0, arg_7_1)
	...
	for iter_7_2 = 1, arg_7_0.items.childCount do
		...
		if iter_7_2 ~= arg_7_1 or not arg_7_0.EXPAND_WIDTH then
			var_7_5 = arg_7_0.CLOSE_WIDTH
		end

		if var_7_4 ~= var_7_5 then
			math = var_1_10010
			var_1_10010 = var_1_10010.abs(var_7_5 - var_7_4) / arg_7_0.DURATION_PARAMETER
			table = var_11
...
function var_0_1.UpdateDrop(arg_9_0)
	...
	local var_9_2 = var_1_10002.Create(var_9_1:getConfig("award_display")[1])

	updateDrop = var_9_0

	var_9_0(arg_9_0.awardTf, var_9_2)

	onButton = var_9_0

	local var_9_3 = arg_9_0
	local var_9_4 = arg_9_0.awardTf
	local var_9_5 = var_6.Find(var_9_4, "get")
	...
	var_9_0(var_9_3, var_9_5, var_9_6, var_9_4)

	onButton = var_9_0

	var_9_0(arg_9_0, arg_9_0.awardTf, function()
	...
	local var_9_7 = var_9_1:isReceive()

	setActive = var_4

	local var_9_8 = arg_9_0.awardTf

	var_4(var_6.Find(var_9_8, "got"), var_9_7)

	setActive = var_4

	local var_9_9 = arg_9_0.awardTf

	var_4(var_6.Find(var_9_9, "get"), arg_9_0.remainCnt > 0 and not var_9_7)
