...
local var_0_0 = "MallStaffMediator"
...
function var_0_1.listNotificationInterests(arg_2_0)
	...
	GAME = var_1_10002
	var_2_0[1] = var_1_10002.ACTIVITY_MALL_OP_DONE
...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	if var_3_1 == var_3_0.ACTIVITY_MALL_OP_DONE then
		local var_3_3 = arg_3_0.viewComponent

		var_4.UpdateData(var_3_3)

		local var_3_4 = arg_3_0.viewComponent

		var_4.UpdateView(var_3_4)
	end
