...
local var_0_2 = var_0_10001.activity_single_enemy

pg = var_0_0

local var_0_3 = var_0_0.activity_clue
...
function var_0_1.init(arg_2_0)
	...
	local var_2_22 = var_3.Find(var_2_21, "total")

	i18n = var_4

	var_1(var_2_22, var_4("clue_pt_tip"))
...
function var_0_1.didEnter(arg_3_0)
	...
	var_1(var_3.Find(var_3_0, "Text"), arg_3_0.ptData.count)
	...
	local var_3_8 = var_3.Find(var_3_7, "tip")

	ClueTasksLayer = var_3_5

	var_1(var_3_8, var_3_5.ShouldShowTip())
	...
	local function var_3_11()
		...
		var_6_1(var_6_0, var_2_10003.OPEN_CLUE_TASk, function()
			if arg_3_0._tf then
				setActive = var_0

				local var_7_0 = arg_3_0.taskBtn
				local var_7_1 = var_2.Find(var_7_0, "tip")

				ClueTasksLayer = var_3_10003

				var_0(var_7_1, var_3_10003.ShouldShowTip())
				...
				local var_7_3 = var_3_10001(var_3)
				local var_7_4 = var_1.getActivityById

				ActivityConst = var_7_0
				var_7_2.ptActivity = var_7_4(var_7_3, var_7_0.Valleyhospital_PT_ACT_ID)
				...
				var_7_5(var_2.Find(var_7_6, "Text"), arg_3_0.ptData.count)
				...
				local var_7_8 = var_1(var_3)
				local var_7_9 = var_1.getActivityById

				ActivityConst = var_7_6
				var_7_7.activity = var_7_9(var_7_8, var_7_6.Valleyhospital_ACT_ID)
				setText = var_7_7

				local var_7_10 = arg_3_0.chapterSp

				var_7_7(var_2.Find(var_7_10, "ticket/count"), "X " .. arg_3_0.activity.data1)
			end
	...
	var_1(var_3_9, var_3_10, var_3_11, var_6)
	...
	ClueBookLayer = var_3_10

	var_1(var_3_13, var_3_10.ShouldShowTip())
	...
	local function var_3_16()
		...
		var_8_1(var_8_0, var_2_10003.OPEN_CLUE_BOOK, function()
			if arg_3_0._tf then
				...
				local var_9_2 = var_2.Find(var_9_1, "tip")

				ClueBookLayer = var_3_10003

				var_0(var_9_2, var_3_10003.ShouldShowTip())
				...
				local var_9_4 = var_3_10001(var_3)
				local var_9_5 = var_1.getActivityById

				ActivityConst = var_9_1
				var_9_3.ptActivity = var_9_5(var_9_4, var_9_1.Valleyhospital_PT_ACT_ID)
				...
				var_9_6(var_2.Find(var_9_7, "Text"), arg_3_0.ptData.count)
				...
				local var_9_9 = var_1(var_3)
				local var_9_10 = var_1.getActivityById

				ActivityConst = var_9_7
				var_9_8.activity = var_9_10(var_9_9, var_9_7.Valleyhospital_ACT_ID)
				setText = var_9_8

				local var_9_11 = arg_3_0.chapterSp

				var_9_8(var_2.Find(var_9_11, "ticket/count"), "X " .. arg_3_0.activity.data1)
			end
	...
	var_1(var_3_14, var_3_15, var_3_16, var_6)
	...
	ClueMapMediator = var_4

	if var_3_20(var_3_19, var_4).cleanChild and arg_3_0.contextData.bookOpen then
		triggerButton = var_2
...
function var_0_1.InitData(arg_10_0)
	...
	ActivityConst = iter_10_0
	arg_10_0.activity = var_10_1(var_10_0, iter_10_0.Valleyhospital_ACT_ID)
	getProxy = var_1
	...
	ActivityConst = var_4
	arg_10_0.ptActivity = var_10_3(var_10_2, var_4.Valleyhospital_PT_ACT_ID)
	ActivityPtData = var_1
	...
	for iter_10_2, iter_10_3 in var_1(var_0_3.get_id_list_by_group) do
		...
		for iter_10_4, iter_10_5 in var_1_10007(iter_10_3) do
			...
			local var_10_7 = var_1_10014.getTaskVO(var_1_10016, var_1_10013)

			if var_1_10014.getTaskStatus(var_10_7) == 1 then
				if not arg_10_0.canSubmitTaskIds[iter_10_2] then
					var_1_10016 = arg_10_0.canSubmitTaskIds
					var_1_10016[iter_10_2] = {}
					var_1_10016 = arg_10_0.submitClueIds
					var_1_10016[iter_10_2] = {}
				end

				table = var_1_10016

				var_1_10016.insert(arg_10_0.canSubmitTaskIds[iter_10_2], var_1_10013)

				table = var_1_10016

				var_1_10016.insert(arg_10_0.submitClueIds[iter_10_2], iter_10_5)
	...
	local var_10_8 = arg_10_0.activity

	arg_10_0.enterStory = var_1.getConfig(var_10_8, "config_client").enterStory
...
function var_0_1.RefreshPtAndTicket(arg_11_0)
	...
	arg_11_0.ptActivity = var_11_1(var_11_0, var_1_10004.Valleyhospital_PT_ACT_ID)
	ActivityPtData = var_1
	...
	var_1(var_3.Find(var_11_2, "Text"), arg_11_0.ptData.count)

	getProxy = var_1
	ActivityProxy = var_3

	local var_11_3 = var_1(var_3)
	local var_11_4 = var_1.getActivityById

	ActivityConst = var_4
	arg_11_0.activity = var_11_4(var_11_3, var_4.Valleyhospital_ACT_ID)
	setText = var_1

	local var_11_5 = arg_11_0.chapterSp

	var_1(var_3.Find(var_11_5, "ticket/count"), "X " .. arg_11_0.activity.data1)
...
function var_0_1.ShowResUI(arg_12_0)
	...
	local var_12_2 = var_1_10002(arg_12_0._tf, "ui/top/res/gold/max")
	local var_12_3 = var_2.GetComponent

	typeof = var_5
	Text = var_1_10007
	arg_12_0.goldMax = var_12_3(var_12_2, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_12_0.goldValue = var_12_5(var_12_4, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_12_0.oilMax = var_12_7(var_12_6, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_12_0.oilValue = var_12_9(var_12_8, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_12_0.gemValue = var_12_11(var_12_10, var_5(var_1_10007))
	PlayerResUI = var_2
	...
	local var_12_13 = var_5(arg_12_0._tf, "ui/top/res/gold")
	...
	var_2(var_12_12, var_12_13, var_12_14, var_7)
	...
	var_2(var_12_15, var_12_16, var_12_17, var_7)
	...
	var_2(var_12_18, var_12_19, var_12_20, var_7)
...
function var_0_1.UpdateCluePanel(arg_16_0)
	...
	local var_16_3 = var_1_10003.GetInt("investigatingGroupId_" .. var_16_0 .. "_" .. var_16_2, 0)
	local var_16_4 = true
	local var_16_5
	local var_16_6 = 0
	local var_16_7
	...
	if var_16_3 ~= 0 then
		...
		var_1_10010 = var_8(var_1_10010)

		local var_16_8 = var_8.getTaskVO

		tonumber = var_1_10011
		var_1_10010 = var_16_8(var_1_10010, var_1_10011(var_16_5[3].task_id))
		var_16_6 = var_8.getProgress(var_1_10010)
		...
		for iter_16_0 = 1, 3 do
			...
			if not var_1_10012(var_1_10014, var_1_10015(var_16_5[iter_16_0].task_id)) then
				var_16_4 = false
	...
	if var_16_4 then
		...
		local var_16_9 = arg_16_0.explore
		local var_16_10 = var_9.Find(var_16_9, "target/Text")

		i18n = var_1_10010

		var_16_7(var_16_10, var_1_10010("clue_unselect_tip"))
	else
		setText = var_16_7

		local var_16_11 = arg_16_0.explore
		local var_16_12 = var_9.Find(var_16_11, "target/Text")
		local var_16_13 = var_16_5[1].unlock_desc
		local var_16_14 = var_16_5[1].unlock_num
		local var_16_15 = "/"
		local var_16_16 = var_16_5[2].unlock_num
		local var_16_17 = "/"
		local var_16_18 = var_16_5[3].unlock_num

		i18n = var_1_10016

		var_16_7(var_16_12, var_16_13 .. var_16_14 .. var_16_15 .. var_16_16 .. var_16_17 .. var_16_18 .. var_1_10016("clue_task_tip", var_16_6))
	end
...
function var_0_1.InitMapsSwitch(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1_10001(arg_17_0.mapsSwitch) do
		...
		local function var_17_2(arg_18_0)
			if arg_18_0 then
				...
				for iter_18_0 = 1, 3 do
					...
					local var_18_0 = arg_17_0.mapsSwitch[iter_18_0]

					var_2_10005 = var_2_10005.GetComponent
					typeof = var_8
					CanvasGroup = var_2_10010
					var_2_10005 = var_2_10005(var_18_0, var_8(var_2_10010))
				...
				if iter_17_0 == 1 then
					...
					for iter_18_1, iter_18_2 in var_1(arg_17_0.chapters) do
						...
						var_2_10006(var_18_1, var_18_2, var_18_3, var_11)
					end
				elseif iter_17_0 == 2 then
					...
					for iter_18_3, iter_18_4 in var_1(arg_17_0.chapters) do
						...
						var_2_10006(var_18_4, var_18_5, var_18_6, var_11)
					end
				else
					ipairs = var_1
					...
					for iter_18_5, iter_18_6 in var_1(arg_17_0.chapters) do
						...
						var_2_10006(var_18_7, var_18_8, var_18_9, var_11)
					end
				end
				...
				var_1(var_3.Find(var_18_10, "dusk"), iter_17_0 == 2)

				setActive = var_1

				local var_18_11 = arg_17_0.chapterSp

				var_1(var_3.Find(var_18_11, "night"), iter_17_0 == 3)

				GetImageSpriteFromAtlasAsync = var_1
				pg = var_3

				local var_18_12 = var_3.item_virtual_data_statistics[arg_17_0.spChapter.enter_cost].icon
				local var_18_13 = ""
				local var_18_14 = arg_17_0.chapterSp

				var_1(var_18_12, var_18_13, var_5.Find(var_18_14, "ticket/icon"), false)

				local var_18_15 = arg_17_0

				getProxy = var_2
				ActivityProxy = var_18_13

				local var_18_16 = var_2(var_18_13)
				local var_18_17 = var_2.getActivityById

				ActivityConst = var_5
				var_18_15.activity = var_18_17(var_18_16, var_5.Valleyhospital_ACT_ID)
				setText = var_18_15

				local var_18_18 = arg_17_0.chapterSp

				var_18_15(var_3.Find(var_18_18, "ticket/count"), "X " .. arg_17_0.activity.data1)

				onButton = var_18_15

				local var_18_19 = arg_17_0
				local var_18_20 = arg_17_0.chapterSp
				...
				var_18_15(var_18_19, var_18_20, var_18_21, var_6)

				pg = var_18_15

				local var_18_22 = var_18_15.BgmMgr.GetInstance()

				var_1.Push(var_18_22, arg_17_0.__cname, arg_17_0.bgms[arg_17_0.contextData.mapIndex])
			end
		...
		var_1_10006(var_17_0, var_17_1, var_17_2, var_1_10011)
...
function var_0_1.OpenChapterLayer(arg_23_0, arg_23_1)
	...
	ClueMapMediator = var_1_10005

	var_23_1(var_23_0, var_1_10005.OPEN_STAGE, arg_23_1)
...
function var_0_1.SubmitClueTask(arg_24_0)
	if #arg_24_0.submitGroupIds > 0 then
		...
		var_24_2(var_24_1, var_1_10005.ON_TASK_SUBMIT_ONESTEP, var_24_0, arg_24_0.canSubmitTaskIds[arg_24_0.submitGroupIds[1]], function(arg_25_0)
			if arg_25_0 then
...
function var_0_1.OpenSingleClueGroupPanel(arg_26_0)
	...
	var_26_1(var_26_0, var_1_10004.OPEN_SINGLE_CLUE_GROUP, arg_26_0.showClueGroupId, arg_26_0.submitClueIds[arg_26_0.showClueGroupId], function()
		...
		local var_27_3 = var_2.Find(var_27_2, "tip")

		ClueBookLayer = var_2_10003

		var_0(var_27_3, var_2_10003.ShouldShowTip())
