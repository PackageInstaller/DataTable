...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	if var_3_1 == nil then
		...
		CommanderProxy = var_3_0

		local var_3_4

		if var_3_1 == var_3_0.PREFAB_FLEET_UPDATE then
			getProxy = var_3_4
			CommanderProxy = var_1_10006

			local var_3_3 = var_3_4(var_1_10006)
			...
			if var_3_1 == var_3_4.COMMANDER_ACTIVITY_FORMATION_OP_DONE then
