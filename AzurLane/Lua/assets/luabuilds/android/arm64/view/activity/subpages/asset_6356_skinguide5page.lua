...
function var_0_1.OnInit(arg_1_0)
	...
	if var_1_1 == var_1_10002 then
		var_1_1 = {}
		Vector2 = var_1_10002
		var_1_1[1] = var_1_10002(-488, 52)
		Vector2 = var_1_10002
		var_1_1[2] = var_1_10002(-420, -41)
		Vector2 = var_1_10002
		var_1_1[3] = var_1_10002(102, -82)
		Vector2 = var_1_10002
		var_1_1[4] = var_1_10002(-471, -128)
		var_0_3 = var_1_1
	else
		PLATFORM_CODE = var_1_1
		...
		if var_1_1 == var_1_10002 then
			var_1_1 = {}
			Vector2 = var_1_10002
			var_1_1[1] = var_1_10002(-480, 189)
			Vector2 = var_1_10002
			var_1_1[2] = var_1_10002(-445, -101)
			Vector2 = var_1_10002
			var_1_1[3] = var_1_10002(-410, -101)
			Vector2 = var_1_10002
			var_1_1[4] = var_1_10002(-354, -108)
			var_0_3 = var_1_1
		else
			var_1_1 = {}
			Vector2 = var_1_10002
			var_1_1[1] = var_1_10002(-490, 130)
			Vector2 = var_2
	...
	arg_1_0.paintAnim = var_1(var_1_2, var_4(var_1_10006))
	findTF = var_1
	...
	local function var_1_5()
		if arg_1_0.selectIndex then
			...
			local var_2_0 = var_0(var_2_10002)
			...
			var_2_3(var_2_2, var_4.ON_TASK_SUBMIT, var_2_1)
		end
	...
	sound = var_1_10006
	guideData = var_1_10007

	var_1(var_1_3, var_1_4, var_1_5, var_1_10006, var_1_10007)
...
function var_0_1.OnDataSetting(arg_3_0)
	...
	arg_3_0.taskProxy = var_1_10001(var_1_10003)
	...
	if not arg_3_0.skinDatas then
		...
		for iter_3_0 = 1, #arg_3_0.taskList do
			...
			var_1_10007 = var_1_10007(var_1_10009(arg_3_0.itemTpl))
			...
			var_1_10008(var_3_3, var_3_4, var_3_5, var_1_10013)
			...
			typeof = var_3_4
			Image = var_1_10013
			var_1_10008 = var_1_10008(var_3_6, var_3_4(var_1_10013))
			GetSpriteFromAtlas = var_1_10009
			var_1_10008.sprite = var_1_10009(var_0_4, "item_" .. var_3_2)
			tf = var_1_10009
			Instantiate = var_11
			var_1_10009 = var_1_10009(var_11(arg_3_0.iconTpl))
			setParent = var_3_6

			var_3_6(var_1_10009, arg_3_0.iconContent)

			setActive = var_3_6

			var_3_6(var_1_10009, true)

			local var_3_7 = arg_3_0.taskProxy
			local var_3_9

			if not var_10.getTaskById(var_3_7, var_3_1) then
				local var_3_8 = arg_3_0.taskProxy

				var_3_9 = var_10.getFinishTaskById(var_3_8, var_3_1)
			end

			var_1_10013 = var_3_9

			local var_3_10 = var_3_9.getConfig(var_1_10013, "award_display")[1]
			local var_3_11 = {
				type = var_3_10[1],
				id = var_3_10[2],
				count = var_3_10[3]
			...
			var_1_10013(var_1_10009, var_3_11)

			onButton = var_1_10013

			local var_3_12 = arg_3_0
			local var_3_13 = var_1_10009
			...
			local function var_3_14()
				...
				var_5_1(var_5_0, var_2_10003.ON_DROP, var_3_11)
			...
			var_1_10013(var_3_12, var_3_13, var_3_14, var_1_10018)

			table = var_1_10013

			var_1_10013.insert(arg_3_0.skinDatas, {
				task = var_3_1,
				name = var_3_2,
				item = var_1_10007,
				icon = var_1_10009
...
function var_0_1.selectItem(arg_6_0, arg_6_1)
	for iter_6_0 = 1, #arg_6_0.skinDatas do
		...
		if var_1_10007(var_1_10009(var_6_0)) then
			return
		end
	end
	...
	for iter_6_1 = arg_6_1 + 1, #arg_6_0.skinDatas do
		...
		Vector2 = var_1_10008
		var_6_3.targetPos = var_1_10008(var_6_1 * 215, 0)
		var_6_1 = var_6_1 + 1
	end
	...
	for iter_6_2 = 1, arg_6_1 do
		...
		Vector2 = var_1_10008
		var_6_5.targetPos = var_1_10008(var_6_1 * 215, 0)
		var_6_1 = var_6_1 + 1
	end
	...
	iter_6_2(arg_6_0.get, not var_6_9 and arg_6_0.remainCnt > 0)

	setActive = iter_6_2

	iter_6_2(arg_6_0.getBound, not var_6_9 and arg_6_0.remainCnt > 0)

	setActive = iter_6_2

	iter_6_2(arg_6_0.got, var_6_9)
	...
	local var_6_11 = var_8(arg_6_0.paint, "show")

	typeof = var_9
	Image = var_11

	local var_6_12 = var_6_10(var_6_11, var_9(var_11))

	GetSpriteFromAtlas = var_7
	var_6_12.sprite = var_7(var_0_4, "bg_" .. arg_6_0.skinDatas[arg_6_1].name)
	...
	local var_6_15 = var_7(var_6_14, var_10(var_12))
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	local var_7_4 = var_4.getStartTime(var_7_3)

	pg = var_1_10005

	local var_7_5 = var_1_10005.TimeMgr.GetInstance()

	arg_7_0.unlockCnt = var_7_2(var_7_1, var_7_4, var_5.GetServerTime(var_7_5)) + 1
	...
	var_1(var_7_7, var_7_4(var_7_8, var_7.getConfig(var_7_9, "config_id")))
	...
	var_1(var_7_10, var_4("skin_page_sign"))
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	local var_8_8 = var_8_4(var_8_3, var_8_6, var_6.GetServerTime(var_8_7)) + 1
	local var_8_9 = arg_8_0.activity

	arg_8_0.unlockCnt = var_8_8 * var_3.getConfig(var_8_9, "config_id")
	...
	local var_8_12 = var_8_3(arg_8_0.times, "desc")

	i18n = var_8_9

	var_2(var_8_12, var_8_9("last_times_sign", arg_8_0.remainCnt))
...
function var_0_1.updateItemPos(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = var_1_10004((#arg_9_0.skinDatas - 1) * var_0_5, 0)
	...
	for iter_9_0 = 1, #arg_9_0.skinDatas do
		...
		if var_1_10010(var_1_10012(var_9_2)) then
			LeanTween = var_1_10010
			var_1_10010 = var_1_10010.cancel
			go = var_1_10012

			var_1_10010(var_1_10012(var_9_2))
		end

		var_1_10010 = arg_9_0.skinDatas[iter_9_0].targetPos

		if arg_9_1 then
			local var_9_3 = var_9_2.anchoredPosition

			var_1_10012 = {}

			if not arg_9_2 and var_9_3.x > var_1_10010.x then
				table = var_1_10013

				var_1_10013.insert(var_1_10012, var_9_1)

				table = var_1_10013

				var_1_10013.insert(var_1_10012, var_9_0)
			elseif arg_9_2 and var_9_3.x < var_1_10010.x then
				table = var_1_10013
			...
			var_1_10013.insert(var_1_10012, var_1_10010)

			table = var_1_10013

			var_1_10013.insert(var_1_10012, var_1_10010)
			arg_9_0:tweenItem(var_9_2, var_1_10012)
		else
...
function var_0_1.tweenItem(arg_10_0, arg_10_1, arg_10_2)
	...
	if 2 <= var_10_0 then
		...
		local var_10_3 = var_1_10005.remove(arg_10_2, 1)
		...
		local var_10_6 = var_10_5(var_9(arg_10_1), var_10_1.x, var_10_2.x, var_10_4)
		local var_10_7 = var_7.setOnUpdate

		System = var_10

		local var_10_8 = var_10_7(var_10_6, var_10.Action_float(function(arg_11_0)
			var_10_1.x = arg_11_0
		...
		var_10_9(var_10_8, var_10.Action(function()
...
function var_0_1.updateItemData(arg_13_0)
	for iter_13_0 = 1, #arg_13_0.skinDatas do
		...
		var_1_10008(var_10(var_13_0, "got"), var_13_3)
	end
...
function var_0_1.OnDestroy(arg_14_0)
	for iter_14_0 = 1, #arg_14_0.skinDatas do
		...
		if var_1_10006(var_1_10008(var_14_0)) then
			LeanTween = var_1_10006
			var_1_10006 = var_1_10006.cancel
			go = var_1_10008

			var_1_10006(var_1_10008(var_14_0), false)
		end
	end
