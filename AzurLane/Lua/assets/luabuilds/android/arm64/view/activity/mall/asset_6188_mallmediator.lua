...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.SETTLE_ROUND, function(arg_6_0, arg_6_1)
		...
		local var_6_2 = var_2_10005.ACTIVITY_MALL_OP
		local var_6_3 = {
			activity_id = arg_6_1
		}

		ActivityMallOPCommand = var_2_10007
		var_6_3.cmd = var_2_10007.CMD.SETTLE_ROUND
	...
	arg_1_0:bind(var_0_1.INPUT_GOLD, function(arg_7_0, arg_7_1, arg_7_2)
		...
		local var_7_2 = var_2_10006.ACTIVITY_MALL_OP
		local var_7_3 = {
			activity_id = arg_7_1
		}

		ActivityMallOPCommand = var_2_10008
		var_7_3.cmd = var_2_10008.CMD.INPUT_GOLD
	...
	arg_1_0:bind(var_0_1.GET_GOLD_AWARD, function(arg_8_0, arg_8_1, arg_8_2)
		...
		local var_8_2 = var_2_10006.ACTIVITY_MALL_OP
		local var_8_3 = {
			activity_id = arg_8_1
		}

		ActivityMallOPCommand = var_2_10008
		var_8_3.cmd = var_2_10008.CMD.GET_GOLD_AWARD
...
function var_0_1.handleNotification(arg_10_0, arg_10_1)
	...
	if var_10_1 == var_10_0.ACTIVITY_MALL_OP_DONE then
		...
		if var_10_6 == var_1_10008.CMD.SETTLE_ROUND then
			...
			if #var_10_2.awards >= 0 then
				...
				var_10_6.insert(var_10_5, function(arg_12_0)
					...
					var_12_1(var_12_0, var_2_10004.ON_ACHIEVE, var_10_2.awards, arg_12_0)
		...
		if var_10_1 == var_10_3.ZERO_HOUR_OP_DONE then
