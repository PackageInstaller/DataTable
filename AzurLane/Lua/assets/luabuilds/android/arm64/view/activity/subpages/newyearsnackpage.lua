...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1.make(var_3_0, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			local var_4_3 = arg_4_2.Find(var_4_2, "Finished")
			local var_4_4 = arg_4_2:Find("FinalFinished")

			setActive = var_4_2

			var_4_2(var_4_0, arg_4_1 > arg_3_0.curDay)
			...
			if arg_4_1 <= arg_3_0.curDay then
				...
				var_7(var_4_3, arg_4_1 <= arg_3_0.playedCount and arg_4_1 ~= arg_3_0.needCount)
	...
	local function var_3_4()
		...
		var_5_1(var_5_0, var_2_10003.GO_MINI_GAME, 19, {
			callback = function()
				Context = var_3_10000
				...
				var_6_1(var_6_2, var_3_10004.NEWYEAR_BACKHILL)
	...
	local function var_3_7()
		...
		i18n = var_2_10004
		var_7_2.helps = var_2_10004("help_xinnian2021__meishiyemian")
...
function var_0_1.tryGetFinalAward(arg_10_0)
	...
	local var_10_2 = var_1_10002(var_4)
	...
	if var_10_7 <= var_10_6 and not var_10_9 then
		...
		local var_10_12 = var_1_10011.SEND_MINI_GAME_OP
		local var_10_13 = {
			hubid = var_4.id
		}

		MiniGameOPCommand = var_13
		var_10_13.cmd = var_13.CMD_ULTIMATE
		var_10_13.args1 = {}
...
function var_0_1.IsTip()
	...
	if var_11_1(var_11_0, var_1_10003.activity_const.NEWYEAR_SNACK_PAGE_ID.act_id) and not var_0:isEnd() then
		local var_11_2 = var_0:getConfig("config_client").linkMiniGameID

		getProxy = var_11_0
		MiniGameProxy = var_4

		local var_11_3 = var_11_0(var_4)
		local var_11_4 = var_2.GetMiniGameData(var_11_3, var_11_2)
		local var_11_5 = var_2.getConfig(var_11_4, "hub_id")

		getProxy = var_11_3
		MiniGameProxy = var_6

		local var_11_6 = var_11_3(var_6)
		local var_11_7 = var_4.GetHubByHubId(var_11_6, var_11_5).usedtime
		local var_11_8 = var_4:getConfig("reward_need")
		local var_11_9 = var_4.ultimate > 0

		if var_11_8 <= var_11_7 and not var_11_9 then
			return true
