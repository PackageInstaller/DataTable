...
function var_0_1.Show(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in var_1_10003(arg_3_0.textTFs) do
		table = var_1_10008
		...
		var_1_10008.insert(var_3_0, function(arg_4_0)
			...
			var_4_0[var_4_1] = var_2_10003.New(function()
				...
				typeof = var_3
				Typewriter = var_3_10005

				local var_5_4 = var_5_3(var_5_2, var_3(var_3_10005))
	...
	var_3.insert(var_3_0, function(arg_6_0)
		...
		local var_6_3 = var_2_10002.value

		go = var_4

		local var_6_4 = var_6_3(var_4(arg_3_0.textContainer), 1, 0, 0.5)
		local var_6_5 = var_2.setOnUpdate

		System = var_5

		local var_6_6 = var_6_5(var_6_4, var_5.Action_float(function(arg_7_0)
		...
		local var_6_8 = var_6_7(var_6_6, var_5.Action(arg_6_0))
