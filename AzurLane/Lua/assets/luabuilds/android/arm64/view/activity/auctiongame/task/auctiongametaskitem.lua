...
function var_0_1.Init(arg_2_0)
	...
	local function var_2_2()
		...
		if var_0.getConfig(var_3_0, "scene") and #var_0 > 0 and var_0[2] and var_0[2].unlockActivityID and var_0[1] == "AUCTION_GAME_ENTRANCE" then
			getProxy = var_1
			ContextProxy = var_3

			local var_3_1 = var_1(var_3)
			local var_3_2 = var_1.getContextByMediator

			AuctionGameEntranceMediator = var_2_10004

			if var_3_2(var_3_1, var_2_10004) then
				local var_3_3 = arg_2_0
				local var_3_4 = var_1.emit

				BaseUI = var_2_10004

				var_3_4(var_3_3, var_2_10004.ON_CLOSE)
		...
		local var_3_6 = var_1.emit

		AuctionGameTaskMediator = var_2_10004

		var_3_6(var_3_5, var_2_10004.ON_TASK_GO, arg_2_0.taskVO)
...
function var_0_1.SetData(arg_9_0, arg_9_1)
	...
	local var_9_2 = arg_9_1.getProgress(var_9_1)
	local var_9_3 = arg_9_1:getConfig("sub_type")

	TASK_SUB_TYPE_REPEATABLE = var_9_1
	...
	var_9_3(var_9_4, var_7.format("%s/%s", var_9_2, var_9_0))
	...
	local var_9_6 = arg_9_1.getConfig(var_9_5, "award_display")
	local var_9_7 = arg_9_0.rewardList

	var_5.align(var_9_7, #var_9_6)

	local var_9_8 = arg_9_1:getConfig("type")

	Task = var_9_5

	local var_9_9 = var_9_8 == var_9_5.TYPE_REPEATABLE
