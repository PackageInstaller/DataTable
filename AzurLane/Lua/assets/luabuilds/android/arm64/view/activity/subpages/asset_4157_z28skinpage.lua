...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".NewYearSnackPage"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1.make(var_2_0, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			local var_3_3 = arg_3_2.Find(var_3_2, "Finished")
			local var_3_4 = arg_3_2:Find("FinalFinished")

			setActive = var_3_2

			var_3_2(var_3_0, arg_3_1 > arg_2_0.curDay)
			...
			if arg_3_1 <= arg_2_0.curDay then
				...
				var_7(var_3_3, arg_3_1 <= arg_2_0.playedCount and arg_3_1 ~= arg_2_0.needCount)
	...
	local function var_2_4()
		...
		var_4_1(var_4_0, var_2_10003.GO_MINI_GAME, var_2_1, {
			callback = function()
				Context = var_3_10000
				...
				var_5_1(var_5_2, var_3_10004.NEWYEAR_BACKHILL_2022)
	...
	local function var_2_7()
		...
		i18n = var_2_10004
		var_6_2.helps = var_2_10004("help_xinnian2022_z28")
...
function var_0_1.tryGetFinalAward(arg_9_0)
	...
	local var_9_2 = var_1_10002(var_4)
	...
	if var_9_4 <= var_9_3 and not var_9_6 then
		...
		local var_9_9 = var_1_10009.SEND_MINI_GAME_OP
		local var_9_10 = {
			hubid = var_2.id
		}

		MiniGameOPCommand = var_11
		var_9_10.cmd = var_11.CMD_ULTIMATE
		var_9_10.args1 = {}
