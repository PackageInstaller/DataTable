...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.activityID = var_5_1(var_5_0, var_1_10004.ACTIVITY_TYPE_RED_PACKET_LOTTER).id
	arg_5_0.awardList = {}
	arg_5_0.awardListMap = {}

	if var_1:getConfig("config_client") then
		ipairs = var_5_0
		...
		for iter_5_0, iter_5_1 in var_5_0(var_2) do
			...
			var_1_10014.insert(arg_5_0.awardListMap[var_5_6], var_5_7)

			var_1_10014 = arg_5_0.awardList
			var_1_10014[var_5_2] = var_5_7
		end
	end
...
function var_0_1.findUI(arg_6_0)
	...
	for iter_6_0 = 1, 5 do
		...
		local var_6_5 = var_6_4.GetChild(var_1_10010, iter_6_0 - 1)

		table = var_1_10009

		var_1_10009.insert(arg_6_0.packetTFList, var_6_5)
	end

	local var_6_6 = var_2:Find("ContainerFront")

	for iter_6_1 = 1, 5 do
		local var_6_7 = var_6_6:GetChild(iter_6_1 - 1)

		table = var_1_10010

		var_1_10010.insert(arg_6_0.packetTFList, var_6_7)
	end

	local var_6_8 = arg_6_0._tf
	local var_6_9 = var_5.Find(var_6_8, "AwardPanel")

	arg_6_0.awardTpl = var_5.Find(var_6_9, "AwardTpl")

	local var_6_10 = arg_6_0.awardTpl

	arg_6_0.iconTpl = var_6.Find(var_6_10, "Icon/IconTpl")
	arg_6_0.awardTFList = {}
	...
	;(function(arg_7_0, arg_7_1, arg_7_2)
		...
		for iter_7_0, iter_7_1 in var_2_10004(var_7_1) do
	...
	arg_6_0.aniPanel = var_7.Find(var_6_11, "AniPanel")

	local var_6_12 = arg_6_0.aniPanel

	arg_6_0.aniTF = var_7.Find(var_6_12, "Ani")
	GetComponent = var_7
...
function var_0_1.addListener(arg_8_0)
	...
	local function var_8_8()
		...
		pg = var_2_10004
		var_11_2.helps = var_2_10004.gametip.tips_yuandanhuoyue2023.tip
...
function var_0_1.updateActData(arg_12_0)
	...
	local var_12_2 = var_12_1(var_12_0, var_1_10004.ACTIVITY_TYPE_RED_PACKET_LOTTER)

	pg = var_1_10002

	local var_12_3 = var_1_10002.TimeMgr.GetInstance()
	local var_12_4 = var_12_2.data1
	local var_12_5 = var_12_2.data2
	local var_12_6 = var_12_3:GetServerTime()

	math = var_1_10006
	arg_12_0.curCount = var_1_10006.min(10, var_12_3:DiffDay(var_12_5, var_12_6) + 1) - var_12_4
	...
	for iter_12_0, iter_12_1 in var_7(var_12_2.data2_list) do
		...
		if not var_12.contains(arg_12_0.gotIndexList, iter_12_1) then
			table = var_12

			var_12.insert(arg_12_0.gotIndexList, iter_12_1)
		end
	end
	...
	for iter_12_2, iter_12_3 in var_7(var_12_2.data1_list) do
		...
		if not var_12.contains(arg_12_0.gotIDList, iter_12_3) then
			table = var_12

			var_12.insert(arg_12_0.gotIDList, iter_12_3)
		end
	end
...
function var_0_1.updatePacketTpl(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_3 = arg_13_2.Find(var_13_2, "Selected")
	local var_13_4 = arg_13_0:isPacketIndexGot(arg_13_1)
	...
	var_13_2(var_13_0, not var_13_4)
	...
	local function var_13_7()
		if not var_13_4 and arg_13_0.curCount > 0 then
			...
			var_14_1(var_14_0, var_2_10003.ACTIVITY_OPERATION, {
				cmd = 1,
	...
	var_13_2(var_13_5, var_13_6, var_13_7, var_1_10012)
...
function var_0_1.updateAwardTpl(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_3 = arg_16_2.Find(var_16_2, "Got")
	local var_16_4 = arg_16_0.awardList[arg_16_1]

	updateDrop = var_16_2

	var_16_2(var_16_1, var_16_4)

	local var_16_5 = arg_16_0:isAwardGot(arg_16_1)

	setActive = var_7

	var_7(var_16_3, var_16_5)
	...
	var_7(var_16_6, var_16_7, var_16_8, var_1_10012)
...
function var_0_1.isShowRedPoint()
	...
	local var_27_2 = var_27_1(var_27_0, var_1_10003.ACTIVITY_TYPE_RED_PACKET_LOTTER)

	pg = var_1_10001

	local var_27_3 = var_1_10001.TimeMgr.GetInstance()
	local var_27_4 = var_27_2.data1
	local var_27_5 = var_27_2.data2
	local var_27_6 = var_27_3
	local var_27_7 = var_27_3.GetServerTime(var_27_6)
	local var_27_8 = var_27_3:DiffDay(var_27_5, var_27_7) + 1

	math = var_27_6

	return var_27_6.min(10, var_27_3:DiffDay(var_27_5, var_27_7) + 1) - var_27_4 > 0
end
