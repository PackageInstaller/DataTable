...
function var_0_1.init(arg_2_0)
	...
	local var_2_9 = var_3.Find(var_2_8, "BuffList/Title/Text")

	i18n = var_4

	var_1(var_2_9, var_4("activityboss_sp_all_buff"))

	setText = var_1

	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_3.Find(var_2_10, "Rewards/Desc")

	i18n = var_4

	var_1(var_2_11, var_4("activityboss_sp_best_score"))

	setText = var_1

	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_3.Find(var_2_12, "Rewards/Reward/Text")

	i18n = var_4

	var_1(var_2_13, var_4("activityboss_sp_display_reward"))

	setText = var_1

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_3.Find(var_2_14, "Active/Title/Text")

	i18n = var_4

	var_1(var_2_15, var_4("activityboss_sp_active_buff"))

	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_3.Find(var_2_16, "Active/PT/Title")

	i18n = var_4

	var_1(var_2_17, var_4("activityboss_sp_score_bonus"))
...
function var_0_1.didEnter(arg_3_0)
	...
	arg_3_0.buffs = var_3_0(var_3.GetSelectableBuffs(var_3_1), function(arg_4_0)
	...
	local var_3_4 = var_3_3(var_3_2, var_4.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2)

	_ = var_1_10002

	var_1_10002.each(var_3_4:GetHistoryBuffs(), function(arg_5_0)
		_ = var_2_10001
	...
	local var_3_10 = var_5.Find(var_3_9, "back_btn")
	...
	var_3_7(var_3_8, var_3_10, var_3_11, var_3_9)

	onButton = var_3_7

	local var_3_12 = arg_3_0
	local var_3_13 = arg_3_0.top
	local var_3_14 = var_5.Find(var_3_13, "option")
	...
	var_3_7(var_3_12, var_3_14, var_3_15, var_3_13)

	onButton = var_3_7

	local var_3_16 = arg_3_0
	local var_3_17 = arg_3_0._tf
	local var_3_18 = var_5.Find(var_3_17, "Rewards/Reward")

	local function var_3_19()
		local var_11_0 = arg_3_0
		local var_11_1 = var_0.emit

		ActivityBossBuffSelectMediator = var_2_10003

		local var_11_2 = var_2_10003.SHOW_REWARDS
		local var_11_3 = arg_3_0.rewards
		local var_11_4 = arg_3_0.targets
		local var_11_5 = var_3_4

		var_11_1(var_11_0, var_11_2, var_11_3, var_11_4, var_6.GetHighestScore(var_11_5))
	...
	var_3_7(var_3_16, var_3_18, var_3_19, var_3_17)
	...
	local function var_3_22()
		...
		var_12_1(var_12_0, var_2_10003.ON_START, arg_3_0.activeBuffs)
	...
	var_3_7(var_3_20, var_3_21, var_3_22, var_3_17)
	...
	var_2(var_4.Find(var_3_24, "Rewards/Score"), var_3_4:GetHighestScore())
	arg_3_0:UpdateView()
...
function var_0_1.UpdateBuffItem(arg_14_0, arg_14_1, arg_14_2)
	...
	var_1_10006(var_14_1:GetIconPath(), "", var_14_0:Find("Item/Icon"))
	...
	var_1_10006(var_14_3, var_14_4, var_14_5, var_11)
...
function var_0_1.UpdateActiveBuffs(arg_16_0)
	...
	local var_16_1 = var_16_0(var_3.floor((#arg_16_0.activeBuffs - 1) / 5) + 1, 4) * 5
	...
	var_3(var_5.Find(var_16_5, "PT/Text"), "+" .. var_16_4 .. "%")
...
function var_0_1.UpdateActiveBuffItem(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_2 = var_19_0:Find("Icon")

	tobool = var_1_10008

	var_5(var_19_2, var_1_10008(var_19_1))
	...
	var_5(var_19_1:GetIconPath(), "", var_19_0:Find("Icon"))
