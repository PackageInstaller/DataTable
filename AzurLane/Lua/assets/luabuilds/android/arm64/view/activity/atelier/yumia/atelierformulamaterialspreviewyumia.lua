...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.Atelier.base.AtelierFormulaMaterialsPreview"))

function var_0_1.InitCustom(arg_1_0)
	setText = var_1_10001

	local var_1_0 = arg_1_0._tf
	local var_1_1 = var_3.Find(var_1_0, "Frame/closeText")

	i18n = var_1_10004

	var_1_10001(var_1_1, var_1_10004("yumia_atelier_tip13"))

	setText = var_1_10001

	local var_1_2 = arg_1_0._tf
	local var_1_3 = var_3.Find(var_1_2, "Frame/Text")

	i18n = var_4

	var_1_10001(var_1_3, var_4("yumia_atelier_tip11"))

	setText = var_1_10001

	local var_1_4 = arg_1_0._tf
	local var_1_5 = var_3.Find(var_1_4, "Frame/Text_1")

	i18n = var_4

	var_1_10001(var_1_5, var_4("yumia_atelier_tip12"))
...
function var_0_1.ShowMaterialsPreview(arg_4_0, arg_4_1)
	...
	local var_4_1 = var_1_10002(var_4_0, var_1_10005(var_1_10007))
	...
	local function var_4_12(arg_7_0)
		if arg_7_0.Instance then
			...
			if var_1.GetLimitItemID(var_7_0) == 0 then
				var_2_10003 = var_4_8

				local var_7_1 = arg_7_0.Instance
				local var_7_2 = var_4.GetConfigID(var_7_1)
				local var_7_3 = var_4_8
				local var_7_4 = arg_7_0.Instance
				local var_7_5

				if not var_7_3[var_6.GetConfigID(var_7_4)] then
					var_7_5 = 0
				end

				var_2_10003[var_7_2] = var_7_5 + 1
		...
		for iter_7_0, iter_7_1 in var_2_10003(var_4_7.all) do
			...
			if not var_4_10[iter_7_1] and not var_4_4[iter_7_1] then
				AtelierMaterial = var_7_8
				var_7_8 = var_7_8.New({
					configId = iter_7_1
				})
			end

			if var_7_8:IsNormal() and var_7_6:CanUseMaterial(var_7_8, var_4_6, arg_4_0.contextData.versionIndex) then
				var_7_7 = var_7_7 or iter_7_1

				if var_7_8.count > 0 then
					local var_7_9 = var_4_8
					local var_7_10

					if not var_4_8[var_7_7] then
						var_7_10 = 0
					end

					var_7_9[var_7_7] = var_7_10 + 1
		...
		if var_7_7 then
			...
			if not var_4_9[var_7_7] then
				var_7_12 = 0
			end

			var_7_11[var_7_7] = var_7_12 + 1
		else
			assert = var_7_11
			...
			var_7_11(var_7_13, iter_7_0.format("节点 %s 找不到合适的材料", var_7_6:GetConfigID()))
		end
	...
	var_11.each(arg_4_1, function(arg_9_0)
		...
		if var_9_1 == var_2_10003.TYPE.ANY then
			var_4_12(arg_9_0)
		end
	...
	var_11.each(arg_4_1, function(arg_10_0)
		...
		if var_10_1 == var_2_10003.TYPE.ELEMENT_CATEGORY then
			var_4_12(arg_10_0)
		end
	...
	var_11.each(arg_4_1, function(arg_11_0)
		...
		if var_11_1 == var_2_10003.TYPE.CATEGORY then
			var_4_12(arg_11_0)
		end
	...
	var_11.each(arg_4_1, function(arg_12_0)
		...
		if var_12_1 == var_2_10003.TYPE.ELEMENT then
			var_4_12(arg_12_0)
		end
	...
	var_11.each(arg_4_1, function(arg_13_0)
		...
		if var_13_1 == var_2_10003.TYPE.NONE then
			var_4_12(arg_13_0)
		end
	...
	local function var_4_16()
		...
		var_2_10001(var_15_1.parent, #var_4_14 > 0)
		...
		var_15_0.Foreach(var_15_2, function(arg_16_0, arg_16_1)
			...
			var_4(var_16_3, var_16_4, var_16_5, var_9)
	...
	local function var_4_17()
		...
		var_2_10001(var_18_1.parent, #var_4_15 > 0)
		...
		var_18_0.Foreach(var_18_2, function(arg_19_0, arg_19_1)
			...
			var_4(var_19_3, var_19_4, var_19_5, var_9)
...
function var_0_1.HideMaterialsPreview(arg_21_0, arg_21_1)
	...
	local var_21_1 = var_2(var_21_0, var_1_10005(var_1_10007))
...
function var_0_1.AddTimer(arg_24_0, arg_24_1, arg_24_2)
	...
	FrameTimer = var_24_1
	arg_24_0.timer = var_24_1.New(function()
		local var_25_0 = 0
		...
		local var_25_4 = var_25_2(var_25_3, iter_25_0.min(arg_24_1, 8))
		local var_25_5 = 0
		...
		local var_25_9 = var_25_7(var_25_8, iter_25_1.min(arg_24_2, 8))
...
function var_0_1.AddTimer2(arg_26_0)
	...
	for iter_26_0 = 0, var_26_4 - 1 do
		...
		local var_26_6 = var_26_1:GetChild(iter_26_0)

		typeof = var_1_10012
		Animation = var_14

		var_1_10009(var_26_6, var_1_10012(var_14), false)

		GetComponent = var_1_10009

		local var_26_7 = var_26_1:GetChild(iter_26_0)

		typeof = var_1_10012
		CanvasGroup = var_14
		var_1_10009 = var_1_10009(var_26_7, var_1_10012(var_14))
		var_1_10009.alpha = 0
	end
	...
	for iter_26_1 = 0, var_26_5 - 1 do
		...
		local var_26_8 = var_26_3:GetChild(iter_26_1)

		typeof = var_1_10012
		Animation = var_14

		var_1_10009(var_26_8, var_1_10012(var_14), false)

		GetComponent = var_1_10009

		local var_26_9 = var_26_3:GetChild(iter_26_1)

		typeof = var_1_10012
		CanvasGroup = var_14
		var_1_10009 = var_1_10009(var_26_9, var_1_10012(var_14))
		var_1_10009.alpha = 0
	end
	...
	arg_26_0.timer = var_6.New(function()
		if var_26_10 >= var_26_4 and var_26_10 >= var_26_5 then
		...
		if var_26_10 < var_26_4 then
			GetComponent = var_0

			local var_27_1 = var_26_1
			local var_27_2 = var_2.GetChild(var_27_1, var_26_10)

			typeof = var_2_10003
			Animation = var_5

			local var_27_3 = var_0(var_27_2, var_2_10003(var_5))

			var_27_3.enabled = true
			var_2_10003 = var_27_3

			var_27_3.Stop(var_2_10003)

			var_2_10003 = var_27_3

			var_27_3.Play(var_2_10003, "Anim_AtelierStoreYumiaUI_Tpl_In")
		end

		if var_26_10 < var_26_5 then
			GetComponent = var_0

			local var_27_4 = var_26_3
			local var_27_5 = var_2.GetChild(var_27_4, var_26_10)

			typeof = var_2_10003
			Animation = var_5

			local var_27_6 = var_0(var_27_5, var_2_10003(var_5))
	...
	local var_26_11 = arg_26_0.timer

	var_6.Start(var_26_11)
