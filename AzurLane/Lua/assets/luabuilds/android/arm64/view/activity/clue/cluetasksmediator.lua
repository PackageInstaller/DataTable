...
local var_0_0 = "ClueTasksMediator"

import = var_0_10003

local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.base.ContextMediator"))

var_0_1.ON_TASK_SUBMIT = "ClueTasksMediator.ON_TASK_SUBMIT"
var_0_1.ON_TASK_SUBMIT_ONESTEP = "ClueTasksMediator.ON_TASK_SUBMIT_ONESTEP"
var_0_1.ON_TASK_GO = "ClueTasksMediator.ON_TASK_GO"
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_1 == var_6_0.SUBMIT_ACTIVITY_TASK_DONE then
		...
		var_4("hand SUBMIT_ACTIVITY_TASK_DONE", #var_6_2.awards)
		...
		if #var_6_2.awards > 0 then
			...
			var_6_4(var_6_3, var_7.ON_ACHIEVE, var_6_2.awards)
		end
