	...
	for iter_8_0, iter_8_1 in var_1_10001(arg_8_0.table_Top) do
		...
		local function var_8_2(arg_9_0)
			if arg_9_0 then
				...
				var_9_0.pageIndex = iter_8_0
				SetActive = var_9_0

				var_9_0(arg_8_0.bg_1, iter_8_0 == 1)

				SetActive = var_9_0

				var_9_0(arg_8_0.bg_2, iter_8_0 ~= 1)

				local var_9_1 = arg_8_0

				var_1.DataList(var_9_1, iter_8_0)
			end
		...
		var_1_10006(var_8_0, var_8_1, var_8_2, var_1_10011)
	end
...
function var_0_1.UpdateView(arg_10_0)
	for iter_10_0 = 1, #arg_10_0.table_Top do
		...
		var_1_10005(var_7.Find(var_10_0, "Label"), arg_10_0:OnGetCount(iter_10_0) .. "/" .. arg_10_0:OnCount(iter_10_0))
	end

	triggerToggle = var_1

	local var_10_1 = arg_10_0.table_Top
	local var_10_2
...
function var_0_1.ShowSitePage(arg_16_0)
	...
	var_14(var_16_4:Find("Text"), var_16_13)
	...
	var_1_10027(var_16_21:Find("Text"), var_16_31)
...
function var_0_1.OnDestroy(arg_25_0)
	...
	var_1.UnOverlayPanel(var_25_0, arg_25_0.boxTF)
