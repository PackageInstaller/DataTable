...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("...PSS.Hei5.PSSHei5Scene"))
...
function var_0_1.initTplVar(arg_2_0)
	...
	var_2_1, setText = var_1.Find(var_2_0, "frame/phase/btn_pay/Text"), var_1_10002
	i18n = var_1_10005

	var_1_10002(var_2_1, var_1_10005("winter_cruise_btn_pay"))

	local var_2_2 = arg_2_0._tf
	local var_2_3

	var_2_3, setText = var_2.Find(var_2_2, "frame/phase/AwardTipText"), var_2_0
	i18n = var_1_10006

	var_2_0(var_2_3, var_1_10006("winter_cruise_pay_reward"))
