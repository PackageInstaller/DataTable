...
function var_0_1.didEnter(arg_2_0)
	...
	var_1_10001(var_2_0, var_4.Find(var_2_1, "top/btn_back"), function()
	...
	var_1_10001(var_2_2, var_4.Find(var_2_3, "top/btn_home"), function()
	...
	local var_2_6 = var_4.Find(var_2_5, "top/info/btn_help")
	...
	local function var_2_7()
		...
		pg = var_2_10004
		var_5_2.helps = var_2_10004.gametip["0815_main_help"].tip
	...
	var_1_10001(var_2_4, var_2_6, var_2_7, var_2_5)
	...
	var_1_10001(var_2_8, var_4.Find(var_2_9, "btn/btn_game"), function()
		local var_6_0 = arg_2_0
		local var_6_1 = var_0.emit

		CowboyTownMediator = var_2_10003

		var_6_1(var_6_0, var_2_10003.MINI_GAME)
	...
	var_1_10001(var_2_10, var_4.Find(var_2_11, "btn/btn_skin"), function()
		local var_7_0 = arg_2_0
		local var_7_1 = var_0.emit

		CowboyTownMediator = var_2_10003

		var_7_1(var_7_0, var_2_10003.SKIN)
	...
	var_1_10001(var_2_12, var_4.Find(var_2_13, "btn/btn_expansion"), function()
		local var_8_0 = arg_2_0
		local var_8_1 = var_0.emit

		CowboyTownMediator = var_2_10003

		var_8_1(var_8_0, var_2_10003.EXPANSION)
	...
	var_1_10001(var_2_14, var_4.Find(var_2_15, "btn/btn_task"), function()
		local var_9_0 = arg_2_0
		local var_9_1 = var_0.emit

		CowboyTownMediator = var_2_10003

		var_9_1(var_9_0, var_2_10003.TASK)
	...
	var_1_10001(var_2_16, var_4.Find(var_2_17, "btn/btn_story"), function()
		local var_10_0 = arg_2_0
		local var_10_1 = var_0.emit

		CowboyTownMediator = var_2_10003

		var_10_1(var_10_0, var_2_10003.STORY)
...
function var_0_1.UpdateView(arg_11_0)
	...
	var_1_10001(var_3.Find(var_11_0, "btn/btn_game/tip"), var_0_1.MiniGameTip())

	setActive = var_1_10001

	local var_11_1 = arg_11_0._tf

	var_1_10001(var_3.Find(var_11_1, "btn/btn_expansion/tip"), var_0_1.ExpansionTips())
...
function var_0_1.UpdateStoryView(arg_13_0)
	...
	var_1_10001(var_3.Find(var_13_0, "btn/btn_story/tip"), var_0_1.StoryTips())
...
function var_0_1.MiniGameTip()
	...
	CowboyTownMediator = var_1_10003

	return var_15_1(var_15_0, var_1_10003.MINI_GAME_ID).count > 0
end
...
function var_0_1.UpdateTaskTips(arg_17_0)
	...
	local var_17_1 = var_3.Find(var_17_0, "btn/btn_task/tip")

	SixYearUsTaskMediator = var_1_10004

	var_1_10001(var_17_1, var_1_10004.GetTaskRedTip())
