...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	var_1.make(var_1_0, function(arg_2_0, arg_2_1, arg_2_2)
		...
		if arg_2_0 == var_2_10003.EventUpdate then
			...
			local var_2_11 = var_2_5
			local var_2_12 = var_2_5.getProgress(var_2_11)
			local var_2_13 = var_2_5:getConfig("target_num")

			setText = var_2_11

			var_2_11(arg_2_2:Find("description"), var_2_5:getConfig("desc"))

			setText = var_2_11

			local var_2_14 = arg_2_2:Find("progressText")

			setColorStr = var_14

			var_2_11(var_2_14, var_14(var_2_12, "#36AF41FF") .. "/" .. var_2_13)

			setSlider = var_2_11

			var_2_11(arg_2_2:Find("progress"), 0, var_2_13, var_2_12)
			...
			var_2_17(var_2_20, var_2_21, var_2_22, var_2_10020)
			...
			var_2_17(var_2_23, var_2_24, var_2_25, var_2_10020)
		end
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	local var_6_1 = var_1_10004(var_1_10006(arg_6_0.nday), "#36AF41FF")
	local var_6_2 = "/"
	local var_6_3 = arg_6_0.activity

	var_1(var_6_0, var_6_1 .. var_6_2 .. #var_6.getConfig(var_6_3, "config_data"))
