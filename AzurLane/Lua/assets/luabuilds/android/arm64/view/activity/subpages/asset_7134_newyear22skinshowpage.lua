...
function var_0_1.findUI(arg_2_0)
	...
	local function var_2_9()
		...
		var_4_1(var_4_0, var_4_2, var_2_10004.NEWYEAR_BACKHILL_2022)
...
function var_0_1.switchNextPaint(arg_6_0)
	...
	var_6(var_6_5, var_1_10009(var_6_3, var_6_2))
	...
	var_6(var_8(arg_6_0.paintBackTF, "outlineTxt"), var_6_4)
	...
	local var_6_7 = var_6(var_6_6, var_9(var_11))
	...
	local var_6_9 = var_1_10007(var_6_8, var_10(var_12))

	LeanTween = var_6_6

	local var_6_10 = var_6_6.value

	go = var_10

	local var_6_11 = var_6_10(var_10(arg_6_0.paintFrontTF), 1, 0, arg_6_0.paintSwitchTime)
	local var_6_12 = var_8.setOnUpdate

	System = var_11

	local var_6_13 = var_6_12(var_6_11, var_11.Action_float(function(arg_7_0)
	...
	var_6_14(var_6_13, var_11.Action(function()
		...
		var_8_0(var_2(arg_6_0.paintFrontTF, "txt"), var_6_4)

		setText = var_8_0
		findTF = var_2

		var_8_0(var_2(arg_6_0.paintFrontTF, "outlineTxt"), var_6_4)
...
function var_0_1.initPaint(arg_10_0)
	...
	var_6(var_10_4, var_1_10009(var_10_3, var_10_2))
	...
	var_6(var_8(arg_10_0.paintFrontTF, "outlineTxt"), var_10_1)
	...
	var_7(var_10_8, var_10(var_10_7, var_10_6))
	...
	var_7(var_9(arg_10_0.paintBackTF, "outlineTxt"), var_10_5)
