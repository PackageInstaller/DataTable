...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.main.NavalAcademyStudent"))
...
function var_0_1.updateLogic(arg_8_0)
	...
	if arg_8_0.state == var_0_1.ShipState.Walk then
		...
		Vector2 = var_7
		var_8_5.localScale = var_8_4 * var_7.one
		...
		local var_8_8 = var_7.value(arg_8_0._go, 0, 1, var_8_3)
		local var_8_9 = var_7.setOnUpdate

		System = var_10

		local var_8_10 = var_8_9(var_8_8, var_10.Action_float(function(arg_9_0)
			local var_9_0
			local var_9_2
			...
			local var_9_8 = var_9_7 * var_2_10003.one
		...
		var_8_11(var_8_10, var_10.Action(function()
