...
function var_0_1.OnFirstFlush(arg_6_0)
	...
	local function var_6_2()
		...
		var_7_1(var_7_0, var_7_2, var_2_10004.NEWMEIXIV4_SKIRMISH, {
	...
	var_1.make(var_6_3, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			if not var_6.getTaskById(var_8_3, var_8_2) then
				local var_8_4 = arg_6_0.taskProxy
			...
			var_7(arg_8_2:Find("finish"), var_8_5 and var_8_5:getTaskStatus() == 2 or var_8_0 <= arg_6_0.clearTaskNum)

			setActive = var_7

			var_7(arg_8_2:Find("lock"), false)

			setText = var_7

			var_7(arg_8_2:Find("title"), "P" .. var_8_0)
		end
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	var_1(var_9_0, var_1_10004.format("%02d", arg_9_0.curTaskIndex))
	...
	var_1(var_9_1, var_9_2 .. var_1_10005.format("%02d", arg_9_0.curTaskIndex))
	...
	typeof = var_4
	Image = var_6
	var_9_4(var_9_3, var_4(var_6)).fillAmount = arg_9_0.curTaskIndex / #arg_9_0.taskList
