...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".TemplatePage.UrExchangeTemplatePage"))
...
function var_0_1.OnInit(arg_2_0)
	...
	arg_2_0.shopProxy = var_1_10001(var_1_10003)
	getProxy = var_1
	PlayerProxy = var_1_10003
	arg_2_0.playerProxy = var_1(var_1_10003)
	getProxy = var_1
	TaskProxy = var_1_10003
	arg_2_0.taskProxy = var_1(var_1_10003)
	getProxy = var_1
	ShopsProxy = var_1_10003
	arg_2_0.shopProxy = var_1(var_1_10003)
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	var_1_10001(var_4_0, var_1_10004("UrExchange_Pt_NotEnough"))
	...
	arg_4_0.isLinkActOpen = var_1.getActivityById(var_4_1, arg_4_0.config.activitytime) and not var_1:isEnd()
	setActive = var_2

	var_2(arg_4_0._tasksTF, arg_4_0.isLinkActOpen)

	local var_4_2 = arg_4_0.uilist

	var_2.make(var_4_2, function(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_4_4 = arg_4_0._btnSimulate
	...
	local function var_4_5()
		...
		if arg_4_0.config.expedition == 0 then
			...
			var_6_1(var_6_0, var_2_10003("tech_simulate_closed"))
		else
			i18n = var_6_1
			...
			local var_6_3 = var_2_10001.MsgboxMgr.GetInstance()
			...
			var_1.ShowMsgBox(var_6_3, {
				...
				onYes = function()
					...
					local var_7_2 = var_3_10003.ON_SIMULATION_COMBAT
					local var_7_3 = {
					...
					var_7_1(var_7_0, var_7_2, var_7_3, var_7_4, var_3_10006)
	...
	local var_4_7 = arg_4_0._btnExchange
	...
	local function var_4_8()
		...
		if arg_4_0.canExchange then
			...
			Drop = var_2_10004
			var_9_2.drop = var_2_10004.Create({
			...
			function var_9_2.onYes()
				...
				var_10_1(var_10_0, var_3_10003.ON_ACT_SHOPPING, arg_4_0.shopId, 1, arg_4_0.curGoods.id, 1)
				...
				var_10_3(var_10_2, var_3.BuildUrRedeem(arg_4_0.curGoods.commodity_id, 2))
			...
			local var_9_4 = var_2_10001.delayedCall
			local var_9_5 = 1

			System = var_2_10004
			var_9_3.leantween = var_9_4(var_9_5, var_2_10004.Action(function()
	...
	local var_4_10 = arg_4_0._btnHelp
	...
	local function var_4_11()
		...
		i18n = var_2_10004
		var_12_2.helps = var_2_10004("UrExchange_Pt_help")
	...
	var_2(var_4_9, var_4_10, var_4_11, var_1_10007)
...
var_0_1.taskTypeDic = {
	[var_0_1.SP_FIRST] = function(arg_14_0, arg_14_1)
		...
		local function var_14_1()
			...
			local var_15_3 = var_2_10004.TASK
			local var_15_4 = {}

			TaskScene = var_2_10006
			var_15_4.page = var_2_10006.PAGE_TYPE_ACT
	...
	[var_0_1.SP_DAILY] = function(arg_16_0, arg_16_1)
		local function var_16_0()
			...
			local var_17_2 = var_2_10003.EVENT_GO_SCENE

			SCENE = var_2_10004

			local var_17_3 = var_2_10004.LEVEL
			local var_17_4 = {}

			pg = var_2_10006
			var_17_4.mapIdx = var_2_10006.chapter_template[arg_16_1[1]].map
	...
	[var_0_1.RANDOM_DAILY] = function(arg_18_0, arg_18_1)
		...
		local function var_18_1()
			...
			local var_19_2 = var_2_10003.EVENT_GO_SCENE

			SCENE = var_2_10004

			local var_19_3 = var_2_10004.TASK
			local var_19_4 = {}

			TaskScene = var_2_10006
			var_19_4.page = var_2_10006.PAGE_TYPE_ACT
	...
	[var_0_1.CHALLANGE] = function(arg_20_0, arg_20_1)
		...
		local function var_20_3()
			...
			local var_21_2 = var_2_10003.EVENT_GO_SCENE

			SCENE = var_2_10004

			local var_21_3 = var_2_10004.TASK
			local var_21_4 = {}

			TaskScene = var_2_10006
			var_21_4.page = var_2_10006.PAGE_TYPE_ACT
	...
	[var_0_1.MINI_GAME] = function(arg_22_0, arg_22_1)
		...
		local function var_22_3()
			...
			var_23_1(var_23_0, var_2_10003.GO_MINI_GAME, var_22_0)
	...
	[var_0_1.SHOP_BUY] = function(arg_24_0, arg_24_1)
		local function var_24_0()
			...
			local var_25_2 = var_2_10003.GO_SHOPS_LAYER
			local var_25_3 = {}

			NewShopsScene = var_2_10005
			var_25_3.warp = var_2_10005.TYPE_ACTIVITY
		...
		local var_24_2 = var_1_10004.activity_shop_template[arg_24_1[1]].num_limit
