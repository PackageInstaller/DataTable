...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_1(var_4_0, var_4_2, var_2_10004.SPRING_FESTIVAL_BACKHILL_2023, {
...
function var_0_1.UpdataPageIndex(arg_8_0)
	...
	for iter_8_0 = #arg_8_0.fireworkPages, 1, -1 do
		...
		var_1_10006(arg_8_0.fireworkPages[iter_8_0], function(arg_9_0)
			...
			if var_2_10002.contains(arg_8_0.unlockIds, var_9_0) then
				var_8_5 = var_8_5 + 1
			end
...
function var_0_1.UpdateFrieworkPanel(arg_11_0, arg_11_1)
	...
	if arg_11_0.fireworkAct then
		var_1_10006 = arg_11_0.fireworkAct
		var_11_1 = not var_4.isEnd(var_1_10006)
	end

	var_2(var_11_1, "烟花活动(type92)已结束")

	local var_11_2 = arg_11_0.fireworkAct

	arg_11_0.unlockCount = var_2.getData1(var_11_2)

	local var_11_3 = arg_11_0.fireworkAct

	arg_11_0.unlockIds = var_2.getData1List(var_11_3)
	...
	for iter_11_0 = #arg_11_0.fireworkPages, 1, -1 do
		...
		var_1_10006(arg_11_0.fireworkPages[iter_11_0], function(arg_12_0)
			...
			if var_2_10002.contains(arg_11_0.unlockIds, var_12_0) then
				setActive = var_2
				...
				var_2(var_12_1, var_12_2, var_12_3, var_2_10007)
			end
	...
	for iter_11_1, iter_11_2 in var_3(arg_11_0.fireworkPages) do
		...
		local var_11_4 = iter_11_2

		tonumber = var_1_10011
		var_1_10011 = var_1_10011(iter_11_2.name) == arg_11_1

		var_1_10008(var_11_4, var_1_10011)
	end
	...
	for iter_11_3, iter_11_4 in var_3(arg_11_0.dots) do
		...
		local var_11_5 = iter_11_4

		tonumber = var_1_10011
		var_1_10011 = var_1_10011(iter_11_4.name) == arg_11_1

		var_1_10008(var_11_5, var_1_10011)
	end
	...
	local var_11_6 = var_3(var_5)
	local var_11_7 = var_3.getRawData(var_11_6)

	arg_11_0.ptNum = var_3.getResource(var_11_7, arg_11_0.ptID)
	setText = var_4
...
function var_0_1.OnUnlockClick(arg_14_0, arg_14_1)
	...
	if arg_14_0.unlockCount <= 0 then
		...
		var_14_1(var_14_0, var_1_10005("activity_yanhua_tip6"))
	...
	i18n = var_1_10006
	var_14_4.content = var_1_10006("activity_yanhua_tip4", arg_14_0.ptConsume)
	...
	function var_14_4.onYes()
		if arg_14_0.ptNum < arg_14_0.ptConsume then
			...
			var_15_1(var_15_0, var_2_10003("activity_yanhua_tip5"))
		else
			...
			var_15_3(var_15_2, var_2_10003.EVENT_OPERATION, {
				cmd = 1,
