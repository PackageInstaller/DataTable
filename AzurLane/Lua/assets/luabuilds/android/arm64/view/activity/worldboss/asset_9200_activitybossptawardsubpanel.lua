...
function var_0_1.OnInit(arg_2_0)
	...
	arg_2_0.UIlist = var_2_1(var_2_3, var_4.Find(var_2_4, "window/panel/list/item"))
	...
	typeof = var_4
	Text = var_2_4
	arg_2_0.totalTxt = var_2_7(var_2_6, var_4(var_2_4))
	...
	typeof = var_4
	Text = var_2_4
	arg_2_0.totalTitleTxt = var_2_10(var_2_9, var_4(var_2_4))
	...
	local var_2_17 = var_4.Find(var_2_16, "bg_dark")
	...
	var_1(var_2_15, var_2_17, var_2_18, var_2_16)
	...
	var_1(var_2_19, var_2_20, var_2_21, var_2_16)
	...
	var_1(var_2_22, var_2_23, var_2_24, var_2_16)
...
function var_0_1.UpdateView(arg_6_0, arg_6_1)
	...
	if arg_6_1.type == 2 then
		...
		i18n = var_1_10012
		var_6_7 = var_6_7(var_6_9, var_1_10012("pt_cosume", var_6_8))
		i18n = var_1_10010

		local var_6_10 = "pt_total_count"

		i18n = var_1_10013
		arg_6_0.cntTitle = var_1_10010(var_6_10, var_1_10013("pt_cosume", var_6_8))
		arg_6_0.resTitle = var_6_7
	else
		i18n = var_6_7

		local var_6_11 = var_6_7("pt_count", var_6_8)

		i18n = var_1_10010
		arg_6_0.cntTitle = var_1_10010("pt_total_count", var_6_8)
	...
	var_6_12(arg_6_0.btn_get, var_6_13)

	setActive = var_6_12

	var_6_12(arg_6_0.btn_banned, not var_6_13)
...
function var_0_1.UpdateList(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	var_5.make(var_7_0, function(arg_8_0, arg_8_1, arg_8_2)
		...
		local var_8_5 = arg_8_2.Find(var_8_4, "award")
		...
		local function var_8_6()
			...
			var_9_1(var_9_0, var_3_10003.ON_DROP, var_8_2)
		...
		var_6(var_8_3, var_8_5, var_8_6, var_8_4)

		setActive = var_6

		var_6(arg_8_2:Find("award/mask"), arg_8_1 + 1 <= arg_7_3)

		local var_8_7 = arg_7_0.ptData.progress_target[arg_8_1 + 1] < arg_7_4

		setActive = var_7

		var_7(arg_8_2:Find("mask"), var_8_7)

		if var_8_7 then
			setText = var_7

			local var_8_8 = arg_8_2:Find("mask/Text")
			...
			var_7(var_8_8, var_10(var_8_9, var_2_10013.round(arg_7_0.ptData.progress_target[arg_8_1 + 1] / 100)))
		end
