...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.worldboss.ActivityBossTotalRewardPanel"))
...
function var_0_1.UpdateView(arg_4_0)
	...
	local var_4_4 = var_4.Find(var_4_3, "Fixed/ButtonGO/pic")

	i18n = var_5

	var_1_10002(var_4_4, var_5("text_confirm"))

	onButton = var_1_10002

	local var_4_5 = arg_4_0
	local var_4_6 = arg_4_0.window
	local var_4_7 = var_5.Find(var_4_6, "Fixed/ButtonGO")
	...
	var_1_10002(var_4_5, var_4_7, var_4_8, var_4_6)

	setText = var_1_10002

	local var_4_9 = arg_4_0.window
	local var_4_10 = var_4.Find(var_4_9, "Fixed/ButtonExit/pic")

	i18n = var_4_7

	var_1_10002(var_4_10, var_4_7("autofight_leave"))

	onButton = var_1_10002

	local var_4_11 = arg_4_0
	local var_4_12 = arg_4_0.window
	local var_4_13 = var_5.Find(var_4_12, "Fixed/ButtonExit")
	...
	var_1_10002(var_4_11, var_4_13, var_4_14, var_4_12)
	...
	var_4_11(var_6.Find(var_4_17, "Content/TextArea2"), arg_4_0.contextData.totalBattleTimes)
	...
	CustomIndexLayer = var_4_13

	local var_4_20 = var_4_13.Clone2Full(arg_4_0.itemList, #var_4_15)

	ipairs = var_6

	for iter_4_0, iter_4_1 in var_6(var_4_20) do
		var_1_10011 = var_4_15[iter_4_0]
		var_1_10012 = var_4_20[iter_4_0]
		...
		local var_4_22 = var_1_10012
		local var_4_23 = var_1_10012.Find(var_4_22, "Icon")
		...
		var_1_10013(var_4_21, var_4_23, var_4_24, var_4_22)
	end
	...
	if var_4_19 then
		...
		for iter_4_2 = 1, #var_4_15 do
			local var_4_25 = var_4_20[iter_4_2]

			setActive = var_1_10011

			var_1_10011(var_4_25, false)
	...
	if not arg_4_0.contextData.stopReason then
		if arg_4_0.contextData.isAutoFight then
			table = var_4_27
			var_4_27 = var_4_27.insert

			local var_4_28 = var_4_26

			i18n = var_1_10011

			var_4_27(var_4_28, var_1_10011("multiple_sorties_finish"))
		else
			table = var_4_27
			var_4_27 = var_4_27.insert

			local var_4_29 = var_4_26

			i18n = var_1_10011

			var_4_27(var_4_29, var_1_10011("multiple_sorties_stop"))
		end
	else
		table = var_4_27

		local var_4_30 = var_4_27.insert
		local var_4_31 = var_4_26

		var_1_10011 = var_7
		i18n = var_1_10012

		var_4_30(var_4_31, var_1_10011 .. var_1_10012("multiple_sorties_stop_tip_end"))
	end

	if arg_4_0.contextData.totalBattleTimes then
		table = var_8

		local var_4_32 = var_8.insert
		local var_4_33 = var_4_26

		i18n = var_1_10011

		var_4_32(var_4_33, var_1_10011("multiple_sorties_end_status", arg_4_0.contextData.totalBattleTimes, arg_4_0.contextData.totalBattleTimes - arg_4_0.contextData.continuousBattleTimes))

		if #var_4_26 > 0 then
			setText = var_8

			local var_4_34 = arg_4_0.boxView
			local var_4_35 = var_10.Find(var_4_34, "Content/TextArea2/Text")

			table = var_11

			var_8(var_4_35, var_11.concat(var_4_26, "\n"))
		end
	end
...
function var_0_1.willExit(arg_14_0)
	...
	BossRushTotalRewardPanelMediator = var_1_10004

	var_14_1(var_14_0, var_1_10004.ON_WILL_EXIT)
