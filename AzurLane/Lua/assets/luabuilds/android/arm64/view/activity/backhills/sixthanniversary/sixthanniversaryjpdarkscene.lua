...
function var_0_1.init(arg_2_0)
	...
	local var_2_4 = var_3.Find(var_2_3, "top/Count/explain")

	i18n = var_4

	var_1(var_2_4, var_4("jp6th_lihoushan_pt1"))
	...
	for iter_2_0 = 1, 7 do
		...
		local var_2_9 = var_2_8(var_2_7, var_1_10008(iter_2_0), arg_2_0.levelcontainer)
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.jp6th_lihoushan_help.tip
	...
	local var_3_14 = var_4.Find(var_3_13, "top/Shop")

	local function var_3_15()
		local var_7_0 = arg_3_0
		local var_7_1 = var_0.emit

		SixthAnniversaryJPDarkMediator = var_2_10003

		local var_7_2 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		var_7_1(var_7_0, var_7_2, var_2_10004.ZUMA_PT_SHOP)
	...
	local var_3_18 = var_4.Find(var_3_17, "top/Task")
	...
	local function var_3_19()
		...
		var_8_1(var_8_0, var_8_2, var_2_10004.LAUNCH_BALL_TASK)
	...
	var_1_10001(var_3_16, var_3_18, var_3_19, var_3_17)

	onButton = var_1_10001

	local var_3_20 = arg_3_0
	local var_3_21 = arg_3_0._tf
	local var_3_22 = var_4.Find(var_3_21, "BG/door")
	...
	local function var_3_23()
		...
		var_9_1(var_9_0, var_2_10003.SIXTH_ANNIVERSARY_JP)
	...
	local var_3_24 = arg_3_0.config.config_client.lihoushanstory

	pg = var_1_10002

	local var_3_25 = var_1_10002.NewStoryMgr.GetInstance()

	var_2.Play(var_3_25, var_3_24)
...
function var_0_1.UpdateLevels(arg_11_0)
	...
	for iter_11_0 = 1, 7 do
		...
		local var_11_3 = var_11_2(var_11_1, var_1_10008(iter_11_0), arg_11_0.levelcontainer)

		var_1_10008 = arg_11_0
		var_1_10006 = arg_11_0.GetLevelStatus(var_1_10008, iter_11_0)

		arg_11_0:UpdateLevelByStatus(var_11_3, var_1_10006)
	end

	for iter_11_1 = 1, 3 do
		local var_11_4 = arg_11_0.levelcontainer
		local var_11_5 = var_5.Find(var_11_4, "role" .. iter_11_1)

		LaunchBallActivityMgr = var_1_10006
		var_1_10006 = var_1_10006.CheckZhuanShuAble(arg_11_0.activityID, iter_11_1)
		LaunchBallActivityMgr = var_11_4

		local var_11_6 = var_11_4.IsFinishZhuanShu(arg_11_0.activityID, iter_11_1)

		setActive = var_1_10008

		var_1_10008(var_11_5, var_1_10006 and not var_11_6)
		...
		local function var_11_9()
			...
			var_1.Play(var_12_1, var_12_0, function()
				...
				LaunchBallGameConst = var_3_10002

				var_13_0(var_3_10002.round_type_zhuanshu, iter_11_1)
		...
		var_1_10008(var_11_7, var_11_8, var_11_9, var_1_10013)
	end

	local var_11_10 = arg_11_0.levelcontainer
	local var_11_11 = var_1.Find(var_11_10, "endless")
	local var_11_12 = arg_11_0.finishCnt
	local var_11_13 = arg_11_0.maxCnt <= var_11_12

	setActive = var_3

	var_3(var_11_11, var_11_13)
	...
	local function var_11_16()
		...
		var_14_0(var_2_10002.round_type_wuxian, 1)
	...
	var_3(var_11_14, var_11_15, var_11_16, var_1_10008)
...
function var_0_1.UpdateLevelByStatus(arg_16_0, arg_16_1, arg_16_2)
	if arg_16_2 == var_0_1.STATUS_LOCK then
		...
		local function var_16_2()
			...
			var_17_1(var_17_0, var_2_10003("jp6th_lihoushan_time"))
		...
		var_3(var_16_0, var_16_1, var_16_2, var_8)
	elseif arg_16_2 == var_0_1.STATUS_FOG then
		...
		local function var_16_5()
			...
			var_18_1(var_18_0, var_2_10003("jp6th_lihoushan_order"))
		...
		var_3(var_16_3, var_16_4, var_16_5, var_8)
	elseif arg_16_2 == var_0_1.STATUS_STORY then
		...
		var_3(var_16_6, var_16_7, var_16_8, var_8)
	elseif arg_16_2 == var_0_1.STATUS_NOROMAL then
		...
		local function var_16_11()
			...
			local var_21_1 = var_2_10002.round_type_juqing

			tonumber = var_2_10003

			var_21_0(var_21_1, var_2_10003(arg_16_1.name))
		...
		var_3(var_16_9, var_16_10, var_16_11, var_8)
	end

	local var_16_12 = arg_16_1:Find("arrow")

	LeanTween = var_1_10004

	var_1_10004.cancel(var_16_12.gameObject)
	...
	if var_4(arg_16_1.name) == arg_16_0.curIndex then
		...
		var_6(var_16_12, true)

		LeanTween = var_6

		local var_16_13 = var_6.moveY(var_16_12, arg_16_0.arrowPosYList[var_4] + var_0_1.ARROW_ANIM_DELTA, var_0_1.ARROW_ANIM_TIME)

		var_6.setLoopPingPong(var_16_13)
	else
		setActive = var_6

		var_6(var_16_12, false)
	end
...
function var_0_1.UpdateCount(arg_22_0)
	...
	var_1_10001(var_22_0, var_1_10004.GetRemainCount(arg_22_0.activityID))
...
function var_0_1.UpdateTaskTip(arg_23_0)
	...
	local var_23_1 = var_3.Find(var_23_0, "Task/Tip")

	LaunchBallTaskMgr = var_1_10004

	var_1_10001(var_23_1, var_1_10004.GetRedTip())
...
function var_0_1.onBackPressed(arg_24_0)
	...
	SixthAnniversaryJPDarkMediator = var_1_10004

	local var_24_2 = var_1_10004.GO_SCENE

	SCENE = var_1_10005

	var_24_1(var_24_0, var_24_2, var_1_10005.SIXTH_ANNIVERSARY_JP)
