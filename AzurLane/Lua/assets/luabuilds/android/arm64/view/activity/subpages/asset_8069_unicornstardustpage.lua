...
local var_0_0 = "UnicornStardustPage"
	...
	local function var_3_2()
		if arg_3_0.taskVO then
			...
			if not var_0.isReceive(var_4_0) then
				...
				var_4_2(var_4_1, var_2_10003, var_2_10004.TASK)
		...
		do
			...
			local var_4_5 = var_2_10003.EVENT_GO_SCENE

			SCENE = var_2_10004

			var_4_4(var_4_3, var_4_5, var_2_10004.NAVALACADEMYSCENE)
		end
...
function var_0_1.OnUpdateFlush(arg_5_0)
	...
	var_1_10001(arg_5_0.got, arg_5_0.taskIndex == #arg_5_0.taskList)
