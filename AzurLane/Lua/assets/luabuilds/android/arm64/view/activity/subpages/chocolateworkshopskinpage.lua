...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_5, var_1_6, var_1_7, var_1_10006)
	...
	var_1(var_1_11, var_4("valentinesday__shop_tip"))
	...
	var_1(var_1_14, var_1_15, var_1_16, var_6)
	...
	var_1(var_1_17, var_1_18, var_1_19, var_6)
	...
	var_1(var_1_20, var_1_21, var_1_22, var_6)
	...
	math = var_2
	arg_1_0.sdName = var_1_24[var_2.random(#arg_1_0.sdNameList)]
	...
	var_1.make(var_7_0, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			if not var_6.getTaskById(var_8_3, var_8_2) then
				local var_8_4 = arg_7_0.taskProxy

				var_8_5 = var_6.getFinishTaskById(var_8_4, var_8_2)
			end

			assert = var_7

			var_7(var_8_5, "without this task by id: " .. var_8_2)

			local var_8_6 = var_8_5:getConfig("award_display")[1]
			local var_8_7 = {
				type = var_8_6[1],
				id = var_8_6[2],
				count = var_8_6[3]
			...
			local function var_8_10()
				...
				var_9_1(var_9_0, var_3_10003.ON_DROP, var_8_7)
			...
			var_9(var_8_8, var_8_9, var_8_10, var_2_10014)

			local var_8_11 = var_8_5
			local var_8_12 = var_8_5.getProgress(var_8_11)
			local var_8_13 = var_8_5:getConfig("target_num")

			setText = var_8_11

			var_8_11(arg_8_2:Find("description"), var_8_5:getConfig("desc"))

			setText = var_8_11

			local var_8_14 = arg_8_2:Find("progressText")

			setColorStr = var_14

			var_8_11(var_8_14, var_14(var_8_12, "#BBCF2EFF") .. "/" .. var_8_13)

			setSlider = var_8_11

			var_8_11(arg_8_2:Find("progress"), 0, var_8_13, var_8_12)

			local var_8_15 = arg_8_2:Find("go_btn")
			local var_8_16 = arg_8_2:Find("get_btn")
			local var_8_17 = arg_8_2
			local var_8_18 = arg_8_2.Find(var_8_17, "got_btn")
			local var_8_19 = var_8_5:getTaskStatus()

			setActive = var_8_17

			var_8_17(var_8_15, var_8_19 == 0)

			setActive = var_8_17

			var_8_17(var_8_16, var_8_19 == 1)

			setActive = var_8_17

			var_8_17(var_8_18, var_8_19 == 2)
			...
			local function var_8_22()
				...
				var_10_1(var_10_0, var_3_10003.ON_TASK_GO, var_8_5)
			...
			var_8_17(var_8_20, var_8_21, var_8_22, var_2_10020)
			...
			local function var_8_25()
				...
				var_11_1(var_11_0, var_3_10003.ON_TASK_SUBMIT, var_8_5)
			...
			var_8_17(var_8_23, var_8_24, var_8_25, var_2_10020)
		end
...
function var_0_1.OnUpdateFlush(arg_12_0)
	...
	for iter_12_0 = 1, arg_12_0.finishContainer.childCount do
		var_1_10007 = arg_12_0.finishContainer

		local var_12_0 = var_5.GetChild(var_1_10007, iter_12_0 - 1)
	...
	if not arg_12_0.showBubbleTag then
		if var_12_4 == 0 then
			...
			var_12_6(var_12_5, var_1_10007(arg_12_0.bubbleTextTable[arg_12_0.sdName][1]))
		...
		elseif var_12_4 == 1 then
			...
			var_12_6(var_12_7, var_1_10007(arg_12_0.bubbleTextTable[arg_12_0.sdName][2]))
	...
	if var_12_4 == 0 then
		...
		var_12_6(var_6.Find(var_12_8, "choco_factory_rest"), true)
	else
		setActive = var_12_6

		local var_12_9 = arg_12_0.aniContainerTF

		var_12_6(var_6.Find(var_12_9, "choco_factory_working"), true)
	end
...
function var_0_1.showBubble(arg_15_0, arg_15_1)
	...
	if not arg_15_1 then
		...
		math = var_1_10006
		var_15_0 = var_1_10003(var_15_1[var_1_10006.random(#arg_15_0.bubbleTextList)])
	else
		var_15_0 = arg_15_1
	end
	...
	local function var_15_2(arg_16_0)
		...
		var_16_0(var_16_1, var_2_10004.one * arg_16_0)
	...
	local function var_15_3()
		...
		local var_17_1 = var_17_0(var_2_10002(arg_15_0.bubbleTF), 1, 0, var_0_1.FADE_OUT_TIME)
		local var_17_2 = var_0.setOnUpdate

		System = var_3

		local var_17_3 = var_17_2(var_17_1, var_3.Action_float(var_15_2))
		local var_17_4 = var_0.setOnComplete

		System = var_3

		var_17_4(var_17_3, var_3.Action(function()
	...
	var_15_4(var_1_10007(arg_15_0.bubbleTF))
	...
	local var_15_6 = var_15_5(var_7(arg_15_0.bubbleTF), 0, 1, var_0_1.FADE_TIME)
	local var_15_7 = var_5.setOnUpdate

	System = var_8

	local var_15_8 = var_15_7(var_15_6, var_8.Action_float(var_15_2))
	local var_15_9 = var_5.setOnComplete

	System = var_8

	var_15_9(var_15_8, var_8.Action(function()
		LeanTween = var_2_10000
		...
		local var_19_1 = var_2_10002(arg_15_0.bubbleTF)
		local var_19_2 = var_0_1.SHOW_TIME

		System = var_4

		var_19_0(var_19_1, var_19_2, var_4.Action(var_15_3))
