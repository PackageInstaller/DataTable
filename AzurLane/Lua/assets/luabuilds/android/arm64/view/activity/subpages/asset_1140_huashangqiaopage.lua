...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_2()
		...
		SpringFashionFestaMedalAlbumView = var_2_10003
	...
	local function var_3_8()
		...
		var_6_1(var_6_0, var_2_10003.GO_SPECIAL_EXERCISE)
	...
	if var_1_10001.date("%d") == "06" then
		...
		if var_1.date("%m") == "02" then
			...
			if var_1.date("%Y") == "2025" then
				...
				var_1(var_3_13, var_4("tolovemainpage_build_countdown"))
				...
				if var_1.date("%d") >= "01" then
					...
					var_1(var_3_15, var_4("tolovemainpage_skin_countdown", 24 - arg_3_0.times - 1))
				else
					setText = var_1
					...
					var_1(var_3_16, var_4("tolovemainpage_skin_countdown", 24 - arg_3_0.times))
				end
			end
		end
	end
