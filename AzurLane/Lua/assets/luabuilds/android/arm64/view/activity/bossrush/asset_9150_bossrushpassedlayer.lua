...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.challenge.ChallengePassedLayer"))
...
function var_0_1.updateSlider(arg_8_0, arg_8_1)
	...
	local var_8_4 = var_8_2(var_8_3, var_1_10009(var_1_10011)).preferredWidth * 0.5
...
function var_0_1.moveSlider(arg_13_0, arg_13_1)
	...
	local var_13_5 = var_13_4(var_1_10009(arg_13_0.slider), var_13_2, var_13_3, var_0_1.GROW_TIME)
	local var_13_6 = var_7.setDelay(var_13_5, 1.4)
	local var_13_7 = var_7.setOnUpdate

	System = var_10

	local var_13_8 = var_13_7(var_13_6, var_10.Action_float(function(arg_14_0)
	...
	var_13_9(var_13_8, var_10.Action(function()
