...
function var_0_0._ShowNormalFleet_(arg_11_0, arg_11_1)
	...
	if not var_11_2[var_1_10004.Valleyhospital_ACT_ID][arg_11_1 - 2000] then
	...
	if not var_4[var_5 + var_6.MEGA_SUBMARINE_FLEET_OFFSET] then
		...
		Fleet = var_1_10009
		var_4[var_11_3] = var_11_4(var_5 + var_1_10009.MEGA_SUBMARINE_FLEET_OFFSET)
	end
	...
	Fleet = var_12
	var_11_9[2] = var_4[var_5 + var_12.MEGA_SUBMARINE_FLEET_OFFSET]
...
function var_0_0._openShipInfo_(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_2 = var_1_10005(var_1_10007)
...
function var_0_0._openCommanderPanel_(arg_18_0, arg_18_1, arg_18_2)
	...
	var_4.setCallback(var_18_1, function(arg_19_0)
		...
		if var_19_0 == var_2_10002.COMMANDER_OP_SHOW_SKILL then
			...
			if var_19_2 == var_2.COMMANDER_OP_ADD then
				...
				var_19_7.FleetType = var_2_10006.FLEET_TYPE_ACTIVITY
...
function var_0_0._CreateNewFleet_(arg_23_0)
	...
	if var_4.MEGA_SUBMARINE_FLEET_OFFSET < arg_23_0 then
		FleetType = var_23_2
