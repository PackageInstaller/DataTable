...
function var_0_1.register(arg_1_0)
	...
	if var_1_10001 == var_1_10002 then
		arg_1_0:bind(var_0_1.ON_GET, function(arg_2_0, arg_2_1)
			...
			var_2_1(var_2_0, var_2_10005.ACTIVITY_OPERATION, {
				cmd = 4,
				activity_id = var_0_2
			})
...
function var_0_1.GetCollectionData()
	...
	local var_3_3 = var_1_10004(var_1_10006)
	...
	for iter_3_0 = 1, #var_3_6 do
		...
		elseif iter_3_0 == var_3_4 and var_3_5 and #var_3_5 > 0 then
			for iter_3_2 = 1, #var_3_5 do
				...
				local var_3_7 = var_1_10017

				ActivityConst = var_1_10021

				if var_1_10018(var_3_7, var_1_10021.EXPEDITION_TYPE_BOSS) ~= 0 then
					bit = var_1_10018
					var_1_10018 = var_1_10018.band

					local var_3_8 = var_1_10017

					ActivityConst = var_1_10021

					if var_1_10018(var_3_8, var_1_10021.EXPEDITION_TYPE_GOT) ~= 0 then
						bit = var_1_10018
	...
	for iter_3_3 = 1, #var_1.boss_list do
		local var_3_10 = var_1.boss_list[iter_3_3]
		local var_3_11 = 0

		for iter_3_4 = 1, #var_3_10 do
			table = var_1_10019

			if var_1_10019.contains(var_3_2, var_3_10[iter_3_4]) then
				var_3_11 = var_3_11 + 1
			end
		end

		if var_3_11 == #var_3_10 then
			var_3_9 = var_3_9 + 1
		end
	end
	...
	return var_3_1, var_3_2, var_3_9, var_3_12
end
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_1 == var_5_0.ACTIVITY_UPDATED and var_5_2.id == var_0_2 then
