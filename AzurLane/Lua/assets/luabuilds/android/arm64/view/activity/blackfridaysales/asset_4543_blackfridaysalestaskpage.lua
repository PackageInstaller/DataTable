...
function var_0_1.initData(arg_3_0)
	...
	local var_3_2 = var_3_1(var_3_0, var_1_10004.ACTIVITY_TYPE_TASKS)

	ipairs = var_1_10002

	for iter_3_0, iter_3_1 in var_1_10002(var_3_2) do
...
function var_0_1.initUI(arg_4_0)
	...
	arg_4_0.taskGroupItemList = var_4_3(var_4_4, var_4.Find(var_4_5, "tpl"))
	setActive = var_1
...
function var_0_1.updateTaskGroup(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_2 = arg_8_1.Find(var_8_1, "info")
	local var_8_3 = {}

	ipairs = var_8_1

	for iter_8_0, iter_8_1 in var_8_1(var_8_0) do
		var_1_10013 = iter_8_1

		if not iter_8_1.isReceive(var_1_10013) then
			table = var_11
	...
	if 0 < var_8_4 then
		...
		if not var_8_4.remove(var_8_3, 1) then
			var_8_5 = var_8_0[#var_8_0]
		end
		...
		var_7(var_8_6, iter_8_1(var_1_10012), #var_8_3 > 0)
		arg_8_0:updateTaskDisplay(var_8_2, var_8_5)

		setActive = var_7

		local var_8_7 = var_8_2:Find("toggle_mark")
		local var_8_8 = #var_8_3

		var_7(var_8_7, 0 < var_8_8)

		local var_8_9 = var_8_5:getTaskStatus()
		...
		var_8(var_8_10, var_11(var_1_10013)).alpha = var_8_9 == 2 and 0.5 or 1
		setActive = var_9

		var_9(var_8_2:Find("mask"), var_8_9 == 2)

		setActive = var_9

		var_9(var_8_2:Find("bg/receive"), var_8_9 == 1)

		onToggle = var_9

		var_9(arg_8_0, var_8_2, function(arg_9_0)
			if arg_9_0 then
				...
				local var_9_1 = var_2_10002.New(var_2_10001, arg_8_0.extendTpl)
				...
				var_2.make(var_9_1, function(arg_10_0, arg_10_1, arg_10_2)
					...
					if arg_10_0 == var_3_10003.EventUpdate then
						...
						var_3.updateTaskDisplay(var_10_0, arg_10_2, var_8_3[arg_10_1])
					end
				...
				var_3(arg_8_0.content, 0, 1 - (arg_8_2 - 1) / (#arg_8_0.showVOGroup + #var_8_3 - 4))
			else
				removeAllChildren = var_2_10001

				local var_9_2 = arg_8_1

				var_2_10001(var_3.Find(var_9_2, "content"))
			end
...
function var_0_1.updateTaskDisplay(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_1 = arg_11_2.getProgress(var_11_0)
	local var_11_2 = arg_11_2:getConfig("target_num")

	setSlider = var_11_0

	var_11_0(arg_11_1:Find("Slider"), 0, var_11_2, var_11_1)
	...
	local var_11_7 = arg_11_1.Find(var_11_6, "IconTpl")
	...
	local function var_11_8()
		...
		var_12_1(var_12_0, var_2_10003.ON_DROP, var_11_4)
	...
	var_6(var_11_5, var_11_7, var_11_8, var_11_6)

	local var_11_9 = arg_11_2:getTaskStatus()

	setActive = var_7

	var_7(arg_11_1:Find("go"), var_11_9 == 0)

	setActive = var_7

	var_7(arg_11_1:Find("get"), var_11_9 == 1)

	setActive = var_7

	var_7(arg_11_1:Find("got"), var_11_9 == 2)

	setText = var_7

	local var_11_10 = arg_11_1:Find("desc")

	setColorStr = var_10

	var_7(var_11_10, var_10(arg_11_2:getConfig("desc"), arg_11_0:getColor(var_0_1.TXT_DESC, var_11_9)))

	setText = var_7

	local var_11_11 = arg_11_1
	local var_11_12 = arg_11_1.Find(var_11_11, "Slider/Text")

	setColorStr = var_10

	local var_11_13 = var_10(var_11_1, arg_11_0:getColor(var_0_1.TXT_CURRENT_NUM, var_11_9))

	setColorStr = var_11_11

	var_7(var_11_12, var_11_13 .. var_11_11("/" .. var_11_2, arg_11_0:getColor(var_0_1.TXT_TARGET_NUM, var_11_9)))

	onButton = var_7

	local var_11_14 = arg_11_0
	local var_11_15 = arg_11_1
	local var_11_16 = arg_11_1.Find(var_11_15, "go")
	...
	local function var_11_17()
		...
		var_13_1(var_13_0, var_2_10003.TASK_GO, arg_11_2)
	...
	var_7(var_11_14, var_11_16, var_11_17, var_11_15)

	onButton = var_7

	local var_11_18 = arg_11_0
	local var_11_19 = arg_11_1
	local var_11_20 = arg_11_1.Find(var_11_19, "get")
	...
	local function var_11_21()
		...
		var_14_1(var_14_0, var_2_10003.TASK_SUBMIT, arg_11_2)

		return
	end

	SFX_CONFIRM = var_11_19

	var_7(var_11_18, var_11_20, var_11_21, var_11_19)
...
function var_0_1.filterAll(arg_16_0)
	...
	arg_16_0.taskVOGroup = var_1_10001.map(arg_16_0.taskGroupList, function(arg_17_0)
		...
		return var_2_10001.map(arg_17_0, function(arg_18_0)
			...
			var_3_10001(var_3.getTaskVO(var_18_0, arg_18_0), "without this task:" .. arg_18_0)
...
function var_0_1.isTip(arg_25_0)
	if arg_25_0.finishVOList then
		...
		local var_25_2 = var_1_10002(var_1_10004)
		local var_25_3 = var_2.getActivitiesByType

		ActivityConst = var_1_10005

		local var_25_4 = var_25_3(var_25_2, var_1_10005.ACTIVITY_TYPE_TASKS)

		ipairs = var_1_10003

		for iter_25_0, iter_25_1 in var_1_10003(var_25_4) do
			var_1_10010 = iter_25_1

			if iter_25_1.getConfig(var_1_10010, "config_client").blackFriday then
				var_25_1 = iter_25_1
		...
		if var_25_1 then
			...
			if not var_25_1.isEnd(var_25_5) then
				...
				local var_25_7 = var_25_1:getConfig("config_client").taskGroup

				ipairs = var_25_5

				for iter_25_2, iter_25_3 in var_25_5(var_25_7) do
					ipairs = var_1_10010
					...
					for iter_25_4, iter_25_5 in var_1_10010(iter_25_3) do
						...
						local var_25_8 = var_25_6:getTaskVO(iter_25_5)

						if var_1_10015.getTaskStatus(var_25_8) == 1 then
							return true
						end
					end
				end
