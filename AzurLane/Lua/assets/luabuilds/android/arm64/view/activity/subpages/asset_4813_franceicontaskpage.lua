...
function var_0_1.Switch(arg_4_0, arg_4_1)
	...
	local var_4_7 = var_4_6(var_7(arg_4_0.phases[1]), var_4_3, 0.4)
	local var_4_8 = var_5.setOnComplete

	System = var_8

	var_4_8(var_4_7, var_8.Action(function()
	...
	var_4_11(var_4_10, var_8.Action_float(function(arg_6_0)
	...
	var_4_11(var_7.Find(var_4_12, "Image"), true)
	...
	local var_4_14 = var_4_11(var_4_13, var_8(var_10))

	LeanTween = var_1_10006

	local var_4_15 = var_1_10006.value

	go = var_8

	local var_4_16 = var_4_15(var_8(arg_4_0.phases[2]), 0, 1, 0.4)
	local var_4_17 = var_6.setOnUpdate

	System = var_9

	var_4_17(var_4_16, var_9.Action_float(function(arg_7_0)
	...
	var_4_17(var_8.Find(var_4_18, "label"), false)
	...
	local var_4_20 = var_4_19(var_8(arg_4_0.phases[2]), var_4_2, 0.4)
	local var_4_21 = var_6.setOnComplete

	System = var_9

	var_4_21(var_4_20, var_9.Action(function()
...
function var_0_1.OnUpdateFlush(arg_10_0)
	...
	local var_10_2 = var_3.TimeMgr.GetInstance()
	...
	if var_1_10007(arg_10_0.battleBtn) then
		var_10_5 = var_10_3
	end

	var_10_0(var_10_4, var_10_5)
	...
	if 1 <= var_10_9 then
		...
		if not var_10(var_10_7, "#487CFFFF") then
			var_10_11 = var_10_7
		end

		var_10_5(var_10_10, var_10_11)

		setText = var_10_5

		var_10_5(arg_10_0.progress, "/" .. var_10_8)

		setFillAmount = var_10_5

		var_10_5(arg_10_0.bar, var_10_7 / var_10_8)
