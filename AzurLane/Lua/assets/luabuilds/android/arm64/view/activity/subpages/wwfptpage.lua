...
function var_0_1.initPtData(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1(arg_3_0.subActivities) do
		...
		var_1_10006 = var_1_10006.getActivityById(var_1_10008, iter_3_1)

		if arg_3_0.subPtDate[iter_3_1] then
			local var_3_0 = arg_3_0.subPtDate[iter_3_1]

			var_7.Update(var_3_0, var_1_10006)
		else
			local var_3_1 = arg_3_0.subPtDate

			ActivityPtData = var_1_10008
			var_3_1[iter_3_1] = var_1_10008.New(var_1_10006)
		end
	end
	...
	local var_3_2 = var_1(var_3)
	local var_3_3 = var_1.getRawData(var_3_2)

	arg_3_0.resNum = var_1.getResource(var_3_3, arg_3_0.resID)
...
function var_0_1.setStep2Progress(arg_5_0)
	...
	local var_5_3 = var_5.Find

	tostring = var_1_10008

	local var_5_4 = var_5_3(var_5_2, var_1_10008(arg_5_0.curActIndex))
	local var_5_5 = var_5.GetComponent

	typeof = var_8
	Image = var_10

	var_2(var_5_1, var_5_5(var_5_4, var_8(var_10)).sprite)
	...
	typeof = var_5
	Image = var_5_4
	var_5_7(var_5_6, var_5(var_5_4)).fillAmount = var_5_0 / var_0_2
...
function var_0_1.initTaskData(arg_6_0)
	...
	arg_6_0.taskProxy = var_1_10001(var_1_10003)
	arg_6_0.curTask = {}
	...
	for iter_6_0, iter_6_1 in var_1(arg_6_0.taskList) do
		...
		if not var_6.getTaskById(var_6_0, iter_6_1) then
			...
			var_6_2 = var_6.getFinishTaskById(var_6_1, iter_6_1)
		end

		if var_6_2 then
			table = var_1_10007

			var_1_10007.insert(arg_6_0.curTask, var_6_2.id)

			if var_6_2:getTaskStatus() == 0 then
...
function var_0_1.OnFirstFlush(arg_8_0)
	...
	local function var_8_2()
		...
		local var_9_2 = var_2_10003.SHOW_AWARD_WINDOW

		PtAwardWindow = var_2_10004

		var_9_1(var_9_0, var_9_2, var_2_10004, {
	...
	local function var_8_5()
		...
		local var_10_3 = var_2(var_2_10004)
		local var_10_4 = var_2.getData(var_10_3)
		local var_10_5 = var_10_2.type

		DROP_TYPE_RESOURCE = var_10_3

		if var_10_5 == var_10_3 then
			local var_10_6 = var_10_2.id

			PlayerConst = var_10_3

			if var_10_6 == var_10_3.ResGold and var_10_4:GoldMax(var_10_2.count) then
				table = var_4
				...
				var_4.insert(var_10_0, function(arg_11_0)
					...
					local var_11_3 = var_3_10005("gold_max_tip_title")

					i18n = var_3_10006
					var_11_2.content = var_11_3 .. var_3_10006("award_max_warning")
		...
		var_10_3(var_10_0, function()
			...
			local var_13_5 = var_3_10005.EVENT_PT_OPERATION
			local var_13_6 = {
				cmd = 1
			}
			local var_13_7 = arg_8_0.subPtDate[arg_8_0.curSubActID]

			var_13_6.activity_id = var_7.GetId(var_13_7)
	...
	local function var_8_8()
		...
		i18n = var_2_10004
		var_14_2.helps = var_2_10004("wwf_bamboo_help")
	...
	local function var_8_11()
		if arg_8_0.resNum <= 0 then
			...
			var_15_1(var_15_0, var_2_10003("wwf_bamboo_tip3"))
			...
			var_15_4(var_15_3, var_2_10003.EVENT_PT_OPERATION, {
				cmd = 5,
	...
	if arg_8_0.isFirst == 0 then
		...
		var_3(var_8_33, var_6("wwf_guide_tip"))
...
function var_0_1.OnUpdateFlush(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1_10001(arg_23_0.subActivities) do
		...
		ActivityProxy = var_1_10008
		var_1_10008 = var_1_10006(var_1_10008)
		var_1_10006 = var_1_10006.getActivityById(var_1_10008, iter_23_1)

		if arg_23_0.subPtDate[iter_23_1] then
			local var_23_0 = arg_23_0.subPtDate[iter_23_1]

			var_7.Update(var_23_0, var_1_10006)
		else
			local var_23_1 = arg_23_0.subPtDate

			ActivityPtData = var_1_10008
			var_23_1[iter_23_1] = var_1_10008.New(var_1_10006)
		end
	end
	...
	local var_23_2 = var_1(var_3)
	local var_23_3 = var_1.getRawData(var_23_2)

	arg_23_0.resNum = var_1.getResource(var_23_3, arg_23_0.resID)
	setText = var_2
	...
	local var_23_6 = var_23_2(var_23_5, var_6(var_1_10008))
	...
	typeof = var_6
	CanvasGroup = var_1_10008
	var_23_6(var_23_7, var_6(var_1_10008)).alpha = 0
...
function var_0_1.OnUpdatePtAct(arg_24_0)
	...
	var_1_10001(arg_24_0.tags, function(arg_25_0)
		...
		var_2_10001(var_25_0, var_2_10004(arg_25_0.name) == arg_24_0.curActIndex)
	...
	var_1_10007(arg_24_0.step, function(arg_26_0)
		...
		var_2_10001(var_26_0, var_2_10004(arg_26_0.name) < var_24_1 and true or false)
	...
	if 1 <= var_24_7 then
		...
		if not var_10(var_24_5, "#94D979") then
			var_24_9 = var_24_5
		end
		...
		var_8(arg_24_0.awardTF, var_24_11)
		...
		var_11(arg_24_0.convertBtn, not var_24_13)

		setActive = var_11

		var_11(arg_24_0.getBtn, var_24_13)

		setActive = var_11

		var_11(arg_24_0.gotBtn, not var_24_15)

		setActive = var_11

		local var_24_18 = arg_24_0.step

		var_11(var_13.Find(var_24_18, "10"), not var_24_15)

		setActive = var_11

		var_11(arg_24_0.switchRedDot, not var_24_15 and not arg_24_0:isFinishAllAct())
...
function var_0_1.playPaintingAni(arg_27_0)
	...
	local var_27_5 = var_1_10005(var_27_4, var_1_10008(var_1_10010))
	...
	local var_27_7 = var_1_10006(var_27_6, var_1_10009(var_1_10011))

	LeanTween = var_27_4

	local var_27_8 = var_27_4.value

	go = var_9

	local var_27_9 = var_27_8(var_9(var_27_3), 1, 0, 0.4)
	local var_27_10 = var_7.setOnUpdate

	System = var_10

	local var_27_11 = var_27_10(var_27_9, var_10.Action_float(function(arg_28_0)
	...
	var_27_12(var_27_11, var_10.Action(function()
		...
		local var_29_1 = var_29_0(var_2_10002(var_27_2), 0, 1, 0.4)
		local var_29_2 = var_0.setOnUpdate

		System = var_3

		local var_29_3 = var_29_2(var_29_1, var_3.Action_float(function(arg_30_0)
...
function var_0_1.playSpineAni(arg_32_0)
	...
	local var_32_6 = var_32_1(var_32_5, var_1_10007(var_1_10009))

	setActive = var_32_3

	var_32_3(var_32_2, true)
	...
	local var_32_8 = var_32_7(var_7(var_32_2), 0, 1, var_32_0)
	local var_32_9 = var_5.setOnUpdate

	System = var_8

	var_32_9(var_32_8, var_8.Action_float(function(arg_33_0)
	...
	local function var_32_10()
		...
		local var_34_1 = var_34_0(var_2_10002(var_32_2), 1, 0, var_32_0)
		local var_34_2 = var_0.setOnUpdate

		System = var_3

		var_34_2(var_34_1, var_3.Action_float(function(arg_35_0)
		...
		local var_34_5 = var_34_3(var_34_4, var_3(1, 0, 1), var_32_0)
		local var_34_6 = var_0.setFrom

		Vector3 = var_3

		local var_34_7 = var_34_6(var_34_5, var_3(1, 1, 1))
		local var_34_8 = var_0.setOnComplete

		System = var_3

		var_34_8(var_34_7, var_3.Action(function()
		...
		var_34_9(var_34_10, var_3.Action(function()
			setActive = var_3_10000
			...
			local var_37_2 = var_37_1(var_37_0, var_3(var_3_10005)).fillAmount
			...
			local var_37_5 = var_37_4(var_3_10004(arg_32_0.step2), var_37_2, var_37_3 / var_0_2, 1)
			local var_37_6 = var_2.setOnUpdate

			System = var_5

			local var_37_7 = var_37_6(var_37_5, var_5.Action_float(function(arg_38_0)
				local var_38_0 = arg_32_0.step2
				local var_38_1 = var_1.GetComponent

				typeof = var_4_10004
				Image = var_4_10006
				var_38_1(var_38_0, var_4_10004(var_4_10006)).fillAmount = arg_38_0
			...
			var_37_8(var_37_7, var_5.Action(function()
	...
	local var_32_12 = var_32_8.scale
	local var_32_13 = var_32_2

	Vector3 = var_10

	local var_32_14 = var_32_12(var_32_13, var_10(1, 1, 1), var_32_0)
	local var_32_15 = var_7.setFrom

	Vector3 = var_10

	local var_32_16 = var_32_15(var_32_14, var_10(1, 0, 1))
	local var_32_17 = var_7.setOnComplete

	System = var_10

	var_32_17(var_32_16, var_10.Action(function()
		setActive = var_2_10000
	...
	var_7(var_32_18, var_32_19, var_32_20, var_12)
	...
	var_1.make(var_43_0, function(arg_44_0, arg_44_1, arg_44_2)
		...
		if arg_44_0 == var_2_10003.EventUpdate then
			...
			if not var_6.getTaskById(var_44_3, var_44_2) then
				local var_44_4 = arg_43_0.taskProxy

				var_44_5 = var_6.getFinishTaskById(var_44_4, var_44_2)
			end

			assert = var_7

			var_7(var_44_5, "without this task by id: " .. var_44_2)

			local var_44_6 = var_44_5:getConfig("award_display")[1]
			local var_44_7 = {
				type = var_44_6[1],
				id = var_44_6[2],
				count = var_44_6[3]
			...
			var_9(var_44_1, var_44_7)

			onButton = var_9

			local var_44_8 = arg_43_0
			local var_44_9 = var_44_1

			local function var_44_10()
				local var_45_0 = arg_43_0
				local var_45_1 = var_0.emit

				BaseUI = var_3_10003

				var_45_1(var_45_0, var_3_10003.ON_DROP, var_44_7)
			...
			var_9(var_44_8, var_44_9, var_44_10, var_2_10014)

			local var_44_11 = var_44_5
			local var_44_12 = var_44_5.getProgress(var_44_11)
			local var_44_13 = var_44_5:getConfig("target_num")

			setText = var_44_11

			var_44_11(arg_44_2:Find("description"), var_44_5:getConfig("desc"))

			setText = var_44_11

			var_44_11(arg_44_2:Find("progressText"), var_44_12 .. "/" .. var_44_13)

			setSlider = var_44_11

			var_44_11(arg_44_2:Find("progress"), 0, var_44_13, var_44_12)

			local var_44_14 = arg_44_2
			local var_44_15 = arg_44_2.Find(var_44_14, "go_btn")
			local var_44_16 = var_44_5

			if var_44_5.getTaskStatus(var_44_16) == 1 then
				table = var_44_14
				...
				var_44_14.insert(arg_43_0.finishTaskVOList, var_44_5)
			end
			...
			local var_44_17 = arg_43_0
			local var_44_18 = var_44_15

			local function var_44_19()
				local var_46_0 = arg_43_0
				local var_46_1 = var_0.emit

				ActivityMediator = var_3_10003

				var_46_1(var_46_0, var_3_10003.ON_TASK_GO, var_44_5)
			...
			var_44_14(var_44_17, var_44_18, var_44_19, var_18)

			local var_44_20 = var_44_5:getConfig("type")

			setImageSprite = var_44_16

			local var_44_21 = arg_44_2:Find("type")
			local var_44_22 = arg_43_0.typeImages
			local var_44_23 = var_17.Find

			tostring = var_2_10020

			local var_44_24 = var_44_23(var_44_22, var_2_10020(var_44_20))
			local var_44_25 = var_17.GetComponent

			typeof = var_20
			Image = var_22

			var_44_16(var_44_21, var_44_25(var_44_24, var_20(var_22)).sprite, true)

			setImageSprite = var_44_16

			local var_44_26 = arg_44_2:Find("progress/slider")
			local var_44_27 = arg_43_0.barImages
			local var_44_28 = var_17.Find

			tostring = var_20

			local var_44_29 = var_44_28(var_44_27, var_20(var_44_20))
			local var_44_30 = var_17.GetComponent

			typeof = var_20
			Image = var_22

			var_44_16(var_44_26, var_44_30(var_44_29, var_20(var_22)).sprite)
		end
...
function var_0_1.autoFinishTask(arg_50_0)
	...
	for iter_50_0, iter_50_1 in var_1_10003(arg_50_0.finishItemList) do
		...
		var_1_10008 = var_1_10008(var_50_2, var_1_10011(var_1_10013))
		var_1_10011 = arg_50_0

		local var_50_3 = arg_50_0.managedTween

		LeanTween = var_1_10012

		var_50_3(var_1_10011, var_1_10012.delayedCall, function()
			...
			local var_51_4 = var_51_3(var_51_2, var_3.Action_float(function(arg_52_0)
			...
			var_51_5(var_51_4, var_3.Action(function()
				...
				var_53_0(var_2.Find(var_53_1, "finnal"), true)
	...
	var_50_5(var_50_4, iter_50_0.delayedCall, function()
		pg = var_2_10000
		...
		var_54_1(var_54_0, var_2_10003.SUBMIT_TASK_ONESTEP, {
...
function var_0_1.isNewTask(arg_59_0)
	...
	if var_1_10002.GetInt("wwf_todo_task_num_" .. var_59_1) == 0 and not arg_59_0 == 0 or var_2 < arg_59_0 then
		return true
	else
		return false
	end
...
function var_0_1.IsShowRed()
	...
	for iter_60_0, iter_60_1 in var_1_10005(var_60_2) do
		...
		var_1_10010 = var_1_10010.getActivityById(var_1_10012, iter_60_1)

		if var_60_4[iter_60_1] then
			local var_60_5 = var_60_4[iter_60_1]

			var_11.Update(var_60_5, var_1_10010)
		else
			ActivityPtData = var_11
			var_60_4[iter_60_1] = var_11.New(var_1_10010)
		end
	end
	...
	for iter_60_2, iter_60_3 in var_1_10010(var_60_3) do
		...
		if not var_60_9:getTaskById(iter_60_3) then
			var_60_12 = var_60_9:getFinishTaskById(iter_60_3)
		end

		if var_60_12 then
			table = var_1_10016

			var_1_10016.insert(var_60_10, var_60_12.id)

			if var_60_12:getTaskStatus() == 0 then
	...
	if (function()
		...
		if not var_0_1.canFinishTask(var_60_10, var_60_9) and not var_0_1.canGetPtAward(var_60_4) and not var_0_1.canAddProgress(var_60_8, var_60_4) then
			var_60_13 = var_0_1.isNewTask(var_60_11)
		end
