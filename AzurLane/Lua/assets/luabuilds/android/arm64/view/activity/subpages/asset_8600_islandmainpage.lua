...
function var_0_1.initBtn(arg_1_0)
	...
	function arg_1_0.btnFuncList.shop(arg_2_0)
		...
		local function var_2_2()
			...
			if var_3_0(var_3_2(var_3_1, var_3_10005.ACTIVITY_TYPE_SHOP), function(arg_4_0)
				...
				if var_0.isEnd(var_3_3) then
					pg = var_3_10001
					var_3_3 = var_3_10001.TipsMgr.GetInstance()
					var_3_10001 = var_3_10001.ShowTips
					i18n = var_3_1

					var_3_10001(var_3_3, var_3_1("challenge_end_tip"))
				...
				local var_3_4 = var_3_10001(var_3_3)
				...
				if var_3_5(var_3_4, var_3_1.ACTIVITY_TYPE_ISLAND) and not var_1:isEnd() then
					...
					SCENE = var_3_10006
					var_3_10006 = var_3_10006.ANNIVERSARY_ISLAND_SEA

					local var_3_9 = {}

					SixthAnniversaryIslandScene = var_3_10008
					var_3_9.wraps = var_3_10008.SHOP

					var_3_7(var_3_6, var_3_8, var_3_10006, var_3_9)
				else
					...
					local var_3_13 = var_3_10006.New
					local var_3_14 = {}

					SixthAnniversaryIslandShopMediator = var_3_10009
					var_3_14.mediator = var_3_10009
					SixthAnniversaryIslandShopLayer = var_3_10009
					var_3_14.viewComponent = var_3_10009
		...
		var_2_10001(var_2_0, var_2_1, var_2_2, var_2_10006)
	...
	function arg_1_0.btnFuncList.activity(arg_5_0)
		...
		local function var_5_2()
			...
			if not var_6_1(var_6_0, var_3_10003.ACTIVITY_TYPE_ISLAND) or var_0:isEnd() then
				pg = var_3_10001

				local var_6_2 = var_3_10001.TipsMgr.GetInstance()
				local var_6_3 = var_1.ShowTips

				i18n = var_3_10004

				var_6_3(var_6_2, var_3_10004("challenge_end_tip"))
			...
			local var_6_6 = var_3_10004.EVENT_GO_SCENE

			SCENE = var_3_10005

			var_6_5(var_6_4, var_6_6, var_3_10005.ANNIVERSARY_ISLAND_SEA)
	...
	function arg_1_0.btnFuncList.mountain(arg_7_0)
		...
		local function var_7_2()
			...
			if not var_8_1(var_8_0, var_3_10003.ACTIVITY_TYPE_BUILDING_BUFF_2) or var_0:isEnd() then
				pg = var_3_10001

				local var_8_2 = var_3_10001.TipsMgr.GetInstance()
				local var_8_3 = var_1.ShowTips

				i18n = var_3_10004

				var_8_3(var_8_2, var_3_10004("challenge_end_tip"))
			...
			local var_8_6 = var_3_10004.EVENT_GO_SCENE

			SCENE = var_3_10005

			var_8_5(var_8_4, var_8_6, var_3_10005.ANNIVERSARY_ISLAND_BACKHILL_2023)
...
function var_0_1.OnUpdateFlush(arg_9_0)
	local var_9_0 = {
		shop = function()
			...
			local var_10_1 = var_2_10002(var_2_10004)
			local var_10_2 = var_2.getActivitiesByType

			ActivityConst = var_2_10005

			return var_10_0(var_10_2(var_10_1, var_2_10005.ACTIVITY_TYPE_SHOP), function(arg_11_0)
		...
		activity = function()
			...
			return var_12_1(var_12_0, var_2_10003.ACTIVITY_TYPE_ISLAND)
		end,
		mountain = function()
			getProxy = var_2_10000
			ActivityProxy = var_2_10002
			...
			return var_13_1(var_13_0, var_2_10003.ACTIVITY_TYPE_BUILDING_BUFF_2)
		end
	}
	...
	for iter_9_0, iter_9_1 in var_2(var_9_0) do
		...
		local var_9_3 = var_10.Find(var_9_2, iter_9_0)

		tobool = var_1_10011

		var_1_10008(var_9_3, var_1_10011(var_9_1 and not var_9_1:isEnd()))
	end
