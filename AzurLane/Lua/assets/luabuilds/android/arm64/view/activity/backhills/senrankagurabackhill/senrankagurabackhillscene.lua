...
function var_0_1.init(arg_2_0)
	...
	import = var_2_9
	arg_2_0.graphPath = var_2_10(var_2_9("GameCfg.BackHillGraphs.SenrankaguraBackHillGraph"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.senrankagura_backhill_help.tip
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "renshuzhidaochang", function()
		...
		var_7_1(var_7_0, var_7_2, var_2_10004.SENRANKAGURA_TRAIN)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "michuanrenfashu", function()
		...
		var_8_1(var_8_0, var_8_2, var_2_10004.SENRANKAGURA_MEDAL)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "renzherenwuban", function()
		...
		var_9_4.id = var_2_10006.SENRANKAGURA_TURNTABLE
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "baochouleijisuo", function()
		...
		ActivityConst = var_2_10006
		var_10_4.id = var_2_10006.SENRANKAGURA_PT
...
function var_0_1.UpdateView(arg_11_0)
	...
	var_1_10001(var_3.Find(var_11_0, "Tip"), var_0_1.TrainTip())

	setActive = var_1_10001

	local var_11_1 = arg_11_0.upper_michuanrenfashu

	var_1_10001(var_3.Find(var_11_1, "Tip"), var_0_1.MedalTip())

	setActive = var_1_10001

	local var_11_2 = arg_11_0.upper_renzherenwuban

	var_1_10001(var_3.Find(var_11_2, "Tip"), var_0_1.TaskTip())

	setActive = var_1_10001

	local var_11_3 = arg_11_0.upper_baochouleijisuo

	var_1_10001(var_3.Find(var_11_3, "Tip"), var_0_1.PTTip())
...
function var_0_1.MedalTip()
	...
	local var_13_2 = var_13_1(var_13_0, var_1_10003.SENRANKAGURA_MEDAL_ID)

	Activity = var_1_10001

	local var_13_3

	if not var_1_10001.IsActivityReady(var_13_2) then
...
function var_0_1.TaskTip()
	...
	local var_14_2 = var_14_1(var_14_0, var_1_10003.SENRANKAGURA_TURNTABLE)

	Activity = var_1_10001

	return var_1_10001.IsActivityReady(var_14_2)
end
...
function var_0_1.PTTip()
	...
	local var_15_2 = var_15_1(var_15_0, var_1_10003.SENRANKAGURA_PT)

	Activity = var_1_10001

	return var_1_10001.IsActivityReady(var_15_2)
end
...
function var_0_1.TrainTip()
	...
	local var_16_2 = var_16_1(var_16_0, var_1_10003.SENRANKAGURA_TRAIN_ACT_ID)

	Activity = var_1_10001

	return var_1_10001.IsActivityReady(var_16_2)
end
