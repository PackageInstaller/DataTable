...
function var_0_1.init(arg_2_0)
	...
	import = var_2_9
	arg_2_0.graphPath = var_2_10(var_2_9("GameCfg.BackHillGraphs.USCastle2023Graph"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.uscastle2023_help.tip
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "yanhuiyaoyue", function()
		...
		if var_7_1(var_7_0, var_2_10003.ACTIVITY_TYPE_FEAST) and not var_0:isEnd() then
			...
			var_2_10001(var_7_2, var_2_10004, var_2_10005.FEAST)
		else
			pg = var_2_10001

			local var_7_3 = var_2_10001.TipsMgr.GetInstance()
			local var_7_4 = var_1.ShowTips

			i18n = var_2_10004

			var_7_4(var_7_3, var_2_10004("common_activity_notStartOrEnd"))
		end
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "xintiaochengbao", function()
		...
		var_8_1(var_8_0, var_2_10003.GO_MINI_GAME, 56)
...
function var_0_1.XinTiaoChengBaoTip()
	...
	return var_11_0(var_1_10002.MINIGAME_XINTIAOCHENGBAO)
end
...
function var_0_1.UpdateView(arg_12_0)
	...
	var_1_10001(var_3.Find(var_12_0, "Tip"), var_0_1.FeastTip())

	setActive = var_1_10001

	local var_12_1 = arg_12_0.upper_xintiaochengbao

	var_1_10001(var_3.Find(var_12_1, "Tip"), var_0_1.XinTiaoChengBaoTip())
...
function var_0_1.PlayerOneFirework(arg_17_0)
	...
	local var_17_5 = var_4.random(#var_0_1.SFX_LIST)

	if var_17_4 then
		setLocalPosition = var_17_3

		var_17_3(var_17_4, arg_17_0:GetFireworkPos())

		setActive = var_17_3

		var_17_3(var_17_4, true)

		pg = var_17_3

		local var_17_6 = var_17_3.CriMgr.GetInstance()
		...
		var_5.GetPrefab(var_17_8, "ui/" .. var_17_2, "", function(arg_19_0)
			...
			var_1(var_19_0, var_4.GetFireworkPos(var_19_1))
