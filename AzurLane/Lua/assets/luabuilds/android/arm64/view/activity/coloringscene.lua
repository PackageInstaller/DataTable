...
function var_0_1.getUIName(arg_1_0)
	...
	if var_1_1(var_1_0, var_1_10004.ACTIVITY_TYPE_COLORING_ALPHA) then
		AcessWithinNull = var_1_10002

		if var_1_10002(var_1:getConfig("config_client"), "ui") then
			return var_2
		end
	end
	...
	var_1_0(false, "Not Set PixelDraw Activity config_client ID: " .. var_1_2)
