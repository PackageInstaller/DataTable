...
function var_0_1.initTask(arg_9_0)
	...
	for iter_9_0 = 1, #var_9_2 do
		...
		if not var_8.task_data_template[var_9_4] then
			print = var_1_10009
			var_1_10011 = "task_data_template 不存在任务id : "
			tostring = var_1_10012

			var_1_10009(var_1_10011 .. var_1_10012(var_9_4))
		end

		var_1_10009 = var_8.type

		local var_9_5 = var_8.sub_type
		...
		if var_1_10009 ~= var_1_10011.TYPE_ACTIVITY then
			...
			if var_1_10009 == var_1_10011.TYPE_ACTIVITY_BRANCH then
				var_1_10011 = arg_9_0:getTaskGroup(var_1_10009, var_9_5)

				arg_9_0:insertTaskToGroup(var_9_4, var_8, var_1_10011)
			end
		end
	end
...
function var_0_1.updateTaskList(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	if arg_11_4.subType ~= 33 then
		...
		local var_11_11 = var_18(var_11_1, "#95b345")
		local var_11_12 = "/"

		setColorStr = var_20

		var_15(var_11_10, var_11_11 .. var_11_12 .. var_20(var_11_0, "#e9c9bd"))
	else
		setText = var_15
		findTF = var_11_10
	...
	local var_11_14 = var_18(var_11_8, "award")
	...
	elseif var_11_0 <= var_11_1 then
		...
		var_15(var_11_16, var_11_17, var_11_18, var_20)
		...
		if not arg_11_0.nextTickFlag then
			...
			var_15(function()
				...
				var_2_10000(var_2_10002(var_11_8, "get"))
		...
		var_15(var_11_16, var_11_17, var_11_19, var_20)
	end
	...
	if var_11_3 then
		...
		var_15(var_11_20, var_11_21, var_11_22, var_20)
	end
