...
function var_0_1.OnLoaded(arg_3_0)
	...
	local var_3_3 = var_4.Find(var_3_2, "Text")

	i18n = var_5

	var_2(var_3_3, var_5("cruise_btn_all"))

	arg_3_0.btnPay = var_1:Find("btns/btn_pay")
	setText = var_2

	local var_3_4 = arg_3_0.btnPay
	local var_3_5 = var_4.Find(var_3_4, "Text")

	i18n = var_5

	var_2(var_3_5, var_5("cruise_btn_pay"))
	...
	function arg_3_0.scrollCom.onUpdateItem(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_4_2, var_2_10006(arg_4_1), arg_3_0.awardList[arg_4_0 + 1])
...
function var_0_1.Flush(arg_9_0, arg_9_1)
	...
	elseif arg_9_0.phase == #arg_9_0.awardList then
		...
		var_9_4(var_9_3, var_5.clamp(arg_9_0.phasePos[arg_9_0.phase], 0, 1), true)
	end
	...
	if not arg_9_0.isPay then
		...
		local var_9_9 = var_9_5.TimeMgr.GetInstance()
		local var_9_10 = var_4.inTime

		pg = var_1_10007

		if not var_9_10(var_9_9, var_1_10007.pay_data_display[var_9_8].time) then
			setActive = var_5

			var_5(arg_9_0.btnPay, false)
		end
	end
...
function var_0_1.UpdateAwardInfo(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	local var_14_4 = arg_14_2.Find(var_14_3, "base")
	...
	local function var_14_5()
		...
		var_15_1(var_15_0, var_2_10003.ON_NEW_STYLE_DROP, {
			drop = var_14_1
		})
	...
	SFX_CONFIRM = var_14_3

	var_6(var_14_2, var_14_4, var_14_5, var_14_3)
	...
	local var_14_6 = arg_14_2:Find("base/got")
	local var_14_7

	if arg_14_0.awardDic[arg_14_3.pt] then
		var_14_7 = not arg_14_0:IsSpecialMask(var_14_1.type)
	end

	var_6(var_14_6, var_14_7)

	setActive = var_6

	local var_14_8 = arg_14_2:Find("base/got_frame")
	local var_14_9

	if arg_14_0.awardDic[arg_14_3.pt] then
		var_14_9 = arg_14_0:IsSpecialMask(var_14_1.type)
	end

	var_6(var_14_8, var_14_9)

	Drop = var_6

	local var_14_10 = var_6.Create(arg_14_3.award_pay)

	onButton = var_7

	local var_14_11 = arg_14_0
	local var_14_12 = arg_14_2
	local var_14_13 = arg_14_2.Find(var_14_12, "pay")
	...
	local function var_14_14()
		...
		var_16_1(var_16_0, var_2_10003.ON_NEW_STYLE_DROP, {
			drop = var_14_10
		})
	...
	var_7(var_14_11, var_14_13, var_14_14, var_14_12)

	updateDrop = var_7

	var_7(arg_14_2:Find("pay/mask/IconTpl"), var_14_10)

	setActive = var_7

	var_7(arg_14_2:Find("pay/frame_skin"), arg_14_0:IsSkinFrame(var_14_10.type))

	setActive = var_7

	var_7(arg_14_2:Find("pay/frame_ui"), arg_14_0:IsBattleUIFrame(var_14_10.type))

	setActive = var_7

	var_7(arg_14_2:Find("pay/no_pay"), not arg_14_0.isPay and not arg_14_0:IsSpecialMask(var_14_10.type))

	setActive = var_7

	var_7(arg_14_2:Find("pay/no_pay_frame"), not arg_14_0.isPay and arg_14_0:IsSpecialMask(var_14_10.type))
	...
	local var_14_15 = arg_14_2:Find("pay/get")
	local var_14_16

	if arg_14_0.isPay then
		var_14_16 = var_14_0 and not arg_14_0.awardPayDic[arg_14_3.pt]
	end
	...
	local var_14_17 = arg_14_2:Find("pay/got")
	local var_14_18

	if arg_14_0.awardPayDic[arg_14_3.pt] then
		var_14_18 = not arg_14_0:IsSpecialMask(var_14_10.type)
	end
	...
	local var_14_19 = arg_14_2:Find("pay/got_frame")
	local var_14_20

	if arg_14_0.awardPayDic[arg_14_3.pt] then
		var_14_20 = arg_14_0:IsSpecialMask(var_14_10.type)
	end

	var_7(var_14_19, var_14_20)
	...
	if #var_1.GetCrusingUnreceiveAward(var_18_0) > 0 then
		...
		if arg_18_0:CheckLimitMax(var_1) then
			...
			var_3.insert(var_18_1, function(arg_19_0)
				...
				local var_19_2 = var_2_10004.NewStyleMsgboxMgr.TYPE_COMMON_MSGBOX
				local var_19_3 = {}

				i18n = var_2_10006
				var_19_3.contentText = var_2_10006("player_expResource_mail_fullBag")
		...
		var_3(var_18_1, function()
			...
			var_20_1(var_20_0, var_2_10003.EVENT_GET_AWARD_ALL)
	...
	for iter_21_0, iter_21_1 in var_1_10003(arg_21_1) do
		...
		if var_21_2 == var_1_10009 then
			if iter_21_1.id == 1 then
				if var_21_1:GoldMax(iter_21_1.count) then
					pg = var_8

					local var_21_3 = var_8.TipsMgr.GetInstance()
					local var_21_4 = var_8.ShowTips

					i18n = var_1_10011

					var_21_4(var_21_3, var_1_10011("gold_max_tip_title"))

					return true
				end
			elseif iter_21_1.id == 2 and var_21_1:OilMax(iter_21_1.count) then
				pg = var_8

				local var_21_5 = var_8.TipsMgr.GetInstance()
				local var_21_6 = var_8.ShowTips

				i18n = var_1_10011

				var_21_6(var_21_5, var_1_10011("oil_max_tip_title"))

				return true
			end
		else
			local var_21_7 = iter_21_1.type

			DROP_TYPE_ITEM = var_1_10009

			if var_21_7 == var_1_10009 then
				Item = var_21_7
				var_1_10009 = var_21_7.getConfigData(iter_21_1.id).type
				Item = var_10
				...
				if var_1_10009 == var_10.EXP_BOOK_TYPE then
					...
					if var_1_10009.getItemCountById(var_1_10011, iter_21_1.id) + iter_21_1.count > var_8.max_num then
						return true
					end
				end
			end
