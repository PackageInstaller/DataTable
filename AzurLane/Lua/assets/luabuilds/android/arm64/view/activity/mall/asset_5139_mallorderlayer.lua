...
function var_0_1.init(arg_2_0)
	...
	local var_2_14 = var_4.Find(var_2_13, "staff")
	...
	var_1_10001(var_2_12, var_2_14, var_2_15, var_2_13)

	onButton = var_1_10001

	local var_2_16 = arg_2_0
	local var_2_17 = arg_2_0.uiOrderBtnsTF
	local var_2_18 = var_4.Find(var_2_17, "start")

	local function var_2_19()
		local var_8_0 = arg_2_0
		local var_8_1 = var_0.emit

		MallOrderMediator = var_2_10003

		var_8_1(var_8_0, var_2_10003.START_ORDER, arg_2_0.activity.id, arg_2_0.showId, arg_2_0.selectedIds)
	...
	var_1_10001(var_2_16, var_2_18, var_2_19, var_2_17)

	onButton = var_1_10001

	local var_2_20 = arg_2_0
	local var_2_21 = arg_2_0.uiOrderBtnsTF
	local var_2_22 = var_4.Find(var_2_21, "complete")
	...
	local function var_2_23()
		...
		var_9_1(var_9_0, var_2_10003.COMPLETE_ORDER, arg_2_0.activity.id, arg_2_0.showId)
	...
	var_1_10001(var_2_20, var_2_22, var_2_23, var_2_21)
	...
	var_1_10001(var_2_24, var_2_25, var_2_26, var_2_21)
	...
	arg_2_0.orderSlotUIList = var_2_27(var_2_28, var_4.Find(var_2_29, "tpl"))
	...
	arg_2_0.staffSlotUIList = var_2_31(var_2_32, var_4.Find(var_2_33, "tpl"))
	...
	local var_2_40 = var_3.Find(var_2_39, "staff/Text")

	i18n = var_4

	var_1(var_2_40, var_4("mall_order_btn_staff"))

	setText = var_1

	local var_2_41 = arg_2_0.uiOrderBtnsTF
	local var_2_42 = var_3.Find(var_2_41, "start/Text")

	i18n = var_4

	var_1(var_2_42, var_4("mall_order_btn_start"))

	setText = var_1

	local var_2_43 = arg_2_0.uiOrderBtnsTF
	local var_2_44 = var_3.Find(var_2_43, "doing/Text")

	i18n = var_4

	var_1(var_2_44, var_4("mall_order_btn_doing"))

	setText = var_1

	local var_2_45 = arg_2_0.uiOrderBtnsTF
	local var_2_46 = var_3.Find(var_2_45, "complete/Text")

	i18n = var_4

	var_1(var_2_46, var_4("mall_order_btn_complete"))
...
function var_0_1.UpdateData(arg_16_0)
	...
	arg_16_0.activity = var_16_1(var_16_0, var_1_10004.ACTIVITY_TYPE_MALL)
	...
	if not arg_16_0.selectedIds then
		...
		var_16_5 = var_16_5(var_3.GetStaffList(var_16_4))
	end
...
function var_0_1.UpdateView(arg_18_0)
	...
	var_1_10001(var_18_0, var_4.GetGold(var_18_1))
	...
	if arg_18_0.paintName ~= "" then
		...
		var_18_2(var_18_3, var_4.activity_mall_custom_order[arg_18_0.showId].desc)
		...
		var_18_2(var_18_4, var_4("mall_order_char_header") .. arg_18_0.showName)
	end
	...
	var_2(var_4.Find(var_18_6, "content"), var_18_5)

	setActive = var_2

	local var_18_7 = arg_18_0.uiOrderPanel

	var_2(var_4.Find(var_18_7, "empty"), not var_18_5)
...
function var_0_1.GetStatus(arg_19_0)
	...
	if arg_19_0.orderData.id ~= 0 then
		...
		if not (var_1_10002.GetEndTime(var_19_2) <= var_19_1) or not var_0_1.STATUS.COMPLETE then
	...
	local var_19_4 = var_1_10002.activity_mall_custom_order[arg_19_0.showId]
...
function var_0_1.CheckShowDialogue(arg_27_0)
	...
	if arg_27_0.status ~= var_0_1.STATUS.WAIT and arg_27_0.status ~= var_0_1.STATUS.EMPTY then
		...
		var_1(var_3.Find(var_27_0, "Text"), arg_27_0.showWord)
...
function var_0_1.ShowCompleteDialogue(arg_28_0, arg_28_1)
	...
	var_1_10002(var_4.Find(var_28_0, "paint"), arg_28_0.paintName, "duihua")
	...
	var_3(var_5.Find(var_28_2, "content/Text"), var_28_1)
...
function var_0_1.UpdateStaffAndTarget(arg_30_0)
	...
	for iter_30_2, iter_30_3 in var_1(arg_30_0.selectedIds) do
		...
		for iter_30_4, iter_30_5 in var_1_10007(var_30_2:GetAttrList()) do
...
function var_0_1.UpdateStaffAttrsCond(arg_31_0, arg_31_1)
	...
	local var_31_1 = var_31_0:Find("Text")

	i18n = var_1_10006

	var_1_10003(var_31_1, var_1_10006("mall_order_need_attrs_header"))
	...
	for iter_31_0, iter_31_1 in var_4(arg_31_0.targetAttrs) do
		...
		var_1_10010(var_31_0:Find("list/" .. iter_31_0), iter_31_1 > 0)
		...
		if 0 < iter_31_1 then
			...
			var_11(var_31_0:Find("list/" .. iter_31_0 .. "/Text"), var_1_10010)
		end
	end

	setActive = var_4

	var_4(arg_31_1:Find("unfinished"), not var_31_2)

	setActive = var_4

	var_4(arg_31_1:Find("finished"), var_31_2)
...
function var_0_1.UpdataOrderInfo(arg_32_0)
	...
	local var_32_0 = var_1_10001.map(arg_32_0.showConfig.order_cost_show, function(arg_33_0)
		...
		i18n = var_3
		var_33_1.text = var_3("word_consume") .. var_33_0.count .. var_33_0:getName()
	...
	arg_32_0.UpdateStaffAttrsCond(var_32_1, arg_32_0.uiOrderAttrsCondTF)

	local var_32_2 = #arg_32_0.selectedIds
	local var_32_3 = arg_32_0.targetNum <= var_32_2

	setColorStr = var_3

	local var_32_4 = var_3(#arg_32_0.selectedIds, var_32_3 and "#4c9922" or "#df6126")

	i18n = var_32_1

	local var_32_5 = var_32_1("mall_order_need_staff_header") .. var_32_4 .. "/" .. arg_32_0.targetNum
	...
	local var_32_6 = var_5.StaticAlign
	local var_32_7 = arg_32_0.uiOrderCostTF
	local var_32_8 = arg_32_0.uiOrderCostTF

	var_32_6(var_32_7, var_8.Find(var_32_8, "tpl"), #var_32_0, function(arg_34_0, arg_34_1, arg_34_2)
		UIItemList = var_2_10003
	...
	local var_32_9 = var_32_6.map(arg_32_0.showConfig.order_reward_show, function(arg_35_0)
		Drop = var_2_10001
	...
	local var_32_10 = var_6.StaticAlign
	local var_32_11 = arg_32_0.uiOrderAwardTF
	local var_32_12 = arg_32_0.uiOrderAwardTF

	var_32_10(var_32_11, var_9.Find(var_32_12, "tpl"), #var_32_9, function(arg_36_0, arg_36_1, arg_36_2)
		UIItemList = var_2_10003

		if arg_36_0 == var_2_10003.EventUpdate then
			setText = var_3

			var_3(arg_36_2:Find("Text"), var_32_9[arg_36_1 + 1])
		end
...
function var_0_1.UpdateBtns(arg_37_0)
	...
	var_1(var_3.Find(var_37_0, "doing"), arg_37_0.status == var_0_1.STATUS.DOING)

	setActive = var_1

	local var_37_1 = arg_37_0.uiOrderBtnsTF

	var_1(var_3.Find(var_37_1, "complete"), arg_37_0.status == var_0_1.STATUS.COMPLETE)

	setActive = var_1

	local var_37_2 = arg_37_0.uiOrderBtnsTF

	var_1(var_3.Find(var_37_2, "time"), arg_37_0.status == var_0_1.STATUS.DOING or arg_37_0.status == var_0_1.STATUS.PREPARE)

	if arg_37_0.status == var_0_1.STATUS.PREPARE then
		setText = var_1

		local var_37_3 = arg_37_0.uiOrderBtnsTF
		local var_37_4 = var_3.Find(var_37_3, "time/Text")

		pg = var_4

		local var_37_5 = var_4.TimeMgr.GetInstance()

		var_1(var_37_4, var_4.DescCDTime(var_37_5, arg_37_0.showConfig.cost_time))
	end
...
function var_0_1.CheckStartBtn(arg_38_0)
	if arg_38_0.status == var_0_1.STATUS.PREPARE then
		...
		var_1(var_3.Find(var_38_0, "start"), arg_38_0:CanStart())
	else
		setActive = var_1

		local var_38_1 = arg_38_0.uiOrderBtnsTF

		var_1(var_3.Find(var_38_1, "start"), false)
	end
...
function var_0_1.CanStart(arg_39_0)
	...
	for iter_39_2, iter_39_3 in var_1(var_3.GetCost(arg_39_0.showId)) do
...
function var_0_1.UpdateEmptyPanel(arg_40_0)
	...
	var_40_0(var_40_2, arg_40_0.status == var_0_1.STATUS.EMPTY)
	...
	if arg_40_0.status == var_0_1.STATUS.EMPTY then
		...
		var_5(var_40_5, var_1_10008("mall_order_finished_all_tip"))
		...
		if arg_40_0.level < var_40_6.unlock_lv then
			...
			var_6(var_40_7, var_1_10009("mall_order_unlock_lv_tip", var_40_6.unlock_lv))
		...
		if 0 < var_40_10 then
			...
			local var_40_11 = var_40_3:Find("Text")

			i18n = var_1_10010

			var_7(var_40_11, var_1_10010("mall_order_wait_tip"))
...
function var_0_1.OnInitStaffItem(arg_41_0, arg_41_1)
	...
	local function var_41_3()
		...
		if #arg_41_0.selectedIds == arg_41_0.targetNum then
			...
			var_42_1(var_42_0, var_2_10003("mall_staff_position_full_tip"))
		...
		if var_42_3 == var_42_2.STATUS.ORDER then
			return
		end
		...
		var_2({
			function(arg_43_0)
				...
				if var_43_0 == var_3_10002.STATUS.FLOOR then
					...
					i18n = var_3_10005
					var_43_3.content = var_3_10005("mall_remove_floor_sure")
	...
	var_1_10003(var_41_1, var_41_2, var_41_3, var_1_10008)
...
function var_0_1.UpdateOrderSlotTpl(arg_47_0, arg_47_1, arg_47_2)
	...
	local var_47_2, var_47_4

	if var_47_0 then
		local var_47_1 = arg_47_0.activity

		var_47_2 = var_47_2.GetStaff(var_47_1, var_47_0)
		MallStaffCard = var_1_10005

		local var_47_3 = var_1_10005.StaticUpdateIcon

		var_47_4 = arg_47_2

		var_47_3(arg_47_2.Find(var_47_4, "icon"), var_47_2.tid)
	end

	onButton = var_47_2

	local var_47_5 = arg_47_0
	local var_47_6 = arg_47_2
	...
	var_47_2(var_47_5, var_47_6, var_47_7, var_47_4)
...
function var_0_1.SetTotalCount(arg_49_0)
	...
	var_49_0(var_49_1, var_1_10004({
		function(arg_50_0)
			...
			local var_50_1, var_50_2 = arg_50_0.GetStatusInfos(var_50_0)

			MallStaff = var_50_0

			return var_50_1 == var_50_0.STATUS.FLOOR and 1 or 0
		end,
		function(arg_51_0)
			return -arg_51_0.id
		end
...
function var_0_1.UpdateStaffSlotTpl(arg_52_0, arg_52_1, arg_52_2)
	...
	if var_52_0 then
		...
		var_1_10005.StaticUpdateIcon(arg_52_2:Find("icon"), var_52_2.tid)
	end

	onButton = var_52_2

	local var_52_3 = arg_52_0
	local var_52_4 = arg_52_2
	local var_52_5 = arg_52_2.Find(var_52_4, "icon")
	...
	var_52_2(var_52_3, var_52_5, var_52_6, var_52_4)
...
function var_0_1.StartTimer(arg_55_0)
	...
	arg_55_0.timer = var_1.New(function()
		...
		local var_56_4 = var_3.Find(var_56_3, "time/Text")

		pg = var_2_10004

		local var_56_5 = var_2_10004.TimeMgr.GetInstance()

		var_1(var_56_4, var_4.DescCDTime(var_56_5, var_56_2))
...
function var_0_1.StartNextTimer(arg_58_0, arg_58_1)
	...
	arg_58_0.nextTimer = var_2.New(function()
		...
		local var_59_4 = var_3.Find(var_59_3, "empty/list/time/value")

		pg = var_2_10004

		local var_59_5 = var_2_10004.TimeMgr.GetInstance()

		var_1(var_59_4, var_4.DescCDTime(var_59_5, var_59_2))
