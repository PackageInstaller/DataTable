...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_18 = var_4.Find(var_2_17, "award/got/title")

	i18n = var_5

	var_2(var_2_18, var_5("liner_event_award_tip3"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_1(var_4_0, var_2_10003.ON_START_REASONING, arg_3_0.activity.id, arg_3_0.curIdx)
	...
	var_1.make(var_3_11, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventInit then
			...
			var_2_10005(arg_6_2:Find("Text"), var_6_0)

			setText = var_2_10005

			local var_6_1 = arg_6_2

			var_2_10005(arg_6_2.Find(var_6_1, "selected/Text"), var_6_0)

			local var_6_3, var_6_5

			if 1 < var_3 then
				local var_6_2 = arg_3_0

				var_6_3 = var_6_3.IsFinishWithGroupIdx(var_6_2, var_3 - 1)
				...
				var_6(var_6_4, var_6_1(var_2_10011), var_6_3)

				setActive = var_6
				var_6_5 = arg_6_2

				var_6(arg_6_2.Find(var_6_5, "lock"), not var_6_3)

				if not var_6_3 then
					setActive = var_6
					var_6_5 = arg_6_2

					var_6(arg_6_2.Find(var_6_5, "selected"), false)
				end
			end

			onToggle = var_6_3

			local var_6_6 = arg_3_0
			local var_6_7 = arg_6_2

			local function var_6_8(arg_7_0)
				if arg_7_0 then
			...
			var_6_3(var_6_6, var_6_7, var_6_8, var_6_5)
		else
			UIItemList = var_3
...
function var_0_1.UpdateActivity(arg_8_0, arg_8_1)
	...
	arg_8_0.finishEventIds = var_2.GetFinishEventIds(var_8_4)
...
function var_0_1.FlushPage(arg_9_0)
	...
	var_1(var_9_2, var_4("ui/linermainui_atlas", "event_title" .. arg_9_0.groups[arg_9_0.curIdx].id), true)
	...
	for iter_9_0, iter_9_1 in var_3(var_9_5) do
		local var_9_6 = arg_9_0.itemTFs[iter_9_0]

		setActive = var_9_7

		var_9_7(var_9_6, true)

		local var_9_7 = var_9_6:Find("name/Text")
		local var_9_8 = var_9_6:Find("desc")
		local var_9_9 = arg_9_0.groups[arg_9_0.curIdx]
		local var_9_10 = var_11.GetEvent(var_9_9, iter_9_1)

		table = var_12

		local var_9_11 = var_12.contains(arg_9_0.finishEventIds, iter_9_1)

		setText = var_9_9

		local var_9_12 = var_9_7

		if not var_9_11 or not var_9_10:GetTitle() then
			i18n = var_1_10016
			var_1_10016 = var_1_10016("liner_event_title" .. iter_9_0)
		end

		var_9_9(var_9_12, var_1_10016)
		...
		if not var_9_11 or not ("clue" .. iter_9_1) then
			var_9_13 = "empty" .. iter_9_0
		end

		setImageSprite = var_14
		var_1_10016 = var_9_6:Find("icon")
		GetSpriteFromAtlas = var_1_10017

		var_14(var_1_10016, var_1_10017("ui/linermainui_atlas", var_9_13), true)

		setText = var_14
		var_1_10016 = var_9_8

		if not var_9_11 or not var_9_10:GetLogDesc() then
			var_1_10017 = ""
		end

		var_14(var_1_10016, var_1_10017)

		setActive = var_14

		var_14(var_9_6:Find("empty"), not var_9_11)
	end
	...
	var_4(arg_9_0.awardTF, var_9_15)
	...
	local function var_9_18()
		...
		var_10_1(var_10_0, var_2_10003.ON_DROP, var_9_15)
	...
	var_4(var_9_16, var_9_17, var_9_18, var_9_7)
	...
	var_9_19(arg_9_0.goBtn, not var_4 and not var_9_20)

	setActive = var_9_19

	var_9_19(arg_9_0.getBtn, var_9_20)

	setActive = var_9_19

	var_9_19(arg_9_0.gotTF, var_4)

	setActive = var_9_19

	local var_9_21 = arg_9_0.awardTF

	var_9_19(var_8.Find(var_9_21, "mask"), var_4)
	...
	if var_9_20 then
		...
		var_9_19(var_9_22, var_9_23)

		setActive = var_9_19

		var_9_19(arg_9_0.awardDesc, not var_4)
		...
		if var_4 then
			...
			var_7(var_9_26, var_10.GetConclusions(var_9_27)[var_9_25])
		end
...
function var_0_1.IsFinishWithGroupIdx(arg_12_0, arg_12_1)
	...
	return var_12_0(var_4.GetIds(var_12_1), function(arg_13_0)
		table = var_2_10001
...
function var_0_1.IsTipWithGroupId(arg_14_0, arg_14_1)
	...
	local var_14_2 = var_4.all

	pg = var_6

	return var_14_2(var_6.activity_liner_event_group[arg_14_1].ids, function(arg_15_0)
		table = var_2_10001

		return var_2_10001.contains(var_14_1, arg_15_0)
	end)
end
...
function var_0_1.IsTip()
	...
	if var_16_2 then
		...
		var_1_10005 = var_16_2
		var_16_3 = not var_16_2.isEnd(var_1_10005)
	end
	...
	var_1_10001(var_16_3, var_16_4 .. var_1_10005.ACTIVITY_TYPE_LINER)

	local var_16_5 = var_16_2:GetEventGroupIds()

	underscore = var_16_0

	return var_16_0.any(var_16_5, function(arg_17_0)
...
function var_0_1.IsUnlcok()
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10003.ACTIVITY_TYPE_LINER)
	...
	if var_18_2 then
		...
		var_1_10005 = var_18_2
		var_18_3 = not var_18_2.isEnd(var_1_10005)
	end
	...
	var_1_10001(var_18_3, var_18_4 .. var_1_10005.ACTIVITY_TYPE_LINER)
