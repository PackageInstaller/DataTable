...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10004("mall_summary_btn"))

	setText = var_1_10001

	local var_2_1 = arg_2_0._tf
	local var_2_2 = var_3.Find(var_2_1, "window/tip")

	i18n = var_4

	var_1_10001(var_2_2, var_4("word_click_to_close"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_5()
		...
		var_5_1(var_5_0, var_2_10003.OPEN_SUMMARY_BOX)
...
function var_0_1.Show(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_3 = var_6.value
	local var_6_4

	go = var_8

	local var_6_5 = var_6_2(var_6_1, var_6_3, var_6_4, var_8(arg_6_0.uiSliderTF), 0, 1, var_0_1.SILDER_TIME)
...
function var_0_1.ShowAnim(arg_8_0)
	...
	var_1_10001(var_8_0, var_1_10004("mall_open_title"))
...
function var_0_1.ShowRandomShowStaff(arg_9_0)
	...
	local var_9_1 = var_1_10002.random(1, var_0_1.STAFF_CLOTHES_CNT)
	...
	var_4(var_9_3, var_9_4, var_8.Find(var_9_5, "body"))
	...
	var_4(var_9_6, var_9_7, var_8.Find(var_9_8, "clothes"))
	...
	var_4(var_9_9, var_9_10, var_8.Find(var_9_11, "face"))
...
function var_0_1.ChangeToEvaluate(arg_13_0)
	...
	var_1(var_13_0, var_1_10004("mall_evaluate_title"))
	...
	MallLevel = var_1_10002

	local var_13_2 = var_1_10002.GetShowInfos(arg_13_0.level)
	...
	for iter_13_0, iter_13_1 in var_6(var_13_2.wordList) do
		...
		var_1_10011.insert(var_13_1, function(arg_14_0)
			...
			var_2_10002(var_14_0:Find("name/Text"), var_13_3)

			setText = var_2_10002

			var_2_10002(var_14_0:Find("word/Text"), iter_13_1)

			GetImageSpriteFromAtlasAsync = var_2_10002

			var_2_10002(var_13_4, "", var_14_0:Find("icon"), true)

			scrollToBottom = var_2_10002

			var_2_10002(arg_13_0.uiDialogueTF)
			...
			var_14_2(var_14_1, var_5.delayedCall, function()
				arg_14_0()
