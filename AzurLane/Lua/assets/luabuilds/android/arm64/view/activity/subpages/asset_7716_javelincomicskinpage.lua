...
function var_0_1.InitView(arg_2_0)
	...
	arg_2_0.chargeIDList = var_1(var_3.getActivityById(var_2_2, arg_2_0.linkActId).data1_list)
	Clone = var_1
	pg = var_3
	arg_2_0.puzzleIDList = var_1(var_3.activity_template[arg_2_0.linkActId].config_data)
...
function var_0_1.RegisterEvent(arg_3_0)
	...
	local function var_3_3()
		...
		if var_2_10000.gametip.comic_help then
			...
			pg = var_2_10004
			var_4_2.helps = var_2_10004.gametip.comic_help.tip
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	for iter_6_0 = 1, #arg_6_0.puzzleIDList do
		...
		local var_6_5 = var_6_2.contains(arg_6_0.linkActivity.data1_list, var_6_4)
...
function var_0_1.DoPieceAnimation(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	var_9_4(var_9_3, var_8.Action(arg_9_4))
...
function var_0_1.FetchFinalAward(arg_13_0)
	...
	var_13_1(var_13_0, var_1_10004.EVENT_OPERATION, {
		cmd = 1,
