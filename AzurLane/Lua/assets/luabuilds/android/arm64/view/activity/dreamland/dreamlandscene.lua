...
function var_0_1._PlayBGM(arg_4_0)
	...
	local var_4_1, var_4_2 = arg_4_0.getThemeName(var_4_0, arg_4_0.period)

	pg = var_4_0

	local var_4_3 = var_4_0.BgmMgr.GetInstance()

	var_3.Push(var_4_3, arg_4_0.__cname, var_4_2)

	arg_4_0._bgm = var_4_2
...
function var_0_1.init(arg_5_0)
	...
	arg_5_0.cg = var_1_10001(var_5_0, var_1_10004(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_5_0.storyTxt = var_5_6(var_5_5, var_4(var_1_10006))
	...
	arg_5_0.scrollrect = var_5_10(var_5_9, var_4(var_1_10006))
...
function var_0_1.InitData(arg_6_0)
	...
	local var_6_3 = var_6_2(var_6_1, var_1_10004.ACTIVITY_TYPE_DREAMLAND)

	getProxy = var_1_10002
	ActivityProxy = var_4

	local var_6_4 = var_1_10002(var_4)
	local var_6_5 = var_2.getActivityByType

	ActivityConst = var_1_10005

	local var_6_6 = var_6_5(var_6_4, var_1_10005.ACTIVITY_TYPE_HOTSPRING_2)

	assert = var_6_1

	var_6_1(var_6_3 and var_6_6)

	DreamlandData = var_6_1
	arg_6_0.gameData = var_6_1.New(var_6_3, var_6_6)
...
function var_0_1.UpdateTip(arg_10_0)
	...
	var_1_10001(var_10_0, var_4.ExistAnyMapOrExploreAward(var_10_1))
...
function var_0_1.RegisterEvent(arg_20_0)
	...
	local var_20_2 = var_4.Find(var_20_1, "adapt/back")
	...
	local function var_20_3()
		...
		var_21_1(var_21_0, var_2_10003.ON_BACK)
	...
	var_1(var_20_0, var_20_2, var_20_3, var_20_1)

	onButton = var_1

	local var_20_4 = arg_20_0
	local var_20_5 = arg_20_0._tf
	local var_20_6 = var_4.Find(var_20_5, "adapt/home")
	...
	local function var_20_7()
		...
		var_22_1(var_22_0, var_2_10003.ON_HOME)
	...
	var_1(var_20_4, var_20_6, var_20_7, var_20_5)

	onButton = var_1

	local var_20_8 = arg_20_0
	local var_20_9 = arg_20_0._tf
	local var_20_10 = var_4.Find(var_20_9, "adapt/help")
	...
	local function var_20_11()
		...
		pg = var_2_10004
		var_23_2.helps = var_2_10004.gametip.dream_land_tip.tip
	...
	var_1(var_20_8, var_20_10, var_20_11, var_20_9)

	onButton = var_1

	local var_20_12 = arg_20_0
	local var_20_13 = arg_20_0._tf
	local var_20_14 = var_4.Find(var_20_13, "adapt/handbook")
	...
	var_1(var_20_12, var_20_14, var_20_15, var_20_13)

	onButton = var_1

	local var_20_16 = arg_20_0
	local var_20_17 = arg_20_0._tf
	local var_20_18 = var_4.Find(var_20_17, "adapt/hotspring")
	...
	var_1(var_20_16, var_20_18, var_20_19, var_20_17)
	...
	var_1(var_20_20, var_20_21, var_20_22, var_20_17)
...
function var_0_1.UpdateTimeBtn(arg_27_0)
	...
	var_1_10002(arg_27_0.timeBtn, var_27_1)
...
function var_0_1.InitThemeMask(arg_31_0)
	...
	DreamlandUtil = var_1_10002

	local var_31_2 = var_1_10002.List2Map(var_31_1, "id")
	...
	var_3(arg_31_0.themeMask, function(arg_32_0)
		...
		var_2_10001(var_32_0, var_32_1[var_2_10005(arg_32_0.name)] == nil)
...
function var_0_1.InitExploreObjs(arg_33_0)
	...
	local var_33_2 = var_1_10002.List2Map(var_33_1, "pic")

	eachChild = var_33_0

	var_33_0(arg_33_0.theme, function(arg_34_0)
...
function var_0_1.EnableOrDisableInteraction(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
	...
	local function var_35_4()
		...
		if var_0.ShouldShowChatTip(var_36_1, arg_35_2.id) then
			...
			var_2_10001(var_36_4)

			local var_36_5 = arg_35_0
			local var_36_6 = var_1.emit

			DreamlandMediator = var_4

			local var_36_7 = var_4.RECORD_EXPLORE
			local var_36_8 = arg_35_0.gameData

			var_36_6(var_36_5, var_36_7, var_5.GetActivityId(var_36_8), var_36_4, arg_35_2.id)
		end
	...
	var_6(var_35_2, var_35_3, var_35_4, var_1_10011)

	if var_35_1 then
		setActive = var_6

		local var_35_5 = var_35_1
		local var_35_6 = arg_35_0.gameData

		var_6(var_35_5, var_9.ShouldShowChatTip(var_35_6, arg_35_2.id))
	end
...
function var_0_1.GenPlayableStoryPoint(arg_37_0, arg_37_1)
	...
	var_1_10003(arg_37_0.storyTplSub, false)

	setActive = var_1_10003

	var_1_10003(arg_37_0.storyTpl, true)

	local var_37_1 = arg_37_0.storyTpl

	Vector3 = var_37_0
	var_37_1.localPosition = var_37_0(var_2.pos.x, var_2.pos.y, 0)
	...
	var_37_2(var_37_3, var_37_4, var_37_5, var_8)
...
function var_0_1.FocusStory(arg_39_0, arg_39_1)
	...
	local var_39_5 = var_39_4(var_39_3, var_6.easeOutExpo)
	local var_39_6 = var_3.setOnComplete

	System = var_6

	var_39_6(var_39_5, var_6.Action(function()
...
function var_0_1.SetUpSpine(arg_53_0, arg_53_1)
	...
	local var_53_2 = var_53_1(var_53_0, var_1_10005(var_1_10007.Unity.SkeletonGraphic))
	local var_53_3 = var_2.ToTable(var_53_2)
	local var_53_4 = {}

	ipairs = var_53_2

	for iter_53_0, iter_53_1 in var_53_2(var_53_3) do
		...
		typeof = var_1_10013
		SpineAnimUI = var_1_10015
		var_1_10010 = var_1_10010(var_53_6, var_1_10013(var_1_10015))
		string = var_1_10011
		var_1_10011 = var_1_10011.split(var_53_5.gameObject.transform.parent.name, "#")

		local var_53_7 = arg_53_0.gameData
		local var_53_8 = var_12.GetExploreSubType(var_53_7, var_1_10011[1])

		DreamlandUtil = var_1_10013
		var_1_10013 = var_1_10013.GetSpineNormalAction(var_53_8)
...
function var_0_1.SwitchAnim(arg_60_0, arg_60_1, arg_60_2, arg_60_3)
	...
	local var_60_2 = var_60_1(var_60_0, var_7.Action_float(function(arg_61_0)
		...
		var_2_10001(var_61_0, var_2_10004(var_2_10006)).alpha = arg_61_0
	...
	var_60_3(var_60_2, var_7.Action(arg_60_3))
...
function var_0_1.RecordTheme(arg_62_0, arg_62_1)
	...
	var_1_10003.SetInt("dreamland_theme_id" .. var_62_1, arg_62_1)
...
function var_0_1.GetDefaultTheme(arg_63_0)
	...
	return (var_1_10002.GetInt("dreamland_theme_id" .. var_63_1, 1))
end
...
function var_0_1.GetNodeInfoFromTheme(arg_67_0, arg_67_1)
	...
	var_1_10003(var_1_10005(arg_67_1), function(arg_68_0)
		if arg_68_0.name ~= "bgs" then
			local var_68_0 = arg_68_0
			local var_68_1 = arg_68_0.GetSiblingIndex(var_68_0)
			local var_68_2 = arg_68_0.localPosition

			table = var_68_0

			var_68_0.insert(var_67_0, {
				tf = arg_68_0,
				position = var_68_2
			})
		end
		...
		for iter_73_2, iter_73_3 in var_1_10010(iter_73_1) do
			...
			var_15.insert(var_73_2, function(arg_74_0)
				...
				if var_1.MapId2MapGraph(var_74_0, iter_73_0) then
					...
					var_2_10002.InitHotSpringCharacter(var_74_1, iter_73_3, var_1, arg_74_0)
				else
					print = var_2_10002

					var_2_10002("不存在路径", iter_73_0)
					arg_74_0()
				end
...
function var_0_1.InitHotSpringCharacter(arg_76_0, arg_76_1, arg_76_2, arg_76_3)
	...
	GraphPath = var_1_10009

	var_76_3(var_76_2, var_1_10009.New(arg_76_2))
...
local function var_0_3(arg_79_0, arg_79_1)
	...
	for iter_79_0, iter_79_1 in var_1_10004(var_79_0) do
		local var_79_2 = iter_79_1.position.y

		if arg_79_1.y < var_79_2 then
			local var_79_3 = iter_79_1.tf
			local var_79_4 = var_9.GetSiblingIndex(var_79_3)

			table = var_10

			var_10.insert(var_79_1, var_79_4 + 1)
		end
	end
...
function var_0_1.UpdateShipLayer(arg_81_0)
	...
	for iter_81_0, iter_81_1 in var_1_10004(var_81_1) do
		...
		var_1_10011.SetAsLastSibling(var_81_5)
	end
