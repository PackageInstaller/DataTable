...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_3()
		...
		var_4_1(var_4_0, var_2_10003.GO_MINI_GAME, arg_3_0.gameId)
	...
	local function var_3_7()
		...
		local var_5_2 = var_2_10003.SEND_MINI_GAME_OP
		local var_5_3 = {
			hubid = arg_3_0.hubId
		}

		MiniGameOPCommand = var_5
		var_5_3.cmd = var_5.CMD_ULTIMATE
		var_5_3.args1 = {}
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	for iter_6_0 = 1, var_6_2 do
		...
		var_1_10009(var_6_4:Find("mark"), iter_6_0 <= var_6_1)

		setActive = var_1_10009

		var_1_10009(var_6_4:Find("icon"), iter_6_0 == var_6_1 and arg_6_0.ultimate == 0)
	end
	...
	var_4(var_6.Find(var_6_5, "got"), arg_6_0.ultimate == 1)

	setActive = var_4

	local var_6_6 = arg_6_0.rtBtns

	var_4(var_6.Find(var_6_6, "get"), arg_6_0.ultimate == 0 and var_6_1 == var_6_0)

	setActive = var_4

	local var_6_7 = arg_6_0.rtBtns

	var_4(var_6.Find(var_6_7, "got"), arg_6_0.ultimate == 1)

	setActive = var_4

	local var_6_8 = arg_6_0.rtBtns

	var_4(var_6.Find(var_6_8, "go"), var_6_1 < var_6_0)

	setActive = var_4

	local var_6_9 = arg_6_0.rtBtns

	var_4(var_6.Find(var_6_9, "red"), var_6_1 <= var_6_0 and arg_6_0.ultimate ~= 1 and arg_6_0.data.count > 0)
