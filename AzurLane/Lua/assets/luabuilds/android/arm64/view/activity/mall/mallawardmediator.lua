...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.INPUT_GOLD, function(arg_2_0, arg_2_1, arg_2_2)
		...
		local var_2_2 = var_2_10006.ACTIVITY_MALL_OP
		local var_2_3 = {
			activity_id = arg_2_1
		}

		ActivityMallOPCommand = var_2_10008
		var_2_3.cmd = var_2_10008.CMD.INPUT_GOLD
	...
	arg_1_0:bind(var_0_1.GET_PT_AWARD, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.ACT_NEW_PT, arg_3_1)
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	if var_7_1 == var_7_0.ACT_NEW_PT_DONE then
		if arg_7_0:IsAwardHandledByParent() then
			...
			var_7_6(var_7_5, var_1_10007.ON_ACHIEVE, var_7_3.awards, function()
		...
		if var_7_1 == var_7_6.ACTIVITY_MALL_OP_DONE then
			var_7_7 = var_7_3.cmd
			ActivityMallOPCommand = var_7_2

			if var_7_7 == var_7_2.CMD.INPUT_GOLD then
				local var_7_8 = arg_7_0.viewComponent

				var_7_7.UpdateView(var_7_8)
			end
		else
			GAME = var_7_7

			if var_7_1 == var_7_7.SUBMIT_TASK_AWARD_DOWN then
				if arg_7_0:IsAwardHandledByParent() then
					local var_7_9 = arg_7_0.viewComponent

					var_4.UpdateView(var_7_9)
				else
					local var_7_10 = arg_7_0.viewComponent
					local var_7_11 = var_4.emit

					BaseUI = var_1_10007

					var_7_11(var_7_10, var_1_10007.ON_ACHIEVE, var_7_3.awards, function()
