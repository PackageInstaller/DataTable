	...
	for iter_2_0 = 1, 2 do
		...
		var_1_10008.insert(var_2_5, function(arg_3_0)
			...
			var_2.LoadImage(var_3_2, var_3_1, function(arg_4_0)
				...
				local var_4_4 = var_4_3(var_4_2, var_4(var_3_10006))
	...
	for iter_6_0, iter_6_1 in var_1_10005(arg_6_0.list) do
		if iter_6_1 then
			...
			var_1_10010.insert(var_6_0, function(arg_7_0)
				...
				local var_7_1 = var_2_10002.value(iter_6_1.gameObject, iter_6_1.anchoredPosition.y, var_7_0.y - arg_6_1 * 0.8, 0.2)
				...
				local var_7_5 = var_7_4(var_7_3, var_5.easeOutQuad)
				local var_7_6 = var_2.setOnComplete

				System = var_5

				var_7_6(var_7_5, var_5.Action(arg_7_0))
...
function var_0_0.DoCheck(arg_10_0, arg_10_1)
	...
	if var_4(var_10_0).y + var_10_0.rect.height + arg_10_0.list[arg_10_1 + 1].rect.height - arg_10_0.tr.rect.height >= 50 then
		...
		typeof = var_1_10009
		Image = var_1_10011
		var_10_3 = var_10_3(var_10_2, var_1_10009(var_1_10011))
		var_1_10009 = arg_10_0

		local var_10_4 = arg_10_0.GetBg(var_1_10009, arg_10_1 + 2)
	...
	if var_10_3.abs(var_4.y) >= var_10_0.rect.height then
		...
		typeof = var_1_10009
		Image = var_1_10011
		var_10_6(var_10_5, var_1_10009(var_1_10011)).sprite = nil
		...
		for iter_15_0, iter_15_1 in var_4(var_3) do
			...
			var_1_10011.GetUI(var_15_3, var_15_1, true, function(arg_16_0)
				if not arg_15_0.list then
					...
					Vector3 = var_2_10002
					var_16_1.anchoredPosition3D = var_2_10002(var_15_2[1], var_15_2[2], -200)
					setActive = var_16_1
...
function var_0_0.ReturnEffect(arg_17_0, arg_17_1)
	if arg_17_1.childCount > 0 then
		for iter_17_0 = 1, var_2 do
			...
			local var_17_1 = var_1_10008.GetInstance()

			var_1_10008.ReturnUI(var_17_1, var_17_0.name, var_17_0.gameObject)
		end
	end
...
function var_0_0.Clear(arg_18_0)
	...
	var_1_10001(arg_18_0.tr, function(arg_19_0)
		...
		typeof = var_2_10004
		Image = var_2_10006
		var_19_1(var_19_0, var_2_10004(var_2_10006)).sprite = nil
