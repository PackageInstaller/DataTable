...
local var_0_1 = var_0_10001.activity_event_question
...
function var_0_0.Init(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_1(var_0_1.all) do
		...
		local var_2_2 = arg_2_0.GetNextTime(var_2_1, iter_2_0)
		local var_2_3 = arg_2_0:WrapQuestion(var_2_0, var_2_2)

		table = var_2_1

		var_2_1.insert(arg_2_0.questiones, var_2_3)
	end
...
function var_0_0.GetAnswerFlag(arg_8_0, arg_8_1, arg_8_2)
	...
	return var_8_0.map(arg_8_2, function(arg_10_0)
...
function var_0_0.SetAnswerFlag(arg_11_0, arg_11_1, arg_11_2)
	...
	var_1_10004.SetInt(arg_11_1 .. "_" .. arg_11_2 .. "_" .. var_11_1, 1)
