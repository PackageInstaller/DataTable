...
local var_0_0 = "AnimeMidtermLoginPage"
...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_8, var_1_9, var_1_10, var_6)
...
function var_0_1.updateAwardInfo(arg_11_0, arg_11_1)
	math = var_1_10002
	arg_11_1 = var_1_10002.max(arg_11_1, 1)

	local var_11_0 = arg_11_0.loader

	var_2.GetOffSpriteRequest(var_11_0, arg_11_0.dayProgressImg)

	local var_11_1 = arg_11_0.loader

	var_2.GetOffSpriteRequest(var_11_1, arg_11_0.awardImg)

	local var_11_2 = arg_11_0.loader

	var_2.GetSprite(var_11_2, "ui/activityuipage/animelogin_atlas", "tianshu_" .. arg_11_1, arg_11_0.dayProgressImg, true)

	local var_11_3 = arg_11_0.loader

	var_2.GetSprite(var_11_3, "ui/activityuipage/animemidtermloginpage_atlas", "icon_" .. arg_11_1, arg_11_0.awardImg, true)

	setActive = var_2

	var_2(arg_11_0.maskImg, arg_11_1 <= arg_11_0.nday)

	setActive = var_2

	var_2(arg_11_0.arrowLeft, arg_11_1 ~= 1)

	setActive = var_2

	var_2(arg_11_0.arrowRight, arg_11_1 ~= arg_11_0.allDaycount)

	local var_11_4 = arg_11_0.pointUIItemList

	var_2.align(var_11_4, arg_11_0.allDaycount)
