...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0._canvasGroup = var_1_10003(var_1_0, var_1_10006(var_1_10008))
	findTF = var_3
	arg_1_0._iconContent = var_3(arg_1_0._tf, "icons")
	GetComponent = var_3
	findTF = var_5

	local var_1_1 = var_5(arg_1_0._tf, "icons")

	typeof = var_6
	EventTriggerListener = var_8
	arg_1_0._eventTrigger = var_3(var_1_1, var_6(var_8))
	...
	local var_1_2 = var_5.item_bound[1]

	PuzzleConnectConst = var_6

	local var_1_3 = var_1_2 + var_6.item_spacing

	PuzzleConnectConst = var_6

	local var_1_4 = var_6.item_bound[2]

	PuzzleConnectConst = var_7
	arg_1_0._boundData = var_3(var_1_3, var_1_4 + var_7.item_spacing)
...
function var_0_0.updateIcon(arg_3_0)
		...
		for iter_3_2, iter_3_3 in var_1_10007(iter_3_1) do
			if iter_3_3 > 0 then
				...
				if #arg_3_0._iconTfs < var_3_0 then
					...
					var_3_1 = var_3_1(var_1_10014(arg_3_0._iconTpl))
					setActive = var_1_10013

					var_1_10013(var_3_1, true)

					setParent = var_1_10013

					var_1_10013(var_3_1, arg_3_0._iconContent)

					setActive = var_1_10013
					findTF = var_15

					var_1_10013(var_15(var_3_1, "line"), false)

					setActive = var_1_10013
					findTF = var_15

					var_1_10013(var_15(var_3_1, "lineBound"), false)

					table = var_1_10013

					var_1_10013.insert(arg_3_0._iconTfs, var_3_1)
				end

				setActive = var_3_1

				var_3_1(arg_3_0._iconTfs[var_3_0], true)

				local var_3_2 = arg_3_0._iconTfs[var_3_0]

				Vector2 = var_1_10013
				var_3_2.anchoredPosition = var_1_10013((iter_3_2 - 1) * arg_3_0._boundData.x, -(iter_3_0 - 1) * arg_3_0._boundData.y)
			end
		end
	end
	...
	for iter_3_5, iter_3_6 in var_2(arg_3_0._iconTfs) do
		...
		for iter_3_7 = var_3_3, var_1_10008.color_count do
			setActive = iter_3_3
			findTF = var_1_10013

			iter_3_3(var_1_10013(iter_3_6, iter_3_7), iter_3_7 == arg_3_0._color)
		end
	end
