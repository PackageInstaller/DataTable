...
function var_0_1.didEnter(arg_4_0)
	...
	var_1_10002(arg_4_0, arg_4_0._helpBtn, function()
		...
		pg = var_2_10004
		var_7_2.helps = var_2_10004.gametip.help_newyear_feast.tip
	...
	var_1_10002(arg_4_0, arg_4_0.btn_shouce_help, function()
		...
		pg = var_2_10004
		var_10_2.helps = var_2_10004.gametip.help_newyear_stamp.tip
	...
	var_1_10002(arg_4_0, arg_4_0.btn_receive, function()
		...
		if var_0.GetHubByHubId(var_11_0, arg_4_0.HUB_ID).ultimate == 0 then
			...
			if var_11_1 < var_0.getConfig(var_2_10004, "reward_need") then
				return
			end
			...
			local var_11_4 = var_2_10004.MINI_GAME_OPERATOR
			local var_11_5 = {
				hubid = var_0.id
			}
	...
	arg_4_0:InitFacility(arg_4_0.shrine, function()
		...
		var_12_1(var_12_0, var_2_10003.GO_MINI_GAME, 3)
	...
	arg_4_0:InitFacility(arg_4_0.snack_street, function()
		...
		var_13_1(var_13_0, var_2_10003.GO_MINI_GAME, 8)
	...
	arg_4_0:InitFacility(arg_4_0.divination, function()
		...
		var_14_4.id = var_2_10006.CYGNET_BATHROBE_PAGE_ID
	...
	arg_4_0:InitFacility(arg_4_0.shop, function()
		...
		var_15_1(var_15_0, var_15_2, var_2_10004.SKINSHOP)
	...
	var_4_3(var_4_2, var_5.NEWYEAR_ACTIVITY, 3, 5)
	arg_4_0:UpdateView()
	...
	if arg_4_0.contextData.isOpenShrine then
		...
		var_4_6(var_4_5, var_5.GO_MINI_GAME, 3)
	end
	...
	if var_4_0:GetMiniGameData(3) and not var_2:GetRuntimeData("isInited") then
		...
		NewYearFestivalMediator = var_6

		local var_4_9 = var_6.MINIGAME_OPERATION
		local var_4_10 = arg_4_0.HUB_ID

		MiniGameOPCommand = var_1_10008

		var_4_8(var_4_7, var_4_9, var_4_10, var_1_10008.CMD_SPECIAL_GAME, {
			3,
			1
		})
	end
...
function var_0_1.UpdateView(arg_17_0)
	...
	var_17_0(arg_17_0.ticketTimes, "X " .. var_2.count)
	...
	var_17_0(var_17_2, var_7.format("%02d", var_17_1))

	ipairs = var_17_0

	for iter_17_0, iter_17_1 in var_17_0(arg_17_0.group_get) do
		setActive = var_9

		var_9(iter_17_1, iter_17_0 <= var_17_1)
	end
	...
	var_6(var_17_5, var_2.count > 0)

	local var_17_6 = arg_17_0.shrine
	local var_17_7 = var_6.Find(var_17_6, "tip")
	local var_17_8 = var_1
	local var_17_9 = var_1.GetMiniGameData(var_17_8, 3)
	local var_17_10 = false

	if var_17_9 then
		if not var_17_9:GetRuntimeData("count") then
			var_17_8 = 0
		end

		if 0 < var_17_8 then
			NewYearShrinePage = var_10
			var_17_10 = var_10.IsTip()
		else
			var_17_10 = false
		end
	end
	...
	var_17_8(var_17_7, var_17_10)

	local var_17_11 = arg_17_0.divination
	local var_17_12

	var_17_12, setActive = var_9.Find(var_17_11, "tip"), var_10
	CygnetBathrobePage = var_1_10013

	var_10(var_17_12, var_1_10013.IsTip())
