...
function var_0_0.UpdateAwardGot(arg_7_0)
	setActive(arg_7_0.bg:Find("switcher/phase2/got"), not arg_7_0.ptData:CanGetNextAward() and arg_7_0.inPhase2)
...
function var_0_0.OnUpdateFlush(arg_8_0)
	...
	local var_8_4 = var_8_3 >= 1 and setColorStr(var_8_1, "#92C1F1FF") or var_8_1
