...
local var_0_2 = var_0_10001.activity_holiday_region

pg = var_0_0

local var_0_3 = var_0_0.activity_holiday_site
...
function var_0_1.init(arg_2_0)
	...
	local var_2_4 = var_3.Find(var_2_3, "regions")
	local var_2_5 = arg_2_0.map

	arg_2_0.regionList = var_2_2(var_2_4, var_4.Find(var_2_5, "regions/region"))
	UIItemList = var_1

	local var_2_6 = var_1.New
	local var_2_7 = arg_2_0.map
	local var_2_8 = var_3.Find(var_2_7, "sites")
	local var_2_9 = arg_2_0.map

	arg_2_0.siteList = var_2_6(var_2_8, var_4.Find(var_2_9, "sites/site"))
	...
	local var_2_27 = var_3.Find(var_2_26, "ui/bookBtn/name")

	i18n = var_4

	var_1(var_2_27, var_4("holiday_tip_collection"))

	setText = var_1

	local var_2_28 = arg_2_0._tf
	local var_2_29 = var_3.Find(var_2_28, "ui/taskBtn/name")

	i18n = var_4

	var_1(var_2_29, var_4("holiday_tip_task"))

	setText = var_1

	local var_2_30 = arg_2_0._tf
	local var_2_31 = var_3.Find(var_2_30, "ui/shopBtn/name")

	i18n = var_4

	var_1(var_2_31, var_4("holiday_tip_shop"))

	setText = var_1

	local var_2_32 = arg_2_0._tf
	local var_2_33 = var_3.Find(var_2_32, "ui/wharfBtn/name")

	i18n = var_4

	var_1(var_2_33, var_4("holiday_tip_trans"))

	setText = var_1

	local var_2_34 = arg_2_0._tf
	local var_2_35 = var_3.Find(var_2_34, "ui/taskBar/title")

	i18n = var_4

	var_1(var_2_35, var_4("holiday_tip_task_now"))

	setText = var_1

	local var_2_36 = arg_2_0.allRepairCompletePage
	local var_2_37 = var_3.Find(var_2_36, "panel/desc")

	i18n = var_4

	var_1(var_2_37, var_4("holiday_tip_finish"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_8()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.holiday_tip_gametip.tip
	...
	local var_3_11 = var_3_6.max(var_3_9 / 0, var_3_10 / 2522)
	local var_3_12 = arg_3_0.mapScaleSlider
	local var_3_13 = var_4.GetComponent

	typeof = var_1_10007
	Slider = var_1_10009
	var_3_13(var_3_12, var_1_10007(var_1_10009)).minValue = var_3_11
	...
	local var_3_16 = var_3_15(var_3_14, var_7(var_1_10009))
	...
	var_3_16(arg_3_0, arg_3_0.mapScaleSlider, function(arg_7_0)
		...
		var_7_6(var_4.Find(var_7_10, "regions"), arg_7_0 > 0.75)

		setActive = var_7_6

		local var_7_11 = arg_3_0.map

		var_7_6(var_4.Find(var_7_11, "sites"), arg_7_0 > 0.75)
	...
	var_4.Play(var_3_17, arg_3_0.firstStory, function()
		...
		if not var_0.IsPlayed(var_8_0, "HOLIDAY_1") then
			...
			var_8_3(var_8_2, var_3.STORY_UPDATE, {
				storyId = "HOLIDAY_1"
			})
		end
...
function var_0_1.InitData(arg_9_0)
	...
	arg_9_0.activityProxy = var_1(var_1_10003)
	getProxy = var_1
	TaskProxy = var_1_10003
	arg_9_0.taskProxy = var_1(var_1_10003)
...
function var_0_1.ExchangeAndSiteClick(arg_12_0)
	...
	if var_2.getData1(var_12_2) == 0 and var_12_1 and not arg_12_0.doingExchange then
		...
		HolidayVillaMapMediator = var_1_10005

		var_12_3(var_12_14, var_1_10005.EXCHANGE_RESOURCES, arg_12_0.activityId)
	...
	for iter_12_0, iter_12_1 in var_12_3(var_0_2.all) do
		...
		if var_8.getTaskStatus(var_12_17) == 2 then
			...
			if not var_12_16.contains(arg_12_0.clickedSiteIds, var_12_15.site_id) then
				local var_12_18 = arg_12_0
				local var_12_19 = arg_12_0.emit

				HolidayVillaMapMediator = var_13

				var_12_19(var_12_18, var_13.SITE_CLICKED, arg_12_0.activityId, var_12_15.site_id)
			end
		end
	end
		...
		if var_0_3[iter_12_3].type == 1 then
			...
			if var_8.contains(arg_12_0.clickedSiteIds, var_7.id) then
				...
				if not var_8.IsPlayed(var_12_20, var_7.jumpto) then
					...
					var_12_22(var_12_21, var_11.STORY_UPDATE, {
...
function var_0_1.ShowMap(arg_13_0)
	...
	var_2.make(var_13_1, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			if var_14_2.task_id == 0 then
				...
				var_14_6(arg_14_2, var_14_8 == 2 and var_14_5 ~= 2)
			end
			...
			if var_14_5 ~= 2 then
				...
				local var_14_11 = var_9.SetRes
				local var_14_12 = arg_14_2

				var_14_11(var_14_10, arg_14_2.Find(var_14_12, "res"), var_14_9)

				onButton = var_14_11

				local var_14_13 = arg_13_0
				...
				local function var_14_15()
					...
					for iter_15_0, iter_15_1 in var_3_10000(var_14_9) do
						...
						if var_15_1 > var_7.getVitemNumber(var_15_2, var_15_0) then
							...
							local var_15_3 = var_3_10008.TipsMgr.GetInstance()

							var_3_10008 = var_3_10008.ShowTips
							i18n = var_3_10011

							var_3_10008(var_15_3, var_3_10011("holiday_tip_rebuild_not"))
					...
					local var_15_4 = arg_13_0.ani

					Vector2 = var_1
					var_15_4.anchoredPosition = var_1(var_14_1.rebuild_ani[1], var_14_1.rebuild_ani[2])
					SetActionCallback = var_15_4

					var_15_4(arg_13_0.ani, function(arg_16_0)
						if arg_16_0 == "finish" then
							...
							var_16_1(var_16_0, var_4.ON_TASK_SUBMIT_ONESTEP, arg_13_0.taskActivityId, {
								var_14_1.task_id
							}, function(arg_17_0)
								if arg_17_0 then
									local var_17_0
									...
									var_2.ShowSiteDescPage(var_17_1, var_14_2, true, function()
										if var_17_0 then
											...
											if not var_0.IsPlayed(var_18_0, var_17_0) then
												...
												var_18_3(var_18_2, var_3.STORY_UPDATE, {
													storyId = var_17_0
												})
											end
										end
									...
									HolidayVillaMapMediator = var_5

									var_17_3(var_17_2, var_5.SITE_CLICKED, arg_13_0.activityId, var_14_1.site_id)
								end
					...
					var_15_4(arg_13_0.ani, "normal", false)
				...
				var_14_11(var_14_13, var_14_14, var_14_15, var_14_12)
			else
				var_13_0 = var_13_0 + 1
			end
		end
	...
	for iter_13_0 = 0, 8 do
		...
		var_1_10006(var_1_10008.GetChild(var_13_3, iter_13_0), false)
	end
	...
	if var_13_0 ~= 6 then
		...
		var_2(var_4.Find(var_13_4, "bg" .. var_13_0), true)
	else
		pg = var_2

		local var_13_5 = var_2.TimeMgr.GetInstance()
		local var_13_6 = var_2.GetServerHour(var_13_5)

		ipairs = var_3

		for iter_13_1, iter_13_2 in var_3(arg_13_0.mapTimes) do
			var_1_10008 = iter_13_2[1][1]

			local var_13_7 = iter_13_2[1][2]
			local var_13_8 = iter_13_2[2]
			local var_13_9 = iter_13_2[3]

			if var_1_10008 <= var_13_6 and var_13_6 < var_13_7 then
				setActive = var_1_10012

				local var_13_10 = arg_13_0.map

				var_1_10012(var_14.Find(var_13_10, "bg" .. var_13_0 .. "_" .. var_13_8), true)

				if arg_13_0.bgm ~= var_13_9 then
					arg_13_0.bgm = var_13_9
					pg = var_1_10012

					local var_13_11 = var_1_10012.BgmMgr.GetInstance()

					var_1_10012.Push(var_13_11, arg_13_0.__cname, var_13_9)
				end
	...
	for iter_13_3 = #var_3(var_0_3.all), 1, -1 do
		table = var_1_10008

		if not var_1_10008.contains(var_13_12, var_0_3[var_3[iter_13_3]].type) then
			table = var_1_10008
	...
	var_4.make(var_13_13, function(arg_19_0, arg_19_1, arg_19_2)
		UIItemList = var_2_10003
		...
		if arg_19_0 == var_2_10003.EventUpdate then
			...
			var_2_10007(arg_19_2:Find("1"), var_19_1 == 2)

			setActive = var_2_10007

			var_2_10007(arg_19_2:Find("2"), var_19_1 == 1 or var_19_1 == 3)

			if var_19_3 then
				table = var_2_10007

				if not var_2_10007.contains(arg_13_0.clickedSiteIds, var_19_0) then
					Vector2 = var_2_10007
					arg_19_2.anchoredPosition = var_2_10007(var_4.locate[1], var_4.locate[2])

					if var_19_1 == 1 then
						for iter_19_0 = 0, arg_19_2:Find("2").childCount - 1 do
							local var_19_4 = arg_19_2:Find("2")
							local var_19_5 = var_11.GetChild(var_19_4, iter_19_0)

							setActive = var_12

							var_12(var_19_5, var_19_5.name == var_4.icon)
						end
						...
						local function var_19_8()
							...
							var_20_2(var_20_1, var_3.SITE_CLICKED, arg_13_0.activityId, var_19_0)
						...
						var_2_10007(var_19_6, var_19_7, var_19_8, var_12)
					elseif var_19_1 == 2 then
						setText = var_2_10007

						var_2_10007(arg_19_2:Find("1/name"), var_4.name)

						onButton = var_2_10007

						local var_19_9 = arg_13_0
						local var_19_10 = arg_19_2
						...
						var_2_10007(var_19_9, var_19_10, var_19_11, var_12)
					elseif var_19_1 == 3 then
						for iter_19_1 = 0, arg_19_2:Find("2").childCount - 1 do
							local var_19_12 = arg_19_2:Find("2")
							local var_19_13 = var_11.GetChild(var_19_12, iter_19_1)

							setActive = var_12

							var_12(var_19_13, var_19_13.name == var_4.icon)
						end

						onButton = var_2_10007

						local var_19_14 = arg_13_0
						...
						local function var_19_16()
							...
							var_22_2(var_22_1, var_3.SITE_CLICKED, arg_13_0.activityId, var_19_0)
						...
						var_2_10007(var_19_14, var_19_15, var_19_16, var_12)
					end
	...
	local var_13_14 = arg_13_0.siteList

	var_4.align(var_13_14, #var_3)
...
function var_0_1.ShowUI(arg_23_0)
	...
	arg_23_0.SetRes(var_23_9, arg_23_0.res, var_23_0)

	local var_23_10 = var_0_3[arg_23_0.funtionIds[1]].task_id
	local var_23_11 = arg_23_0.taskProxy
	local var_23_12 = var_3.getFinishTaskById(var_23_11, var_23_10)

	setActive = var_23_9

	local var_23_13 = arg_23_0.watermelonGameBtn

	var_23_9(var_6.Find(var_23_13, "lock"), not var_23_12)

	setActive = var_23_9

	local var_23_14 = arg_23_0.watermelonGameBtn

	var_23_9(var_6.Find(var_23_14, "remain"), var_23_12)

	local var_23_16, var_23_17

	if var_23_12 then
		setText = var_23_9

		local var_23_15 = arg_23_0.watermelonGameBtn

		var_23_16 = var_23_16.Find(var_23_15, "remain/Text")
		getProxy = var_7
		MiniGameProxy = var_23_17
		var_23_17 = var_7(var_23_17)

		var_23_9(var_23_16, var_7.GetHubByGameId(var_23_17, 76).count)
		...
		local function var_23_19()
			...
			HolidayVillaMapMediator = var_2_10003

			var_24_1(var_24_0, var_2_10003.OPEN_MINI_GAME, 76)
		...
		var_23_9(var_23_16, var_23_18, var_23_19, var_23_17)
	else
		onButton = var_23_9
		var_23_16 = arg_23_0

		local var_23_20 = arg_23_0.watermelonGameBtn
		...
		local function var_23_21()
			...
			var_25_1(var_25_0, var_2_10003("activity_holiday_function_lock"))
		...
		var_23_9(var_23_16, var_23_20, var_23_21, var_23_17)
	end

	local var_23_22 = var_0_3[arg_23_0.funtionIds[2]].task_id
	local var_23_23 = arg_23_0.taskProxy
	local var_23_24 = var_5.getFinishTaskById(var_23_23, var_23_22)

	setActive = var_23_16

	local var_23_25 = arg_23_0.minerGameBtn

	var_23_16(var_8.Find(var_23_25, "lock"), not var_23_24)

	setActive = var_23_16

	local var_23_26 = arg_23_0.minerGameBtn

	var_23_16(var_8.Find(var_23_26, "remain"), var_23_24)

	local var_23_28, var_23_29
	...
	if var_23_24 then
		...
		var_23_28 = var_23_28.Find(var_23_27, "remain/Text")
		getProxy = var_9
		MiniGameProxy = var_23_29
		var_23_29 = var_9(var_23_29)

		var_23_16(var_23_28, var_9.GetHubByGameId(var_23_29, 77).count)

		onButton = var_23_16
		var_23_28 = arg_23_0

		local var_23_30 = arg_23_0.minerGameBtn
		...
		local function var_23_31()
			...
			var_26_1(var_26_0, var_2_10003.OPEN_MINI_GAME, 77)
		...
		var_23_16(var_23_28, var_23_30, var_23_31, var_23_29)
	else
		onButton = var_23_16
		var_23_28 = arg_23_0
		...
		local function var_23_33()
			...
			var_27_1(var_27_0, var_2_10003("activity_holiday_function_lock"))
		...
		var_23_16(var_23_28, var_23_32, var_23_33, var_23_29)
	end

	local var_23_34 = var_0_3[arg_23_0.funtionIds[3]].task_id
	local var_23_35 = arg_23_0.taskProxy
	local var_23_36 = var_7.getFinishTaskById(var_23_35, var_23_34)

	setActive = var_23_28

	local var_23_37 = arg_23_0.springBtn

	var_23_28(var_10.Find(var_23_37, "lock"), not var_23_36)

	setActive = var_23_28

	local var_23_38 = arg_23_0.springBtn

	var_23_28(var_10.Find(var_23_38, "tip"), var_23_36)
	...
	if var_23_36 then
		...
		local var_23_39 = arg_23_0.springBtn

		var_23_28(var_23_40.Find(var_23_39, "tip"), false)
		...
		local function var_23_42()
			...
			var_28_1(var_28_0, var_2_10003.GO_HOTSPRING)
		...
		var_23_28(var_23_40, var_23_41, var_23_42, var_13)
	else
		onButton = var_23_28
		var_23_40 = arg_23_0

		local var_23_43 = arg_23_0.springBtn
		...
		local function var_23_44()
			...
			var_29_1(var_29_0, var_2_10003("activity_holiday_function_lock"))
		...
		var_23_28(var_23_40, var_23_43, var_23_44, var_13)
	end

	local var_23_45 = arg_23_0.taskIdAndPositions[1][1]
	local var_23_46 = arg_23_0.taskProxy
	local var_23_47 = var_9.getFinishTaskById(var_23_46, var_23_45)

	setActive = var_23_40

	var_23_40(arg_23_0.bookBtn, var_23_47)

	setActive = var_23_40

	var_23_40(arg_23_0.taskBtn, var_23_47)

	setActive = var_23_40

	var_23_40(arg_23_0.shopBtn, var_23_47)

	setActive = var_23_40

	var_23_40(arg_23_0.wharfBtn, var_23_47)

	if var_23_47 then
		setActive = var_23_40

		local var_23_48 = arg_23_0.bookBtn
		local var_23_49 = var_12.Find(var_23_48, "tip")

		CollectionBookMediator = var_13

		var_23_40(var_23_49, var_13.GetCollectionBookTip())

		onButton = var_23_40

		local var_23_50 = arg_23_0
		local var_23_51 = arg_23_0.bookBtn
		...
		local function var_23_52()
			...
			var_30_1(var_30_0, var_2_10003.ON_BOOK)
		...
		var_23_40(var_23_50, var_23_51, var_23_52, var_15)

		setActive = var_23_40

		local var_23_53 = arg_23_0.taskBtn
		local var_23_54 = var_12.Find(var_23_53, "tip")

		HolidayVillaTasksLayer = var_23_51

		var_23_40(var_23_54, var_23_51.ShouldShowTip())

		onButton = var_23_40

		local var_23_55 = arg_23_0
		local var_23_56 = arg_23_0.taskBtn
		...
		local function var_23_57()
			...
			var_31_1(var_31_0, var_2_10003.OPEN_HolidayVilla_TASk)
		...
		var_23_40(var_23_55, var_23_56, var_23_57, var_15)

		setText = var_23_40

		local var_23_58 = arg_23_0.shopBtn
		local var_23_59 = var_12.Find(var_23_58, "res/Text")
		local var_23_60 = arg_23_0.activity

		var_23_40(var_23_59, var_13.getVitemNumber(var_23_60, 66005))

		onButton = var_23_40

		local var_23_61 = arg_23_0
		...
		local function var_23_63()
			...
			var_32_1(var_32_0, var_2_10003.ON_SHOP)
		...
		var_23_40(var_23_61, var_23_62, var_23_63, var_23_60)

		setText = var_23_40

		local var_23_64 = arg_23_0.wharfBtn
		local var_23_65 = var_12.Find(var_23_64, "res/Text")
		local var_23_66 = arg_23_0.activity

		var_23_40(var_23_65, var_13.getVitemNumber(var_23_66, 66006))

		onButton = var_23_40

		local var_23_67 = arg_23_0
		local var_23_68 = arg_23_0.wharfBtn

		local function var_23_69()
			local var_33_0 = arg_23_0
			local var_33_1 = var_0.emit

			HolidayVillaMapMediator = var_2_10003

			var_33_1(var_33_0, var_2_10003.OPEN_WHARF)
		...
		var_23_40(var_23_67, var_23_68, var_23_69, var_23_66)
	end
...
function var_0_1.SetRes(arg_34_0, arg_34_1, arg_34_2)
	...
	for iter_34_1, iter_34_2 in var_3(arg_34_2) do
		...
		for iter_34_3 = 0, arg_34_1.childCount - 1 do
			...
			local var_34_3 = arg_34_1.GetChild(var_34_2, iter_34_3).name

			tostring = var_34_2

			if var_34_3 == var_34_2(var_34_0) then
				setActive = var_34_3

				var_34_3(var_14, true)

				setText = var_34_3

				var_34_3(var_14:Find("Text"), var_34_1)
...
function var_0_1.SetTaskBar(arg_35_0)
	...
	for iter_35_0, iter_35_1 in var_1_10002(arg_35_0.taskIdAndPositions) do
		...
		if var_9.getTaskStatus(var_35_4) ~= 2 then
			...
			local var_35_6 = var_13.Find(var_35_5, "desc")
			local var_35_7 = var_9

			var_11(var_35_6, var_9.getConfig(var_35_7, "desc"))
			...
			local function var_35_10()
				...
				typeof = var_2_10003
				Slider = var_2_10005
				var_36_1(var_36_0, var_2_10003(var_2_10005)).value = 1
				...
				var_36_0(arg_35_0.mapScroll, ((0 - var_36_2) / 2 - var_35_2[1]) / (0 - var_36_2), ((2522 - var_36_3) / 2 - var_35_2[2]) / (2522 - var_36_3))
			...
			var_11(var_35_8, var_35_9, var_35_10, var_35_7)
	...
	if not var_35_0 then
		...
		local var_35_11 = arg_35_0.taskBar
		local var_35_12 = var_4.Find(var_35_11, "desc")

		i18n = iter_35_0

		var_2(var_35_12, iter_35_0("holiday_tip_task_finish"))

		onButton = var_2

		local var_35_13 = arg_35_0
		local var_35_14 = arg_35_0.taskBar
		...
		local function var_35_15()
			...
			local var_37_2 = var_37_1(var_37_0, var_2_10003(var_2_10005))
		...
		var_2(var_35_13, var_35_14, var_35_15, var_7)
	end
...
function var_0_1.ShowSiteDescPage(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	var_4(var_6.Find(var_38_1, "repairComplete"), arg_38_2)

	setText = var_4

	local var_38_2 = arg_38_0.siteDescPage

	var_4(var_6.Find(var_38_2, "panel/name"), arg_38_1.jumpto[1][1])

	setText = var_4

	local var_38_3 = arg_38_0.siteDescPage

	var_4(var_6.Find(var_38_3, "panel/desc"), arg_38_1.jumpto[2][1])
	...
	var_4(var_38_4, var_7.Find(var_38_5, "panel/picBg/mask/picture"))

	onButton = var_4

	local var_38_6 = arg_38_0
	local var_38_7 = arg_38_0.siteDescPage
	local var_38_8 = var_7.Find(var_38_7, "bg")
	...
	local function var_38_9()
		...
		var_39_1(var_39_0, var_39_2, var_4.Find(var_39_3, "subPages"))
	...
	var_4(var_38_6, var_38_8, var_38_9, var_38_7)

	onButton = var_4

	local var_38_10 = arg_38_0
	local var_38_11 = arg_38_0.siteDescPage
	local var_38_12 = var_7.Find(var_38_11, "closeBtn")
	...
	local function var_38_13()
		...
		var_40_1(var_40_0, var_40_2, var_4.Find(var_40_3, "subPages"))
	...
	SFX_CANCEL = var_38_11

	var_4(var_38_10, var_38_12, var_38_13, var_38_11)
...
function var_0_1.ShowAllRepairPage(arg_41_0)
	...
	var_41_2(var_41_1, var_4.Find(var_41_3, "panel/source/res"), arg_41_0.beforeExchangeResList)

	setText = var_41_2

	local var_41_4 = arg_41_0.allRepairCompletePage
	local var_41_5 = var_3.Find(var_41_4, "panel/destination/res/Text")
	local var_41_6 = arg_41_0.activity

	var_41_2(var_41_5, var_4.getVitemNumber(var_41_6, 66005) - arg_41_0.beforeExchangeResList[5][2])

	onButton = var_41_2

	local var_41_7 = arg_41_0
	local var_41_8 = arg_41_0.allRepairCompletePage
	local var_41_9 = var_4.Find(var_41_8, "bg")
	...
	local function var_41_10()
		...
		var_42_1(var_42_0, var_42_2, var_4.Find(var_42_3, "subPages"))
	...
	var_41_2(var_41_7, var_41_9, var_41_10, var_41_8)

	onButton = var_41_2

	local var_41_11 = arg_41_0
	local var_41_12 = arg_41_0.allRepairCompletePage
	local var_41_13 = var_4.Find(var_41_12, "closeBtn")
	...
	local function var_41_14()
		...
		var_43_1(var_43_0, var_43_2, var_4.Find(var_43_3, "subPages"))

		return
	end

	SFX_CANCEL = var_41_12

	var_41_2(var_41_11, var_41_13, var_41_14, var_41_12)
...
function var_0_1.onBackPressed(arg_45_0)
	...
	if var_1_10001(arg_45_0.siteDescPage) then
		...
		var_45_1(var_45_0, var_45_2, var_5.Find(var_45_3, "subPages"))
	...
	if var_45_1(arg_45_0.allRepairCompletePage) then
		...
		var_45_5(var_45_4, var_45_6, var_5.Find(var_45_7, "subPages"))
...
function var_0_1.IsShowMainTip(arg_46_0)
	...
	local var_46_6 = var_6(var_1_10008)
	...
	local var_46_9 = var_46_6(var_1_10010)
	...
	if var_46_4 then
		...
		local var_46_11 = var_46_13(var_46_11)

		if not (var_46_13.GetHubByGameId(var_46_11, 76).count > 0) then
			if var_46_7 then
				getProxy = var_46_13
				MiniGameProxy = var_46_11

				local var_46_12 = var_46_13(var_46_11)

				if not (var_46_13.GetHubByGameId(var_46_12, 77).count > 0) then
					if var_46_10 then
						CollectionBookMediator = var_46_13

						local var_46_13

						if not var_46_13.GetCollectionBookTip() then
							if var_46_10 then
								::label_46_0::

								HolidayVillaTasksLayer = var_46_13
								var_46_13 = var_46_13.ShouldShowTip()
