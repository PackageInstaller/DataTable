...
function var_0_0.RandomPile(arg_4_0)
	...
	local var_4_2 = var_4_0(var_4_1, #var_1_10004.Prefabs)

	PileGameConst = var_1_10002

	return var_1_10002.Prefabs[var_4_2]
end
...
function var_0_0.AddPile(arg_7_0, arg_7_1)
	...
	var_7_1.position = var_4(var_7_2, var_1_10007.START_Y, 0)
	Vector3 = var_4
	...
	PileGameConst = var_7
	var_7_1.leftMaxPosition = var_4(var_7_3, var_7.START_Y, 0)
	Vector3 = var_4
	...
	PileGameConst = var_7
	var_7_1.rightMaxPosition = var_4(var_7_4, var_7.START_Y, 0)
	...
	Vector2 = var_1_10005
	var_7_5.offset = var_1_10005(arg_7_1.boundary[1], arg_7_1.boundary[2])
	Vector2 = var_5
...
function var_0_0.ShouldSink(arg_27_0)
	local var_27_0 = arg_27_0:GetIndex()

	PileGameConst = var_1_10002

	return var_27_0 == var_1_10002.SINK_LEVEL + 1
end
...
function var_0_0.GetNextPos(arg_29_0, arg_29_1)
	...
	local var_29_2 = arg_29_0.GetPrevItem(var_29_1, arg_29_1)
	local var_29_3 = 0

	if var_29_2 then
		var_29_3 = var_29_2.position.y + var_29_2.sizeDelta.y
	else
		var_29_3 = var_29_0.position.y - var_29_0.sizeDelta.y
	end

	Vector3 = var_29_1

	return var_29_1(var_29_0.position.x, var_29_3, 0)
end
