...
function var_0_1.CommonInit(arg_4_0)
	...
	TeamType = var_4_5
	var_4_9[var_4_5.Vanguard] = {}
	TeamType = var_3
	var_4_9[var_3.Main] = {}
	TeamType = var_3
	var_4_9[var_3.Submarine] = {}
	arg_4_0._gridTFs = var_4_9
	arg_4_0._gridFrame = var_4_6:Find("mask/GridFrame")

	for iter_4_0 = 1, 3 do
		local var_4_10 = arg_4_0._gridTFs

		TeamType = var_1_10007

		local var_4_11 = var_4_10[var_1_10007.Main]
		local var_4_12 = arg_4_0._gridFrame

		var_4_11[iter_4_0] = var_1_10007.Find(var_4_12, "main_" .. iter_4_0)

		local var_4_13 = arg_4_0._gridTFs

		TeamType = var_1_10007

		local var_4_14 = var_4_13[var_1_10007.Vanguard]
		local var_4_15 = arg_4_0._gridFrame

		var_4_14[iter_4_0] = var_1_10007.Find(var_4_15, "vanguard_" .. iter_4_0)

		local var_4_16 = arg_4_0._gridTFs

		TeamType = var_1_10007

		local var_4_17 = var_4_16[var_1_10007.Submarine]
		local var_4_18 = arg_4_0._gridFrame

		var_4_17[iter_4_0] = var_1_10007.Find(var_4_18, "submarine_" .. iter_4_0)
	end

	local var_4_19 = arg_4_0.rtAdapt

	arg_4_0._nextPage = var_2.Find(var_4_19, "middle/nextPage")

	local var_4_20 = arg_4_0.rtAdapt

	arg_4_0._prevPage = var_2.Find(var_4_20, "middle/prevPage")
	arg_4_0._heroContainer = var_4_6:Find("HeroContainer")
	arg_4_0._checkBtn = var_4_6:Find("checkBtn")

	local var_4_21 = arg_4_0._tf

	arg_4_0._blurPanel = var_2.Find(var_4_21, "blur_panel")

	local var_4_22 = arg_4_0._blurPanel

	arg_4_0.topPanel = var_2.Find(var_4_22, "top")

	local var_4_23 = arg_4_0._blurPanel

	arg_4_0.topPanelBg = var_2.Find(var_4_23, "top_bg")

	local var_4_24 = arg_4_0.topPanel

	arg_4_0._backBtn = var_2.Find(var_4_24, "back_btn")

	local var_4_25 = arg_4_0.rtAdapt

	arg_4_0._spoilsContainer = var_2.Find(var_4_25, "right/infomation/atlasloot/spoils/items/items_container")

	local var_4_26 = arg_4_0.rtAdapt

	arg_4_0._item = var_2.Find(var_4_26, "right/infomation/atlasloot/spoils/items/item_tpl")
	SetActive = var_2
	...
	arg_4_0._goals = var_2.Find(var_4_27, "right/infomation/target/goal")
	arg_4_0._heroInfo = arg_4_0:getTpl("heroInfo")

	local var_4_28 = arg_4_0

	arg_4_0._starTpl = arg_4_0.getTpl(var_4_28, "star_tpl")
	setText = var_2
	findTF = var_4_28

	local var_4_29 = var_4_28(arg_4_0.rtAdapt, "middle/gear_score/vanguard/line/Image/Text1")

	i18n = var_5

	var_2(var_4_29, var_5("pre_combat_vanguard"))

	setText = var_2
	findTF = var_4_29

	local var_4_30 = var_4_29(arg_4_0.rtAdapt, "middle/gear_score/main/line/Image/Text1")

	i18n = var_5

	var_2(var_4_30, var_5("pre_combat_main"))

	setText = var_2
	findTF = var_4_30

	local var_4_31 = var_4_30(arg_4_0.rtAdapt, "middle/gear_score/submarine/line/Image/text1")

	i18n = var_5

	var_2(var_4_31, var_5("pre_combat_submarine"))

	setText = var_2

	local var_4_32 = arg_4_0._costContainer
	local var_4_33 = var_4.Find(var_4_32, "title")

	i18n = var_5

	var_2(var_4_33, var_5("pre_combat_consume"))

	setText = var_2
	findTF = var_4_33

	local var_4_34 = var_4_33(arg_4_0.rtAdapt, "right/infomation/target/title/GameObject")

	i18n = var_5

	var_2(var_4_34, var_5("pre_combat_targets"))

	setText = var_2
	findTF = var_4_34

	local var_4_35 = var_4_34(arg_4_0.rtAdapt, "right/infomation/atlasloot/atlasloot/title/GameObject")

	i18n = var_5

	var_2(var_4_35, var_5("pre_combat_atlasloot"))

	setText = var_2

	local var_4_36 = arg_4_0._startBtn
	local var_4_37 = var_4.Find(var_4_36, "text")

	i18n = var_5

	var_2(var_4_37, var_5("pre_combat_start"))

	setText = var_2

	local var_4_38 = arg_4_0._startBtn
	local var_4_39 = var_4.Find(var_4_38, "text_en")

	i18n = var_5

	var_2(var_4_39, var_5("pre_combat_start_en"))

	local var_4_40 = arg_4_0.rtAdapt

	arg_4_0._middle = var_2.Find(var_4_40, "middle")

	local var_4_41 = arg_4_0.rtAdapt

	arg_4_0._right = var_2.Find(var_4_41, "right")
	...
	local var_4_42 = arg_4_0._middle

	arg_4_0.guideDesc = var_2.Find(var_4_42, "guideDesc")

	if arg_4_0.contextData.stageId then
		arg_4_0:SetStageID(arg_4_0.contextData.stageId)
	end

	local var_4_43 = arg_4_0._startBtn

	arg_4_0._costTip = var_2.Find(var_4_43, "cost_container/popup/tip")

	local var_4_44 = arg_4_0.rtAdapt

	arg_4_0._continuousBtn = var_2.Find(var_4_44, "right/multiple")
	setText = var_2

	local var_4_45 = arg_4_0._continuousBtn
	local var_4_46 = var_4.Find(var_4_45, "text")

	i18n = var_5

	var_2(var_4_46, var_5("multiple_sorties_title"))

	setText = var_2

	local var_4_47 = arg_4_0._continuousBtn
	local var_4_48 = var_4.Find(var_4_47, "text_en")

	i18n = var_5

	var_2(var_4_48, var_5("multiple_sorties_title_eng"))
...
function var_0_1.Register(arg_5_0)
	...
	var_1.AddHeroInfoModify(var_5_1, function(arg_7_0, arg_7_1)
		...
		local var_7_9 = var_7_7.battle_cost_template[var_7_8]

		setActive = var_7_5

		var_7_5(var_7_4, var_7_3 and var_7_9.enter_energy_cost > 0)
		...
		var_10(var_12(var_7_0, "type"), var_9, true)

		setText = var_10
		findTF = var_12

		var_10(var_12(var_7_0, "frame/lv_contain/lv"), arg_7_1.level)
		...
		if 0 < var_7_12 then
			...
			local var_7_17 = var_7_0:Find("expbuff")
			...
			local var_7_24 = var_7_0:Find("expbuff")
	...
	var_1.AddLongPress(var_5_2, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
		...
		BossSinglePreCombatMediator = var_2_10007
	...
	var_1.AddSwitchToDisplayMode(var_5_9, function()
		...
		var_0(var_2.Find(var_15_3, "save"), true)

		setActive = var_0

		local var_15_4 = arg_5_0._checkBtn

		var_0(var_2.Find(var_15_4, "edit"), false)
	...
	var_1.AddSwitchToPreviewMode(var_5_11, function()
		...
		var_0(var_2.Find(var_17_3, "save"), false)

		setActive = var_0

		local var_17_4 = arg_5_0._checkBtn

		var_0(var_2.Find(var_17_4, "edit"), true)
...
function var_0_1.SetStageID(arg_22_0, arg_22_1)
	...
	findTF = var_7
	var_22_11[1] = var_7(arg_22_0._goals, "goal_tpl")
	findTF = var_7
...
function var_0_1.UpdateFleetView(arg_30_0, arg_30_1)
	...
	local var_30_3 = var_1_10005.Vanguard
	local var_30_4 = arg_30_0._currentForm

	PreCombatLayer = var_1_10007

	var_30_2(var_30_1, var_30_3, var_30_4 ~= var_1_10007.FORM_EDIT)
	...
	var_30_6(var_30_5, var_30_7, var_30_8 ~= var_7.FORM_EDIT)
	...
	var_30_10(var_30_9, var_30_11, var_30_12 ~= var_7.FORM_EDIT)
...
function var_0_1.quickExitFunc(arg_35_0)
	...
	if var_35_0 == var_1_10002.FORM_EDIT then
		...
		BossSinglePreCombatMediator = var_1_10004

		var_35_2(var_35_1, var_1_10004.ON_ABORT_EDIT)
	end
...
function var_0_1.didEnter(arg_36_0)
		...
		if var_37_1 == var_2_10002.FORM_EDIT then
			...
			var_37_1.insert(var_37_0, function(arg_38_0)
				...
				function var_38_2.onYes()
					...
					BossSinglePreCombatMediator = var_4_10003
	...
	local function var_36_8()
		...
		if var_49_0 == var_2_10001.FORM_EDIT then
			local var_49_1 = arg_36_0
			local var_49_2 = var_0.emit

			BossSinglePreCombatMediator = var_2_10003

			var_49_2(var_49_1, var_2_10003.ON_COMMIT_EDIT, function()
				pg = var_3_10000
				...
				var_50_1(var_50_0, var_3_10003("battle_preCombatLayer_save_success"))
			...
			if var_49_3 == var_1.FORM_PREVIEW then
	...
	local var_36_9 = arg_36_0._currentForm

	PreCombatLayer = var_2

	if var_36_9 == var_2.FORM_EDIT then
		local var_36_10 = arg_36_0._formationLogic

		var_36_9.SwitchToDisplayMode(var_36_10)
	else
		local var_36_11 = arg_36_0._formationLogic

		var_36_9.SwitchToPreviewMode(var_36_11)
	end

	setActive = var_36_9

	var_36_9(arg_36_0._autoToggle, true)

	onToggle = var_36_9

	local var_36_12 = arg_36_0
	local var_36_13 = arg_36_0._autoToggle

	local function var_36_14(arg_51_0)
		local var_51_0 = arg_36_0
		local var_51_1 = var_1.emit

		BossSinglePreCombatMediator = var_2_10004

		var_51_1(var_51_0, var_2_10004.ON_AUTO, {
			isOn = not arg_51_0,
		...
		if arg_51_0 and arg_36_0._subUseable == true then
			...
			local function var_51_4(arg_52_0)
				...
				BossSinglePreCombatMediator = var_3_10004

				var_52_1(var_52_0, var_3_10004.ON_SUB_AUTO, {
					isOn = not arg_52_0,
			...
			var_51_1(var_51_2, var_51_3, var_51_4, var_6, var_2_10007)
	...
	var_36_9(var_36_12, var_36_13, var_36_14, var_1_10006, var_1_10007)

	triggerToggle = var_36_9

	local var_36_15 = arg_36_0._autoToggle

	ys = var_36_13

	var_36_9(var_36_15, var_36_13.Battle.BattleState.IsAutoBotActive())
	...
	local var_36_16 = arg_36_0.contextData.stageId

	getProxy = var_2
	ActivityProxy = var_4

	local var_36_17 = var_2(var_4)
	local var_36_18 = var_2.getActivityById(var_36_17, arg_36_0.contextData.actId)
	local var_36_19 = var_2.GetEnemyDataByStageId(var_36_18, var_36_16)
	local var_36_20

	if var_3.IsContinuousType(var_36_19) then
		::label_36_0::

		var_1_10007 = var_2
		var_36_20 = var_2.HasPassStage(var_1_10007, var_36_16)
	end

	setActive = var_36_19

	var_36_19(arg_36_0._continuousBtn, var_4)

	setActive = var_36_19

	local var_36_21 = arg_36_0._continuousBtn

	var_36_19(var_8.Find(var_36_21, "lock"), not var_36_20)

	if var_36_20 then
		Color = var_36_19

		if not var_36_19.white then
			Color = var_36_19
			var_36_19 = var_36_19.New(0.2980392156862745, 0.2980392156862745, 0.2980392156862745)
		end

		setImageColor = var_1_10007

		var_1_10007(arg_36_0._continuousBtn, var_36_19)

		setTextColor = var_1_10007

		local var_36_22 = arg_36_0._continuousBtn

		var_1_10007(var_9.Find(var_36_22, "text"), var_36_19)

		setTextColor = var_1_10007

		local var_36_23 = arg_36_0._continuousBtn

		var_1_10007(var_9.Find(var_36_23, "text_en"), var_36_19)

		onButton = var_1_10007

		local var_36_24 = arg_36_0
		local var_36_25 = arg_36_0._continuousBtn
		...
		local function var_36_26()
			...
			if var_36_20 then
				...
				var_54_1(var_54_0, var_2_10003.SHOW_CONTINUOUS_OPERATION_WINDOW, arg_36_0._currentFleetVO.id)
			else
				pg = var_54_1
				...
				var_54_3(var_54_2, var_2_10003("multiple_sorties_locked_tip"))
			end
		...
		var_1_10007(var_36_24, var_36_25, var_36_26, var_12)
...
function var_0_1.displayFleetInfo(arg_55_0)
	...
	var_1_10002(var_55_2, var_55_1 == var_1_10005.Normal)
	...
	var_1_10002(var_55_3, var_55_1 == var_5.Normal)

	math = var_1_10002

	local var_55_4 = var_1_10002.floor
	local var_55_5 = arg_55_0._currentFleetVO
	local var_55_6 = var_4.GetGearScoreSum

	TeamType = var_1_10007

	local var_55_7 = var_55_4(var_55_6(var_55_5, var_1_10007.Vanguard))

	math = var_55_0

	local var_55_8 = var_55_0.floor
	local var_55_9 = arg_55_0._currentFleetVO
	local var_55_10 = var_5.GetGearScoreSum

	TeamType = var_1_10008

	local var_55_11 = var_55_8(var_55_10(var_55_9, var_1_10008.Main))
	...
	var_4(var_55_12, var_55_1 == var_55_9.Submarine)

	math = var_4

	local var_55_13 = var_4.floor
	local var_55_14 = arg_55_0._currentFleetVO
	local var_55_15 = var_6.GetGearScoreSum

	TeamType = var_1_10009

	local var_55_16 = var_55_13(var_55_15(var_55_14, var_1_10009.Submarine))
	...
	local var_55_20 = var_55_17.battle_cost_template[var_55_19].oil_cost == 0 and 0 or var_55_18.oil

	setActive = var_9

	var_9(arg_55_0._costContainer, true)
	...
	if var_55_23 == var_55_21.ACTIVITY_TYPE_BOSSSINGLE_VARIABLE then
		...
		local var_55_25 = var_55_22.battle_cost_template[var_55_19].oil_cost > 0
		local var_55_26 = 0
		local var_55_27 = 0
		...
		if var_55_28 then
			...
			if not iter_55_0(0.9803921568627451, 0.39215686274509803, 0.39215686274509803) then
				Color = iter_55_0
				iter_55_0 = iter_55_0.white
			end

			var_17(var_55_32, iter_55_0)
			...
			if var_55_28 then
				...
				var_17(arg_55_0, arg_55_0._costTip, function()
					...
					i18n = var_2_10004
					var_56_2.content = var_2_10004("use_oil_limit_help", var_55_27, var_55_26)
