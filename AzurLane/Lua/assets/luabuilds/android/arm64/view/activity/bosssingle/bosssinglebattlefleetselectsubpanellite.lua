...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_3 = var_1_10002.Normal
	local var_2_4 = {}
	...
	for iter_2_0 = 0, arg_2_0.toggleList.childCount - 1 do
		...
		var_1_10005(var_2_19, var_8.Find(var_2_20, "item" .. iter_2_0 + 1))
	end
	...
	local var_2_24 = var_3.Find(var_2_23, "panel/formation_btn/text")

	i18n = var_4

	var_1(var_2_24, var_4("autofight_formation"))

	setText = var_1

	local var_2_25 = arg_2_0._tf
	local var_2_26 = var_3.Find(var_2_25, "panel/commander_btn/text")

	i18n = var_4

	var_1(var_2_26, var_4("autofight_cat"))

	setText = var_1

	local var_2_27 = arg_2_0._tf
	local var_2_28 = var_3.Find(var_2_27, "panel/title/Image/text")

	i18n = var_4

	var_1(var_2_28, var_4("fleet_select_title"))
...
function var_0_1.SetFleets(arg_8_0, arg_8_1)
	...
	local var_8_1 = var_8_0(var_4.values(arg_8_1))
...
function var_0_1.showToggleMask(arg_15_0, arg_15_1, arg_15_2)
	...
	for iter_15_0, iter_15_1 in var_1_10004(arg_15_0.toggles) do
		...
		if var_15_1 then
			...
			typeof = var_13
			Toggle = var_1_10015
			var_1_10010 = var_1_10010(var_15_2, var_13(var_1_10015))

			local var_15_3 = iter_15_1:Find("lock")
			local var_15_4 = var_15_1
			local var_15_5, var_15_6 = var_15_1.isUnlock(var_15_4)

			setToggleEnabled = var_15_4

			var_15_4(iter_15_1, var_15_5)

			setActive = var_15_4

			var_15_4(var_15_3, not var_15_5)

			table = var_15_4

			local var_15_7 = var_15_4.contains(arg_15_0.selectIds[arg_15_1], var_15_1.id)

			setActive = var_1_10015

			var_1_10015(iter_15_1:Find("on"), var_15_7)

			setActive = var_1_10015

			var_1_10015(iter_15_1:Find("off"), not var_15_7)
			...
			if var_15_5 then
				...
				local var_15_9 = iter_15_1

				local function var_15_10(arg_17_0)
					if arg_17_0 then
				...
				var_1_10015(var_15_8, var_15_9, var_15_10, var_20)
			else
				onButton = var_1_10015

				local var_15_11 = arg_15_0
				local var_15_12 = var_15_3
				...
				local function var_15_13()
					...
					var_0.ShowTips(var_18_0, var_15_6)
				...
				var_1_10015(var_15_11, var_15_12, var_15_13, var_20)
			end
		end
	end
...
function var_0_1.updateFleet(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_3 = arg_20_0.getFleetById(var_20_2, var_20_1)
	local var_20_4 = arg_20_0.tfFleets[arg_20_1][arg_20_2]

	findTF = var_20_2

	local var_20_5 = var_20_2(var_20_4, "bg/name")
	local var_20_6 = var_20_4
	local var_20_7 = var_20_4.Find

	TeamType = var_1_10012

	local var_20_8 = var_20_7(var_20_6, var_1_10012.Main)
	local var_20_9 = var_20_4
	local var_20_10 = var_20_4.Find

	TeamType = var_1_10013

	local var_20_11 = var_20_10(var_20_9, var_1_10013.Vanguard)
	local var_20_12 = var_20_4
	local var_20_13 = var_20_4.Find

	TeamType = var_1_10014

	local var_20_14 = var_20_13(var_20_12, var_1_10014.Submarine)

	setActive = var_20_9

	var_20_9(var_20_4:Find("btn_recom"), false)

	local var_20_15 = var_20_4
	local var_20_16 = var_20_4.Find(var_20_15, "btn_clear")

	setActive = var_20_12

	var_20_12(var_20_16, false)

	local var_20_17 = var_20_4:Find("btn_select")

	setActive = var_20_15

	var_20_15(var_20_17, var_20_0)

	local var_20_18 = var_20_4
	local var_20_19 = var_20_4.Find(var_20_18, "selected")
	local var_20_20 = var_20_4:Find("commander")

	setActive = var_20_18

	var_20_18(var_20_19, false)
	...
	if var_20_8 then
		...
		var_20_18(var_20_8, var_20_0 and var_20_3)
	end

	if var_20_11 then
		setActive = var_20_18

		var_20_18(var_20_11, var_20_0 and var_20_3)
	end

	if var_20_14 then
		setActive = var_20_18

		var_20_18(var_20_14, var_20_0 and var_20_3)
	end

	if var_20_0 and var_20_3 then
		setText = var_20_18

		local var_20_21 = var_20_5

		if var_20_3 then
			var_1_10021 = var_20_3

			local var_20_22

			if not var_20_3.GetName(var_1_10021) then
				var_20_22 = ""
			end

			var_20_18(var_20_21, var_20_22)

			FleetType = var_20_18

			if arg_20_1 == var_20_18.Submarine then
				local var_20_23 = arg_20_0

				var_20_18 = arg_20_0.updateShips

				local var_20_24 = var_20_14
				local var_20_25 = var_20_3.subShips

				var_1_10021 = var_20_3.id
				TeamType = var_1_10022

				var_20_18(var_20_23, var_20_24, var_20_25, var_1_10021, var_1_10022.Submarine)
			else
				local var_20_26 = arg_20_0

				var_20_18 = arg_20_0.updateShips

				local var_20_27 = var_20_8
				local var_20_28 = var_20_3.mainShips

				var_1_10021 = var_20_3.id
				TeamType = var_1_10022

				var_20_18(var_20_26, var_20_27, var_20_28, var_1_10021, var_1_10022.Main)

				local var_20_29 = arg_20_0

				var_20_18 = arg_20_0.updateShips

				local var_20_30 = var_20_11
				local var_20_31 = var_20_3.vanguardShips

				var_1_10021 = var_20_3.id
				TeamType = var_22

				var_20_18(var_20_29, var_20_30, var_20_31, var_1_10021, var_22.Vanguard)
			end
			...
			local function var_20_34()
				arg_20_0.toggleList.position = (var_20_17.position + var_20_16.position) / 2
			...
			var_20_18(var_20_32, var_20_33, var_20_34, var_1_10021)
...
function var_0_1.updateShips(arg_25_0, arg_25_1, arg_25_2, arg_25_3, arg_25_4)
	...
	local var_25_0 = var_1_10005(var_7)

	for iter_25_0 = 1, 3 do
		local var_25_1 = var_25_0

		if var_25_0.getShipById(var_25_1, arg_25_2[iter_25_0]) then
			local var_25_2 = var_10 and arg_25_0.tfShipTpl

			cloneTplTo = var_25_1

			local var_25_3 = var_25_1(var_25_2, arg_25_1)

			setActive = var_13

			var_13(var_25_3, true)

			if var_10 then
				updateShip = var_13

				var_13(var_25_3, var_10)

				setActive = var_13

				var_13(var_25_3:Find("event_block"), false)
			end

			setActive = var_13

			var_13(var_25_3:Find("ship_type"), false)
		end
	end
...
function var_0_1.selectFleet(arg_26_0, arg_26_1, arg_26_2, arg_26_3)
	...
	if arg_26_1 == var_5.Normal and arg_26_0:getLimitNums(arg_26_1) > 0 and arg_26_3 == 0 then
		...
		if #var_5.filter(var_26_0, function(arg_27_0)
			...
			var_26_2(var_26_1, var_8("level_fleet_lease_one_ship"))
	...
	if arg_26_0:getFleetById(arg_26_3) then
		...
		if var_5:isLegalToFight() ~= true then
			...
			var_26_4(var_26_3, var_1_10009("level_fleet_not_enough"))
...
function var_0_1.OnCombat(arg_33_0)
	...
	var_33_4(var_33_3, var_1_10005.GO_SINGLE_PRECOMBAT, {
