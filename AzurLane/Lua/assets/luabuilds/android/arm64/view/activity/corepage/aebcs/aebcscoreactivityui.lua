...
function var_0_1.init(arg_2_0, ...)
	...
	if var_2_4 ~= nil then
		...
		var_2_6(var_6.Find(var_2_7, "adapt/top/btn_home/text_tip/Text (Legacy)"), var_2_4)
	end
			...
			if var_3.detect(arg_2_0.activities, function(arg_4_0)
				...
				elseif not arg_2_0.pageDic[var_3.id] then
					...
					if arg_2_0.pageDic[var_3.id] ~= nil then
						...
						local var_3_3 = arg_3_2.Find(var_3_2, "tip")
						...
						if var_4:IsShowReminder() == nil then
							...
							var_3_2(var_3_4, var_3.readyToAchieve(var_2_10012))
						else
							setActive = var_3_2

							var_3_2(var_3_3, var_6)
						end
						...
						var_3_2(var_3_5, var_3_6, var_3_7, var_2_10012)
					end
				end
	...
	pg = var_8
	arg_2_0.camEventId = var_2_11(var_2_10, var_8.CameraFixMgr.ASPECT_RATIO_UPDATE, function(arg_6_0, arg_6_1)
...
function var_0_1.ONToggleName(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_0 = arg_8_1:Find("off/name")

	i18n = var_1_10006

	var_1_10003(var_8_0, var_1_10006("danmachi_main_sheet" .. arg_8_2:getConfig("is_show")))

	setText = var_1_10003

	local var_8_1 = arg_8_1:Find("on/name")

	i18n = var_6

	var_1_10003(var_8_1, var_6("danmachi_main_sheet" .. arg_8_2:getConfig("is_show")))
...
function var_0_1.didEnter(arg_9_0)
	...
	if not arg_9_0.contextData.activeScenario then
		...
		var_9_1 = var_9_1(var_9_0, var_1_10004(var_1_10006))
	...
	var_9_1(var_9_2, var_9_3, var_9_4, var_1_10006)
...
function var_0_1.skinCommdityTimeStamp(arg_11_0, arg_11_1)
	...
	local var_11_2 = var_1_10003.max(arg_11_1 - var_11_1, 0)

	math = var_11_0

	local var_11_3 = var_11_0.floor(var_11_2 / 0)
...
function var_0_1.ActiveScenarioLayer(arg_12_0, arg_12_1)
	...
	var_1_10002(var_4.Find(var_12_0, "left_mask"), not arg_12_1)

	setActive = var_1_10002

	local var_12_1 = arg_12_0._tf

	var_1_10002(var_4.Find(var_12_1, "adapt/tabs"), not arg_12_1)

	setActive = var_1_10002

	local var_12_2 = arg_12_0._tf

	var_1_10002(var_4.Find(var_12_2, "adapt/decorate"), not arg_12_1)

	setActive = var_1_10002

	local var_12_3 = arg_12_0._tf

	var_1_10002(var_4.Find(var_12_3, "adapt/btn_skin"), not arg_12_1)
