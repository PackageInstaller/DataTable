...
function var_0_1.OnUpdateFlush(arg_11_0)
	...
	local var_11_15 = var_5.Find(var_11_14, "count")

	i18n = var_6

	var_3(var_11_15, var_6("SkinDiscount_Got", arg_11_0:GetCouponCountText()))

	setActive = var_3

	local var_11_16 = arg_11_0.rtSkinCoupon

	var_3(var_5.Find(var_11_16, "icon/get"), arg_11_0.couponGet > 0)
