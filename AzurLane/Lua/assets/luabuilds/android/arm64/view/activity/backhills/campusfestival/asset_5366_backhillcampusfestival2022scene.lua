...
function var_0_1.init(arg_2_0)
	...
	arg_2_0._SDPlace = var_1.Find(var_2_9, "SDPlace")
	arg_2_0.containers = {
		arg_2_0._SDPlace
	}

	local var_2_10 = arg_2_0.top
	local var_2_11 = var_1.Find(var_2_10, "GameCount/Text")
	local var_2_12 = var_1.GetComponent

	typeof = var_4
	Text = var_1_10006
	arg_2_0.gameCountTxt = var_2_12(var_2_11, var_4(var_1_10006))

	local var_2_13 = arg_2_0.top
	local var_2_14 = var_1.Find(var_2_13, "Material/Text")
	local var_2_15 = var_1.GetComponent

	typeof = var_4
	Text = var_1_10006
	arg_2_0.materialTxt = var_2_15(var_2_14, var_4(var_1_10006))
	GraphPath = var_1

	local var_2_16 = var_1.New

	import = var_2_14
	arg_2_0.graphPath = var_2_16(var_2_14("GameCfg.BackHillGraphs.BackHillCampusFestiva2022Graph"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.backhill_campusfestival_tip.tip
	...
	var_1_10001(var_3_12, var_4.Find(var_3_13, "top/Invitation"), function()
		...
		if var_7_1(var_7_0, var_2_10003.INVITATION_JP_FIFTH) and not var_0:isEnd() then
			local var_7_2 = arg_3_0
			local var_7_3 = var_1.emit

			BackHillMediatorTemplate = var_2_10004

			local var_7_4 = var_2_10004.GO_SCENE

			SCENE = var_2_10005

			var_7_3(var_7_2, var_7_4, var_2_10005.ACTIVITY, {
				id = var_0.id
			})
		end
	...
	local var_3_16 = var_3_15(var_3_14, var_4.MINIGAME_CAKEMAKING)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "cakeshop", function()
		...
		var_8_1(var_8_0, var_2_10003.GO_MINI_GAME, 42)
	...
	PLATFORM_CODE = iter_3_0
	PLATFORM_JP = iter_3_1

	var_2(var_3_17, iter_3_0 == iter_3_1)
...
function var_0_1.UpdateActivity(arg_11_0, arg_11_1)
	local var_11_0 = arg_11_1:getConfig("type")

	ActivityConst = var_1_10003

	if var_11_0 == var_1_10003.ACTIVITY_TYPE_BUILDING_BUFF then
		arg_11_0:UpdateView()
	end
...
function var_0_1.RegisterDataResponse(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10002(var_12_1) do
		...
		var_7.AddRawListener(var_12_2, {
			...
			var_13_1(var_13_0, var_13_2 .. var_6.getUIName(var_13_3) .. "_atlas", "entrance_" .. iter_12_1 .. arg_13_1, arg_13_0["map_" .. iter_12_1], true)
	...
	var_3.insertto(var_12_4, var_12_1)
...
function var_0_1.UpdateView(arg_18_0)
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10004.ACTIVITY_TYPE_BUILDING_BUFF)

	pairs = var_1_10002

	for iter_18_0, iter_18_1 in var_1_10002(arg_18_0.Buildings) do
		var_1_10007 = arg_18_0.Respones
		...
		var_1_10007[iter_18_1] = var_18_3
		var_1_10007 = arg_18_0.Respones
		var_1_10007[iter_18_1 .. "Tip"] = arg_18_0:UpdateBuildingTip(var_18_2, iter_18_0)
	end

	_ = var_2

	local var_18_4 = var_2.all

	_ = var_4

	local var_18_5 = var_18_4(var_4.keys(arg_18_0.Buildings), function(arg_19_0)
		local var_19_0
	...
	var_3(arg_18_0.map_Decoration, var_18_5)

	next = var_3

	local var_18_6 = var_3(var_18_2.data1KeyValueList[1])
	local var_18_7 = arg_18_0.Respones
	local var_18_8

	if not var_18_2.data1KeyValueList[1][var_18_6] then
		var_18_8 = 0
	end

	var_18_7.materialCount = var_18_8
	...
	local function var_18_9()
		...
		return var_20_0(var_2_10002.MINIGAME_CAKEMAKING)
	end

	local var_18_10 = arg_18_0.Respones

	tobool = var_6
	var_18_10.cakeshopTip = var_6(var_18_9())
	getProxy = var_18_10
	ActivityProxy = var_1_10007

	local var_18_11 = var_18_10(var_1_10007)
	local var_18_12 = var_5.getActivityById

	ActivityConst = var_8

	local var_18_13 = var_18_12(var_18_11, var_8.MINIGAME_CAKEMAKING)

	getProxy = var_6
	MiniGameProxy = var_8

	local var_18_14 = var_6(var_8)
	local var_18_15 = var_6.GetHubByHubId(var_18_14, var_18_13:getConfig("config_id"))
	local var_18_16 = arg_18_0

	arg_18_0.UpdateHubData(var_18_16, var_18_15)
	...
	local function var_18_17()
		...
		local var_21_2 = var_21_1(var_21_0, var_2_10003.ACTIVITY_TYPE_SUMMARY)

		Activity = var_2_10001

		return var_2_10001.IsActivityReady(var_21_2)
	end

	local var_18_18 = arg_18_0.Respones

	tobool = var_18_16
	var_18_18.shujvhuiguTip = var_18_16(var_18_17())
...
function var_0_1.IsShowMainTip(arg_23_0)
	local function var_23_0()
		...
		return var_24_0(var_2_10002.MINIGAME_CAKEMAKING)
	end
	...
	local function var_23_1()
		...
		local var_25_2 = var_25_1(var_25_0, var_2_10003.ACTIVITY_TYPE_BUILDING_BUFF)

		Activity = var_2_10001

		return var_2_10001.IsActivityReady(var_25_2)
	end
	...
	local function var_23_2()
		...
		local var_26_2 = var_26_1(var_26_0, var_2_10003.ACTIVITY_TYPE_SUMMARY)

		Activity = var_2_10001

		return var_2_10001.IsActivityReady(var_26_2)
	end
