...
function var_0_0.initFurn(arg_4_0)
	...
	local var_4_2 = var_4(arg_4_0._tf, "bg/mask")

	typeof = var_1_10005
	CanvasGroup = var_7
	arg_4_0.bannerCanvas = var_1_10002(var_4_2, var_1_10005(var_7))
	...
	local var_4_4 = var_4_0(var_4_1, "item")
	...
	for iter_4_0 = 0, #var_0_23 - 1 do
		...
		pg = var_1_10011
		var_0_24 = var_1_10011.furniture_data_template[var_0_23[iter_4_0 + 1]]
		var_0_25 = var_0_24.icon
		GetImageSpriteFromAtlasAsync = var_1_10011
		var_1_10013 = "ui/monopolyworldui_atlas"

		local var_4_7 = var_0_25

		findTF = var_1_10015

		var_1_10011(var_1_10013, var_4_7, var_1_10015(var_1_10010, "img"), true)

		var_1_10013 = var_4_1

		var_4_1.AddChild(var_1_10013, var_1_10010)

		setActive = var_1_10011

		var_1_10011(var_1_10010, true)

		table = var_1_10011

		var_1_10011.insert(arg_4_0.furnItems, var_1_10010)
	end
	...
	for iter_4_1 = 1, #var_0_23 do
		...
		var_1_10010(var_4_8, var_1_10013(arg_4_0._tf, "bg/furnName/img" .. iter_4_1))
	end
...
function var_0_0.initEvent(arg_6_0)
	...
	local function var_6_5()
		...
		pg = var_2_10004
		var_9_2.helps = var_2_10004.gametip.help_monopoly_world.tip
	...
	local function var_6_8()
		if not arg_6_0.inAnimatedFlag then
			...
			var_10_1(var_10_0, var_2_10003.ON_BACK)
		end
	...
	var_1_10001(var_6_9, var_6_10, var_6_11, var_6)
...
function var_0_0.showRollAnimated(arg_13_0, arg_13_1)
	...
	var_1_10002({
		function(arg_14_0)
			...
			local var_14_0 = var_3(arg_13_0.btnStart, "anim")

			typeof = var_4
			Animator = var_6

			local var_14_1 = var_2_10001(var_14_0, var_4(var_6))
			...
			var_14_2(var_14_3, var_4.Action(function()
			...
			var_14_4(var_14_5, var_4.Action(function()
				arg_14_0()
...
function var_0_0.checkCountStory(arg_18_0, arg_18_1)
	...
	if var_1_10005.detect(var_18_2, function(arg_19_0)
		return arg_19_0[1] == var_18_0
	end) then
		pg = var_18_1

		local var_18_3 = var_18_1.NewStoryMgr.GetInstance()
...
function var_0_0.changeAnimeState(arg_20_0, arg_20_1)
	if arg_20_1 then
		...
		typeof = var_1_10005
		Image = var_1_10007
		var_20_1(var_20_0, var_1_10005(var_1_10007)).raycastTarget = false
		...
		var_20_3(var_20_2, var_1_10005.LOCK_ACT_MAIN, true)
	else
		...
		typeof = var_1_10005
		Image = var_1_10007
		var_20_5(var_20_4, var_1_10005(var_1_10007)).raycastTarget = true
		...
		var_20_7(var_20_6, var_5.LOCK_ACT_MAIN, false)
	end
	...
	for iter_21_0 = 1, #var_21_0 do
		...
		for iter_21_1 = 1, #var_21_3 do
			...
			if 0 < var_21_5 then
				...
				local var_21_8 = var_15(var_21_6, var_21_7, var_1_10019(var_21_5))

				Vector2 = var_1_10016
				var_21_8.localPosition = var_1_10016(var_0_1 * var_21_4 + var_21_2.x, -var_0_2 * var_21_4 + var_21_2.y)
				pg = var_21_6

				local var_21_9 = var_21_6.activity_event_monopoly_map[var_21_5].icon

				GetSpriteFromAtlas = var_18

				local var_21_10 = var_18("ui/monopolyworldui_atlas", var_21_9)

				findTF = var_1_10019

				local var_21_11 = var_1_10019(var_21_8, "image")

				var_1_10019 = var_1_10019.GetComponent
				typeof = var_22
				Image = var_1_10024
				var_1_10019 = var_1_10019(var_21_11, var_22(var_1_10024))
				var_1_10019.sprite = var_21_10
				findTF = var_1_10019

				local var_21_12 = var_1_10019(var_21_8, "image")

				var_1_10019 = var_1_10019.GetComponent
				typeof = var_22
				Image = var_1_10024

				local var_21_13 = var_1_10019(var_21_12, var_22(var_1_10024))

				var_1_10019.SetNativeSize(var_21_13)
				...
				var_20.insert(arg_21_0.mapCells, var_1_10019)
			end
		end
	end
...
function var_0_0.initChar(arg_23_0)
	...
	var_1.GetSpineChar(var_23_0, var_0_4, true, function(arg_24_0)
		...
		var_24_3.anim = var_24_5(var_24_4, var_5(var_2_10007))
...
function var_0_0.updataCharDirect(arg_25_0, arg_25_1, arg_25_2)
	if arg_25_0.model then
		...
		if not arg_25_0.getMoveType(var_25_3, arg_25_0.mapCells[arg_25_1].mapId, arg_25_0.mapCells[var_25_1].mapId, arg_25_2) then
			var_25_4 = arg_25_0.char.localScale.x
		end

		local var_25_5 = arg_25_0.char

		Vector3 = var_25_3
		var_25_5.localScale = var_25_3(var_25_4, arg_25_0.char.localScale.y, arg_25_0.char.localScale.z)
	end
...
function var_0_0.checkCharActive(arg_27_0)
	if arg_27_0.anim then
		if arg_27_0.effectId and arg_27_0.effectId > 0 then
			var_1_10003 = arg_27_0

			arg_27_0.changeAnimeState(var_1_10003, true)

			var_1_10003 = arg_27_0

			arg_27_0.checkEffect(var_1_10003, function()
		...
		elseif arg_27_0.step and arg_27_0.step > 0 then
			...
			arg_27_0.checkStep(var_1_10003, function()
		...
		elseif arg_27_0.activity then
			...
			arg_27_0.activity = var_1.getActivityById(var_27_0, arg_27_0.activity.id)
...
function var_0_0.activityDataUpdata(arg_32_0, arg_32_1)
	...
	local var_32_3 = var_32_0.ceil((var_32_1 - var_32_2) / 0)
	...
	arg_32_0.advanceTotalCnt = #arg_32_1.getDataConfig(var_32_6, "reward")
	arg_32_0.isAdvanceRp = arg_32_0.advanceTotalCnt - var_32_5 > 0
	arg_32_0.leftAwardCnt = arg_32_0.activity.data2_list[1] - var_32_5
	math = var_10

	local var_32_7 = var_10.max
	local var_32_8 = 0

	math = var_1_10013
	arg_32_0.advanceRpCount = var_32_7(var_32_8, var_1_10013.min(var_9, arg_32_0.advanceTotalCnt) - var_32_5)
	math = var_10

	local var_32_9 = var_10.max(0, var_9 - arg_32_0.advanceTotalCnt)

	math = var_32_6
	arg_32_0.commonRpCount = var_32_9 - var_32_6.max(0, var_32_5 - arg_32_0.advanceTotalCnt)
...
function var_0_0.checkStep(arg_33_0, arg_33_1)
	if arg_33_0.step > 0 then
		...
		MonopolyWorldScene = var_1_10005

		var_33_1(var_33_0, var_1_10005.ON_MOVE, arg_33_0.activity.id, function(arg_34_0, arg_34_1, arg_34_2)
			...
			var_34_0({
				...
				function(arg_36_0)
					...
					if arg_34_1 and #arg_34_1 > 0 and arg_33_0.pos == 1 then
						...
						local var_36_1 = var_3_10003(arg_33_0._tf, "topRight/times")

						tostring = var_3_10004

						var_36_0(var_36_1, var_3_10004(arg_33_0.turnCnt))
					...
					if var_36_0(arg_33_0.effectStart) then
						...
						var_36_5(var_36_6, var_4.Action(function()
...
function var_0_0.updataUI(arg_40_0)
	...
	if arg_40_0.turnCnt and arg_40_0.turnCnt < #var_0_23 then
		...
		var_2(var_40_2, var_1_10005(var_0_6, var_40_1, 1))
	else
		setText = var_2
		var_40_2 = arg_40_0.gameTipUI2
		i18n = var_1_10005

		var_2(var_40_2, var_1_10005(var_0_7, var_40_1))
	end
	...
	if arg_40_0.leftCount and arg_40_0.leftCount > 0 then
		...
		var_2(var_40_2(arg_40_0.btnStart, "img3"), true)

		setActive = var_2
		findTF = var_40_2

		var_2(var_40_2(arg_40_0.btnStart, "img4"), false)
	else
		setActive = var_2
		findTF = var_40_2

		var_2(var_40_2(arg_40_0.btnStart, "img3"), false)

		setActive = var_2
		findTF = var_40_2

		var_2(var_40_2(arg_40_0.btnStart, "img4"), true)
	end

	setText = var_2
	findTF = var_40_2

	local var_40_3 = var_40_2(arg_40_0._tf, "topRight/times")

	tostring = var_1_10005

	var_2(var_40_3, var_1_10005(arg_40_0.turnCnt))
	...
	for iter_40_0 = 1, #arg_40_0.furnItems do
		if iter_40_0 <= arg_40_0.turnCnt then
			...
			var_6(var_1_10008(arg_40_0.furnItems[iter_40_0], "got"), true)
		else
			setActive = var_6
			findTF = var_1_10008

			var_6(var_1_10008(arg_40_0.furnItems[iter_40_0], "got"), false)
		end
	end
	...
	if arg_40_0.bannerSnap.StartingScreen == 0 and not arg_40_0.bannerInit then
		...
		var_40_4 = arg_40_0.bannerSnap

		if var_2.CurrentScreen(var_40_4) ~= arg_40_0.turnCnt and arg_40_0.turnCnt < #var_0_23 then
			local var_40_5 = arg_40_0.turnCnt % 5
			local var_40_6 = arg_40_0.bannerSnap
			local var_40_7 = var_40_5 - var_3.CurrentScreen(var_40_6)
			local var_40_8 = 1

			math = var_40_4

			for iter_40_1 = var_40_8, var_40_4.abs(var_40_7) do
				math = var_7

				if var_7.sign(var_40_7) > 0 then
					local var_40_9 = arg_40_0.bannerSnap

					var_7.NextScreen(var_40_9, true)
				else
					local var_40_10 = arg_40_0.bannerSnap

					var_7.PreviousScreen(var_40_10, true)
				end
			end
		end
	end
	...
	if arg_40_0.turnCnt >= #var_0_23 then
		...
		if arg_40_0.bannerCanvas.blocksRaycasts ~= true then
			var_40_11 = arg_40_0.bannerCanvas
			var_40_11.blocksRaycasts = true
		end

		isActive = var_40_11
		findTF = var_40_4

		if not var_40_11(var_40_4(arg_40_0._tf, "bg/dots")) then
			var_40_4 = arg_40_0.bannerSnap

			var_2.NextScreen(var_40_4, true)

			setActive = var_2
			findTF = var_40_4

			var_2(var_40_4(arg_40_0._tf, "bg/dots"), true)
		end
	else
		local var_40_12

		if arg_40_0.bannerCanvas.blocksRaycasts == true then
			var_40_12 = arg_40_0.bannerCanvas
			var_40_12.blocksRaycasts = false
		end

		isActive = var_40_12
		findTF = var_40_4

		if var_40_12(var_40_4(arg_40_0._tf, "bg/dots")) then
			setActive = var_2
			findTF = var_4

			var_2(var_4(arg_40_0._tf, "bg/dots"), false)
		end
	end
...
function var_0_0.checkEffect(arg_43_0, arg_43_1)
	if arg_43_0.effectId > 0 then
		...
		local var_43_2, var_43_3 = arg_43_0.getActionName(var_43_1, var_43_0.icon)

		pg = var_43_1

		local var_43_4 = var_43_1.activity_event_monopoly_event[arg_43_0.effectId].story
		...
		var_6({
			function(arg_44_0)
				if var_43_2 then
					...
					var_1.changeCharAction(var_44_0, var_43_2, 1, function()
				...
				if var_43_3 then
					...
					if var_1.getEffectTf(var_44_1, var_43_3) then
						Vector2 = var_2_10002
						var_1.anchoredPosition = var_2_10002(var_43_0.position.x, var_43_0.position.y)
						setActive = var_2
				...
				if not var_43_2 and not var_43_3 then
					arg_44_0()
				elseif not var_43_2 and var_43_3 then
					LeanTween = var_1
					...
					var_44_2(var_44_3, var_2_10004.Action(function()
						arg_44_0()
			...
			function(arg_47_0)
				if var_43_4 then
					...
					if var_1(var_43_4) ~= 0 then
						pg = var_1

						local var_47_0 = var_1.NewStoryMgr.GetInstance()

						var_1.Play(var_47_0, var_43_4, arg_47_0, true, true)
...
function var_0_0.triggerEfeect(arg_51_0, arg_51_1)
	...
	var_51_1(var_51_0, var_1_10005.ON_TRIGGER, arg_51_0.activity.id, function(arg_52_0, arg_52_1)
		if arg_52_0 and #arg_52_0 >= 0 then
			...
			local var_52_2 = var_2.getEffectTf(var_52_1, var_0_18, #arg_52_0)
			...
			var_3({
				function(arg_53_0)
					if var_52_2 then
						...
						var_1(var_52_2, false)

						setActive = var_1

						var_1(var_52_2, true)

						local var_53_0 = var_52_2
						...
						var_53_1(var_53_2, var_4.Action(function()
							arg_53_0()
...
function var_0_0.changeBg(arg_57_0)
	...
	for iter_57_0 = 1, 5 do
		...
		local var_57_2 = var_1_10007(var_57_1, var_10(var_1_10012)).color.a

		if iter_57_0 == var_57_0 then
			if var_57_2 ~= 1 then
				LeanTween = var_57_1

				var_57_1.alpha(var_1_10006, 1, 0.5)
			end
		elseif var_57_2 ~= 0 then
			LeanTween = var_57_1

			var_57_1.alpha(var_1_10006, 0, 0.5)
		end
	end
...
function var_0_0.toMoveCar(arg_58_0)
	...
	local var_58_1 = var_1_10002.abs(arg_58_0.targetPosition.y - arg_58_0.char.localPosition.y)
	...
	if not (var_4.abs(arg_58_0.baseSpeedX) < var_58_2) or not arg_58_0.baseSpeedX then
...
function var_0_0.moveCharWithPaths(arg_60_0, arg_60_1, arg_60_2, arg_60_3)
	...
	for iter_60_0 = 1, #arg_60_1 do
		...
		var_11.insert(var_60_0, function(arg_61_0)
			...
			local var_61_5 = var_61_4(var_4(arg_60_0.char), var_60_2.tf.localPosition, var_61_3)
			local var_61_6 = var_2.setEase

			LeanTweenType = var_5

			local var_61_7 = var_61_6(var_61_5, var_5.linear)
			local var_61_8 = var_2.setOnComplete

			System = var_5

			var_61_8(var_61_7, var_5.Action(function()
				if arg_60_2 == var_0_14 then
					...
					var_62_0(var_62_1, var_3_10003.Action(function()
						arg_61_0()
...
function var_0_0.dispose(arg_68_0)
	...
	for iter_68_0 = 1, 5 do
		...
		if var_1_10006.isTweening(var_1_10005) then
			LeanTween = var_1_10006

			var_1_10006.cancel(var_1_10005)
		end
	end
