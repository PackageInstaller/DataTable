...
function var_0_1.didEnter(arg_3_0)
	...
	var_1(var_3_0, var_1_10004(var_1_10006(#arg_3_0.activeIDList), "#8CD5FFFF") .. "/" .. #arg_3_0.allIDList)
...
function var_0_1.willExit(arg_4_0)
	...
	if var_4_0(var_1_10003(arg_4_0.photo)) then
		LeanTween = var_1
		...
		var_4_1(var_3(arg_4_0.photo), false)
	end
...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.activityData = var_5_1(var_5_0, var_1_10004.IDOL_MASTER_MEDAL_ID)
...
function var_0_1.findUI(arg_6_0)
	...
	findTF = var_6_1
	arg_6_0.tplButtom = var_6_1(var_6_4, "tplButtom")
	...
	for iter_6_0 = 1, var_0_1.PAGE_NUM do
		...
		go = var_1_10011
		var_1_10007 = var_1_10007(var_1_10009(var_1_10011(arg_6_0.tplButtom)))
		...
		var_1_10008("ui/idolmastermedalcollectionui_atlas", "icon" .. iter_6_0, function(arg_7_0)
			if var_1_10007 then
				...
				var_1(var_2_10003(var_1_10007, "icon"), arg_7_0, true)
			end
		...
		var_1_10008("ui/idolmastermedalcollectionui_atlas", "iconSelect" .. iter_6_0, function(arg_8_0)
			if var_1_10007 then
				...
				var_1(var_2_10003(var_1_10007, "iconSelect"), arg_8_0, true)
			end
...
function var_0_1.addListener(arg_9_0)
	...
	local function var_9_5()
		...
		pg = var_2_10004
		var_11_2.helps = var_2_10004.gametip.idolmaster_collection.tip
	...
	for iter_9_0, iter_9_1 in var_1_10001(arg_9_0.switchBtnList) do
		...
		var_1_10006(var_9_6, var_9_7, var_9_8, var_1_10011)
	end
...
function var_0_1.getMedalStatus(arg_15_0, arg_15_1)
	...
	if var_1_10003.contains(arg_15_0.activatableIDList, arg_15_1) then
...
function var_0_1.updatePhotoNode(arg_16_0, arg_16_1, arg_16_2)
	...
	if var_16_6 == var_0_1.MEDAL_STATUS_ACTIVATED then
		if arg_16_2 then
			...
			var_8("ui/idolmastermedalcollectionui_atlas", "photo" .. arg_16_0.curPage, function(arg_18_0)
				...
				if var_18_0(var_3(arg_16_0.photo)) then
					LeanTween = var_18_1
					var_18_1 = var_18_1.cancel
					go = var_3

					var_18_1(var_3(arg_16_0.photo), false)
				end
				...
				local var_18_3 = var_18_1(var_18_2, var_4(var_2_10006))
				...
				local var_18_5 = var_18_4(var_18_2(arg_16_0.photo), 0, 1, 0.3)
				local var_18_6 = var_1.setOnUpdate

				System = var_4

				var_18_6(var_18_5, var_4.Action_float(function(arg_19_0)
					...
					var_3_10001(var_19_0, var_3_10004(var_3_10006)).alpha = arg_19_0
	...
	if var_16_6 == var_0_1.MEDAL_STATUS_ACTIVATABLE then
		...
		local function var_16_10()
			...
			var_21_1(var_21_0, var_2_10003.MEMORYBOOK_UNLOCK, {
				id = arg_16_1,
		...
		var_8(var_16_8, var_16_9, var_16_10, var_1_10013)
	end
...
function var_0_1.updateInfoNode(arg_22_0, arg_22_1)
	...
	if var_22_6 == var_0_1.MEDAL_STATUS_ACTIVATABLE then
		...
		local function var_22_10()
			...
			var_25_1(var_25_0, var_2_10003.MEMORYBOOK_UNLOCK, {
				id = arg_22_1,
		...
		var_7(var_22_8, var_22_9, var_22_10, var_1_10012)
	end
...
function var_0_1.updateSwitchBtnTF(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1_10001(arg_26_0.switchBtnList) do
		...
		local var_26_1 = iter_26_1.Find(var_26_0, "tip")
		local var_26_2 = arg_26_0

		if arg_26_0.caculateActivatable(var_26_2, iter_26_0) == 0 or iter_26_0 == arg_26_0.curPage then
			setActive = var_26_0
		...
		local var_26_3 = iter_26_0 == arg_26_0.curPage

		setActive = var_26_2

		var_26_2(iter_26_1:Find("icon"), not var_26_3)

		setActive = var_26_2

		var_26_2(iter_26_1:Find("iconSelect"), var_26_3)
	end
...
function var_0_1.updateAfterSubmit(arg_27_0, arg_27_1)
	...
	arg_27_0.activityProxy = var_1_10002(var_1_10004)

	local var_27_0 = arg_27_0.activityProxy
	local var_27_1 = var_2.getActivityById

	ActivityConst = var_1_10005
	arg_27_0.activityData = var_27_1(var_27_0, var_1_10005.IDOL_MASTER_MEDAL_ID)
	...
	local var_27_3 = var_1_10007(#arg_27_0.activeIDList)

	COLOR_WHITE = var_1_10008

	var_2(var_27_2, var_5(var_27_3, var_1_10008) .. "/" .. #arg_27_0.allIDList)
	arg_27_0:checkAward()
...
function var_0_1.caculateActivatable(arg_28_0, arg_28_1)
	...
	for iter_28_0, iter_28_1 in var_1_10004(var_28_0) do
		...
		table = var_1_10010
		var_1_10010 = var_1_10010.contains(arg_28_0.activatableIDList, iter_28_1)
...
function var_0_1.checkAward(arg_29_0)
	...
	if #arg_29_0.activeIDList == #arg_29_0.allIDList and arg_29_0.activityData.data1 ~= 1 then
		...
		local var_29_2 = var_4.ACTIVITY_OPERATION
		local var_29_3 = {
			cmd = 1
		}

		ActivityConst = var_1_10006
		var_29_3.activity_id = var_1_10006.IDOL_MASTER_MEDAL_ID
