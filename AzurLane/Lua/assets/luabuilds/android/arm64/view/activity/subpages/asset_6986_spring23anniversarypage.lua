...
function var_0_1.findUI(arg_2_0)
	...
	for iter_2_3 = 1, var_2_5 * 3 do
		...
		if var_1_10006.contains(arg_2_0.hideIndex, (iter_2_3 - 1) % var_0_6 + 1) or not arg_2_0.scrollAble and var_0_6 < iter_2_3 then
			...
			var_1_10006(var_8.GetChild(var_2_12, iter_2_3 - 1), false)
		end
	end
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	var_1(arg_7_0, arg_7_0.btnGo, function()
		...
		var_9_1(var_9_0, var_9_2, var_2_10004.SPRING_FESTIVAL_BACKHILL_2023)
...
function var_0_1.initBtnEvent(arg_12_0, arg_12_1, arg_12_2)
	if arg_12_2 == 1 then
		...
		local function var_12_2()
			...
			var_13_1(var_13_0, var_2_10003.GO_PRAY_POOL)
	...
	elseif arg_12_2 == 2 then
		...
		local function var_12_5()
			...
			var_14_1(var_14_0, var_14_2, var_2_10004.ACTIVITY_TYPE_RETURN_AWARD_ID5)
		...
		var_1_10003(var_12_3, var_12_4, var_12_5, var_1_10008)
	elseif arg_12_2 == 3 then
		...
		local function var_12_8()
			...
			var_15_1(var_15_0, var_2_10003.EVENT_GO_SCENE, var_0_7)
		...
		var_1_10003(var_12_6, var_12_7, var_12_8, var_1_10008)
	elseif arg_12_2 == 4 then
		...
		local function var_12_11()
			...
			var_16_1(var_16_0, var_2_10003.GO_MINI_GAME, var_0_2)
		...
		var_1_10003(var_12_9, var_12_10, var_12_11, var_1_10008)
	elseif arg_12_2 == 5 then
		...
		local function var_12_14()
			...
			var_17_1(var_17_0, var_17_2, var_2_10004.SUMMARY)
		...
		var_1_10003(var_12_12, var_12_13, var_12_14, var_1_10008)
	elseif arg_12_2 == 6 then
		...
		local function var_12_17()
			...
			local var_18_3 = var_2_10004.CHARGE
			local var_18_4 = {}

			ChargeScene = var_2_10006
			var_18_4.wrap = var_2_10006.TYPE_DIAMOND
		...
		var_1_10003(var_12_15, var_12_16, var_12_17, var_1_10008)
	end
...
function var_0_1.OnDestroy(arg_22_0)
	...
	if var_22_0(var_1_10003(arg_22_0.paintFrontTF)) then
		LeanTween = var_1
		...
		var_22_1(var_3(arg_22_0.paintFrontTF))
	end
