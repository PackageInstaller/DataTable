...
function var_0_1.init(arg_2_0)
	...
	arg_2_0._stageShip = var_1.Find(var_2_4, "stageship")
	...
	local var_2_9 = arg_2_0.upper_model

	arg_2_0.modelTip = var_1.Find(var_2_9, "tip")
	setActive = var_1
	...
	arg_2_0._middle = var_1.Find(var_2_10, "middle")
	arg_2_0.containers = {
		arg_2_0._middle
	}
	GraphPath = var_1
	...
	import = var_2_10
	arg_2_0.graphPath = var_2_11(var_2_10("GameCfg.BackHillGraphs.MusicFestivalGraph2"))

	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_1.GetComponentInParent

	typeof = var_4
	UnityEngine = var_1_10006

	local var_2_14 = var_2_13(var_2_12, var_4(var_1_10006.Canvas)) and var_1.sortingOrder
	...
	local var_2_17 = var_2_16(var_2_15, var_6(var_1_10008.Canvas))

	var_2_17.sortingOrder = var_2_14 - 2
	AutoLoader = var_2_17
	arg_2_0.loader = var_2_17.New()
...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_8 = var_3_7(var_3_6, var_4.MUSIC_FESTIVAL_ID_2)
	...
	var_2(arg_3_0, arg_3_0.upper_model, function()
		...
		var_7_1(var_7_0, var_7_2, var_2_10004.ACTIVITY, {
			id = var_3_8.id
		})
	...
	arg_3_0.InitFacilityCross(var_3_9, arg_3_0._map, arg_3_0._upper, "jichangwutai", function()
		...
		var_8_1(var_8_0, var_2_10003.GO_MINI_GAME, 16)
	...
	local var_3_12 = var_3_11(var_3_10, var_5.ACTIVITY_TYPE_PT_BUFF)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "leijipt", function()
		...
		var_9_1(var_9_0, var_9_2, var_2_10004.ACTIVITY, {
			id = var_3_12.id
		})
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "jinianzhang", function()
		...
		var_13_1.mediator = var_2_10003
		IdolMedalCollectionView2 = var_2_10003
		var_13_1.viewComponent = var_2_10003
		...
		var_13_4(var_13_3, var_2_10004.GO_SUBLAYER, var_13_2)
...
function var_0_1.UpdateView(arg_14_0)
	...
	local var_14_4 = var_14_3(var_14_2, var_1_10006.MUSIC_FESTIVAL_ID_2)

	getProxy = var_1_10004
	MiniGameProxy = var_6

	local var_14_5 = var_1_10004(var_6)
	local var_14_6 = var_4.GetHubByHubId(var_14_5, var_14_4:getConfig("config_id")).count
	local var_14_7 = 0 < var_14_6
	local var_14_8 = arg_14_0.upper_jichangwutai
	local var_14_9 = var_6.Find(var_14_8, "tip")

	setActive = var_7

	var_7(var_14_9, var_14_7)

	local var_14_10 = var_5.usedtime >= var_5:getConfig("reward_need") and var_5.ultimate == 0

	setActive = var_7

	var_7(arg_14_0.modelTip, var_14_10)

	local var_14_11 = var_14_0
	local var_14_12 = var_14_0.getActivityByType

	ActivityConst = var_10

	local var_14_13 = var_14_12(var_14_11, var_10.ACTIVITY_TYPE_PT_BUFF)
	local var_14_14 = arg_14_0.upper_leijipt
	local var_14_15 = var_8.Find(var_14_14, "tip")
	local var_14_16 = var_14_13:readyToAchieve()

	setActive = var_9

	var_9(var_14_15, var_14_16)

	local var_14_17 = arg_14_0.upper_jinianzhang
	local var_14_18 = var_9.Find(var_14_17, "tip")
	local var_14_19 = var_0_1.MedalTip()

	setActive = var_10

	var_10(var_14_18, var_14_19)
...
function var_0_1.getStageShip(arg_15_0)
	...
	if not var_15_2(var_15_1, var_1_10005.MUSIC_FESTIVAL_ID_2) then
		return
	end
	...
	if var_2:getConfig("config_client") and var_3.stage_on_ship then
		...
		return var_4[var_6.random(1, var_15_3)], var_4.action[1]
	end
...
function var_0_1.updateStageShip(arg_16_0)
	...
	var_3.GetSpine(var_16_2, var_16_0, function(arg_17_0)
		...
		var_17_1(var_17_0, var_2_10004(0.63, 0.63, 1))
...
function var_0_1.getStudents(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_1 = var_1_10004(var_1_10006)
	...
	if var_5:getConfig("config_client") then
		var_18_2 = var_18_2.stage_off_ship
	end
	...
	if var_18_2 then
		...
		local var_18_4 = var_7.random(arg_18_1, arg_18_2)
		local var_18_5 = #var_18_3

		while var_18_4 > 0 and 0 < var_18_5 do
			math = var_18_6

			local var_18_6 = var_18_6.random(1, var_18_5)

			table = var_10

			var_10.insert(var_18_0, var_18_3[var_18_6])
...
function var_0_1.MedalTip()
	...
	local var_19_2 = var_19_1(var_19_0, var_1_10003.ACTIVITY_TYPE_PUZZLA)

	Activity = var_1_10001

	return var_1_10001.IsActivityReady(var_19_2)
end
...
function var_0_1.IsShowMainTip(arg_20_0)
	...
	local var_20_2 = var_20_1(var_20_0, var_1_10005.MUSIC_FESTIVAL_ID_2)

	assert = var_1_10003

	var_1_10003(var_20_2)
	...
	local function var_20_3()
		...
		return var_21_1(var_21_0, var_2_10003.ACTIVITY_TYPE_PT_BUFF) and not var_0:isEnd() and var_0:readyToAchieve()
	end
	...
	local function var_20_5()
		...
		return var_22_1(var_22_0, var_3.getConfig(var_22_2, "config_id")).usedtime >= var_0:getConfig("reward_need") and var_0.ultimate == 0
	end
	...
	local function var_20_6()
		...
		return var_23_1(var_23_0, var_3.getConfig(var_23_2, "config_id")).count > 0
	end
