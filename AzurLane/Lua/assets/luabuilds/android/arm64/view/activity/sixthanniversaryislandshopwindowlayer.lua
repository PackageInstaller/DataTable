...
function var_0_1.setGoods(arg_2_0, arg_2_1)
	...
	arg_2_0.max = var_2_1(var_4.getOwnedCount(var_2_2) / arg_2_0.singleCost)
	...
	if arg_2_1:getConfig("num_limit") ~= 0 then
		...
		math = var_5
		arg_2_0.max = var_2_3(var_2_4, var_5.max(arg_2_1:GetPurchasableCnt(), 0))
	end
...
function var_0_1.init(arg_3_0)
	...
	local var_3_3 = var_3_2:Find("cost/Text")
	...
	local function var_3_35()
		...
		SixthAnniversaryIslandShopWindowMediator = var_2_10003
