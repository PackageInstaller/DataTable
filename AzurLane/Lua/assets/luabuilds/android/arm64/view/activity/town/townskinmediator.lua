...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	local var_3_3 = arg_3_1.getBody(var_3_2)

	GAME = var_3_0

	if var_3_1 == var_3_0.ACTIVITY_STORYUNLOCKED_DONE then
		local var_3_4 = arg_3_0.viewComponent

		var_4.UpdataStoryState(var_3_4, var_3_3)
	else
		ActivityProxy = var_4

		if var_3_1 == var_4.ACTIVITY_UPDATED then
			local var_3_5 = var_3_3:getConfig("type")

			ActivityConst = var_3_2

			if var_3_5 == var_3_2.ACTIVITY_TYPE_TownSkinStory then
				local var_3_6 = arg_3_0.viewComponent

				var_4.UpdateItemView(var_3_6, var_3_3)
			end
		end
	end
