...
function var_0_1.OnUpdateFlush(arg_1_0)
	...
	COLOR_WHITE = var_1_10013

	var_1_10007(var_1_8, var_1_10010(var_1_9, var_1_10013) .. "/" .. var_1_2)
	...
	if 1 <= var_1_7 then
		...
		if not var_1_13(var_1_11, var_1_10013) then
			setColorStr = var_1_13

			local var_1_12 = var_1_5

			COLOR_WHITE = var_1_10013
			var_1_13 = var_1_13(var_1_12, var_1_10013)
		end
