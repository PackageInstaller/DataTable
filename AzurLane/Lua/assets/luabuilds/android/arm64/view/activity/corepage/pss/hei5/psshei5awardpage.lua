...
function var_0_1.OnLoaded(arg_4_0)
	...
	local var_4_3 = var_4.Find(var_4_2, "Text")

	i18n = var_5

	var_2(var_4_3, var_5(arg_4_0.btnAllTip))
	...
	function arg_4_0.scrollCom.onUpdateItem(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_5_2, var_2_10006(arg_5_1), arg_4_0.awardList[arg_5_0 + 1])
...
function var_0_1.Flush(arg_9_0, arg_9_1)
	...
	local var_9_5 = var_5.Find(var_9_4, "Text")
	...
	if var_9_3 then
		...
		if not var_9_6.NewHex("#ffffff") then
			Color = var_9_6
			var_9_6 = var_9_6.NewHex("#7df39f")
		end

		var_3(var_9_5, var_9_6)
...
function var_0_1.BuildPhaseAwardScrollPos(arg_10_0)
	...
	for iter_10_0 = 1, #arg_10_0.awardList - 1 do
		...
		var_1_10007(var_10_8, var_10.HeadIndexToValue(var_10_9, iter_10_0 - 1) / var_10_3)
		...
		var_1_10007(var_10_10, var_10.HeadIndexToValue(var_10_11, iter_10_0 - 1) / var_10_7)
	end
...
function var_0_1.UpdateAwardInfo(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	cancelColorRich = var_1_10006
	var_12_1.desc = var_1_10006(var_12_1.desc)
	onButton = var_6

	local var_12_2 = arg_12_0
	local var_12_3 = arg_12_2
	local var_12_4 = arg_12_2.Find(var_12_3, "base")
	...
	local function var_12_5()
		...
		var_13_1(var_13_0, var_2_10003.ON_NEW_STYLE_DROP, {
			drop = var_12_1
		})
	...
	SFX_CONFIRM = var_12_3

	var_6(var_12_2, var_12_4, var_12_5, var_12_3)
	...
	local var_12_6 = var_6.Create(arg_12_3.award_pay)

	onButton = var_7

	local var_12_7 = arg_12_0
	local var_12_8 = arg_12_2
	local var_12_9 = arg_12_2.Find(var_12_8, "pay")
	...
	local function var_12_10()
		...
		var_14_1(var_14_0, var_2_10003.ON_NEW_STYLE_DROP, {
			drop = var_12_6
		})
	...
	SFX_CONFIRM = var_12_8

	var_7(var_12_7, var_12_9, var_12_10, var_12_8)

	updateDrop = var_7

	var_7(arg_12_2:Find("pay/mask/IconTpl"), var_12_6)

	setActive = var_7

	var_7(arg_12_2:Find("pay/no_pay"), not arg_12_0.isPay and not arg_12_0:IsSpecialMask(var_12_6.type))

	setActive = var_7

	local var_12_11 = arg_12_2:Find("pay/get")
	local var_12_12

	if arg_12_0.isPay then
		var_12_12 = var_12_0 and not arg_12_0.awardPayDic[arg_12_3.pt]
	end

	var_7(var_12_11, var_12_12)
	...
	if #var_1.GetHei5UnreceiveAward(var_16_0) > 0 then
		...
		if arg_16_0:CheckLimitMax(var_1) then
			...
			var_3.insert(var_16_1, function(arg_17_0)
				...
				i18n = var_2_10006
				var_17_3.contentText = var_2_10006("player_expResource_mail_fullBag")
		...
		var_3(var_16_1, function()
			...
			var_18_1(var_18_0, var_2_10003.EVENT_GET_AWARD_ALL)
...
function var_0_1.CheckLimitMax(arg_19_0, arg_19_1)
	...
	for iter_19_0, iter_19_1 in var_1_10003(arg_19_1) do
		...
		if var_19_2 == var_1_10009 then
			if iter_19_1.id == 1 then
				if var_19_1:GoldMax(iter_19_1.count) then
					pg = var_8

					local var_19_3 = var_8.TipsMgr.GetInstance()
					local var_19_4 = var_8.ShowTips

					i18n = var_1_10011

					var_19_4(var_19_3, var_1_10011("gold_max_tip_title"))

					return true
				end
			elseif iter_19_1.id == 2 and var_19_1:OilMax(iter_19_1.count) then
				pg = var_8

				local var_19_5 = var_8.TipsMgr.GetInstance()
				local var_19_6 = var_8.ShowTips

				i18n = var_1_10011

				var_19_6(var_19_5, var_1_10011("oil_max_tip_title"))
			...
			if var_19_7 == var_1_10009 then
				Item = var_19_7
				var_1_10009 = var_19_7.getConfigData(iter_19_1.id).type
				Item = var_10
				...
				if var_1_10009 == var_10.EXP_BOOK_TYPE then
					...
					if var_1_10009.getItemCountById(var_1_10011, iter_19_1.id) + iter_19_1.count > var_8.max_num then
						return true
					end
				end
			end
