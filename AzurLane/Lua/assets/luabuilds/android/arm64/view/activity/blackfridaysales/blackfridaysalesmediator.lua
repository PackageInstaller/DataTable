...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.CHARGE, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_2_10005.CHARGE_OPERATION, {
			shopId = arg_8_1
		})
...
function var_0_1.handleNotification(arg_11_0, arg_11_1)
	...
	if var_11_1 == var_11_0.SUBMIT_ACTIVITY_TASK_DONE then
		local var_11_3 = arg_11_0.viewComponent

		var_11_4 = var_11_4.emit
		BaseUI = var_1_10007

		var_11_4(var_11_3, var_1_10007.ON_AWARD, {
		...
		var_11_4(var_11_5, var_1_10007.ON_ACHIEVE, var_11_2, function()
		...
		if var_11_1 == var_11_4.UPDATED then
			...
			if var_11_1 == var_4.SHOPPING_DONE then
				if #var_11_2.awards > 0 then
					...
					var_11_8(var_11_7, var_1_10007.ON_ACHIEVE, var_11_2.awards)
				end
				...
				if var_11_1 == var_11_8.NEW_SERVER_SHOP_SHOPPING_DONE then
					if #var_11_2.awards > 0 then
						...
						var_11_11(var_11_10, var_1_10007.ON_ACHIEVE, var_11_2.awards)
					end
					...
					if var_11_1 == var_11_11.CHARGE_SUCCESS then
						Goods = var_4
						...
						local var_11_16 = var_11_14(var_11_15, var_7.TYPE_CHARGE)
