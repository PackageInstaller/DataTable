...
function var_0_1.register(arg_1_0)
	...
	local var_1_3 = var_1_2(var_1_1, var_4.TowerClimbingGameID)
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_1 == var_4_0.SEND_MINI_GAME_OP_DONE and var_4_3.hubid == 9 then
		local var_4_4 = var_4_3.cmd

		MiniGameOPCommand = var_4_2

		if var_4_4 == var_4_2.CMD_SPECIAL_GAME then
			local var_4_5 = var_4_3.argList[1]

			MiniGameDataCreator = var_5

			if var_4_5 == var_5.TowerClimbingGameID and var_4_3.argList[2] == 2 then
				getProxy = var_4
				MiniGameProxy = var_1_10006

				local var_4_6 = var_4(var_1_10006)
				local var_4_7 = var_4.GetMiniGameData

				MiniGameDataCreator = var_1_10007

				local var_4_8 = var_4_7(var_4_6, var_1_10007.TowerClimbingGameID)
				local var_4_9 = arg_4_0.viewComponent

				var_5.SetData(var_4_9, var_4_8)

				local var_4_10 = arg_4_0.viewComponent

				var_5.OpenBook(var_4_10, var_4_3.argList[3])

				local var_4_11 = arg_4_0.viewComponent

				var_5.UpdateTip(var_4_11)
			end
		end
	end
