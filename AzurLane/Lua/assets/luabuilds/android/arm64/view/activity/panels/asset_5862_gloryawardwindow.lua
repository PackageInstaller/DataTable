...
local function var_0_2(arg_1_0)
	...
	var_3.make(var_1_2, function(arg_2_0, arg_2_1, arg_2_2)
		...
		if arg_2_0 == var_2_10003.EventUpdate then
			...
			var_2_10005(arg_2_2:Find("title/Text"), "PHASE " .. arg_2_1 + 1)

			setText = var_2_10005

			var_2_10005(arg_2_2:Find("target/title"), var_2_2:getConfig("desc"))

			setText = var_2_10005

			var_2_10005(arg_2_2:Find("target/Text"), "")
			...
			local var_2_7 = arg_2_2.Find(var_2_6, "award")
			...
			local function var_2_8()
				...
				var_3_1(var_3_0, var_3_10003.ON_DROP, var_2_4)
			...
			var_7(var_2_5, var_2_7, var_2_8, var_2_6)
...
function var_0_1.Show(arg_4_0, arg_4_1)
	...
	i18n = var_1_10006
	var_4_2.text = var_3(var_4_3, var_1_10006("pass_times"))
	setActive = var_4_2
