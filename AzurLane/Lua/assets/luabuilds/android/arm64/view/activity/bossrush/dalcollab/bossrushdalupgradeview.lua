...
function var_0_1.UpdateView(arg_4_0)
	...
	for iter_4_2, iter_4_3 in var_2(var_4_4) do
		...
		var_1_10008(var_4_7, var_11.GetBuildingConfigTable(var_4_8, iter_4_3).name)
	end
...
function var_0_1.OnLoaded(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10002(var_6_1) do
		...
		var_1_10007 = var_1_10007.Find(var_6_2, "Panel/upgrade_" .. iter_6_1)
		onButton = var_1_10008

		var_1_10008(arg_6_0, var_1_10007, function()
		...
		local var_6_3 = arg_6_0._upgradeActivity

		var_1_10008 = var_1_10008 .. var_9.GetBuildingLevel(var_6_3, iter_6_1) - 1
		setText = var_9

		var_9(var_1_10007:Find("unselected/level"), var_1_10008)

		setText = var_9

		var_9(var_1_10007:Find("selected/level"), var_1_10008)

		setText = var_9

		local var_6_4 = var_1_10007:Find("mask/name")
		local var_6_5 = arg_6_0._upgradeActivity

		var_9(var_6_4, var_12.GetBuildingConfigTable(var_6_5, iter_6_1).name)

		arg_6_0._upgradeList[iter_6_1] = var_1_10007
	end

	local var_6_6 = arg_6_0._tf

	arg_6_0._upgradeDetailView = var_2.Find(var_6_6, "UpgradePage")

	local var_6_7 = arg_6_0._upgradeDetailView

	arg_6_0._upgradeDetailCurrentName = var_2.Find(var_6_7, "page/skill/name")

	local var_6_8 = arg_6_0._upgradeDetailView

	arg_6_0._upgradeDetailLevel = var_2.Find(var_6_8, "page/skill/level")

	local var_6_9 = arg_6_0._upgradeDetailView

	arg_6_0._upgradeDetailIcon = var_2.Find(var_6_9, "page/skill/icon")
	arg_6_0._upgradeDetailList = {}

	for iter_6_2 = 1, 3 do
		local var_6_10 = arg_6_0._upgradeDetailView
		local var_6_11 = var_6.Find(var_6_10, "page/upgrade_list/skill_detail_" .. iter_6_2)

		setText = var_1_10007

		var_1_10007(var_6_11:Find("active/level"), "LV." .. iter_6_2)

		setText = var_1_10007

		local var_6_12 = var_6_11:Find("active/active")

		i18n = var_10

		var_1_10007(var_6_12, var_10("DAL_upgrade_active"))

		setText = var_1_10007

		var_1_10007(var_6_11:Find("disable/level"), "LV." .. iter_6_2)

		setText = var_1_10007

		local var_6_13 = var_6_11:Find("disable/unlock")

		i18n = var_10

		var_1_10007(var_6_13, var_10("DAL_upgrade_unlock"))

		table = var_1_10007

		var_1_10007.insert(arg_6_0._upgradeDetailList, var_6_11)
	end

	local var_6_14 = arg_6_0._upgradeDetailView

	arg_6_0._closeDetailBtn = var_2.Find(var_6_14, "Top/back_btn")
	setText = var_2

	local var_6_15 = arg_6_0._closeDetailBtn
	local var_6_16 = var_4.Find(var_6_15, "label")

	i18n = var_5

	var_2(var_6_16, var_5("DAL_upgrade_program"))
	...
	local var_6_17 = arg_6_0._upgradeDetailView

	arg_6_0._upgradeBtn = var_2.Find(var_6_17, "page/upgrade_btn")
	setText = var_2

	local var_6_18 = arg_6_0._upgradeBtn
	local var_6_19 = var_4.Find(var_6_18, "label/upgrade")

	i18n = var_5

	var_2(var_6_19, var_5("word_levelup"))
	...
	var_2(arg_6_0, arg_6_0._upgradeBtn, function()
		...
		BossRushDALCollabMediator = var_2_10003

		var_9_1(var_9_0, var_2_10003.ON_UPGRADE, {
			cmd = 1,
	...
	arg_6_0._closeBtn = var_2.Find(var_6_20, "Top/back_btn")
	setText = var_2

	local var_6_21 = arg_6_0._closeBtn
	local var_6_22 = var_4.Find(var_6_21, "label")

	i18n = var_5

	var_2(var_6_22, var_5("DAL_upgrade_ship"))

	setText = var_2

	local var_6_23 = arg_6_0._upgradeDetailView
	local var_6_24 = var_4.Find(var_6_23, "Top/back_btn/label")

	i18n = var_5

	var_2(var_6_24, var_5("DAL_upgrade_ship"))
	...
	var_2(var_6_25, var_5.Find(var_6_26, "Top/res"), function()
		local var_10_0 = arg_6_0.event
		local var_10_1 = var_0.emit

		BaseUI = var_2_10003

		var_10_1(var_10_0, var_2_10003.ON_ITEM, var_0_1.RES_ID)
	...
	var_2(var_6_27, var_5.Find(var_6_28, "Top/res"), function()
		local var_11_0 = arg_6_0.event
		local var_11_1 = var_0.emit

		BaseUI = var_2_10003

		var_11_1(var_11_0, var_2_10003.ON_ITEM, var_0_1.RES_ID)
...
function var_0_1.updateRes(arg_13_0)
	...
	var_1_10002(var_4.Find(var_13_2, "Top/res/text"), var_13_1)

	setText = var_1_10002

	local var_13_3 = arg_13_0._upgradeDetailView

	var_1_10002(var_4.Find(var_13_3, "Top/res/text"), var_13_1)
...
function var_0_1.openUpgradeDetail(arg_14_0, arg_14_1)
	...
	var_1_10003(arg_14_0._upgradeDetailCurrentName, var_14_1.name)
	...
	local var_14_5 = var_14_4(var_14_3, var_6(var_1_10008)).sprite
	local var_14_6 = arg_14_0._upgradeDetailIcon
	local var_14_7 = var_4.GetComponent

	typeof = var_1_10007
	Image = var_1_10009
	var_14_7(var_14_6, var_1_10007(var_1_10009)).sprite = var_14_5
	...
	var_14_3(arg_14_0._upgradeDetailLevel, "LV." .. var_14_9)
...
function var_0_1.updateDetail(arg_15_0, arg_15_1)
	...
	var_15_0(arg_15_0._upgradeDetailLevel, "LV." .. var_15_3 - 1)

	ipairs = var_15_0

	for iter_15_0, iter_15_1 in var_15_0(arg_15_0._upgradeDetailList) do
	...
	if 4 <= var_15_3 then
		...
		var_5(var_7.Find(var_15_5, "label/value"), var_15_4)
	end
