...
AuctionGameMainBidLayer = var_0_10003
...
function var_0_2.init(arg_1_0)
	...
	local function var_1_5()
		...
		local var_3_1 = var_1(var_2_10003)
		local var_3_2 = var_1.GetAuctionState(var_3_1)

		AuctionGameConst = var_2_10003

		local var_3_4

		if var_3_2 ~= var_2_10003.AUCTION_PHASE.BID then
			pg = var_3_4
			...
			var_3_4(var_3_3, var_2_10006("auction_game_wait_bid_phase"))
		...
		if var_3_0 < var_3_6[var_1.GetAuctionID(var_3_7)].bottom_price then
			...
			var_3_8(var_3_7, var_2_10007("auction_game_min_bid", var_3))
		...
		if var_3_8(var_3_7).gold < var_3_0 then
			...
			var_3_10(var_3_9, var_2_10008("auction_game_exceeds_max_value"))
	...
	var_1(var_1_3, var_1_4, var_1_5, var_1_10006.SOUND_EFFECT.BID)
...
function var_0_2.OnClickBidBtn(arg_5_0)
	...
	if var_2.GetRound(var_5_1) == 1 then
		...
		var_1_10004.GuideBided(var_5_0)
	else
		AuctionGameTools = var_1_10004

		var_1_10004.GuideBided2(var_5_0)
	end
