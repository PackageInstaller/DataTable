...
function var_0_1.Init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10004("auction_main_pt"))
	...
	var_1_10001(var_2_1, var_4("auction_main_select_event"))
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_2_0.bidEventCom = var_1_10001(var_2_2, var_4(var_6))
	...
	local var_2_6 = var_2_5(var_2_4, var_1_10005.ACTIVITY_TYPE_AUCTION_GAME)
	local var_2_7 = var_2.getConfig(var_2_6, "config_client").itemID

	LoadSpriteAsync = var_2_4
	Drop = var_6

	local var_2_8 = var_6.New
	local var_2_9 = {}

	DROP_TYPE_VITEM = var_1_10009
	var_2_9.type = var_1_10009
	var_2_9.id = var_2_7

	local var_2_10 = var_2_8(var_2_9)

	var_2_4(var_6.getIcon(var_2_10), function(arg_4_0)
		IsNil = var_2_10001
	...
	var_2_4(var_2_11, var_2_12, var_2_13, var_1_10009)
	...
	local function var_2_16()
		...
		if var_2_10002.AUCTION_PHASE.WAIT_OVER <= var_6_1 then
			pg = var_2
			...
			var_6_3(var_6_2, var_2_10005("auction_game_cannot_forfeit"))
	...
	var_2_4(var_2_14, var_2_15, var_2_16, var_1_10009)
	...
	local function var_2_19()
		...
		local var_7_3 = var_2_10004.ON_ADD_SUBLAYER
		...
		i18n = var_2_10009
		var_7_6.content = var_2_10009("auction_game_forfeit_tip")

		function var_7_6.comformCallback()
			getProxy = var_3_10000
			AuctionGameProxy = var_3_10002
			...
			local var_8_3 = var_8_0:GetAuctionState()

			AuctionGameConst = var_8_1

			if var_8_3 == var_8_1.AUCTION_PHASE.BID then
				pg = var_8_3
				var_8_2 = var_8_3.gameset.auction_bid_time.key_value + var_8_2
			else
				pg = var_8_3
				var_8_2 = var_8_3.gameset.auction_event_choose_time.key_value + var_8_2
			end

			pg = var_8_3

			local var_8_4 = var_8_3.GameTrackerMgr.GetInstance()
			local var_8_5 = var_2.Record

			GameTrackerBuilder = var_3_10005

			var_8_5(var_8_4, var_3_10005.BuildAuctionBid(var_8_0:GetAuctionID(), var_8_0:GetRound(), var_8_2, 0, 1))

			local var_8_6 = arg_2_0
			local var_8_7 = var_2.emit

			AuctionGameMainMediator = var_5

			var_8_7(var_8_6, var_5.FORFEIT)
	...
	var_2_4(var_2_17, var_2_18, var_2_19, var_1_10009)
	...
	local function var_2_22()
		...
		if arg_2_0.waitBid then
			...
			var_9_1(var_9_0, var_2_10003("auction_game_wait_bid_phase"))
	...
	var_2_4(var_2_20, var_2_21, var_2_22, var_1_10009)
	...
	local function var_2_25()
		...
		var_10_1(var_10_0, var_2_10003.PLAY_ROOM_MATCH_STOP)

		local var_10_2 = arg_2_0
		local var_10_3 = var_0.emit

		AuctionGameMainMediator = var_3

		var_10_3(var_10_2, var_3.EXIT)
	...
	var_2_4(var_2_23, var_2_24, var_2_25, var_1_10009)
	...
	for iter_2_0 = 1, #var_2_27 do
		...
		string = var_1_10012
		var_1_10009[iter_2_0] = var_1_10010(arg_2_0[var_1_10012.format("uiPlayerTf%s", iter_2_0)], arg_2_0._parentClass)
	end
	...
	for iter_2_1 = #var_2_27 + 1, 4 do
		...
		var_1_10009(arg_2_0[var_1_10011.format("uiPlayerTf%s", iter_2_1)], false)
	end
	...
	var_5(var_2_28, iter_2_1("auction_show_personal_event"))
	...
	var_5(var_2_29, var_8("auction_show_common_event"))
	...
	local function var_2_32()
		...
		AuctionGameMainScene = var_3

		var_11_1(var_11_0, var_3.SHOW_FILTER_EVENT, arg_2_0.uiFilterPanelTf)
	...
	var_5(var_2_30, var_2_31, var_2_32, var_10)
	...
	var_5(var_2_33, var_2_34, var_2_35, var_10)
	...
	var_5(var_2_36, var_2_37, var_2_38, var_10)
...
function var_0_1.didEnter(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1_10002(arg_14_0.playerViewList) do
	...
	handler = var_1_10007
	var_14_4[1] = var_14_6(var_14_5, var_14_7, var_1_10007(arg_14_0, arg_14_0.OnRefreshForfeit))
	...
	handler = var_7
	var_14_4[2] = var_14_9(var_14_8, var_14_10, var_7(arg_14_0, arg_14_0.OnRefreshPlayerState))
	...
	handler = var_7
	var_14_4[3] = var_14_12(var_14_11, var_14_13, var_7(arg_14_0, arg_14_0.OnPopEventLayer))
	...
	handler = var_7
	var_14_4[4] = var_14_15(var_14_14, var_14_16, var_7(arg_14_0, arg_14_0.OnEventSelected))
	...
	handler = var_7
	var_14_4[5] = var_14_18(var_14_17, var_14_19, var_7(arg_14_0, arg_14_0.OnShowEmoji))
	...
	handler = var_7
	var_14_4[6] = var_14_21(var_14_20, var_14_22, var_7(arg_14_0, arg_14_0.OnSwitchEmoji))
	...
	var_14_4(var_14_23, var_14_24(var_7.GetCurrencyCnt()))
...
function var_0_1.RefreshBidDone(arg_18_0, arg_18_1)
	...
	local var_18_1 = var_5("auction_main_bid_price")

	StringHelper = var_1_10006

	var_2(var_18_0, var_18_1 .. var_1_10006.ForamtNumber(arg_18_1))
...
function var_0_1.OnPopBidLayer(arg_21_0)
	...
	local var_21_2 = var_1_10004.ON_ADD_SUBLAYER

	Context = var_1_10005

	local var_21_3 = var_1_10005.New
	local var_21_4 = {}

	AuctionGameMainBidLayer = var_1_10008
	var_21_4.viewComponent = var_1_10008
	AuctionGameMainBidMediator = var_1_10008
	var_21_4.mediator = var_1_10008
...
function var_0_1.OnPopEventLayer(arg_22_0)
	...
	local var_22_2 = var_1_10004.ON_ADD_SUBLAYER

	Context = var_1_10005

	local var_22_3 = var_1_10005.New
	local var_22_4 = {}

	AuctionGameMainEventLayer = var_1_10008
	var_22_4.viewComponent = var_1_10008
	AuctionGameMainEventMediator = var_1_10008
	var_22_4.mediator = var_1_10008
...
function var_0_1.OnShowEmoji(arg_24_0, arg_24_1, arg_24_2)
	...
	AuctionGameProxy = var_1_10006

	local var_24_1 = var_1_10004(var_1_10006)
	local var_24_2 = var_4.GetPlayerList(var_24_1)

	ipairs = var_1_10005

	for iter_24_0, iter_24_1 in var_1_10005(var_24_2) do
...
function var_0_1.OnSwitchEmoji(arg_25_0)
	...
	for iter_25_0, iter_25_1 in var_1_10002(var_25_1) do
