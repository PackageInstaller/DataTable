...
function var_0_1.bindEvent(arg_2_0)
	...
	arg_2_0:bind(var_0_1.ON_START, function(arg_10_0, arg_10_1, arg_10_2)
		...
		local var_10_1 = var_2_10004(var_2_10006)
		local var_10_3
		...
		if var_4.getRawData(var_10_1).oil < var_10_0 then
			...
			var_10_3(var_10_2, var_2_10008("stage_beginStage_error_noResource"))
		...
		var_10_3({
			function(arg_11_0)
				...
				for iter_11_0, iter_11_1 in var_3_10005(var_11_2.ships) do
					...
					var_3_10010(var_11_5, var_3_10013.getShipById(var_3_10015, iter_11_1))
				end

				local var_11_6 = var_11_2:GetName()

				Fleet = var_6

				var_6.EnergyCheck(var_11_4, var_11_6, function(arg_12_0)
					if arg_12_0 then
						arg_11_0()
					end
...
function var_0_1.handleNotification(arg_23_0, arg_23_1)
	...
	if var_23_1 == var_23_0.BEGIN_STAGE_DONE then
		...
		if var_23_1 == var_23_4.BEGIN_STAGE_ERRO then
			if var_23_2 == 3 then
				pg = var_23_6
				...
				var_23_6(var_23_5, var_1_10007)
			end
		else
			PreCombatMediator = var_23_6

			if var_23_1 == var_23_6.BEGIN_STAGE_PROXY then
				local var_23_7 = arg_23_0.viewComponent
				local var_23_8 = var_4.emit

				PreCombatMediator = var_1_10007

				var_23_8(var_23_7, var_1_10007.BEGIN_STAGE_PROXY, var_23_2)
			elseif var_23_1 == var_0_1.CONTINUOUS_OPERATION then
				...
				var_23_10(var_23_9, var_1_10007.ON_START, var_23_2.mainFleetId, var_23_2.battleTimes)
			end
		end
	end
