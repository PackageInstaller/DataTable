...
function var_0_1.UpdateStoryView(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10002(var_4_0) do
		...
		var_4_4(var_4_5, not var_4_3)

		setActive = var_4_4

		var_4_4(var_4_7, var_4_3)

		if var_4_3 then
			onButton = var_4_4

			var_4_4(arg_4_0, var_4_7, function()
				pg = var_2_10000
				...
				local var_5_2 = var_2_10003.NewStoryMgr.GetInstance()

				var_5_1(var_5_0, var_3.StoryId2StoryName(var_5_2, var_1_10008), nil, true)
			...
			var_4_4(arg_4_0, var_4_5, function()
				...
				if var_0.getActivityById(var_6_0, 5535).data1 <= 0 then
					...
					var_6_2(var_6_1, var_2_10004("activity_0815_town_memory"))
				...
				var_6_4(var_6_3, var_2_10004.ACTIVITY_UNLOCKSTORY, {
					cmd = 1,
...
function var_0_1.UpdateItemView(arg_7_0, arg_7_1)
	...
	local var_7_1 = var_4.Find(var_7_0, "frame/des/count")

	tostring = var_1_10005

	var_1_10002(var_7_1, var_1_10005(arg_7_1.data1))
...
function var_0_1.UpdataStoryState(arg_8_0, arg_8_1)
	...
	for iter_8_2, iter_8_3 in var_5(var_8_4) do
		if iter_8_2 == var_8_1 then
			...
			local var_8_12 = var_8_11(var_8_10, var_16(var_1_10018))
			...
			var_15(function()
				...
				local var_9_3 = var_3.NewStoryMgr.GetInstance()

				var_9_2(var_9_1, var_3.StoryId2StoryName(var_9_3, var_8_0))
			...
			if var_8_5 then
				...
				var_15(arg_8_0, var_8_9, function()
					...
					local var_10_2 = var_2_10003.NewStoryMgr.GetInstance()

					var_10_1(var_10_0, var_3.StoryId2StoryName(var_10_2, var_8_0), nil, true)
				...
				var_15(arg_8_0, var_8_7, function()
					...
					if var_0.getActivityById(var_11_0, 5535).data1 <= 0 then
						...
						var_11_2(var_11_1, var_2_10004("activity_0815_town_memory"))
					...
					var_11_4(var_11_3, var_2_10004.ACTIVITY_UNLOCKSTORY, {
						cmd = 1,
...
function var_0_1.didEnter(arg_12_0)
	...
	local var_12_2 = var_4.Find(var_12_1, "frame/back")
	...
	local var_12_6 = var_4.Find(var_12_5, "bg")
	...
	var_1_10001(var_12_8, var_4.Find(var_12_9, "frame/des/itemDes"), function()
		getProxy = var_2_10000
		ActivityProxy = var_2_10002
		...
		DROP_TYPE_VITEM = var_15_0
		var_15_2.type = var_15_0
		...
		var_15_5(var_15_4, var_5.ON_DROP, var_15_2)
...
function var_0_1.ShowMask(arg_16_0, arg_16_1)
	...
	var_16_1, GetOrAddComponent = var_2.Find(var_16_0, "mask"), var_1_10003
	typeof = var_1_10006
	CanvasGroup = var_1_10008
	var_1_10003(var_16_1, var_1_10006(var_1_10008)).blocksRaycasts = arg_16_1
