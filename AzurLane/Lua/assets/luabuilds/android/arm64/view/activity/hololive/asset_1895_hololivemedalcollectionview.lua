...
function var_0_1.InitData(arg_4_0)
	...
	arg_4_0.taskProxy = var_1_10002(var_1_10004)

	local var_4_1 = var_4_0
	local var_4_2 = var_4_0.getActivityById

	ActivityConst = var_1_10005
	arg_4_0.actMedal = var_4_2(var_4_1, var_1_10005.HOLOLIVE_MEDAL_COLLECTION)
	...
	arg_4_0.taskGroup = var_4_4[var_1_10003.HOLOLIVE_MEDAL_COLLECTION_TASK].config_data
...
function var_0_1.FindUI(arg_5_0)
	...
	arg_5_0.taskListItems = var_5_7(var_3.Find(var_5_8, "Content"), #arg_5_0.taskGroup)
	CustomIndexLayer = var_1

	local var_5_9 = var_1.Clone2Full
	local var_5_10 = arg_5_0._tf

	arg_5_0.medalListItems = var_5_9(var_3.Find(var_5_10, "middle/console/grid"), 9)
	...
	typeof = var_4
	Image = var_6
	arg_5_0.medalImg = var_5_13(var_5_12, var_4(var_6))
	...
	for iter_5_0 = 1, #arg_5_0.taskGroup do
		LoadSprite = var_5_10
		var_5_10 = var_5_10("ui/HololiveMedalCollectionUI_atlas", var_0_2[iter_5_0])
		...
		local var_5_19 = var_5_18(var_5_17, var_9(var_1_10011))

		var_5_19.sprite = var_5_10
		...
		local var_5_23 = var_5_22(var_5_21, var_10(var_1_10012))

		var_5_23.sprite = var_5_10
...
function var_0_1.AddListener(arg_6_0)
	...
	local function var_6_5()
		...
		pg = var_2_10004
		var_8_2.helps = var_2_10004.gametip.hololive_dalaozhang.tip
	...
	var_1_10002(arg_6_0, arg_6_0.taskScroll, function(arg_9_0)
	...
	var_1_10002(var_6_8, var_6_9, var_6_10, var_1_10007)
...
function var_0_1.DataSetting(arg_11_0)
	if #arg_11_0.activatableIDList > 0 then
		...
		if var_11_1 then
			...
			local var_11_5 = var_1_10006.MEMORYBOOK_UNLOCK
			local var_11_6 = {
				id = var_11_1
			}

			ActivityConst = var_1_10008
			var_11_6.actId = var_1_10008.HOLOLIVE_MEDAL_COLLECTION
...
function var_0_1.UpdateView(arg_12_0)
	...
	for iter_12_0 = 1, #arg_12_0.taskGroup do
		...
		local var_12_9 = var_12_3.Find(var_12_8, "btn_get")
		local var_12_10 = var_12_3:Find("btn_got")

		table = var_12_8

		local var_12_11 = var_12_8.contains(arg_12_0.activeIDList, arg_12_0.allIDList[iter_12_0])
		local var_12_12
		local var_12_13 = 0
		local var_12_14
		...
		if var_12_6 then
			...
			var_12_14 = var_12_6.getProgress(var_1_10019)
			var_1_10020 = var_12_6

			local var_12_15 = var_12_6.getConfig(var_1_10020, "target_num")

			var_1_10019 = var_12_6:getConfig("desc")
			string = var_1_10020
			var_1_10019 = var_1_10020.gsub(var_1_10019, "$1", var_12_14)
			string = var_1_10020
			var_1_10019 = var_1_10020.gsub(var_1_10019, "$2", var_12_15)
			setText = var_1_10020

			var_1_10020(var_12_3:Find("desc"), var_1_10019)

			var_1_10022 = var_12_6
			var_12_12 = var_12_6.getTaskStatus(var_1_10022) == 2 and arg_12_0.materialGray or nil
			onButton = var_1_10020
			var_1_10022 = arg_12_0
			var_1_10023 = var_12_7
			...
			local function var_12_16()
				...
				var_13_1(var_13_0, var_2_10003.ON_TASK_GO, var_12_6)
			...
			var_1_10020(var_1_10022, var_1_10023, var_12_16, var_25)

			onButton = var_1_10020
			var_1_10022 = arg_12_0
			var_1_10023 = var_12_9
			...
			local function var_12_17()
				...
				var_14_1(var_14_0, var_2_10003.ON_TASK_SUBMIT, var_12_6)
			...
			var_1_10020(var_1_10022, var_1_10023, var_12_17, var_25)
		else
			pg = var_12_14
			var_12_14 = var_12_14.task_data_template[var_12_4].target_num

			local var_12_18 = var_12_11 and var_12_14 or 0

			pg = var_1_10019
			var_1_10019 = var_1_10019.task_data_template[var_12_4].desc
			string = var_1_10020
			var_1_10019 = var_1_10020.gsub(var_1_10019, "$1", var_12_18)
			string = var_1_10020
			...
			local function var_12_19()
				...
				var_15_1(var_15_0, var_2_10003("common_activity_end"))
			...
			var_1_10020(var_1_10022, var_1_10023, var_12_19, var_25)
		end

		setActive = var_12_14
		var_1_10019 = var_12_7
		var_1_10020 = var_12_13 == 0

		var_12_14(var_1_10019, var_1_10020)

		setActive = var_12_14
		var_1_10019 = var_12_9
		var_1_10020 = var_12_13 == 1

		var_12_14(var_1_10019, var_1_10020)

		setActive = var_12_14
		var_1_10019 = var_12_10
		var_1_10020 = var_12_13 == 2

		var_12_14(var_1_10019, var_1_10020)

		var_1_10019 = var_12_3

		local var_12_20 = var_12_3.GetComponent

		typeof = var_1_10020
		Image = var_1_10022
		var_12_20(var_1_10019, var_1_10020(var_1_10022)).material = var_12_12
		var_1_10019 = var_12_3
		var_1_10019 = var_12_3.Find(var_1_10019, "icon")

		local var_12_21 = var_17.GetComponent

		typeof = var_1_10020
		Image = var_1_10022
		var_12_21(var_1_10019, var_1_10020(var_1_10022)).material = var_12_12
		var_1_10020 = arg_12_0.medalListItems[var_0_3[iter_12_0]]
		var_1_10020 = var_17.Find(var_1_10020, "icon")

		local var_12_22 = var_18.GetComponent

		typeof = var_21
		Image = var_1_10023

		local var_12_23 = var_12_22(var_1_10020, var_21(var_1_10023))

		var_12_23.enabled = var_12_11

		if not var_12_1 or not arg_12_0.materialGray then
			var_1_10019 = nil
		end

		var_12_23.material = var_1_10019
	...
	local var_12_24 = arg_12_0.medalImg

	var_12_24.material = not var_12_0 and not var_12_1 and arg_12_0.materialGray
	setActive = var_12_24

	var_12_24(arg_12_0.medalGet, var_12_0)

	setActive = var_12_24

	var_12_24(arg_12_0.medalGot, var_12_1)
...
function var_0_1.GetFinal(arg_16_0)
	if #arg_16_0.activeIDList == #arg_16_0.allIDList and arg_16_0.actMedal.data1 ~= 1 then
		...
		local var_16_2 = var_1_10004.ACTIVITY_OPERATION
		local var_16_3 = {
			cmd = 1
		}

		ActivityConst = var_1_10006
		var_16_3.activity_id = var_1_10006.HOLOLIVE_MEDAL_COLLECTION
...
function var_0_1.PlayStory(arg_17_0, arg_17_1)
	...
	if var_2.getConfig(var_17_0, "config_client").story then
		...
		local var_17_1 = var_1_10003.NewStoryMgr.GetInstance()
...
function var_0_1.IsTip()
	...
	if var_18_3(var_18_2, var_1_10005.HOLOLIVE_MEDAL_COLLECTION) and not var_2:isEnd() then
		local var_18_4 = var_2
		local var_18_5 = var_2.getConfig(var_18_4, "config_data")

		pg = var_18_2

		local var_18_6 = var_18_2.activity_template

		ActivityConst = var_18_4

		local var_18_7 = var_18_6[var_18_4.HOLOLIVE_MEDAL_COLLECTION_TASK].config_data
