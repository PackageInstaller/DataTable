...
local function var_0_7(arg_1_0)
	...
	function var_1_0.Get(arg_3_0)
		...
		if #arg_3_0.list == 0 then
			...
			var_3_2(var_3_1, var_2_10005(var_2_10007))
		else
			table = var_3_2
	...
	function var_1_0.Clear(arg_5_0, arg_5_1)
		...
		typeof = var_2_10005
		Image = var_2_10007
		var_5_1(var_5_0, var_2_10005(var_2_10007)).sprite = nil
		setActive = var_3
...
function var_0_1.getMemoryState(arg_10_0, arg_10_1)
	...
	if (not var_1_10003.contains(arg_10_0.unlockItems, arg_10_1) or not var_0_4) and (not var_10_0 or not var_0_3) then
		var_10_1 = var_0_2
	end
...
function var_0_1.updateMemorys(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1(arg_11_0.targetItems) do
		...
		local var_11_1 = arg_11_0.getMemoryState(var_11_0, iter_11_1)
		local var_11_2 = iter_11_0 % var_0_5

		table = var_11_0

		local var_11_3 = var_11_0.insert
		local var_11_4 = arg_11_0.memorys
		local var_11_5 = {
			id = iter_11_1
		}
		local var_11_6

		if var_11_2 ~= 0 or not var_0_5 then
			var_11_6 = var_11_2
		end

		var_11_5.index = var_11_6
		var_11_5.pos = var_0_6[iter_11_0]
		var_11_5.state = var_11_1
	...
	arg_11_0:updateMemoryBook(var_11_7, true)
...
function var_0_1.init(arg_12_0)
	...
	typeof = var_5
	Image = var_1_10007
	arg_12_0.getSprite = var_12_6(var_12_5, var_5(var_1_10007)).sprite
	...
	typeof = var_5
	Slider = var_1_10007
	arg_12_0.slider = var_12_9(var_12_8, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_12_0.totalTxt = var_12_12(var_12_11, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_12_0.currValueTxt = var_12_15(var_12_14, var_5(var_1_10007))
...
function var_0_1.didEnter(arg_13_0)
	...
	local function var_13_5()
		...
		pg = var_2_10004
		var_15_2.helps = var_2_10004.gametip.memorybook_notice.tip
	...
	var_1(var_13_3, var_13_4, var_13_5, var_1_10006)

	onButton = var_1

	local var_13_6 = arg_13_0
	local var_13_7 = arg_13_0.page1
	local var_13_8 = var_4.Find(var_13_7, "switch")
	...
	var_1(var_13_6, var_13_8, var_13_9, var_13_7)

	onButton = var_1

	local var_13_10 = arg_13_0
	local var_13_11 = arg_13_0.page2
	local var_13_12 = var_4.Find(var_13_11, "switch")
	...
	var_1(var_13_10, var_13_12, var_13_13, var_13_11)
...
function var_0_1.updateMemoryBook(arg_19_0, arg_19_1, arg_19_2)
	...
	if arg_19_2 then
		if arg_19_1 == var_0_1.PAGE_TWO then
			...
			var_19_8 = arg_19_0.page2
			Vector3 = var_19_6
			var_19_8.localPosition = var_19_6.New(0, 0)
			var_19_8 = arg_19_0.page1
			Vector3 = var_9
			var_19_8.localPosition = var_9.New(-1280, 0)
			setActive = var_19_8

			var_19_8(var_19_7, true)
		else
			local var_19_9 = arg_19_0.page1
			local var_19_10 = var_7.Find(var_19_9, "switch")

			var_19_8 = arg_19_0.page2
			Vector3 = var_19_9
			var_19_8.localPosition = var_19_9.New(1280, 0)
			var_19_8 = arg_19_0.page1
			Vector3 = var_9
			var_19_8.localPosition = var_9.New(0, 0)
			setActive = var_19_8

			var_19_8(var_19_10, true)
		end
	elseif arg_19_1 == var_0_1.PAGE_TWO then
		local var_19_11 = arg_19_0.page2
		local var_19_12 = var_7.Find(var_19_11, "switch")

		setActive = var_19_8

		var_19_8(var_19_12, false)

		var_19_8 = arg_19_0.page2
		Vector3 = var_19_11
		var_19_8.localPosition = var_19_11.New(1280, 0)
		var_19_8 = arg_19_0.page1
		Vector3 = var_9
		var_19_8.localPosition = var_9.New(0, 0)
		LeanTween = var_19_8

		var_19_8.moveX(arg_19_0.page2, 0, 0.5)

		LeanTween = var_19_8

		local var_19_13 = var_19_8.moveX(arg_19_0.page1, -1280, 0.5)

		var_19_8 = var_19_8.setOnComplete
		System = var_11

		var_19_8(var_19_13, var_11.Action(function()
			setActive = var_2_10000

			var_2_10000(var_19_12, true)

			return
		end))
	else
		local var_19_14 = arg_19_0.page1
		local var_19_15 = var_7.Find(var_19_14, "switch")

		setActive = var_19_8

		var_19_8(var_19_15, false)

		local var_19_16 = arg_19_0.page2

		Vector3 = var_19_14
		var_19_16.localPosition = var_19_14.New(0, 0)

		local var_19_17 = arg_19_0.page1

		Vector3 = var_9
		var_19_17.localPosition = var_9.New(-1280, 0)
		LeanTween = var_19_17

		var_19_17.moveX(arg_19_0.page2, 1280, 0.5)

		LeanTween = var_8

		local var_19_18 = var_8.moveX(arg_19_0.page1, 0, 0.5)
		local var_19_19 = var_8.setOnComplete

		System = var_11

		var_19_19(var_19_18, var_11.Action(function()
			setActive = var_2_10000
...
function var_0_1.updatePageTip(arg_26_0, arg_26_1)
	...
	local var_26_1, var_26_2 = arg_26_0.getStartAndEndIndex(var_26_0, arg_26_1)

	_ = var_26_0

	local var_26_3 = var_26_0.any

	_ = var_1_10006

	return var_26_3(var_1_10006.slice(arg_26_0.memorys, var_26_1, var_0_5), function(arg_27_0)
...
function var_0_1.updateMemoryItem(arg_28_0, arg_28_1, arg_28_2)
	...
	local function var_28_2()
		...
		local var_29_6 = var_29_5(var_29_4, var_5(var_2_10007))
		...
		var_29_6(var_29_7, var_5.Find(var_29_8, "container"))
	...
	elseif var_28_0 == var_0_3 then
		...
		local function var_28_6()
			...
			MemoryBookMediator = var_2_10003

			var_30_1(var_30_0, var_2_10003.ON_UNLOCK, arg_28_2.id, arg_28_0.activity.id)
		...
		var_1_10007(var_28_4, var_28_5, var_28_6, var_1_10012)
...
function var_0_1.updateAward(arg_33_0, arg_33_1)
	if not arg_33_0.isInitAward then
		...
		if var_33_0 == var_1_10004 then
			...
			var_1_10005("furniture/" .. var_1_10004:getConfig("picture"), "", function(arg_34_0)
	...
	if var_33_2(var_5(arg_33_0.awardLabel)) then
		LeanTween = var_33_3
		var_33_3 = var_33_3.cancel
		go = var_5

		var_33_3(var_5(arg_33_0.awardLabel))
	end
	...
	if not var_33_1 then
		...
		local function var_33_6()
			if not arg_33_1 then
				...
				var_35_1(var_35_0, var_2_10003("memorybook_get_award_tip"))
			else
				...
				var_35_3(var_35_2, var_2_10003.EVENT_OPERATION, {
					cmd = 1,
		...
		var_33_3(var_33_4, var_33_5, var_33_6, var_1_10008)
	end
