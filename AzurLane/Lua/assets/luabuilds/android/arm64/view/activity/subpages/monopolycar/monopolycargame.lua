...
function var_0_0.initData(arg_2_0)
	...
	arg_2_0.mapCells = {}
	arg_2_0.showSkinId = var_0_4[math.random(1, #var_0_4)]
...
function var_0_0.initEvent(arg_4_0)
	...
	onButton(arg_4_0._binder, arg_4_0.btnRp, function()
		if arg_4_0.leftAwardCnt > 0 then
			arg_4_0._event:emit(MonopolyCarPage.ON_AWARD)
		end
...
function var_0_0.showRollAnimated(arg_10_0, arg_10_1)
	...
	seriesAsync({
		...
		if arg_10_0.step > 0 then
			...
			arg_10_0.imgTouzi:GetComponent(typeof(Image)).sprite = GetSpriteFromAtlas("ui/activityuipage/monopolycar_atlas", arg_10_0.step)
		end
	...
	for iter_29_0 = 1, #MonopolyCarConst.map_dic do
		for iter_29_1 = 1, #MonopolyCarConst.map_dic[iter_29_0] do
			if MonopolyCarConst.map_dic[iter_29_0][iter_29_1] > 0 then
				local var_29_0 = cloneTplTo(arg_29_0.tplMapCell, arg_29_0.mapContainer, tostring(MonopolyCarConst.map_dic[iter_29_0][iter_29_1]))
				...
				var_29_2:GetComponent(typeof(Image)).sprite = GetSpriteFromAtlas("ui/activityuipage/monopolycar_atlas", pg.activity_event_monopoly_map[MonopolyCarConst.map_dic[iter_29_0][iter_29_1]].icon)
