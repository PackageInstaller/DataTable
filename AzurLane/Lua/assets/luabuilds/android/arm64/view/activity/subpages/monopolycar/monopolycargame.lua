...
function var_0_0.initUI(arg_3_0)
	...
	arg_3_0.commonAnim = var_3_1(var_3_0, var_4(var_1_10006))
	findTF = var_1
...
function var_0_0.initEvent(arg_4_0)
	...
	local function var_4_5()
		...
		pg = var_2_10004
		var_7_2.helps = var_2_10004.gametip.help_monopoly_car.tip
...
function var_0_0.showRollAnimated(arg_10_0, arg_10_1)
	...
	var_10_6({
		...
		local var_25_0 = arg_10_0.step

		if 0 < var_25_0 then
			GetSpriteFromAtlas = var_25_0

			local var_25_1 = var_25_0("ui/activityuipage/monopolycar_atlas", arg_10_0.step)

			setActive = var_1

			var_1(arg_10_0.imgTouzi, true)

			local var_25_2 = arg_10_0.imgTouzi
			local var_25_3 = var_1.GetComponent

			typeof = var_4
			Image = var_2_10006
			var_25_3(var_25_2, var_4(var_2_10006)).sprite = var_25_1
		end

		local var_25_4 = arg_10_0

		var_0.updataUI(var_25_4)

		local var_25_5 = arg_10_0

		var_0.checkCharActive(var_25_5)
	...
	for iter_29_0 = 1, #var_29_0 do
		...
		for iter_29_1 = 1, #var_29_3 do
			...
			if 0 < var_29_5 then
				...
				local var_29_10 = var_18("ui/activityuipage/monopolycar_atlas", var_29_9)
...
function var_0_0.initChar(arg_31_0)
	...
	var_1.GetSpineChar(var_31_1, arg_31_0.showSkinId, true, function(arg_33_0)
		...
		typeof = var_5
		SpineAnimUI = var_2_10007
		var_33_3.showAnim = var_33_5(var_33_4, var_5(var_2_10007))
