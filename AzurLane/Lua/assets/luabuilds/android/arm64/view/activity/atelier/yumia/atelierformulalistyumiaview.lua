...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.Atelier.base.AtelierFormulaListView"))

bit = var_0_10001
var_0_1.FilterAll = var_0_10001.bor(1)
...
function var_0_1.InitCustom(arg_1_0)
	...
	local var_1_1 = var_3.Find(var_1_0, "Bar/Text")

	i18n = var_4

	var_1(var_1_1, var_4("yumia_atelier_tip5"))

	setText = var_1

	local var_1_2 = arg_1_0._tf
	local var_1_3 = var_3.Find(var_1_2, "Frame/Tabs/Equip/UnSelected/Text")

	i18n = var_4

	var_1(var_1_3, var_4("yumia_atelier_tip2"))

	setText = var_1

	local var_1_4 = arg_1_0._tf
	local var_1_5 = var_3.Find(var_1_4, "Frame/Tabs/Equip/Selected/Text")

	i18n = var_4

	var_1(var_1_5, var_4("yumia_atelier_tip2"))

	setText = var_1

	local var_1_6 = arg_1_0._tf
	local var_1_7 = var_3.Find(var_1_6, "Frame/Tabs/Item/UnSelected/Text")

	i18n = var_4

	var_1(var_1_7, var_4("yumia_atelier_tip3"))

	setText = var_1

	local var_1_8 = arg_1_0._tf
	local var_1_9 = var_3.Find(var_1_8, "Frame/Tabs/Item/Selected/Text")

	i18n = var_4

	var_1(var_1_9, var_4("yumia_atelier_tip3"))

	setText = var_1

	local var_1_10 = arg_1_0._tf
	local var_1_11 = var_3.Find(var_1_10, "Frame/title/Text")

	i18n = var_4

	var_1(var_1_11, var_4("yumia_atelier_tip4"))

	setCanvasGroupAlpha = var_1

	local var_1_12 = arg_1_0._tf

	var_1(var_3.Find(var_1_12, "Frame"), 0)
...
function var_0_1.didEnter(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_3_0(arg_3_0.formulaFilterButtons) do
		...
		var_1_10006(var_3_1, var_3_2, var_3_3, var_1_10011)
	end
	...
	var_1(var_3_4, var_4.Find(var_3_5, "Frame/Filter/Toggle"), function(arg_5_0)
...
function var_0_1.FilterFormulas(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_1_10002(var_4.GetFormulasByVersion(var_7_1, var_7_0)) do
	...
	var_2.sort(arg_7_0.filterFormulas, function(arg_8_0, arg_8_1)
		local var_8_0 = {
			...
			function(arg_10_0)
				local var_10_0 = arg_10_0:GetType()

				AtelierFormula = var_3_10002

				if var_10_0 ~= var_3_10002.TYPE.TOOL then
					local var_10_1 = arg_7_0.activity

					if not var_1.IsCompleteAllTools(var_10_1, arg_10_0:getConfig("version")) then
						do return 1 end
...
function var_0_1.IsFormulaTypeFit(arg_12_0, arg_12_1)
	...
	local var_12_2 = arg_12_1.GetType(var_12_1)
	local var_12_3 = {}

	AtelierFormula = var_12_1
	var_12_3[var_12_1.TYPE.EQUIP] = function()
		return var_12_0 == var_0_1.FORMULA_TYPE.EQUIP
	end
	AtelierFormula = var_7
	var_12_3[var_7.TYPE.ITEM] = function()
		return var_12_0 == var_0_1.FORMULA_TYPE.ITEM
	end
	AtelierFormula = var_7
	var_12_3[var_7.TYPE.TOOL] = function()
		return var_12_0 == var_0_1.FORMULA_TYPE.ITEM
	end
	AtelierFormula = var_7
	var_12_3[var_7.TYPE.OTHER] = function()
		return var_12_0 == var_0_1.FORMULA_TYPE.ITEM
	end

	return var_1_10003(var_12_2, var_12_3)
end
