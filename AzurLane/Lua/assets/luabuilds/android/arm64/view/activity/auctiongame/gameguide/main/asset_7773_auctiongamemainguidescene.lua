...
AuctionGameMainScene = var_0_10003
...
function var_0_2.didEnter(arg_2_0)
	...
	if not var_1.IsPlayed(var_2_0, "AUCTION_GUIDE_2") then
		...
		var_1(var_2_2, var_4.UIMgr.GetInstance().OverlayMain)
...
function var_0_2.OnStartRoundOver(arg_6_0)
	...
	local var_6_4 = var_6_0.TimeMgr.GetInstance()
	...
	if var_6_3 - var_3.GetServerTime(var_6_4) > 0 then
		...
		local var_6_7 = var_1_10007.ON_ADD_SUBLAYER

		Context = var_1_10008

		local var_6_8 = var_1_10008.New
		local var_6_9 = {}

		AuctionGameMainRoundOverLayer = var_1_10011
		var_6_9.viewComponent = var_1_10011
		AuctionGameMainRoundOverMediator = var_1_10011
		var_6_9.mediator = var_1_10011
...
function var_0_2.AddTimer(arg_7_0)
	...
	var_7_0(arg_7_0.uiCdText, var_7_3 .. "<size=30>s</size>")
...
function var_0_2.AddRoundOverTimer(arg_8_0)
	...
	arg_8_0.timer = var_1.New(function()
		...
		local var_9_2 = var_2_10002.TimeMgr.GetInstance()
