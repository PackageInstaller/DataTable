...
function var_0_1.OnUpdateFlush(arg_3_0)
	...
	if 1 <= var_3_3 then
		...
		if not var_7(var_3_1, "#947D80FF") then
			var_3_5 = var_3_1
		end
		...
		local var_3_6 = arg_3_0.shareBtn
		local var_3_7 = arg_3_0

		var_4(var_3_6, arg_3_0.isFinished(var_3_7))
		...
		var_4(var_3_8, var_3_9, var_3_10, var_3_7)
...
function var_0_1.addListener(arg_7_0)
	...
	local function var_7_8()
		...
		pg = var_2_10004
		var_12_2.helps = var_2_10004.gametip.pizzahut_help.tip
...
function var_0_1.initMainPanel(arg_14_0)
	...
	var_1_10001(var_14_0, var_14_1, var_14_2, var_1_10006)
	...
	for iter_14_0, iter_14_1 in var_1_10001(arg_14_0.mainToggleTFList) do
		...
		local function var_14_5(arg_16_0)
			...
			if arg_16_0 == true then
				...
				for iter_16_0 = 1, 3 do
					local var_16_6 = arg_14_0.secondPanel

					var_16_5[iter_16_0] = var_2_10008.GetChild(var_16_6, iter_16_0 - 1)
				end
				...
				if #var_16_1 == 1 then
					...
					var_16_7(var_16_5[2], false)

					setActive = var_16_7

					var_16_7(var_16_5[3], false)

					getImageSprite = var_16_7
					var_16_7 = var_16_7(var_16_1[1])
					setImageSprite = var_5
					var_2_10009 = var_16_5[1]

					var_5(var_7.Find(var_2_10009, "icon"), var_16_7, true)

					onToggle = var_5

					local var_16_8 = arg_14_0

					var_2_10008 = var_16_5[1]

					function var_2_10009(arg_17_0)
					...
					var_5(var_16_8, var_2_10008, var_2_10009, var_10)
					...
					var_16_7(var_16_5[2], true)

					setActive = var_16_7

					var_16_7(var_16_5[3], true)
					...
					for iter_16_1 = 1, 3 do
						...
						local var_16_9 = var_16_5[iter_16_1]

						var_2_10009(var_11.Find(var_16_9, "icon"), var_2_10008, true)

						onToggle = var_2_10009

						local var_16_10 = arg_14_0
						local var_16_11 = var_16_5[iter_16_1]

						local function var_16_12(arg_18_0)
						...
						var_2_10009(var_16_10, var_16_11, var_16_12, var_14)
					end
				end
				...
				local var_16_13 = arg_14_0

				var_4.openSecondPanel(var_16_13)
			...
			var_1.updateMainSelectPanel(var_16_14)
		...
		var_1_10006(var_14_3, var_14_4, var_14_5, var_1_10011)
	end
...
function var_0_1.openSelectBtn(arg_41_0)
	...
	local var_41_8 = var_41_7(var_41_6, var_4.Action_float(function(arg_44_0)
		setLocalPosition = var_2_10001
	...
	var_41_9(var_41_8, var_4.Action(function()
		setLocalPosition = var_2_10000
...
function var_0_1.closeSelectBtn(arg_46_0)
	...
	local var_46_1 = var_46_0(var_1_10003(arg_46_0.selectBtn), 1, 0, var_0_1.Menu_Ani_Close_Time)
	local var_46_2 = var_1.setOnUpdate

	System = var_4

	local var_46_3 = var_46_2(var_46_1, var_4.Action_float(function(arg_47_0)
		setImageAlpha = var_2_10001
	...
	var_46_4(var_46_3, var_4.Action(function()
		setImageAlpha = var_2_10000
	...
	local var_46_8 = var_46_7(var_46_6, var_4.Action_float(function(arg_49_0)
		setLocalPosition = var_2_10001
	...
	var_46_9(var_46_8, var_4.Action(function()
		setLocalPosition = var_2_10000
...
function var_0_1.updatePizza(arg_52_0)
	...
	if arg_52_0.selectedList[1] then
		var_52_13 = arg_52_0.selectedList[1] > 0
	end

	var_52_8(var_52_12, var_52_13)
	...
	if arg_52_0.selectedList[2] then
		var_52_15 = arg_52_0.selectedList[2] > 0
	end

	var_52_8(var_52_14, var_52_15)

	setActive = var_52_8

	local var_52_16 = var_52_5
	local var_52_17

	if arg_52_0.selectedList[3] then
		var_52_17 = arg_52_0.selectedList[3] > 0
	end

	var_52_8(var_52_16, var_52_17)

	setActive = var_52_8

	local var_52_18 = var_52_7
	local var_52_19

	if arg_52_0.selectedList[4] then
		var_52_19 = arg_52_0.selectedList[4] > 0
	end

	var_52_8(var_52_18, var_52_19)

	setActive = var_52_8

	local var_52_20 = var_52_9
	local var_52_21

	if arg_52_0.selectedList[5] then
		var_52_21 = arg_52_0.selectedList[5] > 0
	end

	var_52_8(var_52_20, var_52_21)

	setActive = var_52_8

	local var_52_22 = var_52_11
	local var_52_23

	if arg_52_0.selectedList[6] then
		var_52_23 = arg_52_0.selectedList[6] > 0
	end

	var_52_8(var_52_22, var_52_23)

	if arg_52_0.selectedList[1] then
		local var_52_24 = arg_52_0.selectedList[1]

		if 0 < var_52_24 then
			getImageSprite = var_52_24

			local var_52_25 = arg_52_0._tf

			var_52_22 = var_52_22.Find
			tostring = var_1_10012

			local var_52_26 = var_52_24(var_52_22(var_52_25, var_1_10012(arg_52_0.selectedList[1]), arg_52_0.pizzaResTF))

			setImageSprite = var_8

			var_8(var_52_1, var_52_26, true)
		end
	end

	if arg_52_0.selectedList[2] and arg_52_0.selectedList[2] > 0 then
		local var_52_27 = arg_52_0.selectedList[1] .. arg_52_0.selectedList[2]

		getImageSprite = var_8

		local var_52_28 = arg_52_0.pizzaResTF
		local var_52_29 = var_8(var_10.Find(var_52_28, var_52_27))

		setImageSprite = var_52_22

		var_52_22(var_52_3, var_52_29, true)
	end

	if arg_52_0.selectedList[3] and arg_52_0.selectedList[3] > 0 then
		local var_52_30 = arg_52_0.selectedList[1] .. arg_52_0.selectedList[2] .. arg_52_0.selectedList[3]

		getImageSprite = var_8

		local var_52_31 = arg_52_0.pizzaResTF
		local var_52_32 = var_8(var_10.Find(var_52_31, var_52_30))

		setImageSprite = var_52_22

		var_52_22(var_52_5, var_52_32, true)
	end

	if arg_52_0.selectedList[4] and arg_52_0.selectedList[4] > 0 then
		local var_52_33 = 4 .. arg_52_0.selectedList[4]

		getImageSprite = var_8

		local var_52_34 = arg_52_0.pizzaResTF
		local var_52_35 = var_8(var_10.Find(var_52_34, var_52_33))

		setImageSprite = var_52_22

		var_52_22(var_52_7, var_52_35, true)
	end

	if arg_52_0.selectedList[5] and arg_52_0.selectedList[5] > 0 then
		local var_52_36 = 5 .. arg_52_0.selectedList[5]

		getImageSprite = var_8

		local var_52_37 = arg_52_0.pizzaResTF
		local var_52_38 = var_8(var_10.Find(var_52_37, var_52_36))

		setImageSprite = var_52_22

		var_52_22(var_52_9, var_52_38, true)
	end

	if arg_52_0.selectedList[6] and arg_52_0.selectedList[6] > 0 then
		local var_52_39 = 6 .. arg_52_0.selectedList[6]

		getImageSprite = var_8

		local var_52_40 = arg_52_0.pizzaResTF
		local var_52_41 = var_8(var_10.Find(var_52_40, var_52_39))

		setImageSprite = var_52_22

		var_52_22(var_52_11, var_52_41, true)
	end
...
function var_0_1.updateMainSelectPanel(arg_53_0)
	if arg_53_0.selectedList[1] then
		local var_53_0 = arg_53_0.selectedList[1]

		if 0 < var_53_0 then
			getImageSprite = var_53_0

			local var_53_1 = arg_53_0._tf

			var_1_10003 = var_1_10003.Find
			tostring = var_1_10006

			local var_53_2 = var_53_0(var_1_10003(var_53_1, var_1_10006(arg_53_0.selectedList[1]), arg_53_0.selectedIconResTF))
	...
	if arg_53_0.selectedList[2] and arg_53_0.selectedList[2] > 0 then
		...
		local var_53_5 = var_2(var_4.Find(var_53_4, var_53_3))

		setImageSprite = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[2], var_53_5, true)

		setActive = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[2], true)
	end
	...
	if arg_53_0.selectedList[3] and arg_53_0.selectedList[3] > 0 then
		...
		local var_53_8 = var_2(var_4.Find(var_53_7, var_53_6))

		setImageSprite = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[3], var_53_8, true)

		setActive = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[3], true)
	end
	...
	if arg_53_0.selectedList[4] and arg_53_0.selectedList[4] > 0 then
		...
		local var_53_11 = var_2(var_4.Find(var_53_10, var_53_9))

		setImageSprite = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[4], var_53_11, true)

		setActive = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[4], true)
	end
	...
	if arg_53_0.selectedList[5] and arg_53_0.selectedList[5] > 0 then
		...
		local var_53_14 = var_2(var_4.Find(var_53_13, var_53_12))

		setImageSprite = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[5], var_53_14, true)

		setActive = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[5], true)
	end
	...
	if arg_53_0.selectedList[6] and arg_53_0.selectedList[6] > 0 then
		...
		local var_53_17 = var_2(var_4.Find(var_53_16, var_53_15))

		setImageSprite = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[6], var_53_17, true)

		setActive = var_1_10003

		var_1_10003(arg_53_0.mainToggleSelectedTF[6], true)
	end
...
function var_0_1.share(arg_58_0)
	...
	var_1.GetUI(var_58_0, "PizzahutSharePage", false, function(arg_59_0)
		...
		var_2_10002(arg_59_0, var_59_0, false)

		arg_58_0.shareGo = arg_59_0

		local var_59_1 = arg_59_0
		local var_59_2 = arg_59_0.Find(var_59_1, "PlayerName")
		local var_59_3 = arg_59_0:Find("PizzaContainer")

		getProxy = var_59_1
		PlayerProxy = var_6

		local var_59_4 = var_59_1(var_6)
		local var_59_5 = var_4.getData(var_59_4).name

		setText = var_59_4

		var_59_4(var_59_2, var_59_5)

		getProxy = var_59_4
		PlayerProxy = var_9

		local var_59_6 = var_59_4(var_9)
		local var_59_7 = var_7.getRawData(var_59_6)

		getProxy = var_2_10008
		UserProxy = var_10

		local var_59_8 = var_2_10008(var_10)
		local var_59_9 = var_8.getRawData(var_59_8)

		getProxy = var_59_6
		ServerProxy = var_2_10011

		local var_59_10 = var_59_6(var_2_10011)
		...
		var_2_10013(var_59_17:Find("name/value"), var_59_14)

		setText = var_2_10013

		var_2_10013(var_59_17:Find("server/value"), var_59_15)

		setText = var_2_10013

		var_2_10013(var_59_17:Find("lv/value"), var_59_7.level)

		cloneTplTo = var_2_10013

		local var_59_18 = var_2_10013(arg_58_0.pizzaTF, var_59_3)

		setLocalPosition = var_59_16
		tf = var_16

		var_59_16(var_16(var_59_18), {
			x = 0,
			y = 0
		})

		setLocalScale = var_59_16
		tf = var_16
		...
		local var_59_19 = var_59_16.ShareMgr.GetInstance()
		local var_59_20 = var_14.Share

		pg = var_17

		var_59_20(var_59_19, var_17.ShareMgr.TypePizzahut)
...
function var_0_1.initSD(arg_60_0)
	...
	local var_60_1 = var_1.New("chuixue_6", function(arg_61_0)
		...
		Vector3 = var_2_10002
		var_61_0.localScale = var_2_10002.one
...
function var_0_1.showBubble(arg_62_0, arg_62_1)
	...
	local function var_62_1(arg_63_0)
		...
		var_63_0(var_63_1, var_2_10004.one * arg_63_0)
	...
	local function var_62_2()
		...
		local var_64_1 = var_64_0(var_2_10002(arg_62_0.bubble), 1, 0, var_0_1.FADE_OUT_TIME)
		local var_64_2 = var_0.setOnUpdate

		System = var_3

		local var_64_3 = var_64_2(var_64_1, var_3.Action_float(var_62_1))
		local var_64_4 = var_0.setOnComplete

		System = var_3

		var_64_4(var_64_3, var_3.Action(function()
	...
	var_62_3(var_1_10007(arg_62_0.bubble))
	...
	local var_62_5 = var_62_4(var_7(arg_62_0.bubble), 0, 1, var_0_1.FADE_TIME)
	local var_62_6 = var_5.setOnUpdate

	System = var_8

	local var_62_7 = var_62_6(var_62_5, var_8.Action_float(var_62_1))
	local var_62_8 = var_5.setOnComplete

	System = var_8

	var_62_8(var_62_7, var_8.Action(function()
		LeanTween = var_2_10000
		...
		local var_66_1 = var_2_10002(arg_62_0.bubble)
		local var_66_2 = var_0_1.SHOW_TIME

		System = var_4

		var_66_0(var_66_1, var_66_2, var_4.Action(var_62_2))
