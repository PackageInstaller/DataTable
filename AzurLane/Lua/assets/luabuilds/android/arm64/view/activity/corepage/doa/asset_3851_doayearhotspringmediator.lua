...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.UNLOCK_SLOT, function(arg_2_0, arg_2_1)
		...
		i18n = var_2_10007
		var_2_4.content = var_2_10007("hotspring_expand", var_2_2)
		...
		function var_2_4.onYes()
			...
			if var_0.GetCoins(var_3_0) < var_2_2 then
				...
				var_3_2(var_3_1, var_3_10004("hotspring_tip2"))
	...
	arg_1_0:bind(var_0_1.OPEN_INFO, function()
		...
		DOAYearHotSpringShipSelectMediator = var_2_10006
		var_5_3.mediator = var_2_10006
		DOAYearHotSpringShipSelectLayer = var_2_10006
...
function var_0_1.OnSelShips(arg_7_0, arg_7_1, arg_7_2)
	...
	var_7_1.priorEquipUpShipIDList = var_7_3(var_7.GetShipIds(var_7_4), function(arg_10_0)
		return arg_10_0 > 0
	end)
	i18n = var_5
	...
	local var_7_7 = var_8.New
	local var_7_8 = {}

	DockyardScene = var_1_10011
	var_7_8.viewComponent = var_1_10011
	DockyardMediator = var_1_10011
	var_7_8.mediator = var_1_10011
...
function var_0_1.OnSelected(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	local var_14_1 = var_1_10004(var_6.GetShipIds(var_14_0))

	_ = var_1_10005

	local var_14_2 = var_1_10005.each

	_ = var_1_10007

	local var_14_3 = var_1_10007.range
	local var_14_4 = arg_14_0.activity

	var_14_2(var_14_3(var_9.GetSlotCount(var_14_4)), function(arg_15_0)
	...
	if arg_14_2 == nil or #arg_14_2 == 0 then
		...
		if 0 < var_14_2 then
			...
			local var_14_7 = var_9.ACTIVITY_OPERATION
			local var_14_8 = {
				activity_id = arg_14_0.activity.id
			}

			SpringActivity = var_11
			var_14_8.cmd = var_11.OPERATION_SETSHIP
			var_14_8.kvargs1 = {
				{
					value = 0,
					key = arg_14_1
	...
	var_14_6.Foreach(var_14_1, function(arg_17_0, arg_17_1)
		if arg_17_1 ~= 0 then
			table = var_2_10002
	...
	var_8.Foreach(var_14_1, function(arg_19_0, arg_19_1)
		local var_19_0
	...
	if #var_14_11 > 0 then
		...
		local var_14_16 = var_11.ACTIVITY_OPERATION
		local var_14_17 = {
			activity_id = arg_14_0.activity.id
		}

		SpringActivity = var_13
		var_14_17.cmd = var_13.OPERATION_SETSHIP
...
function var_0_1.handleNotification(arg_21_0, arg_21_1)
	...
	if var_21_1 == nil then
		...
		ActivityProxy = var_21_0

		local var_21_5

		if var_21_1 == var_21_0.ACTIVITY_SHOW_AWARDS then
			local var_21_4 = arg_21_0.viewComponent

			var_21_5 = var_21_5.emit
			BaseUI = var_1_10007

			var_21_5(var_21_4, var_1_10007.ON_ACHIEVE, var_21_3.awards, var_21_3.callback)
		else
			ActivityProxy = var_21_5

			if var_21_1 == var_21_5.ACTIVITY_UPDATED then
				local var_21_6 = var_21_3:getConfig("type")

				ActivityConst = var_21_2

				if var_21_6 == var_21_2.ACTIVITY_TYPE_HOTSPRING then
					arg_21_0.activity = var_21_3

					local var_21_7 = arg_21_0.viewComponent

					var_4.SetActivity(var_21_7, var_21_3)

					local var_21_8 = arg_21_0.viewComponent

					var_4.UpdateView(var_21_8)
				end
			elseif var_21_1 == var_0_1.OPEN_CHUANWU then
				...
				var_21_10(var_21_9, var_21_11, var_1_10008(var_21_3))
			elseif var_21_1 == var_0_1.UNLOCK_SLOT then
				local var_21_12 = arg_21_0.viewComponent

				var_4.emit(var_21_12, var_0_1.UNLOCK_SLOT, var_21_3)
			end
		end
	end
