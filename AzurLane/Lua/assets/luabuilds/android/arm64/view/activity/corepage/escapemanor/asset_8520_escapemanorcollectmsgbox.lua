...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.CorePage.DOA.DOACoreActivityMsgBox"))
...
function var_0_1.Show(arg_3_0, arg_3_1)
	...
	var_1_10003(arg_3_0.iconTF, var_3_1)

	UpdateOwnDisplay = var_1_10003

	var_1_10003(arg_3_0.ownTF, var_3_1)
	...
	local var_3_4 = var_6.Find(var_3_3, "Text")
	...
	if 1 < var_3_8 then
		...
		Vector3 = var_3_4
		var_3_9.localPosition = var_3_4(130, -49, 0)
	end
	...
	var_3_9.StaticAlign(arg_3_0.list, arg_3_0.tpl, var_3_8, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			var_2_10007(arg_4_2.Find(var_4_3, "mask/title"), var_4_2)

			local var_4_4 = arg_4_2:Find("skip_btn")

			setText = var_2_10008

			local var_4_5 = var_4_4:Find("text")

			i18n = var_4_3

			var_2_10008(var_4_5, var_4_3("task_go"))
			...
			var_2_10008(var_4_6, var_4_7, var_4_8, var_13)
