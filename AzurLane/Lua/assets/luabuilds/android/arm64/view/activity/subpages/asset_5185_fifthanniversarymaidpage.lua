...
local var_0_0 = "FifthAnniversaryMaidPage"
	...
	var_1.make(var_3_7, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10005.EventInit then
			...
			if arg_4_0 == var_4_4.EventUpdate then
				local var_4_10 = var_4_3:getTaskStatus()
				local var_4_11 = arg_4_2
				local var_4_12 = arg_4_2.Find(var_4_11, "got")
				local var_4_13 = arg_4_2:Find("get")

				setActive = var_4_11

				var_4_11(var_4_13, var_4_10 == 1 and arg_3_0.remainCnt > 0)

				setActive = var_4_11

				var_4_11(var_4_12, var_4_10 == 2)
				...
				local function var_4_16()
					...
					var_6_1(var_6_0, var_3_10003.ON_TASK_SUBMIT, var_4_3)
				...
				var_4_11(var_4_14, var_4_15, var_4_16, var_2_10013)
			end
		end
...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	arg_7_0.unlockCnt = var_7_4(var_7_3, var_7_6, var_6.GetServerTime(var_7_7)) + 1

	local var_7_8

	if not (arg_7_0.unlockCnt > arg_7_0.totalCnt) or not arg_7_0.totalCnt then
		var_7_8 = arg_7_0.unlockCnt
	end

	arg_7_0.unlockCnt = var_7_8

	local var_7_9 = arg_7_0.usedCnt

	arg_7_0.remainCnt = arg_7_0.totalCnt <= var_7_9 and 0 or arg_7_0.unlockCnt - arg_7_0.usedCnt
	setText = var_2

	local var_7_10 = arg_7_0.countTF

	string = var_7_6

	var_2(var_7_10, var_7_6.format("%02d", arg_7_0.remainCnt))

	local var_7_11 = arg_7_0.activity
	local var_7_12 = var_2.getConfig(var_7_11, "config_client").story
	...
	for iter_7_2, iter_7_3 in var_3(arg_7_0.taskList) do
		...
		if var_8.getFinishTaskById(var_7_13, iter_7_3) then
			checkExist = var_1_10009

			if var_1_10009(var_7_12, {
				iter_7_2
			}, {
				1
			}) then
				...
				local var_7_14 = var_1_10009.NewStoryMgr.GetInstance()

				var_1_10009.Play(var_7_14, var_7_12[iter_7_2][1])
			end
		end
	end

	local var_7_15 = arg_7_0.itemList

	var_3.align(var_7_15, #arg_7_0.taskList)
