...
function var_0_1.init(arg_5_0)
	...
	local var_5_1 = var_3.Find(var_5_0, "piece/Text")

	i18n = var_4

	var_1(var_5_1, var_4("activity_permanent_tips2"))

	onButton = var_1

	local var_5_2 = arg_5_0
	local var_5_3 = arg_5_0.permanentFinshMask
	local var_5_4 = var_4.Find(var_5_3, "piece/arrow/Image")
	...
	local function var_5_5()
		...
		var_6_1(var_6_0, var_2_10003.FINISH_ACTIVITY_PERMANENT)
	...
	var_1(var_5_2, var_5_4, var_5_5, var_5_3)
	...
	var_1.make(var_5_6, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			if var_3.getConfig(var_7_0, "title_res_tag") then
				local var_7_1 = arg_7_2
				local var_7_2 = arg_7_2.Find(var_7_1, "red")
				...
				if not var_7_0("activityuitable/" .. var_4 .. "_text", "") then
					...
					var_7_3 = var_7_3("activityuitable/activity_text", "")
				end
				...
				if not var_7_1("activityuitable/" .. var_4 .. "_text_selected", "") then
					GetSpriteFromAtlas = var_7_4
					var_7_4 = var_7_4("activityuitable/activity_text_selected", "")
				end

				setImageSprite = var_8

				var_8(arg_7_2:Find("off/text"), var_7_3, true)

				setImageSprite = var_8

				var_8(arg_7_2:Find("on/text"), var_7_4, true)
				...
				var_8(var_7_5, var_3.readyToAchieve(var_7_6))
				...
				var_8(var_7_7, var_2_10011, var_7_8, var_7_6)
			end

			local var_7_9 = arg_5_0.pageDic[var_3.id]
			...
			local function var_7_12(arg_9_0)
				if var_7_9 then
					if arg_9_0 then
			...
			var_6(var_7_10, var_7_11, var_7_12, var_2_10011)
		end
...
function var_0_1.didEnter(arg_10_0)
	...
	var_1(var_10_2, var_10_3, var_10_4, var_1_10006)
...
function var_0_1.setActivities(arg_21_0, arg_21_1)
	...
	CompareFuncs = iter_21_0

	var_21_2(var_21_3, iter_21_0({
		function(arg_22_0)
...
function var_0_1.updateActivity(arg_25_0, arg_25_1)
	...
	if var_1_10002.PageIdLink[arg_25_1.id] then
		...
		local var_25_0 = var_2(var_1_10004)
		local var_25_1 = var_2.getActivityById

		ActivityConst = var_1_10005
		arg_25_1 = var_25_1(var_25_0, var_1_10005.PageIdLink[arg_25_1.id])
	end
	...
	if arg_25_1:isShow() then
		...
		if var_25_3(var_25_2, var_25_4) and not arg_25_1:isEnd() then
			...
			if arg_25_0.activity and arg_25_0.activity.id == arg_25_1.id then
				...
				if var_6.activity_task_permanent[arg_25_1.id] then
...
function var_0_1.removeActivity(arg_28_0, arg_28_1)
	if arg_28_0:getActivityIndex(arg_28_1) then
		table = var_1_10003

		var_1_10003.remove(arg_28_0.activities, var_2)

		local var_28_0 = arg_28_0.pageDic[arg_28_1]

		var_3.Destroy(var_28_0)
	...
	var_3.make(var_31_2, function(arg_32_0, arg_32_1, arg_32_2)
		...
		if arg_32_0 == var_2_10003.EventUpdate then
			...
			if var_32_0 then
				...
				if var_2_10006.getCount(var_32_0) ~= 0 and var_32_0.isShow() then
					...
					var_2_10006(var_32_3, var_32_4, var_32_5, var_2_10011)
			...
			var_2_10006(arg_32_2:Find("tip"), var_32_2)

			LoadImageSpriteAsync = var_2_10006

			var_2_10006("activitybanner/" .. var_32_1, arg_32_2)
		end
...
function var_0_1.selectActivity(arg_35_0, arg_35_1)
	...
	var_35_1(var_35_0, function()
		...
		if var_4.activity_task_permanent[arg_35_1.id] then
			local var_40_3 = arg_35_1

			var_40_4 = var_4.canPermanentFinish(var_40_3)
		end
...
function var_0_1.verifyTabs(arg_42_0, arg_42_1)
	...
	if not arg_42_0.getActivityIndex(var_42_0, arg_42_1) then
		var_42_1 = 1
	end

	local var_42_2 = arg_42_0.tabs
	local var_42_3 = var_3.GetChild(var_42_2, var_42_1 - 1)

	triggerToggle = var_42_0

	var_42_0(var_42_3, true)
...
function var_0_1.loadActivityPanel(arg_43_0, arg_43_1, arg_43_2)
	...
	local var_43_1 = arg_43_2.getConfig(var_43_0, "type")
	local var_43_2

	if var_43_2 and arg_43_1 then
		local var_43_3 = arg_43_0

		var_43_0 = arg_43_0.emit
		ActivityMediator = var_1_10008

		var_43_0(var_43_3, var_1_10008.OPEN_LAYER, var_43_2)
	elseif var_43_2 and not arg_43_1 then
		local var_43_4 = arg_43_0

		var_43_0 = arg_43_0.emit
		ActivityMediator = var_1_10008

		var_43_0(var_43_4, var_1_10008.CLOSE_LAYER, var_43_2.mediator)
	else
		originalPrint = var_43_0

		var_43_0("------活动id为" .. arg_43_2.id .. "类型为" .. arg_43_2:getConfig("type") .. "的页面不存在")
	end
...
function var_0_1.getBonusWindow(arg_44_0, arg_44_1, arg_44_2)
	...
	if not var_3.Find(var_44_0, arg_44_1) then
		...
		local var_44_1 = var_1_10004.GetInstance()
...
function var_0_1.ShowWindow(arg_46_0, arg_46_1, arg_46_2)
	...
	if not arg_46_0.windowList[var_46_0] then
		arg_46_0:getBonusWindow(var_46_0, function(arg_47_0)
			...
			tf = var_2_10005
			var_47_0[var_47_1] = var_47_2(var_2_10005(arg_47_0), arg_46_0)
