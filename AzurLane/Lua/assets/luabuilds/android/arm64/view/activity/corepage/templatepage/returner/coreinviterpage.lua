...
local var_0_0 = var_0_10000("CoreInviterPage")
...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_1 = var_3.Find(var_1_0, "bg1/pt_panel/slider/Text")
	local var_1_2 = var_3.GetComponent

	typeof = var_6
	Text = var_1_10008
	arg_1_0.ptTxt = var_1_2(var_1_1, var_6(var_1_10008))

	local var_1_3 = arg_1_0._tf
	local var_1_4 = var_3.Find(var_1_3, "bg1/pt_panel/total_progress")
	local var_1_5 = var_3.GetComponent

	typeof = var_6
	Text = var_1_10008
	arg_1_0.phaseTotalTxt = var_1_5(var_1_4, var_6(var_1_10008))

	local var_1_6 = arg_1_0._tf
	local var_1_7 = var_3.Find(var_1_6, "bg1/pt_panel/progress")
	local var_1_8 = var_3.GetComponent

	typeof = var_6
	Text = var_1_10008
	arg_1_0.phaseTxt = var_1_8(var_1_7, var_6(var_1_10008))

	local var_1_9 = arg_1_0._tf

	arg_1_0.progress = var_3.Find(var_1_9, "bg1/pt_panel/slider")

	local var_1_10 = arg_1_0._tf

	arg_1_0.getBtn = var_3.Find(var_1_10, "bg1/pt_panel/get")

	local var_1_11 = arg_1_0._tf

	arg_1_0.awardTF = var_3.Find(var_1_11, "bg1/pt_panel/item")

	local var_1_12 = arg_1_0._tf

	arg_1_0.awardOverView = var_3.Find(var_1_12, "bg1/pt_panel/award_overview")
	...
	typeof = var_6
	Image = var_1_10008
	arg_1_0.bg = var_1_15(var_1_14, var_6(var_1_10008))
	UIItemList = var_3

	local var_1_16 = var_3.New
	local var_1_17 = arg_1_0._tf
	local var_1_18 = var_5.Find(var_1_17, "bg1/returners/content")
	local var_1_19 = arg_1_0._tf

	arg_1_0.returnerList = var_1_16(var_1_18, var_6.Find(var_1_19, "bg1/returners/content/tpl"))

	local var_1_20 = arg_1_0._tf

	arg_1_0.help = var_3.Find(var_1_20, "bg1/help")

	local var_1_21 = arg_1_0._tf

	arg_1_0.pushBtn = var_3.Find(var_1_21, "bg1/push_btn")

	local var_1_22 = arg_1_0._tf

	arg_1_0.pushedBtn = var_3.Find(var_1_22, "bg1/pushed_btn")

	local var_1_23 = arg_1_0._tf

	arg_1_0.pushDisBtn = var_3.Find(var_1_23, "bg1/push_btn_dis")

	local var_1_24 = arg_1_0._tf
	local var_1_25 = var_3.Find(var_1_24, "bg1/code")
	local var_1_26 = var_3.GetComponent

	typeof = var_6
	Text = var_1_19
	arg_1_0.codeTxt = var_1_26(var_1_25, var_6(var_1_19))

	local var_1_27 = arg_1_0._tf

	arg_1_0.taskLockPanel = var_3.Find(var_1_27, "bg1/task_lock_panel")
	setText = var_3
	...
	var_3(var_1_29, var_6("word_sell_lock"))

	local var_1_30 = arg_1_0._tf

	arg_1_0.taskPanel = var_3.Find(var_1_30, "bg1/task_panel")

	local var_1_31 = arg_1_0._tf

	arg_1_0.taskItemTF = var_3.Find(var_1_31, "bg1/task_panel/item")

	local var_1_32 = arg_1_0._tf

	arg_1_0.taskProgress = var_3.Find(var_1_32, "bg1/task_panel/progress")

	local var_1_33 = arg_1_0._tf

	arg_1_0.taskDesc = var_3.Find(var_1_33, "bg1/task_panel/desc")

	local var_1_34 = arg_1_0._tf

	arg_1_0.taskGoBtn = var_3.Find(var_1_34, "bg1/task_panel/go")

	local var_1_35 = arg_1_0._tf

	arg_1_0.taskGotBtn = var_3.Find(var_1_35, "bg1/task_panel/got")

	local var_1_36 = arg_1_0._tf

	arg_1_0.taskGetBtn = var_3.Find(var_1_36, "bg1/task_panel/get")

	local var_1_37 = arg_1_0._tf
	local var_1_38 = var_3.Find(var_1_37, "bg1/task_panel/p")
	local var_1_39 = var_3.GetComponent

	typeof = var_6
	Text = var_8
	arg_1_0.taskProgressTxt = var_1_39(var_1_38, var_6(var_8))
	setText = var_3

	local var_1_40 = arg_1_0._tf
	local var_1_41 = var_5.Find(var_1_40, "bg1/pt_panel/title")

	i18n = var_6

	var_3(var_1_41, var_6("activity_return_reward_pt"))
	arg_1_0:Init()
...
function var_0_0.Init(arg_2_0)
	...
	local function var_2_2()
		...
		local var_3_2 = var_2_10003.RETURN_AWARD_OP
		local var_3_3 = {
			activity_id = arg_2_0.activity.id
		}

		ActivityConst = var_5
		var_3_3.cmd = var_5.RETURN_AWARD_OP_GET_AWARD
	...
	local function var_2_5()
		...
		var_4_3.cmd = var_2_10005.RETURN_AWARD_OP_SHOW_AWARD_OVERVIEW
		var_4_3.arg1 = {
			blur = true,
	...
	local function var_2_8()
		...
		if not arg_2_0.returners or #arg_2_0.returners >= 3 then
			...
			var_5_1(var_5_0, var_2_10003("returner_max_count"))
		...
		i18n = var_2_10004
		var_5_4.content = var_2_10004("returner_push_tip")
		...
		function var_5_4.onYes()
			...
			ActivityConst = var_5
			var_6_3.cmd = var_5.RETURN_AWARD_OP_PUSH_UID
...
function var_0_0.Update(arg_7_0, arg_7_1)
	...
	if var_1_10003.FetchReturnersTime then
		...
		if var_3.FetchReturnersTime <= var_7_1 then
			...
			local var_7_4 = var_1_10006.RETURN_AWARD_OP
			local var_7_5 = {
				activity_id = arg_7_0.activity.id
			}

			ActivityConst = var_8
			var_7_5.cmd = var_8.RETURN_AWARD_OP_GET_RETRUNERS
...
function var_0_0.UpdateUI(arg_10_0)
	...
	local function var_10_6()
		...
		var_11_1(var_11_0, var_2_10003.ON_DROP, var_10_3)
	...
	var_3(var_10_4, var_10_5, var_10_6, var_1_10008)
...
function var_0_0.UpdateTasks(arg_13_0, arg_13_1)
	if arg_13_0.isPush then
		...
		local var_13_2 = var_1_10004(var_1_10006)
		local var_13_3 = 0
		...
		if (not arg_13_0:getTask(arg_13_1[var_13_3]) or var_6:isReceive()) and var_13_3 < var_13_1 then
			if var_13_3 == #arg_13_1 and var_6 and var_6:isReceive() then
				...
				local var_13_6 = var_1_10010.RETURN_AWARD_OP
				local var_13_7 = {
					activity_id = var_2.id
				}

				ActivityConst = var_12
				var_13_7.cmd = var_12.RETURN_AWARD_OP_ACCEPT_TASK
...
function var_0_0.UpdateTaskTF(arg_14_0, arg_14_1)
	...
	local var_14_1 = arg_14_1.isFinish(var_14_0)
	local var_14_2 = arg_14_1:isReceive()

	setActive = var_14_0

	var_14_0(arg_14_0.taskGoBtn, arg_14_1 and not var_14_1)

	setActive = var_14_0

	var_14_0(arg_14_0.taskGotBtn, arg_14_1 and var_14_2)

	setActive = var_14_0

	var_14_0(arg_14_0.taskGetBtn, arg_14_1 and var_14_1 and not var_14_2)
	...
	local function var_14_7()
		...
		var_15_1(var_15_0, var_2_10003.ON_DROP, var_14_4)
	...
	var_6(var_14_5, var_14_6, var_14_7, var_1_10011)
	...
	local function var_14_14()
		...
		var_16_1(var_16_0, var_2_10003.ON_TASK_GO, arg_14_1)
	...
	local function var_14_17()
		...
		var_17_1(var_17_0, var_2_10003.ON_TASK_SUBMIT, arg_14_1)
...
local function var_0_1(arg_18_0, arg_18_1)
	...
	var_1_10002("qicon/" .. arg_18_1:getPainting(), function(arg_19_0)
		...
		if not var_2_10001(arg_18_0) then
			...
			typeof = var_2_10004
			Image = var_2_10006
			var_19_1(var_19_0, var_2_10004(var_2_10006)).sprite = arg_19_0
		end
	...
	var_2.make(var_20_1, function(arg_21_0, arg_21_1, arg_21_2)
		...
		if arg_21_0 == var_2_10003.EventUpdate then
			...
			if var_20_0[arg_21_1 + 1] then
				var_21_0 = var_3:getIcon()
				Ship = var_2_10005

				local var_21_1 = var_2_10005.New({
					configId = var_21_0
				})

				var_0_1(arg_21_2:Find("info/icon"), var_21_1)
			...
			var_21_0(arg_21_2:Find("empty"), not var_3)

			setActive = var_21_0

			var_21_0(arg_21_2:Find("info"), var_3)
		end
