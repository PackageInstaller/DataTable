...
function var_0_1.initUI(arg_7_0)
	...
	for iter_7_0 = 0, 7 do
		...
		var_1_10006.insert(arg_7_0.entranceTFList, var_7_1)

		var_1_10006 = var_7_1:Find("Mask")

		local var_7_2 = var_7_1
		local var_7_3 = var_7_1.Find(var_7_2, "GotImg")
		local var_7_4 = var_7_1:Find("LockText")

		setActive = var_7_2

		var_7_2(var_1_10006, true)
...
function var_0_1.addListener(arg_10_0)
	...
	local function var_10_5()
		...
		pg = var_2_10004
		var_12_2.helps = var_2_10004.gametip.hololive_lianliankan.tip
	...
	for iter_10_0, iter_10_1 in var_1_10001(arg_10_0.entranceTFList) do
		local var_10_6 = iter_10_1:Find("EntranceBtn")
		...
		local function var_10_9()
			...
			var_13_2(var_13_1, var_3.GO_MINI_GAME, var_0_1.HOLOLIVE_LINKGAME_ID)
		...
		var_1_10007(var_10_7, var_10_8, var_10_9, var_1_10012)
	end
	...
	if 0 < var_15_1 then
		...
		if var_3.getConfig(var_15_2, "reward_need") <= var_15_0 then
			...
			local function var_15_5()
				...
				local var_16_2 = var_2_10003.SEND_MINI_GAME_OP
				local var_16_3 = {
					hubid = arg_15_0.linkGameHub.id
				}

				MiniGameOPCommand = var_5
				var_16_3.cmd = var_5.CMD_ULTIMATE
				var_16_3.args1 = {}
			...
			var_3(var_15_3, var_15_4, var_15_5, var_1_10008)
		else
			setActive = var_3
...
function var_0_1.updateEntranceList(arg_17_0)
	...
	for iter_17_0 = 1, 8 do
		...
		local var_17_4 = var_6
		local var_17_5 = var_6.Find(var_17_4, "LockText")
		local var_17_6 = arg_17_0.linkGameData
		local var_17_7 = var_10.GetConfigCsvLine(var_17_6, iter_17_0).unlock_txt

		setText = var_17_4

		var_17_4(var_17_5, var_17_7)

		if iter_17_0 <= var_17_0 then
			setActive = var_17_4

			var_17_4(var_17_2, false)
		...
		elseif iter_17_0 == var_17_0 + 1 then
			if arg_17_0.linkGameHub.count == 0 then
				...
				var_17_6(var_17_2, true)

				setActive = var_17_6

				var_17_6(var_17_3, false)

				setActive = var_17_6

				var_17_6(var_17_5, true)
...
function var_0_1.updateData(arg_18_0)
	...
	arg_18_0.miniGameProxy = var_1_10001(var_1_10003)
