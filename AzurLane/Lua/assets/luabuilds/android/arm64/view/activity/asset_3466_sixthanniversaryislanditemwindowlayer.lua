...
function var_0_1.init(arg_2_0)
	...
	var_1(var_3.Find(var_2_1, "content/bottom/Text"), arg_2_0.contextData.text)
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_4, var_4_5 = var_4_1(var_4_3)

	setActive = var_6

	var_6(var_4_2:Find("owner"), var_4_5)

	if var_4_5 then
		setText = var_6

		local var_4_6 = var_4_2:Find("owner")

		i18n = var_9

		var_6(var_4_6, var_9("word_own1") .. var_4_4)
	end
	...
	local var_4_7 = var_4_2:Find("line/content/Text")
	local var_4_8

	if not var_4_0.desc then
		var_4_8 = var_4_0:getConfig("desc")
	end

	var_6(var_4_7, var_4_8)
