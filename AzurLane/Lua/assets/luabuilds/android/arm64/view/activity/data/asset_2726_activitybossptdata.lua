...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".ActivityPtData"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_1 = var_1_10003(var_5)
	...
	var_1_2(var_1_4, "miss activity_event_worldboss config, ID: " .. var_1_3)

	arg_1_0.linkID = var_1_0
	arg_1_0.progress_target = var_1_4.reward_pt
...
function var_0_1.GetBossProgress(arg_2_0)
	...
	local var_2_2 = var_2.getActivityById(var_2_1, arg_2_0.linkID)
	local var_2_3 = 0

	if var_2_2 and not var_2_2:isEnd() then
		var_2_3 = var_2_2:GetBossHP() or 0
	end

	return var_2_3, arg_2_0.progress_target[var_2_0]
end
