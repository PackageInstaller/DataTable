...
function var_0_1.flushTaskData(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_1_10002(var_2_1) do
		...
		if not var_1_10007.getTaskById(var_1_10009, iter_2_1) then
			getProxy = var_1_10008
			TaskProxy = var_10

			local var_2_2 = var_1_10008(var_10)
...
function var_0_1.GetClearEnemyList(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10002(arg_3_0.activity.data2_list) do
		...
		var_1_10007(var_3_1, var_10.GetEnemyDataByStageId(var_3_2, iter_3_1).id)
	end
...
function var_0_1.UpdateAwardState(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	local var_5_5 = var_5_0.Find(var_5_4, "got")
	local var_5_6 = var_5:getTaskStatus()

	updateDrop = var_5_4
	findTF = var_1_10013

	var_5_4(var_1_10013(var_5_0, "mask"), var_5_2)

	setActive = var_5_4

	var_5_4(var_5_3, arg_5_3)

	if var_5_5 then
		setActive = var_5_4

		var_5_4(var_5_5, arg_5_3 and var_5_6 == 2)
	end

	onButton = var_5_4

	var_5_4(arg_5_0, var_5_0, function()
		local var_6_0 = arg_5_0
		local var_6_1 = var_0.emit

		BaseUI = var_2_10003

		var_6_1(var_6_0, var_2_10003.ON_DROP, var_5_2)
...
function var_0_1.RefreshAwardStates(arg_7_0)
	...
	local var_7_2 = arg_7_0:GetClearEnemyList()

	ipairs = var_7_0

	for iter_7_0, iter_7_1 in var_7_0(arg_7_0.stageTFList) do
		local var_7_3 = arg_7_0.activity
		local var_7_4 = var_8.GetEnemyDataById(var_7_3, var_7_1[iter_7_0])

		arg_7_0:UpdateAwardState(iter_7_0, iter_7_1, arg_7_0:IsStageUnlock(var_7_4, var_7_2))
	end
...
function var_0_1.OnFirstFlush(arg_8_0)
	...
	local var_8_3 = arg_8_0.GetClearEnemyList(var_8_2)
	...
	for iter_8_0, iter_8_1 in var_8_2(arg_8_0.stageTFList) do
		local var_8_5 = arg_8_0.activity
		local var_8_6 = var_9.GetEnemyDataById(var_8_5, var_8_1[iter_8_0])

		setText = var_1_10010

		var_1_10010(iter_8_1:Find("name/text"), var_8_6:getConfig("name"))

		var_1_10010 = arg_8_0:IsStageUnlock(var_8_6, var_8_3)

		arg_8_0:UpdateAwardState(iter_8_0, iter_8_1, var_1_10010)
		...
		if var_1_10010 then
			...
			var_11(arg_8_0, iter_8_1, function()
				...
				local var_9_2 = var_9_0(var_2_10002)
				...
				local var_9_10 = var_7.GetExpeditionId(var_9_9)

				SYSTEM_REWARD_PERFORM = var_2_10008

				var_9_6(var_9_5, var_9_7, var_9_8, var_9_10, var_2_10008, arg_8_0.activity.configId)
...
function var_0_1.OnUpdateFlush(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1(arg_12_0._taskList) do
		if iter_12_1:getTaskStatus() == 1 then
			...
			var_12_1(var_12_0, var_1_10010.ON_TASK_SUBMIT, iter_12_1, function()
