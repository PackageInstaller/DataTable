...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	if arg_2_0.furnitureThemeBtn and var_2_1.furniture_theme_link then
		...
		var_2(var_2_2, var_2_3, var_2_4, var_1_10007)
	end
	...
	if arg_2_0.medalBtn and var_2_1.medal_link then
		...
		var_2(var_2_5, var_2_6, var_2_7, var_1_10007)
	end
...
function var_0_1.PlayOpenEffect(arg_7_0)
	...
	var_7_1(var_7_0, var_4.delayedCall, function()
	...
	var_7_3(var_7_2, var_4.delayedCall, function()
		setActive = var_2_10000
	...
	var_7_5(var_7_4, var_4.delayedCall, function()
		setActive = var_2_10000
...
function var_0_1.PlayClickEffect(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_2 = var_1_10004(192, 60, 0)
	...
	if var_11_1 then
		...
		var_6(arg_11_0.effectClick, var_11_4)

		setActive = var_6

		var_6(arg_11_0.effectClick, true)
		...
		var_11_6(var_11_5, var_9.delayedCall, function()
			setActive = var_2_10000
