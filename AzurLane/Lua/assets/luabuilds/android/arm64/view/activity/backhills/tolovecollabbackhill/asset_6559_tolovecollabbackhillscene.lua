...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_2 = var_4.Find(var_3_1, "upper/task")

	local function var_3_3()
		local var_4_0 = arg_3_0
		local var_4_1 = var_0.emit

		ToLoveCollabBackHillMediator = var_2_10003

		var_4_1(var_4_0, var_2_10003.TASK)
	...
	local var_3_6 = var_4.Find(var_3_5, "upper/jinianzhang")
	...
	local function var_3_7()
		...
		var_5_1(var_5_0, var_2_10003.TROPHY)
	...
	local var_3_10 = var_4.Find(var_3_9, "upper/help")
	...
	local function var_3_11()
		...
		var_6_1(var_6_0, var_2_10003.PUZZLE)
	...
	local var_3_14 = var_4.Find(var_3_13, "top/return_btn")
	...
	local var_3_18 = var_4.Find(var_3_17, "top/return_main_btn")
	...
	local var_3_22 = var_4.Find(var_3_21, "top/help_btn")
	...
	local function var_3_23()
		...
		pg = var_2_10004
		var_9_2.helps = var_2_10004.gametip.tolove_main_help.tip
	...
	local var_3_26 = var_4.Find(var_3_25, "upper/xiaoyouxi")
	...
	local function var_3_27()
		...
		var_10_1(var_10_0, var_2_10003.MINI_GAME)
	...
	var_1_10001(var_3_24, var_3_26, var_3_27, var_3_25)

	onButton = var_1_10001

	local var_3_28 = arg_3_0
	local var_3_29 = arg_3_0._tf
	local var_3_30 = var_4.Find(var_3_29, "upper/tebiezuozhan")
	...
	local function var_3_31()
		...
		if var_11_1 then
			...
			if not var_11_0.isUnlock(var_11_3) then
				pg = var_11_0

				local var_11_4 = var_11_0.TipsMgr.GetInstance()
				local var_11_5 = var_3.ShowTips

				i18n = var_2_10006

				var_11_5(var_11_4, var_2_10006("common_activity_end"))
			else
				...
				local var_11_8 = var_2_10006.GO_SCENE

				SCENE = var_2_10007

				var_11_7(var_11_6, var_11_8, var_2_10007.LEVEL, {
					chapterId = var_11_2,
					mapIdx = var_11_1
				})
			end
	...
	var_1_10001(var_3_28, var_3_30, var_3_31, var_3_29)
	arg_3_0:UpdateView()
...
function var_0_1.UpdateView(arg_12_0)
	...
	local var_12_2 = var_4.Find(var_12_1, "upper/task/tips")

	ToLoveCollabTaskMediator = var_1_10005

	var_1_10002(var_12_2, var_1_10005.GetTaskRedTip())
	...
	local var_12_5 = var_12_4(var_12_3, var_5.ACTIVITY_TYPE_PUZZLA)
	local var_12_6 = false

	ipairs = var_12_3

	for iter_12_0, iter_12_1 in var_12_3(var_12_5.data1_list) do
		table = var_1_10009
	...
	var_4(var_6.Find(var_12_7, "upper/jinianzhang/tips"), var_12_6)

	setActive = var_4

	local var_12_8 = arg_12_0._tf
	local var_12_9 = var_6.Find(var_12_8, "upper/help/tips")

	PuzzleConnectMediator = var_7

	var_4(var_12_9, var_7.GetRedTip())

	setActive = var_4

	local var_12_10 = arg_12_0._tf
	local var_12_11 = var_6.Find(var_12_10, "upper/xiaoyouxi/tips")

	ToLoveGameVo = var_7

	var_4(var_12_11, var_7.ShouldShowTip())
...
function var_0_1.IsShowMainTip()
	...
	local function var_14_2()
		...
		local var_16_2 = var_16_1(var_16_0, var_2_10003.ACTIVITY_TYPE_PUZZLA)
		local var_16_3 = false

		ipairs = var_16_0

		for iter_16_0, iter_16_1 in var_16_0(var_16_2.data1_list) do
			table = var_2_10007
