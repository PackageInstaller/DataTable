...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_10 = var_3.Find(var_1_9, "panel/monster")

	typeof = var_4
	Animator = var_6
	arg_1_0.monsterAni = var_1(var_1_10, var_4(var_6))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local var_2_5 = var_4.Find(var_2_4, "close")
	...
	local var_2_9 = var_4.Find(var_2_8, "close_btn")
	...
	var_1(var_2_7, var_2_9, var_2_10, var_2_8)
	...
	local function var_2_13()
		...
		var_8(var_6_0, function()
			...
			ActivityMediator = var_3_10006

			local var_8_6 = var_3_10006.EVENT_PT_OPERATION
			local var_8_7 = {
				cmd = 1
			}
			local var_8_8 = arg_2_0.ptData

			var_8_7.activity_id = var_8.GetId(var_8_8)
	...
	var_1(var_2_11, var_2_12, var_2_13, var_2_8)

	setActive = var_1

	local var_2_14 = arg_2_0.bg

	var_1(var_3.Find(var_2_14, "blink_effect"), true)
...
function var_0_1.OnUpdateFlush(arg_10_0)
	...
	var_1_10007(var_10_8, var_1_10010(var_10_1, "#f0dbff") .. "/" .. var_10_2)
	...
	if 1 <= var_10_7 then
		...
		if not var_10(var_10_5, "#f0dbff") then
			var_10_10 = var_10_5
		end
...
function var_0_1.IsSpecialPhase(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_11_0(var_0_2) do
...
function var_0_1.UpdateMonster(arg_13_0)
	...
	local var_13_2 = arg_13_0:GetMonsterScale(var_13_1)

	setLocalScale = var_13_0

	local var_13_3 = arg_13_0.monster

	Vector2 = var_1_10006

	var_13_0(var_13_3, var_1_10006(var_13_2, var_13_2))

	setLocalScale = var_13_0

	local var_13_4 = arg_13_0.monsterReflect

	Vector2 = var_6

	var_13_0(var_13_4, var_6(var_13_2, var_13_2))
...
function var_0_1.PlayFeedAni(arg_14_0)
	if arg_14_0.isPlaying then
		...
		var_1_10002.insert(arg_14_0.coutinuePlay, var_14_1)
	...
	local var_14_4 = var_14_3(var_14_2, var_1_10004.moveX, function()
...
function var_0_1.PlayThrowFoodAni(arg_17_0, arg_17_1)
	...
	local var_17_1 = var_1_10003(500, -70)
	local var_17_2 = 1
	...
	arg_17_0.foodTimer = var_7.New(function()
		...
		var_2_10001(arg_17_0.food, var_18_0)
...
function var_0_1.PlayMonsterAni(arg_19_0)
	...
	var_6(var_19_6, var_1_10009(var_19_0, var_19_0))
	...
	var_6(var_19_7, var_9(var_19_0, var_19_0))
	...
	arg_19_0.monsterTimer = var_6.New(function()
		...
		var_2_10001(arg_19_0.monster, var_20_0)

		setLocalScale = var_2_10001

		var_2_10001(arg_19_0.monsterReflect, var_20_0)
	...
	local var_19_10 = var_19_9(var_19_8, var_9.moveX, function()
		local var_21_0 = arg_19_0
		local var_21_1 = var_0.managedTween

		LeanTween = var_2_10003

		local var_21_2 = var_21_1(var_21_0, var_2_10003.moveY, function()
...
function var_0_1.OpenMonsterWin(arg_23_0)
	...
	if var_23_2(var_23_1(arg_23_0.spriteRole)) then
		...
		var_23_3(var_3(arg_23_0.spriteRole))
	end
	...
	local var_23_6 = var_23_5(var_23_4, var_4.moveX, nil, arg_23_0.spriteRole, arg_23_0.spriteRole.localPosition.x + 20, 0.8)
