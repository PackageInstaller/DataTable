...
function var_0_1.OnInit(arg_2_0)
	...
	arg_2_0.uilist = var_2_2(var_2_3, var_4.Find(var_2_4, "tpl"))
...
function var_0_1.OnDataSetting(arg_3_0)
	...
	arg_3_0.actTaskProxy = var_1_10001(var_1_10003)
	underscore = var_1

	local var_3_0 = var_1.flatten
	local var_3_1 = arg_3_0.activity

	arg_3_0.taskGroup = var_3_0(var_3.getConfig(var_3_1, "config_data"))
	pg = var_1
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	var_1.make(var_7_0, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventInit then
			...
			local var_8_2 = arg_8_2:Find("item")
			...
			local function var_8_5()
				if arg_7_0.taskDic[var_8_1] then
					...
					if var_0.getTaskStatus(var_9_0) == 1 then
						...
						if not var_0.isOver(var_9_1) then
							...
							var_9_3(var_9_2, var_3_10003.ON_ACTIVITY_TASK_SUBMIT, {
				...
				do
					...
					var_9_5(var_9_4, var_3_10003.ON_DROP, var_2_10006)
				end
			...
			var_7(var_8_3, var_8_4, var_8_5, var_2_10012)
		else
			UIItemList = var_8_0
			...
			if arg_8_0 == var_8_0.EventUpdate then
				...
				var_2_10006(arg_8_2:Find("tip"), var_8_8 and var_8_8:getTaskStatus() == 1 and not var_8_8:isOver())
			end
		end
	...
	local function var_7_3()
		...
		var_10_1(var_10_0, var_10_2, var_2_10004.DORM3DSELECT)
	...
	local var_7_6 = var_7_2(var_1_10006)
	local var_7_7 = var_7_5(var_7_4, var_4.getRawData(var_7_6).level, "SelectDorm3DMediator")

	setActive = var_1_10002

	var_1_10002(arg_7_0.goBtn, var_7_7)

	setActive = var_1_10002

	var_1_10002(arg_7_0.lockTF, not var_7_7)

	setActive = var_1_10002

	local var_7_8 = arg_7_0.goBtn

	var_1_10002(var_4.Find(var_7_8, "tip"), var_0_1.IsShowGoRed())

	PlayerPrefs = var_1_10002

	var_1_10002.SetString("DormSignPage", var_0_1.GetDate())
...
function var_0_1.GetDate()
	...
	local var_12_2 = var_1_10003.TimeMgr.GetInstance()

	return var_12_1(var_12_0, var_3.GetServerTime(var_12_2), "%Y/%m/%d")
end
...
function var_0_1.IsShowGoRed()
	...
	return var_1_10000.GetString("DormSignPage", "") ~= var_0_1.GetDate()
end
...
function var_0_1.IsShowAwardRed()
	...
	local var_15_2 = var_15_1(var_15_0, var_1_10003.DORM_SIGN_ID)

	_ = var_1_10001

	return var_1_10001.any(var_15_2, function(arg_16_0)
