...
function var_0_1.init(arg_2_0)
	...
	typeof = var_1_10004
	YSTool = var_1_10006
	arg_2_0.ysScreenShoter = var_2_1(var_2_0, var_1_10004(var_1_10006.YSScreenShoter))
	onButton = var_1
	...
	local function var_2_7()
		...
		local var_4_1 = var_2_10002(var_2_10004)

		var_4_0(var_2.getPlayerId(var_4_1))
		...
		var_4_3(var_4_2, var_2_10003("friend_id_copy_ok"))
	...
	local function var_2_10()
		...
		local var_5_3 = var_2_10002.GameTrackerMgr.GetInstance()
		local var_5_4 = var_2.Record

		GameTrackerBuilder = var_2_10005

		var_5_4(var_5_3, var_2_10005.BuildNameCard(1, var_5_2.id))
	...
	local function var_2_13()
		...
		var_2_10000(var_2_10002.UIMgr.GetInstance().OverlayEffect, false)
		...
		local function var_6_0(arg_7_0)
			...
			var_3_10001(var_3_10003.UIMgr.GetInstance().OverlayEffect, true)
			...
			var_3_10001.MediaTool.SaveImageWithBytes(arg_7_0, function(arg_8_0, arg_8_1)
				if arg_8_0 then
					...
					var_8_1(var_8_0, var_4_10005("word_save_ok"))
				end
		...
		tackCallBack = var_2_10004

		var_6_2(var_6_1, var_2_10004, var_6_0)
		...
		local var_6_4 = var_2(var_2_10004)
		local var_6_5 = var_2.getData(var_6_4)

		pg = var_6_1

		local var_6_6 = var_6_1.GameTrackerMgr.GetInstance()
		local var_6_7 = var_3.Record

		GameTrackerBuilder = var_2_10006

		var_6_7(var_6_6, var_2_10006.BuildNameCard(2, var_6_5.id))
	...
	var_1(var_2_15, var_4("auction_success_cnt_title"))
	...
	var_1(var_2_16, var_4("auction_success_rate_title"))
	...
	var_1(var_2_17, var_4("auction_currency_title"))
	...
	var_1(var_2_18, var_4("auction_total_profit_title"))
	...
	var_1(var_2_19, var_4("auction_highest_profit_title"))
	...
	var_1(var_2_20, var_4("auction_collection_type_title"))
	...
	var_1(var_2_21, var_4("auction_collection_price_title"))
...
function var_0_1.didEnter(arg_9_0)
	...
	var_9_0(arg_9_0.uiNameText, var_9_3.name)

	setText = var_9_0

	var_9_0(arg_9_0.uiUidText, var_9_3.id)

	getProxy = var_9_0
	UserProxy = var_5

	local var_9_4 = var_9_0(var_5)
	local var_9_5 = var_3.getRawData(var_9_4)

	getProxy = var_9_2
	ServerProxy = var_6

	local var_9_6 = var_9_2(var_6)
	...
	var_9_10(arg_9_0.uiMatchesCntText, var_9_12)

	setText = var_9_10

	var_9_10(arg_9_0.uiSuccessCntText, var_5.bidSuccessCnt)
	...
	var_9_10(var_9_13, var_10.format("%.2f", var_5.totalBidPrice == 0 and 0 or var_5.totalCollectionPrice / var_5.totalBidPrice))
	...
	var_9_10(var_9_14, var_10.ForamtNumberK(var_5.gold))
	...
	var_9_10(var_9_15, var_10.ForamtNumberK(var_5.totalProfit))
	...
	var_9_10(var_9_16, var_10.ForamtNumberK(var_5.highestProfit))
	...
	local var_9_18 = var_10.format
	local var_9_19 = "<color=#393a3c>%s/</color>%s"
	local var_9_20 = var_5.unlockCollectionCnt

	pg = var_1_10014

	var_9_10(var_9_17, var_9_18(var_9_19, var_9_20, #var_1_10014.auction_collection.all))
	...
	var_9_10(var_9_21, var_10.ForamtNumberK(var_5.totalCollectionPrice))

	local var_9_22 = var_9_3:GetShipPhantomMarks()[1]

	getProxy = var_9_11
	BayProxy = var_10

	local var_9_23 = var_9_11(var_10)

	arg_9_0.shipVO = var_8.GetShipPhantom(var_9_23, var_9_22)
	setPaintingPrefabAsync = var_8

	local var_9_24 = arg_9_0.uiPaintingTf
	local var_9_25 = arg_9_0.shipVO
	local var_9_26 = var_11.getPainting(var_9_25)
	local var_9_27 = "biandui"
	local var_9_28
	local var_9_29 = {}
	local var_9_30 = arg_9_0.shipVO

	var_9_29.skinID = var_15.getSkinId(var_9_30)
	var_9_29.rotateZ = arg_9_0.paintingDefaultAngle.z

	var_8(var_9_24, var_9_26, var_9_27, var_9_28, var_9_29)

	GetImageSpriteFromAtlasAsync = var_8

	local var_9_31 = "SquareIcon/"
	local var_9_32 = arg_9_0.shipVO

	var_8(var_9_31 .. var_11.getPainting(var_9_32), "", arg_9_0.uiIcon)

	pg = var_8

	local var_9_33 = var_8.GameTrackerMgr.GetInstance()
	local var_9_34 = var_8.Record

	GameTrackerBuilder = var_11

	var_9_34(var_9_33, var_11.BuildNameCard(0, var_9_3.id))
...
function var_0_1.willExit(arg_10_0)
	...
	var_1_10001(var_10_0, var_4.getPainting(var_10_1))
