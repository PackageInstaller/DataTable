...
function var_0_1.OnInit(arg_6_0)
	...
	local var_6_5 = var_3.Find(var_6_4, "title")

	i18n = var_4

	var_1(var_6_5, var_4("collect_page_got"))
	...
	local var_6_8 = var_3.Find(var_6_7, "title")

	i18n = var_4

	var_1(var_6_8, var_4("collect_page_got"))
...
function var_0_1.Show(arg_7_0, arg_7_1)
	...
	var_1_10003(arg_7_0.iconTF, var_7_1)

	UpdateOwnDisplay = var_1_10003

	var_1_10003(arg_7_0.ownTF, var_7_1)
	...
	local var_7_4 = var_6.Find(var_7_3, "Text")
	...
	var_5.StaticAlign(arg_7_0.list, arg_7_0.tpl, var_7_8, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			local var_8_3 = arg_8_2:Find("skip_btn")
			...
			local function var_8_6()
				if var_8_0 == var_0_1.SKIP_TYPE_SCENE then
					...
					var_9_1(var_9_0, var_3_10003, var_3_10004, var_9_2)
				elseif var_8_0 == var_0_1.SKIP_TYPE_ACTIVITY then
					...
					local var_9_5 = var_3_10003.GO_SCENE

					SCENE = var_3_10004

					var_9_4(var_9_3, var_9_5, var_3_10004.ACTIVITY, {
						id = var_8_1
					})
				end
			...
			var_2_10008(var_8_4, var_8_5, var_8_6, var_2_10013)
...
function var_0_1.setWindowSize(arg_10_0, arg_10_1)
	...
	var_1_10002(var_10_0, var_1_10005(716, 7 + 50 * arg_10_1))
