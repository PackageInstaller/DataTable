...
function var_0_1.register(arg_1_0)
	...
	var_1_8(var_1_7, var_8.isLegalToFight(var_1_9) == true)
...
function var_0_1.bindEvent(arg_2_0)
	...
	arg_2_0:bind(var_0_1.REMOVE_SHIP, function(arg_7_0, arg_7_1, arg_7_2)
		(function(arg_8_0, arg_8_1)
			if not arg_8_0:canRemove(arg_8_1) then
				...
				local var_8_1, var_8_2 = arg_8_0.getShipPos(var_8_0, arg_8_1)

				pg = var_8_0

				local var_8_3 = var_8_0.TipsMgr.GetInstance()
				local var_8_4 = var_4.ShowTips

				i18n = var_3_10007

				local var_8_5 = "ship_formationUI_removeError_onlyShip"
				local var_8_6 = arg_8_1
				local var_8_7 = arg_8_1.getConfigTable(var_8_6).name
				local var_8_8 = arg_8_0.name

				Fleet = var_8_6

				var_8_4(var_8_3, var_3_10007(var_8_5, var_8_7, var_8_8, var_8_6.C_TEAM_NAME[var_8_2]))
	...
	arg_2_0:bind(var_0_1.CHANGE_FLEET_SHIP, function(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
		...
		local var_10_2 = var_10_1(var_2_10007.map(arg_2_0.contextData.fleets, function(arg_11_0)
			return arg_11_0:GetRawShipIds()
		end))

		BossRushFleetSelectMediator = var_2_10006

		local var_10_3, var_10_4, var_10_5 = var_2_10006.getDockCallbackFuncs(arg_10_1, arg_10_2, arg_10_3, var_10_2, arg_2_0.contextData.actId)
		local var_10_6 = arg_2_0
		local var_10_7 = var_9.sendNotification

		GAME = var_12

		local var_10_8 = var_12.GO_SCENE

		SCENE = var_2_10013

		local var_10_9 = var_2_10013.DOCKYARD
		local var_10_10 = {
			selectedMin = 0,
			useBlackBlock = true,
			selectedMax = 1,
		...
		i18n = var_2_10015
		var_10_10.leastLimitMsg = var_2_10015("battle_preCombatMediator_leastLimit")
		...
		var_10_12.__index = var_2_10019.TAG_HIDE_ACTIVITY_BOSS
		var_10_10.hideTagFlags = var_15(var_10_11, var_10_12)
	...
	arg_2_0:bind(var_0_1.ON_UPDATE_CUSTOM_FLEET, function(arg_12_0)
		...
		var_2_10001.each(arg_2_0.contextData.fleets, function(arg_13_0)
			...
			local var_13_0 = var_3_10001(var_3_10003)
		...
		var_2_10002.each(arg_2_0.contextData.fleets, function(arg_14_0)
		...
		var_12_2(var_12_1, var_5.EDIT_ACTIVITY_FLEET, {
		...
		var_2({
			function(arg_16_0)
				for iter_16_0 = 1, #arg_2_0.contextData.fleets - 1 do
					...
					if var_5.isLegalToFight(var_16_0) ~= true then
						...
						var_16_2(var_16_1, var_3_10009("series_enemy_team_notenough"))
			...
			function(arg_19_0)
				...
				var_3_10001.SerialIpairsAsync(arg_2_0.contextData.fleets, function(arg_20_0, arg_20_1, arg_20_2)
					...
					local var_20_4 = arg_2_0.contextData.actId
					...
					if var_4_10006.any(arg_20_1:getShipIds(), function(arg_21_0)
						...
						local var_21_1, var_21_2 = var_5_10002.ShipStatusCheck("inActivity", var_1, nil, {
							inActivity = var_20_4
						})
				...
				if var_22_0 == var_3_10002.MODE.SINGLE then
					...
					if var_22_0.any(arg_2_0.contextData.fleets, function(arg_23_0)
						...
						return var_4_10001.any(arg_23_0:GetRawShipIds(), function(arg_24_0)
							...
							local var_24_0 = var_5_10001(var_5_10003)
							local var_24_1 = var_1.RawGetShipById(var_24_0, arg_24_0)
							local var_24_2 = var_1.getEnergy(var_24_1)

							pg = var_24_0

							return var_24_2 <= var_24_0.gameset.series_enemy_mood_limit.key_value
						end)
					end) then
						pg = var_22_0
						...
						var_22_0(var_22_1, var_4("series_enemy_mood_error"))
					...
					var_22_0.SerialIpairsAsync(arg_2_0.contextData.fleets, function(arg_25_0, arg_25_1, arg_25_2)
						...
						local var_25_1 = var_4_10005.map

						_ = var_4_10007

						local var_25_2 = var_25_1(var_4_10007.values(arg_25_1.ships), function(arg_26_0)
							getProxy = var_5_10001
							BayProxy = var_5_10003

							local var_26_0 = var_5_10001(var_5_10003)
						...
						var_25_0(var_25_2, var_4_10006.DEFAULT_NAME[arg_25_0], function(arg_27_0)
							if arg_27_0 then
								arg_25_2()
							end
			...
			function(arg_28_0)
				...
				local var_28_0 = var_3_10001(var_3_10003)
				...
				if var_1.GoldMax(var_28_1, 1) then
					...
					local var_28_3 = var_28_2 .. var_28_0("resource_max_tip_battle")

					getProxy = var_3
					ChapterProxy = var_5

					local var_28_4 = var_3(var_5)
					local var_28_5 = var_3.StopAutoFight

					ChapterConst = var_3_10006

					var_28_5(var_28_4, var_3_10006.AUTOFIGHT_STOP_REASON.GOLD_MAX)
			...
			function(arg_29_0)
				...
				if var_2(var_4).remasterTickets < var_1 then
					pg = var_29_1
					...
					var_29_1(var_29_0, var_3_10006("levelScene_remaster_tickets_not_enough"))
				...
				i18n = var_3_10007
				var_29_4.content = var_3_10007("levelScene_activate_remaster_1", var_1)
			...
			function(arg_30_0)
				...
				local var_30_1 = var_3_10002(var_4)
				...
				var_30_3(var_30_2, var_5.BOSSRUSH_TRACE, {
					actId = arg_2_0.contextData.actId,
	...
	arg_2_0:bind(var_0_1.SHOW_CONTINUOUS_OPERATION_WINDOW, function(arg_31_0)
		...
		local var_31_2 = var_2_10004.remove(var_31_1)
		...
		local function var_31_3()
			...
			if var_0.__cname == "CollabrateBossRushSeriesData" then
				...
				BossRushSeriesData = var_3_10003

				if var_32_3 == var_3_10003.TYPE.EXTRA then
		...
		local var_31_6 = var_2_10009.New
		local var_31_7 = {}

		BossRushContinuousOperationWindowMediator = var_2_10012
		var_31_7.mediator = var_2_10012
		BossRushContinuousOperationWindow = var_2_10012
		var_31_7.viewComponent = var_2_10012
		...
		pg = var_13
		var_31_8.maxCount = var_13.gameset.series_enemy_multiple_limit.key_value
	...
	arg_2_0:bind(var_0_1.BEGIN_STAGE, function(arg_34_0)
		...
		var_34_3(var_34_2, var_2_10005.BEGIN_STAGE, {
			system = arg_2_0.contextData.system,
			actId = arg_2_0.contextData.actId,
...
function var_0_1.onAutoBtn(arg_35_0, arg_35_1)
	...
	var_35_3(var_35_2, var_1_10007.AUTO_BOT, {
...
function var_0_1.onAutoSubBtn(arg_36_0, arg_36_1)
	...
	var_36_3(var_36_2, var_1_10007.AUTO_SUB, {
...
function var_0_1.commitEdit(arg_39_0)
	...
	var_1_10002.each(arg_39_0.contextData.fleets, function(arg_41_0)
	...
	var_39_2(var_39_1, var_5.EDIT_ACTIVITY_FLEET, {
...
function var_0_1.handleNotification(arg_43_0, arg_43_1)
	...
	if var_43_1 == var_43_0.BEGIN_STAGE_DONE then
		...
		var_43_4(var_43_3, var_1_10007, var_1_10008.COMBATLOAD, var_43_2)
	else
		GAME = var_43_4

		if var_43_1 == var_43_4.BEGIN_STAGE_ERRO then
			if var_43_2 == 3 then
				pg = var_4
				...
				function var_1_10007.onYes()
					...
					var_44_1(var_44_0, var_2_10003.ON_CLOSE)

					return
				end

				var_43_6(var_43_5, var_1_10007)
			end
		else
			local var_43_8

			if var_43_1 == var_0_1.CONTINUOUS_OPERATION then
				local var_43_7 = arg_43_0.viewComponent

				var_43_8 = var_43_8.emit
				BossRushPreCombatMediator = var_1_10007

				var_43_8(var_43_7, var_1_10007.ON_START, var_43_2.battleTimes)
			else
				GAME = var_43_8

				if var_43_1 == var_43_8.BOSSRUSH_TRACE_DONE then
					...
					if var_43_1 == var_4.BOSSRUSH_TRACE_ERROR then
						return
					end
				end
			end
