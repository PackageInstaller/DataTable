...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1_10002(var_2_5, var_2_6, var_2_7, var_1_10007)
	...
	local function var_2_10()
		...
		local var_5_2 = var_2_10001.MsgboxMgr.GetInstance()
		local var_5_3 = var_1.ShowMsgBox
		local var_5_4 = {}

		MSGBOX_TYPE_LIKN_COLLECT_GUIDE = var_2_10005
		var_5_4.type = var_2_10005
		Msgbox4LinkCollectGuide = var_2_10005
		var_5_4.show_type = var_2_10005.SHOW_TYPE_NORMAL
	...
	var_1_10002(var_2_8, var_2_9, var_2_10, var_1_10007)
...
function var_0_1.UpdateView(arg_14_0)
	for iter_14_0 = 1, #arg_14_0.table_Top do
		if iter_14_0 == 1 then
			...
			local var_14_1 = var_7.Find(var_14_0, "type_image/name")

			i18n = var_1_10008

			var_1_10005(var_14_1, var_1_10008("yumia_award_1"))

			setText = var_1_10005

			local var_14_2 = arg_14_0.table_Top[iter_14_0]
			local var_14_3 = var_7.Find(var_14_2, "on/name")

			i18n = var_1_10008

			var_1_10005(var_14_3, var_1_10008("yumia_award_1"))

			setText = var_1_10005

			local var_14_4 = arg_14_0.table_Top[iter_14_0]
			local var_14_5 = var_7.Find(var_14_4, "on/name2")

			i18n = var_1_10008

			var_1_10005(var_14_5, var_1_10008("dal_AwardPage_name_1"))
		elseif iter_14_0 == 2 then
			setText = var_1_10005

			local var_14_6 = arg_14_0.table_Top[iter_14_0]
			local var_14_7 = var_7.Find(var_14_6, "type_image/name")

			i18n = var_1_10008

			var_1_10005(var_14_7, var_1_10008("yumia_award_4"))

			setText = var_1_10005

			local var_14_8 = arg_14_0.table_Top[iter_14_0]
			local var_14_9 = var_7.Find(var_14_8, "on/name")

			i18n = var_1_10008

			var_1_10005(var_14_9, var_1_10008("yumia_award_4"))

			setText = var_1_10005

			local var_14_10 = arg_14_0.table_Top[iter_14_0]
			local var_14_11 = var_7.Find(var_14_10, "on/name2")

			i18n = var_1_10008

			var_1_10005(var_14_11, var_1_10008("dal_AwardPage_name_2"))
		end
	end
...
function var_0_1.selectBoxbg(arg_15_0, arg_15_1)
	...
	if var_1_10002.getCount(arg_15_1.skipable_list) > 1 then
		...
		local var_15_1 = var_4.Find(var_15_0, "Panel/BG")

		LoadSprite = var_1_10005

		var_2(var_15_1, var_1_10005("ui/DALAwardPage_atlas", "box_bg2"), true)
	else
		table = var_2
		...
		if var_2.getCount(arg_15_1.skipable_list) == 1 then
			...
			local var_15_3 = var_4.Find(var_15_2, "Panel/BG")

			LoadSprite = var_1_10005

			var_2(var_15_3, var_1_10005("ui/DALAwardPage_atlas", "box_bg1"), true)
		end
	end
...
function var_0_1.DoSkip(arg_18_0, arg_18_1, arg_18_2)
	...
	if arg_18_1 == var_1_10003.SKIP_TYPE_SCENE then
		...
		var_18_1(var_18_0, var_1_10006, var_1_10007, var_18_2)
	else
		...
		if arg_18_1 == var_18_1.SKIP_TYPE_ACTIVITY then
			...
			local var_18_5 = var_1_10006.GO_SCENE

			SCENE = var_1_10007

			var_18_4(var_18_3, var_18_5, var_1_10007.ACTIVITY, {
				id = arg_18_2
			})
		end
	end
