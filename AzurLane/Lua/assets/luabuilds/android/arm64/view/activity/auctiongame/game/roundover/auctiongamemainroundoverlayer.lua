...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_2 = var_1_10002.GetPlayerNoSortList(var_3_1:GetRound())

	ipairs = var_3_0

	for iter_3_0, iter_3_1 in var_3_0(var_3_2) do
		local var_3_3 = arg_3_0.boardItemList

		AuctionGameMainRoundOverPlayer = var_1_10009
		var_1_10009 = var_1_10009.New
		string = var_1_10011
		var_3_3[iter_3_0] = var_1_10009(arg_3_0[var_1_10011.format("uiPlayerTf%s", iter_3_0)], arg_3_0)

		local var_3_4 = arg_3_0.boardItemList[iter_3_0]

		var_8.didEnter(var_3_4, iter_3_1.data)
	end
	...
	for iter_3_2 = #var_3_2 + 1, 4 do
		...
		iter_3_1(arg_3_0[var_1_10009.format("uiPlayerTf%s", iter_3_2)], false)
	end
