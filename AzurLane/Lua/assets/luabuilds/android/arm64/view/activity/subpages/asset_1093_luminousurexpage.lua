	...
	local function var_4_8()
		...
		if arg_4_0.canExchange then
			...
			function var_9_2.onYes()
				...
				var_10_2(var_10_1, var_3_10004.ON_ACT_SHOPPING, arg_4_0.shopId, 1, arg_4_0.curGoods.id, 1, function()
					if arg_4_0._tf then
						IsNil = var_0
				...
				var_10_4(var_10_3, var_4.BuildUrRedeem(var_10_0.commodity_id, 2))
...
function var_0_1.UpdateTask(arg_27_0, arg_27_1, arg_27_2)
	...
	if var_27_5 then
		...
		var_9(arg_27_0, arg_27_2:Find("btn_go"), function()
			...
			var_28_1(var_28_0, var_2_10003.BuildUrJump(var_27_1))
...
function var_0_1.OnUpdateFlush(arg_29_0)
	...
	var_1(var_3.Find(var_29_1, "red"), arg_29_0.canExchange)
