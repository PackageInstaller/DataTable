...
function var_0_0.UpdateActData(arg_3_0, arg_3_1)
	...
	local var_3_3 = var_3_0.ceil((var_3_1 - var_3_2) / 0) * arg_3_1:getDataConfig("daily_time")
	local var_3_4
	...
	if not arg_3_1:getDataConfig("sum_lap_reward_show") then
		var_3_11 = {}
	end

	arg_3_0.lapReward = var_3_11

	local var_3_12 = {}

	i18n = var_8
	var_3_12[1] = var_8("MonopolyCar2024Game_title1")
	i18n = var_8
	var_3_12[2] = var_8("MonopolyCar2024Game_title2")
	arg_3_0.titles = var_3_12
	_ = var_3_12
	arg_3_0.pickableShipId = var_3_12.map(arg_3_1:getDataConfig("ship_reward"), function(arg_4_0)
		return arg_4_0[1]
	end)
	arg_3_0.spEvents = {}
	ipairs = var_7
	...
	for iter_3_0, iter_3_1 in var_7(var_3_13) do
	...
	for iter_12_0, iter_12_1 in var_3(var_0_6) do
		...
		var_1_10008.insert(var_12_0, function(arg_13_0)
			...
			var_1.GetSpineChar(var_13_0, iter_12_1, true, function(arg_14_0)
				...
				local var_14_4 = var_14_3(var_14_2, var_5(var_7))
...
function var_0_0.InitUI(arg_17_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_17_0.btnAutoImg = var_17_2(var_17_1, var_4(var_1_10006))
	findTF = var_1
...
function var_0_0.RegisterUI(arg_18_0)
	...
	local function var_18_5()
		...
		pg = var_2_10004
		var_20_2.helps = var_2_10004.gametip.help_monopoly_car2024.tip
	...
	local function var_18_11()
		...
		var_22_1(var_22_0, var_2_10003.ON_CLOSE)
...
function var_0_0.EnableAuto(arg_25_0)
	...
	if arg_25_0.leftCount <= 0 then
		...
		var_25_1(var_25_0, var_1_10004("common_count_noenough"))
	...
	if arg_25_0.useCount < 10 then
		...
		var_25_3(var_25_2, var_1_10004("MonopolyCar2024Game_lock_auto_tip", arg_25_0.useCount))
	...
	var_25_6(var_25_5, var_1_10004("MonopolyCar2024Game_open_auto_tip"))
...
function var_0_0.Roll(arg_30_0, arg_30_1)
	...
	var_3({
		function(arg_31_0)
			...
			var_31_1(var_31_0, var_2_10004.ON_START, arg_30_0.actId, function(arg_32_0)
...
function var_0_0.PlayRollAnimation(arg_42_0, arg_42_1, arg_42_2)
	...
	var_1_10003(var_1_10005(arg_42_0.rollStep, "animroot/Image/Text"), "00")
	...
	local var_42_2 = var_42_1(var_42_0, var_6(var_8))
	local var_42_3 = var_3.GetComponent

	typeof = var_7
	DftAniEvent = var_1_10009

	local var_42_4 = var_42_3(var_42_2, var_7(var_1_10009))

	findTF = var_42_0

	local var_42_5 = var_42_0(arg_42_0.rollStep, "animroot")
	local var_42_6 = var_5.GetComponent

	typeof = var_8
	Animation = var_1_10010

	local var_42_7 = var_42_6(var_42_5, var_8(var_1_10010))
	local var_42_8 = var_5.GetComponent

	typeof = var_1_10009
	DftAniEvent = var_1_10011

	local var_42_9 = var_42_8(var_42_7, var_1_10009(var_1_10011))

	var_6.SetTriggerEvent(var_42_9, function()
		setText = var_2_10000
		findTF = var_2_10002

		var_2_10000(var_2_10002(arg_42_0.rollStep, "animroot/Image/Text"), "0" .. arg_42_1)
...
function var_0_0.TriggerEvent(arg_61_0, arg_61_1)
	...
	var_61_1(var_61_0, var_1_10005.ON_TRIGGER, arg_61_0.actId, function(arg_62_0, arg_62_1)
...
function var_0_0.CheckCountStory(arg_63_0, arg_63_1)
	...
	if var_1_10004.detect(var_63_1, function(arg_64_0)
		...
		local var_63_2 = var_1_10005.NewStoryMgr.GetInstance()
...
function var_0_0.CheckMove(arg_73_0, arg_73_1)
	...
	var_1_10003({
		function(arg_74_0)
			...
			var_74_1(var_74_0, var_2_10004.ON_MOVE, arg_73_0.actId, function(arg_75_0, arg_75_1, arg_75_2)
...
function var_0_0.ReadyMoveCar(arg_77_0, arg_77_1, arg_77_2)
	...
	var_7.insert(var_77_0, function(arg_80_0)
		...
		local var_80_1 = var_80_0(var_2_10003(arg_77_0._tf), 1, 0, 0.1)
		local var_80_2 = var_1.setOnComplete

		System = var_4

		var_80_2(var_80_1, var_4.Action(arg_80_0))
...
function var_0_0.MoveCar(arg_81_0)
	...
	local var_81_1 = var_1_10002.abs(arg_81_0.targetPosition.y - arg_81_0.car.localPosition.y)
	...
	if not (var_4.abs(arg_81_0.baseSpeedX) < var_81_2) or not arg_81_0.baseSpeedX then
...
function var_0_0.CheckPickCharacter(arg_83_0, arg_83_1)
	if arg_83_0.selectedShipId == 0 or #arg_83_0.pickCharList == 0 then
		local function var_83_0(arg_84_0)
			...
			var_84_3(var_84_2, var_5.ON_PICK, arg_83_0.actId, var_84_0, function(arg_85_0)
	...
	for iter_89_0 = 1, #var_0_4 do
		...
		for iter_89_1 = 1, #var_89_2 do
			...
			if 0 < var_89_4 then
				...
				local var_89_7 = var_14(var_89_5, var_89_6, var_1_10018(var_89_4))

				Vector2 = var_1_10015
				var_89_7.localPosition = var_1_10015(var_0_1 * var_89_3 + var_89_1.x, -var_0_2 * var_89_3 + var_89_1.y)
				pg = var_89_5

				local var_89_8 = var_89_5.activity_event_monopoly_map[var_89_4].icon

				GetSpriteFromAtlas = var_17

				local var_89_9 = var_17("ui/MonopolyCar2024_atlas", var_89_8)
				local var_89_10 = var_89_7

				var_1_10018 = var_89_7.GetComponent
				typeof = var_1_10021
				Image = var_1_10023
				var_1_10018 = var_1_10018(var_89_10, var_1_10021(var_1_10023))
				var_1_10018.sprite = var_89_9
				...
				local var_89_12 = var_1_10018(var_89_11, var_1_10021(var_1_10023))

				var_1_10018.SetNativeSize(var_89_12)
				...
				var_19.insert(arg_89_0.mapCells, var_1_10018)
			end
		end
	end
...
function var_0_0.InitCar(arg_91_0, arg_91_1)
	...
	var_2.GetSpineChar(var_91_0, var_0_3, true, function(arg_92_0)
		...
		var_92_3.anim = var_92_5(var_92_4, var_5(var_2_10007))
