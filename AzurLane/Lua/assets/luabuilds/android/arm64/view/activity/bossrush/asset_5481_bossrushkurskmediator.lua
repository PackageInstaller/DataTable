...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_FLEET_SELECT, function(arg_2_0, arg_2_1)
		...
		BossRushFleetSelectView = var_2_10008
	...
	arg_1_0:bind(var_0_1.ON_EXTRA_RANK, function(arg_3_0)
		...
		local var_3_3 = var_2_10005.BILLBOARD
		local var_3_4 = {}

		PowerRank = var_2_10007
		var_3_4.page = var_2_10007.TYPE_BOSSRUSH
	...
	arg_1_0:bind(var_0_1.ON_PERFORM_COMBAT, function(arg_4_0, arg_4_1, arg_4_2)
		...
		local var_4_2 = var_2_10006.BEGIN_STAGE
		local var_4_3 = {}

		SYSTEM_PERFORM = var_2_10008
		var_4_3.system = var_2_10008
	...
	arg_1_0:bind(var_0_1.GO_ACT_SHOP, function(arg_5_0, arg_5_1)
		...
		PtAwardMediator = var_2_10008
		var_5_3.mediator = var_2_10008
		PtAwardLayer = var_2_10008
	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT, function(arg_6_0, arg_6_1)
		local var_6_0 = arg_1_0
		local var_6_1 = var_2.sendNotification

		GAME = var_2_10005

		var_6_1(var_6_0, var_2_10005.SUBMIT_TASK, arg_6_1.id)
	...
	local var_1_5 = var_1_2.GetConfigClientSetting(var_1_4, "PTID")

	getProxy = var_1_1
	ActivityProxy = var_6

	local var_1_6 = var_1_1(var_6)
	local var_1_7 = var_4.getActivitiesByType

	ActivityConst = var_1_10007

	local var_1_8 = var_1_7(var_1_6, var_1_10007.ACTIVITY_TYPE_PT_BUFF)

	ipairs = var_1_4

	for iter_1_0, iter_1_1 in var_1_4(var_1_8) do
		if iter_1_1:getDataConfig("pt") == var_1_5 then
			local var_1_9 = arg_1_0.viewComponent

			var_10.SetPtActivity(var_1_9, iter_1_1)
	...
	var_5.addbubbleMsgBox(var_1_10, function(arg_7_0)
		...
		if var_7_2(var_7_1, var_2_10004) then
			return
		end
	...
	var_5.addbubbleMsgBox(var_1_11, function(arg_8_0)
		pg = var_2_10001
...
function var_0_1.handleNotification(arg_10_0, arg_10_1)
	...
	local var_10_3 = arg_10_1:getType()
	...
	if var_10_0 == nil then
		...
		if var_10_0 == var_10_1.BEGIN_STAGE_DONE then
			getProxy = var_10_5
			ContextProxy = var_1_10007

			local var_10_4 = var_10_5(var_1_10007)

			var_10_5 = var_10_5.getContextByMediator
			BossRushPreCombatMediator = var_1_10008

			if not var_10_5(var_10_4, var_1_10008) then
				...
				local var_10_7 = var_1_10009.GO_SCENE

				SCENE = var_1_10010

				var_10_6(var_1_10008, var_10_7, var_1_10010.COMBATLOAD, var_10_2)
			end
		else
			...
			if var_10_0 == var_10_5.ACTIVITY_UPDATED then
				if var_10_2 then
					if var_5.id == arg_10_0.viewComponent.activity.id then
						var_1_10008 = arg_10_0.viewComponent
					...
					elseif var_5.id == arg_10_0.viewComponent.ptActivity.id then
						...
						var_6.SetPtActivity(var_1_10008, var_5)
				...
				if var_10_0 == var_5.SUBMIT_ACTIVITY_TASK_DONE then
					...
					var_10_9(var_10_8, var_1_10008.ON_ACHIEVE, var_10_2.awards, function()
