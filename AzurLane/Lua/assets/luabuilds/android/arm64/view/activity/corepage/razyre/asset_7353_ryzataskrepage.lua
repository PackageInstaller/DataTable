...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_5 = var_6(arg_1_0.btnPoint, "text")

	i18n = var_7

	var_4(var_1_5, var_7(var_0_2))

	for iter_1_0 = 1, var_0_22 do
		findTF = var_1_6

		local var_1_6 = var_1_6(arg_1_0.taskTagPanel, "btn" .. iter_1_0)

		setText = var_9
		findTF = var_1_10011
		var_1_10011 = var_1_10011(var_1_6, "off/text")
		i18n = var_12

		var_9(var_1_10011, var_12(var_0_7[iter_1_0]))

		setText = var_9
		findTF = var_1_10011
		var_1_10011 = var_1_10011(var_1_6, "on/text")
		i18n = var_12
	...
	local var_1_7 = var_6(arg_1_0.taskDetailPanel, "desc/title")

	i18n = iter_1_0

	var_4(var_1_7, iter_1_0(var_0_8))

	setText = var_4
	findTF = var_1_7

	local var_1_8 = var_1_7(arg_1_0.taskDetailPanel, "awardText")

	i18n = var_7

	var_4(var_1_8, var_7(var_0_9))

	setText = var_4
	findTF = var_1_8

	local var_1_9 = var_1_8(arg_1_0.taskDetailPanel, "btnGet/text")

	i18n = var_7

	var_4(var_1_9, var_7(var_0_11))

	setText = var_4
	findTF = var_1_9

	local var_1_10 = var_1_9(arg_1_0.taskDetailPanel, "btnGo/text")

	i18n = var_7

	var_4(var_1_10, var_7(var_0_10))

	setText = var_4
	findTF = var_1_10

	local var_1_11 = var_1_10(arg_1_0.taskDetailPanel, "btnSubmit/text")

	i18n = var_7

	var_4(var_1_11, var_7(var_0_13))

	setText = var_4
	findTF = var_1_11

	local var_1_12 = var_1_11(arg_1_0.taskDetailPanel, "btnDetail/text")

	i18n = var_7

	var_4(var_1_12, var_7(var_0_12))

	setText = var_4
	findTF = var_1_12

	local var_1_13 = var_1_12(arg_1_0.btnGetAll, "text")

	i18n = var_7

	var_4(var_1_13, var_7(var_0_14))

	setText = var_4
	findTF = var_1_13

	local var_1_14 = var_1_13(arg_1_0.submitPanel, "btnComfirm/text")

	i18n = var_7

	var_4(var_1_14, var_7(var_0_15))

	setText = var_4
	findTF = var_1_14

	local var_1_15 = var_1_14(arg_1_0.submitPanel, "btnCancel/text")

	i18n = var_7

	var_4(var_1_15, var_7(var_0_16))

	setText = var_4
	findTF = var_1_15

	local var_1_16 = var_1_15(arg_1_0.submitPanel, "bg/text")

	i18n = var_7

	var_4(var_1_16, var_7(var_0_20))

	setText = var_4
	findTF = var_1_16

	local var_1_17 = var_1_16(arg_1_0.pointPanel, "title")

	i18n = var_7

	var_4(var_1_17, var_7(var_0_2))

	setText = var_4
	findTF = var_1_17

	local var_1_18 = var_1_17(arg_1_0.pointPanel, "levelNum/text")

	i18n = var_7

	var_4(var_1_18, var_7(var_0_17))

	setText = var_4
	findTF = var_1_18

	local var_1_19 = var_1_18(arg_1_0.pointPanel, "levelBuff/text")

	i18n = var_7

	var_4(var_1_19, var_7(var_0_18))

	arg_1_0.pointStarTfs = {}

	local var_1_20 = arg_1_0.pointLevelStar.sizeDelta.x

	for iter_1_1 = 1, #arg_1_0.ptBuffs do
		tf = var_1_21
		Instantiate = var_1_10011

		local var_1_21 = var_1_21(var_1_10011(arg_1_0.pointStarTpl))

		SetParent = var_1_10010

		var_1_10010(var_1_21, arg_1_0.pointLevelStar)

		setActive = var_1_10010

		var_1_10010(var_1_21, true)

		setText = var_1_10010
		findTF = var_12

		var_1_10010(var_12(var_1_21, "bg/text"), iter_1_1)

		setText = var_1_10010
		findTF = var_12

		var_1_10010(var_12(var_1_21, "img/text"), iter_1_1)

		var_1_10010 = arg_1_0.ptBuffs[iter_1_1].pt[1]
		Vector3 = var_1_10011
		var_1_21.anchoredPosition = var_1_10011(var_1_10010 / arg_1_0.maxNum * var_1_20, -18, 0)
		table = var_1_10011

		var_1_10011.insert(arg_1_0.pointStarTfs, var_1_21)

		if iter_1_1 == 1 then
			setActive = var_1_10011

			var_1_10011(var_1_21, false)
		end
	end
...
function var_0_1.updateTask(arg_2_0, arg_2_1)
	...
	for iter_2_0 = 1, #var_2_1 do
		...
		local var_2_3 = var_7.getProgress(var_1_10011)
		...
		local var_2_4 = var_7.getConfig(var_1_10014, "type")
	...
	if var_2_7 then
		...
		if 0 < var_2_8 then
			for iter_2_1 = 1, #var_2_7 do
				...
				var_1_10013 = var_1_10010.New(arg_2_0.activityId, {
					progress = 0,
					id = var_2_9
				})
				...
				if var_1_10010.getConfig(var_1_10013, "ryza_type") > 0 then
					...
					if not arg_2_0.displayTask[var_1_10011] then
						var_2_10 = arg_2_0.displayTask
						var_2_10[var_1_10011] = {}
					end

					table = var_2_10

					var_2_10.insert(arg_2_0.displayTask[var_1_10011], var_1_10010)
	...
	for iter_2_2, iter_2_3 in var_6(arg_2_0.displayTask) do
		table = var_1_10011

		var_1_10011.sort(iter_2_3, var_2_11)
	end

	table = var_6

	var_6.sort(arg_2_0.allDisplayTask, var_2_11)
	...
	if arg_2_1 then
		...
		arg_2_0.onClickTag(var_2_12)
	end

	if #arg_2_0.getAllTasks > 0 then
		setActive = var_6

		var_6(arg_2_0.btnGetAll, true)
	else
		setActive = var_6

		var_6(arg_2_0.btnGetAll, false)
	end

	getProxy = var_6
	PlayerProxy = var_2_12

	local var_2_13 = var_6(var_2_12)
	local var_2_14

	if not var_6.getData(var_2_13)[arg_2_0.ptName] then
		var_2_14 = 0
	end
	...
	for iter_2_4 = #arg_2_0.ptBuffs, 1, -1 do
		var_2_15 = arg_2_0.ptBuffs[iter_2_4].pt[1] <= var_2_14 and var_2_15 < iter_2_4 and iter_2_4 or var_2_15
	end
	...
	for iter_2_5 = 1, #arg_2_0.pointStarTfs do
		...
		if iter_2_5 <= var_2_15 then
			...
			var_1_10013(var_1_10015(var_2_16, "img"), true)
		else
			setActive = var_1_10013
			findTF = var_1_10015

			var_1_10013(var_1_10015(var_2_16, "img"), false)
		end
	end
	...
	for iter_2_6 = 1, #var_2_17 do
		...
		pg = var_1_10014
		var_1_10014 = var_1_10014.benefit_buff_template[var_2_18].desc
		findTF = var_1_10015
	...
	var_9(arg_2_0.pointProgressSlider, 0, arg_2_0.maxNum, var_2_14)

	setText = var_9

	var_9(arg_2_0.pointProgressText, var_2_14 .. "/" .. arg_2_0.maxNum)

	setText = var_9
	findTF = var_11

	local var_2_19 = var_11(arg_2_0.btnPoint, "text")

	i18n = var_12

	var_9(var_2_19, var_12(var_0_2) .. "Lv." .. var_2_15)

	setText = var_9
	findTF = var_2_19

	var_9(var_2_19(arg_2_0.pointPanel, "levelNum/num"), "Lv." .. var_2_15)

	setText = var_9
	findTF = var_11

	var_9(var_11(arg_2_0.pointPanel, "levelBuff/num"), "Lv." .. var_2_15)
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local function var_4_5()
		...
		var_6_2(var_6_1, var_2_10004.SUBMIT_ACTIVITY_TASK, {
	...
	local function var_4_14()
		...
		i18n = var_2_10004
		var_9_2.helps = var_2_10004("ryza_task_help_tip")
	...
	local function var_4_17()
		...
		local var_10_1 = var_2_10001.m02
		local var_10_2 = var_1.sendNotification

		GAME = var_2_10004

		var_10_2(var_10_1, var_2_10004.TASK_GO, {
			taskVO = var_10_0
		})
	...
	var_1_10001(var_4_21, var_4_22, var_4_23, var_1_10006)
	...
	local function var_4_26()
		...
		if var_1.getConfig(var_13_2, "sub_type") == 1006 then
			...
			var_13_0.openSubmitPanel(var_13_3, arg_4_0.selectTask)
		else
			pg = var_13_0

			local var_13_4 = var_13_0.m02
			local var_13_5 = var_2.sendNotification

			GAME = var_2_10005

			var_13_5(var_13_4, var_2_10005.SUBMIT_ACTIVITY_TASK, {
				act_id = arg_4_0.activityId,
				task_ids = {
	...
	var_1_10001(var_4_24, var_4_25, var_4_26, var_1_10006)
	...
	local function var_4_29()
		...
		if var_1.getConfig(var_14_2, "sub_type") == 1006 then
			...
			var_14_0.openSubmitPanel(var_14_3, arg_4_0.selectTask)
		else
			pg = var_14_0

			local var_14_4 = var_14_0.m02
			local var_14_5 = var_2.sendNotification

			GAME = var_2_10005

			var_14_5(var_14_4, var_2_10005.SUBMIT_ACTIVITY_TASK, {
				act_id = arg_4_0.activityId,
				task_ids = {
					arg_4_0.selectTask.id
				}
	...
	var_1_10001(var_4_27, var_4_28, var_4_29, var_1_10006)
	...
	local function var_4_32()
		if arg_4_0.selectTask then
			...
			if var_0(var_2.getConfig(var_15_0, "target_id_2")) and 0 < var_0 then
				getProxy = var_1
				ActivityProxy = var_2_10003

				local var_15_1 = var_1(var_2_10003)
				local var_15_2 = var_1.getActivityByType

				ActivityConst = var_15_0

				local var_15_3 = var_15_2(var_15_1, var_15_0.ACTIVITY_TYPE_ATELIER_LINK)

				AtelierMaterial = var_2

				local var_15_4 = var_2.New
				local var_15_5 = {
					configId = var_0
				}
				local var_15_6 = arg_4_0.selectTask

				var_15_5.count = var_5.getConfig(var_15_6, "target_num")
				...
				local var_15_10 = var_2_10006.OPEN_LAYER

				Context = var_15_6

				local var_15_11 = var_15_6.New
				local var_15_12 = {}

				AtelierMaterialDetailMediator = var_2_10010
				var_15_12.mediator = var_2_10010
				AtelierMaterialDetailLayer = var_2_10010
				var_15_12.viewComponent = var_2_10010
				var_15_12.data = {
					material = var_15_7
				}
	...
	var_1_10001(var_4_30, var_4_31, var_4_32, var_1_10006)
	...
	local function var_4_35()
		...
		var_16_1(var_16_0, var_2_10003.SUBMIT_ACTIVITY_TASK, {
			act_id = arg_4_0.activityId,
			task_ids = {
				arg_4_0.selectTask.id
			}
	...
	var_1_10001(var_4_33, var_4_34, var_4_35, var_1_10006)
	...
	var_1_10001(var_4_36, var_4_37, var_4_38, var_1_10006)
	...
	for iter_4_0 = 1, var_0_22 do
		var_4_38 = iter_4_0
		findTF = var_1_10006
		var_1_10006 = var_1_10006(arg_4_0.taskTagPanel, "btn" .. var_4_38)
		onButton = var_1_10007

		var_1_10007(arg_4_0, var_1_10006, function()
			if arg_4_0.showTagIndex then
				setActive = var_0
				findTF = var_2_10002

				var_0(var_2_10002(arg_4_0.btnTags[arg_4_0.showTagIndex], "on"), false)

				if arg_4_0.showTagIndex == var_4_38 then
					arg_4_0.showTagIndex = nil
				else
					local var_18_0 = arg_4_0

					var_18_0.showTagIndex = var_4_38
					setActive = var_18_0
					findTF = var_2_10002

					var_18_0(var_2_10002(arg_4_0.btnTags[arg_4_0.showTagIndex], "on"), true)
				end
			else
				local var_18_1 = arg_4_0

				var_18_1.showTagIndex = var_4_38
				setActive = var_18_1
				findTF = var_2_10002

				var_18_1(var_2_10002(arg_4_0.btnTags[arg_4_0.showTagIndex], "on"), true)
			end
		...
		var_1_10007.insert(arg_4_0.btnTags, var_1_10006)
	end
	...
	local var_4_41 = var_2.GetInt
	local var_4_42 = "ryza_task_help_"

	getProxy = var_4_38
	PlayerProxy = var_1_10007

	local var_4_43 = var_4_38(var_1_10007)

	if var_4_41(var_4_42 .. var_5.getRawData(var_4_43).id) ~= 1 then
		var_4_40 = true
	end
	...
	if var_4_40 then
		...
		local var_4_44 = var_4_39.SetInt
		local var_4_45 = "ryza_task_help_"

		getProxy = var_1_10006
		PlayerProxy = var_1_10008

		local var_4_46 = var_1_10006(var_1_10008)

		var_4_44(var_4_45 .. var_6.getRawData(var_4_46).id, 1)
		...
		MSGBOX_TYPE_HELP = var_4_43
		var_4_49.type = var_4_43
		i18n = var_4_43
		var_4_49.helps = var_4_43("ryza_task_help_tip")
...
function var_0_1.onUpdateTaskItem(arg_21_0, arg_21_1, arg_21_2)
	...
	local var_21_2 = var_3(var_21_1, var_6(var_1_10008))
	...
	local var_21_5 = var_21_4(var_21_3, var_7.linear)
	local var_21_6 = var_4.setOnUpdate

	System = var_7

	local var_21_7 = var_21_6(var_21_5, var_7.Action_float(function(arg_22_0)
	...
	var_21_8(var_21_7, var_7.Action(function()
	...
	local var_21_14 = var_4
	local var_21_15 = var_4.isFinish(var_21_14)
	local var_21_16 = var_4:isCircle()

	setActive = var_21_14
	findTF = var_1_10014

	var_21_14(var_1_10014(arg_21_2, "selected"), arg_21_0.selectIndex == arg_21_1)

	setActive = var_21_14
	findTF = var_14

	var_21_14(var_14(arg_21_2, "typeNew"), var_4:isNew())

	setActive = var_21_14
	findTF = var_14

	var_21_14(var_14(arg_21_2, "typeCircle"), var_4:isCircle())

	setActive = var_21_14
	findTF = var_14

	var_21_14(var_14(arg_21_2, "finish"), var_21_13)

	setActive = var_21_14
	findTF = var_14

	var_21_14(var_14(arg_21_2, "mask"), var_21_13)

	setActive = var_21_14
	findTF = var_14

	var_21_14(var_14(arg_21_2, "complete"), not var_21_13 and var_21_15 and not var_21_16)

	setText = var_21_14
	findTF = var_14

	local var_21_17 = var_14(arg_21_2, "desc/text")

	shortenString = var_15

	var_21_14(var_21_17, var_15(var_21_11, 10))

	if not var_21_12 or var_21_12 == 0 then
		var_21_12 = "attack"
	end

	setImageSprite = var_21_14
	findTF = var_21_17
	...
	var_21_14(var_21_18, var_15(var_0_21, var_21_12))
	...
	var_21_14(var_21_19, var_15(arg_21_2), function()
		if arg_21_0.selectItem then
			setActive = var_0
			findTF = var_2_10002

			var_0(var_2_10002(arg_21_0.selectItem, "selected"), false)
		end

		setActive = var_0
		findTF = var_2_10002

		var_0(var_2_10002(arg_21_2, "selected"), true)
...
function var_0_1.updateDetail(arg_25_0)
	...
	local var_25_2 = var_1.getProgress(var_25_1)
	local var_25_3 = var_1.target

	pg = var_25_1

	local var_25_4 = var_25_1.task_data_template[var_25_0]
	local var_25_5 = var_1:isFinish()
	local var_25_6 = var_1:isOver()
	local var_25_7 = var_1:isCircle()
	local var_25_8 = var_1:isSubmit()

	arg_25_0.awards = var_25_4.award_display

	local var_25_9 = var_25_4.desc
	local var_25_10 = var_25_4.ryza_icon
	local var_25_11 = var_1:getConfig("sub_type")
	...
	var_1_10013(arg_25_0.detailDescText, var_25_9)

	if not var_25_6 then
		setText = var_1_10013

		var_1_10013(arg_25_0.detaiProgressText, var_25_2 .. "/" .. var_25_3)
	else
		setText = var_1_10013

		var_1_10013(arg_25_0.detaiProgressText, "--/--")
	end

	setText = var_1_10013

	var_1_10013(arg_25_0.detailTitleText, var_25_4.name)

	setActive = var_1_10013

	var_1_10013(arg_25_0.detailBtnDetail, var_25_11 == 1006 and not var_25_5 and not var_25_6)

	setActive = var_1_10013

	var_1_10013(arg_25_0.detailBtnGo, not var_25_6 and not var_25_5 and var_25_11 ~= 1006)

	setActive = var_1_10013

	var_1_10013(arg_25_0.detailBtnGet, not var_25_6 and var_25_5 and not var_25_8)

	setActive = var_1_10013

	var_1_10013(arg_25_0.detailBtnSubmit, not var_25_6 and var_25_5 and var_25_8)

	setActive = var_1_10013

	var_1_10013(arg_25_0.detailActive, not var_25_6 and not var_25_5 and not var_25_7)
	...
	var_1_10013(var_25_12, var_16(var_0_21, var_25_10))
	...
	if #arg_25_0.iconTfs < #arg_25_0.awards then
		...
		for iter_25_0 = 1, var_25_13 do
			...
			local var_25_14 = var_25_14(var_1_10020(arg_25_0.IconTpl))

			setParent = var_19

			var_19(var_25_14, arg_25_0.detailAwardContent)

			setActive = var_19

			var_19(var_25_14, true)

			table = var_19

			var_19.insert(arg_25_0.iconTfs, var_25_14)
		end
	end
	...
	for iter_25_1 = 1, #arg_25_0.iconTfs do
		...
		if iter_25_1 <= #arg_25_0.awards then
			var_25_15 = arg_25_0.awards[iter_25_1]
			...
			var_19(arg_25_0.iconTfs[iter_25_1], var_25_16)

			onButton = var_19

			local var_25_17 = arg_25_0
			local var_25_18 = arg_25_0.iconTfs[iter_25_1]

			local function var_25_19()
				local var_26_0 = arg_25_0
				local var_26_1 = var_0.emit

				BaseUI = var_2_10003

				var_26_1(var_26_0, var_2_10003.ON_DROP, var_25_16)
			...
			var_19(var_25_17, var_25_18, var_25_19, var_1_10024)
			...
			var_25_15(arg_25_0.iconTfs[iter_25_1], false)
		end
	end
...
function var_0_1.openSubmitPanel(arg_29_0, arg_29_1)
	...
	local var_29_0 = var_1_10002(arg_29_1:getConfig("target_id_2"))

	pg = var_1_10003

	local var_29_1 = var_1_10003.activity_ryza_item[var_29_0].name

	updateDrop = var_4

	local var_29_2 = arg_29_0.subimtItem
	local var_29_3 = {}

	DROP_TYPE_RYZA_DROP = var_1_10008
	var_29_3.type = var_1_10008
	tonumber = var_1_10008
	var_29_3.id = var_1_10008(var_29_0)
	var_29_3.count = arg_29_1:getConfig("target_num")

	var_4(var_29_2, var_29_3)

	setText = var_4

	var_4(arg_29_0.submitItemDesc, var_29_1)
