...
local var_0_0 = "BossRushVerZenkerEXBattleResultLayer"
...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_7 = var_4.Find(var_3_6, "Confirm/Text")

	i18n = var_3_4

	var_1_10002(var_3_7, var_3_4("battle_result_confirm"))
	...
	var_3_11(var_7.range(#var_3_9), function(arg_5_0)
		...
		local var_5_4 = var_1
		local var_5_5 = var_1.Find(var_5_4, "content/desc")
		local var_5_6 = var_1:Find("mask/painting")

		setActive = var_5_4

		var_5_4(var_1, arg_5_0 <= #var_3_9)
		...
		var_5(var_5_7, var_8("series_enemy_score") .. " ")
	...
	var_3_11(var_7.Find(var_3_12, "TotalScore/Text"), var_3_10)
	arg_3_0:loadUI()
...
function var_0_1.onBackPressed(arg_10_0)
	...
	var_1_10001(var_3.Find(var_10_0, "Confirm"))
...
function var_0_1.loadUI(arg_12_0)
	...
	local var_12_4 = var_12_0(var_1_10005)
	...
	var_1_10007(var_12_11:Find("name/value"), var_12_8)

	setText = var_1_10007

	local var_12_12 = var_12_11:Find("server")

	i18n = var_10

	var_1_10007(var_12_12, var_10("zengke_series_serverinfo"))

	setText = var_1_10007

	var_1_10007(var_12_11:Find("server/value"), var_12_9)

	setText = var_1_10007

	var_1_10007(var_12_11:Find("lv/value"), var_12_1.level)
