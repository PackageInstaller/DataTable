local var_0_0 = class("EighthHotSpringScene", import("view.activity.BackHills.NewYearFestival.NewYearHotSpringScene"))
...
function var_0_0.didEnter(arg_3_0)
	...
	setImageSprite(arg_3_0.top:Find("Ticket/Icon"), LoadSprite("props/eighthwenquanshoupai", "eighthwenquanshoupai"))
