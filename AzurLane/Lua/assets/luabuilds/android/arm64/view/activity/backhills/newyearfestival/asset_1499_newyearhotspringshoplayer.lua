...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.chatAnimator = var_1(var_2_2, var_4(var_1_10006))
	GetComponent = var_1
	...
	arg_2_0.chatAnimEvent = var_1(var_2_3, var_4(var_1_10006))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_4.Find(var_4_1, "Top/Back")
	...
	local var_4_6 = var_4.Find(var_4_5, "Top/Help")
	...
	local function var_4_7()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.hotspring_shop_help.tip
	...
	var_1_10001(var_4_8, var_4.Find(var_4_9, "BG"), function()
	...
	local var_4_12 = var_4.Find(var_4_11, "window/button_container/Button1")
	...
	var_1_10001(var_4_10, var_4_12, var_4_13, var_4_11)
	...
	var_1_10001(var_4_14, var_4.Find(var_4_15, "Box/Spine"), function()
	...
	var_1.Load(var_4_17, function()
		...
		var_11_1(var_11_0, var_3.Find(var_11_2, "Box/Spine"))
...
function var_0_1.ShowEnterMsg(arg_13_0)
	...
	if var_13_1(var_13_0, var_1_10004.ACTIVITY_TYPE_HOTSPRING) then
		...
		local var_13_3 = var_1_10002.all
...
function var_0_1.UpdateView(arg_15_0)
	...
	local var_15_2 = var_1_10002(var_1_10004)
	...
	if not var_15_3[var_15_0(var_15_1)] then
		var_15_4 = 0
	end
	...
	var_15_2(var_6.Find(var_15_5, "Top/Ticket/TicketText"), var_15_4)
...
function var_0_1.UpdateGoods(arg_16_0)
	...
	var_1_10002.sort(var_16_0, function(arg_17_0, arg_17_1)
	...
	var_16_1(var_16_2, var_5.GetChild(var_16_3, 0), #var_16_0, function(arg_18_0, arg_18_1, arg_18_2)
		...
		var_2_10005(arg_18_2:Find("mask"), not var_18_1)
		...
		var_8(var_18_5, var_18_6, var_18_7, var_13)
...
function var_0_1.Purchase(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4)
	...
	i18n = var_1_10009
	var_22_2.content = var_1_10009("hotspring_shop_exchange", arg_22_1:getConfig("resource_num") * arg_22_2, arg_22_1:getConfig("num") * arg_22_2, arg_22_3)
...
function var_0_1.OnPurchase(arg_25_0, arg_25_1, arg_25_2)
	...
	NewYearHotSpringShopMediator = var_1_10007

	var_25_2(var_25_1, var_1_10007.ON_ACT_SHOPPING, var_25_0, 1, arg_25_1.id, arg_25_2)
...
function var_0_1.ShowMsgbox(arg_27_0, arg_27_1)
	...
	var_3(var_27_2, var_27_3, var_27_4, var_1_10008)
...
function var_0_1.DisplayChat(arg_29_0, arg_29_1)
	...
	var_2(function()
		...
		local var_30_1 = var_2_10002(arg_29_0.chat)
		local var_30_2 = 10

		System = var_4

		local var_30_3 = var_30_0(var_30_1, var_30_2, var_4.Action(function()
