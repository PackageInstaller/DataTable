...
function var_0_1.init(arg_2_0)
	...
	local function var_2_6()
		...
		if var_1.IsBusy(var_4_1) then
			...
			for iter_4_4, iter_4_1 in var_1(arg_2_0.dailyTaskList) do
			...
			for iter_4_4, iter_4_3 in var_1(arg_2_0.challengeTaskList) do
		...
		AuctionGameTaskMediator = iter_4_4

		var_4_3(var_4_2, iter_4_4.ON_ACTIVITY_TASK_SUBMIT_ONESTEP, arg_2_0.taskActivityID, var_4_0)
	...
	var_1_10001(var_2_14, var_4("auction_task_challenge"))
...
function var_0_1.didEnter(arg_7_0)
	...
	var_1(var_7_0, var_4.ship_skin_template[900284].painting, "chuanwu", nil, {
		skinID = 900284
	})
...
function var_0_1.willExit(arg_8_0)
	...
	var_1(var_8_0, var_4.ship_skin_template[900284].painting)
...
function var_0_1.OnSwitchBtn(arg_9_0, arg_9_1)
	if arg_9_1 == var_0_1.TASK_TYPE.DAILY then
		...
		var_2(var_9_0, var_1_10005.NewHex("#FFFFFF"))
		...
		var_2(var_9_1, var_1_10005.NewHex("#393A3C"))
		...
		var_2(var_9_2, var_1_10005.NewHex("#393A3C"))
		...
		var_2(var_9_3, var_5.NewHex("#FFFFFF"))
...
function var_0_1.GetTaskList(arg_10_0)
	...
	local var_10_4 = var_10_3(var_10_2, var_1_10007.ACTIVITY_TYPE_AUCTION_GAME)
	local var_10_5 = var_4.getConfig(var_10_4, "config_client").taskActID

	pg = var_10_2

	local var_10_6 = var_10_2.activity_template[var_10_5].config_data

	arg_10_0.taskActivityID = var_10_5
	getProxy = var_10_4
	TaskProxy = var_1_10009

	local var_10_7 = var_10_4(var_1_10009)

	ipairs = var_8

	for iter_10_0, iter_10_1 in var_8(var_10_6) do
		local var_10_8
...
function var_0_1.OnInitItem(arg_12_0, arg_12_1)
	...
	tf = var_1_10005
	var_12_0[arg_12_1] = var_12_1(var_1_10005(arg_12_1), arg_12_0)
