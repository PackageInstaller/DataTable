...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10004("auction_settlement_quick"))
	...
	var_1_10001(var_2_1, var_4("auction_settlement_name"))
	...
	var_1_10001(var_2_2, var_4("auction_settlement_price"))
	...
	var_1_10001(var_2_3, var_4("auction_settlement_value"))
	...
	var_1_10001(var_2_4, var_4("auction_settlement_revenue"))
	...
	var_1_10001(var_2_5, var_4("auction_settlement_dividend"))
	...
	var_1_10001(var_2_6, var_4("auction_settlement_session"))
	...
	local function var_2_15()
		...
		var_5_1(var_5_0, var_2_10003.ShareMgr.AuctionGame)
...
function var_0_1.didEnter(arg_6_0)
	...
	local var_6_5 = var_1:GetAuctionID()

	setScrollText = var_7

	local var_6_6 = arg_6_0.uiSessionText

	pg = var_10

	var_7(var_6_6, var_10.auction_session[var_6_5].name)

	setText = var_7

	local var_6_7 = arg_6_0.uiBidText

	StringHelper = var_10

	var_7(var_6_7, var_10.ForamtNumber(var_2.bidValue))

	setText = var_7

	var_7(arg_6_0.uiStoreHouseText, 0)

	setText = var_7

	local var_6_8 = arg_6_0.uiProceedsText

	string = var_10

	local var_6_9 = var_10.format
	local var_6_10 = "<color=#B13535>%s</color>"

	StringHelper = var_13

	var_7(var_6_8, var_6_9(var_6_10, var_13.ForamtNumber(-var_2.bidValue)))

	setText = var_7

	var_7(arg_6_0.uiDividendText, 0)
	...
	local var_6_14 = var_0_1.REVEAL_ITEM

	handler = var_6_10
	var_6_11[1] = var_6_13(var_6_12, var_6_14, var_6_10(arg_6_0, arg_6_0.OnRefreshText))

	local var_6_15 = arg_6_0
	local var_6_16 = arg_6_0.bind
	local var_6_17 = var_0_1.REVEAL_OVER

	handler = var_12
	var_6_11[2] = var_6_16(var_6_15, var_6_17, var_12(arg_6_0, arg_6_0.OnRefreshOver))
	arg_6_0.eventList = var_6_11

	local var_6_18 = arg_6_0.storeView

	var_7.didEnter(var_6_18)
	...
	local var_6_19 = var_7(var_9)
	local var_6_20 = var_7.getActivityByType

	ActivityConst = var_6_17

	local var_6_21 = var_6_20(var_6_19, var_6_17.ACTIVITY_TYPE_AUCTION_GAME)
	local var_6_22 = var_8.getConfig(var_6_21, "config_client").itemID

	LoadSpriteAsync = var_6_19
	Drop = var_12

	local var_6_23 = var_12.New
	local var_6_24 = {}

	DROP_TYPE_VITEM = var_15
	var_6_24.type = var_15
	var_6_24.id = var_6_22

	local var_6_25 = var_6_23(var_6_24)

	var_6_19(var_12.getIcon(var_6_25), function(arg_7_0)
		IsNil = var_2_10001
...
function var_0_1.OnRefreshText(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_5 = var_9.format
	local var_9_6 = "<color=%s>%s</color>"
	local var_9_7 = var_9_3 > 0 and "#03825F" or "#B13535"

	StringHelper = var_13

	var_6(var_9_4, var_9_5(var_9_6, var_9_7, var_13.ForamtNumber(var_9_3)))
...
function var_0_1.OnRefreshOver(arg_10_0)
	...
	local var_10_0 = var_1_10001(var_3)
	...
	local var_10_8 = var_1_10007(var_1_10009)
	...
	var_10_11(var_10_10, var_1_10010.BuildAuctionSettlement(var_10_6, var_10_9, var_10_1.bidValue, arg_10_0.addValue, var_10_2.gold, var_10_2.gold + var_10_3))
	...
	local var_10_13 = var_10_1.bidUserID

	getProxy = var_10_5
	PlayerProxy = var_10

	local var_10_14 = var_10_5(var_10)

	if var_10_13 ~= var_8.getPlayerId(var_10_14) then
		setText = var_10_13

		local var_10_15 = arg_10_0.uiDividendText

		string = var_10_14

		local var_10_16 = var_10_14.format
		local var_10_17 = "<color=%s>%s</color>"
		local var_10_18 = var_10_1.proceeds
		local var_10_19 = 0 < var_10_18 and "#03825F" or "#B13535"

		StringHelper = var_14

		var_10_13(var_10_15, var_10_16(var_10_17, var_10_19, var_14.ForamtNumber(var_10_1.proceeds)))
	end
...
function var_0_1.willExit(arg_11_0)
	...
	var_1(var_11_0, var_4.getPainting(var_11_1))
