...
local var_0_0 = "YidaliV2framePage"
...
function var_0_1.UpdateAwardGot(arg_7_0)
	...
	var_7_0(arg_7_0.step, not var_7_3)

	setActive = var_7_0

	var_7_0(arg_7_0.progress, not var_7_3)
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	if 1 <= var_8_9 then
		...
		if not var_10(var_8_11, var_1_10013) then
			var_8_12 = var_8_7
		end

		var_8_5(var_8_10, var_8_12)
