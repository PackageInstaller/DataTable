...
local var_0_2 = var_0_10001.activity_ryza_furniture

pg = var_0_0

local var_0_3 = var_0_0.furniture_data_template
...
function var_0_1.init(arg_2_0)
	...
	local var_2_10 = var_3.Find(var_2_9, "detail/awardList")
	local var_2_11 = arg_2_0.detailPage

	arg_2_0.awardList = var_2_8(var_2_10, var_4.Find(var_2_11, "detail/awardList/stage"))
	...
	var_1(var_2_12, var_4("yumia_stronghold_2"))

	for iter_2_0 = 1, 3 do
		setText = var_2_9

		local var_2_13 = arg_2_0.strongholdPage
		local var_2_14 = var_2_14.Find(var_2_13, iter_2_0 .. "/comfort/text")

		i18n = var_1_10008

		var_2_9(var_2_14, var_1_10008("yumia_stronghold_3"))

		var_2_14 = arg_2_0.detailPage
		var_2_9 = var_2_9.Find(var_2_14, "detail/stronghold/furnitures/" .. iter_2_0)

		for iter_2_1 = 1, var_2_9.childCount do
			local var_2_15 = var_2_9:Find(iter_2_1)

			for iter_2_2 = 0, var_2_15.childCount - 1 do
				local var_2_16 = var_2_15:GetChild(iter_2_2)

				setText = var_1_10016

				local var_2_17 = var_2_16:Find("comfort/comf/text")

				i18n = var_1_10019

				var_1_10016(var_2_17, var_1_10019("yumia_stronghold_3"))
			end
		end

		setText = var_6

		local var_2_18 = arg_2_0.detailPage

		var_1_10008 = var_1_10008.Find(var_2_18, "info/" .. iter_2_0 .. "/comfort/text")
		i18n = iter_2_1

		var_6(var_1_10008, iter_2_1("yumia_stronghold_3"))
	end

	setText = var_1

	local var_2_19 = arg_2_0.detailPage
	local var_2_20 = var_3.Find(var_2_19, "detail/progress/Root/text")

	i18n = iter_2_0

	var_1(var_2_20, iter_2_0("yumia_stronghold_4"))

	setText = var_1

	local var_2_21 = arg_2_0.detailPage
	local var_2_22 = var_3.Find(var_2_21, "detail/awardTitle/text")

	i18n = var_4

	var_1(var_2_22, var_4("yumia_stronghold_5"))

	setText = var_1

	local var_2_23 = arg_2_0.detailPage
	local var_2_24 = var_3.Find(var_2_23, "detail/awardList/stage/got/text")

	i18n = var_4

	var_1(var_2_24, var_4("yumia_stronghold_6"))

	setText = var_1

	local var_2_25 = arg_2_0.makeFurniturePanel
	local var_2_26 = var_3.Find(var_2_25, "panel/complete/root/text")

	i18n = var_4

	var_1(var_2_26, var_4("yumia_stronghold_7"))

	setText = var_1

	local var_2_27 = arg_2_0.makeFurniturePanel
	local var_2_28 = var_3.Find(var_2_27, "panel/comfort/title")

	i18n = var_4

	var_1(var_2_28, var_4("yumia_stronghold_3"))

	setText = var_1

	local var_2_29 = arg_2_0.makeFurniturePanel
	local var_2_30 = var_3.Find(var_2_29, "panel/consume/title")

	i18n = var_4

	var_1(var_2_30, var_4("yumia_stronghold_8"))

	setText = var_1

	local var_2_31 = arg_2_0.makeFurniturePanel
	local var_2_32 = var_3.Find(var_2_31, "panel/consume/text")

	i18n = var_4

	var_1(var_2_32, var_4("yumia_stronghold_9"))

	setText = var_1

	local var_2_33 = arg_2_0.makeFurniturePanel
	local var_2_34 = var_3.Find(var_2_33, "panel/makeBtn/text")

	i18n = var_4

	var_1(var_2_34, var_4("yumia_stronghold_10"))

	pg = var_1

	local var_2_35 = var_1.CameraFixMgr.GetInstance()
	local var_2_36 = var_1.bind

	pg = var_4
	arg_2_0.camEventId = var_2_36(var_2_35, var_4.CameraFixMgr.ASPECT_RATIO_UPDATE, function(arg_3_0, arg_3_1)
	...
	local var_2_37 = arg_2_0._tf.rect.height
	local var_2_39

	if 1440 < var_2_37 then
		local var_2_38 = arg_2_0.adapt

		var_2_39 = var_2_39.GetComponent
		typeof = var_5
		RectTransform = var_2_14
		var_2_39 = var_2_39(var_2_38, var_5(var_2_14))
		Vector2 = var_2_35
		var_2_39.sizeDelta = var_2_35(0, 1440 - var_2_37)

		local var_2_40 = arg_2_0.makeFurniturePanel

		var_2_39 = var_2_39.GetComponent
		typeof = var_5
		RectTransform = var_2_14
		var_2_39 = var_2_39(var_2_40, var_5(var_2_14))
		Vector2 = var_3
		var_2_39.sizeDelta = var_3(0, 1440 - var_2_37)
	end

	pg = var_2_39

	local var_2_41 = var_2_39.UIMgr.GetInstance()

	var_2.BlurPanel(var_2_41, arg_2_0._tf, false)

	local var_2_42 = arg_2_0._tf
	local var_2_43 = var_2.GetComponent

	typeof = var_5
	DftAniEvent = var_2_14

	local var_2_44 = var_2_43(var_2_42, var_5(var_2_14))

	var_2.SetTriggerEvent(var_2_44, function()
		for iter_4_0 = 0, 2 do
			...
			local var_4_3 = var_4_2(var_4_1, var_7(var_2_10009))
	...
	local var_2_45 = arg_2_0.detailPage
	local var_2_46 = var_3.GetComponent

	typeof = var_6
	DftAniEvent = var_1_10008

	local var_2_47 = var_2_46(var_2_45, var_6(var_1_10008))

	var_3.SetTriggerEvent(var_2_47, function()
		for iter_5_0 = 0, 2 do
			...
			local var_5_4 = var_5_3(var_5_2, var_2_10008(var_2_10010))

			isActive = var_5_1

			if var_5_1(var_4) then
				var_2_10008 = var_5_4

				var_5_4.Play(var_2_10008, "Anim_YoumiyaStrongholdUI_Strongholdpage01_In")
			end
		end
		...
		for iter_6_0 = 1, 3 do
			...
			for iter_6_1 = 1, var_6_1.childCount do
				...
				for iter_6_2 = 0, var_6_2.childCount - 1 do
					local var_6_3 = var_6_2:GetChild(iter_6_2)

					setActive = var_2_10015

					var_2_10015(var_6_3:Find("comfort/icon/VX"), true)
				end
			end
		end
...
function var_0_1.UpdateAdapt(arg_10_0)
	...
	local var_10_6 = var_10_5(var_10_4, var_8(var_1_10010))
	...
	var_10_6(var_7.Find(var_10_7, "adapt"), {
		x = 0,
		y = 0
	})
...
function var_0_1.InitData(arg_11_0)
	...
	arg_11_0.activityProxy = var_1_10001(var_1_10003)
...
function var_0_1.RefreshData(arg_12_0)
	...
	local var_12_2 = var_12_1(var_12_0, var_1_10004.ACTIVITY_TYPE_ATELIER_LINK)
	...
	arg_12_0.activity = var_12_4(var_12_3, var_1_10005.YUMIA_BASE_ACT_ID)
...
function var_0_1.SetRes(arg_13_0, arg_13_1)
	...
	for iter_13_0 = 0, arg_13_1.childCount - 1 do
		...
		var_8(arg_13_1:GetChild(iter_13_0), false)
	end
	...
	for iter_13_1, iter_13_2 in var_4(var_13_2) do
		...
		for iter_13_3 = 0, arg_13_1.childCount - 1 do
			...
			local var_13_6 = arg_13_1.GetChild(var_13_5, iter_13_3).name

			tostring = var_13_5

			if var_13_6 == var_13_5(var_13_3) then
				setActive = var_13_6

				var_13_6(var_15, true)

				setText = var_13_6

				var_13_6(var_15:Find("Text"), var_13_4)
...
function var_0_1.RefreshView(arg_14_0)
	...
	for iter_14_0 = 1, 3 do
		...
		local var_14_2 = var_14_1:Find("root/name")

		i18n = var_1_10009

		var_1_10006(var_14_2, var_1_10009("yumia_base_name_" .. iter_14_0))

		setText = var_1_10006

		var_1_10006(var_14_1:Find("comfort/count2/count1"), arg_14_0.comfortCount[iter_14_0])

		setText = var_1_10006

		var_1_10006(var_14_1:Find("comfort/count2"), "/" .. arg_14_0.allComfortCount[iter_14_0])

		GetImageSpriteFromAtlasAsync = var_1_10006

		var_1_10006("ui/CourtyardUI_atlas", "express_" .. arg_14_0:GetComfortableLevel(arg_14_0.comfortCount[iter_14_0]), var_14_1:Find("comfort/icon"))

		onButton = var_1_10006

		local var_14_3 = arg_14_0

		var_1_10009 = var_14_1
		...
		var_1_10006(var_14_3, var_1_10009, var_14_4, var_11)

		var_1_10006 = false

		local var_14_5 = arg_14_0.awardInfos[iter_14_0]

		for iter_14_1 = 1, #var_14_5 do
			local var_14_6 = var_14_5[iter_14_1][1]
			local var_14_7 = var_14_5[iter_14_1][2]

			if var_14_6 <= arg_14_0.comfortCount[iter_14_0] and iter_14_1 > arg_14_0.gotAwardIndex[iter_14_0] then
				var_1_10006 = true
		...
		var_8(var_14_1:Find("tip"), var_1_10006)
	end
...
function var_0_1.SetDetailPage(arg_16_0)
	for iter_16_0 = 1, 3 do
		...
		local var_16_1 = var_7.Find(var_16_0, "info/" .. iter_16_0 .. "/root/name")

		i18n = var_1_10008

		var_1_10005(var_16_1, var_1_10008("yumia_base_name_" .. iter_16_0))

		setText = var_1_10005

		local var_16_2 = arg_16_0.detailPage

		var_1_10005(var_7.Find(var_16_2, "info/" .. iter_16_0 .. "/comfort/count2/count1"), arg_16_0.comfortCount[iter_16_0])

		setText = var_1_10005

		local var_16_3 = arg_16_0.detailPage

		var_1_10005(var_7.Find(var_16_3, "info/" .. iter_16_0 .. "/comfort/count2"), "/" .. arg_16_0.allComfortCount[iter_16_0])

		GetImageSpriteFromAtlasAsync = var_1_10005

		local var_16_4 = "ui/CourtyardUI_atlas"

		var_1_10008 = "express_" .. arg_16_0:GetComfortableLevel(arg_16_0.comfortCount[iter_16_0])

		local var_16_5 = arg_16_0.detailPage

		var_1_10005(var_16_4, var_1_10008, var_9.Find(var_16_5, "info/" .. iter_16_0 .. "/comfort/icon"))

		local var_16_6 = arg_16_0.detailPage

		var_1_10005 = var_1_10005.Find(var_16_6, "detail/stronghold/furnitures/" .. iter_16_0)

		local var_16_7 = false

		for iter_16_1 = 0, var_1_10005.childCount - 1 do
			local var_16_8 = var_1_10005:GetChild(iter_16_1)
			local var_16_9 = true

			for iter_16_2 = 0, var_16_8.childCount - 1 do
				local var_16_10 = var_16_8
				local var_16_11 = var_16_8.GetChild(var_16_10, iter_16_2)

				tonumber = var_1_10018
				var_1_10018 = var_1_10018(var_16_11.name)
				table = var_16_10

				local var_16_12 = var_16_10.contains(arg_16_0.okFurnitureIds, var_1_10018)

				setActive = var_20

				var_20(var_16_11:Find("fur"), var_16_12)

				setActive = var_20

				var_20(var_16_11:Find("lockFur"), not var_16_12)

				setActive = var_20

				var_20(var_16_11:Find("comfort"), not var_16_12)

				setText = var_20

				var_20(var_16_11:Find("comfort/comf/count"), var_0_2[var_1_10018].com_add)
				...
				if not var_16_12 then
					...
					local var_16_14 = var_16_11

					local function var_16_15()
						local var_17_0 = arg_16_0

						var_0.ShowMakePanel(var_17_0, var_1_10018)
					...
					var_20(var_16_13, var_16_14, var_16_15, var_25)
				else
			...
			var_13(var_16_8, not var_16_7)

			if not var_16_7 and not var_16_9 then
				var_16_7 = true
			end
		end
	end
	...
	local var_16_17 = arg_16_0.detailPage
	local var_16_18 = var_4.Find(var_16_17, "leftChange")
	...
	var_1(var_16_16, var_16_18, var_16_19, var_16_17)

	onButton = var_1

	local var_16_20 = arg_16_0
	local var_16_21 = arg_16_0.detailPage
	local var_16_22 = var_4.Find(var_16_21, "rightChange")
	...
	var_1(var_16_20, var_16_22, var_16_23, var_16_21)
...
function var_0_1.EnterDetailPage(arg_20_0, arg_20_1)
	...
	for iter_20_0 = 1, 3 do
		...
		var_1_10006(var_8.Find(var_20_0, "info/" .. iter_20_0), iter_20_0 == arg_20_1)
	end
	...
	var_2(var_4.Find(var_20_1, "detail/progress/countBg/furnitureCount"), arg_20_0.furnitureCount[arg_20_1] .. "/" .. arg_20_0.allFurnitureCount[arg_20_1])
	...
	for iter_20_1 = 1, 3 do
		...
		var_6(var_8.Find(var_20_2, "detail/stronghold/furnitures/" .. iter_20_1), iter_20_1 == arg_20_1)
	end
	...
	var_5.make(var_20_6, function(arg_21_0, arg_21_1, arg_21_2)
		...
		if arg_21_0 == var_2_10003.EventUpdate then
			...
			local var_21_5 = arg_21_2.Find(var_21_4, "award")
			...
			local function var_21_6()
				...
				var_22_1(var_22_0, var_3_10003.ON_DROP, var_21_2)
			...
			var_6(var_21_3, var_21_5, var_21_6, var_21_4)
	...
	var_5(var_7.Find(var_20_8, "detail/allGetBtn/VX"), var_20_3)
	...
	if var_20_3 then
		...
		var_5(var_7.Find(var_20_9, "detail/allGetBtn"), false, false)

		onButton = var_5

		local var_20_10 = arg_20_0
		local var_20_11 = arg_20_0.detailPage
		local var_20_12 = var_8.Find(var_20_11, "detail/allGetBtn")

		local function var_20_13()
			local var_23_0 = arg_20_0
			local var_23_1 = var_0.emit

			YoumiyaStrongholdMediator = var_2_10003

			var_23_1(var_23_0, var_2_10003.GET_AWARD, arg_20_1, var_20_4)
		...
		var_5(var_20_10, var_20_12, var_20_13, var_20_11)
	else
		setGray = var_5

		local var_20_14 = arg_20_0.detailPage

		var_5(var_7.Find(var_20_14, "detail/allGetBtn"), true, false)

		removeOnButton = var_5

		local var_20_15 = arg_20_0.detailPage

		var_5(var_7.Find(var_20_15, "detail/allGetBtn"))
	end
	...
	if var_5(arg_20_0.makeFurniturePanel) then
		...
		var_5(var_7.Find(var_20_16, "panel/closeBtn"))
	end
...
function var_0_1.ShowMakePanel(arg_24_0, arg_24_1)
	...
	local var_24_4 = var_24_3(var_24_2, var_1_10007(var_1_10009))
	...
	local var_24_10 = var_9.Find(var_24_9, "panel/closeBtn")
	...
	var_24_2(var_24_8, var_24_10, var_24_11, var_24_9)

	onButton = var_24_2

	local var_24_12 = arg_24_0
	local var_24_13 = arg_24_0._tf
	local var_24_14 = var_9.Find(var_24_13, "bg")
	...
	local function var_24_15()
		...
		var_2_10000(var_2.Find(var_27_0, "panel/closeBtn"))
	...
	var_24_2(var_24_12, var_24_14, var_24_15, var_24_13)

	setText = var_24_2

	local var_24_16 = arg_24_0.makeFurniturePanel

	var_24_2(var_8.Find(var_24_16, "panel/name"), var_24_1.name)

	HXSet = var_24_2

	local var_24_17, var_24_18 = var_24_2.autoHxShiftPath("furnitures/" .. var_24_1.picture, "")
	...
	local var_24_22 = var_24_21(var_24_20, var_11(var_1_10013))

	GetSpriteFromAtlasAsync = var_9

	var_9(var_24_17, var_24_18, function(arg_28_0)
		...
		Vector3 = var_2_10005
		var_28_4.localScale = var_2_10005(var_28_2, var_28_2, 1)
	...
	var_9(var_11.Find(var_24_23, "panel/comfort/count"), var_24_0.com_add)

	setText = var_9

	local var_24_24 = arg_24_0.makeFurniturePanel

	var_9(var_11.Find(var_24_24, "panel/desc"), var_24_1.describe)

	setActive = var_9

	local var_24_25 = arg_24_0.makeFurniturePanel

	var_9(var_11.Find(var_24_25, "panel/complete"), false)

	onButton = var_9

	local var_24_26 = arg_24_0
	local var_24_27 = arg_24_0.makeFurniturePanel
	local var_24_28 = var_12.Find(var_24_27, "panel/consume/goBtn")
	...
	local function var_24_29()
		...
		local var_29_2 = var_2_10003.YOUMIA_GO_SCENE

		SCENE = var_2_10004

		var_29_1(var_29_0, var_29_2, var_2_10004.ATELIER_COMPOSITE, {
			activityID = 50043,
			versionIndex = 2
		})
	...
	var_9(var_24_26, var_24_28, var_24_29, var_24_27)
	arg_24_0:SetConsumeList(var_24_0.material)

	local var_24_30 = true

	ipairs = var_24_20

	for iter_24_0, iter_24_1 in var_24_20(var_24_0.material) do
		local var_24_31 = iter_24_1[2]

		if iter_24_1[3] > arg_24_0:GetItemCount(var_24_31) then
			var_24_30 = false
		end
	end
	...
	if var_24_30 then
		...
		local var_24_32 = arg_24_0.makeFurniturePanel

		var_10(var_12.Find(var_24_32, "panel/makeBtn"), false, true)

		onButton = var_10

		local var_24_33 = arg_24_0
		local var_24_34 = arg_24_0.makeFurniturePanel
		local var_24_35 = var_13.Find(var_24_34, "panel/makeBtn")
		...
		local function var_24_36()
			...
			var_0.SetTriggerEvent(var_30_0, function()
				...
				YoumiyaStrongholdMediator = var_3_10003

				var_31_1(var_31_0, var_3_10003.MAKE_FURNITURE, arg_24_1, var_24_0.material)
				...
				var_31_2(var_2.Find(var_31_3, "panel/closeBtn"))
			...
			var_0(var_2.Find(var_30_1, "panel/complete"), true)
			...
			local var_30_4 = var_30_3(var_30_2, var_3(var_5))
			...
			var_0(var_2.Find(var_30_5, "panel/makeBtn"))
		...
		var_10(var_24_33, var_24_35, var_24_36, var_24_34)
	else
		setGray = var_10

		local var_24_37 = arg_24_0.makeFurniturePanel

		var_10(var_12.Find(var_24_37, "panel/makeBtn"), true, true)

		removeOnButton = var_10

		local var_24_38 = arg_24_0.makeFurniturePanel

		var_10(var_12.Find(var_24_38, "panel/makeBtn"))
	end
...
function var_0_1.SetConsumeList(arg_32_0, arg_32_1)
	...
	for iter_32_3, iter_32_4 in var_4(var_32_2) do
		...
		for iter_32_5 = 0, var_32_1.childCount - 1 do
			...
			local var_32_6 = var_32_1.GetChild(var_32_5, iter_32_5).name

			tostring = var_32_5

			if var_32_6 == var_32_5(var_32_3) then
				setActive = var_32_6

				var_32_6(var_15, true)

				setText = var_32_6

				var_32_6(var_15:Find("count1"), arg_32_0:GetItemCount(var_32_3))

				setText = var_32_6

				var_32_6(var_15:Find("count2"), "/" .. var_32_4)
...
function var_0_1.GoBack(arg_35_0)
	...
	if var_1_10001(arg_35_0.detailPage) then
		...
		if var_1(arg_35_0.makeFurniturePanel) then
			...
			var_1(var_3.Find(var_35_0, "panel/closeBtn"))
		end
		...
		for iter_35_0 = 1, 3 do
			...
			for iter_35_1 = 1, var_35_2.childCount do
				...
				for iter_35_2 = 0, var_35_3.childCount - 1 do
					local var_35_4 = var_35_3:GetChild(iter_35_2)

					setActive = var_1_10016

					var_1_10016(var_35_4:Find("comfort/icon/VX"), false)
				end
			end
		end
...
function var_0_1.ShouldShowTip()
	...
	local var_38_2 = var_1_10002(var_1_10004)
	local var_38_3 = var_2.getActivityById

	ActivityConst = var_1_10005

	local var_38_4 = var_38_3(var_38_2, var_1_10005.YUMIA_BASE_ACT_ID)
	...
	for iter_38_0 = 1, 3 do
		var_1_10011 = var_2
		var_38_6[iter_38_0] = var_2.getKVPList(var_1_10011, 1, iter_38_0)
	end
