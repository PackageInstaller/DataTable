...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	var_2(arg_7_0.countTF, arg_7_0.remainCnt)

	local var_7_12 = arg_7_0.activity
	local var_7_13 = var_2.getConfig(var_7_12, "config_client").story

	ipairs = var_3

	for iter_7_2, iter_7_3 in var_3(arg_7_0.taskList) do
		local var_7_14 = arg_7_0.taskProxy

		if var_8.getFinishTaskById(var_7_14, iter_7_3) then
			checkExist = var_1_10009

			if var_1_10009(var_7_13, {
				iter_7_2
			}, {
				1
			}) then
				...
				local var_7_15 = var_1_10009.NewStoryMgr.GetInstance()

				var_1_10009.Play(var_7_15, var_7_13[iter_7_2][1])
			end
		end
	end

	local var_7_16 = arg_7_0.itemList

	var_3.align(var_7_16, #arg_7_0.taskList)
