local var_0_0 = class("SkinGuide4Page", import("...base.BaseActivityPage"))
local var_0_2 = {
	{
		50,
		-50
...
function var_0_0.OnUpdateFlush(arg_7_0)
	...
	arg_7_0.unlockCnt = (var_7_1:DiffDay(arg_7_0.activity:getStartTime(), pg.TimeMgr.GetInstance():GetServerTime()) + 1) * arg_7_0.activity:getConfig("config_id")
	...
	if arg_7_0.unlockCnt > arg_7_0.totalCnt then
		...
		setText(arg_7_0.countTF, arg_7_0.remainCnt)
