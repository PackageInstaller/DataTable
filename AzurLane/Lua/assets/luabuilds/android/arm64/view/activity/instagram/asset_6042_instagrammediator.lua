...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_READED, function(arg_2_0, arg_2_1)
		...
		local var_2_2 = var_2_10005.ACT_INSTAGRAM_OP
		local var_2_3 = {
			arg2 = 0
		}

		ActivityConst = var_2_10007
		var_2_3.cmd = var_2_10007.INSTAGRAM_OP_MARK_READ
	...
	arg_1_0:bind(var_0_1.ON_LIKE, function(arg_3_0, arg_3_1)
		...
		local var_3_2 = var_2_10005.ACT_INSTAGRAM_OP
		local var_3_3 = {
			arg2 = 0
		}

		ActivityConst = var_2_10007
		var_3_3.cmd = var_2_10007.INSTAGRAM_OP_LIKE
	...
	arg_1_0:bind(var_0_1.ON_SHARE, function(arg_4_0, arg_4_1)
		...
		local var_4_2 = var_2_10005.ACT_INSTAGRAM_OP
		local var_4_3 = {
			arg2 = 0
		}

		ActivityConst = var_2_10007
		var_4_3.cmd = var_2_10007.INSTAGRAM_OP_SHARE
	...
	arg_1_0:bind(var_0_1.ON_COMMENT, function(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
		...
		local var_5_2 = var_2_10007.ACT_INSTAGRAM_OP
		local var_5_3 = {}

		ActivityConst = var_2_10009
		var_5_3.cmd = var_2_10009.INSTAGRAM_OP_COMMENT
	...
	arg_1_0:bind(var_0_1.ON_REPLY_UPDATE, function(arg_6_0, arg_6_1)
		...
		local var_6_2 = var_2_10005.ACT_INSTAGRAM_OP
		local var_6_3 = {
			arg2 = 0
		}

		ActivityConst = var_2_10007
		var_6_3.cmd = var_2_10007.INSTAGRAM_OP_UPDATE
	...
	arg_1_0:bind(var_0_1.CLOSE_ALL, function(arg_9_0)
		...
		var_9_1(var_9_0, var_2_10004.CLOSE_ALL)
...
function var_0_1.handleNotification(arg_11_0, arg_11_1)
	...
	local function var_11_3()
		...
		InstagramProxy = var_2_10005

		var_12_1(var_12_0, var_2_10003(var_2_10005))

		local var_12_2 = arg_11_0.viewComponent

		var_0.UpdateInstagram(var_12_2, var_11_2.id)

		local var_12_3 = arg_11_0.viewComponent

		var_0.UpdateSelectedInstagram(var_12_3, var_11_2.id)
		...
		var_12_5(var_12_4, var_3.CHANGE_JUUS_TIP)
	...
	if var_11_0 == var_11_1.ACT_INSTAGRAM_OP_DONE then
		local var_11_4 = arg_11_0.viewComponent
		local var_11_5 = var_5.SetProxy

		getProxy = var_1_10008
		InstagramProxy = var_1_10010

		var_11_5(var_11_4, var_1_10008(var_1_10010))

		local var_11_6 = var_11_2.cmd

		ActivityConst = var_1_10006

		if var_11_6 == var_1_10006.INSTAGRAM_OP_SHARE then
			pg = var_11_6

			local var_11_7 = var_11_6.ShareMgr.GetInstance()
			local var_11_8 = var_5.Share

			pg = var_8

			var_11_8(var_11_7, var_8.ShareMgr.TypeInstagram)

			goto label_11_0
		end

		local var_11_9 = var_11_2.cmd

		ActivityConst = var_6

		if var_11_9 == var_6.INSTAGRAM_OP_LIKE then
			var_11_3()

			local var_11_10 = arg_11_0.viewComponent

			var_5.UpdateLikeBtn(var_11_10)

			pg = var_5

			local var_11_11 = var_5.TipsMgr.GetInstance()
			local var_11_12 = var_5.ShowTips

			i18n = var_8

			var_11_12(var_11_11, var_8("ins_click_like_success"))

			goto label_11_0
		end

		local var_11_13 = var_11_2.cmd

		ActivityConst = var_6

		if var_11_13 == var_6.INSTAGRAM_OP_COMMENT then
			pg = var_11_13

			local var_11_14 = var_11_13.TipsMgr.GetInstance()
			local var_11_15 = var_5.ShowTips

			i18n = var_8

			var_11_15(var_11_14, var_8("ins_push_comment_success"))
			var_11_3()

			goto label_11_0
		end

		local var_11_16 = var_11_2.cmd

		ActivityConst = var_6

		if var_11_16 ~= var_6.INSTAGRAM_OP_ACTIVE then
			do
				local var_11_17 = var_11_2.cmd

				ActivityConst = var_6

				if var_11_17 == var_6.INSTAGRAM_OP_UPDATE then
					local var_11_18 = arg_11_0.viewComponent

					var_5.InitList(var_11_18)
					var_11_3()
				else
					local var_11_19 = var_11_2.cmd

					ActivityConst = var_6

					if var_11_19 == var_6.INSTAGRAM_OP_MARK_READ then
						var_11_3()
					end
				end
