...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.GO_HOTSPRING, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_2, var_2_10005.HOLIDAY_VILLA_HOTSPRING)
	...
	arg_1_0:bind(var_0_1.SITE_CLICKED, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10006.ACTIVITY_OPERATION, {
			cmd = 2,
			activity_id = arg_4_1,
			arg1 = arg_4_2
		})
	...
	arg_1_0:bind(var_0_1.ON_SHOP, function(arg_5_0)
		...
		HolidayVillaShopMediator = var_2_10007
		var_5_3.mediator = var_2_10007
		HolidayVillaShopLayer = var_2_10007
	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT_ONESTEP, function(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		...
		var_6_1(var_6_0, var_2_10007.SUBMIT_ACTIVITY_TASK, {
			act_id = arg_6_1,
			task_ids = arg_6_2,
			callback = arg_6_3
		})
	...
	arg_1_0:bind(var_0_1.OPEN_WHARF, function(arg_7_0)
		...
		HolidayVillaWharfLayer = var_2_10007
		var_7_3.viewComponent = var_2_10007
		HolidayVillaWharfMediator = var_2_10007
	...
	arg_1_0:bind(var_0_1.OPEN_HolidayVilla_TASk, function(arg_8_0, arg_8_1)
		...
		HolidayVillaTasksLayer = var_2_10008
		var_8_3.viewComponent = var_2_10008
		HolidayVillaTasksMediator = var_2_10008
	...
	arg_1_0:bind(var_0_1.ON_BOOK, function(arg_9_0, arg_9_1)
		...
		CollectionBookLayer = var_2_10008
		var_9_3.viewComponent = var_2_10008
		CollectionBookMediator = var_2_10008
...
function var_0_1.handleNotification(arg_12_0, arg_12_1)
	...
	if var_12_1 ~= var_12_0.ACTIVITY_OPERATION_DONE then
		GAME = var_4

		if var_12_1 ~= var_4.SUBMIT_ACTIVITY_TASK_DONE then
			GAME = var_4

			if var_12_1 == var_4.ISLAND_SHOPPING_DONE then
				var_1_10006 = arg_12_0.viewComponent

				var_4.RefreshData(var_1_10006)

				var_1_10006 = arg_12_0.viewComponent

				var_4.Show(var_1_10006)
			else
				ActivityProxy = var_4

				if var_12_1 == var_4.ACTIVITY_EXCHANGE_RESOURCES then
					var_1_10006 = arg_12_0.viewComponent
					...
					var_4.ShowAllRepairPage(var_1_10006)
				else
					GAME = var_4

					if var_12_1 == var_4.STORY_UPDATE_DONE then
						getProxy = var_4
						TaskProxy = var_1_10006

						local var_12_3 = var_4(var_1_10006)
