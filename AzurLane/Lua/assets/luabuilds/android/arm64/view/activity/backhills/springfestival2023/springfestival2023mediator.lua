...
local var_0_0 = "SpringFestival2023Mediator"
...
var_0_1.PLAY_FIREWORKS = "PLAY_FIREWORKS"
...
function var_0_1.listNotificationInterests(arg_6_0)
	...
	var_6_0[3] = var_0_1.PLAY_FIREWORKS
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	if var_7_1 == var_7_0.SEND_MINI_GAME_OP_DONE then
		...
		elseif var_7_1 == var_0_1.PLAY_FIREWORKS then
			local var_7_5 = arg_7_0.viewComponent

			var_4.PlayFireworks(var_7_5, var_7_2)
		end
	end
