...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".AprilFoolBulinSubView"))
...
function var_0_1.OnInit(arg_2_0)
	...
	if not var_2_1(var_2_0, var_1_10004.ACTIVITY_TYPE_PUZZLA) or var_1:isEnd() then
		arg_2_0:Destroy()
	...
	local var_2_2 = var_1_10002.activity_event_picturepuzzle[var_1.id]
	...
	var_3(arg_2_0, arg_2_0.bulin, function()
		...
		local var_3_3 = var_2_10004.PUZZLE_PIECE_OP
		local var_3_4 = {
			actId = var_0.id,
			id = var_3_0
		}

		PuzzleActivity = var_6
		var_3_4.cmd = var_6.CMD_ACTIVATE
		...
		function var_3_4.callback()
			...
			var_3_10000({
				function(arg_5_0)
					...
					var_5_3(var_5_2, var_5.ON_ACHIEVE, {
						{
							type = var_5_1[1],
							id = var_5_1[2],
							count = var_5_1[3]
				...
				function(arg_6_0)
					...
					local var_6_0 = var_4_10001(var_4_10003)
					local var_6_1 = var_1.getActivityByType

					ActivityConst = var_4_10004

					local var_6_2 = var_6_1(var_6_0, var_4_10004.ACTIVITY_TYPE_PUZZLA)

					table = var_4_10002

					if #var_4_10002.mergeArray(var_6_2.data1_list, var_6_2.data2_list, true) < #var_2_2.pickup_picturepuzzle + #var_2_2.drop_picturepuzzle then
						return arg_6_0()
					end

					local var_6_3 = var_6_2:getConfig("config_client").comStory

					pg = var_4

					local var_6_4 = var_4.NewStoryMgr.GetInstance()

					var_4.Play(var_6_4, var_6_3, arg_6_0)
