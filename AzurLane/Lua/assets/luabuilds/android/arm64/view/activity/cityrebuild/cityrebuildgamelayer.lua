...
function var_0_1.init(arg_2_0)
	...
	local var_2_13 = var_3.Find(var_2_12, "top/awardPanel/first/items")
	local var_2_14 = arg_2_0.ui

	arg_2_0.firstAwardList = var_2_11(var_2_13, var_4.Find(var_2_14, "top/awardPanel/first/items/item"))
	...
	typeof = var_4
	Animation = var_2_14
	arg_2_0.damageAni = var_2_28(var_2_27, var_4(var_2_14))
	...
	local var_2_36 = var_3.Find(var_2_35, "left/cityLevel/title")

	i18n = var_2_34

	var_2_31(var_2_36, var_2_34("ninja_game_citylevel"))

	setText = var_2_31

	local var_2_37 = arg_2_0.ui
	local var_2_38 = var_3.Find(var_2_37, "left/battleLevel/title")

	i18n = var_4

	var_2_31(var_2_38, var_4("ninja_game_wave"))

	setText = var_2_31

	local var_2_39 = arg_2_0.summaryPanel
	local var_2_40 = var_3.Find(var_2_39, "buildingDPS")

	i18n = var_4

	var_2_31(var_2_40, var_4("ninja_game_citydmg"))

	setText = var_2_31

	local var_2_41 = arg_2_0.summaryPanel
	local var_2_42 = var_3.Find(var_2_41, "charaDPS")

	i18n = var_4

	var_2_31(var_2_42, var_4("ninja_game_allydmg"))

	setText = var_2_31

	local var_2_43 = arg_2_0.summaryPanel
	local var_2_44 = var_3.Find(var_2_43, "DPS")

	i18n = var_4

	var_2_31(var_2_44, var_4("ninja_game_dps"))

	setText = var_2_31

	local var_2_45 = arg_2_0.summaryPanel
	local var_2_46 = var_3.Find(var_2_45, "time")

	i18n = var_4

	var_2_31(var_2_46, var_4("ninja_game_time"))

	setText = var_2_31

	local var_2_47 = arg_2_0.summaryPanel
	local var_2_48 = var_3.Find(var_2_47, "pts")

	i18n = var_4

	var_2_31(var_2_48, var_4("ninja_game_income"))

	setText = var_2_31

	local var_2_49 = arg_2_0.summaryPanel
	local var_2_50 = var_3.Find(var_2_49, "pt")

	i18n = var_4

	var_2_31(var_2_50, var_4("ninja_game_ptcount"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_8()
		...
		CityRebuildGameMediator = var_2_10003

		var_6_1(var_6_0, var_2_10003.OPEN_BOOK)
	...
	local function var_3_14()
		...
		var_8_1(var_8_0, var_2_10003.CHOOSE_LEVEL, arg_3_0.activityId, arg_3_0.cityRebuildData.curLevel - 1)
	...
	local function var_3_17()
		...
		var_9_1(var_9_0, var_2_10003.CHOOSE_LEVEL, arg_3_0.activityId, arg_3_0.cityRebuildData.curLevel + 1)
	...
	local function var_3_20()
		...
		var_10_1(var_10_0, var_2_10003.RESULT, arg_3_0.activityId)
	...
	var_1(var_3_18, var_3_19, var_3_20, var_1_10006)
	arg_3_0:BgScroll()
	arg_3_0:Refresh()
...
function var_0_1.InitData(arg_11_0)
	...
	if arg_11_0.cityRebuildData.startTime == 0 then
		...
		CityRebuildGameMediator = var_4

		var_11_2(var_11_1, var_4.INIT_TIME, arg_11_0.activityId)
	end
...
function var_0_1.BgScroll(arg_12_0)
	...
	local var_12_8 = var_12_7(var_7(arg_12_0.bg1), 0, var_12_4, 20)
	local var_12_9 = var_5.setOnUpdate

	System = var_8

	local var_12_10 = var_12_9(var_12_8, var_8.Action_float(function(arg_13_0)
	...
	local var_12_12 = var_12_11(var_12_10, var_8.linear)
	...
	local var_12_16 = var_12_15(var_12_14, var_8.Action_float(function(arg_14_0)
	...
	local var_12_18 = var_12_17(var_12_16, var_8.linear)
	...
	local var_12_22 = var_12_21(var_12_20, var_8.Action_float(function(arg_15_0)
	...
	local var_12_24 = var_12_23(var_12_22, var_8.linear)
...
function var_0_1.SetSpine(arg_17_0)
	...
	arg_17_0.ClearSpine(var_17_0)

	pg = var_1
	arg_17_0.prefab = var_1.activity_ninja_enemy[arg_17_0.cityRebuildData.curLevel].model

	local var_17_1 = arg_17_0.prefab

	tonumber = var_2
	pg = var_1_10004

	local var_17_2 = var_2(var_1_10004.activity_ninja_enemy[arg_17_0.cityRebuildData.curLevel].scale)

	Vector3 = var_17_0

	local var_17_3 = var_17_0(-var_17_2, var_17_2, 1)

	Vector3 = var_4

	local var_17_4 = var_4(0, -328, 0)

	Vector3 = var_5

	local var_17_5 = var_5(-600, -328, 0)
	...
	var_6.GetSpineChar(var_17_6, var_17_1, true, function(arg_18_0)
		if var_17_1 ~= arg_17_0.prefab or var_17_1 == arg_17_0.loadedPrefab then
			PoolMgr = var_1

			local var_18_0 = var_1.GetInstance()

			var_1.ReturnSpineChar(var_18_0, var_17_1, arg_18_0)

			return
		end

		arg_17_0.loadedPrefab = var_17_1
		...
		arg_17_0._ship.localScale = var_17_3
		...
		var_18_4.anim = var_18_6(var_18_5, var_5(var_2_10007))
	...
	local var_17_7 = var_6.GetInstance()

	var_6.GetSpineChar(var_17_7, var_17_1, true, function(arg_19_0)
		if var_17_1 ~= arg_17_0.prefab or var_17_1 == arg_17_0.loadedPrefab2 then
			PoolMgr = var_1

			local var_19_0 = var_1.GetInstance()

			var_1.ReturnSpineChar(var_19_0, var_17_1, arg_19_0)

			return
		end

		arg_17_0.loadedPrefab2 = var_17_1
		...
		arg_17_0._ship2.localScale = var_17_3
		...
		typeof = var_5
		SpineAnimUI = var_2_10007
		var_19_4.anim2 = var_19_6(var_19_5, var_5(var_2_10007))
...
function var_0_1.WalkSpine(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	if arg_20_1 and arg_20_2 then
		...
		local var_20_1 = var_1_10005(-600, -4, 0)
		...
		var_20_3(var_20_2, var_9.Action_float(function(arg_21_0)
...
function var_0_1.SetLevelAndAward(arg_25_0)
	...
	var_2.make(var_25_1, function(arg_26_0, arg_26_1, arg_26_2)
		...
		if arg_26_0 == var_2_10003.EventUpdate then
			...
			var_5(var_26_2, var_26_3, var_26_4, var_10)
		end
	...
	var_2(var_4.Find(var_25_3, "count"), arg_25_0.cityRebuildData.summaryPt > 0)

	setText = var_2

	local var_25_4 = arg_25_0.resultBtn
	local var_25_5 = var_4.Find(var_25_4, "count")

	CityRebuildData = var_5

	var_2(var_25_5, var_5.PtToShow(arg_25_0.cityRebuildData.summaryPt) .. "+")
...
function var_0_1.SetSummaryPanelAndHp(arg_28_0)
	...
	local var_28_12 = var_1_10009.ceil((#var_28_0 + var_28_2[10] + (#var_28_0 + var_28_2[10]) * arg_28_0:GetParam(1)^(var_28_2[8] - 1) / arg_28_0:GetParam(2)) * arg_28_0:GetParam(3)^(var_28_2[9] - 1) + arg_28_0:GetParam(4) * var_28_2[7])
	...
	var_15(var_17.Find(var_28_17, "buildingDPS/Text"), var_28_12)

	setText = var_15

	local var_28_18 = arg_28_0.summaryPanel

	var_15(var_17.Find(var_28_18, "charaDPS/Text"), var_10)

	setText = var_15

	local var_28_19 = arg_28_0.summaryPanel

	var_15(var_17.Find(var_28_19, "DPS/Text"), var_28_13)

	setText = var_15

	local var_28_20 = arg_28_0.summaryPanel

	var_15(var_17.Find(var_28_20, "time/Text"), var_28_15 .. "s")

	setText = var_15

	local var_28_21 = arg_28_0.summaryPanel

	var_15(var_17.Find(var_28_21, "pts/Text"), "+" .. var_28_16 .. "/s")

	setText = var_15

	local var_28_22 = arg_28_0.summaryPanel

	var_15(var_17.Find(var_28_22, "pt/Text"), var_28_14)

	setText = var_15

	local var_28_23 = arg_28_0.ptAwardCount

	CityRebuildData = var_18

	var_15(var_28_23, var_18.PtToShow(var_28_11))
	...
	var_28_23(arg_28_0.previousLevelBtn, var_4 > 1)

	pg = var_28_23

	local var_28_26 = var_28_23.activity_ninja_enemy.all
	...
	typeof = var_1_10024
	Text = var_1_10026
	var_28_35(var_28_34, var_1_10024(var_1_10026)).fontSize = var_28_33
	...
	for iter_28_0, iter_28_1 in var_24(var_28_38) do
		pg = var_1_10029
		...
		if not var_1_10030.contains(var_28_36, var_1_10029) then
			...
			var_1_10030(var_28_39, var_33.Find(var_28_40, var_1_10029))
		end
	end
	...
	arg_28_0:StartTimer(function()
		...
		local var_29_4 = var_5.PtToShow(var_29_2)
		local var_29_5 = "/<color=#b7b7b7>"

		CityRebuildData = var_7

		var_2(var_29_3, var_29_4 .. var_29_5 .. var_7.PtToShow(var_28_4) .. "</color>")
...
function var_0_1.Summary(arg_31_0, arg_31_1, arg_31_2)
	...
	var_6(var_8.Find(var_31_4, "resultEffect/" .. var_31_1), true)
	arg_31_0:StartTimers(function()
		setActive = var_2_10000

		local var_32_0 = arg_31_0._tf

		var_2_10000(var_2.Find(var_32_0, "resultEffect/" .. var_31_1), false)
		arg_31_1()
