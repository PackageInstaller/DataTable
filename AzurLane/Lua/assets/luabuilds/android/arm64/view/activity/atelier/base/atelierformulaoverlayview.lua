...
function var_0_1.didEnter(arg_6_0)
	...
	var_1_10001(var_6_0, var_4.Find(var_6_1, "List"), function()
...
var_0_2[var_0_0.TYPE.EQUIP] = "text_equip"
...
function var_0_1.RefreshFormulaInfo(arg_8_0, arg_8_1)
	...
	var_8_1(var_8_0, var_8_2, var_8_3, var_7:Find("Type"))
	...
	var_8_6(var_8_5, var_6.Find(var_8_7, "Icon"), var_8_4)

	setText = var_8_6

	local var_8_8 = arg_8_0._tf

	var_8_6(var_5.Find(var_8_8, "Name"), arg_8_1:GetName())

	setText = var_8_6

	local var_8_9 = arg_8_0._tf

	var_8_6(var_5.Find(var_8_9, "Description/Text"), arg_8_1:GetDesc())

	tostring = var_8_6

	local var_8_10 = arg_8_1
	local var_8_11 = var_8_6(arg_8_1.GetMaxLimit(var_8_10) - arg_8_1:GetUsedCount())
	...
	local var_8_13 = var_6.Find(var_8_12, "RestCount/Text")

	i18n = var_8_10

	var_4(var_8_13, var_8_10("ryza_rest_produce_count", var_8_11))
