...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_16 = var_3.Find(var_1_15, "lock/Text")

	i18n = var_4

	var_1(var_1_16, var_4("liner_sign_unlock_tip"))
	...
	local var_1_19 = var_1_18(var_1_17, var_4(var_6))
	...
	var_1_19(var_3.Find(var_1_20, "input/pan"), not arg_1_0.lockNamed)
	...
	local var_1_23 = var_1_22(var_1_21, var_4(var_6))
	...
	var_1_23(var_3.Find(var_1_24, "name/edit"), not arg_1_0.lockNamed)
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1.make(var_3_0, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventInit then
			...
			var_4_2("ui/activityuipage/linersignpage_atlas", "D" .. var_4_0, arg_4_2:Find("day"), true)
		else
			UIItemList = var_4_0
			...
			if arg_4_0 == var_4_0.EventUpdate then
				...
				var_2_10006(arg_4_2:Find("cur"), var_4_7 == arg_3_0.nday)
	...
	local function var_3_8()
		...
		local var_9_2 = var_2_10004.STORE_DATE
		local var_9_3 = {}

		ActivityConst = var_2_10006
		var_9_3.actId = var_2_10006.LINER_NAMED_ID
	...
	var_1(arg_3_0, arg_3_0.linerInput, function(arg_11_0)
		...
		do
			...
			local var_11_3 = var_2_10004.STORE_DATE
			local var_11_4 = {}

			ActivityConst = var_2_10006
			var_11_4.actId = var_2_10006.LINER_NAMED_ID
			...
			function var_11_4.callback()
				...
				var_12_1(var_12_0, var_3_10003("liner_name_modify"))
	...
	local function var_3_11()
		...
		var_0({
			...
			local var_15_2 = var_3_10003.EVENT_GO_SCENE

			SCENE = var_3_10004

			var_15_1(var_15_0, var_15_2, var_3_10004.LINER)
...
function var_0_1.OnUpdateFlush(arg_16_0)
	...
	var_1_10002(arg_16_0.signTF, not var_16_0)

	setActive = var_1_10002

	var_1_10002(arg_16_0.namedTF, var_16_0 and not arg_16_0:IsNamed())

	setActive = var_1_10002

	var_1_10002(arg_16_0.linerTF, var_16_0 and arg_16_0:IsNamed())

	setActive = var_1_10002

	local var_16_1 = arg_16_0.linerBtn

	var_1_10002(var_4.Find(var_16_1, "lock"), arg_16_0:IsLockLiner())

	local var_16_2

	if not var_16_0 then
		var_1_10002 = arg_16_0.taskGroup[arg_16_0.nday]
		var_16_2 = arg_16_0.taskProxy

		local var_16_3

		if not var_3.getTaskById(var_16_2, var_1_10002) then
			var_16_2 = arg_16_0.taskProxy
			var_16_3 = var_3.getFinishTaskById(var_16_2, var_1_10002)
		end

		arg_16_0.curTaskVO = var_16_3
		math = var_16_3

		local var_16_4 = var_16_3.min
		local var_16_5 = arg_16_0.activity

		arg_16_0.remainCnt = var_16_4(var_16_2.getDayIndex(var_16_5), #arg_16_0.taskGroup) - arg_16_0.nday

		local var_16_6 = arg_16_0.curTaskVO

		if var_4.getTaskStatus(var_16_6) == 1 then
			arg_16_0.remainCnt = arg_16_0.remainCnt + 1
		end

		setActive = var_4

		var_4(arg_16_0.signBtn, arg_16_0.remainCnt > 0)

		setActive = var_4

		var_4(arg_16_0.signGreyBtn, arg_16_0.remainCnt <= 0)
		...
		var_4(var_16_7, var_7("liner_sign_cnt_tip") .. arg_16_0.remainCnt)

		local var_16_8 = arg_16_0.uilist

		var_4.align(var_16_8, #arg_16_0.taskGroup)
	else
		getProxy = var_1_10002
		ActivityProxy = var_4

		local var_16_9 = var_1_10002(var_4)
		local var_16_10 = var_2.getActivityById

		ActivityConst = var_16_2

		local var_16_11 = var_16_10(var_16_9, var_16_2.LINER_NAMED_ID)
...
function var_0_1.IsNamed(arg_18_0)
	...
	return var_18_1(var_18_0, var_1_10004.LINER_NAMED_ID) and not var_1:isEnd() and var_1:getStrData1() ~= ""
end
...
function var_0_1.IsLockLiner(arg_19_0)
	...
	return not var_19_1(var_19_0, var_1_10004.LINER_ID) or var_1:isEnd()
end
