...
function var_0_1.initBtn(arg_1_0)
	...
	function arg_1_0.btnFuncList.shop(arg_2_0)
		...
		local function var_2_2()
			...
			if not var_3_0(var_3_2(var_3_1, var_3_10005.ACTIVITY_TYPE_SHOP), function(arg_4_0)
				return arg_4_0:getConfig("config_id") == 3
			end) or var_0:isEnd() then
				pg = var_3_10001

				local var_3_3 = var_3_10001.TipsMgr.GetInstance()
			...
			local var_3_4 = var_3_10001.New
			local var_3_5 = {}

			HolidayVillaShopMediator = var_3_1
			var_3_5.mediator = var_3_1
			HolidayVillaShopLayer = var_3_1
			...
			var_3_8(var_3_7, var_5.OPEN_LAYER, var_3_6)
	...
	function var_1_1.activity(arg_5_0)
		...
		local function var_5_2()
			...
			local var_6_2 = var_6_1(var_6_0, var_3_10003.HOLIDAY_ACT_PRE_ID).data3

			if 5 <= var_6_2 then
				underscore = var_6_2

				local var_6_3 = var_6_2.flatten

				var_3_10005 = var_0

				local var_6_4 = var_6_3(var_0.getConfig(var_3_10005, "config_data"))

				getProxy = var_2
				TaskProxy = var_3_10004

				local var_6_5 = var_2(var_3_10004)
				local var_6_6 = var_6_4[var_0.data3]
				local var_6_7 = var_6_5:getTaskVO(var_6_6)

				if var_3_10004.getTaskStatus(var_6_7) == 2 then
					local var_6_8 = arg_1_0

					var_3_10005 = var_3_10005.emit
					ActivityMediator = var_3_10008
					var_3_10008 = var_3_10008.EVENT_GO_SCENE
					SCENE = var_3_10009

					var_3_10005(var_6_8, var_3_10008, var_3_10009.HOLIDAY_VILLA_MAP)
				else
					...
					local var_6_10 = var_3_10008.SELECT_ACTIVITY

					ActivityConst = var_3_10009

					var_3_10005(var_6_9, var_6_10, var_3_10009.HOLIDAY_ACT_PRE_ID)
				end
			else
				...
				local var_6_13 = var_3_10004.SELECT_ACTIVITY

				ActivityConst = var_3_10005

				var_6_12(var_6_11, var_6_13, var_3_10005.HOLIDAY_ACT_PRE_ID)
			end
	...
	local function var_1_4()
		...
		HolidayVillaMedalAlbumView = var_2_10003
