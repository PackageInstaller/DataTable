...
function var_0_1.PlayBGM(arg_2_0)
	...
	if not arg_2_0.activity then
		...
		var_2_2 = var_2_1(var_2_0, var_1_10005.ACTIVITY_TYPE_LINER)
		assert = var_2
		...
		if var_2_2 then
			...
			var_1_10006 = var_2_2
			var_2_3 = not var_2_2.isEnd(var_1_10006)
		end
		...
		var_2(var_2_3, var_2_4 .. var_1_10006.ACTIVITY_TYPE_LINER)
	end

	local var_2_5 = var_2_2:GetBgmName()

	pg = var_1_10003

	local var_2_6 = var_1_10003.BgmMgr.GetInstance()

	var_3.Push(var_2_6, arg_2_0.__cname, var_2_5)
...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.targetLayoutCom = var_3_12(var_3_11, var_4(var_1_10006))
	...
	var_1(var_3.Find(var_3_15, "tpl"), false)
	...
	LinerPassTimePage = var_2
	arg_3_0.timePage = var_2.New(var_3_21, arg_3_0)
	...
	Vector2 = var_5
	arg_3_0.delta = var_5(var_3_23 - 100, var_3_24 - 100) / 2
	Vector2 = var_5
...
function var_0_1.addListeners(arg_4_0)
	...
	local var_4_2 = var_4_1(var_4_0, var_1_10004.LINER_NAMED_ID)
	...
	if var_4_2 then
		...
		var_1_10006 = var_4_2
		var_4_3 = not var_4_2.isEnd(var_1_10006)
	end
	...
	var_1_10002(var_4_3, var_4_4 .. var_1_10006.LINER_NAMED_ID)
	...
	var_4_7(arg_4_0, arg_4_0.nameInput, function(arg_5_0)
		...
		do
			...
			LinerMediator = var_2_10005

			var_5_2(var_5_1, var_2_10005.SET_NAME, {
				actId = var_4_2.id,
				strValue = var_5_0,
				callback = function()
					...
					var_6_2(var_6_1, var_3("liner_name_modify"))
	...
	local var_4_7 = var_4_7 == var_4_0 and var_4_7
	...
	local var_4_10 = var_4_9(var_4_8, var_6(var_1_10008))
	...
	var_4_10(var_5.Find(var_4_11, "name/edit"), not var_4_7)

	onButton = var_4_10

	local var_4_12 = arg_4_0
	local var_4_13 = arg_4_0.topUI
	local var_4_14 = var_6.Find(var_4_13, "back")
	...
	var_4_10(var_4_12, var_4_14, var_4_15, var_4_13)

	onButton = var_4_10

	local var_4_16 = arg_4_0
	local var_4_17 = arg_4_0.topUI
	local var_4_18 = var_6.Find(var_4_17, "home")
	...
	var_4_10(var_4_16, var_4_18, var_4_19, var_4_17)

	onButton = var_4_10

	local var_4_20 = arg_4_0
	local var_4_21 = arg_4_0.topUI
	local var_4_22 = var_6.Find(var_4_21, "help")
	...
	local function var_4_23()
		...
		pg = var_2_10004
		var_9_2.helps = var_2_10004.gametip.liner_help.tip
	...
	var_4_10(var_4_20, var_4_22, var_4_23, var_4_21)
	...
	var_4_10(var_4_24, var_4_25, var_4_26, var_4_21)

	onButton = var_4_10

	local var_4_27 = arg_4_0
	local var_4_28 = arg_4_0.topUI
	local var_4_29 = var_6.Find(var_4_28, "fullview")
	...
	var_4_10(var_4_27, var_4_29, var_4_30, var_4_28)
...
function var_0_1.didEnter(arg_13_0)
	...
	var_1_10002.insert(var_13_0, function(arg_14_0)
		...
		if var_1.GetCurIdx(var_14_0) == 1 then
			...
			var_14_2(var_14_1, var_2_10004.delayedCall, function()
				local var_15_0 = arg_13_0.targetIds[1]

				triggerButton = var_3_10001

				local var_15_1 = arg_13_0._tf
				local var_15_2 = var_3.Find

				tostring = var_3_10006

				var_3_10001(var_15_2(var_15_1, var_3_10006(var_15_0), arg_13_0.roomsTF))
...
function var_0_1.InitRooms(arg_18_0)
	...
	var_1(arg_18_0.roomsTF, function(arg_19_0)
		...
		if var_2_10002.contains(arg_18_0.roomIds, var_1) then
	...
	arg_18_0.floatItemList = var_18_1(var_18_2, var_4.Find(var_18_3, "tpl"))
	...
	var_1.make(var_18_4, function(arg_20_0, arg_20_1, arg_20_2)
		...
		if arg_20_0 == var_2_10003.EventUpdate then
			...
			var_2_10005(arg_20_2:Find("tag"), function(arg_21_0)
			...
			var_2_10005(arg_20_2:Find("arrow"), function(arg_22_0)
				setActive = var_3_10001
			...
			var_2_10005(var_20_2, var_20_3, var_20_4, var_10)
		end
...
function var_0_1.OnUpdateRoom(arg_26_0, arg_26_1, arg_26_2)
	...
	if not var_1_10003.contains(arg_26_0.roomIds, arg_26_1) then
		...
		var_3(var_26_0, var_26_1, var_26_2, var_8)
	...
	if not var_1_10004.contains(arg_26_0.targetIds, arg_26_1) then
		LinerTime = var_26_5
	...
	var_6(var_26_7, var_26_5)

	eachChild = var_6

	var_6(var_26_7, function(arg_28_0)
	...
	if var_26_4 == var_6.TYPE.EXPLORE then
		table = var_6
	...
	local function var_26_12()
		...
		LinerTime = var_2_10004
		var_29_4[var_2_10004.TYPE.TARGET] = function()
			pg = var_3_10000
			...
			var_32_1(var_32_0, var_3.GetStory(var_32_2), function()
				local var_33_0 = arg_26_0
				local var_33_1 = var_0.emit

				LinerMediator = var_4_10003

				var_33_1(var_33_0, var_4_10003.CLICK_ROOM, arg_26_0.activity.id, arg_26_1)
		...
		LinerTime = var_4
		var_29_4[var_4.TYPE.EXPLORE] = function()
		...
		LinerTime = var_4
		var_29_4[var_4.TYPE.EVENT] = function()
			local var_36_0 = arg_26_0.curTime
			local var_36_1 = var_0.GetEventSubType(var_36_0, arg_26_1)

			LinerTime = var_3_10001

			if var_36_1 == var_3_10001.EVENT_SUB_TYPE.CLUE then
				...
				if var_36_1 == var_1.EVENT_SUB_TYPE.STORY then
					...
					var_36_4(var_36_3, var_4.GetStory(var_36_5, arg_26_1), function()
						local var_38_0 = arg_26_0
						local var_38_1 = var_0.emit

						LinerMediator = var_4_10003

						var_38_1(var_38_0, var_4_10003.CLICK_ROOM, arg_26_0.activity.id, arg_26_1)
		...
		LinerTime = var_4
		var_29_4[var_4.TYPE.STORY] = function()
			...
			var_3_10000({
				...
				function(arg_42_0)
					...
					var_42_1(var_42_0, var_4.GetStory(var_42_2), arg_42_0, true)
				...
				var_43_1(var_43_0, var_4_10003.CLICK_ROOM, arg_26_0.activity.id, arg_26_1)
	...
	var_8(var_26_10, var_26_11, var_26_12, var_13)
...
function var_0_1.UpdateRoomChar(arg_44_0, arg_44_1, arg_44_2)
	...
	if var_44_4 ~= "" then
		...
		var_9.GetSpineChar(var_44_8, var_44_4, true, function(arg_45_0)
			...
			local var_45_1 = var_2_10003(arg_45_0)
			local var_45_2 = {}

			LinerRoomCharPoint = var_5
			var_45_2.x = var_5.SCALE
			LinerRoomCharPoint = var_5
			var_45_2.y = var_5.SCALE
			...
			var_45_4(var_45_3, var_45_5, var_5(arg_45_0), var_44_2[2])
...
function var_0_1.InitCharBehavior(arg_46_0, arg_46_1, arg_46_2, arg_46_3)
	...
	if var_46_0.type == 2 then
		...
		var_1_10009 = arg_46_2
		var_1_10009 = arg_46_2.GetComponent(var_1_10009, "SpineAnimUI")

		var_7.SetAction(var_1_10009, var_46_2, 0)
	elseif var_46_0.type == 1 then
		local var_46_3 = var_46_0.startPoint.x
		local var_46_4 = var_46_0.endPoint.x - var_46_3

		LinerRoomCharPoint = var_1_10009

		local var_46_5 = var_46_4 / var_1_10009.SPEED

		setLocalPosition = var_46_6

		var_46_6(arg_46_2, var_46_0.startPoint)
		...
		if not arg_46_3 then
			...
			LinerRoomCharPoint = var_46_6
			var_46_6 = var_46_6.MOVE_ACTION
		end

		local var_46_7 = arg_46_2:GetComponent("SpineAnimUI")

		var_10.SetAction(var_46_7, var_46_6, 0)

		local var_46_8 = arg_46_0
		local var_46_9 = arg_46_0.managedTween

		LeanTween = var_13

		local var_46_10 = var_13.value
		local var_46_11

		go = var_1_10015

		local var_46_12 = var_46_9(var_46_8, var_46_10, var_46_11, var_1_10015(arg_46_2), var_46_3, var_7, var_46_5)
		local var_46_13 = var_10.setOnUpdate

		System = var_46_10

		local var_46_14 = var_46_13(var_46_12, var_46_10.Action_float(function(arg_47_0)
		...
		var_10.setLoopPingPong(var_46_14)
	end
...
function var_0_1.InitRandomChars(arg_49_0)
	...
	underscore = iter_49_0

	local var_49_3 = var_49_2(var_49_1, iter_49_0.filter(arg_49_0.roomIds, function(arg_50_0)
		return arg_50_0 ~= 4 and arg_50_0 ~= 31
	end), var_0_1.FINISH_CHAR_CNT)
	local var_49_4 = arg_49_0:GetRandomItems(arg_49_0.sdConfig, var_0_1.FINISH_CHAR_CNT)

	ipairs = var_49_1

	for iter_49_2, iter_49_3 in var_49_1(var_49_3) do
		local var_49_5 = var_49_4[iter_49_2]

		PoolMgr = var_1_10009

		local var_49_6 = var_1_10009.GetInstance()

		var_1_10009.GetSpineChar(var_49_6, var_49_5, true, function(arg_51_0)
			arg_49_0.roomChars[iter_49_3][1] = var_49_5
			...
			local var_51_2 = var_4(arg_51_0)
			local var_51_3 = {}

			LinerRoomCharPoint = var_6
			var_51_3.x = var_6.SCALE
			LinerRoomCharPoint = var_6
			var_51_3.y = var_6.SCALE

			var_2(var_51_2, var_51_3)

			setParent = var_2

			var_2(arg_51_0, var_51_1)
			...
			var_51_5(var_51_4, var_51_6, var_6(arg_51_0))
...
function var_0_1.FillRandomChars(arg_52_0)
	...
	for iter_52_0, iter_52_3 in var_4(arg_52_0.roomIds) do
		local var_52_3 = arg_52_0.rooms[iter_52_3]

		if var_9.GetSpineCharInfo(var_52_3, arg_52_0.curTime.id) and var_9[1] and var_9[2] then
			table = var_10

			var_10.removebyvalue(var_52_0, iter_52_3)
	...
	underscore = iter_52_3
	arg_52_0.randomIds = var_52_7(var_52_6, iter_52_3.filter(var_52_0, function(arg_53_0)
		return arg_53_0 ~= 4 and arg_53_0 ~= 31
	end), var_52_5)

	local var_52_8 = arg_52_0:GetRandomItems(var_52_1, var_52_5)

	ipairs = var_6

	for iter_52_4, iter_52_5 in var_6(arg_52_0.randomIds) do
		local var_52_9 = var_52_8[iter_52_4]

		PoolMgr = var_1_10012

		local var_52_10 = var_1_10012.GetInstance()

		var_1_10012.GetSpineChar(var_52_10, var_52_9, true, function(arg_54_0)
			arg_52_0.roomChars[iter_52_5][1] = var_52_9
			...
			local var_54_2 = var_4(arg_54_0)
			local var_54_3 = {}

			LinerRoomCharPoint = var_6
			var_54_3.x = var_6.SCALE
			LinerRoomCharPoint = var_6
			var_54_3.y = var_6.SCALE

			var_2(var_54_2, var_54_3)

			setParent = var_2

			var_2(arg_54_0, var_54_1)
			...
			var_54_5(var_54_4, var_54_6, var_6(arg_54_0))
...
function var_0_1.UpdateBg(arg_55_0, arg_55_1)
	...
	if not arg_55_1 then
		...
		local var_55_0 = arg_55_0.curTime

		var_55_1 = var_2.GetBgType(var_55_0)
	end
	...
	for iter_55_0, iter_55_1 in var_1_10003(arg_55_0.bgDiffList) do
		...
		var_1_10008(iter_55_1, function(arg_56_0)
			...
			var_2_10001(arg_56_0, arg_56_0.name == var_55_1)
...
function var_0_1.UpdateFinishTime(arg_57_0)
	...
	local var_57_2 = var_57_0(var_57_1, var_1_10004.time()).hour
	...
	var_57_6(var_57_5, var_8.GetReallyTimeType(var_57_7, var_57_2))
	...
	var_5(var_57_8, var_8.format("%d:%02d ", var_57_2, var_57_3) .. var_57_4)
...
function var_0_1.UpdateTimeUI(arg_58_0)
	...
	if arg_58_0.isReallyTime then
		...
		var_58_0(var_58_1, var_4("liner_target_type5"))
	...
	var_58_0(var_58_3, var_4.GetStartTimeDesc(var_58_4))
	...
	var_1_10002(arg_58_0.targetTagTF, function(arg_61_0)
		setActive = var_2_10001
	...
	LinerTime = var_1_10007
	var_58_9[var_1_10007.TYPE.TARGET] = function()
		i18n = var_2_10000

		local var_62_0 = "liner_target_type1"
		local var_62_1 = arg_58_0.rooms[arg_58_0.targetIds[1]]

		var_58_7 = var_2_10000(var_62_0, var_3.GetName(var_62_1))

		return
	end
	LinerTime = var_7
	var_58_9[var_7.TYPE.EXPLORE] = function()
		...
		local var_63_4 = var_63_0("liner_target_type2")

		string = var_63_2
		var_58_7 = var_63_4 .. var_63_2.format("(%d/%d)", var_63_1 - var_63_3, var_63_1)

		return
	end
	LinerTime = var_7
	var_58_9[var_7.TYPE.EVENT] = function()
		...
		string = var_64_2
		var_58_7 = var_64_4 .. var_64_2.format("(%d/%d)", var_64_3, var_64_1)

		return
	end
	LinerTime = var_7
	var_58_9[var_7.TYPE.STORY] = function()
		i18n = var_2_10000

		local var_65_0 = "liner_target_type4"
		local var_65_1 = arg_58_0.rooms[arg_58_0.targetIds[1]]

		var_58_7 = var_2_10000(var_65_0, var_3.GetName(var_65_1))

		return
	end

	var_58_5(var_58_8, var_58_9)

	local var_58_10 = arg_58_0.targetLayoutCom

	LinerTime = var_4
	var_58_10.spacing = (var_58_6 == var_4.TYPE.EXPLORE or arg_58_0.isFinishAll) and -60 or -10
...
function var_0_1.CheckTime(arg_66_0)
	...
	local var_66_3 = var_1_10003.max(var_66_2 - 1, 1)
...
function var_0_1.UpdateView(arg_68_0, arg_68_1)
	...
	LinerTime = var_1_10003

	if var_68_2 ~= var_1_10003.TYPE.EXPLORE and arg_68_0.targetIds[1] then
	...
	if var_68_4 == var_3.TYPE.EXPLORE then
		pg = var_68_4
		...
		if not var_2.IsPlayed(var_68_5, "Liner_1") then
			arg_68_0:FocusNode(var_0_1.GUIDE_ROOM_ID, function()
				...
				var_69_2(var_69_1, var_3.STORY_UPDATE, {
					storyId = "Liner_1"
				})
...
function var_0_1.UpdateData(arg_70_0)
	...
	local var_70_0 = var_1_10001(var_1_10003)
	local var_70_1 = var_1.getActivityByType

	ActivityConst = var_1_10004
	arg_70_0.activity = var_70_1(var_70_0, var_1_10004.ACTIVITY_TYPE_LINER)
	assert = var_1

	local var_70_2

	if arg_70_0.activity then
		var_1_10005 = arg_70_0.activity
		var_70_2 = not var_3.isEnd(var_1_10005)
	end

	local var_70_3 = "not exist liner act, type: "

	ActivityConst = var_1_10005

	var_1(var_70_2, var_70_3 .. var_1_10005.ACTIVITY_TYPE_LINER)

	local var_70_4 = arg_70_0.activity

	arg_70_0.endingStory = var_1.getConfig(var_70_4, "config_client").endingstory[1]

	local var_70_5 = arg_70_0.activity

	arg_70_0.timeConfig = var_1.getConfig(var_70_5, "config_client").endingtime

	local var_70_6 = arg_70_0.activity

	arg_70_0.sdConfig = var_1.getConfig(var_70_6, "config_client").sd

	local var_70_7 = arg_70_0.activity

	arg_70_0.isFinishAll = var_1.IsFinishAllTime(var_70_7)
	...
	if arg_70_0.isFinishAll then
		...
		local var_70_8 = var_70_9.NewStoryMgr.GetInstance()

		var_70_9 = var_70_9.IsPlayed(var_70_8, arg_70_0.endingStory)
	end

	arg_70_0.isReallyTime = var_70_9

	local var_70_10 = arg_70_0.activity

	arg_70_0.exploredRoomIds = var_1.GetExploredRoomIds(var_70_10)

	local var_70_11 = arg_70_0.activity

	arg_70_0.curEventInfos = var_1.GetCurEventInfo(var_70_11)
	...
	if arg_70_0.curTime then
		...
		arg_70_0.oldTime = var_70_12

		local var_70_13 = arg_70_0.activity

		arg_70_0.curTime = var_1.GetCurTime(var_70_13)
		...
		if arg_70_0.isFinishAll then
			...
			local var_70_14 = arg_70_0.curTime
			local var_70_15 = var_1.GetType(var_70_14)

			LinerTime = var_1_10002

			if var_70_15 == var_1_10002.TYPE.EVENT then
				arg_70_0.targetIds = {
					arg_70_0:_getCurEventRoomId()
				}
			else
				local var_70_16 = arg_70_0.curTime

				arg_70_0.targetIds = var_1.GetTargetRoomIds(var_70_16)
			end
		end
...
function var_0_1.UpdateTips(arg_72_0)
	...
	local var_72_1 = var_3.Find(var_72_0, "tip")

	LinerLogBookLayer = var_1_10004

	var_1_10001(var_72_1, var_1_10004.IsTip())
...
function var_0_1.onDragFunction(arg_73_0)
	...
	for iter_73_0, iter_73_1 in var_73_0(arg_73_0.targetIds) do
		...
		if var_73_3(var_73_2, var_1_10009(iter_73_1)) then
			var_1_10009 = arg_73_0._tf

			local var_73_4 = var_7.InverseTransformPoint(var_1_10009, var_6.position)
			local var_73_5

			ipairs = var_1_10009

			for iter_73_2, iter_73_3 in var_1_10009(var_0_1.screenPoints) do
				local var_73_6 = var_0_1.screenPoints[iter_73_2 % 4 + 1]

				Vector2 = var_1_10015
				var_1_10015 = var_1_10015(var_73_4.x, var_73_4.y)
				LineLine = var_1_10016
				Vector2 = var_18

				local var_73_7, var_73_8

				var_1_10016, var_73_7, var_73_8 = var_1_10016(var_18.zero, var_1_10015, iter_73_3, var_73_6)

				if var_1_10016 then
					var_73_5 = var_1_10015 * var_73_7

					break
				end
			end

			local var_73_9 = arg_73_0.floatItemList.container

			var_1_10009 = var_1_10009.Find
			tostring = iter_73_2

			local var_73_10 = var_1_10009(var_73_9, iter_73_2(iter_73_1))
			local var_73_11 = var_1_10009.GetComponent

			typeof = iter_73_3
			CanvasGroup = var_1_10015

			local var_73_12 = var_73_11(var_73_10, iter_73_3(var_1_10015))

			tobool = var_73_9
			var_73_12.interactable = var_73_9(var_73_5)
			var_73_12.blocksRaycasts = var_11
			var_73_12.alpha = var_11 and 1 or 0
			setActive = var_12
			var_1_10016 = arg_73_0.roomsTF

			var_12(var_14.Find(var_1_10016, iter_73_1 .. "/tag"), not var_11)

			if var_73_5 then
				local var_73_13 = var_73_5
				local var_73_14 = var_73_5 * (1 - 50 / var_73_5.Magnitude(var_73_13))

				setAnchoredPosition = var_13

				var_13(var_1_10009, var_73_14)

				math = var_13

				local var_73_15 = var_13.rad2Deg

				math = var_73_13

				local var_73_16 = var_73_15 * var_73_13.atan2(var_73_5.y, var_73_5.x)

				setLocalEulerAngles = var_14

				var_14(var_1_10009:Find("arrow"), {
					z = var_73_16
				})
			end
		end
...
function var_0_1.FocusNode(arg_74_0, arg_74_1, arg_74_2)
	...
	local var_74_2 = var_74_1(var_74_0, var_1_10006(arg_74_1)).anchoredPosition * -1

	math = var_74_0
	var_74_2.x = var_74_0.clamp(var_74_2.x, -arg_74_0.extendLimit.x, arg_74_0.extendLimit.x)
	math = var_5
	...
	var_6.insert(var_74_3, function(arg_75_0)
		...
		var_2_10001(var_75_0, var_2_10004(var_2_10006), false)
		...
		if 0 < var_75_1 then
			...
			local var_75_6 = var_75_4(var_75_5, var_2_10007(var_74_2.x, var_74_2.y, 0), var_75_2)
			local var_75_7 = var_4.setEase

			LeanTweenType = var_7

			local var_75_8 = var_75_7(var_75_6, var_7.easeInOutSine)
			local var_75_9 = var_4.setOnUpdate

			System = var_7

			local var_75_10 = var_75_9(var_75_8, var_7.Action_float(function(arg_76_0)
			...
			System = var_7
			var_75_3.twFocusId = var_75_11(var_75_10, var_7.Action(arg_75_0)).uniqueId
	...
	var_6(var_74_3, function()
		...
		var_2_10000(var_77_0, var_2_10003(var_2_10005), true)
...
function var_0_1.SwitchMode(arg_78_0, arg_78_1, arg_78_2)
	...
	local var_78_5 = var_1_10009.value
	local var_78_6

	go = var_1_10011

	local var_78_7 = var_78_4(var_78_3, var_78_5, var_78_6, var_1_10011(arg_78_0.mapTF), var_78_1, var_78_2, var_0_1.SCALE_ANIM_TIME)
	...
	var_78_10(var_78_9, var_9.Action_float(function(arg_79_0)
	...
	if not var_78_0 then
		...
		local var_78_13 = var_9.move
		local var_78_14

		go = var_11

		local var_78_15 = var_11(arg_78_0.mapTF)

		Vector3 = var_12

		local var_78_16 = var_78_12(var_78_11, var_78_13, var_78_14, var_78_15, var_12(0, 0, 0), var_0_1.SCALE_ANIM_TIME)
		...
		var_78_19(var_78_18, var_9.Action(function()
			if arg_78_2 then
				arg_78_2()
			end
...
function var_0_1.PlayAnim(arg_81_0, arg_81_1, arg_81_2)
	...
	var_1_10003({
		...
		function(arg_84_0)
			...
			local var_84_3 = var_84_2(var_84_1, var_4(var_2_10006))
