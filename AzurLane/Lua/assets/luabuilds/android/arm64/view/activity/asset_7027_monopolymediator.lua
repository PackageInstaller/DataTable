...
function var_0_1.register(arg_1_0)
	...
	MonopolyPtMediator = var_1_10004
	...
	var_1_1(var_1_0, var_1_10004.ON_STOP, function(arg_2_0, arg_2_1, arg_2_2)
		if not arg_1_0.viewComponent.autoFlag then
			...
			if #var_3.AWARDS > 0 then
				...
				MonopolyPtMediator = var_2_10007
	...
	if not arg_1_0.viewComponent.autoFlag then
		...
		if #var_1.AWARDS > 0 then
			...
			local var_1_16 = var_4.ON_ACHIEVE

			MonopolyPtMediator = var_5

			var_1_15(var_1_14, var_1_16, var_5.AWARDS, function()
				return
			end)
...
function var_0_1.getLeftRpCount()
	...
	local var_9_2 = var_9_1(var_9_0, var_1_10003.ACTIVITY_TYPE_MONOPOLY).data2_list[2]
...
function var_0_1.onAward(arg_10_0, arg_10_1, arg_10_2)
	for iter_10_0 = 1, #arg_10_1 do
		...
		MonopolyPtMediator = var_1_10009

		var_1_10007(var_1_10009.AWARDS, arg_10_1[iter_10_0])
	end
	...
	if arg_10_0.viewComponent.autoFlag then
		...
		local var_10_3 = iter_10_0.ON_ACHIEVE

		MonopolyPtMediator = var_1_10007

		var_10_2(var_10_1, var_10_3, var_1_10007.AWARDS, arg_10_2)
...
function var_0_1.handleNotification(arg_12_0, arg_12_1)
	...
	if var_12_0 ~= var_12_1.ACTIVITY_UPDATED then
		ActivityProxy = var_5
		...
		if var_12_0 == var_5.ACTIVITY_ADDED then
			...
			if var_12_0 == var_5.MONOPOLY_AWARD_DONE then
				local var_12_5 = arg_12_0._activity
				local var_12_6 = var_5.getConfig(var_12_5, "type")

				ActivityConst = var_12_3

				if var_12_6 == var_12_3.ACTIVITY_TYPE_MONOPOLY and arg_12_0.viewComponent.onAward then
					local var_12_7 = arg_12_0.viewComponent

					var_5.onAward(var_12_7, var_12_2.awards, var_12_2.callback)
				else
					local var_12_8 = arg_12_0.viewComponent
					local var_12_9 = var_5.emit

					BaseUI = var_8

					var_12_9(var_12_8, var_8.ON_ACHIEVE, var_12_2.awards, var_12_2.callback)
				end
			end
		end
