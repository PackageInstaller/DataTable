...
local var_0_2 = var_0_10001.activity_holiday_site
	...
	arg_1_0.taskTypeDic = var_1({
		[var_0_1.MINI_GAME] = function(arg_2_0, arg_2_1)
			...
			local function var_2_3()
				...
				local var_3_1 = var_3_10001(var_3_10003)
				local var_3_2 = var_1.getActivityById

				ActivityConst = var_3_10005

				local var_3_3 = var_3_2(var_3_1, var_3_10005.HOLIDAY_ACT_ID)
				local var_3_4 = var_2.getConfig(var_3_3, "config_client").function_id
				local var_3_5 = var_0_2[var_3_4[1]].task_id

				if var_3_0:getFinishTaskById(var_3_5) then
					local var_3_6 = arg_2_0

					var_3_10007 = var_3_10007.emit
					ActivityMediator = var_3_10010

					var_3_10007(var_3_6, var_3_10010.GO_MINI_GAME, var_2_0)
				else
					pg = var_3_10007

					local var_3_7 = var_3_10007.TipsMgr.GetInstance()
					local var_3_8 = var_7.ShowTips

					i18n = var_3_10010

					var_3_8(var_3_7, var_3_10010("challenge_minigame_unlock"))
				end
