...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_4.Find(var_4_1, "battle")
	...
	local function var_4_3()
		...
		local var_5_2 = var_2_10002(var_2_10004)
		...
		if var_2.getRawData(var_5_2).oil < var_5_1 then
			...
			var_5_4(var_5_3, var_2_10006("stage_beginStage_error_noResource"))
		...
		var_5_6(var_5_5, var_2_10006.CONTINUOUS_OPERATION)
	...
	local var_4_6 = var_4.Find(var_4_5, "window/top/btnBack")
	...
	local var_4_10 = var_4.Find(var_4_9, "bg")
...
function var_0_1.UpdateContent(arg_9_0)
	...
	local var_9_3 = var_1_10004(var_6)
	...
	if var_4.getRawData(var_9_3).oil < var_9_1 then
		...
		var_9_2 = var_9_4(var_9_5, var_9_6, var_1_10009)
	end
