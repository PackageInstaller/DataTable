...
function var_0_1.OnInit(arg_3_0)
	...
	if not var_3_1(var_3_0, var_1_10004.ACTIVITY_TYPE_PUZZLA) or var_1:isEnd() then
		arg_3_0:Destroy()
	...
	local var_3_2 = var_1_10002.activity_event_picturepuzzle[var_1.id]
	...
	var_3(arg_3_0, arg_3_0.bulin, function()
		...
		var_4_2(var_4_1, var_2_10004.PUZZLE_PIECE_OP, {
			cmd = 2,
			actId = var_0.id,
			id = var_4_0,
			callback = function()
...
function var_0_1.ShowAprilFoolBulin(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_2 = var_1_10005(var_1_10007)
	local var_8_3 = var_5.getActivityByType

	ActivityConst = var_1_10008

	if not var_8_3(var_8_2, var_1_10008.ACTIVITY_TYPE_PUZZLA) or var_3:isEnd() then
		return
	end
