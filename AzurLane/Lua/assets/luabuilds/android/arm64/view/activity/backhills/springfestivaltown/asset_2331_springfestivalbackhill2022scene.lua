...
function var_0_1.init(arg_2_0)
	...
	arg_2_0._sdPlace = var_1.Find(var_2_6, "SDPlace")
	...
	for iter_2_1 = 0, arg_2_0._upper.childCount - 1 do
		...
		go = var_1_10006
		var_1_10006 = var_1_10006(var_2_9).name
		arg_2_0["upper_" .. var_1_10006] = var_2_9
	end
	...
	import = var_3
	arg_2_0.graphPath = var_2_10(var_3("GameCfg.BackHillGraphs.SpringFestival2022Graph"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.springfes_tips1.tip
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "fushundamaoxian", function()
		...
		var_7_1(var_7_0, var_2_10003.GO_MINI_GAME, 37)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "longtenghuyue", function()
		...
		var_8_4.id = var_2_10006.ANSHAN_CHANGCHUN_GAIZAO_ID
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "huazhongshijie", function()
		...
		if not var_9_1(var_9_0, var_2_10003.ACTIVITY_TYPE_WORLDINPICTURE) or var_0:isEnd() then
			pg = var_2_10001
		...
		local var_9_4 = var_0:getConfig("config_client").linkActID

		pg = var_9_0

		local var_9_5 = var_9_0.m02
		local var_9_6 = var_2.sendNotification

		GAME = var_2_10005

		local var_9_7 = var_2_10005.GO_SCENE

		SCENE = var_2_10006

		var_9_6(var_9_5, var_9_7, var_2_10006.ACTIVITY, {
			id = var_9_4
		})
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "huituriji", function()
		...
		var_10_1(var_10_0, var_10_2, var_2_10004.COLORING)
...
function var_0_1.UpdateView(arg_12_0)
	...
	local var_12_2 = var_1_10003(var_1_10005)

	getProxy = var_1_10004
	ColoringProxy = var_1_10006

	local var_12_3 = var_1_10004(var_1_10006)
	...
	var_4(var_6.Find(var_12_5, "Tip"), var_12_4)
	...
	local var_12_7 = var_12_6(var_6.MINIGAME_SPRINGFESTIVAL_2022)

	setActive = var_4

	local var_12_8 = arg_12_0.upper_fushundamaoxian

	var_4(var_6.Find(var_12_8, "Tip"), var_12_7)
	...
	var_4(var_6.Find(var_12_10, "Tip"), var_12_9)
	...
	local var_12_13 = var_12_12(var_12_11, var_7.ACTIVITY_TYPE_WORLDINPICTURE)
	...
	var_4(var_6.Find(var_12_15, "Tip"), var_12_14)
	...
	local var_12_18 = var_12_17(var_12_16, var_7.ANSHAN_CHANGCHUN_GAIZAO_ID)
	...
	var_4(var_6.Find(var_12_20, "Tip"), var_12_19)
