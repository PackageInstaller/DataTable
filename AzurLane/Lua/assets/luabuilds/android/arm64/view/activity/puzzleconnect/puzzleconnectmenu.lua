	...
	local var_1_0 = {
		Ctor = function(arg_2_0)
			...
			local function var_2_2()
				...
				PlayerProxy = var_3_10007

				local var_3_2 = var_3_10005(var_3_10007)

				var_3_0(var_3_1 .. var_3_10003(var_5.getPlayerId(var_3_2)) .. "_" .. arg_2_0._configId, 1)
				...
				PuzzleConnectLayer = var_3

				var_3_5(var_3_4, var_3.OPEN_DETAIL, {
			...
			var_1(var_2_0, var_2_1, var_2_2, var_2_10006)
		...
		updateUI = function(arg_7_0)
			...
			for iter_7_0 = 1, var_0_1 do
				...
				findTF = var_2_10007
				var_2_10007 = var_2_10007(arg_7_0._tf, "iconBg/" .. iter_7_0)
				...
				if iter_7_0 <= #var_7_0 then
					...
					var_9(var_2_10006, var_7_1)

					onButton = var_9

					local var_7_2 = arg_7_0._event
					local var_7_3 = var_2_10006
					...
					local function var_7_4()
						...
						var_9_1(var_9_0, var_3_10003.ON_DROP, var_7_1)
					...
					var_9(var_7_2, var_7_3, var_7_4, var_2_10014)
					...
					var_9(var_2_10007, true)
				else
					setActive = var_7_1

					var_7_1(var_2_10006, false)

					setActive = var_7_1

					var_7_1(var_2_10007, false)
				end
			end
		...
		setItemMask = function(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
			...
			if arg_11_1 then
				...
				math = var_2_10011
				var_11_2 = var_2_10008(var_11_3, var_2_10011.floor(arg_11_3 / 24), arg_11_3 % 24)
			...
			if var_11_0 then
				...
				var_2_10008(var_11_4, var_2_10011("tolovegame_puzzle_ship_unknown"))
				...
				var_2_10008(var_11_5, var_2_10011("tolovegame_puzzle_lock"))
			else
				setText = var_2_10008
				...
				var_2_10008(var_11_6, var_2_10011.ship_data_statistics[arg_11_0._data.ship_id].name)
				...
				var_2_10008(var_11_7, var_2_10011("tolovegame_puzzle_unlock"))
			end
			...
			if var_11_1 then
				...
				typeof = var_2_10011
				Image = var_2_10013
				var_2_10008 = var_2_10008(var_11_8, var_2_10011(var_2_10013))
				Color = var_2_10009
				var_2_10008.color = var_2_10009.New(1, 1, 1, 0.5)
			else
				GetComponent = var_2_10008
				...
				typeof = var_2_10011
				Image = var_2_10013
				var_2_10008 = var_2_10008(var_11_9, var_2_10011(var_2_10013))
				Color = var_2_10009
				var_2_10008.color = var_2_10009.New(1, 1, 1, 1)
			end
		...
		updateDetailBtn = function(arg_12_0, arg_12_1)
			...
			elseif arg_12_0._progressCount == 3 then
				...
				var_12_2 = var_12_2(var_12_1, var_2_10006(var_2_10008))
			...
			var_12_2(var_5(arg_12_0._btnDetail, "on"), var_12_0)

			setActive = var_12_2
			findTF = var_5

			var_12_2(var_5(arg_12_0._btnDetail, "off"), not var_12_0)
		...
		updateProgress = function(arg_14_0)
			...
			for iter_14_0 = 1, var_0_2 do
				...
				var_2_10007 = var_2_10007(var_14_2, var_2_10010(iter_14_0))

				if iter_14_0 ~= 1 then
					findTF = var_2_10008
					var_14_1 = var_2_10008(arg_14_0._progressTf, "line" .. iter_14_0)
				end
				...
				if var_14_1 then
					...
					var_2_10008(var_2_10010(var_14_1, "on"), iter_14_0 <= var_14_0)

					setActive = var_2_10008
					findTF = var_2_10010

					var_2_10008(var_2_10010(var_14_1, "off"), var_14_0 < iter_14_0)
				end
				...
				if var_2_10007 then
					...
					var_2_10008(var_2_10010(var_2_10007, "on"), iter_14_0 <= var_14_0)

					setActive = var_2_10008
					findTF = var_2_10010

					var_2_10008(var_2_10010(var_2_10007, "off"), var_14_0 < iter_14_0)
				end
			end
...
function var_0_0.Ctor(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_1 = var_6(arg_18_0._tf, "back")
	...
	local function var_18_2()
		...
		var_19_1(var_19_0, var_2_10003.ON_BACK)
	...
	var_3(var_18_0, var_18_1, var_18_2, var_8)
	...
	local function var_18_5()
		...
		var_20_1(var_20_0, var_2_10003.ON_HOME)
	...
	var_3(var_18_3, var_18_4, var_18_5, var_8)
...
function var_0_0.setActivity(arg_22_0, arg_22_1)
	...
	parseTimeConfig = var_1_10006

	local var_22_4, var_22_5 = var_1_10006(arg_22_1:getConfig("time"))

	pg = var_8

	local var_22_6 = var_8.TimeMgr.GetInstance()
	local var_22_7 = var_8.parseTimeFromConfig(var_22_6, var_22_4[2])

	pg = var_1_10009

	local var_22_8 = var_1_10009.TimeMgr.GetInstance()
	local var_22_9 = var_9.GetServerTime(var_22_8)

	for iter_22_0 = 1, #arg_22_0.items do
		local var_22_10 = var_22_3 < iter_22_0 and true or false
		local var_22_11 = var_22_7 + 0 * (iter_22_0 - 1)

		math = var_1_10016
		var_1_10016 = var_1_10016.floor((var_22_11 - var_22_9) / 16)

		local var_22_12 = true
		local var_22_13 = arg_22_0.items[iter_22_0]
		local var_22_14 = var_18.getConfigId(var_22_13)
		local var_22_16

		if 1 < iter_22_0 then
			local var_22_15 = arg_22_0.items[iter_22_0 - 1]

			var_22_16 = var_22_16.getConfigId(var_22_15)
			table = var_20

			if not var_20.contains(var_22_2, var_22_16) then
				var_22_12 = false
			end
		end

		PuzzleConnectMediator = var_22_16

		local var_22_17 = var_22_16.GetPuzzleActivityState(var_22_14, arg_22_1)
		local var_22_18 = false

		PuzzleConnectMediator = var_21

		if var_22_17 ~= var_21.state_complete and not var_22_10 and var_22_12 then
			PlayerPrefs = var_21

			local var_22_19 = var_21.GetInt
			local var_22_20 = "puzzle_connect_new_"

			tostring = var_1_10024
			getProxy = var_1_10026
			PlayerProxy = var_1_10028
			var_1_10028 = var_1_10026(var_1_10028)

			if var_22_19(var_22_20 .. var_1_10024(var_1_10026.getPlayerId(var_1_10028)) .. "_" .. var_22_14) ~= 1 then
				var_22_18 = true
			end
		end
		...
		PuzzleConnectMediator = var_22

		if var_22_17 == var_22.state_collection then
			var_22_21 = 0
		else
			PuzzleConnectMediator = var_22

			if var_22_17 == var_22.state_puzzle then
				var_22_21 = 1
			else
				PuzzleConnectMediator = var_22

				if var_22_17 == var_22.state_connection then
					var_22_21 = 2
				else
					PuzzleConnectMediator = var_22

					if var_22_17 == var_22.state_complete then
						var_22_21 = 3
					end
				end
			end
		...
		var_1_10024 = arg_22_0.items[iter_22_0]

		var_22.setItemNew(var_1_10024, var_22_18)

		var_1_10024 = arg_22_0.items[iter_22_0]

		var_22.setItemMask(var_1_10024, var_22_10, var_22_12, var_1_10016, var_22_21)
	end
...
function var_0_0.createItem(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_1 = var_23_0(var_1_10005(var_1_10007(arg_23_0.itemTpl)), arg_23_0._event, arg_23_2)
