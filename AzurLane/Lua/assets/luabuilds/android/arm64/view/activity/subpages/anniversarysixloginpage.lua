...
function var_0_0.OnFirstFlush(arg_1_0)
	...
	local var_1_1 = arg_1_0.bg:Find("btn_more")
	local var_1_2 = PLATFORM_CODE == PLATFORM_CH and LuaHelper.GetCHPackageType() == PACKAGE_TYPE_BILI and pg.TimeMgr.GetInstance():inTime(arg_1_0.activity:getConfig("config_client")[2])
