...
local var_0_0 = "AnniversarySixLoginPage"
...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	local var_1_2 = var_3.Find(var_1_1, "btn_more")
	...
	if var_4 == var_1_1 then
		LuaHelper = var_4

		local var_1_3 = var_4.GetCHPackageType()

		PACKAGE_TYPE_BILI = var_1_1

		if var_1_3 == var_1_1 then
			pg = var_1_3

			local var_1_4 = var_1_3.TimeMgr.GetInstance()
			local var_1_5 = var_4.inTime
			local var_1_6 = arg_1_0.activity

			var_1_7 = var_1_5(var_1_4, var_7.getConfig(var_1_6, "config_client")[2])
	...
	local var_1_10 = var_4.Find(var_1_9, "btn_more")
