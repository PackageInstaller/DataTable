...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.CorePage.SailingShip3.SailingShip3CoreActivityUI"))
...
function var_0_1.didEnter(arg_4_0)
	...
	if not arg_4_0.contextData.activeScenario then
		...
		var_4_1 = var_4_1(var_4_0, var_1_10004(var_1_10006))
	...
	var_4_1(var_4_2, var_4_3, var_4_4, var_1_10006)
...
function var_0_1.ONToggleName(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_0 = arg_6_1:Find("on/name")

	i18n = var_1_10006

	var_1_10003(var_6_0, var_1_10006("dal_main_sheet" .. arg_6_2:getConfig("is_show")))

	setText = var_1_10003

	local var_6_1 = arg_6_1:Find("off/name")

	i18n = var_6

	var_1_10003(var_6_1, var_6("dal_main_sheet" .. arg_6_2:getConfig("is_show")))

	setText = var_1_10003

	local var_6_2 = arg_6_1:Find("on/name_1")

	i18n = var_6

	var_1_10003(var_6_2, var_6("dal_main_sheet" .. arg_6_2:getConfig("is_show") .. "_en"))

	setText = var_1_10003

	local var_6_3 = arg_6_1:Find("off/name_1")

	i18n = var_6

	var_1_10003(var_6_3, var_6("dal_main_sheet" .. arg_6_2:getConfig("is_show") .. "_en"))
...
function var_0_1.selectActivity(arg_7_0, arg_7_1)
	...
	var_2(var_4.Find(var_7_0, "adapt/Main"), arg_7_1.id == 50241)

	SetActive = var_2

	local var_7_1 = arg_7_0._tf

	var_2(var_4.Find(var_7_1, "adapt/tab_bg"), arg_7_1.id ~= 50253)

	SetActive = var_2

	local var_7_2 = arg_7_0._tf

	var_2(var_4.Find(var_7_2, "adapt/Favorability_tan_bg"), arg_7_1.id == 50253)
...
function var_0_1.OnSetTime(arg_9_0)
	...
	local var_9_5 = var_4.Find(var_9_4, "adapt/top/btn_home/text_tip/timetext")

	i18n = var_1_10005

	var_2(var_9_5, var_1_10005("activity_remain_time"))

	setText = var_2

	local var_9_6 = arg_9_0._tf
	local var_9_7 = var_4.Find(var_9_6, "adapt/top/btn_home/text_tip/time")

	math = var_5

	local var_9_8 = var_5.floor(var_9_3 / 0)

	i18n = var_9_6

	var_2(var_9_7, var_9_8 .. var_9_6("word_date"))
