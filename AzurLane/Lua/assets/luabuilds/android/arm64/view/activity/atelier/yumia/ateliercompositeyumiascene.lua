...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.Atelier.base.AtelierCompositeBaseScene"))
...
function var_0_1.InitCustom(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "bg/Empty/bg/Text")

	i18n = var_4

	var_1(var_2_2, var_4(arg_2_0.unlockText))
...
function var_0_1.UpdateAdapt(arg_7_0)
	...
	var_7_5(var_7_4, var_8(var_1_10010)).aspectRatio = var_7_3
	...
	typeof = var_8
	AspectRatioFitter = var_1_10010
	var_7_7(var_7_6, var_8(var_1_10010)).aspectRatio = var_7_3
...
function var_0_1.OnClickStore(arg_8_0)
	...
	local var_8_3 = var_8_2(var_8_1, var_1_10005)

	addSubLayer = var_8_0
	Context = var_1_10005

	local var_8_4 = var_1_10005.New
	local var_8_5 = {}

	AtelierStoreBaseMediator = var_1_10008
	var_8_5.mediator = var_1_10008
	AtelierStoreYumiaScene = var_1_10008
	var_8_5.viewComponent = var_1_10008
	var_8_5.data = {
		activity = arg_8_0.activity
	}

	var_8_0(var_8_4(var_8_5), var_8_3)
...
function var_0_1.UpdateRyzaDrop(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	if var_15_3 ~= var_15_1 then
		...
		var_15_1("weaponframes", "bg" .. var_15_4, arg_15_1:Find("icon_bg"))

		local var_15_5 = arg_15_2.type

		DROP_TYPE_RYZA_DROP = var_7

		if var_15_5 ~= var_7 then
			onButton = var_15_5
			...
			var_15_5(var_15_6, var_15_7, var_15_8, var_1_10011)
		else
...
function var_0_1.AddChatTimer(arg_22_0)
	...
	math = var_1_10004
	arg_22_0.idleTimer = var_22_0(var_22_1, 8 + var_1_10004.random() * 4)
...
function var_0_1.DispalyChat(arg_24_0, arg_24_1)
	...
	local var_24_1 = var_1_10002(var_24_0, var_1_10005(var_1_10007))
