...
function var_0_1.didEnter(arg_3_0)
	...
	AuctionGameMainRightView = var_1_10006

	local var_3_5 = var_1_10006.EVENT_SELECTED

	handler = var_1_10007
	var_3_2[1] = var_3_4(var_3_3, var_3_5, var_1_10007(arg_3_0, arg_3_0.RefreshEstimate))
...
function var_0_1.RefreshEstimate(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_1_10004(var_5_0:GetStoreItemDataList()) do
		var_1_10011 = iter_5_1

		local var_5_3

		var_5_3, var_1_10010 = iter_5_1.GetEstimateValue(var_1_10011)
		var_5_1 = var_5_1 + var_5_3
		var_5_2 = var_5_2 + var_1_10010
	end

	setText = var_4

	local var_5_4 = arg_5_0.uiEstimateText

	i18n = iter_5_0

	local var_5_5 = "auction_store_estimate"

	StringHelper = var_1_10010

	local var_5_6 = var_1_10010.ForamtNumber(var_5_1)

	StringHelper = var_1_10011

	var_4(var_5_4, iter_5_0(var_5_5, var_5_6, var_1_10011.ForamtNumber(var_5_2)))
