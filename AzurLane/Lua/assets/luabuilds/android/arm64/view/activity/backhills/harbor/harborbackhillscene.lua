...
function var_0_1.init(arg_2_0)
	...
	import = var_2_9
	arg_2_0.graphPath = var_2_10(var_2_9("GameCfg.BackHillGraphs.HarborBackHillGraph"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.harbor_backhill_help.tip
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "xuanshangban", function()
		if var_0_1.XuanShangBanFirstTip() then
			...
			local var_7_2 = var_2_10001.SetInt

			var_2_10003 = "FIRST_INTO_ACT_"
			ActivityConst = var_2_10004

			var_7_2(var_2_10003 .. var_2_10004.PIRATE_MEDAL_ACT_ID .. "_" .. var_7_1, 1)
		end
		...
		local var_7_5 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		var_7_4(var_7_3, var_7_5, var_2_10004.TEMPESTA_MEDAL_COLLECTION)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "mimichuanchang", function()
		...
		var_8_1(var_8_0, var_8_2, var_2_10004.SECRET_SHIPYARD)
...
function var_0_1.XuanShangBanFirstTip()
	...
	local var_9_2 = var_1_10001.GetInt
	local var_9_3 = "FIRST_INTO_ACT_"

	ActivityConst = var_1_10004

	return var_9_2(var_9_3 .. var_1_10004.PIRATE_MEDAL_ACT_ID .. "_" .. var_9_1) == 0
end
...
function var_0_1.XuanShangBanTip()
	...
	local var_10_2 = var_10_1(var_10_0, var_1_10003.PIRATE_MEDAL_ACT_ID)
	local var_10_3
...
function var_0_1.MiMiChuanChangTip()
	...
	if not var_0_1.IsFinishAllActTask() then
		getProxy = var_13_0
		ActivityProxy = var_1_10002
		var_1_10002 = var_13_0(var_1_10002)
		var_13_0 = var_13_0.getActivityById
		ActivityConst = var_1_10003
		var_13_0 = var_13_0(var_1_10002, var_1_10003.BOAT_QIAN_SHAO_ZHAN)
		...
		return var_13_1(var_1_10002.MINIGAME_PIRATE_ID)
	end
...
function var_0_1.UpdateView(arg_14_0)
	...
	var_1_10001(var_3.Find(var_14_0, "Tip"), var_0_1.MiMiChuanChangTip())

	setActive = var_1_10001

	local var_14_1 = arg_14_0.upper_xuanshangban

	var_1_10001(var_3.Find(var_14_1, "Tip"), var_0_1.XuanShangBanTip())
