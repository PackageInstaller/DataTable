...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.uilist = var_1_7(var_1_8, var_4.Find(var_1_9, "1"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_3()
		...
		pg = var_2_10004
		var_3_2.helps = var_2_10004.gametip.metalgearsub_help_tip.tip
	...
	var_1_10002(var_2_1, var_2_2, var_2_3, var_1_10007)
	...
	local function var_2_6()
		...
		local var_4_2 = var_2_10003.GO_SUBMARINE_RUN
		local var_4_3 = var_2_0
		local var_4_4 = var_4.getConfig(var_4_3, "config_client").stage_ids

		math = var_2_10005

		var_4_1(var_4_0, var_4_2, var_4_4[var_2_10005.min(arg_2_0.progess + 1, arg_2_0.maxday)])
	...
	var_1_10002(var_2_4, var_2_5, var_2_6, var_1_10007)
	...
	local function var_2_10()
		...
		var_5_1(var_5_0, var_2_10003.ON_DROP, var_2_7)
	...
	var_1_10003(var_2_8, var_2_9, var_2_10, var_1_10008)
	...
	local function var_2_15()
		...
		var_6_1(var_6_0, var_2_10003.ON_DROP, var_2_12)
	...
	var_5(var_2_13, var_2_14, var_2_15, var_1_10010)
	...
	var_5.make(var_2_16, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			if arg_7_1 < arg_2_0.progess then
				...
				local var_7_3 = var_7_2(var_7_1, var_6.easeInOutSine)
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	var_8_3(var_8_2, var_6.min(arg_8_0.maxday, var_0_2 - 1))
	...
	var_8_3(var_5(arg_8_0.mainAward, "dis"), not var_8_0.data4 or var_8_0.data4 == 0)

	setActive = var_8_3
	findTF = var_5

	var_8_3(var_5(arg_8_0.mainAward, "dis/lock"), arg_8_0.maxday < var_0_2)

	setActive = var_8_3
	findTF = var_5

	var_8_3(var_5(arg_8_0.mainAward, "get"), var_8_0.data4 > 0)
	...
	if var_8_0.data4 == 0 and arg_8_0.progess >= var_0_2 then
		...
		var_8_5(var_8_4, var_6.EVENT_OPERATION, {
			cmd = 3,
	...
	if not (var_8_5(var_8_0.data2_list[1], 0) > 0) then
		...
		if var_3(var_8_0.data2_list[2], 0) > 0 then
			...
			var_8_7(var_8_6, var_6.EVENT_OPERATION, {
				cmd = 2,
				activity_id = var_8_0.id
			})
		end
