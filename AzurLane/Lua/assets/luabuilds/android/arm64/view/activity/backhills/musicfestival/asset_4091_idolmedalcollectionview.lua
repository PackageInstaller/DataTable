...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.activityData = var_5_1(var_5_0, var_1_10004.IDOL_MEDAL_COLLECTION)
...
function var_0_1.addListener(arg_7_0)
	...
	local function var_7_5()
		...
		pg = var_2_10004
		var_9_2.helps = var_2_10004.gametip.music_collection.tip
	...
	for iter_7_0, iter_7_1 in var_1_10001(arg_7_0.switchBtnList) do
		...
		var_1_10006(var_7_6, var_7_7, var_7_8, var_1_10011)
	end

	addSlip = var_1
	SLIP_TYPE_HRZ = var_3

	var_1(var_3, arg_7_0.bg, function()
...
function var_0_1.updateMedalView(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_1 = var_1_10004.contains(arg_14_0.activeIDList, arg_14_2)
	...
	local var_14_6 = var_7
	local var_14_7 = var_7.Find(var_14_6, "Activable")
	local var_14_8 = var_7:Find("DisActive")

	setActive = var_14_6

	var_14_6(var_14_5, var_14_1)

	setActive = var_14_6

	var_14_6(var_14_7, var_14_2)

	setActive = var_14_6

	var_14_6(var_14_8, var_14_3)

	if var_14_5 then
		setImageSprite = var_14_6

		local var_14_9 = var_14_5

		GetSpriteFromAtlas = var_14
		var_1_10016 = "ui/musicfestivalmedalcollectionui_atlas"
		tostring = var_1_10017

		var_14_6(var_14_9, var_14(var_1_10016, var_1_10017(arg_14_2)))
	end
	...
	if var_14_2 then
		...
		local function var_14_12()
			...
			local var_15_2 = var_2_10003.MEMORYBOOK_UNLOCK
			local var_15_3 = {
				id = arg_14_2
			}

			ActivityConst = var_5
			var_15_3.actId = var_5.IDOL_MEDAL_COLLECTION
		...
		var_14_6(var_14_10, var_14_11, var_14_12, var_1_10016)
	end

	if var_14_3 then
		table = var_14_6

		local var_14_13 = var_14_6.indexof(arg_14_0.allIDList, arg_14_2, 1)
		local var_14_14 = arg_14_0.activityData
		local var_14_15 = var_12.getConfig(var_14_14, "config_client").unlock_desc[var_14_13]

		setText = var_13

		var_13(var_14_8, var_14_15)
	end
...
function var_0_1.updateSwitchBtnTF(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_1_10001(arg_16_0.switchBtnList) do
		...
		if arg_16_0:caculateActivatable(iter_16_0) == 0 or iter_16_0 == arg_16_0.curPage then
			setActive = var_16_0

			var_16_0(var_6, false)
		end
...
function var_0_1.updateAfterSubmit(arg_17_0, arg_17_1)
	...
	arg_17_0.activityProxy = var_1_10002(var_1_10004)

	local var_17_0 = arg_17_0.activityProxy
	local var_17_1 = var_2.getActivityById

	ActivityConst = var_1_10005
	arg_17_0.activityData = var_17_1(var_17_0, var_1_10005.IDOL_MEDAL_COLLECTION)
	...
	local var_17_3 = var_1_10007(#arg_17_0.activeIDList)

	COLOR_RED = var_1_10008

	var_2(var_17_2, var_5(var_17_3, var_1_10008) .. "/" .. #arg_17_0.allIDList)
	arg_17_0:checkAward()
...
function var_0_1.caculateActivatable(arg_19_0, arg_19_1)
	...
	for iter_19_0, iter_19_1 in var_1_10004(var_19_0) do
		...
		table = var_1_10010
		var_1_10010 = var_1_10010.contains(arg_19_0.activatableIDList, iter_19_1)
...
function var_0_1.checkAward(arg_20_0)
	if #arg_20_0.activeIDList == #arg_20_0.allIDList and arg_20_0.activityData.data1 ~= 1 then
		...
		local var_20_2 = var_1_10004.ACTIVITY_OPERATION
		local var_20_3 = {
			cmd = 1
		}

		ActivityConst = var_1_10006
		var_20_3.activity_id = var_1_10006.IDOL_MEDAL_COLLECTION
