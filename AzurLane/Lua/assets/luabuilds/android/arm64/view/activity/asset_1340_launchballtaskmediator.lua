...
function var_0_1.register(arg_1_0)
	...
	LaunchBallTaskMediator = var_1_10004

	var_1_1(var_1_0, var_1_10004.SUBMIT_ALL, function(arg_2_0, arg_2_1)
		...
		for iter_2_0 = 1, #arg_2_1 do
			...
			var_2_1(var_2_0, var_2_10009.SUBMIT_TASK, arg_2_1[iter_2_0].id)
		end
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_1 == var_5_0.SUBMIT_ACTIVITY_TASK_DONE then
		if #var_5_2.awards > 0 then
			...
			var_5_4(var_5_3, iter_5_0.ON_ACHIEVE, var_5_2.awards)
		end
		...
		if var_5_1 == var_5_4.SUBMIT_TASK_DONE then
			if arg_5_0.submit and arg_5_0.submit > 0 then
				...
				if arg_5_0.submit == 0 then
					...
					var_5_7(var_5_6, iter_5_0.ON_ACHIEVE, arg_5_0.awards, function()
				...
				var_5_9(var_5_8, iter_5_0.ON_ACHIEVE, var_5_2, function()
