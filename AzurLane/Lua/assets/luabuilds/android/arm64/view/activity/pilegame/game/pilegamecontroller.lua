...
function var_0_0.OnStartGame(arg_17_0, arg_17_1)
	...
	if arg_17_1 then
		...
		arg_17_0.lockTimer = var_17_2(var_17_3, var_1_10006.BAN_OP_TIME, 1)
...
function var_0_0.Update(arg_24_0)
	...
	if arg_24_0.state >= var_0_0.STATE_START and arg_24_0.state < var_0_0.STATE_END then
		...
		local var_24_1 = arg_24_0.time

		Time = var_2
		arg_24_0.time = var_24_1 + var_2.deltaTime
	end
...
function var_0_0.DoShake(arg_28_0)
	...
	for iter_28_0, iter_28_1 in var_1_10003(arg_28_0.shakePositions) do
		...
		Vector3 = var_1_10012
		var_1_10012 = var_1_10012(var_28_5, var_28_3.position.y, 0)
		...
		if var_28_3.onTheMove == true then
			...
			Vector3 = var_13
			var_28_3.position = var_13.MoveTowards(var_28_3.position, var_1_10012, var_28_1)
		end

		if var_28_3.position.x == var_1_10012.x and var_28_3.onTheMove == false then
			var_28_3.onTheMove = true
		elseif var_28_3.position.x == var_1_10011.x and var_28_3.onTheMove == true then
			var_28_3.onTheMove = false
		end

		local var_28_6 = arg_28_0.view

		var_13.OnItemPositionChange(var_28_6, var_28_3)
	end

	if arg_28_0.shakePositions[1][1].position.x ~= var_28_2.x then
		local var_28_7 = arg_28_0.view

		var_4.OnShake(var_28_7, var_3.x - var_28_2.x)
	end
...
function var_0_0.CheckCollide(arg_37_0)
	...
	elseif not var_37_3 and var_37_1 then
		...
		var_37_2.AddFailedCnt(var_37_6)

		local var_37_7 = arg_37_0.view

		var_37_2.UpdateFailedCnt(var_37_7, arg_37_0.model.maxFailedCnt, arg_37_0.model.failedCnt, true, arg_37_0.item)

		local var_37_8 = arg_37_0.model

		var_37_2.RemoveTailItem(var_37_8)

		local var_37_9 = arg_37_0.view

		var_37_2.OnRemovePile(var_37_9, arg_37_0.item)

		local var_37_10 = arg_37_0.model

		if var_37_2.IsMaxfailedCnt(var_37_10) then
	...
	elseif not var_37_1 and not var_37_5 then
		...
		var_37_2.AddScore(var_37_11)

		local var_37_12 = arg_37_0.model

		if var_37_2.IsExceedingTheHighestScore(var_37_12) then
			local var_37_13 = arg_37_0.view

			var_37_2.OnExceedingTheHighestScore(var_37_13)
		end

		local var_37_14 = arg_37_0.view

		var_37_2.UpdateScore(var_37_14, arg_37_0.model.score, arg_37_0.item)
		arg_37_0:CheckRock()
		arg_37_0:OnStartGame(true)
	else
		assert = var_37_2

		var_37_2(false, "Why is it running here?")
	end
