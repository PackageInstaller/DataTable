...
function var_0_1.OnUpdateFlush(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10001(arg_3_0.taskVOList) do
		...
		local var_3_4 = var_7:Find("Full")

		SkirmishVO = var_3_2

		if var_3_0 < var_3_2.StateClear then
			setActive = var_10
...
function var_0_1.initData(arg_5_0)
	...
	local var_5_0 = var_1_10003.activity_template

	ActivityConst = var_1_10004
	arg_5_0.taskGroup = var_1_10001(var_5_0[var_1_10004.ACTIVITY_ID_US_SKIRMISH].config_data)
	arg_5_0.taskCount = #arg_5_0.taskGroup
	getProxy = var_1
	SkirmishProxy = var_3
	arg_5_0.skirmishProxy = var_1(var_3)
...
function var_0_1.addListener(arg_6_0)
	...
	local function var_6_2()
		...
		if var_2_10000.gametip.help_tempesteve then
			...
			pg = var_2_10004
			var_7_2.helps = var_2_10004.gametip.help_tempesteve.tip
	...
	local function var_6_5()
		...
		local var_8_3 = var_2_10004.LEVEL
		local var_8_4 = {}

		SkirmishProxy = var_2_10006
		var_8_4.mapIdx = var_2_10006.SkirmishMap
