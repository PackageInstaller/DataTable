...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.Atelier.base.AtelierMaterialSelectView"))
...
function var_0_1.InitCustom(arg_1_0)
	...
	local var_1_5 = var_3.Find(var_1_4, "Frame/closeBtn/Text")

	i18n = var_4

	var_1(var_1_5, var_4("yumia_atelier_tip10"))

	setText = var_1

	local var_1_6 = arg_1_0._tf
	local var_1_7 = var_3.Find(var_1_6, "left/titleBg/Text_1")

	i18n = var_4

	var_1(var_1_7, var_4("yumia_atelier_tip8"))
...
function var_0_1.didEnter(arg_2_0)
	...
	local var_2_2 = var_4.Find(var_2_1, "Frame/closeBtn")
...
function var_0_1.UpdateCandicateItem(arg_4_0, arg_4_1, arg_4_2)
	...
	var_6(var_4_4, var_4_5, var_4_6, var_1_10011)
...
function var_0_1.UpdateCandicatePanel(arg_6_0, arg_6_1)
	...
	local var_6_5 = var_6_4(var_1_10006.activity_ryza_item.all, function(arg_7_0)
		local var_7_0
	...
	var_6_2.sort(var_6_5, function(arg_9_0, arg_9_1)
...
function var_0_1.ShowCandicatePanel(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	var_1_10005(arg_11_0._go, true)

	SetComponentEnabled = var_1_10005
	...
	var_1_10005(var_11_2, var_8(var_1_10010), false)
	...
	local var_11_4 = var_1_10005(var_11_3, var_8(var_1_10010))
	...
	var_5(var_7.Find(var_11_7, "select"), true)
...
function var_0_1.HideCandicatePanel(arg_15_0)
	...
	var_1(var_3.Find(var_15_0, "select"), false)
	...
	local var_15_2 = var_1(var_15_1, var_4(var_6))
