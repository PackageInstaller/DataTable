	...
	arg_5_0.btnFuncList = {
		task = function(arg_7_0)
			...
			var_2_10001(arg_5_0, arg_7_0, function()
				if var_5_2.taskLinkActID and var_5_0(var_5_2.taskLinkActID) then
					...
					var_8_1(var_8_0, var_3_10003("common_activity_end"))
				...
				local var_8_4 = var_3_10003.EVENT_GO_SCENE

				SCENE = var_3_10004

				var_8_3(var_8_2, var_8_4, var_3_10004.TASK, {
					page = "activity"
				})
		...
		shop = function(arg_9_0)
			...
			var_2_10001(arg_5_0, arg_9_0, function()
				if var_5_2.shopLinkActID then
					...
					if not var_10_0.getActivitiesById(var_3_10002, var_5_2.shopLinkActID) then
						underscore = var_10_0
		...
		build = function(arg_12_0)
			...
			var_2_10001(arg_5_0, arg_12_0, function()
				if var_5_2.buildLinkActID and var_5_0(var_5_2.buildLinkActID) then
					...
					var_13_1(var_13_0, var_3_10003("common_activity_end"))
				...
				local var_13_4 = var_3_10003.EVENT_GO_SCENE

				SCENE = var_3_10004

				local var_13_5 = var_3_10004.GETBOAT
				local var_13_6 = {}

				BuildShipScene = var_3_10006
				var_13_6.page = var_3_10006.PAGE_BUILD
				BuildShipScene = var_6
				var_13_6.projectName = var_6.PROJECTS.ACTIVITY
		...
		fight = function(arg_14_0)
			...
			var_2_10001(arg_5_0, arg_14_0, function()
				if var_5_2.fightLinkActID and var_5_0(var_5_2.fightLinkActID) then
					...
					var_15_1(var_15_0, var_3_10003("common_activity_end"))
				...
				var_15_3(var_15_2, var_3_10003.BATTLE_OPERA)
		...
		lottery = function(arg_16_0)
			...
			var_2_10001(arg_5_0, arg_16_0, function()
				if var_5_2.lotteryLinkActID and var_5_0(var_5_2.lotteryLinkActID) then
					...
					var_17_1(var_17_0, var_3_10003("common_activity_end"))
				...
				var_17_3(var_17_2, var_3_10003.GO_LOTTERY)
		...
		skinshop = function(arg_21_0)
			...
			var_2_10001(arg_5_0, arg_21_0, function()
				...
				local var_22_2 = var_3_10003.EVENT_GO_SCENE

				SCENE = var_3_10004

				var_22_1(var_22_0, var_22_2, var_3_10004.SKINSHOP)
		...
		display_btn = function(arg_23_0)
			...
			local function var_23_2()
				...
				local var_24_2 = var_3_10003.SHOW_AWARD_WINDOW

				PtAwardWindow = var_3_10004
				...
				var_24_3.unlockStamps = var_6.GetDayUnlockStamps(var_24_4)

				var_24_1(var_24_0, var_24_2, var_3_10004, var_24_3)
			...
			var_2_10001(var_23_0, var_23_1, var_23_2, var_2_10006)
		...
		get_btn = function(arg_25_0)
			...
			local function var_25_2()
				...
				local var_26_3 = var_3_10002(var_3_10004)
				local var_26_4 = var_2.getRawData(var_26_3)

				pg = var_3_10004

				local var_26_5 = var_3_10004.gameset.urpt_chapter_max.description[1]

				LOCK_UR_SHIP = var_26_3

				if var_26_3 then
					var_26_3 = 0
				else
					getProxy = var_26_3
					BagProxy = var_3_10007

					local var_26_6 = var_26_3(var_3_10007)

					var_26_3 = var_26_3.GetLimitCntById(var_26_6, var_26_5)
				end

				Task = var_3_10006

				local var_26_7, var_26_8 = var_3_10006.StaticJudgeOverflow(var_26_4.gold, var_26_4.oil, var_26_3, true, true, {
					{
						var_26_2.type,
						var_26_2.id,
						var_26_2.count
				...
				if var_26_7 then
					...
					var_8.insert(var_26_0, function(arg_27_0)
						...
						var_27_2.type = var_4_10005
						i18n = var_4_10005
						var_27_2.content = var_4_10005("award_max_warning")
						var_27_2.items = var_26_8
				...
				var_8(var_26_0, function()
					...
					ActivityMediator = var_4_10005

					local var_28_5 = var_4_10005.EVENT_PT_OPERATION
					local var_28_6 = {
						cmd = 1
					}
					local var_28_7 = arg_5_0.ptData

					var_28_6.activity_id = var_7.GetId(var_28_7)
			...
			var_2_10001(var_25_0, var_25_1, var_25_2, var_2_10006)
		...
		boost_btn = function(arg_30_0)
			...
			local function var_30_2()
				...
				if var_5_2.boostLinkActID and var_5_0(var_5_2.boostLinkActID) then
					pg = var_31_0
					var_3_10002 = var_31_0.TipsMgr.GetInstance()
					var_31_0 = var_31_0.ShowTips
					i18n = var_3_10003

					var_31_0(var_3_10002, var_3_10003("common_activity_end"))
				...
				local var_31_1 = var_31_0(var_3_10002)
				...
				local var_31_5 = var_0
				local var_31_6 = var_0.getConfig(var_31_5, "config_client").name
				local var_31_7 = var_0:getConfig("config_client").desc

				if var_31_4 and var_31_6 and var_31_7 then
					pg = var_31_5

					local var_31_8 = var_31_5.MsgboxMgr.GetInstance()
					...
					MSGBOX_TYPE_DROP_ITEM = var_3_10009
					var_31_10.type = var_3_10009
					i18n = var_3_10009
					var_31_10.content = var_3_10009(var_31_7)
					i18n = var_9
					var_31_10.name = var_9(var_31_6)
					var_31_10.iconPath = {
						"Props/" .. var_31_4,
						var_31_4
					}
			...
			var_2_10001(var_30_0, var_30_1, var_30_2, var_2_10006)
...
function var_0_1.OnUpdateFlush(arg_32_0)
	...
	if 1 <= var_32_12 then
		...
		if not var_9(var_32_14, var_1_10012) then
			var_32_15 = var_32_10
		end
		...
		var_32_18(arg_32_0.battleBtn, var_32_21 and not var_32_17 and var_32_19)

		setActive = var_32_18

		var_32_18(arg_32_0.getBtn, var_32_17)

		setActive = var_32_18

		var_32_18(arg_32_0.gotBtn, not var_32_19)

		local var_32_22 = arg_32_0.ptData
		local var_32_23 = var_9.GetAward(var_32_22)

		updateDrop = var_32_20

		var_32_20(arg_32_0.awardTF, var_32_23)
		...
		local function var_32_26()
			...
			var_33_1(var_33_0, var_2_10003.ON_DROP, var_32_23)
		...
		var_32_20(var_32_24, var_32_25, var_32_26, var_1_10015)
...
function var_0_1.GetWorldPtData(arg_35_0, arg_35_1)
	...
	if arg_35_1 <= var_35_1 - var_35_2 then
		...
		var_35_7.activity_id = var_7.GetId(var_35_8)
