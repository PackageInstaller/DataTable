local var_0_0 = class("LittleDaihoRePage", import(".TemplatePage.PtTemplatePage"))
...
function var_0_0.OnUpdateFlush(arg_10_0)
	...
	arg_10_0.itemList:align(arg_10_0.ptData:GetLevel())

	local var_10_0, var_10_1, var_10_2 = arg_10_0.ptData:GetResProgress()
	local var_10_3 = var_10_2 >= 1 and setColorStr(var_10_0, "#9F413AFF") or var_10_0

	setText(arg_10_0.progress, var_10_3 .. "/" .. var_10_1)
