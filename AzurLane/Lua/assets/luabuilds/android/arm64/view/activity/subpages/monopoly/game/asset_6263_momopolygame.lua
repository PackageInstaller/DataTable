...
local var_0_1 = var_0_10001.activity_event_monopoly_map

pg = var_2

local var_0_2 = var_2.activity_event_monopoly_event
...
local function var_0_13(arg_35_0, arg_35_1)
	...
	function var_35_0.CeateCell(arg_40_0, arg_40_1, arg_40_2)
		...
		if var_40_0 == 0 then
			...
			var_2_10005 = arg_40_0.path[var_40_0]

			local var_40_2 = arg_40_0.path[1]

			var_2_10005:SetNext(var_40_1)
			var_40_1:SetNext(var_40_2)
		end

		table = var_2_10005

		var_2_10005.insert(arg_40_0.path, var_40_1)
...
local function var_0_14(arg_49_0, arg_49_1)
	...
	typeof = var_1_10006
	Image = var_1_10008
	var_49_0._img = var_49_2(var_49_1, var_1_10006(var_1_10008))
...
local function var_0_15(arg_53_0, arg_53_1)
	...
	local var_53_3 = var_1_10004(var_53_2)

	Vector3 = var_53_1
	var_53_3.localScale = var_53_1(0.5, 0.5, 0.5)
	...
	var_53_6(var_53_5, var_8(var_53_2))
	...
	local var_53_11 = var_53_10(var_53_9, var_9(var_11))

	Vector2 = var_7
	var_53_11.sizeDelta = var_7(3, 3)
	Vector2 = var_7
		...
		var_2_10005.each(arg_55_1, function(arg_56_0)
			...
			var_3_10001.insert(var_55_0, function(arg_57_0)
				...
				if arg_55_0._tf.localPosition == var_57_2 then
					...
					local var_57_4 = var_57_3(var_4(arg_55_0._tf), var_57_2, arg_55_3)
					local var_57_5 = var_2.setOnComplete

					System = var_5

					var_57_5(var_57_4, var_5.Action(function()
	...
	function var_53_0.Jump(arg_61_0, arg_61_1, arg_61_2)
		arg_61_0:Action({
			...
			SFX_STEP_MONOPOLY = var_3_10003

			var_62_1(var_62_0, var_3_10003)
...
function var_0_0.SetUp(arg_68_0, arg_68_1, arg_68_2)
	...
	var_4({
		function(arg_69_0)
			...
			local var_69_2 = var_3.GetInstance()
...
function var_0_0.setActivity(arg_73_0, arg_73_1)
	...
	local var_73_7 = var_1_10008.ceil((var_73_6 - var_73_0) / 0)
	...
	local var_73_10 = arg_73_0.advanceTotalCnt - var_73_4

	arg_73_0.isAdvanceRp = 0 < var_73_10
	arg_73_0.leftAwardCnt = var_73_3 - var_73_4
	math = var_10

	local var_73_11 = var_10.max
	local var_73_12 = 0

	math = var_13
	arg_73_0.advanceRpCount = var_73_11(var_73_12, var_13.min(var_73_3, arg_73_0.advanceTotalCnt) - var_73_4)
	math = var_10

	local var_73_13 = var_10.max(0, var_73_3 - arg_73_0.advanceTotalCnt)

	math = var_11
	arg_73_0.commonRpCount = var_73_13 - var_11.max(0, var_73_4 - arg_73_0.advanceTotalCnt)
...
function var_0_0.init(arg_75_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_75_0.valueImg = var_75_5(var_75_4, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_75_0.leftcountLabel = var_75_8(var_75_7, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_75_0.leftCountTF = var_75_11(var_75_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_75_0.nextRedPacketStepTF = var_75_14(var_75_13, var_4(var_1_10006))
	...
	arg_75_0.commonAnim = var_75_17(var_75_16, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_75_0.commonRpCnt = var_75_20(var_75_19, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_75_0.dropShipTxt = var_75_23(var_75_22, var_4(var_1_10006))
	...
	i18n = var_1_10002
	var_75_26.text = var_1_10002("monopoly_left_count")
	...
	typeof = var_4
	Text = var_1_10006
	arg_75_0.advanceTxt = var_75_33(var_75_32, var_4(var_1_10006))
...
function var_0_0.updateValue(arg_78_0, arg_78_1)
	if arg_78_1 ~= 0 then
		...
		var_1_10004 = arg_78_0.valueImg

		var_1_10002.SetNativeSize(var_1_10004)
	end

	setActive = var_1_10002
	go = var_1_10004

	var_1_10002(var_1_10004(arg_78_0.valueImg), arg_78_1 ~= 0)
...
function var_0_0.didEnter(arg_79_0)
	...
	local function var_79_5()
		...
		if arg_79_0.leftCount <= 0 then
			...
			var_80_1(var_80_0, var_2_10003("common_count_noenough"))
	...
	var_2(var_79_3, var_79_4, var_79_5, var_1_10007)
	...
	local function var_79_8()
		if arg_79_0.leftAwardCnt > 0 then
			...
			var_81_1(var_81_0, var_2_10003.ON_AWARD)
		end
	...
	var_2(var_79_6, var_79_7, var_79_8, var_1_10007)
	...
	local function var_79_11()
		...
		var_82_2.type = var_2_10004
		pg = var_2_10004
		var_82_2.helps = var_2_10004.gametip.help_chunjie_monopoly.tip
	...
	var_2(var_79_9, var_79_10, var_79_11, var_1_10007)
...
function var_0_0.blockAllEvent(arg_83_0, arg_83_1)
	...
	var_83_1(var_83_0, var_1_10005.LOCK_ACT_MAIN, arg_83_1)
		...
		function(arg_87_0)
			...
			;(function()
				if var_84_2 then
					...
					MonopolyPage = var_3_10003

					var_88_2(var_88_1, var_3_10003.ON_TRIGGER, arg_84_0.activity.id, function(arg_89_0, arg_89_1)
...
function var_0_0.checkState(arg_91_0)
	...
	if arg_91_0:getStrory() then
		...
		var_1_10003.insert(var_91_0, function(arg_92_0)
			pg = var_2_10001
	...
	if arg_91_0.step ~= 0 then
		...
		var_3.insert(var_91_0, function(arg_94_0)
			...
			MonopolyPage = var_2_10004

			var_94_1(var_94_0, var_2_10004.ON_MOVE, arg_91_0.activity.id, function(arg_95_0, arg_95_1, arg_95_2)
...
function var_0_0.startAction(arg_98_0)
	...
	local function var_98_2(arg_99_0)
		...
		var_99_1(var_99_0, var_2_10004.ON_MOVE, var_98_0, function(arg_100_0, arg_100_1, arg_100_2)
	...
	var_1_10004({
		...
		function(arg_103_0)
			...
			var_103_1(var_103_0, var_2_10004.ON_START, var_98_0, function(arg_104_0)
				var_98_1 = arg_104_0
		...
		function(arg_107_0)
			...
			local var_107_1 = var_2_10002.NewStoryMgr.GetInstance()
...
function var_0_0.getStrory(arg_109_0)
	...
	if var_1_10004.detect(var_109_2, function(arg_110_0)
