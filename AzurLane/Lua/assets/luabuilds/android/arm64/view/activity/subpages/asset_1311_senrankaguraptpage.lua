...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_4(var_2_5, var_2_6, var_2_7, var_1_10009)
...
function var_0_1.SetBgImage(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	for iter_12_0 = 1, 3 do
		...
		findTF = var_1_10009
		var_1_10009 = var_1_10009(arg_12_0.titleImgTf, "img" .. iter_12_0)

		local var_12_0 = iter_12_0 == arg_12_1 and 1 or 0

		LeanTween = var_11

		local var_12_1 = var_11.alpha(var_1_10008, var_12_0, arg_12_2)
		local var_12_2 = var_11.setEase

		LeanTweenType = var_14

		var_12_2(var_12_1, var_14.easeOutQuad)

		LeanTween = var_12_2

		local var_12_3 = var_12_2.alpha(var_1_10009, var_12_0, arg_12_2)
		local var_12_4 = var_11.setEase

		LeanTweenType = var_14

		var_12_4(var_12_3, var_14.easeOutQuad)

		if arg_12_2 > 0 and 1 < arg_12_1 then
			setActive = var_11

			local var_12_5 = arg_12_0.bg

			var_11(var_13.Find(var_12_5, var_0_5[arg_12_1 - 1]), true)

			if arg_12_3 then
				LeanTween = var_11

				local var_12_6 = var_11.delayedCall
				local var_12_7 = 1

				System = var_14

				var_12_6(var_12_7, var_14.Action(arg_12_3))
			end
		end
	end
