...
function var_0_0.InitBlock(arg_8_0, arg_8_1)
	...
	for iter_8_0 = 1, var_8_1 do
		...
		var_1_10008.insert(var_8_0, function(arg_9_0)
			...
			var_2_10002.insert(arg_8_0.blocks, var_9_1)
...
local function var_0_2(arg_11_0, arg_11_1)
	if not arg_11_1 then
		...
		if var_11_3 < var_11_6 - (var_11_0.x + var_11_1 / 2) - arg_11_0 then
			...
			math = var_1_10014
			var_1_10014 = var_1_10014.random(var_11_9, var_11_8)
			table = var_15

			var_15.insert(var_11_7, var_10 + var_1_10014 + arg_11_0 / 2)
		end

		local var_11_10 = var_11_0.x - var_11_1 / 2

		math = var_13

		local var_11_11

		if var_11_3 < var_13.abs(var_11_5 - var_11_10) - arg_11_0 then
			math = var_1_10014
			var_1_10014 = var_1_10014.min(var_11_4, var_13)
			var_11_11 = var_11_3
			...
			local var_11_12 = var_16.random(var_11_11, var_1_10014)

			table = var_17

			var_17.insert(var_11_7, var_11_10 - var_11_12 - arg_11_0 / 2)
		end

		assert = var_1_10014

		var_1_10014(#var_11_7 > 0, var_11 .. " & " .. var_13 .. " - " .. arg_11_0 .. " - " .. var_11_0.x .. "-" .. var_11_1)

		math = var_1_10014

		local var_11_13 = var_1_10014.random(1, #var_11_7)

		Vector2 = var_11_11

		return var_11_11(var_11_7[var_11_13], var_11_0.y + var_11_2)
	end
...
function var_0_0.AddNewBlock(arg_15_0, arg_15_1)
	...
	var_1_10003.insert(arg_15_0.blocks, var_15_0)
...
function var_0_0.DoSink(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	var_1_10005.insert(var_16_0, function(arg_17_0)
		...
		var_17_1(var_17_0, var_17_2, var_2_10005.SINK_DISTANCE * arg_16_2)
...
function var_0_0.ReBornPlayer(arg_34_0)
	...
	for iter_34_0, iter_34_1 in var_1_10003(arg_34_0.blocks) do
		if iter_34_1.isActive then
			...
			var_1_10008.insert(var_34_0, iter_34_1)
		end
	end
	...
	var_34_4(var_34_3, var_34_5 + var_1_10008(0, 10))
...
function var_0_0.Update(arg_39_0)
	local var_39_0 = arg_39_0.ground.sleepTime
	local var_39_2

	if 0 < var_39_0 then
		local var_39_1 = arg_39_0.ground

		var_39_2 = arg_39_0.ground.sleepTime
		Time = var_1_10003
		var_39_1.sleepTime = var_39_2 - var_1_10003.deltaTime
	...
	if arg_39_0.ground.IsRuning and arg_39_0.ground.sleepTime <= 0 then
		local var_39_3 = arg_39_0.ground.position

		var_39_2 = var_0_3(arg_39_0.higestLevel)

		local var_39_4 = arg_39_0.ground

		Vector2 = var_4

		local var_39_5 = var_39_3.x
		local var_39_6 = var_39_3.y

		Time = var_1_10008
		var_39_4.position = var_4(var_39_5, var_39_6 + var_39_2 * var_1_10008.deltaTime)
	...
	if var_1.IsInvincible(var_39_7) then
		...
		TowerClimbingGameSettings = var_39_2

		if var_39_9 == var_39_2.INVINCEIBLE_TIME then
...
function var_0_0.SetGroundSleep(arg_40_0, arg_40_1)
	if arg_40_0.ground.IsRuning then
		...
		TowerClimbingGameSettings = var_1_10007
		var_40_0.position = var_1_10003(var_40_1, var_40_2 - var_1_10007.GROUND_SLIDE_DOWNWARD_DISTANCE)
