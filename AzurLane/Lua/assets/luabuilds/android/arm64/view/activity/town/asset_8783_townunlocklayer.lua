...
function var_0_1.init(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "frame/content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uiList = var_2_0(var_2_2, var_4.Find(var_2_3, "frame/content/tpl"))
	...
	var_1.make(var_2_4, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			local var_3_3 = arg_3_2:Find("icon")

			GetSpriteFromAtlas = var_2_10009

			var_2_10006(var_3_3, var_2_10009("ui/townui_atlas", var_3_2), true)
			...
			if var_3_0 == var_0_1.TYPE.NEW then
				...
				if not var_3_4("town_unlcok_new") then
					i18n = var_3_4
					var_3_4 = var_3_4("town_unlcok_level")
				end

				setText = var_2_10007

				var_2_10007(arg_3_2:Find("tip/Text"), var_3_4)
