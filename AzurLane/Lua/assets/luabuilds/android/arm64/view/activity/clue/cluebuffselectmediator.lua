...
function var_0_1.register(arg_1_0)
	...
	if not var_1_1 or var_1_1 == "" then
		...
		for iter_1_0 in var_3.gmatch(var_1_1, "[^|]+") do
			...
			var_1_10007(var_1_3, var_1_10010(iter_1_0))
		end
	end
	...
	var_1_7(var_1_8, var_1_9, var_1_10007, var_1_10008.MEGA_SUBMARINE_FLEET_OFFSET)
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_1 == var_4_0.COMMANDER_ACTIVITY_FORMATION_OP_DONE then
		local var_4_4 = arg_4_1:getBody()

		getProxy = var_4_2
		FleetProxy = var_1_10007

		local var_4_5 = var_4_2(var_1_10007)
