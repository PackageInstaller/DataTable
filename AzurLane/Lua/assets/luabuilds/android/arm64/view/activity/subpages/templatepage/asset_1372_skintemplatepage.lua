...
local var_0_0 = "SkinTemplatePage"
...
function var_0_1.OnUpdateFlush(arg_11_0)
	...
	if arg_11_0.dayTF then
		...
		local var_11_0 = arg_11_0.dayTF

		tostring = var_1_10004

		var_1(var_11_0, var_1_10004(arg_11_0.nday))
	end

	local var_11_1 = arg_11_0.uilist

	var_1.align(var_11_1, #arg_11_0.taskGroup[arg_11_0.nday])
