...
function var_0_1.OnInit(arg_1_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.turnTxt = var_1_6(var_1_5, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.turnCntTxt = var_1_9(var_1_8, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.progressTxt = var_1_12(var_1_11, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.progressCntTxt = var_1_15(var_1_14, var_4(var_1_10006))
	...
	arg_1_0._paintingParticleSystem = var_1_26(var_1_25, var_4(var_1_10006))
	...
	local function var_1_32()
		if arg_1_0.activity then
			...
			var_2_5(var_2_4, var_3.GO_MONOPOLY2026, arg_1_0.activity.id, function()
	...
	var_1(var_1_30, var_1_31, var_1_32, var_1_10006)
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.taskDesc = var_1_38(var_1_37, var_4(var_1_10006))
...
function var_0_1.OnFirstFlush(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_1_10001(arg_5_0.turnAwards) do
		...
		local var_5_0 = iter_5_1:Find("bg_lock/Text")

		i18n = var_1_10009

		var_1_10006(var_5_0, var_1_10009("RapidSeasideMonopolyPage_award_loop" .. iter_5_0))

		setText = var_1_10006

		local var_5_1 = iter_5_1:Find("bg_unlock/Text")

		i18n = var_1_10009

		var_1_10006(var_5_1, var_1_10009("RapidSeasideMonopolyPage_award_loop" .. iter_5_0))
	end

	onButton = var_1

	local var_5_2 = arg_5_0
	local var_5_3 = arg_5_0.btnManual
	...
	local function var_5_4()
		...
		RapidSeasideMedalAlbumView = var_2_10003
	...
	var_1(var_5_2, var_5_3, var_5_4, var_1_10006)

	setText = var_1

	local var_5_5 = arg_5_0.Txtmanual

	i18n = var_5_3

	var_1(var_5_5, var_5_3("anniversary_nine_main_page"))
	arg_5_0:UpdateRed()
...
function var_0_1.UpdateTurnAwards(arg_8_0)
	...
	if var_1_10003.gameset[var_8_1] then
		...
		i18n = var_12
		var_8_12.text = var_12("RapidSeasideMonopolyPage_progress_tip")
		...
		for iter_8_0, iter_8_1 in var_14(arg_8_0.turnAwards) do
			...
			var_1_10027 = iter_8_1

			var_1_10023(iter_8_1.Find(var_1_10027, "mask"), var_1_10020)
			...
			function var_1_10027()
				local var_9_0 = arg_8_0
				local var_9_1 = var_0.emit

				BaseUI = var_2_10003

				var_9_1(var_9_0, var_2_10003.ON_DROP, var_1_10020)
			...
			var_1_10023(var_8_19, var_8_20, var_1_10027, var_28)

			setActive = var_1_10023
			var_1_10027 = iter_8_1

			var_1_10023(iter_8_1.Find(var_1_10027, "got"), var_21 <= var_8_6)

			setActive = var_1_10023
			var_1_10027 = iter_8_1

			var_1_10023(iter_8_1.Find(var_1_10027, "bg_lock"), var_21 <= var_8_5)

			setActive = var_1_10023
			var_1_10027 = iter_8_1

			var_1_10023(iter_8_1.Find(var_1_10027, "bg_unlock"), var_8_5 < var_21)
			...
			var_1_10023(iter_8_1.Find(var_1_10027, "can_get_mask"), var_8_18)
		...
		local var_8_24 = var_8_21.ceil((var_8_22 - var_8_23) / 0) * var_8_0:getDataConfig("daily_time")
		local var_8_25
		...
		local function var_8_32()
			...
			local var_10_2 = var_2_10003.MONOPOLY_OP
			local var_10_3 = {
			...
			ActivityConst = var_5
			var_10_3.cmd = var_5.MONOPOLY_OP_ROUND_AWD
		...
		var_8_29(var_8_30, var_8_31, var_8_32, var_1_10027)
...
function var_0_1.UpdateTask(arg_11_0)
	...
	local var_11_4 = var_3
	local var_11_5 = var_3.getTaskById(var_11_4, var_11_1)
	local var_11_6 = var_11_3
	local var_11_7 = var_11_3.getConfig(var_11_6, "award_display")[1]

	Drop = var_11_4

	local var_11_8 = var_11_4.New({
		type = var_11_7[1],
		id = var_11_7[2],
		count = var_11_7[3]
	})
	...
	local var_11_9 = arg_11_0.taskAward

	var_11_6(var_10.Find(var_11_9, "mask"), var_11_8)

	onButton = var_11_6

	local var_11_10 = arg_11_0
	local var_11_11 = arg_11_0.taskAward
	...
	local function var_11_12()
		...
		var_12_1(var_12_0, var_2_10003.ON_DROP, var_11_8)
	...
	var_11_6(var_11_10, var_11_11, var_11_12, var_13)

	local var_11_13 = var_11_3
	local var_11_14 = var_11_3.getConfig(var_11_13, "target_num")
	local var_11_15, var_11_16

	if var_11_5 ~= nil then
		math = var_11_15
		var_11_15 = var_11_15.min(var_11_3:getProgress(), var_11_14)
		setSlider = var_11_13

		var_11_13(arg_11_0.taskProgress, 0, var_11_14, var_11_15)

		var_11_13 = var_11_3:getConfig("desc")
		ipairs = var_11_16

		for iter_11_2, iter_11_1 in var_11_16({
			var_11_15
		}) do
			string = var_1_10016
			var_11_13 = var_1_10016.gsub(var_11_13, "$" .. iter_11_2, iter_11_1)
		end

		var_11_16 = arg_11_0.taskDesc
		var_11_16.text = var_11_13

		local var_11_17 = var_11_3

		var_11_16 = var_11_3.isFinish(var_11_17)
		iter_11_2 = var_11_3

		local var_11_18 = var_11_3.isReceive(iter_11_2)

		setActive = var_11_17

		local var_11_19 = arg_11_0.taskGoBtn

		var_1_10016 = not var_11_16 and not var_11_18

		var_11_17(var_11_19, var_1_10016)

		setActive = var_11_17

		local var_11_20 = arg_11_0.taskGetBtn

		var_1_10016 = var_11_16 and not var_11_18

		var_11_17(var_11_20, var_1_10016)

		setActive = var_11_17

		var_11_17(arg_11_0.taskGotBtn, var_11_18)
	else
		var_11_15 = var_11_14
		setSlider = var_11_13
		...
		local var_11_21 = var_11_3:getConfig("desc")

		ipairs = var_11_16

		for iter_11_2, iter_11_3 in var_11_16({
			var_11_15
		}) do
			string = var_1_10016
			var_11_21 = var_1_10016.gsub(var_11_21, "$" .. iter_11_2, iter_11_3)
		end

		local var_11_22 = arg_11_0.taskDesc

		var_11_22.text = var_11_21
		setActive = var_11_22

		var_11_22(arg_11_0.taskGoBtn, false)

		setActive = var_11_22

		var_11_22(arg_11_0.taskGetBtn, false)

		setActive = var_11_22

		var_11_22(arg_11_0.taskGotBtn, true)
	end

	onButton = var_11_15

	local var_11_23 = arg_11_0
	local var_11_24 = arg_11_0.taskGetBtn
	...
	local function var_11_25()
		...
		var_13_1(var_13_0, var_2_10003.ON_TASK_SUBMIT, var_11_3, function(arg_14_0)
			if arg_14_0 then
	...
	var_11_15(var_11_23, var_11_24, var_11_25, iter_11_2)

	onButton = var_11_15

	local var_11_26 = arg_11_0
	local var_11_27 = arg_11_0.taskGoBtn
	...
	var_11_15(var_11_26, var_11_27, var_11_28, iter_11_2)
...
function var_0_1.UpdateRed(arg_16_0)
	...
	if var_1_10001.activity_template[arg_16_0.activity.id].config_client.is_showMedal then
		...
		ActivityMedalGroup = var_1_10006

		var_1_10003(var_16_1, var_1_10006.showTip(var_16_0))
	end
