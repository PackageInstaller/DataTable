...
local var_0_0 = "SleeplessCityPage"
...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	local function var_1_2()
		...
		local var_2_3 = var_2_10002(var_2_10004)
		local var_2_4 = var_2.getRawData(var_2_3)

		pg = var_2_10004

		local var_2_5 = var_2_10004.gameset.urpt_chapter_max.description[1]

		LOCK_UR_SHIP = var_2_3
		...
		if var_2_3 then
			...
			local var_2_6 = var_2_3(var_2_10007)

			var_2_3 = var_2_3.GetLimitCntById(var_2_6, var_2_5)
		end

		Task = var_2_10006

		local var_2_7, var_2_8 = var_2_10006.StaticJudgeOverflow(var_2_4.gold, var_2_4.oil, var_2_3, true, true, {
			{
				var_2_2.type,
				var_2_2.id,
				var_2_2.count
		...
		if var_2_7 then
			...
			var_8.insert(var_2_0, function(arg_3_0)
				...
				var_3_2.type = var_3_10005
				i18n = var_3_10005
				var_3_2.content = var_3_10005("award_max_warning")
				var_3_2.items = var_2_8
		...
		var_8(var_2_0, function()
			...
			local var_4_5 = var_3_10005.EVENT_PT_OPERATION
			local var_4_6 = {
				cmd = 1
			}
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	if 1 <= var_6_11 then
		...
		if not var_6_14(var_6_13, var_1_10011) then
			setColorStr = var_6_14
		...
		var_6_17(arg_6_0.battleBtn, var_6_20 and not var_6_16 and var_6_18)

		setActive = var_6_17

		var_6_17(arg_6_0.getBtn, var_6_16)

		setActive = var_6_17

		var_6_17(arg_6_0.gotBtn, not var_6_18)
		...
		var_6_19(arg_6_0.awardTF, var_6_22)
		...
		local function var_6_25()
			...
			var_7_1(var_7_0, var_2_10003.ON_DROP, var_6_22)
		...
		var_6_19(var_6_23, var_6_24, var_6_25, var_1_10014)

		setText = var_6_19

		local var_6_26 = arg_6_0.bg
		local var_6_27 = var_11.Find(var_6_26, "description")

		i18n = var_6_24

		var_6_19(var_6_27, var_6_24("activity_victory"))
