...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.tipGrayBtnTxt = var_2_7(var_2_6, var_4(var_1_10006))
	setActive = var_1
	...
	local var_2_9 = var_3.Find(var_2_8, "frame/tip_text")

	i18n = var_4

	var_1(var_2_9, var_4("sculpture_puzzle_tip"))
...
function var_0_1.LoadLine(arg_8_0, arg_8_1)
	...
	var_8_3(var_8_2, var_8_4, var_8_5, var_8.Events.UnityAction_UnityEngine_Object(function(arg_9_0)
		...
		var_2_10002(var_9_0, function(arg_10_0)
...
local function var_0_2(arg_11_0, arg_11_1)
	...
	local var_11_2 = arg_11_0:GetComponent("RectTransform")

	LuaHelper = var_11_0

	return (var_11_0.ScreenToLocal(var_11_2, arg_11_1, var_11_1))
end
...
local function var_0_4(arg_12_0, arg_12_1, arg_12_2)
	if arg_12_0 == arg_12_1 then
		...
		local var_12_1 = arg_12_0.TransformPoint(var_12_0, arg_12_2)
		local var_12_2 = arg_12_1:InverseTransformPoint(var_12_1)

		Vector3 = var_12_0

		return var_12_0(var_12_2.x, var_12_2.y, 0)
	end
...
function var_0_1.HandlePuzzlePart(arg_13_0, arg_13_1)
	...
	var_1_10002(arg_13_1, function(arg_14_0)
		...
		local var_14_2 = var_14_1(var_14_0, var_2_10004(var_2_10006))
		local var_14_3
		local var_14_4
		...
		var_14_2:AddDragEndFunc(function(arg_17_0, arg_17_1)
			...
			if var_3_10004.Distance(var_17_1, arg_14_0.localPosition) < 50 then
				...
				if var_4.IsFinishAll(var_17_3) then
					...
					var_17_5(var_17_4, var_7.ON_JOINT_SCULPTURE, arg_13_0.id)
				end
			else
...
function var_0_1.LoadPuzzle(arg_19_0, arg_19_1)
	...
	local var_19_2 = var_1_10003.Inst
	...
	var_19_3(var_19_2, var_19_4, var_19_5, var_8.Events.UnityAction_UnityEngine_Object(function(arg_20_0)
		Object = var_2_10001
...
function var_0_1.RegisterEvent(arg_21_0)
	...
	local function var_21_2()
		...
		i18n = var_2_10005
		var_22_3.content = var_2_10005("sculpture_drawline_exit")
	...
	local function var_21_6()
		...
		if not var_0.IsFinishAll(var_24_0) then
			...
			for iter_24_0, iter_24_1 in var_2_10001(arg_21_0.slots) do
	...
	var_1_10002(var_21_4, var_21_5, var_21_6, var_1_10007)
...
function var_0_1.AddTimer(arg_26_0, arg_26_1)
	...
	Timer = var_1_10003
	arg_26_0.timer = var_1_10003.New(function()
		var_26_0 = var_26_0 - 1
...
function var_0_1.BlinkSlots(arg_29_0, arg_29_1, arg_29_2)
	...
	for iter_29_0, iter_29_1 in var_1_10004(arg_29_1) do
		...
		local var_29_3 = var_29_2(var_29_1, var_1_10012(var_1_10014)).color
		...
		var_29_1.insert(var_29_0, function(arg_30_0)
			...
			local var_30_3 = var_30_2(var_30_1, var_4.Action_float(function(arg_31_0)
			...
			var_30_4(var_30_3, var_4.Action(function()
