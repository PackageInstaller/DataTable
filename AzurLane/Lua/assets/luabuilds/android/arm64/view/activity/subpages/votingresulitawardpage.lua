...
function var_0_1.OnDataSetting(arg_2_0)
	...
	local var_2_7 = var_2_5(var_2_4, var_5.getStartTime(var_2_6), var_1:GetServerTime()) + 1
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1(arg_4_0.taskList) do
		...
		local var_4_5 = var_4_2.Find(var_4_4, "close")
		...
		var_1_10007(var_4_3, var_4_5, var_4_6, var_4_4)

		local var_4_7 = arg_4_0.taskProxy

		var_1_10007 = var_1_10007.getTaskVO(var_4_7, iter_4_1)
		Drop = var_4_1

		local var_4_8 = var_4_1.Create(var_1_10007:getConfig("award_display")[1])

		ipairs = var_4_7

		for iter_4_2, iter_4_3 in var_4_7({
			"close",
			"expand"
		}) do
			local var_4_9 = var_4_2:Find(iter_4_3 .. "/IconTpl")

			updateDrop = var_1_10015

			var_1_10015(var_4_9, var_4_8)

			setText = var_1_10015

			local var_4_10 = var_4_9:Find("get/tip/Text")

			i18n = var_18

			var_1_10015(var_4_10, var_18("voting_page_reward"))
			...
			local function var_4_13()
				...
				var_6_1(var_6_0, var_2_10003.ON_DROP, var_4_8)
			...
			var_1_10015(var_4_11, var_4_12, var_4_13, var_20)

			onButton = var_1_10015

			local var_4_14 = arg_4_0
			local var_4_15 = var_4_9
			local var_4_16 = var_4_9.Find(var_4_15, "get")
			...
			local function var_4_17()
				...
				var_7_1(var_7_0, var_2_10003.ON_TASK_SUBMIT, var_1_10007)

				return
			end

			SFX_CONFIRM = var_4_15

			var_1_10015(var_4_14, var_4_16, var_4_17, var_4_15)
		end
	end

	arg_4_0:UpdateDisplay(1)

	local var_4_18 = arg_4_0.activity

	if var_1.getConfig(var_4_18, "config_client").firstStory then
		playStory = var_2
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10001(arg_8_0.taskList) do
		...
		for iter_8_2, iter_8_3 in var_1_10007({
			"close",
			"expand"
		}) do
			...
			var_1_10013(var_8_4:Find("get"), arg_8_0.remainCnt > 0 and not var_8_1:isReceive())

			setActive = var_1_10013

			var_1_10013(var_8_4:Find("got"), var_8_1:isReceive())
		end
	end
...
function var_0_1.UpdateDisplay(arg_9_0, arg_9_1)
	...
	for iter_9_0 = 1, #arg_9_0.taskList do
		...
		local var_9_3 = var_9_2(var_9_1, var_1_10010(var_1_10012))

		setActive = var_9_0
		var_1_10012 = var_6

		var_9_0(var_6.Find(var_1_10012, "expand/IconTpl"), iter_9_0 == arg_9_0.index)
		...
		if iter_9_0 == arg_9_0.index then
			...
			var_8(var_6.Find(var_1_10012, "close"), false)
		else
			local var_9_4 = {}
			local var_9_5
			...
			if var_9_3.preferredWidth ~= var_0_1.CLOSE_WIDTH then
				if arg_9_0.dicLT[iter_9_0] then
					...
					var_9_5.cancel(arg_9_0.dicLT[iter_9_0])

					var_9_5 = arg_9_0.dicLT
					var_9_5[iter_9_0] = nil
				end

				table = var_9_5

				var_9_5.insert(var_9_4, function(arg_10_0)
					...
					local var_10_3 = var_2_10005(var_0)
					local var_10_4 = var_9_3.preferredWidth
					local var_10_5 = arg_9_0.CLOSE_WIDTH

					math = var_2_10008

					local var_10_6 = var_10_2(var_10_3, var_10_4, var_10_5, var_2_10008.abs(var_9_3.preferredWidth - arg_9_0.CLOSE_WIDTH) / arg_9_0.DURATION_PARAMETER)
					...
					local var_10_10 = var_10_9(var_10_8, var_6.Action_float(function(arg_11_0)
					...
					System = var_6
					var_10_0[var_10_1] = var_10_11(var_10_10, var_6.Action(arg_10_0)).uniqueId
			...
			var_9_5(var_9_4, function()
				...
				var_12_0(var_2.Find(var_12_1, "close"), true)
