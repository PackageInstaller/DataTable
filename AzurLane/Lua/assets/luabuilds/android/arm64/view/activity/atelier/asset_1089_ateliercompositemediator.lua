...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10004.COMPOSITE_ATELIER_RECIPE, function(arg_2_0, arg_2_1, arg_2_2)
		local var_2_0 = arg_1_0
		local var_2_1 = var_3.sendNotification

		GAME = var_2_10006

		var_2_1(var_2_0, var_2_10006.COMPOSITE_ATELIER_RECIPE, {
	...
	AtelierMaterialDetailMediator = var_4
	...
	var_1_3(var_1_2, var_4.SHOW_DETAIL, function(arg_3_0, arg_3_1)
		...
		local var_3_4 = var_2_10007.New
		local var_3_5 = {}

		AtelierMaterialDetailMediator = var_2_10010
		var_3_5.mediator = var_2_10010
	...
	local var_1_7 = var_1_6(var_1_5, var_4.ACTIVITY_TYPE_ATELIER_LINK)
	local var_1_8
	...
	AtelierTools = var_1_5

	local var_1_9 = var_1_5.IsUnlockAtelier(var_1_7, var_1_8)
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_1 == var_5_0.COMPOSITE_ATELIER_RECIPE_DONE then
		local var_5_4 = arg_5_0.viewComponent

		var_4.OnCompositeResult(var_5_4, var_5_3)
	else
		ActivityProxy = var_4
		...
		if var_5_1 == var_4.ACTIVITY_UPDATED then
			...
			if var_5_5 == var_5_2.ACTIVITY_TYPE_ATELIER_LINK then
				local var_5_6 = arg_5_0.viewComponent

				var_4.SetActivity(var_5_6, var_5_3)
			end
		elseif var_5_1 == var_0_1.OPEN_FORMULA then
			local var_5_7 = arg_5_0.viewComponent

			var_4.OnReceiveFormualRequest(var_5_7, var_5_3)
		end
	end
