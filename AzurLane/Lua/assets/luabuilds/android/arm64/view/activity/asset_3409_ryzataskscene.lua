...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.activityId = var_2_1(var_2_0, var_1_10004.ACTIVITY_TYPE_TASK_RYZA).id
	...
	local var_2_7 = var_6(arg_2_0.btnPoint, "text")

	i18n = var_7

	var_4(var_2_7, var_7(var_0_2))

	for iter_2_0 = 1, var_0_22 do
		findTF = var_2_8

		local var_2_8 = var_2_8(arg_2_0.taskTagPanel, "btn" .. iter_2_0)

		setText = var_9
		findTF = var_1_10011
		var_1_10011 = var_1_10011(var_2_8, "off/text")
		i18n = var_12

		var_9(var_1_10011, var_12(var_0_7[iter_2_0]))

		setText = var_9
		findTF = var_1_10011
		var_1_10011 = var_1_10011(var_2_8, "on/text")
		i18n = var_12
	...
	local var_2_9 = var_6(arg_2_0.taskDetailPanel, "desc/title")

	i18n = iter_2_0

	var_4(var_2_9, iter_2_0(var_0_8))

	setText = var_4
	findTF = var_2_9

	local var_2_10 = var_2_9(arg_2_0.taskDetailPanel, "awardText")

	i18n = var_7

	var_4(var_2_10, var_7(var_0_9))

	setText = var_4
	findTF = var_2_10

	local var_2_11 = var_2_10(arg_2_0.taskDetailPanel, "btnGet/text")

	i18n = var_7

	var_4(var_2_11, var_7(var_0_11))

	setText = var_4
	findTF = var_2_11

	local var_2_12 = var_2_11(arg_2_0.taskDetailPanel, "btnGo/text")

	i18n = var_7

	var_4(var_2_12, var_7(var_0_10))

	setText = var_4
	findTF = var_2_12

	local var_2_13 = var_2_12(arg_2_0.taskDetailPanel, "btnSubmit/text")

	i18n = var_7

	var_4(var_2_13, var_7(var_0_13))

	setText = var_4
	findTF = var_2_13

	local var_2_14 = var_2_13(arg_2_0.taskDetailPanel, "btnDetail/text")

	i18n = var_7

	var_4(var_2_14, var_7(var_0_12))

	setText = var_4
	findTF = var_2_14

	local var_2_15 = var_2_14(arg_2_0.btnGetAll, "text")

	i18n = var_7

	var_4(var_2_15, var_7(var_0_14))

	setText = var_4
	findTF = var_2_15

	local var_2_16 = var_2_15(arg_2_0.submitPanel, "btnComfirm/text")

	i18n = var_7

	var_4(var_2_16, var_7(var_0_15))

	setText = var_4
	findTF = var_2_16

	local var_2_17 = var_2_16(arg_2_0.submitPanel, "btnCancel/text")

	i18n = var_7

	var_4(var_2_17, var_7(var_0_16))

	setText = var_4
	findTF = var_2_17

	local var_2_18 = var_2_17(arg_2_0.submitPanel, "bg/text")

	i18n = var_7

	var_4(var_2_18, var_7(var_0_20))

	setText = var_4
	findTF = var_2_18

	local var_2_19 = var_2_18(arg_2_0.pointPanel, "title")

	i18n = var_7

	var_4(var_2_19, var_7(var_0_2))

	setText = var_4
	findTF = var_2_19

	local var_2_20 = var_2_19(arg_2_0.pointPanel, "levelNum/text")

	i18n = var_7

	var_4(var_2_20, var_7(var_0_17))

	setText = var_4
	findTF = var_2_20

	local var_2_21 = var_2_20(arg_2_0.pointPanel, "levelBuff/text")

	i18n = var_7

	var_4(var_2_21, var_7(var_0_18))

	arg_2_0.pointStarTfs = {}

	local var_2_22 = arg_2_0.pointLevelStar.sizeDelta.x

	for iter_2_1 = 1, #arg_2_0.ptBuffs do
		tf = var_2_23
		Instantiate = var_1_10011

		local var_2_23 = var_2_23(var_1_10011(arg_2_0.pointStarTpl))

		SetParent = var_1_10010

		var_1_10010(var_2_23, arg_2_0.pointLevelStar)

		setActive = var_1_10010

		var_1_10010(var_2_23, true)

		setText = var_1_10010
		findTF = var_12

		var_1_10010(var_12(var_2_23, "bg/text"), iter_2_1)

		setText = var_1_10010
		findTF = var_12

		var_1_10010(var_12(var_2_23, "img/text"), iter_2_1)

		var_1_10010 = arg_2_0.ptBuffs[iter_2_1].pt[1]
		Vector3 = var_1_10011
		var_2_23.anchoredPosition = var_1_10011(var_1_10010 / arg_2_0.maxNum * var_2_22, -18, 0)
		table = var_1_10011

		var_1_10011.insert(arg_2_0.pointStarTfs, var_2_23)

		if iter_2_1 == 1 then
			setActive = var_1_10011

			var_1_10011(var_2_23, false)
		end
	end
...
function var_0_1.updateTask(arg_3_0, arg_3_1)
	...
	local var_3_0 = var_2(var_1_10004)
	...
	for iter_3_0 = 1, #var_3_1 do
		...
		local var_3_3 = var_7.getProgress(var_1_10011)

		var_1_10010 = var_7:getTarget()
		var_1_10013 = var_7
		var_1_10011 = var_7.getConfig(var_1_10013, "ryza_type")
		var_1_10014 = var_7

		local var_3_4 = var_7.getConfig(var_1_10014, "type")

		var_1_10015 = var_7
		var_1_10013 = var_7.getConfig(var_1_10015, "sub_type")
		...
		if 0 < var_1_10011 then
			...
			if var_7.isFinish(var_1_10016) then
				var_1_10016 = var_7

				if var_7.isOver(var_1_10016) or var_1_10013 == 1006 then
					-- block empty
				else
					table = var_1_10014
	...
	if var_3_7 then
		...
		if 0 < var_3_8 then
			for iter_3_1 = 1, #var_3_7 do
				...
				var_1_10013 = var_1_10010.New(arg_3_0.activityId, {
					progress = 0,
					id = var_3_9
				})

				var_1_10010.setOver(var_1_10013)

				var_1_10013 = var_1_10010

				if var_1_10010.getConfig(var_1_10013, "ryza_type") > 0 then
					local var_3_10

					if not arg_3_0.displayTask[var_1_10011] then
						var_3_10 = arg_3_0.displayTask
						var_3_10[var_1_10011] = {}
					end

					table = var_3_10

					var_3_10.insert(arg_3_0.displayTask[var_1_10011], var_1_10010)
	...
	for iter_3_2, iter_3_3 in var_6(arg_3_0.displayTask) do
		table = var_1_10011

		var_1_10011.sort(iter_3_3, var_3_11)
	end

	table = var_6

	var_6.sort(arg_3_0.allDisplayTask, var_3_11)
	...
	if arg_3_1 then
		...
		arg_3_0.onClickTag(var_3_12)
	end

	if #arg_3_0.getAllTasks > 0 then
		setActive = var_6

		var_6(arg_3_0.btnGetAll, true)
	else
		setActive = var_6

		var_6(arg_3_0.btnGetAll, false)
	end

	getProxy = var_6
	PlayerProxy = var_3_12

	local var_3_13 = var_6(var_3_12)
	local var_3_14

	if not var_6.getData(var_3_13)[arg_3_0.ptName] then
		var_3_14 = 0
	end
	...
	for iter_3_4 = #arg_3_0.ptBuffs, 1, -1 do
		var_3_15 = arg_3_0.ptBuffs[iter_3_4].pt[1] <= var_3_14 and var_3_15 < iter_3_4 and iter_3_4 or var_3_15
	end
	...
	for iter_3_5 = 1, #arg_3_0.pointStarTfs do
		...
		if iter_3_5 <= var_3_15 then
			...
			var_1_10013(var_1_10015(var_3_16, "img"), true)
		else
			setActive = var_1_10013
			findTF = var_1_10015

			var_1_10013(var_1_10015(var_3_16, "img"), false)
		end
	end
	...
	for iter_3_6 = 1, #var_3_17 do
		...
		pg = var_1_10014
		var_1_10014 = var_1_10014.benefit_buff_template[var_3_18].desc
		findTF = var_1_10015
		var_1_10015 = var_1_10015(arg_3_0.pointPanel, "add/" .. iter_3_6)
		PLATFORM_CODE = var_1_10016
		PLATFORM_JP = var_17

		if var_1_10016 == var_17 then
			findTF = var_1_10016
			var_1_10016 = var_1_10016(var_1_10015, "img")
			Vector2 = var_17
			var_1_10016.sizeDelta = var_17(450, 70)
			setText = var_1_10016
			findTF = var_18

			var_1_10016(var_18(var_1_10015, "text_jp"), var_1_10014)
		else
			setText = var_1_10016
			findTF = var_18

			var_1_10016(var_18(var_1_10015, "text"), var_1_10014)
		end
	end

	setSlider = var_9

	var_9(arg_3_0.pointProgressSlider, 0, arg_3_0.maxNum, var_3_14)

	setText = var_9

	var_9(arg_3_0.pointProgressText, var_3_14 .. "/" .. arg_3_0.maxNum)

	setText = var_9
	findTF = var_11

	local var_3_19 = var_11(arg_3_0.btnPoint, "text")

	i18n = var_12

	var_9(var_3_19, var_12(var_0_2) .. "Lv." .. var_3_15)

	setText = var_9
	findTF = var_3_19

	var_9(var_3_19(arg_3_0.pointPanel, "levelNum/num"), "Lv." .. var_3_15)

	setText = var_9
	findTF = var_11

	var_9(var_11(arg_3_0.pointPanel, "levelBuff/num"), "Lv." .. var_3_15)
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_5()
		...
		var_7_2(var_7_1, var_2_10004.SUBMIT_TASK_ALL, {
	...
	local function var_5_14()
		...
		i18n = var_2_10004
		var_10_2.helps = var_2_10004("ryza_task_help_tip")
	...
	local function var_5_17()
		...
		var_11_2(var_11_1, var_2_10004.TASK_GO, {
			taskVO = var_11_0
		})
	...
	var_1_10001(var_5_18, var_5_19, var_5_20, var_1_10006)
	...
	var_1_10001(var_5_21, var_5_22, var_5_23, var_1_10006)
	...
	local function var_5_26()
		...
		if var_1.getConfig(var_14_2, "sub_type") == 1006 then
			...
			RyzaTaskMediator = var_2_10005

			var_14_5(var_14_4, var_2_10005.SUBMIT_TASK, {
				activityId = arg_5_0.activityId,
	...
	var_1_10001(var_5_24, var_5_25, var_5_26, var_1_10006)
	...
	local function var_5_29()
		...
		if var_1.getConfig(var_15_2, "sub_type") == 1006 then
			...
			var_15_5(var_15_4, var_2_10005.SUBMIT_TASK, {
				activityId = arg_5_0.activityId,
				id = arg_5_0.selectTask.id
			})
		end
	...
	var_1_10001(var_5_27, var_5_28, var_5_29, var_1_10006)
	...
	local function var_5_32()
		if arg_5_0.selectTask then
			...
			if var_0(var_2.getConfig(var_16_0, "target_id_2")) and 0 < var_0 then
				...
				var_16_2.count = var_4.getConfig(var_16_3, "target_num")

				local var_16_4 = var_16_1(var_16_2)
				local var_16_5 = arg_5_0
				local var_16_6 = var_2.emit

				RyzaTaskMediator = var_5

				var_16_6(var_16_5, var_5.SHOW_DETAIL, var_16_4)
			end
		end
	...
	var_1_10001(var_5_30, var_5_31, var_5_32, var_1_10006)
	...
	local function var_5_35()
		...
		var_17_1(var_17_0, var_2_10003.SUBMIT_TASK, {
			activityId = arg_5_0.activityId,
			id = arg_5_0.selectTask.id
		})
	...
	var_1_10001(var_5_33, var_5_34, var_5_35, var_1_10006)
	...
	var_1_10001(var_5_36, var_5_37, var_5_38, var_1_10006)
	...
	for iter_5_0 = 1, var_0_22 do
		var_5_38 = iter_5_0
		findTF = var_1_10006
		var_1_10006 = var_1_10006(arg_5_0.taskTagPanel, "btn" .. var_5_38)
		onButton = var_1_10007

		var_1_10007(arg_5_0, var_1_10006, function()
			if arg_5_0.showTagIndex then
				setActive = var_0
				findTF = var_2_10002

				var_0(var_2_10002(arg_5_0.btnTags[arg_5_0.showTagIndex], "on"), false)

				if arg_5_0.showTagIndex == var_5_38 then
					arg_5_0.showTagIndex = nil
				else
					local var_19_0 = arg_5_0

					var_19_0.showTagIndex = var_5_38
					setActive = var_19_0
					findTF = var_2_10002

					var_19_0(var_2_10002(arg_5_0.btnTags[arg_5_0.showTagIndex], "on"), true)
				end
			else
				local var_19_1 = arg_5_0

				var_19_1.showTagIndex = var_5_38
				setActive = var_19_1
				findTF = var_2_10002

				var_19_1(var_2_10002(arg_5_0.btnTags[arg_5_0.showTagIndex], "on"), true)
			end
		...
		var_1_10007.insert(arg_5_0.btnTags, var_1_10006)
	end
	...
	local var_5_41 = var_2.GetInt
	local var_5_42 = "ryza_task_help_"

	getProxy = var_5_38
	PlayerProxy = var_1_10007

	local var_5_43 = var_5_38(var_1_10007)

	if var_5_41(var_5_42 .. var_5.getRawData(var_5_43).id) ~= 1 then
		var_5_40 = true
	end
	...
	if var_5_40 then
		...
		local var_5_44 = var_5_39.SetInt
		local var_5_45 = "ryza_task_help_"

		getProxy = var_1_10006
		PlayerProxy = var_1_10008

		local var_5_46 = var_1_10006(var_1_10008)

		var_5_44(var_5_45 .. var_6.getRawData(var_5_46).id, 1)
		...
		MSGBOX_TYPE_HELP = var_5_43
		var_5_49.type = var_5_43
		i18n = var_5_43
		var_5_49.helps = var_5_43("ryza_task_help_tip")
...
function var_0_1.onUpdateTaskItem(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_2 = var_3(var_22_1, var_6(var_1_10008))
	...
	local var_22_5 = var_22_4(var_22_3, var_7.linear)
	local var_22_6 = var_4.setOnUpdate

	System = var_7

	local var_22_7 = var_22_6(var_22_5, var_7.Action_float(function(arg_23_0)
	...
	var_22_8(var_22_7, var_7.Action(function()
	...
	local var_22_14 = var_4
	local var_22_15 = var_4.isFinish(var_22_14)
	local var_22_16 = var_4:isCircle()

	setActive = var_22_14
	findTF = var_1_10014

	var_22_14(var_1_10014(arg_22_2, "selected"), arg_22_0.selectIndex == arg_22_1)

	setActive = var_22_14
	findTF = var_14

	var_22_14(var_14(arg_22_2, "typeNew"), var_4:isNew())

	setActive = var_22_14
	findTF = var_14

	var_22_14(var_14(arg_22_2, "typeCircle"), var_4:isCircle())

	setActive = var_22_14
	findTF = var_14

	var_22_14(var_14(arg_22_2, "finish"), var_22_13)

	setActive = var_22_14
	findTF = var_14

	var_22_14(var_14(arg_22_2, "mask"), var_22_13)

	setActive = var_22_14
	findTF = var_14

	var_22_14(var_14(arg_22_2, "complete"), not var_22_13 and var_22_15 and not var_22_16)

	setText = var_22_14
	findTF = var_14

	local var_22_17 = var_14(arg_22_2, "desc/text")

	shortenString = var_15

	var_22_14(var_22_17, var_15(var_22_11, 10))

	if not var_22_12 or var_22_12 == 0 then
		var_22_12 = "attack"
	end

	setImageSprite = var_22_14
	findTF = var_22_17
	...
	var_22_14(var_22_18, var_15(var_0_21, var_22_12))
	...
	var_22_14(var_22_19, var_15(arg_22_2), function()
		if arg_22_0.selectItem then
			setActive = var_0
			findTF = var_2_10002

			var_0(var_2_10002(arg_22_0.selectItem, "selected"), false)
		end

		setActive = var_0
		findTF = var_2_10002

		var_0(var_2_10002(arg_22_2, "selected"), true)
...
function var_0_1.updateDetail(arg_26_0)
	...
	local var_26_2 = var_1.getProgress(var_26_1)
	local var_26_3 = var_1.target

	pg = var_26_1

	local var_26_4 = var_26_1.task_data_template[var_26_0]
	local var_26_5 = var_1:isFinish()
	local var_26_6 = var_1:isOver()
	local var_26_7 = var_1:isCircle()
	local var_26_8 = var_1:isSubmit()

	arg_26_0.awards = var_26_4.award_display

	local var_26_9 = var_26_4.desc
	local var_26_10 = var_26_4.ryza_icon
	local var_26_11 = var_1:getConfig("sub_type")
	...
	var_1_10013(arg_26_0.detailDescText, var_26_9)

	if not var_26_6 then
		setText = var_1_10013

		var_1_10013(arg_26_0.detaiProgressText, var_26_2 .. "/" .. var_26_3)
	else
		setText = var_1_10013

		var_1_10013(arg_26_0.detaiProgressText, "--/--")
	end

	setText = var_1_10013

	var_1_10013(arg_26_0.detailTitleText, var_26_4.name)

	setActive = var_1_10013

	var_1_10013(arg_26_0.detailBtnDetail, var_26_11 == 1006 and not var_26_5 and not var_26_6)

	setActive = var_1_10013

	var_1_10013(arg_26_0.detailBtnGo, not var_26_6 and not var_26_5 and var_26_11 ~= 1006)

	setActive = var_1_10013

	var_1_10013(arg_26_0.detailBtnGet, not var_26_6 and var_26_5 and not var_26_8)

	setActive = var_1_10013

	var_1_10013(arg_26_0.detailBtnSubmit, not var_26_6 and var_26_5 and var_26_8)

	setActive = var_1_10013

	var_1_10013(arg_26_0.detailActive, not var_26_6 and not var_26_5 and not var_26_7)
	...
	var_1_10013(var_26_12, var_16(var_0_21, var_26_10))
	...
	if #arg_26_0.iconTfs < #arg_26_0.awards then
		...
		for iter_26_0 = 1, var_26_13 do
			...
			local var_26_14 = var_26_14(var_1_10020(arg_26_0.IconTpl))

			setParent = var_19

			var_19(var_26_14, arg_26_0.detailAwardContent)

			setActive = var_19

			var_19(var_26_14, true)

			table = var_19

			var_19.insert(arg_26_0.iconTfs, var_26_14)
		end
	end
	...
	for iter_26_1 = 1, #arg_26_0.iconTfs do
		...
		if iter_26_1 <= #arg_26_0.awards then
			var_26_15 = arg_26_0.awards[iter_26_1]
			...
			var_19(arg_26_0.iconTfs[iter_26_1], var_26_16)

			onButton = var_19

			local var_26_17 = arg_26_0
			local var_26_18 = arg_26_0.iconTfs[iter_26_1]
			...
			local function var_26_19()
				...
				var_27_1(var_27_0, var_2_10003.ON_DROP, var_26_16)
			...
			var_19(var_26_17, var_26_18, var_26_19, var_1_10024)
			...
			var_26_15(arg_26_0.iconTfs[iter_26_1], false)
		end
	end
...
function var_0_1.openSubmitPanel(arg_28_0, arg_28_1)
	...
	local var_28_0 = var_1_10002(arg_28_1:getConfig("target_id_2"))

	pg = var_1_10003

	local var_28_1 = var_1_10003.activity_ryza_item[var_28_0].name

	updateDrop = var_4

	local var_28_2 = arg_28_0.subimtItem
	local var_28_3 = {}

	DROP_TYPE_RYZA_DROP = var_1_10008
	var_28_3.type = var_1_10008
	tonumber = var_1_10008
	var_28_3.id = var_1_10008(var_28_0)
	var_28_3.count = arg_28_1:getConfig("target_num")

	var_4(var_28_2, var_28_3)

	setText = var_4

	var_4(arg_28_0.submitItemDesc, var_28_1)
