...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.START_SELECT, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.ACTIVITY_PERMANENT_START, {
			activity_id = arg_2_1
		})
	...
	local var_1_3 = var_4.getActivityIdsByType

	ActivityPermanentProxy = var_1_10007

	var_1_1(var_1_0, var_1_3(var_1_2, var_1_10007.TYPE_NORMAL_ACTIVITY))
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if arg_4_1.getBody(var_4_1) and not var_3.id then
		var_4_2 = var_3.activity_id
	end

	GAME = var_4_1

	if var_4_0 ~= var_4_1.ACTIVITY_PERMANENT_START_DONE then
		GAME = var_5
		...
		if var_4_0 == var_5.ACTIVITY_PERMANENT_FINISH_DONE then
			...
			local var_4_3 = var_5(var_1_10007)

			if not var_5.IsNormalActivityId(var_4_3, var_4_2) then
				return
			end

			local var_4_4 = arg_4_0.viewComponent

			var_5.closeView(var_4_4)
		end
