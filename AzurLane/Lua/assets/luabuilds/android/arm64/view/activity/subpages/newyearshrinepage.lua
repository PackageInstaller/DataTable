...
function var_0_1.OnDataSetting(arg_2_0)
	...
	local var_2_3 = var_1_10005.TimeMgr.GetInstance()

	arg_2_0.dayFromStart = var_2_1(var_2_0, var_2_2, var_5.GetServerTime(var_2_3)) + 1
	math = var_1
	...
	if var_1.getConfig(var_2_4, "config_client").story then
		...
		for iter_2_0, iter_2_1 in var_1_10002(var_1) do
			if iter_2_1[1] then
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1_10002(arg_3_0.countText, var_3_0)
	...
	var_2.make(var_3_1, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			local var_4_2 = arg_4_2.Find(var_4_1, "Unlock")
			local var_4_3 = arg_4_2:Find("Lock")

			setActive = var_4_1

			var_4_1(var_4_3, not (arg_4_1 <= arg_3_0.curDay))
	...
	local function var_3_8()
		...
		var_6_1(var_6_0, var_2_10003.GO_MINI_GAME, var_0_1.GO_MINI_GAME_ID, {
			callback = function()
				Context = var_3_10000
	...
	local var_3_10 = var_3.NewStoryMgr.GetInstance()

	math = var_3_6

	local var_3_11 = var_3_6.clamp(arg_3_0.playCount, 0, var_0_1.MAX_COUNT)
...
function var_0_1.IsTip()
	...
	if var_12_1(var_12_0, var_1_10003.activity_const.NEWYEAR_SHRINE_PAGE_ID.act_id) and not var_0:isEnd() then
		pg = var_1
		...
		local var_12_5 = var_1_10005.TimeMgr.GetInstance()
		local var_12_6 = var_12_3(var_12_2, var_12_4, var_5.GetServerTime(var_12_5)) + 1

		math = var_12_0

		local var_12_7 = var_12_0.clamp(var_12_6, 1, var_0_1.MAX_COUNT)

		math = var_12_2

		return var_12_7 > var_12_2.clamp(var_0.data2, 0, var_0_1.MAX_COUNT)
	end
