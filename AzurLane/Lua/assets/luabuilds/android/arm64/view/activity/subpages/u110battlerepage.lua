...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_2()
		...
		if var_0.getConfig(var_4_0, "config_client").fightLinkActID then
			...
			local var_4_1 = var_2_10001(var_3)

			var_2_10001 = var_2_10001.getActivityById(var_4_1, var_0)
		end

		if not var_2_10001 or var_2_10001:isEnd() then
			pg = var_4_0
			...
			var_4_3(var_4_2, var_2_10005("challenge_end_tip"))
		...
		var_4_5(var_4_4, var_2_10005.SPECIAL_BATTLE_OPERA)
	...
	local function var_3_8()
		...
		if var_0.getConfig(var_6_0, "config_client").buildLinkActID then
			...
			local var_6_1 = var_2_10001(var_3)

			var_2_10001 = var_2_10001.getActivityById(var_6_1, var_0)
		end
		...
		if not var_2_10001 or var_2_10001:isEnd() then
			...
			var_6_3(var_6_2, var_2_10005("challenge_end_tip"))
		...
		local var_6_6 = var_2_10005.EVENT_GO_SCENE

		SCENE = var_2_10006

		local var_6_7 = var_2_10006.GETBOAT
		local var_6_8 = {}

		BuildShipScene = var_2_10008
		var_6_8.projectName = var_2_10008.PROJECTS.SPECIAL
