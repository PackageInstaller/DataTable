...
function var_0_1.OnInit(arg_2_0)
	...
	local function var_2_7()
		...
		var_4_1(var_4_0, var_4_2, var_2_10004.NEWYEAR_BACKHILL_2023)
...
function var_0_1.OnDataSetting(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_2(var_4.getConfig(var_5_1, "config_client").display_link) do
		if iter_5_1[2] ~= 0 then
			...
			if var_5_3(var_5_2, var_1_10010.shop_template[iter_5_1[2]].time) then
				table = var_5_3
				...
				var_5_4(var_5_5, var_1_10010.random(#arg_5_0.showList + 1), iter_5_1[1])
			end
		end
	end
...
function var_0_1.DelayCall(arg_8_0)
	...
	var_1_10002.insert(var_8_0, function(arg_9_0)
		...
		System = var_2_10005
		var_9_0.uniqueId = var_9_1(var_9_2, var_2_10005.Action(arg_9_0)).uniqueId
	...
	var_2(var_8_0, function()
		...
		var_2_10000(var_12_0, var_2_10003(arg_8_0.rtBg))
		...
		local var_12_2 = var_2_10001.alpha(arg_8_0.rtFront, 0, 0.5)
		local var_12_3 = var_1.setEase

		LeanTweenType = var_4

		local var_12_4 = var_12_3(var_12_2, var_4.easeOutSine)
		local var_12_5 = var_1.setOnComplete

		System = var_4
		var_12_1.uniqueId = var_12_5(var_12_4, var_4.Action(function()
