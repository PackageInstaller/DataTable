...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.items = var_1_10002.Clone2Full(var_1_2, 11)
	...
	for iter_1_0 = 1, #var_0_2 do
		...
		var_1_9(var_1_8, var_1_10, var_1_10010, var_11.Find(var_1_11, "Character"))
	end
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	var_5(var_7.Find(var_8_5, "Lock"), not var_8_1)
