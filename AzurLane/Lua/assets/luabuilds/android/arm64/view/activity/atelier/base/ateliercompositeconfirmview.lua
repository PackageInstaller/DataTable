...
function var_0_1.didEnter(arg_6_0)
	...
	local var_6_6 = var_4.Find(var_6_5, "Window/Cancel")
...
function var_0_1.ShowCompositeConfirmWindow(arg_9_0, arg_9_1)
	...
	local var_9_6 = var_8.Find(var_9_5, "Window/Confirm")
	...
	local function var_9_7()
		...
		var_11_1(var_11_0, var_2_10003.COMPOSITE_ATELIER_RECIPE, var_9_2, var_9_1)
	...
	var_5(var_9_4, var_9_6, var_9_7, var_9_5)
	...
	local var_9_11 = var_5

	if var_5.GetMaxLimit(var_9_11) > 0 then
		var_9_11 = var_5

		local var_9_12

		if not (var_5.GetMaxLimit(var_9_11) - var_5:GetUsedCount()) then
			var_9_12 = 10000
		end

		local var_9_13 = arg_9_0.activity
		local var_9_14 = var_8.GetItems(var_9_13)

		pairs = var_9_11

		for iter_9_0, iter_9_1 in var_9_11(var_9_3) do
			local var_9_15

			if not var_9_14[iter_9_0] or not var_9_14[iter_9_0].count then
				var_9_15 = 0
			end
			...
			local var_9_16 = var_9_12

			math = var_1_10018
			var_9_12 = var_1_10015(var_9_16, var_1_10018.floor(var_9_15 / iter_9_1))
		end

		local var_9_17 = var_9_12
		local var_9_18 = {
			1,
			var_9_10 and var_9_17 or 1
		}

		Drop = var_11

		local var_9_19 = var_11.New({
			type = var_5:GetProduction()[1],
			id = var_5:GetProduction()[2]
		})
		local var_9_20 = arg_9_0._parentClass
		local var_9_21 = var_12.UpdateRyzaDrop
		local var_9_22 = arg_9_0._tf

		var_9_21(var_9_20, var_15.Find(var_9_22, "Window/Icon"), var_9_19)

		local var_9_23 = arg_9_0._tf
		local var_9_24 = var_12.Find(var_9_23, "Window/Counters")
		local var_9_25 = var_9_19:getConfig("name")

		setActive = var_9_23

		var_9_23(var_9_24, var_9_10)

		if var_9_10 then
			setAnchoredPosition = var_9_23

			local var_9_26 = arg_9_0._tf

			var_9_23(var_16.Find(var_9_26, "Window/Icon"), {
				y = var_0_2
			})
			;(function()
				setText = var_2_10000

				local var_12_0 = var_9_24

				var_2_10000(var_2.Find(var_12_0, "Number"), var_9_1)

				setText = var_2_10000

				local var_12_1 = arg_9_0._tf
				local var_12_2 = var_2.Find(var_12_1, "Window/Text")

				i18n = var_3

				var_2_10000(var_12_2, var_3("ryza_composite_confirm", var_9_25, var_9_1))
			...
			var_15(arg_9_0, var_9_24:Find("Plus"), function()
				local var_13_0 = var_9_1

				var_9_1 = var_9_1 + 1
				math = var_1
				var_9_1 = var_1.clamp(var_9_1, var_9_18[1], var_9_18[2])
				...
				if var_13_0 == var_9_1 then
					...
					var_13_2(var_13_1, var_4("ryza_tip_max_composite_count"))
			...
			var_15(arg_9_0, var_9_24:Find("Minus"), function()
				var_9_1 = var_9_1 - 1
				math = var_0
				var_9_1 = var_0.clamp(var_9_1, var_9_18[1], var_9_18[2])
			...
			var_15(arg_9_0, var_9_24:Find("Plus10"), function()
				...
				if var_15_0 == var_9_1 then
					...
					var_15_2(var_15_1, var_4("ryza_tip_max_composite_count"))
			...
			var_15(arg_9_0, var_9_24:Find("Minus10"), function()
				var_9_1 = var_9_1 - 10
				math = var_0
				var_9_1 = var_0.clamp(var_9_1, var_9_18[1], var_9_18[2])
			...
			var_9_23(var_16.Find(var_9_27, "Window/Icon"), {
				y = var_0_3
			})
			...
			local var_9_29 = var_16.Find(var_9_28, "Window/Text")

			i18n = var_17

			var_9_23(var_9_29, var_17("ryza_composite_confirm_single", var_9_25, var_9_1))
		end
