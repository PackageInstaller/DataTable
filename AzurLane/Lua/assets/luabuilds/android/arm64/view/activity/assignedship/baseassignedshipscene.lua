...
function var_0_1.setItemVO(arg_2_0, arg_2_1)
	...
	arg_2_0.style, arg_2_0.title = var_2(var_4.getConfig(var_2_1, "open_ui"))
...
function var_0_1.init(arg_4_0)
	...
	arg_4_0.itemList = var_4_2(var_4_3, var_5.Find(var_4_4, "item"))
	...
	var_2.make(var_4_5, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10004.EventUpdate then
			...
			var_4("extra_page/" .. arg_4_0.style .. "/is_" .. var_5_0, "", arg_5_2:Find("selected"))
			...
			var_4(var_5_1, var_5_2, var_5_3, var_9)
		end
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_5()
		...
		pg = var_2_10007
		var_9_2.content = var_2_10004(var_9_3, var_2_10007.ship_data_statistics[arg_7_0.selectedShipNumber].name)
		...
		function var_9_2.onYes()
			...
			var_10_1(var_10_0, var_3_10003.ON_USE_ITEM, arg_7_0.itemVO.id, arg_7_0.count, {
	...
	var_1(var_3.GetChild(var_7_7, 0), true)
...
function var_0_1.checkAndSetSprite(arg_11_0, arg_11_1, arg_11_2)
	if arg_11_0.spList[arg_11_1] and arg_11_0.afterAnima[arg_11_1] then
		...
		typeof = var_6
		Image = var_1_10008
		var_11_1(var_11_0, var_6(var_1_10008)).enabled = true
...
function var_0_1.changeShowCharacter(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	if arg_12_3 then
		...
		local var_12_0 = var_1_10004(var_1_10006(arg_12_2), 0, 0.3)

		var_1_10004 = var_1_10004.setOnComplete
		System = var_1_10007

		var_1_10004(var_12_0, var_1_10007.Action(function()
			local var_13_0 = arg_12_2
			local var_13_1 = var_0.GetComponent

			typeof = var_2_10003
			Image = var_2_10005
			var_13_1(var_13_0, var_2_10003(var_2_10005)).enabled = false
		...
		typeof = var_1_10007
		Image = var_1_10009
		var_1_10004 = var_1_10004(var_12_1, var_1_10007(var_1_10009))
