...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ADD_WORKPLACE, function(arg_3_0, arg_3_1)
		...
		local var_3_2 = var_2_10005.ACTIVITY_TOWN_OP
		local var_3_3 = {
		...
		TownActivity2 = var_7
		var_3_3.cmd = var_7.OPERATION.SETTLE_GOLD
	...
	arg_1_0:bind(var_0_1.ALL_WORKPLACE, function(arg_4_0)
		...
		local var_4_2 = var_2_10004.ACTIVITY_TOWN_OP
		local var_4_3 = {
			activity_id = arg_1_0.activity.id
		}

		TownActivity2 = var_6
		var_4_3.cmd = var_6.OPERATION.ALL_GOLD
	...
	arg_1_0:bind(var_0_1.UPGRADE_WORKPLACE, function(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
		...
		local var_5_2 = var_2_10007.ACTIVITY_TOWN_OP
		local var_5_3 = {
			activity_id = arg_1_0.activity.id
		}

		TownActivity2 = var_9
		var_5_3.cmd = var_9.OPERATION.UPGRADE_PLACE
	...
	arg_1_0:bind(var_0_1.CLICK_BUBBLE, function(arg_6_0, arg_6_1)
		...
		local var_6_2 = var_2_10005.ACTIVITY_TOWN_OP
		local var_6_3 = {
			activity_id = arg_1_0.activity.id
		}

		TownActivity2 = var_7
		var_6_3.cmd = var_7.OPERATION.CLICK_BUBBLE
	...
	arg_1_0:bind(var_0_1.OPEN_CLUE_BOOK, function(arg_7_0, arg_7_1)
		...
		LiquorFloorBookLayer = var_2_10008
		var_7_3.viewComponent = var_2_10008
		LiquorFloorBookMediator = var_2_10008
	...
	arg_1_0:bind(var_0_1.GO_FIGHT, function(arg_8_0, arg_8_1)
		...
		if var_8_1 then
			var_2_10007 = var_2
			var_2_10007 = var_2.getMapById(var_2_10007, var_8_1)

			if not var_8_0.isUnlock(var_2_10007) then
				getProxy = var_8_0
				ChapterProxy = var_2_10007
				var_2_10008 = var_8_0(var_2_10007)

				if var_8_0.getActiveChapter(var_2_10008) then
					::label_8_0::

					var_2_10009 = var_6
					var_8_1 = var_6.getConfig(var_2_10009, "map")
				end

				if not var_6 then
					var_2_10009 = var_8_0
					var_8_1 = var_8_0.GetLastNormalMap(var_2_10009)
				end

				pg = var_2_10007
				var_2_10009 = var_2_10007.m02

				local var_8_3 = var_7.sendNotification

				GAME = var_2_10010

				local var_8_4 = var_2_10010.GO_SCENE

				SCENE = var_2_10011

				var_8_3(var_2_10009, var_8_4, var_2_10011.LEVEL, {
				...
				local var_8_5 = var_8_0.m02
				local var_8_6 = var_5.sendNotification

				GAME = var_2_10008

				local var_8_7 = var_2_10008.GO_SCENE

				SCENE = var_2_10009

				var_8_6(var_8_5, var_8_7, var_2_10009.LEVEL, {
					chapterId = var_8_2,
					mapIdx = var_8_1
				})
			end
	...
	if not var_1_2(var_1_1, var_4.ACTIVITY_TYPE_TOWN2) or var_1:isEnd() then
		assert = var_1_10002
...
function var_0_1.ChangeShips(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_2 = var_1_10006.ACTIVITY_TOWN_OP
	local var_10_3 = {
		activity_id = arg_10_0.activity.id
	}

	TownActivity = var_8
	var_10_3.cmd = var_8.OPERATION.CHANGE_SHIPS
...
function var_0_1.OnSelShips(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	var_11_1.priorEquipUpShipIDList = var_11_4(var_8.GetShipIds(var_11_5), function(arg_13_0)
		return arg_13_0 > 0
	end)
	i18n = var_6
	...
	local var_11_8 = var_9.New
	local var_11_9 = {}

	DockyardScene = var_1_10012
	var_11_9.viewComponent = var_1_10012
	DockyardMediator = var_1_10012
	var_11_9.mediator = var_1_10012
...
function var_0_1.OnSelected(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4)
	...
	local var_14_1 = var_1_10005(var_7.GetShipIds(var_14_0))
	local var_14_2 = {}
	local var_14_3 = {}
...
function var_0_1.GetSelectedShipIds(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in var_1_10004(var_6.GetShipIds(var_15_2)) do
		local var_15_3
		...
		if 0 < iter_15_1 then
			...
			var_15_3 = var_9.RawGetShipById(var_1_10011, iter_15_1)
		else
			var_15_3 = false
		end
		...
		if var_15_3 and var_15_3.id ~= var_15_0 then
			...
			var_10.insert(var_15_1, var_15_3.id)
		end
	end
...
function var_0_1.handleNotification(arg_17_0, arg_17_1)
	...
	if var_17_1 == var_17_0.ACTIVITY_TOWN_OP_DONE then
		switch = var_4

		local var_17_4 = var_17_3.cmd
		local var_17_5 = {}

		TownActivity2 = var_1_10008
		var_17_5[var_1_10008.OPERATION.UPGRADE_PLACE] = function()
		...
		TownActivity2 = var_8
		var_17_5[var_8.OPERATION.CHANGE_SHIPS] = function()
		...
		TownActivity2 = var_8
		var_17_5[var_8.OPERATION.CLICK_BUBBLE] = function()
			...
			var_20_3(var_20_2, var_2_10003.ON_ACHIEVE, var_17_3.awards)

			return
		end
		TownActivity2 = var_8
		var_17_5[var_8.OPERATION.SETTLE_GOLD] = function()
			...
			var_21_2(var_21_1, var_2_10003.ON_ACHIEVE, var_17_3.awards)

			return
		end
		TownActivity2 = var_8
		var_17_5[var_8.OPERATION.ALL_GOLD] = function()
			...
			var_22_2(var_22_1, var_2_10003.ON_ACHIEVE, var_17_3.awards)

			return
		end

		var_4(var_17_4, var_17_5)
	...
	if var_17_1 == var_4.ACTIVITY_UPDATED then
		local var_17_6 = var_17_3

		var_17_7 = var_17_3.getConfig(var_17_6, "type")
		ActivityConst = var_17_2

		if var_17_7 == var_17_2.ACTIVITY_TYPE_TOWN2 then
			getProxy = var_17_7
			ActivityProxy = var_17_6

			local var_17_8 = var_17_7(var_17_6)

			var_17_7 = var_17_7.getActivityByType
			ActivityConst = var_7
			arg_17_0.activity = var_17_7(var_17_8, var_7.ACTIVITY_TYPE_TOWN2)

			local var_17_9 = arg_17_0.viewComponent

			var_17_7.SetActivity(var_17_9, arg_17_0.activity)

			local var_17_10 = arg_17_0.viewComponent

			var_17_7.InitData(var_17_10)
		end
	...
	if var_17_1 ~= var_17_7.SUBMIT_TASK_AWARD_DOWN then
		GAME = var_4

		if var_17_1 == var_4.TOTAL_TASK_UPDATED then
			local var_17_11 = arg_17_0.viewComponent

			var_4.RefreshRedPoint(var_17_11)
		end
