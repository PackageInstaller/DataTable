...
function var_0_0.Play(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
	...
	if var_2_1 == var_1_10007.EXPLORE_TYPE_HOLD then
		...
		arg_2_0.PlayInterActionAnimHold(var_2_3, arg_2_4.sub_type, var_2_0, var_2_2, arg_2_2)

		local var_2_4 = arg_2_0.holdSpinePlayRecorder
		local var_2_5 = arg_2_2.name

		defaultValue = var_2_3
		var_2_4[var_2_5] = not var_2_3(var_2_2, false)
	else
...
function var_0_0.PlayInterActionAnimOnce(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	if var_4_0 == var_1_10005.EXPLORE_SUBTYPE_EFFECT then
		...
		local var_4_2 = var_1_10006.GetSpineNormalAction(var_4_0)
...
function var_0_0.RemoveEffect(arg_10_0, arg_10_1)
	...
	if arg_10_0.effects[arg_10_1] then
		...
		local var_10_1 = var_1_10003.GetInstance()

		var_3.ReturnUI(var_10_1, arg_10_1, var_10_0)
