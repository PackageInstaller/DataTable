...
function var_0_1.OnInit(arg_1_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_1_0.progressTxt = var_1_7(var_1_6, var_4(var_1_10006))
	...
	local function var_1_13()
		...
		pg = var_2_10004
		var_2_2.helps = var_2_10004.gametip.ur_exchange_help_tip.tip
	...
	local function var_1_16()
		...
		pg = var_2_10004
		var_3_2.helps = var_2_10004.gametip.ur_exchange_help_tip.tip
	...
	var_1(var_1_14, var_1_15, var_1_16, var_1_10006)
	...
	local function var_1_19()
		...
		local var_4_2 = var_2_10001.SystemOpenMgr.GetInstance()
		local var_4_3, var_4_4 = var_1.isOpenSystem(var_4_2, var_4_1.level, "FragmentShop")

		if not var_4_3 then
			pg = var_4_2

			local var_4_5 = var_4_2.TipsMgr.GetInstance()
		...
		local var_4_8 = var_2_10006.GO_SHOPS_LAYER_STEEET
		local var_4_9 = {}

		NewShopsScene = var_2_10008
		var_4_9.warp = var_2_10008.TYPE_FRAGMENT
	...
	var_1(var_1_20, var_1_21, var_1_22, var_1_10006)
	...
	local function var_1_25()
		...
		var_6_1(var_6_0, var_6_2, var_2_10004.TASK)
	...
	var_1(var_1_23, var_1_24, var_1_25, var_1_10006)
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	local var_7_2 = var_1_10004(var_1_10006)
	...
	NotifyTipHelper = var_8

	var_7_4(var_7_8, var_8.ShouldShowUrTip())
