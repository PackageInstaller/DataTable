...
local var_0_0 = "ActivityBossAlbionScene"
...
function var_0_1.UpdateDropItems(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_1_10001(var_2_0) do
		...
		local var_2_2 = var_6.Find(var_2_1, "milestone/item/IconTpl")
		local var_2_3 = {
		...
		var_8(var_2_4, var_2_5, var_2_6, var_1_10013)
	end
