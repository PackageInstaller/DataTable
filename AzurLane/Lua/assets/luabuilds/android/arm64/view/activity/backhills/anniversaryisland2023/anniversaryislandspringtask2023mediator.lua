...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.SHOW_SUBMIT_WINDOW, function(arg_5_0, arg_5_1)
		...
		AnniversaryIslandSpringTaskSubmitWindowMediator = var_2_10008
		var_5_3.mediator = var_2_10008
		AnniversaryIslandSpringTaskSubmitWindow = var_2_10008
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	AnniversaryIslandSpringTask2023Mediator = var_7_0

	local var_7_4

	if var_7_1 == var_7_0.SUBMIT_TASK then
		local var_7_3 = arg_7_0.viewComponent

		var_7_4 = var_7_4.emit
		AnniversaryIslandSpringTask2023Mediator = var_1_10007

		var_7_4(var_7_3, var_1_10007.SUBMIT_TASK, var_7_2)
	else
		GAME = var_7_4

		local var_7_6

		if var_7_1 == var_7_4.SUBMIT_ACTIVITY_TASK_DONE then
			local var_7_5 = arg_7_0.viewComponent

			var_7_6 = var_7_6.emit
			BaseUI = var_1_10007

			var_7_6(var_7_5, var_1_10007.ON_ACHIEVE, var_7_2.awards, function()
				...
				local var_8_0 = var_2_10000(var_2)
				local var_8_1 = var_0.getActivityByType

				ActivityConst = var_2_10003

				local var_8_2 = var_8_1(var_8_0, var_2_10003.ACTIVITY_TYPE_HOTSPRING_2)
				local var_8_3 = var_0.GetUnlockTaskIds(var_8_2)
				local var_8_4 = var_0
				local var_8_5 = var_0.GetConfigID(var_8_4)

				getProxy = var_8_2
				ActivityTaskProxy = var_2_10005

				local var_8_6 = var_8_2(var_2_10005)
				local var_8_7 = var_3.getTaskVOsByActId(var_8_6, var_8_5)

				_ = var_8_4

				if var_8_4.all(var_8_3, function(arg_9_0)
					_ = var_3_10001
					...
					local var_8_10 = var_7.CHANGE_SCENE

					SCENE = var_2_10008

					var_8_9(var_8_8, var_8_10, var_2_10008.ANNIVERSARY_ISLAND_SPRING)
				end
			...
			if var_7_1 == var_7_6.ACTIVITY_UPDATED then
