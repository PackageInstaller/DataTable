...
function var_0_0.updateSelect(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_5(arg_6_0._tf, "ad/title/text")

	i18n = iter_6_0

	var_3(var_6_2, iter_6_0(var_0_5[arg_6_1]))
...
function var_0_0.setItemData(arg_7_0, arg_7_1, arg_7_2)
	...
	var_1_10010(var_12(arg_7_1, "ad/icon/IconTpl"), var_7_5)
	...
	var_1_10010(var_7_6, var_7_7, var_7_8, var_15)

	setScrollText = var_1_10010
	findTF = var_7_6

	var_1_10010(var_7_6(arg_7_1, "ad/name/text"), var_7_5:getName())

	setText = var_1_10010
	findTF = var_12

	local var_7_9 = var_12(arg_7_1, "ad/amount/text")

	i18n = var_13

	var_1_10010(var_7_9, var_13(var_0_1, var_7_3, var_7_1))

	setActive = var_1_10010
	findTF = var_7_9

	var_1_10010(var_7_9(arg_7_1, "ad/soldOut"), var_7_3 == 0)
...
function var_0_0.updateItemsCount(arg_9_0, arg_9_1)
	...
	for iter_9_0 = 1, var_9_0 do
		...
		var_1_10007 = var_1_10007(var_1_10009(arg_9_0._awardTpl))
