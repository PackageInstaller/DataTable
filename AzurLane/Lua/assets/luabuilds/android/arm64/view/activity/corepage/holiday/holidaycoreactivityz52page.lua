...
function var_0_1.OnInit(arg_1_0)
	...
	for iter_1_0 = 1, arg_1_0.progTF.childCount do
		...
		var_1_7[iter_1_0] = var_1_9(var_1_8, var_9.Find(var_1_10, "prog_" .. iter_1_0))
	end
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_5()
		...
		local var_7_3 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		var_7_2(var_7_1, var_7_3, var_2_10004.MALL_MAP)
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	local var_8_1 = arg_8_0.isAllSigned(var_8_0)
	local var_8_2 = arg_8_0:isTargetLocking()

	setActive = var_8_0

	var_8_0(arg_8_0.btnSign, not var_8_1)

	setActive = var_8_0

	var_8_0(arg_8_0.btnLock, var_8_2 and var_8_1)

	setActive = var_8_0

	var_8_0(arg_8_0.btnGo, not var_8_2 and var_8_1)
	...
	if not var_8_1 then
		...
		local var_8_6 = var_8_4(var_6.getDayIndex(var_8_5), #arg_8_0.taskGroup)
	...
	for iter_8_0 = 1, var_8_11 do
		...
		var_1_10009(var_8_12.current, iter_8_0 == var_8_11 and not var_8_1)
	end
