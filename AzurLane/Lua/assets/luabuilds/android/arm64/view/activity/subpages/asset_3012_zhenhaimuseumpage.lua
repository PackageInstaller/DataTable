...
function var_0_1.initSkin(arg_1_0)
	...
	var_1(var_1_1, var_4("island_act_tips1"))
	...
	var_1(var_1_2, var_4(arg_1_0.skinTf, "left"), function()
		if var_0_3 then
			Time = var_0
		...
		if arg_1_0.skinIndex > 0 then
			...
			var_1.StartTimer(var_3_2, function()
				...
				var_3_10000(var_3_10002(arg_1_0.skinTf, "skins/skin" .. var_3_0), false)
			...
			local var_3_5 = var_3_4(var_3_3, var_4(var_6))
	...
	var_1(var_1_3, var_4(arg_1_0.skinTf, "right"), function()
		if var_0_3 then
			Time = var_0
		...
		if arg_1_0.skinIndex < arg_1_0.showItemNum then
			...
			var_1.StartTimer(var_5_2, function()
				...
				var_3_10000(var_3_10002(arg_1_0.skinTf, "skins/skin" .. var_5_0), false)
			...
			local var_5_5 = var_5_4(var_5_3, var_4(var_6))
	...
	for iter_1_0 = 0, var_0_2 do
		...
		var_5(var_1_4, var_1_10008(arg_1_0.skinTf, "page/" .. iter_1_0), function()
			if var_0_3 then
				Time = var_0
			...
			if arg_1_0.skinIndex ~= iter_1_0 then
				...
				if arg_1_0.skinIndex < iter_1_0 then
					...
					var_1.StartTimer(var_7_2, function()
						...
						var_3_10000(var_3_10002(arg_1_0.skinTf, "skins/skin" .. var_7_0), false)
					...
					local var_7_5 = var_7_4(var_7_3, var_4(var_6))
					...
					local var_7_10 = var_7_9(var_7_8, var_4(var_6))
		...
		var_1_10008 = iter_1_0 <= arg_1_0.showItemNum

		var_5(var_1_5, var_1_10008)
	end
...
function var_0_1.UpdateTask(arg_10_0, arg_10_1, arg_10_2)
	...
	if not var_5.getTaskById(var_10_2, var_10_1) then
		var_10_2 = arg_10_0.taskProxy
		var_10_3 = var_5.getFinishTaskById(var_10_2, var_10_1)
	end

	local var_10_4 = arg_10_2
	local var_10_5 = arg_10_2.Find(var_10_4, "get_btn")
	...
	local function var_10_8()
		if arg_10_0.nday <= var_0_2 then
			...
			function arg_10_0.playHandle()
				...
				var_12_1(var_12_0, var_3_10003.ON_TASK_SUBMIT, var_10_3)
			...
			var_11_2(var_11_1, var_2_10003.ON_TASK_SUBMIT, var_10_3)
		end
	...
	var_10_2(var_10_6, var_10_7, var_10_8, var_1_10012)

	local var_10_9 = arg_10_2
	local var_10_10 = arg_10_2.Find(var_10_9, "got_btn")
	...
	var_10_4(var_10_11, var_10_12, var_10_13, var_1_10013)

	local var_10_14 = arg_10_0.bg
	local var_10_15 = var_8.Find(var_10_14, "review_btn")

	onButton = var_10_9

	local var_10_16 = arg_10_0
	local var_10_17 = var_10_15
	...
	var_10_9(var_10_16, var_10_17, var_10_18, var_1_10014)
...
function var_0_1.pageUpdate(arg_15_0)
	for iter_15_0 = 0, var_0_2 do
		...
		var_1_10005(var_1_10007(arg_15_0.skinTf, "page/" .. iter_15_0), iter_15_0 <= arg_15_0.showItemNum)

		setActive = var_1_10005
		findTF = var_1_10007

		var_1_10005(var_1_10007(arg_15_0.skinTf, "page/" .. iter_15_0 .. "/selected"), arg_15_0.skinIndex == iter_15_0)

		setActive = var_1_10005
		findTF = var_1_10007

		var_1_10005(var_1_10007(arg_15_0.skinTf, "skins/skin" .. iter_15_0), arg_15_0.skinIndex == iter_15_0)

		findTF = var_1_10005
		var_1_10007 = var_1_10005(arg_15_0.skinTf, "skins/skin" .. iter_15_0)
		var_1_10005 = var_1_10005.GetComponent
		typeof = var_8
		Image = var_10
		var_1_10005 = var_1_10005(var_1_10007, var_8(var_10))
...
function var_0_1.updateSkinUI(arg_18_0)
	if arg_18_0.playHandle then
		...
		var_1(var_1_10003(arg_18_0.skinTf, "left"), false)

		setActive = var_1
		findTF = var_1_10003

		var_1(var_1_10003(arg_18_0.skinTf, "right"), false)

		setActive = var_1
		findTF = var_1_10003

		var_1(var_1_10003(arg_18_0.skinTf, "page"), false)
	else
		setActive = var_1
		findTF = var_1_10003

		var_1(var_1_10003(arg_18_0.skinTf, "left"), arg_18_0.skinIndex > 0)

		setActive = var_1
		findTF = var_3

		var_1(var_3(arg_18_0.skinTf, "right"), arg_18_0.skinIndex < arg_18_0.showItemNum)

		setActive = var_1
		findTF = var_3

		var_1(var_3(arg_18_0.skinTf, "page"), true)
	end
...
function var_0_1.displayWindow(arg_19_0, arg_19_1)
	...
	if arg_19_1 then
		...
		local var_19_2 = var_19_1(var_19_0, var_5(var_1_10007))
		...
		local var_19_7 = var_19_6:getTaskStatus()
		local var_19_8
		...
		arg_19_0.showItemNum = var_19_8

		if var_19_7 ~= 2 then
			arg_19_0.showItemNum = arg_19_0.showItemNum - 1
		end

		var_1_10007 = arg_19_0

		arg_19_0.updateSkinUI(var_1_10007)

		if arg_19_0.playHandle then
			local var_19_9 = arg_19_0.nday - 1

			setActive = var_6
			findTF = var_1_10008

			var_6(var_1_10008(arg_19_0.skinTf, "skins/skin" .. var_19_9), true)
			arg_19_0:StartTimer(function()
				setActive = var_2_10000
				findTF = var_2_10002

				var_2_10000(var_2_10002(arg_19_0.skinTf, "skins/skin" .. var_19_9), false)
			...
			local var_19_10 = var_6(arg_19_0.skinTf, "skins/skin" .. arg_19_0.skinIndex)
			local var_19_11 = var_6.GetComponent

			typeof = var_9
			Animation = var_11

			local var_19_12 = var_19_11(var_19_10, var_9(var_11))

			var_6.Play(var_19_12, "anim_zhenhaimuseum_skin_right")
		end
	else
		pg = var_19_1

		local var_19_13 = var_19_1.UIMgr.GetInstance()

		var_2.UnOverlayPanel(var_19_13, arg_19_0.skinTf)

		local var_19_14 = arg_19_0.skinTf
		local var_19_15 = var_2.GetComponent

		typeof = var_5
		Animation = var_1_10007

		local var_19_16 = var_19_15(var_19_14, var_5(var_1_10007))

		var_2.Play(var_19_16, "anim_zhenhaimuseum_out")
		arg_19_0:StartTimer(function()
			setActive = var_2_10000
