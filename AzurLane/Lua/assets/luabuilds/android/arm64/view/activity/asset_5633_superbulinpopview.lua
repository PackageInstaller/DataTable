	...
	var_1(arg_2_0, arg_2_0._tf, function()
		...
		var_2_10000({
			function(arg_4_0)
				...
				i18n = var_3_10005
				var_4_2.content = var_3_10005("super_bulin")
			...
			function(arg_6_0)
				...
				local var_6_5 = var_3_10006.BEGIN_STAGE
				local var_6_6 = {
					warnMsg = "bulin_tip_other3"
				}

				SYSTEM_SIMULATION = var_3_10008
				var_6_6.system = var_3_10008
				...
				function var_6_6.exitCallback()
					...
					local var_7_0 = var_4_10000(var_4_10002)
