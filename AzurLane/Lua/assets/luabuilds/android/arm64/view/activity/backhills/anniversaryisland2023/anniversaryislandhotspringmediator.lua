...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.OPEN_INFO, function()
		...
		AnniversaryIslandSpringShipSelectMediator = var_2_10006
		var_3_3.mediator = var_2_10006
		AnniversaryIslandSpringShipSelectLayer = var_2_10006
...
function var_0_1.OnSelected(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	local var_4_1 = var_1_10004(var_6.GetShipIds(var_4_0))

	_ = var_1_10005

	local var_4_2 = var_1_10005.each

	_ = var_1_10007

	local var_4_3 = var_1_10007.range
	local var_4_4 = arg_4_0.activity

	var_4_2(var_4_3(var_9.GetSlotCount(var_4_4)), function(arg_5_0)
	...
	if arg_4_2 == nil or #arg_4_2 == 0 then
		...
		if 0 < var_4_2 then
			...
			local var_4_7 = var_9.ACTIVITY_OPERATION
			local var_4_8 = {
				activity_id = arg_4_0.activity.id
			}

			Spring2Activity = var_11
			var_4_8.cmd = var_11.OPERATION_SETSHIP
			var_4_8.kvargs1 = {
				{
					value = 0,
					key = arg_4_1
	...
	var_4_6.Foreach(var_4_1, function(arg_7_0, arg_7_1)
		if arg_7_1 ~= 0 then
			table = var_2_10002
	...
	var_8.Foreach(var_4_1, function(arg_9_0, arg_9_1)
		local var_9_0
	...
	if #var_4_11 > 0 then
		...
		local var_4_16 = var_11.ACTIVITY_OPERATION
		local var_4_17 = {
			activity_id = arg_4_0.activity.id
		}

		Spring2Activity = var_13
		var_4_17.cmd = var_13.OPERATION_SETSHIP
...
function var_0_1.handleNotification(arg_11_0, arg_11_1)
	...
	if var_11_1 == nil then
		...
		if var_11_1 == var_11_0.ACTIVITY_SHOW_AWARDS then
			local var_11_4 = arg_11_0.viewComponent

			var_11_5 = var_11_5.emit
			BaseUI = var_1_10007

			var_11_5(var_11_4, var_1_10007.ON_ACHIEVE, var_11_3.awards, var_11_3.callback)
		else
			ActivityProxy = var_11_5

			if var_11_1 == var_11_5.ACTIVITY_UPDATED then
				local var_11_6 = var_11_3:getConfig("type")

				ActivityConst = var_11_2

				if var_11_6 == var_11_2.ACTIVITY_TYPE_HOTSPRING_2 then
					arg_11_0.activity = var_11_3

					local var_11_7 = arg_11_0.viewComponent

					var_4.SetActivity(var_11_7, var_11_3)

					local var_11_8 = arg_11_0.viewComponent

					var_4.UpdateView(var_11_8)
				end
			elseif var_11_1 == var_0_1.OPEN_CHUANWU then
				...
				var_11_10(var_11_9, var_11_11, var_1_10008(var_11_3))
			end
		end
	end
