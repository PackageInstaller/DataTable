...
function var_0_1.OnInit(arg_1_0)
	...
	typeof = var_4
	Image = var_6
	arg_1_0.coupletUpImg = var_1(var_1_3, var_4(var_6))
	findTF = var_1
	...
	tf = var_1
	instantiate = var_3
	arg_1_0.awardIcon = var_1(var_3(arg_1_0.iconTpl))

	local var_1_4 = arg_1_0.awardIcon

	Vector2 = var_1_10002
	var_1_4.anchoredPosition = var_1_10002(0, 0)
	setActive = var_1_4
	...
	for iter_1_0 = 1, var_0_3 do
		...
		local var_1_5 = var_1_5(var_1_10007(arg_1_0.itemTpl))
		...
		var_6(var_1_5, arg_1_0.itemContainer)

		table = var_6

		var_6.insert(arg_1_0.items, var_1_5)
	end

	arg_1_0.coupletBottomWords = {}

	for iter_1_1 = 1, var_0_4 do
		local var_1_6 = arg_1_0:createWord(iter_1_1, arg_1_0.coupletBottomContents)

		arg_1_0:addCoupletWordEvent(var_1_6)

		table = var_6

		var_6.insert(arg_1_0.coupletBottomWords, var_1_6)
	end

	GameObject = var_1

	local var_1_7 = var_1.Find("UICamera")
	local var_1_8 = var_1.GetComponent

	typeof = iter_1_1
	Camera = var_6
	arg_1_0._uiCamera = var_1_8(var_1_7, iter_1_1(var_6))
	Timer = var_1
	...
	var_1(arg_1_0, arg_1_0.btnHelp, function()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.couplete_help.tip
	...
	var_1(arg_1_0, arg_1_0.charClick, function()
		...
		if arg_1_0.charClickCount % 3 == 0 and not arg_1_0.coupletComplete and arg_1_0.coupletUnLock then
			...
			var_7_1(var_7_0, var_2_10003(var_7_2, var_2_10006("couplete_pair_" .. arg_1_0.coupletIndex)), true)
		end
	...
	local var_1_11 = arg_1_0.taskBtnGo
	...
	local function var_1_12()
		...
		var_8_1(var_8_0, var_2_10003.ON_TASK_GO, arg_1_0.taskVO)
	...
	var_1(var_1_10, var_1_11, var_1_12, var_6)

	onButton = var_1

	local var_1_13 = arg_1_0
	local var_1_14 = arg_1_0.taskBtnGet
	...
	local function var_1_15()
		...
		var_9_1(var_9_0, var_2_10003.SUBMIT_TASK, {
			normal_submit = true,
			virtual = false,
		...
		var_9_3(var_9_2, var_3(var_0_16), true)
	...
	var_1(var_1_13, var_1_14, var_1_15, var_6)

	Ship = var_1

	local var_1_16 = var_1.New({
		skin_id = 502010,
		configId = 502011
	})
	local var_1_17 = var_1.getPrefab(var_1_16)

	PoolMgr = var_3

	local var_1_18 = var_3.GetInstance()

	var_3.GetSpineChar(var_1_18, var_1_17, true, function(arg_10_0)
		...
		var_10_3(var_10_2, var_4(arg_1_0.charPos, "pos"), false)
		...
		typeof = var_5
		SpineAnimUI = var_7
		var_10_4.anim = var_10_6(var_10_5, var_5(var_7))
...
function var_0_1.OnShowFlush(arg_11_0)
	...
	if arg_11_0.data1List and arg_11_0.data2List and #arg_11_0.data1List ~= #arg_11_0.data2List then
		...
		var_11_1(var_11_0, var_1_10004(var_0_16))
	elseif arg_11_0.data1List and arg_11_0.data2List and #arg_11_0.data1List == #arg_11_0.data2List and not arg_11_0.coupletFinishAll then
		...
		var_11_3(var_11_2, var_1_10004(var_0_18))
	elseif arg_11_0.coupletFinishAll then
		...
		var_11_5(var_11_4, var_1_10004(var_0_15))
	end
...
function var_0_1.OnDataSetting(arg_13_0)
	if not arg_13_0.coupletIds then
		var_1_10003 = arg_13_0.activity
		arg_13_0.coupletIds = var_1.getConfig(var_1_10003, "config_client").couplet
	...
	local var_13_2 = var_1_10002(var_4)
...
function var_0_1.onTimer(arg_14_0)
	...
	elseif arg_14_0.tipStayIndex == 0 then
		...
		var_14_1(var_14_0, var_1_10004(var_0_17), true)
	end
...
function var_0_1.updateUI(arg_17_0)
	...
	for iter_17_0 = #arg_17_0.coupletIds, 1, -1 do
		...
		if not var_1_10007.contains(arg_17_0.data1List, var_17_0) then
			var_1_10007 = false
		end

		local var_17_1 = arg_17_0.items[iter_17_0]

		setActive = var_9
		findTF = var_1_10011

		var_9(var_1_10011(var_17_1, "got"), var_1_10006 or false)

		setActive = var_9
		findTF = var_1_10011

		var_9(var_1_10011(var_17_1, "bgMask"), not var_1_10007 or var_1_10006 or false)

		setActive = var_9
		findTF = var_1_10011

		var_9(var_1_10011(var_17_1, "red"), var_1_10007)

		setActive = var_9
		findTF = var_1_10011

		var_9(var_1_10011(var_17_1, "lock"), not var_1_10007 or false)

		if iter_17_0 == 7 then
			setActive = var_9
			findTF = var_1_10011

			var_9(var_1_10011(arg_17_0.finalAward, "lock"), not var_1_10007 or false)

			setActive = var_9
			findTF = var_1_10011

			var_9(var_1_10011(arg_17_0.finalAward, "mask"), not var_1_10007 or var_1_10006 or false)

			setActive = var_9
			findTF = var_1_10011

			var_9(var_1_10011(arg_17_0.finalAward, "got"), arg_17_0.coupletFinishAll)
		end
	end
...
function var_0_1.finishAll(arg_18_0)
	if #arg_18_0.data2List == #arg_18_0.coupletIds and #arg_18_0.data2List == #arg_18_0.data1List and arg_18_0.activity.data1 == 0 then
		...
		var_18_1(var_18_0, var_1_10004.PUZZLE_PIECE_OP, {
			cmd = 1,
...
function var_0_1.updateTask(arg_19_0)
	...
	local function var_19_8()
		...
		var_20_1(var_20_0, var_2_10003.ON_DROP, var_19_5)
	...
	var_5(var_19_6, var_19_7, var_19_8, var_1_10010)
	...
	var_6(arg_19_0.taskDesc, var_19_10)

	local var_19_11 = var_19_3:getTaskStatus()

	setActive = var_19_9

	var_19_9(arg_19_0.taskBtnGo, var_19_11 == 0)

	setActive = var_19_9

	var_19_9(arg_19_0.taskBtnGet, var_19_11 == 1)

	setActive = var_19_9

	var_19_9(arg_19_0.taskBtnGot, var_19_11 == 2)

	local var_19_12 = var_19_3
	local var_19_13 = var_19_3.getProgress(var_19_12)
	local var_19_14 = var_19_3:getConfig("target_num")

	setSlider = var_19_12

	var_19_12(arg_19_0.taskSlider, 0, var_19_14, var_19_13)

	setText = var_19_12

	var_19_12(arg_19_0.taskCur, var_19_13)

	setText = var_19_12

	var_19_12(arg_19_0.taskMax, "/" .. var_19_14)
...
function var_0_1.finishCouplete(arg_21_0)
	if arg_21_0.coupletUnLock and not arg_21_0.coupletComplete then
		...
		for iter_21_0 = 1, #arg_21_0.coupletBottomWords do
			var_1_10008 = arg_21_0.coupletBottomWords[iter_21_0]

			local var_21_2 = false

			if var_1_10008.index == var_1_10008.swapIndex then
				var_21_2 = true
			else
				...
				if var_10 == var_11 and var_21_1 and #var_21_1 > 0 then
					for iter_21_1 = 1, #var_21_1 do
						local var_21_3 = var_21_1[iter_21_1]

						table = var_1_10015

						if var_1_10015.contains(var_21_3, var_1_10008.index) then
							table = var_1_10015

							if var_1_10015.contains(var_21_3, var_1_10008.swapIndex) then
								var_21_2 = true
							end
						end
					end
		...
		if var_4.contains(arg_21_0.data1List, var_21_0) then
			...
			if not var_4.contains(arg_21_0.activity.data2_list, var_21_0) then
				...
				if #arg_21_0.activity.data2_list == #arg_21_0.coupletIds - 1 then
					function var_21_4(arg_22_0)
						local var_22_0 = arg_21_0
						local var_22_1 = var_1.emit

						ActivityMediator = var_2_10004

						var_22_1(var_22_0, var_2_10004.NEXT_DISPLAY_AWARD, arg_22_0)
					...
					var_21_6 = arg_21_0.showTips
					i18n = var_1_10008

					var_21_6(var_21_5, var_1_10008(var_0_15), true)
				else
				...
				local var_21_7 = var_21_6.m02
				local var_21_8 = var_5.sendNotification

				GAME = var_1_10008

				var_21_8(var_21_7, var_1_10008.MEMORYBOOK_UNLOCK, {
					id = var_21_0,
					actId = arg_21_0.activity.id,
					awardCallback = var_21_4
				})
			end
		end
...
function var_0_1.updateCoupletWord(arg_24_0)
	...
	var_1_10002(arg_24_0.coupletUpImg, var_24_0)

	setActive = var_1_10002

	var_1_10002(arg_24_0.coupletUpContents, arg_24_0.coupletUnLock)

	setActive = var_1_10002

	var_1_10002(arg_24_0.coupletUpLock, not arg_24_0.coupletUnLock)
	...
	for iter_24_1 = 1, #arg_24_0.coupletBottomWords do
		...
		if #var_24_1 > 0 then
			...
			var_1_10011 = var_24_1
			math = var_1_10012
			var_24_3 = var_24_4(var_1_10011, var_1_10012.random(1, #var_24_1))
		else
			var_24_3 = iter_24_1
		end
		...
		local var_24_5 = var_24_2.tf

		var_1_10012 = arg_24_0
		var_24_5.anchoredPosition = arg_24_0.getWordPosition(var_1_10012, var_24_3)
		setImageSprite = var_24_5
		findTF = var_1_10011
		var_1_10011 = var_1_10011(var_24_2.tf, "img")
		GetSpriteFromAtlas = var_1_10012

		var_24_5(var_1_10011, var_1_10012(var_0_8, "couplet_" .. arg_24_0.coupletIndex .. "_" .. var_24_2.index), true)
		...
		if var_24_2.index == var_24_2.swapIndex then
			var_24_6 = var_24_2.index == var_24_2.swapIndex
		else
			PLATFORM_CODE = var_1_10012
			PLATFORM_JP = var_13

			if var_1_10012 == var_13 and var_1_10011 and #var_1_10011 > 0 then
				for iter_24_2 = 1, #var_1_10011 do
					local var_24_7 = var_1_10011[iter_24_2]

					table = var_17

					if var_17.contains(var_24_7, var_24_2.index) then
						table = var_17

						if var_17.contains(var_24_7, var_24_2.swapIndex) then
							var_24_6 = true
						end
					end
				end
		...
		var_1_10012(var_14(var_24_2.tf, "bgOn"), var_24_6)

		GetComponent = var_1_10012
		findTF = var_14

		local var_24_8 = var_14(var_24_2.tf, "bgOn")

		typeof = var_15
		Image = var_17

		local var_24_9 = var_1_10012(var_24_8, var_15(var_17))

		var_1_10012.SetNativeSize(var_24_9)

		GetComponent = var_1_10012
		findTF = var_24_9

		local var_24_10 = var_24_9(var_24_2.tf, "bgOff")

		typeof = var_15
		Image = var_17

		local var_24_11 = var_1_10012(var_24_10, var_15(var_17))

		var_1_10012.SetNativeSize(var_24_11)
	end
	...
	local var_24_12 = arg_24_0.countDesc

	i18n = var_6

	var_3(var_24_12, var_6(var_0_11, arg_24_0.coupletIndex))
...
function var_0_1.createWord(arg_29_0, arg_29_1, arg_29_2)
	...
	local var_29_0 = var_1_10003(var_1_10005(arg_29_0.wordTpl))

	setParent = var_1_10004

	var_1_10004(var_29_0, arg_29_2)

	setActive = var_1_10004

	var_1_10004(var_29_0, true)
	...
	local var_29_2 = var_4(var_29_1, var_7(var_1_10009))
...
function var_0_1.getWordByPosition(arg_30_0, arg_30_1)
	...
	if var_1_10003.abs(var_30_1.x) < var_0_5 / 2 then
		math = var_3
		...
		local var_30_3 = var_30_2(var_5.abs((var_30_1.y - var_0_6 / 2) / var_0_6)) + 1
...
function var_0_1.getWordPosition(arg_31_0, arg_31_1)
	...
	return var_1_10004(var_31_0 * var_0_5, -var_31_1 * var_0_6)
end
...
function var_0_1.tweenWord(arg_32_0, arg_32_1)
	...
	local var_32_2 = var_1_10004.isTweening

	go = var_6

	local var_32_3

	if var_32_2(var_6(arg_32_1.tf)) then
		LeanTween = var_32_3
		var_32_3 = var_32_3.cancel
		go = var_6

		var_32_3(var_6(arg_32_1.tf))
	end

	LeanTween = var_32_3

	local var_32_4 = var_32_3.value

	go = var_6

	local var_32_5 = var_32_4(var_6(arg_32_1.tf), arg_32_1.tf.anchoredPosition.y, var_32_1.y, 0.1)
	local var_32_6 = var_4.setOnUpdate

	System = var_7

	local var_32_7 = var_32_6(var_32_5, var_7.Action_float(function(arg_33_0)
	...
	local var_32_8 = var_4.setOnComplete

	System = var_7

	var_32_8(var_32_7, var_7.Action(function()
		...
		if arg_32_1.index == arg_32_1.swapIndex then
			...
			if var_3 == var_4 and var_34_1 and #var_34_1 > 0 then
				for iter_34_0 = 1, #var_34_1 do
					local var_34_2 = var_34_1[iter_34_0]

					table = var_2_10008

					if var_2_10008.contains(var_34_2, arg_32_1.index) then
						table = var_2_10008

						if var_2_10008.contains(var_34_2, arg_32_1.swapIndex) then
							var_34_0 = true
						end
					end
				end
		...
		var_3(var_2_10005(arg_32_1.tf, "bgOn"), var_34_0)
...
function var_0_1.clearTween(arg_35_0)
	for iter_35_0 = 1, #arg_35_0.coupletBottomWords do
		...
		if var_1_10006(var_1_10008(var_35_0.tf)) then
			LeanTween = var_1_10006
			var_1_10006 = var_1_10006.cancel
			go = var_1_10008

			var_1_10006(var_1_10008(var_35_0.tf))
		end
	end
	...
	if var_1_10003(arg_36_1) == "table" then
		if arg_36_1 then
			...
			if 0 < var_36_0 then
				...
				i18n = var_36_0
				math = var_5
				var_36_0 = var_36_0(arg_36_1[var_5.random(1, #arg_36_1)])
				setText = var_4
				findTF = var_1_10006

				var_4(var_1_10006(arg_36_0.charTip, "text"), var_36_0)
		...
		var_3(var_5(arg_36_0.charTip, "text"), arg_36_1)
