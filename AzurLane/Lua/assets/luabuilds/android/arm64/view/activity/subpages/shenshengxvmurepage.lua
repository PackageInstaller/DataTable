...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	if var_2_6[var_2.getConfig(var_2_7, "config_id")].start_time == "stop" then
		...
		pg = var_2_5
		var_2_10 = var_2_5.TimeMgr.GetInstance()
		arg_2_0.inTime = var_3.GetServerTime(var_2_10) - var_2_9 > 0
	end

	setActive = var_2_9

	local var_2_11 = arg_2_0.battleBtn
	...
	if var_2_10(arg_2_0.battleBtn) then
		var_2_12 = arg_2_0.inTime
	end

	var_2_9(var_2_11, var_2_12)
...
function var_0_1.Switch(arg_4_0, arg_4_1)
	...
	var_2(var_4_0, var_4_1, var_4_2, var_1_10007)
...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	if var_1_10005(arg_7_0.battleBtn) then
	...
	local var_7_3 = arg_7_0.activity.data1

	pg = var_1_10003

	local var_7_4 = var_1_10003.activity_event_avatarframe
	local var_7_5 = arg_7_0.activity

	if var_7_4[var_4.getConfig(var_7_5, "config_id")].target < var_7_3 then
		var_7_3 = var_3
	end

	local var_7_6 = var_7_3 / var_3

	setText = var_7_2

	local var_7_7 = arg_7_0.step
	...
	if 1 <= var_7_6 then
		...
		if not var_8(var_7_3, "#487CFFFF") then
			var_7_8 = var_7_3
		end

		var_7_2(var_7_7, var_7_8)

		setText = var_7_2

		var_7_2(arg_7_0.progress, "/" .. var_3)

		setFillAmount = var_7_2

		var_7_2(arg_7_0.bar, var_7_3 / var_3)

		local var_7_9 = var_3 <= var_7_3
		local var_7_10 = arg_7_0.activity.data2
		local var_7_11 = 1 <= var_7_10

		setActive = var_7

		var_7(arg_7_0.battleBtn, not var_7_11 and not var_7_9 and arg_7_0.inTime)

		setActive = var_7

		var_7(arg_7_0.getBtn, var_7_9 and not var_7_11)

		setActive = var_7

		var_7(arg_7_0.gotBtn, var_7_11)
