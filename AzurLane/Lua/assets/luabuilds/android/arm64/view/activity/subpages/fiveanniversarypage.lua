...
function var_0_1.OnInit(arg_1_0)
	...
	if var_1_10002 ~= var_3 then
		...
		if var_1_10002 == var_3 then
			...
			Vector2 = var_1_10002
			var_1_0.anchoredPosition = var_1_10002(-11, -20)
			Vector2 = var_1_10002
			var_1_0.sizeDelta = var_1_10002(1437, 90)
		else
			PLATFORM_CODE = var_1_10002
			PLATFORM_US = var_3
...
function var_0_1.initBtnEvent(arg_11_0, arg_11_1, arg_11_2)
	...
	elseif arg_11_2 == 2 then
		...
		local function var_11_5()
			...
			if var_2_10000 == var_2_10001 then
				...
				var_13_1(var_13_0, var_2_10003.SELECT_ACTIVITY, 41327)
			else
				...
				local var_13_4 = var_2_10003.SELECT_ACTIVITY

				ActivityConst = var_2_10004

				var_13_3(var_13_2, var_13_4, var_2_10004.ACTIVITY_TYPE_RETURN_AWARD_ID5)
			end
	...
	elseif arg_11_2 == 3 then
		...
		local function var_11_8()
			...
			if var_2_10000 == var_2_10001 then
				...
				var_14_1(var_14_0, var_2_10003, var_2_10004.SIXTH_ANNIVERSARY_JP)
			else
				...
				var_14_3(var_14_2, var_2_10003.EVENT_GO_SCENE, var_0_7)
			end
	...
	elseif arg_11_2 == 4 then
		...
		local function var_11_11()
			...
			if var_2_10000 == var_2_10001 then
				...
				var_15_1(var_15_0, var_2_10003, var_2_10004.SIXTH_ANNIVERSARY_JP_DARK)
			else
				...
				var_15_3(var_15_2, var_2_10003.GO_MINI_GAME, var_0_2)
			end
	...
	elseif arg_11_2 == 6 then
		...
		local function var_11_17()
			...
			local var_17_3 = var_2_10004.CHARGE
			local var_17_4 = {}

			ChargeScene = var_2_10006
			var_17_4.wrap = var_2_10006.TYPE_DIAMOND
		...
		var_1_10003(var_11_15, var_11_16, var_11_17, var_1_10008)
	end
