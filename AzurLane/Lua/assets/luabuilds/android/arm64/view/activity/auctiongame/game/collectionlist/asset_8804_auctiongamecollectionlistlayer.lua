...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10004("auction_collection_title"))
	...
	var_1_10001(var_2_1, var_4("auction_collect_unlock"))
	...
	var_1_10001(var_2_2, var_2_3, var_2_4, var_6)
	...
	var_1_10001(var_2_5, var_2_6, var_2_7, var_6)
	...
	AuctionGameCollectionItem = var_6
	arg_2_0.uiScrollView = var_2_8(var_2_9, var_2_10, var_2_11, var_6)
	...
	for iter_2_0, iter_2_1 in var_1(arg_2_0.rarityList) do
		...
		AuctionGameCollectionRarityItem = var_2_13

		local var_2_13 = var_2_13.New

		string = var_1_10009
		var_2_12[iter_2_0] = var_2_13(arg_2_0[var_1_10009.format("uiRarityItem%s", iter_2_0)], arg_2_0)
		var_1_10008 = arg_2_0.rarityItemList[iter_2_0]

		var_6.didEnter(var_1_10008, iter_2_1)
	end
	...
	for iter_2_2, iter_2_3 in var_1(arg_2_0.contourList) do
		local var_2_14 = iter_2_3[1]
		local var_2_15 = iter_2_3[2]

		table = var_1_10008
		var_1_10008 = var_1_10008.insert

		local var_2_16 = arg_2_0.contourItemList

		AuctionGameCollectionContourItem = var_1_10011
		var_1_10011 = var_1_10011.New
		string = var_1_10013

		var_1_10008(var_2_16, var_1_10011(arg_2_0[var_1_10013.format("uiContourItem%s", iter_2_2)], arg_2_0))

		local var_2_17 = arg_2_0.contourItemList[#arg_2_0.contourItemList]

		var_1_10008.didEnter(var_2_17, var_2_15, var_2_14)
	end
...
function var_0_1.didEnter(arg_5_0)
	...
	arg_5_0.RefreshCollectionList(var_5_2)

	local var_5_3 = {}
	local var_5_4 = arg_5_0
	local var_5_5 = arg_5_0.bind
	local var_5_6 = var_0_1.ON_SWITCH_RARITY

	handler = var_6
	var_5_3[1] = var_5_5(var_5_4, var_5_6, var_6(arg_5_0, arg_5_0.OnSwitchRarity))

	local var_5_7 = arg_5_0
	local var_5_8 = arg_5_0.bind
	local var_5_9 = var_0_1.ON_SWITCH_CONTOUR

	handler = var_6
	var_5_3[2] = var_5_8(var_5_7, var_5_9, var_6(arg_5_0, arg_5_0.OnSwitchContour))
	arg_5_0.eventIDList = var_5_3
	getProxy = var_5_3
	AuctionGameBaseProxy = var_5_2

	local var_5_10 = var_5_3(var_5_2)

	setText = var_2

	local var_5_11 = arg_5_0.uiCollectText

	string = var_5_9

	local var_5_12 = var_5_9.format
	local var_5_13 = "%s/%s"
	local var_5_14 = var_5_10.unlockCollectionCnt

	pg = var_9

	var_2(var_5_11, var_5_12(var_5_13, var_5_14, #var_9.auction_collection.all))
...
function var_0_1.RefreshCollectionList(arg_6_0)
	...
	local var_6_3, var_6_4 = var_6_2(var_6_1, var_4, var_5)
	...
	local var_6_6 = var_1_10006.format
	local var_6_7 = "%s - %s"

	StringHelper = var_1_10009

	local var_6_8 = var_1_10009.ForamtNumber(var_6_3)

	StringHelper = var_1_10010

	var_6_1(var_6_5, var_6_6(var_6_7, var_6_8, var_1_10010.ForamtNumber(var_6_4)))

	ipairs = var_6_1

	for iter_6_0, iter_6_1 in var_6_1(arg_6_0.rarityItemList) do
...
function var_0_1.GetCollectionList(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0, iter_8_1 in var_1_10004(var_1_10006.auction_collection.all) do
		pg = var_1_10009
...
function var_0_1.GetFilterData(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1_10003(var_1_10005.auction_collection.all) do
		pg = var_1_10008
