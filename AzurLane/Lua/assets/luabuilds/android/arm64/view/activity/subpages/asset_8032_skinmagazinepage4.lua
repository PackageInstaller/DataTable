...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local var_4_21 = arg_4_0.rtAward
	local var_4_22 = var_5.Find(var_4_21, "get/click/desc")

	i18n = var_6

	var_4_14(var_4_22, var_6(var_0_1.TIP_KEY))

	local var_4_23 = arg_4_0.activity

	if var_3.getConfig(var_4_23, "config_client").firstStory then
		pg = var_4_15

		local var_4_24 = var_4_15.NewStoryMgr.GetInstance()

		var_4.Play(var_4_24, var_3)
	end
