local var_0_0 = class("XiaoAiJiErPage", import(".TemplatePage.PtTemplatePage"))
...
function var_0_0.OnUpdateFlush(arg_3_0)
	...
	setText(arg_3_0.step, setColorStr(var_3_0, "#f0d1c6") .. " / " .. var_3_1)

	local var_3_6 = var_3_5 >= 1 and setColorStr(var_3_3, COLOR_GREEN) or setColorStr(var_3_3, "#f0d1c6")
...
function var_0_0.tryClaimTaskReward(arg_8_0)
	for iter_8_0 = 1, #arg_8_0.taskGroups do
		for iter_8_1, iter_8_2 in ipairs(arg_8_0.taskGroups[iter_8_0].tasks) do
			local var_8_0 = iter_8_2.finish == 1

			if iter_8_2.targetNum <= iter_8_2.progress and not var_8_0 then
				local var_8_1 = arg_8_0.taskProxy:getTaskById(iter_8_2.id)
	...
	if #{} > 0 then
		arg_8_0:emit(ActivityMediator.ON_TASK_SUBMIT_ONESTEP, {})
	end
