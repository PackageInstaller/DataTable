...
function var_0_1.OnInit(arg_1_0)
	...
	local function var_1_3()
		...
		pg = var_2_10004
		var_2_2.helps = var_2_10004.gametip.littleaijier_npc.tip
...
function var_0_1.OnUpdateFlush(arg_3_0)
	...
	var_1_10007(var_3_8, var_1_10010(var_3_1, "#f0d1c6") .. " / " .. var_3_2)
...
function var_0_1.OnFirstFlush(arg_6_0)
	...
	local function var_6_2()
		...
		var_7_1(var_7_0, var_7_2, var_2_10004.LEVEL)
...
function var_0_1.tryClaimTaskReward(arg_8_0)
		...
		for iter_8_1, iter_8_2 in var_1_10008(var_8_1) do
			...
			if var_8_2 <= var_8_3 and not var_8_4 then
				...
				if var_16.getTaskById(var_8_5, iter_8_2.id) then
					...
					var_1_10017.insert(var_8_0, var_16)
				end
			end
		end
	end
	...
	if #var_8_0 > 0 then
		...
		ActivityMediator = iter_8_0

		var_8_7(var_8_6, iter_8_0.ON_TASK_SUBMIT_ONESTEP, var_8_0)
	end
...
function var_0_1.initTask(arg_9_0)
	...
	local var_9_2 = var_1_10002.activity_template[var_9_1].config_data[1]
...
function var_0_1.updateTaskList(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	if var_11_3 then
		...
		var_1_10015(var_17(var_11_8, "mask1"), var_11_2)
	else
		setActive = var_1_10015
		findTF = var_17

		var_1_10015(var_17(var_11_8, "mask2"), var_11_2)
	end
	...
	if var_11_2 then
		...
		var_1_10015(var_17(var_11_8, "pahase"), false)

		setSlider = var_1_10015
		findTF = var_17

		var_1_10015(var_17(var_11_8, "slider"), 0, 1, 1)
	else
		setActive = var_1_10015
		findTF = var_17

		var_1_10015(var_17(var_11_8, "pahase"), true)

		setSlider = var_1_10015
		findTF = var_17

		var_1_10015(var_17(var_11_8, "slider"), 0, 1, var_11_1 / var_11_0)
	end

	setText = var_1_10015
	findTF = var_17

	var_1_10015(var_17(var_11_8, "desc"), var_11_4)
	...
	if arg_11_4.subType ~= 33 then
		...
		var_15(var_11_9, var_18(var_11_1, "#957b01") .. "/" .. var_11_0)
	else
		setText = var_15
		findTF = var_11_9
	...
	local var_11_11 = var_18(var_11_8, "award")
	...
	var_15(var_11_10, var_11_11, var_11_12, var_20)
	...
	elseif var_11_0 <= var_11_1 then
		...
		var_15(var_11_13, var_11_14, var_11_15, var_20)
	else
		setActive = var_15
		findTF = var_11_13
		...
		var_15(var_11_13, var_11_14, var_11_16, var_20)
	end
	...
	if var_11_3 then
		...
		var_15(var_11_17, var_11_18, var_11_19, var_20)
	end
