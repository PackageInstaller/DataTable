...
function var_0_1.OnUpdateFlush(arg_4_0)
	...
	local var_4_9 = var_1_10010(var_4_1, "#838fff")
	local var_4_10 = " / "

	setColorStr = var_12

	var_1_10007(var_4_8, var_4_9 .. var_4_10 .. var_12(var_4_2, "#666176"))
	...
	if 1 <= var_4_7 then
		...
		if not var_4_13(var_4_12, var_13) then
			setColorStr = var_4_13
		...
		var_1_10007(var_4_11, var_4_13 .. var_4_14 .. var_4_12(var_4_6, "#666176"))
		...
		if arg_4_0.firstSliderInit then
			...
			typeof = var_10
			Slider = var_12
			var_4_15 = var_4_15(var_4_16, var_10(var_12)).value
			...
			local var_4_18 = var_4_17(var_10(arg_4_0.slider), var_4_15, var_4_7, 1)
			local var_4_19 = var_8.setOnUpdate

			System = var_11

			var_4_19(var_4_18, var_11.Action_float(function(arg_5_0)
...
function var_0_1.updateTaskList(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	...
	if arg_12_4.subType ~= 33 then
		...
		local var_12_10 = var_18(var_12_1, "#19383")
		local var_12_11 = "/"

		setColorStr = var_20

		var_15(var_12_9, var_12_10 .. var_12_11 .. var_20(var_12_0, "#5c5967"))
	else
		setText = var_15
		findTF = var_12_9
