...
function var_0_1.didEnter(arg_6_0)
	...
	local var_6_2 = var_4.Find(var_6_1, "Composite")
	...
	local var_6_6 = var_4.Find(var_6_5, "AutoFill")
...
function var_0_1.Show(arg_9_0, arg_9_1)
	...
	if not arg_9_0.nodePools then
		...
		var_9_1.circle = var_1_10003(var_5.Find(var_9_2, "CircleNode").gameObject, 100)
		var_1_10003 = var_0_2.New

		local var_9_3 = arg_9_0._tf

		var_9_1.hexagon = var_1_10003(var_5.Find(var_9_3, "HexagonNode").gameObject, 100)
		var_1_10003 = var_0_2.New

		local var_9_4 = arg_9_0._tf

		var_9_1.anyHexagon = var_1_10003(var_5.Find(var_9_4, "AnyHexagonNode").gameObject, 100)
		var_1_10003 = var_0_2.New

		local var_9_5 = arg_9_0._tf

		var_9_1.doubleHexagon = var_1_10003(var_5.Find(var_9_5, "DoubleHexagonNode").gameObject, 100)
	...
	if not arg_9_0.pluralRoot then
		pg = var_9_6
		var_9_6 = var_9_6.PoolMgr.GetInstance().root
	end

	arg_9_0.pluralRoot = var_9_6
	...
	arg_9_0.nodeList = var_9_7
	_ = var_9_7

	var_9_7.each(arg_9_0.nodeList, function(arg_11_0)
		...
		local var_11_5 = var_11_4:Find("Item")

		typeof = var_2_10006
		Image = var_8

		var_3(var_11_5, var_2_10006(var_8), false)

		local var_11_6 = arg_9_0._parentClass.loader

		var_3.ClearRequest(var_11_6, var_11_4:Find("Ring"))

		local var_11_7 = arg_9_0

		var_3.CleanNodeLinks(var_11_7, arg_11_0)

		local var_11_8 = arg_9_0._parentClass.loader

		var_3.ClearRequest(var_11_8, var_11_4)

		local var_11_9 = var_11_3
		local var_11_10 = var_11_3.Enqueue

		go = var_6

		if not var_11_10(var_11_9, var_6(arg_11_0.GO)) then
			setParent = var_4
			go = var_6

			var_4(var_6(arg_11_0.GO), arg_9_0.pluralRoot)

			setActive = var_4
			go = var_6

			var_4(var_6(arg_11_0.GO), false)
		end
	...
	local var_9_8 = arg_9_0.viewContent

	Vector2 = var_5

	var_2(var_9_8, var_5.zero)

	local var_9_9 = 0

	_ = var_1_10003

	var_1_10003.each(arg_9_1:GetCircleList(), function(arg_12_0)
		...
		var_3(var_5(var_12_2), arg_9_0.viewContent)
...
function var_0_1.OnClickComposite(arg_13_0)
	...
	if not var_2.IsAvaliable(var_13_2) then
		...
		var_13_4(var_13_3, var_1_10006("ryza_tip_composite_invalid"))
...
function var_0_1.UseMat(arg_17_0, arg_17_1)
	...
	if not arg_17_0.temps[arg_17_1:GetConfigID()] then
		...
		var_17_1 = var_17_1(var_4.GetItems(var_17_0)[arg_17_1:GetConfigID()])
	end
...
function var_0_1.FillNode(arg_18_0, arg_18_1, arg_18_2)
	...
	var_1_10004.insert(var_18_0, function(arg_19_0)
		...
		AtelierMaterial = var_2_10005

		local var_19_3 = var_2_10005.New
		local var_19_4 = {
			count = 1
		}
		local var_19_5 = arg_18_2

		var_19_4.configId = var_8.GetConfigID(var_19_5)
	...
	local var_18_2 = var_1_10005.select(arg_18_0.nodeLayer[var_18_1], function(arg_20_0)
		...
		if 0 < var_1_10010 then
			...
			if iter_23_0 == 1 then
				...
				for iter_23_4, iter_23_5 in var_23_10(var_23_2) do
					local var_23_3 = iter_23_5.Data

					if iter_23_10.GetLimitItemID(var_23_3) ~= 0 then
						if not arg_23_0.temps[var_17] then
							local var_23_4 = arg_23_0.activity

							var_1_10018 = var_1_10018.GetItems(var_23_4)[var_17]
						end
						...
						if var_1_10018 and var_1_10018.count > 0 then
							...
							var_19.insert(var_23_0, function(arg_24_0)
								...
								var_24_1(var_24_0, var_24_2, var_2_10005.New({
									count = 1,
									configId = var_0
								}), arg_24_0, true)
						...
						local var_23_5 = arg_23_0.activity

						var_1_10018 = var_1_10018.GetFormulas(var_23_5)[arg_23_0.contextData.formulaId]
						ipairs = var_19

						for iter_23_6, iter_23_7 in var_19(arg_23_0.circleTypeList) do
							if iter_23_10:GetType() == iter_23_7 then
								local var_23_6 = false

								ipairs = var_1_10025
								pg = var_1_10027

								for iter_23_8, iter_23_9 in var_1_10025(var_1_10027.activity_ryza_item.all) do
									local var_23_8
									...
									if var_23_8 and var_23_8.count > 0 and var_23_8:IsNormal() and iter_23_10:CanUseMaterial(var_23_8, var_1_10018, arg_23_0.contextData.versionIndex) then
										...
										var_31.insert(var_23_0, function(arg_25_0)
											...
											local var_25_3 = var_2_10005.New
											local var_25_4 = {
												count = 1
											}
											local var_25_5 = var_23_8

											var_25_4.configId = var_8.GetConfigID(var_25_5)
				...
				for iter_23_10, iter_23_11 in var_23_9(arg_23_0.circleTypeList) do
					_ = var_1_10018
					...
					var_1_10018.each(var_23_2, function(arg_27_0)
						...
						if var_1.GetType(var_27_0) == iter_23_11 then
							...
							for iter_27_0, iter_27_1 in var_3(var_2_10005.activity_ryza_item.all) do
								local var_27_3
								...
								if var_27_3 and var_27_3.count > 0 and var_27_3:IsNormal() and var_1:CanUseMaterial(var_27_3, var_23_10, arg_23_0.contextData.versionIndex) then
									...
									var_9.insert(var_23_11, function()
										...
										local var_28_3 = var_3_10004.New
										local var_28_4 = {
											count = 1
										}
										local var_28_5 = var_27_3

										var_28_4.configId = var_7.GetConfigID(var_28_5)
				...
				if #var_23_11 > 0 then
					...
					var_13.insert(var_23_0, function(arg_29_0)
						...
						var_29_1(var_29_0, iter_29_0.delayedCall, function()
							arg_29_0()
			...
			if var_1_10010 then
				...
				var_23_10.insert(var_23_0, function(arg_31_0)
					...
					var_31_1(var_31_0, var_2_10004("ryza_material_not_enough"))
					arg_31_0()
...
function var_0_1.FillNodeAndPlayAnim(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4)
	...
	if not arg_34_1.ChangeInstance then
		...
		tobool = var_1_10006
		var_34_1 = var_34_1 ~= var_1_10006(arg_34_2)
	end
	...
	var_34_0({
		function(arg_35_0)
			...
			var_2_10001.ParallelIpairsAsync({
				...
				var_36_0[arg_36_0] = var_4.GetPrefab(var_36_1, arg_36_1, "", function(arg_37_0)
					...
					var_4_10001(var_37_0, var_4_10004(arg_34_1.GO))
					...
					var_4_10001(var_37_1, var_4.zero)
		...
		function(arg_38_0)
			...
			var_38_1(var_38_0, var_4.delayedCall, function()
		...
		function(arg_40_0)
			...
			var_40_1(var_40_0, var_4.delayedCall, function()
				arg_40_0()
...
function var_0_1.DisPlayUnlockEffect(arg_43_0, arg_43_1, arg_43_2)
	...
	for iter_43_0, iter_43_1 in var_1_10004(arg_43_0.nodeLayer[arg_43_1]) do
		...
		local var_43_4 = var_10.GetPrefab(var_43_3, "ui/" .. arg_43_0.unlockEffect, "", function(arg_44_0)
			...
			var_2_10001(var_44_0, var_2_10004(var_43_2.GO))
			...
			var_2_10001(var_44_1, var_4.zero)
		...
		var_1_10011.insert(var_43_1, var_43_4)
	end
	...
	var_43_6(var_43_5, iter_43_0.delayedCall, function()
	...
	var_43_8(var_43_7, var_7.delayedCall, function()
		_ = var_2_10000
...
function var_0_1.RefreshBtn(arg_50_0)
	...
	local var_50_3 = var_5.Find(var_50_2, "Bar/Text")

	i18n = var_1_10006

	var_1_10003(var_50_3, var_1_10006("ryza_tip_put_materials", var_50_1, var_50_0))

	setGray = var_1_10003

	local var_50_4 = arg_50_0._tf
	local var_50_5 = var_5.Find(var_50_4, "AutoFill")
	local var_50_6 = arg_50_0.activity
	local var_50_7 = var_6.GetFormulas(var_50_6)[arg_50_0.contextData.formulaId]

	var_1_10003(var_50_5, not var_6.IsAvaliable(var_50_7))

	setActive = var_1_10003

	local var_50_8 = arg_50_0._tf

	var_1_10003(var_5.Find(var_50_8, "Composite/Disabled"), var_50_1 < var_50_0)
...
function var_0_1.UpdateNodeView(arg_52_0, arg_52_1)
	...
	var_52_1(var_52_0:Find("Lock"), var_52_4)

	if var_52_4 then
		local var_52_5 = var_3:GetType()

		AtelierFormulaCircle = var_52_3

		if var_52_5 ~= var_52_3.TYPE.ANY then
			local var_52_6 = arg_52_0._parentClass.loader

			var_52_5.GetSpriteQuiet(var_52_6, arg_52_0.commonBundleName, "element_" .. var_52_2, var_52_0:Find("Lock/Require/Icon"))
		end

		setText = var_52_5

		var_52_5(var_52_0:Find("Lock/Require/Text"), "X" .. var_3:GetLevel())
	end

	for iter_52_0 = 3, var_3:GetLevel() + 1, -1 do
		local var_52_7 = var_52_0:Find("Slots")
		local var_52_8 = var_10.GetChild(var_52_7, iter_52_0 - 1)
		local var_52_9 = arg_52_0._parentClass.loader

		var_11.GetSpriteQuiet(var_52_9, arg_52_0.bundleName, "slot_BLOCKED", var_52_8:Find("Image"))
	end

	local var_52_10 = arg_52_1.Instance
	local var_52_11 = var_52_0
	local var_52_12 = var_52_0.Find(var_52_11, "Item")

	if not var_52_10 then
		local var_52_13 = var_3:GetType()

		AtelierFormulaCircle = var_52_11

		if var_52_13 == var_52_11.TYPE.ANY then
			setActive = var_52_13

			var_52_13(var_52_0:Find("All"), true)
		else
			setActive = var_52_13

			var_52_13(var_52_0:Find("Icon"), true)

			local var_52_14 = arg_52_0._parentClass.loader

			var_52_13.GetSpriteQuiet(var_52_14, arg_52_0.bundleName, "icon_" .. var_52_2, var_52_0:Find("Icon"), true)
		end

		setActive = var_52_13

		var_52_13(var_52_12, false)

		local var_52_15 = var_3:GetType()

		AtelierFormulaCircle = var_52_11

		if var_52_15 ~= var_52_11.TYPE.BASE then
			var_52_15 = var_3:GetType()
			AtelierFormulaCircle = var_52_11

			if var_52_15 == var_52_11.TYPE.SAIREN then
				AtelierMaterial = var_52_15
				var_52_15 = var_52_15.New({
					configId = var_3:GetLimitItemID()
				})
				setActive = var_52_11

				var_52_11(var_52_0:Find("Name"), true)

				setScrollText = var_52_11

				local var_52_16 = var_52_0:Find("Name/Rect/Text")

				var_1_10014 = var_52_15

				var_52_11(var_52_16, var_52_15.GetName(var_1_10014))
			else
				setActive = var_52_15

				var_52_15(var_52_0:Find("Name"), false)
			end

			for iter_52_1 = 1, var_3:GetLevel() do
				var_1_10014 = var_52_0
				var_1_10014 = var_52_0.Find(var_1_10014, "Slots")

				local var_52_17 = var_12.GetChild(var_1_10014, iter_52_1 - 1)
				local var_52_18 = arg_52_0._parentClass.loader

				var_13.GetSpriteQuiet(var_52_18, arg_52_0.bundleName, "slot_NULL", var_52_17:Find("Image"))
			end

			goto label_52_0

			local var_52_19 = var_3:GetRingElement(var_52_10)

			AtelierFormulaCircle = var_52_11
			var_52_11 = var_52_11.ELEMENT_NAME[var_52_19]

			local var_52_20 = var_3:GetType()

			AtelierFormulaCircle = var_11

			if var_52_20 == var_11.TYPE.ANY then
				setActive = var_52_20
				var_1_10014 = var_52_0

				var_52_20(var_52_0.Find(var_1_10014, "All"), false)
			else
				setActive = var_52_20
				var_1_10014 = var_52_0

				var_52_20(var_52_0.Find(var_1_10014, "Icon"), false)
			end

			setActive = var_52_20

			var_52_20(var_52_12, true)

			local var_52_21
			local var_52_22 = var_3:GetType()

			AtelierFormulaCircle = var_12

			if var_52_22 ~= var_12.TYPE.BASE then
				var_52_22 = var_3:GetType()
				AtelierFormulaCircle = var_12

				if var_52_22 == var_12.TYPE.SAIREN then
					var_52_21 = var_52_10:GetBaseCircleTransform()
				else
					var_52_21 = var_52_10:GetNormalCircleTransform()
				end

				setLocalScale = var_52_22

				do
					local var_52_23 = var_52_12

					Vector3 = var_1_10014

					local var_52_24 = var_1_10014.New

					unpack = var_1_10016

					var_52_22(var_52_23, var_52_24(var_1_10016(var_52_21, 1, 3)))

					setAnchoredPosition = var_52_22

					local var_52_25 = var_52_12

					Vector2 = var_14

					local var_52_26 = var_14.New

					unpack = var_16

					var_52_22(var_52_25, var_52_26(var_16(var_52_21, 4, 5)))

					local var_52_27 = arg_52_0._parentClass.loader

					var_11.GetSpriteQuiet(var_52_27, var_52_10:GetIconPath(), "", var_52_12, true)
					...
					var_11(var_52_0:Find("Name/Rect/Text"), var_52_10:GetName())

					for iter_52_2 = 1, var_3:GetLevel() do
						local var_52_28 = var_52_0:Find("Slots")
						local var_52_29 = var_15.GetChild(var_52_28, iter_52_2 - 1)
						local var_52_30 = arg_52_0._parentClass.loader

						var_16.GetSpriteQuiet(var_52_30, arg_52_0.bundleName, "slot_" .. var_52_11, var_52_29:Find("Image"))
					end
				end

				::label_52_0::

				local var_52_31 = var_52_0:Find("Ring")

				setImageColor = var_52_11

				local var_52_32 = var_52_31
				local var_52_33 = var_3

				var_52_11(var_52_32, var_3.GetElementRingColor(var_52_33, var_52_10))

				if arg_52_1.Change then
					local var_52_34 = arg_52_1.Data
					local var_52_35 = var_9.GetRingElement(var_52_34, var_52_10)

					if var_52_4 then
						var_52_35 = nil
					end

					if arg_52_0.ringEffect[var_52_35] then
						local var_52_36 = arg_52_1.Data
						local var_52_37 = var_10.GetType(var_52_36)

						AtelierFormulaCircle = var_52_34

						local var_52_38 = var_52_37 == var_52_34.TYPE.BASE and "_o" or "_6"
						local var_52_39 = arg_52_0._parentClass.loader

						var_11.GetPrefab(var_52_39, "ui/" .. arg_52_0.ringEffect[var_52_35] .. var_52_38, "", function(arg_53_0)
							setParent = var_2_10001

							var_2_10001(arg_53_0, var_52_31)
							...
							var_2_10001(var_53_0, var_4.zero)

							return
						end, var_52_31)
					else
						local var_52_40 = arg_52_0._parentClass.loader

						var_10.ClearRequest(var_52_40, var_52_31)
					end
				...
				if arg_52_1.ChangeInstance then
					if var_52_10 then
						local var_52_41 = arg_52_0._parentClass.loader

						var_9.GetPrefab(var_52_41, "ui/" .. arg_52_0.deployEffect, "", function(arg_54_0)
							setParent = var_2_10001
							...
							var_2_10001(var_54_0, var_4.zero)

							return
						end, var_52_0)
					else
						local var_52_42 = arg_52_0._parentClass.loader

						var_9.ClearRequest(var_52_42, var_52_0)
					end
				...
				local var_52_43 = arg_52_0
				local var_52_44 = var_52_0

				local function var_52_45()
					if var_52_4 then
						return
					end
				...
				var_9(var_52_43, var_52_44, var_52_45, var_52_33)
...
function var_0_1.InitNodeLayer(arg_60_0)
	...
	for iter_60_0, iter_60_1 in var_1(arg_60_0.nodeList) do
		...
		AtelierFormulaCircle = var_1_10008

		if var_60_1 ~= var_1_10008.TYPE.BASE then
			AtelierFormulaCircle = var_1_10008

			if var_60_1 == var_1_10008.TYPE.SAIREN then
				var_1_10008 = arg_60_0.nodeLayer
				...
				var_1_10008[1] = var_60_2
				table = var_1_10008

				var_1_10008.insert(arg_60_0.nodeLayer[1], iter_60_0)
			else
				var_1_10008 = arg_60_0.nodeLayer
				...
				var_1_10008[2] = var_60_3
				table = var_1_10008

				var_1_10008.insert(arg_60_0.nodeLayer[2], iter_60_0)
			end
		end
	end
...
function var_0_1.SetCirclePanel(arg_61_0)
	...
	local var_61_3 = var_1_10005.cos(var_61_1)

	math = var_1_10006

	local var_61_4 = var_61_0 * var_61_2(var_61_3, var_1_10006.sin(var_61_1))

	Vector2 = var_1_10004
	arg_61_0.axisY = var_61_0 * var_1_10004(0, 1)
	...
	var_61_6(var_61_5, var_61_7, var_7.zero)
	...
	var_61_6(var_61_8, (var_61_9 + var_7.New(var_61_0, var_61_0)) * 2)
...
function var_0_1.SetCirclePosition(arg_62_0, arg_62_1, arg_62_2)
	...
	var_4.each(var_62_1, function(arg_63_0)
		...
		Vector2 = var_8
		var_63_6.viewMax = var_8.Max(arg_62_0.viewMax, -var_63_4)
...
function var_0_1.RefreshNodeLinks(arg_65_0, arg_65_1)
	...
	for iter_65_0 = 1, 6 do
		...
		var_1_10007(var_9.GetChild(var_65_1, iter_65_0 - 1), false)
	end
	...
	var_4.each(var_65_2:GetNeighbors(), function(arg_66_0)
		...
		local var_66_1 = var_3.Find(var_66_0, "Links")

		var_2_10001(var_3.GetChild(var_66_1, arg_66_0[1] - 1), true)
...
function var_0_1.RefreshNodeLinkEffects(arg_67_0, arg_67_1, arg_67_2, arg_67_3)
	...
	var_1_10004.Foreach(arg_67_2.links, function(arg_68_0, arg_68_1)
		...
		var_4.GetPrefab(var_68_3, "ui/" .. var_68_2, "", function(arg_69_0)
			...
			var_3_10001(var_69_0, var_4.Find(var_69_1, "Link"))
			...
			var_3_10001(var_69_2, var_4.New(0, -15))
