...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.CrusingWindowLayer"))
...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_3.Find(var_2_0, "panel"), arg_2_0.windowSprite, true)
	...
	local var_2_4 = var_3.Find(var_2_3, "Text")

	i18n = var_4

	var_1(var_2_4, var_4("cruise_tip_skin"))
	...
	local var_2_8 = var_2_7(var_2_6, var_4.ACTIVITY_TYPE_PT_CRUSING)

	pg = var_1_10002

	local var_2_9

	if not var_1_10002.battlepass_event_pt[var_2_8.id].equip_skin then
		var_2_9 = {}
	end
	...
	arg_2_0.itemList = var_2_10(var_2_11, var_6.GetChild(var_2_12, 0))
	...
	var_3.make(var_2_13, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			var_2_10004(arg_3_2:Find("IconTpl"), var_3_0)
			...
			var_2_10004(var_3_1, var_3_2, var_3_3, var_9)
		end
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_6()
		...
		var_7_1(var_7_0, var_2_10003.GO_CRUSING)
