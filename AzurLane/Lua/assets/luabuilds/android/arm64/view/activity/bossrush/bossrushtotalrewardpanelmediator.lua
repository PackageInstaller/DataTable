...
local var_0_0 = "BossRushTotalRewardPanelMediator"

import = var_0_10003

local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.worldboss.ActivityBossTotalRewardPanelMediator"))

var_0_1.ON_WILL_EXIT = "BossRushTotalRewardPanelMediator:ON_WILL_EXIT"
var_0_1.GET_NEW_SHIP = "BossRushTotalRewardPanelMediator:GET_NEW_SHIP"
