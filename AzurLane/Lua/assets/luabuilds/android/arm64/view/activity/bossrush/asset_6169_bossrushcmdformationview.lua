...
function var_0_1.init(arg_2_0)
	...
	local var_2_7 = var_3.Find(var_2_6, "atttr_panel/abilitys/mask/content")
	local var_2_8 = arg_2_0.descFrameTF

	arg_2_0.abilitysTF = var_2_5(var_2_7, var_4.Find(var_2_8, "atttr_panel/abilitys/mask/content/attr"))
	UIItemList = var_1

	local var_2_9 = var_1.New
	local var_2_10 = arg_2_0.descFrameTF
	local var_2_11 = var_3.Find(var_2_10, "atttr_panel/talents/mask/content")
	local var_2_12 = arg_2_0.descFrameTF

	arg_2_0.talentsTF = var_2_9(var_2_11, var_4.Find(var_2_12, "atttr_panel/talents/mask/content/attr"))
	...
	local var_2_26 = var_3.Find(var_2_25, "record/content")
	local var_2_27 = arg_2_0.recordPanel

	arg_2_0.recordList = var_2_24(var_2_26, var_4.Find(var_2_27, "record/content/commanders"))
	onButton = var_1
	...
	local function var_2_30()
		...
		var_3_1.type = var_2_10003.COMMANDER_OP_REST_ALL
	...
	var_1(var_2_28, var_2_29, var_2_30, var_2_27)
	...
	var_1(var_2_31, var_2_32, var_2_33, var_2_27)

	onButton = var_1

	local var_2_34 = arg_2_0
	local var_2_35 = arg_2_0.recordPanel
	local var_2_36 = var_4.Find(var_2_35, "back")
	...
	var_1(var_2_34, var_2_36, var_2_37, var_2_35)

	onButton = var_1

	local var_2_38 = arg_2_0
	local var_2_39 = arg_2_0._tf
	local var_2_40 = var_4.Find(var_2_39, "bg")
	...
	var_1(var_2_38, var_2_40, var_2_41, var_2_39)
...
function var_0_1.updateRecordFleet(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10002(arg_12_0.recordCommanders) do
...
function var_0_1.UpdatePrefabFleet(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	local var_15_1 = arg_15_2.Find(var_15_0, "fleet_name")
	local var_15_2 = arg_15_1:getName()

	onInputEndEdit = var_15_0

	var_15_0(arg_15_0, var_15_1, function()
		getInputText = var_2_10000

		local var_16_0 = var_2_10000(var_15_1)
		local var_16_1 = arg_15_0.callback
		local var_16_2 = {}

		LevelUIConst = var_2_10004
		var_16_2.type = var_2_10004.COMMANDER_OP_RENAME
	...
	local var_15_5 = arg_15_2.Find(var_15_4, "use_btn")
	...
	local function var_15_6()
		...
		LevelUIConst = var_2_10003
		var_18_1.type = var_2_10003.COMMANDER_OP_USE_PREFAB
	...
	var_15_0(var_15_3, var_15_5, var_15_6, var_15_4)

	onButton = var_15_0

	local var_15_7 = arg_15_0
	local var_15_8 = arg_15_2
	local var_15_9 = arg_15_2.Find(var_15_8, "record_btn")
	...
	local function var_15_10()
		...
		LevelUIConst = var_2_10003
		var_19_1.type = var_2_10003.COMMANDER_OP_RECORD_PREFAB
	...
	var_15_0(var_15_7, var_15_9, var_15_10, var_15_8)
	...
	for iter_15_0, iter_15_1 in var_8(var_15_11) do
		local var_15_13 = arg_15_1:getCommanderByPos(iter_15_0)

		arg_15_0:updateCommander(iter_15_1, iter_15_0, var_15_13)
		arg_15_0:updateSkillTF(var_15_13, var_15_12[iter_15_0])
	end
...
function var_0_1.updateDesc(arg_20_0)
	...
	CommanderConst = var_20_0

	for iter_20_0 = var_20_2, var_20_0.MAX_FORMATION_POS do
...
function var_0_1.updateAdditions(arg_21_0)
	...
	var_5.make(var_21_4, function(arg_22_0, arg_22_1, arg_22_2)
		...
		if arg_22_0 == var_2_10003.EventUpdate then
			...
			local var_22_1 = arg_22_2:Find("name")

			AttributeType = var_2_10007

			var_4(var_22_1, var_2_10007.Type2Name(var_22_0.attrName))

			setText = var_4

			local var_22_2 = arg_22_2:Find("Text")

			string = var_7

			var_4(var_22_2, var_7.format("%0.3f", var_22_0.value) .. "%")
	...
	var_5.make(var_21_6, function(arg_23_0, arg_23_1, arg_23_2)
		...
		if arg_23_0 == var_2_10003.EventUpdate then
			...
			var_4(var_2_10006(arg_23_2, "name_mask/name"), var_23_0.name)

			local var_23_1 = var_23_0.type

			CommanderConst = var_2_10005

			local var_23_2 = var_23_1 == var_2_10005.TALENT_ADDITION_RATIO and "%" or ""
...
function var_0_1.updateSkillTF(arg_24_0, arg_24_1, arg_24_2)
	...
	if arg_24_1 then
		var_1_10003 = arg_24_1:getSkills()[1]
		GetImageSpriteFromAtlasAsync = var_1_10004

		var_1_10004("CommanderSkillIcon/" .. var_1_10003:getConfig("icon"), "", arg_24_2:Find("icon"))

		setText = var_1_10004

		var_1_10004(arg_24_2:Find("level"), "Lv." .. var_1_10003:getLevel())
		...
		local function var_24_2()
			...
			LevelUIConst = var_2_10003
			var_25_1.type = var_2_10003.COMMANDER_OP_SHOW_SKILL
		...
		var_1_10004(var_24_0, var_24_1, var_24_2, var_9)
	else
...
function var_0_1.updateCommander(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
	...
	local var_26_1 = arg_26_1.Find(var_26_0, "add")
	local var_26_2 = arg_26_1:Find("info")

	if arg_26_3 then
		local var_26_3 = arg_26_1

		var_26_0 = arg_26_1.Find(var_26_3, "info/mask/icon")

		local var_26_4 = arg_26_1
		local var_26_5 = arg_26_1.Find(var_26_4, "info/frame")

		GetImageSpriteFromAtlasAsync = var_26_3

		var_26_3("CommanderHrz/" .. arg_26_3:getPainting(), "", var_26_0)

		local var_26_6 = arg_26_1

		if arg_26_1.Find(var_26_6, "info/name") then
			setText = var_26_4

			var_26_4(var_9, arg_26_3:getName())
		end

		Commander = var_26_4

		local var_26_7 = var_26_4.rarity2Frame
		local var_26_8 = arg_26_3
		local var_26_9 = var_26_7(arg_26_3.getRarity(var_26_8))

		setImageSprite = var_26_6

		local var_26_10 = var_26_5

		GetSpriteFromAtlas = var_26_8

		var_26_6(var_26_10, var_26_8("weaponframes", "commander_" .. var_26_9))
	end
	...
	if arg_26_4 then
		...
		local function var_26_13()
			...
			LevelUIConst = var_2_10003
			var_27_1.type = var_2_10003.COMMANDER_OP_ADD
		...
		var_26_0(var_26_11, var_26_12, var_26_13, var_1_10012)
		...
		local function var_26_16()
			...
			LevelUIConst = var_2_10003
			var_28_1.type = var_2_10003.COMMANDER_OP_ADD
		...
		var_26_0(var_26_14, var_26_15, var_26_16, var_1_10012)
	end

	setActive = var_26_0

	var_26_0(var_26_1, not arg_26_3)

	setActive = var_26_0

	var_26_0(var_26_2, arg_26_3)
