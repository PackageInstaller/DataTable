local var_0_0 = class("RyzaPtRePage", import("view.activity.CorePage.CorePtTemplatePage"))
local var_0_1 = 9
...
function var_0_0.OnDestroy(arg_20_0)
	if isActive(arg_20_0.clickMask) then
		setActive(arg_20_0.clickMask, false)
		pg.UIMgr.GetInstance():UnOverlayPanel(arg_20_0.clickMask, arg_20_0.bg)
	end
