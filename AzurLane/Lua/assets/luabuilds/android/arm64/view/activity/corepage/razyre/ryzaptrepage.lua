...
function var_0_1.OnDestroy(arg_20_0)
	...
	if var_1_10001(arg_20_0.clickMask) then
		setActive = var_1

		var_1(arg_20_0.clickMask, false)

		pg = var_1

		local var_20_0 = var_1.UIMgr.GetInstance()

		var_1.UnOverlayPanel(var_20_0, arg_20_0.clickMask, arg_20_0.bg)
	end
