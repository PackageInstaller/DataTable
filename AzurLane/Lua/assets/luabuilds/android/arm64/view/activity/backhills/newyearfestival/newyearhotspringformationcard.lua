...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_16 = var_4.Find(var_1_15, "front/stars")
	local var_1_17 = arg_1_0.content

	arg_1_0.UIlist = var_1_14(var_1_16, var_5.Find(var_1_17, "front/stars/star_tpl"))
...
function var_0_0.flush(arg_3_0)
	...
	local var_3_6 = arg_3_0.shipVO
	local var_3_7 = var_4.rarity2bgPrint(var_3_6)

	GetImageSpriteFromAtlasAsync = var_3_2

	var_3_2("bg/star_level_card_" .. var_3_7, "", arg_3_0.bgImage)

	local var_3_8 = var_3_0
	local var_3_9, var_3_10 = var_3_0.GetFrameAndEffect(var_3_8, true)

	setRectShipCardFrame = var_3_8

	var_3_8(arg_3_0.frame, var_3_7, var_3_9)

	setFrameEffect = var_3_8

	var_3_8(arg_3_0.otherBg, var_3_10)

	local var_3_11 = arg_3_0.shipVO
	local var_3_12 = var_7.getShipType(var_3_11)

	setImageSprite = var_8

	local var_3_13 = arg_3_0.shipType

	GetSpriteFromAtlas = var_11

	local var_3_14 = "shiptype"

	shipType2print = var_1_10014

	var_8(var_3_13, var_11(var_3_14, var_1_10014(var_3_12)))
