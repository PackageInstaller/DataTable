...
function var_0_1.OnDataSetting(arg_3_0)
	...
	local var_3_4 = var_1_10005.TimeMgr.GetInstance()

	arg_3_0.dayFromStart = var_3_2(var_3_1, var_3_3, var_5.GetServerTime(var_3_4)) + 1
	math = var_1
	...
	if var_1.getConfig(var_3_5, "config_client") then
		...
		if var_1_10002(var_1) == "table" and var_1.story then
			ipairs = var_3_5

			for iter_3_0, iter_3_1 in var_3_5(var_1_10002) do
				if iter_3_1[1] then
	...
	local var_3_6 = var_4(arg_3_0.isAchieved)

	tostring = var_5

	local var_3_7 = var_5(arg_3_0.playCount)

	tostring = var_6

	var_1_10002(var_3_6, var_3_7, var_6(arg_3_0.curDay))
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local function var_4_5()
		if arg_4_0.curDay >= arg_4_0.maxDay and arg_4_0.playCount >= arg_4_0.maxDay and not (arg_4_0.isAchieved > 0) then
			...
			var_6_1(var_6_0, var_2_10003.EVENT_OPERATION, {
				cmd = 1,
	...
	local function var_4_8()
		...
		var_7_1(var_7_0, var_2_10003.GO_MINI_GAME, var_0_1.GO_MINI_GAME_ID, {})
	...
	local var_4_10 = var_3.NewStoryMgr.GetInstance()

	math = var_4_6

	local var_4_11 = var_4_6.clamp(arg_4_0.playCount, 0, arg_4_0.maxDay)
...
function var_0_1.OnUpdateFlush(arg_10_0)
	...
	Shrine2022View = var_4

	var_1_10001(var_10_0, var_4.IsNeedShowTipForShipCount())
