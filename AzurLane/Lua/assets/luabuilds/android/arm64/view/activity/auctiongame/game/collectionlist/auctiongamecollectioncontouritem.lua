...
function var_0_1.Init(arg_2_0)
	...
	local function var_2_2()
		...
		var_3_1(var_3_0, var_2_10003.ON_SWITCH_CONTOUR, arg_2_0.contourData)
...
function var_0_1.didEnter(arg_4_0, arg_4_1, arg_4_2)
	...
	if arg_4_1 == 0 then
		...
		var_3(var_4_0, var_1_10006("auction_game_rarity_0"))
	else
		setText = var_3
		...
		var_3(var_4_1, var_1_10006.format("%s×%s", arg_4_2, arg_4_1))
	end
