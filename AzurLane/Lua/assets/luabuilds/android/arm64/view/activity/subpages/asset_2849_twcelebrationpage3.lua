...
function var_0_1.OnUpdateFlush(arg_3_0)
	...
	var_3_4(arg_3_0.share, var_3_3 and not var_3_5)

	setActive = var_3_4

	var_3_4(arg_3_0.finished, var_3_3 and var_3_5)

	setActive = var_3_4

	var_3_4(arg_3_0.unfinished, var_3_3 and not var_3_5)
...
function var_0_1.initShare(arg_7_0)
	...
	var_1.GetUI(var_7_0, "TWCelebrationShare", false, function(arg_8_0)
		...
		local var_8_2 = var_8_1(var_8_0, var_2_10004(var_2_10006)).transform
		local var_8_3 = var_2.GetChild(var_8_2, 0)

		SetParent = var_8_0

		var_8_0(arg_8_0, var_8_3, false)
