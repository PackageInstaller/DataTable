...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.battle.PreCombatLayer"))
...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_5, var_4("multiple_sorties_title"))

	setText = var_1

	local var_2_6 = arg_2_0._continuousBtn
	local var_2_7 = var_3.Find(var_2_6, "text_en")

	i18n = var_4

	var_1(var_2_7, var_4("multiple_sorties_title_eng"))

	setText = var_1

	local var_2_8 = arg_2_0._ticket
	local var_2_9 = var_3.Find(var_2_8, "title")

	i18n = var_4

	var_1(var_2_9, var_4("ex_pass_use"))

	setText = var_1

	local var_2_10 = arg_2_0._bonus
	local var_2_11 = var_3.Find(var_2_10, "title")

	i18n = var_4

	var_1(var_2_11, var_4("expedition_extra_drop_tip"))
...
function var_0_1.Register(arg_3_0)
	...
	var_1.AddHeroInfoModify(var_3_1, function(arg_5_0, arg_5_1)
		...
		local var_5_1 = var_2_10003(var_5_0, "stars")
		...
		if var_5_3 then
			...
			var_5_6, var_5_7 = arg_5_1.getEnergyPrint(var_5_5)
			GetSpriteFromAtlas = var_5_5

			if not var_5_5("energy", var_5_6) then
				warning = var_2_10009
			...
			var_2_10009(var_5_4, var_5_5)
		end

		local var_5_8 = arg_3_0.contextData.system

		pg = var_5_7

		local var_5_9 = var_5_7.battle_cost_template[var_5_8]

		setActive = var_5_5

		var_5_5(var_5_4, var_5_3 and var_5_9.enter_energy_cost > 0)

		local var_5_10 = arg_5_1:getStar()
		...
		local var_5_11 = "shiptype"

		shipType2print = iter_5_0

		if not var_9(var_5_11, iter_5_0(arg_5_1:getShipType())) then
			warning = var_10

			var_10("找不到船形, shipConfigId: " .. arg_5_1.configId)
		end

		setImageSprite = var_10
		findTF = var_12

		var_10(var_12(var_5_0, "type"), var_9, true)

		setText = var_10
		findTF = var_12

		var_10(var_12(var_5_0, "frame/lv_contain/lv"), arg_5_1.level)

		local var_5_12 = var_5_9.ship_exp_award
		local var_5_14
		...
		if 0 < var_5_12 then
			...
			local var_5_13 = var_5_12(var_12)

			var_5_14 = var_10.getBuffShipList(var_5_13)

			local var_5_15 = arg_5_1
			local var_5_16 = var_5_14[arg_5_1.getGroupId(var_5_15)]
			local var_5_17 = var_5_0:Find("expbuff")

			setActive = var_5_15

			var_5_15(var_5_17, var_5_16 ~= nil)

			if var_5_16 then
				local var_5_18 = var_5_16 / 100
				local var_5_19 = var_5_16 % 100

				tostring = var_16

				local var_5_20 = var_16(var_5_18)
				local var_5_21
				...
				if 0 < var_5_19 then
					...
					var_5_20 = var_5_21 .. var_5_22 .. var_2_10019(var_5_19)
				end

				setText = var_5_21

				local var_5_23 = var_5_17:Find("text")

				string = var_2_10020

				var_5_21(var_5_23, var_2_10020.format("EXP +%s%%", var_5_20))
			end
		else
			local var_5_24 = var_5_0:Find("expbuff")

			setActive = var_5_14

			var_5_14(var_5_24, false)
		end
	...
	var_1.AddLongPress(var_3_2, function(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		...
		ActivityBossPreCombatMediator = var_2_10007

		var_6_1(var_6_0, var_2_10007.OPEN_SHIP_INFO, arg_6_1.id, arg_6_2)
	...
	var_1.AddShiftOnly(var_3_6, function(arg_10_0)
		...
		ActivityBossPreCombatMediator = var_2_10004

		var_10_1(var_10_0, var_2_10004.CHANGE_FLEET_SHIPS_ORDER, arg_10_0)
	...
	var_1.AddSwitchToDisplayMode(var_3_9, function()
		...
		var_0(var_2.Find(var_13_3, "save"), true)

		setActive = var_0

		local var_13_4 = arg_3_0._checkBtn

		var_0(var_2.Find(var_13_4, "edit"), false)
	...
	var_1.AddSwitchToPreviewMode(var_3_11, function()
		...
		var_0(var_2.Find(var_15_3, "save"), false)

		setActive = var_0

		local var_15_4 = arg_3_0._checkBtn

		var_0(var_2.Find(var_15_4, "edit"), true)
...
function var_0_1.SetStageID(arg_20_0, arg_20_1)
	...
	local var_20_1 = var_1_10003(var_20_0.award_display)

	checkExist = var_4
	pg = var_1_10006

	if var_4(var_1_10006.expedition_activity_template[arg_20_1], {
		"pt_drop_display"
	}) then
		type = var_5
		...
		if var_5(var_4) == "table" then
			...
			for iter_20_0 = #var_4, 1, -1 do
				if var_20_2:getActivityById(var_4[iter_20_0][1]) and not var_1_10010:isEnd() then
					...
					var_20_5[2] = var_1_10016(var_4[iter_20_0][2])

					var_20_3(var_20_4, var_1_10014, var_20_5)
				end
			end
		end
	end
	...
	if var_20_6 ~= var_6 then
		...
		for iter_20_1, iter_20_2 in var_20_6(var_20_1) do
			...
			onButton = var_12
			var_1_10014 = arg_20_0

			local var_20_8 = var_1_10010
			...
			var_12(var_1_10014, var_20_8, var_20_9, var_1_10017)
		end
	end
	...
	local function var_20_10(arg_22_0, arg_22_1)
		...
		if var_2_10002(arg_22_0) == "table" then
			...
			var_22_0 = var_22_0(var_4.ObjectiveList[arg_22_0[1]], arg_22_0[2])
			setWidgetText = var_2_10003

			var_2_10003(arg_22_1, var_22_0)
		else
			setActive = var_22_0
	...
	findTF = var_7
	var_20_11[1] = var_7(arg_20_0._goals, "goal_tpl")
	findTF = var_7
...
function var_0_1.SetFleets(arg_23_0, arg_23_1)
	...
	local var_23_1 = var_23_0(var_1_10004.values(arg_23_1), function(arg_24_0)
		local var_24_0 = arg_24_0:getFleetType()

		FleetType = var_2_10002

		return var_24_0 == var_2_10002.Normal
	end)
...
function var_0_1.UpdateFleetView(arg_29_0, arg_29_1)
	...
	local var_29_3 = var_1_10005.Vanguard
	local var_29_4 = arg_29_0._currentForm

	PreCombatLayer = var_1_10007

	var_29_2(var_29_1, var_29_3, var_29_4 ~= var_1_10007.FORM_EDIT)
	...
	PreCombatLayer = var_7

	var_29_6(var_29_5, var_29_7, var_29_8 ~= var_7.FORM_EDIT)
	...
	var_29_10(var_29_9, var_29_11, var_29_12 ~= var_7.FORM_EDIT)
...
function var_0_1.updateFleetBg(arg_30_0)
	...
	var_1_10002(var_30_2, var_30_1 == var_1_10005.Normal)
	...
	var_1_10002(var_30_3, var_30_1 == var_5.Submarine)
...
function var_0_1.resetFormationComponent(arg_31_0)
	...
	local var_31_1 = var_3.Find(var_31_0, "flag")
	local var_31_2 = arg_31_0._currentFleetVO
	local var_31_3 = var_4.getTeamByName

	TeamType = var_1_10007

	var_1_10001(var_31_1, #var_31_3(var_31_2, var_1_10007.Main) ~= 0)

	SetActive = var_1_10001

	local var_31_4 = arg_31_0._gridTFs.submarine[1]
	local var_31_5 = var_3.Find(var_31_4, "flag")
	local var_31_6 = arg_31_0._currentFleetVO
	local var_31_7 = var_4.getTeamByName

	TeamType = var_7

	var_1_10001(var_31_5, #var_31_7(var_31_6, var_7.Submarine) ~= 0)
...
function var_0_1.quickExitFunc(arg_34_0)
	...
	if var_34_0 == var_1_10002.FORM_EDIT then
		...
		ActivityBossPreCombatMediator = var_1_10004

		var_34_2(var_34_1, var_1_10004.ON_ABORT_EDIT)
	end
...
function var_0_1.didEnter(arg_35_0)
	...
	local function var_35_2()
		...
		if var_36_1 == var_2_10002.FORM_EDIT then
			...
			var_36_1.insert(var_36_0, function(arg_37_0)
				...
				i18n = var_3_10005
				var_37_2.content = var_3_10005("battle_preCombatLayer_save_confirm")

				function var_37_2.onYes()
					local var_38_0 = arg_35_0
					local var_38_1 = var_0.emit

					ActivityBossPreCombatMediator = var_4_10003

					var_38_1(var_38_0, var_4_10003.ON_COMMIT_EDIT, function()
						pg = var_5_10000
						...
						var_39_1(var_39_0, var_5_10003("battle_preCombatLayer_save_success"))
						arg_37_0()
				...
				function var_37_2.onNo()
					...
					var_40_1(var_40_0, var_4_10003.ON_ABORT_EDIT)
					arg_37_0()
		...
		var_36_1(var_36_0, function()
			...
			var_3_10000(var_41_0, var_3_10003(var_3_10005)).interactable = false
			...
			var_41_2(var_41_3, var_3_10004.Action(function()
	...
	var_1_10001(var_35_0, var_35_1, var_35_2, var_1_10006)
	...
	local function var_35_5()
		...
		if var_43_1 == var_2_10002.FORM_EDIT then
			...
			var_43_1.insert(var_43_0, function(arg_44_0)
				...
				i18n = var_3_10005
				var_44_2.content = var_3_10005("battle_preCombatLayer_save_march")
				...
				function var_44_2.onYes()
					...
					var_45_1(var_45_0, var_4_10003.ON_COMMIT_EDIT, function()
						pg = var_5_10000
						...
						var_46_1(var_46_0, var_5_10003("battle_preCombatLayer_save_success"))
						arg_44_0()
		...
		var_43_1(var_43_0, function()
			...
			var_47_1(var_47_0, var_3_10003.ON_START, arg_35_0._currentFleetVO.id)
	...
	var_1_10001(var_35_3, var_35_4, var_35_5, var_1_10006)
	...
	local function var_35_8()
		...
		if var_48_0 == var_2_10001.FORM_EDIT then
			local var_48_1 = arg_35_0
			local var_48_2 = var_0.emit

			ActivityBossPreCombatMediator = var_2_10003

			var_48_2(var_48_1, var_2_10003.ON_COMMIT_EDIT, function()
				pg = var_3_10000
				...
				var_49_1(var_49_0, var_3_10003("battle_preCombatLayer_save_success"))
			...
			PreCombatLayer = var_1

			if var_48_3 == var_1.FORM_PREVIEW then
	...
	var_1_10001(var_35_6, var_35_7, var_35_8, var_1_10006)
	...
	local var_35_9 = arg_35_0._currentForm

	PreCombatLayer = var_2

	if var_35_9 == var_2.FORM_EDIT then
		local var_35_10 = arg_35_0._formationLogic

		var_35_9.SwitchToDisplayMode(var_35_10)
	else
		local var_35_11 = arg_35_0._formationLogic

		var_35_9.SwitchToPreviewMode(var_35_11)
	end

	pg = var_35_9

	local var_35_12 = var_35_9.UIMgr.GetInstance()

	var_1.BlurPanel(var_35_12, arg_35_0._tf)
	...
	local var_35_14 = arg_35_0._autoToggle

	local function var_35_15(arg_50_0)
		local var_50_0 = arg_35_0
		local var_50_1 = var_1.emit

		ActivityBossPreCombatMediator = var_2_10004

		var_50_1(var_50_0, var_2_10004.ON_AUTO, {
			isOn = not arg_50_0,
		...
		if arg_50_0 and arg_35_0._subUseable == true then
			...
			local function var_50_4(arg_51_0)
				...
				ActivityBossPreCombatMediator = var_3_10004

				var_51_1(var_51_0, var_3_10004.ON_SUB_AUTO, {
					isOn = not arg_51_0,
			...
			var_50_1(var_50_2, var_50_3, var_50_4, var_6, var_2_10007)
	...
	var_1(var_35_13, var_35_14, var_35_15, var_1_10006, var_1_10007)

	triggerToggle = var_1

	local var_35_16 = arg_35_0._autoToggle

	ys = var_35_14

	var_1(var_35_16, var_35_14.Battle.BattleState.IsAutoBotActive())
	...
	local var_35_17 = arg_35_0.contextData.stageId

	getProxy = var_2
	ActivityProxy = var_4

	local var_35_18 = var_2(var_4)
	local var_35_19 = var_2.getActivityById(var_35_18, arg_35_0.contextData.actId)

	setActive = var_3

	local var_35_20 = arg_35_0._continuousBtn
	local var_35_21 = arg_35_0.contextData.system

	SYSTEM_ACT_BOSS = var_1_10007

	var_3(var_35_20, var_35_21 == var_1_10007)
	...
	if var_35_19 then
		...
		var_35_20 = var_35_19
		var_35_22 = var_35_19.IsOilLimit(var_35_20, var_35_17)
	end

	setActive = var_35_18

	local var_35_23 = arg_35_0._continuousBtn

	var_35_18(var_6.Find(var_35_23, "lock"), not var_35_22)

	if var_35_22 then
		Color = var_35_18

		if not var_35_18.white then
			Color = var_35_18
			var_35_18 = var_35_18.New(0.2980392156862745, 0.2980392156862745, 0.2980392156862745)
		end

		setImageColor = var_35_20

		var_35_20(arg_35_0._continuousBtn, var_35_18)

		setTextColor = var_35_20

		local var_35_24 = arg_35_0._continuousBtn

		var_35_20(var_7.Find(var_35_24, "text"), var_35_18)

		setTextColor = var_35_20

		local var_35_25 = arg_35_0._continuousBtn

		var_35_20(var_7.Find(var_35_25, "text_en"), var_35_18)

		onButton = var_35_20

		local var_35_26 = arg_35_0
		local var_35_27 = arg_35_0._continuousBtn

		local function var_35_28()
			local var_53_1
			...
			if var_35_22 then
				...
				var_53_1(var_53_0, var_2_10003.SHOW_CONTINUOUS_OPERATION_WINDOW, arg_35_0._currentFleetVO.id)
			else
				pg = var_53_1
				...
				var_53_3(var_53_2, var_2_10003("multiple_sorties_locked_tip"))
			end
		...
		var_35_20(var_35_26, var_35_27, var_35_28, var_10)
...
function var_0_1.displayFleetInfo(arg_54_0)
	...
	var_1_10002(arg_54_0._costContainer, true)
	...
	var_54_2(arg_54_0._bonus, var_54_4 > 0)

	setActive = var_54_2

	var_54_2(arg_54_0._ticket, var_54_4 <= 0)

	setText = var_54_2

	local var_54_5 = arg_54_0._bonus

	var_54_2(var_7.Find(var_54_5, "Text"), var_54_4)

	local var_54_6, var_54_17
	...
	if var_54_4 <= 0 then
		...
		local var_54_9 = var_54_3(var_54_6, "")

		setImageSprite = var_54_8

		local var_54_10 = arg_54_0._ticket

		var_54_8(var_9.Find(var_54_10, "icon"), var_54_9)

		getProxy = var_54_8
		PlayerProxy = var_9

		local var_54_11 = var_54_8(var_9)
		local var_54_12 = var_7.getRawData(var_54_11)
		local var_54_13 = var_7.getResource(var_54_12, arg_54_0._ticketItemID)
		local var_54_14 = 1
		local var_54_15 = arg_54_0._ticket
		local var_54_16 = var_9.Find(var_54_15, "checkbox")

		SYSTEM_BOSS_EXPERIMENT = var_54_17

		if var_54_0 == var_54_17 then
			var_54_14 = 0
			triggerToggle = var_54_17

			var_54_17(var_54_16, false)

			setToggleEnabled = var_54_17

			var_54_17(var_54_16, false)
		else
			SYSTEM_HP_SHARE_ACT_BOSS = var_54_17

			if var_54_0 == var_54_17 then
				triggerToggle = var_54_17

				var_54_17(var_54_16, true)

				setToggleEnabled = var_54_17

				var_54_17(var_54_16, false)
			else
				SYSTEM_ACT_BOSS_SP = var_54_17

				if var_54_0 == var_54_17 then
					setActive = var_54_17

					var_54_17(arg_54_0._ticket, false)
				else
					SYSTEM_ACT_BOSS = var_54_17

					if var_54_0 == var_54_17 then
						var_54_17 = 0 < var_54_13
						getProxy = var_54_15
						SettingsProxy = var_1_10013
						var_1_10013 = var_54_15(var_1_10013)

						local var_54_18 = var_11.isTipActBossExchangeTicket(var_1_10013) == 1

						setToggleEnabled = var_12

						var_12(var_54_16, var_54_17)

						triggerToggle = var_12

						var_12(var_54_16, var_54_17 and var_54_18)
					end
				end
			end
		end
		...
		if var_54_13 < var_54_14 then
			setColorStr = var_54_17

			local var_54_19 = var_54_13

			COLOR_RED = var_1_10013
			var_54_13 = var_54_17(var_54_19, var_1_10013) or var_54_13
		end

		setText = var_54_17

		local var_54_20 = arg_54_0._ticket

		var_54_17(var_12.Find(var_54_20, "Text"), var_54_14 .. "/" .. var_54_13)

		onToggle = var_54_17

		local var_54_21 = arg_54_0
		local var_54_22 = var_54_16

		local function var_54_23(arg_55_0)
			getProxy = var_2_10001
			SettingsProxy = var_2_10003

			local var_55_0 = var_2_10001(var_2_10003)
		...
		var_54_17(var_54_21, var_54_22, var_54_23, var_15, var_1_10016)
	end

	pg = var_54_6

	local var_54_24 = var_54_6.battle_cost_template[var_54_0].oil_cost > 0
	local var_54_25 = 0
	local var_54_26 = 0
	local var_54_27 = false

	ipairs = var_54_17

	for iter_54_0, iter_54_1 in var_54_17({
		arg_54_0.contextData.fleets[1]
	}) do
		local var_54_28 = iter_54_1:GetCostSum().oil

		if not var_54_24 then
			var_54_28 = 0
		end

		var_54_26 = var_54_26 + var_54_28

		local var_54_29 = iter_54_0 == 1
		local var_54_30 = arg_54_0.contextData.costLimit[var_54_29 and 1 or 2]

		if 0 < var_54_30 then
			var_54_27 = var_54_27 or var_54_30 < var_54_28
			math = var_18
			var_54_28 = var_18.min(var_54_28, var_54_30)
		end

		var_54_25 = var_54_25 + var_54_28
	end

	setTextColor = var_10

	local var_54_31 = arg_54_0._costText

	if var_54_27 then
		Color = iter_54_0

		if not iter_54_0(0.9803921568627451, 0.39215686274509803, 0.39215686274509803) then
			Color = iter_54_0
			iter_54_0 = iter_54_0.white
		end

		var_10(var_54_31, iter_54_0)
		var_0_2.tweenNumText(arg_54_0._costText, var_54_25)

		setActive = var_10

		var_10(arg_54_0._costTip, var_54_27)
		...
		if var_54_27 then
			...
			var_10(arg_54_0, arg_54_0._costTip, function()
				...
				i18n = var_2_10004
				var_56_2.content = var_2_10004("use_oil_limit_help", var_54_26, var_54_25)
		...
		local var_54_32 = arg_54_0._fleetNameText

		Fleet = var_13

		var_10(var_54_32, var_13.DEFAULT_NAME_BOSS_ACT[arg_54_0._currentFleetVO.id])
