...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_2_0, var_4("island_sign_text"))
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	var_1.make(var_7_0, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventInit then
			...
			if var_8_0 < 7 then
				var_8_3 = arg_8_2:Find("item")
				updateDrop = var_7

				var_7(var_8_3, var_8_2)
			end
			...
			var_8_3(var_8_4, var_8_5, var_8_6, var_2_10011)
		end
	...
	local var_7_2 = arg_7_0:GetCanReceiveTaskList()

	setActive = var_1_10002

	local var_7_3 = arg_7_0.uiGoBtn

	var_1_10002(var_4.Find(var_7_3, "tip"), #var_7_2 > 0)

	onButton = var_1_10002

	local var_7_4 = arg_7_0
	local var_7_5 = arg_7_0.uiGoBtn
	...
	local function var_7_6()
		...
		var_0.ExecuteAction(var_11_1, "Show", true, function()
			...
			if #var_0.GetCanReceiveTaskList(var_12_0) > 0 then
				...
				var_12_2(var_12_1, var_3_10004.ON_ACTIVITY_TASK_LIST_SUBMIT, {
	...
	var_1_10002(var_7_4, var_7_5, var_7_6, var_7)

	PlayerPrefs = var_1_10002

	var_1_10002.SetString("IslandSignPage", var_0_1.GetDate())
...
function var_0_1.OnUpdateFlush(arg_13_0)
	...
	local var_13_2 = arg_13_0:GetCanReceiveTaskList()

	setActive = var_1_10002

	local var_13_3 = arg_13_0.uiGoBtn

	var_1_10002(var_4.Find(var_13_3, "tip"), #var_13_2 > 0)
...
function var_0_1.GetDate()
	...
	local var_14_2 = var_1_10003.TimeMgr.GetInstance()

	return var_14_1(var_14_0, var_3.GetServerTime(var_14_2), "%Y/%m/%d")
end
...
function var_0_1.IsShowAwardRed()
	...
	local var_17_2 = var_17_1(var_17_0, var_1_10003.ISLAND_SIGN_ID)

	_ = var_1_10001

	return var_1_10001.any(var_17_2, function(arg_18_0)
...
function var_0_1.GetCanReceiveTaskList(arg_19_0)
	...
	local var_19_2 = var_19_1(var_19_0, var_1_10004.ISLAND_SIGN_ID)
	local var_19_3 = {}
