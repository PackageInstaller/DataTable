...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	var_1_10003.insert(var_2_0, function(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10004.GET_NEW_SERVER_SHOP, {
...
function var_0_1.setData(arg_6_0)
	...
	local var_6_2 = var_6_1(var_6_0, var_1_10005.ACTIVITY_TYPE_NEWSERVER_TASK)
	local var_6_3 = var_1
	local var_6_4 = var_1.getActivityByType

	ActivityConst = var_1_10006

	local var_6_5 = var_6_4(var_6_3, var_1_10006.ACTIVITY_TYPE_NEWSERVER_SHOP)
	local var_6_6 = var_1
	local var_6_7 = var_1.getActivityByType

	ActivityConst = var_1_10007

	local var_6_8 = var_6_7(var_6_6, var_1_10007.ACTIVITY_TYPE_NEWSERVER_GIFT)
	local var_6_9
...
function var_0_1.didEnter(arg_8_0)
	...
	local function var_8_5()
		...
		pg = var_2_10004
		var_10_2.helps = var_2_10004.gametip.newserver_activity_tip.tip
	...
	local var_8_8 = var_4.Find(var_8_7, "gem/add_btn")
...
function var_0_1.updateTips(arg_16_0)
	if arg_16_0.taskActivity then
		...
		var_1(var_16_1, var_4.isTip(var_16_2))
	end
	...
	if arg_16_0.shopActivity then
		...
		local var_16_4 = var_3.Find(var_16_3, "tip")
		local var_16_5 = arg_16_0.newServerShopPage

		var_1(var_16_4, var_4.isTip(var_16_5))
	end
	...
	if arg_16_0.giftActivity then
		...
		local var_16_7 = var_3.Find(var_16_6, "tip")
		local var_16_8 = arg_16_0.newServerGiftPage

		var_1(var_16_7, var_4.isTip(var_16_8))
	end
...
function var_0_1.updateTime(arg_18_0)
	...
	local var_18_4 = var_1_10004.floor(var_18_3 / 0)

	math = var_18_2

	local var_18_5 = var_18_2.floor((var_18_3 - var_18_4 * 0) / 16)
	...
	var_6(var_18_6, var_1_10009("newserver_time", var_18_4, var_18_5))

	setActive = var_6

	local var_18_7 = arg_18_0.timeTF

	var_6(var_8.Find(var_18_7, "title_activity"), arg_18_0.taskActivity)

	setActive = var_6

	local var_18_8 = arg_18_0.timeTF

	var_6(var_8.Find(var_18_8, "title_shop"), not arg_18_0.taskActivity)
...
function var_0_1.onUpdatePlayer(arg_20_0, arg_20_1)
	...
	local var_20_1 = var_4.Find(var_20_0, "gem/gem_value")
	local var_20_2 = arg_20_0.player

	var_1_10002(var_20_1, var_5.getTotalGem(var_20_2))
...
function var_0_1.isShow()
	...
	local var_23_2 = var_23_1(var_23_0, var_1_10004.ACTIVITY_TYPE_NEWSERVER_TASK)
	local var_23_3 = var_0
	local var_23_4 = var_0.getActivityByType

	ActivityConst = var_1_10005

	local var_23_5 = var_23_4(var_23_3, var_1_10005.ACTIVITY_TYPE_NEWSERVER_SHOP)
	local var_23_6 = var_0
	local var_23_7 = var_0.getActivityByType

	ActivityConst = var_1_10006

	local var_23_8 = var_23_7(var_23_6, var_1_10006.ACTIVITY_TYPE_NEWSERVER_GIFT)
