...
local function var_0_2(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	var_4.make(var_1_0, function(arg_2_0, arg_2_1, arg_2_2)
		...
		if arg_2_0 == var_2_10003.EventUpdate then
			...
			local var_2_6 = arg_2_2.Find(var_2_5, "award")
			...
			local function var_2_7()
				...
				var_3_1(var_3_0, var_3_10003.ON_DROP, var_2_3)
			...
			var_6(var_2_4, var_2_6, var_2_7, var_2_5)

			setActive = var_6

			local var_2_8 = arg_2_2:Find("award/mask")

			table = var_2_6

			var_6(var_2_8, var_2_6.contains(arg_1_3, var_2_1))
...
function var_0_1.Show(arg_4_0, arg_4_1)
	...
	local var_4_9 = var_1_10008("pt_count", var_4_8)

	i18n = var_4_7
	arg_4_0.cntTitle = var_4_7("pt_total_count", var_4_8)
