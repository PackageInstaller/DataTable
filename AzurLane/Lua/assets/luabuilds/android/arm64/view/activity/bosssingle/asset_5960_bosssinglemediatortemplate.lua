...
function var_0_1.BindBattleEvents(arg_2_0)
	...
	local var_2_1 = var_2_0(var_1_10003)

	getProxy = var_2
	ActivityProxy = var_1_10004

	local var_2_2 = var_2(var_1_10004)
	local var_2_3 = var_2.getActivityByType

	ActivityConst = var_1_10005

	if not var_2_3(var_2_2, var_1_10005.ACTIVITY_TYPE_BOSSSINGLE) then
		return
	end
	...
	local var_2_7 = var_2_6(var_1_10007)
	...
	var_2_12(var_2_11, var_9.EVENT_PT_OPERATION, function(arg_5_0, arg_5_1)
	...
	arg_2_0:bind(var_0_1.ON_PRECOMBAT, function(arg_6_0, arg_6_1)
		...
		if not var_2.getActivityFleets(var_6_0)[arg_2_0.contextData.activityID] then
			...
			var_6_2(var_6_1, var_2_10006("elite_disable_no_fleet"))
		...
		if var_3.isLegalToFight(var_6_4) ~= true then
			...
			var_6_6(var_6_5, var_2_10006("elite_disable_formation_unsatisfied"))
		...
		if var_6_7.any(var_6_8, function(arg_7_0)
			...
			if var_7_1 then
				...
				var_7_0.ShowTips(var_7_3, var_7_2)
			...
			return var_7_0.any(arg_7_0:getShipIds(), function(arg_8_0)
				getProxy = var_4_10001
				BayProxy = var_4_10003

				local var_8_0 = var_4_10001(var_4_10003)
				...
				local var_8_1, var_8_2 = var_4_10002.ShipStatusCheck("inActivity", var_1, nil, {
					inActivity = var_6_9
				})
		...
		local var_6_16 = var_2_10011.New
		local var_6_17 = {}

		BossSinglePreCombatMediator = var_2_10014
		var_6_17.mediator = var_2_10014
		BossSinglePreCombatLayer = var_2_10014
		var_6_17.viewComponent = var_2_10014
		var_6_17.data = {
			system = var_6_10,
			stageId = var_6_12,
	...
	arg_2_0:bind(var_0_1.ON_OPEN_DOCK, function(arg_13_0, arg_13_1)
		...
		local var_13_10 = var_2_10013.GO_SCENE

		SCENE = var_2_10014

		local var_13_11 = var_2_10014.DOCKYARD
		local var_13_12 = {
			selectedMin = 0,
			useBlackBlock = true,
			selectedMax = 1
		...
		i18n = var_2_10016
		var_13_12.leastLimitMsg = var_2_10016("ship_formationMediator_leastLimit")
		var_13_12.quitTeam = var_13_1 ~= nil
		var_13_12.teamFilter = var_13_3
		i18n = var_16
		var_13_12.leftTopInfo = var_16("word_formation")
		...
		var_13_14.__index = var_2_10020.TAG_HIDE_ACTIVITY_BOSS
		var_13_12.hideTagFlags = var_16(var_13_13, var_13_14)
		var_13_12.otherSelectedIds = var_13_2
		pg = var_16

		local var_13_15 = var_16.ShipFlagMgr.GetInstance()

		var_13_12.ignoredIds = var_16.FilterShips(var_13_15, {
			isActivityNpc = true
		})
	...
	arg_2_0:bind(var_0_1.ON_FLEET_SHIPINFO, function(arg_14_0, arg_14_1)
		...
		var_14_1(var_14_0, var_14_2, var_2_10006.SHIPINFO, {
	...
	arg_2_0:bind(var_0_1.ON_SELECT_COMMANDER, function(arg_17_0, arg_17_1, arg_17_2)
		...
		local var_17_5 = var_2_10009.GO_SCENE

		SCENE = var_2_10010

		local var_17_6 = var_2_10010.COMMANDERCAT
		local var_17_7 = {
			maxCount = 1
		}

		CommanderCatScene = var_2_10012
		var_17_7.mode = var_2_10012.MODE_SELECT
		var_17_7.activeCommander = var_17_2[arg_17_2]
		CommanderCatScene = var_12
		var_17_7.fleetType = var_12.FLEET_TYPE_BOSSSINGLE
		var_17_7.ignoredIds = {}
		...
		function var_17_7.onSelected(arg_19_0, arg_19_1)
			...
			local var_19_1 = var_3_10003(var_3_10005)
			local var_19_2 = var_3.getCommanderById(var_19_1, var_19_0)

			pairs = var_3_10005

			for iter_19_0, iter_19_1 in var_3_10005(var_0) do
				if iter_19_0 == arg_17_1 then
					...
					for iter_19_2, iter_19_3 in var_10(var_17_2) do
						if iter_19_3.groupId == var_19_2.groupId and iter_19_2 ~= arg_17_2 then
							...
							var_19_4(var_19_3, var_3_10018("commander_can_not_select_same_group"))

							return
						end
					end
				elseif iter_19_0 == var_0_1.GetPairedFleetIndex(arg_17_1) then
					local var_19_5 = iter_19_1:getCommanders()

					pairs = var_3_10011

					for iter_19_4, iter_19_5 in var_3_10011(var_19_5) do
						if var_19_0 == iter_19_5.id then
							pg = var_16
							var_3_10018 = var_16.TipsMgr.GetInstance()

							local var_19_6 = var_16.ShowTips

							i18n = var_3_10019

							var_19_6(var_3_10018, var_3_10019("commander_is_in_fleet_already"))
			...
			local var_19_7 = var_0

			var_5.updateCommanderByPos(var_19_7, arg_17_2, var_19_2)

			local var_19_8 = var_2_1

			var_5.updateActivityFleet(var_19_8, arg_2_0.contextData.activityID, arg_17_1, var_0)
			arg_19_1()
	...
	var_2_14(var_2_13, var_9.BEGIN_STAGE_PROXY, function(arg_21_0, arg_21_1)
		local var_21_0 = arg_2_0
		local var_21_1 = var_2.sendNotification

		PreCombatMediator = var_2_10005

		var_21_1(var_21_0, var_2_10005.BEGIN_STAGE_PROXY, {
			curFleetId = arg_21_1
		})
	...
	arg_2_0:bind(var_0_1.ON_PERFORM_COMBAT, function(arg_22_0, arg_22_1, arg_22_2)
		...
		local var_22_2 = var_2_10006.BEGIN_STAGE
		local var_22_3 = {}

		SYSTEM_PERFORM = var_2_10008
		var_22_3.system = var_2_10008
...
function var_0_1.GetBattleHanldDic(arg_23_0)
	...
	var_23_0[var_1_10002.BEGIN_STAGE_DONE] = function(arg_24_0, arg_24_1)
		...
		local var_24_2 = var_24_1(var_2_10005)
		local var_24_3 = var_3.getContextByMediator

		PreCombatMediator = var_2_10007

		if not var_24_3(var_24_2, var_2_10007) then
			local var_24_4 = arg_24_0
			local var_24_5 = arg_24_0.sendNotification

			GAME = var_2_10007

			local var_24_6 = var_2_10007.GO_SCENE

			SCENE = var_2_10008

			var_24_5(var_24_4, var_24_6, var_2_10008.COMBATLOAD, var_24_0)
		end
	...
	var_23_0[var_2.COMMANDER_ACTIVITY_FORMATION_OP_DONE] = function(arg_25_0, arg_25_1)
		...
		local var_25_1 = var_2_10003(var_2_10005)
		local var_25_2 = var_3.getActivityFleets(var_25_1)[var_25_0.actId]

		arg_25_0.contextData.actFleets = var_25_2

		local var_25_3 = arg_25_0.viewComponent

		var_4.updateEditPanel(var_25_3)

		local var_25_4 = arg_25_0.viewComponent

		var_4.updateCommanderFleet(var_25_4, var_25_2[var_25_0.fleetId])
	...
	var_23_0[var_2.PREFAB_FLEET_UPDATE] = function(arg_26_0, arg_26_1)
		...
		local var_26_1 = var_2_10003(var_2_10005)
		local var_26_2 = var_3.getPrefabFleet(var_26_1)
		local var_26_3 = arg_26_0.viewComponent

		var_4.setCommanderPrefabs(var_26_3, var_26_2)

		local var_26_4 = arg_26_0.viewComponent

		var_4.updateCommanderPrefab(var_26_4)
...
function var_0_1.getDockCallbackFuncs4ActicityFleet(arg_27_0, arg_27_1, arg_27_2)
	...
	local var_27_1 = var_1_10004(var_1_10006)
	...
	local var_27_4 = var_27_3(var_27_2, var_1_10008.ACTIVITY_TYPE_BOSSSINGLE)
