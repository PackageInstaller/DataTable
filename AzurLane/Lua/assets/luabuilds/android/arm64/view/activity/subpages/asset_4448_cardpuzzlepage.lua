...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_3()
		...
		var_5_1(var_5_0, var_2_10003.GO_CARDPUZZLE_COMBAT, arg_3_0.selectedId)
...
function var_0_1.UpdateItem(arg_7_0, arg_7_1, arg_7_2)
	...
	var_1_10006(arg_7_2:Find("finish"), var_7_2)

	setActive = var_1_10006

	var_1_10006(arg_7_2:Find("normal"), not var_7_2 and arg_7_0.selectedId ~= var_7_1)
	...
	var_1_10006(var_7_3, var_7_4, var_7_5, var_11)
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	if arg_9_0:CheckAward() then
		...
		local function var_9_4()
			...
			local var_10_2 = var_2_10003.EVENT_OPERATION
			local var_10_3 = {
				cmd = 2,
			...
			var_10_3.arg1 = var_5.CheckAward(var_10_4)
	...
	var_1(var_9_5, var_4(#arg_9_0.finishList, "#C2FFF3") .. "/" .. #arg_9_0.levelList)
