...
function var_0_0.OnUpdateFlush(arg_4_0)
	...
	local var_4_8 = var_4_7 >= 1 and setColorStr(var_4_5, COLOR_GREEN) or setColorStr(var_4_5, "COLOR_GREEN")

	setText(arg_4_0.progress, var_4_8 .. "/" .. setColorStr(var_4_6, "#4e2c2b"))
	...
	if arg_4_0.firstSliderInit then
		...
		local var_4_9 = GetComponent(arg_4_0.slider, typeof(Slider)).value

		LeanTween.value(go(arg_4_0.slider), arg_4_0.l1 ~= var_4_2 and 0 or arg_4_0.sliderValue, var_4_7, 1):setOnUpdate(System.Action_float(function(arg_5_0)
...
function var_0_0.initTask(arg_9_0)
	...
	local var_9_0 = pg.activity_template[arg_9_0.activity:getConfig("config_client").task_act_id].config_data[1]
	...
	for iter_9_0 = 1, #var_9_0 do
		if not pg.task_data_template[var_9_0[iter_9_0]] then
			print("task_data_template 不存在任务id : " .. tostring(var_9_0[iter_9_0]))
		end

		local var_9_1 = pg.task_data_template[var_9_0[iter_9_0]].type

		if pg.task_data_template[var_9_0[iter_9_0]].type ~= Task.TYPE_ACTIVITY then
			if var_9_1 == Task.TYPE_ACTIVITY_BRANCH then
				arg_9_0:insertTaskToGroup(var_9_0[iter_9_0], pg.task_data_template[var_9_0[iter_9_0]], (arg_9_0:getTaskGroup(var_9_1, pg.task_data_template[var_9_0[iter_9_0]].sub_type)))
			end
		end
	end
