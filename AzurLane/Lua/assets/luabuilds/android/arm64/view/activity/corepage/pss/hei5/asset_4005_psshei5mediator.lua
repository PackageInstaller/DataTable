...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10005.SUBMIT_TASK, arg_5_1.id)
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_TASK_QUICK_SUBMIT, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10005.QUICK_TASK, arg_6_1.id)
	...
	local var_1_3 = var_1_2(var_1_1, var_4.ACTIVITY_TYPE_PT_HEI5)
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_1 == var_8_0.ACTIVITY_UPDATED then
	...
	if var_8_1 == var_4.CRUSING_CMD_DONE then
		local var_8_8 = arg_8_0.viewComponent

		var_8_9 = var_8_9.emit
		BaseUI = var_1_10007

		var_8_9(var_8_8, var_1_10007.ON_ACHIEVE, var_8_2.awards)
	...
	if var_8_1 == var_8_9.CHARGE_SUCCESS then
		Goods = var_8_12
		...
		Goods = var_7
		var_8_12 = var_8_12(var_8_13, var_7.TYPE_CHARGE)
	...
	if var_8_1 ~= var_8_12.SUBMIT_TASK_DONE then
		GAME = var_4

		if var_8_1 == var_4.SUBMIT_ACTIVITY_TASK_DONE then
