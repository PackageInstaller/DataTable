...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_2 = arg_1_0.getBtn

	arg_1_0.getBtnGray = var_1.Find(var_1_2, "gray")

	local var_1_3 = arg_1_0.bg

	arg_1_0.shopBtn = var_1.Find(var_1_3, "exchange_btn")

	local var_1_4 = arg_1_0.bg

	arg_1_0.content = var_1.Find(var_1_4, "award_list/content")

	local var_1_5 = arg_1_0.bg

	arg_1_0.awardTpl = var_1.Find(var_1_5, "award")

	local var_1_6 = arg_1_0.bg

	arg_1_0.sptf = var_1.Find(var_1_6, "sp_award")

	local var_1_7 = arg_1_0.bg

	arg_1_0.spAward = var_1.Find(var_1_7, "sp_award/award")

	local var_1_8 = arg_1_0.bg

	arg_1_0.ptCount = var_1.Find(var_1_8, "ptCount")
	GetComponent = var_1
	arg_1_0.scrollCom = var_1(arg_1_0.content, "LScrollRect")

	local var_1_9 = arg_1_0.scrollCom

	function var_1_9.onUpdateItem(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_2, var_2_10006(arg_2_1))
	...
	var_1_9(arg_1_0.awardTpl, false)
...
function var_0_1.OnDataSetting(arg_3_0)
	if arg_3_0.ptData then
		...
		for iter_3_0, iter_3_1 in var_1(arg_3_0.ptData.dropList) do
			...
			Drop = var_1_10010
			var_3_3.drop = var_1_10010.New({
				type = iter_3_1[1],
				id = iter_3_1[2],
				count = iter_3_1[3]
			})
			table = var_1_10010
			var_3_3.isImportant = var_1_10010.contains(arg_3_0.highValueItemSort, iter_3_0)
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local function var_4_2()
		...
		local var_5_6 = var_5_2.gameset.urpt_chapter_max.description[1]

		LOCK_UR_SHIP = var_5_4
		...
		if var_5_4 then
			...
			var_2_10006 = var_5_4(var_2_10006)
			var_5_4 = var_5_4.GetLimitCntById(var_2_10006, var_5_6)
		end

		local var_5_7 = arg_4_0.ptData
		local var_5_8 = var_5.GetAllAvailableAwards(var_5_7)

		Task = var_2_10006

		local var_5_9, var_5_10 = var_2_10006.StaticJudgeOverflow(var_5_5.gold, var_5_5.oil, var_5_4, true, true, var_5_8)
		...
		var_8(var_5_3, function()
			...
			local var_7_4 = var_3_10004.EVENT_PT_OPERATION
			local var_7_5 = {
				cmd = 4
			}
			local var_7_6 = arg_4_0.ptData

			var_7_5.activity_id = var_6.GetId(var_7_6)
	...
	local var_4_5 = var_1_10002(var_4)
	local var_4_6 = var_2.getActivityById(var_4_5, var_4_4)

	onButton = var_4_3

	var_4_3(arg_4_0, arg_4_0.shopBtn, function()
		if var_4_6 then
			...
			if var_0.isEnd(var_8_0) then
				...
				var_8_2(var_8_1, var_2_10003("common_activity_end"))
			...
			local var_8_5 = var_2_10003.GO_SHOPS_LAYER
			local var_8_6 = {}

			NewShopsScene = var_2_10005
			var_8_6.warp = var_2_10005.TYPE_ACTIVITY
...
function var_0_1.BuildPhaseAwardScrollPos(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1(arg_10_0.awardList) do
		if iter_10_1.isImportant then
			...
			var_10_5.pos = var_10.HeadIndexToValue(var_10_6, iter_10_0 - var_0_1.SHOW_COUNT) / arg_10_0.impTotalPos
...
function var_0_1.UpdateAward(arg_12_0, arg_12_1, arg_12_2)
	...
	if not (var_12_0 <= var_5.GetLevel(var_12_2)) then
		...
		var_12_3(arg_12_2:Find("got"), var_5)

		setActive = var_12_3

		var_12_3(arg_12_2:Find("get"), var_12_4)

		setActive = var_12_3

		var_12_3(arg_12_2:Find("lock"), var_12_5)
		...
		local function var_12_8()
			...
			var_13_1(var_13_0, var_2_10003.ON_DROP, var_12_1)
		...
		var_12_3(var_12_6, var_12_7, var_12_8, var_13)
...
function var_0_1.OnUpdateFlush(arg_14_0)
	...
	if var_2(arg_14_0._tf) then
		...
		local var_14_5 = var_1_10005.clamp
		local var_14_6 = arg_14_0.scrollCom
		local var_14_7 = var_7.HeadIndexToValue
		local var_14_8 = arg_14_0.ptData

		var_14_4(var_14_3, var_14_5(var_14_7(var_14_6, var_10.GetLevel(var_14_8)) / arg_14_0.impTotalPos + var_14_2, 0, 1), true)
	end
	...
	local var_14_11 = var_5.GetMaxAvailableTargetIndex(var_14_10)
	local var_14_12 = arg_14_0.ptData

	var_14_4(var_14_9, var_14_11 == var_6.GetLevel(var_14_12))
...
function var_0_1.GetWorldPtData(arg_15_0, arg_15_1)
	...
	if arg_15_1 <= var_15_1 - var_15_2 then
		...
		var_15_7.activity_id = var_7.GetId(var_15_8)
