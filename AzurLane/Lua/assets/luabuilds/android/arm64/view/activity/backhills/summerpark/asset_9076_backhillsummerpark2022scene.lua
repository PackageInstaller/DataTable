...
function var_0_1.init(arg_2_0)
	...
	import = var_2_9
	arg_2_0.graphPath = var_2_10(var_2_9("GameCfg.BackHillGraphs.BackHillSummerParkGraph"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.summerland_tip.tip
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "bingqilin", function()
		...
		var_7_1(var_7_0, var_2_10003.GO_MINI_GAME, 41)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "qimazhan", function()
		...
		var_8_4.id = var_2_10006.ISUZU_SPORTS_SKIN_ID
	...
	var_2(var_3_16, var_5 == var_6)

	PLATFORM_CODE = var_2
	PLATFORM_US = var_3_12

	if var_2 == var_3_12 then
		local function var_3_17()
			...
			var_9_1(var_9_0, var_9_2, var_2_10004.SUMMARY)
...
function var_0_1.UpdateView(arg_10_0)
	local function var_10_0()
		...
		return var_11_0(var_2_10002.MINIGAME_ICECREAM)
	end
	...
	var_1_10002(var_4.Find(var_10_1, "Tip"), var_10_0())
	...
	local function var_10_2()
		...
		local var_12_2 = var_12_1(var_12_0, var_2_10003.ISUZU_SPORTS_SKIN_ID)

		Activity = var_2_10001

		return var_2_10001.IsActivityReady(var_12_2)
	end
	...
	var_1_10003(var_5.Find(var_10_3, "Tip"), var_10_2())
	...
	local function var_10_4()
		...
		local var_13_2 = var_13_1(var_13_0, var_2_10003.ACTIVITY_TYPE_SUMMARY)

		Activity = var_2_10001

		return var_2_10001.IsActivityReady(var_13_2)
	end
	...
	var_4(var_6.Find(var_10_5, "Tip"), var_10_4())
...
function var_0_1.IsShowMainTip(arg_14_0)
	local function var_14_0()
		...
		return var_15_0(var_2_10002.MINIGAME_ICECREAM)
	end
	...
	local function var_14_1()
		...
		local var_16_2 = var_16_1(var_16_0, var_2_10003.ISUZU_SPORTS_SKIN_ID)
	...
	local function var_14_2()
		...
		local var_17_2 = var_17_1(var_17_0, var_2_10003.ACTIVITY_TYPE_SUMMARY)
