...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_14, var_4("brs_reward_tip_1"))
	...
	var_1(var_1_24, var_1_25, var_1_26, var_6)
	...
	var_1(var_1_27, var_1_28, var_1_29, var_6)
...
function var_0_1.InitData(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10001(arg_8_0.table_Top) do
		...
		local var_8_0 = iter_8_1:Find("on/Text")

		i18n = var_1_10009

		var_1_10006(var_8_0, var_1_10009(arg_8_0.table_local[iter_8_0]))

		setText = var_1_10006

		local var_8_1 = iter_8_1:Find("off/Text")

		i18n = var_1_10009

		var_1_10006(var_8_1, var_1_10009(arg_8_0.table_local[iter_8_0]))

		onToggle = var_1_10006

		local var_8_2 = arg_8_0

		var_1_10009 = iter_8_1
		...
		local function var_8_3(arg_9_0)
			if arg_9_0 then
				...
				var_2_10001(var_3.Find(var_9_1, "off"), false)
			else
				setActive = var_2_10001

				local var_9_2 = arg_8_0.table_Top[iter_8_0]

				var_2_10001(var_3.Find(var_9_2, "off"), true)
			end
		...
		var_1_10006(var_8_2, var_1_10009, var_8_3, var_11)
	end
...
function var_0_1.UpdateView(arg_10_0)
	for iter_10_0 = 1, #arg_10_0.table_Top do
		...
		var_1_10005(var_7.Find(var_10_0, "on/label"), arg_10_0:OnGetCount(iter_10_0) .. "/" .. arg_10_0:OnCount(iter_10_0))

		setText = var_1_10005

		local var_10_1 = arg_10_0.table_Top[iter_10_0]

		var_1_10005(var_7.Find(var_10_1, "off/label"), arg_10_0:OnGetCount(iter_10_0) .. "/" .. arg_10_0:OnCount(iter_10_0))
	end
...
function var_0_1.OnGetCount(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in var_1_10003(arg_15_0.dataList) do
		if arg_15_0.guideConfig[iter_15_1.id].type == 4 and arg_15_1 == 1 then
			...
			if var_11(var_1_10013.getShipGroup(var_1_10015, var_15_2)) then
				var_15_0 = var_15_0 + 1
			end
...
function var_0_1.ShowSitePage(arg_16_0)
	...
	local var_16_7 = var_2
	local var_16_8 = var_2.Find(var_16_7, "notget")
	local var_16_9 = var_7.Find(var_16_8, "Text")

	setText = var_16_7

	local var_16_10 = var_16_6

	i18n = var_1_10012

	var_16_7(var_16_10, var_1_10012("word_got"))
	...
	var_16_7(var_16_11, var_12("word_not_get"))

	Drop = var_16_7

	local var_16_12 = var_16_7.New({
		type = arg_16_0.showDataList[1].config.type,
		id = arg_16_0.showDataList[1].config.drop_id
	})
	local var_16_13 = var_9.getName(var_16_12)
	local var_16_14 = var_9.id

	pg = var_16_12

	local var_16_15 = var_16_12.ship_data_template[var_16_14].group_type

	tobool = var_1_10013
	getProxy = var_1_10015
	CollectionProxy = var_1_10017

	local var_16_16 = var_1_10015(var_1_10017)
	local var_16_17 = var_1_10013(var_15.getShipGroup(var_16_16, var_16_15))

	SetActive = var_14

	var_14(var_16_3, not var_16_17)

	SetActive = var_14

	var_14(var_5, var_16_17)

	SetActive = var_14

	var_14(var_7, not var_16_17)

	local var_16_18 = arg_16_0.bg_1
	local var_16_19 = var_14.Find(var_16_18, "Role_right")
	local var_16_20 = var_14.Find(var_16_19, "lock_bg")
	local var_16_21 = var_14:Find("name")
	local var_16_22 = var_14:Find("get")
	local var_16_23 = var_17.Find(var_16_22, "Text")
	local var_16_24 = var_14
	local var_16_25 = var_14.Find(var_16_24, "notget")
	local var_16_26 = var_19.Find(var_16_25, "Text")

	setText = var_16_24

	local var_16_27 = var_16_23

	i18n = var_1_10024

	var_16_24(var_16_27, var_1_10024("word_got"))

	setText = var_16_24

	local var_16_28 = var_16_26

	i18n = var_24

	var_16_24(var_16_28, var_24("word_not_get"))

	local var_16_29 = arg_16_0.showDataList[2].config.drop_id

	Drop = var_16_25

	local var_16_30 = var_16_25.New({
		type = arg_16_0.showDataList[2].config.type,
		id = arg_16_0.showDataList[2].config.drop_id
	})
	local var_16_31 = var_22.getName(var_16_30)
	local var_16_32 = var_22.id

	pg = var_16_30

	local var_16_33 = var_16_30.ship_data_template[var_16_32].group_type

	tobool = var_26
	getProxy = var_1_10028
	CollectionProxy = var_1_10030

	local var_16_34 = var_1_10028(var_1_10030)
	local var_16_35 = var_26(var_28.getShipGroup(var_16_34, var_16_33))

	SetActive = var_1_10027

	var_1_10027(var_19, not var_16_35)

	SetActive = var_1_10027

	var_1_10027(var_17, var_16_35)

	SetActive = var_1_10027

	var_1_10027(var_16_20, not var_16_35)
...
function var_0_1.ShowCharaPage(arg_17_0)
	...
	var_1.make(var_17_2, function(arg_18_0, arg_18_1, arg_18_2)
		...
		if arg_18_0 == var_2_10003.EventUpdate then
			...
			var_18_1(var_18_0, var_18_2, var_18_3, var_2_10008)
		end
...
function var_0_1.OnUpdateItem(arg_19_0, arg_19_1, arg_19_2)
	...
	var_6(var_19_3, var_19_4, var_19_5, var_1_10011)

	changeToScrollText = var_6

	local var_19_6 = arg_19_2:Find("name_mask/name")

	Drop = var_19_4

	local var_19_7 = var_19_4.New({
		type = var_19_0.config.type,
		id = var_19_0.config.drop_id
	})

	var_6(var_19_6, var_9.getName(var_19_7))
	...
	local var_19_8 = arg_19_2:Find("owner")

	typeof = var_9
	CanvasGroup = var_11
	var_6(var_19_8, var_9(var_11)).alpha = var_19_0.count == var_19_0.config.count and 0.5 or 1
	setActive = var_7
...
function var_0_1.updateBoxPanel(arg_21_0, arg_21_1)
	...
	var_1_10003(arg_21_0.boxIconTF, var_21_0)
	...
	var_4(var_21_2, var_7(var_21_0.desc))
	...
	var_4(var_21_3, var_7("word_got"))

	local var_21_4 = arg_21_1.show_type

	Msgbox4LinkCollectGuide = var_5

	if var_21_4 == var_5.SHOW_TYPE_NORMAL then
		setText = var_21_4
	...
	var_21_4.StaticAlign(arg_21_0.boxSrcContent, arg_21_0.boxSrcTpl, #arg_21_1.skipable_list, function(arg_22_0, arg_22_1, arg_22_2)
		...
		if arg_22_0 == var_2_10003.EventUpdate then
			...
			var_2_10007(arg_22_2.Find(var_22_3, "SrcText"), var_22_2)

			local var_22_4 = arg_22_2:Find("GoBtn")

			setText = var_2_10008

			local var_22_5 = var_22_4:Find("go")

			i18n = var_22_3

			var_2_10008(var_22_5, var_22_3("brs_reward_tip_2"))
			...
			local function var_22_8()
				...
				if var_23_0 == var_3_10001.SKIP_TYPE_SCENE then
					...
					var_23_2(var_23_1, var_3_10003, var_23_3, var_23_4)
				else
					local var_23_5 = var_22_0

					Msgbox4LinkCollectGuide = var_1

					if var_23_5 == var_1.SKIP_TYPE_ACTIVITY then
						local var_23_6 = arg_21_0
						local var_23_7 = var_0.emit

						ActivityMediator = var_3_10003

						var_23_7(var_23_6, var_3_10003.SELECT_ACTIVITY, var_22_1)
					end
				end
			...
			var_2_10008(var_22_6, var_22_7, var_22_8, var_13)
		end
...
function var_0_1.Hx4Channel(arg_29_0)
	...
	if not var_3(var_29_0) then
		...
		var_3(var_29_2, var_1_10006.isHx())
	end
	...
	if not var_3(var_29_1) then
		...
		var_3(var_29_3, var_1_10006.isHx())
	end
