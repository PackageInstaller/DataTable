...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".BossSinglePreCombatLayer"))
...
function var_0_1.displayFleetInfo(arg_54_0)
	...
	var_1_10002(var_54_2, var_54_1 == var_1_10005.Normal)
	...
	var_1_10002(var_54_3, var_54_1 == var_5.Normal)

	math = var_1_10002

	local var_54_4 = var_1_10002.floor
	local var_54_5 = arg_54_0._currentFleetVO
	local var_54_6 = var_4.GetGearScoreSum

	TeamType = var_1_10007

	local var_54_7 = var_54_4(var_54_6(var_54_5, var_1_10007.Vanguard))

	math = var_54_0

	local var_54_8 = var_54_0.floor
	local var_54_9 = arg_54_0._currentFleetVO
	local var_54_10 = var_5.GetGearScoreSum

	TeamType = var_1_10008

	local var_54_11 = var_54_8(var_54_10(var_54_9, var_1_10008.Main))
	...
	var_4(var_54_12, var_54_1 == var_54_9.Submarine)

	math = var_4

	local var_54_13 = var_4.floor
	local var_54_14 = arg_54_0._currentFleetVO
	local var_54_15 = var_6.GetGearScoreSum

	TeamType = var_1_10009

	local var_54_16 = var_54_13(var_54_15(var_54_14, var_1_10009.Submarine))
	...
	local var_54_20 = var_54_17.battle_cost_template[var_54_19].oil_cost == 0 and 0 or var_54_18.oil

	setActive = var_9

	var_9(arg_54_0._costContainer, true)
	...
	var_9(var_54_21, var_12.GetName(var_54_22))
	...
	if arg_54_0.contextData.costLimit then
		...
		local var_54_24 = var_10.battle_cost_template[var_54_19].oil_cost > 0
		local var_54_25 = 0

		var_1_10013 = 0

		local var_54_26 = false
		...
		for iter_54_0, iter_54_1 in var_1_10015({
			...
			local var_54_27 = iter_54_1:GetCostSum().oil

			if not var_54_24 then
				var_54_27 = 0
			end

			var_1_10013 = var_1_10013 + var_54_27

			local var_54_28 = iter_54_0 == 1
			local var_54_29 = arg_54_0.contextData.costLimit[var_54_28 and 1 or 2]

			if 0 < var_54_29 then
				var_54_26 = var_54_26 or var_54_29 < var_54_27
				math = var_23
				var_54_27 = var_23.min(var_54_27, var_54_29)
			end

			var_54_25 = var_54_25 + var_54_27
		end

		setTextColor = var_15

		local var_54_30 = arg_54_0._costText
		...
		if var_54_26 then
			...
			var_15(var_54_30, iter_54_0)
			var_0_2.tweenNumText(arg_54_0._costText, var_54_25)

			setActive = var_10

			local var_54_31 = arg_54_0._costTip

			isCostOver = var_1_10013

			var_10(var_54_31, var_1_10013)
			...
			if var_10 then
				...
				var_10(arg_54_0, arg_54_0._costTip, function()
					...
					baseCost = var_2_10007
					var_55_2.content = var_2_10004(var_55_3, var_2_10007, var_54_18)
