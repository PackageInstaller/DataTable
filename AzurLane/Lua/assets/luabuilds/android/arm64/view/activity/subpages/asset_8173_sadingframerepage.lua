...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_5 = var_3.Find(var_1_4, "AD/switcher/phase2/barContent")

	typeof = var_4
	Slider = var_6
	arg_1_0.bar = var_1(var_1_5, var_4(var_6))
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	if 1 <= var_6_1 then
		...
		if not var_7(var_6_3, var_1_10010) then
			var_6_4 = var_6_0
		end
		...
		var_6(var_8.Find(var_6_18, "AD/switcher/phase2/progress"), not var_6_7)
