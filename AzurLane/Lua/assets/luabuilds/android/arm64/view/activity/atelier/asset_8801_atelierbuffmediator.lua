...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10004.UPDATE_ATELIER_BUFF, function(arg_2_0, arg_2_1)
		local var_2_0 = arg_1_0
		local var_2_1 = var_2.sendNotification

		GAME = var_2_10005

		var_2_1(var_2_0, var_2_10005.UPDATE_ATELIER_BUFF, arg_2_1)
	...
	local var_1_6 = var_1_5(var_1_4, var_4.ACTIVITY_TYPE_ATELIER_LINK)

	assert = var_1_10002

	var_1_10002(var_1_6 and not var_1_6:isEnd())
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_1 == nil then
		...
		if var_5_1 == var_5_0.ACTIVITY_UPDATED then
			...
			if var_5_4 == var_5_2.ACTIVITY_TYPE_ATELIER_LINK then
			...
			if var_5_1 == var_5_4.UPDATE_ATELIER_BUFF_DONE then
