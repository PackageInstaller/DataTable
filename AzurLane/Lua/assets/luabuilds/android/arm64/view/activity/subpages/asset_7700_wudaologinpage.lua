...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	for iter_3_0 = 1, 8 do
		...
		local var_3_2 = var_1_10005(var_3_0, var_8.Find(var_3_1, "layout"))
		...
		local function var_3_8()
			...
			var_4_1(var_4_0, var_2_10003.ON_DROP, var_3_5)
		...
		var_9(var_3_6, var_3_7, var_3_8, var_1_10014)
	end
...
function var_0_1.OnUpdateFlush(arg_5_0)
	for iter_5_0 = 1, 8 do
		...
		var_5_1(var_5_4, var_1_10010.format("number%d", iter_5_0), var_5_2:Find("day"), true)

		setActive = var_5_1

		var_5_1(var_5_2:Find("got"), var_5_3)
	end
