...
function var_0_1.register(arg_1_0)
	...
	local var_1_3 = var_1_2(var_1_1, var_5.ANNIVERSARY_TASK_LIST_ID)
...
function var_0_1.acceptTask(arg_4_0, arg_4_1)
	...
	local var_4_2 = var_1_10004.TimeMgr.GetInstance()
	local var_4_3 = var_4.DiffDay(var_4_2, arg_4_1.data1, var_4:GetServerTime()) + 1

	math = var_6

	local var_4_4 = var_6.clamp(var_4_3, 1, #var_4_1)

	if arg_4_1.data3 ~= 0 then
		if var_6 < var_4_4 then
			_ = var_4_2

			local var_4_5 = var_4_2.all

			_ = var_9

			if var_4_5(var_9.flatten({
				var_4_1[var_6]
			}), function(arg_5_0)
				...
				var_4_7(var_4_6, var_10.ACTIVITY_OPERATION, {
					cmd = 1,
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_1 ~= var_8_0.TASK_ADDED then
		TaskProxy = var_8_4

		if var_8_1 ~= var_8_4.TASK_UPDATED then
			TaskProxy = var_8_4

			if var_8_1 ~= var_8_4.TASK_REMOVED then
				TaskProxy = var_8_4

				local var_8_4

				if var_8_1 == var_8_4.TASK_DELETE then
					var_1_10006 = arg_8_0
					var_8_4 = arg_8_0.getTaskByIds(var_1_10006)

					local var_8_5 = arg_8_0.viewComponent

					var_8_2.setTaskList(var_8_5, var_8_4)
				else
					GAME = var_8_4

					if var_8_1 == var_8_4.SUBMIT_TASK_DONE then
						getProxy = var_4
						ActivityProxy = var_1_10006

						local var_8_6 = var_4(var_1_10006)

						var_8_2 = var_4.getActivityById
						ActivityConst = var_1_10008
						var_8_2 = var_8_2(var_8_6, var_1_10008.ANNIVERSARY_TASK_LIST_ID)

						if arg_8_0.viewComponent.dateIndex and arg_8_0.viewComponent.dateIndex == var_8_2.data3 then
							local var_8_7 = arg_8_0.viewComponent

							var_6.updateTaskGroupDesc(var_8_7, var_8_2.data3)
						end

						local var_8_8 = arg_8_0.viewComponent

						var_6.updateBottomTaskGroup(var_8_8, var_8_2.data3)

						local var_8_9 = arg_8_0.viewComponent
						local var_8_10 = var_6.emit

						BaseUI = var_9

						var_8_10(var_8_9, var_9.ON_ACHIEVE, var_8_3)
						arg_8_0:acceptTask(var_8_2)
					else
						ActivityProxy = var_4

						if var_8_1 == var_4.ACTIVITY_UPDATED then
							local var_8_11 = var_8_3.id

							ActivityConst = var_8_2

							if var_8_11 == var_8_2.ANNIVERSARY_TASK_LIST_ID then
								local var_8_12 = arg_8_0.viewComponent

								var_4.setActivity(var_8_12, var_8_3)

								local var_8_13 = arg_8_0.viewComponent

								var_4.updateTaskGroups(var_8_13)

								local var_8_14 = arg_8_0.viewComponent

								var_4.moveToTaskGroup(var_8_14, arg_8_0.viewComponent.date, nil, true)
							end
						end
					end
				end
