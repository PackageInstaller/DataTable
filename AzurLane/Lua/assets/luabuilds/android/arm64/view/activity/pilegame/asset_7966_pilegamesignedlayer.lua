...
function var_0_1.didEnter(arg_4_0)
	...
	local function var_4_5()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip.help_chunjie_stamp.tip
	...
	local function var_4_8()
		...
		PileGameSignedMediator = var_2_10005

		var_7_2(var_7_1, var_2_10005.ON_GET_AWARD)
...
function var_0_1.UpdateIconDesc(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10001(arg_8_0.icons) do
		...
		local function var_8_2()
			...
			i18n = var_2_10004
			var_9_2.content = var_2_10004("special_animal" .. iter_8_0)
...
function var_0_1.UpdateSigned(arg_10_0)
	...
	var_4(arg_10_0.getBtn, var_10_3)

	setActive = var_4

	var_4(arg_10_0.gotBtn, not var_10_3)

	setGray = var_4

	var_4(arg_10_0.getBtn, var_10_3 and var_10_2 < var_10_1, true)

	ipairs = var_4

	for iter_10_0, iter_10_1 in var_4(arg_10_0.icons) do
		...
		local var_10_7 = var_10_6(var_10_5, var_1_10013(var_1_10015))

		if var_10_4 then
			Color = var_1_10011

			if not var_1_10011.New(1, 1, 1, 1) then
				Color = var_1_10011
				var_1_10011 = var_1_10011.New(1, 1, 1, 0.1)
			end

			var_10_7.color = var_1_10011
		end
	end
