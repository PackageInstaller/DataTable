...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10004("mall_summary_title"))
	...
	var_1_10001(var_2_1, var_4("word_click_to_close"))
	...
	var_1_10001(var_2_2, var_4("mall_total_income_header"))
	...
	var_1_10001(var_2_3, var_4("mall_balance_header"))
...
function var_0_1.OnInit(arg_3_0)
	...
	arg_3_0.floorUIList = var_3_3(var_3_4, var_4.Find(var_3_5, "tpl"))
	...
	var_1.make(var_3_6, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			local var_5_1 = arg_5_2:Find("header")

			i18n = var_2_10007

			var_2_10004(var_5_1, var_2_10007("mall_floor_income_header", var_5_0))
...
function var_0_1.Show(arg_6_0)
	...
	ActivityConst = var_4
	arg_6_0.activity = var_6_2(var_6_1, var_4.ACTIVITY_TYPE_MALL)
	...
	for iter_6_0, iter_6_1 in var_1(var_3.GetFloorListAsc(var_6_4)) do
