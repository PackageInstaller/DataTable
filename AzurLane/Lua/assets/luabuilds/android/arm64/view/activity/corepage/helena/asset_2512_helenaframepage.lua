...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_9 = var_3.Find(var_1_8, "AD/switcher/phase2/task_bg_2/battle_btn/Text")

	i18n = var_4

	var_1(var_1_9, var_4("other_world_task_go"))

	setText = var_1

	local var_1_10 = arg_1_0._tf
	local var_1_11 = var_3.Find(var_1_10, "AD/switcher/phase2/task_bg_2/get_btn/Text")

	i18n = var_4

	var_1(var_1_11, var_4("other_world_task_get"))

	setText = var_1

	local var_1_12 = arg_1_0._tf
	local var_1_13 = var_3.Find(var_1_12, "AD/switcher/phase2/task_bg_2/got_btn/Text")

	i18n = var_4

	var_1(var_1_13, var_4("other_world_task_got"))
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	if 1 <= var_6_1 then
		...
		var_1_10004(var_6_2, var_6_3 .. var_1_10008("/" .. var_2, "#FFFFFF"))
...
function var_0_1.Switch(arg_7_0, arg_7_1)
	...
	if arg_7_1 then
		...
		var_2(var_4.Find(var_7_0, "switcher"), "anim_HelenaFramePage_switcher")
	else
		quickPlayAnimation = var_2

		local var_7_1 = arg_7_0.bg

		var_2(var_4.Find(var_7_1, "switcher"), "anim_HelenaFramePage_switcher2")
	end
