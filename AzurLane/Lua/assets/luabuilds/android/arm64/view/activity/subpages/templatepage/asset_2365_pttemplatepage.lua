...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_5()
		...
		if var_2.getConfig(var_5_2, "config_client") ~= "" then
			...
			if var_3.getConfig(var_5_3, "config_client").linkActID then
				getProxy = var_3
				ActivityProxy = var_5_3

				local var_5_4 = var_3(var_5_3)

				var_5_1 = var_3.getActivityById(var_5_4, var_5_0)
			end
		end
		...
		if var_2.fightLinkActID then
			...
			local var_5_5 = var_5_2(var_2_10006)

			if var_5_2.getActivityById(var_5_5, var_3) then
				local var_5_6 = arg_3_0

				var_5_2 = var_5_2.emit
				ActivityMediator = var_2_10007

				var_5_2(var_5_6, var_2_10007.SKIP_ACTIVITY_MAP, var_3)
		...
		if not var_5_0 then
			...
			var_5_2(var_5_7, var_2_10007.BATTLE_OPERA)
		elseif var_5_1 and not var_5_1:isEnd() then
			...
			var_5_2(var_5_8, var_2_10007.BATTLE_OPERA)
		else
			pg = var_5_2

			local var_5_9 = var_5_2.TipsMgr.GetInstance()
			local var_5_10 = var_4.ShowTips

			i18n = var_2_10007

			var_5_10(var_5_9, var_2_10007("common_activity_end"))
		end
