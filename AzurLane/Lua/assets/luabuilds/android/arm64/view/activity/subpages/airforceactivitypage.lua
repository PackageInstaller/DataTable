...
function var_0_1.OnDataSetting(arg_2_0)
	...
	arg_2_0.linkActivity = var_2_1(var_2_0, var_4.getConfig(var_2_2, "config_client").linkActID)
	...
	_ = var_1_10002
	arg_2_0.summaryTask = var_1_10002.detect(var_2_4, function(arg_4_0)
...
function var_0_1.TrySubmitTask(arg_6_0)
	...
	if var_1.isFinish(var_6_0) then
		...
		if not var_1.isReceive(var_6_1) then
			...
			var_6_3(var_6_2, var_1_10004.SUBMIT_TASK, arg_6_0.summaryTask.id)
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	local function var_7_2()
		...
		var_8_1(var_8_0, var_8_2, var_2_10004.AIRFORCE_DRAGONEMPERY)
	...
	for iter_7_0 = 1, #arg_7_0.subTasks do
		...
		var_1_10008 = var_1_10008.GetChild(var_7_4, iter_7_0 - 1)
		...
		local function var_7_5()
			...
			if not var_0.isReceive(var_10_0) then
				...
				local var_10_1 = var_2_10002.m02

				var_2_10002 = var_2_10002.sendNotification
				GAME = var_2_10005

				var_2_10002(var_10_1, var_2_10005.SUBMIT_TASK, var_0.id)
			end
			...
			var_2_10002(var_10_2, var_2_10005("airforce_title_" .. iter_7_0))
			...
			var_2_10002(var_10_3, var_5("airforce_desc_" .. iter_7_0))

			pg = var_2_10002

			local var_10_4 = var_2_10002.UIMgr.GetInstance()
		...
		var_5(var_7_3, var_1_10008, var_7_5, var_7_4)
	end
	...
	var_7_6(arg_7_0.iconAward, var_7_8)
	...
	local function var_7_11()
		...
		var_11_1(var_11_0, var_2_10003.ON_DROP, var_7_8)
	...
	var_7_6(var_7_9, var_7_10, var_7_11, var_1_10008)
...
function var_0_1.OnUpdateFlush(arg_12_0)
	...
	for iter_12_0 = 1, #var_12_0 do
		...
		local var_12_5 = var_10.GetChild(var_12_4, iter_12_0 - 1)

		var_1_10008(var_10.Find(var_12_5, "viewed"), var_12_3)
	...
	var_3(var_12_6, var_6.isReceive(var_12_7))

	setActive = var_3

	local var_12_8 = arg_12_0.btnBattle
	local var_12_9 = var_5.Find(var_12_8, "tip")
	local var_12_10 = arg_12_0.activity

	var_3(var_12_9, var_6.readyToAchieve(var_12_10))
...
function var_0_1.GetFightCount(arg_13_0)
	...
	return var_8.min(var_13_7 * var_13_2, var_13_1) - var_13_3
end
