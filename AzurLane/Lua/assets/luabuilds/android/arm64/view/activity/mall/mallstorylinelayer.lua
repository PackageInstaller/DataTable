...
function var_0_1.init(arg_2_0)
	...
	local var_2_1 = var_3.Find(var_2_0, "tip")

	i18n = var_1_10004

	var_1_10001(var_2_1, var_1_10004("word_click_to_close"))
	...
	local var_2_8 = var_1_10002(var_4)
	local var_2_9 = var_2.getActivityByType

	ActivityConst = var_2_0

	local var_2_10 = var_2_9(var_2_8, var_2_0.ACTIVITY_TYPE_MALL)
	...
	local var_2_13 = var_2_12(var_2_11, var_5.ACTIVITY_TYPE_MALL)
	...
	for iter_2_2 = 0, arg_2_0.tabsListCount - 1 do
		...
		local var_2_18 = var_10.GetChild(var_2_17, iter_2_2)
		...
		var_1_10007(var_2_16, var_2_18, var_2_19, var_2_17)
	end
...
function var_0_1.UpdataToggle(arg_5_0, arg_5_1)
	...
	if arg_5_1 == var_0_1.num.Skin or not arg_5_0:OnTask(var_5_0) then
		var_5_1 = arg_5_0:GetSkinFinishNum(var_5_0)
	end
	...
	var_1_10004(var_6.Find(var_5_2, "tabs/" .. arg_5_1 .. "/name"), var_5_1 .. "/" .. #var_5_0)

	setText = var_1_10004

	local var_5_3 = arg_5_0.adapt

	var_1_10004(var_6.Find(var_5_3, "tabs/" .. arg_5_1 .. "/on/name"), var_5_1 .. "/" .. #var_5_0)
...
function var_0_1.OnUpdata(arg_6_0, arg_6_1)
	for iter_6_0 = 0, arg_6_0.decorate1ListCount - 1 do
		...
		var_1_10006(var_8.Find(var_6_0, "decorate1/" .. iter_6_0 + 1), iter_6_0 + 1 == arg_6_1)
	end
	...
	for iter_6_1 = 0, arg_6_0.page_listCount - 1 do
		...
		var_1_10006(var_8.Find(var_6_1, "page_list/" .. iter_6_1 + 1), iter_6_1 + 1 == arg_6_1)
	end
...
function var_0_1.GetSkinFinishNum(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in var_1_10003(arg_8_1) do
		...
		if var_1_10008(var_8_1, var_1_10011(iter_8_1.desc)) then
			var_8_0 = var_8_0 + 1
		end
	end
...
function var_0_1.OnStoryUPdata(arg_10_0, arg_10_1, arg_10_2)
	...
	var_1_10007(var_10_4, var_10_5, var_10_6, var_12)
...
function var_0_1.OnSkinPage(arg_13_0, arg_13_1)
	...
	local var_13_5 = var_2.Find(var_13_4, "left")
	...
	var_4(var_13_3, var_13_5, var_13_6, var_13_4)

	onButton = var_4

	local var_13_7 = arg_13_0
	local var_13_8 = var_2
	local var_13_9 = var_2.Find(var_13_8, "right")
	...
	var_4(var_13_7, var_13_9, var_13_10, var_13_8)
...
function var_0_1.OnSkin(arg_16_0, arg_16_1, arg_16_2)
	...
	var_1_10004(arg_16_2:Find("left"), arg_16_0.roleindex == 1)

	setActive = var_1_10004

	var_1_10004(arg_16_2:Find("right"), arg_16_0.roleindex == 0)

	setText = var_1_10004

	var_1_10004(arg_16_2:Find("Text"), arg_16_0.roleindex + 1 .. "/" .. #arg_16_0.SkinList / 5)
...
function var_0_1.OnSkinUpdata(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_2 = var_17_0(var_17_1, var_1_10006(arg_17_2.desc))
	local var_17_3 = arg_17_2.name

	i18n = var_17_1

	local var_17_4 = var_17_1("mall_char_lock")
	local var_17_5 = arg_17_2.lua
	local var_17_6 = arg_17_2.icon

	SetActive = var_8

	var_8(arg_17_1:Find("on"), var_17_2)

	SetActive = var_8

	var_8(arg_17_1:Find("off"), not var_17_2)

	setText = var_8

	var_8(arg_17_1:Find("on/name"), var_17_3)

	setText = var_8

	var_8(arg_17_1:Find("off/lockname"), var_17_4)

	setImageSprite = var_8

	local var_17_7 = arg_17_1:Find("on/bg")

	LoadSprite = var_11

	var_8(var_17_7, var_11("ui/mallstorylineui_atlas", var_17_6))
	...
	var_8(var_17_8, var_17_9, var_17_10, var_13)

	onButton = var_8

	local var_17_11 = arg_17_0
	local var_17_12 = arg_17_1
	local var_17_13 = arg_17_1.Find(var_17_12, "on/bg")
	...
	var_8(var_17_11, var_17_13, var_17_14, var_17_12)
...
function var_0_1.OnRoleUPdata(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_7 = arg_23_1:Find("on/icon")

	LoadSprite = var_12

	var_9(var_23_7, var_12("ui/mallstorylineui_atlas", var_23_4))

	onButton = var_9

	local var_23_8 = arg_23_0
	local var_23_9 = arg_23_1
	local var_23_10 = arg_23_1.Find(var_23_9, "on")
	...
	var_9(var_23_8, var_23_10, var_23_11, var_23_9)

	onButton = var_9

	local var_23_12 = arg_23_0
	local var_23_13 = arg_23_1
	local var_23_14 = arg_23_1.Find(var_23_13, "off")
	...
	var_9(var_23_12, var_23_14, var_23_15, var_23_13)
...
function var_0_1.OnPlacePage(arg_27_0, arg_27_1)
	...
	for iter_27_0 = 0, var_27_2 - 1 do
		...
		var_1_10007(var_9.Find(var_27_3, "table/" .. iter_27_0 + 1), arg_27_0.Placeindex == iter_27_0 + 1)
	end
	...
	var_4(var_27_5, var_7.Find(var_27_6, "page_list/" .. arg_27_1 .. "/table"), function()
	...
	local var_27_9 = var_7.Find(var_27_8, "left")
	...
	var_4(var_27_7, var_27_9, var_27_10, var_27_8)

	onButton = var_4

	local var_27_11 = arg_27_0
	local var_27_12 = arg_27_0.Place
	local var_27_13 = var_7.Find(var_27_12, "right")
	...
	var_4(var_27_11, var_27_13, var_27_14, var_27_12)
...
function var_0_1.OnPlaceList(arg_32_0, arg_32_1, arg_32_2)
	...
	var_1_10003(var_5.Find(var_32_0, "left"), arg_32_0.Placeindex ~= 0)

	setActive = var_1_10003

	local var_32_1 = arg_32_0.Place

	var_1_10003(var_5.Find(var_32_1, "right"), arg_32_0.Placeindex < 2)

	setActive = var_1_10003

	local var_32_2 = arg_32_0.Place

	var_1_10003(var_5.Find(var_32_2, "table/0"), arg_32_0.Placeindex == 0)

	setActive = var_1_10003

	local var_32_3 = arg_32_0.Place

	var_1_10003(var_5.Find(var_32_3, "table/1"), arg_32_0.Placeindex == 1)

	setActive = var_1_10003

	local var_32_4 = arg_32_0.Place

	var_1_10003(var_5.Find(var_32_4, "table/2"), arg_32_0.Placeindex == 2)
...
function var_0_1.OnPlaceUPdata(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	local var_33_1 = var_1_10005("mall_continue_to_unlock")
	...
	if var_33_0 then
		...
		local var_33_6 = arg_33_1:Find("icon")

		LoadSprite = var_13

		var_1_10010(var_33_6, var_13("ui/mallstorylineui_atlas", var_33_2))
	end
...
function var_0_1.didEnter(arg_34_0)
	...
	local var_34_2 = var_4.Find(var_34_1, "bg")
	...
	var_1_10001(var_34_0, var_34_2, var_34_3, var_34_1)
