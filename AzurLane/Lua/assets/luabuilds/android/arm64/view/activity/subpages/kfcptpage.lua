...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	local var_1_2 = var_4.Find(var_1_1, "sdBtn")
	...
	local function var_1_3()
		...
		var_2_1(var_2_0, var_2_2, var_2_10004.SKINSHOP)
	...
	var_1(var_1_4, var_1_5, var_1_6, var_1_1)
	...
	local function var_1_9()
		...
		local var_4_3 = var_2_10002(var_2_10004)
		local var_4_4 = var_2.getRawData(var_4_3)

		pg = var_2_10004

		local var_4_5 = var_2_10004.gameset.urpt_chapter_max.description[1]

		LOCK_UR_SHIP = var_4_3
		...
		if var_4_3 then
			...
			local var_4_6 = var_4_3(var_2_10007)

			var_4_3 = var_4_3.GetLimitCntById(var_4_6, var_4_5)
		end

		Task = var_2_10006

		local var_4_7, var_4_8 = var_2_10006.StaticJudgeOverflow(var_4_4.gold, var_4_4.oil, var_4_3, true, true, {
			{
				var_4_2.type,
				var_4_2.id,
				var_4_2.count
	...
	var_1(var_1_7, var_1_8, var_1_9, var_1_1)
	...
	local var_1_11 = var_1.New(arg_1_0.sdName, function(arg_7_0)
		...
		Vector3 = var_2_10002
		var_7_0.localScale = var_2_10002.one
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	if 1 <= var_8_3 then
		...
		if not var_7(var_8_1, "#ffc563") then
			var_8_5 = var_8_1
		end
...
function var_0_1.OnDestroy(arg_12_0)
	if arg_12_0.sdSpineLRQ then
		local var_12_0 = arg_12_0.sdSpineLRQ
	...
	if arg_12_0.sdSpine then
		local var_12_1 = arg_12_0.sdSpine.transform

		Vector3 = var_1_10002
		var_12_1.localScale = var_1_10002.one
		pg = var_12_1

		local var_12_2 = var_12_1.PoolMgr.GetInstance()

		var_1.ReturnSpineChar(var_12_2, arg_12_0.sdName, arg_12_0.sdSpine)
