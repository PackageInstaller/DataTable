...
function var_0_0.OnFirstFlush(arg_3_0)
	...
	for iter_3_0 = 1, 7 do
		...
		updateDrop(var_3_0:Find("item"), (Drop.Create(arg_3_0.config.front_drops[iter_3_0])))
...
function var_0_0.OnUpdateFlush(arg_5_0)
	...
	for iter_5_0 = 1, 7 do
		...
		GetImageSpriteFromAtlasAsync("ui/activityuipage/day7_login_atlas", string.format("day%d", iter_5_0) .. (iter_5_0 <= arg_5_0.activity.data1 and "_sel" or ""), var_5_0:Find("day"), true)
