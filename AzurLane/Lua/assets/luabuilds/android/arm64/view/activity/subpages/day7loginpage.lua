...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	for iter_3_0 = 1, 7 do
		...
		local var_3_2 = var_7.Create(arg_3_0.config.front_drops[iter_3_0])
		...
		var_3_0(var_3_3, var_3_4, var_3_5, var_1_10013)
	end
...
function var_0_1.OnUpdateFlush(arg_5_0)
	...
	local var_5_1 = var_1_10004.format
	local var_5_2 = "0%d"

	math = var_1_10007

	var_1_10001(var_5_0, var_5_1(var_5_2, var_1_10007.max(arg_5_0.activity.data1, 1)), arg_5_0.labelDay, true)
	...
	for iter_5_0 = 1, 7 do
		...
		GetImageSpriteFromAtlasAsync = var_5_3

		local var_5_6 = "ui/activityuipage/day7_login_atlas"

		string = var_10

		var_5_3(var_5_6, var_10.format("day%d", iter_5_0) .. (var_5_5 and "_sel" or ""), var_5_4:Find("day"), true)

		setActive = var_5_3

		var_5_3(var_5_4:Find("got"), var_5_5)
	end
