...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_5()
		...
		var_5_1(var_5_0, var_2_10003.SPECIAL_BATTLE_OPERA)
...
function var_0_1.GetAllAward(arg_7_0)
	...
	local var_7_3 = var_1_10003(var_1_10005)
	local var_7_4 = var_3.getRawData(var_7_3)

	pg = var_1_10005

	local var_7_5 = var_1_10005.gameset.urpt_chapter_max.description[1]
	...
	if var_7_3 then
		...
		local var_7_6 = var_7_3(var_1_10008)
	...
	local var_7_7, var_7_8 = var_1_10007.StaticJudgeOverflow(var_7_4.gold, var_7_4.oil, var_7_3, true, true, {
		{
			var_7_2.type,
			var_7_2.id,
			var_7_2.count
	...
	if var_7_7 then
		...
		var_9.insert(var_7_0, function(arg_8_0)
			...
			var_8_2.type = var_2_10005
			i18n = var_2_10005
			var_8_2.content = var_2_10005("award_max_warning")
	...
	var_9(var_7_0, function()
		...
		local var_9_5 = var_2_10005.EVENT_PT_OPERATION
		local var_9_6 = {
			cmd = 1
		}
		local var_9_7 = arg_7_0.ptData

		var_9_6.activity_id = var_7.GetId(var_9_7)
...
function var_0_1.OnUpdateFlush(arg_10_0)
	...
	var_1_10002(var_4.Find(var_10_2, "IconTpl"), var_10_1)
	...
	local var_10_8 = var_1_10008(var_10_4, "#ffffff")

	setColorStr = var_1_10009

	var_5(var_10_7, var_10_8 .. var_1_10009("/" .. var_10_5, "#DD9D9D"))
	...
	var_10_11(arg_10_0.battleBtn, var_10_14 and not var_10_10 and var_10_12)

	setActive = var_10_11

	var_10_11(arg_10_0.getBtn, var_10_10)

	setActive = var_10_11

	var_10_11(arg_10_0.gotBtn, not var_10_12)
	...
	for iter_10_0 = 1, 10 do
		...
		if iter_10_0 <= var_12.GetLevel(var_10_15) then
			...
			var_12(var_14.Find(var_10_16, "schedule/" .. iter_10_0 .. "/on"), true)

			SetActive = var_12

			local var_10_17 = arg_10_0.bg

			var_12(var_14.Find(var_10_17, "schedule/" .. iter_10_0 .. "/not"), false)
		else
			SetActive = var_12

			local var_10_18 = arg_10_0.bg

			var_12(var_14.Find(var_10_18, "schedule/" .. iter_10_0 .. "/on"), false)

			SetActive = var_12

			local var_10_19 = arg_10_0.bg

			var_12(var_14.Find(var_10_19, "schedule/" .. iter_10_0 .. "/not"), true)
		end
	end
...
function var_0_1.GetWorldPtData(arg_11_0, arg_11_1)
	...
	if arg_11_1 <= var_11_1 - var_11_2 then
		...
		var_11_7.activity_id = var_7.GetId(var_11_8)
