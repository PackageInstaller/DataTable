...
function var_0_1.init(arg_2_0)
	...
	local function var_2_5()
		...
		CultivatingPlantMediator = var_2_10003

		var_4_1(var_4_0, var_2_10003.GO_SCENE)
	...
	local function var_2_8()
		...
		if not var_0:isReceive() then
			...
			CultivatingPlantMediator = var_4

			var_5_2(var_5_1, var_4.ON_TASK_SUBMIT, var_0)
		else
	...
	var_1(var_2_14, iter_2_0("cultivating_plant_task_title"))
	...
	var_1(var_2_15, var_4("cultivating_plant_island_task"))
...
function var_0_1.SelectPage(arg_9_0, arg_9_1)
	...
	for iter_9_0 = 1, arg_9_0.uiList.childCount do
		...
		var_1_10009 = var_8.GetComponent
		typeof = var_1_10012
		LayoutElement = var_1_10014
		var_1_10009 = var_1_10009(var_9_3, var_1_10012(var_1_10014))
		var_1_10009.preferredWidth = iter_9_0 == arg_9_1 and var_9_1 or var_9_0
		setActive = var_9_3

		local var_9_4 = var_8:Find("Image")

		var_1_10014 = iter_9_0 ~= arg_9_1

		var_9_3(var_9_4, var_1_10014)

		setActive = var_9_3

		local var_9_5 = var_8:Find("main")

		var_1_10014 = iter_9_0 == arg_9_1

		var_9_3(var_9_5, var_1_10014)

		getProxy = var_9_3
		TaskProxy = var_9_5

		local var_9_6 = var_9_3(var_9_5)

		if var_11.getTaskVO(var_9_6, arg_9_0.taskList[iter_9_0]) then
			var_1_10014 = var_11

			if not var_11.isFinish(var_1_10014) then
				var_1_10012 = false
			end

			setActive = var_9_6

			var_9_6(var_8:Find("Image/got"), var_1_10012)

			setActive = var_9_6

			var_9_6(var_8:Find("main/got"), var_1_10012)
		end
	end
	...
	local var_9_7 = arg_9_0.uiCultivatingText

	i18n = iter_9_0
	string = var_1_10009

	var_4(var_9_7, iter_9_0(var_1_10009.format("cultivating_plant_part_" .. arg_9_0.index)))
...
function var_0_1.RefreshTask(arg_10_0)
	...
	local var_10_4 = var_1_10004.Create(var_10_1.award_display[1])

	updateDrop = var_10_2

	var_10_2(arg_10_0.uiRewardItem, var_10_4)
	...
	local function var_10_7()
		...
		var_11_1(var_11_0, var_2_10003.ON_DROP, var_10_4)
	...
	if var_10_3 then
		...
		if not var_10_3.isReceive(var_10_5) then
			var_10_8 = false
		end
		...
		if var_10_3 then
			...
			var_10_5(arg_10_0.uiRewardGot, var_10_8)

			setActive = var_10_5

			var_10_5(arg_10_0.uiRed, var_10_9 and not var_10_8)

			setGray = var_10_5

			var_10_5(arg_10_0.uiIslandBtn, not var_10_9)

			setText = var_10_5

			var_10_5(arg_10_0.uiTaskDesc, var_10_1.desc)

			local var_10_10

			if not var_10_3 or not var_10_3:getProgress() then
				var_10_10 = 0
			end

			setText = var_10_6

			local var_10_11 = arg_10_0.uiTaskCnt

			string = var_1_10011

			var_10_6(var_10_11, var_1_10011.format("<color=#268BC5>%s</color>/%s", var_10_10, var_10_1.target_num))

			local var_10_12 = arg_10_0.uiSlider

			var_10_12.fillAmount = var_10_10 / var_10_1.target_num
			setActive = var_10_12

			var_10_12(arg_10_0.uiTask, false)

			setActive = var_10_12

			var_10_12(arg_10_0.uiTask, true)
