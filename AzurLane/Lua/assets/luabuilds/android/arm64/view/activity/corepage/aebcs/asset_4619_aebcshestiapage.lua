...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.CorePage.BRS.HeiYanPtPage"))
...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_1, var_1_10004("other_world_temple_award"))

	setText = var_1

	local var_1_2 = arg_1_0.task_bg
	local var_1_3 = var_3.Find(var_1_2, "schedule")

	i18n = var_4

	var_1(var_1_3, var_4("Outpost_20250904_Progress"))
...
function var_0_1.OnUpdateFlush(arg_2_0)
	...
	if 1 <= var_2_3 then
		...
		if not var_7(var_2_1, "#2572ff") then
			var_2_5 = var_2_1
		end
