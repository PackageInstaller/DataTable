	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_2_10003({
			function(arg_4_0)
				...
				local var_4_2 = var_3_10004.SUBMIT_ACTIVITY_TASK
				local var_4_3 = {}
				local var_4_4 = arg_3_1

				var_4_3.act_id = var_6.getActId(var_4_4)
				var_4_3.task_ids = {
					arg_3_1.id
				}
		...
		var_2_10002({
			function(arg_7_0)
				...
				for iter_7_0, iter_7_1 in var_7_2(var_7_1) do
					...
					var_7_4(var_7_3, var_3_10010.SUBMIT_ACTIVITY_TASK, {
						act_id = iter_7_0,
						task_ids = iter_7_1
					})
				end
...
function var_0_1.handleNotification(arg_10_0, arg_10_1)
	...
	if var_10_1 == var_10_0.SUBMIT_ACTIVITY_TASK_DONE then
		...
		if arg_10_0.awardIndex == 0 then
			...
			var_10_4(var_10_3, iter_10_0.ON_ACHIEVE, arg_10_0.showAwards, function()
		...
		if var_10_1 == var_10_4.ACTIVITY_UPDATED then
...
function var_0_1.GetTaskRedTip()
	...
	if var_13_1(var_13_0, var_1_10003.TOLOVE_TASK_ID) and not var_0:isEnd() then
		local var_13_2 = var_0:getConfig("config_data")

		pairs = var_13_0

		for iter_13_0, iter_13_1 in var_13_0(var_13_2) do
			getProxy = var_1_10007
			TaskProxy = var_1_10009
			var_1_10009 = var_1_10007(var_1_10009)

			if var_1_10007.getTaskVO(var_1_10009, iter_13_1) and var_1_10007:getTaskStatus() == 1 then
				return true
			end
		end
	end
