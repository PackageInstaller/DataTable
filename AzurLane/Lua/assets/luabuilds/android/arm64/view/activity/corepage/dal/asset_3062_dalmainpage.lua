...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_10, var_4("yumia_main_tip_3"))
	...
	var_1(var_1_12, var_4("yumia_main_tip_2"))
	...
	var_1(var_1_14, var_4("yumia_main_tip_1"))
...
function var_0_1.updateUI(arg_5_0)
	...
	local var_5_2, var_5_3 = var_5_1(var_5_0, var_1_10004.shop_template[arg_5_0.shop_id].time)
	local var_5_4
	local var_5_6
	...
	local var_5_10, var_5_11 = var_5_9(var_5_8, var_7.activity_template[arg_5_0.activity.id].time)
	local var_5_12
	local var_5_14
	...
	var_5_14(var_5_16, var_10("tolovemainpage_build_countdown"))
	...
	var_5_14(arg_5_0, arg_5_0.shop, function()
		...
		var_6_3(var_6_2, var_2_10003.GO_CHANGE_SHOP)
	...
	var_5_14(arg_5_0, arg_5_0.build, function()
		...
		local var_7_4 = var_2_10003.EVENT_GO_SCENE

		SCENE = var_2_10004

		local var_7_5 = var_2_10004.GETBOAT
		local var_7_6 = {}

		BuildShipScene = var_2_10006
		var_7_6.page = var_2_10006.PAGE_BUILD
		BuildShipScene = var_6
		var_7_6.projectName = var_6.PROJECTS.ACTIVITY
	...
	var_5_14(arg_5_0, arg_5_0.fight, function()
		...
		var_8_1(var_8_0, var_2_10003.ON_COLLAB_BOSSRUSH_MAP)
...
function var_0_1.skinCommdityTimeStamps(arg_9_0, arg_9_1)
	...
	local var_9_2 = var_1_10003.max(arg_9_1 - var_9_1, 0)

	math = var_9_0

	local var_9_3 = var_9_0.floor(var_9_2 / 0)
