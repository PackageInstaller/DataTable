...
function NewServerPTShopConst.isGoodOnSell(arg_3_0, arg_3_1)
	return var_0_0.isGoodInTime(arg_3_0, arg_3_1) and arg_3_0:isLeftCount()
end

function NewServerPTShopConst.isGoodSellOut(arg_4_0, arg_4_1)
	return var_0_0.isGoodInTime(arg_4_0, arg_4_1) and not arg_4_0:isLeftCount()
end
...
function NewServerPTShopConst.GetAllGoodVOList(arg_6_0)
	arg_6_0 = arg_6_0 or var_0_0.GetActivity()

	local var_6_0 = {}

	for iter_6_0, iter_6_1 in pairs(arg_6_0.data2KeyValueList) do
		local var_6_1 = NewServerPTGood.New(iter_6_0)

		var_6_1:updateAllInfo(arg_6_0)
...
function NewServerPTShopConst.GetStartTime(arg_10_0)
...
function NewServerPTShopConst.GetSecSinceStart(arg_11_0)
	...
	return var_11_0:GetServerTime() - var_0_0.GetStartTime(arg_11_0)
end

function NewServerPTShopConst.isGoodInTime(arg_12_0, arg_12_1)
