...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	if var_1.CanFetchRank(var_3_0, var_0_2) then
		...
		var_3_2(var_3_1, var_5.MINI_GAME_FRIEND_RANK, {
			id = var_0_2,
			callback = function(...)
	...
	local function var_3_5()
		...
		var_2_10001(arg_3_0.rankPanel, not var_5_0)
		...
		if not var_5_0 then
			...
			local var_5_8 = var_2_10007.SEND_MINI_GAME_OP
			local var_5_9 = {
				hubid = var_5_4.id
			}

			MiniGameOPCommand = var_9
			var_5_9.cmd = var_9.CMD_SPECIAL_TRACK
			var_5_9.args1 = {
				var_0_2,
				var_5_5
			}
	...
	var_3_2(var_3_3, var_3_4, var_3_5, var_1_10007)
	...
	var_2.make(var_3_9, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventInit then
			var_7_0 = arg_7_2:Find("item_mask/item")
			pg = var_2_10004

			local var_7_1 = var_2_10004.mini_game[var_0_2].simple_config_data.drop[arg_7_1 + 1]
			local var_7_2 = {
				type = var_7_1[1],
				id = var_7_1[2],
				count = var_7_1[3]
			...
			var_6(var_7_3, var_7_4, var_7_5, var_2_10011)
			...
			if arg_7_0 == var_7_0.EventUpdate then
				setActive = var_3
	...
	local function var_3_13()
		...
		var_9_1(var_9_0, var_2_10003.GO_MINI_GAME, var_0_2)
	...
	var_2(var_3_11, var_3_12, var_3_13, var_1_10007)
	...
	local function var_3_16()
		...
		pg = var_2_10004
		var_10_2.helps = var_2_10004.gametip.racing_minigame_help.tip
	...
	local var_3_18 = var_4.Find(var_3_17, "cost_static")

	i18n = var_3_15

	var_2(var_3_18, var_3_15("racing_cost"))

	setText = var_2

	local var_3_19 = arg_3_0.rankPanel
	local var_3_20 = var_4.Find(var_3_19, "static/top_text")

	i18n = var_5

	var_2(var_3_20, var_5("racing_rank_top_text"))

	setText = var_2

	local var_3_21 = arg_3_0.rankPanel
	local var_3_22 = var_4.Find(var_3_21, "static/half_h_static")

	i18n = var_5

	var_2(var_3_22, var_5("racing_rank_half_h"))

	setText = var_2

	local var_3_23 = arg_3_0.rankBlank
	local var_3_24 = var_4.Find(var_3_23, "text")

	i18n = var_5

	var_2(var_3_24, var_5("racing_rank_no_data"))
...
function var_0_1.updateRankTf(arg_12_0, arg_12_1)
	...
	arg_12_1 = var_1_10005.filter(arg_12_1, function(arg_13_0)
	...
	var_5(var_7.Find(var_12_3, "list_panel/scroll_bar/handle"), #arg_12_1 > 5)
	...
	var_5.StaticAlign(arg_12_0.rankContainer, arg_12_0.rankTpl, #arg_12_1, function(arg_14_0, arg_14_1, arg_14_2)
		...
		var_3(var_14_0, var_6.getScoreString(var_14_1, arg_12_1[arg_14_1 + 1].score))
...
function var_0_1.updateRankFaceTf(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	...
	var_1_10006("qicon/" .. var_17_1:getPainting(), function(arg_18_0)
		...
		typeof = var_4
		Image = var_2_10006
		var_18_2(var_18_1, var_4(var_2_10006)).sprite = arg_18_0
...
function var_0_1.updateRankSelfTf(arg_19_0, arg_19_1, arg_19_2)
	...
	var_8(var_10.Find(var_19_7, "name"), var_19_5.name)

	setText = var_8

	local var_19_8 = arg_19_0.rankSelf

	var_8(var_10.Find(var_19_8, "score"), arg_19_0:getScoreString(var_19_5.score))

	local var_19_9 = arg_19_0
	local var_19_10 = arg_19_0.updateRankPosTf
	local var_19_11 = arg_19_0.rankSelf

	var_19_10(var_19_9, var_11.Find(var_19_11, "position"), var_19_5.position)

	local var_19_12 = arg_19_0
	local var_19_13 = arg_19_0.updateRankFaceTf
	local var_19_14 = arg_19_0.rankSelf

	var_19_13(var_19_12, var_11.Find(var_19_14, "face"), var_19_5.display, nil)
