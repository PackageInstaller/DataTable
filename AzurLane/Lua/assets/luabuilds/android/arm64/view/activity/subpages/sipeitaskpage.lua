...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	local function var_6_5()
		...
		var_7_1(var_7_0, var_2_10003.ON_DROP, var_6_2)
	...
	var_3(var_6_3, var_6_4, var_6_5, var_1_10008)
	...
	var_6_6(var_6_10, var_8.getConfig(var_6_11, "desc"))

	setText = var_6_6

	var_6_6(arg_6_0.progress, var_6_7 .. "/" .. var_6_9)

	setSlider = var_6_6

	var_6_6(arg_6_0.slider, 0, var_6_9, var_6_7)
	...
	var_6_8(arg_6_0.battleBtn, var_6_13 == 0)

	setActive = var_6_8

	var_6_8(arg_6_0.getBtn, var_6_13 == 1)

	setActive = var_6_8

	var_6_8(arg_6_0.gotBtn, var_6_13 == 2)
