	...
	arg_1_0:bind(var_0_1.ON_SETTLE, function()
		if arg_1_0.contextData.win then
			...
			if var_2_0 == var_2_10001 then
				...
				var_2_0(var_2_1, var_2_10003.GO_BACK)
...
function var_0_1.ShowTotalAward(arg_13_0, arg_13_1)
	...
	if not var_3.getActivityById(var_13_1, var_13_0) or not var_3:getConfig("config_client").mediator then
		var_13_2 = "BossRushKurskMediator"
	end

	getProxy = var_13_1
	ContextProxy = var_1_10007

	local var_13_3 = var_13_1(var_1_10007)
	local var_13_4 = var_5.getContextByMediator

	_G = var_1_10008

	local var_13_5, var_13_6 = var_13_4(var_13_3, var_1_10008[var_13_2])

	getProxy = var_13_3
	ActivityProxy = var_1_10009

	local var_13_7 = var_13_3(var_1_10009)
	local var_13_8, var_13_9 = var_7.GetContinuousTime(var_13_7)
	local var_13_10 = var_13_6
	local var_13_11 = var_13_6.addChild

	Context = var_1_10012

	local var_13_12 = var_1_10012.New
	local var_13_13 = {}

	BossRushTotalRewardPanelMediator = var_1_10015
	var_13_13.mediator = var_1_10015
	BossRushTotalRewardPanel = var_1_10015
	var_13_13.viewComponent = var_1_10015
	var_13_13.data = {
		isLayer = true,
		rewards = arg_13_1,
	...
	var_13_15(var_13_14, var_12.GO_BACK)
