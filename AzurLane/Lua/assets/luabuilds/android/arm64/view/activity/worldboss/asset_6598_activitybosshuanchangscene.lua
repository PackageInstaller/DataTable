...
function var_0_1.init(arg_2_0)
	...
	for iter_2_0 = 1, 4 do
		...
		var_2_4[iter_2_0] = var_6.Find(var_2_5, iter_2_0)
	end
	...
	arg_2_0.rankList = var_2_12(var_3.Find(var_2_13, "layout"), 3)
	ipairs = var_1

	for iter_2_1, iter_2_2 in var_1(arg_2_0.rankList) do
		setActive = var_6

		var_6(iter_2_2, false)
	end
	...
	local var_2_25 = var_4.Find(var_2_24, "back_btn")
	...
	var_1(var_2_23, var_2_25, var_2_26, var_2_24)
...
function var_0_1.UpdateDropItems(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10001(var_4_0) do
		...
		var_8(var_4_4, var_4_5, var_4_6, var_13)
	end
...
function var_0_1.UpdatePage(arg_6_0)
	...
	var_1_10002(var_6_1, var_1_10005.floor(var_6_0 / 100))
	...
	var_1_10002(var_6_2, var_5.format("%02d", var_6_0 % 100) .. "%")
	...
	for iter_6_0 = 1, 4 do
		...
		local var_6_5 = var_6_4:Find("Slider")
		local var_6_6 = 0
		local var_6_7 = 2500

		math = var_13

		local var_6_8 = var_13.min

		math = var_1_10015

		var_6_9(var_6_5, var_6_6, var_6_7, var_6_8(var_1_10015.max(var_6_0 - (iter_6_0 - 1) * 2500, 0), 2500))

		local var_6_9 = arg_6_0.contextData.mileStones[5 - iter_6_0]

		setActive = var_1_10009

		var_1_10009(var_6_4:Find("milestone/item"), not var_6_9)

		setActive = var_1_10009

		var_1_10009(var_6_4:Find("milestone/time"), var_6_9)

		if var_6_9 then
			var_1_10009 = var_6_3:STimeDescC(arg_6_0.contextData.mileStones[5 - iter_6_0], "%m/%d/%H:%M")
			setText = var_6_5
			var_1_10014 = var_6_4

			var_6_5(var_6_4.Find(var_1_10014, "milestone/time/Text"), var_1_10009)
		end
	end

	for iter_6_1 = 1, #arg_6_0.stageList - 1 do
		local var_6_10 = arg_6_0.contextData.normalStageIDs[iter_6_1]
		local var_6_11 = arg_6_0.stageList[iter_6_1]
		...
		for iter_6_2, iter_6_3 in var_1_10009(arg_6_0.contextData.ticketInitPools) do
			...
			for iter_6_4, iter_6_5 in var_1_10014(iter_6_3[1]) do
				if iter_6_5 == var_6_10 then
					local var_6_12 = iter_6_3[2]
					local var_6_13

					if not arg_6_0.contextData.stageTickets[var_6_10] then
						var_6_13 = 0
					end

					local var_6_14 = var_6_11:Find("count")

					setActive = var_1_10022

					var_1_10022(var_6_14, var_6_13 > 0)

					setText = var_1_10022

					var_1_10022(var_6_14:Find("res"), var_6_13)

					setText = var_1_10022

					var_1_10022(var_6_14:Find("max"), var_6_12)
				end
			end
		end
	end
	...
	local var_6_15 = arg_6_0.awardFlash
	local var_6_16 = arg_6_0.contextData.ptData

	var_3(var_6_15, var_6.CanGetAward(var_6_16))

	if arg_6_0.bonusWindow then
		local var_6_17 = arg_6_0.bonusWindow

		if var_3.IsShowing(var_6_17) then
			local var_6_18 = arg_6_0.bonusWindow.buffer

			var_3.UpdateView(var_6_18, arg_6_0.contextData.ptData)
		end
	end

	local var_6_19 = arg_6_0:GetEXTicket()

	setText = var_4

	var_4(arg_6_0.ticketNum, var_6_19)
...
function var_0_1.UpdateRank(arg_7_0, arg_7_1)
	...
	for iter_7_0 = 1, #arg_7_0.rankList do
		...
		if iter_7_0 <= #arg_7_1 then
			var_1_10007 = var_7_0:Find("Text")
			tostring = var_1_10008

			local var_7_2

			if #var_1_10008(arg_7_1[iter_7_0].name) >= 11 then
				local var_7_1 = var_1_10007

				var_7_2 = var_1_10007.GetComponent
				typeof = var_1_10012
				Text = var_1_10014
				var_7_2 = var_7_2(var_7_1, var_1_10012(var_1_10014))
				var_7_2.fontSize = 23
			else
				local var_7_3 = var_1_10007

				var_7_2 = var_1_10007.GetComponent
				typeof = var_1_10012
				Text = var_1_10014
				var_7_2 = var_7_2(var_7_3, var_1_10012(var_1_10014))
				var_7_2.fontSize = 28
			end

			setText = var_7_2

			var_7_2(var_1_10007, var_1_10008)
		end
	end
