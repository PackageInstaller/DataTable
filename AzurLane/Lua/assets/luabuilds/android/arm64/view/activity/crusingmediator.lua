...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.EVENT_OPEN_TASK, function(arg_2_0)
		...
		CrusingTaskMediator = var_2_10007
		var_2_3.mediator = var_2_10007
		CrusingTaskLayer = var_2_10007
	...
	arg_1_0:bind(var_0_1.EVENT_GET_AWARD_PAY, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10005.CRUSING_CMD, {
			cmd = 3,
			activity_id = arg_1_0.viewComponent.activity.id,
			arg1 = arg_4_1
		})
	...
	arg_1_0:bind(var_0_1.EVENT_GET_AWARD_ALL, function(arg_5_0)
		...
		var_5_1(var_5_0, var_2_10004.CRUSING_CMD, {
			cmd = 4,
			activity_id = arg_1_0.viewComponent.activity.id
		})
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_1 == var_9_0.ACTIVITY_UPDATED then
		...
		if var_9_1 == var_4.CRUSING_CMD_DONE then
			local var_9_7 = arg_9_0.viewComponent
			local var_9_8 = var_4.emit

			BaseUI = var_1_10007

			var_9_8(var_9_7, var_1_10007.ON_ACHIEVE, var_9_2.awards)
		else
			local var_9_9

			if var_9_1 == var_0_1.UNFROZEN_MAP_UPDATE then
				...
				if var_9_1 == var_9_9.UPDATED then
					...
					if var_9_1 == var_4.CHARGE_SUCCESS then
						Goods = var_4
						...
						local var_9_14 = var_9_12(var_9_13, var_7.TYPE_CHARGE)
