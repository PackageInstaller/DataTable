...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.SUBMIT_TASK_ALL, function(arg_2_0, arg_2_1)
		...
		var_2.checkActStory(var_2_0, arg_2_1.activityId, arg_2_1.ids, function()
			...
			var_3_1(var_3_0, var_3_10003.SUBMIT_ACTIVITY_TASK, {
	...
	arg_1_0:bind(var_0_1.SUBMIT_TASK, function(arg_4_0, arg_4_1)
		...
		var_2.checkActStory(var_4_0, arg_4_1.activityId, {
			...
			var_5_1(var_5_0, var_3_10003.SUBMIT_ACTIVITY_TASK, {
	...
	arg_1_0:bind(var_0_1.TASK_GO, function(arg_6_0, arg_6_1)
		...
		if var_6_2 == var_6_1.OTHERWORLD_MAP then
			pg = var_6_2
			...
			var_6_4(var_6_3, var_2_10006.OTHERWORLD_MAP, {
				mode = var_2[2].mode
			})
		else
			...
			var_6_6(var_6_5, var_2_10006.TASK_GO, {
...
function var_0_1.handleNotification(arg_13_0, arg_13_1)
	...
	if var_13_1 == var_13_0.SUBMIT_ACTIVITY_TASK_DONE then
		if #var_13_2.awards > 0 then
			...
			var_13_4(var_13_3, var_1_10007.ON_ACHIEVE, var_13_2.awards)
		end
		...
		if var_13_1 == var_13_4.ZERO_HOUR_OP_DONE then
