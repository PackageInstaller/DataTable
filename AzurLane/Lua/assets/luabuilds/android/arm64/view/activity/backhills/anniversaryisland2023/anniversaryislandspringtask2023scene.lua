...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.taskListRect = var_1_10002(var_2_1, "LScrollRect")
	...
	local var_2_4 = var_4.Find(var_2_3, "Desc/Text")

	i18n = var_5

	var_2_2(var_2_4, var_5("springtask_tip"))

	setActive = var_2_2

	local var_2_5 = arg_2_0._tf

	var_2_2(var_4.Find(var_2_5, "Top/Help"), false)
...
function var_0_1.BuildTaskVOs(arg_4_0)
	...
	local var_4_2 = var_4_1(var_4_0, var_1_10004.ACTIVITY_TYPE_HOTSPRING_2)
	local var_4_3 = var_1.GetUnlockTaskIds(var_4_2)

	arg_4_0.activityId = var_1:GetConfigID()
	getProxy = var_4_2
	ActivityTaskProxy = var_1_10006

	local var_4_4 = var_4_2(var_1_10006)
	local var_4_5 = var_4.getTaskVOsByActId(var_4_4, var_3)
	...
	arg_4_0.taskVOs = var_5.map(var_4_3, function(arg_5_0)
		...
		if not var_2_10001.detect(var_4_5, function(arg_6_0)
			return arg_6_0:GetConfigID() == arg_5_0
		end) then
			ActivityTask = var_2_10002
			var_5_0 = var_2_10002.New(var_0, {
				id = arg_5_0
			})
	...
	var_4_4.sort(arg_4_0.taskVOs, var_4_6)
...
function var_0_1.UpdateTaskListItem(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_3 = var_1_10006.task_data_template[var_10_2]
	...
	local var_10_8 = var_4
	local var_10_9 = var_4.getProgress(var_10_8)
	local var_10_10 = var_4:getTargetNumber()

	setActive = var_10_8

	var_10_8(var_10_0:Find("Lock"), arg_10_0.lockTasks[var_4])

	setText = var_10_8

	var_10_8(var_10_0:Find("BG/Progress"), var_10_9 .. "/" .. var_10_10)

	setSlider = var_10_8

	var_10_8(var_10_0:Find("BG/ProgressBar"), 0, var_10_10, var_10_9)

	changeToScrollText = var_10_8

	var_10_8(var_10_0:Find("BG/Name/Text"), var_10_3.name)

	setActive = var_10_8

	var_10_8(var_10_0:Find("BG/Go"), not var_10_5 and not var_10_4)

	setActive = var_10_8

	var_10_8(var_10_0:Find("BG/Commit"), not var_10_5 and var_10_4 and var_10_6)

	setActive = var_10_8

	var_10_8(var_10_0:Find("BG/Reward"), not var_10_5 and var_10_4 and not var_10_6)

	setActive = var_10_8

	var_10_8(var_10_0:Find("BG/Got"), var_10_5)

	UIItemList = var_10_8

	local var_10_11 = var_10_8.StaticAlign
	local var_10_12 = var_10_0:Find("BG/Items")
	local var_10_13 = var_10_0:Find("BG/Items")

	var_10_11(var_10_12, var_16.GetChild(var_10_13, 0), #var_10_7, function(arg_11_0, arg_11_1, arg_11_2)
		...
		var_5(arg_10_0, arg_11_2, function()
			...
			var_12_1(var_12_0, var_3_10003.ON_DROP, var_11_1)
	...
	local var_10_15 = var_10_0
	local var_10_16 = var_10_0.Find(var_10_15, "BG/Go")
	...
	local function var_10_17()
		...
		var_13_1(var_13_0, var_2_10003.TASK_GO, {
			taskVO = var_0
		})
	...
	var_10_11(var_10_14, var_10_16, var_10_17, var_10_15)

	onButton = var_10_11

	local var_10_18 = arg_10_0
	local var_10_19 = var_10_0
	local var_10_20 = var_10_0.Find(var_10_19, "BG/Commit")
	...
	local function var_10_21()
		...
		var_14_1(var_14_0, var_2_10003.SHOW_SUBMIT_WINDOW, var_0)
	...
	var_10_11(var_10_18, var_10_20, var_10_21, var_10_19)

	onButton = var_10_11

	local var_10_22 = arg_10_0
	local var_10_23 = var_10_0
	local var_10_24 = var_10_0.Find(var_10_23, "BG/Reward")
	...
	local function var_10_25()
		...
		var_15_1(var_15_0, var_2_10003.SUBMIT_TASK, var_0)
	...
	var_10_11(var_10_22, var_10_24, var_10_25, var_10_23)
...
function var_0_1.didEnter(arg_16_0)
	...
	local var_16_2 = var_4.Find(var_16_1, "Top/Back")
	...
	var_1_10001(var_16_0, var_16_2, var_16_3, var_16_1)

	onButton = var_1_10001

	local var_16_4 = arg_16_0
	local var_16_5 = arg_16_0._tf
	local var_16_6 = var_4.Find(var_16_5, "Top/Home")
	...
	var_1_10001(var_16_4, var_16_6, var_16_7, var_16_5)

	onButton = var_1_10001

	local var_16_8 = arg_16_0
	local var_16_9 = arg_16_0._tf
	local var_16_10 = var_4.Find(var_16_9, "Top/Help")
	...
	local function var_16_11()
		...
		i18n = var_2_10004
		var_19_2.helps = var_2_10004("springtask_help")
	...
	var_1_10001(var_16_8, var_16_10, var_16_11, var_16_9)
