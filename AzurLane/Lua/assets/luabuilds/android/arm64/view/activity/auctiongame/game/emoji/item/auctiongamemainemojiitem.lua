...
function var_0_1.Init(arg_2_0)
	...
	local function var_2_2()
		...
		local var_3_1 = var_0:GetSendEmojiTimestamp()

		pg = var_2_10002

		local var_3_2 = var_3_1 + var_2_10002.gameset.auction_emoji_duration.key_value

		pg = var_2

		local var_3_3 = var_2.TimeMgr.GetInstance()

		if var_3_2 > var_2.GetServerTime(var_3_3) then
			pg = var_3_2

			local var_3_4 = var_3_2.TipsMgr.GetInstance()
			local var_3_5 = var_1.ShowTips

			i18n = var_3_3

			var_3_5(var_3_4, var_3_3("donot_send_emoji_frequently"))
		...
		AuctionGameMainEmojiMediator = var_3_3

		var_3_7(var_3_6, var_3_3.ON_CLICK_EMOJI, arg_2_0.id)
...
function var_0_1.didEnter(arg_4_0, arg_4_1)
	...
	local var_4_0 = var_2.emoji_template[arg_4_1]

	PoolMgr = var_1_10003

	local var_4_1 = var_1_10003.GetInstance()

	var_3.GetPrefab(var_4_1, "emoji/" .. var_4_0.pic, var_4_0.pic, true, function(arg_5_0)
		IsNil = var_2_10001
		...
		if not var_2_10001(arg_4_0._tf) then
			...
			if var_5_1(var_5_0, var_2_10004(var_2_10006)) then
				var_5_1.preserveAspect = true
			end

			tf = var_2_10002

			local var_5_2 = var_2_10002(arg_5_0)

			Vector2 = var_5_0
			var_5_2.anchoredPosition = var_5_0.zero
			rtf = var_5_2
			...
			var_1.ReturnPrefab(var_5_4, "emoji/" .. var_4_0.pic, var_4_0.pic, arg_5_0)
		end
