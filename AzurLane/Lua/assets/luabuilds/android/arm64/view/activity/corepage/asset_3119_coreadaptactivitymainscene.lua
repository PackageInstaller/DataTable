...
local var_0_0 = "CoreAdaptActivityMainScene"
...
function var_0_1.init(arg_2_0, ...)
	...
	arg_2_0.btnBack = var_1.Find(var_2_0, "adapt/TopPage/top/btn_back")

	arg_2_0:CustomInit()

	local var_2_1
	local var_2_2 = arg_2_0.tabsList
			...
			if var_3.detect(arg_2_0.activities, function(arg_4_0)
				...
				elseif not arg_2_0.pageDic[var_3.id] then
					...
					if arg_2_0.pageDic[var_3.id] ~= nil then
						...
						var_5(var_3_5, var_3.readyToAchieve(var_3_6))
						...
						local function var_3_9(arg_5_0)
							if arg_5_0 then
								local var_5_0 = arg_2_0

								var_1.selectActivity(var_5_0, var_0)

								if var_2_1 ~= var_0.id then
						...
						var_5(var_3_7, var_3_8, var_3_9, var_3_6)
					end
				end
	...
	local var_2_3 = var_2.CameraFixMgr.GetInstance()
	local var_2_4 = var_2.bind

	pg = var_5
	arg_2_0.camEventId = var_2_4(var_2_3, var_5.CameraFixMgr.ASPECT_RATIO_UPDATE, function(arg_6_0, arg_6_1)
	...
	local var_2_7 = var_5.Find(var_2_6, "adapt/TopPage/top/btn_back")
	...
	var_2(var_2_5, var_2_7, var_2_8, var_2_6)
...
function var_0_1.CustomInit(arg_10_0)
	return
end

function var_0_1.GetButtonNameText(arg_11_0, arg_11_1)
	return
end

function var_0_1.OnClickBtn(arg_12_0, arg_12_1, arg_12_2)
	return
end
