...
function var_0_1.ShowNextPainting(arg_4_0)
	...
	var_2({
		function(arg_5_0)
			...
			local var_5_2 = var_2_10004.value
			local var_5_3

			go = var_2_10006

			local var_5_4 = var_5_1(var_5_0, var_5_2, var_5_3, var_2_10006(arg_4_0.paintTF), 1, 0, var_0_4 / 2)
			...
			local var_5_6 = var_5_5(var_5_4, var_5_2.Action_float(function(arg_6_0)
				...
				var_3_10001(var_6_0, var_3_10004(var_3_10006)).alpha = arg_6_0
			...
			var_5_7(var_5_6, var_4.Action(function()
				arg_5_0()
		...
		function(arg_8_0)
			...
			var_2_10001("ui/activityuipage/idolv3mainpage_atlas", var_4_0, function(arg_9_0)
				...
				typeof = var_3_10004
				Image = var_3_10006
				var_9_1(var_9_0, var_3_10004(var_3_10006)).sprite = arg_9_0
		...
		function(arg_10_0)
			...
			local var_10_2 = var_2_10004.value
			local var_10_3

			go = var_2_10006

			local var_10_4 = var_10_1(var_10_0, var_10_2, var_10_3, var_2_10006(arg_4_0.paintTF), 0, 1, var_0_4 / 2)
			...
			local var_10_6 = var_10_5(var_10_4, var_10_2.Action_float(function(arg_11_0)
				...
				typeof = var_3_10004
				CanvasGroup = var_3_10006
				var_3_10001(var_11_0, var_3_10004(var_3_10006)).alpha = arg_11_0
			...
			var_10_7(var_10_6, var_4.Action(function()
				arg_10_0()
