...
var_0_1.BIND_EVENT_ACT_ID = var_0_0.OTHER_WORLD_TERMINAL_EVENT_ID
pg = var_2
...
function var_0_1.OnLoaded(arg_3_0)
	...
	var_3_0.name = var_1_10002(var_1_10004.PAGE_PERSONAL)
	...
	local var_3_3 = var_3.Find(var_3_2, "title/content/Text")

	i18n = var_4

	var_1(var_3_3, var_4("personal_info_title"))
	...
	local var_3_16 = var_3.Find(var_3_15, "title/content/Text")

	i18n = var_4

	var_1(var_3_16, var_4("personal_property_title"))
	...
	var_1(var_3.Find(var_3_19, "upgrade"), false)
	...
	if var_1 ~= var_2 then
		...
		if var_1 == var_2 then
			...
			var_1(var_3.Find(var_3_21, "frame/ability_2"), false)
		else
			...
			var_1(var_3.Find(var_3_23, "frame/ability"), false)
		end
		...
		local var_3_25 = var_3.Find(var_3_24, "title/content/Text")

		i18n = var_4

		var_1(var_3_25, var_4("personal_ability_title"))
		...
		local var_3_30 = var_3.Find(var_3_29, "Text")

		i18n = var_4

		var_1(var_3_30, var_4("personal_random"))
		...
		local var_3_33 = var_3.Find(var_3_32, "Text")

		i18n = var_4

		var_1(var_3_33, var_4("personal_random"))
...
function var_0_1.OnInit(arg_4_0)
	...
	var_1(var_3.Find(var_4_11, "infos/name/box/edit"), arg_4_0.unlockRandom)
	...
	typeof = var_4
	InputField = var_6
	var_4_13(var_4_12, var_4(var_6)).interactable = arg_4_0.unlockRandom
...
function var_0_1.UpdateView(arg_9_0, arg_9_1)
	if arg_9_0.contextData.upgrade then
		...
		if arg_9_0.contextData.upgrade then
			...
			for iter_9_2, iter_9_3 in var_3(var_5.GetShowConfig(var_9_3)) do
...
function var_0_1.UpdateInfo(arg_11_0, arg_11_1)
	...
	local var_11_0 = arg_11_0:GetRollAttrInfoById(var_0_1.NAME_ID, arg_11_1)

	setText = var_1_10003

	var_1_10003(arg_11_0.nameTitle, var_11_0 .. "：")

	local var_11_1 = arg_11_0
	local var_11_2, var_11_3 = arg_11_0.GetRollAttrInfoById(var_11_1, var_0_1.JOB_ID, arg_11_1)

	setText = var_11_1

	var_11_1(arg_11_0.jobTitle, var_11_2 .. "：")

	setText = var_11_1

	var_11_1(arg_11_0.jobValue, var_11_3)

	local var_11_4 = arg_11_0
	local var_11_5, var_11_6 = arg_11_0.GetRollAttrInfoById(var_11_4, var_0_1.GUARDIAN_ID, arg_11_1)

	setText = var_11_4

	var_11_4(arg_11_0.guardianTitle, var_11_5 .. "：")

	setText = var_11_4

	var_11_4(arg_11_0.guardianValue, var_11_6)

	local var_11_7 = arg_11_0
	local var_11_8, var_11_9 = arg_11_0.GetRollAttrInfoById(var_11_7, var_0_1.LV_ID, arg_11_1)

	setText = var_11_7

	var_11_7(arg_11_0.lvTitle, var_11_8 .. "：")

	setText = var_11_7

	var_11_7(arg_11_0.lvValue, var_11_9)

	setSlider = var_11_7

	local var_11_10 = arg_11_0.lvSlider
	local var_11_11 = 0
	local var_11_12 = 1

	tonumber = var_1_10014

	var_11_7(var_11_10, var_11_11, var_11_12, var_1_10014(var_11_9) / var_0_1.config[var_0_1.LV_ID].random_value[2])

	if arg_11_1 then
		OtherworldMapScene = var_11_7

		local var_11_13 = var_11_7.personalRandomData

		var_11_13[var_0_1.JOB_ID] = var_11_3
		OtherworldMapScene = var_11_13

		local var_11_14 = var_11_13.personalRandomData

		var_11_14[var_0_1.GUARDIAN_ID] = var_11_6
		OtherworldMapScene = var_11_14
		var_11_14.personalRandomData[var_0_1.LV_ID] = var_11_9
	end
...
function var_0_1.UpdateProperty(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in var_1_10003(var_0_1.PROPERTY_IDS) do
		...
		if arg_12_0.propertyContent.childCount < var_12_0 then
			...
			local var_12_4, var_12_5 = arg_12_0.GetRollAttrInfoById(var_12_3, iter_12_1, arg_12_1)

			setText = var_12_3

			var_12_3(var_12_2:Find("name"), var_12_4)

			setText = var_12_3

			var_12_3(var_12_2:Find("value/Text"), var_12_5)

			if arg_12_1 then
				OtherworldMapScene = var_12_3
				var_12_3.personalRandomData[iter_12_1] = var_12_5
			end
		end
	end
	...
	for iter_12_2 = 1, arg_12_0.propertyContent.childCount - 1 do
		if var_12_0 < iter_12_2 then
			...
			local var_12_6 = arg_12_0.propertyContent

			iter_12_1(var_9.GetChild(var_12_6, iter_12_2 - 1), false)
		end
	end
...
function var_0_1.UpdateAbility(arg_13_0, arg_13_1)
	...
	if arg_13_1 then
		...
		var_13_0 = arg_13_0.GetRandomAbilityIds(var_1_10005)
	else
		OtherworldMapScene = var_1_10003

		if var_1_10003.personalRandomData then
			pairs = var_1_10003
			OtherworldMapScene = var_1_10005

			for iter_13_0, iter_13_1 in var_1_10003(var_1_10005.personalRandomData) do
				table = var_1_10008
	...
	for iter_13_4, iter_13_5 in var_3(var_13_0) do
		if arg_13_0.abilityContent.childCount < iter_13_4 then
			...
			local var_13_4, var_13_5 = arg_13_0.GetRollAttrInfoById(var_13_3, iter_13_5, arg_13_1)

			setText = var_13_3

			var_13_3(var_13_2:Find("name"), var_13_4)

			setText = var_13_3

			var_13_3(var_13_2:Find("value/Text"), var_13_5)

			if arg_13_1 then
				OtherworldMapScene = var_13_3
				var_13_3.personalRandomData[iter_13_5] = var_13_5
			end
		end
	end
	...
	for iter_13_6 = 1, arg_13_0.abilityContent.childCount do
		if #var_13_0 < iter_13_6 then
			...
			local var_13_6 = arg_13_0.abilityContent

			var_7(var_9.GetChild(var_13_6, iter_13_6 - 1), false)
		end
	end
...
function var_0_1.GetStaticInfo(arg_21_0, arg_21_1)
	...
	local var_21_3 = var_1_10003(var_21_2)
...
function var_0_1.PlayLevelAnim(arg_22_0, arg_22_1)
	...
	var_5(arg_22_0.lvUpgradeTF, var_22_2)
	...
	if var_22_2 then
		...
		var_22_4(var_22_3, var_8.delayedCall, function()
			setActive = var_2_10000
		...
		local var_22_7 = var_8.value
		local var_22_8

		go = var_10

		local var_22_9 = var_22_6(var_22_5, var_22_7, var_22_8, var_10(arg_22_0.lvValue), var_22_0, var_22_1, var_0_1.LV_ANIM_TIME)
		...
		local var_22_11 = var_22_10(var_22_9, var_22_7.Action_float(function(arg_24_0)
			...
			var_2_10001(var_24_0, var_2_10004.floor(arg_24_0))
		...
		var_22_12(var_22_11, var_8.Action(function()
			arg_22_1()
		...
		local var_22_16 = var_22_8.value
		local var_22_17

		go = var_11

		local var_22_18 = var_22_15(var_22_14, var_22_16, var_22_17, var_11(arg_22_0.lvSlider), var_22_0 / var_22_13, var_22_1 / var_22_13, var_0_1.LV_ANIM_TIME)
	...
	for iter_27_0 = 1, #var_0_1.PROPERTY_IDS do
		if iter_27_0 > arg_27_0.propertyContent.childCount then
			...
			if var_7 then
				...
				var_13(var_1_10008:Find("name"), var_0_1.config[var_27_2].name)

				setText = var_13

				var_13(var_1_10008:Find("value/Text"), var_27_3)
			end

			if var_27_5 then
				table = var_13

				var_13.insert(var_27_0, function(arg_28_0)
					setActive = var_2_10001

					local var_28_0 = var_1_10008

					var_2_10001(var_3.Find(var_28_0, "upgrade"), var_27_5)
					...
					var_28_2(var_28_1, var_4.delayedCall, function()
						setActive = var_3_10000

						local var_29_0 = var_1_10008

						var_3_10000(var_2.Find(var_29_0, "upgrade"), false)
					...
					local var_28_5 = var_4.value
					local var_28_6

					go = var_6

					local var_28_7 = var_28_4(var_28_3, var_28_5, var_28_6, var_6(var_1_10008), var_27_3, var_27_4, var_0_1.PROPERTY_TPL_ANIM_TIME)
					...
					local var_28_9 = var_28_8(var_28_7, var_28_5.Action_float(function(arg_30_0)
						...
						local var_30_1 = var_3.Find(var_30_0, "value/Text")

						math = var_3_10004

						var_3_10001(var_30_1, var_3_10004.floor(arg_30_0))
					...
					var_28_10(var_28_9, var_4.Action(function()
						arg_28_0()
		...
		for iter_35_0 = 1, #var_35_1 do
			...
			if var_35_4 then
				...
				if not var_1_10012(arg_35_0.abilityTpl, arg_35_0.abilityContent) then
					local var_35_6 = arg_35_0.abilityContent

					var_1_10012 = var_1_10012.GetChild(var_35_6, iter_35_0 - 1)
				end

				GetOrAddComponent = var_1_10013

				local var_35_7 = var_1_10012

				typeof = var_1_10016
				CanvasGroup = var_1_10018
				var_1_10013 = var_1_10013(var_35_7, var_1_10016(var_1_10018))
				...
				if var_35_0[iter_35_0] ~= var_35_5 then
					if not var_35_4 then
						...
						var_1_10013.insert(var_35_3, function(arg_36_0)
							...
							local var_36_2 = var_2_10004.value
							local var_36_3

							go = var_2_10006

							local var_36_4 = var_36_1(var_36_0, var_36_2, var_36_3, var_2_10006(var_1_10012), 1, 0, var_0_1.ABILITY_TPL_ANIM_TIME)
							...
							local var_36_8 = var_36_7(var_36_6, var_4.Action_float(function(arg_37_0)
								...
								var_3_10001(var_37_0, var_3_10004(var_3_10006)).alpha = arg_37_0
							...
							var_36_9(var_36_8, var_4.Action(function()
								setText = var_3_10000

								local var_38_0 = var_1_10012

								var_3_10000(var_2.Find(var_38_0, "name"), var_0_1.config[var_35_5].name)

								setText = var_3_10000

								local var_38_1 = var_1_10012

								var_3_10000(var_2.Find(var_38_1, "value/Text"), arg_35_0.upgradeCfg[var_35_5])
								arg_36_0()
					...
					var_1_10013.insert(var_35_3, function(arg_39_0)
						if var_35_4 then
							...
							local var_39_0 = var_1_10012

							var_1(var_3.Find(var_39_0, "name"), var_0_1.config[var_35_5].name)

							setText = var_1

							local var_39_1 = var_1_10012

							var_1(var_3.Find(var_39_1, "value/Text"), arg_35_0.upgradeCfg[var_35_5])
						end

						local var_39_2 = arg_35_0
						local var_39_3 = var_1.managedTween

						LeanTween = var_2_10004

						local var_39_4 = var_2_10004.value
						local var_39_5

						go = var_2_10006

						local var_39_6 = var_39_3(var_39_2, var_39_4, var_39_5, var_2_10006(var_1_10012), 0, 1, var_0_1.ABILITY_TPL_ANIM_TIME)
						local var_39_7 = var_1.setEase

						LeanTweenType = var_39_4

						local var_39_8 = var_39_7(var_39_6, var_39_4.easeOutBack)
						local var_39_9 = var_1.setOnUpdate

						System = var_4

						local var_39_10 = var_39_9(var_39_8, var_4.Action_float(function(arg_40_0)
							GetOrAddComponent = var_3_10001
							...
							typeof = var_3_10004
							CanvasGroup = var_3_10006
							var_3_10001(var_40_0, var_3_10004(var_3_10006)).alpha = arg_40_0

							return
						end))
						local var_39_11 = var_1.setOnComplete

						System = var_4

						var_39_11(var_39_10, var_4.Action(function()
							arg_39_0()
