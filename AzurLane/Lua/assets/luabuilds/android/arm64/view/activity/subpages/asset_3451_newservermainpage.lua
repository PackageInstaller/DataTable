...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1_10001(arg_2_0, arg_2_0.shopBtn, function()
		...
		local var_3_3 = var_2_10004.NEW_SERVER_CARNIVAL
		local var_3_4 = {}

		NewServerCarnivalScene = var_2_10006
		var_3_4.page = var_2_10006.SHOP_PAGE
	...
	var_1_10001(arg_2_0, arg_2_0.buildBtn, function()
		...
		if var_4_1(var_4_0, var_2_10003.ACTIVITY_TYPE_NEWSERVER_BUILD) and not var_0:isEnd() then
			...
			var_4_4.page = var_2_10007.PAGE_NEWSERVER

			var_4_3(var_4_2, var_2_10004, var_2_10005, var_4_4)
		else
			...
			local var_4_7 = var_2_10004.EVENT_GO_SCENE

			SCENE = var_2_10005

			var_4_6(var_4_5, var_4_7, var_2_10005.GETBOAT)
		end
...
function var_0_1.updateTime(arg_6_0)
	...
	local var_6_3 = var_6_1(var_6_0, var_5.getStartTime(var_6_2), "%m.%d")
	local var_6_4 = var_1:STimeDescS(arg_6_0.activity.stopTime, "%m.%d %H:%M")

	setText = var_6_0

	var_6_0(arg_6_0.time, var_6_3 .. " - " .. var_6_4)
