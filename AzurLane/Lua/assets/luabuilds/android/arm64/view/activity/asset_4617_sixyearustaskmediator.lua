	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_2_10003({
			...
			function(arg_5_0)
				...
				local var_5_2 = var_3_10004.SUBMIT_ACTIVITY_TASK
				local var_5_3 = {}
				local var_5_4 = arg_3_1

				var_5_3.act_id = var_6.getActId(var_5_4)
				var_5_3.task_ids = {
					arg_3_1.id
				}
		...
		var_2_10002({
			...
			function(arg_9_0)
				...
				for iter_9_0, iter_9_1 in var_9_2(var_9_1) do
					...
					var_9_4(var_9_3, var_3_10010.SUBMIT_ACTIVITY_TASK, {
						act_id = iter_9_0,
						task_ids = iter_9_1
					})
				end
...
function var_0_1.settleTownGold(arg_12_0, arg_12_1, arg_12_2)
	...
	if var_1_10003.any(arg_12_1, function(arg_13_0)
		...
		local var_12_2 = var_6.ACTIVITY_TOWN_OP
		local var_12_3 = {
			activity_id = arg_12_0.townActId
		}

		TownActivity = var_8
		var_12_3.cmd = var_8.OPERATION.SETTLE_GOLD
...
function var_0_1.handleNotification(arg_15_0, arg_15_1)
	...
	if var_15_1 == var_15_0.SUBMIT_ACTIVITY_TASK_DONE then
		...
		if arg_15_0.awardIndex == 0 then
			...
			var_15_4(var_15_3, iter_15_0.ON_ACHIEVE, arg_15_0.showAwards, function()
		...
		if var_15_1 == var_15_4.ACTIVITY_UPDATED then
...
function var_0_1.GetTaskRedTip()
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10003.SIX_YEAR_US_TASK_ACT_ID)

	getProxy = var_1_10001
	ActivityProxy = var_3

	local var_18_3 = var_1_10001(var_3)
	local var_18_4 = var_1.getActivityById

	ActivityConst = var_1_10004

	local var_18_5 = var_18_4(var_18_3, var_1_10004.SIX_YEAR_US_TASK_2_ACT_ID)

	if var_18_2 and not var_18_2:isEnd() then
		local var_18_6 = var_18_2:getConfig("config_data")

		pairs = var_18_3

		for iter_18_0, iter_18_1 in var_18_3(var_18_6) do
			getProxy = var_1_10008
			TaskProxy = var_1_10010
			var_1_10010 = var_1_10008(var_1_10010)

			if var_1_10008.getTaskVO(var_1_10010, iter_18_1) and var_1_10008:getTaskStatus() == 1 then
				return true
			end
		end
	end
	...
	if var_18_5 and not var_18_5:isEnd() then
		local var_18_7 = var_18_5:getConfig("config_data")

		pairs = var_18_3

		for iter_18_2, iter_18_3 in var_18_3(var_18_7) do
			getProxy = var_1_10008
			TaskProxy = var_1_10010
			var_1_10010 = var_1_10008(var_1_10010)

			if var_1_10008.getTaskVO(var_1_10010, iter_18_3) and var_1_10008:getTaskStatus() == 1 then
				return true
			end
		end
	end
