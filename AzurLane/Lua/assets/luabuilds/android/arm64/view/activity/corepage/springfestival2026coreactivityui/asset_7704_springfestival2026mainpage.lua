...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_12, var_4("fengfanV3_20251023_jinianshouce"))
	...
	var_1(var_1_14, var_4("drawdiary_ui_2026"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1(arg_2_0, arg_2_0.Manual, function()
		...
		DonghuangMedalAlbumView = var_2_10003
	...
	var_1(arg_2_0, arg_2_0.plot, function()
		...
		SpringFestival2026ColoringAnshanMediator = var_2_10003
		var_4_1.mediator = var_2_10003
		SpringFestival2026ColoringAnshanscene = var_2_10003
...
function var_0_1.updateUI(arg_5_0)
	if arg_5_0.shop_id then
		...
		if var_5_3 then
			...
			var_1_10004 = var_1_10004.Table2ServerTime(var_5_5, var_5_3)

			local var_5_6 = var_0_1

			var_5_4 = var_5.skinCommdityTimeStamps(var_5_6, var_1_10004)
		end

		setActive = var_1_10004

		var_1_10004(arg_5_0.shop_bgtime, var_5_4 and var_5_4 ~= 0)

		setText = var_1_10004

		var_1_10004(arg_5_0.shop_time, var_5_4)

		onButton = var_1_10004

		var_1_10004(arg_5_0, arg_5_0.shop, function()
			if var_5_4 == nil then
				pg = var_0
	...
	local var_5_9, var_5_10 = var_5_8(var_5_7, var_1_10004.activity_template[arg_5_0.activity.id].time)
	local var_5_11
	local var_5_13
	...
	var_5_13(var_5_15, var_7("tolovemainpage_build_countdown"))
	...
	var_5_13(arg_5_0, arg_5_0.fight, function()
		...
		var_8_1.mediator = var_2_10003
		ActivityBossZhangwuScene = var_2_10003
		var_8_1.viewComponent = var_2_10003
		...
		var_8_4(var_8_3, var_2_10004.ON_ADD_SUBLAYER, var_8_2)
