...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_3, var_4("zengke_series_pt"))

	setText = var_1

	local var_2_4 = arg_2_0.ptBtn
	local var_2_5 = var_3.Find(var_2_4, "Text/en")

	i18n = var_4

	var_1(var_2_5, var_4("zengke_series_pt_small"))
	...
	var_1(var_2_10, var_4("zengke_series_rank"))

	setText = var_1

	local var_2_11 = arg_2_0.rankBtn
	local var_2_12 = var_3.Find(var_2_11, "Text/en")

	i18n = var_4

	var_1(var_2_12, var_4("zengke_series_rank_small"))
	...
	var_1(var_2_15, var_4("zengke_series_task"))

	setText = var_1

	local var_2_16 = arg_2_0.taskBtn
	local var_2_17 = var_3.Find(var_2_16, "Text/en")

	i18n = var_4

	var_1(var_2_17, var_4("zengke_series_task_small"))
	...
	var_1(var_3.Find(var_2_19, "Battle/Nodes"), function(arg_3_0, arg_3_1)
	...
	var_1(var_3.Find(var_2_20, "Story/Nodes"), function(arg_4_0, arg_4_1)
	...
	pg = var_4
	arg_2_0.camEventId = var_2_25(var_2_24, var_4.CameraFixMgr.ASPECT_RATIO_UPDATE, function(arg_5_0, arg_5_1)
...
function var_0_1.didEnter(arg_8_0)
	...
	local function var_8_11()
		...
		i18n = var_2_10004
		var_11_2.helps = var_2_10004("zengke_series_help")
	...
	local function var_8_14()
		...
		BossRushVerZenkerMediator = var_2_10003
...
function var_0_1.getBG(arg_18_0)
	if arg_18_0.contextData.displayMode ~= var_0_1.DISPLAY.STORY then
		...
		local var_18_2 = var_2.TimeMgr.GetInstance()
		local var_18_3 = var_2.GetServerHour(var_18_2)
		local var_18_4 = var_18_1[#var_18_1][2]

		ipairs = var_18_2

		for iter_18_0, iter_18_1 in var_18_2(var_18_1) do
		...
		local var_18_8 = var_18_5.NewStoryMgr.GetInstance()

		ipairs = var_4

		for iter_18_2, iter_18_3 in var_4(var_18_6) do
...
function var_0_1.UpdateView(arg_21_0)
	...
	local var_21_5 = arg_21_0.ptTip

	Activity = var_6

	var_3(var_21_5, var_6.IsActivityReady(arg_21_0.ptActivity))

	local var_21_6 = arg_21_0.contextData.displayMode

	arg_21_0:addbubbleMsgBoxList({
		function(arg_23_0)
			local var_23_0

			if var_21_6 == var_0_1.DISPLAY.BATTLE then
				local var_23_1 = arg_21_0.activity

				var_23_0 = var_2.getConfig(var_23_1, "config_client").openActivityStory
			elseif var_21_6 == var_0_1.DISPLAY.STORY then
...
function var_0_1.UpdateBattle(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1_10002(var_26_0:GetActiveSeriesIds()) do
		...
		local var_26_7 = var_26_2:Find("blue")

		BossRushSeriesData = var_1_10014
		var_1_10014 = var_26_6 == var_1_10014.TYPE.NORMAL

		var_26_3(var_26_7, var_1_10014)

		setActive = var_26_3

		local var_26_8 = var_26_2:Find("red")

		BossRushSeriesData = var_1_10014
		var_1_10014 = var_26_6 ~= var_1_10014.TYPE.NORMAL

		var_26_3(var_26_8, var_1_10014)

		local var_26_9

		BossRushSeriesData = var_26_5

		if var_26_6 == var_26_5.TYPE.NORMAL then
			var_1_10014 = var_26_2
			var_26_9 = var_26_2.Find(var_1_10014, "blue")
		else
			var_1_10014 = var_26_2
			var_26_9 = var_26_2.Find(var_1_10014, "red")
		end

		setText = var_12

		var_12(var_26_9:Find("Text"), var_1_10008:GetName())

		setText = var_12
		var_1_10014 = var_26_9:Find("diff/Text")
		switch = var_15
		...
		var_26_11[3005] = var_26_12

		var_12(var_1_10014, var_15(var_26_10, var_26_11))

		BossRushSeriesData = var_12

		local var_26_13 = var_26_6 == var_12.TYPE.SP

		setActive = var_26_8

		var_26_8(var_26_2:Find("times"), var_26_13)
		...
		if var_26_13 then
			...
			var_26_14 = var_1_10008:GetMaxBonusCount() - var_1_10014 > 0
			setText = var_16

			local var_26_15 = var_26_2
			local var_26_16 = var_26_2.Find(var_26_15, "times/Text")

			i18n = var_26_12
			var_26_12 = var_26_12("series_enemy_SP_count")
			setColorStr = var_26_15
			math = var_1_10022

			var_16(var_26_16, var_26_12 .. var_26_15(var_1_10022.max(0, var_15 - var_1_10014) .. "/" .. var_15, var_26_14 and "#6EE868" or "#7f7f7f"))
		end
		...
		local function var_26_19()
			...
			if not var_26_14 then
				...
				local var_32_5 = var_0.TipsMgr.GetInstance()
				local var_32_6 = var_0.ShowTips

				i18n = var_2_10003

				var_32_6(var_32_5, var_2_10003("series_enemy_SP_error"))

				return
			end

			local var_32_7 = arg_26_0
			local var_32_8 = var_0.emit

			BossRushVerZenkerMediator = var_2_10003

			var_32_8(var_32_7, var_2_10003.ON_FLEET_SELECT, var_1_10008)
		...
		var_1_10014(var_26_17, var_26_18, var_26_19, var_26_12)
	end
...
function var_0_1.UpdateStory(arg_33_0)
	...
	for iter_33_0, iter_33_1 in var_1_10004(arg_33_0.storyNodesDict) do
		...
		var_1_10010 = iter_33_1:IsActive(arg_33_0.activity, arg_33_0.ptActivity)
	...
	var_4(var_33_5, iter_33_0("zengke_story_reward_count") .. var_33_1 .. "/" .. var_33_2)
	...
	var_4(var_33_6, var_7(arg_33_0.storyTask))
	...
	if arg_33_0.storyTask then
		...
		local function var_33_14()
			...
			var_36_1(var_36_0, var_2_10003.ON_DROP, var_33_9)
		...
		var_7(var_33_12, var_33_13, var_33_14, var_12)
		...
		var_33_10(var_33_11:Find("get"), var_33_16 == 1)

		setActive = var_33_10

		var_33_10(var_33_11:Find("got"), var_33_16 == 2)
	end
	...
	var_1_10005({
		function(arg_38_0)
			...
			if var_1(arg_37_1) and var_1 > 0 then
				...
				BossRushVerZenkerMediator = var_2_10005
...
function var_0_1.UpdateStoryTask(arg_39_0)
	...
	var_39_3(var_39_8, var_39_9(var_39_11(var_39_10, var_1_10010.ZENGKEHAIJUNSHANGJIANG_TASK_ACT_ID)))
	...
	local var_39_14 = var_39_0.Create(var_39_13[1])
	local var_39_15 = arg_39_0.storyAward
	local var_39_16 = var_4.Find(var_39_15, "award_bg")

	updateDrop = var_5

	var_5(var_39_16:Find("IconTpl"), var_39_14)
	...
	local function var_39_19()
		...
		var_40_1(var_40_0, var_2_10003.ON_DROP, var_39_14)
	...
	var_5(var_39_17, var_39_18, var_39_19, var_10)
	...
	var_39_15(var_39_16:Find("get"), var_39_21 == 1)

	setActive = var_39_15

	var_39_15(var_39_16:Find("got"), var_39_21 == 2)

	if var_39_21 == 1 then
		local var_39_22 = arg_39_0
		local var_39_23 = arg_39_0.emit

		BossRushVerZenkerMediator = var_9

		var_39_23(var_39_22, var_9.ON_TASK_SUBMIT, arg_39_0.storyTask)
	end
