...
function var_0_1.init(arg_2_0, ...)
	...
	var_1(var_2_1, var_4("outpost_20250904_Title1"))
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			if var_3.detect(arg_2_0.activities, function(arg_4_0)
				...
				elseif not arg_2_0.pageDic[var_3.id] then
					...
					local var_3_1 = arg_3_2:Find("on/name")

					i18n = var_2_10007

					var_4(var_3_1, var_2_10007("outpost_20250904_Sidebar" .. var_3:getConfig("is_show")))

					setText = var_4

					local var_3_2 = arg_3_2:Find("name")

					i18n = var_7

					var_4(var_3_2, var_7("outpost_20250904_Sidebar" .. var_3:getConfig("is_show")))
