...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.Atelier.base.AtelierFormulaOverlayView"))

function var_0_1.InitCustom(arg_1_0)
	setText = var_1_10001

	local var_1_0 = arg_1_0._tf
	local var_1_1 = var_3.Find(var_1_0, "closeBtn/Text")

	i18n = var_1_10004

	var_1_10001(var_1_1, var_1_10004("yumia_atelier_tip6"))

	setText = var_1_10001

	local var_1_2 = arg_1_0._tf
	local var_1_3 = var_3.Find(var_1_2, "RestCount/Text_1")

	i18n = var_4

	var_1_10001(var_1_3, var_4("yumia_atelier_tip8"))

	setText = var_1_10001

	local var_1_4 = arg_1_0._tf
	local var_1_5 = var_3.Find(var_1_4, "List/Text")

	i18n = var_4

	var_1_10001(var_1_5, var_4("yumia_atelier_tip9"))
...
function var_0_1.didEnter(arg_2_0)
	...
	var_1(var_2_0, var_4.Find(var_2_1, "closeBtn"), function()
...
function var_0_1.RefreshFormulaInfo(arg_4_0, arg_4_1)
	...
	var_4_2(var_4_1, var_6.Find(var_4_3, "Icon"), var_4_0)

	setText = var_4_2

	local var_4_4 = arg_4_0._tf

	var_4_2(var_5.Find(var_4_4, "Name"), arg_4_1:GetName())

	setText = var_4_2

	local var_4_5 = arg_4_0._tf

	var_4_2(var_5.Find(var_4_5, "Description/Text"), arg_4_1:GetDesc())
	...
	var_4(var_6.Find(var_4_7, "RestCount/cntText"), var_4_6)
