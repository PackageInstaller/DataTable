...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_11, var_4("Outpost_20250904_Progress"))
	...
	var_1(var_1_12, var_4("Outpost_20260514_Detail"))
...
function var_0_1.getTaskIdx(arg_12_0, arg_12_1)
	...
	local var_12_2 = arg_12_1.getNDay(var_12_1)
	local var_12_3 = #arg_12_0.taskGroup

	math = var_12_1

	local var_12_4 = var_12_1.min(var_12_2, var_12_3)
	local var_12_5 = true
	...
	return var_7.min(var_12_0, var_12_3)
end
...
function var_0_1.isTaskFinished(arg_13_0, arg_13_1)
	if not arg_13_0.taskProxy then
		...
		arg_13_0.taskProxy = var_2(var_1_10004)
	end
