...
function var_0_1.addListener(arg_6_0)
	...
	if var_1_10001 then
		...
		var_1_10002(var_6_1, var_6_2, var_1_10006, var_1_10007)
	end
	...
	local function var_6_5()
		...
		if var_2_10003.indexof(arg_6_0.specialPhaseList, var_8_1, 1) then
			...
			local var_8_8 = var_8_4(var_2_10008)
			local var_8_9 = var_6.getData(var_8_8)
			local var_8_10 = var_8_7.type

			DROP_TYPE_RESOURCE = var_8_8

			if var_8_10 == var_8_8 then
				var_8_10 = var_8_7.id
				PlayerConst = var_8_8

				if var_8_10 == var_8_8.ResGold and var_8_9:GoldMax(var_8_7.count) then
					table = var_8_10
					...
					var_8_10.insert(var_8_5, function(arg_9_0)
						...
						local var_9_3 = var_3_10005("gold_max_tip_title")

						i18n = var_3_10006
						var_9_2.content = var_9_3 .. var_3_10006("award_max_warning")
	...
	local function var_6_8()
		...
		var_11_1(var_11_0, var_2_10003.SPECIAL_BATTLE_OPERA)
	...
	local function var_6_14()
		...
		pg = var_2_10004
		var_13_2.helps = var_2_10004.gametip.icecream_help.tip
		...
		local function var_15_5(arg_17_0)
			if arg_17_0 == true then
				...
				for iter_17_1 = 1, 3 do
					...
					var_2_10009(var_11.Find(var_17_5, "icon"), var_2_10008, true)

					onToggle = var_2_10009
					...
					var_2_10009(var_17_6, var_17_7, var_17_8, var_14)
				end
	...
	local function var_15_8()
		...
		if not var_0.isFinished(var_19_0) then
			if arg_15_0.curSelectIndex then
				...
				local var_19_6 = var_2_10005.EVENT_PT_OPERATION
				local var_19_7 = {
					cmd = 1
				}
				local var_19_8 = arg_15_0.ptData

				var_19_7.activity_id = var_7.GetId(var_19_8)
...
function var_0_1.openMainPanel(arg_21_0, arg_21_1)
	...
	local var_21_1 = var_21_0(var_4(arg_21_0.mainPanel), 0, 1, var_0_1.Menu_Ani_Open_Time)
	...
	local var_21_8 = var_21_7(var_21_6, var_5.Action_float(function(arg_24_0)
	...
	var_21_9(var_21_8, var_5.Action(function()
...
function var_0_1.closeMainPanel(arg_26_0)
	...
	local var_26_1 = var_26_0(var_1_10003(arg_26_0.mainPanel), 1, 0, var_0_1.Menu_Ani_Close_Time)
	local var_26_2 = var_1.setOnUpdate

	System = var_4

	local var_26_3 = var_26_2(var_26_1, var_4.Action_float(function(arg_27_0)
	...
	var_26_4(var_26_3, var_4.Action(function()
	...
	local var_26_8 = var_26_7(var_26_6, var_4.Action_float(function(arg_29_0)
		setLocalPosition = var_2_10001
	...
	var_26_9(var_26_8, var_4.Action(function()
		setLocalPosition = var_2_10000
...
function var_0_1.openSecondPanel(arg_31_0)
	...
	local var_31_1 = var_31_0(var_3(arg_31_0.secondPanel), 0, 1, var_0_1.Menu_Ani_Open_Time)
	local var_31_2 = var_1.setOnUpdate

	System = var_4

	local var_31_3 = var_31_2(var_31_1, var_4.Action_float(function(arg_32_0)
	...
	var_31_4(var_31_3, var_4.Action(function()
	...
	local var_31_8 = var_31_7(var_31_6, var_4.Action_float(function(arg_34_0)
		setLocalPosition = var_2_10001
	...
	var_31_9(var_31_8, var_4.Action(function()
		setLocalPosition = var_2_10000
...
function var_0_1.closeSecondPanel(arg_36_0)
	...
	local var_36_1 = var_36_0(var_1_10003(arg_36_0.secondPanel), 1, 0, var_0_1.Menu_Ani_Close_Time)
	local var_36_2 = var_1.setOnUpdate

	System = var_4

	local var_36_3 = var_36_2(var_36_1, var_4.Action_float(function(arg_37_0)
	...
	var_36_4(var_36_3, var_4.Action(function()
	...
	local var_36_8 = var_36_7(var_36_6, var_4.Action_float(function(arg_39_0)
		setLocalPosition = var_2_10001
...
function var_0_1.openSelectBtn(arg_41_0)
	...
	local var_41_1 = var_41_0(var_3(arg_41_0.selectBtn), 0, 1, var_0_1.Menu_Ani_Open_Time)
	local var_41_2 = var_1.setOnUpdate

	System = var_4

	local var_41_3 = var_41_2(var_41_1, var_4.Action_float(function(arg_42_0)
	...
	var_41_4(var_41_3, var_4.Action(function()
...
function var_0_1.closeSelectBtn(arg_44_0)
	...
	local var_44_1 = var_44_0(var_1_10003(arg_44_0.selectBtn), 1, 0, var_0_1.Menu_Ani_Close_Time)
	local var_44_2 = var_1.setOnUpdate

	System = var_4

	local var_44_3 = var_44_2(var_44_1, var_4.Action_float(function(arg_45_0)
		setImageAlpha = var_2_10001
	...
	var_44_4(var_44_3, var_4.Action(function()
		setImageAlpha = var_2_10000
...
function var_0_1.updateIcecream(arg_48_0, arg_48_1)
	...
	if var_48_11 then
		...
		for iter_48_0, iter_48_1 in var_48_8(var_48_0) do
	...
	if var_48_11 then
		...
		local var_48_20 = var_10(var_12.Find(var_48_19, var_48_18))

		setImageSprite = var_48_16

		var_48_16(var_48_3, var_48_20, true)
	end
	...
	if var_48_0[2] and var_48_0[2] > 0 then
		...
		local var_48_23 = var_10(var_12.Find(var_48_22, var_48_21))

		setImageSprite = var_48_16

		var_48_16(var_48_5, var_48_23, true)
	end
	...
	if var_48_0[3] and var_48_0[3] > 0 then
		...
		local var_48_26 = var_10(var_12.Find(var_48_25, var_48_24))

		setImageSprite = var_48_16

		var_48_16(var_48_7, var_48_26, true)
	end
	...
	if var_48_0[4] and var_48_0[4] > 0 then
		...
		local var_48_29 = var_10(var_12.Find(var_48_28, var_48_27))

		setImageSprite = var_48_16

		var_48_16(var_48_9, var_48_29, true)
	end
...
function var_0_1.updateMainSelectPanel(arg_49_0)
	...
	if arg_49_0.selectedList[2] and arg_49_0.selectedList[2] > 0 then
		...
		iter_49_0 = iter_49_0(var_49_4)
		setImageSprite = var_1_10005

		var_1_10005(arg_49_0.mainToggleSelectedTF[2], iter_49_0, true)

		setActive = var_1_10005

		var_1_10005(arg_49_0.mainToggleSelectedTF[2], true)
	else
		setActive = var_49_5
	...
	if arg_49_0.selectedList[3] and arg_49_0.selectedList[3] > 0 then
		var_49_7 = arg_49_0.selectedList[3]

		local var_49_8 = arg_49_0.iconTable["3"][var_49_7]

		getImageSprite = var_49_4
		var_49_4 = var_49_4(var_49_8)
		setImageSprite = iter_49_0

		iter_49_0(arg_49_0.mainToggleSelectedTF[3], var_49_4, true)

		setActive = iter_49_0

		iter_49_0(arg_49_0.mainToggleSelectedTF[3], true)
	else
		setActive = var_49_7

		var_49_7(arg_49_0.mainToggleSelectedTF[3], false)
	end

	local var_49_9

	if arg_49_0.selectedList[4] and arg_49_0.selectedList[4] > 0 then
		var_49_9 = arg_49_0.selectedList[4]

		local var_49_10 = arg_49_0.iconTable["4"][var_49_9]

		getImageSprite = var_49_4

		local var_49_11 = var_49_4(var_49_10)

		setImageSprite = iter_49_0

		iter_49_0(arg_49_0.mainToggleSelectedTF[4], var_49_11, true)

		setActive = iter_49_0

		iter_49_0(arg_49_0.mainToggleSelectedTF[4], true)
	else
		setActive = var_49_9

		var_49_9(arg_49_0.mainToggleSelectedTF[4], false)
	end
...
function var_0_1.share(arg_54_0)
	...
	var_1.GetUI(var_54_0, "IcecreamSharePage", false, function(arg_55_0)
		...
		var_2_10002(arg_55_0, var_55_0, false)

		arg_54_0.shareGo = arg_55_0

		local var_55_1 = arg_55_0
		local var_55_2 = arg_55_0.Find(var_55_1, "PlayerName")
		local var_55_3 = arg_55_0:Find("IcecreamContainer")

		getProxy = var_55_1
		PlayerProxy = var_6

		local var_55_4 = var_55_1(var_6)
		...
		var_55_4(var_55_6, var_2_10010("icecream_make_tip", var_55_5))

		getProxy = var_55_4
		PlayerProxy = var_55_6

		local var_55_7 = var_55_4(var_55_6)
		local var_55_8 = var_7.getRawData(var_55_7)

		getProxy = var_2_10008
		UserProxy = var_10

		local var_55_9 = var_2_10008(var_10)
		local var_55_10 = var_8.getRawData(var_55_9)

		getProxy = var_55_7
		ServerProxy = var_2_10011

		local var_55_11 = var_55_7(var_2_10011)
		...
		var_13(var_55_18:Find("name/value"), var_55_15)

		setText = var_13

		var_13(var_55_18:Find("server/value"), var_55_16)

		setText = var_13

		var_13(var_55_18:Find("lv/value"), var_55_8.level)

		cloneTplTo = var_13

		local var_55_19 = var_13(arg_54_0.icecreamTF, var_55_3)

		setLocalPosition = var_55_17
		tf = var_16

		var_55_17(var_16(var_55_19), {
			x = 0,
			y = 0
		})

		setLocalScale = var_55_17
		tf = var_16
		...
		local var_55_20 = var_55_17.ShareMgr.GetInstance()
		local var_55_21 = var_14.Share

		pg = var_17

		var_55_21(var_55_20, var_17.ShareMgr.TypeIcecream)
...
function var_0_1.initSD(arg_56_0)
	...
	local var_56_1 = var_1.New("salatuojia_8", function(arg_57_0)
		...
		Vector3 = var_2_10002
		var_57_0.localScale = var_2_10002.one
