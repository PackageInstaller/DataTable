...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_14 = var_3.Find(var_3_13, "sub/Text")

	i18n = var_4

	var_1(var_3_14, var_4("ship_limit_notice"))
	...
	for iter_3_0 = 0, arg_3_0.toggleList.childCount - 1 do
		table = var_3_13
		var_3_13 = var_3_13.insert

		local var_3_25 = arg_3_0.toggles
		local var_3_26 = arg_3_0.toggleList

		var_3_13(var_3_25, var_8.Find(var_3_26, "item" .. iter_3_0 + 1))
	end
	...
	var_1(var_3.Find(var_3_29, "panel/title/ASvalue"), false)

	setText = var_1

	local var_3_30 = arg_3_0._tf
	local var_3_31 = var_3.Find(var_3_30, "panel/formation_btn/text")

	i18n = var_4

	var_1(var_3_31, var_4("autofight_formation"))

	setText = var_1

	local var_3_32 = arg_3_0._tf
	local var_3_33 = var_3.Find(var_3_32, "panel/commander_btn/text")

	i18n = var_4

	var_1(var_3_33, var_4("autofight_cat"))

	setText = var_1

	local var_3_34 = arg_3_0._tf
	local var_3_35 = var_3.Find(var_3_34, "panel/title/Image/text")

	i18n = var_4

	var_1(var_3_35, var_4("fleet_select_title"))
...
function var_0_1.SetFleets(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in var_10_0(arg_10_1) do
		...
		if iter_10_1:isSubmarineFleet() then
			local var_10_1 = arg_10_0.fleets

			FleetType = var_1_10008

			local var_10_2 = #var_10_1[var_1_10008.Submarine]
			local var_10_3 = arg_10_0

			var_1_10008 = arg_10_0.getLimitNums
			FleetType = var_1_10011

			if var_10_2 < var_1_10008(var_10_3, var_1_10011.Submarine) then
				table = var_10_2

				local var_10_4 = var_10_2.insert
				local var_10_5 = arg_10_0.fleets

				FleetType = var_10_3

				var_10_4(var_10_5[var_10_3.Submarine], iter_10_1)
			end
		else
			...
			local var_10_7 = #var_10_6[var_1_10008.Normal]
			local var_10_8 = arg_10_0

			var_1_10008 = arg_10_0.getLimitNums
			FleetType = var_1_10011

			if var_10_7 < var_1_10008(var_10_8, var_1_10011.Normal) then
				table = var_10_7

				local var_10_9 = var_10_7.insert
				local var_10_10 = arg_10_0.fleets

				FleetType = var_10_8

				var_10_9(var_10_10[var_10_8.Normal], iter_10_1)
			end
		end
	end
...
function var_0_1.SetOilLimit(arg_11_0, arg_11_1)
	...
	var_1_10003(arg_11_0.rtCostLimit, var_11_0)

	setText = var_1_10003

	local var_11_1 = arg_11_0.rtCostLimit
	local var_11_2 = var_5.Find(var_11_1, "text")

	i18n = var_6

	var_1_10003(var_11_2, var_6("formationScene_use_oil_limit_tip_worldboss"))
	...
	if var_11_0 then
		...
		var_4(var_6.Find(var_11_5, "cost_noraml/Text"), var_11_4 > 0)

		if 0 < var_11_4 then
			setText = var_4

			local var_11_6 = arg_11_0.rtCostLimit
			local var_11_7 = var_6.Find(var_11_6, "cost_noraml/Text")

			string = var_7

			local var_11_8 = var_7.format
			local var_11_9 = "%s(%d)"

			i18n = var_1_10010

			var_4(var_11_7, var_11_8(var_11_9, var_1_10010("formationScene_use_oil_limit_surface"), var_11_4))
		end
		...
		var_4(var_6.Find(var_11_11, "cost_boss/Text"), var_11_10 > 0)
		...
		var_4(var_6.Find(var_11_13, "cost_sub/Text"), var_11_12 > 0)

		if 0 < var_11_12 then
			setText = var_4

			local var_11_14 = arg_11_0.rtCostLimit
			local var_11_15 = var_6.Find(var_11_14, "cost_sub/Text")

			string = var_7

			local var_11_16 = var_7.format
			local var_11_17 = "%s(%d)"

			i18n = var_1_10010

			var_4(var_11_15, var_11_16(var_11_17, var_1_10010("formationScene_use_oil_limit_submarine"), var_11_12))
		end
	end
...
function var_0_1.UpdateView(arg_14_0)
	...
	if not var_1 then
		...
		local var_14_0 = var_1.SystemOpenMgr.GetInstance()
		...
		var_14_3 = var_14_1(var_14_0, var_4.getRawData(var_14_2).level, "CommanderCatMediator")
	else
		var_14_3 = false
	end
	...
	var_1_10002(var_14_4, true)

	setActive = var_1_10002

	var_1_10002(arg_14_0.commanderToggle, var_14_3)

	setActive = var_1_10002

	var_1_10002(arg_14_0.btnTry, arg_14_0.showTryBtn)
...
function var_0_1.updateFleet(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_5 = var_17_4(var_17_3, var_1_10010.Main)
	local var_17_6 = var_17_1
	local var_17_7 = var_17_1.Find

	TeamType = var_1_10011

	local var_17_8 = var_17_7(var_17_6, var_1_10011.Vanguard)
	local var_17_9 = var_17_1
	local var_17_10 = var_17_1.Find

	TeamType = var_1_10012

	local var_17_11 = var_17_10(var_17_9, var_1_10012.Submarine)
	local var_17_12 = var_17_1:Find("btn_recom")
	local var_17_13 = var_17_1:Find("btn_clear")
	local var_17_14 = var_17_1
	local var_17_15 = var_17_1.Find(var_17_14, "selected")
	local var_17_16 = var_17_1
	local var_17_17 = var_17_1.Find(var_17_16, "commander")

	setActive = var_17_14

	var_17_14(var_17_15, false)
	...
	if var_17_5 then
		...
		var_17_14(var_17_5, var_3 and var_17_0)
	end

	if var_17_8 then
		setActive = var_17_14

		var_17_14(var_17_8, var_3 and var_17_0)
	end

	if var_17_11 then
		setActive = var_17_14

		var_17_14(var_17_11, var_3 and var_17_0)
	end

	local var_17_18 = arg_17_0.viewParent.contextData.bossActivity
	local var_17_19 = var_14.getConfig(var_17_18, "type")

	ActivityConst = var_17_16

	if var_17_19 == var_17_16.ACTIVITY_TYPE_BOSSSINGLE_VARIABLE then
		Fleet = var_17_19

		if not var_17_19.DEFAULT_NAME_BOSS_SINGLE_VARIABLE_ACT then
			Fleet = var_17_19
			var_17_19 = var_17_19.DEFAULT_NAME_BOSS_SINGLE_ACT
		end

		if var_3 and var_17_0 then
			setText = var_15

			local var_17_20 = var_17_2
			local var_17_21

			if not var_17_19[var_17_0.id] then
				var_17_21 = ""
			end

			var_15(var_17_20, var_17_21)

			FleetType = var_15

			if arg_17_1 == var_15.Submarine then
				local var_17_22 = arg_17_0
				local var_17_23 = arg_17_0.updateShips
				local var_17_24 = var_17_11
				local var_17_25 = var_17_0.subShips

				var_1_10020 = var_17_0.id
				TeamType = var_1_10021

				var_17_23(var_17_22, var_17_24, var_17_25, var_1_10020, var_1_10021.Submarine)
			else
				local var_17_26 = arg_17_0
				local var_17_27 = arg_17_0.updateShips
				local var_17_28 = var_17_5
				local var_17_29 = var_17_0.mainShips

				var_1_10020 = var_17_0.id
				TeamType = var_1_10021

				var_17_27(var_17_26, var_17_28, var_17_29, var_1_10020, var_1_10021.Main)

				local var_17_30 = arg_17_0
				local var_17_31 = arg_17_0.updateShips
				local var_17_32 = var_17_8
				local var_17_33 = var_17_0.vanguardShips

				var_1_10020 = var_17_0.id
				TeamType = var_21

				var_17_31(var_17_30, var_17_32, var_17_33, var_1_10020, var_21.Vanguard)
			end

			arg_17_0:updateCommanders(var_17_17, var_17_0)
			...
			local var_17_34 = arg_17_0
			local var_17_35 = var_17_13
			...
			var_15(var_17_34, var_17_35, var_17_36, var_1_10020)
		end
...
function var_0_1.updateShips(arg_20_0, arg_20_1, arg_20_2, arg_20_3, arg_20_4)
	...
	local var_20_0 = var_1_10005(var_7)

	for iter_20_0 = 1, 3 do
		local var_20_1 = var_20_0
		local var_20_2

		if not var_20_0.getShipById(var_20_1, arg_20_2[iter_20_0]) or not arg_20_0.tfShipTpl then
			var_20_2 = arg_20_0.tfEmptyTpl
		end

		cloneTplTo = var_20_1

		local var_20_3 = var_20_1(var_20_2, arg_20_1)

		setActive = var_13

		var_13(var_20_3, true)

		if var_10 then
			updateShip = var_13

			var_13(var_20_3, var_10)

			setActive = var_13

			var_13(var_20_3:Find("event_block"), var_10:getFlag("inEvent"))
		end

		setActive = var_13

		var_13(var_20_3:Find("ship_type"), false)
		...
		local var_20_5 = var_13(var_20_4, var_16(var_18)).onLongPressed

		var_14.RemoveAllListeners(var_20_5)
		...
		var_20_4(arg_20_0, var_20_3, var_20_6)

		local var_20_7 = var_13.onLongPressed

		var_15.AddListener(var_20_7, function()
			if var_0 then
...
function var_0_1.updateCommanderBtn(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_6 = var_5.Find(var_23_5, "blank")
	local var_23_7 = var_5:Find("commander")

	setActive = var_23_5

	var_23_5(var_23_2, false)

	setActive = var_23_5

	var_23_5(var_23_3, var_3 and not arg_23_0.viewParent.contextData.showCommander)

	setActive = var_23_5

	var_23_5(var_23_4, var_3 and not arg_23_0.viewParent.contextData.showCommander)

	setActive = var_23_5

	var_23_5(var_23_7, var_3 and var_23_0 and arg_23_0.viewParent.contextData.showCommander)

	setActive = var_23_5

	var_23_5(var_23_6, not var_3 or var_3 and not var_23_0 and arg_23_0.viewParent.contextData.showCommander)
...
function var_0_1.updateCommanders(arg_24_0, arg_24_1, arg_24_2)
	for iter_24_0 = 1, 2 do
		...
		var_24_1(var_24_2, not var_24_0)

		setActive = var_24_1

		var_24_1(var_24_4, var_24_0)

		if var_24_0 then
			Commander = var_24_1
			var_24_1 = var_24_1.rarity2Frame

			local var_24_5 = var_24_0

			var_24_1 = var_24_1(var_24_0.getRarity(var_24_5))
			setImageSprite = var_24_3
			var_1_10016 = var_24_4

			local var_24_6 = var_24_4.Find(var_1_10016, "frame")

			GetSpriteFromAtlas = var_24_5

			var_24_3(var_24_6, var_24_5("weaponframes", "commander_" .. var_24_1))

			GetImageSpriteFromAtlasAsync = var_24_3

			var_24_3("CommanderHrz/" .. var_24_0:getPainting(), "", var_24_4:Find("mask/icon"))
		end
		...
		var_24_1(var_24_7, var_24_8, var_24_9, var_1_10016)

		onButton = var_24_1

		local var_24_10 = arg_24_0
		local var_24_11 = var_24_4

		local function var_24_12()
		...
		var_24_1(var_24_10, var_24_11, var_24_12, var_1_10016)
	end
...
function var_0_1.clearFleet(arg_29_0, arg_29_1)
	...
	local var_29_2 = var_29_1(var_29_0, var_1_10005.Main)
	local var_29_3 = arg_29_1
	local var_29_4 = arg_29_1.Find

	TeamType = var_1_10006

	local var_29_5 = var_29_4(var_29_3, var_1_10006.Vanguard)
	local var_29_6 = arg_29_1
	local var_29_7 = arg_29_1.Find

	TeamType = var_1_10007

	local var_29_8 = var_29_7(var_29_6, var_1_10007.Submarine)
...
function var_0_1.updatePropetyLimit(arg_30_0)
	...
	if #arg_30_0.propetyLimitation > 0 then
		...
		local var_30_3 = var_30_0(var_30_1, var_4.GetChild(var_30_2, 0))
		...
		var_30_3:make(function(arg_31_0, arg_31_1, arg_31_2)
			...
			if arg_31_0 == var_2_10003.EventUpdate then
				...
				if var_30_4[arg_31_1] == 1 then
					...
					typeof = var_11
					Text = var_2_10013
					var_31_6 = var_31_6(var_31_5, var_11(var_2_10013))
					Color = var_2_10009
					var_31_6.color = var_2_10009.New(1, 0.9607843137254902, 0.5019607843137255)
				else
					...
					typeof = var_11
					Text = var_2_10013
					var_31_6 = var_31_6(var_31_7, var_11(var_2_10013))
					Color = var_2_10009
					var_31_6.color = var_2_10009.New(0.9568627450980393, 0.30196078431372547, 0.30196078431372547)
				end
				...
				local var_31_9 = var_31_8 .. var_2_10009.eliteConditionCompareTip(var_31_2) .. var_31_3
...
function var_0_1.IsPropertyLimitationSatisfy(arg_38_0)
	...
	for iter_38_2 = 1, 2 do
		...
		if var_38_6[var_1_10011.Normal][iter_38_2] then
			...
			for iter_38_5, iter_38_6 in var_1_10011(var_10.mainShips) do
				table = var_1_10016
	...
	for iter_38_7, iter_38_8 in var_8(var_38_2) do
		...
		var_1_10013, iter_38_5, iter_38_6, var_38_9 = var_1_10013(iter_38_8)
		string = var_1_10017

		if var_1_10017.sub(var_1_10013, 1, 5) == "fleet" then
			var_38_7[var_1_10013] = 0
			var_38_8[var_1_10013] = var_38_9
		end
	end
	...
	for iter_38_9, iter_38_10 in var_8(var_38_5) do
		local var_38_10 = var_38_1[iter_38_10]

		var_38_4 = var_38_4 + 1
		intProperties = iter_38_5
		iter_38_5 = iter_38_5(var_38_10:getProperties())
		pairs = iter_38_6

		for iter_38_11, iter_38_12 in iter_38_6(var_38_3) do
			string = var_1_10020

			if var_1_10020.sub(iter_38_11, 1, 5) == "fleet" then
				if iter_38_11 == "fleet_totle_level" then
					var_38_7[iter_38_11] = var_38_7[iter_38_11] + var_38_10.level
				end
			elseif iter_38_11 == "level" then
				var_38_3[iter_38_11] = iter_38_12 + var_38_10.level
			else
	...
	for iter_38_15, iter_38_16 in var_9(var_38_2) do
		...
		local var_38_12, var_38_13

		iter_38_5, var_38_12, var_38_13 = iter_38_5(iter_38_16)
		...
		var_1_10017 = var_1_10017.EliteConditionCompare(var_38_12, var_38_3[iter_38_5], var_38_13) and 1 or 0
		var_38_11[iter_38_15] = var_1_10017
	end

	return var_38_11, var_38_3
end
