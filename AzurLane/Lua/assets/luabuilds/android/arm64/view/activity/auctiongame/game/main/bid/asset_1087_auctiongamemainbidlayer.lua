...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.bidEventCom = var_1_10001(var_2_0, var_1_10004(var_1_10006))
	...
	for iter_2_0 = 0, 9 do
		...
		string = var_1_10008
		var_1_10008 = arg_2_0[var_1_10008.format("uiNumBtn%s", iter_2_0)]
		...
		var_2_4(var_2_5, var_1_10008, var_1_10009, var_10.SOUND_EFFECT.BID_KEYPAD)
	end

	onButton = var_1

	local var_2_6 = arg_2_0
	local var_2_7 = arg_2_0.uiBtn00
	...
	var_1(var_2_6, var_2_7, var_2_8, var_1_10006.SOUND_EFFECT.BID_KEYPAD)

	onButton = var_1

	local var_2_9 = arg_2_0
	local var_2_10 = arg_2_0.uiBtn000
	...
	var_1(var_2_9, var_2_10, var_2_11, var_6.SOUND_EFFECT.BID_KEYPAD)

	onButton = var_1

	local var_2_12 = arg_2_0
	local var_2_13 = arg_2_0.uiMultiplierBtn
	...
	var_1(var_2_12, var_2_13, var_2_14, var_6.SOUND_EFFECT.BID_KEYPAD)

	onButton = var_1

	local var_2_15 = arg_2_0
	local var_2_16 = arg_2_0.uiDeleteBtn
	...
	var_1(var_2_15, var_2_16, var_2_17, var_6.SOUND_EFFECT.BID_KEYPAD)

	onButton = var_1

	local var_2_18 = arg_2_0
	local var_2_19 = arg_2_0.uiClearBtn
	...
	var_1(var_2_18, var_2_19, var_2_20, var_6.SOUND_EFFECT.BID_KEYPAD)

	onButton = var_1

	local var_2_21 = arg_2_0
	local var_2_22 = arg_2_0.uiBidBtn
	...
	local function var_2_23()
		...
		local var_11_1 = var_1(var_2_10003)
		local var_11_2 = var_1.GetAuctionState(var_11_1)

		pg = var_2_10003

		local var_11_3 = var_2_10003.TimeMgr.GetInstance()
		...
		if var_11_0 < var_11_7[var_1.GetAuctionID(var_11_8)].bottom_price then
			...
			var_11_9(var_11_8, var_2_10007("auction_game_min_bid", var_3))
		...
		if var_11_9(var_11_8).gold < var_11_0 then
			...
			var_11_11(var_11_10, var_2_10008("auction_game_exceeds_max_value"))
		...
		local var_11_14 = var_2_10008.ON_ADD_SUBLAYER

		Context = var_2_10009

		local var_11_15 = var_2_10009.New
		local var_11_16 = {}

		AuctionGameMainMsgLayer = var_2_10012
		var_11_16.viewComponent = var_2_10012
		AuctionGameMainMsgMediator = var_2_10012
		var_11_16.mediator = var_2_10012
		...
		StringHelper = var_2_10016
		var_11_17.content = var_2_10013(var_11_18, var_2_10016.ForamtNumber(var_11_0))
	...
	var_1(var_2_21, var_2_22, var_2_23, var_6.SOUND_EFFECT.BID)

	setText = var_1

	local var_2_24 = arg_2_0.uiCurrencyTitleText

	i18n = var_2_22

	var_1(var_2_24, var_2_22("auction_main_pt"))

	getProxy = var_1
	ActivityProxy = var_2_24

	local var_2_25 = var_1(var_2_24)
	local var_2_26 = var_1.getActivityByType

	ActivityConst = var_2_23

	local var_2_27 = var_2_26(var_2_25, var_2_23.ACTIVITY_TYPE_AUCTION_GAME)
	local var_2_28 = var_2.getConfig(var_2_27, "config_client").itemID

	LoadSpriteAsync = var_2_25
	Drop = var_6

	local var_2_29 = var_6.New
	local var_2_30 = {}

	DROP_TYPE_VITEM = var_1_10009
	var_2_30.type = var_1_10009
	var_2_30.id = var_2_28

	local var_2_31 = var_2_29(var_2_30)

	var_2_25(var_6.getIcon(var_2_31), function(arg_13_0)
		IsNil = var_2_10001
	...
	local var_2_32 = arg_2_0.uiCurrencyText

	StringHelper = var_7

	local var_2_33 = var_7.ForamtNumber

	AuctionGameTools = var_1_10009

	var_2_25(var_2_32, var_2_33(var_1_10009.GetCurrencyCnt()))

	setText = var_2_25

	local var_2_34 = arg_2_0.uiClearText

	i18n = var_7

	var_2_25(var_2_34, var_7("auction_bid_keyboard_clear"))
...
function var_0_1.didEnter(arg_14_0)
	...
	var_14_1(var_14_0, var_4.SOUND_EFFECT.EXPAND_POPUP)
...
function var_0_1.RefreshUI(arg_15_0)
	...
	pg = var_1_10005
	arg_15_0.multiplierNum = var_1_10003(var_1_10005.auction_round[var_15_1].one_hit)
	setText = var_3
	...
	var_3(var_15_2, var_1_10006.format("%s", arg_15_0.multiplierNum))
...
function var_0_1.RefreshNumText(arg_19_0)
	...
	var_1_10001(var_19_0, var_1_10004.ForamtNumber(arg_19_0.inputNum))
...
function var_0_1.OnClickBidBtn(arg_20_0)
	...
	local var_20_0 = var_1(var_1_10003)

	pg = var_1_10002

	local var_20_1 = var_1_10002.gameset.auction_bid_time.key_value
	local var_20_2 = var_20_0:GetTimestamp()

	pg = var_1_10004

	local var_20_3 = var_1_10004.TimeMgr.GetInstance()
	local var_20_4 = var_20_1 - (var_20_2 - var_4.GetServerTime(var_20_3))

	pg = var_3

	local var_20_5 = var_3.GameTrackerMgr.GetInstance()
	local var_20_6 = var_3.Record

	GameTrackerBuilder = var_20_3

	var_20_6(var_20_5, var_20_3.BuildAuctionBid(var_20_0:GetAuctionID(), var_20_0:GetRound(), var_20_4, arg_20_0.inputNum, 0))

	local var_20_7 = arg_20_0.inputNum
	local var_20_8 = arg_20_0
	local var_20_9 = arg_20_0.emit

	AuctionGameMainBidMediator = var_1_10007

	var_20_9(var_20_8, var_1_10007.BID, var_20_7)
...
function var_0_1.willExit(arg_21_0)
	...
	var_21_2(var_21_1, var_4.SOUND_EFFECT.COLLAPSE_POPUP)
