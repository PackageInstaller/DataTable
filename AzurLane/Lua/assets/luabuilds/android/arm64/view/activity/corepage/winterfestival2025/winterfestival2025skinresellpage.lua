...
local var_0_0 = "WinterFestival2025SkinReSellPage"
...
function var_0_1.OnDataSetting(arg_2_0)
	...
	if var_2_3(var_2_2, var_4.getConfigData(arg_2_0.couponItemId).link_id) then
		local var_2_4 = var_1
		...
		if not var_1.isEnd(var_2_4) then
			...
			arg_2_0.subActivity = var_2_7(var_2_6, var_5.getConfig(var_2_8, "config_client").sub_act_id)
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local function var_4_2()
		...
		var_5_2.helps = var_4.GetTips(var_5_3)
	...
	local function var_4_5()
		...
		local var_6_3 = var_2_10004.SKINSHOP
		local var_6_4 = {}

		NewSkinShopScene = var_2_10006
		var_6_4.page = var_2_10006.PAGE_RETURN
	...
	local function var_4_8()
		...
		local var_7_3 = var_2_10004.CHARGE
		local var_7_4 = {}
		local var_7_5 = arg_4_0

		var_7_4.wrap = var_6.GetGiftShopType(var_7_5)
	...
	for iter_4_0, iter_4_1 in var_1_10001(arg_4_0.taskGroup) do
		...
		var_4_10(var_4_13:Find("day/Text"), "DAY" .. iter_4_0)

		Drop = var_4_10

		local var_4_14 = var_4_10.Create(var_4_11:getConfig("award_display")[1])

		updateDrop = var_4_12

		var_4_12(var_4_13:Find("IconTpl"), var_4_14)

		onButton = var_4_12

		local var_4_15 = arg_4_0
		local var_4_16 = var_4_13
		local var_4_17 = var_4_13.Find(var_4_16, "get")
		...
		local function var_4_18()
			...
			var_8_1(var_8_0, var_2_10003.ON_TASK_SUBMIT, var_4_11)

			return
		end

		SFX_CONFIRM = var_4_16

		var_4_12(var_4_15, var_4_17, var_4_18, var_4_16)

		onButton = var_4_12

		var_4_12(arg_4_0, var_4_13, function()
			local var_9_0 = arg_4_0
			local var_9_1 = var_0.emit

			BaseUI = var_2_10003

			var_9_1(var_9_0, var_2_10003.ON_DROP, var_4_14)
	...
	local var_4_20 = arg_4_0.rtSkinCoupon
	local var_4_21 = var_4.Find(var_4_20, "icon/get")
	...
	SFX_CONFIRM = var_4_20

	var_1(var_4_19, var_4_21, var_4_22, var_4_20)
...
function var_0_1.OnUpdateFlush(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1_10002(arg_11_0.taskGroup) do
		...
		local var_11_6 = var_11_3:isReceive()

		setActive = var_11_4

		var_11_4(var_11_5:Find("got"), var_11_6 or iter_11_0 < arg_11_0.nday)

		setActive = var_11_4

		var_11_4(var_11_5:Find("get"), not var_11_0 and not var_11_6 and iter_11_0 == arg_11_0.nday)

		if not var_11_0 then
			isActive = var_11_4
			var_11_0 = var_11_4(var_11_5:Find("get"))
		end
	end
	...
	local var_11_9 = arg_11_0.rtSkinCoupon
	local var_11_10 = var_6.Find(var_11_9, "icon")
	...
	local function var_11_11()
		...
		var_12_1(var_12_0, var_2_10003.ON_DROP, var_11_7)

		return
	end

	SFX_CONFIRM = var_11_9

	var_3(var_11_8, var_11_10, var_11_11, var_11_9)

	updateDrop = var_3

	local var_11_12 = arg_11_0.rtSkinCoupon

	var_3(var_5.Find(var_11_12, "icon/IconTpl"), var_11_7)

	setActive = var_3

	local var_11_13 = arg_11_0.rtSkinCoupon

	var_3(var_5.Find(var_11_13, "icon/get"), arg_11_0.couponGet > 0)

	setText = var_3

	local var_11_14 = arg_11_0.rtSkinCoupon

	var_3(var_5.Find(var_11_14, "count"), arg_11_0:GetCouponCountText())

	setActive = var_3

	local var_11_15 = arg_11_0.rtSkinCoupon

	var_3(var_5.Find(var_11_15, "icon/get"), arg_11_0.couponGet > 0)
...
function var_0_1.GetTips(arg_13_0)
	...
	return var_1_10001.gametip.SkinDiscountHelp_Winter.tip
end
