...
function var_0_1.init(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "Text")

	i18n = var_4

	var_1(var_2_2, var_4("expedition_award_tip"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_2 = var_4.Find(var_3_1, "Receive")
	...
	var_1_10001(var_3_4, var_4.Find(var_3_5, "BG"), function()
	...
	local var_3_10 = var_4.Find(var_3_9, "Materials")
	local var_3_11 = arg_3_0.window
	local var_3_12 = var_5.Find(var_3_11, "Materials")

	var_3_8(var_3_10, var_5.GetChild(var_3_12, 0), #arg_3_0.awards, function(arg_7_0, arg_7_1, arg_7_2)
