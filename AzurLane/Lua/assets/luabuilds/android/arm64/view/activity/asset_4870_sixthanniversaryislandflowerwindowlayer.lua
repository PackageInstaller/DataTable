...
function var_0_1.init(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "content/title/Text")

	i18n = var_4

	var_1(var_2_2, var_4("islandnode_tips7", arg_2_0.contextData.name))

	local var_2_3 = arg_2_0._tf
	local var_2_4 = var_1.Find(var_2_3, "content/main/content")

	UIItemList = var_1_10002
	arg_2_0.itemList = var_1_10002.New(var_2_4, var_2_4:Find("icon"))
	...
	local var_2_9 = var_5.Find(var_2_8, "content/bottom/btn")
