...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.nameImg = var_1_1(var_1_0, var_5(var_1_10007))
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.roleImg = var_1_3(var_1_2, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.consumeTxt = var_1_5(var_1_4, var_5(var_1_10007))
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.consumeIcon = var_1_7(var_1_6, var_5(var_1_10007))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_2_0 < var_1_10004.STATE_UNLOCK then
...
function var_0_0.UpdateConsume(arg_4_0)
	...
	local var_4_4 = var_4.activity_workbench_item[var_4_3]
...
function var_0_0.UpdateName(arg_5_0)
	...
	var_5_2.sprite = var_5_0("ui/SculptureUI_atlas", var_5_1 .. "_title")
...
function var_0_0.UpdateRole(arg_6_0, arg_6_1)
	...
	if arg_6_1 == var_1_10003.STATE_FINSIH then
...
function var_0_0.UpdateBtns(arg_11_0, arg_11_1)
	...
	SculptureActivity = var_1_10005

	var_1_10002(var_11_0, arg_11_1 == var_1_10005.STATE_FINSIH)

	setActive = var_1_10002

	local var_11_1 = arg_11_0.continueBtn

	SculptureActivity = var_5

	if var_5.STATE_UNLOCK <= arg_11_1 then
		SculptureActivity = var_5

		local var_11_2

		if not (arg_11_1 < var_5.STATE_JOINT) then
			var_11_2 = false
		else
			var_11_2 = true
		end
		...
		var_1_10002(var_11_4, arg_11_1 < var_5.STATE_UNLOCK)
