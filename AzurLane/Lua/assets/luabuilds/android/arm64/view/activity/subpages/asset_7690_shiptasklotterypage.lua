...
function var_0_1.OnInit(arg_1_0)
	...
	local function var_1_2()
		if arg_1_0.currentTask then
			...
			var_2_1(var_2_0, var_2_10003.ON_TASK_SUBMIT, arg_1_0.currentTask)
		end
	...
	local function var_1_5()
		if arg_1_0.currentTask then
			...
			var_3_1(var_3_0, var_2_10003.ON_TASK_GO, arg_1_0.currentTask)
		end
	...
	local function var_1_8()
		...
		var_4_1(var_4_0, var_2_10003.ON_DROP, arg_1_0.drop)
...
function var_0_1.updateUI(arg_7_0)
	...
	for iter_7_0 = 1, #arg_7_0.taskIds do
		if not var_7_0 then
			...
			if var_1_10006.getTaskById(var_1_10008, arg_7_0.taskIds[iter_7_0]) then
				break
			end
		end
	end
	...
	if not var_7_0 then
		for iter_7_1 = #arg_7_0.taskIds, 1, -1 do
			...
			if var_1_10006.getFinishTaskById(var_1_10008, arg_7_0.taskIds[iter_7_1]) then
				break
			end
		end
	end
...
function var_0_1.showTaskUI(arg_8_0)
	...
	var_2(var_8_2, var_5.getConfig(var_8_3, "desc"))

	setText = var_2

	local var_8_4 = arg_8_0.progressDesc
	local var_8_5 = arg_8_0.currentTask
	local var_8_6 = var_5.getProgress(var_8_5)
	local var_8_7 = "/"
	local var_8_8 = arg_8_0.currentTask

	var_2(var_8_4, var_8_6 .. var_8_7 .. var_7.getConfig(var_8_8, "target_num"))
	...
	local var_8_12 = var_6.getConfig(var_8_11, "target_num")
	local var_8_13 = arg_8_0.currentTask

	var_2(var_8_9, var_8_10, var_8_12, var_7.getProgress(var_8_13))
	...
	var_2(var_8_14, var_5.getTaskStatus(var_8_15) == 1)
	...
	var_2(var_8_16, var_5.getTaskStatus(var_8_17) == 0)
	...
	var_2(var_8_18, var_5.getTaskStatus(var_8_19) == 2)
