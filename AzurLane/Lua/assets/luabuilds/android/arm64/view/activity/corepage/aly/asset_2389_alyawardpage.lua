...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_13 = var_1_12(var_1_11, var_4(var_1_10006))
	...
	local var_1_17 = var_1_16(var_1_15, var_4(var_1_10006))
	...
	local var_1_21 = var_1_20(var_1_19, var_4(var_1_10006))
	...
	var_1(var_1_28, var_4("brs_reward_tip_1"))
	...
	var_1(var_1_38, var_1_39, var_1_40, var_6)
	...
	var_1(var_1_41, var_1_42, var_1_43, var_6)
...
function var_0_1.OnFirstFlush(arg_6_0)
	...
	var_1_10002(var_6_2, var_6_3, var_6_4, var_1_10007)
	...
	var_1_10002(var_6_5, var_6_6, var_6_7, var_1_10007)
	...
	local function var_6_10()
		...
		var_9_2.show_type = var_2_10004.SHOW_TYPE_NORMAL
...
function var_0_1.ResetTop(arg_11_0)
	for iter_11_0 = 1, #arg_11_0.table_Top do
		...
		local var_11_1 = var_7.Find(var_11_0, "tabs/top_" .. iter_11_0 .. "/Label")

		i18n = var_1_10008

		var_1_10005(var_11_1, var_1_10008("yumia_award_" .. iter_11_0))

		setTextColor = var_1_10005

		local var_11_2 = arg_11_0.AD
		local var_11_3 = var_7.Find(var_11_2, "tabs/top_" .. iter_11_0 .. "/Label")

		Color = var_1_10008

		var_1_10005(var_11_3, var_1_10008.NewHex("cfcfcf"))
	end
	...
	for iter_12_0, iter_12_1 in var_1_10001(arg_12_0.table_Top) do
		...
		local function var_12_2(arg_13_0)
			if arg_13_0 then
				...
				local var_13_3 = var_3.Find(var_13_2, "tabs/top_" .. iter_12_0 .. "/Label")

				Color = var_4

				var_1(var_13_3, var_4.NewHex("0a2e31"))
			end
		...
		var_1_10006(var_12_0, var_12_1, var_12_2, var_1_10011)
	end
...
function var_0_1.OnUpdateItem(arg_21_0, arg_21_1, arg_21_2)
	...
	var_6(var_21_3, var_21_4, var_21_5, var_1_10011)

	changeToScrollText = var_6

	local var_21_6 = arg_21_2:Find("name_mask/name")

	Drop = var_21_4

	local var_21_7 = var_21_4.New({
		type = var_21_0.config.type,
		id = var_21_0.config.drop_id
	})

	var_6(var_21_6, var_9.getName(var_21_7))

	setText = var_6

	local var_21_8 = arg_21_2:Find("owner/title")

	i18n = var_9

	var_6(var_21_8, var_9("collect_page_got"))
	...
	local var_21_9 = arg_21_2:Find("owner")

	typeof = var_9
	CanvasGroup = var_11
	var_6(var_21_9, var_9(var_11)).alpha = var_21_0.count == var_21_0.config.count and 0.5 or 1
	setActive = var_7
...
function var_0_1.updateBoxPanel(arg_23_0, arg_23_1)
	...
	var_1_10003(arg_23_0.boxIconTF, var_23_0)
	...
	var_4(var_23_2, var_7(var_23_0.desc))
	...
	var_4(var_23_3, var_7("word_got") .. "：")

	local var_23_4 = arg_23_1.show_type

	Msgbox4LinkCollectGuide = var_5

	if var_23_4 == var_5.SHOW_TYPE_NORMAL then
		setText = var_23_4
	...
	var_23_4.StaticAlign(arg_23_0.boxSrcContent, arg_23_0.boxSrcTpl, #arg_23_1.skipable_list, function(arg_24_0, arg_24_1, arg_24_2)
		...
		if arg_24_0 == var_2_10003.EventUpdate then
			...
			var_2_10007(arg_24_2.Find(var_24_3, "SrcText"), var_24_2)

			local var_24_4 = arg_24_2:Find("GoBtn")

			setText = var_2_10008

			local var_24_5 = var_24_4:Find("go")

			i18n = var_24_3

			var_2_10008(var_24_5, var_24_3("brs_reward_tip_2"))

			onButton = var_2_10008

			local var_24_6 = arg_23_0
			local var_24_7 = var_24_4
			...
			var_2_10008(var_24_6, var_24_7, var_24_8, var_13)
		end
...
function var_0_1.DoSkip(arg_26_0, arg_26_1, arg_26_2)
	...
	if arg_26_1 == var_1_10003.SKIP_TYPE_SCENE then
		...
		var_26_1(var_26_0, var_1_10006, var_1_10007, var_26_2)
	else
		...
		if arg_26_1 == var_26_1.SKIP_TYPE_ACTIVITY then
			...
			local var_26_5 = var_1_10006.GO_SCENE

			SCENE = var_1_10007

			var_26_4(var_26_3, var_26_5, var_1_10007.ACTIVITY, {
				id = arg_26_2
			})
		end
	end
