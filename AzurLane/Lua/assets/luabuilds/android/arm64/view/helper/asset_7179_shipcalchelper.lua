...
function var_0_0.CalcDestoryRes(arg_1_0)
	...
	for iter_1_0, iter_1_1 in var_1_10005(arg_1_0) do
		...
		var_1_4, var_1_10011, var_1_5 = iter_1_1:calReturnRes()
		...
		var_1_0 = var_1_10013(var_1_10015, var_1_10016.map(var_1_5, function(arg_2_0)
			Drop = var_2_10001
	...
	for iter_1_2 = #var_5.MergeSameDrops(var_1_0), 1, -1 do
		...
		if var_1_6 == var_1_10011 then
			...
			if var_9.getConfig(var_1_7, "virtual_type") == 20 then
				unpack = var_10
				pg = var_1_7

				local var_1_8

				var_1_8, var_1_10011 = var_10(var_1_7.gameset.urpt_chapter_max.description)
				math = var_12

				local var_1_9 = var_12.min

				var_1_10014 = var_9.count
				getProxy = var_1_10015
				BagProxy = var_1_10017
				var_1_10017 = var_1_10015(var_1_10017)
				var_1_3 = var_1_9(var_1_10014, var_1_10011 - var_1_10015.GetLimitCntById(var_1_10017, var_1_8)) < var_9.count
		...
		if 0 < var_1_10 then
			...
			if var_1_11 == var_11 then
				...
				if var_1_11.getConfigData(iter_1_4.id).virtual_type == 20 then
					...
					var_1_10014 = var_1_10014.GetLimitCntById(var_1_10016, var_1_13)
					math = var_1_10015
					var_1_3 = var_1_10015.min(var_1_14 - var_1_10014, var_1_12) < var_1_12

					if var_1_10015 <= 0 then
						var_1_10016 = var_1[iter_1_3]
						var_1_10016.count = 0
					else
						var_1_10016 = var_1[iter_1_3]
						var_1_10016.count = var_1_10015
					end
				end
			end
		end
	...
	CompareFuncs = iter_1_3

	var_1_15(var_1_16, iter_1_3({
		function(arg_3_0)
			return arg_3_0.id
		end
	}))
