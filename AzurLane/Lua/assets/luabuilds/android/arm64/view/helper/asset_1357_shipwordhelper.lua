...
local var_0_1 = var_0_10001.ship_skin_template

pg = var_2

local var_0_2 = var_2.ship_skin_words
...
local function var_0_13(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	if not var_7 then
		...
		if var_1_10009(var_7_3) == "table" and #var_7_3 == 0 or var_0_8(var_7_3) then
			if arg_7_3 then
				arg_7_3[1] = true
			end
...
local function var_0_16(arg_10_0)
	...
	if var_10_2(var_1_10005 .. var_10_1) == 2 then
		underscore = var_1_10004

		local var_10_3 = var_1_10004.any

		getGameset = var_6

		if var_10_3(var_6("profile_cvchange_button_block")[2], function(arg_11_0)
			...
			CV_LANGUAGE_KEY = var_6

			var_10_4(var_6 .. var_10_1, 1)
	...
	if var_0_3[arg_18_0] and var_2.main_extra and var_2.main_extra ~= "" then
		...
		for iter_18_0, iter_18_1 in var_1_10005(var_2.main_extra) do
			...
			if var_18_2 <= arg_18_1 then
				...
				for iter_18_2, iter_18_3 in var_1_10013(var_1_10012) do
...
function var_0_0.GetCVList()
	...
	for iter_28_0, iter_28_1 in var_1_10001(var_1_10003.character_voice.all) do
		pg = var_1_10006
...
function var_0_0.ExistDifferentWord(arg_29_0, arg_29_1, arg_29_2)
	...
	if var_1_10006.find(arg_29_1, "main") then
		...
		string = var_1_10007
		var_29_1 = var_1_10007.split(var_29_2, "|")[arg_29_2]
	else
...
function var_0_0.ExistDifferentExWord(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	if var_6.find(arg_30_1, "main") then
...
function var_0_0.GetCvDataForShip(arg_33_0, arg_33_1)
	...
	local var_33_1 = arg_33_0.getSkinId(var_33_0)
	local var_33_2 = arg_33_0:getCVIntimacy()

	string = var_33_0

	local var_33_3 = var_33_0.split(arg_33_1, "_")
	local var_33_4
	local var_33_5
	local var_33_6
	local var_33_7
	...
	if var_33_3[1] == "main" then
		...
		var_33_10, var_33_13, var_33_14 = var_33_10(var_33_11, var_33_12, var_1_10015(var_33_3[2]), nil, var_33_2)
		var_33_5 = var_33_14
		var_33_6 = var_33_13
		var_33_4 = var_33_10
		ShipWordHelper = var_33_10
		...
		local var_33_15 = var_33_1
		local var_33_16 = var_33_3[1]

		tonumber = var_15
		var_33_7 = var_33_10(var_33_15, var_33_16, var_15(var_33_3[2]))
		ShipWordHelper = var_33_10
		var_33_10 = var_33_10.GetL2dSoundEffect

		local var_33_17 = var_33_1
		local var_33_18 = var_33_3[1]

		tonumber = var_15
		var_33_8 = var_33_10(var_33_17, var_33_18, var_15(var_33_3[2]))
	else
		ShipWordHelper = var_33_10

		local var_33_19, var_33_20, var_33_21 = var_33_10.GetWordAndCV(var_33_1, arg_33_1, nil, nil, var_33_2)

		var_33_5 = var_33_21
		var_33_6 = var_33_20
		var_33_4 = var_33_19
		ShipWordHelper = var_33_19
		var_33_7 = var_33_19.GetL2dCvCalibrate(var_33_1, arg_33_1)
		ShipWordHelper = var_11
		var_33_8 = var_11.GetL2dSoundEffect(var_33_1, arg_33_1)
	end
