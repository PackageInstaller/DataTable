...
local var_0_2 = var_2.character_voice_special
...
function var_0_0.GetWordAndCV(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_2_6(var_2_7, var_1_10012.WORD_TYPE_MAIN) then
		string = var_9

		local var_2_8 = var_9.split(arg_2_1, "_")

		ShipWordHelper = var_1_10010
		arg_2_1 = var_1_10010.WORD_TYPE_MAIN
		...
		local var_2_10 = var_1_10010(var_2_9)
		local var_2_11
		...
		string = var_2_9
		var_2_2 = var_2_9.split(var_2_11 or "", "|")[var_2_10] or ""
...
function var_0_0.ExistWord(arg_3_0, arg_3_1)
	...
	if var_3_1(var_3_2, var_1_10006.WORD_TYPE_MAIN) then
		string = var_3
		...
		local var_3_4 = var_1_10004.split(arg_3_1, "_")
	...
	if var_5_0 then
		...
		if var_5_0[var_1_10004.WORD_TYPE_MAIN] then
			...
			if var_5_0[var_4.WORD_TYPE_MAIN] ~= "" then
				...
				ShipWordHelper = var_1_10006
				var_5_1 = #var_5_2(var_5_0[var_1_10006.WORD_TYPE_MAIN], "|")
			end
		end
	end
...
function var_0_0.GetExpression(arg_6_0, arg_6_1)
	...
	if var_6_2(var_6_3, var_1_10007.WORD_TYPE_MAIN) then
		string = var_4
		...
		local var_6_6 = var_1_10005(var_6_5)

		ShipWordHelper = var_6

		local var_6_7

		if not var_6_0[var_6.WORD_TYPE_MAIN] then
			var_6_7 = ""
		end

		string = var_6_5
		var_6_1 = var_6_5.split(var_6_7, "|")[var_6_6] or ""
