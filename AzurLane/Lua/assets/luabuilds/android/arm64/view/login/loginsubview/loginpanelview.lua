...
function var_0_1.InitEvent(arg_5_0)
	...
	local function var_5_2()
		...
		if arg_5_0.shareData.autoLoginEnabled and arg_5_0.shareData.lastLoginUser then
			...
			var_6_1(var_6_0, var_2_10003.ON_LOGIN, arg_5_0.shareData.lastLoginUser)
		...
		if var_6_1(arg_5_0.loginUsername) == "" then
			...
			var_2_10001(var_6_2, var_2_10004("login_loginScene_error_noUserName"))

			ActivateInputField = var_2_10001

			var_2_10001(arg_5_0.loginUsername)
		...
		if not var_2_10001(arg_5_0.loginPassword) then
			var_6_3 = ""
		end
		...
		if var_2.New({
			...
			local var_6_4 = arg_5_0.event
			local var_6_5 = var_3.emit

			LoginMediator = var_2_10006

			var_6_5(var_6_4, var_2_10006.ON_LOGIN, var_2)
		end
	...
	local function var_5_5()
		...
		var_7_3[1] = var_2_10005.DEFINE.REGISTER_PANEL_VIEW
