...
function var_0_1.OnInit(arg_4_0)
	...
	var_1(var_4_12, var_4("yostar_login_btn"))

	setText = var_1

	local var_4_13 = arg_4_0.jpTransBtn
	local var_4_14 = var_3.Find(var_4_13, "Text")

	i18n = var_4

	var_1(var_4_14, var_4("yostar_trans_btn"))
	...
	PLATFORM_CODE = var_4
	PLATFORM_JP = var_4_13

	var_1(var_4_15, var_4 == var_4_13)
	...
	PLATFORM_CODE = var_4
	PLATFORM_US = var_4_13

	var_1(var_4_17, var_4 == var_4_13)
	...
	if var_4 == var_4_13 then
		pg = var_4

		local var_4_19 = var_4.SdkMgr.GetInstance()
		local var_4_20

		if var_4.GetChannelUID(var_4_19) == "3" then
			var_4_20 = false
		else
			var_4_20 = true
		end
		...
		var_1(var_4_21, var_4_20 == var_4_13)
		...
		if var_4 == var_4_13 then
			...
			local var_4_23 = var_4.SdkMgr.GetInstance()
			local var_4_24

			if var_4.GetChannelUID(var_4_23) ~= "1" then
				var_4_24 = false
			else
				var_4_24 = true
			end

			var_1(var_4_22, var_4_24)

			setActive = var_1

			local var_4_25 = arg_4_0.amazonLoginBtn_en

			PLATFORM_CODE = var_4_24
			PLATFORM_US = var_4_13

			if var_4_24 == var_4_13 then
				pg = var_4_24

				local var_4_26 = var_4_24.SdkMgr.GetInstance()
				local var_4_27

				if var_4.GetChannelUID(var_4_26) ~= "3" then
					var_4_27 = false
				else
					var_4_27 = true
				end

				var_1(var_4_25, var_4_27)
				arg_4_0:InitEvent()
...
function var_0_1.InitEvent(arg_5_0)
	...
	var_1_10001(arg_5_0, arg_5_0.yostarLoginBtn_en, function()
		...
		local var_12_2 = var_2_10003.SWITCH_SUB_VIEW
		local var_12_3 = {}

		LoginSceneConst = var_2_10005
		var_12_3[1] = var_2_10005.DEFINE.YOSTAR_ALERT_VIEW
		LoginSceneConst = var_5
		var_12_3[2] = var_5.DEFINE.AIRI_LOGIN_PANEL_VIEW
		LoginSceneConst = var_5
		var_12_3[3] = var_5.DEFINE.PRESS_TO_LOGIN
