...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".NewSkinShopScene"))
...
function var_0_1.init(arg_2_0)
	...
	NewSkinShopScene = var_1_10002
	var_2_0.mode = var_1_10002.MODE_OVERVIEW
	...
	arg_2_0.itemView = var_2_1(var_3.Find(var_2_2, "overlay"), arg_2_0.event)
...
function var_0_1.GetCommodity(arg_3_0, arg_3_1)
	...
	local var_3_2 = var_3_0(var_3_1, var_1_10005.TYPE_CHARGE)
	...
	local var_3_5 = var_3_1.getBuyCount(var_3_4, var_3_2.id)
...
function var_0_1.didEnter(arg_5_0)
	...
	var_1(var_3.Find(var_5_0, "overlay/left/mask"), false)
	...
	local var_5_3 = var_5_1(arg_5_0.scrollrect.gameObject)
	...
	var_4(var_6.Find(var_5_4, "overlay/right/price"), false)
...
function var_0_1.GetAllCommodity(arg_9_0)
	...
	local var_9_2 = var_1_10002(var_1_10004)
...
function var_0_1.OnUpdateItem(arg_17_0, arg_17_1, arg_17_2)
	...
	string = var_17_3
	var_17_5.text = var_17_6 .. var_17_3.format("%0.1f", var_17_4 / 100) .. "%"
