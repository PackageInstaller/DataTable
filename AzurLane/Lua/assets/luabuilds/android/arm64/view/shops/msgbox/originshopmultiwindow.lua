...
function var_0_1.InitWindow(arg_7_0, arg_7_1, arg_7_2)
	...
	WorldNShopCommodity = var_1_10009

	local var_7_4

	if var_1_10006(var_7_3, var_1_10009) then
		var_7_3 = arg_7_1
	...
	if var_7_2 ~= 0 then
		math = var_1_10007
		var_7_6 = var_1_10007.min(var_7_6, var_7_2 - arg_7_1.buyCount)
	end
	...
	var_8(var_10.Find(var_7_7, "left/IconTpl"), var_7_0)
	...
	var_7_8(var_7_10, var_7_11, var_7_12, var_13)
