...
function var_0_1.UpdateItem(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	var_2_0, setActive = arg_2_3:Find("mask"), var_1_10005

	local var_2_1 = arg_2_0.commodity

	var_1_10005(var_2_0, not var_8.CanPurchaseSubGoods(var_2_1, arg_2_2))
...
function var_0_1.OnConfirm(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10004.NEW_SERVER_SHOP_SHOPPING, {
