...
function var_0_1.RefreshUI(arg_9_0)
	...
	local function var_9_3()
		if arg_9_0.shop.refreshCount - 1 >= #var_9_0.refresh_price then
			...
			var_10_1(var_10_0, var_2_10003("shopStreet_refresh_max_count"))
		...
		i18n = var_2_10008
		var_10_5.content = var_2_10005(var_10_6, var_2_10008("word_gem_icon"), var_10_2, arg_9_0.shop.refreshCount - 1)
		...
		function var_10_5.onYes()
			...
			if var_0.getTotalGem(var_11_0) < var_10_2 then
				...
				var_11_2(var_11_1, var_3_10003("common_no_resource"))
				...
				var_11_4(var_11_3, var_3_10003.REFRESH_MILITARY_SHOP, true)
			end
	...
	var_1_10002(var_9_1, var_9_2, var_9_3, var_1_10007)

	setButtonEnabled = var_1_10002

	var_1_10002(arg_9_0.refreshBtn, true)
...
function var_0_1.OnClickCommodity(arg_15_0, arg_15_1)
	...
	function var_15_3.onYes()
		...
		var_16_1(var_16_0, var_2_10003.BUY_ITEM, var_15_0.id, 1)
...
function var_0_1.AddTimer(arg_17_0)
	...
	arg_17_0.timer = var_1_10002.New(function()
		...
		if var_18_0 - var_1.GetServerTime(var_18_1) <= 0 then
			...
			i18n = var_18_4
			var_18_6.text = var_18_4("shop_refresh_time", var_18_5)
		end
...
function var_0_1.OnTimeOut(arg_19_0)
	...
	var_19_1(var_19_0, var_1_10004.REFRESH_MILITARY_SHOP)
