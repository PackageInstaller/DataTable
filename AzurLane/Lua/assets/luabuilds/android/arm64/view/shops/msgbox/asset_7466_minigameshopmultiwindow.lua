...
local var_0_0 = "MiniGameShopMultiWindow"
...
function var_0_1.InitWindow(arg_8_0, arg_8_1, arg_8_2)
	...
	GameRoomProxy = var_1_10006

	local var_8_2 = var_1_10004(var_1_10006)
	local var_8_3 = var_4.getTicket(var_8_2)

	math = var_8_0

	local var_8_4 = var_8_0.max

	math = var_1_10007

	local var_8_5 = var_8_4(var_1_10007.floor(var_8_3 / arg_8_1:getConfig("price")), 1)

	if arg_8_1:GetMaxCnt() ~= 0 then
		math = var_7
		var_8_5 = var_7.min(var_8_5, arg_8_1:GetMaxCnt())
	end
	...
	;(function(arg_9_0)
		...
		math = var_1
		arg_9_0 = var_1.min(arg_9_0, var_8_5)
	...
	local var_8_6 = arg_8_0.topItem

	var_8(var_10.Find(var_8_6, "left/IconTpl"), var_8_1)
	...
	local var_8_7 = arg_8_0.descTF
	local var_8_8

	if not var_8_1.desc then
		var_8_8 = var_8_1:getConfig("desc")
	end

	var_8_7.text = var_8_8
	updateDrop = var_8_7

	var_8_7(arg_8_0.bottomItem, var_8_1)

	onButton = var_8_7

	local var_8_9 = arg_8_0
	local var_8_10 = arg_8_0.confirmBtn
	...
	var_8_7(var_8_9, var_8_10, var_8_11, var_13)

	onButton = var_8_7

	var_8_7(arg_8_0, arg_8_0.leftBtn, function()
	...
	var_8_7(arg_8_0, arg_8_0.rightBtn, function()
		var_0(arg_8_0.curCount + 1)
	...
	var_8_7(arg_8_0, arg_8_0.maxBtn, function()
		var_0(var_8_5)
