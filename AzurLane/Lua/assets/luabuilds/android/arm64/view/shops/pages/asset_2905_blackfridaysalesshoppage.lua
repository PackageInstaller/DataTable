...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_11 = var_3.Find(var_2_10, "pagefooter/coinShop/Text")

	i18n = var_2_9

	var_2_6(var_2_11, var_2_9("blackfriday_coinshop"))

	setText = var_2_6

	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_3.Find(var_2_12, "pagefooter/coinShop/mark")

	i18n = var_4

	var_2_6(var_2_13, var_4("blackfriday_coinshop"))

	setText = var_2_6

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_3.Find(var_2_14, "pagefooter/gemShop/Text")

	i18n = var_4

	var_2_6(var_2_15, var_4("blackfriday_gemshop"))

	setText = var_2_6

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_3.Find(var_2_16, "pagefooter/gemShop/mark")

	i18n = var_4

	var_2_6(var_2_17, var_4("blackfriday_gemshop"))

	setText = var_2_6

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_3.Find(var_2_18, "pagefooter/ptShop/Text")

	i18n = var_4

	var_2_6(var_2_19, var_4("blackfriday_ptshop"))

	setText = var_2_6

	local var_2_20 = arg_2_0._tf
	local var_2_21 = var_3.Find(var_2_20, "pagefooter/ptShop/mark")

	i18n = var_4

	var_2_6(var_2_21, var_4("blackfriday_ptshop"))
...
function var_0_1.UpdateRes(arg_3_0)
	...
	local var_3_3 = var_1_10003(var_5)
	...
	if not arg_3_0.isInitResIcon then
		...
		local var_3_6 = var_7.New
		local var_3_7 = {}

		DROP_TYPE_RESOURCE = var_1_10010
		var_3_7.type = var_1_10010
		var_3_7.id = var_3_2

		local var_3_8 = var_3_6(var_3_7)

		var_5(var_7.getIcon(var_3_8), "", arg_3_0.resIcon)
	end
...
function var_0_1.OnClickCard(arg_9_0, arg_9_1)
	...
	if var_2.Selectable(var_9_0) then
		...
		var_9_2:ExecuteAction("Open", var_2, function(arg_10_0, arg_10_1, arg_10_2)
			...
			local var_10_4 = var_2_10006.NEW_SERVER_SHOP_SHOPPING
			local var_10_5 = {}

			ActivityConst = var_2_10008
			var_10_5.actType = var_2_10008.ACTIVITY_TYPE_BLACK_FRIDAY_SHOP
...
function var_0_1.FetchShop(arg_12_0, arg_12_1)
	...
	if not var_12_1(var_12_0, var_1_10005.ACTIVITY_TYPE_BLACK_FRIDAY_SHOP) then
		pg = var_1_10003
...
function var_0_1.OnSwitch(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_1 = arg_19_1.Find(var_19_0, "mark")
	...
	local function var_19_2()
		...
		var_20_0.markTr = var_19_1
		setActive = var_20_0

		var_20_0(var_19_1, true)
	...
	var_19_0(var_19_3, var_19_4, var_19_5, var_1_10010)
...
function var_0_1.SwitchTab(arg_22_0, arg_22_1)
	...
	if var_4.GetTabCount(var_22_2) <= 1 then
		...
		var_4(var_6.Find(var_22_3, "pagefooter"), false)
	end
...
function var_0_1.updateLocalRedDotData(arg_25_0, arg_25_1)
	if arg_25_0:isPhaseTip(arg_25_1) then
		...
		var_25_1(var_25_0, var_5.UPDATE_SHOP_RED_DOT)
	end
