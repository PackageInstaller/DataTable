...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".NewServerShopPurchasePanel"))
...
function var_0_1.OnConfirm(arg_1_0)
	...
	local var_1_2 = var_1_10004.NEW_SERVER_SHOP_SHOPPING
	local var_1_3 = {}

	ActivityConst = var_1_10006
	var_1_3.actType = var_1_10006.ACTIVITY_TYPE_BLACK_FRIDAY_SHOP
