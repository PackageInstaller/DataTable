...
function var_0_1.Ctor(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	typeof = var_7
	Text = var_1_10009
	arg_2_0.skinNameTxt = var_2_4(var_2_3, var_7(var_1_10009))
	...
	typeof = var_7
	Text = var_1_10009
	arg_2_0.shipNameTxt = var_2_7(var_2_6, var_7(var_1_10009))
	...
	typeof = var_7
	Text = var_1_10009
	arg_2_0.timeLimitTxt = var_2_11(var_2_10, var_7(var_1_10009))
	...
	local var_2_17 = var_6.Find(var_2_16, "overlay/right/container/tags_container/tags")
	local var_2_18 = arg_2_0._tf

	arg_2_0.uiTagList = var_2_15(var_2_17, var_7.Find(var_2_18, "overlay/right/container/tags_container/tags/tpl"))
	...
	typeof = var_7
	Image = var_2_18
	arg_2_0.obtainBtnImg = var_2_27(var_2_26, var_7(var_2_18))
	...
	typeof = var_7
	Text = var_2_18
	arg_2_0.giftText = var_2_32(var_2_31, var_7(var_2_18))
	...
	typeof = var_7
	Text = var_2_18
	arg_2_0.consumeRealPriceTxt = var_2_36(var_2_35, var_7(var_2_18))
	...
	typeof = var_7
	Text = var_2_18
	arg_2_0.consumePriceTxt = var_2_39(var_2_38, var_7(var_2_18))
	...
	typeof = var_7
	Text = var_2_18
	arg_2_0.experienceTxt = var_2_43(var_2_42, var_7(var_2_18))
	setText = var_4

	local var_2_44 = arg_2_0.consumeTr
	local var_2_45 = var_6.Find(var_2_44, "originalprice/label")

	i18n = var_7

	var_4(var_2_45, var_7("skin_original_price"))
	...
	Vector3 = var_7
	arg_2_0.interactionPreview = var_2_58(var_2_59, var_7(0, 0, 0))
...
function var_0_1.RegisterEvent(arg_3_0)
	arg_3_0:bind(var_0_1.EVT_SHOW_OR_HIDE_PURCHASE_VIEW, function(arg_4_0, arg_4_1)
		...
		if arg_3_0.spineChar then
			...
			if arg_4_1 then
				...
				if var_2.ship_skin_template[arg_3_0.skinId].purchase_offset and #var_2 >= 3 then
					var_4_2 = arg_3_0.spineChar

					local var_4_3 = var_3.SetLocalPosition

					Vector3 = var_2_10006

					var_4_3(var_4_2, var_2_10006(var_2[1], var_2[2], var_2[3]))
				end

				if var_2 and #var_2 >= 4 then
					var_4_2 = arg_3_0.spineChar

					local var_4_4 = var_3.SetLocalScale

					Vector3 = var_2_10006

					var_4_4(var_4_2, var_2_10006(var_2[4], var_2[4], var_2[4]))
				end
			else
				local var_4_5 = arg_3_0.spineChar
				local var_4_6 = var_2.SetLocalPosition

				Vector3 = var_4_2

				var_4_6(var_4_5, var_4_2(0, 0, 0))

				local var_4_7 = arg_3_0.spineChar
				local var_4_8 = var_2.SetLocalScale

				Vector3 = var_5

				var_4_8(var_4_7, var_5(0.9, 0.9, 1))
			end
		end
	...
	local function var_3_2()
		...
		if var_2_10000.IsChangeSkin(arg_3_0.skinId) then
			...
			var_6_0.changeSkinId = var_2_10001.GetChangeSkinNextId(arg_3_0.skinId)
...
function var_0_1.FlushChangeSkin(arg_8_0, arg_8_1)
	...
	var_1_10004(arg_8_0.changeSkinUI, var_8_1 and true or false)

	if var_8_1 then
		ShipSkin = var_1_10004

		local var_8_2 = var_1_10004.GetChangeSkinGroupId(var_8_0)
		...
		var_5(var_8_4, not var_8.IsAsmrSkin(var_8_5))
	end
...
function var_0_1.FlushBgWithAnim(arg_11_0, arg_11_1)
	...
	local var_11_2 = var_11_1(var_11_0, var_1_10005(var_1_10007))
	...
	var_3({
		function(arg_12_0)
			...
			var_12_1(var_12_0, var_12_2, var_12_3, var_12_4, var_2_10007.linear, arg_12_0)
		...
		var_14_1(var_14_0, var_14_2, var_14_3, var_14_4, var_2_10006.linear, function()
...
function var_0_1.DoSwitchBgAnim(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4, arg_16_5)
	...
	local var_16_1 = var_6(var_16_0, var_1_10009(var_1_10011))

	var_16_1.alpha = arg_16_1
	LeanTween = var_1_10007

	local var_16_2 = var_1_10007.value(arg_16_0.bgsGo, arg_16_1, arg_16_2, arg_16_3)
	local var_16_3 = var_7.setOnUpdate

	System = var_10

	local var_16_4 = var_16_3(var_16_2, var_10.Action_float(function(arg_17_0)
	...
	var_16_6(var_16_5, var_10.Action(arg_16_5))
...
function var_0_1.ClearSwitchBgAnim(arg_18_0)
	...
	var_1(var_18_0, var_1_10004(var_1_10006)).alpha = 1
...
function var_0_1.FlushBG(arg_19_0, arg_19_1, arg_19_2)
	...
	if var_19_3 == var_1_10007.SKIN_TYPE_TB then
		...
		var_19_2 = var_19_3(var_1_10008.GetSecIdBySkinId(var_19_0))
	else
		ShipGroup = var_19_3
	...
	local var_19_5 = var_19_2:getShipBgPrint(true)

	pg = var_7

	local var_19_6 = var_7.ship_skin_template[var_19_0].painting

	if not arg_19_0.isToggleShowBg then
		checkABExist = var_8

		if not var_8("painting/" .. var_19_6 .. "_n") then
			if var_19_1.bg_sp ~= "" then
				var_19_5 = var_19_1.bg_sp
			end
		end

		if var_19_5 ~= var_19_2:rarity2bgPrintForGet() then
			pg = var_9

			local var_19_7 = var_9.DynamicBgMgr.GetInstance()

			var_9.LoadBg(var_19_7, arg_19_0, var_19_5, arg_19_0.diffBg.parent, arg_19_0.diffBg, function(arg_20_0)
				if arg_19_2 then
					arg_19_2()
				end
			...
			local var_19_8 = var_9.DynamicBgMgr.GetInstance()

			var_9.ClearBg(var_19_8, arg_19_0:getUIName())
		...
		var_9(arg_19_0.diffBg, var_8)

		setActive = var_9

		var_9(arg_19_0.defaultBg, not var_8)
...
function var_0_1.FlushName(arg_22_0, arg_22_1)
	...
	if var_22_3 == var_5.SKIN_TYPE_TB then
		...
		var_22_3.text = var_22_4(var_7.GetSecIdBySkinId(var_22_0))
	else
		ShipGroup = var_22_3
...
function var_0_1.FlushPaintingToggle(arg_23_0, arg_23_1)
	...
	local var_23_1 = "painting/"
	local var_23_2 = var_23_0
	local var_23_3 = var_1_10003(var_23_1 .. var_23_0.getConfig(var_23_2, "painting") .. "_n")

	if arg_23_0.isToggleShowBg and not var_23_3 then
		triggerToggle = var_4
	...
	if not var_23_0.IsSpine(var_23_4) then
		var_23_4 = var_23_0
		var_23_5 = var_23_0.IsLive2d(var_23_4)
	end

	if var_23_5 then
		PlayerPrefs = var_5

		local var_23_6 = var_5.GetInt
		local var_23_7 = "skinShop#l2dPreViewToggle"

		getProxy = var_23_2
		PlayerProxy = var_1_10010
		var_1_10010 = var_23_2(var_1_10010)

		if var_23_6(var_23_7 .. var_23_2.getRawData(var_1_10010).id, 0) == 1 then
	...
	if arg_23_0.isToggleDynamic and not var_23_5 then
		triggerToggle = var_23_9

		var_23_9(arg_23_0.dynamicToggle, false)

		arg_23_0.isToggleDynamic = false
	elseif arg_23_0.isToggleDynamic then
		local var_23_8 = arg_23_0.dynamicToggle

		var_23_9 = var_23_9.GetComponent
		typeof = var_23_2
		Toggle = var_1_10010

		if not var_23_9(var_23_8, var_23_2(var_1_10010)).isOn then
			local var_23_10 = var_23_0

			if var_23_0.IsLive2d(var_23_10) then
				Live2dConst = var_23_9

				if var_23_9.GetLive2DArm32MatchAble() then
					arg_23_0.isToggleDynamic = false
					getProxy = var_23_9
					PlayerProxy = var_23_10

					local var_23_11 = var_23_9(var_23_10)

					var_23_9 = var_23_9.getRawData(var_23_11).id
					PlayerPrefs = var_23_4

					var_23_4.SetInt("skinShop#l2dPreViewToggle" .. var_23_9, 0)
			...
			var_23_9(arg_23_0.dynamicToggle, true)
	...
	if var_23_3 then
		...
		local var_23_13 = arg_23_0.showBgToggle

		local function var_23_14(arg_24_0)
		...
		var_23_9(var_23_12, var_23_13, var_23_14, var_1_10010)
	end
	...
	if var_23_0:IsSpine() or var_23_0:IsLive2d() then
		...
		local var_23_16 = arg_23_0.dynamicToggle

		local function var_23_17(arg_25_0)
			if arg_25_0 then
			...
			var_25_1(arg_23_0.showBgToggle, not arg_25_0 and var_23_3)
		...
		var_5(var_23_15, var_23_16, var_23_17, var_1_10010)
	end
	...
	var_5(arg_23_0.dynamicToggle, var_23_5)
	...
	var_5(arg_23_0.showBgToggle, not arg_23_0.isToggleDynamic and var_23_3)
...
function var_0_1.RecordFlag(arg_26_0, arg_26_1)
	...
	var_1_10003.SetInt("skinShop#l2dPreViewToggle" .. var_26_1, arg_26_1 and 1 or 0)
	...
	NewSkinShopMediator = var_6

	var_26_3(var_26_2, var_6.ON_RECORD_ANIM_PREVIEW_BTN, arg_26_1)
...
function var_0_1.FlushDynamicPaintingResState(arg_29_0, arg_29_1)
	...
	local var_29_3 = var_5.ship_skin_template[arg_29_0.skinId].painting
	local var_29_4
	...
	if not var_29_1 and var_29_2 ~= "" then
		...
		var_29_4(var_29_7, var_29_8, var_29_9, var_1_10011)
	end
...
function var_0_1.FlushPainting(arg_34_0, arg_34_1)
	...
	local var_34_1 = var_1_10003.ship_skin_template[arg_34_0.skinId].painting

	ShipSkin = var_4

	local var_34_2 = var_4.GetChangeSkinData(arg_34_0.skinId) and true or false

	if var_34_0 == var_0_3 and not arg_34_0:ExistL2dRes(var_34_1) or var_34_0 == var_0_4 and not arg_34_0:ExistSpineRes(var_34_1) then
		var_34_0 = var_0_2
	end
...
function var_0_1.LoadMeshPainting(arg_36_0, arg_36_1, arg_36_2)
	...
	local var_36_1 = var_1_10004(var_36_0, "PaintingScaler")
	...
	if not arg_36_2 then
		...
		if var_7("painting/" .. var_36_3 .. "_n") then
	...
	if not var_7("painting/" .. var_36_3) then
		return
	end
	...
	var_7.GetPainting(var_36_5, var_36_3, true, function(arg_37_0)
		...
		var_37_1(var_3.GetChild(var_37_2, 0), var_36_2)
...
function var_0_1.LoadL2dPainting(arg_39_0, arg_39_1)
	...
	if var_39_1 == var_1_10005.SKIN_TYPE_TB then
		...
		var_39_2 = var_39_3(var_1_10007.GetSecIdBySkinId(var_39_0))
	else
		pg = var_39_3
	...
	Vector3 = var_1_10008
	var_39_6.position = var_1_10008(0, 0, -1)
	...
	arg_39_0.live2dChar = var_6.New(var_39_7, function(arg_40_0)
		...
		var_40_3(var_40_2, var_4.L2D_DEFAULT_LAYER)
...
function var_0_1.LoadSpinePainting(arg_42_0, arg_42_1)
	...
	if var_42_1 == var_1_10005.SKIN_TYPE_TB then
		...
		NewEducateHelper = var_1_10007
		var_42_2 = var_42_3(var_1_10007.GetSecIdBySkinId(var_42_0))
	else
		pg = var_42_3
		var_42_3 = var_42_3.ship_skin_template[var_42_0].ship_group
		ShipGroup = var_1_10006
		var_1_10006 = var_1_10006.getDefaultShipConfig(var_42_3)
		Ship = var_1_10007
	...
	local var_42_4 = var_42_3.GenerateData
	local var_42_5 = {
		ship = var_42_2
	}

	Vector3 = var_1_10008
	var_42_5.position = var_1_10008(0, 0, 0)
	var_42_5.parent = arg_42_0.spTF
	var_42_5.effectParent = arg_42_0.spBg
	var_42_5.offset = var_42_2:GetSkinConfig().shop_offset

	local var_42_6 = var_42_4(var_42_5)

	pg = var_1_10006

	local var_42_7 = var_1_10006.UIMgr.GetInstance()

	var_6.LoadingOn(var_42_7)

	SpinePainting = var_6
	arg_42_0.spinePainting = var_6.New(var_42_6, function(arg_43_0)
...
function var_0_1.FlushPreviewBtn(arg_49_0, arg_49_1)
	...
	var_1_10003(arg_49_0.switchPreviewBtn)
	...
	var_1_10003(arg_49_0.switchPreviewBtn, var_49_0)
...
function var_0_1.IsSwitchTweening(arg_51_0)
	...
	if not var_51_0(var_1_10003(arg_51_0.furnitureBg)) then
		LeanTween = var_51_1
		var_51_1 = var_51_1.isTweening
		go = var_3
		var_51_1 = var_51_1(var_3(arg_51_0.charBg))
	end
...
function var_0_1.ClearSwitchTween(arg_52_0)
	...
	if arg_52_0.IsSwitchTweening(var_52_0) then
		...
		var_52_2(var_3(arg_52_0.charBg))
	end
...
function var_0_1.StartSwitchAnim(arg_53_0, arg_53_1, arg_53_2, arg_53_3, arg_53_4)
	...
	local var_53_2 = var_53_1(var_53_0, var_1_10008(var_1_10010))
	...
	local var_53_5 = var_53_4(var_53_3, var_1_10009(var_1_10011))
	...
	local var_53_11 = var_53_10(var_1_10013(arg_53_1), var_53_9, arg_53_3)
	local var_53_12 = var_11.setOnComplete

	System = var_14

	var_53_12(var_53_11, var_14.Action(function()
	...
	var_53_15(var_53_14, var_14.Action(function()
...
function var_0_1.GetObtainBtnState(arg_58_0, arg_58_1)
	...
	if var_58_1 == var_1_10003.SkinShopTimeLimit then
	...
	if arg_58_0.isPreviewFurniture then
		...
		local var_58_2 = var_2(var_58_0)
		local var_58_3 = var_2.getRawData(var_58_2)
		local var_58_4 = var_2.HasFurniture

		Goods = var_5

		if var_58_4(var_58_3, var_5.Id2FurnitureId(arg_58_1.id)) then
			return var_0_5
		else
			return var_0_9
		end
	...
	if var_58_5 ~= var_3.TYPE_ACTIVITY then
		do
			local var_58_6 = arg_58_1.type

			Goods = var_3

			if var_58_6 == var_3.TYPE_ACTIVITY_EXTRA then
				return var_0_7
...
function var_0_1.FlushPrice(arg_60_0, arg_60_1)
	...
	local var_60_2 = var_60_1 == var_1_10003.SkinShopTimeLimit
	...
	if var_60_3 ~= var_60_0.TYPE_ACTIVITY then
	...
	if var_60_2 then
		local var_60_6 = arg_60_0:GetMode()

		NewSkinShopScene = var_5

		if var_60_6 == var_5.MODE_EXPERIENCE_FOR_ITEM then
	...
	local var_60_8 = var_60_7 == var_5.TYPE_SKIN
...
function var_0_1.UpdateExperiencePrice4Item(arg_61_0, arg_61_1)
	...
	local var_61_2 = var_1_10003(var_5)
	...
	if not var_61_0.detect(var_61_3, function(arg_62_0)
...
function var_0_1.UpdateExperiencePrice(arg_63_0, arg_63_1)
	...
	local var_63_1 = var_1_10003(var_5)
	local var_63_2 = var_3.getRawData(var_63_1)

	if var_3.getSkinTicket(var_63_2) < var_63_0 then
		local var_63_3 = "<color="

		COLOR_RED = var_63_2

		local var_63_4

		if not (var_63_3 .. var_63_2 .. ">") then
			var_63_4 = ""
		end

		local var_63_5 = var_63_4 .. var_3 .. (var_3 < var_63_0 and "</color>" or "")

		arg_63_0.experienceTxt.text = var_63_5 .. "/" .. var_63_0
...
function var_0_1.UpdateCommodityPrice(arg_64_0, arg_64_1)
	...
	var_64_2(var_6(var_1_10008(arg_64_0.consumePriceTxt)).parent, var_64_0 ~= var_64_1)
...
function var_0_1.UpdateFurniturePrice(arg_65_0, arg_65_1)
	...
	local var_65_1 = var_1_10003.New({
		id = var_65_0
	})
	...
	local var_65_5 = var_65_4(var_65_3, var_1_10008.ResDiamond)
	...
	var_65_6(var_8(var_1_10010(arg_65_0.consumePriceTxt)).parent, var_65_2 ~= var_65_5)
...
function var_0_1.FlushObtainBtn(arg_66_0, arg_66_1)
	...
	local var_66_1 = arg_66_0.GetObtainBtnState(var_66_0, arg_66_1)
	local var_66_2

	if not arg_66_0.obtainBtnSprites[var_66_1] then
		GetSpriteFromAtlas = var_66_0
		var_66_2 = var_66_0("ui/skinshopui_atlas", var_0_13(var_66_1))
		arg_66_0.obtainBtnSprites[var_66_1] = var_66_2
	end

	arg_66_0.obtainBtnImg.sprite = var_66_2

	local var_66_3 = arg_66_0.obtainBtnImg

	var_4.SetNativeSize(var_66_3)

	setActive = var_4

	var_4(arg_66_0.giftTag, var_66_1 == var_0_12)

	setActive = var_4

	var_4(arg_66_0.giftItem, var_66_1 == var_0_12)

	local var_66_4

	if var_66_1 == var_0_12 then
		arg_66_0:FlushGift(arg_66_1)
	else
		var_66_4 = arg_66_0.giftText
		var_66_4.text = ""
	end
	...
	local var_66_6 = arg_66_0.obtainBtn
	...
	local function var_66_7()
		...
		if var_2_10002(var_67_1) then
			...
			var_2.insert(var_67_0, function(arg_68_0)
				...
				i18n = var_3_10005
				var_68_2.content = var_3_10005("SkinDiscount_Hint")
				...
				function var_68_2.onYes()
					if var_67_1 then
						...
						if not var_0.isEnd(var_69_0) then
							...
							NewSkinShopMediator = var_4_10003

							var_69_2(var_69_1, var_4_10003.OPEN_ACTIVITY, var_67_1.id)
						end
					end
		...
		var_2(var_67_0, function()
			if var_66_1 == var_0_6 or var_66_1 == var_0_8 or var_66_1 == var_0_12 then
				...
				var_0.OnClickBtn(var_71_1, var_66_1, arg_66_1)
			end
	...
	var_66_4(var_66_5, var_66_6, var_66_7, var_1_10009)
...
function var_0_1.OnClickBtn(arg_72_0, arg_72_1, arg_72_2)
	...
	elseif arg_72_1 == var_0_10 then
		local var_72_0 = arg_72_0:GetMode()

		NewSkinShopScene = var_1_10004

		if var_72_0 == var_1_10004.MODE_EXPERIENCE_FOR_ITEM then
...
function var_0_1.FlushGift(arg_73_0, arg_73_1)
	...
	local var_73_1 = arg_73_1.GetGiftList(var_73_0)[1]

	updateDrop = var_73_0

	var_73_0(arg_73_0.giftItem, {
		type = var_73_1.type,
		id = var_73_1.id,
		count = var_73_1.count
	})
	...
	arg_73_0.giftText.text = var_73_2
...
function var_0_1.OnItemPurchase(arg_74_0, arg_74_1)
	...
	local var_74_1 = arg_74_1:GetVoucherIdList()

	getProxy = var_3
	BagProxy = var_1_10005

	local var_74_2 = var_3(var_1_10005)
	local var_74_3 = var_3.GetExclusiveDiscountItem4Shop(var_74_2, arg_74_1.id)

	if #var_74_1 <= 0 and #var_74_3 <= 0 then
		return
	end
	...
	for iter_74_0, iter_74_1 in var_5(var_74_1) do
		table = var_1_10010

		var_1_10010.insert(var_74_4, iter_74_1)
	end

	ipairs = var_5

	for iter_74_2, iter_74_3 in var_5(var_74_3) do
		table = var_1_10010

		var_1_10010.insert(var_74_4, iter_74_3.id)
	end

	local var_74_5 = arg_74_0.skinId

	pg = var_6

	local var_74_6 = var_6.ship_skin_template[var_74_5]

	SwitchSpecialChar = var_7

	local var_74_7 = var_7(var_74_6.name, true)
	local var_74_8 = arg_74_0.voucherMsgBox

	var_8.ExecuteAction(var_74_8, "Show", {
		itemList = var_74_4,
		skinId = var_74_5,
		skinName = var_74_7,
		...
		onYes = function(arg_75_0)
			if arg_75_0 then
				...
				NewSkinShopMediator = var_2_10004

				var_75_1(var_75_0, var_2_10004.ON_ITEM_PURCHASE, arg_75_0, arg_74_1.id)
			else
				...
				var_75_3(var_75_2, var_2_10004.ON_SHOPPING, arg_74_1.id, 1)
			end
...
function var_0_1.OnPurchase(arg_76_0, arg_76_1)
	...
	if arg_76_1:isDisCount() and arg_76_1:IsItemDiscountType() then
		...
		NewSkinShopMediator = var_1_10005

		var_76_2(var_76_1, var_1_10005.ON_SHOPPING_BY_ACT, arg_76_1.id, 1)
	else
		...
		var_76_4(var_76_3, var_1_10005.ON_SHOPPING, arg_76_1.id, 1)
	end
...
function var_0_1.OnActivity(arg_77_0, arg_77_1)
	...
	local var_77_1 = arg_77_1.getConfig(var_77_0, "time")
	local var_77_2 = arg_77_1
	local var_77_3 = arg_77_1.getConfig(var_77_2, "activity")

	getProxy = var_77_0
	ActivityProxy = var_6

	local var_77_4 = var_77_0(var_6)
	local var_77_5 = var_4.getActivityById(var_77_4, var_77_3)

	if var_77_3 == 0 then
		pg = var_77_2

		local var_77_6 = var_77_2.TimeMgr.GetInstance()

		if not var_77_2.inTime(var_77_6, var_77_1) then
			if var_77_5 and not var_77_5:isEnd() then
				var_77_2 = arg_77_1.type
				Goods = var_77_4

				if var_77_2 == var_77_4.TYPE_ACTIVITY then
					local var_77_7 = arg_77_0

					var_77_2 = arg_77_0.emit
					NewSkinShopMediator = var_1_10008

					var_77_2(var_77_7, var_1_10008.GO_SHOPS_LAYER, arg_77_1:getConfig("activity"))
				else
					var_77_2 = arg_77_1.type
					Goods = var_6

					if var_77_2 == var_6.TYPE_ACTIVITY_EXTRA then
						if arg_77_1:getConfig("scene") and #var_77_2 > 0 then
							var_1_10008 = arg_77_0

							local var_77_8 = arg_77_0.emit

							NewSkinShopMediator = var_1_10009

							var_77_8(var_1_10008, var_1_10009.OPEN_SCENE, var_77_2)
						else
							var_1_10008 = arg_77_0
							...
							var_77_9(var_1_10008, var_1_10009.OPEN_ACTIVITY, var_77_3)
						end
					end
				end
			else
				...
				local var_77_10 = var_77_2.TipsMgr.GetInstance()
				local var_77_11 = var_5.ShowTips

				i18n = var_1_10008

				var_77_11(var_77_10, var_1_10008("common_activity_not_start"))
			end
...
function var_0_1.OnBackyard(arg_78_0, arg_78_1)
	...
	local var_78_2 = var_1_10005(var_1_10007)
	local var_78_4

	if not var_78_1(var_78_0, var_5.getRawData(var_78_2).level, "BackYardMediator") then
		pg = var_2

		local var_78_3 = var_2.open_systems_limited[1]

		pg = var_1_10003
		var_78_4 = var_1_10003.TipsMgr.GetInstance()

		local var_78_5 = var_3.ShowTips

		i18n = var_6

		var_78_5(var_78_4, var_6("no_open_system_tip", var_78_3.name, var_78_3.level))
...
function var_0_1.OnExperience(arg_79_0, arg_79_1)
	...
	local var_79_1 = var_1_10003(var_1_10005)
	...
	if var_3.getSkinById(var_79_1, var_79_0) and not var_3:isExpireType() then
		...
		var_79_3(var_79_2, var_1_10007("already_have_the_skin"))

		return
	end

	local var_79_4 = arg_79_1
	local var_79_5 = arg_79_1.getConfig(var_79_4, "resource_num")
	local var_79_6 = arg_79_1:getConfig("time_second") * var_79_5

	pg = var_79_4

	local var_79_7 = var_79_4.TimeMgr.GetInstance()
	...
	i18n = var_1_10015
	var_79_15.content = var_1_10015("exchange_limit_skin_tip", var_79_5, var_79_12, var_79_8, var_79_9)

	function var_79_15.onYes()
		getProxy = var_2_10000
		PlayerProxy = var_2_10002

		local var_80_0 = var_2_10000(var_2_10002)
		local var_80_1 = var_0.getRawData(var_80_0)

		if var_0.getSkinTicket(var_80_1) < var_79_5 then
			pg = var_0
			...
			var_80_3(var_80_2, var_2_10003("common_no_item_1"))
		...
		var_80_5(var_80_4, var_2_10003.ON_SHOPPING, arg_79_1.id, 1)
...
function var_0_1.OnExperience4Item(arg_81_0, arg_81_1)
	...
	local var_81_1 = var_1_10003(var_1_10005)
	...
	if var_3.getSkinById(var_81_1, var_81_0) and not var_3:isExpireType() then
		...
		var_81_3(var_81_2, var_1_10007("already_have_the_skin"))

		return
	end

	local var_81_4 = arg_81_1
	local var_81_5 = arg_81_1.getConfig(var_81_4, "resource_num")
	local var_81_6 = arg_81_1:getConfig("time_second") * var_81_5

	pg = var_81_4

	local var_81_7 = var_81_4.TimeMgr.GetInstance()
	...
	local var_81_13 = var_11(var_1_10013)
	local var_81_14 = var_11.GetSkinExperienceItems(var_81_13)

	_ = var_1_10012

	local var_81_15 = var_1_10012.detect(var_81_14, function(arg_82_0)
		return arg_82_0:CanUseForShop(arg_81_1.id)
	end)

	pg = var_81_13

	local var_81_16 = var_81_13.MsgboxMgr.GetInstance()
	local var_81_17 = var_13.ShowMsgBox
	local var_81_18 = {}

	i18n = var_1_10017
	var_81_18.content = var_1_10017("exchange_limit_skin_tip", var_81_5, var_81_12, var_81_8, var_81_9)

	function var_81_18.onYes()
		if not var_81_15 or var_81_15.count < var_81_5 then
			pg = var_0
			...
			var_83_1(var_83_0, var_2_10003("common_no_item_1"))
		...
		var_83_3(var_83_2, var_2_10003.ON_ITEM_EXPERIENCE, var_81_15.id, arg_81_1.id, 1)
...
function var_0_1.FlushTag(arg_84_0, arg_84_1)
	...
	var_5.make(var_84_2, function(arg_85_0, arg_85_1, arg_85_2)
		...
		if arg_85_0 == var_2_10003.EventUpdate then
			...
			var_3(var_85_0, var_85_1 .. var_2_10007.Tag2Name(var_84_1[arg_85_1 + 1]), function(arg_86_0)
				...
				local var_86_3 = var_86_2(var_86_1, var_4(var_3_10006))
...
function var_0_1.FlushChar(arg_87_0, arg_87_1, arg_87_2)
	...
	var_3.Load(var_87_1, true, function(arg_88_0)
		...
		if var_88_0.skinshop_spine_scale[arg_87_2] then
			...
			var_88_2(var_88_1, var_2_10005(var_1.skinshop_scale, var_1.skinshop_scale, 1))
		else
			...
			var_88_4(var_88_3, var_2_10005(0.9, 0.9, 1))
		end
		...
		var_88_6(var_88_5, var_2_10005(0, 0, 0))
...
function var_0_1.FlushTimeline(arg_89_0, arg_89_1)
	...
	if arg_89_1:IsActivityExtra() and arg_89_1:ShowMaintenanceTime() then
		var_89_3, var_1_10006 = arg_89_1:GetMaintenanceMonthAndDay()

		function var_89_2()
			i18n = var_2_10000

			return var_2_10000("limit_skin_time_before_maintenance", var_89_3, var_1_10006)
		end

		var_89_1 = true
	else
		local var_89_4 = arg_89_1

		var_89_3 = arg_89_1.getConfig(var_89_4, "genre")
		ShopArgs = var_1_10006

		if var_89_3 == var_1_10006.SkinShopTimeLimit then
			getProxy = var_89_3
			ShipSkinProxy = var_89_4

			local var_89_5 = var_89_3(var_89_4)

			var_89_1 = var_89_3.getSkinById(var_89_5, var_89_0) and var_89_3:isExpireType() and not var_89_3:isExpired()
			...
			if var_89_1 then
				function var_89_2()
					...
					return var_2_10000(var_2.getRemainTime(var_91_0))
				end
			end
		else
			pg = var_89_3

			local var_89_6 = var_89_3.TimeMgr.GetInstance()
			local var_89_7

			var_89_3, var_89_7 = var_89_3.inTime(var_89_6, arg_89_1:getConfig("time"))

			if var_89_7 then
				pg = var_89_6

				local var_89_8 = var_89_6.TimeMgr.GetInstance()
				local var_89_9 = var_7.Table2ServerTime(var_89_8, var_89_7)

				function var_89_2()
					skinCommdityTimeStamp = var_2_10000

					return var_2_10000(var_89_9)
				end
			end
		end
	end
