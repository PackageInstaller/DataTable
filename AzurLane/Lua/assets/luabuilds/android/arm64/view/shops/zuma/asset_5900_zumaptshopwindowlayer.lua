...
function var_0_1.initData(arg_6_0)
	...
	var_6_3.type = var_6.getConfig(var_6_4, "resource_category")

	local var_6_5 = arg_6_0.goodVO

	var_6_3.id = var_6.getConfig(var_6_5, "resource_type")

	local var_6_6 = var_6_2(var_6_3)

	arg_6_0.maxBuyCount = var_6_1(var_3.getOwnedCount(var_6_6) / arg_6_0.perCost)
	...
	if var_1.getConfig(var_6_7, "num_limit") ~= 0 then
		...
		local var_6_10 = var_4.max
		local var_6_11 = arg_6_0.goodVO

		arg_6_0.maxBuyCount = var_6_8(var_6_9, var_6_10(var_6.GetPurchasableCnt(var_6_11), 0))
	end
	...
	var_6_13.type = var_4.getConfig(var_6_14, "resource_category")

	local var_6_15 = arg_6_0.goodVO

	var_6_13.id = var_4.getConfig(var_6_15, "resource_type")
...
function var_0_1.findUI(arg_7_0)
	...
	var_7_4, setText = var_2:Find("Count/Tip"), var_7_2
	i18n = var_1_10007

	var_7_2(var_7_4, var_1_10007("word_own1"))

	arg_7_0.titleTF = var_1:Find("Title")

	local var_7_5 = var_1:Find("Buy")

	arg_7_0.minusBtn = var_4.Find(var_7_5, "Minus")
...
function var_0_1.addListener(arg_8_0)
	...
	local function var_8_9()
		...
		if arg_8_0.curBuyCount > arg_8_0.maxBuyCount then
			...
			var_10_1(var_10_0, var_2_10003(var_10_2, var_6.getName(var_10_3)))
		...
		var_10_5(var_10_4, var_2_10003.ISLAND_SHOPPING, {
	...
	var_8_13(var_8_12, var_5.max(arg_8_0.maxBuyCount, 1))
...
function var_0_1.updateGoodInfoPanel(arg_12_0)
	...
	var_1_10003(arg_12_0.itemTF, var_12_1)

	local var_12_2 = var_12_1
	local var_12_3, var_12_4 = var_12_1.getOwnedCount(var_12_2)

	setActive = var_12_2

	var_12_2(arg_12_0.countTF, var_12_4)

	if var_12_4 then
		setText = var_12_2

		var_12_2(arg_12_0.countText, var_12_3)
	end

	setText = var_12_2

	var_12_2(arg_12_0.nameText, var_12_1:getConfig("name"))

	setText = var_12_2

	local var_12_5 = arg_12_0.descText

	string = var_8

	local var_12_6 = var_8.gsub
	local var_12_7

	if not var_12_1.desc then
		var_12_7 = var_12_1:getConfig("desc")
	end

	var_12_2(var_12_5, var_12_6(var_12_7, "<[^>]+>", ""))
