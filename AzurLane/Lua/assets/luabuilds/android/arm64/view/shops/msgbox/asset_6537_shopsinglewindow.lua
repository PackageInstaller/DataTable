...
function var_0_1.InitWindow(arg_8_0, arg_8_1, arg_8_2)
	...
	var_4(var_8_1, var_8_2, var_8_3, var_1_10009)

	updateDrop = var_4

	local var_8_4 = arg_8_0.itemTF

	var_4(var_6.Find(var_8_4, "left/IconTpl"), var_8_0)
	...
	if var_8_6 then
		...
		local var_8_9 = var_8(var_1_10010)
		local var_8_10 = var_8.getShipGroup

		pg = var_1_10011

		local var_8_11 = var_6(var_8_10(var_8_9, var_1_10011.ship_data_template[var_8_0.id].group_type))

		SetActive = var_8_7

		var_8_7(var_8_8:Find("unlocked"), var_8_11)

		SetActive = var_8_7

		var_8_7(var_8_8:Find("locked"), not var_8_11)
	end
