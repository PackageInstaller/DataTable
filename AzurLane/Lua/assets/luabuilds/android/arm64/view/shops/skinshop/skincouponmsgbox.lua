...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.label1 = var_2_5(var_2_4, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.nameTxt = var_2_9(var_2_8, var_4(var_1_10006))
	setText = var_1
	...
	var_1(var_2_11, var_4("msgbox_text_cancel"))
	...
	var_1(var_2_13, var_4("msgbox_text_confirm"))

	setText = var_1

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_3.Find(var_2_14, "window/top/bg/infomation/title")

	i18n = var_4

	var_1(var_2_15, var_4("words_information"))
