...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".SkinCouponMsgBox"))
local var_0_2 = 0
local var_0_3 = 1
...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.label1 = var_2_6(var_2_5, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.nameTxt = var_2_10(var_2_9, var_4(var_1_10006))
	setText = var_1
	...
	var_1(var_2_12, var_4("msgbox_text_cancel"))

	setText = var_1

	local var_2_13 = arg_2_0.confirmBtn
	local var_2_14 = var_3.Find(var_2_13, "pic")

	i18n = var_4

	var_1(var_2_14, var_4("msgbox_text_confirm"))

	setText = var_1

	local var_2_15 = arg_2_0._tf
	local var_2_16 = var_3.Find(var_2_15, "window/top/bg/infomation/title")

	i18n = var_4

	var_1(var_2_16, var_4("words_information"))
	...
	local var_2_20 = var_3.Find(var_2_19, "window/top/bg/infomation/title")

	i18n = var_4

	var_1(var_2_20, var_4("title_info"))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.linkText = var_2_30(var_2_29, var_4(var_6))
	setText = var_1

	local var_2_31 = arg_2_0._tf
	local var_2_32 = var_3.Find(var_2_31, "window/frame/option/nonuse/Text")

	i18n = var_4

	var_1(var_2_32, var_4("skin_shop_nonuse_label"))

	setText = var_1

	local var_2_33 = arg_2_0._tf
	local var_2_34 = var_3.Find(var_2_33, "window/frame/option/use/Text")

	i18n = var_4

	var_1(var_2_34, var_4("skin_shop_use_label"))
...
function var_0_1.RegisterBtn(arg_3_0, arg_3_1)
	...
	var_1_10002(var_3_0, var_3_1, var_3_2, var_1_10007)
	...
	var_1_10002(var_3_3, var_3_4, var_3_5, var_1_10007)
	...
	var_1_10002(var_3_6, var_3_7, var_3_8, var_1_10007)
	...
	var_1_10002(var_3_9, var_3_10, var_3_11, var_1_10007)
	...
	var_1_10002(var_3_12, var_3_13, var_3_14, var_1_10007)
	...
	var_1_10002(var_3_15, var_3_16, var_3_17, var_1_10007)
	...
	var_1_10002(var_3_18, var_3_19, var_3_20, var_1_10007)
...
function var_0_1.UpdateLink(arg_16_0)
	...
	if not var_1_10002.item_data_statistics[var_16_0].usage_arg[2] then
		var_16_1 = 0
	end

	local var_16_2 = arg_16_0.linkText

	i18n = var_1_10004
	var_16_2.text = var_1_10004("skin_shop_discount_item_link", var_16_1)
...
function var_0_1.UpdateItem(arg_17_0, arg_17_1)
	...
	local var_17_3 = var_5.Find(var_17_2, "window/frame/scrollrect/list")
	local var_17_4 = arg_17_0._tf

	var_17_1(var_17_3, var_6.Find(var_17_4, "window/frame/left"), #var_17_0, function(arg_18_0, arg_18_1, arg_18_2)
...
function var_0_1.FlushItem(arg_19_0, arg_19_1, arg_19_2)
	...
	var_1_10004(arg_19_2:Find("name_bg/Text"), var_19_2)
	...
	var_1_10004(var_19_3, var_19_4, var_19_5, var_9)
...
function var_0_1.UpdateStyle(arg_23_0, arg_23_1)
	...
	var_1_10003(arg_23_0.itemTrs[var_23_0], true)
...
function var_0_1.SetTipText(arg_25_0, arg_25_1)
	...
	if var_25_3 then
		...
		for iter_25_4, iter_25_5 in var_7(var_25_2) do
			if iter_25_4 ~= var_25_3 then
				if var_25_4 == "" then
					...
					var_1_10013 = "、"
					i18n = iter_25_2
					var_25_4 = var_1_10012 .. var_1_10013 .. iter_25_2(iter_25_5[2])
				end
			end
		end
		...
		local var_25_5 = arg_25_0.tipText

		i18n = iter_25_4

		local var_25_6 = "no_share_skin_gametip"

		i18n = var_1_10013

		var_7(var_25_5, iter_25_4(var_25_6, var_1_10013(var_25_2[var_25_3][2]), var_25_4))
	end
