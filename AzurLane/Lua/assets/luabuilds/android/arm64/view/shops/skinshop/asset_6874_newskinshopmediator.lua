				...
				if var_14_3 ~= var_1_10007.SkinShop then
					...
					if var_14_3 == var_7.SkinShopTimeLimit then
						...
						if var_14_5 == var_1_10008.SKIN_TYPE_TB then
							...
							var_14_5 = arg_14_0.addSubLayers
							Context = var_1_10010
							...
							var_14_7.mediator = var_1_10013
							NewSkinTBLayer = var_1_10013
							var_14_7.viewComponent = var_1_10013
							var_1_10013 = {
								skinId = var_5.effect_args[1]
							}

							local var_14_8 = var_5.genre

							ShopArgs = var_1_10015
							var_1_10013.timeLimit = var_14_8 == var_1_10015.SkinShopTimeLimit
							var_14_7.data = var_1_10013

							var_14_5(var_14_6, var_1_10010(var_14_7))
						else
							PaintingShowScene = var_14_5

							if var_14_5.GetSkinShowAble(var_14_3) then
								local var_14_9 = arg_14_0
								local var_14_10 = arg_14_0.addSubLayers
								...
								PaintingShowMediator = var_1_10013
								var_14_11.mediator = var_1_10013
								PaintingShowNewSkinScene = var_1_10013
								var_14_11.viewComponent = var_1_10013
								var_1_10013 = {
									is_shop = true,
									skinId = var_14_3
								}

								local var_14_12 = var_5.genre

								ShopArgs = var_1_10015
								var_1_10013.timeLimit = var_14_12 == var_1_10015.SkinShopTimeLimit
								var_14_11.data = var_1_10013

								var_14_10(var_14_9, var_1_10010(var_14_11))
							else
								local var_14_13 = arg_14_0
								local var_14_14 = arg_14_0.addSubLayers

								Context = var_1_10010

								local var_14_15 = var_1_10010.New
								local var_14_16 = {}

								NewSkinMediator = var_1_10013
								var_14_16.mediator = var_1_10013
								NewSkinLayer = var_1_10013
								var_14_16.viewComponent = var_1_10013

								local var_14_17 = {
									skinId = var_5.effect_args[1]
								}
								local var_14_18 = var_5.genre

								ShopArgs = var_1_10015
								var_14_17.timeLimit = var_14_18 == var_1_10015.SkinShopTimeLimit
								var_14_16.data = var_14_17

								var_14_14(var_14_13, var_14_15(var_14_16))
							end
						end

						local var_14_19 = arg_14_0.viewComponent

						var_7.OnShopping(var_14_19, var_14_2.id)
						...
						if var_14_0 == var_5.BUY_FURNITURE_DONE then
							...
							var_5.OnFurnitureUpdate(var_14_20, var_14_4[1])
						else
							GAME = var_5
							...
							if var_14_0 == var_5.LOAD_LAYERS then
								var_14_21 = var_14_2.context.mediator
								NewBackYardShopMediator = var_14_3

								if var_14_21 == var_14_3 then
									local var_14_22 = arg_14_0

									var_14_21 = arg_14_0.sendNotification
									PlayerResUI = var_1_10008

									var_14_21(var_14_22, var_1_10008.HIDE)
								end
							else
								GAME = var_14_21

								if var_14_0 == var_14_21.REMOVE_LAYERS then
									local var_14_23 = var_14_2.context.mediator

									NewBackYardShopMediator = var_14_3

									if var_14_23 == var_14_3 then
										local var_14_24 = arg_14_0
										local var_14_25 = arg_14_0.sendNotification

										PlayerResUI = var_1_10008

										var_14_25(var_14_24, var_1_10008.SHOW)
									end
								end
							end
						end
