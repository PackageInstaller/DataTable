...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.shops.skinShop.SkinCouponMsgBox"))
local var_0_2 = 0
local var_0_3 = 1
...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_6
	arg_2_0.linkText = var_2_29(var_2_28, var_4(var_6))
	setText = var_1

	local var_2_30 = arg_2_0._tf
	local var_2_31 = var_3.Find(var_2_30, "window/frame/option/nonuse/Text")

	i18n = var_4

	var_1(var_2_31, var_4("skin_shop_nonuse_label"))

	setText = var_1

	local var_2_32 = arg_2_0._tf
	local var_2_33 = var_3.Find(var_2_32, "window/frame/option/use/Text")

	i18n = var_4

	var_1(var_2_33, var_4("skin_shop_use_label"))
...
function var_0_1.UpdateContent(arg_12_0, arg_12_1)
	...
	if arg_12_0.prevSelected then
		...
		var_12_3.text = var_7(var_12_4, var_10.getName(var_12_5), var_1_10005, var_12_0)
	else
...
function var_0_1.UpdateItem(arg_14_0, arg_14_1)
	...
	local var_14_3 = var_5.Find(var_14_2, "window/frame/scrollrect/list")
	local var_14_4 = arg_14_0._tf

	var_14_1(var_14_3, var_6.Find(var_14_4, "window/frame/left"), #var_14_0, function(arg_15_0, arg_15_1, arg_15_2)
...
function var_0_1.FlushItem(arg_16_0, arg_16_1, arg_16_2)
	...
	var_1_10003(var_16_0, var_6.getName(var_16_1))
	...
	var_1_10003(var_16_2, var_16_3, var_16_4, var_16_1)
...
function var_0_1.UpdateStyle(arg_20_0, arg_20_1)
	...
	var_1_10003(arg_20_0.itemTrs[var_20_0], true)
...
function var_0_1.SetTipText(arg_22_0, arg_22_1)
	...
	if var_22_3 then
		...
		for iter_22_4, iter_22_5 in var_7(var_22_2) do
			if iter_22_4 ~= var_22_3 then
				if var_22_4 == "" then
					...
					var_1_10013 = "、"
					i18n = iter_22_2
					var_22_4 = var_1_10012 .. var_1_10013 .. iter_22_2(iter_22_5[2])
				end
			end
		end
		...
		local var_22_5 = arg_22_0.tipText

		i18n = iter_22_4

		local var_22_6 = "no_share_skin_gametip"

		i18n = var_1_10013

		var_7(var_22_5, iter_22_4(var_22_6, var_1_10013(var_22_2[var_22_3][2]), var_22_4))
	end
