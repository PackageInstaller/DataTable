...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.text = var_2_6(var_2_5, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.textWithGift = var_2_10(var_2_9, var_4(var_1_10006))
	UIItemList = var_1

	local var_2_11 = var_1.New
	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_3.Find(var_2_12, "frame/gift_bg/gift/drops")
	local var_2_14 = arg_2_0._tf

	arg_2_0.dropsList = var_2_11(var_2_13, var_4.Find(var_2_14, "frame/gift_bg/gift/drops/item"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_8()
		if arg_3_0.commodity then
			...
			NewSkinShopMainView = var_2_10003

			var_6_1(var_6_0, var_2_10003.EVT_ON_PURCHASE, arg_3_0.commodity)
		end
...
function var_0_1.Show(arg_7_0, arg_7_1)
	...
	NewSkinShopMainView = var_5

	var_7_1(var_7_0, var_5.EVT_SHOW_OR_HIDE_PURCHASE_VIEW, true)
...
function var_0_1.Flush(arg_9_0, arg_9_1)
	...
	local var_9_5 = var_9_2.ship_skin_template
	local var_9_6 = arg_9_1
	local var_9_7 = var_9_5[arg_9_1.getSkinId(var_9_6)].name

	getProxy = var_7
	PlayerProxy = var_9_6

	local var_9_8 = var_7(var_9_6)
	local var_9_9 = var_7.getRawData(var_9_8)

	if var_9_4 <= var_7.getChargeGem(var_9_9) then
		COLOR_GREEN = var_8
		...
		i18n = var_9_9
		var_9_3.text = var_9_9("skin_shop_buy_confirm", var_8, var_9_4, var_9_7)
...
function var_0_1.FlushGift(arg_10_0, arg_10_1)
	...
	var_2.make(var_10_0, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			var_5(var_11_2, var_11_3, var_11_4, var_2_10010)
		end
...
function var_0_1.SetTipText(arg_13_0, arg_13_1)
	...
	if var_13_3 then
		...
		for iter_13_4, iter_13_5 in var_7(var_13_2) do
			if iter_13_4 ~= var_13_3 then
				if var_13_4 == "" then
					...
					var_1_10013 = "、"
					i18n = iter_13_2
					var_13_4 = var_1_10012 .. var_1_10013 .. iter_13_2(iter_13_5[2])
				end
			end
		end
		...
		local var_13_5 = arg_13_0.tipText

		i18n = iter_13_4

		local var_13_6 = "no_share_skin_gametip"

		i18n = var_1_10013

		var_7(var_13_5, iter_13_4(var_13_6, var_1_10013(var_13_2[var_13_3][2]), var_13_4))
	end
...
function var_0_1.Hide(arg_14_0)
	...
	NewSkinShopMainView = var_1_10004

	var_14_1(var_14_0, var_1_10004.EVT_SHOW_OR_HIDE_PURCHASE_VIEW, false)
