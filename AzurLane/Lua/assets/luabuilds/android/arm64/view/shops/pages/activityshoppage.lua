...
function var_0_1.GetPaintingName(arg_3_0)
	...
	local var_3_1 = var_2(var_1_10004)
...
function var_0_1.init(arg_9_0)
	...
	local var_9_3 = var_3.Find(var_9_2, "viewport/view")
	local var_9_4 = arg_9_0.scrollRectSpecial

	arg_9_0.groupList = var_9_1(var_9_3, var_4.Find(var_9_4, "viewport/view/group"))
...
function var_0_1.GetResDataList(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10003(var_12_2) do
		...
		var_12_6.type = var_1_10013
		var_12_6.resID = iter_12_1
		var_12_6.cnt = var_12_4

		var_1_10009(var_12_5, var_12_6)
	end
...
function var_0_1.UpdateTip(arg_18_0)
	...
	var_18_2.text = var_18_3 .. var_18_4 .. var_18_5 .. var_1_10007(var_18_6, var_10.getOpenTime(var_18_7)) .. "</size>"
...
function var_0_1.TipPurchase(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	...
	if 0 < var_23_0 then
		...
		i18n = var_1_10012
		var_23_5.content = var_1_10012("pt_shop_tran_tip", var_23_2, arg_23_3, var_23_0 * var_23_1.count, var_23_1:getConfig("name"))
...
function var_0_1.OnPurchase(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_1 = arg_24_1.getConfig(var_24_0, "commodity_type")
	local var_24_2 = arg_24_1:getConfig("commodity_id")

	DROP_TYPE_ITEM = var_24_0

	if var_24_1 == var_24_0 then
		getProxy = var_24_0
		BagProxy = var_7

		local var_24_3 = var_24_0(var_7)
		...
		if var_5.RawGetItemById(var_24_3, var_24_2) and var_5:IsShipExpType() and var_5:IsMaxCnt() then
			...
			var_24_5(var_24_4, var_1_10009("item_is_max_cnt"))
	...
	NewShopMainMediator = var_1_10009

	var_24_8(var_24_7, var_1_10009.ON_ACT_SHOPPING, var_24_6, 1, arg_24_1.id, arg_24_2)
...
function var_0_1.OnClickCommodity(arg_25_0, arg_25_1, arg_25_2)
	...
	if var_3 and not arg_25_1:CheckArgLimit() then
		...
		if var_25_1 == var_1_10009.LIMIT_ARGS_META_SHIP_EXISTENCE then
			...
			local var_25_5 = var_1_10010.TipsMgr.GetInstance()
			...
			var_25_6(var_25_5, var_1_10013(var_25_7, var_25_8))
		else
			ShopArgs = var_25_4
			...
			if var_25_1 == var_25_4.LIMIT_ARGS_SALE_START_TIME then
				...
				var_25_11(var_25_10, var_1_10013("meta_shop_exchange_limit_2_tip", var_25_9.year, var_25_9.month, var_25_9.day, var_25_9.hour, var_25_9.min, var_25_9.sec))
			end
		end
...
function var_0_1.Show(arg_26_0)
	...
	if var_1_10001.activity_template[arg_26_0.shop.activityId] and var_1.config_client and var_1.config_client.category then
		...
		var_26_0(var_1_10004(arg_26_0.lScrollrect), false)

		setActive = var_26_0

		var_26_0(arg_26_0.scrollRectSpecial, true)

		var_1_10004 = arg_26_0.groupList

		var_26_0.make(var_1_10004, function(arg_27_0, arg_27_1, arg_27_2)
			...
			if arg_27_0 == var_2_10003.EventUpdate then
				...
				local var_27_1 = arg_27_2:Find("title/name")

				i18n = var_2_10007

				var_4(var_27_1, var_2_10007(arg_26_0.spiltNameCodes[arg_27_1 + 1]))

				UIItemList = var_4

				local var_27_2 = var_4.New(arg_27_2:Find("items"), arg_27_2:Find("items/ActivityShopNewTpl"))
				...
				var_4.make(var_27_2, function(arg_28_0, arg_28_1, arg_28_2)
					...
					if arg_28_0 == var_3_10003.EventUpdate then
						...
						var_28_1(var_28_2, var_28_3, var_28_4, var_3_10009)
		...
		var_26_0.align(var_1_10004, #arg_26_0.splitCommodities)
		...
		var_26_0(var_1_10004(arg_26_0.lScrollrect), true)
	...
	if var_2.GetBGM(var_26_1) ~= "" then
		...
		var_26_3(var_26_2, var_26_4, var_6.GetBGM(var_26_5))
	end
...
function var_0_1.Hide(arg_31_0)
	...
	var_31_0(var_1_10004(arg_31_0.lScrollrect), true)
