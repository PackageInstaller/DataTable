...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.itemCountTF = var_2_13(var_2_12, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.countTF = var_2_19(var_2_18, var_4(var_1_10006))
	...
	local var_2_23 = var_3.Find(var_2_22, "got/panel_bg/got_text")

	i18n = var_4

	var_1(var_2_23, var_4("shops_msgbox_output"))

	setText = var_1

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_3.Find(var_2_24, "count/image_text")

	i18n = var_4

	var_1(var_2_25, var_4("shops_msgbox_exchange_count"))

	setText = var_1

	local var_2_26 = arg_2_0._tf
	local var_2_27 = var_3.Find(var_2_26, "actions/cancel_button/label")

	i18n = var_4

	var_1(var_2_27, var_4("shop_word_cancel"))

	setText = var_1

	local var_2_28 = arg_2_0._tf
	local var_2_29 = var_3.Find(var_2_28, "actions/confirm_button/label")

	i18n = var_4

	var_1(var_2_29, var_4("shop_word_exchange"))
...
function var_0_1.InitWindow(arg_7_0, arg_7_1, arg_7_2)
	...
	ActivityCommodity = var_7

	local var_7_2

	if var_4(var_7_1, var_7) then
		local var_7_3

		var_7_2, var_1_10005, var_7_3 = arg_7_1:CheckTimeLimit()
		setActive = var_7

		var_7(arg_7_0.timeLimitTF, var_7_2)

		if var_7_2 and var_1_10005 then
			getProxy = var_7
			ActivityProxy = var_9

			local var_7_4 = var_7(var_9)
			local var_7_5 = var_7.getActivityById

			Item = var_1_10011

			local var_7_6 = var_7_5(var_7_4, var_1_10011.getConfigData(var_7_0.id).link_id)
			local var_7_7 = var_8.IsMaintenanceFinish(var_7_6) and "eventshop_time_hint" or "eventshop_time_hint2"

			setText = var_7_4

			local var_7_8 = arg_7_0.timeLimitTF
			local var_7_9 = var_12.Find(var_7_8, "Text")
			...
			local var_7_11 = var_1_10016.TimeMgr.GetInstance()

			var_7_4(var_7_9, var_13(var_7_10, var_16.STimeDescS(var_7_11, var_8.stopTime, "%m.%d")))
		end
	end
	...
	local var_7_14 = var_1_10005.max

	math = var_7

	local var_7_15 = var_7_14(var_7.floor(var_7_13 / arg_7_1:getConfig("resource_num")), 1)
	...
	if arg_7_1:getConfig("num_limit") == 0 then
		...
		QuotaCommodity = var_9

		if var_6(var_7_16, var_9) then
			local var_7_17 = arg_7_1:GetPurchasableCnt()

			math = var_7

			local var_7_18 = var_7.min
			local var_7_19 = var_7_15

			math = var_10
			var_7_15 = var_7_18(var_7_19, var_10.max(0, var_7_17))
		end
		...
		local var_7_20 = arg_7_0.topItem

		var_7(var_9.Find(var_7_20, "left/IconTpl"), var_7_0)
		...
		local var_7_21 = arg_7_0.descTF

		HXSet = var_8

		local var_7_22 = var_8.hxLan
		local var_7_23, var_7_24

		if not var_7_0.desc then
			var_7_23 = var_7_0
			var_7_24 = var_7_0.getConfig(var_7_23, "desc")
		end

		var_7_21.text = var_7_22(var_7_24)
		updateDrop = var_7_21

		var_7_21(arg_7_0.bottomItem, var_7_0)
		...
		local function var_7_27()
			if arg_7_2 then
				...
				var_9_0(var_9_1, var_9_2, var_4.getConfig(var_9_3, "name"))
			end
		...
		var_7_21(var_7_25, var_7_26, var_7_27, var_7_23)

		onButton = var_7_21

		var_7_21(arg_7_0, arg_7_0.leftBtn, function()
		...
		var_7_21(arg_7_0, arg_7_0.rightBtn, function()
			var_0(arg_7_0.curCount + 1)
		...
		var_7_21(arg_7_0, arg_7_0.maxBtn, function()
			var_0(var_7_15)
