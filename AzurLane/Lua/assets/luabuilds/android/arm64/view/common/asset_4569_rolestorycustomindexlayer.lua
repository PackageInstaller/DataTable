...
function var_0_1.init(arg_2_0)
	...
	local var_2_1 = var_3.Find(var_2_0, "index_panel/Text")

	i18n = var_1_10004

	var_1(var_2_1, var_1_10004("memory_filter_title_1"))

	setText = var_1

	local var_2_2 = arg_2_0._tf
	local var_2_3 = var_3.Find(var_2_2, "index_panel/Text/Text")

	i18n = var_4

	var_1(var_2_3, var_4("memory_filter_title_2"))
