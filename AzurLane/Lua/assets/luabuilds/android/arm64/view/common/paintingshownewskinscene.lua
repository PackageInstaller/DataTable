...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.common.PaintingShowScene"))
...
function var_0_1.closeView(arg_2_0)
	...
	if not arg_2_0.skinLayerAdded then
		...
		local var_2_2 = var_1_10004.New
		local var_2_3 = {}

		NewSkinMediator = var_1_10007
		var_2_3.mediator = var_1_10007
		NewSkinLayer = var_1_10007
		var_2_3.viewComponent = var_1_10007
		var_2_3.data = {
