...
function var_0_1.UpdateVirtualBtn(arg_3_0)
	...
	var_1(var_3_3, var_4(arg_3_0.names[arg_3_0.preIndex]))
...
function var_0_1.OnInit(arg_4_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_4_0.greySprite = var_4_3(var_4_2, var_4(var_1_10006)).sprite
	...
	typeof = var_4
	Image = var_1_10006
	arg_4_0.yellowSprite = var_4_6(var_4_5, var_4(var_1_10006)).sprite
	tf = var_1
	instantiate = var_4_5
	...
	Vector3 = var_1_10002
	var_4_9.localEulerAngles = var_1_10002.New(0, 0, 0)
	onButton = var_4_9
	...
	var_2(arg_4_0, var_4_11, function()
	...
	local var_4_14 = var_2(var_4_13, var_5(var_1_10007))
	...
	for iter_4_0 = 1, #arg_4_0.options do
		...
		if iter_4_0 == 1 then
			...
			local var_4_16 = var_1_10008(var_1_10010(arg_4_0.btnTpl))
			local var_4_17 = var_1_10008.Find(var_4_16, "Image")

			go = var_1_10010
			var_1_10010 = var_1_10010(var_1_10008)
			i18n = var_4_16
			var_1_10010.name = var_4_16(arg_4_0.names[iter_4_0])
			...
			local var_4_18 = var_4_17

			i18n = var_13

			var_1_10010(var_4_18, var_13(arg_4_0.names[iter_4_0]))
			...
			var_1_10010(var_4_19, var_4_20, var_4_21, var_15)
...
function var_0_1.UpdateData(arg_9_0, arg_9_1)
	...
	if var_9_2 == var_5.Mode.AND then
		if var_9_1 then
			...
			var_9_4 = arg_9_0.tag
			bit = var_6
			var_9_3[var_9_4] = var_6.bxor(var_9_0, arg_9_0.options[arg_9_1])
		end
	else
