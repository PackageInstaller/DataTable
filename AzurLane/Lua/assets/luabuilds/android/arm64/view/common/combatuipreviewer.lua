...
local var_0_1 = var_2(0, 1, 40)

Vector3 = var_0_10003

local var_0_2 = var_0_10003(35, 1, 40)
...
function var_0_0.setCombatUI(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	...
	var_6(var_8.Find(var_3_0, "Text"), "03:00")
	...
	for iter_3_0 = 1, 3 do
		...
		if iter_3_0 == 3 then
			...
			if var_14(var_3_4, var_17(var_1_10019.Playables.PlayableDirector)) then
				var_14.enabled = true
			end
		end
	end
	...
	var_7(var_9.Find(var_3_5, "heroBlood"), true)
	...
	var_7(var_9.Find(var_3_6, "enemyBlood"), true)
	...
	for iter_3_1 = 0, var_3_8 do
		var_1_10015 = var_7
		var_1_10015 = var_7.GetChild(var_1_10015, iter_3_1)
		var_1_10013 = var_1_10013.GetComponent
		typeof = var_16
		Image = var_1_10018
		var_1_10013 = var_1_10013(var_1_10015, var_16(var_1_10018))
	...
	if var_5:Find("Stick/Area/BG/spine") then
		local var_3_9 = var_9
		local var_3_10 = var_9.GetComponent

		typeof = var_1_10013
		SpineAnimUI = var_1_10015

		local var_3_11 = var_3_10(var_3_9, var_1_10013(var_1_10015))

		var_10.SetAction(var_3_11, "normal", 0)
	end

	arg_3_0.stick = var_5:Find("Stick/Area/Stick")

	local var_3_12 = arg_3_0.stick

	arg_3_0.stickTail = var_10.Find(var_3_12, "tailGizmos")
...
function var_0_0.load(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5)
	...
	local function var_4_2()
		...
		local function var_5_1(arg_6_0)
			...
			for iter_6_0, iter_6_1 in var_3_10005(var_3_10007.Battle.BattleConst.FXContainerIndex) do
			...
			local function var_6_9(arg_7_0, arg_7_1)
				...
				var_7_2(var_7_1, var_6.Battle.BattleConst.ActionName.MOVE, 0, true)
				...
				local var_7_7 = var_7_3.EffectMgr.GetInstance()
				local var_7_8 = var_7.PlayBattleEffect
				local var_7_9 = var_7_6

				Vector3 = var_4_10011

				var_7_8(var_7_7, var_7_9, var_4_10011.zero, true)
			...
			local var_6_14 = var_6_12(var_6_11, var_10.getPrefab(var_6_13))

			ys = var_8

			local var_6_15 = var_8.Battle.BattleResourceManager.GetInstance()
			local var_6_16 = var_8.GetCharacterQIcon
			local var_6_17 = arg_4_0.shipVO
			local var_6_18 = var_6_16(var_6_15, var_11.getPrefab(var_6_17))

			findTF = var_6_11

			local var_6_19 = var_6_11(arg_4_0.mainArrow, "icon")

			setImageSprite = var_6_15

			var_6_15(var_6_19, var_6_18)

			setImageSprite = var_6_15
			findTF = var_12

			var_6_15(var_12(arg_4_0.bossHPBar, "BossIcon/icon"), var_6_14)

			setText = var_6_15
			findTF = var_12

			local var_6_20 = var_12(arg_4_0.bossHPBar, "BossNameBG/BossName")

			ys = var_13

			var_6_15(var_6_20, var_13.Battle.BattleDataFunction.GetPlayerShipTmpDataFromID(arg_4_0.enemyVO.configId).name)

			setActive = var_6_15

			var_6_15(arg_4_0.rawImage, true)

			pg = var_6_15

			local var_6_21 = var_6_15.TimeMgr.GetInstance()
		...
		local function var_5_2(arg_12_0)
			...
			for iter_12_0, iter_12_1 in var_3_10005(var_3_10007.Battle.BattleConst.FXContainerIndex) do
			...
			local function var_12_7(arg_13_0, arg_13_1)
				...
				var_13_2(var_13_1, var_6.Battle.BattleConst.ActionName.MOVE, 0, true)
				...
				local var_13_7 = var_13_3.EffectMgr.GetInstance()
				local var_13_8 = var_7.PlayBattleEffect
				local var_13_9 = var_13_6

				Vector3 = var_4_10011

				var_13_8(var_13_7, var_13_9, var_4_10011.zero, true)
		...
		var_5_4(var_5_3, var_5.getPrefab(var_5_5), function(arg_18_0)
			var_5_2(arg_18_0)
		...
		var_5_7(var_5_6, var_5.getPrefab(var_5_8), function(arg_19_0)
			var_5_1(arg_19_0)
...
function var_0_0.updatePopUp(arg_21_0)
	...
	if var_21_2(var_21_1, var_4(var_1_10006)) then
		ys = var_21_3

		var_21_3.Battle.BattleCharacter.ChatPopAnimation(arg_21_0.chatPop, 4)

		ys = var_21_3
		var_21_3 = var_21_3.Battle.BattleCharacter.setChatText
		var_21_4 = arg_21_0.chatPop
		pg = var_1_10005

		var_21_3(var_21_4, var_1_10005.ship_skin_words[100000].skill)
	else
		LeanTween = var_21_3

		local var_21_5 = var_21_3.scale

		rtf = var_21_4

		local var_21_6 = var_21_4(arg_21_0.chatPop.gameObject)

		Vector3 = var_1_10005

		local var_21_7 = var_21_5(var_21_6, var_1_10005.New(0, 0, 1), 0.1)
		local var_21_8 = var_2.setEase

		LeanTweenType = var_5

		local var_21_9 = var_21_8(var_21_7, var_5.easeInBack)
		local var_21_10 = var_2.setOnComplete

		System = var_5

		var_21_10(var_21_9, var_5.Action(function()
			ys = var_2_10000
			...
			var_22_0(var_22_1, var_3.ship_skin_words[100000].skill)
...
function var_0_0.updateSkillFloat(arg_23_0)
	...
	if arg_23_0.skinKey == "Standard" then
		...
		local var_23_2 = var_23_0.GetCharacterIcon
		local var_23_3 = arg_23_0.shipVO

		var_23_1 = var_23_2(var_1_10005, var_6.getPrefab(var_23_3))
	else
		var_1_10005 = var_23_0

		local var_23_4 = var_23_0.GetCharacterSquareIcon
		local var_23_5 = arg_23_0.shipVO

		var_23_1 = var_23_4(var_1_10005, var_6.getPrefab(var_23_5))
	end

	local var_23_6 = arg_23_0.skill.transform
	local var_23_7 = arg_23_0.skill

	Vector3 = var_1_10005
	var_23_7.localScale = var_1_10005(1.5, 1.5, 0)

	local var_23_8 = var_23_6
	local var_23_9 = var_23_6.GetComponent

	typeof = var_7
	Animation = var_9

	local var_23_10, var_23_11

	if var_23_9(var_23_8, var_7(var_9)) then
		var_23_10 = 1
		...
		if var_4.GetClip(var_23_11, "anim_skinui_skill_" .. var_23_10) then
			repeat
		...
		if 1 < var_23_10 then
			...
			local var_23_12 = "anim_skinui_skill_"

			math = var_10

			var_23_8(var_23_11, var_23_12 .. var_10.random(var_23_10 - 1))
		end
	end
	...
	local var_23_13 = var_7(var_23_6, "skill/skill_name/Text")

	HXSet = var_23_11

	local var_23_14 = var_23_11.hxLan

	pg = var_10

	var_23_10(var_23_13, var_23_14(var_10.skill_data_template[9033].name))

	findTF = var_23_10

	local var_23_15 = var_23_10(var_23_6, "skill/icon_mask/icon")

	findTF = var_23_8

	local var_23_16 = var_23_8(var_23_6, "skill/skill_name")
	local var_23_17 = var_23_15
	local var_23_18 = var_23_15.GetComponent

	typeof = var_10
	Image = var_1_10012

	local var_23_19 = var_23_18(var_23_17, var_10(var_1_10012))

	var_23_19.sprite = var_23_1
	Color = var_23_19

	local var_23_20 = var_23_19.New(1, 1, 1, 1)
	local var_23_21 = var_23_16
	local var_23_22 = var_23_16.GetComponent

	typeof = var_11
	Image = var_1_10013

	local var_23_23 = var_23_22(var_23_21, var_11(var_1_10013))

	var_23_23.color = var_23_20
	findTF = var_23_23

	local var_23_24 = var_23_23(var_23_6, "skill")
	local var_23_25 = var_8.GetComponent

	typeof = var_11
	Image = var_1_10013
	var_23_25(var_23_24, var_11(var_1_10013)).color = var_23_20

	local var_23_26 = var_23_6
	local var_23_27 = var_23_6.GetComponent

	typeof = var_11
	DftAniEvent = var_1_10013

	local var_23_28 = var_23_27(var_23_26, var_11(var_1_10013))

	var_8.SetEndEvent(var_23_28, function(arg_24_0)
	...
	Clone = var_9
	var_23_6.position = var_9(arg_23_0.heroBar.position)
...
function var_0_0.updateHPPop(arg_25_0)
	...
	if not arg_25_0._popNumMgr then
		...
		var_25_1(var_25_0, var_4.Find(var_25_2, "HPTextCharacterContainer/container"))
	...
	local var_25_5 = var_1_10002.random(1, 2) > 1
...
function var_0_0.updateStick(arg_26_0)
	if arg_26_0._stickMoveCount and arg_26_0._stickMoveCount <= var_0_10 then
		...
		var_1_10003 = var_26_0 * var_26_0 + var_26_1 * var_26_1

		if var_0_12 * 2 < var_1_10003 then
			math = var_4

			local var_26_2 = var_4.atan2(var_26_1, var_26_0)
			local var_26_3
			local var_26_4
			local var_26_5 = var_0_12

			math = var_1_10008

			local var_26_6 = var_26_5 * var_1_10008.cos(var_26_2)
			local var_26_7 = var_0_12

			math = var_8

			local var_26_8 = var_26_7 * var_8.sin(var_26_2)
			local var_26_9 = var_26_6 / var_0_12
			local var_26_10 = var_26_8 / var_0_12

			math = var_1_10009

			local var_26_11 = var_1_10009.random() * 2

			math = var_10

			local var_26_12 = var_26_11 * var_10.pi

			math = var_10

			local var_26_13 = var_10.random(var_0_13, var_0_14)

			math = var_1_10011
			arg_26_0.stickVX = var_1_10011.cos(var_26_12) * var_26_13
			math = var_11
			arg_26_0.stickVY = var_11.sin(var_26_12) * var_26_13

			if arg_26_0.stickVX * var_26_9 + arg_26_0.stickVY * var_26_10 > 0 then
		...
		local var_26_14 = arg_26_0._stickMoveCount

		if var_0_10 <= var_26_14 then
			...
			local var_26_15 = arg_26_0.stick

			Vector3 = var_5
			var_26_15.localPosition = var_5.zero
	...
	elseif arg_26_0._stickStopCount and arg_26_0._stickStopCount <= var_0_11 then
		...
		local var_26_16 = arg_26_0._stickStopCount

		if var_0_11 <= var_26_16 then
			if arg_26_0.stickTail then
				setActive = var_1
			...
			local var_26_17 = var_1.random() * 2

			math = var_2

			local var_26_18 = var_26_17 * var_2.pi

			math = var_2

			local var_26_19 = var_2.random(var_0_13, var_0_14)

			math = var_1_10003
			arg_26_0.stickVX = var_1_10003.cos(var_26_18) * var_26_19
			math = var_3
			arg_26_0.stickVY = var_3.cos(var_26_18) * var_26_19
...
function var_0_0.SeaUpdate(arg_27_0)
	...
	local var_27_9 = var_1_10009.TimeMgr.GetInstance()
	...
	local var_27_11 = var_10.TimeMgr.GetInstance()
	...
	local var_27_13 = var_27_9.TimeMgr.GetInstance()
	...
	local var_27_15 = var_27_11.TimeMgr.GetInstance()
