...
function var_0_1.didEnter(arg_3_0)
	...
	var_3_1(var_3_0, var_4.getGradeList(var_3_2))
...
function var_0_1.willExit(arg_4_0)
	...
	var_4_0(var_1_10003(arg_4_0.modTipTF))
...
function var_0_1.setFleet(arg_6_0, arg_6_1)
	...
	var_6_0(var_1_10005.MODE_CASUAL)

	local var_6_1 = var_2

	ChallengeProxy = var_5

	var_6_1(var_5.MODE_INFINITE)
...
function var_0_1.findUI(arg_8_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_8_0.material = var_8_36(var_8_35, var_4(var_1_10006)).material
	...
	typeof = var_4
	Image = var_1_10006
	arg_8_0.material1 = var_8_39(var_8_38, var_4(var_1_10006)).material
	...
	function arg_8_0.fleetEditPanel.onCombat()
		...
		var_11_2(var_11_1, var_2_10003.ON_PRECOMBAT, arg_8_0.curMode)
...
function var_0_1.initData(arg_14_0)
	...
	arg_14_0.challengeProxy = var_1_10001(var_1_10003)
...
function var_0_1.addListener(arg_15_0)
	...
	local function var_15_5()
		...
		var_17_2.type = var_2_10004
		pg = var_2_10004
		var_17_2.helps = var_2_10004.gametip.challenge_help.tip
	...
	local function var_15_8()
		...
		var_18_1(var_18_0, var_2_10003.ON_OPEN_RANK)
	...
	local function var_15_11()
		...
		if not var_19_1(var_19_0, var_2_10003.ACTIVITY_TYPE_CHALLENGE) or var_0:isEnd() then
			pg = var_2_10001

			local var_19_2 = var_2_10001.TipsMgr.GetInstance()
			local var_19_3 = var_1.ShowTips

			i18n = var_2_10004

			var_19_3(var_19_2, var_2_10004("challenge_end_tip"))
		...
		if var_1.isCrossedSeason(var_19_4) == true then
			...
			if not arg_15_0.curModeInfo then
				pg = var_19_7
				var_2_10004 = var_19_7.MsgboxMgr.GetInstance()
				...
				i18n = var_2_10006
				var_19_8.content = var_2_10006("challenge_season_update")

				function var_19_8.onYes()
					local var_20_0 = arg_15_0
					local var_20_1 = var_0.emit

					ChallengeConst = var_3_10003

					var_20_1(var_20_0, var_3_10003.RESET_DATA_EVENT, var_19_6)

					return
				end

				function var_19_8.onNo()
					local var_21_0 = arg_15_0
					local var_21_1 = var_0.emit

					ChallengeConst = var_3_10003

					var_21_1(var_21_0, var_3_10003.RESET_DATA_EVENT, var_19_6)

					return
				end

				var_19_7(var_2_10004, var_19_8)
			...
			local var_19_9 = var_19_6 == var_19_7.MODE_CASUAL and "challenge_season_update_casual_clear" or "challenge_season_update_infinite_clear"

			ChallengeProxy = var_19_5

			if var_19_6 == var_19_5.MODE_CASUAL then
				do
					local var_19_10 = arg_15_0.curModeInfo
					local var_19_12

					if not var_3.getScore(var_19_10) then
						local var_19_11 = arg_15_0.curModeInfo

						var_19_12 = var_3.getLevel(var_19_11)
					end

					pg = var_2_10004

					local var_19_13 = var_2_10004.MsgboxMgr.GetInstance()
					...
					i18n = var_2_10008
					var_19_14.content = var_2_10008(var_19_9, var_19_12)

					function var_19_14.onNo()
						local var_22_0 = arg_15_0
						local var_22_1 = var_0.emit

						ChallengeConst = var_3_10003

						var_22_1(var_22_0, var_3_10003.RESET_DATA_EVENT, var_19_6)

						return
					end

					function var_19_14.onYes()
						local var_23_0 = arg_15_0
						local var_23_1 = var_0.emit

						ChallengeMainMediator = var_3_10003

						var_23_1(var_23_0, var_3_10003.ON_PRECOMBAT, arg_15_0.curMode)

						return
					end

					var_2_10004(var_19_13, var_19_14)
				...
				if not arg_15_0.curModeInfo then
					local var_19_15 = arg_15_0

					var_1.doOnFleetPanel(var_19_15)

					return
				end

				local var_19_16 = arg_15_0
				local var_19_17 = var_1.emit

				ChallengeMainMediator = var_2_10004

				var_19_17(var_19_16, var_2_10004.ON_PRECOMBAT, arg_15_0.curMode)
	...
	local function var_15_14()
		...
		i18n = var_2_10004
		var_24_2.content = var_2_10004("challenge_normal_reset")
		...
		function var_24_2.onYes()
			...
			local var_25_2 = var_3_10003.RESET_DATA_EVENT
			local var_25_3 = arg_15_0.challengeProxy

			var_25_1(var_25_0, var_25_2, var_4.getCurMode(var_25_3))
	...
	var_3(var_5, arg_15_0.paintingContainer, var_15_15, var_15_16)
...
function var_0_1.updateData(arg_29_0)
	...
	if not arg_29_0.curModeInfo then
		...
		if var_29_1 == var_2.MODE_CASUAL then
			local var_29_2 = arg_29_0.challengeInfo
			...
			if var_29_3 == var_2.MODE_INFINITE then
				...
				pg = var_29_4
				arg_29_0.dungeonIDList = var_29_4.activity_event_challenge[var_29_7].infinite_stage[var_29_5][1]
			end
		end
	else
	...
	if var_29_10 == var_2.MODE_INFINITE then
		...
		if arg_29_0.curModeInfo then
			...
			if var_29_13.activity_event_challenge[var_29_16].infinite_stage[var_29_14][2] then
				pg = var_4
				...
				if var_30_3.BOSS_NUM < var_30_2 then
					...
					if var_30_2 % var_6.BOSS_NUM == 0 then
						...
						local function var_30_4(arg_31_0)
							...
							var_31_4(var_31_3, var_4.Action_float(function(arg_32_0)
						...
						var_7(arg_30_0.painting, var_30_0[var_30_1], "chuanwu", function()
							...
							if var_0.GetChild(var_33_1, 0) then
								...
								local var_33_2 = var_2_10001(var_0, "MeshImage")
						...
						var_7(arg_30_0.paintingShadow1, var_30_0[var_30_1], "chuanwu", function()
							...
							if var_0.GetChild(var_34_1, 0) then
								local var_34_2 = var_0:GetComponent("Image")

								Color = var_34_1
								var_34_2.color = var_34_1.New(0, 0, 0, 0.44)
							end
						...
						var_7(arg_30_0.paintingShadow2, var_30_0[var_30_1], "chuanwu", function()
							...
							if var_0.GetChild(var_35_1, 0) then
								local var_35_2 = var_0:GetComponent("Image")

								Color = var_35_1
								var_35_2.color = var_35_1.New(1, 1, 1, 0.15)
							end
						...
						local var_30_5 = var_0_1.BOSS_NUM - var_30_1
						...
						if 2 <= var_30_5 then
							...
							var_30_5(arg_30_0.roundTF_2, true)
							...
							var_30_5(arg_30_0.mask_2, true)

							LoadSpriteAsync = var_30_5

							var_30_5("shipYardIcon/" .. var_30_0[var_30_1 + 1], function(arg_37_0)
								setImageSprite = var_2_10001
							...
							var_30_5("shipYardIcon/" .. var_30_0[var_30_1 + 2], function(arg_38_0)
								setImageSprite = var_2_10001
							...
							if var_0_1.BOSS_NUM - var_30_1 == 1 then
								...
								var_30_6(arg_30_0.roundTF_1, true)

								setActive = var_30_6

								var_30_6(arg_30_0.roundTF_2, false)

								setActive = var_30_6

								var_30_6(arg_30_0.mask_1, true)

								setActive = var_30_6

								var_30_6(arg_30_0.mask_2, false)

								LoadSpriteAsync = var_30_6

								var_30_6("shipYardIcon/" .. var_30_0[var_30_1 + 1], function(arg_39_0)
									setImageSprite = var_2_10001
								...
								var_30_6 = arg_30_0.curMode
								ChallengeProxy = var_8

								if var_30_6 == var_8.MODE_INFINITE then
									LoadSpriteAsync = var_30_6

									var_30_6("shipYardIcon/" .. arg_30_0.nextNameList[var_30_1 + 2], function(arg_40_0)
										setImageSprite = var_2_10001
								...
								var_30_6(arg_30_0.roundTF_1, false)
								...
								var_30_6(arg_30_0.mask_1, false)

								setActive = var_30_6

								var_30_6(arg_30_0.mask_2, false)

								local var_30_7 = arg_30_0.curMode

								ChallengeProxy = var_8

								if var_30_7 == var_8.MODE_INFINITE then
									LoadSpriteAsync = var_30_7

									var_30_7("shipYardIcon/" .. arg_30_0.nextNameList[var_30_1 + 1], function(arg_41_0)
										setImageSprite = var_2_10001
									...
									var_30_7("shipYardIcon/" .. arg_30_0.nextNameList[var_30_1 + 2], function(arg_42_0)
										setImageSprite = var_2_10001
	...
	if var_43_1 == var_1_10004.MODE_CASUAL then
		...
		if var_43_1.BOSS_NUM < var_43_0 then
			...
			if var_43_0 % var_43_1.BOSS_NUM == 0 then
				...
				var_43_1(var_43_2, var_1_10006.format("%02d", var_43_0))
			...
			if var_44_2 == var_1_10005.MODE_INFINITE then
				...
				if var_44_2.BOSS_NUM < var_44_1 then
					...
					if var_44_1 % var_44_2.BOSS_NUM == 0 then
						...
						ChallengeConst = var_9

						var_44_7(var_44_6, var_9.BOSS_NUM)
...
function var_0_1.updateTimePanel(arg_50_0)
	...
	local var_50_2 = var_50_1(var_50_0, var_1_10005.ACTIVITY_TYPE_CHALLENGE).stopTime

	pg = var_50_0

	local var_50_3 = var_50_0.TimeMgr.GetInstance()
	local var_50_4 = var_4.STimeDescS(var_50_3, var_50_2, "%Y.%m.%d")

	setText = var_5

	var_5(arg_50_0.activityTimeText, var_50_4)

	pg = var_5

	local var_50_5 = var_5.TimeMgr.GetInstance()
	...
	var_11(var_50_11, var_14.format("%02d:%02d:%02d", var_50_8, var_50_9, var_50_10))
	...
	arg_50_0.timer = var_11.New(function()
		...
		var_2_10004(var_51_5, var_7.format("%02d:%02d:%02d", var_51_2, var_51_3, var_51_4))
...
function var_0_1.updateSwitchModBtn(arg_52_0)
	...
	local var_52_0 = arg_52_0.curMode

	ChallengeProxy = var_1_10002

	if var_52_0 == var_1_10002.MODE_CASUAL then
		setActive = var_52_0

		var_52_0(arg_52_0.casualModBtnBG, true)

		setActive = var_52_0

		var_52_0(arg_52_0.infiniteModBtnBG, false)
	else
		setActive = var_52_0

		var_52_0(arg_52_0.casualModBtnBG, false)

		setActive = var_52_0

		var_52_0(arg_52_0.infiniteModBtnBG, true)
	end

	onButton = var_52_0

	local var_52_1 = arg_52_0
	local var_52_2 = arg_52_0.casualModBtn
	...
	local function var_52_3()
		...
		if arg_52_0.curModeInfo then
			...
			local function var_53_3()
				...
				var_54_1(var_54_0, var_3_10003.MODE_CASUAL)
			...
			if var_2.isCrossedSeason(var_53_4) then
				...
				pg = var_53_4
				var_2_10006 = var_53_4.MsgboxMgr.GetInstance()
				...
				i18n = var_2_10008
				var_53_8.content = var_2_10008(var_53_5, var_53_6)
				...
				function var_53_8.onYes()
					...
					local var_55_2 = var_3_10003.RESET_DATA_EVENT

					ChallengeProxy = var_3_10004

					var_55_1(var_55_0, var_55_2, var_3_10004.MODE_INFINITE)
			...
			i18n = var_2_10006
			var_53_11.content = var_2_10006("challenge_infinite_click_switch", var_53_2)
	...
	var_52_0(var_52_1, var_52_2, var_52_3, var_1_10006)

	onButton = var_52_0

	local var_52_4 = arg_52_0
	local var_52_5 = arg_52_0.infiniteModBtn
	...
	local function var_52_6()
		...
		if arg_52_0.curModeInfo then
			...
			local function var_56_4()
				...
				var_57_1(var_57_0, var_3_10003.MODE_INFINITE)
			...
			if var_2.isCrossedSeason(var_56_5) then
				...
				pg = var_56_5
				var_2_10006 = var_56_5.MsgboxMgr.GetInstance()
				...
				i18n = var_2_10008
				var_56_9.content = var_2_10008(var_56_6, var_56_7)
				...
				function var_56_9.onYes()
					...
					local var_58_2 = var_3_10003.RESET_DATA_EVENT

					ChallengeProxy = var_3_10004

					var_58_1(var_58_0, var_58_2, var_3_10004.MODE_CASUAL)
			...
			i18n = var_2_10006
			var_56_12.content = var_2_10006("challenge_casual_click_switch", var_56_3)
	...
	var_52_0(var_52_4, var_52_5, var_52_6, var_1_10006)
...
function var_0_1.updateStartBtn(arg_60_0)
	...
	if arg_60_0.userChallengeInfoList[arg_60_0.curMode] then
		...
		if var_60_0 == var_1_10003.MODE_CASUAL then
			var_60_0 = var_1:getLevel()
			ChallengeConst = var_3

			if var_60_0 > var_3.BOSS_NUM then
				SetActive = var_60_0
...
function var_0_1.updateAwardPanel(arg_62_0)
	...
	local var_62_2 = var_62_1(var_62_0, var_1_10004.ACTIVITY_TYPE_CHALLENGE)

	pg = var_1_10002

	local var_62_3 = var_1_10002.activity_template[var_62_2.id].config_data[1]
	...
	local var_62_5 = var_4(var_1_10006)
	local var_62_7
	...
	if not var_4.getTaskById(var_62_5, var_62_4) then
		...
		local var_62_6 = var_1_10005(var_7)

		var_62_7 = var_5.getFinishTaskById(var_62_6, var_62_4)
	end

	local var_62_8 = var_62_7
	local var_62_9 = var_62_7.getConfig(var_62_8, "target_num")
	local var_62_10 = arg_62_0.challengeInfo
	local var_62_11 = var_6.getGradeList(var_62_10).activityMaxScore

	setText = var_62_8

	var_62_8(arg_62_0.scoreText, var_62_11 .. " / " .. var_62_9)

	if var_62_7:getTaskStatus() == 0 then
		setActive = var_62_10

		var_62_10(arg_62_0.getBtn, false)

		setActive = var_62_10

		var_62_10(arg_62_0.getBtnBanned, true)

		setActive = var_62_10

		var_62_10(arg_62_0.gotBtn, false)
	elseif var_7 == 1 then
		setActive = var_62_10

		var_62_10(arg_62_0.getBtn, true)

		setActive = var_62_10

		var_62_10(arg_62_0.getBtnBanned, false)
	...
	elseif var_7 == 2 then
		...
		var_62_10(arg_62_0.gotBtn, true)
	end
	...
	local function var_62_16()
		...
		var_63_1(var_63_0, var_2_10003.ON_DROP, var_62_13)
	...
	var_10(var_62_14, var_62_15, var_62_16, var_1_10015)
	...
	local function var_62_19()
		...
		ChallengeConst = var_2_10003

		var_64_1(var_64_0, var_2_10003.CLICK_GET_AWARD_BTN, var_62_7.id)
	...
	var_10(var_62_17, var_62_18, var_62_19, var_1_10015)
...
function var_0_1.showSLResetMsgBox(arg_65_0)
	...
	for iter_65_0, iter_65_1 in var_1_10004(arg_65_0.userChallengeInfoList) do
		local var_65_3 = iter_65_1:getResetFlag()

		ChallengeConst = var_1_10010

		if var_1_10010.NEED_TO_RESET_SAVELOAD <= var_65_3 then
			var_65_0 = true
			var_65_1 = iter_65_1
			var_65_2 = iter_65_0
	...
	if var_65_0 == true then
		...
		i18n = var_1_10010
		var_65_8.content = var_1_10010(var_65_4, var_65_5)
		...
		function var_65_8.onYes()
			...
			var_66_1(var_66_0, var_2_10003.RESET_DATA_EVENT, var_65_2)
		...
		function var_65_8.onNo()
			...
			var_67_1(var_67_0, var_2_10003.RESET_DATA_EVENT, var_65_2)
...
function var_0_1.showTipText(arg_68_0)
	...
	var_68_1(var_68_3, var_1_10005(var_68_2))
	...
	if var_68_5(var_68_4, var_5(var_7)) then
	...
	var_3(arg_68_0.modTipTF, true)

	setActive = var_3

	var_3(arg_68_0.modTipText, true)
...
function var_0_1.isFinishedCasualMode(arg_71_0)
	...
	elseif not var_71_2 then
		...
		if var_71_4 then
			var_1_10005 = var_71_4:getSeasonID()

			local var_71_7 = arg_71_0.challengeInfo

			if var_1_10005 == var_6.getSeasonID(var_71_7) then
				ChallengeConst = var_1_10005

				if var_1_10005.BOSS_NUM <= var_71_6 then
					var_71_0 = true
				else
					var_71_0 = false
				end
			...
			if var_71_6 >= var_1_10005.BOSS_NUM then
				var_71_0 = true
...
function var_0_1.commitEdit(arg_73_0)
	...
	ChallengeMainMediator = var_1_10004

	var_73_1(var_73_0, var_1_10004.ON_COMMIT_FLEET)
...
function var_0_1.openShipInfo(arg_74_0, arg_74_1, arg_74_2)
	...
	ChallengeMainMediator = var_1_10006

	var_74_1(var_74_0, var_1_10006.ON_FLEET_SHIPINFO, {
		shipId = arg_74_1,
		shipVOs = arg_74_2
	})
...
function var_0_1.openCommanderPanel(arg_78_0, arg_78_1, arg_78_2)
	...
	local var_78_0 = var_1_10003(var_1_10005)
	local var_78_1 = var_3.getActivityByType

	ActivityConst = var_1_10006

	local var_78_2 = var_78_1(var_78_0, var_1_10006.ACTIVITY_TYPE_CHALLENGE).id
	...
	var_4.setCallback(var_78_3, function(arg_79_0)
		...
		if var_79_0 == var_2_10002.COMMANDER_OP_SHOW_SKILL then
			...
			var_79_2(var_79_1, var_2_10004.ON_COMMANDER_SKILL, arg_79_0.skill)
		else
			local var_79_3 = arg_79_0.type

			LevelUIConst = var_2

			if var_79_3 == var_2.COMMANDER_OP_ADD then
				...
				var_79_5(var_79_4, var_2_10004.ON_SELECT_ELITE_COMMANDER, arg_78_2, arg_79_0.pos)
				...
				local var_79_10 = var_2_10004.COMMANDER_FORMATION_OP
				local var_79_11 = {}

				LevelUIConst = var_2_10006
				var_79_11.FleetType = var_2_10006.FLEET_TYPE_ACTIVITY
