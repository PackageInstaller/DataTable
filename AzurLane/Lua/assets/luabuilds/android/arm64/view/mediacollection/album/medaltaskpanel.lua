...
function var_0_0.UpdateList(arg_10_0, arg_10_1)
	...
	var_2.make(var_10_0, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			local var_11_3 = var_11_2(var_11_1, var_7(var_2_10009))
			...
			local var_11_10 = arg_11_2.Find(var_11_9, "frame/got_btn")
			local var_11_11 = arg_11_2:Find("frame/go_btn")

			setText = var_11_9

			var_11_9(var_11_7, var_11_0:getConfig("desc"))
			...
			var_17(var_11_10, var_11_0:getTaskStatus() == 2)
			...
			local var_11_21 = var_11_0

			var_17(var_11_20, var_11_0.getTaskStatus(var_11_21) == 0)

			onButton = var_17

			local var_11_22 = arg_10_0
			local var_11_23 = var_11_11
			...
			var_17(var_11_22, var_11_23, var_11_24, var_11_21)

			onButton = var_17

			local var_11_25 = arg_10_0
			local var_11_26 = var_11_8
			...
			var_17(var_11_25, var_11_26, var_11_27, var_11_21)
		end
...
function var_0_0.updateAwards(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	for iter_16_1 = 1, var_16_1 do
		...
		if var_16_4 then
			...
			setActive = var_16_7
			findTF = var_1_10016
			var_1_10016 = var_1_10016(var_16_3, "got")
			Task = var_16_8

			var_16_7(var_1_10016, var_16_8.OwnSpAward(var_16_5))
		end
	end
