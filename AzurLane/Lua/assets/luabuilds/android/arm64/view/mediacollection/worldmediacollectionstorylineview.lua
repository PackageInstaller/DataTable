...
function var_0_0.init(arg_2_0)
	...
	local var_2_5 = var_2_4(var_2_3, var_4(var_1_10006)).onValueChanged
	...
	local var_2_13 = var_3.Find(var_2_12, "camp/label/text")

	i18n = var_4

	var_1(var_2_13, var_4("storyline_camp"))
	...
	var_1(var_2_15, var_4("storyline_goto"))
...
function var_0_0.initFilter(arg_7_0)
	...
	local var_7_4 = var_3.Find(var_7_3, "NodeFilter/label/cn")

	i18n = var_4

	var_1(var_7_4, var_4("indexsort_camp"))

	setText = var_1

	local var_7_5 = arg_7_0.tf
	local var_7_6 = var_3.Find(var_7_5, "NodeFilter/label/en")

	i18n = var_4

	var_1(var_7_6, var_4("indexsort_campeng"))
	...
	for iter_7_0, iter_7_1 in var_7_7(var_0_0.NATION_LIST) do
		...
		local var_7_12 = var_1_10008:Find("Text")

		i18n = var_12

		var_7_11(var_7_12, var_12(iter_7_1.name))
	end
...
function var_0_0.updateFilterList(arg_11_0, arg_11_1)
	...
	for iter_11_2, iter_11_3 in var_11_1(var_0_0.NATION_LIST) do
		...
		var_1_10008(var_10.Find(var_11_2, "on"), arg_11_0.filterDict[iter_11_3.key])

		setActive = var_1_10008

		local var_11_3 = arg_11_0.filterTFDict[iter_11_3.key]

		var_1_10008(var_10.Find(var_11_3, "off"), not arg_11_0.filterDict[iter_11_3.key])
	end
...
function var_0_0.updateChapterProgress(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_3(arg_15_0.nodeDataDict) do
		...
		local var_15_6 = iter_15_1.VO

		if not var_15_4[var_8.GetChapter(var_15_6)] or not (var_15_4[var_8] + 1) then
			var_1_10009 = 1
		end
	...
	for iter_15_2, iter_15_3 in var_4(var_15_4) do
		...
		var_1_10009.insert(var_15_7, iter_15_2)
	end
	...
	local var_15_8 = var_5.min(var_0_0.CHAPTER_PROGRESS_MIN_WIDTH, arg_15_0.chapterProgressTotalWidth / var_4)
	local var_15_9 = {}
	local var_15_10 = {}
	local var_15_11 = arg_15_0.chapterProgressTotalWidth
	local var_15_12 = var_15_5
	local var_15_13 = true

	while var_15_13 and 0 < var_15_12 do
		var_15_13 = false
		ipairs = var_1_10011

		for iter_15_4, iter_15_5 in var_1_10011(var_15_7) do
			if not var_15_10[iter_15_5] and var_15_8 > var_15_11 * (var_15_4[iter_15_5] / var_15_12) then
				var_15_9[iter_15_5] = var_15_8
				var_15_10[iter_15_5] = true
				var_15_11 = var_15_11 - var_15_8
				var_15_12 = var_15_12 - var_16
				var_15_13 = true
			end
		end
	end
	...
	for iter_15_6, iter_15_7 in var_1_10011(var_15_7) do
		if not var_15_10[iter_15_7] then
			local var_15_14

			if not (var_15_12 > 0) or not (var_15_11 * (var_15_4[iter_15_7] / var_15_12)) then
				var_15_14 = 0
			end

			var_15_9[iter_15_7] = var_15_14
		end
	end
	...
	for iter_15_8, iter_15_9 in var_12(var_15_7) do
		local var_15_16 = {
			w = var_15_9[iter_15_9],
			x = var_15_15
		}
		...
		if 1 < iter_15_8 then
			...
			local var_15_17 = var_18(arg_15_0.chapterProgressSplit, arg_15_0.chapterProgressContainer)

			setActive = var_1_10019

			var_1_10019(var_15_17, true)

			Vector2 = var_1_10019
			var_15_17.anchoredPosition = var_1_10019(var_15_16.x, 2.86)
		end

		var_15_16.leftBound = var_15_16.x
		var_15_16.rightBound = var_15_16.x + var_15_16.w
		cloneTplTo = var_18

		local var_15_18 = var_18(arg_15_0.chapterProgressLabel, arg_15_0.chapterProgressContainer)

		Vector2 = var_1_10019
		var_15_18.anchoredPosition = var_1_10019(var_15_16.x, 12)
		rtf = var_1_10019
		var_1_10019 = var_1_10019(var_15_18)
		Vector2 = var_20
		var_1_10019.sizeDelta = var_20(var_15_16.w, 32)
		setText = var_1_10019

		local var_15_19 = var_15_18

		i18n = var_22

		var_1_10019(var_15_19, var_22("storyline_chapter" .. iter_15_9))

		setActive = var_1_10019

		var_1_10019(var_15_18, true)

		var_1_10019 = var_15_18:Find("chapterWarpBtn")
		onButton = var_20

		var_20(arg_15_0, var_1_10019, function()
		...
		arg_15_0.progressDict[iter_15_9] = var_15_16
		var_15_15 = var_15_15 + var_15_16.w
	end
...
function var_0_0.showFilter(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1(var_0_0.NATION_LIST) do
		...
		var_1_10006(var_8.Find(var_17_1, "on"), arg_17_0.filterDict[iter_17_1.key])

		setActive = var_1_10006

		local var_17_2 = arg_17_0.filterTFDict[iter_17_1.key]

		var_1_10006(var_8.Find(var_17_2, "off"), not arg_17_0.filterDict[iter_17_1.key])
	end
...
function var_0_0.ShowNodeDetail(arg_22_0, arg_22_1)
	...
	var_1_10003(var_5.Find(var_22_2, "info/title"), var_22_1:GetName())

	setText = var_1_10003

	local var_22_3 = arg_22_0.detailView

	var_1_10003(var_5.Find(var_22_3, "info/desc/content"), var_22_1:GetDesc())
	...
	var_1_10003(var_22_4, var_6.Find(var_22_5, "info/icon"), true)
	...
	var_1_10003(var_22_6, var_22_7, var_7.Find(var_22_8, "info/icon/mark"), true)

	local var_22_9 = arg_22_0.detailView
	local var_22_10 = var_3.Find(var_22_9, "camp/nations")
	local var_22_11 = var_22_1:GetNations()

	eachChild = var_22_9

	var_22_9(var_22_10, function(arg_23_0)
		...
		var_2_10002(var_23_1, var_2_10005.contains(var_22_11, var_23_0))

		setActive = var_2_10002

		var_2_10002(arg_23_0:Find("filter"), arg_22_0.filterDict[var_23_0])

		return
	end)

	local var_22_12 = arg_22_0.nodeDataDict[arg_22_1].nodeTF
	...
	for iter_22_0, iter_22_1 in var_7(arg_22_0.filterDict) do
		...
		if var_1_10012.contains(var_22_11, iter_22_0) then
			var_22_13 = true
	...
	if var_22_13 then
		...
		var_7(var_22_12:Find("info/selected_multi"), true)
	else
		setActive = var_7

		var_7(var_22_12:Find("info/selected"), true)
	end

	local var_22_14 = (var_22_12.anchoredPosition.x - var_0_0.START_GAP) / arg_22_0.contentWidth

	scrollTo = var_8

	var_8(arg_22_0.scroll, var_22_14)
	arg_22_0:TryPlayBGM()
...
function var_0_0.onScroll(arg_26_0)
	...
	if var_26_6 ~= arg_26_0.contentHeight then
		...
		var_26_7(var_10(arg_26_0.nodeContainer), var_26_6, 0.5)
	end
...
function var_0_0.updateCurrentChapterMark(arg_27_0, arg_27_1)
	if arg_27_0.currentChapter ~= arg_27_1 then
		...
		Vector2 = var_5
		var_27_2.sizeDelta = var_5(var_27_0.w, var_27_1.height)
...
function var_0_0.gotoStory(arg_28_0)
	...
	if var_28_2 ~= "" then
		...
		elseif var_28_2[1] == 2 then
			...
			for iter_28_0, iter_28_1 in var_6(var_1_10008.memory_group.all) do
				pg = var_1_10011
		...
		var_28_6(var_1_10008.memory_group[var_28_4], var_28_5)
	elseif var_28_3 ~= "" then
		...
		elseif var_28_3[1] == 2 then
			...
			for iter_28_2, iter_28_3 in var_6(var_1_10008.world_collection_record_group.all) do
				pg = var_1_10011
...
function var_0_0.updateNodes(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1_10001(arg_29_0.nodeDataDict) do
		...
		var_1_10010 = iter_29_1.VO

		if not var_8.IsMemoryBlock(var_1_10010) then
			local var_29_3 = false

			pairs = var_29_1

			for iter_29_2, iter_29_3 in var_29_1(arg_29_0.filterDict) do
				table = var_1_10014
			...
			var_9(var_29_0:Find("info/selected_filter"), var_29_3)
		end
	end

	if arg_29_0.selectedID then
		local var_29_4 = arg_29_0.nodeDataDict[arg_29_0.selectedID].nodeTF
		local var_29_5 = var_1.VO
		local var_29_6 = var_3.GetNations(var_29_5)
		local var_29_7 = false

		pairs = var_29_5

		for iter_29_4, iter_29_5 in var_29_5(arg_29_0.filterDict) do
			table = var_1_10010

			if var_1_10010.contains(var_29_6, iter_29_4) then
				var_29_7 = true
		...
		if var_29_7 then
			...
			var_5(var_29_4:Find("info/selected_multi"), true)

			setActive = var_5

			var_5(var_29_4:Find("info/selected"), false)
		else
			setActive = var_5

			var_5(var_29_4:Find("info/selected_multi"), false)

			setActive = var_5

			var_5(var_29_4:Find("info/selected"), true)
		end

		local var_29_8 = arg_29_0.detailView
		local var_29_9 = var_5.Find(var_29_8, "camp/nations")

		eachChild = var_6

		var_6(var_29_9, function(arg_30_0)
			tonumber = var_2_10001
			...
			var_2_10002(var_30_1, var_2_10005.contains(var_29_6, var_30_0))

			setActive = var_2_10002

			var_2_10002(arg_30_0:Find("filter"), arg_29_0.filterDict[var_30_0])
...
function var_0_0.updateNodeTree(arg_31_0)
	...
	for iter_31_0, iter_31_1 in var_1_10004(arg_31_0.memoryNodeDict) do
		...
		for iter_31_2, iter_31_3 in var_1_10009(iter_31_1) do
			...
			var_1_10016(var_1_10015, true)

			if iter_31_3:IsMemoryBlock() then
				LoadImageSpriteAtlasAsync = var_1_10016

				var_1_10016("ui/worldmediacollectionmemoryui_atlas", "node_tail", var_1_10015:Find("info/icon"))

				setText = var_1_10016

				var_1_10016(var_1_10015:Find("info/name"), iter_31_3:GetName())

				setActive = var_1_10016

				var_1_10016(var_1_10015:Find("info/name"), false)

				setActive = var_1_10016

				var_1_10016(var_1_10015:Find("info/mark"), false)
			else
				LoadImageSpriteAsync = var_1_10016

				var_1_10016("memorystoryline/" .. iter_31_3:GetIcon(), var_1_10015:Find("info/icon"), true)
				...
				var_1_10016("ui/worldmediacollectionmemoryui_atlas", iter_31_3:GetMark(), var_1_10015:Find("info/mark"))

				onButton = var_1_10016

				var_1_10016(arg_31_0, var_1_10015, function()
					local var_32_0 = arg_31_0
					local var_32_1 = var_0.ShowNodeDetail
					local var_32_2 = iter_31_3

					var_32_1(var_32_0, var_3.GetConfigID(var_32_2))
			...
			arg_31_0.nodeMap[iter_31_0][var_1_10016] = true
	...
	arg_31_0.sortLinkData(var_31_9)

	local var_31_10 = arg_31_0.nodeContainer.sizeDelta

	var_31_10.x = var_31_0

	local var_31_11 = arg_31_0.nodeContainer

	var_31_11.sizeDelta = var_31_10
	rtf = var_31_11

	local var_31_12 = var_31_11(arg_31_0.nodeContainer).rect.width

	rtf = var_31_9
	arg_31_0.contentWidth = var_31_12 - var_31_9(arg_31_0.scroll).rect.width
...
function var_0_0.sortLinkData(arg_33_0)
	...
	for iter_33_0, iter_33_1 in var_1_10001(arg_33_0.nodeDataDict) do
		...
		if var_1_10006(var_8.GetLinkEvent(var_33_0)) == "table" then
			ipairs = var_1_10006

			local var_33_1 = iter_33_1.VO

			for iter_33_2, iter_33_3 in var_1_10006(var_8.GetLinkEvent(var_33_1)) do
...
function var_0_0.updateNodeLine(arg_34_0)
	...
	for iter_34_0, iter_34_1 in var_1_10001(arg_34_0.nodeDataDict) do
		...
		for iter_34_2, iter_34_3 in var_1_10007(iter_34_1.linkData) do
...
function var_0_0.linkVRTLine(arg_35_0, arg_35_1, arg_35_2)
	...
	local var_35_1 = var_1_10005(var_1_10007(arg_35_0.linkVrtTpl))

	setActive = var_1_10006

	var_1_10006(var_35_1, true)
...
function var_0_0.linkHRZLine(arg_36_0, arg_36_1, arg_36_2)
	...
	local var_36_4 = var_36_0(var_1_10007(arg_36_0.linkHrzTpl))

	setActive = var_36_2

	var_36_2(var_36_4, true)
...
function var_0_0.linkBranchLine(arg_37_0, arg_37_1, arg_37_2)
	...
	local var_37_12 = var_12(var_14.Find(var_37_11, "Story/" .. var_37_2))
