...
function var_0_1.OnInit(arg_2_0)
	...
	var_1_10001(var_2_0, var_4.Find(var_2_1, "Buttom"), function()
	...
	typeof = var_4
	Animation = var_2_1
	arg_2_0.anim = var_2_3(var_2_2, var_4(var_2_1))
	...
	typeof = var_4
	CanvasGroup = var_2_1
	arg_2_0.canvasGroup = var_2_5(var_2_4, var_4(var_2_1))
	...
	local var_2_10 = var_4.Find(var_2_9, "ArchiveList/ProgressDesc")

	i18n = var_5

	var_2(var_2_10, var_5("world_collection_1"))
...
function var_0_1.Enter(arg_7_0)
	local function var_7_0()
		...
		local var_8_2 = var_2_10001.GetCollectionFileGroupTemplate(arg_7_0.contextData.FileGroupIndex)

		ipairs = var_8_0

		for iter_8_0, iter_8_1 in var_8_0(var_8_2.child) do
...
function var_0_1.UpdateView(arg_10_0)
	...
	arg_10_0.archiveList = var_10_0(var_3.GetCollectionFileGroupTemplate(arg_10_0.contextData.FileGroupIndex).child, function(arg_11_0)
		WorldCollectionProxy = var_2_10001
	...
	WorldCollectionProxy = var_1_10002

	local var_10_3 = var_1_10002.GetCollectionFileGroupTemplate(arg_10_0.contextData.FileGroupIndex)
	local var_10_4 = 0
	local var_10_5 = #var_10_3.child

	ipairs = var_5

	for iter_10_0, iter_10_1 in var_5(var_10_3.child) do
	...
	var_5(var_7.Find(var_10_6, "ArchiveList/ProgressDesc/ProgressText"), var_10_4 .. "/" .. var_10_5)
...
function var_0_1.OnUpdateFile(arg_13_0, arg_13_1, arg_13_2)
	...
	if arg_13_0.fileChildIndex[arg_13_2] and arg_13_0.fileChildIndex[arg_13_2] ~= arg_13_1 then
		...
		var_1_10005 = arg_13_0.fileChild
		var_1_10005[var_13_1] = nil
	end
	...
	local var_13_5 = var_1_10005(arg_13_2)

	WorldCollectionProxy = var_13_3

	local var_13_6 = var_13_3.GetCollectionFileGroupTemplate(arg_13_0.contextData.FileGroupIndex)
	local var_13_7 = var_13_4
	local var_13_8 = var_13_4.IsUnlock(var_13_7, var_13_0.id)
	local var_13_9 = arg_13_1 == arg_13_0.contextData.SelectedFile

	setActive = var_13_7

	var_13_7(var_13_5:Find("Selected"), var_13_9)

	string = var_13_7

	local var_13_10 = var_13_7.format
	local var_13_11 = "%s %s"

	shortenString = var_12
	...
	local var_13_13 = var_13_10(var_13_11, var_12(var_13_12, 6), var_0_2(var_13_0.group_ID))

	setText = var_10

	local var_13_14 = var_13_5:Find("Desc")

	setColorStr = var_13

	local var_13_15 = var_13_13

	if var_13_9 then
		var_1_10016 = "#000"
	else
		COLOR_WHITE = var_1_10016
	end

	var_10(var_13_14, var_13(var_13_15, var_1_10016))

	setActive = var_10

	var_10(var_13_5:Find("Desc"), var_13_8)

	setActive = var_10

	var_10(var_13_5:Find("Icon"), var_13_8)

	setActive = var_10

	var_10(var_13_5:Find("Cover"), var_13_8)

	setActive = var_10

	var_10(var_13_5:Find("Locked"), not var_13_8)
	...
	var_10(var_13_17, var_13_18, var_13_19, var_15)
...
function var_0_1.SwitchFileIndex(arg_15_0, arg_15_1)
	...
	if arg_15_1 and arg_15_0.archiveList[arg_15_1] then
		...
		local var_15_1 = var_1_10003.GetCollectionProxy(var_15_0)

		var_1_10003 = var_1_10003.IsUnlock(var_15_1, var_2.id)
	end

	if var_1_10003 then
		var_1_10004 = arg_15_0.contextData.SelectedFile

		local var_15_2 = arg_15_0.fileChild[var_1_10004]

		arg_15_0.contextData.SelectedFile = arg_15_1

		if var_15_2 then
			arg_15_0:OnUpdateFile(var_1_10004, var_15_2)
		end
		...
		local var_15_3 = arg_15_0.document

		var_6(var_8.Find(var_15_3, "Head/Title"), var_2.name)
...
function var_0_1.SetDocument(arg_16_0, arg_16_1, arg_16_2)
	...
	if arg_16_1.pic then
		var_1_10004 = #var_3

		if 0 < var_1_10004 then
			LoadSprite = var_1_10004
			var_1_10004 = var_1_10004("CollectionFileIllustration/" .. var_3, "")
			setImageSprite = var_5

			var_5(arg_16_0.documentImage, var_1_10004, true)

			setActive = var_5

			var_5(arg_16_0.documentImage, var_1_10004)
			...
			if var_1_10004 then
				...
				if arg_16_1.is_classified == 1 then
					...
					local var_16_0 = var_5.GetCollectionGroup(arg_16_1.id)

					WorldCollectionProxy = var_6

					local var_16_1 = var_6.GetCollectionFileGroupTemplate(var_16_0).type
					local var_16_2 = arg_16_0.loader

					var_8.GetSprite(var_16_2, "ui/WorldMediaCollectionFileDetailUI_atlas", "stamp" .. var_16_1, arg_16_0.documentStamp)
				end
			end
	...
	var_1_10004(arg_16_0.documentImage, false)
...
function var_0_1.getTextPreferredHeight(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_3 = var_17_2(var_17_1, var_1_10007(arg_17_1, 0))

	ReflectionHelp = var_1_10005

	local var_17_4 = var_1_10005.RefCallMethod

	typeof = var_7

	local var_17_5 = var_7("UnityEngine.TextGenerator")
	local var_17_6 = "GetPreferredHeight"
	local var_17_7 = var_17_0
	local var_17_8 = {}

	typeof = var_1_10011
	var_17_8[1] = var_1_10011("System.String")
	typeof = var_11
	var_17_8[2] = var_11("UnityEngine.TextGenerationSettings")
...
function var_0_1.SetDocumentText(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	local var_18_2 = var_7.max(var_18_0 - var_18_1, 0)
	...
	local var_18_7 = var_18_6(var_18_5, var_1_10013(var_1_10015))
	...
	local function var_18_9()
		...
		if var_2_10001(arg_18_0.documentHead) then
			...
			var_19_0 = var_19_0 + var_19_2(var_19_1, var_2_10004(var_2_10006)).preferredHeight
		end
		...
		if arg_18_2 then
			...
			if 0 < var_19_8 then
				local var_19_9 = arg_18_0.documentTip
				local var_19_10 = var_4.Find(var_19_9, "Text")
				local var_19_11 = var_4.GetComponent

				typeof = var_7
				Text = var_2_10009

				local var_19_12 = var_19_11(var_19_10, var_7(var_2_10009))

				var_19_12.text = arg_18_2
				var_19_7 = var_0_1.getTextPreferredHeight(var_19_12, var_18_0, arg_18_2)

				local var_19_13 = arg_18_0.documentRect

				var_19_5 = var_19_5.GetComponent
				typeof = var_8
				VerticalLayoutGroup = var_2_10010
				var_19_4 = var_19_4 + (var_19_7 + var_19_5(var_19_13, var_8(var_2_10010)).spacing)
			end
		end

		if var_0 then
			local var_19_14 = arg_18_0.documentImage

			Vector2 = var_19_5
			var_19_14.anchoredPosition = var_19_5(0, -50 - var_19_7)
		end

		local var_19_15 = var_19_4 + var_0_1.getTextPreferredHeight(var_18_7, var_18_0, var_18_8)
		local var_19_16 = arg_18_0.documentContentTF.sizeDelta

		var_19_16.y = var_19_15
		arg_18_0.documentContentTF.sizeDelta = var_19_16

		local var_19_17 = arg_18_0.document
		local var_19_18 = var_6.Find(var_19_17, "Viewport")
		local var_19_19 = arg_18_0.document
		local var_19_20 = var_7.Find(var_19_19, "Arrow")
		local var_19_21 = var_19_18.rect.height

		setActive = var_19_19

		var_19_19(var_19_20, var_19_21 < var_19_15)

		local var_19_22 = arg_18_0.document
		local var_19_23 = var_9.GetComponent

		typeof = var_12
		ScrollRect = var_2_10014

		local var_19_24 = var_19_23(var_19_22, var_12(var_2_10014)).onValueChanged

		var_10.RemoveAllListeners(var_19_24)
		...
		local var_19_26 = var_19_25.max(var_4 - var_19_21, 0) * arg_18_3
		local var_19_27 = arg_18_0.documentContentTF

		Vector2 = var_13
		var_19_27.anchoredPosition = var_13(0, var_19_26)
		Vector2 = var_19_27
		var_9.velocity = var_19_27.zero

		if var_19_21 < var_19_15 then
			onScroll = var_12

			var_12(arg_18_0, arg_18_0.document, function(arg_20_0)
				setActive = var_3_10001

				var_3_10001(var_19_20, arg_20_0.y > 0.01)
...
function var_0_1.SplitRichAndLetters(arg_22_0)
	...
	while true do
		...
		if not var_9.find(var_22_5, "/") and not var_1_10008 then
			...
			elseif var_9 then
				...
				if 0 < var_22_6 then
					table = var_22_6
					var_22_7 = var_22_2[var_22_6.remove(var_22_3)]
					var_22_7.EndTagIndex = #var_22_2
				end
			end

			string = var_22_6

			local var_22_8 = var_22_6.sub(arg_22_0, var_22_4 + 1, -1)

			string = var_22_7
			arg_22_0 = var_22_7.sub(arg_22_0, 1, var_1_10005 - 1) .. var_22_8
	...
	while true do
		...
		var_1_10008, var_22_13 = var_1_10008.find(arg_22_0, "[\x01-\x7F�-�][�-�]*", var_22_10)

		local var_22_14

		if not var_22_13 then
			var_22_14 = #var_22_9 + 1

			local var_22_15 = {}

			string = var_12
			var_22_15.value = var_12.sub(arg_22_0, var_22_12, #arg_22_0)
			var_22_15.start = var_22_12
			var_22_9[var_22_14] = var_22_15
		...
		local var_22_16 = var_22_14.sub(arg_22_0, var_1_10008, var_22_13)
		local var_22_17 = false

		PLATFORM_CODE = var_12
		PLATFORM_US = var_13

		if var_12 == var_13 then
			if var_22_11 ~= (var_22_16 == " " or var_22_16 == " ") then
				var_22_17 = var_1_10008 > 1
			end
		...
		if var_22_17 then
			local var_22_18 = #var_22_9 + 1
			local var_22_19 = {}

			string = var_14
			var_22_19.value = var_14.sub(arg_22_0, var_22_12, var_1_10008 - 1)
			var_22_19.start = var_22_12
			var_22_9[var_22_18] = var_22_19
			var_22_12 = var_1_10008
		end

		var_22_10 = var_22_13 + 1
	end

	return var_22_9, var_22_2
end
