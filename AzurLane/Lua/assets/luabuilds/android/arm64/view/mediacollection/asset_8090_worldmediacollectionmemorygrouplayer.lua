...
function var_0_1.OnInit(arg_2_0)
	...
	pg = var_3
	arg_2_0.memoryGroups = var_2_0(var_3.memory_group.all, function(arg_3_0)
		pg = var_2_10001
	...
	local var_2_5 = var_2(arg_2_0.memoryGroupList)
	...
	arg_2_0.memoryGroupsGrid = var_2_8(var_2_7, var_5(var_1_10007))
	...
	for iter_2_2, iter_2_3 in var_2(arg_2_0.memoryActivityToggles) do
		...
		var_1_10007(var_2_16, var_2_17, var_2_18, var_1_10012)
	end

	setText = var_2

	local var_2_19 = arg_2_0.memoryActivityToggles[1]
	local var_2_20 = var_4.Find(var_2_19, "Image1/Text")

	i18n = iter_2_2

	var_2(var_2_20, iter_2_2("memory_actiivty_ex"))

	setText = var_2

	local var_2_21 = arg_2_0.memoryActivityToggles[1]
	local var_2_22 = var_4.Find(var_2_21, "Image2/Text")

	i18n = var_5

	var_2(var_2_22, var_5("memory_actiivty_ex"))

	setText = var_2

	local var_2_23 = arg_2_0.memoryActivityToggles[2]
	local var_2_24 = var_4.Find(var_2_23, "Image1/Text")

	i18n = var_5

	var_2(var_2_24, var_5("memory_activity_sp"))

	setText = var_2

	local var_2_25 = arg_2_0.memoryActivityToggles[2]
	local var_2_26 = var_4.Find(var_2_25, "Image2/Text")

	i18n = var_5

	var_2(var_2_26, var_5("memory_activity_sp"))

	setText = var_2

	local var_2_27 = arg_2_0.memoryActivityToggles[3]
	local var_2_28 = var_4.Find(var_2_27, "Image1/Text")

	i18n = var_5

	var_2(var_2_28, var_5("memory_activity_daily"))

	setText = var_2

	local var_2_29 = arg_2_0.memoryActivityToggles[3]
	local var_2_30 = var_4.Find(var_2_29, "Image2/Text")

	i18n = var_5

	var_2(var_2_30, var_5("memory_activity_daily"))

	setText = var_2

	local var_2_31 = arg_2_0.memoryActivityToggles[4]
	local var_2_32 = var_4.Find(var_2_31, "Image1/Text")

	i18n = var_5

	var_2(var_2_32, var_5("memory_activity_others"))

	setText = var_2

	local var_2_33 = arg_2_0.memoryActivityToggles[4]
	local var_2_34 = var_4.Find(var_2_33, "Image2/Text")

	i18n = var_5

	var_2(var_2_34, var_5("memory_activity_others"))

	local var_2_35 = arg_2_0.contextData
	local var_2_36
	...
	var_2_35.toggle = var_2_36

	local var_2_37 = arg_2_0.contextData.toggle

	triggerToggle = var_2_36

	var_2_36(arg_2_0.memoryToggles[var_2_37], true)
	arg_2_0:SwitchMemoryFilter(var_2_37)
	...
	for iter_2_4, iter_2_5 in var_3(arg_2_0.memoryToggles) do
		...
		local var_2_39 = iter_2_5

		local function var_2_40(arg_7_0)
			if not arg_7_0 then
				return
			end
		...
		SFX_UI_TAG = var_1_10013

		var_1_10008(var_2_38, var_2_39, var_2_40, var_1_10013)
	end

	local var_2_41 = arg_2_0
	local var_2_42 = arg_2_0.OverlayPanel
	local var_2_43 = arg_2_0.memoryTogGroup
	local var_2_44 = {}

	LayerWeightConst = var_1_10008
	var_2_44.overlayType = var_1_10008.OVERLAY_UI_ADAPT

	var_2_42(var_2_41, var_2_43, var_2_44)

	AutoLoader = var_2_42
	arg_2_0.loader = var_2_42.New()

	local var_2_45 = arg_2_0._tf

	arg_2_0.searchBtn = var_3.Find(var_2_45, "ActivityToggle/search_btn/btn")

	local var_2_46 = arg_2_0._tf

	arg_2_0.nameSearchInput = var_3.Find(var_2_46, "ActivityToggle/search_btn/search")

	local var_2_47 = arg_2_0._tf

	arg_2_0.closeSearch = var_3.Find(var_2_47, "ActivityToggle/search_btn/icon")
	setText = var_3

	local var_2_48 = arg_2_0.searchBtn
	local var_2_49 = var_5.Find(var_2_48, "label")

	i18n = var_6

	var_3(var_2_49, var_6("storyline_memorysearch2"))
	...
	var_3(arg_2_0, arg_2_0.searchBtn, function()
		...
		local var_8_1 = var_2.Find(var_8_0, "holder")

		i18n = var_3

		var_2_10000(var_8_1, var_3("storyline_memorysearch1"))
	...
	var_3(arg_2_0, arg_2_0.closeSearch, function()
		if arg_2_0.searchOpen then
			...
			local var_9_1 = var_2.Find(var_9_0, "label")

			i18n = var_3

			var_0(var_9_1, var_3("storyline_memorysearch2"))
		else
			triggerButton = var_0
	...
	arg_2_0.rectAnchorX = var_3.Find(var_2_50, "GroupRect").anchoredPosition.x

	arg_2_0:UpdateView()

	local var_2_51 = arg_2_0._tf

	arg_2_0.storyLineBtn = var_3.Find(var_2_51, "StoryLineBtn")

	local var_2_52 = arg_2_0._tf

	arg_2_0.storyLineEntranceBtn = var_3.Find(var_2_52, "StoryLineBtn/entranceBtn")

	local var_2_53 = arg_2_0._tf

	arg_2_0.storyLineHideBtn = var_3.Find(var_2_53, "StoryLineBtn/closeBtn")
	...
	arg_2_0.storylineTF = var_3.Find(var_2_54, "StoryLine")
	WorldMediaCollectionStoryLineView = var_3
	arg_2_0.storyLineView = var_3.New(arg_2_0.storylineTF)

	local function var_2_55(arg_14_0, arg_14_1)
	...
	local function var_2_56(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_2_57 = arg_2_0.storyLineView

	var_5.ConfigCallback(var_2_57, var_2_55, var_2_56)
...
function var_0_1.StoryLineBtnSetActive(arg_16_0, arg_16_1)
	...
	var_1_10002(var_4.Find(var_16_0, "StoryLineBtn/on"), not arg_16_1)
...
function var_0_1.SwitchStoryLineMode(arg_17_0, arg_17_1)
	...
	if arg_17_1 == var_0_1.FORM_MODE then
		...
		var_2(var_4.Find(var_17_0, "GroupRect"), true)
	...
	elseif arg_17_1 == var_0_1.LINE_MODE then
		...
		var_2(var_4.Find(var_17_3, "GroupRect"), false)
...
function var_0_1.MemoryFilter(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_3(var_1_10005.memory_group.all) do
		pg = var_1_10008
...
function var_0_1.onInitMemoryGroup(arg_26_0, arg_26_1)
	...
	local function var_26_2()
		if arg_26_0.memoryGroupInfos[arg_26_1] then
			...
			local var_27_0 = var_1(var_2_10003)
			local var_27_1 = var_1.getRawData(var_27_0).id

			PlayerPrefs = var_2_10002

			var_2_10002.DeleteKey("MEMORY_GROUP_NOTIFICATION" .. var_27_1 .. " " .. var_0.id)
...
function var_0_1.onUpdateMemoryGroup(arg_28_0, arg_28_1, arg_28_2)
	...
	local var_28_2 = var_6(arg_28_2)

	var_28_1(var_6.Find(var_28_2, "title"), var_28_0.title)
	...
	local var_28_7 = var_9(arg_28_2)

	var_28_4(var_28_3, var_28_5, var_28_6, var_9.Find(var_28_7, "BG"))
	...
	local var_28_10 = var_1_10005.GetInt("MEMORY_GROUP_NOTIFICATION" .. var_28_9 .. " " .. var_28_0.id, 0) == 1

	setActive = var_28_8
	tf = var_8

	local var_28_11 = var_8(arg_28_2)

	var_28_8(var_8.Find(var_28_11, "Tip"), var_28_10)
	...
	local var_28_14 = var_10(arg_28_2)

	var_8(var_10.Find(var_28_14, "count"), var_28_13 .. "/" .. var_28_12)

	return
end

function var_0_1.Return2MemoryGroup(arg_30_0)
	if not arg_30_0.contextData.memoryGroup or arg_30_0:GetCurrentMode() == var_0_1.LINE_MODE then
		return
	end
...
function var_0_1.SwitchReddotMemory(arg_31_0)
	...
	local var_31_1 = var_1_10002(var_1_10004)
	local var_31_2 = var_2.getRawData(var_31_1).id

	ipairs = var_1_10003

	for iter_31_0, iter_31_1 in var_1_10003(arg_31_0.memoryGroups) do
...
function var_0_1.GetIndexRatio(arg_32_0, arg_32_1)
	...
	if arg_32_1 > 0 then
		...
		math = var_1_10007
		var_32_0 = (var_32_2 * var_1_10007.floor((arg_32_1 - 1) / var_32_3) + var_32_1.paddingFront) / (var_32_4 - arg_32_0.memoryGroupViewport.rect.height)
		Mathf = var_7
...
function var_0_1.UpdateView(arg_33_0)
	...
	var_1_10002(var_4.Find(var_33_1, "GroupRect"), {
	...
	for iter_33_0, iter_33_1 in var_1_10002(arg_33_0.memoryActivityToggles) do
		...
		var_7(var_33_2, var_1_10010(var_1_10012.memory_group.all, function(arg_34_0)
			pg = var_2_10001
...
function var_0_1.GetMatchGroupList(arg_37_0, arg_37_1, arg_37_2)
	...
	string = var_1_10005
	arg_37_1 = var_37_0(var_1_10005.gsub(arg_37_1, "%.", "%%."))

	local var_37_1 = {}

	pairs = var_1_10004

	for iter_37_0, iter_37_1 in var_1_10004(arg_37_0.memoryGroups) do
		string = var_37_2

		local var_37_2 = var_37_2.find

		string = var_1_10011

		if var_37_2(var_1_10011.lower(iter_37_1.title), arg_37_1) then
			table = var_37_2

			var_37_2.insert(var_37_1, iter_37_1)
		end
	end
