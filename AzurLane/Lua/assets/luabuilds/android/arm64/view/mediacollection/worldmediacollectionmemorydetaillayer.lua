...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_3.Find(var_2_0, "ItemRect/TitleRecord"), false)

	setActive = var_1

	local var_2_1 = arg_2_0._tf

	var_1(var_3.Find(var_2_1, "ItemRect/TitleMemory"), true)
	...
	arg_2_0.memoryItemsGrid = var_2_9(var_2_8, var_5(var_1_10007))
	setText = var_2

	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_4.Find(var_2_10, "ItemRect/ProgressDesc")

	i18n = var_5

	var_2(var_2_11, var_5("world_collection_2"))
...
function var_0_1.onInitMemoryItem(arg_5_0, arg_5_1)
	...
	var_2(var_5_0, var_5_1, var_5_2, var_1_10007)
...
function var_0_1.onUpdateMemoryItem(arg_7_0, arg_7_1, arg_7_2)
	...
	if var_7_0.is_open ~= 1 then
		...
		if var_7_5.IsPlayed(var_7_3, var_7_0.unlock_pre, true) then
			...
			typeof = var_8
			Text = var_10
			var_7_5 = var_7_5(var_7_4, var_8(var_10))
...
function var_0_1.PlayMemory(arg_9_0, arg_9_1)
	if arg_9_1.type == 1 then
		...
		string = var_1_10003
		var_1_10003 = var_1_10003.len(arg_9_1.mask)

		if 0 < var_1_10003 then
			setActive = var_1_10003

			var_1_10003(var_9_0, true)

			local var_9_1 = var_9_0

			var_1_10003 = var_9_0.GetComponent
			typeof = var_6
			Image = var_1_10008
			var_1_10003 = var_1_10003(var_9_1, var_6(var_1_10008))
			LoadSprite = var_4
			var_1_10003.sprite = var_4(arg_9_1.mask)
		else
			setActive = var_1_10003

			var_1_10003(var_9_0, false)
		end

		setActive = var_1_10003

		var_1_10003(arg_9_0.memoryMask, true)

		pg = var_1_10003

		local var_9_2 = var_1_10003.NewStoryMgr.GetInstance()

		var_1_10003.ReViewPlay(var_9_2, arg_9_1.story, function()
	...
	elseif arg_9_1.type == 2 then
		...
		local var_9_4 = var_2.StoryName2StoryId(var_9_3, arg_9_1.story)

		assert = var_1_10003

		local var_9_5 = var_9_4 and var_9_4 ~= 0
		local var_9_6 = "Missing Story Stage ID: "
		local var_9_7
		...
		var_1_10003(var_9_5, var_9_6 .. var_9_7)

		local var_9_8 = arg_9_0
		local var_9_9 = arg_9_0.emit

		WorldMediaCollectionMediator = var_6

		local var_9_10 = var_6.BEGIN_STAGE
		local var_9_11 = {
			memory = true
		}

		SYSTEM_PERFORM = var_1_10008
		var_9_11.system = var_1_10008
		var_9_11.stageId = var_9_4
...
function var_0_1.ShowSubMemories(arg_11_0, arg_11_1, arg_11_2)
	...
	if arg_11_2 then
		...
		if 0 < var_11_3 then
			var_11_4 = arg_11_0.memoryItemList
			...
			math = var_1_10010
			var_11_2 = (var_11_5 * var_1_10010.floor((var_11_3 - 1) / var_11_6) + var_11_4.paddingFront) / (var_11_7 - arg_11_0.memoryItemViewport.rect.height)
			Mathf = var_10
	...
	local var_11_10 = var_11_4.reduce(arg_11_0.memories, 0, function(arg_14_0, arg_14_1)
	...
	var_11_8(var_9.Find(var_11_11, "ItemRect/ProgressText"), var_11_10 .. "/" .. var_11_9)

	_ = var_11_8

	local var_11_12 = var_11_8.filter

	pg = var_9

	local var_11_13 = var_11_12(var_9.re_map_template.all, function(arg_15_0)
		pg = var_2_10001
	...
	if var_11_10 < var_11_9 then
		...
		var_9(var_11.Find(var_11_16, "ItemRect/UnlockTip"), var_11_15)
		...
		if var_11_15 then
			...
			local var_11_18 = var_11.sort

			Map = var_11_16

			local var_11_19 = var_11_17(var_11_18(var_11_16.GetRearChaptersOfRemaster(var_11_13[1])), function(arg_16_0)
			...
			local var_11_21 = var_12.Find(var_11_20, "ItemRect/UnlockTip")
			...
			var_10(var_11_21, var_13(var_11_22, var_11_23, var_1_10017.concat(var_11_19, "/")))
		end
...
function var_0_1.UpdateView(arg_18_0)
	...
	var_1_10002(var_4.Find(var_18_1, "ItemRect"), {
