...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".MedalTaskPanel"))
...
function var_0_1.UpdateList(arg_1_0, arg_1_1)
	...
	var_2.make(var_1_0, function(arg_2_0, arg_2_1, arg_2_2)
		...
		if arg_2_0 == var_2_10003.EventUpdate then
			...
			local var_2_3 = var_2_2(var_2_1, var_7(var_2_10009))
			...
			local var_2_9 = arg_2_2
			local var_2_10 = arg_2_2.Find(var_2_9, "frame/got_btn")
			local var_2_11 = arg_2_2:Find("frame/go_btn")

			setText = var_2_9

			var_2_9(var_2_7, var_2_0:getConfig("desc"))
			...
			local var_2_20 = var_2_19(var_2_18, var_19(var_2_10021))
			...
			local var_2_23 = var_2_22(var_2_21, var_20(var_2_10022))
			local var_2_24 = var_2_20.preferredWidth
			local var_2_25 = var_2_23.preferredWidth

			Vector2 = var_20
			var_2_4.sizeDelta = var_20(var_2_24, var_2_4.sizeDelta.y)
			Vector2 = var_20
			...
			var_23(var_2_10, var_2_0:getTaskStatus() == 2)
			...
			local var_2_29 = var_2_11
			local var_2_30 = var_2_0

			var_23(var_2_29, var_2_0.getTaskStatus(var_2_30) == 0)

			onButton = var_23

			local var_2_31 = arg_1_0
			local var_2_32 = var_2_11
			...
			local function var_2_33()
				...
				var_3_1(var_3_0, var_3_10003.ON_TASK_GO, var_2_0)
			...
			var_23(var_2_31, var_2_32, var_2_33, var_2_30)

			onButton = var_23

			local var_2_34 = arg_1_0
			local var_2_35 = var_2_8
			...
			local function var_2_36()
				...
				var_4_1(var_4_0, var_3_10003.ON_TASK_SUBMIT, var_2_0)
			...
			var_23(var_2_34, var_2_35, var_2_36, var_2_30)
		end
