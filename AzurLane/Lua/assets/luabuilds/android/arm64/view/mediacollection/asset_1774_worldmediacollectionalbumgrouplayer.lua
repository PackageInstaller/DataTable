...
function var_0_1.OnInit(arg_2_0)
	...
	pg = var_3
	arg_2_0.albumGroups = var_2_0(var_3.activity_medal_group.all, function(arg_3_0)
		pg = var_2_10001
	...
	local var_2_5 = var_2(arg_2_0.albumGroupList)
	...
	arg_2_0.albumGroupsGrid = var_2_8(var_2_7, var_5(var_1_10007))
	AutoLoader = var_2
	arg_2_0.loader = var_2.New()
	setText = var_2

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_4.Find(var_2_9, "top/expireCheckBox/text")

	i18n = var_5

	var_2(var_2_10, var_5("word_show_expire_content"))
	...
	var_2(var_2_14, var_2_15, var_2_16, var_7)
	...
	var_2(var_2_17, var_2_18, var_2_19, var_7)
	...
	var_2_23(var_2_22, var_5.Find(var_2_24, "tip"), {
		...
		local var_12_1 = var_2_10004(var_2_10006)

		var_2_10001(var_12_0, var_4.IsTipUnlockLetter(var_12_1))
...
function var_0_1.onInitAlbumGroup(arg_16_0, arg_16_1)
	...
	var_2(var_16_0, var_16_1, var_16_2, var_1_10007)
...
function var_0_1.onUpdateAlbumGroup(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_5 = var_1_10009(arg_18_2)

	var_18_2(var_18_1, var_18_3, var_18_4, var_9.Find(var_18_5, "BG"))
	...
	if var_18_2.IsMedalGroupCollectionGrey(var_18_0.id) then
		...
		var_1_10005 = var_1_10005.GetMedalGroupStateByID(var_18_0.id)
		ActivityMedalGroup = var_6
		var_18_6 = var_1_10005 < var_6.STATE_ACTIVE
	end

	setActive = var_1_10005
	tf = var_18_3

	local var_18_7 = var_18_3(arg_18_2)

	var_1_10005(var_7.Find(var_18_7, "expireMask"), var_18_6)
...
function var_0_1.SwitchReddotMemory(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10003(arg_20_0.albumGroups) do
...
function var_0_1.GetIndexRatio(arg_21_0, arg_21_1)
	...
	if arg_21_1 > 0 then
		...
		math = var_1_10007
		var_21_0 = (var_21_2 * var_1_10007.floor((arg_21_1 - 1) / var_21_3) + var_21_1.paddingFront) / (var_21_4 - arg_21_0.albumGroupViewport.rect.height)
		Mathf = var_7
...
function var_0_1.ExpireFilter(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10002(var_1_10004.activity_medal_group.all) do
		pg = var_1_10007
...
function var_0_1.UpdateView(arg_23_0)
	...
	var_1_10002(var_4.Find(var_23_1, "GroupRect"), {
...
function var_0_1.onInitCard(arg_26_0, arg_26_1)
	...
	var_26_1(arg_26_0, var_26_0.go, function()
		if var_26_0.shipGroup then
			...
			var_27_1(var_27_0, var_2_10003.OPEN_LOVE_LETTER_DISPLAY, var_26_0.shipGroup.id)
		end
...
function var_0_1.onUpdateCard(arg_28_0, arg_28_1, arg_28_2)
	...
	var_28_4(var_28_3, var_9.Find(var_28_5, "content/pick_up"), {
		"love_letter_unlock_letter"
	}, function(arg_29_0)
		...
		var_2_10002(var_29_2, var_2_10005.any(var_29_1:GetDisplayLetterList(), function(arg_30_0)
...
function var_0_1.OnDestroy(arg_32_0)
	...
	for iter_32_0, iter_32_1 in var_1_10001(arg_32_0.cardItems) do
		...
		var_1_10006(var_32_0, var_9.Find(var_32_1, "content/pick_up"))
	end
	...
	var_32_3(var_32_2, var_4.Find(var_32_4, "tip"))
