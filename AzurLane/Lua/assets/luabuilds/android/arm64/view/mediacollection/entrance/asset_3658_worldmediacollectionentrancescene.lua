...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_7, not var_4)

	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_1.Find(var_2_8, "Main/empty")

	SetCompomentEnabled = var_1_10002

	local var_2_10 = var_2_9
	local var_2_11 = "Image"

	LOCK_ALBUM = var_1_10006

	var_1_10002(var_2_10, var_2_11, var_1_10006)

	setActive = var_1_10002

	local var_2_12 = var_2_9:Find("Image")

	LOCK_ALBUM = var_2_11

	var_1_10002(var_2_12, not var_2_11)

	setActive = var_1_10002

	local var_2_13 = var_2_9:Find("Image1")

	LOCK_ALBUM = var_5

	var_1_10002(var_2_13, var_5)

	local var_2_14 = arg_2_0._tf

	arg_2_0.optionBtn = var_2.Find(var_2_14, "Top/blur_panel/adapt/top/option")

	local var_2_15 = arg_2_0._tf

	arg_2_0.backBtn = var_2.Find(var_2_15, "Top/blur_panel/adapt/top/back_btn")
	setText = var_2

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_4.Find(var_2_16, "Main/empty/label")

	i18n = var_5

	var_2(var_2_17, var_5("cryptolalia_unopen"))

	setText = var_2

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_4.Find(var_2_18, "Main/empty1/label")

	i18n = var_5

	var_2(var_2_19, var_5("cryptolalia_unopen"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_8()
		...
		WorldMediaCollectionEntranceMediator = var_2_10003

		var_6_1(var_6_0, var_2_10003.OPEN_RECALL)
	...
	local function var_3_11()
		...
		var_7_1(var_7_0, var_2_10003.OPEN_NEWRECALL)
	...
	local function var_3_14()
		...
		if var_2_10000 then
			...
			var_8_1(var_8_0, var_2_10003("word_comingSoon"))
		else
			...
			var_8_3(var_8_2, var_2_10003.OPEN_CRYPTOLALIA)
		end
	...
	local var_3_17 = var_3_13(var_1_10006)
	local var_3_18 = var_3_16(var_3_15, var_4.getRawData(var_3_17).level, "WorldMediator")

	setActive = var_1_10002

	var_1_10002(arg_3_0.archiveLockTF, not var_3_18)
	...
	local function var_3_21()
		if not var_3_18 then
			...
			var_9_1(var_2_10003, var_2_10004("no_open_system_tip", var_9_0.name, var_9_0.level))
		...
		var_9_3(var_9_2, var_2_10003.OPEN_ARCHIVE)
	...
	var_1_10002(var_3_19, var_3_20, var_3_21, var_1_10007)
	...
	local function var_3_24()
		...
		var_10_1(var_10_0, var_2_10003.OPEN_RECORD)
	...
	var_1_10002(var_3_22, var_3_23, var_3_24, var_1_10007)
	...
	local function var_3_27()
		...
		var_11_1(var_11_0, var_2_10003.OPEN_ALBUM)
	...
	var_1_10002(var_3_25, var_3_26, var_3_27, var_1_10007)
