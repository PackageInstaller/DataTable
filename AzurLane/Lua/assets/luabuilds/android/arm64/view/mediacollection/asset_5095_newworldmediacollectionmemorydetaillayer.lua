...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_3 = var_3.Find(var_2_2, "AD/task/ProgressDesc")

	i18n = var_4

	var_1(var_2_3, var_4("activity_permanent_progress"))
...
function var_0_1.onUpdateMemoryItem(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5, arg_4_6)
	...
	local var_4_4 = var_10(var_1_10012)
	...
	local var_4_5 = var_4_2:Find("on/num")

	string = var_14

	var_1_10011(var_4_5, var_14.format("%02d", arg_4_1))

	setText = var_1_10011

	local var_4_6 = var_4_2:Find("deblocking/Text")

	i18n = var_14

	var_1_10011(var_4_6, var_14("memory_unlock"))

	setText = var_1_10011

	local var_4_7 = var_4_2:Find("lock_bg/go/name")

	i18n = var_14

	var_1_10011(var_4_7, var_14("memory_goto"))
	...
	local var_4_10 = var_4_2.Find(var_4_9, "lock_bg/go")

	local function var_4_11()
		local var_5_0 = arg_4_0
		local var_5_1 = var_0.emit

		WorldMediaCollectionMediator = var_2_10003

		var_5_1(var_5_0, var_2_10003.GO_TASK)
	...
	var_1_10011(var_4_8, var_4_10, var_4_11, var_4_9)

	onButton = var_1_10011

	local var_4_12 = arg_4_0
	local var_4_13 = var_4_2
	local var_4_14 = var_4_2.Find(var_4_13, "deblocking")
	...
	local function var_4_15()
		...
		var_6_1(var_6_0, var_2_10003.TRIGGER_PERSONAL_TASK, arg_4_4, function()
	...
	var_1_10011(var_4_12, var_4_14, var_4_15, var_4_13)

	onButton = var_1_10011

	local var_4_16 = arg_4_0
	local var_4_17 = var_4_2
	local var_4_18 = var_4_2.Find(var_4_17, "on/play")
	...
	var_1_10011(var_4_16, var_4_18, var_4_19, var_4_17)
...
function var_0_1.PlayMemory(arg_10_0, arg_10_1)
	if arg_10_1.type == 1 then
		...
		string = var_1_10003
		var_1_10003 = var_1_10003.len(arg_10_1.mask)
		...
		if 0 < var_1_10003 then
			...
			var_1_10003 = var_10_0.GetComponent
			typeof = var_6
			Image = var_1_10008
			var_1_10003 = var_1_10003(var_10_1, var_6(var_1_10008))
			LoadSprite = var_4
			var_1_10003.sprite = var_4(arg_10_1.mask)
		else
			setActive = var_1_10003
		...
		var_1_10003(arg_10_0.memoryMask, true)

		pg = var_1_10003

		local var_10_2 = var_1_10003.NewStoryMgr.GetInstance()

		var_1_10003.ReViewPlay(var_10_2, arg_10_1.story, function()
	...
	elseif arg_10_1.type == 2 then
		...
		local var_10_3 = var_2.NewStoryMgr.GetInstance()
		local var_10_4 = var_2.StoryName2StoryId(var_10_3, arg_10_1.story)

		assert = var_1_10003

		local var_10_5 = var_10_4 and var_10_4 ~= 0
		local var_10_6 = "Missing Story Stage ID: "
		local var_10_7
		...
		var_1_10003(var_10_5, var_10_6 .. var_10_7)

		local var_10_8 = arg_10_0
		local var_10_9 = arg_10_0.emit

		WorldMediaCollectionMediator = var_6

		local var_10_10 = var_6.BEGIN_STAGE
		local var_10_11 = {
			memory = true
		}

		SYSTEM_PERFORM = var_1_10008
		var_10_11.system = var_1_10008
		var_10_11.stageId = var_10_4
...
function var_0_1.ShowSubMemories(arg_12_0, arg_12_1, arg_12_2)
	...
	var_7(var_9.Find(var_12_5, "AD/icon_bg/painting/name_bg/name"), var_12_3.name)

	SetActive = var_7

	local var_12_6 = arg_12_0._tf

	var_7(var_9.Find(var_12_6, "AD/icon_bg/painting/name_bg/off"), var_12_4)
	...
	local var_12_9 = var_1_10008.ship_skin_template[var_12_3.skin_id].painting
	...
	if arg_12_2 then
		...
		if 0 < var_12_12 then
			...
			var_12_14 = arg_12_0.memoryItemsGrid.cellSize.y + arg_12_0.memoryItemsGrid.spacing.y
			...
			math = var_1_10016
			var_12_11 = (var_12_14 * var_1_10016.floor((var_12_12 - 1) / var_12_15) + var_12_13.paddingFront) / (var_12_16 - arg_12_0.memoryItemViewport.rect.height)
			Mathf = var_16
	...
	var_12_14(var_15.Find(var_12_19, "AD/task/ProgressText"), var_12_18 .. "/" .. var_12_17)

	setText = var_12_14

	local var_12_20 = arg_12_0._tf

	var_12_14(var_15.Find(var_12_20, "AD/task/headline_bg/headline_name"), arg_12_1.title)
