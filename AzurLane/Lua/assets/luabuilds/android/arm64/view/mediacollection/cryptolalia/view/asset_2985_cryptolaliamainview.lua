...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.downloadBtnAnim = var_1_1(var_1_0, var_5(var_1_10007))
...
function var_0_0.Flush(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	if not arg_3_0.cryptolalia or arg_3_0.cryptolalia.id ~= arg_3_1.id then
		...
		local var_3_1 = not arg_3_1:IsForever() and arg_3_1:IsLock()

		setActive = var_5

		var_5(arg_3_0.timeLimit, var_3_1)
		arg_3_0:RemoveTimer()
		arg_3_0:AddTimer(arg_3_1, var_3_1)
	end
...
function var_0_0.FlushState(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	if arg_6_3 then
		...
		if not var_1_10004.STATE_DOWNLOADING then
			var_1_10006 = arg_6_1
			var_6_0 = arg_6_1.GetState(var_1_10006, arg_6_2)
		end
		...
		Cryptolalia = var_1_10008

		var_1_10005(var_6_1, var_1_10008.STATE_LOCK == var_6_0)
		...
		var_1_10005(var_6_2, var_8.STATE_DOWNLOADABLE == var_6_0)

		local var_6_3

		if arg_6_0.state then
			var_6_3 = arg_6_0.state
			Cryptolalia = var_1_10006

			if var_6_3 == var_1_10006.STATE_LOCK then
				Cryptolalia = var_6_3
		...
		var_6_3(var_6_6, var_6_0 == var_8.STATE_DOWNLOADING)
		...
		var_6_3(var_6_7, var_8.STATE_PLAYABLE == var_6_0)
		...
		var_6_3(var_6_8, var_8.STATE_PLAYABLE == var_6_0)

		setText = var_6_3

		local var_6_9 = arg_6_0.deleteBtn
		local var_6_10 = var_7.Find(var_6_9, "label")

		i18n = var_8

		var_6_3(var_6_10, var_8("cryptolalia_delete_res", arg_6_1:GetResSize(arg_6_2)))
		...
		var_6_3(var_6_11, var_8.STATE_PLAYABLE ~= var_6_0)
		...
		if var_6_0 ~= var_8.STATE_DOWNLOADING then
			PLATFORM_CODE = var_8
			PLATFORM_CH = var_6_9

			if var_8 == var_6_9 then
		...
		local var_6_15 = var_1_10006(20, -9.2)
		...
		var_8(var_10.Find(var_6_17, "ch"), var_6_16 and var_6_14 or var_6_15)

		setAnchoredPosition = var_8

		local var_6_18 = arg_6_0.switchBtn

		var_8(var_10.Find(var_6_18, "jp"), var_6_16 and var_6_15 or var_6_14)
		...
		var_8(var_6_19, var_6_0 ~= var_11.STATE_DOWNLOADING)
		...
		if var_8.STATE_LOCK == var_6_0 then
			...
			i18n = var_9
			var_6_20.text = var_9("cryptolalia_lock_res")
		else
			...
			if var_6_20.STATE_PLAYABLE ~= var_6_0 then
				...
				i18n = var_9
				var_6_21.text = var_9("cryptolalia_not_download_res")
			else
