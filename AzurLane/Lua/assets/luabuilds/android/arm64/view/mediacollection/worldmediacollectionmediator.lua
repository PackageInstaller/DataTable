...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.BEGIN_STAGE, function(arg_2_0, arg_2_1)
		...
		var_2_2(var_2_1, var_2_10005.BEGIN_STAGE, arg_2_1)
	...
	arg_1_0:bind(var_0_1.GO_TASK, function(arg_4_0, arg_4_1)
		...
		local var_4_3 = var_2_10006.TASK
		local var_4_4 = {}

		TaskScene = var_2_10008
		var_4_4.page = var_2_10008.PAGE_TYPE_BRANCH
	...
	arg_1_0:bind(var_0_1.OPEN_LOVE_LETTER_DISPLAY, function(arg_5_0, arg_5_1)
		...
		LoveLetterDisplayMediator = var_2_10008
		var_5_3.mediator = var_2_10008
		LoveLetterDisplayLayer = var_2_10008
		...
		LoveLetterProxy = var_2_10014

		local var_5_6 = var_2_10012(var_2_10014)
		local var_5_7 = var_12.GetGroupData(var_5_6, arg_5_1)

		var_5_5.__index = var_12.GetLetterDataFromId(var_5_7)
		var_5_3.data = var_2_10008(var_5_4, var_5_5)
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_1 == var_8_0.UPDATED then
		...
		if var_8_1 == var_4.BEGIN_STAGE_DONE then
			...
			local var_8_6 = var_1_10007.GO_SCENE

			SCENE = var_1_10008

			var_8_5(var_8_4, var_8_6, var_1_10008.COMBATLOAD, var_8_2)
		else
			GAME = var_8_5

			if var_8_1 == var_8_5.UNLOCK_LOVE_LETTER_DONE then
				pg = var_4
				...
				if var_8_1 == var_4.STORY_UPDATE_DONE then
...
function var_0_1.TriggerPersonalTask(arg_9_0, arg_9_1, arg_9_2)
	...
	if var_9_2[1] then
		...
		pg = var_1_10004
		var_1_10004 = var_1_10004.task_data_trigger[var_3].task_id
	end

	assert = var_9_0

	local var_9_3 = var_1_10004 and var_1_10004 ~= 0
	local var_9_4 = "invalid taskId for groupId:"

	tostring = var_9

	var_9_0(var_9_3, var_9_4 .. var_9(arg_9_1))

	getProxy = var_9_0
	TaskProxy = var_9_3

	local var_9_5 = var_9_0(var_9_3)

	if not var_5.getFinishTaskById(var_9_5, var_1_10004) then
		pg = var_5

		local var_9_6 = var_5.task_data_template[var_1_10004].story_id
		...
		var_9_11(var_9_10, var_9.TRIGGER_TASK, var_1_10004)
	end
