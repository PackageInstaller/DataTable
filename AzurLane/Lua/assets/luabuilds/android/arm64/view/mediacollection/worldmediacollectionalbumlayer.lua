...
function var_0_1.OnSelected(arg_8_0)
	...
	if var_8_1(var_8_0, var_1_10005.QIXI_ACTIVITY_ID) and not var_2:isEnd() then
		local var_8_2 = var_2:getConfig("config_data")

		_ = var_8_0

		local var_8_3 = var_4[#var_8_0.flatten(var_8_2)]
		...
		if var_6.getTaskById(var_8_4, var_8_3) and not var_1_10007:isFinish() then
			pg = var_8

			local var_8_5 = var_8.NewStoryMgr.GetInstance()

			var_8.Play(var_8_5, "HOSHO8", function()
				local var_9_0 = arg_8_0
				local var_9_1 = var_0.emit

				CollectionScene = var_2_10003

				var_9_1(var_9_0, var_2_10003.ACTIVITY_OP, {
					cmd = 2,
	...
	local var_8_6 = arg_8_0.contextData.memoryGroup
	local var_8_7 = arg_8_0.contextData

	var_8_7.memoryGroup = nil

	if var_8_6 then
		pg = var_8_7

		if var_8_7.memory_group[var_8_6] then
			local var_8_8 = arg_8_0
			local var_8_9 = arg_8_0.ShowSubMemories

			pg = var_1_10007

			var_8_9(var_8_8, var_1_10007.memory_group[var_8_6])
...
function var_0_1.ShowAlbum(arg_17_0, arg_17_1)
	...
	WorldMediaCollectionMediator = var_1_10010

	var_17_6(var_17_5, var_1_10010.ON_ADD_SUBLAYER, var_17_4)
