...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_3.Find(var_2_0, "ItemRect/TitleRecord"), true)

	setActive = var_1

	local var_2_1 = arg_2_0._tf

	var_1(var_3.Find(var_2_1, "ItemRect/TitleMemory"), false)
	...
	local var_2_7 = var_4.Find(var_2_6, "ItemRect/ProgressDesc")

	i18n = var_5

	var_2(var_2_7, var_5("world_collection_2"))
...
function var_0_1.OnUpdateRecordItem(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_0.CheckRecordIsUnlock(var_7_0) then
		...
		typeof = var_8
		Text = var_1_10010
		var_7_6 = var_7_6(var_7_5, var_8(var_1_10010))
		...
		local var_7_8 = var_7_4:Find("normal/id")

		string = var_1_10010

		var_7(var_7_8, var_1_10010.format("#%u", var_7_0.group_ID))
	else
		setActive = var_7_6
	...
	var_7_6(var_7_9, var_7_10, var_7_11, var_1_10010)
...
function var_0_1.PlayMemory(arg_10_0, arg_10_1)
	...
	if arg_10_1.type == var_0_1.TypeBattle then
		...
		var_10_3 = arg_10_0.emit
		WorldMediaCollectionMediator = var_1_10006

		local var_10_4 = var_1_10006.BEGIN_STAGE
		local var_10_5 = {
			memory = true
		}

		SYSTEM_PERFORM = var_1_10008
		var_10_5.system = var_1_10008
		var_10_5.stageId = var_10_1

		var_10_3(var_10_2, var_10_4, var_10_5)
	else
		findTF = var_10_1

		local var_10_6 = var_10_1(arg_10_0.memoryMask, "pic")

		string = var_10_3

		local var_10_7 = var_10_3.len(arg_10_1.mask)

		if 0 < var_10_7 then
			setActive = var_10_7

			var_10_7(var_10_6, true)

			local var_10_8 = var_10_6

			var_10_7 = var_10_6.GetComponent
			typeof = var_6
			Image = var_1_10008
			var_10_7 = var_10_7(var_10_8, var_6(var_1_10008))
			LoadSprite = var_4
			var_10_7.sprite = var_4(arg_10_1.mask)
		else
			setActive = var_10_7

			var_10_7(var_10_6, false)
		end
		...
		local var_10_9 = var_10_7.NewStoryMgr.GetInstance()

		var_3.Play(var_10_9, arg_10_1.story, function()
...
function var_0_1.ShowRecordGroup(arg_12_0, arg_12_1)
	...
	var_1_10003("Missing Record Group Config ID: " .. (arg_12_1 or "NIL"))

	_ = var_1_10003
	arg_12_0.records = var_1_10003.map(var_12_1.child, function(arg_13_0)
	...
	local var_12_4 = var_4.reduce(arg_12_0.records, 0, function(arg_14_0, arg_14_1)
	...
	var_12_2(var_7.Find(var_12_5, "ItemRect/ProgressText"), var_12_4 .. "/" .. var_12_3)
