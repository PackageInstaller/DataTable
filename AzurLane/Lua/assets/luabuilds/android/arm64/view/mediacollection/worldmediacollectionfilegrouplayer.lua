...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_7 = var_3.Find(var_2_6, "ProgressDesc")

	i18n = var_4

	var_1(var_2_7, var_4("world_collection_3"))
...
function var_0_1.UpdateGroupList(arg_4_0)
	...
	var_1_10002.clear(arg_4_0.fileGroups)
	...
	local var_4_4 = var_4.each

	pg = var_1_10006

	var_4_4(var_1_10006.world_collection_file_group.all, function(arg_5_0)
		pg = var_2_10001
	...
	var_1_10005(arg_4_0.emptyTip, var_4_5)
	...
	var_1_10005(arg_4_0.scroll, not var_4_5)
...
function var_0_1.BlurTip(arg_7_0)
	...
	var_7_4[1] = var_7.Find(var_7_5, "EmptyTip")
...
function var_0_1.Hide(arg_10_0)
	...
	var_10_0(var_1_10003(arg_10_0.content))
...
function var_0_1.OnUpdateFileGroup(arg_11_0, arg_11_1, arg_11_2)
	...
	var_1_10005(var_11_1:Find("FileIndex"), var_11_0.id_2)
	...
	for iter_11_0, iter_11_1 in var_8(var_11_0.child) do
		var_1_10015 = var_11_5

		if var_11_5.IsUnlock(var_1_10015, iter_11_1) then
			var_11_6 = var_11_6 + 1
		end
	end
	...
	typeof = var_13
	HorizontalLayoutGroup = var_1_10015

	local var_11_13 = var_11_12(var_11_11, var_13(var_1_10015)).padding.left
	...
	var_13(var_11_15, var_11_16, var_11_17, var_1_10018)
