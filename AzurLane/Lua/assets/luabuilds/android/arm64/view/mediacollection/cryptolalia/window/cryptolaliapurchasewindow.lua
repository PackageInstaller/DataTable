...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.signature = var_2_5(var_2_4, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.name = var_2_8(var_2_7, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.shipname = var_2_11(var_2_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.gemCntTxt = var_2_16(var_2_15, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.ticketCntTxt = var_2_19(var_2_18, var_4(var_1_10006))
	...
	local var_2_22 = var_3.Find(var_2_21, "title")

	i18n = var_4

	var_1(var_2_22, var_4("cryptolalia_use_gem_title"))

	setText = var_1

	local var_2_23 = arg_2_0.ticketToggle
	local var_2_24 = var_3.Find(var_2_23, "title")

	i18n = var_4

	var_1(var_2_24, var_4("cryptolalia_use_ticket_title"))
	...
	var_1(var_2_26, var_4("cryptolalia_exchange"))
...
function var_0_1.Show(arg_7_0, arg_7_1)
	...
	var_3("CryptolaliaShip/" .. var_7_2, "cd", function(arg_8_0)
	...
	local function var_7_5()
		...
		CryptolaliaMediator = var_2_10003

		var_9_1(var_9_0, var_2_10003.UNLOCK, arg_7_1.id, arg_7_0.costType)
	...
	if var_4.getResource(var_7_10, var_7_8.id) < var_7_8.count then
		...
		local var_7_12 = var_8(var_5, var_6)

		setColorStr = var_1_10009
		var_7_11.text = var_7_12 .. var_1_10009("/" .. var_7_8.count, "#AFAFAF")
		...
		local var_7_15 = var_7_14(var_7_13, var_10.COST_TYPE_TICKET)
