...
function var_0_0.InitUI(arg_3_0)
	...
	var_1(arg_3_0, arg_3_0._nextBtn, function()
		...
		var_9_0._currentIndex = var_9_1(var_9_2, #var_4.GetMedalIds(var_9_3))
...
function var_0_0.UpdateMedal(arg_12_0)
	...
	var_12_0(arg_12_0._nameText, var_12_3.activity_medal_name)

	setText = var_12_0

	var_12_0(arg_12_0._descText, var_12_3.activity_medal_desc)
	...
	if arg_12_0._medal.timeStamp then
		...
		local var_12_7 = var_1_10007.TimeMgr.GetInstance()

		var_3(var_12_5, var_12_6 .. var_7.CTimeDescC(var_12_7, arg_12_0._medal.timeStamp, "%Y/%m/%d"))

		setText = var_3

		local var_12_8 = arg_12_0._progressText

		i18n = var_12_6

		var_3(var_12_8, var_12_6("word_unlock"))
	else
		setText = var_3

		local var_12_9 = arg_12_0._conditionText

		pg = var_12_6

		var_3(var_12_9, var_12_6.task_data_template[var_12_3.task_id].desc)

		setText = var_3

		local var_12_10 = arg_12_0._progressText

		i18n = var_6

		var_3(var_12_10, var_6("word_lock"))
	end
	...
	local var_12_11 = arg_12_0._medalGroup
	local var_12_12 = var_4.GetMedalGroupState(var_12_11)

	ActivityMedalGroup = var_5

	if var_12_12 == var_5.STATE_EXPIRE then
		setText = var_5

		local var_12_13 = arg_12_0._stateText

		setColorStr = var_1_10008
		i18n = var_1_10010
		var_1_10010 = var_1_10010("word_cant_gain_anymore")

		local var_12_14

		if not arg_12_0._parent.setColorstateText then
			var_12_14 = arg_12_0.setColorstateText
		end

		var_5(var_12_13, var_1_10008(var_1_10010, var_12_14))
	else
		ActivityMedalGroup = var_5

		if var_12_12 == var_5.STATE_CLOSE then
			setText = var_5

			local var_12_15 = arg_12_0._stateText

			setColorStr = var_1_10008
			i18n = var_1_10010

			local var_12_16 = var_1_10010("word_activity_not_open")
			local var_12_17

			if not arg_12_0._parent.setColorstate then
				var_12_17 = arg_12_0.setColorstate
			end

			var_5(var_12_15, var_1_10008(var_12_16, var_12_17))
		end
	end

	SetActive = var_5

	local var_12_18 = arg_12_0._stateText

	ActivityMedalGroup = var_1_10008

	var_5(var_12_18, var_12_12 ~= var_1_10008.STATE_ACTIVE)
	...
	local var_12_19 = arg_12_0._nextBtn
	local var_12_20 = arg_12_0._currentIndex
	local var_12_21 = arg_12_0._medalGroup

	var_5(var_12_19, var_12_20 ~= #var_9.GetMedalIds(var_12_21))
