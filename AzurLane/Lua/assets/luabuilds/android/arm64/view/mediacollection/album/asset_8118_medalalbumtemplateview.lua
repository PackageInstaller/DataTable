...
function var_0_1.SetMedalGroupData(arg_1_0, arg_1_1)
	...
	ActivityMedalGroup = var_3

	if var_1_2 == var_3.STATE_ACTIVE then
...
function var_0_1.FindUI(arg_5_0)
	...
	arg_5_0.medalDetailView = var_5_14(var_4.Find(var_5_15, "DetailView"), arg_5_0)
	...
	arg_5_0.medalTaskView = var_5_17(var_4.Find(var_5_18, "TaskView"), arg_5_0)
...
function var_0_1.AddListener(arg_7_0)
	...
	for iter_7_0 = 1, arg_7_0.MEDAL_COUNT do
		...
		var_7_2(arg_7_0, arg_7_0.slots[iter_7_0].click, function()
	...
	var_1(arg_7_0, arg_7_0.helpBtn, function()
		...
		pg = var_2_10004
		var_12_2.helps = var_2_10004.gametip[arg_7_0.HELP_TIPS].tip
	...
	local function var_7_8()
		...
		var_13_4(var_13_3, var_2_10005.ON_DROP, var_13_2)
	...
	if arg_7_0.trophyLock then
		...
		local function var_7_11()
			...
			var_14_4(var_14_3, var_2_10005.ON_DROP, var_14_2)
...
function var_0_1.UpdateView(arg_17_0)
	...
	for iter_17_0 = 1, arg_17_0.MEDAL_COUNT do
		var_1_10007 = var_17_1[iter_17_0]
		var_1_10008 = arg_17_0.slots[iter_17_0]

		if var_17_3[var_1_10007].timeStamp then
			setActive = var_9

			var_9(var_1_10008.active, true)
		else
			setActive = var_9

			var_9(var_1_10008.active, false)
		end
	end

	if arg_17_0.trophyLock then
		local var_17_4 = arg_17_0.trophyLock
		local var_17_5 = var_3.GetComponent

		typeof = iter_17_0
		Image = var_1_10008

		local var_17_6 = var_17_5(var_17_4, iter_17_0(var_1_10008))

		iter_17_0 = arg_17_0
		var_17_6.enabled = not arg_17_0.OwnTrophy(iter_17_0)
	end

	local var_17_7 = arg_17_0.medalLock
	local var_17_8 = var_3.GetComponent

	typeof = iter_17_0
	Image = var_1_10008

	local var_17_9 = var_17_8(var_17_7, iter_17_0(var_1_10008))

	var_17_9.enabled = not arg_17_0:OwnMedal()
	setActive = var_17_9

	local var_17_10 = arg_17_0.taskBtn
	local var_17_11 = arg_17_0.currentMedalGroup
	local var_17_12 = var_6.GetMedalGroupState(var_17_11)

	ActivityMedalGroup = var_1_10007

	var_17_9(var_17_10, var_17_12 == var_1_10007.STATE_ACTIVE)
...
function var_0_1.OwnTrophy(arg_18_0)
	...
	if var_18_1 then
		...
		if var_18_0(var_18_1) == "table" then
			var_18_2 = var_18_1[1]
		end
	end
	...
	return var_4.OwnSpAward(var_18_3)
end
...
function var_0_1.OwnMedal(arg_19_0)
	...
	if var_19_1 then
		...
		if var_19_0(var_19_1) == "table" then
			var_19_2 = var_19_1[2]
		end
	end
