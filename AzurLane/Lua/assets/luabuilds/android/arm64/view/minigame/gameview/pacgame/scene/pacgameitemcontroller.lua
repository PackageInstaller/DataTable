...
function var_0_0.tryCreateItem(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1_10003(arg_10_0._gridDic) do
		if iter_10_1:GetPassAble() and not iter_10_1:GetScoreFlag() and iter_10_1:GetIndex() ~= var_10_2 then
			table = var_8

			var_8.insert(var_10_0, iter_10_1:GetIndex())
		end
	end

	local var_10_3 = #arg_10_0._items

	PacGameConst = var_4

	if var_10_3 <= var_4.max_item_count then
		local var_10_4 = #var_10_0

		if 10 <= var_10_4 then
			math = var_10_4

			local var_10_5 = var_10_4.random()

			PacGameConst = var_4

			if var_10_5 <= var_4.item_rate then
				math = var_10_5

				local var_10_6 = var_10_0[var_10_5.random(1, #var_10_0)]
				local var_10_7 = arg_10_0._gridDic[var_10_6]
				local var_10_8 = var_4.GetIndex(var_10_7)
				local var_10_9 = var_4:GetPosition()
				local var_10_10, var_10_11 = var_4:GetVH()
				local var_10_12 = arg_10_0._mapTFDic[var_10_10]
				local var_10_13 = arg_10_0._itemConfig

				math = var_1_10011

				local var_10_14 = var_10_13[var_1_10011.random(1, #arg_10_0._itemConfig)]
				local var_10_15 = arg_10_0:createItem(var_10_14, var_10_8, var_10_12)

				var_11.SetPosition(var_10_15, var_10_9)
...
function var_0_0.createItem(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	PacGameItem = var_1_10007

	return (var_1_10007.New(var_11_2, arg_11_2, var_4))
end
