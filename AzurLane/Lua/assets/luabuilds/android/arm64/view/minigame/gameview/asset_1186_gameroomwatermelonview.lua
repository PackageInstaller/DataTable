...
local var_0_0 = "GameRoomWatermelonView"
...
function var_0_1.didEnter(arg_4_0)
	WatermelonGameVo = var_1_10001
	arg_4_0._gameVo = var_1_10001.New(arg_4_0:GetMGData().id)
	var_0_2 = arg_4_0._gameVo
...
function var_0_1.initEvent(arg_5_0)
	...
	var_5_13(var_5_12, var_4.BACK_MENU, function(arg_12_0, arg_12_1, arg_12_2)
		...
		local var_12_8 = arg_5_0

		var_3.openCoinLayer(var_12_8, true)
	...
	var_5_27(var_5_26, var_4.SUBMIT_GAME_SUCCESS, function(arg_19_0, arg_19_1, arg_19_2)
		if not arg_5_0.sendSuccessFlag then
			...
			var_3.SendSuccess(var_19_0, arg_19_1)
		end
