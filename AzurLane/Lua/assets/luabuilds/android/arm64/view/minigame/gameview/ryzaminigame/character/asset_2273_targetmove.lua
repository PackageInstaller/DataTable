...
function var_0_1.TimeUpdate(arg_8_0, arg_8_1)
	...
	var_8_1(var_8_0, var_1_10005(0, 0))
...
function var_0_1.MoveDelta(arg_10_0, arg_10_1, arg_10_2)
	...
	unpack = var_1_10010
	var_10_2.x = var_10_3(var_10_4, var_1_10010(var_10_1.x))
	math = var_7
	...
	unpack = var_10
	var_10_2.y = var_10_5(var_10_6, var_10(var_10_1.y))
	...
	elseif var_10_2.x == 0 then
		...
		unpack = var_10
		var_10_2.y = var_10_7(var_10_8, var_10(var_10_1.y))
		...
		if var_10_2.y == 0 then
			...
			unpack = var_10
			var_10_2.x = var_10_9(var_10_10, var_10(var_10_1.x))
			...
			if not var_10_0(var_10_11) then
				...
				unpack = iter_10_3
				var_10_16.x = var_10_17(var_10_18, iter_10_3(var_10_1.x))
				math = var_11
				...
				unpack = var_14
				var_10_16.y = var_10_19(var_10_20, var_14(var_10_1.y))
...
function var_0_1.PlayAnim(arg_14_0, arg_14_1)
	if arg_14_0.status ~= arg_14_1 then
		...
		local var_14_3 = var_14_2(var_14_1, var_5(var_1_10007))
