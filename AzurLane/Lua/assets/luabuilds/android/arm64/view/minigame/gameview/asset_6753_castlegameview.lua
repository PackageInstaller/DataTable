...
function var_0_1.initEvent(arg_5_0)
	...
	arg_5_0:bind(var_0_1.BACK_MENU, function(arg_11_0, arg_11_1, arg_11_2)
		...
		var_11_1(var_11_0, var_6.GetMGHubData(var_11_2))
		...
		if not var_3.getBGM(var_11_6) then
			...
			local var_11_7 = var_2_10004.CriMgr.GetInstance()
	...
	arg_5_0:bind(var_0_1.SHOW_RULE, function(arg_14_0, arg_14_1, arg_14_2)
		...
		local var_14_3 = var_2_10007.gametip

		CastleGameVo = var_2_10008
		var_14_2.helps = var_14_3[var_2_10008.rule_tip].tip
...
function var_0_1.Update(arg_21_0)
	...
	if var_1 then
		...
		if var_21_0(var_1_10003.S) then
			var_21_1 = arg_21_0.gameUI
			var_21_2 = var_21_2.press
			KeyCode = var_1_10004

			var_21_2(var_21_1, var_1_10004.S, true)
		end
		...
		if var_21_3(var_21_1.S) then
			...
			var_21_5(var_21_4, var_1_10004.S, false)
		end
		...
		if var_21_6(var_21_4.W) then
			...
			var_21_8(var_21_7, var_1_10004.W, true)
		end
		...
		if var_21_9(var_21_7.W) then
			...
			var_21_11(var_21_10, var_1_10004.W, false)
		end
		...
		if var_21_12(var_21_10.A) then
			...
			var_21_14(var_21_13, var_1_10004.A, true)
		end
		...
		if var_21_15(var_21_13.A) then
			...
			var_21_17(var_21_16, var_1_10004.A, false)
		end
		...
		if var_21_18(var_21_16.D) then
			...
			var_21_20(var_21_19, var_1_10004.D, true)
		end
		...
		if var_21_21(var_21_19.D) then
			...
			var_21_23(var_21_22, var_1_10004.D, false)
		end
	end
...
function var_0_1.onGameOver(arg_32_0)
	...
	local var_32_1 = var_3(arg_32_0._tf)
	local var_32_2 = 0.1

	System = var_5

	var_32_0(var_32_1, var_32_2, var_5.Action(function()
