local var_0_0 = class("GameRoomWatermelonView", import("..BaseMiniGameView"))
local var_0_1
...
function var_0_0.didEnter(arg_4_0)
	arg_4_0._gameVo = WatermelonGameVo.New(arg_4_0:GetMGData().id)
	var_0_1 = arg_4_0._gameVo
