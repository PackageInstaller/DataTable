...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	TouchCakeGameConst = var_1_10004

	for iter_1_0 = var_1_0, var_1_10004.max_cake_count do
		local var_1_1 = var_0_1.GetTplItemFromPool("CakeTpl", arg_1_0._cakeContainer)

		TouchCakeItem = var_1_10008
		var_1_10008 = var_1_10008.New(var_1_1, arg_1_0._event)
		table = var_9

		var_9.insert(arg_1_0.cakeItems, var_1_10008)
	end
...
function var_0_0.start(arg_2_0)
	...
	local var_2_0 = var_1_10003.cake_init_pos[1]

	TouchCakeGameConst = var_1_10004
	arg_2_0._cakeBottomPos = var_1(var_2_0, var_1_10004.cake_init_pos[2])
	...
	for iter_2_0 = #arg_2_0.cakeItemPool, 1, -1 do
		if arg_2_0:getItemFromPool() then
			table = var_1_10006

			var_1_10006.insert(arg_2_0.cakeItems, var_5)
		end
	end
...
function var_0_0.getRandCakeData(arg_5_0)
	...
	local var_5_0 = var_1_10003.cake_data

	TouchCakeGameConst = var_1_10004

	local var_5_1 = var_1_10004.cake_data.all

	math = var_1_10005

	local var_5_2 = var_1_10005.random
	local var_5_3 = 1

	TouchCakeGameConst = var_1_10008

	return var_1_10001(var_5_0[var_5_1[var_5_2(var_5_3, #var_1_10008.cake_data.all)]])
end
...
function var_0_0.getRandPropDataByRate(arg_8_0)
	if not arg_8_0.weightTotal then
		...
		for iter_8_0, iter_8_1 in var_1(var_1_10003.prop_rate) do
			...
			if var_1_10007.prop_times then
				TouchCakeGameConst = var_1_10007

				if var_1_10007.prop_times[iter_8_1.id] then
					TouchCakeGameConst = var_1_10007
					var_8_0 = var_1_10007.prop_times[iter_8_1.id].times
				end
			end

			table = var_1_10007

			var_1_10007.insert(arg_8_0.weightData, {
	...
	if not arg_8_0.propDirectPool or #arg_8_0.propDirectPool == 0 then
		...
		local var_8_1 = var_1_10003.prop_random_direct

		math = iter_8_0

		local var_8_2 = iter_8_0.random
		local var_8_3 = 1

		TouchCakeGameConst = var_1_10007
		arg_8_0.propDirectPool = var_1(var_8_1[var_8_2(var_8_3, #var_1_10007.prop_random_direct)])
	end
	...
	local var_8_4 = var_1_10002.random(1, arg_8_0.weightTotal)
	local var_8_5
	...
	if var_8_5 and var_8_5 ~= 0 then
		Clone = var_4
		TouchCakeGameConst = var_6

		return var_4(var_6.prop_data[var_8_5]), var_1
	end
...
function var_0_0.touchBottomCake(arg_10_0, arg_10_1, arg_10_2)
	...
	var_3({
		function(arg_11_0)
			...
			TouchCakeGameConst = var_2_10002
			var_11_1.removeTimeTick = var_2_10002.remove_time
