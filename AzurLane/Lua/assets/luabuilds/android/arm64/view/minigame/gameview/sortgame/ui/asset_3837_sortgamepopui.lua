...
function var_0_0.initRankUI(arg_12_0)
	...
	local var_12_1 = var_4(arg_12_0.rankUI, "ad/close")
...
function var_0_0.setChildVisible(arg_15_0, arg_15_1, arg_15_2)
	for iter_15_0 = 1, arg_15_1.childCount do
		local var_15_0 = arg_15_1:GetChild(iter_15_0 - 1)

		setActive = var_1_10008

		var_1_10008(var_15_0, arg_15_2)
	end
...
function var_0_0.UpdateRankData(arg_21_0, arg_21_1)
	for iter_21_0 = 1, #arg_21_1 do
		...
		if #arg_21_0._rankItems < iter_21_0 then
			...
			local var_21_0 = var_7(var_1_10009(arg_21_0._rankItemTpl))
		...
		var_1_10009 = arg_21_0

		arg_21_0.SetRankItemData(var_1_10009, var_1_10006, arg_21_1[iter_21_0], iter_21_0)
...
function var_0_0.SetRankItemData(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	local var_22_5 = var_1_10009(var_1_10011)
	local var_22_6 = var_9.isSelf(var_22_5, var_22_1)

	setText = var_1_10010
	findTF = var_12

	var_1_10010(var_12(arg_22_1, "nameText"), var_22_0)
	...
	var_22_8(var_22_7, var_13(arg_22_1, "bg"), false)
	...
	var_22_10(var_22_9, var_13(arg_22_1, "rank"), false)
	...
	var_10(var_22_11, var_13(arg_22_3))
	...
	var_10(var_22_12, var_13(var_22_3))
...
function var_0_0.UpdateSettlementUI(arg_23_0)
	...
	local var_23_0 = var_1_10003(arg_23_0.settlementUI, "ad")

	typeof = var_1_10004
	Animator = var_6

	local var_23_1 = var_1_10001(var_23_0, var_1_10004(var_6))
	...
	if 0 < var_23_6 then
		getProxy = var_23_6
		GameRoomProxy = var_23_5
		var_23_5 = var_23_6(var_23_5)
		var_23_6 = var_23_6.getRoomScore

		local var_23_7 = arg_23_0._gameVo

		var_23_4 = var_23_6(var_23_5, var_7.GetConfig(var_23_7, "game_room"))

		goto label_23_1
	end

	getProxy = var_23_6
	MiniGameProxy = var_23_5
	var_23_5 = var_23_6(var_23_5)
	var_23_6 = var_23_6.GetHighScore

	local var_23_8 = arg_23_0._gameVo

	if var_23_6(var_23_5, var_7.GetGameId(var_23_8)) then
		local var_23_9 = #var_23_6

		if not (0 < var_23_9) or not var_23_6[1] then
			::label_23_0::
		...
		var_23_6(var_23_5(arg_23_0.settlementUI, "ad/new"), var_23_4 < var_23_3)
		...
		var_23_11(var_23_10, var_7.STORE_SERVER, {
			var_23_3,
			1
		})
		...
		local var_23_13 = var_23_9(arg_23_0.settlementUI, "ad/currentText")
		...
		SimpleMGEvent = var_10

		var_23_16(var_23_15, var_10.SUBMIT_GAME_SUCCESS, var_23_3)
...
function var_0_0.BackPressed(arg_24_0)
	...
	if var_1_10001(arg_24_0.pauseUI) then
		...
		var_24_1(var_24_0, var_1_10004.PAUSE_GAME, false)
	else
		isActive = var_24_1
		...
		if var_24_1(arg_24_0.leaveUI) then
			...
			var_24_3(var_24_2, var_1_10004.LEVEL_GAME, false)
		else
			isActive = var_24_3
			...
			if not var_24_3(arg_24_0.pauseUI) then
				...
				if not var_1(arg_24_0.pauseUI) then
					...
					if not var_1.IsSettlement(var_24_4) then
						...
						var_24_6(var_24_5, var_1_10004.PAUSE_GAME, true)
					end
...
function var_0_0.UpdateGameUI(arg_26_0, arg_26_1)
	...
	var_1_10002(var_26_0, var_5.ceil(arg_26_1.gameTime))
...
function var_0_0.ReadyStart(arg_27_0)
	...
	var_27_2(var_27_1, var_4.SFX_COUNT_DOWN)
