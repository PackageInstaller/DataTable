...
local var_0_1 = {
	...
	function()
		...
		function var_24_0.Trigger(arg_25_0, arg_25_1)
			...
			if arg_25_1.invincibleTime then
				...
				Color = var_2_10003
				var_25_2.color = var_2_10003.New(1, 1, 1, 0)
				setActive = var_25_2

				local var_25_3 = arg_25_0.rt

				var_25_2(var_4.Find(var_25_3, "GameObject/saiche_zhadan"), true)
	...
	function()
		...
		function var_30_0.Ctor(arg_31_0, arg_31_1, arg_31_2, arg_31_3)
			...
			typeof = var_7
			SpineAnimUI = var_2_10009
			arg_31_0.comSpineAnim = var_31_1(var_31_0, var_7(var_2_10009))
			...
			for iter_31_0, iter_31_1 in var_4({
				...
				var_2_10009(var_31_3, var_12.Find(var_31_4, "GameObject/" .. iter_31_1))
			end
		...
		function var_30_0.ActionCallback(arg_34_0)
			...
			var_2_10001(arg_34_0.action, {
				...
				yunxuan = function()
					...
					var_38_0(var_2.Find(var_38_1, "GameObject/saiche_xuanyun"), false)

					setActive = var_38_0

					local var_38_2 = arg_34_0.rt

					var_38_0(var_2.Find(var_38_2, "GameObject/saiche_jiansu"), false)
		...
		function var_30_0.Show(arg_39_0, ...)
			...
			var_1(arg_39_0.state, {
				...
				yunxuan = function()
					...
					var_43_0(var_2.Find(var_43_1, "GameObject/saiche_xuanyun"), true)

					setActive = var_43_0

					local var_43_2 = arg_39_0.rt

					var_43_0(var_2.Find(var_43_2, "GameObject/saiche_jiansu"), true)
		...
		function var_30_0.TriggerEffect(arg_44_0, arg_44_1)
			...
			var_2_10002(arg_44_1.__cname, {
				MoreTime = function()
					...
					RacingMiniGameConfig = var_3_10003

					var_45_1(var_45_0, var_3_10003.ITEM_ADD_TIME)
				...
				Invincibility = function()
					...
					var_46_0(var_2.Find(var_46_1, "invincibility"), true)
				...
				Mire = function()
					...
					local var_50_2 = var_3_10003.min
					local var_50_3 = arg_44_0.controller.enginePower

					RacingMiniGameConfig = var_3_10006

					var_50_1(var_50_0, var_50_2(var_50_3, var_3_10006.OBSTACLE_POWER_BLOCK))
				...
				SpeedBumps = function()
					...
					local var_51_2 = var_3_10003.min
					local var_51_3 = arg_44_0.controller.enginePower

					RacingMiniGameConfig = var_3_10006

					var_51_1(var_51_0, var_51_2(var_51_3, var_3_10006.OBSTACLE_POWER_BLOCK))
		...
		function var_30_0.UpdateInvincibility(arg_52_0, arg_52_1)
			...
			if arg_52_0.invincibleTime <= 0 then
				...
				var_2(var_4.Find(var_52_0, "invincibility"), false)
				...
				var_3(var_5.Find(var_52_2, "invincibility/saiche_wudihudun_xiaoshi"), var_52_1)

				setActive = var_3

				local var_52_3 = arg_52_0.rt

				var_3(var_5.Find(var_52_3, "invincibility/saiche_wudihudun"), not var_52_1)
			end
