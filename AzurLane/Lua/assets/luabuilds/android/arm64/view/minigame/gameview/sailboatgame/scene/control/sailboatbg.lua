...
function var_0_0.updateGrid(arg_5_0)
	for iter_5_0 = #arg_5_0._bgGrids, 1, -1 do
		var_1_10006 = arg_5_0._bgGrids[iter_5_0].w

		local var_5_0 = var_1_10005.h
		...
		if not (var_9.abs(var_1_10005.anchoredPos.x) > arg_5_0._removeBound.x) then
			...
			if not var_1_10005.stop then
				...
				if var_9.abs(var_1_10005.anchoredPos.x) < arg_5_0._sceneWidth then
					...
					if var_9.abs(var_1_10005.anchoredPos.y) < arg_5_0._sceneHeight and #arg_5_0:checkPrepareCreate(var_1_10005) > 0 then
						var_1_10012 = arg_5_0

						arg_5_0.createPrepareGrid(var_1_10012, var_9)
					end
				end
				...
				if var_1_10005.tf == nil then
					...
					local var_5_2 = var_1_10005.tf

					typeof = var_1_10012
					CanvasGroup = var_1_10014
					var_9(var_5_2, var_1_10012(var_1_10014)).alpha = 1
				end
	...
	for iter_5_1 = #arg_5_0._bgPrepareGrids, 1, -1 do
		...
		var_1_10006.insert(arg_5_0._bgGrids, var_1_10005)
	end
...
function var_0_0.checkPrepare(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	local var_8_3 = arg_8_0.getGrid(var_8_2, var_8_0, var_8_1)
	local var_8_4 = arg_8_0:getPrepareGrid(var_8_0, var_8_1)

	assert = var_8_2

	var_8_2(not var_8_3 or not var_8_4, "创建了两个相同位置的grid,请检查代码")

	if not var_8_3 and not var_8_4 then
		return {
			w = var_8_0,
			h = var_8_1
		}
...
function var_0_0.createPrepareGrid(arg_10_0, arg_10_1)
	for iter_10_0 = 1, #arg_10_1 do
		...
		var_1_10008.insert(arg_10_0._bgPrepareGrids, var_10_1)
	end
...
function var_0_0.removeGrid(arg_14_0, arg_14_1)
	if arg_14_1.tf then
		...
		local var_14_2 = var_1_10003(var_14_1, var_1_10006(var_1_10008))
...
function var_0_0.clear(arg_18_0)
	...
	for iter_18_0 = #arg_18_0._bgGrids, 1, -1 do
		...
		if var_1_10005.remove(arg_18_0._bgGrids, iter_18_0).tf then
			...
			var_1_10006 = var_1_10006(var_18_0, var_1_10009(var_1_10011))
			var_1_10006.alpha = 0
			table = var_1_10006

			var_1_10006.insert(arg_18_0._bgTfPool, var_1_10005.tf)
		end
	end
	...
	for iter_18_1 = #arg_18_0._bgPrepareGrids, 1, -1 do
		...
		local var_18_1 = var_1_10005.tf

		typeof = var_1_10009
		CanvasGroup = var_1_10011
		var_1_10006 = var_1_10006(var_18_1, var_1_10009(var_1_10011))
		var_1_10006.alpha = 0
		table = var_1_10006
