...
function var_0_0.start(arg_2_0)
	for iter_2_0 = #arg_2_0._effects, 1, -1 do
		...
		var_1_10006.insert(arg_2_0._effectPool, var_1_10005)
	end
...
function var_0_0.getEffect(arg_4_0, arg_4_1)
	if #arg_4_0._effectPool > 0 then
		for iter_4_0 = 1, #arg_4_0._effectPool do
			if #arg_4_0._effectPool[iter_4_0].name == arg_4_1 then
				...
				return (var_1_10006.remove(arg_4_0._effectPool, iter_4_0))
			end
		end
	end
	...
	local var_4_2 = var_1_10006(var_4_0, "img")

	typeof = var_1_10007
	DftAniEvent = var_9

	local var_4_3 = var_4(var_4_2, var_1_10007(var_9))
...
function var_0_0.createEffect(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	if arg_7_2 then
		var_1_10006 = var_7_0.tf
		var_1_10006.localScale = arg_7_2
	end

	if arg_7_3 then
		var_1_10006 = var_7_0.tf
		var_1_10006.anchoredPosition = arg_7_3
	end

	if arg_7_4 then
		SetParent = var_1_10006

		var_1_10006(var_7_0.tf, arg_7_4)
	else
		SetParent = var_1_10006

		var_1_10006(var_7_0.tf, arg_7_0._content)
	end

	setActive = var_1_10006

	var_1_10006(var_7_0.tf, true)

	table = var_1_10006

	var_1_10006.insert(arg_7_0._effects, var_7_0)
...
function var_0_0.effectEnd(arg_8_0, arg_8_1)
	for iter_8_0 = 1, #arg_8_0._effects do
		if arg_8_0._effects[iter_8_0] == arg_8_1 then
			...
			var_1_10007(var_8_0.tf, false)

			table = var_1_10007

			var_1_10007.insert(arg_8_0._effectPool, var_8_0)
