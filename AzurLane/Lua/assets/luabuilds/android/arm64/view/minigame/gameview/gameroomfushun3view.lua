...
local var_0_0 = "GameRoomFushun3View"
...
function var_0_1.initData(arg_23_0)
	...
	var_23_0(var_1_10003.night_type)
...
function var_0_1.initUI(arg_27_0)
	...
	local function var_27_29()
		...
		local var_37_3 = arg_27_0

		var_37_2.helps = var_4.getGameRoomData(var_37_3).game_help
	...
	local function var_27_32()
		...
		var_0.openCoinLayer(var_38_0, false)

		local var_38_1 = arg_27_0

		var_0.readyStart(var_38_1)
...
function var_0_1.clearUI(arg_50_0)
	...
	arg_50_0:openCoinLayer(false)

	setActive = var_1

	var_1(arg_50_0.gameUI, false)
...
function var_0_1.showSettlement(arg_67_0)
	...
	local var_67_2 = arg_67_0.scoreNum

	getProxy = var_67_0
	GameRoomProxy = var_5

	local var_67_3 = var_67_0(var_5)
	local var_67_4 = var_3.getRoomScore(var_67_3, arg_67_0:getGameRoomData().id)

	setActive = var_67_1
	findTF = var_6

	var_67_1(var_6(arg_67_0.settlementUI, "ad/new"), var_67_4 < var_67_2)

	if var_67_4 <= var_67_2 then
		var_67_4 = var_67_2
	...
	local var_67_5 = var_67_1(arg_67_0.settlementUI, "ad/highText")

	findTF = var_67_3

	local var_67_6 = var_67_3(arg_67_0.settlementUI, "ad/currentText")

	setText = var_6

	var_6(var_67_5, var_67_4)

	setText = var_6

	var_6(var_67_6, var_67_2)
	arg_67_0:SendSuccess(var_67_2 or 0)
