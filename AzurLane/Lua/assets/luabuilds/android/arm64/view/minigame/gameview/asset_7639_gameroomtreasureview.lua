...
function var_0_1.initUI(arg_70_0)
	...
	local var_70_17 = var_4(arg_70_0.menuUI, "btnBack")
	...
	var_1(var_70_16, var_70_17, var_70_18, var_6)
	...
	var_1(var_70_19, var_70_20, var_70_21, var_6)
	...
	local function var_70_24()
		...
		var_79_2.type = var_2_10004

		local var_79_3 = arg_70_0

		var_79_2.helps = var_4.getGameRoomData(var_79_3).game_help
	...
	var_1(var_70_22, var_70_23, var_70_24, var_6)
...
function var_0_1.initGameUI(arg_80_0)
	...
	var_1(var_80_0, var_4(arg_80_0.gameUI, "topRight/btnStop"), function()
	...
	var_1(var_80_1, var_4(arg_80_0.gameUI, "btnLeave"), function()
...
function var_0_1.openMenuUI(arg_87_0)
	...
	var_1_10001(var_1_10003(arg_87_0._tf, "scene_container"), false)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_87_0.bgTf, "on"), true)
...
function var_0_1.gameStart(arg_93_0)
	...
	var_1_10001(var_1_10003(arg_93_0._tf, "scene_container"), true)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_93_0.bgTf, "on"), false)
...
function var_0_1.transformColor(arg_94_0, arg_94_1)
	...
	local var_94_0 = var_1_10002(var_1_10004.sub(arg_94_1, 1, 2), 16)

	tonumber = var_1_10003
	string = var_5

	local var_94_1 = var_1_10003(var_5.sub(arg_94_1, 3, 4), 16)

	tonumber = var_4
	string = var_6

	local var_94_2 = var_4(var_6.sub(arg_94_1, 5, 6), 16)
...
function var_0_1.addScore(arg_95_0, arg_95_1, arg_95_2)
	...
	local var_95_4 = var_1_10004(var_95_3, var_1_10007(var_1_10009))
	...
	if arg_95_1 then
		...
		for iter_95_0 = 1, #var_0_48 do
			if arg_95_1 and arg_95_1 >= var_0_48[iter_95_0].score then
				...
				var_95_3 = var_0_48[iter_95_0].font

				break
			end
		end

		local var_95_6 = arg_95_0:transformColor(var_95_5)

		arg_95_0.scoreNum = arg_95_0.scoreNum + arg_95_1

		local var_95_7 = arg_95_1 >= 0 and "+" or ""

		setText = var_8

		var_8(var_95_2, var_95_7 .. arg_95_1)

		var_95_4.fontSize = var_95_3 or 40
		setTextColor = var_8

		var_8(var_95_2, var_95_6)
	elseif arg_95_2 then
		local var_95_8 = arg_95_0:transformColor("66f2fb")

		var_95_4.fontSize = 40
		setTextColor = var_95_3

		var_95_3(var_95_2, var_95_8)

		var_95_3 = arg_95_0.gameTime

		if 0 < var_95_3 then
			arg_95_0.gameTime = arg_95_0.gameTime + arg_95_2
		end

		var_95_3 = 0 < arg_95_2 and "+" or ""
		setText = var_7

		var_7(var_95_2, var_95_3 .. arg_95_2 .. "s")
	end

	setActive = var_95_3

	var_95_3(arg_95_0.sceneScoreTf, true)
...
function var_0_1.updateGameUI(arg_100_0)
	...
	var_1_10001(var_100_0, var_4.ceil(arg_100_0.gameTime))
...
function var_0_1.onGameOver(arg_101_0)
	...
	var_101_1(var_101_2, var_101_3, var_5.Action(function()
...
function var_0_1.showSettlement(arg_103_0)
	...
	local var_103_0 = var_3(arg_103_0.settlementUI, "ad")

	typeof = var_4
	Animator = var_6

	local var_103_1 = var_1_10001(var_103_0, var_4(var_6))
	...
	if var_103_3 then
		...
		var_5(var_7(arg_103_0.settlementUI, "ad/new"), var_103_6 < var_103_4)
...
function var_0_1.willExit(arg_107_0)
	if arg_107_0.handle then
		...
		var_1.RemoveListener(var_1_10003, arg_107_0.handle)
	end
	...
	if arg_107_0._tf then
		...
		if var_107_0(var_1_10003(arg_107_0._tf)) then
			LeanTween = var_1
