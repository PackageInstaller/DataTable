...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.countAnimator = var_3_3(var_3_2, var_4(var_1_10006))
	...
	arg_3_0.countDft = var_3_6(var_3_5, var_4(var_1_10006))
	...
	local var_3_11 = var_3.Find(var_3_10, "box/content")

	i18n = var_4

	var_1(var_3_11, var_4("idolmaster_game_tip1"))
	...
	local var_3_16 = var_3.Find(var_3_15, "box/content")

	i18n = var_4

	var_1(var_3_16, var_4("idolmaster_game_tip2"))
	...
	local var_3_20 = var_3.Find(var_3_19, "box/cur_score")

	i18n = var_4

	var_1(var_3_20, var_4("idolmaster_game_tip3"))
	...
	local var_3_24 = var_3.Find(var_3_23, "box/highest_score")

	i18n = var_4

	var_1(var_3_24, var_4("idolmaster_game_tip4"))
	...
	local var_3_33 = var_3.Find(var_3_32, "top/title/score_title")

	i18n = var_4

	var_1(var_3_33, var_4("idolmaster_game_tip5"))
	...
	typeof = var_4
	Animator = var_6
	arg_3_0.manjuuAnimator = var_3_38(var_3_37, var_4(var_6))
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_3_0.manjuuDft = var_3_40(var_3_39, var_4(var_6))
	...
	typeof = var_4
	Animator = var_6
	arg_3_0.resultAnimator = var_3_43(var_3_42, var_4(var_6))
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_3_0.resultDft = var_3_45(var_3_44, var_4(var_6))
...
function var_0_1.didEnter(arg_5_0)
	...
	var_1_10001(arg_5_0.cupContainer, function(arg_12_0)
		...
		local function var_12_2()
			...
			var_0(var_2.Find(var_13_0, "select"), true)
...
function var_0_1.initGameData(arg_14_0)
	...
	var_3(arg_14_0.cupContainer, function(arg_15_0)
		...
		var_2_10001("ui/minigameui/guessforkgameui", var_14_1, function(arg_16_0)
			...
			var_3_10001(var_3.Find(var_16_0, "front"), arg_16_0, true)
	...
	math = var_3
	arg_14_0.forkIndex = var_3.random(var_0_16)
...
function var_0_1.playForkAni(arg_19_0, arg_19_1)
	...
	var_1_10003(arg_19_0.fork, var_19_1:Find("fork_node"), false)

	setLocalScale = var_1_10003

	local var_19_2 = arg_19_0.fork

	Vector3 = var_6

	var_1_10003(var_19_2, var_6.one)
	...
	var_1_10003(var_19_3, var_6(0, 50, 0))

	setActive = var_1_10003

	var_1_10003(arg_19_0.fork, true)
	...
	var_19_5(var_19_4, var_6.delayedCall, function()
		local var_20_0 = arg_19_0
		local var_20_1 = var_0.managedTween

		LeanTween = var_2_10003

		local var_20_2 = var_20_1(var_20_0, var_2_10003.moveY, function()
		...
		var_20_3(var_20_2, var_3.linear)
...
function var_0_1.startSwap(arg_22_0, arg_22_1)
	if arg_22_1 < 1 then
		...
		arg_22_0.startTimer(var_1_10004)
	...
	var_1_10004.remove(var_22_0, var_22_1)
...
function var_0_1.swapCup(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	local var_24_7 = var_24_6(var_24_5, var_1_10012.moveX, nil, arg_24_1, var_24_2.x, var_24_4)
	local var_24_8 = var_9.setEase

	LeanTweenType = var_12

	var_24_8(var_24_7, var_12.linear)
	...
	local var_24_11 = var_24_10(var_24_9, var_12.moveX, function()
		if arg_24_3 then
			arg_24_3()
		end
	...
	var_24_12(var_24_11, var_12.linear)
...
function var_0_1.playManjuuAni(arg_32_0, arg_32_1)
	...
	var_5.SetEndEvent(var_32_3, function()
		...
		var_2_10001(var_3.Find(var_33_2, "select"), false)
...
function var_0_1.playResultAni(arg_34_0, arg_34_1)
	...
	var_1_10003(arg_34_0.result, var_34_1:Find("result_node"), false)
	...
	var_1_10003(var_34_2, var_6.one)
	...
	var_1_10003(var_34_3, var_6.zero)

	setActive = var_1_10003

	var_1_10003(arg_34_0.result, true)

	if arg_34_1 then
		pg = var_1_10003

		local var_34_4 = var_1_10003.CriMgr.GetInstance()

		var_1_10003.PlaySoundEffect_V3(var_34_4, var_0_12)

		local var_34_5 = arg_34_0.resultAnimator

		var_1_10003.Play(var_34_5, var_0_22)

		local var_34_6 = arg_34_0.resultDft

		var_1_10003.SetEndEvent(var_34_6, function()
		...
		local var_34_7 = var_1_10003.CriMgr.GetInstance()
		...
		local var_34_9 = var_34_8[var_34_0.random(#var_0_23)]
...
function var_0_1.showCorrectBar(arg_37_0)
	...
	var_37_3(var_37_2, var_5.Action(function()
		setActive = var_2_10000
	...
	local var_37_8 = var_37_7(var_7(arg_37_0.curScoreTxt), arg_37_0.curScore, var_37_6, var_37_4)
	local var_37_9 = var_5.setOnUpdate

	System = var_8

	local var_37_10 = var_37_9(var_37_8, var_8.Action_float(function(arg_39_0)
		setText = var_2_10001
		...
		var_2_10001(var_39_0, var_2_10004.ceil(arg_39_0))
	...
	var_37_11(var_37_10, var_8.Action(function()
	...
	local var_37_15 = var_37_14(var_37_13, var_8.Action_float(function(arg_41_0)
		setText = var_2_10001
		...
		var_2_10001(var_41_0, var_2_10004.ceil(arg_41_0))
	...
	var_37_16(var_37_15, var_8.Action(function()
	...
	var_37_16(var_37_17, var_37_18, var_37_19, var_10)
...
function var_0_1.playTimeOutAni(arg_45_0)
	...
	var_1_10002(arg_45_0.result, var_45_1:Find("result_node"), false)
	...
	var_1_10002(var_45_2, var_5.one)
	...
	var_1_10002(var_45_3, var_5.zero)

	setActive = var_1_10002

	var_1_10002(arg_45_0.result, true)
...
function var_0_1.endGame(arg_47_0)
	...
	var_1_10001(var_47_0, var_47_1, var_47_2, var_1_10006)
...
function var_0_1.enterResultUI(arg_50_0)
	...
	if var_1.GetRuntimeData(var_50_0, "elements") then
		...
		var_50_0(arg_50_0.newTag, var_50_2 < arg_50_0.curScore)
...
function var_0_1.OnGetAwardDone(arg_51_0, arg_51_1)
	...
	if var_51_0 == var_1_10003.CMD_COMPLETE and arg_51_0:GetMGHubData().ultimate == 0 then
		...
		if var_51_1 >= var_2.getConfig(var_51_2, "reward_need") then
			...
			var_51_6.cmd = var_8.CMD_ULTIMATE
			var_51_6.args1 = {}
