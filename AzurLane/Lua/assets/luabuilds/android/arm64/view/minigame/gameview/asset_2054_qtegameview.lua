...
function var_0_1.init(arg_2_0)
	...
	local var_2_54 = var_1.UIMgr.GetInstance()

	var_1.OverlayPanel(var_2_54, arg_2_0.keyBar, {
		pbList = {
			arg_2_0.keyBar
		}
	})

	local var_2_55 = arg_2_0.keyUI

	arg_2_0.roundTxt = var_1.Find(var_2_55, "round_time_bar/txt")

	local var_2_56 = arg_2_0._tf

	arg_2_0.firePos = var_1.Find(var_2_56, "content/pos/fire_pos").anchoredPosition

	local var_2_57 = arg_2_0._tf

	arg_2_0.hitPos = var_1.Find(var_2_57, "content/pos/hit_pos").anchoredPosition

	local var_2_58 = arg_2_0._tf

	arg_2_0.aPos = var_1.Find(var_2_58, "content/pos/a_pos").anchoredPosition

	local var_2_59 = arg_2_0._tf

	arg_2_0.bPos = var_1.Find(var_2_59, "content/pos/b_pos").anchoredPosition

	local var_2_60 = arg_2_0._tf

	arg_2_0.cPos = var_1.Find(var_2_60, "content/pos/c_pos").anchoredPosition

	local var_2_61 = arg_2_0._tf

	arg_2_0.missPos = var_1.Find(var_2_61, "content/pos/miss_pos").anchoredPosition

	local var_2_62 = arg_2_0.content

	arg_2_0.backBtn = var_1.Find(var_2_62, "back_btn")
	AutoLoader = var_1
	arg_2_0.autoLoader = var_1.New()

	local var_2_63 = arg_2_0.autoLoader

	var_1.LoadSprite(var_2_63, "ui/minigameui/qtegameuiasync_atlas", "background", arg_2_0.gameBg, false)
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_2()
		...
		var_0.setGameState(var_8_0, arg_7_0.STATE_BEGIN)
	...
	var_1(arg_7_0, arg_7_0.ruleBtn, function()
		...
		pg = var_2_10004
		var_10_2.helps = var_2_10004.gametip.qte_game_help.tip
	...
	var_1.SetEndEvent(var_7_12, function()
		...
		if var_0.GetMGHubData(var_17_0).count > 0 then
			local var_17_1 = arg_7_0

			var_0.SendSuccess(var_17_1, 0)
		end
...
function var_0_1.fireBlocks(arg_31_0)
	...
	var_31_7(var_31_6, var_11.delayedCall, function()
		...
		var_0.setGuinuAction(var_36_0, "action")
...
function var_0_1.loadXGM(arg_50_0, arg_50_1)
	if arg_50_0.xgm then
		...
		var_2.LoadPrefab(var_50_0, "ui/minigameui/qtegameuiasync_atlas", "xiongguimao", function(arg_51_0)
...
function var_0_1.willExit(arg_86_0)
	...
	local var_86_1 = var_1.UIMgr.GetInstance()

	var_1.UnOverlayPanel(var_86_1, arg_86_0.keyBar, arg_86_0.content)
	...
	local var_86_2 = arg_86_0.autoLoader

	var_1.Clear(var_86_2)
