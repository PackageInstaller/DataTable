...
function var_0_1.initUI(arg_7_0)
	...
	local var_7_4 = var_3.Find(var_7_3, "right_panel/item_list/content")

	typeof = var_4
	ScrollRect = var_6
	arg_7_0.listScrollRect = var_1(var_7_4, var_4(var_6))
	onButton = var_1

	local var_7_5 = arg_7_0
	local var_7_6 = arg_7_0.mainUI
	local var_7_7 = var_4.Find(var_7_6, "btn_back")
	...
	var_1(var_7_5, var_7_7, var_7_8, var_7_6)

	onButton = var_1

	local var_7_9 = arg_7_0
	local var_7_10 = arg_7_0.mainUI
	local var_7_11 = var_4.Find(var_7_10, "bg/btn_help")
	...
	local function var_7_12()
		...
		pg = var_2_10004
		var_9_2.helps = var_2_10004.gametip.icecreamgame_tip.tip
	...
	var_1(var_7_9, var_7_11, var_7_12, var_7_10)

	onButton = var_1

	local var_7_13 = arg_7_0
	local var_7_14 = arg_7_0.mainUI
	local var_7_15 = var_4.Find(var_7_14, "bg/btn_start")
	...
	var_1(var_7_13, var_7_15, var_7_16, var_7_14)

	arg_7_0.totalTimes = arg_7_0:getGameTotalTime()

	local var_7_17 = arg_7_0:getGameUsedTimes() - 4 < 0 and 0 or arg_7_0:getGameUsedTimes() - 4

	scrollTo = var_2

	var_2(arg_7_0.listScrollRect, 0, 1 - var_7_17 / (arg_7_0.totalTimes - 4))

	onButton = var_2

	local var_7_18 = arg_7_0
	local var_7_19 = arg_7_0.mainUI
	local var_7_20 = var_5.Find(var_7_19, "right_panel/arrows_up")
	...
	var_2(var_7_18, var_7_20, var_7_21, var_7_19)

	onButton = var_2

	local var_7_22 = arg_7_0
	local var_7_23 = arg_7_0.mainUI
	local var_7_24 = var_5.Find(var_7_23, "right_panel/arrows_down")
	...
	var_2(var_7_22, var_7_24, var_7_25, var_7_23)

	pg = var_2

	local var_7_26 = var_2.mini_game[arg_7_0:GetMGData().id].simple_config_data.drop_ids
	local var_7_27 = arg_7_0.mainUI
	local var_7_28 = var_3.Find(var_7_27, "right_panel/item_list/content")

	UIItemList = var_7_22
	arg_7_0.itemList = var_7_22.New(var_7_28, var_7_28:GetChild(0))

	local var_7_29 = arg_7_0.itemList

	var_4.make(var_7_29, function(arg_13_0, arg_13_1, arg_13_2)
		arg_13_1 = arg_13_1 + 1
		...
		if arg_13_0 == var_2_10003.EventUpdate then
			...
			local var_13_1 = arg_13_2.Find(var_13_0, "IconTpl")
			local var_13_2 = {}

			unpack = var_13_0

			local var_13_3, var_13_4, var_13_5 = var_13_0(var_7_26[arg_13_1])

			var_13_2.count = var_13_5
			var_13_2.id = var_13_4
			var_13_2.type = var_13_3
			updateDrop = var_13_3

			var_13_3(var_13_1, var_13_2)

			onButton = var_13_3

			local var_13_6 = arg_7_0
			...
			var_13_3(var_13_6, var_13_7, var_13_8, var_10)
		end
	...
	var_4.align(var_7_30, #var_7_26)

	local var_7_31 = arg_7_0._tf

	arg_7_0.countUI = var_4.Find(var_7_31, "ui/count_ui")
	GetComponent = var_4

	local var_7_32 = arg_7_0.countUI
	local var_7_33 = var_6.Find(var_7_32, "count")

	typeof = var_7
	Animator = var_9
	arg_7_0.countAnimator = var_4(var_7_33, var_7(var_9))
	GetOrAddComponent = var_4

	local var_7_34 = arg_7_0.countUI
	local var_7_35 = var_6.Find(var_7_34, "count")

	typeof = var_7
	DftAniEvent = var_9
	arg_7_0.countDft = var_4(var_7_35, var_7(var_9))

	local var_7_36 = arg_7_0.countDft

	var_4.SetTriggerEvent(var_7_36, function()
		return
	end)

	local var_7_37 = arg_7_0.countDft

	var_4.SetEndEvent(var_7_37, function()
	...
	local var_7_38 = arg_7_0._tf

	arg_7_0.pauseUI = var_4.Find(var_7_38, "ui/pause_ui")
	onButton = var_4

	local var_7_39 = arg_7_0
	local var_7_40 = arg_7_0.pauseUI
	local var_7_41 = var_7.Find(var_7_40, "panel/btn_confirm")
	...
	local function var_7_42()
		...
		var_17_1(var_17_0, var_17_2, var_4.Find(var_17_3, "ui"))
	...
	var_4(var_7_39, var_7_41, var_7_42, var_7_40)

	local var_7_43 = arg_7_0._tf

	arg_7_0.returnUI = var_4.Find(var_7_43, "ui/return_ui")
	onButton = var_4

	local var_7_44 = arg_7_0
	local var_7_45 = arg_7_0.returnUI
	local var_7_46 = var_7.Find(var_7_45, "panel/btn_confirm")
	...
	local function var_7_47()
		...
		var_18_1(var_18_0, var_18_2, var_4.Find(var_18_3, "ui"))
	...
	var_4(var_7_44, var_7_46, var_7_47, var_7_45)

	onButton = var_4

	local var_7_48 = arg_7_0
	local var_7_49 = arg_7_0.returnUI
	local var_7_50 = var_7.Find(var_7_49, "panel/btn_cancel")
	...
	local function var_7_51()
		...
		var_19_1(var_19_0, var_19_2, var_4.Find(var_19_3, "ui"))
	...
	var_4(var_7_48, var_7_50, var_7_51, var_7_49)

	local var_7_52 = arg_7_0._tf

	arg_7_0.endUI = var_4.Find(var_7_52, "ui/end_ui")
	onButton = var_4

	local var_7_53 = arg_7_0
	local var_7_54 = arg_7_0.endUI
	local var_7_55 = var_7.Find(var_7_54, "panel/btn_finish")
	...
	local function var_7_56()
		...
		var_20_1(var_20_0, var_20_2, var_4.Find(var_20_3, "ui"))
	...
	var_4(var_7_53, var_7_55, var_7_56, var_7_54)
...
function var_0_1.initGameUI(arg_22_0)
	...
	var_1(var_22_4, var_4.Find(var_22_5, "Button/btn_pause"), function()
	...
	var_1(var_22_6, var_4.Find(var_22_7, "Button/btn_back"), function()
	...
	for iter_22_0 = 1, 4 do
		...
		var_5(var_22_12, var_8.Find(var_22_13, "L" .. iter_22_0), function()
		...
		var_5(var_22_14, var_8.Find(var_22_15, "R" .. iter_22_0), function()
	...
	arg_22_0:bind(var_0_3, function(arg_28_0, arg_28_1, ...)
		...
		var_2_10002(var_4.Find(var_28_0, arg_28_1), ...)
...
function var_0_1.updateMainUI(arg_30_0)
	...
	for iter_30_0 = 1, var_30_2 do
		...
		local var_30_4 = var_3:GetChild(iter_30_0 - 1)

		setActive = var_1_10011

		var_1_10011(var_30_4:Find("finish"), var_30_3.finish)

		setActive = var_1_10011

		var_1_10011(var_30_4:Find("lock"), var_30_3.lock)

		setActive = var_1_10011

		var_1_10011(var_30_4:Find("IconTpl"), var_30_3.award)
	end
	...
	var_7(arg_30_0.listScrollRect, 0, var_30_5)
	arg_30_0:checkGet()
...
function var_0_1.checkGet(arg_31_0)
	if arg_31_0:getUltimate() == 0 then
		...
		if arg_31_0.getGameTotalTime(var_31_0) > arg_31_0:getGameUsedTimes() then
			return
		end

		pg = var_31_0

		local var_31_1 = var_31_0.m02
		local var_31_2 = var_3.sendNotification

		GAME = var_1_10006

		local var_31_3 = var_1_10006.SEND_MINI_GAME_OP
		local var_31_4 = {
			hubid = arg_31_0:GetMGHubData().id
		}

		MiniGameOPCommand = var_8
		var_31_4.cmd = var_8.CMD_ULTIMATE
		var_31_4.args1 = {}
...
function var_0_1.resetGame(arg_34_0)
	...
	var_1(var_3.Find(var_34_0, "Character"), function(arg_35_0)
		table = var_2_10001
	...
	var_1(var_3.Find(var_34_1, "BulletTimeMask"), false)
...
local function var_0_19(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	...
	local function var_36_1(arg_37_0, arg_37_1)
		...
		for iter_37_0 = var_2_10002.max(#arg_37_1[1], 2), 1, -1 do
			...
			if arg_37_1[1][iter_37_0] then
				var_2_10006 = arg_37_0:Find(iter_37_0)
				GetImageSpriteFromAtlasAsync = var_2_10007

				var_2_10007("ui/minigameui/icecreamgameui_atlas", "Assets/ArtResource/UI/MiniGameUI/IceCreamGameUI/ICE_S/" .. var_0_15[arg_37_1[1][iter_37_0]] .. ".png", var_2_10006:Find("Scoop"), true)

				var_2_10007 = arg_37_1[2][var_0_13[#arg_37_1[1]][iter_37_0]]
				setActive = var_8

				var_8(var_2_10006:Find("Topping"), var_2_10007)

				if var_2_10007 then
					GetImageSpriteFromAtlasAsync = var_8

					var_8("ui/minigameui/icecreamgameui_atlas", "Assets/ArtResource/UI/MiniGameUI/IceCreamGameUI/ICE_S/" .. var_0_16[var_2_10007] .. ".png", var_2_10006:Find("Topping"), true)
				end
			end
		end
	...
	function var_36_0.Ctor(arg_38_0)
		...
		for iter_38_0, iter_38_1 in var_2({
			...
			var_2_10007(var_9.Find(var_38_1, iter_38_1), function(arg_39_0)
				setActive = var_3_10001
		...
		var_38_2(var_4.Find(var_38_3, "Bubble/" .. var_38_0), arg_36_2)
		...
		var_38_2(var_38_4, var_38_5, var_6.Find(var_38_6, "Bubble"), true)

		setActive = var_38_2

		local var_38_7 = arg_36_0

		var_38_2(var_4.Find(var_38_7, "Bubble/Boost"), false)
		...
		typeof = var_5
		Animator = var_7
		arg_38_0.animator = var_38_2(var_38_8, var_5(var_7))
		...
		local var_38_11 = var_38_10(var_38_9, var_5(var_7))
	...
	function var_36_0.Result(arg_41_0, arg_41_1, arg_41_2)
		...
		elseif arg_41_1 == 1 then
			...
			var_41_2(var_6.Find(var_41_3, "IceCream/" .. var_41_0), arg_41_2)
			...
			if 2 <= arg_41_1 then
				...
				var_41_5(var_6.Find(var_41_6, "IceCream/" .. var_41_0), arg_41_2)
...
function var_0_1.CreateTarget(arg_42_0, arg_42_1)
	...
	local var_42_2 = var_42_0(var_42_1, var_1_10005.random(#arg_42_0.targetNameList))

	cloneTplTo = var_1_10003

	local var_42_3 = arg_42_0.rtResource
	local var_42_4 = var_1_10003(var_5.Find(var_42_3, "Character/" .. var_42_2), arg_42_0.rtWalk, var_42_2)
	...
	for iter_42_0 = var_42_6[var_6.random(#var_42_6)], 1, -1 do
		...
		local var_42_7 = var_42_5[1]

		math = var_1_10013

		var_1_10010(var_42_7, var_1_10013.random(4))
	end
	...
	for iter_42_1 = var_7.max(1, #var_42_5[1] - 1), 1, -1 do
		...
		local var_42_9 = var_42_5[2]

		table = var_1_10014
		var_1_10014 = var_1_10014.remove

		local var_42_10 = var_42_8

		math = var_1_10017

		var_1_10011(var_42_9, var_1_10014(var_42_10, var_1_10017.random(#var_42_8)))
	end

	math = var_7

	local var_42_11 = var_7.clamp
	local var_42_12 = var_0_6[#var_42_5[1]][2] - arg_42_0.countList[#var_42_5[1]]

	unpack = var_10

	local var_42_13 = var_42_11(var_42_12, var_10(var_0_6[#var_42_5[1]]))
	local var_42_14 = arg_42_0.countList

	var_42_14[#var_42_5[1]] = arg_42_0.countList[#var_42_5[1]] + 1
	table = var_42_14

	var_42_14.insert(arg_42_0.targetList, var_0_19(var_42_4, arg_42_0, var_42_5, var_42_13))
...
function var_0_1.ResultTarget(arg_44_0, arg_44_1, arg_44_2, ...)
	...
	if arg_44_0.effectTrigger.bullet_time.doingTime > 0 then
		...
		var_4(var_6.Find(var_44_1, "BulletTimeMask"), false)
	end
...
function var_0_1.TriggerSpecialEffect(arg_46_0, arg_46_1, arg_46_2)
	if arg_46_1 == 3 then
		...
		elseif var_6[var_7] == "count" then
			...
			var_8(var_10.Find(var_46_2, "Bubble/Boost"), true)
	...
	local var_47_0 = {
		...
		Result = function(arg_50_0, arg_50_1)
			...
			local function var_50_2(arg_51_0, arg_51_1, arg_51_2)
				...
				return var_51_1 - var_3_10005.abs(var_51_0)
			end
			...
			local var_50_5 = var_50_4(var_50_3, iter_50_0(var_2_10010))
		...
		Reset = function(arg_53_0)
			...
			var_1.SetTriggerEvent(var_53_3, function()
				for iter_56_0 = arg_53_0._tf.name == "Cone" and 2 or 3, 1, -1 do
					...
					var_3_10004(var_6.Find(var_56_0, iter_56_0), false)
				end
				...
				var_0(var_2.Find(var_56_1, "Back"), false)
				...
				if arg_53_0._tf.name == "Bowl" then
					...
					var_0(var_2.Find(var_56_2, "Front"), false)
				end
			...
			var_1(var_3.Find(var_53_4, "Back"), true)
			...
			if arg_53_0._tf.name == "Bowl" then
				...
				var_1(var_3.Find(var_53_5, "Front"), true)
			end
			...
			for iter_53_0 = arg_53_0._tf.name == "Cone" and 2 or 3, 1, -1 do
				...
				var_6(var_53_7, iter_53_0 <= #arg_47_2[1])
				...
				if iter_53_0 <= #arg_47_2[1] then
					...
					var_6.SetEndEvent(var_53_9, function()
						...
						if arg_53_0.successLeftLight then
							...
							var_58_0(var_2.Find(var_58_1, "Good"), {
								x = 0,
								y = -10
							})
							...
							var_58_0(var_2.Find(var_58_2, "Good"), false)

							setActive = var_58_0

							local var_58_3 = var_53_7

							var_58_0(var_2.Find(var_58_3, "Good"), true)
						end
					...
					var_6.SetEndEvent(var_53_11, function()
						...
						if arg_53_0.successRightLight then
							...
							var_59_0(var_2.Find(var_59_1, "Good"), {
								x = 10,
								y = 6
							})
							...
							var_59_0(var_2.Find(var_59_2, "Good"), false)

							setActive = var_59_0

							local var_59_3 = var_53_7

							var_59_0(var_2.Find(var_59_3, "Good"), true)
						end
		...
		ReadyBall = function(arg_60_0)
			...
			var_2_10002(var_60_1:Find("Scoop_Next"), true)
		...
		MakeBall = function(arg_61_0, arg_61_1)
			...
			var_2_10003(var_61_1:Find("Scoop_Next"), false)

			setActive = var_2_10003

			var_2_10003(var_61_1:Find("Scoop"), true)
			...
			local var_61_4 = var_61_3(var_61_2, var_6(var_8))
		...
		ReadyTopping = function(arg_62_0)
			...
			var_2_10002(var_62_1:Find("Topping_Next"), true)
		...
		MakeTopping = function(arg_63_0, arg_63_1)
			...
			var_2_10003(var_63_1:Find("Topping_Next"), false)

			setActive = var_2_10003

			var_2_10003(var_63_1:Find("Topping"), true)
			...
			local var_63_4 = var_63_3(var_63_2, var_6(var_8))
		...
		MakeMissTopping = function(arg_64_0, arg_64_1)
			...
			var_3(var_64_1:Find("Topping_Next"), false)

			setActive = var_3

			var_3(var_64_1:Find("Topping"), true)
			...
			local var_64_4 = var_64_3(var_64_2, var_6(var_8))
		...
		FailMissTopping = function(arg_65_0)
			...
			var_2_10003(var_65_2:Find("Topping_Next"), false)

			setActive = var_2_10003

			var_2_10003(var_65_2:Find("Topping"), true)
			...
			local var_65_5 = var_65_4(var_65_3, var_6(var_8))
		...
		SafeMissTopping = function(arg_66_0)
			...
			var_2_10003(var_66_2:Find("Topping_Next"), false)

			setActive = var_2_10003

			var_2_10003(var_66_2:Find("Topping"), true)
			...
			local var_66_5 = var_66_4(var_66_3, var_6(var_8))
...
function var_0_1.DoIceCream(arg_67_0)
	...
	if var_1.timeBoost then
		...
		var_5(var_7.Find(var_67_4, "BulletTimeMask"), true)
	end
	...
	for iter_70_0, iter_70_1 in var_70_1(arg_70_0.poolBG) do
		...
		for iter_70_2 = iter_70_0 == "GroupC/Manjuu" and 2 or 1, 1, -1 do
			if iter_70_0 == "GroupD" then
				...
				local var_70_3 = iter_70_1

				math = var_1_10014
				var_70_2[iter_70_3(var_70_3, var_1_10014.random(#iter_70_1))] = true
			end
		end

		local var_70_4 = arg_70_0.gameUI

		for iter_70_3 = var_7.Find(var_70_4, "BG/" .. iter_70_0).childCount, 1, -1 do
...
function var_0_1.onTimer(arg_72_0)
	if arg_72_0.effectTrigger.bullet_time.doingTime > 0 then
		...
		if var_1.doingTime <= 0 then
			...
			var_2(var_4.Find(var_72_0, "BulletTimeMask"), false)
		end
...
function var_0_1.updateWalker(arg_73_0)
	for iter_73_0 = #arg_73_0.targetList, 1, -1 do
		...
		var_1_10009 = var_73_1(var_73_0, var_1_10009(var_1_10011))

		local var_73_2 = var_6.GetCurrentAnimatorStateInfo(var_1_10009, 0)
		...
		if var_5.result then
			if var_5.isLeave then
				...
				local var_73_3 = var_5._tf.anchoredPosition.x

				if var_0_8[1] < var_73_3 then
					arg_73_0:RemoveTarget()
				end
			end
		else
			local var_73_4 = var_0_8[3]

			if 1 < iter_73_0 then
				math = var_1_10009
				var_73_4 = var_1_10009.min(var_73_4, arg_73_0.targetList[iter_73_0 - 1]._tf.anchoredPosition.x)
			end

			if var_73_4 - var_5._tf.anchoredPosition.x < var_0_8[3] then
				if not var_5.state or var_5.state ~= "Stand" then
					var_5.state = "Stand"
					var_1_10011 = var_6

					var_6.Play(var_1_10011, "Stand")
				end
			elseif var_8 < var_0_8[2] then
...
function var_0_1.setAnimatorSpeed(arg_74_0, arg_74_1, arg_74_2)
	...
	local var_74_2 = var_74_1(var_74_0, var_1_10006(var_1_10008), true)
	local var_74_3 = var_3.ToTable(var_74_2)

	ipairs = var_1_10004

	for iter_74_0, iter_74_1 in var_1_10004(var_74_3) do
...
function var_0_1.addScore(arg_77_0, arg_77_1, arg_77_2)
	...
	if arg_77_2 == 0 then
		...
		var_1_10004(var_77_2, var_7.NewHex("ED666DFF"))
	elseif arg_77_2 == 1 then
		...
		var_1_10004(var_77_3, var_7.NewHex("FAB149FF"))
	elseif arg_77_2 == 2 then
		...
		var_1_10004(var_77_4, var_7.NewHex("C6CC15FF"))
	elseif arg_77_2 == 3 then
		...
		var_1_10004(var_77_5, var_7.NewHex("80BF1CFF"))
	else
		assert = var_1_10004
...
function var_0_1.endGame(arg_80_0)
	...
	var_80_1(var_80_0, var_4.delayedCall, function()
...
function var_0_1.showEndUI(arg_82_0)
	...
	if var_82_2 then
		...
		var_4(var_6.Find(var_82_6, "panel/now/Text/new"), var_82_5 < var_82_3)
		...
		var_82_7(var_82_8, var_82_5)

		setText = var_82_7

		var_82_7(var_82_10, var_82_3)
...
function var_0_1.onBackPressed(arg_88_0)
	...
	if var_1(arg_88_0.pauseUI) then
		...
		var_88_1(var_88_0, var_88_2, var_5.Find(var_88_3, "ui"))
	...
	if var_88_1(arg_88_0.returnUI) then
		...
		var_88_5(var_88_4, var_88_6, var_5.Find(var_88_7, "ui"))
