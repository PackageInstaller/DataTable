...
function var_0_1.InitRegister(arg_5_0, arg_5_1)
	...
	local var_5_3 = var_5_2(var_5_1, var_1_10006(var_1_10008))
	...
	arg_5_0:Register("move", function(arg_7_0)
		...
		if not var_1(var_7_3, var_4) then
	...
	arg_5_0:Register("leave", function(arg_8_0)
		...
		if not var_1(var_8_3, var_4) then
...
function var_0_1.ChangeHide(arg_9_0, arg_9_1)
	...
	var_2(var_9_0, var_1_10005(var_1_10007)).alpha = arg_9_0.hideCount > 0 and 0.5 or 1
