...
function var_0_0.showSettlement(arg_177_0)
	...
	local var_177_0 = getProxy(GameRoomProxy):getRoomScore(arg_177_0:getGameRoomData().id)

	if var_177_0 <= arg_177_0.scoreNum then
		var_177_0 = arg_177_0.scoreNum
	...
	setText(findTF(arg_177_0.settlementUI, "ad/highText"), var_177_0)
	setText(findTF(arg_177_0.settlementUI, "ad/currentText"), arg_177_0.scoreNum)

	arg_177_0.sendSuccessFlag = true

	arg_177_0:SendSuccess(arg_177_0.scoreNum or 0)
