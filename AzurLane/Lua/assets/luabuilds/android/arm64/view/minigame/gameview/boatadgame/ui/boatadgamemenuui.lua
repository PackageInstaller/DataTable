...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_1 = var_5(arg_1_0.menuUI, "desc")
	...
	local var_1_16 = var_6(arg_1_0.menuUI, "btnStart")
	...
	local function var_1_20()
		...
		var_7_1(var_7_0, var_2_10003.BACK_HOME)
	...
	if var_0_1.drop and #var_4 > 0 then
		for iter_1_0 = 1, 7 do
			...
			var_1_10010 = var_1_10010(var_1_10012(var_1_21))
			...
			var_11(var_1_23, var_14(arg_1_0.menuUI, "battList/Viewport/Content"))

			local var_1_24 = iter_1_0

			GetSpriteFromAtlasAsync = var_1_10012

			var_1_10012(var_0_1.ui_atlas, "battleDesc" .. var_1_24, function(arg_8_0)
				if arg_8_0 then
					setImageSprite = var_2_10001
					findTF = var_2_10003

					var_2_10001(var_2_10003(var_1_10010, "state_open/desc"), arg_8_0, true)

					setImageSprite = var_2_10001
					findTF = var_3

					var_2_10001(var_3(var_1_10010, "state_clear/desc"), arg_8_0, true)

					setImageSprite = var_2_10001
					findTF = var_3

					var_2_10001(var_3(var_1_10010, "state_current/desc"), arg_8_0, true)

					setImageSprite = var_2_10001
					findTF = var_3

					var_2_10001(var_3(var_1_10010, "state_closed/desc"), arg_8_0, true)
				end
			...
			var_14(var_1_10012, var_1_25)

			onButton = var_14

			local var_1_26 = arg_1_0._event
			local var_1_27 = var_1_10012
			...
			local function var_1_28()
				...
				var_9_1(var_9_0, var_2_10003.ON_DROP, var_1_25)
			...
			var_14(var_1_26, var_1_27, var_1_28, var_1_10019)
