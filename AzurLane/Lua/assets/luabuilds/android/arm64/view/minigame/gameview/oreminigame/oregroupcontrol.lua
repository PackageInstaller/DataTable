...
function var_0_0.AddListener(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10004.EVENT_ORE_NEW, function(arg_3_0, arg_3_1)
	...
	var_2_3(var_2_2, var_4.EVENT_ORE_DESTROY, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10005(arg_2_0.oresTF, arg_4_1.index), arg_4_1.id)
...
function var_0_0.NewOre(arg_5_0, arg_5_1, arg_5_2)
	...
	if not var_1_10003(arg_5_0.oresTF, arg_5_1) then
		...
		OreGameConfig = var_10

		var_5_5(var_5_4, var_10.EVENT_ORE_EF_MINED, {
			index = arg_5_1
		})
	end
...
function var_0_0.Reset(arg_6_0)
	...
	OreGameConfig = iter_6_0
	arg_6_0.weightTable = var_6_0[var_6_1(#iter_6_0.ORE_REFRESH_WEIGHT)]
	arg_6_0.count = 0
	arg_6_0.pools = {}
	removeAllChildren = var_1
...
function var_0_0.GetNewOreConfig(arg_7_0)
	...
	if var_7_0 == var_1_10002.DIAMOND_CONFIH.count then
		...
		math = var_7_1
		var_7_1 = var_7_1.random() < var_7_0 and 7 or 8
		arg_7_0.count = 0
	...
	OreGameConfig = var_7_1
	arg_7_0.count = var_7_1.ORE_CONFIG[var_7_3].type == 4 and 0 or arg_7_0.count + 1
...
function var_0_0.GetOre(arg_9_0, arg_9_1)
	if arg_9_0.pools[arg_9_1] and #arg_9_0.pools[arg_9_1] > 0 then
		...
		return var_2.remove(arg_9_0.pools[arg_9_1])
	end
	...
	return (var_2(var_1_10004(var_1_10006(arg_9_0.tpls, "tpl_" .. arg_9_1))))
end
...
function var_0_0.ReturnOre(arg_10_0, arg_10_1, arg_10_2)
	...
	var_10_1(var_10_0, var_1_10006(arg_10_0.poolTF), false)
	...
	var_10_2(var_10_3, var_6(arg_10_1))
