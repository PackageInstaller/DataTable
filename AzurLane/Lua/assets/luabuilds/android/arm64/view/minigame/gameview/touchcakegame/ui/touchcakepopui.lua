...
function var_0_0.setRankItemData(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	if 0 < arg_16_3 and arg_16_3 <= 3 then
		...
		var_11(var_16_12, var_14(var_16_3, var_0_3[arg_16_3]))
	elseif var_16_6 then
		...
		var_11(var_16_12, var_14(var_16_3, var_0_4))
	else
		setActive = var_11
		findTF = var_16_12
...
function var_0_0.updateSettlementUI(arg_19_0)
	...
	local var_19_3 = var_19_0.floor(var_0_1.gameTime)
	...
	if var_4 then
		...
		local var_19_11 = var_1_10008(arg_19_0.settlementUI, "ad/currentText")
