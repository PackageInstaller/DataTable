...
local var_0_0 = var_0_10000("MusicBeatGamePopUI")
local var_0_1 = {
	"#E59C4B",
	"#56748D",
	"#AB7959"
...
function var_0_0.initLeavelUI(arg_5_0)
	...
	local var_5_0 = var_3(arg_5_0.leaveUI, "ad/btnCancel/text")

	i18n = var_4

	var_1(var_5_0, var_4("event_ui_giveup"))

	setText = var_1
	findTF = var_5_0

	local var_5_1 = var_5_0(arg_5_0.leaveUI, "ad/btnOk/text")

	i18n = var_4

	var_1(var_5_1, var_4("word_exist"))

	setText = var_1
	findTF = var_5_1

	local var_5_2 = var_5_1(arg_5_0.leaveUI, "ad/desc")

	i18n = var_4

	var_1(var_5_2, var_4("beat_game_exit_desc"))

	GetComponent = var_1
	findTF = var_5_2

	local var_5_3 = var_5_2(arg_5_0.leaveUI, "ad/img_2")

	typeof = var_4
	Image = var_6

	local var_5_4 = var_1(var_5_3, var_4(var_6))

	var_1.SetNativeSize(var_5_4)

	setText = var_1
	findTF = var_5_4

	local var_5_5 = var_5_4(arg_5_0.leaveUI, "ad/btnOk/text")

	i18n = var_4

	var_1(var_5_5, var_4("word_exist"))

	setText = var_1
	findTF = var_5_5

	local var_5_6 = var_5_5(arg_5_0.leaveUI, "ad/btnCancel/text")

	i18n = var_4

	var_1(var_5_6, var_4("word_cancel"))
	...
	local var_5_7 = arg_5_0._event

	findTF = var_4

	local var_5_8 = var_4(arg_5_0.leaveUI, "ad/btnOk")
	...
	var_1(var_5_7, var_5_8, var_5_9, var_6)

	onButton = var_1

	local var_5_10 = arg_5_0._event

	findTF = var_5_8

	local var_5_11 = var_5_8(arg_5_0.leaveUI, "ad/btnCancel")
	...
	var_1(var_5_10, var_5_11, var_5_12, var_6)
...
function var_0_0.initPauseUI(arg_8_0)
	...
	local var_8_0 = var_3(arg_8_0.pauseUI, "ad/img_2")
	...
	local var_8_2 = var_8_1(arg_8_0.pauseUI, "ad/btnOk/text")

	i18n = var_4

	var_1(var_8_2, var_4("child2_replay_continue"))
	...
	local var_8_4 = var_4(arg_8_0.pauseUI, "ad/btnOk")
	...
	var_1(var_8_3, var_8_4, var_8_5, var_6)
...
function var_0_0.initSettlementUI(arg_10_0)
	...
	var_1(var_10_0, var_4("ryza_task_confirm"))

	setText = var_1
	findTF = var_10_0

	local var_10_1 = var_10_0(arg_10_0.settlementUI, "ad/highScore")

	i18n = var_4

	var_1(var_10_1, var_4("beat_game_high_score"))

	setText = var_1
	findTF = var_10_1

	local var_10_2 = var_10_1(arg_10_0.settlementUI, "ad/currentScore")

	i18n = var_4

	var_1(var_10_2, var_4("beat_game_current_score"))
...
function var_0_0.initRankUI(arg_12_0)
	...
	local var_12_6 = var_1(var_12_5, var_4(var_6))
	...
	local var_12_8 = var_4(arg_12_0.rankUI, "ad/close")
	...
	var_1(var_12_7, var_12_8, var_12_9, var_6)
	...
	var_1(var_12_10, var_12_11, var_12_12, var_6)

	setText = var_1
	findTF = var_12_10

	local var_12_13 = var_12_10(arg_12_0.rankUI, "ad/bg/title")

	i18n = var_12_11

	var_1(var_12_13, var_12_11("beat_game_rank"))

	setText = var_1
	findTF = var_12_13

	local var_12_14 = var_12_13(arg_12_0._rankItemTpl, "imgMy/text")

	i18n = var_4

	var_1(var_12_14, var_4("beat_game_my_record"))

	setText = var_1
	findTF = var_12_14

	local var_12_15 = var_12_14(arg_12_0.myRankItem, "imgMy/text")

	i18n = var_4

	var_1(var_12_15, var_4("beat_game_my_record"))
...
function var_0_0.updateRankData(arg_15_0, arg_15_1)
	...
	local var_15_3 = arg_15_0.setRankItemData
	local var_15_4 = arg_15_0.myRankItem
	local var_15_5 = {
		score = 0,
		player_id = var_2:getPlayerId()
	}
	local var_15_6 = var_2

	var_15_5.name = var_2.getData(var_15_6).name

	var_15_3(var_15_2, var_15_4, var_15_5, 0)
	...
	for iter_15_0 = 1, #arg_15_1 do
		...
		if #arg_15_0._rankItems < iter_15_0 then
			tf = var_9
			instantiate = var_15_6

			local var_15_7 = var_9(var_15_6(arg_15_0._rankItemTpl))

			setActive = var_1_10010

			var_1_10010(var_15_7, false)

			setParent = var_1_10010

			var_1_10010(var_15_7, arg_15_0._rankContent)

			table = var_1_10010

			var_1_10010.insert(arg_15_0._rankItems, var_15_7)
		end

		var_15_5 = arg_15_0._rankItems[iter_15_0]

		local var_15_8 = arg_15_1[iter_15_0].player_id

		getProxy = var_1_10010
		PlayerProxy = var_1_10012
		var_1_10012 = var_1_10010(var_1_10012)

		if var_1_10010.isSelf(var_1_10012, var_15_8) then
			arg_15_0:setRankItemData(arg_15_0.myRankItem, arg_15_1[iter_15_0], iter_15_0)
		end

		arg_15_0:setRankItemData(var_15_5, arg_15_1[iter_15_0], iter_15_0)

		setActive = var_15_6

		var_15_6(var_15_5, true)
	end

	for iter_15_1 = #arg_15_1 + 1, #arg_15_0._rankItems do
		setActive = var_15_5

		var_15_5(arg_15_0._rankItems, false)
	end
...
function var_0_0.setRankItemData(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	if 0 < arg_16_3 and arg_16_3 <= 3 then
		...
		var_11(var_16_12, var_14(var_16_3, var_0_1[arg_16_3]))
	elseif var_16_6 then
		...
		var_11(var_16_12, var_14(var_16_3, var_0_2))
	else
		setActive = var_11
		findTF = var_16_12
	...
	var_11(var_16_13, var_14(arg_16_3))
...
function var_0_0.updateSettlementUI(arg_19_0)
	...
	local var_19_2 = arg_19_0._gameVo.scoreNum

	getProxy = var_19_0
	MiniGameProxy = var_5

	local var_19_3 = var_19_0(var_5)

	if var_3.GetHighScore(var_19_3, arg_19_0._gameVo.gameId) then
		local var_19_4 = #var_3
		local var_19_5

		if not (0 < var_19_4) or not var_3[1] then
			var_19_5 = 0
		end
		...
		var_19_3(var_7(arg_19_0.settlementUI, "ad/new"), var_19_5 < var_19_2)

		local var_19_7

		if 0 < var_19_2 and var_19_5 < var_19_2 then
			local var_19_6 = arg_19_0._event

			var_19_7 = var_19_7.emit
			MusicBeatGameEvent = var_8

			var_19_7(var_19_6, var_8.STORE_SERVER, {
				var_19_2,
				1
			})
		end
		...
		local var_19_8 = var_19_7(arg_19_0.settlementUI, "ad/highText")

		findTF = var_6

		local var_19_9 = var_6(arg_19_0.settlementUI, "ad/currentText")

		setText = var_7

		var_7(var_19_9, var_19_2)

		setText = var_7

		var_7(var_19_8, var_19_5 < var_19_2 and var_19_2 or var_19_5)

		local var_19_10 = arg_19_0._event
		local var_19_11 = var_7.emit

		MusicBeatGameEvent = var_10

		var_19_11(var_19_10, var_10.SUBMIT_GAME_SUCCESS)
...
function var_0_0.popRankUI(arg_28_0, arg_28_1)
	...
	var_1_10002(arg_28_0.rankUI, arg_28_1)
...
function var_0_0.clearUI(arg_29_0)
	...
	var_1_10001(arg_29_0.settlementUI, false)

	setActive = var_1_10001

	var_1_10001(arg_29_0.countUI, false)
