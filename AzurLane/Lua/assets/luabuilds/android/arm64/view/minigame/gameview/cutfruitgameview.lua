...
local var_0_0 = "CutFruitGameView"

import = var_0_10003

local var_0_1 = var_0_10000(var_0_0, var_0_10003("..BaseMiniGameView"))

var_0_1.EVENT_DIRECT = "CutFruitGameView:EVENT_DIRECT"
...
function var_0_1.initEvent(arg_5_0)
	...
	var_5_11(var_5_10, var_4.STOP_TIME_STEP, function(arg_11_0, arg_11_1, arg_11_2)
		local var_11_0 = arg_5_0._gameVo

		var_3.StopTimeStep(var_11_0, arg_11_1)
	...
	var_5_13(var_5_12, var_4.PAUSE_GAME, function(arg_12_0, arg_12_1, arg_12_2)
		if arg_12_1 then
	...
	var_5_15(var_5_14, var_4.BACK_MENU, function(arg_13_0, arg_13_1, arg_13_2)
		if arg_13_1 and arg_13_1.restart then
			local var_13_0 = arg_5_0

			var_3.readyStart(var_13_0, arg_13_1)
		else
			local var_13_1 = arg_5_0.menuUI
			local var_13_2 = var_3.Update
			local var_13_3 = arg_5_0

			var_13_2(var_13_1, var_6.GetMGHubData(var_13_3))

			local var_13_4 = arg_5_0.menuUI

			var_3.Show(var_13_4, true)

			local var_13_5 = arg_5_0.gameUI

			var_3.Show(var_13_5, false)

			local var_13_6 = arg_5_0.popUI

			var_3.PopSelectUI(var_13_6, true)

			local var_13_7 = arg_5_0.gameScene

			var_3.ShowContainer(var_13_7, false)

			local var_13_8 = arg_5_0
			local var_13_9 = var_3.changeBgm

			CutFruitGameConst = var_6

			var_13_9(var_13_8, var_6.bgm_type_default)
		end
	...
	var_5_17(var_5_16, var_4.CLOSE_GAME, function(arg_14_0, arg_14_1, arg_14_2)
	...
	var_5_19(var_5_18, var_4.GAME_OVER, function(arg_15_0, arg_15_1, arg_15_2)
		local var_15_0 = arg_5_0

		var_3.onGameOver(var_15_0, arg_15_1)
	...
	var_5_21(var_5_20, var_4.SHOW_RULE, function(arg_16_0, arg_16_1, arg_16_2)
		pg = var_2_10003
		...
		local var_16_3 = var_2_10007.gametip

		CutFruitGameConst = var_2_10008
		var_16_2.helps = var_16_3[var_2_10008.rule_tip].tip
	...
	var_5_23(var_5_22, var_4.SHOW_RANK, function(arg_17_0, arg_17_1, arg_17_2)
		local var_17_0 = arg_5_0
		local var_17_1 = var_3.getRankData
		local var_17_2 = arg_5_0._gameVo

		var_17_1(var_17_0, var_6.GetGameId(var_17_2), function(arg_18_0)
			local var_18_0 = arg_5_0.popUI

			var_1.UpdateRankData(var_18_0, arg_18_0)

			return
		end)

		local var_17_3 = arg_5_0.popUI

		var_3.PopRankUI(var_17_3, true)
	...
	var_5_25(var_5_24, var_4.READY_START, function(arg_19_0, arg_19_1, arg_19_2)
		local var_19_0 = arg_5_0

		var_3.readyStart(var_19_0, arg_19_1)
	...
	var_5_27(var_5_26, var_4.STORE_SERVER, function(arg_20_0, arg_20_1, arg_20_2)
		getProxy = var_2_10003
		MiniGameProxy = var_2_10005

		local var_20_0 = var_2_10003(var_2_10005)
		local var_20_1 = var_3.UpdataHighScore
		local var_20_2 = arg_5_0._gameVo

		var_20_1(var_20_0, var_6.GetGameId(var_20_2), arg_20_1)
	...
	var_5_29(var_5_28, var_4.SUBMIT_GAME_SUCCESS, function(arg_21_0, arg_21_1, arg_21_2)
	...
	var_5_31(var_5_30, var_4.ADD_SCORE, function(arg_22_0, arg_22_1, arg_22_2)
		local var_22_0 = arg_5_0

		var_3.addScore(var_22_0, arg_22_1.num)
...
function var_0_1.initUI(arg_23_0)
	...
	CutFruitGamePopUI = var_1
	arg_23_0.popUI = var_1.New(arg_23_0._tf, arg_23_0, arg_23_0._gameVo)

	local var_23_0 = arg_23_0.popUI

	var_1.ClearUI(var_23_0)

	CutFruitGamingUI = var_1
	arg_23_0.gameUI = var_1.New(arg_23_0._tf, arg_23_0, arg_23_0._gameVo)

	local var_23_1 = arg_23_0.gameUI

	var_1.Show(var_23_1, false)

	CutFruitGameMenuUI = var_1
	arg_23_0.menuUI = var_1.New(arg_23_0._tf, arg_23_0, arg_23_0._gameVo)

	local var_23_2 = arg_23_0.menuUI

	var_1.Update(var_23_2)

	local var_23_3 = arg_23_0.menuUI

	var_1.Show(var_23_3, true)

	local var_23_4 = arg_23_0.popUI

	var_1.PopSelectUI(var_23_4, true)

	CutFruitGameScene = var_1
	arg_23_0.gameScene = var_1.New(arg_23_0._tf, arg_23_0, arg_23_0._gameVo)

	return
end

function var_0_1.changeBgm(arg_24_0, arg_24_1)
	local var_24_0

	CutFruitGameConst = var_1_10003

	if arg_24_1 == var_1_10003.bgm_type_default then
		if not arg_24_0:getBGM() then
			pg = var_3

			local var_24_1 = var_3.CriMgr.GetInstance()

			if var_3.IsDefaultBGM(var_24_1) then
				pg = var_3
				var_24_0 = var_3.voice_bgm.NewMainScene.default_bgm
			else
				pg = var_3
				var_24_0 = var_3.voice_bgm.NewMainScene.bgm
			end
		end
	else
		CutFruitGameConst = var_3

		if arg_24_1 == var_3.bgm_type_menu then
			CutFruitGameConst = var_3
			var_24_0 = var_3.menu_bgm
		else
			CutFruitGameConst = var_3

			if arg_24_1 == var_3.bgm_type_game then
				CutFruitGameConst = var_3
				var_24_0 = var_3.game_bgm
			end
		end
	end
	...
	if arg_24_0.bgm ~= var_24_0 then
		...
		local var_24_2 = var_3.BgmMgr.GetInstance()

		var_3.Push(var_24_2, arg_24_0.__cname, var_24_0)
	end

	return
end

function var_0_1.OnUpdate(arg_25_0)
	arg_25_0:gameStep()

	return
end

function var_0_1.readyStart(arg_26_0, arg_26_1)
	arg_26_0.readyStartFlag = true

	local var_26_0 = arg_26_0._gameVo

	var_2.Prepare(var_26_0)

	local var_26_1 = arg_26_0.popUI

	var_2.ReadyStart(var_26_1)

	local var_26_2 = arg_26_0.menuUI

	var_2.Show(var_26_2, false)

	local var_26_3 = arg_26_0.gameUI

	var_2.Show(var_26_3, false)

	local var_26_4 = arg_26_0.gameScene

	var_2.Prepare(var_26_4, arg_26_1)
...
function var_0_1.gameStart(arg_27_0)
	...
	local var_27_3 = arg_27_0.gameScene

	var_1.Start(var_27_3)
	arg_27_0:timerStart()

	local var_27_4 = arg_27_0
	local var_27_5 = arg_27_0.changeBgm

	CutFruitGameConst = var_4

	var_27_5(var_27_4, var_4.bgm_type_game)
...
function var_0_1.gameStep(arg_28_0)
	if arg_28_0.gameStartFlag and not arg_28_0.gameStop and not arg_28_0.settlementFlag then
		...
		var_1.Step(var_1_10003)

		var_1_10003 = arg_28_0.gameScene

		var_1.Step(var_1_10003)

		var_1_10003 = arg_28_0._gameVo

		if var_1.GetTime(var_1_10003) <= 0 then
			var_1_10003 = arg_28_0

			arg_28_0.onGameOver(var_1_10003, false)
		end
	end
	...
	if var_1 then
		...
		if var_28_0(var_1_10003.A) then
			var_28_1 = arg_28_0
			var_28_2 = arg_28_0.emit
			CutFruitGameView = var_1_10004
			var_1_10004 = var_1_10004.EVENT_DIRECT
			CutFruitGameConst = var_1_10005

			var_28_2(var_28_1, var_1_10004, var_1_10005.DIRECT_LEFT)
		end
		...
		if var_28_3(var_28_1.D) then
			var_28_4 = arg_28_0
			var_28_5 = arg_28_0.emit
			CutFruitGameView = var_1_10004
			var_1_10004 = var_1_10004.EVENT_DIRECT
			CutFruitGameConst = var_1_10005

			var_28_5(var_28_4, var_1_10004, var_1_10005.DIRECT_RIGHT)
		end
		...
		if var_28_6(var_28_4.W) then
			var_28_7 = arg_28_0
			var_28_8 = arg_28_0.emit
			CutFruitGameView = var_1_10004
			var_1_10004 = var_1_10004.EVENT_DIRECT
			CutFruitGameConst = var_1_10005

			var_28_8(var_28_7, var_1_10004, var_1_10005.DIRECT_UP)
		end

		Input = var_28_8

		local var_28_9 = var_28_8.GetKeyDown

		KeyCode = var_28_7

		if var_28_9(var_28_7.S) then
			local var_28_10 = arg_28_0
			local var_28_11 = arg_28_0.emit

			CutFruitGameView = var_1_10004

			local var_28_12 = var_1_10004.EVENT_DIRECT

			CutFruitGameConst = var_1_10005

			var_28_11(var_28_10, var_28_12, var_1_10005.DIRECT_DOWN)
		end
	end
...
function var_0_1.getRankData(arg_32_0, arg_32_1, arg_32_2)
	...
	var_32_1(var_32_0, var_1_10006.MINI_GAME_FRIEND_RANK, {
		id = arg_32_1,
...
function var_0_1.stepRunTimeData(arg_35_0)
	...
	var_35_1(var_35_0, var_1_10004.deltaTime)
...
function var_0_1.onGameOver(arg_37_0, arg_37_1)
	...
	var_2.SetSuccess(var_37_0, arg_37_1 and true or false)

	local var_37_1 = arg_37_0._gameVo

	var_2.SetSettlement(var_37_1, true)

	local var_37_2 = arg_37_0.gameScene

	var_2.GameOver(var_37_2)
	...
	local var_37_3 = var_2.delayedCall

	go = var_4

	local var_37_4 = var_4(arg_37_0._tf)
	local var_37_5 = 1

	System = var_6

	var_37_3(var_37_4, var_37_5, var_6.Action(function()
