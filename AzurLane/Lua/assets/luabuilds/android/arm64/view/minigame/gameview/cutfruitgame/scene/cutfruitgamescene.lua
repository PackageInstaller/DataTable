...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	CutFruitGameView = var_7

	var_1_1(var_1_0, var_7.EVENT_DIRECT, function(arg_3_0, arg_3_1, arg_3_2)
...
function var_0_0.onEventHandle(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	if arg_4_1 == var_0_0.GET_SCORE then
		...
		var_4_1(var_4_0, var_1_10007.ADD_SCORE, {
			num = arg_4_2
		})
	end
...
function var_0_0.Prepare(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_1_10005.chapter_data
	local var_6_3 = arg_6_0._gameVo

	var_6_1(var_6_0, var_6_2[var_6.GetGameRound(var_6_3)])
