...
function var_0_0.AddListener(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10004.EVENT_DELIVER, function(arg_4_0, arg_4_1)
	...
	var_3_3(var_3_2, var_4.EVENT_PLAY_CONTAINER_HIT, function(arg_5_0, arg_5_1)
...
function var_0_0.PlayDeliverAnim(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	local var_6_6 = var_6_5(var_6_4, var_8(var_1_10010))
	...
	local var_6_10 = var_6_9(var_6_8, var_8(var_1_10010))
...
function var_0_0.PlayHitAnim(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	var_6(var_7_4, var_9(arg_7_2.x + arg_7_0.hitPos.x, arg_7_2.y + arg_7_0.hitPos.y))
	...
	local var_7_8 = var_7_7(var_7_6, var_9(var_11))
...
function var_0_0.Reset(arg_9_0)
	...
	var_1(var_3.Find(var_9_0, "ore/pos"), false)

	removeAllChildren = var_1

	local var_9_1 = arg_9_0.mainTF.parent

	var_1(var_3.Find(var_9_1, "ore/pos"))
...
function var_0_0.OnTimer(arg_10_0, arg_10_1)
	if arg_10_0.deliverTime then
		...
		if arg_10_0.mainTF.anchoredPosition.y < -230 then
			...
			var_3(var_5.Find(var_10_1, "ore/pos"))
			arg_10_0:Reset()
		end
	end
	...
	if arg_10_0.breakTime then
		...
		if arg_10_0.breakTime >= var_0_0.BREAK_MOVE_TIME / 3 then
			...
			if not var_3(var_5.Find(var_10_3, "ore/pos")) then
				setActive = var_3

				local var_10_4 = arg_10_0.mainTF.parent

				var_3(var_5.Find(var_10_4, "ore/pos"), true)
			end
