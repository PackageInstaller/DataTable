...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	GetComponent = var_5
	findTF = var_1_10007
	arg_1_0.spineAnimUI = var_5(var_1_10007(arg_1_0._tf, "spine"), "SpineAnimUI")
	...
	typeof = var_8
	Animation = var_10
	arg_1_0.angryAni = var_1_4(var_1_3, var_8(var_10))
	...
	typeof = var_8
	Animation = var_10
	arg_1_0.selectAni = var_1_6(var_1_5, var_8(var_10))
	arg_1_0.direct = {
		-1,
		0
	}
...
function var_0_0.SetRoleActionByState(arg_3_0, arg_3_1)
	...
	if arg_3_1 == var_1_10002.SHIP_STATE.stop then
		...
		var_3_1(var_3_0, var_1_10005.SHIP_STATE_ACTION.normal, 0)
	else
		...
		if arg_3_1 == var_3_1.SHIP_STATE.walk then
			...
			var_3_3(var_3_2, var_1_10005.SHIP_STATE_ACTION.walk, 0)
		else
			...
			if arg_3_1 == var_3_3.SHIP_STATE.crash then
				...
				var_3_5(var_3_4, var_1_10005.SHIP_STATE_ACTION.crash, 0)
			end
		end
	end
...
function var_0_0.RandomAngryTime(arg_4_0)
	...
	local var_4_1 = var_1_10003.CHILD_ANGER_TIME[1]

	CrossRoadGameConst = var_1_10004
	arg_4_0.angryTime = var_4_0(var_4_1, var_1_10004.CHILD_ANGER_TIME[2])
...
function var_0_0.CanAngryStart(arg_5_0, arg_5_1)
	if arg_5_0.id == arg_5_0.fa then
		...
		if var_5_0 ~= var_3.SHIP_STATE.stop then
		...
		local var_5_1 = arg_5_0.lastSelectTime

		CrossRoadGameConst = var_3

		if arg_5_1 > var_5_1 + var_3.CAN_ANGRY_TIME then
			local var_5_2 = arg_5_0.lastAngryRollTime

			CrossRoadGameConst = var_3

			if arg_5_1 > var_5_2 + var_3.ONCE_ANGRY_TIME then
...
function var_0_0.RollAngryState(arg_7_0)
	...
	return var_7_0 < var_1_10002.ANGRY_PERCENT
end
