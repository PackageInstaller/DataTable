...
local function var_0_5(arg_1_0, arg_1_1, arg_1_2)
	local var_1_0 = {
		ctor = function(arg_2_0)
			...
			arg_2_0._eventTrigger = var_1(var_2_0, var_4(var_2_10006))
			GameObject = var_1
			...
			typeof = var_4
			Camera = var_2_10006
			arg_2_0._uiCamera = var_2_2(var_2_1, var_4(var_2_10006))
			Vector2 = var_1
			...
			var_1.AddDragFunc(var_2_4, function(arg_4_0, arg_4_1, arg_4_2)
				...
				Vector2 = var_3_10004
				var_4_1.dragScreenPos = var_3_10004(arg_4_1.position.x, arg_4_1.position.y + var_0_4.y)
		...
		getScreentScaleRate = function(arg_7_0)
			...
			local var_7_2 = var_2_10003(var_2_10005.Find("UICamera/Canvas")).sizeDelta.x
		...
		isTweening = function(arg_9_0)
			...
			return var_9_0(var_2_10003(arg_9_0._rectItem))
		end,
		...
		fadeTo = function(arg_14_0, arg_14_1)
			...
			arg_14_0.clearTween(var_14_0)

			local var_14_1 = arg_14_0._rectItem.anchoredPosition.x
			local var_14_2 = arg_14_0
			local var_14_3 = arg_14_0.getIndexPosition(var_14_2, arg_14_1).x

			Vector2 = var_14_0

			local var_14_4 = var_14_0(0, arg_14_0._rectItem.anchoredPosition.y)

			LeanTween = var_14_2

			local var_14_5 = var_14_2.value

			go = var_7

			local var_14_6 = var_14_5(var_7(arg_14_0._rectItem), var_14_1, var_14_3, 0.1)
			local var_14_7 = var_5.setOnUpdate

			System = var_8

			local var_14_8 = var_14_7(var_14_6, var_8.Action_float(function(arg_15_0)
				var_14_4.x = arg_15_0
				arg_14_0._rectItem.anchoredPosition = var_14_4

				return
			end))
			local var_14_9 = var_5.setOnComplete

			System = var_8

			var_14_9(var_14_8, var_8.Action(function()
				return
			end))
		...
		clearTween = function(arg_22_0)
			...
			if var_22_0(var_2_10003(arg_22_0._rectItem)) then
				LeanTween = var_1
				...
				var_22_1(var_3(arg_22_0._rectItem))
			end
...
function var_0_0.Ctor(arg_26_0, arg_26_1, arg_26_2, arg_26_3)
	...
	for iter_26_0 = 1, var_0_3 do
		...
		PipeGameConst = var_1_10011
		var_1_10009 = var_1_10009(var_1_10011.tpl_rect_item, arg_26_0._content)

		local var_26_1 = var_0_5(var_1_10009, arg_26_0._dragPos, var_26_0)

		table = var_1_10011

		var_1_10011.insert(arg_26_0.rectItems, var_26_1)
	end
	...
	if #arg_32_0.rectDatas >= 0 then
		for iter_32_0 = 1, #arg_32_0.rectItems do
			...
			if var_5:getItem() == nil then
				...
				var_32_3(var_32_2, var_1_10010.map_item_data[var_32_1])
			end
		end
	end
...
function var_0_0.removeTopRectData(arg_36_0)
	...
	var_1_10002.insert(arg_36_0.rectItems, var_36_0)
	...
	var_36_3(var_36_2, var_6.map_item_data[var_36_1])
