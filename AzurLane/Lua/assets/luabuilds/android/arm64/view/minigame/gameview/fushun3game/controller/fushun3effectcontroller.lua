...
function var_0_0.start(arg_2_0)
	for iter_2_0 = #arg_2_0._effects, 1, -1 do
		...
		var_2_1(var_2_0, var_1_10008.remove(arg_2_0._effects, iter_2_0))
	end
...
function var_0_0.addEffectToTarget(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_1.data.parent then
		...
		var_7_0 = arg_7_1.tf
		Vector2 = var_1_10004
		var_7_0.anchoredPosition = var_1_10004(0, 0)
		setActive = var_7_0
		...
		var_7_1.localScale = var_1_10004.game_scale_v3
...
function var_0_0.instiateEffect(arg_9_0, arg_9_1)
	if arg_9_1 then
		...
		local var_9_0 = var_1_10002(var_1_10004(var_1_10006(arg_9_0._effectTpl, arg_9_1.name)))
		local var_9_1 = {
			tf = var_9_0,
			data = arg_9_1
		}
		...
		local var_9_2 = var_6(var_9_0, "efAnim")

		typeof = var_1_10007
		DftAniEvent = var_9

		local var_9_3 = var_4(var_9_2, var_1_10007(var_9))
...
function var_0_0.removeEffect(arg_11_0, arg_11_1)
	for iter_11_0 = #arg_11_0._effects, 1, -1 do
		if arg_11_0._effects[iter_11_0] == arg_11_1 then
			...
			var_11_1(var_11_0, var_9.remove(arg_11_0._effects, iter_11_0))
		end
	end
	...
	if arg_12_1 then
		...
		for iter_12_0 = var_12_0, #var_1_10004.effect_data do
			...
			if var_1_10007.effect_data[iter_12_0].trigger == arg_12_1 then
				...
				return var_1_10007(var_1_10009.effect_data[iter_12_0])
			end
		end
	elseif arg_12_2 then
		...
		for iter_12_1 = var_12_1, #var_1_10004.effect_data do
			...
			if var_1_10007.effect_data[iter_12_1].name == arg_12_2 then
				...
				return var_1_10007(var_1_10009.effect_data[iter_12_1])
			end
		end
	end
