...
function var_0_1.didEnter(arg_3_0)
	...
	if var_3_1 == var_1_10002.round_type_zhuanshu then
		LaunchBallGameVo = var_3_1

		local var_3_2 = var_3_1.SetPlayer

		LaunchBallGameVo = var_3_0

		var_3_2(var_3_0.gameRoundData.player_id)
		arg_3_0:readyStart()
	end
...
function var_0_1.initEvent(arg_6_0)
	...
	arg_6_0:bind(var_0_1.BACK_MENU, function(arg_12_0, arg_12_1, arg_12_2)
		...
		var_12_3(var_12_2, var_6.GetMGHubData(var_12_4))
		...
		if not var_3.getBGM(var_12_8) then
			...
			local var_12_9 = var_4.CriMgr.GetInstance()
	...
	arg_6_0:bind(var_0_1.SUBMIT_GAME_SUCCESS, function(arg_18_0, arg_18_1, arg_18_2)
		...
		local var_18_4 = var_2_10008.result_player

		LaunchBallGameVo = var_2_10009

		var_18_3(var_18_4, var_2_10009.selectPlayer)
		...
		var_18_5(var_18_6, var_9.gameRoundData.id)
...
function var_0_1.Update(arg_24_0)
	...
	if var_1 then
		...
		if var_24_0(var_1_10003.S) and arg_24_0.timer then
			var_24_1 = arg_24_0
		...
		if var_24_2(var_24_1.S) then
			...
			var_24_4(var_24_3, var_1_10004.S, false)
		end
		...
		if var_24_7(var_24_6.W) then
			...
			var_24_9(var_24_8, var_1_10004.W, false)
		end
		...
		if var_24_10(var_24_8.A) then
			...
			var_24_12(var_24_11, var_1_10004.A, true)
		end
		...
		if var_24_13(var_24_11.A) then
			...
			var_24_15(var_24_14, var_1_10004.A, false)
		end
		...
		if var_24_16(var_24_14.D) then
			...
			var_24_18(var_24_17, var_1_10004.D, true)
		end
		...
		if var_24_19(var_24_17.D) then
			...
			var_24_21(var_24_20, var_1_10004.D, false)
		end
