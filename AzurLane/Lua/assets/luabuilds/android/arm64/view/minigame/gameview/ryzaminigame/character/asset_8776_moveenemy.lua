...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.miniGame.gameView.RyzaMiniGame.character.TargetMove"))
...
function var_0_1.InitUI(arg_1_0, arg_1_1)
	...
	local var_1_7 = var_1_6(var_1_5, var_5(var_1_10007))
...
function var_0_1.TimeUpdate(arg_6_0, arg_6_1)
	if not arg_6_0.lock then
		...
		if var_6_0 then
			...
			var_1_10008 = var_6_0
			var_1_10011 = arg_6_0
			var_6_2 = var_6_4(var_6_3, var_1_10008, arg_6_0.GetSpeedDis(var_1_10011) * arg_6_1)
			...
			if not arg_6_0.wanderPos then
				...
				NewPos = var_7
				arg_6_0.wanderDir = var_7(0, 0)
				arg_6_0.wanderTime = 1.5
			end

			if arg_6_1 >= arg_6_0.wanderTime then
				local var_6_7 = arg_6_0.wanderPos

				NewPos = var_1_10008
				math = var_1_10010

				local var_6_8 = var_1_10010.random() * 2 - 1

				math = var_1_10011

				local var_6_9 = var_6_7 + var_1_10008(var_6_8, var_1_10011.random() * 2 - 1) * arg_6_0.wander - arg_6_0.realPos

				arg_6_0.wanderDir = var_1_10008.Normalize(var_6_9)
			end
		...
		if var_6_1.x == 0 and var_6_1.y == 0 then
			...
			local var_6_11 = arg_6_0.PlayMove

			RyzaMiniGameConfig = var_1_10008

			var_6_11(var_6_10, var_1_10008.GetFourDirMark(var_6_1))
		end
...
function var_0_1.MoveDelta(arg_7_0, arg_7_1, arg_7_2)
	if (arg_7_1 - arg_7_0.realPos).x == 0 and var_3.y == 0 then
		...
		return var_3 * var_7_0(var_7_1, arg_7_2 / var_1_10007.sqrt(var_3:SqrMagnitude()))
	end
...
function var_0_1.GetMoveInfo(arg_8_0)
	...
	if var_1.SearchRyza(var_8_0, arg_8_0, arg_8_0.search) then
		local var_8_1 = arg_8_0.responder

		if var_1.Wayfinding(var_8_1, arg_8_0) and #var_1 > 0 then
			local var_8_2 = var_1[#var_1] - arg_8_0.realPos
			local var_8_3 = var_1_10002 - arg_8_0.pos

			if var_8_2:SqrMagnitude() > var_8_3:SqrMagnitude() then
				var_1_10002 = arg_8_0.pos
			end

			local var_8_4

			if (var_1_10002 - arg_8_0.realPos).x ~= 0 or var_8_4.y ~= 0 then
				math = var_6
				var_8_4 = var_8_4 * (1 / var_6.sqrt(var_8_4:SqrMagnitude()))
			end

			return var_1_10002, var_8_4
		end
	end
...
function var_0_1.PlayWait(arg_10_0)
	...
	if not var_1_10005.split(arg_10_0.status, "_")[2] then
		var_10_3 = "S"
	end
...
function var_0_1.PlayDamage(arg_12_0)
	if not arg_12_0.lock then
		...
		if not var_1_10005.split(arg_12_0.status, "_")[2] then
			var_12_3 = "S"
		end
...
function var_0_1.PlayDead(arg_13_0)
	...
	if not var_1_10005.split(arg_13_0.status, "_")[2] then
		var_13_3 = "S"
	end
...
function var_0_1.UpdateAlpha(arg_16_0)
	...
	var_2(var_16_3, var_1_10005(var_1_10007)).alpha = var_16_1
...
function var_0_1.TimeTrigger(arg_17_0, arg_17_1)
	if arg_17_0.hp > 0 then
		...
		if var_2.CollideRyza(var_17_0, arg_17_0) then
			...
			var_17_2(var_17_1, var_17_3, var_17_4, var_7)
		end
	end
