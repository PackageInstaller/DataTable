	...
	local var_1_0 = {
		...
		createChar = function(arg_5_0, arg_5_1)
			...
			if not arg_5_0.getCharFromPool(var_5_0, arg_5_1) then
				BeachGuardConst = var_2_10003

				local var_5_1 = var_2_10003.chars[arg_5_1]

				BeachGuardChar = var_5_0

				local var_5_2 = var_5_0.New

				tf = var_2_10006
				instantiate = var_2_10008
				var_5_3 = var_5_2(var_2_10006(var_2_10008(arg_5_0._charTpl)), var_5_1, arg_5_0._event)
			end
		...
		step = function(arg_10_0, arg_10_1)
			for iter_10_0 = #arg_10_0.chars, 1, -1 do
				var_2_10008 = arg_10_0.chars[iter_10_0]

				var_6.step(var_2_10008, arg_10_1)
			end

			for iter_10_1 = #arg_10_0.enemys, 1, -1 do
				var_2_10008 = arg_10_0.enemys[iter_10_1]
			...
			for iter_10_2 = #arg_10_0.enemys, 1, -1 do
				...
				if not var_6.getTarget(var_10_0) then
					local var_10_1 = var_6:getLineIndex()

					var_2_10008 = var_6:getPointWorld()

					local var_10_2 = var_6:getPos()
					local var_10_3 = arg_10_0
					local var_10_4 = arg_10_0.getCharLine(var_10_3, var_10_1)
					local var_10_5 = false

					ipairs = var_10_3

					for iter_10_3, iter_10_4 in var_10_3(var_10_4) do
						if iter_10_4:checkCollider(var_2_10008, var_10_2) and (not var_10_5 or true) then
							var_10_5 = true
				...
				local var_10_6 = var_6:getPos().x

				BeachGuardConst = var_2_10008

				if var_10_6 < var_2_10008.enemy_over_width then
					arg_10_0.enemyOver = true
				end
			end

			for iter_10_5 = 1, #arg_10_0.chars do
				local var_10_7 = arg_10_0.chars[iter_10_5]
				local var_10_8 = var_6.getSkillDistance(var_10_7)

				BeachGuardConst = var_2_10008

				local var_10_9 = var_10_8 * var_2_10008.part_width

				var_2_10008 = arg_10_0:getCanHitChar(var_6:getLineIndex(), var_6:getCamp())
				ipairs = var_10_7

				for iter_10_6, iter_10_7 in var_10_7(var_2_10008) do
					if iter_10_7:getPos().x - var_6:getPos().x > 0 and var_14 < var_10_9 then
		...
		addEnemyChar = function(arg_19_0, arg_19_1, arg_19_2)
			...
			local var_19_2 = arg_19_0.createChar(var_19_1, var_19_0)

			var_4.prepareData(var_19_2)
			var_4:setLineIndex(arg_19_2.index)

			local var_19_3 = arg_19_0.content
			local var_19_4 = var_5.InverseTransformPoint(var_19_3, arg_19_2.position)

			math = var_19_1

			local var_19_5 = var_19_1.random

			BeachGuardConst = var_8

			local var_19_6 = var_8.enemy_pos[1]

			BeachGuardConst = var_2_10009

			local var_19_7 = var_19_5(var_19_6, var_2_10009.enemy_pos[2])
			local var_19_8 = var_4
			local var_19_9 = var_4.setParent
			local var_19_10 = arg_19_0.content
			local var_19_11 = false

			Vector2 = var_2_10012

			local var_19_12 = var_19_7 + var_19_4.x
			local var_19_13 = var_19_4.y

			BeachGuardConst = var_2_10016

			var_19_9(var_19_8, var_19_10, var_19_11, var_2_10012(var_19_12, var_19_13 + var_2_10016.enemy_offset_y))
			var_4:setCamp(2)
...
local function var_0_2(arg_22_0, arg_22_1)
	local var_22_0 = {
		Ctor = function(arg_23_0)
			...
			BeachGuardConst = var_2_10002

			for iter_23_0 = var_23_0, var_2_10002.line_num do
				findTF = var_2_10005
				var_2_10005 = var_2_10005(arg_23_0._tf, "sceneContainer/scene/linePos/" .. iter_23_0)
				tf = var_2_10006
				instantiate = var_8
				var_2_10006 = var_2_10006(var_8(arg_23_0.lineTpl))
				Vector2 = var_7
				var_2_10006.anchoredPosition = var_7(0, 0)
				setParent = var_7

				var_7(var_2_10006, var_2_10005)

				BeachGuardLine = var_7

				local var_23_1 = var_7.New(var_2_10006, arg_23_0.gridTpl, arg_23_0._event)

				var_7.setIndex(var_23_1, iter_23_0)
		...
		onTimer = function(arg_30_0)
			...
			if arg_30_0.dragData.flag ~= true or not arg_30_0.dragData.pos then
				if arg_30_0.preCharGrid then
					...
					BeachGuardGameView = var_2_10004

					local var_30_2 = var_2_10004.PULL_CHAR
					local var_30_3 = {
						card_id = arg_30_0.preCardID
					}
					local var_30_4 = arg_30_0.preCharGrid

					var_30_3.line_index = var_6.getLineIndex(var_30_4)

					local var_30_5 = arg_30_0.preCharGrid

					var_30_3.grid_index = var_6.getIndex(var_30_5)
			...
			if arg_30_0:getGridByWorld(var_30_6) and var_2:isEmpty() then
				...
				if var_30_11 and var_30_13 then
					BeachGuardConst = var_30_10

					local var_30_14 = var_30_10.chars[var_30_7].distance
		...
		getGridByChar = function(arg_34_0, arg_34_1)
			for iter_34_0 = 1, #arg_34_0.lines do
				...
				for iter_34_1, iter_34_2 in var_2_10007(var_34_1) do
		...
		getAbleLinePos = function(arg_35_0, arg_35_1)
			...
			for iter_35_0 = 1, #arg_35_0.activeLines do
				...
				if var_2_10008.contains(arg_35_1, var_35_2) then
					table = var_2_10008
					var_2_10008 = var_2_10008.insert

					local var_35_3 = var_35_0
					local var_35_4 = {}
					local var_35_5 = arg_35_0.activeLines[iter_35_0]

					var_35_4.position = var_12.getPosition(var_35_5)
					var_35_4.index = var_35_2

					var_2_10008(var_35_3, var_35_4)
				end
			end
	...
	local var_36_0 = {
		...
		useSkill = function(arg_38_0, arg_38_1)
			...
			if var_38_0 == var_2_10004.skill_craft then
				local var_38_1 = arg_38_0._event
				local var_38_2 = var_3.emit

				BeachGuardGameView = var_2_10006

				var_38_2(var_38_1, var_2_10006.ADD_CRAFT, {
					num = var_2.num
				})
			else
				...
				if var_38_3 == var_4.skill_bullet then
					...
					if var_38_5 == var_4.skill_melee then
						...
						BeachGuardGameView = var_2_10009

						var_38_10(var_38_9, var_2_10009.CREATE_CHAR_DAMAGE, {
							damage = var_38_6,
							position = var_38_8,
							target = var_38_7,
							useData = arg_38_1
		...
		pullBullet = function(arg_39_0, arg_39_1, arg_39_2)
			...
			if var_39_3 then
				...
				Vector2 = var_39_8
				var_39_4.anchoredPosition = var_39_8(var_39_0.tf.anchoredPosition.x + var_39_3.x, var_39_0.tf.anchoredPosition.y + var_39_3.y)
			end
			...
			if var_39_0.config.point_able then
				...
				if var_39_0.config.speed_high and var_39_0.config.speed_high ~= 0 then
					...
					math = var_39_8
					var_39_8 = var_39_8.random(-10, 5)
					var_39_6 = var_39_7.x + 5
					math = var_10
					var_39_7.x = var_39_6 - var_10.random() * 15

					local var_39_9 = arg_39_2.useChar

					var_39_6 = var_39_6.getPos(var_39_9)

					local var_39_10

					if var_39_7 and var_39_6 then
						math = var_39_10
						var_39_10 = var_39_10.abs(var_39_7.x - var_39_6.x)
						math = var_39_9
						var_39_0.life = var_39_10 / var_39_9.abs(var_39_0.speed.x)
					else
						math = var_39_10

						local var_39_11 = var_39_10.abs(var_39_0.distanceVec.x)

						math = var_39_9
						var_39_0.life = var_39_11 / var_39_9.abs(var_39_0.speed.x)
					end
				else
					math = var_39_7
					...
					math = var_39_8
					var_39_0.life = var_39_12 / var_39_8.abs(var_39_0.speed.x)
				end
			end
			...
			if var_39_0.config.speed_high and var_39_0.config.speed_high ~= 0 then
				...
				math = var_39_8
				var_39_13 = var_39_13 / var_39_8.pow(var_39_0.life / 2, 2)

				local var_39_14 = var_39_0.speed

				math = var_39_6
				var_39_14.y = var_39_6.abs(var_39_13) * (var_39_0.life / 2)
		...
		getOrCreateBullet = function(arg_41_0, arg_41_1)
			...
			if not arg_41_0.getBulletFromPool(var_41_0, arg_41_1) then
				...
				local var_41_1 = var_2_10003.bullet[arg_41_1]

				BeachGuardAsset = var_41_0

				local var_41_2 = var_41_0.getBullet(var_41_1.name)
				...
				if var_6.life then
					...
					if var_6.life <= 0 then
						...
						if var_6.config.speed_high and var_6.config.speed_high ~= 0 and not var_6.hit then
							...
							BeachGuardGameView = var_14

							var_2_10011(var_45_5, var_14.BULLET_DAMAGE, {
								damage = var_45_4,
		...
		clear = function(arg_47_0)
			for iter_47_0 = #arg_47_0.bullets, 1, -1 do
				...
				var_2_10006(var_2_10005.tf, false)

				var_2_10005.distanceVec = nil
				table = var_2_10006

				var_2_10006.insert(arg_47_0.bulletPool, var_2_10005)
			end
	...
	local var_48_0 = {
		...
		step = function(arg_52_0, arg_52_1)
			...
			for iter_52_0 = #arg_52_0._chapterDatas, 1, -1 do
				if arg_52_0._chapterDatas[iter_52_0].time < arg_52_0._overTime then
					...
					local var_52_2 = var_52_1(var_52_0, var_2_10011.remove(arg_52_0._chapterDatas, iter_52_0))

					table = var_2_10009

					var_2_10009.insert(arg_52_0.enemyDatas, var_52_2)
				end
			end

			for iter_52_1 = #arg_52_0.enemyDatas, 1, -1 do
				if arg_52_0.enemyDatas[iter_52_1].loop then
					var_2_10006.stepTime = var_2_10006.stepTime - arg_52_1

					if var_2_10006.stepTime <= 0 then
						local var_52_3 = var_2_10006.step

						math = var_8
						var_2_10006.stepTime = var_8.random() * (var_52_3[2] - var_52_3[1]) + var_52_3[1]

						arg_52_0:addEnemyData(var_2_10006)
					end

					if arg_52_0._overTime > var_2_10006.stop then
						table = var_7
			...
			if #arg_52_0.enemyList > 0 and arg_52_0.addEnemyTime <= 0 then
				...
				var_52_6(var_52_5, var_2_10006.ADD_ENEMY, var_52_4)
			end
		...
		addEnemyData = function(arg_55_0, arg_55_1)
			...
			if var_55_1 then
				...
				BeachGuardGameView = var_2_10007

				var_2_10004(var_55_2, var_2_10007.ENEMY_COMMING)
			end
			...
			for iter_55_0 = 1, var_55_3.num do
				...
				var_2_10011.insert(arg_55_0.enemyList, {
					id = var_55_5,
					lines = var_2_10010
				})
			end
	...
	local var_58_0 = {
		...
		createDamage = function(arg_64_0, arg_64_1)
			...
			if var_64_7 == var_2_10010.bullet_type_range then
				...
				local var_64_11 = arg_64_0.charCtrl
				local var_64_12 = var_13.getLineCampChars(var_64_11, {
					var_64_3 + 1,
					var_64_3 - 1,
					var_64_3
				}, var_64_10)
				...
				if var_4.target then
					local var_64_13 = var_4.target

					var_2_10014 = var_15.getPos(var_64_13)
				else
					local var_64_14 = arg_64_0.effectFrontTf

					var_2_10014 = var_15.InverseTransformPoint(var_64_14, var_64_1)
				end

				if var_64_12 and #var_64_12 > 0 then
					BeachGuardConst = var_15

					local var_64_15 = var_64_9 * var_15.part_width

					for iter_64_0 = 1, #var_64_12 do
						var_2_10020 = var_64_12[iter_64_0]

						if not var_4.target or var_4.target ~= var_2_10020 then
							math = var_21

							if var_64_15 > var_21.abs(var_2_10014.x - var_2_10020:getPos().x) then
								local var_64_16 = var_2_10020:getWorldPos()

								Clone = var_2_10022
								var_2_10022 = var_2_10022(var_4)
								var_2_10022.target = var_2_10020
				...
				local var_64_17 = var_64_5.type

				BeachGuardConst = var_64_8

				if var_64_17 == var_64_8.bullet_type_disperse then
					local var_64_18 = var_64_5.config.up
					local var_64_19 = var_9.down
					local var_64_20 = var_64_4 == 1 and 2 or 1

					arg_64_0:addDamageByDisperse({
						var_64_3 - 1
					}, var_9.range, var_64_20, var_64_18, var_4)
					arg_64_0:addDamageByDisperse({
						var_64_3 + 1
					}, var_9.range, var_64_20, var_64_19, var_4)
				end
			end

			if var_64_5.buff and #var_64_5.buff > 0 then
				for iter_64_1 = 1, #var_64_5.buff do
					local var_64_21 = var_64_5.buff[iter_64_1]

					BeachGuardConst = var_2_10014

					local var_64_22 = var_2_10014.buff[var_64_21].type
					local var_64_23 = var_2_10014.trigger
					local var_64_24 = var_2_10014.bound
					local var_64_25 = var_4.useChar
					local var_64_26 = var_4.target

					BeachGuardConst = var_2_10020

					if var_64_23 == var_2_10020.buff_trigger_other then
						var_64_26:addBuff(var_2_10014)
					else
						BeachGuardConst = var_2_10020

						if var_64_23 == var_2_10020.buff_trigger_self then
							var_64_25:addBuff(var_2_10014)

							if var_64_24 and var_64_24 ~= nil then
								local var_64_27 = var_4.useChar

								var_2_10020 = var_2_10020.getCamp(var_64_27)

								local var_64_28 = var_4.useChar
								local var_64_29 = var_21.getLineIndex(var_64_28)
								local var_64_30 = var_4.useChar
								local var_64_31 = var_22.getGridIndex(var_64_30)

								if var_64_29 and var_64_31 then
									local var_64_32 = arg_64_0.charCtrl
									local var_64_33 = var_23.getCharByCamp(var_64_32, var_2_10020)

									ipairs = var_64_30

									for iter_64_2, iter_64_3 in var_64_30(var_64_33) do
										if iter_64_3 ~= var_64_25 then
											local var_64_34 = iter_64_3
											local var_64_35 = iter_64_3.getGridIndex(var_64_34)
											local var_64_36 = iter_64_3:getLineIndex()

											math = var_64_34

											if var_64_34.abs(var_64_35 - var_64_31) <= var_64_24[1] then
												math = var_31

												if var_31.abs(var_64_36 - var_64_29) <= var_64_24[2] then
		...
		addDamageByDisperse = function(arg_65_0, arg_65_1, arg_65_2, arg_65_3, arg_65_4, arg_65_5)
			...
			if var_6.getLineCampChars(var_65_0, arg_65_1, arg_65_3) and #var_6 > 0 then
				...
				for iter_65_0 = 1, #var_6 do
					...
					if var_2_10015.abs(var_65_3.x - var_65_5.x) < var_65_1 then
						var_2_10015 = var_13:getWorldPos()
						Clone = var_65_4

						local var_65_6 = var_65_4(arg_65_5)

						var_65_6.target = var_13

						arg_65_0:createDamage({
							damage = arg_65_4,
							position = var_2_10015,
							useData = var_65_6
						})
					end
				end
		...
		getEffect = function(arg_67_0, arg_67_1)
			...
			setParent = var_2_10005

			var_2_10005(var_67_3, arg_67_0.effectFrontTf)
		...
		step = function(arg_69_0, arg_69_1)
			...
			for iter_69_0 = 1, #var_69_1 do
				...
				for iter_69_1, iter_69_2 in var_69_5(var_69_6) do
					if not var_69_7 and iter_69_2:inBulletBound() and iter_69_2:checkBulletCollider(var_69_4) then
						...
						var_69_11.position = var_24.getAnimPos(var_69_12)
		...
		clear = function(arg_71_0)
			for iter_71_0 = #arg_71_0.effects, 1, -1 do
				...
				var_2_10005(var_71_0, var_8.remove(arg_71_0.effects, iter_71_0))
			end
...
function var_0_0.setData(arg_76_0, arg_76_1)
	...
	if arg_76_1.fog then
		...
		var_1_10007(var_9(arg_76_0._tf, "sceneContainer/scene_front/fog"), true)
	else
		setActive = var_1_10007
		findTF = var_9

		var_1_10007(var_9(arg_76_0._tf, "sceneContainer/scene_front/fog"), false)
	end

	GetComponent = var_1_10007
	findTF = var_9

	local var_76_6 = var_9(arg_76_0._tf, "sceneBg/map")

	typeof = var_1_10010
	Image = var_12

	local var_76_7 = var_1_10007(var_76_6, var_1_10010(var_12))

	BeachGuardAsset = var_76_5
	var_76_7.sprite = var_76_5.getBeachMap(var_76_2.pic)
...
function var_0_0.step(arg_78_0)
	...
	if var_2.getEnemyOver(var_78_6) then
		...
		var_78_8(var_78_7, var_5.GAME_OVER)
	else
		...
		if #var_2.getEnemys(var_78_9) == 0 then
			...
			if var_2.getFinishCreate(var_78_10) then
				...
				var_78_12(var_78_11, var_5.GAME_OVER)
			end
		end
	end
