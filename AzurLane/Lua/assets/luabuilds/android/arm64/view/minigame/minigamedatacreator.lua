...
function var_0_0.DataCreateFunc(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	if arg_1_0 == var_1_10004.CMD_SPECIAL_GAME then
		...
		local var_1_4 = {}
		local var_1_5 = var_1_3:getConfig("type")

		MiniGameConst = var_10

		local var_1_8

		if var_1_5 == var_10.MG_TYPE_3 then
			if var_1_1 == 1 then
			...
			local var_1_6 = var_1_3:getConfig("type")

			MiniGameConst = var_1_8

			if var_1_6 == var_1_8.MG_TYPE_5 then
				if var_1_1 == 1 then
					var_1_4.count = arg_1_2[1]
					var_1_4.isInited = true
				elseif var_1_1 == 2 then
					...
					local var_1_7 = arg_1_1[4]

					var_1_8 = arg_1_1[5]

					local var_1_9 = var_1_3
					local var_1_10 = var_1_3.GetRuntimeData(var_1_9, "kvpElements")[1]

					table = var_1_9

					var_1_9.insert(var_1_10, {
						key = var_1_7,
						value = var_1_8
					})
		...
		local var_1_11 = var_1_3:getConfig("type")

		MiniGameConst = var_1_8

		if var_1_11 ~= var_1_8.MG_TYPE_2 or var_1_1 ~= 1 then
			MiniGameConst = var_1_12

			if var_1_11 ~= var_1_12.MG_TYPE_5 or var_1_1 ~= 1 then
				MiniGameConst = var_1_12

				local var_1_12

				if var_1_11 == var_1_12.MG_TYPE_4 then
					var_1_12 = {}

					for iter_1_0 = 1, #arg_1_2 do
						var_1_12[iter_1_0] = arg_1_2[iter_1_0]
					end
					...
					for iter_1_1, iter_1_2 in var_12(arg_1_3) do
						...
						var_1_13[iter_1_2.key] = var_1_14
					end

					var_1_4.elements = var_1_12
					var_1_4.kvpElements = var_1_13
				end

				pairs = var_1_12

				for iter_1_5, iter_1_6 in var_1_12(var_1_4) do
