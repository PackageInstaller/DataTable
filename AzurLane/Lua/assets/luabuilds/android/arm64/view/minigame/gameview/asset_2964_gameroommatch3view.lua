...
function var_0_1.didEnter(arg_5_0)
	...
	var_1_10001(arg_5_0, arg_5_0.startBtn, function()
		...
		if var_0_8 then
			...
			local var_7_7 = var_7_4(var_7_3, var_7_5, var_7_6, var_2_10005(arg_5_0.mainPage), 1, 0, var_0_21)
...
function var_0_1.updateData(arg_20_0)
	...
	arg_20_0.infinite = arg_20_0.GetMGHubData(var_20_0).count == 0

	local var_20_1 = arg_20_0:GetMGData()
	local var_20_2 = var_2.GetRuntimeData(var_20_1, "elements")
	...
	arg_20_0.best = var_3.getRoomScore(var_20_3, arg_20_0:getGameRoomData().id)
...
function var_0_1.startGame(arg_37_0)
	...
	arg_37_0.handle = var_1_10002:CreateListener(function()
		...
		var_2_10000(var_41_0, var_2_10003.floor(var_37_0.time))
