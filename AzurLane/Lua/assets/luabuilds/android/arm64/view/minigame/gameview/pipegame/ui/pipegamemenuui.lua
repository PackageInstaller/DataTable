...
local var_0_0 = var_0_10000("PipeGameMenuUI")
local var_0_1
...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_14 = arg_1_0.imgHelp
	...
	local var_1_17 = arg_1_0.btnStart
	...
	local var_1_20 = arg_1_0.btnRank
	...
	local var_1_23 = arg_1_0.btnHome
	...
	var_3(var_1_22, var_1_23, var_1_24, var_8)

	findTF = var_3

	local var_1_25 = var_3(arg_1_0.menuUI, "tplBattleItem")
	local var_1_26 = var_0_1.drop

	for iter_1_0 = 1, 7 do
		local var_1_27 = iter_1_0

		tf = var_1_10010
		instantiate = var_1_10012
		var_1_10010 = var_1_10010(var_1_10012(var_1_25))
		var_1_10010.name = "battleItem_" .. iter_1_0
		setParent = var_11

		local var_1_28 = var_1_10010

		findTF = var_14

		var_11(var_1_28, var_14(arg_1_0.menuUI, "battList/Viewport/Content"))
		...
		local var_1_30 = {
			type = var_1_26[iter_1_0][1],
			id = var_1_26[iter_1_0][2],
			amount = var_1_26[iter_1_0][3]
		}

		updateDrop = var_14

		var_14(var_1_10012, var_1_30)

		onButton = var_14

		local var_1_31 = arg_1_0._event
		local var_1_32 = var_1_10012
		...
		local function var_1_33()
			...
			var_10_1(var_10_0, var_2_10003.ON_DROP, var_1_30)
		...
		var_14(var_1_31, var_1_32, var_1_33, var_1_10019)
		...
		local var_1_34 = var_0_1.GetGameUseTimes()
		local var_1_35 = var_0_1.GetGameTimes()
	end
...
function var_0_0.update(arg_13_0, arg_13_1)
	...
	for iter_13_0 = 1, 7 do
		...
		var_1_10008(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_open"), false)

		setActive = var_1_10008
		findTF = var_1_10010

		var_1_10008(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_closed"), false)

		setActive = var_1_10008
		findTF = var_1_10010

		var_1_10008(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_clear"), false)

		setActive = var_1_10008
		findTF = var_1_10010

		var_1_10008(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_current"), false)

		if iter_13_0 <= var_13_1 then
			SetParent = var_1_10008
			var_1_10010 = arg_13_0.dropItems[iter_13_0]
			findTF = var_11

			var_1_10008(var_1_10010, var_11(arg_13_0.battleItems[iter_13_0], "state_clear/icon"))
			...
			var_1_10008(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_clear"), true)
		elseif iter_13_0 == var_13_1 + 1 and 1 <= var_13_2 then
			setActive = var_1_10008
			findTF = var_1_10010

			var_1_10008(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_current"), true)

			SetParent = var_1_10008
			var_1_10010 = arg_13_0.dropItems[iter_13_0]
			findTF = var_11

			var_1_10008(var_1_10010, var_11(arg_13_0.battleItems[iter_13_0], "state_current/icon"))
		...
		elseif var_13_1 < iter_13_0 and iter_13_0 <= var_13_1 + var_13_2 then
			...
			var_1_10008(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_open"), true)

			SetParent = var_1_10008
			var_1_10010 = arg_13_0.dropItems[iter_13_0]
			findTF = var_11

			var_1_10008(var_1_10010, var_11(arg_13_0.battleItems[iter_13_0], "state_open/icon"))
			...
			var_1_10008(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_closed"), true)

			SetParent = var_1_10008
			var_1_10010 = arg_13_0.dropItems[iter_13_0]
			findTF = var_11

			var_1_10008(var_1_10010, var_11(arg_13_0.battleItems[iter_13_0], "state_closed/icon"))
...
function var_0_0.CheckGet(arg_14_0)
	...
	var_1_10002(var_1_10004(arg_14_0.menuUI, "got"), false)

	if arg_14_0:getUltimate(var_14_0) and var_2 ~= 0 then
	...
	if var_2 == 0 then
		if var_0_1.total_times > arg_14_0:getGameUsedTimes(var_14_0) then
			return
		end

		pg = var_5

		local var_14_1 = var_5.m02
		local var_14_2 = var_5.sendNotification

		GAME = var_1_10008

		local var_14_3 = var_1_10008.SEND_MINI_GAME_OP
		local var_14_4 = {
			hubid = var_14_0.id
		}

		MiniGameOPCommand = var_10
		var_14_4.cmd = var_10.CMD_ULTIMATE
		var_14_4.args1 = {}
		...
		var_14_2(var_14_1(arg_14_0.menuUI, "got"), true)
	end
