...
function var_0_1.initEvent(arg_6_0)
	...
	arg_6_0:bind(var_0_1.SHOW_RULE, function(arg_17_0, arg_17_1, arg_17_2)
		...
		var_17_2.type = var_2_10007
		pg = var_2_10007
		var_17_2.helps = var_2_10007.gametip[var_0_2.rule_tip].tip
...
function var_0_1.initUI(arg_23_0)
	...
	if var_1_10001 then
		...
		var_1_10001(var_1_10003(arg_23_0._tf, "tpl"), false)
	end
...
function var_0_1.initBgAnimation(arg_24_0)
	...
	local var_24_2 = var_24_1(var_24_0, var_1_10004.BOAT_QIAN_SHAO_ZHAN)

	getProxy = var_1_10002
	TaskProxy = var_4

	local var_24_3 = var_1_10002(var_4)
	local var_24_4 = {
		"Phase_00",
		"Phase_01",
		"Phase_02",
	...
	local var_24_9 = var_6(var_24_8, var_9(var_11))
...
function var_0_1.Update(arg_25_0)
	...
	if var_1 then
		...
		if var_25_0(var_1_10003.S) then
			var_25_1 = arg_25_0.gameUI
			var_25_2 = var_25_2.press
			KeyCode = var_1_10004

			var_25_2(var_25_1, var_1_10004.S, true)
		end
		...
		if var_25_3(var_25_1.S) then
			...
			var_25_5(var_25_4, var_1_10004.S, false)
		end
		...
		if var_25_6(var_25_4.W) then
			...
			var_25_8(var_25_7, var_1_10004.W, true)
		end
		...
		if var_25_9(var_25_7.W) then
			...
			var_25_11(var_25_10, var_1_10004.W, false)
		end
		...
		if var_25_12(var_25_10.A) then
			...
			var_25_14(var_25_13, var_1_10004.A, true)
		end
		...
		if var_25_15(var_25_13.A) then
			...
			var_25_17(var_25_16, var_1_10004.A, false)
		end
		...
		if var_25_18(var_25_16.D) then
			...
			var_25_20(var_25_19, var_1_10004.D, true)
		end
		...
		if var_25_21(var_25_19.D) then
			...
			var_25_23(var_25_22, var_1_10004.D, false)
		end
		...
		if var_25_24(var_25_22.J) then
			...
			var_25_26(var_25_25, var_1_10004.J, true)
		end
	end
...
function var_0_1.onGameOver(arg_36_0)
	...
	local var_36_1 = var_3(arg_36_0._tf)
	local var_36_2 = 0.1

	System = var_5

	var_36_0(var_36_1, var_36_2, var_5.Action(function()
