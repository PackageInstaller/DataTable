...
function var_0_0.initCountUI(arg_2_0)
	...
	arg_2_0.countAnimator = var_1(var_2_0, var_4(var_1_10006))
	...
	arg_2_0.countDft = var_1(var_2_1, var_4(var_1_10006))
...
function var_0_0.initLeavelUI(arg_5_0)
	...
	local var_5_2 = var_4(arg_5_0.leaveUI, "ad/btnConfirm")
	...
	local function var_5_3()
		...
		CrossRoadGameView = var_2_10003

		var_6_2(var_6_1, var_2_10003.LEAVEL_GAME, true)
	...
	var_1(var_5_1, var_5_2, var_5_3, var_6)
	...
	local function var_5_6()
		...
		var_7_2(var_7_1, var_2_10003.LEAVEL_GAME, false)
	...
	var_1(var_5_4, var_5_5, var_5_6, var_6)
...
function var_0_0.initSettlementUI(arg_8_0)
	...
	local var_8_1 = var_4(arg_8_0.settlementUI, "ad/btnOver")
	...
	local function var_8_2()
		...
		var_9_2(var_9_1, var_2_10003.BACK_MENU)
	...
	local function var_8_5()
		...
		var_10_2(var_10_1, var_2_10003.AGAIN)
...
function var_0_0.UpdateSettlementUI(arg_16_0)
	...
	local var_16_0 = var_1_10003(arg_16_0.settlementUI, "ad")

	typeof = var_1_10004
	Animator = var_6

	local var_16_1 = var_1_10001(var_16_0, var_1_10004(var_6))
	...
	var_16_2(var_16_6, var_7("mini_game_crossroad_score"))

	setText = var_16_2

	var_16_2(arg_16_0.curScoreTextCnt, var_16_3)
	...
	var_16_2(var_16_7, var_7("mini_game_crossroad_cnt"))

	setText = var_16_2

	var_16_2(arg_16_0.curRoleTextCnt, var_16_5)
	...
	var_16_9(var_16_8, var_7.SUBMIT_GAME_SUCCESS, {
		num = var_16_3,
		cnt = var_16_5
	})
...
function var_0_0.BackPressed(arg_17_0)
	...
	if var_1_10001(arg_17_0.leaveUI) then
		...
		var_17_1(var_17_0, var_1_10004.LEAVEL_GAME, false)
	else
		setActive = var_17_1
		...
		var_17_3(var_17_2, var_4.PAUSE_GAME, true)
	end
...
function var_0_0.UpdateGameUI(arg_19_0, arg_19_1)
	...
	var_1_10002(var_19_0, var_5.ceil(arg_19_1.gameTime))
...
function var_0_0.ReadyStart(arg_20_0)
	...
	var_20_2(var_20_1, var_4.SFX_COUNT_DOWN)
