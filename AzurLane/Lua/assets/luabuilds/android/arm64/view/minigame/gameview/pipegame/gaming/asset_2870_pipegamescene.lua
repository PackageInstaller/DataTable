...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0._moveAnimator = var_3(var_1_0, var_6(var_1_10008))
	findTF = var_3
	arg_1_0._bgRight = var_3(arg_1_0.sceneContent, "scene_background/content/bgRight")
	GetComponent = var_3
	findTF = var_5

	local var_1_1 = var_5(arg_1_0._bgRight, "img")

	typeof = var_6
	Animator = var_8
	arg_1_0._bgRightAnimator = var_3(var_1_1, var_6(var_8))
		...
		if arg_2_0 == var_2_10002.REMOVE_RECT_TOP then
			...
			if arg_2_0 == var_2.PALY_ANIMATION_COMPLETE then
				...
				var_2_1.playMove(var_2_3, function()
					...
					PipeGameEvent = var_3_10003

					var_3_1(var_3_0, var_3_10003.GAME_OVER)
	...
	PipeMapControl = var_1_10004

	local var_1_3 = var_1_10004.New

	findTF = var_6
	arg_1_0.mapCtrl = var_1_3(var_6(arg_1_0.sceneContent, "scene/content/map"), var_1_2)
	...
	local var_1_5 = var_6(arg_1_0.sceneContent, "scene/content/rect")

	findTF = var_7
	arg_1_0.rectCtrl = var_1_4(var_1_5, var_7(arg_1_0.sceneContent, "scene/content/dragPos"), var_1_2)
	PiPePassTest = var_4
...
function var_0_0.dispose(arg_11_0)
	...
	if var_11_3(var_11_2(arg_11_0.sceneContent)) then
		...
		var_11_4(var_3(arg_11_0.sceneContent))
	end
...
function var_0_0.playMove(arg_13_0, arg_13_1)
	...
	var_13_2(var_13_1, var_6(var_13_0))
	...
	var_13_4(var_13_5, var_13_6, var_7.Action(function()
		if arg_13_1 then
			arg_13_1()
		end
