...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_6 = var_5(arg_1_0.skill, "ad/anim")

	typeof = var_6
	Animator = var_8
	arg_1_0.skillAnim = var_3(var_1_6, var_6(var_8))
	onButton = var_3
	...
	var_3(arg_1_0._event, arg_1_0.skill, function()
		...
		var_4_1(var_4_0, var_2_10003.PRESS_SKILL)
...
function var_0_0.step(arg_9_0)
	...
	if var_1_10001.enemyStopTime then
		...
		if 0 < var_9_0 then
			...
			arg_9_0.subGameStepTime = var_9_0 + var_1_10002.deltaTime
		end
	end
	...
	local var_9_2 = var_1_10004.floor

	LaunchBallGameVo = var_1_10006

	var_9_0(var_9_1, var_9_2(var_1_10006.gameStepTime - arg_9_0.subGameStepTime))
	...
	var_9_0(var_9_3, var_4.scoreNum)

	LaunchBallGameVo = var_9_0

	if var_9_0.pressSkill and var_1.time > 0 then
		setFillAmount = var_1_10002

		var_1_10002(arg_9_0.skillCd, var_1.time / var_1.data.cd_time)

		isActive = var_1_10002

		if not var_1_10002(arg_9_0.skillCd) then
			local var_9_4 = arg_9_0.skillAnim

			var_1_10002.Play(var_9_4, "empty")

			setActive = var_1_10002

			var_1_10002(arg_9_0.skillCd, true)
		end
	else
		isActive = var_1_10002

		if var_1_10002(arg_9_0.skillCd) then
			setActive = var_2
