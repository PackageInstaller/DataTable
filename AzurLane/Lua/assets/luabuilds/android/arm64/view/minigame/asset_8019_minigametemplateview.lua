...
function var_0_1.updateMainUI(arg_4_0)
	if arg_4_0:getShowSide() then
		...
		local var_4_3 = var_5.min(var_1.usedtime + 1, var_4_2)
		...
		for iter_4_0 = 1, var_4_4 do
			...
			var_1_10015 = var_6
			var_1_10013 = var_6.GetChild(var_1_10015, iter_4_0 - 1)
			setActive = var_1_10014

			var_1_10014(var_1_10013:Find("finish"), var_4_5.finish)

			setActive = var_1_10014

			var_1_10014(var_1_10013:Find("lock"), var_4_5.lock)
			...
			var_1_10014(var_4_6, var_4_7)

			triggerToggle = var_1_10014

			var_1_10014(var_1_10013, iter_4_0 == var_4_3)
		end

		local var_4_8 = var_6:GetChild(0).anchoredPosition.y
		local var_4_9 = var_6
		local var_4_10 = var_4_8 - var_6.GetChild(var_4_9, var_4_3 - 1).anchoredPosition.y
		local var_4_11 = var_6.rect.height
		local var_4_12 = var_6
		local var_4_13 = var_6.GetComponent

		typeof = var_1_10013
		ScrollRect = var_1_10015

		local var_4_14 = var_4_13(var_4_12, var_1_10013(var_1_10015)).viewport.rect.height

		math = var_4_9

		local var_4_15 = var_4_9.clamp(var_4_10, 0, var_4_11 - var_4_14) / (var_4_11 - var_4_14)

		scrollTo = var_12

		var_12(var_6, nil, 1 - var_4_15)
	end
...
function var_0_1.checkGet(arg_5_0)
	if arg_5_0:GetMGHubData().ultimate == 0 then
		...
		var_5_5.cmd = var_7.CMD_ULTIMATE
		var_5_5.args1 = {}
...
function var_0_1.initPageUI(arg_6_0)
	...
	local var_6_5 = var_6_2.Find(var_6_4, "btn_back")
	...
	var_1_10002(var_6_3, var_6_5, var_6_6, var_6_4)

	onButton = var_1_10002

	local var_6_7 = arg_6_0
	local var_6_8 = var_6_2
	local var_6_9 = var_6_2.Find(var_6_8, "btn_help")
	...
	local function var_6_10()
		...
		pg = var_2_10004
		var_8_2.helps = var_2_10004.gametip["2023spring_minigame_help"].tip
	...
	var_1_10002(var_6_7, var_6_9, var_6_10, var_6_8)

	local var_6_11 = arg_6_0:GetMGData()
	local var_6_12 = var_2.GetSimpleValue(var_6_11, "story")

	onButton = var_6_1

	local var_6_13 = arg_6_0
	local var_6_14 = var_6_2
	local var_6_15 = var_6_2.Find(var_6_14, "btn_start")
	...
	local function var_6_16()
		...
		if var_2_10001(var_6_12, {
			...
			var_2_10002.insert(var_9_0, function(arg_10_0)
				pg = var_3_10001
	...
	var_6_1(var_6_13, var_6_15, var_6_16, var_6_14)

	arg_6_0.stageIndex = 0

	local var_6_17 = arg_6_0

	if arg_6_0.getShowSide(var_6_17) then
		pg = var_3

		local var_6_18 = var_3.mini_game[arg_6_0:GetMGData().id].simple_config_data.drop
		local var_6_19 = var_6_2:Find("side_panel/award/content")

		UIItemList = var_6_17
		arg_6_0.itemList = var_6_17.New(var_6_19, var_6_19:GetChild(0))

		local var_6_20 = arg_6_0.itemList

		var_5.make(var_6_20, function(arg_12_0, arg_12_1, arg_12_2)
			arg_12_1 = arg_12_1 + 1
			UIItemList = var_2_10003

			if arg_12_0 == var_2_10003.EventUpdate then
				local var_12_0 = arg_12_2
				local var_12_1 = arg_12_2.Find(var_12_0, "IconTpl")
				local var_12_2 = {}

				unpack = var_12_0

				local var_12_3, var_12_4, var_12_5 = var_12_0(var_6_18[arg_12_1])

				var_12_2.count = var_12_5
				var_12_2.id = var_12_4
				var_12_2.type = var_12_3
				updateDrop = var_12_3

				var_12_3(var_12_1, var_12_2)

				onButton = var_12_3

				local var_12_6 = arg_6_0
				local var_12_7 = var_12_1

				local function var_12_8()
					local var_13_0 = arg_6_0

					var_0.emit(var_13_0, var_0_1.ON_DROP, var_12_2)
				...
				var_12_3(var_12_6, var_12_7, var_12_8, var_2_10010)

				onToggle = var_12_3

				var_12_3(arg_6_0, arg_12_2, function(arg_14_0)
					if arg_14_0 then
		...
		local var_6_21 = arg_6_0.itemList

		var_5.align(var_6_21, #var_6_18)
	end

	local var_6_22 = arg_6_0.rtTitlePage
	local var_6_23 = var_3.Find(var_6_22, "countdown")
	local var_6_24 = var_3.Find(var_6_23, "bg/Image")
	local var_6_25 = var_4.GetComponent

	typeof = var_7
	DftAniEvent = var_9

	local var_6_26 = var_6_25(var_6_24, var_7(var_9))

	var_4.SetEndEvent(var_6_26, function()
	...
	local var_6_27 = arg_6_0.rtTitlePage
	local var_6_28 = var_4.Find(var_6_27, "pause")

	onButton = var_6_22

	local var_6_29 = arg_6_0
	local var_6_30 = var_6_28
	local var_6_31 = var_6_28.Find(var_6_30, "window/btn_confirm")
	...
	SFX_CONFIRM = var_6_30

	var_6_22(var_6_29, var_6_31, var_6_32, var_6_30)

	local var_6_33 = arg_6_0.rtTitlePage
	local var_6_34 = var_5.Find(var_6_33, "exit")

	onButton = var_6_27

	local var_6_35 = arg_6_0
	local var_6_36 = var_6_34
	local var_6_37 = var_6_34.Find(var_6_36, "window/btn_cancel")
	...
	var_6_27(var_6_35, var_6_37, var_6_38, var_6_36)

	onButton = var_6_27

	local var_6_39 = arg_6_0
	local var_6_40 = var_6_34
	local var_6_41 = var_6_34.Find(var_6_40, "window/btn_confirm")
	...
	SFX_CONFIRM = var_6_40

	var_6_27(var_6_39, var_6_41, var_6_42, var_6_40)

	local var_6_43 = arg_6_0.rtTitlePage
	local var_6_44 = var_6.Find(var_6_43, "result")

	onButton = var_6_33

	local var_6_45 = arg_6_0
	local var_6_46 = var_6_44
	local var_6_47 = var_6_44.Find(var_6_46, "window/btn_finish")
	...
	SFX_CONFIRM = var_6_46

	var_6_33(var_6_45, var_6_47, var_6_48, var_6_46)
...
function var_0_1.initControllerUI(arg_20_0)
	...
	local var_20_4 = var_20_1.Find(var_20_3, "btn_back")
	...
	var_1_10002(var_20_2, var_20_4, var_20_5, var_20_3)

	onButton = var_1_10002

	var_1_10002(arg_20_0, var_20_1:Find("btn_pause"), function()
...
function var_0_1.initOpenUISwich(arg_25_0)
	arg_25_0.openSwitchDic = {
		...
		result = function()
			...
			var_2_10004(var_29_6:Find("window/now/new"), var_29_4 < var_29_3)
...
function var_0_1.openUI(arg_30_0, arg_30_1)
	...
	if arg_30_0.status then
		...
		var_2(var_4.Find(var_30_0, arg_30_0.status), false)
	end
	...
	if arg_30_1 then
		...
		var_2(var_4.Find(var_30_1, arg_30_1), true)
	end
