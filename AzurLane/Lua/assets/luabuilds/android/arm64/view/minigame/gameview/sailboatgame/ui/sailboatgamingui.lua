...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_0 = var_5(arg_1_0._gameUI, "progress")

	typeof = var_6
	Slider = var_8
	arg_1_0.progress = var_3(var_1_0, var_6(var_8))
	findTF = var_3
	...
	local function var_1_3()
		...
		if var_0_1.UseSkill() then
			...
			var_2_1(var_2_0, var_2_10003.USE_SKILL)
	...
	findTF = var_5
	arg_1_0.joyStick = var_1_10(var_5(arg_1_0._gameUI, "joyStick"))
	...
	typeof = var_6
	Slider = var_8
	arg_1_0._hpSlider = var_3(var_1_12, var_6(var_8))
	findTF = var_3
...
function var_0_0.step(arg_10_0, arg_10_1)
	if not arg_10_0._char then
		...
		local var_10_1 = arg_10_0._char

		var_10_0.maxValue = var_3.getMaxHp(var_10_1)
	end

	local var_10_2 = var_0_1.gameTime
	local var_10_3 = var_0_1.gameStepTime
	...
	local var_10_4 = arg_10_0.gameTime

	math = var_7

	var_1_10004(var_10_4, var_7.floor(var_10_2))

	arg_10_0.progress.value = var_10_3 / arg_10_0.maxProgress
	...
	var_4.setDirectTarget(var_10_6, arg_10_0.direct)
	...
	local var_10_7 = arg_10_0.joyStick

	var_4.joyStickData = var_5.getValue(var_10_7)
	setText = var_4

	var_4(arg_10_0.skillCount, var_0_1.GetSkill())

	local var_10_8 = arg_10_0._char
	local var_10_9 = var_4.getHpPos(var_10_8)

	arg_10_0._hpTf.position = var_10_9
	arg_10_0.powerTf.position = var_10_9

	local var_10_10 = arg_10_0._hpSlider
	local var_10_11 = arg_10_0._char

	var_10_10.value = var_6.getHp(var_10_11)
