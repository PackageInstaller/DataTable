...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	var_4(var_1_2, var_1_10007("pac_game_start_btn"))
	...
	var_4(var_1_3, var_7("pac_game_rule_btn"))
...
function var_0_0.initUI(arg_2_0)
	...
	for iter_2_0 = 1, 7 do
		...
		local var_2_27 = var_2_26(var_2_25, "ad/desc")

		i18n = var_11

		var_8(var_2_27, var_11("which_day_2", var_2_24))

		findTF = var_8

		local var_2_28 = var_8(var_2_25, "ad/iconMask/icon")
		...
		var_10(var_2_29, var_2_30, var_2_31, var_1_10015)
...
function var_0_0.Update(arg_13_0)
	...
	if var_13_6(var_13_5, var_8.GetGameId(var_13_7)) then
		local var_13_8 = #var_5
		local var_13_9

		if not (0 < var_13_8) or not var_5[1] then
			var_13_9 = 0
		end

		setText = var_13_5

		local var_13_10 = arg_13_0.highScore

		i18n = var_13_7

		var_13_5(var_13_10, var_13_7("pac_game_high_score_tip", var_13_9))
