...
function var_0_0.updatePlayerDirect(arg_12_0)
	...
	local var_12_4 = var_12_3 - var_1_10005.abs(var_12_2)

	if 0.3 <= var_12_4 then
		var_12_2 = 0
	else
		math = var_12_4
...
function var_0_0.createRole(arg_15_0, arg_15_1)
	...
	PacGameRole = var_1_10005

	return (var_1_10005.New(var_15_2, var_2))
end
...
function var_0_0.createRoles(arg_16_0, arg_16_1)
	...
	for iter_16_0 = 1, #arg_16_1 do
		...
		var_1_10008.insert(var_16_0, var_16_1)
	end
