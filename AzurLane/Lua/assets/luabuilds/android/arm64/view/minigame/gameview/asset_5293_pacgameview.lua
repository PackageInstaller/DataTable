...
function var_0_1.initEvent(arg_5_0)
	...
	var_5_23(var_5_22, var_4.READY_START, function(arg_18_0, arg_18_1, arg_18_2)
		...
		var_2_10004(var_18_1 .. var_2_10007(var_18_0))
...
function var_0_1.gameStep(arg_28_0)
	if arg_28_0.gameStartFlag and not arg_28_0.gameStop and not arg_28_0.settlementFlag then
		...
		if var_1.GetTime(var_1_10003) <= 0 then
			...
			arg_28_0.onGameOver(var_1_10003)
		end
	end
	...
	if var_1 then
		...
		if var_28_12(var_28_10.W) then
			...
			var_28_14(var_28_13, var_1_10004.W, true)
		end
		...
		if var_28_15(var_28_13.W) then
			...
			var_28_17(var_28_16, var_1_10004.W, false)
		end
		...
		if var_28_18(var_28_16.S) then
			...
			var_28_20(var_28_19, var_1_10004.S, true)
		end
		...
		if var_28_21(var_28_19.S) then
			...
			var_28_23(var_28_22, var_1_10004.S, false)
		end
	end
...
function var_0_1.onGameOver(arg_37_0, arg_37_1)
	...
	local var_37_2 = var_4(arg_37_0._tf)
	local var_37_3 = 0.1

	System = var_6

	var_37_1(var_37_2, var_37_3, var_6.Action(function()
