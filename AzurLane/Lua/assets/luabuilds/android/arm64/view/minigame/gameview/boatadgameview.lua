...
local var_0_2 = var_0_10001("view.miniGame.gameView.BoatAdGame.BoatAdGameVo")
...
function var_0_1.checkGet(arg_4_0)
	...
	if var_0_2.GetGameTimes() == 0 then
		...
		local var_4_2 = var_1_10009.SEND_MINI_GAME_OP
		local var_4_3 = {
			hubid = var_1.id
		}

		MiniGameOPCommand = var_11
		var_4_3.cmd = var_11.CMD_ULTIMATE
		var_4_3.args1 = {}
...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.timer = var_2.New(function()
		...
		local var_6_0 = var_2_10000.realtimeSinceStartup - arg_5_0.realTimeStartUp

		if arg_5_0.stepCount < var_6_0 then
			local var_6_1 = arg_5_0

			var_0.onTimer(var_6_1)

			local var_6_2 = arg_5_0

			Time = var_1
			var_6_2.realTimeStartUp = var_1.realtimeSinceStartup
		end
...
function var_0_1.initEvent(arg_7_0)
	...
	var_7_1(var_7_0, var_1_10004.LEVEL_GAME, function(arg_8_0, arg_8_1, arg_8_2)
		if arg_8_1 then
	...
	var_7_3(var_7_2, var_4.USE_SKILL, function(arg_9_0, arg_9_1, arg_9_2)
	...
	var_7_5(var_7_4, var_4.COUNT_DOWN, function(arg_10_0, arg_10_1, arg_10_2)
	...
	var_7_7(var_7_6, var_4.OPEN_PAUSE_UI, function(arg_11_0, arg_11_1, arg_11_2)
	...
	var_7_9(var_7_8, var_4.OPEN_LEVEL_UI, function(arg_12_0, arg_12_1, arg_12_2)
	...
	var_7_11(var_7_10, var_4.PAUSE_GAME, function(arg_13_0, arg_13_1, arg_13_2)
		if arg_13_1 then
	...
	var_7_13(var_7_12, var_4.BACK_MENU, function(arg_14_0, arg_14_1, arg_14_2)
		local var_14_0 = arg_7_0.menuUI
		local var_14_1 = var_3.update
		local var_14_2 = arg_7_0

		var_14_1(var_14_0, var_6.GetMGHubData(var_14_2))
		...
		if not var_3.getBGM(var_14_6) then
			...
			local var_14_7 = var_2_10004.CriMgr.GetInstance()
	...
	var_7_15(var_7_14, var_4.CLOSE_GAME, function(arg_15_0, arg_15_1, arg_15_2)
	...
	var_7_17(var_7_16, var_4.BACK_HOME, function(arg_16_0, arg_16_1, arg_16_2)
		local var_16_0 = arg_7_0
		local var_16_1 = var_3.emit

		BaseUI = var_2_10006

		var_16_1(var_16_0, var_2_10006.ON_HOME)
	...
	var_7_19(var_7_18, var_4.GAME_OVER, function(arg_17_0, arg_17_1, arg_17_2)
	...
	var_7_21(var_7_20, var_4.SHOW_RULE, function(arg_18_0, arg_18_1, arg_18_2)
		pg = var_2_10003
		...
		var_18_2.type = var_2_10007
		pg = var_2_10007
		var_18_2.helps = var_2_10007.gametip[var_0_2.rule_tip].tip
	...
	var_7_23(var_7_22, var_4.READY_START, function(arg_19_0, arg_19_1, arg_19_2)
	...
	var_7_25(var_7_24, var_4.STORE_SERVER, function(arg_20_0, arg_20_1, arg_20_2)
	...
	var_7_27(var_7_26, var_4.SUBMIT_GAME_SUCCESS, function(arg_21_0, arg_21_1, arg_21_2)
		...
		local var_21_6 = var_2_10007.m02
		local var_21_7 = var_7.sendNotification

		GAME = var_2_10010

		local var_21_8 = var_2_10010.SEND_MINI_GAME_OP
		local var_21_9 = {}
		local var_21_10 = arg_7_0

		var_21_9.hubid = var_12.GetMGHubData(var_21_10).id
		MiniGameOPCommand = var_12
		var_21_9.cmd = var_12.CMD_SUCCESS_DATA
		var_21_9.args1 = {
			var_21_3,
			var_21_4,
			var_21_5
	...
	var_7_29(var_7_28, var_4.ADD_SCORE, function(arg_22_0, arg_22_1, arg_22_2)
	...
	BoatAdGameEvent = var_4

	var_7_31(var_7_30, var_4.OPEN_AD_WINDOW, function(arg_23_0, arg_23_1, arg_23_2)
	...
	var_7_33(var_7_32, var_4.CLOSE_AD_UI, function(arg_24_0, arg_24_1, arg_24_2)
...
function var_0_1.initUI(arg_25_0)
	...
	if var_1_10001 then
		...
		var_1_10001(var_1_10003(arg_25_0._tf, "tpl"), false)
	end
...
function var_0_1.Update(arg_26_0)
	...
	if var_1 then
		...
		if var_26_0(var_1_10003.S) then
			var_26_1 = arg_26_0.gameUI
			var_26_2 = var_26_2.press
			KeyCode = var_1_10004

			var_26_2(var_26_1, var_1_10004.S, true)
		end
		...
		if var_26_3(var_26_1.S) then
			...
			var_26_5(var_26_4, var_1_10004.S, false)
		end
		...
		if var_26_6(var_26_4.W) then
			...
			var_26_8(var_26_7, var_1_10004.W, true)
		end
		...
		if var_26_9(var_26_7.W) then
			...
			var_26_11(var_26_10, var_1_10004.W, false)
		end
		...
		if var_26_12(var_26_10.A) then
			...
			var_26_14(var_26_13, var_1_10004.A, true)
		end
		...
		if var_26_15(var_26_13.A) then
			...
			var_26_17(var_26_16, var_1_10004.A, false)
		end
		...
		if var_26_18(var_26_16.D) then
			...
			var_26_20(var_26_19, var_1_10004.D, true)
		end
		...
		if var_26_21(var_26_19.D) then
			...
			var_26_23(var_26_22, var_1_10004.D, false)
		end
		...
		if var_26_24(var_26_22.J) then
			...
			var_26_26(var_26_25, var_1_10004.J, true)
		end
	end
