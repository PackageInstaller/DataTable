...
function var_0_0.AddListener(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10004.EVENT_DO_CARRY, function(arg_4_0, arg_4_1)
	...
	var_3_3(var_3_2, var_4.EVENT_AKASHI_HIT, function(arg_5_0, arg_5_1)
...
function var_0_0.AddDftAniEvent(arg_6_0)
	...
	var_1_10001(var_3.Find(var_6_0, "main"), function(arg_7_0)
		...
		local var_7_2 = var_7_1(var_7_0, var_4(var_2_10006))
		...
		var_1.SetEndEvent(var_7_2, function()
			if arg_6_0.isDeliver then
				...
				local var_8_5 = var_8_4(var_8_3, var_3(var_3_10005))
	...
	var_1_10001(var_3.Find(var_6_1, "effect"), function(arg_9_0)
...
function var_0_0.Reset(arg_11_0)
	...
	var_1_10001(var_11_0, var_1_10004(0, -100))
	...
	local var_11_4 = var_11_3(var_11_2, var_4(var_6))
...
function var_0_0.ResetStatus(arg_13_0)
	...
	var_1(var_3.Find(var_13_0, "main"), function(arg_14_0)
		for iter_14_0 = 1, 3 do
			local var_14_0 = arg_14_0:Find("ore/Image/" .. iter_14_0 .. "/oreTF")

			removeAllChildren = var_2_10006

			var_2_10006(var_14_0)
		end
...
function var_0_0.AddOre(arg_16_0, arg_16_1)
	...
	var_2(var_4.Find(var_16_0, "main"), function(arg_17_0)
		...
		if var_17_0.childCount < #arg_16_0.oreList - 1 then
			...
			for iter_17_0, iter_17_1 in var_17_6(arg_16_0.oreList) do
				...
				local var_17_4 = var_17_4(var_17_3, var_17_0, iter_17_0)
			end
		else
			...
			local var_17_7 = var_4(var_17_6, var_17_0, #arg_16_0.oreList)
		end
		...
		var_17_6(var_17_1, function(arg_18_0)
			...
			var_3_10001(var_3.Find(var_18_0, arg_18_0.name), arg_18_0.anchoredPosition)
...
function var_0_0.SetStatus(arg_20_0, arg_20_1)
	...
	var_1_10002(var_4.Find(var_20_0, "main"), function(arg_21_0)
		...
		var_2_10001(arg_21_0:Find("ore/Image"), function(arg_22_0)
			...
			var_3_10001(var_22_0, var_22_1 == var_3_10005(arg_22_0.name))
...
function var_0_0.SetAnimDir(arg_23_0, arg_23_1)
	...
	var_1_10002(var_4.Find(var_23_0, "main"), function(arg_24_0)
		local var_24_0
...
function var_0_0.PlayHitAnim(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	var_4(var_6.Find(var_25_0, "effect/EF_Clash_" .. arg_25_1), true)
	...
	local var_25_11 = var_9.EVENT_PLAY_CONTAINER_HIT
	local var_25_12 = {
	...
	local var_25_14 = var_11.Find
	local var_25_15 = "ore/Image/"

	tostring = var_1_10015
	var_25_12.oreTF = var_25_14(var_25_13, var_25_15 .. var_1_10015(arg_25_0.status))
...
function var_0_0.PlayDeliver(arg_26_0)
	...
	var_1(var_3.Find(var_26_0, "tool"), false)

	setActive = var_1

	local var_26_1 = arg_26_0.mainTF

	var_1(var_3.Find(var_26_1, "ore"), false)
	...
	local var_26_5 = var_26_4(var_26_3, var_4(var_6))
...
function var_0_0.CheckDeliver(arg_27_0)
	...
	if var_27_0 < var_1_10002.RANGE_Y[1] + 2 and arg_27_0._tf.anchoredPosition.x > -100 and arg_27_0._tf.anchoredPosition.x < 100 and arg_27_0.animDir == "S" and arg_27_0.weight > 0 then
		...
		local var_27_3 = var_1_10004.EVENT_DELIVER
		local var_27_4 = {
		...
		local var_27_6 = var_6.Find
		local var_27_7 = "ore/Image/"

		tostring = var_1_10010
		var_27_4.oreTF = var_27_6(var_27_5, var_27_7 .. var_1_10010(arg_27_0.status))
...
function var_0_0.OnTimer(arg_28_0, arg_28_1)
	...
	if arg_28_0.hitTime then
		if arg_28_1 * 5 < arg_28_0.hitTime and arg_28_0.hitTime <= arg_28_1 * 6 then
			...
			local var_28_4 = var_28_3(var_28_2, var_5(var_1_10007))
...
function var_0_0.UpdateAnim(arg_29_0, arg_29_1)
	...
	if var_29_2 ~= "" and arg_29_0.mainAnimName ~= var_29_2 then
		...
		local var_29_8 = var_29_7(var_29_6, var_10(var_1_10012))
		...
		if var_29_4 ~= "" and var_29_4 ~= arg_29_0.toolAnimName then
			...
			if not var_7.find(var_29_4, "N_1") then
				...
				if var_7.find(var_29_4, "N_2") then
					...
					typeof = var_10
					Image = var_1_10012
					var_29_11(var_29_10, var_10(var_1_10012)).enabled = false
				else
					...
					typeof = var_10
					Image = var_1_10012
					var_29_14(var_29_13, var_10(var_1_10012)).enabled = true
					...
					local var_29_18 = var_29_17(var_29_16, var_10(var_1_10012))
				...
				if var_29_3 ~= "" and var_29_3 ~= arg_29_0.oreAnimName then
					...
					local var_29_22 = var_29_21(var_29_20, var_10(var_1_10012))
					...
					if not var_29_1 and var_0_0.oreAnimOffset[arg_29_0.status][arg_29_0.animDir] then
						...
						var_8(var_29_24, var_0_0.oreAnimOffset[arg_29_0.status][arg_29_0.animDir])
					else
						setAnchoredPosition = var_8
...
function var_0_0.UpdatePosition(arg_30_0, arg_30_1)
	...
	local var_30_1 = var_30_0 * var_1_10003.TIME_INTERVAL * arg_30_0.speed
	local var_30_2 = {
...
function var_0_0.SetPosition(arg_31_0, arg_31_1)
	...
	if var_1_10002.CheckRemovable(arg_31_1) then
		...
		typeof = var_5
		Canvas = var_1_10007
		var_31_1(var_31_0, var_5(var_1_10007)).sortingOrder = -arg_31_1.y + 320
	end
