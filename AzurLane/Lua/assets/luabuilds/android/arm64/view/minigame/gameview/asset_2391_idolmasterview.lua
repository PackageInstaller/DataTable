	...
	local var_1_0 = {
		...
		selectGift = function(arg_7_0, arg_7_1)
			...
			if #arg_7_0.selectedGifts >= var_0_17 then
				...
				var_7_4(var_7_3, var_7_5, var_2_10007(arg_7_0.selectedGifts), function(arg_8_0, arg_8_1)
					if not arg_8_0 then
		...
		moveJiujiu = function(arg_11_0, arg_11_1, arg_11_2)
			if arg_11_1 == -1 then
				...
				Vector3 = var_11_5
				var_11_6.localScale = var_11_5.New(1, 1, 1)
			end
...
local function var_0_41(arg_13_0, arg_13_1, arg_13_2)
	local var_13_0 = {
		...
		createIdol = function(arg_15_0, arg_15_1, arg_15_2)
			...
			local var_15_3 = var_5.GetInstance()
		...
		createFans = function(arg_20_0, arg_20_1)
			...
			var_2_10002(var_20_0, var_5(arg_20_0._groupTf, "fansPos"))

			if #arg_20_0.fans > 0 then
				local var_20_1 = arg_20_0.fans[#arg_20_0.fans].tf.anchoredPosition.x + var_0_34

				math = var_20_0
				var_2.x = var_20_1 + var_20_0.random() * 200 + 22
				Vector3 = var_3
				arg_20_1.anchoredPosition = var_3.New(var_2.x, var_2.y, var_2.z)
			else
				Vector3 = var_2
				arg_20_1.anchoredPosition = var_2.New((#arg_20_0.fans + 1) * var_0_34 + 200, 0, 0)
			end

			setActive = var_2
			findTF = var_20_0

			var_2(var_20_0(arg_20_1, "wanted"), false)

			table = var_2

			local var_20_2 = var_2.insert
			local var_20_3 = arg_20_0.fans
			local var_20_4 = {
				tf = arg_20_1
			}

			math = var_6
			var_20_4.speed = var_6.random() * 50 + 200

			var_20_2(var_20_3, var_20_4)

			local var_20_5 = arg_20_0.fans[#arg_20_0.fans]
			local var_20_6 = "jiu-fan"

			math = var_20_3

			local var_20_7 = var_20_6 .. var_20_3.random(1, 4)

			PoolMgr = var_4

			local var_20_8 = var_4.GetInstance()

			var_4.GetSpineChar(var_20_8, var_20_7, true, function(arg_21_0)
				...
				var_21_3(var_21_2, var_3_10004(var_20_5.tf, "spinePos"), false)
				...
				local var_21_6 = var_21_5(var_21_4, var_4(var_6))
		...
		step = function(arg_27_0, arg_27_1)
			...
			for iter_27_0 = #arg_27_0.fans, 1, -1 do
				...
				local var_27_1 = var_6.tf.anchoredPosition.x
				local var_27_3

				if (iter_27_0 - 1) * var_0_34 < var_27_1 then
					local var_27_2 = var_8.x

					var_27_3 = var_6.speed
					Time = var_11
					var_8.x = var_27_2 - var_27_3 * var_11.deltaTime
				...
				elseif iter_27_0 == 1 and not var_6.leave then
					if var_6.gifts == nil then
						...
						local var_27_4 = var_9("ui/minigameui/idolmasterui_atlas", "pack" .. var_6.gifts[1])

						setImageSprite = var_27_3
						findTF = var_12

						var_27_3(var_12(var_6.tf, "score/pack"), var_27_4)
			...
			if #arg_27_0.fans > 0 then
				...
				local var_27_5 = var_2.tf

				var_3.SetSiblingIndex(var_27_5, #arg_27_0.fans - 1)
			end
		...
		showFansWanted = function(arg_30_0, arg_30_1)
			...
			var_2_10006(var_2_10008(arg_30_1.tf, "wanted"), true)

			setActive = var_2_10006
			findTF = var_8

			var_2_10006(var_8(arg_30_1.tf, "wanted/bg1"), not var_30_2)

			setActive = var_2_10006
			findTF = var_8

			var_2_10006(var_8(arg_30_1.tf, "wanted/bgTime1"), not var_30_2)

			setActive = var_2_10006
			findTF = var_8

			var_2_10006(var_8(arg_30_1.tf, "wanted/time1"), not var_30_2)

			setActive = var_2_10006
			findTF = var_8

			var_2_10006(var_8(arg_30_1.tf, "wanted/bg2"), var_30_2)

			setActive = var_2_10006
			findTF = var_8

			var_2_10006(var_8(arg_30_1.tf, "wanted/bgTime2"), var_30_2)

			setActive = var_2_10006
			findTF = var_8

			var_2_10006(var_8(arg_30_1.tf, "wanted/time2"), var_30_2)
			...
			local var_30_3 = var_8(arg_30_1.tf, "wanted/time1")

			math = var_9

			local var_30_4 = var_9.abs

			math = var_11

			var_6(var_30_3, var_30_4(var_11.ceil(var_30_0)) .. "S")
			...
			local var_30_6 = var_9.abs

			math = var_11

			var_6(var_30_5, var_30_6(var_11.ceil(var_30_0)) .. "S")
			...
			for iter_30_0 = 1, #var_30_1 do
				...
				var_11(var_13(arg_30_1.tf, "wanted/item" .. iter_30_0), var_30_7, true)
			end
		...
		createWantedGifts = function(arg_36_0)
			...
			local var_36_2 = var_3.insert
			local var_36_3 = var_36_1
			local var_36_4 = var_0_15

			math = var_2_10007

			var_36_2(var_36_3, var_36_4[var_2_10007.random(1, #var_0_15)])
			...
			for iter_36_0 = 1, 2 do
				...
				math = var_10
				var_36_5 = var_36_5(var_36_6, var_10.random(1, #var_36_0))
				table = var_2_10008

				var_2_10008.insert(var_36_1, var_36_5)
			end
		...
		fanLeave = function(arg_37_0, arg_37_1, arg_37_2, arg_37_3)
			...
			var_2_10004(var_2_10006(arg_37_1.tf, "wanted"), false)
			...
			elseif var_0_31 then
				...
				var_5(var_7(arg_37_1.tf, "score"), "+" .. var_0_5)

				setActive = var_5
				findTF = var_7

				var_5(var_7(arg_37_1.tf, "score"), true)
			end
	...
	local var_41_0 = {
		Ctor = function(arg_42_0)
			...
			for iter_42_0 = 1, var_0_32 do
				...
				var_2_10005 = var_2_10005(var_2_10007(arg_42_0._tplGroup))
				...
				var_2_10007.insert(arg_42_0.groups, var_2_10006)
			end
		...
		getRandomIdols = function(arg_45_0)
			...
			if var_2_10003.random() > 0.6 then
				Clone = var_3
			...
			for iter_45_0 = #var_45_0 + 1, var_0_32 do
				...
				var_2_10008(var_45_2, var_2_10011(var_45_3, var_2_10014.random(1, #var_45_1)))
			end
			...
			for iter_45_1 = 1, var_0_32 do
				...
				local var_45_6 = var_45_0

				math = var_2_10015

				var_2_10009(var_45_5, var_2_10012(var_45_6, var_2_10015.random(1, #var_45_0)))
			end
		...
		start = function(arg_48_0)
			...
			for iter_48_0 = 1, 3 do
				...
				var_48_1(var_48_0, var_2_10009(var_2_10011(arg_48_0._tplFans)))
			end
		...
		step = function(arg_49_0, arg_49_1)
			...
			if not arg_49_0.createFansTime then
				...
				local var_49_2 = arg_49_1 + arg_49_0.getApearTime(var_49_1)

				math = var_49_1
				arg_49_0.createFansTime = var_49_2 + var_49_1.random() * 1
			elseif arg_49_1 > arg_49_0.createFansTime and arg_49_0:getFansAmount() <= 10 then
				local var_49_3 = arg_49_0:getApearTime()

				math = var_3

				local var_49_4 = var_3.random(1, #arg_49_0.groups)
				...
				var_49_6(var_49_5, var_2_10007(var_2_10009(arg_49_0._tplFans)))

				local var_49_7 = arg_49_1 + var_49_3

				math = var_5
				arg_49_0.createFansTime = var_49_7 + var_5.random() * 1
			end
...
function var_0_1.initUI(arg_60_0)
	...
	local var_60_0 = var_3(arg_60_0.countUI, "count")

	typeof = var_4
	Animator = var_6
	arg_60_0.countAnimator = var_1(var_60_0, var_4(var_6))
	GetComponent = var_1
	findTF = var_60_0
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_60_0.countDft = var_1(var_60_1, var_4(var_6))
	...
	local var_60_5 = var_4(arg_60_0.leaveUI, "ad/btnOk")
	...
	var_1(var_60_4, var_60_5, var_60_6, var_6)
	...
	var_1(var_60_7, var_60_8, var_60_9, var_6)
	...
	local var_60_11 = var_4(arg_60_0.pauseUI, "ad/btnOk")
	...
	var_1(var_60_10, var_60_11, var_60_12, var_6)
	...
	local var_60_14 = var_4(arg_60_0.settlementUI, "ad/btnOver")
	...
	var_1(var_60_13, var_60_14, var_60_15, var_6)
	...
	local var_60_16 = var_3(arg_60_0.menuUI, "battList")

	typeof = var_4
	ScrollRect = var_6
	arg_60_0.battleScrollRect = var_1(var_60_16, var_4(var_6))
	arg_60_0.totalTimes = arg_60_0:getGameTotalTime()

	local var_60_17 = arg_60_0:getGameUsedTimes() - 4 < 0 and 0 or arg_60_0:getGameUsedTimes() - 4

	scrollTo = var_2

	var_2(arg_60_0.battleScrollRect, 0, 1 - var_60_17 / (arg_60_0.totalTimes - 4))

	onButton = var_2

	local var_60_18 = arg_60_0

	findTF = var_5

	local var_60_19 = var_5(arg_60_0.menuUI, "rightPanelBg/arrowUp")

	local function var_60_20()
	...
	var_2(var_60_18, var_60_19, var_60_20, var_7)
	...
	local var_60_22 = var_60_19(arg_60_0.menuUI, "rightPanelBg/arrowDown")

	local function var_60_23()
		local var_68_0
	...
	var_2(var_60_21, var_60_22, var_60_23, var_7)

	onButton = var_2

	local var_60_24 = arg_60_0

	findTF = var_60_22

	local var_60_25 = var_60_22(arg_60_0.menuUI, "btnBack")

	local function var_60_26()
	...
	var_2(var_60_24, var_60_25, var_60_26, var_7)
	...
	local var_60_28 = var_60_25(arg_60_0.menuUI, "btnRule")

	local function var_60_29()
		pg = var_2_10000
		...
		var_70_2.type = var_2_10004
		pg = var_2_10004
		var_70_2.helps = var_2_10004.gametip.handshake_game_help.tip
	...
	var_2(var_60_27, var_60_28, var_60_29, var_7)
	...
	local var_60_31 = var_60_28(arg_60_0.menuUI, "btnStart")

	local function var_60_32()
	...
	SFX_CANCEL = var_60_34

	var_2(var_60_30, var_60_31, var_60_32, var_60_34)

	findTF = var_2

	local var_60_33 = var_2(arg_60_0.menuUI, "tplBattleItem")
	...
	for iter_60_0 = 1, arg_60_0.totalTimes do
		...
		local var_60_34 = var_60_34(var_1_10009(var_60_33))

		var_60_34.name = "battleItem_" .. iter_60_0
		setParent = var_8

		local var_60_35 = var_60_34

		findTF = var_11

		var_8(var_60_35, var_11(arg_60_0.menuUI, "battList/Viewport/Content"))

		local var_60_36 = iter_60_0

		GetSpriteFromAtlasAsync = var_1_10009

		var_1_10009("ui/minigameui/idolmasterui_atlas", "tx_" .. var_60_36, function(arg_72_0)
			setImageSprite = var_2_10001
			findTF = var_2_10003

			var_2_10001(var_2_10003(var_60_34, "state_open/icon"), arg_72_0, true)

			setImageSprite = var_2_10001
			findTF = var_3

			var_2_10001(var_3(var_60_34, "state_clear/icon"), arg_72_0, true)

			setImageSprite = var_2_10001
			findTF = var_3

			var_2_10001(var_3(var_60_34, "state_current/icon"), arg_72_0, true)
		...
		var_1_10009("ui/minigameui/idolmasterui_atlas", "battleDesc" .. var_60_36, function(arg_73_0)
			setImageSprite = var_2_10001
			findTF = var_2_10003

			var_2_10001(var_2_10003(var_60_34, "state_open/buttomDesc"), arg_73_0, true)

			setImageSprite = var_2_10001
			findTF = var_3

			var_2_10001(var_3(var_60_34, "state_clear/buttomDesc"), arg_73_0, true)

			setImageSprite = var_2_10001
			findTF = var_3

			var_2_10001(var_3(var_60_34, "state_current/buttomDesc"), arg_73_0, true)

			setImageSprite = var_2_10001
			findTF = var_3

			var_2_10001(var_3(var_60_34, "state_closed/buttomDesc"), arg_73_0, true)
		...
		var_1_10009(var_60_34, true)

		table = var_1_10009

		var_1_10009.insert(arg_60_0.battleItems, var_60_34)
	end
	...
	local var_60_37 = arg_60_0

	findTF = var_6

	local var_60_38 = var_6(arg_60_0.helpUI, "close")

	local function var_60_39()
		setActive = var_2_10000
	...
	var_3(var_60_37, var_60_38, var_60_39, var_8)
...
function var_0_1.initGameUI(arg_75_0)
	...
	var_1(var_75_0, var_4(arg_75_0.gameUI, "topRight/btnStop"), function()
	...
	var_1(var_75_1, var_4(arg_75_0.gameUI, "btnLeave"), function()
	...
	for iter_75_0 = 1, var_0_29 do
		...
		var_75_2(var_75_3, var_1_10008(arg_75_0.gameUI, "top/heart" .. iter_75_0 .. "/full"))
	end
	...
	local var_75_5 = var_3(arg_75_0._tf, "scene/gift")

	findTF = var_4
	arg_75_0.giftUI = var_75_4(var_75_5, var_4(arg_75_0._tf, "scene/jiujiuWorker"), arg_75_0)
	findTF = var_1
...
function var_0_1.initTextTip(arg_78_0)
	...
	var_78_4(var_3(arg_78_0.settlementUI, "ad/currentTextDesc"), var_0_37)

	setText = var_78_4
	findTF = var_3

	var_78_4(var_3(arg_78_0.settlementUI, "ad/highTextDesc"), var_0_38)

	setText = var_78_4
	findTF = var_3

	var_78_4(var_3(arg_78_0.gameUI, "top/scoreImg/socre"), var_0_39)

	setText = var_78_4
	findTF = var_3

	var_78_4(var_3(arg_78_0.pauseUI, "ad/tip"), var_0_35)

	setText = var_78_4
	findTF = var_3

	var_78_4(var_3(arg_78_0.leaveUI, "ad/tip"), var_0_36)
...
function var_0_1.updateMenuUI(arg_81_0)
	...
	for iter_81_0 = 1, #arg_81_0.battleItems do
		...
		var_1_10007(var_1_10009(arg_81_0.battleItems[iter_81_0], "state_open"), false)

		setActive = var_1_10007
		findTF = var_1_10009

		var_1_10007(var_1_10009(arg_81_0.battleItems[iter_81_0], "state_closed"), false)

		setActive = var_1_10007
		findTF = var_1_10009

		var_1_10007(var_1_10009(arg_81_0.battleItems[iter_81_0], "state_clear"), false)

		setActive = var_1_10007
		findTF = var_1_10009

		var_1_10007(var_1_10009(arg_81_0.battleItems[iter_81_0], "state_current"), false)

		if iter_81_0 <= var_81_0 then
			setActive = var_1_10007
			findTF = var_1_10009

			var_1_10007(var_1_10009(arg_81_0.battleItems[iter_81_0], "state_clear"), true)
		elseif iter_81_0 == var_81_0 + 1 and 1 <= var_81_1 then
			setActive = var_1_10007
			findTF = var_1_10009

			var_1_10007(var_1_10009(arg_81_0.battleItems[iter_81_0], "state_current"), true)
		elseif var_81_0 < iter_81_0 and iter_81_0 <= var_81_0 + var_81_1 then
			setActive = var_1_10007
			findTF = var_1_10009

			var_1_10007(var_1_10009(arg_81_0.battleItems[iter_81_0], "state_open"), true)
		else
			setActive = var_1_10007
			findTF = var_1_10009

			var_1_10007(var_1_10009(arg_81_0.battleItems[iter_81_0], "state_closed"), true)
		end
	end
	...
	var_5(var_7(arg_81_0.menuUI, "btnStart/tip"), var_81_1 > 0)
	arg_81_0:CheckGet()
...
function var_0_1.CheckGet(arg_82_0)
	...
	var_1_10001(var_1_10003(arg_82_0.menuUI, "got"), false)
	...
	if arg_82_0:getUltimate() == 0 then
		...
		if arg_82_0.getGameTotalTime(var_82_1) > arg_82_0:getGameUsedTimes() then
			return
		end

		pg = var_82_1

		local var_82_2 = var_82_1.m02
		local var_82_3 = var_3.sendNotification

		GAME = var_6

		local var_82_4 = var_6.SEND_MINI_GAME_OP
		local var_82_5 = {
			hubid = arg_82_0:GetMGHubData().id
		}

		MiniGameOPCommand = var_8
		var_82_5.cmd = var_8.CMD_ULTIMATE
		var_82_5.args1 = {}

		var_82_3(var_82_2, var_82_4, var_82_5)

		setActive = var_82_3
		findTF = var_82_2

		var_82_3(var_82_2(arg_82_0.menuUI, "got"), true)
	end
...
function var_0_1.openMenuUI(arg_83_0)
	...
	var_1_10001(var_1_10003(arg_83_0._tf, "scene_front"), false)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_83_0._tf, "scene_background"), false)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_83_0._tf, "scene"), false)
...
function var_0_1.gameStart(arg_87_0)
	...
	var_1_10001(var_1_10003(arg_87_0._tf, "scene_front"), true)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_87_0._tf, "scene_background"), true)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_87_0._tf, "scene"), true)
...
function var_0_1.updateGameUI(arg_97_0)
	...
	if var_97_0(var_3.ceil(arg_97_0.gameTime) / 60) < 10 then
		var_97_1 = "0" .. var_97_1
	end
	...
	if var_97_2(var_4.ceil(arg_97_0.gameTime) % 60) < 10 then
		var_97_3 = "0" .. var_97_3
	end
...
function var_0_1.onGameOver(arg_100_0)
	...
	local var_100_1 = var_3(arg_100_0._tf)
	local var_100_2 = 2

	System = var_5

	var_100_0(var_100_1, var_100_2, var_5.Action(function()
...
function var_0_1.showSettlement(arg_102_0)
	...
	local var_102_0 = var_3(arg_102_0.settlementUI, "ad")

	typeof = var_4
	Animator = var_6

	local var_102_1 = var_1_10001(var_102_0, var_4(var_6))
	...
	if var_102_3 then
		...
		var_5(var_7(arg_102_0.settlementUI, "ad/new"), var_102_6 < var_102_4)
...
function var_0_1.willExit(arg_106_0)
	if arg_106_0.handle then
		...
		var_1.RemoveListener(var_1_10003, arg_106_0.handle)
	end
	...
	if arg_106_0._tf then
		...
		if var_106_0(var_1_10003(arg_106_0._tf)) then
			LeanTween = var_1
