...
function var_0_0.AddDebugInput(arg_6_0)
	...
	if var_1_10001 then
		...
		if var_6_0(var_1_10003.Space) then
...
function var_0_0.InitGameUI(arg_7_0, arg_7_1)
	...
	var_2(var_7_7, var_5.Find(var_7_8, "btn_carry"), function()
...
function var_0_0.InitControl(arg_9_0)
	...
	arg_9_0.akashiControl = var_9_0(var_9_1, var_4.Find(var_9_2, "Akashi"), arg_9_0.collisionMgr)
	...
	arg_9_0.enemiesControl = var_9_3(var_9_4, var_4.Find(var_9_5, "Enemies"), arg_9_0.collisionMgr)
	...
	arg_9_0.minersControl = var_9_6(var_9_7, var_4.Find(var_9_8, "Miners"), arg_9_0.collisionMgr)
	...
	arg_9_0.oreGroupControl = var_9_9(var_9_10, var_4.Find(var_9_11, "MainContent/ore_group"), arg_9_0.collisionMgr)
	...
	arg_9_0.containerControl = var_9_12(var_9_13, var_4.Find(var_9_14, "MainContent/container"))
...
function var_0_0.AddListener(arg_10_0)
	...
	var_10_1(var_10_0, var_1_10004.EVENT_DO_CARRY, function(arg_11_0, arg_11_1)
	...
	var_10_3(var_10_2, var_4.EVENT_DELIVER, function(arg_12_0, arg_12_1)
		...
		local var_12_4 = var_12_3(var_12_2, var_2_10005(var_2_10007))
	...
	var_10_5(var_10_4, var_4.EVENT_AKASHI_HIT, function(arg_13_0, arg_13_1)
		arg_10_0.weight = 0
		...
		local var_13_3 = var_13_2(var_13_1, var_2_10005(var_2_10007))
...
function var_0_0.OnCarryBtnClick(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10004.EVENT_CHECK_CARRY, {
...
function var_0_0.UpdateTimeUI(arg_15_0)
	if arg_15_0.timeCount < 60 then
		...
		var_1(var_15_0, var_1_10004.format("%02d", arg_15_0.timeCount / 60))
	end
	...
	var_1(var_15_1, var_1_10004.format("%02d", arg_15_0.timeCount % 60))
...
function var_0_0.UpdateWeightUI(arg_16_0)
	...
	if arg_16_0.weight == 0 then
		...
		local var_16_1 = arg_16_0.rtPointer

		Vector3 = var_1_10005

		var_2(var_16_1, var_1_10005(0, 0, 90))

		return
	end

	local var_16_2 = arg_16_0.weight

	OreGameConfig = var_1_10003

	if var_16_2 == var_1_10003.MAX_WEIGHT then
		setLocalEulerAngles = var_16_2

		local var_16_3 = arg_16_0.rtPointer

		Vector3 = var_1_10005

		var_16_2(var_16_3, var_1_10005(0, 0, -90))

		return
	end

	OreGameConfig = var_16_2

	local var_16_4 = var_16_2.CAPACITY

	if arg_16_0.weight <= var_16_4.WOOD_BOX then
		var_16_0 = 90 - arg_16_0.weight * 40 / var_16_4.WOOD_BOX
	elseif arg_16_0.weight <= var_16_4.IRON_BOX then
		var_16_0 = 37 - (arg_16_0.weight - var_16_4.WOOD_BOX) * 60 / (var_16_4.IRON_BOX - var_16_4.WOOD_BOX)
	else
		var_16_0 = -37 - (arg_16_0.weight - var_16_4.IRON_BOX) * 40 / (var_16_4.CART - var_16_4.IRON_BOX)
	end

	setLocalEulerAngles = var_3

	local var_16_5 = arg_16_0.rtPointer

	Vector3 = var_1_10006

	var_3(var_16_5, var_1_10006(0, 0, var_16_0))
