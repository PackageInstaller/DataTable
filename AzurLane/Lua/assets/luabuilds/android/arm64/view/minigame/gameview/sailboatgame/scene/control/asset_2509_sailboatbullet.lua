...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_6
	Image = var_8
	arg_1_0._img = var_3(var_1_1, var_6(var_8))
...
function var_0_0.start(arg_3_0)
	...
	if arg_3_0:getConfig("fire_effect") then
		...
		SailBoatGameEvent = var_1_10007

		local var_3_4 = var_1_10007.CREATE_EFFECT
		local var_3_5 = {
			effect = var_3_0
		}

		Vector3 = var_1_10009
		var_3_5.direct = var_1_10009(arg_3_0._move.x, 1, 1)
...
function var_0_0.step(arg_5_0, arg_5_1)
	...
	if arg_5_0._life then
		var_5_0 = arg_5_0._life
	...
	local var_5_1 = var_5_0.abs(var_2.x)

	SailBoatGameVo = var_4

	if var_4.scene_width < var_5_1 then
		arg_5_0._removeFlag = true
	else
		math = var_5_1

		local var_5_2 = var_5_1.abs(var_2.y)

		SailBoatGameVo = var_4

		if var_5_2 > var_4.scene_height then
			arg_5_0._removeFlag = true
		end
	end
...
function var_0_0.hit(arg_9_0)
	if arg_9_0:getConfig("hit_effect") then
		...
		SailBoatGameEvent = var_4

		local var_9_2 = var_4.CREATE_EFFECT
		local var_9_3 = {
			effect = var_9_0
		}

		Vector3 = var_1_10006
		var_9_3.direct = var_1_10006(1, 1, 1)
...
function var_0_0.checkPositionInRange(arg_25_0, arg_25_1)
	...
	local var_25_2 = var_1_10004.abs(var_25_0.y - arg_25_1.y)
