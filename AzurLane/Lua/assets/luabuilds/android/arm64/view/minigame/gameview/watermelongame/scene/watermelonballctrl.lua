...
function var_0_0.step(arg_4_0, arg_4_1)
	if not arg_4_0.nextBallId then
		...
		local var_4_1 = var_2.emit

		WatermelonGameEvent = var_1_10005

		var_4_1(var_4_0, var_1_10005.UPDATE_NEXT_BALL, arg_4_0.nextBallId)
	end
	...
	if not arg_4_0.readyBall then
		...
		if arg_4_0.createBallCd then
			local var_4_2 = arg_4_0.createBallCd
		...
		local var_4_3 = arg_4_0.readyBall.tf

		var_4_3.anchoredPosition = arg_4_0._startPos.anchoredPosition
		Physics2D = var_4_3

		local var_4_4 = var_4_3.Raycast
		local var_4_5 = arg_4_0._startPos.position

		Vector2 = var_1_10005

		if var_4_4(var_4_5, var_1_10005(0, -1)) and var_2.transform then
			var_1_10006 = arg_4_0._startPos

			local var_4_6 = var_4.InverseTransformPoint

			Vector2 = var_7

			local var_4_7 = var_4_6(var_1_10006, var_7(var_2.point.x, var_2.point.y, 0))
			local var_4_8 = arg_4_0._rayTf

			Vector2 = var_1_10006

			local var_4_9 = arg_4_0._rayTf.sizeDelta.x

			math = var_9
			var_4_8.sizeDelta = var_1_10006(var_4_9, var_9.abs(var_4_7.y))
		end
	end

	local var_4_10 = arg_4_0.readyBall and true or false

	isActive = var_1_10003

	if var_1_10003(arg_4_0._rayTf) ~= var_4_10 then
		setActive = var_3

		var_3(arg_4_0._rayTf, var_4_10)
	end
	...
	if arg_4_0.tickToOver then
		...
		if arg_4_0.tickToOver and arg_4_0.tickToOver <= 0 then
			...
			local var_4_12 = var_3.emit

			WatermelonGameEvent = var_1_10006

			var_4_12(var_4_11, var_1_10006.GAME_OVER, true)
...
function var_0_0.createMegerBall(arg_13_0, arg_13_1, arg_13_2)
	...
	Vector3 = var_13_0
	var_13_1.position = var_13_0(arg_13_2.x, arg_13_2.y, 0)
...
function var_0_0.checkCollisionBall(arg_18_0, arg_18_1)
	...
	if arg_18_0:checkColliderBall(var_18_0, var_18_1) then
		...
		WatermelonGameEvent = var_10

		local var_18_6 = var_10.ADD_SCORE
		local var_18_7 = {}

		WatermelonGameConst = var_1_10012
		var_18_7.num = var_1_10012.ball_data[var_18_2].score
...
function var_0_0.removeBall(arg_21_0, arg_21_1)
	for iter_21_0 = #arg_21_0._balls, 1, -1 do
		if arg_21_0._balls[iter_21_0] == arg_21_1 then
			...
			local var_21_1 = var_1_10007(arg_21_1.tf, "Physics2DItem").CollisionEnter

			var_1_10007.RemoveAllListeners(var_21_1)

			Destroy = var_1_10007

			var_1_10007(var_21_0.tf)
...
function var_0_0.initBallData(arg_27_0, arg_27_1, arg_27_2)
	...
	WatermelonGameConst = var_1_10004

	local var_27_2 = var_1_10004.ball_data[var_27_1]

	GetComponent = var_27_0
	...
	local var_27_4 = var_27_0(var_27_3, var_1_10008(var_1_10010.CircleCollider2D))

	GetComponent = var_6

	local var_27_5 = var_6(arg_27_1, "Rigidbody2D")
	...
	var_27_7(var_27_6, var_10(arg_27_1, "size_image"), false)
...
function var_0_0.getRandomIdByWeight(arg_28_0)
	...
	if not arg_28_0.weightTotal then
		...
		for iter_28_0 = var_28_0, #var_1_10002.drop_ball_ids do
			...
			local var_28_3 = arg_28_0.weightIdList

			WatermelonGameConst = var_8

			var_28_2(var_28_3, var_8.drop_ball_ids[iter_28_0].id)
		end
	end

	math = var_28_0

	local var_28_4 = var_28_0.random(1, arg_28_0.weightTotal)

	for iter_28_1 = 1, #arg_28_0.weightList do
		if var_28_4 <= arg_28_0.weightList[iter_28_1] or iter_28_1 == #arg_28_0.weightList then
