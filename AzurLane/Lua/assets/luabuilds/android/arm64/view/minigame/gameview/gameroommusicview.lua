...
function var_0_1.MyGetRuntimeData(arg_2_0)
	...
	if not var_1_10002(var_4.GetRuntimeData(var_2_2, "elements"), {
		1
	}) then
		var_2_3 = 0
	end
...
function var_0_1.init(arg_4_0)
	...
	pg = var_1_10003
	arg_4_0.music_amount_middle = var_4_0(#var_1_10003.beat_game_music.all / 2)
	arg_4_0.musicDatas = {}
	...
	local var_4_2 = var_1.GetInt("musicgame_idol_speed")
	...
	if 0 < var_4_2 then
		...
		if not var_4_2.GetInt("musicgame_idol_speed") then
			var_4_3 = 1
		end

		arg_4_0.game_speed = var_4_3
		arg_4_0.game_dgree = 1

		local var_4_4 = arg_4_0._tf

		arg_4_0.countContent = var_1.Find(var_4_4, "countContent")
		arg_4_0.countTf = nil

		local var_4_5 = arg_4_0._tf

		arg_4_0.top = var_1.Find(var_4_5, "top")

		local var_4_6 = arg_4_0.top

		arg_4_0.btn_pause = var_1.Find(var_4_6, "pause")

		local var_4_7 = arg_4_0.top

		arg_4_0.score = var_1.Find(var_4_7, "score")

		local var_4_8 = arg_4_0._tf

		arg_4_0.game_content = var_1.Find(var_4_8, "GameContent")

		local var_4_9 = arg_4_0.game_content

		arg_4_0.noteTpl = var_1.Find(var_4_9, "noteTpl")

		local var_4_10 = arg_4_0._tf

		arg_4_0.pauseview = var_1.Find(var_4_10, "Pauseview")

		local var_4_11 = arg_4_0._tf

		arg_4_0.selectview = var_1.Find(var_4_11, "Selectview")
		findTF = var_1

		local var_4_12 = var_1(arg_4_0.selectview, "bg")
		...
		var_2("ui/minigameui/musicgameother_atlas", "selectbg", function(arg_6_0)
			...
			local var_6_0 = var_4_12

			typeof = var_2_10004
			Image = var_2_10006

			local var_6_1 = var_2_10001(var_6_0, var_2_10004(var_2_10006))

			var_6_1.sprite = arg_6_0
			setActive = var_6_1

			var_6_1(var_4_12, true)
		...
		arg_4_0.firstview = var_2.Find(var_4_13, "firstview")

		local var_4_14 = arg_4_0._tf

		arg_4_0.scoreview = var_2.Find(var_4_14, "ScoreView")
		setActive = var_2
		...
		local var_4_15 = var_2.BgmMgr.GetInstance()

		var_2.StopPlay(var_4_15)
...
function var_0_1.didEnter(arg_7_0)
	...
	local var_7_3 = var_1_10005(arg_7_0.selectview)
	local var_7_4 = 2

	System = var_7

	var_7_2(var_7_3, var_7_4, var_7.Action(function()
	...
	arg_7_0.BtnRightDelegate = var_4(var_6.Find(var_7_7, "btn_right"), "EventTriggerListener")
	...
	arg_7_0.BtnLeftDelegate = var_4(var_6.Find(var_7_10, "btn_left"), "EventTriggerListener")
	...
	local var_7_15 = var_7.Find(var_7_14, "pause")
	...
	local function var_7_16()
		...
		var_0("ui/minigameui/musicgameother_atlas", "pause_" .. arg_7_0.musicData.picture, function(arg_15_0)
			...
			var_3_10001(var_3.Find(var_15_0, "bottom/song"), arg_15_0, true)
		...
		local var_14_3 = var_2.Find(var_14_2, "bottom/img")

		typeof = var_3
		Image = var_5

		local var_14_4 = var_0(var_14_3, var_3(var_5))
		...
		if not arg_7_0.ahead_timeflag then
			...
			if var_14_7 >= 0 and var_14_8 > 0 then
				...
				local var_14_10 = var_14_9(var_5.floor(var_14_7 % 60000 / 1000))
				local var_14_11 = var_2

				math = var_2_10006

				local var_14_12 = var_14_11(var_2_10006.floor(var_14_7 / 60000))

				setText = var_5

				local var_14_13 = arg_7_0.pauseview

				var_5(var_7.Find(var_14_13, "bottom/now"), var_14_12 .. ":" .. var_14_10)

				local var_14_14 = var_2

				math = var_7

				local var_14_15 = var_14_14(var_7.floor(var_14_8 % 60000 / 1000))
				local var_14_16 = var_2

				math = var_7

				local var_14_17 = var_14_16(var_7.floor(var_14_8 / 60000))

				setText = var_5

				local var_14_18 = arg_7_0.pauseview

				var_5(var_7.Find(var_14_18, "bottom/total"), var_14_17 .. ":" .. var_14_15)

				setActive = var_5

				local var_14_19 = arg_7_0.pauseview

				var_5(var_7.Find(var_14_19, "bottom/triangle"), true)

				setActive = var_5

				local var_14_20 = arg_7_0.pauseview

				var_5(var_7.Find(var_14_20, "bottom/TimeSlider"), true)

				setActive = var_5

				local var_14_21 = arg_7_0.pauseview

				var_5(var_7.Find(var_14_21, "bottom/now"), true)

				setActive = var_5

				local var_14_22 = arg_7_0.pauseview

				var_5(var_7.Find(var_14_22, "bottom/total"), true)

				setSlider = var_5

				local var_14_23 = arg_7_0.pauseview

				var_5(var_7.Find(var_14_23, "bottom/TimeSlider"), 0, 1, var_14_7 / var_14_8)
				...
				Vector3 = var_14_28
				var_14_31.localPosition = var_14_28(var_14_25 + var_14_7 / var_14_8 * (var_14_27 - var_14_25), var_14_29.y, var_14_29.z)
			...
			var_14_7(var_2.Find(var_14_33, "bottom/triangle"), false)

			setActive = var_14_7

			local var_14_34 = arg_7_0.pauseview

			var_14_7(var_2.Find(var_14_34, "bottom/TimeSlider"), false)

			setActive = var_14_7

			local var_14_35 = arg_7_0.pauseview

			var_14_7(var_2.Find(var_14_35, "bottom/now"), false)

			setActive = var_14_7

			local var_14_36 = arg_7_0.pauseview

			var_14_7(var_2.Find(var_14_36, "bottom/total"), false)
	...
	SFX_UI_CLICK = var_7_14

	var_4(var_7_13, var_7_15, var_7_16, var_7_14)

	onButton = var_4

	local var_7_17 = arg_7_0
	local var_7_18 = arg_7_0.pauseview
	local var_7_19 = var_7.Find(var_7_18, "bottom/back")
	...
	local function var_7_20()
		...
		i18n = var_2_10004
		var_17_2.content = var_2_10004("reselect_music_game")
		...
		function var_17_2.onYes()
			...
			local var_18_7 = var_18_6(var_18_5, var_3(var_3_10005))
	...
	SFX_UI_CLICK = var_7_18

	var_4(var_7_17, var_7_19, var_7_20, var_7_18)

	onButton = var_4

	local var_7_21 = arg_7_0
	local var_7_22 = arg_7_0.pauseview
	local var_7_23 = var_7.Find(var_7_22, "bottom/restart")
	...
	local function var_7_24()
		...
		i18n = var_2_10004
		var_19_2.content = var_2_10004("restart_music_game")
	...
	SFX_UI_CLICK = var_7_22

	var_4(var_7_21, var_7_23, var_7_24, var_7_22)

	onButton = var_4

	local var_7_25 = arg_7_0
	local var_7_26 = arg_7_0.pauseview
	local var_7_27 = var_7.Find(var_7_26, "bottom/resume")
	...
	local function var_7_28()
		...
		if not arg_7_0.ahead_timeflag then
			...
			local function var_21_4()
				...
				var_23_0(var_2.Find(var_23_1, "bottom/triangle"), true)

				setActive = var_23_0

				local var_23_2 = arg_7_0.pauseview

				var_23_0(var_2.Find(var_23_2, "bottom/TimeSlider"), true)

				setActive = var_23_0

				local var_23_3 = arg_7_0.pauseview

				var_23_0(var_2.Find(var_23_3, "bottom/now"), true)

				setActive = var_23_0

				local var_23_4 = arg_7_0.pauseview

				var_23_0(var_2.Find(var_23_4, "bottom/total"), true)
	...
	SFX_UI_CLICK = var_7_26

	var_4(var_7_25, var_7_27, var_7_28, var_7_26)
...
function var_0_1.onBackPressed(arg_28_0)
	if not arg_28_0.countingfive_flag and not arg_28_0.firstview_timerRunflag then
		if arg_28_0.game_playingflag then
			...
			if not var_1(var_3.Find(var_28_0, "pause_above")) then
				triggerButton = var_1

				local var_28_1 = arg_28_0.top

				var_1(var_3.Find(var_28_1, "pause"))
			end
		else
			isActive = var_1
...
function var_0_1.OnApplicationPaused(arg_29_0, arg_29_1)
	if arg_29_1 and not arg_29_0.countingfive_flag and not arg_29_0.firstview_timerRunflag and arg_29_0.game_playingflag then
		...
		if not var_2(var_4.Find(var_29_0, "pause_above")) then
			triggerButton = var_2

			local var_29_1 = arg_29_0.top

			var_2(var_4.Find(var_29_1, "pause"))
		end
	end
...
function var_0_1.willExit(arg_30_0)
	...
	if var_30_10(var_30_8(arg_30_0.selectview)) then
		...
		var_30_11(var_3(arg_30_0.selectview))
	end
	...
	if var_30_12(var_3(arg_30_0.countContent)) then
		LeanTween = var_30_13
		var_30_13 = var_30_13.cancel
		go = var_3

		var_30_13(var_3(arg_30_0.countContent))
	end
	...
	if var_30_14(var_3(arg_30_0.scoreview)) then
		LeanTween = var_30_15
		var_30_15 = var_30_15.cancel
		go = var_3

		var_30_15(var_3(arg_30_0.scoreview))
	end
	...
	if var_30_16(var_3(arg_30_0.game_content)) then
		LeanTween = var_30_17
		var_30_17 = var_30_17.cancel
		go = var_3

		var_30_17(var_3(arg_30_0.game_content))
	end
...
function var_0_1.game_before(arg_36_0)
	...
	var_36_1(var_36_0, var_4.Find(var_36_2, "scoreContent/scroll"), false)
	...
	tostring = var_5
	arg_36_0.scoreSliderTf = var_36_4(var_36_3, var_36_5 .. var_5(arg_36_0.musicData.content_type))
	setSlider = var_1
	...
	var_1(var_3(arg_36_0.scoreSliderTf, "img/mask/yinyue20_S"), false)

	arg_36_0.scoreSFlag = false
	setImageColor = var_1
	findTF = var_3

	local var_36_6 = var_3(arg_36_0.scoreSliderTf, "img")

	Color = var_4

	var_1(var_36_6, var_4(1, 1, 1, 1))
	...
	for iter_36_0 = 1, var_36_8.childCount do
		...
		local var_36_10 = var_36_8.GetChild(var_36_9, iter_36_0 - 1)

		for iter_36_1 = 1, var_36_10.childCount do
			setActive = var_1_10011

			var_1_10011(var_36_10:GetChild(iter_36_1 - 1), false)
		end

		setActive = var_7
		findTF = var_9
		var_1_10011 = var_36_10
		tostring = var_1_10012

		var_7(var_9(var_1_10011, var_1_10012(arg_36_0.musicData.content_type)), true)

		setActive = var_7
		var_1_10011 = var_36_8

		var_7(var_36_8.GetChild(var_1_10011, iter_36_0 - 1), false)
	end
	...
	for iter_36_2 = 1, var_36_12.childCount do
		local var_36_13 = var_36_12:GetChild(iter_36_2 - 1)

		setActive = var_36_9

		var_36_9(var_36_13, false)
	end

	if arg_36_0.musicData.bottom_type and arg_36_0.musicData.bottom_type > 0 then
		local var_36_14 = arg_36_0.game_content

		arg_36_0.bottonLeftBg = var_3.Find(var_36_14, "bottomList/" .. arg_36_0.musicData.bottom_type .. "/bottom_leftbg")

		local var_36_15 = arg_36_0.game_content

		arg_36_0.bottonRightBg = var_3.Find(var_36_15, "bottomList/" .. arg_36_0.musicData.bottom_type .. "/bottom_rightbg")
		setActive = var_3
		...
		var_3(var_5.Find(var_36_16, "bottomList/" .. arg_36_0.musicData.bottom_type), true)

		setActive = var_3

		local var_36_17 = arg_36_0.game_content

		var_3(var_5.Find(var_36_17, "bottomList/" .. arg_36_0.musicData.bottom_type), true)
	end
	...
	var_3(var_5.Find(var_36_18, "combo"), false)

	setActive = var_3

	local var_36_19 = arg_36_0.game_content

	var_3(var_5.Find(var_36_19, "combo_n"), false)

	setActive = var_3

	local var_36_20 = arg_36_0.game_content

	var_3(var_5.Find(var_36_20, "MusicStar"), false)
	...
	var_3(var_5.Find(var_36_21, "Spinelist"), true)
	...
	local var_36_22 = arg_36_0:getMusicNote(arg_36_0.musicData, arg_36_0.game_dgree)

	require = var_4

	local var_36_23 = var_4(var_36_22)

	arg_36_0.leftPu = {}
	arg_36_0.rightPu = {}
	ipairs = var_5

	for iter_36_4, iter_36_5 in var_5(var_36_23.left_track) do
		table = iter_36_1
	...
	for iter_36_6, iter_36_7 in var_5(var_36_23.right_track) do
		table = iter_36_1
	...
	arg_36_0.setTfChildVisible(var_36_24, arg_36_0.noteTpl, false)

	if not arg_36_0.gameNoteLeft then
		MusicGameNote = var_5

		local var_36_25 = var_5.New

		findTF = var_36_24
		var_36_24 = var_36_24(arg_36_0.game_content, "MusicPieceLeft")

		local var_36_26 = arg_36_0.noteTpl

		MusicGameNote = var_9
		arg_36_0.gameNoteLeft = var_36_25(var_36_24, var_36_26, var_9.type_left)
	end
	...
	if not arg_36_0.gameNoteRight then
		...
		local var_36_28 = var_36_24(arg_36_0.game_content, "MusicPieceRight")
		local var_36_29 = arg_36_0.noteTpl

		MusicGameNote = var_9
		arg_36_0.gameNoteRight = var_36_27(var_36_28, var_36_29, var_9.type_right)
	end

	local var_36_30 = arg_36_0.gameNoteLeft

	var_5.setStartData(var_36_30, arg_36_0.leftPu, arg_36_0.game_speed, arg_36_0.game_dgree, arg_36_0.noteType)

	local var_36_31 = arg_36_0.gameNoteLeft

	var_5.setStateCallback(var_36_31, function(arg_37_0)
	...
	var_5.setLongTimeCallback(var_36_32, function(arg_38_0)
	...
	local var_36_33 = arg_36_0.gameNoteRight

	var_5.setStartData(var_36_33, arg_36_0.rightPu, arg_36_0.game_speed, arg_36_0.game_dgree, arg_36_0.noteType)

	local var_36_34 = arg_36_0.gameNoteRight

	var_5.setStateCallback(var_36_34, function(arg_39_0)
	...
	var_5.setLongTimeCallback(var_36_35, function(arg_40_0)
	...
	local var_36_36 = arg_36_0:getMusicNote(arg_36_0.musicData, arg_36_0.game_dgree)

	require = var_6
	arg_36_0.musicpu = var_6(var_36_36)
	ipairs = var_6
	...
	local var_36_37 = arg_36_0.scoreSliderTf
	local var_36_38 = arg_36_0.top
	local var_36_39 = var_7.Find(var_36_38, "scoreContent/B")
	local var_36_40 = arg_36_0.top
	local var_36_41 = var_8.Find(var_36_40, "scoreContent/A")
	local var_36_42 = arg_36_0.top
	local var_36_43 = var_9.Find(var_36_42, "scoreContent/S")

	Vector3 = var_36_40
	var_36_39.anchoredPosition = var_36_40(arg_36_0.scoreSliderTf.anchoredPosition.x + var_36_37.rect.width * 0.53, var_36_39.anchoredPosition.y, var_36_39.anchoredPosition.z)
	Vector3 = var_10
	var_36_41.anchoredPosition = var_10(arg_36_0.scoreSliderTf.anchoredPosition.x + var_36_37.rect.width * 0.72, var_36_39.anchoredPosition.y, var_36_39.anchoredPosition.z)
	Vector3 = var_10
	var_36_43.anchoredPosition = var_10(arg_36_0.scoreSliderTf.anchoredPosition.x + var_36_37.rect.width * 0.885, var_36_39.anchoredPosition.y, var_36_39.anchoredPosition.z)
...
function var_0_1.loadSDModel(arg_43_0, arg_43_1)
	...
	if not arg_43_0.SDname[arg_43_1] or arg_43_0.SDname[arg_43_1] == "" or arg_43_0.SDname[arg_43_1] == "none" then
		...
		var_43_0(var_1_10004(arg_43_0._tf, "Spinelist/" .. arg_43_1 .. "/shadow"), false)

		setActive = var_43_0
		findTF = var_4

		var_43_0(var_4(arg_43_0._tf, "Spinelist/" .. arg_43_1 .. "/light"), false)
	...
	local var_43_2 = var_1_10003(arg_43_0._tf, "Spinelist/" .. arg_43_1 .. "/shadow")
	...
	if arg_43_0.musicLight and arg_43_0.shadowLight then
		...
		var_5(var_7(arg_43_0._tf, "Spinelist/" .. arg_43_1 .. "/shadow"), true)
	else
		setActive = var_5
		findTF = var_7

		var_5(var_7(arg_43_0._tf, "Spinelist/" .. arg_43_1 .. "/shadow"), false)
	end
	...
	for iter_43_0 = 1, var_0_7 do
		...
		if arg_43_0.musicLight and arg_43_0.musicLight > 0 then
			...
			var_43_3(var_1_10011(arg_43_0._tf, "Spinelist/" .. arg_43_1 .. "/light"), false)
			...
			if arg_43_0.musicData.ships[iter_43_0] and arg_43_0.musicData.ships[iter_43_0] ~= "" and arg_43_0.musicData.ships[iter_43_0] ~= "none" then
				LoadSpriteAtlasAsync = var_10

				var_10("ui/minigameui/musicgameother_atlas", "light" .. arg_43_0.musicLight, function(arg_44_0)
					setActive = var_2_10001
					findTF = var_2_10003

					var_2_10001(var_2_10003(arg_43_0._tf, "Spinelist/" .. var_43_3 .. "/light"), true)

					setImageSprite = var_2_10001
					findTF = var_3

					var_2_10001(var_3(arg_43_0._tf, "Spinelist/" .. var_43_3 .. "/light"), arg_44_0, true)
...
function var_0_1.loadAndPlayMusic(arg_48_0, arg_48_1, arg_48_2)
	...
	var_48_2(var_48_1, var_48_3, var_1_10008.CRI_FADE_TYPE.FADE_INOUT, function(arg_49_0)
		if arg_49_0 == nil then
			...
			if var_1 and var_0_2 then
				...
				var_49_3(var_49_2, var_4.GetLength(var_49_4) * var_0_3)
			else
...
function var_0_1.rec_scorce(arg_54_0)
	...
	var_1(var_3.Find(var_54_0, "scoreContent/B/bl"), false)

	setActive = var_1

	local var_54_1 = arg_54_0.top

	var_1(var_3.Find(var_54_1, "scoreContent/A/al"), false)

	setActive = var_1

	local var_54_2 = arg_54_0.top

	var_1(var_3.Find(var_54_2, "scoreContent/S/sl"), false)
	...
	var_1(var_3.Find(var_54_3, "combo_n/" .. arg_54_0.musicData.content_type), 0)
...
function var_0_1.effect_play(arg_55_0, arg_55_1, arg_55_2)
	if arg_55_1 == "nothing" then
		...
		var_1_10003(var_1_10005.Find(var_55_0, "scoreContent/S/liubianxing"), false)
		...
		var_1_10003(var_1_10005.Find(var_55_1, "MusicStar"), false)
	...
	elseif arg_55_1 == "S" then
		if arg_55_2 then
			...
			var_1_10003(var_1_10005(arg_55_0.scoreSliderTf, "img/mask/yinyue20_S"), true)
		else
			setActive = var_1_10003
			findTF = var_1_10005

			var_1_10003(var_1_10005(arg_55_0.scoreSliderTf, "img/mask/yinyue20_S"), false)
		end
	end
...
function var_0_1.scoresliderAcombo_update(arg_56_0)
	...
	if var_56_1 < 0.53 then
		...
		var_5(var_7.Find(var_56_4, "scoreContent/B/bl"), false)

		setActive = var_5

		local var_56_5 = arg_56_0.top

		var_5(var_7.Find(var_56_5, "scoreContent/A/al"), false)

		setActive = var_5

		local var_56_6 = arg_56_0.top

		var_5(var_7.Find(var_56_6, "scoreContent/S/sl"), false)
	elseif 0.53 <= var_56_1 then
		setActive = var_5

		local var_56_7 = arg_56_0.top

		var_5(var_7.Find(var_56_7, "scoreContent/B/bl"), true)
		...
		if 0.72 <= var_56_1 then
			...
			var_5(var_7.Find(var_56_8, "scoreContent/A/al"), true)
			...
			if 0.885 <= var_56_1 then
				...
				var_5(var_7.Find(var_56_9, "scoreContent/S/sl"), true)
			end
		end
	end
	...
	var_5(var_7.Find(var_56_10, "combo_n/" .. arg_56_0.musicData.content_type), arg_56_0.combo_link)
...
function var_0_1.score_update(arg_57_0, arg_57_1)
	...
	if arg_57_1 == 0 then
		...
		var_3(var_5.Find(var_57_2, "combo"), false)

		setActive = var_3

		local var_57_3 = arg_57_0.game_content

		var_3(var_5.Find(var_57_3, "combo_n"), false)
	else
		...
		if arg_57_0.combo_link > 1 then
			...
			var_57_9(var_5.Find(var_57_5, "combo"), true)

			setActive = var_57_9

			local var_57_6 = arg_57_0.game_content

			var_57_9(var_5.Find(var_57_6, "combo_n"), true)
			...
			local var_57_10 = var_57_9(var_57_8, var_6(var_8))
			...
			local var_57_13 = var_57_9(var_57_12, var_6(var_8))
			...
			var_57_9(var_5.Find(var_57_14, "combo"), false)

			setActive = var_57_9

			local var_57_15 = arg_57_0.game_content

			var_57_9(var_5.Find(var_57_15, "combo_n"), false)
		end
	...
	if not var_4.loopTime(var_57_18) then
		...
		if arg_57_0.game_dgree == 2 and arg_57_0.combo_link > 50 or arg_57_0.game_dgree == 1 and arg_57_0.combo_link > 20 then
			...
			if not var_5(var_57_20) then
				...
				var_5(var_7.Find(var_57_21, "MusicStar"), true)
			end
		else
			SetActive = var_5
			...
			var_5(var_7.Find(var_57_22, "MusicStar"), false)
		end
...
function var_0_1.count_five(arg_58_0, arg_58_1)
	...
	local var_58_2 = var_1_10003(arg_58_0.countTf, "img")

	findTF = var_58_0

	local var_58_3 = var_58_0(arg_58_0.countTf, "bg")
	...
	arg_58_0.count_timer = var_8.New(function()
		...
		if var_58_1 < 0 then
			...
			local var_60_4 = var_60_3(var_2(arg_58_0.countContent), 0, 2, 2)

			var_60_3 = var_60_3.setOnUpdate
			System = var_3

			local var_60_5 = var_60_3(var_60_4, var_3.Action_float(function(arg_61_0)
				local var_61_0
				...
				if arg_61_0 <= 0.25 then
					...
					local var_61_3 = var_58_6

					Vector3 = var_5

					var_61_2(var_61_3, var_5(var_61_1, var_61_1, var_61_1))
				elseif arg_61_0 >= 1.8 then
					local var_61_4 = (2 - arg_61_0) * 4
					local var_61_5 = var_58_5

					Vector3 = var_3_10003
					var_61_5.localScale = var_3_10003(var_61_4, var_61_4, var_61_4)
					setLocalScale = var_61_5

					local var_61_6 = var_58_6

					Vector3 = var_5

					var_61_5(var_61_6, var_5(var_61_4, var_61_4, var_61_4))

					setImageAlpha = var_61_5

					var_61_5(var_58_5, var_61_4)
				end
			...
			local var_60_6 = var_60_3(var_60_5, var_3.linear)

			var_60_3 = var_60_3.setOnComplete
			System = var_3

			var_60_3(var_60_6, var_3.Action(function()
				...
				var_62_0(var_62_1, var_3(1, 1, 1, 1))
...
function var_0_1.showSelevtView(arg_63_0)
	...
	local var_63_15 = var_63_14(var_63_13, var_1_10014(var_1_10016))
	...
	local function var_63_18()
		...
		var_66_2.type = var_2_10004
		pg = var_2_10004
		var_66_2.helps = var_2_10004.gametip.help_music_game.tip
	...
	var_12(var_63_16, var_63_17, var_63_18, var_1_10017)
	...
	var_12(var_63_19, var_63_20, var_63_21, var_1_10017)
	...
	SFX_UI_CONFIRM = var_1_10017

	var_12(var_63_22, var_63_23, var_63_24, var_1_10017)

	onButton = var_12

	local var_63_25 = arg_63_0
	local var_63_26 = var_63_3
	local var_63_27 = var_63_3.Find(var_63_26, "easy")

	local function var_63_28()
		...
		var_69_0(var_2.Find(var_69_1, "hard/frame"), false)

		setActive = var_69_0

		local var_69_2 = var_63_3

		var_69_0(var_2.Find(var_69_2, "easy/frame"), true)
	...
	SFX_UI_CLICK = var_63_26

	var_12(var_63_25, var_63_27, var_63_28, var_63_26)

	onButton = var_12

	local var_63_29 = arg_63_0
	local var_63_30 = var_63_3
	local var_63_31 = var_63_3.Find(var_63_30, "hard")

	local function var_63_32()
		...
		var_70_0(var_2.Find(var_70_1, "easy/frame"), false)

		setActive = var_70_0

		local var_70_2 = var_63_3

		var_70_0(var_2.Find(var_70_2, "hard/frame"), true)
	...
	SFX_UI_CLICK = var_63_30

	var_12(var_63_29, var_63_31, var_63_32, var_63_30)

	onButton = var_12

	local var_63_33 = arg_63_0
	local var_63_34 = var_63_8

	local function var_63_35()
		setActive = var_2_10000

		local var_71_0 = var_63_8

		var_2_10000(var_2.Find(var_71_0, "x" .. arg_63_0.game_speed), false)
		...
		var_0(var_2.Find(var_71_2, "x" .. arg_63_0.game_speed), true)
	...
	var_12(var_63_33, var_63_34, var_63_35, var_63_30)
	...
	local var_63_36 = arg_63_0.gameMusicIndex

	for iter_63_0 = 1, arg_63_0.music_amount do
		local var_63_37 = arg_63_0.song_btns

		cloneTplTo = var_63_39
		var_63_37[iter_63_0] = var_63_39(arg_63_0.song_btn, var_63_4, "music" .. iter_63_0)

		local var_63_38 = arg_63_0.musicDatas[iter_63_0]

		setActive = var_63_39

		var_63_39(arg_63_0.song_btns[iter_63_0], true)

		local var_63_39 = arg_63_0.song_btn.localPosition

		math = var_1_10019
		var_1_10019 = var_1_10019.abs(iter_63_0 - var_63_36)

		local var_63_40 = iter_63_0 - var_63_36 < arg_63_0.music_amount_middle and var_1_10019 or iter_63_0 - arg_63_0.music_amount_middle * 2
		local var_63_41 = arg_63_0.song_btns[iter_63_0]

		Vector3 = var_22
		var_63_41.localPosition = var_22(var_63_39.x + var_63_40 * 1022, var_63_39.y, var_63_39.z)
		var_63_39 = arg_63_0.song_btn.localScale

		local var_63_42 = arg_63_0.song_btns[iter_63_0]

		Vector3 = var_22

		local var_63_43 = var_63_39.x

		math = var_25

		local var_63_44 = var_63_43 - var_25.abs(var_63_40) * 0.2
		local var_63_45 = var_63_39.y

		math = var_26

		local var_63_46 = var_63_45 - var_26.abs(var_63_40) * 0.2
		local var_63_47 = var_63_39.z

		math = var_27
		var_63_42.localScale = var_22(var_63_44, var_63_46, var_63_47 - var_27.abs(var_63_40) * 0.2)

		local var_63_48 = arg_63_0.song_btns[iter_63_0]
		local var_63_49 = var_21.Find(var_63_48, "song")
		local var_63_50 = var_21.GetComponent

		typeof = var_24
		Image = var_26

		local var_63_51 = var_63_50(var_63_49, var_24(var_26))
		local var_63_52 = var_63_4:Find("img/" .. var_63_38.picture)
		local var_63_53 = var_22.GetComponent

		typeof = var_25
		Image = var_27
		var_63_51.sprite = var_63_53(var_63_52, var_25(var_27)).sprite

		local var_63_54 = arg_63_0.song_btns[iter_63_0]
		local var_63_55 = var_22.Find(var_63_54, "zhuanji3/zhuanji2_5")
		local var_63_56 = var_22.GetComponent

		typeof = var_25
		Image = var_27

		local var_63_57 = var_63_56(var_63_55, var_25(var_27))
		local var_63_58 = var_63_4:Find("img/" .. var_63_38.picture .. "_1")
		local var_63_59 = var_23.GetComponent

		typeof = var_26
		Image = var_28
		var_63_57.sprite = var_63_59(var_63_58, var_26(var_28)).sprite
		Color = var_63_57

		local var_63_60 = var_63_57.New
		local var_63_61 = 1
		local var_63_62 = 1
		local var_63_63 = 1

		math = var_27
		var_63_51.color = var_63_60(var_63_61, var_63_62, var_63_63, 1 - var_27.abs(var_63_40) * 0.6)
		onButton = var_22

		local var_63_64 = arg_63_0
		local var_63_65 = arg_63_0.song_btns[iter_63_0]

		local function var_63_66()
		...
		var_22(var_63_64, var_63_65, var_63_66, var_27)

		if iter_63_0 == var_63_36 then
			local var_63_67 = arg_63_0.song_btns[iter_63_0]
			local var_63_68 = var_22.GetComponent

			typeof = var_63_65
			Animator = var_27

			local var_63_69 = var_63_68(var_63_67, var_63_65(var_27))

			var_22.Play(var_63_69, "plate_out")

			local var_63_70 = arg_63_0.song_btns[iter_63_0]
			local var_63_71 = var_22.GetComponent

			typeof = var_25
			Button = var_27
			var_63_71(var_63_70, var_25(var_27)).interactable = false
		end
	end
...
function var_0_1.updateMusic(arg_73_0, arg_73_1)
	...
	var_73_2(var_73_1, var_5.Find(var_73_3, "scoreContent/B/bl"), false)

	local var_73_4 = arg_73_0
	local var_73_5 = arg_73_0.setTfChildVisible
	local var_73_6 = arg_73_0.top

	var_73_5(var_73_4, var_5.Find(var_73_6, "scoreContent/B/b"), false)

	local var_73_7 = arg_73_0
	local var_73_8 = arg_73_0.setTfChildVisible
	local var_73_9 = arg_73_0.top

	var_73_8(var_73_7, var_5.Find(var_73_9, "scoreContent/A/al"), false)

	local var_73_10 = arg_73_0
	local var_73_11 = arg_73_0.setTfChildVisible
	local var_73_12 = arg_73_0.top

	var_73_11(var_73_10, var_5.Find(var_73_12, "scoreContent/A/a"), false)

	local var_73_13 = arg_73_0
	local var_73_14 = arg_73_0.setTfChildVisible
	local var_73_15 = arg_73_0.top

	var_73_14(var_73_13, var_5.Find(var_73_15, "scoreContent/S/sl"), false)

	local var_73_16 = arg_73_0
	local var_73_17 = arg_73_0.setTfChildVisible
	local var_73_18 = arg_73_0.top

	var_73_17(var_73_16, var_5.Find(var_73_18, "scoreContent/S/s"), false)

	setActive = var_73_17

	local var_73_19 = arg_73_0.top

	var_73_17(var_4.Find(var_73_19, "scoreContent/B/b/" .. arg_73_0.musicData.content_type), true)

	setActive = var_73_17

	local var_73_20 = arg_73_0.top

	var_73_17(var_4.Find(var_73_20, "scoreContent/B/bl/" .. arg_73_0.musicData.content_type), true)

	setActive = var_73_17

	local var_73_21 = arg_73_0.top

	var_73_17(var_4.Find(var_73_21, "scoreContent/A/a/" .. arg_73_0.musicData.content_type), true)

	setActive = var_73_17

	local var_73_22 = arg_73_0.top

	var_73_17(var_4.Find(var_73_22, "scoreContent/A/al/" .. arg_73_0.musicData.content_type), true)

	setActive = var_73_17

	local var_73_23 = arg_73_0.top

	var_73_17(var_4.Find(var_73_23, "scoreContent/S/s/" .. arg_73_0.musicData.content_type), true)

	setActive = var_73_17

	local var_73_24 = arg_73_0.top

	var_73_17(var_4.Find(var_73_24, "scoreContent/S/sl/" .. arg_73_0.musicData.content_type), true)

	local var_73_25 = arg_73_0
	local var_73_26 = arg_73_0.setTfChildVisible
	local var_73_27 = arg_73_0.game_content

	var_73_26(var_73_25, var_5.Find(var_73_27, "combo_n"), false)

	local var_73_28 = arg_73_0
	local var_73_29 = arg_73_0.setTfChildVisible
	local var_73_30 = arg_73_0.game_content

	var_73_29(var_73_28, var_5.Find(var_73_30, "combo"), false)

	setActive = var_73_29

	local var_73_31 = arg_73_0.game_content

	var_73_29(var_4.Find(var_73_31, "combo_n/" .. arg_73_0.musicData.content_type), true)

	setActive = var_73_29

	local var_73_32 = arg_73_0.game_content

	var_73_29(var_4.Find(var_73_32, "combo/" .. arg_73_0.musicData.content_type), true)
	...
	var_73_35(var_73_34, var_5.Find(var_73_36, "score"), false)

	setActive = var_73_35

	local var_73_37 = arg_73_0.top
	local var_73_38 = var_4.Find
	local var_73_39 = "score/"

	tostring = var_8

	var_73_35(var_73_38(var_73_37, var_73_39 .. var_8(arg_73_0.musicData.content_type)), true)
	...
	tostring = var_73_37
	arg_73_0.gameScoreTf = var_73_41(var_73_40, var_73_42 .. var_73_37(arg_73_0.musicData.content_type) .. "/text")
	findTF = var_2
...
function var_0_1.updateEffectTf(arg_75_0)
	...
	var_3(iter_75_0(arg_75_0.game_content, "effect/" .. var_75_2))

	local var_75_3 = arg_75_0.game_content

	arg_75_0.fullComboEffect = var_3.Find(var_75_3, "effect/" .. var_75_2 .. "/yinyue_Fullcombo")

	local var_75_4 = arg_75_0.game_content

	arg_75_0.liveClearEffect = var_3.Find(var_75_4, "effect/" .. var_75_2 .. "/yinyue_LiveClear")

	local var_75_5 = arg_75_0.game_content

	arg_75_0.yinyueGood = var_3.Find(var_75_5, "effect/" .. var_75_2 .. "/yinyue_good")

	local var_75_6 = arg_75_0.game_content

	arg_75_0.yinyueComboeffect = var_3.Find(var_75_6, "effect/" .. var_75_2 .. "/yinyue_comboeffect")

	local var_75_7 = arg_75_0.game_content

	arg_75_0.yinyuePerfect = var_3.Find(var_75_7, "effect/" .. var_75_2 .. "/yinyue_perfect")

	local var_75_8 = arg_75_0.game_content

	arg_75_0.yinyuePefectLoop = var_3.Find(var_75_8, "effect/" .. var_75_2 .. "/yinyue_perfect_loop02")
		...
		for iter_79_0 = 1, arg_78_0.music_amount do
			...
			if var_78_1 <= 0 then
				if var_79_0 == var_0 then
					local var_79_1 = arg_78_0.song_btns[iter_79_0]
					local var_79_2 = var_5.GetComponent

					typeof = var_2_10008
					Animator = var_2_10010

					local var_79_3 = var_79_2(var_79_1, var_2_10008(var_2_10010))

					var_5.Play(var_79_3, "plate_out")
				else
					local var_79_4 = arg_78_0.song_btns[iter_79_0]
					local var_79_5 = var_5.GetComponent

					typeof = var_2_10008
					Animator = var_2_10010

					local var_79_6 = var_79_5(var_79_4, var_2_10008(var_2_10010))

					var_5.Play(var_79_6, "plate_static")

					local var_79_7 = arg_78_0.song_btns[iter_79_0]
					local var_79_8 = var_5.GetComponent

					typeof = var_2_10008
					Button = var_2_10010
					var_79_8(var_79_7, var_2_10008(var_2_10010)).interactable = true
				end
			else
				local var_79_9 = arg_78_0.song_btns[iter_79_0]
				local var_79_10 = var_5.GetComponent

				typeof = var_2_10008
				Animator = var_2_10010

				local var_79_11 = var_79_10(var_79_9, var_2_10008(var_2_10010))

				var_5.Play(var_79_11, "plate_static")

				local var_79_12 = arg_78_0.song_btns[iter_79_0]
				local var_79_13 = var_5.GetComponent

				typeof = var_2_10008
				Button = var_2_10010
				var_79_13(var_79_12, var_2_10008(var_2_10010)).interactable = false
			end

			local var_79_14 = arg_78_0.song_btn.localPosition

			math = var_6

			local var_79_15 = var_6.abs(var_79_0 - var_0)
			local var_79_16 = var_79_14.x

			var_2_10008 = var_79_0 - var_0 > 0 and 1 or -1

			local var_79_17 = (var_79_16 + var_2_10008 * var_79_15 * 1022) * (1 - var_78_1 * 2) + var_78_2[iter_79_0].x * var_78_1 * 2

			var_2_10008 = arg_78_0.song_btns[iter_79_0]
			Vector3 = var_9
			var_2_10008.localPosition = var_9(var_79_17, var_79_14.y, var_79_14.z)

			local var_79_18 = arg_78_0.song_btns[iter_79_0].localScale
			local var_79_19 = (1 - var_79_15 * 0.2) * (1 - var_78_1 * 2) + var_78_3[iter_79_0].x * var_78_1 * 2

			var_2_10008 = arg_78_0.song_btns[iter_79_0]
			Vector3 = var_9
			var_2_10008.localScale = var_9(var_79_19, var_79_19, var_79_19)
			var_2_10010 = arg_78_0.song_btns[iter_79_0]
			var_2_10010 = var_2_10008.Find(var_2_10010, "song")
			var_2_10008 = var_2_10008.GetComponent
			typeof = var_11
			Image = var_13
			var_2_10008 = var_2_10008(var_2_10010, var_11(var_13))

			local var_79_20 = (1 - var_79_15 * 0.6) * (1 - var_78_1 * 2) + var_2_10008.color.a * var_78_1 * 2

			Color = var_9
			var_2_10008.color = var_9.New(1, 1, 1, 1 - var_79_15 * 0.6)
		end

		if var_78_1 <= 0 then
			arg_78_0.changeLocalposTimerflag = false

			local var_79_21 = arg_78_0.changeLocalpos_timer

			var_0.Stop(var_79_21)
		end
...
function var_0_1.Firstshow(arg_85_0, arg_85_1, arg_85_2, arg_85_3)
	...
	var_4("ui/minigameui/musicgameother_atlas", "help1", function(arg_86_0)
		...
		local var_86_0 = var_2_10003(arg_85_0.firstview, "num/img1")

		typeof = var_2_10004
		Image = var_6
		var_2_10001(var_86_0, var_2_10004(var_6)).sprite = arg_86_0
	...
	var_4("ui/minigameui/musicgameother_atlas", "help2", function(arg_87_0)
		...
		local var_87_0 = var_2_10003(arg_85_0.firstview, "num/img2")

		typeof = var_2_10004
		Image = var_6
		var_2_10001(var_87_0, var_2_10004(var_6)).sprite = arg_87_0
	...
	for iter_85_0 = 1, 2 do
		...
		local var_85_0 = var_85_0(arg_85_1, "num/img" .. iter_85_0)

		setActive = var_1_10009

		var_1_10009(var_85_0, iter_85_0 == arg_85_3 and true or false)
	end
	...
	local var_85_2 = arg_85_0.firstview_timer

	var_4.Start(var_85_2)
...
function var_0_1.updatSelectview(arg_90_0)
	...
	var_1(var_3.Find(var_90_0, "top/Speedlist/x" .. arg_90_0.game_speed), true)
	...
	for iter_90_0 = 1, arg_90_0.music_amount do
		...
		var_6(var_8.Find(var_90_2, "song/best"), false)
	...
	if arg_90_0.song_btns[var_90_4] and 0 < var_90_5 then
		...
		var_4(var_6.Find(var_90_6, "song/best"), true)
...
function var_0_1.locadScoreView(arg_93_0)
	...
	setImageColor = var_1_10002

	local var_93_1 = var_93_0

	Color = var_1_10005

	var_1_10002(var_93_1, var_1_10005(0, 0, 0))

	LoadSpriteAtlasAsync = var_1_10002

	var_1_10002("ui/minigameui/musicgameother_atlas", "scoreBg" .. arg_93_0.musicBg, function(arg_94_0)
		if var_93_0 then
			GetComponent = var_1
			...
			local var_94_1 = var_1(var_94_0, var_2_10004(var_2_10006))
	...
	var_1_10002(var_4.Find(var_93_2, "combo"), false)

	setActive = var_1_10002

	local var_93_3 = arg_93_0.game_content

	var_1_10002(var_4.Find(var_93_3, "MusicStar"), false)

	setActive = var_1_10002

	local var_93_4 = arg_93_0.game_content

	var_1_10002(var_4.Find(var_93_4, "combo_n"), false)

	setActive = var_1_10002

	var_1_10002(arg_93_0.game_content, false)

	setActive = var_1_10002

	var_1_10002(arg_93_0.top, false)

	setActive = var_1_10002

	local var_93_5 = arg_93_0._tf

	var_1_10002(var_4.Find(var_93_5, "Spinelist"), false)
	...
	for iter_93_0 = 1, var_93_7 do
		...
		local var_93_8 = arg_93_0.scoreview

		var_7(var_9.Find(var_93_8, "maskBg/bg" .. iter_93_0), iter_93_0 == arg_93_0.musicBg)
	end
	...
	for iter_93_1 = 1, var_93_10 do
		...
		var_9(var_11.Find(var_93_12, "maskBgBottom/bg" .. iter_93_1), var_93_11)
	end
	...
	if arg_93_0.painting then
		...
		var_6(var_8.Find(var_93_15, "paint"), arg_93_0.painting)
	end
	...
	if var_93_17[var_8.lower(arg_93_0.painting)] then
		...
		var_9.PaintingDownload({
			...
			finishFunc = function()
				...
				var_2_10000(var_2.Find(var_95_0, "paint"), arg_93_0.painting, "mainNormal")
		...
		var_93_18(var_10.Find(var_93_19, "paint"), arg_93_0.painting, "mainNormal")
	end
	...
	var_93_18(var_10.Find(var_93_20, "scoreImg/square/easy"), var_93_13 == 1)

	setActive = var_93_18

	local var_93_21 = arg_93_0.scoreUIContent

	var_93_18(var_10.Find(var_93_21, "scoreImg/square/hard"), var_93_13 == 2)

	setActive = var_93_18

	local var_93_22 = arg_93_0.scoreUIContent

	var_93_18(var_10.Find(var_93_22, "scoreList/fullCombo"), arg_93_0.miss_number == 0)

	setActive = var_93_18

	local var_93_23 = arg_93_0.scoreUIContent

	var_93_18(var_10.Find(var_93_23, "scoreImg/perfect/noMiss"), arg_93_0.miss_number == 0 and arg_93_0.good_number == 0)
	...
	local function var_93_24(arg_96_0, arg_96_1, arg_96_2)
		...
		local var_96_1 = var_96_0(var_2_10005(arg_93_0.scoreview), 0, arg_96_1, 0.6)
		local var_96_2 = var_3.setOnUpdate

		System = var_6

		local var_96_3 = var_96_2(var_96_1, var_6.Action_float(function(arg_97_0)
			setText = var_3_10001
			...
			var_3_10001(var_97_0, var_3_10004.round(arg_97_0))
		...
		var_96_4(var_96_3, var_6.Action(function()
			arg_96_2()
	...
	var_9({
		function(arg_99_0)
			...
			var_99_0(var_3.Find(var_99_1, "scoreList/perfect"), arg_93_0.perfect_number, arg_99_0)
		...
		function(arg_100_0)
			...
			var_100_0(var_3.Find(var_100_1, "scoreList/good"), arg_93_0.good_number, arg_100_0)
		...
		function(arg_101_0)
			...
			var_101_0(var_3.Find(var_101_1, "scoreList/miss"), arg_93_0.miss_number, arg_101_0)
		...
		function(arg_102_0)
			...
			var_102_0(var_3.Find(var_102_1, "scoreList/combo"), arg_93_0.combo_number, arg_102_0)
		...
		function(arg_103_0)
			...
			if arg_93_0.score_number > arg_93_0.bestScorelist[var_93_14 + (var_93_13 - 1) * arg_93_0.music_amount] then
				...
				var_103_2(var_4.Find(var_103_1, "scoreImg/square/newScore"), true)
				...
				var_103_2(var_4.Find(var_103_3, "scoreImg/square/newScore"), false)
			end

			local var_103_4 = var_93_24
			local var_103_5 = arg_93_0.scoreUIContent

			var_103_4(var_4.Find(var_103_5, "scoreImg/square/bestscore"), var_103_0, arg_103_0)

			local var_103_6 = var_93_24
			local var_103_7 = arg_93_0.scoreUIContent

			var_103_6(var_4.Find(var_103_7, "scoreImg/square/score"), arg_93_0.score_number, function()
				return
			end)
		...
		function(arg_105_0)
			...
			if arg_93_0.score_number < arg_93_0.score_blist[var_93_13] then
				function var_105_0()
					...
					BaseMiniGameMediator = var_3

					var_106_2(var_106_1, var_3.MINI_GAME_SUCCESS, arg_93_0.score_number)

					return
				end
			else
				local var_105_1 = arg_93_0.score_number

				if arg_93_0.score_blist[var_93_13] <= var_105_1 and arg_93_0.score_number < arg_93_0.score_alist[var_93_13] then
					function var_105_0()
						...
						var_107_2(var_107_1, var_3.MINI_GAME_SUCCESS, arg_93_0.score_number)

						return
					end
				else
					local var_105_2 = arg_93_0.score_number

					if arg_93_0.score_alist[var_93_13] <= var_105_2 and arg_93_0.score_number < arg_93_0.score_slist[var_93_13] then
						function var_105_0()
							...
							var_108_2(var_108_1, var_3.MINI_GAME_SUCCESS, arg_93_0.score_number)
						...
						function var_105_0()
							...
							var_109_2(var_109_1, var_3.MINI_GAME_SUCCESS, arg_93_0.score_number)
			...
			local var_105_3 = arg_93_0
			local var_105_4 = var_2.GetMGHubData(var_105_3)

			pg = var_3

			local var_105_5 = var_3.NewStoryMgr.GetInstance()
			local var_105_6 = arg_93_0
			local var_105_7 = var_4.GetMGData(var_105_6)
			local var_105_8

			if not var_4.getConfig(var_105_7, "simple_config_data").story[var_105_4.usedtime + 1] or not var_4[var_105_4.usedtime + 1][1] then
				var_105_8 = nil
			end

			if var_105_4.count > 0 and var_105_8 and not var_105_5:IsPlayed(var_105_8) and arg_93_0.score_number >= arg_93_0.score_blist[var_93_13] then
				var_105_5:Play(var_105_8, var_105_0)
			else
				var_105_0()
			end
	...
	var_10(var_93_26, arg_93_0.musicData.music_name)
	...
	local var_93_30 = var_93_29(var_93_28, var_13(var_1_10015))
	...
	typeof = var_14
	Image = var_1_10016
	var_93_30.sprite = var_93_33(var_93_32, var_14(var_1_10016)).sprite
	...
	local var_93_37 = var_93_36(var_93_35, var_14(var_1_10016))
	...
	typeof = var_15
	Image = var_1_10017
	var_93_37.sprite = var_93_40(var_93_39, var_15(var_1_10017)).sprite
	GetComponent = var_93_37

	local var_93_41 = arg_93_0.scoreUIContent
	local var_93_42 = var_13.Find(var_93_41, "btnList/share")

	typeof = var_93_39
	Image = var_16

	local var_93_43 = var_93_37(var_93_42, var_93_39(var_16))
	...
	local var_93_46 = var_15.Find(var_93_45, "btnList/share")
	...
	local function var_93_47()
		...
		var_111_1(var_111_0, var_2_10003.ShareMgr.TypeSummary)
	...
	var_12(var_93_44, var_93_46, var_93_47, var_93_45)

	GetComponent = var_12

	local var_93_48 = arg_93_0.scoreUIContent
	local var_93_49 = var_14.Find(var_93_48, "btnList/restart")

	typeof = var_93_46
	Image = var_17

	local var_93_50 = var_12(var_93_49, var_93_46(var_17))
	...
	local var_93_53 = var_15.Find(var_93_52, "btnList/restart")
	...
	local function var_93_54()
		...
		if arg_93_0.painting then
			...
			var_0(var_2.Find(var_112_4, "paint"), arg_93_0.painting)
	...
	SFX_UI_CLICK = var_93_52

	var_12(var_93_51, var_93_53, var_93_54, var_93_52)

	GetComponent = var_12

	local var_93_55 = arg_93_0.scoreUIContent
	local var_93_56 = var_14.Find(var_93_55, "btnList/reselect")

	typeof = var_93_53
	Image = var_17

	local var_93_57 = var_12(var_93_56, var_93_53(var_17))
	...
	local var_93_60 = var_15.Find(var_93_59, "btnList/reselect")
	...
	local function var_93_61()
		...
		local var_113_6 = var_113_5(var_113_4, var_3(var_2_10005))
		...
		if arg_93_0.painting then
			...
			var_0(var_2.Find(var_113_10, "paint"), arg_93_0.painting)
	...
	SFX_UI_CLICK = var_93_59

	var_12(var_93_58, var_93_60, var_93_61, var_93_59)
...
function var_0_1.setScoceview_pj(arg_114_0, arg_114_1)
	...
	var_1_10002(var_4.Find(var_114_0, "scoreImg/square/c"), false)

	setActive = var_1_10002

	local var_114_1 = arg_114_0.scoreUIContent

	var_1_10002(var_4.Find(var_114_1, "scoreImg/square/b"), false)

	setActive = var_1_10002

	local var_114_2 = arg_114_0.scoreUIContent

	var_1_10002(var_4.Find(var_114_2, "scoreImg/square/a"), false)

	setActive = var_1_10002

	local var_114_3 = arg_114_0.scoreUIContent

	var_1_10002(var_4.Find(var_114_3, "scoreImg/square/s"), false)
	...
	elseif arg_114_1 == "c" then
		...
		var_1_10002(var_4.Find(var_114_4, "scoreImg/square/c"), true)
	elseif arg_114_1 == "b" then
		setActive = var_1_10002

		local var_114_5 = arg_114_0.scoreUIContent

		var_1_10002(var_4.Find(var_114_5, "scoreImg/square/b"), true)
	elseif arg_114_1 == "a" then
		setActive = var_1_10002

		local var_114_6 = arg_114_0.scoreUIContent

		var_1_10002(var_4.Find(var_114_6, "scoreImg/square/a"), true)
	elseif arg_114_1 == "s" then
		setActive = var_1_10002

		local var_114_7 = arg_114_0.scoreUIContent

		var_1_10002(var_4.Find(var_114_7, "scoreImg/square/s"), true)
	end
...
function var_0_1.Scoceview_ani(arg_115_0)
	...
	var_1_10002(var_4.Find(var_115_1, "btnList/reselect"), false)

	setActive = var_1_10002

	local var_115_2 = arg_115_0.scoreUIContent

	var_1_10002(var_4.Find(var_115_2, "btnList/restart"), false)

	setActive = var_1_10002

	local var_115_3 = arg_115_0.scoreUIContent

	var_1_10002(var_4.Find(var_115_3, "btnList/share"), false)
	...
	local function var_115_4()
		...
		if var_115_0 >= 0.99 then
			...
			var_0(var_2.Find(var_116_0, "btnList/reselect"), true)

			setActive = var_0

			local var_116_1 = arg_115_0.scoreUIContent

			var_0(var_2.Find(var_116_1, "btnList/restart"), true)

			setActive = var_0

			local var_116_2 = arg_115_0.scoreUIContent

			var_0(var_2.Find(var_116_2, "btnList/share"), true)

			setText = var_0

			local var_116_3 = arg_115_0.scoreUIContent

			var_0(var_2.Find(var_116_3, "scoreList/perfect"), arg_115_0.perfect_number)

			setText = var_0

			local var_116_4 = arg_115_0.scoreUIContent

			var_0(var_2.Find(var_116_4, "scoreList/good"), arg_115_0.good_number)

			setText = var_0

			local var_116_5 = arg_115_0.scoreUIContent

			var_0(var_2.Find(var_116_5, "scoreList/miss"), arg_115_0.miss_number)

			setText = var_0

			local var_116_6 = arg_115_0.scoreUIContent

			var_0(var_2.Find(var_116_6, "scoreList/combo"), arg_115_0.combo_number)

			setText = var_0

			local var_116_7 = arg_115_0.scoreUIContent

			var_0(var_2.Find(var_116_7, "scoreImg/square/bestscore"), arg_115_0.score_number)
		else
			setText = var_0

			local var_116_8 = arg_115_0.scoreUIContent
			local var_116_9 = var_2.Find(var_116_8, "scoreList/perfect")

			math = var_2_10003

			var_0(var_116_9, var_2_10003.floor(arg_115_0.perfect_number * var_115_0))

			setText = var_0

			local var_116_10 = arg_115_0.scoreUIContent
			local var_116_11 = var_2.Find(var_116_10, "scoreList/good")

			math = var_3

			var_0(var_116_11, var_3.floor(arg_115_0.good_number * var_115_0))

			setText = var_0

			local var_116_12 = arg_115_0.scoreUIContent
			local var_116_13 = var_2.Find(var_116_12, "scoreList/miss")

			math = var_3

			var_0(var_116_13, var_3.floor(arg_115_0.miss_number * var_115_0))

			setText = var_0

			local var_116_14 = arg_115_0.scoreUIContent
			local var_116_15 = var_2.Find(var_116_14, "scoreList/combo")

			math = var_3

			var_0(var_116_15, var_3.floor(arg_115_0.combo_number * var_115_0))

			setText = var_0

			local var_116_16 = arg_115_0.scoreUIContent
			local var_116_17 = var_2.Find(var_116_16, "scoreImg/square/bestscore")

			math = var_3

			var_0(var_116_17, var_3.floor(arg_115_0.score_number * var_115_0))
		end
	...
	Timer = var_1_10003
	arg_115_0.Scoceview_timer = var_1_10003.New(var_115_4, arg_115_0.time_interval, -1)
	...
	if var_124_2 then
		...
		if var_124_0 == 1 then
			...
			if not var_124_3(var_124_1.J) then
				...
				if arg_124_0.song_Tlength and not arg_124_0.scoreview_flag then
					...
					if var_2(arg_124_0.song_Tlength) / 1000 - arg_124_0.musicgame_nowtime <= 0.01666 then
						...
						if arg_124_0.perfect_number > 0 and arg_124_0.good_number == 0 and arg_124_0.miss_number == 0 then
							...
							local var_124_24 = var_5(arg_124_0.fullComboEffect)
							local var_124_25 = 2

							System = var_7

							var_124_23(var_124_24, var_124_25, var_7.Action(function()
								var_124_22()
							...
							if (arg_124_0.good_number > 0 or arg_124_0.perfect_number > 0) and arg_124_0.miss_number <= 0 then
								setActive = var_124_26

								var_124_26(arg_124_0.fullComboEffect, true)
								...
								LeanTween = var_124_26
								var_124_26 = var_124_26.delayedCall
								go = var_5

								local var_124_27 = var_5(arg_124_0.fullComboEffect)
								local var_124_28 = 2

								System = var_7

								var_124_26(var_124_27, var_124_28, var_7.Action(function()
									var_124_22()
								...
								var_124_26(arg_124_0.liveClearEffect, true)

								LeanTween = var_124_26

								local var_124_29 = var_124_26.delayedCall

								go = var_5

								local var_124_30 = var_5(arg_124_0.liveClearEffect)
								local var_124_31 = 2

								System = var_7

								var_124_29(var_124_30, var_124_31, var_7.Action(function()
									var_124_22()
				...
				local var_124_32 = arg_124_0.gameNoteLeft

				var_2.step(var_124_32, arg_124_0.gameStepTime)

				local var_124_33 = arg_124_0.gameNoteRight

				var_2.step(var_124_33, arg_124_0.gameStepTime)
				arg_124_0:scoresliderAcombo_update()

				if arg_124_0.drumpFlag then
					local var_124_34 = arg_124_0.gameNoteLeft

					if not var_2.loopTime(var_124_34) then
						local var_124_35 = arg_124_0.gameNoteRight

						if not var_2.loopTime(var_124_35) then
							arg_124_0.drumpFlag = false
							Time = var_2
							arg_124_0.drupTime = var_2.realtimeSinceStartup

							local var_124_36 = arg_124_0

							arg_124_0.setActionSDmodel(var_124_36, "jump")

							LeanTween = var_2

							local var_124_37 = var_2.delayedCall

							go = var_124_36

							local var_124_38 = var_124_36(arg_124_0.game_content)
							local var_124_39 = 1

							System = var_6

							var_124_37(var_124_38, var_124_39, var_6.Action(function()
