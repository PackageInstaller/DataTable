...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	arg_1_0._contentAniamtor = var_1_1(var_1_0, var_7(var_1_10009))
	...
	arg_1_0._contentDftEvent = var_1_3(var_1_2, var_7(var_1_10009))
	...
	for iter_1_0 = 1, var_0_1 * var_0_2 do
		...
		var_1_10010(var_1_10009, arg_1_0._gridTpl.parent)

		setActive = var_1_10010

		var_1_10010(var_1_10009, true)

		SortGameGrid = var_1_10010
		var_1_10010 = var_1_10010.New(var_1_10009, arg_1_0._event, var_1_5)
		arg_1_0._grids[iter_1_0] = var_1_10010

		local var_1_6 = arg_1_0._grids[iter_1_0]

		var_11.SetRemoveEventCallback(var_1_6, function(arg_3_0, arg_3_1)
		...
		var_11.SetMoveBottomCallback(var_1_7, function(arg_4_0)
		...
		var_11.SetScoreCallback(var_1_8, function(arg_5_0, arg_5_1)
			...
			local var_5_3 = var_2_10005.ADD_SCORE
			local var_5_4 = {}
			local var_5_5 = arg_1_0

			var_5_4.num = var_7.GetScore(var_5_5, arg_5_1)
			var_5_4.combo = arg_1_0._comboIndex

			local var_5_6 = arg_1_0._grids[arg_5_0]

			var_5_4.position = var_7.GetPosition(var_5_6)
			...
			if arg_1_0._wantedItem and arg_1_0._wantedItem == arg_5_1 then
				...
				var_5_7 = var_5_7(var_5_1, var_5.GetPlayerIdByItem(var_5_8, arg_5_1))
				...
				local var_5_11 = var_6.PLAYER_SPEAK

				var_5_6 = arg_1_0._runtimeData

				local var_5_12 = var_7.GetSpeakData

				SortGameConst = var_10

				var_5_10(var_5_9, var_5_11, var_5_12(var_5_6, var_10.sort_conifg_type_chat, var_5_7))
			end
			...
			if var_5_13(var_5_1.combo_speak_num, arg_1_0._comboIndex) then
				local var_5_14 = arg_1_0._event
				local var_5_15 = var_2.emit

				SortGameView = var_5

				local var_5_16 = var_5.PLAYER_SPEAK
				local var_5_17 = arg_1_0._runtimeData
				local var_5_18 = var_6.GetSpeakData

				SortGameConst = var_5_6

				var_5_15(var_5_14, var_5_16, var_5_18(var_5_17, var_5_6.sort_conifg_type_combo))
			end

			return
		end)
		var_1_10010:AddItemEventCallback(function(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_1_9 = var_4.Find("UICamera")
	local var_1_10 = var_4.GetComponent

	typeof = iter_1_0
	Camera = var_1_10009
	arg_1_0._uiCamera = var_1_10(var_1_9, iter_1_0(var_1_10009))
...
function var_0_0.checkGameOver(arg_10_0)
	if #arg_10_0._itemIds == 0 and #arg_10_0._itemIdsPool == 0 then
		...
		SortGameView = var_1_10004

		var_10_1(var_10_0, var_1_10004.GAME_OVER_TIME)
	end
...
function var_0_0.onGridDrag(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	if not arg_12_0._dragGridIndex then
		...
		arg_12_0._dragGridStartPos = var_12_1(var_12_0, var_8.ScreenToWorldPoint(var_12_2, arg_12_0._startDragPos))
		setActive = var_5
...
function var_0_0.onGridDragEnd(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	if arg_15_0._dragGridIndex and arg_15_0._grids[arg_15_0._dragGridIndex] then
		...
		if var_15_8 == var_7.grid_type_out then
...
function var_0_0.checkGridInput(arg_18_0, arg_18_1)
	if arg_18_1:GetInputLayerCount() < arg_18_0._itemLayerMax then
		local var_18_0 = arg_18_1:GetInputEmptyLayer()

		SortGameConst = var_3

		if var_18_0 <= var_3.grid_max_layer then
	...
	if arg_21_1:GetType() > 0 then
		...
		for iter_21_0 = 1, #var_21_2 do
			...
			if var_21_2[iter_21_0] ~= 0 and #arg_21_0._itemIdsPool > 0 then
				...
				local var_21_5 = arg_21_0:GetIdFromPool(var_21_3, var_21_4)

				var_21_0 = var_21_0 + 1
				table = var_1_10013

				var_1_10013.insert(var_21_1, var_21_5)
			else
				table = var_21_4
		...
		local var_21_6 = "插入id列表 = "

		table = iter_21_0

		var_7(var_21_6 .. iter_21_0.concat(var_21_1, ","))
...
function var_0_0.GetIdFromPool(arg_22_0, arg_22_1, arg_22_2)
	...
	if arg_22_0._itemIdsPool then
		var_22_0 = #arg_22_0._itemIdsPool

		if 0 < var_22_0 then
			local var_22_1

			if arg_22_1 then
				var_22_0 = arg_22_0:GetPassItemCount(arg_22_1)
				SortGameConst = var_22_1

				if var_22_0 <= var_22_1.pass_limit_num then
					var_22_1 = nil
					...
					for iter_22_0, iter_22_1 in var_6(arg_22_1) do
						if var_22_2 < iter_22_1 and arg_22_0:checkIdExist(arg_22_0._itemIdsPool, iter_22_0) and iter_22_0 ~= arg_22_2 then
							var_22_2 = iter_22_1
							var_22_1 = iter_22_0
						end
					end
					...
					if var_22_1 then
						for iter_22_2 = 1, #arg_22_0._itemIdsPool do
							if arg_22_0._itemIdsPool[iter_22_2] == var_22_1 then
								table = var_10

								local var_22_3 = var_10.remove(arg_22_0._itemIdsPool, iter_22_2)

								table = var_1_10011

								var_1_10011.insert(arg_22_0._itemIds, var_22_3)

								arg_22_1[var_22_1] = arg_22_1[var_22_1] + 1
								print = var_1_10011

								var_1_10011("匹配成功，匹配id = " .. var_22_1)
					...
					var_22_1("本次从池子中取不到元素， 长度 = " .. #arg_22_0._itemIdsPool)
				end
			end

			table = var_22_0
			var_22_0 = var_22_0.remove(arg_22_0._itemIdsPool, 1)
			table = var_22_1

			var_22_1.insert(arg_22_0._itemIds, var_22_0)
...
function var_0_0.GetScreentScaleRate(arg_24_0)
	...
	local var_24_2 = var_1_10003(var_1_10005.Find("UICamera/Canvas")).sizeDelta.x
...
function var_0_0.GetGridIdMap(arg_25_0, arg_25_1, arg_25_2)
	...
	SortGameConst = var_1_10005

	if var_25_1 == var_1_10005.grid_type_empty then
		var_25_0 = {
			0,
			0,
			0
		...
		if var_25_1 == var_5.grid_type_normal then
			math = var_25_2
			var_25_2 = var_25_2.random()
			...
			SortGameConst = var_25_2

			if var_25_1 == var_25_2.grid_type_two then
				var_25_0 = {
					1,
					1,
					0
				...
				if var_25_1 == var_5.grid_type_out then
					var_25_0 = {
						0,
						1,
						0
...
function var_0_0.Prepare(arg_29_0)
	...
	for iter_29_0 = 1, #var_29_3 do
		var_1_10015 = arg_29_0._runtimeData

		local var_29_14 = var_13.GetPlayerItems(var_1_10015, var_29_3[iter_29_0])
	...
	for iter_29_2 = 1, #var_29_12 do
		...
		var_14.insert(arg_29_0._itemIdsPool, var_29_12[iter_29_2])
	end

	for iter_29_3 = 1, #var_29_15 do
		table = var_14

		var_14.insert(arg_29_0._itemIdsPool, var_29_15[iter_29_3])
	end
	...
	for iter_29_4 = var_29_17, var_12.init_pass_num do
		...
		for iter_29_5 = #arg_29_0._itemIdsPool, 1, -1 do
			if arg_29_0._itemIdsPool[iter_29_5] == var_1_10015 then
				...
				var_29_18(var_29_19, var_1_10024.remove(arg_29_0._itemIdsPool, iter_29_5))
...
function var_0_0.Step(arg_30_0, arg_30_1, arg_30_2)
	...
	if var_30_1 >= var_1_10004.wait_speak_time then
		...
		var_1_10006 = var_1_10006.PLAYER_SPEAK

		local var_30_4 = arg_30_0._runtimeData

		var_1_10007 = var_1_10007.GetSpeakData
		SortGameConst = var_1_10010

		var_30_3(var_30_2, var_1_10006, var_1_10007(var_30_4, var_1_10010.sort_conifg_type_wait))
	end
	...
	if not arg_30_0._wantedStepTime then
		...
		if arg_30_0._wantedRefreshTime >= 0 then
			...
			if arg_30_0._wantedRefreshTime <= 0 then
				...
				local var_30_5 = var_3.random()

				SortGameConst = var_4

				if var_30_5 < var_4.wanted_rate then
					local var_30_6 = arg_30_0._runtimeData

					arg_30_0._wantedItem = var_3.GetRandomWantedItem(var_30_6, arg_30_0:GetAllBottomIds())

					if arg_30_0._wantedItem then
						local var_30_7 = arg_30_0._runtimeData
						local var_30_8 = var_3.GetPlayerIdByItem(var_30_7, arg_30_0._wantedItem)

						var_1_10006 = arg_30_0._event

						local var_30_9 = var_4.emit

						SortGameView = var_1_10007

						local var_30_10 = var_1_10007.WANTED_ITEM_REFRESH
						local var_30_11 = {
							item_id = arg_30_0._wantedItem
						}

						SortGameConst = var_9
						var_30_11.player_prefab = var_9.player_data[var_30_8].prefab

						var_30_9(var_1_10006, var_30_10, var_30_11)

						SortGameConst = var_30_9
						arg_30_0._wantedStepTime = var_30_9.wanted_step_time
					end
				end
	...
	elseif arg_30_0._wantedStepTime >= 0 then
		...
		if arg_30_0._wantedStepTime <= 0 then
			...
			local var_30_12 = arg_30_0._event
			local var_30_13 = var_3.emit

			SortGameView = var_1_10006

			var_30_13(var_30_12, var_1_10006.WANTED_ITEM_REFRESH, {})
		end
	end
	...
	if arg_30_0._checkLockTime >= 1.3 then
		...
		for iter_30_0 = 1, #arg_30_0._grids do
			local var_30_15 = arg_30_0._grids[iter_30_0]

			var_30_14 = var_30_14 + var_8.GetInputEmptyCount(var_30_15)
		end

		local var_30_16 = arg_30_0:GetIdsDic(arg_30_0:GetAllBottomIds())
		local var_30_17 = arg_30_0:GetPassItemCount(var_30_16)

		if var_30_14 == 0 or var_30_14 == 1 and var_30_17 == 0 or var_30_14 == 2 and var_30_17 == 0 then
			local var_30_18 = arg_30_0._contentAniamtor

			var_6.SetTrigger(var_30_18, "reset")
		end
...
function var_0_0.ResetGrid(arg_31_0)
	...
	for iter_31_2 = 1, #arg_31_0._grids do
		...
		local var_31_2 = arg_31_0._grids[iter_31_2]

		var_5.SetShowAniamtion(var_31_2)
	end

	arg_31_0._wantedItem = nil
	arg_31_0._wantedStepTime = nil

	local var_31_3 = arg_31_0._event
	local var_31_4 = var_1.emit

	SortGameView = iter_31_2

	var_31_4(var_31_3, iter_31_2.WANTED_ITEM_REFRESH, {})
...
function var_0_0.GetAllBottomIds(arg_33_0)
	...
	for iter_33_0 = 1, #arg_33_0._grids do
		...
		for iter_33_1, iter_33_2 in var_1_10008(var_33_2) do
