...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_1 = var_5(arg_1_0.menuUI, "lastTimes/img")

	typeof = var_6
	Image = var_8

	local var_1_2 = var_3(var_1_1, var_6(var_8))
	...
	var_3(var_1_9, var_1_10, var_1_11, var_8)
	...
	var_3(var_1_12, var_1_13, var_1_14, var_8)
	...
	var_3(var_1_21, var_1_22, var_1_23, var_8)
	...
	var_3(var_1_24, var_1_25, var_1_26, var_8)
	...
	for iter_1_0 = 1, 7 do
		...
		var_1_10010 = var_1_10010(var_1_10012(var_1_27))
		...
		var_11(var_1_30, var_14(arg_1_0.menuUI, "battList/Viewport/Content"))
		...
		var_14(var_1_10012, var_1_32)

		onButton = var_14

		local var_1_33 = arg_1_0._event
		local var_1_34 = var_1_10012
		...
		var_14(var_1_33, var_1_34, var_1_35, var_1_10019)
		...
		local var_1_36 = var_0_1.GetGameUseTimes()
		local var_1_37 = var_0_1.GetGameTimes()
	end
...
function var_0_0.update(arg_13_0, arg_13_1)
	...
	var_13_0(var_6(arg_13_0.btnStart, "tip"), var_13_2 > 0)
	...
	for iter_13_0 = 1, 7 do
		...
		var_8(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_open"), false)

		setActive = var_8
		findTF = var_1_10010

		var_8(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_closed"), false)

		setActive = var_8
		findTF = var_1_10010

		var_8(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_clear"), false)

		setActive = var_8
		findTF = var_1_10010

		var_8(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_current"), false)
		...
		if iter_13_0 <= var_13_1 then
			...
			var_8(var_1_10010, var_11(arg_13_0.battleItems[iter_13_0], "state_clear/icon"))

			setActive = var_8

			var_8(arg_13_0.dropItems[iter_13_0], true)

			setActive = var_8
			findTF = var_1_10010

			var_8(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_clear"), true)
		elseif iter_13_0 == var_13_1 + 1 and 1 <= var_13_2 then
			setActive = var_8
			findTF = var_1_10010

			var_8(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_current"), true)

			SetParent = var_8
			var_1_10010 = arg_13_0.dropItems[iter_13_0]
			findTF = var_11

			var_8(var_1_10010, var_11(arg_13_0.battleItems[iter_13_0], "state_current/icon"))
		...
		elseif var_13_1 < iter_13_0 and iter_13_0 <= var_13_1 + var_13_2 then
			...
			var_8(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_open"), true)

			SetParent = var_8
			var_1_10010 = arg_13_0.dropItems[iter_13_0]
			findTF = var_11

			var_8(var_1_10010, var_11(arg_13_0.battleItems[iter_13_0], "state_open/icon"))
			...
			var_8(var_1_10010(arg_13_0.battleItems[iter_13_0], "state_closed"), true)

			SetParent = var_8
			var_1_10010 = arg_13_0.dropItems[iter_13_0]
			findTF = var_11

			var_8(var_1_10010, var_11(arg_13_0.battleItems[iter_13_0], "state_closed/icon"))
