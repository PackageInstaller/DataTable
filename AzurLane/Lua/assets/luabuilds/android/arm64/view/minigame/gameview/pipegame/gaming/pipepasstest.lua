...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_0 = var_1_10006(arg_1_0._tf, "left/ok")

	typeof = var_1_10007
	EventTriggerListener = var_9
	arg_1_0._leftTrigger = var_4(var_1_0, var_1_10007(var_9))
	...
	var_4.AddPointClickFunc(var_1_1, function()
		...
		local var_2_1 = var_2_10005(arg_1_0._tf, "left/inputId")

		typeof = var_2_10006
		Text = var_8
		var_2_0._leftId = var_2_10001(var_2_10003(var_2_1, var_2_10006(var_8)).text)
		...
		typeof = var_6
		Text = var_8
		var_2_2._leftIndex = var_1(var_3(var_2_3, var_6(var_8)).text)
		...
		var_2_5(var_3(arg_1_0._tf, "left/icon"), var_0_1.GetSprite(var_2_4.img), false)
	...
	typeof = var_7
	EventTriggerListener = var_9
	arg_1_0._rightTrigger = var_4(var_1_2, var_7(var_9))
	...
	var_4.AddPointClickFunc(var_1_3, function()
		...
		local var_3_1 = var_2_10005(arg_1_0._tf, "right/inputId")

		typeof = var_2_10006
		Text = var_8
		var_3_0._rightId = var_2_10001(var_2_10003(var_3_1, var_2_10006(var_8)).text)
		...
		typeof = var_6
		Text = var_8
		var_3_2._rightIndex = var_1(var_3(var_3_3, var_6(var_8)).text)
		...
		local var_3_6 = var_3(arg_1_0._tf, "right/icon")
		local var_3_7 = var_0_1.GetSprite

		PipeGameConst = var_6

		var_3_5(var_3_6, var_3_7(var_6.map_item_data[arg_1_0._rightId].img), false)
	...
	typeof = var_7
	EventTriggerListener = var_9
	arg_1_0._passTrigger = var_4(var_1_4, var_7(var_9))
...
function var_0_0.setPassDesc(arg_5_0, arg_5_1)
	if arg_5_1 then
		...
		var_1_10002(var_1_10004(arg_5_0._tf, "passDesc"), "检测通过")
	else
		setText = var_1_10002
		findTF = var_1_10004

		var_1_10002(var_1_10004(arg_5_0._tf, "passDesc"), "检测失败")
	end
