...
function var_0_0.AddListener(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10004.EVENT_ENEMY_DESTROY, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005(arg_2_0.roadTFs[arg_3_1.roadID], arg_3_1.index), arg_3_1.id)
...
function var_0_0.Init(arg_4_0)
	...
	findTF = var_1_10002
	var_4_0[1] = var_1_10002(arg_4_0._tf, "road_1")
	findTF = var_2
	var_4_0[2] = var_2(arg_4_0._tf, "road_2")
	findTF = var_2
	var_4_0[3] = var_2(arg_4_0._tf, "road_3")
	arg_4_0.roadTFs = var_4_0
	findTF = var_4_0
	arg_4_0.tpls = var_4_0(arg_4_0._tf, "tpls")
	arg_4_0.enemyList = {}
...
function var_0_0.InitCreatList(arg_5_0)
	...
	local function var_5_1(arg_7_0, arg_7_1, arg_7_2)
		...
		local var_7_1 = var_2_10004(var_2_10006.CREATE_CONFIG[arg_7_2].enemy)

		assert = var_2_10005

		var_2_10005(var_7_0 <= #var_7_1, "create cfg illegal. ID: " .. arg_7_2)
	...
	arg_5_0.roadDir = var_5_2[var_5_3(#var_1_10006.ROAD_DIRECTION)]
	ipairs = var_3
...
function var_0_0.CreateEnemy(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in var_1_10002(arg_8_1) do
		...
		var_8_2(var_8_1, var_1_10012(arg_8_0.roadTFs[iter_8_1.roadID]), false)
...
function var_0_0.GetEnemy(arg_11_0, arg_11_1)
	if arg_11_0.pools[arg_11_1] and #arg_11_0.pools[arg_11_1] > 0 then
		...
		return var_2.remove(arg_11_0.pools[arg_11_1])
	end
	...
	return (var_2(var_1_10004(var_1_10006(arg_11_0.tpls, arg_11_1))))
end
...
function var_0_0.ReturnEnemy(arg_12_0, arg_12_1, arg_12_2)
	...
	var_12_1(var_12_0, var_1_10006(arg_12_0.poolTF), false)
	...
	var_12_2(var_12_3, var_6(arg_12_1))
