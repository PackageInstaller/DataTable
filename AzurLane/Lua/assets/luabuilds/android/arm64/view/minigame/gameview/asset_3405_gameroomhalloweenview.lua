...
function var_0_1.initUI(arg_117_0)
	...
	local var_117_13 = arg_117_0

	findTF = var_4

	local var_117_14 = var_4(arg_117_0.menuUI, "ad/btnStart")

	local function var_117_15()
		setActive = var_2_10000
	...
	var_1(var_117_13, var_117_14, var_117_15, var_6)

	onButton = var_1

	local var_117_16 = arg_117_0

	findTF = var_117_14

	local var_117_17 = var_117_14(arg_117_0.menuUI, "ad/btnBack")

	local function var_117_18()
	...
	var_1(var_117_16, var_117_17, var_117_18, var_6)
	...
	local var_117_20 = var_117_17(arg_117_0.menuUI, "ad/btnRule")

	local function var_117_21()
		pg = var_2_10000
		...
		var_124_2.type = var_2_10004

		local var_124_3 = arg_117_0

		var_124_2.helps = var_4.getGameRoomData(var_124_3).game_help
	...
	var_1(var_117_19, var_117_20, var_117_21, var_6)
...
function var_0_1.initData(arg_125_0)
	...
	findTF = var_3
	arg_125_0.charactor = var_125_0(var_3(arg_125_0.scene, "charactor"), var_0_26, arg_125_0.scene)
	...
	findTF = var_3
	arg_125_0.flyer = var_125_1(var_3(arg_125_0.scene, "flyCharactor"), var_0_27)
	...
	local var_125_3 = var_3(arg_125_0._tf, "controller")

	findTF = var_4
	arg_125_0.controllerUI = var_125_2(var_125_3, var_4(arg_125_0._tf, "conRight/useLight"))
	...
	findTF = var_3
	arg_125_0.ghostBossController = var_125_4(var_3(arg_125_0._tf, "ghostBoss"))
	...
	findTF = var_3
	arg_125_0.ghostChildController = var_125_5(var_3(arg_125_0.scene, "tplGhost"), arg_125_0.charactor, arg_125_0.scene)
	...
	local var_125_7 = var_3(arg_125_0._tf, "bg/eyes")

	findTF = var_4
	arg_125_0.eyesController = var_125_6(var_125_7, var_4(arg_125_0.scene, "charactor"))
	...
	typeof = var_4
	Animator = var_6
	arg_125_0.countAnimator = var_1(var_125_9, var_4(var_6))
	GetComponent = var_1
	findTF = var_125_9
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_125_0.countDft = var_1(var_125_10, var_4(var_6))
...
function var_0_1.updateUI(arg_149_0)
	for iter_149_0 = 1, #arg_149_0.hearts do
		if iter_149_0 <= arg_149_0.heartNum then
			...
			var_5(var_1_10007(arg_149_0.hearts[iter_149_0], "img"), true)
		else
			setActive = var_5
			findTF = var_1_10007

			var_5(var_1_10007(arg_149_0.hearts[iter_149_0], "img"), false)
		end
	end
...
function var_0_1.loseHeart(arg_151_0, arg_151_1)
	if arg_151_0.heartNum and arg_151_0.heartNum > 0 then
		...
		if arg_151_0.heartNum == 0 then
			...
			var_151_5(var_151_6, var_151_7, var_7.Action(function()
...
function var_0_1.showSettlement(arg_156_0)
	...
	local var_156_0 = var_3(arg_156_0.settlementUI, "ad")

	typeof = var_4
	Animator = var_6

	local var_156_1 = var_1_10001(var_156_0, var_4(var_6))
	...
	local var_156_3 = var_156_0(var_5)
	local var_156_4
	...
	local var_156_5 = var_156_1(arg_156_0.settlementUI, "ad/highText")

	findTF = var_156_3

	local var_156_6 = var_156_3(arg_156_0.settlementUI, "ad/currentText")
...
function var_0_1.AddDebugInput(arg_172_0)
	...
	if var_1_10001 then
		...
		if var_172_0(var_1_10003.A) then
			var_172_1 = arg_172_0
...
function var_0_1.willExit(arg_175_0)
	...
	if var_175_0(var_1_10003(arg_175_0._tf)) then
		LeanTween = var_1
