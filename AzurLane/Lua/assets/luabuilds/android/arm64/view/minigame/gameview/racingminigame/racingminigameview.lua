...
function var_0_1.initPageUI(arg_4_0)
	...
	local var_4_10 = var_4_7.Find(var_4_9, "window/btn_confirm")
	...
	var_4_1(var_4_8, var_4_10, var_4_11, var_4_9)

	local var_4_12 = arg_4_0.rtTitlePage
	local var_4_13 = var_3.Find(var_4_12, "exit")

	onButton = var_4_6

	local var_4_14 = arg_4_0
	local var_4_15 = var_4_13
	local var_4_16 = var_4_13.Find(var_4_15, "window/btn_cancel")
	...
	var_4_6(var_4_14, var_4_16, var_4_17, var_4_15)

	onButton = var_4_6

	local var_4_18 = arg_4_0
	local var_4_19 = var_4_13
	local var_4_20 = var_4_13.Find(var_4_19, "window/btn_confirm")
	...
	SFX_CONFIRM = var_4_19

	var_4_6(var_4_18, var_4_20, var_4_21, var_4_19)

	local var_4_22 = arg_4_0.rtTitlePage
	local var_4_23 = var_4.Find(var_4_22, "result")

	onButton = var_4_12

	local var_4_24 = arg_4_0
	local var_4_25 = var_4_23
	local var_4_26 = var_4_23.Find(var_4_25, "window/btn_finish")
	...
	SFX_CONFIRM = var_4_25

	var_4_12(var_4_24, var_4_26, var_4_27, var_4_25)
...
function var_0_1.didEnter(arg_10_0)
	...
	local var_10_3 = var_4(var_1_10006)

	var_10_2(var_10_1, var_4.GetRank(var_10_3, arg_10_0:GetMGData().id))
...
function var_0_1.initOpenUISwich(arg_11_0)
	...
	function arg_11_0.openSwitchDic.result()
		...
		local var_12_4 = var_12_1(var_2_10004)
		...
		var_12_4(var_12_7.Find(var_12_8, "window/now/new"), var_12_5 < var_12_3)
		...
		if var_12_5 <= var_12_3 then
			...
			local var_12_9 = var_12_4(var_6)

			var_12_4 = var_12_4.UpdataHighScore
			var_12_10 = var_12_2
			math = var_12_8

			var_12_4(var_12_9, var_12_10, var_12_8.floor(var_12_3 * 100))
		end

		setText = var_12_4

		local var_12_11 = var_12_7:Find("window/high/Text")

		string = var_12_10

		var_12_4(var_12_11, var_12_10.format("%.2fm", var_12_5))
		...
		var_12_4(var_12_13, var_7.format("%.2fm", var_12_3))
		...
		BaseMiniGameMediator = var_12_12

		var_12_17(var_12_16, var_12_12.GAME_FINISH_TRACKING, {
			game_id = var_12_2,
			hub_id = var_12_15.id,
	...
	function arg_11_0.openSwitchDic.countdown()
		...
		SFX_STEP_PILE_COUNTDOWN = var_2_10003
