...
function var_0_0.start(arg_2_0)
	...
	for iter_2_0 = 1, #var_0_1.equips do
		if var_0_1.equips[iter_2_0] and var_0_1.equips[iter_2_0] > 0 then
			...
			var_1_10010 = arg_2_0._char

			var_8.setEquipData(var_1_10010, var_2_3)
	...
	for iter_2_1 = 1, #var_2_5[1] do
		...
		Clone = var_1_10012
		var_1_10010 = var_1_10010(var_1_10012(var_1_10009))
		table = var_1_10011
...
function var_0_0.checkCharEnemyFire(arg_4_0, arg_4_1, arg_4_2)
	...
	if arg_4_1:getLife() and arg_4_2:getLife() and not arg_4_1:inFireCd(var_4_2) then
		...
		local var_4_17 = var_18.pow(var_5.x - var_4_0.x, 2)

		math = var_19

		local var_4_18 = var_4_16(var_4_17 + var_19.pow(var_5.y - var_4_0.y, 2))
		local var_4_19 = arg_4_0._char

		if var_4_18 < var_17.getWeaponMaxDistance(var_4_19) then
			math = var_18

			local var_4_20 = var_18.atan2
			local var_4_21 = var_5.y - var_4_0.y

			math = var_21

			local var_4_22 = var_4_21 + var_21.random(-20, 20)
			local var_4_23 = var_5.x - var_4_0.x

			math = var_22

			local var_4_24 = var_4_20(var_4_22, var_4_23 + var_22.random(-20, 20))

			math = var_4_19

			local var_4_25 = var_4_24 * var_4_19.rad2Deg

			for iter_4_0 = 1, #var_4_12 do
				local var_4_26 = var_4_12[iter_4_0]

				if var_24.getFireAble(var_4_26) then
					local var_4_27 = var_24
					local var_4_28 = var_24.getAngel(var_4_27)
					local var_4_29 = false

					math = var_4_27

					if var_4_27.abs(var_4_25) < var_4_28 and var_4_2 == 1 then
						var_4_29 = true
					else
						math = var_27

						local var_4_30 = var_27.abs

						math = var_29

						if var_4_28 > var_4_30(180 - var_29.abs(var_4_25)) and var_4_2 == -1 then
							var_4_29 = true
						end
					end

					if var_4_29 then
						local var_4_31 = var_24

						if var_24.fire(var_4_31) then
							arg_4_1:fire(var_4_2)

							pg = var_28

							local var_4_32 = var_28.CriMgr.GetInstance()

							var_28.PlaySoundEffect_V3(var_4_32, var_0_1.SFX_SOUND_FIRE)
							...
							local var_4_34 = var_31.cos(var_4_24)

							math = var_1_10032
							var_4_33.move = var_4_31(var_4_34, var_1_10032.sin(var_4_24))

							local var_4_35 = arg_4_0._char

							var_4_33.hit = var_29.getHitGroup(var_4_35)
							Vector2 = var_29
							var_4_33.effect_pos = var_29(0, 0)
							var_4_33.effect_content = var_4_15

							local var_4_36 = arg_4_0._eventCall

							SailBoatGameEvent = var_31

							var_4_36(var_31.BOAT_EVENT_FIRE, {
								bullet_id = var_27.bullet_id,
								weapon_data = var_27,
								fire_data = var_4_33
							})
...
function var_0_0.getCharNextTouchFlag(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	for iter_5_0 = 1, #var_5_7 do
		...
		SailBoatGameConst = var_1_10016

		if var_5_9 == var_1_10016.item_static then
			local var_5_10 = var_14:getPosition()

			math = var_1_10016

			if var_1_10016.abs(var_5_10.x - var_5_1.x) < 500 then
				math = var_1_10016

				if var_1_10016.abs(var_5_10.y - var_5_1.y) < 500 then
					local var_5_11

					var_1_10016, var_5_11 = var_14:getColliderData()

					if not arg_5_0:checkLeave(arg_5_3, arg_5_4, var_5_1, var_5_10) and var_0_1.CheckRectCollider(var_5_6, var_1_10016, var_5_3, var_5_11) then
						return true
					end
				end
			end
