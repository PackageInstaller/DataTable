	...
	for iter_3_1 = #arg_3_0._bullets, 1, -1 do
				...
				if iter_3_3:getLife() then
					...
					if iter_3_3:getLife() then
						...
						if var_0_1.PointInRect2(var_3_7, var_3_9, var_3_10) then
							...
							if var_1_10022.contains(var_3_6, var_3_8) then
								var_10:hit()

								var_1_10022 = var_10:getDamage()

								if iter_3_3:damage(var_1_10022) then
									local var_3_11 = arg_3_0._event

									SailBoatGameEvent = var_26

									var_3_11(var_26.DESTROY_ENEMY, iter_3_3:getDestroyData())
								end
		...
		if not var_10:getRemoveFlag() and var_3:getLife() then
			...
			if var_13.contains(var_3_6, var_3_3) then
				local var_3_12, var_3_13 = var_3:getMinMaxPosition()

				if var_0_1.PointInRect2(var_3_7, var_3_12, var_3_13) then
					var_10:hit()

					local var_3_14 = var_10:getDamage()

					var_3:damage(var_3_14)
		...
		if var_10:getRemoveFlag() then
			...
			local var_3_15 = var_13.remove(arg_3_0._bullets, iter_3_1)

			var_13.clear(var_3_15)
