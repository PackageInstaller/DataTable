...
function var_0_0.step(arg_3_0, arg_3_1)
	...
	for iter_3_0 = #arg_3_0._enemys, 1, -1 do
		...
		if var_7:getRemoveFlag() then
			...
			if var_7.getHp(var_3_2) <= 0 then
				var_3_3 = arg_3_0._eventCall
				BoatAdGameEvent = var_3_2

				var_3_3(var_3_2.ADD_SCORE, var_7:getConfig("score"))

				local var_3_4 = var_7

				if var_7.getBoss(var_3_4) and not var_0_1.isEndLessRound then
					var_3_3 = arg_3_0._eventCall
					BoatAdGameEvent = var_3_4

					var_3_3(var_3_4.PLAYER_DEAD, true)
				end
			end

			table = var_3_3

			var_3_3.remove(arg_3_0._enemys, iter_3_0)
			arg_3_0:returnEnemy(var_7)
		end

		if not var_7:getRemoveFlag() and var_7:getConfig("boss") and not var_7:getBattle() then
			local var_3_5 = var_0_1.char
			local var_3_6 = var_8.getPosition(var_3_5)
			local var_3_7, var_3_8 = var_7:getRelaPositionX()

			if var_3_8 - var_3_6.y < 600 then
				math = var_11

				if var_11.abs(var_3_7 - var_3_6.x) > 10 then
					local var_3_9 = var_7:getScale()
					local var_3_10 = (var_3_7 > var_3_6.x and -1 or 1) * 700 * arg_3_1 * var_3_9

					var_7:bossFocus(var_3_10)
				end
			end
		end
	end
	...
	if arg_3_0._moveSpeed ~= 0 and arg_3_0._speedDownTime > 0 then
		...
		if arg_3_0._speedDownTime <= 0 then
			...
			for iter_3_1 = 1, #arg_3_0._enemys do
				local var_3_11 = arg_3_0._enemys[iter_3_1]

				var_7.speedDown(var_3_11, false)
			end
		end
	end
...
function var_0_0.getOrCreateEnemy(arg_8_0, arg_8_1, arg_8_2)
	...
	if not var_8_0 then
		...
		local var_8_3 = var_0_1.GetGameTplTf(var_8_2.tpl)
