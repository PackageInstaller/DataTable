...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	var_2.AddPointDownFunc(var_1_2, function(arg_2_0, arg_2_1)
		...
		var_2_5(var_2_4, var_6.getOffset(var_2_6, arg_1_0.dragPos, arg_1_0.startPos))
...
function var_0_0.step(arg_9_0)
	...
	local var_9_4 = var_3.pow(arg_9_0.currentX - arg_9_0.startPos.x, 2)

	math = var_4
	arg_9_0.distanceRate = var_9_3(var_9_4 + var_4.pow(arg_9_0.currentY - arg_9_0.startPos.y, 2)) / arg_9_0.maxDistance
	math = var_1
...
function var_0_0.setDirectTarget(arg_10_0, arg_10_1)
	...
	if arg_10_1.x ~= 0 or arg_10_1.y ~= 0 then
		...
		var_10_1(var_10_0, var_1_10005(arg_10_1.x * 1000, arg_10_1.y * 1000))
	elseif arg_10_0.active then
		...
		var_10_3(var_10_2, var_1_10005(0, 0))
	end
