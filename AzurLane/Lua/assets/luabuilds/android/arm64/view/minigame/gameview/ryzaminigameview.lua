...
local function var_0_2(arg_4_0, arg_4_1)
	...
	local var_4_2 = var_4_1(var_4_0, var_1_10005(var_1_10007), true)
	local var_4_3 = var_2.ToTable(var_4_2)

	ipairs = var_1_10003

	for iter_4_0, iter_4_1 in var_1_10003(var_4_3) do
...
function var_0_1.openUI(arg_5_0, arg_5_1)
	if arg_5_0.status then
		...
		var_2(var_4.Find(var_5_0, arg_5_0.status), false)
	end
	...
	if arg_5_1 then
		...
		var_2(var_4.Find(var_5_1, arg_5_1), true)
	end
	...
	var_2(arg_5_1, {
		...
		result = function()
			...
			var_2_10004(var_9_6:Find("window/now/new"), var_9_4 < var_9_3)
			...
			if var_9_4 <= var_9_3 then
				...
				var_2_10004.StoreDataToServer(var_9_7, {
					var_9_4
				})
			end
			...
			var_2_10004(var_9_6:Find("window/high/Text"), var_9_4)

			setText = var_2_10004

			var_2_10004(var_9_6:Find("window/now/Text"), var_9_3)
...
function var_0_1.updateMainUI(arg_10_0)
	...
	if var_3 == var_10_1 then
		...
		math = var_10_3
		var_10_3 = var_10_3.min(var_1.usedtime + 1, var_10_2)
	end

	local var_10_4 = arg_10_0.itemList.container.childCount

	for iter_10_0 = 1, var_10_4 do
		local var_10_5 = {}

		if iter_10_0 <= var_3 then
			var_10_5.finish = true
		elseif iter_10_0 <= var_10_2 then
			-- block empty
		elseif var_3 == var_10_1 then
			var_10_5.finish = false
			var_10_5.lock = false
		else
			var_10_5.lock = true
		end
		...
		var_1_10015 = var_6
		var_1_10013 = var_6.GetChild(var_1_10015, iter_10_0 - 1)
		setActive = var_1_10014

		var_1_10014(var_1_10013:Find("finish"), var_10_5.finish)

		setActive = var_1_10014

		var_1_10014(var_1_10013:Find("lock"), var_10_5.lock)

		setToggleEnabled = var_1_10014

		var_1_10014(var_1_10013, iter_10_0 <= var_10_3)
	...
	local var_10_6 = var_6:GetChild(0).anchoredPosition.y
	local var_10_7 = var_6
	local var_10_8 = var_10_6 - var_6.GetChild(var_10_7, var_10_3 - 1).anchoredPosition.y
	local var_10_9 = var_6.rect.height
	local var_10_10 = var_6
	local var_10_11 = var_6.GetComponent

	typeof = var_1_10013
	ScrollRect = var_1_10015

	local var_10_12 = var_10_11(var_10_10, var_1_10013(var_1_10015)).viewport.rect.height

	math = var_10_7

	local var_10_13 = var_10_7.clamp(var_10_8, 0, var_10_9 - var_10_12) / (var_10_9 - var_10_12)

	scrollTo = var_12

	var_12(var_6, nil, 1 - var_10_13)

	setActive = var_12

	local var_10_14 = arg_10_0.rtTitlePage

	var_12(var_14.Find(var_10_14, "main/tip/Image"), var_3 == var_10_1)
	arg_10_0:checkGet()

	if var_3 == 1 and var_10_3 == 2 then
		PlayerPrefs = var_12
		...
		if var_12.GetInt("ryza_minigame_guide", 0) == 0 then
			...
			local var_10_15 = var_12.NewGuideMgr.GetInstance()

			var_12.Play(var_10_15, "Ryza_MiniGame")
		...
		if var_12.GetInt("ryza_minigame_help", 0) == 0 then
			...
			local var_10_16 = arg_10_0.rtTitlePage

			var_12(var_14.Find(var_10_16, "main/btn_rule"))
		end
	end
...
function var_0_1.checkGet(arg_11_0)
	if arg_11_0:GetMGHubData().ultimate == 0 then
		...
		var_11_5.cmd = var_7.CMD_ULTIMATE
		var_11_5.args1 = {}
...
function var_0_1.initUI(arg_12_0)
	...
	local var_12_5 = var_12_2.Find(var_12_4, "btn_back")
	...
	var_1_10002(var_12_3, var_12_5, var_12_6, var_12_4)

	onButton = var_1_10002

	local var_12_7 = arg_12_0
	local var_12_8 = var_12_2
	local var_12_9 = var_12_2.Find(var_12_8, "btn_rule")
	...
	local function var_12_10()
		...
		pg = var_2_10004
		var_14_2.helps = var_2_10004.gametip.ryza_mini_game.tip
	...
	var_1_10002(var_12_7, var_12_9, var_12_10, var_12_8)

	local var_12_11 = arg_12_0:GetMGData()
	local var_12_12 = var_2.GetSimpleValue(var_12_11, "story")

	onButton = var_12_1

	local var_12_13 = arg_12_0
	local var_12_14 = var_12_2
	local var_12_15 = var_12_2.Find(var_12_14, "btn_start")
	...
	local function var_12_16()
		...
		if var_2_10001(var_12_12, {
			...
			var_2_10002.insert(var_15_0, function(arg_16_0)
				pg = var_3_10001
	...
	SFX_CONFIRM = var_12_14

	var_12_1(var_12_13, var_12_15, var_12_16, var_12_14)

	arg_12_0.stageIndex = 0
	pg = var_3

	local var_12_17 = var_3.mini_game[arg_12_0:GetMGData().id].simple_config_data.drop_ids
	local var_12_18 = var_12_2:Find("side_panel/award/content")

	UIItemList = var_12_13
	arg_12_0.itemList = var_12_13.New(var_12_18, var_12_18:GetChild(0))

	local var_12_19 = arg_12_0.itemList

	var_5.make(var_12_19, function(arg_18_0, arg_18_1, arg_18_2)
		arg_18_1 = arg_18_1 + 1
		UIItemList = var_2_10003

		if arg_18_0 == var_2_10003.EventUpdate then
			local var_18_0 = arg_18_2
			local var_18_1 = arg_18_2.Find(var_18_0, "IconTpl")
			local var_18_2 = {}

			unpack = var_18_0

			local var_18_3, var_18_4, var_18_5 = var_18_0(var_12_17[arg_18_1])

			var_18_2.count = var_18_5
			var_18_2.id = var_18_4
			var_18_2.type = var_18_3
			updateDrop = var_18_3

			var_18_3(var_18_1, var_18_2)

			onButton = var_18_3

			local var_18_6 = arg_12_0
			local var_18_7 = var_18_1

			local function var_18_8()
				local var_19_0 = arg_12_0

				var_0.emit(var_19_0, var_0_1.ON_DROP, var_18_2)
			...
			var_18_3(var_18_6, var_18_7, var_18_8, var_2_10010)

			onToggle = var_18_3

			var_18_3(arg_12_0, arg_18_2, function(arg_20_0)
				if arg_20_0 then
	...
	local var_12_20 = arg_12_0.itemList

	var_5.align(var_12_20, #var_12_17)

	local var_12_21 = arg_12_0
	local var_12_22 = arg_12_0.GetMGHubData(var_12_21)
	local var_12_23 = var_5.getConfig(var_12_22, "reward_need")

	setActive = var_12_21

	var_12_21(var_12_18:GetChild(var_12_23), true)

	onToggle = var_12_21

	var_12_21(arg_12_0, var_12_18:GetChild(var_12_23), function(arg_21_0)
		if arg_21_0 then
			arg_12_0.stageIndex = 0
		end
	...
	local var_12_24 = arg_12_0.rtTitlePage
	local var_12_25 = var_7.Find(var_12_24, "countdown")
	local var_12_26 = var_7.Find(var_12_25, "bg/Image")
	local var_12_27 = var_8.GetComponent

	typeof = var_11
	DftAniEvent = var_13

	local var_12_28 = var_12_27(var_12_26, var_11(var_13))

	var_8.SetEndEvent(var_12_28, function()
	...
	local var_12_29 = arg_12_0.rtTitlePage
	local var_12_30 = var_8.Find(var_12_29, "pause")

	onButton = var_12_24

	local var_12_31 = arg_12_0
	local var_12_32 = var_12_30
	local var_12_33 = var_12_30.Find(var_12_32, "window/btn_confirm")
	...
	SFX_CONFIRM = var_12_32

	var_12_24(var_12_31, var_12_33, var_12_34, var_12_32)

	local var_12_35 = arg_12_0.rtTitlePage
	local var_12_36 = var_9.Find(var_12_35, "exit")

	onButton = var_12_29

	local var_12_37 = arg_12_0
	local var_12_38 = var_12_36
	local var_12_39 = var_12_36.Find(var_12_38, "window/btn_cancel")
	...
	SFX_CANCEL = var_12_38

	var_12_29(var_12_37, var_12_39, var_12_40, var_12_38)

	onButton = var_12_29

	local var_12_41 = arg_12_0
	local var_12_42 = var_12_36
	local var_12_43 = var_12_36.Find(var_12_42, "window/btn_confirm")
	...
	SFX_CONFIRM = var_12_42

	var_12_29(var_12_41, var_12_43, var_12_44, var_12_42)

	local var_12_45 = arg_12_0.rtTitlePage
	local var_12_46 = var_10.Find(var_12_45, "result")

	onButton = var_12_35

	local var_12_47 = arg_12_0
	local var_12_48 = var_12_46
	local var_12_49 = var_12_46.Find(var_12_48, "window/btn_finish")
	...
	local function var_12_50()
		...
		var_2_10000(var_2.Find(var_26_0, "Viewport"), false)
	...
	SFX_CONFIRM = var_12_48

	var_12_35(var_12_47, var_12_49, var_12_50, var_12_48)
...
function var_0_1.initGameUI(arg_27_0)
	...
	var_1(var_27_5, var_4.Find(var_27_6, "bottom/btn_bomb"), function()
	...
	local var_27_11 = var_4.Find(var_27_10, "top/btn_back")
	...
	var_1(var_27_9, var_27_11, var_27_12, var_27_10)

	onButton = var_1

	local var_27_13 = arg_27_0
	local var_27_14 = arg_27_0.rtController
	local var_27_15 = var_4.Find(var_27_14, "top/btn_pause")
	...
	var_1(var_27_13, var_27_15, var_27_16, var_27_14)
	...
	arg_27_0:bind(var_0_1.EVENT_WINDOW_FOCUS, function(arg_36_0, arg_36_1)
		...
		math = var_2_10006
		var_36_1.x = var_2_10006.clamp(-arg_36_1.x, -arg_27_0.buffer.x, arg_27_0.buffer.x)
		math = var_6
		var_36_1.y = var_6.clamp(-arg_36_1.y, -arg_27_0.buffer.y - 48, arg_27_0.buffer.y - 48)
	...
	arg_27_0:bind(var_0_1.EVENT_UPDATE_HIDE, function(arg_38_0, arg_38_1, arg_38_2)
		...
		MoveEnemy = var_2_10006

		if var_2_10003(var_38_0, var_2_10006) then
			...
			var_3(var_38_1, var_2_10006(var_2_10008)).alpha = arg_38_2 and 0 or 1
		end
...
function var_0_1.initTimer(arg_39_0)
	...
	arg_39_0.timer = var_39_0(var_39_1, var_1_10004.TIME_INTERVAL, -1)
...
function var_0_1.readyStart(arg_41_0)
	...
	var_1(var_3.Find(var_41_0, "Viewport"), true)
...
function var_0_1.initConfig(arg_47_0)
	if arg_47_0.stageIndex == 0 then
		...
		RyzaMiniGameConfig = var_1_10005

		local var_47_3 = var_47_2(var_1_10005.ENEMY_TYPE_LIST, 1)
		local var_47_4 = {}
		...
		NewPos = var_47_5
		var_47_7.mapSize = var_47_5(var_47_6[1].width, var_47_6[1].height)
		...
		for iter_47_0, iter_47_1 in var_47_8(var_47_6) do
			...
			for iter_47_2, iter_47_3 in var_1_10011(iter_47_1.layer) do
				if iter_47_3.item then
					...
					if arg_47_0.stageIndex == 0 then
						isa = var_17
						RyzaMiniGameConfig = var_1_10019
						var_1_10019 = var_1_10019.CreateInfo(var_47_9.name)
						TargetMove = iter_47_4

						if var_17(var_1_10019, iter_47_4) then
...
function var_0_1.buildMap(arg_48_0)
	...
	var_1_10001(var_3.Find(var_48_0, "bg/NW"), function(arg_49_0)
		...
		var_2_10001(var_49_0, var_49_1 == var_2_10005(var_2_10007.floor((arg_48_0.stageIndex - 1) % 8 / 2) + 1))
	...
	local var_48_4 = var_48_0.max(var_48_3.width + 0 - var_48_2.width, 0)

	math = var_6
	arg_48_0.buffer = var_48_1(var_48_4, var_6.max(var_48_3.height + 160 - var_48_2.height, 0)) * 0.5
	Time = var_3
	...
	local var_48_11 = var_48_8(var_48_9, var_9.GetChild(var_48_10, 0))
	...
	var_48_13(var_48_12, var_10.zero, arg_48_0.config.mapSize)
...
function var_0_1.initController(arg_51_0)
	...
	local var_51_1 = var_4.format
	local var_51_2 = "%02d:%02d"

	math = var_1_10007

	local var_51_3 = var_1_10007.floor(arg_51_0.countTime / 60)

	math = var_1_10008

	var_1_10001(var_51_0, var_51_1(var_51_2, var_51_3, var_1_10008.floor(arg_51_0.countTime % 60)))
...
function var_0_1.updateControllerStatus(arg_52_0, arg_52_1, arg_52_2, arg_52_3)
	...
	MoveRyza = var_1_10008

	if var_1_10005(var_52_1, var_1_10008) then
		if arg_52_2 == "hp" then
			eachChild = var_5
			...
			var_5(arg_52_0.rtRyzaHP, function(arg_53_0)
				...
				local var_53_0 = arg_53_0:Find("active")

				tonumber = var_2_10004

				var_2_10001(var_53_0, var_2_10004(arg_53_0.name) <= arg_52_3.num)
			...
			local var_52_2 = arg_52_0.rtStatus
			local var_52_3 = var_7.Find

			string = var_1_10010

			var_5(var_52_3(var_52_2, var_1_10010.upper(arg_52_2) .. "/bit"), function(arg_54_0)
				setActive = var_2_10001
				...
				var_2_10001(var_54_0, var_2_10004(arg_54_0.name) <= arg_52_3.num)
		...
		local var_52_4 = arg_52_1

		MoveEnemy = var_1_10008

		if var_5(var_52_4, var_1_10008) then
			setSlider = var_5
...
function var_0_1.popRyzaUI(arg_55_0, arg_55_1, arg_55_2, arg_55_3)
	...
	if var_1_10004(var_55_0, var_1_10007) then
		local var_55_1 = arg_55_0.reactorUIs[arg_55_1]

		if arg_55_2 == "hp" then
			local var_55_2 = var_55_1
			local var_55_3 = var_55_1.Find
			local var_55_4 = "pop/hp_"
			local var_55_5 = arg_55_3.delta
			local var_55_6 = var_55_3(var_55_2, var_55_4 .. (0 < var_55_5 and "up" or "down"))

			for iter_55_0 = 1, 2 do
				setActive = var_10

				var_10(var_55_6:Find(iter_55_0), iter_55_0 * iter_55_0 == arg_55_3.delta * arg_55_3.delta)
			end

			setActive = var_55_0

			var_55_0(var_55_6, false)

			setActive = var_55_0

			var_55_0(var_55_6, true)
		else
			local var_55_7 = var_55_1:Find("pop/" .. arg_55_2 .. "_up")

			setActive = var_55_0

			var_55_0(var_55_7, false)

			setActive = var_55_0

			var_55_0(var_55_7, true)
		end
	end
...
function var_0_1.CreateReactor(arg_56_0, arg_56_1)
	...
	local var_56_6 = var_10.Find(var_56_5, var_56_1)
	local var_56_7 = arg_56_0.rtMain
	local var_56_8 = var_56_3(var_56_4, var_1_10008(var_56_6, var_11.Find(var_56_7, var_56_2)), arg_56_0.responder)
	...
	if var_1_10006(var_56_9, var_9) then
		var_56_10 = arg_56_0.reactorUIs
		cloneTplTo = var_56_4
		var_56_10[var_56_8] = var_56_4(arg_56_0.tplUIRyza, arg_56_0.rtControllerUI)
		eachChild = var_56_10

		local var_56_11 = arg_56_0.reactorUIs[var_56_8]

		var_56_10(var_8.Find(var_56_11, "pop"), function(arg_57_0)
			...
			local var_57_2 = var_57_1(var_57_0, var_2_10004(var_2_10006))
		...
		if var_56_10(var_56_12, var_9) then
			local var_56_13 = arg_56_0.reactorUIs

			cloneTplTo = var_56_4
			var_56_13[var_56_8] = var_56_4(arg_56_0.tplUIEnemy, arg_56_0.rtControllerUI)
			setAnchoredPosition = var_56_13

			local var_56_14 = arg_56_0.reactorUIs[var_56_8]

			var_56_13(var_8.Find(var_56_14, "hp"), {
...
function var_0_1.soilMapPartition(arg_60_0, arg_60_1, arg_60_2)
	...
	local var_60_2 = var_1_10006.min(arg_60_2.x, arg_60_2.y)
	local var_60_3 = var_60_0.size_rate[1]

	math = var_8

	if var_60_1(var_60_2 * (var_60_3 + var_8.random() * (var_60_0.size_rate[2] - var_60_0.size_rate[1]))) < 2 then
		return
	end
	...
	var_60_6(var_60_5, var_9(var_60_9, var_60_10 + var_60_11), var_4)
	...
	if arg_60_2.x > arg_60_2.y then
		...
		NewPos = var_60_9
		var_60_9 = var_60_9(arg_60_1.x + (var_60_4 % 2 > 0 and 0 or var_60_12), arg_60_1.y)
		NewPos = var_12

		var_60_15(var_60_14, var_60_9, var_12(arg_60_2.x - var_60_12, arg_60_2.y))

		local var_60_16 = arg_60_0
		local var_60_17 = arg_60_0.soilMapPartition

		NewPos = var_60_9

		local var_60_18 = arg_60_1.x
		local var_60_19
		...
		var_60_9 = var_60_9(var_60_18 + var_60_19, arg_60_1.y + (var_60_4 > 1 and 0 or var_60_13))
		NewPos = var_12

		var_60_17(var_60_16, var_60_9, var_12(var_4, arg_60_2.y - var_60_13))
	else
		local var_60_20 = arg_60_0
		local var_60_21 = arg_60_0.soilMapPartition

		NewPos = var_60_9

		local var_60_22 = arg_60_1.x + (var_60_4 % 2 > 0 and 0 or var_60_12)
		...
		local var_60_25 = var_60_9(var_60_22, var_60_23 + var_60_24)

		NewPos = var_12

		var_60_21(var_60_20, var_60_25, var_12(arg_60_2.x - var_60_12, var_4))

		local var_60_26 = arg_60_0
		local var_60_27 = arg_60_0.soilMapPartition

		NewPos = var_60_25

		local var_60_28 = var_60_25(arg_60_1.x, arg_60_1.y + (var_60_4 > 1 and 0 or var_60_13))

		NewPos = var_12

		var_60_27(var_60_26, var_60_28, var_12(arg_60_2.x, arg_60_2.y - var_60_13))
	end
...
function var_0_1.dealSoilMap(arg_61_0, arg_61_1, arg_61_2)
	...
	for iter_61_0 = 0, 3 do
		...
		var_1_10008(var_61_1, arg_61_1 + var_1_10011(var_61_2, var_61_3))
	end
	...
	local function var_61_6(arg_63_0)
		...
		for iter_63_0, iter_63_1 in var_2_10003(var_0_4) do
			NewPos = var_2_10008
			unpack = var_2_10010
			var_2_10008 = arg_63_0 + var_2_10008(var_2_10010(iter_63_1))

			if var_61_4(var_2_10008) then
				defaultValue = var_9

				if var_9(var_61_5[var_2_10008.x .. "_" .. var_2_10008.y], true) then
	...
	local function var_61_7(arg_64_0)
		...
		for iter_64_0, iter_64_1 in var_2_10001(var_0_4) do
			NewPos = var_2_10006
			unpack = var_2_10008
			var_2_10006 = arg_64_0 + var_2_10006(var_2_10008(iter_64_1))

			if var_61_4(var_2_10006) then
				defaultValue = var_7

				if var_7(var_61_5[var_2_10006.x .. "_" .. var_2_10006.y], true) then
					RyzaMiniGameConfig = var_7

					if not var_7.SOIL_SPRITES_DIC[var_61_6(var_2_10006)] then
						return false
					end
				end
			end
	...
	local var_61_9 = var_1_10009.SOIL_RANDOM_CONFIG.cancel_rate
	local var_61_10
	local var_61_11 = 0

	while var_61_11 < #var_61_0 do
		var_61_5[var_61_0[var_61_11 + 1].x .. "_" .. var_10.y] = false
		math = var_12

		if var_12.random() < var_61_9[1] + var_61_9[2] * (1 - var_61_8 / arg_61_2 / arg_61_2) * (1 - var_61_8 / arg_61_2 / arg_61_2) and var_61_7(var_10) then
			var_61_8 = var_61_8 + 1
		else
			var_61_5[var_10.x .. "_" .. var_10.y] = true
		end
		...
		for iter_61_1, iter_61_2 in var_12(var_0_3) do
			NewPos = var_1_10017
			unpack = var_1_10019
			var_1_10017 = var_10 + var_1_10017(var_1_10019(iter_61_2))

			if var_61_4(var_1_10017) and var_61_5[var_1_10017.x .. "_" .. var_1_10017.y] == nil then
				table = var_18

				var_18.insert(var_61_0, var_1_10017)
			end
		end
	end

	local var_61_12 = arg_61_0.config.mapSize.x
	local var_61_13 = arg_61_0.config.mapSize.y
	...
	for iter_61_3 = arg_61_1.x, arg_61_1.x + arg_61_2 - 1 do
		for iter_61_4 = arg_61_1.y, arg_61_1.y + arg_61_2 - 1 do
			...
			if var_1_10022(var_61_5[iter_61_3 .. "_" .. iter_61_4], true) then
				RyzaMiniGameConfig = var_1_10022
				var_1_10022 = var_1_10022.SOIL_SPRITES_DIC

				local var_61_14 = var_61_6

				NewPos = var_25
				var_1_10022 = var_1_10022[var_61_14(var_25(iter_61_3, iter_61_4))]
				assert = var_23

				var_23(var_1_10022)

				local var_61_15 = arg_61_0.rtPlane
				local var_61_16 = var_23.GetChild(var_61_15, iter_61_4 * var_61_12 + iter_61_3)

				setImageAlpha = var_24

				var_24(var_61_16, 1)

				setImageSprite = var_24

				var_24(var_61_16, arg_61_0.sprites[var_1_10022])
			end
		end
	end
...
function var_0_1.onTimer(arg_67_0)
	...
	local var_67_2 = var_1_10004.format
	local var_67_3 = "%02d:%02d"

	math = var_1_10007

	local var_67_4 = var_1_10007.floor(arg_67_0.countTime / 60)

	math = var_1_10008

	var_1(var_67_1, var_67_2(var_67_3, var_67_4, var_1_10008.floor(arg_67_0.countTime % 60)))
	...
	var_67_6(var_67_5, var_4.TIME_INTERVAL)
	...
	if var_1.GetJoyStick(var_67_7).x ~= 0 or var_1.y ~= 0 then
		...
		if var_67_8.x == 0 then
			...
			var_67_4 = var_67_8.y
			var_67_4 = 0 < var_67_4 and 270 or 90
			var_67_12.z = var_67_4

			var_3(var_67_11, var_67_12)
		else
			setLocalEulerAngles = var_3

			local var_67_13 = var_67_10
			local var_67_14 = {}

			math = var_67_4

			local var_67_15 = var_67_4.atan2(-var_67_8.y, var_67_8.x)

			math = var_8
			var_67_14.z = var_67_15 / var_8.pi * 180

			var_3(var_67_13, var_67_14)
		end
	end
