...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_3 = var_4(arg_3_0._go, "back")
	...
	var_1(var_3_2, var_3_3, var_3_4, var_6)
	arg_3_0:CheckAaward()
...
function var_0_1.CheckAaward(arg_7_0)
	...
	local var_7_2 = var_1:getConfig("reward_need")

	if var_7_0 == 0 and var_7_2 <= var_7_1 then
		pg = var_1_10005

		local var_7_3 = var_1_10005.m02
		local var_7_4 = var_5.sendNotification

		GAME = var_1_10008

		local var_7_5 = var_1_10008.SEND_MINI_GAME_OP
		local var_7_6 = {
			hubid = var_1.id
		}

		MiniGameOPCommand = var_10
		var_7_6.cmd = var_10.CMD_ULTIMATE
		var_7_6.args1 = {}
