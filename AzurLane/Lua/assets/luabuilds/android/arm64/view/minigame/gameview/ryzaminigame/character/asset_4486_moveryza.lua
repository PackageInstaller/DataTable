...
function var_0_1.InitUI(arg_1_0, arg_1_1)
	...
	var_1_5(var_1_4, var_1_10005(arg_1_1.spirit, true))
	...
	local var_1_9 = var_1_8(var_1_7, var_5(var_7)).material
	...
	local var_1_13 = var_1_12(var_1_11, var_5(var_7))
		...
		var_2_10000(arg_1_0.status, {
			Burn_S = function()
				if arg_1_0.spriteVanish then
					...
					var_3_0(var_2.Find(var_3_1, "front/EF_Vanish"), true)
				end
	...
	var_3(var_5.Find(var_1_14, "front"), function(arg_5_0)
	...
	local var_1_18 = var_1_17(var_1_16, var_6(var_8))
	...
	var_3.SetTriggerEvent(var_1_18, function()
		...
		var_1(arg_1_0.summonCount, {
			function()
				...
				var_3_10000(var_8_0, var_3_10003(var_3_10005)).alpha = 0
			...
			function()
				...
				typeof = var_3_10003
				CanvasGroup = var_3_10005
				var_3_10000(var_9_0, var_3_10003(var_3_10005)).alpha = 1
				...
				local var_9_3 = var_9_2(var_9_1, var_3(var_3_10005)).material
			...
			function()
				...
				local var_10_2 = var_10_1(var_10_0, var_3_10003(var_3_10005)).material
...
function var_0_1.InitRegister(arg_11_0, arg_11_1)
	...
	arg_11_0:Register("hit", function(arg_14_0, arg_14_1)
		local var_14_0 = arg_11_0.invincibilityTime
		...
		var_2.Hurt(var_14_1, arg_14_0)

		pg = var_2

		local var_14_2 = var_2.CriMgr.GetInstance()

		var_2.PlaySoundEffect_V3(var_14_2, "ui-ryza-minigame-damage")

		local var_14_3 = arg_14_1 - arg_11_0.realPos

		math = var_3

		local var_14_4 = var_14_3 * (1 / var_3.sqrt(var_14_3:SqrMagnitude()))

		setAnchoredPosition = var_3

		local var_14_5 = arg_11_0.rtScale
		local var_14_6 = var_5.Find(var_14_5, "front/EF_Hit")

		NewPos = var_2_10006

		var_3(var_14_6, var_2_10006(var_14_4.x, -var_14_4.y) * 16)

		setActive = var_3

		local var_14_7 = arg_11_0.rtScale

		var_3(var_5.Find(var_14_7, "front/EF_Hit"), true)

		if arg_11_0.hp > 0 then
			RyzaMiniGameConfig = var_3

			local var_14_8 = var_3.GetFourDirMark(var_14_4)
			local var_14_9 = arg_11_0

			var_4.PlayAnim(var_14_9, "Damage_" .. (var_14_8 == "" and "S" or var_14_8))

			local var_14_10 = arg_11_0

			var_4.PlayDamage(var_14_10)
		else
			local var_14_11 = arg_11_0

			var_3.DeregisterAll(var_14_11)

			local var_14_12 = arg_11_0

			var_3.PlayAnim(var_14_12, "Gameover_A")
		end
	...
	var_2(arg_16_1, {
		...
		spirit = function()
			if not arg_16_0.spirit then
				...
				var_0(var_2.Find(var_22_1, "front/EF_Summon"), true)
			end
...
function var_0_1.UpdateSpirit(arg_23_0, arg_23_1)
	...
	var_1_10003(var_5.Find(var_23_1, "main"), function(arg_24_0)
		...
		local var_24_2 = var_24_1(var_24_0, var_4(var_2_10006)).material
...
function var_0_1.TimeUpdate(arg_27_0, arg_27_1)
	...
	if not arg_27_0.lock then
		if arg_27_0.invincibilityTime > 0 then
			...
			local var_27_3 = var_27_2(var_27_1, var_5(var_1_10007)).material
			local var_27_4 = var_2.SetInt
			local var_27_5 = "_Overwrite"

			math = var_1_10006

			var_27_4(var_27_3, var_27_5, var_1_10006.floor(arg_27_0.invincibilityTime / var_0_3) % 2)
		end

		local var_27_6 = arg_27_0
		local var_27_7, var_27_8 = arg_27_0.GetMoveInfo(var_27_6)

		RyzaMiniGameConfig = var_27_6

		local var_27_9 = var_27_6.ReSetDir(var_27_8)

		RyzaMiniGameConfig = var_4

		if var_4.GetEightDirMark(var_27_9) == "" then
		...
		local var_27_10 = arg_27_0:MoveDelta(var_27_9, arg_27_0:GetSpeedDis() * arg_27_1)

		arg_27_0:MoveUpdate(var_27_10)

		if #var_4 == 1 and var_0_2[var_4][1] * var_27_10.x + var_0_2[var_4][2] * var_27_10.y == 0 then
...
function var_0_1.PlayIdle(arg_39_0)
	...
	if not var_1_10005.split(arg_39_0.status, "_")[2] then
		var_39_3 = "S"
	end
...
function var_0_1.PlayDamage(arg_40_0)
	...
	if not var_1_10005.split(arg_40_0.status, "_")[2] then
		var_40_3 = "S"
	end
...
function var_0_1.SetHide(arg_42_0, arg_42_1)
	...
	var_2(var_42_0, var_5(var_1_10007)).alpha = arg_42_1 and 0.7 or 1
