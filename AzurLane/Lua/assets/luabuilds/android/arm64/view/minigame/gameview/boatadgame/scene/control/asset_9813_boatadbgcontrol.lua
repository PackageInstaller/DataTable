...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_0(var_1_1, var_6.GetComponent(var_1_2, "SkeletonGraphic"))
	...
	var_1_3(var_1_4, var_6.GetComponent(var_1_5, "SkeletonGraphic"))
	...
	var_1_6(var_1_7, var_6.GetComponent(var_1_8, "SkeletonGraphic"))
	...
	for iter_1_0 = 1, 3 do
		...
		local var_1_10 = var_10(var_1_9, "ad/img/spine")

		typeof = var_1_10011
		SpineAnimUI = var_13
		var_1_8 = var_1_8(var_1_10, var_1_10011(var_13))
		...
		var_1_10(var_1_9, arg_1_0._content)

		setActive = var_1_10

		var_1_10(var_1_9, false)

		table = var_1_10

		var_1_10.insert(arg_1_0.thunders, var_1_11)
	end
...
function var_0_0.step(arg_3_0, arg_3_1)
	if arg_3_0._createTime > 0 then
		...
		if arg_3_0._createTime <= 0 then
			...
			if var_2.random(1, 100) <= var_0_3 then
				...
				local var_3_2 = var_5.create_bg

				math = var_1_10006

				local var_3_3 = var_1_10006.random

				var_1_10008 = 1
				BoatAdGameConst = var_1_10009

				var_3_1(var_3_0, var_3_2[var_3_3(var_1_10008, #var_1_10009.create_bg)])
			end
		end
	end
		...
		if arg_3_0._thunderTime <= 0 then
			...
			for iter_3_0 = 1, #arg_3_0.thunders do
				if arg_3_0.thunders[iter_3_0].active == false then
					...
					local var_3_4 = arg_3_0._bgs

					math = var_1_10008

					local var_3_5 = var_3_4[var_1_10008.random(1, #arg_3_0._bgs)]

					var_1_10008 = var_6.tf
					var_1_10008.anchoredPosition = var_3_5:getPosition()
	...
	for iter_3_1 = #arg_3_0._bgs, 1, -1 do
		local var_3_6 = arg_3_0._bgs[iter_3_1]

		var_6.step(var_3_6, arg_3_1)
...
function var_0_0.getOrCreateItem(arg_9_0, arg_9_1)
	...
	if not var_9_0 then
		...
		BoatAdBg = var_1_10005

		local var_9_4 = var_1_10005.New(var_9_3, arg_9_0._event)
