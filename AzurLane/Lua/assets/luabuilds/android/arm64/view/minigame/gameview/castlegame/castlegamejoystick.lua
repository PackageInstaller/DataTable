...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0._eventTriggerListener = var_2(var_1_1, var_5(var_1_10007))
	...
	var_2.AddDragFunc(var_1_3, function(arg_3_0, arg_3_1)
		...
		var_3_5(var_3_4, var_6.getOffset(var_3_6, arg_1_0.dragPos, arg_1_0.startPos))
	...
	var_2.AddPointUpFunc(var_1_4, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10005(0, 0))
...
function var_0_0.setTargetPos(arg_5_0, arg_5_1)
	...
	local var_5_2 = var_1_10005.pow(arg_5_1.x - var_5_0.x, 2)

	math = var_1_10006

	local var_5_3 = var_5_1(var_5_2 + var_1_10006.pow(arg_5_1.y - var_5_0.y, 2))
	...
	if arg_5_0.maxDistance < var_5_3 then
		...
		local var_5_5 = var_6.abs(arg_5_1.y - var_5_0.y)

		math = var_7

		local var_5_6 = var_5_4(var_5_5 / var_7.abs(arg_5_1.x - var_5_0.x))
...
function var_0_0.step(arg_8_0)
	...
	local var_8_4 = var_3.pow(arg_8_0.currentX - arg_8_0.startPos.x, 2)

	math = var_4
	arg_8_0.distanceRate = var_8_3(var_8_4 + var_4.pow(arg_8_0.currentY - arg_8_0.startPos.y, 2)) / arg_8_0.maxDistance
	math = var_1
	...
	local var_8_6 = var_3.abs(arg_8_0.currentY - arg_8_0.startPos.y)

	math = var_4
	arg_8_0.angle = var_8_5(var_8_6 / var_4.abs(arg_8_0.currentX - arg_8_0.startPos.x))
...
function var_0_0.setDirectTarget(arg_9_0, arg_9_1)
	if not arg_9_0.active then
		...
		var_9_1(var_9_0, var_1_10005(arg_9_1.x * 1000, arg_9_1.y * 1000))
	end
