...
local var_0_1 = {
	TargetObject = function()
		...
		function var_1_0.Init(arg_8_0, arg_8_1)
			...
			var_8_2(var_8_1, var_8_3 - var_2_10006(0, arg_8_0:GetSize().y - 1))
		...
		function var_1_0.UpdatePos(arg_10_0, arg_10_1)
			...
			typeof = var_2_10005
			Canvas = var_2_10007
			var_10_1(var_10_0, var_2_10005(var_2_10007)).sortingOrder = (arg_10_1.y + arg_10_0:GetSize().y) * 10 + arg_10_0:GetBaseOrder()
	...
	TargetIce = function()
		...
		function var_13_0.InitUI(arg_15_0, arg_15_1)
			...
			local var_15_3 = var_15_2(var_15_1, var_5(var_2_10007))
	...
	TargetItem = function()
		...
		function var_18_0.InitUI(arg_21_0, arg_21_1)
			...
			var_2(var_4.Find(var_21_0, "scale/type"), function(arg_22_0)
	...
	TargetArbor = function()
		...
		function var_23_0.InitUI(arg_24_0, arg_24_1)
			...
			var_2_10003(var_5.Find(var_24_1, "scale/Image"), function(arg_25_0)
				setActive = var_3_10001
	...
	TargetMove = function()
		...
		function var_26_0.InitUI(arg_29_0, arg_29_1)
			...
			local var_29_4 = var_29_3(var_29_2, var_5(var_2_10007))
		...
		function var_26_0.PlayIdle(arg_35_0, arg_35_1)
			...
			var_35_1(var_35_0, var_2_10005.format("Idle_%s%s", arg_35_1 or arg_35_0:GetDirMark(), arg_35_0.inLantern and "_Lantern" or ""))
		...
		function var_26_0.PlayMove(arg_36_0, arg_36_1)
			...
			var_36_1(var_36_0, var_2_10005.format("Move_%s%s", arg_36_1 or arg_36_0:GetDirMark(), arg_36_0.inLantern and "_Lantern" or ""))
		...
		function var_26_0.GetDirPos(arg_38_0, arg_38_1)
			...
			return var_2_10002(var_2_10004(var_26_1[arg_38_1 or arg_38_0:GetDirMark()]))
		end
		...
		function var_26_0.PlayAnim(arg_41_0, arg_41_1)
			...
			if var_2_10002(arg_41_0.loopAnimDic[arg_41_0:GetStatusMark(arg_41_1)]) and arg_41_0.status == arg_41_1 then
				-- block empty
			else
				arg_41_0.inLock = not var_2
				arg_41_0.status = arg_41_1

				local var_41_0 = arg_41_0.mainTarget
				local var_41_1 = var_3.GetComponent

				typeof = var_2_10006
				Animator = var_8

				local var_41_2 = var_41_1(var_41_0, var_2_10006(var_8))

				var_3.Play(var_41_2, arg_41_1, -1, 0)
				arg_41_0:RushCheck()
			end
	...
	TargetFuShun = function()
		...
		function var_42_0.InitUI(arg_46_0, arg_46_1)
			...
			arg_46_0.rushTime = var_2(var_4.GetSkillParam("rush", arg_46_0.level.rush), {
				1
			})
					...
					if iter_47_1 == "item" then
						...
						if arg_47_0.level[iter_47_1] > 0 then
							...
							if iter_47_1 == "ice" then
								...
								if var_13.CheckIce(var_47_6, arg_47_0.pos + arg_47_0:GetDirPos()) then
									var_47_7 = "attack"
			...
			elseif arg_48_1 == "trigger" then
				...
				var_2_10003(arg_48_0.status, {
					["Freeze_" .. var_48_0 .. "_3_Shot"] = function()
						...
						var_49_2.parent = var_4.Find(var_49_3, "bk")
						...
						var_49_6.dirPos = var_4.GetDirPos(var_49_7)
					...
					["Attack_" .. var_48_0] = function()
						...
						var_3_10000(var_48_0, {
							N = function()
								...
								var_51_2.parent = var_4.Find(var_51_3, "bk")
							...
							S = function()
								...
								var_52_2.parent = var_4.Find(var_52_3, "fr")
							...
							var_53_2.parent = var_4.Find(var_53_3, "fr")
							...
							var_53_6.parent = var_4.Find(var_53_7, "bk")
						...
						var_50_2.dir = var_4.GetDirMark(var_50_3)

						local var_50_4 = arg_48_0

						var_50_2.dirPos = var_4.GetDirPos(var_50_4)
					...
					Lantern_Activate = function()
						...
						var_54_4.parent = var_5.Find(var_54_5, "bk")
			...
			elseif arg_48_1 == "end" then
				...
				var_2_10003(arg_48_0.status, {
					["Bomb_" .. var_48_0 .. "_1_Start"] = function()
						...
						var_0.PlayAnim(var_55_1, "Bomb_" .. var_48_0 .. "_3_End")
		...
		function var_42_0.RushCheck(arg_57_0)
			...
			if arg_57_0.inRush and arg_57_0.loopAnimDic[arg_57_0:GetStatusMark(arg_57_0.status)] then
				...
				local var_57_0 = var_42_5
				local var_57_1 = arg_57_0

				for iter_57_2, iter_57_3 in var_1(var_57_0[arg_57_0.GetDirMark(var_57_1)]) do
					string = var_57_1
					var_57_1 = var_57_1.split(iter_57_3, "_")
					table = var_2_10007
					var_2_10007 = var_2_10007.insert

					local var_57_2 = arg_57_0.rushEffects
					local var_57_3 = arg_57_0.controller
					local var_57_4 = var_10.CreateTarget
					local var_57_5 = {
						name = iter_57_3
					}
					local var_57_6 = arg_57_0.rtScale

					var_57_5.parent = var_14.Find(var_57_6, var_57_1[#var_57_1])

					var_2_10007(var_57_2, var_57_4(var_57_3, var_57_5))
				end
			end
		...
		function var_42_0.OnTimerUpdate(arg_58_0, arg_58_1)
			...
			if arg_58_0.inCharge then
				...
				local var_58_0 = arg_58_0.inCharge

				if var_42_2 < var_58_0 then
					arg_58_0.inCharge = nil

					local var_58_1 = arg_58_0
					local var_58_2 = arg_58_0.PlayAnim

					string = iter_58_0

					var_58_2(var_58_1, iter_58_0.format("Freeze_%s_3_Shot", arg_58_0:GetDirMark()))
				end
			elseif arg_58_0.inMove then
				arg_58_0.inMove = arg_58_0.inMove - arg_58_1 * arg_58_0:GetSpeed()

				local var_58_3 = arg_58_0.inMove
			...
			elseif arg_58_0.inLock then
				...
				if var_2.InBlackHoleRange(var_58_4, arg_58_0.pos, true) then
					arg_58_0.inShock = 1
				...
				elseif arg_58_0.inLantern and arg_58_0.inLantern <= 0 then
					...
					local var_58_5 = arg_58_0.effectLantern

					var_2.PlayAnim(var_58_5, "EF_bk_overlay_Lantern_Finish")

					arg_58_0.effectLantern = nil
				else
					if arg_58_0:CheckSkill("ice") then
						local var_58_6 = arg_58_0.controller

						if var_2.GetPressInput(var_58_6, "Skill_0") then
							arg_58_0:ReloadSkill("ice")

							local var_58_7 = arg_58_0.controller

							if var_2.CheckIce(var_58_7, arg_58_0.pos + arg_58_0:GetDirPos()) then
								local var_58_8 = arg_58_0
								local var_58_9 = arg_58_0.PlayAnim

								string = var_5

								var_58_9(var_58_8, var_5.format("Attack_%s", arg_58_0:GetDirMark()))
							else
								arg_58_0.inCharge = 0

								local var_58_10 = arg_58_0
								local var_58_11 = arg_58_0.PlayAnim

								string = var_5

								var_58_11(var_58_10, var_5.format("Freeze_%s_1_Start", arg_58_0:GetDirMark()))
							end
					...
					if arg_58_0:CheckSkill("flash") then
						...
						if var_2.GetPressInput(var_58_12, "Skill_1") then
							arg_58_0:ReloadSkill("flash")

							local var_58_13 = arg_58_0:GetDirPos()

							for iter_58_2 = arg_58_0.flashPower, 0, -1 do
								local var_58_14 = arg_58_0.controller

								if var_7.Moveable(var_58_14, arg_58_0.pos + var_58_13 * iter_58_2) then
									local var_58_15 = arg_58_0.controller

									var_7.CreateTarget(var_58_15, {
										name = "EF_bk_Flash_Jump",
										pos = arg_58_0.pos
									})
									arg_58_0:UpdatePos(arg_58_0.pos + var_58_13 * iter_58_2)

									arg_58_0.realPos = arg_58_0.pos

									arg_58_0:UpdatePosition()

									local var_58_16 = arg_58_0.controller
									local var_58_17 = var_7.CreateTarget
									local var_58_18 = {
										name = "EF_bk_Flash_Land"
									}
									local var_58_19 = arg_58_0.rtScale

									var_58_18.parent = var_11.Find(var_58_19, "bk")

									var_58_17(var_58_16, var_58_18)

									local var_58_20 = arg_58_0
									local var_58_21 = arg_58_0.PlayAnim

									string = var_58_18

									var_58_21(var_58_20, var_58_18.format("Flash_%s", arg_58_0:GetDirMark()))
					...
					if arg_58_0:CheckSkill("rush") then
						local var_58_22 = arg_58_0.controller

						if var_2.GetPressInput(var_58_22, "Skill_2") then
					...
					if arg_58_0.itemType and arg_58_0:CheckSkill("item") then
						local var_58_23 = arg_58_0.controller

						if var_2.GetPressInput(var_58_23, "Skill_3") and (arg_58_0.itemType ~= "lantern" or not arg_58_0.inLantern) then
							if arg_58_0.itemType == "lantern" then
								...
								if arg_58_0.itemType == "bomb" then
									local var_58_24 = arg_58_0

									var_58_25 = arg_58_0.PlayAnim
									string = var_5

									var_58_25(var_58_24, var_5.format("Bomb_%s_1_Start", arg_58_0:GetDirMark()))
								else
									assert = var_58_25
					...
					if not var_2.GetCacheInput(var_58_26) then
						defaultValue = var_3
						arg_58_0.idleTime = var_3(arg_58_0.idleTime, 0) - arg_58_1

						arg_58_0:PlayIdle()
					elseif arg_58_0:GetStatusMark() == "Move" then
						local var_58_27 = arg_58_0.controller

						if var_3.Moveable(var_58_27, arg_58_0.pos + arg_58_0:GetDirPos(var_2)) then
							arg_58_0.inMove = 1
					...
					elseif var_2 == arg_58_0:GetDirMark() then
						...
						if var_3(arg_58_0.idleTime, 0) <= 0 then
							local var_58_28 = arg_58_0.controller

							if var_3.Moveable(var_58_28, arg_58_0.pos + arg_58_0:GetDirPos()) then
								arg_58_0.inMove = 1
		...
		function var_42_0.PopPoint(arg_59_0, arg_59_1)
			...
			var_2_10003(var_59_1:Find("Text"), "+" .. arg_59_1)

			setActive = var_2_10003

			var_2_10003(var_59_1, false)

			setActive = var_2_10003

			var_2_10003(var_59_1, true)
	...
	TargetNenjuu = function()
		...
		function var_62_0.InitUI(arg_66_0, arg_66_1)
			...
			for iter_66_0, iter_66_1 in var_2(var_4.ABILITY_LIST) do
			...
			elseif arg_67_1 == "trigger" then
				...
				var_2_10003(arg_67_0.status, {
					["Attack_" .. var_67_0] = function()
						...
						var_68_2.parent = var_4.Find(var_68_3, var_67_0 == "N" and "bk" or "fr")
						...
						if not arg_67_0.isDoppel then
							...
							var_68_6.dir = var_4.GetDirMark(var_68_7)

							local var_68_8 = arg_67_0

							var_68_6.dirPos = var_4.GetDirPos(var_68_8)

							local var_68_9 = arg_67_0

							var_68_6.power = var_4.CheckAbility(var_68_9, "breakpassable") and 3 or 1
						...
						var_68_12.dirPos = var_4.GetDirPos(var_68_13)
		...
		function var_62_0.RushCheck(arg_70_0)
			...
			if arg_70_0.inStealth and arg_70_0.loopAnimDic[arg_70_0:GetStatusMark(arg_70_0.status)] then
				...
				local var_70_0 = var_62_6
				local var_70_1 = arg_70_0

				for iter_70_2, iter_70_3 in var_1(var_70_0[arg_70_0.GetDirMark(var_70_1)]) do
					string = var_70_1
					var_70_1 = var_70_1.split(iter_70_3, "_")
					table = var_2_10007
					var_2_10007 = var_2_10007.insert

					local var_70_2 = arg_70_0.rushEffects
					local var_70_3 = arg_70_0.controller
					local var_70_4 = var_10.CreateTarget
					local var_70_5 = {
						name = iter_70_3
					}
					local var_70_6 = arg_70_0.rtScale

					var_70_5.parent = var_14.Find(var_70_6, var_70_1[#var_70_1])

					var_2_10007(var_70_2, var_70_4(var_70_3, var_70_5))
				end
			end
		...
		function var_62_0.OnTimerUpdate(arg_71_0, arg_71_1)
			...
			for iter_71_0, iter_71_3 in var_2_10002(arg_71_0.featuresAbility) do
				if iter_71_3 and var_62_5[iter_71_0] > 0 then
			...
			elseif arg_71_0.inLock then
				...
				if arg_71_0:CheckAbility("attack") and not arg_71_0.inScare then
					...
					for iter_71_2, iter_71_3 in var_2({
						...
						var_2_10009 = arg_71_0.controller

						if var_7.AttackCheck(var_2_10009, {
							pos = arg_71_0.pos,
							dirPos = arg_71_0:GetDirPos(iter_71_3)
						}) then
							var_2_10009 = arg_71_0

							arg_71_0.DoAttack(var_2_10009, iter_71_3)
				...
				local var_71_4 = var_2.GetWayfindingMap
				local var_71_5 = arg_71_0.pos

				tobool = iter_71_3

				local var_71_6 = var_71_4(var_71_3, var_71_5, iter_71_3(arg_71_0.isDoppel))
				local var_71_7 = arg_71_0.pos

				ipairs = var_71_3

				for iter_71_4, iter_71_5 in var_71_3({
					"E",
					"S",
					"W",
					"N"
					...
					if var_71_6[var_2_10009(arg_71_0.pos + arg_71_0:GetDirPos(iter_71_5))] then
						tostring = var_2_10010
						var_2_10010 = var_71_6[var_2_10010(var_71_7)]

						if arg_71_0.inScare then
							if not var_2_10010 or var_2_10010.value < var_2_10009.value then
								var_71_7 = arg_71_0.pos + arg_71_0:GetDirPos(iter_71_5)
							end
						...
						if var_2_10010 then
							do
								...
								if not var_2_10010.lightValue then
									var_71_8 = var_2_10010.value
								end

								local var_71_9

								if not var_2_10009.lightValue then
									var_71_9 = var_2_10009.value
								end

								if var_71_9 < var_71_8 then
									var_71_7 = arg_71_0.pos + arg_71_0:GetDirPos(iter_71_5)
								end
							end
				...
				if arg_71_0:CheckAbility("teleport") and not arg_71_0.inScare then
					if var_71_7 == arg_71_0.pos then
						...
						if var_71_6[var_4(var_71_7)] then
							tostring = var_4

							if var_71_6[var_4(var_71_7)].value > var_62_4 then
								arg_71_0:DoTeleport(var_71_6)
								arg_71_0:PlayIdle()
				...
				if not arg_71_0.isDoppel and arg_71_0:CheckAbility("attack") then
					local var_71_10 = arg_71_0.controller

					if var_4.CheckIce(var_71_10, var_71_7) then
						arg_71_0:DoAttack(arg_71_0:GetDirMark(var_71_7 - arg_71_0.pos))

						goto label_71_1
					end
				end

				local var_71_11 = arg_71_0.controller

				if var_4.Moveable(var_71_11, var_71_7) then
					local var_71_12 = arg_71_0:GetDirMark(var_71_7 - arg_71_0.pos)

					arg_71_0.inMove = 1

					arg_71_0:UpdatePos(var_71_7)

					if arg_71_0.inScare then
						arg_71_0:PlayAnim("Fear_" .. var_71_12)
					else
						arg_71_0:PlayMove(var_71_12)
					end
		...
		function var_62_0.DoAttack(arg_72_0, arg_72_1)
			...
			var_72_1(var_72_0, var_5.format("Attack_%s", arg_72_1))
	...
	TargetEffect = function()
		...
		function var_75_0.InitUI(arg_78_0, arg_78_1)
			...
			local var_78_3 = var_78_2(var_78_1, var_5(var_2_10007))
	...
	TargetSubEffect = function()
		...
		function var_95_0.InitUI(arg_97_0, arg_97_1)
			...
			local var_97_3 = var_97_2(var_97_1, var_5(var_2_10007))
	...
	TargetRushEffect = function()
		...
		function var_99_0.InitUI(arg_101_0, arg_101_1)
			...
			var_2(var_101_1, var_5(var_2_10007))
