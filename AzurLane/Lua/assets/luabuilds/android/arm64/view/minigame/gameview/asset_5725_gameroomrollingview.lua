...
local var_0_0 = "GameRoomRollingView"
...
function var_0_1.init(arg_2_0)
	...
	local function var_2_13()
		if not arg_2_0.startFlag then
			...
			var_0.openCoinLayer(var_4_1, false)
		end
	...
	local function var_2_16()
		...
		var_5_2.helps = var_4.getGameRoomData(var_5_3).game_help
	...
	local function var_2_19()
		...
		var_0.openCoinLayer(var_6_0, true)
	...
	local function var_2_24()
		if not arg_2_0.countStart then
			...
			var_7_0(arg_2_0.overLight, false)

			arg_2_0.stopFlag = true
		end
...
function var_0_1.showScoreUI(arg_11_0, arg_11_1)
	...
	GameRoomProxy = var_1_10004

	local var_11_0 = var_1_10002(var_1_10004)

	if var_2.getRoomScore(var_11_0, arg_11_0:getGameRoomData().id) < arg_11_1 then
		setActive = var_1_10003

		var_1_10003(arg_11_0.scoreNew, true)
	else
		setActive = var_1_10003

		var_1_10003(arg_11_0.scoreNew, false)
	end

	local var_11_1 = arg_11_1 < var_11_1 and var_11_1 or arg_11_1

	setActive = var_1_10003

	var_1_10003(arg_11_0.scoreUI, true)

	setText = var_1_10003

	var_1_10003(arg_11_0.labelCurScore, arg_11_1)

	setText = var_1_10003

	var_1_10003(arg_11_0.labelHigh, var_11_1)
	arg_11_0:StoreDataToServer({
		var_11_1
	})
	arg_11_0:SendSuccess(arg_11_1)
