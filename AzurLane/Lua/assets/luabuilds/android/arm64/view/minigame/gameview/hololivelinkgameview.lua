...
function var_0_1.willExit(arg_6_0)
	...
	var_6_0(var_1_10003(arg_6_0.countDown))

	for iter_6_0 = 0, arg_6_0.layout.childCount - 1 do
		LeanTween = var_6_1

		local var_6_1 = var_6_1.cancel

		go = var_1_10007

		local var_6_2 = arg_6_0.layout

		var_6_1(var_1_10007(var_9.GetChild(var_6_2, iter_6_0)))
	end

	if arg_6_0.countTimer then
		local var_6_3 = arg_6_0.countTimer
...
function var_0_1.addListener(arg_9_0)
	...
	local function var_9_5()
		...
		pg = var_2_10004
		var_11_2.helps = var_2_10004.gametip.hololive_lianliankan.tip
...
function var_0_1.playStory(arg_15_0)
	...
	if var_1.GetConfigCsvLine(var_15_0, arg_15_0.linkGameID).story == "" then
		...
		local var_15_2 = var_4.NewStoryMgr.GetInstance()
...
function var_0_1.GameBegin(arg_18_0)
	...
	if 0 < var_18_2 then
		repeat
			...
			math = var_1_10005
			var_1_10005 = var_1_10005.floor
			math = var_1_10007
			var_18_2 = var_18_2(var_1_10005(var_1_10007.random() * #var_18_0 + 1), 1, #var_18_0)
			math = var_18_3

			local var_18_3 = var_18_3.floor(var_18_1 / (var_0_1.MAX_COLUMN - 2)) + 1
			...
			var_18_4[var_18_3] = var_1_10007

			local var_18_5 = arg_18_0.cards[var_18_3]

			var_18_5[var_1_10005] = {
				row = var_18_3,
				column = var_1_10005,
			...
			var_18_5.remove(var_18_0, var_18_2)
	...
	for iter_18_0 = 0, var_0_1.MAX_ROW - 1 do
		for iter_18_1 = 0, var_0_1.MAX_COLUMN - 1 do
			...
			var_18_6[iter_18_0] = var_18_7

			local var_18_8 = arg_18_0.cards[iter_18_0]
			local var_18_9
	...
	local var_18_10 = arg_18_0.list

	var_3.make(var_18_10, function(arg_19_0, arg_19_1, arg_19_2)
		...
		if arg_19_0 == var_2_10003.EventUpdate then
			...
			if var_19_2.state == var_0_1.CARD_STATE_NORMAL then
				...
				local var_19_4 = var_6(var_8.GetChild(var_19_3, var_19_2.id))
				...
				local var_19_6 = var_7(var_19_5, var_10(var_12))
	...
	var_3.align(var_18_11, var_0_1.MAX_ROW * var_0_1.MAX_COLUMN)

	UIItemList = var_3
	arg_18_0.llist = var_3.New(arg_18_0.bottom, arg_18_0.line)

	local var_18_12 = arg_18_0.llist

	var_3.make(var_18_12, function(arg_20_0, arg_20_1, arg_20_2)
		UIItemList = var_2_10003
	...
	var_3.align(var_18_13, var_0_1.MAX_ROW * var_0_1.MAX_COLUMN)
	...
	for iter_18_2 = 0, arg_18_0.countDown.childCount - 1 do
		...
		local var_18_14 = arg_18_0.countDown

		var_7(var_9.GetChild(var_18_14, iter_18_2), false)
	end

	local var_18_15 = 0
	local var_18_16 = arg_18_0.countDown
	local var_18_17 = var_4.GetChild(var_18_16, var_18_15)

	setActive = var_5

	var_5(var_18_17, true)
	...
	local var_18_18 = var_5.value

	go = var_7

	local var_18_19 = var_18_18(var_7(arg_18_0.countDown), 0, 1, 1)
	local var_18_20 = var_5.setOnUpdate

	System = var_8

	local var_18_21 = var_18_20(var_18_19, var_8.Action_float(function(arg_21_0)
		math = var_2_10001
		arg_21_0 = var_2_10001.min(arg_21_0 / 0.3, 1)
		setImageAlpha = var_1

		var_1(var_18_17, arg_21_0)
	...
	local var_18_22 = var_5.setOnComplete

	System = var_8

	local var_18_23 = var_18_22(var_18_21, var_8.Action(function()
		setActive = var_2_10000

		var_2_10000(var_18_17, false)

		var_18_15 = var_18_15 + 1

		if var_18_15 < arg_18_0.countDown.childCount then
			local var_22_0 = arg_18_0.countDown

			var_18_17 = var_0.GetChild(var_22_0, var_18_15)
			setActive = var_0

			var_0(var_18_17, true)
	...
	local var_18_24 = var_5.setRepeat(var_18_23, 4)
	local var_18_25 = var_5.setLoopType

	LeanTweenType = var_8

	local var_18_26 = var_18_25(var_18_24, var_8.punch)
	local var_18_27 = var_5.setOnCompleteOnRepeat(var_18_26, true)
	local var_18_28 = var_5.setEase

	LeanTweenType = var_8

	var_18_28(var_18_27, var_8.easeOutSine)
...
function var_0_1.GameLoop(arg_23_0)
	local function var_23_0(arg_24_0)
		...
		for iter_24_0 = 1, #arg_24_0 - 1 do
			...
			if var_24_3 ~= 0 then
				setActive = var_12
				var_2_10016 = var_24_7

				var_12(var_24_7.Find(var_2_10016, "y" .. var_24_3), true)
			elseif var_24_4 ~= 0 then
				setActive = var_12
				var_2_10016 = var_24_7

				var_12(var_24_7.Find(var_2_10016, "x" .. var_24_4), true)
			end
		end
	...
	var_6.each(var_23_5, function(arg_26_0, arg_26_1)
		...
		local var_26_2 = arg_26_1.Find(var_26_1, "display/icon")
		...
		local function var_26_3()
			...
			elseif not var_23_2 then
				...
				var_3(var_5.Find(var_27_2, "display/selected"), true)
			...
			elseif var_23_2 == var_2 then
				...
				var_3(var_5.Find(var_27_3, "display/selected"), false)
			...
			elseif var_23_2.id ~= var_2.id then
				...
				var_3(var_5.Find(var_27_4, "display/selected"), false)
				...
				if not var_3.LinkLink(var_27_5, var_23_2, var_2) then
					...
					var_4(var_6.Find(var_27_6, "display/selected"), false)
					...
					var_27_7(var_6.Find(var_27_8, "display/selected"), true)
					var_23_0(var_3)
					...
					typeof = var_9
					Animator = var_3_10011

					local var_27_12 = var_6(var_27_11, var_9(var_3_10011))
					...
					typeof = var_3_10010
					Animator = var_3_10012

					local var_27_14 = var_7(var_27_13, var_3_10010(var_3_10012))

					GetComponent = var_27_11

					local var_27_15 = var_27_11(var_27_9, "DftAniEvent")

					GetComponent = var_27_13

					local var_27_16 = var_27_13(var_27_10, "DftAniEvent")
		...
		var_2_10002(var_26_0, var_26_2, var_26_3, var_26_1)
	...
	local function var_23_9()
		if arg_23_0.state ~= var_0_1.GAME_STATE_GAMING then
			...
			if var_0.realtimeSinceStartup - var_23_6 < var_0_1.RESET_CD then
				...
				var_31_1(var_31_0, var_2_10003("common_wait"))
			else
				if var_23_2 then
					setActive = var_0
					...
					var_0(var_2.Find(var_31_2, "display/selected"), false)
				...
				while #var_31_4 > 0 do
					...
					local var_31_6 = var_31_6.clamp

					math = iter_31_0
					iter_31_0 = iter_31_0.floor
					math = var_2_10007
					var_31_6 = var_31_6(iter_31_0(var_2_10007.random() * #var_31_4 + 1), 1, #var_31_4)

					local var_31_7 = arg_23_0.cards[var_31_3[var_31_5].row][var_31_3[var_31_5].column]
				...
				var_3.each(var_31_8, function(arg_32_0, arg_32_1)
					...
					if arg_23_0.cards[var_32_0][var_32_1].state == var_0_1.CARD_STATE_NORMAL then
						...
						local var_32_3 = var_5(var_7.GetChild(var_32_2, var_4.id))
	...
	var_1_10007(var_23_7, var_23_8, var_23_9, var_1_10012)

	Time = var_1_10007
	arg_23_0.startTime = var_1_10007.realtimeSinceStartup
	Timer = var_7
	arg_23_0.countTimer = var_7.New(function()
		...
		Time = var_2_10003
		var_33_0.lastRecord = var_33_1((var_2_10003.realtimeSinceStartup - arg_23_0.startTime) * 1000)
		math = var_33_0
		...
		var_1(var_33_3, var_4.FormatRecordTime(var_33_4, var_33_2))
...
function var_0_1.GameEnd(arg_34_0)
	...
	if arg_34_0.bestScoreTable[arg_34_0.linkGameID] == 0 then
		...
		local var_34_5 = var_1_10005.SEND_MINI_GAME_OP
		local var_34_6 = {}
		local var_34_7 = arg_34_0.miniGameData

		var_34_6.hubid = var_7.getConfig(var_34_7, "hub_id")
		MiniGameOPCommand = var_7
		var_34_6.cmd = var_7.CMD_COMPLETE
		var_34_6.args1 = {
			var_34_2,
			arg_34_0.linkGameID
		}
...
function var_0_1.IterateByOneSnap(arg_36_0, arg_36_1, arg_36_2, arg_36_3, arg_36_4)
	for iter_36_0 = 1, #arg_36_3 do
		...
		for iter_36_1, iter_36_2 in var_1_10010(var_36_0) do
...
function var_0_1.setIconList(arg_39_0)
	...
	local var_39_2 = arg_39_0.GetMGData(var_39_1)
	local var_39_3 = var_2.GetRuntimeData(var_39_2, "curLinkGameID")

	print = var_39_1

	local var_39_4 = "当前地图ID"

	tostring = var_1_10007

	var_39_1(var_39_4, var_1_10007(var_39_3))

	local var_39_5 = var_2
	local var_39_6 = var_2.GetConfigCsvLine(var_39_5, var_39_3).block

	ipairs = var_39_5

	for iter_39_0, iter_39_1 in var_39_5(var_39_6) do
		local var_39_7 = iter_39_1[1]

		if iter_39_1[2] % 2 ~= 0 then
			assert = var_13

			var_13(false, "资源名" .. var_39_7 .. "数量不为偶数" .. var_12)
		end

		local var_39_8 = var_0_1.NAME_TO_INDEX[var_39_7]

		assert = var_1_10014

		var_1_10014(var_39_8, "没有定义该资源名" .. var_39_7)

		for iter_39_2 = 1, var_12 do
			table = var_18

			var_18.insert(var_39_0, var_39_8)
		end
	end
