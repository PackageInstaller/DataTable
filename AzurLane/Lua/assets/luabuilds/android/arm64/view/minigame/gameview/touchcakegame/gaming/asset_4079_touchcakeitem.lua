...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0._cakeAnimUI = var_3(var_1_0, var_6(var_1_10008))
	findTF = var_3
	...
	typeof = var_6
	SpineAnimUI = var_1_10008
	arg_1_0._propLeftAnimUI = var_3(var_1_1, var_6(var_1_10008))
	findTF = var_3
	...
	typeof = var_6
	SpineAnimUI = var_1_10008
	arg_1_0._propRightAnimUI = var_3(var_1_2, var_6(var_1_10008))
	arg_1_0._props = {
		{
			direct = -1,
...
function var_0_0.updateItem(arg_5_0)
	...
	local var_5_2 = var_5_1(var_5_0, var_1_10004.cake_anim_normal)
	...
	for iter_5_0, iter_5_1 in var_2(arg_5_0._props) do
		...
		if iter_5_1.data then
			...
			if iter_5_1.data.spine then
				...
				TouchCakeGameConst = var_1_10012

				local var_5_6, var_5_7 = var_5_5(var_5_4, var_1_10012.prop_anim_normal, iter_5_1.data)
...
function var_0_0.setIconVisible(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0 = 1, var_6_0 do
		...
		var_1_10009(var_6_1, var_6_1.name == arg_6_2)
	end
...
function var_0_0.touchAction(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_2 = var_7_1(var_7_0, var_1_10006.cake_anim_action, arg_7_1)
	...
	Clone = var_8
	var_7_6.cake = var_8(arg_7_0._cakeData)
...
function var_0_0.getCakeAnimName(arg_8_0, arg_8_1, arg_8_2)
	...
	if arg_8_1 == var_1_10004.cake_anim_normal then
...
function var_0_0.propAction(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10001(arg_20_0._props) do
		if iter_20_1.data then
			...
			TouchCakeScene = var_1_10008
			var_1_10008 = var_1_10008.EVENT_ACTION_PROP

			local var_20_1 = {}

			Clone = var_1_10010
			var_20_1.prop = var_1_10010(iter_20_1)

			var_20_0(var_1_10008, var_20_1, function(arg_21_0)
				if iter_20_1.data.spine then
					...
					TouchCakeGameConst = var_2_10006

					local var_21_4, var_21_5 = var_21_3(var_21_2, var_2_10006.prop_anim_action, iter_20_1.data, iter_20_1.direct)
