...
local var_0_0 = "GameRoomHideSeekView"
	...
	local var_1_0 = {
		ctor = function(arg_2_0)
			...
			for iter_2_0 = 1, #var_0_40 do
				...
				findTF = var_2_10006
				var_2_10006 = var_2_10006(arg_2_0._sceneTf, var_0_40[iter_2_0].name)
				table = var_7
			...
			for iter_4_1 = #arg_4_0._activeFurnitures, 1, -1 do
				if arg_4_0._activeFurnitures[iter_4_1].time then
					...
					if var_6.time <= 0 then
						arg_4_0:setFurnitureTimeEvent(var_6)
					end
				end
			end
		...
		setFurnitureTimeEvent = function(arg_5_0, arg_5_1)
			if arg_5_1.data.type == var_0_16 then
				...
				arg_5_0.returnCharIndex(var_5_0, arg_5_1.charIndex)

				math = var_2

				if var_2.random() <= arg_5_1.data.weight and #var_0_47 > 0 then
					table = var_2

					local var_5_1 = var_2.remove

					var_5_0 = var_0_47
					math = var_5
					arg_5_1.charIndex = var_5_1(var_5_0, var_5.random(1, #var_0_47))
				else
				...
				local var_5_2 = var_5_0(arg_5_1.animTf, "anim")

				typeof = var_5
				Animator = var_7

				local var_5_3 = var_2(var_5_2, var_5(var_7))

				var_2.SetInteger(var_5_3, "charIndex", arg_5_1.charIndex)
			elseif arg_5_1.data.type == var_0_14 then
				if arg_5_1.data.hide and not arg_5_1.readyToRemove then
					...
					var_5_4, GetComponent = var_2(arg_5_1.animTf, "anim"), var_3
					typeof = var_2_10006
					Animator = var_2_10008

					local var_5_5 = var_3(var_5_4, var_2_10006(var_2_10008))

					var_3.SetTrigger(var_5_5, "hide")
				else
			...
			elseif arg_5_1.data.type == var_0_15 then
				if arg_5_1.charIndex then
					...
					arg_5_0.returnCharIndex(var_5_6, arg_5_1.charIndex)

					if arg_5_1.animTf then
						setActive = var_2
						findTF = var_5_6

						var_2(var_5_6(arg_5_1.animTf, "collider"), false)
					end
		...
		appearChar = function(arg_7_0, arg_7_1)
			...
			if arg_7_1 then
				var_2_10005 = arg_7_0
				var_7_0 = arg_7_0.getFunitureFromPool(var_2_10005, arg_7_1)
			end
			...
			if not var_7_0 then
				...
				var_2_10005 = arg_7_0._furnituresPools
				math = var_2_10006
				var_7_0 = var_7_1(var_2_10005, var_2_10006.random(1, #arg_7_0._furnituresPools))
			end

			local var_7_2 = var_7_0.data.pos_data_list

			math = var_2_10005

			local var_7_3 = var_7_2[var_2_10005.random(1, #var_3.pos_data_list)].pos_name
			local var_7_4 = var_4.anim_name
			local var_7_5 = arg_7_0
			local var_7_6 = arg_7_0.getActiveIndex(var_7_5)

			if not var_0_41[var_7_4] then
				print = var_7_5

				var_7_5("警告，没有找到" .. var_7_4 .. "的动画数据")
			...
			if var_7_0.data.type == var_0_16 then
				...
				math = var_2_10013
				var_7_7 = var_7_8(var_7_9, var_2_10013.random(1, #var_0_47))
			end
			...
			arg_7_0:getAnimTfByPosData(var_4, var_7_6, function(arg_8_0, arg_8_1)
				if arg_8_1 ~= var_7_0.activeIndex then
					...
					var_2.returnAnimTf(var_8_0, var_7_4, arg_8_0)
				...
				if var_7_0.data.hide_tfs then
					for iter_8_0 = 1, #var_7_0.data.hide_tfs do
						...
						var_3_10006(var_3_10008(var_7_0.tf, var_7_0.data.hide_tfs[iter_8_0]), false)
					end
				end

				findTF = var_2

				local var_8_1 = var_2(var_7_0.tf, var_7_3)

				SetParent = var_3_10003

				var_3_10003(arg_8_0, var_8_1)

				setActive = var_3_10003

				var_3_10003(arg_8_0, true)

				setActive = var_3_10003
				findTF = var_5

				var_3_10003(var_5(arg_8_0, "collider"), true)

				Vector2 = var_3_10003
				arg_8_0.anchoredPosition = var_3_10003(0, 0)
		...
		prepareAnim = function(arg_10_0, arg_10_1)
			...
			local var_10_2 = var_2_10006(var_10_1, "anim")

			typeof = var_2_10007
			Animator = var_9

			local var_10_3 = var_4(var_10_2, var_2_10007(var_9))
			...
			if arg_10_1.data.type ~= var_0_16 then
				...
				var_4.SetTrigger(var_10_3, "trigger")
			end

			GetOrAddComponent = var_5
			findTF = var_10_3

			local var_10_4 = var_10_3(var_10_1, "collider")

			typeof = var_8
			EventTriggerListener = var_10

			local var_10_5 = var_5(var_10_4, var_8(var_10))

			var_5.AddPointDownFunc(var_10_5, function(arg_11_0, arg_11_1, arg_11_2)
				...
				if not var_11_0 then
					...
					local var_11_3 = var_5.CriMgr.GetInstance()
		...
		getAnimTfByPosData = function(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
			...
			if arg_13_0._furnitureAnimTfPool and arg_13_0._furnitureAnimTfPool[var_13_0] and #arg_13_0._furnitureAnimTfPool[var_13_0] > 0 then
				...
				var_13_1(var_2_10007.remove(arg_13_0._furnitureAnimTfPool[var_13_0], 1), arg_13_2)
		...
		returnFurniture = function(arg_14_0, arg_14_1)
			...
			if arg_14_1.data.hide_tfs then
				for iter_14_0 = 1, #arg_14_1.data.hide_tfs do
					...
					var_2_10006(var_2_10008(arg_14_1.tf, arg_14_1.data.hide_tfs[iter_14_0]), true)
				end
			end
			...
			for iter_14_1 = #arg_14_0._activeFurnitures, 1, -1 do
				if arg_14_0._activeFurnitures[iter_14_1] == arg_14_1 then
					...
					var_14_1(var_14_2, var_2_10009.remove(arg_14_0._activeFurnitures, iter_14_1))
				end
			end
			...
			for iter_14_2 = #arg_14_0._unActiveFurnitures, 1, -1 do
				if arg_14_0._unActiveFurnitures[iter_14_2] == arg_14_1 then
					...
					var_14_3(var_14_4, var_2_10009.remove(arg_14_0._unActiveFurnitures, iter_14_2))
				end
			end
		...
		createAnimTf = function(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
			...
			if arg_16_0._animTplDic[var_16_1] then
				...
				var_16_2(var_2_10009(var_2_10011(arg_16_0._animTplDic[var_16_1])), arg_16_2)
			else
				...
				var_16_2(var_0_37, var_16_0, function(arg_17_0)
					...
					var_17_0(var_3_10003(arg_17_0), arg_16_0._tplContainer)
					...
					var_17_1(var_3(var_5(arg_16_0._animTplDic[var_16_1])), arg_16_2)
		...
		destroy = function(arg_20_0)
			...
			for iter_20_0 = 1, #arg_20_0._furnitureAnimTfPool do
				if arg_20_0._furnitureAnimTfPool[iter_20_0].animTf then
					...
					findTF = var_2_10008
					var_2_10008 = var_2_10008(var_5, "collider")
					typeof = var_2_10009
					EventTriggerListener = var_11
					var_2_10006 = var_2_10006(var_2_10008, var_2_10009(var_11))
...
local function var_0_53(arg_21_0, arg_21_1)
	local var_21_0 = {
		ctor = function(arg_22_0)
			...
			local var_22_0 = var_3(arg_22_0._roleTf, "img/anim")

			typeof = var_4
			Animator = var_6
			arg_22_0._roleAnimator = var_1(var_22_0, var_4(var_6))
			GetComponent = var_1
			findTF = var_22_0
			...
			typeof = var_4
			DftAniEvent = var_6
			arg_22_0._dftEvent = var_1(var_22_1, var_4(var_6))
			...
			arg_22_0._eventTrigger = var_1(var_22_3, var_4(var_6))
			...
			for iter_22_0 = 1, #var_0_49 do
				...
				if var_0_49[iter_22_0].start then
					...
					var_22_5(var_22_6, var_2_10008(var_0_49[iter_22_0]))
				end
		...
		step = function(arg_27_0)
			...
			if 0 < var_27_0 then
				...
				if arg_27_0.showTime <= 0 then
					arg_27_0.showTime = 0
					var_2_10003 = arg_27_0

					arg_27_0.checkShow(var_2_10003)
				end
			end
			...
			if arg_27_0._currentTargetData and not arg_27_0.removeRoleFlag then
				...
				local var_27_7 = var_27_6 * var_2_10004.sin(arg_27_0._moveAngle)
		...
		setRoleNext = function(arg_29_0, arg_29_1)
			if arg_29_1 or not arg_29_0._currentTargetData.finish then
				...
				local var_29_7 = var_8.atan

				math = var_10

				local var_29_8 = var_10.abs(arg_29_0._currentTargetPos.y - arg_29_0._roleTf.anchoredPosition.y)

				math = var_11
				arg_29_0._moveAngle = var_29_7(var_29_8 / var_11.abs(arg_29_0._currentTargetPos.x - arg_29_0._roleTf.anchoredPosition.x))
...
local function var_0_58(arg_33_0, arg_33_1)
	local var_33_0 = {
		ctor = function(arg_34_0)
			...
			local var_34_1 = var_2_10004(arg_34_0._tf, "collider")
			...
			var_1(var_34_0, var_34_1, var_34_2, var_6)
		...
		start = function(arg_36_0)
			...
			if not arg_36_0.loadedFlag then
				...
				var_1(var_0_37, var_0_46, function(arg_37_0)
					...
					local var_37_2 = var_4(arg_36_0._tvTf, "anim")

					typeof = var_3_10005
					Animator = var_7
					var_37_1._tvAnimator = var_2(var_37_2, var_3_10005(var_7))
					GetComponent = var_37_1
					findTF = var_3_10003

					local var_37_3 = var_3_10003(arg_36_0._tvTf, "anim")

					typeof = var_37_2
					DftAniEvent = var_6

					local var_37_4 = var_37_1(var_37_3, var_37_2(var_6))
					...
					var_2(var_37_5, var_5(arg_36_0._tvTf, "collider"), function()
					...
					var_2(var_37_6, var_5(arg_36_0._tf, "posTv"))
		...
		setTvData = function(arg_40_0)
			...
			local var_40_1 = var_2_10002(var_0_56)
			...
			for iter_40_0 = 1, var_40_0 do
				...
				var_2_10011 = arg_40_0.playTvData
				table = var_2_10012
				var_2_10012 = var_2_10012.remove

				local var_40_4 = var_40_1

				math = var_2_10015

				var_2_10009(var_2_10011, var_2_10012(var_40_4, var_2_10015.random(1, #var_40_1)))
			end

			table = var_5

			local var_40_5 = var_5.insert
			local var_40_6 = arg_40_0.playTvData

			table = iter_40_0

			local var_40_7 = iter_40_0.remove
			local var_40_8 = var_40_2

			math = var_2_10011

			var_40_5(var_40_6, var_40_7(var_40_8, var_2_10011.random(1, #var_40_2)))

			table = var_40_5

			local var_40_9 = var_40_5.insert
			local var_40_10 = arg_40_0.playTvData

			table = var_8

			local var_40_11 = var_8.remove
			local var_40_12 = var_40_3

			math = var_11

			var_40_9(var_40_10, var_40_11(var_40_12, var_11.random(1, #var_40_3)))

			local var_40_13 = arg_40_0._tvAnimator

			var_5.Play(var_40_13, arg_40_0.playTvData[arg_40_0.playIndex], -1, 0)
		...
		updateUI = function(arg_44_0)
			...
			if arg_44_0.loadedFlag then
				...
				var_44_0(var_2_10003(arg_44_0._tf, "on"), false)

				setActive = var_44_0
				findTF = var_2_10003

				var_44_0(var_2_10003(arg_44_0._tf, "off"), false)

				if not arg_44_0.tvCanvas then
					GetComponent = var_44_0
					findTF = var_2_10003
					var_2_10003 = var_2_10003(arg_44_0._tvTf, "anim")
					typeof = var_4
					CanvasGroup = var_6
					arg_44_0.tvCanvas = var_44_0(var_2_10003, var_4(var_6))
				end

				var_44_0 = arg_44_0.tvCanvas
				var_44_0.alpha = arg_44_0._active and 1 or 0
			else
				setActive = var_44_0
				findTF = var_2_10003

				var_44_0(var_2_10003(arg_44_0._tf, "on"), arg_44_0._active)

				setActive = var_44_0
				findTF = var_3

				var_44_0(var_3(arg_44_0._tf, "off"), not arg_44_0._active)
			end
...
function var_0_1.showScore(arg_52_0, arg_52_1)
	...
	if #arg_52_0.showScoresPool > 0 then
		table = var_3
		var_52_0 = var_3.remove(arg_52_0.showScoresPool, 1)
	else
		tf = var_3
		Instantiate = var_1_10005
		var_52_0 = var_3(var_1_10005(arg_52_0.showScoreTpl))
		setParent = var_3

		var_3(var_52_0, arg_52_0.sceneFrontContainer)

		GetComponent = var_3
		findTF = var_1_10005
		var_1_10005 = var_1_10005(var_52_0, "anim")
		typeof = var_6
		DftAniEvent = var_8

		local var_52_1 = var_3(var_1_10005, var_6(var_8))

		var_3.SetEndEvent(var_52_1, function()
			for iter_53_0 = #arg_52_0.showScores, 1, -1 do
				if var_52_0 == arg_52_0.showScores[iter_53_0] then
					...
					var_53_0(var_53_1, var_2_10007.remove(arg_52_0.showScores, iter_53_0))
				end
			end
	...
	local var_52_2 = var_1_10005(var_52_0, "anim")
	local var_52_3 = "+"

	tostring = var_7

	var_3(var_52_2, var_52_3 .. var_7(arg_52_1.score))

	local var_52_4 = arg_52_0.uiCam
	local var_52_5 = var_3.ScreenToWorldPoint(var_52_4, arg_52_1.pos)
	local var_52_6 = arg_52_0.sceneFrontContainer

	var_52_0.anchoredPosition = var_4.InverseTransformPoint(var_52_6, var_52_5)
	setActive = var_4
...
function var_0_1.initUI(arg_57_0)
	...
	local var_57_0 = var_3(arg_57_0.countUI, "count")

	typeof = var_4
	Animator = var_6
	arg_57_0.countAnimator = var_1(var_57_0, var_4(var_6))
	GetOrAddComponent = var_1
	findTF = var_57_0
	...
	typeof = var_4
	DftAniEvent = var_6
	arg_57_0.countDft = var_1(var_57_1, var_4(var_6))
	...
	local var_57_5 = var_4(arg_57_0.leaveUI, "ad/btnOk")
	...
	var_1(var_57_4, var_57_5, var_57_6, var_6)
	...
	var_1(var_57_7, var_57_8, var_57_9, var_6)
	...
	local var_57_11 = var_4(arg_57_0.pauseUI, "ad/btnOk")
	...
	var_1(var_57_10, var_57_11, var_57_12, var_6)
	...
	local var_57_14 = var_4(arg_57_0.settlementUI, "ad/btnOver")
	...
	var_1(var_57_13, var_57_14, var_57_15, var_6)
	...
	local var_57_16 = var_3(arg_57_0.menuUI, "battList")

	typeof = var_4
	ScrollRect = var_6
	arg_57_0.battleScrollRect = var_1(var_57_16, var_4(var_6))
	arg_57_0.totalTimes = arg_57_0:getGameTotalTime()

	local var_57_17 = arg_57_0:getGameUsedTimes() - 4 < 0 and 0 or arg_57_0:getGameUsedTimes() - 4

	scrollTo = var_2

	var_2(arg_57_0.battleScrollRect, 0, 1 - var_57_17 / (arg_57_0.totalTimes - 4))

	onButton = var_2

	local var_57_18 = arg_57_0

	findTF = var_5

	local var_57_19 = var_5(arg_57_0.menuUI, "rightPanelBg/arrowUp")

	local function var_57_20()
	...
	var_2(var_57_18, var_57_19, var_57_20, var_7)

	onButton = var_2

	local var_57_21 = arg_57_0

	findTF = var_57_19

	local var_57_22 = var_57_19(arg_57_0.menuUI, "rightPanelBg/arrowDown")

	local function var_57_23()
		local var_65_0
	...
	var_2(var_57_21, var_57_22, var_57_23, var_7)

	onButton = var_2

	local var_57_24 = arg_57_0

	findTF = var_57_22

	local var_57_25 = var_57_22(arg_57_0.menuUI, "btnBack")

	local function var_57_26()
	...
	var_2(var_57_24, var_57_25, var_57_26, var_7)

	onButton = var_2

	local var_57_27 = arg_57_0

	findTF = var_57_25

	local var_57_28 = var_57_25(arg_57_0.menuUI, "btnRule")

	local function var_57_29()
		pg = var_2_10000
		...
		var_67_2.type = var_2_10004

		local var_67_3 = arg_57_0

		var_67_2.helps = var_4.getGameRoomData(var_67_3).game_help
	...
	var_2(var_57_27, var_57_28, var_57_29, var_7)

	onButton = var_2

	local var_57_30 = arg_57_0

	findTF = var_57_28

	local var_57_31 = var_57_28(arg_57_0.menuUI, "btnStart")

	local function var_57_32()
		setActive = var_2_10000
	...
	SFX_CANCEL = var_57_34

	var_2(var_57_30, var_57_31, var_57_32, var_57_34)

	findTF = var_2

	local var_57_33 = var_2(arg_57_0.menuUI, "tplBattleItem")
	...
	for iter_57_0 = 1, 7 do
		...
		local var_57_34 = var_57_34(var_1_10009(var_57_33))

		var_57_34.name = "battleItem_" .. iter_57_0
		setParent = var_8

		local var_57_35 = var_57_34

		findTF = var_11

		var_8(var_57_35, var_11(arg_57_0.menuUI, "battList/Viewport/Content"))

		local var_57_36 = iter_57_0

		GetSpriteFromAtlasAsync = var_1_10009

		var_1_10009("ui/minigameui/" .. var_0_5, "battleDesc" .. var_57_36, function(arg_69_0)
			setImageSprite = var_2_10001
			findTF = var_2_10003

			var_2_10001(var_2_10003(var_57_34, "state_open/buttomDesc"), arg_69_0, true)

			setImageSprite = var_2_10001
			findTF = var_3

			var_2_10001(var_3(var_57_34, "state_clear/buttomDesc"), arg_69_0, true)

			setImageSprite = var_2_10001
			findTF = var_3

			var_2_10001(var_3(var_57_34, "state_current/buttomDesc"), arg_69_0, true)

			setImageSprite = var_2_10001
			findTF = var_3

			var_2_10001(var_3(var_57_34, "state_closed/buttomDesc"), arg_69_0, true)
		...
		var_1_10009(var_57_34, true)

		table = var_1_10009

		var_1_10009.insert(arg_57_0.battleItems, var_57_34)
	end
...
function var_0_1.initGameUI(arg_70_0)
	...
	var_1(var_70_0, var_4(arg_70_0.gameUI, "topRight/btnStop"), function()
	...
	var_1(var_70_1, var_4(arg_70_0.gameUI, "btnLeave"), function()
	...
	Vector2 = var_1_10002
	var_70_2.anchoredPosition = var_1_10002(0, 0)
	...
	local var_70_4 = var_70_2(var_70_3, var_4(var_6))
	local var_70_5
	local var_70_6
...
function var_0_1.initController(arg_76_0)
	...
	findTF = var_1_10003
	arg_76_0.furnitureCtrl = var_76_0(var_1_10003(arg_76_0.sceneContainer, "scene"), arg_76_0)

	local var_76_1 = var_0_53

	findTF = var_3
	arg_76_0.moveRoleCtrl = var_76_1(var_3(arg_76_0.sceneContainer, "scene"), arg_76_0)

	local var_76_2 = var_0_58

	findTF = var_3
	arg_76_0.tvCtrl = var_76_2(var_3(arg_76_0.sceneContainer, "scene/furniture_tv"), arg_76_0)
...
function var_0_1.AddDebugInput(arg_78_0)
	...
	if var_1 then
		...
		if var_78_0(var_1_10003.S) then
			-- block empty
		end
	end
...
function var_0_1.updateMenuUI(arg_79_0)
	...
	for iter_79_0 = 1, #arg_79_0.battleItems do
		...
		var_1_10007(var_1_10009(arg_79_0.battleItems[iter_79_0], "state_open"), false)

		setActive = var_1_10007
		findTF = var_1_10009

		var_1_10007(var_1_10009(arg_79_0.battleItems[iter_79_0], "state_closed"), false)

		setActive = var_1_10007
		findTF = var_1_10009

		var_1_10007(var_1_10009(arg_79_0.battleItems[iter_79_0], "state_clear"), false)

		setActive = var_1_10007
		findTF = var_1_10009

		var_1_10007(var_1_10009(arg_79_0.battleItems[iter_79_0], "state_current"), false)

		if iter_79_0 <= var_79_0 then
			setActive = var_1_10007
			findTF = var_1_10009

			var_1_10007(var_1_10009(arg_79_0.battleItems[iter_79_0], "state_clear"), true)
		elseif iter_79_0 == var_79_0 + 1 and 1 <= var_79_1 then
			setActive = var_1_10007
			findTF = var_1_10009

			var_1_10007(var_1_10009(arg_79_0.battleItems[iter_79_0], "state_current"), true)
		elseif var_79_0 < iter_79_0 and iter_79_0 <= var_79_0 + var_79_1 then
			setActive = var_1_10007
			findTF = var_1_10009

			var_1_10007(var_1_10009(arg_79_0.battleItems[iter_79_0], "state_open"), true)
		else
			setActive = var_1_10007
			findTF = var_1_10009

			var_1_10007(var_1_10009(arg_79_0.battleItems[iter_79_0], "state_closed"), true)
		end
	end
	...
	var_5(var_7(arg_79_0.menuUI, "btnStart/tip"), var_79_1 > 0)
	arg_79_0:CheckGet()
...
function var_0_1.CheckGet(arg_80_0)
	...
	var_1_10001(var_1_10003(arg_80_0.menuUI, "got"), false)
	...
	if arg_80_0:getUltimate() == 0 then
		...
		if arg_80_0.getGameTotalTime(var_80_1) > arg_80_0:getGameUsedTimes() then
			return
		end

		pg = var_80_1

		local var_80_2 = var_80_1.m02
		local var_80_3 = var_3.sendNotification

		GAME = var_6

		local var_80_4 = var_6.SEND_MINI_GAME_OP
		local var_80_5 = {
			hubid = arg_80_0:GetMGHubData().id
		}

		MiniGameOPCommand = var_8
		var_80_5.cmd = var_8.CMD_ULTIMATE
		var_80_5.args1 = {}

		var_80_3(var_80_2, var_80_4, var_80_5)

		setActive = var_80_3
		findTF = var_80_2

		var_80_3(var_80_2(arg_80_0.menuUI, "got"), true)
	end
...
function var_0_1.openMenuUI(arg_81_0)
	...
	var_1_10001(var_1_10003(arg_81_0.sceneContainer, "scene_front"), false)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_81_0.sceneContainer, "scene_background"), false)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_81_0.sceneContainer, "scene"), false)
...
function var_0_1.gameStart(arg_84_0)
	...
	var_1_10001(var_1_10003(arg_84_0.sceneContainer, "scene_front"), true)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_84_0.sceneContainer, "scene_background"), true)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_84_0.sceneContainer, "scene"), true)
	...
	for iter_84_0 = #arg_84_0.showScores, 1, -1 do
		...
		if not var_84_0.contains(arg_84_0.showScoresPool, arg_84_0.showScores[iter_84_0]) then
			table = var_84_0
			var_84_0 = var_84_0.remove(arg_84_0.showScores, iter_84_0)
			table = var_6

			var_6.insert(arg_84_0.showScoresPool, var_84_0)
		end
	end
	...
	for iter_84_1 = #arg_84_0.showScoresPool, 1, -1 do
		...
		var_84_0(arg_84_0.showScoresPool[iter_84_1], false)
	end
...
function var_0_1.updateGameUI(arg_96_0)
	...
	var_1_10001(var_96_0, var_4.ceil(arg_96_0.gameTime))

	local var_96_1 = arg_96_0.sceneContainer

	Vector2 = var_1_10002
	var_96_1.anchoredPosition, arg_96_0.velocityXSmoothing = var_1_10002.SmoothDamp(arg_96_0.sceneContainer.anchoredPosition, arg_96_0.offsetPosition, arg_96_0.velocityXSmoothing, var_0_42)
...
function var_0_1.onGameOver(arg_98_0)
	...
	local var_98_1 = var_3(arg_98_0._tf)
	local var_98_2 = 0.1

	System = var_5

	var_98_0(var_98_1, var_98_2, var_5.Action(function()
...
function var_0_1.showSettlement(arg_100_0)
	...
	local var_100_0 = var_3(arg_100_0.settlementUI, "ad")

	typeof = var_4
	Animator = var_6

	local var_100_1 = var_1_10001(var_100_0, var_4(var_6))

	var_1.Play(var_100_1, "settlement", -1, 0)

	local var_100_2 = arg_100_0.scoreNum

	getProxy = var_100_0
	GameRoomProxy = var_5

	local var_100_3 = var_100_0(var_5)
	local var_100_4 = var_3.getRoomScore(var_100_3, arg_100_0:getGameRoomData().id)

	setActive = var_100_1
	findTF = var_6

	var_100_1(var_6(arg_100_0.settlementUI, "ad/new"), var_100_4 < var_100_2)

	if var_100_4 <= var_100_2 then
		var_100_4 = var_100_2
	...
	local var_100_5 = var_100_1(arg_100_0.settlementUI, "ad/highText")

	findTF = var_100_3

	local var_100_6 = var_100_3(arg_100_0.settlementUI, "ad/currentText")

	setText = var_6

	var_6(var_100_5, var_100_4)

	setText = var_6

	var_6(var_100_6, var_100_2)

	arg_100_0.sendSuccessFlag = true

	arg_100_0:SendSuccess(var_100_2)
...
function var_0_1.willExit(arg_104_0)
	if arg_104_0.handle then
		...
		var_1.RemoveListener(var_1_10003, arg_104_0.handle)
	end
	...
	if arg_104_0._tf then
		...
		if var_104_0(var_1_10003(arg_104_0._tf)) then
			LeanTween = var_1
