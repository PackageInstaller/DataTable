...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_3 = var_1_2(var_1_1, var_7.FRONT_ROAD_NAME)
	...
	CrossRoadGameConst = var_7
	arg_1_0.frontRoadList = var_1_5(var_1_4, var_7.FRONT_ROAD_NAME)
	arg_1_0.joyData = {
		go = false,
		stop = false,
		left = false,
	...
	var_2.SetActionCallBack(var_2_2, function(arg_3_0)
		if arg_3_0 == "finish" then
			...
			if var_3_0 == var_2_10002.PLAYER_STATE.crash then
				...
				var_1.SetAction(var_3_1, "recover2", 0)

				local var_3_2 = arg_2_0

				CrossRoadGameConst = var_2_10002
				var_3_2.state = var_2_10002.PLAYER_STATE.recover
		...
		if arg_3_0 == "action" then
			local var_3_3 = arg_2_0.state

			CrossRoadGameConst = var_2_10002

			if var_3_3 == var_2_10002.PLAYER_STATE.recover then
				local var_3_4 = arg_2_0

				CrossRoadGameConst = var_2
				var_3_4.state = var_2.PLAYER_STATE.normal
				arg_2_0.carshChangePos = true

				local var_3_5 = arg_2_0

				var_1.setActionNormal(var_3_5)
...
function var_0_0.PlayZhihuiHit(arg_11_0)
	...
	var_11_1(var_11_0, var_1_10004.PLAYER_STATE.crash, 0)
...
function var_0_0.CheckAndClearBin(arg_12_0)
	...
	for iter_12_0 = var_12_1, var_1_10002.GAME_TRACK_COUNT do
		if arg_12_0.itemList[iter_12_0] ~= nil then
			...
			if var_12_2 == var_1_10006.BING_MIAN then
				...
				if var_12_2.CheckPlayerInItem(var_12_3, arg_12_0._tf, arg_12_0.itemList[iter_12_0].go) then
					local var_12_4 = arg_12_0._event

					CrossRoadGameConst = var_12_3

					var_12_4(var_12_3.DISPOSE_BIN, iter_12_0)
				end
			end
		end
	end
