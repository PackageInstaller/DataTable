...
local function var_0_1(arg_1_0)
	...
	while true do
		...
		for iter_1_2, iter_1_3 in var_8(arg_1_0) do
			if var_1_0[arg_1_0] == nil or var_1_0[arg_1_0] <= var_1_10007 then
				...
				if var_1_10014(iter_1_2) ~= "number" then
					type = var_1_10014

					if var_1_10014(iter_1_2) == "boolean" then
						var_1_10014 = "["
						tostring = var_1_10015
						var_1_5 = var_1_10014 .. var_1_10015(iter_1_2) .. "]"
					else
						var_1_10014 = "['"
						tostring = var_1_10015
						var_1_5 = var_1_10014 .. var_1_10015(iter_1_2) .. "']"
					...
					if var_1_10014(iter_1_3) ~= "number" then
						type = var_1_10014

						local var_1_6

						if var_1_10014(iter_1_3) == "boolean" then
							var_1_10014 = var_1_4
							string = var_1_10015
							...
							tostring = var_18
							var_1_4 = var_1_10014 .. var_1_10015 .. var_1_6 .. var_1_7 .. var_18(iter_1_3)
						else
							type = var_1_10014

							if var_1_10014(iter_1_3) == "table" then
								var_1_10014 = var_1_4
								string = var_1_10015
								var_1_4 = var_1_10014 .. var_1_10015.rep("\t", var_1_3) .. var_1_5 .. " = {\n"
								table = var_1_10014

								var_1_10014.insert(var_1_1, arg_1_0)

								table = var_1_10014

								var_1_10014.insert(var_1_1, iter_1_3)
								...
								tostring = var_18
								var_1_4 = var_1_10014 .. var_1_10015 .. var_1_6 .. var_1_8 .. var_18(iter_1_3) .. "'"
							end
						end
						...
						if var_1_10007 == var_1_10006 then
							...
							var_1_10015 = "\n"
							string = var_1_6
							var_1_4 = var_1_10014 .. var_1_10015 .. var_1_6.rep("\t", var_1_3 - 1) .. "}"
						else
							var_1_4 = var_1_4 .. ","
						end
						...
						if var_1_10007 == var_1_10006 then
							...
							var_1_10014 = "\n"
							string = var_1_10015
							var_1_4 = var_1_9 .. var_1_10014 .. var_1_10015.rep("\t", var_1_3 - 1) .. "}"
						end
		...
		if var_1_10006 == 0 then
			...
			string = var_10
			var_1_4 = var_1_10 .. var_1_11 .. var_10.rep("\t", var_1_3 - 1) .. "}"
		end
	...
	local var_1_12 = var_6.concat(var_1_2)
...
function var_0_0.createLayerData(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	for iter_11_0 = 1, #arg_11_1 do
		...
		if arg_11_0:relationTile(var_11_1, arg_11_2, arg_11_3, var_11_2) and var_11_1 ~= 0 then
			table = var_1_10012

			var_1_10012.insert(var_11_0, var_11)
		end
	end
