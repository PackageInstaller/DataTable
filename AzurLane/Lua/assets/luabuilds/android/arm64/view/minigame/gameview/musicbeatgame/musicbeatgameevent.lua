...
this.TRACK_TRIGGER = "track trigger"
this.TRACK_REMOVE = "track remove"
this.KEY_CODE_DOWN = "key code down"
this.TRACK_EVENT_MATCH = "track event match"
