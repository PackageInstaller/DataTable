...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.leftListener = var_3(var_1_0, var_6(var_1_10008))
	GetComponent = var_3
	...
	typeof = var_6
	EventTriggerListener = var_1_10008
	arg_1_0.rightListener = var_3(var_1_1, var_6(var_1_10008))
	findTF = var_3
	...
	local function var_1_6()
		if not var_0_1.startSettlement then
			...
			TouchCakeGameEvent = var_2_10003
			...
			TouchCakeGameEvent = var_3

			var_4_3(var_4_2, var_3.OPEN_LEVEL_UI)
		end
	...
	var_3(var_1_4, var_1_5, var_1_6, var_1_10008)
	...
	local function var_1_9()
		if not var_0_1.startSettlement then
			...
			var_5_1(var_5_0, var_2_10003.PAUSE_GAME, true)
			...
			var_5_3(var_5_2, var_3.OPEN_PAUSE_UI)
		end
	...
	var_3(var_1_7, var_1_8, var_1_9, var_1_10008)
...
function var_0_0.updateCombo(arg_10_0)
	...
	local var_10_1 = var_1_10001(var_10_0, var_4(var_1_10006))
...
function var_0_0.step(arg_12_0, arg_12_1)
	...
	if var_12_1 < 10 then
		...
		if not (var_12_3 .. var_6(var_12_1)) then
			tostring = var_12_3
