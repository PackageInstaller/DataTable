...
local function var_0_16(arg_1_0, arg_1_1)
	local var_1_0 = {
		ctor = function(arg_2_0)
			...
			local var_2_0 = var_2_10003(arg_2_0._tf, "ad/anim")

			typeof = var_2_10004
			Animator = var_6
			arg_2_0._animator = var_1(var_2_0, var_2_10004(var_6))
			findTF = var_1
			arg_2_0.angleTf = var_1(arg_2_0._tf, "ad/angle")
			GetComponent = var_1
			findTF = var_3

			local var_2_1 = var_3(arg_2_0._tf, "ad/angle/left")

			typeof = var_4

			local var_2_2 = var_1(var_2_1, var_4("UnityEngine.PolygonCollider2D"))
			...
			local var_2_4 = var_1(var_2_3, var_4("UnityEngine.PolygonCollider2D"))
		...
		setBuff = function(arg_4_0, arg_4_1)
			...
			if arg_4_0.buffType then
				...
				for iter_4_0 = 0, arg_4_0.buffIcon.childCount - 1 do
					...
					var_2_10007 = var_2_10007.GetChild(var_4_1, iter_4_0)
					setActive = var_2_10008

					var_2_10008(var_2_10007, var_2_10007.name == var_4_0)
				end
			else
				for iter_4_1 = 0, arg_4_0.buffIcon.childCount - 1 do
					local var_4_2 = arg_4_0.buffIcon
					local var_4_3 = var_6.GetChild(var_4_2, iter_4_1)

					setActive = var_2_10007

					var_2_10007(var_4_3, false)
				end
			end
		...
		checkWorldInCircle = function(arg_20_0, arg_20_1)
			...
			local var_20_2 = var_2_10003.abs(var_20_1.x - arg_20_0.circlePos.x)
			...
			if not (150 <= var_20_2) then
				...
				local var_20_6 = var_6.pow(var_20_1.x - arg_20_0.circlePos.x, 2)

				math = var_2_10007

				if var_20_5(var_20_6 + var_2_10007.pow(var_20_1.y - arg_20_0.circlePos.y, 2)) < var_0_5 then
					return true
				end
		...
		checkWorldInRect = function(arg_21_0, arg_21_1)
			...
			local var_21_3 = var_21_0.sqrt

			math = var_2_10006

			local var_21_4 = var_2_10006.pow(var_21_1.x - arg_21_0.circlePos.x, 2)

			math = var_2_10007

			local var_21_5 = var_21_3(var_21_4 + var_2_10007.pow(var_21_1.y - arg_21_0.circlePos.y, 2))
		...
		setTimeRemove = function(arg_23_0)
			...
			var_23_1(var_23_0, var_2_10004.SFX_ENEMY_REMOVE)

			local var_23_2 = arg_23_0
			local var_23_3 = arg_23_0.getBuff

			LaunchBallGameConst = var_4

			if var_23_3(var_23_2, var_4.enemy_buff_boom) then
		...
		playEffectAnim = function(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
			...
			local var_24_2 = var_2_10005(var_24_1, var_8(var_2_10010))
...
function var_0_0.Ctor(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4)
	...
	arg_33_0.enemyDatas = {}
	pairs = var_5
	LaunchBallGameConst = var_7

	for iter_33_0, iter_33_1 in var_5(var_7.enemy_data) do
		LoadAny = var_1_10010
		LaunchBallGameVo = var_1_10012
		var_1_10012 = var_1_10012.ui_atlas

		local var_33_0 = iter_33_1.name

		typeof = var_1_10014
		RuntimeAnimatorController = var_1_10016
		var_1_10010 = var_1_10010(var_1_10012, var_33_0, var_1_10014(var_1_10016))
		table = var_1_10011
	...
	Clone = var_5
	LaunchBallGameConst = var_7
	arg_33_0.enemyRule = var_5(var_7.enemy_create_rule)
	arg_33_0.enemysList = {}
	arg_33_0.enemyPool = {}
	findTF = var_5
...
function var_0_0.start(arg_34_0)
	...
	arg_34_0.roundDatas = var_34_1(var_3.round_enemy[arg_34_0.gameRoundData.round_enemy])
	Clone = var_1
	LaunchBallGameConst = var_3
	arg_34_0.lineData = var_1(var_3.map_data[arg_34_0.gameRoundData.map])
	Clone = var_1
	LaunchBallGameConst = var_3
	arg_34_0.enemyBuffs = var_1(var_3.enemy_round_buff[arg_34_0.gameRoundData.enemy_buff])
	...
	for iter_34_0, iter_34_1 in var_1(arg_34_0.enemysList) do
		for iter_34_2 = #iter_34_1, 1, -1 do
			...
			var_34_3(var_34_2, var_1_10013.remove(iter_34_1, iter_34_2))
		end
	end
	...
	if var_1(arg_34_0.lineTf, "ad/points") then
		var_34_4 = arg_34_0:createPoints(var_1)
		table = var_3

		var_3.insert(arg_34_0.pointsList, var_34_4)
	...
	if var_34_4(arg_34_0.lineTf, "ad/points1") then
		local var_34_5 = arg_34_0:createPoints(var_2)

		table = var_4

		var_4.insert(arg_34_0.pointsList, var_34_5)
...
function var_0_0.updateEnemyData(arg_36_0)
	...
	for iter_36_1 = 1, #arg_36_0.enemysList do
		if arg_36_0.enemysList[iter_36_1] then
			local var_36_3 = #var_7

			if 0 < var_36_3 then
				local var_36_4 = var_7[#var_7]
				local var_36_5 = var_8.getDistance(var_36_4)

				table = var_9

				local var_36_6 = var_9.insert
				local var_36_7 = var_36_1

				math = var_1_10012

				var_36_6(var_36_7, var_1_10012.floor(var_36_5 / arg_36_0.lastPointDistance[iter_36_1] * 10))
			end
		end
	end
	...
	for iter_40_0, iter_40_1 in var_1_10001(arg_40_0.enemysList) do
		...
		for iter_40_2 = #iter_40_1, 1, -1 do
			...
			if var_11.getRemoveFlag(var_40_2) then
				...
				var_40_5(var_40_4, var_1_10015.remove(iter_40_1, iter_40_2))
	...
	if arg_40_0.timeRemoveAll then
		...
		if 0 < var_40_7 then
			...
			if arg_40_0.timeRemoveAll <= 0 then
				...
				for iter_40_3, iter_40_4 in var_2(arg_40_0.enemysList) do
					for iter_40_5 = #iter_40_4, 1, -1 do
						...
						if not var_11.getRemoveFlag(var_40_10) then
							...
							var_40_12(var_15.SPILT_ENEMY_SCORE, {
								num = var_40_11
							})
						end
					end
				...
				var_40_13(var_4.result_skill_count, var_40_9)
...
function var_0_0.appearEnemyBuff(arg_41_0, arg_41_1, arg_41_2, arg_41_3, arg_41_4)
	...
	if arg_41_1 == var_1_10006.enemy_buff_slow then
		...
		LaunchBallPlayerControl = var_1_10008

		if var_41_1(var_1_10008.buff_time_max) then
			arg_41_0.slowTime = arg_41_0.slowTime * 1.5
			LaunchBallGameVo = var_41_1
			var_41_1 = var_41_1.AddGameResultData
			LaunchBallGameVo = var_1_10008

			var_41_1(var_1_10008.result_use_pass_skill, 1)
		...
		if arg_41_1 == var_41_1.enemy_buff_back then
			...
			if var_41_2(var_1_10008.buff_time_max) then
				arg_41_0.backEnemyTime = arg_41_0.backEnemyTime * 1.3
				LaunchBallGameVo = var_41_2
				var_41_2 = var_41_2.AddGameResultData
				LaunchBallGameVo = var_1_10008

				var_41_2(var_1_10008.result_use_pass_skill, 1)
			end
		else
			...
			if arg_41_1 == var_41_2.enemy_buff_boom then
				var_1_10008 = arg_41_3
				var_41_3 = arg_41_3.getDistance(var_1_10008)

				local var_41_4 = var_41_0.distance

				for iter_41_0 = 1, #arg_41_4 do
					local var_41_5 = arg_41_4[iter_41_0]

					if not var_12.getRemoveFlag(var_41_5) then
						math = var_12

						local var_41_6 = var_12.abs
						local var_41_7 = arg_41_4[iter_41_0]

						if var_41_4 >= var_41_6(var_14.getDistance(var_41_7) - var_41_3) then
							local var_41_8 = arg_41_4[iter_41_0]

							var_13.setTimeRemove(var_41_8)

							LaunchBallGameVo = var_13

							local var_41_9 = var_13.GetScore(1, 1)
							local var_41_10 = arg_41_0._eventCall

							LaunchBallGameScene = var_16

							var_41_10(var_16.SPILT_ENEMY_SCORE, {
								num = var_41_9
							})
						end
					end
				...
				if arg_41_1 == var_41_3.enemy_buff_concentrate then
					local var_41_11 = arg_41_0._eventCall

					LaunchBallGameScene = var_1_10008

					var_41_11(var_1_10008.CONCENTRATE_TRIGGER, var_41_0)
				end
			end
		end
	end
		...
		for iter_43_2 = 1, #iter_43_1 do
			...
			if iter_43_2 <= #iter_43_1 - 1 then
				...
				if var_12.getDistance(var_43_2) > var_0_6 then
					...
					var_1_10016 = var_43_1

					if var_43_3 - var_43_1.getDistance(var_1_10016) < var_0_6 - var_0_14 then
			...
			for iter_43_3 = 1, #iter_43_1 do
				if var_43_0 <= iter_43_3 then
					...
					if var_12.getDistance(var_43_5) - var_43_4:getDistance() < var_0_6 - var_0_14 then
						...
						var_43_7(var_43_6, var_43_8 * var_1_10016.deltaTime)
					else
						break
					end
				end
			...
			if var_44_0 ~= 0 then
				...
				for iter_44_3 = 1, #iter_44_1 do
					if iter_44_3 == var_44_0 then
						...
						var_44_9(var_44_8, var_44_10 * var_1_10015.deltaTime)
					elseif var_44_0 < iter_44_3 then
						...
						if var_44_12 - var_12.getDistance(var_44_13) < var_0_6 + var_0_14 then
							...
							var_44_15(var_44_14, var_44_16 * var_1_10015.deltaTime)
				...
				if var_12.getSplitFlag(var_46_1) then
					...
					if var_46_3 >= 3 or var_46_4 then
						...
						if arg_46_0.splitFireIndex and arg_46_0.splitFireIndex + 1 >= arg_46_0.fireIndex then
							...
							local var_46_7 = var_17.AddGameResultData

							LaunchBallGameVo = var_46_6

							var_46_7(var_46_6.result_series_count, 1)
						...
						if arg_46_0.amuletOverFlag then
							...
							local var_46_8 = var_17.AddGameResultData

							LaunchBallGameVo = var_46_6

							var_46_8(var_46_6.result_over_count, 1)
						end
...
function var_0_0.checkEnemyFinal(arg_47_0)
	...
	if arg_47_0:checkTargetScore() then
		...
		for iter_47_0, iter_47_1 in var_1_10002(arg_47_0.enemysList) do
			var_47_0 = var_47_0 + #iter_47_1
		end

		if var_47_0 == 0 then
			local var_47_1 = arg_47_0._eventCall

			LaunchBallGameScene = var_4

			var_47_1(var_4.ENEMY_FINISH)
	...
	for iter_47_2, iter_47_3 in var_47_0(arg_47_0.enemysList) do
		if iter_47_3 and #iter_47_3 > 0 then
			local var_47_2 = iter_47_3[#iter_47_3]

			if var_6.getFinish(var_47_2) then
				local var_47_3 = arg_47_0._eventCall

				LaunchBallGameScene = var_47_2

				var_47_3(var_47_2.ENEMY_FINISH)
...
function var_0_0.updateEnemyVo(arg_48_0)
	...
	for iter_48_0, iter_48_1 in var_1_10002(arg_48_0.enemysList) do
		for iter_48_2 = 1, #iter_48_1 do
			...
			if not var_1_10012.contains(var_48_0, var_48_2) then
				table = var_1_10012

				var_1_10012.insert(var_48_0, var_48_2)

				var_1_10012 = #var_48_0
				LaunchBallGameConst = var_48_1

				if var_1_10012 >= var_48_1.color_total then
					LaunchBallGameVo = var_1_10012
					var_1_10012.enemyColors = var_48_0
...
function var_0_0.updateGameResultSplitCount(arg_49_0, arg_49_1, arg_49_2)
	...
	var_49_0(var_1_10005.result_split_count, 1)
	...
	if 1 < arg_49_2 then
		...
		var_49_1(var_5.result_series_count, 1)
		...
		var_49_2(var_5.result_mix_count, 1)
	end
	...
	if 3 < arg_49_1 then
		...
		var_49_3(var_5.result_many_count, 1)
	end
...
function var_0_0.checkSplit(arg_50_0, arg_50_1, arg_50_2)
	...
	if var_50_4 then
		...
		if arg_50_0._eventCall then
			...
			LaunchBallGameScene = var_13

			var_50_12(var_13.SPILT_ENEMY_SCORE, {
				split = true,
				num = var_50_11,
				count = var_50_2
			})
			...
			LaunchBallPlayerControl = var_13

			if var_50_13(var_13.buff_time_max) and arg_50_0.enemyStopTime and arg_50_0.enemyStopTime > 0 then
				LaunchBallGameVo = var_11

				local var_50_14 = var_11.AddGameResultData

				LaunchBallGameVo = var_13

				var_50_14(var_13.result_skill_count, var_50_2)
			end
		end
...
function var_0_0.createPoints(arg_51_0, arg_51_1)
	...
	for iter_51_0, iter_51_1 in var_6(var_51_3) do
		Vector2 = var_1_10011
		var_1_10011 = var_1_10011(0, 0)
		Vector2 = var_1_10012
		var_1_10012 = var_1_10012(0, 0)

		local var_51_4 = 0
		local var_51_5 = 0

		if iter_51_0 > 1 then
			local var_51_6 = var_51_3[iter_51_0 - 1]
			local var_51_7 = var_51_3[iter_51_0]

			math = var_1_10017
			var_1_10017 = var_1_10017.sqrt
			math = var_1_10019
			var_1_10019 = var_1_10019.pow(var_51_7.x - var_51_6.x, 2)
			math = var_1_10020
			var_51_1 = var_51_1 + var_1_10017(var_1_10019 + var_1_10020.pow(var_51_7.y - var_51_6.y, 2))
		end

		local var_51_8

		if iter_51_0 < #var_51_3 then
			var_51_8 = var_51_3[iter_51_0]

			local var_51_9 = var_51_3[iter_51_0 + 1]

			math = var_1_10017
			var_1_10017 = var_1_10017.atan
			math = var_1_10019
			var_1_10019 = var_1_10019.abs(var_51_9.y - var_51_8.y)
			math = var_1_10020

			local var_51_10 = var_1_10017(var_1_10019 / var_1_10020.abs(var_51_9.x - var_51_8.x))

			math = var_1_10017
			var_1_10017 = var_1_10017.atan2(var_51_9.y - var_51_8.y, var_51_9.x - var_51_8.x)
			math = var_1_10018
			var_51_5 = var_1_10017 * var_1_10018.rad2Deg
			var_1_10017 = var_51_9.x
			var_1_10017 = var_51_8.x < var_1_10017 and 1 or -1
			var_1_10018 = var_51_9.y
			var_1_10018 = var_51_8.y < var_1_10018 and 1 or -1
			var_1_10012.x = var_1_10017
			var_1_10012.y = var_1_10018
			math = var_1_10019
			var_1_10011.x = var_1_10019.cos(var_51_10) * var_1_10017
			math = var_1_10019
			var_1_10011.y = var_1_10019.sin(var_51_10) * var_1_10018
		elseif iter_51_0 == #var_51_3 then
			var_51_8 = var_51_3[iter_51_0 - 1]

			local var_51_11 = var_51_3[iter_51_0]

			math = var_1_10017
			var_1_10017 = var_1_10017.atan
			math = var_1_10019
			var_1_10019 = var_1_10019.abs(var_51_11.y - var_51_8.y)
			math = var_1_10020

			local var_51_12 = var_1_10017(var_1_10019 / var_1_10020.abs(var_51_11.x - var_51_8.x))

			math = var_1_10017
			var_1_10017 = var_1_10017.atan2(var_51_11.y - var_51_8.y, var_51_11.x - var_51_8.x)
			math = var_1_10018
			var_51_5 = var_1_10017 * var_1_10018.rad2Deg
			var_1_10017 = var_51_11.x
			var_1_10017 = var_51_8.x < var_1_10017 and 1 or -1
			var_1_10018 = var_51_11.y
			var_1_10018 = var_51_8.y < var_1_10018 and 1 or -1
			var_1_10012.x = var_1_10017
			var_1_10012.y = var_1_10018
			math = var_1_10019
			var_1_10011.x = var_1_10019.cos(var_51_12) * var_1_10017
			math = var_1_10019
			var_1_10011.y = var_1_10019.sin(var_51_12) * var_1_10018
		end

		table = var_51_8

		var_51_8.insert(var_51_0, {
			pos = iter_51_1,
			distance = var_51_1,
			move = var_1_10011,
			direct = var_1_10012,
...
function var_0_0.getEnemyBuff(arg_54_0)
	...
	for iter_54_0 = 1, #arg_54_0.enemyBuffs.buffs do
		...
		if var_54_3 == var_1_10009.enemy_buff_back then
			var_1_10010 = arg_54_0

			local var_54_4 = arg_54_0.getEnemyByBuff

			LaunchBallGameConst = var_1_10011

			if var_54_4(var_1_10010, var_1_10011.enemy_buff_slow) then
				var_54_2 = false
			end
		else
			...
			if var_54_5 == var_1_10009.enemy_buff_slow then
				...
				if var_54_6(var_1_10010, var_1_10011.enemy_buff_back) then
					var_54_2 = false
				end
			end
		end
		...
		if var_54_2 then
			...
			LaunchBallPlayerControl = var_1_10012

			if var_1_10010(var_1_10012.buff_time_max) then
...
function var_0_0.getOrCreateEnemy(arg_56_0)
	...
	if 0 < var_56_1 then
		...
		local var_56_2 = var_56_1(var_1_10004(arg_56_0._enemyTpl))
...
function var_0_0.getEnemyDataByRule(arg_60_0)
	if not arg_60_0.currentEnemyRule then
		var_1_10003 = arg_60_0
		arg_60_0.currentEnemyRule = arg_60_0.getEnemyRule(var_1_10003)
	end

	if #var_0_1 > 0 then
		var_1_10003 = arg_60_0

		local var_60_0 = arg_60_0.getEnemyById

		table = var_1_10004

		return var_60_0(var_1_10003, var_1_10004.remove(var_0_1, 1))
	end
	...
	if arg_60_0.currentEnemyRule then
		...
		if arg_60_0.currentEnemyRule.single then
			var_60_1 = arg_60_0.currentEnemyRule.singleId
		else
			local var_60_2 = arg_60_0.currentEnemyRule.enemys

			math = var_1_10003
			var_60_1 = var_60_2[var_1_10003.random(1, #arg_60_0.currentEnemyRule.enemys)]
		end
		...
		return arg_60_0:getEnemyById(var_60_1)
	end
				...
				if arg_66_1.concentrate then
					...
					if not var_17.getTimeRemove(var_66_7) then
						...
						if arg_66_0._eventCall then
							...
							local var_66_10 = arg_66_0._eventCall

							LaunchBallGameScene = var_20

							var_66_10(var_20.SPILT_ENEMY_SCORE, {
								num = var_66_9
							})
						end
						...
						local var_66_11 = var_66_9.GetBuff

						LaunchBallPlayerControl = var_66_8

						if var_66_11(var_66_8.buff_time_max) and arg_66_0.enemyStopTime and arg_66_0.enemyStopTime > 0 then
							LaunchBallGameVo = var_17

							local var_66_12 = var_17.AddGameResultData

							LaunchBallGameVo = var_19

							var_66_12(var_19.result_skill_count, 1)
						end
					end
					...
					local var_66_15 = arg_66_0
					local var_66_16 = arg_66_0.createEnemy(var_66_15, iter_66_0, var_66_14, arg_66_0.pointsList[iter_66_0], arg_66_0.enemysList[iter_66_0], var_66_13)

					var_19.setSplitFlag(var_66_16, true)
					var_19:playAnimation("Spawn")

					local var_66_17 = arg_66_0:getBackBuff()

					LaunchBallGameConst = var_66_15

					local var_66_18 = arg_66_1[var_66_15.amulet_buff_back]

					if var_66_17 or var_66_18 then
						local var_66_19 = arg_66_0
						local var_66_20 = arg_66_0.setBackTime

						LaunchBallPlayerControl = var_25

						var_66_20(var_66_19, var_25.buff_amulet_back_time, #var_9, var_0_9)
					end
