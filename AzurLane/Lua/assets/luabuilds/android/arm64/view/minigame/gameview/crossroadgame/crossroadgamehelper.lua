...
function var_0_0.IsRectCross(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5, arg_1_6, arg_1_7, arg_1_8)
	...
	if var_1_0 <= var_1_10010.min(arg_1_3, arg_1_7) then
		math = var_1_0
...
function var_0_0.WeightCarRandom(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10002(var_1_10004.crossroad_ship.all) do
		pg = var_1_10007
	...
	for iter_13_2, iter_13_3 in var_13_1(var_5.crossroad_ship.all) do
		pg = var_1_10008
...
function var_0_0.CheckRoleInItem(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_5, var_15_6 = arg_15_0.GetPosByTf(var_15_4, arg_15_2.go)

	math = var_15_4

	local var_15_7 = var_15_4.max(var_15_0, var_15_5)

	math = var_10

	return var_15_7 <= var_10.min(var_15_2, var_15_6)
end
...
function var_0_0.CheckPlayerInItem(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_3, var_16_4 = arg_16_0.GetPosByTf(var_16_2, arg_16_2)

	math = var_16_2

	local var_16_5 = var_16_2.max(var_16_0, var_16_3)

	math = var_8

	return var_16_5 <= var_8.min(var_16_1, var_16_4)
end
...
function var_0_0.GetAddNum(arg_18_0)
	...
	local var_18_1 = var_18_0(var_1_10003.floor(arg_18_0 / 10))

	tostring = var_1_10002

	return var_18_1 .. var_1_10002(arg_18_0 % 10) .. " "
end
