...
function var_0_1.PackData(arg_17_0)
	...
	local var_17_3 = var_1_10005(var_1_10007)
	local var_17_4, var_17_5, var_17_6 = var_17_2(var_5.getRoomScore(var_17_3, arg_17_0:getGameRoomData().id))

	print = var_1_10006

	var_1_10006(var_17_4, "-", var_17_5)
