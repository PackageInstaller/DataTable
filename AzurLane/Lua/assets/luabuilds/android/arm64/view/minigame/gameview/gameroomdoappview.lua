...
local var_0_0 = "GameRoomDOAPPView"
...
function var_0_1.initPageUI(arg_3_0)
	...
	local var_3_2 = var_4.Find(var_3_1, "main/btn_help")
	...
	local function var_3_3()
		...
		pg = var_2_10004
		var_4_2.helps = var_2_10004.gametip.doa_minigame_help.tip
	...
	local var_3_8 = var_5.Find(var_3_7, "main/btn_start")
	...
	local function var_3_9()
		...
		if var_2_10001(var_3_5, {
			...
			var_2_10002.insert(var_5_0, function(arg_6_0)
				pg = var_3_10001
		...
		var_2_10002(var_5_0, function()
			...
			var_0.openCoinLayer(var_7_1, false)
	...
	var_1_10002(var_3_6, var_3_8, var_3_9, var_3_7)
	...
	local var_3_13 = var_3_11
	local var_3_14 = var_3_11.Find(var_3_13, "btn_back")
	...
	local function var_3_15()
		...
		var_0.openCoinLayer(var_8_1, true)

		local var_8_2 = arg_3_0

		var_0.openCoinLayer(var_8_2, true)
	...
	var_3_4(var_3_12, var_3_14, var_3_15, var_3_13)

	onButton = var_3_4

	local var_3_16 = arg_3_0
	local var_3_17 = var_3_11
	local var_3_18 = var_3_11.Find(var_3_17, "btn/confirm")
	...
	SFX_CONFIRM = var_3_17

	var_3_4(var_3_16, var_3_18, var_3_19, var_3_17)

	eachChild = var_3_4

	var_3_4(var_3_11:Find("content"), function(arg_10_0)
		setText = var_2_10001

		local var_10_0 = arg_10_0:Find("name/Text")

		i18n = var_2_10004

		var_2_10001(var_10_0, var_2_10004("doa_minigame_" .. arg_10_0.name))
		...
		local function var_10_3(arg_11_0)
			if arg_11_0 then
				...
				var_11_0(var_3.Find(var_11_1, arg_10_0.name), {
					x = 70
				})
				...
				var_11_0(var_3.Find(var_11_2, arg_10_0.name .. "/Image"), "Win")
			else
				local var_11_3
				...
				var_11_3(var_3.Find(var_11_4, arg_10_0.name), {
					x = 110
				})
				...
				var_11_3(var_3.Find(var_11_5, arg_10_0.name .. "/Image"), "Idle")
			end
		...
		var_2_10001(var_10_1, var_10_2, var_10_3, var_6)
...
local function var_0_2(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	local var_12_0 = arg_12_0:Find("name/Text")

	i18n = var_7

	var_1_10004(var_12_0, var_7("doa_minigame_" .. arg_12_1))
	...
	var_1_10004(arg_12_0:Find("point"), function(arg_15_0)
		...
		var_2_10001(var_15_0, var_2_10004(arg_15_0.name) <= arg_12_2)
...
function var_0_1.initOpenUISwich(arg_16_0)
	...
	function arg_16_0.openSwitchDic.result()
		...
		local var_17_2 = var_2.Find(var_17_1, "result/window/self")
		local var_17_3 = arg_16_0.gameController

		var_17_0(var_17_2, var_3.GetResultInfo(var_17_3, false))

		local var_17_4 = var_0_2
		local var_17_5 = arg_16_0.rtTitlePage
		local var_17_6 = var_2.Find(var_17_5, "result/window/other")
		local var_17_7 = arg_16_0.gameController

		var_17_4(var_17_6, var_3.GetResultInfo(var_17_7, true))
	...
	function arg_16_0.openSwitchDic.select()
		...
		var_2_10000(var_2.Find(var_18_0, "select/content/Marie"), true)
...
function var_0_1.initBackPressSwitch(arg_19_0)
	...
	function arg_19_0.backPressSwitchDic.select()
		...
		var_0.openCoinLayer(var_20_1, true)
...
function var_0_1.getShowSide(arg_22_0)
	return false
end
