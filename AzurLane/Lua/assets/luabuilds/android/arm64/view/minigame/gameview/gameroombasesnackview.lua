...
local var_0_0 = "GameRoomBaseSnackView"
...
function var_0_1.onBackPressed(arg_6_0)
	...
	function var_6_3.onYes()
		...
		var_0.setState(var_7_0, var_0_1.States_Finished)
...
function var_0_1.findUI(arg_10_0)
	...
	arg_10_0.ruleBtn = var_2:Find("RuleBtn")
...
function var_0_1.addListener(arg_16_0)
	...
	local var_16_4 = arg_16_0.startBtn

	local function var_16_5()
		local var_18_0 = arg_16_0

		var_0.openCoinLayer(var_18_0, false)

		local var_18_1 = arg_16_0

		var_0.setState(var_18_1, var_0_1.States_Memory)
	...
	local var_16_7 = arg_16_0.ruleBtn
	...
	local function var_16_8()
		...
		var_19_2.helps = arg_16_0.gameHelpTip
...
function var_0_1.openResultView(arg_35_0)
	...
	function var_35_0.onSubmit(arg_36_0)
		...
		var_1.SendSuccess(var_36_0, arg_35_0.score)
		...
		var_1.updateSelectedOrderTag(var_36_1, true)

		arg_35_0.selectedSnackTFList = {}

		local var_36_2 = arg_35_0.animtor

		var_1.SetBool(var_36_2, "AniSwitch", var_0_1.Ani_Open_2_Close)

		local var_36_3 = arg_35_0

		var_1.setState(var_36_3, var_0_1.States_Before)
