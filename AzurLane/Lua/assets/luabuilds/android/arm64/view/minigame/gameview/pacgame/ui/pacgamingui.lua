...
function var_0_0.initUI(arg_2_0)
	...
	findTF = var_3
	arg_2_0.joyStick = var_2_6(var_3(arg_2_0._gameUI, "joyStick"))
	...
	var_1(var_2_8, var_4("pac_game_gaming_time_desc"))
	...
	var_1(var_2_9, var_4("pac_game_gaming_score"))
...
function var_0_0.Start(arg_8_0)
	...
	if var_8_2(var_8_1, var_4.GetGameId(var_8_3)) then
		local var_8_4 = #var_1
		...
		var_8_1(arg_8_0.scoreTF, 0)

		if arg_8_0._editorFlag then
			setActive = var_3
			findTF = var_5

			var_3(var_5(arg_8_0._gameUI, "joyStick"), false)

			setActive = var_3
			findTF = var_5

			var_3(var_5(arg_8_0._gameUI, "top"), false)

			setActive = var_3
			findTF = var_5

			var_3(var_5(arg_8_0._gameUI, "bg_top"), false)
		end
...
function var_0_0.Step(arg_9_0)
	...
	var_9_3(var_9_2, var_4.getValue(var_9_4))
...
function var_0_0.SetChildVisible(arg_10_0, arg_10_1, arg_10_2)
	for iter_10_0 = 1, arg_10_1.childCount do
		local var_10_0 = arg_10_1:GetChild(iter_10_0 - 1)

		setActive = var_1_10008

		var_1_10008(var_10_0, arg_10_2)
	end
