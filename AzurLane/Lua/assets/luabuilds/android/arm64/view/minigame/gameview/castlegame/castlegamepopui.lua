...
local var_0_0 = var_0_10000("CastleGamePopUI")
...
function var_0_0.updateSettlementUI(arg_12_0)
	...
	CastleGameVo = var_12_0

	local var_12_4 = var_12_0.scoreNum
	...
	if var_12_3 then
		...
		if var_7.GetGameTimes() and var_7 > 0 and not arg_12_0.sendSuccessFlag then
			local var_12_11 = arg_12_0._event
			local var_12_12 = var_8.emit

			CastleGameView = var_1_10011

			var_12_12(var_12_11, var_1_10011.SUBMIT_GAME_SUCCESS)
		end
...
function var_0_0.readyStart(arg_18_0)
	...
	var_18_2(var_18_1, var_4.SFX_COUNT_DOWN)
