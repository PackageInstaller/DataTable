...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	findTF = var_5
	arg_1_0.joyStick = var_1_0(var_5(arg_1_0._gameUI, "joyStick"))
	onButton = var_3
	...
	local var_1_7 = var_5(arg_1_0._gameUI, "addScore/ad")

	typeof = var_6
	Animator = var_8
	arg_1_0.addScoreAnim = var_3(var_1_7, var_6(var_8))
...
function var_0_0.addScore(arg_7_0, arg_7_1)
	...
	var_7(var_9(var_5, var_7_2), true)

	setText = var_7
	findTF = var_9

	local var_7_4 = var_9(var_5, var_7_2 .. "/txt")
	local var_7_5 = "+"

	tostring = var_11

	var_7(var_7_4, var_7_5 .. var_11(var_7_0))
...
function var_0_0.step(arg_8_0)
	...
	local var_8_2 = var_1_10004.floor

	CastleGameVo = var_1_10006

	var_1(var_8_1, var_8_2(var_1_10006.gameTime))
