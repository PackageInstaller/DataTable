...
function var_0_1.initUI(arg_7_0)
	...
	local function var_7_12()
		...
		var_9_2.helps = var_4.getGameRoomData(var_9_3).game_help
	...
	local function var_36_1(arg_37_0, arg_37_1)
		...
		for iter_37_0 = var_2_10002.max(#arg_37_1[1], 2), 1, -1 do
			...
			if arg_37_1[1][iter_37_0] then
				...
				var_2_10007("ui/minigameui/icecreamgameui_atlas", var_0_15[arg_37_1[1][iter_37_0]], var_2_10006:Find("Scoop"), true)
				...
				if var_2_10007 then
					...
					var_8("ui/minigameui/icecreamgameui_atlas", var_0_16[var_2_10007], var_2_10006:Find("Topping"), true)
				end
			end
		end
...
function var_0_1.showEndUI(arg_82_0)
	...
	local var_82_2 = var_1_10002(var_4)
	...
	var_3(var_5.Find(var_82_4, "panel/now/Text/new"), var_82_3 < var_82_1)
	...
	var_82_5(var_82_6, var_82_3)

	setText = var_82_5

	var_82_5(var_82_8, var_82_1)
