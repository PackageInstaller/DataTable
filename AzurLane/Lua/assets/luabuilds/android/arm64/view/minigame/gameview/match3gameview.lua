...
function var_0_0.startGame(arg_37_0)
	...
	if arg_37_0.infinite then
		local var_37_2 = var_0_15 or var_0_16
		local var_37_3 = var_37_0(var_37_1, var_37_2)

		arg_37_0.handle = UpdateBeat:CreateListener(function()
			setText(arg_37_0.countdownText, math.floor(var_37_3.time))

			if var_37_3.time <= var_0_17 and not isActive(arg_37_0.warning) then
