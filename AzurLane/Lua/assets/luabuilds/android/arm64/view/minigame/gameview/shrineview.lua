...
function var_0_1.OnSendMiniGameOPDone(arg_5_0, arg_5_1)
	...
	if var_5_0 == arg_5_0.miniGameId then
		if var_5_1 == 1 then
			...
			arg_5_0.updateWitchImg(var_1_10007)
...
function var_0_1.findUI(arg_11_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_11_0.bgImg = var_11_6(var_11_5, var_4(var_1_10006))

	local var_11_7 = arg_11_0.bgImg

	Color = var_1_10002
	var_11_7.color = var_1_10002.New(1, 1, 1)
...
function var_0_1.addListener(arg_12_0)
	...
	local function var_12_5()
		...
		pg = var_2_10004
		var_14_2.helps = var_2_10004.gametip.help_newyear_shrine.tip
...
function var_0_1.updateBuff(arg_23_0, arg_23_1)
	if arg_23_1 then
		...
		var_1_10002(var_1_10004, var_1_10005("ui/shrineui_atlas", "buff_type_" .. arg_23_1))
		...
		for iter_23_0, iter_23_1 in var_23_2(var_23_1.buff_list) do
			...
			if var_1_10010.indexof(var_23_3, iter_23_1.id, 1) then
				...
				if var_1_10010.GetServerTime(var_23_5) < iter_23_1.timestamp then
					...
					var_23_5(var_23_6, var_1_10015("ui/shrineui_atlas", "buff_type_" .. var_23_4))
