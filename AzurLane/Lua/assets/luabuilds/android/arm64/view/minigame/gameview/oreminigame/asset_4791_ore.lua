...
function var_0_0.AddListener(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10004.EVENT_UPDATE_ORE_TARGET, function(arg_3_0, arg_3_1)
		if not arg_2_0.isDestroy then
			setActive = var_2
			findTF = var_2_10004

			var_2(var_2_10004(arg_2_0.effectTF, "Frame"), arg_2_0.index == arg_3_1.index)
		end
	...
	var_2_3(var_2_2, var_4.EVENT_CHECK_CARRY, function(arg_4_0, arg_4_1)
		if not arg_2_0.isDestroy and arg_2_0.isTarget then
			local var_4_0 = arg_4_1.weight + arg_2_0.config.weight

			OreGameConfig = var_3

			if var_4_0 > var_3.MAX_WEIGHT then
				setActive = var_4_0
				findTF = var_2_10004

				var_4_0(var_2_10004(arg_2_0.effectTF, "Limit"), true)

				setActive = var_4_0
				findTF = var_4

				var_4_0(var_4(arg_2_0.effectTF, "Full"), true)
			else
				...
				var_4_2(var_4_1, var_2_10005.EVENT_DO_CARRY, {
...
function var_0_0.AddDftAniEvent(arg_5_0)
	...
	local var_5_2 = var_5_1(var_5_0, var_4(var_1_10006))
	...
	local var_5_5 = var_5_4(var_5_3, var_4(var_1_10006))
	...
	local var_5_8 = var_5_7(var_5_6, var_4(var_1_10006))

	var_1.SetEndEvent(var_5_8, function()
		setActive = var_2_10000
		findTF = var_2_10002

		var_2_10000(var_2_10002(arg_5_0.effectTF, "Limit"), false)
	...
	local var_5_11 = var_5_10(var_5_9, var_4(var_1_10006))

	var_1.SetEndEvent(var_5_11, function()
		setActive = var_2_10000
		findTF = var_2_10002

		var_2_10000(var_2_10002(arg_5_0.effectTF, "Full"), false)
...
function var_0_0.Init(arg_10_0)
	...
	arg_10_0.animator = var_10_1(var_10_0, var_4(var_1_10006))
	...
	local var_10_7 = var_10_6(var_10_5, var_5(var_1_10007))
	...
	local var_10_11 = var_10_10(var_10_9, var_5(var_1_10007))
...
function var_0_0.PlayBlink(arg_13_0)
	...
	local var_13_2 = var_13_1(var_13_0, var_4(var_1_10006))
...
function var_0_0.Destroy(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10004.EVENT_ORE_DESTROY, {
