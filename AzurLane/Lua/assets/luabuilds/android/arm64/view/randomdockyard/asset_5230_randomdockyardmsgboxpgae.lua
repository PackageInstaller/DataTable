...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.titleTxt = var_2_7(var_2_6, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.titleEnTxt = var_2_10(var_2_9, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.subTitleTxt = var_2_13(var_2_12, var_4(var_1_10006))
	setText = var_1

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_3.Find(var_2_14, "frame/confirm_button/pic")

	i18n = var_4

	var_1(var_2_15, var_4("text_confirm"))

	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_3.Find(var_2_16, "frame/cancel_button/pic")

	i18n = var_4

	var_1(var_2_17, var_4("text_cancel"))
...
function var_0_1.OnUpdateItem(arg_11_0, arg_11_1, arg_11_2)
	...
	if not arg_11_0.cards[arg_11_2] then
		...
		arg_11_0.OnInitItem(var_1_10006, arg_11_2)
