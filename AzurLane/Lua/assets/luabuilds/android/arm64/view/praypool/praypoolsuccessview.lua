...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.buildShipProxy = var_1(var_3)
...
function var_0_1.initUI(arg_6_0)
	...
	for iter_6_0 = 2, 6 do
		...
		var_1_10006 = var_1_10006(var_6_16(var_6_15, var_1_10011(iter_6_0)))
		var_1_10007 = arg_6_0.ratioSpriteMap
	...
	var_6_18.Light1 = var_4(var_6.Find(var_6_19, "Light/Normal/Light1"))
	getImageSprite = var_4

	local var_6_20 = arg_6_0._tf

	var_6_18.Light2 = var_4(var_6.Find(var_6_20, "Light/Normal/Light2"))
	getImageSprite = var_4

	local var_6_21 = arg_6_0._tf

	var_6_18.Light2_2 = var_4(var_6.Find(var_6_21, "Light/Normal/Light2_2"))
	getImageSprite = var_4

	local var_6_22 = arg_6_0._tf

	var_6_18.Light3 = var_4(var_6.Find(var_6_22, "Light/Normal/Light3"))
	getImageSprite = var_4

	local var_6_23 = arg_6_0._tf

	var_6_18.RarityBG = var_4(var_6.Find(var_6_23, "RarityBG/Normal"))
	...
	var_6_24.Light1 = var_4(var_6.Find(var_6_25, "Light/UR/Light1"))
	getImageSprite = var_4

	local var_6_26 = arg_6_0._tf

	var_6_24.Light2 = var_4(var_6.Find(var_6_26, "Light/UR/Light2"))
	getImageSprite = var_4

	local var_6_27 = arg_6_0._tf

	var_6_24.Light2_2 = var_4(var_6.Find(var_6_27, "Light/UR/Light2_2"))
	getImageSprite = var_4

	local var_6_28 = arg_6_0._tf

	var_6_24.Light3 = var_4(var_6.Find(var_6_28, "Light/UR/Light3"))
	getImageSprite = var_4

	local var_6_29 = arg_6_0._tf

	var_6_24.RarityBG = var_4(var_6.Find(var_6_29, "RarityBG/UR"))
	...
	local function var_6_32()
		...
		local var_7_8 = var_7_4.getCount(var_7_7)

		_ = var_7_6

		local var_7_9 = var_7_6.min
		local var_7_10 = {}

		math = var_2_10010
		var_7_10[1] = var_2_10010.floor(var_7_3.gold / var_7_1.use_gold)
		math = var_10
		var_7_10[2] = var_10.floor(var_7_5 / var_7_1.number_1)
		MAX_BUILD_WORK_COUNT = var_10
		var_7_10[3] = var_10 - var_7_8

		local var_7_11 = var_7_9(var_7_10)

		math = var_8

		local var_7_12 = var_8.max(1, var_7_11)
		...
		var_9.show(var_7_14, var_7_12, var_7_13, function(arg_9_0)
			...
			PrayPoolConst = var_3_10004

			var_9_1(var_9_0, var_3_10004.START_BUILD_SHIP_EVENT, var_7_1.id, arg_9_0, 0)
			...
			if var_7_13(arg_10_0) then
				...
				return var_3_10004("build_ship_tip", arg_10_0, var_7_1.name, var_10_0, var_10_1, var_3)
			end
		end)
	...
	SFX_UI_BUILDING_STARTBUILDING = var_1_10007

	var_6_17(var_6_30, var_6_31, var_6_32, var_1_10007)
...
function var_0_1.updateUI(arg_11_0)
	...
	arg_11_0.updatePaint(var_11_2, var_11_1)

	local var_11_3
	local var_11_4 = arg_11_0.bagProxy
	local var_11_5

	if not var_3.getItemById(var_11_4, arg_11_0.useItem) then
		var_11_5 = {
			count = 0
		}
	end
	...
	var_3(arg_11_0.curCubeNumText, var_11_5.count)

	pg = var_3

	local var_11_6 = var_3.ship_data_create_material

	pg = var_11_2

	local var_11_7 = var_11_6[var_11_2.activity_ship_create[arg_11_0.poolType].create_id]

	setText = var_6

	var_6(arg_11_0.buildCubeNumText, var_11_7.number_1)

	setText = var_6

	var_6(arg_11_0.buildGoldNumText, var_11_7.use_gold)
...
function var_0_1.updatePaint(arg_12_0, arg_12_1)
	for iter_12_0 = 1, 2 do
		...
		local function var_12_3()
			...
			GetComponent = var_13_0

			local var_13_3 = var_13_0(var_13_2, "MeshImage")
			local var_13_4
			...
			local var_13_7 = var_13_6(var_13_5, var_2_10007(var_2_10009)).material
		...
		var_12_1(var_12_4, var_1_10017.getPaintingName(var_12_0), "build", var_12_3)

		local var_12_5 = var_11:Find("Light1")

		var_1_10017 = var_11

		local var_12_6 = var_11.Find(var_1_10017, "Light2")
		local var_12_7 = var_15.Find(var_12_6, "Light2_2")

		var_1_10017 = var_11:Find("Light3")

		if not var_1_10010 then
			setImageSprite = var_12_6

			var_12_6(var_12_5, arg_12_0.raritySpriteMap.Normal.Light1)

			setImageSprite = var_12_6

			var_12_6(var_15, arg_12_0.raritySpriteMap.Normal.Light2)

			setImageSprite = var_12_6

			var_12_6(var_12_7, arg_12_0.raritySpriteMap.Normal.Light2_2)

			setImageSprite = var_12_6

			var_12_6(var_1_10017, arg_12_0.raritySpriteMap.Normal.Light3)

			setImageColor = var_12_6

			var_12_6(var_12_5, var_0_1.Rarity_To_Light_Color_1[var_1_10009])

			setImageColor = var_12_6

			var_12_6(var_15, var_0_1.Rarity_To_Light_Color_1[var_1_10009])

			setImageColor = var_12_6

			var_12_6(var_12_7, var_0_1.Rarity_To_Light_Color_1[var_1_10009])

			setImageColor = var_12_6

			var_12_6(var_1_10017, var_0_1.Rarity_To_Light_Color_2[var_1_10009])
		else
			setImageSprite = var_12_6

			var_12_6(var_12_5, arg_12_0.raritySpriteMap.UR.Light1)

			setImageSprite = var_12_6

			var_12_6(var_15, arg_12_0.raritySpriteMap.UR.Light2)

			setImageSprite = var_12_6

			var_12_6(var_12_7, arg_12_0.raritySpriteMap.UR.Light2_2)

			setImageSprite = var_12_6

			var_12_6(var_1_10017, arg_12_0.raritySpriteMap.UR.Light3)
		end

		local var_12_8 = arg_12_0.shipRarityTF[iter_12_0]
		local var_12_9

		if not var_1_10010 or not arg_12_0.raritySpriteMap.UR.RarityBG then
			var_12_9 = arg_12_0.raritySpriteMap.Normal.RarityBG
		end

		setImageSprite = var_20

		var_20(var_12_8, var_12_9)

		local var_12_10 = var_11
		local var_12_11 = var_11.Find(var_12_10, "NameText")

		setText = var_1_10021

		var_1_10021(var_12_11, var_1_10007)

		local var_12_12 = var_11

		var_1_10021 = var_11.Find(var_12_12, "NameEngText")
		setText = var_12_10

		var_12_10(var_1_10021, var_1_10008)

		local var_12_13 = var_12_8:Find("NumImg")

		setImageSprite = var_12_12

		var_12_12(var_12_13, arg_12_0.ratioSpriteMap[var_1_10009], true)
	end
...
function var_0_1.MsgBox(arg_14_0)
	...
	typeof = var_5
	Text = var_1_10007
	var_14_0.valueTxt = var_14_2(var_14_1, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	var_14_0.text = var_14_4(var_14_3, var_5(var_1_10007))
	...
	local var_14_5 = var_4(var_14_0.cancenlBtn, "Image/Image (1)")

	i18n = var_5

	var_2(var_14_5, var_5("text_cancel"))
	...
	var_2(var_14_6, var_5("text_confirm"))
	...
	function var_14_0.init(arg_16_0)
		...
		var_1(var_16_0, var_16_1, var_16_2, var_2_10006)
		...
		var_1(var_16_3, var_16_4, var_16_5, var_2_10006)
		...
		var_1(var_16_6, var_16_7, var_16_8, var_2_10006)
		...
		var_1(var_16_9, var_16_10, var_16_11, var_2_10006)
		...
		local function var_16_14()
			...
			if var_0.verifyCount(var_21_0, arg_16_0.count - 1) then
				...
				math = var_3_10001
				var_21_1.count = var_3_10001.max(arg_16_0.count - 1, 1)
		...
		var_1(var_16_12, var_16_13, var_16_14, var_2_10006)
		...
		local function var_16_17()
			...
			if var_0.verifyCount(var_22_0, arg_16_0.count + 1) then
				...
				math = var_3_10001
				var_22_1.count = var_3_10001.min(arg_16_0.count + 1, arg_16_0.max)
		...
		var_1(var_16_15, var_16_16, var_16_17, var_2_10006)
		...
		var_1(var_16_18, var_16_19, var_16_20, var_2_10006)
...
Color = var_0_0
var_0_2[2] = var_0_0(0.5568627450980392, 0.5568627450980392, 0.5568627450980392, 1)
Color = var_2
