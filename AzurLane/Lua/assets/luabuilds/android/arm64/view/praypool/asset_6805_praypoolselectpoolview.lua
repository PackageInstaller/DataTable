...
function var_0_1.initUI(arg_6_0)
	...
	var_1.make(var_6_4, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			var_7_1, setImageSprite = arg_7_2:Find("PoolImg"), var_2_10005
			GetSpriteFromAtlas = var_2_10008

			var_2_10005(var_7_1, var_2_10008("ui/prayselectpoolpage_atlas", "pool" .. var_7_0))
			...
			var_2_10005(var_7_2, var_7_3, var_7_4, var_10)
	...
	var_6_6(var_6_5, #var_4.activity_ship_create.all)
	...
	local function var_6_10()
		...
		var_9_1(var_9_0, var_2_10003.STATE_HOME)
		...
		local var_9_4 = var_3.SWITCH_TO_HOME_PAGE

		PrayProxy = var_2_10004

		var_9_3(var_9_2, var_9_4, var_2_10004.STATE_HOME)
	...
	var_6_7(var_6_8, var_6_9, var_6_10, var_1_10006)
	...
	local function var_6_13()
		...
		var_10_2(var_10_1, var_3.STAGE_SELECT_SHIP)
		...
		local var_10_5 = var_3.SWITCH_TO_SELECT_SHIP_PAGE

		PrayProxy = var_2_10004

		var_10_4(var_10_3, var_10_5, var_2_10004.STAGE_SELECT_SHIP)
	...
	var_6_7(var_6_11, var_6_12, var_6_13, var_1_10006)
	arg_6_0:Show()
...
function var_0_1.updateUI(arg_11_0)
	...
	if var_1.getSelectedPoolType(var_11_0) then
		...
		var_1_10002(arg_11_0.poolToggleList[var_1], true)
	else
		return
	end
