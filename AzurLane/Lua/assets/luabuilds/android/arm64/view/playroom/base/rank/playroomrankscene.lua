...
function var_0_1.init(arg_2_0)
	...
	var_2_1(var_2_13, var_4("island_friend"))
	...
	var_2_1(var_2_14, var_4("island_guild"))
	...
	var_2_1(var_2_15, var_4("island_guild"))
	...
	var_2_1(var_2_16, var_4("channel_name_1"))
	...
	var_2_1(var_2_17, var_4("channel_name_1"))
	...
	var_2_1(var_2_18, var_2_19, var_2_20, var_6)
	...
	var_2_1(var_2_21, var_2_22, var_2_23, var_6)
	...
	var_2_1(var_2_24, var_2_25, var_2_26, var_6)
	...
	PlayRoomRankItem = var_6
	arg_2_0.uiScrollView = var_2_27(var_2_28, var_2_29, var_2_30, var_6)
...
function var_0_1.RefreshUI(arg_10_0)
	...
	var_10_2(var_10_1, var_4.GetSelfRankData(var_10_3, arg_10_0.contextData.gameType))
...
function var_0_1.GetDisplayData(arg_12_0)
	...
	elseif arg_12_0.selectedPage == var_0_1.PAGE.GUILD then
		...
		local var_12_5 = var_4(var_12_4)

		var_12_1 = var_4.getRawData(var_12_5) and var_4:getSortMemberWithoutSelf() or {}
	else
		return var_12_3
	end
	...
	for iter_12_0, iter_12_1 in var_5(var_12_1) do
		...
		var_1_10010.insert(var_12_6, iter_12_1.id)
	end
	...
	for iter_12_2, iter_12_3 in var_5(var_12_3) do
		...
		if var_1_10010.keyof(var_12_6, iter_12_3.playerData.id) then
			table = var_1_10010
