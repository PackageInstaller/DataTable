...
function var_0_1.registerPlayRoom(arg_4_0)
	arg_4_0:bind(var_0_1.ON_CLICK_MATCH, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10005.PLAY_ROOM_CREATE_ROOM, arg_5_1)
	...
	arg_4_0:bind(var_0_1.REFRESH_ROOM_INFO, function(arg_6_0)
		...
		var_6_1(var_6_0, var_2_10004.PLAY_ROOM_REFRESH_ROOM_INFO)
	...
	arg_4_0:bind(var_0_1.PLAY_ROOM_MATCH_STOP, function(arg_7_0)
		...
		var_7_1(var_7_0, var_2_10004.PLAY_ROOM_EXIT_ROOM, {
			arg = 0
		})
	...
	arg_4_0:bind(var_0_1.ON_CLICK_READY, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_2_10005.PLAY_ROOM_READY, arg_8_1)
	...
	arg_4_0:bind(var_0_1.ON_MATCH_CLICK_READY, function(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_2_10005.PLAY_ROOM_MATCH_READY, arg_9_1)
	...
	arg_4_0:bind(var_0_1.ON_CLICK_QUICK_MATCH, function(arg_10_0, arg_10_1)
		...
		var_10_1(var_10_0, var_2_10005.PLAY_ROOM_QUICK_MATCH, arg_10_1)
...
function var_0_1.initNotificationHandleDicPlayRoom(arg_11_0)
	...
	var_11_0[var_1_10002.PLAY_ROOM_CREATE_ROOM_DONE] = function()
		...
		if var_12_1 == var_2_10001.PLAY_ROOM_TYPE.MATCH then
			local var_12_2 = arg_11_0
			local var_12_3 = var_0.sendNotification

			GAME = var_2_10003

			var_12_3(var_12_2, var_2_10003.PLAY_ROOM_START_GAME)
	...
	var_11_0[var_2.PLAY_ROOM_EXIT_MATCH_READY_ROOM] = function(arg_18_0, arg_18_1)
		...
		var_18_1(var_18_0, var_2_10005.PLAY_ROOM_EXIT_ROOM)
	...
	var_11_0[var_2.PLAY_ROOM_REFRESH_ROOM_INFO_DONE] = function()
		...
		if var_0.GetRoomData(var_19_0) then
			...
			PlayRoomConst = var_19_0

			if var_19_1 == var_19_0.PLAY_ROOM_STATE.PLAYING then
				IslandCheaterTavernRecordTools = var_19_1

				var_19_1.StartGame()

				local var_19_2 = arg_11_0
				...
				var_19_3(var_19_2, var_2_10004, var_2_10005)
			else
				local var_19_4 = var_0.roomType

				PlayRoomConst = var_2

				if var_19_4 ~= var_2.PLAY_ROOM_TYPE.MATCH then
					local var_19_5 = arg_11_0
					local var_19_6 = var_1.sendNotification

					CheaterTavernEvent = var_2_10004

					local var_19_7 = var_2_10004.PLAY_ROOM_LOAD_ROOM_SCENE

					IslandCheaterTavernConst = var_2_10005

					var_19_6(var_19_5, var_19_7, var_2_10005.SceneRoomType.CustomRoom)
				end
			end
		end
