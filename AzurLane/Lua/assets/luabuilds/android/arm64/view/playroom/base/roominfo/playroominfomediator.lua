local var_0_0 = class("PlayRoomInfoMediator", import("view.base.ContextMediator"))

var_0_0.ON_CLICK_VIEWER = "PlayRoomInfoMediator::ON_CLICK_VIEWER"
var_0_0.ON_CLICK_READY = "PlayRoomInfoMediator::ON_CLICK_READY"
var_0_0.ON_CLICK_KICK = "PlayRoomInfoMediator::ON_CLICK_KICK"
var_0_0.ON_CLICK_INVITE = "PlayRoomInfoMediator::ON_CLICK_INVITE"
var_0_0.ON_CLICK_CLOSE = "PlayRoomInfoMediator::ON_CLICK_CLOSE"
var_0_0.ON_CLICK_START_GAME = "PlayRoomInfoMediaotr::ON_CLICK_START_GAME"
var_0_0.ON_CLICK_CHANGE_CHARACTER = "PlayRoomInfoMediaotr::ON_CLICK_CHANGE_CHARACTER"
var_0_0.ON_SWITCH_ROOM_TYPE = "PlayRoomInfoMediator.ON_SWITCH_ROOM_TYPE"
var_0_0.ON_MATCH_CLICK_READY = "PlayRoomInfoMediaotr:ON_MATCH_CLICK_READY"

function var_0_0.register(arg_1_0)
	arg_1_0:bind(var_0_0.ON_CLICK_VIEWER, function()
	...
	arg_1_0:bind(var_0_0.ON_CLICK_INVITE, function()
		arg_1_0:addSubLayers(Context.New({
	...
	arg_1_0:bind(var_0_0.ON_CLICK_READY, function(arg_4_0, arg_4_1)
		arg_1_0:sendNotification(GAME.PLAY_ROOM_READY, arg_4_1)

		return
	end)
	arg_1_0:bind(var_0_0.ON_CLICK_KICK, function(arg_5_0, arg_5_1)
		arg_1_0:sendNotification(GAME.PLAY_ROOM_KICK, arg_5_1)

		return
	end)
	arg_1_0:bind(var_0_0.ON_CLICK_CLOSE, function(arg_6_0, arg_6_1)
		arg_1_0:sendNotification(GAME.PLAY_ROOM_EXIT_ROOM)

		return
	end)
	arg_1_0:bind(var_0_0.ON_CLICK_START_GAME, function(arg_7_0, arg_7_1)
		arg_1_0:sendNotification(GAME.PLAY_ROOM_START_GAME)

		return
	end)
	arg_1_0:bind(var_0_0.ON_CLICK_CHANGE_CHARACTER, function(arg_8_0, arg_8_1)
		arg_1_0:sendNotification(CheaterTavernEvent.OPEN_SELECT_SHIP, IslandCheaterTavernConst.ChangeDressType.InRoom)

		return
	end)
	arg_1_0:bind(var_0_0.ON_SWITCH_ROOM_TYPE, function(arg_9_0)
		arg_1_0:sendNotification(GAME.PLAY_ROOM_SWITCH_ROOM_TYPE)

		return
	end)
	arg_1_0:bind(var_0_0.ON_MATCH_CLICK_READY, function(arg_10_0, arg_10_1)
		arg_1_0:sendNotification(GAME.PLAY_ROOM_MATCH_READY, arg_10_1)
