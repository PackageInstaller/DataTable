...
function var_0_1.init(arg_2_0)
	...
	var_2_1(var_2_7, var_4("play_room_season_en"))
	...
	var_2_1(var_2_8, var_4("match_ui_room_create"))
	...
	var_2_1(var_2_9, var_4("match_ui_room_search"))
	...
	local var_2_12 = var_4(arg_2_0, arg_2_0.IndexItem)
	local var_2_13 = arg_2_0.uiScrollViewTf

	PlayRoomMainItem = var_6
	arg_2_0.uiLScrollView = var_2_10(var_2_11, var_2_12, var_2_13, var_6)
	onButton = var_1
	...
	local function var_2_22()
		...
		var_5_1(var_5_0, var_2_10003.JOIN_ROOM, {
			id = 0
		})
	...
	var_1(var_2_24, var_2_21("island_bar_quick_game"))
	...
	local function var_2_27()
		...
		var_6_1(var_6_0, var_2_10003.REFRESH_ROOM_LIST)
	...
	var_1(var_2_28, var_2_29, var_2_30, var_6)
	...
	var_1(var_2_31, var_2_32, var_2_33, var_6)
	...
	var_1(var_2_34, var_2_35, var_2_36, var_6)
	...
	local function var_2_39()
		...
		local var_11_2 = var_2_10003.CREATE_ROOM
		local var_11_3 = {}

		PlayRoomConst = var_2_10005
		var_11_3.type = var_2_10005.PLAY_ROOM_TYPE.COMMON

		local var_11_4 = arg_2_0

		var_11_3.gameType = var_5.GetGameType(var_11_4)
	...
	var_1(var_2_37, var_2_38, var_2_39, var_6)
	...
	local function var_2_42()
		...
		local var_12_2 = var_2_10003.CREATE_ROOM
		local var_12_3 = {}

		PlayRoomConst = var_2_10005
		var_12_3.type = var_2_10005.PLAY_ROOM_TYPE.PERSON

		local var_12_4 = arg_2_0

		var_12_3.gameType = var_5.GetGameType(var_12_4)
	...
	var_1(var_2_40, var_2_41, var_2_42, var_6)
...
function var_0_1.didEnter(arg_14_0)
	...
	var_14_0.selectedRoomSortType = var_1_10002.ROOM_SORT_TYPE.ROOM_PLAYER_SUM

	local var_14_1 = arg_14_0.contextData

	PlayRoomConst = var_2
	var_14_1.selectedRoomType = var_2.PLAY_ROOM_TYPE.ALL

	local var_14_2 = arg_14_0.contextData

	PlayRoomConst = var_2
	var_14_2.selectedRoomState = var_2.PLAY_ROOM_STATE.ALL
	...
	local var_14_6 = var_0_1.ON_CLICK_ITEM_BTN

	handler = var_1_10006
	var_14_3[1] = var_14_5(var_14_4, var_14_6, var_1_10006(arg_14_0, arg_14_0.OnRefreshSortBtn))
	arg_14_0.eventList = var_14_3

	local var_14_7 = arg_14_0
	local var_14_8 = arg_14_0.emit

	PlayRoomMainMediator = var_14_4

	var_14_8(var_14_7, var_14_4.REFRESH_ROOM_LIST)
...
function var_0_1.RefreshSortText(arg_24_0)
	...
	var_1_10001(var_24_0, var_1_10004.SORT_TEXT[arg_24_0.contextData.selectedRoomSortType])
...
function var_0_1.OnQuickRoomFail(arg_27_0)
	...
	i18n = var_1_10005
	var_27_2.content = var_1_10005("island_bar_quick_tip")
