...
function var_0_1.Init(arg_2_0)
	...
	local function var_2_2()
		...
		if var_0.GetInviteList(var_3_0)[1] then
			...
			var_3_3(var_3_2, var_2_10006.PLAY_ROOM_INVITE_AGREE, {
				id = var_1.id,
			...
			var_3_5(var_3_4, var_6.BuildPlayRoomInvate("bar", var_1.id, 1))
		end
	...
	local function var_2_5()
		...
		if var_0.GetInviteList(var_4_0)[1] then
			...
			var_4_3(var_4_2, var_2_10005.PLAY_ROOM_INVITE_REFUSE, var_4_1)
			...
			var_4_5(var_4_4, var_5.BuildPlayRoomInvate("bar", var_4_1, 0))
		end
...
function var_0_1.RefreshInvite(arg_11_0)
	...
	if var_11_1[1] and arg_11_0.endTime ~= var_11_1[1].timestamp then
		...
		local var_11_5 = var_1_10007.TimeMgr.GetInstance()

		var_11_4(var_11_3, var_7.GetServerTime(var_11_5), var_11_1[1].timestamp + var_11_2)
	end
...
function var_0_1.RefreshUI(arg_12_0, arg_12_1)
	...
	local var_12_3 = var_7.format
	local var_12_4 = "%s/%s"
	local var_12_5 = var_12_1.teamCnt

	PlayRoomTools = var_1_10011

	var_1_10004(var_12_2, var_12_3(var_12_4, var_12_5, var_1_10011.GetMaxPlayerCnt(var_12_1.gameType)))
	...
	var_1_10005("qicon/" .. var_12_6:getPrefab(), function(arg_13_0)
...
function var_0_1.StartLeanTween(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_3 = var_14_0(var_14_1, var_14_2 / var_1_10007.gameset.match_refuseCD.key_value, 0, arg_14_2 - arg_14_1)
	local var_14_4 = var_3.setOnUpdate

	System = var_6

	local var_14_5 = var_14_4(var_14_3, var_6.Action_float(function(arg_15_0)
	...
	var_14_6(var_14_5, var_6.Action(function()
