...
function var_0_1.Init(arg_2_0)
	...
	local function var_2_2()
		...
		var_3_1(var_3_0, var_2_10003.ON_CLICK_INVITE)
	...
	local function var_2_8()
		...
		var_5_1(var_5_0, var_2_10003.ON_CLICK_CHANGE_CHARACTER)
...
function var_0_1.didEnter(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4, arg_6_5)
	...
	if arg_6_1 then
		...
		local var_6_0 = var_6_4(var_1_10008)

		arg_6_0.isSelf = var_6_4.getPlayerId(var_6_0) == arg_6_1.id
		setActive = var_6_0

		var_6_0(arg_6_0.uiBgTf, false)

		setActive = var_6_0

		var_6_0(arg_6_0.uiMainTf, true)

		setText = var_6_0

		var_6_0(arg_6_0.uiNameText, arg_6_1.name)

		setActive = var_6_0

		var_6_0(arg_6_0.uiRoomOwnerGo, arg_6_2 == arg_6_1.id)

		setActive = var_6_0

		var_6_0(arg_6_0.uiKickTf, arg_6_2 == var_6_4 and not var_7)

		getProxy = var_6_0
		PlayRoomProxy = var_10

		local var_6_1 = var_6_0(var_10)
		...
		if arg_6_2 == var_6_4 or not arg_6_4 then
			if var_7 then
				...
				if arg_6_3 ~= var_1_10013.SceneRoomType.MatchInfoRoom then
					var_1_10013 = not arg_6_5
