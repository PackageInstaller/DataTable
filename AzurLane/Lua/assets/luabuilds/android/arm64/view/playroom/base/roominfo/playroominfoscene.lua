...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_0, var_2_1, var_2_2, iter_2_0)
	...
	local function var_2_5()
		...
		PlayRoomInfoMediator = var_2_10003

		var_4_1(var_4_0, var_2_10003.ON_CLICK_VIEWER)
	...
	var_1(var_2_3, var_2_4, var_2_5, iter_2_0)
	...
	local function var_2_8()
		...
		var_5_1(var_5_0, var_2_10003.ON_CLICK_READY, {
			arg = 1
		})
	...
	var_1(var_2_6, var_2_7, var_2_8, iter_2_0)
	...
	local function var_2_11()
		...
		var_6_1(var_6_0, var_2_10003.ON_CLICK_READY, {
			arg = 0
		})
	...
	var_1(var_2_9, var_2_10, var_2_11, iter_2_0)
	...
	local function var_2_14()
		...
		if not var_2_10001.IsPlayerFull() then
			...
			var_1.insert(var_7_0, function(arg_8_0)
				...
				i18n = var_3_10005
				var_8_2.content = var_3_10005("island_bar_quick_addbot")
		...
		var_1(var_7_0, function()
			...
			PlayRoomInfoMediator = var_3_10003

			var_9_1(var_9_0, var_3_10003.ON_CLICK_START_GAME)
	...
	var_1(var_2_12, var_2_13, var_2_14, iter_2_0)
	...
	local function var_2_17()
		...
		i18n = var_2_10004
		var_10_2.content = var_2_10004("play_room_switch_tip")
		...
		function var_10_2.onYes()
			...
			var_11_1(var_11_0, var_3_10003.ON_SWITCH_ROOM_TYPE)
	...
	var_1(var_2_15, var_2_16, var_2_17, iter_2_0)
	...
	local function var_2_20()
		...
		local var_12_2 = var_2_10003.ON_ADD_SUBLAYER
	...
	var_1(var_2_18, var_2_19, var_2_20, iter_2_0)
	...
	local function var_2_23()
		...
		var_13_1(var_13_0, var_2_10003.ON_MATCH_CLICK_READY, {
			arg = 1
		})
	...
	var_1(var_2_21, var_2_22, var_2_23, iter_2_0)
	...
	local function var_2_26()
		...
		UniPasteBoard = var_14_0

		var_14_0.SetClipBoardString(var_14_1[1])
		...
		var_14_3(var_14_2, var_2_10006("friend_id_copy_ok"))
	...
	var_1(var_2_24, var_2_25, var_2_26, iter_2_0)
	...
	if var_1.GetRoomData(var_2_27) then
		var_2_24 = 1
		PlayRoomTools = var_2_27

		for iter_2_0 = var_2_24, var_2_27.GetMaxTeamCnt(var_2.gameType) do
			local var_2_28 = arg_2_0.playerItemList

			PlayRoomInfoPlayerItem = var_1_10008
			var_1_10008 = var_1_10008.New
			Object = var_1_10010
			var_2_28[iter_2_0] = var_1_10008(var_1_10010.Instantiate(arg_2_0.uiPlayerItem, arg_2_0.uiPlayerPanel), arg_2_0)
		end
	end
	...
	var_2_24(var_2_29, iter_2_0("match_ui_room_ready1"))
	...
	var_2_24(var_2_30, var_6("match_ui_room_ready2"))
	...
	var_2_24(var_2_31, var_6("match_ui_room_startgame"))
	...
	var_2_24(var_2_32, var_6("match_ui_accept"))
	...
	var_2_24(var_2_33, var_6("match_ui_matching"))
	...
	var_2_24(var_2_34, var_6("match_ui_matching_loading"))
...
function var_0_1.didEnter(arg_16_0)
	...
	arg_16_0.playRoomProxy = var_1_10001(var_1_10003)
	...
	local var_16_2 = arg_16_0.sceneRoomType

	IslandCheaterTavernConst = var_16_0

	if var_16_2 == var_16_0.SceneRoomType.CustomRoom then
		arg_16_0:RefreshUI()
	else
		...
		if var_16_3 == var_3.SceneRoomType.MatchInfoRoom then
...
function var_0_1.InitUIDisplay(arg_17_0)
	...
	if var_17_2 == var_1_10003.SceneRoomType.CustomRoom then
		-- block empty
	else
		...
		if var_17_3 == var_3.SceneRoomType.MatchInfoRoom then
			...
			var_17_3(var_17_4, var_5("match_ui_point_match"))
		end
	end
...
function var_0_1.RefreshUI(arg_19_0)
	...
	if var_19_1 == var_1_10007.PLAY_ROOM_TYPE.PERSON then
		...
		var_7(var_19_5, var_1_10010("match_ui_room_filter6"))
	else
		setText = var_7
		...
		var_7(var_19_6, var_1_10010("match_ui_room_filter5"))
	end
	...
	PlayRoomTools = var_1_10014

	var_7(var_19_7, var_10(var_19_8, var_19_9, var_1_10014.GetMaxViewerCnt(var_2.gameType)))
	...
	var_19_10(arg_19_0.uiStartBtn, var_19_11)

	setActive = var_19_10

	var_19_10(arg_19_0.uiRoomSwitchBtn, var_19_11)

	PlayRoomTools = var_19_10

	local var_19_12 = var_19_10.IsViewer()
	...
	PlayRoomTools = var_13

	var_10(var_19_14, not var_13.CanStartGame(), true)
...
function var_0_1.RefreshPlayerList(arg_20_0)
	...
	local var_20_2 = var_20_0(var_1_10006)
	local var_20_3 = var_4.getPlayerId(var_20_2)

	ipairs = var_1_10005

	for iter_20_0, iter_20_1 in var_1_10005(arg_20_0.playerItemList) do
		if var_20_1[iter_20_0] then
			...
			PlayRoomTools = var_1_10016

			var_20_6(var_20_5, var_20_7, var_1_10016.GetHostID(), arg_20_0.sceneRoomType, var_1_10011)
		end
	end
...
function var_0_1.OnClickCloseBtn(arg_21_0)
	...
	if var_21_0 == var_1_10002.SceneRoomType.MatchInfoRoom then
		...
		var_21_2(var_21_1, var_1_10004.ON_MATCH_CLICK_READY, {
			arg = 0
		})
	end
	...
	var_21_4(var_21_3, var_1_10004.ON_CLICK_CLOSE, {
...
function var_0_1.RefreshMatchInfoUI(arg_23_0)
	...
	arg_23_0.RefreshMatchInfoPlayerList(var_23_0)

	local var_23_1 = arg_23_0.playRoomProxy

	if not var_1.GetMatchRoomData(var_23_1) then
		return
	end
	...
	local var_23_2 = var_23_0(var_1_10005)
	local var_23_3 = var_3.getPlayerId(var_23_2)

	table = var_23_1

	if var_23_1.contains(var_2.readyList, var_23_3) then
		...
		var_23_2 = arg_23_0.StartLeanTween
		pg = var_8

		local var_23_5 = var_8.TimeMgr.GetInstance()
		local var_23_6 = var_8.GetServerTime(var_23_5)
		local var_23_7 = arg_23_0.playRoomProxy

		var_23_2(var_23_4, var_23_6, var_9.GetMatchRoomData(var_23_7).endTimestamp)
	end

	setActive = var_23_2

	var_23_2(arg_23_0.uiRoomSwitchBtn, false)
...
function var_0_1.RefreshMatchInfoPlayerList(arg_24_0)
	...
	local var_24_2 = var_24_0(var_1_10006)
	local var_24_3 = var_4.getPlayerId(var_24_2)

	ipairs = var_1_10005

	for iter_24_0, iter_24_1 in var_1_10005(arg_24_0.playerItemList) do
...
function var_0_1.StartLeanTween(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_3 = var_25_0(var_25_1, var_25_2 / var_1_10007.gameset.match_refuseCD.key_value, 0, arg_25_2 - arg_25_1)
	local var_25_4 = var_3.setOnUpdate

	System = var_6

	local var_25_5 = var_25_4(var_25_3, var_6.Action_float(function(arg_26_0)
		...
		local var_26_5 = var_2_10006.format
		local var_26_6 = "%02d:%02d"

		math = var_2_10009

		var_26_1(var_26_4, var_26_5(var_26_6, var_2_10009.floor(var_26_3 / 60), var_26_3 % 60))
	...
	var_25_6(var_25_5, var_6.Action(function()
...
function var_0_1.StartLoadLeanTween(arg_29_0, arg_29_1)
	...
	local var_29_2 = var_29_1(var_29_0, var_5.Action_float(function(arg_30_0)
	...
	var_29_3(var_29_2, var_5.Action(function()
...
function var_0_1.RefreshLoadInfoUI(arg_34_0)
	...
	local var_34_2 = var_34_0(var_1_10006)
	local var_34_3 = var_4.getPlayerId(var_34_2)

	table = var_1_10005

	local var_34_4 = var_1_10005.contains(var_2.readyList, var_34_3)

	ipairs = var_34_2

	for iter_34_0, iter_34_1 in var_34_2(arg_34_0.playerItemList) do
...
function var_0_1.RefreshMessage(arg_36_0)
	...
	var_1_10002(arg_36_0.uiChatItemGo, #var_36_0 > 0)
	...
	local var_36_2 = arg_36_0.uiChannelImage

	GetSpriteFromAtlas = var_4

	local var_36_3 = "channel"

	ChatConst = var_1_10007
	var_36_2.sprite = var_4(var_36_3, var_1_10007.GetChannelSprite(var_36_1.type) .. "_mel")

	local var_36_4 = arg_36_0.uiChatText
	local var_36_5 = var_3.GetComponent(var_36_4, "RichText")
	local var_36_6 = var_36_1.type

	ChatConst = var_36_4

	if var_36_6 == var_36_4.ChannelPublic then
		var_36_5.supportRichText = true
		ChatProxy = var_4

		var_4.InjectPublic(var_36_5, var_36_1, true)
	else
		local var_36_7 = var_36_1

		if var_36_1.IsWorldBossNotify(var_36_7) then
			var_36_5.supportRichText = true

			local var_36_8 = var_36_1.args.playerName
			local var_36_9 = var_36_1.args.bossName

			GetPerceptualSize = var_36_7

			local var_36_10 = var_36_7(var_36_8 .. var_36_9) - 18
			local var_36_11
			...
			i18n = var_36_11
			var_36_5.text = var_36_11("ad_4", var_36_1.args.supportType, var_36_8, var_36_9, var_36_1.args.level)
		else
			var_36_5.supportRichText = var_36_1.emojiId ~= nil
			var_36_5.text = arg_36_0:MatchEmoji(var_36_5, var_36_1)
		end
	end
...
function var_0_1.MatchEmoji(arg_37_0, arg_37_1, arg_37_2)
	...
	for iter_37_0 in var_37_3(var_37_4, var_1_10009.EmojiIconCodeMatch) do
		table = var_1_10011
		...
		if var_1_10011(var_1_10013, var_1_10014(iter_37_0)) then
			var_37_2 = true
			pg = var_1_10011
	...
	if not arg_37_2.emojiId then
		if var_37_2 then
			...
			return (var_37_5(var_37_6, iter_37_0.EmojiIconCodeMatch, function(arg_38_0)
				table = var_2_10001
				...
				local var_38_1 = var_2_10003.emoji_small_template.all

				tonumber = var_2_10004

				if var_38_0(var_38_1, var_2_10004(arg_38_0)) then
					string = var_1
...
function var_0_1.GetMessages(arg_39_0)
	...
	local var_39_0 = var_1(var_1_10003)
	...
	local var_39_4 = var_39_2

	var_39_3(var_39_2.getCacheMsgList(var_39_4), function(arg_42_0)
	...
	local var_39_5 = var_39_3.each

	getProxy = var_6
	PlayRoomProxy = var_39_4

	local var_39_6 = var_6(var_39_4)

	var_39_5(var_6.GetChatMsgs(var_39_6), function(arg_43_0)
	...
	var_39_5.sort(arg_39_0.displays, function(arg_44_0, arg_44_1)
...
function var_0_1.InsertMsg(arg_45_0, arg_45_1, arg_45_2)
	...
	local var_45_0 = var_1_10003(var_1_10005)
