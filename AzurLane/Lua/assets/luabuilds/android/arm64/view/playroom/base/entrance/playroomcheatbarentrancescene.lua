...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10004("match_ui_point"))
	...
	var_1_10001(var_2_1, var_4("match_ui_room_list"))
	...
	var_1_10001(var_2_2, var_4("match_ui_point_match"))
	...
	local function var_2_8()
		...
		if var_0.GetMatchFlag(var_4_0) then
			...
			var_4_2(var_4_1, var_2_10003("match_ui_matching2"))
		...
		local var_4_5 = var_2_10003.ON_ADD_SUBLAYER

		Context = var_2_10004

		local var_4_6 = var_2_10004.New
		local var_4_7 = {}

		PlayRoomMainScene = var_2_10007
		var_4_7.viewComponent = var_2_10007
		PlayRoomMainMediator = var_2_10007
		var_4_7.mediator = var_2_10007

		local var_4_8 = {}
		local var_4_9 = arg_2_0

		var_4_8.gameType = var_8.GetGameType(var_4_9)
	...
	local function var_2_11()
		...
		if var_0.GetMatchFlag(var_5_0) then
			...
			var_5_2(var_5_1, var_2_10004("match_ui_matching2"))
		...
		local var_5_5 = var_2_10002.TimeMgr.GetInstance()

		if var_5_4 > var_2.GetServerTime(var_5_5) then
			PlayRoomTools = var_5_3

			var_5_3.ShowPunishementBox(var_5_4)
		...
		PlayRoomEntranceMediator = var_2_10006

		local var_5_8 = var_2_10006.ON_CLICK_MATCH
		local var_5_9 = {}

		PlayRoomConst = var_2_10008
		var_5_9.type = var_2_10008.PLAY_ROOM_TYPE.MATCH

		local var_5_10 = arg_2_0

		var_5_9.gameType = var_8.GetGameType(var_5_10)
	...
	var_1_10001(var_2_9, var_2_10, var_2_11, var_6)
	...
	local function var_2_14()
		...
		var_6_5.gameType = var_8.GetGameType(var_6_6)
	...
	var_1_10001(var_2_12, var_2_13, var_2_14, var_6)
	...
	local function var_2_17()
		...
		pg = var_2_10004
		var_7_2.helps = var_2_10004.gametip.island_help_bar.tip
	...
	var_1_10001(var_2_15, var_2_16, var_2_17, var_6)
	...
	local function var_2_20()
		...
		PlayRoomEntranceMediator = var_2_10003

		var_8_1(var_8_0, var_2_10003.ON_CLICK_CHANGE_CHARACTER)
	...
	var_1_10001(var_2_18, var_2_19, var_2_20, var_6)
...
function var_0_1.didEnter(arg_9_0)
	...
	var_1_10001(var_9_0, var_1_10004.GetPtScrore(arg_9_0:GetGameType()))
	...
	var_1_10002("Island/IslandCheaterTavernIcon/" .. var_9_1, "", arg_9_0.uiPointImage, true)
	...
	if arg_9_0.contextData.params and arg_9_0.contextData.params.skipInit then
		...
		PlayRoomEntranceMediator = var_5

		var_9_2(var_9_3, var_5.REFRESH_ROOM_INFO)
	end
	...
	if var_3.GetInt("barHelp" .. var_9_5, 0) == 0 then
		PlayerPrefs = var_3
	...
	local var_9_6 = var_3(var_5)
	local var_9_7 = var_3.GetMatchFlag(var_9_6)

	setActive = var_5

	var_5(arg_9_0.uiSwitchBtn, not var_9_7)
