...
local var_0_10 = var_0_10009("view.equipment.SpWeaponSortCfg")
...
function var_0_1.init(arg_4_0)
	...
	i18n = var_1_10007
	var_4_14.holder = var_1_10007("search_equipment")
	...
	var_4_14.parent = var_7.Find(var_4_15, "buttons")

	local var_4_16 = arg_4_0.blurPanel

	var_4_14.expand_parent = var_7.Find(var_4_16, "adapt")
	Vector3 = var_7
	var_4_14.anchoredPosition = var_7(-1305, arg_4_0.topPanel.sizeDelta.y * -0.5, 0)
	...
	local var_4_19 = var_3(var_5)

	NotchAdapt = var_4_17

	if var_4_17.CheckNotchRatio == 2 or not var_4_19:CheckLargeScreen() then
	...
	typeof = var_7
	GridLayoutGroup = var_9
	var_4_22(var_4_21, var_7(var_9)).constraintCount = var_4_18 and 8 or 7
	...
	typeof = var_8
	GridLayoutGroup = var_10
	var_4_25(var_4_24, var_8(var_10)).constraintCount = var_4_18 and 8 or 7
	findTF = var_6
	...
	if not var_9.gameset.equip_select_limit.key_value then
		var_4_40 = 0
	end
...
function var_0_1.SetSpWeaponUpdate(arg_15_0)
	...
	if var_15_0 == var_1_10002.WARP_TO_WEAPON and arg_15_0.page == var_0_5 then
		...
		local var_15_1 = arg_15_0.contextData.warp

		StoreHouseConst = var_2

		if var_15_1 == var_2.WARP_TO_DESIGN and arg_15_0.contextData.designPage == var_0_7 then
			arg_15_0:UpdateSpweaponCapacity()
		end
	end
...
function var_0_1.didEnter(arg_16_0)
	...
	local var_16_1 = var_3.Find(var_16_0, "tip")

	i18n = var_1_10004

	var_1_10001(var_16_1, var_1_10004("equipment_select_device_destroy_tip"))

	setActive = var_1_10001

	local var_16_2 = arg_16_0.topItems
	local var_16_3 = var_3.Find(var_16_2, "adapt/stamp")

	getProxy = var_4
	TaskProxy = var_6

	local var_16_4 = var_4(var_6)

	var_1_10001(var_16_3, var_4.mingshiTouchFlagEnabled(var_16_4))

	onButton = var_1_10001

	local var_16_5 = arg_16_0
	local var_16_6 = arg_16_0.topItems
	local var_16_7 = var_4.Find(var_16_6, "adapt/stamp")
	...
	SFX_CONFIRM = var_16_6

	var_1_10001(var_16_5, var_16_7, var_16_8, var_16_6)
	...
	var_1_10001(var_16_9, var_16_10, var_16_11, var_16_6)

	onToggle = var_1_10001

	local var_16_12 = arg_16_0
	local var_16_13 = arg_16_0.equipmentToggle
	local var_16_14 = var_4.Find(var_16_13, "equipment")
	...
	var_1_10001(var_16_12, var_16_14, var_16_15, var_16_13)

	onToggle = var_1_10001

	local var_16_16 = arg_16_0
	local var_16_17 = arg_16_0.equipmentToggle
	local var_16_18 = var_4.Find(var_16_17, "skin")
	...
	var_1_10001(var_16_16, var_16_18, var_16_19, var_16_17)

	onToggle = var_1_10001

	local var_16_20 = arg_16_0
	local var_16_21 = arg_16_0.equipmentToggle
	local var_16_22 = var_4.Find(var_16_21, "spweapon")
	...
	var_1_10001(var_16_20, var_16_22, var_16_23, var_16_21)

	setActive = var_1_10001

	local var_16_24 = arg_16_0.equipmentToggle
	local var_16_25 = var_3.Find(var_16_24, "spweapon")

	LOCK_SP_WEAPON = var_16_22

	var_1_10001(var_16_25, not var_16_22)
	...
	local function var_16_28(arg_22_0)
		if arg_22_0 then
			...
			var_2_10001(var_22_0, var_2_10004.OPEN_DESIGN)
			...
			var_2_10001(var_22_2, var_2_10004.CLOSE_DESIGN_LAYER)
		end
	...
	var_1_10001(var_16_26, var_16_27, var_16_28, var_6)
	...
	local function var_16_31(arg_23_0)
		if arg_23_0 then
			...
			var_23_1(var_23_0, var_2_10004.OPEN_SPWEAPON_DESIGN)
			...
			var_23_4(var_23_3, var_2_10004.CLOSE_SPWEAPON_DESIGN_LAYER)
		end
	...
	var_1_10001(var_16_29, var_16_30, var_16_31, var_6)
	...
	local function var_16_34(arg_24_0)
		...
		var_24_1(var_24_0, var_2_10004.DESIGN_FILTER_CHANGED, arg_16_0.isShowAllDesign)
	...
	var_1(var_16_32, var_16_33, var_16_34, var_6)
	...
	local function var_16_37()
		...
		var_25_0(var_25_1, var_2_10003(var_2_10005)).interactable = false
	...
	var_1(var_16_35, var_16_36, var_16_37, var_6)
	...
	var_1(var_16_38, var_16_39, var_16_40, var_6)
	...
	var_1(var_16_41, var_16_42, var_16_43, var_6)
	...
	local function var_16_46()
		...
		local var_29_0 = var_2_10000(arg_16_0.page, {
			[var_0_3] = function()
				...
				Clone = var_3_10003
				var_30_0.indexDatas = var_3_10003(arg_16_0.contextData.indexDatas)
				...
				function var_30_0.callback(arg_31_0)
					...
					if var_31_1(var_31_0, var_4_10004(var_4_10006)) then
						bit = var_2

						local var_31_2 = var_2.band
						local var_31_3 = arg_31_0.extraIndex

						IndexConst = var_4_10005

						if var_31_2(var_31_3, var_4_10005.EquipmentExtraEquiping) > 0 then
						...
						var_2(var_31_5, var_5.GetShowBusyFlag(var_31_6))
					else
				...
				var_30_1.__index = var_3_10004.EQUIPMENT_INDEX_COMMON
			...
			[var_0_5] = function()
				...
				Clone = var_3_10003
				var_32_0.indexDatas = var_3_10003(arg_16_0.contextData.spweaponIndexDatas)
		...
		var_29_2(var_29_1, var_4.OPEN_EQUIPMENT_INDEX, var_29_0)
	...
	var_1(var_16_44, var_16_45, var_16_46, var_6)
	...
	local function var_16_49()
		...
		local var_34_3 = var_2_10004.EquipSkinIndexAll

		IndexConst = var_2_10005
		var_34_1.equipSkinIndex = var_34_2(var_34_3, var_2_10005.EquipSkinIndexAux)
		IndexConst = var_2
		...
		IndexConst = var_5
		var_34_1.equipSkinTheme = var_34_4(var_34_5, var_5.EquipSkinThemeEnd)
	...
	var_1(var_16_47, var_16_48, var_16_49, var_6)
	...
	local function var_16_61(arg_36_0)
		...
		if arg_36_0 then
			...
			if var_36_0 ~= var_2_10002.WARP_TO_MATERIAL then
				...
				var_36_0(var_36_1, var_2_10004("equipment_select_materials_tip"))
	...
	var_1(var_16_59, var_16_60, var_16_61, var_6)
		...
		if arg_37_0 then
			...
			if var_2_10001 ~= var_2_10002.WARP_TO_WEAPON then
				...
				if arg_16_0.page == var_0_4 then
					...
					var_2_10001(var_3.Find(var_37_0, "skin"), true)
				elseif arg_16_0.page == var_0_5 then
					triggerToggle = var_2_10001

					local var_37_1 = arg_16_0.equipmentToggle

					var_2_10001(var_3.Find(var_37_1, "spweapon"), true)
				else
					triggerToggle = var_2_10001

					local var_37_2 = arg_16_0.equipmentToggle

					var_2_10001(var_3.Find(var_37_2, "equipment"), true)
				end
			end
		else
			setActive = var_2_10001
	...
	var_1(var_16_62, var_16_63, var_16_64, var_6)
	...
	local function var_16_67(arg_38_0)
		if arg_38_0 then
			...
			var_2_10001(var_38_0, var_2_10004.CLOSE_DESIGN_LAYER)
			...
			var_2_10001(var_38_1, var_2_10004.CLOSE_SPWEAPON_DESIGN_LAYER)
		end
		...
		if arg_38_0 then
			...
			LOCK_SP_WEAPON = var_2_10004
			var_2_10004 = not var_2_10004
		end

		var_2_10001(var_38_2, var_2_10004)
	...
	var_1(var_16_65, var_16_66, var_16_67, var_6)
	...
	var_1(var_16_68, var_16_69, var_16_70, var_6)
	...
	local function var_16_73()
		...
		if var_40_0 == var_2_10001.DESTROY then
			...
			StoreHouseConst = var_1
			var_40_1.mode = var_1.OVERVIEW
	...
	var_1(var_16_71, var_16_72, var_16_73, var_6)
	...
	var_1(var_16_74, var_16_75, var_16_76, var_6)
	...
	local function var_16_79()
		...
		if var_2_10001.any(arg_16_0.selectedIds, function(arg_43_0)
			...
			var_1.insert(var_42_0, function(arg_44_0)
				...
				var_44_2(var_44_1, var_44_3, var_3_10005.map(arg_16_0.selectedIds, function(arg_45_0)
	...
	var_1(var_16_77, var_16_78, var_16_79, var_6)
...
function var_0_1.updateCapacity(arg_53_0)
	...
	var_53_0(var_53_1, var_53_2 .. var_53_3 .. var_6.getMaxEquipmentBag(var_53_4))
...
function var_0_1.setShip(arg_56_0, arg_56_1)
	...
	var_1_10002(var_56_0, not var_1_10005(arg_56_1))
...
function var_0_1.setPlayer(arg_57_0, arg_57_1)
	...
	if var_57_0 == var_1_10003.WARP_TO_WEAPON and arg_57_0.page == var_0_3 then
		...
		local var_57_1 = arg_57_0.contextData.warp

		StoreHouseConst = var_3

		if var_57_1 == var_3.WARP_TO_DESIGN and arg_57_0.contextData.designPage == var_0_6 then
			arg_57_0:updateCapacity()
		end
	end
...
function var_0_1.initSort(arg_58_0)
	...
	for iter_58_0, iter_58_1 in var_1(var_0_9.sort) do
		if iter_58_0 <= arg_58_0.sortContain.childCount then
			local var_58_0 = arg_58_0.sortContain
			local var_58_1

			if not var_58_1.GetChild(var_58_0, iter_58_0 - 1) then
				cloneTplTo = var_58_1
				var_58_1 = var_58_1(arg_58_0.sortTpl, arg_58_0.sortContain)
			end

			setActive = var_1_10007

			var_1_10007(var_58_1, true)

			setImageSprite = var_1_10007
			findTF = var_9

			local var_58_2 = var_9(var_58_1, "Image")

			GetSpriteFromAtlas = var_10

			var_1_10007(var_58_2, var_10("ui/equipmentui_atlas", iter_58_1.spr), true)

			onToggle = var_1_10007

			local var_58_3 = arg_58_0
			local var_58_4 = var_58_1

			local function var_58_5(arg_61_0)
				if arg_61_0 then
			...
			var_1_10007(var_58_3, var_58_4, var_58_5, var_12)

			var_1_10007 = arg_58_0.sortButtons
			var_1_10007[iter_58_0] = var_58_1
		end
	end
...
function var_0_1.UpdateWeaponWrapButtons(arg_62_0)
	...
	var_1_10002(var_62_1, var_62_2 == var_1_10006.OVERVIEW)
	...
	var_1_10002(var_62_3, var_62_4 == var_6.OVERVIEW and not arg_62_0.contextData.shipId)
...
function var_0_1.updatePageFilterButtons(arg_63_0, arg_63_1)
	...
	for iter_63_0, iter_63_1 in var_1_10002(var_0_9.sort) do
		...
		var_1_10007(var_63_0, var_10.contains(iter_63_1.pages, arg_63_1))
	end
...
function var_0_1.initEquipment(arg_69_0, arg_69_1)
	...
	local function var_69_3()
		if arg_69_0.page == var_0_4 then
			...
			var_70_1(var_70_0, var_2_10003.ON_UNEQUIP_EQUIPMENT_SKIN)
		elseif arg_69_0.page == var_0_3 then
			...
			var_70_3(var_70_2, var_2_10003.ON_UNEQUIP_EQUIPMENT)
		end
	...
	var_1_10003(var_69_1, var_69_2, var_69_3, var_1_10008)
	...
	var_1_10003(var_69_4, var_69_5, var_69_6, var_1_10008)
...
function var_0_1.updateEquipment(arg_72_0, arg_72_1, arg_72_2)
	...
	var_72_0.update(var_72_2, var_72_1)
	...
	if var_72_1 then
		...
		for iter_72_0, iter_72_1 in var_72_2(arg_72_0.selectedIds) do
			if var_72_1.id == iter_72_1[1] then
				var_72_3 = true
				var_72_4 = iter_72_1[2]
	...
	var_72_0:updateSelected(var_72_3, var_72_4)
	...
	if not var_72_1 then
		...
		local var_72_5 = var_72_1

		SpWeapon = var_10

		if var_7(var_72_5, var_10) then
			onButton = var_7
			...
			local function var_72_8()
				if arg_72_0.shipVO then
					...
					var_73_0.oldSpWeaponUid = var_2_10001.GetUID(var_73_1)

					local var_73_2 = var_72_1

					var_73_0.oldShipId = var_2_10001.GetShipId(var_73_2)
					...
					if not var_73_0 then
						...
						if var_73_0.GetShipId(var_73_3) then
							var_73_0 = {}
							EquipmentInfoMediator = var_2_10001
							var_73_0.type = var_2_10001.TYPE_DISPLAY

							local var_73_4 = var_72_1

							var_73_0.spWeaponUid = var_2_10001.GetUID(var_73_4)

							local var_73_5 = var_72_1

							var_73_0.shipId = var_2_10001.GetShipId(var_73_5)

							if not var_73_0 then
								var_73_0 = {}
								EquipmentInfoMediator = var_2_10001
								var_73_0.type = var_2_10001.TYPE_DEFAULT
			...
			var_7(var_72_6, var_72_7, var_72_8, var_1_10012)
		elseif var_72_0.equipmentVO.isSkin then
			if var_72_1.shipId then
				onButton = var_7

				local var_72_9 = arg_72_0
				local var_72_10 = var_72_0.go

				local function var_72_11()
					...
					var_74_3(var_74_2, var_5.ON_EQUIPMENT_SKIN_INFO, var_72_1.id, arg_72_0.contextData.pos, {
						id = var_74_0,
						pos = var_74_1
					})
				...
				var_7(var_72_9, var_72_10, var_72_11, var_1_10012)
			else
				onButton = var_7
				...
				local function var_72_14()
					...
					var_75_1(var_75_0, var_2_10003.ON_EQUIPMENT_SKIN_INFO, var_72_1.id, arg_72_0.contextData.pos)
				...
				var_7(var_72_12, var_72_13, var_72_14, var_1_10012)
			end
		elseif var_72_1.mask then
			...
			local var_72_15 = arg_72_0.mode

			StoreHouseConst = var_8

			if var_72_15 == var_8.DESTROY then
				onButton = var_72_15

				local var_72_16 = arg_72_0
				local var_72_17 = var_72_0.go

				local function var_72_18()
				...
				var_72_15(var_72_16, var_72_17, var_72_18, var_1_10012)
			else
				onButton = var_72_15

				local var_72_19 = arg_72_0
				local var_72_20 = var_72_0.go

				local function var_72_21()
					if arg_72_0.shipVO then
						local var_77_0 = {}
				...
				var_72_15(var_72_19, var_72_20, var_72_21, var_1_10012)
			end
		end
	end
...
function var_0_1.updateEquipmentCount(arg_79_0, arg_79_1)
	...
	var_2(var_79_1, var_5("list_empty_tip_storehouseui_equip"))
...
function var_0_1.filterEquipment(arg_80_0)
	...
	var_2("ui/share/index_atlas", var_80_0, function(arg_81_0)
	...
	for iter_80_0, iter_80_1 in var_3(arg_80_0.equipmentVOs) do
		if not iter_80_1.isSkin then
			...
			var_8.insert(var_80_1, iter_80_1)
		end
	end
	...
	for iter_80_4, iter_80_3 in var_4(var_80_1) do
		var_1_10009 = iter_80_3.count

		if (0 < var_1_10009 or iter_80_3.shipId) and arg_80_0:checkFitBusyCondition(iter_80_3) then
			IndexConst = var_1_10009

			if var_1_10009.filterEquipByType(iter_80_3, arg_80_0.contextData.indexDatas.typeIndex) then
				IndexConst = var_1_10009

				if var_1_10009.filterEquipByProperty(iter_80_3, var_80_2) then
					IndexConst = var_1_10009
	...
	local var_80_3 = arg_80_0.searchBar

	if var_4.GetInputText(var_80_3) and var_4 ~= "" then
		underscore = var_5
		arg_80_0.loadEquipmentVOs = var_5.filter(arg_80_0.loadEquipmentVOs, function(arg_82_0)
	...
	if arg_80_0.contextData.sortData then
		...
		local var_80_5 = iter_80_4.sort

		var_1_10009 = arg_80_0.loadEquipmentVOs
		CompareFuncs = var_1_10010

		var_80_5(var_1_10009, var_1_10010(var_0_9.sortFunc(var_5, var_80_4)))
	end
	...
	local var_80_6 = arg_80_0.sortBtn
	local var_80_7 = var_8.Find(var_80_6, "Image")

	GetSpriteFromAtlas = var_1_10009

	var_6(var_80_7, var_1_10009("ui/equipmentui_atlas", var_5.spr), true)
...
function var_0_1.filterEquipSkin(arg_83_0)
	...
	for iter_83_0, iter_83_1 in var_1_10006(arg_83_0.equipmentVOs) do
	...
	if arg_83_0.filterImportance ~= nil then
		for iter_83_4 = #arg_83_0.loadEquipmentVOs, 1, -1 do
			if arg_83_0.loadEquipmentVOs[iter_83_4].isSkin or not var_10.isSkin and var_10:isImportance() then
				table = var_1_10011

				var_1_10011.remove(arg_83_0.loadEquipmentVOs, iter_83_4)
			end
		end
	end
	...
	if arg_83_0.contextData.sortData then
		...
		var_83_7(var_83_8, var_1_10011(var_0_9.sortFunc(var_6, var_83_6)))
	end
...
function var_0_1.filterSpWeapon(arg_84_0)
	...
	var_1_10003("ui/share/index_atlas", var_84_0, function(arg_85_0)
		setImageSprite = var_2_10001
	...
	for iter_84_0, iter_84_1 in var_5(arg_84_0.spweaponVOs) do
		...
		if var_1_10010.filterSpWeaponByType(iter_84_1, var_84_1) then
			IndexConst = var_1_10010

			if var_1_10010.filterSpWeaponByRarity(iter_84_1, var_84_2) and arg_84_0:checkFitBusyCondition(iter_84_1) and (arg_84_0.filterImportance == nil or iter_84_1:IsImportant()) then
				table = var_1_10010
	...
	local var_84_3 = arg_84_0.searchBar

	if var_5.GetInputText(var_84_3) and var_5 ~= "" then
		EquipmentTools = var_6

		local var_84_4 = var_6.GetMatchSpEquipmentListKeyByShip(var_5)

		underscore = var_84_3
		arg_84_0.loadEquipmentVOs = var_84_3.filter(arg_84_0.loadEquipmentVOs, function(arg_86_0)
			local var_86_0

			if not arg_86_0:IsMatchKey(var_0) then
				table = var_86_0
				var_86_0 = var_86_0.contains(var_84_4, arg_86_0.id)
			end
	...
	if arg_84_0.contextData.spweaponSortData then
		local var_84_5 = arg_84_0.asc

		table = iter_84_0

		local var_84_6 = iter_84_0.sort

		var_1_10010 = arg_84_0.loadEquipmentVOs
		CompareFuncs = var_1_10011

		var_84_6(var_1_10010, var_1_10011(var_0_10.sortFunc(var_6, var_84_5)))
	end
	...
	local var_84_7 = arg_84_0.sortBtn
	local var_84_8 = var_9.Find(var_84_7, "Image")

	GetSpriteFromAtlas = var_1_10010

	var_7(var_84_8, var_1_10010("ui/equipmentui_atlas", var_6.spr), true)
...
function var_0_1.Scroll2Equip(arg_89_0, arg_89_1)
	...
	for iter_89_0, iter_89_1 in var_89_0(arg_89_0.loadEquipmentVOs) do
		...
		if var_1_10007.SameEquip(iter_89_1, arg_89_1) then
			...
			typeof = var_10
			GridLayoutGroup = var_1_10012

			local var_89_3 = var_1_10007(var_89_2, var_10(var_1_10012)).cellSize.y + var_1_10007.spacing.y
			...
			var_1_10012 = arg_89_0

			arg_89_0.ScrollEquipPos(var_1_10012, var_89_4 - arg_89_0.equipmentRect.paddingFront)
...
function var_0_1.ScrollEquipPos(arg_90_0, arg_90_1)
	...
	local var_90_3 = var_90_2(var_90_1, var_5(var_1_10007)).cellSize.y + var_2.spacing.y
...
function var_0_1.checkFitBusyCondition(arg_91_0, arg_91_1)
	if arg_91_1.shipId then
		...
		if arg_91_0:GetShowBusyFlag() then
			var_91_0 = arg_91_0.mode
			StoreHouseConst = var_1_10003

			if var_91_0 == var_1_10003.DESTROY then
				var_91_0 = false
...
function var_0_1.sortItems(arg_97_0)
	...
	var_1(var_97_3, var_4("list_empty_tip_storehouseui_item"))
...
function var_0_1.updateItem(arg_102_0, arg_102_1, arg_102_2)
	...
	tobool = var_5
	getProxy = var_102_2
	TechnologyProxy = var_1_10009

	local var_102_3 = var_102_2(var_1_10009)
	local var_102_5, var_102_6

	if var_5(var_7.getItemCanUnlockBluePrint(var_102_3, var_102_1.id)) then
		getProxy = var_5
		TechnologyProxy = var_7

		local var_102_4 = var_5(var_7)

		underscore = var_102_5
		var_102_5 = var_102_5.map
		var_102_6 = var_102_4
		var_102_5 = var_102_5(var_102_4.getItemCanUnlockBluePrint(var_102_6, var_102_1.id), function(arg_103_0)
		...
		if var_7.detect(var_102_5, function(arg_104_0)
			...
			local function var_102_8()
				...
				MSGBOX_TYPE_BLUEPRINT_UNLOCK_ITEM = var_2_10004
				var_105_2.type = var_2_10004
				...
				function var_105_2.onYes()
					...
					local var_106_2 = var_3_10003.ITEM_GO_SCENE

					SCENE = var_3_10004

					var_106_1(var_106_0, var_106_2, var_3_10004.SHIPBLUEPRINT, {
				...
				i18n = var_4
				var_105_2.yesText = var_4("text_forward")
			...
			var_8(var_102_6, var_102_7, var_102_8, var_1_10013)
		else
			onButton = var_8
			var_102_6 = arg_102_0

			local var_102_9 = var_102_0.go

			local function var_102_10()
				pg = var_2_10000
				...
				Vector2 = var_2_10004
				var_107_2.windowSize = var_2_10004(1010, 685)
				...
				function var_107_2.onYes()
					...
					var_108_2.type = var_3_10004
					i18n = var_3_10004
					var_108_2.content = var_3_10004("techpackage_item_use_confirm")
					underscore = var_4

					local var_108_3 = var_4.map
					local var_108_4 = var_102_1

					var_108_2.items = var_108_3(var_6.getConfig(var_108_4, "display_icon"), function(arg_109_0)
						return {
							type = arg_109_0[1],
							id = arg_109_0[2],
							count = arg_109_0[3]
					...
					function var_108_2.onYes()
						...
						var_110_1(var_110_0, var_4_10003.ON_USE_ITEM, var_102_1.id, 1)
			...
			var_8(var_102_6, var_102_9, var_102_10, var_1_10013)
		end

		goto label_102_0
	end

	local var_102_11 = var_102_1:getConfig("type")

	Item = var_102_5

	if var_102_11 == var_102_5.INVITATION_TYPE then
		onButton = var_102_11
		...
		local function var_102_14()
			...
			local var_111_2 = var_2_10003.ITEM_GO_SCENE

			SCENE = var_2_10004

			var_111_1(var_111_0, var_111_2, var_2_10004.INVITATION, {
				itemVO = var_102_1
			})
		...
		var_102_11(var_102_12, var_102_13, var_102_14, var_102_6)
	...
	if var_102_16 ~= var_6.ASSIGNED_TYPE then
		var_102_15 = var_102_1
		var_102_16 = var_102_1.getConfig(var_102_15, "type")
		Item = var_6

		if var_102_16 == var_6.EQUIPMENT_ASSIGNED_TYPE then
			underscore = var_102_16
			var_102_16 = var_102_16.any
			pg = var_102_15

			if var_102_16(var_102_15.gameset.general_blueprint_list.description, function(arg_112_0)
				return var_102_1.id == arg_112_0
			end) then
				onButton = var_102_16

				local var_102_17 = arg_102_0
				local var_102_18 = var_102_0.go

				local function var_102_19()
				...
				var_102_16(var_102_17, var_102_18, var_102_19, var_102_6)
			else
				onButton = var_102_16

				local var_102_20 = arg_102_0
				local var_102_21 = var_102_0.go

				local function var_102_22()
				...
				var_102_16(var_102_20, var_102_21, var_102_22, var_102_6)
			end
		else
			Item = var_102_16
			...
			if var_102_16.IsLoveLetterCheckItem(var_102_1.id) then
				...
				local var_102_23 = arg_102_0
				local var_102_24 = var_102_0.go

				local function var_102_25()
				...
				var_5(var_102_23, var_102_24, var_102_25, var_102_6)
			else
				local var_102_26 = var_102_1:getConfig("type")

				Item = var_6

				if var_102_26 == var_6.LOVE_LETTER_TYPE then
					onButton = var_102_26

					local var_102_27 = arg_102_0
					local var_102_28 = var_102_0.go

					local function var_102_29()
					...
					var_102_26(var_102_27, var_102_28, var_102_29, var_102_6)
				else
					local var_102_30 = var_102_1:getConfig("type")

					Item = var_6

					if var_102_30 == var_6.SKIN_ASSIGNED_TYPE then
						onButton = var_102_30

						local var_102_31 = arg_102_0
						local var_102_32 = var_102_0.go

						local function var_102_33()
							...
							var_0.emit(var_117_0, var_0_1.ON_ITEM, var_102_1.id, function()
								...
								if var_1.IsAllSkinOwner(var_118_2) then
									...
									var_118_4.type = var_3_10004
									var_118_4.id = var_118_1[5]

									local var_118_5 = var_118_3(var_118_4)
									local var_118_6 = arg_102_0.msgBox

									var_118_0 = var_118_0.ExecuteAction

									local var_118_7 = "Show"
									local var_118_8 = {}

									i18n = var_3_10007
									var_3_10009 = "blackfriday_pack_select_skinall_dialog"

									local var_118_9 = var_102_1

									var_118_8.content = var_3_10007(var_3_10009, var_3_10010.getConfig(var_118_9, "name"), var_118_5:getName())

									local var_118_10 = {
										count = 1
									}

									DROP_TYPE_ITEM = var_3_10008
									var_118_10.type = var_3_10008
									var_118_10.id = var_102_1.id
									var_118_8.leftDrop = var_118_10
									var_118_8.rightDrop = var_118_5

									function var_118_8.onYes()
										local var_119_0 = arg_102_0
										local var_119_1 = var_0.emit

										EquipmentMediator = var_4_10003

										var_119_1(var_119_0, var_4_10003.ON_USE_ITEM, var_102_1.id, 1, {
											0
										})
									...
									var_118_0(var_118_6, var_118_7, var_118_8)
								else
									local var_118_11 = {}

									ipairs = var_118_0

									for iter_118_0, iter_118_1 in var_118_0(var_118_1[2]) do
										var_118_11[iter_118_1] = true
									end

									local var_118_12 = arg_102_0
									local var_118_13 = var_2.emit

									EquipmentMediator = iter_118_0

									local var_118_14 = iter_118_0.ITEM_ADD_LAYER

									Context = iter_118_1

									local var_118_15 = iter_118_1.New
									local var_118_16 = {}

									NewSelectSkinLayer = var_3_10009
									var_118_16.viewComponent = var_3_10009
									NewSkinAtlasMediator = var_3_10009
									var_118_16.mediator = var_3_10009

									local var_118_17 = {}

									SelectSkinLayer = var_3_10010
									var_118_17.mode = var_3_10010.MODE_SELECT
									var_118_17.itemId = var_102_1.id
									underscore = var_10

									local var_118_18 = var_10.map
									local var_118_19 = var_102_1

									var_118_17.selectableSkinList = var_118_18(var_12.GetValidSkinList(var_118_19), function(arg_120_0)
										...
										if not var_118_11[arg_120_0] then
											var_120_2 = false
										end
									...
									function var_118_17.OnConfirm(arg_121_0)
										local var_121_0 = arg_102_0
										local var_121_1 = var_1.emit

										EquipmentMediator = var_4_10004

										var_121_1(var_121_0, var_4_10004.ON_USE_ITEM, var_102_1.id, 1, {
											arg_121_0
										})
									...
									var_118_16.data = var_118_17

									var_118_13(var_118_12, var_118_14, var_118_15(var_118_16))
								end
						...
						var_102_30(var_102_31, var_102_32, var_102_33, var_102_6)
					else
						onButton = var_102_30
						...
						var_102_30(var_102_34, var_102_35, var_102_36, var_102_6)
					end
				end
			end
		end
...
function var_0_1.selectEquip(arg_125_0, arg_125_1, arg_125_2)
	...
	local var_125_0 = arg_125_0.mode

	StoreHouseConst = var_1_10004

	if var_125_0 == var_1_10004.DESTROY then
		...
		for iter_125_0, iter_125_1 in var_6(arg_125_0.selectedIds) do
			if iter_125_1[1] == arg_125_1.id then
				var_125_1 = true
				var_125_2 = iter_125_0
				var_125_3 = iter_125_1[2]
		...
		if not var_125_1 then
			local var_125_4, var_125_5 = arg_125_0.checkEquipment(arg_125_1, function()
			...
			if not var_125_4 then
				if var_125_5 then
					pg = var_8

					local var_125_6 = var_8.TipsMgr.GetInstance()

					var_8.ShowTips(var_125_6, var_125_5)
				end

				return
			end

			local var_125_7 = arg_125_0:selectCount()

			if arg_125_0.selectedMax > 0 and var_125_7 + arg_125_2 > arg_125_0.selectedMax then
				arg_125_2 = arg_125_0.selectedMax - var_125_7
			end

			if arg_125_0.selectedMax == 0 or var_125_7 < arg_125_0.selectedMax then
				table = var_9
				...
				if arg_125_0.selectedMax == 1 then
					var_125_8 = arg_125_0.selectedIds
					var_125_8[1] = {
						arg_125_1.id,
						arg_125_2
					}
					...
					local var_125_9 = var_125_8.TipsMgr.GetInstance()
					local var_125_10 = var_9.ShowTips

					i18n = var_1_10012

					var_125_10(var_125_9, var_1_10012("equipment_equipmentScene_selectError_more", arg_125_0.selectedMax))
			...
			if var_125_3 - arg_125_2 > 0 then
				var_125_11 = arg_125_0.selectedIds[var_125_2]
				var_125_11[2] = var_125_3 - arg_125_2
			else
				table = var_125_11

				var_125_11.remove(arg_125_0.selectedIds, var_125_2)
			end
		end
	end
...
function var_0_1.checkDestroyGold(arg_128_0, arg_128_1, arg_128_2)
	...
	if var_5.GoldMax(var_128_5, var_128_0) then
		...
		local var_128_8 = var_8("gold_max_tip_title")

		i18n = iter_128_1

		var_128_7(var_128_6, var_128_8 .. iter_128_1("resource_max_tip_destroy"))
...
function var_0_1.updateSelected(arg_129_0)
	...
	if var_129_2 == var_2.DESTROY then
		...
		if arg_129_0.selectedMax == 0 then
			...
			var_2(iter_129_0(arg_129_0.selectPanel, "bottom_info/bg_input/count"), var_129_3)
		else
			setText = var_2
			findTF = iter_129_0

			var_2(iter_129_0(arg_129_0.selectPanel, "bottom_info/bg_input/count"), var_129_3 .. "/" .. arg_129_0.selectedMax)
		end
		...
		if #arg_129_0.selectedIds < arg_129_0.selectedMin then
			...
			var_2(iter_129_0(arg_129_0.selectPanel, "confirm_button/mask"), true)
		else
			setActive = var_2
			findTF = iter_129_0

			var_2(iter_129_0(arg_129_0.selectPanel, "confirm_button/mask"), false)
		end
	end
