...
function var_0_1.init(arg_5_0)
	...
	var_1(var_5_15, var_4("list_empty_tip_equipmentdesignui"))
...
function var_0_1.didEnter(arg_8_0)
	...
	var_2(var_8_5, var_8_6, var_8_7, var_1_10007)
	...
	var_2(var_8_8, var_8_9, var_8_10, var_1_10007)
	...
	local function var_8_13()
		...
		IndexConst = var_2_10007
		var_11_18[1] = var_2_10007.EquipmentTypeSmallCannon
		IndexConst = var_7
		var_11_18[2] = var_7.EquipmentTypeMediumCannon
		IndexConst = var_7
		var_11_18[3] = var_7.EquipmentTypeBigCannon
		...
		IndexConst = var_7
		var_11_23[1] = var_7.EquipmentTypeWarshipTorpedo
		IndexConst = var_7
		var_11_23[2] = var_7.EquipmentTypeSubmaraineTorpedo
		...
		EquipmentDesignMediator = var_4

		var_11_26(var_11_25, var_4.OPEN_EQUIPMENTDESIGN_INDEX, var_11_0)
	...
	var_2(var_8_11, var_8_12, var_8_13, var_1_10007)
	arg_8_0:initTags()
...
function var_0_1.initTags(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1(var_0_2) do
		if iter_14_0 <= arg_14_0.tagContainer.childCount then
			local var_14_0 = arg_14_0.tagContainer
			local var_14_1

			if not var_14_1.GetChild(var_14_0, iter_14_0 - 1) then
				cloneTplTo = var_14_1
				var_14_1 = var_14_1(arg_14_0.tagTpl, arg_14_0.tagContainer)
			end
			...
			local var_14_2 = var_9(var_14_1, "Image")

			GetSpriteFromAtlas = var_10

			var_1_10007(var_14_2, var_10("ui/equipmentdesignui_atlas", iter_14_1))
			...
			local function var_14_5(arg_17_0)
				if arg_17_0 then
			...
			var_1_10007(var_14_3, var_14_4, var_14_5, var_12)

			table = var_1_10007

			var_1_10007.insert(arg_14_0.tagTFs, var_14_1)
...
local function var_0_3(arg_22_0, arg_22_1)
	...
	local var_22_1 = var_5(arg_22_0, "name_bg/tag")
	...
	local var_22_3 = var_1_10009.type2Tag
	local var_22_4 = arg_22_1

	var_1_10003(var_22_1, var_1_10006(var_22_2, var_22_3(arg_22_1.getConfig(var_22_4, "type"))))

	eachChild = var_1_10003

	var_1_10003(var_22_0, function(arg_23_0)
		setActive = var_2_10001
	...
	local var_22_6 = var_4.filter(var_22_5, function(arg_24_0)
		local var_24_1
	...
	if not var_22_7 or not arg_22_1:isDevice() or not {
		1,
		2,
		5
	} then
	...
	for iter_22_0, iter_22_1 in var_7(var_22_8) do
		local var_22_9 = var_22_0:Find("attr_" .. iter_22_1)

		setActive = var_22_4

		var_22_4(var_22_9, true)

		if iter_22_1 == 5 then
			setText = var_22_4

			local var_22_10 = var_22_9:Find("value")

			getSkillName = var_16

			var_22_4(var_22_10, var_16(var_22_7))
		else
			var_22_4 = ""

			local var_22_11 = ""
			local var_22_12 = #var_22_6

			if 0 < var_22_12 then
				table = var_22_12
				var_22_12 = var_22_12.remove(var_22_6, 1)
				Equipment = var_16
				var_22_4, var_22_11 = var_16.GetInfoTrans(var_22_12)
			end

			setText = var_22_12

			var_22_12(var_22_9:Find("tag"), var_22_4)

			setText = var_22_12

			var_22_12(var_22_9:Find("value"), var_22_11)
		end
	end
...
function var_0_1.createDesign(arg_25_0, arg_25_1)
	...
	local var_25_1 = var_1_10003(arg_25_1, "mask")
	local var_25_2 = arg_25_1
	local var_25_3 = arg_25_1.Find(var_25_2, "name_bg/mask/name")
	local var_25_4 = {
		go = arg_25_1,
		nameTxt = var_25_3
	}

	ClearTweenItemAlphaAndWhite = var_25_2

	var_25_2(var_25_4.go)

	function var_25_4.getItemById(arg_26_0, arg_26_1)
		local var_26_0
	...
	function var_25_4.update(arg_27_0, arg_27_1, arg_27_2)
		...
		TweenItemAlphaAndWhite = var_2_10005

		var_2_10005(arg_27_0.go)

		Equipment = var_2_10005

		local var_27_2 = var_2_10005.getConfigData(var_27_1)
		...
		var_6(var_27_3, var_9(var_27_2.name, 6))
		...
		local function var_27_6()
			...
			if var_28_0.count >= var_27_0.material_num then
				...
				COLOR_WHITE = var_3_10005

				if not var_2(var_28_2, var_3_10005) then
					::label_28_0::
					...
					COLOR_RED = var_3_10005
					var_28_1 = var_2(var_28_3, var_3_10005)
				end
	...
	function var_25_4.clear(arg_29_0)
...
function var_0_1.initDesign(arg_30_0, arg_30_1)
	...
	local var_30_2 = var_1_10006(var_30_0.go)
	local var_30_3 = var_6.Find(var_30_2, "info/make_btn")

	local function var_30_4()
		local var_31_0 = arg_30_0

		var_0.showDesignDesc(var_31_0, var_30_0.designId)
	...
	var_1_10003(var_30_1, var_30_3, var_30_4, var_30_2)
	...
	local var_30_6 = var_30_3(var_30_0.go)
	local var_30_7 = var_6.Find(var_30_6, "look")

	local function var_30_8()
		local var_32_0 = arg_30_0.obtainWayPage

		var_0.ExecuteAction(var_32_0, "Show", var_30_0.designId)
	...
	var_1_10003(var_30_5, var_30_7, var_30_8, var_30_6)
...
function var_0_1.getDesignVO(arg_35_0, arg_35_1)
	...
	math = var_1_10005
	var_35_0.canMakeCount = var_1_10005.floor(var_4 / var_35_1[arg_35_1].material_num)
	math = var_5
	...
	local var_35_4 = var_35_2.getConfigData(var_35_3)
...
function var_0_1.filter(arg_38_0, arg_38_1, arg_38_2)
	...
	var_1_10004("ui/share/index_atlas", var_38_0, function(arg_39_0)
	...
	local var_38_1 = var_1_10004.compose_data_template
	local var_38_2 = {}
	...
	local var_38_4 = var_7(var_1_10009)

	ipairs = var_8

	for iter_38_0, iter_38_1 in var_8(var_38_1.all) do
		pg = var_1_10013
		var_1_10013 = var_1_10013.compose_data_template[iter_38_1]
		var_1_10016 = arg_38_0

		local var_38_5 = arg_38_0.getItemById(var_1_10016, var_1_10013.material_id).count

		if 0 < var_38_5 or arg_38_0.contextData.isShowAllDesign and var_38_4:ShouldShowEquipmentDesignObtainWay(iter_38_1) then
			table = var_38_5

			var_38_5.insert(var_38_2, iter_38_1)
		end
	end
	...
	for iter_38_2, iter_38_3 in var_10(var_38_2) do
		local var_38_8 = arg_38_0:getDesignVO(iter_38_3)

		IndexConst = var_1_10016

		if var_1_10016.filterEquipByType(var_38_8, arg_38_0.contextData.indexDatas.typeIndex) then
			IndexConst = var_1_10016

			if var_1_10016.filterEquipByProperty(var_38_8, var_38_7) then
				IndexConst = var_1_10016

				if var_1_10016.filterEquipAmmo1(var_38_8, arg_38_0.contextData.indexDatas.equipAmmoIndex1) then
					IndexConst = var_1_10016

					if var_1_10016.filterEquipAmmo2(var_38_8, arg_38_0.contextData.indexDatas.equipAmmoIndex2) then
						IndexConst = var_1_10016

						if var_1_10016.filterEquipByCamp(var_38_8, arg_38_0.contextData.indexDatas.equipCampIndex) then
							IndexConst = var_1_10016

							if var_1_10016.filterEquipByRarity(var_38_8, arg_38_0.contextData.indexDatas.rarityIndex) then
								table = var_1_10016

								var_1_10016.insert(var_38_6, iter_38_3)
							end
						end
					end
				end
	...
	local var_38_9 = arg_38_0.scollRect

	var_10.SetTotalCount(var_38_9, #var_38_6, arg_38_2 and -1 or 0)
	...
	local var_38_10 = var_10("ui/equipmentdesignui_atlas", var_0_2[arg_38_1])

	setImageSprite = var_11

	local var_38_11 = arg_38_0.sortBtn

	var_11(var_13.Find(var_38_11, "Image"), var_38_10)
...
function var_0_1.showDesignDesc(arg_47_0, arg_47_1)
	...
	local var_47_2 = var_1_10003.compose_data_template[arg_47_1].equip_id

	Equipment = var_5

	local var_47_3 = var_5.New({
		id = var_47_2
	})

	updateEquipInfo = var_1_10006

	var_1_10006(var_47_1:Find("bg/attrs/content"), var_47_3:GetPropertiesInfo(), var_47_3:GetSkill())

	local var_47_4 = var_47_1:Find("bg/frame/icon")

	GetImageSpriteFromAtlasAsync = var_7

	var_7("equips/" .. var_47_3:getConfig("icon"), "", var_47_4)

	changeToScrollText = var_7

	var_7(var_47_1:Find("bg/name"), var_47_3:getConfig("name"))

	UIItemList = var_7

	local var_47_5 = var_7.New(var_47_1:Find("bg/frame/stars"), var_47_1:Find("bg/frame/stars/sarttpl"))

	var_7.align(var_47_5, var_47_3:getConfig("rarity"))

	setImageSprite = var_8
	findTF = var_47_5

	local var_47_6 = var_47_5(var_47_1, "bg/frame/type")

	GetSpriteFromAtlas = var_11

	local var_47_7 = "equiptype"

	EquipType = var_14

	var_8(var_47_6, var_11(var_47_7, var_14.type2Tag(var_47_3:getConfig("type"))))

	setText = var_8

	local var_47_8 = var_47_1:Find("bg/frame/speciality/Text")
	local var_47_9
	...
	var_8(var_47_8, var_47_9)

	LoadSprite = var_8

	local var_47_10 = var_8("bg/equipment_bg_" .. var_47_3:getConfig("rarity"))
	local var_47_11 = var_47_1:Find("bg/frame")
	local var_47_12 = var_9.GetComponent

	typeof = var_12
	Image = var_14

	local var_47_13 = var_47_12(var_47_11, var_12(var_14))

	var_47_13.sprite = var_47_10
	findTF = var_47_13

	local var_47_14 = var_47_13(var_47_1, "bg/frame/numbers")
	local var_47_15
	...
	for iter_47_0 = 0, var_47_14.childCount - 1 do
		local var_47_16 = var_47_14:GetChild(iter_47_0)

		setActive = var_16

		var_16(var_47_16, iter_47_0 == var_47_15)
	end

	local var_47_17 = arg_47_0:getItemById(var_3.material_id)

	math = var_12

	local var_47_18 = var_12.floor(var_47_17.count / var_3.material_num)
	local var_47_19 = 1
	local var_47_20 = var_47_1:Find("bg/calc/values/Text")
	local var_47_21 = var_3.gold_num
	local var_47_22 = var_47_1:Find("bg/calc/gold/Text")

	;(function(arg_48_0)
		setText = var_2_10001

		var_2_10001(var_47_20, arg_48_0)

		setText = var_2_10001

		var_2_10001(var_47_22, arg_48_0 * var_47_21)
	...
	local var_47_23 = var_20(var_47_1, "bg/calc/minus")
	local var_47_24 = 0.5

	local function var_47_25(arg_49_0)
		if var_47_19 <= 1 then
			arg_49_0()
	...
	local var_47_26
	local var_47_27 = true
	local var_47_28 = true
	local var_47_29 = 0.1

	SFX_PANEL = var_1_10027

	var_18(var_47_23, var_47_24, var_47_25, var_47_26, var_47_27, var_47_28, var_47_29, var_1_10027)

	pressPersistTrigger = var_18
	findTF = var_47_23

	local var_47_30 = var_47_23(var_47_1, "bg/calc/add")
	local var_47_31 = 0.5

	local function var_47_32(arg_50_0)
		if var_47_19 == var_47_18 then
			arg_50_0()
	...
	local var_47_33
	local var_47_34 = true
	local var_47_35 = true
	local var_47_36 = 0.1

	SFX_PANEL = var_1_10027

	var_18(var_47_30, var_47_31, var_47_32, var_47_33, var_47_34, var_47_35, var_47_36, var_1_10027)

	onButton = var_18

	local var_47_37 = arg_47_0

	findTF = var_47_31

	local var_47_38 = var_47_31(var_47_1, "bg/calc/max")

	local function var_47_39()
		if var_47_19 == var_47_18 then
			return
		end
		...
		math = var_2_10003
		var_47_19 = var_51_2(var_2_10003.min(var_47_18, var_51_1), 1)
	...
	var_18(var_47_37, var_47_38, var_47_39, var_23)
	...
	local var_47_41 = var_47_38(var_47_1, "bg/cancel_btn")
	...
	var_18(var_47_40, var_47_41, var_47_42, var_23)
	...
	local var_47_44 = var_47_41(var_47_1, "bg/confirm_btn")

	local function var_47_45()
		local var_53_0 = arg_47_0
		local var_53_1 = var_0.emit

		EquipmentDesignMediator = var_2_10003

		var_53_1(var_53_0, var_2_10003.MAKE_EQUIPMENT, arg_47_1, var_47_19)
	...
	var_18(var_47_43, var_47_44, var_47_45, var_23)

	onButton = var_18

	local var_47_46 = arg_47_0
	local var_47_47 = var_47_1
	...
	var_18(var_47_46, var_47_47, var_47_48, var_23)
