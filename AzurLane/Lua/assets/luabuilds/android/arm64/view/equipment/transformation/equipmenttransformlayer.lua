...
function var_0_1.init(arg_2_0)
	...
	local var_2_11 = var_3.Find(var_2_10, "Adapt/TitleText")

	i18n = var_4

	var_1(var_2_11, var_4("equipment_upgrade_title"))

	setText = var_1

	local var_2_12 = arg_2_0.consumePanel
	local var_2_13 = var_3.Find(var_2_12, "Consume")

	i18n = var_4

	var_1(var_2_13, var_4("equipment_upgrade_coin_consume"))

	setText = var_1

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_3.Find(var_2_14, "Adapt/InfoPanel/StoreCount/OnShip/NameText")

	i18n = var_4

	var_1(var_2_15, var_4("equipment_upgrade_equipped_tag"))

	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_3.Find(var_2_16, "Adapt/InfoPanel/StoreCount/Free/NameText")

	i18n = var_4

	var_1(var_2_17, var_4("equipment_upgrade_spare_tag"))
	...
	var_2_18(var_2_20, false)

	setActive = var_2_18

	var_2_18(var_2_20:Find("subs"), false)

	Instantiate = var_2_18

	local var_2_21 = var_2_18(var_2_20).transform
...
function var_0_1.UpdateConsumeComparer(arg_5_0)
	...
	if arg_5_0.contextData.sourceEquipmentInstance then
		...
		local var_5_4, var_5_5

		var_5_3, var_5_4, var_5_5 = var_5_3.CheckTransformEnoughGold({
	...
	if var_5_2 then
		...
		local var_5_7 = var_5_3(var_5_6, var_1_10007)
		...
		if var_5_1 > 0 then
			...
			if var_5_2 then
				...
				var_5_7 = var_5_8 .. var_5_6(var_5_9, var_9)

				local var_5_10 = arg_5_0.consumePanel
				local var_5_11 = var_5.Find(var_5_10, "GoldText")
				local var_5_12 = var_5.GetComponent

				typeof = var_8
				Text = var_1_10010
				var_5_12(var_5_11, var_8(var_1_10010)).text = var_5_7
...
function var_0_1.UpdateFormula(arg_6_0, arg_6_1)
	...
	EquipmentTransformMediator = var_8

	var_6_7(var_6_6, var_8.UPDATE_NEW_FLAG, arg_6_0.equipmentTarget)

	setActive = var_6_7

	local var_6_8 = arg_6_0.layer
	local var_6_9 = var_7.Find(var_6_8, "SwitchButton")

	EquipmentProxy = var_8

	var_6_7(var_6_9, #var_8.GetTransformSources(arg_6_0.equipmentTarget) > 1)
	arg_6_0:UpdatePage()
...
function var_0_1.UpdateSourceEquipmentPaths(arg_9_0)
	...
	_ = var_1_10002
	arg_9_0.hasRoot = var_1_10002.any(var_9_1, function(arg_10_0)
	...
	_ = var_9_0
	arg_9_0.childsCanUse = var_9_0.any(var_9_3, function(arg_11_0)
...
function var_0_1.UpdateFormulaItems(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10001(arg_13_0.formulaItems) do
		...
		local var_13_1 = iter_13_1.Find(var_13_0, "Item")
		local var_13_2 = arg_13_0.transformMaterials[iter_13_0]

		setActive = var_13_0

		var_13_0(iter_13_1, var_13_2)
		...
		if var_13_2 then
			...
			var_13_3.type = var_9
			var_13_3.id = var_13_2[1]
			var_13_3.count = var_13_2[2]
			updateDrop = var_9

			var_9(var_13_1, var_13_3)
			...
			local function var_13_6()
				...
				var_0.emit(var_14_0, var_0_1.ON_DROP, var_13_3)
			...
			var_9(var_13_4, var_13_5, var_13_6, var_1_10014)

			getProxy = var_9
			BagProxy = var_13_4

			local var_13_7 = var_9(var_13_4)
			local var_13_8

			if not var_9.getItemCountById(var_13_7, var_13_2[1]) then
				var_13_8 = 0
			end

			setText = var_10
			var_1_10014 = iter_13_1

			local var_13_9 = iter_13_1.Find(var_1_10014, "NumText")

			setColorStr = var_13_6

			local var_13_10 = var_13_8

			if var_13_8 < var_13_2[2] then
				COLOR_RED = var_13_11
				...
				var_10(var_13_9, var_13_6(var_13_10, var_13_11) .. "/" .. var_13_2[2])

				local var_13_12 = arg_13_0.equipmentSourceId == 0

				setActive = var_13_7

				var_13_7(iter_13_1:Find("Line"), not var_13_12)

				setActive = var_13_7

				var_13_7(iter_13_1:Find("Line2"), var_13_12)
			end
		end
	end
...
function var_0_1.UpdateTargetInfo(arg_15_0)
	...
	local var_15_1 = var_3.Find(var_15_0, "Item")
	local var_15_2 = {
	...
	var_15_6(var_15_5, var_4.getConfigData(arg_15_0.equipmentTarget).name)
	...
	for iter_15_0, iter_15_1 in var_5(var_15_10) do
	...
	local var_15_15 = var_15_8:Find("Viewport/Content")

	updateEquipInfo = var_7

	var_7(var_15_15, var_15_14:GetPropertiesInfo(), var_15_14:GetSkill())

	Canvas = var_7

	var_7.ForceUpdateCanvases()
	var_0_1.FitTextBGSize(var_15_15:Find("attrs"))
	var_0_1.FitTextBGSize(var_15_15:Find("weapon"))
	var_0_1.FitTextBGSize(var_15_15:Find("equip_info"))
...
function var_0_1.UpdateSourceInfo(arg_17_0)
	...
	var_1_10004(var_6.Find(var_17_1, "Item"), var_1_10002)
	...
	if var_1 then
		...
		if var_17_2 == var_7 then
			var_17_2 = var_1.template.count
			var_17_2 = var_1.composeCfg.material_num <= var_17_2
			setColorStr = var_7
			math = var_9

			local var_17_5 = var_9.min(var_1.template.count, var_1.composeCfg.material_num)
			...
			if var_17_2 then
				...
				var_17_4 = var_7(var_17_5, var_1_10010)
				setText = var_17_2

				var_17_2(var_17_3, var_17_4)

				local var_17_6 = arg_17_0.sourceEquipItem
				local var_17_7 = var_6.Find(var_17_6, "Mask/NameText")
				local var_17_8 = var_6.GetComponent(var_17_7, "ScrollText")
				local var_17_9 = var_6.SetText

				Equipment = var_9

				var_17_9(var_17_8, var_9.getConfigData(arg_17_0.equipmentSourceId).name)

				setActive = var_17_9

				local var_17_10 = arg_17_0.sourceEquipItem

				var_17_9(var_8.Find(var_17_10, "craftable"), arg_17_0.hasRoot)

				onButton = var_17_9

				local var_17_11 = arg_17_0
				local var_17_12 = arg_17_0.sourceEquipItem
				local var_17_13 = var_9.Find(var_17_12, "craftable")

				local function var_17_14()
					local var_18_0 = arg_17_0
					local var_18_1 = var_0.emit

					EquipmentTransformMediator = var_2_10003

					local var_18_2 = var_2_10003.OPEN_LAYER

					Context = var_2_10004

					local var_18_3 = var_2_10004.New
					local var_18_4 = {}

					EquipmentTraceBackMediator = var_2_10007
					var_18_4.mediator = var_2_10007
					EquipmentTraceBackLayer = var_2_10007
					var_18_4.viewComponent = var_2_10007
					var_18_4.data = {
				...
				var_17_9(var_17_11, var_17_13, var_17_14, var_17_12)

				onButton = var_17_9

				local var_17_15 = arg_17_0
				local var_17_16 = arg_17_0.sourceEquipItem
				local var_17_17 = var_9.Find(var_17_16, "Item")
				...
				local function var_17_18()
					if arg_17_0.childsCanUse then
						...
						var_19_1(var_19_0, var_2_10003.SELECT_TRANSFORM_FROM_STOREHOUSE, arg_17_0.equipmentSourceId)
					end
				...
				var_17_9(var_17_15, var_17_17, var_17_18, var_17_16)

				local var_17_19 = arg_17_0.sourceEquipItem
				local var_17_20 = var_6.Find(var_17_19, "Status")
				...
				if not arg_17_0.childsCanUse then
					...
					LoadSprite = var_17_18

					var_7(var_17_21, var_17_18("ui/equipmenttransformui_atlas", "noown"))

					setActive = var_7

					var_7(var_17_20, true)
				elseif not var_1 then
					setImageSprite = var_7

					local var_17_22 = var_17_20

					LoadSprite = var_17_18

					var_7(var_17_22, var_17_18("ui/equipmenttransformui_atlas", "unselect"))
				...
				var_17_19(var_10.Find(var_17_24, "EquipShip"), var_17_23)

				if var_17_23 then
					getProxy = var_17_19
					BayProxy = var_10

					local var_17_25 = var_17_19(var_10)
					...
					var_17_28(var_17_27, var_17_29, var_17_30, var_14.Find(var_17_31, "EquipShip/Image"))
				end
...
function var_0_1.didEnter(arg_20_0)
	...
	var_1_10001(var_20_0, var_4.Find(var_20_1, "BG"), function()
	...
	local var_20_4 = var_4.Find(var_20_3, "ComposeBtn")
	...
	local function var_20_5()
		...
		if arg_20_0.equipmentSourceId ~= 0 and not var_22_0 then
			if arg_20_0.childsCanUse then
				...
				var_22_2(var_22_1, var_2_10004("equipment_upgrade_quick_interface_feedback_source_chosen"))
				...
				if arg_20_0.hasRoot then
					...
					var_22_4(var_22_3, var_2_10004("equipment_upgrade_feedback_equipment_can_be_produced"))
					...
					var_22_6(var_22_5, var_2_10004("equipment_upgrade_feedback_lack_of_equipment"))
		...
		if not var_1.CheckEnoughMaterials(var_22_7) then
			...
			local var_22_8 = var_2_10002.TipsMgr.GetInstance()
			local var_22_9 = var_2.ShowTips

			i18n = var_2_10005

			var_22_9(var_22_8, var_2_10005("equipment_upgrade_feedback_lack_of_materials"))
		...
		EquipmentTransformMediator = var_2_10005

		var_22_11(var_22_10, var_2_10005.TRANSFORM_EQUIP, var_22_0, arg_20_0.contextData.formulaId)
	...
	var_1_10001(var_20_2, var_20_4, var_20_5, var_20_3)

	onButton = var_1_10001

	local var_20_6 = arg_20_0
	local var_20_7 = arg_20_0.layer
	local var_20_8 = var_4.Find(var_20_7, "OverviewBtn")
	...
	local function var_20_9()
		...
		var_23_1(var_23_0, var_2_10003.OPEN_TRANSFORM_TREE, arg_20_0.equipmentTarget)
	...
	var_1_10001(var_20_6, var_20_8, var_20_9, var_20_7)

	onButton = var_1_10001

	local var_20_10 = arg_20_0
	local var_20_11 = arg_20_0.layer
	local var_20_12 = var_4.Find(var_20_11, "SwitchButton")
	...
	local function var_20_13()
		...
		var_24_1 = var_2_10001.indexof(var_24_0, arg_20_0.contextData.formulaId) and var_1 % #var_24_0 + 1 or 1
	...
	var_1_10001(var_20_10, var_20_12, var_20_13, var_20_11)

	onButton = var_1_10001

	local var_20_14 = arg_20_0
	local var_20_15 = arg_20_0.layer
	local var_20_16 = var_4.Find(var_20_15, "HelpBtn")
	...
	local function var_20_17()
		...
		pg = var_2_10004
		var_25_2.helps = var_2_10004.gametip.equipment_upgrade_help.tip
	...
	var_1_10001(var_20_14, var_20_16, var_20_17, var_20_15)
	...
	EquipmentTransformMediator = var_5

	local var_20_22, var_20_23 = var_20_21(var_20_20, var_5)
	...
	if var_20_23 then
		...
		local var_20_24 = var_20_20.m02

		var_20_20 = var_20_20.retrieveMediator(var_20_24, var_20_23.mediator.__cname)
	end

	setActive = var_5

	local var_20_25 = arg_20_0.layer
	local var_20_26 = var_7.Find(var_20_25, "OverviewBtn")
	local var_20_27 = var_20_20.class

	EquipmentTransformTreeMediator = var_20_25

	var_5(var_20_26, var_20_27 ~= var_20_25)

	pg = var_5

	local var_20_28 = var_5.UIMgr.GetInstance()

	var_5.BlurPanel(var_20_28, arg_20_0._tf)
