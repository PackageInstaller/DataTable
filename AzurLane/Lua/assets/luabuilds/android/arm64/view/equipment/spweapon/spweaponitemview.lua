...
function var_0_0.update(arg_2_0, arg_2_1, arg_2_2)
	...
	var_1_10003(var_2_0, var_6(arg_2_1))
	...
	var_2_1.text = var_1_10004(var_6.GetName(var_2_2), 5)
	...
	if var_2_4 and 0 < var_2_4 then
		...
		local var_2_6 = var_2_7(var_2_5)

		var_2_7 = var_2_7.getShipById(var_2_6, var_2_4)
		setImageSprite = var_2_3
		findTF = var_7

		local var_2_8 = var_7(arg_2_0.equiped, "Image")

		LoadSprite = var_2_2

		var_2_3(var_2_8, var_2_2("qicon/" .. var_2_7:getPainting()))
	end

	setActive = var_2_7

	var_2_7(arg_2_0.specialFrame, not arg_2_1:IsReal())

	local var_2_9 = arg_2_1.owned and "frame_design_owned" or "frame_design"

	GetImageSpriteFromAtlasAsync = var_6

	var_6("weaponframes", var_2_9, arg_2_0.specialFrame)
