...
function var_0_1.register(arg_1_0)
	...
	if var_1_1 == var_1_0.EQUIPSCENE then
	...
	arg_1_0:bind(var_0_1.ON_EQUIP, function(arg_3_0)
		if arg_1_0.contextData.oldShipId then
			...
			local var_3_0 = var_1.getShipById(var_2_10004, arg_1_0.contextData.oldShipId)

			ShipStatus = var_2_10003

			local var_3_1

			var_3_1, var_2_10004 = var_2_10003.ShipStatusCheck("onModify", var_3_0)
			...
			if not var_3_1 then
				...
				var_3_6(var_3_5, var_2_10008.EQUIP_FROM_SHIP, {
			...
			if arg_1_0.viewComponent.fromEquipmentView then
				...
				var_3_8(var_3_7, var_2_10004.NO_UPDATE)
			end
			...
			var_3_10(var_3_9, var_2_10004.EQUIP_TO_SHIP, {
				equipmentId = arg_1_0.contextData.equipmentId,
				shipId = arg_1_0.contextData.shipId,
				pos = arg_1_0.contextData.pos
			})
	...
	arg_1_0:bind(var_0_1.ON_UNEQUIP, function(arg_4_0)
		...
		var_4_1(var_4_0, var_2_10004.UNEQUIP_FROM_SHIP, {
			shipId = arg_1_0.contextData.shipId,
			pos = arg_1_0.contextData.pos
		})
	...
	arg_1_0:bind(var_0_1.ON_INTENSIFY, function(arg_5_0)
		...
		EquipUpgradeMediator = var_2_10007
		var_5_3.mediator = var_2_10007
		EquipUpgradeLayer = var_2_10007
		...
		var_5_1(var_5_0, var_5_2(var_5_3), true, function()
			...
			var_6_1(var_6_0, var_3_10003.ON_CLOSE)
	...
	arg_1_0:bind(var_0_1.ON_CHANGE, function(arg_7_0)
		...
		local var_7_2 = var_2_10003(var_5)
		local var_7_3 = var_3.getEquipments(var_7_2, true)
		local var_7_4 = var_1:getEquipsInShips(function(arg_8_0, arg_8_1)
			local var_8_1
		...
		for iter_7_0, iter_7_1 in var_7_2(var_7_3) do
			if not var_7_1:isForbiddenAtPos(iter_7_1, arg_1_0.contextData.pos) then
				...
				var_11.insert(var_7_4, iter_7_1)
			end
		end

		_ = var_6

		var_6.each(var_7_4, function(arg_9_0)
		...
		local var_7_6 = var_6.emit

		BaseUI = var_9

		var_7_6(var_7_5, var_9.ON_CLOSE)
		...
		local var_7_9 = var_9.GO_SCENE

		SCENE = iter_7_1

		local var_7_10 = iter_7_1.EQUIPSCENE
		local var_7_11 = {
			lock = true,
			equipmentVOs = var_7_4,
			shipId = arg_1_0.contextData.shipId,
			pos = arg_1_0.contextData.pos
		}

		StoreHouseConst = var_12
		var_7_11.warp = var_12.WARP_TO_WEAPON
		StoreHouseConst = var_12
		var_7_11.mode = var_12.EQUIPMENT

		var_7_8(var_7_7, var_7_9, var_7_10, var_7_11)
	...
	arg_1_0:bind(var_0_1.ON_REVERT, function(arg_10_0, arg_10_1)
		...
		var_10_1(var_10_0, var_2_10005.REVERT_EQUIPMENT, {
			id = arg_10_1
		})
	...
	arg_1_0:bind(var_0_1.ON_MOVE, function(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_2_10005.ON_CLOSE)
		...
		var_11_3(var_11_2, var_11_4, var_2_10006.SHIPINFO, {
			page = 2,
			shipId = arg_11_1
		})
	...
	if not var_1_3:getEquipmentById(var_1_4) then
		if var_1_4 and 0 < var_1_4 then
			Equipment = var_6
			...
			do
				...
				var_6.setEquipment(var_1_5, var_1_2)
			end
...
function var_0_1.handleNotification(arg_14_0, arg_14_1)
	...
	if var_14_1 ~= var_14_0.DESTROY_EQUIPMENTS_DONE then
		GAME = var_4

		if var_14_1 ~= var_4.EQUIP_TO_SHIP_DONE then
			GAME = var_4

			if var_14_1 == var_4.REVERT_EQUIPMENT_DONE then
				local var_14_3 = arg_14_0.viewComponent
				local var_14_4 = var_4.emit

				BaseUI = var_1_10007

				var_14_4(var_14_3, var_1_10007.ON_CLOSE)
			end
