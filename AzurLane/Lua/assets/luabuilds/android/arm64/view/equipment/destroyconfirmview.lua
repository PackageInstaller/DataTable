...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_4 = var_3.Find(var_2_3, "frame/title_text/Text")

	i18n = var_4

	var_1(var_2_4, var_4("equipment_select_device_destroy_bonus_tip"))
	...
	var_1(var_2_5, var_4("equipment_select_device_destroy_nobonus_tip"))

	onButton = var_1

	local var_2_6 = arg_2_0
	local var_2_7 = arg_2_0._tf
	local var_2_8 = var_4.Find(var_2_7, "frame/actions/cancel_btn")
	...
	var_1(var_2_10, var_2_11, var_2_12, var_2_7)

	onButton = var_1

	local var_2_13 = arg_2_0
	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_4.Find(var_2_14, "frame/top/btnBack")
	...
	local var_2_19 = var_4.Find(var_2_18, "frame/actions/confirm_btn")
	...
	local function var_2_20()
		...
		var_6_1(var_6_0, var_2_10003.ON_DESTROY, arg_2_0.selectedIds)
	...
	SFX_UI_EQUIPMENT_RESOLVE = var_2_18
...
function var_0_1.DisplayDestroyBonus(arg_10_0, arg_10_1)
		...
		if var_1_10009.CanInBag(iter_10_1[1]) then
			...
			for iter_10_2, iter_10_3 in var_12(var_10_2) do
				...
				if not var_10_4 then
					...
					DROP_TYPE_ITEM = iter_10_5
					var_10_6.type = iter_10_5
	...
	if 0 < var_10_1 then
		...
		DROP_TYPE_RESOURCE = iter_10_1
		var_10_9.type = iter_10_1
	...
	var_4.make(var_10_10, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			local function var_11_5()
				...
				if var_12_0 ~= var_3_10001 then
					...
					if var_12_1 == var_3_10001 then
						...
						BaseUI = var_3_10003
						var_3_10003 = var_3_10003.ON_ITEM

						local var_12_4 = var_0

						var_12_3(var_12_2, var_3_10003, var_4.getConfig(var_12_4, "id"))
					else
						local var_12_5 = var_0.type

						DROP_TYPE_EQUIP = var_3_10001

						if var_12_5 == var_3_10001 then
							local var_12_6 = arg_10_0
							local var_12_7 = var_0.emit

							BaseUI = var_3_10003

							local var_12_8 = var_3_10003.ON_EQUIPMENT
							local var_12_9 = {}
							local var_12_10 = var_0

							var_12_9.equipmentId = var_5.getConfig(var_12_10, "id")
							EquipmentInfoMediator = var_5
							var_12_9.type = var_5.TYPE_DISPLAY
			...
			var_6(var_11_3, var_11_4, var_11_5, var_11)
		end
