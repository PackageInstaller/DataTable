...
function var_0_1.Updatelayout(arg_11_0)
	...
	if var_1_10002.any(arg_11_0.equips, function(arg_12_0)
		...
		var_11_1(var_11_2, var_5("destroy_high_rarity_tip"))
	end
	...
	if var_11_1.any(arg_11_0.equips, function(arg_13_0)
		...
		var_11_3(var_11_4, var_5("destroy_high_intensify_tip", ""))
	end
	...
	if #var_11_0 == 0 then
		...
		var_11_5(var_11_6, var_5("destroy_importantequipment_tip"))
	end
	...
	var_11_5(var_11_7, var_5(var_11_8, var_1_10008.concat(var_11_0, ",")))
	...
	if var_11_5.any(arg_11_0.equips, function(arg_14_0)
		...
		math = var_1_10003
		arg_11_0.key = var_1_10003.random(100000, 999999)
		setText = var_1_10003
		...
		var_1_10003(var_11_9, var_6("destroy_equip_rarity_tip", arg_11_0.key))
	else
		setText = var_1_10003

		var_1_10003(arg_11_0.urLabel, "")
	end

	setActive = var_1_10003

	var_1_10003(arg_11_0.urOverflowLabel, false)

	setActive = var_1_10003

	var_1_10003(arg_11_0.urLabel, var_2)

	setActive = var_1_10003

	var_1_10003(arg_11_0.urInput, var_2)
...
function var_0_1.UpdateEquips(arg_15_0)
	...
	var_1_10001(var_15_0, var_1_10004({
		function(arg_16_0)
	...
	local var_15_1 = #arg_15_0.equips
	local var_15_6
	...
	if 5 < var_15_1 then
		...
		var_15_1(var_3.Find(var_15_2, "window/content/ships"), true)

		setActive = var_15_1

		local var_15_3 = arg_15_0._tf

		var_15_1(var_3.Find(var_15_3, "window/content/ships_single"), false)

		local var_15_4 = arg_15_0._tf
		local var_15_5 = var_1.Find(var_15_4, "window/content/ships/content")

		var_15_6 = var_1.GetComponent(var_15_5, "LScrollRect")

		function var_15_6.onUpdateItem(arg_18_0, arg_18_1)
			updateEquipment = var_2_10002
			tf = var_2_10004

			var_2_10002(var_2_10004(arg_18_1), arg_15_0.equips[arg_18_0 + 1])
		...
		local var_15_8 = var_1.Find(var_15_7, "window/content/ships_single")

		UIItemList = var_15_6

		local var_15_9 = var_15_6.New(var_15_8, var_15_8:Find("IconTpl"))

		setActive = var_15_7

		local var_15_10 = arg_15_0._tf

		var_15_7(var_5.Find(var_15_10, "window/content/ships"), false)

		setActive = var_15_7

		local var_15_11 = arg_15_0._tf

		var_15_7(var_5.Find(var_15_11, "window/content/ships_single"), true)
		var_15_9:make(function(arg_20_0, arg_20_1, arg_20_2)
		...
		var_15_9:align(#arg_15_0.equips)
	end
