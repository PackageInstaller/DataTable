...
;({}).SameDrop = function(arg_1_0, arg_1_1)
...
;({}).CheckEquipmentFormulasSucceed = function(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_0) do
		...
		for iter_2_4, iter_2_5 in pairs(var_2_5) do
			if iter_2_4 ~= "gold" then
				local var_2_12 = var_2_2[iter_2_4] or 0

				var_2_2[iter_2_4] = var_2_12 + iter_2_5
			end
		end

		local var_2_13 = var_2_2.gold or 0

		var_2_2.gold = var_2_13 + var_2_6
		var_2_3 = var_2_4.target_id
	end

	return true
end
;({}).CheckTransformFormulasSucceed = function(arg_3_0, arg_3_1)
	...
	elseif arg_3_1.type == DROP_TYPE_ITEM then
		if var_3_1.gold < arg_3_1.composeCfg.gold_num then
			...
			local var_3_6 = var_3_0:getItemCountById(arg_3_1.composeCfg.material_id) or 0

			if var_3_6 < arg_3_1.composeCfg.material_num then
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_0) do
		local var_3_8 = pg.equip_upgrade_data[iter_3_1]
		local var_3_9 = Equipment.GetRevertRewardsStatic(var_3_7)

		assert(Equipment.CanInBag(var_3_7), "Missing equip_data_template ID: " .. (var_3_7 or "NIL"))

		local var_3_10 = Equipment.CanInBag(var_3_7) and Equipment.getConfigData(var_3_7).destory_gold or 0

		var_3_7 = Equipment.GetEquipRootStatic(var_3_7)

		assert(var_3_8 and var_3_8.upgrade_from == var_3_7, "Transform a non formula equipment, formula " .. (iter_3_1 or -1) .. " equipment " .. (var_3_7 or -1))

		for iter_3_2, iter_3_3 in ipairs(var_3_8.material_consume) do
			local var_3_11 = var_3_1[iter_3_3[1]]

			if not var_3_1[iter_3_3[1]] then
				var_3_11 = var_3_0:getItemCountById(iter_3_3[1])
				var_3_11 = var_3_11 or 0
			end

			var_3_1[iter_3_3[1]] = var_3_11 - iter_3_3[2]

			if var_3_1[iter_3_3[1]] < 0 then
				local var_3_12 = Item.getConfigData(iter_3_3[1])

				return false, var_3_12 and var_3_12.name
			end
		end

		var_3_1.gold = var_3_1.gold - var_3_8.coin_consume

		if var_3_1.gold < 0 then
			local var_3_14 = Drop.New({
				type = DROP_TYPE_RESOURCE,
				id = PlayerConst.ResGold
			}):getName()
		...
		for iter_3_4, iter_3_5 in pairs(var_3_9) do
			if iter_3_4 ~= "gold" then
				local var_3_15 = var_3_1[iter_3_4] or var_3_0:getItemCountById(iter_3_4)

				var_3_1[iter_3_4] = var_3_15 + iter_3_5
			end
		end

		local var_3_16 = var_3_1.gold or 0

		var_3_1.gold = var_3_16 + var_3_10
		var_3_7 = var_3_8.target_id
	end

	return true
end
;({}).CheckTransformEnoughGold = function(arg_4_0, arg_4_1)
