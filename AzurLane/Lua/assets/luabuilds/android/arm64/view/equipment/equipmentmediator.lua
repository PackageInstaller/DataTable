...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.DESIGN_FILTER_CHANGED, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.TOGGLE_ALL_DESIGN_EQUIPMENT, arg_2_1)
	...
	arg_1_0:bind(var_0_1.ITEM_GO_SCENE, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10006.GO_SCENE, arg_3_1, arg_3_2)
	...
	arg_1_0:bind(var_0_1.ON_USE_ITEM, function(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
		...
		var_5_1(var_5_0, var_2_10007.USE_ITEM, {
			id = arg_5_1,
			count = arg_5_2,
			arg = arg_5_3
		})
	...
	arg_1_0:bind(var_0_1.ON_DESTROY, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10005.DESTROY_EQUIPMENTS, {
			equipments = arg_6_1
		})
	...
	arg_1_0:bind(var_0_1.ON_UNEQUIP_EQUIPMENT, function(arg_7_0)
		...
		var_7_1(var_7_0, var_2_10004.UNEQUIP_FROM_SHIP, {
	...
	arg_1_0:bind(var_0_1.OPEN_DESIGN, function(arg_8_0)
		...
		local var_8_2 = var_8_1(var_8_0, var_2_10005)
		local var_8_3 = var_2.getContextByMediator

		EquipmentDesignMediator = var_2_10006

		if var_8_3(var_8_2, var_2_10006) then
			return
		end
		...
		local var_8_6 = var_2_10007.New
		local var_8_7 = {}

		EquipmentDesignLayer = var_2_10010
		var_8_7.viewComponent = var_2_10010
		EquipmentDesignMediator = var_2_10010
		var_8_7.mediator = var_2_10010

		local var_8_8 = {}
		local var_8_9 = arg_1_0.viewComponent

		var_8_8.groupName = var_11.getGroupName(var_8_9)
	...
	arg_1_0:bind(var_0_1.CLOSE_DESIGN_LAYER, function(arg_9_0)
		...
		local var_9_2 = var_9_1(var_9_0, var_2_10005)
		local var_9_3 = var_2.getContextByMediator

		EquipmentDesignMediator = var_2_10006

		if var_9_3(var_9_2, var_2_10006) then
			local var_9_4 = arg_1_0
			local var_9_5 = var_4.sendNotification

			GAME = var_2_10007

			var_9_5(var_9_4, var_2_10007.REMOVE_LAYERS, {
				context = var_3
			})
		end
	...
	arg_1_0:bind(var_0_1.OPEN_SPWEAPON_DESIGN, function(arg_10_0)
		...
		local var_10_2 = var_10_1(var_10_0, var_2_10005)
		local var_10_3 = var_2.getContextByMediator

		SpWeaponDesignMediator = var_2_10006

		if var_10_3(var_10_2, var_2_10006) then
			return
		end
		...
		local var_10_6 = var_2_10007.New
		local var_10_7 = {}

		SpWeaponDesignLayer = var_2_10010
		var_10_7.viewComponent = var_2_10010
		SpWeaponDesignMediator = var_2_10010
		var_10_7.mediator = var_2_10010

		local var_10_8 = {}
		local var_10_9 = arg_1_0.viewComponent

		var_10_8.groupName = var_11.getGroupName(var_10_9)
	...
	arg_1_0:bind(var_0_1.CLOSE_SPWEAPON_DESIGN_LAYER, function(arg_11_0)
		...
		local var_11_2 = var_11_1(var_11_0, var_2_10005)
		local var_11_3 = var_2.getContextByMediator

		SpWeaponDesignMediator = var_2_10006

		if var_11_3(var_11_2, var_2_10006) then
			local var_11_4 = arg_1_0
			local var_11_5 = var_4.sendNotification

			GAME = var_2_10007

			var_11_5(var_11_4, var_2_10007.REMOVE_LAYERS, {
				context = var_3
			})
		end
	...
	arg_1_0:bind(var_0_1.ON_EQUIPMENT_SKIN_INFO, function(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
		...
		local var_12_2 = var_2_10007.New
		local var_12_3 = {}

		EquipmentSkinMediator = var_2_10010
		var_12_3.mediator = var_2_10010
		EquipmentSkinLayer = var_2_10010
		var_12_3.viewComponent = var_2_10010
	...
	arg_1_0:bind(var_0_1.ON_UNEQUIP_EQUIPMENT_SKIN, function(arg_13_0)
		...
		var_13_1(var_13_0, var_2_10004.EQUIP_EQUIPMENTSKIN_TO_SHIP, {
			equipmentSkinId = 0,
			shipId = arg_1_0.contextData.shipId,
			pos = arg_1_0.contextData.pos
		})
	...
	arg_1_0:bind(var_0_1.OPEN_EQUIPSKIN_INDEX_LAYER, function(arg_14_0, arg_14_1)
		...
		var_14_3.mediator = var_2_10008
		IndexLayer = var_2_10008
		var_14_3.viewComponent = var_2_10008
	...
	if var_1_4 then
		...
		if var_1_6 == var_1_3.EQUIPMENT then
			var_1_5 = var_1_4
			var_1_6 = var_1_4.getEquip(var_1_5, arg_1_0.contextData.pos)
			var_1_7 = arg_1_0.contextData
			defaultValue = var_1_5
			var_1_7.qiutBtn = var_1_5(var_1_6, nil)
		else
			var_1_6 = arg_1_0.contextData.mode
			StoreHouseConst = var_1_7

			if var_1_6 == var_1_7.SKIN then
				var_1_5 = var_1_4
				var_1_6 = var_1_4.getEquipSkin(var_1_5, arg_1_0.contextData.pos) ~= 0
				arg_1_0.contextData.qiutBtn = var_1_6
			end
		end
	end
	...
	if arg_1_0.contextData.equipmentVOs then
		var_1_8 = arg_1_0.contextData.equipmentVOs
	else
		local var_1_9 = arg_1_0.equipmentProxy

		var_1_8 = var_4.getEquipments(var_1_9, true)
		ipairs = var_4

		for iter_1_0, iter_1_1 in var_4(var_1:getEquipsInShips()) do
			table = var_1_10009

			var_1_10009.insert(var_1_8, iter_1_1)
		end

		pairs = var_4

		local var_1_10 = arg_1_0.equipmentProxy

		for iter_1_2, iter_1_3 in var_4(var_6.getEquipmentSkins(var_1_10)) do
			table = var_1_10009

			var_1_10009.insert(var_1_8, {
				isSkin = true,
				id = iter_1_3.id,
	...
	var_4.setEquipments(var_1_11, var_1_8)

	local var_1_12 = arg_1_0.viewComponent
	local var_1_13 = var_4.setCapacity
	local var_1_14 = arg_1_0.equipmentProxy

	var_1_13(var_1_12, var_7.getCapacity(var_1_14))

	local var_1_15 = arg_1_0

	arg_1_0.UpdateSpWeapons(var_1_15)

	getProxy = var_4
	BagProxy = var_1_15

	local var_1_16 = var_4(var_1_15)
	local var_1_17 = var_4.getItemsByExclude(var_1_16)
	local var_1_18 = arg_1_0.viewComponent

	var_6.setItems(var_1_18, var_1_17)

	getProxy = var_6
	PlayerProxy = var_1_18

	local var_1_19 = var_6(var_1_18)
	local var_1_20 = var_6.getData(var_1_19)
	local var_1_21 = arg_1_0.viewComponent

	var_8.setPlayer(var_1_21, var_1_20)
...
function var_0_1.UpdateSpWeapons(arg_16_0)
	...
	local var_16_2 = var_1_10002(var_4)
	local var_16_3 = var_2.GetSpWeaponsInShips(var_16_2, var_16_1)

	_ = var_16_0

	local var_16_4 = var_16_0.values

	getProxy = var_5
	EquipmentProxy = var_1_10007

	local var_16_5 = var_5(var_1_10007)
	local var_16_6 = var_16_4(var_5.GetSpWeapons(var_16_5))

	ipairs = var_16_2

	for iter_16_0, iter_16_1 in var_16_2(var_16_6) do
...
function var_0_1.handleNotification(arg_18_0, arg_18_1)
	...
	EquipmentProxy = var_18_0

	local var_18_3

	if var_18_1 == var_18_0.EQUIPMENT_UPDATED then
		var_1_10006 = arg_18_0.viewComponent
		var_18_3 = var_18_3.setCapacity

		local var_18_4 = arg_18_0.equipmentProxy

		var_18_3(var_1_10006, var_1_10007.getCapacity(var_18_4))

		var_1_10006 = arg_18_0.viewComponent

		var_18_3.setEquipment(var_1_10006, var_18_2)

		if arg_18_0.canUpdate then
			var_1_10006 = arg_18_0.viewComponent

			var_18_3.setEquipmentUpdate(var_1_10006)
		end
	...
	if var_18_1 == var_18_3.SHIP_EQUIPMENT_ADDED then
		var_1_10006 = arg_18_0.viewComponent

		var_4.addShipEquipment(var_1_10006, var_18_2)

		if arg_18_0.canUpdate then
			var_1_10006 = arg_18_0.viewComponent

			var_4.setEquipmentUpdate(var_1_10006)
		end
	...
	if var_18_1 == var_4.SHIP_EQUIPMENT_REMOVED then
		var_1_10006 = arg_18_0.viewComponent

		var_4.removeShipEquipment(var_1_10006, var_18_2)
	...
	if var_18_1 == var_4.EQUIPMENT_SKIN_UPDATED then
		var_1_10006 = arg_18_0.viewComponent
		var_18_5 = var_18_5.setCapacity

		local var_18_6 = arg_18_0.equipmentProxy

		var_18_5(var_1_10006, var_1_10007.getCapacity(var_18_6))

		var_1_10006 = arg_18_0.viewComponent

		var_18_5.setEquipmentSkin(var_1_10006, var_18_2)

		if arg_18_0.canUpdate then
			var_1_10006 = arg_18_0.viewComponent

			var_18_5.setEquipmentSkinUpdate(var_1_10006)
		end
	...
	if var_18_1 == var_18_5.SHIP_UPDATED then
		if var_18_2.id == arg_18_0.contextData.shipId then
			var_1_10006 = arg_18_0.viewComponent

			var_4.setShip(var_1_10006, var_18_2)
		end
	...
	if var_18_1 == var_4.UPDATED then
		var_1_10006 = arg_18_0.viewComponent

		var_4.setPlayer(var_1_10006, var_18_2)
	...
	if var_18_1 == var_4.USE_ITEM_DONE then
		if #var_18_2.drops > 0 then
			var_1_10006 = arg_18_0.viewComponent
			var_18_7 = var_18_7.emit
			BaseUI = var_1_10007

			var_18_7(var_1_10006, var_1_10007.ON_WORLD_ACHIEVE, {
				animation = true,
	...
	if var_18_1 == var_18_7.FRAG_SELL_DONE then
		var_1_10006 = arg_18_0.viewComponent
		var_18_8 = var_18_8.emit
		BaseUI = var_1_10007

		var_18_8(var_1_10006, var_1_10007.ON_ACHIEVE, var_18_2.awards)
	...
	if var_18_1 == var_18_8.DESTROY_EQUIPMENTS_DONE then
		arg_18_0.canUpdate = true
		var_1_10006 = arg_18_0.viewComponent

		var_18_9.setEquipmentUpdate(var_1_10006)
		...
		if #var_18_2 > 0 then
			...
			var_18_9(var_1_10006, var_1_10007.ON_AWARD, {
				items = var_18_2
			})
		end
	...
	if var_18_1 == var_18_9.ITEM_UPDATED then
		if arg_18_0.canUpdate then
			getProxy = var_4
			BagProxy = var_1_10006
			var_1_10007 = var_4(var_1_10006)

			local var_18_10 = var_4.getItemsByExclude(var_1_10007)
			local var_18_11 = arg_18_0.viewComponent

			var_6.setItems(var_18_11, var_18_10)
		end

		goto label_18_0
	end

	if var_18_1 == var_0_1.BATCHDESTROY_MODE then
	...
	if var_18_1 == var_0_1.SWITCH_TO_SPWEAPON_PAGE then
	...
	if var_18_1 == var_4.REVERT_EQUIPMENT_DONE then
		if #var_18_2.awards > 0 then
			...
			var_18_15(var_18_14, var_1_10007.ON_AWARD, {
	...
	if var_18_1 ~= var_18_15.EQUIP_TO_SHIP_DONE then
		GAME = var_18_17

		local var_18_17

		if var_18_1 == var_18_17.UNEQUIP_FROM_SHIP_DONE then
			local var_18_16 = arg_18_0.viewComponent

			var_18_17 = var_18_17.emit
			BaseUI = var_1_10007

			var_18_17(var_18_16, var_1_10007.ON_BACK)
		...
		if var_18_1 ~= var_18_17.EQUIP_EQUIPMENTSKIN_TO_SHIP_DONE then
			GAME = var_4

			if var_18_1 == var_4.EQUIP_EQUIPMENTSKIN_FROM_SHIP_DONE then
				local var_18_18 = arg_18_0.viewComponent
				local var_18_19 = var_4.emit

				BaseUI = var_1_10007

				var_18_19(var_18_18, var_1_10007.ON_BACK)
			elseif var_18_1 == var_0_1.NO_UPDATE then
				arg_18_0.canUpdate = false
			else
				GAME = var_4

				if var_18_1 == var_4.TRANSFORM_EQUIPMENT_AWARD_FINISHED then
					...
					if var_18_1 == var_4.SPWEAPONS_UPDATED then
						...
						if var_18_1 == var_4.LOVE_ITEM_MAIL_REPAIR_DONE then
							if #var_18_2.awards > 0 then
								...
								var_18_23(var_18_22, var_1_10007.ON_AWARD, {
									items = var_18_2.awards
								})
							end
						else
							...
							if var_18_1 == var_18_23.SELL_ITEM_DONE then
								local var_18_24 = arg_18_0.viewComponent
								local var_18_25 = var_4.emit

								BaseUI = var_1_10007

								var_18_25(var_18_24, var_1_10007.ON_ACHIEVE, var_18_2.awards)
							end
						end
					end
				end
