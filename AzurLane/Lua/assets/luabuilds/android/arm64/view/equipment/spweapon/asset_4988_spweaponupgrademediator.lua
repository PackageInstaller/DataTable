...
function var_0_1.UpdateSpWeapons(arg_2_0)
	...
	local var_2_2 = var_1_10002.values

	getProxy = var_1_10004
	EquipmentProxy = var_1_10006

	local var_2_3 = var_1_10004(var_1_10006)
	local var_2_4 = var_2_2(var_4.GetSpWeapons(var_2_3))
...
function var_0_1.BindEvent(arg_3_0)
	arg_3_0:bind(var_0_1.EQUIPMENT_UPGRADE, function(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
		...
		var_4_1(var_4_0, var_2_10007.UPGRADE_SPWEAPON, {
	...
	arg_3_0:bind(var_0_1.EQUIPMENT_COMPOSITE, function(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
		...
		var_5_1(var_5_0, var_2_10007.COMPOSITE_SPWEAPON, {
			id = arg_5_1,
	...
	arg_3_0:bind(var_0_1.ON_SKILLINFO, function(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
		...
		local var_7_2 = var_2_10007.New
		local var_7_3 = {}

		SkillInfoMediator = var_2_10010
		var_7_3.mediator = var_2_10010
		SpWeaponSkillInfoLayer = var_2_10010
		var_7_3.viewComponent = var_2_10010
		var_7_3.data = {
			unlock = arg_7_2,
			skillId = arg_7_1,
			skillOnShip = {
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_1 == var_9_0.COMPOSITE_SPWEAPON_DONE then
		...
		if arg_9_0.contextData.shipId and arg_9_0.contextData.shipId > 0 then
			...
			var_9_7(var_9_6, var_1_10007.EQUIP_SPWEAPON_TO_SHIP, {
		...
		if var_9_1 == var_9_7.EQUIP_SPWEAPON_TO_SHIP_DONE then
			local var_9_8 = arg_9_0.viewComponent

			var_9_9 = var_9_9.emit
			BaseUI = var_1_10007

			var_9_9(var_9_8, var_1_10007.ON_BACK)
		else
			GAME = var_9_9

			if var_9_1 == var_9_9.UPGRADE_SPWEAPON_DONE then
				...
				if var_9_1 == var_4.ITEM_UPDATED then
					...
					var_9_14(var_9_13, var_1_10007.getData(var_1_10009))
				else
					PlayerProxy = var_9_14

					local var_9_16

					if var_9_1 == var_9_14.UPDATED then
						...
						local var_9_17 = var_1_10007(var_1_10009)

						var_9_16(var_9_15, var_7.getData(var_9_17))
					else
						EquipmentProxy = var_9_16

						if var_9_1 == var_9_16.SPWEAPONS_UPDATED then
