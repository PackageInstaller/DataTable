...
function var_0_1.init(arg_2_0)
	...
	arg_2_0._tabGroup = var_2_3(var_2_2, var_4(var_1_10006))
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0._detailTitleImgComp = var_2_8(var_2_7, var_4(var_1_10006))
	...
	arg_2_0._scrollRect = var_2_17(var_2_16, var_4(var_1_10006))
...
function var_0_1.didEnter(arg_4_0)
	...
	var_1_10001(arg_4_0, arg_4_0._stopRemind, function(arg_6_0)
		...
		BulletinBoardMediator = var_2_10004

		var_6_1(var_6_0, var_2_10004.SET_STOP_REMIND, arg_6_0)
	...
	local var_4_3 = var_1_10001(var_3)
	local var_4_4 = var_1.getStopRemind(var_4_3)

	triggerToggle = var_3

	var_3(arg_4_0._stopRemind, var_4_4)
...
function var_0_1.setNotices(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in var_1_10004(arg_7_1) do
		...
		var_1_10009(var_7_2, var_1_10012(iter_7_1.id))
		...
		var_1_10010(var_1_10009:Find("common_state/title_mask/title_txt"), iter_7_1.btnTitle)

		setScrollText = var_1_10010

		var_1_10010(var_1_10009:Find("select_state/title_mask/title_txt"), iter_7_1.btnTitle)

		changeToScrollText = var_1_10010

		var_1_10010(var_1_10009:Find("common_state/time_txt"), iter_7_1.title)

		changeToScrollText = var_1_10010

		var_1_10010(var_1_10009:Find("select_state/time_txt"), iter_7_1.title)

		table = var_1_10010

		var_1_10010.insert(arg_7_0._tabList, var_1_10009)
		...
		typeof = var_13
		Toggle = var_15
		var_1_10010 = var_1_10010(var_1_10012, var_13(var_15))
		var_1_10010.group = arg_7_0._tabGroup
		onToggle = var_11
		...
		local function var_7_5(arg_8_0)
			...
			var_2_10001(var_3.Find(var_8_1, "common_state"), not arg_8_0)
		...
		var_11(var_7_3, var_7_4, var_7_5, var_1_10016)
	end
...
function var_0_1.setNoticeDetail(arg_9_0, arg_9_1)
	...
	Color = var_1_10003
	var_9_0.color = var_1_10003.New(0, 0, 0, 0.4)
	setActive = var_9_0
	...
	var_9_3(var_9_2, var_9_4, var_9_5, var_9_6, var_8.Events.UnityAction_UnityEngine_Sprite(function(arg_10_0)
	...
	for iter_9_0 in var_2.gmatch(arg_9_1.content, "<imgHref>%S-</imgHref>") do
		...
		var_9_5, var_9_7 = var_9_5.find(iter_9_0, "<imgHref>")
		string = var_8
		...
		local var_9_13 = var_13.gsub(var_9_12, "%-", "%%-")

		string = var_13

		local var_9_14 = var_13.gsub(var_9_13, "%?", "%%?")

		string = var_13
		arg_9_0.realContent = var_13.gsub(arg_9_0.realContent, var_9_14, var_9_11)
		string = var_13
		arg_9_0.tempContent = var_13.gsub(arg_9_0.tempContent, var_9_14, "")
		table = var_13

		var_13.insert(arg_9_0.loadPic, var_9_10)
	end
	...
	for iter_9_1, iter_9_2 in var_3(arg_9_0.loadPic) do
		...
		var_9_18(var_9_17, var_9_19, var_9_20, var_9_21, var_1_10014.Events.UnityAction_UnityEngine_Sprite(function(arg_11_0)
			...
			if arg_11_0 ~= nil then
				...
				if arg_9_0.loadingCount <= 0 then
					...
					var_1(var_11_1, var_4(arg_9_0.realContent, true))
				end
			end
