...
function var_0_1.init(arg_2_0)
	...
	arg_2_0._subTabGroup = var_2_4(var_2_3, var_4(var_1_10006))
	...
	arg_2_0._detailTitleImgLayoutElement = var_2_10(var_2_9, var_4(var_1_10006))
	...
	arg_2_0._scrollRect = var_2_21(var_2_20, var_4(var_1_10006))
	...
	arg_2_0._mainAnim = var_2_25(var_2_24, var_4(var_1_10006))
	...
	typeof = var_4
	Animation = var_1_10006
	arg_2_0._bgAnim = var_2_28(var_2_27, var_4(var_1_10006))
	...
	typeof = var_4
	Animation = var_1_10006
	arg_2_0._contentAnim = var_2_31(var_2_30, var_4(var_1_10006))
	pg = var_1
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_3()
		...
		var_4_1(var_4_2, var_3.Action(function()
	...
	var_1(arg_3_0, arg_3_0._stopRemind, function(arg_6_0)
		...
		NewBulletinBoardMediator = var_2_10004
	...
	local var_3_4 = var_1(var_3)
	local var_3_5 = var_1.getStopRemind(var_3_4)

	triggerToggle = var_3

	var_3(arg_3_0._stopRemind, var_3_5)
	...
	var_3(var_3_6, var_6("Announcements_Donotshow"))

	LeanTween = var_3

	local var_3_7 = var_3.rotateAroundLocal

	rtf = var_3_6

	local var_3_8 = arg_3_0._detailTitleImg
	local var_3_9 = var_3_6(var_7.Find(var_3_8, "loading/Image"))

	Vector3 = var_6

	local var_3_10 = var_3_7(var_3_9, var_6(0, 0, -1), 360, 5)
...
function var_0_1.updateRed(arg_7_0)
	for iter_7_0 = 1, 3 do
		...
		local var_7_2 = var_8.GetChild(var_7_1, iter_7_0 - 1)

		var_1_10006(var_8.Find(var_7_2, "Text/red"), var_1_10005)
	end
	...
	for iter_7_3 = 1, #arg_7_0._subTabList do
		...
		var_1_10005(var_7.Find(var_7_3, "red"), not arg_7_0._redDic[arg_7_0.currentMainTab][iter_7_3])
	end
...
function var_0_1.initNotices(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in var_1_10004(arg_9_1) do
		...
		if arg_9_0:checkNotice(iter_9_1) then
			...
			var_9_2(var_9_3, var_12.HasKey(iter_9_1.code))
			...
			var_9_2(var_9_4, var_12(iter_9_1.id))
	...
	for iter_9_2 = 1, 3 do
		...
		local var_9_9 = var_9_8(var_9_7, var_12(var_1_10014))

		setText = var_9_5
		var_1_10014 = var_8

		local var_9_10 = var_8.Find(var_1_10014, "Text")

		i18n = var_1_10013

		var_9_5(var_9_10, var_1_10013(var_0_1.MAIN_TAB_GAMETIP[iter_9_2]))

		onToggle = var_9_5

		var_9_5(arg_9_0, var_8, function(arg_10_0)
			if arg_10_0 then
	...
	if arg_9_0.defaultMainTab then
		...
		var_4(var_6.GetChild(var_9_12, arg_9_0.defaultMainTab - 1), true)
	end
...
function var_0_1.setNotices(arg_11_0, arg_11_1)
	...
	for iter_11_0, iter_11_1 in var_2(arg_11_1) do
		...
		var_1_10008.insert(arg_11_0._subTabList, var_1_10007)

		table = var_1_10008
		var_1_10008 = var_1_10008.insert

		local var_11_0 = arg_11_0._subTabAnims
		local var_11_1 = var_1_10007:Find("select_state")
		local var_11_2 = var_11.GetComponent

		typeof = var_14
		Animation = var_1_10016

		var_1_10008(var_11_0, var_11_2(var_11_1, var_14(var_1_10016)))

		setScrollText = var_1_10008

		var_1_10008(var_1_10007:Find("common_state/mask/Text"), iter_11_1.btnTitle)

		setScrollText = var_1_10008

		var_1_10008(var_1_10007:Find("select_state/mask/Text"), iter_11_1.btnTitle)

		GetSpriteFromAtlasAsync = var_1_10008

		var_1_10008("ui/newbulletinboardui_atlas", var_0_1.ICON_NAME[iter_11_1.icon], function(arg_12_0)
			setImageSprite = var_2_10001

			local var_12_0 = var_1_10007

			var_2_10001(var_3.Find(var_12_0, "common_state/icon"), arg_12_0)
		...
		var_1_10008("ui/newbulletinboardui_atlas", var_0_1.ICON_NAME[iter_11_1.icon] .. "_selected", function(arg_13_0)
			setImageSprite = var_2_10001

			local var_13_0 = var_1_10007

			var_2_10001(var_3.Find(var_13_0, "select_state/icon"), arg_13_0)
		...
		local function var_11_5(arg_14_0)
			if arg_14_0 then
				...
				var_2_10001(var_3.Find(var_14_0, "select_state"), true)
				...
				if arg_11_0.currentSubTab then
					...
					local var_14_5 = var_3.delayedCall
					local var_14_6 = 0.26

					System = var_6
					var_14_4.subTabLT = var_14_5(var_14_6, var_6.Action(function()
						setActive = var_3_10000

						local var_15_0 = arg_11_0._subTabList[var_14_1]

						var_3_10000(var_2.Find(var_15_0, "select_state"), false)
		...
		var_1_10008(var_11_3, var_11_4, var_11_5, var_13)
	end
	...
	arg_11_0.defaultSubTab = var_11_6
	triggerToggle = var_11_6

	var_11_6(arg_11_0._subTabList[arg_11_0.defaultSubTab], true)
...
function var_0_1.setImage(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4)
	...
	local var_16_2 = var_16_1(var_16_0, var_8(var_1_10010))
	local var_16_3 = arg_16_4:Find("loading")

	Color = var_16_0
	var_16_2.color = var_16_0.New(0, 0, 0, 0.4)
	setActive = var_7

	var_7(var_16_3, true)

	local var_16_4 = arg_16_0._loadingFlag

	var_16_4[arg_16_3] = true
	BulletinBoardMgr = var_16_4

	local var_16_5 = var_16_4.Inst
	local var_16_6 = var_7.GetSprite
	local var_16_7 = arg_16_1
	local var_16_8 = arg_16_2
	local var_16_9 = arg_16_3

	UnityEngine = var_1_10013

	var_16_6(var_16_5, var_16_7, var_16_8, var_16_9, var_1_10013.Events.UnityAction_UnityEngine_Sprite(function(arg_17_0)
...
function var_0_1.setNoticeDetail(arg_18_0, arg_18_1)
	local function var_18_0(arg_19_0)
		...
		var_2_10002.insert(arg_18_0._contentList, var_19_0)
	...
	local function var_18_1(arg_20_0)
		...
		var_2_10002.insert(arg_18_0._contentList, var_20_0)
		...
		var_2(var_20_1, var_5(arg_20_0, true))
	...
	if arg_18_1.paramType then
		...
		local function var_18_5()
			if arg_18_1.paramType == 1 then
				...
				var_22_1(var_22_0, var_2_10003.TRACK_OPEN_URL, arg_18_1.track)
			elseif arg_18_1.paramType == 2 then
				...
				var_22_3(var_22_2, var_2_10003.GO_SCENE, arg_18_1.param)
			elseif arg_18_1.paramType == 3 then
				...
				local var_22_6 = var_2_10003.GO_SCENE

				SCENE = var_2_10004

				var_22_5(var_22_4, var_22_6, var_2_10004.ACTIVITY, {
					id = arg_18_1.param
				})
			elseif arg_18_1.paramType == 4 then
				...
				var_22_9(var_22_8, var_2_10004.GO_SCENE, var_22_7[1], var_22_7[2])
			elseif arg_18_1.paramType == 5 then
				...
				if not var_0.IsPlayed(var_22_10, "JIARIBIESHUCHOUBEIZHONG5") then
					...
					var_22_12(var_22_11, var_22_13, var_2_10004.ACTIVITY, {
						id = 5922
					})
				else
					...
					var_22_15(var_22_14, var_22_16, var_2_10004.HOLIDAY_VILLA_MAP)
				end
			end
		...
		var_18_2(var_18_3, var_18_4, var_18_5, var_9)
	else
		setActive = var_18_2
		...
		local function var_18_7(arg_24_0)
			...
			var_24_0(var_2_10003.split(arg_24_0, "<segment/>"), function(arg_25_0)
		...
		for iter_18_0 in var_7.gmatch(arg_18_1.content, "<banner>%S-</banner>") do
			...
			if var_18_13 ~= nil then
				...
				if #var_18_15(var_20.sub(arg_18_1.content, var_18_8, var_18_13 - 1)) > 0 then
					var_18_7(var_18_15)
				end
			end
		...
		if var_18_8 < #arg_18_1.content then
			...
			var_18_16(var_9.sub(arg_18_1.content, var_18_8, #arg_18_1.content))
		end
...
function var_0_1.bannerRotate(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1_10001(arg_26_0._contentList) do
		if iter_26_1:Find("loading/Image") then
			table = var_1_10007
			var_1_10007 = var_1_10007.insert

			local var_26_0 = arg_26_0.LTList

			LeanTween = var_1_10010
			var_1_10010 = var_1_10010.rotateAroundLocal
			rtf = var_1_10012
			var_1_10012 = var_1_10012(var_6)
			Vector3 = var_1_10013
			var_1_10012 = var_1_10010(var_1_10012, var_1_10013(0, 0, -1), 360, 5)

			var_1_10007(var_26_0, var_1_10010.setLoopClamp(var_1_10012).uniqueId)
		end
	end
