...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_SWITCH_SHIP, function(arg_3_0, arg_3_1)
		...
		var_3_3(var_3_2, var_3_4, var_2_10008.DirtyFleet)
	...
	arg_1_0:bind(var_0_1.ON_START, function(arg_6_0)
		...
		local var_6_2 = var_1:getStageId(var_6_1.line.row, var_6_1.line.column)
		...
		var_2_10004({
			...
			function(arg_9_0)
				...
				local var_9_0 = var_3_10001(var_3_10003)
				...
				if var_1.GoldMax(var_9_1, 1) then
					...
					local var_9_3 = var_9_2 .. var_9_0("resource_max_tip_battle")
			...
			local var_10_2 = var_3_10003.BEGIN_STAGE
			local var_10_3 = {}

			SYSTEM_SCENARIO = var_3_10005
			var_10_3.system = var_3_10005
			var_10_3.stageId = var_6_2
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_OP, function(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_2_10005.CHAPTER_OP, arg_11_1)
	...
	var_1_6(var_1_5, var_8.getRawData(var_1_7))
	arg_1_0:display()
...
function var_0_1.onAutoBtn(arg_12_0, arg_12_1)
	...
	var_12_3(var_12_2, var_1_10007.AUTO_BOT, {
...
function var_0_1.onAutoSubBtn(arg_13_0, arg_13_1)
	...
	var_13_3(var_13_2, var_1_10007.AUTO_SUB, {
...
function var_0_1.handleNotification(arg_15_0, arg_15_1)
	...
	local var_15_3 = arg_15_1.getBody(var_15_2)

	PlayerProxy = var_15_0

	local var_15_5

	if var_15_1 == var_15_0.UPDATED then
		local var_15_4 = arg_15_0.viewComponent

		var_15_5 = var_15_5.setPlayerInfo
		getProxy = var_1_10007
		PlayerProxy = var_1_10009

		local var_15_6 = var_1_10007(var_1_10009)

		var_15_5(var_15_4, var_7.getRawData(var_15_6))
	...
	if var_15_1 == var_15_5.BEGIN_STAGE_ERRO then
		setActive = var_15_8

		var_15_8(arg_15_0.viewComponent._startBtn, true)

		if var_15_3 == 3 then
			pg = var_15_8

			local var_15_7 = var_15_8.MsgboxMgr.GetInstance()

			var_15_8 = var_15_8.ShowMsgBox
			...
			i18n = var_1_10008
			var_15_9.content = var_1_10008("battle_preCombatMediator_timeout")

			function var_15_9.onYes()
				local var_16_0 = arg_15_0.viewComponent
				local var_16_1 = var_0.emit

				BaseUI = var_2_10003

				var_16_1(var_16_0, var_2_10003.ON_CLOSE)

				return
			end

			var_15_8(var_15_7, var_15_9)
		end
	...
	if var_15_1 == var_15_8.CHAPTER_OP_DONE then
		local var_15_10 = var_15_3.type

		ChapterConst = var_15_2

		if var_15_10 ~= var_15_2.OpStrategy then
			local var_15_11 = var_15_3.type

			ChapterConst = var_5

			if var_15_11 ~= var_5.OpRepair then
				do
					local var_15_12 = var_15_3.type

					ChapterConst = var_5

					if var_15_12 == var_5.OpRequest then
						arg_15_0:display()
					end
				end
