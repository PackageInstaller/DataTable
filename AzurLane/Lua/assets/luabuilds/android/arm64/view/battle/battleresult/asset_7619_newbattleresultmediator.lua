...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.OPEN_FIALED_HELP, function(arg_3_0, arg_3_1)
		...
		BattleFailTipMediator = var_2_10008
		var_3_3.mediator = var_2_10008
		BattleFailTipLayer = var_2_10008
	...
	arg_1_0:bind(var_0_1.REENTER_STAGE, function(arg_4_0)
		...
		var_4_1(var_4_0, var_2_10004.BEGIN_STAGE, {
	...
	arg_1_0:bind(var_0_1.CHALLENGE_DEFEAT_SCENE, function(arg_6_0, arg_6_1)
		...
		ChallengePassedMediator = var_2_10008
		var_6_3.mediator = var_2_10008
		ChallengePassedLayer = var_2_10008
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_1 == var_8_0.BEGIN_STAGE_DONE then
		...
		var_8_4(var_8_3, var_1_10007, var_1_10008.COMBATLOAD, var_8_2)
	else
		GAME = var_8_4

		local var_8_6

		if var_8_1 == var_8_4.CONTINUE_STAGE_DONE then
			local var_8_5 = arg_8_0

			var_8_6 = arg_8_0.sendNotification
			GAME = var_1_10007

			local var_8_7 = var_1_10007.CHANGE_SCENE

			SCENE = var_1_10008

			var_8_6(var_8_5, var_8_7, var_1_10008.BOSSRUSH_PASSED_COMBATLOAD, var_8_2)
		else
			ContinuousOperationMediator = var_8_6

			local var_8_8

			if var_8_1 == var_8_6.CONTINUE_OPERATION then
				...
				if var_8_1 == var_8_8.SET_SKIP_FLAG then
					var_8_9 = arg_8_0.contextData
					var_8_9.autoSkipFlag = var_8_2
				else
					GAME = var_8_9

					if var_8_1 == var_8_9.ACT_BOSS_EXCHANGE_TICKET_DONE then
						...
						if var_8_1 == var_4.CONTINUE_OPERATION then
