...
function var_0_0.LevelAnimation(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_6_1(var_6_0, var_7.Action_float(function(arg_7_0)
	...
	var_6_3(var_6_2, var_7.Action(arg_6_1))
...
function var_0_0.ExpAnimation(arg_8_0, arg_8_1)
	...
	local var_8_1 = var_1_10003.value(arg_8_0.playerExp.gameObject, 0, var_8_0, 1.5)
	local var_8_2 = var_3.setOnUpdate

	System = var_6

	local var_8_3 = var_8_2(var_8_1, var_6.Action_float(function(arg_9_0)
	...
	var_8_4(var_8_3, var_6.Action(arg_8_1))
...
local function var_0_1(arg_10_0, arg_10_1)
	...
	local var_10_2 = var_1_10004(var_1_10006.user_level, arg_10_0.newPlayer.level).exp_interval

	LeanTween = var_1_10005

	local var_10_3 = var_1_10005.value(arg_10_0.playerExpBar.gameObject, var_10_0, var_10_1, 1.5)
	local var_10_4 = var_5.setOnUpdate

	System = var_8

	local var_10_5 = var_10_4(var_10_3, var_8.Action_float(function(arg_11_0)
	...
	var_10_6(var_10_5, var_8.Action(arg_10_1))
...
local function var_0_2(arg_12_0, arg_12_1)
	...
	local var_12_1 = var_1_10003(var_1_10005.user_level, arg_12_0.oldPlayer.level).exp_interval

	LeanTween = var_1_10004

	local var_12_2 = var_1_10004.value(arg_12_0.playerExpBar.gameObject, var_12_0 / var_12_1, 1, 1)
	...
	var_12_5(var_12_4, var_7.Action(arg_12_1))
...
local function var_0_3(arg_14_0, arg_14_1)
	...
	local var_14_1 = var_1_10003(var_1_10005.user_level, arg_14_0.newPlayer.level).exp_interval

	LeanTween = var_1_10004

	local var_14_2 = var_1_10004.value(arg_14_0.playerExpBar.gameObject, 0, var_14_0 / var_14_1, 1)
	local var_14_3 = var_4.setOnUpdate

	System = var_7

	local var_14_4 = var_14_3(var_14_2, var_7.Action_float(function(arg_15_0)
	...
	var_14_5(var_14_4, var_7.Action(arg_14_1))
...
local function var_0_4(arg_16_0, arg_16_1)
	...
	local var_16_4 = var_16_3(var_16_2, var_8.Action_float(function(arg_17_0)
	...
	var_16_6(var_16_5, var_8.Action(arg_16_1))
