...
function var_0_1.register(arg_1_0)
	...
	local var_1_4 = var_1_1(var_1_10006)
	...
	arg_1_0:bind(var_0_1.OPEN_SHIP_INFO, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		local var_2_3 = iter_2_0.GO_SCENE

		SCENE = iter_2_1

		var_2_2(var_2_1, var_2_3, iter_2_1.SHIPINFO, {
			shipId = arg_2_1,
			shipVOs = var_2_0
		})
	...
	arg_1_0:bind(var_0_1.CHANGE_FLEET_SHIP, function(arg_6_0, arg_6_1, arg_6_2)
		...
		local var_6_4 = var_4:getVanguardShipIds()

		pg = var_6_2

		local var_6_5 = var_6_2.ShipFlagMgr.GetInstance()

		for iter_6_0 = #var_7.FilterShips(var_6_5, {
			isActivityNpc = true,
			inExercise = true
		}), 1, -1 do
		...
		local var_6_6, var_6_7 = arg_1_0.configDockYardFunc(arg_1_0.ships, var_6_3, var_6_4, var_6_0, arg_6_2, function(arg_7_0, arg_7_1)
			local var_7_0 = arg_1_0
			local var_7_1 = var_2.sendNotification

			GAME = var_3_10005

			var_7_1(var_7_0, var_3_10005.UPDATE_EXERCISE_FLEET, {
				fleet = arg_7_0,
				callback = arg_7_1
			})
		...
		local var_6_9 = var_10.sendNotification

		GAME = var_13

		local var_6_10 = var_13.GO_SCENE

		SCENE = var_14

		local var_6_11 = var_14.DOCKYARD
		local var_6_12 = {
			callbackQuit = true,
			selectedMax = 1,
		...
		ShipStatus = var_16
		var_6_12.hideTagFlags = var_16.TAG_HIDE_DEFENSE
		i18n = var_16
		var_6_12.leftTopInfo = var_16("word_formation")
		var_6_12.onShip = var_6_7
		var_6_12.onSelected = var_6_6

		var_6_9(var_6_8, var_6_10, var_6_11, var_6_12)
...
function var_0_1.save(arg_9_0, arg_9_1, arg_9_2)
	if arg_9_1 then
		...
		var_9_1(var_9_0, var_1_10006.UPDATE_EXERCISE_FLEET, {
			fleet = arg_9_1,
			callback = arg_9_2
		})
	elseif arg_9_2 then
	...
	local function var_10_0(arg_11_0, arg_11_1)
		...
		local function var_11_1(arg_12_0)
			if not arg_10_3 then
				...
				for iter_12_0, iter_12_1 in var_1(var_3_10003.reverse(arg_12_0)) do
					table = var_3_10006
		...
		local function var_11_5()
			...
			i18n = var_3_10004
			var_14_2.content = var_3_10004("defense_formation_tip_npc")
		...
		if #arg_11_0 > 0 then
			...
			i18n = var_2_10010
			var_11_8.content = var_2_10010("exercise_clear_fleet_tip")
...
function var_0_1.handleNotification(arg_22_0, arg_22_1)
	...
	local var_22_2 = arg_22_1:getBody()

	GAME = var_22_0

	if var_22_0.EXERCISE_FLEET_RESET == var_22_1 then
