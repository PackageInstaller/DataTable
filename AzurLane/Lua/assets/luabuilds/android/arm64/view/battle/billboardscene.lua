...
PowerRank = var_0_0
var_0_2[1] = var_0_0.TYPE_EXTRA_CHAPTER
PowerRank = var_2
...
function var_0_1.init(arg_3_0)
	...
	var_1(var_3_12, var_4("list_empty_tip_billboardui"))
	...
	local var_3_25 = var_3_12(var_5)
	local var_3_26 = var_3.getActivitiesByType

	ActivityConst = var_6

	local var_3_27 = #var_3_24(var_3_26(var_3_25, var_6.ACTIVITY_TYPE_PT_RANK), function(arg_4_0)
	...
	arg_3_0.updateToggles(var_3_29)
	...
	if var_3.contains(var_0_1.SINGLE_SHOW, var_3_30) then
		setActive = var_3_32

		var_3_32(arg_3_0.leftPanel, false)

		setAnchoredPosition = var_3_32

		local var_3_31 = arg_3_0.mainPanel

		Vector2 = var_6

		var_3_32(var_3_31, var_6(0, -35.5))

		GetSpriteFromAtlas = var_3_32
		var_3_32 = var_3_32("commonbg/bg_fengshan", "")
		setImageSprite = var_3_29

		var_3_29(arg_3_0.extraChapterBg, var_3_32)
	end

	setActive = var_3_32

	local var_3_33 = arg_3_0.extraChapterBg

	PowerRank = var_6

	var_3_32(var_3_33, var_3_30 == var_6.TYPE_EXTRA_CHAPTER)
...
function var_0_1.updateToggles(arg_5_0)
	...
	for iter_5_2, iter_5_3 in var_1(arg_5_0.ptToggles) do
		...
		var_1_10006 = var_1_10006.getActivityById(var_1_10008, iter_5_2)
		setActive = var_1_10007
	...
	var_5_2(var_5_1, iter_5_3(var_1_10007)).enabled = var_5_0
...
function var_0_1.didEnter(arg_6_0)
	...
	local var_6_2 = var_4.Find(var_6_1, "back_btn")
	...
	for iter_6_0, iter_6_1 in var_1_10001(arg_6_0.toggles) do
		...
		local function var_6_6(arg_8_0)
			...
			if var_8_0 == var_2_10002.TYPE_GUILD_BATTLE then
				...
				BillboardMediator = var_4

				var_8_0(var_2_10003, var_4.ON_GUILD_RANK, arg_8_0)
			...
			if arg_8_0 then
				...
				local var_8_1 = var_8_0(var_2_10003:getActivityByRankType(iter_6_0), {
					"id"
				})
				local var_8_2 = arg_6_0

				var_2.switchPage(var_8_2, iter_6_0, var_8_1)
			end
		...
		var_6_1(var_6_4, var_6_5, var_6_6, var_1_10011)
	end
	...
	for iter_6_2, iter_6_3 in var_1(arg_6_0.ptToggles) do
		...
		local function var_6_9(arg_9_0)
			if arg_9_0 then
				...
				PowerRank = var_2_10004

				var_9_1(var_9_0, var_2_10004.TYPE_PT, iter_6_2)
			end
		...
		var_6_1(var_6_7, var_6_8, var_6_9, var_1_10011)
	end
	...
	RankCard = iter_6_2
	arg_6_0.playerCard = var_6_11(var_6_12, iter_6_2.TYPE_SELF)
	...
	var_2(arg_6_0.toggles[var_6_13], true)
...
function var_0_1.onInintItem(arg_13_0, arg_13_1)
	...
	RankCard = var_1_10005

	local var_13_2 = var_13_0(var_13_1, var_1_10005.TYPE_OTHER)

	onButton = var_1_10003

	var_1_10003(arg_13_0, var_13_2._tf, function()
		...
		if var_14_0 == var_2_10001.TYPE_MILITARY_RANK then
			...
			BillboardMediator = var_2_10003

			var_14_2(var_14_1, var_2_10003.OPEN_RIVAL_INFO, var_13_2.rankVO.id)
		end
...
function var_0_1.switchPage(arg_18_0, arg_18_1, arg_18_2)
	...
	if not var_18_0 then
		...
		BillboardMediator = var_1_10007

		var_18_1(var_18_4, var_1_10007.FETCH_RANKS, arg_18_0.page, arg_18_2)
	else
	...
	local var_18_6 = var_6.Find(var_18_5, "tip")

	table = var_1_10007

	local var_18_7 = var_1_10007.contains

	BillboardProxy = var_9

	var_18_1(var_18_6, not var_18_7(var_9.NONTIMER, arg_18_0.page))
...
function var_0_1.updateScoreTitle(arg_19_0, arg_19_1, arg_19_2)
	...
	PowerRank = var_1_10004

	local var_19_2 = var_1_10004:getTitleWord(arg_19_1, arg_19_2)
