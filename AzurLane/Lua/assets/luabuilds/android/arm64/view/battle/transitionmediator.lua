...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_1 == var_4_0.LOAD_SCENE_DONE then
		SCENE = var_4

		if var_4_3 == var_4.TRANSITION then
			arg_4_0.contextData.afterLoadFunc()
		end
	else
		GAME = var_4

		if var_4_1 == var_4.BEGIN_STAGE_DONE then
			getProxy = var_4
			...
			BattleMediator = var_1_10007

			if var_4_5(var_4_4, var_1_10007) then
				getProxy = var_4_2
				ContextProxy = var_1_10007

				local var_4_6 = var_4_2(var_1_10007)

				var_5.RemoveContext(var_4_6, var_4)
			end
			...
			local var_4_9 = var_1_10008.CHANGE_SCENE

			SCENE = var_1_10009

			var_4_8(var_4_7, var_4_9, var_1_10009.COMBATLOAD, var_4_3)
		end
	end
