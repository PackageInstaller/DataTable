...
function var_0_1.RegisterEvent(arg_3_0, arg_3_1)
	...
	var_1_10002({
		...
		var_2_10000(var_7_0, var_7_1, var_7_2, var_2_10005)
...
function var_0_1.MovePainting(arg_9_0, arg_9_1)
	...
	local var_9_3 = var_9_2(var_9_1, var_6.Action_float(function(arg_10_0)
	...
	var_9_4(var_9_3, var_6.Action(arg_9_1))
	...
	var_9_8(var_9_7, var_8.Action_UnityEngine_Vector2(function(arg_11_0)
...
function var_0_1.GetGetObjectives(arg_12_0)
	...
	local var_12_4 = var_1_10005.insert
	local var_12_5 = var_12_1
	local var_12_6 = {}

	setColorStr = var_1_10009
	var_12_6.text = var_1_10009(var_12_3, "#FFFFFFFF")
	setColorStr = var_9

	local var_12_7 = var_12_2.score

	COLOR_BLUE = var_12
	var_12_6.value = var_9(var_12_7, var_12)
	...
	var_12_11.text = var_1_10010(var_12_8, "#FFFFFFFF")
	setColorStr = var_10

	local var_12_12 = var_12_2.maxCombo

	COLOR_YELLOW = var_13
	var_12_11.value = var_10(var_12_12, var_13)
...
function var_0_1.UpdatePainting(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_3 = arg_15_0.GetFlagShip(var_15_2)
	local var_15_4 = var_4.getPainting(var_15_3)

	setPaintingPrefabAsync = var_15_2

	var_15_2(var_15_1, var_15_4, "biandui", function()
		...
		local var_16_1 = var_2_10002(var_15_1, "fitter")
		local var_16_2 = var_2.GetChild(var_16_1, 0)
		local var_16_3 = var_15_4

		ShipWordHelper = var_16_1

		var_16_0(var_16_2, var_16_3, var_16_1.WORD_TYPE_MVP)
		arg_15_2()
	...
	local var_15_6 = arg_15_0.DisplayShipDialogue
	local var_15_7 = arg_15_1.transform

	var_15_6(var_15_5, var_9.Find(var_15_7, "chat"), var_4)
	...
	Vector3 = var_15_3
	var_15_8.localPosition = var_15_3(2500, 0, 0)

	local var_15_9 = arg_15_1.transform

	var_6.SetSiblingIndex(var_15_9, 2)
...
function var_0_1.DisplayShipDialogue(arg_17_0, arg_17_1, arg_17_2)
	...
	if arg_17_0.contextData.score > 1 then
		...
		var_17_3, var_17_5, var_17_6 = var_17_3(var_17_4, var_1_10009.WORD_TYPE_MVP)
		var_17_1 = var_17_6
		...
		local var_17_9 = var_17_3.GetWordAndCV
		local var_17_10 = arg_17_2.skinId

		ShipWordHelper = var_1_10009

		local var_17_11, var_17_12

		var_17_11, var_17_12, var_17_1 = var_17_9(var_17_10, var_1_10009.WORD_TYPE_LOSE)
	end

	local var_17_13 = arg_17_1:Find("Text")
	local var_17_14 = var_6.GetComponent

	typeof = var_9
	Text = var_1_10011

	local var_17_15 = var_17_14(var_17_13, var_9(var_1_10011))

	var_17_15.text = var_17_1

	local var_17_16 = #var_17_1

	CHAT_POP_STR_LEN = var_17_13

	if var_17_13 < var_17_16 then
		TextAnchor = var_17_16

		if not var_17_16.MiddleLeft then
			TextAnchor = var_17_16
			var_17_16 = var_17_16.MiddleCenter
		end

		var_17_15.alignment = var_17_16
...
function var_0_1.OnDestroy(arg_19_0)
	if arg_19_0.paintingTr then
		...
		var_1_10002(arg_19_0.paintingTr, var_19_0:getPainting())
	end
