...
function var_0_1.isTotalClear(arg_4_0)
	...
	if var_4_1 == var_1_10002.MODE_CASUAL then
...
function var_0_1.init(arg_6_0)
	...
	var_1(var_6_1, var_4("battle_result_continue_battle"))
	...
	var_1(var_6_2, var_4("battle_result_quit_battle"))
	...
	var_1(var_6_3, var_4("battle_result_share_battle"))
...
function var_0_1.setStageName(arg_9_0)
	...
	do
		...
		pg = var_1_10002
		var_1_10002 = var_1_10002.expedition_data_template[var_9_1]
	end

	::label_9_0::

	local var_9_2 = arg_9_0.challenge
	local var_9_3 = var_1.getMode(var_9_2)

	ChallengeProxy = var_1_10002

	if var_9_3 == var_1_10002.MODE_INFINITE then
		local var_9_4 = arg_9_0.contextData.stageId

		pg = var_2

		local var_9_5 = var_2.expedition_data_template[var_9_4].name
		local var_9_6 = " - ROUND "
		local var_9_7 = arg_9_0.challenge
		local var_9_8 = var_9_5 .. var_9_6 .. var_5.getLevel(var_9_7)

		setText = var_9_6

		var_9_6(arg_9_0._levelText, var_9_8)
	else
...
function var_0_1.rankAnimaFinish(arg_10_0)
	...
	ChallengeProxy = var_10_0

	if var_10_3 == var_10_0.MODE_INFINITE then
		SetActive = var_10_3
		...
		var_10_5(var_10_4, var_5(var_10_6, var_8.getLastScore(var_10_7)), true)
		...
		var_10_9(var_10_8, var_5(var_10_10, var_8.getScore(var_10_11)), true)
		...
		local var_10_14 = var_10_12(var_10_13, var_5.Action(function()
			...
			var_11_0(var_2.Find(var_11_1, "jieuan01/tips"), true)
		...
		var_3.insert(arg_10_0._delayLeanList, var_10_14.id)
...
function var_0_1.displayDefeat(arg_12_0)
	...
	if arg_12_0:isFail() then
		...
		BattleResultMediator = var_1_10005

		var_12_2(var_12_1, var_1_10005.ON_CHALLENGE_DEFEAT_SCENE, {
			callback = var_12_0
		})
	end
...
function var_0_1.showRightBottomPanel(arg_14_0)
	...
	var_1_10001(var_14_0, var_4("challenge_expire_warn"))
	...
	if not arg_14_0:isTotalClear() then
		...
		var_1(var_3.Find(var_14_1, "jieuan01/tips"), false)
	end
	...
	if arg_14_0:isTotalClear() then
		...
		local function var_14_4()
			...
			var_15_1(var_15_0, var_2_10003.ON_CHALLENGE_SHARE)
		...
		var_1(var_14_2, var_14_3, var_14_4, var_6)
		...
		var_1(var_14_5, var_14_6, var_14_7, var_6)
		...
		var_1(var_14_8, var_14_9, var_14_10, var_6)
	end
...
function var_0_1.skip(arg_20_0)
	...
	elseif arg_20_0._stateFlag == var_0_1.STATE_REPORT then
		...
		while 0 < var_20_0 do
			...
			var_2(iter_20_0.GetChild(var_20_1, var_20_0 - 1), true)
		...
		var_2(iter_20_0.Find(var_20_2, "jieuan01/tips"), true)
	...
	elseif arg_20_0._stateFlag == var_0_1.STATE_DEFEAT then
		if arg_20_0:isTotalClear() then
			...
			BattleResultMediator = iter_20_0

			var_20_4(var_20_3, iter_20_0.ON_BACK_TO_LEVEL_SCENE, {
				goToNext = false
			})
		else
	...
	elseif arg_20_0._stateFlag == var_0_1.STATE_CONTINUE then
		...
		var_20_6(var_20_5, iter_20_0.ON_BACK_TO_LEVEL_SCENE, {
			goToNext = true
		})
	elseif arg_20_0._stateFlag == var_0_1.STATE_QUIT or arg_20_0._stateFlag == var_0_1.STATE_CLEAR then
		...
		var_20_8(var_20_7, iter_20_0.ON_BACK_TO_LEVEL_SCENE, {
			goToNext = false
		})
	end
