...
function var_0_0.ScoreAnimation(arg_5_0, arg_5_1)
	...
	local var_5_1 = var_1_10003.value(arg_5_0.playerExp.gameObject, 0, var_5_0, 1.5)
	local var_5_2 = var_3.setOnUpdate

	System = var_6

	local var_5_3 = var_5_2(var_5_1, var_6.Action_float(function(arg_6_0)
	...
	var_5_4(var_5_3, var_6.Action(arg_5_1))
