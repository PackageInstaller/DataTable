...
function var_0_1.register(arg_1_0)
	...
	local var_1_10 = var_8.getActivityByType

	ActivityConst = var_1_10011

	var_1_8(var_1_7, var_1_10(var_1_9, var_1_10011.ACTIVITY_TYPE_DAILY_STAGE_BONUS))
	arg_1_0:bind(var_0_1.ON_QUICK_BATTLE, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		var_4.CheckShipExpItemOverflow(var_2_0, arg_2_2, function()
			...
			var_3_1(var_3_0, var_3_10003.DAILY_LEVEL_QUICK_BATTLE, {
	...
	arg_1_0:bind(var_0_1.ON_STAGE, function(arg_4_0, arg_4_1)
		...
		local var_4_4 = var_2_10008.New
		local var_4_5 = {}

		PreCombatMediator = var_2_10011
		var_4_5.mediator = var_2_10011
...
function var_0_1.CheckShipExpItemOverflow(arg_6_0, arg_6_1, arg_6_2)
	...
	if var_1_10004.any(var_6_0, function(arg_7_0)
		...
		local var_7_2 = var_2_10002.getConfigData(arg_7_0[2])
		local var_7_3 = arg_7_0[1]

		DROP_TYPE_ITEM = var_4

		if var_7_3 == var_4 then
			...
			if var_7_4 ~= var_4.EXP_BOOK_TYPE or not (var_7_1 >= var_7_2.max_num) then
				var_7_5 = false
			else
				var_7_5 = true
			end
		...
		i18n = var_1_10008
		var_6_3.content = var_1_10008("player_expResource_mail_fullBag")
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_1 == var_9_0.UPDATED then
		...
		if var_9_1 == var_4.DAILY_LEVEL_QUICK_BATTLE_DONE then
			local var_9_4
			...
			if #var_9_2.awards > 0 then
				...
				var_9_4(var_1_10007, var_1_10008.ON_ACHIEVE, var_4)
			end

			getProxy = var_9_4
			DailyLevelProxy = var_1_10007

			local var_9_5 = var_9_4(var_1_10007)
			local var_9_6 = arg_9_0.viewComponent

			var_6.setDailyCounts(var_9_6, var_9_5:getRawData())

			local var_9_7 = arg_9_0.viewComponent

			var_6.UpdateBattleBtn(var_9_7, {
				id = var_9_2.stageId
			})

			local var_9_8 = arg_9_0.viewComponent

			var_6.UpdateDailyLevelCnt(var_9_8, var_9_2.dailyLevelId)

			local var_9_9 = arg_9_0.viewComponent

			var_6.UpdateDailyLevelCntForDescPanel(var_9_9, var_9_2.dailyLevelId)
		else
			GAME = var_4

			if var_9_1 == var_4.REMOVE_LAYERS and var_9_2.context.mediator.__cname == "PreCombatMediator" then
				setActive = var_4
