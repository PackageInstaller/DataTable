...
function var_0_1.StaticGetFinalExpandPosition(arg_3_0)
	if arg_3_0 <= var_0_2 then
		...
		return var_3_1 - var_3_0 * var_1_10003(var_0_3, 0)
	end
...
function var_0_1.GetShrinkPosition(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_1 = arg_6_0.GetExpandPosition(var_6_0, arg_6_1, arg_6_2)
	local var_6_2 = arg_6_2 % 2 ~= 0

	Vector2 = var_6_0

	local var_6_3 = var_6_0(-125, -936)

	if arg_6_1 > 6 and arg_6_1 % 2 == 0 or arg_6_1 <= 6 then
		local var_6_4

		if not var_6_2 or not (var_6_1 - var_6_3) then
			var_6_4 = var_6_1 + var_6_3
		end
...
function var_0_1.ReSortFleetShips(arg_15_0)
	...
	if var_15_6 ~= nil then
		...
		local var_15_9 = var_1_10010.GetTeamFromShipType(var_15_8)
...
function var_0_1.InitSubFleetShips(arg_16_0, arg_16_1)
	...
	for iter_16_0 = 1, var_16_0 do
		if arg_16_0.slots[iter_16_0] then
			var_1_10010 = arg_16_0

			arg_16_0.RevertPainting(var_1_10010, arg_16_0.slots[iter_16_0])

			retPaintingPrefab = var_8

			local var_16_1 = arg_16_0.slots[iter_16_0]

			var_1_10010 = var_1_10010.Find(var_16_1, "mask/painting")

			local var_16_2 = var_2[iter_16_0]

			var_8(var_1_10010, var_11.getPainting(var_16_2))
		end
	end
	...
	for iter_16_1 = var_16_4, var_6.max(var_0_2, #var_2) do
		...
		local var_16_5 = var_16_5.Instantiate(arg_16_0.slots[1], arg_16_0.slots[1].parent)

		table = var_1_10010

		var_1_10010.insert(arg_16_0.slots, var_16_5)

		var_1_10010 = var_2[iter_16_1]
		var_16_5.localPosition = arg_16_0:GetExpandPosition(#var_2, iter_16_1)
		table = var_12

		var_12.insert(var_16_3, function(arg_17_0)
			setPaintingPrefabAsync = var_2_10001

			local var_17_0 = var_16_5
			local var_17_1 = var_3.Find(var_17_0, "mask/painting")
			local var_17_2 = var_1_10010

			var_2_10001(var_17_1, var_4.getPainting(var_17_2), "biandui", arg_17_0)

			local var_17_3 = arg_16_0

			var_1.AdjustPainting(var_17_3, var_16_5, var_1_10010)
...
function var_0_1.DisplaySubFleet(arg_19_0, arg_19_1)
	...
	for iter_19_0 = var_19_2, var_1_10006.max(var_0_2, #var_2) do
		...
		local var_19_5 = arg_19_0.GetExpandPosition(var_19_4, #var_2, iter_19_0).x - var_19_1 * var_0_3

		table = var_19_4

		var_19_4.insert(var_19_0, function(arg_20_0)
			if arg_19_0.exited then
				return
			end
			...
			local var_20_0 = var_1.value(var_19_3.gameObject, var_0, var_19_5, 0.3)
			local var_20_1 = var_1.setOnUpdate

			System = var_4

			local var_20_2 = var_20_1(var_20_0, var_4.Action_float(function(arg_21_0)
			...
			var_20_3(var_20_2, var_4.easeOutQuad)
			...
			var_20_3(function()
				...
				var_0(var_2.Find(var_22_0, "mask/blink"), true)
			...
			var_20_3(function()
				...
				var_0(var_2.Find(var_23_0, "mask/blink"), false)
...
function var_0_1.MoveMainFleetShips(arg_26_0, arg_26_1)
	...
	for iter_26_0, iter_26_1 in var_1_10005(arg_26_0.slots) do
		...
		var_1_10010.insert(var_26_0, function(arg_27_0)
			...
			local var_27_4 = var_27_3(var_27_2, var_6.Action_float(function(arg_28_0)
			...
			local var_27_6 = var_27_5(var_27_4, var_6.easeOutQuad)
			local var_27_7 = var_3.setOnComplete

			System = var_6

			var_27_7(var_27_6, var_6.Action(arg_27_0))
...
function var_0_1.DisplayMainFleet(arg_31_0, arg_31_1)
	...
	for iter_31_0, iter_31_1 in var_1_10005(arg_31_0.slots) do
		...
		var_1_10010.insert(var_31_0, function(arg_32_0)
			...
			local var_32_5 = var_32_1.value(iter_31_1.gameObject, var_32_4, var_32_2, 0.29)
			local var_32_6 = var_4.setOnUpdate

			System = var_7

			var_32_6(var_32_5, var_7.Action_UnityEngine_Vector2(function(arg_33_0)
...
function var_0_1.InitMainFleetShips(arg_37_0, arg_37_1)
	...
	for iter_37_0 = 2, var_37_1 do
		...
		var_1_10009.insert(arg_37_0.slots, var_1_10008)
	end
	...
	for iter_37_1 = 1, var_37_1 do
		...
		var_12.insert(var_37_2, function(arg_38_0)
			...
			local var_38_1 = var_3.Find(var_38_0, "mask/painting")
			local var_38_2 = var_37_4

			var_1(var_38_1, var_4.getPainting(var_38_2), "biandui", arg_38_0)
...
function var_0_1.AdjustPainting(arg_39_0, arg_39_1, arg_39_2)
	...
	local var_39_1 = var_1_10004.ship_skin_newmainui_shift
	local var_39_2 = arg_39_2

	if var_39_1[arg_39_2.getSkinId(var_39_2)] then
		local var_39_3 = var_4.battle_result_display_shift
		local var_39_4 = var_39_0
		local var_39_5 = var_39_0.GetComponent

		typeof = var_1_10009
		RectTransform = var_1_10011

		local var_39_6 = var_39_5(var_39_4, var_1_10009(var_1_10011))

		Vector2 = var_39_2
		var_39_6.anchoredPosition = var_39_2(var_39_3[1] + arg_39_0.defaultPaintingPosition.x, var_39_3[2] + arg_39_0.defaultPaintingPosition.y)

		local var_39_7 = var_39_3[4]

		Vector3 = var_39_4
		var_39_6.localScale = var_39_4(var_39_7, var_39_7, 1)

		local var_39_8 = var_39_6.localEulerAngles

		Vector3 = var_9

		local var_39_9 = var_39_8.x
		local var_39_10 = var_39_8.y
		local var_39_11

		if not var_39_3[5] or not var_39_3[5] then
			var_39_11 = 0
		end

		var_39_6.localEulerAngles = var_9(var_39_9, var_39_10, var_39_11)
	end
...
function var_0_1.RevertPainting(arg_40_0, arg_40_1)
	...
	local var_40_2 = var_40_1(var_40_0, var_1_10006(var_1_10008))
...
function var_0_1.OnDestroy(arg_41_0)
	...
	for iter_41_0, iter_41_1 in var_1_10002(var_41_1) do
		if iter_41_1 and iter_41_1:Find("mask/painting") and var_41_0[iter_41_0] and var_1_10007:Find("fitter").childCount > 0 then
			arg_41_0:RevertPainting(iter_41_1)

			retPaintingPrefab = var_8

			local var_41_2 = var_1_10007
			local var_41_3 = var_41_0[iter_41_0]

			var_8(var_41_2, var_11.getPainting(var_41_3))
		end
