...
function var_0_1.GetGetObjectives(arg_1_0)
	...
	local var_1_4 = var_1_10005.insert
	...
	var_1_6.text = var_1_10009(var_1_3, "#FFFFFFFF")
	setColorStr = var_9

	local var_1_7 = "+" .. var_1_2.basePoint

	COLOR_BLUE = var_12
	var_1_6.value = var_9(var_1_7, var_12)
	...
	var_1_11.text = var_1_10010(var_1_8, "#FFFFFFFF")
	setColorStr = var_10

	local var_1_12 = "-" .. var_1_2.losePoint

	COLOR_BLUE = var_13
	var_1_11.value = var_10(var_1_12, var_13)
	...
	setColorStr = var_1_7
	var_1_16.text = var_1_7(var_1_13, "#FFFFFFFF")
	setColorStr = var_11

	local var_1_17 = "+" .. var_1_2.point

	COLOR_BLUE = var_14
	var_1_16.value = var_11(var_1_17, var_14)
	...
	var_1_21.text = var_1_12(var_1_18, "#FFFFFFFF")
	setColorStr = var_12

	local var_1_22 = var_1_2.total

	COLOR_YELLOW = var_15
	var_1_21.value = var_12(var_1_22, var_15)
