...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.OPEN_RANK, function(arg_2_0)
		...
		local var_2_3 = var_2_10005.BILLBOARD
		local var_2_4 = {}

		PowerRank = var_2_10007
		var_2_4.page = var_2_10007.TYPE_MILITARY_RANK
	...
	arg_1_0:bind(var_0_1.OPEN_RIVAL_INFO, function(arg_3_0, arg_3_1)
		...
		RivalInfoLayer = var_2_10008
		var_3_3.viewComponent = var_2_10008
		RivalInfoMediator = var_2_10008
		...
		RivalInfoLayer = var_2_10009
		var_3_4.type = var_2_10009.TYPE_BATTLE
	...
	arg_1_0:bind(var_0_1.OPEN_DOCKYARD, function(arg_4_0, arg_4_1, arg_4_2)
		...
		local var_4_2 = var_2_10006.GO_SCENE

		SCENE = var_2_10007

		var_4_1(var_4_0, var_4_2, var_2_10007.EXERCISEFORMATION)
	...
	arg_1_0:bind(var_0_1.OPEN_SHOP, function(arg_5_0, arg_5_1)
		...
		local var_5_3 = var_2_10006.SHOP
		...
		if not arg_5_1 then
			...
			var_2_10007.warp = var_2_10008.TYPE_MILITARY_SHOP
		end

		var_5_1(var_5_0, var_5_2, var_5_3, var_2_10007)
	...
	arg_1_0.bind(var_1_7, var_0_1.REPLACE_RIVALS, function(arg_6_0)
		...
		var_6_1(var_6_0, var_2_10004.REPLACE_RIVALS)
	...
	if var_1_0:getSeasonInfo() then
		...
		var_1_13(var_1_12, var_1_10012.GET_SEASON_INFO)
	end
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_1 == var_8_0.REPLACE_RIVALS_DONE then
		local var_8_4 = arg_8_0.viewComponent

		var_8_7.setRivals(var_8_4, var_8_3)

		local var_8_5 = arg_8_0.viewComponent

		var_8_7.updateRivals(var_8_5)
		...
		var_8_7(var_8_6, var_1_10007("exercise_replace_rivals_ok_tip"))
	else
		GAME = var_8_7

		if var_8_1 == var_8_7.GET_SEASON_INFO_DONE then
			local var_8_8 = arg_8_0.viewComponent

			var_4.setSeasonInfo(var_8_8, var_8_3)
		else
			MilitaryExerciseProxy = var_4

			if var_8_1 == var_4.EXERCISE_FLEET_UPDATED then
				local var_8_9 = arg_8_0.viewComponent

				var_4.setFleet(var_8_9, var_8_3)

				local var_8_10 = arg_8_0.viewComponent

				var_4.initPlayerFleet(var_8_10)
			else
				PlayerProxy = var_4
				...
				if var_8_1 == var_4.UPDATED then
					...
					var_4.updatePlayer(var_8_11, var_8_3)
				else
					MilitaryExerciseProxy = var_4

					if var_8_1 == var_4.SEASON_INFO_UPDATED then
						local var_8_12 = arg_8_0.viewComponent

						var_4.updateSeaInfoVO(var_8_12, var_8_3)

						local var_8_13 = arg_8_0.viewComponent

						var_4.updateSeasonTime(var_8_13)
					else
						GAME = var_4

						local var_8_15

						if var_8_1 == var_4.MILITARY_STARTED then
							local var_8_14 = arg_8_0

							var_8_15 = arg_8_0.addSubLayers
							Context = var_1_10007

							local var_8_16 = var_1_10007.New
							local var_8_17 = {}

							ExercisePreCombatMediator = var_1_10010
							var_8_17.mediator = var_1_10010
							ExercisePreCombatLayer = var_1_10010
							var_8_17.viewComponent = var_1_10010
							var_8_17.data = {
								stageId = 80000,
								system = var_8_3.system,
								rivalId = var_8_3.rivalId
							}

							var_8_15(var_8_14, var_8_16(var_8_17))
						else
							ActivityProxy = var_8_15

							if var_8_1 == var_8_15.ACTIVITY_UPDATED then
								local var_8_18 = var_8_3.id

								ActivityConst = var_8_2

								if var_8_18 == var_8_2.MILITARY_EXERCISE_ACTIVITY_ID then
									local var_8_19 = arg_8_0.viewComponent

									var_4.setActivity(var_8_19, var_8_3)

									local var_8_20 = arg_8_0.viewComponent

									var_4.updateSeasonLeftTime(var_8_20, var_8_3.stopTime)
								end
							end
						end
					end
