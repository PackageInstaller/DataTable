...
function var_0_1.init(arg_4_0)
	...
	var_1_10009(var_11.Find(var_4_21, "jieuan01/BG/bg_victory"), var_4_20)

	setActive = var_1_10009

	local var_4_22 = arg_4_0._bg

	var_1_10009(var_11.Find(var_4_22, "jieuan01/BG/bg_fail"), not var_4_20)
	...
	var_1_10009(var_11.Find(var_4_25, "main/conditions"), false)
	...
	typeof = var_12
	AspectRatioFitter = var_14
	arg_4_0._ratioFitter = var_1_10009(var_4_26, var_12(var_14))
	...
	pg = var_12
	arg_4_0.camEventId = var_4_29(var_4_28, var_12.CameraFixMgr.ASPECT_RATIO_UPDATE, function(arg_5_0, arg_5_1)
...
function var_0_1.didEnter(arg_6_0)
	...
	Vector3 = var_5
	var_6_3.localScale = var_5(1.5, 1.5, 0)
	LeanTween = var_6_3
	...
	local var_6_6 = var_6_4(var_6_5, var_7(0.88, 0.88, 1), var_0_1.DURATION_WIN_SCALE)
	local var_6_7 = var_4.setOnComplete

	System = var_7

	var_6_7(var_6_6, var_7.Action(function()
	...
	local var_6_10 = var_6_9(var_6_8, var_7(var_9))

	Color = var_5
	var_6_10.color = var_5.New(0, 0, 0, 0.5)
	...
	var_4(var_6_11, var_6_12, var_6_13, var_9)
