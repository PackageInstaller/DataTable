...
function var_0_1.Register(arg_4_0)
	...
	var_1.AddHeroInfoModify(var_4_1, function(arg_6_0, arg_6_1, arg_6_2)
		...
		var_6_1(var_6_0, var_2_10006(0.65, 0.65, 1))
		...
		local var_6_3 = var_2_10004(var_6_2, "stars")
		...
		if var_6_5 then
			local var_6_7 = arg_6_1
			local var_6_9

			var_6_8, var_6_9 = arg_6_1.getEnergyPrint(var_6_7)
			GetSpriteFromAtlas = var_6_7

			if not var_6_7("energy", var_6_8) then
				warning = var_6_11
		...
		if var_6_5 then
			...
			var_6_11 = arg_4_0.contextData.system
			SYSTEM_DUEL = var_2_10011
			var_6_11 = var_6_11 ~= var_2_10011
		end

		var_6_8(var_6_10, var_6_11)

		local var_6_12 = arg_6_1:getStar()
		...
		local var_6_13 = "shiptype"

		shipType2print = iter_6_0

		if not var_8(var_6_13, iter_6_0(arg_6_1:getShipType())) then
			warning = var_9

			var_9("找不到船形, shipConfigId: " .. arg_6_1.configId)
		end

		setImageSprite = var_9
		findTF = var_11

		var_9(var_11(var_6_2, "type"), var_8, true)

		setText = var_9
		findTF = var_11

		var_9(var_11(var_6_2, "frame/lv_contain/lv"), arg_6_1.level)

		local var_6_14 = var_6_2:Find("expbuff")

		setActive = var_6_13

		var_6_13(var_6_14, false)
	...
	var_1.AddLongPress(var_4_2, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_7_1(var_7_0, var_2_10006.OPEN_SHIP_INFO, arg_7_1.id, arg_7_2)
	...
	var_1.AddClick(var_4_3, function(arg_8_0, arg_8_1, arg_8_2)
		...
		var_8_3(var_8_2, var_2_10006.CHANGE_FLEET_SHIP, arg_8_0, arg_8_2, arg_8_1)
	...
	var_1.AddShiftOnly(var_4_6, function(arg_11_0)
		...
		var_11_1(var_11_0, var_2_10004.CHANGE_FLEET_SHIPS_ORDER, arg_11_0)
	...
	var_1.AddRemoveShip(var_4_7, function(arg_12_0, arg_12_1)
		...
		var_12_1(var_12_0, var_2_10005.REMOVE_SHIP, arg_12_0, arg_12_1)
	...
	var_1.AddCheckRemove(var_4_8, function(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4)
		...
		i18n = var_2_10009
		var_13_2.content = var_2_10009("battle_preCombatLayer_quest_leaveFleet", arg_13_2:getConfigTable().name)
	...
	var_1.AddSwitchToDisplayMode(var_4_9, function()
		...
		var_14_1(var_2.Find(var_14_2, "save"), true)

		setActive = var_14_1

		local var_14_3 = arg_4_0._checkBtn

		var_14_1(var_2.Find(var_14_3, "edit"), false)
	...
	var_1.AddSwitchToPreviewMode(var_4_11, function()
		...
		var_16_1(var_2.Find(var_16_2, "save"), false)

		setActive = var_16_1

		local var_16_3 = arg_4_0._checkBtn

		var_16_1(var_2.Find(var_16_3, "edit"), true)
	...
	var_1.AddGridTipClick(var_4_12, function(arg_17_0, arg_17_1)
		...
		var_17_1(var_17_0, var_2_10005.CHANGE_FLEET_SHIP, nil, arg_17_1, arg_17_0)
...
function var_0_1.didEnter(arg_18_0)
	...
	local function var_18_2()
		...
		if arg_18_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_1.insert(var_19_0, function(arg_20_0)
				...
				i18n = var_3_10005
				var_20_2.content = var_3_10005("battle_preCombatLayer_save_confirm")

				function var_20_2.onYes()
					local var_21_0 = arg_18_0
					local var_21_1 = var_0.emit

					ExercisePreCombatMediator = var_4_10003

					var_21_1(var_21_0, var_4_10003.ON_COMMIT_EDIT, function()
						pg = var_5_10000
						...
						var_22_1(var_22_0, var_5_10003("battle_preCombatLayer_save_success"))
						arg_20_0()
		...
		var_1(var_19_0, function()
			...
			var_3_10000(var_23_0, var_3_10003(var_3_10005)).interactable = false
			...
			var_23_2(var_23_3, var_3_10004.Action(function()
	...
	local function var_18_5()
		...
		if arg_18_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_1.insert(var_25_0, function(arg_26_0)
				...
				i18n = var_3_10005
				var_26_2.content = var_3_10005("battle_preCombatLayer_save_march")
				...
				function var_26_2.onYes()
					...
					var_27_1(var_27_0, var_4_10003.ON_COMMIT_EDIT, function()
						...
						var_28_2(var_28_1, var_5_10003("battle_preCombatLayer_save_success"))
						arg_26_0()
		...
		var_1(var_25_0, function()
			...
			var_29_1(var_29_0, var_3_10003.ON_START, arg_18_0._currentFleetVO.id)
	...
	local function var_18_8()
		...
		var_30_1(var_30_0, var_2_10003.ON_CHANGE_FLEET, arg_18_0._legalFleetIdList[arg_18_0._curFleetIndex + 1])
	...
	local function var_18_11()
		...
		var_31_1(var_31_0, var_2_10003.ON_CHANGE_FLEET, arg_18_0._legalFleetIdList[arg_18_0._curFleetIndex - 1])
	...
	local function var_18_14()
		if arg_18_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_32_1(var_32_0, var_2_10003.ON_COMMIT_EDIT, function()
				pg = var_3_10000
				...
				var_33_1(var_33_0, var_3_10003("battle_preCombatLayer_save_success"))
	...
	if var_18_18 == var_2 then
		...
		local function var_18_21(arg_34_0)
			...
			var_34_1(var_34_0, var_2_10004.ON_AUTO, {
				isOn = not arg_34_0,
			...
			if arg_34_0 and arg_18_0._subUseable == true then
				...
				local function var_34_4(arg_35_0)
					...
					ExercisePreCombatMediator = var_3_10004

					var_35_1(var_35_0, var_3_10004.ON_SUB_AUTO, {
						isOn = not arg_35_0,
				...
				var_34_1(var_34_2, var_34_3, var_34_4, var_6, var_2_10007)
		...
		var_18_18(var_18_19, var_18_20, var_18_21, var_1_10006, var_1_10007)
...
function var_0_1.willExit(arg_38_0)
	if arg_38_0._currentForm == var_0_1.FORM_EDIT then
		...
		local var_38_0 = var_1(var_1_10003)
