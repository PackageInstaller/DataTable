...
function var_0_1.register(arg_1_0)
	...
	local var_1_3 = var_1_10003(var_5)
	local var_1_4
	...
	arg_1_0:bind(var_0_1.CHANGE_FLEET_SHIP, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
		...
		var_2_10004(var_8_0 == var_2_10007.PVP_FLEET_ID, "fleet type error")

		local var_8_1 = arg_1_0.contextData

		ExercisePreCombatLayer = var_2_10005
		var_8_1.form = var_2_10005.FORM_EDIT
		...
		if var_8_2 == var_8_3 then
			...
			if var_4 then
				...
				local var_8_12 = iter_8_0.GO_SCENE

				SCENE = iter_8_1

				local var_8_13 = iter_8_1.DOCKYARD
				local var_8_14 = {
					selectedMin = 0,
					useBlackBlock = true,
					selectedMax = 1,
				...
				local var_8_15 = var_2_10017.ShipFlagMgr.GetInstance()

				var_8_14.ignoredIds = var_17.FilterShips(var_8_15, {
					isActivityNpc = true
				})
				i18n = var_17
				var_8_14.leastLimitMsg = var_17("battle_preCombatMediator_leastLimit")
	...
	arg_1_0:bind(var_0_1.ON_START, function(arg_10_0, arg_10_1)
		...
		var_3({
			...
			function()
				...
				var_12_1(var_12_0, var_3_10003.BEGIN_STAGE, {
					stageId = var_10_0,
...
function var_0_1.changeFleet(arg_13_0, arg_13_1)
	...
	if var_13_0 == var_1_10003 then
		...
		var_13_0(var_1_10004).combatFleetId = arg_13_1
	end
...
function var_0_1.commitEdit(arg_15_0, arg_15_1)
	...
	if var_1_10002(var_1_10004).EdittingFleet == nil or var_3:isFirstFleet() or var_3:isLegalToFight() == true then
		...
		if #var_3.ships == 0 then
			...
			var_15_0 = arg_15_0.contextData.system
			SYSTEM_SUB_ROUTINE = var_1_10005

			if var_15_0 == var_1_10005 then
				-- block empty
			end
		else
			pg = var_15_0

			local var_15_1 = var_15_0.MsgboxMgr.GetInstance()
			local var_15_2 = var_4.ShowMsgBox
			local var_15_3 = {}

			i18n = var_1_10008
			var_15_3.content = var_1_10008("ship_formationMediaror_trash_warning", var_3.defaultName)
			...
			function var_15_3.onYes()
				...
				if var_16_3 == var_4.PVP_FLEET_ID then
					...
					FleetProxy = iter_16_0

					var_16_6(var_16_5, iter_16_0.PVP_FLEET_ID)
				else
...
function var_0_1.onAutoBtn(arg_17_0, arg_17_1)
	...
	var_17_3(var_17_2, var_1_10007.AUTO_BOT, {
...
function var_0_1.onAutoSubBtn(arg_18_0, arg_18_1)
	...
	var_18_3(var_18_2, var_1_10007.AUTO_SUB, {
...
function var_0_1.handleNotification(arg_20_0, arg_20_1)
	...
	local var_20_1 = arg_20_1.getName(var_20_0)
	local var_20_2 = arg_20_1:getBody()

	GAME = var_20_0

	local var_20_4

	if var_20_1 == var_20_0.BEGIN_STAGE_DONE then
		...
		var_20_4(var_20_3, var_1_10007, var_1_10008.COMBATLOAD, var_20_2)
	else
		PlayerProxy = var_20_4

		local var_20_6

		if var_20_1 == var_20_4.UPDATED then
			...
			local var_20_7 = var_1_10007(var_1_10009)

			var_20_6(var_20_5, var_7.getData(var_20_7))
		else
			GAME = var_20_6

			if var_20_1 == var_20_6.BEGIN_STAGE_ERRO and var_20_2 == 3 then
				pg = var_4

				local var_20_8 = var_4.MsgboxMgr.GetInstance()
				local var_20_9 = var_4.ShowMsgBox
				local var_20_10 = {
					hideNo = true
				}

				i18n = var_1_10008
				var_20_10.content = var_1_10008("battle_preCombatMediator_timeout")
				...
				function var_20_10.onYes()
					...
					var_21_1(var_21_0, var_2_10003.ON_CLOSE)
...
function var_0_1.getDockCallbackFuncsForExercise(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	local var_22_0 = var_1_10004(var_1_10006)

	getProxy = var_1_10005
	BayProxy = var_1_10007

	local var_22_1 = var_1_10005(var_1_10007)
