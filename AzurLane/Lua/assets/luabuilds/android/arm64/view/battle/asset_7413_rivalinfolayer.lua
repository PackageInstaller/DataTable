...
function var_0_1.didEnter(arg_3_0)
	...
	var_1(var_3_1, var_1_10004(arg_3_0._tf, "bg"), function()
	...
	var_1(var_3(arg_3_0._tf, "info/title_miex"), arg_3_0.contextData.type == arg_3_0.TYPE_BATTLE)
	...
	local function var_3_5()
		...
		RivalInfoMediator = var_2_10003

		var_5_1(var_5_0, var_2_10003.START_BATTLE)
	...
	var_1(var_3_8, var_3_9, var_3_10, var_6)
	...
	var_1(var_3_11, var_4.isEnableShipName(var_3_12))
...
function var_0_1.UpdateNames(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_1_10001(arg_7_0.names) do
		...
		if not arg_7_0.isRealName or not var_7_1:GetDefaultName() then
			var_7_2 = var_7_1:getName()
		end

		setText = var_1_10009
		findTF = var_1_10011

		var_1_10009(var_1_10011(var_7_0, "content/info/name_mask/name"), var_7_2)
	end
...
function var_0_1.initRivalInfo(arg_8_0)
	...
	var_1_10001(var_1_10003(arg_8_0._tf, "info/name/container/name"), arg_8_0.rivalVO.name)

	setText = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_8_0._tf, "info/name/container/lv"), "Lv." .. arg_8_0.rivalVO.level)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_8_0._tf, "info/rank"), arg_8_0.rivalVO.rank ~= nil)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_8_0._tf, "info/medal"), arg_8_0.rivalVO.rank ~= nil)

	setActive = var_1_10001
	findTF = var_3

	var_1_10001(var_3(arg_8_0._tf, "info/medal/Text"), arg_8_0.rivalVO.rank ~= nil)

	if arg_8_0.rivalVO.rank then
		setText = var_1
		findTF = var_3

		var_1(var_3(arg_8_0._tf, "info/rank/container/value"), arg_8_0.rivalVO.rank)
		...
		local var_8_1 = var_1_10002(arg_8_0._tf, "info/medal")
		local var_8_2 = var_2.GetComponent

		typeof = var_5
		Image = var_1_10007

		local var_8_3 = var_8_2(var_8_1, var_5(var_1_10007))

		findTF = var_3

		local var_8_4 = var_3(arg_8_0._tf, "info/medal/Text")
		local var_8_5 = var_3.GetComponent

		typeof = var_6
		Image = var_1_10008

		local var_8_6 = var_8_5(var_8_4, var_6(var_1_10008))

		SeasonInfo = var_8_1

		local var_8_7 = var_8_1.getEmblem(arg_8_0.rivalVO.score, arg_8_0.rivalVO.rank)

		LoadSpriteAsync = var_8_4

		var_8_4("emblem/" .. var_8_7, function(arg_9_0)
		...
		var_8_4("emblem/n_" .. var_8_7, function(arg_10_0)
	...
	local function var_8_8(arg_11_0, arg_11_1)
		...
		local var_11_0 = var_2_10002(var_4)
		local var_11_1 = var_2.getRawData(var_11_0)
		local var_11_2

		if not var_2.ShouldCheckCustomName(var_11_1) or not arg_11_1:GetDefaultName() then
			var_11_2 = arg_11_1:getName()
		end

		setScrollText = var_2_10003
		findTF = var_5

		var_2_10003(var_5(arg_11_0, "content/info/name_mask/name"), arg_11_1:GetColorName(var_11_2))
	...
	local function var_8_9(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
		...
		var_2_10005(var_12_0, true)

		Vector3 = var_2_10005
		var_12_0.localScale = var_2_10005(1.1, 1.1, 1)
		setActive = var_5
	...
	local var_8_26 = var_8_25(var_8_24, var_1_10014.Main)
	local var_8_27 = arg_8_0.rivalVO
	local var_8_28 = var_12.GetGearScoreSum

	TeamType = var_1_10015

	local var_8_29 = var_8_28(var_8_27, var_1_10015.Vanguard)

	LeanTween = var_8_24

	local var_8_30 = var_8_24.value

	go = var_15

	local var_8_31 = var_8_30(var_15(var_8_21), 0, var_8_26, 0.5)
	local var_8_32 = var_13.setOnUpdate

	System = var_16

	var_8_32(var_8_31, var_16.Action_float(function(arg_13_0)
		setText = var_2_10001
		...
		var_2_10001(var_13_0, var_2_10004.floor(arg_13_0))
	...
	local var_8_36 = var_8_35(var_8_34, var_16.Action_float(function(arg_14_0)
		setText = var_2_10001
		...
		var_2_10001(var_14_0, var_2_10004.floor(arg_14_0))
	...
	var_8_37(var_8_36, var_16.Action(function()
...
function var_0_1.willExit(arg_16_0)
	...
	var_16_1(var_16_0, var_16_2, var_1_10005.UIMgr.GetInstance().UIMain)
