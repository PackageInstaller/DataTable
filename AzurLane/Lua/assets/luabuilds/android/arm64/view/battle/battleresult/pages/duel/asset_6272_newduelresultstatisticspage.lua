...
function var_0_1.UpdatePlayer(arg_1_0)
	...
	local var_1_3 = var_1_2(var_1_10004)
	local var_1_4 = var_2.getSeasonInfo(var_1_3)

	SeasonInfo = var_3

	local var_1_5 = var_3.getMilitaryRank(var_1_4.score, var_1_4.rank)

	SeasonInfo = var_1_3

	local var_1_6, var_1_7 = var_1_3.getNextMilitaryRank(var_1_4.score, var_1_4.rank)
