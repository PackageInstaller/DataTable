...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("..activityBoss.NewActivityBossResultStatisticsPage"))
...
function var_0_1.UpdateTicket(arg_2_0, arg_2_1)
	...
	var_1_10003(var_2_0, true)

	setToggleEnabled = var_1_10003

	var_1_10003(var_2_0, false)
...
function var_0_1.EnoughTicketCount(arg_3_0)
	...
	local var_3_1 = var_1_10002(var_4)
	local var_3_2 = var_2.getRawData(var_3_1)

	return var_2.getResource(var_3_2, var_3_0) > 0
end
...
function var_0_1.OnPlayAgain(arg_4_0, arg_4_1)
	if arg_4_0:IsLastBonus() then
		...
		var_1_10005 = "lastBonus"

		local var_4_2 = {}

		i18n = var_1_10007
		var_4_2.content = var_1_10007("expedition_drop_use_out")

		var_4_1(var_4_0, var_1_10005, var_4_2, arg_4_1)
	...
	if not arg_4_0:EnoughTicketCount() then
		...
		var_4_4(var_4_3, var_1_10005("stage_beginStage_error_noTicket"))
	...
	var_4_10(var_4_9, var_1_10009.REENTER_STAGE)
