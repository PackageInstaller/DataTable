...
function var_0_1.isTotalClear(arg_2_0)
	...
	if var_2_1 == var_1_10002.MODE_CASUAL then
...
function var_0_1.GetGetObjectives(arg_4_0)
	...
	ChallengeProxy = var_4_1

	if var_4_3 == var_4_1.MODE_INFINITE then
		return {}
	else
		local var_4_4 = {}
		...
		local var_4_5 = var_4("challenge_combat_score", var_2:getLastScore())

		NewBattleResultUtil = var_4_2

		local var_4_6, var_4_7 = var_4_2.ColorObjective(true)

		table = var_7

		local var_4_8 = var_7.insert
		local var_4_9 = var_4_4
		local var_4_10 = {}

		setColorStr = var_1_10011
		var_4_10.text = var_1_10011(var_4_5, var_4_7)
		var_4_10.icon = var_4_6

		var_4_8(var_4_9, var_4_10)

		i18n = var_4_8

		local var_4_11 = "challenge_current_score"
		local var_4_12 = var_2
		local var_4_13 = var_4_8(var_4_11, var_2.getScore(var_4_12))

		table = var_1_10008

		local var_4_14 = var_1_10008.insert
		local var_4_15 = var_4_4
		local var_4_16 = {}

		setColorStr = var_4_12
		var_4_16.text = var_4_12(var_4_13, var_4_7)
		var_4_16.icon = var_4_6
...
function var_0_1.UpdateChapterName(arg_5_0)
	...
	if var_5_2 == var_1_10003.MODE_INFINITE then
		pg = var_5_2
		...
		local var_5_5 = var_5(var_1_10007)
...
function var_0_1.LoadChallengeRes(arg_6_0, arg_6_1)
	...
	var_1_10002(var_4.Find(var_6_0, "ResultEffect/Tips"), false)
	...
	var_1_10002("BattleResultItems/Challenge", "", nil, function(arg_7_0)
		if not arg_6_0.exited then
			...
			var_7_1(var_7_0, var_2_10004.Instantiate(arg_7_0, arg_6_0._tf).transform)
...
function var_0_1.UpdateChallengeInfo(arg_8_0, arg_8_1)
	...
	if arg_8_0.challengeExpire then
		...
		if not var_5("challenge_expire_warn") then
			var_8_1 = ""
		end
		...
		var_1_10002(var_8_2, var_8_1("battle_result_continue_battle"))
		...
		var_1_10002(var_8_3, var_5("battle_result_quit_battle"))
		...
		var_1_10002(var_8_4, var_5("battle_result_share_battle"))
		...
		local var_8_5 = arg_8_0:isTotalClear()

		SetActive = var_1_10003

		var_1_10003(arg_8_0.continueBtn, not var_8_5)

		SetActive = var_1_10003

		var_1_10003(arg_8_0.quitBtn, not var_8_5)

		SetActive = var_1_10003

		var_1_10003(arg_8_0.shareBtn, var_8_5)
...
function var_0_1.RegisterChallengeEvent(arg_13_0, arg_13_1)
	if arg_13_0:isTotalClear() then
		...
		local function var_13_2()
			...
			NewBattleResultMediator = var_2_10003

			var_14_1(var_14_0, var_2_10003.CHALLENGE_SHARE)
		...
		var_2(var_13_0, var_13_1, var_13_2, var_1_10007)
		...
		var_2(var_13_6, var_13_7, var_13_8, var_1_10007)
		...
		var_2(var_13_9, var_13_10, var_13_11, var_1_10007)
	end
...
function var_0_1.OnContinue(arg_17_0, arg_17_1)
	if arg_17_0:isFail() then
		...
		var_17_1(var_17_0, var_1_10005.CHALLENGE_DEFEAT_SCENE, {
			callback = arg_17_1
		})
	end
...
function var_0_1.OnQuit(arg_18_0, arg_18_1)
	if arg_18_0:isFail() then
		...
		var_18_1(var_18_0, var_1_10005.CHALLENGE_DEFEAT_SCENE, {
			callback = arg_18_1
		})
	end
