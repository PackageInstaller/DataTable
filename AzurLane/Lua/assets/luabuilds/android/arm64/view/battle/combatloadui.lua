...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	SYSTEM_BOSS_RUSH_COLLABRATE = var_5

	if var_2_2 == var_5 then
...
function var_0_1.init(arg_4_0)
	...
	typeof = var_5
	Slider = var_1_10007
	arg_4_0._loadingProgress = var_4_3(var_4_2, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_4_0._loadingText = var_4_5(var_4_4, var_5(var_1_10007))
	...
	var_2.SetEndEvent(var_4_7, function(arg_5_0)
		...
		CombatLoadMediator = var_2_10004

		var_5_1(var_5_0, var_2_10004.FINISH, arg_4_0._loadObs)
	...
	AppreciatePicConst = var_4_15

	if var_4_17 == var_4_15.TYPE_MANGA and arg_4_0._preloadPicSprite then
		SetActive = var_8
	...
	typeof = var_11
	Text = var_1_10013
	arg_4_0._tipsText = var_4_19(var_4_18, var_11(var_1_10013))
...
function var_0_1.Preload(arg_9_0)
	...
	for iter_9_10, iter_9_3 in var_5(var_9_5) do
	...
	if var_9_6 == var_6 then
		...
		if var_9_6 then
			...
			for iter_9_10, iter_9_5 in var_9_6(var_7.Battle.BattleUnitDetailView.BulletForger) do
				local var_9_7 = "触发自定义子弹替换>>>" .. iter_9_10 .. "<<<，检查是否测试需要，否则联系程序"

				pg = var_1_10011
				iter_9_15 = var_1_10011.TipsMgr.GetInstance()

				var_1_10011.ShowTips(iter_9_15, var_9_7)

				pg = var_1_10011
				var_1_10011 = var_1_10011.bullet_template
				var_1_10011[iter_9_10] = iter_9_5
			end

			pairs = var_9_6
			ys = var_7

			for iter_9_10, iter_9_7 in var_9_6(var_7.Battle.BattleUnitDetailView.BarrageForger) do
				local var_9_8 = "触发自定义弹幕替换>>>" .. iter_9_10 .. "<<<，检查是否测试需要，否则联系程序"

				pg = var_1_10011
				iter_9_15 = var_1_10011.TipsMgr.GetInstance()

				var_1_10011.ShowTips(iter_9_15, var_9_8)

				pg = var_1_10011
				var_1_10011 = var_1_10011.barrage_template
				var_1_10011[iter_9_10] = iter_9_7
			end

			pairs = var_9_6
			ys = var_7

			for iter_9_10, iter_9_9 in var_9_6(var_7.Battle.BattleUnitDetailView.AircraftForger) do
				local var_9_9 = "触发自定义飞机替换>>>" .. iter_9_10 .. "<<<，检查是否测试需要，否则联系程序"

				pg = var_1_10011
				iter_9_15 = var_1_10011.TipsMgr.GetInstance()

				var_1_10011.ShowTips(iter_9_15, var_9_9)

				pg = var_1_10011
				var_1_10011 = var_1_10011.aircraft_template
				var_1_10011[iter_9_10] = iter_9_9
			end

			pairs = var_9_6
			ys = var_7

			for iter_9_10, iter_9_11 in var_9_6(var_7.Battle.BattleUnitDetailView.WeaponForger) do
				local var_9_10 = "触发自定义武器替换>>>" .. iter_9_10 .. "<<<，检查是否测试需要，否则联系程序"

				pg = var_1_10011
				iter_9_15 = var_1_10011.TipsMgr.GetInstance()

				var_1_10011.ShowTips(iter_9_15, var_9_10)

				pg = var_1_10011
				var_1_10011 = var_1_10011.weapon_property
				var_1_10011[iter_9_10] = iter_9_11
				var_1_10011 = var_1.GetWeaponResource(iter_9_10)
				ipairs = var_12

				for iter_9_12, iter_9_13 in var_12(var_1_10011) do
	...
	if var_9_6 then
		...
		if var_9_6 then
			...
			getProxy = var_6
			FleetProxy = iter_9_10

			local var_9_12 = var_6(iter_9_10)
			local var_9_13 = var_6.getFleetById(var_9_12, 11)
			local var_9_14 = var_7.getTeamByName

			TeamType = var_1_10011

			local var_9_15 = var_9_14(var_9_13, var_1_10011.Submarine)

			ipairs = var_9_12

			for iter_9_14, iter_9_15 in var_9_12(var_9_15) do
				table = var_1_10014

				var_1_10014.insert(var_9_11, var_9_3:getShipById(iter_9_15))
			end

			local var_9_16, var_9_17 = var_1.GetPlayerShipResource(var_9_11, arg_9_0.contextData.system)

			ipairs = var_11

			for iter_9_16, iter_9_17 in var_11(var_9_16) do
				var_1:AddPreloadResource(iter_9_17)
			end

			ipairs = var_11

			for iter_9_18, iter_9_19 in var_11(var_9_17) do
	...
	local var_9_18, var_9_19 = var_0_1.GetTotalResourceList(arg_9_0.contextData)

	ipairs = var_7

	for iter_9_20, iter_9_21 in var_7(var_9_18) do
		var_1:AddPreloadResource(iter_9_21)
	end

	ipairs = var_7

	for iter_9_22, iter_9_23 in var_7(var_9_19) do
	...
	if var_7 then
		...
		if var_7 then
			...
			getProxy = var_8
			FleetProxy = iter_9_22
			iter_9_23 = var_8(iter_9_22)

			local var_9_21 = var_8.getFleetById(iter_9_23, 11)

			iter_9_22 = var_9.getTeamByName
			TeamType = iter_9_15
			iter_9_22 = iter_9_22(var_9_21, iter_9_15.Submarine)
			ipairs = iter_9_23

			for iter_9_24, iter_9_25 in iter_9_23(iter_9_22) do
				table = iter_9_13

				iter_9_13.insert(var_9_20, var_9_3:getShipById(iter_9_25))
			end

			local var_9_22

			iter_9_23, var_9_22 = var_1.GetPlayerShipResource(var_9_20, arg_9_0.contextData.system)
			ipairs = var_13

			for iter_9_26, iter_9_27 in var_13(iter_9_23) do
				var_1:AddPreloadResource(iter_9_27)
			end

			ipairs = var_13

			for iter_9_28, iter_9_29 in var_13(var_9_22) do
	...
	local function var_9_25(arg_11_0)
		local var_11_0
		local var_11_1 = var_9_24 == 0 and 0 or arg_11_0 / var_9_24
	...
	local var_9_26 = iter_9_22.UIMgr.GetInstance()
	local var_9_27 = var_10.GetMainCamera(var_9_26)

	setActive = iter_9_23

	iter_9_23(var_9_27, true)

	local var_9_28 = var_1

	var_9_24 = var_1.StartPreload(var_9_28, var_9_23, var_9_25)

	local var_9_29 = arg_9_0._tipsText

	pg = var_9_26

	local var_9_30 = var_9_26.server_language

	math = var_9_28

	local var_9_31 = var_9_28.random

	pg = var_15
	var_9_29.text = var_9_30[var_9_31(#var_15.server_language)].content
...
function var_0_1.GetTotalResourceList(arg_12_0)
	...
	if var_1_10004.Battle.BattleGate.Gates[arg_12_0.system].GetPreloadList then
		...
		for iter_12_2, iter_12_3 in var_1_10007(var_1_10006) do
			table = var_1_10012
	...
	elseif arg_12_0.mainFleetId then
		...
		local var_12_4 = var_5(var_1_10007)
		...
		local var_12_6 = var_6.getShipsByFleet(var_1_10008, var_12_5)

		ipairs = var_12_4

		for iter_12_4, iter_12_5 in var_12_4(var_12_6) do
			table = var_1_10012
	...
	if arg_12_0.prefabFleet then
		...
		for iter_12_6, iter_12_7 in var_1_10008(var_12_7) do
			table = var_1_10013
		...
		for iter_12_8, iter_12_9 in var_8(var_12_8) do
			table = var_1_10013
		...
		for iter_12_10, iter_12_11 in var_8(var_12_9) do
			table = var_1_10013
	...
	local var_12_10, var_12_11 = var_12_7.Battle.BattleResourceManager.GetInstance().GetPlayerShipResource(var_12_2, arg_12_0.system)

	ipairs = var_8

	for iter_12_12, iter_12_13 in var_8(var_12_10) do
		table = var_1_10013
	...
	for iter_12_14, iter_12_15 in var_8(var_12_11) do
		table = var_1_10013
	...
	local var_12_12 = var_8.expedition_data_template[arg_12_0.stageId].dungeon_id
	local var_12_13, var_12_14 = var_5.GetStageResource(var_12_12)

	ipairs = var_11

	for iter_12_16, iter_12_17 in var_11(var_12_13) do
		table = var_1_10016
	...
	for iter_12_22, iter_12_23 in var_11(var_12_14) do
		table = var_1_10016
	...
	local var_12_15 = var_11.expedition_data_template[arg_12_0.stageId]
	local var_12_16 = arg_12_0.system

	SYSTEM_WORLD = var_13

	if var_12_16 == var_13 then
		var_12_16 = var_12_15.difficulty
		ys = var_13

		if var_12_16 == var_13.Battle.BattleConst.Difficulty.WORLD then
			nowWorld = var_12_16

			local var_12_17 = var_12_16()
			local var_12_18 = var_12_16.GetActiveMap(var_12_17)

			ipairs = iter_12_22

			for iter_12_24, iter_12_25 in iter_12_22(var_5.GetMapResource(var_12_18.config.expedition_map_id)) do
				table = var_1_10019
	...
	for iter_12_26, iter_12_27 in var_12_16(var_12_15.map_id) do
		ipairs = iter_12_24
	...
	local var_12_19 = var_12_16.battle_cost_template[arg_12_0.system].global_buff_effected

	if 0 < var_12_19 then
		BuffHelper = var_12_19

		local var_12_20 = var_12_19.GetBattleBuffs()

		_ = var_13

		local var_12_21 = var_13.map(var_12_20, function(arg_13_0)
			return arg_13_0:getConfig("benefit_effect")
		end)

		ipairs = iter_12_22

		for iter_12_30, iter_12_31 in iter_12_22(var_12_21) do
			...
			for iter_12_32, iter_12_33 in iter_12_28(var_1_10019) do
				table = var_1_10025
	...
	local var_12_22 = var_5.GetStageBGM(var_12_12)
...
function var_0_1.generatePrefabShipData(arg_14_0)
	...
	local var_14_2 = var_1_10003.max(#arg_14_0.equipment, #var_14_1.default_equip_list)
...
function var_0_1.addCommanderBuffRes(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_1_10002(arg_16_0) do
		...
		for iter_16_2, iter_16_3 in var_1_10008(var_16_1) do
