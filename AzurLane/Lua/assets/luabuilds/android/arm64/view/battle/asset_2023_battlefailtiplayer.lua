...
function var_0_1.addListener(arg_5_0)
	...
	local function var_5_5()
		...
		if var_7_0 == var_2_10001 then
			...
			var_2_10003 = {}
			i18n = var_2_10004
			var_2_10003.content = var_2_10004("fightfail_up")
			...
			function var_2_10003.onYes()
				...
				if var_8_0 == var_3_10001 then
					...
					BattleFailTipMediator = var_3_10003

					var_8_2(var_8_1, var_3_10003.CHAPTER_RETREAT)
				else
					...
					var_8_4(var_8_3, var_3_10003.GO_HIGEST_CHAPTER)
				end

				return
			end

			var_7_2(var_7_1, var_2_10003)
		else
			local var_7_3 = arg_5_0
			local var_7_4 = var_0.emit

			BattleFailTipMediator = var_2_10003

			var_7_4(var_7_3, var_2_10003.GO_HIGEST_CHAPTER)
		end
	...
	local function var_5_8()
		...
		if var_9_0 == var_2_10001 then
			...
			var_2_10003 = {}
			i18n = var_2_10004
			var_2_10003.content = var_2_10004("fightfail_equip")
			...
			function var_2_10003.onYes()
				...
				if var_10_0 == var_3_10001 then
					...
					var_10_2(var_10_1, var_3_10003.CHAPTER_RETREAT)
				else
					...
					var_10_4(var_10_3, var_3_10003.GO_DOCKYARD_EQUIP)
				end

				return
			end

			var_9_2(var_9_1, var_2_10003)
		else
			...
			var_9_4(var_9_3, var_2_10003.GO_DOCKYARD_EQUIP)
		end
	...
	local function var_5_11()
		...
		var_11_1(var_11_0, var_2_10003.GO_NAVALTACTICS)
	...
	local function var_5_14()
		...
		if var_12_0 == var_2_10001 then
			...
			var_2_10003 = {}
			i18n = var_2_10004
			var_2_10003.content = var_2_10004("fight_strengthen")
			...
			function var_2_10003.onYes()
				...
				if var_13_0 == var_3_10001 then
					...
					var_13_2(var_13_1, var_3_10003.CHAPTER_RETREAT)
				else
					...
					var_13_4(var_13_3, var_3_10003.GO_DOCKYARD_SHIP)
				end

				return
			end

			var_12_2(var_12_1, var_2_10003)
		else
			...
			var_12_4(var_12_3, var_2_10003.GO_DOCKYARD_SHIP)
		end
...
function var_0_1.aniBeforeEnter(arg_17_0)
	...
	local var_17_1 = var_1_10002.value

	go = var_4

	local var_17_2 = var_17_1(var_4(arg_17_0._tf), 0, 1, 0.6)
	local var_17_3 = var_2.setOnUpdate

	System = var_5

	var_17_3(var_17_2, var_5.Action_float(function(arg_18_0)
