...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5, arg_1_6)
	...
	typeof = var_10
	Text = var_1_10012
	arg_1_0.label1 = var_1_1(var_1_0, var_10(var_1_10012))
	...
	typeof = var_10
	Text = var_1_10012
	arg_1_0.label2 = var_1_3(var_1_2, var_10(var_1_10012))
	...
	typeof = var_10
	Image = var_1_10012
	arg_1_0.damagebar = var_1_5(var_1_4, var_10(var_1_10012))
...
function var_0_0.ExpAnimation(arg_7_0, arg_7_1)
	...
	local var_7_1 = var_1_10003.value(arg_7_0.label1.gameObject, 0, var_7_0, 1)
	local var_7_2 = var_3.setOnUpdate

	System = var_6

	local var_7_3 = var_7_2(var_7_1, var_6.Action_float(function(arg_8_0)
	...
	var_7_4(var_7_3, var_6.Action(arg_7_1))
...
function var_0_0.LevelAnimation(arg_9_0, arg_9_1)
	...
	local var_9_2 = var_9_1(var_9_0, var_7.Action_float(function(arg_10_0)
	...
	var_9_3(var_9_2, var_7.Action(arg_9_1))
...
local function var_0_1(arg_11_0, arg_11_1)
	...
	getExpByRarityFromLv1 = var_11_0

	local var_11_4 = arg_11_0.newShip
	local var_11_5 = var_11_0(var_6.getConfig(var_11_4, "rarity"), arg_11_0.newShip.level)

	LeanTween = var_11_2

	local var_11_6 = var_11_2.value(arg_11_0.damagebar.gameObject, var_11_1, var_11_3, 1)
	local var_11_7 = var_5.setOnUpdate

	System = var_8

	local var_11_8 = var_11_7(var_11_6, var_8.Action_float(function(arg_12_0)
	...
	var_11_9(var_11_8, var_8.Action(arg_11_1))
...
local function var_0_2(arg_13_0, arg_13_1)
	...
	getExpByRarityFromLv1 = var_1_10003

	local var_13_2 = arg_13_0.ship
	local var_13_3 = var_1_10003(var_5.getConfig(var_13_2, "rarity"), arg_13_0.ship.level)

	LeanTween = var_13_0

	local var_13_4 = var_13_0.value(arg_13_0.damagebar.gameObject, var_13_1 / var_13_3, 1, 0.5)
	local var_13_5 = var_4.setOnUpdate

	System = var_7

	local var_13_6 = var_13_5(var_13_4, var_7.Action_float(function(arg_14_0)
	...
	var_13_7(var_13_6, var_7.Action(arg_13_1))
...
local function var_0_3(arg_15_0, arg_15_1)
	...
	local var_15_3 = var_1_10003(var_5.getConfig(var_15_2, "rarity"), arg_15_0.newShip.level)

	LeanTween = var_15_0

	local var_15_4 = var_15_0.value(arg_15_0.damagebar.gameObject, 0, var_15_1 / var_15_3, 0.5)
	...
	var_15_7(var_15_6, var_7.Action(arg_15_1))
...
local function var_0_4(arg_17_0, arg_17_1)
	...
	local var_17_4 = var_17_3(var_17_2, var_8.Action_float(function(arg_18_0)
	...
	var_17_6(var_17_5, var_8.Action(arg_17_1))
...
function var_0_0.KillCntAnimation(arg_28_0, arg_28_1)
	...
	local var_28_4 = var_28_3(var_28_2, var_7.Action_float(function(arg_29_0)
	...
	var_28_5(var_28_4, var_7.Action(arg_28_1))
...
function var_0_0.OutputAnimation(arg_30_0, arg_30_1)
	...
	local var_30_4 = var_30_3(var_30_2, var_7.Action_float(function(arg_31_0)
	...
	var_30_5(var_30_4, var_7.Action(arg_30_1))
...
function var_0_0.OutputBarAnimation(arg_32_0, arg_32_1)
	...
	local var_32_5 = var_32_4(var_32_3, var_7.Action_float(function(arg_33_0)
	...
	var_32_6(var_32_5, var_7.Action(arg_32_1))
