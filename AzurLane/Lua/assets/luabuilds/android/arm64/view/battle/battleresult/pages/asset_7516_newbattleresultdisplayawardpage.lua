...
function var_0_1.SetUp(arg_3_0, arg_3_1)
	...
	local var_3_1, var_3_2 = arg_3_0.CollectDrops(var_3_0)
	...
	var_3_0({
		function(arg_4_0)
			...
			var_1.ShowAwards(var_4_0, var_3_1, var_3_2, arg_4_0)
		...
		function(arg_5_0)
			...
			var_1.ShowShips(var_5_0, var_3_1, arg_5_0)
...
function var_0_1.ShowShips(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_1 = var_1_10004(var_6)
	local var_6_2 = var_4.getNewShip(var_6_1, true)
	local var_6_3 = {}

	_ = var_6_1

	var_6_1.each(var_6_2, function(arg_8_0)
	...
	var_6.each(arg_6_1, function(arg_9_0)
		...
		if var_2_10002.isMetaShipByConfigID(var_9_0) then
			...
			if var_2.indexof(var_6_3, var_9_0) then
				...
				var_2_10003.remove(var_6_3, var_2)
			else
				Ship = var_2_10003

				local var_9_1 = var_2_10003.New({
					configId = var_9_0
				})
				...
				local var_9_2 = var_4(var_2_10006)
	...
	for iter_6_0 = var_7.max(1, #var_6_2 - var_6_0 + 1), #var_6_2 do
		...
		DISPLAY_SHIP_GET_EFFECT = var_1_10014

		if var_1_10012(var_1_10014) ~= 1 then
			if not var_6_5.virgin then
				var_1_10014 = var_6_5
				var_1_10012 = var_6_5.getRarity(var_1_10014)
			...
			if var_1_10012 then
				...
				var_1_10014.insert(var_6_4, function(arg_10_0)
					...
					NewBattleResultMediator = var_2_10005

					var_10_2(var_10_1, var_2_10005.GET_NEW_SHIP, var_6_5, arg_10_0, var_10_0)
...
function var_0_1.ShowAwards(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	if #arg_11_1 > 0 then
		...
		var_11_2(var_11_1, var_1_10008.ON_AWARD, {
			items = arg_11_1,
			extraBonus = arg_11_2,
			removeFunc = arg_11_3,
