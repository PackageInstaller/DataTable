...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.stageScrollRect = var_3_10(var_3_9, var_4(var_1_10006))
...
function var_0_1.didEnter(arg_9_0)
	...
	local var_9_2 = var_4.Find(var_9_1, "help_btn")
	...
	local function var_9_3()
		...
		pg = var_2_10004
		var_10_2.helps = var_2_10004.gametip.help_daily_task.tip
	...
	local function var_9_6()
		if arg_9_0.descMode then
			...
			if not var_11_0(var_2_10002(arg_9_0.stageContain)) then
				LeanTween = var_0
				...
				if var_11_1(var_2(arg_9_0.selQuicklyTF)) then
					return
				end
	...
	var_1_10001(arg_9_0, arg_9_0.leftBtn, function()
		...
		var_12_1(var_12_0, var_3.getNextCardId(var_12_2, true))
	...
	var_1_10001(arg_9_0, arg_9_0.rightBtn, function()
		...
		var_13_1(var_13_0, var_3.getNextCardId(var_13_2, false))
...
function var_0_1.initItems(arg_14_0)
	...
	Clone = var_5
	arg_14_0.dailyList = var_14_2(var_5(var_14_1.all))
		...
		if var_14_3 then
			...
			if var_1_10009(var_14_3) == "table" then
				...
				if not var_1_10009.inTime(var_14_5, var_14_3) then
					...
					var_1_10010.remove(arg_14_0.dailyList, iter_14_0)
				end
	...
	if arg_14_0.contextData.dailyLevelId then
		var_14_6 = arg_14_0.contextData.dailyLevelId
		table = var_4

		var_4.removebyvalue(arg_14_0.dailyList, var_14_6)

		table = var_4

		local var_14_7 = var_4.insert
		local var_14_8 = arg_14_0.dailyList

		math = var_7

		var_14_7(var_14_8, var_7.ceil(#var_14_1.all / 2), var_14_6)
	end

	pairs = var_14_6

	for iter_14_1, iter_14_2 in var_14_6(arg_14_0.dailyList) do
		local var_14_9 = arg_14_0.dailyLevelTFs

		cloneTplTo = var_1_10009
		var_14_9[iter_14_2] = var_1_10009(arg_14_0.dailylevelTpl, arg_14_0.content, iter_14_2)
	end
...
function var_0_1.sortDailyList(arg_15_0)
	...
	var_1.sort(arg_15_0.dailyList, function(arg_16_0, arg_16_1)
		...
		local var_16_0 = var_2_10002(var_2_10004.expedition_daily_template[arg_16_0].sort)

		tonumber = var_2_10003
		pg = var_2_10005

		return var_16_0 > var_2_10003(var_2_10005.expedition_daily_template[arg_16_1].sort)
	end)
...
function var_0_1.displayDailyLevels(arg_18_0)
	...
	typeof = iter_18_0
	EnhancelScrollView = var_1_10006
	var_18_1(var_18_0, iter_18_0(var_1_10006)).onCenterClick = function(arg_19_0)
		local var_19_0 = arg_18_0
		local var_19_1 = var_1.tryOpenDesc

		tonumber = var_2_10004

		var_19_1(var_19_0, var_2_10004(arg_19_0.name))
	...
	arg_18_0.checkAniTimer = var_2.New(function()
		...
		if not arg_18_0.descMode then
			...
			for iter_20_0, iter_20_1 in var_2_10002(arg_18_0.dailyLevelTFs) do
				...
				var_2_10007 = var_2_10007(var_20_2, var_2_10010(var_2_10012))
				var_2_10007.alpha = 1
			...
			local var_20_4 = var_2(var_20_3, iter_20_0(var_2_10007))
			...
			typeof = var_5
			CanvasGroup = var_2_10007
			var_20_4(var_20_5, var_5(var_2_10007)).alpha = 0.5
		end
		...
		for iter_20_2, iter_20_3 in var_20_0(arg_18_0.dailyLevelTFs) do
			...
			if arg_18_0.centerAniItem == iter_20_3 and var_20_6 then
				...
				if iter_20_3:Find("icon/card") then
					...
					local var_20_9 = var_20_8(var_20_7, var_11(var_2_10013))
					local var_20_10 = var_7:Find("effect")

					setActive = var_20_7

					var_20_7(var_20_10, var_20_6)
...
function var_0_1.tryOpenDesc(arg_21_0, arg_21_1)
	...
	if var_21_2(var_21_3, var_1_10007(arg_21_0:getWeek())) then
...
function var_0_1.CanOpenDailyLevel(arg_22_0)
	...
	if var_22_2(var_22_3, var_1_10006(var_0_1.getWeek())) then
		var_22_1 = true
	end
...
function var_0_1.initDailyLevel(arg_24_0, arg_24_1)
	...
	if var_24_2(var_24_3, var_1_10007(arg_24_0:getWeek())) then
	...
	local var_24_4 = var_7(var_24_1, "lock")
	local var_24_5

	if not var_4 then
		table = var_1_10008
		var_24_5 = not var_1_10008.isEmpty(var_24_0.weekday)
	else
		var_24_5 = false
	end
	...
	var_1_10005(var_24_4, var_24_5)

	setText = var_1_10005
	findTF = var_24_4

	var_1_10005(var_24_4(var_24_1, "name"), var_24_0.title)

	setActive = var_1_10005
	findTF = var_7

	var_1_10005(var_7(var_24_1, "time"), false)
	...
	if arg_24_0.bonusActivity then
		...
		if not var_24_9.isEnd(var_24_6) then
			...
			var_24_9 = var_24_9(var_24_7(var_9.getConfig(var_24_8, "config_data"), function(arg_25_0)
			...
			local var_24_10 = var_24_1:Find("bonus/Text")

			i18n = var_9

			var_24_3(var_24_10, var_9("dailyLevel_bonus_activity"))

			setActive = var_24_3

			local var_24_11 = var_24_1:Find("bonus")

			tobool = var_9

			var_24_3(var_24_11, var_9(var_24_9))

			if var_24_9 then
				updateDrop = var_24_3

				local var_24_12 = var_24_1:Find("bonus/IconTpl")

				Drop = var_9

				var_24_3(var_24_12, var_9.Create(var_24_9))
			end
	...
	local var_24_13 = var_24_9(var_24_1, "icon")

	PoolMgr = var_24_3

	local var_24_14 = var_24_3.GetInstance()

	var_6.GetPrefab(var_24_14, "dailyui/" .. var_24_0.pic, "", true, function(arg_26_0)
		tf = var_2_10001

		local var_26_0 = var_2_10001(arg_26_0)

		arg_26_0.SetParent(var_26_0, var_24_13, false)
	...
	var_6(var_24_14(var_24_1, "Text"), "")

	setActive = var_6
	findTF = var_8

	var_6(var_8(var_24_1, "lastTime"), false)

	Clone = var_6

	local var_24_15 = var_6(var_24_0.limit_period)
	local var_24_16
	local var_24_20
	...
	if var_24_15 then
		...
		if var_8(var_24_15) == "table" then
			pg = var_8

			local var_24_17 = var_8.TimeMgr.GetInstance()

			if var_8.inTime(var_24_17, var_24_15) then
				pg = var_9

				local var_24_18 = var_9.TimeMgr.GetInstance()
				local var_24_19 = var_9.GetServerTime(var_24_18)

				pg = var_24_17
				var_24_20 = var_24_17.TimeMgr.GetInstance()
				var_24_16 = var_10.Table2ServerTime(var_24_20, {
					year = var_24_15[2][1][1],
					month = var_24_15[2][1][2],
					day = var_24_15[2][1][3],
					hour = var_24_15[2][2][1],
					min = var_24_15[2][2][2],
					sec = var_24_15[2][2][3]
				}) - var_24_19
			end
	...
	if var_24_16 then
		...
		if 0 < var_24_16 then
			math = var_24_23
			var_24_23 = var_24_23.floor
			tonumber = var_24_20
			var_24_21 = var_24_23(var_24_20(var_24_16) / 0)
			i18n = var_24_23
			var_24_22 = var_24_23("word_date")
		elseif 3600 <= var_24_16 then
			math = var_24_23
			var_24_23 = var_24_23.floor
			tonumber = var_24_20
			var_24_21 = var_24_23(var_24_20(var_24_16) / 16)
			i18n = var_24_23
			var_24_22 = var_24_23("word_hour")
		elseif 0 < var_24_16 then
			math = var_24_23
			var_24_23 = var_24_23.floor
			tonumber = var_24_20
			var_24_21 = var_24_23(var_24_20(var_24_16) / 60)
			i18n = var_24_23
			var_24_22 = var_24_23("word_minute")
		end

		setText = var_24_23
		findTF = var_24_20

		local var_24_24 = var_24_20(var_24_1, "lastTime/content/text")

		tostring = var_1_10013

		var_24_23(var_24_24, var_1_10013(var_24_21) .. " ")

		setText = var_24_23
		findTF = var_24_24

		local var_24_25 = var_24_24(var_24_1, "lastTime/content/word")

		tostring = var_13

		var_24_23(var_24_25, var_13(var_24_22))

		setActive = var_24_23
		findTF = var_24_25

		var_24_23(var_24_25(var_24_1, "lastTime"), true)
	end
...
function var_0_1.UpdateDailyLevelCnt(arg_27_0, arg_27_1)
	...
	if var_27_0.limit_time == 0 then
		...
		var_6(var_27_4, var_1_10009.format("%d/%d", var_27_0.limit_time - var_27_3, var_27_0.limit_time))
	end
...
function var_0_1.UpdateDailyLevelCntForDescPanel(arg_29_0, arg_29_1)
	...
	if var_29_0.limit_time == 0 then
		...
		var_4(var_29_2, var_1_10007("challenge_count_unlimit"))
	else
		setText = var_4
		...
		var_4(var_29_3, var_1_10007.format("%d/%d", var_29_0.limit_time - var_29_1, var_29_0.limit_time))
	end
...
function var_0_1.displayStageList(arg_30_0, arg_30_1)
	...
	for iter_30_0, iter_30_1 in var_1_10004(var_30_2) do
...
function var_0_1.updateStageTF(arg_32_0, arg_32_1, arg_32_2)
	...
	var_4(var_1_10006(arg_32_1, "left_panel/name"), var_32_0.name)

	setText = var_4
	findTF = var_6

	var_4(var_6(arg_32_1, "left_panel/lv/Text"), "Lv." .. arg_32_2.level)

	local var_32_1 = arg_32_1:Find("mask")

	setActive = var_1_10005

	var_1_10005(var_32_1, arg_32_2.level > arg_32_0.player.level)

	local var_32_2 = arg_32_2.level

	if arg_32_0.player.level < var_32_2 then
		setText = var_32_2

		var_32_2(var_32_1:Find("msg/msg_contain/Text"), "Lv." .. arg_32_2.level .. " ")

		PLATFORM_CODE = var_32_2
		PLATFORM_US = var_6

		if var_32_2 == var_6 then
			local var_32_3 = var_32_1:Find("msg/msg_contain/Text")

			var_32_2.SetAsLastSibling(var_32_3)
		end
	end

	UIItemList = var_32_2

	local var_32_4 = var_32_2.New(arg_32_1:Find("scrollView/right_panel"), arg_32_0.itemTpl)
	...
	getImageSprite = var_9
	findTF = var_1_10011

	var_6(var_32_5, var_9(var_1_10011(arg_32_0.resource, "normal_bg")))
	...
	local function var_32_8()
		...
		var_34_1(var_34_0, var_2_10003("dailyLevel_unopened"))
	...
	var_6(var_32_6, var_32_7, var_32_8, var_11)
...
function var_0_1.updateStage(arg_35_0, arg_35_1)
	...
	local function var_35_4()
		...
		if var_0.CanQuickBattle(var_36_0, arg_35_1.id) then
			...
			if var_36_2 >= var_36_1.limit_time then
				pg = var_36_2
				var_36_3 = var_36_2.TipsMgr.GetInstance()
				var_36_2 = var_36_2.ShowTips
				i18n = var_2_10004

				var_36_2(var_36_3, var_2_10004("dailyLevel_restCount_notEnough"))
			...
			if not var_36_4(var_36_3(arg_35_0.descMain)) then
				...
				if var_36_5(var_3(arg_35_0.listPanel)) then
					return
				end
	...
	var_3(var_35_2, var_35_3, var_35_4, var_1_10008)
...
function var_0_1.OnOpenPreCombat(arg_37_0, arg_37_1)
	...
	if var_37_1 >= var_37_0.limit_time then
		...
		var_37_1(var_37_2, var_1_10006("dailyLevel_restCount_notEnough"))
	...
	DailyLevelMediator = var_6

	var_37_4(var_37_3, var_6.ON_STAGE, arg_37_1)
...
function var_0_1.OnSelectStage(arg_38_0, arg_38_1)
	...
	var_1_10003(var_38_2, var_38_3, var_38_4, var_1_10008)
	...
	var_1_10003(var_38_5, var_38_6, var_38_7, var_1_10008)
...
function var_0_1.EnableOrDisable(arg_41_0, arg_41_1, arg_41_2)
	...
	local var_41_2 = var_4.isTweening

	go = var_6

	if not var_41_2(var_6(arg_41_0.stageContain)) then
		LeanTween = var_4
		...
		if var_41_3(var_6(arg_41_0.selQuicklyTF)) then
			return
		end
		...
		local var_41_6 = var_41_5(var_41_4, var_1_10007(var_1_10009)).padding.top
...
function var_0_1.DoSelectedAnimation(arg_44_0, arg_44_1, arg_44_2, arg_44_3)
	...
	var_1_10005({
		function(arg_45_0)
			...
			Vector2 = var_2
			var_45_2.sizeDelta = var_2(arg_44_1.sizeDelta.x, 0)
			setActive = var_45_2
			...
			local var_45_6 = var_45_5(var_4(arg_44_0.stageContain), var_45_3.y, var_45_3.y + arg_44_2, var_44_0)
			local var_45_7 = var_2.setOnUpdate

			System = var_5

			local var_45_8 = var_45_7(var_45_6, var_5.Action_float(function(arg_46_0)
				...
				Vector3 = var_46_1
				var_46_3.localPosition = var_46_1(var_46_2.x, var_46_2.y, 0)
			...
			local var_45_10 = var_45_9(var_45_8, var_5.easeInOutCirc)
			local var_45_11 = var_2.setOnComplete

			System = var_5

			var_45_11(var_45_10, var_5.Action(arg_45_0))
		...
		function(arg_47_0)
			...
			local var_47_2 = var_47_1(var_47_0, var_2_10004(var_2_10006))

			LeanTween = var_2_10002

			local var_47_3 = var_2_10002.value

			go = var_4

			local var_47_4 = var_47_3(var_4(arg_44_0.selQuicklyTF), 0, arg_44_0.selQuicklyTFSizeDeltaY, 0.1)
			local var_47_5 = var_2.setOnUpdate

			System = var_5

			local var_47_6 = var_47_5(var_47_4, var_5.Action_float(function(arg_48_0)
			...
			local var_47_8 = var_47_7(var_47_6, var_5.easeInOutCirc)
			local var_47_9 = var_2.setOnComplete

			System = var_5

			var_47_9(var_47_8, var_5.Action(arg_47_0))
...
function var_0_1.DoUnselectAnimtion(arg_49_0, arg_49_1, arg_49_2)
	...
	var_1_10004({
		function(arg_50_0)
			...
			local var_50_3 = var_50_2(var_50_1, var_4(var_2_10006))

			LeanTween = var_2_10002

			local var_50_4 = var_2_10002.value

			go = var_4

			local var_50_5 = var_50_4(var_4(arg_49_0.selQuicklyTF), arg_49_0.selQuicklyTFSizeDeltaY, 0, 0.1)
			local var_50_6 = var_2.setOnUpdate

			System = var_5

			local var_50_7 = var_50_6(var_50_5, var_5.Action_float(function(arg_51_0)
			...
			local var_50_9 = var_50_8(var_50_7, var_5.easeInOutCirc)
			local var_50_10 = var_2.setOnComplete

			System = var_5

			var_50_10(var_50_9, var_5.Action(arg_50_0))
		...
		function(arg_52_0)
			...
			local var_52_2 = var_52_1(var_2_10005(arg_49_0.stageContain), var_49_0.y, var_1, 0.15)
			local var_52_3 = var_3.setOnUpdate

			System = var_6

			local var_52_4 = var_52_3(var_52_2, var_6.Action_float(function(arg_53_0)
			...
			local var_52_7 = var_52_6(var_52_5, var_6.easeInOutCirc)
			local var_52_8 = var_3.setOnComplete

			System = var_6

			var_52_8(var_52_7, var_6.Action(arg_52_0))
...
function var_0_1.UpdateBattleBtn(arg_55_0, arg_55_1)
	...
	local var_55_3 = var_55_0.expedition_daily_template[arg_55_0.dailyLevelId].limit_time
	local var_55_4
	...
	var_1_10008(var_55_8, var_55_9, var_55_10, var_1_10013)

	setText = var_1_10008

	local var_55_11 = var_55_7:Find("Text")

	i18n = var_55_9

	var_1_10008(var_55_11, var_55_9("daily_level_quick_battle_label2"))

	local var_55_12 = var_55_2
	local var_55_13 = var_55_2.Find(var_55_12, "mult")

	onButton = var_55_6

	local var_55_14 = arg_55_0
	local var_55_15 = var_55_13

	local function var_55_16()
	...
	var_55_6(var_55_14, var_55_15, var_55_16, var_1_10014)

	local var_55_17 = var_55_2:Find("once")

	onButton = var_55_12

	local var_55_18 = arg_55_0
	local var_55_19 = var_55_17

	local function var_55_20()
	...
	var_55_12(var_55_18, var_55_19, var_55_20, var_1_10015)

	setText = var_55_12

	local var_55_21 = var_55_13:Find("label")

	i18n = var_55_19

	local var_55_22 = "daily_level_quick_battle_label1"
	local var_55_23 = "   "

	COLOR_WHITE = var_1_10017

	var_55_12(var_55_21, var_55_19(var_55_22, var_55_23, var_1_10017))

	setText = var_55_12

	local var_55_24 = var_55_13
	local var_55_25 = var_55_13.Find(var_55_24, "Text")
	local var_55_26 = "<color="

	COLOR_GREEN = var_55_24

	local var_55_27 = ">"

	math = var_55_23

	var_55_12(var_55_25, var_55_26 .. var_55_24 .. var_55_27 .. var_55_23.max(1, var_55_5) .. "</color>")

	setText = var_55_12

	local var_55_28 = var_55_17:Find("label")

	i18n = var_13

	var_55_12(var_55_28, var_13("daily_level_quick_battle_label3"))

	setText = var_55_12

	var_55_12(var_55_17:Find("Text"), "")
...
function var_0_1.OnQuickBattle(arg_59_0, arg_59_1, arg_59_2)
	...
	if arg_59_2 <= 0 then
		...
		var_59_1(var_59_0, var_1_10006("dailyLevel_restCount_notEnough"))
	...
	if var_59_1.GetInt("daily_level_quick_battle_tip", 0) == 0 then
		...
		local var_59_2 = var_1_10004.MsgboxMgr.GetInstance()
		local var_59_3 = var_4.ShowMsgBox

		var_1_10007 = {}
		i18n = var_1_10008
		var_1_10007.content = var_1_10008("dailyLevel_quickfinish")
		...
		function var_1_10007.onYes()
			...
			var_60_1(var_60_0, var_2_10003.ON_QUICK_BATTLE, arg_59_0.dailyLevelId, arg_59_1.id, arg_59_2)

			return
		end

		var_59_3(var_59_2, var_1_10007)
		...
		DailyLevelMediator = var_1_10007

		var_59_5(var_59_4, var_1_10007.ON_QUICK_BATTLE, arg_59_0.dailyLevelId, arg_59_1.id, arg_59_2)
	end
...
function var_0_1.enableDescMode(arg_61_0, arg_61_1, arg_61_2)
	...
	var_1_10003(var_5.Find(var_61_0, "help_btn"), not arg_61_1)
	...
	local function var_61_1(arg_62_0, arg_62_1, arg_62_2)
		...
		if var_62_0(var_2_10005(arg_62_0)) then
			LeanTween = var_62_1
			var_62_1 = var_62_1.cancel
			go = var_5

			var_62_1(var_5(arg_62_0))
		end
		...
		local var_62_3 = var_62_2(var_5(arg_62_0), arg_62_1, 0.3)
		local var_62_4 = var_3.setEase

		LeanTweenType = var_6

		local var_62_5 = var_62_4(var_62_3, var_6.linear)
		local var_62_6 = var_3.setOnComplete

		System = var_6

		var_62_6(var_62_5, var_6.Action(function()
			if arg_62_2 then
				arg_62_2()
			end
	...
	local function var_61_2()
		...
		for iter_64_0, iter_64_1 in var_2_10000(arg_61_0.dailyLevelTFs) do
			...
			if iter_64_0 ~= arg_61_0.curId then
				...
				if var_2_10005(var_7(iter_64_1)) then
					LeanTween = var_2_10005
					var_2_10005 = var_2_10005.cancel
					go = var_7

					var_2_10005(var_7(iter_64_1))
				end
				...
				var_2_10005 = var_2_10005(var_64_0, var_8(var_2_10010))
				...
				if arg_61_1 then
					...
					var_64_1(var_64_2, var_9.Action_float(function(arg_65_0)
					...
					var_64_5(var_64_4, var_9.Action_float(function(arg_66_0)
...
function var_0_1.flipToSpecificCard(arg_69_0, arg_69_1)
	...
	typeof = var_1_10005
	EnhancelScrollView = var_1_10007

	local var_69_2 = var_69_1(var_69_0, var_1_10005(var_1_10007))

	pairs = var_1_10003

	for iter_69_0, iter_69_1 in var_1_10003(arg_69_0.dailyLevelTFs) do
		if arg_69_1 == iter_69_0 then
			local var_69_3 = iter_69_1
			local var_69_4 = iter_69_1.GetComponent

			typeof = var_1_10011
			EnhanceItem = var_1_10013

			local var_69_5 = var_69_4(var_69_3, var_1_10011(var_1_10013))

			var_1_10011 = var_69_2

			var_69_2.SetHorizontalTargetItemIndex(var_1_10011, var_69_5.scrollViewItemIndex)
		end
	end
...
function var_0_1.tryPlayGuide(arg_70_0)
	...
	var_1.PlayDailyLevel(var_70_0, function()
		...
		var_2_10000(var_2.Find(var_71_0, "help_btn"))
...
function var_0_1.clearTween(arg_73_0)
	...
	local function var_73_0(arg_74_0)
		...
		if var_74_0(var_2_10003(arg_74_0)) then
			LeanTween = var_1
...
function var_0_1.onBackPressed(arg_75_0)
	if arg_75_0.descMode then
		...
		if not var_75_0(var_1_10003(arg_75_0.stageContain)) then
			LeanTween = var_1
			...
			if var_75_1(var_3(arg_75_0.selQuicklyTF)) then
				return
			end
