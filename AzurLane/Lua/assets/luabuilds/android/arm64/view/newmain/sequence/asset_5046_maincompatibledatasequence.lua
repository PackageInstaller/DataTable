...
function var_0_0.CheckSpecialDayForEducateChar(arg_4_0, arg_4_1)
	...
	ChineseCalendar = var_1_10003

	local var_4_2, var_4_3, var_4_4 = var_1_10003.GetCurrYearMonthDay(var_4_1)
	...
	local var_4_8 = var_1_10007(var_1_10009)

	if var_4_7 then
		local var_4_9 = var_4_8:GetFlagShipDisplayMode()

		FlAG_SHIP_DISPLAY_ONLY_SHIP = var_1_10009

		if var_4_9 ~= var_1_10009 and not var_4_8:IsTipDay(var_4_2, var_4_3, var_4_4) then
			ChineseCalendar = var_8

			if var_8.AnySpecialDay(var_4_2, var_4_3, var_4_4) then
				PlayerVitaeShipsPage = var_8

				local var_4_10, var_4_11 = var_8.GetSlotMaxCnt()

				if var_4_11 + 1 and var_10 > 0 then
