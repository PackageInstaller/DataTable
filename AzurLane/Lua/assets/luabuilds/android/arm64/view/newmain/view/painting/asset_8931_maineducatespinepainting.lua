...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".MainSpinePainting"))
local var_0_2
...
function var_0_1.OnDisplayWorld(arg_17_0, arg_17_1)
	...
	expressionAnimName = var_1_10003
...
function var_0_1.CollectIdleEvents(arg_23_0, arg_23_1)
	...
	if var_3.hasFinishState(var_23_1) and arg_23_1 ~= "event_complete" then
		...
		if #var_23_0 == 0 then
			...
			local var_23_8 = var_8.getSkinId(var_23_7)
			local var_23_9 = arg_23_0.ship

			var_23_0 = var_23_5(var_23_4, var_23_6(var_23_8, var_9.getCVIntimacy(var_23_9)))
			getProxy = var_3
			TaskProxy = var_23_4

			local var_23_10 = var_3(var_23_4)

			if var_3.getNotFinishCount(var_23_10) then
				getProxy = var_3
				TaskProxy = var_23_10

				local var_23_11 = var_3(var_23_10)

				if var_3.getNotFinishCount(var_23_11) > 0 and arg_23_1 ~= "mission" then
					table = var_3
