...
function var_0_0.AddChild(arg_4_0)
	...
	local var_4_1 = arg_4_0.GetDot(var_4_0, arg_4_0.total)
	local var_4_2 = arg_4_0:GetItem(arg_4_0.total)

	setActive = var_4_0

	var_4_0(var_4_2, true)

	setActive = var_4_0

	var_4_0(var_4_1, true)
	arg_4_0:UpdateItemPosition(arg_4_0.total, var_4_2)
	arg_4_0:UpdateDotPosition(arg_4_0.total, var_4_1)
...
function var_0_0.ScrollTo(arg_10_0, arg_10_1)
	...
	local var_10_3 = var_10_2(var_1_10006(arg_10_0.container), -1 * var_10_1, 0.2)
	local var_10_4 = var_4.setEase

	LeanTweenType = var_7

	local var_10_5 = var_10_4(var_10_3, var_7.easeInOutSine)
...
function var_0_0.TriggerDot(arg_12_0, arg_12_1, arg_12_2)
	if arg_12_2 then
		...
		typeof = var_1_10007
		Image = var_1_10009
		var_12_1(var_12_0, var_1_10007(var_1_10009)).color = var_1_10003
...
function var_0_0.AddDrag(arg_13_0)
	...
	var_3.AddDragEndFunc(var_13_4, function(arg_16_0, arg_16_1)
		...
		local var_16_2 = var_16_1(var_2_10005.abs(var_16_0 / arg_13_0.itemWidth) + 0.5)
		local var_16_3
...
function var_0_0.Reset(arg_17_0)
	...
	var_17_0(var_3(arg_17_0.container))
