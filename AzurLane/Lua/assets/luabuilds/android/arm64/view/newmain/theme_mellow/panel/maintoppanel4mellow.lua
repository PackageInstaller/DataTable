...
function var_0_1.GetBtns(arg_1_0)
	...
	findTF = var_4
	var_1_0[2] = var_1_1(var_4(arg_1_0._tf, "btns/mail"), arg_1_0.event)
	MainNoticeBtn = var_2

	local var_1_2 = var_2.New

	findTF = var_4
	var_1_0[3] = var_1_2(var_4(arg_1_0._tf, "btns/noti"), arg_1_0.event)
	MainSettingsBtn = var_2

	local var_1_3 = var_2.New

	findTF = var_4
	var_1_0[4] = var_1_3(var_4(arg_1_0._tf, "btns/settings"), arg_1_0.event)
