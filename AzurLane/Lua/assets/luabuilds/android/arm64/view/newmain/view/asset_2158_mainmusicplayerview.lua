...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_0(var_2.Find(var_4_1, "on"), not arg_3_0.isOpen)

		setActive = var_4_0

		local var_4_2 = arg_3_0.btnExtend

		var_4_0(var_2.Find(var_4_2, "off"), arg_3_0.isOpen)
		...
		var_4_3(var_4_4, var_3(arg_3_0.isOpen and 460 or 130, arg_3_0.rtPanel.sizeDelta.y), 0.3)
	...
	local function var_3_11()
		...
		local var_7_2 = var_2_10001.m02
		local var_7_3 = var_1.sendNotification

		GAME = var_4

		var_7_3(var_7_2, var_4.APPRECIATE_CHANGE_MUSIC_PLAY_LOOP_TYPE, {
			loopType = var_7_1
		})
	...
	local function var_3_14()
		...
		local var_11_2 = var_2_10001.music_collect_config[var_11_1].id
		...
		var_11_4(var_11_3, var_2_10006.APPRECIATE_MUSIC_LIKE, {
			musicID = var_11_2,
		...
		var_11_5(var_5.Find(var_11_6, "On"), arg_3_0.isLike)
	...
	local function var_3_17()
		...
		local var_12_3 = var_2_10004.COLLECTSHIP
		local var_12_4 = {}

		CollectionScene = var_2_10006
		var_12_4.toggle = var_2_10006.MUSIC_INDEX
...
function var_0_1.Show(arg_13_0, arg_13_1)
	...
	var_1_10002(var_4.Find(var_13_0, "on"), not arg_13_0.isOpen)

	setActive = var_1_10002

	local var_13_1 = arg_13_0.btnExtend

	var_1_10002(var_4.Find(var_13_1, "off"), arg_13_0.isOpen)

	assert = var_1_10002

	local var_13_2 = arg_13_0.bgmMgr

	var_1_10002(var_4.GetNow(var_13_2) == "MainMusicPlayer")
	...
	arg_13_0.isLike = var_13_5(var_13_4, var_5.GetCurrentMusicId(var_13_6))
	...
	var_2.RegisterMusicCallback(var_13_7, arg_13_0.__cname, "MainMusicPlayer", {
		startCall = function(arg_14_0)
			...
			AppreciateProxy = var_2_10004

			local var_14_1 = var_2_10002(var_2_10004)
			local var_14_2 = var_2.isLikedByMusicID
			local var_14_3 = arg_13_0.musicPlayer

			var_14_0.isLike = var_14_2(var_14_1, var_5.GetCurrentMusicId(var_14_3))
...
function var_0_1.UpdatePlayerDisplay(arg_15_0)
	...
	local var_15_2 = var_1_10002.music_collect_config[var_15_1].album_id

	pg = var_15_0

	local var_15_3 = var_15_0.music_album[var_15_2].cover
	...
	var_5(var_15_4, var_15_5, var_9.Find(var_15_6, "icon/face"), false)

	setActive = var_5

	local var_15_7 = arg_15_0.rtContainer

	var_5(var_7.Find(var_15_7, "LikeBtn/On"), arg_15_0.isLike)
