...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.cg = var_2_1(var_2_0, var_1_10004(var_1_10006))
	...
	arg_2_0.animationPlayer = var_2_3(var_2_2, var_4(var_1_10006))
	...
	arg_2_0.dftAniEvent = var_2_5(var_2_4, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.timeEnTxt = var_2_11(var_2_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.batteryTxt = var_2_14(var_2_13, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.dateTxt = var_2_21(var_2_20, var_4(var_1_10006))
	...
	local var_2_25 = var_3.Find(var_2_24, "tips")
	local var_2_26 = arg_2_0._tf

	arg_2_0.tips = var_2_23(var_2_25, var_4.Find(var_2_26, "tips/tpl"))
	...
	typeof = var_4
	Text = var_2_26
	arg_2_0.chatTxt = var_2_29(var_2_28, var_4(var_2_26))
	...
	arg_2_0.musicPlayerView = var_2_30(var_3.Find(var_2_31, "adapt"), arg_2_0.event)

	local var_2_32 = arg_2_0.musicPlayerView
	local var_2_33 = var_1.Load
	local var_2_34 = arg_2_0._tf

	var_2_33(var_2_32, var_4.Find(var_2_34, "adapt/MusicPlayer").gameObject)
...
function var_0_1.OnInit(arg_3_0)
	...
	var_3_9(var_3_8, var_4.REMOVE_LAYERS, function(arg_7_0, arg_7_1)
	...
	var_3_11(var_3_10, var_4.SET_CONTENT, function(arg_8_0, arg_8_1, arg_8_2)
	...
	var_3_13(var_3_12, var_4.START_ANIMATION, function(arg_9_0, arg_9_1, arg_9_2)
	...
	var_3_15(var_3_14, var_4.STOP_ANIMATION, function(arg_10_0, arg_10_1, arg_10_2)
...
function var_0_1.Exit(arg_16_0, arg_16_1)
	...
	var_2.SetEndEvent(var_16_1, function()
		...
		var_17_1(var_17_0, var_2_10003.EXIT_SILENT_VIEW)
...
function var_0_1.Tracking(arg_18_0, arg_18_1)
	...
	var_18_6(var_18_5, var_1_10009.BuildExitSilentView(var_18_2, var_18_1, var_18_4))
...
function var_0_1.TrackingSwitchShip(arg_19_0)
	...
	local var_19_2 = var_1.GetFlagShip(var_19_1)
	local var_19_3 = var_2.getSkinId(var_19_2)

	isa = var_19_1

	local var_19_4 = var_2

	VirtualEducateCharShip = var_1_10007

	if var_19_1(var_19_4, var_1_10007) then
		var_19_3 = 0
	end

	pg = var_4

	local var_19_5 = var_4.TimeMgr.GetInstance()
	local var_19_6 = var_4.GetServerTime(var_19_5) - arg_19_0.paintingTime

	pg = var_19_5

	local var_19_7 = var_19_5.GameTrackerMgr.GetInstance()
	local var_19_8 = var_6.Record

	GameTrackerBuilder = var_1_10009

	var_19_8(var_19_7, var_1_10009.BuildSwitchPainting(var_19_3, var_19_6))
...
function var_0_1.FlushTips(arg_25_0)
	...
	var_3.make(var_25_2, function(arg_26_0, arg_26_1, arg_26_2)
		...
		if var_2_10003.EventUpdate == arg_26_0 then
			...
			local var_26_4 = var_26_3(var_26_2, var_8(var_2_10010))
			...
			local var_26_5 = arg_26_2:Find("Text")

			i18n = var_8

			var_26_4(var_26_5, var_8("main_silent_tip_" .. var_26_0.type))
			...
			var_26_4(var_26_6, var_26_7, var_26_8, var_10)

			local var_26_9 = arg_25_0

			var_5.InsertAnimation(var_26_9, var_25_1, arg_26_2)
		end
...
function var_0_1.PlayTipOutAnimation(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_2 = var_30_1(var_30_0, var_1_10006(var_1_10008))
	...
	local var_30_5 = var_30_4(var_30_3, var_1_10007(var_1_10009))
...
function var_0_1.InsertAnimation(arg_32_0, arg_32_1, arg_32_2)
	...
	local var_32_1 = var_3(var_32_0, var_6(var_1_10008))
	...
	var_4.insert(arg_32_1, function(arg_33_0)
		...
		local var_33_2 = var_33_1(var_33_0, var_2_10004(var_2_10006))
...
function var_0_1.Skip(arg_34_0, arg_34_1)
	...
	arg_34_0:Exit(function()
		if arg_34_1 == var_0_2 then
			...
			var_35_1(var_35_0, var_2_10003, var_2_10004.EVENT)
		elseif arg_34_1 == var_0_3 then
			...
			var_35_3(var_35_2, var_2_10003, var_2_10004.GETBOAT)
		elseif arg_34_1 == var_0_4 then
			...
			var_35_5(var_35_4, var_2_10003, var_2_10004.TECHNOLOGY)
		elseif arg_34_1 == var_0_5 then
			...
			local var_35_8 = var_2_10003.GO_SCENE

			SCENE = var_2_10004

			local var_35_9 = var_2_10004.NAVALACADEMYSCENE
			local var_35_10 = {}

			NavalAcademyScene = var_2_10006
			var_35_10.warp = var_2_10006.WARP_TO_TACTIC
...
function var_0_1.CollectEventTips(arg_37_0, arg_37_1)
	...
	local var_37_0 = var_1_10002(var_1_10004)
	local var_37_1 = var_2.countByState

	EventInfo = var_1_10005

	local var_37_2 = var_37_1(var_37_0, var_1_10005.StateFinish)
...
function var_0_1.CollectTechTips(arg_39_0, arg_39_1)
	...
	local var_39_0 = var_1_10002(var_1_10004)
...
function var_0_1.FlushDate(arg_45_0)
	...
	local var_45_1 = var_1_10002.split(var_45_0, "/")[1]
	...
	local var_45_4 = var_6.TimeMgr.GetInstance()
...
function var_0_1.FlushMusicPlayer(arg_46_0)
	...
	if var_1_10002(var_4.isShowing(var_46_2)) ~= var_46_1 then
		if var_46_1 then
