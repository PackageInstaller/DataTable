...
function var_0_1.Register(arg_1_0)
	...
	MainBaseActivityBtn = var_1_10004

	local var_1_2 = var_1_10004.UPDATED_TIP

	handler = var_1_10005

	var_1_1(var_1_0, var_1_2, var_1_10005(arg_1_0, arg_1_0.OnRefreshBtn))
...
function var_0_1.CollectActivity(arg_8_0)
	...
	local var_8_1 = var_1_10002.activity_template[var_8_0].page_core
	local var_8_2 = 0
	local var_8_3
	...
	local var_8_5 = var_5.getCorePanelActivities(var_8_4, var_8_1)

	pairs = var_1_10006

	for iter_8_0, iter_8_1 in var_1_10006(var_8_5) do
...
function var_0_1.Dispose(arg_11_0)
	...
	local var_11_2 = var_1_10004.UPDATED_TIP

	handler = var_1_10005

	var_11_1(var_11_0, var_11_2, var_1_10005(arg_11_0, arg_11_0.OnRefreshBtn))
