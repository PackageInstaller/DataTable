...
function var_0_1.InShowTime(arg_1_0)
	...
	local var_1_3 = var_1_2(var_1_1, var_1_10005.ACTIVITY_TYPE_BLACK_FRIDAY_SHOP)
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_4 = var_3_3(var_3_2, var_1_10006.ACTIVITY_TYPE_TASKS)

	ipairs = var_1_10004

	for iter_3_0, iter_3_1 in var_1_10004(var_3_4) do
		var_1_10011 = iter_3_1

		if iter_3_1.getConfig(var_1_10011, "config_client").blackFriday then
			var_3_1 = iter_3_1
	...
	if var_3_1 then
		...
		if not var_3_1.isEnd(var_3_5) then
			...
			local var_3_7 = var_3_1:getConfig("config_client").taskGroup

			ipairs = var_3_5

			for iter_3_2, iter_3_3 in var_3_5(var_3_7) do
				ipairs = var_1_10011
				...
				for iter_3_4, iter_3_5 in var_1_10011(iter_3_3) do
					...
					local var_3_8 = var_3_6:getTaskVO(iter_3_5)

					if var_1_10016.getTaskStatus(var_3_8) == 1 then
						var_3_0 = true
