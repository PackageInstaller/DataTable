...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	var_1_1(var_1_0, var_7.ON_BUFF_DESC, function(arg_2_0, arg_2_1, arg_2_2)
...
function var_0_1.OnLoaded(arg_4_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_4_0.descTxt = var_4_2(var_4_1, var_4(var_1_10006))
...
function var_0_1.UpdateDescPreSce(arg_8_0, arg_8_1)
	...
	local var_8_1 = var_1_10003.TimeMgr.GetInstance()
	local var_8_2 = var_3.GetServerTime(var_8_1)
	local var_8_3 = arg_8_1.timestamp - var_8_2

	if 0 < var_8_3 then
		pg = var_5

		local var_8_4 = var_5.TimeMgr.GetInstance()
		local var_8_5 = var_5.DescCDTime(var_8_4, var_8_3)
		local var_8_6 = arg_8_0.descTxt

		string = var_8_4
		var_8_6.text = var_8_4.gsub(var_8_0, "$1", var_8_5)
	else
		arg_8_0:Hide()
	end
