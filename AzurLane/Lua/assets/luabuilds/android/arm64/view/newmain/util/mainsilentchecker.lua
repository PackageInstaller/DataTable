...
function var_0_1.SetUp(arg_2_0)
	...
	Time = var_1_10002
	arg_2_0.lastActivityTime = var_1_10002.time
	...
	var_2_1(var_2_0, var_5.FOLD, function(arg_3_0, arg_3_1)
...
function var_0_1.EnterState(arg_5_0)
	...
	if arg_5_0._silentRunFlag then
		...
		var_5_1(var_5_0, var_1_10004.ENTER_SILENT_VIEW)
	end
...
function var_0_1.AnyOverlayShowing(arg_6_0)
	...
	local var_6_2 = var_1_10002.LayerWeightMgr.GetInstance().uiOrigin

	pg = var_6_0

	local var_6_3 = var_6_0.NewStoryMgr.GetInstance()
	local var_6_5
