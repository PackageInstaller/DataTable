...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".MainMeshImagePainting"))
local var_0_2
...
function var_0_1.OnFirstTimeTriggerEvent(arg_5_0)
	...
	local var_5_2, var_5_3, var_5_4 = var_1_10002.GetCurrYearMonthDay(var_5_1)
	...
	if var_1_10007.IsNewYear(var_5_2, var_5_3, var_5_4) and not var_5_6() then
		...
		var_5_7(var_9.WORD_KEY_NEWYEAR)
	else
		...
		if var_5_7.IsLunarNewYear(var_5_2, var_5_3, var_5_4) and not var_5_6() then
			...
			var_5_8(var_9.WORD_KEY_LUNARNEWYEAR)
		else
			...
			if var_5_8.IsValentineDay(var_5_2, var_5_3, var_5_4) and not var_5_6() then
				...
				var_5_9(var_9.WORD_KEY_VALENTINE)
			else
				...
				if var_5_9.IsMidAutumnFestival(var_5_2, var_5_3, var_5_4) and not var_5_6() then
					...
					var_5_10(var_9.WORD_KEY_MIDAUTUMNFESTIVAL)
				else
					...
					if var_5_10.AllHallowsDay(var_5_2, var_5_3, var_5_4) and not var_5_6() then
						...
						var_5_11(var_9.WORD_KEY_ALLHALLOWSDAY)
					else
						...
						if var_5_11.IsChristmas(var_5_2, var_5_3, var_5_4) and not var_5_6() then
							...
							var_5_12(var_9.WORD_KEY_CHRISTMAS)
						else
							getProxy = var_5_12
							PlayerProxy = var_9

							local var_5_13 = var_5_12(var_9)
							local var_5_14
							...
							if not var_7.getFlag(var_5_13, "tb_activity") then
								...
								if arg_5_0.ExistImportantActivity(var_5_13) then
									...
									EducateCharWordHelper = var_10

									var_5_14(var_5_13, var_10.WORD_KEY_ACT)
							...
							if var_7.getFlag(var_5_15, "change_tb") then
								...
								var_5_18(var_5_17, var_10.WORD_KEY_CHANGE_TB)
							else
...
function var_0_1.ExistImportantActivity(arg_8_0)
	...
	return var_1_10003.any(var_8_0, function(arg_9_0)
		...
		return var_1.getActivityByType(var_9_0, arg_9_0) and not var_1:isEnd()
	end)
end
...
function var_0_1.DisplayTellTimeWord(arg_14_0, arg_14_1)
	...
	local var_14_2 = var_1_10003.split(var_14_1, ":")

	tonumber = var_14_0

	local var_14_3 = var_14_0(var_14_2[4])
	local var_14_4 = arg_14_0
	local var_14_5 = arg_14_0.DisplayWord

	EducateCharWordHelper = var_1_10008

	var_14_5(var_14_4, var_1_10008.WORD_KEY_TELL_TIME .. var_14_3)
...
function var_0_1.OnDisplayWorld(arg_17_0, arg_17_1)
	...
	if var_1_10002.GetExpression(arg_17_0.ship.educateCharId, arg_17_1) and var_2 ~= "" then
		...
		var_1_10003 = var_1_10003.UpdateExpression
		findTF = var_5

		local var_17_0 = var_5(arg_17_0.container, "fitter")

		var_1_10003(var_5.GetChild(var_17_0, 0), arg_17_0.paintingName, var_2)
	else
		ShipExpressionHelper = var_1_10003

		local var_17_1 = var_1_10003.UpdateExpression

		findTF = var_5

		local var_17_2 = var_5(arg_17_0.container, "fitter")

		var_17_1(var_5.GetChild(var_17_2, 0), arg_17_0.paintingName, "")
	end
...
function var_0_1.OnDisplayWordEnd(arg_18_0)
	...
	if arg_18_0.waitForCharEnd then
		...
		Timer = var_1_10002
		arg_18_0.delayTellTimeTimer = var_1_10002.New(function()
...
function var_0_1.CollectIdleEvents(arg_23_0, arg_23_1)
	...
	if var_3.hasFinishState(var_23_1) and arg_23_1 ~= "event_complete" then
		...
		if var_3.getCanReceiveCount(var_23_2) > 0 and arg_23_1 ~= "mission_complete" then
			table = var_3

			var_3.insert(var_23_0, "mission_complete")
		end

		getProxy = var_3
		MailProxy = var_23_2

		local var_23_3 = var_3(var_23_2)

		if var_3.GetUnreadCount(var_23_3) > 0 and arg_23_1 ~= "mail" then
			table = var_3
		...
		if #var_23_0 == 0 then
			...
			local var_23_5 = arg_23_0.FilterExistEvents
			local var_23_6 = var_0_2.GetShipMainEvents
			local var_23_7 = arg_23_0.ship

			var_23_0 = var_23_5(var_23_4, var_23_6(var_8.getSkinId(var_23_7), -1))
			getProxy = var_3
			TaskProxy = var_23_4

			local var_23_8 = var_3(var_23_4)

			if var_3.getNotFinishCount(var_23_8) then
				getProxy = var_3
				TaskProxy = var_23_8

				local var_23_9 = var_3(var_23_8)

				if var_3.getNotFinishCount(var_23_9) > 0 and arg_23_1 ~= "mission" then
					table = var_3
...
function var_0_1.CollectTouchEvents(arg_25_0)
	...
	local var_25_4 = var_6.getSkinId(var_25_3)
	local var_25_5 = arg_25_0.ship

	return (var_25_1(var_25_0, var_25_2(var_25_4, var_7.getCVIntimacy(var_25_5))))
end
