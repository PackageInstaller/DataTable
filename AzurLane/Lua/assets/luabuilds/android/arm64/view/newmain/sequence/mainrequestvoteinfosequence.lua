...
function var_0_0.RequestMainStage(arg_5_0, arg_5_1)
	...
	if not var_5_0(var_1_10004.activity_vote.all, function(arg_6_0)
		pg = var_2_10001
		...
		if var_3.inTime(var_6_1, var_6_0) then
			if var_1.is_in_game == 1 then
				...
				VoteConst = var_2_10004

				if var_6_2 == var_2_10004.RACE_TYPE_FUN then
					var_6_2 = false
				else
					var_6_2 = true
				end
	...
	local var_5_1 = var_1_10003.m02
	local var_5_2 = var_3.sendNotification

	GAME = var_1_10006

	var_5_2(var_5_1, var_1_10006.FETCH_VOTE_INFO, {
		voteId = var_2,
		callback = function()
...
function var_0_0.ShouldRequestMainStage(arg_8_0, arg_8_1)
	...
	local var_8_2 = var_1_10003.TimeMgr.GetInstance()
	...
	if var_8_1 then
		...
		if not (var_8_5 > var_8_2.RankExpiredTime) then
			local var_8_6
...
function var_0_0.RequestFunStage(arg_9_0, arg_9_1)
	...
	if not var_9_0(var_1_10004.activity_vote.all, function(arg_10_0)
		pg = var_2_10001
		...
		if var_3.inTime(var_10_1, var_10_0) then
			if var_1.is_in_game == 1 then
				...
				if var_10_2 ~= var_2_10004.RACE_TYPE_FUN then
					var_10_2 = false
				else
					var_10_2 = true
				end
	...
	local var_9_1 = var_1_10003.m02
	local var_9_2 = var_3.sendNotification

	GAME = var_1_10006

	var_9_2(var_9_1, var_1_10006.FETCH_VOTE_INFO, {
		voteId = var_2,
		callback = function()
...
function var_0_0.ShouldRequestFunStage(arg_12_0, arg_12_1)
	...
	if var_12_1 then
		...
		if not (var_12_5 > var_12_2.RankExpiredTime) then
			local var_12_6
