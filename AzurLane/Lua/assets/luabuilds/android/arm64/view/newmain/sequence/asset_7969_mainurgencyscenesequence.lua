...
function var_0_0.SkipToActivity(arg_3_0)
	...
	if var_1.findNextAutoActivity(var_3_0) then
		...
		local var_3_1 = var_1_10003.m02
		local var_3_2 = var_3.sendNotification

		GAME = var_1_10006

		local var_3_3 = var_1_10006.GO_SCENE

		SCENE = var_1_10007

		var_3_2(var_3_1, var_3_3, var_1_10007.ACTIVITY)
...
function var_0_0.SkipToReFluxActivity(arg_4_0)
	...
	if var_1.isCanSign(var_4_0) then
		var_4_1 = var_1:isInRefluxTime()
	end

	if var_4_1 then
		pg = var_1_10003

		local var_4_2 = var_1_10003.m02
		local var_4_3 = var_3.sendNotification

		GAME = var_1_10006

		local var_4_4 = var_1_10006.GO_SCENE

		SCENE = var_1_10007

		var_4_3(var_4_2, var_4_4, var_1_10007.REFLUX)
...
function var_0_0.SkipToTechnology(arg_5_0)
	...
	LOCK_TECHNOLOGY = var_1_10002

	if not var_1_10002 then
		pg = var_1_10002

		local var_5_2 = var_1_10002.SystemOpenMgr.GetInstance()
		...
		if var_2.isOpenSystem(var_5_2, var_5_1, "TechnologyMediator") then
			...
			if not var_2.IsPlayed(var_5_3, "FANGAN1") then
				...
				local var_5_6 = var_5.GO_SCENE

				SCENE = var_6

				var_5_5(var_5_4, var_5_6, var_6.SELTECHNOLOGY)
