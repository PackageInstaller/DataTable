...
function var_0_0.Execute(arg_1_0, arg_1_1)
	...
	if not var_1_10002(var_1_10004).isClearNpc then
		getProxy = var_3
	...
	if var_2.getActiveChapter(var_3_0) then
		...
		for iter_3_0, iter_3_1 in var_3_0(var_3_1) do
			if iter_3_1:containsShip(arg_3_1.id) then
				...
				local var_3_4 = var_13.CHAPTER_OP
				local var_3_5 = {}

				ChapterConst = var_1_10015
				var_3_5.type = var_1_10015.OpRetreat
...
function var_0_0.CheckNavTactics(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_1_10004(var_5_1) do
