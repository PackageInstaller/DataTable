...
function var_0_0.CheckSkinCouponActivity(arg_3_0, arg_3_1)
	...
	if not var_3_1(var_3_0, var_1_10005.ACTIVITY_TYPE_SKIN_COUPON) or #var_2 == 0 then
		arg_3_1()
	...
	for iter_3_0, iter_3_1 in var_3_0(var_2) do
...
function var_0_0.ShowTipMsg(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_6 = var_7.TimeMgr.GetInstance()
	local var_5_7 = var_7.STimeDescS(var_5_6, arg_5_1.stopTime, "%m.%d")

	pg = var_5_4

	local var_5_8 = var_5_4.MsgboxMgr.GetInstance()
	local var_5_9 = var_8.ShowMsgBox
	local var_5_10 = {
		hideNo = true
	}

	MSGBOX_TYPE_ITEM_BOX = var_1_10012
	var_5_10.type = var_1_10012
	i18n = var_1_10012
	var_5_10.content = var_1_10012("skin_discount_timelimit", var_5_5, var_5_7)
