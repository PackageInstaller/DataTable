...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	arg_1_0.cg = var_1_1(var_1_0, var_7(var_1_10009))

	local var_1_2 = {}

	MainMeshImagePainting = var_5
	var_1_2[1] = var_5.New(arg_1_0._tf, arg_1_0.event)
...
function var_0_1.Register(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10004.TASK_ADDED, function(arg_3_0)
	...
	var_2_3(var_2_2, var_4.CHAT_STATE_CHANGE, function(arg_4_0, arg_4_1)
	...
	var_2_5(var_2_4, var_4.ENABLE_PAITING_MOVE, function(arg_5_0, arg_5_1)
	...
	var_2_7(var_2_6, var_4.SAVE_PART_SCALE, function(arg_6_0, arg_6_1)
	...
	var_2_9(var_2_8, var_4.ENABLE_PAITING_SCALE, function(arg_7_0, arg_7_1)
	...
	var_2_11(var_2_10, var_4.RESET_PAITING_SCALE, function(arg_8_0, arg_8_1)
	...
	var_2_13(var_2_12, var_4.ON_ENTER_DONE, function(arg_9_0)
	...
	var_2_15(var_2_14, var_4.ENTER_SILENT_VIEW, function()
	...
	var_2_17(var_2_16, var_4.EXIT_SILENT_VIEW, function()
	...
	var_2_19(var_2_18, var_4.RESET_L2D, function()
		...
		MainLive2dPainting = var_2_10003

		if not var_0(var_12_0, var_2_10003) then
			return
		end
	...
	function var_2_19.UnLoadL2dPating()
		if not arg_2_0.reloadOnResume and arg_2_0.painting then
			...
			if var_0(var_13_0, var_2_10003) then
...
function var_0_1.ShouldReLoad(arg_21_0, arg_21_1)
	...
	local var_21_1 = var_1_10003.GetInt("paint_hide_other_obj_" .. arg_21_0.painting.paintingName, 0)
...
function var_0_1.AdjustPositionWithAnim(arg_26_0, arg_26_1)
	...
	var_26_0(var_1_10004(arg_26_0._tf))
	...
	var_26_1(var_4(arg_26_0._bgTf))

	local var_26_2 = arg_26_0:GetPositionAndScale(arg_26_1)

	LeanTween = var_1_10003

	local var_26_3 = var_1_10003.moveLocal

	go = var_5

	local var_26_4 = var_26_3(var_5(arg_26_0._tf), var_26_2, 0.3)
	local var_26_5 = var_3.setEase

	LeanTweenType = var_6

	var_26_5(var_26_4, var_6.easeInOutExpo)

	LeanTween = var_26_5

	local var_26_6 = var_26_5.moveLocal

	go = var_26_4

	local var_26_7 = var_26_6(var_26_4(arg_26_0._bgTf), var_26_2, 0.3)
	local var_26_8 = var_3.setEase

	LeanTweenType = var_6

	var_26_8(var_26_7, var_6.easeInOutExpo)

	local var_26_9 = arg_26_0.shift
	local var_26_10, var_26_11 = var_3.GetSpineShift(var_26_9)

	LeanTween = var_26_9

	local var_26_12 = var_26_9.moveLocal

	go = var_7

	local var_26_13 = var_26_12(var_7(arg_26_0.spineContainer), var_26_10, 0.3)
	local var_26_14 = var_5.setEase

	LeanTweenType = var_8

	var_26_14(var_26_13, var_8.easeInOutExpo)

	local var_26_15 = arg_26_0.shift
	local var_26_16, var_26_17 = var_5.GetL2dShift(var_26_15)
	local var_26_18 = arg_26_0.painting

	if var_7.IslimitYPos(var_26_18) then
		var_26_18 = arg_26_0.painting
		var_26_16.y = var_7.GetHalfBodyOffsetY(var_26_18)
	end

	LeanTween = var_7

	local var_26_19 = var_7.moveLocal

	go = var_26_18

	local var_26_20 = var_26_19(var_26_18(arg_26_0.l2dContainer), var_26_16, 0.3)
	local var_26_21 = var_7.setEase

	LeanTweenType = var_10

	local var_26_22 = var_26_21(var_26_20, var_10.easeInOutExpo)
	local var_26_23 = var_7.setOnComplete

	System = var_10

	var_26_23(var_26_22, var_10.Action(function()
...
function var_0_1.AdjustPosition(arg_28_0, arg_28_1)
	...
	local var_28_11 = var_28_10(var_1_10010)
...
function var_0_1.GetPositionAndScale(arg_29_0, arg_29_1)
	...
	local var_29_4 = var_5(0, 0, 0)

	Vector3 = var_1_10006

	local var_29_5 = var_1_10006(1, 1, 1)
...
function var_0_1.GetAssistantStatus(arg_30_0)
	...
	local var_30_2 = var_1_10002(var_1_10004)

	HXSet = var_30_0

	local var_30_3 = var_30_0.autoHxShiftPath("spinepainting/" .. var_30_1)

	checkABExist = var_1_10004

	local var_30_4 = var_1_10004(var_30_3)
	...
	SHIP_FLAG_BG = var_1_10011

	local var_30_10 = var_30_8(var_30_7, var_30_9, var_1_10011)
	local var_30_11 = var_30_2
	local var_30_12 = var_30_2.getCharacterSetting
	local var_30_13 = arg_30_0.id

	SHIP_FLAG_L2D = var_1_10012

	if var_30_12(var_30_11, var_30_13, var_1_10012) and var_30_6 then
		isa = var_8
		...
		SHIP_FLAG_SP = var_1_10012

		local var_30_20

		if var_30_17(var_30_16, var_30_18, var_1_10012) and var_30_4 then
			isa = var_30_20
...
function var_0_1.Fold(arg_33_0, arg_33_1, arg_33_2)
	...
	if arg_33_1 and not arg_33_0.silentFlag then
		...
		var_1_10004 = var_1_10004.GetMeshImageShift(var_33_1)
		Vector3 = var_5

		local var_33_2 = arg_33_0.painting
		local var_33_3 = var_5(0 - var_7.GetOffset(var_33_2), var_1_10004.y, 0)

		LeanTween = var_33_1

		local var_33_4 = var_33_1.moveLocal(arg_33_0._tf.gameObject, var_33_3, arg_33_2)
		local var_33_5 = var_6.setEase

		LeanTweenType = var_9

		var_33_5(var_33_4, var_9.easeInOutExpo)

		local var_33_6 = var_33_3 - var_33_0

		LeanTween = var_7

		local var_33_7 = var_7.moveLocal(arg_33_0._bgTf.gameObject, var_33_6, arg_33_2)
		local var_33_8 = var_7.setEase

		LeanTweenType = var_10

		local var_33_9 = var_33_8(var_33_7, var_10.easeInOutExpo)
		local var_33_10 = var_7.setOnComplete

		System = var_10

		var_33_10(var_33_9, var_10.Action(function()
	...
	elseif arg_33_0.ship then
		local var_33_11 = arg_33_0:GetPositionAndScale(arg_33_0.ship)

		LeanTween = var_1_10004

		local var_33_12 = var_1_10004.moveLocal(arg_33_0._tf.gameObject, var_33_11, arg_33_2)
		local var_33_13 = var_4.setEase

		LeanTweenType = var_7

		var_33_13(var_33_12, var_7.easeInOutExpo)

		LeanTween = var_33_13

		local var_33_14 = var_33_13.moveLocal(arg_33_0._bgTf.gameObject, var_33_11, arg_33_2)
		local var_33_15 = var_4.setEase

		LeanTweenType = var_7

		local var_33_16 = var_33_15(var_33_14, var_7.easeInOutExpo)
		local var_33_17 = var_4.setOnComplete

		System = var_7

		var_33_17(var_33_16, var_7.Action(function()
...
function var_0_1.EnableDragAndZoom(arg_39_0)
	...
	local var_39_2 = var_1_10002(var_39_1, var_1_10005(var_1_10007))
	...
	local var_39_4 = var_1_10003(var_39_3, var_1_10006(var_1_10008))

	Vector3 = var_39_1

	local var_39_5 = var_39_1(0, 0, 0)
...
function var_0_1.DisableDragAndZoom(arg_43_0)
	if arg_43_0.isEnableDrag then
		...
		local var_43_2 = var_43_1(var_43_0, var_1_10004(var_1_10006))

		ClearEventTrigger = var_1_10002

		var_1_10002(var_43_2)
		...
		typeof = var_1_10005
		PinchZoom = var_1_10007
		var_43_4(var_43_3, var_1_10005(var_1_10007)).enabled = false
...
function var_0_1.Screen2Local(arg_45_0, arg_45_1)
	...
	local var_45_4 = var_45_0.ScreenToLocal(var_45_3, arg_45_1, var_45_1)

	Vector3 = var_45_2

	return var_45_2(var_45_4.x, var_45_4.y, 0)
end
