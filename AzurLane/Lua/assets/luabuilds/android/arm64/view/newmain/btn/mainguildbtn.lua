...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_6
	Image = var_1_10008
	arg_1_0.guildImage = var_1_1(var_1_0, var_6(var_1_10008))
...
function var_0_1.OnClick(arg_2_0)
	...
	if var_1.getRawData(var_2_0) then
		...
		var_2_2(var_2_1, var_1_10004, var_1_10005.GUILD)
	else
		...
		local var_2_5 = var_1_10004.GO_SCENE

		SCENE = var_1_10005

		var_2_4(var_2_3, var_2_5, var_1_10005.NEWGUILD)
	end
...
function var_0_1.Flush(arg_3_0, arg_3_1)
	...
	local var_3_2 = var_1_10003.SystemOpenMgr.GetInstance()
