...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_7
	Button = var_1_10009
	arg_1_0.btn = var_1_2(var_1_1, var_7(var_1_10009))
	...
	typeof = var_7
	Text = var_1_10009
	arg_1_0.empty = var_1_4(var_1_3, var_7(var_1_10009))
...
function var_0_1.RegisterEvent(arg_2_0, arg_2_1)
	...
	var_2_1(var_2_0, var_1_10005.REMOVE_LAYERS, function(arg_3_0, arg_3_1)
	...
	var_2_3(var_2_2, var_5.ANY_CHAT_MSG_UPDATE, function(arg_4_0)
	...
	var_2(var_2_8, var_2_9, var_2_10, var_1_10007)
	...
	var_2(var_2_11, var_2_12, var_2_13, var_1_10007)
...
function var_0_1.GoChatView(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10004.OPEN_CHATVIEW)
...
function var_0_1.SwitchState(arg_9_0)
	...
	i18n = var_1_10007
	var_9_4.content = var_1_10007(var_9_1)
	...
	function var_9_4.onYes()
		...
		HIDE_CHAT_FLAG = var_2_10003

		var_10_1(var_2_10003, var_10_0)
		...
		HIDE_CHAT_FLAG = var_4
		var_10_2.hideChatFlag = var_10_3(var_4)
...
function var_0_1.InstantiateMsgTpl(arg_17_0, arg_17_1)
	for iter_17_0 = #arg_17_0.items + 1, arg_17_1 do
		...
		var_1_10008.insert(arg_17_0.items, var_1_10007)
	end
...
function var_0_1.UpdateMessage(arg_19_0, arg_19_1, arg_19_2)
	...
	var_19_1.sprite = var_1_10004(var_19_2, var_1_10007.GetChannelSprite(arg_19_2.type) .. "_1920")
	findTF = var_4
	...
	if var_19_5 == var_19_3.ChannelPublic then
		...
		if arg_19_2.IsWorldBossNotify(var_19_6) then
			var_19_4.supportRichText = true

			local var_19_7 = arg_19_2.args.playerName
			local var_19_8 = arg_19_2.args.bossName

			GetPerceptualSize = var_19_6

			local var_19_9 = var_19_6(var_19_7 .. var_19_8) - 18
			local var_19_10

			if 0 < var_19_9 then
				GetPerceptualSize = var_19_10
				var_19_10 = var_19_10(var_19_8) - var_19_9
				shortenString = var_10
				var_19_8 = var_10(var_19_8, var_19_10)
			end

			i18n = var_19_10
			var_19_4.text = var_19_10("ad_4", arg_19_2.args.supportType, var_19_7, var_19_8, arg_19_2.args.level)
		else
...
function var_0_1.MatchEmoji(arg_20_0, arg_20_1, arg_20_2)
	...
	for iter_20_0 in var_20_3(var_20_4, var_1_10009.EmojiIconCodeMatch) do
		table = var_1_10011
		...
		if var_1_10011(var_1_10013, var_1_10014(iter_20_0)) then
			var_20_2 = true
			pg = var_1_10011
	...
	if not arg_20_2.emojiId then
		if var_20_2 then
			...
			return (var_20_5(var_20_6, iter_20_0.EmojiIconCodeMatch, function(arg_21_0)
				table = var_2_10001
				...
				local var_21_1 = var_2_10003.emoji_small_template.all

				tonumber = var_2_10004

				if var_21_0(var_21_1, var_2_10004(arg_21_0)) then
					string = var_1
