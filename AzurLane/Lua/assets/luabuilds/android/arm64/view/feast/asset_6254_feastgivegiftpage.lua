...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.nameTxt = var_2_6(var_2_5, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.dialogueTxt = var_2_9(var_2_8, var_4(var_1_10006))
	...
	arg_2_0.typer = var_2_12(var_2_11, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.tipTr = var_2_17(var_2_16, var_4(var_1_10006))
...
function var_0_1.BindEvents(arg_3_0)
	...
	arg_3_0.eventId = var_3_1(var_3_0, var_1_10004.ON_GOT_GIFT, function(arg_4_0, arg_4_1)
	...
	if arg_6_0.feastShip then
		...
		var_2({
			...
			function(arg_10_0)
				...
				var_10_1(var_10_0, var_2_10004.ON_ACHIEVE, arg_6_1, arg_10_0)
			...
			function(arg_11_0)
				...
				local var_11_2 = var_2_10002.NewStoryMgr.GetInstance()
			...
			var_12_1(var_12_0, var_3.ON_BACK_FEAST)
...
local function var_0_2(arg_23_0, arg_23_1)
	...
	return (var_1_10004.ScreenToLocal(var_23_1, arg_23_1, var_23_0))
end
...
function var_0_1.LoadChar(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_1 = var_1_10004.GetInstance()

	var_4.GetPrefab(var_24_1, "feastChar/" .. var_24_0, var_24_0, true, function(arg_25_0)
		if arg_24_0.exited then
			PoolMgr = var_1

			local var_25_0 = var_1.GetInstance()

			var_1.ReturnPrefab(var_25_0, "feastChar/" .. var_24_0, var_24_0, arg_25_0)
		...
		Vector3 = var_2_10002
		var_25_2.localScale = var_2_10002(1, 1, 0)
		...
		local var_25_6 = var_25_5(var_25_4, var_4(var_6))
...
function var_0_1.LoadItem(arg_26_0, arg_26_1, arg_26_2)
	...
	var_1_10004("FeastCharGift/" .. var_26_0, function(arg_27_0)
		...
		local var_27_2 = var_27_1(var_27_0, var_2_10004(var_2_10006))
...
function var_0_1.UpdateGiftState(arg_29_0, arg_29_1, arg_29_2)
	...
	var_3({
		function(arg_30_0)
			...
			var_30_1(var_30_0, var_4.GetDialogueForGift(var_30_2), 4, arg_30_0)
...
function var_0_1.AddGiftEvent(arg_36_0)
	...
	local var_36_2 = var_1_10002(var_36_1, var_1_10005(var_1_10007))
	local var_36_3
	...
	var_36_2:AddDragEndFunc(function(arg_39_0, arg_39_1)
		...
		local var_39_2 = var_2_10004(var_36_0)
...
function var_0_1.ClearGiftEvent(arg_40_0)
	...
	local var_40_1 = var_1_10002(var_40_0, var_1_10005(var_1_10007))
...
function var_0_1.Send(arg_41_0)
	...
	var_41_2(var_41_1, var_1_10005.GIVE_GIFT, var_41_0.tid)
