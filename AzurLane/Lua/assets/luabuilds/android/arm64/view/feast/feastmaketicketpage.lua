...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.envelopesAnim = var_2_4(var_2_3, var_4(var_1_10006))
	...
	local var_2_16 = var_3.Find(var_2_15, "tip/Text")

	i18n = var_4

	var_1(var_2_16, var_4("feast_label_make_ticket_tip"))

	setText = var_1

	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_3.Find(var_2_17, "tip/label")

	i18n = var_4

	var_1(var_2_18, var_4("feast_label_make_ticket_click_tip"))

	setText = var_1

	local var_2_19 = arg_2_0._tf
	local var_2_20 = var_3.Find(var_2_19, "failed_tip/Text")

	i18n = var_4

	var_1(var_2_20, var_4("feast_label_make_ticket_failed_tip"))
...
function var_0_1.OnInit(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10004.ON_MAKE_TICKET, function(arg_4_0, arg_4_1)
...
function var_0_1.OnMakeTicket(arg_5_0, arg_5_1)
	if arg_5_0.feastShip and arg_5_0.feastShip.id == arg_5_1 then
		...
		Vector3 = var_1_10003
		var_5_0.localScale = var_1_10003.zero
		...
		var_2.SetActionCallBack(var_5_2, function(arg_6_0)
			if arg_6_0 == "finish" then
				...
				var_6_0(var_6_1, var_2_10004(1, 1, 1), 0.3)
				...
				var_6_2(var_6_3, var_4(1, 1, 1), 0.3)
...
function var_0_1.Show(arg_7_0, arg_7_1)
	...
	var_2({
		function(arg_8_0)
			...
			var_8_1(var_8_0, var_4.GetPrefab(var_8_2), arg_8_0)
...
function var_0_1.LoadPuzzleRes(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_4 = var_1_10008(var_1_10010)

	UnityEngine = var_1_10009

	var_10_1(var_10_0, var_10_2, var_10_3, var_10_4, var_1_10009.Events.UnityAction_UnityEngine_Object(function(arg_11_0)
		...
		var_11_0.puzzleGo = var_11_1(var_11_2, var_5.Find(var_11_3, "container"))
...
local function var_0_2(arg_13_0, arg_13_1)
	...
	return (var_1_10004.ScreenToLocal(var_13_1, arg_13_1, var_13_0))
end
...
function var_0_1.InitPuzzle(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in var_2(arg_14_0.items) do
		...
		local var_14_2 = var_14_1(var_14_0, var_1_10010(var_1_10012))

		Vector3 = var_1_10008
		var_1_10008 = var_1_10008.zero

		var_14_2:AddBeginDragFunc(function(arg_15_0, arg_15_1)
			arg_14_0.dragging = true
			var_1_10008 = iter_14_1.tr.localPosition
		...
		var_14_2:AddDragEndFunc(function(arg_17_0, arg_17_1)
			...
			if var_2.FindMatcher(var_17_0, iter_14_1) then
				...
				var_3.Merge(var_17_1, iter_14_1, var_2, var_1_10008)
				...
				iter_14_1.tr.localPosition = var_1_10008
			end

			return
		end)
		var_14_2:AddPointUpFunc(function(arg_18_0, arg_18_1)
...
function var_0_1.Merge(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	if arg_23_2.level < arg_23_1.level then
		...
		var_23_0(var_23_1, var_7.Find(var_23_2, "slot"))

		var_23_0 = arg_23_2.tr
		Vector3 = var_5
		var_23_0.localPosition = var_5.zero
		...
		var_23_0(var_23_3, var_7.Find(var_23_4, "slot"))

		local var_23_5 = arg_23_1.tr

		Vector3 = var_5
		var_23_5.localPosition = var_5.zero
...
local function var_0_3(arg_24_0, arg_24_1)
	...
	getBounds = var_1_10003

	local var_24_1 = var_1_10003(arg_24_1.tr)
...
function var_0_1.OnPass(arg_27_0)
	...
	var_27_1(var_27_0, var_4.MAKE_TICKET, arg_27_0.feastShip.tid)
...
function var_0_1.RegisterEvent(arg_28_0, arg_28_1)
	...
	var_1_10002(var_28_0, var_28_1, var_28_2, var_1_10007)
	...
	local function var_28_5()
		...
		FeastScene = var_2_10003

		var_30_2(var_30_1, var_2_10003.ON_SKIP_GIVE_GIFT, arg_28_0.feastShip)
	...
	var_1_10002(var_28_3, var_28_4, var_28_5, var_1_10007)
	...
	local function var_28_8()
		...
		var_31_2.type = var_2_10004
		pg = var_2_10004
		var_31_2.helps = var_2_10004.gametip.feast_make_invitation_tip.tip
	...
	var_1_10002(var_28_6, var_28_7, var_28_8, var_1_10007)
	...
	local function var_28_11()
		...
		var_32_1(var_32_0, var_2_10003.ON_HOME)
	...
	var_1_10002(var_28_9, var_28_10, var_28_11, var_1_10007)
...
function var_0_1.ShowDesc(arg_33_0, arg_33_1)
	...
	Vector3 = var_1_10003
	var_33_1.localPosition = var_1_10003(0, 100, 0)
	...
	var_33_2(var_33_3, var_33_4, var_33_5, var_7)
...
function var_0_1.ClearEvent(arg_37_0, arg_37_1)
	...
	local var_37_2 = var_37_1(var_37_0, var_1_10005(var_1_10007))
	...
	local var_37_5 = var_37_4(var_37_3, var_6(var_1_10008))
	local var_37_6 = var_3.ToTable(var_37_5)

	ipairs = var_37_0

	for iter_37_0, iter_37_1 in var_37_0(var_37_6) do
