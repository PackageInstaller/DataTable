...
function var_0_1.init(arg_4_0)
	...
	arg_4_0.mainCG = var_1_10001(var_4_0, var_1_10004(var_1_10006))
	...
	local var_4_10 = var_3.Find(var_4_9, "main/buffs")
	local var_4_11 = arg_4_0._tf

	arg_4_0.buffUIlist = var_4_8(var_4_10, var_4.Find(var_4_11, "main/buffs/tpl"))
	setText = var_1
	...
	var_1(var_4_13, var_4("feast_invitation_btn_label"))

	setText = var_1

	local var_4_14 = arg_4_0.taskBtn
	local var_4_15 = var_3.Find(var_4_14, "Text")

	i18n = var_4

	var_1(var_4_15, var_4("feast_task_btn_label"))
...
function var_0_1.OnCourtYardLoaded(arg_6_0)
	...
	local function var_6_11()
		...
		pg = var_2_10004
		var_10_2.helps = var_2_10004.gametip.feast_tip.tip
	...
	var_1(var_6_9, var_6_10, var_6_11, var_1_10006)
	...
	var_1(var_6_12, var_6_13, var_6_14, var_1_10006)
	...
	var_6_18(var_6_17, var_4.ON_ACT_UPDATE, function()
	...
	var_6_20(var_6_19, var_4.ON_GOT_GIFT, function()
	...
	var_6_22(var_6_21, var_4.ON_GOT_TICKET, function()
	...
	var_6_24(var_6_23, var_4.GO_INTERACTION, function()
	...
	var_6_26(var_6_25, var_4.GO_INVITATION, function()
		if arg_6_0.taskPage then
	...
	var_6_28(var_6_27, var_4.ON_ACT_UPDATE, function()
	...
	var_6_30(var_6_29, var_4.ON_BACK_FEAST, function()
	...
	var_2.make(var_20_2, function(arg_21_0, arg_21_1, arg_21_2)
		...
		if arg_21_0 == var_2_10003.EventUpdate then
			...
			local function var_21_3()
				...
				local var_22_2 = var_3_10003.ON_DROP
				local var_22_3 = {}

				DROP_TYPE_BUFF = var_3_10005
				var_22_3.type = var_3_10005
...
function var_0_1.PlayEnterStory(arg_23_0)
	...
	local var_23_2 = var_23_1(var_23_0, var_1_10004.ACTIVITY_TYPE_FEAST)

	if var_1.getConfig(var_23_2, "config_client")[6] and var_3 ~= "" then
		pg = var_23_2

		local var_23_3 = var_23_2.NewStoryMgr.GetInstance()
...
function var_0_1.UpdateTips(arg_24_0)
	...
	var_1_10001(var_24_0, var_4.ShouldTipInvitation(var_24_1))
	...
	local var_24_3 = var_4(var_24_1)

	var_1_10001(var_24_2, var_4.ShouldTipTask(var_24_3))
...
function var_0_1.SetUpCourtYard(arg_25_0)
	...
	var_25_2(var_25_1, var_1_10004.SET_UP, 1)
