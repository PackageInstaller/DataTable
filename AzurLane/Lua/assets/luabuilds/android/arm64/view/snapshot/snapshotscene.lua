...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_1_10003.UIMgr.GetInstance().OverlayEffect, false)
	...
	typeof = var_4
	WebCam = var_1_10006
	arg_2_0.webcam = var_2_27(var_2_26, var_4(var_1_10006))
	...
	typeof = var_4
	YSTool = var_1_10006
	arg_2_0.ysScreenShoter = var_2_29(var_2_28, var_4(var_1_10006.YSScreenShoter))
...
function var_0_1.saveVideo(arg_8_0)
	...
	i18n = var_1_10005
	var_8_2.content = var_1_10005("word_save_video")
...
function var_0_1.didEnter(arg_10_0)
	...
	var_1_10001(arg_10_0, arg_10_0.takeBtn, function()
		if arg_10_0.state == var_0_1.STATE_TAKE_PHOTO then
			...
			local function var_13_0(arg_14_0)
				...
				var_3_10001(var_14_0 .. var_3_10004(arg_14_0))
			...
			local function var_13_1(arg_15_0)
				...
				local var_15_1 = var_3_10003.width

				Screen = var_3_10004

				local var_15_2 = var_15_0(var_15_1, var_3_10004.height)

				Tex2DExtension = var_3_10002

				var_3_10002.LoadImage(var_15_2, arg_15_0)
		...
		elseif arg_10_0.state == var_0_1.STATE_TAKE_VIDEO then
			...
			local function var_13_4()
				...
				var_17_1(var_17_0, var_3.Action(function()
					...
					var_18_1.recordFilePath = var_4_10001.RecordTool.GenRecordFilePath()
			...
			if not var_2.GetInt("hadShowForVideoTip") or var_2 <= 0 then
				...
				i18n = var_4
				var_13_7.text = var_4("word_take_video_tip")
				onButton = var_13_7
	...
	local function var_10_0()
		...
		var_23_1(var_2_10002(arg_10_0.modePnlTF), 56, 0.1)
	...
	var_1_10002(arg_10_0, arg_10_0.takePhotoBtn, var_10_0)

	onButton = var_1_10002

	var_1_10002(arg_10_0, arg_10_0.takeVideoBtn, function()
		CheckPermissionGranted = var_2_10000
		ANDROID_RECORD_AUDIO_PERMISSION = var_2_10002

		if var_2_10000(var_2_10002) then
			CheckPermissionGranted = var_0
			ANDROID_WRITE_EXTERNAL_PERMISSION = var_2_10002

			if var_0(var_2_10002) then
		...
		do
			...
			i18n = var_2_10004
			var_24_3.content = var_2_10004("apply_permission_record_audio_tip1")
			...
			function var_24_3.onYes()
				...
				ANDROID_RECORD_AUDIO_PERMISSION = var_3_10003
				var_25_0[1] = var_3_10003
				ANDROID_WRITE_EXTERNAL_PERMISSION = var_3_10003
				var_25_0[2] = var_3_10003
	...
	var_2(arg_10_0, arg_10_0.stopRecBtn, function()
		local function var_26_0(arg_27_0)
			if arg_27_0 then
				...
				if var_3_10001 == var_3_10002 then
					...
					i18n = var_3_10005
					var_27_2.content = var_3_10005("word_save_video")
					...
					function var_27_2.onYes()
						...
						var_4_10000.MediaTool.SaveVideoToAlbum(arg_10_0.recordFilePath, function(arg_30_0, arg_30_1)
							if arg_30_0 then
								...
								var_30_1(var_30_0, var_5_10005("word_save_ok"))
		...
		if not var_26_1(var_2_10003(arg_10_0.stopRecBtn)) then
			LeanTween = var_1
			...
			var_26_3(var_26_2, var_4.Action(function()
				setActive = var_3_10000
...
function var_0_1.changeToTakeVideo(arg_39_0)
	...
	var_39_0(var_1_10003(arg_39_0.modePnlTF), -56, 0.1)
...
function var_0_1.willExit(arg_40_0)
	...
	var_2(var_4.UIMgr.GetInstance().OverlayEffect, var_40_3)
...
function var_0_1.updateSkin(arg_48_0)
	if arg_48_0.showType == var_0_1.SHOW_LIVE2D then
		...
		if var_1.AssetExist(var_48_0, "live2d/" .. arg_48_0.paintSkin) then
			...
			local var_48_3 = var_48_2(var_48_1, var_1_10004(var_1_10006))
			local var_48_4 = 0
			local var_48_5 = 0
			...
			if arg_48_0.showType == var_0_1.SHOW_LIVE2D then
				...
				arg_48_0.live2dRequestId = var_4.GetLive2DModelAsync(var_48_12, arg_48_0.paintSkin, function(arg_49_0)
					...
					LayerMask = var_2_10004

					var_49_0(var_49_1, var_2_10004.NameToLayer("UI"))
					...
					if arg_48_0.skin.live2d_offset then
						var_49_3 = #arg_48_0.skin.live2d_offset

						if 4 <= var_49_3 then
							Vector3 = var_49_3
							var_1.localScale = var_49_3(arg_48_0.skin.live2d_offset[4], arg_48_0.skin.live2d_offset[4], arg_48_0.skin.live2d_offset[4])
					...
					Vector3 = var_49_3
					var_1.localScale = var_49_3(52, 52, 52)

					::label_49_0::

					Vector3 = var_49_3
					var_1.localPosition = var_49_3(arg_48_0.skin.live2d_offset[1] + 500, arg_48_0.skin.live2d_offset[2], arg_48_0.skin.live2d_offset[3])

					local var_49_4 = arg_49_0
					local var_49_5 = arg_49_0.GetComponent

					typeof = var_5
					Live2dChar = var_2_10007

					local var_49_6 = var_49_5(var_49_4, var_5(var_2_10007))

					pg = var_49_1

					local var_49_7 = var_49_1.AssistantInfo.action2Id.idle

					var_49_6:SetAction(var_49_7)

					function var_49_6.FinishAction(arg_50_0)
					...
					local var_49_8 = var_4.SetL2dSortingLayer
					local var_49_9 = arg_49_0

					LayerWeightConst = var_7

					var_49_8(var_49_9, var_7.L2D_DEFAULT_LAYER)

					arg_48_0.live2dCom = var_49_6
					arg_48_0.live2dCom.name = arg_48_0.paintSkin

					local var_49_10 = arg_48_0

					pg = var_5
					var_49_10.playActionId = var_5.AssistantInfo.action2Id.idle

					local var_49_11 = arg_48_0

					pg = var_5
					var_49_11.selectedID = var_5.AssistantInfo.action2Id.idle

					local var_49_12 = arg_48_0
					local var_49_13 = arg_49_0
					local var_49_14 = arg_49_0.GetComponent

					typeof = var_2_10008
					Animator = var_2_10010
					var_49_12.live2dAnimator = var_49_14(var_49_13, var_2_10008(var_2_10010))

					local var_49_15 = arg_48_0.live2dCom

					if var_4.GetCubismParameter(var_49_15, "Paramring") then
						if arg_48_0.contextData and arg_48_0.contextData.propose then
							local var_49_16 = arg_48_0.live2dCom
							local var_49_17 = var_5.AddParameterValue
							local var_49_18 = var_4
							local var_49_19 = 1

							CubismParameterBlendMode = var_2_10010

							var_49_17(var_49_16, var_49_18, var_49_19, var_2_10010.Override)
						else
							local var_49_20 = arg_48_0.live2dCom
							local var_49_21 = var_5.AddParameterValue
							local var_49_22 = var_4
							local var_49_23 = 0

							CubismParameterBlendMode = var_2_10010

							var_49_21(var_49_20, var_49_22, var_49_23, var_2_10010.Override)
						end
					end

					local var_49_24 = arg_48_0

					var_5.ResetL2dPanel(var_49_24)

					local var_49_25 = arg_48_0

					var_5.setLive2dAnimsPanelState(var_49_25, true)
					...
					local var_49_26 = var_5.UIMgr.GetInstance()

					var_5.LoadingOff(var_49_26)

					local var_49_27 = arg_48_0.skin.lip_sync_gain
					local var_49_28 = arg_48_0.skin.lip_smoothing

					if var_49_27 and var_49_27 ~= 0 then
						local var_49_29 = arg_48_0.live2d
						local var_49_30 = var_7.GetChild(var_49_29, 0)

						var_7.GetComponent(var_49_30, "CubismCriSrcMouthInput").Gain = var_49_27
					end

					if var_49_28 and var_49_28 ~= 0 then
						local var_49_31 = arg_48_0.live2d
						local var_49_32 = var_7.GetChild(var_49_31, 0)

						var_7.GetComponent(var_49_32, "CubismCriSrcMouthInput").Smoothing = var_49_28
					end
			...
			elseif arg_48_0.showType == var_0_1.SHOW_SPINE then
				...
				var_4.Load(var_48_14, true, function(arg_51_0)
					...
					var_51_1(var_51_0, var_4(0.5, 0.5, 0.5))
...
function var_0_1.onInitItem(arg_58_0, arg_58_1)
	...
	local function var_58_3()
		...
		if var_0.GetID(var_59_2) ~= 6 then
			local var_59_3 = var_58_0

			if var_0.GetID(var_59_3) == 7 then
				local var_59_4 = arg_58_0

				Time = var_1
				var_59_4.l2dClickCD = var_1.fixedTime
			end

			local var_59_5 = arg_58_0
			local var_59_6 = var_58_0

			var_59_5.selectedID = var_1.GetID(var_59_6)

			local var_59_7 = arg_58_0

			var_0.updateSelectedItem(var_59_7)

			local var_59_8 = arg_58_0

			var_0.setL2dAction(var_59_8, arg_58_0.selectedID)
	...
	var_1_10003(var_58_1, var_58_2, var_58_3, var_1_10008)
...
function var_0_1.setL2dAction(arg_60_0, arg_60_1)
	...
	if arg_60_0.live2dCom and arg_60_1 then
		...
		if arg_60_1 == var_2.AssistantInfo.action2Id.idle then
			local var_60_0 = arg_60_0.live2dCom

			var_2.SetAction(var_60_0, arg_60_1)
		else
			local var_60_1 = arg_60_0.playActionId

			pg = var_1_10003

			if var_60_1 == var_1_10003.AssistantInfo.action2Id.idle then
				local var_60_2 = arg_60_0.live2dCom

				var_2.SetAction(var_60_2, arg_60_1)
			elseif arg_60_0.playActionId == arg_60_1 then
				local var_60_3 = arg_60_0.live2dCom

				var_2.SetAction(var_60_3, arg_60_1)
			end
		end
...
function var_0_1.updateUIDirection(arg_64_0)
	if arg_64_0.isVertical then
		...
		var_1_10003(var_1_10005(arg_64_0.backBtnImg), var_64_0, var_64_1)

		LeanTween = var_1_10003
		var_1_10003 = var_1_10003.rotateZ
		go = var_1_10005

		var_1_10003(var_1_10005(arg_64_0.selectCharBtnImg), var_64_0, var_64_1)

		LeanTween = var_1_10003
		var_1_10003 = var_1_10003.rotateZ
		go = var_1_10005

		var_1_10003(var_1_10005(arg_64_0.switchCamBtnImg), var_64_0, var_64_1)

		LeanTween = var_1_10003
		var_1_10003 = var_1_10003.rotateZ
		go = var_1_10005

		var_1_10003(var_1_10005(arg_64_0.l2dBtnImg), var_64_0, var_64_1)

		LeanTween = var_1_10003
		var_1_10003 = var_1_10003.rotateZ
		go = var_1_10005

		var_1_10003(var_1_10005(arg_64_0.l2dStopBtnImg), var_64_0, var_64_1)

		LeanTween = var_1_10003
		var_1_10003 = var_1_10003.rotateZ
		go = var_1_10005

		var_1_10003(var_1_10005(arg_64_0.l2dPlayBtnImg), var_64_0, var_64_1)

		LeanTween = var_1_10003
		var_1_10003 = var_1_10003.rotateZ
		go = var_1_10005

		var_1_10003(var_1_10005(arg_64_0.l2d2PaintBtnImg), var_64_0, var_64_1)
		...
		var_1_10003(var_1_10005(arg_64_0.paint), var_64_0, var_64_1)

		var_1_10005 = arg_64_0

		arg_64_0.updateListItemRotate(var_1_10005, var_64_0, var_64_1)
	else
		...
		var_64_4(var_1_10005(arg_64_0.backBtnImg), var_64_2, var_64_3)
		...
		var_64_5(var_5(arg_64_0.selectCharBtnImg), var_64_2, var_64_3)
		...
		var_64_6(var_5(arg_64_0.switchCamBtnImg), var_64_2, var_64_3)
		...
		var_64_7(var_5(arg_64_0.l2dBtnImg), var_64_2, var_64_3)
		...
		var_64_8(var_5(arg_64_0.l2dStopBtnImg), var_64_2, var_64_3)
		...
		var_64_9(var_5(arg_64_0.l2dPlayBtnImg), var_64_2, var_64_3)
		...
		var_64_10(var_5(arg_64_0.l2d2PaintBtnImg), var_64_2, var_64_3)
		...
		var_64_11(var_5(arg_64_0.paint), var_64_2, var_64_3)
...
function var_0_1.SetDummyForIOS(arg_67_0, arg_67_1)
	...
	local var_67_3 = var_67_2(var_67_1, var_1_10005(var_1_10007))
	...
	if arg_67_1 then
		...
		local var_67_6 = var_1_10006.UIMgr.GetInstance()

		var_67_5(var_67_4, var_6.GetMainCamera(var_67_6).transform)

		local var_67_7 = arg_67_0.dummy

		Vector3 = var_67_1
		var_67_7.localPosition = var_67_1(0, 0, 3)

		local var_67_8 = arg_67_0.dummy

		Vector3 = var_67_1
		var_67_8.localRotation = var_67_1(0, 0, 0)

		local var_67_9 = arg_67_0.dummy

		Vector3 = var_67_1
		var_67_9.localScale = var_67_1(1, 1, 1)
		setActive = var_67_9
		...
		Vector3 = var_67_1
		var_67_11.localPosition = var_67_1(0, 0, 0)
