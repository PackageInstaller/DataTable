...
function var_0_1.GetShareSkins(arg_2_0)
	...
	return (var_1_10002.map(var_2_1, function(arg_3_0)
		pg = var_2_10001
...
function var_0_1.didEnter(arg_8_0)
	...
	local var_8_0 = var_3(arg_8_0._tf, "select_skin/title/Text")

	i18n = var_4

	var_1(var_8_0, var_4("dorm3d_clothing_choose"))
...
function var_0_1.initSelectSkinPanel(arg_9_0)
	...
	var_9_0(arg_9_0, var_9_1, function()
	...
	var_9_0(arg_9_0, var_9_3, function()
	...
	var_9_0(var_9_4, var_9_5, var_9_6, var_1_10008)
...
function var_0_1.Flush(arg_14_0, arg_14_1)
	...
	for iter_14_1 = #arg_14_1, arg_14_0.skinContainer.childCount - 1 do
		...
		var_1_10006(var_8.GetChild(var_14_0, iter_14_1), false)
	end

	getProxy = var_2
	ShipSkinProxy = var_4

	local var_14_1 = var_2(var_4)
	...
	for iter_14_2, iter_14_3 in var_4(arg_14_1) do
		...
		if not arg_14_0.skinCardMap[var_14_4] then
			ShipSkinCard = var_14_3
			var_14_5 = var_14_3.New(var_14_4.gameObject)
		...
		if var_11.getRemouldSkinId(var_14_6) == iter_14_3.id then
			var_14_6 = arg_14_0.shipVO
			var_14_7 = var_11.isRemoulded(var_14_6)
		else
			var_14_7 = false
		end
		...
		local var_14_8 = arg_14_0.shipVO
		local var_14_9

		if not var_12.proposeSkinOwned(var_14_8, iter_14_3) then
			table = var_14_9

			if not var_14_9.contains(arg_14_0.skinList, iter_14_3.id) and not var_14_7 then
				::label_14_0::

				var_14_9 = iter_14_3.skin_type
				ShipSkin = var_14_6
				var_14_9 = var_14_9 == var_14_6.SKIN_TYPE_OLD or var_14_1:hasSkin(iter_14_3.id)
			end
		end

		var_14_5:updateData(arg_14_0.shipVO, iter_14_3, var_14_9)

		local var_14_10 = arg_14_0.shipVO
		local var_14_11 = var_13.useSkin(var_14_10, iter_14_3.id)

		var_14_5:updateUsing(var_14_11)

		removeOnButton = var_14

		var_14(var_14_4)

		local var_14_12 = arg_14_0.shipVO
		local var_14_14

		if var_14.getRemouldSkinId(var_14_12) == iter_14_3.id then
			local var_14_13 = arg_14_0.shipVO

			var_14_14 = var_14.isRemoulded(var_14_13)
		else
			var_14_14 = false
		end
		...
		local var_14_15 = arg_14_0.shipVO

		if not var_15.proposeSkinOwned(var_14_15, iter_14_3) then
			table = var_15

			local var_14_16

			if var_15.contains(arg_14_0.skinList, iter_14_3.id) or var_14_14 then
				var_14_16 = 1
			else
				var_14_16 = 0
			end

			local var_14_17 = iter_14_3.shop_id
			...
			if 0 < var_14_17 then
				...
				if not var_14_17.shop_template[iter_14_3.shop_id] then
					var_14_18 = nil
				end
				...
				if var_14_18 then
					...
					local var_14_19 = var_14_20.TimeMgr.GetInstance()

					var_14_20 = not var_14_20.inTime(var_14_19, var_14_18.time)
				end

				local var_14_21 = iter_14_3.id
				local var_14_22 = arg_14_0.shipVO
				local var_14_23 = var_14_21 == var_19.getSkinId(var_14_22)
				local var_14_24 = iter_14_3.id
				local var_14_25 = arg_14_0.shipVO
				local var_14_27

				if var_14_24 ~= var_20.getConfig(var_14_25, "skin_id") and not (var_14_16 >= 1) then
					local var_14_26 = iter_14_3.skin_type

					ShipSkin = var_20

					if var_14_26 ~= var_20.SKIN_TYPE_OLD then
						var_14_22 = var_14_1
						var_14_27 = var_14_1.hasSkin(var_14_22, iter_14_3.id)
				...
				getProxy = var_20
				ShipSkinProxy = var_14_25

				local var_14_28 = var_20(var_14_25)
				local var_14_29 = var_20.InForbiddenSkinListAndShow(var_14_28, iter_14_3.id)

				onToggle = var_14_22

				local var_14_30 = arg_14_0
				local var_14_31 = var_14_5.hideObjToggleTF

				local function var_14_32(arg_15_0)
					...
					local var_15_3 = var_4.UPDATE_SKINCONFIG
					local var_15_4 = arg_14_0.shipVO

					var_15_2(var_15_1, var_15_3, var_5.getSkinId(var_15_4))
				...
				var_14_22(var_14_30, var_14_31, var_14_32, var_1_10026)

				onButton = var_14_22

				local var_14_33 = arg_14_0
				local var_14_34 = var_14_5.changeSkinTF

				local function var_14_35(arg_16_0)
					...
					local var_16_1 = var_2_10002.SetStoreChangeSkinId
					local var_16_2 = var_16_0
					local var_16_3 = arg_14_0.shipVO

					var_16_1(var_16_2, var_5.GetShipPhantomMark(var_16_3))

					if var_14_11 then
						local var_16_4 = arg_14_0
						local var_16_5 = var_2.emit

						SwitchSkinMediator = var_5

						local var_16_6 = var_5.CHANGE_SKIN
						local var_16_7 = arg_14_0.shipVO

						var_16_5(var_16_4, var_16_6, var_6.GetShipPhantomMark(var_16_7), var_16_0)
						...
						var_16_9(var_16_8, var_16_10, var_6.GetShipPhantomMark(var_16_11))
					end
				...
				var_14_22(var_14_33, var_14_34, var_14_35, var_1_10026)

				onButton = var_14_22

				var_14_22(arg_14_0, var_14_4, function()
					if var_14_23 then
						...
						if var_14_27 then
							...
							var_2_10004 = var_2_10004.GetShipPhantomMark(var_17_4)

							local var_17_5 = iter_14_3.id
							local var_17_6 = arg_14_0.shipVO

							var_17_2(var_17_1, var_17_3, var_2_10004, var_17_5 == var_6.getConfig(var_17_6, "skin_id") and 0 or iter_14_3.id)

							local var_17_7 = arg_14_0

							var_0.back(var_17_7)
						elseif var_14_18 then
							local var_17_9

							if var_14_20 or var_14_29 then
								pg = var_17_9
								...
								local var_17_11 = {
									shop_id = var_14_18.id
								}

								Goods = var_3

								local var_17_12 = var_17_10(var_17_11, var_3.TYPE_SKIN)

								if var_0.isDisCount(var_17_12) and var_0:IsItemDiscountType() then
									local var_17_13 = arg_14_0
									local var_17_14 = var_1.emit

									SwitchSkinMediator = var_2_10004

									var_17_14(var_17_13, var_2_10004.BUY_ITEM_BY_ACT, var_14_18.id, 1)
								else
									...
									local var_17_17 = var_17_11("text_buy_fashion_tip", var_17_16, iter_14_3.name)

									pg = var_17_15

									local var_17_18 = var_17_15.MsgboxMgr.GetInstance()
									...
									var_3.ShowMsgBox(var_17_18, {
										...
										onYes = function()
											...
											SwitchSkinMediator = var_3_10003

											var_18_1(var_18_0, var_3_10003.BUY_ITEM, var_14_18.id, 1)
