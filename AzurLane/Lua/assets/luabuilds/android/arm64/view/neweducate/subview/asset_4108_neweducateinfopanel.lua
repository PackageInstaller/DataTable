...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_12 = var_3.Find(var_2_11, "personality/personality_title/Text")

	i18n = var_4

	var_1(var_2_12, var_4("child2_personality_title"))
	...
	local var_2_16 = var_3.Find(var_2_15, "attrs/attr_title/Text")

	i18n = var_4

	var_1(var_2_16, var_4("child2_attr_title"))
	...
	local var_2_21 = var_4.Find(var_2_20, "talent/talent_title/Text")

	i18n = var_5

	var_2(var_2_21, var_5("child2_talent_title"))

	local var_2_22 = arg_2_0.contnetTF
	local var_2_23 = var_2.Find(var_2_22, "talent/talents/content")

	UIItemList = var_2_17
	arg_2_0.talentUIList = var_2_17.New(var_2_23, var_2_23:Find("tpl"))
	...
	local var_2_26 = var_5.Find(var_2_25, "status_title/Text")

	i18n = var_6

	var_3(var_2_26, var_6("child2_status_title"))

	local var_2_27 = arg_2_0.statusTF
	local var_2_28 = var_3.Find(var_2_27, "status/content/content")

	UIItemList = var_2_22
	arg_2_0.statusUIList = var_2_22.New(var_2_28, var_2_28:Find("tpl"))
...
function var_0_1.OnInit(arg_4_0)
	...
	var_2(var_4_2, var_5.Find(var_4_3, "slider/handle/Image"), true)
	...
	var_3(var_4_7, var_4_8, var_4_9, var_8)
	...
	local var_4_15 = var_6.Find(var_4_14, "bg")
	...
	var_3(var_4_13, var_4_15, var_4_16, var_4_14)
...
function var_0_1.OnUpdateAttrItem(arg_17_0, arg_17_1, arg_17_2)
	...
	var_17_9, setImageColor = var_10.GetChild(var_17_8, arg_17_1), var_11
	Color = var_1_10014

	var_11(var_17_9, var_1_10014.NewHex(var_17_6))

	setImageColor = var_11

	local var_17_10 = arg_17_2:Find("rank")

	Color = var_14

	var_11(var_17_10, var_14.NewHex(var_17_7))

	setToggleEnabled = var_11

	var_11(arg_17_2, arg_17_0.isTarotChar)
	...
	if arg_17_0.isTarotChar then
		...
		local var_17_11 = arg_17_0.contextData.char
		local var_17_12 = var_11.GetBenefitData(var_17_11)
		local var_17_13 = var_11.GetDisplayPctByDrop
		local var_17_14 = {}

		NewEducateConst = var_16
		var_17_14.type = var_16.DROP_TYPE.ATTR
		var_17_14.id = var_17_0

		local var_17_15, var_17_16 = var_17_13(var_17_12, var_17_14)

		i18n = var_17_12

		local var_17_17 = var_17_12("child2_benefit_summary")
		local var_17_18 = var_17_15
		local var_17_19 = "%"
		local var_17_20 = "\n"

		i18n = var_1_10018

		local var_17_21 = var_17_17 .. var_17_18 .. var_17_19 .. var_17_20 .. var_1_10018("child2_benefit_summary2") .. var_17_16 .. "%"

		setText = var_17_18

		var_17_18(arg_17_2:Find("info/content/desc"), var_17_21)
	end
...
function var_0_1.OnUpdateTalentItem(arg_18_0, arg_18_1, arg_18_2)
	...
	if var_18_0 then
		...
		local var_18_1 = arg_18_2:Find("unlock/name")

		shortenString = var_7

		var_4(var_18_1, var_7(var_18_0:getConfig("name"), 5))
	...
	local var_18_2 = arg_18_0.talentRoundIds[arg_18_1 + 1]

	onButton = var_5

	local var_18_3 = arg_18_0
	local var_18_4 = arg_18_2
	local var_18_5 = arg_18_2.Find(var_18_4, "lock")
	...
	local function var_18_6()
		...
		var_19_1(var_19_0, var_2_10003("child2_talent_unlock_tip", var_18_2))
	...
	var_5(var_18_3, var_18_5, var_18_6, var_18_4)
	...
	var_5(var_18_7, var_8.Find(var_18_8, "status"), function(arg_20_0)
...
function var_0_1.OnUpdateStatusItem(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_4 = var_22_0.GetEndRound(var_22_3)
	local var_22_5 = arg_22_0.contextData.char
	local var_22_6 = var_22_4 - var_6.GetRoundData(var_22_5).round
	...
	if var_22_2 == -1 then
		...
		if not var_22_7("child2_status_time2") then
			i18n = var_22_7
			var_22_7 = var_22_7("child2_status_time1", var_22_6)
		end

		setText = var_22_3

		var_22_3(arg_22_2:Find("time/Text"), var_22_7)

		setText = var_22_3

		var_22_3(arg_22_2:Find("info/content/name"), var_22_0:getConfig("name"))

		setText = var_22_3

		var_22_3(arg_22_2:Find("info/content/desc"), var_22_0:getConfig("desc"))
...
function var_0_1.FlushAttrs(arg_24_0)
	...
	var_24_2(var_6.Find(var_24_6, "slider"), -var_24_1, var_24_1, var_24_5 - var_24_1)
	...
	var_24_2(var_24_7, var_7.abs(var_24_5 - var_24_1))

	local var_24_8 = var_24_3 == "tag1" and "26b1f3" or "ff6767"

	setTextColor = var_24_4

	local var_24_9 = arg_24_0.personalityValueTF

	Color = var_8

	var_24_4(var_24_9, var_8.NewHex(var_24_8))
...
function var_0_1.FlushTarot(arg_27_0)
	...
	if arg_27_0.tarotId then
		...
		var_1(var_27_1 .. var_4.child2_benefit_list[arg_27_0.tarotId].item_icon_little, arg_27_0.tarotIconTF)
	end
	...
	if arg_27_0.tarotId then
		...
		if not var_4.child2_benefit_list[arg_27_0.tarotId].name then
			var_27_3 = "EMPTY"
		end
		...
		var_1(var_27_7, var_4("child2_entry_summary") .. #arg_27_0.entries)
