...
function var_0_0.GetDropConfig(arg_7_0)
	...
	var_7_1[var_1_10005.DROP_TYPE.ATTR] = function()
		pg = var_2_10000
	...
	var_7_1[var_5.DROP_TYPE.RES] = function()
		pg = var_2_10000
	...
	NewEducateConst = var_5
	var_7_1[var_5.DROP_TYPE.POLAROID] = function()
		pg = var_2_10000
	...
	NewEducateConst = var_5
	var_7_1[var_5.DROP_TYPE.BUFF] = function()
		pg = var_2_10000
	...
	NewEducateConst = var_5
	var_7_1[var_5.DROP_TYPE.TAROT] = function()
		pg = var_2_10000
...
function var_0_0.GetDropIcon(arg_14_0)
	...
	var_14_2[var_1_10006.DROP_TYPE.TAROT] = function()
		return var_14_0.item_icon_little
	end

	return var_1_10002(var_14_1, var_14_2, function()
...
function var_0_0.UpdateVectorItem(arg_17_0, arg_17_1, arg_17_2)
	...
	if var_17_0 ~= var_1_10004.DROP_TYPE.ATTR then
		...
		if var_17_1 ~= var_4.DROP_TYPE.RES then
			pg = var_17_1
			var_1_10005 = var_17_1.TipsMgr.GetInstance()

			var_3.ShowTips(var_1_10005, "不支持的掉落展示for Vector,请检查配置！" .. arg_17_1.type)

			return
		end
	end

	local var_17_2 = arg_17_2 or ""
	local var_17_3 = var_0_0.GetDropConfig(arg_17_1)

	LoadImageSpriteAsync = var_1_10005

	var_1_10005("neweducateicon/" .. var_17_3.icon, arg_17_0:Find("icon"))

	setText = var_1_10005

	var_1_10005(arg_17_0:Find("name"), var_17_3.name)

	setText = var_1_10005

	var_1_10005(arg_17_0:Find("value"), var_17_2 .. arg_17_1.number)
...
function var_0_0.UpdateItem(arg_18_0, arg_18_1)
	...
	var_1_10003("neweducateicon/" .. var_0_0.GetDropIcon(arg_18_1), arg_18_0:Find("frame/icon"))

	setText = var_1_10003

	var_1_10003(arg_18_0:Find("frame/count_bg/count"), arg_18_1.number)

	setText = var_1_10003

	local var_18_1 = arg_18_0:Find("name_bg/name")

	shortenString = var_6

	var_1_10003(var_18_1, var_6(var_18_0.name, 5))
...
function var_0_0.NormalType2SiteType(arg_19_0)
	...
	NewEducateConst = var_1_10005
	var_19_1[var_1_10005.SITE_NORMAL_TYPE.WORK] = function()
		NewEducateConst = var_2_10000

		return var_2_10000.SITE_TYPE.WORK
	end
	NewEducateConst = var_5
	var_19_1[var_5.SITE_NORMAL_TYPE.TRAVEL] = function()
		NewEducateConst = var_2_10000
...
function var_0_0.GetSiteColors(arg_25_0)
	...
	NewEducateConst = var_1_10006
	var_25_2[var_1_10006.SITE_TYPE.WORK] = function()
		Color = var_2_10000
		...
		local var_26_1 = var_2_10001.NewHex("eea221")
	end
	NewEducateConst = var_6
	var_25_2[var_6.SITE_TYPE.TRAVEL] = function()
		Color = var_2_10000
		...
		local var_27_1 = var_2_10001.NewHex("eea221")
	end
	NewEducateConst = var_6
	var_25_2[var_6.SITE_TYPE.EVENT] = function()
		Color = var_2_10000
		...
		local var_28_1 = var_2_10001.NewHex("7668e2")
	end
	NewEducateConst = var_6
	var_25_2[var_6.SITE_TYPE.SHIP] = function()
		if var_25_0.bg == "red" then
			...
			Color = var_2_10001
			var_2_10001 = var_2_10001.NewHex("d96964")

			return
		elseif var_25_0.bg == "blue" then
			Color = var_0

			local var_29_1 = var_0.NewHex("39bfff")

			Color = var_2_10001

			local var_29_2 = var_2_10001.NewHex("26b1f3")
...
function var_0_0.PlaySpecialStory(arg_30_0, arg_30_1)
	...
	local var_30_4 = var_5.NewStoryMgr.GetInstance()
	...
	if var_30_3 then
		...
		if var_5.GetMemoryIdByName(var_30_6, arg_30_0) then
			...
			local var_30_7 = var_30_2.m02
			local var_30_8 = var_6.sendNotification

			GAME = var_9

			local var_30_9 = var_9.NEW_EDUCATE_TRACK

			NewEducateTrackCommand = var_10

			var_30_8(var_30_7, var_30_9, var_10.BuildDataMemory(var_2:GetGameCnt(), var_2:GetRoundData().round, var_5))
		end
	end
...
function var_0_0.GetBenefitValue(arg_36_0, arg_36_1)
	...
	return var_36_0(var_36_1, var_1_10005.floor(arg_36_0 * (1 + arg_36_1.ratio / 16) + arg_36_1.value))
end
...
function var_0_0.GetTarotDetailDescKey()
	...
	local var_37_2 = var_1_10001(var_1_10003)
	local var_37_3 = var_1.GetCurChar(var_37_2).id

	NewEducateConst = var_37_0

	return var_37_0.NEW_EDUCATE_TAROT_DETAIL_DESC .. "_" .. var_37_1 .. "_" .. var_37_3
end
...
function var_0_0.SetTarotDeatilDescData(arg_39_0)
	...
	var_39_0(var_3.GetTarotDetailDescKey(var_39_1), arg_39_0 and 1 or 0)
...
function var_0_0.GetNewTipKey()
	...
	local var_40_2 = var_1_10001.child2_data.all

	pg = var_40_0

	local var_40_3 = var_40_2[#var_40_0.child2_data.all]
...
function var_0_0.IsShowNewChildTip()
	...
	if not var_1_10000 then
		...
		local var_41_2 = var_1_10001 and "EducateMediator" or "NewEducateSelectMediator"

		pg = var_41_0

		local var_41_3 = var_41_0.SystemOpenMgr.GetInstance()
		...
		return var_1_10003.GetInt(var_0_0.GetNewTipKey()) ~= 1
	end
end
...
function var_0_0.ClearEventPerformance(arg_43_0)
	...
	local var_43_2 = var_1_10002.NEW_EDUCATE_EVENT_TIP .. "_" .. var_43_1 .. "_" .. arg_43_0.id .. "_" .. arg_43_0:GetGameCnt() .. "_"
	...
	local var_43_4 = var_43_3(var_5.child2_site_event_group.all, function(arg_44_0)
		pg = var_2_10001
...
function var_0_0.TrackRoundEnd()
	...
	local var_46_0 = var_1_10000(var_1_10002)
	...
	if not var_1_10001.map(var_46_1:GetAttrIds(), function(arg_47_0)
	...
	local var_46_6 = var_46_3.m02
	local var_46_7 = var_4.sendNotification

	GAME = var_1_10007

	local var_46_8 = var_1_10007.NEW_EDUCATE_TRACK

	NewEducateTrackCommand = var_1_10008

	local var_46_9 = var_1_10008.BuildDataRoundEnd
	...
	NewEducateChar = var_1_10016

	local var_46_15 = var_46_14(var_46_13, var_1_10016.RES_TYPE.MOOD)
	local var_46_16 = var_46_1
	local var_46_17 = var_46_1.GetResByType

	NewEducateChar = var_1_10017

	local var_46_18 = var_46_17(var_46_16, var_1_10017.RES_TYPE.MONEY)
	local var_46_19 = var_46_1
	local var_46_20 = var_46_1.GetResByType

	NewEducateChar = var_1_10018

	local var_46_21 = var_46_20(var_46_19, var_1_10018.RES_TYPE.FAVOR)
	local var_46_22 = var_46_1
	local var_46_23 = var_46_1.GetPersonality(var_46_22)

	table = var_46_19

	local var_46_24 = var_46_19.concat(var_46_2, ",")

	table = var_46_22

	local var_46_25 = var_46_22.concat(var_46_4, ",")
	local var_46_26 = ";"

	table = var_20

	var_46_7(var_46_6, var_46_8, var_46_9(var_46_10, var_46_11, var_46_12, var_46_15, var_46_18, var_46_21, var_46_23, var_46_24, var_46_25 .. var_46_26 .. var_20.concat(var_46_5, ",")))
...
function var_0_0.TrackEnterTime()
	...
	if var_0.GetEnterTime(var_48_0) == 0 then
		...
		local var_48_1 = var_1_10001(var_1_10003)
		...
		local var_48_4 = var_48_0.m02
		local var_48_5 = var_2.sendNotification

		GAME = var_1_10005

		local var_48_6 = var_1_10005.NEW_EDUCATE_TRACK

		NewEducateTrackCommand = var_1_10006

		var_48_5(var_48_4, var_48_6, var_1_10006.BuildDataEnter(var_48_3, 0))
	end
...
function var_0_0.TrackExitTime()
	...
	if var_0.GetEnterTime(var_49_0) ~= 0 then
		...
		local var_49_1 = var_1_10001.TimeMgr.GetInstance()
		local var_49_2 = var_1.GetServerTime(var_49_1) - var_0

		getProxy = var_49_0
		NewEducateProxy = var_1_10004

		local var_49_3 = var_49_0(var_1_10004)
		local var_49_4 = var_2.GetCurChar(var_49_3).id

		pg = var_49_1

		local var_49_5 = var_49_1.m02
		local var_49_6 = var_3.sendNotification

		GAME = var_1_10006

		local var_49_7 = var_1_10006.NEW_EDUCATE_TRACK

		NewEducateTrackCommand = var_1_10007

		var_49_6(var_49_5, var_49_7, var_1_10007.BuildDataEnter(var_49_4, 1, var_49_2))
...
function var_0_0.GetAllUnlockSecretaryIds()
	...
	local var_50_0 = var_1_10000(var_1_10002)
	local var_50_1
	...
	if not var_1_10001 then
		...
		local var_50_2 = var_1_10001(var_1_10003)

		ipairs = var_50_0
		pg = var_1_10004

		for iter_50_0, iter_50_1 in var_50_0(var_1_10004.child2_data.all) do
			if var_50_2:GetChar(iter_50_1) then
				...
				if var_7.GetPermanentData(var_50_3) then
					...
					table = var_1_10008
					var_50_1 = var_1_10008.mergeArray(var_50_1, var_50_6)
				end
			end
		end
	end
...
function var_0_0.GetEducateCharacterList()
	...
	for iter_51_0, iter_51_1 in var_1_10001(var_1_10003.secretary_special_ship.get_id_list_by_character_id) do
		...
		if not var_1_10006 or iter_51_0 == 1000 then
			...
			EducateCharCharacter = var_1_10009

			var_1_10006(var_51_1, var_1_10009.New(iter_51_0))
		end
	end
...
function var_0_0.GetSecIdBySkinId(arg_52_0)
	...
	for iter_52_0, iter_52_1 in var_1_10001(var_1_10003.secretary_special_ship.all) do
		pg = var_1_10006
...
function var_0_0.UpdateUnlockBySkinId(arg_57_0)
	...
	if var_1_10002.secretary_special_ship[var_57_0].tb_id == 0 then
		getProxy = var_3
		EducateProxy = var_1_10005
		var_1_10005 = var_3(var_1_10005)

		var_3.updateSecretaryIDs(var_1_10005, true)
	else
		getProxy = var_3
		NewEducateProxy = var_1_10005

		local var_57_1 = var_3(var_1_10005)
...
function var_0_0.GetEducateCharSlotMaxCnt()
	...
	local var_58_0 = var_1_10000(var_1_10002)
...
function var_0_0.ReqDataForServer()
	...
	if not var_1_10001 then
		...
		for iter_59_0, iter_59_1 in var_1_10001(var_1_10003.child2_data.all) do
			table = var_1_10006
