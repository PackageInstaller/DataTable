...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.roundAnim = var_2_7(var_2_6, var_4(var_1_10006))
	...
	arg_2_0.roundAnimEvent = var_2_9(var_2_8, var_4(var_1_10006))
...
function var_0_1.Show(arg_5_0, arg_5_1)
	...
	if var_2:IsEndless() then
		...
		var_5_4, var_1_10007, var_5_5 = var_2:GetEndlessProgressInfos()
		var_5_3 = var_5_5
	else
		local var_5_6

		var_5_4, var_1_10007, var_5_6 = var_2:GetProgressInfo()
		var_5_3 = var_5_6
		var_5_2 = var_1_10007
		var_5_1 = var_5_4
	end
	...
	var_5_4(var_5_7, var_1_10009("child2_assess_tip", var_5_2))
	...
	var_5_4(var_5_8, var_9("child2_assess_tip_target", var_5_3))

	local var_5_9 = var_2:IsTemp()

	setText = var_1_10007

	local var_5_10 = arg_5_0.roundTF

	i18n = var_1_10010

	var_1_10007(var_5_10, var_1_10010("child2_cur_round", var_5_9 and var_5_1 or var_5_1 - 1))
		...
		function(arg_6_0)
			...
			var_1.SetTriggerEvent(var_6_1, function()
				...
				if var_5_9 then
					...
					var_3_10001(arg_5_0.roundTF, var_8_1)
