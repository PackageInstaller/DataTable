...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.progressPart = var_2_2(var_3.Find(var_2_3, "progress"), arg_2_0)
	NewEducateTopRes = var_1

	local var_2_4 = var_1.New
	local var_2_5 = arg_2_0._tf

	arg_2_0.resPart = var_2_4(var_3.Find(var_2_5, "res"), arg_2_0)
	...
	var_1(var_3.Find(var_2_8, "btns/home"), not arg_2_0.contextData.hideHome)

	setActive = var_1

	local var_2_9 = arg_2_0.toolbarTF

	var_1(var_3.Find(var_2_9, "btns/help/line"), not arg_2_0.contextData.hideHome)
	...
	if var_1.gameset.child2_rank_switch.key_value == 1 then
		local var_2_10 = arg_2_0.contextData.char
		local var_2_11 = var_1.GetPermanentData(var_2_10)

		var_2_12 = var_1.IsTarotType(var_2_11)
	else
		var_2_12 = false
	end
	...
	local var_2_13 = arg_2_0.toolbarTF

	var_1_10002(var_4.Find(var_2_13, "btns/rank"), var_2_12)

	setAnchoredPosition = var_1_10002

	var_1_10002(arg_2_0.resPart._tf, {
		x = var_2_12 and -697 or -565
	})
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_4.Find(var_3_1, "btns/rank")
	...
	local function var_3_3()
		...
		local var_4_2 = var_2_10003.GO_SUBLAYER
		...
		NewEducateRankMediator = var_2_10007
		var_4_4.mediator = var_2_10007
		NewEducateRankLayer = var_2_10007
	...
	local var_3_6 = var_4.Find(var_3_5, "btns/collect")
	...
	local function var_3_7()
		...
		local var_5_2 = var_2_10003.GO_SUBLAYER
	...
	local var_3_10 = var_4.Find(var_3_9, "btns/refresh")
	...
	local function var_3_11()
		...
		local var_6_2 = var_2_10003.ON_BOX
		local var_6_3 = {}

		i18n = var_2_10005
		var_6_3.content = var_2_10005("child_refresh_sure_tip")
		...
		function var_6_3.onYes()
			...
			var_7_1(var_7_0, var_3_10003.NEW_EDUCATE_REFRESH, {
				id = arg_3_0.contextData.char.id,
	...
	local var_3_15 = var_4.Find(var_3_14, "btns/help")
	...
	local function var_3_16()
		...
		i18n = var_2_10005
		var_8_3.helps = var_2_10005(var_8_0)
	...
	var_3_12(var_3_13, var_3_15, var_3_16, var_3_14)

	onButton = var_3_12

	local var_3_17 = arg_3_0
	local var_3_18 = arg_3_0.toolbarTF
	local var_3_19 = var_4.Find(var_3_18, "btns/home")
	...
	var_3_12(var_3_17, var_3_19, var_3_20, var_3_18)
