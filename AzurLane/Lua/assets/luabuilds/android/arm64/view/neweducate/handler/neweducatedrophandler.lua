...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.dropUIList = var_1_1(var_1_2, var_5.Find(var_1_3, "tpl"))
	...
	var_2.make(var_1_4, function(arg_2_0, arg_2_1, arg_2_2)
		...
		if arg_2_0 == var_2_10003.EventUpdate then
			...
			var_6("neweducateicon/" .. var_2_1, arg_2_2:Find("icon"))

			setText = var_6

			var_6(arg_2_2:Find("name"), var_4.name)
...
function var_0_0.PlayPolaroid(arg_7_0, arg_7_1, arg_7_2)
	...
	var_1_10003({
		function(arg_8_0)
			...
			var_2(var_8_1, var_5.Find(var_8_2, "content/mask/icon"), true)

			setText = var_2

			local var_8_3 = arg_7_0.polaroidTF

			var_2(var_4.Find(var_8_3, "content/desc"), var_8_0.title)
