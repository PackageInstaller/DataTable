...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.uiList = var_1_10002.New(var_2_8, var_2_8:Find("tpl"))
...
function var_0_1.GetRarityBg(arg_6_0, arg_6_1)
	...
	NewEducateBuff = var_1_10006
	var_6_1[var_1_10006.RARITY.BLUE] = function()
		return "bg_blue"
	end
	NewEducateBuff = var_6
	var_6_1[var_6.RARITY.PURPLE] = function()
		return "bg_purple"
	end
	NewEducateBuff = var_6
	var_6_1[var_6.RARITY.GOLD] = function()
		return "bg_gold"
	end
	NewEducateBuff = var_6
	var_6_1[var_6.RARITY.COLOURS] = function()
		return "bg_colours"
	end
...
function var_0_1.UpdateItem(arg_11_0, arg_11_1, arg_11_2)
	...
	var_1_10005(arg_11_2:Find("refresh_btn"), not var_11_1)

	onButton = var_1_10005

	local var_11_2 = arg_11_0
	local var_11_3 = arg_11_2
	local var_11_4 = arg_11_2.Find(var_11_3, "refresh_btn")
	...
	local function var_11_5()
		...
		NewEducateTalentMediator = var_2_10003

		local var_12_2 = var_2_10003.ON_REFRESH_TALENT
		local var_12_3 = arg_11_1

		tonumber = var_2_10005

		var_12_1(var_12_0, var_12_2, var_12_3, var_2_10005(arg_11_2.name))
	...
	var_1_10005(var_11_2, var_11_4, var_11_5, var_11_3)

	setText = var_1_10005

	var_1_10005(arg_11_2:Find("refresh_btn/Text"), var_11_1 and 1 or 0)
	...
	local function var_11_8()
		...
		local var_13_2 = var_2_10003.ON_SELECT_TALENT
		local var_13_3 = arg_11_1

		tonumber = var_2_10005

		var_13_1(var_13_0, var_13_2, var_13_3, var_2_10005(arg_11_2.name))
	...
	var_1_10005(var_11_6, var_11_7, var_11_8, var_10)
...
function var_0_1.RefreshView(arg_14_0)
	...
	local var_14_3 = var_14_2(var_14_1, var_1_10004.SYSTEM.TALENT)
...
function var_0_1.OnRefreshTalent(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_3 = var_15_2(var_15_1, var_1_10006.SYSTEM.TALENT)
	...
	var_4(arg_15_0.uiList.container, function(arg_16_0)
		...
		if var_2_10001(arg_16_0.name) == arg_15_1 then
			...
			local var_16_2 = var_16_1(var_16_0, var_2_10004(var_2_10006))
			...
			local var_16_5 = var_16_4(var_16_3, var_5(var_2_10007))
	...
	var_1_10002({
		...
		var_21_2(arg_18_0.uiList.container, function(arg_23_0)
			...
			if var_3_10001(arg_23_0.name) ~= arg_18_1.idx then
				...
				local var_23_2 = var_23_1(var_23_0, var_3_10004(var_3_10006))
