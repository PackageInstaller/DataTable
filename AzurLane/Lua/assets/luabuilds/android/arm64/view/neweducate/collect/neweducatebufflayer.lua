...
NewEducateBuff = var_0_0

local var_0_3 = var_0_0.TYPE.TAROT
...
i18n = var_0_10004
var_0_6[var_0_7] = var_0_10004("child2_collect_tarot")
...
function var_0_1.init(arg_3_0)
	...
	NewEducateBuff = var_3_4

	local var_3_7 = var_3_4.TYPE.TAROT
	local var_3_8 = var_3_5
	local var_3_9 = var_3_5.Find

	tostring = var_1_10007
	NewEducateBuff = var_1_10009
	var_3_6[var_3_7] = var_3_9(var_3_8, var_1_10007(var_1_10009.TYPE.TAROT))
	...
	tostring = var_7
	NewEducateBuff = var_9
	var_3_10[var_3_11] = var_3_13(var_3_12, var_7(var_9.TYPE.ENTRY))
	...
	tostring = var_7
	NewEducateBuff = var_9
	var_3_14[var_3_15] = var_3_17(var_3_16, var_7(var_9.TYPE.TALENT))
	...
	typeof = var_5
	Animation = var_7
	arg_3_0.animCom = var_3_21(var_3_20, var_5(var_7))
...
function var_0_1.didEnter(arg_4_0)
	...
	var_1(arg_4_0.togglesTF, function(arg_6_0)
		...
		var_2_10002(arg_6_0:Find("name"), var_0_6[var_6_0])
		...
		var_2_10002(var_6_1, var_6_2, var_6_3, var_7)
	...
	var_1(var_4_4, var_4_5, var_4_6, var_4_1)
	...
	var_1(var_4_7, var_4_8, var_4_9, var_4_1)
	...
	var_1(arg_4_0.boxsTF, function(arg_10_0)
		...
		var_2_10001(var_10_0, var_10_1, var_10_2, var_2_10006)
	...
	var_4_11(var_4_10, var_4(var_6.GetChild(var_4_12, 0).name))
...
function var_0_1.InitData(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1(arg_12_0.allIdMap) do
		...
		math = var_12_14
		var_12_16[iter_12_0] = var_12_14.ceil(#iter_12_1 / var_12_15)
	end
...
function var_0_1.UpdateToggles(arg_13_0)
	...
	var_1_10001(arg_13_0.togglesTF, function(arg_14_0)
		...
		var_2_10002(arg_14_0:Find("value"), #arg_13_0.unlockIdMap[var_14_0] .. "/" .. #arg_13_0.allIdMap[var_14_0])
...
function var_0_1.SwtichView(arg_15_0, arg_15_1)
	...
	var_2(arg_15_0.togglesTF, function(arg_16_0)
		...
		local var_16_0 = arg_16_0:Find("sel")

		tonumber = var_2_10004

		var_2_10001(var_16_0, var_2_10004(arg_16_0.name) == arg_15_1)
	...
	var_2(var_4.Find(var_15_0, "pages"), function(arg_17_0)
		setActive = var_2_10001
		...
		var_2_10001(var_17_0, var_2_10004(arg_17_0.name) == arg_15_1)
...
function var_0_1.GetNextType(arg_19_0)
	...
	var_19_1[var_1_10005.TYPE.TAROT] = function()
		NewEducateBuff = var_2_10000

		return var_2_10000.TYPE.ENTRY
	end
	NewEducateBuff = var_5
	var_19_1[var_5.TYPE.ENTRY] = function()
		NewEducateBuff = var_2_10000

		return var_2_10000.TYPE.TALENT
	end
	NewEducateBuff = var_5
	var_19_1[var_5.TYPE.TALENT] = function()
		return nil
	end
...
function var_0_1.GetLastType(arg_23_0)
	...
	NewEducateBuff = var_1_10005
	var_23_1[var_1_10005.TYPE.TAROT] = function()
		return nil
	end
	NewEducateBuff = var_5
	var_23_1[var_5.TYPE.ENTRY] = function()
		NewEducateBuff = var_2_10000

		return var_2_10000.TYPE.TAROT
	end
	NewEducateBuff = var_5
	var_23_1[var_5.TYPE.TALENT] = function()
		NewEducateBuff = var_2_10000
...
function var_0_1.UpdatePage(arg_27_0)
	...
	if arg_27_0.pageAllCntMap[arg_27_0.curType] < arg_27_0.curPageIdx then
		...
		if arg_27_0.GetNextType(var_1_10005) then
	...
	elseif arg_27_0.curPageIdx < 1 then
		...
		if arg_27_0.GetLastType(var_1_10005) then
	...
	local var_27_4 = var_27_3 == var_1_10005.TYPE.TAROT and arg_27_0.curPageIdx <= 1
...
function var_0_1.UpdateItem(arg_28_0, arg_28_1, arg_28_2)
	...
	var_1_10004(arg_28_2:Find("lock"), not var_28_0)

	setActive = var_1_10004

	local var_28_1 = arg_28_2

	var_1_10004(arg_28_2.Find(var_28_1, "unlock"), var_28_0)

	switch = var_1_10004

	local var_28_2 = arg_28_0.curType
	local var_28_3 = {}

	NewEducateBuff = var_28_1
	var_28_3[var_28_1.TYPE.TAROT] = function()
		NewEducateTarotCard = var_2_10000

		local var_29_0 = var_2_10000.StaticShow
		local var_29_1 = arg_28_2

		var_29_0(var_2.Find(var_29_1, "unlock"), arg_28_1)

		setText = var_29_0

		local var_29_2 = arg_28_2

		var_29_0(var_2.Find(var_29_2, "lock/Text"), arg_28_0.config[arg_28_1].get)

		setText = var_29_0

		local var_29_3 = arg_28_2

		var_29_0(var_2.Find(var_29_3, "lock/name/Text"), arg_28_0.config[arg_28_1].name)
		...
		var_29_0(var_29_4, var_29_5, var_29_6, var_5)

		return
	end
	NewEducateBuff = var_8
	var_28_3[var_8.TYPE.ENTRY] = function()
		NewEducateEntryCard = var_2_10000

		local var_31_0 = var_2_10000.StaticShow
		local var_31_1 = arg_28_2

		var_31_0(var_2.Find(var_31_1, "unlock"), arg_28_1)

		setText = var_31_0

		local var_31_2 = arg_28_2

		var_31_0(var_2.Find(var_31_2, "lock/Text"), arg_28_0.config[arg_28_1].get)

		setText = var_31_0

		local var_31_3 = arg_28_2

		var_31_0(var_2.Find(var_31_3, "lock/name"), arg_28_0.config[arg_28_1].name)
		...
		var_31_0(var_31_4, var_31_5, var_31_6, var_5)

		return
	end
	NewEducateBuff = var_8
	var_28_3[var_8.TYPE.TALENT] = function()
		...
		var_1(var_33_1, var_4.Find(var_33_2, "unlock/icon"))

		setText = var_1

		local var_33_3 = arg_28_2

		var_1(var_3.Find(var_33_3, "lock/Text"), var_33_0.get)

		setText = var_1

		local var_33_4 = arg_28_2

		var_1(var_3.Find(var_33_4, "name"), var_33_0.name)
		...
		var_1(var_33_5, var_33_6, var_5.Find(var_33_7, "unlock"))
		...
		var_1(var_33_8, var_33_9, var_33_10, var_6)

		return
	end

	var_1_10004(var_28_2, var_28_3)
...
function var_0_1.ShowDetailBox(arg_35_0, arg_35_1, arg_35_2)
	...
	var_1_10003(arg_35_0.boxsTF, function(arg_36_0)
		...
		var_2_10001(var_36_0, var_36_1 == var_2_10005(arg_36_0.name))
	...
	local var_35_2 = var_35_1(var_35_0, var_6(arg_35_0.curType))
	...
	NewEducateBuff = var_8
	var_35_4[var_8.TYPE.TAROT] = function()
		NewEducateTarotCard = var_2_10000

		local var_37_0 = var_2_10000.StaticShow
		local var_37_1 = var_35_2

		var_37_0(var_2.Find(var_37_1, "bg/tarot"), arg_35_1)

		return
	end
	NewEducateBuff = var_8
	var_35_4[var_8.TYPE.ENTRY] = function()
		NewEducateEntryCard = var_2_10000

		local var_38_0 = var_2_10000.StaticShow
		local var_38_1 = var_35_2

		var_38_0(var_2.Find(var_38_1, "bg/entry/unlock"), arg_35_1)

		setText = var_38_0

		local var_38_2 = var_35_2

		var_38_0(var_2.Find(var_38_2, "bg/entry/lv"), "LV." .. arg_35_0.config[arg_35_1].benefit_level)

		setActive = var_38_0

		local var_38_3 = var_35_2

		var_38_0(var_2.Find(var_38_3, "bg/entry/unlock"), true)

		setActive = var_38_0

		local var_38_4 = var_35_2

		var_38_0(var_2.Find(var_38_4, "bg/entry/lock"), false)

		setActive = var_38_0

		local var_38_5 = var_35_2

		var_38_0(var_2.Find(var_38_5, "bg/toggles"), false)

		return
	end
	NewEducateBuff = var_8
	var_35_4[var_8.TYPE.TALENT] = function()
		local var_39_0 = arg_35_0.config[arg_35_1]
		local var_39_1 = var_35_2
		local var_39_2 = var_1.Find(var_39_1, "bg/talent")

		LoadImageSpriteAsync = var_2_10002

		var_2_10002("neweducateicon/" .. var_39_0.item_icon, var_39_2:Find("rarity/icon"))

		setText = var_2_10002

		var_2_10002(var_39_2:Find("name"), var_39_0.name)

		setText = var_2_10002

		var_2_10002(var_39_2:Find("level"), "LV." .. var_39_0.benefit_level)

		setText = var_2_10002

		var_2_10002(var_39_2:Find("desc/Text"), var_39_0.desc)

		LoadImageSpriteAtlasAsync = var_2_10002

		var_2_10002("ui/neweducatebuffui_atlas", "rarity_" .. var_39_0.rare, var_39_2:Find("rarity"))

		return
	end

	var_1_10004(var_35_3, var_35_4)
...
function var_0_1.ShowEntryBox(arg_40_0, arg_40_1, arg_40_2, arg_40_3)
	...
	var_40_3(var_40_4, var_8.GetChild(var_40_5, 0), #var_40_0, function(arg_43_0, arg_43_1, arg_43_2)
		...
		if arg_43_0 == var_2_10003.EventUpdate then
			...
			var_2_10007(arg_43_2:Find("sel/Image"), not var_43_2)

			setActive = var_2_10007

			var_2_10007(arg_43_2:Find("unsel/Image"), not var_43_2)

			setActive = var_2_10007

			var_2_10007(arg_43_2:Find("sel/Text"), var_43_2)

			setActive = var_2_10007

			var_2_10007(arg_43_2:Find("unsel/Text"), var_43_2)
			...
			local function var_43_5(arg_44_0)
				...
				var_44_0(var_3.Find(var_44_1, "bg/entry/unlock"), var_43_0)

				setText = var_44_0

				local var_44_2 = arg_40_1

				var_44_0(var_3.Find(var_44_2, "bg/entry/lv"), "LV." .. var_43_1)

				setActive = var_44_0

				local var_44_3 = arg_40_1

				var_44_0(var_3.Find(var_44_3, "bg/entry/unlock"), var_43_2)

				setActive = var_44_0

				local var_44_4 = arg_40_1

				var_44_0(var_3.Find(var_44_4, "bg/entry/lock"), not var_43_2)

				setText = var_44_0

				local var_44_5 = arg_40_1

				var_44_0(var_3.Find(var_44_5, "bg/entry/lock/Text"), var_0.get)

				setText = var_44_0

				local var_44_6 = arg_40_1

				var_44_0(var_3.Find(var_44_6, "bg/entry/lock/name"), var_0.name)
			...
			var_2_10007(var_43_3, var_43_4, var_43_5, var_12)
		end
	...
	local var_40_7 = var_7.Find

	tostring = var_10

	var_40_3(var_40_7(var_40_6, var_10(arg_40_3)), true)
