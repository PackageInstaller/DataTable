...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	typeof = var_7
	Text = var_1_10009
	arg_1_0.rankText = var_1_5(var_1_4, var_7(var_1_10009))
	...
	var_4(var_1_7, var_7("child2_rank_not_on"))
	...
	typeof = var_7
	Text = var_9
	arg_1_0.callNameText = var_1_11(var_1_10, var_7(var_9))
	...
	typeof = var_7
	Text = var_9
	arg_1_0.playerNameText = var_1_14(var_1_13, var_7(var_9))
	...
	typeof = var_7
	Text = var_9
	arg_1_0.valueText = var_1_17(var_1_16, var_7(var_9))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	if arg_2_2 == var_5.TYPE_TB_ENDLESS_WAVE then
		...
		local var_2_4 = var_1_10008(var_1_10010)
		local var_2_5 = var_8.GetCurChar(var_2_4)
		local var_2_6 = var_8.GetRoundData(var_2_5)

		var_2_1 = var_2_2(var_2_3, var_2_1 - var_8.GetGameRoundCnt(var_2_6))
	end
