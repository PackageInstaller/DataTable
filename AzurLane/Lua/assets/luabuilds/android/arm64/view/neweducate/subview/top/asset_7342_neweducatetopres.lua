...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_1_10006
	Image = var_1_10008
	arg_1_0.bgImage = var_1_1(var_1_0, var_1_10006(var_1_10008))
	UIItemList = var_3
	...
	arg_1_0.resUIList = var_1_2(var_1_3, var_6.Find(var_1_4, "tpl"))
...
function var_0_0.OnInitItem(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_2 = "neweducateicon/" .. var_4_1.icon
	local var_4_3 = arg_4_2

	var_1_10005(var_4_2, arg_4_2.Find(var_4_3, "icon"))

	onButton = var_1_10005

	local var_4_4 = arg_4_0.event
	...
	local function var_4_6()
		...
		local var_5_2 = var_2_10003.ON_ITEM
		local var_5_3 = {}
		local var_5_4 = {
			number = 1
		}
		...
		var_5_4.type = var_2_10006.DROP_TYPE.RES
		var_5_4.id = var_4_0
	...
	var_1_10005(var_4_4, var_4_5, var_4_6, var_4_3)
...
function var_0_0.OnUpdateItem(arg_6_0, arg_6_1, arg_6_2)
	...
	NewEducateChar = var_6_2

	if var_6_4 == var_6_2.RES_TYPE.MOOD then
		setText = var_6_4

		local var_6_5 = arg_6_2:Find("value")

		setColorStr = var_1_10009

		var_6_4(var_6_5, var_1_10009(var_6_3, arg_6_0:GetMoodColor(var_6_3)) .. var_6_1)

		goto label_6_0
	end

	local var_6_6 = var_3.type

	NewEducateChar = var_7

	if var_6_6 == var_7.RES_TYPE.ACTION then
		setText = var_6_6

		local var_6_7 = arg_6_2:Find("value")
		...
		if var_6_3 == 0 then
			...
			do
				...
				if not var_1_10009(var_6_3, "#ee4a4a") then
					var_6_8 = var_6_3
				end

				var_6_6(var_6_7, var_6_8)

				if false then
					setText = var_6_6

					var_6_6(arg_6_2:Find("value"), var_6_3 .. var_6_1)
				end
			end
...
function var_0_0.Update(arg_7_0, arg_7_1)
	...
	if not arg_7_0.resIds then
		...
		var_7_0[1] = var_7_2(var_7_1, var_1_10006.RES_TYPE.MONEY)

		local var_7_3 = arg_7_0.char
		local var_7_4 = var_3.GetResIdByType

		NewEducateChar = var_6
		var_7_0[2] = var_7_4(var_7_3, var_6.RES_TYPE.MOOD)

		local var_7_5 = arg_7_0.char
		local var_7_6 = var_3.GetResIdByType

		NewEducateChar = var_6
		var_7_0[3] = var_7_6(var_7_5, var_6.RES_TYPE.ACTION)
	end
