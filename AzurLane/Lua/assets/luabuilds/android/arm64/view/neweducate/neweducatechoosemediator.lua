...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_REFRESH_CHOICE, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.NEW_EDUCATE_REFRESH_CHOICE, {
	...
	arg_1_0:bind(var_0_1.ON_MAKE_CHOICE, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.NEW_EDUCATE_MAKE_CHOICE, {
			id = arg_1_0.contextData.char.id,
			idx = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.ON_GIVE_UP_CHOICE, function(arg_4_0)
		...
		var_4_1(var_4_0, var_2_10004.NEW_EDUCATE_GIVE_UP_CHOICE, {
			id = arg_1_0.contextData.char.id
		})
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_1 == var_6_0.NEW_EDUCATE_REFRESH_CHOICE_DONE then
		...
		if var_6_1 == var_4.NEW_EDUCATE_MAKE_CHOICE_DONE then
			...
			if var_6_1 == var_4.NEW_EDUCATE_GIVE_UP_CHOICE_DONE then
