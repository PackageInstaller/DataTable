...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_UPGRADE_ENTRY, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.NEW_EDUCATE_UPGRADE_ENTRY, {
	...
	arg_1_0:bind(var_0_1.ON_GIVE_UP_ENTRY_UP, function(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10004.NEW_EDUCATE_GIVE_UP_ENTRY_UP, {
			id = arg_1_0.contextData.char.id
		})
	...
	arg_1_0:bind(var_0_1.ON_SHOPPING, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10006.NEW_EDUCATE_SHOPPING, {
			isUpgradeEntry = true,
			num = 1,
			id = arg_1_0.contextData.char.id,
			goodId = arg_4_1,
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_1 == var_6_0.NEW_EDUCATE_GIVE_UP_ENTRY_UP_DONE then
		...
		if var_6_1 == var_4.NEW_EDUCATE_UPGRADE_ENTRY_DONE then
