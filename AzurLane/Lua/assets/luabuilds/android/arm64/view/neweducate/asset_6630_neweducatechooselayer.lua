	...
	var_1_10002({
		function(arg_3_0)
			...
			if #var_2.GetChoices(var_3_3) > 0 then
				...
				var_3_5(var_3_4, var_2_10006.NEW_EDUCATE_REQUEST_CHOICES, {
					id = var_1.id,
					callback = arg_3_0
				})
			end
...
function var_0_1.init(arg_4_0)
	...
	local var_4_3 = var_3.Find(var_4_2, "title")

	i18n = var_4

	var_1(var_4_3, var_4("child2_choose_title"))
	...
	local var_4_6 = var_3.Find(var_4_5, "refresh/Text")

	i18n = var_4

	var_1(var_4_6, var_4("child2_refresh_title"))
	...
	typeof = var_4
	Text = var_6
	arg_4_0.refreshCntText = var_4_9(var_4_8, var_4(var_6))
	...
	var_1(var_4_12, var_4("child2_show_detail_desc"))
	...
	var_1(var_4_16, var_4("child2_tarot_empty"))

	UIItemList = var_1

	local var_4_17 = var_1.New
	local var_4_18 = arg_4_0.showPanel
	local var_4_19 = var_3.Find(var_4_18, "tarot_list")
	local var_4_20 = arg_4_0.showPanel

	arg_4_0.tarotUIList = var_4_17(var_4_19, var_4.Find(var_4_20, "tarot_list/tpl"))
	...
	local var_4_24 = var_3.Find(var_4_23, "entry_list")
	local var_4_25 = arg_4_0.showPanel

	arg_4_0.entryUIList = var_4_22(var_4_24, var_4.Find(var_4_25, "entry_list/tpl"))
	...
	local var_4_29 = var_3.Find(var_4_28, "Text")

	i18n = var_4

	var_1(var_4_29, var_4("child2_choose_giveup"))
	...
	local var_4_32 = var_3.Find(var_4_31, "Text")

	i18n = var_4

	var_1(var_4_32, var_4("child2_choose_hide"))
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_2()
		...
		pg = var_2_10004
		var_8_2.helps = var_2_10004.gametip.child2_choose_help.tip
	...
	local function var_7_8()
		...
		NewEducateChooseMediator = var_2_10003

		var_10_1(var_10_0, var_2_10003.ON_GIVE_UP_CHOICE)
	...
	var_1(var_7_16, var_4(var_1_10006.gameset.child2_select_sleep_time.description))
...
function var_0_1.UpdateRefreshCnt(arg_17_0)
	...
	arg_17_0.refreshCnt = var_17_1(var_17_0, var_1_10004.RES_TYPE.REFRESH_CHOICE)
...
function var_0_1.UpdateGiveUpBtn(arg_19_0)
	...
	if arg_19_0.tarotId then
		...
		var_4(var_6.Find(var_19_5, "res/Text"), "+" .. var_19_4[3])
	end
...
function var_0_1.UpdateTarotChoice(arg_21_0, arg_21_1, arg_21_2)
		...
		var_2_10000({
			function(arg_23_0)
				if arg_21_0.tarotId then
					...
					i18n = var_3_10006
					var_23_3.content = var_3_10006("child2_replace_sure_tip")
			...
			NewEducateChooseMediator = var_3_10003

			var_24_1(var_24_0, var_3_10003.ON_MAKE_CHOICE, var_21_0)
	...
	var_5(var_21_3, var_21_4, var_21_5, var_1_10010)
...
function var_0_1.UpdateEntryChoice(arg_25_0, arg_25_1, arg_25_2)
	...
	local function var_25_5()
		...
		var_26_1(var_26_0, var_2_10003.ON_MAKE_CHOICE, var_25_0)
	...
	var_5(var_25_3, var_25_4, var_25_5, var_1_10010)
...
function var_0_1.UpdateRefreshBtn(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	...
	local var_27_5 = arg_27_2:Find("Text")

	math = var_1_10012

	var_1_10009(var_27_5, var_1_10012.min(var_27_2, arg_27_0.refreshCnt))

	setText = var_1_10009

	local var_27_6 = arg_27_3:Find("Text")

	math = var_12

	var_1_10009(var_27_6, var_12.min(var_27_2, arg_27_0.refreshCnt))

	setActive = var_1_10009

	var_1_10009(arg_27_2, var_27_3 and not var_27_4)

	setActive = var_1_10009

	var_1_10009(arg_27_3, not var_27_3 or var_27_4)
	...
	local function var_27_9()
		...
		var_28_1(var_28_0, var_2_10003.ON_REFRESH_CHOICE, arg_27_1)
	...
	var_1_10009(var_27_7, var_27_8, var_27_9, var_14)

	onButton = var_1_10009

	local var_27_10 = arg_27_0
	local var_27_11 = arg_27_3
	...
	local function var_27_12()
		...
		var_29_1(var_29_0, var_2_10003("child2_pool_exhausted"))
	...
	var_1_10009(var_27_10, var_27_11, var_27_12, var_14)
...
function var_0_1.OnRefreshDone(arg_35_0, arg_35_1)
	...
	var_2(arg_35_0:GetUIList().container, function(arg_36_0)
		...
		if var_2_10001(arg_36_0.name) == arg_35_1.idx then
			...
			local var_36_2 = var_36_1(var_36_0, var_2_10004(var_2_10006))
			...
			var_1.SetTriggerEvent(var_36_2, function()
				...
				local var_37_5 = var_3.GetComponent

				typeof = var_3_10006
				Toggle = var_3_10008

				var_37_3(var_37_2, var_37_5(var_37_4, var_3_10006(var_3_10008)).isOn)
			...
			local var_36_6 = var_36_5(var_36_4, var_2_10006(var_2_10008))
...
function var_0_1.OnMakeChoiceDone(arg_38_0, arg_38_1)
	...
	var_3(arg_38_0:GetUIList().container, function(arg_39_0)
		...
		if var_2_10001(arg_39_0.name) ~= arg_38_1.idx then
			...
			local var_39_2 = var_39_1(var_39_0, var_2_10004(var_2_10006))
