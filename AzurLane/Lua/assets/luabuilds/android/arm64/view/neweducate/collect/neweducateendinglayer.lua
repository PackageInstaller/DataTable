...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_2 = var_4.Find(var_3_1, "anim_root/close")
	...
	local var_3_5 = var_3.Find(var_3_4, "review_btn/Text")

	i18n = var_3_2

	var_1(var_3_5, var_3_2("child_btn_review"))
	...
	local var_3_8 = var_3.Find(var_3_7, "on/Text")

	i18n = var_4

	var_1(var_3_8, var_4("child2_endings_toggle_on"))

	setText = var_1

	local var_3_9 = arg_3_0.toggleTF
	local var_3_10 = var_3.Find(var_3_9, "off/Text")

	i18n = var_4

	var_1(var_3_10, var_4("child2_endings_toggle_off"))
	...
	var_1(var_3_12, var_3_13, var_3_14, var_6)
	arg_3_0:UpdatePage()
...
function var_0_1.UpdateItem(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_2 = arg_6_2:Find("finished")

	table = var_8

	var_1_10005(var_6_2, var_8.contains(arg_6_0.finishedIds, var_6_0.id))
	...
	if var_6_1 then
		...
		local var_6_5 = "bg/" .. var_6_0.pic

		var_6_6 = arg_6_2

		var_1_10005(var_6_5, arg_6_2.Find(var_6_6, "unlock/mask/Image"))
		...
		var_1_10005(var_6_7, var_6_4, var_6_8, var_6_6)
	else
	...
	local var_6_11 = var_6_10(var_6_9, var_6_4(var_6_6)).isOn
	local var_6_12 = {}

	if var_6_11 then
		setActive = var_6_9

		var_6_9(arg_6_2:Find("lock"), true)

		setActive = var_6_9

		var_6_9(arg_6_2:Find("lock/icon"), not var_6_1)

		setActive = var_6_9

		var_6_9(arg_6_2:Find("mask"), var_6_1)

		var_6_12 = var_6_0.condition_desc
	else
		setActive = var_6_9

		var_6_9(arg_6_2:Find("mask"), false)
	end
...
function var_0_1.UpdateConditions(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0 = 1, #arg_8_1 do
		...
		if iter_8_0 <= arg_8_2.childCount then
			var_1_10011 = arg_8_2

			local var_8_1

			if not arg_8_2.GetChild(var_1_10011, iter_8_0 - 1) then
				cloneTplTo = var_8_1
			...
			var_1_10011(var_8_1.Find(var_8_4, "icon/unlock"), var_8_3)

			var_1_10011 = var_8_3 and "F59F48" or "888888"
			setTextColor = var_8_2

			local var_8_5 = var_8_1:Find("Text")

			Color = var_8_4

			var_8_2(var_8_5, var_8_4.NewHex(var_1_10011))

			setText = var_8_2

			var_8_2(var_8_1:Find("Text"), var_1_10008[2])
		end
	end
...
function var_0_1.ShowPerformWindow(arg_9_0, arg_9_1)
	...
	var_1_10003("bg/" .. arg_9_1.pic, var_9_1)
	...
	var_1_10003(var_9_2, var_9_3, var_9_4, var_1_10008)

	onButton = var_1_10003

	local var_9_5 = arg_9_0
	local var_9_6 = arg_9_0.performTF
	local var_9_7 = var_6.Find(var_9_6, "review_btn")
	...
	var_1_10003(var_9_5, var_9_7, var_9_8, var_9_6)
