...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.bloodText = var_2_7(var_2_6, var_4(var_1_10006))
	...
	arg_2_0.attrUIList = var_1_10002.New(var_2_13, var_2_13:Find("tpl"))
	...
	var_2(var_2_18, var_5("child2_assess_start_tip"))
	...
	var_1.make(var_3_3, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventInit then
			...
			if arg_5_0 == var_3.EventUpdate then
				...
				local var_5_3 = arg_5_2.Find(var_5_2, "value")
				local var_5_4 = arg_3_0.contextData.char

				var_4(var_5_3, var_7.GetAttr(var_5_4, var_5_1))

				local var_5_5 = arg_3_0.curAttrIdx == arg_5_1 + 1 and "47b9f4" or "6f6f82"

				setTextColor = var_5

				local var_5_6 = arg_5_2:Find("value")

				Color = var_5_2

				var_5(var_5_6, var_5_2.NewHex(var_5_5))
			end
		end
...
function var_0_1.InitData(arg_7_0)
	...
	if arg_7_0.isEndless then
		...
		var_7(var_7_15, var_10("child2_assess_tip_target", var_7_14))
	else
		...
		var_7(var_7_19, var_10("child2_assess_tip_target", var_7_18))
	end
...
function var_0_1.InitStaticUI(arg_11_0)
	...
	var_11_0(arg_11_0.endlessTF, var_11_2)

	if var_11_2 then
		local var_11_3 = var_1

		var_11_0 = var_1.GetWave(var_11_3)

		local var_11_4 = var_1:GetHeighestWave()

		setText = var_11_3

		local var_11_5 = arg_11_0.endlessTF
		local var_11_6 = var_7.Find(var_11_5, "Text")

		i18n = var_1_10008

		var_11_3(var_11_6, var_1_10008("child2_endless_assest_wave", var_11_0))

		setActive = var_11_3

		local var_11_7 = arg_11_0.endlessTF

		var_11_3(var_7.Find(var_11_7, "new"), var_11_4 < var_11_0)
	end

	LoadImageSpriteAtlasAsync = var_11_0

	var_11_0("ui/neweducateassesspanel_atlas", "bg_" .. arg_11_0.tag, arg_11_0.bgTF)

	removeAllChildren = var_11_0

	var_11_0(arg_11_0.bossTF)

	removeAllChildren = var_11_0

	var_11_0(arg_11_0.roleTF)

	setActive = var_11_0

	var_11_0(arg_11_0.resultTF, false)

	setActive = var_11_0

	var_11_0(arg_11_0.damageTF, false)

	setActive = var_11_0

	var_11_0(arg_11_0.damageCritTF, false)

	setActive = var_11_0

	local var_11_8 = arg_11_0.resultTF

	var_11_0(var_5.Find(var_11_8, "title_gold"), arg_11_0.rank == "S")

	setActive = var_11_0

	local var_11_9 = arg_11_0.resultTF

	var_11_0(var_5.Find(var_11_9, "title_red"), arg_11_0.rank ~= "S")

	LoadImageSpriteAtlasAsync = var_11_0

	var_11_0("ui/neweducateassesspanel_atlas", arg_11_0.rank, arg_11_0.rankTF)

	setFillAmount = var_11_0

	var_11_0(arg_11_0.damageBlood, 0)
...
function var_0_1.ShowResult(arg_12_0)
	...
	NewEducateMainMediator = var_1_10006

	var_12_4(var_12_3, var_1_10006.ON_SET_ASSESS_RANK, var_12_1, var_12_2, function()
...
function var_0_1.CheckGuide(arg_22_0, arg_22_1)
	...
	if var_2.IsPlayed(var_22_0, "tb2_12") then
		...
		var_22_2(var_22_1, var_5.STORY_UPDATE, {
			storyId = "tb2_12"
		})
...
function var_0_1.PlayOneATK(arg_29_0, arg_29_1)
	...
	local var_29_7 = var_29_6(var_29_5, var_10(var_1_10012))
	...
	local var_29_10 = var_29_9(var_29_8, var_11(var_1_10013))
	...
	var_9({
		function(arg_30_0)
			...
			local var_30_2 = var_3.Find

			tostring = var_2_10006

			var_1(var_30_2(var_30_1, var_2_10006(var_29_0)), 0.2 / arg_29_0.speed, 3)
			...
			var_30_4(var_30_3, var_4.delayedCall, function()
				arg_30_0()
		...
		function(arg_34_0)
			...
			var_2_10001(var_34_0, var_4.min(arg_29_0.damageHP / arg_29_0.totolHP, 1))

			local var_34_1 = arg_29_0.bloodText

			math = var_2_10002
			var_34_1.text = var_2_10002.max(0, arg_29_0.totolHP - arg_29_0.damageHP) .. "/" .. arg_29_0.totolHP
		...
		if arg_29_0.damageHP >= arg_29_0.totolHP or arg_29_0.curAttrIdx == #arg_29_0.attrIds then
			...
			var_37_1(var_37_0, var_2_10003.delayedCall, function()
