...
function var_0_1.onInitItem(arg_10_0, arg_10_1)
	...
	local function var_10_3()
		...
		var_11_1(var_11_0, var_2_10003.OPEN_CHATROOM, var_10_0.friendVO)
	...
	local function var_10_6()
		...
		i18n = var_2_10004
		var_12_2.content = var_2_10004("remove_friend_tip")
		...
		function var_12_2.onYes()
			...
			var_13_1(var_13_0, var_3_10003.DELETE_FRIEND, var_10_0.friendVO.id)
	...
	var_1_10003(var_10_7, var_10_8, var_10_9, var_1_10008)
	...
	local function var_10_12()
		...
		var_15_1(var_15_0, var_2_10003.VISIT_BACKYARD, var_10_0.friendVO.id)
	...
	var_1_10003(var_10_10, var_10_11, var_10_12, var_1_10008)
...
function var_0_1.sortFriends(arg_17_0)
	if arg_17_0.contextData.sortData then
		...
		local var_17_1 = var_3.Find(var_17_0, "icon")

		GetSpriteFromAtlas = var_4

		var_1(var_17_1, var_4("ui/friendsui_atlas", arg_17_0.contextData.sortData.data.spr), true)
...
function var_0_1.initFriendsSortPanel(arg_19_0)
	...
	local var_19_2 = arg_19_0:getTpl("tpl", var_19_1)

	require = var_19_0
	arg_19_0.friendSortCfg = var_19_0("view.friend.FriendSortCfg")
	ipairs = var_3

	for iter_19_0, iter_19_1 in var_3(arg_19_0.friendSortCfg.SORT_TAG) do
		cloneTplTo = var_1_10008

		local var_19_3 = var_1_10008(var_19_2, var_19_1)
		local var_19_4 = var_1_10008.Find(var_19_3, "arr")

		setImageSprite = var_10

		local var_19_5 = var_1_10008:Find("Image")

		GetSpriteFromAtlas = var_1_10013

		var_10(var_19_5, var_1_10013("ui/friendsui_atlas", iter_19_1.spr), true)
		...
		local function var_19_7(arg_20_0)
			if arg_20_0 then
		...
		var_10(var_19_6, var_1_10013, var_19_7, var_15)

		if iter_19_0 == 1 then
			triggerToggle = var_10

			var_10(var_1_10008, true)
		end
	end
	...
	local var_19_9 = arg_19_0.sortPanel
	...
	var_3(var_19_8, var_19_9, var_19_10, var_1_10008)
...
function var_0_1.openFriendsSortPanel(arg_22_0)
	if arg_22_0.contextData.sortData then
		...
		local var_22_1 = var_3.Find(var_22_0, "index_button/icon")

		GetSpriteFromAtlas = var_1_10004

		var_1(var_22_1, var_1_10004("ui/friendsui_atlas", arg_22_0.contextData.sortData.data.spr), true)
	end
