...
function var_0_1.OnInit(arg_3_0)
	...
	var_1_10001(var_3_0, var_1_10004(arg_3_0.searchPanel, "copy_btn"), function()
		...
		var_4_1(var_4_0, var_2_10003("friend_id_copy_ok"))
	...
	var_1_10001(var_3_1, var_4(arg_3_0.searchPanel, "search_btn"), function()
		pg = var_2_10000
		...
		if arg_3_0.waitTimer and arg_3_0.waitTimer - var_5_1 > 0 then
			...
			var_5_3(var_5_2, var_2_10004("friend_searchFriend_wait_time", arg_3_0.waitTimer - var_5_1))
		...
		if not var_5_4(arg_3_0.searchBar) or var_1 == "" then
			...
			var_5_6(var_5_5, var_2_10005("friend_inpout_key_tip"))
		...
		FriendMediator = var_2_10005

		var_5_8(var_5_7, var_2_10005.SEARCH_FRIEND, 3, var_1)
	...
	var_1_10001(var_3_2, var_4(arg_3_0.searchPanel, "refresh_btn"), function()
		pg = var_2_10000
		...
		if arg_3_0.waitTimer1 and arg_3_0.waitTimer1 - var_6_1 > 0 then
			...
			var_6_3(var_6_2, var_2_10004("friend_searchFriend_wait_time", arg_3_0.waitTimer1 - var_6_1))
		...
		var_6_6(var_6_5, var_2_10005.SEARCH_FRIEND, 1, var_6_4)
...
function var_0_1.UpdateData(arg_7_0, arg_7_1)
	...
	if not arg_7_0.isInit then
		...
		var_7_2(var_7_1, var_1_10005.SEARCH_FRIEND, 1)
	else
...
function var_0_1.initAddPage(arg_9_0)
	...
	var_1(var_3.Find(var_9_0, "self_id_bg/Text"), arg_9_0.playerVO.id)
...
function var_0_1.onInitItem(arg_12_0, arg_12_1)
	...
	local function var_12_3()
		...
		i18n = var_2_10004
		var_13_2.placeholder = var_2_10004("friend_request_msg_placeholder")
		i18n = var_4
		var_13_2.title = var_4("friend_request_msg_title")
		...
		function var_13_2.onYes(arg_14_0)
			...
			var_14_1(var_14_0, var_3_10004.ADD_FRIEND, var_12_0.friendVO.id, arg_14_0)
	...
	local function var_12_6()
		...
		var_15_1(var_15_0, var_2_10003.OPEN_RESUME, var_12_0.friendVO.id)
