...
function var_0_1.init(arg_9_0)
	...
	FriendListPage = var_1_10002
	var_9_2[1] = var_1_10002.New(arg_9_0.pages, arg_9_0.event, arg_9_0.contextData)
	...
	for iter_9_0 = 1, arg_9_0.togglesTF.childCount do
		...
		var_9_3(var_9_5, var_9_6, var_9_7, var_1_10010)
	end
	...
	typeof = var_4
	Text = var_6
	arg_9_0.chatTip = var_9_11(var_9_10, var_4(var_6))
...
function var_0_1.didEnter(arg_11_0)
	...
	local var_11_2 = var_4.Find(var_11_1, "blur_panel/adapt/top/back_btn")
	...
	var_1_10002(arg_11_0.toggles[var_11_4], true)
...
function var_0_1.updateRequestTip(arg_18_0)
	...
	var_1_10001(var_3.Find(var_18_0, "tip"), #arg_18_0.requestVOs > 0)
