...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("..level.LevelEliteFleetPanel"))
...
function var_0_1.set(arg_2_0, arg_2_1, arg_2_2)
	...
	var_1_10003(var_2_0, var_2_1, var_2_2, var_1_10008)
	...
	var_1_10003(var_2_3, var_2_4, var_2_5, var_1_10008)
	...
	var_1_10003(var_2_6, var_2_7, var_2_8, var_1_10008)
	...
	var_1_10003(var_2_9, var_2_10, var_2_11, var_1_10008)
	...
	var_1_10003(var_2_12, var_2_13, var_2_14, var_1_10008)
...
function var_0_1.updateCommanderBtn(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_6 = var_5
	local var_11_7 = var_5.Find(var_11_6, "blank")
	local var_11_8 = var_5:Find("commander")

	setActive = var_11_6

	var_11_6(var_11_3, false)

	setActive = var_11_6

	var_11_6(var_11_4, var_11_0 and not arg_11_0.parent.contextData.showCommander)

	setActive = var_11_6

	var_11_6(var_11_5, var_11_0 and not arg_11_0.parent.contextData.showCommander)

	setActive = var_11_6

	var_11_6(var_11_7, not var_11_0 or var_11_0 and not var_11_1 and arg_11_0.parent.contextData.showCommander)
...
function var_0_1.updateFleet(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_2 = arg_12_2 <= arg_12_0.getLimitNums(var_12_1, arg_12_1)
	local var_12_3 = arg_12_0.tfFleets[arg_12_1][arg_12_2]

	findTF = var_12_1

	local var_12_4 = var_12_1(var_12_3, "bg/name")
	local var_12_5 = var_12_3
	local var_12_6 = var_12_3.Find

	TeamType = var_1_10010

	local var_12_7 = var_12_6(var_12_5, var_1_10010.Main)
	local var_12_8 = var_12_3
	local var_12_9 = var_12_3.Find

	TeamType = var_1_10011

	local var_12_10 = var_12_9(var_12_8, var_1_10011.Vanguard)
	local var_12_11 = var_12_3
	local var_12_12 = var_12_3.Find

	TeamType = var_1_10012

	local var_12_13 = var_12_12(var_12_11, var_1_10012.Submarine)
	local var_12_14 = var_12_3:Find("btn_select")
	local var_12_15 = var_12_3:Find("btn_recom")
	local var_12_16 = var_12_3:Find("btn_clear")
	local var_12_17 = var_12_3:Find("blank")
	local var_12_18 = var_12_3
	local var_12_19 = var_12_3.Find(var_12_18, "selected")
	local var_12_20 = var_12_3:Find("commander")

	setActive = var_12_18

	var_12_18(var_12_19, false)
	...
	if var_12_7 then
		...
		var_12_18(var_12_7, var_12_2 and var_12_0)
	end

	if var_12_10 then
		setActive = var_12_18

		var_12_18(var_12_10, var_12_2 and var_12_0)
	end

	if var_12_13 then
		setActive = var_12_18

		var_12_18(var_12_13, var_12_2 and var_12_0)
	end
	...
	if var_12_2 then
		if var_12_0 then
			...
			if var_12_0.name == "" then
				...
				if not var_19.DEFAULT_NAME[var_12_0.id] then
					var_12_22 = var_12_0.name
				end

				var_12_18(var_12_21, var_12_22)

				FleetType = var_12_18

				if arg_12_1 == var_12_18.Submarine then
					local var_12_23 = arg_12_0

					var_12_18 = arg_12_0.updateShips

					local var_12_24 = var_12_13
					local var_12_25 = var_12_0.subShips

					var_1_10021 = var_12_0.id
					TeamType = var_1_10022

					var_12_18(var_12_23, var_12_24, var_12_25, var_1_10021, var_1_10022.Submarine, var_12_0)
				else
					local var_12_26 = arg_12_0

					var_12_18 = arg_12_0.updateShips

					local var_12_27 = var_12_7
					local var_12_28 = var_12_0.mainShips

					var_1_10021 = var_12_0.id
					TeamType = var_1_10022

					var_12_18(var_12_26, var_12_27, var_12_28, var_1_10021, var_1_10022.Main, var_12_0)

					local var_12_29 = arg_12_0

					var_12_18 = arg_12_0.updateShips

					local var_12_30 = var_12_10
					local var_12_31 = var_12_0.vanguardShips

					var_1_10021 = var_12_0.id
					TeamType = var_22

					var_12_18(var_12_29, var_12_30, var_12_31, var_1_10021, var_22.Vanguard, var_12_0)
				end

				arg_12_0:updateCommanders(var_12_20, var_12_0)

				onButton = var_12_18

				var_12_18(arg_12_0, var_12_15, function()
				...
				local var_12_32 = arg_12_0
				local var_12_33 = var_12_16
				...
				SFX_UI_CLICK = var_1_10021

				var_12_18(var_12_32, var_12_33, var_12_34, var_1_10021)
...
function var_0_1.updateCommanders(arg_15_0, arg_15_1, arg_15_2)
	for iter_15_0 = 1, 2 do
		...
		var_15_1(var_15_2, not var_15_0)

		setActive = var_15_1

		var_15_1(var_15_4, var_15_0)

		if var_15_0 then
			Commander = var_15_1
			var_15_1 = var_15_1.rarity2Frame

			local var_15_5 = var_15_0

			var_15_1 = var_15_1(var_15_0.getRarity(var_15_5))
			setImageSprite = var_15_3
			var_1_10016 = var_15_4

			local var_15_6 = var_15_4.Find(var_1_10016, "frame")

			GetSpriteFromAtlas = var_15_5

			var_15_3(var_15_6, var_15_5("weaponframes", "commander_" .. var_15_1))

			GetImageSpriteFromAtlasAsync = var_15_3

			var_15_3("CommanderHrz/" .. var_15_0:getPainting(), "", var_15_4:Find("mask/icon"))
		end
		...
		var_15_1(var_15_7, var_15_8, var_15_9, var_1_10016)

		onButton = var_15_1

		local var_15_10 = arg_15_0
		local var_15_11 = var_15_4
		...
		var_15_1(var_15_10, var_15_11, var_15_12, var_1_10016)
	end
...
function var_0_1.updateShips(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4, arg_18_5)
	...
	var_6.make(var_18_0, function(arg_19_0, arg_19_1, arg_19_2)
		...
		if arg_19_0 == var_2_10003.EventUpdate then
			...
			local var_19_0 = var_3(var_2_10005)

			if var_3.getShipById(var_19_0, arg_18_2[arg_19_1 + 1]) then
				setActive = var_2_10005

				var_2_10005(arg_19_2:Find("icon_bg"), true)

				setActive = var_2_10005

				var_2_10005(arg_19_2:Find("empty"), false)

				updateShip = var_2_10005

				var_2_10005(arg_19_2, var_4)
			else
				setActive = var_2_10005

				var_2_10005(arg_19_2:Find("icon_bg"), false)

				setActive = var_2_10005

				var_2_10005(arg_19_2:Find("empty"), true)
			end

			setActive = var_2_10005
			findTF = var_7

			var_2_10005(var_7(arg_19_2, "ship_type"), false)
			...
			local var_19_2 = var_2_10005(var_19_1, var_8(var_10))
			...
			var_7.AddListener(var_19_7, function()
				if var_0 then
					...
					local var_22_2 = var_3_10003.map
					local var_22_3 = arg_18_5

					var_22_0(var_22_1, var_22_2(var_5.getShipIds(var_22_3), function(arg_23_0)
...
function var_0_1.showToggleMask(arg_24_0, arg_24_1, arg_24_2)
	...
	for iter_24_0, iter_24_1 in var_1_10004(arg_24_0.toggles) do
		...
		if var_24_1 then
			...
			setButtonEnabled = var_24_5

			var_24_5(iter_24_1, var_1_10010)

			setActive = var_24_5

			var_24_5(var_24_4, not var_1_10010)

			local var_24_5

			if var_1_10010 then
				table = var_24_5
				var_24_5 = var_24_5.contains(arg_24_0.selectIds[arg_24_1], var_24_1.id)
				setActive = var_24_3
				findTF = var_16

				var_24_3(var_16(iter_24_1, "selected"), var_24_5)

				setActive = var_24_3
				findTF = var_16

				var_24_3(var_16(iter_24_1, "text"), not var_24_5)

				setActive = var_24_3
				findTF = var_16

				var_24_3(var_16(iter_24_1, "text_selected"), var_24_5)

				onButton = var_24_3

				local var_24_6 = arg_24_0
				local var_24_7 = iter_24_1
				...
				var_24_3(var_24_6, var_24_7, var_1_10018, var_19)
			else
				onButton = var_24_5

				local var_24_8 = arg_24_0
				local var_24_9 = var_24_4
				...
				var_24_5(var_24_8, var_24_9, var_24_10, var_1_10018)
			end
		end
	end
...
function var_0_1.setFleets(arg_29_0, arg_29_1)
	...
	for iter_29_0, iter_29_1 in var_29_0(arg_29_1) do
		...
		if iter_29_1:isSubmarineFleet() then
			...
			var_29_1(var_29_2[var_1_10010.Submarine], iter_29_1)
		else
			table = var_29_1
			...
			var_29_3(var_29_4[var_1_10010.Normal], iter_29_1)
		end
	end
...
function var_0_1.clearFleet(arg_32_0, arg_32_1)
	...
	local var_32_2 = var_32_1(var_32_0, var_1_10005.Main)
	local var_32_3 = arg_32_1
	local var_32_4 = arg_32_1.Find

	TeamType = var_1_10006

	local var_32_5 = var_32_4(var_32_3, var_1_10006.Vanguard)
	local var_32_6 = arg_32_1
	local var_32_7 = arg_32_1.Find

	TeamType = var_1_10007

	local var_32_8 = var_32_7(var_32_6, var_1_10007.Submarine)

	if var_32_2 then
		removeAllChildren = var_32_3
