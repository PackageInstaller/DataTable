...
function var_0_0.Update(arg_2_0)
	...
	elseif arg_2_0.info.flag == ChapterConst.CellFlagDisabled and arg_2_0.state ~= var_0_0.StateDead then
		...
		if not IsNil(arg_2_0.enemy) then
			setActive(findTF(arg_2_0.enemy, "lv"), true)
			setActive(findTF(arg_2_0.enemy, "titleContain"), true)
			setActive(findTF(arg_2_0.enemy, "damage_count"), true)
			setActive(findTF(arg_2_0.enemy, "fighting"), true)
		end
...
function var_0_0.DestroyGO(arg_5_0)
	if not IsNil(arg_5_0.enemy) then
		setActive(findTF(arg_5_0.enemy, "lv"), true)
		setActive(findTF(arg_5_0.enemy, "titleContain"), true)
		setActive(findTF(arg_5_0.enemy, "damage_count"), true)
		setActive(findTF(arg_5_0.enemy, "fighting"), true)
	end
