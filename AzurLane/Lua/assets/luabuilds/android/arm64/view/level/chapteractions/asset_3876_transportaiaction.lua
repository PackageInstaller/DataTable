...
function var_0_0.applyTo(arg_4_0, arg_4_1, arg_4_2)
	...
	if var_4_1(var_4_0, var_1_10006.Transport, arg_4_0.line.row, arg_4_0.line.column) then
...
function var_0_0.applyToFleet(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	if #arg_5_0.movePath > 0 then
		...
		if not arg_5_3 then
			...
			local var_5_5 = var_1_10010.DirtyFleet

			ChapterConst = var_1_10011

			local var_5_6 = var_1_10011.DirtyAttachment

			ChapterConst = var_1_10012
			var_5_1 = var_5_3(var_5_4, var_5_5, var_5_6, var_1_10012.DirtyChampionPosition)
		end
	end
	...
	if arg_5_0.hp and not arg_5_3 then
		...
		ChapterConst = var_9
		var_5_1 = var_5_7(var_5_8, var_9.DirtyFleet)

		local var_5_9 = arg_5_1

		if arg_5_1.getChapterCell(var_5_9, arg_5_2.line.row, arg_5_2.line.column) then
			local var_5_10 = var_6.attachment

			ChapterConst = var_5_9

			if var_5_10 == var_5_9.AttachBox then
				local var_5_11 = var_6.flag

				ChapterConst = var_8

				if var_5_11 ~= var_8.CellFlagDisabled then
					pg = var_5_11

					local var_5_12 = var_5_11.box_data_template[var_6.attachmentId].type

					ChapterConst = var_9

					if var_5_12 == var_9.BoxTorpedo then
						ChapterConst = var_5_12
						var_6.flag = var_5_12.CellFlagDisabled

						arg_5_1:clearChapterCell(var_6.row, var_6.column)

						bit = var_8

						local var_5_13 = var_8.bor
						local var_5_14 = var_5_1

						ChapterConst = var_11
						var_5_1 = var_5_13(var_5_14, var_11.DirtyAttachment)
					end
				end
			end
		end
...
function var_0_0.PlayAIAction(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	if var_7_1(var_7_0, var_1_10007.Transport, arg_7_0.line.row, arg_7_0.line.column) then
		if #arg_7_0.movePath > 0 then
			...
			var_7_3(var_7_2, var_7_4, var_7_5, var_1_10010(arg_7_0.movePath), arg_7_3)
		else
			local var_7_6 = arg_7_1.fleets[var_4]
			local var_7_7 = arg_7_1

			if arg_7_1.getChapterCell(var_7_7, var_7_6.line.row, var_7_6.line.column) then
				local var_7_8 = var_6.attachment

				ChapterConst = var_7_7

				if var_7_8 == var_7_7.AttachBox then
					local var_7_9 = var_6.flag

					ChapterConst = var_8

					if var_7_9 ~= var_8.CellFlagDisabled then
						pg = var_7_9

						local var_7_10 = var_7_9.box_data_template[var_6.attachmentId].type

						ChapterConst = var_9

						if var_7_10 == var_9.BoxTorpedo then
							local var_7_11 = arg_7_2.viewComponent

							var_8.doPlayTorpedo(var_7_11, arg_7_3)
