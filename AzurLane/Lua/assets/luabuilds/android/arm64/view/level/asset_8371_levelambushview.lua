...
function var_0_1.InitData(arg_3_0)
	...
	pg = var_1_10002
	arg_3_0.template = var_1_10002.expedition_data_template[var_3_1.attachmentId]
...
function var_0_1.InitUI(arg_4_0)
	...
	local var_4_1 = var_1_10002(arg_4_0._tf, "window/ship/lv/Text")
	...
	local var_4_7 = var_10.floor
	local var_4_8 = arg_4_0.chapter

	var_7(var_4_6, var_4_7(var_12.getAmbushDodge(var_4_8, arg_4_0.fleet) * 100) .. "%")
	...
	local function var_4_11()
		...
		local var_5_2 = var_2_10003.ON_OP
		local var_5_3 = {
			arg1 = 0
		}

		ChapterConst = var_2_10005
		var_5_3.type = var_2_10005.OpAmbush
	...
	SFX_UI_WEIGHANCHOR_ATTACK = var_12

	var_7(var_4_9, var_4_10, var_4_11, var_12)
	...
	local function var_4_14()
		...
		local var_6_2 = var_2_10003.ON_OP
		local var_6_3 = {
			arg1 = 1
		}

		ChapterConst = var_2_10005
		var_6_3.type = var_2_10005.OpAmbush
	...
	SFX_UI_WEIGHANCHOR_AVOID = var_12

	var_7(var_4_12, var_4_13, var_4_14, var_12)
	...
	var_4_16(var_4_15, var_10.Action(arg_4_0.onComplete))
