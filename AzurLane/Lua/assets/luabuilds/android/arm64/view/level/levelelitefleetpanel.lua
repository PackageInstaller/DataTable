...
function var_0_1.init(arg_1_0)
	...
	local var_1_3 = var_1_10002.Normal
	local var_1_4 = {}
...
function var_0_1.set(arg_2_0, arg_2_1)
	...
	arg_2_0.suggestionValue = var_2_3(var_4.getConfig(var_2_4, "best_air_dominance"), 150)
	...
	SFX_UI_WEIGHANCHOR_GO = var_7

	var_2(var_2_7, var_2_8, var_2_9, var_7)
	...
	local function var_2_12()
		...
		i18n = var_2_10004
		var_4_2.helps = var_2_10004("help_battle_ac")
	...
	var_2(var_2_10, var_2_11, var_2_12, var_7)
	...
	var_2(var_2_13, var_2_14, var_2_15, var_7)
	...
	var_2(var_2_16, var_2_17, var_2_18, var_7)
	...
	var_2(var_2_19, var_2_20, var_2_21, var_7)
...
function var_0_1.flush(arg_9_0)
	...
	if var_1 and arg_9_0.chapterADValue > 0 then
		...
		var_1(var_3.Find(var_9_0, "panel/title/ADvalue"), true)
		...
		var_1(var_3.Find(var_9_1, "panel/title/ADvalue"), false)
	end
...
function var_0_1.updateLimit(arg_10_0)
	...
	if #arg_10_0.propetyLimitation > 0 then
		...
		for iter_10_0, iter_10_1 in var_10_0(arg_10_0.propetyLimitation) do
			unpack = var_1_10008
			...
			if var_10_1[iter_10_0] == 1 then
				...
				typeof = var_16
				Text = var_1_10018
				var_10_7 = var_10_7(var_10_6, var_16(var_1_10018))
				Color = var_14
				var_10_7.color = var_14.New(1, 0.9607843137254902, 0.5019607843137255)
			else
				...
				typeof = var_16
				Text = var_1_10018
				var_10_7 = var_10_7(var_10_8, var_16(var_1_10018))
				Color = var_14
				var_10_7.color = var_14.New(0.9568627450980393, 0.30196078431372547, 0.30196078431372547)
			end
			...
			var_14(var_1_10012.Find(var_1_10018, "Text"), var_10_10)
		end

		setActive = var_3

		local var_10_11 = arg_10_0.tfLimitElite
		local var_10_12 = var_5.Find(var_10_11, "sub")
		local var_10_13 = arg_10_0.chapter

		var_3(var_10_12, var_6.getConfig(var_10_13, "submarine_num") > 0)
	end
...
function var_0_1.updateFleetPanelADValue(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1_10003(arg_11_0.eliteFleetList) do
		...
		for iter_11_2, iter_11_3 in var_1_10009(arg_11_0.eliteCommanderList[iter_11_0]) do
			...
			var_11_2[iter_11_2] = var_1_10014.getCommanderById(var_1_10016, iter_11_3)
		end
	...
	var_4(var_11_6, iter_11_1("level_scene_title_word_5"))

	setText = var_4

	local var_11_7 = var_11_5:Find("Num1")

	setColorStr = var_7

	local var_11_8 = var_11_3
	local var_11_9

	if var_11_3 < arg_11_0.suggestionValue then
		var_11_9 = "#f1dc36"
	else
		COLOR_WHITE = var_11_9
	end

	var_4(var_11_7, var_7(var_11_8, var_11_9))

	setText = var_4

	var_4(var_11_5:Find("Num2"), arg_11_0.suggestionValue)
...
function var_0_1.initAddButton(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	...
	var_11.sort(arg_12_3, function(arg_13_0, arg_13_1)
		...
		if var_13_0 == var_2_10003(arg_13_1) then
	...
	for iter_12_2 = 1, 3 do
		...
		if var_12_10 then
			...
			if var_12_10 then
				...
				var_1_10022(var_1_10021.Find(var_1_10026, "event_block"), var_12_10:getFlag("inEvent"))
			...
			var_1_10022(var_1_10021.Find(var_1_10026, "ship_type"), true)
			...
			if var_1_10022(var_12_11) == "number" then
				if var_12_11 ~= 0 then
					...
					ShipType = var_25
					var_1_10022 = var_1_10022(var_12_14, var_25.Type2CNLabel(var_12_11))
					...
					var_1_10022(var_1_10021.Find(var_1_10026, "ship_type"), false)
				end
			else
				type = var_1_10022
				...
				if var_1_10022(var_12_11) == "string" then
					...
					local var_12_15 = "shiptype"

					ShipType = var_25
					var_1_10022 = var_1_10022(var_12_15, var_25.BundleType2CNLabel(var_12_11))
					setImageSprite = var_1_10023
			...
			var_1_10022(var_1_10021.Find(var_1_10026, "ship_type"), not var_12_10 and var_12_11 ~= 0)
			...
			var_1_10023.sort(var_1_10022, function(arg_15_0, arg_15_1)
			...
			local var_12_16 = var_12_13

			typeof = var_1_10026
			UILongPressTrigger = var_1_10028
			var_1_10026 = var_1_10023(var_12_16, var_1_10026(var_1_10028)).onReleased
			...
			var_1_10026 = var_1_10023.onReleased
	...
	for iter_12_5 = 3, 1, -1 do
		local var_12_17 = var_12_8[iter_12_5]

		var_17.SetSiblingIndex(var_12_17, var_12_7[iter_12_5] - 1)
	end
...
function var_0_1.initCommander(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	for iter_18_0 = 1, 2 do
		...
		if var_18_1 then
			...
			CommanderProxy = var_1_10014
			var_1_10014 = var_1_10012(var_1_10014)
			var_18_2 = var_1_10012.getCommanderById(var_1_10014, var_18_1)
		end

		var_1_10014 = arg_18_2

		local var_18_3 = arg_18_2.Find(var_1_10014, "pos" .. iter_18_0)
		local var_18_4 = var_1_10012.Find(var_18_3, "add")
		local var_18_5 = var_1_10012

		var_1_10014 = var_1_10012.Find(var_18_5, "info")
		setActive = var_18_3

		var_18_3(var_18_4, not var_18_2)

		setActive = var_18_3

		var_18_3(var_1_10014, var_18_2)

		if var_18_2 then
			Commander = var_18_3

			local var_18_6 = var_18_3.rarity2Frame
			local var_18_7 = var_18_2
			local var_18_8 = var_18_6(var_18_2.getRarity(var_18_7))

			setImageSprite = var_18_5

			local var_18_9 = var_1_10014:Find("frame")

			GetSpriteFromAtlas = var_18_7

			var_18_5(var_18_9, var_18_7("weaponframes", "commander_" .. var_18_8))

			GetImageSpriteFromAtlasAsync = var_18_5

			local var_18_10 = "CommanderHrz/"

			var_1_10021 = var_18_2

			var_18_5(var_18_10 .. var_18_2.getPainting(var_1_10021), "", var_1_10014:Find("mask/icon"))
		end

		local var_18_11 = arg_18_3:wrapEliteFleet(arg_18_1)

		onButton = var_18_5

		local var_18_12 = arg_18_0
		local var_18_13 = var_18_4

		local function var_18_14()
			local var_19_0 = arg_18_0.parent

			var_0.openCommanderPanel(var_19_0, var_18_11, arg_18_3.id, arg_18_1)
		...
		var_18_5(var_18_12, var_18_13, var_18_14, var_1_10021)

		onButton = var_18_5

		local var_18_15 = arg_18_0
		local var_18_16 = var_1_10014

		local function var_18_17()
			local var_20_0 = arg_18_0.parent

			var_0.openCommanderPanel(var_20_0, var_18_11, arg_18_3.id, arg_18_1)
		...
		var_18_5(var_18_15, var_18_16, var_18_17, var_1_10021)
	end
...
function var_0_1.updateFleets(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10001(var_21_0[var_1_10004.Normal]) do
		...
		local var_21_5 = iter_21_1.Find(var_21_4, "blank")
		local var_21_6 = iter_21_1
		local var_21_7 = iter_21_1.Find(var_21_6, "commander")

		setActive = var_21_4

		var_21_4(var_21_3, false)

		setActive = var_21_4
		findTF = var_13

		var_21_4(var_13(iter_21_1, "selected"), false)

		local var_21_8 = arg_21_0.chapter
		local var_21_9 = iter_21_0 <= var_11.getConfig(var_21_8, "group_num")
		...
		var_21_6(var_14(var_21_10, var_1_10017.Main), var_21_9)
		...
		var_21_6(var_14(var_21_11, var_1_10017.Vanguard), var_21_9)

		setActive = var_21_6

		var_21_6(var_21_1, var_21_9 and not arg_21_0.contextData.EditingCommander)

		setActive = var_21_6

		var_21_6(var_21_2, var_21_9 and not arg_21_0.contextData.EditingCommander)

		setActive = var_21_6

		var_21_6(var_21_5, not var_21_9)

		setActive = var_21_6

		var_21_6(var_21_7, var_21_9 and arg_21_0.contextData.EditingCommander)

		setText = var_21_6

		local var_21_12 = iter_21_1:Find("bg/name")
		...
		if var_21_9 then
			...
			if not var_15.DEFAULT_NAME[iter_21_0] then
				var_21_13 = ""
			end

			var_21_6(var_21_12, var_21_13)

			if var_21_9 then
				local var_21_14 = arg_21_0.typeLimitations[iter_21_0][1]
				local var_21_15 = var_12[2]

				var_1_10017 = arg_21_0

				local var_21_16 = arg_21_0.initAddButton
				local var_21_17 = iter_21_1
				local var_21_18 = iter_21_1.Find

				TeamType = var_1_10021

				local var_21_19 = var_21_18(var_21_17, var_1_10021.Main)

				TeamType = var_1_10019

				local var_21_20 = var_21_16(var_1_10017, var_21_19, var_1_10019.Main, var_21_14, iter_21_0)
				local var_21_21 = arg_21_0
				local var_21_22 = arg_21_0.initAddButton

				var_1_10021 = iter_21_1
				var_1_10019 = iter_21_1.Find
				TeamType = var_1_10022
				var_1_10019 = var_1_10019(var_1_10021, var_1_10022.Vanguard)
				TeamType = var_20

				local var_21_23 = var_21_22(var_21_21, var_1_10019, var_20.Vanguard, var_21_15, iter_21_0)

				var_1_10019 = arg_21_0

				arg_21_0.initCommander(var_1_10019, iter_21_0, var_21_7, arg_21_0.chapter)

				if var_21_20 and var_21_23 then
					setActive = var_1_10017
					var_1_10021 = iter_21_1

					var_1_10017(iter_21_1.Find(var_1_10021, "selected"), true)
				end

				onButton = var_1_10017

				var_1_10017(arg_21_0, var_21_1, function()
					if #arg_21_0.eliteFleetList[iter_21_0] ~= 0 then
						...
						i18n = var_2_10004
						var_22_2.content = var_2_10004("battle_preCombatLayer_clear_confirm")
				...
				var_1_10017(arg_21_0, var_21_2, function()
					if #arg_21_0.eliteFleetList[iter_21_0] ~= 6 then
						if var_0 ~= 0 then
							...
							i18n = var_2_10005
							var_24_2.content = var_2_10005("battle_preCombatLayer_auto_confirm")
	...
	local var_21_24 = arg_21_0.tfFleets

	FleetType = iter_21_0

	for iter_21_2, iter_21_3 in var_1(var_21_24[iter_21_0.Submarine]) do
		local var_21_25 = iter_21_2 + 2
		local var_21_26 = iter_21_3:Find("btn_clear")
		local var_21_27 = iter_21_3:Find("btn_recom")
		local var_21_28 = iter_21_3:Find("btn_select")
		local var_21_29 = iter_21_3
		local var_21_30 = iter_21_3.Find(var_21_29, "blank")
		local var_21_31 = iter_21_3
		local var_21_32 = iter_21_3.Find(var_21_31, "commander")

		setActive = var_21_29

		var_21_29(var_21_28, false)

		setActive = var_21_29
		findTF = var_14

		var_21_29(var_14(iter_21_3, "selected"), false)
		...
		local var_21_34 = var_14(var_21_33, var_17.Submarine)
		local var_21_35 = arg_21_0.chapter

		var_21_29(var_21_34, iter_21_2 <= var_15.getConfig(var_21_35, "submarine_num"))

		setActive = var_21_29

		local var_21_36 = var_21_26
		local var_21_37 = arg_21_0.chapter

		var_21_29(var_21_36, iter_21_2 <= var_15.getConfig(var_21_37, "submarine_num") and not arg_21_0.contextData.EditingCommander)

		setActive = var_21_29

		local var_21_38 = var_21_27
		local var_21_39 = arg_21_0.chapter

		var_21_29(var_21_38, iter_21_2 <= var_15.getConfig(var_21_39, "submarine_num") and not arg_21_0.contextData.EditingCommander)
		...
		var_21_29(var_21_40, iter_21_2 > var_15.getConfig(var_21_41, "submarine_num"))
		...
		var_21_29(var_21_42, iter_21_2 <= var_15.getConfig(var_21_43, "submarine_num") and arg_21_0.contextData.EditingCommander)

		setText = var_21_29

		local var_21_44 = iter_21_3
		local var_21_45 = iter_21_3.Find(var_21_44, "bg/name")
		local var_21_46 = arg_21_0.chapter

		if iter_21_2 <= var_15.getConfig(var_21_46, "submarine_num") then
			Fleet = var_15

			local var_21_47 = var_15.DEFAULT_NAME

			Fleet = var_21_44

			local var_21_48

			if not var_21_47[var_21_44.SUBMARINE_FLEET_ID + iter_21_2 - 1] then
				var_21_48 = ""
			end

			var_21_29(var_21_45, var_21_48)
			arg_21_0:initCommander(var_21_25, var_21_32, arg_21_0.chapter)

			local var_21_49 = arg_21_0.chapter

			if iter_21_2 <= var_12.getConfig(var_21_49, "submarine_num") then
				local var_21_50 = arg_21_0
				local var_21_51 = arg_21_0.initAddButton
				local var_21_52 = iter_21_3
				local var_21_53 = iter_21_3.Find

				TeamType = var_18

				local var_21_54 = var_21_53(var_21_52, var_18.Main)

				TeamType = var_16

				if var_21_51(var_21_50, var_21_54, var_16.Submarine, {
					0,
					0,
					0
				}, var_21_25) then
					...
					var_21_31(iter_21_3:Find("selected"), true)
				end

				onButton = var_21_31

				var_21_31(arg_21_0, var_21_26, function()
					if #arg_21_0.eliteFleetList[var_21_25] ~= 0 then
						pg = var_0
						...
						i18n = var_2_10004
						var_26_2.content = var_2_10004("battle_preCombatLayer_clear_confirm")
				...
				var_21_31(arg_21_0, var_21_27, function()
					if #arg_21_0.eliteFleetList[var_21_25] ~= 3 then
						if var_0 ~= 0 then
							pg = var_1
							...
							i18n = var_2_10005
							var_28_2.content = var_2_10005("battle_preCombatLayer_auto_confirm")
