...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".LevelInfoView"))
...
function var_0_1.InitUI(arg_2_0)
	...
	arg_2_0.tfAnim = var_2_4(var_2_3, var_4(var_1_10006))
	...
	arg_2_0.tfAniEvent = var_2_6(var_2_5, var_4(var_1_10006))
	...
	typeof = var_4
	Animation = var_1_10006
	arg_2_0.btnAnim = var_2_11(var_2_10, var_4(var_1_10006))
	...
	typeof = var_4
	DftAniEvent = var_1_10006
	arg_2_0.btnAniEvent = var_2_14(var_2_13, var_4(var_1_10006))
...
function var_0_1.set(arg_9_0, arg_9_1, arg_9_2)
	...
	for iter_9_0, iter_9_1 in var_8(var_9_3) do
		...
		var_1_10013(var_15.Find(var_9_6, iter_9_1), iter_9_0 == var_9_4)
	end
	...
	for iter_9_2, iter_9_3 in var_8(var_9_3) do
		...
		var_1_10013(var_15.Find(var_9_7, iter_9_3), iter_9_2 == var_9_4)
	end
	...
	if 1 < var_9_8 then
		...
		for iter_9_4 = 1, 2 do
			local var_9_9 = var_9_8:Find("Bonus" .. iter_9_4)

			getProxy = var_1_10014
			ChapterProxy = var_16

			local var_9_10 = var_1_10014(var_16)
			local var_9_11 = var_1_10014.getChapterById(var_9_10, var_9_2[iter_9_4], true)
			local var_9_12 = var_1_10014.GetDailyBonusQuota(var_9_11)
			...
			if var_9_12 then
				...
				local var_9_13 = var_9_10(var_18)
				local var_9_14 = var_16.getMapById(var_9_13, var_1_10014:getConfig("map"))
				local var_9_15 = var_16.getConfig(var_9_14, "type")

				Map = var_9_13

				local var_9_16 = var_9_15 == var_9_13.ACTIVITY_HARD and "bonus_us_hard" or "bonus_us"
				local var_9_17 = arg_9_0.loader

				var_19.GetSprite(var_9_17, "ui/levelmainscene_atlas", var_9_16, var_9_9:Find("Image"))
			end
		end
	end
	...
	if var_9_4 == 1 then
		...
		local var_9_18 = arg_9_0.txTitle

		var_9(var_11.Find(var_9_18, "title_index"), var_9_8)

		setTextColor = var_9

		local var_9_19 = arg_9_0.txTitle

		var_9(var_11.Find(var_9_19, "title"), var_9_8)

		setTextColor = var_9

		local var_9_20 = arg_9_0.txTitle

		var_9(var_11.Find(var_9_20, "title_en"), var_9_8)

		local var_9_21 = var_9_1
		local var_9_22 = var_9_1.getConfig(var_9_21, "boss_expedition_id")
		local var_9_23 = var_9_1:getPlayType()

		ChapterConst = var_9_21

		if var_9_23 == var_9_21.TypeMultiStageBoss then
			pg = var_9_23
			var_9_22 = var_9_23.chapter_model_multistageboss[var_9_1.id].boss_expedition_id
		end

		pg = var_9_23

		local var_9_24 = var_9_23.expedition_data_template[var_9_22[#var_9_22]].level

		setText = var_11

		local var_9_25 = arg_9_0.levelBanner

		var_11(var_13.Find(var_9_25, "Text"), "LV " .. var_9_24)

		onButton = var_11

		local var_9_26 = arg_9_0
		local var_9_27 = arg_9_0.btnSwitchNormal
		local var_9_28 = var_14.Find(var_9_27, "Switch")
		...
		local function var_9_29()
			...
			var_10_1(var_10_0, var_3.SWITCH_SPCHAPTER_DIFFICULTY, var_9_5)
		...
		var_11(var_9_26, var_9_28, var_9_29, var_9_27)

		onButton = var_11

		local var_9_30 = arg_9_0
		local var_9_31 = arg_9_0.btnSwitchHard
		local var_9_32 = var_14.Find(var_9_31, "Switch")
		...
		local function var_9_33()
			...
			var_11_1(var_11_0, var_3.SWITCH_SPCHAPTER_DIFFICULTY, var_9_5)
		...
		var_11(var_9_30, var_9_32, var_9_33, var_9_31)
		;(function()
