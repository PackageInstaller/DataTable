...
function var_0_0.applyTo(arg_4_0, arg_4_1, arg_4_2)
	...
	if var_4_1(var_4_0, var_1_10006.Normal, arg_4_0.line.row, arg_4_0.line.column) then
	...
	if arg_5_1:isPlayingWithBombEnemy() then
		if not arg_5_3 then
			...
			var_5.each(arg_5_0.cellUpdates, function(arg_6_0)
				...
				ChapterConst = var_6_0

				if var_6_1 == var_6_0.CellFlagActive then
				...
				ChapterConst = var_5
				var_5_0 = var_6_5(var_6_6, var_5.DirtyAttachment)
	...
	elseif arg_5_0.target then
		...
		if not arg_5_3 then
			...
			if arg_5_0.shipUpdate then
				...
				var_5_0 = var_5_2(var_5_3, var_1_10009.DirtyFleet)
			end
			...
			if var_5_1 then
				...
				if var_5_2(var_5_4, var_1_10009) then
					...
					ChapterConst = var_1_10009
					var_5_0 = var_5_5(var_5_6, var_1_10009.DirtyChampion)
				else
					...
					ChapterConst = var_1_10009
					var_5_0 = var_5_5(var_5_7, var_1_10009.DirtyAttachment)
				end
				...
				ChapterConst = var_1_10009
				var_5_0 = var_5_8(var_5_9, var_1_10009.DirtyFleet)
			end
		end
	end
...
function var_0_0.PlayAIAction(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	local var_9_2 = var_9_1(var_9_0, var_1_10007.Normal, arg_9_0.line.row, arg_9_0.line.column)
	...
	if arg_9_1.isPlayingWithBombEnemy(var_9_3) then
		...
		var_9_0 = arg_9_1:getMapShip(var_9_4)

		local var_9_5 = arg_9_2.viewComponent

		var_9_3.doPlayStrikeAnim(var_9_5, var_9_0, var_9_0:GetMapStrikeAnim(), arg_9_3)
	else
		local var_9_6 = arg_9_0.actType

		ChapterConst = var_9_0

		if var_9_6 == var_9_0.ActType_Poison then
			arg_9_3()
		elseif arg_9_0.target then
			...
			var_9_3(var_9_8, "can not find cell")
			...
			if var_9_9 == var_8.AttachLandbase then
				...
				if var_9_10 == var_9.LBCoastalGun then
					var_9_11 = arg_9_1
					var_9_10 = arg_9_1.getMapShip(var_9_11, var_9_7)

					local var_9_12 = arg_9_2.viewComponent

					var_9.doPlayStrikeAnim(var_9_12, var_9_10, var_9_10:GetMapStrikeAnim(), arg_9_3)
				else
					assert = var_9_10
			...
			local var_9_13 = "-" .. var_9_8.data / 100 .. "%"
			local var_9_14 = arg_9_0.commanderSkillEffectId
			local var_9_15 = var_9_7
			local var_9_16 = var_9_7.getSkill(var_9_15, var_9_14)

			assert = var_9_11

			var_9_11(var_9_16, "can not find skill: " .. var_9_14)

			local var_9_17 = var_9_7:findCommanderBySkillId(var_9_14)

			assert = var_9_15

			var_9_15(var_9_17, "command can not find by skill id: " .. var_9_14)

			local var_9_18 = arg_9_2.viewComponent

			var_11.doPlayCommander(var_9_18, var_9_17, function()
				local var_11_0 = var_9_16
				local var_11_1 = var_0.GetType(var_11_0)

				FleetSkill = var_2_10001

				if var_11_1 == var_2_10001.TypeAirStrikeDodge then
					...
					local var_11_3 = var_9_16
					local var_11_4 = var_0.GetType(var_11_3)

					FleetSkill = var_1

					if var_11_4 == var_1.TypeAttack then
						local var_11_5 = var_9_16
						...
						var_11_8(var_11_7, var_5.getStrikeAnimShip(var_11_9, var_9_7, var_11_6), var_11_6, function()
							local var_15_0 = arg_9_2.viewComponent

							var_0.strikeEnemy(var_15_0, arg_9_0.target, var_9_13, arg_9_3)
