...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".EnemyCellView"))
...
function var_0_1.InitEggCellTransform(arg_1_0)
	...
	var_1(var_1_7, var_4("ui_word_levelui2_inevent"))
	...
	typeof = var_4
	Animator = var_6
	arg_1_0.animator = var_1(var_1_9, var_4(var_6))
...
function var_0_1.UpdateEggCell(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	...
	if var_3_2 ~= var_1_10008.TraitLurk then
		...
		if var_3_3 == var_8.CellFlagActive then
			...
			local var_3_4 = arg_3_1.existFleet

			FleetType = var_1_10010
			var_3_5 = not var_3_4(var_1_10009, var_1_10010.Transport, var_3_0, var_3_1)
	...
	local var_3_7 = arg_3_1.existEnemy

	ChapterConst = var_1_10011

	local var_3_8 = var_3_7(var_3_6, var_1_10011.SubjectChampion, var_3_0, var_3_1)

	setActive = var_1_10009

	var_1_10009(arg_3_0.tfFighting, var_3_5 and var_3_8)

	local var_3_9 = arg_3_0.animator

	var_3_9.enabled = var_3_5 and arg_3_2.data > 0
	setActive = var_3_9

	var_3_9(arg_3_0.tfDamageCount, var_3_5 and arg_3_2.data > 0)

	setActive = var_3_9

	var_3_9(arg_3_0.effectFireball, false)

	local var_3_10 = arg_3_2.trait

	ChapterConst = var_10

	if var_3_10 == var_10.TraitVirgin then
		pg = var_3_10

		local var_3_11 = var_3_10.CriMgr.GetInstance()

		var_3_10 = var_3_10.PlaySoundEffect_V3
		SFX_UI_WEIGHANCHOR_ENEMY = var_12

		var_3_10(var_3_11, var_12)
	end

	if var_3_5 then
		EnemyCellView = var_3_10

		var_3_10.RefreshEnemyTplIcons(arg_3_0, arg_3_3, arg_3_1)
	end

	local var_3_12 = arg_3_0

	arg_3_0.SetActive(var_3_12, var_3_5)

	local var_3_13 = arg_3_2.trait

	ChapterConst = var_10

	local var_3_14 = var_3_13 == var_10.TraitVirgin

	ChapterConst = var_10

	local var_3_15 = var_10.IsBossCell(arg_3_2)

	setActive = var_3_12

	var_3_12(arg_3_0.tfEffectFound, var_3_14 and not var_3_15)

	setActive = var_3_12

	var_3_12(arg_3_0.tfEffectFoundBoss, var_3_14 and var_3_15)

	if var_3_14 then
		pg = var_3_12

		local var_3_16 = var_3_12.CriMgr.GetInstance()

		var_3_12 = var_3_12.PlaySoundEffect_V3
		SFX_UI_WEIGHANCHOR_ENEMY = var_14

		var_3_12(var_3_16, var_14)
	end
