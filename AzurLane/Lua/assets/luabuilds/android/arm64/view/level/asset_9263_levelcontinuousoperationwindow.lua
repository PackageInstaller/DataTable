...
function var_0_1.init(arg_3_0)
	...
	var_1(var_3_19, var_4("multiple_sorties_main_tip"))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_4.Find(var_4_1, "window/top/btnBack")
	...
	defaultValue = var_4_6
	var_4_9.useTicket = var_4_6(arg_4_0.contextData.useTicket, var_4_8)
	triggerToggle = var_4_9

	local var_4_10 = arg_4_0.panel

	var_4_9(var_5.Find(var_4_10, "ticket/checkbox"), var_4_8)

	onToggle = var_4_9

	local var_4_11 = arg_4_0
	local var_4_12 = arg_4_0.panel
	local var_4_13 = var_6.Find(var_4_12, "ticket/checkbox")
	...
	local function var_4_14(arg_7_0)
		...
		var_7_1(var_7_0, var_2_10004.ON_SPITEM_CHANGED, arg_7_0)
	...
	var_4_9(var_4_11, var_4_13, var_4_14, var_4_12, var_9)
	...
	if var_4_16 >= 0 then
		...
		local var_4_19 = var_4_15(var_7)
		local var_4_20 = var_5.getRawData(var_4_19).oil

		math = var_4_17

		local var_4_21 = var_4_17.floor(var_4_20 / var_4_18)

		warning = var_4_19

		var_4_19(var_4_18, var_4_20, var_4_21)
...
function var_0_1.UpdateContent(arg_9_0)
	...
	if arg_9_0.contextData.useTicket then
		...
		if var_9_0 <= var_9_1 then
			...
			local var_9_6 = var_8(var_9_5, var_1_10011)

			setText = var_8

			local var_9_7 = arg_9_0.panel

			var_8(var_10.Find(var_9_7, "ticket/Number"), var_9_6 .. "/" .. var_9_1)

			if false then
				setText = var_8

				local var_9_8 = arg_9_0.panel

				var_8(var_10.Find(var_9_8, "ticket/Number"), var_9_1)
			end

			local var_9_9 = var_9_1 > 0 and var_9_3 > 0

			setActive = var_9

			local var_9_10 = arg_9_0.panel

			var_9(var_11.Find(var_9_10, "ticket/checkboxBan"), not var_9_9)

			setToggleEnabled = var_9

			local var_9_11 = arg_9_0.panel

			var_9(var_11.Find(var_9_11, "ticket/checkbox"), var_9_9)

			if arg_9_0.contextData.useTicket and not var_9_9 then
				triggerToggle = var_9

				local var_9_12 = arg_9_0.panel

				var_9(var_11.Find(var_9_12, "ticket/checkbox"), false)
			end

			local var_9_13 = arg_9_0.contextData.oilCost * (var_9_0 + (var_2.rate - 1) * var_6)

			i18n = var_10

			local var_9_14 = var_10("multiple_sorties_cost1", var_9_13)

			getProxy = var_11
			PlayerProxy = var_13

			local var_9_15 = var_11(var_13)

			if var_11.getRawData(var_9_15).oil < var_9_13 then
				string = var_12

				local var_9_16 = var_12.gsub
				local var_9_17 = var_9_14
				local var_9_18 = "#92fc63"

				COLOR_RED = var_1_10016
				var_9_14 = var_9_16(var_9_17, var_9_18, var_1_10016)
			end

			if var_6 > 0 then
				local var_9_19 = var_9_14

				i18n = var_9_15
				var_9_14 = var_9_19 .. var_9_15("multiple_sorties_cost3", var_6)
			end

			local var_9_20 = arg_9_0.consumeText

			var_9_20.text = var_9_14
			onButton = var_9_20

			local var_9_21 = arg_9_0
			local var_9_22 = arg_9_0.panel
			local var_9_23 = var_15.Find(var_9_22, "battle")

			local function var_9_24()
				if var_9_13 > var_0.oil then
					pg = var_0
					...
					var_10_1(var_10_0, var_2_10003("stage_beginStage_error_noResource"))
				...
				var_10_3(var_10_2, var_2_10003.CONTINUOUS_OPERATION)
			...
			var_9_20(var_9_21, var_9_23, var_9_24, var_9_22)
