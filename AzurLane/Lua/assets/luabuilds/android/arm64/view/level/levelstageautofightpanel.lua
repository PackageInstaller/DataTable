...
function var_0_1.OnInit(arg_8_0)
	...
	local function var_8_4()
		...
		var_9_3(var_9_2, var_9_4, var_9_5, var_2_10007.AUTOFIGHT_STOP_REASON.MANUAL)
	...
	var_1(var_8_2, var_8_3, var_8_4, var_1_10006)
	...
	local function var_8_7()
		...
		if not arg_8_0.isFrozen then
			...
			var_10_4(var_10_3, var_5.TRIGGER_ACTION)
		end
	...
	var_1(var_8_5, var_8_6, var_8_7, var_1_10006)
	...
	local var_8_10 = var_1_10002.split(var_8_9, "$1/$2")

	setText = var_3

	local var_8_11 = arg_8_0.restTime

	var_3(var_5.Find(var_8_11, "Text"), var_8_10[1])

	setText = var_3

	local var_8_12 = arg_8_0.restTime

	var_3(var_5.Find(var_8_12, "Text (2)"), var_8_10[2])
...
function var_0_1.UpdateAutoFightMark(arg_11_0)
	...
	var_1_10002(arg_11_0.btnOn, var_11_1)

	setActive = var_1_10002

	var_1_10002(arg_11_0.btnOff, not var_11_1)
	...
	var_11_3(var_11_2, var_5.STRATEGY_PANEL_AUTOFIGHT_ACTIVE, var_11_1)
...
function var_0_1.UpdateContinuousOperation(arg_12_0)
	...
	if var_12_1(var_12_0, var_1_10004) and var_1:IsActive() then
		local var_12_2 = var_1

		var_1_10002 = var_1.GetTotalBattleTime(var_12_2) - var_1:GetRestBattleTime() + 1
		...
		var_12_4[2] = var_1.GetTotalBattleTime(var_12_5)

		for iter_12_0, iter_12_1 in var_12_2(var_12_4) do
			string = var_12_5
			var_12_3 = var_12_5.gsub(var_12_3, "$" .. iter_12_0, iter_12_1)
		end

		setText = var_4

		local var_12_6 = arg_12_0.restTime

		var_4(var_6.Find(var_12_6, "Count"), var_12_3)
		...
		if not arg_12_0.isCO then
			local var_12_7 = arg_12_0.loader

			var_4.GetSprite(var_12_7, "ui/levelstageview_atlas", "continuous_operation_on", arg_12_0.btnOn)
		...
		var_1_10002(arg_12_0.restTime, false)

		if arg_12_0.isCO then
			local var_12_8 = arg_12_0.loader

			var_2.GetSprite(var_12_8, "ui/levelstageview_atlas", "continuous_operation_on", arg_12_0.btnOn)
