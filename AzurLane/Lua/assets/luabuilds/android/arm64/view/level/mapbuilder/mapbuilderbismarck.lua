...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".MapBuilderShinano"))
...
function var_0_1.OnInit(arg_4_0)
	...
	local var_4_8 = var_3.Find(var_4_7, "zhongzhijiguang_jiasu")

	ChapterConst = var_4

	var_4_6(var_4_8, var_4.LayerWeightMap + 1)

	pg = var_4_6

	local var_4_9 = var_4_6.ViewUtils.SetSortingOrder
	local var_4_10 = arg_4_0.effectDown
	local var_4_11 = var_3.Find(var_4_10, "zhongzhijiguang_jiasu")

	ChapterConst = var_4

	var_4_9(var_4_11, var_4.LayerWeightMap + 1)
	...
	var_1_10004(arg_5_0, arg_5_1, function()
		...
		var_0({
			function(arg_7_0)
				...
				var_7_4(var_7_5, var_7_6, var_5.Action(arg_7_0))
			...
			function(arg_8_0)
				...
				var_8_1(var_8_2, var_8_3, var_5.Action(arg_8_0))
...
function var_0_1.UpdateCustomButtons(arg_10_0)
	...
	local var_10_2 = var_10_1 == var_1_10003.ACT_EXTRA

	setActive = var_10_0

	var_10_0(arg_10_0.buttonUp, false)

	setActive = var_10_0

	var_10_0(arg_10_0.effectUp, false)

	setActive = var_10_0

	var_10_0(arg_10_0.buttonDown, false)

	setActive = var_10_0

	var_10_0(arg_10_0.effectDown, false)

	if not var_10_2 then
		setActive = var_10_0

		var_10_0(arg_10_0.sceneParent.btnPrev, false)

		setActive = var_10_0

		var_10_0(arg_10_0.sceneParent.btnNext, false)

		getProxy = var_10_0
		ChapterProxy = var_6

		local var_10_3 = var_10_0(var_6)
		...
		var_10_6(var_9(arg_10_0.buttonUp), true)
		...
		var_10_7(var_9(arg_10_0.buttonDown), true)
	end
...
function var_0_1.UpdateMapItem(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_2 = var_1_10004(arg_11_1, "main")
	...
	local var_11_3 = var_11_0(var_11_2, "info/bk/fordark")
	...
	local var_11_8 = var_9(var_11_2, "circle/progress")

	findTF = var_11_6

	local var_11_9 = var_11_6(var_11_2, "circle/progress_text")
	...
	local var_11_21 = var_17(var_11_2, "info/bk/title_form/title_index")

	setColorStr = var_18

	var_15(var_11_21, var_18(var_11_1.chapter_name .. "  ", var_11_20))
	...
	var_15(var_11_22, var_18(var_11_11[1], var_11_20))
	...
	var_15(var_11_23, var_18(var_11_24, var_11_20))
	...
	var_15(var_11_25, var_18.format("%d%%", arg_11_2.progress))

	setActive = var_15

	local var_11_26 = var_11_10
	local var_11_27 = arg_11_2

	var_15(var_11_26, arg_11_2.existAchieve(var_11_27))

	local var_11_28 = arg_11_2

	if arg_11_2.existAchieve(var_11_28) then
		ipairs = var_15

		for iter_11_0, iter_11_1 in var_15(arg_11_2.achieves) do
			ChapterConst = var_11_27
			var_11_27 = var_11_27.IsAchieved(iter_11_1)

			local var_11_29 = var_11_10:Find("star" .. iter_11_0 .. "/light")

			setActive = var_22

			var_22(var_11_29, var_11_27)
		end
	end
	...
	if not arg_11_2.active then
		var_11_28 = arg_11_2
		var_11_30 = arg_11_2.isClear(var_11_28)
	else
		var_11_30 = false
	end
	...
	var_16(var_11_4, var_11_30)

	setActive = var_16

	var_16(var_11_5, var_11_7)

	setActive = var_16

	var_16(var_11_9, not var_11_30 and not var_11_7)
	...
	local var_11_32 = var_19(var_11_31, "Text")

	i18n = var_20

	var_11_28(var_11_32, var_20("tag_level_fighting"))

	findTF = var_11_28

	local var_11_33 = var_11_28(var_11_2, "circle/oni")

	setText = var_18
	findTF = var_20

	local var_11_34 = var_20(var_11_33, "Text")

	i18n = var_21

	var_18(var_11_34, var_21("tag_level_oni"))
	...
	local var_11_36 = var_21(var_11_35, "Text")

	i18n = var_22

	var_19(var_11_36, var_22("tag_level_narrative"))
	...
	if var_11_37 then
		...
		local var_11_43 = var_25.alphaCanvas(var_11_39, 0, 0.5)
		local var_11_44 = var_25.setFrom(var_11_43, 1)
		local var_11_45 = var_25.setEase

		LeanTweenType = var_1_10028

		local var_11_46 = var_11_45(var_11_44, var_1_10028.easeInOutSine)

		var_11_41(var_11_40, var_11_42, var_25.setLoopPingPong(var_11_46).uniqueId)
	end
	...
	var_23(var_11_47, var_11_49)

	if var_11_49 then
		var_11_48 = arg_11_2:getConfig("count") - arg_11_2:getTodayDefeatCount() .. "/" .. var_23
		setText = var_25

		local var_11_50 = var_11_47:Find("label")

		i18n = var_1_10028

		var_25(var_11_50, var_1_10028("levelScene_chapter_count_tip"))

		setText = var_25

		local var_11_51 = var_11_47:Find("Text")

		setColorStr = var_28

		local var_11_52 = var_11_48

		var_1_10033 = arg_11_2

		if var_23 <= arg_11_2.getTodayDefeatCount(var_1_10033) then
			COLOR_RED = var_31
			...
			var_25(var_11_51, var_28(var_11_52, var_31))

			local var_11_53 = arg_11_2:GetDailyBonusQuota()

			findTF = var_11_48

			local var_11_54 = var_11_48(var_11_2, "mark")
			local var_11_55 = var_24.Find(var_11_54, "bonus")
			local var_11_56 = var_25.Find(var_11_55, "icon")

			findTF = var_11_54

			local var_11_57 = var_11_54(var_25, "icon/Image")

			setActive = var_11_55

			var_11_55(var_25, var_11_53)

			setActive = var_11_55

			var_11_55(var_24, var_11_53)
			...
			if var_11_56 then
				...
				local var_11_58 = var_11_56

				var_11_59 = var_11_53 and arg_11_0.bonusPtIconPath

				var_11_55(var_11_58, var_11_59)
			end

			local var_11_63

			if var_11_53 then
				local var_11_60 = var_24
				local var_11_61 = var_24.GetComponent

				typeof = var_11_59
				CanvasGroup = var_1_10033

				local var_11_62 = var_11_61(var_11_60, var_11_59(var_1_10033))

				var_11_63 = arg_11_2:GetDailyBonusIconName()

				local var_11_64 = arg_11_0.sceneParent.loader

				var_30.GetSprite(var_11_64, "ui/levelmainscene_atlas", var_11_63, var_25)

				if var_11_56 and arg_11_0.bonusPtIconPath then
					if var_11_57 then
						GetImageSpriteFromAtlasAsync = var_30

						var_30(arg_11_0.bonusPtIconPath, "", var_11_57, true)
					else
						GetImageSpriteFromAtlasAsync = var_30

						var_30(arg_11_0.bonusPtIconPath, "", var_11_56, true)
					end
				end

				LeanTween = var_30

				local var_11_65 = var_30.cancel

				go = var_11_64

				var_11_65(var_11_64(var_24), true)

				local var_11_66 = var_24.anchoredPosition.y

				var_11_62.alpha = 0
				LeanTween = var_31

				local var_11_67 = var_31.value

				go = var_33

				local var_11_68 = var_11_67(var_33(var_24), 0, 1, 0.2)
				local var_11_69 = var_31.setOnUpdate

				System = var_1_10034

				local var_11_70 = var_11_69(var_11_68, var_1_10034.Action_float(function(arg_12_0)
					var_11_62.alpha = arg_12_0

					local var_12_0 = var_0.anchoredPosition

					var_12_0.y = var_11_66 * arg_12_0
					var_0.anchoredPosition = var_12_0

					return
				end))
				local var_11_71 = var_31.setOnComplete

				System = var_1_10034

				local var_11_72 = var_11_71(var_11_70, var_1_10034.Action(function()
					var_11_62.alpha = 1

					local var_13_0 = var_0.anchoredPosition

					var_13_0.y = var_11_66
					var_0.anchoredPosition = var_13_0

					return
				end))
				local var_11_73 = var_31.setEase

				LeanTweenType = var_1_10034

				local var_11_74 = var_11_73(var_11_72, var_1_10034.easeOutSine)

				var_31.setDelay(var_11_74, 0.7)
			end

			local var_11_75 = arg_11_2.id

			onButton = var_11_63

			local var_11_76 = arg_11_0
			local var_11_77 = var_11_2

			local function var_11_78()
				if arg_11_0.chaptersInBackAnimating[var_11_75] then
					return
				end
				...
				local var_14_3 = var_11_75

				Vector3 = var_2_10005

				var_14_2(var_14_1, var_14_3, var_2_10005(var_14_0.x - 10, var_14_0.y + 22))

				return
			end

			SFX_UI_WEIGHANCHOR_SELECT = var_1_10034

			var_11_63(var_11_76, var_11_77, var_11_78, var_1_10034)
