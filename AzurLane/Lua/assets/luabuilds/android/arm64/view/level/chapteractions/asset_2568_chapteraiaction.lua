...
function var_0_0.PlayAIAction(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	if arg_5_1.getChapterCell(var_5_0, arg_5_0.line.row, arg_5_0.line.column) then
		local var_5_1 = var_4.attachment

		ChapterConst = var_5_0

		if var_5_1 == var_5_0.AttachLandbase then
			table = var_5_1

			if not var_5_1.equal(arg_5_0.stgTarget, {
				row = 9999,
				columns = 9999
			}) then
				pg = var_5

				local var_5_2 = var_5.land_based_template[var_4.attachmentId].type

				ChapterConst = var_7

				if var_5_2 == var_7.LBCoastalGun then
					local var_5_3 = arg_5_2.viewComponent

					var_6.doPlayAnim(var_5_3, "coastalgun", function(arg_6_0)
					...
					local var_5_4 = var_5.type

					ChapterConst = var_7

					if var_5_4 == var_7.LBHarbor then
						if not arg_5_0.hp_del or arg_5_0.hp_del <= 0 then
							arg_5_3()
						end

						local var_5_5 = arg_5_2.viewComponent.grid
						local var_5_6 = var_6.PlayAttachmentEffect
						local var_5_7 = var_4.row
						local var_5_8 = var_4.column
						local var_5_9 = "huoqiubaozha"

						Vector2 = var_1_10012

						var_5_6(var_5_5, var_5_7, var_5_8, var_5_9, var_1_10012.zero)
						arg_5_3()
					else
						...
						if var_5_10 == var_7.LBDock then
							arg_5_3()
						else
							local var_5_11 = var_5.type

							ChapterConst = var_7

							if var_5_11 == var_7.LBAntiAir then
								local var_5_12 = arg_5_2.viewComponent

								var_5_11.doPlayAnim(var_5_12, "AntiAirFire", function(arg_7_0)
									setActive = var_2_10001
									...
									var_7_1(var_7_0, var_7_2, var_7_3, var_7_4, var_2_10007.zero, arg_5_3)
	...
	if 0 < var_5_13 then
		local var_5_14 = arg_5_0.stgId

		ChapterConst = var_6

		if var_5_14 == var_6.StrategySonarDetect then
			var_5_14 = {}
			_ = var_6
			...
			var_6.each(arg_5_0.cellUpdates, function(arg_8_0)
				...
				if var_2_10001(var_8_0, var_2_10004) then
					table = var_1

					var_1.insert(var_5_14, arg_8_0)
				end

				return
			end)

			local var_5_15 = arg_5_2.viewComponent.grid

			var_6.PlaySonarDetectAnim(var_5_15, var_5_14, arg_5_3)
		else
			assert = var_5_14
	...
	local var_5_16 = arg_5_1:getChampion(arg_5_0.line.row, arg_5_0.line.column)
	local var_5_17 = arg_5_1:getChampionIndex(arg_5_0.line.row, arg_5_0.line.column)
	local var_5_18

	if not arg_5_0.movePath[#arg_5_0.movePath] then
		var_5_18 = arg_5_0.line
	end
		...
		var_8({
			function(arg_9_0)
				if #arg_5_0.movePath > 0 then
					...
					local var_9_2 = var_5_17
					local var_9_3 = arg_5_0.movePath

					Clone = var_2_10006

					var_9_1(var_9_0, var_9_2, var_9_3, var_2_10006(arg_5_0.movePath), arg_9_0)
				else
					arg_9_0()
				end
			...
			function(arg_10_0)
				if #arg_5_0.shipUpdate > 0 then
					...
					var_1.doPlayEnemyAnim(var_10_0, var_5_16, "SubSairenTorpedoUI", arg_10_0)
				else
					arg_10_0()
				end
			...
			function(arg_11_0)
				...
				if var_11_1 == var_2_10003.ActType_SubmarineHunting and #arg_5_0.cellUpdates > 0 then
					...
					var_2.each(arg_5_0.cellUpdates, function(arg_12_0)
						if var_5_18.row == arg_12_0.row and var_5_18.column == arg_12_0.column then
							isa = var_1

							local var_12_0 = arg_12_0

							ChapterChampionPackage = var_3_10004

							if var_1(var_12_0, var_3_10004) then
								local var_12_1 = arg_5_0

								var_1.TryPlayChampionSubAnim(var_12_1, arg_5_2, arg_12_0, var_5_16, arg_11_0)
...
function var_0_0.applyTo(arg_15_0, arg_15_1, arg_15_2)
	...
	if arg_15_1.getChapterCell(var_15_0, arg_15_0.line.row, arg_15_0.line.column) then
		local var_15_1 = var_3.attachment

		ChapterConst = var_15_0

		if var_15_1 == var_15_0.AttachLandbase then
			table = var_15_1

			if not var_15_1.equal(arg_15_0.stgTarget, {
				row = 9999,
				column = 9999
			}) then
				pg = var_4

				local var_15_2 = var_4.land_based_template[var_3.attachmentId].type

				ChapterConst = var_6

				if var_15_2 == var_6.LBCoastalGun then
					return arg_15_0:applyToCoastalGun(arg_15_1, var_3, arg_15_2)
				else
					local var_15_3 = var_4.type

					ChapterConst = var_6

					if var_15_3 == var_6.LBHarbor then
						return arg_15_0:applyToHarbor(arg_15_1, var_3, arg_15_2)
					else
						local var_15_4 = var_4.type

						ChapterConst = var_6

						if var_15_4 == var_6.LBDock then
							return arg_15_0:applyToDock(arg_15_1, var_3, arg_15_2)
						else
							local var_15_5 = var_4.type

							ChapterConst = var_6

							if var_15_5 == var_6.LBAntiAir then
...
function var_0_0.applyToChampion(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	if #arg_16_0.shipUpdate > 0 then
		...
		if not var_16_5(var_16_4, var_1_10010.Normal, var_16_3.row, var_16_3.column) then
			return false, "can not find fleet at: [" .. arg_16_0.line.row .. ", " .. arg_16_0.line.column .. "]"
		end
	end

	if not arg_16_3 then
		local var_16_6 = #arg_16_0.movePath
		...
		if 0 < var_16_6 then
			...
			local var_16_7 = var_7.bor
			local var_16_8 = var_16_1

			ChapterConst = var_1_10010
			var_16_1 = var_16_7(var_16_8, var_1_10010.DirtyChampionPosition)
		end

		local var_16_9 = arg_16_1
		local var_16_10 = arg_16_1.existFleet

		FleetType = var_1_10010

		if var_16_10(var_16_9, var_1_10010.Submarine, arg_16_2.row, arg_16_2.column) then
			bit = var_7

			local var_16_11 = var_7.bor
			local var_16_12 = var_16_1

			ChapterConst = var_10
			var_16_1 = var_16_11(var_16_12, var_10.DirtyFleet)
		end

		local var_16_13 = arg_16_0.actType

		ChapterConst = var_8

		if var_16_13 == var_8.ActType_SubmarineHunting then
			local var_16_14 = arg_16_1

			if arg_16_1.getChapterCell(var_16_14, var_16_3.row, var_16_3.column) then
				local var_16_15 = var_7.attachment

				ChapterConst = var_16_14

				if var_16_15 == var_16_14.AttachBarrier then
					ChapterConst = var_16_15
					var_7.flag = var_16_15.CellFlagDisabled

					arg_16_1:mergeChapterCell(var_7)

					bit = var_8

					local var_16_16 = var_8.bor
					local var_16_17 = var_16_1

					ChapterConst = var_11
					var_16_1 = var_16_16(var_16_17, var_11.DirtyAttachment)
				end
			end
		end
		...
		if #arg_16_0.shipUpdate > 0 then
			...
			local var_16_18 = var_7.bor
			local var_16_19 = var_16_1

			ChapterConst = var_10
			var_16_1 = var_16_18(var_16_19, var_10.DirtyFleet)
		end
		...
		if #arg_16_0.cellUpdates > 0 then
			...
			var_7.each(arg_16_0.cellUpdates, function(arg_19_0)
				...
				if var_2_10001(var_19_0, var_2_10004) then
					...
					if var_1.mergeChampion(var_19_1, arg_19_0) then
						...
						bit = var_19_1
						var_16_1 = var_19_1.bor(var_16_1, var_2_10002)
						...
						if false then
							...
							ChapterConst = var_4
							var_16_1 = var_19_3(var_19_4, var_4.DirtyAttachment)
						end
			...
			local var_16_20 = var_7.bor
			local var_16_21 = var_16_2

			ChapterConst = var_10
			var_16_2 = var_16_20(var_16_21, var_10.DirtyAutoAction)
		end
	end
	...
	if not arg_20_3 then
		...
		if var_20_1 == var_1_10007.StrategySonarDetect then
			...
			var_20_1.each(arg_20_0.cellUpdates, function(arg_21_0)
				...
				if var_2_10001(var_21_0, var_2_10004) then
					...
					ChapterConst = var_4
					var_20_0 = var_21_2(var_21_3, var_4.DirtyChampion)
				else
					...
					ChapterConst = var_4
					var_20_0 = var_21_5(var_21_6, var_4.DirtyAttachment)
				end
...
function var_0_0.applyToCoastalGun(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	if not var_22_4(var_22_3, var_1_10009.Normal, arg_22_0.stgTarget.row, arg_22_0.stgTarget.column) then
	...
	if not arg_22_3 then
		...
		ChapterConst = var_10
		var_22_1 = var_22_5(var_22_6, var_10.DirtyFleet)
		_ = var_7
		...
		var_7.each(arg_22_0.cellUpdates, function(arg_23_0)
			...
			if var_2_10001(var_23_0, var_2_10004) then
				...
				ChapterConst = var_4
				var_22_1 = var_23_2(var_23_3, var_4.DirtyChampion)
			else
				...
				ChapterConst = var_4
				var_22_1 = var_23_5(var_23_6, var_4.DirtyAttachment)
			end
		...
		if #arg_22_0.cellUpdates > 0 then
			...
			ChapterConst = var_10
			var_22_2 = var_22_7(var_22_8, var_10.DirtyAutoAction)
		end
	end
...
function var_0_0.applyToHarbor(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	if not arg_24_1:getChampion(arg_24_0.stgTarget.row, arg_24_0.stgTarget.column) then
		return false, "can not find champion at: [" .. arg_24_0.stgTarget.row .. ", " .. arg_24_0.stgTarget.column .. "]"
	end

	if not arg_24_3 then
		math = var_1_10007
		arg_24_1.BaseHP = var_1_10007.max(arg_24_1.BaseHP - arg_24_0.hp_del, 0)

		arg_24_1:RemoveChampion(var_6)

		bit = var_7

		local var_24_3 = var_7.bor
		local var_24_4 = var_24_1

		ChapterConst = var_10

		local var_24_5 = var_10.DirtyBase

		ChapterConst = var_1_10011
		var_24_1 = var_24_3(var_24_4, var_24_5, var_1_10011.DirtyChampion)
		bit = var_7

		local var_24_6 = var_7.bor
		local var_24_7 = var_24_2

		ChapterConst = var_24_5
		var_24_2 = var_24_6(var_24_7, var_24_5.DirtyAutoAction)
		...
		if #arg_24_0.cellUpdates > 0 then
			...
			var_7.each(arg_24_0.cellUpdates, function(arg_25_0)
				...
				if var_2_10001(var_25_0, var_2_10004) then
					local var_25_1 = arg_24_1
					local var_25_2 = var_1.mergeChampion(var_25_1, arg_25_0)

					bit = var_2_10002

					local var_25_3 = var_2_10002.bor
					local var_25_4 = var_24_1

					ChapterConst = var_2_10005
					var_24_1 = var_25_3(var_25_4, var_2_10005.DirtyChampion)
				else
					...
					ChapterConst = var_4
					var_24_1 = var_25_6(var_25_7, var_4.DirtyAttachment)
				end
...
function var_0_0.applyToDock(arg_26_0, arg_26_1, arg_26_2, arg_26_3)
	...
	if not var_26_4(var_26_3, var_1_10009.Normal, arg_26_0.stgTarget.row, arg_26_0.stgTarget.column) then
	...
	if not arg_26_3 then
		...
		var_1_10007.each(arg_26_0.cellUpdates, function(arg_27_0)
			isa = var_2_10001
			...
			if var_2_10001(var_27_0, var_2_10004) then
				...
				ChapterConst = var_4
				var_26_1 = var_27_2(var_27_3, var_4.DirtyAttachment)
			end
		...
		ChapterConst = var_10
		var_26_1 = var_26_5(var_26_6, var_10.DirtyFleet)
	end
...
function var_0_0.applyToAntiAir(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	...
	if not arg_29_3 then
		...
		local var_29_5 = var_10.DirtyChampion

		ChapterConst = var_1_10011
		var_29_1 = var_29_3(var_29_4, var_29_5, var_1_10011.DirtyAttachment)
		_ = var_7
		...
		var_7.each(arg_29_0.cellUpdates, function(arg_30_0)
			...
			if var_2_10001(var_30_0, var_2_10004) then
				...
				ChapterConst = var_4
				var_29_1 = var_30_4(var_30_5, var_4.DirtyAttachment)
			end
