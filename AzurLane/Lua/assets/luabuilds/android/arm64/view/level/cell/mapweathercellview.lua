...
function var_0_1.OnLoadedPrefab(arg_5_0, arg_5_1, arg_5_2)
	...
	if arg_5_2 == var_1_10003.FlagWeatherFog then
		...
		math = var_1_10004
		var_1_10004 = var_1_10004.random(1, var_5_0)

		for iter_5_0 = 1, var_5_0 do
			setActive = var_1_10009
			tf = var_1_10011

			local var_5_1 = var_1_10011(arg_5_1)

			var_1_10009(var_1_10011.GetChild(var_5_1, iter_5_0 - 1), iter_5_0 == var_1_10004)
		end
	else
		...
		if arg_5_2 == var_5_0.FlagWeatherFogVisible then
			...
			local var_5_2 = var_3.Pos2FogRes(arg_5_0.line.row, arg_5_0.line.column)

			eachChild = var_1_10004
			tf = var_6

			var_1_10004(var_6(arg_5_1), function(arg_6_0, arg_6_1)
				setActive = var_2_10002

				var_2_10002(arg_6_0, arg_6_0.name == var_5_2)
