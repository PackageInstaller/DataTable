...
function var_0_1.UpdateView(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_3 = var_3_2 / var_3_0.gameset.doa_fever_count.key_value
	...
	var_1_10008({
		function(arg_4_0)
			...
			var_4_0(var_2_10003(arg_3_0.fillImg), true)
			...
			local var_4_9 = var_4_8(var_2_10009(arg_3_0.fillImg), 0, 1, 1)
			local var_4_10 = var_7.setOnUpdate

			System = var_10

			local var_4_11 = var_4_10(var_4_9, var_10.Action_float(function(arg_5_0)
				Mathf = var_3_10001
				...
				local var_5_3 = var_5_2(var_5.max(var_4_5 * var_4_5 - var_5_0 * var_5_0, 0)) * var_4_7
				...
				local var_5_8 = var_8.format
				local var_5_9 = "%02d.%d%%"

				math = var_3_10011

				local var_5_10 = var_3_10011.floor(var_1 * 100)

				math = var_3_10012

				var_5_6(var_5_7, var_5_8(var_5_9, var_5_10, var_3_10012.round(var_1 * 1000) % 10))
			...
			var_4_12(var_4_11, var_10.Action(arg_4_0))
		...
		function(arg_6_0)
			...
			local var_6_2 = var_6_1(var_6_0, var_4(var_2_10006))
			...
			local var_6_4 = var_4.format
			local var_6_5 = "%02d.%d%%"

			math = var_2_10007

			local var_6_6 = var_2_10007.floor(var_3_3 * 100)

			math = var_2_10008

			var_6_2(var_6_3, var_6_4(var_6_5, var_6_6, var_2_10008.round(var_3_3 * 1000) % 10))
			...
			if var_3_1 and var_3_2 == var_0 then
				...
				local var_6_13 = var_6_12(var_6_11, var_2_10005(var_6_6))

				math = var_6_10

				local var_6_14 = var_6_10.random(arg_3_0.PAINTING_RANGE[1], arg_3_0.PAINTING_RANGE[2])
				...
				var_6_11(var_6_15, var_6_6(var_6_16, var_10(var_6_14)), true)

				setActive = var_6_11

				var_6_11(arg_3_0.banner, true)
				...
				local function var_6_17()
					...
					var_7_3(var_7_2, var_3.UN_FROZEN)
					arg_6_0()
				...
				local var_6_20 = var_6_19(var_6_18, var_8(var_10))
