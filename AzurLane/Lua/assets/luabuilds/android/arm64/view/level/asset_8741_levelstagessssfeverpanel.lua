...
function var_0_1.OnInit(arg_2_0)
	...
	arg_2_0.barGroup1 = var_2_1(var_2_0, var_4.Find(var_2_2, "Bar1"))

	local var_2_3 = arg_2_0
	local var_2_4 = arg_2_0.GetBarTFGroup
	local var_2_5 = arg_2_0._tf

	arg_2_0.barGroup2 = var_2_4(var_2_3, var_4.Find(var_2_5, "Bar2"))
	...
	for iter_2_0, iter_2_1 in var_1(var_0_2) do
		...
		for iter_2_2, iter_2_3 in var_2_5(iter_2_1) do
	...
	for iter_2_4, iter_2_5 in var_1(var_0_3) do
		...
		for iter_2_6, iter_2_7 in var_2_5(iter_2_5) do
...
function var_0_1.UpdateKaijuBar(arg_7_0, arg_7_1)
	...
	local var_7_3 = arg_7_1:isLoop() and 0 or var_0_1.stepCount

	math = var_5

	local var_7_4 = var_5.min(var_7_2 / var_7_3, 1)
	local var_7_5 = arg_7_0.barGroup1.fillImg
	local var_7_6 = var_6.GetComponent

	typeof = var_1_10010
	Image = var_1_10012

	local var_7_7 = var_7_6(var_7_5, var_1_10010(var_1_10012))
	local var_7_8 = arg_7_0.barGroup1.ratioText

	if var_7_1 and var_7_2 <= var_7_3 then
		local var_7_9 = arg_7_0.animations

		var_9.Insert(var_7_9, function(arg_8_0)
			local var_8_0 = (var_7_2 - var_7_1) / var_7_3

			math = var_2_10003

			local var_8_1 = var_2_10003.min(var_7_1, var_7_3 - var_1)

			LeanTween = var_2_10004

			local var_8_2 = var_2_10004.value

			go = var_6

			local var_8_3 = var_8_2(var_6(var_0), 0, 1, var_8_1)
			local var_8_4 = var_4.setOnUpdate

			System = var_7

			local var_8_5 = var_8_4(var_8_3, var_7.Action_float(function(arg_9_0)
				Mathf = var_3_10001

				local var_9_0 = var_3_10001.Lerp(var_8_0, var_7_4, arg_9_0)
				local var_9_1 = var_7_7

				var_9_1.fillAmount = var_9_0
				setText = var_9_1

				local var_9_2 = var_7_8

				string = var_5

				local var_9_3 = var_5.format
				local var_9_4 = "%02d%%"

				math = var_3_10008

				var_9_1(var_9_2, var_9_3(var_9_4, var_3_10008.floor(var_9_0 * 100)))
			...
			var_8_6(var_8_5, var_7.Action(arg_8_0))

			return
		end)
	end

	local var_7_10 = arg_7_0:GetIcon(arg_7_1, false)
	local var_7_11 = arg_7_0.animations

	var_10.Insert(var_7_11, function(arg_10_0)
		local var_10_0 = var_7_7

		var_10_0.fillAmount = var_7_4
		setText = var_10_0

		local var_10_1 = var_7_8

		string = var_2_10004

		local var_10_2 = var_2_10004.format
		local var_10_3 = "%02d%%"

		math = var_2_10007

		var_10_0(var_10_1, var_10_2(var_10_3, var_2_10007.floor(var_7_4 * 100)))

		if var_7_4 >= 1 then
			local var_10_4 = arg_7_0.loader

			var_1.GetSpriteQuiet(var_10_4, "ui/LevelStageSSSSFeverPanel_atlas", "icon_" .. var_7_10, arg_7_0.barGroup1.iconImg, true)
		end
	...
	if var_7_1 and var_7_3 > var_7_2 - var_7_1 and var_7_3 <= var_7_2 then
		local var_7_12 = arg_7_0.PanelAnimations

		var_10.Insert(var_7_12, function(arg_11_0)
			local var_11_0 = arg_7_0

			var_1.ShowPanel(var_11_0, var_7_10, "Kaiju", arg_11_0, var_7_10 == "he" and "" or "2")
...
function var_0_1.UpdateSyberSquadBar(arg_12_0, arg_12_1)
	...
	local var_12_3 = arg_12_1:isLoop() and 0 or var_0_1.enemyCount

	math = var_5

	local var_12_4 = var_5.min(var_12_2 / var_12_3, 1)
	local var_12_5 = arg_12_0.barGroup2.fillImg
	local var_12_6 = var_6.GetComponent

	typeof = var_1_10010
	Image = var_1_10012

	local var_12_7 = var_12_6(var_12_5, var_1_10010(var_1_10012))
	local var_12_8 = arg_12_0.barGroup2.ratioText

	if var_12_1 and var_12_2 <= var_12_3 then
		local var_12_9 = arg_12_0.animations

		var_9.Insert(var_12_9, function(arg_13_0)
			math = var_2_10001

			local var_13_0 = var_2_10001.max(var_12_2 - 1, 0) / var_12_3
			...
			local var_13_2 = var_13_1(var_2_10005(var_0), 0, 1, 1)
			local var_13_3 = var_3.setOnUpdate

			System = var_6

			local var_13_4 = var_13_3(var_13_2, var_6.Action_float(function(arg_14_0)
				Mathf = var_3_10001

				local var_14_0 = var_3_10001.Lerp(var_13_0, var_12_4, arg_14_0)
				local var_14_1 = var_12_7

				var_14_1.fillAmount = var_14_0
				setText = var_14_1

				local var_14_2 = var_12_8

				string = var_5

				local var_14_3 = var_5.format
				local var_14_4 = "%02d%%"

				math = var_3_10008

				var_14_1(var_14_2, var_14_3(var_14_4, var_3_10008.floor(var_14_0 * 100)))
			...
			var_13_5(var_13_4, var_6.Action(arg_13_0))

			return
		end)
	end

	local var_12_10 = arg_12_0:GetIcon(arg_12_1, true)
	local var_12_11 = arg_12_0.animations

	var_10.Insert(var_12_11, function(arg_15_0)
		local var_15_0 = var_12_7

		var_15_0.fillAmount = var_12_4
		setText = var_15_0

		local var_15_1 = var_12_8

		string = var_2_10004

		local var_15_2 = var_2_10004.format
		local var_15_3 = "%02d%%"

		math = var_2_10007

		var_15_0(var_15_1, var_15_2(var_15_3, var_2_10007.floor(var_12_4 * 100)))

		if var_12_4 >= 1 then
			local var_15_4 = arg_12_0.loader

			var_1.GetSpriteQuiet(var_15_4, "ui/LevelStageSSSSFeverPanel_atlas", "icon_" .. var_12_10, arg_12_0.barGroup2.iconImg, true)
		end
	...
	if var_12_1 and var_12_2 == var_12_3 then
		local var_12_12 = arg_12_0.PanelAnimations

		var_10.Insert(var_12_12, function(arg_16_0)
			local var_16_0 = arg_12_0

			var_1.ShowPanel(var_16_0, var_12_10, "SyberSquad", arg_16_0)
...
function var_0_1.ShowPanel(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4)
	...
	LevelUIConst = var_1_10008

	var_17_1(var_17_0, var_1_10008.FROZEN)
	...
	local var_17_7 = var_17_6(var_17_5, var_1_10010(var_1_10012))
	...
	if arg_17_4 ~= nil then
		...
		var_8(var_5:Find("Word"), false)

		setActive = var_8

		var_8(var_5:Find("Word2"), false)

		setActive = var_8

		var_8(var_5:Find("Word" .. arg_17_4), true)
	end

	local var_17_9 = var_5
	local var_17_10 = var_5.GetComponent

	typeof = var_11
	DftAniEvent = var_13

	local var_17_11 = var_17_10(var_17_9, var_11(var_13))
	local var_17_12

	local function var_17_13()
		table = var_2_10000

		var_2_10000.removebyvalue(arg_17_0.cleanActions, var_17_13)

		local var_18_0 = var_17_11
		...
		var_18_4(var_18_3, var_3.UN_FROZEN)
	...
	var_17_11:SetEndEvent(var_17_14)

	onButton = var_11

	var_11(arg_17_0, arg_17_0.banner, var_17_14)

	table = var_11

	var_11.insert(arg_17_0.cleanActions, var_17_13)
