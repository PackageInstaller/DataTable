...
function var_0_3.Update(arg_4_0)
	...
	if var_4.IsEnemyAttach(var_4_0.attachment) then
		...
		if var_4_4 == var_1_10005.CellFlagActive then
			local var_4_5 = arg_4_0.chapter

			var_4_4 = var_4_4.existFleet
			FleetType = var_1_10007

			if var_4_4(var_4_5, var_1_10007.Transport, var_4_0.row, var_4_0.column) then
				var_4_3 = false
			end
		end
	end
	...
	if var_4(arg_4_0.go) then
		...
		var_4.GetPrefab(var_4_6, "leveluiview/Tpl_StaticChampion", "Tpl_StaticChampion", function(arg_5_0)
			...
			var_5_5(var_5_6, var_5.ShipIdleAction)
...
function var_0_3.UpdateChampionCell(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	if var_6_0 ~= var_1_10005.TraitLurk then
		...
		if var_6_1 == var_5.CellFlagActive then
			...
			local var_6_2 = arg_6_1.existFleet

			FleetType = var_1_10007
			var_6_3 = not var_6_2(var_1_10006, var_1_10007.Transport, arg_6_2.row, arg_6_2.column)
	...
	local var_6_5 = arg_6_1.existEnemy

	ChapterConst = var_1_10008

	local var_6_6 = var_6_5(var_6_4, var_1_10008.SubjectChampion, arg_6_2.row, arg_6_2.column)

	setActive = var_1_10006

	var_1_10006(arg_6_0.tfFighting, var_6_3 and var_6_6)

	setActive = var_1_10006

	var_1_10006(arg_6_0.tfDamageCount, var_6_3 and arg_6_2.data > 0)

	local var_6_7 = arg_6_2.trait

	ChapterConst = var_6_4

	local var_6_8 = var_6_7 == var_6_4.TraitVirgin

	ChapterConst = var_7

	local var_6_9 = var_7.IsBossCell(arg_6_2)

	setActive = var_8

	var_8(arg_6_0.tfEffectFound, var_6_8 and not var_6_9)

	setActive = var_8

	var_8(arg_6_0.tfEffectFoundBoss, var_6_8 and var_6_9)

	if var_6_8 then
		pg = var_8

		local var_6_10 = var_8.CriMgr.GetInstance()
		local var_6_11 = var_8.PlaySoundEffect_V3

		SFX_UI_WEIGHANCHOR_ENEMY = var_11

		var_6_11(var_6_10, var_11)
	end

	local var_6_12 = arg_6_0.tfShadow

	Vector3 = var_9
	var_6_12.localEulerAngles = var_9(arg_6_1.theme.angle, 0, 0)

	if var_6_3 then
		EnemyCellView = var_6_12

		var_6_12.RefreshEnemyTplIcons(arg_6_0, arg_6_0.config, arg_6_1)
	end

	arg_6_0:SetActive(var_6_3)
...
function var_0_3.StartEggCellView(arg_7_0, arg_7_1, arg_7_2)
	...
	if var_1_10003.EnemySize[arg_7_1.type] == 99 then
		...
		local var_7_0 = arg_7_0:GetLoader()
		...
		if var_3.EnemySize[arg_7_1.type] == 98 then
			...
			local var_7_1 = arg_7_0:GetLoader()

			var_3.GetSpriteQuiet(var_7_1, "ui/share/ship_gizmos_atlas", "enemy_elite", arg_7_0.tfBossIcon)
		else
			setActive = var_3
	...
	Vector3 = var_4
	var_7_2.localScale = var_4(0.5, 0.5, 1)

	local var_7_3 = arg_7_0.tfBossIcon

	Vector2 = var_4
	var_7_3.anchoredPosition = var_4(61.1, -30.6)
	setText = var_7_3

	var_7_3(arg_7_0.textLV, arg_7_1.level)
