...
function var_0_1.Update(arg_2_0)
	...
	if var_2_1(var_2_2, var_1_10005.StatusAirportOutControl) and arg_2_0.state ~= var_0_1.StateOutControl then
		...
		var_2_5 = "Dead"
		AutoLoader = var_1_10006

		var_2_4(var_2_3, var_2_5, var_1_10006.PartLoading)
		...
		if var_2_7(var_2_8, var_2_5.StatusAirportUnderControl) and arg_2_0.state ~= var_0_1.StateUnderControl then
			...
			var_2_10(var_2_9, var_2_11, var_1_10006.PartLoading)
