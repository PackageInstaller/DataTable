...
function var_0_1.init(arg_2_0)
	...
	for iter_2_0 = 1, 3 do
		...
		local var_2_24 = var_2_23[var_6.Vanguard]
		local var_2_25 = arg_2_0.gridFrame

		var_2_24[iter_2_0] = var_6.Find(var_2_25, "vanguard_" .. iter_2_0)

		local var_2_26 = arg_2_0.gridTFs

		TeamType = var_6

		local var_2_27 = var_2_26[var_6.Main]
		local var_2_28 = arg_2_0.gridFrame

		var_2_27[iter_2_0] = var_6.Find(var_2_28, "main_" .. iter_2_0)

		local var_2_29 = arg_2_0.gridTFs

		TeamType = var_6

		local var_2_30 = var_2_29[var_6.Submarine]
		local var_2_31 = arg_2_0.gridFrame

		var_2_30[iter_2_0] = var_6.Find(var_2_31, "submarine_" .. iter_2_0)
	end
	...
	var_2_40(var_2_39, var_4(arg_2_0.playerResOb), false)
...
function var_0_1.Register(arg_3_0)
	...
	var_2.AddHeroInfoModify(var_3_3, function(arg_5_0, arg_5_1, arg_5_2)
		...
		local var_5_2 = var_5.ship_data_template[arg_5_1.configId]

		findTF = var_6

		local var_5_3 = var_6(arg_5_0, "info")

		findTF = var_2_10007

		local var_5_4 = var_2_10007(var_5_3, "stars")

		findTF = var_8

		local var_5_5 = var_8(var_5_3, "energy")
		local var_5_6 = arg_5_1:getStar()

		for iter_5_0 = 1, var_5_6 do
			cloneTplTo = var_2_10014

			var_2_10014(arg_3_0.starTpl, var_5_4)
		end

		local var_5_7 = arg_5_1
		local var_5_8 = arg_5_1.getEnergy(var_5_7)

		Ship = var_11

		local var_5_9 = var_5_8 <= var_11.ENERGY_MID

		findTF = var_11

		local var_5_10 = var_11(var_5_3, "energy")

		if var_5_9 then
			local var_5_11 = arg_5_1
			local var_5_12

			var_5_7, var_5_12 = arg_5_1.getEnergyPrint(var_5_11)
			GetSpriteFromAtlas = var_5_11

			if not var_5_11("energy", var_5_7) then
				warning = var_2_10015

				var_2_10015("找不到疲劳")
			end

			setImageSprite = var_2_10015

			var_2_10015(var_5_10, var_14)
		end

		setActive = var_5_7

		var_5_7(var_5_10, var_5_9)

		local var_5_13 = var_3_1[arg_5_1:getGroupId()]
		local var_5_14 = var_5_3
		local var_5_15 = var_5_3.Find(var_5_14, "expbuff")

		setActive = var_5_16

		var_5_16(var_5_15, var_5_13 ~= nil)

		local var_5_16, var_5_18

		if var_5_13 then
			var_5_16 = var_5_13 / 100
			var_5_14 = var_5_13 % 100
			tostring = var_16

			local var_5_17 = var_16(var_5_16)
			...
			if 0 < var_5_14 then
				...
				var_5_17 = var_5_18 .. var_5_19 .. var_2_10019(var_5_14)
			end

			setText = var_5_18

			local var_5_20 = var_5_15:Find("text")

			string = var_2_10020

			var_5_18(var_5_20, var_2_10020.format("EXP +%s%%", var_5_17))
		end

		GetSpriteFromAtlas = var_5_16

		local var_5_21 = "shiptype"

		shipType2print = var_5_18

		if not var_5_16(var_5_21, var_5_18(arg_5_1:getShipType())) then
			warning = var_5_14

			var_5_14("找不到船形, shipConfigId: " .. arg_5_1.configId)
		end

		setImageSprite = var_5_14
		findTF = var_17

		var_5_14(var_17(var_5_3, "type"), var_14, true)

		setText = var_5_14
		findTF = var_17

		var_5_14(var_17(var_5_3, "frame/lv_contain/lv"), arg_5_1.level)

		local var_5_22 = var_5_0
		local var_5_23 = var_5_0.IsHpSafe(var_5_22)

		findTF = var_5_21

		local var_5_24 = var_5_21(var_5_3, "blood")

		findTF = var_5_22

		local var_5_25 = var_5_22(var_5_24, "fillarea/green")

		findTF = var_18

		local var_5_26 = var_18(var_5_24, "fillarea/red")

		setActive = var_19

		var_19(var_5_25, var_5_23)

		setActive = var_19

		var_19(var_5_26, not var_5_23)

		local var_5_27 = var_5_24
		local var_5_28 = var_5_24.GetComponent

		typeof = var_22
		Slider = var_2_10024

		local var_5_29 = var_5_28(var_5_27, var_22(var_2_10024))

		var_5_29.fillRect = var_5_23 and var_5_25 or var_5_26
		setSlider = var_5_29

		var_5_29(var_5_24, 0, 10000, var_5_0.hpRant)

		setActive = var_5_29

		var_5_29(var_5_24:Find("broken"), var_5_0:IsBroken())
	...
	var_2.AddLongPress(var_3_5, function(arg_7_0, arg_7_1, arg_7_2)
		...
		WorldDetailMediator = var_2_10006

		var_7_1(var_7_0, var_2_10006.OnShipInfo, arg_7_1.id)
...
function var_0_1.didEnter(arg_10_0)
	...
	local function var_10_14()
		...
		var_2_10001(var_3.GetChild(var_15_1, var_0 - 1), true)
	...
	local function var_10_17()
		...
		var_2_10001(var_3.GetChild(var_16_1, var_0 - 1), true)
...
function var_0_1.updateFleetBg(arg_19_0)
	...
	var_1_10002(var_19_2, var_19_1 == var_1_10005.Normal)
	...
	var_1_10002(var_19_3, var_19_1 == var_5.Submarine)
...
function var_0_1.updateToggleList(arg_20_0)
	...
	for iter_20_0 = 1, arg_20_0.fleetToggleList.childCount do
		...
		local var_20_3 = var_1_10007()
		local var_20_4, var_20_5

		var_1_10007, var_20_4, var_20_5 = var_1_10007.BuildFormationIds(var_20_3)
		setActive = var_1_10010

		var_1_10010(var_20_2, iter_20_0 <= var_20_5)
		...
		if iter_20_0 == arg_20_0.fleetToggleList.childCount then
			if arg_20_0.fleets[#arg_20_0.fleets] then
				var_20_6 = var_1_10010:GetFleetType()
				FleetType = var_12

				if var_20_6 ~= var_12.Submarine then
					var_1_10010 = nil
				end
			end
		elseif arg_20_0.fleets[iter_20_0] then
			...
			if var_20_6 ~= var_12.Normal then
				var_1_10010 = nil
			end
		end
		...
		local var_20_7 = var_20_6(var_1_10010)

		setToggleEnabled = var_12

		var_12(var_20_2, var_20_7)

		setActive = var_12

		var_12(var_20_2:Find("lock"), not var_20_7)

		if var_20_7 then
			onToggle = var_12

			local var_20_8 = arg_20_0
			local var_20_9 = var_20_2

			local function var_20_10(arg_21_0)
			...
			var_12(var_20_8, var_20_9, var_20_10, var_17)
			...
			var_12(arg_20_0, var_20_2:Find("lock"), function()
				...
				var_22_1(var_22_0, var_2_10003("world_redeploy_tip"))
...
function var_0_1.setPlayerInfo(arg_23_0, arg_23_1)
	...
	local var_23_2 = var_5()
	local var_23_3 = var_5.IsSystemOpen

	WorldConst = var_1_10008

	var_2(var_23_1, var_23_3(var_23_2, var_1_10008.SystemResource))
...
function var_0_1.updateCharacters(arg_29_0)
	...
	var_29_2(var_29_1, var_1_10004.Vanguard, true)
	...
	var_29_4(var_29_3, var_4.Main, true)
	...
	var_29_6(var_29_5, var_4.Submarine, true)
...
function var_0_1.displayFleetInfo(arg_34_0)
	...
	var_1_10002(arg_34_0.vanguardGS, false)

	setActive = var_1_10002

	var_1_10002(arg_34_0.mainGS, false)

	setActive = var_1_10002

	var_1_10002(arg_34_0.subGS, false)
	...
	local var_34_4 = var_34_0.reduce
	local var_34_5 = var_34_1
	local var_34_6 = var_34_1.GetTeamShipVOs

	TeamType = var_1_10008

	local var_34_7 = var_34_4(var_34_6(var_34_5, var_1_10008.Vanguard, false), 0, function(arg_35_0, arg_35_1)
		return arg_35_0 + arg_35_1:getShipCombatPower()
	end)

	_ = var_34_2

	local var_34_8 = var_34_2.reduce
	local var_34_9 = var_34_1
	local var_34_10 = var_34_1.GetTeamShipVOs

	TeamType = var_9

	local var_34_11 = var_34_8(var_34_10(var_34_9, var_9.Main, false), 0, function(arg_36_0, arg_36_1)
	...
	local var_34_15 = var_34_12(var_34_14(var_34_13, var_10.Submarine, false), 0, function(arg_37_0, arg_37_1)
	...
	if var_34_3 == var_6.Normal then
		...
		var_34_16(var_8.Find(var_34_17, "Text"), var_34_7)
		...
		var_34_16(var_8.Find(var_34_18, "Text"), var_34_11)
		...
		if var_34_3 == var_34_16.Submarine then
			...
			var_34_19(var_8.Find(var_34_20, "Text"), var_34_15)
...
function var_0_1.initAttrFrame(arg_40_0)
	...
	local var_40_3 = var_1_10003.Main

	TeamType = var_40_1
	var_40_0[var_40_3] = var_40_2[var_40_1.Main]
	TeamType = var_40_3
	...
	for iter_40_0, iter_40_1 in var_4(var_40_0) do
		if #arg_40_0.cards[iter_40_0] == 0 then
			...
			for iter_40_2 = 1, 3 do
				...
				local var_40_9 = var_9

				FormationDetailCard = var_1_10019

				var_1_10016(var_40_9, var_1_10019.New(var_1_10015))
			end
...
function var_0_1.updateAttrFrame(arg_41_0)
	...
	local var_41_3 = var_1_10003.Main

	TeamType = var_41_1
	var_41_0[var_41_3] = var_41_2[var_41_1.Main]
	TeamType = var_41_3
	...
	local var_41_6 = var_41_2:GetFleetType()

	pairs = var_4

	for iter_41_0, iter_41_1 in var_4(var_41_0) do
		if #arg_41_0.cards[iter_41_0] > 0 then
			FleetType = var_10

			if var_41_6 == var_10.Submarine then
				TeamType = var_10
				...
				for iter_41_2 = 1, 3 do
					if iter_41_2 <= #iter_41_1 then
						...
						local var_41_8 = var_15.FetchShipVO(iter_41_1[iter_41_2].id)
						local var_41_9 = var_1_10009[iter_41_2]

						var_16.update(var_41_9, var_41_8, var_41_7)

						local var_41_10 = var_1_10009[iter_41_2]

						var_16.updateProps(var_41_10, arg_41_0:getCardAttrProps(var_41_8))
					else
						local var_41_11 = var_1_10009[iter_41_2]

						var_15.update(var_41_11, nil, var_41_7)
					end

					arg_41_0:detachOnCardButton(var_1_10009[iter_41_2])

					if not var_41_7 then
						arg_41_0:attachOnCardButton(var_1_10009[iter_41_2], iter_41_0)
					end
				end
			end
		end
	...
	local var_41_12 = arg_41_0.attrFrame
	local var_41_13 = var_6.Find

	TeamType = var_1_10009

	local var_41_14 = var_41_13(var_41_12, var_1_10009.Main)

	FleetType = iter_41_0

	var_4(var_41_14, var_41_6 == iter_41_0.Normal)

	setActive = var_4

	local var_41_15 = arg_41_0.attrFrame
	local var_41_16 = var_6.Find

	TeamType = var_9

	local var_41_17 = var_41_16(var_41_15, var_9.Submarine)

	FleetType = var_7

	var_4(var_41_17, var_41_6 == var_7.Submarine)

	setActive = var_4

	local var_41_18 = arg_41_0.attrFrame
	local var_41_19 = var_6.Find

	TeamType = var_9

	local var_41_20 = var_41_19(var_41_18, var_9.Vanguard .. "/vanguard")

	FleetType = var_7

	var_4(var_41_20, var_41_6 ~= var_7.Submarine)
...
function var_0_1.getCardAttrProps(arg_43_0, arg_43_1)
	...
	tostring = var_7
	math = var_9
	var_43_4[2] = var_7(var_9.floor(var_43_0.durability))
	var_43_3[1] = var_43_4
	...
	math = var_1_10010
	var_43_5[2] = var_43_6 .. var_1_10008(var_1_10010.floor(var_43_2))
	var_43_3[2] = var_43_5
...
function var_0_1.attachOnCardButton(arg_45_0, arg_45_1, arg_45_2)
	...
	var_45_0:AddPointClickFunc(function(arg_46_0, arg_46_1)
		if not arg_45_0.carddrag and arg_46_0 == arg_45_1.go then
			if arg_45_1.shipVO then
				...
				var_46_1(var_46_0, var_2_10005.OnShipInfo, arg_45_1.shipVO.id, var_0_1.TOGGLE_DETAIL)
			end
	...
	if arg_45_1.shipVO then
		...
		var_45_0:AddBeginDragFunc(function()
			...
			var_47_1(var_47_2, iter_47_0(1.1, 1.1, 0), 0.3)
		...
		var_45_0:AddDragEndFunc(function(arg_49_0, arg_49_1)
			...
			local var_49_1 = var_49_0(var_2_10004.abs(arg_45_1.tr.anchoredPosition.x - var_45_7[arg_45_0.shiftIndex].x) / 200, 1) * 0.3
			...
			local var_49_4 = var_49_3(var_49_2, var_6.easeOutCubic)
			local var_49_5 = var_3.setOnUpdate

			System = var_6

			local var_49_6 = var_49_5(var_49_4, var_6.Action_float(function(arg_50_0)
			...
			var_49_7(var_49_6, var_6.Action(function()
				...
				var_51_5(var_51_6, var_3_10003(1, 1, 0), 0.3)
...
function var_0_1.change2ScrPos(arg_52_0, arg_52_1, arg_52_2)
	...
	return (var_1_10004.ScreenToLocal(arg_52_1, arg_52_2, var_52_1))
end
