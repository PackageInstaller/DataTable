...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OnMapOp, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.WORLD_MAP_OP, arg_2_1)
	...
	arg_1_0:bind(var_0_1.OnMapReq, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10006.WORLD_MAP_REQ, {
			mapId = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.OnOpenScene, function(arg_5_0, arg_5_1, ...)
		...
		local var_5_3 = var_2_10004.UIMgr.GetInstance()
		...
		var_4(var_5_0, function()
			...
			local var_8_3 = var_3_10003.GO_SCENE
			local var_8_4 = arg_5_1

			unpack = var_3_10005

			var_8_2(var_8_1, var_8_3, var_8_4, var_3_10005(var_5_2, 1, var_5_2.len))
	...
	arg_1_0:bind(var_0_1.OnChangeScene, function(arg_9_0, arg_9_1, ...)
		...
		local var_9_3 = var_2_10004.UIMgr.GetInstance()
		...
		var_4(var_9_0, function()
			...
			local var_12_3 = var_3_10003.CHANGE_SCENE
			local var_12_4 = arg_9_1

			unpack = var_3_10005

			var_12_2(var_12_1, var_12_3, var_12_4, var_3_10005(var_9_2, 1, var_9_2.len))
	...
	arg_1_0:bind(var_0_1.OnStart, function(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
		...
		if var_13_0 > arg_13_3.GetLimitDamageLevel(var_13_1) then
			...
			i18n = var_2_10008
			var_13_1.content = var_2_10008("world_low_morale")
	...
	arg_1_0:bind(var_0_1.OnAutoSubmitTask, function(arg_15_0, arg_15_1)
		...
		var_15_1(var_15_0, var_2_10005.WORLD_AUTO_SUMBMIT_TASK, {
			taskId = arg_15_1.id
		})
...
function var_0_1.listNotificationInterests(arg_16_0)
	...
	var_1_10003.each(var_16_2, function(arg_17_0)
...
function var_0_1.handleNotification(arg_18_0, arg_18_1)
	...
	local var_18_3 = arg_18_1.getBody(var_18_2)

	WorldGuider = var_18_0

	local var_18_4 = var_18_0.GetInstance()

	var_4.WorldGuiderNotifyHandler(var_18_4, var_18_1, var_18_3, arg_18_0.viewComponent)

	nowWorld = var_4

	local var_18_5 = var_4()
	...
	GAME = var_9
	var_18_7[var_9.WORLD_MAP_OP_DONE] = function()
		local var_19_0 = var_18_3.mapOp
		local var_19_1 = arg_18_0.viewComponent
		local var_19_2 = var_1.GetCommand(var_19_1, var_19_0.depth)

		if var_18_3.result ~= 0 then
			var_19_2:OpDone()

			if var_18_3.result == 2 then
				local var_19_3 = var_18_5.staminaMgr
		...
		if 0 < var_19_7 then
			...
			if var_19_8 == var_5.OpReqCatSalvage then
				local var_19_9 = var_18_5
				local var_19_10 = var_4.GetFleet(var_19_9, var_19_0.id)
				local var_19_11 = var_4.GetSalvageScoreRarity(var_19_10)

				if var_18_5.isAutoFight then
					local var_19_12 = var_18_5

					var_5.AddAutoInfo(var_19_12, "salvage", {
					...
					var_5.insert(var_19_4, function(arg_20_0)
						...
						var_20_3.titleExtra = var_3_10006(var_19_11)
			...
			elseif var_18_5.isAutoFight then
				local var_19_13 = var_18_5

				var_4.AddAutoInfo(var_19_13, "drops", var_19_0.drops)
			else
				table = var_4
		...
		local var_19_14 = var_19_0.op

		WorldConst = var_5
		var_18_1 = var_5.ReqName[var_19_14]
		assert = var_5

		var_5(var_18_1, "invalid operation: " .. var_19_14)

		WorldConst = var_5

		if var_19_14 == var_5.OpReqTask then
			goto label_19_0
		end

		WorldConst = var_5

		if var_19_14 ~= var_5.OpReqPressingMap then
			WorldConst = var_5

			if var_19_14 == var_5.OpReqCatSalvage then
				local var_19_15 = var_19_4
				...
				function var_19_5()
					...
					var_0.OpDone(var_23_0, var_18_1 .. "Done", var_19_0, var_19_15)
				...
				function var_19_5()
					...
					var_0.OpDone(var_24_0, var_18_1 .. "Done", var_19_0)
			...
			seriesAsync = var_19_14

			var_19_14(var_19_4, var_19_5)

			return
		end
	end
	PlayerProxy = var_9
	var_18_7[var_9.UPDATED] = function()
		...
		local var_25_2 = var_2_10003(var_2_10005)

		var_25_1(var_25_0, var_3.getRawData(var_25_2))

		return
	end
	GAME = var_9
	var_18_7[var_9.BEGIN_STAGE_DONE] = function()
		local var_26_0 = arg_18_0
		local var_26_1 = var_0.sendNotification

		GAME = var_2_10003

		local var_26_2 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		var_26_1(var_26_0, var_26_2, var_2_10004.COMBATLOAD, var_18_3)

		return
	end
	GAME = var_9
	var_18_7[var_9.WORLD_STAMINA_EXCHANGE_DONE] = function()
	...
	WorldInventoryMediator = var_9
	var_18_7[var_9.OnMap] = function()
		local var_28_0 = arg_18_0.viewComponent

		var_0.Op(var_28_0, "OpFocusTargetEntrance", var_18_3)

		return
	end
	WorldCollectionMediator = var_9
	var_18_7[var_9.ON_MAP] = function()
		local var_29_0 = arg_18_0.viewComponent

		var_0.Op(var_29_0, "OpFocusTargetEntrance", var_18_3)

		return
	end
	var_18_7[var_0_1.OnOpenMarkMap] = function()
		local var_30_0 = arg_18_0.viewComponent

		var_0.Op(var_30_0, "OpShowMarkOverview", var_18_3)

		return
	end
	GAME = var_9
	var_18_7[var_9.WORLD_TRIGGER_TASK_DONE] = function()
		pg = var_2_10000

		local var_31_0 = var_2_10000.WorldToastMgr.GetInstance()

		var_0.ShowToast(var_31_0, var_18_3.task, false)

		return
	end
	GAME = var_9
	var_18_7[var_9.WORLD_SUMBMIT_TASK_DONE] = function()
		local var_32_0 = {}

		if #var_18_3.task.config.task_ed > 0 then
			table = var_2
		...
		if var_18_3.drops and #var_18_3.drops > 0 then
			if var_18_5.isAutoFight then
				local var_32_1 = var_18_5

				var_2.AddAutoInfo(var_32_1, "drops", var_18_3.drops)
			else
				table = var_2
				...
				var_2.insert(var_32_0, function(arg_34_0)
					...
					var_1.DisplayAwards(var_34_0, var_18_3.drops, {}, arg_34_0)
		...
		for iter_32_0, iter_32_1 in var_2(var_18_3.expfleets) do
			table = var_2_10007
			...
			var_2_10007.insert(var_32_0, function(arg_35_0)
				...
				var_35_3(var_35_2, var_3_10006.ON_SHIP_EXP, {
					title = "without word",
					oldShips = var_35_0,
					newShips = var_35_1
				}, arg_35_0)
	...
	GAME = var_9
	var_18_7[var_9.WORLD_AUTO_SUMBMIT_TASK_DONE] = function()
		local var_37_0 = {}
		...
		if var_18_3.drops and #var_18_3.drops > 0 then
			if var_18_5.isAutoFight then
				local var_37_1 = var_18_5

				var_2.AddAutoInfo(var_37_1, "drops", var_18_3.drops)
			else
				table = var_2
				...
				var_2.insert(var_37_0, function(arg_39_0)
					...
					var_1.DisplayAwards(var_39_0, var_18_3.drops, {}, arg_39_0)
		...
		for iter_37_0, iter_37_1 in var_2(var_18_3.expfleets) do
			table = var_2_10007
			...
			var_2_10007.insert(var_37_0, function(arg_40_0)
				...
				var_40_3(var_40_2, var_3_10006.ON_SHIP_EXP, {
					title = "without word",
					oldShips = var_40_0,
					newShips = var_40_1
				}, arg_40_0)
	...
	GAME = var_9
	var_18_7[var_9.WORLD_ITEM_USE_DONE] = function()
		local var_42_0 = var_18_3.item
		local var_42_1 = var_18_3.drops
		local var_42_2 = {}

		switch = var_2_10003

		local var_42_3 = var_42_0
		local var_42_4 = var_42_0.getWorldItemType(var_42_3)
		local var_42_5 = {}

		WorldItem = var_42_3
		var_42_5[var_42_3.UsageWorldClean] = function()
			table = var_3_10000
		...
		WorldItem = var_7
		var_42_5[var_7.UsageWorldFlag] = function()
			table = var_3_10000
		...
		WorldItem = var_7
		var_42_5[var_7.UsageWorldBuff] = function()
		...
		var_2_10003(var_42_4, var_42_5)

		if #var_42_1 > 0 then
			if var_18_5.isAutoFight then
				local var_42_6 = var_18_5

				var_3.AddAutoInfo(var_42_6, "drops", var_42_1)
			else
				table = var_3
	...
	GAME = var_9
	var_18_7[var_9.WORLD_RETREAT_FLEET] = function()
		local var_56_0 = var_18_5
	...
	var_18_7[var_0_1.OnTriggerTaskGo] = function()
		local var_57_0 = arg_18_0.viewComponent

		var_0.Op(var_57_0, "OpTaskGoto", var_18_3.taskId)

		return
	end
	GAME = var_9
	var_18_7[var_9.WORLD_MAP_REQ_DONE] = function()
		assert = var_2_10000
	...
	var_18_7[var_0_1.OnNotificationOpenLayer] = function()
		local var_59_0 = arg_18_0

		var_0.addSubLayers(var_59_0, var_18_3.context)

		return
	end
	GAME = var_9
	var_18_7[var_9.WORLD_TRIGGER_AUTO_FIGHT] = function()
	...
	GAME = var_9
	var_18_7[var_9.WORLD_TRIGGER_AUTO_SWITCH] = function()
	...
	var_18_7[var_0_1.OnStartAutoSwitch] = function()
	...
	var_18_7[var_0_1.OnMoveAndOpenLayer] = function()
		local var_63_0 = arg_18_0.viewComponent

		var_0.MoveAndOpenLayer(var_63_0, var_18_3)

		return
	end

	var_18_2(var_18_6, var_18_7)
