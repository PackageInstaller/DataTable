...
function var_0_1.init(arg_2_0)
	function arg_2_0.itemUpdateListenerFunc(...)
		...
		var_3_1(var_3_0, var_3.GetItemList(var_3_2))
	...
	local var_2_7 = var_1_10002(var_4)

	NotchAdapt = var_2_5

	if var_2_5.CheckNotchRatio == 2 or not var_2_7:CheckLargeScreen() then
	...
	var_2_10(var_2_9, var_6(var_1_10008)).constraintCount = var_2_6 and 8 or 7
	...
	var_2_13(var_2_12, var_7(var_1_10009)).constraintCount = var_2_6 and 8 or 7
	...
	var_2_16(var_2_15, var_8(var_1_10010)).constraintCount = var_2_6 and 8 or 7
	ItemUsagePanel = var_6

	local var_2_17 = var_6.New
	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_8.Find(var_2_18, "adapt/item_usage_panel")
	local var_2_20 = arg_2_0._tf

	arg_2_0.itemUsagePanel = var_2_17(var_2_19, var_9.Find(var_2_20, "adapt"))
	ItemResetPanel = var_6

	local var_2_21 = var_6.New
	local var_2_22 = arg_2_0._tf
	local var_2_23 = var_8.Find(var_2_22, "adapt/reset_info_panel")
	local var_2_24 = arg_2_0._tf

	arg_2_0.itemResetPanel = var_2_21(var_2_23, var_9.Find(var_2_24, "adapt"))
	WorldAssignedItemView = var_6

	local var_2_25 = var_6.New
	local var_2_26 = arg_2_0._tf

	arg_2_0.assignedItemView = var_2_25(var_8.Find(var_2_26, "adapt"), arg_2_0.event)
	arg_2_0.itemCards = {}
	...
	local var_2_32 = var_8.Find(var_2_31, "bottom_back/reset_exchange/Text")

	i18n = var_9

	var_6(var_2_32, var_9("world_inventory_tip"))
	...
	var_6(var_8.Find(var_2_42, "bg").rect.width)
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_3 = var_5.Find(var_4_2, "capcity")
	...
	local function var_4_4()
		...
		var_5_3.id = var_2_10005.ResourceID
	...
	var_2(var_4_1, var_4_3, var_4_4, var_4_2)
...
function var_0_1.onBackPressed(arg_6_0)
	...
	var_1_10001(var_3.Find(var_6_0, "bg").rect.width)
...
function var_0_1.willExit(arg_7_0)
	...
	var_7_2(var_7_1, var_1_10004.EventUpdateItem, arg_7_0.itemUpdateListenerFunc)
...
function var_0_1.addListener(arg_11_0)
	...
	local function var_11_2()
		...
		var_2_10000(var_2.Find(var_12_0, "bg").rect.width)
	...
	for iter_11_0, iter_11_1 in var_1(var_0_2.sort) do
		if iter_11_0 <= arg_11_0.sortContain.childCount then
			local var_11_6 = arg_11_0.sortContain

			if not var_1_10006.GetChild(var_11_6, iter_11_0 - 1) then
				cloneTplTo = var_1_10006
				var_1_10006 = var_1_10006(arg_11_0.sortTpl, arg_11_0.sortContain)
			end

			setActive = var_1_10007

			var_1_10007(var_1_10006, true)

			setImageSprite = var_1_10007
			findTF = var_9

			local var_11_7 = var_9(var_1_10006, "Image")

			GetSpriteFromAtlas = var_10

			var_1_10007(var_11_7, var_10("ui/equipmentui_atlas", iter_11_1.spr), true)

			onToggle = var_1_10007

			local var_11_8 = arg_11_0
			local var_11_9 = var_1_10006
			...
			var_1_10007(var_11_8, var_11_9, var_11_10, var_12)

			var_1_10007 = arg_11_0.sortButtons
			var_1_10007[iter_11_0] = var_1_10006
		end
	end
	...
	var_1(var_11_11, var_11_12, var_11_13, var_1_10006)
	...
	var_1(var_11_14, var_11_15, var_11_16, var_1_10006)
	...
	var_1(var_11_17, var_11_18, var_11_19, var_1_10006)
	...
	local function var_11_22()
		...
		var_19_19[1] = var_2_10007.EquipmentTypeSmallCannon
		IndexConst = var_7
		var_19_19[2] = var_7.EquipmentTypeMediumCannon
		IndexConst = var_7
		var_19_19[3] = var_7.EquipmentTypeBigCannon
		...
		IndexConst = var_7
		var_19_24[1] = var_7.EquipmentTypeWarshipTorpedo
		IndexConst = var_7
		var_19_24[2] = var_7.EquipmentTypeSubmaraineTorpedo
		...
		function var_19_0.callback(arg_20_0)
			...
			if var_20_1(var_20_0, var_3_10004(var_3_10006)) then
				bit = var_2

				local var_20_2 = var_2.band
				local var_20_3 = arg_20_0.extraIndex

				IndexConst = var_3_10005

				if var_20_2(var_20_3, var_3_10005.EquipmentExtraEquiping) > 0 then
				...
				var_2(var_20_5, var_5.GetShowBusyFlag(var_20_6))
			else
		...
		WorldInventoryMediator = var_4

		var_19_27(var_19_26, var_4.OPEN_EQUIPMENT_INDEX, var_19_0)
	...
	var_1(var_11_20, var_11_21, var_11_22, var_1_10006)
	...
	var_1(var_11_23, var_11_24, var_11_25, var_1_10006)
	...
	var_1(var_11_26, var_11_27, var_11_28, var_1_10006)
	...
	var_1(var_11_29, var_11_30, var_11_31, var_1_10006)
...
function var_0_1.setInventoryProxy(arg_25_0, arg_25_1)
	...
	WorldInventoryProxy = var_1_10005

	var_25_1(var_25_0, var_1_10005.EventUpdateItem, arg_25_0.itemUpdateListenerFunc)

	local var_25_2 = arg_25_0
	local var_25_3 = arg_25_0.setItemList
	local var_25_4 = arg_25_0.inventoryProxy

	var_25_3(var_25_2, var_5.GetItemList(var_25_4))
...
function var_0_1.initItem(arg_31_0, arg_31_1)
	...
	local function var_31_3()
		...
		if var_32_1 ~= var_2_10001.UsageBuff then
			WorldItem = var_32_3
			...
			if var_32_1 ~= var_32_3.UsageHPRegenerate then
				...
				if var_32_1 == var_32_3.UsageHPRegenerateValue then
					...
					WorldInventoryMediator = var_2_10004

					var_32_3(var_32_2, var_2_10004.OnOpenAllocateLayer, {
						...
						confirmCallback = function(arg_33_0, arg_33_1)
							...
							WorldInventoryMediator = var_3_10005

							var_33_1(var_33_0, var_3_10005.OnUseItem, arg_33_0, 1, arg_33_1)
				...
				if var_32_1 == var_32_3.UsageWorldMap then
					...
					ItemUsagePanel = var_5
					var_32_6.mode = var_5.SEE
					...
					function var_32_6.onUse()
						...
						var_35_1(var_35_0, var_3.getWorldItemOpenDisplay(var_35_2), function()
							local var_36_0 = arg_31_0
							local var_36_1 = var_0.emit

							WorldInventoryMediator = var_4_10003

							var_36_1(var_36_0, var_4_10003.OnMap, var_31_0.itemVO.id)
						...
						if var_32_1 ~= var_32_8.UsageWorldItem then
							...
							if var_32_1 == var_32_8.UsageWorldBuff then
								...
								function var_32_9.onUseBatch(arg_38_0)
									...
									var_38_1(var_38_0, var_3_10004.OnUseItem, var_31_0.itemVO.id, arg_38_0, {})
								...
								function var_32_9.onUseOne()
									...
									var_39_1(var_39_0, var_3_10003.OnUseItem, var_31_0.itemVO.id, 1, {})
								...
								if var_32_1 == var_1.UsageWorldFlag then
									...
									var_1.Open(var_32_13, {
										...
										onUse = function()
											...
											var_42_1(var_42_0, var_3_10003.OnUseItem, var_31_0.itemVO.id, 1, {})
	...
	var_1_10003(var_31_1, var_31_2, var_31_3, var_1_10008)
...
function var_0_1.updateResetExchange(arg_49_0)
	...
	local var_49_3 = var_4.Find(var_49_2, "capcity/Text")
	...
	var_49_5[1] = var_1_10011

	local var_49_6 = {}

	WorldConst = var_1_10012
	var_49_6[1] = var_1_10012.ResourceID

	var_1_10002(var_49_3, var_1_10005(var_7(var_49_4, var_49_5, var_49_6), 0))
...
function var_0_1.activeResetExchange(arg_50_0, arg_50_1)
	...
	local var_50_2 = var_50_1(var_50_0, var_1_10005.SystemResetExchange)

	setActive = var_1_10003

	var_1_10003(arg_50_0.exchangeTips, var_50_2 and arg_50_1)
...
function var_0_1.PlayOpenBox(arg_51_0, arg_51_1, arg_51_2)
	...
	local function var_51_0()
		...
		var_52_2(var_52_1, var_4.Find(var_52_3, "adapt"), false)
	...
	if var_4.Find(var_51_1, arg_51_1 .. "(Clone)") then
		go = var_1_10005
		arg_51_0[arg_51_1] = var_1_10005(var_4)
	end
	...
	if not arg_51_0[arg_51_1] then
		...
		var_51_3(var_51_2, var_51_4 .. var_1_10009.lower(arg_51_1), "", true, function(arg_55_0)
...
function var_0_1.initEquipment(arg_62_0, arg_62_1)
	...
	var_1_10003(var_62_1, var_62_2, var_62_3, var_1_10008)
...
function var_0_1.filterEquipment(arg_66_0)
	...
	if var_66_0 then
		...
		iter_66_0 = var_66_2
		CompareFuncs = iter_66_1

		var_66_5(iter_66_0, iter_66_1(var_0_2.sortFunc(var_66_0, var_66_4)))
	end
	...
	local var_66_6 = arg_66_0.sortBtn
	local var_66_7 = var_6.Find(var_66_6, "Image")

	GetSpriteFromAtlas = iter_66_0

	var_4(var_66_7, iter_66_0("ui/equipmentui_atlas", var_66_0.spr), true)
...
function var_0_1.Scroll2Equip(arg_68_0, arg_68_1)
	...
	for iter_68_0, iter_68_1 in var_2(arg_68_0.loadEquipmentVOs) do
		...
		if var_1_10007.SameEquip(iter_68_1, arg_68_1) then
			...
			local var_68_2 = var_1_10007(var_68_1, var_10(var_1_10012)).cellSize.y + var_1_10007.spacing.y
			...
			var_1_10012 = arg_68_0

			arg_68_0.ScrollEquipPos(var_1_10012, var_68_3 - arg_68_0.equipmentRect.paddingFront)
...
function var_0_1.ScrollEquipPos(arg_69_0, arg_69_1)
	...
	local var_69_3 = var_69_2(var_69_1, var_5(var_1_10007)).cellSize.y + var_2.spacing.y
...
function var_0_1.InitMaterial(arg_78_0, arg_78_1)
	...
	local function var_78_3()
		...
		if var_79_1 == var_2_10001.INVITATION_TYPE then
			local var_79_2 = arg_78_0
			local var_79_3 = var_0.emit

			EquipmentMediator = var_3

			local var_79_4 = var_3.ITEM_GO_SCENE

			SCENE = var_2_10004

			var_79_3(var_79_2, var_79_4, var_2_10004.INVITATION, {
	...
	var_1_10003(var_78_1, var_78_2, var_78_3, var_1_10008)
