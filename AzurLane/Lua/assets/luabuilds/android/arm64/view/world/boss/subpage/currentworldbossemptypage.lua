...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.timeTxt = var_2_2(var_2_1, var_4(var_1_10006))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		pg = var_2_10004
		var_4_2.helps = var_2_10004.gametip.world_boss_help_meta.tip
	...
	local function var_3_5()
		...
		var_5_1(var_5_0, var_2_10003.ON_UPDATE_BOSS_INFO, function()
			pg = var_3_10000
			...
			local var_6_4 = var_3_10007()

			var_6_2.content = var_3_10004(var_6_3, var_7.GetBossProxy(var_6_4).currentBossLV)

			function var_6_2.onYes()
				local var_7_0 = arg_3_0
				local var_7_1 = var_0.emit

				WorldBossMediator = var_4_10003

				local var_7_2 = var_4_10003.ON_BATTLE

				WorldBossConst = var_4_10004

				var_7_1(var_7_0, var_7_2, var_4_10004.GetCurrBossID(), nil, 1, true)
	...
	local var_3_11 = var_4.Find(var_3_10, "list_btn")
	...
	local function var_3_12()
		...
		local var_9_2 = var_2_10003.ON_SWITCH

		WorldBossScene = var_2_10004

		var_9_1(var_9_0, var_9_2, var_2_10004.PAGE_CHALLENGE)
	...
	var_1(var_3_9, var_3_11, var_3_12, var_3_10)
	...
	local function var_3_15()
		...
		if var_2_10000.CanUnlockCurrBoss() then
			...
			var_10_1(var_2_10003, var_2_10004.ON_ACTIVE_BOSS, var_10_0)
		else
			pg = var_10_0
			...
			var_10_3(var_10_2, var_2_10003("world_boss_item_count_noenough"))
		end
	...
	var_1(var_3_13, var_3_14, var_3_15, var_3_10)
...
function var_0_1.OnUpdate(arg_11_0)
	...
	if var_2.inTime(var_11_1, var_11_0) then
		...
		var_1_10003 = var_1_10003.CanUnlockCurrBoss()
	end

	setActive = var_11_1

	var_11_1(arg_11_0.useItem, var_1_10003)

	setActive = var_11_1

	var_11_1(arg_11_0.noItem, not var_1_10003)
	...
	if var_2 then
		...
		local var_11_6 = var_11_3.TimeMgr.GetInstance()
	...
	if not arg_11_0.metaWorldbossBtn then
		...
		var_11_7 = var_11_7(var_6.Find(var_11_8, "archives_btn"), arg_11_0.event)
	end
	...
	if not arg_11_0.ptBtn then
		...
		var_11_9 = var_11_9(var_6.Find(var_11_10, "point"))
	end
