...
function var_0_1.SetBossProxy(arg_2_0, arg_2_1, arg_2_2)
	...
	WorldBossProxy = var_6

	var_2_10(var_2_9, var_6.EventBossUpdated, arg_2_0.onBossUpdated)
...
function var_0_1.RemoveListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10004.EventBossUpdated, arg_6_0.onBossUpdated)
...
function var_0_1.didEnter(arg_17_0)
	...
	var_1(var_17_0, var_17_1, var_17_2, var_1_10006)
