...
function var_0_1.AddListeners(arg_3_0, arg_3_1)
	...
	var_3_1(var_3_0, var_1_10005.EventUnlockProgressUpdated, arg_3_0.onBossProgressUpdate)
	...
	var_3_3(var_3_2, var_5.EventPtUpdated, arg_3_0.onPtUpdated)
...
function var_0_1.RemoveListeners(arg_4_0, arg_4_1)
	...
	var_4_1(var_4_0, var_1_10005.EventUnlockProgressUpdated, arg_4_0.onBossProgressUpdate)
	...
	var_4_3(var_4_2, var_5.EventPtUpdated, arg_4_0.onPtUpdated)
...
function var_0_1.OnLoaded(arg_7_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_7_0.progressTxt = var_7_10(var_7_9, var_4(var_1_10006))
...
function var_0_1.OnInit(arg_8_0)
	...
	if var_1.Find(var_8_0, "title") then
		...
		local var_8_2 = var_3.Find(var_8_1, "title")

		typeof = var_4
		Image = var_6

		local var_8_3 = var_1(var_8_2, var_4(var_6))
...
function var_0_1.UpdateUseItemStyle(arg_9_0, arg_9_1)
	...
	local var_9_3 = var_9_2(var_9_1, var_5(var_1_10007))

	GetSpriteFromAtlas = var_1_10003
	var_9_3.sprite = var_1_10003("MetaWorldboss/" .. arg_9_1, "useitem")
	...
	local var_9_7 = var_9_6(var_9_5, var_5(var_1_10007))
