...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_2, var_4("world_map_title_tips"))

	setText = var_1

	local var_2_3 = arg_2_0.rtLeftPanel
	local var_2_4 = var_3.Find(var_2_3, "title/Text_en")

	i18n = var_4

	var_1(var_2_4, var_4("world_map_title_tips_en"))
	...
	local var_2_9 = var_3.Find(var_2_8, "power/bg/Word")

	i18n = var_2_6

	var_1(var_2_9, var_2_6("world_total_power"))

	setText = var_1

	local var_2_10 = arg_2_0.wsWorldInfo.transform
	local var_2_11 = var_3.Find(var_2_10, "explore/mileage/Text")

	i18n = var_4

	var_1(var_2_11, var_4("world_mileage"))

	setText = var_1

	local var_2_12 = arg_2_0.wsWorldInfo.transform
	local var_2_13 = var_3.Find(var_2_12, "explore/pressing/Text")

	i18n = var_4

	var_1(var_2_13, var_4("world_pressing"))
	...
	arg_2_0.taskItemList = var_2_20(var_2_21, var_4.Find(var_2_22, "task_tpl"))
...
function var_0_1.didEnter(arg_5_0)
	...
	var_1_10001(var_5_3, var_5_5, var_5_6, var_5_4)
	...
	local function var_5_9(arg_8_0)
		...
		if arg_8_0 then
			...
			if not var_2_10004.white then
				Color = var_2_10004
				var_2_10004 = var_2_10004.New(0.48627450980392156, 0.5215686274509804, 0.6431372549019608)
			end

			var_2_10001(var_8_1, var_2_10004)
	...
	var_1_10001(var_5_7, var_5_8, var_5_9, var_5_4)
	...
	local function var_5_12(arg_9_0)
		...
		if arg_9_0 then
			...
			var_2_10001(var_9_1, var_2_10004)
	...
	var_1_10001(var_5_10, var_5_11, var_5_12, var_5_4)
	...
	local function var_5_15()
		...
		if var_10_1(var_10_0, var_2_10003.SystemDailyTask) then
			var_10_0 = arg_5_0
			var_10_2 = var_10_2.emit
			WorldInformationMediator = var_3

			var_10_2(var_10_0, var_3.OnOpenDailyTaskPanel)
		else
			pg = var_10_2
	...
	var_1_10001(var_5_13, var_5_14, var_5_15, var_5_4)
...
function var_0_1.willExit(arg_11_0)
	...
	var_11_1(var_11_0, var_4.EventUpdateTask, arg_11_0.onUpdateTask)
	...
	var_11_3(var_11_2, var_4.EventUpdateDailyTaskIds, arg_11_0.onUpdateDailyTask)
...
function var_0_1.setWorldTaskProxy(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_1_10005.EventUpdateTask, arg_12_0.onUpdateTask)
	...
	var_12_3(var_12_2, var_5.EventUpdateDailyTaskIds, arg_12_0.onUpdateDailyTask)
...
function var_0_1.UpdateFilterTaskList(arg_13_0)
	...
	var_13_0(var_13_1, var_4(var_1_10006.sortDic))
...
function var_0_1.UpdateTaskTpl(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_1 = "ui/worldtaskfloatui_atlas"

	pg = var_1_10007

	var_1_10004(var_15_1, var_1_10007.WorldToastMgr.Type2PictrueName[arg_15_2.config.type], var_15_0:Find("type"), true)

	setText = var_1_10004

	var_1_10004(var_15_0:Find("extend_show/title/Text"), arg_15_2.config.name)

	setText = var_1_10004

	var_1_10004(var_15_0:Find("base_show/title/Text"), arg_15_2.config.name)

	setText = var_1_10004

	var_1_10004(var_15_0:Find("base_show/desc"), arg_15_2.config.description)

	local var_15_2 = var_15_0
	local var_15_3 = var_15_0.Find(var_15_2, "base_show/IconTpl")
	local var_15_4 = var_15_0:Find("base_show/award")

	removeAllChildren = var_15_2

	var_15_2(var_15_4)

	local var_15_5 = arg_15_2.config.show
	local var_15_6 = 1

	math = var_8

	for iter_15_0 = var_15_6, var_8.min(#var_15_5, 2) do
		local var_15_7 = var_15_5[iter_15_0]

		cloneTplTo = var_1_10012
		var_1_10012 = var_1_10012(var_15_3, var_15_4)
		...
		local function var_15_11()
			...
			var_0.emit(var_16_0, var_0_1.ON_DROP, var_15_8)
		...
		var_14(var_15_9, var_15_10, var_15_11, var_1_10019)
	...
	var_15_6(var_15_3, false)

	setSlider = var_15_6

	local var_15_12 = var_15_0:Find("base_show/title/progress")
	local var_15_13 = 0
	local var_15_14 = arg_15_2
	local var_15_15 = arg_15_2.getMaxProgress(var_15_14)
	local var_15_16 = arg_15_2

	var_15_6(var_15_12, var_15_13, var_15_15, arg_15_2.getProgress(var_15_16))

	local var_15_17 = var_15_0
	local var_15_18 = var_15_0.Find(var_15_17, "btn_go")

	onButton = var_8

	local var_15_19 = arg_15_0
	local var_15_20 = var_15_18

	local function var_15_21()
		local var_17_0 = arg_15_0
		local var_17_1 = var_0.emit

		WorldInformationMediator = var_2_10003

		var_17_1(var_17_0, var_2_10003.OnTaskGoto, arg_15_2.id)
	...
	var_8(var_15_19, var_15_20, var_15_21, var_15_14)
	...
	if not arg_15_2:GetFollowingAreaId() then
		var_15_23 = arg_15_2:GetFollowingEntrance()
	end

	var_8(var_15_22, var_15_20(var_15_23))

	local var_15_24 = var_15_0
	local var_15_25 = var_15_0.Find(var_15_24, "btn_get")

	onButton = var_15_17

	local var_15_26 = arg_15_0
	local var_15_27 = var_15_25
	...
	local function var_15_28()
		...
		var_18_1(var_18_0, var_2_10003.OnSubmitTask, arg_15_2)

		return
	end

	SFX_CONFIRM = var_15_16

	var_15_17(var_15_26, var_15_27, var_15_28, var_15_16)

	local var_15_29 = arg_15_2:getState()

	setActive = var_15_24

	local var_15_30 = var_15_18

	WorldTask = var_15_28

	var_15_24(var_15_30, var_15_29 == var_15_28.STATE_ONGOING)

	setActive = var_15_24

	local var_15_31 = var_15_25

	WorldTask = var_13

	var_15_24(var_15_31, var_15_29 == var_13.STATE_FINISHED)
	...
	local var_15_34 = var_15_32
	local var_15_35 = var_15_32.Find(var_15_34, "content/award_bg/panel/content")
	local var_15_36 = arg_15_2.config.show

	removeAllChildren = var_15_34

	var_15_34(var_15_35)

	ipairs = var_15_34

	for iter_15_1, iter_15_2 in var_15_34(var_15_36) do
		cloneTplTo = var_1_10020
		var_1_10020 = var_1_10020(var_15_33, var_15_35)
		...
		var_22(var_1_10020, var_15_37)

		onButton = var_22

		local var_15_38 = arg_15_0
		local var_15_39 = var_1_10020

		local function var_15_40()
			local var_19_0 = arg_15_0

			var_0.emit(var_19_0, var_0_1.ON_DROP, var_15_37)
		...
		var_22(var_15_38, var_15_39, var_15_40, var_1_10027)
	...
	var_15(var_15_32:Find("content/award_bg/arror"), #var_15_36 > 3)
...
function var_0_1.OnUpdateDailyTask(arg_21_0)
	...
	local var_21_1 = var_3.Find(var_21_0, "tip")
	local var_21_2 = arg_21_0.taskProxy

	var_1_10001(var_21_1, var_4.canAcceptDailyTask(var_21_2))

	setActive = var_1_10001

	local var_21_3 = arg_21_0.btnDailyTask
	local var_21_4 = var_3.Find(var_21_3, "locked")

	nowWorld = var_4

	local var_21_5 = var_4()
	local var_21_6 = var_4.IsSystemOpen

	WorldConst = var_1_10007

	var_1_10001(var_21_4, not var_21_6(var_21_5, var_1_10007.SystemDailyTask))
