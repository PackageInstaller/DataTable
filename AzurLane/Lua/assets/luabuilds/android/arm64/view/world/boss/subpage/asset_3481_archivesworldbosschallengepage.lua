...
function var_0_1.OnLoaded(arg_4_0)
	...
	var_1(var_4_3, var_4("world_boss_archives_boss_tip"))
...
function var_0_1.OnInit(arg_5_0)
	...
	local function var_5_2()
		...
		if var_0.GetSelfBoss(var_6_1) then
			...
			if var_2_10001._IsCurrBoss(var_0) then
				pg = var_1
				...
				var_6_3(var_6_2, var_2_10004("current_boss_was_opened"))
		...
		do
			...
			local var_6_6 = var_2_10004.ON_SWITCH

			WorldBossScene = var_2_10005

			var_6_5(var_6_4, var_6_6, var_2_10005.PAGE_ARCHIVES)
		end
	...
	local function var_5_5()
		...
		var_7_1(var_7_0, var_7_2, var_2_10004.PAGE_CHALLENGE)
	...
	local var_5_8 = var_4.Find(var_5_7, "help")
	...
	local function var_5_9()
		...
		pg = var_2_10004
		var_8_2.helps = var_2_10004.gametip.world_archives_boss_help.tip
	...
	var_1(var_5_6, var_5_8, var_5_9, var_5_7)
...
function var_0_1.UpdateEmptyCard(arg_9_0)
	...
	local var_9_4 = var_9_3(var_9_2, var_5(var_1_10007))

	WorldBossConst = var_9_0

	local var_9_5 = var_9_0.GetAchieveState()

	WorldBossConst = var_9_2

	if var_9_5 == var_9_2.ACHIEVE_STATE_STARTING then
