...
function var_0_1.init(arg_3_0)
	...
	local var_3_7 = var_3.Find(var_3_6, "content")
	local var_3_8 = arg_3_0.rtShop

	arg_3_0.goodsItemList = var_3_5(var_3_7, var_4.Find(var_3_8, "content/item_tpl"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_5()
		...
		var_7_3.id = var_2_10005.ResourceID
	...
	var_1.make(var_5_6, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10004.EventUpdate then
			...
			local var_8_3 = var_8_1(var_8_2, var_2_10007.TYPE_WORLD)

			WorldGoodsCard = var_2_10005

			local var_8_4 = var_2_10005.New(arg_8_2)

			var_5.update(var_8_4, var_8_3)

			local var_8_5 = var_8_3:getLimitCount()

			setText = var_7

			local var_8_6 = arg_8_2:Find("item/count_contain/label")

			i18n = var_2_10010

			var_7(var_8_6, var_2_10010("activity_shop_exchange_count"))

			setText = var_7

			var_7(arg_8_2:Find("item/count_contain/count"), var_8_5 - var_8_3.buyCount .. "/" .. var_8_5)

			setTextColor = var_7

			local var_8_7 = arg_8_2:Find("item/count_contain/count")

			Color = var_10

			local var_8_8 = var_10.New

			unpack = var_12
			ActivityGoodsCard = var_2_10014

			var_7(var_8_7, var_8_8(var_12(var_2_10014.DefaultColor)))

			setTextColor = var_7

			local var_8_9 = arg_8_2:Find("item/count_contain/label")

			Color = var_10

			local var_8_10 = var_10.New

			unpack = var_12
			ActivityGoodsCard = var_14

			var_7(var_8_9, var_8_10(var_12(var_14.DefaultColor)))

			onButton = var_7

			local var_8_11 = arg_5_0
			...
			local function var_8_13()
				...
				ShopArgs = var_3_10002

				if var_9_2 == var_3_10002.WorldCollection then
					var_9_1 = var_9_0
					var_9_1 = var_9_0.GetTaskProxy(var_9_1)

					if var_1.hasDoingCollectionTask(var_9_1) then
						pg = var_1
						var_9_1 = var_1.TipsMgr.GetInstance()

						local var_9_3 = var_1.ShowTips

						i18n = var_4

						var_9_3(var_9_1, var_4("world_collection_task_tip_1"))
				...
				if var_8_3.id == 100000 then
					...
					local var_9_4 = var_1.any

					underscore = var_9_1

					if not var_9_4(var_9_1.values(var_9_0.pressingAwardDic), function(arg_10_0)
						return arg_10_0.flag
					end) then
						pg = var_1

						local var_9_5 = var_1.TipsMgr.GetInstance()
						local var_9_6 = var_1.ShowTips

						i18n = var_4

						var_9_6(var_9_5, var_4("world_complete_item_tip"))
				...
				local var_9_7 = var_8_3

				if not var_1.canPurchase(var_9_7) then
					pg = var_1

					local var_9_8 = var_1.TipsMgr.GetInstance()
					local var_9_9 = var_1.ShowTips

					i18n = var_4

					var_9_9(var_9_8, var_4("buy_countLimit"))
				...
				if not (var_8_5 > 1) or not arg_5_0.multiWindow then
					var_9_10 = arg_5_0.singleWindow
				end

				var_9_10:ExecuteAction("Open", var_8_3, function(arg_11_0, arg_11_1)
					local var_11_0 = arg_5_0
					local var_11_1 = var_2.emit

					WorldShopMediator = var_4_10005

					var_11_1(var_11_0, var_4_10005.BUY_ITEM, arg_11_0.id, arg_11_1)
			...
			var_7(var_8_11, var_8_12, var_8_13, var_12)
		end
	...
	arg_5_0.AddWorldListener(var_5_7)

	nowWorld = var_1

	local var_5_8 = var_1()

	arg_5_0:updateGoods(nil, nil, var_5_8:GetWorldShopGoodsDictionary())

	local var_5_9 = var_5_8:IsReseted()

	setActive = var_5_7

	var_5_7(arg_5_0.rtResetTime, var_5_9)

	setActive = var_5_7

	var_5_7(arg_5_0.rtResetTip, not var_5_9)

	setText = var_5_7

	local var_5_10 = arg_5_0.rtResetTime
	local var_5_11 = var_5.Find(var_5_10, "number")

	math = var_6

	var_5_7(var_5_11, var_6.floor(var_5_8:GetResetWaitingTime() / 0))

	setText = var_5_7

	local var_5_12 = arg_5_0.rtResetTip
	local var_5_13 = var_5.Find(var_5_12, "info")

	i18n = var_6

	var_5_7(var_5_13, var_6("world_shop_preview_tip"))

	if var_5_9 then
		WorldGuider = var_5_7

		local var_5_14 = var_5_7.GetInstance()
...
function var_0_1.setPlayer(arg_14_0, arg_14_1)
	...
	var_14_1.type = var_1_10007
	WorldConst = var_1_10007
	var_14_1.id = var_1_10007.ResourceID

	local var_14_2 = var_14_0(var_14_1)
	local var_14_3 = var_4.getIcon(var_14_2)
	local var_14_4 = ""
	local var_14_5 = arg_14_0.rtRes

	var_1_10002(var_14_3, var_14_4, var_6.Find(var_14_5, "icon"), true)

	setText = var_1_10002

	local var_14_6 = arg_14_0.rtRes
	local var_14_7 = var_4.Find(var_14_6, "number")
	local var_14_8 = arg_14_0.player
	local var_14_9 = var_5.getResource

	WorldConst = var_14_5

	var_1_10002(var_14_7, var_14_9(var_14_8, var_14_5.ResourceID))
...
function var_0_1.AddWorldListener(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10004.EventUpdateShopGoods, arg_15_0.onUpdateGoods)
...
function var_0_1.RemoveWorldListener(arg_16_0)
	...
	var_16_1(var_16_0, var_1_10004.EventUpdateShopGoods, arg_16_0.onUpdateGoods)
...
function var_0_1.updateGoods(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	...
	local var_17_2 = var_5
	local var_17_3 = var_5.GetTaskProxy(var_17_2)
	local var_17_4 = {}

	pairs = var_17_2

	for iter_17_0, iter_17_1 in var_17_2(arg_17_3) do
		local var_17_5 = var_17_0
		local var_17_6 = var_17_0.inTime

		pg = var_1_10017

		if var_17_6(var_17_5, var_1_10017.shop_template[iter_17_0].time) then
			local var_17_7 = var_17_0
			local var_17_8 = var_17_0.inTime

			pg = var_1_10017

			if not var_17_8(var_17_7, var_1_10017.shop_template[iter_17_0].time, var_17_1 - 1) then
				-- block empty
			else
				if iter_17_0 == 100000 then
					nowWorld = var_14

					local var_17_9 = var_14()

					if not var_14.IsReseted(var_17_9) then
						goto label_17_0
					end
				end
				...
				local var_17_10 = var_14.shop_template[iter_17_0].genre

				ShopArgs = var_1_10015

				if var_17_10 == var_1_10015.WorldCollection and iter_17_1 == 0 then
					local var_17_11 = var_17_3

					var_17_10 = var_17_3.getRecycleTask
					pg = var_1_10017

					if var_17_10(var_17_11, var_1_10017.shop_template[iter_17_0].effect_args[2]) then
						goto label_17_0
					end
				end
	...
	local var_17_12 = var_9.sort
	local var_17_13 = var_17_4

	CompareFuncs = iter_17_0

	var_17_12(var_17_13, iter_17_0({
		function(arg_18_0)
			pg = var_2_10001
	...
	local var_17_14 = arg_17_0.goodsItemList

	var_9.align(var_17_14, #arg_17_0.goodsList)
