...
function var_0_1.OnInit(arg_3_0)
	...
	arg_3_0.uilist1 = var_3_2(var_4.Find(var_3_3, "frame/list/container1"), var_3_1)
	UIItemList = var_2

	local var_3_4 = var_2.New
	local var_3_5 = arg_3_0._tf

	arg_3_0.uilist2 = var_3_4(var_4.Find(var_3_5, "frame/list/container2"), var_3_1)
	onButton = var_2
	...
	var_2(var_3_6, var_3_7, var_3_8, var_7)
...
function var_0_1.UpdateAwards(arg_6_0)
	...
	local function var_6_2(arg_7_0, arg_7_1)
		...
		var_6(var_7_5, var_7_6, var_7_7, var_2_10011)
	...
	var_6_6(var_6_5, var_7.min(#var_6_1, 4))
	...
	var_6_8(var_6_7, var_7.max(0, #var_6_1 - 4))
