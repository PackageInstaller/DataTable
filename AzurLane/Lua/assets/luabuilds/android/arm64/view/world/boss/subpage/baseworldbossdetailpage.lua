...
function var_0_1.OnLoaded(arg_3_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.leftTime = var_3_6(var_3_5, var_4(var_1_10006))
	UIItemList = var_1

	local var_3_7 = var_1.New
	local var_3_8 = arg_3_0._tf
	local var_3_9 = var_3.Find(var_3_8, "award_panel/list")
	local var_3_10 = arg_3_0._tf

	arg_3_0.awardList = var_3_7(var_3_9, var_4.Find(var_3_10, "award_panel/list/tpl"))
	...
	typeof = var_4
	Text = var_3_10
	arg_3_0.levelTxt = var_3_13(var_3_12, var_4(var_3_10))
	...
	typeof = var_4
	Text = var_3_10
	arg_3_0.hpTxt = var_3_16(var_3_15, var_4(var_3_10))
	...
	typeof = var_4
	Slider = var_3_10
	arg_3_0.hpSlider = var_3_19(var_3_18, var_4(var_3_10))
	...
	var_1.SetCallback(var_3_21, function(arg_4_0)
		...
		local function var_5_2()
			if arg_5_0 >= arg_5_1 then
				...
				var_6_1(var_6_0, var_3_10003("world_joint_max_challenge_people_cnt"))
			...
			if var_0.isDeath(var_6_2) then
				...
				var_6_4(var_6_3, var_3_10003("world_joint_boss_is_death"))
			else
		...
		var_2_10002(var_5_0, var_5_1, var_5_2, var_2_10007)
	...
	local var_3_23 = var_3.Find(var_3_22, "btns/time/label")

	i18n = var_4

	var_1(var_3_23, var_4("time_remaining_tip"))
...
function var_0_1.OnInit(arg_7_0)
	...
	local function var_7_5()
		...
		if var_0.GetLeftTime(var_9_0) <= 0 then
			...
			var_9_2(var_9_1, var_2_10003("world_joint_boss_award_expired"))
		else
			...
			var_9_5(var_9_4, var_2_10003.ON_SUBMIT_AWARD, arg_7_0.boss.id)
		end
...
function var_0_1.OnStart(arg_10_0)
	...
	if var_1.isDeath(var_10_0) then
		...
		var_10_2(var_10_1, var_1_10004("world_joint_boss_is_death"))
	else
		...
		if var_1.GetLeftTime(var_10_3) <= 0 then
			...
			var_10_5(var_10_4, var_1_10004("world_joint_boss_is_death"))
		else
			...
			var_10_7(var_10_6, var_1_10004.ON_BATTLE, arg_10_0.boss.id, false, arg_10_0.hpSlider.value)
		end
	end
...
function var_0_1.AddListeners(arg_11_0, arg_11_1)
	...
	WorldBossProxy = var_1_10005

	var_11_1(var_11_0, var_1_10005.EventPtUpdated, arg_11_0.onPtUpdated)
	...
	var_11_3(var_11_2, var_5.EventBossUpdated, arg_11_0.onBossUpdated)
	...
	var_11_5(var_11_4, var_5.EventRankListUpdated, arg_11_0.onRankListUpdated)
	...
	var_11_7(var_11_6, var_5.EventUnlockProgressUpdated, arg_11_0.onBossProgressUpdate)
...
function var_0_1.RemoveListeners(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_1_10005.EventPtUpdated, arg_12_0.onPtUpdated)
	...
	var_12_3(var_12_2, var_5.EventBossUpdated, arg_12_0.onBossUpdated)
	...
	var_12_5(var_12_4, var_5.EventRankListUpdated, arg_12_0.onRankListUpdated)
	...
	var_12_7(var_12_6, var_5.EventUnlockProgressUpdated, arg_12_0.onBossProgressUpdate)
...
function var_0_1.UpdatePainting(arg_17_0, arg_17_1)
	...
	if arg_17_0.groupId ~= arg_17_1 then
		...
		local var_17_3 = var_17_2(var_17_1, var_5(var_1_10007))

		GetSpriteFromAtlas = var_1_10003
		var_17_3.sprite = var_1_10003("MetaWorldboss/" .. arg_17_0.groupId, "title" .. arg_17_0:GetResSuffix())
		...
		WorldBossConst = var_17_1

		if var_17_1.MetaId2BossId(arg_17_1) then
			pg = var_5
...
function var_0_1.UpdateAward(arg_21_0)
	...
	var_3.make(var_21_2, function(arg_22_0, arg_22_1, arg_22_2)
		...
		if arg_22_0 == var_2_10003.EventUpdate then
			...
			local function var_22_7()
				...
				var_23_1(var_23_0, var_3_10003.ON_DROP, var_22_1)
			...
			var_7(var_22_5, var_22_6, var_22_7, var_2_10012)
		end
	...
	var_21_4(var_21_3, var_6.min(#var_21_1, 3))
...
function var_0_1.UpdateMainInfo(arg_24_0)
	...
	local var_24_5 = var_24_0
	local var_24_6 = var_24_0.IsExpired(var_24_5)
	local var_24_7 = var_24_1:canGetSelfAward()

	setActive = var_24_5

	var_24_5(arg_24_0.supportBtn, not var_24_4 and not var_24_6)

	setActive = var_24_5
	tf = var_10

	var_24_5(var_10(arg_24_0.leftTime).parent, true)

	setActive = var_24_5

	var_24_5(arg_24_0.awardBtn, var_24_4 and var_24_7)

	setActive = var_24_5

	var_24_5(arg_24_0.startBtn, not var_24_4 and not var_24_6)
...
function var_0_1.AddChanllengTimer(arg_25_0)
	...
	local var_25_3 = var_1
	local var_25_4 = var_1.GetExpiredTime(var_25_3)
	...
	if var_25_4 < var_25_2 then
		var_25_5()
	else
		Timer = var_25_3
		arg_25_0.bossTimer = var_25_3.New(function()
			local var_28_0 = var_25_4
			...
			if var_28_0 - var_1.GetServerTime(var_28_1) > 0 then
				...
				local var_28_3 = var_2_10002.TimeMgr.GetInstance()
		...
		local var_25_6 = arg_25_0.bossTimer

		var_5.Start(var_25_6)
...
function var_0_1.AddGetAwaradTimer(arg_30_0)
	...
	local var_30_3 = var_1
	local var_30_4 = var_1.GetExpiredTime(var_30_3)
	...
	if var_30_4 < var_30_2 then
		...
		Timer = var_30_3
		arg_30_0.awardTimer = var_30_3.New(function()
			local var_33_0 = var_30_4
			...
			if var_33_0 - var_1.GetServerTime(var_33_1) > 0 then
				...
				local var_33_3 = var_2_10002.TimeMgr.GetInstance()
		...
		local var_30_6 = arg_30_0.awardTimer

		var_5.Start(var_30_6)
...
function var_0_1.OnBossExpired(arg_34_0)
	...
	var_34_1(var_34_0, var_1_10004.ON_SELF_BOSS_OVERTIME)
