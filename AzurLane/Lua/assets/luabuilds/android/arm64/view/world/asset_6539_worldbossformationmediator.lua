...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.REMOVE_SHIP, function(arg_2_0, arg_2_1, arg_2_2)
		if not arg_2_2:canRemove(arg_2_1) then
			...
			local var_2_1, var_2_2 = arg_2_2.getShipPos(var_2_0, arg_2_1)

			pg = var_2_0

			local var_2_3 = var_2_0.TipsMgr.GetInstance()
			local var_2_4 = var_5.ShowTips

			i18n = var_2_10008

			local var_2_5 = "ship_formationUI_removeError_onlyShip"
			local var_2_6 = arg_2_1
			local var_2_7 = arg_2_1.getConfigTable(var_2_6).name
			local var_2_8 = arg_2_2.name

			Fleet = var_2_6

			var_2_4(var_2_3, var_2_10008(var_2_5, var_2_7, var_2_8, var_2_6.C_TEAM_NAME[var_2_2]))
		...
		var_3.UpdateFleetView(var_2_9, true)
	...
	arg_1_0:bind(var_0_1.OPEN_SHIP_INFO, function(arg_4_0, arg_4_1, arg_4_2)
		...
		local var_4_5 = iter_4_0.GO_SCENE

		SCENE = iter_4_1

		var_4_4(var_4_3, var_4_5, iter_4_1.SHIPINFO, {
			shipId = arg_4_1,
			shipVOs = var_4_2
		})
	...
	arg_1_0:bind(var_0_1.ON_START, function(arg_7_0)
		...
		if not arg_1_0.contextData.isSimulate then
			...
			if var_7_2 ~= true then
				pg = var_7_1
				var_2_10006 = var_7_1.TipsMgr.GetInstance()
				var_7_1 = var_7_1.ShowTips
				i18n = var_2_10007

				var_7_1(var_2_10006, var_2_10007("elite_disable_no_fleet"))
			...
			local var_7_5 = var_4.GetBossProxy(var_7_4)

			if not var_2_10005.GetBossById(var_7_5, arg_1_0.contextData.bossId) then
				pg = var_2_10006

				local var_7_6 = var_2_10006.TipsMgr.GetInstance()
				local var_7_7 = var_6.ShowTips

				i18n = var_2_10009

				var_7_7(var_7_6, var_2_10009("world_joint_boss_not_found"))

				return
			end

			if arg_1_0.contextData.isOther then
				local var_7_8 = var_1_3

				if var_6.GetPt(var_7_8) <= 0 then
					WorldBossConst = var_6

					if var_6._IsCurrBoss(var_2_10005) then
						pg = var_6

						local var_7_9 = var_6.TipsMgr.GetInstance()
						local var_7_10 = var_6.ShowTips

						i18n = var_2_10009

						var_7_10(var_7_9, var_2_10009("world_joint_count_no_enough"))
		...
		local var_7_11 = arg_1_0
		local var_7_12 = var_2.sendNotification

		GAME = var_2_10005

		local var_7_13 = var_2_10005.BEGIN_STAGE
		local var_7_14 = {
			actId = 0,
		...
		isSimulate = var_7
		var_7_14.isSimulate = var_7

		var_7_12(var_7_11, var_7_13, var_7_14)
	...
	arg_1_0:bind(var_0_1.CHANGE_FLEET_SHIP, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
		...
		local var_8_6 = var_2_10010.GO_SCENE

		SCENE = var_2_10011

		local var_8_7 = var_2_10011.DOCKYARD
		local var_8_8 = {
			selectedMin = 1,
			selectedMax = 1,
			ignoredIds = var_8_3
		...
		i18n = var_2_10013
		var_8_8.leastLimitMsg = var_2_10013("ship_formationMediator_leastLimit")
		var_8_8.quitTeam = var_8_1
		var_8_8.teamFilter = arg_8_3
		i18n = var_13
		var_8_8.leftTopInfo = var_13("word_formation")
		...
		function var_8_8.onShip(arg_9_0)
			...
			if var_3_10001.any(arg_8_2.ships, function(arg_10_0)
				...
				return var_10_1(var_10_0, var_4.getShipById(var_10_2, arg_10_0))
			end) then
				local var_9_0 = false

				i18n = var_3_10002

				local var_9_1 = var_3_10002("event_same_type_not_allowed")
		...
		function var_8_8.onSelected(arg_11_0)
			...
			local var_11_1 = var_3_10002(var_3_10004)
		...
		ShipStatus = var_13
		var_8_8.hideTagFlags = var_13.TAG_HIDE_ALL
...
function var_0_1.onAutoBtn(arg_12_0, arg_12_1)
	...
	local var_12_4 = var_1_10007.AUTO_BOT
	local var_12_5 = {
...
function var_0_1.handleNotification(arg_14_0, arg_14_1)
	...
	local var_14_2 = arg_14_1:getBody()

	GAME = var_14_0

	local var_14_4

	if var_14_1 == var_14_0.BEGIN_STAGE_DONE then
		...
		var_14_4(var_14_3, var_1_10007, var_1_10008.COMBATLOAD, var_14_2)
	else
		GAME = var_14_4

		local var_14_6

		if var_14_1 == var_14_4.WORLD_BOSS_START_BATTLE_FIALED then
			local var_14_5 = arg_14_0.viewComponent

			var_14_6 = var_14_6.emit
			BaseUI = var_1_10007

			var_14_6(var_14_5, var_1_10007.ON_CLOSE)
		else
			PlayerProxy = var_14_6

			local var_14_8

			if var_14_1 == var_14_6.UPDATED then
				...
				local var_14_9 = var_1_10007(var_1_10009)

				var_14_8(var_14_7, var_7.getData(var_14_9))
			else
				GAME = var_14_8

				if var_14_1 == var_14_8.END_GUIDE then
