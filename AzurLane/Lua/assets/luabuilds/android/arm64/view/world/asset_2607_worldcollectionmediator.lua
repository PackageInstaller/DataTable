...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_ACHIEVE_OVERVIEW, function(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10004.OnOpenMarkMap, {
			mode = "Achievement"
		})
	...
	local var_1_2 = var_4()
	local var_1_3 = var_4.GetAtlas(var_1_2)

	var_1_1(var_1_0, var_4.GetAchEntranceList(var_1_3))
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_1 == var_6_0.WORLD_ACHIEVE_DONE then
		local var_6_3 = arg_6_0.viewComponent
		local var_6_4 = var_4.emit

		BaseUI = var_1_10007

		var_6_4(var_6_3, var_1_10007.ON_ACHIEVE, var_6_2.drops, function()
