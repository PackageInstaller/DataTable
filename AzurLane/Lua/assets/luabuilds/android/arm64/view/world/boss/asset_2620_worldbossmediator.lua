...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_ARCHIVES_BOSS_STOP_AUTO_BATTLE, function(arg_2_0, arg_2_1)
		...
		local var_2_2 = var_2_10005.WORLD_ARCHIVES_BOSS_STOP_AUTO_BATTLE
		local var_2_3 = {
			id = arg_2_1
		}

		WorldBossConst = var_2_10007
		var_2_3.type = var_2_10007.STOP_AUTO_BATTLE_MANUAL
	...
	arg_1_0:bind(var_0_1.ON_ARCHIVES_BOSS_AUTO_BATTLE_TIMEOVER, function(arg_3_0, arg_3_1)
		...
		local var_3_2 = var_2_10005.WORLD_ARCHIVES_BOSS_STOP_AUTO_BATTLE
		local var_3_3 = {
			id = arg_3_1
		}

		WorldBossConst = var_2_10007
		var_3_3.type = var_2_10007.STOP_AUTO_BATTLE_TIMEOVER
	...
	arg_1_0:bind(var_0_1.ON_ARCHIVES_BOSS_AUTO_BATTLE, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10005.WORLD_ARCHIVES_BOSS_AUTO_BATTLE, {
			id = arg_4_1
		})
	...
	arg_1_0:bind(var_0_1.ON_ACTIVE_ARCHIVES_BOSS, function(arg_5_0)
		...
		local var_5_5 = var_2_10005.WORLD_ACTIVE_WORLD_BOSS
		local var_5_6 = {
			id = var_5_2
		}

		WorldBossConst = var_2_10007
		var_5_6.type = var_2_10007.BOSS_TYPE_ARCHIVES
	...
	arg_1_0:bind(var_0_1.ON_ACTIVE_BOSS, function(arg_6_0, arg_6_1)
		...
		local var_6_2 = var_2_10005.WORLD_ACTIVE_WORLD_BOSS
		local var_6_3 = {
			id = arg_6_1
		}

		WorldBossConst = var_2_10007
		var_6_3.type = var_2_10007.BOSS_TYPE_CURR
	...
	arg_1_0:bind(var_0_1.ON_SWITCH_ARCHIVES, function(arg_7_0, arg_7_1)
		...
		var_7_1(var_7_0, var_2_10005.SWITCH_WORLD_BOSS_ARCHIVES, {
			id = arg_7_1
		})
	...
	arg_1_0:bind(var_0_1.FETCH_RANK_FORMATION, function(arg_8_0, arg_8_1, arg_8_2)
		...
		var_8_1(var_8_0, var_2_10006.WORLD_BOSS_GET_FORMATION, {
			bossId = arg_8_2,
			userId = arg_8_1
		})
	...
	arg_1_0:bind(var_0_1.GO_META, function(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_9_2, var_2_10006.METACHARACTER, {
			autoOpenSyn = true,
	...
	arg_1_0:bind(var_0_1.ON_SELF_BOSS_OVERTIME, function(arg_10_0)
		...
		var_10_1(var_10_0, var_2_10004.WORLD_SELF_BOSS_OVERTIME)
	...
	arg_1_0:bind(var_0_1.ON_SUBMIT_AWARD, function(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_2_10005.WORLD_BOSS_SUBMIT_AWARD, {
			bossId = arg_11_1
		})
	...
	arg_1_0:bind(var_0_1.ON_SURPPORT, function(arg_12_0, arg_12_1)
		if arg_12_1[3] == true then
			...
			GAME = var_2_10005
			var_2_10005 = var_2_10005.WORLD_BOSS_SUPPORT

			local var_12_2 = {}

			WorldBoss = var_2_10007
			var_12_2.type = var_2_10007.SUPPORT_TYPE_WORLD

			var_12_1(var_12_0, var_2_10005, var_12_2)
		end
		...
		if arg_12_1[1] == true then
			...
			WorldBoss = var_2_10007
			var_12_5.type = var_2_10007.SUPPORT_TYPE_FRIEND

			var_12_4(var_12_3, var_2_10005, var_12_5)
		end
		...
		if arg_12_1[2] == true then
			...
			local var_12_8 = var_2_10005.WORLD_BOSS_SUPPORT
			local var_12_9 = {}

			WorldBoss = var_2_10007
			var_12_9.type = var_2_10007.SUPPORT_TYPE_GUILD
	...
	arg_1_0:bind(var_0_1.ON_BATTLE, function(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4)
		...
		var_14_1(var_14_0, var_2_10008.WORLD_BOSS_START_BATTLE, {
			bossId = arg_14_1,
			isOther = arg_14_2,
	...
	arg_1_0:bind(var_0_1.ON_RANK_LIST, function(arg_15_0, arg_15_1)
		...
		var_15_1(var_15_0, var_2_10005.WORLD_GET_BOSS_RANK, {
			bossId = arg_15_1
		})
	...
	arg_1_0:bind(var_0_1.GET_RANK_CNT, function(arg_16_0, arg_16_1, arg_16_2)
		...
		if not var_3.GetRank(var_16_0, arg_16_1) then
			...
			var_16_2(var_16_1, var_2_10007.WORLD_GET_BOSS_RANK, {
				bossId = arg_16_1,
				callback = arg_16_2
			})
		else
	...
	arg_1_0:bind(var_0_1.UPDATE_CACHE_BOSS_HP, function(arg_17_0, arg_17_1)
		...
		var_17_1(var_17_0, var_2_10005.GET_CACHE_BOSS_HP, {
			callback = arg_17_1
		})
	...
	arg_1_0:bind(var_0_1.ON_UPDATE_BOSS_INFO, function(arg_18_0, arg_18_1)
		...
		var_18_1(var_18_0, var_2_10005.WORLD_GET_BOSS, {
			callback = arg_18_1
		})
...
function var_0_1.updateBossProxy(arg_19_0)
	...
	if not var_4.inOtherBossBattle and not arg_19_0.contextData.worldBossId and not var_19_1:ExistSelfBossAward() and var_19_1:GetCanGetAwardBoss() then
		var_1_10005 = arg_19_0.contextData
		var_1_10005.worldBossId = var_4.id
	end
	...
	if var_4.inOtherBossBattle or arg_19_0.contextData.worldBossId then
		if var_19_1:GetCacheBoss(arg_19_0.contextData.worldBossId) then
			WorldBossConst = var_1_10005

			if not var_1_10005._IsCurrBoss(var_4) then
				var_19_4 = arg_19_0.viewComponent

				local var_19_5 = var_5.SwitchPage

				WorldBossScene = var_8

				var_19_5(var_19_4, var_8.PAGE_ARCHIVES_CHALLENGE)
		...
		var_19_6(var_19_4, var_8.PAGE_CHALLENGE)
	else
		local var_19_7 = arg_19_0.viewComponent
		local var_19_8 = var_4.SwitchPage

		WorldBossScene = var_19_4

		var_19_8(var_19_7, var_19_4.PAGE_ENTRANCE)
	end
...
function var_0_1.handleNotification(arg_21_0, arg_21_1)
	...
	if var_21_1 == var_21_0.WORLD_GET_BOSS_DONE then
		...
		if var_21_1 == var_4.WORLD_BOSS_SUPPORT_DONE then
			pg = var_21_5

			local var_21_4 = var_21_5.TipsMgr.GetInstance()

			var_21_5 = var_21_5.ShowTips
			i18n = var_1_10007

			var_21_5(var_21_4, var_1_10007("world_joint_call_support_success"))
		else
			GAME = var_21_5

			local var_21_7

			if var_21_1 == var_21_5.WORLD_BOSS_SUBMIT_AWARD_DONE then
				local var_21_6 = arg_21_0.viewComponent

				var_21_7 = var_21_7.emit
				BaseUI = var_1_10007

				var_21_7(var_21_6, var_1_10007.ON_ACHIEVE, var_21_3.items)

				local var_21_8 = arg_21_0.viewComponent

				var_21_7.getAwardDone(var_21_8)
			else
				GAME = var_21_7

				local var_21_9

				if var_21_1 == var_21_7.REMOVE_LAYERS then
					if not var_21_3.onHome then
						var_21_9 = var_21_3.context.mediator
						WorldBossFormationMediator = var_21_2

						if var_21_9 == var_21_2 then
							local var_21_10 = arg_21_0.viewComponent

							var_21_9.OnRemoveLayers(var_21_10)
						end
					end
				else
					GAME = var_21_9

					if var_21_1 == var_21_9.WORLD_BOSS_GET_FORMATION_DONE then
						local var_21_11 = arg_21_0.viewComponent

						var_4.OnShowFormationPreview(var_21_11, var_21_3.ships)
					else
						GAME = var_4

						local var_21_14

						if var_21_1 == var_4.SWITCH_WORLD_BOSS_ARCHIVES_DONE then
							local var_21_12 = arg_21_0.viewComponent

							var_21_14.OnSwitchArchives(var_21_12)

							pg = var_21_14

							local var_21_13 = var_21_14.TipsMgr.GetInstance()

							var_21_14 = var_21_14.ShowTips
							i18n = var_1_10007

							var_21_14(var_21_13, var_1_10007("world_boss_switch_archives_success"))
						else
							GAME = var_21_14

							if var_21_1 == var_21_14.WORLD_ARCHIVES_BOSS_STOP_AUTO_BATTLE_DONE then
								local var_21_15 = arg_21_0.viewComponent

								var_4.OnAutoBattleResult(var_21_15, var_21_3)
							else
								GAME = var_4

								if var_21_1 == var_4.WORLD_ARCHIVES_BOSS_AUTO_BATTLE_DONE then
									local var_21_16 = arg_21_0.viewComponent

									var_4.OnAutoBattleStart(var_21_16, var_21_3)
								else
									GAME = var_4

									if var_21_1 == var_4.GET_META_PT_AWARD_DONE then
										local var_21_17 = arg_21_0.viewComponent

										var_4.OnGetMetaAwards(var_21_17)

										local var_21_18 = arg_21_0.viewComponent
										local var_21_19 = var_4.emit

										BaseUI = var_1_10007

										var_21_19(var_21_18, var_1_10007.ON_ACHIEVE, var_21_3.awards)
									end
								end
							end
						end
