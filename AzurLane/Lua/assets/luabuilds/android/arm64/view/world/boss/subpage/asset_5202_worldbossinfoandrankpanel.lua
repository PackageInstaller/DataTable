...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.rankList = var_2_3(var_3.Find(var_2_4, "rank_panel/list"), arg_2_0.myRankTF)
	pg = var_1
	...
	typeof = var_4
	Text = var_6
	arg_2_0.rankCnt1 = var_2_7(var_2_6, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.maskTxt = var_2_12(var_2_11, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.infoTitle = var_2_15(var_2_14, var_4(var_6))
	UIItemList = var_1

	local var_2_16 = var_1.New
	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_3.Find(var_2_17, "info_panel/scrollrect/content")
	local var_2_19 = arg_2_0._tf

	arg_2_0.infoSkillList = var_2_16(var_2_18, var_4.Find(var_2_19, "info_panel/scrollrect/content/tpl"))
	...
	var_2.make(var_7_1, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			var_2_10006("ui/WorldBossUI_atlas", "color_" .. var_8_1, function(arg_9_0)
				...
				typeof = var_4
				Image = var_3_10006
				var_9_2(var_9_1, var_4(var_3_10006)).sprite = arg_9_0

				return
			end)

			local var_8_2 = arg_8_2:Find("color/Text")

			setText = var_2_10007

			var_2_10007(var_8_2, var_8_0)
		end
...
function var_0_1.ResetInfoLayout(arg_10_0)
	...
	var_1_10003(function()
		...
		var_0.each(var_11_0, function(arg_12_0, arg_12_1)
			...
			local var_12_2 = arg_12_1.Find(var_12_1, "color/Text")
			local var_12_3 = "　"

			math = var_12_1

			local var_12_4, var_12_5 = var_12_1.modf(var_12_2.sizeDelta.x / var_10_0)

			math = var_8

			local var_12_6 = var_8.ceil(var_10_0 * var_12_5)
			...
			if 0 < var_12_5 then
				var_12_3 = var_12_3 .. "<size=" .. var_12_6 .. ">　</size>"
			end

			setText = var_9

			var_9(arg_12_1:Find("Text"), var_12_3 .. var_12_0)
...
function var_0_1.FlushRank(arg_13_0)
	...
	if not var_13_1 then
		...
		WorldBossMediator = var_1_10008

		var_13_4(var_13_3, var_1_10008.ON_RANK_LIST, var_1.id)
	else
		...
		var_13_7(var_13_6, var_8.min(#var_13_1, 3))
...
function var_0_1.AddWaitResultTimer(arg_15_0)
	...
	arg_15_0.RemoveWaitTimer(var_15_0)

	local var_15_1 = arg_15_0.boss
	local var_15_2 = var_1.ShouldWaitForResult(var_15_1)

	setActive = var_15_0

	var_15_0(arg_15_0.maskTF, var_15_2)

	if var_15_2 then
		local var_15_3 = var_1:GetWaitForResultTime()

		Timer = var_15_1
		arg_15_0.waitTimer = var_15_1.New(function()
			pg = var_2_10000
			...
			if var_15_3 - var_16_1 < 0 then
				...
				var_2.AddWaitResultTimer(var_16_2)

				if arg_15_0.callback then
					arg_15_0.callback(false)
				end
			else
				local var_16_3 = arg_15_0.maskTxt

				pg = var_2_10003

				local var_16_4 = var_2_10003.TimeMgr.GetInstance()

				var_16_3.text = var_3.DescCDTime(var_16_4, var_1)
			end
...
function var_0_1.UpdateRankTF(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	local var_18_4 = arg_18_1.Find(var_18_3, "value/view")
	...
	local function var_18_5()
		...
		var_19_2(var_19_1, var_2_10004.FETCH_RANK_FORMATION, arg_18_2.id, var_19_0.id)
	...
	var_1_10004(var_18_2, var_18_4, var_18_5, var_18_3)
