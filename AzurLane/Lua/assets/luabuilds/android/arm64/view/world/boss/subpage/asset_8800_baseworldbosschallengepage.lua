...
function var_0_1.OnInit(arg_4_0)
	...
	local var_4_2 = var_3.Find(var_4_1, "list_panel/mask/bg/container")
	local var_4_3 = arg_4_0._tf

	arg_4_0.scrollRect = var_4_0(var_4_2, var_4.Find(var_4_3, "list_panel/mask/tpl"))
	...
	typeof = var_4
	Slider = var_6
	arg_4_0.hpSlider = var_4_7(var_4_6, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_4_0.levelTxt = var_4_10(var_4_9, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_4_0.hpTxt = var_4_13(var_4_12, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_4_0.expiredTimeTxt = var_4_16(var_4_15, var_4(var_6))
	...
	local function var_4_25()
		...
		if var_8_0 <= var_1.GetServerTime(var_8_1) then
			...
			local var_8_4 = var_2.TimeMgr.GetInstance()

			var_8_3.cdTime = var_2.GetServerTime(var_8_4) + var_8_0
			var_8_1 = arg_4_0
	...
	var_1(var_4_23, var_4_24, var_4_25, var_6)
	...
	local function var_4_28()
		...
		var_10_1(var_10_0, var_2_10003("world_joint_not_refresh_frequently"))
	...
	var_1(var_4_26, var_4_27, var_4_28, var_6)
	...
	WorldBoss = var_1_10002
	var_4_30[1] = var_1_10002.BOSS_TYPE_WORLD
	WorldBoss = var_2
	...
	local var_4_33 = var_4.Find(var_4_32, "list_panel/frame/filter/toggles/friend")
	...
	var_4_30(var_4_31, var_4_33, var_4_34, var_4_32)

	GetComponent = var_4_30

	local var_4_35 = arg_4_0._tf
	local var_4_36 = var_3.Find(var_4_35, "list_panel/frame/filter/toggles/friend/unsel")

	typeof = var_4_33
	Image = var_6

	local var_4_37 = var_4_30(var_4_36, var_4_33(var_6))
	...
	local var_4_39 = var_3.Find(var_4_38, "list_panel/frame/filter/toggles/friend/sel")

	typeof = var_4
	Image = var_6

	local var_4_40 = var_1(var_4_39, var_4(var_6))
	...
	local var_4_42 = var_3.Find(var_4_41, "list_panel/frame/filter/toggles/guild/sel")

	typeof = var_4
	Image = var_6

	local var_4_43 = var_1(var_4_42, var_4(var_6))
	...
	local var_4_45 = var_3.Find(var_4_44, "list_panel/frame/filter/toggles/guild/unsel")

	typeof = var_4
	Image = var_6

	local var_4_46 = var_1(var_4_45, var_4(var_6))
	...
	local var_4_49 = var_4.Find(var_4_48, "list_panel/frame/filter/toggles/guild")
	...
	var_1(var_4_47, var_4_49, var_4_50, var_4_48)
...
function var_0_1.UpdateEmptyCard(arg_13_0)
	...
	local var_13_2 = var_1_10002.GetCurrBossGroup()
	...
	local var_13_5 = var_13_4(var_13_3, var_6(var_1_10008))

	GetSpriteFromAtlas = var_4
	var_13_5.sprite = var_4("MetaWorldboss/" .. var_13_2, "item_04")
...
function var_0_1.CheckToggle(arg_14_0)
	...
	if var_1_10001.all(arg_14_0.filterFlags, function(arg_15_0)
		...
		var_1(var_3.Find(var_14_0, "list_panel/frame/filter/toggles/friend"), true)

		triggerToggle = var_1

		local var_14_1 = arg_14_0._tf

		var_1(var_3.Find(var_14_1, "list_panel/frame/filter/toggles/guild"), true)
	end
...
function var_0_1.UpdatePainting(arg_17_0, arg_17_1)
	if arg_17_0.groupId ~= arg_17_1 then
		...
		var_17_3.sprite = var_1_10003("MetaWorldboss/" .. arg_17_1, "title" .. arg_17_0:GetResSuffix())
		...
		if not var_17_1.world_joint_boss_template[var_17_4].p_offset_other then
...
function var_0_1.RotateRefreshBtn(arg_18_0, arg_18_1)
	...
	local var_18_1 = var_18_0(var_1_10004(arg_18_0.refreshBtn), -360, 0.5)
	local var_18_2 = var_2.setOnComplete

	System = var_6

	var_18_2(var_18_1, var_6.Action(function()
...
function var_0_1.AddListeners(arg_21_0, arg_21_1)
	...
	var_21_1(var_21_0, var_1_10005.EventRankListUpdated, arg_21_0.onRankListUpdated)
	...
	var_21_3(var_21_2, var_5.EventCacheBossListUpdated, arg_21_0.onCacheBossUpdated)
...
function var_0_1.RemoveListeners(arg_22_0, arg_22_1)
	...
	var_22_1(var_22_0, var_1_10005.EventRankListUpdated, arg_22_0.onRankListUpdated)
	...
	var_22_3(var_22_2, var_5.EventCacheBossListUpdated, arg_22_0.onCacheBossUpdated)
...
function var_0_1.Update(arg_25_0)
	...
	var_25_1(var_25_0, var_1_10004.UPDATE_CACHE_BOSS_HP, function()
...
function var_0_1.UpdateNonProcessList(arg_27_0)
	...
	local function var_27_2(arg_28_0)
		...
		return var_2_10002.any(var_28_0, function(arg_30_0)
...
function var_0_1.OnInitCard(arg_33_0, arg_33_1, arg_33_2)
	...
	var_1_10006(arg_33_1)

	setText = var_1_10006

	var_1_10006(arg_33_1:Find("tags/friend/Text"), "")

	setText = var_1_10006

	local var_33_4 = arg_33_1

	var_1_10006(arg_33_1.Find(var_33_4, "tags/guild/Text"), "")

	if var_33_0 then
		var_33_1 = var_33_0:isDeath()
		var_1_10006 = var_33_0:GetType()
		setActive = var_33_2

		local var_33_5 = arg_33_1:Find("tags/friend")

		WorldBoss = var_33_4

		var_33_2(var_33_5, var_1_10006 == var_33_4.BOSS_TYPE_FRIEND)

		setActive = var_33_2

		local var_33_6 = arg_33_1:Find("tags/guild")

		WorldBoss = var_10

		var_33_2(var_33_6, var_1_10006 == var_10.BOSS_TYPE_GUILD)

		setActive = var_33_2

		local var_33_7 = arg_33_1:Find("tags/world")

		WorldBoss = var_10

		var_33_2(var_33_7, var_1_10006 == var_10.BOSS_TYPE_WORLD)

		Vector3 = var_33_2
		var_33_3.anchoredPosition = var_33_2(0, 14, 0)
		setText = var_7
		...
		local var_33_8 = arg_33_1:Find("tags/guild/Text")
		local var_33_9 = var_33_0

		var_7(var_33_8, var_33_0.GetRoleName(var_33_9))
		...
		var_7(var_33_10, var_33_11, var_33_12, var_33_9)
		arg_33_0:UpdateCardStyle(arg_33_1, var_33_0.config.meta_id)
	end

	setActive = var_1_10006

	var_1_10006(arg_33_1:Find("complete"), var_33_0 and var_33_1)

	setActive = var_1_10006

	var_1_10006(arg_33_1:Find("raiding"), var_33_0 and not var_33_1)

	setActive = var_1_10006

	var_1_10006(arg_33_1:Find("empty"), not var_33_0)

	setActive = var_1_10006

	var_1_10006(var_33_3, var_33_0)

	setActive = var_1_10006

	var_1_10006(arg_33_1:Find("tags/friend/Text"), false)

	setActive = var_1_10006

	var_1_10006(arg_33_1:Find("tags/guild/Text"), false)
...
function var_0_1.UpdateCardStyle(arg_35_0, arg_35_1, arg_35_2)
	...
	local var_35_2 = var_35_1(var_35_0, var_6(var_1_10008))

	GetSpriteFromAtlas = var_1_10004
	var_35_2.sprite = var_1_10004("MetaWorldboss/" .. arg_35_2, "item_03")
	...
	local var_35_5 = var_35_4(var_35_3, var_6(var_1_10008))

	GetSpriteFromAtlas = var_4
	var_35_5.sprite = var_4("MetaWorldboss/" .. arg_35_2, "item_04")
	...
	local var_35_8 = var_35_7(var_35_6, var_7(var_1_10009))

	GetSpriteFromAtlas = var_35_3
	var_35_8.sprite = var_35_3("MetaWorldboss/" .. arg_35_2, "item_01" .. arg_35_0:GetResSuffix())
...
function var_0_1.OnPreviewCard(arg_36_0, arg_36_1, arg_36_2)
	if arg_36_0.prevSelected and arg_36_0.prevSelected.boss then
		var_1_10005 = arg_36_0.prevSelected.childTF

		local var_36_0 = var_3.Find(var_1_10005, "tags")

		Vector3 = var_1_10004
		var_36_0.anchoredPosition = var_1_10004(0, 14, 0)
		setActive = var_36_0

		local var_36_1 = arg_36_0.prevSelected.childTF

		var_36_0(var_1_10005.Find(var_36_1, "tags/friend/Text"), false)

		setActive = var_36_0

		local var_36_2 = arg_36_0.prevSelected.childTF

		var_36_0(var_1_10005.Find(var_36_2, "tags/guild/Text"), false)

		setActive = var_36_0

		local var_36_3 = arg_36_0.prevSelected.childTF

		var_36_0(var_1_10005.Find(var_36_3, "selected"), false)
	end

	local var_36_5

	if arg_36_0.displays[arg_36_2 + 1] then
		local var_36_4 = var_3

		var_36_5 = var_3.isDeath(var_36_4)
		setActive = var_1_10005

		var_1_10005(arg_36_1:Find("selected/challenging"), not var_36_5)

		setActive = var_1_10005

		var_1_10005(arg_36_1:Find("selected/finished"), var_36_5)

		local var_36_6 = arg_36_1:Find("tags")

		Vector3 = var_36_4
		var_36_6.anchoredPosition = var_36_4(-17, 41.69, 0)
		setActive = var_36_6

		var_36_6(arg_36_1:Find("tags/friend/Text"), true)

		setActive = var_36_6

		var_36_6(arg_36_1:Find("tags/guild/Text"), true)
		arg_36_0:UpdateMainView(var_3)
	end

	setActive = var_36_5

	var_36_5(arg_36_1:Find("selected"), var_3)
...
function var_0_1.UpdateMainView(arg_38_0, arg_38_1, arg_38_2)
	...
	local var_38_2 = arg_38_1.isDeath(var_38_1)
	local var_38_3 = arg_38_1:GetLeftTime()
	...
	var_38_1(var_38_4, var_38_5, var_38_6, var_1_10011)
	...
	local function var_38_11()
		...
		var_40_1(var_40_0, var_2_10003.ON_BATTLE, arg_38_1.id, true)
	...
	var_38_8(var_38_9, var_38_10, var_38_11, var_1_10012)

	setActive = var_38_8

	var_38_8(arg_38_0.startBtn, not var_38_2 and var_38_3 > 0)
	arg_38_0:removeBattleTimer()

	if not var_38_2 and not arg_38_2 then
...
function var_0_1.addBattleTimer(arg_41_0, arg_41_1)
	...
	local var_41_1 = var_1_10003.TimeMgr.GetInstance()
	local var_41_2 = var_41_0 - var_3.GetServerTime(var_41_1)
	...
	if 0 <= var_41_2 then
		...
		arg_41_0.timer = var_5.New(function()
			if arg_41_0.exited then
				...
				var_0.removeBattleTimer(var_2_10002)
			...
			if var_42_0 - var_1.GetServerTime(var_42_1) <= 0 then
				...
				i18n = var_2_10002
				var_42_2.text = var_2_10002("world_word_expired")

				local var_42_3 = arg_41_0

				var_1.removeBattleTimer(var_42_3)

				local var_42_4 = arg_41_0

				var_1.UpdateMainView(var_42_4, arg_41_1, true)
			else
				local var_42_5 = arg_41_0.expiredTimeTxt

				pg = var_2_10002

				local var_42_6 = var_2_10002.TimeMgr.GetInstance()

				var_42_5.text = var_2.DescCDTime(var_42_6, var_0)
			end

			return
		end, 1, -1)

		local var_41_3 = arg_41_0.timer

		var_5.Start(var_41_3)
		arg_41_0.timer.func()
	else
