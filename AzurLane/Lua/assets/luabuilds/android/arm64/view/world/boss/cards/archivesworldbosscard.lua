...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.nameTxt = var_1_8(var_1_7, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.uProgressTxt = var_1_13(var_1_12, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.sProgressTxt = var_1_17(var_1_16, var_5(var_1_10007))
	...
	var_2(var_4.Find(var_1_22, "label"), arg_1_0.underwayLabelStr)
	...
	var_2(var_1_23, var_5("meta_syn_rate"))
...
function var_0_0.Flush(arg_3_0)
	...
	if arg_3_0.bossId == var_3_1 then
		...
		var_1_10006(arg_3_0.underwayTr, var_3_3 and not var_3_5)

		setActive = var_1_10006

		var_1_10006(arg_3_0.staticTr, not var_3_3 and not var_3_5)

		setActive = var_1_10006

		var_1_10006(arg_3_0.staticMaskTr, not var_3_3 and not var_3_5)

		setActive = var_1_10006

		var_1_10006(arg_3_0.finishTr, var_3_5)
		...
		elseif var_3_3 then
			...
			var_3_11(var_12.Find(var_3_12, "label"), arg_3_0.underwayLabelStr .. "(" .. var_3_6 .. "/" .. var_3_7 .. ")")
		else
			setText = var_3_11

			local var_3_13 = arg_3_0.underwayTr

			var_3_11(var_12.Find(var_3_13, "label"), arg_3_0.underwayLabelStr)
			...
			if var_3_8 then
				...
				local var_3_15 = var_12.Find(var_3_14, "label")

				i18n = var_13

				var_3_11(var_3_15, var_13("meta_pt_point"))
				...
				var_3_11(var_3_16, var_13("meta_syn_finish"))
				...
				var_3_11(var_12.Find(var_3_17, "label"), "")
				...
				var_3_11(var_3_18, var_13("meta_syn_rate"))
...
function var_0_0.Select(arg_4_0)
	...
	local var_4_2 = var_4_1(var_4_0, var_4.Action_float(function(arg_5_0)
