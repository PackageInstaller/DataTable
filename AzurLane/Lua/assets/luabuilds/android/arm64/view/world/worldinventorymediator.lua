...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OnUseItem, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		var_2_1(var_2_0, var_2_10007.WORLD_ITEM_USE, {
			itemID = arg_2_1,
			count = arg_2_2 or 1,
			args = arg_2_3
		})
	...
	arg_1_0:bind(var_0_1.OnMap, function(arg_3_0, arg_3_1)
		...
		for iter_3_0, iter_3_1 in var_3_0(var_3_1.config.teasure_chapter) do
	...
	arg_1_0:bind(var_0_1.OnOpenAllocateLayer, function(arg_4_0, arg_4_1)
		...
		WorldAllocateMediator = var_2_10008
		var_4_3.mediator = var_2_10008
		WorldAllocateLayer = var_2_10008
	...
	arg_1_0.bind(var_1_0, var_0_1.OPEN_EQUIPMENT_INDEX, function(arg_6_0, arg_6_1)
	...
	var_2.setInventoryProxy(var_1_2, var_1_1:GetInventoryProxy())

	local var_1_3 = arg_1_0.viewComponent

	var_2.setWorldFleet(var_1_3, var_1_1:GetFleets())
	...
	local var_1_5 = var_1_0(var_5)
	local var_1_6 = var_3.getEquipments(var_1_5, true)

	ipairs = var_5

	for iter_1_0, iter_1_1 in var_5(var_1_4:getEquipsInShips()) do
		table = var_1_10010

		var_1_10010.insert(var_1_6, iter_1_1)
	end

	local var_1_7 = arg_1_0.viewComponent

	var_5.setEquipments(var_1_7, var_1_6)

	getProxy = var_5
	BagProxy = var_1_7

	local var_1_8 = var_5(var_1_7)
	local var_1_9 = var_5.GetItemsByCondition(var_1_8, {
		is_world = 1
	})
	local var_1_10 = arg_1_0.viewComponent

	var_7.SetMaterials(var_1_10, var_1_9)
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	EquipmentProxy = var_8_0

	if var_8_1 == var_8_0.EQUIPMENT_UPDATED then
		var_1_10006 = arg_8_0.viewComponent

		var_4.setEquipment(var_1_10006, var_8_2)
	else
		GAME = var_4

		local var_8_3

		if var_8_1 == var_4.USE_ITEM_DONE then
			if #var_8_2.drops ~= 0 then
				var_1_10006 = arg_8_0.viewComponent
				var_8_3 = var_8_3.emit
				BaseUI = var_1_10007

				var_8_3(var_1_10006, var_1_10007.ON_AWARD, {
					animation = true,
					items = var_8_2.drops
				})
			end
			...
			if var_8_1 == var_8_3.FRAG_SELL_DONE then
				var_1_10006 = arg_8_0.viewComponent
				var_8_4 = var_8_4.emit
				BaseUI = var_1_10007

				var_8_4(var_1_10006, var_1_10007.ON_ACHIEVE, var_8_2.awards)
			else
				GAME = var_8_4

				local var_8_5

				if var_8_1 == var_8_4.DESTROY_EQUIPMENTS_DONE then
					table = var_8_5
					...
					if var_8_5.getCount(var_8_2) ~= 0 then
						...
						var_8_5(var_1_10006, var_1_10007.ON_AWARD, {
							items = var_8_2
						})
					end
				else
					...
					if var_8_1 == var_8_5.ITEM_UPDATED then
						if arg_8_0.canUpdate then
							getProxy = var_4
							BagProxy = var_1_10006
							var_1_10007 = var_4(var_1_10006)

							local var_8_6 = var_4.GetItemsByCondition(var_1_10007, {
								is_world = 1
							})
							local var_8_7 = arg_8_0.viewComponent

							var_6.SetMaterials(var_8_7, var_8_6)
						end
					else
						GAME = var_4
						...
						if var_8_1 == var_4.REVERT_EQUIPMENT_DONE then
							table = var_8_9
							...
							if var_8_9.getCount(var_8_2.awards) > 0 then
								...
								var_8_9(var_8_8, var_1_10007.ON_AWARD, {
							...
							if var_8_1 == var_8_9.TRANSFORM_EQUIPMENT_AWARD_FINISHED then
