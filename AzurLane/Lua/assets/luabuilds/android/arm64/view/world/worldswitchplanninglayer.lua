...
function var_0_1.init(arg_2_0)
	...
	local var_2_12 = var_3.Find(var_2_11, "pic")

	i18n = var_4

	var_1(var_2_12, var_4("text_cancel"))
	...
	local var_2_18 = var_3.Find(var_2_17, "pic")

	i18n = var_4

	var_1(var_2_18, var_4("text_confirm"))
	...
	local function var_2_21()
		...
		WorldSwitchPlanningMediator = var_2_10003

		var_6_1(var_6_0, var_2_10003.OnConfirm)
	...
	local var_2_24 = var_3.Find(var_2_23, "pic")

	i18n = var_4

	var_1(var_2_24, var_4("text_goto"))
	...
	local function var_2_27()
		...
		if var_7_2(var_7_1, var_2_10004.SwitchPlainingItemId) > 0 then
			...
			WorldInventoryMediator = var_2_10009
			var_7_7.mediator = var_2_10009
			WorldInventoryLayer = var_2_10009
			var_7_7.viewComponent = var_2_10009
			var_7_6.context = var_2_10006(var_7_7)
			...
			if not var_7_9(var_7_8, var_7_5.SystemResetShop) then
				...
				var_7_11(var_7_10, var_4("world_automode_treasure_3"))
			else
				local var_7_12 = arg_2_0
				local var_7_13 = var_1.emit

				WorldSwitchPlanningMediator = var_4

				local var_7_14 = var_4.OnMove
				local var_7_15 = {
					inMap = false
				}
				...
				local var_7_16 = var_2_10006.New
				local var_7_17 = {}

				WorldShopMediator = var_2_10009
				var_7_17.mediator = var_2_10009
				WorldShopLayer = var_2_10009
				var_7_17.viewComponent = var_2_10009
	...
	var_1(var_2_25, var_2_26, var_2_27, var_6)
	...
	local var_2_31 = var_4.Find(var_2_30, "toggles/toggle_base")
	...
	local function var_2_32(arg_8_0)
		if arg_8_0 then
			...
			var_1(var_3.Find(var_8_1, "content"), nil, 1)
		end
	...
	var_1(var_2_29, var_2_31, var_2_32, var_2_30)

	onToggle = var_1

	local var_2_33 = arg_2_0
	local var_2_34 = arg_2_0.rtContent
	local var_2_35 = var_4.Find(var_2_34, "toggles/toggle_safe")
	...
	local function var_2_36(arg_9_0)
		if arg_9_0 then
			...
			var_1(var_3.Find(var_9_1, "content"), nil, 1)
		end
	...
	var_1(var_2_33, var_2_35, var_2_36, var_2_34)

	onToggle = var_1

	local var_2_37 = arg_2_0
	local var_2_38 = arg_2_0.rtContent
	local var_2_39 = var_4.Find(var_2_38, "toggles/toggle_treasure")
	...
	local function var_2_40(arg_10_0)
		if arg_10_0 then
			...
			var_1(var_3.Find(var_10_1, "content"), nil, 1)
		end
	...
	var_1(var_2_37, var_2_39, var_2_40, var_2_38)
		...
		var_1_10011(var_6, function(arg_11_0)
			...
			local function var_11_2(arg_12_0)
				...
				if arg_11_0 == var_2_44 and arg_12_0 then
					...
					var_3(var_0, function(arg_13_0)
						if arg_13_0 ~= arg_11_0 then
							...
							if var_1(var_13_0, var_4_10004(var_4_10006)).isOn == true then
								triggerToggle = var_1
				...
				elseif var_2_46 > 1 then
					...
					if var_3(var_12_3, var_3_10006(var_3_10008)).isOn == true then
						triggerToggle = var_3
	...
	var_2_51(var_2_52, var_8(var_2_48))
	...
	arg_2_0.togglesList = {
		...
		boss = {
			...
			setFlag = function(arg_21_0)
				...
				local var_21_0 = var_2_10001(var_2_10003)
		...
		consume = {
			...
			setFlag = function(arg_23_0)
				...
				local var_23_0 = var_2_10001(var_2_10003)
	...
	for iter_2_2, iter_2_3 in var_5(arg_2_0.togglesList) do
		var_1_10012 = arg_2_0.rtView

		local var_2_53 = var_10.Find(var_1_10012, "content/" .. iter_2_2 .. "/toggles")

		pairs = var_1_10011

		for iter_2_4, iter_2_5 in var_1_10011(iter_2_3.info) do
			onToggle = var_1_10016

			local var_2_54 = arg_2_0
			local var_2_55 = var_2_53
			local var_2_56 = var_2_53.Find(var_2_55, iter_2_4)

			function var_1_10020(arg_24_0)
				if arg_24_0 then
			...
			var_1_10016(var_2_54, var_2_56, var_1_10020, var_2_55)
		end
	end
	...
	for iter_2_6, iter_2_7 in var_6(var_2_57) do
		...
		local var_2_60 = var_2_59:Find("Text")

		i18n = var_15

		var_1_10012(var_2_60, var_15(iter_2_7.text))

		pairs = var_1_10012

		for iter_2_8, iter_2_9 in var_1_10012(iter_2_7.info) do
			setText = var_17

			local var_2_61 = var_2_59:Find("toggles/" .. iter_2_8 .. "/Text")

			i18n = var_1_10020

			var_17(var_2_61, var_1_10020(iter_2_9))
		end
	end

	setText = var_6

	local var_2_62 = arg_2_0.rtWindow
	local var_2_63 = var_8.Find(var_2_62, "top/bg/title")

	i18n = iter_2_6

	var_6(var_2_63, iter_2_6("world_automode_title_1"))

	setText = var_6

	local var_2_64 = arg_2_0.rtWindow
	local var_2_65 = var_8.Find(var_2_64, "top/bg/title/title_en")

	i18n = var_9

	var_6(var_2_65, var_9("world_automode_title_2"))

	setText = var_6

	local var_2_66 = arg_2_0.rtContent
	local var_2_67 = var_8.Find(var_2_66, "toggles/toggle_base/Text")

	i18n = var_9

	var_6(var_2_67, var_9("area_putong"))

	setText = var_6

	local var_2_68 = arg_2_0.rtContent
	local var_2_69 = var_8.Find(var_2_68, "toggles/toggle_safe/Text")

	i18n = var_9

	var_6(var_2_69, var_9("area_anquan"))

	setText = var_6

	local var_2_70 = arg_2_0.rtContent
	local var_2_71 = var_8.Find(var_2_70, "toggles/toggle_treasure/Text")

	i18n = var_9

	var_6(var_2_71, var_9("area_yinmi"))
...
function var_0_1.didEnter(arg_25_0)
	...
	local var_25_1 = var_3.Find(var_25_0, "toggles")
	local var_25_2 = var_3.GetChild

	PlayerPrefs = var_6

	var_1_10001(var_25_2(var_25_1, var_6.GetInt("auto_switch_mode", 0)), true)
...
function var_0_1.initToggle(arg_27_0, arg_27_1)
	...
	for iter_27_0, iter_27_1 in var_1_10004(var_2.info) do
		if iter_27_1 == var_27_0 then
			...
			var_1_10009(var_11.Find(var_27_1, "content/" .. arg_27_1 .. "/toggles/" .. iter_27_0), true)
...
function var_0_1.updateView(arg_28_0, arg_28_1)
	...
	local var_28_1 = arg_28_1 == var_0_1.MODE_TREASURE and not var_28_0:GetGobalFlag("treasure_flag")

	setActive = var_28_6

	local var_28_2 = arg_28_0.rtView

	var_28_6(var_6.Find(var_28_2, "content"), not var_28_1)

	setActive = var_28_6

	local var_28_3 = arg_28_0.rtContent

	var_28_6(var_6.Find(var_28_3, "scrollbar"), not var_28_1)

	setActive = var_28_6

	local var_28_4 = arg_28_0.rtView

	var_28_6(var_6.Find(var_28_4, "tip"), var_28_1)

	setActive = var_28_6

	var_28_6(arg_28_0.btnConfirm, not var_28_1)

	setActive = var_28_6

	var_28_6(arg_28_0.btnMove, var_28_1)

	local var_28_6

	if var_28_1 then
		local var_28_5 = var_28_0:GetInventoryProxy()

		var_28_6 = var_28_6.GetItemCount
		WorldConst = var_7

		if var_28_6(var_28_5, var_7.SwitchPlainingItemId) > 0 then
			setText = var_28_6

			local var_28_7 = arg_28_0.rtView
			local var_28_8 = var_6.Find(var_28_7, "tip/Text")

			i18n = var_7

			var_28_6(var_28_8, var_7("world_automode_treasure_2"))
		else
			setText = var_28_6

			local var_28_9 = arg_28_0.rtView
			local var_28_10 = var_6.Find(var_28_9, "tip/Text")

			i18n = var_7

			var_28_6(var_28_10, var_7("world_automode_treasure_1"))
		end
	end
	...
	var_28_6(var_6.Find(var_28_11, "content"), function(arg_29_0)
		...
		if var_0_1.modeToggleDic[arg_28_1] then
			...
			var_1(arg_29_0.name, {
				base = function()
					...
					PlayerPrefs = var_3_10005

					for iter_30_0, iter_30_1 in var_3_10001(var_30_1(var_3_10005.GetString("auto_switch_difficult_base", "all"))) do
					...
					var_1(var_3.Find(var_30_2, "content/base/toggles"), function(arg_31_0)
				...
				treasure = function()
					...
					for iter_32_0, iter_32_1 in var_3_10001(var_32_1(var_3_10005.GetString("auto_switch_difficult_treasure", "all"))) do
					...
					var_1(var_3.Find(var_32_2, "content/treasure/toggles"), function(arg_33_0)
						triggerToggle = var_4_10001
...
function var_0_1.saveConfig(arg_35_0, arg_35_1)
	...
	var_1_10003(var_5.Find(var_35_1, "content/" .. arg_35_1 .. "/toggles"), function(arg_36_0)
		...
		if var_2_10001(var_36_0, var_2_10004(var_2_10006)).isOn then
			table = var_1
	...
	var_35_2(var_35_3, var_6.concat(var_35_0, "&"))
...
function var_0_1.checkDifficultValid(arg_38_0, arg_38_1)
	...
	for iter_38_0, iter_38_1 in var_1_10003(var_38_0) do
		if iter_38_1 == "all" then
			...
			if var_1_10008.sub(iter_38_1, 1, 6) == "until_" then
				...
				if arg_38_1 <= var_1_10008(var_10.sub(iter_38_1, 7)) then
					return true
				end
			else
				tonumber = var_1_10008
