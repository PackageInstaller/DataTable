...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_3 = var_3.Find(var_2_2, "window/top/title")

	i18n = var_4

	var_1(var_2_3, var_4("world_boss_title_auto_battle"))

	setText = var_1

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_3.Find(var_2_4, "window/msg_panel/label")

	i18n = var_4

	var_1(var_2_5, var_4("world_boss_archives_auto_battle_reusle_title"))

	setText = var_1

	local var_2_6 = arg_2_0._tf
	local var_2_7 = var_3.Find(var_2_6, "window/msg_panel/battle_cnt/label")

	i18n = var_4

	var_1(var_2_7, var_4("world_boss_title_battle_cnt"))

	setText = var_1

	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_3.Find(var_2_8, "window/msg_panel/damage/label")

	i18n = var_4

	var_1(var_2_9, var_4("world_boss_title_total_damage"))

	setText = var_1

	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_3.Find(var_2_10, "window/msg_panel/oil/label")

	i18n = var_4

	var_1(var_2_11, var_4("world_boss_title_consume_oil_cnt"))

	setText = var_1

	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_3.Find(var_2_12, "window/btns/start/pic")
	...
	typeof = var_4
	Text = var_6
	arg_2_0.battleCntTxt = var_2_16(var_2_15, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.damageTxt = var_2_19(var_2_18, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.oilTxt = var_2_22(var_2_21, var_4(var_6))
