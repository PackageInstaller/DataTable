...
function var_0_1.showWindow(arg_3_0, arg_3_1)
	...
	if not arg_3_0.allWindows[arg_3_1] then
		...
		var_3(var_3_1, var_6(arg_3_0._tf, "ad"))
...
function var_0_1.prepareWindow(arg_4_0, arg_4_1)
	...
	local var_4_1 = var_1_10005(arg_4_1, "ad")
	...
	var_2(var_4(arg_4_1, "ad/desc"), arg_4_0.itemConfig.display)

	setText = var_2
	findTF = var_4

	local var_4_5 = var_4(arg_4_1, "ad/num")

	i18n = var_5

	var_2(var_4_5, var_5(var_0_3, arg_4_0.num))
	...
	var_2(var_4_6, var_5(var_0_2, arg_4_0.dayLimit))
