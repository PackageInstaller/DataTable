...
function var_0_1.initData(arg_3_0)
	...
	arg_3_0.mainTaskVOs = var_3_3(var_3_2, var_4.GetMainTasksForShow(var_3_4))

	local var_3_5 = arg_3_0.taskProxy
	local var_3_6 = var_1.FilterByGroup
	local var_3_7 = arg_3_0.taskProxy

	arg_3_0.otherTaskVOs = var_3_6(var_3_5, var_4.GetTargetTasksForShow(var_3_7))
...
function var_0_1.findUI(arg_4_0)
	...
	local var_4_11 = var_3.Find(var_4_10, "target_info/Text")

	i18n = var_4

	var_1(var_4_11, var_4("child_target_set_empty"))
	...
	local var_4_14 = var_3.Find(var_4_13, "skip_title")

	i18n = var_4

	var_1(var_4_14, var_4("child_target_set_skip"))
	...
	local var_4_22 = var_3.Find(var_4_21, "progress/title")

	i18n = var_4

	var_1(var_4_22, var_4("child_target_progress"))
	...
	local var_4_27 = var_3.Find(var_4_26, "Text")

	i18n = var_4

	var_1(var_4_27, var_4("child_target_finish_tip"))

	setText = var_1

	local var_4_28 = arg_4_0.leftTF
	local var_4_29 = var_3.Find(var_4_28, "time/title")

	i18n = var_4

	var_1(var_4_29, var_4("child_target_time_title"))
	...
	local var_4_34 = var_3.Find(var_4_33, "list/tpl/status/get/btn/Text")

	i18n = var_4

	var_1(var_4_34, var_4("word_take"))

	UIItemList = var_1

	local var_4_35 = var_1.New
	local var_4_36 = arg_4_0.mainTaskTF
	local var_4_37 = var_3.Find(var_4_36, "list")
	local var_4_38 = arg_4_0.mainTaskTF

	arg_4_0.mainTaskUIList = var_4_35(var_4_37, var_4.Find(var_4_38, "list/tpl"))
	...
	var_1(var_4_40, var_4("child_target_title1"))
	...
	local var_4_44 = var_3.Find(var_4_43, "list/tpl/status/get/btn/Text")

	i18n = var_4

	var_1(var_4_44, var_4("word_take"))

	UIItemList = var_1

	local var_4_45 = var_1.New
	local var_4_46 = arg_4_0.otherTaskTF
	local var_4_47 = var_3.Find(var_4_46, "list")
	local var_4_48 = arg_4_0.otherTaskTF

	arg_4_0.otherTaskUIList = var_4_45(var_4_47, var_4.Find(var_4_48, "list/tpl"))
	...
	var_1(var_4_50, var_4("child_target_title2"))
...
function var_0_1.addListener(arg_6_0)
	...
	local var_6_2 = var_4.Find(var_6_1, "anim_root/close")
	...
	local function var_6_6()
		function arg_6_0.onExit()
			...
			local var_9_2 = var_3_10003.New
			local var_9_3 = {}

			EducateTargetSetLayer = var_3_10006
			var_9_3.viewComponent = var_3_10006
			EducateTargetSetMediator = var_3_10006
			var_9_3.mediator = var_3_10006
...
function var_0_1.sumbitTask(arg_14_0, arg_14_1)
	...
	EducateTargetMediator = var_1_10005

	var_14_1(var_14_0, var_1_10005.ON_TASK_SUBMIT, arg_14_1)
	...
	if arg_15_0.targetId ~= 0 then
		...
		local function var_15_5()
			if arg_15_0.canGetFinishAward then
				...
				EducateTargetMediator = var_2_10003

				var_16_1(var_16_0, var_2_10003.ON_GET_TARGET_AWARD)
			else
		...
		var_4(var_15_3, var_15_4, var_15_5, var_1_10009)
		...
		if var_4.GetStageReaminWeek(var_15_7, var_15_0.stage) <= 1 then
			...
			if not var_15_8("word_in_one_week") then
				var_15_8 = var_4
				i18n = var_15_7
				var_15_8 = var_15_8 .. var_15_7("word_week")
			end

			setText = var_15_7

			var_15_7(arg_15_0.timeTF, var_15_8)
...
function var_0_1.updataTarget(arg_17_0)
	...
	var_5(var_7.Find(var_17_5, "receiveVX"), arg_17_0.canGetFinishAward)

	setActive = var_5

	local var_17_6 = arg_17_0.unfinishTF

	var_5(var_7.Find(var_17_6, "tip"), arg_17_0.canGetFinishAward)
...
function var_0_1.playProgressAnim(arg_18_0, arg_18_1)
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10005(var_1_10007)).value
	local var_18_3 = arg_18_0.sliderTF.rect
	local var_18_4 = arg_18_0.progressWhiteTF

	Vector2 = var_5
	var_18_4.sizeDelta = var_5(var_18_3.width * arg_18_1, var_18_3.height)
	...
	local var_18_7 = var_18_6(var_18_5, var_7(var_1_10009))
	...
	var_18_9(var_18_8, var_7.delayedCall, function()
		local var_19_0 = arg_18_0
		local var_19_1 = var_0.managedTween

		LeanTween = var_2_10003

		local var_19_2 = var_2_10003.value
		local var_19_3

		go = var_2_10005

		local var_19_4 = var_19_1(var_19_0, var_19_2, var_19_3, var_2_10005(arg_18_0.sliderTF), var_18_2, arg_18_1, 0.264)
		...
		var_19_7(var_19_6, var_3.easeInCubic)
...
function var_0_1.updateItem(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	local var_22_3 = arg_22_2:Find("status/go")

	EducateTask = var_9

	var_1_10006(var_22_3, var_22_2 == var_9.STATUS_UNFINISH)

	setActive = var_1_10006

	local var_22_4 = arg_22_2:Find("status/get")

	EducateTask = var_9

	var_1_10006(var_22_4, var_22_2 == var_9.STATUS_FINISH)

	setActive = var_1_10006

	local var_22_5 = arg_22_2:Find("status/got")

	EducateTask = var_9

	var_1_10006(var_22_5, var_22_2 == var_9.STATUS_RECEIVE)

	local var_22_6 = var_22_0:GetAwardShow()

	EducateHelper = var_22_1

	var_22_1.UpdateDropShow(arg_22_2:Find("award"), var_22_6)
	...
	local var_22_8 = arg_22_2
	local var_22_9 = arg_22_2.Find(var_22_8, "status/get")
	...
	local function var_22_10()
		...
		local var_24_4 = var_24_3(var_24_2, var_2_10004(var_2_10006))
	...
	var_7(var_22_7, var_22_9, var_22_10, var_22_8)
