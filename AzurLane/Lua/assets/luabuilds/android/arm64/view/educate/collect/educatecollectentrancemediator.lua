...
local var_0_0 = "EducateCollectEntranceMediator"
...
function var_0_1.listNotificationInterests(arg_2_0)
	...
	var_2_0[1] = var_1_10002.CLEAR_NEW_TIP
...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	if var_3_1 == var_3_0.CLEAR_NEW_TIP then
		local var_3_4 = var_3_3.index

		EducateTipHelper = var_3_2

		if var_3_4 == var_3_2.NEW_MEMORY then
			local var_3_5 = arg_3_0.viewComponent

			var_4.updateMemoryTip(var_3_5)
		end
	end
