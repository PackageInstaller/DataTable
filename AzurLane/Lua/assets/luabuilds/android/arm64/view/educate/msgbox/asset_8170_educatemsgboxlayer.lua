...
i18n = var_0_10004
var_0_5[var_0_6] = var_0_10004("child_msg_title_tip")
...
function var_0_1.init(arg_2_0)
	...
	local var_2_19 = var_5.Find(var_2_18, "res/gold")
	local var_2_20 = var_5.GetComponent

	typeof = var_8
	Image = var_1_10010

	var_2_16(var_2_15, var_2_17, var_2_20(var_2_19, var_8(var_1_10010)).sprite)
	...
	local var_2_28 = var_3.Find(var_2_27, "pic")

	i18n = var_4

	var_1(var_2_28, var_4("word_cancel"))
	...
	local var_2_31 = var_3.Find(var_2_30, "pic")

	i18n = var_4

	var_1(var_2_31, var_4("word_ok"))
...
function var_0_1.commonSetting(arg_6_0, arg_6_1)
	...
	var_1_10009(var_6_8, var_6_9, var_6_10, var_1_10014)
	...
	var_1_10009(var_6_11, var_6_12, var_6_13, var_1_10014)
	...
	var_1_10009(var_6_14, var_6_15, var_6_16, var_1_10014)
	...
	local var_6_19 = var_12.Find(var_6_18, "anim_root/bg")
	...
	var_1_10009(var_6_17, var_6_19, var_6_20, var_6_18)
...
function var_0_1.showSingleItemBox(arg_18_0)
	...
	var_1_10002(var_18_1, var_18_2)

	local var_18_3 = arg_18_0.settings.drop.type

	EducateConst = var_3

	if var_18_3 == var_3.DROP_TYPE_RES then
		var_18_3 = var_18_0.id
		EducateChar = var_3

		if var_18_3 == var_3.RES_MOOD_ID then
			setText = var_18_3

			var_18_3(arg_18_0.singleItemDesc, arg_18_0:getMoodDesc(var_18_0.desc))
	...
	setText = var_18_3
	var_18_1 = arg_18_0.singleItemDesc
	...
	local var_18_5 = arg_18_0.settings.drop.type

	EducateConst = var_3

	if var_18_5 == var_3.DROP_TYPE_ITEM then
		getProxy = var_18_5
		EducateProxy = var_18_1

		local var_18_6 = var_18_5(var_18_1)

		var_18_5 = var_18_5.GetItemCntById(var_18_6, var_18_0.id)
		setText = var_3

		local var_18_7 = arg_18_0.singleItemOwn

		i18n = var_1_10006

		var_3(var_18_7, var_1_10006("child_msg_owned", var_18_5))

		setActive = var_3

		var_3(arg_18_0.singleItemOwn, true)
	else
		setActive = var_18_5

		var_18_5(arg_18_0.singleItemOwn, false)
	end
...
function var_0_1.getMoodDesc(arg_19_0, arg_19_1)
	...
	local var_19_3 = var_1_10003.gsub
	local var_19_4 = arg_19_1
	local var_19_5 = "$1"

	i18n = var_1_10007

	return var_19_3(var_19_4, var_19_5, var_1_10007("child_mood_desc" .. var_19_2))
end
