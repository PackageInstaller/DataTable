...
function var_0_1.findUI(arg_4_0)
	...
	local var_4_9 = var_3.Find(var_4_8, "title/Text")

	i18n = var_4

	var_1(var_4_9, var_4("child_btn_bag"))
	...
	var_1(var_4_15, var_4("child_bag_empty_tip"))
...
function var_0_1.addListener(arg_6_0)
	...
	var_1_10001(arg_6_0.togglesTF, function(arg_9_0)
		...
		local var_9_0 = arg_9_0:Find("Text")

		i18n = var_2_10004

		var_2_10001(var_9_0, var_2_10004("child_item_type" .. arg_9_0.name))
		...
		var_2_10001(arg_6_0, arg_9_0, function(arg_10_0)
			...
			local var_10_2 = var_4.Find(var_10_1, "icon")

			Color = var_3_10005

			var_3_10002(var_10_2, var_3_10005.NewHex(var_10_0))
			...
			var_3_10002(var_10_4, var_5.NewHex(var_10_0))
			...
			if arg_10_0 then
				...
				var_10_7(var_10_6, var_5(arg_9_0.name))
			end
...
function var_0_1.didEnter(arg_11_0)
	...
	var_1(var_3.Find(var_11_0, "0"), true)
...
function var_0_1.updateItem(arg_23_0, arg_23_1, arg_23_2)
	...
	var_1_10005.UpdateDropShow(arg_23_2, var_23_1)
	...
	var_5(var_23_2, var_23_3, var_23_4, var_1_10010)
