...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_4 = var_3.Find(var_2_3, "tips/limit/Text")

	i18n = var_4

	var_1(var_2_4, var_4("child_option_limit"))
...
function var_0_1.addListener(arg_3_0)
	...
	local function var_3_2()
		...
		local var_4_2 = var_2_10003.EDUCATE_GO_SCENE

		SCENE = var_2_10004

		var_4_1(var_4_0, var_4_2, var_2_10004.EDUCATE_SCHEDULE)
	...
	local function var_3_5()
		...
		if var_2_10000(var_2.Find(var_5_0, "lock")) then
			return
		end
		...
		local var_5_3 = var_2_10003.EDUCATE_GO_SCENE

		SCENE = var_5_0

		var_5_2(var_5_1, var_5_3, var_5_0.EDUCATE_MAP)
	...
	local function var_3_8()
		...
		local var_6_2 = var_2_10003.EDUCATE_ON_MSG_TIP
		local var_6_3 = {}

		i18n = var_2_10005
		var_6_3.content = var_2_10005("child_school_sure_tip")
		...
		function var_6_3.onYes()
			...
			if var_0.ENTER_NEW_STAGE_PERFORMS[2] then
				pg = var_3_10001
				var_7_1 = var_3_10001.PerformMgr.GetInstance()

				var_3_10001.PlayOne(var_7_1, var_0, function()
				...
				var_3_10001.playGuide(var_7_1, "tb_9_1")

				var_7_1 = arg_3_0

				var_3_10001.onEnterVirtualStage(var_7_1)
			end

			getProxy = var_3_10001
			EducateProxy = var_7_1

			local var_7_2 = var_3_10001(var_7_1)
	...
	local function var_3_11()
		...
		local var_9_2 = var_2_10003.EDUCATE_ON_MSG_TIP
		local var_9_3 = {}

		i18n = var_2_10005
		var_9_3.content = var_2_10005("child_upgrade_sure_tip")
		...
		function var_9_3.onYes()
			...
			EducateConst = var_3_10001

			if var_3_10001.ENTER_NEW_STAGE_PERFORMS[var_10_3 + 1] then
				pg = var_2
				var_3_10004 = var_2.PerformMgr.GetInstance()

				var_2.PlayOne(var_3_10004, var_1, function()
				...
				var_2.onEnterVirtualStage(var_3_10004)
			end

			getProxy = var_2
			EducateProxy = var_3_10004

			local var_10_4 = var_2(var_3_10004)
	...
	local function var_3_14()
		...
		local var_12_2 = var_2_10003.EDUCATE_GO_SUBLAYER
		...
		EducateTargetSetMediator = var_2_10007
		var_12_4.mediator = var_2_10007
		EducateTargetSetLayer = var_2_10007
	...
	local function var_3_17()
		...
		local var_13_2 = var_2_10003.EDUCATE_ON_MSG_TIP
		local var_13_3 = {}

		i18n = var_2_10005
		var_13_3.content = var_2_10005("child_end_sure_tip")
		...
		function var_13_3.onYes()
			...
			var_14_1(var_14_0, var_3_10003.FIRST_ENTER_END_PERFORM, function()
				local var_15_0 = arg_3_0
				local var_15_1 = var_0.emit

				EducateMediator = var_4_10003

				var_15_1(var_15_0, var_4_10003.ON_ENDING_TRIGGER)
	...
	local function var_3_20()
		...
		local var_16_2 = var_2_10003.EDUCATE_ON_MSG_TIP
		local var_16_3 = {}

		i18n = var_2_10005
		var_16_3.content = var_2_10005("child_reset_sure_tip")

		function var_16_3.onYes()
			local var_17_0 = arg_3_0
			local var_17_1 = var_0.emit

			EducateMediator = var_3_10003

			var_17_1(var_17_0, var_3_10003.ON_GAME_RESET)
	...
	local var_3_24 = var_3_23(var_3_22, var_3_20(var_1_10007))
...
function var_0_1.playGuide(arg_18_0, arg_18_1)
	...
	if not var_2.IsPlayed(var_18_0, arg_18_1) then
		...
		var_18_3(var_18_2, var_5.STORY_UPDATE, {
			storyId = arg_18_1
		})
	end
...
function var_0_1.onEnterVirtualStage(arg_19_0)
	...
	EducateMediator = var_4

	var_19_2(var_19_1, var_4.ENTER_VIRTUAL_STAGE)
...
function var_0_1.Flush(arg_20_0)
	...
	local var_20_5 = var_1_10002(var_1_10004)
	...
	var_3(var_5.Find(var_20_7, "lock"), not var_20_4 or var_20_6)
	...
	EducateConst = var_20_7

	if var_20_9 ~= var_20_7.STATUES_ENDING then
		...
		if var_20_10 == var_7.STATUES_RESET then
			var_20_11 = false
		else
			var_20_11 = true
		end

		var_3(var_20_8, var_20_11)
		...
		if var_20_13 ~= var_7.STATUES_ENDING then
			...
			if var_20_14 == var_7.STATUES_RESET then
				var_20_15 = false
			else
				var_20_15 = true
			end

			var_3(var_20_12, var_20_15)
			...
			if arg_20_0:isUpgradeBtnShow() then
				var_20_19 = not var_20_6
			end

			var_3(var_20_18, var_20_19)
			arg_20_0:updateTargetSetBtn()

			setActive = var_3

			local var_20_20 = arg_20_0.endingBtn
			local var_20_21 = arg_20_0.status

			EducateConst = var_7

			var_3(var_20_20, var_20_21 == var_7.STATUES_ENDING)

			setActive = var_3

			local var_20_22 = arg_20_0.resetBtn
			local var_20_23 = arg_20_0.status

			EducateConst = var_7

			var_3(var_20_22, var_20_23 == var_7.STATUES_RESET)
...
function var_0_1.updateTargetSetBtn(arg_24_0)
	...
	var_1_10002(arg_24_0.targetSetBtn, var_24_0)

	if var_24_0 then
		setActive = var_1_10002

		local var_24_1 = arg_24_0.mapBtn

		var_1_10002(var_4.Find(var_24_1, "lock"), true)
	end
...
function var_0_1.updateMapBtnTips(arg_25_0)
	...
	local var_25_0 = var_1(var_1_10003)
	local var_25_1 = var_1.GetShowSiteIds(var_25_0)

	underscore = var_1_10002

	local var_25_2 = var_1_10002.any(var_25_1, function(arg_26_0)
		...
		return var_26_0(var_2_10003.NEW_SITE, arg_26_0)
	end)

	underscore = var_25_0

	local var_25_3 = var_25_0.any(var_25_1, function(arg_27_0)
		...
		return var_2_10002.any(var_27_1, function(arg_28_0)
	...
	var_4(var_6.Find(var_25_4, "tips/new"), var_25_2)

	setActive = var_4

	local var_25_5 = arg_25_0.mapBtn

	var_4(var_6.Find(var_25_5, "tips/limit"), var_25_3)
