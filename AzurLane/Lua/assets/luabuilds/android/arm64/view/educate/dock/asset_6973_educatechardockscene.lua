...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.selectPage = var_2_2(var_3.Find(var_2_3, "adapt/pages"), arg_2_0.event)
	EducateCharGroupPage = var_1

	local var_2_4 = var_1.New
	local var_2_5 = arg_2_0._tf

	arg_2_0.groupPage = var_2_4(var_3.Find(var_2_5, "adapt/pages/groupPage"), arg_2_0.event, arg_2_0.contextData)
...
function var_0_1.didEnter(arg_3_0)
	...
	arg_3_0:bind(var_0_1.ON_SELECTED, function(arg_9_0, arg_9_1)
		...
		EducateCharDockMediator = var_2_10005

		var_9_1(var_9_0, var_2_10005.ON_SELECTED, arg_9_1)
