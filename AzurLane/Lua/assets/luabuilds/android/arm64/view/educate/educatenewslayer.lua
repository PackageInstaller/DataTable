...
EducateSpecialEvent = var_0_0
var_0_2[var_0_0.TAG_ING] = "5ACEFE"
...
function var_0_1.initData(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10002(var_1_10004.child_event_special.all) do
...
function var_0_1.findUI(arg_4_0)
	...
	arg_4_0.importUIList = var_4_10(var_3.Find(var_4_11, "list"), arg_4_0.tplTF)
	setText = var_1

	local var_4_12 = arg_4_0.importTF
	local var_4_13 = var_3.Find(var_4_12, "title/Text")

	i18n = var_4

	var_1(var_4_13, var_4("child_news_import_title"))

	setText = var_1

	local var_4_14 = arg_4_0.importTF
	local var_4_15 = var_3.Find(var_4_14, "empty/Text")

	i18n = var_4

	var_1(var_4_15, var_4("child_news_import_empty"))
	...
	arg_4_0.otherUIList = var_4_17(var_3.Find(var_4_18, "list"), arg_4_0.tplTF)
	setText = var_1

	local var_4_19 = arg_4_0.otherTF
	local var_4_20 = var_3.Find(var_4_19, "title/Text")

	i18n = var_4

	var_1(var_4_20, var_4("child_news_other_title"))

	setText = var_1

	local var_4_21 = arg_4_0.otherTF
	local var_4_22 = var_3.Find(var_4_21, "empty/Text")

	i18n = var_4

	var_1(var_4_22, var_4("child_news_other_empty"))
...
function var_0_1.updateEventItem(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	EducateSpecialEvent = var_1_10006

	local var_12_3 = var_1_10006.TAG2NAME[var_12_2]

	setImageColor = var_12_1

	local var_12_4 = arg_12_2:Find("block")

	Color = var_1_10010

	var_12_1(var_12_4, var_1_10010.NewHex(var_0_2[var_12_2]))

	setText = var_12_1

	var_12_1(arg_12_2:Find("name"), var_12_0:getConfig("main_desc"))

	setTextColor = var_12_1

	local var_12_5 = arg_12_2:Find("name")

	Color = var_10

	var_12_1(var_12_5, var_10.NewHex(var_0_3[var_12_2]))

	eachChild = var_12_1

	var_12_1(arg_12_2:Find("name/tags"), function(arg_13_0)
	...
	var_12_1(arg_12_2:Find("time/Text"), var_12_0:GetTimeDesc())
...
function var_0_1.updateNewsList(arg_14_0)
	...
	var_1_10002.sort(arg_14_0.importEvents, var_14_0)
	...
	var_2(var_4.Find(var_14_1, "empty"), #arg_14_0.importEvents <= 0)

	setActive = var_2

	local var_14_2 = arg_14_0.otherTF

	var_2(var_4.Find(var_14_2, "empty"), #arg_14_0.otherEvents <= 0)
