...
function var_0_1.OnInit(arg_2_0)
	...
	arg_2_0.showAnim = var_2_4(var_2_3, var_4(var_1_10006))
	...
	arg_2_0.showAnimEvent = var_2_6(var_2_5, var_4(var_1_10006))
	...
	local var_2_15 = var_3.Find(var_2_14, "title/name_title/name")

	i18n = var_4

	var_1(var_2_15, var_4("child_archive_name"))

	setText = var_1

	local var_2_16 = arg_2_0.page1
	local var_2_17 = var_3.Find(var_2_16, "attr_title/Text")

	i18n = var_4

	var_1(var_2_17, var_4("child_attr_name1"))

	setText = var_1

	local var_2_18 = arg_2_0.page1
	local var_2_19 = var_3.Find(var_2_18, "buff_title/Text")

	i18n = var_4

	var_1(var_2_19, var_4("child_buff_name"))
	...
	local var_2_23 = var_3.Find(var_2_22, "attrs/content")
	local var_2_24 = arg_2_0.page1

	arg_2_0.attrsList1 = var_2_21(var_2_23, var_4.Find(var_2_24, "attrs/tpl"))
	...
	local var_2_29 = var_3.Find(var_2_28, "buff/content/content")
	local var_2_30 = arg_2_0.page1

	arg_2_0.buffItemList = var_2_27(var_2_29, var_4.Find(var_2_30, "buff/tpl"))
	...
	local var_2_34 = var_3.Find(var_2_33, "attr_title/Text")

	i18n = var_4

	var_1(var_2_34, var_4("child_attr_name2"))
	...
	local var_2_39 = var_3.Find(var_2_38, "content")
	local var_2_40 = arg_2_0.attr3UnlockTF

	arg_2_0.attrsList2 = var_2_37(var_2_39, var_4.Find(var_2_40, "tpl"))
...
function var_0_1.updateAttr1Item(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_2 = var_14_1(var_14_0, var_1_10006.ATTR_TYPE_MAJOR)[arg_14_1 + 1][1]
	local var_14_3 = arg_14_0.config[var_14_2]

	GetImageSpriteFromAtlasAsync = var_6

	var_6("ui/educatecommonui_atlas", "attr_" .. var_14_2, arg_14_2:Find("icon_bg/icon"), true)

	setScrollText = var_6

	var_6(arg_14_2:Find("name_mask/name"), var_14_3.name)
	...
	var_14_4(arg_14_2:Find("grade/Text"), var_14_5)

	setText = var_14_4

	var_14_4(arg_14_2:Find("value"), var_14_6)

	EducateConst = var_14_4

	local var_14_7 = var_14_4.GRADE_2_COLOR[var_14_5][1]
	...
	var_14_10, setImageColor = var_10.GetChild(var_14_9, arg_14_1), var_11
	Color = var_1_10014

	var_11(var_14_10, var_1_10014.NewHex(var_14_7))

	setImageColor = var_11

	local var_14_11 = arg_14_2:Find("grade")

	Color = var_14

	var_11(var_14_11, var_14.NewHex(var_14_8))
...
function var_0_1.updateBuffItem(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_2 = arg_15_2.Find(var_15_1, "time/Text")
	local var_15_3 = var_15_0
	local var_15_4 = var_15_0.GetReaminWeek(var_15_3)

	i18n = var_15_1

	var_4(var_15_2, var_15_4 .. var_15_1("word_week"))
	...
	var_4(var_15_5, var_15_6, var_15_7, var_15_3)
...
function var_0_1.showBuffBox(arg_17_0, arg_17_1)
	...
	local var_17_2 = var_1_10005.EDUCATE_ON_ITEM
	local var_17_3 = {}
	local var_17_4 = {
		number = 1
	}
	...
	var_17_4.type = var_1_10008.DROP_TYPE_BUFF
...
function var_0_1.updateAttr2Item(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10006.ATTR_TYPE_MINOR)[arg_18_1 + 1][1]
	local var_18_3 = arg_18_0.config[var_18_2]

	GetImageSpriteFromAtlasAsync = var_6

	var_6("ui/educatecommonui_atlas", "attr_" .. var_18_2, arg_18_2:Find("icon"), true)

	setText = var_6

	var_6(arg_18_2:Find("name"), var_18_3.name)
	...
	var_6(var_18_4, var_9.GetAttrById(var_18_5, var_18_2))
...
function var_0_1.updateNature(arg_19_0)
	...
	local var_19_1 = var_3.GetAttrGroupByType

	EducateChar = var_1_10006

	for iter_19_0, iter_19_1 in var_1_10001(var_19_1(var_19_0, var_1_10006.ATTR_TYPE_PERSONALITY)) do
...
function var_0_1.Flush(arg_20_0)
	...
	local var_20_5 = var_4.GetAttrGroupByType

	EducateChar = var_1_10007

	var_20_3(var_20_2, #var_20_5(var_20_4, var_1_10007.ATTR_TYPE_MAJOR))
	...
	local var_20_11 = var_4.GetAttrGroupByType

	EducateChar = var_7

	var_20_9(var_20_8, #var_20_11(var_20_10, var_7.ATTR_TYPE_MINOR))
	...
	var_1_10002(var_20_14, var_1_10005("educateavatar/" .. var_20_13), true)
	arg_20_0:updateNature()

	setImageSprite = var_2

	local var_20_15 = arg_20_0.avatarTF
	local var_20_16 = var_4.Find(var_20_15, "mask/Image")

	LoadSprite = var_5

	var_2(var_20_16, var_5("squareicon/" .. var_20_13), true)

	setText = var_2

	local var_20_17 = arg_20_0.page1
	local var_20_18 = var_4.Find(var_20_17, "title/name/Text")
	local var_20_19 = arg_20_0.char

	var_2(var_20_18, var_5.GetName(var_20_19))
	...
	var_20_12(arg_20_0.buffContentTF, var_20_21)

	setActive = var_20_12

	var_20_12(arg_20_0.buffLockTF, not var_20_21)

	EducateHelper = var_20_12

	local var_20_22 = var_20_12.IsShowNature()
	...
	local var_20_24 = var_20_23(var_6.SYSTEM_ATTR_3)
	...
	var_6(var_8.Find(var_20_26, "pagination"), var_20_25)
