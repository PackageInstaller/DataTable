...
local var_0_2 = var_2.SYSTEM_GO_OUT
...
function var_0_0.GetSystemUnlockTips()
	...
	for iter_1_0, iter_1_1 in var_1_1(var_0_0.system_tip_list) do
		...
		if not var_1_10007 then
			...
			if var_1_10008.IsSystemUnlock(iter_1_0) then
				table = var_1_10008

				var_1_10008.insert(var_1_3, iter_1_0)
			end
		end
	end
...
function var_0_0.SaveSystemUnlockTip(arg_2_0)
	...
	var_1_10002.SetInt(var_2_1 .. var_0_0.system_save_key .. arg_2_0, 1)
...
function var_0_0.ClearSystemUnlockTips()
	...
	for iter_3_0, iter_3_1 in var_1_10001(var_0_0.system_tip_list) do
...
for iter_0_0, iter_0_1 in var_1(var_3.child_site.all) do
	pg = var_0_10006
...
function var_0_0.GetSiteUnlockTipIds()
	...
	for iter_4_0, iter_4_1 in var_4_1(var_0_0.needTipSiteIds) do
		PlayerPrefs = var_1_10007
		...
		if not var_1_10007 then
			...
			if var_1_10008.IsSiteUnlock(iter_4_1, true) then
				table = var_1_10008

				var_1_10008.insert(var_4_3, iter_4_1)
...
function var_0_0.SaveSiteUnlockTipId(arg_5_0)
	...
	var_1_10002.SetInt(var_5_1 .. var_0_0.site_save_key .. arg_5_0, 1)
...
function var_0_0.ClearSiteUnlockTipIds()
	...
	for iter_6_0, iter_6_1 in var_1_10001(var_1_10003.child_site.all) do
...
for iter_0_2, iter_0_3 in var_1(var_3.child_plan.all) do
	pg = var_0_10006
...
function var_0_0.GetPlanUnlockTipIds()
	...
	local var_7_3 = var_7_0(var_1_10004)
	local var_7_4 = var_2.GetPlanProxy(var_7_3)

	ipairs = var_1_10003

	for iter_7_0, iter_7_1 in var_1_10003(var_0_0.needTipPlanIds) do
		PlayerPrefs = var_1_10008
		var_1_10008 = var_1_10008.GetInt(var_7_1 .. var_0_0.plan_save_key .. iter_7_1, 0) == 1

		if not var_1_10008 then
			pg = var_1_10009
			var_1_10009 = var_1_10009.child_plan[iter_7_1].pre

			if var_7_4:GetHistoryCntById(var_1_10009[1]) >= var_1_10009[2] then
				table = var_10
...
function var_0_0.SavePlanUnlockTipId(arg_8_0)
	...
	var_1_10002.SetInt(var_8_1 .. var_0_0.plan_save_key .. arg_8_0, 1)
...
function var_0_0.ClearPlanUnlockTipIds()
	...
	for iter_9_0, iter_9_1 in var_1_10001(var_0_0.needTipPlanIds) do
...
function var_0_0.SetNewTip(arg_11_0, arg_11_1)
	...
	if arg_11_1 then
		...
		if not var_1_10003(arg_11_1) then
			var_11_2 = ""
		end
...
function var_0_0.IsShowNewTip(arg_12_0, arg_12_1)
	...
	if arg_12_1 then
		...
		if not var_1_10003(arg_12_1) then
			var_12_2 = ""
		end
...
function var_0_0.ClearNewTip(arg_13_0, arg_13_1)
	...
	if arg_13_1 then
		...
		if not var_1_10003(arg_13_1) then
			var_13_2 = ""
		end
		...
		if var_6.HasKey(var_13_4) then
			...
			var_13_6(var_13_5, var_1_10009.CLEAR_NEW_TIP, {
				index = arg_13_0,
				id = arg_13_1
			})
		end
