...
function var_0_1.initData(arg_3_0)
	...
	arg_3_0.attrList = var_3_2(var_3_1, var_1_10004.ATTR_TYPE_PERSONALITY)
...
function var_0_1.findUI(arg_4_0)
	...
	local var_4_3 = var_3.Find(var_4_2, "content")
	local var_4_4 = arg_4_0.windowTF

	arg_4_0.attrUIList = var_4_1(var_4_3, var_4.Find(var_4_4, "content/tpl"))
...
function var_0_1.addListener(arg_5_0)
	...
	local function var_5_2()
		...
		i18n = var_2_10005
		var_6_3.content = var_2_10005("child_extraAttr_sure_tip")

		function var_6_3.onYes()
			local var_7_0 = arg_5_0
			local var_7_1 = var_0.emit

			EducateExtraAttrMediator = var_3_10003

			var_7_1(var_7_0, var_3_10003.ON_ATTR_ADD, {
...
function var_0_1.didEnter(arg_8_0)
	...
	var_1.make(var_8_0, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventInit then
			...
			var_4(var_9_1, var_9_2, var_9_3, var_9)
		else
			UIItemList = var_9_0
...
function var_0_1.updateView(arg_11_0)
	...
	var_11_1(var_11_5, var_11_6 .. var_1_10007.child_attr[var_11_4].name)
