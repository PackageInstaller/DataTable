...
function var_0_1.initGroups(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1(var_1_10003.child_polaroid.get_id_list_by_group) do
		table = var_1_10006
...
function var_0_1.didEnter(arg_6_0)
	...
	local var_6_10 = var_7.Find(var_6_9, "res/gold")
	local var_6_11 = var_7.GetComponent

	typeof = var_10
	Image = var_1_10012

	var_6_7(var_6_6, var_6_8, var_6_11(var_6_10, var_10(var_1_10012)).sprite)
	...
	local var_6_14 = var_5.Find(var_6_13, "tip")

	i18n = var_6

	var_6_7(var_6_14, var_6("child_buy_polaroid_tip"))
...
function var_0_1.initShowList(arg_8_0)
	...
	arg_8_0.showList = var_8_1(var_8_2, var_4.Find(var_8_3, "tpl"))
	...
	var_1.make(var_8_4, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			var_2_10005(arg_9_2:Find("unlock/unselected/Text"), var_9_0)

			setText = var_2_10005

			var_2_10005(arg_9_2:Find("unlock/selected/Text"), var_9_0)

			setActive = var_2_10005

			var_2_10005(arg_9_2:Find("lock"), not var_9_2)

			setActive = var_2_10005

			var_2_10005(arg_9_2:Find("unlock"), var_9_2)

			setActive = var_2_10005

			var_2_10005(arg_9_2:Find("unlock/selected"), arg_8_0.selectedIndex == arg_9_1 + 1)

			setActive = var_2_10005

			var_2_10005(arg_9_2:Find("unlock/unselected"), arg_8_0.selectedIndex ~= arg_9_1 + 1)

			onButton = var_2_10005

			var_2_10005(arg_8_0, arg_9_2, function(arg_10_0)
				...
				if not var_9_2 then
					...
					var_10_3(var_10_2, var_4("child_polaroid_lock_tip"))
				end
...
function var_0_1.Flush(arg_13_0)
	...
	var_13_1(arg_13_0.curCntTF, var_13_2)

	setText = var_13_1

	var_13_1(arg_13_0.allCntTF, "/" .. var_13_3)
	arg_13_0:updatePage()
...
function var_0_1.updateItem(arg_15_0, arg_15_1, arg_15_2)
	...
	if var_15_4 then
		...
		local var_15_6 = "educatepolaroid/" .. var_15_3.pic

		var_1_10012 = arg_15_2

		var_7(var_15_6, arg_15_2.Find(var_1_10012, "unlock/mask/Image"))
		...
		var_7(var_15_7, var_15_8, var_15_9, var_1_10012)
	else
		...
		local var_15_10 = arg_15_2:Find("lock/unlock_btn")

		setActive = var_7

		var_7(var_15_10, arg_15_0.gameCnt > 1)
		...
		var_7(var_15_11, var_15_12, var_15_13, var_1_10012)
	end
...
function var_0_1.showPerformWindow(arg_21_0, arg_21_1, arg_21_2)
	...
	var_3(var_5.GetChild(var_21_1, 0))
...
function var_0_1.updatePerform(arg_22_0, arg_22_1, arg_22_2)
	...
	var_1_10004(var_22_1, var_7.Find(var_22_2, "bg/icon/Image"))

	setActive = var_1_10004

	local var_22_3 = arg_22_0.performTF

	var_1_10004(var_6.Find(var_22_3, "bg/icon/lock"), not arg_22_2)

	setText = var_1_10004

	local var_22_4 = arg_22_0.performTF
	local var_22_5 = var_6.Find(var_22_4, "bg/Text")
	local var_22_6
	...
	var_1_10004(var_6.Find(var_22_7, "bg/lock"), not arg_22_2)
	...
	if not arg_22_2 then
		...
		var_1_10004(var_6.Find(var_22_8, "bg/lock/desc/Text"), var_22_0.condition)
		...
		var_1_10005(var_22_10, arg_22_0.gameCnt > 1)
		...
		var_1_10005(var_22_11, var_22_12, var_22_13, var_10)
	end
...
function var_0_1.OnClickBuyBtn(arg_24_0, arg_24_1)
	...
	local var_24_4 = var_7.EDUCATE_ON_MSG_TIP
	local var_24_5 = {}

	i18n = var_1_10009
	var_24_5.content = var_1_10009("child_polaroid_buy", var_24_1, var_24_0)
	...
	function var_24_5.onYes()
		...
		local var_25_2 = var_2_10003.UNLOCK
		local var_25_3 = {}

		EducateBuyCollectCommand = var_2_10005
		var_25_3.type = var_2_10005.TYPE.POLAROID
