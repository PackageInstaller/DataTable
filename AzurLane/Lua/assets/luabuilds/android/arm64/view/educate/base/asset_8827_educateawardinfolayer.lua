...
function var_0_1.didEnter(arg_4_0)
	...
	local function var_4_6()
		...
		var_6_1(var_6_0, var_2_10003("child_polaroid_get_tip"))
...
function var_0_1.showWindow(arg_7_0)
	if #arg_7_0.showAwardDrops > 0 then
		...
		var_3.insert(var_7_2, function(arg_8_0)
		...
		for iter_7_0 = 1, var_7_3 do
			...
			var_1_10008.insert(var_7_2, function(arg_10_0)
				if arg_7_0.showAwardDrops[iter_7_0] then
					...
					var_2_10003.UpdateDropShow(var_10_0, var_1)
				...
				if arg_7_0.showAttrDrops[iter_7_0] then
					...
					EducateHelper = var_2_10004

					var_2_10004.UpdateDropShowForAttr(var_10_1, var_2)
				end
				...
				var_10_3(var_10_2, var_2_10006.delayedCall, function()
					arg_10_0()
		...
		var_4(var_7_2, function()
			...
			var_13_1(var_13_0, var_2_10003.delayedCall, function()
...
function var_0_1.getAwardDrops(arg_15_0)
	...
	var_15_2[1] = var_1_10005.DROP_TYPE_ATTR
	EducateConst = var_5
	var_15_2[2] = var_5.DROP_TYPE_RES
	EducateConst = var_5
	var_15_2[3] = var_5.DROP_TYPE_ITEM
	EducateConst = var_5
	var_15_2[4] = var_5.DROP_TYPE_BUFF
...
function var_0_1.getAttrDrops(arg_16_0)
	...
	EducateConst = var_1_10005
	var_16_2[1] = var_1_10005.DROP_TYPE_ITEM
	...
	var_16_1.each(var_16_3, function(arg_17_0)
		table = var_2_10001
		...
		EducateHelper = var_2_10004
		var_16_4 = var_17_0(var_17_1, var_2_10004.GetItemAddDrops(arg_17_0))
...
function var_0_1.getPolaroidDrops(arg_18_0)
	...
	EducateConst = var_1_10005
	var_18_2[1] = var_1_10005.DROP_TYPE_POLAROID
...
function var_0_1.showPolaroidAnim(arg_19_0)
	...
	var_4.insert(var_19_2, function(arg_20_0)
		...
		var_20_1(var_20_0, var_2_10004.delayedCall, function()
	...
	if var_4.CheckNewSecretaryTip(var_19_3) then
		...
		var_4.insert(var_19_2, function(arg_22_0)
			...
			var_22_3.type = var_2_10006.UNLOCK_NEW_SECRETARY
