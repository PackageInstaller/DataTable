...
local var_0_4 = var_0(var_0_3, var_0_10003("..base.BaseUI"))
local var_0_5 = {
	{
		0,
		1,
...
function var_0_4.init(arg_2_0)
	...
	arg_2_0.scrollItem = var_2_10(var_3.Find(var_2_11, "blur_panel/scrollItem").gameObject, arg_2_0.dispatch)
	...
	arg_2_0.detailPanel = var_2_13(var_3.Find(var_2_14, "detailPanel").gameObject, arg_2_0.dispatch)
	...
	var_1(var_2_20, var_4("list_empty_tip_eventui"))
...
function var_0_4.didEnter(arg_7_0)
	...
	local var_7_4 = var_3.Find(var_7_3, "stamp")

	getProxy = var_7_1
	TaskProxy = var_6

	local var_7_5 = var_7_1(var_6)

	var_1_10001(var_7_4, var_4.mingshiTouchFlagEnabled(var_7_5))
	...
	if var_1_10001 then
		...
		var_1_10001(var_3.Find(var_7_6, "stamp"), false)
	end
	...
	local var_7_9 = var_4.Find(var_7_8, "stamp")
	...
	var_1_10001(var_7_7, var_7_9, var_7_10, var_7_8)
	...
	for iter_7_0, iter_7_1 in var_1(var_0_6) do
		...
		var_7_11[iter_7_0] = var_7.Find(var_7_12, "frame/scroll_rect/tagRoot/" .. iter_7_1 .. "_btn")
		onToggle = var_7_11
				...
				if arg_7_0.selectedItem then
					...
					for iter_11_0 = 0, var_11_2 - 1 do
						...
						elseif var_11_3 < iter_11_0 then
							...
							typeof = var_2_10013
							LayoutElement = var_2_10015

							local var_11_6 = var_11_5(var_11_4, var_2_10013(var_2_10015))
							local var_11_7
	...
	local function var_7_14()
		...
		EventInfo = var_2_10001

		if var_12_1 == var_2_10001.StateFinish then
			local var_12_2 = arg_7_0.dispatch

			EventConst = var_12_0

			var_12_2(var_12_0.EVENT_FINISH, arg_7_0.scrollItem.event)
		else
	...
	var_3(var_7_15, var_7_16, var_7_17, var_1_10008)
	...
	var_3(var_7_18, var_7_19, var_7_20, var_1_10008)
	...
	var_3(var_7_21, var_7_22, var_7_23, var_1_10008)
	arg_7_0:ctimer()
...
function var_0_4.updateAll(arg_16_0)
	if arg_16_0.selectedItem then
		...
		if var_1.detect(arg_16_0.eventList, function(arg_17_0)
			...
			local var_16_0 = var_1_10002(var_4)
...
function var_0_4.filter(arg_22_0)
	...
	CompareFuncs = iter_22_0

	var_22_1(var_22_2, iter_22_0({
		function(arg_23_0)
...
function var_0_4.onInitItem(arg_28_0, arg_28_1)
	...
	local function var_28_1()
		...
		if var_29_1 == var_2_10001.StateFinish then
			local var_29_2 = arg_28_0.dispatch

			EventConst = var_29_0

			var_29_2(var_29_0.EVENT_FINISH, var_28_0.event)
		else
	...
	var_4(var_28_2, var_28_3, var_28_4, var_1_10009)
	...
	var_4(var_28_5, var_28_6, var_28_7, var_1_10009)
...
function var_0_4.onUpdateItem(arg_30_0, arg_30_1, arg_30_2)
	...
	tf = var_1_10005
	var_1_10003(var_1_10005(arg_30_2), "CanvasGroup").alpha = 1
...
function var_0_4.easeInDetail(arg_36_0, arg_36_1)
	...
	local var_36_6 = var_36_0 * var_7.abs(var_36_5 - var_36_4.localPosition.y - arg_36_0.selectedItem.tr.localPosition.y) / var_36_3.rect.height
	...
	local var_36_10 = var_10.value(var_36_4.gameObject, var_36_7, var_36_9, var_36_6)
	local var_36_11 = var_10.setEase

	LeanTweenType = var_13

	local var_36_12 = var_36_11(var_36_10, var_13.easeInOutCirc)
	local var_36_13 = var_10.setOnUpdate

	System = var_13

	local var_36_14 = var_36_13(var_36_12, var_13.Action_float(function(arg_37_0)
	...
	var_36_15(var_36_14, var_13.Action(function()
		...
		var_38_6(var_38_5, var_6.Find(var_38_7, "maskDetail"), true)
		...
		local var_38_13 = var_38_12(var_38_11, var_6.easeInOutCirc)
		local var_38_14 = var_3.setOnComplete

		System = var_6

		var_38_14(var_38_13, var_6.Action(arg_36_1))
		...
		for iter_38_1, iter_38_2 in var_38_19(var_38_17) do
			...
			typeof = var_2_10014
			LayoutElement = var_2_10016

			local var_38_22 = var_38_21(var_38_20, var_2_10014(var_2_10016))

			arg_36_0.rawLayouts[iter_38_2] = var_38_22.ignoreLayout
			var_38_22.ignoreLayout = true
			shiftPanel = var_12
			var_2_10014 = var_12(iter_38_2, nil, iter_38_2.localPosition.y + var_38_4, var_36_1, 0, true)

			local var_38_23 = var_12.setEase

			LeanTweenType = var_15

			var_38_23(var_2_10014, var_15.easeInOutCirc)
		end
...
function var_0_4.easeOutDetail(arg_39_0, arg_39_1)
	...
	for iter_39_0 = 0, var_39_2 - 1 do
		if var_4:GetChild(iter_39_0) == arg_39_0.selectedItem.tr then
			var_39_3 = iter_39_0
	...
	for iter_39_1, iter_39_2 in var_8(var_39_4) do
		...
		var_1_10013(var_39_5, var_16.easeInOutCirc)
	end
	...
	local var_39_8 = var_39_7(var_39_6, var_11.easeInOutCirc)
	local var_39_9 = var_8.setOnComplete

	System = var_11

	var_39_9(var_39_8, var_11.Action(function()
		ipairs = var_2_10000
		...
		for iter_40_0, iter_40_1 in var_2_10000(var_39_4) do
			...
			typeof = var_2_10008
			LayoutElement = var_2_10010

			local var_40_2 = var_40_1(var_40_0, var_2_10008(var_2_10010))
			local var_40_3
...
function var_0_4.showDetail(arg_41_0)
	...
	var_41_9(var_41_8, var_9.Find(var_41_10, "maskDetail"), true)
	...
	for iter_41_0 = 0, var_41_13 - 1 do
		...
		if var_41_16(var_41_15, var_1_10016(var_1_10018)).ignoreLayout or not var_12.gameObject.activeSelf then
		...
		elseif var_41_14 < iter_41_0 then
			...
			Vector3 = var_15
			var_12.localPosition = var_41_17 + var_15.New(-1, var_41_7, 0)
		end
	end
...
function var_0_4.ctimer(arg_42_0)
	...
	arg_42_0.timer = var_1_10002.New(function()
		...
		local var_43_3 = var_0

		if var_0.STimeDescS(var_43_3, var_43_2, "%Y/%m/%d") ~= var_0:STimeDescS(var_43_2 - 1, "%Y/%m/%d") then
			local var_43_4 = arg_42_0.dispatch

			EventConst = var_43_3

			var_43_4(var_43_3.EVENT_FLUSH_ALL)
		...
		for iter_43_0, iter_43_1 in var_3(arg_42_0.scrollItems) do
			if iter_43_1.go.name ~= "-1" then
				...
				local var_43_6 = iter_43_1.event

				if var_8.GetCountDownTime(var_43_6) and var_8 < 0 then
					var_43_5 = true
				end
			end
		end
		...
		if var_43_5 then
			local var_43_7 = arg_42_0.dispatch

			EventConst = var_5

			var_43_7(var_5.EVENT_LIST_UPDATE)
		end
...
function var_0_4.updateBtnTip(arg_47_0)
	...
	local var_47_1 = var_1_10002(var_1_10004)

	var_47_0[2] = var_2.checkNightEvent(var_47_1)
	ipairs = var_2

	for iter_47_0, iter_47_1 in var_2(arg_47_0.eventList) do
		var_1_10009 = iter_47_1
		var_1_10007 = iter_47_1.GetState(var_1_10009)
	...
	for iter_47_2, iter_47_3 in var_2(arg_47_0.toggles) do
		...
		var_1_10007(var_1_10009(iter_47_3, "tip"), var_47_0[iter_47_2])
	end
