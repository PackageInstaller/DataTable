...
function var_0_1.showCustomMsgBox(arg_8_0, arg_8_1)
	...
	var_1_10003(arg_8_0.msgBoxItemPanel, var_8_2)

	setActive = var_1_10003

	var_1_10003(arg_8_0.msgBoxContent, not var_8_2)

	local var_8_15

	if var_8_2 then
		var_1_10003 = arg_8_1.items

		for iter_8_0 = arg_8_0.msgboxItemContains.childCount + 1, #var_1_10003 do
		...
		for iter_8_1 = 1, var_8_3 do
			...
			var_1_10010(var_8_5, iter_8_1 <= #var_1_10003)

			if iter_8_1 <= #var_1_10003 then
				var_1_10010 = var_1_10003[iter_8_1]
				updateDrop = var_8_4

				var_8_4(var_8_5, var_1_10010)

				local var_8_6 = 0
				local var_8_7 = var_1_10010.type
				...
				if var_8_7 == var_13 then
					var_8_8 = arg_8_0.shareData.player
					var_8_6 = var_12.getResById(var_8_8, var_1_10010.id)
				else
					local var_8_9 = var_1_10010.type

					DROP_TYPE_ITEM = var_13

					if var_8_9 == var_13 then
						getProxy = var_8_9
						BagProxy = var_8_8

						local var_8_10 = var_8_9(var_8_8)

						var_8_6 = var_12.getItemCountById(var_8_10, var_1_10010.id)
					end
				end

				var_8_6 = var_8_6 < var_1_10010.count and "<color=#D6341DFF>" .. var_8_6 .. "</color>" or "<color=#A9F548FF>" .. var_8_6 .. "</color>"
				setText = var_13

				var_13(var_8_5:Find("icon_bg/count"), var_8_6 .. "/" .. var_12)
			end
		end
		...
		var_8_15(var_8_13, var_8_14)
	else
		setText = var_1_10003
		var_8_15 = arg_8_0.msgBoxContent
	...
	if arg_8_1.title then
		...
		var_8_15(arg_8_0.msgBoxTitle, var_8_17)

		setText = var_8_15

		var_8_15(arg_8_0.msgBoxTitleEn, var_8_18 or "")
	end
