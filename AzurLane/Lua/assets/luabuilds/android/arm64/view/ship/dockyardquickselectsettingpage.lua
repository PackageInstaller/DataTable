...
function var_0_1.InitUI(arg_3_0)
	...
	local var_3_0 = var_1_10003(arg_3_0._tf, "window/top/bg/obtain/title")

	i18n = var_1_10004

	var_1_10001(var_3_0, var_1_10004("retire_title"))
	...
	var_1_10001(var_3_1, var_4("unique_ship_retire_protect"))
	...
	local var_3_3 = var_1_10002(var_3_2, "on")
	...
	var_4(arg_3_0, var_3_3, function(arg_4_0)
		...
		local var_4_2 = var_4_1(var_4_0, var_2_10004(var_2_10006))
	...
	var_8(var_3_9, var_1_10011(var_3_8, "keep_all"), function(arg_7_0)
		if arg_7_0 then
	...
	var_8(var_3_10, var_11(var_3_8, "keep_one"), function(arg_8_0)
		if arg_8_0 then
	...
	var_8(var_3_11, var_11(var_3_8, "keep_none"), function(arg_9_0)
		if arg_9_0 then
	...
	var_9(var_3_13, var_12(var_3_12, "keep_all"), function(arg_10_0)
		if arg_10_0 then
	...
	var_9(var_3_14, var_12(var_3_12, "keep_needed"), function(arg_11_0)
		if arg_11_0 then
	...
	var_9(var_3_15, var_12(var_3_12, "keep_none"), function(arg_12_0)
		if arg_12_0 then
	...
	local var_3_17 = var_12(arg_3_0._tf, "window/top/btnBack")
	...
	var_9(var_3_16, var_3_17, var_3_18, var_14)
	...
	local function var_3_21()
		...
		i18n = var_2_10004
		var_14_2.helps = var_2_10004("retire_setting_help")
	...
	var_9(var_3_19, var_3_20, var_3_21, var_14)
	...
	if var_3_23 == "KeepAll" then
		...
		var_12(var_14(var_3_8, "keep_all"), true)
	elseif var_3_23 == "KeepOne" then
		triggerToggle = var_12
		findTF = var_14

		var_12(var_14(var_3_8, "keep_one"), true)
	elseif var_3_23 == "KeepNone" then
		triggerToggle = var_12
		findTF = var_14

		var_12(var_14(var_3_8, "keep_none"), true)
	end
	...
	if var_3_24 == "KeepAll" then
		...
		var_12(var_14(var_3_12, "keep_all"), true)
	elseif var_3_24 == "KeepNeeded" then
		triggerToggle = var_12
		findTF = var_14

		var_12(var_14(var_3_12, "keep_needed"), true)
	elseif var_3_24 == "KeepNone" then
		triggerToggle = var_12
		findTF = var_14

		var_12(var_14(var_3_12, "keep_none"), true)
	end

	setText = var_12
	findTF = var_14

	local var_3_25 = var_14(arg_3_0._tf, "window/notifications/options/notify_tpl_4/Text")

	i18n = var_15

	var_12(var_3_25, var_15("retire_1"))
	...
	var_12(var_3_26, var_15("retire_2"))

	local var_3_27 = {}

	PlayerPrefs = var_13
	var_3_27[1] = var_13.GetInt("QuickSelectRarity1", 3)
	PlayerPrefs = var_13
	...
	for iter_3_6 = 1, #var_3_5 do
		setText = var_17
		findTF = var_1_10019
		var_1_10019 = var_1_10019(var_3_5[iter_3_6], "Text")
		i18n = iter_3_7

		var_17(var_1_10019, iter_3_7("retire_rarity", iter_3_6))

		pairs = var_17

		for iter_3_7, iter_3_8 in var_17(var_3_6) do
