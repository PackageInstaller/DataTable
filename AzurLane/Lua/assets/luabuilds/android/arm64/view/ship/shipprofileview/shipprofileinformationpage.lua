...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.voiceBtnTxt = var_2_11(var_2_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.voiceBtnTxt1 = var_2_14(var_2_13, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.profileTxt = var_2_18(var_2_17, var_4(var_1_10006))
...
function var_0_1.UpdateCvBtn(arg_3_0, arg_3_1)
	...
	local var_3_4 = var_1_10005.New(0.5, 0.5, 0.5, 1)
...
function var_0_1.UpdateLang2(arg_4_0)
	...
	local var_4_2 = var_1_10003.ship_skin_words[var_4_1.id]

	PlayerPrefs = var_4

	local var_4_3 = var_4.SetInt

	CV_LANGUAGE_KEY = var_1_10006

	var_4_3(var_1_10006 .. var_4_0, 2)
...
function var_0_1.UpdateLang1(arg_5_0)
	...
	local var_5_2 = var_1_10003.ship_skin_words[var_5_1.id]
...
function var_0_1.OnInit(arg_8_0)
	...
	local function var_8_2()
		...
		var_9_1(var_9_0, var_2_10003.WEDDING_REVIEW, {
...
function var_0_1.EnterAnim(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_1 = var_10_0(var_1_10005(arg_10_0._tf), 0, arg_10_1)
	local var_10_2 = var_3.setEase

	LeanTweenType = var_6

	local var_10_3 = var_10_2(var_10_1, var_6.easeInOutSine)
	local var_10_4 = var_3.setOnComplete

	System = var_6

	var_10_4(var_10_3, var_6.Action(arg_10_2))
...
function var_0_1.ExistAnim(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_1 = var_11_0(var_1_10005(arg_11_0._tf), 1000, arg_11_1)
	local var_11_2 = var_3.setEase

	LeanTweenType = var_6

	local var_11_3 = var_11_2(var_11_1, var_6.easeInOutSine)
...
function var_0_1.Update(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	if var_4(arg_13_0.weddingReview) then
		...
		var_1_10005(arg_13_0.weddingReview, function(arg_14_0)
			setActive = var_2_10001

			var_2_10001(arg_14_0, arg_14_0.name == var_13_0)
...
function var_0_1.UpdateProfileInfo(arg_16_0)
	...
	local var_16_2, var_16_3, var_16_4 = var_16_0(var_16_1, var_1_10004.WORD_TYPE_PROFILE)
	...
	if var_16_5.ship_skin_words[arg_16_0.skin.id] then
		...
		if var_16_8 then
			...
			var_1_10006(var_16_9, var_16_10, var_16_11, var_1_10011)
		end

		setActive = var_1_10006

		var_1_10006(arg_16_0.profilePlayBtn, var_16_8)
...
function var_0_1.UpdateLanguage(arg_20_0)
	...
	local var_20_2 = var_1_10003.ship_skin_words[arg_20_0.skin.id]
		...
		__index = function(arg_21_0, arg_21_1)
			if arg_21_1 == "voice_key_2" then
				...
				if var_2_10002.ship_skin_words[arg_20_0.skin.id][arg_21_1] == 0 then
					...
					var_2_10002(var_21_0, var_21_1, var_2_10006.ship_skin_words[var_20_1.id][arg_21_1])
			...
			do
				...
				var_2_10002(var_21_2, var_21_3, var_2_10006.ship_skin_words[arg_20_0.skin.id][arg_21_1])
			end
	...
	if var_20_3.voice_key_2 >= 0 and var_20_4 == 0 then
		pg = var_6
		var_20_4 = var_6.gameset.language_default.key_value
		PlayerPrefs = var_6

		local var_20_6 = var_6.SetInt

		CV_LANGUAGE_KEY = var_8

		var_20_6(var_8 .. var_20_0, var_20_4)
	end

	local var_20_7 = arg_20_0

	arg_20_0.OnCvBtn(var_20_7, var_20_4 == 2)
	...
	if var_20_3.voice_key_2 >= 0 or var_20_3.voice_key_2 == -2 then
		if var_20_3.voice_key_2 % 10 == 2 then
			...
			i18n = var_20_7
			var_20_8.text = var_20_7("word_chinese")

			local var_20_9 = arg_20_0.voiceBtnTxt1

			i18n = var_20_7
			var_20_9.text = var_20_7("word_japanese")
		elseif var_6 == 3 then
			local var_20_10 = arg_20_0.voiceBtnTxt

			i18n = var_20_7
			var_20_10.text = var_20_7("word_japanese_2")
...
function var_0_1.UpdateCvList(arg_25_0, arg_25_1)
	...
	if var_25_2 < var_6.GetMainSceneWordCnt(arg_25_0.skin.id, var_25_4) then
...
function var_0_1.AddMainExBtn(arg_27_0, arg_27_1, arg_27_2)
	...
	local var_27_1 = var_27_0(var_1_10005(arg_27_0.cvTpl, arg_27_0.cvContainer))
	...
	var_1_10004(var_27_2, var_27_3, var_27_4, var_1_10009)
...
function var_0_1.AddCvBtn(arg_29_0, arg_29_1)
	...
	local var_29_1 = var_29_0(var_1_10004(arg_29_0.cvTpl, arg_29_0.cvContainer))
	...
	var_1_10003(var_29_2, var_29_3, var_29_4, var_1_10008)
...
function var_0_1.AddExCvBtn(arg_31_0, arg_31_1)
	...
	local var_31_1 = var_31_0(var_1_10004(arg_31_0.cvTpl, arg_31_0.cvContainer))
	...
	var_1_10003(var_31_2, var_31_3, var_31_4, var_1_10008)
