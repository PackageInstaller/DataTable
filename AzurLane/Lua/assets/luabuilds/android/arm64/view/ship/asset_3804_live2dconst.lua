...
function var_0_0.SaveL2dIdle(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_10004.SetInt(var_1_0, arg_1_2)
...
function var_0_0.SaveL2dAction(arg_2_0, arg_2_1, arg_2_2)
	...
	var_1_10004.SetInt(var_2_0, arg_2_2)
...
function var_0_0.GetL2dIdleSaveName(arg_3_0, arg_3_1)
	...
	return var_3_0 .. var_3_1 .. var_3_2 .. var_5(arg_3_1) .. "_idle_index"
end
...
function var_0_0.GetL2dActionSaveName(arg_4_0, arg_4_1)
	...
	return var_4_0 .. var_4_1 .. var_4_2 .. var_5(arg_4_1) .. "_action_id"
end
...
function var_0_0.SaveDragData(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	var_1_10005.SetFloat(var_6_0, arg_6_3)
...
function var_0_0.GetDragData(arg_7_0, arg_7_1, arg_7_2)
	...
	return var_1_10004.GetFloat(var_7_0)
end
...
function var_0_0.GetDragSaveName(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_3 = var_6(arg_8_1)
	local var_8_4 = "_"

	tostring = var_8

	return var_8_0 .. var_8_1 .. var_8_2 .. var_8_3 .. var_8_4 .. var_8(arg_8_2) .. "_target"
end
...
function var_0_0.SetDragActionIndex(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	var_1_10005.SetInt(var_9_0, arg_9_3)
...
function var_0_0.GetDragActionIndex(arg_10_0, arg_10_1, arg_10_2)
	...
	if not var_1_10004.GetInt(var_10_0) or var_10_1 <= 0 then
		var_10_1 = 1
	end
...
function var_0_0.GetDragActionIndexName(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_3 = var_6(arg_11_1)
	local var_11_4 = "_"

	tostring = var_8

	return var_11_0 .. var_11_1 .. var_11_2 .. var_11_3 .. var_11_4 .. var_8(arg_11_2) .. "_action_index"
end
...
function var_0_0.ClearLive2dSave(arg_15_0, arg_15_1)
	...
	if not var_1_10002.ship_skin_template[arg_15_0] then
		...
		local var_15_0 = "找不到skinId"

		tostring = var_1_10005

		var_2(var_15_0 .. var_1_10005(arg_15_0) .. " 清理失败")
	...
	if var_2.L2D_PARAMETER_DIC[arg_15_1] then
		ChangeSkinLink = var_15_1
		var_15_1 = var_15_1.L2D_PARAMETER_DIC
		var_15_1[arg_15_1] = {}
	end

	pg = var_15_1

	if var_15_1.ship_skin_template[arg_15_0].ship_l2d_id and #var_2 > 0 then
		...
		for iter_15_0, iter_15_1 in var_1_10003(var_2) do
			...
			if var_1_10008.ship_l2d[iter_15_1] then
				...
				if var_1_10008.relation_parameter and var_1_10008.relation_parameter.list then
					...
					string = var_1_10011
					var_1_10010 = var_1_10011.gsub(var_1_10010, "%$1", iter_15_1)
					string = var_1_10011
					var_1_10010 = var_1_10011.gsub(var_1_10010, "%$2", arg_15_0)
					string = var_1_10011
					var_1_10010 = var_1_10011.gsub(var_1_10010, "%$3", arg_15_1)

					for iter_15_2 = 1, #var_0_0.RELATION_DRAG_NAME_LIST do
						local var_15_2 = var_0_0.RELATION_DRAG_NAME_LIST[iter_15_2]
						local var_15_3 = var_1_10010 .. var_15_2

						PlayerPrefs = var_17

						var_17.SetFloat(var_15_3, 0)
					end
				end
			else
				warning = var_1_10009
				...
				var_1_10009(var_1_10011(iter_15_1) .. "不存在，不清理该dragid")
			end
		end
	end
	...
	local var_15_4 = var_1_10003.TipsMgr.GetInstance()
	local var_15_5 = var_3.ShowTips

	i18n = iter_15_0

	var_15_5(var_15_4, iter_15_0("live2d_reset_desc"))
...
function var_0_0.ShowLive2DArm32Tips()
	...
	var_17_1(var_17_0, var_1_10003("l2d_32xbanned_warning"))
...
function var_0_0.SaveL2dBgmVolume(arg_20_0, arg_20_1)
	if arg_20_0 and arg_20_1 then
		...
		if var_2.IsChangeSkin(arg_20_0) then
			...
			if not var_1_10003.GetChangeSkinNextId(arg_20_0) then
				var_20_0 = nil
			end
			...
			if var_20_0 then
				...
				var_20_1 = var_20_1.SetFloat
				Live2dConst = var_1_10006

				var_20_1(var_1_10006.PAINTING_BGM_VOLUME .. "_" .. var_20_0, arg_20_1)
			end

			PlayerPrefs = var_20_1

			local var_20_2 = var_20_1.SetFloat

			Live2dConst = var_1_10006

			var_20_2(var_1_10006.PAINTING_BGM_VOLUME .. "_" .. arg_20_0, arg_20_1)
...
function var_0_0.GetPaintingBgmVolume(arg_21_0)
	...
	if var_21_1(var_1_10004.PAINTING_BGM_VOLUME .. "_" .. arg_21_0) ~= nil then
		var_21_0 = var_2
	end
