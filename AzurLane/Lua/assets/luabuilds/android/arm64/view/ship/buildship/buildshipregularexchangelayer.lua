...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_1_10003(arg_2_0.ids) do
		...
		var_1_10008.insert(var_2_1, function(arg_3_0)
			...
			var_2_10001(var_3_0, var_2_10004(iter_2_1), function(arg_4_0)
...
function var_0_1.init(arg_6_0)
	...
	arg_6_0.iconList = var_1_10002.New(var_6_5, var_6_5:Find("tpl"))
	...
	var_2.make(var_6_6, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			var_2_10004(arg_8_2:Find("Image"), arg_6_0.iconSprites[var_8_0.configId], true)

			setActive = var_2_10004

			local var_8_1 = arg_8_2:Find("noget")

			getProxy = var_7
			CollectionProxy = var_9

			local var_8_2 = var_7(var_9)

			var_2_10004(var_8_1, not var_7.getShipGroup(var_8_2, var_8_0:getGroupId()))
			...
			var_2_10004(var_8_3, var_8_4, var_8_5, var_8_2)

			triggerToggle = var_2_10004

			var_2_10004(arg_8_2, arg_8_1 == 1)
		end
	...
	local var_6_9 = var_5.Find(var_6_8, "select/operation/help")
	...
	local function var_6_10()
		...
		i18n = var_2_10004
		var_10_2.helps = var_2_10004("Normalbuild_URexchange_help")
	...
	var_2(var_6_7, var_6_9, var_6_10, var_6_8)

	setText = var_2

	local var_6_11 = arg_6_0._tf
	local var_6_12 = var_4.Find(var_6_11, "select/operation/count/Text")

	i18n = var_6_9

	var_2(var_6_12, var_6_9("Normalbuild_URexchange_text2") .. ":")
	...
	local function var_6_17()
		...
		if arg_6_0.count < arg_6_0.cfg.exchange_request then
			...
			var_11_1(var_11_0, var_2_10003("Normalbuild_URexchange_warning1"))
		else
			pg = var_11_1
			...
			var_11_4.content = var_2_10004(var_11_5, var_7.getName(var_11_6))

			function var_11_4.onYes()
				local var_12_0 = arg_6_0
				local var_12_1 = var_0.emit

				BuildShipRegularExchangeMediator = var_3_10003

				var_12_1(var_12_0, var_3_10003.EXCHAGNE_SHIP, arg_6_0.shipVO.configId)
	...
	var_2(var_6_15, var_6_16, var_6_17, var_7)
...
function var_0_1.flush(arg_14_0)
	...
	var_1_10001(var_14_0, var_1_10004({
		function(arg_15_0)
			Ship = var_2_10001
			...
			local var_15_1 = var_2_10002(var_2_10004)
...
function var_0_1.willExit(arg_17_0)
	...
	if arg_17_0.shipVO then
		...
		var_1(var_17_0, var_4.getPainting(var_17_1))
	end
