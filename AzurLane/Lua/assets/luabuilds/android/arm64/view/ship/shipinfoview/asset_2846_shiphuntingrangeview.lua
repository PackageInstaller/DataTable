...
function var_0_1.DisplayHuntingRange(arg_5_0)
	...
	var_1_10002(arg_5_0.huntingRange, true)
	arg_5_0:UpdateHuntingRange(var_5_0, var_5_0:getHuntingLv())

	setText = var_2

	var_2(arg_5_0.curLevel, "Lv." .. var_5_0:getHuntingLv())

	setText = var_2

	local var_5_1 = arg_5_0.tips

	i18n = var_5

	var_2(var_5_1, var_5("ship_hunting_level_tips"))

	onButton = var_2

	local var_5_2 = arg_5_0
	local var_5_3 = arg_5_0.closeBtn
	...
	local function var_5_7()
		...
		pg = var_2_10004
		var_7_2.helps = var_2_10004.gametip.help_shipinfo_hunting.tip
	...
	local var_5_8 = var_2.UIMgr.GetInstance()

	var_2.BlurPanel(var_5_8, arg_5_0.huntingRange)
...
function var_0_1.UpdateHuntingRange(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0 = 0, var_8_0.childCount - 1 do
		...
		var_1_10009(var_8_1:Find("activate"), false)
	end
	...
	var_5.each(var_8_2, function(arg_9_0)
		...
		if var_4.GetChild(var_9_4, var_9_3) and var_9_3 ~= 24 then
			...
			var_2_10005(var_4:Find("activate"), true)
		end

		return
	end)

	local var_8_3 = arg_8_0.huntingRange
	local var_8_4 = var_5.Find(var_8_3, "frame/last")
	local var_8_5 = arg_8_0.huntingRange
	local var_8_6 = var_6.Find(var_8_5, "frame/next")

	setActive = var_8_3

	var_8_3(var_8_4, arg_8_2 > 1)
	...
	var_8_3(var_8_7, arg_8_2 < #arg_8_1.getConfig(var_8_8, "hunting_range"))

	setText = var_8_3

	var_8_3(arg_8_0.showLevel, "Lv." .. arg_8_2)
	...
	var_8_3(var_8_9, var_8_10, var_8_11, var_8_8)

	onButton = var_8_3

	local var_8_12 = arg_8_0
	local var_8_13 = var_8_6
	...
	var_8_3(var_8_12, var_8_13, var_8_14, var_8_8)
