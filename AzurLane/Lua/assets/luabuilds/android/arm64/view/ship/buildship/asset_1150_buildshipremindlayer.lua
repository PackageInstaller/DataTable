...
function var_0_1.init(arg_3_0)
	...
	local var_3_2 = var_3_1:Find("top/bg/infomation/title")

	i18n = var_1_10005

	var_1_10002(var_3_2, var_1_10005("title_info"))

	arg_3_0.btnBack = var_3_1:Find("top/btnBack")
	arg_3_0.btnConfirm = var_3_1:Find("button_container/confirm")
	setText = var_2

	local var_3_3 = arg_3_0.btnConfirm
	local var_3_4 = var_4.Find(var_3_3, "pic")

	i18n = var_5

	var_2(var_3_4, var_5("text_confirm"))

	local var_3_5 = var_3_1
	local var_3_6 = var_3_1.Find(var_3_5, "item_panel")

	setText = var_3_0

	local var_3_7 = var_3_6:Find("word/Text")

	i18n = var_3_3

	var_3_0(var_3_7, var_3_3("last_building_not_shown"))

	arg_3_0.toggleLock = var_3_6:Find("lock_toggle")

	local var_3_8 = var_3_6:Find("scrollview")

	UIItemList = var_3_5
	arg_3_0.shipItemList = var_3_5.New(var_3_8, var_3_8:Find("item_tpl"))

	local var_3_9 = arg_3_0.shipItemList

	var_4.make(var_3_9, function(arg_4_0, arg_4_1, arg_4_2)
		arg_4_1 = arg_4_1 + 1
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			var_5(var_4_2, var_4_3, var_4_4, var_10)
			...
			local function var_4_7()
				...
				BuildShipRemindMediator = var_3_10003

				var_6_1(var_6_0, var_3_10003.SHOW_NEW_SHIP, var_4_0)
			...
			var_5(var_4_5, var_4_6, var_4_7, var_10)
		end
	...
	if arg_11_0.isLockNew then
		...
		if #var_2.value(var_11_4) > 0 then
			...
			var_3.insert(var_11_0, function(arg_14_0)
				...
				BuildShipRemindMediator = var_2_10004

				local var_14_2 = var_2_10004.ON_LOCK
				local var_14_3 = var_0

				Ship = var_2_10006

				var_14_1(var_14_0, var_14_2, var_14_3, var_2_10006.LOCK_STATE_LOCK, arg_14_0)
