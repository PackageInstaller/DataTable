...
function var_0_0.step(arg_8_0)
	...
	local var_8_4 = var_8_3(var_8_2, var_1_10005(0, 0, -10))
	local var_8_5 = var_1
	...
	local var_8_7 = var_8.width

	Screen = var_9

	local var_8_8 = var_8_6(var_8_5, var_1_10006(var_8_7, var_9.height, -10))

	Screen = var_8_2

	local var_8_9 = var_8_2.width / (var_8_8.x - var_8_4.x)
...
function var_0_0.createDrags(arg_10_0)
	...
	for iter_10_0 = 1, #arg_10_0._bounds do
		...
		var_1_10007(var_10_1, var_1_10010(var_1_10012))

		SetParent = var_1_10007

		var_1_10007(var_1_10006, arg_10_0._container)

		table = var_1_10007
		var_1_10007 = var_1_10007.insert

		local var_10_2 = arg_10_0._dragsUI

		tf = var_1_10010

		var_1_10007(var_10_2, var_1_10010(var_1_10006))

		var_1_10006.name = var_10_0.name
		setText = var_1_10007
		findTF = var_10_2

		var_1_10007(var_10_2(var_1_10006, "ad/text"), var_10_0.name)

		setActive = var_1_10007
		findTF = var_9

		var_1_10007(var_9(var_1_10006, "ad/text"), false)

		var_1_10007 = var_10_0.name
		var_1_10010 = arg_10_0

		arg_10_0.getDragBoundUI(var_1_10010, var_1_10007, function(arg_11_0)
			local var_11_0

			if arg_10_0._tf then
				tf = var_11_0
				var_11_0 = var_11_0(arg_11_0)
				arg_11_0.name = var_1_10007
				findTF = var_2
				...
				local var_11_3 = var_3.GetOffset(var_11_2, var_1_10007)
				local var_11_4 = arg_10_0

				var_11_0.localScale, var_11_0.anchoredPosition = var_4.GetScale(var_11_4, var_1_10007), var_11_3
				setActive = var_11_2

				var_11_2(var_11_0, true)

				setText = var_11_2
				findTF = var_7

				local var_11_5 = var_7(var_11_0, "Image/Text")

				tostring = var_8

				var_11_2(var_11_5, var_8(iter_10_0))
			else
				Destroy = var_11_0
...
function var_0_0.clearDrags(arg_21_0)
	if arg_21_0._dragsUI and #arg_21_0._dragsUI > 0 then
		for iter_21_0 = 1, #arg_21_0._dragsUI do
			...
			var_1_10005(var_1_10007(var_21_0, var_1_10010(var_1_10012)))
