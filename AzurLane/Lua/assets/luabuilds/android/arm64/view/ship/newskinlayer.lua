...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	if var_3.bg then
		...
		if not var_2_3 or not ("bg/star_level_bg_" .. var_2_3) then
			...
			local var_2_6 = var_1_10012.IsBluePrintGroup(var_4)

			ShipGroup = var_1_10013
			var_2_3 = var_2_4 .. var_1_10009(var_2_5, var_2_6, var_1_10013.IsMetaGroup(var_4))
		end
...
function var_0_1.init(arg_3_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0._skinName = var_3_8(var_3_7, var_4(var_1_10006))
...
function var_0_1.setSkin(arg_7_0, arg_7_1)
	...
	arg_7_0.cg = var_1_10002(var_7_0, var_1_10005(var_1_10007))
	...
	local var_7_4 = var_7_3(var_7_2, var_5(var_1_10007))

	Color = var_3
	var_7_4.color = var_3.New(0, 0, 0, 1)
...
function var_0_1.setSkinPri(arg_9_0, arg_9_1)
	...
	var_9_1.layer = var_1_10003.NameToLayer("UI")

	local var_9_2 = var_9_1.transform

	Vector3 = var_9_0
	var_9_2.localPosition = var_9_0(0, 0, -10)
	setParent = var_9_2
	...
	SFX_UI_DOCKYARD_CHARGET = var_6

	var_9_4(var_9_3, var_6)
	...
	local var_9_7 = var_9_6(var_9_5, var_6(var_8))

	Color = var_4
	var_9_7.color = var_4.New(0, 0, 0, 0)
	...
	local var_9_8 = var_3.ship_skin_template[arg_9_1].ship_group

	pg = var_4

	local var_9_9 = var_4.ship_data_statistics[arg_9_0._skinConfig.ship_group * 10 + 1]
	local var_9_10

	if arg_9_0._skinConfig.bg_sp and arg_9_0._skinConfig.bg_sp ~= "" then
		var_9_10 = arg_9_0._skinConfig.bg_sp

		goto label_9_2
	end

	if arg_9_0._skinConfig.bg then
		local var_9_11 = #arg_9_0._skinConfig.bg

		if not (0 < var_9_11) or not arg_9_0._skinConfig.bg then
			::label_9_0::

			if arg_9_0._skinConfig.rarity_bg then
				::label_9_1::

				var_9_11 = #arg_9_0._skinConfig.rarity_bg
				var_9_10 = 0 < var_9_11 and arg_9_0._skinConfig.rarity_bg
			end
		end
		...
		if var_9_10 then
			...
			local var_9_12 = var_9_11.DynamicBgMgr.GetInstance()

			var_9_11.LoadBg(var_9_12, arg_9_0, var_9_10, arg_9_0._bg, arg_9_0._staticBg, function(arg_11_0)
			...
			var_9_11 = "newshipbg/bg_"
			shipRarity2bgPrint = var_7

			local var_9_13 = var_9_9.rarity

			ShipGroup = var_1_10010

			local var_9_14 = var_1_10010.IsBluePrintGroup(var_9_8)

			ShipGroup = var_1_10011

			local var_9_15 = var_9_11 .. var_7(var_9_13, var_9_14, var_1_10011.IsMetaGroup(var_9_8))

			GetSpriteFromAtlasAsync = var_9_11

			var_9_11(var_9_15, "", function(arg_13_0)
		...
		setPaintingPrefabAsync = var_9_11

		var_9_11(arg_9_0._paintingTF, arg_9_0._skinConfig.painting, "huode")

		local var_9_16 = arg_9_0._skinName

		i18n = var_7
		var_9_16.text = var_7("ship_newSkin_name", arg_9_0._skinConfig.name)
		...
		local var_9_20 = var_9.RawGetWord
		local var_9_21 = arg_9_1

		ShipWordHelper = var_1_10012

		local var_9_22, var_9_24, var_9_26

		if var_9_20(var_9_21, var_1_10012.WORD_TYPE_UNLOCK) == "" then
			ShipWordHelper = var_9_22
			var_9_22 = var_9_22.GetWordAndCV

			local var_9_23 = arg_9_1

			ShipWordHelper = var_12

			local var_9_25

			var_9_22, var_9_24, var_9_25 = var_9_22(var_9_23, var_12.WORD_TYPE_DROP)
			var_9_26 = var_9_25
			var_9_19 = var_9_24

			local var_9_27 = var_9_22
		else
			ShipWordHelper = var_9_22
			var_9_22 = var_9_22.GetWordAndCV

			local var_9_28 = arg_9_1

			ShipWordHelper = var_12

			local var_9_29

			var_9_22, var_9_24, var_9_29 = var_9_22(var_9_28, var_12.WORD_TYPE_UNLOCK)
			var_9_26 = var_9_29
			var_9_19 = var_9_24

			local var_9_30 = var_9_22
		end

		setWidgetText = var_9_22

		local var_9_31 = arg_9_0._dialogue

		SwitchSpecialChar = var_12

		var_9_22(var_9_31, var_12(var_9_26, true), "desc/Text")

		local var_9_32 = arg_9_0._dialogue.transform

		Vector3 = var_9_24
		var_9_32.localScale = var_9_24(0, 1, 1)
		SetActive = var_9_32

		var_9_32(arg_9_0._dialogue, false)

		SetActive = var_9_32

		var_9_32(arg_9_0._dialogue, true)

		LeanTween = var_9_32

		local var_9_33 = var_9_32.scale
		local var_9_34 = arg_9_0._dialogue

		Vector3 = var_12

		local var_9_35 = var_9_33(var_9_34, var_12(1, 1, 1), 0.1)
		local var_9_36 = var_9.setOnComplete

		System = var_12

		var_9_36(var_9_35, var_12.Action(function()
			setActive = var_2_10000
...
function var_0_1.showExitTip(arg_15_0)
	...
	i18n = var_1_10005
	var_15_2.content = var_1_10005("give_up_cloth_change")
...
function var_0_1.didEnter(arg_17_0)
	...
	pg = var_1_10002
	arg_17_0.shipName = var_1_10002.ship_skin_template[var_17_0].name
	onButton = var_2
	...
	var_2(var_17_1, var_17_2, var_17_3, var_1_10007)
	...
	local function var_17_6()
		...
		var_19_1(var_19_0, var_2_10003.ShareMgr.TypeNewSkin)
	...
	var_2(var_17_4, var_17_5, var_17_6, var_1_10007)
	...
	var_2(var_17_7, var_17_8, var_17_9, var_1_10007)
...
function var_0_1.GetShips(arg_21_0, arg_21_1)
	...
	local var_21_2 = var_1_10003.sort
	local var_21_3 = var_21_1

	CompareFuncs = var_1_10006

	var_21_2(var_21_3, var_1_10006({
		function(arg_22_0)
...
function var_0_1.onSwitch(arg_28_0, arg_28_1, arg_28_2)
	...
	var_1_10003(arg_28_0, arg_28_1, function()
		if arg_28_2 then
			...
			var_29_2(var_29_1, var_2_10003("err_cloth_change_noship", arg_28_0.shipName))
		end
...
function var_0_1.paintView(arg_30_0)
	...
	if not var_30_16(var_1_10017(var_4)) then
		LeanTween = var_30_17
		var_30_17 = var_30_17.moveX
		rtf = var_17

		local var_30_18 = var_30_17(var_17(var_4), 150, 0.5)

		var_30_17 = var_30_17.setEase
		LeanTweenType = var_18

		var_30_17(var_30_18, var_18.easeInOutSine)
	end
	...
	var_30_20:AddDragFunc(function(arg_34_0, arg_34_1)
		if var_30_21 then
			...
			local var_34_1 = var_2_10003(arg_30_0._paintingTF)
	...
	var_19(var_30_23, var_30_24, var_30_25, var_1_10024)
	...
	function var_0_1.hidePaintView(arg_36_0, arg_36_1)
		...
		var_36_1(var_4(arg_36_0._paintingTF))
...
function var_0_1.recyclePainting(arg_37_0)
	if arg_37_0._shipVO then
		...
		var_1(var_37_0, var_4.getPainting(var_37_1))
	end
...
function var_0_1.openSelectPanel(arg_38_0)
	...
	var_38_1(var_38_0, var_38_2, var_1_10005.New({
...
function var_0_1.willExit(arg_43_0)
	...
	local var_43_2 = var_1_10002.ship_data_statistics[var_43_1]

	pg = var_43_0

	local var_43_3 = var_43_0.TipsMgr.GetInstance()
	local var_43_4 = var_3.ShowTips

	i18n = var_1_10006

	local var_43_5 = var_1_10006("ship_newSkinLayer_get", var_43_2.name, arg_43_0._skinConfig.name)

	COLOR_GREEN = var_1_10007

	var_43_4(var_43_3, var_43_5, var_1_10007)
