...
function var_0_1.register(arg_1_0)
	...
	CollectionScene = var_6

	var_1_17(var_1_16, var_6.GET_AWARD, function(arg_2_0, arg_2_1, arg_2_2)
		local var_2_0 = arg_1_0
		local var_2_1 = var_3.sendNotification

		GAME = var_2_10006

		var_2_1(var_2_0, var_2_10006.COLLECT_GET_AWARD, {
			id = arg_2_1,
			index = arg_2_2
		})
	...
	var_1_19(var_1_18, var_6.SHOW_DETAIL, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_3_2, var_2_10007.SHIP_PROFILE, {
			showTrans = arg_3_1,
			groupId = arg_3_2
		})
	...
	var_1_21(var_1_20, var_6.ACTIVITY_OP, function(arg_4_0, arg_4_1)
		local var_4_0 = arg_1_0
		local var_4_1 = var_2.sendNotification

		GAME = var_2_10005

		var_4_1(var_4_0, var_2_10005.ACTIVITY_OPERATION, arg_4_1)
	...
	var_1_23(var_1_22, var_6.BEGIN_STAGE, function(arg_5_0, arg_5_1)
		local var_5_0 = arg_1_0
		local var_5_1 = var_2.sendNotification

		GAME = var_2_10005

		var_5_1(var_5_0, var_2_10005.BEGIN_STAGE, arg_5_1)
	...
	var_1_25(var_1_24, var_6.ON_INDEX, function(arg_6_0, arg_6_1)
	...
	var_1_27(var_1_26, var_6.hasFinish(var_1_28))
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	CollectionProxy = var_8_0

	if var_8_1 == var_8_0.AWARDS_UPDATE then
		...
		if var_8_1 == var_4.COLLECT_GET_AWARD_DONE then
			...
			local var_8_7 = arg_8_0.collectionProxy

			var_8_6(var_8_5, var_1_10007.hasFinish(var_8_7))
			...
			var_8_6(var_8_8, var_1_10007.ON_ACHIEVE, var_8_2.items)
		else
			PlayerProxy = var_8_6

			if var_8_1 == var_8_6.UPDATED then
				local var_8_9 = arg_8_0.viewComponent

				var_4.setPlayer(var_8_9, var_8_2)
			else
				GAME = var_4

				if var_8_1 == var_4.BEGIN_STAGE_DONE then
					local var_8_10 = arg_8_0
					local var_8_11 = arg_8_0.sendNotification

					GAME = var_1_10007

					local var_8_12 = var_1_10007.GO_SCENE

					SCENE = var_1_10008

					var_8_11(var_8_10, var_8_12, var_1_10008.COMBATLOAD, var_8_2)
				elseif var_8_1 == var_0_1.EVENT_OBTAIN_SKIP then
					local var_8_13 = arg_8_0.viewComponent

					var_4.skipIn(var_8_13, var_8_2.toggle, var_8_2.displayGroupId)
				end
			end
		end
	end
