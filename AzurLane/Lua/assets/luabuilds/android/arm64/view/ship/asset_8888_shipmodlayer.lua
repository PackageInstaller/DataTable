...
function var_0_1.init(arg_4_0)
	...
	local var_4_5 = var_3.Find(var_4_4, "bg/add_ship_panel/title/tip")

	i18n = var_4

	var_1(var_4_5, var_4("ship_mod_exp_to_attr_tip"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local var_5_2 = var_4.Find(var_5_1, "ok_btn")
	...
	local function var_5_3()
		local function var_6_0()
			...
			if not arg_5_0.contextData.materialShipIds or #arg_5_0.contextData.materialShipIds == 0 then
				...
				var_7_4(var_7_3, var_3_10005("word_materal_no_enough"))
		...
		if var_1.isActivityNpc(var_6_1) then
			...
			i18n = var_2_10005
			var_6_4.content = var_2_10005("npc_strength_tip")
	...
	local var_5_6 = var_4.Find(var_5_5, "cancel_btn")
	...
	local var_5_10 = var_4.Find(var_5_9, "select_btn")

	local function var_5_11()
		local var_9_0 = arg_5_0
		local var_9_1 = var_0.emit

		ShipModMediator = var_2_10003

		var_9_1(var_9_0, var_2_10003.ON_AUTO_SELECT_SHIP)
...
function var_0_1.blurPanel(arg_10_0, arg_10_1)
	if arg_10_1 then
		...
		var_10_4[1] = var_8.Find(var_10_5, "bg")
...
function var_0_1.startModShip(arg_11_0)
	if not arg_11_0.hasAddition then
		...
		var_1_10004 = {}
		i18n = var_1_10005
		var_1_10004.content = var_1_10005("ship_mod_no_addition_tip")

		function var_1_10004.onYes()
			local var_12_0 = arg_11_0
			local var_12_1 = var_0.emit

			ShipModMediator = var_2_10003

			var_12_1(var_12_0, var_2_10003.MOD_SHIP, arg_11_0.shipVO.id)
		...
		ShipModMediator = var_1_10004

		var_11_3(var_11_2, var_1_10004.MOD_SHIP, arg_11_0.shipVO.id)
	end
...
function var_0_1.clearAllShip(arg_14_0)
	for iter_14_0 = 1, var_0_2 do
		...
		var_1_10006(var_14_1:Find("IconTpl"), false)

		onButton = var_1_10006

		local var_14_2 = arg_14_0
		local var_14_3 = var_14_1
		local var_14_4 = var_14_1.Find(var_14_3, "add")
		...
		local function var_14_5()
			...
			var_15_1(var_15_0, var_2_10003.ON_SELECT_MATERIAL_SHIPS)
		...
		var_1_10006(var_14_2, var_14_4, var_14_5, var_14_3)
	end
...
function var_0_1.initSelectedShips(arg_16_0)
	...
	for iter_16_0 = 1, var_0_2 do
		...
		if iter_16_0 <= var_16_1 then
			...
			local var_16_6 = var_16_3.Find(var_16_5, "add")
			...
			local function var_16_7()
				...
				var_17_1(var_17_0, var_2_10003.ON_SELECT_MATERIAL_SHIPS)
			...
			var_1_10008(var_16_4, var_16_6, var_16_7, var_16_5)
		end

		setActive = var_1_10008

		var_1_10008(var_16_3:Find("IconTpl"), iter_16_0 <= var_16_1)
	end
...
function var_0_1.updateShip(arg_18_0, arg_18_1, arg_18_2)
	...
	local function var_18_3()
		...
		for iter_19_0, iter_19_1 in var_2_10000(arg_18_0.contextData.materialShipIds) do
			if arg_18_2 == iter_19_1 then
				...
				var_2_10006(var_8.Find(var_19_2, "IconTpl"), false)
				...
				local function var_19_5()
					...
					ShipModMediator = var_3_10003

					var_20_1(var_20_0, var_3_10003.ON_SELECT_MATERIAL_SHIPS)
				...
				var_2_10006(var_19_3, var_19_4, var_19_5, var_11)

				table = var_2_10006

				var_2_10006.remove(arg_18_0.contextData.materialShipIds, iter_19_0)

				local var_19_6 = arg_18_0

				var_2_10006.updateAttrs(var_19_6)
	...
	var_1_10004(var_18_1, var_18_2, var_18_3, var_1_10009)
...
function var_0_1.initAttrs(arg_21_0)
	arg_21_0.attrTFs = {}
	pairs = var_1
	ShipModAttr = var_1_10003

	for iter_21_0, iter_21_1 in var_1(var_1_10003.ID_TO_ATTR) do
...
function var_0_1.updateAttr(arg_23_0, arg_23_1)
	...
	local var_23_4 = var_23_3(var_23_2, var_1_10007(var_1_10009))

	ShipModAttr = var_23_0

	local var_23_5 = var_23_0.ID_TO_ATTR[arg_23_1]
	...
	local var_23_9 = var_7(var_9.getShipProperties(var_23_8))
	...
	local var_23_14 = var_11.max
	local var_23_15 = arg_23_0.shipVO
	local var_23_16 = var_23_14(var_13.getModExpRatio(var_23_15, var_23_5), 1)
	...
	local var_23_20 = var_23_17.max

	math = var_16

	local var_23_21 = var_16.min

	math = var_1_10018

	local var_23_22 = var_23_20(var_23_21(var_1_10018.floor((var_23_19 + var_23_11) / var_23_16), var_23_18 - var_23_9[var_23_5]), 0)
	...
	local var_23_23 = var_23_1:Find("info_container/name")

	AttributeType = var_18

	var_15(var_23_23, var_18.Type2Name(var_23_5))
	...
	local var_23_24 = var_23_1:Find("prev_slider")
	local var_23_25 = var_15.GetComponent

	typeof = var_18
	Slider = var_20

	local var_23_26 = var_23_25(var_23_24, var_18(var_20))

	arg_23_0:setSliderValue(var_23_26, (var_23_11 + var_23_19) / var_23_16)

	local var_23_27 = var_23_19 / var_23_16
	local var_23_28 = var_23_19 + var_23_11 .. "/" .. var_23_13
	...
	local var_23_29 = var_23_1:Find("cur_slider")
	local var_23_30 = var_18.GetComponent

	typeof = var_21
	Slider = var_1_10023

	local var_23_31 = var_23_30(var_23_29, var_21(var_1_10023))

	arg_23_0:setSliderValue(var_23_31, var_23_27)

	setText = var_19

	var_19(var_2:Find("exp_container/Text"), var_23_28)
...
function var_0_1.modAttrAnim(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	local var_24_2 = var_1_10006(arg_24_2:getShipProperties())
	...
	for iter_24_0, iter_24_1 in var_7(arg_24_0.attrTFs) do
		...
		if var_24_3 == 0 then
			...
			local var_24_15 = var_24_14(var_24_13, var_1_10025(var_1_10027))

			var_1_10025 = var_24_12
			...
			local var_24_17 = var_24_16(var_1_10025, var_1_10026(var_1_10028))
			local var_24_18 = arg_24_0.getRemainExp(arg_24_1, var_1_10012)

			var_1_10027 = var_16
			var_1_10025 = var_16.Find(var_1_10027, "info_container/addition")
			var_1_10028 = var_15
			var_1_10026 = var_15.Find(var_1_10028, "exp_container/Text")

			arg_24_0:setSliderValue(var_24_17, 0)

			setText = var_1_10027

			var_1_10027(var_15:Find("exp_container/Text"), var_24_18 .. "/" .. var_24_10)

			function var_1_10027(arg_25_0, arg_25_1)
				setText = var_2_10002
			...
			if 1 <= var_24_9 then
				var_1_10028 = var_24_2[var_1_10012]
				...
				arg_24_0:tweenValue(var_24_15, var_24_15.value, 1, var_24_0, nil, function(arg_26_0)
					...
					SFX_BREAK_OUT_FULL = var_2_10003

					var_27_1(var_27_0, var_2_10003)

					var_1_10028 = var_1_10028 + 1

					var_1_10027(var_1_10028, var_24_1[var_1_10012] - var_1_10028)

					if var_24_1[var_1_10012] - var_1_10028 > 0 then
						...
						var_1.tweenValue(var_27_2, var_24_15, 0, 1, var_24_0, nil, function(arg_28_0)
							...
							SFX_BREAK_OUT_FULL = var_3_10003

							var_29_1(var_29_0, var_3_10003)

							var_1_10028 = var_1_10028 + 1

							var_1_10027(var_1_10028, var_24_1[var_1_10012] - var_1_10028)

							if var_1_10028 == var_24_1[var_1_10012] then
								local var_29_2 = arg_24_0

								var_0.tweenValue(var_29_2, var_24_15, 0, var_24_18 / var_24_10, var_24_0, nil, function(arg_30_0)
						...
						var_1.tweenValue(var_27_3, var_24_15, 0, var_24_18 / var_24_10, var_24_0, nil, function(arg_32_0)
				...
				arg_24_0:tweenValue(var_24_15, var_24_15.value, var_24_18 / var_24_10, var_24_0, nil, function(arg_34_0)
...
function var_0_1.tweenValue(arg_36_0, arg_36_1, arg_36_2, arg_36_3, arg_36_4, arg_36_5, arg_36_6, arg_36_7, arg_36_8)
	...
	local var_36_3 = var_36_2(var_11(arg_36_1), arg_36_2, arg_36_3, arg_36_4)
	local var_36_4 = var_9.setOnUpdate

	System = var_12

	local var_36_5 = var_36_4(var_36_3, var_12.Action_float(function(arg_37_0)
		if arg_36_6 then
			arg_36_6(arg_37_0)
		end
	...
	local var_36_8 = var_36_7(var_36_6, var_12.Action(function()
		if arg_36_7 then
			arg_36_7()
		end
...
function var_0_1.getModExpAdditions(arg_40_0, arg_40_1)
	...
	for iter_40_0, iter_40_1 in var_1_10007(var_1_10009.ID_TO_ATTR) do
		local var_40_4 = 0
...
function var_0_1.willExit(arg_45_0)
	...
	for iter_45_0, iter_45_1 in var_1(var_45_0) do
		...
		var_1_10006(var_1_10008(iter_45_1))
	end
...
function var_0_1.onBackPressed(arg_46_0)
	...
	var_46_1(var_46_0, var_1_10004.ON_BACK_PRESSED, true)
