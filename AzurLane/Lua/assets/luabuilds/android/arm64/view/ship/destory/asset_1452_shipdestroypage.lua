...
function var_0_1.OnLoaded(arg_2_0)
	...
	function arg_2_0.cardScrollRect.onUpdateItem(arg_4_0, arg_4_1)
		...
		local var_4_3 = var_4_1(var_4_2, var_2_10006.TAG_HIDE_DESTROY)
	...
	local var_2_6 = var_3.Find(var_2_5, "frame/bg_award/label")

	i18n = var_4

	var_1(var_2_6, var_4("disassemble_available") .. ":")

	local var_2_7 = arg_2_0._tf
	local var_2_8 = var_1.Find(var_2_7, "frame/bg_award/res_list")

	UIItemList = var_2
	arg_2_0.resList = var_2.New(var_2_8, var_2_8:Find("res"))
...
function var_0_1.CalcShipsReturnRes(arg_16_0, arg_16_1)
	...
	ShipCalcHelper = var_1_10003

	return var_1_10003.CalcDestoryRes(var_16_0)
end
...
function var_0_1.RefreshRes(arg_18_0)
	...
	local var_18_3 = var_4.insert
	local var_18_4 = var_18_2
	local var_18_5 = 1

	Drop = var_1_10008

	local var_18_6 = var_1_10008.New
	local var_18_7 = {}

	DROP_TYPE_RESOURCE = var_1_10011
	var_18_7.type = var_1_10011
	PlayerConst = var_1_10011
	var_18_7.id = var_1_10011.ResOil
	...
	local var_18_11 = var_8.New
	local var_18_12 = {}

	DROP_TYPE_RESOURCE = var_11
	var_18_12.type = var_11
	PlayerConst = var_11
	var_18_12.id = var_11.ResGold
