...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	var_1_10003("bg/star_level_bg_" .. var_2_1:rarity2bgPrintForGet(arg_2_0.showTrans), "", arg_2_1)
...
function var_0_1.init(arg_6_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.labelName = var_6_14(var_6_13, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.labelEnName = var_6_17(var_6_16, var_4(var_1_10006))
	...
	arg_6_0.live2DBtn = var_6_38(var_3.Find(var_6_39, "L2D_btn"))
	arg_6_0.l2dBtnOn = false
	GetComponent = var_1

	local var_6_40 = arg_6_0.blurPanel
	local var_6_41 = var_3.Find(var_6_40, "L2D_btn")

	typeof = var_4
	Image = var_6

	local var_6_42 = var_1(var_6_41, var_4(var_6))
	...
	local var_6_44 = var_3.Find(var_6_43, "L2D_btn/img")

	typeof = var_4
	Image = var_6

	local var_6_45 = var_1(var_6_44, var_4(var_6))
	...
	local var_6_48 = var_1(var_6_47, var_4(var_6))
	...
	local var_6_50 = var_3.Find(var_6_49, "SP_btn/img")

	typeof = var_4
	Image = var_6

	local var_6_51 = var_1(var_6_50, var_4(var_6))
	...
	local var_6_53 = var_3.Find(var_6_52, "adapt/top/title")

	typeof = var_4
	Image = var_6

	local var_6_54 = var_1(var_6_53, var_4(var_6))
	...
	local var_6_64 = var_5.Find(var_6_63, "scroll/Viewport/skin_container")
	local var_6_65 = arg_6_0.leftProfile

	arg_6_0.UISkinList = var_6_62(var_6_64, var_6.Find(var_6_65, "scroll/Viewport/skin_container/skin_tpl"))
...
function var_0_1.didEnter(arg_8_0)
	...
	local function var_8_5()
		...
		ShipProfileMediator = var_2_10003

		var_10_1(var_10_0, var_2_10003.OPEN_EQUIP_CODE_SHARE, arg_8_0.shipGroup.id)
	...
	local function var_8_8()
		...
		var_11_1(var_11_0, var_2_10003.OPEN_CRYPTOLALIA, arg_8_0.shipGroup.id)
	...
	local function var_8_14()
		...
		if var_2_10000.isTweening(arg_8_0.chatTF.gameObject) then
			...
			Vector3 = var_2_10001
			var_14_0.localScale = var_2_10001(0, 0, 0)
	...
	local function var_8_17()
		...
		var_15_1(var_15_0, var_2_10003.ShareMgr.TypeShipProfile)
	...
	local function var_8_20()
		...
		ShipProfileMediator = var_3

		var_16_1(var_16_0, var_3.CLICK_ROTATE_BTN, arg_8_0.shipGroup, arg_8_0.showTrans, arg_8_0.skin)
	...
	for iter_8_0, iter_8_1 in var_1(arg_8_0.toggles) do
		...
		var_1_10006(var_8_22, var_8_23, var_8_24, var_1_10011)
	end
	...
	local function var_8_28()
		...
		if var_2_10001.IsChangeSkin(var_19_0.id) then
			...
			local var_19_2 = var_2_10002.ship_skin_template[var_19_1]
	...
	var_1(var_8_26, var_8_27, var_8_28, var_1_10006)
...
function var_0_1.InitSkinList(arg_20_0)
	...
	var_1.make(var_20_0, function(arg_21_0, arg_21_1, arg_21_2)
		...
		if arg_21_0 == var_2_10003.EventUpdate then
			...
			var_2_10005.insert(arg_20_0.skinBtns, var_21_1)
			...
			var_21_3(var_21_2, var_21_4, var_21_5, var_2_10010.contains(arg_20_0.ownedSkinList, var_21_0.id))
			...
			local function var_21_8()
				if not var_21_1.unlock then
					...
					var_22_1(var_22_0, var_3_10003("ship_profile_skin_locked"))
			...
			var_21_3(var_21_6, var_21_7, var_21_8, var_10)
...
function var_0_1.showSkinProfile(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	var_1_10005(arg_23_0.btnChangeSkin, var_23_0)
	...
	if var_23_0 then
		...
		var_5(var_23_2, not var_8.IsAsmrSkin(var_23_3))
	end
...
function var_0_1.InitCommon(arg_24_0)
	...
	var_24_1(var_24_0, var_4.rarity2bgPrintForGet(var_24_2, arg_24_0.showTrans))
	...
	var_24_1(var_24_3, var_4(var_24_4, var_7.getShipType(var_24_5, arg_24_0.showTrans)))
...
function var_0_1.SetPainting(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_0 = var_3.ship_skin_template[arg_25_1].painting

	setPaintingPrefabAsync = var_1_10004

	var_1_10004(arg_25_0.painting, var_25_0, "chuanwu", function()
		setActive = var_2_10000
...
function var_0_1.LoadSkinBg(arg_29_0, arg_29_1)
	...
	if arg_29_0.shipSkinBg ~= arg_29_1 then
		...
		local function var_29_4(arg_30_0)
			...
			Vector3 = var_2_10002
			var_30_0.localPosition = var_2_10002(0, 0, 200)
			rtf = var_30_0
		...
		local function var_29_5()
			...
			var_31_1(var_31_0, var_31_2 .. var_4.getRarity(var_31_3, arg_29_0.showTrans), true, function(arg_32_0)
				...
				Vector3 = var_2
				var_32_4.localPosition = var_2(1, 1, 1)
				...
				var_1(var_32_7, var_4.PAINTING_RARITY_DESIGN_LAYER)
		...
		local function var_29_6()
			...
			var_33_1(var_33_0, var_33_2 .. var_4.getRarity(var_33_3, arg_29_0.showTrans), true, function(arg_34_0)
				...
				Vector3 = var_2
				var_34_4.localPosition = var_2(1, 1, 1)
...
function var_0_1.TweenPage(arg_43_0, arg_43_1)
	if arg_43_1 == var_0_1.INDEX_DETAIL then
		...
		rtf = var_1_10004
		var_1_10004 = var_43_0(var_1_10004(arg_43_0.leftProfile), -700, var_0_2)

		local var_43_1 = var_2.setEase

		LeanTweenType = var_5

		var_43_1(var_1_10004, var_5.easeInOutSine)
		...
		rtf = var_1_10004
		var_1_10004 = var_43_2(var_1_10004(arg_43_0.live2DBtn._tf), -70, var_0_2)

		local var_43_3 = var_2.setEase

		LeanTweenType = var_5

		var_43_3(var_1_10004, var_5.easeInOutSine)
		...
		rtf = var_1_10004
		var_1_10004 = var_43_4(var_1_10004(arg_43_0.spinePaintingBtn), -70, var_0_2)

		local var_43_5 = var_2.setEase

		LeanTweenType = var_5

		var_43_5(var_1_10004, var_5.easeInOutSine)
		...
		rtf = var_1_10004
		var_1_10004 = var_43_6(var_1_10004(arg_43_0.painting), arg_43_0.paintingInitPos.x, var_0_2)

		local var_43_7 = var_2.setEase

		LeanTweenType = var_5

		var_43_7(var_1_10004, var_5.easeInOutSine)
		...
		rtf = var_1_10004
		var_1_10004 = var_43_8(var_1_10004(arg_43_0.name), arg_43_0.nameInitPos.x, var_0_2)

		local var_43_9 = var_2.setEase

		LeanTweenType = var_5

		var_43_9(var_1_10004, var_5.easeInOutSine)
	elseif arg_43_1 == var_0_1.INDEX_PROFILE then
		...
		local var_43_11 = var_43_10(var_1_10004(arg_43_0.leftProfile), 0, var_0_2)
		local var_43_12 = var_2.setEase

		LeanTweenType = var_5

		var_43_12(var_43_11, var_5.easeInOutSine)
		...
		var_43_15(var_43_14, var_5.easeInOutSine)
		...
		var_43_18(var_43_17, var_5.easeInOutSine)
		...
		var_43_21(var_43_20, var_5.easeInOutSine)
		...
		var_43_24(var_43_23, var_5.easeInOutSine)
	end
...
function var_0_1.ShiftSkin(arg_44_0, arg_44_1)
	...
	var_3("ui/share/btn_l2d_atlas", var_44_3, function(arg_45_0)
		GetComponent = var_2_10001

		local var_45_0 = arg_44_0.blurPanel
		local var_45_1 = var_3.Find(var_45_0, "L2D_btn")

		typeof = var_2_10004
		Image = var_6

		local var_45_2 = var_2_10001(var_45_1, var_2_10004(var_6))

		var_45_2.sprite = arg_45_0
		GetComponent = var_45_2

		local var_45_3 = arg_44_0.blurPanel
		local var_45_4 = var_3.Find(var_45_3, "L2D_btn/img")

		typeof = var_4
		Image = var_6

		local var_45_5 = var_45_2(var_45_4, var_4(var_6))

		var_45_5.sprite = arg_45_0
		GetComponent = var_45_5

		local var_45_6 = arg_44_0.blurPanel
		local var_45_7 = var_3.Find(var_45_6, "L2D_btn")

		typeof = var_4
		Image = var_6

		local var_45_8 = var_45_5(var_45_7, var_4(var_6))
		...
		local var_45_10 = var_3.Find(var_45_9, "L2D_btn/img")

		typeof = var_4
		Image = var_6

		local var_45_11 = var_1(var_45_10, var_4(var_6))
	...
	arg_44_0.DestroySpinePainting(var_44_4)

	local var_44_5 = arg_44_0.pages[var_0_1.INDEX_PROFILE]

	var_3.ExecuteAction(var_44_5, "Flush", arg_44_1, false)

	local var_44_6

	PlayerPrefs = var_44_4

	local var_44_7 = var_44_4.GetInt("paint_hide_other_obj_" .. arg_44_0.skin.painting, 0) == 0

	if arg_44_0.skin.bg_sp and arg_44_0.skin.bg_sp ~= "" and var_44_7 then
		var_44_6 = arg_44_0.skin.bg_sp
	elseif arg_44_0.skin.bg and arg_44_0.skin.bg ~= "" then
		var_44_6 = arg_44_0.skin.bg
	else
		local var_44_8 = arg_44_0.shipGroup

		var_44_6 = var_6.rarity2bgPrintForGet(var_44_8, arg_44_0.showTrans, arg_44_0.skin.id)
	end

	arg_44_0:LoadSkinBg(var_44_6)
...
function var_0_1.UpdateCryptolaliaBtn(arg_46_0, arg_46_1)
	...
	local var_46_3 = var_1_10007(var_1_10009)
	local var_46_4 = var_7.getRawData(var_46_3)

	var_4(var_46_2, var_7.ExistCryptolalia(var_46_4, var_46_1))
...
function var_0_1.LoadModel(arg_47_0, arg_47_1)
	...
	var_3:Load(true, function(arg_48_0)
		...
		var_48_3(var_48_2, var_4(0.8, 0.8, 1))
...
function var_0_1.CreateLive2D(arg_50_0)
	...
	local var_50_4 = var_1_10002.ship_skin_template[arg_50_0.skin.id].live2d_offset_profile
	local var_50_5
	local var_50_6
	...
	Live2DPainting = var_50_6

	local var_50_9 = var_50_6.GenerateData
	local var_50_10 = {}

	Ship = var_1_10007
	var_50_10.ship = var_1_10007.New({
		noChangeSkin = true,
		configId = var_50_3,
	...
	Vector3 = var_7
	var_50_10.position = var_7(0, 0, 0)
	var_50_10.offset = var_50_4
	var_50_10.parent = arg_50_0.l2dRoot

	local var_50_11 = var_50_9(var_50_10)

	Live2DPainting = var_1_10005
	arg_50_0.l2dChar = var_1_10005.New(var_50_11, function(arg_51_0)
...
function var_0_1.OnCVBtnClick(arg_53_0, arg_53_1)
	...
	elseif arg_53_1.voice.resource_key == "get" then
		...
		if var_1_10005.GetSkinShowAble(var_53_2) then
			...
			ShipProfileMediator = var_1_10008

			var_53_4(var_53_3, var_1_10008.OPEN_PAINTING_SHOW, var_53_2, function()
...
function var_0_1.UpdatePaintingFace(arg_63_0, arg_63_1)
	...
	if 0 < var_63_2 then
		...
		var_63_3(var_7.GetChild(var_63_4, 0), arg_63_0.paintingName, var_63_1, var_2.maxfavor, arg_63_1.skin.id)
	end
	...
	if arg_63_0.spinePainting then
		...
		if var_6.GetExpression(arg_63_0.paintingName, var_63_1, var_2.maxfavor, arg_63_1.skin.id) ~= "" then
			...
			if var_7.isInAction(var_63_10) then
				...
				var_63_12(var_63_11, var_10.getIdleName(var_63_13), 0, true)
			...
			if var_7.isInAction(var_63_18) then
				...
				var_63_20(var_63_19, var_10.getIdleName(var_63_21), 0, true)
...
function var_0_1.PlayVoice(arg_66_0, arg_66_1, arg_66_2)
	...
	local var_66_3 = var_66_2.voice_key

	ShipWordHelper = var_1_10007

	if not (var_1_10007.CV_KEY_REPALCE <= var_66_3) then
		local var_66_4 = var_66_2.voice_key_2

		ShipWordHelper = var_7

		if not (var_7.CV_KEY_REPALCE <= var_66_4) then
			local var_66_5 = var_66_2.voice_key

			ShipWordHelper = var_7

			if var_66_5 == var_7.CV_KEY_BAN_NEW then
				local var_66_6 = 0

				if arg_66_1.isLive2d and arg_66_0.l2dChar and var_66_0.voiceCalibrate then
					var_66_6 = var_66_0.voiceCalibrate
				end

				local var_66_7 = arg_66_0.cvLoader

				var_7.DelayPlaySound(var_66_7, var_66_0.cvPath, var_66_6, function(arg_67_0)
					if arg_67_0 then
			...
			local var_66_8 = var_66_0.se

			if arg_66_1.isLive2d and arg_66_0.l2dChar and var_66_8 then
				local var_66_9 = arg_66_0.cvLoader

				var_7.RawPlaySound(var_66_9, "event:/ui/" .. var_66_8[1], var_66_8[2])
			end
...
function var_0_1.ShowDailogue(arg_71_0, arg_71_1, arg_71_2, arg_71_3)
	...
	local var_71_3 = var_71_2(var_71_1, var_1_10009(var_1_10011))

	setText = var_1_10007

	local var_71_4 = arg_71_0.chatText

	SwitchSpecialChar = var_1_10010

	var_1_10007(var_71_4, var_1_10010(var_4))

	local var_71_5 = #var_71_3.text

	CHAT_POP_STR_LEN = var_71_1

	if var_71_1 < var_71_5 then
		TextAnchor = var_71_5
		...
		if arg_71_0.initChatBgH < var_71_6 then
			...
			local var_71_10 = var_10(arg_71_0.chatTF.gameObject)

			Vector3 = var_11

			local var_71_11 = var_71_9(var_71_10, var_11.New(1, 1, 1), var_0_1.CHAT_ANIMATION_TIME)
			local var_71_12 = var_8.setEase

			LeanTweenType = var_11

			local var_71_13 = var_71_12(var_71_11, var_11.easeOutBack)
			local var_71_14 = var_8.setDelay(var_71_13, var_71_0 and var_71_0 or 0)
			local var_71_15 = var_8.setOnComplete

			System = var_11

			var_71_15(var_71_14, var_11.Action(function()
				LeanTween = var_2_10000
				...
				local var_73_1 = var_2_10002(arg_71_0.chatTF.gameObject)

				Vector3 = var_2_10003

				local var_73_2 = var_73_0(var_73_1, var_2_10003.New(0, 0, 1), var_0_1.CHAT_ANIMATION_TIME)
				local var_73_3 = var_0.setEase

				LeanTweenType = var_3

				local var_73_4 = var_73_3(var_73_2, var_3.easeInBack)
				local var_73_5 = var_0.setDelay(var_73_4, var_0_1.CHAT_ANIMATION_TIME + arg_71_2[1])
				local var_73_6 = var_0.setOnComplete

				System = var_3

				var_73_6(var_73_5, var_3.Action(function()
					if arg_71_0.dailogueCallback then
						arg_71_0.dailogueCallback()
...
function var_0_1.StopDailogue(arg_75_0)
	...
	Vector3 = var_1_10002
	var_75_0.localScale = var_1_10002(0, 0)
...
function var_0_1.playOpening(arg_77_0, arg_77_1)
	...
	if var_3("ui/skinunlockanim/" .. var_77_0) then
		...
		local var_77_1 = var_1_10004.CpkPlayMgr.GetInstance()
...
function var_0_1.updateSpinePaintingState(arg_80_0)
	...
	if var_1_10002(var_80_0) then
		...
		var_3(var_5.Find(var_80_1, "on"), arg_80_0.spinePaintingisOn)

		setActive = var_3

		local var_80_2 = arg_80_0.spinePaintingToggle

		var_3(var_5.Find(var_80_2, "off"), not arg_80_0.spinePaintingisOn)
		...
		local function var_80_5()
			...
			var_81_0(var_2.Find(var_81_1, "on"), arg_80_0.spinePaintingisOn)

			setActive = var_81_0

			local var_81_2 = arg_80_0.spinePaintingToggle

			var_81_0(var_2.Find(var_81_2, "off"), not arg_80_0.spinePaintingisOn)
		...
		var_3(var_80_3, var_80_4, var_80_5, var_8)
	else
		setActive = var_3
...
function var_0_1.CreateSpinePainting(arg_82_0)
	if arg_82_0.skin.id ~= arg_82_0.preSkinId then
		...
		local var_82_2 = var_2.GenerateData
		local var_82_3 = {}

		Ship = var_1_10005
		var_82_3.ship = var_1_10005.New({
			noChangeSkin = true,
			configId = var_82_1,
			skin_id = arg_82_0.skin.id
		})
		Vector3 = var_5
		var_82_3.position = var_5(0, 0, 0)
		var_82_3.parent = arg_82_0.spinePaintingRoot
		pg = var_5
		var_82_3.offset = var_5.ship_skin_template[arg_82_0.skin.id].spine_offset_profile
		var_82_3.effectParent = arg_82_0.spinePaintingBgRoot

		local var_82_4 = var_82_2(var_82_3)

		SpinePainting = var_82_0
		arg_82_0.spinePainting = var_82_0.New(var_82_4, function()
			return
		end)
