...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_1_10006
	Text = var_1_10008
	arg_1_0.label = var_1_1(var_1_0, var_1_10006(var_1_10008))
...
function var_0_0.loop(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	math = var_1_10007
	arg_2_0.timer = var_2_0(var_2_1, arg_2_2 + arg_2_3 * var_1_10007.random(), arg_2_1)
...
function var_0_0.display(arg_4_0)
	...
	Vector3 = var_1_10002
	var_4_0.localScale = var_1_10002.New(0, 0, 1)
	...
	if var_3 < var_4_2 then
		...
		local var_4_4 = var_3(arg_4_0.dialog)

		Vector3 = var_4

		local var_4_5 = var_4_3(var_4_4, var_4.New(1, 1, 1), var_0_1)
		local var_4_6 = var_1.setEase

		LeanTweenType = var_4

		var_4_6(var_4_5, var_4.easeOutBack)
		...
		local var_4_9 = var_4_7(var_4_8, var_4.New(0, 0, 1), var_0_1)
		local var_4_10 = var_1.setOnComplete

		System = var_4

		local var_4_11 = var_4_10(var_4_9, var_4.Action(function()
		...
		var_4_13(var_4_12, var_4.easeInBack)
