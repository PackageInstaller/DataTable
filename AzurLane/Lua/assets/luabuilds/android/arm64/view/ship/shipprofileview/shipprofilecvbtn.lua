...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	var_2(var_4.Find(var_1_3, "tag_common"), true)
...
function var_0_0.Init(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
	...
	if arg_2_1:getIntimacyName(var_2_0) then
		setmetatable = var_1_10007
		arg_2_0.voice = var_1_10007({
			voice_name = var_6
		}, {
			__index = arg_2_4
		})
	...
	local var_2_5
	local var_2_6
	local var_2_7 = arg_2_4.key

	string = var_1_10014

	local var_2_8 = var_1_10014.find
	local var_2_9 = var_2_7

	ShipWordHelper = var_1_10017

	local var_2_10

	if var_2_8(var_2_9, var_1_10017.WORD_TYPE_MAIN) then
		string = var_2_10
		var_2_10 = var_2_10.gsub

		local var_2_11 = var_2_7

		ShipWordHelper = var_17
		var_2_10 = var_2_10(var_2_11, var_17.WORD_TYPE_MAIN, "")
		tonumber = var_1_10015
		var_2_4 = var_1_10015(var_2_10)
		ShipWordHelper = var_15

		local var_2_12 = var_15.GetWordAndCV
		local var_2_13 = arg_2_0.skin.id

		ShipWordHelper = var_18
		var_2_1, var_2_2, var_2_3 = var_2_12(var_2_13, var_18.WORD_TYPE_MAIN, var_2_4)

		if arg_2_0.isLive2d then
			ShipWordHelper = var_15

			local var_2_14 = var_15.GetL2dCvCalibrate
			local var_2_15 = arg_2_0.skin.id

			ShipWordHelper = var_18
			var_2_5 = var_2_14(var_2_15, var_18.WORD_TYPE_MAIN, var_2_4)
			ShipWordHelper = var_15

			local var_2_16 = var_15.GetL2dSoundEffect
			local var_2_17 = arg_2_0.skin.id

			ShipWordHelper = var_18
			var_2_6 = var_2_16(var_2_17, var_18.WORD_TYPE_MAIN, var_2_4)
		end
	else
		ShipWordHelper = var_2_10
		var_2_1, var_2_2, var_2_3 = var_2_10.GetWordAndCV(arg_2_0.skin.id, var_2_7)

		if arg_2_0.isLive2d then
			ShipWordHelper = var_14
			var_2_5 = var_14.GetL2dCvCalibrate(arg_2_0.skin.id, var_2_7)
			ShipWordHelper = var_14
			var_2_6 = var_14.GetL2dSoundEffect(arg_2_0.skin.id, var_2_7)
		end
	end
...
function var_0_0.Update(arg_3_0)
	...
	if not arg_3_0.isLive2d then
		...
		var_3_3 = var_3_3(var_3_2, var_3_4 .. var_1_10008.WORD_TYPE_MAIN .. "_")
...
function var_0_0.UpdateCvBtn(arg_4_0)
	...
	var_1_10007(arg_4_0.tagDiff, var_4_6)
	...
	if not var_4_2 then
		...
		var_1_10007(var_4_7, var_4_8, var_4_9, var_1_10012)
	end
