...
function var_0_1.updateStatistics(arg_5_0)
	...
	local var_5_3 = var_1_10004(var_5_1:getShipProperties())
	local var_5_4 = arg_5_0.attrPanel

	ipairs = var_6

	for iter_5_0, iter_5_1 in var_6(var_0_2) do
		local var_5_5 = var_5_4:GetChild(iter_5_0 - 1)

		setText = var_1_10012

		local var_5_6 = var_5_5:Find("name")

		AttributeType = var_1_10015

		var_1_10012(var_5_6, var_1_10015.Type2Name(iter_5_1))

		setText = var_1_10012

		var_1_10012(var_5_5:Find("value"), var_5_3[iter_5_1])

		setText = var_1_10012

		var_1_10012(var_5_5:Find("value1"), var_5_2[iter_5_1])

		var_1_10012 = var_5_5:Find("addition")

		if var_5_2[iter_5_1] - var_5_3[iter_5_1] == 0 then
			setActive = var_14

			var_14(var_1_10012, false)
		else
			setText = var_14

			var_14(var_1_10012, "+" .. var_13)
		end
	end

	local var_5_7 = var_5_4:GetChild(5)
	local var_5_8 = var_5_1
	local var_5_9 = var_5_1.getBattleTotalExpend(var_5_8)
	local var_5_10 = var_5_0
	local var_5_11 = var_5_0.getBattleTotalExpend(var_5_10)

	setText = var_5_8

	local var_5_12 = var_5_7:Find("name")

	AttributeType = var_1_10012

	local var_5_13 = var_1_10012.Type2Name

	AttributeType = var_14

	var_5_8(var_5_12, var_5_13(var_14.Expend))

	setText = var_5_8

	var_5_8(var_5_7:Find("value"), var_5_9)

	setText = var_5_8

	var_5_8(var_5_7:Find("value1"), var_5_11)

	local var_5_14 = var_5_7
	local var_5_15 = var_5_7.Find(var_5_14, "addition")

	math = var_5_10

	if var_5_10.abs(var_5_11 - var_5_9) == 0 then
		setActive = var_5_14

		var_5_14(var_5_15, false)
	else
		setText = var_5_14

		var_5_14(var_5_15, "+" .. var_10)
	end

	local var_5_16 = var_5_0:getStar()
	local var_5_17 = var_5_1:getStar()
	local var_5_18 = arg_5_0.rarePanel
	local var_5_19 = var_13.Find(var_5_18, "stars_from")
	local var_5_20 = arg_5_0.rarePanel
	local var_5_21 = var_14.Find(var_5_20, "stars_to")

	for iter_5_2 = 1, var_5_17 do
		setActive = var_1_10019

		var_1_10019(var_5_19:GetChild(iter_5_2 - 1), true)
	end

	for iter_5_3 = 1, var_5_16 do
		setActive = var_1_10019

		var_1_10019(var_5_21:GetChild(iter_5_3 - 1), true)
	end
	...
	var_15(arg_5_0._paintingShadowTF, var_5_0:getPainting(), "chuanwu", function()
		...
		Color = var_6_0
		var_6_2.color = var_6_0.New(0, 0, 0)
		findTF = var_2
		...
		if not var_6_1(var_6_3) then
			...
			local var_6_6 = var_6_5(var_6_4, var_6(var_2_10008))

			var_6_5 = var_6_5.ToTable(var_6_6)
			ipairs = var_4

			for iter_6_0, iter_6_1 in var_4(var_6_5) do
				Color = var_2_10009
		...
		if not var_4(var_6_7) then
			local var_6_8 = var_6_7:GetComponent("Image")

			Color = var_5
			var_6_8.color = var_5.New(0, 0, 0)
		end

		return
	end)

	local var_5_22 = var_5_0:getPrefab()

	pg = var_16

	local var_5_23 = var_16.UIMgr.GetInstance()

	var_16.LoadingOn(var_5_23)

	SpineAnimChar = var_16

	local var_5_24 = var_16.New()

	var_16.SetPaint(var_5_24, var_5_22)
	var_16:Load(true, function(arg_7_0)
		...
		var_7_2(var_7_1, var_2_10004(1, 1, 1))
	...
	local var_5_25 = var_5_0:getCVIntimacy()

	ShipWordHelper = var_5_23

	local var_5_26 = var_5_23.GetWordAndCV
	local var_5_27 = var_5_0:getSkinId()

	ShipWordHelper = var_21

	local var_5_28, var_5_29, var_5_30 = var_5_26(var_5_27, var_21.WORD_TYPE_UPGRADE, nil, nil, var_5_25)

	setWidgetText = var_21

	var_21(arg_5_0._chat, var_5_30)

	local var_5_31 = arg_5_0._chat
	local var_5_32 = var_21.Find(var_5_31, "Text")
	local var_5_33 = var_21.GetComponent

	typeof = var_24
	Text = var_1_10026

	local var_5_34 = #var_5_33(var_5_32, var_24(var_1_10026)).text

	CHAT_POP_STR_LEN = var_5_32

	if var_5_32 < var_5_34 then
		TextAnchor = var_5_34

		if not var_5_34.MiddleLeft then
			TextAnchor = var_5_34
			var_5_34 = var_5_34.MiddleCenter
		end

		var_21.alignment = var_5_34

		local var_5_35 = arg_5_0._chat.transform

		Vector3 = var_5_32
		var_5_35.localScale = var_5_32(0, 0, 1)
		LeanTween = var_5_35

		local var_5_36 = var_5_35.delayedCall
		local var_5_37 = 0.6

		System = var_25
		arg_5_0.delayTId = var_5_36(var_5_37, var_25.Action(function()
			...
			local var_9_1 = var_2(arg_5_0._chat)

			Vector3 = var_3

			local var_9_2 = var_9_0(var_9_1, var_3.New(1, 1, 1), 0.3)
			local var_9_3 = var_0.setEase

			LeanTweenType = var_3

			var_9_3(var_9_2, var_3.easeOutBack)

			local var_9_4 = arg_5_0

			var_0.voice(var_9_4, var_5_29)

			return
		end)).id

		local var_5_38 = var_5_0
		local var_5_39 = var_23.isBluePrintShip(var_5_38)
		local var_5_40 = var_23:isMetaShip()

		GetSpriteFromAtlasAsync = var_5_38

		var_5_38("newshipbg/bg_" .. var_23:rarity2bgPrintForGet(), "", function(arg_10_0)
			setImageSprite = var_2_10001
		...
		if var_5_39 then
			if arg_5_0.metaBg then
				...
				var_5_38(arg_5_0.metaBg, false)
			end

			if arg_5_0.designBg and arg_5_0.designName ~= "raritydesign" .. var_23:getRarity() then
				PoolMgr = var_5_38

				local var_5_41 = var_5_38.GetInstance()

				var_5_38.ReturnUI(var_5_41, arg_5_0.designName, arg_5_0.designBg)
			...
			if not arg_5_0.designBg then
				...
				local var_5_42 = var_5_38.GetInstance()

				var_5_38.GetUI(var_5_42, "raritydesign" .. var_23:getRarity(), true, function(arg_11_0)
					...
					Vector3 = var_2
					var_11_4.localPosition = var_2(1, 1, 1)
				...
				var_5_38(arg_5_0.designBg, true)
			end
		elseif var_5_40 then
			if arg_5_0.designBg then
				setActive = var_5_38

				var_5_38(arg_5_0.designBg, false)
			end

			if arg_5_0.metaBg and arg_5_0.metaName ~= "raritymeta" .. var_23:getRarity() then
				PoolMgr = var_5_38

				local var_5_43 = var_5_38.GetInstance()

				var_5_38.ReturnUI(var_5_43, arg_5_0.metaName, arg_5_0.metaBg)
			...
			if not arg_5_0.metaBg then
				...
				local var_5_44 = var_5_38.GetInstance()

				var_5_38.GetUI(var_5_44, "raritymeta" .. var_23:getRarity(), true, function(arg_12_0)
					...
					Vector3 = var_2
					var_12_4.localPosition = var_2(1, 1, 1)
		...
		local var_5_45 = var_5_38.GetInstance()

		var_26.GetUI(var_5_45, "tupo_" .. var_23:getRarity(), true, function(arg_13_0)
			...
			Vector3 = var_2_10002
			var_13_1.localPosition = var_2_10002(1, 1, 1)
		...
		local var_5_46 = var_26.GetInstance()

		var_26.GetUI(var_5_46, var_23:isMetaShip() and "tupo_meta" or "tupo", true, function(arg_14_0)
			...
			Vector3 = var_2_10002
			var_14_1.localPosition = var_2_10002(1, 1, 1)
