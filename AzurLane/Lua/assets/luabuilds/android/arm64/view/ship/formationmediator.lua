...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.CHANGE_FLEET_NAME, function(arg_4_0, arg_4_1, arg_4_2)
		arg_1_0.commitEdit(function()
			...
			var_5_1(var_5_0, var_3_10003.RENAME_FLEET, {
				id = arg_4_1,
				name = arg_4_2
			})
	...
	arg_1_0:bind(var_0_1.OPEN_SHIP_INFO, function(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		local function var_6_0()
			...
			for iter_7_0, iter_7_1 in var_1(var_3.getShipIds(var_7_1)) do
				table = var_3_10006
	...
	arg_1_0:bind(var_0_1.ON_CHANGE_FLEET, function(arg_8_0, arg_8_1)
		arg_1_0.commitEdit(function()
			...
			var_9_1(var_9_0, var_3.GetRegularFleets(var_9_2))
	...
	arg_1_0:bind(var_0_1.CHANGE_FLEET_SHIP, function(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4)
		...
		local var_13_8 = var_2_10014.GO_SCENE

		SCENE = var_2_10015

		local var_13_9 = var_2_10015.DOCKYARD
		local var_13_10 = {
			useBlackBlock = true,
			selectedMax = 1,
			energyDisplay = true,
	...
	arg_1_0.bind(var_1_7, var_0_1.COMMANDER_FORMATION_OP, function(arg_15_0, arg_15_1)
		...
		var_15_1(var_15_0, var_2_10005.COMMANDER_FORMATION_OP, {
			data = arg_15_1
		})
...
function var_0_1.onSelectCommander(arg_16_0, arg_16_1)
	...
	local var_16_1 = var_1_10003(var_1_10005)
	...
	for iter_16_0, iter_16_1 in var_16_2(var_16_4) do
		if var_16_3 and iter_16_1 == var_16_3.id then
			table = var_11

			var_11.remove(var_16_4, iter_16_0)
	...
	local var_16_7 = iter_16_0.GO_SCENE

	SCENE = iter_16_1

	local var_16_8 = iter_16_1.COMMANDERCAT
	local var_16_9 = {
		maxCount = 1
	}

	CommanderCatScene = var_1_10012
	var_16_9.mode = var_1_10012.MODE_SELECT
	CommanderCatScene = var_12
	var_16_9.fleetType = var_12.FLEET_TYPE_COMMON
	...
	function var_16_9.onSelected(arg_18_0, arg_18_1)
		...
		var_18_2(var_18_1, var_2_10006.SELECT_FLEET_COMMANDER, {
			fleetId = arg_16_1,
			pos = arg_16_0,
			...
			callback = function()
				if var_16_0.EdittingFleet then
					...
					local var_19_0 = var_0(var_3_10002)
	...
	function var_16_9.onQuit(arg_20_0)
		...
		var_20_1(var_20_0, var_2_10004.COOMMANDER_EQUIP_TO_FLEET, {
			commanderId = 0,
			fleetId = arg_16_1,
			pos = arg_16_0,
...
function var_0_1.refreshEdit(arg_22_0, arg_22_1)
	...
	local var_22_0 = var_1_10002(var_1_10004)
...
function var_0_1.commitEdit(arg_23_0)
	...
	if var_1_10001(var_1_10003).EdittingFleet == nil or var_2:isFirstFleet() or var_2:isLegalToFight() == true or #var_2.ships == 0 then
		...
		i18n = var_1_10007
		var_23_2.content = var_1_10007("ship_formationMediaror_trash_warning", var_2.defaultName)
...
function var_0_1.handleNotification(arg_27_0, arg_27_1)
	...
	if var_27_1 == var_27_0.FLEET_UPDATED then
		getProxy = var_4
		FleetProxy = var_1_10006
		var_1_10007 = var_4(var_1_10006)

		local var_27_3 = var_4.GetRegularFleets(var_1_10007)
		local var_27_4 = arg_27_0.viewComponent

		var_1_10006.SetFleets(var_27_4, var_27_3)
	else
		FleetProxy = var_4

		local var_27_5

		if var_27_1 == var_4.FLEET_RENAMED then
			pg = var_27_5
			var_1_10006 = var_27_5.TipsMgr.GetInstance()
			var_27_5 = var_27_5.ShowTips
			i18n = var_1_10007

			var_27_5(var_1_10006, var_1_10007("ship_formationMediator_changeNameSuccess"))

			getProxy = var_27_5
			FleetProxy = var_1_10006

			local var_27_6 = var_27_5(var_1_10006)
			local var_27_7 = var_27_5.GetRegularFleets(var_27_6)
			local var_27_8 = arg_27_0.viewComponent

			var_1_10006.SetFleets(var_27_8, var_27_7)

			local var_27_9 = arg_27_0.viewComponent

			var_1_10006.UpdateFleetView(var_27_9, true)

			local var_27_10 = arg_27_0.viewComponent

			var_1_10006.DisplayRenamePanel(var_27_10, false)
		else
			CommanderProxy = var_27_5

			local var_27_11

			if var_27_1 == var_27_5.PREFAB_FLEET_UPDATE then
				getProxy = var_27_11
				CommanderProxy = var_1_10006
				var_27_11 = var_27_11(var_1_10006)

				local var_27_12 = arg_27_0.viewComponent

				var_5.setCommanderPrefabFleet(var_27_12, var_27_11:getPrefabFleet())

				local var_27_13 = arg_27_0.viewComponent

				var_5.updateCommanderFormation(var_27_13)
			else
				GAME = var_27_11

				if var_27_1 == var_27_11.COOMMANDER_EQUIP_TO_FLEET_DONE then
					local var_27_14 = arg_27_0.viewComponent

					var_4.updateCommanderFormation(var_27_14)
				end
			end
		end
	end
...
function var_0_1.checkChangeShip(arg_28_0, arg_28_1, arg_28_2)
	...
	local var_28_0 = var_1_10003(var_1_10005)

	getProxy = var_1_10004
	FleetProxy = var_1_10006

	local var_28_1 = var_1_10004(var_1_10006)
	local var_28_2 = var_28_0:getRawData()
	local var_28_3 = arg_28_2.configId
	local var_28_4 = var_28_1

	if not (var_28_1.GetRegularFleetByShip(var_28_4, arg_28_2) and var_7.id == arg_28_0.id) and (not arg_28_1 or not arg_28_1:isSameKind(arg_28_2)) then
		ipairs = var_28_4

		for iter_28_0, iter_28_1 in var_28_4(arg_28_0.ships) do
			local var_28_5 = var_28_2[iter_28_1]

			if var_14.isSameKind(var_28_5, arg_28_2) then
				local var_28_6 = false

				i18n = var_1_10015
				var_1_10015 = var_1_10015("ship_formationMediator_changeNameError_sameShip")
...
function var_0_1.removeShipFromFleet(arg_29_0, arg_29_1)
	if not arg_29_0:canRemove(arg_29_1) then
		...
		local var_29_1, var_29_2 = arg_29_0.getShipPos(var_29_0, arg_29_1)

		pg = var_29_0

		local var_29_3 = var_29_0.TipsMgr.GetInstance()
		local var_29_4 = var_4.ShowTips

		i18n = var_1_10007

		local var_29_5 = "ship_formationUI_removeError_onlyShip"
		local var_29_6 = arg_29_1
		local var_29_7 = arg_29_1.getConfigTable(var_29_6).name
		local var_29_8 = arg_29_0.name

		Fleet = var_29_6

		var_29_4(var_29_3, var_1_10007(var_29_5, var_29_7, var_29_8, var_29_6.C_TEAM_NAME[var_29_2]))
	...
	arg_29_0.removeShip(var_29_9, arg_29_1)

	getProxy = var_2
	FleetProxy = var_29_9
	var_2(var_29_9).EdittingFleet = arg_29_0
...
function var_0_1.saveEdit()
	...
	local var_30_0 = var_1_10000(var_1_10002)
...
function var_0_1.getDockCallbackFuncs(arg_31_0, arg_31_1, arg_31_2, arg_31_3)
	...
	local var_31_1 = var_1_10005(var_1_10007)

	getProxy = var_1_10006
	ChapterProxy = var_1_10008

	local var_31_2 = var_1_10006(var_1_10008)
	...
	local function var_31_3(arg_32_0, arg_32_1)
		...
		if var_6.GetRegularFleetByShip(var_32_4, arg_32_0) ~= nil and var_6.id ~= arg_31_2.id then
			if arg_31_1 == nil and not var_6:canRemove(arg_32_0) then
				...
				local var_32_10 = var_10(var_32_8, var_32_9, var_2_10014.C_TEAM_NAME[var_32_6])
	...
	local function var_31_4(arg_33_0, arg_33_1, arg_33_2)
		...
		if var_4.GetRegularFleetByShip(var_33_1, var_3) and var_4.id ~= arg_31_2.id then
			...
			i18n = var_2_10009
			var_33_4.content = var_2_10009("ship_formationMediator_quest_replace", var_4.defaultName)
	...
	local function var_31_5(arg_34_0)
		...
		;(function()
			...
			if not var_35_1:canRemove(var_0) and arg_31_1 == nil then
				local var_35_16 = var_35_1
				local var_35_17, var_35_18 = var_35_1.getShipPos(var_35_16, var_0)

				pg = var_35_16

				local var_35_19 = var_35_16.TipsMgr.GetInstance()
				local var_35_20 = var_5.ShowTips

				i18n = var_3_10008

				local var_35_21 = "ship_formationMediator_replaceError_onlyShip"
				local var_35_22 = var_35_1.defaultName

				Fleet = var_3_10012

				var_35_20(var_35_19, var_3_10008(var_35_21, var_35_22, var_3_10012.C_TEAM_NAME[var_35_18]))
			else
				...
				if arg_31_1 then
					...
					local var_35_23 = arg_31_0
					local var_35_24 = var_3.sendNotification

					GAME = var_6

					var_35_24(var_35_23, var_6.UPDATE_FLEET, {
						fleet = var_35_1
					})

					local var_35_25 = arg_31_2

					var_3.removeShip(var_35_25, arg_31_1)

					local var_35_26 = arg_31_2

					var_3.insertShip(var_35_26, var_0, var_35_3, arg_31_3)

					var_31_0.EdittingFleet = arg_31_2

					var_0_1.saveEdit()

					local var_35_27 = arg_31_0
					local var_35_28 = var_3.sendNotification

					GAME = var_6

					var_35_28(var_35_27, var_6.UPDATE_FLEET, {
						fleet = arg_31_2
					})
				else
					local var_35_29 = arg_31_0
					local var_35_30 = var_3.sendNotification

					GAME = var_6

					var_35_30(var_35_29, var_6.UPDATE_FLEET, {
						fleet = var_35_1
					})

					local var_35_31 = arg_31_2

					var_3.insertShip(var_35_31, var_0, nil, arg_31_3)

					var_31_0.EdittingFleet = arg_31_2

					var_0_1.saveEdit()

					local var_35_32 = arg_31_0
					local var_35_33 = var_3.sendNotification

					GAME = var_6

					var_35_33(var_35_32, var_6.UPDATE_FLEET, {
						fleet = arg_31_2
					})
				end
			end
