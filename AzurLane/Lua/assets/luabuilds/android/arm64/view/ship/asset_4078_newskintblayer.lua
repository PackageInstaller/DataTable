...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.ship.NewSkinLayer"))
...
function var_0_1.setSkinPri(arg_3_0, arg_3_1)
	...
	var_3_1.layer = var_1_10003.NameToLayer("UI")

	local var_3_2 = var_3_1.transform

	Vector3 = var_3_0
	var_3_2.localPosition = var_3_0(0, 0, -10)
	setParent = var_3_2
	...
	local var_3_7 = var_3_6(var_3_5, var_6(var_8))

	Color = var_4
	var_3_7.color = var_4.New(0, 0, 0, 0)

	local var_3_8 = arg_3_0

	arg_3_0.recyclePainting(var_3_8)
	...
	if arg_3_0._skinConfig.bg_sp and arg_3_0._skinConfig.bg_sp ~= "" then
		var_3_9 = arg_3_0._skinConfig.bg_sp

		goto label_3_2
	end

	if arg_3_0._skinConfig.bg then
		local var_3_10 = #arg_3_0._skinConfig.bg

		if not (0 < var_3_10) or not arg_3_0._skinConfig.bg then
			::label_3_0::

			if arg_3_0._skinConfig.rarity_bg then
				::label_3_1::

				var_3_10 = #arg_3_0._skinConfig.rarity_bg
				var_3_9 = 0 < var_3_10 and arg_3_0._skinConfig.rarity_bg
			end
		end
		...
		if var_3_9 then
			...
			local var_3_11 = var_3_10.DynamicBgMgr.GetInstance()

			var_3_10.LoadBg(var_3_11, arg_3_0, var_3_9, arg_3_0._bg, arg_3_0._staticBg, function(arg_5_0)
		...
		setPaintingPrefabAsync = var_3_10

		var_3_10(arg_3_0._paintingTF, arg_3_0._skinConfig.painting, "huode")

		local var_3_12 = arg_3_0._skinName

		i18n = var_3_8
		var_3_12.text = var_3_8("ship_newSkin_name", arg_3_0._skinConfig.name)
		...
		local var_3_16 = var_7.GetWordAndCV

		NewEducateHelper = var_9

		local var_3_17, var_3_18, var_3_19 = var_3_16(var_9.GetSecIdBySkinId(arg_3_1), "login")
		local var_3_20 = var_3_19
		local var_3_21 = var_3_18
		local var_3_22 = var_3_17

		setWidgetText = var_3_17

		local var_3_23 = arg_3_0._dialogue

		SwitchSpecialChar = var_10

		var_3_17(var_3_23, var_10(var_3_20, true), "desc/Text")

		local var_3_24 = arg_3_0._dialogue.transform

		Vector3 = var_3_18
		var_3_24.localScale = var_3_18(0, 1, 1)
		SetActive = var_3_24

		var_3_24(arg_3_0._dialogue, false)

		SetActive = var_3_24

		var_3_24(arg_3_0._dialogue, true)

		LeanTween = var_3_24

		local var_3_25 = var_3_24.scale
		local var_3_26 = arg_3_0._dialogue

		Vector3 = var_10

		local var_3_27 = var_3_25(var_3_26, var_10(1, 1, 1), 0.1)
		local var_3_28 = var_7.setOnComplete

		System = var_10

		var_3_28(var_3_27, var_10.Action(function()
			setActive = var_2_10000
...
function var_0_1.didEnter(arg_8_0)
	...
	local function var_8_5()
		...
		var_10_1(var_10_0, var_2_10003.ShareMgr.TypeNewSkin)
	...
	var_1(arg_8_0, arg_8_0.changeSkinBtn, function()
		...
		NewEducateHelper = var_2_10002

		local var_12_1

		if var_12_0(var_2_10002.GetSecIdBySkinId(arg_8_0.contextData.skinId)) then
			var_12_1 = arg_8_0
			...
			NewSkinTBMediator = var_2_10003

			var_12_1(var_12_2, var_2_10003.GO_SET_TB_SKIN)
		else
			pg = var_12_1
			...
			var_12_4(var_12_3, var_2_10003("secretary_special_character_buy_unlock"))
		end
...
function var_0_1.willExit(arg_14_0)
	...
	if not arg_14_0.hideExitTip then
		...
		local var_14_5 = var_1_10006("ship_newSkinLayer_get", var_14_2, var_14_1)

		COLOR_GREEN = var_1_10007

		var_14_4(var_14_3, var_14_5, var_1_10007)
	end
