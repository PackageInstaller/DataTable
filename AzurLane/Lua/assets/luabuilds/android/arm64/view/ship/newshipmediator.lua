...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_EXIT, function(arg_2_0, arg_2_1, arg_2_2)
		...
		local var_2_0 = var_2_10003(var_2_10005)
	...
	arg_1_0:bind(var_0_1.ON_SKIP_BATCH, function(arg_3_0, arg_3_1, arg_3_2)
		getProxy = var_2_10003
		BuildShipProxy = var_2_10005

		local var_3_0 = var_2_10003(var_2_10005)
	...
	arg_1_0:bind(var_0_1.ON_LOCK, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10006.UPDATE_LOCK, {
	...
	arg_1_0.bind(var_1_2, var_0_1.ON_EVALIATION, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10005.FETCH_EVALUATION, arg_6_1)
	...
	if var_1_0:getRarity() >= 4 then
		...
		GAME_RESTOREVIEW_ALREADY = var_1_10007

		if not var_1_6(var_1_5, var_1_10007) then
			pg = var_4
			...
			local var_1_10 = var_1_10007.COMMON_FLAG
			local var_1_11 = {}

			GAME_RESTOREVIEW_ALREADY = var_1_10009
			var_1_11.flagID = var_1_10009
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_1 == var_8_0.UPDATE_LOCK_DONE then
		...
		if var_8_1 == var_4.FETCH_EVALUATION_DONE then
			...
			local var_8_7 = var_1_10007.New
			local var_8_8 = {}

			ShipEvaluationMediator = var_1_10010
			var_8_8.mediator = var_1_10010
			ShipEvaluationLayer = var_1_10010
			var_8_8.viewComponent = var_1_10010
			var_8_8.data = {
				groupId = var_8_2,
