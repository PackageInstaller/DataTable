...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.bgImage = var_1_5(var_1_4, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.lvTxt = var_1_10(var_1_9, var_5(var_1_10007))
	...
	local var_1_18 = var_4.Find(var_1_17, "front/stars")
	local var_1_19 = arg_1_0.content

	arg_1_0.UIlist = var_1_16(var_1_18, var_5.Find(var_1_19, "front/stars/star_tpl"))
	...
	local var_1_24 = var_4.Find(var_1_23, "add/Text")

	i18n = var_5

	var_2(var_1_24, var_5("rect_ship_card_tpl_add"))
...
function var_0_0.flush(arg_4_0)
	...
	elseif var_4_0 == var_0_3 then
		...
		local var_4_4 = var_4_1.getStar(var_4_3)
		local var_4_5 = arg_4_0.UIlist

		var_5.make(var_4_5, function(arg_6_0, arg_6_1, arg_6_2)
			UIItemList = var_2_10003

			if arg_6_0 == var_2_10003.EventUpdate then
				setActive = var_3

				var_3(arg_6_2:Find("star"), arg_6_1 < var_4_4)
			end

			return
		end)

		local var_4_6 = arg_4_0.UIlist

		var_5.align(var_4_6, var_4_2)
		...
		local var_4_7 = arg_4_0.shipVO
		local var_4_8 = var_5.rarity2bgPrint(var_4_7)

		GetImageSpriteFromAtlasAsync = var_4_3

		var_4_3("bg/star_level_card_" .. var_4_8, "", arg_4_0.bgImage)

		local var_4_9 = var_4_1
		local var_4_10, var_4_11 = var_4_1.GetFrameAndEffect(var_4_9, true)

		setRectShipCardFrame = var_4_9

		var_4_9(arg_4_0.frame, var_4_8, var_4_10)

		setFrameEffect = var_4_9

		var_4_9(arg_4_0.otherBg, var_4_11)

		setProposeMarkIcon = var_4_9

		var_4_9(arg_4_0.proposeMark, var_4_1)

		local var_4_12 = arg_4_0.shipVO
		local var_4_13 = var_8.getShipType(var_4_12)

		setImageSprite = var_9

		local var_4_14 = arg_4_0.shipType

		GetSpriteFromAtlas = var_12

		local var_4_15 = "shiptype"

		shipType2print = var_1_10015

		var_9(var_4_14, var_12(var_4_15, var_1_10015(var_4_13)))
