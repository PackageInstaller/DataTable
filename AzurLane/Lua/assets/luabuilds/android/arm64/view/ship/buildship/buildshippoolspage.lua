...
function var_0_1.RefreshFreeBuildActivity(arg_4_0)
	...
	ipairs = var_1
	getProxy = var_3
	ActivityProxy = iter_4_1

	local var_4_0 = var_3(iter_4_1)
	local var_4_1 = var_3.getActivitiesByType

	ActivityConst = var_1_10006

	for iter_4_2, iter_4_3 in var_1(var_4_1(var_4_0, var_1_10006.ACTIVITY_TYPE_BUILD_FREE)) do
		local var_4_2 = iter_4_3

		if iter_4_3.isEnd(var_4_2) == false then
			local var_4_3 = arg_4_0.freeActTimer
			local var_4_4 = iter_4_3.id

			Timer = var_4_2

			local var_4_5 = var_4_2.New
			...
			local function var_4_6()
				...
				var_5_1(var_5_0, var_2_10003.ON_UPDATE_ACT)

				return
			end

			local var_4_7 = iter_4_3.stopTime

			pg = var_1_10012

			local var_4_8 = var_1_10012.TimeMgr.GetInstance()

			var_4_3[var_4_4] = var_4_5(var_4_6, var_4_7 - var_1_10012.GetServerTime(var_4_8))

			local var_4_9 = arg_4_0.freeActTimer[iter_4_3.id]
...
function var_0_1.OnLoaded(arg_7_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_7_0.buildPoolExchangeTxt = var_7_15(var_7_14, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_7_0.buildPoolExchangeGetTxt = var_7_19(var_7_18, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_7_0.buildPoolExchangeName = var_7_22(var_7_21, var_4(var_1_10006))
	...
	local var_7_25 = var_3.Find(var_7_24, "name/Text")

	i18n = var_4

	var_1(var_7_25, var_4("Normalbuild_URexchange_text1"))

	onButton = var_1

	local var_7_26 = arg_7_0
	local var_7_27 = arg_7_0.rtRegularExchange
	local var_7_28 = var_4.Find(var_7_27, "name/icon")
	...
	local function var_7_29()
		...
		i18n = var_2_10004
		var_8_2.helps = var_2_10004("Normalbuild_URexchange_help")
	...
	var_1(var_7_26, var_7_28, var_7_29, var_7_27)

	setText = var_1

	local var_7_30 = arg_7_0.rtRegularExchange
	local var_7_31 = var_3.Find(var_7_30, "count/name")

	i18n = var_7_28

	var_1(var_7_31, var_7_28("Normalbuild_URexchange_text2") .. ":")

	setText = var_1

	local var_7_32 = arg_7_0.rtRegularExchange
	local var_7_33 = var_3.Find(var_7_32, "show/Text")

	i18n = var_4

	var_1(var_7_33, var_4("Normalbuild_URexchange_text3"))

	setText = var_1

	local var_7_34 = arg_7_0.rtRegularExchange
	local var_7_35 = var_3.Find(var_7_34, "get/Text")

	i18n = var_4

	var_1(var_7_35, var_4("Normalbuild_URexchange_text4"))
	...
	var_7_36[1] = var_4.Find(var_7_37, "show")

	local var_7_38 = arg_7_0.rtRegularExchange

	var_7_36[2] = var_4.Find(var_7_38, "get")
	...
	for iter_7_0, iter_7_1 in var_1(var_7_36) do
		...
		local function var_7_41()
			...
			var_9_1(var_9_0, var_2_10003.ON_BUILDPOOL_UR_EXCHANGE)
		...
		var_7_38(var_7_39, var_7_40, var_7_41, var_1_10011)
	end
...
function var_0_1.Flush(arg_13_0, arg_13_1, arg_13_2)
	...
	arg_13_0.pools = var_1_10004.filter(arg_13_1, function(arg_14_0)
		...
		local var_14_2 = var_2_10002(arg_13_2)

		if var_14_1 then
			local var_14_3 = var_14_1:getConfig("type")

			ActivityConst = var_4

			local var_14_4

			if var_14_3 ~= var_4.ACTIVITY_TYPE_NEWSERVER_BUILD then
				var_14_4 = false
	...
	if #arg_13_0.pools > 4 then
		...
		arg_13_0.AdjustToggleContainer(var_13_1)
	end

	local var_13_2 = {}
	local var_13_3 = arg_13_0:ActivePool()

	BuildShipScene = var_13_1

	local var_13_4 = var_13_1.buildShipActPoolId
	...
	for iter_13_0, iter_13_1 in var_7(arg_13_0.pools) do
		local var_13_5 = iter_13_1
		local var_13_6 = iter_13_1.GetMark(var_13_5)
		local var_13_7 = arg_13_0
		local var_13_8 = arg_13_0.GetPoolTpl(var_13_7, var_13_6)

		setActive = var_13_5

		var_13_5(var_13_8, true)

		if iter_13_1:IsActivity() then
			arg_13_0:AddActivityTimer(iter_13_1)
		end

		local var_13_9 = var_13_8:Find("frame")

		removeOnToggle = var_13_7

		var_13_7(var_13_9)

		triggerToggle = var_13_7

		var_13_7(var_13_9, false)
		...
		var_13_7(var_13_10, var_13_11, var_13_12, var_1_10020)

		var_13_2[iter_13_1:GetPoolId()] = var_13_8
	end
	...
	for iter_13_2, iter_13_3 in var_7(arg_13_0.pools) do
		local var_13_13 = var_13_2[iter_13_3:GetPoolId()]

		var_12.SetAsFirstSibling(var_13_13)
	end

	local var_13_14 = arg_13_0:GetActivePool(var_13_3, var_13_4)

	triggerToggle = var_8

	local var_13_15 = var_13_2[var_13_14:GetPoolId()]

	var_8(var_10.Find(var_13_15, "frame"), true)

	local var_13_16
	local var_13_17
	local var_13_18 = arg_13_0.contextData

	var_13_18.projectName = nil
	scrollTo = var_13_18

	var_13_18(arg_13_0.poolContainer.parent, 0, 1)
...
local function var_0_2(arg_19_0)
	...
	local var_19_0 = var_1_10001.select(arg_19_0.pools, function(arg_20_0)
		local var_20_0 = arg_20_0:GetMark()

		BuildShipPool = var_2_10002

		return var_20_0 == var_2_10002.BUILD_POOL_MARK_NEW
	end)
...
function var_0_1.AdjustToggleContainer(arg_25_0)
	if not arg_25_0.isInit then
		...
		var_25_4(var_25_3, var_7(var_1_10009)).padding.left = 60
...
function var_0_1.UpdateArr(arg_26_0, arg_26_1)
	...
	var_26_1(arg_26_0, arg_26_0.poolContainer.parent, function(arg_27_0)
		getBounds = var_2_10001

		local var_27_0 = var_2_10001(var_26_2)

		getBounds = var_2_10002

		local var_27_1 = var_2_10002(var_26_4)
	...
	var_26_1(var_26_5, var_26_6, var_26_7, var_1_10010)
	...
	var_26_1(var_26_8, var_26_9, var_26_10, var_1_10010)
...
function var_0_1.GetPoolTpl(arg_30_0, arg_30_1)
	...
	if #arg_30_0[arg_30_1 .. "PoolTpls"] <= 0 then
		...
		local var_30_2 = var_5.Instantiate(var_3, arg_30_0.poolContainer).transform
...
function var_0_1.ActivePool(arg_31_0)
	...
	local var_31_1 = var_1_10002(var_4)
	local var_31_2 = var_2.getActivityByType

	ActivityConst = var_1_10005

	local var_31_3 = var_31_2(var_31_1, var_1_10005.ACTIVITY_TYPE_BUILD)
	local var_31_6
	...
	if arg_31_0.contextData.activity then
		...
		if 0 < var_31_4 then
			...
			getProxy = var_31_5
			ActivityProxy = var_31_6
			var_31_6 = var_31_5(var_31_6)

			if var_3.getActivityById(var_31_6, arg_31_0.contextData.activity) and not var_3:isEnd() then
	...
	if arg_31_0.contextData.projectName then
		...
		if var_31_8.projectName then
			...
			BuildShipPool = var_31_6

			if var_31_8 == var_31_6.BUILD_POOL_MARK_NEW and not var_31_0 then
		...
		elseif var_31_3 and not var_31_3:isEnd() then
			...
			if not var_31_6.detect(arg_31_0.pools, function(arg_33_0)
				return arg_33_0.id == var_31_8
			end) or not var_5:GetMark() then
				::label_31_0::

				BuildShipPool = var_31_9
				var_31_7 = var_31_9.BUILD_POOL_MARK_HEAVY
			end
...
function var_0_1.UpdateTicket(arg_36_0)
	...
	local var_36_0 = var_1_10001(var_1_10003)
	...
	if var_1.getBuildFreeActivityByBuildId(var_36_0, arg_36_0.pool.id) and not var_2:isEnd() then
		...
		var_36_1.type = var_1_10006
		var_36_1.id = var_2:getConfig("config_client")[1]
		var_36_1.count = var_2.data1
		var_1_10003 = var_1_10003(var_36_1)
		var_36_0 = var_2.stopTime
		pg = var_36_1

		local var_36_2 = var_36_1.TimeMgr.GetInstance()

		var_36_0 = var_36_0 - var_5.GetServerTime(var_36_2) < 0
		setActive = var_5

		local var_36_3 = arg_36_0.freeCount

		var_5(var_7.Find(var_36_3, "tip"), var_36_0 and var_1_10003.count > 0)

		LoadImageSpriteAtlasAsync = var_5

		local var_36_4 = var_1_10003:getConfig("icon")
		local var_36_5 = ""
		local var_36_6 = arg_36_0.freeCount

		var_5(var_36_4, var_36_5, var_9.Find(var_36_6, "icon"))
		...
		local var_36_7 = arg_36_0
		local var_36_8 = arg_36_0.freeCount

		local function var_36_9()
			local var_37_0 = arg_36_0
			local var_37_1 = var_0.emit

			BaseUI = var_2_10003

			var_37_1(var_37_0, var_2_10003.ON_DROP, var_1_10003)
		...
		var_5(var_36_7, var_36_8, var_36_9, var_10)

		local var_36_10 = arg_36_0._tf
		local var_36_11 = var_5.Find(var_36_10, "gallery/item_bg/ticket")

		LoadImageSpriteAtlasAsync = var_6

		var_6(var_1_10003:getConfig("icon"), "", var_36_11:Find("icon"))

		setText = var_6

		var_6(var_36_11:Find("name"), var_1_10003:getConfig("name"))

		setText = var_6

		local var_36_12 = var_36_11:Find("tip")

		i18n = var_9

		var_6(var_36_12, var_9("build_ticket_description"))
	end

	checkExist = var_1_10003

	local var_36_13 = var_1_10003(var_1:getBuildPoolActivity(arg_36_0.pool), {
		"getConfig",
		{
			"type"
		}
	...
	ActivityConst = var_36_0

	local var_36_14 = var_36_13 == var_36_0.ACTIVITY_TYPE_NEWSERVER_BUILD

	setText = var_4

	local var_36_15 = arg_36_0._tf
	local var_36_16 = var_6.Find(var_36_15, "gallery/prints/intro/text")
	...
	if var_36_14 then
		...
		if not var_36_17("newserver_build_tip") then
			i18n = var_36_17
			var_36_17 = var_36_17("build_pools_intro")
		end

		var_4(var_36_16, var_36_17)

		setActive = var_4

		local var_36_18 = arg_36_0.freeCount

		tobool = var_36_17

		var_4(var_36_18, var_36_17(var_2))

		setActive = var_4

		var_4(arg_36_0.quickCount, not var_36_14)

		arg_36_0.useTicket = var_36_14 or var_2 and var_2.data1 > 0
		setActive = var_4

		local var_36_19 = arg_36_0._tf

		var_4(var_6.Find(var_36_19, "gallery/item_bg/item"), not arg_36_0.useTicket)

		setActive = var_4

		local var_36_20 = arg_36_0._tf

		var_4(var_6.Find(var_36_20, "gallery/item_bg/gold"), not arg_36_0.useTicket)

		setActive = var_4

		local var_36_21 = arg_36_0._tf

		var_4(var_6.Find(var_36_21, "gallery/item_bg/ticket"), arg_36_0.useTicket)
...
function var_0_1.SwitchPool(arg_38_0, arg_38_1)
	...
	PLATFORM_CH = var_38_0

	if var_1_10004 == var_38_0 and var_38_1 then
		arg_38_0.buildPainting = var_38_1:getConfig("config_client").build_painting
	end

	setActive = var_1_10004

	var_1_10004(arg_38_0.tipTime, var_38_1 and var_38_1:isVariableTime())

	isActive = var_1_10004

	if var_1_10004(arg_38_0.tipTime) then
		pg = var_4

		local var_38_2 = var_4.TimeMgr.GetInstance()
		local var_38_3 = var_38_1

		var_38_0 = var_38_1.getStartTime(var_38_3)

		local var_38_4 = var_38_1.stopTime

		setText = var_38_3

		local var_38_5 = arg_38_0.tipTime

		var_1_10010 = var_38_2:STimeDescC(var_38_0, "%Y.%m.%d")
		var_1_10011 = " - "
		var_1_10014 = var_38_2

		var_38_3(var_38_5, var_1_10010 .. var_1_10011 .. var_38_2.STimeDescC(var_1_10014, var_38_4, "%m.%d %H:%M"))
	end

	local var_38_6 = arg_38_1:GetMark()

	GetSpriteFromAtlas = var_38_0

	local var_38_7 = var_38_0("ui/BuildShipUI_atlas", "sub_title_" .. var_38_6)
	local var_38_8 = arg_38_0._tf
	local var_38_9 = var_6.Find(var_38_8, "gallery/bg/type")
	local var_38_10 = var_6.GetComponent

	typeof = var_9
	Image = var_1_10011
	var_38_10(var_38_9, var_9(var_1_10011)).sprite = var_38_7

	local var_38_11 = arg_38_1:getConfigTable()
	local var_38_12
	local var_38_13

	if arg_38_1:IsActivity() then
		var_38_12 = var_2:getBuildActivityCfgByID(var_38_11.id)
	else
		var_38_12 = var_2:getNoneActBuildActivityCfgByID(var_38_11.id)
	end

	HXSet = var_9

	local var_38_14 = var_9.HxPath
	local var_38_15

	if not var_38_12 or not var_38_12.bg then
		var_38_15 = "loadingbg/bg_" .. var_38_11.icon
	end

	local var_38_16 = var_38_14(var_38_15)

	LoadSprite = var_1_10010

	local var_38_17 = var_1_10010(var_38_16)
	local var_38_18 = var_38_12 and var_38_12.buildship_tip
	local var_38_19 = arg_38_0.tipSTxt
	local var_38_20 = var_11.SetText

	if var_38_18 then
		HXSet = var_1_10014

		if not var_1_10014.hxLan(var_38_18) then
			i18n = var_1_10014
			var_1_10014 = var_1_10014("buildship_" .. var_38_6 .. "_tip")
		end

		var_38_20(var_38_19, var_1_10014)

		local var_38_21 = arg_38_0._tf
		local var_38_22 = var_11.Find(var_38_21, "gallery/bg")
		local var_38_23 = var_11.GetComponent

		typeof = var_14
		Image = var_1_10016
		var_38_23(var_38_22, var_14(var_1_10016)).sprite = var_38_17

		local var_38_24 = arg_38_0._tf
		local var_38_25 = var_12.Find(var_38_24, "gallery/item_bg/item/Text")
		local var_38_26 = arg_38_0._tf
		local var_38_27 = var_13.Find(var_38_26, "gallery/item_bg/gold/Text")

		setText = var_38_24

		var_38_24(var_38_25, var_38_11.number_1)

		setText = var_38_24

		var_38_24(var_38_27, var_38_11.use_gold)
		...
		if arg_38_1:getConfig("exchange_count") > 0 then
			...
			var_15.insert(var_38_28, function(arg_39_0)
				getProxy = var_2_10001
				BuildShipProxy = var_2_10003

				local var_39_0 = var_2_10001(var_2_10003)
				local var_39_1 = var_1.getRegularExchangeCount(var_39_0)

				pg = var_2_10002

				local var_39_2 = var_2_10002.ship_data_create_exchange

				REGULAR_BUILD_POOL_EXCHANGE_ID = var_39_0

				if not (var_39_1 < var_39_2[var_39_0].exchange_request) then
					...
					if var_39_1 == var_2.CurrentSTimeDesc(var_39_3, "%Y/%m/%d") then
						...
						local function var_39_5(arg_40_0)
							...
							if arg_40_0 then
								...
								local var_40_2 = var_3_10004.TimeMgr.GetInstance()
								local var_40_3

								if not var_4.CurrentSTimeDesc(var_40_2, "%Y/%m/%d") then
									var_40_3 = ""
								end
						...
						i18n = var_2_10007
						var_39_8.content = var_2_10007("Normalbuild_URexchange_warning3")
						i18n = var_7
						var_39_8.stopRamindContent = var_7("dont_remind_today")
		...
		local var_38_29 = arg_38_0
		local var_38_30 = arg_38_0._tf
		local var_38_31 = var_18.Find(var_38_30, "gallery/start_btn")

		local function var_38_32()
			seriesAsync = var_2_10000

			var_2_10000(var_38_28, function()
				if arg_38_0.useTicket then
					...
					if arg_38_0.useTicket and (not var_44_1 or var_44_1:isEnd()) then
						...
						var_44_3(var_44_2, var_3_10004("common_activity_end"))
					...
					if arg_38_0.useTicket then
						...
						Item = var_3_10006
						var_44_7.itemVO = var_3_10006.New({
							id = var_44_1:getConfig("config_client")[1],
							count = var_44_1.data1
						})
						var_44_7.buildPool = var_38_11
						MAX_BUILD_WORK_COUNT = var_6
						var_44_7.max = var_6 - arg_38_0.contextData.startCount
						...
						function var_44_7.onConfirm(arg_45_0)
							...
							if var_1.IsActivity(var_45_0) then
								...
								BuildShipMediator = var_4_10004
								var_4_10004 = var_4_10004.ACT_ON_BUILD

								local var_45_3 = arg_38_1

								var_45_2(var_45_1, var_4_10004, var_5.GetActivityId(var_45_3), var_38_11.id, arg_45_0, true)
							else
								...
								var_45_5(var_45_4, var_4_10004.ON_BUILD, var_38_11.id, arg_45_0, true)
							end
						...
						if not var_44_7 then
							...
							function var_44_7.onConfirm(arg_46_0)
								...
								if var_1.IsActivity(var_46_0) then
									...
									var_46_2(var_46_1, var_4_10004, var_5.GetActivityId(var_46_3), var_38_11.id, arg_46_0)
								else
									...
									var_46_5(var_46_4, var_4_10004.ON_BUILD, var_38_11.id, arg_46_0)
								end
		...
		SFX_UI_BUILDING_STARTBUILDING = var_38_30

		var_15(var_38_29, var_38_31, var_38_32, var_38_30)

		BuildShipScene = var_15
		var_15.projectName = var_38_6
...
function var_0_1.UpdateBuildPoolPaiting(arg_48_0, arg_48_1)
	...
	elseif var_0_3(arg_48_1) then
		...
		local var_48_1 = var_3.ship_data_create_exchange[arg_48_1:GetActivityId()].exchange_ship_id[1]

		pg = var_4

		local var_48_2 = var_4.ship_data_statistics[var_48_1]
		...
		pg = var_5
		var_48_0 = var_5.ship_skin_template[var_48_2.skin_id].painting
	else
		local var_48_3 = arg_48_0.contextData.falgShip

		var_48_0 = var_3.getPainting(var_48_3)
	end
	...
	if arg_48_0.painting ~= var_48_0 then
		...
		if arg_48_0.buildPainting then
			...
			var_4(arg_48_0.patingTF, var_48_0, "build", var_48_4)
		else
...
local function var_0_4(arg_50_0)
	...
	local var_50_1 = var_1:GetChild(0)

	IsNil = var_3

	if var_3(var_50_1) then
		return nil
	end

	pg = var_3

	local var_50_2 = var_3.SdkMgr.GetInstance()
	local var_50_3 = var_3.GetChannelUIDIncludeHarmony(var_50_2)

	return (var_50_1:Find("build_hx_ch" .. var_50_3))
end
...
function var_0_1.Hx4Channel(arg_51_0)
	...
	if not var_1_10002(var_51_0) then
		setActive = var_2
		...
		var_2(var_51_1, var_1_10005.isHx())
	end
...
function var_0_1.RevertHxChannel(arg_52_0)
	...
	if not var_1_10002(var_52_0) then
		setActive = var_2
...
function var_0_1.UpdateBuildPoolExchange(arg_53_0, arg_53_1)
	...
	if arg_53_1:IsActivity() then
		local var_53_3 = arg_53_1:GetActivityId()

		pg = var_1_10006

		if var_1_10006.ship_data_create_exchange[var_53_3] then
			var_53_0 = var_1_10006.exchange_request
			var_53_1 = var_1_10006.exchange_available_times
			var_53_2 = var_1_10006.exchange_ship_id[1]
		end
	end

	if var_53_0 and var_53_0 > 0 and var_53_1 and var_53_1 > 0 then
		local var_53_4 = arg_53_1:GetActivity().data1
		local var_53_5 = var_1_10006.data2

		math = var_1_10009

		local var_53_6 = var_1_10009.min(var_53_1, var_53_5 + 1) * var_53_0
		local var_53_7 = arg_53_0.buildPoolExchangeTxt

		i18n = var_11
		var_53_7.text = var_11("build_count_tip") .. "<color=#FFDF48>" .. var_53_4 .. "</color>/" .. var_53_6

		local var_53_8 = var_53_5 < var_53_1 and var_53_6 <= var_53_4

		setActive = var_11

		var_11(arg_53_0.buildPoolExchangeGetBtnMark, var_53_8)

		local var_53_9 = arg_53_0.buildPoolExchangeGetTxt

		var_53_9.text = var_53_5 .. "/" .. var_53_1
		pg = var_53_9

		local var_53_10 = var_53_9.ship_data_statistics[var_53_2].name
		local var_53_11 = arg_53_0.buildPoolExchangeName

		SwitchSpecialChar = var_13
		var_53_11.text = var_13(var_53_10, true)
		pg = var_53_11

		local var_53_12 = var_53_11.ship_data_statistics[var_53_2].rarity

		eachChild = var_13

		local var_53_13 = arg_53_0.buildPoolExchangeTF

		var_13(var_15.Find(var_53_13, "bg"), function(arg_54_0)
			setActive = var_2_10001
			...
			var_2_10001(var_54_0, var_54_1 == var_2_10005(var_53_12))
		...
		local var_53_14 = arg_53_0
		local var_53_15 = arg_53_0.buildPoolExchangeTF

		local function var_53_16()
			if var_53_8 then
				...
				var_55_1(var_55_0, var_2_10003.ON_BUILDPOOL_EXCHANGE, var_1_10006.id)
			end
		...
		var_13(var_53_14, var_53_15, var_53_16, var_18)

		setGray = var_13

		var_13(arg_53_0.buildPoolExchangeGetBtn, not var_53_8, true)

		setButtonEnabled = var_13

		var_13(arg_53_0.buildPoolExchangeTF, var_53_8)
	else
		removeOnButton = var_1_10006

		var_1_10006(arg_53_0.buildPoolExchangeTF)
	end

	setActive = var_1_10006

	var_1_10006(arg_53_0.buildPoolExchangeTF, var_5)
...
function var_0_1.UpdateRegularBuildPoolExchange(arg_56_0, arg_56_1)
	...
	local var_56_1 = arg_56_1.getConfig(var_56_0, "exchange_count")
	local var_56_2 = 0 < var_56_1

	setActive = var_3

	var_3(arg_56_0.rtRegularExchange, var_56_2)

	if var_56_2 then
		getProxy = var_3
		BuildShipProxy = var_5

		local var_56_3 = var_3(var_5)
		local var_56_4 = var_3.getRegularExchangeCount(var_56_3)

		pg = var_56_0

		local var_56_5 = var_56_0.ship_data_create_exchange

		REGULAR_BUILD_POOL_EXCHANGE_ID = var_56_3

		local var_56_6 = var_56_5[var_56_3]

		setText = var_56_3

		local var_56_7 = arg_56_0.rtRegularExchange

		var_56_3(var_7.Find(var_56_7, "count/Text"), "<color=#FFDF48>" .. var_56_4 .. "</color>/" .. var_56_6.exchange_request)

		setActive = var_56_3

		local var_56_8 = arg_56_0.rtRegularExchange

		var_56_3(var_7.Find(var_56_8, "show"), var_56_4 < var_56_6.exchange_request)

		setActive = var_56_3

		local var_56_9 = arg_56_0.rtRegularExchange

		var_56_3(var_7.Find(var_56_9, "get"), var_56_4 >= var_56_6.exchange_request)
	end
...
function var_0_1.UpdateTestBtn(arg_57_0, arg_57_1)
	...
	if var_1_10003 ~= var_1_10004 and arg_57_1:IsActivity() and not arg_57_1:IsEnd() then
		if arg_57_1:GetStageId() then
			...
			local var_57_2 = arg_57_0.testBtn
			...
			local function var_57_3()
				...
				i18n = var_2_10004
				var_58_2.content = var_2_10004("juese_tiyan")
				...
				function var_58_2.onYes()
					...
					var_59_1(var_59_0, var_3_10003.SIMULATION_BATTLE, var_1_10003)
			...
			var_1_10004(var_57_1, var_57_2, var_57_3, var_1_10009)
		end
	end
...
function var_0_1.AddActivityTimer(arg_60_0, arg_60_1)
	...
	if arg_60_1:IsActivity() then
		...
		var_60_5[var_60_6] = var_60_3.New(function()
			...
			BuildShipMediator = var_3

			var_61_2(var_61_1, var_3.ON_UPDATE_ACT)
