...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	findTF = var_4
	arg_1_0.changeSkinToggle = var_1_0(var_4(arg_1_0.changeSkinTF, "ToggleUI"))
	setActive = var_2
	...
	typeof = var_5
	Toggle = var_7
	arg_1_0.hideObjToggle = var_2(var_1_1, var_5(var_7))
	setText = var_2
	findTF = var_1_1
	...
	var_2(var_1_2, var_5("paint_hide_other_obj_tip"))
...
function var_0_0.updateSkin(arg_2_0, arg_2_1, arg_2_2)
	if arg_2_0.skin ~= arg_2_1 or arg_2_0.own ~= arg_2_2 then
		...
		var_3(var_2_0, var_6(arg_2_1.name, 7))

		local var_2_1 = not arg_2_2

		setActive = var_1_10004

		var_1_10004(arg_2_0.bgMark, var_2_1)

		if var_2_1 then
			setActive = var_1_10004

			var_1_10004(arg_2_0.picNotBuy, false)

			setActive = var_1_10004

			var_1_10004(arg_2_0.picActivity, false)

			setActive = var_1_10004

			var_1_10004(arg_2_0.picPropose, false)

			setActive = var_1_10004

			var_1_10004(arg_2_0.picShare, false)

			var_1_10004 = arg_2_1.skin_type
			ShipSkin = var_2_0

			if var_1_10004 == var_2_0.SKIN_TYPE_PROPOSE then
				setActive = var_1_10004

				var_1_10004(arg_2_0.picPropose, true)

				goto label_2_0
			end

			if arg_2_0.skin.shop_id > 0 then
				setActive = var_1_10004

				var_1_10004(arg_2_0.picNotBuy, true)

				goto label_2_0
			end

			_ = var_1_10004
			var_1_10004 = var_1_10004.any
			pg = var_6

			if not var_1_10004(var_6.activity_shop_template.all, function(arg_3_0)
				pg = var_2_10001
				...
				if var_1_10004(var_6.activity_shop_extra.all, function(arg_4_0)
					pg = var_2_10001
					...
					var_1_10004(arg_2_0.picActivity, true)
				else
					setActive = var_1_10004
				...
				for iter_2_0 = 0, arg_2_0.tags.childCount - 1 do
					...
					var_8(var_10.GetChild(var_2_2, iter_2_0), false)
				end
				...
				var_4.each(arg_2_1.tag, function(arg_5_0)
					...
					var_2_10001(var_3.Find(var_5_0, "tag" .. arg_5_0), true)
...
function var_0_0.updateData(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	if arg_6_0.ship ~= arg_6_1 or arg_6_0.skin ~= arg_6_2 or arg_6_0.own ~= arg_6_3 or arg_6_0.skinId ~= arg_6_2.id then
		...
		if arg_6_3 and var_6_0 then
			...
			var_1_10005(arg_6_0.changeSkinTF, true)
		else
			setActive = var_1_10005

			var_1_10005(arg_6_0.changeSkinTF, false)
		end

		if var_6_0 then
			local var_6_1 = arg_6_0.changeSkinToggle

			var_1_10005 = var_1_10005.setShipData

			local var_6_2 = arg_6_0.skin.id
			local var_6_3 = arg_6_0.ship

			var_1_10005(var_6_1, var_6_2, var_9.GetShipPhantomMark(var_6_3))

			setActive = var_1_10005

			local var_6_4 = arg_6_0.changeSkinTF
			local var_6_5 = arg_6_0.changeSkinToggle

			var_1_10005(var_6_4, not var_8.IsAsmrSkin(var_6_5))
		end

		setActive = var_1_10005

		var_1_10005(arg_6_0.nameBar, true)

		setActive = var_1_10005

		var_1_10005(arg_6_0.effectBar, false)

		setText = var_1_10005

		local var_6_6 = arg_6_0.name

		shortenString = var_8

		var_1_10005(var_6_6, var_8(arg_6_2.name, 7))

		local var_6_7 = arg_6_0.skin.id
		local var_6_8 = arg_6_0.ship
		local var_6_9 = var_6_7 == var_6.getConfig(var_6_8, "skin_id")

		ShipSkin = var_6

		local var_6_10 = var_6.IsShareSkin(arg_6_0.ship, arg_6_0.skin.id)
		local var_6_11 = false

		if var_6_10 then
			ShipSkin = var_8
			var_6_11 = var_8.CanUseShareSkinForShip(arg_6_0.ship, arg_6_0.skin.id)
		end

		setActive = var_8

		var_8(arg_6_0.shareFlag, var_6_10)

		local var_6_12 = not var_6_9 and not arg_6_3 or var_6_10 and not var_6_11

		setActive = var_6_13

		var_6_13(arg_6_0.bgMark, var_6_12)

		if var_6_12 then
			setActive = var_6_13

			var_6_13(arg_6_0.picNotBuy, false)

			setActive = var_6_13

			var_6_13(arg_6_0.picActivity, false)

			setActive = var_6_13

			var_6_13(arg_6_0.picPropose, false)

			setActive = var_6_13

			var_6_13(arg_6_0.picShare, false)

			local var_6_13 = arg_6_2.skin_type

			ShipSkin = var_10

			if var_6_13 == var_10.SKIN_TYPE_PROPOSE then
				setActive = var_6_13

				var_6_13(arg_6_0.picPropose, true)

				goto label_6_0
			end

			if not arg_6_3 and arg_6_0.skin.shop_id > 0 then
				setActive = var_6_13

				var_6_13(arg_6_0.picNotBuy, true)
			...
			if not arg_6_3 then
				_ = var_6_13
				var_6_13 = var_6_13.any
				pg = var_11

				if not var_6_13(var_11.activity_shop_template.all, function(arg_7_0)
					pg = var_2_10001
					...
					if var_6_13(var_11.activity_shop_extra.all, function(arg_8_0)
						pg = var_2_10001
						...
						var_6_13(arg_6_0.picActivity, true)

						goto label_6_0
					end

					if var_6_10 and not var_6_11 then
						setActive = var_6_13

						var_6_13(arg_6_0.picShare, true)
					else
						setActive = var_6_13
					...
					var_6_13(arg_6_0.tags, true)

					for iter_6_0 = 0, arg_6_0.tags.childCount - 1 do
						setActive = var_1_10013

						local var_6_14 = arg_6_0.tags

						var_1_10013(var_15.GetChild(var_6_14, iter_6_0), false)
					end
					...
					var_9.each(arg_6_2.tag, function(arg_9_0)
						...
						var_2_10001(var_3.Find(var_9_0, "tag" .. arg_9_0), true)

						return
					end)
					arg_6_0:flushSkin()

					local var_6_15 = arg_6_0.skin.id

					ShipSkin = var_10

					if var_10.IsChangeSkin(arg_6_0.skin.id) then
						ShipSkin = var_10
						var_6_15 = var_10.GetChangeSkinMainId(arg_6_0.skin.id)
					end

					getProxy = var_10
					ShipSkinProxy = var_12

					local var_6_16 = var_10(var_12)
					local var_6_17

					if var_10.getSkinById(var_6_16, var_6_15) and var_10:isExpireType() then
						var_6_17 = not var_10:isExpired()
					end

					setActive = var_6_16

					var_6_16(arg_6_0.timelimitTag, var_6_17)

					setActive = var_6_16

					var_6_16(arg_6_0.timelimitTimeTxt, var_6_17)

					if arg_6_0.skinTimer then
						local var_6_18 = arg_6_0.skinTimer

						var_12.Stop(var_6_18)
					end
					...
					if var_6_17 then
						...
						arg_6_0.skinTimer = var_12.New(function()
							...
							local var_10_1 = var_2_10000(var_2.getRemainTime(var_10_0))

							setText = var_2_10001

							local var_10_2 = arg_6_0.timelimitTimeTxt

							var_2_10001(var_3.Find(var_10_2, "Text"), var_10_1)

							return
						end, 1, -1)

						local var_6_19 = arg_6_0.skinTimer

						var_12.Start(var_6_19)
...
function var_0_0.updateSelected(arg_11_0, arg_11_1)
	if arg_11_0.selected ~= arg_11_1 then
		...
		var_2(var_11_0, var_1_10005(arg_11_0.selected))
	end
...
function var_0_0.loadPainting(arg_15_0)
	...
	var_1_10002(arg_15_0.hideObjToggle, var_15_1)
