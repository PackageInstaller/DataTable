...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_3 = var_2_2 .. var_2_0.lower(arg_2_1)

	HXSet = var_5

	local var_2_4 = var_5.autoHxShiftPath(var_2_3, nil, true)
	local var_2_5 = var_2_1:CheckF(var_2_4)

	warning = var_6

	local var_2_6 = "OnCheckToUpdate state = "

	tostring = var_9

	var_6(var_2_6 .. var_9(var_2_5))

	DownloadState = var_6

	if var_2_5 ~= var_6.CheckToUpdate then
		DownloadState = var_6

		if var_2_5 == var_6.UpdateFailure then
...
function var_0_0.OnCheckToUpdate(arg_3_0, arg_3_1)
	...
	local function var_3_2()
		...
		local var_4_4 = var_2_10004.BytesToString(var_4_3)
		...
		var_4_7.type = var_2_10009
		string = var_2_10009

		local var_4_8 = var_2_10009.format

		i18n = var_2_10011
		var_4_7.content = var_4_8(var_2_10011("group_download_tip", var_4_4))
...
function var_0_0.OnUpdated(arg_7_0, arg_7_1, arg_7_2)
	...
	var_1_10004(var_7_1 .. var_1_10007(var_7_0))

	setActive = var_1_10004

	var_1_10004(arg_7_0.live2dBtn, var_7_0)

	setActive = var_1_10004

	var_1_10004(arg_7_0.live2dState, false)

	setActive = var_1_10004

	var_1_10004(arg_7_0.live2dToggle, true)

	setActive = var_1_10004

	var_1_10004(arg_7_0.live2dOn, arg_7_2)

	setActive = var_1_10004

	var_1_10004(arg_7_0.live2dOff, not arg_7_2)
	...
	var_1_10004(var_7_2, var_7_3, var_7_4, var_9)
