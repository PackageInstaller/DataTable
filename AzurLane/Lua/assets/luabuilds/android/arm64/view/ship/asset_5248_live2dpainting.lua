...
function var_0_0.GenerateData(arg_1_0)
	local var_1_0 = {
		SetData = function(arg_2_0, arg_2_1)
			...
			local var_2_2 = arg_2_0.GetShipSkinConfig(var_2_1).live2d_offset
			local var_2_3

			if var_2_0 and #var_2_0 >= 4 then
				Vector3 = var_2_1
				var_2_3 = var_2_1(var_2_0[4], var_2_0[4], var_2_0[4])
			elseif var_2_2 and #var_2_2 >= 4 then
				Vector3 = var_2_1
				var_2_3 = var_2_1(var_2_2[4], var_2_2[4], var_2_2[4])
			else
				Vector3 = var_2_1
				var_2_3 = var_2_1(52, 52, 52)
			end
			...
			if var_2_0 and #var_2_0 >= 3 then
				if var_2_0[1] and var_2_0[2] and var_2_0[3] then
					...
					var_2_4 = arg_2_0:GetShipSkinConfig().live2d_offset
				end
			else
				var_2_4 = arg_2_0:GetShipSkinConfig().live2d_offset
			end
			...
			if arg_2_1.position then
				var_2_5 = arg_2_1.position
			else
				Vector3 = var_7
				var_2_5 = var_7(0, 0, 0)
			end

			arg_2_0.scale = var_2_3
			...
			if arg_2_0.skinId then
				pg = var_2_8
				var_2_8 = var_2_8.ship_skin_template[arg_2_0.skinId].spine_use_live2d == 1
				arg_2_0.spineUseLive2d = var_2_8
			end

			BuildVector3 = var_2_8
			arg_2_0.position = var_2_5 + var_2_8(var_2_4)
...
local function var_0_12(arg_10_0, arg_10_1)
	...
	if arg_10_0.enablePlayActions and #arg_10_0.enablePlayActions > 0 then
		...
		if not var_2.contains(arg_10_0.enablePlayActions, arg_10_1) then
			...
			var_2(var_4(arg_10_1) .. "不在白名单中,不播放该动作")
	...
	if arg_10_0.ignorePlayActions and #arg_10_0.ignorePlayActions > 0 then
		...
		if var_2.contains(arg_10_0.ignorePlayActions, arg_10_1) then
			...
			var_2(var_4(arg_10_1) .. "在黑名单中，不播放该动作")
...
local function var_0_13(arg_11_0, arg_11_1, arg_11_2)
	...
	if arg_11_0.animationClipNames and (not arg_11_0:checkActionExist(arg_11_1) or var_3 == false) then
		string = var_1_10004

		if var_1_10004.find(arg_11_1, "main_") then
			arg_11_1 = "main_3"
		end
	end
	...
	if not arg_11_0.isPlaying or arg_11_2 then
		...
		if var_0_3.action2Id[arg_11_1] then
			...
			if var_1_10004.isHx() then
				var_11_0 = arg_11_0

				if arg_11_0.checkActionExist(var_11_0, arg_11_1 .. "_hx") then
			...
			if var_1_10004.isHx() and arg_11_0._shopPreView then
				var_11_0 = arg_11_0

				if arg_11_0.checkActionExist(var_11_0, arg_11_1 .. "_shophx") then
			...
			var_11_0 = arg_11_0.liveCom

			var_1_10004.SetAction(var_11_0, var_11_1)

			if arg_11_1 == "idle" then
				var_11_0 = arg_11_0

				arg_11_0.live2dActionChange(var_11_0, false)
			else
				if arg_11_0._animator.speed ~= 1 then
					var_11_0 = arg_11_0

					arg_11_0.resumeSpeed(var_11_0)
				end

				var_11_0 = arg_11_0

				arg_11_0.live2dActionChange(var_11_0, true)
			end
			...
			var_1_10004(var_11_0(arg_11_1) .. " action is not exist")
		end
	end
...
local function var_0_14(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_12_2, var_1_10006.zero)
...
local function var_0_15(arg_13_0, arg_13_1, arg_13_2)
	...
	if var_13_0(var_1_10005.NOTICE_ACTION_LIST, arg_13_1) then
...
local function var_0_16(arg_14_0, arg_14_1, arg_14_2)
	...
	if arg_14_1 == var_1_10003.EVENT_ACTION_APPLY then
		...
		local var_14_1 = arg_14_2.callback

		var_1_10006 = arg_14_2.finishCall

		local var_14_2 = arg_14_2.activeData
		local var_14_3 = arg_14_2.focus
		local var_14_4 = arg_14_2.react
		local var_14_5 = var_14_2.idle_focus
		local var_14_6 = var_0_11(arg_14_0)
		local var_14_7
		...
		if var_14_6 then
			if var_14_4 ~= nil then
				...
				local var_14_10 = arg_14_0.setReactPos

				tobool = var_1_10017

				var_14_10(var_14_9, var_1_10017(var_14_4))
			end

			if var_14_5 and var_14_5 == 1 and (not var_1_10004 or var_1_10004 == "") then
				var_1_10004 = "idle"

				local var_14_11 = arg_14_0
				local var_14_12 = arg_14_0.changeIdleIndex
				local var_14_13

				if not var_14_2.idle or not var_14_2.idle then
					var_14_13 = 0
				end
			...
			if var_0_13(arg_14_0, var_1_10004, var_14_3 or false) then
				print = var_14_15

				var_14_15("id = " .. var_14_0 .. " 触发成功")

				local var_14_14 = arg_14_0

				var_14_15 = arg_14_0.onListenerHandle
				Live2DPainting = var_17

				var_14_15(var_14_14, var_17.ON_ACTION_PLAY, {
					action = var_1_10004
				})
			...
			elseif var_14_8 then
				...
				var_14_15("id = " .. var_14_0 .. " 空触发成功")
				arg_14_0:applyActiveData(arg_14_2)
			end

			if var_14_5 and var_14_5 == 1 then
		...
		if arg_14_1 == var_14_0.EVENT_ACTION_ABLE then
			if arg_14_0.ableFlag ~= arg_14_2.ableFlag then
				...
				if arg_14_2.ableFlag then
					...
					local var_14_17 = arg_14_0.setEnableActions

					if not arg_14_0.tempEnable then
						var_1_10006 = {}
					end

					var_14_17(var_14_16, var_1_10006)
				end
			end
			...
			if arg_14_1 == var_14_17.EVENT_ADD_PARAMETER_COM then
				local var_14_18 = arg_14_0.liveCom

				var_3.AddParameterValue(var_14_18, arg_14_2.com, arg_14_2.start, var_0_8[arg_14_2.mode])
			else
				Live2DPainting = var_3

				if arg_14_1 == var_3.EVENT_REMOVE_PARAMETER_COM then
					local var_14_19 = arg_14_0.liveCom

					var_3.removeParameterValue(var_14_19, arg_14_2.com)
				else
					Live2DPainting = var_3
					...
					if arg_14_1 == var_3.EVENT_CHANGE_IDLE_INDEX then
						...
						if arg_14_1 == var_3.EVENT_GET_PARAMETER then
							var_14_20 = 0
							var_1_10006 = arg_14_0.liveCom

							if var_1_10004.GetCubismParameter(var_1_10006, arg_14_2.name) then
								var_14_20 = var_1_10004.Value
							end

							if arg_14_2.callback then
								arg_14_2.callback(var_14_20)
							end
						else
							Live2DPainting = var_14_20

							local var_14_22

							if arg_14_1 == var_14_20.EVENT_GET_WORLD_POSITION then
								local var_14_21 = arg_14_0._tf

								var_14_22 = var_14_22.TransformPoint
								Vector3 = var_1_10006
								var_14_22 = var_14_22(var_14_21, var_1_10006(arg_14_2.pos[1], arg_14_2.pos[2], arg_14_2.pos[3]))

								if arg_14_2.callback then
									arg_14_2.callback(var_14_22)
								end
							else
								Live2DPainting = var_14_22

								local var_14_23

								if arg_14_1 == var_14_22.EVENT_GET_DRAG_PARAMETER then
									var_14_23 = 0
									ipairs = var_1_10004

									for iter_14_0, iter_14_1 in var_1_10004(arg_14_0.drags) do
										if iter_14_1.parameterName == arg_14_2.name then
											var_14_23 = iter_14_1.parameterValue
										end
									end

									if arg_14_2.callback then
										arg_14_2.callback(var_14_23)
									end
								else
									Live2DPainting = var_14_23

									if arg_14_1 == var_14_23.EVENT_GAME_XIAQI then
										...
										local var_14_24, var_14_25 = var_3.CheckXiaQiFinish(arg_14_0)
										...
										if var_14_24 then
											...
											var_5(function()
												...
												var_0.setDragCommonData(var_15_0, var_0_0.COMMON_XIAQI_RESULT, var_14_25)
										...
										if var_5.CheckXiaQiLast(arg_14_0) then
											Live2DExtend = var_5

											if var_5.GetXiaQiLastDrag(arg_14_0) then
												var_5:setTargetValueDelay(-1, 0.2)
											end
										end

										Live2DExtend = var_5

										local var_14_26, var_14_27 = var_5.CheckXiaQiFinish(arg_14_0)
										...
										if var_14_26 then
											...
											var_7(function()
												...
												var_0.setDragCommonData(var_16_0, var_0_0.COMMON_XIAQI_RESULT, var_14_27)
	...
	for iter_19_2 = 1, #arg_19_0.drags do
		...
		if var_19_13 and var_19_15 then
			...
			if var_14.getParameterCom(var_19_16) then
				...
				var_19_14.ChangeParameterData(var_19_17, var_14, var_19_13)
			end
		end
		...
		for iter_19_3, iter_19_4 in var_19_14(var_19_19) do
		...
		if arg_19_0.drags[iter_19_2].parameterName == "ParamBGM_loop" then
			...
			local var_19_23 = var_16.CriMgr.GetInstance()
	...
	if arg_19_0.foldAble then
		...
		if 0 < var_19_24 then
			...
			if arg_19_0.foldAble <= 0 then
				...
				NewMainMediator = iter_19_2

				var_19_27(var_19_26, iter_19_2.HIDE_PANEL, false)
			end
		end
	end
...
local function var_0_18(arg_20_0)
	...
	for iter_20_1, iter_20_2 in var_2(arg_20_0.live2dData.shipL2dId) do
		...
		if var_1_10007.ship_l2d[iter_20_2] and arg_20_0:getDragEnable(var_1_10007) then
			...
			if var_1_10007.relation_parameter and var_1_10007.relation_parameter.list then
				...
				for iter_20_3, iter_20_4 in var_20_2(var_20_5) do
	...
	arg_20_0.eventTrigger = var_2(var_20_13, var_5(var_1_10007))
	...
	local var_20_19 = var_5.Action(function()
	...
	var_20_18(var_20_17, var_20_19, iter_20_2.Action(function()
		if not arg_20_0.useEventTriggerFlag then
...
function var_0_0.checkActionProfile(arg_28_0, arg_28_1)
	...
	if not var_1_10002.indexof(arg_28_0.animationClipNames, arg_28_1) or var_2 == false then
		...
		if var_1_10003.find(arg_28_1, "main_") then
			return true
		end
	end
...
local function var_0_19(arg_34_0, arg_34_1)
	...
	var_34_0(var_34_1, var_1_10005.NameToLayer("UI"))
	...
	typeof = var_5
	Live2dChar = iter_34_1
	arg_34_0.liveCom = var_34_4(var_34_3, var_5(iter_34_1))
	...
	typeof = var_5
	Animator = iter_34_1
	arg_34_0._animator = var_34_6(var_34_5, var_5(iter_34_1))

	local var_34_7 = arg_34_1
	local var_34_8 = arg_34_1.GetComponent

	typeof = var_5
	CubismModel = iter_34_1
	arg_34_0.cubismModelCom = var_34_8(var_34_7, var_5(iter_34_1))
	arg_34_0.loadSheets = {}
	...
	if arg_34_0._animator and arg_34_0._animator.runtimeAnimatorController then
		...
		for iter_34_0, iter_34_1 in var_3(var_34_10) do
			table = var_1_10008
	...
	function arg_34_0.liveCom.FinishAction(arg_35_0)
		...
		if arg_34_0.foldAble then
			...
			var_35_3(var_35_2, var_4.HIDE_PANEL, false)
		end
	...
	typeof = var_5
	DftAniEvent = iter_34_1
	arg_34_0.dftCom = var_34_12(var_34_13, var_5(iter_34_1))
	...
	var_2.SetCommonEvent(var_34_14, function(arg_37_0)
		...
		if var_2_10002.contains(var_0_1, var_37_0[1]) then
			...
			if var_37_1.cv_voice then
				...
				ShipWordHelper = var_2_10012
				var_37_4 = var_37_10(var_2_10012.RawGetCVKey(var_37_3))
				pg = var_37_10
				...
				if var_37_0[3] then
					...
					if var_37_4 and var_37_4 ~= "" and var_37_5 and var_37_5 ~= "" then
						if var_37_1.bgm then
							...
							local var_37_13 = var_37_11.CriMgr.GetInstance()
					...
					if var_37_9 then
						...
						if var_37_10(var_37_0[2]) / 100 and 0 <= var_10 then
							...
							local var_37_17 = var_12.CriMgr.GetInstance()
	...
	var_34_18(var_34_19, var_5.L2D_DEFAULT_LAYER)
...
function var_0_0.UpdateL2dBgmVolume(arg_39_0)
	...
	local var_39_2 = var_39_0.CriMgr.GetInstance()
...
function var_0_0.Ctor(arg_40_0, arg_40_1, arg_40_2)
	...
	var_3(not var_5.isEmpty(var_40_0))
	...
	local var_40_3 = var_1_10004.Live2DMgr.GetInstance()
...
function var_0_0.SetVisible(arg_42_0, arg_42_1)
	...
	if arg_42_1 then
		...
		if var_42_0(var_4.getSkinId(var_42_1), arg_42_0.live2dData.ship.id, true) then
...
function var_0_0.loadLive2dData(arg_45_0)
	...
	LIVE2D_STATUS_SAVE = var_1_10003

	if var_45_0(var_1_10003, 1) ~= 1 and not arg_45_0.live2dData.spineUseLive2d then
		...
		local var_45_5, var_45_6 = var_45_3(var_3.GetShipSkinConfig(var_45_4).id, arg_45_0.live2dData.ship.id)
		...
		if not var_45_7(var_45_8, var_6.GetShipSkinConfig(var_45_9).id, arg_45_0.live2dData.ship.id) then
			var_45_10 = 1
		end
...
function var_0_0.saveLive2dData(arg_46_0)
	...
	if var_46_0(var_1_10003, 1) ~= 1 and not arg_46_0.live2dData.spineUseLive2d then
		return
	end
	...
	if arg_46_0.liveCom then
		...
		if var_2.GetCubismParameter(var_46_3, "ParamBGM_loop") then
			...
			var_1_10003.SaveL2dBgmVolume(var_46_1, var_2.Value)
		end
	end
...
function var_0_0.changeActionIdle(arg_47_0)
	...
	local var_47_2 = var_47_0[var_47_1(var_1_10004.random(#var_0_3.idleActions))]
...
function var_0_0.setReactPos(arg_50_0, arg_50_1)
	if arg_50_0.liveCom then
		...
		Vector3 = var_1_10003
		var_50_1.reactPos = var_1_10003(0, 0, 0)
...
function var_0_0.offsetL2dPositonDelay(arg_63_0, arg_63_1, arg_63_2, arg_63_3)
	if arg_63_0._tf then
		...
		if var_63_0(var_1_10006(arg_63_0._tf)) then
			LeanTween = var_4
			...
			var_63_1(var_1_10006(arg_63_0._tf))
		end
	end
	...
	local var_63_5 = var_1_10006(arg_63_0._tf)
	local var_63_6 = arg_63_1

	System = var_8

	var_63_4(var_63_5, var_63_6, var_8.Action(function()
		if arg_63_0._tf then
...
function var_0_0.resetL2dData(arg_66_0)
	...
	if var_66_0(var_1_10003(arg_66_0._tf)) then
		return
	end
	...
	var_66_1(var_3.getSkinId(var_66_2), arg_66_0.live2dData.ship.id)
	...
	if arg_66_0.changeBgmVolume then
		...
		local var_66_5 = var_4.CriMgr.GetInstance()

		var_66_4(var_66_3, var_4.getBGMVolume(var_66_5))
...
function var_0_0.applyActiveData(arg_67_0, arg_67_1)
	...
	if var_67_0 then
		...
		if 0 <= var_67_7 then
			...
			arg_67_0.setEnableActions(var_1_10012, var_67_0)
	...
	if var_67_1 then
		...
		if 0 < var_67_8 then
			...
			for iter_67_2, iter_67_1 in var_67_8(var_67_1) do
	...
	if var_67_3 then
		...
		if 0 <= var_67_9 then
			...
			arg_67_0.setIgnoreActions(var_1_10012, var_67_3)
	...
	if var_67_4 then
		...
		if var_1_10011(var_67_4) == "number" and 0 <= var_67_4 then
			...
			if var_11(var_67_4) == "table" then
				...
				math = var_12
				var_67_11 = var_67_12[var_12.random(1, #var_67_12)]
			end
		end
		...
		if var_67_11 then
			...
			arg_67_0.changeIdleIndex(iter_67_2, var_67_11)
		end

		iter_67_2 = arg_67_0

		arg_67_0.saveLive2dData(iter_67_2)
	end
	...
	if var_67_6 ~= nil then
		...
		NewMainMediator = iter_67_2

		var_67_14(var_67_13, iter_67_2.HIDE_PANEL, var_67_6)
	end
...
function var_0_0.changeIdleIndex(arg_70_0, arg_70_1)
	...
	var_70_4(var_70_3, var_6.ON_ACTION_CHANGE_IDLE, {
		...
		if arg_79_0.drags then
			for iter_79_0 = 1, #arg_79_0.drags do
				...
				if var_5.GetDrawablePart(var_79_0, arg_79_0.drags[iter_79_0].drawAbleName) then
					...
					typeof = var_1_10009
					MeshRenderer = var_1_10011

					local var_79_3 = var_6(var_79_2, var_1_10009(var_1_10011))

					table = var_79_0

					var_79_0.insert(arg_79_0.dragRenders, var_79_3)
				end
			end
		end
	end
...
function var_0_0.setSortingLayer(arg_81_0, arg_81_1)
	...
	local var_81_2 = var_81_1(var_81_0, var_1_10005(var_1_10007))

	LayerWeightConst = var_1_10003
	var_81_2.SortingOrder = var_1_10003.L2D_DEFAULT_LAYER
...
function var_0_0.updateL2dSortMode(arg_82_0)
	...
	local var_82_2 = var_82_1(var_82_0, var_1_10004(var_1_10006))

	CubismSortingMode = var_1_10002
	var_82_2.SortingMode = var_1_10002.BackToFrontOrder
...
function var_0_0.setSortingModeFrontZ(arg_83_0)
	...
	local var_83_2 = var_83_1(var_83_0, var_1_10004(var_1_10006))

	CubismSortingMode = var_1_10002
	var_83_2.SortingMode = var_1_10002.BackToFrontZ
...
function var_0_0.Dispose(arg_84_0)
	...
	ChangeSkinLink = var_1_10003

	if var_84_0(var_1_10003.L2D_SAVE_TEMPLATE_DISPOSE, arg_84_0.live2dData.skinId) then
		...
		if arg_84_0.live2dData.ship and arg_84_0.live2dData.ship.id and arg_84_0.live2dData.ship.id > 0 then
			...
			var_2.L2D_PARAMETER_DIC[arg_84_0.live2dData.ship.id] = var_84_1
		end
	end
	...
	if arg_84_0.state == var_0_0.STATE_INITED then
		...
		local var_84_2 = arg_84_0.liveCom

		var_1.SetMouseInputActions(var_84_2, nil, nil)
	end

	if arg_84_0.dftCom then
		local var_84_3 = arg_84_0.dftCom

		var_1.SetCommonEvent(var_84_3, nil)
	end

	pg = var_1

	local var_84_4 = var_1.CriMgr.GetInstance()

	var_1.DisposePaintingBgm(var_84_4)

	local var_84_5 = arg_84_0

	arg_84_0.unloadCueSheet(var_84_5)

	if arg_84_0._tf then
		LeanTween = var_1

		local var_84_6 = var_1.isTweening

		go = var_84_5

		if var_84_6(var_84_5(arg_84_0._tf)) then
			LeanTween = var_1

			local var_84_7 = var_1.cancel

			go = var_3

			var_84_7(var_3(arg_84_0._tf))
		end
	end
	...
	if arg_84_0.changeBgmVolume then
		...
		local var_84_8 = var_1.CriMgr.GetInstance()
		local var_84_9 = var_1.changeBGMVolume

		pg = var_4

		local var_84_10 = var_4.CriMgr.GetInstance()

		var_84_9(var_84_8, var_4.getBGMVolume(var_84_10))
	end
	...
	if arg_84_0.live2dRequestId then
		...
		local var_84_11 = var_1.Live2DMgr.GetInstance()

		var_1.StopLoadingLive2d(var_84_11, arg_84_0.live2dRequestId)
	...
	if arg_84_0.drags then
		for iter_84_0 = 1, #arg_84_0.drags do
			local var_84_12 = arg_84_0.drags[iter_84_0]

			var_5.dispose(var_84_12)
		end
	...
	if arg_84_0.live2dData then
		local var_84_13 = arg_84_0.live2dData

		var_1.Clear(var_84_13)

		arg_84_0.live2dData = nil
	end

	if arg_84_0.timer then
		local var_84_14 = arg_84_0.timer

		var_1.Stop(var_84_14)
	...
	if arg_84_0._go and arg_84_0.state == var_0_0.STATE_INITED then
		...
		local var_84_15 = var_1.Live2DMgr.GetInstance()

		var_1.ReturnLive2DModel(var_84_15, arg_84_0.modelName, arg_84_0._go)
...
function var_0_0.AtomSouceFresh(arg_92_0)
	...
	local var_92_2 = var_92_1(var_92_0, var_1_10004.CriMgr.C_VOICE)
...
function var_0_0.SetL2dSortingLayer(arg_93_0, arg_93_1)
	...
	typeof = var_1_10005
	CubismRenderController = var_1_10007
	var_93_1(var_93_0, var_1_10005(var_1_10007)).SortingOrder = arg_93_1
...
function var_0_0.UpdateL2dSortMode(arg_94_0)
	...
	local var_94_2 = var_94_1(var_94_0, var_1_10004(var_1_10006))

	CubismSortingMode = var_1_10002
	var_94_2.SortingMode = var_1_10002.BackToFrontOrder
...
function var_0_0.SetSortingModeFrontZ(arg_95_0)
	...
	local var_95_2 = var_95_1(var_95_0, var_1_10004(var_1_10006))

	CubismSortingMode = var_1_10002
	var_95_2.SortingMode = var_1_10002.BackToFrontZ
