...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.levelTF = var_1_5(var_1_4, var_5(var_1_10007))
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.iconTF = var_1_8(var_1_7, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.date = var_1_13(var_1_12, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.manifestoTF = var_1_16(var_1_15, var_5(var_1_10007))
...
function var_0_0.update(arg_2_0, arg_2_1, arg_2_2)
	if arg_2_0.shipVO ~= arg_2_1 then
		...
		var_1_10004(arg_2_0.content, var_3)

		setActive = var_1_10004

		var_1_10004(arg_2_0.quit, not var_3)
	end
...
function var_0_0.updateSelected(arg_3_0, arg_3_1)
	...
	if arg_3_0.selected then
		if not arg_3_0.selectedTwId then
			...
			local var_3_4 = var_3_3(var_3_2, var_5.easeInOutSine)
...
function var_0_0.flush(arg_4_0)
	if arg_4_0.shipVO then
		...
		var_2(var_4_1 .. var_5.getPainting(var_4_2), function(arg_5_0)
		...
		var_2(var_4_3, var_5.ShowPropose(var_4_4))

		for iter_4_0 = arg_4_0.starsTF.childCount, var_4_0.star - 1 do
			cloneTplTo = var_4_4

			var_4_4(arg_4_0.starTF, arg_4_0.starsTF)
		end
		...
		for iter_4_1 = 1, var_2 do
			...
			var_1_10008(var_4_6, iter_4_1 <= var_4_0.star)
		end
	end
...
function var_0_0.flushDetail(arg_7_0)
	...
	if var_1_10002(var_7_0) and arg_7_0.detailType > var_0_0.DetailType0 then
		...
		var_1_10003 = var_7_0.getShipProperties(var_7_1)

		local var_7_2 = {
			"name"
		}

		AttributeType = var_7_1
		var_7_2[2] = var_7_1.Durability
		AttributeType = var_5
		...
		for iter_7_0 = 1, 6 do
			...
			if arg_7_0.detailType == var_0_0.DetailType1 then
				if iter_7_0 == 1 then
					...
					var_7_7.text = var_14.Type2Name(var_7_11)
					tostring = var_14
					math = var_1_10016
					var_7_9.text = var_14(var_1_10016.floor(var_1_10003[var_7_11]))
				end
			elseif arg_7_0.detailType == var_0_0.DetailType2 then
				...
				if iter_7_0 == 6 then
					...
					i18n = var_14
					var_7_7.text = var_7_12 .. var_14("word_synthesize_power") .. "</color>"
					tostring = var_7_12
					var_7_9.text = var_7_12(var_7_3)
				elseif iter_7_0 == 5 then
					var_7_12 = "<color=#A9F548FF>"
					i18n = var_14
					var_7_7.text = var_7_12 .. var_14("word_level") .. "</color>"
					var_7_9.text = "Lv." .. arg_7_0.shipVO.level
				elseif iter_7_0 == 1 then
					TextAnchor = var_7_12
					var_7_7.alignment = var_7_12.MiddleCenter
					var_7_10 = var_7_0
					var_7_7.text = var_7_0.getShipArmorName(var_7_10)
					var_7_9.text = ""
				elseif iter_7_0 == 4 then
					AttributeType = var_7_12

					local var_7_13 = var_7_12.Type2Name

					AttributeType = var_7_10
					var_7_7.text = var_7_13(var_7_10.Expend)

					local var_7_14 = var_7_0:getBattleTotalExpend()

					tostring = var_14
					math = var_1_10016
					var_7_9.text = var_14(var_1_10016.floor(var_7_14))
				else
					local var_7_15 = var_7_2[iter_7_0 + 6]

					AttributeType = var_14
					var_7_7.text = var_14.Type2Name(var_7_15)
					tostring = var_14
					math = var_1_10016
					var_7_9.text = var_14(var_1_10016.floor(var_1_10003[var_7_15]))
				end
			end
		end
	end
	...
	var_1_10003(arg_7_0.detail, var_2 and arg_7_0.detailType > var_0_0.DetailType0)
