...
function var_0_1.init(arg_5_0)
	...
	local var_5_3 = var_3.Find(var_5_2, "bg/title/Image")

	i18n = var_4

	var_1(var_5_3, var_4("word_preview"))
	...
	local var_5_19 = var_3.Find(var_5_18, "bottom/panel_title/tip")

	i18n = var_4

	var_1(var_5_19, var_4("breakout_tip"))

	setText = var_1

	local var_5_20 = arg_5_0.rightPanel
	local var_5_21 = var_3.Find(var_5_20, "bottom/break_btn/tip_deactive/values/ok")

	i18n = var_4

	var_1(var_5_21, var_4("text_confirm"))

	setText = var_1

	local var_5_22 = arg_5_0.rightPanel
	local var_5_23 = var_3.Find(var_5_22, "bottom/break_btn/tip_active/image/ok")

	i18n = var_4

	var_1(var_5_23, var_4("text_confirm"))
	...
	Vector3 = var_1_10002
	var_5_28.localPosition = var_1_10002(-360, 50, 40)
	setActive = var_5_28
...
function var_0_1.loadChar(arg_6_0)
	if not arg_6_0.shipPrefab then
		...
		local var_6_2 = var_1_10002.UIMgr.GetInstance()
		...
		var_2:Load(true, function(arg_7_0)
			...
			var_7_2(var_7_1, var_2_10004(0.8, 0.8, 1))
...
function var_0_1.addDragListenter(arg_11_0)
	...
	var_1:AddDragEndFunc(function(arg_14_0, arg_14_1)
		if var_11_1 < -50 then
			...
			ShipUpgradeMediator2 = var_2_10005

			var_14_1(var_14_0, var_2_10005.NEXTSHIP, -1)
		elseif var_11_1 > 50 then
			...
			var_14_3(var_14_2, var_2_10005.NEXTSHIP)
		end
	...
	local function var_15_2()
		...
		if var_1.isActivityNpc(var_17_1) then
			...
			var_1.insert(var_17_0, function(arg_18_0)
				...
				i18n = var_3_10005
				var_18_2.content = var_3_10005("npc_breakout_tip")
		...
		var_1(var_17_0, function()
			...
			if not var_19_0 then
				...
				var_2.ShowTips(var_3_10004, var_19_1)
			...
			if arg_15_0.breakCfg.breakout_id == 0 then
				...
				local var_19_2 = var_2.ShowTips

				i18n = var_3_10005

				var_19_2(var_3_10004, var_3_10005("ship_upgradeStar_maxLevel"))
			...
			if arg_15_0.shipVO.level < arg_15_0.breakCfg.level then
				...
				local var_19_3 = var_2.ShowTips

				i18n = var_3_10005

				var_19_3(var_3_10004, var_3_10005("ship_upgradeStar_error_lvLimit"))
			...
			if not arg_15_0.isEnoughItems then
				...
				var_19_4(var_3_10004, var_3_10005("ship_upgradeStar_error_noEnoughMatrail"))
			...
			if arg_15_0.player.gold < arg_15_0.breakCfg.use_gold then
				...
				local var_19_5 = "switch_to_shop_tip_2"

				i18n = var_3_10007

				local var_19_6 = var_3_10004(var_19_5, var_3_10007("word_gold"))

				ChargeScene = var_3_10005

				var_2(var_19_6, var_3_10005.TYPE_ITEM, {
					{
						59001,
			...
			if not arg_15_0.contextData.materialShipIds or #arg_15_0.contextData.materialShipIds < arg_15_0.breakCfg.use_char_num then
				...
				var_19_8(var_19_7, var_3_10005("ship_upgradeStar_select_material_tip"))

				return
			end

			local var_19_9 = arg_15_0
			local var_19_10 = var_2.emit

			ShipUpgradeMediator2 = var_3_10005

			var_19_10(var_19_9, var_3_10005.UPGRADE_SHIP, arg_15_0.contextData.materialShipIds)
	...
	local function var_15_5()
		...
		if 0 < var_20_5 then
			...
			var_3.insert(var_20_5, function(arg_21_0)
				...
				local var_21_1, var_21_2 = var_21_0(var_3_10003.map(var_0, function(arg_22_0)
...
function var_0_1.getStages(arg_26_0)
	...
	for iter_26_0 = 1, 4 do
		...
		var_1_10008(arg_26_0.shipBreakOutCfg[var_1_10007], "必须存在配置" .. var_1_10007)

		table = var_1_10008

		var_1_10008.insert(var_26_0, var_1_10007)
	end
...
function var_0_1.updateStagesScrollView(arg_27_0)
	...
	if var_1_10001.indexof(arg_27_0.breakIds, arg_27_0.shipVO.configId) and var_1 >= 1 and var_1 <= var_0_2 then
		...
		typeof = var_6
		Toggle = var_1_10008
		var_27_2(var_27_1, var_6(var_1_10008)).isOn = true
	end
...
function var_0_1.updateBattleView(arg_28_0)
	...
	for iter_28_0 = 1, var_0_2 do
		...
		local function var_28_4(arg_29_0)
			if arg_29_0 then
				...
				if not var_2_10002(var_2_10004.ship_data_template[var_28_0.breakout_id], {
					"specific_type"
				}) then
					var_29_1 = {}
				end
				...
				for iter_29_0, iter_29_1 in var_2_10003(var_29_1) do
					local var_29_2 = var_29_0
					local var_29_3 = "/"

					i18n = var_2_10010
					ShipType = var_2_10012
					var_29_0 = var_29_2 .. var_29_3 .. var_2_10010(var_2_10012.SpecificTableTips[iter_29_1])
				end
		...
		var_1_10008(var_28_2, var_28_3, var_28_4, var_1_10013)
	end
	...
	local var_28_8 = var_28_7(var_28_6, var_1_10005(var_1_10007)).group
	...
	if var_28_5.clamp(var_28_9, 1, var_0_2) and var_2 >= 1 and var_2 <= var_0_2 then
		local var_28_10 = arg_28_0.stages
		local var_28_11 = var_3.Find(var_28_10, "stage" .. var_2)

		triggerToggle = var_4

		var_4(var_28_11, true)
	end
...
function var_0_1.updateBreakOutView(arg_36_0, arg_36_1)
	...
	local var_36_5
	local var_36_6
	local var_36_7 = arg_36_0.tipDeactive
	local var_36_8 = var_9.Find(var_36_7, "values/label")
	local var_36_9 = arg_36_0.tipDeactive
	local var_36_10 = var_10.Find(var_36_9, "values/value")
	...
	if var_36_3 then
		...
		local var_36_11 = var_36_8

		i18n = var_14

		var_36_7(var_36_11, var_14("word_level_upperLimit"))
	else
		...
		var_11(var_36_10, arg_36_0.shipVO.level, arg_36_0.breakCfg.level)

		setText = var_11

		local var_36_12 = var_36_8

		i18n = var_14

		var_11(var_36_12, var_14("word_level_require"))
	end

	local function var_36_13(arg_37_0, arg_37_1)
		setText = var_2_10002
		...
		if arg_37_1.afterAttr == 0 then
			...
			COLOR_GREEN = var_2_10008
			var_37_2 = var_5(var_37_3, var_2_10008)
		end
	...
	if var_36_6 and var_36_6 ~= arg_36_0.shipTempCfg[arg_36_1.configId].max_level then
		local var_36_15 = arg_36_0.attrs
		local var_36_16, var_36_17 = var_13.Find(var_36_15, "attr_1"), var_36_13
		local var_36_18 = {
		...
		i18n = var_1_10018
		var_36_18.name = var_1_10018("word_level_upperLimit")

		var_36_17(var_36_16, var_36_18)

		var_36_14 = 1
	end

	for iter_36_2 = 1, #var_0_3 do
		var_1_10019 = arg_36_0.attrs

		local var_36_19 = var_17.Find(var_1_10019, "attr_" .. var_36_14 + iter_36_2)

		setActive = var_1_10018

		var_1_10018(var_36_19, true)

		math = var_1_10018
		var_1_10018 = var_1_10018.floor(var_36_0[var_0_3[iter_36_2]])
		math = var_1_10019
		var_1_10019 = var_1_10019.floor(var_36_2[var_0_3[iter_36_2]])
		var_1_10020 = var_36_13

		local var_36_20 = var_36_19
		local var_36_21 = {
			preAttr = var_1_10018,
			afterAttr = var_1_10019
		}

		i18n = var_1_10024
		var_36_21.name = var_1_10024("word_attr_" .. var_0_3[iter_36_2])

		var_1_10020(var_36_20, var_36_21)
	end

	local var_36_22 = var_36_14 + #var_0_3 + 1
	local var_36_23 = arg_36_0.attrs
	local var_36_24 = var_14.Find(var_36_23, "attr_" .. var_36_22)

	setActive = var_15

	var_15(var_36_24, true)

	local var_36_25 = var_36_13
	local var_36_26 = var_36_24
	local var_36_27 = {
		preAttr = var_36_4,
		afterAttr = var_36_5
	}
	...
	i18n = var_1_10019
	var_36_27.name = var_1_10019("word_attr_luck")

	var_36_25(var_36_26, var_36_27)

	for iter_36_3 = var_36_22 + 1, 8 do
		local var_36_28 = arg_36_0.attrs
		local var_36_29 = var_36_29.Find(var_36_28, "attr_" .. iter_36_3)

		setActive = var_1_10020

		var_1_10020(var_36_29, false)
	end
	...
	for iter_36_4 = 1, arg_36_1:getStar() do
		cloneTplTo = var_36_29

		var_36_29(arg_36_0.starTpl, arg_36_0.starsFrom)
	end
	...
	if var_36_1:getStar() > arg_36_1:getStar() and not var_36_3 then
		for iter_36_5 = 1, var_36_1:getStar() do
			...
			var_36_29(arg_36_0.starTpl, arg_36_0.starsTo)
		end
	end

	setActive = var_15

	var_15(arg_36_0.appendStarTips, var_36_1:getStar() ~= arg_36_1:getStar())

	setActive = var_15

	var_15(arg_36_0.starOpera, var_36_1:getStar() ~= arg_36_1:getStar())

	local var_36_30 = arg_36_0.breakCfg.use_gold

	if arg_36_0.player.gold < var_36_30 then
		var_36_30 = "<color=#FB4A2C>" .. var_36_30 .. "</color>"
	end

	setText = var_16

	local var_36_31 = arg_36_0.tipActive

	var_16(var_18.Find(var_36_31, "text"), var_36_30)
...
function var_0_1.initMaterialShips(arg_38_0)
	...
	local var_38_1 = var_1_10002(var_1_10004)
	...
	for iter_38_0 = 1, 3 do
		...
		if iter_38_0 <= var_38_0 and var_38_3 and var_38_3[iter_38_0] then
			var_38_2 = var_38_1:getShipById(var_38_3[iter_38_0])
			updateShip = var_10

			var_10(var_1_10007, var_38_2, {
				initStar = true
			})

			SetActive = var_10

			var_10(var_1_10007, true)
		else
			SetActive = var_38_2

			var_38_2(var_1_10007, false)
		end

		onButton = var_38_2

		var_38_2(arg_38_0, arg_38_0.itemTFs[iter_38_0], function()
			local var_39_0 = arg_38_0
			local var_39_1 = var_0.emit

			ShipUpgradeMediator2 = var_2_10003

			var_39_1(var_39_0, var_2_10003.ON_SELECT_SHIP, arg_38_0.shipVO, var_38_0)
...
function var_0_1.onBackPressed(arg_43_0)
	...
	var_43_3(var_43_2, var_1_10004.ON_BACK_PRESSED, true)
