...
function var_0_1.OnInit(arg_4_0)
	...
	arg_4_0.lowToggle = var_4_0(var_3.Find(var_4_1, "speeds"), 4)[1]
	...
	for iter_4_0 = 1, 4 do
		...
		local function var_4_4(arg_5_0)
			if arg_5_0 then
				...
				if var_2_10001.GetInt("dorm3d_graphics_settings_new", 0) ~= iter_4_0 then
					...
					GAME = var_2_10005
					var_2_10005 = var_2_10005.APARTMENT_TRACK
					Dorm3dTrackCommand = var_2_10006

					var_5_1(var_5_0, var_2_10005, var_2_10006.BuildDataGraphics(iter_4_0))
				...
				var_5_3(var_5_2, var_2_10005.SelectGraphicSettingLevel)
			end
		...
		var_6(var_4_2, var_4_3, var_4_4, var_1_10011, var_1_10012)
	end

	setText = var_2

	local var_4_5 = arg_4_0.lowToggle
	local var_4_6 = var_4.Find(var_4_5, "Text")

	i18n = iter_4_0

	var_2(var_4_6, iter_4_0("grapihcs3d_setting_quality_option_low"))

	setText = var_2

	local var_4_7 = arg_4_0.mediumToggle
	local var_4_8 = var_4.Find(var_4_7, "Text")

	i18n = var_5

	var_2(var_4_8, var_5("grapihcs3d_setting_quality_option_medium"))

	setText = var_2

	local var_4_9 = arg_4_0.highToggle
	local var_4_10 = var_4.Find(var_4_9, "Text")

	i18n = var_5

	var_2(var_4_10, var_5("grapihcs3d_setting_quality_option_high"))

	setText = var_2

	local var_4_11 = arg_4_0.playerToggle
	local var_4_12 = var_4.Find(var_4_11, "Text")

	i18n = var_5

	var_2(var_4_12, var_5("grapihcs3d_setting_quality_option_custom"))
...
function var_0_1.OnUpdate(arg_6_0)
	...
	if var_1_10001.GetInt("dorm3d_graphics_settings_new", 2) == 1 then
		...
		var_1_10002(arg_6_0.lowToggle, true)
	elseif var_1 == 2 then
		triggerToggle = var_1_10002

		var_1_10002(arg_6_0.mediumToggle, true)
	elseif var_1 == 3 then
		triggerToggle = var_1_10002

		var_1_10002(arg_6_0.highToggle, true)
	else
		triggerToggle = var_1_10002

		var_1_10002(arg_6_0.playerToggle, true)
	end
