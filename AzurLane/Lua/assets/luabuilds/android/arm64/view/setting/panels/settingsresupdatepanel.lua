...
function var_0_1.OnInit(arg_4_0)
	...
	var_1(var_4_7, var_4("Settings_title_resManage_All"))
	...
	var_1(var_4_8, var_4("Settings_title_resManage_Main"))
	...
	var_1(var_4_9, var_4("Settings_title_resManage_Sub"))
	...
	var_1_10002(arg_4_0.fullTF, var_4_13)

	if var_4_13 then
		SettingsMainGroupBtn = var_1_10002
		arg_4_0.mainGroupBtn = var_1_10002.New(arg_4_0.fullGroupTF)
		...
		var_1_10002 = var_1_10002(var_4_14, var_5(var_1_10007)).padding
		var_1_10002.top = 0
	else
		GetComponent = var_1_10002
		...
		typeof = var_5
		VerticalLayoutGroup = var_1_10007
		var_1_10002 = var_1_10002(var_4_15, var_5(var_1_10007)).padding.top
		...
		var_4_12(var_4_16, var_6(var_1_10008)).padding.top = var_1_10002
	end

	SettingsGalleryBtn = var_1_10002

	local var_4_17 = var_1_10002.New
	local var_4_18 = {
		isDel = true,
		tpl = arg_4_0.tpl,
	...
	var_4_18.iconSP = var_5(var_7.Find(var_4_19, "GALLERY_PIC"))
	...
	var_4_21.iconSP = var_5(var_7.Find(var_4_22, "MANGA"))
	...
	var_4_24.iconSP = var_5(var_7.Find(var_4_25, "DORM"))
	...
	var_4_27.iconSP = var_5(var_7.Find(var_4_28, "MAP"))
	...
	var_4_30.iconSP = var_5(var_7.Find(var_4_31, "REPAIR"))
	...
	var_4_33.iconSP = var_5(var_7.Find(var_4_34, "CV"))
	...
	var_4_36.iconSP = var_5(var_7.Find(var_4_37, "L2D"))
	...
	var_4_39.iconSP = var_5(var_7.Find(var_4_40, "GALLERY_BGM"))
