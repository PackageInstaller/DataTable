...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.cg = var_2_8(var_2_7, var_5(var_1_10007))
	...
	typeof = var_5
	CanvasGroup = var_1_10007
	arg_2_0.topLayerCg = var_2_11(var_2_10, var_5(var_1_10007))
	setActive = var_2
	...
	local var_2_13 = var_4.Find(var_2_12, "editor/editing_region/mask/middle/Text")

	i18n = var_5

	var_2(var_2_13, var_5("settings_battle_tip"))

	setText = var_2

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_4.Find(var_2_14, "editor/buttons/normal/edit/Image")

	i18n = var_5

	var_2(var_2_15, var_5("settings_battle_Btn_edit"))

	setText = var_2

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_4.Find(var_2_16, "editor/buttons/normal/reset/Image")

	i18n = var_5

	var_2(var_2_17, var_5("settings_battle_Btn_reset"))

	setText = var_2

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_4.Find(var_2_18, "editor/title")

	i18n = var_5

	var_2(var_2_19, var_5("settings_battle_title"))

	setText = var_2

	local var_2_20 = arg_2_0._tf
	local var_2_21 = var_4.Find(var_2_20, "editor/buttons/editing/save/Image")

	i18n = var_5

	var_2(var_2_21, var_5("settings_battle_Btn_save"))

	setText = var_2

	local var_2_22 = arg_2_0._tf
	local var_2_23 = var_4.Find(var_2_22, "editor/buttons/editing/cancel/Image")

	i18n = var_5

	var_2(var_2_23, var_5("settings_battle_Btn_cancel"))
...
function var_0_1.SetInterfaceAnchor(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4, arg_17_5)
	...
	local var_17_3 = var_1_10009(arg_17_0.interface).rect.height
...
function var_0_1.OverrideInterfaceSetting(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	local var_22_1 = var_1_10005(arg_22_0.interface).rect.height
