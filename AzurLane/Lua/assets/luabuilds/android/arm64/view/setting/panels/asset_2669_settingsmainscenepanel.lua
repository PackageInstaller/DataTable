...
function var_0_1.CommonToggleSetting(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5)
	...
	local var_10_1 = arg_10_1.Find(var_10_0, "on")
	local var_10_2 = arg_10_1:Find("off")
	...
	var_10_0(var_10_3, var_10_4, var_10_5, var_1_10013)
	...
	var_10_0(var_10_6, var_10_7, var_10_8, var_1_10013)
...
function var_0_1.InitStandbyModeToggle(arg_13_0)
	...
	var_13_3(var_13_2, var_13_4, var_13_5, var_1_10007("settings_enable_standby_mode"), var_0_1.IsEnableStandbyMode(), function(arg_14_0)
...
function var_0_1.EnableOrDisableSubToggles(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in var_1_10002(arg_15_0.subToggles) do
		...
		var_1_10007 = var_1_10007(var_15_0, var_1_10010(var_1_10012))
...
function var_0_1.InitTimeSystemToggle(arg_16_0)
	...
	var_16_3(var_16_2, var_16_4, var_16_5, var_1_10007("settings_time_system"), var_0_1.IsEnable24HourSystem())
...
function var_0_1.InitFlagShipInteractionToggle(arg_17_0)
	...
	var_17_3(var_17_2, var_17_4, var_17_5, var_1_10007("settings_flagship_interaction"), var_0_1.IsEnableFlagShipInteraction())
...
function var_0_1.InitEnterStandbyModeTime(arg_18_0)
	...
	local var_18_2 = var_18_1:Find("notify_tpl/mask/Text")

	i18n = var_1_10005

	var_1_10002(var_18_2, var_1_10005("settings_enter_standby_mode_time"))
	...
	if var_18_3[var_0_1.GetEnterFlagShipValue()] then
		triggerToggle = var_5
	...
	for iter_18_0, iter_18_1 in var_5(var_18_3) do
		onToggle = var_1_10010

		local var_18_4 = arg_18_0
		local var_18_5 = iter_18_1

		local function var_18_6(arg_19_0)
			if arg_19_0 then
		...
		var_1_10010(var_18_4, var_18_5, var_18_6, var_1_10015)
	end
...
function var_0_1.SetIntegerCache(arg_20_0, arg_20_1)
	...
	local var_20_2 = var_1_10004(var_1_10006)
