...
function var_0_1.OnInit(arg_4_0)
	...
	var_4_3(var_4(arg_4_0.btnTpl, "off"))
	...
	var_4_4(var_4(arg_4_0.btnTpl, "on"))
...
function var_0_1.createBtn(arg_5_0, arg_5_1)
	...
	var_4(var_5_2, var_5_3, var_5_4, var_1_10009)
...
function var_0_1.createToggle(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_2:Find("on")

	setText = var_6_0

	var_6_0(var_6_1, arg_6_1.text)

	onToggle = var_6_0

	local var_6_3 = arg_6_0
	local var_6_4 = var_6_2
	local var_6_5 = arg_6_1.func

	SFX_UI_TAG = var_1_10010
	SFX_UI_CANCEL = var_1_10011

	var_6_0(var_6_3, var_6_4, var_6_5, var_1_10010, var_1_10011)
...
function var_0_1.btn_brightness_setvalue(arg_9_0)
	...
	local function var_9_3()
		...
		var_10_1, setText = var_0.Find(var_10_0, var_9_1.go .. "/mask/Text"), var_2_10001

		local var_10_2 = var_9_0

		YSNormalTool = var_2_10005

		var_2_10001(var_10_1, var_10_2 .. var_2_10005.BrightnessTool.GetBrightnessValue())
...
function var_0_1.btn_push_10s(arg_19_0)
	local var_19_0 = {
		...
		func = function()
			...
			local var_20_3 = var_3.TimeMgr.GetInstance()
			local var_20_4 = var_20_2(var_20_1, var_3.GetServerTime(var_20_3), "*t").year .. var_0.month .. var_0.day .. var_0.hour .. var_0.min .. var_0.sec
			...
			local var_20_7 = var_3.PushNotificationMgr.GetInstance()
	...
	local function var_31_1(arg_32_0)
		if arg_32_0 then
			...
			if var_2_10001 == var_2_10002 then
				...
				i18n = var_2_10005
				var_32_2.content = var_2_10005("word_save_video")
				...
				function var_32_2.onYes()
					...
					var_3_10000.MediaTool.SaveVideoToAlbum(arg_31_0.recordFilePath, function(arg_35_0, arg_35_1)
						if arg_35_0 then
							...
							var_35_1(var_35_0, var_4_10005("word_save_ok"))
...
function var_0_1.btn_vulkan(arg_37_0)
	...
	local var_37_2 = {
		...
		func = function()
			...
			GraphApiHelper = var_2_10002

			var_38_0(var_2_10002.Api.Force_Vulkan)
...
function var_0_1.btn_gles(arg_39_0)
	...
	local var_39_2 = {
		...
		func = function()
			...
			var_40_0(var_2_10002.Api.Force_OpenGLES)
