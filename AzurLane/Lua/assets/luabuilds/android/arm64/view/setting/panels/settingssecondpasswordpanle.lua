...
function var_0_1.OnInit(arg_4_0)
	...
	local var_4_1 = var_3.Find(var_4_0, "options/close/Text")

	i18n = var_4

	var_1(var_4_1, var_4("settings_pwd_label_close"))

	setText = var_1

	local var_4_2 = arg_4_0._tf
	local var_4_3 = var_3.Find(var_4_2, "options/open/Text")

	i18n = var_4

	var_1(var_4_3, var_4("settings_pwd_label_open"))
	arg_4_0:SetData()
...
function var_0_1.RegisterEvent(arg_6_0)
	...
	var_1_10001(arg_6_0, arg_6_0.helpBtn, function()
		...
		i18n = var_2_10004
		var_7_2.helps = var_2_10004("secondary_password_help")
	...
	local function var_6_5()
		if arg_6_0.rawdata.state <= 0 then
			...
			if var_1.GetFloat("firstOpenSecondaryPassword") == 0 then
				...
				i18n = var_2_10005
				var_10_3.helps = var_2_10005("secondary_password_help")
...
function var_0_1.UpdateBtnState(arg_13_0)
	...
	var_2(var_4.Find(var_13_2, "on"), not var_13_1)

	setActive = var_2

	local var_13_3 = arg_13_0.closeBtn

	var_2(var_4.Find(var_13_3, "off"), var_13_1)

	setActive = var_2

	local var_13_4 = arg_13_0.openBtn

	var_2(var_4.Find(var_13_4, "on"), var_13_1)

	setActive = var_2

	local var_13_5 = arg_13_0.openBtn

	var_2(var_4.Find(var_13_5, "off"), not var_13_1)
	...
	var_13_7(var_13_6, var_5.ON_SECON_PWD_STATE_CHANGE)
