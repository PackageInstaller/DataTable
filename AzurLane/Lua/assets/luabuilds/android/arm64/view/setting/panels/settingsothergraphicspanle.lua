...
function var_0_1.JumpToCustomSetting(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_5.APARTMENT_TRACK

	Dorm3dTrackCommand = var_1_10006

	var_6_1(var_6_0, var_6_2, var_1_10006.BuildDataGraphics(4))
	...
	NewSettingsMediator = var_5

	var_6_4(var_6_3, var_5.SelectCustomGraphicSetting)
...
function var_0_1.UpdateItem(arg_7_0, arg_7_1, arg_7_2)
	...
	var_7_1, setText = arg_7_2:Find("mask/Text"), var_1_10005
	i18n = var_1_10008

	var_1_10005(var_7_1, var_1_10008(var_7_0.settingName))

	local var_7_2 = var_7_0.settingType == var_0_2.toggle
	local var_7_3 = arg_7_2
	local var_7_4 = arg_7_2.Find(var_7_3, "toggle")
	local var_7_5 = arg_7_2:Find("select")

	setActive = var_7_3

	var_7_3(var_7_4, var_7_2)

	setActive = var_7_3

	var_7_3(var_7_5, not var_7_2)
	...
	if var_7_2 then
		...
		local var_7_8 = arg_7_2.Find(var_7_7, "toggle/off")
		local var_7_9 = arg_7_2:Find("toggle/on")
		...
		local function var_7_10(arg_9_0)
			...
			var_2_10001(var_3.Find(var_9_0, "show"), not arg_9_0)

			SetActive = var_2_10001

			local var_9_1 = var_7_9

			var_2_10001(var_3.Find(var_9_1, "show"), arg_9_0)
		...
		local function var_7_13()
			...
			if var_7_0.tips then
				...
				var_2_10001.insert(var_10_0, function(arg_11_0)
					...
					i18n = var_3_10005
					var_11_2.content = var_3_10005(var_7_0.tips)
				...
				if arg_7_0.customSetting and var_7_0.hasChild then
					...
					var_10_2(var_10_1, var_2_10003.SelectCustomGraphicSetting)
		...
		var_13(var_7_11, var_7_12, var_7_13, var_1_10018)
		...
		local function var_7_16()
			...
			if arg_7_0.customSetting and var_7_0.hasChild then
				...
				var_15_1(var_15_0, var_2_10003.SelectCustomGraphicSetting)
		...
		var_13(var_7_14, var_7_15, var_7_16, var_1_10018)
		...
		if arg_7_0.graphicLevel == var_0_5.Custom then
			...
			if arg_7_0.graphicLevel == var_0_5.Custom then
				...
				do
					...
					for iter_7_0, iter_7_1 in var_7_7(var_7_0.options) do
					...
					;(function()
						...
						local var_16_2 = var_7_5

						var_2(var_4.Find(var_16_2, "leftbu"), not var_16_0)

						setActive = var_2

						local var_16_3 = var_7_5

						var_2(var_4.Find(var_16_3, "rightbu"), not var_16_1)

						setText = var_2

						local var_16_4 = var_7_5
						local var_16_5 = var_4.Find(var_16_4, "Text")

						i18n = var_5

						var_2(var_16_5, var_5(var_7_0.optionNames[var_7_19]))
					...
					var_12(arg_7_0, var_7_5:Find("leftbu"), function()
						var_7_19 = var_7_19 - 1
					...
					var_12(arg_7_0, var_7_5:Find("rightbu"), function()
						var_7_19 = var_7_19 + 1
