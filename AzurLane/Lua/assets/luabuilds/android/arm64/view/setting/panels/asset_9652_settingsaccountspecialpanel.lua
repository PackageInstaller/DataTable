...
function var_0_1.findUI(arg_6_0)
	...
	var_6_8(var_6_12, var_1_10006("settings_text_account_del"))
	...
	var_6_8(var_6_13, var_6("settings_text_account_del_desc"))
	...
	var_6_8(var_6_14, var_6("settings_text_account_del_confirm"))
	...
	var_6_8(var_6_15, var_6("settings_text_account_del_btn"))
	...
	var_6_8(var_6_16, var_6("settings_text_account_del_btn"))

	triggerToggle = var_6_8

	var_6_8(arg_6_0.comfirmToggle, false)
...
function var_0_1.openMsgBox(arg_12_0)
	...
	MSGBOX_TYPE_ACCOUNTDELETE = var_1_10005
	var_12_2.type = var_1_10005
	pg = var_1_10005
	var_12_2.title = var_1_10005.MsgboxMgr.TITLE_INFORMATION
	...
	function var_12_2.onYes(arg_13_0)
		...
		if arg_13_0 == var_2_10001("box_account_del_target") then
			...
			local var_13_0 = var_2_10002.SdkMgr.GetInstance()

			var_2_10002.AccountDelete(var_13_0)
		else
			pg = var_2_10002

			local var_13_1 = var_2_10002.TipsMgr.GetInstance()
			local var_13_2 = var_2.ShowTips

			i18n = var_2_10005

			var_13_2(var_13_1, var_2_10005("tip_account_del_dismatch"))
		end
