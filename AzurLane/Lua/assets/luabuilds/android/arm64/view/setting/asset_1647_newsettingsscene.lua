...
function var_0_1.OnRandomFlagShipModeUpdate(arg_7_0)
	...
	var_7_1(var_7_0, var_1_10004.EVT_UPDTAE)
...
function var_0_1.OnSelectGraphicSettingLevel(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10004.EVT_UPDTAE)
...
function var_0_1.OnSelectCustomGraphicSetting(arg_9_0)
	...
	SettingsGraphicsPanle = var_1_10004

	var_9_1(var_9_0, var_1_10004.EVT_UPDTAE)
...
function var_0_1.OnApplicationPause(arg_10_0)
	...
	SettingsNotificationPanel = var_1_10004

	var_10_1(var_10_0, var_1_10004.UPDATE_ALARM_PANEL)
...
function var_0_1.init(arg_12_0)
	...
	SettingsOtherPage = var_12_1
	var_12_3[1] = var_12_1.New(var_12_2, arg_12_0.event, arg_12_0.contextData)
	...
	var_2(var_4.Find(var_12_12, "blur_panel/adapt/left_length/threeD"), false)
...
function var_0_1.didEnter(arg_13_0)
	...
	local function var_13_5()
		...
		i18n = var_2_10004
		var_15_2.content = var_2_10004("main_settingsScene_quest_exist")

		function var_15_2.onYes()
			local var_16_0 = arg_13_0
			local var_16_1 = var_0.emit

			NewSettingsMediator = var_3_10003

			var_16_1(var_16_0, var_3_10003.ON_LOGOUT)
	...
	if var_1_10001 == var_1_10002 then
		...
		local var_13_7 = arg_13_0.helpBtn
		...
		if var_1_10001 == var_1_10002 then
			...
			local var_13_10 = arg_13_0.helpBtn
			...
			local var_13_12 = arg_13_0.helpBtn

			var_1_10001.SetAsFirstSibling(var_13_12)
		end
	end
	...
	for iter_13_0, iter_13_1 in var_1_10001(arg_13_0.toggles) do
		...
		local var_13_14 = iter_13_1

		local function var_13_15(arg_19_0)
			if arg_19_0 then
		...
		var_1_10006(var_13_13, var_13_14, var_13_15, var_1_10011)
	end

	setActive = var_1

	local var_13_16 = arg_13_0.otherTip

	PlayerPrefs = iter_13_0

	var_1(var_13_16, iter_13_0.GetInt("firstIntoOtherPanel", 0) == 0)
...
function var_0_1.SwitchPage(arg_21_0, arg_21_1)
	...
	Settings3DPage = var_6

	if var_3(var_21_3, var_6) then
	...
	SettingsOtherPage = var_6

	if var_3(var_21_4, var_6) then
		isActive = var_3
...
function var_0_1.CloseYostarAlertView(arg_23_0)
	if arg_23_0.yostarAlertView then
		...
		if var_23_1(var_23_0, var_1_10004.STATES.INITED) then
...
function var_0_1.onBackPressed(arg_24_0)
	...
	if var_1_10002(var_24_2) then
		triggerButton = var_2

		local var_24_3 = var_24_2.transform

		var_2(var_4.Find(var_24_3, "dialog/title/back"))
