...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10004.GUILD_LIST_REFRESH)
	...
	arg_1_0:bind(var_0_1.APPLY, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10006.GUILD_APPLY, {
			id = arg_2_1,
			content = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.REFRESH, function(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10004.GUILD_LIST_REFRESH)
	...
	arg_1_0:bind(var_0_1.SEARCH, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10005.GUILD_SEARCH, arg_4_1)
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_1 ~= var_6_0.GUILD_LIST_REFRESH_DONE then
		GAME = var_4

		if var_6_1 == var_4.GUILD_SEARCH_DONE then
			...
			if var_6_1 == var_4.GUILD_APPLY_DONE then
