...
function var_0_1.preload(arg_7_0, arg_7_1)
	...
	var_1_10002({
		function(arg_8_0)
			...
			var_8_1(var_8_0, var_2_10004.GET_GUILD_REPORT, {
				callback = arg_8_0
			})
		...
		function(arg_9_0)
			...
			if not var_1.GetActiveEvent(var_9_1) then
				...
				local var_9_2 = var_2_10002.m02
				local var_9_3 = var_2.sendNotification

				GAME = var_2_10005

				var_9_3(var_9_2, var_2_10005.GUILD_GET_ACTIVATION_EVENT, {
					force = false,
					callback = arg_9_0
				})
			elseif var_1 and var_1:IsExpired() then
				...
				var_9_5(var_9_4, var_2_10005.GUILD_GET_ACTIVATION_EVENT, {
					force = true,
					callback = arg_9_0
				})
			else
...
function var_0_1.init(arg_25_0)
	...
	arg_25_0:bind(var_0_1.OPEN_MISSION_FORAMTION, function(arg_29_0, arg_29_1)
		...
		var_29_5.shipCnt = var_2_10009.MISSION_MAX_SHIP_CNT
...
function var_0_1.didEnter(arg_34_0)
	...
	local function var_34_3()
		...
		var_35_2.type = var_2_10004
		pg = var_2_10004
		var_35_2.helps = var_2_10004.gametip.guild_event_help_tip.tip
	...
	var_1(var_34_1, var_34_2, var_34_3, var_1_10006)
	arg_34_0:EnterEvent()
