...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_CANCEL_TECH, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.GUILD_CANCEL_TECH, {
			id = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.ON_UPGRADE, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10005.GUILD_START_TECH, {
			id = arg_4_1
		})
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_START, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10005.GUILD_START_TECH_TASK, {
			id = arg_5_1
		})
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	if var_7_1 == var_7_0.GUILD_UPDATED then
	...
	if var_7_1 == var_4.GUILD_START_TECH_DONE then
	...
	if var_7_1 ~= var_4.DONATE_UPDTAE then
		GuildProxy = var_4

		if var_7_1 ~= var_4.TECHNOLOGY_START then
			GuildProxy = var_4

			if var_7_1 == var_4.TECHNOLOGY_STOP then
				...
				if var_7_1 == var_4.HANDLE_GUILD_AND_PUBLIC_GUILD_TECH_DONE then
