...
function var_0_1.init(arg_6_0)
	...
	arg_6_0.toggleGroup = var_6_3(var_6_2, var_4(var_1_10006))
	...
	GuildMemberInfoPage = var_2
	var_6_11[1] = var_2.New(arg_6_0._tf, arg_6_0.event)
...
function var_0_1.didEnter(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10002(arg_8_0.btns) do
		...
		local function var_8_3()
			if iter_8_0 == 2 then
				...
				if var_0.IsRecruit(var_10_0) then
					...
					var_10_2(var_10_1, var_2_10003("guild_trainee_duty_change_tip"))
			...
			local function var_10_6()
				...
				var_0(var_2.Find(var_11_1, "sel"), true)
		...
		var_1_10007(var_8_1, var_8_2, var_8_3, var_1_10012)
		...
		var_1_10007.SetCallBack(var_8_4, function(arg_12_0)
			...
			var_12_0(var_12_1, var_2_10004.UIMgr.GetInstance().OverlayMain)
	...
	local function var_8_7()
		...
		pg = var_2_10004
		var_14_2.helps = var_2_10004.gametip.guild_member_tip.tip
...
function var_0_1.LoadPainting(arg_15_0, arg_15_1)
	...
	var_1_10004(arg_15_0.buttonsPanel, true)
	...
	if not var_15_4 or var_15_4 == "" then
		...
		setText = var_5
		var_1_10009 = arg_15_0.chatPanel

		var_5(var_15_11.Find(var_1_10009, "Text"), var_15_4)
	end
	...
	local var_15_9, var_15_11

	if var_15_3.isHxPropose() then
		local var_15_6 = arg_15_0.guildVO
		local var_15_7 = var_15_9.GetOfficePainting(var_15_6)

		pg = var_15_9

		local var_15_8 = var_15_9.GuildPaintingMgr.GetInstance()

		var_15_9 = var_15_9.Update
		var_1_10009 = var_15_7
		Vector3 = var_1_10010

		var_15_9(var_15_8, var_1_10009, var_1_10010(-643, -160, 0))
	else
		Ship = var_15_9
		var_1_10009 = var_15_9.New({
			configId = arg_15_1.icon,
			skin_id = arg_15_1.skinId
		})

		local var_15_10 = var_15_9.getPainting(var_1_10009)

		pg = var_15_11
		var_1_10009 = var_15_11.GuildPaintingMgr.GetInstance()
		var_15_11 = var_15_11.Update

		local var_15_12 = var_15_10

		Vector3 = var_1_10011

		var_15_11(var_1_10009, var_15_12, var_1_10011(-484, 0, 0), true)
	end

	setActive = var_15_9

	local var_15_13 = arg_15_0.btns[4]

	GuildConst = var_1_10009

	local var_15_14

	if var_15_2 == var_1_10009.DUTY_DEPUTY_COMMANDER then
		GuildConst = var_9

		if var_15_0 == var_9.DUTY_COMMANDER then
			var_15_14 = arg_15_1:isLongOffLine()
	...
	var_15_9(var_15_13, var_15_14)

	GuildConst = var_15_9

	if var_15_2 ~= var_15_9.DUTY_DEPUTY_COMMANDER then
		GuildConst = var_6
		...
		if var_15_2 == var_6.DUTY_COMMANDER then
			...
			setButtonEnabled = var_15_11

			var_15_11(arg_15_0.btns[2], var_15_15)

			setGray = var_15_11

			var_15_11(arg_15_0.btns[2], not var_15_15, true)

			GuildConst = var_15_11

			if var_15_2 ~= var_15_11.DUTY_DEPUTY_COMMANDER then
				GuildConst = var_7
				...
				if var_15_2 == var_7.DUTY_COMMANDER then
					...
					setButtonEnabled = var_15_13

					var_15_13(arg_15_0.btns[3], var_15_16)

					setGray = var_15_13

					var_15_13(arg_15_0.btns[3], not var_15_16, true)
...
function var_0_1.onBackPressed(arg_20_0)
	...
	SFX_CANCEL = iter_20_0

	var_20_1(var_20_0, iter_20_0)
...
function var_0_1.willExit(arg_21_0)
	...
	if var_1(var_3.MsgboxMgr.GetInstance()._go) then
		triggerButton = var_1
		pg = var_3
