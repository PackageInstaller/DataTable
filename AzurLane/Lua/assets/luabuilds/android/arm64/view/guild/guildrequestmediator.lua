...
function var_0_1.register(arg_1_0)
	...
	if not var_1:getSortRequest() or var_1.requestCount > 0 then
		...
		var_1_2(var_1_1, var_1_10006.GUILD_GET_REQUEST_LIST, arg_1_0.guild.id)
	...
	arg_1_0:bind(var_0_1.ACCPET, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.GUIDL_REQUEST_ACCEPT, arg_2_1)
	...
	arg_1_0:bind(var_0_1.REJECT, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.GUIDL_REQUEST_REJECT, arg_3_1)
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_1 == var_5_0.REQUEST_DELETED then
		...
		if var_5_1 == var_4.GUILD_GET_REQUEST_LIST_DONE then
			...
			if var_5_1 == var_5_5.REQUEST_COUNT_UPDATED then
				local var_5_8 = arg_5_0
				local var_5_9 = arg_5_0.sendNotification

				GAME = var_1_10007

				var_5_9(var_5_8, var_1_10007.GUILD_GET_REQUEST_LIST, arg_5_0.guild.id)
