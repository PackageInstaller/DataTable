...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_4 = var_3.Find(var_2_3, "frame/upgrade/content")
	local var_2_5 = arg_2_0._tf

	arg_2_0.upgradeList = var_2_2(var_2_4, var_4.Find(var_2_5, "frame/upgrade/content/tpl"))
	UIItemList = var_1

	local var_2_6 = var_1.New
	local var_2_7 = arg_2_0._tf
	local var_2_8 = var_3.Find(var_2_7, "frame/breakout/content")
	local var_2_9 = arg_2_0._tf

	arg_2_0.breakOutList = var_2_6(var_2_8, var_4.Find(var_2_9, "frame/upgrade/content/tpl"))
	...
	typeof = var_4
	Image = var_2_9
	arg_2_0.inDevelopmentIcon = var_2_15(var_2_14, var_4(var_2_9))
	...
	typeof = var_4
	Text = var_2_9
	arg_2_0.inDevelopmentName = var_2_18(var_2_17, var_4(var_2_9))
	...
	typeof = var_4
	Text = var_2_9
	arg_2_0.inDevelopmentLevel1Txt = var_2_21(var_2_20, var_4(var_2_9))
	...
	typeof = var_4
	Text = var_2_9
	arg_2_0.inDevelopmentLevel2Txt = var_2_24(var_2_23, var_4(var_2_9))
	...
	typeof = var_4
	Text = var_2_9
	arg_2_0.inDevelopmentLevel1Desc = var_2_27(var_2_26, var_4(var_2_9))
	...
	typeof = var_4
	Text = var_2_9
	arg_2_0.inDevelopmentLevel2Desc = var_2_30(var_2_29, var_4(var_2_9))
	...
	typeof = var_4
	Text = var_2_9
	arg_2_0.inDevelopmentProgressTxt = var_2_34(var_2_33, var_4(var_2_9))
	...
	local var_2_38 = var_3.Find(var_2_37, "level1/level/label")

	i18n = var_4

	var_1(var_2_38, var_4("guild_tech_label_max_level"))

	setText = var_1

	local var_2_39 = arg_2_0.inDevelopmentPanel
	local var_2_40 = var_3.Find(var_2_39, "level2/level/label")

	i18n = var_4

	var_1(var_2_40, var_4("guild_tech_label_max_level"))

	setText = var_1

	local var_2_41 = arg_2_0.inDevelopmentPanel
	local var_2_42 = var_3.Find(var_2_41, "progress/title/Text")

	i18n = var_4

	var_1(var_2_42, var_4("guild_tech_label_dev_progress"))

	setText = var_1

	local var_2_43 = arg_2_0.inDevelopmentPanel
	local var_2_44 = var_3.Find(var_2_43, "progress/title/label")

	i18n = var_4

	var_1(var_2_44, var_4("guild_tech_label_condition"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_6(arg_4_0)
		...
		var_2_10001(var_3.Find(var_4_2, "on"), arg_4_0)

		setActive = var_2_10001

		local var_4_3 = arg_3_0.toggle

		var_2_10001(var_3.Find(var_4_3, "off"), not arg_4_0)
	...
	local function var_3_9()
		...
		var_5_1(var_5_0, var_2_10003.ON_OPEN_OFFICE)
...
function var_0_1.Update(arg_8_0, arg_8_1)
	...
	arg_8_0.activityGroup = var_2.detect(arg_8_0.technologyGroupVOs, function(arg_9_0)
		...
		GuildTechnologyGroup = var_2_10002

		return var_9_0 == var_2_10002.STATE_START
	end)
	GuildMember = var_2
...
function var_0_1.InitBreakOutList(arg_16_0, arg_16_1)
	...
	var_2.make(var_16_0, function(arg_18_0, arg_18_1, arg_18_2)
		...
		if arg_18_0 == var_2_10003.EventUpdate then
			...
			var_6(var_4._tf, not var_18_2)

			setActive = var_6

			var_6(arg_18_2:Find("back"), var_18_2)
			...
			if var_18_2 then
				...
				local var_18_5 = arg_18_2.Find(var_18_4, "back")
				...
				var_6(var_18_3, var_18_5, var_18_6, var_18_4)
...
function var_0_1.InitDevingItem(arg_20_0)
	...
	if var_20_2 ~= 0 then
		...
		GuildConst = var_1_10012
		var_20_5 = var_1_10012.GET_TECHNOLOGY_DESC(var_1:getConfig("effect_args"), var_1:getConfig("num"))
		GuildConst = var_12
	...
	local var_20_9 = arg_20_0.inDevelopmentLevel2Txt

	var_20_9.text = var_20_6
	setFillAmount = var_20_9

	var_20_9(arg_20_0.inDevelopmentProgress, var_20_7 / var_20_8)
