...
function var_0_0.UpdateStyle(arg_10_0)
	...
	local var_10_2 = not arg_10_0.IsUnLock(var_10_1)
	local var_10_3 = arg_10_0:IsMain()

	setActive = var_10_1

	var_10_1(arg_10_0.subLockBg, not var_10_0 and not var_10_3 and var_10_2)

	setActive = var_10_1

	var_10_1(arg_10_0.subUnlockBg, not var_10_0 and not var_10_3 and not var_10_2)

	setActive = var_10_1

	var_10_1(arg_10_0.unlockBg, not var_10_0 and var_10_3 and not var_10_2)

	setActive = var_10_1

	var_10_1(arg_10_0.lockBg, not var_10_0 and var_10_3 and var_10_2)
...
function var_0_0.UpdateTip(arg_11_0)
	...
	if arg_11_0:IsUnLock() then
		local var_11_0 = arg_11_0.data

		if var_1.CanFormation(var_11_0) then
			var_11_1 = not arg_11_0:IsFinish()
		end
	end

	setActive = var_1_10002

	var_1_10002(arg_11_0.tip, var_11_1)
...
function var_0_0.UpdateLineStyle(arg_12_0)
	...
	local function var_12_1(arg_13_0, arg_13_1)
		if arg_13_0.gameObject.name == "line" then
			...
			local var_13_2 = var_13_1(var_13_0, var_2_10005(var_2_10007))

			GetSpriteFromAtlas = var_2_10003
			var_13_2.sprite = var_2_10003("ui/guildmissionui_atlas", arg_13_1 .. "_line")
		elseif arg_13_0.gameObject.name == "head" then
			...
			local var_13_5 = var_13_4(var_13_3, var_2_10005(var_2_10007))

			GetSpriteFromAtlas = var_2_10003
			var_13_5.sprite = var_2_10003("ui/guildmissionui_atlas", arg_13_1)
	...
	for iter_12_0, iter_12_1 in var_1_10003(arg_12_0.childs) do
		local var_12_3 = arg_12_0.lines[iter_12_1]
		local var_12_4 = iter_12_1:IsMain()

		ipairs = var_1_10010

		for iter_12_2, iter_12_3 in var_1_10010(var_12_3) do
			local var_12_5

			if (not var_12_2 or not var_0_4[2]) and (not var_12_4 or not var_0_4[3]) then
				var_12_5 = var_0_4[1]
			end
	...
	if arg_12_0.parent then
		local var_12_9 = arg_12_0.parent

		var_12_8 = var_6.IsFinish(var_12_9)
	end
	...
	for iter_12_4, iter_12_5 in var_6(var_12_6) do
		...
		if iter_12_5.type == var_0_0.LINE_LEFT then
			var_12_10 = (var_12_2 or var_12_8) and var_0_4[2] or var_12_7 and var_0_4[3] or var_0_4[1]
		else
			var_12_10 = var_12_2 and var_0_4[2] or var_12_7 and var_0_4[3] or var_0_4[1]
		end

		var_12_1(iter_12_5.tf, var_12_10)
	end
...
function var_0_0.CalcOffset(arg_16_0)
	...
	if #arg_16_0.parent.childs == 2 then
		...
		if var_1_10006.abs(var_16_1 + var_16_3) <= var_16_4 then
