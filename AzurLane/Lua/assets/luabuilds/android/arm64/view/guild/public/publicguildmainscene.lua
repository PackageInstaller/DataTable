...
function var_0_1.OnUpdateDonateList(arg_2_0)
	if arg_2_0.page then
		...
		PublicGuildOfficePage = var_1_10004

		if var_1(var_2_0, var_1_10004) then
...
function var_0_1.OnTechGroupUpdate(arg_4_0, arg_4_1)
	if arg_4_0.page then
		...
		PublicGuildTechnologyPage = var_1_10005

		if var_2(var_4_0, var_1_10005) then
...
function var_0_1.init(arg_8_0)
	...
	PublicGuildOfficePage = var_8_6
	var_8_8[1] = var_8_6.New(var_8_7, arg_8_0.event)
...
function var_0_1.didEnter(arg_9_0)
	...
	var_9_1(var_9_0, var_4.Find(var_9_2, "bg/painting"))
	...
	var_1(var_9_4, var_9_5, var_9_6, var_9_2)
	...
	local function var_9_9()
		...
		PublicGuildOfficePage = var_2_10003

		local var_11_2

		if var_2_10000(var_11_0, var_2_10003) then
			pg = var_11_2
			...
			i18n = var_2_10004
			var_2_10003.helps = var_2_10004("guild_public_office_tip")

			var_11_2(var_11_1, var_2_10003)
		else
			isa = var_11_2

			local var_11_3 = arg_9_0.page

			PublicGuildTechnologyPage = var_2_10003

			if var_11_2(var_11_3, var_2_10003) then
				pg = var_0
				...
				MSGBOX_TYPE_HELP = var_2_10004
				var_11_6.type = var_2_10004
				i18n = var_2_10004
				var_11_6.helps = var_2_10004("guild_public_tech_tip")
	...
	var_1(var_9_7, var_9_8, var_9_9, var_9_2)
	...
	for iter_9_0, iter_9_1 in var_1(arg_9_0.toggles) do
		...
		var_9_2(var_9_10, var_9_11, var_9_12, var_1_10011)

		if iter_9_0 == 1 then
			triggerToggle = var_9_2

			var_9_2(iter_9_1, true)
		end
	end
