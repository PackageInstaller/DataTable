...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_6()
		if arg_3_0.guildVO then
			...
			i18n = var_2_10004
			var_5_2.content = var_2_10004("guild_tip_dissolve")
			...
			function var_5_2.onYes()
				...
				var_6_1(var_6_0, var_3_10003.DISSOLVE, arg_3_0.guildVO.id)
	...
	local function var_3_9()
		...
		var_2_10000({
			...
			var_9_1(var_9_0, var_3_10003.QUIT, arg_3_0.guildVO.id)
	...
	local function var_3_15()
		...
		if not var_11_1 or var_11_1 == "" then
			...
			var_2_10003(var_11_3, var_2_10006("guild_create_error_noname"))
		...
		if var_11_1 ~= var_3.getName(var_11_4) then
			...
			if var_4.getTotalGem(var_11_6) < var_11_5 then
				...
				var_11_7(var_11_6, var_7("common_no_rmb"))
		...
		local function var_11_10()
			...
			if var_12_1 ~= var_1.getPolicy(var_12_2) then
				...
				var_12_4(var_12_3, var_12_5, var_12_6, var_5.getPolicy(var_12_7), "")
			end
			...
			if var_12_9 ~= var_1.getManifesto(var_12_10) then
				...
				var_12_12(var_12_11, var_12_13, var_12_14, var_12_15, var_6.getManifesto(var_12_16))
			end
			...
			if var_12_18 ~= var_1.getName(var_12_19) then
				...
				var_12_21(var_12_20, var_12_22, var_12_23, var_12_24, var_6.getName(var_12_25))
			end
		...
		if var_11_11 ~= var_5.getFaction(var_11_12) then
			...
			i18n = var_8
			var_11_15.content = var_8("guild_faction_change_tip")
			...
			function var_11_15.onYes()
				...
				local var_13_2 = var_3_10003.MODIFY
				local var_13_3 = 2
				local var_13_4 = var_11_0

				var_13_1(var_13_0, var_13_2, var_13_3, var_5.getFaction(var_13_4), "")
	...
	;(function(arg_14_0)
		...
		var_2_10001(arg_3_0, arg_14_0, function()
			...
			local var_15_1, var_15_2 = var_3_10001(var_15_0, {
				isReplace = true
			})
...
function var_0_1.DealQuit(arg_16_0, arg_16_1)
	...
	if not var_2.GetActiveEvent(var_16_0) or var_2 and not var_2:IsParticipant() then
		...
		local var_16_1 = var_1_10003.MsgboxMgr.GetInstance()
		local var_16_2 = var_3.ShowMsgBox
		local var_16_3 = {}

		i18n = var_1_10007
		var_16_3.content = var_1_10007("guild_tip_quit")
	...
	if var_16_5 + var_2.GetExtraJoinCnt(var_16_6) <= 0 then
		...
		do
			local var_16_7 = var_1_10007.format("<color=%s>%d</color>/%d", var_6, var_5, var_4)

			pg = var_16_6

			local var_16_8 = var_16_6.MsgboxMgr.GetInstance()
			local var_16_9 = var_8.ShowMsgBox
			local var_16_10 = {}

			i18n = var_12
			var_16_10.content = var_12("guild_tip_quit_operation", var_16_7)
...
function var_0_1.DealBattleReportAward(arg_17_0, arg_17_1)
	...
	local function var_17_1()
		...
		var_18_1(var_18_0, var_2_10003.SUBMIT_GUILD_REPORT, {
			ids = var_0,
			callback = arg_17_1
		})
	...
	local var_17_2 = var_17_0.MsgboxMgr.GetInstance()
	local var_17_3 = var_4.ShowMsgBox
	local var_17_4 = {}

	i18n = var_1_10008
	var_17_4.content = var_1_10008("guild_exist_report_award_when_exit")
	...
	function var_17_4.onNo()
		...
		var_19_1(var_19_0, var_2_10003.QUIT, arg_17_0.guildVO.id)
...
function var_0_1.Show(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_6 = var_20_5 == var_4.DUTY_COMMANDER
	...
	var_20_4(var_20_10, var_8.inChangefactionTime(var_20_11))
	...
	if var_20_9 then
		...
		setText = var_20_8
		var_20_11 = arg_20_0.factionMask

		var_20_8(var_8.Find(var_20_11, "timer_container/Text"), var_20_13)
	end

	local var_20_14 = arg_20_0.guildVO

	arg_20_0.faction = var_5.getFaction(var_20_14)
	onToggle = var_5

	local var_20_15 = arg_20_0
	local var_20_16 = arg_20_0.factionBLHXToggle

	local function var_20_17(arg_21_0)
		if arg_21_0 then
	...
	var_5(var_20_15, var_20_16, var_20_17, var_20_11)

	onToggle = var_5

	local var_20_18 = arg_20_0
	local var_20_19 = arg_20_0.factionCSZZToggle

	local function var_20_20(arg_22_0)
		if arg_22_0 then
	...
	var_5(var_20_18, var_20_19, var_20_20, var_20_11)

	local var_20_21 = arg_20_0.guildVO

	arg_20_0.policy = var_5.getPolicy(var_20_21)
	onToggle = var_5

	local var_20_22 = arg_20_0
	local var_20_23 = arg_20_0.policyRELAXToggle

	local function var_20_24(arg_23_0)
		if arg_23_0 then
	...
	var_5(var_20_22, var_20_23, var_20_24, var_20_11)

	onToggle = var_5

	local var_20_25 = arg_20_0
	local var_20_26 = arg_20_0.policyPOWERToggle

	local function var_20_27(arg_24_0)
		if arg_24_0 then
	...
	var_5(var_20_25, var_20_26, var_20_27, var_20_11)

	local var_20_28 = arg_20_0.faction

	GuildConst = var_20_8

	if var_20_28 == var_20_8.FACTION_TYPE_BLHX then
		triggerToggle = var_20_28

		var_20_28(arg_20_0.factionBLHXToggle, true)
	else
		local var_20_29 = arg_20_0.faction

		GuildConst = var_6

		if var_20_29 == var_6.FACTION_TYPE_CSZZ then
			triggerToggle = var_20_29

			var_20_29(arg_20_0.factionCSZZToggle, true)
		end
	end

	local var_20_30 = arg_20_0.policy

	GuildConst = var_6

	if var_20_30 == var_6.POLICY_TYPE_RELAXATION then
		triggerToggle = var_20_30

		var_20_30(arg_20_0.policyRELAXToggle, true)
	else
		local var_20_31 = arg_20_0.policy

		GuildConst = var_6

		if var_20_31 == var_6.POLICY_TYPE_POWER then
			triggerToggle = var_20_31

			var_20_31(arg_20_0.policyPOWERToggle, true)
		end
	end

	local var_20_32 = arg_20_0.policyPOWERToggle
	local var_20_33 = var_5.GetComponent

	typeof = var_20_26
	Toggle = var_20_11
	var_20_33(var_20_32, var_20_26(var_20_11)).interactable = var_20_6

	local var_20_34 = arg_20_0.policyRELAXToggle
	local var_20_35 = var_5.GetComponent

	typeof = var_8
	Toggle = var_20_11
	var_20_35(var_20_34, var_8(var_20_11)).interactable = var_20_6

	local var_20_36 = arg_20_0.factionCSZZToggle
	local var_20_37 = var_5.GetComponent

	typeof = var_8
	Toggle = var_20_11
	var_20_37(var_20_36, var_8(var_20_11)).interactable = var_20_6

	local var_20_38 = arg_20_0.factionBLHXToggle
	local var_20_39 = var_5.GetComponent

	typeof = var_8
	Toggle = var_20_11
	var_20_39(var_20_38, var_8(var_20_11)).interactable = var_20_6

	local var_20_40 = arg_20_0.guildVO
	local var_20_41 = var_5.getDutyByMemberId(var_20_40, arg_20_0.playerVO.id)

	setActive = var_6

	local var_20_42 = arg_20_0.quitBtn

	GuildConst = var_20_27

	var_6(var_20_42, var_20_41 ~= var_20_27.DUTY_COMMANDER)

	setActive = var_6

	local var_20_43 = arg_20_0.dissolveBtn

	GuildConst = var_9

	var_6(var_20_43, var_20_41 == var_9.DUTY_COMMANDER)
