...
function var_0_1.OnRefresh(arg_2_0, arg_2_1)
	...
	var_2_0(var_4.Find(var_2_1, "content"), arg_2_1.content)
	...
	local var_2_4 = var_3.New(var_2_3, var_2_3:GetChild(0))
	...
	var_3.make(var_2_4, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			local var_3_0 = arg_3_2:Find("name_mask/name")

			getText = var_6

			var_3(var_3_0, var_6(arg_3_2:Find("name")))
		end
