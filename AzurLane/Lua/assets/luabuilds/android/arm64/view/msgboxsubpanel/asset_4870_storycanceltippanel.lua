...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_1 = var_3.Find(var_2_0, "Name")

	i18n = var_1_10004

	var_1_10001(var_2_1, var_1_10004("autofight_story"))
...
function var_0_1.OnRefresh(arg_4_0, arg_4_1)
	...
	var_4_1(var_4_0, var_1_10005(1000, 640))
	...
	local var_4_7 = var_4_4.value

	go = var_7

	local var_4_8 = var_4_7(var_7(var_4_3), var_4_6, 0, var_4_6)
	local var_4_9 = var_5.setOnUpdate

	System = var_8

	local var_4_10 = var_4_9(var_4_8, var_8.Action_float(function(arg_5_0)
		...
		var_2_10001(var_5_0, arg_5_0 - var_2_10004.floor(arg_5_0))
		...
		local var_5_2 = var_4.clamp

		math = var_6

		var_2_10001(var_5_1, var_5_2(var_6.ceil(arg_5_0), 0, var_4_6))
	...
	var_4_11(var_4_10, var_8.Action(function()
...
function var_0_1.OnDestory(arg_8_0)
	...
	var_8_0(var_3.Find(var_8_1, "CircleProgress"))
