...
function var_0_1.SetMonthCardEndDateLocal()
	...
	if not var_1_2(var_1_1, var_1_10004.MONTH) or var_1.leftDate == 0 then
		return
	end

	PlayerPrefs = var_1_0

	var_1_0.SetInt("MonthCardEndDate" .. var_0.id, var_1:getLeftDate())
...
function var_0_1.GetMonthCardEndDate()
	...
	return var_1_10001.GetInt("MonthCardEndDate" .. var_0.id, 0)
end
...
function var_0_1.SetMonthCardTipDate(arg_3_0)
	...
	var_1_10002.SetInt("MonthCardTipDate" .. var_1.id, arg_3_0)
...
function var_0_1.GetMonthCardTipDate()
	...
	return var_1_10001.GetInt("MonthCardTipDate" .. var_0.id, 0)
end
...
function var_0_1.SetMonthCardTagDate()
	...
	local var_5_1 = var_1_10001.TimeMgr.GetInstance()
	local var_5_2 = var_1.GetNextTime(var_5_1, 0, 0, 0)

	PlayerPrefs = var_5_0

	var_5_0.SetInt("MonthCardTagDate" .. var_0.id, var_5_2)
...
function var_0_1.GetShowMonthCardTag()
	...
	if not var_6_2(var_6_1, var_1_10004.MONTH) or var_1.leftDate == 0 then
		return false
	end
...
function var_0_1.TryShowMonthCardTipPanel(arg_7_0)
	...
	if var_7_2 >= var_2 - 0 and var_7_3 < var_2 - 0 then
		...
		local var_7_6 = var_7_5(var_7_4, var_1_10008.min(var_7_2, var_2), "*t")

		i18n = var_1_10006

		local var_7_7 = var_1_10006("trade_card_tips4", var_7_6.year, var_7_6.month, var_7_6.day)

		pg = var_7_4

		local var_7_8 = var_7_4.TimeMgr.GetInstance()
		local var_7_9 = var_7.STimeDescS(var_7_8, var_2, "*t")

		i18n = var_8

		local var_7_10 = var_8("trade_card_tips4", var_7_9.year, var_7_9.month, var_7_9.day)
		...
		MSGBOX_TYPE_MONTH_CARD_TIP = var_1_10014
		var_7_14.type = var_1_10014
		pg = var_1_10014
		var_7_14.title = var_1_10014.MsgboxMgr.TITLE_INFORMATION
		i18n = var_14
		var_7_14.content = var_14(var_7_11 and "trade_card_tips2" or "trade_card_tips3", var_7_10)
		var_7_14.dateText = var_7_7
		i18n = var_14
		var_7_14.yesText = var_14("trade_card_tips1")
...
function var_0_1.Init(arg_11_0)
	...
	local var_11_1 = var_3.Find(var_11_0, "NameText")

	pg = var_1_10004

	var_1(var_11_1, var_1_10004.ship_data_statistics[312011].name)
...
function var_0_1.UpdateView(arg_12_0, arg_12_1)
	...
	Vector2 = var_1_10003
	var_12_0.sizeDelta = var_1_10003.New(960, 685)
	setText = var_12_0

	local var_12_1 = arg_12_0._tf

	var_12_0(var_4.Find(var_12_1, "Desc"), arg_12_1.content)

	setText = var_12_0

	local var_12_2 = arg_12_0._tf

	var_12_0(var_4.Find(var_12_2, "Date"), arg_12_1.dateText)
