...
function var_0_1.UpdateView(arg_2_0, arg_2_1)
	...
	var_1_10003(var_2_1, var_1_10006(var_2_0))
	...
	Vector2 = var_1_10004
	var_2_2.sizeDelta = var_1_10004.New(1000, 638)
	...
	local var_2_8 = var_2_4("box_account_del_target")

	i18n = var_2_6

	local var_2_9 = var_2_6("box_account_del_input", var_2_8)
	...
	var_7(var_2_10, var_10("box_account_del_click"))
