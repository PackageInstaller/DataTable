...
function var_0_1.GetBGM(arg_2_0)
	...
	local var_2_2 = var_2.IsBGMEnable(var_2_1)

	if var_2_0:IsBgmSkin() and var_2_2 then
...
function var_0_1.ReloadPanting(arg_5_0, arg_5_1)
	if arg_5_0.displaySkinID and arg_5_0.displaySkinID == arg_5_1 then
		...
		local var_5_1 = arg_5_0.GetFlagShip(var_5_0)

		arg_5_0:ReturnPainting()

		local var_5_2 = var_5_1:getPainting()

		setPaintingPrefabAsync = var_5_0

		var_5_0(arg_5_0.painting, var_5_2, "kanban")
...
function var_0_1.init(arg_9_0)
	...
	arg_9_0.mainViewCg = var_9_4(var_9_3, var_4(var_1_10006))
	...
	arg_9_0.detailCg = var_1_10002(var_9_17, var_1_10005(var_1_10007))
	...
	var_9_15(var_9_19, false)

	local var_9_20 = {}

	PlayerVitaeSpineBtn = var_9_18

	local var_9_21 = var_9_18.New
	local var_9_22 = var_9_19

	PlayerVitaeBaseBtn = var_1_10007
	var_9_20[1] = var_9_21(var_9_22, var_1_10007.HRZ_TYPE)
	PlayerVitaeBGBtn = var_4

	local var_9_23 = var_4.New
	local var_9_24 = var_9_19

	PlayerVitaeBaseBtn = var_7
	var_9_20[2] = var_9_23(var_9_24, var_7.HRZ_TYPE)
	...
	PlayerVitaeBaseBtn = var_7
	var_9_20[3] = var_9_25(var_9_26, var_7.HRZ_TYPE)
	...
	PlayerVitaeBaseBtn = var_7
	var_9_20[4] = var_9_27(var_9_28, var_7.HRZ_TYPE)
	...
	for iter_9_0 = 1, #arg_9_0.btns do
		...
		var_9_30(var_9_29, var_10.Find(var_9_31, "adapt/toggleBtns"), #arg_9_0.btns - iter_9_0)
	end
	...
	local var_9_34 = var_3(var_9_33, var_6(var_8))
	...
	local var_9_36 = var_3(var_9_35, var_6(var_8))
	...
	var_3(var_9_37, var_6.Find(var_9_38, "adapt/toggleBtns"))
	...
	local var_9_40 = var_5.Find(var_9_39, "adapt/toggleBtns")
	local var_9_41 = arg_9_0._tf

	var_3(var_9_40, var_6.Find(var_9_41, "detail"), true)

	local var_9_42 = arg_9_0.contextData

	PlayerVitaeRenamePage = var_4
	var_9_42.renamePage = var_4.New(arg_9_0._tf, arg_9_0.event)
	...
	var_4("CommonBG/bg_admiral", function(arg_10_0)
		...
		Color = var_2_10002
		var_10_2.color = var_2_10002.New(1, 1, 1, 1)
...
function var_0_1.didEnter(arg_11_0)
	...
	local function var_11_5()
		...
		var_13_3(var_13_2, var_2_10004.CHANGE_SKIN, var_13_1)
	...
	local function var_11_11()
		...
		var_15_3(var_15_2, var_2_10004.OPEN_CRYPTOLALIA, var_15_1:getGroupId())
...
function var_0_1.UpdateReplaceTip(arg_17_0)
	...
	if not var_4.ShouldEducateCharTip(var_17_1) then
		getProxy = var_17_3
...
function var_0_1.DoEnterAnimation(arg_18_0)
	local function var_18_0(arg_19_0)
		...
		local var_19_3 = var_19_2(var_19_1, var_5.Action_float(function(arg_20_0)
		...
		var_19_5(var_19_4, var_5.easeInOutSine)
	...
	;(function(arg_21_0)
		...
		var_21_3(var_21_2, var_5.easeInOutSine)
...
function var_0_1.UpdatePainting(arg_23_0, arg_23_1)
	...
	for iter_23_0, iter_23_3 in var_1_10005(arg_23_0.btns) do
		if iter_23_3:IsActive(var_23_0) then
			table = var_1_10011

			var_1_10011.insert(var_23_2, iter_23_3)
		end

		var_1_10013 = iter_23_3

		iter_23_3.Update(var_1_10013, var_10, #var_23_2, var_23_0)

		if var_10 and not var_23_1 then
			var_1_10013 = iter_23_3

			if iter_23_3.IsOverlap(var_1_10013, arg_23_0.detailPosx) then
				var_23_1 = true
			end
		end
	end
	...
	if not arg_23_0.displaySkinID or arg_23_0.displaySkinID ~= var_23_0:getSkinId() or arg_23_1 then
		...
		setPaintingPrefabAsync = var_23_6

		var_23_6(arg_23_0.painting, var_23_4, "kanban")

		arg_23_0.paintingName = var_23_4
		HXSet = var_23_6

		if not var_23_6.isHxSkin() then
			getProxy = var_23_6
			ShipSkinProxy = var_8

			local var_23_5 = var_23_6(var_8)

			var_23_6 = var_23_6.HasFashion(var_23_5, var_23_0)
		else
			var_23_6 = false
		end
		...
		setActive = var_23_3
		iter_23_3 = arg_23_0.switchSkinBtn
		...
		if var_23_6 then
			...
			VirtualEducateCharShip = var_1_10013
			var_23_8 = not var_23_8(var_23_7, var_1_10013)
		end

		var_23_3(iter_23_3, var_23_8)

		iter_23_3 = var_23_0
		arg_23_0.displaySkinID = var_23_0.getSkinId(iter_23_3)
	end

	local var_23_9 = var_23_0:getGroupId()
	...
	local var_23_11 = iter_23_3(var_1_10011)
	local var_23_12 = var_9.getRawData(var_23_11)

	var_23_6(var_23_10, var_9.ExistCryptolalia(var_23_12, var_23_9))
...
function var_0_1.updateSwitchSkinBtnTag(arg_25_0)
	...
	local var_25_1 = arg_25_0.switchSkinBtnTag

	PaintingGroupConst = var_1_10005

	var_1_10002(var_25_1, #var_1_10005.GetPaintingNameListByShipVO(var_25_0) > 0)
...
function var_0_1.checkShowResetL2dBtn(arg_27_0)
	...
	if arg_27_0.GetFlagShip(var_27_0) then
		var_1_10004 = var_1

		if var_1.GetSkinConfig(var_1_10004).spine_use_live2d == 1 then
			setActive = var_2
	...
	local var_27_1 = "live2d/"

	string = var_27_0

	local var_27_2 = var_27_1 .. var_27_0.lower(var_1:getPainting())

	HXSet = var_3

	local var_27_3 = var_3.autoHxShiftPath(var_27_2, nil, true)

	checkABExist = var_3

	if not var_3(var_27_3) then
		setActive = var_1_10004

		var_1_10004(arg_27_0.btnLive2dReset, false)
	...
	var_1_10004(arg_27_0.btnLive2dReset, true)

	onButton = var_1_10004

	local var_27_4 = arg_27_0
	local var_27_5 = arg_27_0.btnLive2dReset
	...
	local function var_27_6()
		...
		if var_0.GetFlagShip(var_28_0) then
			...
			var_2_10001.ClearLive2dSave(var_28_2:getSkinId(), var_28_2.id)
	...
	var_1_10004(var_27_4, var_27_5, var_27_6, var_1_10009)
