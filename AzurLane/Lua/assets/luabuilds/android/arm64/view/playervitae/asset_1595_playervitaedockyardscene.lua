...
function var_0_1.init(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1(var_3_0) do
		...
		if var_3_1 == 0 then
			...
			var_8.insert(arg_3_0.selectedIds, var_1_10006)
		else
			table = var_8

			var_8.insert(arg_3_0.selectedMarks, iter_3_1)
		end
	end
...
function var_0_1.selectPhantom(arg_5_0, arg_5_1)
	...
	if var_5_1 or arg_5_0.selectedMax == 1 and arg_5_0:GetSelectCount() > 0 then
		...
		if not var_5_6 then
			if var_5_7 then
				pg = var_8
				var_1_10010 = var_8.TipsMgr.GetInstance()

				var_8.ShowTips(var_1_10010, var_5_7)
			end
	...
	if not var_5_1 then
		...
		if arg_5_0.selectedMax == 0 or arg_5_0:GetSelectCount() < arg_5_0.selectedMax then
			...
			var_5_12(var_5_11, var_1_10010("ship_dockyardScene_error_choiseRoleLess", arg_5_0.selectedMax))
...
function var_0_1.GetConfirmSelect(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_1_10002(arg_9_0.selectedIds) do
		...
		var_1_10007(var_9_1, var_1_10010.PackMark(iter_9_1, 0))
	end
