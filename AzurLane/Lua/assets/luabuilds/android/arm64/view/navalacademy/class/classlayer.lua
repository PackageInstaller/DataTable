...
function var_0_1.OnUpdateResField(arg_5_0, arg_5_1)
	...
	ClassResourceField = var_1_10005

	if not var_1_10002(var_5_0, var_1_10005) then
		return
	end
...
function var_0_1.init(arg_6_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.tranSpeedTxt = var_6_5(var_6_4, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.proficiencyProgressTxt = var_6_8(var_6_7, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.tranProgressTxt = var_6_12(var_6_11, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.exp2ProficiencyRatioTxt = var_6_16(var_6_15, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.chatProficiencyTxt = var_6_21(var_6_20, var_4(var_1_10006))
	...
	local var_6_32 = var_3.Find(var_6_31, "blur_panel/adapt/bottom/progress/book/Text/label")

	i18n = var_6_30

	var_6_25(var_6_32, var_6_30("class_label_gen"))

	setText = var_6_25

	local var_6_33 = arg_6_0._tf
	local var_6_34 = var_3.Find(var_6_33, "blur_panel/adapt/bottom/progress/proficiency/label")

	i18n = var_4

	var_6_25(var_6_34, var_4("class_label_tran"))

	setText = var_6_25

	local var_6_35 = arg_6_0._tf
	local var_6_36 = var_3.Find(var_6_35, "blur_panel/adapt/bottom/upgarde/Text")

	i18n = var_4

	var_6_25(var_6_36, var_4("word_levelup"))
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_2()
		...
		var_8_1(var_8_0, var_2_10003.ON_BACK)
	...
	local function var_7_5()
		...
		i18n = var_2_10004
		var_9_2.helps = var_2_10004("course_class_help")
	...
	local function var_7_11()
		...
		local var_11_2 = var_2_10004.gameset.level_get_proficency.key_value
		local var_11_3 = arg_7_0.resClass
		local var_11_4 = var_5.GetExp2ProficiencyRatio(var_11_3)
		local var_11_5 = arg_7_0.course

		var_11_0.text = var_2_10001(var_11_1, var_11_2, var_11_4 * var_6.getExtraRate(var_11_5))
...
function var_0_1.DisplayChatContent(arg_12_0)
	...
	local var_12_1 = var_3(arg_12_0.chatProficiency)

	Vector3 = var_4

	local var_12_2 = var_12_0(var_12_1, var_4(1.5, 1.5, 1), 0.3)
	local var_12_3 = var_1.setFrom

	Vector3 = var_4

	local var_12_4 = var_12_3(var_12_2, var_4.zero)
	local var_12_5 = var_1.setOnComplete

	System = var_4

	var_12_5(var_12_4, var_4.Action(function()
		...
		local var_13_1 = var_2_10002(arg_12_0.chatProficiency)

		Vector3 = var_2_10003

		local var_13_2 = var_13_0(var_13_1, var_2_10003(0, 0, 0), 0.2)
		local var_13_3 = var_0.setDelay(var_13_2, 2)
		local var_13_4 = var_0.setOnComplete

		System = var_3

		var_13_4(var_13_3, var_3.Action(function()
			IsNil = var_3_10000
...
function var_0_1.FilterStudents(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10003(arg_15_0.shipGroups) do
		table = var_1_10008
...
function var_0_1.InitClassInfo(arg_16_0)
	...
	var_16_3(var_16_2, var_1_10006("course_class_name", var_16_1:getConfig("name_show")))
...
function var_0_1.LoadClassRoom(arg_17_0)
	...
	var_17_1.insert(var_17_0, function(arg_20_0)
		...
		var_20_1.configId = var_4.getConfig(var_20_2, "id")
...
function var_0_1.AddStudent(arg_23_0, arg_23_1, arg_23_2)
	...
	var_23_1(var_23_0, var_1_10006(-0.9, 0.9, 1))
	...
	var_23_3(var_23_2, var_6(37, 62, 0))
...
function var_0_1.AddTeacher(arg_24_0, arg_24_1, arg_24_2)
	...
	var_24_1(var_24_0, var_1_10006(0.9, 0.9, 1))
...
function var_0_1.LoadChar(arg_26_0, arg_26_1, arg_26_2)
	...
	var_3:Load(true, function(arg_27_0)
		...
		var_27_1(var_27_0, var_2_10004.UI)
