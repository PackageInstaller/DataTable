...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.lessonNameTxt = var_2_8(var_2_7, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.lessonDescTxt = var_2_11(var_2_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.lessonExpTxt = var_2_14(var_2_13, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.lessonTimeTxt = var_2_17(var_2_16, var_4(var_1_10006))
	NewNavalTacticsAdditionSkillCard = var_1

	local var_2_18 = var_1.New
	local var_2_19 = arg_2_0._tf

	arg_2_0.skillCard = var_2_18(var_3.Find(var_2_19, "skill/info"))
	...
	local var_2_23 = var_3.Find(var_2_22, "introl/exp_label")

	i18n = var_4

	var_1(var_2_23, var_4("tactics_class_get_exp"))

	setText = var_1

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_3.Find(var_2_24, "introl/timer_label")

	i18n = var_4

	var_1(var_2_25, var_4("tactics_class_spend_time"))

	setText = var_1

	local var_2_26 = arg_2_0.confirmBtn
	local var_2_27 = var_3.Find(var_2_26, "Image")

	i18n = var_4

	var_1(var_2_27, var_4("tactics_class_start"))

	setText = var_1

	local var_2_28 = arg_2_0.cancelBtn
	local var_2_29 = var_3.Find(var_2_28, "Image")

	i18n = var_4

	var_1(var_2_29, var_4("tactics_class_cancel"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_5()
		...
		var_5_3(var_5_2, var_3.ON_LESSON_SELECTED, arg_3_0.student)
	...
	local function var_3_8()
		...
		var_6_1(var_6_0, var_2_10003.ON_RESEL_SKILL, arg_3_0.student)
...
function var_0_1.GetLessons(arg_12_0)
	...
	local var_12_2 = var_12_1(var_12_0, var_1_10004.LESSON_TYPE)

	table = var_1_10002

	var_1_10002.sort(var_12_2, function(arg_13_0, arg_13_1)
...
function var_0_1.UpdateLessons(arg_14_0, arg_14_1, arg_14_2)
	...
	for iter_14_0 = 1, #var_14_0 do
		...
		arg_14_0:UpdateLesson(var_1_10008, var_14_0[iter_14_0], arg_14_1, arg_14_2)
	end
...
function var_0_1.UpdateLesson(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	var_1_10005(var_15_0, var_1_10008.New({
		id = arg_15_2.id,
	...
	var_10(var_15_4, var_15_5, var_15_6, var_1_10015)

	local var_15_7 = var_15_2 == 100 and "" or "EXP" .. var_15_2 .. "%"

	setText = var_11

	var_11(arg_15_1:Find("addition"), var_15_7)
