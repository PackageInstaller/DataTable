...
function var_0_1.ResendCancelOp(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in var_2(arg_4_1) do
		...
		NewNavalTacticsMediator = var_1_10010

		var_4_1(var_4_0, var_1_10010.ON_CANCEL, iter_4_1[1], iter_4_1[2])
	end
...
function var_0_1.BlockEvents(arg_6_0)
	...
	var_1_10001(var_6_0, var_1_10004(var_1_10006)).blocksRaycasts = false
...
function var_0_1.UnblockEvents(arg_7_0)
	...
	typeof = var_1_10004
	CanvasGroup = var_1_10006
	var_1_10001(var_7_0, var_1_10004(var_1_10006)).blocksRaycasts = true
...
function var_0_1.init(arg_11_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_11_0.painting = var_11_2(var_11_1, var_4(var_1_10006))
	...
	NewNavalTacticsStudentsPage = var_1_10002
	arg_11_0.studentsPage = var_1_10002.New(var_11_9, arg_11_0.event)
...
function var_0_1.didEnter(arg_12_0)
	arg_12_0:bind(var_0_1.ON_UNLOCK, function(arg_13_0, arg_13_1)
		...
		var_2.ExecuteAction(var_13_0, "Show", arg_13_1, function()
			...
			NewNavalTacticsMediator = var_3_10003

			var_14_1(var_14_0, var_3_10003.ON_SHOPPING, arg_13_1)
	...
	arg_12_0:bind(var_0_1.ON_ADD_STUDENT, function(arg_15_0, arg_15_1)
		...
		if not var_15_1(var_15_0, var_2_10005.LESSON_TYPE) then
			ItemTipPanel = var_2
			...
			local var_15_5 = var_2_10008("ship_book")

			i18n = var_2_10009

			if not var_15_2(var_15_3, var_5(var_15_4, var_15_5, var_2_10009("ship_book"))) then
				pg = var_2
				...
				var_15_7(var_15_6, var_5("tactics_no_lesson"))
			end
		...
		NewNavalTacticsMediator = var_5

		var_15_9(var_15_8, var_5.ON_SELECT_SHIP, arg_15_1)
	...
	var_1(var_12_0, var_4.mingshiTouchFlagEnabled(var_12_1))
	...
	SFX_CONFIRM = var_12_1

	var_1(var_12_2, var_12_3, var_12_4, var_12_1)
	...
	var_1(var_12_5, var_12_6, var_12_7, var_12_1)
	...
	var_1(var_12_8, var_12_9, var_12_10, var_12_1)
...
function var_0_1.OnUpdateQuickFinishPanel(arg_23_0)
	...
	var_1_10002(arg_23_0.quickFinishPanel, var_23_1 > 0)
	...
	var_1_10002(var_23_2, var_5("skill_learn_tip", var_23_1))
...
function var_0_1.SetPainting(arg_24_0)
	...
	local var_24_4 = var_1_10006(var_1_10008)

	UnityEngine = var_1_10007

	var_24_1(var_24_0, var_24_2, var_24_3, var_24_4, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_25_0)
...
function var_0_1.AddStudentFinish(arg_29_0, arg_29_1)
	...
	if var_2.isActivityNpc(var_29_1) then
		...
		i18n = var_1_10007
		var_29_4.content = var_1_10007("npc_learn_skill_tip")
...
function var_0_1.StartLesson(arg_31_0, arg_31_1, arg_31_2)
	...
	local var_31_2 = arg_31_1.getSkillId(var_31_1, arg_31_2)
	local var_31_3 = arg_31_2:getName()

	ShipSkill = var_31_1

	local var_31_4 = var_31_1.New(arg_31_2.skills[var_31_2], arg_31_2.id)
	local var_31_5 = var_6.GetName(var_31_4)

	pg = var_8

	local var_31_6 = var_8.MsgboxMgr.GetInstance()
	local var_31_7 = var_8.ShowMsgBox
	local var_31_8 = {}

	i18n = var_1_10012
	var_31_8.content = var_1_10012("tactics_lesson_start_tip", var_31_0, var_31_3, var_31_5)
	...
	function var_31_8.onYes()
		...
		if var_0.IsMaxLevel(var_32_0) then
			...
			var_32_2(var_32_1, var_2_10003("tactics_max_level"))
		...
		local var_32_5 = var_2_10003.ON_START
		local var_32_6 = {
			shipId = arg_31_1.shipId
		}
		local var_32_7 = arg_31_1

		var_32_6.skillPos = var_5.getSkillId(var_32_7, arg_31_2)
