...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.levelTxt = var_1_1(var_1_0, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.timeTxt = var_1_3(var_1_2, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.floatTxt = var_1_6(var_1_5, var_5(var_1_10007))
	findTF = var_2
	...
	local var_1_7 = var_4(arg_1_0._tf, "time/label")

	i18n = var_5

	var_2(var_1_7, var_5("class_label_upgrading"))
...
function var_0_1.FloatAni(arg_3_0)
	...
	local var_3_1 = var_3_0(var_1_10003(arg_3_0.bubble), arg_3_0.heigh + 20, 2)
...
function var_0_1.UpdateBubble(arg_4_0)
	...
	local var_4_1 = arg_4_0.GetResField(var_4_0)

	if var_1.HasRes(var_4_1) then
		arg_4_0:FloatAni()
	end
	...
	local function var_4_4()
		...
		var_5_3(var_5_2, var_2_10004.ON_GET_RES, var_5_1:GetResourceType())
...
function var_0_1.PlayGetResAnim(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_6_1(var_4(arg_6_0.floatTF), 30, 1)
...
function var_0_1.UpdateResField(arg_8_0)
	...
	var_3(arg_8_0.timeTF, var_8_1)

	setActive = var_3

	var_3(arg_8_0.nameTF, not var_8_1)
...
function var_0_1.Dispose(arg_13_0)
	...
	if var_13_1(var_13_0(arg_13_0.floatTF)) then
		...
		var_13_2(var_3(arg_13_0.floatTF))
	end
	...
	var_13_3(var_3(arg_13_0.bubble))
