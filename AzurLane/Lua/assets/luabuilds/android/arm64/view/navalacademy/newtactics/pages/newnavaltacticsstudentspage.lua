...
function var_0_1.OnLoaded(arg_5_0)
	...
	NewNavalTacticsShipCard = var_7

	var_5_7(var_5_8, var_7.New(var_5_2, arg_5_0.event))
	...
	NewNavalTacticsEmptyCard = var_7

	var_5_9(var_5_10, var_7.New(var_5_4, arg_5_0.event))
	...
	NewNavalTacticsLockCard = var_7

	var_5_11(var_5_12, var_7.New(var_5_6, arg_5_0.event))
...
function var_0_1.OnInit(arg_6_0)
	...
	local function var_6_2()
		...
		pg = var_2_10004
		var_7_2.helps = var_2_10004.gametip.tactics_lesson_system_introduce.tip
...
function var_0_1.Flush(arg_9_0)
	...
	NavalAcademyProxy = var_9_1

	for iter_9_0 = var_9_3, var_9_1.MAX_SKILL_CLASS_NUM do
