...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.UIlist = var_2_2(var_2_4, var_4.Find(var_2_5, "window/panel/list/item"))
	...
	typeof = var_4
	Text = var_2_5
	arg_2_0.totalTxt = var_2_9(var_2_8, var_4(var_2_5))
...
function var_0_1.UpdateList(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	var_4.make(var_8_0, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			var_2_10006(arg_9_2:Find("award/mask"), var_9_3, {
				hideName = true
			})
			...
			local var_9_8 = arg_9_2.Find(var_9_7, "award")
			...
			local function var_9_9()
				...
				var_10_1(var_10_0, var_3_10003.ON_DROP, var_9_3)
			...
			var_9_4(var_9_6, var_9_8, var_9_9, var_9_7)

			local var_9_10 = arg_8_0.ptData
			local var_9_11 = var_6.GetDroptItemState(var_9_10, arg_9_1 + 1)

			ActivityPtData = var_7

			if var_9_11 == var_7.STATE_LOCK then
				setActive = var_7
				...
				if var_9_11 == var_7.STATE_CAN_GET then
					setActive = var_7
	...
	scrollTo = var_1_10005

	var_1_10005(arg_8_0.scrollPanel, 0, 1 - arg_8_3 * 17 / (#arg_8_2 * 17 - 7 - 591))
	...
	if var_5.CanGetAward(var_8_4) then
		...
		local function var_8_7()
			...
			local var_11_6 = var_4(var_6)
			local var_11_7 = var_4.getRawData(var_11_6)

			pg = var_6

			local var_11_8 = var_6.gameset.urpt_chapter_max.description[1]

			LOCK_UR_SHIP = var_11_6

			if var_11_6 then
				var_11_6 = 0
			else
				getProxy = var_11_6
				BagProxy = var_2_10009

				local var_11_9 = var_11_6(var_2_10009)

				var_11_6 = var_11_6.GetLimitCntById(var_11_9, var_11_8)
			end

			Task = var_2_10008

			local var_11_10, var_11_11 = var_2_10008.StaticJudgeOverflow(var_11_7.gold, var_11_7.oil, var_11_6, true, true, var_11_1)
			...
			var_10(var_11_0, function()
				...
				ChildishnessSchoolPtMediator = var_3_10004

				local var_13_4 = var_3_10004.EVENT_PT_OPERATION
				local var_13_5 = {
					cmd = 4
				}
				local var_13_6 = arg_8_0.ptData

				var_13_5.activity_id = var_6.GetId(var_13_6)
		...
		var_5(var_8_5, var_8_6, var_8_7, var_10)
	else
		setActive = var_5
...
function var_0_1.UpdatePtData(arg_15_0)
	...
	local var_15_2 = var_15_1(var_15_0, var_1_10004.ALVIT_PT_ACT_ID)

	ActivityPtData = var_1_10002
	arg_15_0.ptData = var_1_10002.New(var_15_2)
