...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.mainAnim = var_2_1(var_2_0, var_1_10004(var_1_10006))
	...
	local var_2_6 = var_2_5(var_2_4, var_1_10005(var_1_10007))
...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_6 = var_4.Find(var_3_5, "home")
	...
	local var_3_10 = var_4.Find(var_3_9, "help")
	...
	local function var_3_11()
		...
		pg = var_2_10004
		var_6_2.helps = var_2_10004.gametip["202406_main_help"].tip
	...
	local function var_3_14()
		...
		KindergartenMediator = var_2_10003
		...
		TongXinSpringMediator = var_2_10007
		var_7_4.mediator = var_2_10007
		TongXinSpringLayer = var_2_10007
	...
	var_1_10001(var_3_15, var_3_16, var_3_17, var_3_9)
	...
	var_1_10001(var_3_18, var_3_19, var_3_20, var_3_9)
	...
	local function var_3_23()
		...
		var_10_1(var_10_0, var_2_10003.ON_EXTRA_RANK)
	...
	var_1_10001(var_3_21, var_3_22, var_3_23, var_3_9)
	...
	var_1_10001(var_3_24, var_3_25, var_3_26, var_3_9)
...
function var_0_1.UpdatePt(arg_13_0)
	...
	if var_13_1(var_13_0, var_1_10004.ALVIT_PT_ACT_ID) and not var_1:isEnd() then
		setActive = var_1_10002

		var_1_10002(arg_13_0.ptBtn, true)

		setActive = var_1_10002

		var_1_10002(arg_13_0.ptTip, var_0_1.ShowPtTip(var_1))

		setText = var_1_10002

		var_1_10002(arg_13_0.ptValue, var_1.data1)
	else
		setActive = var_1_10002

		var_1_10002(arg_13_0.ptBtn, false)
	end
...
function var_0_1.UpdateTask(arg_14_0)
	...
	if var_14_1(var_14_0, var_1_10004.ALVIT_TASK_ACT_ID) and not var_1:isEnd() then
		setActive = var_1_10002

		var_1_10002(arg_14_0.taskBtn, true)

		setActive = var_1_10002

		var_1_10002(arg_14_0.taskTip, var_0_1.ShowTaskTip(var_1))
	else
		setActive = var_1_10002

		var_1_10002(arg_14_0.taskBtn, false)
	end
...
function var_0_1.UpdateParadise(arg_15_0)
	...
	if var_15_1(var_15_0, var_1_10004.ACTIVITY_TYPE_HOTSPRING) and not var_1:isEnd() then
		setActive = var_1_10002

		var_1_10002(arg_15_0.paradiseBtn, true)

		local var_15_2 = var_1

		var_1_10002 = #var_1.GetAvaliableShipIds(var_15_2)

		local var_15_3 = var_1:GetTotalSlotCount()
		...
		var_15_2(var_15_4, var_1_10007.format("(%d/%d)", var_1_10002, var_15_3))
	else
		setActive = var_1_10002

		var_1_10002(arg_15_0.paradiseBtn, false)
	end
...
function var_0_1.ShowPtTip(arg_17_0)
	...
	if not arg_17_0 then
		...
		local var_17_0 = var_17_1(var_1_10003)

		var_17_1 = var_17_1.getActivityById
		ActivityConst = var_1_10004
		var_17_1 = var_17_1(var_17_0, var_1_10004.ALVIT_PT_ACT_ID)
	end

	Activity = var_1_10002

	return var_1_10002.IsActivityReady(var_17_1)
end
...
function var_0_1.ShowTaskTip(arg_18_0)
	...
	if not arg_18_0 then
		...
		local var_18_0 = var_18_1(var_1_10003)

		var_18_1 = var_18_1.getActivityById
		ActivityConst = var_1_10004
		var_18_1 = var_18_1(var_18_0, var_1_10004.ALVIT_TASK_ACT_ID)
	end

	Activity = var_1_10002

	return var_1_10002.IsActivityReady(var_18_1)
end
