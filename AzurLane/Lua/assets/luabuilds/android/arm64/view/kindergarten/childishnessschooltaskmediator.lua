...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10006.SUBMIT_TASK, arg_3_1.id, arg_3_2)
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_1 == var_6_0.SUBMIT_TASK_DONE then
		...
		var_6_4(var_6_3, var_1_10007.ON_ACHIEVE, var_6_2)
	...
	if var_6_1 ~= var_6_4.SUBMIT_AVATAR_TASK_DONE then
		GAME = var_4

		if var_6_1 == var_4.SUBMIT_ACTIVITY_TASK_DONE then
			local var_6_6 = arg_6_0.viewComponent
			local var_6_7 = var_4.emit

			BaseUI = var_1_10007

			var_6_7(var_6_6, var_1_10007.ON_ACHIEVE, var_6_2.awards)
