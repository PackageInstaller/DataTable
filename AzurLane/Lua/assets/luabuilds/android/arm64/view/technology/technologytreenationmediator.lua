...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10004.CLICK_UP_TEC_BTN, function(arg_2_0, arg_2_1, arg_2_2)
		local var_2_0 = arg_1_0
		local var_2_1 = var_3.sendNotification

		GAME = var_2_10006

		var_2_1(var_2_0, var_2_10006.START_CAMP_TEC, {
			tecID = arg_2_1,
			levelID = arg_2_2
		})
	...
	var_1_3(var_1_2, var_4.FINISH_UP_TEC, function(arg_3_0, arg_3_1, arg_3_2)
		local var_3_0 = arg_1_0
		local var_3_1 = var_3.sendNotification

		GAME = var_2_10006

		var_3_1(var_3_0, var_2_10006.FINISH_CAMP_TEC, {
			tecID = arg_3_1,
			levelID = arg_3_2
		})
	...
	var_1_5(var_1_4, var_4.OPEN_ALL_BUFF_DETAIL, function()
		...
		AllBuffDetailMediator = var_2_10006
		var_4_3.mediator = var_2_10006
		AllBuffDetailLayer = var_2_10006
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_1 == var_4.START_TEC_BTN_SUCCESS then
		...
		if var_6_1 == var_4.FINISH_TEC_SUCCESS then
			...
			if var_6_1 == var_4.CLOSE_TECHNOLOGY_NATION_LAYER_NOTIFICATION then
				...
				if var_6_1 == var_4.GOT_TEC_CAMP_AWARD then
					...
					var_7.updateTecItem(var_6_14, var_6_12)

					local var_6_15 = arg_6_0.viewComponent

					var_7.updateOneStepBtn(var_6_15)

					local var_6_16 = arg_6_0.viewComponent

					var_7.updateAllTecItemRp(var_6_16)

					local var_6_17 = arg_6_0.viewComponent
					local var_6_18 = var_7.emit

					BaseUI = var_10

					var_6_18(var_6_17, var_10.ON_ACHIEVE, var_6_11)
				else
					TechnologyConst = var_6_11

					if var_6_1 == var_6_11.GOT_TEC_CAMP_AWARD_ONESTEP then
						local var_6_19 = var_6_2.awardList
						local var_6_20 = arg_6_0.viewComponent

						var_5.updateTecItemList(var_6_20)

						local var_6_21 = arg_6_0.viewComponent

						var_5.updateOneStepBtn(var_6_21)

						local var_6_22 = arg_6_0.viewComponent
						local var_6_23 = var_5.emit

						BaseUI = var_1_10008

						var_6_23(var_6_22, var_1_10008.ON_ACHIEVE, var_6_19)
					end
				end
			end
		end
