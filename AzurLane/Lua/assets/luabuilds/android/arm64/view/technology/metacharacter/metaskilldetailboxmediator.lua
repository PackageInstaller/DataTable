...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	if var_3_1 ~= var_3_0.TACTICS_META_UNLOCK_SKILL_DONE then
		GAME = var_4

		if var_3_1 == var_4.TACTICS_META_SWITCH_SKILL_DONE then
			GAME = var_4

			if var_3_1 == var_4.TACTICS_META_SWITCH_SKILL_DONE and arg_3_0.contextData.expInfoList and #var_4 > 0 then
