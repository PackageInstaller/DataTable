...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_ACTIVATION, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.ENERGY_META_ACTIVATION, {
			shipId = arg_2_1
		})
	...
	arg_1_0:bind(var_0_1.ON_PREVIEW, function(arg_3_0, arg_3_1, arg_3_2)
		...
		local var_3_3 = var_2_10007.New
		local var_3_4 = {}

		ShipPreviewLayer = var_2_10010
		var_3_4.viewComponent = var_2_10010
		ShipPreviewMediator = var_2_10010
		var_3_4.mediator = var_2_10010
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_1 == var_5_0.ENERGY_META_ACTIVATION_DONE then
		local var_5_3 = arg_5_0
		local var_5_4 = arg_5_0.addSubLayers

		Context = var_1_10007

		local var_5_5 = var_1_10007.New
		local var_5_6 = {}

		ShipBreakResultLayer = var_1_10010
		var_5_6.viewComponent = var_1_10010
		ShipBreakResultMediator = var_1_10010
		var_5_6.mediator = var_1_10010
		var_5_6.data = {
