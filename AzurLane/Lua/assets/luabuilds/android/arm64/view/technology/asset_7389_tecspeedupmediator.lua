...
local var_0_0 = "TecSpeedUpMediator"
...
function var_0_1.listNotificationInterests(arg_2_0)
	...
	GAME = var_1_10002
	var_2_0[1] = var_1_10002.USE_TEC_SPEEDUP_ITEM_DONE
...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	if var_3_1 == var_3_0.USE_TEC_SPEEDUP_ITEM_DONE then
		local var_3_3 = arg_3_0.viewComponent

		var_4.closeView(var_3_3)
	end
