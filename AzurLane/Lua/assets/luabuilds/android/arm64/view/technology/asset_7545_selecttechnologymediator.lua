...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_TECHNOLOGY, function()
		...
		var_2_1(var_2_0, var_2_2, var_2_10004.TECHNOLOGY)
	...
	arg_1_0:bind(var_0_1.ON_BLUEPRINT, function()
		...
		var_3_1(var_3_0, var_3_2, var_2_10004.SHIPBLUEPRINT)
	...
	var_1_1(var_1_0, var_4.OPEN_TECHNOLOGY_TREE_SCENE, function()
		...
		var_4_1(var_4_0, var_4_2, var_2_10004.TECHNOLOGY_TREE_SCENE)
	...
	arg_1_0:bind(var_0_1.ON_TRANSFORM_EQUIPMENT, function()
		...
		var_5_1(var_5_0, var_5_2, var_2_10004.EQUIPMENT_TRANSFORM)
	...
	arg_1_0.bind(var_1_2, var_0_1.ON_META, function()
		...
		var_6_1(var_6_0, var_6_2, var_2_10004.METACHARACTER)
...
function var_0_1.onBlueprintNotify()
	...
	local var_8_4 = var_8_0.getBluePrints(var_8_3)
	local var_8_5 = var_8_0

	if not var_8_0.getBuildingBluePrint(var_8_5) then
		_ = var_8_3

		local var_8_6 = var_8_3.any

		_ = var_5

		return var_8_6(var_5.values(var_8_4), function(arg_9_0)
			local var_9_0 = arg_9_0:getState()

			ShipBluePrint = var_2_10002

			local var_9_1 = var_9_0 == var_2_10002.STATE_LOCK
			local var_9_2, var_9_3 = arg_9_0:isFinishPrevTask()

			return var_9_1 and var_9_2
		end)
	else
		local var_8_7 = var_2
		local var_8_8 = var_2.getState(var_8_7)

		ShipBluePrint = var_8_5

		if var_8_8 == var_8_5.STATE_DEV_FINISHED then
			return true
		end

		local var_8_9 = false
		local var_8_10 = var_2:getTaskIds()

		_ = var_8_7

		return var_8_7.any(var_8_10, function(arg_10_0)
			...
			local var_10_2 = var_2_10002(var_4)
			local var_10_3 = var_2.isFinishPrevTasks(var_10_2, arg_10_0)

			ShipBluePrint = var_10_0

			local var_10_4

			if var_10_0.TASK_STATE_OPENING then
				var_10_4 = var_10_3
			end
...
function var_0_1.handleNotification(arg_12_0, arg_12_1)
	...
	if var_12_1 == var_12_0.UPDATED then
