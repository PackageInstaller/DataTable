...
function var_0_1.initData(arg_6_0)
	...
	arg_6_0.technologyProxy = var_1_10001(var_1_10003)
	getProxy = var_1
	TaskProxy = var_1_10003
	arg_6_0.taskProxy = var_1(var_1_10003)
	getProxy = var_1
	BagProxy = var_1_10003
	arg_6_0.bagProxy = var_1(var_1_10003)
	...
	local var_6_14 = var_6_12.ceil(var_6_13 / arg_6_0.itemExp)
	local var_6_15 = arg_6_0.bagProxy
	local var_6_16 = var_9.getItemCountById(var_6_15, arg_6_0.itemID)

	math = var_10
	arg_6_0.maxUseNum = var_10.min(var_6_14, var_6_16)
...
function var_0_1.findUI(arg_7_0)
	...
	var_7_1, setText = var_1.Find(var_7_0, "Window/top/bg/obtain/title"), var_1_10002
	i18n = var_1_10005

	var_1_10002(var_7_1, var_1_10005("tec_speedup_title"))
	...
	var_6(var_7_9, var_9.gametip.tec_speedup_help_tip.tip)
...
function var_0_1.addListener(arg_8_0)
	...
	local function var_8_8()
		...
		if var_2.isExpOverFlow(var_11_3) then
			...
			var_2_10005 = {}
			i18n = var_2_10006
			var_2_10005.content = var_2_10006("tec_speedup_overflow", var_11_2)
			...
			function var_2_10005.onYes()
				...
				var_12_1(var_12_0, var_3_10003.USE_TEC_SPEEDUP_ITEM, {
			...
			var_11_7(var_11_6, var_2_10005.USE_TEC_SPEEDUP_ITEM, {
				blueprintid = arg_8_0.shipBluePrintOnDev.id,
				itemid = arg_8_0.itemID,
				number = arg_8_0.curUseNum,
				taskID = arg_8_0.expTaskID
	...
	var_8_12(var_8_17, var_8_18, var_8_19, var_1_10008)
	...
	local var_8_21 = var_8_12(var_8_20, var_8_18(var_1_10008))
	...
	var_3:AddPointUpFunc(function(arg_18_0, arg_18_1)
	...
	local var_8_24 = arg_8_0.addBtn
	local var_8_25 = var_8_22

	SFX_PANEL = var_1_10010

	var_8_20(var_8_23, var_8_24, var_8_25, var_1_10010)

	GetOrAddComponent = var_8_20

	local var_8_26 = arg_8_0.addBtn

	typeof = var_8_24
	EventTriggerListener = var_1_10010

	local var_8_27 = var_8_20(var_8_26, var_8_24(var_1_10010))

	var_5.AddPointDownFunc(var_8_27, function(arg_20_0, arg_20_1)
...
function var_0_1.initTaskPanel(arg_23_0)
	...
	var_1_10002(arg_23_0.taskNameText, var_23_1)
	...
	local var_23_5 = var_1_10006.split
	local var_23_6 = var_23_3

	i18n = var_1_10009

	var_23_0(var_23_4, var_23_5(var_23_6, var_1_10009("tech_catchup_sentence_pauses"))[2])
	...
	local var_23_13 = var_11.floor(var_23_8 / 16)

	math = var_1_10012

	var_23_7(var_23_11, var_23_6(var_23_12, var_23_13, var_1_10012.floor(var_23_10 / 16)))

	local var_23_14 = var_23_8 / var_23_10

	setSlider = var_23_9

	var_23_9(arg_23_0.expProgressSlider, 0, 1, var_23_14)
	...
	var_23_9(var_23_15, var_9.floor(var_23_14 * 100) .. "%")
...
function var_0_1.updateTaskPanel(arg_24_0, arg_24_1)
	...
	local var_24_8 = var_1_10012.floor(var_24_5 / 16)

	math = var_1_10013

	var_24_3(var_24_6, var_1_10009(var_24_7, var_24_8, var_1_10013.floor(var_24_4 / 16)))

	local var_24_9 = var_24_5 / var_24_4

	setSlider = var_7

	var_7(arg_24_0.expProgressSlider, 0, 1, var_24_9)
	...
	var_7(var_24_10, var_10.floor(var_24_9 * 100) .. "%")
...
function var_0_1.initItem(arg_25_0)
	...
	var_1_10002(var_25_0.icon, "", arg_25_0.itemIcon)
	...
	var_1_10002(var_25_1, var_5.getItemCountById(var_25_2, arg_25_0.itemID))

	setText = var_1_10002

	var_1_10002(arg_25_0.itemNameText, var_25_0.name)
