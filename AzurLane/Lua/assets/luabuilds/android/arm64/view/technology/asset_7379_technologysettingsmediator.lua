...
function var_0_1.bindEvent(arg_2_0)
	arg_2_0:bind(var_0_1.CHANGE_TENDENCY, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.CHANGE_REFRESH_TECHNOLOGYS_TENDENCY, {
			pool_id = 2,
			tendency = arg_3_1
		})
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_1 == var_5_0.CHANGE_REFRESH_TECHNOLOGYS_TENDENCY_DONE then
		getProxy = var_5_4
		TechnologyProxy = var_1_10006

		local var_5_3 = var_5_4(var_1_10006)
		...
		if var_5_1 == var_5_4.SELECT_TEC_TARGET_CATCHUP_DONE then
