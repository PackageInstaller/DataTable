...
function var_0_1.initUITextTips(arg_5_0)
	...
	var_5_2(var_5_6, var_1_10007("battle_end_subtitle2"))
	...
	var_5_2(var_5_7, var_7("meta_skill_dailyexp"))
	...
	var_5_2(var_5_8, var_7("meta_skill_learn"))
...
function var_0_1.updateSkillTF(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_10 = var_11_0.Find(var_11_9, "Tag/learing")
	local var_11_11 = var_11_0:Find("Tag/unlockable")

	getProxy = var_11_9
	BayProxy = var_16

	local var_11_12 = var_11_9(var_16)
	...
	getSkillConfig = var_11_12

	local var_11_15 = var_11_12(arg_11_2)

	setImageSprite = var_11_13

	local var_11_16 = var_11_5

	LoadSprite = var_1_10020

	var_11_13(var_11_16, var_1_10020("skillicon/" .. var_11_15.icon))

	setText = var_11_13

	local var_11_17 = var_11_7

	shortenString = var_20
	getSkillName = var_22

	var_11_13(var_11_17, var_20(var_22(var_11_15.id), 8))

	setText = var_11_13

	var_11_13(var_11_8, var_11_14)
	...
	local var_11_21 = var_14
	local var_11_22 = var_14.isSkillLevelMax(var_11_21, arg_11_2)
	local var_11_23 = var_17:getSkillExp(arg_11_2)

	pg = var_11_21

	if not (var_11_14 >= var_11_21.skill_data_template[arg_11_2].max_level) then
		if var_11_20 then
			MetaCharacterConst = var_24

			local var_11_24 = var_24.getMetaSkillTacticsConfig(arg_11_2, var_11_14).need_exp
			...
			var_24(var_11_6, false)

			setActive = var_24

			var_24(var_11_4, false)
		end
	else
		setText = var_24

		var_24(var_11_6, var_11_23 .. "/Max")

		setSlider = var_24

		var_24(var_11_4, 0, 1, 1)

		setActive = var_24

		var_24(var_11_6, true)

		setActive = var_24

		var_24(var_11_4, true)
	end

	setActive = var_24

	var_24(var_11_1, var_11_19 and not var_11_22)

	setActive = var_24

	var_24(var_11_10, var_11_19 and not var_11_22)

	setActive = var_24

	var_24(var_11_11, not var_11_20)

	setActive = var_24

	var_24(var_11_3, not var_11_20)
	...
	local function var_11_27(arg_12_0)
		if arg_12_0 then
			if not var_11_20 then
				...
				MSGBOX_TYPE_META_SKILL_UNLOCK = var_2_10005
				var_2_10004.type = var_2_10005
				var_2_10004.metaShipVO = var_0
				var_2_10004.skillID = arg_11_2

				var_12_1(var_12_0, var_2_10004)
			elseif not var_11_19 and not var_11_22 then
				pg = var_1
				...
				getSkillName = var_2_10008
				var_2_10004.content = var_2_10005(var_12_4, var_2_10008(arg_11_2))
				...
				function var_2_10004.onYes()
					...
					var_13_1(var_13_0, var_3_10003.TACTICS_META_SWITCH_SKILL, {
				...
				var_12_3(var_12_2, var_2_10004)
			elseif var_11_22 then
				pg = var_1
				...
				var_12_6(var_12_5, var_2_10004("meta_skill_maxtip2"))
			end
		end
	...
	var_24(var_11_25, var_11_26, var_11_27, var_1_10029)
...
function var_0_1.updateSkillList(arg_14_0)
	...
	local var_14_2 = var_1_10002.getTacticsSkillIDListByShipConfigID(var_14_1.configId)
...
function var_0_1.updateShipDetail(arg_16_0)
	...
	var_4(var_16_4, var_1_10007(var_16_3, var_16_2))
	...
	setColorStr = var_16_5

	local var_16_7 = var_16_5(var_16_6, "#FFF152FF")
	local var_16_8 = "/"
