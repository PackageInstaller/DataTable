...
function var_0_1.initUITextTips(arg_5_0)
	...
	var_5_4(var_5_8, var_1_10008("meta_pt_point"))
	...
	var_5_4(var_5_9, var_8("meta_pt_point"))
	...
	var_5_4(var_5_10, var_8("meta_award_get"))
	...
	var_5_4(var_5_11, var_8("meta_award_got"))
...
function var_0_1.updateAwardTpl(arg_14_0, arg_14_1, arg_14_2)
	...
	local function var_14_19()
		...
		var_15_1(var_15_0, var_2_10003.ON_DROP, var_14_16)
	...
	var_20(var_14_17, var_14_18, var_14_19, var_1_10025)
	...
	if arg_14_2 < arg_14_0.ptData.level + 1 then
		...
		var_1_10021(var_4, true)

		setActive = var_1_10021

		var_1_10021(var_14_2, true)

		setActive = var_1_10021

		var_1_10021(var_14_3, false)

		setActive = var_1_10021

		var_1_10021(var_7, false)

		setActive = var_1_10021

		var_1_10021(var_9, true)

		setActive = var_1_10021

		var_1_10021(var_14_12, false)

		setActive = var_1_10021

		var_1_10021(var_14_13, true)

		setActive = var_1_10021

		var_1_10021(var_14_8, false)

		setActive = var_1_10021

		var_1_10021(var_14_9, true)

		setActive = var_1_10021

		var_1_10021(var_14_10, false)
	elseif arg_14_0.ptData.count < var_14_15 then
		...
		var_1_10021(var_14_2, false)

		setActive = var_1_10021

		var_1_10021(var_14_3, true)
		...
		var_1_10021(var_14_9, false)

		setActive = var_1_10021

		var_1_10021(var_14_10, true)
	else
		setActive = var_1_10021

		var_1_10021(var_4, false)
		...
		var_1_10021(var_7, true)

		setActive = var_1_10021

		var_1_10021(var_9, false)

		setActive = var_1_10021

		var_1_10021(var_14_12, true)

		setActive = var_1_10021

		var_1_10021(var_14_13, false)

		setActive = var_1_10021

		var_1_10021(var_14_8, true)
...
function var_0_1.updatePTInfo(arg_16_0)
	...
	var_1_10001(var_16_0, var_1_10004(var_6.getPtIconPath(var_16_1)))
