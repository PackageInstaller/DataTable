...
function var_0_1.initUITextTips(arg_5_0)
	...
	var_5_1, setText = var_1.Find(var_5_0, "PTPanel/TipText"), var_1_10002
	i18n = var_1_10005

	var_1_10002(var_5_1, var_1_10005("meta_cur_pt"))

	local var_5_2 = arg_5_0._tf
	local var_5_3

	var_5_3, setText = var_2.Find(var_5_2, "TaskPanel/ActTimePanel/Tip"), var_5_0
	i18n = var_1_10006

	var_5_0(var_5_3, var_1_10006("meta_acttime_limit"))
...
function var_0_1.findUI(arg_8_0)
	...
	arg_8_0.scrollSC = var_1(var_3.Find(var_8_12, "Scroll"), "ScrollRect")
...
function var_0_1.addListener(arg_9_0)
	...
	local function var_9_2()
		...
		local var_10_3 = var_10_0.m02
		local var_10_4 = var_2.sendNotification

		GAME = var_2_10005

		var_10_4(var_10_3, var_2_10005.GET_META_PT_AWARD, {
	...
	var_1_10001(arg_9_0, arg_9_0.getNextBtn, function()
		...
		var_12_1(var_12_0, var_2_10003("meta_pt_notenough"))
...
function var_0_1.updateActTimePanel(arg_15_0)
	...
	if var_1_10002(var_15_0.timeConfig) == "string" then
		...
		if var_2(var_15_0.timeConfig) == "table" then
			...
			local var_15_3 = var_1_10003.TimeMgr.GetInstance()
			local var_15_4 = var_3.GetServerTime(var_15_3)

			pg = var_15_1

			local var_15_5 = var_15_1.TimeMgr.GetInstance()
			...
			var_15_3(var_15_7, var_8("meta_pt_left", var_15_6))
		end
	end
...
function var_0_1.updatePtPanel(arg_17_0)
	...
	var_1_10001(var_17_0, var_1_10004(var_6.getPtIconPath(var_17_1)))
	...
	var_1_10002(var_17_4, var_1_10005.format("%d", var_17_3 * 100) .. "%")
	...
	var_17_2(arg_17_0.ptNumText, var_17_6)
...
function var_0_1.updateTaskTpl(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_8 = arg_20_1.Find(var_20_7, "Info/AwardInfo/Award/Tag/Got")
	local var_20_9 = arg_20_1
	local var_20_10 = arg_20_1.Find(var_20_9, "GotMask")

	setText = var_20_7

	var_20_7(var_20_0, arg_20_2)

	local var_20_11 = arg_20_0.curMetaProgressVO.metaPtData.targets[arg_20_2]

	setText = var_20_9

	var_20_9(var_20_1, var_20_11)

	setImageSprite = var_20_9

	local var_20_12 = var_20_2

	LoadSprite = var_16

	local var_20_13 = arg_20_0.curMetaProgressVO

	var_20_9(var_20_12, var_16(var_18.getPtIconPath(var_20_13)))

	Drop = var_20_9

	local var_20_14 = var_20_9.Create(arg_20_0.curMetaProgressVO.metaPtData.dropList[arg_20_2])

	updateDrop = var_14

	var_14(var_20_5, var_20_14, {
		hideName = true
	})
	...
	local var_20_16 = arg_20_1
	local var_20_17 = arg_20_1.Find(var_20_16, "Info/AwardInfo/Award")
	...
	local function var_20_18()
		...
		var_21_1(var_21_0, var_2_10003.ON_DROP, var_20_14)
	...
	var_14(var_20_15, var_20_17, var_20_18, var_20_16)

	setText = var_14

	local var_20_19 = var_20_3

	shortenString = var_20_17

	var_14(var_20_19, var_20_17(var_20_14:getConfig("name"), 6))

	local var_20_20 = arg_20_0.curMetaProgressVO.unlockPTNum
	...
	var_15(var_20_21, var_20_18.round(var_20_11 / var_20_20 * 100) .. "%")

	if arg_20_2 < arg_20_0.curMetaProgressVO.metaPtData.level + 1 then
		setActive = var_20_19

		var_20_19(var_20_8, true)
		...
		var_20_19(var_20_10, true)

		setGray = var_20_19

		var_20_19(arg_20_1, true, true)
	else
		if arg_20_0.curMetaProgressVO.metaPtData.count < var_20_11 then
			setActive = var_16

			var_16(var_20_8, false)
...
function var_0_1.updateGetAwardBtn(arg_22_0)
	...
	if var_22_1 then
		...
		var_22_0(arg_22_0.getAllBtn, true)

		setActive = var_22_0

		var_22_0(arg_22_0.getAllBtnDisable, false)

		setActive = var_22_0

		var_22_0(arg_22_0.getNextBtn, false)
	elseif var_22_3 then
		setActive = var_22_0

		var_22_0(arg_22_0.getAllBtn, false)
		...
		var_22_0(arg_22_0.getNextBtn, true)
	else
		setActive = var_22_0
		...
		var_22_0(arg_22_0.getAllBtnDisable, true)
...
function var_0_1.moveShipImg(arg_23_0, arg_23_1)
	...
	local var_23_6 = var_1_10009.moveX
	local var_23_7

	rtf = var_1_10011

	local var_23_8 = var_23_5(var_23_4, var_23_6, var_23_7, var_1_10011(arg_23_0.shipImg), var_23_3, 0.3)
...
function var_0_1.movePanel(arg_24_0)
	...
	local var_24_4 = var_1_10006.moveX
	local var_24_5

	rtf = var_1_10008

	local var_24_6 = var_24_3(var_24_2, var_24_4, var_24_5, var_1_10008(arg_24_0.taskPanel), var_24_1, 0.3)
	...
	local var_24_11 = var_8.moveX
	local var_24_12

	rtf = var_10

	local var_24_13 = var_24_10(var_24_9, var_24_11, var_24_12, var_10(arg_24_0.ptPanel), var_24_8, 0.3)
...
function var_0_1.goWorldFunc(arg_28_0)
	...
	MetaCharacterMediator = var_1_10004

	local var_28_2 = var_28_1(var_28_0, var_1_10004)

	pg = var_1_10002

	local var_28_3 = var_1_10002.m02
	...
	local var_28_7 = var_1_10006.GO_SCENE

	SCENE = var_1_10007

	var_28_6(var_28_5, var_28_7, var_1_10007.WORLDBOSS)
