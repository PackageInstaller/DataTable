...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.nationProxy = var_1_10001(var_1_10003)
...
function var_0_1.findUI(arg_9_0)
	...
	if not var_9_8 then
		...
		var_9_8 = var_9_8(var_9_7, var_4(var_1_10006))
		...
		var_9_10, setText = var_2.Find(var_9_9, "CampTecItem/AwardPanel/FinishBtn/Text"), var_9_7
		i18n = var_1_10006

		var_9_7(var_9_10, var_1_10006("tec_nation_award_finish"))
	else
		setActive = var_9_8
...
function var_0_1.addListener(arg_12_0)
	...
	local function var_12_2()
		...
		var_13_1(var_13_0, var_2_10003.GET_CAMP_TEC_AWARD_ONESTEP)
...
function var_0_1.updateTecItemList(arg_14_0)
	...
	var_14_2(var_14_1, #var_5.fleet_tech_group.all)
...
function var_0_1.updateAllTecItemRp(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_1_10002(arg_16_0.panelList) do
		...
		local var_16_6 = var_16_3.fleet_tech_group[iter_16_0].nation[1]
		local var_16_7
		local var_16_8
		...
		if not arg_16_0.tecList[iter_16_0] then
			...
			pg = var_1_10016
			var_16_7 = var_16_9(var_1_10016.fleet_tech_group[iter_16_0].techs, arg_16_0.tecList[iter_16_0].completeID, 1) or 0
		end
		...
		if var_16_7 == 0 then
			...
			local var_16_12 = var_1_10016.fleet_tech_group[iter_16_0].techs[1]

			pg = var_1_10016
			var_16_11 = var_1_10016.fleet_tech_template[var_16_12].pt
		else
			pg = var_1_10016
			...
			if var_16_7 == #var_1_10016.fleet_tech_group[iter_16_0].techs then
				...
				local var_16_13 = var_1_10016.fleet_tech_group[iter_16_0].techs[var_16_7]

				pg = var_1_10016
				var_16_11 = var_1_10016.fleet_tech_template[var_16_13].pt
			else
				pg = var_1_10016

				local var_16_14 = var_1_10016.fleet_tech_group[iter_16_0].techs[var_16_7 + 1]

				pg = var_1_10016
				var_16_11 = var_1_10016.fleet_tech_template[var_16_14].pt
			end
		end

		var_1_10016 = var_16_11 <= var_16_10
		pg = var_1_10017
		var_1_10017 = var_16_7 == #var_1_10017.fleet_tech_group[iter_16_0].techs

		local var_16_15 = var_1_10016 and not var_1_10017

		setActive = var_1_10019

		var_1_10019(var_16_5, var_16_15 and var_16_1)
	end
...
function var_0_1.updateTecItem(arg_17_0, arg_17_1)
	...
	local var_17_16 = var_4
	local var_17_17 = var_4.Find(var_17_16, "LevelText/Text")
	local var_17_18 = var_4
	local var_17_19 = var_4.Find(var_17_18, "PointTextBar")

	pg = var_17_16

	local var_17_20 = var_17_16.fleet_tech_group[arg_17_1].name

	pg = var_17_18

	local var_17_21 = var_17_18.fleet_tech_group[arg_17_1].nation[1]

	setImageSprite = var_22

	local var_17_22 = var_17_5

	GetSpriteFromAtlas = var_1_10025

	var_22(var_17_22, var_1_10025("TecNation", "camptec_nation_bar_" .. var_17_21))

	setImageSprite = var_22

	local var_17_23 = var_17_7

	GetSpriteFromAtlas = var_25

	var_22(var_17_23, var_25("TecNation", "camptec_nation_text_" .. var_17_21), true)

	setImageSprite = var_22

	local var_17_24 = var_17_13

	GetSpriteFromAtlas = var_25

	var_22(var_17_24, var_25("TecNation", "camp_tec_english_" .. var_17_21), true)
	...
	var_22(var_17_25, var_25("TecNation", "camptec_logo_" .. var_17_21))

	setText = var_22

	var_22(var_17_3, var_17_20)
	...
	if not arg_17_0.tecList[arg_17_1] then
		...
		local var_17_28 = var_24.indexof

		pg = var_26
		var_17_26 = var_17_28(var_26.fleet_tech_group[arg_17_1].techs, arg_17_0.tecList[arg_17_1].completeID, 1) or 0
	end

	local var_17_29 = arg_17_0.nationToPoint[var_17_21]
	local var_17_30

	if var_17_26 == 0 then
		pg = var_26
		var_17_27 = var_26.fleet_tech_group[arg_17_1].techs[1]
		pg = var_26
		var_17_30 = var_26.fleet_tech_template[var_17_27].pt
	else
		pg = var_26

		if var_17_26 == #var_26.fleet_tech_group[arg_17_1].techs then
			pg = var_26
			var_17_27 = var_26.fleet_tech_group[arg_17_1].techs[var_17_26]
			pg = var_26
			var_17_30 = var_26.fleet_tech_template[var_17_27].pt
		else
			pg = var_26
			var_17_27 = var_26.fleet_tech_group[arg_17_1].techs[var_17_26 + 1]
			pg = var_26
			var_17_30 = var_26.fleet_tech_template[var_17_27].pt
		end
	end
	...
	var_26:setImageAmount(var_17_14, 0.1 + 0.8 * var_17_29 / var_17_30)

	setText = var_26

	var_26(var_17_17, var_17_26)

	setText = var_26

	var_26(var_17_19, var_17_29 .. "/" .. var_17_30)

	local function var_17_31(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_17_34, var_17_37

	if not arg_17_0.tecList[arg_17_1] then
		if var_17_30 <= var_17_29 then
			var_17_31(false, true, false)
		else
			var_17_31(true, false, false)
		end
	else
		pg = var_17_34

		if var_17_26 == #var_17_34.fleet_tech_group[arg_17_1].techs then
			var_17_31(true, false, false)
		elseif arg_17_0.tecList[arg_17_1].studyID ~= 0 then
			var_17_31(false, false, true)

			if arg_17_0.timerList[arg_17_1] then
				local var_17_32 = arg_17_0.timerList[arg_17_1]

				var_17_34.Stop(var_17_32)
			end

			local var_17_33 = arg_17_0.nationProxy

			var_17_34 = var_17_34.getLeftTime(var_17_33)
			setText = var_17_37

			local var_17_35 = var_17_12

			pg = var_31

			local var_17_36 = var_31.TimeMgr.GetInstance()

			var_17_37(var_17_35, var_31.DescCDTime(var_17_36, var_17_34))

			var_17_37 = arg_17_0.timerList
			Timer = var_17_33
			var_17_37[arg_17_1] = var_17_33.New(function()
				var_17_34 = var_17_34 - 1
				setText = var_0
				...
				local var_19_1 = var_2_10003.TimeMgr.GetInstance()

				var_0(var_19_0, var_3.DescCDTime(var_19_1, var_17_34))
			...
			local var_17_38 = arg_17_0.timerList[arg_17_1]

			var_17_37.Start(var_17_38)
		elseif var_17_30 <= var_17_29 then
			var_17_31(false, true, false)
		else
			var_17_31(true, false, false)
		end
	...
	local var_17_39 = arg_17_0
	local var_17_40 = var_17_9
	...
	local function var_17_41()
		...
		var_20_1(var_20_0, var_2_10003.CLICK_UP_TEC_BTN, arg_17_1, var_17_27)

		return
	end

	SFX_PANEL = var_1_10032

	var_17_34(var_17_39, var_17_40, var_17_41, var_1_10032)

	local var_17_42 = var_2:Find("Mask/DetailPanel")

	GetComponent = var_17_37

	local var_17_43 = var_17_37(var_2, "LayoutElement")
	local var_17_44 = var_17_42:Find("Toggle")

	arg_17_0:updateDetailPanel(var_17_42, var_17_26, arg_17_1, var_17_21, false)
	...
	var_30(arg_17_0, var_4:Find("BG"), function(arg_21_0)
		if arg_21_0 then
			...
			var_2_10001(var_17_44, false)

			LeanTween = var_2_10001
			var_2_10001 = var_2_10001.value
			go = var_2_10003
			var_2_10003 = var_2_10001(var_2_10003(var_0), arg_17_0.tecItemTplOriginWidth, arg_17_0.tecItemTplOriginWidth + var_17_42.rect.width, 0.25)
			var_2_10001 = var_2_10001.setOnUpdate
			System = var_2_10004
			var_2_10003 = var_2_10001(var_2_10003, var_2_10004.Action_float(function(arg_22_0)
				var_17_43.preferredWidth = arg_22_0
			...
			var_2_10001(var_2_10003, var_2_10004.Action(function()
			...
			var_21_0(var_2_10003(var_0))

			local var_21_1 = var_17_43.preferredWidth

			LeanTween = var_2_10002

			local var_21_2 = var_2_10002.value

			go = var_2_10004

			local var_21_3 = var_21_2(var_2_10004(var_0), var_21_1, arg_17_0.tecItemTplOriginWidth, 0.25)
			local var_21_4 = var_2.setOnUpdate

			System = var_5

			var_21_4(var_21_3, var_5.Action_float(function(arg_24_0)
				var_17_43.preferredWidth = arg_24_0
...
function var_0_1.updateDetailPanel(arg_25_0, arg_25_1, arg_25_2, arg_25_3, arg_25_4, arg_25_5)
	...
	local var_25_1 = arg_25_1.Find(var_25_0, "TypeItemContainer")
	local var_25_2 = arg_25_1
	local var_25_3

	var_25_3, setImageSprite = arg_25_1.Find(var_25_2, "BG/Logo"), var_25_0
	GetSpriteFromAtlas = var_1_10011

	var_25_0(var_25_3, var_1_10011("TecNation", "camptec_logo_" .. arg_25_4))

	local var_25_4 = arg_25_1
	local var_25_5 = arg_25_1.Find(var_25_4, "Toggle")

	pg = var_25_2

	if arg_25_2 == #var_25_2.fleet_tech_group[arg_25_3].techs and arg_25_5 == false then
		setActive = var_9

		var_9(var_25_5, false)
	end

	local function var_25_6(arg_26_0, arg_26_1, arg_26_2)
		UIItemList = var_2_10003

		local var_26_0 = var_2_10003.New(var_25_1, arg_25_0.typeItemTpl)
		local var_26_1
		...
		if arg_26_2 then
			...
			var_2_10009, var_26_7, var_26_8 = var_2_10009.calculateCurBuff(var_26_6, arg_26_0 - 1, arg_26_1)
			var_26_4 = var_26_8
			var_26_3 = var_26_7
			var_26_2 = var_2_10009
		end

		pg = var_2_10009

		local var_26_9 = var_2_10009.fleet_tech_template[var_26_1].add
		local var_26_10 = {}
		local var_26_11 = {}

		ipairs = var_12

		for iter_26_0, iter_26_1 in var_12(var_26_9) do
			local var_26_12 = iter_26_1[2]
			local var_26_13 = iter_26_1[3]

			ShipType = var_2_10019
			var_2_10019 = var_2_10019.FilterOverQuZhuType(iter_26_1[1])
			ipairs = var_2_10020

			for iter_26_2, iter_26_3 in var_2_10020(var_2_10019) do
				local var_26_14
				...
				if arg_26_2 then
					...
					if not var_2_10026.indexof(var_26_2, iter_26_3, 1) then
						...
						if not var_2_10026.indexof(var_26_3[iter_26_3], var_26_12, 1) then
							var_26_14 = {
								attr = var_26_12,
								value = var_26_13,
								attrColor = var_26_5,
						...
						elseif var_26_13 ~= var_26_4[iter_26_3][var_26_12] then
							var_26_14 = {
								attr = var_26_12,
								value = var_26_13,
								valueColor = var_26_5
				...
				if var_26_10[iter_26_3] then
					table = var_2_10026

					var_2_10026.insert(var_26_10[iter_26_3], var_26_14)
				else
					var_26_10[iter_26_3] = {
						var_26_14
					}
					var_26_11[#var_26_11 + 1] = iter_26_3
				end
			end
		end
		...
		var_26_0:make(function(arg_27_0, arg_27_1, arg_27_2)
			...
			if arg_27_0 == var_3_10003.EventUpdate then
				...
				local var_27_2 = var_26_11[arg_27_1 + 1]

				setImageSprite = var_6

				local var_27_3 = var_27_0

				GetSpriteFromAtlas = var_3_10009

				var_6(var_27_3, var_3_10009("ShipType", "buffitem_tec_" .. var_27_2))

				local var_27_4 = arg_25_0

				var_6.upBuffList(var_27_4, arg_27_2, var_26_10[var_27_2])
			end

			return
		end)
		var_26_0:align(#var_26_11)
	...
	local function var_25_9(arg_28_0)
		if arg_28_0 == true then
			var_25_6(arg_25_2 + 1, arg_25_3, true)
		else
			var_25_6(arg_25_2, arg_25_3)
		end
	...
	var_25_4(var_25_7, var_25_8, var_25_9, var_15)

	if arg_25_5 == false then
		triggerToggle = var_25_4

		var_25_4(var_25_5, false)
	end
...
function var_0_1.upBuffList(arg_29_0, arg_29_1, arg_29_2)
	...
	local var_29_1 = var_1_10004.New(var_29_0, arg_29_0.buffItemTpl)

	var_4.make(var_29_1, function(arg_30_0, arg_30_1, arg_30_2)
		UIItemList = var_2_10003
		...
		if arg_30_0 == var_2_10003.EventUpdate then
			...
			AttributeType = var_2_10012

			local var_30_7 = var_2_10012.Type2Name

			pg = var_2_10014

			var_9(var_30_6, var_30_7(var_2_10014.attribute_info_by_type[var_30_2].name))
...
function var_0_1.updateTecLevelAward(arg_31_0, arg_31_1, arg_31_2)
	...
	local var_31_2 = arg_31_1:Find("ItemContainer")

	UIItemList = var_31_0

	local var_31_3 = var_31_0.New(var_31_2, arg_31_0.awardTpl)
	local var_31_4 = arg_31_1:Find("Level")
	local var_31_5 = arg_31_1:Find("Level/Num")
	local var_31_6 = arg_31_1:Find("GetBtn")
	local var_31_7 = arg_31_1:Find("DisGetBtn")
	local var_31_8 = arg_31_1
	local var_31_9 = arg_31_1.Find(var_31_8, "FinishBtn")
	local var_31_10 = arg_31_0.nationProxy
	local var_31_11 = var_11.GetTecItemByGroupID(var_31_10, arg_31_2)

	pg = var_31_8

	local var_31_12 = var_31_8.fleet_tech_group[arg_31_2]
	local var_31_13
	...
	if not var_1_10016.indexof(var_31_12.techs, var_31_14, 1) then
		var_31_16 = 0
	end
	...
	if var_31_18 then
		...
		var_31_19(var_31_4, true)

		setActive = var_31_19

		var_31_19(var_31_2, true)

		setActive = var_31_19

		var_31_19(var_31_6, var_31_15 < var_31_16)
		...
		var_31_19(var_31_5, var_31_17)

		pg = var_31_19
		var_31_19 = var_31_19.fleet_tech_template[var_31_18].level_award_display

		var_31_3:make(function(arg_32_0, arg_32_1, arg_32_2)
			UIItemList = var_2_10003
		...
		var_31_3:align(#var_31_19)

		if var_31_15 < var_31_16 then
			onButton = var_20

			local var_31_20 = arg_31_0
			local var_31_21 = var_31_6
			...
			local function var_31_22()
				...
				var_33_1(var_33_0, var_2_10003.GET_CAMP_TEC_AWARD, {
					groupID = arg_31_2,
					tecID = var_31_18
				})
			...
			var_20(var_31_20, var_31_21, var_31_22, var_1_10025)
		end
	else
		setActive = var_31_19

		var_31_19(var_31_4, false)

		setActive = var_31_19

		var_31_19(var_31_2, false)

		setActive = var_31_19

		var_31_19(var_31_6, false)
...
function var_0_1.updateOneStepBtn(arg_34_0)
	...
	var_1_10001(var_34_0, var_4.isAnyTecCampCanGetAward(var_34_1))
