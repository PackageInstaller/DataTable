...
local var_0_2 = var_0_10001.ship_meta_breakout
...
function var_0_1.initUITipText(arg_6_0)
	...
	var_6_4(var_6_8, var_1_10008("meta_energy_preview_title"))
	...
	var_6_4(var_6_9, var_8("meta_energy_preview_tip"))
	...
	var_6_4(var_6_10, var_8("word_level_upperLimit"))
	...
	var_6_4(var_6_11, var_8("meta_break"))
...
function var_0_1.initData(arg_7_0)
	...
	arg_7_0.metaCharacterProxy = var_1(var_1_10003)
	getProxy = var_1
...
function var_0_1.initUI(arg_8_0)
	...
	UIItemList = var_8_5
	arg_8_0.nameTFStarUIList = var_8_5.New(var_8_8, var_8_6)
	...
	Vector3 = var_8_7
	var_8_39.localPosition = var_8_7(-360, 50, 40)
	setActive = var_8_39
...
function var_0_1.addListener(arg_9_0)
	...
	local function var_9_8()
		...
		i18n = var_2_10004
		var_12_2.content = var_2_10004("meta_energy_active_box_tip")
		...
		function var_12_2.onYes()
			...
			var_13_1(var_13_0, var_3_10003.ENERGY_META_ACTIVATION, {
...
function var_0_1.updateShipImg(arg_16_0)
	...
	var_3(var_16_2, var_1_10006(var_16_0, var_16_1), true)

	local var_16_3 = arg_16_0.curMetaCharacterVO.id

	MetaCharacterConst = var_4

	local var_16_4 = var_4.UIConfig[var_16_3]

	setLocalPosition = var_16_2

	var_16_2(arg_16_0.shipImg, {
		x = var_16_4[5],
		y = var_16_4[6]
	})

	setLocalScale = var_16_2
...
function var_0_1.updateNamePanel(arg_17_0)
	...
	var_1_10004(arg_17_0.nameScrollText, var_17_3)

	local var_17_4 = var_17_0
	local var_17_5 = var_17_0.getShipType(var_17_4)

	setImageSprite = var_17_2

	local var_17_6 = arg_17_0.shipTypeImg

	LoadSprite = var_1_10008

	var_17_2(var_17_6, var_1_10008("shiptype", var_17_5))

	local var_17_7 = var_17_0:getConfig("english_name")

	setText = var_17_4

	var_17_4(arg_17_0.enNameText, var_17_7)

	local var_17_8 = var_17_0:getMaxStar()
	local var_17_9 = var_17_0:getStar()
	local var_17_10 = arg_17_0.nameTFStarUIList

	var_8.make(var_17_10, function(arg_18_0, arg_18_1, arg_18_2)
		UIItemList = var_2_10003

		if arg_18_0 == var_2_10003.EventUpdate then
			local var_18_0 = arg_18_2
			local var_18_1 = arg_18_2.Find(var_18_0, "empty")
			local var_18_2 = arg_18_2:Find("on")

			arg_18_1 = arg_18_1 + 1
			setActive = var_18_0

			var_18_0(var_18_2, arg_18_1 <= var_17_9)
		end
	...
	var_8.align(var_17_11, var_17_8)
...
function var_0_1.updateAttrPanel(arg_21_0)
	...
	local function var_21_3(arg_22_0, arg_22_1)
		...
		local var_22_2 = var_2_10003(var_21_0)
		...
		if var_2_10007.Expend ~= var_22_3 then
			...
			var_2_10010 = var_22_2

			local var_22_8 = var_22_2.getShipProperties(var_2_10010)

			math = var_22_6
			var_22_4 = var_22_6.floor(var_22_7[var_22_3])
			math = var_9
			var_22_5 = var_9.floor(var_22_8[var_22_3])
		else
			math = var_22_7
			var_22_7 = var_22_7.floor

			local var_22_9 = var_21_0

			var_22_4 = var_22_7(var_9.getBattleTotalExpend(var_22_9))
			math = var_22_7
		...
		local var_22_10 = arg_22_1:Find("NameText")

		AttributeType = var_2_10010

		var_22_7(var_22_10, var_2_10010.Type2Name(var_22_3))
		...
		local var_22_11 = arg_21_0.starFromList
		local var_22_12 = var_7.align
		local var_22_13 = var_21_0

		var_22_12(var_22_11, var_10.getStar(var_22_13))

		local var_22_14 = arg_21_0.starToList

		var_7.align(var_22_14, var_22_2:getStar())
	...
	local function var_21_4(arg_23_0, arg_23_1)
		...
		MetaCharacterConst = var_2_10003

		local var_23_2 = var_2_10003.ENERGY_ATTRS[arg_23_0 + 1]
		local var_23_3 = 0
		...
		if var_2_10005.Expend ~= var_23_2 then
			...
			math = var_2_10006
			var_23_3 = var_2_10006.floor(var_23_5[var_23_2])
		else
			math = var_23_5
			...
			var_23_3 = var_23_5(var_7.getBattleTotalExpend(var_23_6))
		end

		setText = var_23_5

		local var_23_7 = arg_23_1:Find("NameText")

		AttributeType = var_2_10008

		var_23_5(var_23_7, var_2_10008.Type2Name(var_23_2))
		...
		local var_23_8 = arg_23_1:Find("NextValueText")

		setColorStr = var_8

		local var_23_9 = var_23_3

		COLOR_GREEN = var_2_10011

		var_23_5(var_23_8, var_8(var_23_9, var_2_10011))
		...
		local var_23_10 = arg_21_0.starFromList
		local var_23_11 = var_5.align
		local var_23_12 = var_21_0

		var_23_11(var_23_10, var_8.getStar(var_23_12))

		local var_23_13 = arg_21_0.starToList

		var_5.align(var_23_13, 0)
	...
	var_21_7(var_21_6, #var_9.ENERGY_ATTRS)
...
function var_0_1.updateMaterialPanel(arg_25_0, arg_25_1)
	...
	local var_25_3 = var_1_10005(var_1_10007)
	...
	DROP_TYPE_ITEM = var_25_16
	var_25_18.type = var_25_16
	var_25_18.id = var_25_12
	var_25_18.count = var_25_14
	updateDrop = var_25_16

	var_25_16(var_12, var_25_18, {
		hideName = true
	})
	...
	local function var_25_21()
		...
		var_26_1(var_26_0, var_2_10003.ON_DROP, var_25_18)
	...
	var_25_16(var_25_19, var_25_20, var_25_21, var_1_10020)
	...
	if var_25_14 < var_25_13 then
		...
		var_25_16(var_25_22, var_25_20(var_25_23, var_1_10021) .. "/" .. var_25_13)
		...
		local var_25_24 = var_25_16(var_25_22)
		...
		if var_25_25 < var_25_7 then
			setColorStr = var_19
			var_1_10021 = var_25_7
			COLOR_RED = var_1_10022

			local var_25_27

			if not var_19(var_1_10021, var_1_10022) then
				var_25_27 = var_25_7
			end

			var_16(var_25_26, var_25_27)

			if var_25_25 < var_25_7 then
				var_25_4 = false
				onButton = var_16

				local var_25_28 = arg_25_0
				local var_25_29 = arg_25_0.activeBtnDisable

				local function var_25_30()
					Item = var_2_10000
					...
					local var_27_2 = var_2_10001(var_27_1, var_2_10004("word_gold"))

					i18n = var_2

					local var_27_3 = var_2("text_noRes_info_tip", var_27_0, var_25_7 - var_25_25)
					...
					var_3.ShowMsgBox(var_27_7, {
						...
						onYes = function()
							...
							MetaCharacterMediator = var_3_10005

							if var_28_2(var_28_1, var_3_10005) then
				...
				var_16(var_25_28, var_25_29, var_25_30, var_1_10021)
			end

			local var_25_31 = arg_25_0.levelNumText
			local var_25_32 = arg_25_0.repairRateText
			local var_25_33
			local var_25_34
			local var_25_35, var_25_36 = var_25_2:getLimited()
			local var_25_37 = var_25_0.level

			if var_25_0.level < var_25_35 then
				setColorStr = var_21

				local var_25_38 = var_25_37

				COLOR_RED = var_1_10024

				if not var_21(var_25_38, var_1_10024) then
					::label_25_0::

					setColorStr = var_21

					local var_25_39 = var_25_37

					COLOR_GREEN = var_1_10024
					var_25_37 = var_21(var_25_39, var_1_10024)
				end

				setText = var_21

				local var_25_40 = var_25_31

				i18n = var_1_10024

				var_21(var_25_40, var_1_10024("meta_energy_ship_level_need", var_25_37, var_25_35))

				local var_25_41 = var_3:getRepairRate() * 100 .. "%%"

				if var_3:getRepairRate() < var_25_36 / 100 then
					setColorStr = var_22

					local var_25_42 = var_25_41

					COLOR_RED = var_1_10025

					if not var_22(var_25_42, var_1_10025) then
						::label_25_1::

						setColorStr = var_22

						local var_25_43 = var_25_41

						COLOR_GREEN = var_1_10025
						var_25_41 = var_22(var_25_43, var_1_10025)
					end

					setText = var_22

					local var_25_44 = var_25_32

					i18n = var_1_10025

					var_22(var_25_44, var_1_10025("meta_energy_ship_repairrate_need", var_25_41, var_25_36 .. "%%"))

					if var_25_35 > var_25_0.level then
						var_25_4 = false
					end
...
function var_0_1.moveShipImg(arg_29_0, arg_29_1)
	...
	local var_29_6 = var_1_10009.moveX
	local var_29_7

	rtf = var_1_10011

	local var_29_8 = var_29_5(var_29_4, var_29_6, var_29_7, var_1_10011(arg_29_0.shipImg), var_29_3, 0.2)
...
function var_0_1.moveRightPanel(arg_30_0)
	...
	local var_30_4 = var_1_10006.moveX
	local var_30_5

	rtf = var_1_10008

	local var_30_6 = var_30_3(var_30_2, var_30_4, var_30_5, var_1_10008(arg_30_0.rightPanel), var_30_1, 0.2)
...
function var_0_1.updatePreviewAttrListPanel(arg_31_0)
	...
	local var_31_5 = var_6(var_31_4:getFinalAddition(var_31_3))
	local var_31_6 = arg_31_0.previewAttrUIItemList

	var_7.make(var_31_6, function(arg_32_0, arg_32_1, arg_32_2)
		UIItemList = var_2_10003
		...
		if arg_32_0 == var_2_10003.EventUpdate then
			...
			var_7(var_32_4, var_2_10010("attricon", var_32_3))
			...
			var_7(var_32_5, var_10.Type2Name(var_32_3))
			...
			if var_32_3 == var_7.ArmorType then
				...
				var_7(var_32_6, var_10.getShipArmorName(var_32_7))
			else
				setText = var_7
	...
	for iter_33_0 = 1, 3 do
		...
		local function var_33_8(arg_34_0)
			if arg_34_0 then
				...
				if not var_2_10002(var_2_10004.ship_data_template[var_33_3.breakout_id], {
					"specific_type"
				}) then
					var_34_1 = {}
				end
				...
				for iter_34_0, iter_34_1 in var_2_10003(var_34_1) do
					...
					i18n = var_2_10010
					ShipType = var_2_10012
					var_34_0 = var_34_2 .. var_34_3 .. var_2_10010(var_2_10012.SpecificTableTips[iter_34_1])
				end
		...
		var_1_10011(var_33_6, var_33_7, var_33_8, var_1_10016)

		if iter_33_0 == 1 then
			triggerToggle = var_1_10011

			var_1_10011(var_33_5, true)
		end
	end
...
function var_0_1.showBarrage(arg_44_0)
	...
	WeaponPreviewer = var_44_0
	arg_44_0.previewer = var_44_0.New(arg_44_0.rawImage)
