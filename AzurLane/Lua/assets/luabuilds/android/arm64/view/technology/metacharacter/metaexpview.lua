...
function var_0_1.initUITip(arg_5_0)
	...
	var_5_1, setText = var_1.Find(var_5_0, "Panel/Title/Text"), var_1_10002
	i18n = var_1_10005
...
function var_0_1.updateIconList(arg_9_0)
	...
	var_3.make(var_9_3, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			local var_10_13 = var_2_10017(var_2_10019)
			...
			LoadSprite = var_2_10023

			var_20(var_10_17, var_2_10023(var_10_16, var_10_15))
			...
			local function var_10_20()
				...
				local var_11_1 = var_3_10002.New
				local var_11_2 = {}

				MetaSkillDetailBoxLayer = var_3_10005
				var_11_2.viewComponent = var_3_10005
				MetaSkillDetailBoxMediator = var_3_10005
				var_11_2.mediator = var_3_10005
				var_11_2.data = {
					metaShipID = var_0.id,
			...
			var_20(var_10_18, var_10_19, var_10_20, var_25)
		end
...
function var_0_1.openPanel(arg_13_0)
	...
	local var_13_2 = var_13_1(var_1_10004(arg_13_0.panelTF), 0, var_13_0, 0.5)
	...
	var_13_5(var_13_4, var_5.Action(function()
...
function var_0_1.closePanel(arg_16_0)
	...
	local var_16_2 = var_16_1(var_1_10004(arg_16_0.panelTF), -var_16_0, 0, 0.5)
	local var_16_3 = var_2.setOnUpdate

	System = var_5

	local var_16_4 = var_16_3(var_16_2, var_5.Action_float(function(arg_17_0)
		setAnchoredPosition = var_2_10001
	...
	var_16_5(var_16_4, var_5.Action(function()
