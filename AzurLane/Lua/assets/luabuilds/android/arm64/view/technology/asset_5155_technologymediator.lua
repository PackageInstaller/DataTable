...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_START, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.START_TECHNOLOGY, {
			id = arg_2_1.id,
	...
	arg_1_0:bind(var_0_1.ON_FINISHED, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.FINISH_TECHNOLOGY, {
			id = arg_3_1.id,
	...
	arg_1_0:bind(var_0_1.ON_REFRESH, function(arg_4_0)
		...
		var_4_1(var_4_0, var_2_10004.REFRESH_TECHNOLOGYS)
	...
	arg_1_0:bind(var_0_1.ON_STOP, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10005.STOP_TECHNOLOGY, {
			id = arg_5_1.id,
	...
	arg_1_0:bind(var_0_1.ON_JOIN_QUEUE, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10005.JOIN_QUEUE_TECHNOLOGY, {
			id = arg_6_1.id,
	...
	arg_1_0:bind(var_0_1.ON_FINISH_QUEUE, function(arg_7_0)
		...
		var_7_1(var_7_0, var_2_10004.FINISH_QUEUE_TECHNOLOGY)
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_CLICK_SETTINGS_BTN, function(arg_8_0)
		...
		TechnologySettingsLayer = var_2_10007
		var_8_3.viewComponent = var_2_10007
		TechnologySettingsMediator = var_2_10007
...
function var_0_1.handleNotification(arg_10_0, arg_10_1)
	...
	local var_10_1 = arg_10_1.getBody(var_10_0)
	local var_10_2 = arg_10_1
	local var_10_3 = arg_10_1.getName(var_10_2)

	TechnologyProxy = var_10_0

	if var_10_3 == var_10_0.TECHNOLOGY_UPDATED then
		local var_10_4 = arg_10_0.viewComponent

		var_4.updateTechnology(var_10_4, var_10_1)
	else
		GAME = var_4

		local var_10_5

		if var_10_3 == var_4.FINISH_TECHNOLOGY_DONE then
			var_10_5 = #var_10_1.items

			if 0 < var_10_5 then
				local var_10_6 = arg_10_0.viewComponent

				var_10_5 = var_10_5.emit
				BaseUI = var_1_10007

				var_10_5(var_10_6, var_1_10007.ON_AWARD, {
					animation = true,
					items = var_10_1.items
				})
			end
			...
			if var_10_3 == var_10_5.FINISH_QUEUE_TECHNOLOGY_DONE then
				var_10_7 = {}
				ipairs = var_10_2

				for iter_10_0, iter_10_1 in var_10_2(var_10_1.dropInfos) do
					if #iter_10_1 > 0 then
						table = var_10

						var_10.insert(var_10_7, function(arg_11_0)
							local var_11_0 = arg_10_0.viewComponent
							local var_11_1 = var_1.emit

							BaseUI = var_2_10004

							var_11_1(var_11_0, var_2_10004.ON_AWARD, {
								animation = true,
								items = iter_10_1,
								removeFunc = arg_11_0
							})
				...
				if var_10_3 == var_10_7.REFRESH_TECHNOLOGYS_DONE then
					arg_10_0:onRefresh()
				else
					GAME = var_4

					if var_10_3 == var_4.JOIN_QUEUE_TECHNOLOGY_DONE then
						arg_10_0:onRefresh()
					else
						TechnologyProxy = var_4

						if var_10_3 == var_4.REFRESH_UPDATED then
							local var_10_8 = arg_10_0.viewComponent

							var_4.setRefreshFlag(var_10_8, var_10_1)

							local var_10_9 = arg_10_0.viewComponent

							var_4.updateRefreshBtn(var_10_9, var_10_1)
						else
							PlayerProxy = var_4

							if var_10_3 == var_4.UPDATED then
								local var_10_10 = arg_10_0.viewComponent

								var_4.setPlayer(var_10_10, var_10_1)
							else
								TechnologySettingsMediator = var_4

								if var_10_3 == var_4.EXIT_CALL then
									local var_10_11 = arg_10_0.viewComponent

									var_4.updatePickUpVersionChange(var_10_11)
								end
							end
						end
					end
