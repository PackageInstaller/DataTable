...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.themeTxt = var_2_5(var_2_4, var_4(var_1_10006))
	...
	arg_2_0.rawIcon = var_2_16(var_2_15, var_4(var_1_10006))
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.shipIcon = var_2_20(var_2_19, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.shipTxt = var_2_23(var_2_22, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.countTxt = var_2_29(var_2_28, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.gemCount = var_2_33(var_2_32, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.goldCount = var_2_37(var_2_36, var_4(var_1_10006))
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.energyIcon = var_2_41(var_2_40, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.energyTxt = var_2_44(var_2_43, var_4(var_1_10006))
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.energyAddition = var_2_47(var_2_46, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.energyAdditionTxt = var_2_50(var_2_49, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.maxCnt = var_2_59(var_2_58, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.maxBtnTxt = var_2_63(var_2_62, var_4(var_1_10006))
	setText = var_1

	local var_2_64 = arg_2_0._tf
	local var_2_65 = var_3.Find(var_2_64, "frame/price/label")

	i18n = var_4

	var_1(var_2_65, var_4("backyard_theme_total_print"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_3()
		...
		NewBackYardShopMediator = var_2_10004

		local var_5_3 = var_2_10004.ON_SHOPPING
		local var_5_4 = var_5_0

		PlayerConst = var_2_10006

		var_5_2(var_5_1, var_5_3, var_5_4, var_2_10006.ResDormMoney)
	...
	local function var_3_6()
		...
		local var_6_3 = var_2_10004.ON_SHOPPING
		local var_6_4 = var_6_0

		PlayerConst = var_2_10006

		var_6_2(var_6_1, var_6_3, var_6_4, var_2_10006.ResDiamond)
	...
	var_1_10002(var_3_10, var_3_11, var_3_12, var_1_10007)
	...
	var_1_10002(var_3_13, var_3_14, var_3_15, var_1_10007)
	...
	var_1_10002(var_3_16, var_3_17, var_3_18, var_1_10007)
...
function var_0_1.SetUp(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_3 = var_7.Find(var_13_2, "content/Text")

	i18n = var_8

	var_5(var_13_3, var_8("word_buy"))

	setText = var_5

	local var_13_4 = arg_13_0.goldPurchaseBtn
	local var_13_5 = var_7.Find(var_13_4, "content/Text")

	i18n = var_8

	var_5(var_13_5, var_8("word_buy"))
...
function var_0_1.UpdateSkinType(arg_14_0)
	...
	local var_14_1 = var_1_10002.ExistFurniture(var_14_0)
	...
	if var_14_1 then
		...
		var_6("QIcon/" .. var_14_4.prefab, "", arg_14_0.shipIcon.gameObject)

		ShipGroup = var_6

		local var_14_5 = var_6.getDefaultShipConfig(var_14_4.ship_group)
...
function var_0_1.UpdateMainInfo(arg_15_0)
	...
	local var_15_4 = var_15_0.canPurchaseByDormMoeny(var_15_3)
	local var_15_5 = var_15_0:canPurchaseByGem()

	setActive = var_15_3

	var_15_3(arg_15_0.goldPurchaseBtn, var_15_4)

	setActive = var_15_3

	var_15_3(arg_15_0.gemPurchaseBtn, var_15_5)

	setActive = var_15_3

	var_15_3(arg_15_0.gemIcon, var_15_5)

	setActive = var_15_3

	var_15_3(arg_15_0.gemCount, var_15_5)

	setActive = var_15_3

	var_15_3(arg_15_0.goldIcon, var_15_4)

	setActive = var_15_3

	var_15_3(arg_15_0.goldCount, var_15_4)

	setActive = var_15_3

	var_15_3(arg_15_0.line, var_15_4 and var_15_5)
	...
	local var_15_8 = var_15_7(var_15_6, var_8(var_1_10010))
	...
	local var_15_11 = var_15_10(var_15_9, var_9(var_1_10011))

	if var_15_5 and var_15_4 then
	...
	elseif not var_15_5 and var_15_4 then
...
function var_0_1.UpdateEnergy(arg_16_0, arg_16_1)
	...
	LoadSpriteAtlasAsync = var_1_10007

	var_1_10007("ui/CourtyardUI_atlas", "express_" .. var_16_5, function(arg_17_0)
	...
	local var_16_6 = var_1_10007.New(0.5921569, 0.8470588, 0.4235294, 1)

	Color = var_16_4

	local var_16_7 = var_16_4.New(0.945098, 0.7960784, 0.3019608, 1)
...
function var_0_1.UpdatePrice(arg_18_0)
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10005.ResDormMoney)
	local var_18_3 = var_1
	local var_18_4 = var_1.getPrice

	PlayerConst = var_1_10006

	local var_18_5 = var_18_4(var_18_3, var_1_10006.ResDiamond)
	...
	for iter_18_0 = 1, arg_18_0.count do
		...
		var_1_10009(var_18_7, var_1_10012.New({
...
function var_0_1.UpdateIcon(arg_19_0)
	...
	var_19_0.sprite = var_1_10002(var_19_1 .. var_5.getConfig(var_19_2, "icon"), "")
	...
	local function var_19_7()
		...
		local var_20_1 = var_2_10001.ExistFurniture(var_20_0)
		local var_20_2 = 312011

		if var_20_1 then
			Goods = var_3
			var_20_2 = var_3.Id2ShipSkinId(var_20_0)
		end
		...
		pg = var_2_10006
		var_20_3.interactionPreview = var_20_4(var_2_10006.UIMgr.GetInstance().OverlayMain, arg_19_0._event)
	...
	var_3(var_19_5, var_19_6, var_19_7, var_8)
...
function var_0_1.Show(arg_21_0)
	...
	var_1(var_21_0, var_1_10004.UIMgr.GetInstance().OverlayMain)
