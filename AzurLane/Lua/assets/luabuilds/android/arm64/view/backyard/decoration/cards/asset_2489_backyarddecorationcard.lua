...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.animation = var_1_3(var_1_2, var_5(var_1_10007))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
	...
	local var_2_0 = var_1_10005.hxLan
	local var_2_1 = arg_2_1
	local var_2_2 = var_2_0(arg_2_1.getConfig(var_2_1, "name"))

	setText = var_1_10006

	local var_2_3 = arg_2_0.comfortableTF

	shortenString = var_2_1

	var_1_10006(var_2_3, var_2_1(var_2_2, 4))

	local var_2_4 = arg_2_1:getConfig("count")
	...
	local var_2_5 = arg_2_0.maskTF
	local var_2_6 = var_10.Find(var_2_5, "Text")

	i18n = var_11

	var_8(var_2_6, var_11("courtyard_label_using", arg_2_3))
