...
function var_0_1.InitList(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_4_0(var_4_3) do
		if iter_4_1:IsPurchased(var_4_1) then
			table = var_8
...
function var_0_1.OnInitItem(arg_10_0, arg_10_1)
	...
	var_1_10003(arg_10_0, var_10_0._tf, function()
	...
	var_1_10003(arg_10_0, var_10_0.add, function()
