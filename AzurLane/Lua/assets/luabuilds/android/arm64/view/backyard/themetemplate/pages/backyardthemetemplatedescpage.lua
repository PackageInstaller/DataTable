...
function var_0_1.OnLoaded(arg_6_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_6_0.icon = var_6_4(var_6_3, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.idTxt = var_6_7(var_6_6, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.idLabel = var_6_10(var_6_9, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.nameTxt = var_6_14(var_6_13, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.timeTxt = var_6_18(var_6_17, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.btn1Txt = var_6_22(var_6_21, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.btn2Txt = var_6_26(var_6_25, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.heartTxt = var_6_31(var_6_30, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.collectionTxt = var_6_36(var_6_35, var_4(var_1_10006))

	local var_6_37 = arg_6_0.idLabel

	i18n = var_1_10002
	var_6_37.text = var_1_10002("word_theme") .. "ID:"
...
function var_0_1.RefreshSortBtn(arg_10_0)
	...
	if var_10_2 == var_1_10004.THEME_TEMPLATE_TYPE_CUSTOM then
		...
		var_10_4, var_10_1 = var_10_3(var_1_10005(var_1_10007).TYPE)
	else
		local var_10_5
...
function var_0_1.Update1(arg_12_0)
	...
	local function var_12_5()
		...
		BackYardThemeTemplateMsgBox = var_2_10005
		var_14_3.type = var_2_10005.TYPE_IMAGE
		i18n = var_5
		var_14_3.content = var_5("backyard_theme_apply_tip2")

		local var_14_4 = arg_12_0.template

		var_14_3.srpiteName = var_5.GetTextureIconName(var_14_4)

		local var_14_5 = arg_12_0.template

		var_14_3.md5 = var_5.GetIconMd5(var_14_5)

		function var_14_3.onYes()
			local var_15_0 = arg_12_0
			local var_15_1 = var_0.emit

			NewBackYardThemeTemplateMediator = var_3_10003

			var_15_1(var_15_0, var_3_10003.ON_APPLY_TEMPLATE, arg_12_0.template, function()
	...
	i18n = var_1_10002
	var_12_6.text = var_1_10002("courtyard_label_detail")
...
function var_0_1.Update2(arg_17_0)
	...
	local function var_17_4()
		...
		var_18_1(var_18_0, var_2_10003.ON_DELETE_TEMPLATE, var_0)
	...
	var_1_10003(var_17_2, var_17_3, var_17_4, var_1_10008)
	...
	local function var_17_7()
		if var_17_1 then
			...
			var_19_1(var_19_0, var_2_10003.ON_CANCEL_UPLOAD_TEMPLATE, var_0)
		else
			...
			var_19_3(var_19_2, var_2_10003.ON_UPLOAD_TEMPLATE, var_0)
		end
	...
	var_1_10003(var_17_5, var_17_6, var_17_7, var_1_10008)

	if not var_17_1 then
		getProxy = var_1_10003
		DormProxy = var_17_5

		local var_17_8 = var_1_10003(var_17_5)
		local var_17_9 = var_3.GetUploadThemeTemplateCnt(var_17_8)

		var_17_0 = arg_17_0.timeTxt
		i18n = var_17_8

		local var_17_10 = "backyard_theme_upload_cnt"
		local var_17_11 = var_17_9

		BackYardConst = var_1_10009
		var_17_0.text = var_17_8(var_17_10, var_17_11, var_1_10009.MAX_UPLOAD_THEME_CNT)
	end

	local var_17_12 = arg_17_0.btn1Txt

	i18n = var_17_0
	var_17_12.text = var_17_0("courtyard_label_delete")

	local var_17_13 = arg_17_0.btn2Txt
	...
	if var_17_1 then
		...
		if not var_17_14("courtyard_label_cancel_share") then
			i18n = var_17_14
			var_17_14 = var_17_14("courtyard_label_share")
		end

		var_17_13.text = var_17_14
...
function var_0_1.Update3(arg_20_0)
	...
	local var_20_2 = var_1_10002("backyard_theme_template_collection_cnt")

	getProxy = var_20_0
	DormProxy = var_1_10005

	local var_20_3 = var_20_0(var_1_10005)
	local var_20_4 = var_3.GetThemeTemplateCollectionCnt(var_20_3)
	local var_20_5 = "/"

	BackYardConst = var_20_3
	var_20_1.text = var_20_2 .. var_20_4 .. var_20_5 .. var_20_3.MAX_COLLECTION_CNT
...
function var_0_1.UpdatePlayer(arg_21_0)
	...
	if not var_1.ExistPlayerInfo(var_21_0) then
		...
		var_21_2(var_21_1, var_1_10004.GET_TEMPLATE_PLAYERINFO, arg_21_0.pageType, arg_21_0.template)
	else
		...
		var_21_3("qicon/" .. var_1:getPainting(), function(arg_22_0)
			IsNil = var_2_10001
		...
		if arg_21_0.preLoadIcon then
			var_21_6 = arg_21_0.preLoadIcon.name
			PoolMgr = var_3

			local var_21_7 = var_3.GetInstance()

			var_3.ReturnPrefab(var_21_7, "IconFrame/" .. var_21_6, var_21_6, arg_21_0.preLoadIcon)
		end

		AttireFrame = var_21_6

		local var_21_8 = var_21_6.attireFrameRes
		local var_21_9 = var_1
		local var_21_10 = var_1.id

		getProxy = var_21_5
		PlayerProxy = var_1_10008

		local var_21_11 = var_21_5(var_1_10008)
		local var_21_12 = var_21_10 == var_6.getRawData(var_21_11).id

		AttireConst = var_6

		local var_21_13 = var_21_8(var_21_9, var_21_12, var_6.TYPE_ICON_FRAME, var_1.propose)

		PoolMgr = var_3

		local var_21_14 = var_3.GetInstance()

		var_3.GetPrefab(var_21_14, "IconFrame/" .. var_21_13, var_21_13, true, function(arg_23_0)
			if arg_21_0.icon then
				arg_23_0.name = var_21_13
				findTF = var_1
				...
				typeof = var_2_10005
				Image = var_2_10007
				var_23_1(var_23_0, var_2_10005(var_2_10007)).raycastTarget = false
				setParent = var_3
		...
		local function var_21_17()
			...
			local var_24_1 = var_2_10001(var_2_10003)
			...
			NewBackYardThemeTemplateMediator = var_2_10005

			var_24_6(var_24_5, var_2_10005.ON_DISPLAY_PLAYER_INFO, var_0.id, var_24_2, arg_21_0.template.id)
		...
		var_3(var_21_15, var_21_16, var_21_17, var_8)
	end
...
function var_0_1.UpdateLikeInfo(arg_25_0)
	...
	local function var_25_9()
		...
		if not var_25_6 then
			...
			var_26_2(var_26_1, var_2_10003.ON_LIKE_THEME, arg_25_0.template, arg_25_0.template.time)
		end
	...
	var_4(var_25_7, var_25_8, var_25_9, var_1_10009)

	setActive = var_4

	var_4(arg_25_0.heartSel, var_25_6 or var_25_4)

	local var_25_10 = var_25_0:IsCollected()

	onButton = var_25_5

	local var_25_11 = arg_25_0
	local var_25_12 = arg_25_0.collection
	...
	local function var_25_13()
		...
		if var_25_10 then
			...
			i18n = var_2_10005
			var_27_3.content = var_2_10005("backyard_theme_cancel_collection")
			...
			function var_27_3.onYes()
				...
				var_28_1(var_28_0, var_3_10003.ON_COLECT_THEME, arg_25_0.template, true, arg_25_0.template.time)

				return
			end

			var_27_2(var_27_1, var_2_10003, var_27_3)
		else
			...
			var_27_5(var_27_4, var_2_10003.ON_COLECT_THEME, arg_25_0.template, false, arg_25_0.template.time)
		end
	...
	var_25_5(var_25_11, var_25_12, var_25_13, var_1_10010)

	setActive = var_25_5

	var_25_5(arg_25_0.collectionSel, var_25_10 or var_25_4)
...
function var_0_1.UpdateWindow(arg_29_0)
	...
	if var_29_1 == var_1_10003.THEME_TEMPLATE_TYPE_SHOP then
		...
		if var_29_1 == var_3.THEME_TEMPLATE_TYPE_CUSTOM then
			local var_29_2 = arg_29_0.template
			...
			if var_29_1.IsPushed(var_29_2) then
				...
				var_29_1 = arg_29_0.frame
				Vector2 = var_3
				var_29_1.sizeDelta = var_3(arg_29_0.frame.sizeDelta.x, 395)
			end
		else
			var_29_1 = arg_29_0.pageType
			BackYardConst = var_3

			if var_29_1 == var_3.THEME_TEMPLATE_TYPE_COLLECTION then
				var_29_1 = arg_29_0.frame
				Vector2 = var_3
				var_29_1.sizeDelta = var_3(arg_29_0.frame.sizeDelta.x, 456)
			end
...
function var_0_1.Show(arg_30_0)
	...
	var_30_4[1] = var_7.Find(var_30_5, "adpter/frame")
