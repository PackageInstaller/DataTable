...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.shipIcon = var_2_11(var_2_10, var_4(var_1_10006))
...
function var_0_1.shortenString(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_1, var_3_2 = var_1_10004.find(arg_3_1, "<color=#%w+>")
	...
	local var_3_10 = var_3_7(var_3_8, var_3_9, var_1_10014.len(arg_3_1))
	local var_3_11 = ""
	local var_3_12 = 0

	ipairs = var_3_9

	for iter_3_0, iter_3_1 in var_3_9({
		var_3_5,
		var_3_6,
		var_3_10
	}) do
...
function var_0_1.SetUp(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	if arg_4_0.furniture ~= arg_4_1 then
		...
		HXSet = var_1_10007
		var_4_0.text = var_1_10005(var_1_10007.hxLan(arg_4_1:getConfig("name")), 10)
		var_1_10006 = arg_4_0

		local var_4_1 = arg_4_0.shortenString

		HXSet = var_7

		local var_4_2 = var_4_1(var_1_10006, var_7.hxLan(arg_4_1:getConfig("describe")), 41)

		arg_4_0.descTxt.text = var_4_2

		local var_4_3 = arg_4_0.icon

		LoadSprite = var_1_10006
		var_4_3.sprite = var_1_10006("furnitureicon/" .. arg_4_1:getConfig("icon"))

		local var_4_4 = arg_4_0.icon

		var_5.SetNativeSize(var_4_4)
	end
...
function var_0_1.UpdateSkinType(arg_5_0)
	...
	local var_5_1 = var_1_10002.ExistFurniture(var_5_0)
	...
	if var_5_1 then
		...
		var_6("QIcon/" .. var_5_4, "", arg_5_0.shipIcon.gameObject)
	end
