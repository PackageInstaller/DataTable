...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.foodName = var_2_4(var_2_3, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.foodDesc = var_2_7(var_2_6, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.countValue = var_2_12(var_2_11, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.total = var_2_15(var_2_14, var_4(var_1_10006))
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.totalIcon = var_2_18(var_2_17, var_4(var_1_10006))
	...
	var_1(var_2_28, var_4("word_ok"))

	setText = var_1

	local var_2_29 = arg_2_0._tf
	local var_2_30 = var_3.Find(var_2_29, "frame/title")

	i18n = var_4

	var_1(var_2_30, var_4("words_information"))
...
function var_0_1.Show(arg_7_0, arg_7_1)
	...
	local var_7_3 = var_1_10003.shop_template[var_7_2].resource_type
	...
	var_7_6(var_7_7 .. var_1_10010(var_7_3), "", function(arg_9_0)
		...
		Vector2 = var_2_10002
		var_9_1.sizeDelta = var_2_10002(50, 50)
	...
	var_7_8(var_7_9, var_7_10, var_7_11, var_12)
	...
	local function var_7_14()
		if var_7_5 == 999 then
			...
			var_11_1(var_11_0, var_2_10003("backyard_backyardGranaryLayer_buyCountLimit", var_7_5))
	...
	var_7_8(var_7_12, var_7_13, var_7_14, var_12)
	...
	local function var_7_17()
		if var_7_5 == 999 then
			...
			var_12_1(var_12_0, var_2_10003("backyard_backyardGranaryLayer_buyCountLimit", var_7_5))
	...
	var_7_8(var_7_15, var_7_16, var_7_17, var_12)
	...
	var_7_8(var_7_18, var_7_19, var_7_20, var_12)
...
function var_0_1.Purchase(arg_14_0, arg_14_1)
	...
	if var_14_1[var_1_10003(arg_14_1.resourceType)] < arg_14_1.resourceNum * arg_14_1.count then
		if arg_14_1.resourceType == 4 then
			GoShoppingMsgBox = var_3
			i18n = var_5
			var_1_10007 = "switch_to_shop_tip_3"
			i18n = var_1_10008

			local var_14_2 = var_5(var_1_10007, var_1_10008("word_gem"))

			ChargeScene = var_1_10006

			var_3(var_14_2, var_1_10006.TYPE_DIAMOND)
		else
			...
			local var_14_3 = var_3.New
			local var_14_4 = {}

			DROP_TYPE_RESOURCE = var_1_10006
			var_14_4.type = var_1_10006
			var_14_4.id = arg_14_1.resourceType

			local var_14_5 = var_14_3(var_14_4)
			local var_14_6 = var_3.getName(var_14_5)
			...
			var_14_7(var_1_10006, var_1_10007("backyard_backyardGranaryLayer_error_noResource", var_14_6))
		end
	...
	var_14_9(var_14_8, var_1_10006.BUY_FOOD, arg_14_1.shopId, arg_14_1.count)
	arg_14_0:Hide()
...
function var_0_1.UpdateFood(arg_15_0, arg_15_1)
	...
	local var_15_3 = var_1_10008.New
	local var_15_4 = {
		id = arg_15_1
	}
	...
	local var_15_5 = var_1_10011(var_1_10013)

	var_15_4.cnt = var_11.getItemCountById(var_15_5, arg_15_1)
