...
function var_0_0.FileExists(arg_12_0)
	...
	return var_1_10002.FileExists(var_12_0)
end
...
function var_0_0.TakeIcon(arg_14_0, arg_14_1)
	...
	var_0_0.TakePhoto(arg_14_0, function(arg_15_0)
		...
		local var_15_3 = var_2_10004.Texture2D.New(var_14_0, var_14_1)

		var_4.SetPixels(var_15_3, var_15_2)
		var_4:Apply()
		arg_14_1(var_4)
...
function var_0_0.SavePhoto(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	...
	var_1_10004({
		function(arg_18_0)
			...
			ScreenShooter = var_2_10002

			var_2_10002.SaveTextureToLocal(var_18_0, arg_17_2, true)
			arg_18_0()
		...
		function(arg_20_0)
			...
			var_2_10002.SaveTextureToLocal(var_20_0, arg_17_1, true)
			arg_20_0()
...
function var_0_0.ClearCache(arg_35_0, arg_35_1)
	...
	if arg_35_1 then
		...
		if not var_1_10003(var_35_0.asset) then
			Object = var_3
