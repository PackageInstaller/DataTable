...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.subTitleTxt = var_2_3(var_2_2, var_4(var_1_10006))
	setText = var_1

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_3.Find(var_2_4, "frame/view/subtitle1/Text")

	i18n = var_4

	var_1(var_2_5, var_4("backyard_backyardScene_comforChatContent1"))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.expressionTxt = var_2_8(var_2_7, var_4(var_6))
	...
	typeof = var_4
	Image = var_6
	arg_2_0.comfortableImg = var_2_11(var_2_10, var_4(var_6))
	...
	typeof = var_4
	Image = var_6
	arg_2_0.comfortableBg = var_2_14(var_2_13, var_4(var_6))
	UIItemList = var_1

	local var_2_15 = var_1.New
	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_3.Find(var_2_16, "frame/view/list/content")
	local var_2_18 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_15(var_2_17, var_4.Find(var_2_18, "frame/view/list/content/tpl"))
	...
	typeof = var_4
	Animation = var_2_18
	arg_2_0.animation = var_2_21(var_2_20, var_4(var_2_18))
	...
	arg_2_0.dftAniEvent = var_2_24(var_2_23, var_4(var_2_18))
	...
	typeof = var_4
	Text = var_2_18
	arg_2_0.expAdditionTxt = var_2_30(var_2_29, var_4(var_2_18))
	setText = var_1

	local var_2_31 = arg_2_0._tf
	local var_2_32 = var_3.Find(var_2_31, "frame/exp")

	i18n = var_4

	var_1(var_2_32, var_4("courtyard_label_comfortable_addition"))

	setText = var_1

	local var_2_33 = arg_2_0._tf
	local var_2_34 = var_3.Find(var_2_33, "frame/title")

	i18n = var_4

	var_1(var_2_34, var_4("word_comfort_level"))
...
function var_0_1.OnInit(arg_3_0)
	...
	var_1_10002(var_3_7, var_3_8, var_3_9, var_1_10007)
...
function var_0_1.FlushExpression(arg_10_0, arg_10_1)
	...
	i18n = var_10_0
	var_10_2.text = var_10_0("backyard_backyardScene_expression_label_" .. var_10_1)
...
i18n = var_0_0
var_0_2[1] = var_0_0("word_wallpaper")
i18n = var_2
	...
	var_2.make(var_12_2, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_2_10003.EventUpdate then
			...
			var_2_10004("ui/CourtyardUI_atlas", "icon_" .. var_13_0, function(arg_14_0)
				...
				local var_14_3 = var_14_2(var_14_1, var_4(var_3_10006))
			...
			var_2_10005(arg_13_2:Find("line"), var_13_1)

			setActive = var_2_10005

			var_2_10005(arg_13_2:Find("bg"), var_13_1)
		end
