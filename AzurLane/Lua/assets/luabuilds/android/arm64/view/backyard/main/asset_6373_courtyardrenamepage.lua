...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_5 = var_3.Find(var_2_4, "frame/cancel/Text")

	i18n = var_4

	var_1(var_2_5, var_4("word_cancel"))
	...
	var_1(var_2_9, var_4("backyard_rename_title"))

	setText = var_1

	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_3.Find(var_2_10, "frame/input/placehoder")

	i18n = var_4

	var_1(var_2_11, var_4("backyard_rename_tip"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		if not var_2_10000(arg_3_0.input) or var_0 == "" then
			...
			var_2_10001(var_4_0, var_2_10004("word_should_input"))
		...
		var_4_2(var_4_1, var_4.RENAME, var_0)
