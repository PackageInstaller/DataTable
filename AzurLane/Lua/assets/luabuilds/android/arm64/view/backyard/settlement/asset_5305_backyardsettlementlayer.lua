...
function var_0_1.init(arg_4_0)
	...
	local var_4_8 = var_3.Find(var_4_7, "container")
	local var_4_9 = arg_4_0.frame

	arg_4_0.uilist = var_4_6(var_4_8, var_4.Find(var_4_9, "container/ship_tpl"))
...
function var_0_1.InitPainting(arg_8_0, arg_8_1, arg_8_2)
	...
	if arg_8_0.dormVO.food == 0 then
		...
		var_3(var_8_0, var_6("backyard_backyardGranaryLayer_noFood"))
	else
		pg = var_3
		...
		local var_8_6 = var_7.TimeMgr.GetInstance()
		local var_8_7 = var_7.DescCDTime(var_8_6, var_8_4)
		local var_8_8
		...
		local var_8_10 = var_8_1.split(var_8_9, "||")

		assert = var_8_5

		var_8_5(#var_8_10 > 0, "gametip ==> backyard_addExp_Info 必须用||分开")
...
function var_0_1.UpdateShips(arg_9_0)
	...
	for iter_9_2, iter_9_3 in var_9_2(arg_9_0.cards) do
		table = var_1_10010
...
function var_0_1.willExit(arg_11_0)
	...
	var_11_1(var_11_0, var_11_2, var_1_10005.UIMgr.GetInstance().UIMain)
