...
function var_0_1.OnUsageItem(arg_3_0, arg_3_1)
	...
	local var_3_1 = var_4(var_1_10006)
...
function var_0_1.init(arg_6_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.chatTxt = var_6_3(var_6_2, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.chatTxt1 = var_6_6(var_6_5, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.chatTime = var_6_9(var_6_8, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.chatTxt2 = var_6_12(var_6_11, var_4(var_1_10006))
	...
	typeof = var_4
	Slider = var_1_10006
	arg_6_0.capacityBar = var_6_15(var_6_14, var_4(var_1_10006))
	...
	typeof = var_4
	Slider = var_1_10006
	arg_6_0.capacityBarEffect = var_6_18(var_6_17, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.capacityTxt = var_6_21(var_6_20, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_6_0.additionTxt = var_6_25(var_6_24, var_4(var_1_10006))
	...
	local var_6_30 = var_3.Find(var_6_29, "frame/extend_btn/Text")

	i18n = var_4

	var_1(var_6_30, var_4("enter_extend_food_label"))
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_5()
		...
		ShoppingStreet = var_2_10001

		local var_9_2 = var_2_10001.getRiseShopId

		ShopArgs = var_2_10003

		if not var_9_2(var_2_10003.BackyardFoodExtend, var_9_1.food_extend_count) then
			pg = var_9_0

			local var_9_3 = var_9_0.TipsMgr.GetInstance()
			local var_9_4 = var_2.ShowTips

			i18n = var_2_10005

			var_9_4(var_9_3, var_2_10005("backyard_backyardGranaryLayer_buy_max_count"))
...
function var_0_1.InitCharChat(arg_11_0, arg_11_1)
	...
	if var_11_1(var_11_0, var_1_10005.FLOOR_1) <= 0 then
		local var_11_2 = arg_11_0.chatTxt2

		i18n = var_11_0
		var_11_2.text = var_11_0("backyard_backyardGranaryLayer_noShip")
...
function var_0_1.AddChatTimer(arg_13_0, arg_13_1)
	...
	local var_13_1 = arg_13_1.getFoodLeftTime(var_13_0)
	local var_13_2 = arg_13_0.chatTxt

	i18n = var_13_0
	var_13_2.text = var_13_0("backyard_backyardGranaryLayer_foodTimeNotice_top")

	local var_13_3 = arg_13_0.chatTxt1

	i18n = var_4
	var_13_3.text = var_4("backyard_backyardGranaryLayer_foodTimeNotice_bottom")
	...
	arg_13_0.timer = var_3.New(function()
		...
		if var_14_0 - var_1.GetServerTime(var_14_1) <= 0 then
			...
			local var_14_3 = arg_13_0.chatTxt2

			i18n = var_2_10002
			var_14_3.text = var_2_10002("backyard_backyardGranaryLayer_word")

			local var_14_4 = arg_13_0

			var_1.ClearTxts(var_14_4)
		else
			local var_14_5 = arg_13_0.chatTime

			pg = var_2_10002

			local var_14_6 = var_2_10002.TimeMgr.GetInstance()

			var_14_5.text = var_2.DescCDTime(var_14_6, var_0)
		end

		return
	end, 1, -1)

	local var_13_4 = arg_13_0.timer

	var_3.Start(var_13_4)
	arg_13_0.timer.func()
...
function var_0_1.UpdateCapacityWithAnim(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_4 = var_18_3(var_18_2, var_8.Action_float(function(arg_19_0)
	...
	var_18_5(var_18_4, var_8.easeOutQuint)
	...
	local var_18_8 = var_18_7(var_18_6, var_8.easeInOutQuart)
	local var_18_9 = var_5.setOnUpdate

	System = var_8

	local var_18_10 = var_18_9(var_18_8, var_8.Action_float(function(arg_20_0)
	...
	local var_18_12 = var_18_11(var_18_10, var_8.Action(function()
...
local function var_0_3(arg_22_0, arg_22_1)
	...
	var_1_10002(var_22_6, var_22_7, var_22_8, var_22_9, var_22_10, var_22_11, var_22_12, var_1_10011)
...
function var_0_1.InitFoods(arg_27_0)
	...
	var_1_10002.insert(arg_27_0.cards, var_27_0)
	...
	for iter_27_0 = 1, #var_0_2 - 1 do
		...
		var_1_10007.insert(var_27_1, function(arg_28_0)
			...
			local var_28_1 = var_28_0(var_2_10003(arg_27_0.cardTpl, arg_27_0.cardTpl.parent))
...
function var_0_1.UpdateCards(arg_30_0)
	for iter_30_0 = 1, #var_0_2 do
		...
		var_1_10007 = var_1_10007.getItemCountById(var_1_10009, var_30_0)
...
function var_0_1.SimulateAddFood(arg_31_0, arg_31_1, arg_31_2)
	if not arg_31_0.isSimulation then
		...
		local var_31_0 = var_3(var_1_10005)

		arg_31_0.simulateFood = var_3.getRawData(var_31_0).food
		var_1_10006 = var_3
		arg_31_0.simulateCapacity = var_3.GetCapcity(var_1_10006)
		Item = var_4
		arg_31_0.simulateAddition = var_4.getConfigData(arg_31_1).usage_arg[1]
		getProxy = var_4
		BagProxy = var_1_10006
		var_1_10006 = var_4(var_1_10006)
		arg_31_0.simulateItemCnt = var_4.getItemCountById(var_1_10006, arg_31_1)
	...
	if arg_31_0.simulateFood >= arg_31_0.simulateCapacity then
		...
		var_31_2(var_31_1, var_1_10006("backyard_backyardGranaryLayer_full"))
		arg_31_2()
	...
	elseif arg_31_0.simulateItemCnt == 0 then
		...
		var_31_4(var_31_3, var_1_10006("backyard_backyardGranaryLayer_foodCountLimit"))
		arg_31_2()
...
function var_0_1.DoAddFoodAnimation(arg_32_0, arg_32_1)
	...
	if var_32_1(var_4(arg_32_0.additionTxt)) then
		LeanTween = var_32_2
		var_32_2 = var_32_2.cancel
		go = var_4

		var_32_2(var_4(arg_32_0.additionTxt))
	end
	...
	local var_32_4 = var_32_3(var_4(arg_32_0.additionTxt), 220, 0.5)
	local var_32_5 = var_2.setFrom(var_32_4, 160)
	local var_32_6 = var_2.setOnComplete

	System = var_5

	var_32_6(var_32_5, var_5.Action(function()
...
function var_0_1.ShowCapcityTip(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4)
	...
	var_34_4.type = var_1_10011
	i18n = var_1_10011
	var_34_4.content = var_1_10011("backyard_food_remind", var_34_1)
	i18n = var_11
	var_34_4.name = var_11("backyard_food_count", arg_34_2 .. "/" .. arg_34_3)

	local var_34_5 = {}

	DROP_TYPE_ITEM = var_1_10012
	var_34_5.type = var_1_10012
	var_34_5.id = arg_34_1
	i18n = var_1_10012
	var_34_5.count = var_1_10012("common_food") .. ":" .. arg_34_4
	...
	function var_34_4.onYes()
		...
		BackyardFeedMediator = var_2_10003

		var_35_1(var_35_0, var_2_10003.USE_FOOD, arg_34_1, 1, var_34_0.stopRemindToggle.isOn)
...
function var_0_1.TriggerAddFood(arg_36_0, arg_36_1, arg_36_2)
	...
	var_36_1(var_36_0, var_1_10006.USE_FOOD, arg_36_1, arg_36_2)
...
function var_0_1.willExit(arg_38_0)
	...
	if var_38_0(var_3(arg_38_0.additionTxt)) then
		LeanTween = var_1
		...
		var_38_1(var_3(arg_38_0.additionTxt))
	end
