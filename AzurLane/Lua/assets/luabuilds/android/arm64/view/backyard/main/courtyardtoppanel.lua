...
function var_0_1.init(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.comfortableTxt = var_2_8(var_2_7, var_4(var_1_10006))
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.comfortableImg = var_2_11(var_2_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.switchTxt = var_2_15(var_2_14, var_4(var_1_10006))
	...
	local var_2_17 = var_3.Find(var_2_16, "btns/topright")

	typeof = var_4
	CanvasGroup = var_6
	arg_2_0.cg = var_1(var_2_17, var_4(var_6))
	setText = var_1

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_3.Find(var_2_18, "btns/topright/comfortable/label")

	i18n = var_4

	var_1(var_2_19, var_4("word_comfort_level"))

	setText = var_1

	local var_2_20 = arg_2_0._tf
	local var_2_21 = var_3.Find(var_2_20, "btns/topright/switch/label")

	i18n = var_4

	var_1(var_2_21, var_4("courtyard_label_floor"))
...
function var_0_1.OnRegister(arg_3_0)
	...
	local function var_3_11()
		...
		if not var_2.isUnlockFloor(var_7_1, var_7_0) then
			...
			CourtYardMediator = var_5

			var_7_4(var_7_3, var_5.SWITCH, var_7_0)
		end
...
function var_0_1.UnLockTip(arg_8_0)
	...
	if not var_1.IsMaxLevel(var_8_0) then
		...
		var_8_1(var_8_0, var_1_10004("sec_floor_limit_tip"))
	...
	local var_8_3 = var_1_10002.shop_template[var_8_2].resource_num

	_BackyardMsgBoxMgr = var_8_0

	local var_8_4 = var_8_0
	local var_8_5 = var_8_0.Show
	local var_8_6 = {}

	i18n = var_1_10007
	var_8_6.content = var_1_10007("backyard_open_2floor", var_8_3)
	...
	function var_8_6.onYes()
		...
		var_9_1(var_9_0, var_2_10003.UN_LOCK_2FLOOR, var_8_2, 1)
...
function var_0_1.OnFlush(arg_14_0, arg_14_1)
	if not arg_14_1 then
		...
		local var_14_0 = var_1_10004.DORM_UPDATE_TYPE_NAME

		BackYardConst = var_1_10005
		arg_14_1 = var_1_10002(var_14_0, var_1_10005.DORM_UPDATE_TYPE_LEVEL)
	end
	...
	if var_14_1(var_14_2, var_1_10005.DORM_UPDATE_TYPE_NAME) > 0 then
		arg_14_0:FlushName()
	end
	...
	if var_14_3(var_14_4, var_5.DORM_UPDATE_TYPE_LEVEL) > 0 then
...
function var_0_1.FlushComfortable(arg_16_0)
	...
	local var_16_2 = var_1:GetComfortableLevel(var_16_1)

	LoadSpriteAtlasAsync = var_16_0

	var_16_0("ui/CourtyardUI_atlas", "express_" .. var_16_2, function(arg_17_0)
