...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_7 = var_3.Find(var_3_6, "frame/title")

	i18n = var_3_4

	var_1_10001(var_3_7, var_3_4("word_preview"))
...
function var_0_1.Show(arg_6_0, arg_6_1, arg_6_2)
	...
	arg_6_0.shipId = var_1_10004.getDefaultShipConfig(var_6_0.ship_group).id
...
function var_0_1.SetUp(arg_7_0)
	...
	id = var_1_10006
	arg_7_0.instance = var_7_0(var_7_2(var_7_1, var_1_10006))
	...
	local var_7_8 = arg_7_0.GetPutFurniture(var_7_7)
	local var_7_9 = 0

	Timer = var_7_7
	arg_7_0.timer = var_7_7.New(function()
		if arg_7_0.step == 2 then
			local var_8_0 = var_7_4
			local var_8_1 = var_0.GetStorey(var_8_0)

			if var_0.GetFurniture(var_8_1, var_7_8.id) then
				var_2_10003 = var_0

				if not var_0.AnySlotIsLoop(var_2_10003) then
					var_2_10003 = var_0

					if not var_0.IsInteractionState(var_2_10003) then
						GetOrAddComponent = var_1
						var_2_10005 = var_7_6
						var_2_10003 = var_2_10003.GetRect(var_2_10005)
						typeof = var_2_10004
						CanvasGroup = var_2_10006

						local var_8_2 = var_1(var_2_10003, var_2_10004(var_2_10006))

						var_8_2.alpha = 0
						setActive = var_8_2

						var_8_2(arg_7_0.mask, true)

						onButton = var_8_2
						var_2_10003 = arg_7_0

						local var_8_3 = arg_7_0.mask
						...
						var_8_2(var_2_10003, var_8_3, var_2_10005, var_2_10006)
		...
		if arg_7_0.step == 1 then
			local var_8_4 = var_7_6
			local var_8_5 = var_0.GetCurrStorey(var_8_4)

			if var_0.ItemsIsLoaded(var_8_5) then
				local var_8_6 = arg_7_0

				var_0.StartInteraction(var_8_6, var_7_4)

				GetOrAddComponent = var_0

				local var_8_7 = var_7_6
				local var_8_8 = var_2.GetRect(var_8_7)

				typeof = var_2_10003
				CanvasGroup = var_2_10005
				var_0(var_8_8, var_2_10003(var_2_10005)).alpha = 1
				arg_7_0.step = 2
			end
		end
		...
		if var_0.IsInit(var_8_9) then
			local var_8_10 = var_7_4

			if var_0.IsLoaed(var_8_10) and arg_7_0.step == 0 then
				local var_8_11 = arg_7_0

				var_8_11.step = 1
				GetOrAddComponent = var_8_11

				local var_8_12 = var_7_6
				local var_8_13 = var_2.GetRect(var_8_12)

				typeof = var_2_10003
				CanvasGroup = var_2_10005
				var_8_11(var_8_13, var_2_10003(var_2_10005)).alpha = 0

				local var_8_14 = var_7_4

				var_0.AddFurniture(var_8_14, var_7_8)

				local var_8_15 = var_7_4
				local var_8_16 = var_0.AddShip
				local var_8_17 = arg_7_0

				var_8_16(var_8_15, var_3.GetPutShip(var_8_17))
			end
		end
	...
	local var_7_10 = arg_7_0.timer

	var_5.Start(var_7_10)
...
function var_0_1.GenCourtYardData(arg_13_0)
	...
	var_13_4.system = var_6.SYSTEM_VISIT
