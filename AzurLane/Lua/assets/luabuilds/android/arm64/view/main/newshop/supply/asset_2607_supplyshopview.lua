...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_1_10002.TYPE_ACTIVITY

	ActivityShopPage = var_3_0
	var_3_1[var_3_2] = var_3_0.New(arg_3_0, arg_3_0._go)
	ShopConst = var_3_2
...
function var_0_1.initUI(arg_5_0)
	...
	arg_5_0.lScrollRect = var_1_10001(var_3.Find(var_5_0, "scroll"), "LScrollRect")
	...
	typeof = var_4
	RectTransform = var_6
	arg_5_0.scrollRectTF = var_1(var_5_2, var_4(var_6))
	GetComponent = var_1

	local var_5_3 = arg_5_0.scrollContent

	typeof = var_4
	GridLayoutGroup = var_6
	arg_5_0.layoutGroup = var_1(var_5_3, var_4(var_6))
	...
	local var_5_6 = var_3.Find(var_5_5, "viewport/view/group/items")

	typeof = var_4
	GridLayoutGroup = var_6

	local var_5_7 = var_1(var_5_6, var_4(var_6))
...
function var_0_1.SetAllShopData(arg_7_0, arg_7_1)
	...
	ipairs = var_1_10003
	ShopConst = var_1_10005

	for iter_7_0, iter_7_1 in var_1_10003(var_1_10005.SUPPLY_SHOP_LIST[arg_7_0.supplyShopType]) do
		ipairs = var_1_10008
	...
	local var_7_2 = arg_7_0:GetDefaultShopIndex()

	triggerButton = var_4

	local var_7_3 = arg_7_0._tf
	local var_7_4 = var_6.Find(var_7_3, "toggleGroup")

	var_4(var_6.GetChild(var_7_4, arg_7_0.packageSortList[var_7_2].index - 1))
	arg_7_0:UpdateShop()
...
function var_0_1.initToggleList(arg_10_0)
	...
	UIItemList = var_10_0
	arg_10_0.uiToggleList = var_10_0.New(var_10_1, var_10_3)
			...
			if var_11_0 == var_5.TYPE_ACTIVITY then
				...
				if var_2_10006.activity_template[var_11_2] then
					...
					if var_6.activity_template[var_11_2].config_client then
						...
						local var_11_4 = arg_11_2:Find("selected/Label")

						i18n = var_2_10010

						local var_11_5

						if not var_2_10010(var_11_3) then
							i18n = var_11_5
							ShopConst = var_12
							var_11_5 = var_11_5(var_12.TYPE2NAME[var_11_0])
						end

						var_2_10007(var_11_4, var_11_5)
						...
						do
							local var_11_6 = arg_11_2:Find("selected/Label")

							i18n = var_2_10008
							ShopConst = var_10

							var_11_2(var_11_6, var_2_10008(var_10.TYPE2NAME[var_11_0]))
						end
						...
						local var_11_7 = arg_11_2:Find("selected/enText")

						i18n = var_2_10008
						ShopConst = var_10

						var_11_2(var_11_7, var_2_10008(var_10.TYPE2NAME[var_11_0] .. "en"))

						setText = var_11_2

						local var_11_8 = arg_11_2:Find("unselected/Label")

						i18n = var_2_10008
						ShopConst = var_10

						var_11_2(var_11_8, var_2_10008(var_10.TYPE2NAME[var_11_0]))

						local var_11_9 = arg_10_0.packageSortList[arg_11_1 + 1].index
						local var_11_10 = arg_10_0.allShopList[var_11_0][1]
						local var_11_11 = arg_10_0.pages[var_11_0]
						local var_11_12

						var_2_10008, var_11_12 = var_7.CanOpen(var_11_11, var_11_10, arg_10_0.player)

						if var_2_10008 == false then
							setActive = var_11_11

							var_11_11(arg_11_2:Find("unselected/Label/lock"), true)
						else
							setActive = var_11_11

							var_11_11(arg_11_2:Find("unselected/Label/lock"), false)
						end

						setActive = var_11_11

						var_11_11(arg_11_2:Find("unselected"), true)

						setActive = var_11_11

						var_11_11(arg_11_2:Find("selected"), false)
						...
						if arg_11_0 == var_11_0.EventUpdate then
							...
							local function var_11_15()
								...
								if var_12_4 == false then
									...
									local var_12_6 = var_12_3.TipsMgr.GetInstance()

									var_12_3.ShowTips(var_12_6, var_12_5)
								...
								var_12_3(var_8.Find(var_12_7, "unselected"), false)

								setActive = var_12_3

								local var_12_8 = arg_11_2

								var_12_3(var_8.Find(var_12_8, "selected"), true)
								...
								if arg_10_0.prevBtn then
									...
									var_6(var_8.Find(var_12_9, "unselected"), true)

									setActive = var_6

									local var_12_10 = arg_10_0.prevBtn

									var_6(var_8.Find(var_12_10, "selected"), false)
								end
							...
							var_3(var_11_13, var_11_14, var_11_15, var_2_10008)
						end
...
function var_0_1.RefreshResItemList(arg_16_0, arg_16_1)
	...
	for iter_16_0, iter_16_1 in var_1_10002(arg_16_1) do
		...
		if not arg_16_0.shopResItemList[iter_16_0] then
			...
			go = var_1_10010
			var_16_1 = var_16_1(var_1_10010(arg_16_0.shopResItem), arg_16_0.shopResParent)
		end
...
function var_0_1.blurView(arg_27_0)
	...
	var_27_4[1] = var_7.Find(var_27_5, "bg")
