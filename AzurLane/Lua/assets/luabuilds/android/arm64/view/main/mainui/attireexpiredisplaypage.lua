...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "window/sliders/scrollrect/content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uilist = var_2_0(var_2_2, var_4.Find(var_2_3, "window/sliders/scrollrect/content/tpl"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_4.Find(var_3_1, "window/confirm_btn")
...
function var_0_1.OnDestroy(arg_10_0)
	...
	var_10_1(var_10_0, var_10_2, var_1_10005.UIMgr.GetInstance()._normalUIMain)
