...
function var_0_1.init(arg_2_0)
	...
	local var_2_16 = var_3.Find(var_2_15, "send_channel/list")
	local var_2_17 = arg_2_0.rtPage

	arg_2_0.uiSendChanncelList = var_2_14(var_2_16, var_4.Find(var_2_17, "send_channel/list/tpl"))
	UIItemList = var_1

	local var_2_18 = var_1.New
	local var_2_19 = arg_2_0.rtPage
	local var_2_20 = var_3.Find(var_2_19, "channels/list")
	local var_2_21 = arg_2_0.rtPage

	arg_2_0.uiChanncelList = var_2_18(var_2_20, var_4.Find(var_2_21, "send_channel/list/tpl"))
	...
	local var_2_24 = var_3.Find(var_2_23, "send_channel/Text")

	i18n = var_4

	var_1(var_2_24, var_4("notice_label_send"))

	setText = var_1

	local var_2_25 = arg_2_0.rtPage
	local var_2_26 = var_3.Find(var_2_25, "channels/Text")

	i18n = var_4

	var_1(var_2_26, var_4("notice_label_recv"))

	setText = var_1

	local var_2_27 = arg_2_0.rtPage
	local var_2_28 = var_3.Find(var_2_27, "room/Text")

	i18n = var_4

	var_1(var_2_28, var_4("notice_label_room"))

	setText = var_1

	local var_2_29 = arg_2_0.rtPage
	local var_2_30 = var_3.Find(var_2_29, "room/tip")

	i18n = var_4

	var_1(var_2_30, var_4("notice_label_tip"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_14()
		...
		getInputText = var_2_10008

		var_2_10001(var_8_0, var_8_1, var_8_2, var_2_10006(var_2_10008(arg_3_0.roomInput)))
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			local function var_10_3()
				...
				if var_11_0 == var_3_10001.CHANNEL_GUILD then
					...
					local var_11_1 = var_11_0(var_3_10002)
			...
			var_4(var_10_1, var_10_2, var_10_3, var_2_10009)
...
function var_0_1.InitChannels(arg_12_0)
	...
	var_2.make(var_12_1, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_2_10003.EventUpdate then
			...
			var_13_2(arg_13_2:Find("line"), not var_13_5 and not var_13_4)
		end
...
function var_0_1.FlushSendChannel(arg_15_0)
	...
	var_2.eachActive(var_15_1, function(arg_16_0, arg_16_1)
		...
		var_2_10004(arg_16_1.Find(var_16_1, "mark"), var_16_0)

		PlayRoomChatConst = var_2_10004

		local var_16_2 = var_2_10004.CHANNEL2CN(var_2)

		setText = var_2_10005

		local var_16_3 = arg_16_1:Find("Text")

		setColorStr = var_16_1

		var_2_10005(var_16_3, var_16_1(var_16_2, var_16_0 and "#FFFFFF" or "#393a3c"))
	...
	var_2.eachActive(var_17_1, function(arg_18_0, arg_18_1)
		...
		if not (var_18_0 == var_4.CHANNEL_ALL) or not var_18_2 then
			...
			if not var_4 and not var_18_2 then
				...
				var_2_10006(arg_18_1.Find(var_18_3, "mark"), var_2_10005)

				PlayRoomChatConst = var_2_10006

				local var_18_4 = var_2_10006.CHANNEL2CN(var_18_0)

				setText = var_2_10007

				local var_18_5 = arg_18_1:Find("Text")

				setColorStr = var_18_3

				var_2_10007(var_18_5, var_18_3(var_18_4, var_2_10005 and "#FFFFFF" or "#393a3c"))
...
function var_0_1.FlushRoom(arg_19_0)
	...
	var_1_10002(arg_19_0.roomInput, var_19_1)
