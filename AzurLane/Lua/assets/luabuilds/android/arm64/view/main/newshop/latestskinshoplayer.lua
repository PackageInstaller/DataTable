...
var_0_1.TYPE_NEW_SKIN = "newSkin"
var_0_1.TYPE_PERMANANT_SKIN = "permanentSkin"
...
function var_0_1.init(arg_4_0)
	...
	local var_4_121 = var_3.Find(var_4_120, "panelMask/panel/bottom/ok/Text")

	i18n = var_4

	var_1(var_4_121, var_4("shop_new_confirm"))
	arg_4_0:Overlay()
...
function var_0_1.InitData(arg_20_0)
	...
	if not arg_20_0.contextData.type then
		var_20_0 = var_0_1.TYPE_PERMANANT_SKIN
	end
...
function var_0_1.GetAllCommodities(arg_21_0)
	if arg_21_0.type == var_0_1.TYPE_NEW_SKIN then
		getProxy = var_1
		ShipSkinProxy = var_1_10003
		var_1_10003 = var_1(var_1_10003)
		arg_21_0.commodities = var_1.GetInTimeSkins(var_1_10003)
	elseif arg_21_0.type == var_0_1.TYPE_PERMANANT_SKIN then
		getProxy = var_1
		ShipSkinProxy = var_1_10003
		var_1_10003 = var_1(var_1_10003)
		arg_21_0.commodities = var_1.GetPermanentSkins(var_1_10003)
	end
	...
	if var_1 then
		...
		local var_21_0 = var_1.gameset.levellimit_skintype.key_value

		pg = var_2

		local var_21_1 = var_2.gameset.levellimit_skintype.description
		...
		if var_21_0 >= var_3.getData(var_21_2).level then
			_ = var_1_10004
			arg_21_0.commodities = var_1_10004.filter(arg_21_0.commodities, function(arg_22_0)
				...
				return var_2.contains(var_21_1, var_22_0)
			end)
		end
	end
	...
	if arg_21_0.mode == var_0_1.MODE_OVERVIEW then
		for iter_21_0 = #arg_21_0.commodities, 1, -1 do
			local var_21_3 = arg_21_0.commodities[iter_21_0]
			local var_21_4 = var_5.getConfig(var_21_3, "genre")

			ShopArgs = var_1_10007

			if var_21_4 == var_1_10007.SkinShopTimeLimit then
				table = var_21_4

				var_21_4.remove(arg_21_0.commodities, iter_21_0)
			end
		end
	end
...
function var_0_1.filterOk(arg_32_0, arg_32_1)
	...
	local var_32_8 = var_1_10010.New({
		id = var_32_7
	})
	local var_32_9 = var_10.GetDefaultShipConfig(var_32_8)
	local var_32_10 = arg_32_0
	local var_32_11 = arg_32_0.ToVShip(var_32_10, var_32_9)
	...
	if var_32_0 ~= 0 then
		...
		local var_32_13 = var_32_10(var_1_10016)

		var_32_10 = var_32_10.hasSkin(var_32_13, var_32_7)

		local var_32_14 = var_10:NoUse()

		if var_32_0 == 1 and var_32_10 then
			var_32_12 = true
		end

		if var_32_0 == 2 and not var_32_10 then
			var_32_12 = true
		end

		if var_32_0 == 3 and var_32_10 and var_32_14 then
			var_32_12 = true
		end
	...
	if var_32_1[1] ~= 0 then
		...
		for iter_32_0, iter_32_1 in var_32_10(var_32_1) do
			if iter_32_1 == 1 then
				var_1_10021 = var_10

				if not var_10.IsLive2d(var_1_10021) then
					var_1_10021 = var_10

					if var_10.IsLive2dPlus(var_1_10021) then
						var_32_15 = true
					end
					...
					if iter_32_1 == 2 then
						...
						if not var_10.IsLive2d(var_1_10021) then
							...
							if not var_10.IsLive2dPlus(var_1_10021) then
								var_1_10021 = var_10

								if not var_10.IsSpine(var_1_10021) then
									var_1_10021 = var_10

									if not var_10.IsSpinePlus(var_1_10021) then
										var_32_15 = true
									end
								end
							end
					...
					if iter_32_1 == 3 then
						...
						if not var_10.IsSpine(var_1_10021) then
							...
							if var_10.IsSpinePlus(var_1_10021) then
								var_32_15 = true
							end
							...
							if iter_32_1 == 4 then
								...
								if var_10.IsBG(var_1_10021) then
									var_32_15 = true
								end
							end
							...
							if iter_32_1 == 5 then
								...
								if var_10.IsDbg(var_1_10021) then
									var_32_15 = true
								end
							end
							...
							if iter_32_1 == 6 then
								...
								if var_10.isBgm(var_1_10021) then
									var_32_15 = true
								end
							end
	...
	if var_32_2 ~= 0 then
		...
		var_32_10 = var_10:CantUse()

		if var_32_2 == 1 and not var_32_10 then
			var_32_16 = true
		end

		if var_32_2 == 2 and var_32_10 then
			var_32_16 = true
		end
	...
	if var_32_3[1] ~= 0 then
		...
		for iter_32_2, iter_32_3 in var_32_10(var_32_3) do
			ShipIndexCfg = var_1_10019
			var_1_10019 = var_1_10019.camp
			ipairs = var_1_10020

			for iter_32_4, iter_32_5 in var_1_10020(var_1_10019[iter_32_3 + 1].types) do
				Nation = var_1_10025

				if iter_32_5 == var_1_10025.LINK then
					var_1_10025 = var_32_11:getNation()
					Nation = var_1_10026

					if var_1_10026.LINK <= var_1_10025 then
						var_32_17 = true
					end
	...
	if var_32_4[1] ~= 0 then
		...
		for iter_32_6, iter_32_7 in var_32_10(var_32_4) do
			ShipIndexCfg = var_1_10019
			var_1_10019 = var_1_10019.rarity
			table = var_1_10020

			if var_1_10020.contains(var_1_10019[iter_32_7 + 1].types, var_32_11:getRarity()) then
				var_32_18 = true
			end
	...
	if var_32_5[1] ~= 0 then
		...
		for iter_32_8, iter_32_9 in var_32_10(var_32_5) do
			ShipIndexCfg = var_1_10019

			local var_32_20 = var_1_10019.type[iter_32_9 + 1].types

			if iter_32_9 + 1 < 4 then
				var_1_10021 = var_1_10019[iter_32_9].shipTypes
				table = var_22

				if var_22.contains(var_32_20, var_32_11:getShipType()) then
					var_32_19 = true
				end

				table = var_22

				if var_22.contains(var_32_20, var_32_11:getTeamType()) then
					var_32_19 = true
				end
			else
				table = var_1_10021

				if var_1_10021.contains(var_32_20, var_32_11:getShipType()) then
					var_32_19 = true
				end
			end
	...
	if var_32_6[1] ~= 0 then
		...
		for iter_32_10, iter_32_11 in var_32_10(var_32_6) do
			local var_32_22 = arg_32_0.classifyIds[iter_32_11 + 1]
			local var_32_23 = arg_32_1:getConfig("genre")

			ShopArgs = var_1_10021

			if var_32_23 == var_1_10021.SkinShopTimeLimit then
				if arg_32_0.mode == var_0_1.MODE_EXPERIENCE_FOR_ITEM then
					var_32_21 = var_32_22 == var_0_16 and arg_32_0:ExitSkinExperienceItem(arg_32_1.id)
				else
					var_32_21 = var_32_22 == var_0_14
				end
			elseif var_32_22 == var_0_13 then
				var_32_21 = true
			else
				if var_32_22 == var_0_15 then
					table = var_20

					if var_20.contains(arg_32_0.returnSkins, arg_32_1.id) then
						var_32_21 = true
				...
				if arg_32_0:GetShopTypeIdBySkinId(var_32_7) ~= 0 or not var_0_17 then
					var_1_10021 = var_20
				end

				var_32_21 = var_1_10021 == var_32_22
			end
...
function var_0_1.SetFilterPanel(arg_127_0)
	...
	local var_127_14 = arg_127_0
	local var_127_15 = arg_127_0.SetOptionList
	local var_127_16 = var_127_7

	ShipIndexConst = var_1_10012

	var_127_15(var_127_14, var_127_16, var_1_10012.CampNames, true)

	local var_127_17 = arg_127_0
	local var_127_18 = arg_127_0.SetOptionList
	local var_127_19 = var_127_9

	ShipIndexConst = var_12

	var_127_18(var_127_17, var_127_19, var_12.RarityNames, true)

	local var_127_20 = arg_127_0
	local var_127_21 = arg_127_0.SetOptionList
	local var_127_22 = var_127_11

	ShipIndexConst = var_12

	var_127_21(var_127_20, var_127_22, var_12.TypeNames, true)
	...
	local var_127_23 = arg_127_0
	local var_127_24 = arg_127_0.filterUI
	local var_127_25 = var_11.Find(var_127_24, "bg")

	local function var_127_26()
		pairs = var_2_10000
	...
	SFX_PANEL = var_127_24

	var_8(var_127_23, var_127_25, var_127_26, var_127_24)

	onButton = var_8

	local var_127_27 = arg_127_0
	local var_127_28 = arg_127_0.filterUI
	local var_127_29 = var_11.Find(var_127_28, "panelMask/panel/closeBtn")

	local function var_127_30()
		pairs = var_2_10000
	...
	SFX_PANEL = var_127_28

	var_8(var_127_27, var_127_29, var_127_30, var_127_28)

	onButton = var_8

	local var_127_31 = arg_127_0
	local var_127_32 = arg_127_0.filterUI
	local var_127_33 = var_11.Find(var_127_32, "panelMask/panel/bottom/ok")

	local function var_127_34()
		pairs = var_2_10000
	...
	SFX_PANEL = var_127_32

	var_8(var_127_31, var_127_33, var_127_34, var_127_32)
			...
			function var_1_10013()
				...
				if iter_136_0 == 0 then
					...
					for iter_137_2 = 0, arg_136_1.childCount - 1 do
						local var_137_4 = arg_136_0
						local var_137_5 = var_5.SetOptionSelect
						local var_137_6 = arg_136_1
						local var_137_7 = var_8.GetChild(var_137_6, iter_137_2)

						table = var_2_10009

						var_137_5(var_137_4, var_137_7, var_2_10009.contains(arg_136_0.filterValuesTemp[arg_136_2], iter_137_2))
					end
				end
...
function var_0_1.GetSkinClassify(arg_139_0)
	...
	for iter_139_0, iter_139_1 in var_1_10003(arg_139_0.commodities) do
		local var_139_2

		if arg_139_0:GetShopTypeIdBySkinId(iter_139_1:getSkinId()) ~= 0 or not var_0_17 then
			var_139_2 = var_8
		end

		local var_139_3

		if not var_139_1[var_139_2] then
			var_139_3 = 0
		end

		var_139_1[var_139_2] = var_139_3 + 1
	end
	...
	for iter_139_2, iter_139_3 in var_4(arg_139_0.returnSkins) do
		var_139_4[iter_139_3] = true
	end

	underscore = var_4

	if var_4.any(arg_139_0.commodities, function(arg_140_0)
		return var_139_4[arg_140_0.id]
	end) then
		table = var_4

		var_4.insert(var_139_0, var_0_15)
	end

	ipairs = var_4
	pg = var_6

	for iter_139_4, iter_139_5 in var_4(var_6.skin_page_template.all) do
		if iter_139_5 ~= var_0_18 and iter_139_5 ~= var_0_19 then
			local var_139_5

			if not var_139_1[iter_139_5] then
				var_139_5 = 0
			end
			...
			if var_139_5 > 0 then
				...
				var_139_5.insert(var_139_0, iter_139_5)
			end
		end
	end

	if arg_139_0.mode == var_0_1.MODE_EXPERIENCE then
		table = var_4

		var_4.insert(var_139_0, 1, var_0_14)
	end

	if arg_139_0.mode == var_0_1.MODE_EXPERIENCE_FOR_ITEM then
		table = var_4

		var_4.insert(var_139_0, 1, var_0_16)
	end

	table = var_4

	var_4.insert(var_139_0, 1, var_0_13)

	arg_139_0.classifyIds = var_139_0
	ipairs = var_4

	for iter_139_6, iter_139_7 in var_4(arg_139_0.classifyIds) do
		if iter_139_7 == var_0_13 then
			table = var_9

			local var_139_6 = var_9.insert
			local var_139_7 = arg_139_0.classifyNames

			i18n = var_1_10012

			var_139_6(var_139_7, var_1_10012("shop_filter_all"))
		elseif iter_139_7 == var_0_14 or iter_139_7 == var_0_16 then
			table = var_9

			local var_139_8 = var_9.insert
			local var_139_9 = arg_139_0.classifyNames

			i18n = var_1_10012

			var_139_8(var_139_9, var_1_10012("shop_filter_trial"))
		else
			local var_139_10

			if iter_139_7 == var_0_15 then
				table = var_139_10
				var_139_10 = var_139_10.insert

				local var_139_11 = arg_139_0.classifyNames

				i18n = var_1_10012

				var_139_10(var_139_11, var_1_10012("shop_filter_retro"))
			else
				table = var_139_10

				local var_139_12 = var_139_10.insert
				local var_139_13 = arg_139_0.classifyNames

				pg = var_1_10012

				var_139_12(var_139_13, var_1_10012.skin_page_template[iter_139_7].name)
			end
		end
	end
...
function var_0_1.GetShopTypeIdBySkinId(arg_141_0, arg_141_1)
	pg = var_1_10002

	local var_141_0 = var_1_10002.ship_skin_template.get_id_list_by_shop_type_id
	...
	for iter_141_0, iter_141_1 in var_3(var_141_0) do
		ipairs = var_1_10008

		for iter_141_2, iter_141_3 in var_1_10008(iter_141_1) do
...
function var_0_1.OnShopping(arg_142_0, arg_142_1)
	if not arg_142_0.showingCommodity then
		return
	end

	if arg_142_0.purchaseView then
		local var_142_0 = arg_142_0.purchaseView

		if var_2.GetLoaded(var_142_0) then
			local var_142_1 = arg_142_0.purchaseView

			var_2.Hide(var_142_1)
		end
	end
...
function var_0_1.OnFurnitureUpdate(arg_143_0, arg_143_1)
	...
	if var_1_10003.ExistFurniture(var_143_0) then
		Goods = var_3

		if var_3.Id2FurnitureId(var_143_0) == arg_143_1 then
...
function var_0_1.CheckDownloadSkinList(arg_144_0, arg_144_1)
	local var_144_0 = {}

	ipairs = var_1_10003

	for iter_144_0, iter_144_1 in var_1_10003(arg_144_0.commodities) do
		PaintingGroupConst = var_1_10008

		var_1_10008.AddPaintingNameBySkinID(var_144_0, iter_144_1:getSkinId())
	end
	...
	var_4.PaintingDownload(var_144_1)

	return
end

function var_0_1.willExit(arg_145_0)
	arg_145_0:ClearCards()

	ClearLScrollrect = var_1

	var_1(arg_145_0.scrollrect)

	pg = var_1

	local var_145_0 = var_1.DynamicBgMgr.GetInstance()

	var_1.ClearBg(var_145_0, arg_145_0:getUIName())

	if arg_145_0.live2dChar then
		local var_145_1 = arg_145_0.live2dChar

		var_1.Dispose(var_145_1)

		arg_145_0.live2dChar = nil
	end

	if arg_145_0.voucherMsgBox then
		local var_145_2 = arg_145_0.voucherMsgBox

		var_1.Destroy(var_145_2)

		arg_145_0.voucherMsgBox = nil
	end

	if arg_145_0.purchaseView then
		local var_145_3 = arg_145_0.purchaseView

		var_1.Destroy(var_145_3)
	...
	for iter_145_0, iter_145_1 in var_1(arg_145_0.downloads) do
		iter_145_1:Dispose()
	end
	...
	if arg_145_0.interactionPreview then
		local var_145_4 = arg_145_0.interactionPreview

		var_1.Dispose(var_145_4)
...
function var_0_1.onBackPressed(arg_146_0)
	pg = var_1_10001

	local var_146_0 = var_1_10001.m02
	local var_146_1 = var_1.sendNotification

	NewShopMainScene = var_1_10004

	var_146_1(var_146_0, var_1_10004.CLOSE_VIEW)
