...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.mainImg = var_2_4(var_2_3, var_4(var_1_10006.UI.Graphic))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.nameTxt = var_2_8(var_2_7, var_4(var_6))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.shipnameTxt = var_2_11(var_2_10, var_4(var_6))
	...
	ShipAtlasBgBtn = var_2_18

	local var_2_21 = var_2_18.New
	local var_2_22 = var_2_19

	PlayerVitaeBaseBtn = var_6
	var_2_20[1] = var_2_21(var_2_22, var_6.HRZ_TYPE, arg_2_0.event, arg_2_0.bgFlag)
	...
	PlayerVitaeBaseBtn = var_6
	var_2_20[2] = var_2_23(var_2_24, var_6.HRZ_TYPE, arg_2_0.event, arg_2_0.l2dFlag)
	...
	arg_2_0.bgView = var_2_27(var_4.Find(var_2_28, "bg/bg"))
	SkinAtlasPaintingView = var_2

	local var_2_29 = var_2.New
	local var_2_30 = arg_2_0._tf

	arg_2_0.paintingView = var_2_29(var_4.Find(var_2_30, "paint"))
...
function var_0_1.OnInit(arg_3_0)
	...
	typeof = var_3_4
	PinchZoom = var_1_10006

	local var_3_8 = var_3_7(var_3_6, var_3_4(var_1_10006))
	...
	local function var_3_14()
		...
		if var_0.CantUse(var_7_0) then
			...
			var_7_2(var_7_1, var_2_10003("without_ship_to_wear"))
	...
	local function var_3_17()
		...
		local var_8_2 = var_2_10001.New({
			id = var_8_1
		})
		local var_8_3 = {}

		MSGBOX_TYPE_OBTAIN = var_3
		var_8_3.type = var_3
	...
	local function var_3_20()
		...
		if var_2_10000.GetChangeSkinData(arg_3_0.skin.id) then
			...
			var_9_1.id = var_2_10003.GetChangeSkinNextId(arg_3_0.skin.id)
	...
	var_2(var_3_21, var_5.Find(var_3_22, "main"), function()
...
function var_0_1.OnNext(arg_14_0)
	...
	SkinAtlasScene = var_1_10004

	var_14_1(var_14_0, var_1_10004.ON_NEXT_SKIN, arg_14_0.index)
...
function var_0_1.OnPrev(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10004.ON_PREV_SKIN, arg_15_0.index)
...
function var_0_1.Show(arg_16_0, arg_16_1, arg_16_2)
	...
	var_16_0(arg_16_0.changeBtnDis, var_16_3)

	setActive = var_16_0

	var_16_0(arg_16_0.changeBtnEn, not var_16_3)

	ShipSkin = var_16_0

	local var_16_4 = var_16_0.GetChangeSkinData(arg_16_0.skin.id)

	setActive = var_16_2

	var_16_2(arg_16_0.changeSkinUI, var_16_4 and true or false)
	...
	var_6(var_16_6, not var_9.IsAsmrSkin(var_16_7))
	...
	var_6(var_16_8, not var_9.OwnShip(var_16_9))
...
function var_0_1.UpdateChar(arg_26_0, arg_26_1, arg_26_2)
	...
	var_4.GetSpineChar(var_26_1, var_26_0, true, function(arg_27_0)
