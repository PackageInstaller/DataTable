...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.SELL_BLUEPRINT, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.FRAG_SELL, {
			arg_2_1
		})
	...
	arg_1_0:bind(var_0_1.USE_ITEM, function(arg_3_0, arg_3_1, arg_3_2)
		...
		UseItemCommand = var_2_10004

		if not var_2_10004.Check(var_3_1, arg_3_2) then
		...
		var_4.PlayOpenBox(var_3_3, var_3_1:getConfig("display_effect"), function()
			...
			local var_4_2 = var_3_10003.USE_ITEM
			local var_4_3 = {
				id = arg_3_1,
				count = arg_3_2
			}
			local var_4_4 = var_3_1
			local var_4_5 = var_5.getConfig(var_4_4, "type")

			Item = var_3_10006
			var_4_3.isEquipBox = var_4_5 == var_3_10006.EQUIPMENT_BOX_TYPE_5
	...
	arg_1_0:bind(var_0_1.COMPOSE_ITEM, function(arg_5_0, arg_5_1, arg_5_2)
		...
		var_5_1(var_5_0, var_2_10006.COMPOSE_ITEM, {
			id = arg_5_1,
			count = arg_5_2
		})
	...
	arg_1_0:bind(var_0_1.EXCHANGE_LOVE_LETTER_ITEM, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10005.EXCHANGE_LOVE_LETTER_ITEM, {
			activity_id = arg_6_1
		})
	...
	arg_1_0:bind(var_0_1.CHECK_LOVE_LETTER_MAIL, function(arg_8_0, arg_8_1, arg_8_2)
		...
		var_8_1(var_8_0, var_2_10006.LOVE_ITEM_MAIL_CHECK, {
			item_id = arg_8_1,
			group_id = arg_8_2
		})
	...
	arg_1_0:bind(var_0_1.REPAIR_LOVE_LETTER_MAIL, function(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
		...
		var_9_1(var_9_0, var_2_10007.LOVE_ITEM_MAIL_REPAIR, {
			item_id = arg_9_1,
			year = arg_9_2,
			group_id = arg_9_3
		})
...
function var_0_1.handleNotification(arg_11_0, arg_11_1)
	...
	if var_11_1 == var_11_0.ITEM_UPDATED then
		...
		if var_11_2.id == var_11_3.id then
			if not (var_11_2.count <= 0) then
				if var_11_3.extra then
					...
					local var_11_4 = var_5(var_1_10007)
				...
				do
					...
					local var_11_8 = var_1_10008.New
					local var_11_9 = {}

					DROP_TYPE_ITEM = var_1_10011
					var_11_9.type = var_1_10011
					...
					if var_11_1 == var_11_3.USE_ITEM_DONE then
						...
						if var_11_1 == var_4.FRAG_SELL_DONE then
							...
							if var_11_1 == var_4.LOVE_ITEM_MAIL_CHECK_DONE then
