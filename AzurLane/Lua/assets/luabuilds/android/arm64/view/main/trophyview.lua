...
Color = var_0_10001
var_0_0.GRAY_COLOR = var_0_10001(0.764, 0.764, 0.764, 0.784)
...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0._trophyDescUpper = var_1_1(var_1_0, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0._trophyDescLower = var_1_3(var_1_2, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0._trophyCount = var_1_5(var_1_4, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Slider = var_1_10007
	arg_1_0._progressBar = var_1_7(var_1_6, var_5(var_1_10007))
	findTF = var_2
...
function var_0_0.setGray(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_2 then
		...
		typeof = var_6
		Image = var_1_10008
		var_6_1(var_6_0, var_6(var_1_10008)).color = var_0_0.GRAY_COLOR
	else
		...
		local var_6_4 = var_6_3(var_6_2, var_6(var_1_10008))

		Color = var_1_10004
		var_6_4.color = var_1_10004.white
	end
...
function var_0_0.updateProgressView(arg_7_0, arg_7_1)
	...
	if var_5.canClaimed(var_7_2) then
		local var_7_3 = arg_7_0._progressTrophy

		var_7_4 = not var_5.isClaimed(var_7_3)
	end
...
function var_0_0.GetTrophyClaimTipsID(arg_8_0)
	...
	if var_1_10001(var_3.getConfig(var_8_0, "icon")) < 9000 then
...
function var_0_0.SetTrophyReminderMaterial(arg_9_0, arg_9_1)
	if arg_9_0._reminder then
		...
		typeof = var_5
		Image = var_1_10007
		var_9_2(var_9_1, var_5(var_1_10007)).material = arg_9_1
	end
...
function var_0_0.PlayClaimAnima(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	local var_10_2 = var_10_1(var_10_0, var_7(var_1_10009))
	...
	local var_10_5 = var_10_4(var_10_3, var_1_10008(var_1_10010))
	...
	var_5.SetEndEvent(var_10_5, function(arg_11_0)
		...
		if var_4.canClaimed(var_11_1) then
			local var_11_2 = arg_10_0._progressTrophy

			var_11_3 = not var_4.isClaimed(var_11_2)
		end
	...
	var_10_7(var_10_6, var_10(arg_10_0._tf, "frame"), false)
