...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_4 = var_3.Find(var_2_3, "frame/top/title")

	i18n = var_4

	var_1(var_2_4, var_4("words_information"))
	...
	var_1(var_2_6, var_4("msgbox_text_confirm"))
...
local function var_0_2(arg_4_0)
	...
	if var_4_0 == var_1_10002.MONTH_CARD then
		return var_0_1.TYPE_MONTH_CARD
	else
		Goods = var_2

		if var_4_0 == var_2.ITEM_BOX then
			return var_0_1.TYPE_GIFTPACKAGE
		else
			Goods = var_2

			if var_4_0 == var_2.PASS_ITEM then
...
function var_0_1.LoadWindow(arg_9_0, arg_9_1, arg_9_2)
	...
	var_9_1(var_9_0, var_9_2, var_9_3, var_9.Events.UnityAction_UnityEngine_Object(function(arg_10_0)
...
function var_0_1.UpdateMonthCard(arg_14_0, arg_14_1)
	...
	local var_14_0 = arg_14_1:Find("title/label/txt")

	i18n = var_1_10005

	var_1_10002(var_14_0, var_1_10005("chargetip_monthcard_1"))

	local var_14_1 = arg_14_0.chargeCommodity
	local var_14_2 = var_2.getConfig(var_14_1, "gem")
	local var_14_3 = arg_14_0.chargeCommodity
	local var_14_4 = var_14_2 + var_3.getConfig(var_14_3, "extra_gem")

	setText = var_3

	var_3(arg_14_1:Find("title/Text"), "X" .. var_14_4)

	setText = var_3

	local var_14_5 = arg_14_1:Find("sub_title")

	i18n = var_6

	var_3(var_14_5, var_6("chargetip_monthcard_2"))

	local var_14_6 = arg_14_0.chargeCommodity
	local var_14_7 = var_3.getConfig(var_14_6, "display")

	var_0_3(arg_14_1, var_14_7)
...
function var_0_1.UpdateGiftPackage(arg_15_0, arg_15_1)
	...
	local var_15_0 = arg_15_1:Find("title")

	i18n = var_1_10005

	var_1_10002(var_15_0, var_1_10005("chargetip_giftpackage"))

	local var_15_1 = arg_15_0.chargeCommodity
	local var_15_2 = var_2.GetDropItem(var_15_1)

	UIItemList = var_1_10003

	local var_15_3 = var_1_10003.New(arg_15_1:Find("list/content"), arg_15_1:Find("list/content/award"))

	var_3.make(var_15_3, function(arg_16_0, arg_16_1, arg_16_2)
		UIItemList = var_2_10003
...
function var_0_1.UpdateCrusing(arg_17_0, arg_17_1)
	...
	local var_17_0 = arg_17_1:Find("title")

	i18n = var_1_10005

	var_1_10002(var_17_0, var_1_10005("chargetip_crusing"))

	setText = var_1_10002

	local var_17_1 = arg_17_1:Find("sub_title")

	i18n = var_5

	var_1_10002(var_17_1, var_5("charge_tip_crusing_label"))

	local var_17_2 = arg_17_0.chargeCommodity
	local var_17_3 = var_2.getConfig(var_17_2, "display")

	var_0_3(arg_17_1, var_17_3)
