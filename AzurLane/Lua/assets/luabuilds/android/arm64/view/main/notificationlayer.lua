...
function var_0_1.init(arg_5_0)
	...
	local var_5_8 = var_4.Find(var_5_7, "contain/ListContainer/inputbg/input/Placeholder")

	i18n = var_5

	var_2(var_5_8, var_5("notice_input_desc"))
	...
	typeof = var_5
	CanvasGroup = var_7
	arg_5_0.enterRoomCG = var_5_20(var_5_19, var_5(var_7))
	...
	typeof = var_5
	InputField = var_7
	arg_5_0.inputTF = var_5_25(var_5_24, var_5(var_7))
	...
	typeof = var_5
	Image = var_7
	arg_5_0.switchNormalSprite = var_5_29(var_5_28, var_5(var_7)).sprite
	...
	typeof = var_5
	Image = var_7
	arg_5_0.switchSelectedSprite = var_5_32(var_5_31, var_5(var_7)).sprite
	setText = var_2
	findTF = var_5_31
	...
	var_2(var_5_33, var_5("notice_label_send"))
	...
	var_2(var_5_34, var_5("notice_label_recv"))
	...
	var_2(var_5_35, var_5("notice_label_room"))
	...
	var_2(var_5_36, var_5("notice_label_tip"))
	...
	var_2(var_5_37, var_5("please_input_1_99"))
	...
	var_2(var_5_38, var_5("word_cancel"))
	...
	typeof = var_5
	Image = var_7
	arg_5_0.normalSprite = var_5_44(var_5_43, var_5(var_7)).sprite
	...
	typeof = var_5
	Image = var_7
	arg_5_0.selectedSprite = var_5_47(var_5_46, var_5(var_7)).sprite
	...
	typeof = var_5
	Image = var_7
	arg_5_0.bottomChannelNormalSprite = var_5_51(var_5_50, var_5(var_7)).sprite
	...
	typeof = var_5
	Image = var_7
	arg_5_0.bottomChannelSelectedSprite = var_5_54(var_5_53, var_5(var_7)).sprite

	local var_5_55 = {}

	ChatConst = var_5_3
	var_5_55[1] = var_5_3.ChannelAll
	ChatConst = var_3
	...
	for iter_5_0, iter_5_1 in var_3(var_5_55) do
		...
		typeof = var_13
		Image = var_1_10015
		var_5_56[iter_5_0] = var_5_59(var_5_58, var_13(var_1_10015)).sprite
		...
		typeof = var_13
		Image = var_1_10015
		var_5_60[iter_5_0] = var_5_63(var_5_62, var_13(var_1_10015)).sprite
		...
		typeof = var_13
		Image = var_1_10015
		var_5_64[iter_5_0] = var_5_67(var_5_66, var_13(var_1_10015)).sprite
		table = var_5_64
		...
		if var_5_68(var_1_10011.SendChannels, iter_5_0) then
			...
			typeof = var_13
			Image = var_1_10015
			var_5_69[iter_5_0] = var_5_72(var_5_71, var_13(var_1_10015)).sprite
		end
	end
...
function var_0_1.adjustMsgListPanel(arg_6_0)
	...
	GetComponent = var_6_1
	var_6_1(arg_6_0.listTF, "LayoutElement").preferredHeight = var_6_2 - var_6_3
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_2()
		...
		var_0.PlayUIAnimation(var_8_0, arg_7_0._tf, "exit", function()
			if arg_7_0.currentForm == var_0_1.FORM_BATTLE then
				...
				NotificationMediator = var_3_10003

				var_9_1(var_9_0, var_3_10003.BATTLE_CHAT_CLOSE)
			end
	...
	local function var_7_8()
		if arg_7_0.input.text == "" then
			...
			var_11_1(var_11_0, var_2_10004("main_notificationLayer_sendButton"))
		...
		var_11_3(var_11_2, var_2_10004.ON_SEND_PUBLIC, var_0_1.ChannelBits.send, var_0)
	...
	var_1(var_7_12, var_7_13, var_7_14, var_6)
	...
	local function var_7_17()
		...
		local var_14_2 = var_2_10003.CHANGE_ROOM

		tonumber = var_2_10004

		var_14_1(var_14_0, var_14_2, var_2_10004(arg_7_0.inputTF.text))
	...
	var_1(var_7_15, var_7_16, var_7_17, var_6)
	...
	local function var_7_20()
		...
		var_2_10000(var_15_0, not var_2_10003(arg_7_0.channelSendPop))
	...
	var_1(var_7_18, var_7_19, var_7_20, var_6)
	...
	var_7_23(var_7_24, var_7_25, var_5.Action(function()
	...
	Vector2 = var_1_10002
	var_7_26.offsetMax = var_1_10002(0, 0)
	rtf = var_7_26
	...
	var_2.make(var_20_1, function(arg_21_0, arg_21_1, arg_21_2)
		...
		if arg_21_0 == var_2_10003.EventUpdate then
			...
			local function var_21_3()
				...
				local var_22_1 = var_3_10001.ToggleBits
				local var_22_2 = var_0_1.ChannelBits.recv
				local var_22_3 = var_22_0

				ChatConst = var_3_10005

				local var_22_4 = var_22_1(var_22_2, var_22_3, var_3_10005.ChannelAll, var_21_0)
			...
			var_4(var_21_1, var_21_2, var_21_3, var_9)
		end
...
function var_0_1.updateFilter(arg_24_0)
	...
	var_2.each(var_24_1, function(arg_25_0, arg_25_1)
		...
		if var_25_1(var_25_2, var_2_10006.lshift(1, var_25_0)) > 0 then
	...
	local var_24_3 = var_1_10003.lshift
	local var_24_4 = 1

	ChatConst = var_1_10006

	local var_24_5 = var_24_3(var_24_4, var_1_10006.ChannelAll)

	_ = var_24_1
	arg_24_0.filteredMessages = var_24_1.filter(arg_24_0.messages, function(arg_26_0)
		local var_26_2
		...
		if var_24_2 ~= var_24_5 then
			...
			if not (var_26_0(var_26_1, var_2_10004.lshift(1, arg_26_0.type)) > 0) then
				var_26_2 = false
...
function var_0_1.updateChatChannel(arg_27_0)
	...
	var_1_10001(var_3.Find(var_27_0, "Text"), arg_27_0.bottomChannelTextSprites[var_0_1.ChannelBits.send], true)
...
function var_0_1.updateChannelSendPop(arg_28_0)
	...
	local var_28_3 = var_28_1(var_4.Find(var_28_2, "type_send"), arg_28_0.bottomChannelTpl)
	...
	var_28_3:make(function(arg_31_0, arg_31_1, arg_31_2)
		...
		if arg_31_0 == var_2_10003.EventUpdate then
			...
			var_4(var_31_1, var_31_2, var_31_3, var_9)
		end
...
function var_0_1.updateRoom(arg_33_0)
	...
	local var_33_1 = var_3.Find(var_33_0, "text")

	i18n = var_1_10004

	var_1_10001(var_33_1, var_1_10004("main_notificationLayer_enter_room", arg_33_0.player.chatRoomId == 0 and "" or arg_33_0.player.chatRoomId))
	...
	if arg_33_0.player.chatRoomId == 0 then
		...
		if not var_4("common_not_enter_room") then
...
function var_0_1.showChangeRoomPanel(arg_34_0)
	...
	var_34_1.text = var_1_10002(arg_34_0.player.chatRoomId)
	...
	var_34_3:make(function(arg_37_0, arg_37_1, arg_37_2)
		...
		if arg_37_0 == var_2_10003.EventUpdate then
			...
			var_4(var_37_1, var_37_2, var_37_3, var_9)
		end

		return
	end)
	var_34_3:align(#var_34_2)
	var_34_4()

	arg_34_0.tempRoomRecvBits = var_0_1.ChannelBits.recv
	ChatConst = var_4

	local var_34_5 = var_4.RecvChannels

	UIItemList = var_5

	local var_34_6 = var_5.New(arg_34_0.roomRecvBtns, arg_34_0.switchTpl)

	local function var_34_7()
		local var_39_0 = var_34_6

		var_0.each(var_39_0, function(arg_40_0, arg_40_1)
			local var_40_0 = var_34_5[arg_40_0 + 1]
			...
			if var_40_1(var_40_2, var_3_10006.lshift(1, var_40_0)) > 0 then
				setImageSprite = var_3
	...
	var_34_6:make(function(arg_41_0, arg_41_1, arg_41_2)
		UIItemList = var_2_10003

		if arg_41_0 == var_2_10003.EventUpdate then
			local var_41_0 = var_34_5[arg_41_1 + 1]
			...
			local function var_41_3()
				...
				local var_42_0 = var_3_10000.filter(var_34_5, function(arg_43_0)
					ChatConst = var_4_10001
				...
				var_42_1.tempRoomRecvBits = var_42_2(var_42_3, var_42_4, var_3_10006.ChannelAll, var_41_0)
			...
			var_4(var_41_1, var_41_2, var_41_3, var_9)
		end

		return
	end)
	var_34_6:align(#var_34_5)
	var_34_7()
...
function var_0_1.updateAll(arg_46_0)
	...
	PLATFORM_CODE = iter_46_0
	PLATFORM_JP = var_5

	var_1(var_46_0, iter_46_0 == var_5 and #arg_46_0.filteredMessages <= 0)
...
function var_0_1.append(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
	...
	if var_0_1.MaxCount * 2 <= var_47_0 then
		...
		if var_47_0 == var_5.ChannelPublic then
	...
	local var_47_1 = arg_47_0.emptySign

	PLATFORM_CODE = var_1_10007
	PLATFORM_JP = var_1_10008

	var_47_0(var_47_1, var_1_10007 == var_1_10008 and #arg_47_0.filteredMessages <= 0)
...
function var_0_1.appendOthers(arg_48_0, arg_48_1, arg_48_2)
	...
	if var_48_0.id == arg_48_0.player.id then
		...
		setmetatable = var_6
		Clone = var_1_10008
		arg_48_1.player = var_6(var_1_10008(arg_48_0.player), {
	...
	if 0 < var_48_4 then
		...
		var_48_4(var_48_3.tf, true)

		table = var_48_4

		var_48_4.remove(var_48_1, 1)
	else
		cloneTplTo = var_48_4

		local var_48_5 = var_48_4(var_48_2, arg_48_0.content)

		ChatBubble = var_8
		var_48_3 = var_8.New(var_48_5)
	end

	local var_48_6 = var_48_3.tf

	var_7.SetSiblingIndex(var_48_6, arg_48_2)
	...
	local var_48_8 = var_48_3.headTF
	...
	local function var_48_9()
		...
		var_49_3(var_49_2, var_2_10005.OPEN_INFO, var_48_0, var_49_1, arg_48_1.content)
	...
	var_7(var_48_7, var_48_8, var_48_9, var_1_10012)
...
function var_0_1.appendPublic(arg_50_0, arg_50_1, arg_50_2)
	...
	if arg_50_1.id == 4 then
		...
		local var_50_2 = var_1_10005(var_50_1, arg_50_0.content)
...
function var_0_1.appendTopPublic(arg_51_0, arg_51_1)
	...
	local var_51_2 = var_5(arg_51_0.topPublic, "text")

	var_51_1(var_5.GetComponent(var_51_2, "RichText"), arg_51_1)
	...
	local var_51_5 = var_51_4(var_51_3, var_6(var_8))
	...
	ChatConst = var_51_2
	var_51_5.sprite = var_51_0(var_51_6, var_51_2.GetChannelSprite(arg_51_1.type) .. "_1920")
...
function var_0_1.showEnterRommTip(arg_53_0)
	...
	if not var_53_0(var_1_10003(arg_53_0.enterRoomTip)) then
		LeanTween = var_1
		...
		local var_53_2 = var_53_1(var_3(arg_53_0.enterRoomTip), 1, 0, 2)
		local var_53_3 = var_1.setOnUpdate

		System = var_4

		local var_53_4 = var_53_3(var_53_2, var_4.Action_float(function(arg_54_0)
		...
		local var_53_6 = var_53_5(var_53_4, var_4.easeInSine)
		local var_53_7 = var_1.setOnComplete

		System = var_4

		local var_53_8 = var_53_7(var_53_6, var_4.Action(function()
			...
			var_55_1(var_2_10002(arg_53_0.enterRoomTip))
...
function var_0_1.displayEmojiPanel(arg_57_0)
	...
	NotificationMediator = var_1_10005

	local var_57_3 = var_1_10005.OPEN_EMOJI
	...
	local function var_57_4(arg_58_0)
		...
		local var_58_2 = var_2_10004.ON_SEND_PUBLIC
		local var_58_3 = var_0_1.ChannelBits.send

		string = var_2_10006

		local var_58_4 = var_2_10006.gsub

		ChatConst = var_2_10008

		var_58_1(var_58_0, var_58_2, var_58_3, var_58_4(var_2_10008.EmojiCode, "code", arg_58_0))
	...
	var_57_2(var_57_1, var_57_3, var_57_4, var_1_10007(var_57_0.x, var_57_0.y, 0))
...
function var_0_1.willExit(arg_59_0)
	...
	var_59_0(var_3(arg_59_0.enterRoomTip))
...
function var_0_1.insertEmojiToInputText(arg_60_0, arg_60_1)
	...
	ChatConst = var_1_10006
	var_60_0.text = var_60_1 .. var_60_2(var_1_10006.EmojiIconCode, "code", arg_60_1)
