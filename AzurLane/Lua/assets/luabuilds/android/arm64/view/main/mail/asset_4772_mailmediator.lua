...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_REQUIRE, function(arg_2_0, arg_2_1, arg_2_2)
		if arg_2_1 == "collection" then
			...
			var_2_10003(var_2_0, var_2_10006.GET_COLLECTION_MAIL_LIST, {
				callback = arg_2_2
			})
		else
			type = var_2_10003
			...
			if var_2_10003(arg_2_1) == "number" then
				...
				var_2_2(var_2_1, var_2_10006.GET_MAIL_LIST_TO_INDEX, {
					index = arg_2_1,
					callback = arg_2_2
				})
			else
				...
				var_2_4(var_2_3, var_2_10006.GET_MAIL_LIST, {
					cmd = arg_2_1,
					callback = arg_2_2
				})
			end
	...
	arg_1_0:bind(var_0_1.ON_OPERATION, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.DEAL_MAIL_OPERATION, arg_3_1)
	...
	arg_1_0:bind(var_0_1.ON_DELETE_COLLECTION, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10005.DELETE_COLLECTION_MAIL, arg_4_1)
	...
	arg_1_0:bind(var_0_1.ON_WITHDRAWAL, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10005.GET_STORE_RES, arg_5_1)
	...
	arg_1_0:bind(var_0_1.ON_EXTEND_STORE, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10005.EXTEND_STORE_CAPACITY, {
			isDiamond = arg_6_1
		})
	...
	arg_1_0:bind(var_0_1.ON_GET_MAIL_TITLE, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_7_1(var_7_0, var_2_10006.GET_MAIL_TITLE_LIST, {
			mailList = arg_7_1,
			callback = arg_7_2
		})
...
function var_0_1.initNotificationHandleDic(arg_8_0)
	...
	var_8_0[var_2.DELETE_COLLECTION_MAIL_DONE] = function(arg_10_0, arg_10_1)
		...
		var_10_3(var_10_2, var_6("main_mailMediator_mailDelete"))
	...
	var_8_0[var_2.GET_STORE_RES_DONE] = function(arg_11_0, arg_11_1)
		...
		var_11_3(var_11_2, var_2_10006("mail_storeroom_taken_1"))
	...
	var_8_0[var_2.EXTEND_STORE_CAPACITY_DONE] = function(arg_12_0, arg_12_1)
		...
		var_12_3(var_12_2, var_2_10006("mail_storeroom_extend_1"))
...
function var_0_1.ShowAndCheckDrops(arg_15_0, arg_15_1)
	...
	if 0 < var_15_1 then
		...
		var_15_1.insert(var_15_0, function(arg_16_0)
			local var_16_0 = arg_15_0.viewComponent
			local var_16_1 = var_1.emit

			BaseUI = var_2_10004

			var_16_1(var_16_0, var_2_10004.ON_ACHIEVE, arg_15_1, arg_16_0)
	...
	if var_15_1.detect(arg_15_1, function(arg_17_0)
		...
		if var_17_0 == var_2_10002 then
			local var_17_1 = arg_17_0:getConfig("type")

			Item = var_2_10002

			if var_17_1 == var_2_10002.SKIN_ASSIGNED_TYPE then
				Item = var_17_1
				var_17_2 = var_17_1.InTimeLimitSkinAssigned(arg_17_0.id)
		...
		var_4.insert(var_15_0, function(arg_18_0)
			...
			var_18_2.content = var_2_10005(var_18_3, var_8.getName(var_18_4))
	...
	var_4(var_15_0, function()
		...
		local var_19_1 = var_2_10001(var_2_10003)
		...
		if var_19_0 then
			...
			MSGBOX_TYPE_HELP = iter_19_1
			var_19_5.type = iter_19_1
			i18n = iter_19_1
			var_19_5.helps = iter_19_1("help_research_package")
