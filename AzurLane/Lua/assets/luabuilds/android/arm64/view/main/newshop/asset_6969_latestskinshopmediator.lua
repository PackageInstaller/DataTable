...
function var_0_1.initNotificationHandleDic(arg_19_0)
			...
			if var_22_1 ~= var_2_10005.SkinShop then
				...
				if var_22_2 == var_5.SkinShopTimeLimit then
					...
					if var_22_4 == var_2_10006.SKIN_TYPE_TB then
						...
						var_22_4 = arg_22_0.addSubLayers
						Context = var_2_10008
						...
						var_22_6.mediator = var_2_10011
						NewSkinTBLayer = var_2_10011
						var_22_6.viewComponent = var_2_10011
						var_2_10011 = {
							skinId = var_3.effect_args[1]
						}

						local var_22_7 = var_3.genre

						ShopArgs = var_2_10013
						var_2_10011.timeLimit = var_22_7 == var_2_10013.SkinShopTimeLimit
						var_22_6.data = var_2_10011

						var_22_4(var_22_5, var_2_10008(var_22_6))
					else
						PaintingShowScene = var_22_4

						if var_22_4.GetSkinShowAble(var_22_3) then
							local var_22_8 = arg_22_0
							local var_22_9 = arg_22_0.addSubLayers
							...
							PaintingShowMediator = var_2_10011
							var_22_10.mediator = var_2_10011
							PaintingShowNewSkinScene = var_2_10011
							var_22_10.viewComponent = var_2_10011
							var_2_10011 = {
								is_shop = true,
								skinId = var_22_3
							}

							local var_22_11 = var_3.genre

							ShopArgs = var_2_10013
							var_2_10011.timeLimit = var_22_11 == var_2_10013.SkinShopTimeLimit
							var_22_10.data = var_2_10011

							var_22_9(var_22_8, var_2_10008(var_22_10))
						else
							local var_22_12 = arg_22_0
							local var_22_13 = arg_22_0.addSubLayers

							Context = var_2_10008

							local var_22_14 = var_2_10008.New
							local var_22_15 = {}

							NewSkinMediator = var_2_10011
							var_22_15.mediator = var_2_10011
							NewSkinLayer = var_2_10011
							var_22_15.viewComponent = var_2_10011

							local var_22_16 = {
								skinId = var_3.effect_args[1]
							}
							local var_22_17 = var_3.genre

							ShopArgs = var_2_10013
							var_22_16.timeLimit = var_22_17 == var_2_10013.SkinShopTimeLimit
							var_22_15.data = var_22_16

							var_22_13(var_22_12, var_22_14(var_22_15))
						end
					end

					local var_22_18 = arg_22_0.viewComponent

					var_5.OnShopping(var_22_18, var_22_0.id)

					pg = var_5

					local var_22_19 = var_5.EasyRedDotMgr.GetInstance()

					var_5.TriggerMarks(var_22_19, "specialShop")
				end
	...
	GAME = var_19_1
	var_19_0[var_19_1.BUY_FURNITURE_DONE] = function(arg_23_0, arg_23_1)
		local var_23_0 = arg_23_1:getType()
		local var_23_1 = arg_23_0.viewComponent

		var_3.OnFurnitureUpdate(var_23_1, var_23_0[1])

		return
	end
	NewShopMainMediator = var_2
	var_19_0[var_2.NOTI_UPDATE_CURRENT] = function(arg_24_0, arg_24_1)
		local var_24_0 = arg_24_0.viewComponent

		var_2.GetAllCommodities(var_24_0)

		local var_24_1 = arg_24_0.viewComponent

		var_2.Refresh(var_24_1, true)

		return
	end
	GAME = var_2
	var_19_0[var_2.CHARGE_OPERATION_DONE] = function(arg_25_0, arg_25_1)
		local var_25_0 = arg_25_0.viewComponent

		var_2.closeView(var_25_0)
