...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.tipText = var_1_6(var_1_5, var_5(var_1_10007))
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.resIcon = var_1_10(var_1_9, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.resCount = var_1_13(var_1_12, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.price = var_1_16(var_1_15, var_5(var_1_10007))
	...
	var_1_41(var_1_42, var_5.Find(var_1_43, "real_tpl/tag/hot"))
	...
	var_1_44(var_1_45, var_5.Find(var_1_46, "real_tpl/tag/new"))
	...
	var_1_47(var_1_48, var_5.Find(var_1_49, "real_tpl/tag/advice"))
	...
	var_1_50(var_1_51, var_5.Find(var_1_52, "real_tpl/tag/double"))
	...
	var_1_53(var_1_54, var_5.Find(var_1_55, "real_tpl/tag/activity"))
	...
	var_1_56(var_1_57, var_5.Find(var_1_58, "real_tpl/tag/time"))
	...
	var_1_59(var_1_60, var_5.Find(var_1_61, "real_tpl/tag/discount"))
...
function var_0_0.update(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	var_1_10005(arg_2_0.desc, true)

	setText = var_1_10005

	var_1_10005(arg_2_0.desc, "")
	...
	var_1_10005(arg_2_0.focusTip, arg_2_1:isTip())

	setActive = var_1_10005

	var_1_10005(arg_2_0.icon, arg_2_1:isChargeType())

	setActive = var_1_10005

	var_1_10005(arg_2_0.contain, true)

	setActive = var_1_10005

	var_1_10005(arg_2_0.countDown, false)
	...
	if arg_2_0.packageTag then
		local var_2_8 = arg_2_1:GetPackageTag()

		setActive = var_2_0

		var_2_0(arg_2_0.packageTag, var_2_8 ~= "")

		setText = var_2_0

		local var_2_9 = arg_2_0.packageTag

		var_2_0(var_8.Find(var_2_9, "Text"), var_2_8)
	end
...
function var_0_0.updateCharge(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if not var_3_0.contains(arg_3_3, arg_3_1.id) then
		::label_3_0::

		var_3_1 = arg_3_1
		var_3_2 = arg_3_1.firstPayDouble(var_3_1)
	end

	local var_3_3 = var_3_2 and 4 or arg_3_1:getConfig("tag")

	setActive = var_3_1

	var_3_1(arg_3_0.timeLeftTag, false)

	setActive = var_3_1

	var_3_1(arg_3_0.tag, var_3_3 > 0)
	...
	if 0 < var_3_3 then
		...
		for iter_3_0, iter_3_1 in var_7(arg_3_0.tags) do
			...
			var_1_10012(iter_3_1, iter_3_0 == var_3_3)
		end
	end
	...
	local var_3_5, var_3_6 = arg_3_1.inTime(var_3_4)
	local var_3_8

	if var_3_5 and not arg_3_1:isFree() and var_3_6 and 0 < var_3_6 then
		pg = var_3_4

		local var_3_7 = var_3_4.TimeMgr.GetInstance()
		local var_3_9

		var_3_4, var_3_8, var_3_9 = var_3_4.parseTimeFrom(var_3_7, var_3_6)
		...
		if 0 < var_3_4 then
			...
			var_12(arg_3_0.numLeftText, var_3_4)
		elseif 0 < var_3_8 then
			setActive = var_12
			...
			var_12(arg_3_0.numLeftText, var_3_8)
		elseif 0 < var_3_9 then
			setActive = var_12
			...
			var_12(arg_3_0.numLeftText, var_3_9)
		else
			setActive = var_12
		...
		if var_3_12 <= var_3_6 then
			var_3_13 = var_3_6 % var_3_12
		elseif var_3_11 <= var_3_6 then
			var_3_13 = var_3_6 % var_3_11
		elseif var_3_10 <= var_3_6 then
			var_3_13 = var_3_6 % var_3_10
		end

		if var_3_13 and var_3_13 > 0 then
			if arg_3_0.countDownTimer then
				local var_3_14 = arg_3_0.countDownTimer

				var_16.Stop(var_3_14)

				arg_3_0.countDownTimer = nil
			end

			Timer = var_16
			arg_3_0.countDownTimer = var_16.New(function()
			...
			local var_3_15 = arg_3_0.countDownTimer

			var_16.Start(var_3_15)
		end
	end

	setActive = var_3_4

	var_3_4(arg_3_0.resIcon, not arg_3_1:isItemBox())

	setActive = var_3_4

	var_3_4(arg_3_0.resCount, not arg_3_1:isItemBox())

	local var_3_16 = arg_3_1:isGem()

	setActive = var_3_8

	var_3_8(arg_3_0.name, not var_3_16)

	setScrollText = var_3_8

	var_3_8(arg_3_0.name, arg_3_1:getConfig("name_display"))

	setActive = var_3_8

	local var_3_17 = arg_3_0.important
	local var_3_18

	if not arg_3_1:isItemBox() then
		var_3_18 = arg_3_1:isGiftBox()
	end

	var_3_8(var_3_17, var_3_18)

	setActive = var_3_8

	var_3_8(arg_3_0.count, var_3_16 or arg_3_1:isMonthCard())

	local var_3_22

	if arg_3_1:isItemBox() or arg_3_1:isGiftBox() or arg_3_1:isPassItem() then
		local var_3_19 = arg_3_0
		local var_3_20 = arg_3_0.updateImport
		local var_3_21 = arg_3_1:getConfig("display")

		var_3_22 = arg_3_1

		var_3_20(var_3_19, var_3_21, arg_3_1.getConfig(var_3_22, "descrip"))
	end

	local var_3_23 = arg_3_1:getConfig("limit_type")
	local var_3_24 = arg_3_1.buyCount
	local var_3_25 = arg_3_1
	local var_3_26 = arg_3_1.getLimitCount(var_3_25)

	if var_3_23 == 2 then
		setText = var_13

		local var_3_27 = arg_3_0.limitText

		i18n = var_3_22

		var_13(var_3_27, var_3_22("charge_limit_all", var_3_26 - var_3_24, var_3_26))

		setActive = var_13

		local var_3_28 = arg_3_0.mask

		var_3_22 = var_3_26 - var_3_24 <= 0

		var_13(var_3_28, var_3_22)
	elseif var_3_23 == 4 then
		setText = var_13

		local var_3_29 = arg_3_0.limitText

		i18n = var_3_22

		var_13(var_3_29, var_3_22("charge_limit_daily", var_3_26 - var_3_24, var_3_26))

		setActive = var_13

		local var_3_30 = arg_3_0.mask

		var_3_22 = var_3_26 - var_3_24 <= 0

		var_13(var_3_30, var_3_22)
	else
		setText = var_13

		var_13(arg_3_0.limitText, "")
	end
	...
	if arg_3_1:isGem() then
		...
		if var_3_2 then
			local var_3_31 = arg_3_1
			local var_3_32 = arg_3_1.getConfig(var_3_31, "gem")

			var_3_22 = arg_3_1

			local var_3_33 = var_3_32 * arg_3_1.getConfig(var_3_22, "first_pay_double")

			var_3_25 = arg_3_0.tipText
			i18n = var_3_31
			var_3_25.text = var_3_31("charge_double_gem_tip", var_3_33)
		else
			local var_3_34

			if arg_3_1:hasExtraGem() then
				var_3_34 = arg_3_0.tipText
				i18n = var_3_25
				var_3_34.text = var_3_25("charge_extra_gem_tip", arg_3_1:getConfig("extra_gem"))
			else
				setActive = var_3_34

				var_3_34(arg_3_0.tipTF, false)
			end
		end
	elseif arg_3_1:isGiftBox() then
		-- block empty
	elseif arg_3_1:isMonthCard() then
		local var_3_35 = arg_3_2
		local var_3_36 = arg_3_2.getCardById

		VipCard = var_3_22

		if var_3_36(var_3_35, var_3_22.MONTH) and not var_13:isExpire() then
			local var_3_37 = var_13

			var_3_25 = var_13.getLeftDate(var_3_37)
			pg = var_3_35
			var_1_10017 = var_3_35.TimeMgr.GetInstance()

			local var_3_38 = var_15.GetServerTime(var_1_10017)

			math = var_3_37

			local var_3_39 = var_3_37.floor((var_3_25 - var_3_38) / 0)

			if not arg_3_1:getConfig("limit_arg") then
				var_1_10017 = 0
			end

			setActive = var_18

			var_18(arg_3_0.mask, var_1_10017 < var_3_39)

			setText = var_18

			local var_3_40 = arg_3_0.limitText

			i18n = var_21

			var_18(var_3_40, var_21("charge_month_card_lefttime_tip", var_3_39))
		end

		setText = var_3_25

		local var_3_41 = arg_3_0.desc

		string = var_1_10017

		local var_3_42 = var_1_10017.gsub
		local var_3_43 = arg_3_1:getConfig("descrip")
		local var_3_44 = "$1"
		local var_3_45

		if not var_4 or not arg_3_1:getConfig("gem") then
			var_3_45 = arg_3_1:getConfig("extra_gem")
		end

		var_3_25(var_3_41, var_3_42(var_3_43, var_3_44, var_3_45))
	...
	local var_3_46 = arg_3_0.price

	var_3_46.text = arg_3_1:getConfig("money")
	PLATFORM_CODE = var_3_46
	PLATFORM_CHT = var_14

	if var_3_46 == var_14 and arg_3_1:IsLocalPrice() then
		setActive = var_13

		var_13(arg_3_0.rmb, false)
	end

	local var_3_47 = arg_3_0.iconTF

	GetSpriteFromAtlas = var_14
	var_3_47.sprite = var_14("chargeicon/1", "")
	LoadSpriteAsync = var_3_47

	var_3_47("chargeicon/" .. arg_3_1:getConfig("picture"), function(arg_5_0)
		if arg_5_0 then
			IsNil = var_2_10001
	...
	setButtonEnabled = var_3_47

	local var_3_48 = arg_3_0.tr

	isActive = var_16

	var_3_47(var_3_48, not var_16(arg_3_0.mask))
...
function var_0_0.UpdateShipIcon(arg_6_0, arg_6_1)
	...
	local var_6_4 = arg_6_1:getConfigTable().usage_arg[1][1]
	...
	local var_6_5 = var_6_1.shop_template[var_6_4].effect_args[1]
	...
	local var_6_6 = var_6.ship_skin_template[var_6_5]

	LoadSpriteAsync = var_1_10007

	var_1_10007("qicon/" .. var_6_6.prefab, function(arg_7_0)
		if arg_7_0 then
			IsNil = var_2_10001
...
function var_0_0.updateGemItem(arg_8_0, arg_8_1, arg_8_2)
	...
	if 0 < var_8_0 then
		...
		var_5(var_8_2, var_1_10008("charge_limit_all", var_8_0 - var_8_1, var_8_0))
	...
	if arg_8_1.getConfig(var_8_3, "group_limit") > 0 then
		local var_8_4

		if not arg_8_1:getConfig("group_type") then
			var_8_4 = 0
		end
		...
		if var_8_4 == 1 then
			...
			var_8_3(var_8_5, var_1_10010("charge_limit_daily", var_5 - arg_8_1.groupCount, var_5))
		elseif var_8_4 == 2 then
			...
			var_8_3(var_8_6, var_1_10010("charge_limit_weekly", var_5 - arg_8_1.groupCount, var_5))
		elseif var_8_4 == 3 then
			...
			var_8_3(var_8_7, var_1_10010("charge_limit_monthly", var_5 - arg_8_1.groupCount, var_5))
		end
	end
	...
	local var_8_9 = arg_8_1:getConfig("tag")

	setActive = var_7

	var_7(arg_8_0.tag, var_8_9 > 0)
	...
	if 0 < var_8_9 then
		...
		for iter_8_0, iter_8_1 in var_7(arg_8_0.tags) do
			...
			var_1_10012(iter_8_1, iter_8_0 == var_8_9)
		end
	end
	...
	local var_8_11, var_8_12 = arg_8_1.inTime(var_8_10)

	if var_8_11 and not arg_8_1:isFree() and var_8_12 and 0 < var_8_12 then
		pg = var_8_10

		local var_8_13 = var_8_10.TimeMgr.GetInstance()
		local var_8_14, var_8_15

		var_8_10, var_8_14, var_8_15 = var_8_10.parseTimeFrom(var_8_13, var_8_12)

		if 0 < var_8_10 then
			setActive = var_12

			var_12(arg_8_0.timeLeftTag, true)

			setActive = var_12

			var_12(arg_8_0.dayLeftTag, true)

			setActive = var_12

			var_12(arg_8_0.hourLeftTag, false)

			setActive = var_12

			var_12(arg_8_0.minLeftTag, false)

			setText = var_12

			var_12(arg_8_0.numLeftText, var_8_10)
		elseif 0 < var_8_14 then
			setActive = var_12
			...
			var_12(arg_8_0.dayLeftTag, false)

			setActive = var_12

			var_12(arg_8_0.hourLeftTag, true)
			...
			var_12(arg_8_0.numLeftText, var_8_14)
		elseif 0 < var_8_15 then
			...
			var_12(arg_8_0.minLeftTag, true)

			setText = var_12

			var_12(arg_8_0.numLeftText, var_8_15)
		else
			setActive = var_12
		...
		if var_8_17 <= var_8_12 then
			var_8_18 = var_8_12 % var_8_17
		elseif var_1_10013 <= var_8_12 then
			var_8_18 = var_8_12 % var_1_10013
		elseif var_8_16 <= var_8_12 then
			var_8_18 = var_8_12 % var_8_16
		end

		if var_8_18 and var_8_18 > 0 then
			if arg_8_0.countDownTimer then
				local var_8_19 = arg_8_0.countDownTimer

				var_16.Stop(var_8_19)
			...
			var_16.Start(var_8_20)
		end
	end

	setActive = var_8_10

	var_8_10(arg_8_0.name, true)

	local var_8_21 = #arg_8_1:getConfig("effect_args")

	if 0 < var_8_21 then
		Item = var_8_21

		if var_8_21.getConfigData(var_9[1]) then
			setScrollText = var_11

			var_11(arg_8_0.name, var_8_21.name)

			var_1_10013 = arg_8_0

			arg_8_0.updateImport(var_1_10013, var_8_21.display_icon, var_8_21.display)

			var_1_10013 = arg_8_0

			if arg_8_0.CheckSkinDiscounItem(var_1_10013, var_8_21.display_icon) then
		...
		var_8_22.sprite = var_12("chargeicon/1", "")
		LoadSpriteAsync = var_8_22

		var_8_22(var_8_21.icon, function(arg_10_0)
			if arg_10_0 then
				IsNil = var_2_10001
	...
	setButtonEnabled = var_8_21

	local var_8_23 = arg_8_0.tr

	isActive = var_1_10013

	var_8_21(var_8_23, not var_1_10013(arg_8_0.mask))
...
function var_0_0.CheckSkinDiscounItem(arg_11_0, arg_11_1)
	...
	for iter_11_0, iter_11_1 in var_1_10002(arg_11_1) do
		...
		if var_1_10007.getConfigTable(var_11_0).usage then
			...
			if var_11_1 == var_11_0.USAGE_SHOP_DISCOUNT then
				return var_1_10007
			end
		end
	end
...
local function var_0_1(arg_12_0)
	...
	if arg_12_0.getConfigTable(var_12_0).usage then
		local var_12_1 = var_1.usage

		ItemUsage = var_12_0

		if var_12_1 == var_12_0.USAGE_SKIN_EXP then
			return false
		end
	end
...
function var_0_0.updateImport(arg_13_0, arg_13_1, arg_13_2)
	...
	for iter_13_0, iter_13_1 in var_1_10004(arg_13_1) do
		...
		var_1_10009(var_13_1, var_1_10012.Create(iter_13_1))
	end
	...
	var_4(var_13_4, iter_13_2.gsub(arg_13_2, "$1", #var_13_0))
...
function var_0_0.updateCountdown(arg_14_0, arg_14_1)
	...
	if arg_14_1 then
		...
		local var_14_3 = var_1_10003:GetServerTime()

		pg = var_1_10008

		local var_14_4 = var_1_10008.TimeMgr.GetInstance()

		var_14_0 = var_14_2(var_14_1, var_14_3, var_8.Table2ServerTime(var_14_4, arg_14_1)) < 365
	end
	...
	local var_14_5 = var_1_10003.TimeMgr.GetInstance()
	...
	local var_14_6 = var_14_5:Table2ServerTime(arg_14_1)

	Timer = var_6
	arg_14_0.updateTimer = var_6.New(function()
		local var_16_0 = var_14_5

		if var_0.GetServerTime(var_16_0) > var_14_6 then
			var_0()
		end

		local var_16_1 = var_14_6 - var_0 < 0 and 0 or var_16_1
		...
		if 0 < var_16_2 then
			...
			local var_16_4 = var_2_10006("skin_remain_time")

			var_2_10007 = var_16_2
			i18n = var_2_10008

			var_3(var_16_3, var_16_4 .. var_2_10007 .. var_2_10008("word_date"))
		else
			math = var_3
			...
			if 0 < var_16_5 then
				...
				local var_16_7 = var_2_10007("skin_remain_time")

				var_2_10008 = var_16_5
				i18n = var_9

				var_4(var_16_6, var_16_7 .. var_2_10008 .. var_9("word_hour"))
			else
				math = var_4
				...
				if 0 < var_16_8 then
					...
					i18n = var_2_10008
					var_2_10008 = var_2_10008("skin_remain_time")

					local var_16_10 = var_16_8

					i18n = var_10

					var_5(var_16_9, var_2_10008 .. var_16_10 .. var_10("word_minute"))
				else
					setText = var_5
					...
					local var_16_12 = var_2_10008("skin_remain_time")
					local var_16_13 = var_16_1

					i18n = var_10

					var_5(var_16_11, var_16_12 .. var_16_13 .. var_10("word_second"))
				end
			end
		end
	...
	local var_14_7 = arg_14_0.updateTimer

	var_6.Start(var_14_7)
