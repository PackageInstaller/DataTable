...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".NewSkinAtlasLayer"))
...
function var_0_1.init(arg_1_0)
	...
	local var_1_1 = var_3.Find(var_1_0, "adapt/top/title/Text")

	i18n = var_1_10004

	var_1(var_1_1, var_1_10004("shop_new_able_to_exchange"))

	setText = var_1

	local var_1_2 = arg_1_0._tf
	local var_1_3 = var_3.Find(var_1_2, "adapt/top/have/Text")

	i18n = var_4

	var_1(var_1_3, var_4("shop_new_able_to_exchange"))
...
function var_0_1.Check(arg_4_0, arg_4_1)
	...
	local var_4_2 = var_4_0.getConfigData(var_4_1).name
	...
	i18n = var_1_10010
	var_4_6.content = var_1_10010("skin_exchange_confirm", var_4_2, arg_4_1.skinName)
...
function var_0_1.OnUpdateItem(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_0.goDic[arg_7_2] and arg_7_0.goDic[arg_7_2] ~= arg_7_1 then
		...
		local var_7_3 = arg_7_0.GetDisplayIndex(var_7_2, var_7_1)

		arg_7_0:ReturnIndex(arg_7_0.goDic[arg_7_2])

		if var_7_3 ~= arg_7_0:GetDisplayIndex(var_7_1) then
			local var_7_4 = {}

			table = var_7_2

			var_7_2.insert(var_7_4, var_7_3)
	...
	if var_7_0 then
		...
		local var_7_11 = var_9.Find(var_7_10, "skins")

		tf = var_10

		local var_7_12 = var_10(arg_7_2)
		local var_7_13 = var_7_9(var_7_11, var_10.Find(var_7_12, "skins/SkinAtlasCard"))
		...
		var_7.make(var_7_13, function(arg_8_0, arg_8_1, arg_8_2)
			...
			if arg_8_0 == var_2_10003.EventUpdate then
				...
				var_2_10005.insert(arg_7_0.cards, var_8_1)
				...
				var_5(var_8_2, var_8_3, var_8_4, var_10)
