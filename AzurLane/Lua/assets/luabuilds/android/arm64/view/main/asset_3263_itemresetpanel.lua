...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_2 = var_6.Find(var_1_1, "bg")
	...
	var_3(var_1_0, var_1_2, var_1_3, var_1_1)
	...
	var_3(var_1_5, var_1_6, var_1_7, var_1_1)
	...
	local var_1_12 = var_5.Find(var_1_11, "view/content")
	local var_1_13 = arg_1_0.fromListPanel

	arg_1_0.fromItemList = var_1_10(var_1_12, var_6.Find(var_1_13, "view/content/item"))
	...
	var_3.make(var_1_14, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			if var_4_0 then
				...
				local var_4_1 = arg_4_2:Find("from/Text")

				pg = var_7

				var_2_10004(var_4_1, var_7.world_item_data_origin[var_4_0].origin_text)
			end
		end
...
function var_0_0.Update(arg_7_0, arg_7_1)
	...
	local var_7_3 = var_6.Find(var_7_2, "top_text")

	i18n = var_7

	var_4(var_7_3, var_7("world_item_recycle_" .. (var_7_1 and 1 or 2)))

	setText = var_4

	local var_7_4 = arg_7_0.infoPanel
	local var_7_5 = var_6.Find(var_7_4, "bottom_text")

	i18n = var_7

	var_4(var_7_5, var_7("world_item_origin"))

	updateDrop = var_4

	local var_7_6 = arg_7_0.infoPanel

	var_4(var_6.Find(var_7_6, "before"), var_7_0)

	updateDrop = var_4

	local var_7_7 = arg_7_0.infoPanel
	local var_7_8 = var_6.Find(var_7_7, "after")

	defaultValue = var_7

	var_4(var_7_8, var_7(var_7_1, var_7_0))

	setActive = var_4

	local var_7_9 = arg_7_0.infoPanel

	var_4(var_6.Find(var_7_9, "after/destroy_mask"), not var_7_1)
	...
	var_7_11(var_7_10, var_7.max(#arg_7_0.infoList, 3))
