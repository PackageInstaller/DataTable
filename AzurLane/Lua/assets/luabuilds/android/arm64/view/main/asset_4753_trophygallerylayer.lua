...
function var_0_1.init(arg_4_0)
	...
	arg_4_0._trophyDetailPanel = var_4_9(var_3.Find(var_4_10, "trophyPanel"), arg_4_0._tf)
...
function var_0_1.ensureTrophyViewCache(arg_9_0, arg_9_1)
	...
	local var_9_1 = var_1_10004(arg_9_0._trophyLowerTpl, arg_9_0._trophyContainer)
	...
	local function var_9_4()
		...
		if var_10_1:canClaimed() and not var_10_1:isClaimed() then
			if not var_2:IsPlaying() then
				...
				TrophyGalleryMediator = var_2_10006

				var_10_3(var_10_2, var_2_10006.ON_TROPHY_CLAIM, var_10_1.id)
			end
	...
	var_8(var_9_5, var_11.Find(var_9_6, "frame"), var_9_4)
	...
	var_8(var_9_7, var_11.Find(var_9_8, "frame"), var_9_4)
...
function var_0_1.updateTrophyReminderMaterial(arg_12_0, arg_12_1)
	...
	if var_5(var_12_1) then
		...
		var_5.LoadBundle(var_12_2, var_12_1, function(arg_13_0)
			...
			typeof = var_2_10005
			Material = var_2_10007

			local var_13_3 = var_13_1(var_13_0, var_13_2, var_2_10005(var_2_10007), false, false)
...
function var_0_1.didEnter(arg_14_0)
	...
	local function var_14_8()
		...
		pg = var_2_10004
		var_17_2.helps = var_2_10004.gametip.medal_help_tip.tip
	...
	for iter_14_0, iter_14_1 in var_1(arg_14_0._pageToggle) do
		...
		var_1_10006(var_14_12, var_14_13, var_14_14, var_1_10011)
	end
	...
	var_14_16(var_14_15, var_4.Find(var_14_17, "tip"), {
	...
	var_14_19(var_14_18, var_4.Find(var_14_20, "info/icon/tip"), {
		"love_letter_level_up",
		"love_letter_level_reward"
	}, function(arg_21_0)
		...
		LoveLetterProxy = var_2_10006

		local var_21_1 = var_2_10004(var_2_10006)

		var_2_10001(var_21_0, var_4.IsTipAllLevelReward(var_21_1))
...
function var_0_1.updatePage(arg_22_0, arg_22_1)
	...
	var_3(var_5.Find(var_22_1, "filter"), not var_22_0)
...
function var_0_1.updateTrophyList(arg_23_0)
	...
	for iter_23_2, iter_23_3 in iter_23_0(arg_23_0.trophyGroups) do
		if arg_23_0:checkTrophyVisible(iter_23_3, var_23_1, var_23_0) then
			local var_23_3 = arg_23_0:ensureTrophyViewCache(iter_23_2)

			math = var_1_10010
			var_1_10010 = var_1_10010.fmod(var_23_2, 2) == 1

			local var_23_4

			if not var_1_10010 or not var_23_3.upperGO then
				var_23_4 = var_23_3.lowerGO
			end

			local var_23_5

			if not var_1_10010 or not var_23_3.lowerGO then
				var_23_5 = var_23_3.upperGO
			end

			local var_23_6

			if not var_1_10010 or not var_23_3.upperView then
				var_23_6 = var_23_3.lowerView
			end

			setActive = var_14

			var_14(var_23_4, true)

			setActive = var_14

			var_14(var_23_5, false)

			local var_23_7 = var_23_4.transform

			var_14.SetSiblingIndex(var_23_7, var_23_2 - 1)
...
function var_0_1.PlayTrophyClaim(arg_24_0, arg_24_1)
	...
	local var_24_3 = var_1_10004(var_6.Find(var_24_2, "claim_fx"))
...
function var_0_1.onFilter(arg_29_0)
	...
	for iter_29_0 = 1, #var_0_1.Filter do
		...
		var_1_10005(var_7.GetChild(var_29_0, iter_29_0 - 1), iter_29_0 == arg_29_0._filterIndex)
	end
...
function var_0_1.updateLoveLetterPage(arg_30_0)
	...
	if not arg_30_0.contextData.checkRalizeGift then
		...
		var_1_10003 = var_30_0(var_1_10003)

		if var_30_0.IsTipRealizeGift(var_1_10003) then
			var_1_10003 = arg_30_0
			var_30_0 = arg_30_0.emit
			TrophyGalleryMediator = var_1_10004

			var_30_0(var_1_10003, var_1_10004.OPEN_REALIZE_GIFT_LAYER)
		end
	end
	...
	local var_30_1 = var_30_0(var_1_10003)
	...
	local var_30_6 = var_30_5:Find("word")

	i18n = var_1_10006

	var_30_2(var_30_6, var_1_10006("loveactivity_ui_10"))

	local var_30_7 = var_30_3:GetAllLevel()

	setText = var_30_4

	var_30_4(var_30_5:Find("count"), var_30_7)

	local var_30_8 = var_30_3
	local var_30_9, var_30_10 = var_30_3.GetAllLevelProgress(var_30_8)

	if var_30_10 == 0 then
		setSlider = var_30_8

		var_30_8(var_30_5:Find("Slider"), 0, 1, 1)
	else
		setSlider = var_30_8

		var_30_8(var_30_5:Find("Slider"), 0, var_30_10, var_30_9)
	end

	setText = var_30_8

	var_30_8(var_30_5:Find("Slider/Text"), var_30_9 .. "/" .. var_30_10)

	local var_30_11 = var_30_3:GetAllLevelNextAward()

	updateDrop = var_7

	var_7(var_30_5:Find("icon/mask/IconTpl"), var_30_11[1])

	onButton = var_7

	local var_30_12 = arg_30_0
	local var_30_13 = var_30_5
	local var_30_14 = var_30_5.Find(var_30_13, "icon/mask/IconTpl")
	...
	local function var_30_15()
		...
		local var_31_2 = var_2_10003.ON_DROP

		drop = var_2_10004

		var_31_1(var_31_0, var_31_2, var_2_10004[1])
	...
	var_7(var_30_12, var_30_14, var_30_15, var_30_13)

	setActive = var_7

	var_7(var_30_5:Find("icon/got"), var_30_10 == 0)

	onButton = var_7

	local var_30_16 = arg_30_0
	local var_30_17 = var_30_5
	local var_30_18 = var_30_5.Find(var_30_17, "click")
	...
	local function var_30_19()
		...
		local var_32_2 = var_2_10001.NewStyleMsgboxMgr.GetInstance()
		local var_32_3 = var_1.Show

		pg = var_2_10004

		local var_32_4 = var_2_10004.NewStyleMsgboxMgr.TYPE_LOVE_LETTER_LEVEL_REWARD
		local var_32_5 = {}
		...
		if #var_32_1 > 0 then
			...
			pg = var_2_10008
			var_32_7.type = var_2_10008.NewStyleMsgboxMgr.BUTTON_TYPE.cancel
			i18n = var_8
			var_32_7.name = var_8("msgbox_text_cancel")
			SFX_CANCEL = var_8
			var_32_7.sound = var_8
			var_32_6[1] = var_32_7

			local var_32_8 = {}

			pg = var_8
			var_32_8.type = var_8.NewStyleMsgboxMgr.BUTTON_TYPE.confirm
			i18n = var_8
			var_32_8.name = var_8("mail_get_oneclick")

			function var_32_8.func()
				local var_33_0 = arg_30_0
				local var_33_1 = var_0.emit

				TrophyGalleryMediator = var_3_10003

				var_33_1(var_33_0, var_3_10003.ON_GET_ALL_LOVE_LETTER_REWARD, var_32_1)

				return
			end

			SFX_CONFIRM = var_8
			var_32_8.sound = var_8
			var_32_6[2] = var_32_8
	...
	var_7(var_30_16, var_30_18, var_30_19, var_30_17)
...
function var_0_1.onInitCard(arg_34_0, arg_34_1)
	...
	var_1_10003(arg_34_0, var_34_0.go, function()
		if var_34_0.shipGroup then
			local var_35_0 = arg_34_0
			local var_35_1 = var_0.emit

			TrophyGalleryMediator = var_2_10003

			var_35_1(var_35_0, var_2_10003.OPEN_DISPLAY_WINDOW, var_34_0.shipGroup.id)
		end
...
function var_0_1.onUpdateCard(arg_36_0, arg_36_1, arg_36_2)
	...
	var_36_4(var_36_3, var_9.Find(var_36_5, "content/pick_up"), {
		"love_letter_level_up"
	}, function(arg_37_0)
		getProxy = var_2_10001
		LoveLetterProxy = var_2_10003
		...
		var_2_10002(arg_37_0, var_37_1:GetDisplayLevel() < var_37_1:GetMaxLevel() and var_37_1:CanLevelUp())
...
function var_0_1.willExit(arg_40_0)
	...
	var_40_2(var_40_1, var_4.Find(var_40_3, "tip"))
	...
	var_40_5(var_40_4, var_4.Find(var_40_6, "info/icon/tip"))
	...
	for iter_40_0, iter_40_1 in var_40_5(arg_40_0.cardItems) do
		...
		local var_40_7 = var_40_6.EasyRedDotMgr.GetInstance()

		var_40_6 = var_40_6.UnRegisterRedDot

		local var_40_8 = iter_40_0.transform

		var_40_6(var_40_7, var_9.Find(var_40_8, "content/pick_up"))
	end
