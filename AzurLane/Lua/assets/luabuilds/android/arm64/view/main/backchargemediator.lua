...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.CHARGE, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10005.REFUND_CHHARGE, {
			shopId = arg_2_1
		})
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_1 == var_4_0.UPDATED then
		...
		if var_4_1 == var_4.CHARGED_LIST_UPDATED then
			-- block empty
		else
			GAME = var_4

			if var_4_1 == var_4.CHARGE_CONFIRM_FAILED then
				-- block empty
			else
				GAME = var_4
				...
				if var_4_1 == var_4.CHARGE_SUCCESS then
					local var_4_3 = arg_4_0

					var_4_4 = arg_4_0.sendNotification
					GAME = var_1_10007

					var_4_4(var_4_3, var_1_10007.GET_REFUND_INFO)
				else
					GAME = var_4_4

					if var_4_1 == var_4_4.REFUND_INFO_UPDATE then
