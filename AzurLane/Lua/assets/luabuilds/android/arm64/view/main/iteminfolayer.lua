...
function var_0_1.init(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "top/bg/infomation/title")

	i18n = var_4

	var_1(var_2_2, var_4("words_information"))
	...
	i18n = var_2_1
	var_2_5[2] = var_2_1("msgbox_text_confirm")
	...
	i18n = var_5
	var_2_6[2] = var_5("msgbox_text_analyse")
	...
	i18n = var_5
	var_2_7[2] = var_5("loveletter_exchange_button")
	...
	i18n = var_5
	var_2_8[2] = var_5("msgbox_text_use")
	...
	i18n = var_5
	var_2_9[2] = var_5("recycle_btn_label")
	...
	i18n = var_5
	var_2_10[2] = var_5("go_skinshop_btn_label")
	...
	i18n = var_5
	var_2_11[2] = var_5("go_skinexperienceshop_btn_label")
	var_2_4.skinExperienceShopBtn = var_2_11

	for iter_2_0, iter_2_1 in var_1(var_2_4) do
		unpack = var_2_12

		local var_2_12, var_2_13 = var_2_12(iter_2_1)
		local var_2_14 = arg_2_0.btnContent

		arg_2_0[iter_2_0] = var_8.Find(var_2_14, var_2_12)

		if var_2_13 then
			setText = var_8

			local var_2_15 = arg_2_0[iter_2_0]

			var_8(var_10.Find(var_2_15, "pic"), var_2_13)
		end
	end

	local var_2_16 = arg_2_0.window

	arg_2_0.itemTF = var_1.Find(var_2_16, "item")

	local var_2_17 = arg_2_0._tf

	arg_2_0.operatePanel = var_1.Find(var_2_17, "operate")

	local var_2_18 = arg_2_0.operatePanel
	local var_2_19 = var_1.Find(var_2_18, "item/left/own/Text")
	local var_2_20 = var_1.GetComponent

	typeof = var_4
	Text = var_2_12
	arg_2_0.countTF = var_2_20(var_2_19, var_4(var_2_12))

	local var_2_21 = arg_2_0.operatePanel

	arg_2_0.keepFateTog = var_1.Find(var_2_21, "got/keep_tog")
	setText = var_1

	local var_2_22 = arg_2_0.keepFateTog
	local var_2_23 = var_3.Find(var_2_22, "label")

	i18n = var_4

	var_1(var_2_23, var_4("keep_fate_tip"))

	arg_2_0.operateBtns = {}

	local var_2_24 = arg_2_0.operateBtns
	local var_2_25 = arg_2_0.operatePanel

	var_2_24.Confirm = var_2.Find(var_2_25, "actions/confirm_button")

	local var_2_26 = arg_2_0.operateBtns
	local var_2_27 = arg_2_0.operatePanel

	var_2_26.Cancel = var_2.Find(var_2_27, "actions/cancel_button")

	local var_2_28 = arg_2_0.operateBtns
	local var_2_29 = arg_2_0.operatePanel

	var_2_28.Resolve = var_2.Find(var_2_29, "actions/resolve_button")
	setText = var_2_28

	local var_2_30 = arg_2_0.operateBtns.Confirm
	local var_2_31 = var_3.Find(var_2_30, "label")

	i18n = var_2_29

	var_2_28(var_2_31, var_2_29("msgbox_text_confirm"))

	setText = var_2_28

	local var_2_32 = arg_2_0.operateBtns.Cancel
	local var_2_33 = var_3.Find(var_2_32, "label")

	i18n = var_4

	var_2_28(var_2_33, var_4("msgbox_text_cancel"))

	setText = var_2_28

	local var_2_34 = arg_2_0.operateBtns.Resolve
	local var_2_35 = var_3.Find(var_2_34, "label")

	i18n = var_4

	var_2_28(var_2_35, var_4("msgbox_text_analyse"))

	SetActive = var_2_28

	var_2_28(arg_2_0.operatePanel, false)

	SetActive = var_2_28

	var_2_28(arg_2_0.window, true)

	arg_2_0.operateMode = nil

	local var_2_36 = arg_2_0.operatePanel

	arg_2_0.operateBonusList = var_1.Find(var_2_36, "got/panel_bg/list")

	local var_2_37 = arg_2_0.operatePanel

	arg_2_0.operateBonusTpl = var_1.Find(var_2_37, "got/panel_bg/list/item")

	local var_2_38 = arg_2_0.operatePanel

	arg_2_0.operateCountdesc = var_1.Find(var_2_38, "count/image_text")

	local var_2_39 = arg_2_0.operatePanel

	arg_2_0.operateValue = var_1.Find(var_2_39, "count/number_panel/value")

	local var_2_40 = arg_2_0.operatePanel

	arg_2_0.operateValueInput = var_1.Find(var_2_40, "count/number_panel/InputField")

	local var_2_41 = arg_2_0.operatePanel

	arg_2_0.operateLeftButton = var_1.Find(var_2_41, "count/number_panel/left")

	local var_2_42 = arg_2_0.operatePanel

	arg_2_0.operateRightButton = var_1.Find(var_2_42, "count/number_panel/right")

	local var_2_43 = arg_2_0.operatePanel

	arg_2_0.operateMaxButton = var_1.Find(var_2_43, "count/max")
	ItemRecycleConfirmationPage = var_1

	local var_2_44 = var_1.New

	pg = var_2_43
	arg_2_0.recycleConfirmationPage = var_2_44(var_2_43.UIMgr.GetInstance().OverlayMain)

	local var_2_45 = arg_2_0.recycleConfirmationPage

	var_1.SetCallback(var_2_45, function()
...
function var_0_1.setDrop(arg_7_0, arg_7_1)
	...
	if var_7_0 == var_1_10003 then
		...
		arg_7_0.setItemInfo(var_1_10004, arg_7_1, arg_7_0.itemTF)
	else
		...
		if var_7_1 == var_1_10003 then
			...
			local var_7_2 = var_7_1(var_1_10004)
...
function var_0_1.setItemInfo(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_0 = arg_8_2:Find("left/IconTpl")

	setmetatable = var_1_10006

	var_1_10003(var_8_0, var_1_10006({
		count = 0
	}, {
		__index = arg_8_1
	}))
	...
	local var_8_2 = arg_8_2.Find(var_8_1, "display_panel/name_container/shiptype")

	setActive = var_1_10004

	local var_8_3 = var_8_2
	local var_8_4 = arg_8_1.type

	DROP_TYPE_SHIP = var_8

	var_1_10004(var_8_3, var_8_4 == var_8)

	local var_8_5 = arg_8_1.type

	DROP_TYPE_SHIP = var_8_1

	if var_8_5 == var_8_1 then
		GetImageSpriteFromAtlasAsync = var_8_5

		local var_8_6 = "shiptype"

		shipType2print = var_7

		var_8_5(var_8_6, var_7(arg_8_1:getConfig("type")), var_8_2, false)
	end
...
function var_0_1.setItem(arg_10_0, arg_10_1)
	...
	if var_2.getConfig(var_10_0, "compose_number") > 0 and var_2 <= arg_10_0.itemVO.count then
		...
		var_1_10009 = arg_10_0.operatePanel

		var_10_2(var_10_1, var_10_3, var_7.Find(var_1_10009, "item"))
	...
	local var_10_4 = arg_10_0.itemVO
	local var_10_5 = var_3.getConfig(var_10_4, "usage")

	ItemUsage = var_10_0

	if var_10_5 == var_10_0.SOS then
		setText = var_10_5

		local var_10_6 = arg_10_0.useBtn

		var_10_5(var_5.Find(var_10_6, "text"), 1)

		setActive = var_10_5

		var_10_5(arg_10_0.useBtn, true)
	end

	local var_10_7 = arg_10_0.itemVO
	local var_10_8 = var_3.getConfig(var_10_7, "type")
	local var_10_9 = arg_10_0.itemVO

	if var_4.IsRepairLoveLetterItem(var_10_9) then
		onButton = var_4

		local var_10_10 = arg_10_0
		local var_10_11 = arg_10_0.loveRepairBtn
		...
		local function var_10_12()
			...
			i18n = var_2_10004
			var_11_2.content = var_2_10004("loveletter2018_ui_1")

			function var_11_2.onYes()
				local var_12_0 = arg_10_0
				local var_12_1 = var_0.emit

				ItemInfoMediator = var_3_10003

				var_12_1(var_12_0, var_3_10003.REPAIR_LOVE_LETTER_ITEM, arg_10_0.itemVO)
		...
		var_4(var_10_10, var_10_11, var_10_12, var_1_10009)
		...
		if var_4.IsLoveLetterCheckItem(arg_10_0.itemVO.id) then
			...
			if not arg_10_0.itemVO.extra then
				pg = var_10_13
				var_10_13 = var_10_13.loveletter_2018_2021[arg_10_0.itemVO.id].ship_group_id
			end

			local var_10_14 = arg_10_0

			var_10_7 = arg_10_0.getButton(var_10_14, "checkMail", arg_10_0.blueBtn)
			setText = var_6

			local var_10_15 = var_10_7:Find("pic")

			i18n = var_1_10009

			var_6(var_10_15, var_1_10009("loveletter_recover_bottom1"))

			onButton = var_6

			local var_10_16 = arg_10_0

			var_1_10009 = var_10_7

			local function var_10_17()
				local var_13_0 = arg_10_0
				local var_13_1 = var_0.emit

				ItemInfoMediator = var_2_10003

				var_13_1(var_13_0, var_2_10003.CHECK_LOVE_LETTER_MAIL, arg_10_0.itemVO.id, var_10_13)
			...
			var_6(var_10_16, var_1_10009, var_10_17, var_11)

			local var_10_18 = arg_10_0
			local var_10_19 = arg_10_0.getButton(var_10_18, "repairMail", arg_10_0.yellowBtn)

			setText = var_10_14
			var_1_10009 = var_10_19:Find("pic")
			i18n = var_10

			var_10_14(var_1_10009, var_10("loveletter_recover_bottom2"))

			getProxy = var_10_14
			BagProxy = var_1_10009
			var_1_10009 = var_10_14(var_1_10009)

			local var_10_20 = var_7.GetLoveLetterRepairInfo(var_1_10009, arg_10_0.itemVO.id .. "_" .. var_10_13)

			onButton = var_10_18

			local var_10_21 = arg_10_0
			local var_10_22 = var_10_19
			...
			local function var_10_23()
				if not var_10_20 then
					...
					var_14_1(var_14_0, var_2_10003("loveletter_recover_tip1"))
				elseif #var_10_20 == 0 then
					pg = var_0
					...
					var_14_3(var_14_2, var_2_10003("loveletter_recover_tip3"))
				else
					local var_14_4

					if #var_10_20 == 1 then
						var_14_4 = var_10_20[1]
						pg = var_2_10001

						local var_14_5 = var_2_10001.MsgboxMgr.GetInstance()
						local var_14_6 = var_1.ShowMsgBox

						var_2_10004 = {
							delayConfirm = 3
						}
						i18n = var_2_10005
						var_2_10007 = "loveletter_recover_text1"

						local var_14_7 = var_14_4

						ShipGroup = var_2_10009

						local var_14_8 = var_2_10009.New({
							id = var_10_13
						})

						var_2_10004.content = var_2_10005(var_2_10007, var_14_7, var_9.getName(var_14_8))
						...
						function var_2_10004.onYes()
							...
							var_15_1(var_15_0, var_3_10003.REPAIR_LOVE_LETTER_MAIL, arg_10_0.itemVO.id, var_14_4, var_10_13)

							return
						end

						var_14_6(var_14_5, var_2_10004)
					else
						table = var_14_4

						var_14_4.sort(var_10_20)

						pg = var_0

						local var_14_9 = var_0.MsgboxMgr.GetInstance()
						local var_14_10 = var_0.ShowMsgBox
						local var_14_11 = {
							hideYes = true
						}
						...
						local var_14_12 = "loveletter_recover_text2"

						ShipGroup = var_2_10007

						local var_14_13 = var_2_10007.New({
							id = var_10_13
						})

						var_14_11.content = var_2_10004(var_14_12, var_7.getName(var_14_13))
						underscore = var_4
						var_14_11.custom = var_4.map(var_10_20, function(arg_16_0)
							local var_16_0 = {
								delayButton = 3
							}
							...
							function var_16_0.onCallback()
								...
								ItemInfoMediator = var_4_10003

								var_17_1(var_17_0, var_4_10003.REPAIR_LOVE_LETTER_MAIL, arg_10_0.itemVO.id, arg_16_0, var_10_13)
			...
			var_10_18(var_10_21, var_10_22, var_10_23, var_1_10013)

			setGray = var_10_18

			var_10_18(var_10_19, not var_10_20 or #var_10_20 == 0)
		else
			local var_10_24 = arg_10_0.itemVO
			local var_10_25 = var_4.getConfig(var_10_24, "type")

			Item = var_10_7

			if var_10_25 == var_10_7.EQUIPMENT_BOX_TYPE_5 then
				local var_10_26 = arg_10_0
				local var_10_27 = arg_10_0.setItemInfo
				local var_10_28 = arg_10_1
				local var_10_29 = arg_10_0.operatePanel

				var_10_27(var_10_26, var_10_28, var_8.Find(var_10_29, "item"))

				setActive = var_10_27

				var_10_27(arg_10_0.useOneBtn, true)

				onButton = var_10_27

				local var_10_30 = arg_10_0
				local var_10_31 = arg_10_0.useOneBtn
				...
				var_10_27(var_10_30, var_10_31, var_10_32, var_1_10009)
			else
				local var_10_33 = arg_10_0.itemVO

				if var_4.CanOpen(var_10_33) then
					setText = var_4

					local var_10_34 = arg_10_0.useBtn

					var_4(var_10_33.Find(var_10_34, "text"), 1)

					setActive = var_4

					var_4(arg_10_0.useBtn, true)

					if arg_10_0.itemVO.count > 1 then
						setText = var_4

						local var_10_35 = arg_10_0.batchUseBtn

						var_10_33 = var_10_33.Find(var_10_35, "text")
						math = var_7

						var_4(var_10_33, var_7.min(arg_10_0.itemVO.count, 10))

						setActive = var_4

						var_4(arg_10_0.batchUseBtn, true)
					end
				else
					Item = var_4

					if var_10_8 == var_4.BLUEPRINT_TYPE then
						getProxy = var_4
						TechnologyProxy = var_10_33

						local var_10_36 = var_4(var_10_33)
						local var_10_37 = var_4.GetBlueprint4Item(var_10_36, arg_10_0.itemVO.id)

						LOCK_FRAGMENT_SHOP = var_10_33

						if not var_10_33 and var_10_37 then
							var_1_10009 = var_4:getBluePrintById(var_10_37)

							if var_6.isMaxLevel(var_1_10009) then
								setActive = var_7
								...
								arg_10_0.UpdateBlueprintResolveNum(var_1_10009)
							end
						end

						local var_10_38 = arg_10_0
						local var_10_39 = arg_10_0.setItemInfo

						var_1_10009 = arg_10_1

						local var_10_40 = arg_10_0.operatePanel

						var_10_39(var_10_38, var_1_10009, var_10.Find(var_10_40, "item"))

						setActive = var_10_39

						var_10_39(arg_10_0.okBtn, true)
					else
						Item = var_4

						local var_10_42

						if var_10_8 == var_4.TEC_SPEEDUP_TYPE then
							setActive = var_10_42

							var_10_42(arg_10_0.resolveBtn, true)
							arg_10_0:UpdateSpeedUpResolveNum()

							local var_10_41 = arg_10_0

							var_10_42 = arg_10_0.setItemInfo

							local var_10_43 = arg_10_1
							local var_10_44 = arg_10_0.operatePanel

							var_10_42(var_10_41, var_10_43, var_8.Find(var_10_44, "item"))
							...
							if var_10_8 == var_10_42.LOVE_LETTER_TYPE then
								setActive = var_4
								...
								if var_10_8 == var_4.METALESSON_TYPE then
									setActive = var_4
									...
									local var_10_46 = arg_10_0.metaskillBtn
									...
									local function var_10_47()
										...
										local var_19_3 = var_2_10003.GO_SCENE

										SCENE = var_2_10004

										var_19_2(var_19_1, var_19_3, var_2_10004.METACHARACTER)
									...
									var_4(var_10_45, var_10_46, var_10_47, var_1_10009)
									...
									if var_10_8 == var_4.SKIN_ASSIGNED_TYPE then
										setActive = var_4
										...
										local var_10_49 = arg_10_0.useOneBtn
										...
										var_4(var_10_48, var_10_49, var_10_50, var_1_10009)

										setActive = var_4

										var_4(arg_10_0.okBtn, true)
									else
										local var_10_51 = arg_10_0.itemVO

										if var_4.IsExclusiveDiscountType(var_10_51) then
											setActive = var_4
											...
											local var_10_52 = arg_10_0.itemVO

											if var_4.IsSkinExperienceType(var_10_52) then
												setActive = var_4
...
function var_0_1.didEnter(arg_22_0)
	...
	local var_22_3 = var_5.Find(var_22_2, "bg")
	...
	var_1_10002(var_22_1, var_22_3, var_22_4, var_22_2)

	onButton = var_1_10002

	local var_22_5 = arg_22_0
	local var_22_6 = arg_22_0._tf
	local var_22_7 = var_5.Find(var_22_6, "window/top/btnBack")
	...
	var_1_10002(var_22_5, var_22_7, var_22_8, var_22_6)
	...
	SFX_CONFIRM = var_22_6

	var_1_10002(var_22_9, var_22_10, var_22_11, var_22_6)
	...
	local function var_22_14()
		...
		var_26_1(var_26_0, var_2_10003.USE_ITEM, arg_22_0.itemVO.id, 1)
	...
	var_1_10002(var_22_12, var_22_13, var_22_14, var_22_6)
	...
	local function var_22_17()
		...
		local var_27_2 = var_2_10003.USE_ITEM
		local var_27_3 = arg_22_0.itemVO.id

		math = var_2_10005

		var_27_1(var_27_0, var_27_2, var_27_3, var_2_10005.min(arg_22_0.itemVO.count, 10))
	...
	var_1_10002(var_22_15, var_22_16, var_22_17, var_22_6)
	...
	var_1_10002(var_22_18, var_22_19, var_22_20, var_22_6)
	...
	var_1_10002(var_22_21, var_22_22, var_22_23, var_22_6)
	...
	var_1_10002(var_22_24, var_22_25, var_22_26, var_22_27, var_22_28, var_22_29, var_22_30, var_1_10011)
	...
	var_1_10002(var_22_31, var_22_32, var_22_33, var_22_34, var_22_35, var_22_36, var_22_37, var_1_10011)
	...
	var_1_10002(var_22_38, var_22_39, var_22_40, var_22_34)

	onInputEndEdit = var_1_10002

	var_1_10002(arg_22_0, arg_22_0.operateValueInput, function(arg_33_0)
		...
		local var_33_1 = var_2_10002.min
		local var_33_2 = var_0_4

		math = var_2_10005

		local var_33_3 = var_33_1(var_33_2, var_2_10005.min(var_33_0, arg_22_0.operateMax))

		math = var_3

		local var_33_4 = var_3.max(1, var_33_3)
	...
	local var_22_43 = var_22_42 == var_22_0.EQUIPMENT_BOX_TYPE_5
	...
	local function var_22_49()
		if arg_22_0.operateMode == var_0_6.COMPOSE then
			...
			var_35_1(var_35_0, var_2_10003.COMPOSE_ITEM, arg_22_0.itemVO.id, arg_22_0.operateCount)
			...
			if arg_22_0.itemVO.count - arg_22_0.operateCount * var_35_3 < var_35_3 then
				...
				var_2_10003 = arg_22_0

				var_1.SetOperateCount(var_2_10003, 1)
			end
		elseif arg_22_0.operateMode == var_0_6.USE then
			...
			var_35_5(var_35_4, var_2_10003.USE_ITEM, arg_22_0.itemVO.id, arg_22_0.operateCount)
		end
	...
	local function var_22_52()
		...
		local var_36_4 = var_2_10001(var_36_2, var_4.getName(var_36_3), var_36_1[2])
	...
	local function var_22_55()
		...
		local var_37_3 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		var_37_2(var_37_1, var_37_3, var_2_10004.SKINSHOP)
	...
	local function var_22_58()
		...
		local var_38_3 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		local var_38_4 = var_2_10004.SKINSHOP
		local var_38_5 = {}

		NewSkinShopScene = var_2_10006
		var_38_5.mode = var_2_10006.MODE_EXPERIENCE_FOR_ITEM
	...
	local function var_22_61()
		...
		local var_39_2 = var_2_10003.SELL_BLUEPRINT
		...
		DROP_TYPE_ITEM = var_2_10007
		var_39_4.type = var_2_10007
	...
	local var_22_65 = var_22_41(var_22_64, var_22_61(var_22_36))
	...
	var_22_64(arg_22_0, arg_22_0.keepFateTog, function(arg_41_0)
		...
		if arg_41_0 then
			...
			GAME = var_2_10004
			var_2_10004 = var_2_10004.CANCEL_COMMON_FLAG

			local var_41_2 = {}

			SHOW_DONT_KEEP_FATE_ITEM = var_2_10006
			var_41_2.flagID = var_2_10006

			var_41_0(var_41_1, var_2_10004, var_41_2)
		else
			pg = var_41_0
			...
			local var_41_5 = var_2_10004.COMMON_FLAG
			local var_41_6 = {}

			SHOW_DONT_KEEP_FATE_ITEM = var_2_10006
			var_41_6.flagID = var_2_10006
...
function var_0_1.UpdateCount(arg_42_0, arg_42_1)
	if arg_42_0.operateMode == var_0_6.COMPOSE then
		...
		local var_42_1 = var_3.clamp
		local var_42_2 = arg_42_1
		local var_42_3 = 1

		math = var_1_10007

		local var_42_4 = var_1_10007.floor
		local var_42_5 = arg_42_0.itemVO.count
		local var_42_6 = arg_42_0.itemVO

		arg_42_1 = var_42_1(var_42_2, var_42_3, var_42_4(var_42_5 / var_10.getConfig(var_42_6, "compose_number")))
...
function var_0_1.SetOperateCount(arg_43_0, arg_43_1)
	if arg_43_0.operateMode == var_0_6.COMPOSE then
		...
		local var_43_3 = var_43_0.clamp

		var_1_10006 = arg_43_1

		local var_43_4 = 1

		math = var_1_10008
		arg_43_1 = var_43_3(var_1_10006, var_43_4, var_1_10008.floor(arg_43_0.itemVO.count / var_43_2))

		if arg_43_0.operateCount ~= arg_43_1 then
			arg_43_0.operateCount = arg_43_1
			var_1_10006 = arg_43_0

			arg_43_0.UpdateComposeCount(var_1_10006)
		end
	...
	elseif arg_43_0.operateMode == var_0_6.USE then
		...
		math = var_1_10006
		arg_43_1 = var_43_6(var_43_7, var_43_8, var_1_10006.min(arg_43_0.operateMax, var_0_4))
...
function var_0_1.UpdateComposeCount(arg_44_0)
	...
	local var_44_2 = var_1_10003.insert
	local var_44_3 = var_44_1
	local var_44_4 = {}

	DROP_TYPE_ITEM = var_1_10007
	var_44_4.type = var_1_10007

	local var_44_5 = arg_44_0.itemVO

	var_44_4.id = var_7.getConfig(var_44_5, "target_id")
	...
	var_44_2.StaticAlign(arg_44_0.operateBonusList, arg_44_0.operateBonusTpl, #var_44_1, function(arg_45_0, arg_45_1, arg_45_2)
		...
		if arg_45_0 == var_2_10003.EventUpdate then
			...
			local var_45_3 = arg_45_2.Find(var_45_2, "IconTpl")
			...
			var_2_10004(var_45_1, var_45_3, var_45_4, var_45_2)
		end
	...
	var_3(var_44_6, iter_44_0("compose_amount_prefix"))
...
function var_0_1.UpdateResolvePanel(arg_47_0)
	...
	local var_47_4 = var_47_1.insert
	local var_47_5 = var_47_3
	local var_47_6 = {}

	DROP_TYPE_RESOURCE = var_1_10008
	var_47_6.type = var_1_10008
	...
	var_47_4.StaticAlign(arg_47_0.operateBonusList, arg_47_0.operateBonusTpl, #var_47_3, function(arg_48_0, arg_48_1, arg_48_2)
		...
		if arg_48_0 == var_2_10003.EventUpdate then
			...
			local var_48_3 = arg_48_2.Find(var_48_2, "IconTpl")
			...
			var_2_10004(var_48_1, var_48_3, var_48_4, var_48_2)
		end
	...
	for iter_47_0, iter_47_1 in var_4(arg_47_0.operateBtns) do
		...
		var_9(iter_47_1, iter_47_0 == "Resolve" or iter_47_0 == "Cancel")
	end
	...
	var_4(var_47_7, iter_47_0("resolve_amount_prefix"))
	...
	if var_47_9 == var_5.TEC_SPEEDUP_TYPE then
		setActive = var_47_9
...
function var_0_1.UpdateBlueprintResolveNum(arg_50_0)
	...
	if var_50_2 == var_1_10003.BLUEPRINT_TYPE then
		getProxy = var_3
		TechnologyProxy = var_5

		local var_50_3 = var_3(var_5)
...
function var_0_1.UpdateSpeedUpResolveNum(arg_51_0)
	...
	if var_51_2 == var_1_10003.TEC_SPEEDUP_TYPE then
...
function var_0_1.UpdateUsePanel(arg_52_0)
	...
	local var_52_2 = var_1_10003.insert
	local var_52_3 = var_52_1
	local var_52_4 = {}

	DROP_TYPE_ITEM = var_1_10007
	var_52_4.type = var_1_10007
	var_52_4.id = var_0_5
	...
	for iter_52_0, iter_52_1 in var_3(arg_52_0.operateBtns) do
		...
		var_8(iter_52_1, iter_52_0 == "Confirm" or iter_52_0 == "Cancel")
	end
	...
	var_3(var_52_5, iter_52_0("use_amount_prefix"))
...
function var_0_1.PlayOpenBox(arg_55_0, arg_55_1, arg_55_2)
	...
	if var_4.Find(var_55_1, arg_55_1 .. "(Clone)") then
		go = var_1_10005
		arg_55_0[arg_55_1] = var_1_10005(var_4)
	end
	...
	if not arg_55_0[arg_55_1] then
		...
		var_5.insert(var_55_0, function(arg_56_0)
			...
			var_56_1(var_56_0, var_56_2 .. var_2_10005.lower(arg_55_1), "", true, function(arg_57_0)
	...
	var_5(var_55_0, function()
		...
		SFX_UI_EQUIPMENT_OPEN = var_5

		var_58_4(var_58_3, var_5)
...
function var_0_1.inOutAnim(arg_61_0, arg_61_1, arg_61_2)
	if arg_61_1 then
		...
		local var_61_3 = var_61_2(var_61_1, var_1_10007(var_1_10009))
		...
		local var_61_7 = var_61_6(var_61_5, var_1_10009(var_1_10011))
		...
		local var_61_11 = var_61_10(var_61_9, var_1_10011(var_1_10013))
		...
		local var_61_15 = var_61_14(var_61_13, var_1_10013(var_1_10015))
