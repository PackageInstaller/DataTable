...
function var_0_1.InitUI(arg_6_0)
	...
	arg_6_0.normalList = var_6_13(var_3.Find(var_6_14, "list"), arg_6_0.itemTpl)
	UIItemList = var_1

	local var_6_15 = var_1.New
	local var_6_16 = arg_6_0.specialWindow

	arg_6_0.specialList = var_6_15(var_3.Find(var_6_16, "list"), arg_6_0.itemTpl)
	setScrollText = var_1
	...
	var_1(var_6_17, var_4("ui_pack_tip1"))
	...
	var_1(var_6_18, var_4("ui_pack_tip2"))
	...
	var_1(var_6_19, var_4("ui_pack_tip3"))
	...
	var_1(var_6_23, var_6_24, var_6_25, var_6)
	...
	var_1(var_6_26, var_6_27, var_6_28, var_6)
	...
	local var_6_33 = var_3.Find(var_6_32, "mainPanel/topBar/left/elementList")
	local var_6_34 = arg_6_0._tf

	arg_6_0.toggleList = var_6_31(var_6_33, var_4.Find(var_6_34, "mainPanel/topBar/left/elementList/main_toggle"))
	UpdateBeat = var_1
...
function var_0_1.UpdateClick(arg_10_0)
	...
	if var_1_10001.Input.GetMouseButtonDown(0) then
		...
		var_1.each(var_10_0, function(arg_11_0, arg_11_1)
			...
			typeof = var_2_10005
			Toggle = var_2_10007
			var_2_10002(var_11_0, var_2_10005(var_2_10007)).isOn = false
...
function var_0_1.updateGiftWindow(arg_12_0)
	...
	local var_12_1 = var_3.Find(var_12_0, "Price/BuyText")

	i18n = var_1_10004

	var_1_10001(var_12_1, var_1_10004("word_buy"))

	setText = var_1_10001

	local var_12_2 = arg_12_0.buyNormalBtn
	local var_12_3 = var_3.Find(var_12_2, "Price/content/Text")
	local var_12_4 = arg_12_0.normalGoodVO

	var_1_10001(var_12_3, var_4.getConfig(var_12_4, "money"))
	...
	local function var_12_7()
		...
		var_13_1(var_13_0, var_2_10003.CHARGE_OPERATION, {
	...
	var_1_10001(var_12_5, var_12_6, var_12_7, var_12_4)

	setText = var_1_10001

	local var_12_8 = arg_12_0.buySpecialBtn
	local var_12_9 = var_3.Find(var_12_8, "Price/BuyText")

	i18n = var_12_6

	var_1_10001(var_12_9, var_12_6("word_buy"))

	setText = var_1_10001

	local var_12_10 = arg_12_0.buySpecialBtn
	local var_12_11 = var_3.Find(var_12_10, "Price/content/Text")
	local var_12_12 = arg_12_0.specailGoodVO

	var_1_10001(var_12_11, var_4.getConfig(var_12_12, "money"))
	...
	local function var_12_15()
		...
		var_14_1(var_14_0, var_2_10003.CHARGE_OPERATION, {
	...
	var_1_10001(var_12_13, var_12_14, var_12_15, var_12_12)
	...
	for iter_12_0, iter_12_1 in var_1_10002(var_4.GetExtraServiceItem(var_12_17)) do
		table = var_7

		var_7.insert(var_12_16, iter_12_1)
	...
	var_2.make(var_12_18, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			local function var_15_6()
				...
				var_16_1(var_16_0, var_3_10003.ON_DROP, var_15_3)
			...
			var_7(var_15_4, var_15_5, var_15_6, var_2_10012)
			...
			if var_15_10(var_15_9, var_10(var_15_8)).text == "" then
				setScrollText = var_7
	...
	for iter_12_2, iter_12_3 in var_2(var_4.GetExtraServiceItem(var_12_20)) do
		table = var_7

		var_7.insert(var_12_16, iter_12_3)
	end
	...
	var_2.make(var_12_21, function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_0 == var_2_10003.EventUpdate then
			...
			local function var_17_6()
				...
				var_18_1(var_18_0, var_3_10003.ON_DROP, var_17_3)
			...
			var_7(var_17_4, var_17_5, var_17_6, var_2_10012)
...
function var_0_1.InitBattleShow(arg_19_0)
	...
	local var_19_1 = var_1_10002.New({
		id = 100011,
		configId = 100011,
		skin_id = 100010
	})
	...
	var_4(var_19_3, var_19_4, var_19_5, var_1_10009)
...
function var_0_1.InitTitle(arg_29_0, arg_29_1)
	...
	for iter_29_0, iter_29_1 in var_1_10002(arg_29_1) do
		...
		if var_29_0 == var_1_10008 then
			...
			string = var_1_10014
			var_1_10014 = var_1_10014.format("rare_%s", var_29_2)

			local var_29_6 = arg_29_0._tf

			var_29_4(var_29_3, var_29_5, var_1_10014, var_15.Find(var_29_6, "mainPanel/topBar/left/rareImage"))
			...
			var_10.make(var_29_7, function(arg_30_0, arg_30_1, arg_30_2)
				...
				if arg_30_0 == var_2_10003.EventUpdate then
					...
					CombatSkinConst = var_2_10008

					local var_30_4 = var_2_10008.TYPE_ICON_NAME[var_30_0]

					findTF = var_2_10009

					var_30_2(var_30_1, var_30_3, var_30_4, var_2_10009(arg_30_2, "on"))
					...
					CombatSkinConst = var_11

					local var_30_10 = var_30_8(var_30_9, var_11.TYPE_ICON_NAME[var_30_0])

					findTF = var_9

					var_30_6(var_30_5, var_30_7, var_30_10, var_9(arg_30_2, "off"))
					...
					local function var_30_13(arg_31_0)
						...
						var_3_10001(var_31_0, var_3_10004("battleui_display" .. var_30_0))
						...
						var_3_10002(var_31_4, var_31_3 + var_3_10005(-20, 46, 0))
					...
					var_30_6(var_30_11, var_30_12, var_30_13, var_9)
				end
