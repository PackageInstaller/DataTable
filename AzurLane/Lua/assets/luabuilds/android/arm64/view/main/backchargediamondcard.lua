...
function var_0_0.update(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if var_2_1 then
		var_2_2 = arg_2_1:getConfig("gem")
	elseif arg_2_1:hasExtraGem() then
		var_2_2 = arg_2_1:getConfig("extra_gem")
	end

	setText = var_2_2

	var_2_2(arg_2_0.diamondCountText, arg_2_1:getConfig("gem"))

	PLATFORM_CODE = var_2_2
	PLATFORM_US = var_2_0

	if var_2_2 == var_2_0 then
		var_2_2 = arg_2_1:getConfig("money")
		setText = var_2_0

		local var_2_3 = arg_2_0.priceText

		math = var_1_10010

		local var_2_4 = var_1_10010.floor(var_2_2 / 100)
		local var_2_5 = "."

		math = var_12

		var_2_0(var_2_3, var_2_4 .. var_2_5 .. var_2_2 - var_12.floor(var_2_2 / 100) * 100)
	else
		setText = var_2_2

		var_2_2(arg_2_0.priceText, arg_2_1:getConfig("money"))
	end

	LoadSpriteAsync = var_2_2

	var_2_2("chargeicon/" .. arg_2_1:getConfig("picture"), function(arg_3_0)
		if arg_3_0 then
			IsNil = var_2_10001
	...
	if arg_2_0.goods.buyTime then
		...
		local var_2_7 = var_6.STimeDescS(var_2_6, arg_2_0.goods.buyTime, "%Y-%m-%d %H:%M")

		setText = var_2_0

		var_2_0(arg_2_0.beginTimeText, var_2_7)
	end
	...
	if arg_2_0.goods.refundTime then
		...
		var_2_9 = var_2_9.STimeDescS(var_2_8, arg_2_0.goods.refundTime, "%Y-%m-%d %H:%M")
		setText = var_2_0

		var_2_0(arg_2_0.backTimeText, var_2_9)
	end

	setText = var_2_9

	local var_2_10 = arg_2_0.beginTimeDesc

	i18n = var_9

	var_2_9(var_2_10, var_9("Supplement_pay6"))

	setText = var_2_9

	local var_2_11 = arg_2_0.backTimeDesc

	i18n = var_9

	var_2_9(var_2_11, var_9("Supplement_pay7"))

	setText = var_2_9

	local var_2_12 = arg_2_0.leftDesc

	i18n = var_9

	var_2_9(var_2_12, var_9("Supplement_pay8", "1/1"))
