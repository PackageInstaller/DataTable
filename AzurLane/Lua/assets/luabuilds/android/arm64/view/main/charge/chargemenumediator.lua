...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	if var_3_1 ~= var_4.CHARGE_SUCCESS then
		GAME = var_3_6

		do
			local var_3_6

			if var_3_1 == var_3_6.SHOPPING_DONE then
				...
				if arg_3_0.viewComponent.lookUpIndex then
					...
					local var_3_7 = var_1_10007.TRACK

					TrackConst = var_1_10008

					local var_3_8 = var_1_10008.GetTrackData

					TrackConst = var_1_10010

					local var_3_9 = var_1_10010.SYSTEM_SHOP

					TrackConst = var_1_10011

					var_3_6(var_3_5, var_3_7, var_3_8(var_3_9, var_1_10011.ACTION_BUY_RECOMMEND, arg_3_0.viewComponent.lookUpIndex))
				end

				GAME = var_3_6

				if var_3_1 == var_3_6.CHARGE_SUCCESS then
					Goods = var_3_6
					...
					Goods = var_7
					var_3_6 = var_3_6(var_3_10, var_7.TYPE_CHARGE)
				...
				if var_3_1 == var_3_6.REMOVE_LAYER_DONE then
...
function var_0_1.bindEvent(arg_4_0)
	arg_4_0:bind(var_0_1.GO_SKIN_SHOP, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_5_2, var_2_10006.SKINSHOP)
	...
	arg_4_0:bind(var_0_1.GO_SUPPLY_SHOP, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_6_2, var_2_10006.SHOP, arg_6_1)
	...
	arg_4_0:bind(var_0_1.GO_CHARGE_SHOP, function(arg_7_0, arg_7_1)
		...
		var_7_1(var_7_0, var_7_2, var_2_10006.CHARGE, {
			warp = arg_7_1
		})
