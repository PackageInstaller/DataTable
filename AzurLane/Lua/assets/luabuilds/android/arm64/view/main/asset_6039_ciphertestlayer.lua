...
function var_0_1.LoadL2dPainting(arg_8_0, arg_8_1)
	...
	local var_8_2 = var_1_10004.GenerateData
	local var_8_3 = {}

	Ship = var_1_10007
	var_8_3.ship = var_1_10007.New({
		id = 999,
		configId = var_8_1.id,
		skin_id = arg_8_1
	})
	Vector3 = var_7
	var_8_3.position = var_7(0, 0, -1)
	...
	Live2DPainting = var_8_3
	var_8_6 = var_8_3.New(var_8_4, function(arg_9_0)
