...
function var_0_1.findUI(arg_7_0)
	...
	arg_7_0.inputSC = var_1(var_7_3, var_4(var_1_10006))
...
function var_0_1.addListener(arg_8_0)
	...
	var_1_10001(arg_8_0, arg_8_0.confirmBtn, function()
		...
		if not var_2_10000(arg_8_0.inputSC.text) then
			...
			var_12_1(var_12_0, var_2_10003("set_birth_empty_tip"))
		else
			pg = var_12_1
			...
			i18n = var_2_10004
			var_12_4.title = var_2_10004("set_birth_title")
			i18n = var_4
			var_12_4.content = var_4("set_birth_confirm_tip", arg_8_0.inputSC.text)
