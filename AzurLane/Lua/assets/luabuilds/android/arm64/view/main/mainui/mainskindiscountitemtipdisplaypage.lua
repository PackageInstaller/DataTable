...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_7 = var_3.Find(var_2_6, "window/item_panel/scrollview/list")
	local var_2_8 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_5(var_2_7, var_4.Find(var_2_8, "window/item_panel/scrollview/list/tpl"))
	setText = var_1

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_3.Find(var_2_9, "window/item_panel/label/Text")

	i18n = var_4

	var_1(var_2_10, var_4("skin_discount_item_expired_tip"))

	setText = var_1

	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_3.Find(var_2_11, "window/stopRemind/Label")

	i18n = var_4

	var_1(var_2_12, var_4("skin_discount_item_repeat_remind_label"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		pg = var_2_10004
		var_4_2.helps = var_2_10004.gametip.skin_discount_item_notice.tip
	...
	local function var_3_11()
		...
		var_7_1(var_7_0, var_7_2, var_2_10004.EQUIPSCENE)
...
function var_0_1.MarkRemind(arg_9_0)
	...
	var_1_10003.SetString("SkinDiscountItemTip" .. var_9_2, var_9_0)
...
function var_0_1.UnMarkRemind(arg_10_0)
	...
	var_1_10002.DeleteKey("SkinDiscountItemTip" .. var_10_1)
...
function var_0_1.UpdateItem(arg_14_0, arg_14_1, arg_14_2)
	...
	var_1_10004(arg_14_2, var_14_2)

	setScrollText = var_1_10004

	local var_14_3 = arg_14_2:Find("name_bg/Text")
	local var_14_4 = var_14_2

	var_1_10004(var_14_3, var_14_2.getName(var_14_4))
	...
	local function var_14_7()
		...
		var_15_1(var_15_0, var_2_10003.ON_DROP, var_14_2)
	...
	var_1_10004(var_14_5, var_14_6, var_14_7, var_14_4)
...
function var_0_1.OnDestroy(arg_16_0)
	...
	var_16_1(var_16_0, var_16_2, var_1_10005.UIMgr.GetInstance()._normalUIMain)
