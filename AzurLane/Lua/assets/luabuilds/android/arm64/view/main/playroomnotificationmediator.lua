...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OPEN_FRIEND_INFO, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		var_2_1(var_2_0, var_2_10007.OPEN_FRIEND_INFO_DONE, arg_2_2)
		...
		local var_2_4 = var_7.FRIEND_SEARCH
		local var_2_5 = {}

		SearchFriendCommand = var_2_10009
		var_2_5.type = var_2_10009.SEARCH_TYPE_RESUME
	...
	arg_1_0:bind(var_0_1.CHANGE_CHAT_ROOM, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10005.CHANGE_CHAT_ROOM, arg_3_1)
	...
	arg_1_0:bind(var_0_1.SEND_CHAT, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10006.PLAY_ROOM_SEND_CHAT, {
			channel = arg_4_1,
	...
	arg_1_0:bind(var_0_1.OPEN_EMOJI, function(arg_5_0, arg_5_1)
		...
		EmojiLayer = var_2_10008
		var_5_3.viewComponent = var_2_10008
		EmojiMediator = var_2_10008
