...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_8 = var_3.Find(var_2_7, "window/top/title_list/infomation/title")

	i18n = var_4

	var_1(var_2_8, var_4("chang_ship_skin_window_title"))

	setText = var_1

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_3.Find(var_2_9, "window/sliders/please/Text")

	i18n = var_4

	var_1(var_2_10, var_4("choose_ship_to_wear_this_skin"))

	setText = var_1

	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_3.Find(var_2_11, "window/exchange_btn/Image")

	i18n = var_4

	var_1(var_2_12, var_4("change"))

	setText = var_1

	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_3.Find(var_2_13, "window/cancel_btn/Image")

	i18n = var_4

	var_1(var_2_14, var_4("word_cancel"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_11 = var_4.Find(var_3_10, "bg0")
	...
	var_1_10001(var_3_9, var_3_11, var_3_12, var_3_10)
	...
	var_1_10001(var_3_13, var_3_14, var_3_15, var_3_10)
	...
	var_1_10001(var_3_16, var_3_17, var_3_18, var_3_10)
...
function var_0_1.OnConfirm(arg_10_0)
	...
	if not arg_10_0.selectIds or #arg_10_0.selectIds <= 0 then
		...
		i18n = var_1_10005
		var_10_2.content = var_1_10005("new_skin_no_choose")
	...
	for iter_10_0, iter_10_1 in var_10_1(arg_10_0.selectIds) do
		...
		local var_10_4 = var_8.m02
		local var_10_5 = var_8.sendNotification

		GAME = var_1_10011

		var_10_5(var_10_4, var_1_10011.SET_SHIP_SKIN, {
			shipId = var_1_10006,
			phantomId = var_10_3,
	...
	if arg_10_0.flagRandomMark then
		...
		local var_10_6 = var_1.m02
		local var_10_7 = var_1.sendNotification

		GAME = var_4

		local var_10_8 = var_4.CHANGE_RANDOM_SHIPS
		local var_10_9 = {}

		underscore = var_1_10006
		var_10_9.addList = var_1_10006.to_array(arg_10_0.selectIds)
		var_10_9.deleteList = {}

		var_10_7(var_10_6, var_10_8, var_10_9)
	end
...
function var_0_1.Show(arg_12_0, arg_12_1)
	...
	var_2(var_4.Find(var_12_0, "window"), true)

	setActive = var_2

	local var_12_1 = arg_12_0._tf

	var_2(var_4.Find(var_12_1, "select_skin"), false)
...
function var_0_1.ShowAdmiral(arg_13_0)
	...
	var_1_10001(var_3.Find(var_13_0, "window"), false)

	setActive = var_1_10001

	local var_13_1 = arg_13_0._tf

	var_1_10001(var_3.Find(var_13_1, "select_skin"), true)
	...
	local var_13_6 = var_13_3.Find(var_13_5, "btnBack")
	...
	var_1_10002(var_13_4, var_13_6, var_13_7, var_13_5)
	...
	local var_13_10 = var_13_3.Find(var_13_9, "exchange_btn")
	...
	local function var_13_11()
		...
		var_15_5(var_15_4, var_2_10005.CHANGE_PLAYER_ICON, {
			skinPage = true,
			after = var_15_3
		})
	...
	SFX_CONFIRM = var_13_9

	var_2(var_13_8, var_13_10, var_13_11, var_13_9)

	arg_13_0.paintingInfo = {}
	PlayerVitaeShipsPage = var_2

	local var_13_12, var_13_13 = var_2.GetSlotMaxCnt()

	getProxy = var_13_8
	PlayerProxy = var_13_11

	local var_13_14 = var_13_8(var_13_11)
	local var_13_15 = var_4.getRawData(var_13_14)
	local var_13_16 = var_4.GetShipPhantomMarks(var_13_15)
	local var_13_17 = var_13_3:Find("frame/style_scroll/view_port")

	UIItemList = var_13_15

	var_13_15.StaticAlign(var_13_17, var_13_17:GetChild(0), var_13_12, function(arg_16_0, arg_16_1, arg_16_2)
		arg_16_1 = arg_16_1 + 1
		...
		if arg_16_0 == var_2_10003.EventUpdate then
			...
			var_3(var_16_0, var_16_1, var_16_2, var_2_10008)

			if var_13_16[arg_16_1] then
				getProxy = var_3
				BayProxy = var_16_0
				...
				if not var_3.GetShipPhantom(var_16_0, var_13_16[arg_16_1]) then
					var_16_3 = nil
				end

				setActive = var_2_10004

				var_2_10004(arg_16_2:Find("Style_card"), var_16_3)

				setActive = var_2_10004

				var_2_10004(arg_16_2:Find("empty"), not var_16_3)

				if var_16_3 then
					var_2_10004 = var_16_3:getSkinId()
					pg = var_16_0
					var_16_0 = var_16_0.ship_skin_template[var_2_10004]

					local var_16_4 = arg_13_0.paintingInfo
					local var_16_5 = {}
					local var_16_6

					if not var_16_0.painting then
						var_16_6 = "unknown"
					end

					var_16_5.paintingName = var_16_6
					var_16_5.painting = arg_16_2:Find("Style_card/bg/mask/painting")
					var_16_5.skinID = var_2_10004
					var_16_4[arg_16_1] = var_16_5

					local var_16_7 = arg_13_0

					var_6.loadPainting(var_16_7, arg_13_0.paintingInfo[arg_16_1])

					changeToScrollText = var_6

					var_6(arg_16_2:Find("Style_card/bg/desc/name_bar/name"), var_16_0.name)

					setToggleEnabled = var_6

					var_6(arg_16_2, true)
				else
					var_2_10004 = var_13_13 < arg_16_1
					setActive = var_16_0

					var_16_0(arg_16_2:Find("empty/add"), not var_2_10004)

					setActive = var_16_0

					var_16_0(arg_16_2:Find("empty/lock"), var_2_10004)

					setText = var_16_0

					local var_16_8 = arg_16_2:Find("empty/lock/Text")

					i18n = var_8

					var_16_0(var_16_8, var_8("secretary_unlock" .. arg_16_1))

					setToggleEnabled = var_16_0

					var_16_0(arg_16_2, not var_2_10004)
				end

				triggerToggle = var_2_10004

				var_2_10004(arg_16_2, arg_16_1 == arg_13_0.selectIndex)
	...
	local var_13_18 = arg_13_0._tf
	local var_13_19 = var_8.Find(var_13_18, "select_skin/title/Text")

	i18n = var_9

	var_6(var_13_19, var_9("choose_secretary_change_title"))

	setText = var_6

	local var_13_20 = arg_13_0._tf
	local var_13_21 = var_8.Find(var_13_20, "select_skin/please")

	i18n = var_9

	var_6(var_13_21, var_9("choose_secretary_change_to_this_ship"))

	setText = var_6

	local var_13_22 = arg_13_0._tf
	local var_13_23 = var_8.Find(var_13_22, "select_skin/exchange_btn/Image")

	i18n = var_9

	var_6(var_13_23, var_9("change"))
...
function var_0_1.GetFlagShipMark(arg_18_0)
	if arg_18_0.isNew then
		...
		return var_1.GetSetFlagShip(var_1_10003)
	else
		getProxy = var_1
		SettingsProxy = var_1_10003
...
function var_0_1.SetFlagShipMark(arg_19_0, arg_19_1)
	if arg_19_0.isNew then
		...
		var_2.SetFlagShip(var_1_10004, arg_19_1)
	else
		getProxy = var_2
		SettingsProxy = var_1_10004

		local var_19_0 = var_2(var_1_10004)
...
function var_0_1.GetShips(arg_22_0, arg_22_1)
	...
	local var_22_2 = var_1_10003.sort
	local var_22_3 = var_22_1

	CompareFuncs = var_1_10006

	var_22_2(var_22_3, var_1_10006({
		function(arg_23_0)
...
function var_0_1.FlushShips(arg_28_0)
	...
	var_1_10001.StaticAlign(arg_28_0.shipContent, arg_28_0.shipCardTpl, #arg_28_0.ships, function(arg_29_0, arg_29_1, arg_29_2)
		...
		if arg_29_0 == var_2_10003.EventUpdate then
			...
			local var_29_4 = var_8.Find(var_29_3, "Text")
			local var_29_5 = "-  "

			i18n = var_29_3

			var_6(var_29_4, var_29_5 .. var_29_3("shop_skin_already_inuse") .. "  -")
			...
			local function var_29_8(arg_30_0)
				...
				if arg_30_0 then
					...
					var_30_2(var_30_3, var_4.GetSelectMark(var_30_4))
				else
					table = var_30_2
					...
					var_30_5(var_30_6, var_4.GetSelectMark(var_30_7))
				end
			...
			var_6(var_29_6, var_29_7, var_29_8, var_11)
		end
...
function var_0_1.loadPainting(arg_32_0, arg_32_1)
	...
	var_1_10003(arg_32_1.painting, arg_32_1.paintingName, "pifu", nil, {
		rotateZ = 0,
