...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.GO_META_BOSS, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_2, var_2_10005.WORLDBOSS)
	...
	arg_1_0:bind(var_0_1.ON_UR_ACTIVITY, function(arg_3_0)
		...
		local var_3_3 = var_2_10005.ACTIVITY
		local var_3_4 = {}

		ActivityConst = var_2_10007
		var_3_4.id = var_2_10007.UR_ITEM_ACT_ID
	...
	arg_1_0:bind(var_0_1.ON_CRUSING, function(arg_4_0)
		...
		var_4_1(var_4_0, var_4_2, var_2_10005.CRUSING)
	...
	arg_1_0:bind(var_0_1.GET_CLASS_RES, function(arg_5_0)
		...
		var_5_1(var_5_0, var_2_10004.HARVEST_CLASS_RES)
	...
	arg_1_0:bind(var_0_1.ON_TECH_QUEUE_FINISH, function(arg_6_0)
		...
		var_6_1(var_6_0, var_2_10004.FINISH_QUEUE_TECHNOLOGY)
	...
	arg_1_0:bind(var_0_1.ON_TECH_FINISHED, function(arg_7_0, arg_7_1)
		...
		var_7_1(var_7_0, var_2_10005.FINISH_TECHNOLOGY, {
			id = arg_7_1.id,
	...
	arg_1_0:bind(var_0_1.FINISH_EVENT, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
		...
		var_8_1(var_8_0, var_2_10007.EVENT_FINISH, {
			id = arg_8_1.id,
			callback = function()
	...
	arg_1_0:bind(var_0_1.FINISH_CLASS, function(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
		...
		var_11_1(var_11_0, var_2_10007.CANCEL_LEARN_TACTICS, {
			shipId = arg_11_1,
			type = arg_11_2,
			onConfirm = arg_11_3
		})
	...
	arg_1_0:bind(var_0_1.ON_ACTIVE_EVENT, function(arg_12_0)
		...
		var_12_1(var_12_0, var_12_2, var_2_10005.EVENT)
	...
	arg_1_0:bind(var_0_1.ON_ACTIVE_CLASS, function(arg_13_0)
		...
		var_13_1(var_13_0, var_13_2, var_2_10005.NAVALTACTICS)
	...
	arg_1_0:bind(var_0_1.ON_ACTIVE_TECH, function(arg_14_0)
		...
		var_14_1(var_14_0, var_14_2, var_2_10005.TECHNOLOGY)
	...
	arg_1_0:bind(var_0_1.GET_OIL_RES, function(arg_15_0)
		...
		local var_15_2 = var_2_10004.HARVEST_RES

		PlayerConst = var_2_10005

		var_15_1(var_15_0, var_15_2, var_2_10005.ResOil)
	...
	arg_1_0:bind(var_0_1.GET_GOLD_RES, function(arg_16_0)
		...
		local var_16_2 = var_2_10004.HARVEST_RES

		PlayerConst = var_2_10005

		var_16_1(var_16_0, var_16_2, var_2_10005.ResGold)
	...
	arg_1_0:bind(var_0_1.ON_INS, function(arg_17_0)
		...
		var_17_1(var_17_0, var_2_10004.ON_OPEN_INS_LAYER)
		...
		var_17_3(var_17_2, var_4.ON_CLOSE)
	...
	arg_1_0:bind(var_0_1.FINISH_CLASS_ALL, function()
		...
		var_18_1(var_18_0, var_18_2, var_2_10004.NAVALTACTICS)
...
function var_0_1.continueClass(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	local var_20_0 = var_1_10004(var_1_10006)
	local var_20_1 = var_4.getShipById(var_20_0, arg_20_1)

	getProxy = var_1_10006
	BagProxy = var_8

	local var_20_2 = var_1_10006(var_8)
	local var_20_3 = var_6.getItemsByType

	Item = var_1_10010

	local var_20_4 = var_20_3(var_20_2, var_1_10010.LESSON_TYPE)

	table = var_8

	if var_8.getCount(var_20_4 or {}) <= 0 then
		pg = var_8
		...
		var_20_6(var_20_5, var_1_10011("tactics_no_lesson"))
	...
	local var_20_9 = var_1_10011.GO_SCENE

	SCENE = var_1_10012

	var_20_8(var_20_7, var_20_9, var_1_10012.NAVALTACTICS, {
		shipToLesson = {
			shipId = arg_20_1,
...
function var_0_1.handleNotification(arg_22_0, arg_22_1)
	...
	if var_22_1 == var_22_0.UPDATED then
		var_1_10006 = arg_22_0.viewComponent

		var_4.OnPlayerUpdate(var_1_10006, var_22_3)
	...
	if var_22_1 == var_4.HARVEST_RES_DONE then
		var_22_4 = nil

		if var_22_3.type == 2 then
			i18n = var_22_2
			var_22_4 = var_22_2("word_oil")
		elseif var_22_3.type == 1 then
			i18n = var_22_2
			var_22_4 = var_22_2("word_gold")
		end

		pg = var_22_2
		var_1_10007 = var_22_2.TipsMgr.GetInstance()
		var_22_2 = var_22_2.ShowTips
		i18n = var_1_10008

		var_22_2(var_1_10007, var_1_10008("commission_get_award", var_22_4, var_22_3.outPut))
	...
	if var_22_1 ~= var_22_4.EVENT_LIST_UPDATE then
		GAME = var_22_5

		do
			local var_22_5

			if var_22_1 == var_22_5.EVENT_FINISH_UPDATE then
				getProxy = var_22_5
				EventProxy = var_1_10006
				var_22_5 = var_22_5(var_1_10006)
				var_1_10007 = arg_22_0.viewComponent

				var_22_2.OnUpdateEventInfo(var_1_10007)
			else
				GAME = var_22_5

				local var_22_6

				if var_22_1 == var_22_5.EVENT_SHOW_AWARDS then
					var_22_6 = nil
					coroutine = var_22_2

					var_22_2.wrap(function()
						if #var_22_3.oldShips > 0 then
							local var_23_0 = arg_22_0.viewComponent
							local var_23_1 = var_0.emit

							BaseUI = var_2_10003
							var_2_10003 = var_2_10003.ON_SHIP_EXP

							local var_23_2 = {}

							pg = var_2_10005
							var_23_2.title = var_2_10005.collection_template[var_22_3.eventId].title
							var_23_2.oldShips = var_22_3.oldShips
							var_23_2.newShips = var_22_3.newShips
							var_23_2.isCri = var_22_3.isCri

							var_23_1(var_23_0, var_2_10003, var_23_2, var_22_6)
						...
						var_23_4(var_23_3, var_2_10003.ON_ACHIEVE, var_22_3.awards, function()
							if var_22_3.onConfirm then
								var_22_3.onConfirm()
							end
					...
					if var_22_1 == var_22_6.CANCEL_LEARN_TACTICS_DONE then
						local var_22_7 = arg_22_0.viewComponent

						var_22_8.OnUpdateClass(var_22_7)

						var_22_8 = var_22_3.totalExp
						var_22_2 = var_22_3.oldSkill

						local var_22_9 = var_22_3.newSkill

						getProxy = var_1_10007
						BayProxy = var_1_10009

						local var_22_10 = var_1_10007(var_1_10009)

						var_1_10007 = var_1_10007.getShipById(var_22_10, var_22_3.shipId)

						local var_22_11 = var_22_9.id
						local var_22_12
						local var_22_13 = var_22_9.level

						if var_22_2.level < var_22_13 then
							i18n = var_22_13
							var_1_10012 = "tactics_end_to_learn"

							local var_22_14 = var_1_10007:getName()

							getSkillName = var_1_10014
							var_22_13 = var_22_13(var_1_10012, var_22_14, var_1_10014(var_22_11), var_22_8)
							i18n = var_11
							var_22_12 = var_22_13 .. var_11("tactics_skill_level_up", var_22_2.level, var_22_9.level)
						else
							i18n = var_22_13
							var_1_10012 = "tactics_end_to_learn"

							local var_22_15 = var_1_10007:getName()

							getSkillName = var_1_10014
							var_22_12 = var_22_13(var_1_10012, var_22_15, var_1_10014(var_22_11), var_22_8)
						end

						pg = var_22_13

						if var_22_13.skill_data_template[var_22_11].max_level <= var_22_9.level then
							arg_22_0:HandleClassMaxLevel(var_1_10007, var_22_3, var_22_11, var_22_8)
						else
							local var_22_16 = var_22_12

							i18n = var_1_10012

							local var_22_17 = var_22_16 .. var_1_10012("tactics_continue_to_learn")

							pg = var_22_16

							local var_22_18 = var_22_16.MsgboxMgr.GetInstance()

							var_11.ShowMsgBox(var_22_18, {
								modal = true,
								hideNo = false,
								hideClose = true,
								content = var_22_17,
								onYes = function()
									...
									var_0.continueClass(var_25_0, var_22_3.shipId, var_22_11, var_22_3.id)
						...
						if var_22_1 == var_22_8.FINISH_TECHNOLOGY_DONE then
							local var_22_19 = arg_22_0.viewComponent

							var_22_20.OnUpdateTechnology(var_22_19)

							var_22_20 = #var_22_3.items

							if 0 < var_22_20 then
								local var_22_21 = arg_22_0.viewComponent

								var_22_20 = var_22_20.emit
								BaseUI = var_1_10007

								var_22_20(var_22_21, var_1_10007.ON_AWARD, {
									animation = true,
									items = var_22_3.items
								})
							end
						else
							GAME = var_22_20

							if var_22_1 == var_22_20.FINISH_QUEUE_TECHNOLOGY_DONE then
								local var_22_22 = arg_22_0.viewComponent

								var_4.OnUpdateTechnology(var_22_22)

								local var_22_23 = {}

								ipairs = var_22_2

								for iter_22_0, iter_22_1 in var_22_2(var_22_3.dropInfos) do
									if #iter_22_1 > 0 then
										table = var_10

										var_10.insert(var_22_23, function(arg_27_0)
											local var_27_0 = arg_22_0.viewComponent
											local var_27_1 = var_1.emit

											BaseUI = var_2_10004

											var_27_1(var_27_0, var_2_10004.ON_AWARD, {
												animation = true,
												items = iter_22_1,
												removeFunc = arg_27_0
											})
								...
								var_5(var_22_23, function()
									...
									if var_0.getActivateTechnology(var_28_0) and var_0:isCompleted() then
										...
										var_28_2(var_28_1, var_2_10004.FINISH_TECHNOLOGY, {
											id = var_0.id,
...
function var_0_1.HandleClassMaxLevel(arg_29_0, arg_29_1, arg_29_2, arg_29_3, arg_29_4)
	...
	local var_29_1 = arg_29_1:getName()

	getSkillName = var_1_10009

	local var_29_2 = var_1_10005(var_29_0, var_29_1, var_1_10009(arg_29_3), arg_29_4)
	local var_29_3 = arg_29_1
	local var_29_4 = arg_29_1.getSkillList(var_29_3)

	_ = var_29_0

	if var_29_0.all(var_29_4, function(arg_30_0)
		...
		local var_29_5 = var_29_2

		i18n = var_29_3

		local var_29_6 = var_29_5 .. var_29_3("tactics_continue_to_learn_other_ship_skill")

		pg = var_29_3

		local var_29_7 = var_29_3.MsgboxMgr.GetInstance()

		var_29_3.ShowMsgBox(var_29_7, {
			modal = true,
			hideClose = true,
			content = var_29_6,
			onYes = function()
				...
				local var_31_2 = var_2_10003.GO_SCENE

				SCENE = var_2_10004

				var_31_1(var_31_0, var_31_2, var_2_10004.NAVALTACTICS)
		...
		local var_29_9 = var_29_8 .. var_29_3("tactics_continue_to_learn_other_skill")

		pg = var_8

		local var_29_10 = var_8.MsgboxMgr.GetInstance()

		var_8.ShowMsgBox(var_29_10, {
			modal = true,
			hideClose = true,
			content = var_29_9,
			onYes = function()
				...
				var_32_1(var_32_0, var_32_2, var_2_10004.NAVALTACTICS, {
					shipToLesson = {
