...
function var_0_0.AddItem(arg_3_0, arg_3_1)
	...
	if #arg_3_0.childs <= 0 then
		...
		RollingCircleItem = var_1_10005
		var_3_0 = var_1_10005.New(var_3_2, var_3 + 1, arg_3_1)
		...
		var_3_0.SetPrev(var_1_10009, var_3_3)

		var_1_10009 = var_3_0

		var_3_0.SetNext(var_1_10009, var_3_4)

		var_1_10009 = var_3_4

		var_3_4.SetPrev(var_1_10009, var_3_0)

		var_1_10009 = var_3_3

		var_3_3.SetNext(var_1_10009, var_3_0)

		var_1_10009 = var_3_0

		var_3_0.Init(var_1_10009)
	end
	...
	var_4(var_3_5, var_3_6, var_3_7, var_1_10009)
...
function var_0_0.ScrollTo(arg_5_0, arg_5_1)
	...
	if var_2.detect(arg_5_0.childs, function(arg_6_0)
		...
		triggerButton = var_1_10003

		var_1_10003(var_2._tr)
	end
...
function var_0_0.AddDragListener(arg_7_0)
	...
	local function var_7_1()
		...
		local var_9_0 = var_2_10000.detect(arg_7_0.childs, function(arg_10_0)
			...
			return var_10_1(var_10_0, var_4.GetCenterIndex(var_10_2))
		end)
...
function var_0_0.GetCenterIndex(arg_11_0)
	...
	return var_1_10003.min(4, var_11_1)
end
...
function var_0_0.AddVerticalDrag(arg_14_0, arg_14_1, arg_14_2)
	...
	var_14_0:AddDragFunc(function(arg_16_0, arg_16_1)
		...
		local var_16_2 = var_16_1(var_2_10005.floor(var_16_0 / var_14_1))
...
function var_0_0.Dispose(arg_18_0)
	...
	var_1(var_3(arg_18_0.parent, "EventTriggerListener"))
