...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_4 = var_5.Find(var_1_3, "Text")

	i18n = var_6

	var_3(var_1_4, var_6("commission_label_unlock_tech_tip"))
...
function var_0_1.Init(arg_3_0)
	...
	if var_1_10001 then
		...
		var_1_10001(var_3.Find(var_3_0, "frame"), false)
		...
		var_1_10001(var_3.Find(var_3_1, "frame"), true)
		...
		local var_3_2 = arg_3_0:CanOpen()

		setActive = var_1_10002

		var_1_10002(arg_3_0.lockTF, not var_3_2)

		setGray = var_1_10002

		var_1_10002(arg_3_0.toggle, not var_3_2, true)

		setActive = var_1_10002

		var_1_10002(arg_3_0.foldFlag, false)

		setActive = var_1_10002

		var_1_10002(arg_3_0.goBtn, var_3_2)
...
function var_0_1.OnFlush(arg_4_0)
	...
	TechnologyConst = var_4_0
	var_4_2.leisure = var_4_0.QUEUE_TOTAL_COUNT + 1
	ipairs = var_3
	...
	var_3(var_5.Find(var_4_3, "frame/counter"), function(arg_5_0)
...
function var_0_1.UpdateListItem(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	local var_6_4 = var_6_0.getConfig(var_6_3, "time")

	if var_6_0.time == 0 then
		setText = var_6_3

		local var_6_5 = arg_6_3:Find("unlock/desc/name_bg/Text")

		i18n = var_1_10011

		var_6_3(var_6_5, var_1_10011("commission_idle"))

		onButton = var_6_3

		local var_6_6 = arg_6_0
		local var_6_7 = arg_6_3
		local var_6_8 = arg_6_3.Find(var_6_7, "unlock/leisure/go_btn")
		...
		var_6_3(var_6_6, var_6_8, var_6_9, var_6_7)

		onButton = var_6_3

		local var_6_10 = arg_6_0
		local var_6_11 = arg_6_3
		...
		var_6_3(var_6_10, var_6_11, var_6_12, var_6_7)
	elseif var_6_2 < var_7 - var_6_4 then
		arg_6_0:UpdateTechnology(arg_6_3, var_6_0)

		setText = var_6_3

		local var_6_13 = arg_6_3:Find("unlock/ongoging/time")

		pg = var_11

		local var_6_14 = var_11.TimeMgr.GetInstance()

		var_6_3(var_6_13, var_11.DescCDTime(var_6_14, var_6_4))
	elseif var_6_2 < var_7 then
		...
		if var_6_0:finishCondition() then
			var_6_3 = arg_6_3:Find("unlock/finished/finish_btn")
			onButton = var_9

			local var_6_15 = arg_6_0
			local var_6_16 = var_6_3
			...
			local function var_6_17()
				...
				var_9_1(var_9_0, var_2_10003.ON_TECH_FINISHED, {
					id = var_6_0.id,
			...
			var_9(var_6_15, var_6_16, var_6_17, var_1_10014)

			onButton = var_9

			local var_6_18 = arg_6_0
			local var_6_19 = arg_6_3
			...
			var_9(var_6_18, var_6_19, var_6_20, var_1_10014)
		else
			setText = var_6_3

			var_6_3(arg_6_3:Find("unlock/ongoging/time"), "00:00:00")
		end
	end

	setActive = var_6_3

	var_6_3(arg_6_3:Find("unlock"), true)

	setActive = var_6_3

	var_6_3(arg_6_3:Find("lock"), false)

	setActive = var_6_3

	var_6_3(arg_6_3:Find("unlock/leisure"), not var_6_0:isActivate())

	setActive = var_6_3

	local var_6_21 = arg_6_3:Find("unlock/ongoging")
	local var_6_22

	if var_6_0:isActivate() then
		var_6_22 = not var_6_0:isCompleted()
	end

	var_6_3(var_6_21, var_6_22)

	setActive = var_6_3

	var_6_3(arg_6_3:Find("unlock/finished"), var_6_0:isCompleted())

	setActive = var_6_3

	local var_6_23 = arg_6_3:Find("unlock/desc/task_bg")
	local var_6_24

	if var_6_0:isActivate() then
		var_6_24 = var_6_0:getConfig("condition") > 0
	end

	var_6_3(var_6_23, var_6_24)
...
function var_0_1.AddTimer(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_2 = var_11_1(var_11_0, var_6(var_1_10008))
	local var_11_3 = arg_11_0.timers
	local var_11_4 = arg_11_1.id

	Timer = var_6
	var_11_3[var_11_4] = var_6.New(function()
		local var_12_0 = arg_11_1
		local var_12_1 = var_0.getFinishTime(var_12_0)

		pg = var_2_10001

		local var_12_2 = var_2_10001.TimeMgr.GetInstance()
		...
		if var_12_1 - var_1.GetServerTime(var_12_2) > 0 then
			...
			local var_12_4 = var_12_0.TimeMgr.GetInstance()
...
function var_0_1.UpdateTechnology(arg_14_0, arg_14_1, arg_14_2)
	...
	if 0 < var_14_0 then
		...
		local var_14_4 = arg_14_1:Find("unlock/desc/task_bg/Text")

		shortenString = var_9

		var_6(var_14_4, var_9(var_14_3, 10))
	end
...
function var_0_1.GetList(arg_15_0)
	...
	local var_15_2 = var_1_10002.SystemOpenMgr.GetInstance()
	local var_15_3 = var_2.isOpenSystem(var_15_2, var_15_1.level, "TechnologyMediator")
	local var_15_4 = arg_15_0.list

	if var_15_3 then
		TechnologyConst = var_15_2

		local var_15_5

		if not (var_15_2.QUEUE_TOTAL_COUNT + 1) then
			var_15_5 = 0
		end
...
function var_0_1.OnSkip(arg_16_0)
	...
	var_16_1(var_16_0, var_1_10004.ON_ACTIVE_TECH)
...
function var_0_1.OnFinishAll(arg_17_0)
	...
	if var_1_10001(var_1_10003).queue[1] then
		...
		if var_2.isCompleted(var_17_0) then
			...
			var_17_2(var_17_1, var_1_10005.ON_TECH_QUEUE_FINISH)
	...
	do
		...
		var_17_5(var_17_4, var_1_10006.ON_TECH_FINISHED, {
			id = var_17_3.id,
