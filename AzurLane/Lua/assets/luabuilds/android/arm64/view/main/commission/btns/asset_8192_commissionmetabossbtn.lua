...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_6
	Text = var_1_10008
	arg_1_0.text = var_1_2(var_1_1, var_6(var_1_10008))
...
function var_0_0.Flush(arg_3_0)
	...
	local function var_3_3()
		if var_3_0 ~= var_0_0.STATE_LOCK then
			...
			var_4_1(var_4_0, var_2_10003.GO_META_BOSS)
		end
...
function var_0_0.SetLeftTime(arg_5_0)
	...
	arg_5_0.timer = var_1.New(function()
		...
		local var_6_2 = var_2_10002.TimeMgr.GetInstance()

		var_6_1.text = var_2.DescCDTimeForMinute(var_6_2, var_0)
