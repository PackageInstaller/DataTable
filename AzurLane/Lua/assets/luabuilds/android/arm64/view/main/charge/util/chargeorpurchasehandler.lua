...
function var_0_1.FetchFirstChargeIds(arg_6_0, arg_6_1, arg_6_2)
	...
	if var_6_1:ShouldRefreshChargeList() then
		...
		var_6_4(var_6_3, var_1_10008.GET_CHARGE_LIST, {
			callback = var_6_2
		})
	else
		var_6_2()
...
function var_0_1.PurchaseItem(arg_9_0, arg_9_1)
	...
	var_1_10003(var_9_1 == var_1_10006)

	Item = var_1_10003

	local var_9_2 = var_1_10003.getConfigData(var_9_0.id)
	local var_9_3 = {
		isLocalPrice = false,
		isChargeType = false,
		isMonthCard = false,
	...
	i18n = var_5
	var_9_3.tipExtra = var_5("charge_title_getitem")
	var_9_3.extraItems = arg_9_1:GetDropList()
	var_9_3.price = arg_9_1:getConfig("resource_num")
	var_9_3.tagType = arg_9_1:getConfig("tag")

	function var_9_3.onYes()
		local var_10_0 = arg_9_0

		var_0.Purchase(var_10_0, var_9_2.name, arg_9_1)

		return
	end

	arg_9_0:ShowMsgBox(var_9_3)
...
function var_0_1.ChargeMonthCardAndGiftPack(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_11 = arg_11_2.isMonthCard(var_11_10)
	local var_11_12 = arg_11_2:getConfig("descrip_extra")

	table = var_11_10

	local var_11_13 = not var_11_10.contains(arg_11_1, arg_11_2.id) and arg_11_2:firstPayDouble() and 4 or arg_11_2:getConfig("tag")
	local var_11_14 = {
		isChargeType = true,
		commodity = arg_11_2,
...
function var_0_1.ChargeGem(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_1 = arg_13_2.getConfig(var_13_0, "money")
	local var_13_2 = arg_13_2:getConfig("gem")

	table = var_13_0

	local var_13_3 = not var_13_0.contains(arg_13_1, arg_13_2.id) and arg_13_2:firstPayDouble() and 4 or arg_13_2:getConfig("tag")
	...
	local var_13_7 = arg_13_2.getConfig(var_13_6, "money")
	local var_13_8 = arg_13_2:IsLocalPrice()

	i18n = var_13_6

	local var_13_9 = var_13_6("charge_start_tip", var_13_1, var_13_2)
	local var_13_10 = {
		isChargeType = true,
		commodity = arg_13_2,
...
function var_0_1.ShowMsgBox(arg_15_0, arg_15_1)
	...
	ChargeItemPanelMediator = var_1_10008
	var_15_3.mediator = var_1_10008
	ChargeItemPanelLayer = var_1_10008
...
function var_0_1.Purchase(arg_16_0, arg_16_1, arg_16_2)
	...
	i18n = var_1_10007
	var_16_2.content = var_1_10007("charge_scene_buy_confirm", arg_16_2:getConfig("resource_num"), arg_16_1)
	...
	function var_16_2.onYes()
		...
		var_17_1(var_17_0, var_2_10003.SHOPPING, {
			count = 1,
			id = arg_16_2.id
		})
...
function var_0_1.Charge(arg_18_0, arg_18_1)
	...
	if var_1_10002.isNeedSetBirth() then
		...
		ChargeBirthdayMediator = var_1_10008
		var_18_2.mediator = var_1_10008
		ChargeBirthdayLayer = var_1_10008
		var_18_2.viewComponent = var_1_10008
		var_18_2.data = {}

		var_18_1(var_18_0, var_1_10005(var_18_2))
	else
		pg = var_18_1
		...
		var_18_4(var_18_3, var_1_10005.CHARGE_OPERATION, {
			shopId = arg_18_1.id
		})
	end
...
function var_0_1.addSubLayers(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	var_1_10004(var_1_10006(var_19_0, var_1_10009), "should be an instance of Context")

	getProxy = var_1_10004
	ContextProxy = var_6

	local var_19_1 = var_1_10004(var_6)
	...
	var_19_4(var_19_3, var_1_10009.LOAD_LAYERS, {
