...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_6 = var_3.Find(var_2_5, "titles/rank_title")

	i18n = var_4

	var_2_4(var_2_6, var_4("vote_label_rank"))

	setText = var_2_4

	local var_2_7 = arg_2_0._tf
	local var_2_8 = var_3.Find(var_2_7, "titles/votes")

	i18n = var_4

	var_2_4(var_2_8, var_4("word_votes"))

	setText = var_2_4

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_3.Find(var_2_9, "tip")

	i18n = var_4

	var_2_4(var_2_10, var_4("vote_label_rank_fresh_time_tip"))
...
function var_0_1.Update(arg_5_0, arg_5_1)
	...
	var_2(var_5_0, var_5_1 == var_1_10006.VOTE_STAGE)
	...
	var_2(var_5_2, var_5_3 ~= var_6.VOTE_STAGE)

	setActive = var_2

	local var_5_4 = arg_5_0._tf
	local var_5_5 = var_4.Find(var_5_4, "tip")
	local var_5_6 = arg_5_0.phase

	VoteGroup = var_5_4

	var_2(var_5_5, var_5_6 == var_5_4.VOTE_STAGE)
	arg_5_0:UpdateList()
...
function var_0_1.NewCard(arg_9_0, arg_9_1)
	...
	return {
		Update = function(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
			...
			local var_10_1 = var_6.Find(var_10_0, "number")

			setColorStr = var_2_10007

			var_2_10004(var_10_1, var_2_10007(arg_10_1, arg_10_3))

			setText = var_2_10004

			local var_10_2 = var_9_0
			local var_10_3 = var_6.Find(var_10_2, "name")

			setColorStr = var_7
			shortenString = var_9

			var_2_10004(var_10_3, var_7(var_9(arg_10_0:getShipName(), 6), arg_10_3))

			setText = var_2_10004

			local var_10_4 = var_9_0
			local var_10_5 = var_6.Find(var_10_4, "Text")

			setColorStr = var_7

			var_2_10004(var_10_5, var_7(arg_10_2, arg_10_3))
