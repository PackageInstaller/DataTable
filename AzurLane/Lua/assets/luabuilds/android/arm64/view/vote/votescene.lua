...
function var_0_1.init(arg_3_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.title = var_3_2(var_3_1, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.subTitle = var_3_8(var_3_7, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.tagtimeTF = var_3_11(var_3_10, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_3_0.numberTxt = var_3_21(var_3_20, var_4(var_1_10006))
	...
	local var_3_24 = var_3.Find(var_3_23, "main/right_panel/filter_bg/search/hold")

	i18n = var_4

	var_1(var_3_24, var_4("dockyard_search_holder"))

	local var_3_25 = {}

	ShipIndexConst = var_1_10002
	var_3_25.typeIndex = var_1_10002.TypeAll
...
function var_0_1.didEnter(arg_5_0)
	...
	arg_5_0.shipsPage = var_5_4(var_7.Find(var_5_5, "main/right_panel"), arg_5_0.event, arg_5_0.contextData)
	...
	arg_5_0.rankPage = var_5_7(var_7.Find(var_5_8, "main/left_panel"), arg_5_0.event, arg_5_0.contextData)
	...
	var_5(var_5_9, var_5_10, var_5_11, var_10)
	...
	local function var_5_14()
		...
		local var_10_2 = var_2_10001.MsgboxMgr.GetInstance()
		local var_10_3 = var_1.ShowMsgBox
		local var_10_4 = {}

		MSGBOX_TYPE_HELP = var_2_10005
		var_10_4.type = var_2_10005
		pg = var_2_10005
		var_10_4.helps = var_2_10005.gametip[var_10_1].tip
	...
	var_5(var_5_12, var_5_13, var_5_14, var_10)
	...
	local function var_5_17()
		...
		Clone = var_2_10001
		var_11_0.indexDatas = var_2_10001(arg_5_0.ShipIndex)
		...
		VoteMediator = var_2_10004

		var_11_2(var_11_1, var_2_10004.ON_FILTER, var_11_0)
	...
	var_5(var_5_15, var_5_16, var_5_17, var_10)
	...
	local function var_5_20()
		...
		var_14_1(var_14_0, var_2_10003.ON_SCHEDULE)
	...
	var_5(var_5_18, var_5_19, var_5_20, var_10)
	...
	var_5(var_5_21, var_5_22, var_5_23, var_10)
	...
	var_5(arg_5_0, arg_5_0.ticketBtn, function()
		...
		var_16_1(var_16_0, var_2_10003.OPEN_EXCHANGE)
...
function var_0_1.CheckPaintingRes(arg_17_0, arg_17_1, arg_17_2)
	...
	for iter_17_0, iter_17_1 in var_17_0({
		var_17_1
	}) do
...
function var_0_1.OnVote(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_3 = arg_18_0:GetVotes()

	defaultValue = var_18_1
	arg_18_2 = var_18_1(arg_18_2, false)

	local var_18_4 = arg_18_0.voteMsgBox

	var_6.ExecuteAction(var_18_4, "Open", var_18_0, var_18_2, var_18_3, arg_18_2, function(arg_19_0)
		local var_19_0 = arg_18_0.contextData.voteGroup
		local var_19_1 = var_1.GetStage(var_19_0)

		VoteGroup = var_2_10002

		if var_19_1 ~= var_2_10002.VOTE_STAGE then
			pg = var_19_1
			...
			var_19_3(var_19_2, var_2_10004("common_activity_end"))
		...
		if arg_19_0 <= var_18_3 then
			...
			var_19_5(var_19_4, var_2_10004.ON_VOTE, arg_18_0.contextData.voteGroup.id, var_18_0.group, arg_19_0)
		else
			pg = var_19_5
			...
			var_19_7(var_19_6, var_2_10004("vote_not_enough"))
		end
...
function var_0_1.initShips(arg_22_0)
	...
	local var_22_2 = var_1_10002(arg_22_0.search)
	...
	for iter_22_0, iter_22_1 in var_22_0(var_22_1) do
		...
		if var_22_3 == var_1_10009.TypeAll then
			...
			if var_22_4 == var_1_10009.RarityAll then
				...
				if var_22_5 == var_1_10009.CampAll and iter_22_1:IsMatchSearchKey(var_22_2) then
					table = var_8
	...
	if var_22_10 == var_8.TypeAll then
		local var_22_11 = arg_22_0.ShipIndex.campIndex

		ShipIndexConst = var_8

		if var_22_11 == var_8.CampAll then
			local var_22_12 = arg_22_0.ShipIndex.rarityIndex

			ShipIndexConst = var_8

			if var_22_12 == var_8.RarityAll then
				var_22_13 = false
