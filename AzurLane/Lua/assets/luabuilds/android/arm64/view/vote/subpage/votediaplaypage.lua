...
function var_0_1.OnInit(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.numberTxt = var_2_1(var_2_0, var_4(var_1_10006))
	findTF = var_1
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.enNameTxt = var_2_5(var_2_4, var_4(var_1_10006))
	findTF = var_1
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.descTxt = var_2_7(var_2_6, var_4(var_1_10006))
	findTF = var_1
	...
	arg_2_0.valueInput = var_2_9(var_2_8, var_4(var_1_10006))
	findTF = var_1
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.rankTxt = var_2_11(var_2_10, var_4(var_1_10006))
	findTF = var_1
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.votesTxt = var_2_13(var_2_12, var_4(var_1_10006))
	findTF = var_1
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.shiptypeTxt = var_2_15(var_2_14, var_4(var_1_10006))
	findTF = var_1
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.nationImg = var_2_17(var_2_16, var_4(var_1_10006))
	findTF = var_1
...
function var_0_1.Open(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
	...
	var_6(var_3_0, var_9(arg_3_0.valueInput), function()
		getInputText = var_2_10000
		go = var_2_10002

		local var_4_0 = var_2_10000(var_2_10002(arg_3_0.valueInput))

		tonumber = var_2_10001

		if var_2_10001(var_4_0) < 1 then
			arg_3_0.value = 1
		elseif var_1 > arg_3_0.maxValue then
			local var_4_1 = arg_3_0

			math = var_3
			var_4_1.value = var_3.max(1, arg_3_0.maxValue)
		else
			arg_3_0.value = var_1
		end
...
function var_0_1.Update(arg_6_0, arg_6_1)
	...
	local var_6_1 = arg_6_1.getNationality(var_6_0)
	local var_6_2

	if var_6_1 then
		LoadSprite = var_6_0

		local var_6_3 = "prints/"

		nation2print = var_1_10007
		var_6_2 = var_6_0(var_6_3 .. var_1_10007(var_6_1) .. "_0")
	else
		GetSpriteFromAtlas = var_6_0
		var_6_2 = var_6_0("ui/VoteUI_atlas", "nation")
	end

	arg_6_0.nationImg.sprite = var_6_2
	...
	var_4(var_6_4, var_6_5, var_6_6, var_1_10009)

	onButton = var_4

	local var_6_7 = arg_6_0
	local var_6_8 = arg_6_0.miunsBtn
	...
	var_4(var_6_10, var_6_11, var_6_12, var_1_10009)

	onButton = var_4

	local var_6_13 = arg_6_0
	local var_6_14 = arg_6_0.submitBtn
