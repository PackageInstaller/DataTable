...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("view.activity.Panels.PtAwardWindow"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_3 = var_5.Find(var_1_2, "frame/panel/list")
	local var_1_4 = arg_1_0._tf

	arg_1_0.UIlist = var_1_1(var_1_3, var_6.Find(var_1_4, "frame/panel/list/tpl"))
...
function var_0_1.UpdateTitle(arg_2_0, arg_2_1)
	if arg_2_1 == var_0_1.TYPE_CURR then
		...
		i18n = var_1_10003
		arg_2_0.cntTitle = var_1_10003("vote_lable_curr_title_2")
	...
	elseif arg_2_1 == var_0_1.TYPE_ACC then
		...
		i18n = var_1_10003
		arg_2_0.cntTitle = var_1_10003("vote_lable_acc_title_2")
