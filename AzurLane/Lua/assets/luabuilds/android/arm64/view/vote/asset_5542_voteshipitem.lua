...
function var_0_0.flush(arg_3_0)
	...
	var_1_10001(var_3_0 .. var_4.getPainting(var_3_1), function(arg_4_0)
		IsNil = var_2_10001
	...
	if var_1_10001 == var_1_10002 then
		...
		var_1_10001(var_3_2, var_4.getShipName(var_3_3))
	else
		setText = var_1_10001
		go = var_3_2
		...
		var_1_10001(var_3_4, var_4(var_6.getShipName(var_3_5), 5))
	end
