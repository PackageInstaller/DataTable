...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.SUBMIT_TASK, function()
		...
		if not var_2_1(var_2_0, var_2_10003.VOTE_ENTRANCE_ACT_ID) or var_0:isEnd() then
			pg = var_2_10001

			local var_2_2 = var_2_10001.TipsMgr.GetInstance()
			local var_2_3 = var_1.ShowTips

			i18n = var_2_10004

			var_2_3(var_2_2, var_2_10004("common_activity_notStartOrEnd"))
		...
		var_2_6(var_2_5, var_2_10005.SUBMIT_TASK, var_2_4)
	...
	arg_1_0:bind(var_0_1.ON_VOTE, function()
		...
		if not var_0.GetOpeningNonFunVoteGroup(var_3_0) then
			...
			local var_3_1 = var_2_10001.TipsMgr.GetInstance()
			local var_3_2 = var_1.ShowTips

			i18n = var_2_10004

			var_3_2(var_3_1, var_2_10004("vote_tip_area_closed"))
		...
		local var_3_5 = var_2_10004.GO_SCENE

		SCENE = var_2_10005

		var_3_4(var_3_3, var_3_5, var_2_10005.VOTE, {
			voteGroup = var_0
		})
	...
	arg_1_0:bind(var_0_1.ON_FUN_VOTE, function()
		...
		if not var_0.GetOpeningFunVoteGroup(var_4_0) then
			...
			local var_4_1 = var_2_10001.TipsMgr.GetInstance()
			local var_4_2 = var_1.ShowTips

			i18n = var_2_10004

			var_4_2(var_4_1, var_2_10004("vote_tip_area_closed"))
		...
		local var_4_5 = var_2_10004.GO_SCENE

		SCENE = var_2_10005

		var_4_4(var_4_3, var_4_5, var_2_10005.VOTE, {
			voteGroup = var_0
		})
	...
	arg_1_0:bind(var_0_1.ON_EXCHANGE, function()
		...
		if not var_0.GetOpeningNonFunVoteGroup(var_5_0) then
			...
			local var_5_1 = var_2_10001.TipsMgr.GetInstance()
			local var_5_2 = var_1.ShowTips

			i18n = var_2_10004

			var_5_2(var_5_1, var_2_10004("common_activity_notStartOrEnd"))
	...
	arg_1_0:bind(var_0_1.ON_SCHEDULE, function()
		...
		var_6_1(var_6_0, var_6_2, var_2_10004.VOTESCHEDULE)
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_1 == var_9_0.SUBMIT_ACTIVITY_TASK_DONE then
		...
		var_9_7(var_9_6, var_1_10007.ON_ACHIEVE, var_9_2.awards, nil)
	else
		GAME = var_9_7

		if var_9_1 == var_9_7.ON_NEW_VOTE_DONE then
			...
			if var_9_1 == var_4.STORY_END then
