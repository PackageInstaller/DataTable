...
local var_0_0 = "GetPrefabRequestPackage"
...
function var_0_1.__call(arg_1_0)
	...
	var_3.GetPrefab(var_1_2, var_1_0, var_1_1, true, function(arg_2_0)
		if arg_1_0.stopped then
			PoolMgr = var_1

			local var_2_0 = var_1.GetInstance()

			var_1.ReturnPrefab(var_2_0, var_1_0, var_1_1, arg_2_0, true)
