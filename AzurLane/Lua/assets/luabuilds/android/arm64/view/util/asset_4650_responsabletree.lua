...
function var_0_0.Response(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if var_0_2 <= var_3_0 then
		...
		var_3_0("Exceed the Iterate Limitation, Might have inherit loop")
	...
	if not not var_4(arg_3_0._listeners) then
		table = var_3_1
		var_3_1 = var_3_1.concat(arg_3_2, ".")
		ipairs = var_6
		...
		for iter_3_0, iter_3_1 in var_6(arg_3_0._listeners) do
			...
			for iter_3_2, iter_3_3 in var_1_10012(iter_3_1.keys) do
				...
				if not var_18.match(var_3_1, var_3_3) and (not var_3_2 or not var_3_2.strict) then
					local var_3_4 = "^" .. iter_3_3 .. "%."

					string = var_19
					var_3_5 = var_19.match(var_3_1, var_3_4)
				end

				local var_3_6

				if var_3_5 then
					var_3_6 = var_3_6 or var_3_2 and not var_3_2.NoAffectOnTransparent
	...
	if var_3_6 then
		...
		if not var_3_1(arg_3_0._parents) then
			return
		end

		table = var_3_1

		local var_3_7 = var_3_1.getCount(arg_3_0._parents)
		...
		for iter_3_4, iter_3_5 in var_6(arg_3_0._parents) do
			...
			if 0 < var_3_7 then
				...
				var_1_10012(var_3_9, var_3_10, iter_3_3.keyof(iter_3_4:GetRawData(), arg_3_0))
				iter_3_4:Response(arg_3_1, var_3_8, arg_3_3)
			end
		end
...
function var_0_0.DoAction(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	for iter_4_0, iter_4_1 in var_1_10006(arg_4_1.keys) do
		...
		while var_1_10012 and var_1_10013 < #var_1_10011 do
			var_1_10012 = var_1_10012[var_1_10011[var_1_10013 + 1]]
		end
	...
	if arg_4_1.settings and arg_4_1.settings.useOldRef then
		...
		local var_4_2 = var_6.shallowCopy(var_4_0)
		...
		for iter_4_2, iter_4_3 in var_7(arg_4_1.keys) do
			...
			if var_1_10013.equal(var_1_10012, arg_4_2) then
				var_4_2[iter_4_2] = arg_4_3[1]

				break
			end
		end

		arg_4_1.listener(var_4_1, var_4_0, var_4_2, arg_4_3[2])
	else
		local var_4_3 = arg_4_1.listener

		unpack = var_8

		var_4_3(var_8(var_4_0, 1, var_4_1))
	end
...
function var_0_0.insert(arg_13_0, ...)
	...
	if 1 < var_13_0 then
		...
		var_3(var_13_2, var_13_3 .. var_1_10007(var_13_0))
