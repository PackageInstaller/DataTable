...
UnityEngine = var_0_10002

local var_0_2 = var_0_10002.Vector2
local var_0_3 = 1e-06
...
local function var_0_6(arg_3_0, arg_3_1)
	...
	return var_1_10003.band(var_3_0, 1) > 0
end
...
local function var_0_9(arg_6_0)
	...
	for iter_6_0 = 1, #arg_6_0 do
		...
		var_1_10009.insert(var_6_1, iter_6_0)
		...
		Vector2 = var_1_10013
		var_6_5[2] = var_1_10013.Distance(arg_6_0[iter_6_0], arg_6_0[var_6_3])

		var_1_10009(var_6_4, var_6_5)
	end
	...
	var_5.sort(var_6_2, var_6_6)

	while #var_6_1 > 2 and #var_6_2 > 0 do
		local var_6_7 = var_6_2[1][1]

		table = var_6_8

		local var_6_8 = var_6_8.indexof(var_6_1, var_6_7)
		local var_6_9 = var_0_4(var_6_8 + 1, #var_6_1)
		local var_6_10 = var_0_4(var_6_8 + 2, #var_6_1)
		local var_6_11 = var_6_1[var_6_9]
		local var_6_12 = var_6_1[var_6_10]
		local var_6_13

		if var_0_1.VectorCross(arg_6_0[var_6_7], arg_6_0[var_6_12], arg_6_0[var_6_11]) > 0 and not var_0_8(arg_6_0[var_6_7], arg_6_0[var_6_12], arg_6_0, var_6_1, var_6_10, var_6_8) then
			table = var_6_13

			var_6_13.insert(var_6_0, var_6_7)

			table = var_6_13

			var_6_13.insert(var_6_0, var_6_11)

			table = var_6_13

			var_6_13.insert(var_6_0, var_6_12)

			var_6_13 = var_6_1[var_0_4(var_6_8 - 1, #var_6_1)]

			local var_6_14 = var_6_1[var_0_4(var_6_10 + 1, #var_6_1)]

			for iter_6_1 = #var_6_2, 1, -1 do
				if var_6_2[iter_6_1][1] == var_6_11 or var_18 == var_6_13 then
					table = var_19

					var_19.remove(var_6_2, iter_6_1)
				end
			end

			table = var_14

			local var_6_15 = var_14.insert
			local var_6_16 = var_6_2
			local var_6_17 = {
				var_6_13
			}

			Vector2 = var_18
			var_6_17[2] = var_18.Distance(arg_6_0[var_6_13], arg_6_0[var_6_12])

			var_6_15(var_6_16, var_6_17)

			table = var_6_15

			local var_6_18 = var_6_15.insert
			local var_6_19 = var_6_2
			local var_6_20 = {
				var_6_7
			}

			Vector2 = var_18
			var_6_20[2] = var_18.Distance(arg_6_0[var_6_7], arg_6_0[var_6_14])

			var_6_18(var_6_19, var_6_20)

			table = var_6_18

			var_6_18.remove(var_6_1, var_6_11)

			table = var_14

			var_14.sort(var_6_2, var_6_6)
		end

		table = var_6_13

		var_6_13.remove(var_6_2, 1)
	end
