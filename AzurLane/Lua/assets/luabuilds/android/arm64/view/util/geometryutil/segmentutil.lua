...
local function var_0_5(arg_4_0, arg_4_1)
	...
	local var_4_0 = var_1_10002.Min(arg_4_0, arg_4_1)

	Vector2 = var_1_10003

	local var_4_1 = var_1_10003.Max(arg_4_0, arg_4_1)
end
...
local function var_0_8(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	if not arg_7_3 or not (arg_7_3 - arg_7_2) then
		var_7_1 = arg_7_2 - arg_7_0
	end
...
local function var_0_9(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	if not arg_8_3 or not (arg_8_3 - arg_8_2) then
		var_8_1 = arg_8_2 - arg_8_0
	end
...
local function var_0_12(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	local var_11_0 = var_0_8(arg_11_0, arg_11_2, arg_11_1) * var_0_8(arg_11_0, arg_11_1, arg_11_3)
	local var_11_1 = var_0_4(var_4) == 0 and var_0_4(var_5)

	if var_11_0 < -var_0_1 then
		return false
	end

	return var_0_8(arg_11_2, arg_11_3, arg_11_0) * var_0_8(arg_11_2, arg_11_1, arg_11_3) >= -var_0_1, var_11_1
end

local function var_0_13(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	if var_0_8(arg_12_0, arg_12_2, arg_12_1) * var_0_8(arg_12_0, arg_12_1, arg_12_3) <= var_0_1 then
		return false
	end

	local var_12_0

	var_12_0 = var_0_8(arg_12_2, arg_12_3, arg_12_0) * var_0_8(arg_12_2, arg_12_1, arg_12_3) > var_0_1

	local var_12_1 = var_0_4(var_4)
end
...
local function var_0_15(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	local var_14_5 = var_14_2 * (arg_14_3.y - arg_14_2.y) - var_14_3 * var_14_4

	if var_0_2(var_14_5) then
		return false
	end

	local var_14_6 = arg_14_0.x * arg_14_1.y - arg_14_0.y * arg_14_1.x
	local var_14_7 = arg_14_2.x * arg_14_3.y - arg_14_2.y * arg_14_3.x
	local var_14_8 = (-var_14_4 * var_14_6 - -var_14_2 * var_14_7) / var_14_5
	local var_14_9 = (-var_9 * var_14_6 - -var_14_3 * var_14_7) / var_14_5
	local var_14_10 = true

	Vector2 = var_1_10016

	local var_14_11 = var_1_10016(var_14_8, var_14_9)
end
