...
function var_0_1.findUI(arg_6_0)
	...
	var_1(var_6_10, var_4("world_collection_back"))
...
function var_0_1.addListener(arg_8_0)
	...
	local function var_8_11()
		...
		local var_12_3 = var_2_10004.APPRECIATE_MANGA_LIKE
		local var_12_4 = {
			mangaID = var_12_0
		}

		MangaConst = var_2_10006
		var_12_4.action = var_2_10006.CANCEL_MANGA_LIKE
	...
	local function var_8_14()
		...
		local var_13_3 = var_2_10004.APPRECIATE_MANGA_LIKE
		local var_13_4 = {
			mangaID = var_13_0
		}

		MangaConst = var_2_10006
		var_13_4.action = var_2_10006.SET_MANGA_LIKE
	...
	var_1_10001(var_8_15, var_8_16, var_8_17, var_6)
	...
	var_1_10001(var_8_18, var_8_19, var_8_20, var_6)
...
function var_0_1.updatePicImg(arg_20_0)
	...
	if arg_20_0.contextData.isShowingNotRead then
		var_20_5 = "#"
		pg = var_20_3
		var_20_4 = var_20_5 .. var_20_3.cartoon[var_20_0].cartoon_id
	else
		var_20_5 = "#"
		pg = var_20_3
		var_20_4 = var_20_5 .. var_20_3.cartoon[var_20_0].cartoon_id .. "/" .. #arg_20_0.mangaIDLIst
	end
	...
	local var_20_8 = var_8.value
	local var_20_9

	go = var_10

	local var_20_10 = var_20_7(var_20_6, var_20_8, var_20_9, var_10(arg_20_0.picImg), 0, 1, 0.3)
	...
	var_20_13(var_20_12, var_8.Action(function()
...
function var_0_1.updateLikeBtn(arg_23_0)
	...
	var_1_10003(arg_23_0.likeOnBtn, var_23_1)

	setActive = var_1_10003

	var_1_10003(arg_23_0.likeOffBtn, not var_23_1)
...
function var_0_1.updateLoadingBtn(arg_24_0)
	...
	var_1_10003(arg_24_0.addLoadingBtn, not var_24_1)

	setActive = var_1_10003

	var_1_10003(arg_24_0.removeLoadingBtn, var_24_1)
...
function var_0_1.readManga(arg_25_0)
	...
	if not var_2.isMangaEverReadByID(var_25_0) then
		...
		var_25_2(var_25_1, var_1_10005.APPRECIATE_MANGA_READ, {
			mangaID = var_25_0
		})
	end
...
function var_0_1.isPicUsed(arg_26_0, arg_26_1)
	...
	return var_26_0(var_4.getMangaPicIDList(var_26_1, true), arg_26_1)
end
...
function var_0_1.removeLoadingPic(arg_27_0, arg_27_1)
	...
	var_27_4(var_27_3, iter_27_0.UPDATE_LOADING_PIC, var_27_0)
...
function var_0_1.addLoadingPic(arg_28_0, arg_28_1)
	...
	getProxy = var_1_10003
	LoadingPicProxy = var_5

	local var_28_2 = var_1_10003(var_5)
	local var_28_3 = var_3.getMangaPicIDList(var_28_2)

	table = var_28_0

	var_28_0.insert(var_28_3, arg_28_1)
	...
	var_28_5(var_28_4, var_7.UPDATE_LOADING_PIC, var_28_1)
