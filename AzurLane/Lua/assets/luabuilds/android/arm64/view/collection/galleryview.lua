...
function var_0_1.findUI(arg_6_0)
	...
	local var_6_8 = var_3.Find(var_6_7, "TextLikeOff")

	i18n = var_4

	var_1(var_6_8, var_4("loading_pic_btn"))

	setText = var_1

	local var_6_9 = arg_6_0.setFilterToggle
	local var_6_10 = var_3.Find(var_6_9, "TextLikeOn")

	i18n = var_4

	var_1(var_6_10, var_4("loading_pic_btn"))
...
function var_0_1.addListener(arg_7_0)
	...
	local function var_7_5()
		...
		function var_11_0.onCallback()
			...
			if var_12_0(var_3_10002.persistentDataPath .. "/hashes-pic.csv") then
				BundleWizard = var_0
		...
		i18n = var_2_10005
		var_11_3.content = var_2_10005("resource_verify_warn")
		var_11_3.custom = {
			var_11_0
		}
...
function var_0_1.initDownBtnPanel(arg_19_0)
	...
	var_19_1(var_1, not arg_19_0.isDownloading)

	setActive = var_19_1

	var_19_1(var_19_4, arg_19_0.isDownloading)
	...
	if arg_19_0.downloadFailed then
		...
		var_19_7(var_19_5, var_7("word_manga_updatefailure"))
	elseif arg_19_0.isDownloading then
		local var_19_6 = arg_19_0
		local var_19_8

		var_19_7, var_19_8 = arg_19_0.getGalleryDownloadProgress(var_19_6)
		setText = var_19_6
		...
		var_19_6(var_19_9, var_1_10009("word_manga_updating", var_19_7, var_19_8))
	else
		setText = var_19_7

		local var_19_10 = var_19_2

		i18n = var_7

		var_19_7(var_19_10, var_7("word_manga_checktoupdate"))
	end

	onButton = var_19_7

	local var_19_11 = arg_19_0
	local var_19_12 = var_1
	...
	var_19_7(var_19_11, var_19_12, var_19_13, var_1_10009)
...
function var_0_1.showDownloadMsgBox(arg_25_0)
	...
	HashUtil = var_1_10002

	local var_25_1 = var_1_10002.BytesToString(var_25_0)
	...
	var_25_4.type = var_1_10007
	string = var_1_10007

	local var_25_5 = var_1_10007.format

	i18n = var_1_10009
	var_25_4.content = var_25_5(var_1_10009("group_download_tip", var_25_1))
...
function var_0_1.showDownloadRetryMsgBox(arg_32_0, arg_32_1)
	if arg_32_1 then
		warning = var_1_10002
		var_1_10004 = "gallery download failed:"
		tostring = var_1_10005

		var_1_10002(var_1_10004, var_1_10005(arg_32_1))
	end
	...
	local var_32_2 = var_1_10004.MsgboxMgr.GetInstance()
	local var_32_3 = var_4.ShowMsgBox
	local var_32_4 = {}

	MSGBOX_TYPE_NORMAL = var_1_10008
	var_32_4.type = var_1_10008
	i18n = var_1_10008

	local var_32_5 = "file_down_mgr_error"
	local var_32_6 = ""

	tostring = var_1_10012
	var_32_4.content = var_1_10008(var_32_5, var_32_6, var_1_10012(arg_32_1 or ""))
	var_32_4.onYes = var_32_1
	var_32_4.onNo = var_32_0
	var_32_4.onClose = var_32_0
...
function var_0_1.getPicInfoForShowByIndex(arg_37_0, arg_37_1)
	...
	elseif var_2 == false then
		...
		var_1_10003(var_37_0, var_37_1 .. var_1_10007(arg_37_1))
	end
...
function var_0_1.filterPicInfoForShow(arg_40_0)
	...
	for iter_40_0, iter_40_1 in var_2(var_1_10004.gallery_config.all) do
		...
		if var_7.getPicExistStateByID(var_40_1, iter_40_1) then
			...
			var_40_0[var_40_2] = var_1_10008(var_10.TYPE_GALLERY, iter_40_1)
		else
...
function var_0_1.filterPicInfoForShowBySet(arg_42_0)
	...
	for iter_42_0, iter_42_1 in var_1_10004(arg_42_0.picInfoListForShow) do
		local var_42_4
