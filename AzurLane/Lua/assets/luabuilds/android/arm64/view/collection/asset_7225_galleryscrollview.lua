...
function var_0_0.initScrollCallbacks(arg_6_0)
	...
	function arg_6_0.lScrollPageSC.itemMoveCallback(arg_11_0)
		if #arg_6_0.owner.picInfoListForShow == 1 then
			...
			local var_11_3 = var_2_10005.clamp

			math = var_2_10007

			var_11_2(var_11_1, var_11_3(var_2_10007.round(arg_11_0 * (#var_1 - 1)) + 1, 1, #var_1), #var_1)
		end
...
function var_0_0.updateCard(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_2 = arg_19_0.getPicInfoForShowByIndex(var_19_1, var_19_0)
	local var_19_3 = arg_19_2
	local var_19_4 = arg_19_2.Find(var_19_3, "SelectBtn")

	setActive = var_19_1

	var_19_1(var_19_4, false)

	local var_19_5 = arg_19_2:Find("BlackMask")

	setActive = var_19_3

	var_19_3(var_19_5, false)

	local var_19_6 = arg_19_2
	local var_19_7 = arg_19_2.Find(var_19_6, "CardNum")
	local var_19_8 = var_7.Find(var_19_7, "Text")
	...
	var_19_6(var_19_8, "#" .. var_19_0)
	arg_19_0:updateCardImg(var_19_2, arg_19_2)
	arg_19_0:updateCardUsedTag(var_19_2, arg_19_2)
...
function var_0_0.updateCardImg(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_1 = arg_20_2.Find(var_20_0, "CardImg")
	local var_20_2 = arg_20_0
	local var_20_3 = arg_20_0.getPreviewPicPath(var_20_2, arg_20_1)

	GetFileName = var_20_0

	local var_20_4 = var_20_0(var_20_3)

	setActive = var_20_2

	var_20_2(var_20_1, true)

	local var_20_5 = arg_20_0.resLoader

	var_6.LoadSprite(var_20_5, var_20_3, var_20_4, var_20_1, false)
...
function var_0_0.updateCardUsedTag(arg_21_0, arg_21_1, arg_21_2)
	...
	var_1_10004(var_21_0, arg_21_0:isPicUsed(arg_21_1))
...
function var_0_0.updateEmptyCard(arg_22_0, arg_22_1)
	...
	var_22_3(var_22_6, false)

	local var_22_7 = arg_22_1:Find("UsedTag")

	setActive = var_22_5

	var_22_5(var_22_7, false)
...
function var_0_0.updateEmptyCardDownloadState(arg_23_0, arg_23_1)
	...
	var_1_10003(var_23_0, true)

	local var_23_1 = var_23_0:Find("Update")
	local var_23_2 = var_3.Find(var_23_1, "Btn")
	local var_23_3 = var_4.Find(var_23_2, "Text")
	local var_23_4 = var_3
	local var_23_5 = var_3.Find(var_23_4, "Progress")
	...
	var_23_4(var_4, not var_23_7)

	setActive = var_23_4

	var_23_4(var_23_5, var_23_7)

	if var_23_7 then
		local var_23_8 = arg_23_0.owner
		local var_23_9

		var_23_4, var_23_9 = var_23_4.getGalleryDownloadProgress(var_23_8)
		setText = var_23_8

		local var_23_10 = var_23_3

		i18n = var_1_10013

		var_23_8(var_23_10, var_1_10013("word_manga_updating", var_23_4, var_23_9))
	else
		local var_23_11 = arg_23_0.owner

		if var_23_4.isGalleryDownloadFailed(var_23_11) then
			setText = var_23_4

			local var_23_12 = var_23_3

			i18n = var_11

			var_23_4(var_23_12, var_11("word_manga_updatefailure"))
		else
			setText = var_23_4

			local var_23_13 = var_23_3

			i18n = var_11

			var_23_4(var_23_13, var_11("word_manga_checktoupdate"))
		end
	end
	...
	var_23_4(var_23_14, var_23_15, var_23_16, var_1_10013)
