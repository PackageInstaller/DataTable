...
local function var_0_2(arg_1_0)
	...
	function var_1_0.Update(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
		...
		if arg_3_0.trophy then
			...
			var_2_10005(arg_3_0.icon, not var_3_1)

			setActive = var_2_10005

			var_2_10005(arg_3_0.now, var_3_1)

			if var_3_1 then
				setLoveLetterMedal = var_2_10005

				local var_3_2 = arg_3_0.now

				var_2_10005(var_7.Find(var_3_2, "medal"), arg_3_0.trophy, {
					hideMark = true
				})

				setText = var_2_10005

				var_2_10005(arg_3_0.nameTxt, arg_3_1:getName())
			else
				LoadImageSpriteAsync = var_2_10005

				var_2_10005("medal/" .. arg_3_1:getConfig("icon"), arg_3_0.icon, true)

				setText = var_2_10005

				var_2_10005(arg_3_0.nameTxt, arg_3_1:getConfig("name"))
			end

			setActive = var_2_10005

			var_2_10005(arg_3_0.tags[1], arg_3_1:isNew())
	...
	function var_1_0.Dispose(arg_5_0)
		...
		if var_1.Find(var_5_0, "medal").childCount > 0 then
			...
			local var_5_2 = var_3.Find(var_5_1, "medal")

			var_1(var_3.GetChild(var_5_2, 0))
		end
...
local function var_0_3(arg_6_0)
	...
	local function var_6_1(arg_7_0)
		...
		local var_7_2 = var_3.Find(var_7_1, "list")
		local var_7_3 = arg_7_0._tf

		arg_7_0.uiList = var_7_0(var_7_2, var_4.Find(var_7_3, "list/tpl"))
		...
		var_2.make(var_8_0, function(arg_9_0, arg_9_1, arg_9_2)
			...
			if arg_9_0 == var_3_10003.EventUpdate then
				...
				if 0 < var_9_0 then
					...
					local var_9_4 = arg_9_2.Find(var_9_3, "now")
					local var_9_5 = var_9_1:isLoverLetter()

					setActive = var_9_3

					var_9_3(var_9_2, not var_9_5)
					...
					if var_9_5 then
						setLoveLetterMedal = var_9_3

						var_9_3(var_9_4:Find("medal"), var_9_1, {
							hideMark = true
						})
					else
						LoadImageSpriteAsync = var_9_3

						var_9_3("medal/s_" .. var_9_1:getConfig("icon"), var_9_2, true)
					end
	...
	function var_6_0.Dispose(arg_10_0)
		...
		var_1.each(var_10_0, function(arg_11_0, arg_11_1)
			if arg_11_1:Find("now/medal").childCount > 0 then
				...
				var_2(var_4.GetChild(var_11_0, 0))
			end
...
function var_0_1.OnInit(arg_13_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_13_0.totalCount = var_13_5(var_13_4, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_13_0.selectedTxt = var_13_8(var_13_7, var_4(var_1_10006))
	...
	local function var_13_13()
		if #arg_13_0.contextData.selectedMedalList == #arg_13_0.playerVO.displayTrophyList then
			...
			if var_16_0(var_2_10002.keys(arg_13_0.contextData.selectedMedalList), function(arg_17_0)
		...
		var_16_2(var_16_1, var_2_10003.ON_CHANGE_MEDAL_DISPLAY, arg_13_0.contextData.selectedMedalList)
	...
	var_1(var_13_11, var_13_12, var_13_13, var_1_10006)

	local var_13_14 = var_0_3
	local var_13_15 = arg_13_0._tf

	arg_13_0.descPanel = var_13_14(var_3.Find(var_13_15, "desc_panel"))
...
function var_0_1.OnUpdateItem(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_4 = arg_22_1 < var_22_3(var_22_2, var_1_10008(var_1_10010)).constraintCount

	if var_22_1 then
		table = var_22_2

		local var_22_5 = var_22_2.contains(arg_22_0.contextData.selectedMedalList, var_22_1.id)
...
function var_0_1.Update(arg_23_0, arg_23_1, arg_23_2)
	...
	if arg_23_0:getTotalCnt() <= 0 then
		...
		var_23_5(var_23_4, var_23_6, var_8("decoration_medal_placeholder"))
		...
		var_4(var_6.Find(var_23_8, "scrollrect"), false)
	elseif var_3 > 0 then
		...
		if var_4.GetLoaded(var_23_9) then
			...
			var_4(var_6.Find(var_23_11, "scrollrect"), true)
		end
	end
...
function var_0_1.Filter(arg_25_0)
	...
	if var_25_4(var_25_3, var_5(var_7)).constraintCount - #arg_25_0.displayVOs % var_3 == var_3 then
		var_25_5 = 0
	end
