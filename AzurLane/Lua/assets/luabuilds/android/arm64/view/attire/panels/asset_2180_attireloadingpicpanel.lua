...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.loadingPicProxy = var_1(var_1_10003)
...
function var_0_1.addListener(arg_7_0)
	...
	local function var_7_2()
		...
		var_8_4(var_8_3, var_2_10006.UPDATE_LOADING_PIC, var_8_2)
	...
	local function var_7_5()
		...
		i18n = var_2_10004
		var_10_2.content = var_2_10004("loading_quit_tip")
		...
		function var_10_2.onYes()
			...
			var_11_4(var_11_3, var_3_10006.UPDATE_LOADING_PIC, var_11_2)
		...
		diyModeOpenFlag = var_2_10001
		var_10_3.diyModeOpenFlag = var_2_10001
		closeFunc = var_2_10001
		var_10_3.callback = var_2_10001
		pg = var_2_10001

		local var_10_4 = var_2_10001.m02
		local var_10_5 = var_1.sendNotification

		GAME = var_4

		var_10_5(var_10_4, var_4.UPDATE_LOADING_PIC, var_10_3)
	...
	function var_7_6.onUpdateItem(arg_15_0, arg_15_1)
		...
		var_3(var_15_3, var_15_4, var_15_5, var_2_10008)
	...
	var_7_6(var_7_7, var_7_8, var_7_9, var_1_10006)
	...
	var_7_6(var_7_10, var_7_11, var_7_12, var_1_10006)
	...
	var_7_6(var_7_13, var_7_14, var_7_15, var_1_10006)
	...
	var_7_6(var_7_16, var_7_17, var_7_18, var_1_10006)
	...
	var_7_6(var_7_19, var_7_20, var_7_21, var_1_10006)
	...
	var_7_6(var_7_22, var_7_23, var_7_24, var_1_10006)
	...
	var_7_6(var_7_25, var_7_26, var_7_27, var_1_10006)
	...
	var_7_6(arg_7_0, arg_7_0.editBtn, function()
		if not arg_7_0.isEditMode then
			...
			if arg_7_0.isEditChanged then
				...
				i18n = var_2_10005
				var_24_4.content = var_2_10005("loading_pic_tip")
	...
	var_7_6(var_7_28, var_7_29, var_7_30, var_1_10006)
	...
	var_7_6(var_7_31, var_7_32, var_7_33, var_1_10006)
	...
	local function var_7_36()
		if #arg_7_0.curEditPicInfoList == 0 then
			...
			var_29_1(var_29_0, var_2_10003("loading_pic_min"))
		...
		for iter_29_0, iter_29_1 in var_2_10003(arg_7_0.curEditPicInfoList) do
			var_2_10008 = iter_29_1.type
			AppreciatePicConst = var_2_10009

			if var_2_10008 == var_2_10009.TYPE_GALLERY then
				table = var_2_10008

				var_2_10008.insert(var_29_3, iter_29_1.id)
			else
				var_2_10008 = iter_29_1.type
				AppreciatePicConst = var_2_10009

				if var_2_10008 == var_2_10009.TYPE_MANGA then
					table = var_2_10008

					var_2_10008.insert(var_29_4, iter_29_1.id)
				end
			end
		end
		...
		local var_29_7 = var_5.m02
		local var_29_8 = var_5.sendNotification

		GAME = var_2_10008

		var_29_8(var_29_7, var_2_10008.UPDATE_LOADING_PIC, var_29_6)
	...
	var_7_6(var_7_34, var_7_35, var_7_36, var_1_10006)
	...
	local var_7_39 = var_7_38(var_7_37, var_7_35(var_1_10006))
...
function var_0_1.initUIText(arg_32_0)
	...
	var_1_10001(var_32_0, var_1_10004("loading_title"))
	...
	var_1_10001(var_32_1, var_4("loading_picture_lack"))
	...
	var_1_10001(var_32_2, var_4("loading_start_set"))
	...
	var_1_10001(var_32_3, var_4("loading_start_set"))
	...
	var_1_10001(var_32_4, var_4("loading_title"))
	...
	var_1_10001(var_32_5, var_4("loading_pic_chosen"))
	...
	var_1_10001(var_32_6, var_4("loading_chosen_blank"))
...
function var_0_1.updateCountText(arg_35_0)
	...
	local var_35_3 = var_1_10006.format
	local var_35_4 = "%d/%d"
	local var_35_5 = var_35_1

	AppreciatePicConst = var_1_10010

	var_1_10003(var_35_2, var_35_3(var_35_4, var_35_5, var_1_10010.MAX_COUNT))
...
function var_0_1.updatePicTplForImg(arg_39_0, arg_39_1, arg_39_2)
	...
	local var_39_1 = var_1_10004(arg_39_1, "Pic/Manga/Image")
	...
	AppreciatePicConst = var_1_10009

	var_5(var_39_2, var_39_3 == var_1_10009.TYPE_GALLERY)
	...
	var_5(var_39_4, var_39_5 == var_9.TYPE_MANGA)

	local var_39_6 = arg_39_2.type

	AppreciatePicConst = var_6

	if var_39_6 == var_6.TYPE_GALLERY then
		...
		var_5(var_7(arg_39_1, "Pic/Manga"), false)
	else
		local var_39_8 = arg_39_2.type

		AppreciatePicConst = var_6

		if var_39_8 == var_6.TYPE_MANGA then
			...
			var_5(var_7(arg_39_1, "Pic/Manga"), true)
		end
	end
...
function var_0_1.updatePicTplForTag(arg_40_0, arg_40_1, arg_40_2)
	...
	local var_40_1 = var_1_10004(arg_40_1, "Tag/New")
...
function var_0_1.setImage(arg_42_0, arg_42_1, arg_42_2)
	...
	local var_42_3 = var_1_10005(var_42_2, var_1_10008(var_1_10010)).sprite

	IsNil = var_6

	if not var_6(var_42_3) then
		local var_42_4 = var_42_3.name

		string = var_42_2

		local var_42_5 = var_42_2.lower(var_42_4)
...
function var_0_1.openPicViewLayer(arg_44_0, arg_44_1)
	...
	local var_44_1 = var_1_10004.New
	local var_44_2 = {}

	AppreciatePicViewMediator = var_1_10007
	var_44_2.mediator = var_1_10007
	AppreciatePicViewLayer = var_1_10007
	var_44_2.viewComponent = var_1_10007
	var_44_2.data = {
		curPicInfo = arg_44_1,
...
function var_0_1.updateCurPicTplList(arg_46_0)
	for iter_46_0 = 1, arg_46_0.listTF.childCount do
		...
		if var_1_10006(var_46_1).name ~= "-1" then
			tonumber = var_46_0

			local var_46_2 = var_46_0(var_1_10006) + 1
...
function var_0_1.updateFilterBtn(arg_48_0)
	...
	local var_48_1 = var_1_10002(arg_48_0.openFilterBtn, "Default")
...
function var_0_1.initPicInfoList(arg_49_0)
	...
	for iter_49_0, iter_49_1 in var_1_10002(var_1_10004.gallery_config.all) do
		...
		if var_1_10008(var_1_10007) then
			...
			var_1_10008 = var_1_10008.createPicInfo
			AppreciatePicConst = var_10
			var_1_10008 = var_1_10008(var_10.TYPE_GALLERY, iter_49_1)
			table = var_9

			var_9.insert(var_49_0, var_1_10008)
		end
	end
	...
	for iter_49_2, iter_49_3 in var_2(var_4.cartoon.all) do
		...
		if var_1_10008(var_1_10007) then
			...
			var_1_10008 = var_1_10008.createPicInfo
			AppreciatePicConst = var_10
			var_1_10008 = var_1_10008(var_10.TYPE_MANGA, iter_49_3)
			table = var_9
...
function var_0_1.isDefaultPicInfo(arg_53_0, arg_53_1)
	local var_53_0 = arg_53_0:isGalleryPic(arg_53_1)

	table = var_1_10003

	local var_53_1 = var_1_10003.contains

	AppreciatePicConst = var_5

	local var_53_2 = var_53_1(var_5.getDefaultGalleryPicIDList(), arg_53_1.id)

	return var_53_0 and var_53_2
end
...
function var_0_1.getDefaultPicInfoList(arg_61_0)
	...
	for iter_61_0, iter_61_1 in var_1_10003(var_61_0) do
		...
		checkABExist = var_1_10009

		if var_1_10009(var_1_10008) then
			AppreciatePicConst = var_1_10009
			var_1_10009 = var_1_10009.createPicInfo
			AppreciatePicConst = var_11
			var_1_10009 = var_1_10009(var_11.TYPE_GALLERY, iter_61_1)
			table = var_10

			var_10.insert(var_61_1, var_1_10009)
		end
	end
...
function var_0_1.addPicInfoToEditList(arg_65_0, arg_65_1)
	...
	if var_65_0 >= var_1_10003.MAX_COUNT then
		...
		var_65_0(var_65_1, var_1_10005("loading_pic_max"))
