...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.expTxt = var_1_3(var_1_2, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Slider = var_1_10007
	arg_1_0.slider = var_1_5(var_1_4, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.levelTxt = var_1_7(var_1_6, var_5(var_1_10007))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	if arg_2_1:ExistCommander() then
		arg_2_0:UpdateCommander()
	end

	setActive = var_1_10004

	var_1_10004(arg_2_0.emptyTF, not var_3)

	setActive = var_1_10004

	var_1_10004(arg_2_0.commanderTF, var_3)
...
function var_0_0.InitAnim(arg_4_0, arg_4_1)
	...
	if var_4_3 < var_4_1 then
		...
		var_4_4.insert(arg_4_1, function(arg_5_0)
		...
		var_4_4.insert(arg_4_1, function(arg_6_0)
...
function var_0_0.Clear(arg_17_0)
	...
	if var_17_0(var_1_10003(arg_17_0.slider)) then
		LeanTween = var_17_1
		var_17_1 = var_17_1.cancel
		go = var_3

		var_17_1(var_3(arg_17_0.slider))
	end
	...
	if var_17_2(var_3(arg_17_0.expTxt)) then
		LeanTween = var_1
		...
		var_17_3(var_3(arg_17_0.expTxt))
	end
...
function var_0_0.AddExpAnim(arg_20_0, arg_20_1, arg_20_2, arg_20_3, arg_20_4, arg_20_5, arg_20_6)
	...
	var_1_10007({
		function(arg_21_0)
			...
			local var_21_1 = var_21_0(var_2_10003(arg_20_0.slider), arg_20_1, arg_20_2, var_0_1)
			...
			var_21_4(var_21_3, var_4.Action(arg_21_0))
		...
		function(arg_23_0)
			...
			local var_23_1 = var_23_0(var_2_10003(arg_20_0.expTxt), arg_20_3, arg_20_4, var_0_1)
			local var_23_2 = var_1.setOnUpdate

			System = var_4

			local var_23_3 = var_23_2(var_23_1, var_4.Action_float(function(arg_24_0)
				math = var_3_10001
			...
			var_23_4(var_23_3, var_4.Action(arg_23_0))
