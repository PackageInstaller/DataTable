...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Image = var_1_10007
	arg_1_0.style = var_1_2(var_1_1, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.levelTxt = var_1_4(var_1_3, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.expTxt = var_1_6(var_1_5, var_5(var_1_10007))
	findTF = var_2
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.expAdditionTxt = var_1_9(var_1_8, var_5(var_1_10007))
...
function var_0_0.Update(arg_2_0, arg_2_1)
	...
	if var_2_1 == var_1_10003.STATE_LOCK then
		setActive = var_2_0

		var_2_0(arg_2_0.bubble, false)
	else
		Cattery = var_2_0

		if var_2_1 == var_2_0.STATE_EMPTY then
			arg_2_0:FlushEmpty()
		else
			Cattery = var_2_0

			if var_2_1 == var_2_0.STATE_OCCUPATION then
	...
	var_2_0(arg_2_0.lockTF, var_3)

	setActive = var_2_0

	var_2_0(arg_2_0.unlockTF, not var_3)
	arg_2_0:UpdateStyle()
...
function var_0_0.UpdateStyle(arg_3_0)
	...
	if not (var_3_1 == var_1_10003.STATE_LOCK) then
		local var_3_2 = var_1
		local var_3_3 = var_1._GetStyle_(var_3_2)

		Cattery = var_1_10005

		if var_3_1 == var_1_10005.STATE_EMPTY then
			local var_3_4 = arg_3_0.style

			GetSpriteFromAtlas = var_3_2
			var_3_4.sprite = var_3_2("CatteryStyle/" .. var_3_3:GetName(false), "")
		else
			local var_3_5 = arg_3_0.style

			GetSpriteFromAtlas = var_3_2
			var_3_5.sprite = var_3_2("CatteryStyle/" .. var_3_3:GetName(var_1:IsDirty()), "")
		end
	end
...
function var_0_0.InitBubble(arg_8_0)
	...
	local var_8_2 = var_1
	local var_8_3 = var_1.ExiseFeedOP(var_8_2)
	local var_8_4 = var_1:ExistPlayOP()

	setActive = var_8_2

	var_8_2(arg_8_0.clean, var_8_1)

	setActive = var_8_2

	var_8_2(arg_8_0.feed, var_8_3)

	setActive = var_8_2

	var_8_2(arg_8_0.play, var_8_4)

	setActive = var_8_2

	var_8_2(arg_8_0.bubble, var_8_1 or var_8_3 or var_8_4)
