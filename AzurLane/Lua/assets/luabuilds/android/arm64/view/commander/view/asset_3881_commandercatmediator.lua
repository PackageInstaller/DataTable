...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.GET, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10006.COMMANDER_ON_OPEN_BOX, {
			id = arg_3_1,
			callback = arg_3_2
		})
	...
	arg_1_0:bind(var_0_1.BUILD, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10006.COMMANDER_ON_BUILD, {
			tip = true,
			id = arg_4_1,
			callback = arg_4_2
		})
	...
	arg_1_0:bind(var_0_1.BATCH_BUILD, function(arg_5_0, arg_5_1)
		...
		for iter_5_0 = 1, #arg_5_1 do
			...
			var_2_10008.insert(var_5_0, function(arg_6_0)
				...
				var_6_1(var_6_0, var_3_10004.COMMANDER_ON_BUILD, {
					tip = false,
					id = var_5_1,
					callback = arg_6_0
				})
		...
		var_3(var_5_0, function()
			...
			var_7_1(var_7_0, var_3_10003("commander_build_done"))
	...
	arg_1_0:bind(var_0_1.ONE_KEY, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
		...
		var_8_1(var_8_0, var_2_10007.COMMANDER_QUICKLY_FINISH_BOXES, {
			itemCnt = arg_8_1,
			affectCnt = arg_8_2,
			finishCnt = arg_8_3
		})
	...
	arg_1_0:bind(var_0_1.BATCH_GET, function(arg_9_0, arg_9_1)
		...
		for iter_9_0, iter_9_1 in var_2_10003(arg_9_1) do
			local var_9_1 = iter_9_1:getState()

			CommanderBox = var_2_10009

			if var_9_1 == var_2_10009.STATE_FINISHED then
				table = var_9_1

				var_9_1.insert(var_9_0, iter_9_1.id)
			end
		end

		local var_9_2 = arg_1_0
		local var_9_3 = var_3.sendNotification

		GAME = iter_9_0

		var_9_3(var_9_2, iter_9_0.COMMANDER_ON_BATCH, {
			boxIds = var_9_0
		})
	...
	arg_1_0:bind(var_0_1.RESET_TALENT, function(arg_10_0, arg_10_1)
		...
		var_10_1(var_10_0, var_2_10005.COMMANDER_RESET_TALENTS, {
			id = arg_10_1
		})
	...
	arg_1_0:bind(var_0_1.LEARN_TALENT, function(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
		...
		var_11_1(var_11_0, var_2_10007.COMMANDER_LEARN_TALENTS, {
			id = arg_11_1,
			talentId = arg_11_2,
			replaceid = arg_11_3
		})
	...
	arg_1_0:bind(var_0_1.FETCH_NOT_LEARNED_TALENT, function(arg_12_0, arg_12_1)
		...
		var_12_1(var_12_0, var_2_10005.COMMANDER_FETCH_NOT_LEARNED_TALENT, {
			id = arg_12_1
		})
	...
	arg_1_0:bind(var_0_1.RENAME, function(arg_13_0, arg_13_1, arg_13_2)
		...
		var_13_1(var_13_0, var_2_10006.COMMANDER_RENAME, {
	...
	arg_1_0:bind(var_0_1.SKILL_INFO, function(arg_14_0, arg_14_1)
		...
		NewCommanderSkillLayer = var_2_10008
	...
	arg_1_0:bind(var_0_1.LOCK, function(arg_15_0, arg_15_1, arg_15_2)
		...
		var_15_1(var_15_0, var_2_10006.COMMANDER_LOCK, {
	...
	arg_1_0:bind(var_0_1.UPGRADE, function(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
		...
		var_16_1(var_16_0, var_2_10007.COMMANDER_UPGRADE, {
			id = arg_16_1,
	...
	arg_1_0:bind(var_0_1.ON_SELECT, function(arg_17_0, arg_17_1)
		...
		SelectCommanderCatForPlayScene = var_2_10008
	...
	arg_1_0:bind(var_0_1.RESERVE_BOX, function(arg_18_0, arg_18_1)
		...
		var_18_1(var_18_0, var_2_10005.COMMANDER_RESERVE_BOX, {
			count = arg_18_1
		})
	...
	arg_1_0:bind(var_0_1.OPEN_HOME, function(arg_19_0)
		...
		CommanderHomeLayer = var_2_10007
		var_19_3.viewComponent = var_2_10007
		CommanderHomeMediator = var_2_10007
...
function var_0_1.handleNotification(arg_21_0, arg_21_1)
	...
	if var_21_1 == var_21_0.COMMANDER_RESERVE_BOX_DONE then
		local var_21_3 = arg_21_0.viewComponent

		var_21_4 = var_21_4.emit
		CommanderCatScene = var_1_10007

		var_21_4(var_21_3, var_1_10007.MSG_RESERVE_BOX, var_21_2.awards)
	...
	if var_21_1 == var_21_4.UPDATED then
		...
		var_21_6(var_21_5, var_1_10007.MSG_RES_UPDATE)
	...
	if var_21_1 == var_21_6.COMMANDER_QUICKLY_FINISH_BOXES_ERROR then
		local var_21_7 = arg_21_0.viewComponent

		var_21_8 = var_21_8.emit
		CommanderCatScene = var_1_10007

		var_21_8(var_21_7, var_1_10007.MSG_QUICKLY_FINISH_TOOL_ERROR)
	...
	if var_21_1 == var_21_8.COMMANDER_UPGRADE_DONE then
		local var_21_9 = arg_21_0.viewComponent

		var_21_10 = var_21_10.emit
		CommanderCatScene = var_1_10007

		var_21_10(var_21_9, var_1_10007.MSG_UPGRADE, var_21_2.oldCommander, var_21_2.commander)
	...
	if var_21_1 == var_21_10.COMMANDER_LOCK_DONE then
		if var_21_2.flag == 1 then
			...
			var_21_12(var_21_11, var_1_10007("commander_lock_done"))
		elseif var_21_2.flag == 0 then
			...
			var_21_12(var_21_13, var_1_10007("commander_unlock_done"))
		end
	...
	if var_21_1 == var_21_12.COMMANDER_RENAME_DONE then
		pg = var_21_15
		...
		var_21_15(var_21_14, var_1_10007("commander_rename_success_tip"))
	...
	if var_21_1 == var_21_15.COMMANDER_FETCH_NOT_LEARNED_TALENT_DONE then
		local var_21_16 = arg_21_0.viewComponent

		var_21_17 = var_21_17.emit
		CommanderCatScene = var_1_10007

		var_21_17(var_21_16, var_1_10007.MSG_FETCH_TALENT_LIST)
	...
	if var_21_1 == var_21_17.COMMANDER_LEARN_TALENTS_DONE then
		local var_21_18 = arg_21_0.viewComponent

		var_21_19 = var_21_19.emit
		CommanderCatScene = var_1_10007

		var_21_19(var_21_18, var_1_10007.MSG_LEARN_TALENT)
	...
	if var_21_1 ~= var_21_19.COMMANDER_UPDATED then
		CommanderProxy = var_21_21

		if var_21_1 ~= var_21_21.COMMANDER_ADDED then
			CommanderProxy = var_21_21

			local var_21_21

			if var_21_1 == var_21_21.COMMANDER_DELETED then
				local var_21_20 = arg_21_0.viewComponent

				var_21_21 = var_21_21.emit
				CommanderCatScene = var_1_10007

				var_21_21(var_21_20, var_1_10007.MSG_UPDATE)
			...
			if var_21_1 ~= var_21_21.COMMANDER_CATTERY_OP_DONE then
				GAME = var_21_23

				if var_21_1 ~= var_21_23.ZERO_HOUR_OP_DONE then
					GAME = var_21_23

					local var_21_23

					if var_21_1 == var_21_23.PUT_COMMANDER_IN_CATTERY_DONE then
						local var_21_22 = arg_21_0.viewComponent

						var_21_23 = var_21_23.emit
						CommanderCatScene = var_1_10007

						var_21_23(var_21_22, var_1_10007.MSG_HOME_TIP)
					...
					if var_21_1 ~= var_21_23.COMMANDER_ON_BUILD_DONE then
						GAME = var_21_25

						do
							local var_21_25

							if var_21_1 == var_21_25.REFRESH_COMMANDER_BOXES_DONE then
								local var_21_24 = arg_21_0.viewComponent

								var_21_25 = var_21_25.emit
								CommanderCatScene = var_1_10007

								var_21_25(var_21_24, var_1_10007.MSG_BUILD)
							else
								GAME = var_21_25

								if var_21_1 == var_21_25.COMMANDER_ON_OPEN_BOX_DONE then
									pg = var_4
									...
									var_4({
										function(arg_22_0)
											...
											var_22_1(var_22_0, var_2_10004.MSG_OPEN_BOX, var_21_2.boxId, arg_22_0)
										...
										function()
											...
											var_24_1(var_24_0, var_2_10003.MSG_BUILD)
									...
									if var_21_1 == var_4.COMMANDER_ON_BATCH_DONE then
...
function var_0_1.BatchDisplayCommander(arg_25_0, arg_25_1, arg_25_2)
	...
	for iter_25_0, iter_25_1 in var_1_10004(arg_25_1) do
		...
		var_1_10009.insert(var_25_0, function(arg_26_0)
			...
			var_26_1(var_26_0, var_2_10004.MSG_OPEN_BOX, iter_25_1, arg_26_0)
	...
	var_4(var_25_0, function()
		...
		for iter_27_0, iter_27_1 in var_2_10001(arg_25_2) do
			table = var_2_10006

			var_2_10006.insert(var_27_1, function(arg_28_0)
				getProxy = var_3_10001
				CommanderProxy = var_3_10003

				if var_3_10001(var_3_10003).hasSkipFlag then
		...
		var_1(var_27_1, function()
			...
			var_29_1(var_29_0, var_3_10003.MSG_BUILD)
			...
			var_29_3(var_29_2, var_3.MSG_BATCH_BUILD, arg_25_2)
...
function var_0_1.DisplayNewCommander(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_2 = var_1_10006.New
	local var_30_3 = {}

	NewCommanderScene = var_1_10009
	var_30_3.viewComponent = var_1_10009
	NewCommanderMediator = var_1_10009
	var_30_3.mediator = var_1_10009
	var_30_3.data = {
		commander = arg_30_1,
		onExit = arg_30_2
	}
...
function var_0_1.remove(arg_31_0)
	...
	if var_1.isConnected(var_31_0) then
		...
		var_31_2(var_31_1, var_1_10004.OPEN_OR_CLOSE_CATTERY, {
			open = false
		})
	end
