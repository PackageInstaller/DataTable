	...
	if arg_3_0.page then
		...
		if var_2.GetLoaded(var_3_0) then
			...
			if var_2.isShowing(var_3_1) then
				...
				CommanderHomeSelCatteryStylePage = var_1_10005

				if var_2(var_3_2, var_1_10005) then
...
function var_0_1.OnLoaded(arg_4_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_4_0.styleIcon = var_4_3(var_4_2, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_4_0.commanderLevelTxt = var_4_9(var_4_8, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_4_0.commanderExpTxt = var_4_12(var_4_11, var_4(var_1_10006))
	...
	arg_4_0.toggleGroup = var_4_17(var_4_16, var_4(var_1_10006))
...
function var_0_1.OnInit(arg_5_0)
	...
	var_5_1(var_5_0, var_5_2, var_5_3, var_1_10006)
	...
	for iter_5_0, iter_5_1 in var_1(arg_5_0.tags) do
		...
		var_1_10006(var_5_10, var_5_11, var_5_12, var_1_10011)
	end
...
function var_0_1.SwitchPage(arg_11_0, arg_11_1)
	...
	CommanderHomeSelCatteryStylePage = var_6

	local var_11_3 = var_3(var_11_2, var_6)

	setActive = var_1_10004

	var_1_10004(arg_11_0.commanderEmpty, var_11_3)

	setActive = var_1_10004

	var_1_10004(arg_11_0.commanderExp, not var_11_3)
...
function var_0_1.Show(arg_13_0)
	...
	var_13_1(var_13_0, var_1_10004.DESC_PAGE_OPEN)
...
function var_0_1.FlushCatteryInfo(arg_15_0)
	...
	CommanderHomeSelCommanderPage = var_1_10005

	if var_1_10002(var_15_1, var_1_10005) then
	...
	var_15_5(var_15_4, var_5.GetCommander(var_15_6))
...
function var_0_1.UpdateCatteryStyle(arg_18_0)
	...
	if var_1:ExistCommander() then
		local var_18_2 = arg_18_0.styleIcon

		GetSpriteFromAtlas = var_18_0
		var_18_2.sprite = var_18_0("CatteryStyle/" .. var_18_1:GetName(var_1:IsDirty()), "")
	else
		local var_18_3 = arg_18_0.styleIcon

		GetSpriteFromAtlas = var_18_0
		var_18_3.sprite = var_18_0("CatteryStyle/" .. var_18_1:GetName(false), "")
	end
