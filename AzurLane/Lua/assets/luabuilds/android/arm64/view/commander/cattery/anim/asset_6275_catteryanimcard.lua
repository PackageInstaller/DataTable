...
local var_0_1 = var_0_10000(var_0_0, var_0_10003("..CatterySettlementCard"))
local var_0_2 = 1
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_5
	Slider = var_1_10007
	arg_1_0.slider = var_1_3(var_1_2, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.expTxt = var_1_12(var_1_11, var_5(var_1_10007))
	...
	typeof = var_5
	Text = var_1_10007
	arg_1_0.additionTxt = var_1_16(var_1_15, var_5(var_1_10007))
...
function var_0_1.Clear(arg_5_0)
	...
	if var_5_0(var_3(arg_5_0.addition)) then
		LeanTween = var_1
		...
		var_5_1(var_3(arg_5_0.addition))
	end
...
function var_0_1.AdditionAnim(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_1 = var_1_10004.value

	go = var_6

	local var_7_2 = var_7_1(var_6(arg_7_0.addition), var_7_0, var_7_0 + 25, arg_7_1)
	local var_7_3 = var_4.setOnUpdate

	System = var_7

	local var_7_4 = var_7_3(var_7_2, var_7.Action_float(function(arg_8_0)
	...
	var_7_5(var_7_4, var_7.Action(function()
		...
		Vector3 = var_2_10001
		var_9_0.localPosition = var_2_10001(arg_7_0.addition.localPosition.x, var_7_0, 0)
