...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_5 = var_3.Find(var_2_4, "page/frame/list/content")
	local var_2_6 = arg_2_0._tf

	arg_2_0.uiList = var_2_3(var_2_5, var_4.Find(var_2_6, "page/frame/comanderTF"))
...
function var_0_1.Filter(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_7_0(arg_7_0.displayCatteries) do
		local var_7_3 = var_7_1[iter_7_0]

		var_1_10009 = var_8.ExistCommander(var_7_3)

		local var_7_4 = var_8
		local var_7_5 = var_8.GetCommanderId(var_7_4)

		if not var_8:IsLocked() and var_1_10009 and iter_7_1.commanderId == var_7_5 then
			-- block empty
	...
	for iter_7_2, iter_7_3 in var_4(var_7_2) do
		...
		var_1_10009.insert(var_7_6, function(arg_8_0)
			...
			CommanderHomeMediator = var_2_10004

			var_8_1(var_8_0, var_2_10004.ON_SEL_COMMANDER, iter_7_3.pos, iter_7_3.id, false, arg_8_0)
...
function var_0_1.Show(arg_10_0)
	...
	CommanderHomeLayer = var_1_10004

	var_10_1(var_10_0, var_1_10004.DESC_PAGE_OPEN)
...
function var_0_1.InitList(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_2(var_11_1) do
		...
		local var_11_3 = iter_11_1.GetState(var_11_2)
		local var_11_4 = iter_11_1
		local var_11_5 = iter_11_1.ExistCommander(var_11_4)

		Cattery = var_11_2

		local var_11_6 = var_11_3 == var_11_2.STATE_LOCK

		table = var_11_4

		local var_11_7 = var_11_4.insert
		local var_11_8 = arg_11_0.displayCatteries
		local var_11_9 = {
			isLock = var_11_6
		}
		local var_11_10

		if not var_11_5 or not iter_11_1:GetCommanderId() then
			var_11_10 = 0
		end

		var_11_9.commanderId = var_11_10

		var_11_7(var_11_8, var_11_9)
	...
	local var_11_11 = arg_11_0.uiList

	var_2.make(var_11_11, function(arg_12_0, arg_12_1, arg_12_2)
...
function var_0_1.UpdateSelectedCard(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_1 = var_1_10005(var_1_10007)

	if var_5.RawGetCommanderById(var_14_1, var_14_0) then
		CommanderCard = var_1_10006

		local var_14_2 = var_1_10006.New(arg_14_2)

		var_6.update(var_14_2, var_5)

		local var_14_3 = arg_14_0:CheckIncludeSelf(var_5.id)

		setActive = var_8

		var_8(arg_14_2:Find("info/home"), not var_14_3)
	end
	...
	if not var_3.isLock then
		...
		var_6(var_14_4, var_14_5, var_14_6, var_1_10011)
	end
...
function var_0_1.OnUpdateItem(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_6 = var_10.Find(var_19_5, "sel_b")

	table = var_1_10011

	var_1_10008(var_19_6, var_1_10011.contains(var_19_4, var_19_2))

	if var_19_2 > 0 then
		local var_19_7 = arg_19_0:CheckIncludeSelf(var_19_2)

		setActive = var_19_3

		local var_19_8 = var_5._tf

		var_19_3(var_11.Find(var_19_8, "info/home"), not var_19_7)
	end
...
function var_0_1.OnSelected(arg_20_0, arg_20_1)
	if arg_20_0:GetEmptyPosIndex() <= 0 then
		...
		local var_20_0 = var_3.ShowTips

		i18n = var_1_10006

		var_20_0(var_1_10005, var_1_10006("commander_selected_max", arg_20_0.maxCnt))
	...
	local var_20_1 = arg_20_0:GetSelectedCommanderList()

	table = var_1_10005

	local var_20_2

	if not var_1_10005.contains(var_20_1, var_3.id) then
		var_20_2 = arg_20_0.displayCatteries[var_2]
		var_20_2.commanderId = var_3.id
	else
		ipairs = var_20_2

		for iter_20_0, iter_20_1 in var_20_2(arg_20_0.displayCatteries) do
...
function var_0_1.UpdateCardSelected(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10002(arg_21_0.cards) do
		local var_21_1
		...
		local var_21_2 = iter_21_1._tf
		local var_21_3 = var_10.Find(var_21_2, "sel_b")

		table = var_1_10011

		var_1_10008(var_21_3, var_1_10011.contains(var_21_0, var_21_1))
	end
...
function var_0_1.Hide(arg_22_0)
	...
	var_22_1(var_22_0, var_1_10004.DESC_PAGE_CLOSE)
