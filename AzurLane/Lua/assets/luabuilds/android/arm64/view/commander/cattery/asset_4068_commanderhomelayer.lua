...
function var_0_1.init(arg_12_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_12_0.levelTxt = var_12_5(var_12_4, var_4(var_1_10006))
	...
	arg_12_0.opAnim = var_12_12(var_12_11, var_4(var_1_10006))
	UIItemList = var_1
	...
	arg_12_0.UIlist = var_12_13(var_12_14, var_4.Find(var_12_15, "tpl"))
	...
	typeof = var_4
	Text = var_12_15
	arg_12_0.cntTxt = var_12_19(var_12_18, var_4(var_12_15))
	arg_12_0.cards = {}
	...
	arg_12_0.flower = var_12_20(var_3.Find(var_12_21, "bg/frame/flower"))
...
function var_0_1.didEnter(arg_16_0)
	...
	var_1(var_16_0, var_16_1, var_16_2, var_1_10006)
	...
	var_1(var_16_3, var_16_4, var_16_5, var_1_10006)
	...
	var_1(var_16_6, var_16_7, var_16_8, var_1_10006)
	...
	local function var_16_11()
		...
		pg = var_2_10004
		var_20_2.helps = var_2_10004.gametip.cat_home_help.tip
	...
	var_1(var_16_9, var_16_10, var_16_11, var_1_10006)
	...
	local function var_16_14()
		...
		var_21_2(var_21_1, var_2_10003.ON_CLEAN)
	...
	var_1(var_16_12, var_16_13, var_16_14, var_1_10006)
	...
	local function var_16_17()
		...
		var_22_2(var_22_1, var_2_10003.ON_FEED)
	...
	var_1(var_16_15, var_16_16, var_16_17, var_1_10006)
	...
	local function var_16_20()
		...
		var_23_2(var_23_1, var_2_10003.ON_PLAY)
	...
	var_1(var_16_18, var_16_19, var_16_20, var_1_10006)
	...
	var_1(var_16_21, var_16_22, var_16_23, var_1_10006)
...
function var_0_1.OnUpdateItem(arg_26_0, arg_26_1, arg_26_2)
	...
	local function var_26_3()
		...
		if not var_0.IsLocked(var_27_0) then
			...
			var_27_3(var_27_2, var_2_10003("cat_home_unlock"))
		end
	...
	var_1_10004(var_26_1, var_26_2, var_26_3, var_1_10009)
...
function var_0_1.willExit(arg_31_0)
	...
	var_31_1(var_31_0, var_31_2, var_1_10005.UIMgr.GetInstance()._normalUIMain)
