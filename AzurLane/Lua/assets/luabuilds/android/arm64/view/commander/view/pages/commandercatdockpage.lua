...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.reserveTxt = var_2_5(var_2_4, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.homeTxt = var_2_10(var_2_9, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.boxesTxt = var_2_15(var_2_14, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.capacityTxt = var_2_19(var_2_18, var_4(var_1_10006))
	...
	typeof = var_4
	Text = var_1_10006
	arg_2_0.selectedNumTxt = var_2_31(var_2_30, var_4(var_1_10006))
...
function var_0_1.RegisterEvent(arg_3_0)
	...
	var_3_1(var_3_0, var_4.EVENT_NEXT_ONE, function(arg_5_0, arg_5_1)
	...
	var_3_3(var_3_2, var_4.EVENT_PREV_ONE, function(arg_6_0, arg_6_1)
	...
	var_3_5(var_3_4, var_4.MSG_UPDATE, function(arg_7_0)
	...
	var_3_7(var_3_6, var_4.MSG_HOME_TIP, function(arg_8_0)
	...
	var_3_9(var_3_8, var_4.MSG_BUILD, function()
	...
	var_3_11(var_3_10, var_4.MSG_RESERVE_BOX, function()
	...
	var_3_13(var_3_12, var_4.EVENT_FOLD, function(arg_11_0, arg_11_1)
		if arg_11_1 then
			LeanTween = var_2_10002
			var_2_10002 = var_2_10002.moveX
			rtf = var_2_10004

			var_2_10002(var_2_10004(arg_3_0._tf), 1000, 0.5)
		else
			LeanTween = var_2_10002
			...
			var_11_0(var_2_10004(arg_3_0._tf), -423, 0.5)
		end
...
function var_0_1.OnNextOn(arg_12_0, arg_12_1, arg_12_2)
	...
	if not var_12_1 then
		...
		CommanderCatScene = iter_12_2

		var_12_4(var_12_3, iter_12_2.EVENT_SELECTED, var_12_2)
	end
...
function var_0_1.OnInit(arg_15_0)
	...
	var_15_4(var_15_5, var_15_6, var_15_7, var_1_10006)
	...
	var_15_4(var_15_8, var_15_9, var_15_10, var_1_10006)
	...
	var_15_4(var_15_11, var_15_12, var_15_13, var_1_10006)
	...
	var_15_4(var_15_14, var_15_15, var_15_16, var_1_10006)
	...
	local function var_15_19()
		...
		if #arg_15_0.selectedList < var_25_0 then
			...
			var_25_2(var_25_1, var_2_10004("commander_select_min_cnt", var_25_0))
		...
		arg_15_0.onSelected(arg_15_0.selectedList, function()
			...
			CommanderCatScene = var_3_10003

			var_26_1(var_26_0, var_3_10003.EVENT_BACK)
	...
	var_15_4(var_15_17, var_15_18, var_15_19, var_1_10006)
	...
	local function var_15_22()
		...
		var_27_1(var_27_0, var_2_10003.EVENT_BACK)
	...
	var_15_4(var_15_20, var_15_21, var_15_22, var_1_10006)
	...
	if not var_15_4 then
		...
		local function var_15_25()
			...
			var_28_1(var_28_0, var_2_10003.OPEN_HOME)
		...
		var_15_4(var_15_23, var_15_24, var_15_25, var_1_10006)
	else
		setActive = var_15_4
...
function var_0_1.UpdateStyle(arg_32_0)
	...
	var_1_10001(var_32_0, var_32_1 == var_1_10005.MODE_SELECT)
	...
	CommanderCatScene = var_5

	var_1_10001(var_32_2, var_32_3 == var_5.MODE_VIEW)

	local var_32_4 = arg_32_0.contextData.mode

	CommanderCatScene = var_1_10002

	if var_32_4 == var_1_10002.MODE_SELECT then
...
function var_0_1.DisplayCatterySettlement(arg_34_0)
	...
	NewMainMediator = var_34_0

	local var_34_3 = var_34_2 == var_34_0.__cname
	...
	if not var_3.IsRunning(var_34_4) then
		...
		local var_34_5 = var_34_6.NewGuideMgr.GetInstance()

		var_34_6 = var_34_6.IsBusy(var_34_5)
	end

	if var_34_1 and var_34_1:ShouldSettleCattery() and var_34_3 and not var_34_6 then
		Clone = var_1_10004
		var_1_10004 = var_1_10004(var_34_1)
		var_1_10007 = arg_34_0.catterySettlementPage

		var_5.ExecuteAction(var_1_10007, "Show", var_1_10004)
	end

	pg = var_1_10004

	local var_34_7 = var_1_10004.m02
	local var_34_8 = var_4.sendNotification

	GAME = var_1_10007

	var_34_8(var_34_7, var_1_10007.OPEN_OR_CLOSE_CATTERY, {
		open = true
	})
...
function var_0_1.UpdateCapacity(arg_36_0)
	...
	local var_36_2 = var_1_10002.getCount

	getProxy = var_1_10004
	CommanderProxy = var_1_10006

	local var_36_3 = var_1_10004(var_1_10006)
	local var_36_4 = var_36_2(var_4.getRawData(var_36_3))
...
function var_0_1.UpdateReserve(arg_37_0)
	...
	CommanderConst = var_37_0

	local var_37_3 = var_37_0.MAX_GETBOX_CNT - var_37_1
	local var_37_4 = "/"
...
function var_0_1.UpdateBoxes(arg_38_0)
	...
	local var_38_2 = var_1_10002.select(var_38_1, function(arg_39_0)
		local var_39_0 = arg_39_0:getState()

		CommanderBox = var_2_10002

		return var_39_0 == var_2_10002.STATE_FINISHED
	end)
	...
	local var_38_5 = var_6(var_1_10008)

	var_38_3(var_38_4, var_6.ShouldTipBox(var_38_5))
...
function var_0_1.OnInitItem(arg_40_0, arg_40_1)
	...
	local var_40_2 = var_40_0.infoTF
	...
	local function var_40_3()
		...
		if var_41_0 == var_2_10001.MODE_SELECT then
			...
			var_1.OnCheckBefore(var_41_2, var_40_0.commanderVO)

			local var_41_3 = arg_40_0

			var_1.Check(var_41_3, var_40_0.commanderVO)

			local var_41_4 = arg_40_0

			var_1.OnCheckAfter(var_41_4, var_40_0.commanderVO, var_41_1 > #arg_40_0.selectedList)
		else
			...
			var_0.insert(arg_40_0.selectedList, var_40_0.commanderVO.id)

			local var_41_6 = var_40_0
			local var_41_7 = var_0.UpdateSelected
			local var_41_8 = arg_40_0.selectedList

			defaultValue = iter_41_1

			var_41_7(var_41_6, var_41_8, not iter_41_1(arg_40_0.sortData.displayCustomName, true))
			...
			var_41_10(var_41_9, var_41_8.EVENT_SELECTED, var_40_0.commanderVO, true)
		end
	...
	var_1_10003(var_40_1, var_40_2, var_40_3, var_1_10008)

	onButton = var_1_10003

	local var_40_4 = arg_40_0
	local var_40_5 = var_40_0.quitTF
	...
	local function var_40_6()
		...
		if var_40_0.commanderVO.id == 0 then
			arg_40_0.onQuit(function()
				...
				var_43_1(var_43_0, var_3_10003.EVENT_BACK)
	...
	var_1_10003(var_40_4, var_40_5, var_40_6, var_1_10008)
...
function var_0_1.OnCheckBefore(arg_44_0, arg_44_1)
	if arg_44_0.previewCommander and arg_44_0.contextData.maxCount > 1 then
		...
		var_44_1(var_44_0, var_1_10005.EVENT_SELECTED, arg_44_0.previewCommander, true)
	else
		...
		var_44_3(var_44_2, var_1_10005.EVENT_SELECTED, arg_44_1, true)
		...
		if arg_44_0.previewCommander then
			...
			var_44_5(var_44_4, var_5.EVENT_PREVIEW_ADDITION, arg_44_0.previewCommander, true)
		else
			...
			var_44_7(var_44_6, var_5.EVENT_PREVIEW_ADDITION, arg_44_1, true)
		end
	end
...
function var_0_1.OnCheckAfter(arg_45_0, arg_45_1, arg_45_2)
	if arg_45_0.previewCommander and arg_45_0.contextData.maxCount > 1 then
		...
		var_45_1(var_45_0, var_1_10006.EVENT_PREVIEW_PLAY, arg_45_0.selectedList, arg_45_2)
	end
...
function var_0_1.Check(arg_46_0, arg_46_1)
	...
	if var_1_10003.contains(arg_46_0.selectedList, arg_46_1.id) and var_46_0 == 1 then
		...
		if var_3.contains(arg_46_0.selectedList, arg_46_1.id) then
			...
			var_1_10004.remove(arg_46_0.selectedList, var_46_1)
			arg_46_0:UpdateSelected()
	...
	elseif var_46_0 <= #arg_46_0.selectedList then
		...
		var_46_7(var_46_6, var_9("commander_select_max"))
		arg_46_0:UpdateSelected()
...
function var_0_1.NewCard(arg_52_0, arg_52_1)
	...
	if var_52_0 == var_1_10003.MODE_VIEW or arg_52_0.contextData.maxCount == 1 then
		...
		CommanderCatCard = var_1_10005

		return var_52_0(var_52_1, var_1_10005.MARK_TYPE_CIRCLE)
	else
		CommanderCatCard = var_52_0
		...
		return var_52_2(var_52_3, var_1_10005.MARK_TYPE_TICK)
	end
...
function var_0_1.OnUpdateItem(arg_53_0, arg_53_1, arg_53_2)
	...
	var_53_3(var_53_2, var_53_4, var_53_5, not var_1_10010(arg_53_0.sortData.displayCustomName, true))
...
local function var_0_2(arg_54_0, arg_54_1, arg_54_2)
	...
	if var_1_10006.getCount(arg_54_1) ~= 0 and not arg_54_1[var_54_2] then
		CommanderIndexPage = var_6

		if arg_54_1[var_6.NATION_OTHER] then
			CommanderIndexPage = var_6

			if var_6.IsOtherNation(var_54_2) then
				var_54_0 = true
			end
		end
...
function var_0_1.OnDestroy(arg_63_0)
	...
	if arg_63_0.reservePanel then
		local var_63_0 = arg_63_0.reservePanel
	...
	if arg_63_0.boxesPanel then
		local var_63_1 = arg_63_0.boxesPanel

		var_1.Destroy(var_63_1)

		arg_63_0.boxesPanel = nil
	end

	if arg_63_0.indexPanel then
		local var_63_2 = arg_63_0.indexPanel

		var_1.Destroy(var_63_2)

		arg_63_0.indexPanel = nil
	end

	if arg_63_0.catterySettlementPage then
		local var_63_3 = arg_63_0.catterySettlementPage

		var_1.Destroy(var_63_3)

		arg_63_0.catterySettlementPage = nil
	end

	local var_63_4 = arg_63_0.contextData

	math = var_2
	var_63_4.scrollValue = var_2.min(arg_63_0.scrollRect.value, 1)
