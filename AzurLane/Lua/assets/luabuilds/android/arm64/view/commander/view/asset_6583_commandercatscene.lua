...
function var_0_1.init(arg_2_0)
	...
	typeof = var_4
	Image = var_1_10006
	arg_2_0.bgImg = var_2_2(var_2_1, var_4(var_1_10006))
	...
	CommanderMsgBoxPage = var_2_16

	local var_2_18 = var_2_16.New

	pg = var_4
	var_2_17.msgBox = var_2_18(var_4.UIMgr.GetInstance().OverlayMain, arg_2_0.event)
	...
	pg = var_4
	var_2_19.treePanel = var_2_20(var_4.UIMgr.GetInstance().OverlayMain, arg_2_0.event)
	...
	typeof = var_5
	Text = var_7
	var_2_21[1] = var_2_23(var_2_22, var_5(var_7))
	findTF = var_2
	...
	typeof = var_5
	Text = var_7
	var_2_21[2] = var_2_25(var_2_24, var_5(var_7))
	findTF = var_2
	...
	typeof = var_5
	Text = var_7
	var_2_21[3] = var_2_27(var_2_26, var_5(var_7))
	...
	typeof = var_4
	Text = var_6
	arg_2_0.goldTxt = var_2_29(var_2_28, var_4(var_6))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_5()
		...
		pg = var_2_10004
		var_5_2.helps = var_2_10004.gametip.help_commander_info.tip
	...
	var_1_10001(var_3_6, arg_3_0.bgTF, function()
		...
		var_7_1(var_7_0, var_2_10003.EVENT_PREV_ONE, arg_3_0.selectedCommander.id)
		...
		var_8_1(var_8_0, var_2_10003.EVENT_NEXT_ONE, arg_3_0.selectedCommander.id)
...
function var_0_1.UpdateStyle(arg_15_0)
	...
	if arg_15_0.contextData.mode == var_0_1.MODE_SELECT then
		if arg_15_0.contextData.maxCount > 1 then
			...
			local var_15_1 = var_4(arg_15_0.bgTF)
...
function var_0_1.UpdateResources(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1_10002(var_17_1) do
	...
	for iter_19_0, iter_19_1 in var_1_10001(arg_19_0.toggles) do
		...
		local function var_19_2()
			if arg_19_0.pageType then
				...
				var_0(var_2.Find(var_20_0, "Image"), false)
			end
			...
			var_0(var_2.Find(var_20_2, "Image"), true)
		...
		var_1_10006(var_19_0, var_19_1, var_19_2, var_1_10011)
	end
...
function var_0_1.SwitchPage(arg_21_0, arg_21_1)
	...
	if arg_21_1 == var_0_1.PAGE_PLAY and arg_21_0.selectedCommander.inBattle then
		...
		var_21_1(var_21_0, var_1_10005("commander_is_in_battle"))
...
function var_0_1.UpdateMainView(arg_23_0, arg_23_1, arg_23_2)
	...
	if not arg_23_0.paintingName or var_23_0 ~= arg_23_0.paintingName then
		...
		if var_4.GetChild(var_23_2, 0) then
			...
			typeof = var_8
			Image = var_1_10010
			var_23_4(var_23_3, var_8(var_1_10010)).raycastTarget = false
		end
	end
	...
	if 0 < var_23_7 then
		...
		var_6(var_8.Find(var_23_8, "tip/Text"), var_23_7)
	end
	...
	var_6(var_8.Find(var_23_9, "tip"), var_23_7 > 0)
...
function var_0_1.ReturnCommanderPainting(arg_25_0)
	if arg_25_0.selectedCommander then
		...
		var_1(var_25_0, var_4.getPainting(var_25_1))
...
function var_0_1.Fold(arg_26_0)
	...
	local var_26_3 = var_26_2(var_3(arg_26_0.topPanel), 300, 0.5)
	...
	var_26_4(var_26_5, var_26_6, var_26_7, var_6)
...
function var_0_1.UnFold(arg_29_0)
	...
	local var_29_3 = var_29_2(var_3(arg_29_0.topPanel), 0, 0.5)
