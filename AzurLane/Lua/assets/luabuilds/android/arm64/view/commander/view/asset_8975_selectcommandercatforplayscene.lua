...
local var_0_1 = var_0_10000(var_0_0, var_0_10003(".CommanderCatScene"))
...
function var_0_1.RegisterEvent(arg_4_0)
	...
	CommanderCatDockPage = var_1_10004

	var_4_1(var_4_0, var_1_10004.ON_SORT, function(arg_5_0)
...
function var_0_1.CollectIgnoredIdsForPlay(arg_7_0, arg_7_1)
	...
	if var_3.getActiveChapter(var_7_2) then
		...
		var_4.each(var_3.fleets, function(arg_8_0)
			local var_8_0 = arg_8_0:getCommanders()

			pairs = var_2_10002

			for iter_8_0, iter_8_1 in var_2_10002(var_8_0) do
				table = var_2_10007
...
function var_0_1.IsLegalForPlay(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	if var_5.CheckCommanderInFleet(var_9_0, arg_9_2.id) then
		...
		i18n = var_1_10006
		var_1_10006 = var_1_10006("commander_is_in_bigworld")
	...
	if arg_9_1.isMaxLevel(var_9_2) then
		var_9_2 = arg_9_1

		if not arg_9_1.isSameGroup(var_9_2, arg_9_2.groupId) then
			var_9_3 = false
			i18n = var_1_10006
			var_1_10006 = var_1_10006("commander_select_matiral_erro")
	...
	if var_5.IsHome(var_9_4, arg_9_2.id) then
		local var_9_5 = false

		i18n = var_1_10006
		var_1_10006 = var_1_10006("cat_sleep_notplay")
	...
	if not arg_9_0:CheckFullExp(arg_9_1, arg_9_2) and not arg_9_1:isSameGroup(arg_9_2.groupId) then
		...
		local var_9_7 = var_1_10006("commander_exp_limit")
...
function var_0_1.CheckFormation(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	if not var_1_10006.detect(var_12_1, function(arg_13_0)
	...
	i18n = var_1_10012
	var_12_5.content = var_1_10012("commander_material_is_in_fleet_tip")
	...
	function var_12_5.onYes()
		...
		var_14_1(var_14_0, var_2_10003.COOMMANDER_EQUIP_TO_FLEET, {
			commanderId = 0,
...
function var_0_1.CheckGuild(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	local var_16_0 = var_1_10004(var_1_10006)
	...
	i18n = var_1_10010
	var_16_4.content = var_1_10010("commander_is_in_guild")
	...
	function var_16_4.onYes()
		...
		local var_17_1 = var_0

		if not var_0.GetBossMission(var_17_1) or not var_1:IsActive() then
			return
		end

		if not var_1:GetFleetCommanderId(arg_16_1.id) then
			return
		end
		...
		var_17_4(var_17_3, var_8.GUILD_UPDATE_BOSS_FORMATION, {
			force = true,
			editFleet = {
				[var_3.id] = var_3
			},
...
function var_0_1.CheckExtra(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	local var_18_0 = var_1_10004(var_1_10006)
	local var_18_1 = var_4.getCommanders(var_18_0)
	local var_18_2 = var_4:GetExtraCommanders()

	_ = var_18_0

	if not var_18_0.detect(var_18_2, function(arg_19_0)
		return arg_18_1.id == arg_19_0.commanderId
	end) then
		return true
	end

	local var_18_3 = arg_18_0.contextData.msgBox
	local var_18_4 = var_8.ExecuteAction
	local var_18_5 = "Show"
	local var_18_6 = {}

	i18n = var_1_10013
	var_18_6.content = var_1_10013("commander_material_is_in_fleet_tip")
	...
	var_18_6.onNo = arg_18_3
	var_18_6.onClose = arg_18_3
