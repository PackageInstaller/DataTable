...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_27 = var_3.Find(var_2_26, "record/content")
	local var_2_28 = arg_2_0.recordPanel

	arg_2_0.recordList = var_2_25(var_2_27, var_4.Find(var_2_28, "record/content/commanders"))
	onButton = var_1
	...
	var_1(var_2_29, var_2_30, var_2_31, var_2_28)
	...
	var_1(var_2_32, var_2_33, var_2_34, var_2_28)

	onButton = var_1

	local var_2_35 = arg_2_0
	local var_2_36 = arg_2_0._tf
	local var_2_37 = var_4.Find(var_2_36, "bg")
	...
	var_1(var_2_35, var_2_37, var_2_38, var_2_36)
	...
	local function var_2_41()
		...
		local var_6_2 = var_2_10003.COMMANDER_FORMATION_OP
		local var_6_3 = {}

		LevelUIConst = var_2_10005
		var_6_3.FleetType = var_2_10005.FLEET_TYPE_SELECT

		local var_6_4 = {}

		LevelUIConst = var_2_10006
		var_6_4.type = var_2_10006.COMMANDER_OP_REST_ALL
	...
	var_1(var_2_39, var_2_40, var_2_41, var_2_36)

	setText = var_1

	local var_2_42 = arg_2_0.descPanel
	local var_2_43 = var_3.Find(var_2_42, "frame/atttr_panel/abilitys/title/Text")

	i18n = var_2_40

	var_1(var_2_43, var_2_40("commander_subtile_ablity"))

	setText = var_1

	local var_2_44 = arg_2_0.descPanel
	local var_2_45 = var_3.Find(var_2_44, "frame/atttr_panel/talents/title/Text")

	i18n = var_4

	var_1(var_2_45, var_4("commander_subtile_talent"))

	setText = var_1

	local var_2_46 = arg_2_0.recordPanel
	local var_2_47 = var_3.Find(var_2_46, "current/title/Text")

	i18n = var_4

	var_1(var_2_47, var_4("commander_formation_prefab_fleet"))
...
function var_0_1.Update(arg_7_0, arg_7_1, arg_7_2)
	...
	CommanderConst = var_7_0

	for iter_7_0 = var_7_2, var_7_0.MAX_FORMATION_POS do
...
function var_0_1.closeDescPanel(arg_10_0, arg_10_1)
	...
	if not var_10_1(var_1_10005(arg_10_0.samllTF)) then
		LeanTween = var_10_2
		...
		if var_10_2(var_5(arg_10_0.descFrameTF)) then
			return
		end
		...
		var_10_4(var_10_3, var_6.Action(function()
			setActive = var_2_10000
...
function var_0_1.updateDesc(arg_12_0)
	...
	CommanderConst = var_12_0

	for iter_12_0 = var_12_2, var_12_0.MAX_FORMATION_POS do
...
function var_0_1.updateAdditions(arg_13_0)
	...
	var_5.make(var_13_4, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			var_4(var_14_1, var_2_10007.Type2Name(var_14_0.attrName))

			setText = var_4

			local var_14_2 = arg_14_2
			local var_14_3 = arg_14_2.Find(var_14_2, "Text")
			local var_14_4 = "+"

			math = var_14_2

			var_4(var_14_3, (var_14_4 .. var_14_2.floor(var_14_0.value * 1000) / 1000) .. "%")
	...
	var_5.make(var_13_6, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			var_4(var_2_10006(arg_15_2, "name_mask/name"), var_15_0.name)

			local var_15_1 = var_15_0.type

			CommanderConst = var_2_10005

			local var_15_2 = var_15_1 == var_2_10005.TALENT_ADDITION_RATIO and "%" or ""
...
function var_0_1.updateSkillTF(arg_16_0, arg_16_1, arg_16_2)
	...
	if arg_16_1 then
		var_1_10003 = arg_16_1:getSkills()[1]
		GetImageSpriteFromAtlasAsync = var_1_10004

		var_1_10004("CommanderSkillIcon/" .. var_1_10003:getConfig("icon"), "", arg_16_2:Find("icon"))

		setText = var_1_10004

		var_1_10004(arg_16_2:Find("level"), "Lv." .. var_1_10003:getLevel())
		...
		local function var_16_2()
			...
			var_17_1(var_17_0, var_2_10003.ON_CMD_SKILL, var_1_10003)
		...
		var_1_10004(var_16_0, var_16_1, var_16_2, var_9)
	else
...
function var_0_1.updateCommander(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4)
	...
	local var_18_1 = arg_18_1.Find(var_18_0, "add")
	local var_18_2 = arg_18_1:Find("info")

	if arg_18_3 then
		local var_18_3 = arg_18_1

		var_18_0 = arg_18_1.Find(var_18_3, "info/mask/icon")

		local var_18_4 = arg_18_1
		local var_18_5 = arg_18_1.Find(var_18_4, "info/frame")

		GetImageSpriteFromAtlasAsync = var_18_3

		var_18_3("CommanderHrz/" .. arg_18_3:getPainting(), "", var_18_0)

		local var_18_6 = arg_18_1

		if arg_18_1.Find(var_18_6, "info/name") then
			setText = var_18_4

			var_18_4(var_9, arg_18_3:getName())
		end

		Commander = var_18_4

		local var_18_7 = var_18_4.rarity2Frame
		local var_18_8 = arg_18_3
		local var_18_9 = var_18_7(arg_18_3.getRarity(var_18_8))

		setImageSprite = var_18_6

		local var_18_10 = var_18_5

		GetSpriteFromAtlas = var_18_8

		var_18_6(var_18_10, var_18_8("weaponframes", "commander_" .. var_18_9))
	end
	...
	if arg_18_4 then
		...
		local function var_18_13()
			...
			var_19_1(var_19_0, var_2_10003.ON_SELECT_COMMANDER, arg_18_2, arg_18_0.fleet.id)
		...
		var_18_0(var_18_11, var_18_12, var_18_13, var_1_10012)
		...
		local function var_18_16()
			...
			var_20_1(var_20_0, var_2_10003.ON_SELECT_COMMANDER, arg_18_2, arg_18_0.fleet.id)
		...
		var_18_0(var_18_14, var_18_15, var_18_16, var_1_10012)
	end

	setActive = var_18_0

	var_18_0(var_18_1, not arg_18_3)

	setActive = var_18_0

	var_18_0(var_18_2, arg_18_3)
...
function var_0_1.updateRecordPanel(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10002(arg_22_0.recordCommanders) do
...
function var_0_1.UpdatePrefabFleet(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	local var_24_1 = arg_24_2.Find(var_24_0, "fleet_name")
	local var_24_2 = arg_24_1:getName()

	onInputEndEdit = var_24_0

	var_24_0(arg_24_0, var_24_1, function()
		getInputText = var_2_10000

		local var_25_0 = var_2_10000(var_24_1)
		local var_25_1 = arg_24_0
		local var_25_2 = var_1.emit

		FormationMediator = var_2_10004

		local var_25_3 = var_2_10004.COMMANDER_FORMATION_OP
		local var_25_4 = {}

		LevelUIConst = var_2_10006
		var_25_4.FleetType = var_2_10006.FLEET_TYPE_SELECT

		local var_25_5 = {}

		LevelUIConst = var_2_10007
		var_25_5.type = var_2_10007.COMMANDER_OP_RENAME
	...
	local var_24_4 = arg_24_2
	local var_24_5 = arg_24_2.Find(var_24_4, "use_btn")
	...
	local function var_24_6()
		...
		local var_27_2 = var_2_10003.COMMANDER_FORMATION_OP
		local var_27_3 = {}

		LevelUIConst = var_2_10005
		var_27_3.FleetType = var_2_10005.FLEET_TYPE_SELECT

		local var_27_4 = {}

		LevelUIConst = var_2_10006
		var_27_4.type = var_2_10006.COMMANDER_OP_USE_PREFAB
	...
	var_24_0(var_24_3, var_24_5, var_24_6, var_24_4)

	onButton = var_24_0

	local var_24_7 = arg_24_0
	local var_24_8 = arg_24_2
	local var_24_9 = arg_24_2.Find(var_24_8, "record_btn")
	...
	local function var_24_10()
		...
		LevelUIConst = var_2_10005
		var_28_3.FleetType = var_2_10005.FLEET_TYPE_SELECT

		local var_28_4 = {}

		LevelUIConst = var_2_10006
		var_28_4.type = var_2_10006.COMMANDER_OP_RECORD_PREFAB
	...
	var_24_0(var_24_7, var_24_9, var_24_10, var_24_8)
	...
	for iter_24_0, iter_24_1 in var_8(var_24_11) do
		local var_24_13 = arg_24_1:getCommanderByPos(iter_24_0)

		arg_24_0:updateCommander(iter_24_1, iter_24_0, var_24_13)
		arg_24_0:updateSkillTF(var_24_13, var_24_12[iter_24_0])
	end
...
function var_0_1.OnDestroy(arg_30_0)
	...
	if arg_30_0.isShowing(var_30_0) then
		...
		var_30_2(var_3(arg_30_0.descFrameTF))
