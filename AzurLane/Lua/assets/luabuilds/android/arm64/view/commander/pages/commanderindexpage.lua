...
function var_0_1.OnLoaded(arg_3_0)
	...
	local var_3_12 = var_3.Find(var_3_11, "frame/frame/frame/sort_panel/title/Text")

	i18n = var_4

	var_1(var_3_12, var_4("indexsort_sort"))

	setText = var_1

	local var_3_13 = arg_3_0._tf
	local var_3_14 = var_3.Find(var_3_13, "frame/frame/frame/nation_panel/title/Text")

	i18n = var_4

	var_1(var_3_14, var_4("indexsort_camp"))

	setText = var_1

	local var_3_15 = arg_3_0._tf
	local var_3_16 = var_3.Find(var_3_15, "frame/frame/frame/rarity_panel/title/Text")

	i18n = var_4

	var_1(var_3_16, var_4("indexsort_rarity"))

	setText = var_1

	local var_3_17 = arg_3_0._tf
	local var_3_18 = var_3.Find(var_3_17, "frame/frame/frame/name_panel/title/Text")

	i18n = var_4

	var_1(var_3_18, var_4("commandercat_label_display_name"))
...
function var_0_1.OnInit(arg_4_0)
	...
	local function var_4_11()
		...
		CommanderCatDockPage = var_2_10003

		var_8_1(var_8_0, var_2_10003.ON_SORT, arg_4_0.data.displayCustomName)
	...
	var_1(var_4_13, var_4("index_all"))
	...
	local var_4_18 = var_3.Find(var_4_17, "Text")

	i18n = var_4

	var_1(var_4_18, var_4("index_all"))
	...
	var_1(var_4_19, var_4_20, var_4_21, var_6)
	arg_4_0:Reset()
	arg_4_0:InitSort()
	arg_4_0:InitNation()
	arg_4_0:InitRarity()
...
function var_0_1.InitSort(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1(var_0_5.sort) do
		...
		var_1_10007(var_11_0, var_11_1, var_11_2, var_1_10012)

		setText = var_1_10007

		var_1_10007(var_1_10006:Find("Text"), iter_11_1[1])

		var_1_10007 = arg_11_0.sortToggles
		var_1_10007[iter_11_1[2]] = var_1_10006
	end
	...
	for iter_13_0, iter_13_1 in var_1(var_0_5.nation) do
		...
		local function var_13_2(arg_14_0)
			if arg_14_0 then
				...
				local var_14_0 = #arg_13_0.data.nationData

				if 0 < var_14_0 then
					table = var_14_0

					if var_14_0.indexof(arg_13_0.data.nationData, iter_13_1) then
						table = var_2
		...
		var_1_10007(var_13_0, var_13_1, var_13_2, var_1_10012)

		setText = var_1_10007

		local var_13_3 = var_1_10006:Find("Text")

		var_1_10012 = arg_13_0

		var_1_10007(var_13_3, arg_13_0.Nation2Name(var_1_10012, iter_13_1))

		var_1_10007 = arg_13_0.nationToggles
		var_1_10007[iter_13_1] = var_1_10006
	end
	...
	for iter_16_0, iter_16_1 in var_1(var_0_5.rarity) do
		...
		local function var_16_2(arg_17_0)
			if arg_17_0 then
				...
				local var_17_0 = #arg_16_0.data.rarityData

				if 0 < var_17_0 then
					table = var_17_0

					if var_17_0.indexof(arg_16_0.data.rarityData, iter_16_1[2]) then
						table = var_2
		...
		var_1_10007(var_16_0, var_16_1, var_16_2, var_1_10012)

		setText = var_1_10007

		var_1_10007(var_1_10006:Find("Text"), iter_16_1[1])

		var_1_10007 = arg_16_0.rarityToggles
		var_1_10007[iter_16_1[2]] = var_1_10006
	end
...
function var_0_1.InitDisplayName(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1(var_0_5.name) do
		...
		var_1_10007(var_1_10006:Find("Text"), iter_18_1[1])
		...
		var_1_10007(var_18_0, var_18_1, var_18_2, var_12)

		var_1_10007 = arg_18_0.nameToggles
		var_1_10007[iter_18_1[2]] = var_1_10006
	end
...
function var_0_1.Show(arg_20_0, arg_20_1)
	...
	var_2(var_20_0, var_5.UIMgr.GetInstance().OverlayMain)
