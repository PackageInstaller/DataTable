...
function var_0_1.SetLocaliza(arg_3_0)
	...
	local var_3_1 = var_3.Find(var_3_0, "top/title_list/infomation/title")

	i18n = var_1_10004

	var_1_10001(var_3_1, var_1_10004("words_information"))

	setText = var_1_10001

	local var_3_2 = arg_3_0._tf
	local var_3_3 = var_3.Find(var_3_2, "panel/buttonList/ok_button/Image")

	i18n = var_4

	var_1_10001(var_3_3, var_4("word_ok"))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_8 = var_4.Find(var_4_7, "panel/buttonList/ok_button")
...
function var_0_1.UpdateList(arg_8_0)
	...
	var_5.make(var_8_4, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			local var_9_4 = var_5.GetColor(var_9_3, var_8_3 >= var_9_0.lv)

			if var_8_3 < var_9_0.lv then
				local var_9_5 = "(Lv."
				local var_9_6 = var_9_0.lv

				i18n = var_8

				local var_9_7

				if not (var_9_5 .. var_9_6 .. var_8("word_take_effect") .. ")") then
					var_9_7 = ""
				end

				setText = var_9_6

				var_9_6(arg_9_2, "<color=" .. var_9_4 .. ">" .. var_9_2 .. var_9_7 .. "</color>")

				setText = var_9_6

				var_9_6(arg_9_2:Find("level"), "<color=" .. var_9_4 .. ">" .. "Lv." .. var_9_0.lv .. "</color>")
