...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10004("word_click_to_close"))

	setText = var_1_10001

	local var_2_1 = arg_2_0.rtLevelUpPanel
	local var_2_2 = var_3.Find(var_2_1, "adapt/range/content/Text")

	i18n = var_4

	var_1_10001(var_2_2, var_4("loveactivity_ui_13"))
...
function var_0_1.UpdateDisplay(arg_6_0)
	...
	if arg_6_0.contextData.isLevelUp then
		...
		if var_6_1 <= #var_1_10002.lover_letter_content.get_id_list_by_ship_group[arg_6_0.ll.groupId] then
...
function var_0_1.UpdateLoveLetterMedal(arg_8_0)
	...
	setLoveLetterMedal = var_8_0

	var_8_0(var_8_3, arg_8_0.ll)
...
function var_0_1.UpdateMedalSlider(arg_9_0)
	...
	if var_9_2 == 0 then
		...
		var_9_0(var_5.Find(var_9_3, "Slider"), 0, 1, 1)
	else
		setSlider = var_9_0

		local var_9_4 = arg_9_0.rtNow

		var_9_0(var_5.Find(var_9_4, "Slider"), 0, var_9_2, var_9_1)
	end

	setText = var_9_0

	local var_9_5 = arg_9_0.rtNow
	local var_9_6 = var_5.Find(var_9_5, "Text")

	string = var_1_10006

	local var_9_7 = var_1_10006.format

	setColorStr = var_8

	var_9_0(var_9_6, var_9_7(var_8("%d", "#CF90A8") .. "/%d", var_9_1, var_9_2))
...
function var_0_1.UpdateLevelUpPanel(arg_10_0)
	...
	var_2(var_10_3, var_1_10005.Create(var_10_2))
	...
	local function var_10_6()
		...
		LoveLetterGiftLevelDisplayMediator = var_2_10003

		var_11_1(var_11_0, var_2_10003.ON_GO_COLLECTION)
	...
	var_2(var_10_4, var_10_5, var_10_6, var_7)
...
function var_0_1.willExit(arg_12_0)
	...
	if arg_12_0.medalPath then
		...
		local var_12_1 = var_3.Find(var_12_0, "medal")

		var_1(var_3.GetChild(var_12_1, 0))
