...
function var_0_1.init(arg_5_0)
	...
	local var_5_5 = var_4.Find(var_5_4, "before")

	local function var_5_6()
		local var_7_0 = arg_5_0
		local var_7_1 = var_0.emit

		LoveLetterDisplayMediator = var_2_10003

		var_7_1(var_7_0, var_2_10003.ON_UNLOCK_LETTER, arg_5_0.letterId)
...
function var_0_1.didEnter(arg_8_0)
	...
	local var_8_1 = var_3.Find(var_8_0, "after/bg/paper_root/name")
	local var_8_2 = arg_8_0.ll

	var_1_10001(var_8_1, var_4.GetName(var_8_2))
...
function var_0_1.ChangeLetter(arg_9_0, arg_9_1)
	...
	if var_9_0 ~= var_1_10003.clamp(var_9_0, 1, #arg_9_0.letterIds) then
		pg = var_3
		...
		var_9_2(var_9_1, var_6("loveactivity_ui_15"))
	else
...
function var_0_1.ShowLetter(arg_10_0, arg_10_1)
	...
	local var_10_2 = var_4.Find(var_10_1, "after/bg/paper_root/content")

	getProxy = var_1_10005
	LoveLetterProxy = var_7

	local var_10_3 = var_1_10005(var_7)

	var_10_0(var_10_2, var_5.GetLoveLetterContent(var_10_3, arg_10_1))
	...
	var_3.StaticAlign(arg_10_0.rtPointsContainer, arg_10_0.rtPointsTpl, #arg_10_0.letterIds, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			var_3(var_11_0, not var_6.GetLetterUnlock(var_11_1, arg_10_0.letterIds[arg_11_1]))
		end
	...
	var_10_6(var_10_5, var_6.GetLetterUnlock(var_10_7, arg_10_0.letterId))
...
function var_0_1.DoOpenLetter(arg_12_0)
	...
	local var_12_2 = var_4.Find(var_12_1, "click")
	...
	var_2.insert(var_12_6, function(arg_14_0)
		...
		var_2_10002({
			...
			var_3_10000(var_25_0, var_3.Find(var_25_1, "content"))

			setImageSprite = var_3_10000

			local var_25_2 = arg_12_0.rtAnimation

			var_3_10000(var_2.Find(var_25_2, "bg_root/bg"), arg_12_0.spriteBg)

			setImageSprite = var_3_10000

			local var_25_3 = arg_12_0.rtAnimation

			var_3_10000(var_2.Find(var_25_3, "fx_letter_in/deco_letter/deco_letter_1"), arg_12_0.spriteMail)

			setImageSprite = var_3_10000

			local var_25_4 = arg_12_0.rtAnimation

			var_3_10000(var_2.Find(var_25_4, "fx_letter_in/deco_letter/lip_01"), arg_12_0.spriteKiss, true)

			setImageSprite = var_3_10000

			local var_25_5 = arg_12_0.rtAnimation

			var_3_10000(var_2.Find(var_25_5, "hand/hand_deco"), arg_12_0.spriteHand, true)
			...
			local var_25_8 = var_25_7(var_25_6, var_3(var_5))
			...
			var_0(var_2.Find(var_25_9, "letter_style/root"), function(arg_27_0, arg_27_1)
				...
				if arg_27_0.name == arg_12_0.contextData.prefab then
					...
					var_2(var_27_0, var_5.GetName(var_27_1))

					setText = var_2

					local var_27_2 = arg_27_0:Find("after/bg/paper_root/content")
					...
					var_2(var_27_2, var_5.GetLoveLetterContent(var_27_3, arg_12_0.contextData.letterId))
				end
	...
	var_2.insert(var_12_6, function(arg_28_0)
		...
		local var_28_1 = var_3.Find(var_28_0, "painting_root/paint")
		local var_28_2 = arg_12_0.ll

		var_2_10001(var_28_1, var_4.GetPainting(var_28_2), "mainNormal", nil, nil, arg_28_0)
	...
	var_2.insert(var_12_6, function(arg_29_0)
		...
		function arg_12_0.nextCall()
			...
			var_3_10000(var_2.Find(var_30_0, "click"), true)
		...
		var_29_1(var_3.Find(var_29_2, "click"), false)
	...
	var_2.insert(var_12_6, function(arg_31_0)
		...
		function arg_12_0.nextCall()
			...
			var_3_10000(var_2.Find(var_32_0, "click"), true)
		...
		var_31_0(var_3.Find(var_31_1, "click"), false)
	...
	var_2.insert(var_12_6, function(arg_33_0)
		...
		var_33_0(var_3.Find(var_33_1, "click"), false)
...
function var_0_1.UpdateLetterDisplay(arg_35_0, arg_35_1)
	...
	var_1_10002(var_4.Find(var_35_0, "after"), arg_35_1)

	setActive = var_1_10002

	local var_35_1 = arg_35_0.rtStyle

	var_1_10002(var_4.Find(var_35_1, "before"), not arg_35_1)

	setButtonEnabled = var_1_10002

	local var_35_2 = arg_35_0.rtStyle

	var_1_10002(var_4.Find(var_35_2, "before"), not arg_35_1)

	if not arg_35_1 then
		setLoveLetterMedal = var_1_10002

		local var_35_3 = arg_35_0.rtStyle
		local var_35_4 = var_4.Find(var_35_3, "before/medal")
		...
		local var_35_6 = var_1_10008.indexof

		pg = var_1_10010
		var_35_5.level = var_35_6(var_1_10010.lover_letter_content.get_id_list_by_ship_group[arg_35_0.ll.groupId], arg_35_0.contextData.letterId)

		var_1_10002(var_35_4, var_5(var_35_5, {
			__index = arg_35_0.ll
		}))
	end
...
function var_0_1.willExit(arg_40_0)
	if arg_40_0.rtStyle then
		...
		var_1(var_3.Find(var_40_0, "before/medal"), function(arg_41_0, arg_41_1)
	...
	if arg_40_0.rtAnimation then
		...
		local var_40_3 = var_3.Find(var_40_2, "painting_root/paint")
		local var_40_4 = arg_40_0.ll

		var_1(var_40_3, var_4.GetPainting(var_40_4), "mainNormal")
