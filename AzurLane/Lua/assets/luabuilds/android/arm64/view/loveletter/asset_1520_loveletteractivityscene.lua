...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_2_1, var_1_10004("loveactivity_ui_1"))
	...
	var_1_10001(var_2_2, var_4("mail_boxtitle_information"))

	setText = var_1_10001

	local var_2_3 = arg_2_0.btnDaily
	local var_2_4 = var_3.Find(var_2_3, "content/Text")

	i18n = var_4

	var_1_10001(var_2_4, var_4("loveactivity_ui_2"))
	...
	var_1_10001(var_2_6, var_4("loveactivity_ui_3"))
	...
	var_1_10001(var_2_7, var_4("activity_ninjia_main_title"))
	...
	var_1_10001(var_2_9, var_4("mail_box_confirm"))
	...
	local var_2_11 = var_4(arg_2_0._tf, "adapt/TopPage/top/deco/btn_help")
	...
	local function var_2_12()
		...
		pg = var_2_10004
		var_3_2.helps = var_2_10004.gametip.loveactivity_help_tips.tip
	...
	var_1_10001(var_2_10, var_2_11, var_2_12, var_6)
	...
	var_1_10001(var_2_13, var_2_14, var_2_15, var_6)
	...
	var_1_10001(var_2_16, var_2_17, var_2_18, var_6)
	...
	local function var_2_21()
		...
		if var_6_1 < var_6_2 then
			...
			var_6_0 = var_6_0.emit
			LoveLetterActivityMediator = var_2_10005

			var_6_0(var_6_3, var_2_10005.ON_SELECT_GROUP, arg_2_0.activity.id)
		else
			pg = var_6_0

			local var_6_4 = var_6_0.TipsMgr.GetInstance()
			local var_6_5 = var_2.ShowTips

			i18n = var_2_10005

			var_6_5(var_6_4, var_2_10005("common_count_noenough"))
		end
	...
	var_1_10001(var_2_19, var_2_20, var_2_21, var_6)

	onButton = var_1_10001

	local var_2_22 = arg_2_0
	local var_2_23 = arg_2_0.btnDaily
	local var_2_24 = var_4.Find(var_2_23, "content")
	...
	var_1_10001(var_2_22, var_2_24, var_2_25, var_2_23)
	...
	local function var_2_28()
		...
		for iter_8_0 = 1, var_8_1 do
			...
			if var_5.getConfig(var_8_2, "config_data")[iter_8_0] then
				...
				local var_8_3 = var_2_10006(var_8)

				if not var_2_10006.getTaskVO(var_8_3, var_5) then
					var_2_10006 = nil
				end

				if var_2_10006 and var_2_10006:getTaskStatus() == 1 then
					local var_8_4 = arg_2_0
					local var_8_5 = var_7.emit

					LoveLetterActivityMediator = var_2_10010

					var_8_5(var_8_4, var_2_10010.ON_DAILY_LOGIN_REWARD, var_5)
	...
	SFX_CONFIRM = var_2_23

	var_1_10001(var_2_26, var_2_27, var_2_28, var_2_23)
	...
	var_1_10001(var_2_29, var_2_30, var_2_31, var_2_23)
	...
	local function var_2_34()
		...
		LoveLetterActivityMediator = var_2_10003

		var_10_1(var_10_0, var_2_10003.ON_GO_COLLECTION)
	...
	var_1_10001(var_2_32, var_2_33, var_2_34, var_2_23)
...
function var_0_1.SetActivity(arg_11_0, arg_11_1)
	...
	arg_11_0.ll = var_11_1(var_11_0, var_5.GetTargetGroupId(var_11_2))
	setText = var_2

	local var_11_3 = arg_11_0.rtDailyPanel
	local var_11_4 = var_4.Find(var_11_3, "panel/Text")

	string = var_5

	var_2(var_11_4, var_5.format("are you sure to add extra exp to character:%d ?", arg_11_0.ll.groupId))
...
function var_0_1.SetDailyActivity(arg_12_0, arg_12_1)
	...
	local var_12_1 = arg_12_0.btnDaily

	var_1_10003(var_5.Find(var_12_1, "got"), not var_12_0)

	Color = var_1_10003

	local var_12_2 = var_1_10003.NewHex("393939")

	var_12_2.a = 0.8
	setBlackMask = var_4

	local var_12_3 = arg_12_0.btnDaily

	var_4(var_6.Find(var_12_3, "content"), not var_12_0, {
		color = var_12_2
	})
	...
	var_4(var_6.Find(var_12_4, "pick_up"), var_12_0)
...
function var_0_1.didEnter(arg_13_0)
	...
	local var_13_1 = var_1_10002.NewStoryMgr.GetInstance()
	local var_13_2 = arg_13_0.activity
	local var_13_3 = var_3.getNDay(var_13_2)

	ipairs = var_1_10004

	local var_13_4 = arg_13_0.activity

	for iter_13_0, iter_13_1 in var_1_10004(var_6.GetConfigClientSetting(var_13_4, "story")) do
		if iter_13_0 <= var_13_3 and not var_13_1:IsPlayed(iter_13_1[1]) then
			table = var_9

			var_9.insert(var_13_0, function(arg_14_0)
	...
	var_4(var_13_0, function()
		...
		if not arg_13_0.contextData.checkRalizeGift then
			...
			local var_15_1 = var_15_0(var_2_10002)
			...
			if var_15_0.IsTipRealizeGift(var_15_1) then
				...
				var_15_0(var_15_2, var_2_10003.ON_REALIZE_GIFT)
			end
		end
...
function var_0_1.UpdateSlider(arg_16_0)
	...
	var_16_0(var_5.Find(var_16_3, "Slider/progress"), var_16_1 .. "/" .. var_16_2)

	setSlider = var_16_0

	local var_16_4 = arg_16_0.rtSlider

	var_16_0(var_5.Find(var_16_4, "Slider"), 0, var_16_2, var_16_1)
	...
	if var_16_7 == 0 then
		...
		var_16_5(var_7.Find(var_16_8, "Slider"), 0, 1, 1)
	else
		setSlider = var_16_5

		local var_16_9 = arg_16_0.rtNow

		var_16_5(var_7.Find(var_16_9, "Slider"), 0, var_16_7, var_16_6)
	end

	setText = var_16_5

	local var_16_10 = arg_16_0.rtNow
	local var_16_11 = var_7.Find(var_16_10, "Text")

	string = var_8

	local var_16_12 = var_8.format

	setColorStr = var_10

	var_16_5(var_16_11, var_16_12(var_10("%d", "#CF90A8") .. "/%d", var_16_6, var_16_7))
...
function var_0_1.UpdatePainting(arg_17_0)
	...
	var_17_0(var_17_4, var_1_10006.format("%d/%d", var_17_2 - var_17_1, var_17_2))
...
function var_0_1.UpdateLoveLetterMedal(arg_18_0, arg_18_1)
	...
	local var_18_1 = var_4.Find(var_18_0, "tip")

	getProxy = var_1_10005
	LoveLetterProxy = var_7

	local var_18_2 = var_1_10005(var_7)

	var_1_10002(var_18_1, var_5.IsTipRealizeGift(var_18_2))
	...
	if var_7.CanLevelUp(var_18_7) then
		local var_18_8 = arg_18_0.ll.level
		local var_18_9 = arg_18_0.ll

		var_18_10 = var_18_8 < var_8.GetMaxLevel(var_18_9)
	end
	...
	local function var_18_13()
		...
		var_19_1(var_19_0, var_2_10003.ON_GO_TROPHY)
...
function var_0_1.ShowDailyPanel(arg_20_0)
	...
	var_20_1(var_20_0, var_4.Find(var_20_2, "medal"))
	...
	if var_20_5 == 0 then
		...
		var_20_3(var_5.Find(var_20_6, "Slider"), 0, 1, 1)
	else
		setSlider = var_20_3

		local var_20_7 = arg_20_0.rtDailyNow

		var_20_3(var_5.Find(var_20_7, "Slider"), 0, var_20_5, var_20_4)
	end

	setText = var_20_3

	local var_20_8 = arg_20_0.rtDailyNow
	local var_20_9 = var_5.Find(var_20_8, "Text")

	string = var_20_2

	local var_20_10 = var_20_2.format

	setColorStr = var_8

	var_20_3(var_20_9, var_20_10(var_8("%d", "#CF90A8") .. "/%d", var_20_4, var_20_5))
	...
	for iter_20_0 = 1, var_20_12 do
		...
		if var_9.getConfig(var_20_14, "config_data")[iter_20_0] then
			...
			local var_20_15 = var_20_16(var_12)
			local var_20_16

			if not var_20_16.getTaskVO(var_20_15, var_9) then
				var_20_16 = nil
			end
	...
	local var_20_20 = var_11.GetName(var_20_19)
	local var_20_21 = arg_20_0.dailyActivity

	var_5(var_20_17, iter_20_0(var_20_18, var_20_20, var_12.GetConfigClientSetting(var_20_21, "exp")))
...
function var_0_1.willExit(arg_23_0)
	...
	if var_1.Find(var_23_0, "medal").childCount > 0 then
		...
		var_1(var_3.Find(var_23_1, "medal"), function(arg_24_0, arg_24_1)
