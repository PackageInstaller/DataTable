...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_SELECT_GROUP, function(arg_2_0, arg_2_1)
		...
		LoveLetterSelectCharMediator = var_2_10008
		var_2_3.mediator = var_2_10008
		LoveLetterSelectCharLayer = var_2_10008
	...
	arg_1_0:bind(var_0_1.ON_DAILY_LOGIN_REWARD, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10005.SUBMIT_TASK, arg_4_1, nil)
	...
	arg_1_0:bind(var_0_1.ON_GO_COLLECTION, function(arg_5_0)
		...
		var_5_4.page = var_2_10007.PAGE_ALBUM
		WorldMediaCollectionAlbumGroupLayer = var_7
		var_5_4.albumType = var_7.ALBUM_TYPE_LOVE_LETTER
	...
	local var_1_3 = var_1_2(var_1_1, var_5.ACTIVITY_TYPE_LOVE_LETTER_UP)
...
function var_0_1.initNotificationHandleDic(arg_7_0)
	...
	var_7_0[var_2.SUBMIT_TASK_AWARD_DOWN] = function(arg_11_0, arg_11_1)
		...
		var_11_5(var_11_4, var_11_2.ON_ACHIEVE, var_11_0.awards, function()
			...
			ActivityProxy = var_3_10005

			local var_12_3 = var_3_10003(var_3_10005)

			var_12_2(var_12_1, var_3.getActivityById(var_12_3, arg_11_0.viewComponent.dailyActivity.id))
