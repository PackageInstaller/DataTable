...
function var_0_1.OnExecute(arg_2_0)
	...
	arg_2_0.unitId = var_2_2(var_2_1, var_3(var_1_10004)).id
	...
	arg_2_0.animator = var_2_5(var_2_4, var_5(var_1_10006))

	local var_2_6 = arg_2_0
	local var_2_7 = arg_2_0.GetBlackboardVariable(var_2_6, "pause")

	_IslandCore = var_2_6

	local var_2_8 = var_2_6:GetController().strollAllocator
	local var_2_9 = arg_2_0:GetFloatArg("pathId")

	arg_2_0.chaoticOrder = arg_2_0:GetBoolArg("chaoticOrder")

	local var_2_10 = var_2_8
	local var_2_11 = var_2_8.GetWaypoints(var_2_10, var_2_9)

	assert = var_2_10

	var_2_10(#var_2_11 > 0, "waypoints is empty")

	_ = var_2_10
	arg_2_0.waypoints = var_2_10.map(var_2_11, function(arg_3_0)
...
function var_0_1.UpdateRatation(arg_6_0)
	...
	Time = var_1_10006
	var_6_0.rotation = var_6_1(var_6_2, var_6_3, var_6_4 * var_1_10006.deltaTime)
	Vector3 = var_6_0
	...
	if var_6_5(var_6_6, var_3.ToEulerAngles(var_6_7).normalized) >= 0.95 then
...
function var_0_1.DoRatation(arg_18_0)
	local var_18_0 = arg_18_0:GetCurrWaypoint()

	if var_1.GetRotationWhenArrive(var_18_0) == 0 then
		return
	end
...
function var_0_1.ExecuteArriveAction(arg_19_0)
	...
	if not var_1.GetActionWhenArrive(var_19_0) then
		var_1_10004 = arg_19_0

		arg_19_0.EndArriveAction(var_1_10004)
	...
	IslandWayPoint = var_1_10004

	if var_19_1 == var_1_10004.ACTION_TYPE_CHATBUBBLE then
...
function var_0_1.ExecuteProcessAction(arg_28_0)
	...
	arg_28_0.PauseMove(var_28_1)

	local var_28_2 = var_2.type

	IslandWayPoint = var_28_1

	if var_28_2 == var_28_1.ACTION_TYPE_CHATBUBBLE then
		seriesAsync = var_28_2
		...
		local var_28_3 = var_2.type

		IslandWayPoint = var_4

		if var_28_3 == var_4.ACTION_TYPE_ANIM then
...
function var_0_1.OnDrawGizmosSelected(arg_34_0)
	...
	for iter_34_0 = 1, #var_1 do
		...
		local var_34_1 = var_7.DrawText
		local var_34_2 = "point" .. iter_34_0
		local var_34_3 = var_34_0

		Vector3 = var_1_10010

		var_34_1(var_34_2, var_34_3, var_1_10010(1, 0, 0))

		local var_34_4 = var_1[iter_34_0 + 1].position

		LuaHelper = var_34_2

		local var_34_5 = var_34_2.DrawLine
		local var_34_6 = var_34_0

		var_1_10010 = var_34_4
		Vector3 = var_11

		var_34_5(var_34_6, var_1_10010, var_11(1, 0, 0), 0)
	...
	local var_34_7 = var_3.DrawText
	local var_34_8 = "point" .. #var_1
	local var_34_9 = var_1[#var_1].position

	Vector3 = iter_34_0

	var_34_7(var_34_8, var_34_9, iter_34_0(1, 0, 0))

	LuaHelper = var_34_7

	local var_34_10 = var_34_7.DrawLine
	local var_34_11 = var_1[#var_1].position
	local var_34_12 = var_1[1].position

	Vector3 = var_6

	var_34_10(var_34_11, var_34_12, var_6(1, 0, 0), 0)
