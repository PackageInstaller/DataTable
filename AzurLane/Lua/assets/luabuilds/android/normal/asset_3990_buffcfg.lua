...
var_0_10001.buffCfg = var_0_10002({}, {
	__index = function(arg_1_0, arg_1_1)
		if var_0_0[arg_1_1] then
			...
			if var_3 then
				...
				var_3.insert(var_1_0, "GameCfg.battle_lua.buff_extra." .. arg_1_1)
			end
			...
			if var_3 then
				...
				var_3("找不到技能配置: " .. "GameCfg.buff." .. arg_1_1)
			end
...
var_0_10001.Battle.BattleDataFunction.ConvertBuffTemplate()
