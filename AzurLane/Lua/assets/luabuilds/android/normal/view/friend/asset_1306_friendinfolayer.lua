...
function var_0_1.init(arg_5_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_5_0.iconTF = var_5_3(var_5_2, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.playerNameTF = var_5_8(var_5_7, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.levelTF = var_5_11(var_5_10, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.resumeRank = var_5_15(var_5_14, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.nameTF = var_5_25(var_5_24, var_3(var_1_10004))
...
function var_0_1.Init(arg_8_0)
	...
	var_2(var_3.Find(var_8_1, "frame_for_backyard"), var_8_0)

	setActive = var_2

	local var_8_2 = arg_8_0._tf

	var_2(var_3.Find(var_8_2, "frame"), not var_8_0)
	...
	for iter_8_0, iter_8_1 in var_3(arg_8_0:GetBtnTags()) do
		...
		local var_8_7 = var_8_3.GetChild(var_8_6, iter_8_0 - 1)

		setActive = var_8_6

		var_8_6(var_8_7, true)

		onButton = var_8_6

		var_8_6(arg_8_0, var_8_7, function()
			if iter_8_1 == "" then
				return
			end
			...
			if iter_8_1 == "OPEN_INFORM" then
				...
				local var_9_1 = var_1(var_2_10002)
				...
				if not var_2_10002.contains(var_9_1.informs, var_9_0) then
					...
					var_2_10002.openInfromPanel(var_9_2)
				else
					pg = var_2_10002

					local var_9_3 = var_2_10002.TipsMgr.GetInstance()

					var_2_10002 = var_2_10002.ShowTips
					i18n = var_4

					var_2_10002(var_9_3, var_4("chat_msg_inform"))
				end
			else
				local var_9_4 = arg_8_0
				local var_9_5 = var_0.emit

				FriendInfoMediator = var_2_10002

				var_9_5(var_9_4, var_2_10002[iter_8_1])
			end

			return
		end)

		arg_8_0.btnTFs[iter_8_0] = var_8_7
	end

	if arg_8_0.btnTFs[6] then
		setActive = var_3

		local var_8_8 = arg_8_0.btnTFs[6]

		LOCK_ISLAND_DISPLAY = var_5

		var_3(var_8_8, not var_5)
	end
	...
	local var_8_9 = arg_8_0.btnTFs[2]
	local var_8_10 = arg_8_0.friendProxy

	var_3(var_8_9, not var_5.isFriend(var_8_10, arg_8_0.friend.id))

	local var_8_11 = arg_8_0

	arg_8_0.updateBlack(var_8_11)

	local var_8_12 = arg_8_0.contextData.form

	NotificationLayer = var_8_11

	if var_8_12 == var_8_11.FORM_BATTLE then
		setActive = var_8_12

		var_8_12(arg_8_0.btnTFs[3], false)
	end
	...
	var_8_12(var_4.Find(var_8_13, "frame/left_bg"), false)
...
function var_0_1.initInform(arg_11_0)
	...
	if arg_11_0.contextData.backyardView then
		...
		i18n = var_5
		var_1_10003.text = var_1_10004 .. var_5("backyard_theme_inform_them", arg_11_0.contextData.msg)
		require = var_1_10003
		...
		for iter_11_0, iter_11_1 in var_1_10003(var_11_1) do
			...
			var_10(arg_11_0, var_1_10008, function()
				...
				var_0(var_1.Find(var_12_0, "Background/Checkmark"), var_11_4)
	...
	var_1_10003(arg_11_0, arg_11_0.confirmBtn, function()
		if not arg_11_0.contextData.msg then
			...
			var_14_1(var_14_0, var_2_10002("inform_chat_msg"))
		...
		if var_0 then
			if #arg_11_0.informInfoForBackYard == 0 then
				...
				var_14_3(var_14_2, var_2_10002("inform_select_type"))
			...
			var_14_5(var_14_4, var_2_10002.INFORM_BACKYARD, arg_11_0.friend.id, arg_11_0.informInfoForBackYard, arg_11_0.contextData.msg, arg_11_0.friend.name)
		else
			if not arg_11_0.informInfo then
				...
				var_14_7(var_14_6, var_2_10002("inform_select_type"))
			...
			var_14_9(var_14_8, var_2_10002.INFORM, arg_11_0.friend.id, arg_11_0.informInfo, arg_11_0.contextData.msg)
		end
...
function var_0_1.initInfo(arg_18_0)
	...
	var_3("qicon/" .. var_18_1.painting, function(arg_19_0)
		...
		if not var_2_10001(arg_18_0.iconTF) then
			if not arg_19_0 then
				...
				var_19_0.sprite = var_2("heroicon/unknown", "")
			else
	...
	for iter_18_1 = 1, var_18_0.star do
		...
		var_18_2(var_18_3, iter_18_1 <= var_18_0.star)
	end
...
function var_0_1.updateBlack(arg_20_0)
	...
	var_20_0(var_3(arg_20_0.btnTFs[4], "black"), not var_20_1)

	setActive = var_20_0
	findTF = var_3

	var_20_0(var_3(arg_20_0.btnTFs[4], "unblack"), var_20_1)
