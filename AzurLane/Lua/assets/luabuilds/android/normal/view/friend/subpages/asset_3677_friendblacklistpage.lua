...
function var_0_1.UpdateData(arg_4_0, arg_4_1)
	...
	if not arg_4_0.isInit then
		...
		if not arg_4_0.blackVOs then
			...
			var_4_1(var_4_0, var_1_10004.GET_BLACK_LIST)
		else
...
function var_0_1.onInitItem(arg_8_0, arg_8_1)
	...
	var_3(arg_8_0, var_8_0.btn, function()
		pg = var_2_10000
		...
		i18n = var_2_10003
		var_9_2.content = var_2_10003("firend_relieve_blacklist_tip", var_8_0.friendVO.name)
		...
		function var_9_2.onYes()
			...
			var_10_1(var_10_0, var_3_10002.RELIEVE_BLACKLIST, var_8_0.friendVO.id)
