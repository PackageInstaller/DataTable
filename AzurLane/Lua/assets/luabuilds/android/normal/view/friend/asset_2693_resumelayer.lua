...
function var_0_1.init(arg_3_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.resumeLv = var_3_6(var_3_5, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.resumeName = var_3_9(var_3_8, var_3(var_1_10004))
...
function var_0_1.display(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_3.getEmblem(arg_6_1.score, arg_6_1.rank)
	...
	var_6_3(var_6_4 .. arg_6_1.getPainting(var_6_5), function(arg_7_0)
		IsNil = var_2_10001
		...
		if not var_2_10001(arg_6_0.resumeIcon) then
			...
			local var_7_2 = var_7_1(var_7_0, var_2_10003(var_2_10004))

			Color = var_7_0
			var_7_2.color = var_7_0.white
	...
	local var_6_6 = var_6_3.attireFrameRes
	local var_6_7 = arg_6_1
	local var_6_8 = arg_6_1.id

	getProxy = var_6_5
	PlayerProxy = var_1_10008

	local var_6_9 = var_6_5(var_1_10008)
	local var_6_10 = var_6_8 == var_7.getRawData(var_6_9).id

	AttireConst = var_7

	local var_6_11 = var_6_6(var_6_7, var_6_10, var_7.TYPE_ICON_FRAME, arg_6_1.propose)

	PoolMgr = var_6_7

	local var_6_12 = var_6_7.GetInstance()

	var_5.GetPrefab(var_6_12, "IconFrame/" .. var_6_11, var_6_11, true, function(arg_8_0)
		IsNil = var_2_10001
		...
		if arg_6_0.circle then
			...
			typeof = var_2_10004
			Image = var_2_10005
			var_8_1(var_8_0, var_2_10004(var_2_10005)).raycastTarget = false
			setParent = var_3
			...
			var_1.ReturnPrefab(var_8_2, "IconFrame/" .. var_6_11, var_6_11, arg_8_0)
		end
	...
	local var_6_13 = var_5.ship_data_statistics[arg_6_1.icon]

	Ship = var_6

	local var_6_14 = var_6.New({
		configId = var_6_13.id
	})
	local var_6_15 = arg_6_0.resumeStars.childCount
	local var_6_16 = var_6_14:getStar()

	for iter_6_0 = var_6_15, var_6_16 - 1 do
		cloneTplTo = var_1_10013

		var_1_10013(arg_6_0.resumeStarTpl, arg_6_0.resumeStars)
	end

	local var_6_17 = arg_6_0.resumeStars.childCount

	for iter_6_1 = 0, var_6_17 - 1 do
		local var_6_18 = arg_6_0.resumeStars
		local var_6_19 = var_1_10013.GetChild(var_6_18, iter_6_1).gameObject

		var_14.SetActive(var_6_19, iter_6_1 < var_6_13.star)
	end
	...
	for iter_6_2 = 1, 5 do
		...
		var_14(var_1_10013:Find("empty"), iter_6_2 > #arg_6_1.displayTrophyList)

		if iter_6_2 <= #arg_6_1.displayTrophyList then
			setActive = var_14

			var_14(var_1_10013:Find("icon"), true)

			local var_6_20 = arg_6_1.displayTrophyList[iter_6_2]

			Trophy = var_15

			local var_6_21

			if var_15.IsLoveLetterID(var_6_20) then
				LoveLetterTrophy = var_6_21
				var_6_21 = var_6_21.New({
					id = var_6_20
				})
				setLoveLetterMedal = var_16

				var_16(var_1_10013, var_6_21, {
					hideMark = true
				})
			else
				pg = var_6_21

				local var_6_22 = var_6_21.medal_template[arg_6_1.displayTrophyList[iter_6_2]]

				LoadImageSpriteAsync = var_16

				local var_6_23 = "medal/" .. var_6_22.icon

				var_1_10019 = var_1_10013

				var_16(var_6_23, var_1_10013.Find(var_1_10019, "icon"), true)
			end
		end
	end
	...
	for iter_6_3, iter_6_4 in var_9(var_0_2) do
		local var_6_24 = arg_6_0.resumeInfo
		local var_6_25 = var_14.GetChild(var_6_24, iter_6_3 - 1)

		setText = var_6_24

		var_6_24(var_6_25:Find("tag"), iter_6_4.tag)

		local var_6_26 = var_6_25:Find("value")

		if iter_6_4.type == 1 then
			setText = var_16

			var_16(var_6_26, arg_6_0.player[iter_6_4.value])
		elseif iter_6_4.type == 2 then
			math = var_16

			local var_6_27 = var_16.max(arg_6_0.player[iter_6_4.value[1]], 1)

			math = var_17

			local var_6_28 = var_17.max(arg_6_0.player[iter_6_4.value[2]], 0)

			setText = var_18
			var_1_10019 = var_6_26
			string = var_1_10020

			var_18(var_1_10019, var_1_10020.format("%0.2f", var_6_28 / var_6_27 * 100) .. "%")
		elseif iter_6_4.type == 3 then
			...
			var_17(var_6_30, var_1_10019(var_1_10020, var_6_29 / var_1_10021.getCollectionTotal(var_1_10022) * 100) .. "%")
		end
	end
...
function var_0_1.willExit(arg_9_0)
	...
	if arg_9_0.circle.childCount > 0 then
		local var_9_1 = arg_9_0.circle
		local var_9_2 = var_1.GetChild(var_9_1, 0).gameObject

		PoolMgr = var_9_1

		local var_9_3 = var_9_1.GetInstance()

		var_2.ReturnPrefab(var_9_3, "IconFrame/" .. var_9_2.name, var_9_2.name, var_9_2)
	end
