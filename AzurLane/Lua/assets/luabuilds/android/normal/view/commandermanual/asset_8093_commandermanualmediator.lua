...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.SUBMIT_TASK, {
			normal_submit = true,
			virtual = false,
			taskId = arg_3_1.id
		}, arg_3_2)
	...
	arg_1_0:bind(var_0_1.GET_PT_AWARD, function(arg_4_0, arg_4_1)
		...
		local var_4_2 = var_2_10004.COMMANDER_MANUAL_OP
		local var_4_3 = {}

		CommanderManualProxy = var_2_10006
		var_4_3.operation = var_2_10006.GET_PT_AWARD
	...
	arg_1_0:bind(var_0_1.ON_TRIGGER, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10004.ACTIVITY_OPERATION, arg_5_1)
	...
	arg_1_0:bind(var_0_1.ON_UPDATE, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.UPDATE_TASK_PROGRESS, {
			taskId = arg_6_1.id
		})
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_2.SUBMIT_TASK_DONE then
		var_8_4 = #var_8_1
		...
		if 0 < var_8_4 then
			...
			var_8_4(var_1_10006, var_1_10007.ON_ACHIEVE, var_8_1)
		end

		if arg_8_0.viewComponent.contextData.currentPageId then
			var_8_4 = var_8_3[1]
			getProxy = var_1_10006
			CommanderManualProxy = var_1_10007
			var_1_10007 = var_1_10006(var_1_10007)
			var_1_10006 = var_1_10006.GetPageById(var_1_10007, arg_8_0.viewComponent.contextData.currentPageId)
			table = var_1_10007

			if var_1_10007.contains(var_1_10006.taskIdList, var_8_4) and not var_1_10006:IsTaskComplete(var_8_4) then
				var_1_10006:AddFinishedTaskId(var_8_4)
				var_1_10006:AddPt()
			end
		end
		...
		var_8_4.RefreshAll(var_1_10006)
	else
		GAME = var_8_4

		local var_8_5

		if var_8_0 == var_8_4.COMMANDER_MANUAL_OP_DONE then
			var_8_5 = var_8_1.operation
			CommanderManualProxy = var_1_10006

			if var_8_5 == var_1_10006.GET_TASK then
				-- block empty
			else
				var_8_5 = var_8_1.operation
				CommanderManualProxy = var_6

				if var_8_5 == var_6.GET_PT_AWARD then
					local var_8_6 = arg_8_0.viewComponent

					var_8_5 = var_8_5.emit
					BaseUI = var_1_10007

					var_8_5(var_8_6, var_1_10007.ON_ACHIEVE, var_8_1.awards)
				end
			end

			local var_8_7 = arg_8_0.viewComponent

			var_8_5.RefreshAll(var_8_7)
		else
			ActivityProxy = var_8_5

			if var_8_0 == var_8_5.ACTIVITY_OPERATION_DONE and var_8_1 == arg_8_0.viewComponent.techActivity.id then
				local var_8_8 = arg_8_0.viewComponent

				var_5.UpdateTechActivity(var_8_8)
