...
function var_0_0.IsFirstEnterAct(arg_2_0)
	...
	return var_2_0.GetInt(var_0_1 .. var_2_1 .. "_" .. arg_2_0.id, 0) == 0
end
...
function var_0_0.UpdateActEnterTip(arg_3_0)
	...
	var_3_0.SetInt(var_0_1 .. var_3_1 .. "_" .. arg_3_0.id, 1)
...
function var_0_0.UnlockShopPhase(arg_6_0)
	...
	var_6_8 = var_4.GetSeasonShops(var_6_7)[var_6_4] and var_4:IsInTime()
...
function var_0_0.IsFirstEnterShopPhase(arg_7_0)
	...
	return var_7_0.GetInt(var_0_2 .. var_7_1 .. "_" .. arg_7_0, 0) == 0
end
...
function var_0_0.UpdateEnterShopPhase(arg_8_0)
	...
	var_8_0.SetInt(var_0_2 .. var_8_1 .. "_" .. arg_8_0, 1)
...
function var_0_0.IsFirstEnterReview()
	...
	PlayerPrefs = var_14_0

	return var_14_0.GetInt(var_0_3 .. var_14_1, 0) == 0
end
...
function var_0_0.UpdateEnterReview()
	...
	var_15_0.SetInt(var_0_3 .. var_15_1, 1)
