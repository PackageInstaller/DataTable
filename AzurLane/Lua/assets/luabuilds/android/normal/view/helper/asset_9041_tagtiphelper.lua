...
function var_0_0.FuDaiTagTip(arg_1_0)
	...
	local var_1_1 = var_2.pay_data_display
	...
	for iter_1_0, iter_1_1 in var_3(var_1_1.all) do
		if var_1_1[iter_1_1].type == 1 then
			...
			local var_1_2 = var_1_10008.TimeMgr.GetInstance()

			if var_1_10008.inTime(var_1_2, var_1_1[iter_1_1].time) then
				type = var_1_10008

				if var_1_10008(var_1_1[iter_1_1].time) == "table" then
					table = var_1_10008

					var_1_10008.insert(var_1_0, var_1_1[iter_1_1])
				end
			end
		end
	end
	...
	if 0 < var_1_3 then
		local function var_1_4(arg_2_0)
			...
			local var_2_3 = var_2_1.GetInt("Ever_Enter_Mall_", 0)
		...
		local var_1_5 = var_4(var_5)

		if not var_4.getChargedList(var_1_5) then
			pg = var_1_5

			local var_1_6 = var_1_5.m02
			local var_1_7 = var_6.sendNotification

			GAME = var_1_10008

			var_1_7(var_1_6, var_1_10008.GET_CHARGE_LIST, {
				callback = function()
					local var_4_0 = var_0
...
function var_0_0.SkinTagTip(arg_6_0)
	...
	local var_6_0 = var_1_10001(var_2)
	...
	for iter_6_0, iter_6_1 in var_3(var_6_1) do
		...
		if var_6_3 == var_1_10009.TYPE_SKIN then
			...
			if var_6_3(iter_6_1.getConfig(var_6_4, "time")) == "table" then
				local var_6_5 = iter_6_1.genre

				ShopArgs = var_1_10009

				if var_6_5 ~= var_1_10009.SkinShopTimeLimit then
					table = var_6_5

					local var_6_6 = var_6_5.insert

					var_1_10009 = var_6_2
					pg = var_6_4

					local var_6_7 = var_6_4.TimeMgr.GetInstance()

					var_6_6(var_1_10009, var_10.parseTimeFromConfig(var_6_7, iter_6_1:getConfig("time")[1]))
				end
			end
		end
	end
...
function var_0_0.FreeGiftTag(arg_11_0)
	...
	if not var_1.getChargedList(var_11_0) then
		...
		local var_11_1 = var_11_0.m02

		var_11_0 = var_11_0.sendNotification
		GAME = var_1_10005

		var_11_0(var_11_1, var_1_10005.GET_CHARGE_LIST, {
			callback = function()
				_ = var_2_10000
				...
				if var_2_10000.all(arg_11_0, function(arg_13_0)
					...
					for iter_12_0, iter_12_1 in var_0(arg_11_0) do
						...
						var_2_10005(var_12_0, var_7.checkHasFreeNormal(var_12_1))
					end
				end
		...
		for iter_11_0, iter_11_1 in var_11_0(arg_11_0) do
...
function var_0_0.FreeBuildTicketTip(arg_14_0, arg_14_1)
	...
	if var_2.IsShowFreeBuildMark(var_14_0, false) then
		...
		LoadImageSpriteAtlasAsync = var_14_0
		Drop = var_5
		...
		var_14_2.type = var_1_10007
		var_14_2.id = var_3:getConfig("config_client")[1]

		local var_14_3 = var_14_1(var_14_2)

		var_14_0(var_5.getIcon(var_14_3), "", arg_14_0:Find("Image"))

		tostring = var_14_0
		var_14_0 = var_14_0(var_3.data1)
		...
		local var_14_5 = arg_14_0.Find(var_14_4, "Text")

		i18n = var_14_4

		var_5(var_14_5, var_14_4("build_ticket_expire_warning", var_14_0))

		var_0_0.BuildMark = true
	else
		setActive = var_14_0

		var_14_0(arg_14_0, false)
	end
...
function var_0_0.TecShipGiftTip(arg_15_0)
	...
	local var_15_2 = var_1_10003(var_1_10004)
	local var_15_3 = var_15_1 <= var_3.getData(var_15_2).level

	PlayerPrefs = var_1_10005

	local var_15_4 = var_1_10005.GetInt("Tec_Ship_Gift_Enter_Tag", 0) > 0
	local var_15_5 = false

	ipairs = var_7
	pg = var_1_10008

	for iter_15_0, iter_15_1 in var_7(var_1_10008.pay_data_display.all) do
		table = var_1_10012
...
function var_0_0.SetFreeBuildMark()
	if var_0_0.BuildMark then
		...
		if var_0.IsShowFreeBuildMark(var_16_0, false) then
			...
			var_16_1(var_16_2, var_3.CurrentSTimeDesc(var_16_3, "%Y/%m/%d"))
