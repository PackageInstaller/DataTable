...
local var_0_1 = var_1.ship_skin_expression

pg = var_0_10002

local var_0_2 = var_0_10002.ship_skin_expression_ex
local var_0_3 = false
...
function var_0_0._UpdateExpression(arg_9_0, arg_9_1, arg_9_2)
	...
	if var_4(arg_9_0, "face_sub") then
