...
function var_0_0.GenBuffsForActivity(arg_1_0)
	...
	if not arg_1_0.GetBuffList(var_1_0) then
		var_1_1 = {}
	end

	switch = var_1_0

	local var_1_2 = arg_1_0:getConfig("type")
	local var_1_3 = {}

	ActivityConst = var_5
	var_1_3[var_5.ACTIVITY_TYPE_BUFF] = function()
		...
		if var_4_1 == 0 then
			...
			var_4_2 = var_2.getConfig(var_4_3, "config_data")
		else
			table = var_2

			var_2.insert(var_4_2, var_4_1)
		end

		ipairs = var_2

		for iter_4_0, iter_4_1 in var_2(var_4_2) do
			ActivityBuff = var_2_10007
			var_2_10007 = var_2_10007.New(arg_1_0.id, iter_4_1)
			table = var_8

			var_8.insert(var_1_1, var_2_10007)
		end

		return
	end
	ActivityConst = var_5
	var_1_3[var_5.ACTIVITY_TYPE_BUILDING_BUFF] = function()
		...
		for iter_5_0, iter_5_1 in var_5_0(var_5_1) do
			...
			if var_2_10006.activity_event_building[iter_5_1] then
				...
				var_2_10007.each(var_2_10006.buff, function(arg_6_0)
					...
					local var_6_1 = var_1_1

					ActivityBuff = var_3_10003

					var_6_0(var_6_1, var_3_10003.New(arg_1_0.id, arg_6_0))
	...
	ActivityConst = var_5
	var_1_3[var_5.ACTIVITY_TYPE_BUILDING_BUFF_2] = function()
		...
		for iter_7_0, iter_7_1 in var_7_0(var_7_1) do
			...
			if var_2_10006.activity_event_building[iter_7_1] then
				...
				var_2_10007.each(var_2_10006.buff, function(arg_8_0)
					...
					var_8_0(var_8_1, var_3_10003.New(arg_1_0.id, arg_8_0))
		...
		if 0 < var_7_3 then
			...
			if var_2.activity_event_building[var_7_3] then
				...
				var_3.each(var_2.buff, function(arg_9_0)
					table = var_3_10001

					local var_9_0 = var_3_10001.insert
					local var_9_1 = var_1_1

					ActivityBuff = var_3_10003

					var_9_0(var_9_1, var_3_10003.New(arg_1_0.id, arg_9_0))
	...
	ActivityConst = var_5
	var_1_3[var_5.ACTIVITY_TYPE_PT_BUFF] = function()
		...
		for iter_10_0, iter_10_1 in var_2_10001(var_10_0) do
			...
			local var_10_1 = var_1_1

			ActivityBuff = var_2_10008

			var_2_10006(var_10_1, var_2_10008.New(arg_1_0.id, iter_10_1))
		end

		return
	end
	ActivityConst = var_5
	var_1_3[var_5.ACTIVITY_TYPE_ATELIER_LINK] = function()
		...
		for iter_11_0, iter_11_1 in var_11_0(var_11_1) do
			...
			if var_11_2 > 0 and 0 < var_11_3 then
				...
				local var_11_5 = var_1_1

				ActivityBuff = var_2_10010
				var_2_10010 = var_2_10010.New

				local var_11_6 = arg_1_0.id

				AtelierMaterial = var_2_10012

				local var_11_7 = var_2_10012.New({
					configId = var_11_2
				})

				var_11_4(var_11_5, var_2_10010(var_11_6, var_2_10012.GetBuffs(var_11_7)[var_11_3]))
			end
		end
	...
	underscore = var_1_3
	var_1_4[var_1_5] = var_1_3.map(var_1_1, function(arg_12_0)
...
function var_0_0.GetBenefitTypeBuffs(arg_14_0)
	...
	local var_14_1 = var_1_10003(var_1_10004)
	local var_14_2 = var_3.getRawData(var_14_1)

	for iter_14_0, iter_14_1 in var_1_10002(var_3.GetBuffs(var_14_2)) do
...
function var_0_0.GetAllBuff()
	...
	local var_16_1 = var_1_10001(var_1_10002)
	local var_16_2 = var_1.getRawData(var_16_1)
	local var_16_3 = var_16_0(var_1.GetBuffs(var_16_2), function(arg_17_0)
	...
	local var_16_4 = var_1(var_2)
	local var_16_5 = var_1.getRawData(var_16_4)

	pairs = var_16_4

	for iter_16_0, iter_16_1 in var_16_4(var_16_5) do
		table = var_1_10007
...
function var_0_0.GetBackYardExpBuffs()
	...
	BuffUsageConst = var_1_10002

	return var_19_0(var_19_1(var_1_10002.DORM_EXP), function(arg_20_0)
...
function var_0_0.GetBackYardEnergyBuffs()
	...
	return var_21_0(var_21_1(var_1_10002.DORM_ENERGY), function(arg_22_0)
...
function var_0_0.GetShipModExpBuff()
	...
	return var_23_0(var_23_1(var_1_10002.SHIP_MOD_EXP), function(arg_24_0)
...
function var_0_0.GetBackYardPlayerBuffs()
	...
	local var_25_2 = var_2.getRawData(var_25_1)

	for iter_25_0, iter_25_1 in var_1_10001(var_2.GetBuffs(var_25_2)) do
		CommonBuff = var_1_10006

		local var_25_3 = var_1_10006.New(iter_25_1)
		local var_25_4 = var_1_10006.getConfig(var_25_3, "benefit_type")

		BuffUsageConst = var_25_3

		if var_25_4 == var_25_3.DORM_EXP then
			table = var_25_4
...
function var_0_0.GetBattleBuffs(arg_27_0)
	...
	BuffUsageConst = var_1_10003

	return var_27_0(var_27_1(var_1_10003.BATTLE), function(arg_28_0)
...
function var_0_0.GetBuffsByActivityType(arg_29_0)
	...
	var_29_1.each(var_29_2, function(arg_30_0)
		table = var_2_10001
...
function var_0_0.GetBuffsForMainUI()
	...
	local var_32_0 = var_1_10000(var_1_10001)
	local var_32_1 = var_0_0.GetBuffsByActivityType

	ActivityConst = var_1_10002

	for iter_32_0 = #var_32_1(var_1_10002.ACTIVITY_TYPE_BUFF), 1, -1 do
	...
	if var_32_4(var_32_3, var_4.ACTIVITY_TYPE_MINIGAME) then
		var_32_5 = var_2

		if not var_2.isEnd(var_32_5) then
			var_32_5 = var_2
			var_32_3 = var_2.getConfig(var_32_5, "config_client").bufflist
			getProxy = var_32_5
			PlayerProxy = iter_32_0
			iter_32_0 = var_32_5(iter_32_0)
			var_32_5 = var_32_5.getRawData(iter_32_0)
			pairs = iter_32_0

			for iter_32_1, iter_32_2 in iter_32_0(var_32_5.buff_list) do
				pg = var_1_10010

				local var_32_6 = var_1_10010.TimeMgr.GetInstance()

				if var_1_10010.GetServerTime(var_32_6) < iter_32_2.timestamp then
					table = var_1_10012

					if var_1_10012.contains(var_32_3, iter_32_2.id) then
	...
	local var_32_8 = var_32_3(var_32_5)
	local var_32_9 = var_3.GetMiniGameDataByType

	MiniGameConst = iter_32_0

	local var_32_10

	if var_32_9(var_32_8, iter_32_0.MG_TYPE_3) then
		getProxy = var_32_8
		PlayerProxy = var_32_10
		var_32_10 = var_32_8(var_32_10)
		var_32_8 = var_32_8.getRawData(var_32_10)
		var_1_10006 = var_3
		var_32_10 = var_3.getConfig(var_1_10006, "config_data")[2]
		var_1_10006 = nil
		ipairs = var_7

		for iter_32_3, iter_32_4 in var_7(var_32_8.buff_list) do
			table = var_1_10012

			if var_1_10012.indexof(var_32_10, iter_32_4.id, 1) then
				pg = var_1_10012
				var_1_10013 = var_1_10012.TimeMgr.GetInstance()

				if var_1_10012.GetServerTime(var_1_10013) < iter_32_4.timestamp then
					local var_32_11 = var_32_0
					local var_32_12 = var_32_0.getActivityByType

					ActivityConst = var_1_10016

					local var_32_13 = var_32_12(var_32_11, var_1_10016.ACTIVITY_TYPE_MINIGAME)

					ActivityBuff = var_32_11
					var_1_10017 = var_32_11.New(var_32_13.id, iter_32_4.id, iter_32_4.timestamp)

					if var_15.checkShow(var_1_10017) then
						table = var_1_10016

						var_1_10016.insert(var_1, var_15)
					end
				end
	...
	local var_32_14 = var_32_8(var_32_10)
	local var_32_15 = var_4.GetMiniGameDataByType

	MiniGameConst = var_1_10006

	if var_32_15(var_32_14, var_1_10006.MG_TYPE_5) then
		getProxy = var_32_14
		PlayerProxy = var_6

		local var_32_16 = var_32_14(var_6)
		local var_32_17 = var_5.getRawData(var_32_16)
		local var_32_18 = var_4:getConfig("config_data")[2]
		local var_32_19

		ipairs = var_8

		for iter_32_5, iter_32_6 in var_8(var_32_17.buff_list) do
			table = var_1_10013

			if var_1_10013.indexof(var_32_18, iter_32_6.id, 1) then
				pg = var_1_10013

				local var_32_20 = var_1_10013.TimeMgr.GetInstance()

				if var_1_10013.GetServerTime(var_32_20) < iter_32_6.timestamp then
					local var_32_21 = var_32_0
					local var_32_22 = var_32_0.getActivityByType

					ActivityConst = var_1_10017

					local var_32_23 = var_32_22(var_32_21, var_1_10017.ACTIVITY_TYPE_MINIGAME)

					ActivityBuff = var_32_21

					local var_32_24 = var_32_21.New(var_32_23.id, iter_32_6.id, iter_32_6.timestamp)

					if var_16.checkShow(var_32_24) then
						table = var_1_10017

						var_1_10017.insert(var_1, var_16)
					end
				end
