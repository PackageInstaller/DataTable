...
function var_0_0.GetRemasterByActivityId(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10001(var_1_10002.re_map_template.all) do
		pg = var_1_10006
...
function var_0_0.UnlockMemoryGroupStories(arg_7_0, arg_7_1)
	...
	if arg_7_1.sync then
		...
		var_7_1(var_7_0, var_1_10005.STORY_UPDATE_LIST, {
			storyIds = var_2,
...
function var_0_0.ShowUnlockMemoryMsgBox(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	pg = var_1_10009
	var_8_2.content = var_1_10007(var_8_3, var_1_10009.memory_group[arg_8_0].title)
...
function var_0_0.MarkMemoryGroupNotification(arg_9_0)
	...
	var_9_0.SetInt("MEMORY_GROUP_NOTIFICATION" .. var_9_1 .. " " .. arg_9_0, 1)
...
function var_0_0.IsAllStoriesPlayed(arg_10_0)
	...
	local var_10_3 = var_10_1.memory_template
...
function var_0_0.UnlockMemoryGroupStoriesAndShowMsgBox(arg_11_0, arg_11_1)
	...
	var_0_0.ShowUnlockMemoryMsgBox(arg_11_0, var_3, function()
		...
		local var_12_3 = var_2_10003.WORLD_COLLECTION
		local var_12_4 = {}

		WorldMediaCollectionScene = var_2_10005
		var_12_4.page = var_2_10005.PAGE_MEMORTY
...
function var_0_0.GetPermanentActivityTicketCost(arg_14_0, arg_14_1)
	if arg_14_0 and arg_14_1 then
		...
		for iter_14_0, iter_14_1 in var_3(var_14_0) do
...
function var_0_0.GetAllNonActivityIds()
	...
	var_16_1(var_1_10002.re_map_template.all, function(arg_17_0)
...
function var_0_0.GetProgress(arg_18_0)
	...
	if var_0_0.IsRemasterByActivity(arg_18_0) then
		...
		if var_1.re_map_template[arg_18_0] then
			...
			var_18_1 = var_18_1.getActivityById(var_18_0, var_1.activity_id)
		end
		...
		for iter_18_0, iter_18_1 in var_1_10004(var_1.config_data) do
			if var_18_1:HasPassSeries(iter_18_1) then
				math = var_9
				var_18_2 = var_9.max(var_18_2, var_1.chapter_progress[iter_18_0])
			end
		end
		...
		getProxy = var_1
		ChapterProxy = var_18_1

		local var_18_3 = var_1(var_18_1)

		pg = var_18_1

		local var_18_4 = var_18_1.re_map_template[arg_18_0]
		local var_18_5 = 0

		ipairs = var_1_10004

		for iter_18_2, iter_18_3 in var_1_10004(var_18_4.config_data) do
			local var_18_6 = var_18_3:getChapterById(iter_18_3)

			if var_9.isClear(var_18_6) then
				math = var_9
				var_18_5 = var_9.max(var_18_5, var_18_4.chapter_progress[iter_18_2])
			end
		end
...
function var_0_0.ChapterAwardInfo(arg_19_0, arg_19_1)
	...
	local var_19_1 = var_1_10003(var_1_10004)
