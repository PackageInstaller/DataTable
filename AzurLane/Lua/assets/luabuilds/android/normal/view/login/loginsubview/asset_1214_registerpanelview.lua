...
function var_0_1.InitEvent(arg_5_0)
	...
	local function var_5_2()
		...
		if var_2_10000(arg_5_0.registerUsername) == "" then
			...
			var_6_1(var_6_0, var_2_10003("login_loginScene_error_noUserName"))

			ActivateInputField = var_6_1

			var_6_1(arg_5_0.registerUsername)
		...
		if var_6_1.New({
			...
			local var_6_2 = arg_5_0.event
			local var_6_3 = var_2.emit

			LoginMediator = var_2_10004

			var_6_3(var_6_2, var_2_10004.ON_REGISTER, var_1)
		end
	...
	local function var_5_5()
		...
		var_7_3[1] = var_2_10004.DEFINE.LOGIN_PANEL_VIEW
