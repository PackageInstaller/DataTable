...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.propertyPanel = var_2_12(var_2.Find(var_2_13, "bg/property_panel/frame"))
...
function var_0_1.onBackPressed(arg_3_0)
	...
	if var_3_0(var_1_10002(arg_3_0.propPanel)) then
		return
	end
...
function var_0_1.switchPanel(arg_4_0)
	...
	local var_4_5 = var_4_4(var_4_3, var_1_10004(var_1_10005))

	LeanTween = var_4_3

	local var_4_6 = var_4_3.value

	go = var_4

	local var_4_7 = var_4_6(var_4(arg_4_0.propPanel), 0, 1, 0.5)
	local var_4_8 = var_3.setOnUpdate

	System = var_5

	local var_4_9 = var_4_8(var_4_7, var_5.Action_float(function(arg_5_0)
	...
	var_4_10(var_4_9, var_5.Action(function()
	...
	Vector3 = var_4_9
	var_4_11.localPosition = var_4_9.New(-1000, arg_4_0.skillPanel.localPosition.y, arg_4_0.skillPanel.localPosition.z)
	LeanTween = var_4_11
	...
	var_4_14.moveY(var_4_13, -328, 0.2)
	...
	for iter_4_0 = 1, 3 do
		...
		setImageAlpha = var_4_18

		var_4_18(var_4_17, 1)

		LeanTween = var_4_18

		var_4_18.alpha(var_4_17, 0, 0.25)
		...
		var_4_20(var_12(var_4_17), var_4_19.position, 0.3)
...
function var_0_1.initCharacters(arg_7_0)
	...
	for iter_7_0 = 1, 3 do
		...
		local var_7_1 = var_5.Find(var_7_0, "prop_panel/bg/characters/character_" .. iter_7_0)

		onToggle = var_7_0

		var_7_0(arg_7_0, var_7_1, function(arg_8_0)
			if arg_8_0 then
				local var_8_0 = arg_7_0

				var_2_10001.selectCharacterByIdx(var_8_0, var_7_1, var_0_6[iter_7_0])

				setActive = var_2_10001

				local var_8_1 = var_7_1

				var_2_10001(var_2.Find(var_8_1, "selected"), true)

				local var_8_2 = var_7_1

				var_2_10001 = var_2_10001.GetComponent
				typeof = var_3
				RectTransform = var_4
				var_2_10001 = var_2_10001(var_8_2, var_3(var_4))
				Vector2 = var_8_2
				var_2_10001.sizeDelta = var_8_2(196, 196)
			else
				setActive = var_2_10001

				local var_8_3 = var_7_1

				var_2_10001(var_2.Find(var_8_3, "selected"), false)

				local var_8_4 = var_7_1
				...
				Vector2 = var_8_4
				var_8_6.sizeDelta = var_8_4(140, 140)
			end
	...
	for iter_7_1 = 1, 3 do
		local var_7_3 = arg_7_0.characters
		local var_7_4 = var_6.Find(var_7_3, "character_" .. iter_7_1)

		onButton = var_7_3

		var_7_3(arg_7_0, var_7_4, function()
			...
			var_0(var_1.Find(var_9_1, "prop_panel/bg/characters/character_" .. iter_7_1), true)

			return
		end)

		Vector3 = var_7_3
		var_7_4.localPosition = var_7_3.New(var_7_4.localPosition.x, 912, var_7_4.localPosition.z)
		setImageAlpha = var_7
		...
		local var_7_5 = var_7.alpha(var_7_4, 1, 0.3)

		var_7.setDelay(var_7_5, var_7_2[iter_7_1])

		LeanTween = var_7

		local var_7_6 = var_7.moveY(var_7_4, 0, 0.2)

		var_7.setDelay(var_7_6, var_7_2[iter_7_1])
	end
...
function var_0_1.didEnter(arg_10_0)
	...
	local function var_10_5()
		...
		local var_12_1 = var_12_0[var_2_10002.random(#var_0[1])]
		local var_12_2 = var_0[2]

		math = var_3

		local var_12_3 = var_12_2[var_3.random(#var_0[2])]
	...
	var_1_10001(var_10_3, var_10_4, var_10_5, var_5)
	...
	local function var_10_8()
		...
		if not arg_10_0.contextData.configId then
			...
			var_13_1(var_13_0, var_2_10002("login_newPlayerScene_error_notChoiseShip"))
		...
		if var_13_1(arg_10_0.nickname) == "" then
			...
			local var_13_2 = var_13_3.TipsMgr.GetInstance()

			var_13_3 = var_13_3.ShowTips
			i18n = var_2_10003

			var_13_3(var_13_2, var_2_10003("login_newPlayerScene_inputName"))

			return
		end

		nameValidityCheck = var_13_3

		if not var_13_3(var_0, 4, 14, {
			"spece_illegal_tip",
		...
		local var_13_4 = arg_10_0.event
		local var_13_5 = var_1.emit

		NewPlayerMediator = var_3

		var_13_5(var_13_4, var_3.ON_CREATE, var_0, arg_10_0.contextData.configId)
	...
	var_1_10001(var_10_6, var_10_7, var_10_8, var_5)
...
function var_0_1.selectCharacterByIdx(arg_15_0, arg_15_1, arg_15_2)
	...
	arg_15_0.initSkills(var_15_1)

	pg = var_3

	local var_15_2 = var_3.ship_data_statistics[arg_15_2]

	setPaintingPrefab = var_15_1

	var_15_1(arg_15_0.paintTF, var_0_7[arg_15_2], "chuanwu")

	setText = var_15_1

	local var_15_3 = arg_15_0.nameTF

	var_15_1(var_5.Find(var_15_3, "name_mask/Text"), var_15_2.name)

	setText = var_15_1

	local var_15_4 = arg_15_0.nameTF

	var_15_1(var_5.Find(var_15_4, "english_name"), var_15_2.english_name)

	setText = var_15_1

	local var_15_5 = arg_15_0.nameEnTF

	string = var_6

	var_15_1(var_15_5, var_6.upper(var_15_2.english_name))

	Ship = var_15_1

	local var_15_6 = var_15_1.New({
		configId = arg_15_0.contextData.configId
	})

	if var_4.getPrefab(var_15_6) == arg_15_0.shipPrefab then
		return
	end
	...
	local var_15_7 = var_6.UIMgr.GetInstance()

	var_6.LoadingOn(var_15_7)

	PoolMgr = var_6

	local var_15_8 = var_6.GetInstance()

	var_6.GetSpineChar(var_15_8, var_5, true, function(arg_16_0)
		pg = var_2_10001
		...
		local var_16_5 = var_2(arg_16_0)

		Layer = var_3

		var_16_4(var_16_5, var_3.UI)
...
function var_0_1.initSkills(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_2(var_17_0.buff_list_display) do
		...
		local var_17_1 = var_8.contains(var_17_0.buff_list, iter_17_1)

		cloneTplTo = var_9

		local var_17_2 = var_9(arg_17_0.skillTpl, arg_17_0.skillContainer)

		setActive = var_10

		var_10(var_17_2:Find("mask"), not var_17_1)
		...
		local function var_17_5()
			...
			NewPlayerMediator = var_2_10002

			var_18_1(var_18_0, var_2_10002.ON_SKILLINFO, var_1_10007.id)
		...
		var_10(var_17_3, var_17_4, var_17_5, var_1_10014)

		LoadImageSpriteAsync = var_10

		local var_17_6 = "skillicon/" .. var_1_10007.icon

		findTF = var_12

		var_10(var_17_6, var_12(var_17_2, "icon"))
	end
