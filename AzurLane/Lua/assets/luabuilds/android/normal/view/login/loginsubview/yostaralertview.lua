...
function var_0_1.OnInit(arg_4_0)
	...
	var_1(var_4_12, var_3("email_text"))
	...
	var_1(var_4_13, var_3("emailhold_text"))
	...
	var_1(var_4_14, var_3("code_text"))
	...
	var_1(var_4_15, var_3("codehold_text"))
	...
	var_1(var_4_16, var_3("genBtn_text"))
	...
	var_1(var_4_17, var_3("desc_text"))
...
function var_0_1.InitEvent(arg_5_0)
	...
	var_1_10001(arg_5_0, arg_5_0.yostarGenCodeBtn, function()
		...
		if var_2_10000(arg_5_0.yostarEmailTxt) ~= "" then
			...
			local var_7_0 = var_1.SdkMgr.GetInstance()

			var_1.VerificationCodeReq(var_7_0, var_0)

			local var_7_1 = arg_5_0

			var_1.CheckAiriGenCodeCounter(var_7_1)
		else
			pg = var_1
			...
			var_7_3(var_7_2, var_2_10003("verification_code_req_tip1"))
		end
	...
	var_1_10001(arg_5_0, arg_5_0.yostarSureBtn, function()
		...
		local var_8_1 = var_1(arg_5_0.yostarCodeTxt)
		local var_8_3
		...
		if var_8_0 ~= "" and var_8_1 ~= "" then
			if arg_5_0.contextData.isLinkMode == true then
				...
				var_8_3(var_8_2, var_2_10004, var_8_0, var_8_1)
			else
				pg = var_8_3
				...
				var_8_3(var_8_4, var_2_10004, var_8_0, var_8_1)
			end
		else
			pg = var_8_3
			...
			var_8_6(var_8_5, var_2_10004("verification_code_req_tip3"))
		end
	...
	if var_1_10001() > 0 then
		...
		arg_9_0.genCodeTimer = var_1.New(function()
			...
			if 0 < var_10_0 then
				...
				var_1(var_10_1, var_2_10003("genBtn_text"))
