...
function var_0_1.init(arg_7_0)
	...
	var_2(var_7_14, var_4 == var_7_7)

	PLATFORM_CODE = var_2
	PLATFORM_CH = var_7_14

	if var_2 == var_7_14 then
	...
	arg_7_0.pressToLogin = var_2(var_3.Find(var_7_16, "background/press_to_login"), "CanvasGroup")
	LeanTween = var_2
	...
	local var_7_20 = var_7_19(var_7_18, var_4.easeInOutSine)
	...
	arg_7_0.switchGatewayBtn = var_7_34(var_3.Find(var_7_35, "servers/panel/panel/switch_platform"))
	PLATFORM = var_7_36
	...
	if var_7_36 == var_3 then
		...
		arg_7_0.switchGatewayBtn4Oh = var_7_36(var_3.Find(var_7_37, "servers/panel/panel/switch_platform"))
	end
	...
	var_2(var_7_42, var_4("query_role_button"))

	GetComponent = var_2

	local var_7_43 = arg_7_0.adapt
	local var_7_44 = var_3.Find(var_7_43, "servers/panel/panel/servers")

	typeof = var_7_43
	CanvasGroup = var_5
	arg_7_0.serverPanelCanvas = var_2(var_7_44, var_7_43(var_5))
	onButton = var_2
	...
	local function var_7_47()
		...
		var_9_2(var_9_1, var_2.ON_SEARCH_ACCOUNT, {
			callback = function()
	...
	var_2(var_7_45, var_7_46, var_7_47, var_1_10006)
	...
	PLATFORM_CODE = var_2
	PLATFORM_US = var_7_50

	if var_2 == var_7_50 then
	...
	LoginSceneConst = var_7_53
	var_7_54[var_7_53.DEFINE.LOGIN_PANEL_VIEW] = arg_7_0.loginPanelView
	...
	PLATFORM_CODE = var_2
	PLATFORM_CH = var_7_65

	if var_2 == var_7_65 then
		onButton = var_2
		...
		var_2(arg_7_0, arg_7_0.age, function()
			...
			pg = var_2_10003
			var_12_2.helps = var_2_10003.gametip.cadpa_help.tip
			pg = var_3
			var_12_2.title = var_3.MsgboxMgr.TITLE_CADPA
...
function var_0_1.FlushGateWaySwitchBtn(arg_13_0)
	...
	PLATFORM = var_1
	PLATFORM_OPENHARMONY = var_13_0

	if var_1 == var_13_0 then
...
function var_0_1.setServerAccountData(arg_14_0, arg_14_1)
	...
	if arg_14_1 and arg_14_1.level then
		...
		var_5(var_14_3(var_14_2, "mark/charactor"), true)

		setActive = var_5
		findTF = var_14_3

		var_5(var_14_3(var_14_2, "mark/level"), true)

		setActive = var_5
		findTF = var_14_3

		var_5(var_14_3(var_14_2, "mark/searching"), false)

		setText = var_5
		findTF = var_14_3

		var_5(var_14_3(var_14_2, "mark/level"), "lv." .. arg_14_1.level)

		setText = var_5
		findTF = var_14_3
		var_14_3 = var_14_3(var_14_2, "mark/level")
		setColorStr = var_7

		var_5(var_14_3, var_7("lv." .. arg_14_1.level, "#ffffffff"))
	...
	elseif arg_14_1 and arg_14_1.isFail then
		...
		var_5(var_14_3(var_14_2, "mark/charactor"), false)
		...
		var_5(var_14_3, var_7(var_8("query_role_fail"), "#ff9c00ff"))
	else
		setActive = var_5
		findTF = var_14_3
		...
		var_5(var_6(var_14_2, "mark/searching"), false)

		setActive = var_5
		findTF = var_6

		var_5(var_6(var_14_2, "mark/charactor"), false)

		var_14_1.level = 0
		setText = var_5
		findTF = var_6

		local var_14_4 = var_6(var_14_2, "mark/level")

		setColorStr = var_7
		i18n = var_8

		var_5(var_14_4, var_7(var_8("query_role_none"), "#d0d0d0FF"))
	end
...
function var_0_1.searchAountState(arg_15_0, arg_15_1)
	...
	for iter_15_0 = 1, #arg_15_0.serversDic do
		...
		var_1_10008(var_1_10009(var_15_0, "mark"), true)

		if arg_15_1 then
			setActive = var_1_10008
			findTF = var_1_10009

			var_1_10008(var_1_10009(var_15_0, "mark/charactor"), false)

			setActive = var_1_10008
			findTF = var_1_10009

			var_1_10008(var_1_10009(var_15_0, "mark/level"), true)

			setText = var_1_10008
			findTF = var_1_10009
			var_1_10009 = var_1_10009(var_15_0, "mark/level")
			setColorStr = var_10
			i18n = var_11

			var_1_10008(var_1_10009, var_10(var_11("query_role"), "#d0d0d0FF"))

			setActive = var_1_10008
			findTF = var_1_10009

			var_1_10008(var_1_10009(var_15_0, "mark/searching"), true)
		else
			if not var_15_1 then
				...
				var_1_10008(var_1_10009, var_10(var_11("query_role_fail"), "#d0d0d0FF"))
			end

			setActive = var_1_10008
			findTF = var_1_10009

			var_1_10008(var_1_10009(var_15_0, "mark/searching"), false)
		end
	end
...
function var_0_1.initEvents(arg_16_0)
	...
	LoginSceneConst = var_1_10003

	var_16_1(var_16_0, var_1_10003.SWITCH_SUB_VIEW, function(arg_17_0, arg_17_1)
	...
	var_16_3(var_16_2, var_3.CLEAR_REGISTER_VIEW, function(arg_18_0)
...
function var_0_1.switchSubView(arg_19_0, arg_19_1)
	...
	for iter_19_0, iter_19_1 in var_1_10002(arg_19_0.subViewList) do
		...
		BaseSubView = var_1_10009

		if var_1_10007(var_19_0, var_1_10009) then
			table = var_1_10007
			...
			var_1_10007(var_19_1, var_1_10009.contains(arg_19_1, iter_19_0))
		end
	end
	...
	if not var_19_2(var_19_3, var_4.DEFINE.SERVER_PANEL) then
		pg = var_2
	...
	if var_19_5(var_19_6, var_4.DEFINE.AIRI_LOGIN_PANEL_VIEW) then
		setActive = var_2
...
function var_0_1.showUserAgreement(arg_23_0, arg_23_1)
	...
	if var_1_10003 == var_1_10004 then
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_1_10003 = var_1_10003(var_23_1, var_1_10005(var_1_10006))
		Color = var_23_1
		var_1_10003.color = var_23_1.New(0.7843137254901961, 0.7843137254901961, 0.7843137254901961, 0.5019607843137255)
	else
		var_23_0 = true
	end
	...
	var_4(arg_23_0.userAgreenTF, true)

	pg = var_4

	local var_23_3 = var_4.UIMgr.GetInstance()
	...
	var_4(var_5.Find(var_23_4, "window/container/scrollrect/content/Text"), var_23_2.content)
	...
	var_4(arg_23_0, arg_23_0.userAgreenConfirmTF, function()
		if var_23_0 then
			...
			var_24_2(var_24_1, var_2_10002("read_the_user_agreement"))
		end
	...
	var_4(var_23_5, var_6.Find(var_23_6, "window/container/scrollrect"), function(arg_25_0)
		if arg_25_0.y <= 0.01 and not var_23_0 then
			...
			if var_1 == var_2 then
				...
				local var_25_2 = var_25_1(var_25_0, var_2_10003(var_2_10004))

				Color = var_25_0
				var_25_2.color = var_25_0.New(1, 1, 1, 1)
			end
		end
...
function var_0_1.setBg(arg_26_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_26_0.bgImg = var_26_2(var_26_1, var_3(var_1_10004))
...
function var_0_1.setLastLoginServer(arg_29_0, arg_29_1)
	if not arg_29_1 then
		...
		var_1_10002(var_1_10003(arg_29_0.currentServer, "server_name"), "")

		var_1_10002 = arg_29_0.shareData
		var_1_10002.lastLoginServer = nil
		var_1_10003 = arg_29_0

		arg_29_0.updateAdviceServer(var_1_10003)
	...
	var_1_10002(var_1_10003(arg_29_0.currentServer, "server_name"), arg_29_1.name)
...
function var_0_1.didEnter(arg_30_0)
	...
	var_1_10001(var_30_0, var_30_1, var_30_2, var_1_10005)
	...
	var_1_10001(var_30_3, var_30_4, var_30_5, var_1_10005)
	...
	var_1_10001(var_30_6, var_30_7, var_30_8, var_1_10005)
	...
	var_1_10001(var_30_10, var_3 == var_30_8)

	PLATFORM_CODE = var_1_10001
	PLATFORM_JP = var_30_10

	if var_1_10001 ~= var_30_10 then
		PLATFORM_CODE = var_1_10001
		PLATFORM_US = var_30_10
		...
		var_1_10001(var_30_11, var_3 == var_30_8)
		...
		local function var_30_14()
			...
			if var_2_10000 == var_2_10001 then
				...
				var_36_2(var_36_1, var_2_10002("word_systemClose"))
			end
		...
		var_1_10001(var_30_12, var_30_13, var_30_14, var_1_10005)
		...
		local function var_30_17()
			...
			if not (var_37_1 ~= var_37_0.PLATFORM_INNER) then
				var_2_10003 = arg_30_0

				var_2_10002.switchToLogin(var_2_10003)
			elseif var_1 then
				PLATFORM_KR = var_2_10002
				PLATFORM_CODE = var_2_10003

				if var_2_10002 == var_2_10003 then
					pg = var_2_10002

					local var_37_2 = var_2_10002.SdkMgr.GetInstance()

					var_2.SwitchAccount(var_37_2)
				end
			end
		...
		var_1_10001(var_30_15, var_30_16, var_30_17, var_1_10005)
		...
		local function var_30_18()
			...
			if var_39_1 == var_39_0.PLATFORM then
				pg = var_1
		...
		var_2(var_30_19, var_30_20, var_30_21, var_1_10006)
		...
		var_2(var_30_22, var_30_23, var_30_24, var_1_10006)
		...
		var_2(var_30_25, var_30_26, var_30_27, var_1_10006)
		...
		var_2(var_30_28, var_4.Find(var_30_29, "background"), function()
			pg = var_2_10000
			...
			if arg_30_0.isNeedResCheck then
				...
				var_43_1(var_43_0, var_2_10002.CHECK_RES)
			...
			if var_0.CheckNeedUserAgreement(var_43_2) then
				...
				var_43_4(var_43_3, var_2_10003.ON_LOGIN_PROCESS)
			...
			if var_43_4(arg_30_0.pressToLogin).activeSelf then
				...
				if not arg_30_0.shareData.lastLoginServer then
					pg = var_1
					var_43_6 = var_1.TipsMgr.GetInstance()

					local var_43_7 = var_1.ShowTips

					i18n = var_2_10003

					var_43_7(var_43_6, var_2_10003("login_loginScene_choiseServer"))

					return
				end

				local var_43_8 = arg_30_0.shareData.lastLoginServer.status

				Server = var_43_6

				if var_43_8 ~= var_43_6.STATUS.VINDICATE then
					var_43_8 = arg_30_0.shareData.lastLoginServer.status
					Server = var_2

					if var_43_8 == var_2.STATUS.FULL then
						ServerStateChecker = var_43_8

						local var_43_9 = var_43_8.New()

						var_1.Execute(var_43_9, function(arg_44_0)
							if arg_44_0 then
								pg = var_3_10001
								...
								var_44_1(var_44_0, var_3_10003("login_loginScene_server_disabled"))
							else
								...
								var_44_3(var_44_2, var_3_10003.ON_SERVER, arg_30_0.shareData.lastLoginServer)
					...
					local var_43_10 = arg_30_0.event
					local var_43_11 = var_1.emit

					LoginMediator = var_2_10003

					var_43_11(var_43_10, var_2_10003.ON_SERVER, arg_30_0.shareData.lastLoginServer)

					pg = var_43_11

					local var_43_12 = var_43_11.CriMgr.GetInstance()
					local var_43_13 = var_1.PlaySoundEffect_V3

					SFX_CONFIRM = var_3

					var_43_13(var_43_12, var_3)
		...
		if arg_30_0.isOpPlay then
			...
			if var_2 ~= var_3 then
				...
				if var_2.GetString("op_ver", "") ~= arg_30_0.opVersion then
					arg_30_0:playOpening(function()
						...
						var_46_2(var_46_1, var_2.ON_LOGIN_PROCESS)
			...
			var_30_31(var_30_30, var_4.ON_LOGIN_PROCESS)
		else
			...
			var_30_33(var_30_32, var_4.ON_LOGIN_PROCESS)
		end
...
function var_0_1.InitPrivateAndLicence(arg_47_0)
	...
	if var_1_10001 then
		...
		var_1_10002(var_47_0, var_47_1, var_47_2, var_1_10006)
		...
		var_1_10002(var_47_3, var_47_4, var_47_5, var_1_10006)
	end
...
local function var_0_3()
	...
	if var_1_10000.gameset.login_extra_voice.description then
		local var_50_0 = #var_0

		if 0 < var_50_0 then
			math = var_50_0

			local var_50_1 = var_50_0.clamp

			math = var_2

			local var_50_2 = var_2.floor

			math = var_1_10003

			local var_50_3 = var_0[var_50_1(var_50_2(var_1_10003.random() * #var_0) + 1, 1, #var_0)]

			return "cv-" .. var_50_3, "extra"
		end
	end
...
function var_0_1.playExtraVoice(arg_53_0)
	...
	if var_53_0 and var_53_1 then
		...
		local var_53_2 = var_1_10003.CriMgr.GetInstance()

		var_3.PlayCV_V3(var_53_2, var_53_0, var_53_1)
	end
...
function var_0_1.autoLogin(arg_55_0)
	if arg_55_0.shareData.lastLoginUser then
		if arg_55_0.shareData.autoLoginEnabled then
			...
			LoginMediator = var_1_10003

			var_55_1(var_55_0, var_1_10003.ON_LOGIN, arg_55_0.shareData.lastLoginUser)
		end
...
function var_0_1.updateServerTF(arg_56_0, arg_56_1, arg_56_2)
	...
	var_1_10003(var_1_10004(arg_56_1, "name"), "-  " .. arg_56_2.name .. "  -")
	...
	var_56_1(var_56_0, var_56_2, var_6(arg_56_1, "statu"), true)
	...
	Color = var_56_3
	var_56_4.color = var_56_3.New(var_0_5[arg_56_2.status + 1][1], var_0_5[arg_56_2.status + 1][2], var_0_5[arg_56_2.status + 1][3], var_0_5[arg_56_2.status + 1][4])
	setActive = var_56_4
	findTF = var_4

	var_56_4(var_4(arg_56_1, "mark"), arg_56_2.isLogined)
	...
	local function var_56_7()
		...
		if var_57_0 == var_2_10001.STATUS.VINDICATE then
			pg = var_57_0
			var_57_1 = var_57_0.TipsMgr.GetInstance()

			local var_57_2 = var_0.ShowTips

			i18n = var_2_10002

			var_57_2(var_57_1, var_2_10002("login_loginScene_server_vindicate"))
		...
		if var_57_3 == var_57_1.STATUS.FULL then
			pg = var_57_3
			...
			var_57_5(var_57_4, var_2_10002("login_loginScene_server_full"))
	...
	var_56_4(var_56_5, var_56_6, var_56_7, var_7)
...
function var_0_1.updateAdviceServer(arg_58_0)
	...
	local var_58_1 = var_58_0(var_2).firstServer

	setActive = var_2

	var_2(arg_58_0.adviceTF, var_58_1)

	if var_58_1 then
		findTF = var_2

		local var_58_2 = var_2(arg_58_0.adviceTF, "server")
...
function var_0_1.updateServerList(arg_59_0, arg_59_1)
	...
	local var_59_1 = var_59_0(var_1_10003.values(arg_59_1), function(arg_60_0, arg_60_1)
		return arg_60_0.sortIndex < arg_60_1.sortIndex
	end)

	removeAllChildren = var_3

	var_3(arg_59_0.servers)
	...
	if var_3 then
		...
		var_3.sort(var_59_1, function(arg_61_0, arg_61_1)
			string = var_2_10002
			...
			local var_61_1 = var_3.lower(arg_61_1.name)
...
function var_0_1.fillterRefundServer(arg_62_0)
	...
	if var_62_0.data.limitServerIds and #var_62_0.data.limitServerIds > 0 and arg_62_0.serverList and #arg_62_0.serverList > 0 then
		...
		i18n = iter_62_0
		var_62_8.content = iter_62_0("login_arrears_tips", var_62_3)
...
function var_0_1.switchToTencentLogin(arg_64_0)
	...
	var_64_2[1] = var_1_10004.DEFINE.TENCENT_LOGIN_VIEW
...
function var_0_1.switchToAiriLogin(arg_65_0)
	...
	LoginSceneConst = var_1_10004
	var_65_2[1] = var_1_10004.DEFINE.AIRI_LOGIN_PANEL_VIEW
	LoginSceneConst = var_4
	var_65_2[2] = var_4.DEFINE.PRESS_TO_LOGIN
...
function var_0_1.switchToLogin(arg_66_0)
	...
	LoginSceneConst = var_1_10004
	var_66_2[1] = var_1_10004.DEFINE.LOGIN_PANEL_VIEW
...
function var_0_1.switchToRegister(arg_67_0)
	...
	LoginSceneConst = var_1_10004
	var_67_2[1] = var_1_10004.DEFINE.REGISTER_PANEL_VIEW
...
function var_0_1.switchToServer(arg_68_0)
	...
	if var_68_1 ~= var_68_0.PLATFORM_INNER then
		PLATFORM_CODE = var_1_10003
		...
		if var_1_10003 ~= var_1_10004 then
			...
			LoginSceneConst = var_1_10006
			var_68_4[1] = var_1_10006.DEFINE.PRESS_TO_LOGIN
			LoginSceneConst = var_1_10006
			var_68_4[2] = var_1_10006.DEFINE.CURRENT_SERVER
			LoginSceneConst = var_1_10006
			var_68_4[3] = var_1_10006.DEFINE.BG_LAY
	...
	do
		...
		LoginSceneConst = var_1_10006
		var_68_7[1] = var_1_10006.DEFINE.ACCOUNT_BTN
		LoginSceneConst = var_6
		var_68_7[2] = var_6.DEFINE.PRESS_TO_LOGIN
		LoginSceneConst = var_6
		var_68_7[3] = var_6.DEFINE.CURRENT_SERVER
		LoginSceneConst = var_6
		var_68_7[4] = var_6.DEFINE.BG_LAY
...
function var_0_1.SwitchToWaitPanel(arg_69_0, arg_69_1)
	...
	Timer = var_1_10006
	arg_69_0.waitTimer = var_1_10006.New(function()
		setText = var_2_10000
		...
		var_2_10000(var_70_0, var_2_10002("login_wait_tip", var_69_4))
		...
		if arg_69_1 <= 0 then
			...
			var_0(var_1.Find(var_70_1, "background"))
...
function var_0_1.willExit(arg_71_0)
	...
	PLATFORM = var_1
	PLATFORM_OPENHARMONY = var_71_8

	if var_1 == var_71_8 then
...
function var_0_1.closeYostarAlertView(arg_75_0)
	if arg_75_0.yostarAlertView then
		...
		if var_75_1(var_75_0, var_1_10003.STATES.INITED) then
...
function var_0_1.onLoadDataDone(arg_76_0)
	...
	if var_1(var_76_0) then
		...
		local var_76_1 = var_76_0(var_1_10003)
		...
		local var_76_4 = var_4.GO_SCENE

		SCENE = var_5

		var_76_3(var_76_2, var_76_4, var_5.MAINUI, {
			isFromLogin = true
		})
	end
