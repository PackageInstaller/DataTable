...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_CREATE, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.CREATE_NEW_PLAYER, {
			nickname = arg_2_1,
			shipId = arg_2_2
		})
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.CREATE_NEW_PLAYER_DONE then
		local var_5_3 = arg_5_0.facade

		var_5_4 = var_5_4.sendNotification
		GAME = var_1_10006

		var_5_4(var_5_3, var_1_10006.LOAD_PLAYER_DATA, {
			isNewPlayer = true,
			id = var_5_2
		})
	else
		...
		if var_5_0 == var_5_4.LOAD_PLAYER_DATA_DONE then
			...
			var_5_6(var_5_5, var_5_7, var_1_10007.MAINUI)
		end
	end
