...
function var_0_1.initPanel(arg_4_0)
	...
	findTF = var_1_10002
	arg_4_0.mapContainer = var_4_0(var_1_10002(arg_4_0.ad, "map"), arg_4_0)
	...
	findTF = var_2
	arg_4_0.missionPanel = var_4_3(var_2(arg_4_0.ad, "panel/missionPanel"), arg_4_0)
...
function var_0_1.initButtonEvent(arg_5_0)
	...
	local var_5_1 = var_1_10003(arg_5_0.ad, "ui/btnBuild")
...
function var_0_1.initMapTestButton(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1(var_2.island_map.all) do
		pg = var_1_10006
		...
		if var_1_10006.island_map[iter_8_1].sceneName and var_1_10006.sceneName ~= "" then
			...
			local var_8_0 = var_7(var_1_10008(arg_8_0.btnMapTpl))
			...
			var_1_10008(var_8_1, var_1_10010(arg_8_0.ad, "ui/mapGuide"))
			...
			var_9(var_1_10008, "跳转地图: " .. var_1_10006.name)
			...
			local function var_8_3()
				...
				IslandWorldMapMediator = var_2_10002

				var_9_1(var_9_0, var_2_10002.GO_ISLAND, var_1_10006.id)
			...
			var_9(var_1_10010, var_8_2, var_8_3, var_1_10013)
		end
	end
