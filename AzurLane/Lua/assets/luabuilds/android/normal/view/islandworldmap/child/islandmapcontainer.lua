...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_1_10005
	Camera = var_1_10006
	arg_1_0._uiCamera = var_1_1(var_1_0, var_1_10005(var_1_10006))
...
function var_0_0.updatePart(arg_4_0)
	...
	for iter_4_0 = 1, var_4_0 do
		local var_4_1 = var_1
		local var_4_2 = var_1.GetChild(var_4_1, iter_4_0 - 1)

		GetComponent = var_4_1
		findTF = var_9

		local var_4_3 = var_9(var_4_2, "click/img")

		typeof = var_10
		Image = var_11
		var_4_1(var_4_3, var_10(var_11)).alphaHitTestMinimumThreshold = 0.5

		arg_4_0:addTfListenerMove(var_4_2, function()
			local var_5_0 = arg_4_0._uiCamera
			local var_5_1 = var_0.WorldToScreenPoint(var_5_0, var_4_2.position)
		...
		var_9.insert(arg_4_0.partItems, var_4_2)
	end
...
function var_0_0.updateDragBound(arg_6_0)
	...
	local var_6_2 = var_3.abs(arg_6_0._screenSize.y / 2 - arg_6_0._mapTf.sizeDelta.y * arg_6_0._scaleRate / 2)
...
function var_0_0.addTfListenerMove(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_1 = var_1_10003(var_7_0, var_1_10005(var_1_10006))
...
function var_0_0.setScale(arg_15_0, arg_15_1)
	...
	local var_15_1 = var_1_10003(arg_15_0._mapTf)

	Vector3 = var_4

	local var_15_2 = var_15_0(var_15_1, var_4(arg_15_1, arg_15_1, arg_15_1), 0.4)
	local var_15_3 = var_2.setOnUpdate

	System = var_4

	local var_15_4 = var_15_3(var_15_2, var_4.Action_float(function(arg_16_0)
		return
	end))
	...
	local var_15_6 = var_15_5(var_15_4, var_4.easeInOutSine)
	local var_15_7 = var_2.setOnComplete

	System = var_4

	var_15_7(var_15_6, var_4.Action(function()
...
function var_0_0.focusIn(arg_21_0, arg_21_1)
	...
	local var_21_2 = arg_21_0.getScreenCenter(var_21_1)

	Vector3 = var_21_1

	local var_21_3 = var_21_1(var_21_0.x + (var_21_2.x - arg_21_1.x), var_21_0.y + (var_21_2.y - arg_21_1.y), 0)

	arg_21_0:setMoveTo(var_21_3)
...
function var_0_0.setMoveTo(arg_22_0, arg_22_1)
	...
	if var_22_0(var_1_10003(arg_22_0._mapTf)) then
		return
	end
	...
	local var_22_5 = var_22_4(var_22_3, var_4.easeInOutSine)
	local var_22_6 = var_2.setOnComplete

	System = var_4

	var_22_6(var_22_5, var_4.Action(function()
...
function var_0_0.dispose(arg_26_0)
	...
	if var_26_1(var_26_0(arg_26_0._mapTf)) then
		...
		var_26_2(var_2(arg_26_0._mapTf))
	end
