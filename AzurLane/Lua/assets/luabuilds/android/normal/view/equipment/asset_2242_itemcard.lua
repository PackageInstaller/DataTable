...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.countTF = var_1_1(var_1_0, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.nameTF = var_1_3(var_1_2, var_4(var_1_10005))
	findTF = var_2
...
function var_0_0.update(arg_2_0, arg_2_1)
	...
	if not var_1_10002(arg_2_0.timeLimitTag) then
		...
		if arg_2_1:getConfig("time_limit") ~= 1 then
			Item = var_4
			var_2_1 = var_4.InTimeLimitSkinAssigned(arg_2_1.id)
...
function var_0_0.ShortenString(arg_3_0, arg_3_1, arg_3_2)
	...
	while var_3_0 <= var_3_3 do
		...
		local var_3_5, var_3_6 = var_9(var_1_10008)

		var_3_0 = var_3_0 + var_3_5
		var_3_1 = var_3_1 + var_3_6
		math = var_1_10011

		if var_1_10011.ceil(var_3_1) == arg_3_2 - 1 then
			var_3_2 = var_3_0
		elseif arg_3_2 < var_1_10011 then
			var_3_4 = true
