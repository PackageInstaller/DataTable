...
function var_0_1.init(arg_2_0)
	...
	var_2(var_3.Find(var_2_5, "buttons"), true)
	...
	local var_2_13 = var_2_11(var_4)

	NotchAdapt = var_4

	if var_4.CheckNotchRatio == 2 or not var_2_13:CheckLargeScreen() then
	...
	var_2_16(var_2_15, var_6(var_1_10007)).constraintCount = var_2_12 and 8 or 7
	findTF = var_5
	...
	if not var_7.gameset.equip_select_limit.key_value then
		var_2_31 = 0
	end
	...
	var_2_34(var_6.Find(var_2_35, "dispos"), false)

	setActive = var_2_34

	local var_2_36 = arg_2_0.topItems

	var_2_34(var_6.Find(var_2_36, "adapt/select_panel"), false)
	...
	local var_2_41 = var_6.Find(var_2_40, "cancel_button/Image")

	i18n = var_2_40

	var_5(var_2_41, var_2_40("msgbox_text_cancel"))

	setText = var_5

	local var_2_42 = arg_2_0.selectTransformPanel
	local var_2_43 = var_6.Find(var_2_42, "confirm_button/Image")

	i18n = var_2_42

	var_5(var_2_43, var_2_42("msgbox_text_confirm"))
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_9()
		...
		pg = var_2_10003
		var_9_2.helps = var_2_10003.gametip.help_equipment.tip
	...
	local var_7_12 = var_3.Find(var_7_11, "cancel_button")
	...
	local var_7_16 = var_3.Find(var_7_15, "confirm_button")
	...
	var_1(var_7_14, var_7_16, var_7_17, var_5)
...
function var_0_1.updateEquipmentCount(arg_20_0, arg_20_1)
	...
	var_2(var_20_1, var_4("list_empty_tip_storehouseui_equip"))
...
function var_0_1.ScrollEquipPos(arg_21_0, arg_21_1)
	...
	local var_21_3 = var_21_2(var_21_1, var_4(var_1_10005)).cellSize.y + var_2.spacing.y
...
function var_0_1.updateEquipment(arg_28_0, arg_28_1, arg_28_2)
	...
	if var_28_1 then
		...
		for iter_28_0, iter_28_1 in var_7(arg_28_0.selectedIds) do
...
function var_0_1.filterEquipment(arg_30_0)
	...
	for iter_30_0, iter_30_1 in var_3(var_30_1) do
		local var_30_2 = iter_30_1.type

		DROP_TYPE_EQUIP = var_1_10009

		if var_30_2 == var_1_10009 then
			var_30_2 = iter_30_1.template.count

			if 0 < var_30_2 then
				table = var_30_2

				var_30_2.insert(arg_30_0.loadEquipmentVOs, iter_30_1)
			end
		end
	end

	if var_30_0 then
		local var_30_3 = arg_30_0.asc
		local var_30_4 = {
			function(arg_31_0)
		...
		local var_30_5 = var_5.mergeArray
		local var_30_6 = var_30_4

		underscore = iter_30_1

		local var_30_7 = var_30_5(var_30_6, iter_30_1.map(var_0_2.sortFunc(var_30_0, var_30_3), function(arg_33_0)
		...
		local var_30_8 = var_5.sort
		local var_30_9 = arg_30_0.loadEquipmentVOs

		CompareFuncs = var_7

		var_30_8(var_30_9, var_7(var_30_7))
	end
