...
function var_0_1.init(arg_4_0)
	...
	var_1(var_2.Find(var_4_4, "Template"), false)
	...
	var_4_15(var_4_14, var_1_10005(var_1_10006)).constraintCount = var_4_12 and 8 or 7
	...
	var_4_17(var_4_16, var_1_10006(var_1_10007)).constraintCount = var_4_12 and 8 or 7
	findTF = var_4
	...
	var_4(var_4_27, var_6("list_empty_tip_storehouseui_equip"))

	setText = var_4

	local var_4_28 = arg_4_0.equipmentView
	local var_4_29 = var_5.Find(var_4_28, "Viewport/Content/Craft/Banner/Text")

	i18n = var_4_28

	var_4(var_4_29, var_4_28("spweapon_ui_create"))

	setText = var_4

	local var_4_30 = arg_4_0.equipmentView
	local var_4_31 = var_5.Find(var_4_30, "Viewport/Content/StoreHouse/Banner/Text")

	i18n = var_4_30

	var_4(var_4_31, var_4_30("spweapon_ui_storage"))
...
function var_0_1.didEnter(arg_6_0)
	...
	local function var_6_5()
		...
		var_2_10000(var_8_0, var_2_10002(var_2_10003)).interactable = false
	...
	local function var_6_14()
		...
		SpWeaponStoreHouseMediator = var_3

		var_11_5(var_11_4, var_3.OPEN_EQUIPMENT_INDEX, var_11_0)
	...
	var_6_15(var_6_17, var_6_18, var_6_19, var_1_10006, var_1_10007)
	...
	var_6_20(var_6_22, var_6_23, var_6_24, var_1_10007, var_1_10008)
	...
	var_3(var_6_30, var_6_31, var_6_32, var_1_10007)
...
function var_0_1.updateCapacity(arg_18_0)
	...
	local var_18_0 = var_1_10001(var_2)
	...
	var_18_2(arg_18_0.capacityTF, var_18_1 .. "/" .. var_18_3)
...
function var_0_1.initSort(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1(var_0_2.sort) do
		if iter_21_0 <= arg_21_0.sortContain.childCount then
			var_1_10007 = arg_21_0.sortContain

			local var_21_0

			if not var_21_0.GetChild(var_1_10007, iter_21_0 - 1) then
				cloneTplTo = var_21_0
				var_21_0 = var_21_0(arg_21_0.sortTpl, arg_21_0.sortContain)
			end

			setActive = var_1_10007

			var_1_10007(var_21_0, true)

			setImageSprite = var_1_10007
			findTF = var_8

			local var_21_1 = var_8(var_21_0, "Image")

			GetSpriteFromAtlas = var_9

			var_1_10007(var_21_1, var_9("ui/equipmentui_atlas", iter_21_1.spr), true)
			...
			var_1_10007(var_21_2, var_21_3, var_21_4, var_11)

			var_1_10007 = arg_21_0.sortButtons
			var_1_10007[iter_21_0] = var_21_0
		end
	end
...
function var_0_1.initEquipments(arg_25_0)
	...
	arg_25_0.equipmentRect = var_25_0(var_25_1, var_3.Find(var_25_2, "Template"))
	...
	var_1.make(var_25_3, function(arg_26_0, arg_26_1, arg_26_2)
		...
		if arg_26_0 == var_4.EventInit then
	...
	arg_25_0.craftRect = var_25_4(var_25_5, var_3.Find(var_25_6, "Template"))
	...
	var_1.make(var_25_7, function(arg_27_0, arg_27_1, arg_27_2)
		...
		if arg_27_0 == var_4.EventInit then
...
function var_0_1.InitSpWeapon(arg_28_0, arg_28_1)
	...
	local function var_28_3()
		...
		SpWeaponStoreHouseMediator = var_2_10002

		var_29_1(var_29_0, var_2_10002.ON_UNEQUIP)
	...
	if not var_30_1 or var_30_1.mask then
		...
		local function var_30_4()
			if arg_30_0.shipVO then
				...
				var_31_0.oldSpWeaponUid = var_1.GetUID(var_31_1)

				local var_31_2 = var_30_1

				var_31_0.oldShipId = var_1.GetShipId(var_31_2)
				...
				if not var_31_0 then
					...
					if var_31_0.GetShipId(var_31_3) then
						var_31_0 = {}
						EquipmentInfoMediator = var_31_3
						var_31_0.type = var_31_3.TYPE_DISPLAY

						local var_31_4 = var_30_1

						var_31_0.spWeaponUid = var_31_3.GetUID(var_31_4)

						local var_31_5 = var_30_1

						var_31_0.shipId = var_31_3.GetShipId(var_31_5)

						if not var_31_0 then
							var_31_0 = {}
							EquipmentInfoMediator = var_31_3
							var_31_0.type = var_31_3.TYPE_DEFAULT
...
function var_0_1.updateEquipmentCount(arg_33_0)
	...
	local var_33_4 = var_33_3(var_33_2, var_4(var_1_10005)).padding
...
function var_0_1.filterEquipment(arg_34_0)
	...
	local var_34_1 = arg_34_0.isDefaultStatus(var_34_0) and "shaixuan_off" or "shaixuan_on"

	GetSpriteFromAtlasAsync = var_34_0

	var_34_0("ui/share/index_atlas", var_34_1, function(arg_35_0)
	...
	local var_34_2 = arg_34_0.contextData.sortData
	...
	;(function()
		...
		if var_34_2 then
			...
			CompareFuncs = iter_36_2

			var_36_3(var_36_4, iter_36_2(var_0_2.sortFunc(var_34_2, var_36_2)))
		end
	...
	;(function()
		...
		if var_34_2 then
			...
			CompareFuncs = iter_37_2

			var_37_3(var_37_4, iter_37_2(var_0_2.sortFunc(var_34_2, var_37_2)))
		end
	...
	local var_34_3 = arg_34_0.sortBtn
	local var_34_4 = var_6.Find(var_34_3, "Image")

	GetSpriteFromAtlas = var_34_3

	var_5(var_34_4, var_34_3("ui/equipmentui_atlas", var_34_2.spr), true)
...
function var_0_1.UpdateCraftItem(arg_39_0, arg_39_1, arg_39_2)
	...
	local function var_39_4()
		...
		local var_40_2 = var_2_10002.ON_COMPOSITE
		local var_40_3 = var_39_1

		var_40_1(var_40_0, var_40_2, var_3.GetConfigID(var_40_3))
	...
	var_5(var_39_2, var_39_3, var_39_4, var_1_10009)
...
function var_0_1.UpdateCraftCount(arg_42_0)
	...
	local var_42_4 = var_42_3(var_42_2, var_4(var_1_10005)).padding
