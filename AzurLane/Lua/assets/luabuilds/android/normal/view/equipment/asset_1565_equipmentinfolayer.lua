...
function var_0_1.init(arg_2_0)
	...
	var_2(var_3.Find(var_2_7, "transform_tip"), false)
	...
	var_2(var_2_8, var_4("ship_equip_check"))
...
function var_0_1.checkOverGold(arg_6_0, arg_6_1)
	...
	if var_3.GoldMax(var_6_1, var_6_0) then
		...
		local var_6_4 = var_5("gold_max_tip_title")

		i18n = var_6

		var_6_3(var_6_2, var_6_4 .. var_6("resource_max_tip_destroy"))
...
function var_0_1.didEnter(arg_9_0)
	...
	local var_9_4 = var_9_2.contains

	EquipmentInfoMediator = var_3
	arg_9_0.isShowUnique = var_9_4(var_3.SHOW_UNIQUE, var_9_3)
	onButton = var_2

	local var_9_5 = arg_9_0
	local var_9_6 = arg_9_0._tf
	local var_9_7 = var_4.Find(var_9_6, "bg")
	...
	var_2(var_9_5, var_9_7, var_9_8, var_6)
	...
	if arg_11_1 ~= var_1_10002.TYPE_DEFAULT then
		...
		if arg_11_1 == var_11_1.TYPE_SHIP then
			...
			if arg_11_1 == var_11_1.TYPE_DEFAULT and not arg_11_0.defaultTransformTipBar then
				...
				var_11_8(var_11_1, arg_11_0.defaultEquipTF)

				local var_11_9 = var_11_1.sizeDelta

				var_11_9.y = 0
				var_11_1.sizeDelta = var_11_9
				setAnchoredPosition = var_4

				local var_11_10 = var_11_1

				Vector2 = var_1_10006

				var_4(var_11_10, var_1_10006.zero)
			...
			local var_11_12 = arg_11_0.defaultReplaceBtn
			...
			local function var_11_13()
				...
				var_12_4(var_12_3, var_2_10004.ON_CHANGE)
			...
			var_11_1(var_11_11, var_11_12, var_11_13, var_1_10006)

			onButton = var_11_1

			local var_11_14 = arg_11_0
			local var_11_15 = arg_11_0.defaultEnhanceBtn
			...
			local function var_11_16()
				if arg_11_0.shipVO then
					...
					if not var_13_0 then
						...
						local var_13_2 = var_2_10002.TipsMgr.GetInstance()

						var_2_10002.ShowTips(var_13_2, var_13_1)
				...
				EquipmentInfoMediator = var_2_10002

				var_13_4(var_13_3, var_2_10002.ON_INTENSIFY)
			...
			var_11_1(var_11_14, var_11_15, var_11_16, var_1_10006)

			onButton = var_11_1

			local var_11_17 = arg_11_0
			local var_11_18 = arg_11_0.defaultUnloadBtn
			...
			local function var_11_19()
				...
				var_14_4(var_14_3, var_2_10004.ON_UNEQUIP)

				return
			end

			SFX_UI_DOCKYARD_EQUIPOFF = var_1_10006

			var_11_1(var_11_17, var_11_18, var_11_19, var_1_10006)

			onButton = var_11_1

			local var_11_20 = arg_11_0
			local var_11_21 = arg_11_0.defaultDestroyBtn
			...
			var_11_1(var_11_20, var_11_21, var_11_22, var_1_10006)

			onButton = var_11_1

			local var_11_23 = arg_11_0
			local var_11_24 = arg_11_0.defaultRevertBtn
			...
			var_11_1(var_11_23, var_11_24, var_11_25, var_1_10006)
		else
			EquipmentInfoMediator = var_11_1
			...
			if arg_11_1 == var_11_1.TYPE_REPLACE then
				local var_11_26 = arg_11_0.replacePanel

				if not var_11_27.Find(var_11_26, "equipment") then
					var_11_27 = arg_11_0:cloneSampleTo(arg_11_0.replacePanel, var_0_1.Left, "equipment")
				end

				arg_11_0.replaceSrcEquipTF = var_11_27

				local var_11_28 = arg_11_0.replacePanel

				if not var_11_27.Find(var_11_28, "equipment_on_ship") then
					var_11_27 = arg_11_0:cloneSampleTo(arg_11_0.replacePanel, var_0_1.Right, "equipment_on_ship")
				end

				arg_11_0.replaceDstEquipTF = var_11_27

				local var_11_29 = arg_11_0.replacePanel

				arg_11_0.replaceCancelBtn = var_11_27.Find(var_11_29, "actions/cancel_button")

				local var_11_30 = arg_11_0.replacePanel

				arg_11_0.replaceConfirmBtn = var_11_27.Find(var_11_30, "actions/action_button_2")
				onButton = var_11_27

				local var_11_31 = arg_11_0
				local var_11_32 = arg_11_0.replaceCancelBtn
				...
				var_11_27(var_11_31, var_11_32, var_11_33, var_1_10006)

				onButton = var_11_27

				local var_11_34 = arg_11_0
				local var_11_35 = arg_11_0.replaceConfirmBtn
				...
				local function var_11_36()
					...
					if not var_18_1 then
						...
						var_18_4(var_18_3, var_2_10004("equipment_equipmentInfoLayer_error_canNotEquip", var_18_2))
					...
					if arg_11_0.contextData.quickCallback then
						...
						var_18_7(var_18_6, var_2_10004.ON_EQUIP)
					end

					return
				end

				SFX_UI_DOCKYARD_EQUIPADD = var_1_10006

				var_11_27(var_11_34, var_11_35, var_11_36, var_1_10006)
			else
				EquipmentInfoMediator = var_11_27

				if arg_11_1 == var_11_27.TYPE_DISPLAY then
					local var_11_37 = arg_11_0.displayPanel
					local var_11_38

					if not var_2.Find(var_11_37, "equipment") then
						var_11_38 = arg_11_0:cloneSampleTo(arg_11_0.displayPanel, var_0_1.Middle, "equipment")
					end

					arg_11_0.displayEquipTF = var_11_38

					local var_11_39 = arg_11_0.displayPanel

					arg_11_0.displayMoveBtn = var_2.Find(var_11_39, "actions/move_button")

					local var_11_40 = arg_11_0.displayEquipTF

					arg_11_0.defaultTransformTipBar = var_2.Find(var_11_40, "transform_tip")

					local var_11_42

					if arg_11_0.contextData.showTransformTip and not arg_11_0.defaultTransformTipBar then
						local var_11_41 = arg_11_0.defaultPanel

						var_11_42 = var_11_42.Find(var_11_41, "transform_tip")
						setParent = var_11_41

						var_11_41(var_11_42, arg_11_0.displayEquipTF)

						local var_11_43 = var_11_42.sizeDelta

						var_11_43.y = 0
						var_11_42.sizeDelta = var_11_43
						setAnchoredPosition = var_4

						local var_11_44 = var_11_42

						Vector2 = var_1_10006

						var_4(var_11_44, var_1_10006.zero)

						arg_11_0.defaultTransformTipBar = var_11_42
					end

					onButton = var_11_42

					var_11_42(arg_11_0, arg_11_0.displayMoveBtn, function()
						local var_19_0 = arg_11_0
						local var_19_1 = var_0.emit

						EquipmentInfoMediator = var_2_10002

						var_19_1(var_19_0, var_2_10002.ON_MOVE, arg_11_0.shipVO.id)
				...
				elseif arg_11_1 == var_0_1.PANEL_DESTROY then
					...
					local var_11_45 = arg_11_0.destroyPanel
					local var_11_46

					if not var_2.Find(var_11_45, "equipment") then
						var_11_46 = arg_11_0:cloneSampleTo(arg_11_0.destroyPanel, var_0_1.Left, "equipment")
					end

					arg_11_0.destroyEquipTF = var_11_46

					local var_11_47 = arg_11_0.destroyPanel

					arg_11_0.destroyCounter = var_2.Find(var_11_47, "destroy")

					local var_11_48 = arg_11_0.destroyCounter

					arg_11_0.destroyValue = var_2.Find(var_11_48, "count/number_panel/value")

					local var_11_49 = arg_11_0.destroyCounter

					arg_11_0.destroyLeftButton = var_2.Find(var_11_49, "count/number_panel/left")

					local var_11_50 = arg_11_0.destroyCounter

					arg_11_0.destroyRightButton = var_2.Find(var_11_50, "count/number_panel/right")

					local var_11_51 = arg_11_0.destroyCounter

					arg_11_0.destroyBonusList = var_2.Find(var_11_51, "got/list")

					local var_11_52 = arg_11_0.destroyCounter

					arg_11_0.destroyBonusItem = var_2.Find(var_11_52, "got/item")

					local var_11_53 = arg_11_0.destroyPanel

					arg_11_0.destroyCancelBtn = var_2.Find(var_11_53, "actions/cancel_button")

					local var_11_54 = arg_11_0.destroyPanel

					arg_11_0.destroyConfirmBtn = var_2.Find(var_11_54, "actions/destroy_button")
					onButton = var_2

					local var_11_55 = arg_11_0
					local var_11_56 = arg_11_0.destroyLeftButton
					...
					var_2(var_11_55, var_11_56, var_11_57, var_1_10006)

					onButton = var_2

					local var_11_58 = arg_11_0
					local var_11_59 = arg_11_0.destroyRightButton
					...
					var_2(var_11_58, var_11_59, var_11_60, var_1_10006)

					onButton = var_2

					local var_11_61 = arg_11_0
					local var_11_62 = arg_11_0.destroyCounter
					local var_11_63 = var_4.Find(var_11_62, "count/max")
					...
					var_2(var_11_61, var_11_63, var_11_64, var_1_10006)

					onButton = var_2

					local var_11_65 = arg_11_0
					local var_11_66 = arg_11_0.destroyCancelBtn
					...
					var_2(var_11_65, var_11_66, var_11_67, var_1_10006)

					onButton = var_2

					local var_11_68 = arg_11_0
					local var_11_69 = arg_11_0.destroyConfirmBtn
					...
					local function var_11_70()
						...
						var_1(var_24_1, function()
							...
							EquipmentInfoMediator = var_3_10002

							var_26_1(var_26_0, var_3_10002.ON_DESTROY, arg_11_0.destroyCount)
					...
					SFX_UI_EQUIPMENT_RESOLVE = var_1_10006

					var_2(var_11_68, var_11_69, var_11_70, var_1_10006)
				elseif arg_11_1 == var_0_1.PANEL_REVERT then
					...
					if not var_2.Find(var_11_71, "equipment") then
						var_11_72 = arg_11_0:cloneSampleTo(arg_11_0.revertPanel, var_0_1.Left, "equipment")
					end

					arg_11_0.revertEquipTF = var_11_72

					local var_11_73 = arg_11_0.revertPanel

					arg_11_0.revertAwardContainer = var_2.Find(var_11_73, "item_panel/got/list")

					local var_11_74 = arg_11_0.revertPanel

					arg_11_0.revertCancelBtn = var_2.Find(var_11_74, "actions/cancel_button")

					local var_11_75 = arg_11_0.revertPanel

					arg_11_0.revertConfirmBtn = var_2.Find(var_11_75, "actions/revert_button")
					arg_11_0.itemTpl = arg_11_0:getTpl("item_panel/got/item", arg_11_0.revertPanel)
					onButton = var_2

					local var_11_76 = arg_11_0
					local var_11_77 = arg_11_0.revertCancelBtn
					...
					var_2(var_11_76, var_11_77, var_11_78, var_1_10006)

					onButton = var_2

					local var_11_79 = arg_11_0
					local var_11_80 = arg_11_0.revertConfirmBtn
					...
					local function var_11_81()
						...
						var_28_3(var_28_2, var_2_10003.ON_REVERT, var_28_1.id)
					...
					var_2(var_11_79, var_11_80, var_11_81, var_1_10006)
				end
			end
		end
...
function var_0_1.updateOperation1(arg_29_0)
	...
	LOCK_EQUIP_REVERT = var_29_2

	if not var_29_2 then
		if arg_29_0.fromEquipmentView then
			local var_29_1 = arg_29_0.equipmentVO
			local var_29_2 = var_29_2.getConfig(var_29_1, "level")

			if 1 < var_29_2 then
				getProxy = var_29_2
				BagProxy = var_4

				local var_29_3 = var_29_2(var_4)

				var_29_2 = var_29_2.getItemCountById
				Item = var_5

				if not (var_29_2(var_29_3, var_5.REVERT_EQUIPMENT_ID) > 0) then
					var_29_2 = false
				else
					var_29_2 = true
				end

				var_1(var_29_0, var_29_2)
...
function var_0_1.updateOperation2(arg_30_0)
	...
	var_30_1(var_30_0, var_30_2, var_4.getEquip(var_30_3, arg_30_0.contextData.pos))
	...
	var_30_4(var_30_5, arg_30_0.shipVO)

	if arg_30_0.shipVO then
		setImageSprite = var_2
		findTF = var_3

		local var_30_6 = var_3(var_30_5, "Image")
		...
		var_2(var_30_6, var_4(var_30_7 .. var_6.getPainting(var_30_8)))
	end
...
function var_0_1.updateOperation3(arg_31_0)
	...
	if var_1.getEquip(var_31_0, arg_31_0.contextData.pos) then
		local var_31_1 = var_1:GetPropertiesInfo()
		local var_31_2 = arg_31_0.equipmentVO
		local var_31_3 = var_3.GetPropertiesInfo(var_31_2)

		EquipType = var_31_2

		local var_31_4 = var_31_2.getCompareGroup(var_1.configId)

		EquipType = var_5

		if var_31_4 == var_5.getCompareGroup(arg_31_0.equipmentVO.configId) then
			Equipment = var_31_4

			var_31_4.InsertAttrsCompare(var_31_1.attrs, var_31_3.attrs, arg_31_0.shipVO)
		end

		arg_31_0:updateEquipmentPanel(arg_31_0.replaceSrcEquipTF, var_1, var_31_1)
		arg_31_0:updateEquipmentPanel(arg_31_0.replaceDstEquipTF, arg_31_0.equipmentVO, var_31_3)
	else
	...
	var_31_5(var_31_6, arg_31_0.oldShipVO)

	if arg_31_0.oldShipVO then
		setImageSprite = var_3
		findTF = var_4

		local var_31_7 = var_4(var_31_6, "Image")
		...
		var_3(var_31_7, var_5(var_31_8 .. var_7.getPainting(var_31_9)))
	end
...
function var_0_1.updateOperation4(arg_32_0)
	...
	var_32_0(var_32_1, arg_32_0.shipVO)

	if arg_32_0.shipVO then
		setImageSprite = var_2
		findTF = var_3

		local var_32_2 = var_3(var_32_1, "Image")
		...
		var_2(var_32_2, var_4(var_32_3 .. var_6.getPainting(var_32_4)))
	end
...
function var_0_1.updateRevertPanel(arg_33_0)
	...
	local var_33_5 = var_33_1.GetPropertiesInfo(var_33_4)

	Equipment = var_33_4

	var_33_4.InsertAttrsCompare(var_33_3.attrs, var_33_5.attrs, arg_33_0.shipVO)

	local var_33_6 = arg_33_0
	local var_33_7 = arg_33_0.updateEquipmentPanel
	local var_33_8 = arg_33_0.revertEquipTF
	local var_33_9 = var_33_1
	local var_33_10 = var_33_5
	local var_33_11 = arg_33_0.equipmentVO

	var_33_7(var_33_6, var_33_8, var_33_9, var_33_10, var_9.getConfig(var_33_11, "level"))

	local var_33_12 = arg_33_0
	local var_33_13 = arg_33_0.updateOperationAward
	local var_33_14 = arg_33_0.revertAwardContainer
	local var_33_15 = arg_33_0.itemTpl
	local var_33_16 = arg_33_0.equipmentVO

	var_33_13(var_33_12, var_33_14, var_33_15, var_8.getRevertAwards(var_33_16))
...
function var_0_1.updateDestroyCount(arg_34_0)
	...
	DROP_TYPE_RESOURCE = iter_34_0
	var_34_12.type = iter_34_0
...
function var_0_1.updateOperationAward(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
	...
	for iter_35_1 = 1, #arg_35_3 do
		...
		local function var_35_4()
			...
			var_0.emit(var_36_0, var_0_1.ON_DROP, var_35_1)
		...
		var_10(var_35_2, var_35_3, var_35_4, var_1_10014)

		setText = var_10
		findTF = var_35_2

		local var_35_5 = var_35_2(var_35_0, "name_panel/name")

		getText = var_12
		findTF = var_13

		var_10(var_35_5, var_12(var_13(var_35_0, "name")))

		setText = var_10
		findTF = var_35_5

		local var_35_6 = var_35_5(var_35_0, "name_panel/number")
		local var_35_7 = " x "

		getText = var_13
		findTF = var_1_10014

		var_10(var_35_6, var_35_7 .. var_13(var_1_10014(var_35_0, "icon_bg/count")))

		setActive = var_10
		findTF = var_35_6

		var_10(var_35_6(var_35_0, "icon_bg/count"), false)
	end
...
function var_0_1.updateEquipmentPanel(arg_37_0, arg_37_1, arg_37_2, arg_37_3, arg_37_4)
	...
	local var_37_2 = arg_37_1.Find(var_37_1, "empty")

	setActive = var_37_1

	var_37_1(var_37_0, arg_37_2)

	setActive = var_37_1

	var_37_1(var_37_2, not arg_37_2)

	if arg_37_2 then
		findTF = var_37_1

		local var_37_3 = var_37_1(var_37_0, "name")

		setScrollText = var_8
		findTF = var_9

		var_8(var_9(var_37_3, "mask/Text"), arg_37_2:getConfig("name"))

		setActive = var_8
		findTF = var_9

		local var_37_4 = var_9(var_37_3, "unique")
		local var_37_5

		if arg_37_2:isUnique() then
			var_37_5 = arg_37_0.isShowUnique
		end

		var_8(var_37_4, var_37_5)

		findTF = var_8

		local var_37_6 = var_8(var_37_0, "equip")

		setImageSprite = var_9
		findTF = var_10

		local var_37_7 = var_10(var_37_6, "bg")

		GetSpriteFromAtlas = var_11

		local var_37_8 = "ui/equipmentinfoui_atlas"
		local var_37_9 = "equip_bg_"

		EquipmentRarity = var_1_10014

		var_9(var_37_7, var_11(var_37_8, var_37_9 .. var_1_10014.Rarity2Print(arg_37_2:getConfig("rarity"))))

		updateEquipment = var_9

		var_9(var_37_6, arg_37_2, {
			noIconColorful = true
		})
		...
		var_9(var_10(var_37_6, "revert_btn"), false)

		setActive = var_9
		findTF = var_10

		var_9(var_10(var_37_6, "slv"), arg_37_4 or arg_37_2:getConfig("level") > 1)

		setText = var_9
		findTF = var_10

		local var_37_10 = var_10(var_37_6, "slv/Text")
		local var_37_11

		if not arg_37_4 or not (arg_37_4 - 1) then
			var_37_11 = arg_37_2:getConfig("level") - 1
		end

		var_9(var_37_10, var_37_11)

		setActive = var_9
		findTF = var_37_10

		var_9(var_37_10(var_37_6, "slv/next"), arg_37_4)

		setText = var_9
		findTF = var_10

		var_9(var_10(var_37_6, "slv/next/Text"), arg_37_2:getConfig("level") - 1)

		local var_37_12 = var_37_6
		local var_37_13 = var_37_6.Find(var_37_12, "tier")

		setActive = var_37_12

		var_37_12(var_37_13, arg_37_2)

		local var_37_14 = arg_37_2
		local var_37_15

		if not arg_37_2.getConfig(var_37_14, "tech") then
			var_37_15 = 1
		end

		eachChild = var_37_14

		var_37_14(var_37_13, function(arg_38_0)
			...
			var_2_10001(var_38_0, var_2_10003(var_37_15) == arg_38_0.gameObject.name)

			return
		end)

		setImageSprite = var_37_14
		findTF = var_12

		local var_37_16 = var_12(var_37_6, "title")
		...
		var_37_14(var_37_16, var_13(var_37_17, var_15.type2Tag(arg_37_2:getConfig("type"))))

		setText = var_37_14

		local var_37_18 = var_37_6:Find("speciality/Text")
		local var_37_19
		...
		var_37_14(var_37_18, var_37_19)

		updateEquipInfo = var_37_14

		var_37_14(var_37_0:Find("attributes/view/content"), arg_37_3 or arg_37_2:GetPropertiesInfo(), arg_37_2:GetSkill(), arg_37_0.shipVO)
	end
...
function var_0_1.UpdateTransformTipBar(arg_39_0, arg_39_1)
	...
	local var_39_2 = var_1_10004(var_1_10005)
	local var_39_3 = var_39_1(var_39_0, var_4.getData(var_39_2).level, "EquipmentTransformTreeMediator")

	EquipmentProxy = var_39_0

	local var_39_4 = var_39_0.GetTransformTargets

	Equipment = var_4

	local var_39_5 = var_39_4(var_4.GetEquipRootStatic(arg_39_1.id))

	setActive = var_4

	local var_39_6 = arg_39_0.defaultTransformTipBar

	LOCK_EQUIPMENT_TRANSFORM = var_1_10006

	var_4(var_39_6, not var_1_10006 and var_39_3 and #var_39_5 > 0)

	isActive = var_4

	if var_4(arg_39_0.defaultTransformTipBar) then
		pg = var_4
		...
		local var_39_10 = var_6.Find(var_39_9, "list")
		local var_39_11 = arg_39_0.defaultTransformTipBar

		var_39_8(var_39_10, var_7.Find(var_39_11, "list/transformTarget"), #var_39_5, function(arg_40_0, arg_40_1, arg_40_2)
			...
			if arg_40_0 == var_2_10003.EventUpdate then
				...
				local var_40_0 = arg_40_2:Find("item")
				local var_40_1 = {}

				DROP_TYPE_EQUIP = var_8
				var_40_1.type = var_8
				var_40_1.id = var_4

				var_5(var_40_0, var_40_1)

				onButton = var_5

				local var_40_2 = arg_39_0
				local var_40_3 = arg_40_2:Find("item")
				...
				local function var_40_4()
					...
					local var_41_3 = var_3_10003.OPEN_LAYER

					Context = var_3_10004

					local var_41_4 = var_3_10004.New
					local var_41_5 = {}

					EquipmentTransformMediator = var_3_10006
					var_41_5.mediator = var_3_10006
					EquipmentTransformLayer = var_3_10006
					var_41_5.viewComponent = var_3_10006
				...
				var_5(var_40_2, var_40_3, var_40_4, var_9)

				local var_40_5 = arg_40_2:Find("mask/name")
				local var_40_6 = var_5.GetComponent(var_40_5, "ScrollText")
				local var_40_7 = var_5.SetText

				Equipment = var_7

				var_40_7(var_40_6, var_7.getConfigData(var_4).name)
			end
...
function var_0_1.cloneSampleTo(arg_42_0, arg_42_1, arg_42_2, arg_42_3, arg_42_4)
	...
	Vector3 = var_6
	var_42_0.localPosition = var_6.New(var_0_1.pos[arg_42_2][1], var_0_1.pos[arg_42_2][2], var_0_1.pos[arg_42_2][3])
