...
function var_0_1.register(arg_1_0)
	...
	local var_1_5 = var_5(var_1_10006)

	var_1_4(var_1_3, var_5.getRawData(var_1_5))
...
function var_0_1.BindEvent(arg_2_0)
	arg_2_0:bind(var_0_1.ON_REFORGE, function(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10003.REFORGE_SPWEAPON, {
	...
	arg_2_0:bind(var_0_1.ON_CONFIRM_REFORGE, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.CONFIRM_REFORGE_SPWEAPON, {
			shipId = arg_2_0.contextData.shipId,
			uid = arg_2_0.contextData.spWeaponUid,
			op = arg_4_1
		})
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.REFORGE_SPWEAPON_DONE then
		...
		if var_6_0 == var_4.CONFIRM_REFORGE_SPWEAPON_DONE then
			...
			if var_6_0 == var_4.ITEM_UPDATED then
				...
				local var_6_10 = var_1_10006(var_1_10007)

				var_6_9(var_6_8, var_6.getRawData(var_6_10))
			end
		end
	end
