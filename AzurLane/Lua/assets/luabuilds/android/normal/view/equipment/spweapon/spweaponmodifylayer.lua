...
function var_0_1.init(arg_2_0)
	...
	local var_2_9 = var_2.Find(var_2_8, "Attribute/Text")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("spweapon_ui_transform_attr_text"))
	...
	var_1(var_2_11, var_2_10("spweapon_ui_change_attr"))
	...
	var_1(var_2_13, var_2_12("spweapon_ui_keep_attr"))
	...
	arg_2_0.materialItems = var_2_14(var_2.Find(var_2_15, "materials/materials"), 3)
	...
	local var_2_20 = var_2.Find(var_2_19, "materials/panel_title")

	i18n = var_2_19

	var_1(var_2_20, var_2_19("spweapon_ui_need_resource"))

	setText = var_1

	local var_2_21 = arg_2_0.materialStartButton
	local var_2_22 = var_2.Find(var_2_21, "Image")

	i18n = var_2_21

	var_1(var_2_22, var_2_21("spweapon_ui_transform"))
...
function var_0_1.didEnter(arg_5_0)
	...
	var_1_10001(var_5_0, var_3.Find(var_5_1, "BG"), function()
...
function var_0_1.UpdateView(arg_8_0)
	...
	var_1_10001(var_8_0, var_3.GetName(var_8_1))
	...
	var_8_2.Foreach(arg_8_0.materialItems, function(arg_9_0, arg_9_1)
		...
		if var_9_0 then
			...
			if var_4.count < var_9_0[2] then
				...
				COLOR_RED = var_2_10008
				var_9_2 = var_6(var_9_3, var_2_10008) .. "/" .. var_9_0[2]
			end
			...
			var_9_4(arg_8_0, arg_9_1:Find("Icon"), function()
			...
			local var_9_7 = arg_9_1.Find(var_9_6, "Icon/Click")

			setActive = var_9_6

			var_9_6(var_9_7, not arg_8_0.confirmUpgrade)

			onButton = var_9_6

			var_9_6(arg_8_0, var_9_7, function()
				local var_11_0 = arg_8_0

				var_11_0.confirmUpgrade = true
				setActive = var_11_0

				var_11_0(var_9_7, not arg_8_0.confirmUpgrade)
	...
	local var_8_14 = var_7.equal(var_8_7, var_8_9)
	...
	var_8_15(var_8_16, var_10.GetChild(var_8_17, 0), #var_8_7, function(arg_13_0, arg_13_1, arg_13_2)
		...
		var_7(arg_13_2:Find("Name"), var_13_3)

		setText = var_7

		local var_13_4 = arg_13_2
		local var_13_5 = arg_13_2.Find(var_13_4, "Values/Min/Value")

		math = var_13_4

		var_7(var_13_5, var_13_4.min(1, var_13_1))

		setText = var_7

		var_7(arg_13_2:Find("Values/Max/Value"), var_13_1)

		setText = var_7

		var_7(arg_13_2:Find("Values/Current/Value1"), var_13_0)

		setText = var_7

		var_7(arg_13_2:Find("Values/Current/Value2"), var_13_2)

		setActive = var_7

		var_7(arg_13_2:Find("Values/Current/Symbol"), var_8_13)

		setActive = var_7

		var_7(arg_13_2:Find("Values/Current/Value2"), var_8_13)
	...
	local function var_8_20()
		if not arg_8_0.confirmUpgrade then
			...
			var_14_1(var_14_0, var_2_10002("spweapon_tip_transform_materal_check"))
		...
		SpWeaponModifyMediator = var_2_10002

		var_14_3(var_14_2, var_2_10002.ON_REFORGE)
	...
	var_8_15(var_8_18, var_8_19, var_8_20, var_12)
	...
	local function var_8_23()
		...
		MSGBOX_TYPE_CONFIRM_REFORGE_SPWEAPON = var_2_10003
		var_15_2.type = var_2_10003
		SpWeapon = var_2_10003
		var_15_2.op = var_2_10003.CONFIRM_OP_EXCHANGE
		_ = var_3
		var_15_2.attrs = var_3.map({
			1,
			2
		}, function(arg_16_0)
		...
		function var_15_2.onYes()
			...
			SpWeaponModifyMediator = var_3_10002

			local var_17_2 = var_3_10002.ON_CONFIRM_REFORGE

			SpWeapon = var_3_10003

			var_17_1(var_17_0, var_17_2, var_3_10003.CONFIRM_OP_EXCHANGE)
	...
	var_8_15(var_8_21, var_8_22, var_8_23, var_12)
	...
	local function var_8_26()
		...
		SpWeapon = var_2_10003
		var_18_2.op = var_2_10003.CONFIRM_OP_DISCARD
		_ = var_3
		var_18_2.attrs = var_3.map({
			1,
			2
		}, function(arg_19_0)
		...
		function var_18_2.onYes()
			...
			local var_20_2 = var_3_10002.ON_CONFIRM_REFORGE

			SpWeapon = var_3_10003

			var_20_1(var_20_0, var_20_2, var_3_10003.CONFIRM_OP_DISCARD)
	...
	var_8_15(var_8_24, var_8_25, var_8_26, var_12)
