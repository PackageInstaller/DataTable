...
local function var_0_6(arg_1_0, arg_1_1)
	...
	if not arg_1_1.lock_open and arg_1_1.sub and #arg_1_1.sub > 0 then
		GetComponent = var_1_9

		local var_1_8 = var_1_1

		typeof = var_7
		Toggle = var_8
		var_1_9 = var_1_9(var_1_8, var_7(var_8))
		var_1_9.enabled = true
	else
		setActive = var_1_9

		var_1_9(var_1_1:Find("name/close"), false)

		setActive = var_1_9

		var_1_9(var_1_1:Find("name/open"), false)
		...
		typeof = var_7
		Toggle = var_8
		var_1_9(var_1_10, var_7(var_8)).enabled = false
	end
...
local function var_0_7(arg_2_0, arg_2_1)
	...
	local var_2_1 = arg_2_0.Find(var_2_0, "desc")
	...
	var_3(var_2_1:Find("Text"), arg_2_1.desc)
...
local function var_0_10(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_2[1].skillId > 0 then
		...
		if not arg_6_2[1].unlock then
			setColorStr = var_6
			i18n = var_7
			var_6_2 = var_6(var_7("spweapon_tip_skill_locked") .. var_6_2, "#a2a2a2")
		end
		...
		i18n = var_1_10009
		var_6_5.name = var_1_10009("spweapon_attr_effect")
		setColorStr = var_9
		getSkillName = var_1_10010
		var_1_10010 = var_1_10010(arg_6_2[1].skillId)
		var_1_10011 = arg_6_2[1].unlock and "#FFDE00FF" or "#A2A2A2"
		var_6_5.value = var_9(var_1_10010, var_1_10011)
	...
	for iter_6_0, iter_6_1 in var_6_2(arg_6_2[2]) do
		...
		i18n = var_1_10014
		var_6_6.name = var_1_10014("spweapon_attr_skillupgrade")
		setColorStr = var_1_10014
		getSkillName = var_15
		var_6_6.value = var_1_10014(var_15(iter_6_1.skillId), iter_6_1.unlock and "#FFDE00FF" or "#A2A2A2")
		var_6_6.desc = var_1_10010

		var_1_10011(var_1_10012, var_6_6)
	end
	...
	local var_6_7 = var_5(var_6_0, arg_6_0:Find("part"))

	var_5.SetSiblingIndex(var_6_7, 0)

	local var_6_8 = var_0_8
	local var_6_9 = var_5
	local var_6_10 = {
		value = ""
	}
	...
	i18n = var_9
	var_6_10.name = var_9("equip_info_23")

	var_6_8(var_6_9, var_6_10)

	local var_6_11 = arg_6_0:Find("part/value")
	local var_6_12 = var_6.Find(var_6_11, "label")
	local var_6_13 = {}
	local var_6_14 = {}
	...
	if #arg_6_1.part[1] == 0 and #arg_6_1.part[2] == 0 then
		...
		for iter_6_2, iter_6_3 in var_10(arg_6_1.part[1]) do
			var_6_13[iter_6_3] = true
		end

		ipairs = var_10

		for iter_6_4, iter_6_5 in var_10(arg_6_1.part[2]) do
			var_6_14[iter_6_5] = true
		end
	end

	ShipType = var_10

	local var_6_15 = var_10.MergeFengFanType

	ShipType = var_1_10011

	local var_6_16 = var_1_10011.FilterOverQuZhuType

	ShipType = var_1_10012

	local var_6_17 = var_6_15(var_6_16(var_1_10012.AllShipType), var_6_13, var_6_14)

	UIItemList = var_11

	var_11.StaticAlign(var_6, var_6_12, #var_6_17, function(arg_9_0, arg_9_1, arg_9_2)
		arg_9_1 = arg_9_1 + 1
		UIItemList = var_2_10003

		if arg_9_0 == var_2_10003.EventUpdate then
			local var_9_0 = var_6_17[arg_9_1]
			...
			var_2_10004(var_9_1, var_2_10006.Type2CNLabel(var_9_0), arg_9_2)
			...
			if var_6_13[var_9_0] then
				var_9_3 = not var_6_14[var_9_0]
			end
			...
			if var_6_14[var_9_0] then
				var_9_5 = not var_6_13[var_9_0]
			end
			...
			var_2_10004(arg_9_2, not var_6_13[var_9_0] and not var_6_14[var_9_0] and 0.3 or 1)
		end
