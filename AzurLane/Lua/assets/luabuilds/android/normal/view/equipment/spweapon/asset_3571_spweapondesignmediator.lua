...
function var_0_1.register(arg_1_0)
	...
	local var_1_5 = var_3.each

	SpWeapon = var_1_2

	var_1_5(var_1_2.bindConfigTable().all, function(arg_2_0)
	...
	local var_1_12 = var_1_11(var_1_10, var_6.__cname)
...
function var_0_1.UpdateSpWeapons(arg_6_0)
	...
	local var_6_2 = var_6_0.values

	getProxy = var_1_10003
	EquipmentProxy = var_1_10004

	local var_6_3 = var_1_10003(var_1_10004)
	local var_6_4 = var_6_2(var_3.GetSpWeapons(var_6_3))

	ipairs = var_3

	for iter_6_0, iter_6_1 in var_3(var_6_4) do
		table = var_1_10008
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.ITEM_UPDATED then
		...
		var_8_3(var_1_10005, var_1_10006.getRawData(var_1_10007))
	...
	if var_8_0 == var_8_3.UPDATED then
		var_1_10005 = arg_8_0.viewComponent
		...
		var_8_4(var_1_10005, var_1_10006.getRawData(var_1_10007))
	...
	if var_8_0 == var_8_4.COMPOSITE_SPWEAPON_DONE then
		getProxy = var_8_6
		ContextProxy = var_1_10005

		local var_8_5 = var_8_6(var_1_10005)

		var_8_6 = var_8_6.getContextByMediator
		EquipmentMediator = var_1_10006

		local var_8_7 = var_8_6(var_8_5, var_1_10006)
		local var_8_8 = var_8_6.getContextByMediator

		SpWeaponUpgradeMediator = var_1_10007

		if var_8_8(var_8_7, var_1_10007) then
			local var_8_9 = arg_8_0
			local var_8_10 = arg_8_0.sendNotification

			GAME = var_1_10008

			var_8_10(var_8_9, var_1_10008.REMOVE_LAYERS, {
				context = var_5
			})
		end
	...
	if var_8_0 ~= var_8_6.EQUIP_SPWEAPON_TO_SHIP_DONE then
		EquipmentProxy = var_4

		if var_8_0 == var_4.SPWEAPONS_UPDATED then
