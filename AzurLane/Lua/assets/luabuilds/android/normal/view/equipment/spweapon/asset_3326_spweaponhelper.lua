...
local function var_0_6(arg_1_0, arg_1_1)
	...
	local var_1_1 = arg_1_0.Find(var_1_0, "base")
	...
	local var_1_2 = arg_1_1.name
	local var_1_3 = arg_1_1.value

	setActive = var_1_10005

	var_1_10005(var_1_1, var_1_3)
	...
	var_1_10005(var_1_1:Find("name"), var_1_2)

	Canvas = var_1_10005

	var_1_10005.ForceUpdateCanvases()

	IsNil = var_5

	if not var_5(var_1_1:Find("value")) then
		setActive = var_5

		var_5(var_1_1:Find("value"), var_1_3)

		changeToScrollText = var_5

		var_5(var_1_1:Find("value/Text"), var_1_3)
	end

	IsNil = var_5

	if not var_5(var_1_1:Find("effect")) then
		setActive = var_5

		var_5(var_1_1:Find("effect"), false)
	end

	setActive = var_5

	local var_1_4 = var_1_1:Find("value/up")
	local var_1_5

	if arg_1_1.compare then
		var_1_5 = arg_1_1.compare > 0
	end

	var_5(var_1_4, var_1_5)

	setActive = var_5

	local var_1_6 = var_1_1:Find("value/down")
	local var_1_7

	if arg_1_1.compare then
		var_1_7 = arg_1_1.compare < 0
	end

	var_5(var_1_6, var_1_7)
	...
	if not arg_1_1.lock_open and arg_1_1.sub and #arg_1_1.sub > 0 then
		...
		local function var_1_10(arg_2_0)
			...
			var_2_10001(var_2.Find(var_2_0, "sub"), arg_2_0)
		...
		var_5(var_1_8, var_1_9, var_1_10, var_1_10009)

		triggerToggle = var_5

		var_5(var_1_1, arg_1_1.lock_open)
		...
		typeof = var_7
		Toggle = var_1_10
		var_5(var_1_11, var_7(var_1_10)).enabled = true
	else
		local var_1_13
		...
		if arg_1_1.descTrigger ~= nil then
			...
			var_1_13 = arg_1_0.Find(var_1_12, "desc")
			onToggle = var_1_12

			local var_1_14
			local var_1_15 = var_1_1

			local function var_1_16(arg_3_0)
				setActive = var_2_10001

				var_2_10001(var_1_13, arg_3_0)
			...
			var_1_12(var_1_14, var_1_15, var_1_16, var_1_10010)

			onButton = var_1_12

			local var_1_17
			local var_1_18 = var_1_13

			local function var_1_19()
				triggerToggle = var_2_10000

				var_2_10000(var_1_1, false)
			...
			var_1_12(var_1_17, var_1_18, var_1_19, var_1_10010)

			triggerToggle = var_1_12

			var_1_12(var_1_1, arg_1_1.descTrigger)
			...
			typeof = var_8
			Toggle = var_1_19
			var_1_12(var_1_20, var_8(var_1_19)).enabled = true
		else
			setActive = var_1_13

			var_1_13(var_1_1:Find("name/close"), false)

			setActive = var_1_13

			var_1_13(var_1_1:Find("name/open"), false)

			removeOnToggle = var_1_13

			var_1_13(var_1_1)

			GetComponent = var_1_13

			local var_1_21 = var_1_1

			typeof = var_7
			Toggle = var_8
			var_1_13(var_1_21, var_7(var_8)).enabled = false
		end
	end
...
local function var_0_7(arg_5_0, arg_5_1)
	...
	local var_5_1 = arg_5_0.Find(var_5_0, "desc")
	...
	var_3(var_5_1:Find("Text"), arg_5_1.desc)
...
local function var_0_10(arg_9_0, arg_9_1, arg_9_2)
	...
	if arg_9_2[1].skillId > 0 then
		...
		if not arg_9_2[1].unlock then
			setColorStr = var_6
			i18n = var_7
			var_9_2 = var_6(var_7("spweapon_tip_skill_locked") .. var_9_2, "#a2a2a2")
		end
		...
		i18n = var_1_10009
		var_9_5.name = var_1_10009("spweapon_attr_effect")
		setColorStr = var_9
		getSkillName = var_1_10010
		var_1_10010 = var_1_10010(arg_9_2[1].skillId)
		var_1_10011 = arg_9_2[1].unlock and "#FFDE00FF" or "#A2A2A2"
		var_9_5.value = var_9(var_1_10010, var_1_10011)
		var_9_5.desc = var_9_2
		defaultValue = var_9
		var_9_5.descTrigger = var_9(arg_9_2[1].descTrigger, arg_9_2[1].unlock)
	...
	for iter_9_0, iter_9_1 in var_9_2(arg_9_2[2]) do
		...
		if not iter_9_1.unlock then
			...
			i18n = var_1_10012
			var_1_10010 = var_1_10011(var_1_10012("spweapon_tip_skill_locked") .. var_1_10010, "#a2a2a2")
		end
		...
		i18n = var_1_10014
		var_9_6.name = var_1_10014("spweapon_attr_skillupgrade")
		setColorStr = var_1_10014
		getSkillName = var_15
		var_9_6.value = var_1_10014(var_15(iter_9_1.skillId), iter_9_1.unlock and "#FFDE00FF" or "#A2A2A2")
		var_9_6.desc = var_1_10010
		defaultValue = var_1_10014
		var_9_6.descTrigger = var_1_10014(iter_9_1.descTrigger, iter_9_1.unlock)

		var_1_10011(var_1_10012, var_9_6)
	end
	...
	local var_9_7 = var_5(var_9_0, arg_9_0:Find("part"))

	var_5.SetSiblingIndex(var_9_7, 0)

	local var_9_8 = var_0_8
	local var_9_9 = var_5
	local var_9_10 = {
		value = ""
	}
	...
	i18n = var_9
	var_9_10.name = var_9("equip_info_23")

	var_9_8(var_9_9, var_9_10)

	local var_9_11 = arg_9_0:Find("part/value")
	local var_9_12 = var_6.Find(var_9_11, "label")
	local var_9_13 = {}
	local var_9_14 = {}
	...
	if #arg_9_1.part[1] == 0 and #arg_9_1.part[2] == 0 then
		...
		for iter_9_2, iter_9_3 in var_10(arg_9_1.part[1]) do
			var_9_13[iter_9_3] = true
		end

		ipairs = var_10

		for iter_9_4, iter_9_5 in var_10(arg_9_1.part[2]) do
			var_9_14[iter_9_5] = true
		end
	end

	ShipType = var_10

	local var_9_15 = var_10.MergeFengFanType

	ShipType = var_1_10011

	local var_9_16 = var_1_10011.FilterOverQuZhuType

	ShipType = var_1_10012

	local var_9_17 = var_9_15(var_9_16(var_1_10012.AllShipType), var_9_13, var_9_14)

	UIItemList = var_11

	var_11.StaticAlign(var_6, var_9_12, #var_9_17, function(arg_12_0, arg_12_1, arg_12_2)
		arg_12_1 = arg_12_1 + 1
		UIItemList = var_2_10003

		if arg_12_0 == var_2_10003.EventUpdate then
			local var_12_0 = var_9_17[arg_12_1]
			...
			var_2_10004(var_12_1, var_2_10006.Type2CNLabel(var_12_0), arg_12_2)
			...
			if var_9_13[var_12_0] then
				var_12_3 = not var_9_14[var_12_0]
			end
			...
			if var_9_14[var_12_0] then
				var_12_5 = not var_9_13[var_12_0]
			end
			...
			var_2_10004(arg_12_2, not var_9_13[var_12_0] and not var_9_14[var_12_0] and 0.3 or 1)
		end
