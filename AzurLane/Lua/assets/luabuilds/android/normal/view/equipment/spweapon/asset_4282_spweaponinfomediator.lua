...
function var_0_1.register(arg_1_0)
	...
	if var_1_2 == var_1_10004.SPWEAPON_STOREHOUSE then
	...
	if arg_1_0.contextData.shipVO then
		...
		var_1_5[1] = var_1_10007.GetSpWeapon(var_1_6)
		var_1_5[2] = arg_1_0.contextData.shipVO

		if not var_1_5 then
			var_1_5 = {}
			EquipmentProxy = var_1_10007
			var_1_5[1] = var_1_10007.StaticGetSpWeapon(arg_1_0.contextData.shipId, arg_1_0.contextData.spWeaponUid)
		end

		local var_1_7, var_1_8 = var_1_3(var_1_5)
...
function var_0_1.BindEvent(arg_2_0)
	arg_2_0:bind(var_0_1.ON_EQUIP, function(arg_3_0)
		if arg_2_0.contextData.oldShipId then
			...
			var_3_1(var_3_0, var_2_10003.EQUIP_SPWEAPON_FROM_SHIP, {
			...
			var_3_3(var_3_2, var_2_10003.EQUIP_SPWEAPON_TO_SHIP, {
				spWeaponUid = arg_2_0.contextData.oldSpWeaponUid,
				shipId = arg_2_0.contextData.shipId
			})
		end
	...
	arg_2_0:bind(var_0_1.ON_UNEQUIP, function(arg_4_0)
		...
		var_4_1(var_4_0, var_2_10003.EQUIP_SPWEAPON_TO_SHIP, {
			shipId = arg_2_0.contextData.shipId
		})
	...
	arg_2_0:bind(var_0_1.ON_MODIFY, function(arg_5_0)
		...
		SpWeaponModifyMediator = var_2_10005
		var_5_3.mediator = var_2_10005
		SpWeaponModifyLayer = var_2_10005
		...
		var_5_5(var_5_4, var_3.ON_CLOSE)
	...
	arg_2_0:bind(var_0_1.ON_INTENSIFY, function(arg_6_0)
		...
		if var_1.getShipById(var_6_0, arg_2_0.contextData.shipId) then
			...
			local var_6_1, var_6_2 = var_6_0.ShipStatusCheck("onModify", var_2)

			if not var_6_1 then
				pg = var_2_10005

				local var_6_3 = var_2_10005.TipsMgr.GetInstance()

				var_2_10005.ShowTips(var_6_3, var_6_2)
		...
		local var_6_6 = var_2_10005.New
		local var_6_7 = {}

		SpWeaponUpgradeMediator = var_2_10007
		var_6_7.mediator = var_2_10007
		SpWeaponUpgradeLayer = var_2_10007
		var_6_7.viewComponent = var_2_10007
		var_6_7.data = {
			spWeaponUid = arg_2_0.contextData.spWeaponUid,
			shipId = arg_2_0.contextData.shipId
		}
		...
		var_6_5(var_6_4, var_6_6(var_6_7), true, function()
			...
			var_7_1(var_7_0, var_3_10002.ON_CLOSE)
	...
	arg_2_0:bind(var_0_1.ON_CHANGE, function(arg_8_0)
		...
		local var_8_2, var_8_3 = var_8_0.ShipStatusCheck("onModify", var_8_1)
		...
		var_8_6(var_8_5, var_2_10007.ON_CLOSE)
		...
		local var_8_9 = var_7.GO_SCENE

		SCENE = var_2_10008

		local var_8_10 = var_2_10008.SPWEAPON_STOREHOUSE
		local var_8_11 = {
			lock = true,
			shipId = arg_2_0.contextData.shipId
		}

		StoreHouseConst = var_10
		var_8_11.warp = var_10.WARP_TO_WEAPON
		StoreHouseConst = var_10
		var_8_11.mode = var_10.EQUIPMENT
	...
	arg_2_0:bind(var_0_1.ON_MOVE, function(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_2_10004.ON_CLOSE)
		...
		local var_9_4 = var_4.GO_SCENE

		SCENE = var_2_10005

		var_9_3(var_9_2, var_9_4, var_2_10005.SHIPINFO, {
			page = 2,
			shipId = arg_9_1
		})
...
function var_0_1.handleNotification(arg_11_0, arg_11_1)
	...
	if var_11_0 == var_11_1.EQUIP_SPWEAPON_TO_SHIP_DONE then
		local var_11_3 = arg_11_0.viewComponent
		local var_11_4 = var_4.emit

		BaseUI = var_1_10006

		var_11_4(var_11_3, var_1_10006.ON_CLOSE)
	end
