...
function var_0_1.init(arg_2_0)
	...
	var_2_7(var_2_6, var_4(var_1_10005)).constraintCount = 6
	...
	local var_2_11 = var_1
	local var_2_12 = var_1.Find(var_2_11, "Field/Text")

	i18n = var_2_11

	var_4(var_2_12, var_2_11("equipment_upgrade_quick_interface_source_chosen"))

	setText = var_4

	local var_2_13 = var_3
	local var_2_14 = var_3.Find(var_2_13, "Text")

	i18n = var_2_13

	var_4(var_2_14, var_2_13("equipment_upgrade_quick_interface_materials_consume"))
...
function var_0_1.GetAllPaths(arg_4_0, arg_4_1)
	...
	while #var_4_1 > 0 do
		...
		local var_4_2 = var_4_2.remove(var_4_1, 1)

		EquipmentProxy = var_5

		local var_4_3 = var_5.GetTransformSources(var_4_2[1])
		...
		for iter_4_0, iter_4_1 in var_6(var_4_3) do
			...
			if var_4_2[2] then
				...
				if #var_1_10013.GetEquipmentTransformCandicates(var_4_5, var_1_10011) > 0 then
					...
					var_4_6(var_4_7, var_16.map(var_1_10013, function(arg_5_0)
						return {
							source = arg_5_0,
							formulas = var_4_4
						}
...
function var_0_1.UpdateSort(arg_8_0)
	...
	var_1(var_8_4, var_3(var_0_4[arg_8_0.contextData.sortOrder]))
...
function var_0_1.didEnter(arg_10_0)
	function arg_10_0.equipLayoutScroll.onUpdateItem(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_11_2, var_2_10005(arg_11_1))
	...
	local function var_10_3()
		...
		var_1(arg_10_0.sortBar, not var_13_0)
	...
	var_10_0(var_10_1, var_10_2, var_10_3, var_1_10005)

	for iter_10_0 = 1, arg_10_0.sortBar.childCount do
		local var_10_4 = arg_10_0.sortBar

		var_1_10005 = var_1_10005.GetChild(var_10_4, iter_10_0 - 1)
		onButton = var_10_4

		local var_10_5 = arg_10_0
		local var_10_6 = var_1_10005
		...
		var_10_4(var_10_5, var_10_6, var_10_7, var_1_10010)
	end

	onButton = var_1

	local var_10_8 = arg_10_0
	local var_10_9 = arg_10_0.sortOrderBtn
	...
	var_1(var_10_8, var_10_9, var_10_10, var_1_10005)

	onButton = var_1

	local var_10_11 = arg_10_0
	local var_10_12 = arg_10_0.cancelBtn
	...
	var_1(var_10_11, var_10_12, var_10_13, var_1_10005)

	onButton = var_1

	local var_10_14 = arg_10_0
	local var_10_15 = arg_10_0.confirmBtn
	...
	local function var_10_16()
		if not arg_10_0.contextData.sourceEquipmentInstance then
			...
			var_2_10001(var_17_0, var_2_10003("equipment_upgrade_quick_interface_feedback_source_chosen"))
		...
		if not var_2_10001.CheckTransformFormulasSucceed(arg_10_0.contextData.sourceEquipmentFormulaList, var_0) then
			...
			var_17_2(var_17_1, var_3("equipment_upgrade_feedback_lack_of_materials"))
		...
		EquipmentTraceBackMediator = var_3

		var_17_4(var_17_3, var_3.TRANSFORM_EQUIP, var_0, arg_10_0.contextData.sourceEquipmentFormulaList)
	...
	var_1(var_10_14, var_10_15, var_10_16, var_1_10005)

	local var_10_17 = arg_10_0.contextData
	local var_10_18

	if not arg_10_0.contextData.sortOrder then
		var_10_18 = var_0_1.SortOrder.Descend
	end

	var_10_17.sortOrder = var_10_18

	local var_10_19 = arg_10_0.contextData
	local var_10_20

	if not arg_10_0.contextData.sortType then
		var_10_20 = var_0_1.SortType.Rarity
	end

	var_10_19.sortType = var_10_20
	...
	local var_10_21 = arg_10_0.targetEquip
	local var_10_22 = {}

	DROP_TYPE_EQUIP = var_10_16
	var_10_22.type = var_10_16
	var_10_22.id = arg_10_0.contextData.TargetEquipmentId

	var_1(var_10_21, var_10_22)

	pg = var_1

	local var_10_23 = var_1.UIMgr.GetInstance()

	var_1.BlurPanel(var_10_23, arg_10_0._tf, {
		staticBlur = true
	})
...
function var_0_1.UpdateSourceListItem(arg_19_0, arg_19_1, arg_19_2)
	...
	var_5(arg_19_2:Find("Item/mask"), false)

	local var_19_1 = var_3.type

	DROP_TYPE_ITEM = var_19_2

	if var_19_1 == var_19_2 then
		local var_19_2 = arg_19_2
		local var_19_3 = arg_19_2.Find(var_19_2, "Item/icon_bg/count")

		var_19_2 = var_19_0.count

		local var_19_4 = var_3.composeCfg.material_num <= var_19_2

		setColorStr = var_1_10009

		local var_19_5 = var_19_2 .. "/" .. var_7
		...
		if var_19_4 then
			...
			local var_19_6 = var_1_10009(var_19_5, var_11)

			setText = var_19_5

			var_19_5(var_19_3, var_19_6)

			setActive = var_19_5

			var_19_5(arg_19_2:Find("Item/mask"), not var_19_4)

			if var_19_0.shipId then
				getProxy = var_5
				BayProxy = var_19_2

				local var_19_7 = var_5(var_19_2)
				local var_19_8 = var_5.getShipById(var_19_7, var_19_0.shipId)
				local var_19_9 = arg_19_0.loader

				var_6.GetSprite(var_19_9, "qicon/" .. var_19_8:getPainting(), "", arg_19_2:Find("EquipShip/Image"))
			end

			local var_19_10 = arg_19_2:Find("Mask/NameText")
			local var_19_11 = var_5.GetComponent

			typeof = var_7
			ScrollText = var_19_4

			local var_19_12 = var_19_11(var_19_10, var_7(var_19_4))

			var_5.SetText(var_19_12, var_19_0:getConfig("name"))

			onButton = var_5

			local var_19_13 = arg_19_0
			local var_19_14 = arg_19_2:Find("Item")
			...
			local function var_19_15()
				...
				if var_20_0 == var_2_10001 and not (var_0.template.count >= var_0.composeCfg.material_num) then
					...
					var_20_2(var_20_1, var_2_10005(var_20_3, var_7.getConfig(var_20_4, "name")))
				...
				if arg_19_0.lastSourceItem then
					...
					var_0(var_1.Find(var_20_5, "Selected"), false)
				end
				...
				var_20_6(var_1.Find(var_20_7, "Selected"), true)
			...
			var_5(var_19_13, var_19_14, var_19_15, var_9)
...
function var_0_1.UpdateConsumeComparer(arg_22_0)
	...
	if arg_22_0.contextData.sourceEquipmentInstance then
		...
		var_22_3, var_22_4, var_1_10006 = var_22_3.CheckTransformEnoughGold(arg_22_0.contextData.sourceEquipmentFormulaList, arg_22_0.contextData.sourceEquipmentInstance)
		var_22_1 = var_1_10006
		var_22_0 = var_22_4
		var_22_2 = var_22_3
	end
	...
	if var_22_2 then
		...
		local var_22_6 = var_22_3(var_22_5, var_1_10006)

		if var_22_1 > 0 then
			local var_22_7 = var_22_6

			setColorStr = var_1_10006
			var_1_10007 = " + " .. var_22_1
			...
			if var_22_2 then
				...
				var_22_6 = var_22_7 .. var_1_10006(var_1_10007, var_1_10008)

				local var_22_8 = arg_22_0.goldText
				local var_22_9 = var_5.GetComponent

				typeof = var_1_10007
				Text = var_1_10008
				var_22_9(var_22_8, var_1_10007(var_1_10008)).text = var_22_6
...
function var_0_1.UpdateFormula(arg_23_0)
	...
	if var_23_0 then
		...
		if var_23_0 then
			var_23_4 = var_23_0.type
			DROP_TYPE_ITEM = var_1_10005

			if var_23_4 == var_1_10005 then
		...
		var_23_4(var_23_2, var_23_3)

		local var_23_5 = not arg_23_0.contextData.sourceEquipmentFormulaList or #var_4 <= 1
		local var_23_6 = arg_23_0.loader

		var_6.GetSprite(var_23_6, "ui/equipmenttracebackui_atlas", var_23_5 and "wire" or "wire2", arg_23_0.formulaWire)
...
function var_0_1.UpdateFormulaMaterials(arg_24_0)
	...
	var_24_5(var_24_6, var_6.GetChild(var_24_7, 0), #arg_24_0.consumeMaterials, function(arg_26_0, arg_26_1, arg_26_2)
	...
	local var_24_11 = var_24_10(var_24_9, var_7(var_8))
	...
	var_24_11(var_6.Find(var_24_12, "Scrollbar"), not var_24_8)
...
function var_0_1.UpdateFormulaMaterialItem(arg_27_0, arg_27_1, arg_27_2)
	...
	var_5(arg_27_2:Find("Item"), var_27_1)

	getProxy = var_5
	BagProxy = var_6

	local var_27_2 = var_5(var_6)
	local var_27_3 = var_5.getItemCountById(var_27_2, var_27_0.id)

	setText = var_27_2

	local var_27_4 = arg_27_2
	local var_27_5 = arg_27_2.Find(var_27_4, "Count")

	setColorStr = var_27_4

	local var_27_6 = var_27_0.count

	if var_27_0.count <= var_27_3 then
		COLOR_GREEN = var_10
		...
		var_27_2(var_27_5, var_27_4(var_27_6, var_10) .. "/" .. var_27_3)

		onButton = var_27_2

		var_27_2(arg_27_0, arg_27_2:Find("Item"), function()
