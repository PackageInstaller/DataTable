...
function var_0_1.register(arg_1_0)
	...
	var_1_3(var_1_4, "equipmentVOs can not be nil")
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_0 == var_4_1.DESTROY_EQUIPMENTS_DONE then
		...
		if var_4.getCurrentContext(var_4_4) and var_4.mediator.__cname ~= "EquipmentMediator" then
			...
			if var_5.getCount(var_4_2) ~= 0 then
				...
				local var_4_7 = var_1_10007.ON_AWARD
				local var_4_8 = {
					items = var_4_2
				}

				AwardInfoLayer = var_1_10009
				var_4_8.title = var_1_10009.TITLE.ITEM
		...
		if var_4_0 == var_4.CANCEL_LIMITED_OPERATION then
			-- block empty
		end
	end
