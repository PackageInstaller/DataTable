...
function var_0_1.init(arg_8_0)
	...
	if var_8_2.CheckNotchRatio ~= 2 then
		getProxy = var_2
		SettingsProxy = var_3

		local var_8_4 = var_2(var_3)
		...
		var_8_6(var_8_5, var_1_10004(var_1_10005)).constraintCount = var_8_3 and 8 or 7
		...
		var_3(var_8_19, var_5("list_empty_tip_equipmentdesignui"))
...
function var_0_1.didEnter(arg_12_0)
	...
	var_12_5(var_12_7, var_4.Find(var_12_8, "adapt/bottom_back"))
	...
	var_2(var_12_9, var_12_10, var_12_11, var_6)
	...
	local function var_12_17()
		...
		var_15_2.mode = var_2_10003.Mode.OR
		IndexConst = var_3
		...
		SpWeaponDesignMediator = var_3

		var_15_5(var_15_4, var_3.OPEN_EQUIPMENTDESIGN_INDEX, var_15_0)
	...
	defaultValue = var_12_15
	var_12_18.showOwned = var_12_15(arg_12_0.contextData.showOwned, false)
...
function var_0_1.initTags(arg_19_0)
	...
	for iter_19_0, iter_19_1 in var_1(var_0_2) do
		if iter_19_0 <= arg_19_0.tagContainer.childCount then
			var_1_10007 = arg_19_0.tagContainer

			local var_19_0

			if not var_19_0.GetChild(var_1_10007, iter_19_0 - 1) then
				cloneTplTo = var_19_0
				var_19_0 = var_19_0(arg_19_0.tagTpl, arg_19_0.tagContainer)
			end

			setActive = var_1_10007

			var_1_10007(var_19_0, true)

			setImageSprite = var_1_10007
			findTF = var_8

			local var_19_1 = var_8(var_19_0, "Image")

			GetSpriteFromAtlas = var_9

			var_1_10007(var_19_1, var_9("ui/equipmentdesignui_atlas", iter_19_1))
			...
			var_1_10007(var_19_2, var_19_3, var_19_4, var_11)

			table = var_1_10007

			var_1_10007.insert(arg_19_0.tagTFs, var_19_0)
		end
	end
...
function var_0_1.initDesign(arg_27_0, arg_27_1)
	...
	var_3(arg_27_0, var_27_0.go, function()
		local var_28_0 = arg_27_0
		local var_28_1 = var_0.emit

		SpWeaponDesignMediator = var_2_10002

		local var_28_2 = var_2_10002.ON_COMPOSITE
		local var_28_3 = var_27_0.spWeaponVO

		var_28_1(var_28_0, var_28_2, var_3.GetConfigID(var_28_3))
...
function var_0_1.filter(arg_32_0)
	...
	GetSpriteFromAtlasAsync = var_32_0

	var_32_0("ui/share/index_atlas", var_32_1, function(arg_33_0)
	...
	for iter_32_0, iter_32_1 in var_3(arg_32_0.craftList) do
	...
	CompareFuncs = iter_32_1

	var_32_5(var_32_6, iter_32_1(var_0_3.sortFunc(var_0_3.sort[1], var_32_3)))
	...
	var_6(var_7.Find(var_32_8, "Image"), var_32_7)

	setActive = var_6

	var_6(arg_32_0.sortImgAsc, arg_32_0.contextData.asc)

	setActive = var_6

	var_6(arg_32_0.sortImgDec, not arg_32_0.contextData.asc)
