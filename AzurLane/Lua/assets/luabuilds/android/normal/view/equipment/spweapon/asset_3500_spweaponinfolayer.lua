...
function var_0_1.init(arg_2_0)
	...
	var_2(var_2_7, var_4("ship_equip_check"))

	setText = var_2

	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_3.Find(var_2_8, "sample/empty/Text")

	i18n = var_2_8

	var_2(var_2_9, var_2_8("spweapon_ui_empty"))
...
function var_0_1.didEnter(arg_8_0)
	...
	table = var_2
	arg_8_0.isShowUnique = var_2.contains(var_0_1.SHOW_UNIQUE, var_8_2)
	onButton = var_2

	local var_8_3 = arg_8_0
	local var_8_4 = arg_8_0._tf
	local var_8_5 = var_4.Find(var_8_4, "bg")
	...
	var_2(var_8_3, var_8_5, var_8_6, var_6)
...
function var_0_1.initAndSetBtn(arg_10_0, arg_10_1)
	if arg_10_1 == var_0_1.TYPE_DEFAULT or arg_10_1 == var_0_1.TYPE_SHIP then
		...
		var_10_1.Foreach(var_0_2, function(arg_11_0, arg_11_1)
			...
			local var_11_4 = var_11_1.GetChild(var_11_3, 0)

			i18n = var_11_3

			var_11_2(var_11_4, var_11_3(arg_11_1[2]))
		...
		local function var_10_4()
			...
			SpWeaponInfoMediator = var_2_10002

			var_12_1(var_12_0, var_2_10002.ON_CHANGE)
		...
		var_2(var_10_2, var_10_3, var_10_4, var_1_10006)
		...
		local function var_10_7()
			...
			var_13_1(var_13_0, var_2_10002.ON_INTENSIFY)
		...
		var_2(var_10_5, var_10_6, var_10_7, var_1_10006)
		...
		local function var_10_10()
			...
			var_14_1(var_14_0, var_2_10002.ON_UNEQUIP)
		...
		var_2(var_10_8, var_10_9, var_10_10, var_1_10006)
		...
		local function var_10_13()
			...
			var_15_1(var_15_0, var_2_10002.ON_MODIFY)
		...
		var_2(var_10_11, var_10_12, var_10_13, var_1_10006)
	elseif arg_10_1 == var_0_1.TYPE_REPLACE then
		...
		local var_10_21 = var_3.Find(var_10_20, "label")

		i18n = var_10_20

		var_2(var_10_21, var_10_20("msgbox_text_confirm"))

		setText = var_2

		local var_10_22 = arg_10_0.replaceCancelBtn
		local var_10_23 = var_3.Find(var_10_22, "label")

		i18n = var_10_22

		var_2(var_10_23, var_10_22("msgbox_text_cancel"))
		...
		var_2(var_10_24, var_10_25, var_10_26, var_1_10006)
		...
		local function var_10_29()
			if arg_10_0.contextData.quickCallback then
				...
				var_17_2(var_17_1, var_2_10002.ON_EQUIP)
			end
		...
		var_2(var_10_27, var_10_28, var_10_29, var_1_10006)
	elseif arg_10_1 == var_0_1.TYPE_DISPLAY then
		...
		local var_10_34 = var_3.Find(var_10_33, "label")

		i18n = var_10_33

		var_2(var_10_34, var_10_33("msgbox_text_equipdetail"))
		...
		var_2(arg_10_0, arg_10_0.displayMoveBtn, function()
			...
			var_18_1(var_18_0, var_2_10002.ON_MOVE, arg_10_0.shipVO.id)
...
function var_0_1.updateOperation1(arg_19_0)
	...
	SpWeaponHelper = var_1_10005

	var_19_1(var_19_0, var_19_2, var_19_3, var_1_10005.TransformNormalInfo(arg_19_0.equipmentVO))
...
function var_0_1.updateOperation2(arg_20_0)
	...
	var_20_3(var_20_2, var_20_4, var_20_5, var_1_10006.TransformNormalInfo(var_20_1))
	...
	var_20_6(var_20_7, arg_20_0.shipVO)

	if arg_20_0.shipVO then
		setImageSprite = var_3
		findTF = var_4

		local var_20_8 = var_4(var_20_7, "Image")
		...
		var_3(var_20_8, var_5(var_20_9 .. var_7.getPainting(var_20_10)))
	end
...
function var_0_1.updateOperation3(arg_21_0)
	...
	if arg_21_0.equipmentVO then
		SpWeaponHelper = var_2

		local var_21_0, var_21_1 = var_2.CompareNormalInfo(var_1, arg_21_0.oldEquipmentVO)
		...
		var_21_3(var_21_2, var_21_4, var_21_5, var_1_10006.TransformNormalInfo(arg_21_0.oldEquipmentVO))
	end
	...
	var_21_6(var_21_7, arg_21_0.oldShipVO)

	if arg_21_0.oldShipVO then
		setImageSprite = var_3
		findTF = var_4

		local var_21_8 = var_4(var_21_7, "Image")
		...
		var_3(var_21_8, var_5(var_21_9 .. var_7.getPainting(var_21_10)))
	end
...
function var_0_1.updateOperation4(arg_22_0)
	...
	var_22_1(var_22_0, var_22_2, var_22_3, var_1_10005.TransformNormalInfo(arg_22_0.equipmentVO))
	...
	var_22_4(var_22_5, arg_22_0.shipVO)

	if arg_22_0.shipVO then
		setImageSprite = var_2
		findTF = var_3

		local var_22_6 = var_3(var_22_5, "Image")
		...
		var_2(var_22_6, var_4(var_22_7 .. var_6.getPainting(var_22_8)))
	end
...
function var_0_1.updateOperationAward(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	for iter_23_1 = 1, #arg_23_3 do
		...
		local function var_23_4()
			...
			var_0.emit(var_24_0, var_0_1.ON_DROP, var_23_1)
		...
		var_10(var_23_2, var_23_3, var_23_4, var_1_10014)

		setText = var_10
		findTF = var_23_2

		local var_23_5 = var_23_2(var_23_0, "name_panel/name")

		getText = var_12
		findTF = var_13

		var_10(var_23_5, var_12(var_13(var_23_0, "name")))

		setText = var_10
		findTF = var_23_5

		local var_23_6 = var_23_5(var_23_0, "name_panel/number")
		local var_23_7 = " x "

		getText = var_13
		findTF = var_1_10014

		var_10(var_23_6, var_23_7 .. var_13(var_1_10014(var_23_0, "icon_bg/count")))

		setActive = var_10
		findTF = var_23_6

		var_10(var_23_6(var_23_0, "icon_bg/count"), false)
	end
...
function var_0_1.updateEquipmentPanel(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	local var_25_2 = arg_25_1.Find(var_25_1, "empty")

	setActive = var_25_1

	var_25_1(var_25_0, arg_25_2)

	setActive = var_25_1

	var_25_1(var_25_2, not arg_25_2)
	...
	local var_25_3 = var_25_1(var_25_0, "name")

	setScrollText = var_7
	findTF = var_8

	var_7(var_8(var_25_3, "mask/Text"), arg_25_2:GetName())

	findTF = var_7

	local var_25_4 = var_7(var_25_0, "equip")

	setImageSprite = var_8
	findTF = var_9

	local var_25_5 = var_9(var_25_4, "bg")

	GetSpriteFromAtlas = var_10

	local var_25_6 = "ui/equipmentinfoui_atlas"
	local var_25_7 = "equip_bg_"

	ItemRarity = var_1_10013

	var_8(var_25_5, var_10(var_25_6, var_25_7 .. var_1_10013.Rarity2Print(arg_25_2:GetRarity())))

	updateSpWeapon = var_8

	var_8(var_25_4, arg_25_2, {
		noIconColorful = true
	})
	...
	var_8(var_9(var_25_4, "slv"), arg_25_2:GetLevel() > 1)

	setText = var_8
	findTF = var_9

	var_8(var_9(var_25_4, "slv/Text"), arg_25_2:GetLevel() - 1)

	setActive = var_8
	findTF = var_9

	var_8(var_9(var_25_4, "slv/next"), false)

	setText = var_8
	findTF = var_9

	var_8(var_9(var_25_4, "slv/next/Text"), arg_25_2:GetLevel() - 1)

	local var_25_8 = var_25_4
	local var_25_9 = var_25_4.Find(var_25_8, "tier")

	setActive = var_25_8

	var_25_8(var_25_9, arg_25_2)

	local var_25_10 = arg_25_2
	local var_25_11 = arg_25_2.GetTechTier(var_25_10)

	eachChild = var_25_10

	var_25_10(var_25_9, function(arg_26_0)
		...
		var_2_10001(var_26_0, var_2_10003(var_25_11) == arg_26_0.gameObject.name)

		return
	end)

	updateSpWeaponInfo = var_25_10

	var_25_10(var_25_0:Find("attributes/view/content"), arg_25_3, arg_25_2:GetSkillGroup())
...
function var_0_1.cloneSampleTo(arg_27_0, arg_27_1, arg_27_2, arg_27_3, arg_27_4)
	...
	Vector3 = var_6
	var_27_0.localPosition = var_6.New(var_0_1.pos[arg_27_2][1], var_0_1.pos[arg_27_2][2], var_0_1.pos[arg_27_2][3])
