...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_DESTROY, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.DESTROY_EQUIPMENTS, {
			equipments = arg_4_1
		})
	...
	arg_1_0:bind(var_0_1.ON_UNEQUIP_EQUIPMENT, function(arg_5_0)
		...
		var_5_1(var_5_0, var_2_10003.UNEQUIP_FROM_SHIP, {
	...
	arg_1_0:bind(var_0_1.OPEN_DESIGN, function(arg_6_0)
		...
		local var_6_2 = var_6_1(var_6_0, var_2_10004)
		local var_6_3 = var_2.getContextByMediator

		EquipmentDesignMediator = var_2_10005

		if var_6_3(var_6_2, var_2_10005) then
			return
		end
		...
		var_6_7.viewComponent = var_2_10008
		EquipmentDesignMediator = var_2_10008
		var_6_7.mediator = var_2_10008

		local var_6_8 = {}
		local var_6_9 = arg_1_0.viewComponent

		var_6_8.groupName = var_9.getGroupName(var_6_9)
	...
	arg_1_0:bind(var_0_1.CLOSE_DESIGN_LAYER, function(arg_7_0)
		...
		local var_7_2 = var_7_1(var_7_0, var_2_10004)
		local var_7_3 = var_2.getContextByMediator

		EquipmentDesignMediator = var_2_10005

		if var_7_3(var_7_2, var_2_10005) then
			local var_7_4 = arg_1_0
			local var_7_5 = var_4.sendNotification

			GAME = var_2_10006

			var_7_5(var_7_4, var_2_10006.REMOVE_LAYERS, {
				context = var_3
			})
		end
	...
	arg_1_0:bind(var_0_1.ON_UNEQUIP_EQUIPMENT_SKIN, function(arg_9_0)
		...
		var_9_1(var_9_0, var_2_10003.EQUIP_EQUIPMENTSKIN_TO_SHIP, {
			equipmentSkinId = 0,
			shipId = arg_1_0.contextData.shipId,
			pos = arg_1_0.contextData.pos
		})
