...
function var_0_1.BindEvent(arg_2_0)
	...
	arg_2_0:bind(var_0_1.OPEN_TRANSFORM_TREE, function(arg_5_0, arg_5_1)
		...
		local var_5_4 = var_2_10004.GO_SCENE

		SCENE = var_2_10005

		local var_5_5 = var_2_10005.EQUIPMENT_TRANSFORM
		local var_5_6 = {
			targetEquipId = arg_5_1
		}

		EquipmentTransformTreeScene = var_2_10007
		var_5_6.mode = var_2_10007.MODE_HIDESIDE
	...
	arg_2_0:bind(var_0_1.SELECT_TRANSFORM_FROM_STOREHOUSE, function(arg_6_0, arg_6_1)
		...
		local var_6_4 = var_2_10005.GO_SCENE

		SCENE = var_2_10006

		local var_6_5 = var_2_10006.SELECT_TRANSFORM_EQUIPMENT
		local var_6_6 = {}

		StoreHouseConst = var_2_10008
		var_6_6.warp = var_2_10008.WARP_TO_WEAPON
		...
		function var_6_6.onSelect(arg_7_0)
			...
			if var_7_0 == var_3_10002 and arg_7_0.template.count < arg_7_0.composeCfg.material_num then
				pg = var_1
				var_3_10002 = var_1.TipsMgr.GetInstance()

				local var_7_1 = var_1.ShowTips

				i18n = var_3_10003

				local var_7_2 = "equipment_upgrade_feedback_lack_of_fragment"
				local var_7_3 = arg_7_0.template

				var_7_1(var_3_10002, var_3_10003(var_7_2, var_5.getConfig(var_7_3, "name")))

				return false
			else
				local var_7_4 = arg_7_0.type

				DROP_TYPE_EQUIP = var_3_10002

				if var_7_4 == var_3_10002 and arg_7_0.template.count <= 0 then
					pg = var_1
					...
					local var_7_7 = "common_no_x"
					local var_7_8 = arg_7_0.template

					var_7_6(var_7_5, var_3_10003(var_7_7, var_5.getConfig(var_7_8, "name")))
...
function var_0_1.handleNotification(arg_11_0, arg_11_1)
	...
	if var_11_0 == var_11_1.UPDATED then
		local var_11_3 = arg_11_0:getViewComponent()

		var_4.UpdatePlayer(var_11_3, var_11_2)
	...
	if var_11_0 == var_4.ITEM_UPDATED then
		local var_11_4 = arg_11_0:getViewComponent()

		var_4.UpdatePage(var_11_4)
	...
	if var_11_0 == var_4.EQUIPMENT_UPDATED then
		if arg_11_0.contextData.sourceEquipmentInstance then
			var_11_5 = var_11_2.count == 0

			local var_11_6 = arg_11_0.contextData.sourceEquipmentInstance

			if var_11_5 then
				var_1_10006 = var_11_6.type
				DROP_TYPE_EQUIP = var_1_10007

				if var_1_10006 == var_1_10007 then
					EquipmentProxy = var_1_10006

					if var_1_10006.SameEquip(var_11_2, var_11_6.template) then
		...
		var_1_10006 = arg_11_0:getViewComponent()

		var_11_5.UpdateSourceEquipmentPaths(var_1_10006)

		var_1_10006 = var_11_5

		var_11_5.UpdateSourceInfo(var_1_10006)

		var_1_10006 = var_11_5

		var_11_5.UpdateTargetInfo(var_1_10006)
	...
	if var_11_0 ~= var_11_5.UNEQUIP_FROM_SHIP_DONE then
		GAME = var_4

		if var_11_0 == var_4.EQUIP_TO_SHIP_DONE then
			if arg_11_0.contextData.sourceEquipmentInstance then
				local var_11_7 = var_4.type

				DROP_TYPE_EQUIP = var_1_10006

				if var_11_7 == var_1_10006 then
					local var_11_8 = var_11_2:getEquip(var_4.template.shipPos)

					if var_4.template.shipId == var_11_2.id and (not var_11_8 or var_11_8.id ~= var_4.id) then
						arg_11_0.contextData.sourceEquipmentInstance = nil
					end
				end
			end

			local var_11_9 = arg_11_0:getViewComponent()

			var_5.UpdateSourceEquipmentPaths(var_11_9)
			...
			if var_11_0 == var_4.TRANSFORM_EQUIPMENT_DONE then
				var_11_10 = arg_11_0.contextData
				var_11_10.sourceEquipmentInstance = nil

				local var_11_11 = arg_11_0:getViewComponent()

				var_11_10.UpdatePage(var_11_11)
			else
				GAME = var_11_10

				if var_11_0 == var_11_10.TRANSFORM_EQUIPMENT_FAIL then
					local var_11_12 = arg_11_0:getViewComponent()

					var_4.UpdatePage(var_11_12)
				end
			end
		end
