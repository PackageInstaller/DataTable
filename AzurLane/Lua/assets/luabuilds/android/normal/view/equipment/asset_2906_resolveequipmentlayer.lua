...
function var_0_1.init(arg_5_0)
	...
	local var_5_2 = var_2.Find(var_5_1, "top/title_list/infomation/title")

	i18n = var_5_1

	var_1(var_5_2, var_5_1("title_info"))

	setText = var_1

	local var_5_3 = arg_5_0.mainPanel
	local var_5_4 = var_2.Find(var_5_3, "title/Text")

	i18n = var_5_3

	var_1(var_5_4, var_5_3("resolve_equip_tip"))
	...
	local var_5_10 = var_2.Find(var_5_9, "Image")

	i18n = var_5_9

	var_1(var_5_10, var_5_9("text_cancel"))
	...
	local var_5_13 = var_2.Find(var_5_12, "Image")

	i18n = var_5_12

	var_1(var_5_13, var_5_12("text_confirm"))
	...
	local var_5_17 = var_2.Find(var_5_16, "ALL/Label")

	i18n = var_5_16

	var_1(var_5_17, var_5_16("word_equipment_all"))
	...
	local var_5_22 = var_2.Find(var_5_21, "got/title")

	i18n = var_5_21

	var_1(var_5_22, var_5_21("resolve_equip_title"))

	setText = var_1

	local var_5_23 = arg_5_0.destroyConfirm
	local var_5_24 = var_2.Find(var_5_23, "actions/cancel_button/Image")

	i18n = var_5_23

	var_1(var_5_24, var_5_23("text_cancel"))

	setText = var_1

	local var_5_25 = arg_5_0.destroyConfirm
	local var_5_26 = var_2.Find(var_5_25, "actions/destroy_button/Image")

	i18n = var_5_25

	var_1(var_5_26, var_5_25("text_confirm"))
...
function var_0_1.didEnter(arg_6_0)
	...
	local function var_6_8()
		...
		if var_2_10001.any(arg_6_0.selectedIds, function(arg_10_0)
			...
			var_1.insert(var_9_0, function(arg_11_0)
				...
				var_11_2(var_11_1, var_11_3, var_3_10004.map(arg_6_0.selectedIds, function(arg_12_0)
		...
		var_1(var_9_0, function()
			...
			if #arg_6_0.selectedIds <= 0 then
				...
				var_13_1(var_13_0, var_3_10002("err_resloveequip_nochoice"))
	...
	var_1(var_6_9, var_6_10, var_6_11, var_5)
	...
	local function var_6_14()
		...
		var_2_10001(var_15_0, function()
			...
			ResolveEquipmentMediator = var_3_10002

			var_16_1(var_16_0, var_3_10002.ON_RESOLVE, arg_6_0.selectedIds)
	...
	var_1(var_6_12, var_6_13, var_6_14, var_5)
	...
	var_1(arg_6_0.selectOptions, function(arg_17_0)
		...
		var_2_10001(var_17_0, var_17_1, var_17_2, var_2_10005)
...
function var_0_1.OnResolveEquipDone(arg_24_0)
	...
	for iter_24_0, iter_24_1 in var_1_10001(var_0_4) do
		if arg_24_0.optionStatus[iter_24_1] == var_0_6.ALL then
			var_1_10008 = arg_24_0

			arg_24_0.SetLocalDataByOption(var_1_10008, iter_24_1, 1)
		elseif var_6 == var_0_6.NONE then
			var_1_10008 = arg_24_0

			arg_24_0.SetLocalDataByOption(var_1_10008, iter_24_1, 0)
		end
	end
...
function var_0_1.onBackPressed(arg_26_0)
	...
	if var_26_1(arg_26_0.destroyConfirm) then
		...
		var_1(var_2(arg_26_0.destroyConfirm, "actions/cancel_button"))
	else
...
function var_0_1.selAllEquipsByRaritys(arg_30_0, arg_30_1)
	...
	for iter_30_0, iter_30_1 in var_1_10002(arg_30_0.equipmentVOs) do
		...
		local var_30_1 = iter_30_1.getConfig(var_30_0, "rarity")

		table = var_30_0

		if var_30_0.contains(arg_30_1, var_30_1) then
...
function var_0_1.unselAllEquipsByRaritys(arg_31_0, arg_31_1)
	...
	arg_31_0.selectedIds = var_1_10002.select(arg_31_0.selectedIds, function(arg_32_0)
		...
		return not var_32_0.contains(arg_31_1, var_32_1)
	end)
...
function var_0_1.displayDestroyBonus(arg_33_0)
	...
	for iter_33_0, iter_33_1 in var_1_10003(arg_33_0.selectedIds) do
		...
		if var_1_10008.CanInBag(iter_33_1[1]) then
			...
			var_33_1 = var_33_1 + var_1_10010 * iter_33_1[2]
			ipairs = var_11
			...
			for iter_33_2, iter_33_3 in var_11(var_33_2) do
				...
				if not var_33_3 then
					...
					DROP_TYPE_ITEM = iter_33_4
					var_33_5.type = iter_33_4
					var_33_5.id = iter_33_3[1]
					var_33_5.count = iter_33_3[2] * iter_33_1[2]

					var_1_10017(var_33_4, var_33_5)
				end
			end
		end
	end
	...
	if 0 < var_33_1 then
		...
		local var_33_6 = var_3.insert
		local var_33_7 = var_33_0
		local var_33_8 = {
			id = 1
		}

		DROP_TYPE_RESOURCE = iter_33_0
		var_33_8.type = iter_33_0
		var_33_8.count = var_33_1
	...
	for iter_33_6 = #var_33_0, arg_33_0.destroyBonusList.childCount - 1 do
		...
		local var_33_9 = arg_33_0.destroyBonusList

		iter_33_1(var_8.GetChild(var_33_9, iter_33_6))
	end
	...
	for iter_33_8 = 1, #var_33_0 do
		...
		local var_33_11 = var_7.GetChild(var_33_10, iter_33_8 - 1)
		local var_33_12 = var_33_0[iter_33_8].type

		DROP_TYPE_SHIP = var_1_10010

		if var_33_12 == var_1_10010 then
			arg_33_0.hasShip = true
		end

		var_1_10010 = var_33_11

		local var_33_13 = var_33_11.Find(var_1_10010, "icon_bg/icon/icon")

		GetComponent = var_1_10010

		local var_33_14 = var_33_11
		local var_33_15 = var_33_11.Find(var_33_14, "icon_bg/icon")

		typeof = var_33_14
		Image = var_13
		var_1_10010 = var_1_10010(var_33_15, var_33_14(var_13))
		var_1_10010.enabled = true
		IsNil = var_11

		if not var_11(var_33_13) then
			setActive = var_11

			var_11(var_33_13, false)
		end

		updateDrop = var_11

		var_11(var_33_11, var_8)
		...
		var_13(var_33_11:Find("name"), var_33_17)

		onButton = var_13

		local var_33_18 = arg_33_0
		local var_33_19 = var_33_11
		...
		local function var_33_20()
			...
			if var_34_0 ~= var_2_10001 then
				...
				if var_34_1 == var_2_10001 then
					var_2_10001 = arg_33_0

					local var_34_2 = var_0.emit
					local var_34_3 = var_0_1.ON_ITEM
					local var_34_4 = var_0

					var_34_2(var_2_10001, var_34_3, var_3.getConfig(var_34_4, "id"))
				else
					local var_34_5 = var_0.type

					DROP_TYPE_EQUIP = var_2_10001

					if var_34_5 == var_2_10001 then
						local var_34_6 = arg_33_0
						local var_34_7 = var_0.emit
						local var_34_8 = var_0_1.ON_EQUIPMENT
						local var_34_9 = {}
						local var_34_10 = var_0

						var_34_9.equipmentId = var_4.getConfig(var_34_10, "id")
						EquipmentInfoMediator = var_4
						var_34_9.type = var_4.TYPE_DISPLAY

						var_34_7(var_34_6, var_34_8, var_34_9)
					end
				end
		...
		var_13(var_33_18, var_33_19, var_33_20, var_1_10017)
	end
...
function var_0_1.onInitItem(arg_43_0, arg_43_1)
	...
	var_3(var_43_1, var_43_2, var_43_3, var_1_10007)
	...
	var_3(var_43_4, var_43_5, var_43_6, var_1_10007)
...
function var_0_1.onUpdateItem(arg_46_0, arg_46_1, arg_46_2)
	...
	for iter_46_0, iter_46_1 in var_7(arg_46_0.selectedIds) do
...
function var_0_1.selectEquip(arg_48_0, arg_48_1, arg_48_2)
	...
	if arg_48_1:isImportance() then
		...
		var_48_1(var_48_0, var_5("retire_importantequipment_tips"))
...
function var_0_1.GetOptionStatus(arg_51_0, arg_51_1)
	if arg_51_1 == var_0_3.ALL then
		if #arg_51_0.selectedIds == 0 then
			...
			var_1_10003 = arg_51_0

			if arg_51_0.isSelectedAll(var_1_10003) then
				return var_0_6.ALL
			else
				return var_0_6.PART
			end
		...
		if not var_1_10003.any(arg_51_0.equipmentVOs, function(arg_52_0)
			...
			local var_52_1 = arg_52_0.getConfig(var_52_0, "rarity")

			table = var_52_0

			return var_52_0.contains(var_51_0, var_52_1)
		end) then
			return var_0_6.GREY
		end
		...
		local var_51_1 = var_4.any(arg_51_0.selectedIds, function(arg_53_0)
			local var_53_0 = arg_51_0.equipmentVOByIds[arg_53_0[1]]
			local var_53_1 = var_1.getConfig(var_53_0, "rarity")

			table = var_53_0

			return var_53_0.contains(var_51_0, var_53_1)
		end)
		local var_51_2
...
function var_0_1.isSelectedAllRaritys(arg_54_0, arg_54_1)
	...
	for iter_54_0, iter_54_1 in var_1_10002(arg_54_0.equipmentVOByIds) do
		...
		if var_54_0.contains(arg_54_1, var_54_1) then
			local var_54_2 = false

			pairs = var_9

			for iter_54_2, iter_54_3 in var_9(arg_54_0.selectedIds) do
				if iter_54_3[1] == iter_54_1.id and iter_54_1.count == iter_54_3[2] then
					var_54_2 = true
				end
			end

			if var_54_2 == false then
				return false
			end
		end
	end
...
function var_0_1.checkDestroyGold(arg_55_0, arg_55_1, arg_55_2)
	...
	if var_5.GoldMax(var_55_5, var_55_0) then
		...
		local var_55_8 = var_7("gold_max_tip_title")

		i18n = var_8

		var_55_7(var_55_6, var_55_8 .. var_8("resource_max_tip_destroy"))
...
function var_0_1.SureExit(arg_56_0)
	...
	i18n = var_1_10004
	var_56_2.content = var_1_10004("sure_exit_resolve_equip")
...
function var_0_1.willExit(arg_58_0)
	...
	var_58_2(var_58_1, var_58_3, var_1_10004.UIMgr.GetInstance().UIMain)
