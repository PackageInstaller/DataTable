...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".AssignedItemView"))
...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_2_1, var_3("blueprint_select_overflow"))
	...
	local function var_2_4()
		...
		if var_3_1 < var_2.GetBlueprintNeed(var_3_2, var_3_0.id) then
			...
			math = var_4
			var_3_3.count = var_4.floor((var_2 + var_3_0.count - 1) / var_3_0.count)
	...
	local function var_2_7()
			...
			if not var_4.checkBlueprintIsFate(var_4_5, var_4_0.id) then
				if var_4_1 <= var_4_3 then
					...
					var_4.insert(var_4_4, function(arg_5_0)
						...
						i18n = var_3_10004
						var_5_2.content = var_3_10004("blueprint_exchange_fate_unlock")
					...
					var_4.insert(var_4_4, function(arg_6_0)
						...
						var_6_2.content = var_3_10004(var_6_3, var_6.getConfig(var_6_4, "name"), var_4_1 - var_4_3)
		...
		if not arg_2_0.isAllNeedZero and var_4_3 < var_4_1 then
			...
			var_4.insert(var_4_4, function(arg_7_0)
				...
				var_7_2.content = var_3_10004(var_7_3, var_6.getConfig(var_7_4, "name"), var_4_1 - var_4_3)
		...
		var_4(var_4_4, function()
			...
			local var_8_2 = var_3_10002.ON_USE_ITEM
	...
	local var_2_10 = var_2.Find(var_2_9, "Text_off")

	i18n = var_2_9

	var_1(var_2_10, var_2_9("show_fate_demand_count"))

	setText = var_1

	local var_2_11 = arg_2_0.toggleSwitch
	local var_2_12 = var_2.Find(var_2_11, "Text_on")

	i18n = var_2_11

	var_1(var_2_12, var_2_11("show_design_demand_count"))
	...
	local var_2_17 = var_2.Find(var_2_16, "operate/got/top/info/Text")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("fate_unlock_icon_desc"))
...
function var_0_1.GetBlueprintNeed(arg_10_0, arg_10_1)
	...
	local var_10_4 = var_10_2(var_10_1, var_4.GetBlueprint4Item(var_10_3, arg_10_1))
	local var_10_5

	if not arg_10_0.bagProxy then
		getProxy = var_10_5
		BagProxy = var_4
		var_10_5 = var_10_5(var_4)
	end
	...
	return var_10_6(var_10_9 - var_5.getItemCountById(var_10_10, var_10_4:getItemId()), 0)
end
...
function var_0_1.checkBlueprintIsUnlock(arg_11_0, arg_11_1)
	...
	local var_11_4 = var_11_2(var_11_1, var_4.GetBlueprint4Item(var_11_3, arg_11_1))
...
function var_0_1.checkBlueprintIsFate(arg_12_0, arg_12_1)
	...
	local var_12_4 = var_12_2(var_12_1, var_4.GetBlueprint4Item(var_12_3, arg_12_1))
...
function var_0_1.updateValue(arg_13_0)
	...
	var_1.each(var_13_0, function(arg_15_0, arg_15_1)
		...
		local var_15_5 = arg_15_1.Find(var_15_4, "item/icon_bg/count")

		setColorStr = var_15_4

		var_15_2(var_15_5, var_15_4(var_15_1, not arg_13_0.isAllNeedZero and var_15_3 < var_15_1 and "#FF5A5A" or "#FFEC6E") .. "/" .. var_15_3)
...
function var_0_1.updateCountText(arg_16_0)
	...
	local var_16_3 = arg_16_0.GetBlueprintNeed(var_16_2, var_16_0.id)

	setText = var_16_2

	local var_16_4 = arg_16_0.valueText

	if not arg_16_0.isAllNeedZero and var_16_3 < var_16_1 then
		setColorStr = var_6

		local var_16_5

		if not var_6(arg_16_0.count, "#FF5A5A") then
			var_16_5 = arg_16_0.count
		end

		var_16_2(var_16_4, var_16_5)

		setActive = var_16_2

		var_16_2(arg_16_0.countOver, not arg_16_0.isAllNeedZero and var_16_3 < var_16_1)
...
function var_0_1.update(arg_17_0, arg_17_1)
	...
	underscore = var_2
	arg_17_0.displayDrops = var_2.map(arg_17_1:getConfig("display_icon"), function(arg_18_0)
		return {
			type = arg_18_0[1],
			id = arg_18_0[2],
			count = arg_18_0[3]
	...
	local var_17_0 = arg_17_0.ulist

	var_2.make(var_17_0, function(arg_19_0, arg_19_1, arg_19_2)
		arg_19_1 = arg_19_1 + 1
		...
		if arg_19_0 == var_2_10003.EventUpdate then
			...
			var_3(var_19_0, var_19_1, var_19_2, var_2_10007)
			...
			var_3(var_19_3, var_5.getConfig(var_19_4, "name"))
			...
			local var_19_8 = arg_19_2.Find(var_19_7, "item/tip/Text")

			i18n = var_19_7

			var_19_5(var_19_8, var_19_7("tech_character_get"))

			setActive = var_19_5

			local var_19_9 = arg_19_2:Find("item/tip")
			local var_19_10 = arg_17_0

			var_19_5(var_19_9, var_5.checkBlueprintIsUnlock(var_19_10, arg_17_0.displayDrops[arg_19_1].id))

			setActive = var_19_5

			local var_19_11 = arg_19_2:Find("fateFlag")
			local var_19_12 = arg_17_0

			var_19_5(var_19_11, var_5.checkBlueprintIsFate(var_19_12, arg_17_0.displayDrops[arg_19_1].id))
		end

		return
	end)

	local var_17_1 = arg_17_0.ulist

	var_2.align(var_17_1, #arg_17_0.displayDrops)
	...
	local var_17_2 = var_2.New
	local var_17_3 = {}

	DROP_TYPE_ITEM = var_4
	var_17_3.type = var_4
	var_17_3.id = arg_17_1.id
	var_17_3.count = arg_17_1.count

	local var_17_4 = var_17_2(var_17_3)

	updateDrop = var_17_3

	local var_17_5 = arg_17_0.itemTF
	local var_17_6 = var_4.Find(var_17_5, "left/IconTpl")

	setmetatable = var_17_5

	var_17_3(var_17_6, var_17_5({
		count = 0
	}, {
		__index = var_17_4
	}))

	UpdateOwnDisplay = var_17_3

	local var_17_7 = arg_17_0.itemTF

	var_17_3(var_4.Find(var_17_7, "left/own"), var_17_4)

	setText = var_17_3

	var_17_3(arg_17_0.nameTF, arg_17_1:getConfig("name"))

	setText = var_17_3

	var_17_3(arg_17_0.descTF, arg_17_1:getConfig("display"))
