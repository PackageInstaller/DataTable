...
function var_0_1.InitUI(arg_3_0)
	...
	local var_3_19 = var_2.Find(var_3_18, "ExpFull")

	i18n = var_3_18

	var_1(var_3_19, var_3_18("spweapon_ui_levelmax"))
	...
	local var_3_25 = var_2.Find(var_3_24, "Materials/Title")

	i18n = var_3_24

	var_1(var_3_25, var_3_24("spweapon_ui_need_resource"))

	setText = var_1

	local var_3_26 = arg_3_0.materialPanel
	local var_3_27 = var_2.Find(var_3_26, "Materials/Limit/text")

	i18n = var_3_26

	var_1(var_3_27, var_3_26("spweapon_ui_levelmax2"))
	...
	var_1(var_3_33, var_3("msgbox_text_breakthrough"))
	...
	var_1(var_3_34, var_3("msgbox_text_noPos_intensify"))
	...
	var_1(var_3_35, var_3("spweapon_ui_create_button"))
	...
	UIItemList = var_3_41
	arg_3_0.leftPanelItemRect = var_3_41.New(var_3_40, var_3_42)
	setText = var_3

	local var_3_43 = arg_3_0.leftPanel
	local var_3_44 = var_4.Find(var_3_43, "Items/Top/TextName")

	i18n = var_3_43

	var_3(var_3_44, var_3_43("spweapon_ui_ptitem"))

	setText = var_3

	local var_3_45 = arg_3_0.leftPanelAutoSelectButton
	local var_3_46 = var_4.Find(var_3_45, "On/Text")

	i18n = var_3_45

	var_3(var_3_46, var_3_45("spweapon_ui_autoselect"))

	setText = var_3

	local var_3_47 = arg_3_0.leftPanelAutoSelectButton
	local var_3_48 = var_4.Find(var_3_47, "Off/Text")

	i18n = var_3_47

	var_3(var_3_48, var_3_47("spweapon_ui_autoselect"))

	setText = var_3

	local var_3_49 = arg_3_0.leftPanelClearSelectButton
	local var_3_50 = var_4.Find(var_3_49, "On/Text")

	i18n = var_3_49

	var_3(var_3_50, var_3_49("spweapon_ui_cancelselect"))

	setText = var_3

	local var_3_51 = arg_3_0.leftPanelClearSelectButton
	local var_3_52 = var_4.Find(var_3_51, "Off/Text")

	i18n = var_3_51

	var_3(var_3_52, var_3_51("spweapon_ui_cancelselect"))
	...
	arg_3_0.leftPanelEquipScrollComp = var_3(var_4.Find(var_3_54, "Equips/Scroll View"), "LScrollRect")
	setText = var_3

	local var_3_55 = arg_3_0.leftPanel
	local var_3_56 = var_4.Find(var_3_55, "Equips/Top/TextName")

	i18n = var_3_55

	var_3(var_3_56, var_3_55("spweapon_ui_spweapon"))
	...
	local var_3_59 = var_4.Find(var_3_58, "TipText")

	i18n = var_3_58

	var_3(var_3_59, var_3_58("spweapon_ui_helptext"))

	setText = var_3

	local var_3_60 = arg_3_0.equipmentPanel
	local var_3_61 = var_4.Find(var_3_60, "Ship/Detail")

	i18n = var_3_60

	var_3(var_3_61, var_3_60("spweapon_tip_view"))

	setText = var_3

	local var_3_62 = arg_3_0.equipmentPanel
	local var_3_63 = var_4.Find(var_3_62, "Ship/Title")

	i18n = var_3_62

	var_3(var_3_63, var_3_62("spweapon_tip_ship"))

	setText = var_3

	local var_3_64 = arg_3_0.equipmentPanel
	local var_3_65 = var_4.Find(var_3_64, "ShipType/Title")

	i18n = var_3_64

	var_3(var_3_65, var_3_64("spweapon_tip_type"))

	setText = var_3

	local var_3_66 = arg_3_0.craftTargetCount
	local var_3_67 = var_4.Find(var_3_66, "Tip")

	i18n = var_3_66

	var_3(var_3_67, var_3_66("spweapon_tip_owned", ""))
...
function var_0_1.didEnter(arg_8_0)
	...
	local var_8_2 = var_3.Find(var_8_1, "BG")
	...
	local function var_8_6()
		...
		var_10_2.mode = var_2_10003.Mode.OR
		IndexConst = var_3
		...
		SpWeaponUpgradeMediator = var_3

		var_10_5(var_10_4, var_3.OPEN_EQUIPMENT_INDEX, var_10_0)
	...
	function arg_8_0.leftPanelEquipScrollComp.onReturnItem(arg_16_0, arg_16_1)
		...
		var_2_10002(var_2_10003(arg_16_1))
	...
	var_1.make(var_8_10, function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_0 == var_2_10003.EventInit then
			...
			var_2_10004 = arg_17_2:Find("IconTpl")
			...
			local function var_17_1(arg_18_0)
				...
				if arg_8_0.ptMax then
					...
					var_18_5(var_18_4, var_3_10007("spweapon_tip_upgrade"))
					arg_18_0()
			...
			var_3(var_2_10004, var_17_0, var_17_1, var_17_2, var_2_10008, var_17_3, var_17_4, var_2_10011)

			pressPersistTrigger = var_3
			var_2_10004 = arg_17_2:Find("IconTpl/Reduce")

			local var_17_5 = 0.5

			local function var_17_6(arg_19_0)
			...
			var_3(var_2_10004, var_17_5, var_17_6, var_17_7, var_2_10008, var_17_8, var_17_9, var_2_10011)
		else
			UIItemList = var_3

			if arg_17_0 == var_3.EventUpdate then
				local var_17_10 = arg_8_0.candicateMaterials[arg_17_1]

				updateDrop = var_2_10004

				local var_17_11 = arg_17_2
				local var_17_12 = arg_17_2.Find(var_17_11, "IconTpl")

				Drop = var_17_11

				local var_17_13 = var_17_11.New
				local var_17_14 = {}

				DROP_TYPE_ITEM = var_2_10008
				var_17_14.type = var_2_10008
				var_17_14.id = var_17_10.id
				var_17_14.count = var_17_10.count

				var_2_10004(var_17_12, var_17_13(var_17_14))

				setScrollText = var_2_10004

				var_2_10004(arg_17_2:Find("Mask/NameText"), var_17_10:getConfig("name"))

				local var_17_15 = arg_17_2
				local var_17_16 = arg_17_2.Find(var_17_15, "IconTpl/icon_bg/count")

				setText = var_17_15

				var_17_15(var_17_16, var_17_10.count)

				setActive = var_17_15

				var_17_15(arg_17_2:Find("IconTpl/mask"), var_17_10.count == 0)

				local var_17_17 = arg_8_0
				local var_17_18 = var_5.GetSelectMaterial(var_17_17, var_17_10.id)

				setActive = var_17_17

				var_17_17(arg_17_2:Find("IconTpl/Reduce"), var_17_18 and var_17_18.count > 0)

				if var_17_18 then
					setText = var_17_17

					var_17_17(arg_17_2:Find("IconTpl/Reduce/Text"), var_17_18.count)
				end
			end
		end
...
function var_0_1.UpdateEquipItem(arg_21_0, arg_21_1, arg_21_2)
	...
	var_4(arg_21_0, var_21_0, function()
		...
		if arg_21_0.ptMax then
			...
			var_22_2(var_22_1, var_2_10003("spweapon_tip_upgrade"))
		...
		var_22_2({
			function(arg_23_0)
				...
				MSGBOX_TYPE_CONFIRM_DELETE = var_3_10004
				var_23_3.type = var_3_10004
				pg = var_3_10004
				var_23_3.title = var_3_10004.MsgboxMgr.TITLE_INFORMATION
				var_23_3.onYes = arg_23_0

				local var_23_4 = {}
				local var_23_5 = arg_21_1

				var_23_4.name = var_5.GetName(var_23_5)
	...
	var_4(arg_21_0, var_21_0:Find("IconTpl/Reduce"), function()
		...
		var_25_0.removebyvalue(arg_21_0.consumeSpweapons, var_0)
	...
	updateSpWeapon = var_4

	var_4(var_21_0:Find("IconTpl"), arg_21_1)

	setScrollText = var_4

	var_4(var_21_0:Find("Mask/NameText"), arg_21_1:GetName())
	...
	var_21_1(var_21_0:Find("EquipShip"), var_21_2)

	if var_21_2 and 0 < var_21_2 then
		getProxy = var_5
		BayProxy = var_6

		local var_21_3 = var_5(var_6)
		local var_21_4 = var_5.getShipById(var_21_3, var_21_2)

		setImageSprite = var_21_3

		local var_21_5 = var_21_0
		local var_21_6 = var_21_0.Find(var_21_5, "EquipShip/Image")

		LoadSprite = var_21_5

		var_21_3(var_21_6, var_21_5("qicon/" .. var_21_4:getPainting()))
	end

	local var_21_7 = arg_21_0
	local var_21_8 = arg_21_0.GetSelectSpWeapon(var_21_7, arg_21_1)

	setActive = var_21_7

	var_21_7(var_21_0:Find("IconTpl/Reduce"), var_21_8)

	if var_21_8 then
		setText = var_21_7

		var_21_7(var_21_0:Find("IconTpl/Reduce/Text"), 1)
	end
...
function var_0_1.UpdateSelectPt(arg_26_0)
	...
	local var_26_2 = var_26_1 + var_26_0.CalculateHistoryPt(arg_26_0.consumeItems, arg_26_0.consumeSpweapons)
	...
	local function var_26_10(arg_27_0)
		...
		for iter_27_0, iter_27_1 in var_2_10001(arg_27_0) do
			...
			if not var_2_10007.detect(var_26_9, function(arg_28_0)
				...
				Item = var_8
				var_2_10007 = var_8.New({
					id = var_27_0
				})
				var_2_10007.count = 0
				table = var_8

				var_8.insert(var_26_9, var_2_10007)
			end
...
function var_0_1.AutoSelectMaterials(arg_29_0)
	...
	local var_29_2 = var_29_1 + var_29_0.CalculateHistoryPt(arg_29_0.consumeItems, arg_29_0.consumeSpweapons)
	...
	local var_29_12 = var_29_11(var_5.map(arg_29_0.candicateMaterials, function(arg_30_0)
	...
	local var_29_16, var_29_17 = (function(arg_33_0, arg_33_1, arg_33_2)
		...
		local var_33_1 = var_5.min

		math = var_2_10006

		local var_33_2 = arg_33_1 - var_33_0 * var_33_1(var_2_10006.ceil(arg_33_1 / var_33_0), var_3.count)
		...
		elseif var_33_2 < 0 then
			...
			if var_33_6 then
				...
				math = var_12
				var_33_10.count = var_12.max(var_5 - 1, 0)
				...
				math = var_12
				var_33_13.count = var_12.max(var_5, 0)
...
function var_0_1.UpdateAll(arg_35_0, arg_35_1)
	...
	if arg_35_0.craftMode == var_0_3 then
		local var_35_2 = arg_35_0.nextSpWeaponVO
		local var_35_3 = var_2.GetConfigID(var_35_2)
		local var_35_4 = arg_35_0.spWeaponVO
		local var_35_5

		if var_35_3 == var_35_2.GetConfigID(var_35_4) then
			var_35_5 = false
		else
			var_35_5 = true
		end
		...
		var_35_2(arg_35_0.equipmentPanelIcon2, var_35_5)

		setActive = var_35_2

		var_35_2(arg_35_0.equipmentPanelArrow, var_35_5)

		if var_35_5 then
			updateSpWeapon = var_35_2

			var_35_2(arg_35_0.equipmentPanelIcon1, arg_35_0.spWeaponVO)

			updateSpWeapon = var_35_2

			var_35_2(arg_35_0.equipmentPanelIcon2, arg_35_0.nextSpWeaponVO)
			arg_35_0:UpdateAttrs(arg_35_0.materialPanelAttrList, arg_35_0.spWeaponVO, arg_35_0.nextSpWeaponVO)
		else
			updateSpWeapon = var_35_2

			var_35_2(arg_35_0.equipmentPanelIcon1, arg_35_0.nextSpWeaponVO)
		...
		local var_35_7 = var_4.Find(var_35_6, "Name")
		local var_35_8 = arg_35_0.nextSpWeaponVO

		var_35_2(var_35_7, var_5.GetName(var_35_8))
		...
		var_35_9(var_5.Find(var_35_11, "ShipType"), not var_35_10)

		setActive = var_35_9

		local var_35_12 = arg_35_0.equipmentPanel

		var_35_9(var_5.Find(var_35_12, "Ship"), var_35_10)

		if var_35_10 then
			ShipGroup = var_35_9

			local var_35_13 = var_35_9.getDefaultShipConfig
			local var_35_14 = arg_35_0.nextSpWeaponVO
			local var_35_15

			if not var_35_13(var_5.GetUniqueGroup(var_35_14)) or not var_4.id then
				var_35_15 = nil
			end

			assert = var_35_14

			var_35_14(var_35_15 and var_35_15 > 0)

			if var_35_15 and 0 < var_35_15 then
				Ship = var_6

				local var_35_16 = var_6.New({
					configId = var_35_15
				})
				local var_35_17 = arg_35_0.loader
				local var_35_18 = var_7.GetSprite
				local var_35_19 = "qicon/" .. var_35_16:getPainting()
				local var_35_20
				local var_35_21 = arg_35_0.equipmentPanel

				var_35_18(var_35_17, var_35_19, var_35_20, var_11.Find(var_35_21, "Ship/Icon/Image"))

				local function var_35_22()
					local var_36_0 = arg_35_0
					local var_36_1 = var_0.emit

					BaseUI = var_2_10002

					local var_36_2 = var_2_10002.ON_DROP
					local var_36_3 = {}

					DROP_TYPE_SHIP = var_2_10004
					var_36_3.type = var_2_10004
					var_36_3.id = var_35_15
				...
				local var_35_23 = arg_35_0.equipmentPanel
				local var_35_24 = var_8.Find(var_35_23, "Ship/Detail")
				local var_35_25 = var_8.GetComponent(var_35_24, "RichText")

				var_8.AddListener(var_35_25, var_35_22)

				onButton = var_8

				local var_35_26 = arg_35_0
				local var_35_27 = arg_35_0.equipmentPanel

				var_8(var_35_26, var_10.Find(var_35_27, "Ship/Icon"), var_35_22)
			end
		else
			local var_35_28 = arg_35_0.nextSpWeaponVO
			local var_35_29 = var_4.GetWearableShipTypes(var_35_28)

			_ = var_35_28

			local var_35_30 = var_35_28.filter(var_35_29, function(arg_37_0)
				table = var_2_10001

				local var_37_0 = var_2_10001.contains

				ShipType = var_2_10002

				return var_37_0(var_2_10002.AllShipType, arg_37_0)
			end)

			ShipType = var_5

			local var_35_31 = var_5.FilterOverQuZhuType(var_35_30)

			CustomIndexLayer = var_5

			local var_35_32 = var_5.Clone2Full
			local var_35_33 = arg_35_0.equipmentPanel

			var_35_32(var_6.Find(var_35_33, "ShipType/List"), #var_35_31)

			ipairs = var_35_32

			for iter_35_0, iter_35_1 in var_35_32(var_35_31) do
				local var_35_34 = arg_35_0.equipmentPanel
				local var_35_35 = var_10.Find(var_35_34, "ShipType/List")
				local var_35_36 = var_10.GetChild(var_35_35, iter_35_0 - 1)
				local var_35_37 = arg_35_0.loader
				local var_35_38 = var_11.GetSprite
				local var_35_39 = "shiptype"

				ShipType = var_1_10014

				var_35_38(var_35_37, var_35_39, var_1_10014.Type2CNLabel(iter_35_1), var_35_36)
			end
		end
...
function var_0_1.UpdateCraftTargetCount(arg_38_0)
	...
	var_2(var_3.Find(var_38_1, "Text"), var_38_0)
...
function var_0_1.UpdateSpWeaponUpgradeInfo(arg_41_0, arg_41_1, arg_41_2, arg_41_3, arg_41_4)
	...
	local var_41_1 = arg_41_1.Find(var_41_0, "attr_tpl")

	removeAllChildren = var_41_0

	var_41_0(arg_41_1:Find("attrs"))
	...
	local function var_41_2(arg_42_0, arg_42_1)
		...
		var_2_10005(var_42_0:Find("name"), var_42_1)

		setActive = var_2_10005

		var_2_10005(var_42_0:Find("value"), true)

		setText = var_2_10005

		var_2_10005(var_42_0:Find("value"), var_42_2)

		setActive = var_2_10005

		var_2_10005(var_42_0:Find("effect"), false)
		...
		var_2_10005(var_42_5, var_42_6)

		triggerToggle = var_2_10005

		var_2_10005(var_42_0, arg_42_1.lock_open)
		...
		if not arg_42_1.lock_open and arg_42_1.sub and #arg_42_1.sub > 0 then
			...
			typeof = var_7
			Toggle = var_8
			var_42_8 = var_42_8(var_42_7, var_7(var_8))
			...
			typeof = var_7
			Toggle = var_8
			var_42_8(var_42_9, var_7(var_8)).enabled = false
		end
	...
	;(function(arg_43_0, arg_43_1, arg_43_2)
		...
		for iter_43_0, iter_43_1 in var_2_10003(arg_43_2) do
			...
			var_41_2(var_2_10008, iter_43_1)
		end

		return
	end)(arg_41_1:Find("attrs"), var_41_1, arg_41_2)
	...
	if arg_41_3[1].skillId > 0 then
		table = var_41_4
		var_41_4 = var_41_4.insert

		local var_41_5 = var_41_3
		local var_41_6 = {}

		i18n = var_1_10012
		var_41_6.name = var_1_10012("spweapon_attr_effect")
		var_41_6.effect = arg_41_3[1]

		var_41_4(var_41_5, var_41_6)
	end

	ipairs = var_41_4

	for iter_41_0, iter_41_1 in var_41_4(arg_41_3[2]) do
		table = var_1_10014
		...
		i18n = var_1_10017
		var_41_8.name = var_1_10017("spweapon_attr_skillupgrade")
		var_41_8.effect = iter_41_1

		var_1_10014(var_41_7, var_41_8)
	end

	local function var_41_9(arg_44_0, arg_44_1)
		...
		var_2_10005(var_44_0:Find("name"), var_44_1)

		setActive = var_2_10005

		var_2_10005(var_44_0:Find("value"), false)

		setActive = var_2_10005

		var_2_10005(var_44_0:Find("effect"), true)

		getSkillName = var_2_10005

		local var_44_3 = var_2_10005(var_44_2.skillId)

		if not var_44_2.unlock then
			setColorStr = var_6
			var_44_3 = var_6(var_44_3, "#a2a2a2")
			setTextColor = var_6

			local var_44_4 = var_44_0
			local var_44_5 = var_44_0.Find(var_44_4, "effect")

			SummerFeastScene = var_44_4

			var_6(var_44_5, var_44_4.TransformColor("a2a2a2"))
		else
			setTextColor = var_6

			local var_44_6 = var_44_0
			local var_44_7 = var_44_0.Find(var_44_6, "effect")

			SummerFeastScene = var_44_6

			var_6(var_44_7, var_44_6.TransformColor("FFDE00"))
		end

		local var_44_8 = "<material=underline event=displaySkill>" .. var_44_3 .. "</material>"
		local var_44_9 = var_44_0:Find("effect")
		local var_44_10 = var_7.GetComponent(var_44_9, "RichText")

		var_7.AddListener(var_44_10, function(arg_45_0, arg_45_1)
			if arg_45_0 == "displaySkill" then
				...
				if not var_44_2.unlock then
					setColorStr = var_3
					i18n = var_4
					var_45_0 = var_3(var_4("spweapon_tip_skill_locked") .. var_45_0, "#a2a2a2")
				end
				...
				if not arg_44_1.isSkill then
					...
					var_3_10005 = {}
					MSGBOX_TYPE_SINGLE_ITEM = var_3_10006
					var_3_10005.type = var_3_10006

					local var_45_3 = {}

					DROP_TYPE_SPWEAPON = var_3_10007
					var_45_3.type = var_3_10007

					local var_45_4 = arg_41_4

					var_45_3.id = var_7.GetConfigID(var_45_4)
					var_3_10005.drop = var_45_3
					var_3_10005.name = var_44_3
					var_3_10005.content = var_45_0

					var_45_2(var_45_1, var_3_10005)
				else
					local var_45_5 = arg_41_0
					local var_45_6 = var_3.emit

					SpWeaponUpgradeMediator = var_3_10005

					var_45_6(var_45_5, var_3_10005.ON_SKILLINFO, var_44_2.skillId, var_44_2.unlock, 10)
				end
			end
		...
		var_7(var_44_0:Find("effect"), var_44_8)
		...
		local var_44_11 = var_44_0

		typeof = var_9
		Toggle = var_10
		var_7(var_44_11, var_9(var_10)).enabled = false
	...
	;(function(arg_46_0, arg_46_1, arg_46_2)
		...
		for iter_46_0, iter_46_1 in var_2_10003(arg_46_2) do
			...
			var_41_9(var_2_10008, iter_46_1)
		end

		return
	end)(arg_41_1:Find("attrs"), var_41_1, var_41_3)
...
function var_0_1.UpdateExpBar(arg_47_0)
	...
	if not var_47_0 then
		...
		if arg_47_0.upgradeType == var_0_4 then
			...
			var_1_10002(var_47_1, var_4("spweapon_ui_create_exp"))
		elseif arg_47_0.upgradeType == var_0_5 then
			...
			var_1_10002(var_47_2, var_4("spweapon_ui_upgrade_exp"))
		elseif arg_47_0.upgradeType == var_0_6 then
			...
			var_1_10002(var_47_3, var_4("spweapon_ui_breakout_exp"))
		end
...
function var_0_1.UpdateMaterials(arg_48_0)
	...
	var_48_2(arg_48_0.materialPanelMaterialList, not var_48_3)

	setActive = var_48_2

	var_48_2(arg_48_0.materialPanelMaterialListLimit, var_48_3)

	local var_48_4
	local var_48_5 = true

	for iter_48_0 = 1, #arg_48_0.materialPanelMaterialItems do
		var_1_10010 = arg_48_0.materialPanelMaterialItems[iter_48_0]
		setActive = var_1_10011
		findTF = var_1_10012

		var_1_10011(var_1_10012(var_1_10010, "off"), not var_48_0[iter_48_0])

		setActive = var_1_10011
		findTF = var_1_10012

		var_1_10011(var_1_10012(var_1_10010, "Icon"), var_48_0[iter_48_0])

		if var_48_0[iter_48_0] then
			var_1_10012 = var_48_0[iter_48_0].id
			findTF = var_13

			local var_48_6 = var_13(var_1_10010, "Icon")
			local var_48_7 = {}

			DROP_TYPE_ITEM = var_15
			var_48_7.type = var_15
			var_48_7.id = var_1_10011.id
			var_48_7.count = var_1_10011.count
			updateDrop = var_15

			var_15(var_48_6, var_48_7)

			onButton = var_15

			var_15(arg_48_0, var_48_6, function()
				local var_49_0 = arg_48_0
				local var_49_1 = var_0.emit

				BaseUI = var_2_10002

				var_49_1(var_49_0, var_2_10002.ON_DROP, var_48_7)
			...
			local var_48_8 = var_15(arg_48_0.itemVOs[var_1_10012], {
				count = 0
			})
			local var_48_9 = var_1_10011.count .. "/" .. var_48_8.count

			if var_48_8.count < var_1_10011.count then
				setColorStr = var_17

				local var_48_10 = var_48_8.count

				COLOR_RED = var_1_10019
				var_48_9 = var_17(var_48_10, var_1_10019) .. "/" .. var_1_10011.count
				var_48_5 = false
			...
			local var_48_11 = var_17(var_48_6, "icon_bg/count")

			setActive = var_18

			var_18(var_48_11, true)

			setText = var_18

			var_18(var_48_11, var_48_9)

			var_1_10019 = var_48_6

			local var_48_12 = var_48_6.Find(var_1_10019, "Click")

			setActive = var_1_10019

			var_1_10019(var_48_12, not arg_48_0.confirmUpgrade and arg_48_0.upgradeType == var_0_6)

			onButton = var_1_10019

			var_1_10019(arg_48_0, var_48_12, function()
				local var_50_0 = arg_48_0

				var_50_0.confirmUpgrade = true
				setActive = var_50_0

				var_50_0(var_48_12, not arg_48_0.confirmUpgrade)
	...
	local var_48_13 = arg_48_0
	local var_48_14 = arg_48_0.materialPanelButton

	local function var_48_15()
		if not var_48_5 then
			...
			if not var_0.ShowItemTipbyID(var_48_4) then
				...
				local var_51_0 = var_0.TipsMgr.GetInstance()
				local var_51_1 = var_0.ShowTips

				i18n = var_2_10002

				var_51_1(var_51_0, var_2_10002("spweapon_tip_materal_no_enough"))
			end
		...
		if arg_48_0.playerVO.gold < var_48_1 then
			...
			local var_51_2 = var_1(var_2_10002, var_2_10003("word_gold"))

			ChargeScene = var_2_10002

			var_0(var_51_2, var_2_10002.TYPE_ITEM, {
				{
					59001,
		...
		if not arg_48_0.confirmUpgrade and arg_48_0.upgradeType == var_0_6 and #arg_48_0.upgradNeedMaterials > 0 then
			...
			var_51_4(var_51_3, var_2_10002("spweapon_tip_breakout_materal_check"))
		...
		if arg_48_0.craftMode == var_0_2 then
			...
			SpWeaponUpgradeMediator = var_2_10002
			var_2_10002 = var_2_10002.EQUIPMENT_COMPOSITE

			local var_51_7 = arg_48_0.spWeaponVO

			var_51_6(var_51_5, var_2_10002, var_3.GetConfigID(var_51_7), arg_48_0.consumeItems, arg_48_0.consumeSpweapons)
		elseif arg_48_0.craftMode == var_0_3 then
			...
			local var_51_10 = var_2_10002.EQUIPMENT_UPGRADE
			local var_51_11 = arg_48_0.spWeaponVO

			var_51_9(var_51_8, var_51_10, var_3.GetUID(var_51_11), arg_48_0.consumeItems, arg_48_0.consumeSpweapons)
		end

		return
	end

	SFX_UI_DOCKYARD_REINFORCE = var_1_10010

	var_6(var_48_13, var_48_14, var_48_15, var_1_10010)
...
function var_0_1.UpdatePtMaterials(arg_52_0, arg_52_1)
	...
	var_3(var_4.Find(var_52_1, "Off"), var_52_0)

	setActive = var_3

	local var_52_2 = arg_52_0.leftPanelFilterButton

	var_3(var_4.Find(var_52_2, "On"), not var_52_0)
	...
	for iter_52_0, iter_52_1 in var_3(arg_52_0.spWeaponList) do
		...
		if var_52_3 ~= var_9.GetUID(var_52_4) and not iter_52_1:IsUnCraftable() and not iter_52_1:GetShipId() then
			...
			if var_8.filterSpWeaponByType(iter_52_1, arg_52_0.contextData.indexDatas.typeIndex) then
				IndexConst = var_8

				if var_8.filterSpWeaponByRarity(iter_52_1, arg_52_0.contextData.indexDatas.rarityIndex) then
					table = var_8

					var_8.insert(arg_52_0.candicateSpweapons, iter_52_1)
				end
			end
		end
	end
	...
	CompareFuncs = iter_52_1

	var_52_6(var_52_7, iter_52_1(var_3.sortFunc(var_3.sort[1], var_52_5)))
	...
	var_5(var_6.Find(var_52_10, "On"), not arg_52_0.ptMax)

	setActive = var_5

	local var_52_11 = arg_52_0.leftPanelAutoSelectButton

	var_5(var_6.Find(var_52_11, "Off"), arg_52_0.ptMax)
	...
	var_6(var_7.Find(var_52_14, "On"), var_52_13)

	setActive = var_6

	local var_52_15 = arg_52_0.leftPanelClearSelectButton

	var_6(var_7.Find(var_52_15, "Off"), not var_52_13)
...
function var_0_1.UpdateSelectMaterial(arg_55_0, arg_55_1, arg_55_2)
	...
	if not arg_55_0:GetSelectMaterial(arg_55_1) or not var_55_4.count then
		var_55_0 = 0
	end
	...
	if arg_55_2 > 0 then
		...
		if arg_55_0.ptMax then
			pg = var_55_2
			var_1_10007 = var_55_2.TipsMgr.GetInstance()
			var_55_2 = var_55_2.ShowTips
			i18n = var_1_10008

			var_55_2(var_1_10007, var_1_10008("spweapon_tip_upgrade"))
		...
		local var_55_3 = var_55_2.max(var_55_1 - var_55_0, 0)

		math = var_1_10007
		arg_55_2 = var_1_10007.min(arg_55_2, var_55_3)

		if 0 < arg_55_2 then
			if not var_55_4 then
				Item = var_1_10007
				var_55_4 = var_1_10007.New({
					count = 0,
					id = arg_55_1
				})
				table = var_1_10007

				var_1_10007.insert(arg_55_0.consumeItems, var_55_4)
			end

			var_55_4.count = var_55_4.count + arg_55_2
		end
	...
	elseif arg_55_2 < 0 then
		...
		if var_1_10007.max(arg_55_2, var_55_5) < 0 and var_55_4 then
			var_55_4.count = var_55_4.count + arg_55_2

			if var_55_4.count <= 0 then
				table = var_7

				var_7.removebyvalue(arg_55_0.consumeItems, var_55_4)
			end
		end
