...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.ship.SkillInfoLayer"))
...
function var_0_1.didEnter(arg_2_0)
	...
	local var_2_8 = var_3.Find(var_2_7, "panel/buttonList/ok_button")
	...
	var_1_10001(var_2_6, var_2_8, var_2_9, var_5)
	...
	local function var_2_12()
		...
		var_6_1(var_6_0, var_2_10002.WARP_TO_TACTIC)
	...
	local function var_2_15()
		...
		if var_7_0 then
			...
			local var_7_3 = var_2_10003(var_2_10004)
		...
		if var_7_1 then
			...
			var_7_6(var_7_5, var_2_10005.WARP_TO_META_TACTICS, var_7_2.configId)
		end
	...
	local var_2_23 = var_2.Find(var_2_22, "panel/top/title_list/infomation/title")

	i18n = var_2_22

	var_1(var_2_23, var_2_22("words_information"))

	setText = var_1

	local var_2_24 = arg_2_0.buttonList
	local var_2_25 = var_2.Find(var_2_24, "ok_button/Image")

	i18n = var_2_24

	var_1(var_2_25, var_2_24("text_confirm"))

	setText = var_1

	local var_2_26 = arg_2_0.buttonList
	local var_2_27 = var_2.Find(var_2_26, "level_button/Image")

	i18n = var_2_26

	var_1(var_2_27, var_2_26("msgbox_text_upgrade"))
...
function var_0_1.showBase(arg_11_0)
	...
	if not var_11_1 then
		setColorStr = var_4
		var_11_2 = var_4(var_11_2, "#a2a2a2")
	end

	setText = var_4

	var_4(arg_11_0.skillInfoName, var_11_2)

	getSkillConfig = var_4

	local var_11_3 = var_4(var_11_0)
...
function var_0_1.showInfo(arg_12_0, arg_12_1)
	...
	if not var_12_2 then
		setColorStr = var_7
		i18n = var_8
		var_12_4 = var_7(var_8("spweapon_tip_skill_locked") .. var_12_4, "#a2a2a2")
	end

	setText = var_7

	var_7(arg_12_0.skillInfoIntro, var_12_4)
