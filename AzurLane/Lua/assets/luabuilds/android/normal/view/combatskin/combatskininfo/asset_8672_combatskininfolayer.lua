...
function var_0_1.init(arg_2_0)
	...
	local var_2_6 = var_2.Find(var_2_5, "display/info/display_panel/combat_skin/elementList")
	local var_2_7 = arg_2_0._tf

	arg_2_0.toggleList = var_2_4(var_2_6, var_3.Find(var_2_7, "display/info/display_panel/combat_skin/elementList/main"))
	setText = var_1

	local var_2_8 = arg_2_0.confirm
	local var_2_9 = var_2.Find(var_2_8, "upgrade")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("text_consume"))
...
function var_0_1.InitPanel(arg_7_0)
	...
	var_7_4(var_7_3, var_7_1.name)

	setText = var_7_4

	var_7_4(var_7_5, var_7_1.desc)
	...
	var_6.make(var_7_7, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			var_4(var_8_1, var_2_10006.TYPE_ICON_NAME[var_8_0], arg_8_2:Find("icon"), true)

			setScrollText = var_4

			local var_8_2 = arg_8_2
			local var_8_3 = arg_8_2.Find(var_8_2, "TextMask/Text")

			i18n = var_8_2

			var_4(var_8_3, var_8_2("battleui_display" .. var_8_0))
		end
	...
	local function var_7_13()
		...
		pg = var_2_10002
		var_9_0.combatPreview = var_9_1(var_2_10002.UIMgr.GetInstance().OverlayMain)
	...
	SPX_PANEL = var_1_10011

	var_7_9(var_7_11, var_7_12, var_7_13, var_1_10011)

	updateDrop = var_7_9

	local var_7_14 = arg_7_0.skinViewTF
	local var_7_15 = var_8.Find(var_7_14, "info/equip")

	Drop = var_7_14

	local var_7_16 = var_7_14.New
	local var_7_17 = {
		count = 1
	}

	DROP_TYPE_COMBAT_UI_STYLE = var_1_10011
	var_7_17.type = var_1_10011
	var_7_17.id = var_7_0

	var_7_9(var_7_15, var_7_16(var_7_17))
