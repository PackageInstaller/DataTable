...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_5
	arg_1_0.labelHeart = var_1_7(var_1_6, var_4(var_5))
	findTF = var_2
	...
	typeof = var_4
	Image = var_5
	arg_1_0.labelHeartIcon = var_1_9(var_1_8, var_4(var_5))
	findTF = var_2
	...
	typeof = var_4
	Text = var_5
	arg_1_0.labelHeartPlus = var_1_11(var_1_10, var_4(var_5))
	findTF = var_2
	...
	typeof = var_4
	Image = var_5
	arg_1_0.imageUnknown = var_1_13(var_1_12, var_4(var_5))
...
function var_0_0.flush(arg_3_0)
	if arg_3_0.shipGroup then
		...
		var_1_10004 = arg_3_0.labelHeart
		...
		if var_1.hearts > 999 then
			...
			tostring = var_3_3
			var_3_3 = var_3_3(var_1.hearts)
		end

		var_1_10004.text = var_3_3
		setActive = var_1_10004

		var_1_10004(arg_3_0.labelHeartPlus, var_1.hearts > 999)
		...
		if var_1.iheart then
			...
			if not var_3_4.New(1, 0.6, 0.6) then
				Color = var_3_4
				var_3_4 = var_3_4.New(1, 1, 1)
			end

			var_1_10004.color = var_3_4
			var_1_10004 = arg_3_0.labelHeartIcon
			...
			if var_1.iheart then
				...
				if not var_3_5.New(1, 0.6, 0.6) then
					Color = var_3_5
					var_3_5 = var_3_5.New(1, 1, 1)
				end

				var_1_10004.color = var_3_5
				var_1_10004 = arg_3_0.labelHeartPlus
				...
				if var_1.iheart then
					...
					if not var_3_6.New(1, 0.6, 0.6) then
						Color = var_3_6
						var_3_6 = var_3_6.New(1, 1, 1)
					end

					var_1_10004.color = var_3_6
					setShipCardFrame = var_1_10004

					var_1_10004(arg_3_0.shipFrameImg, var_3_0)

					local var_3_7 = arg_3_0.content
					local var_3_8 = var_2.SetActive

					tobool = var_1_10004

					var_3_8(var_3_7, var_1_10004(var_1))

					local var_3_9 = arg_3_0.imageUnknown.gameObject

					var_2.SetActive(var_3_9, not var_1)

					local var_3_10 = arg_3_0.btn
					local var_3_11

					if not var_1 or not arg_3_0.imageFrame then
						var_3_11 = arg_3_0.imageUnknown
					end

					var_3_10.targetGraphic = var_3_11
					setActive = var_3_10

					var_3_10(arg_3_0.ringTF, arg_3_0.propose)
