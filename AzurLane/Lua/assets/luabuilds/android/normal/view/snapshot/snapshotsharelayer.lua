...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_2()
		...
		if not var_2_10000.GetInt("snapshotAgress") or var_0 <= 0 then
			...
			var_1.showUserAgreement(var_4_0, function()
				...
				var_5_1(var_5_0, var_2.ShareMgr.TypePhoto)
			...
			local var_4_1 = var_1.ShareMgr.GetInstance()
			local var_4_2 = var_1.Share

			pg = var_2_10003

			var_4_2(var_4_1, var_2_10003.ShareMgr.TypePhoto)
		end
	...
	var_1_10001(arg_3_0, arg_3_0.confirmBtnTrans, function()
		...
		var_2_10000.MediaTool.SaveImageWithBytes(arg_3_0.bytes, function(arg_7_0, arg_7_1)
			if arg_7_0 then
				...
				var_7_1(var_7_0, var_3_10004("word_save_ok"))
			end
		...
		var_6_1(var_6_0, var_2("word_save_ok"))
...
function var_0_1.showUserAgreement(arg_10_0, arg_10_1)
	...
	i18n = var_10_2
	var_10_3.text = var_10_2("word_snapshot_share_title")
	setActive = var_10_3
	...
	local var_10_5 = var_4.Find(var_10_4, "window/container/scrollrect/content/Text")

	i18n = var_10_4

	var_10_3(var_10_5, var_10_4("word_snapshot_share_agreement"))
