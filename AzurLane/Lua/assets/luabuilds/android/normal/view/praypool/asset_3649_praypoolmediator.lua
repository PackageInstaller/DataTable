...
function var_0_1.register(arg_1_0)
	...
	PrayPoolConst = var_1_10003

	var_1_1(var_1_0, var_1_10003.CLICK_INDEX_BTN, function(arg_2_0, arg_2_1)
	...
	var_1_3(var_1_2, var_3.CLICK_BUILD_BTN, function(arg_3_0, arg_3_1)
		local var_3_0 = arg_1_0
		local var_3_1 = var_2.sendNotification

		PrayPoolConst = var_2_10004

		var_3_1(var_3_0, var_2_10004.BUILD_PRAY_POOL_CMD, arg_3_1)
	...
	var_1_5(var_1_4, var_3.START_BUILD_SHIP_EVENT, function(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
		local var_4_0 = arg_1_0
		local var_4_1 = var_4.sendNotification

		GAME = var_2_10006

		local var_4_2 = var_2_10006.ACTIVITY_OPERATION
		local var_4_3 = {
			cmd = 2,
			buildId = arg_4_1
		}
		...
		var_4_3.activity_id = var_2_10008.ACTIVITY_PRAY_POOL
	...
	local var_1_7 = var_1_4(var_3)
	local var_1_8 = var_2.getPageState(var_1_7)

	PrayProxy = var_1_7

	if var_1_8 ~= var_1_7.STAGE_BUILD_SUCCESS then
		local var_1_9 = var_1_6
		local var_1_10 = var_1_6.getActivityById

		ActivityConst = var_1_10005

		if var_1_10(var_1_9, var_1_10005.ACTIVITY_PRAY_POOL) then
			local var_1_11 = var_3:getData1()
			local var_1_12 = var_3
			local var_1_13 = var_3.getData1List(var_1_12)

			if var_1_11 then
				table = var_1_12

				local var_1_14 = var_1_12.indexof

				pg = var_1_10007

				if var_1_14(var_1_10007.activity_ship_create.all, var_1_11, 1) then
					var_2:setSelectedPoolNum(var_1_11)
					...
					var_1_16(var_1_15, var_8.STAGE_BUILD_SUCCESS)
				end
			end
		end
	end
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	PrayPoolConst = var_6_1

	if var_6_0 == var_6_1.BUILD_PRAY_POOL_SUCCESS then
