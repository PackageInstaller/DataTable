...
function var_0_1.findUI(arg_6_0)
	...
	var_1(arg_6_0, arg_6_0.helpBtn, function()
		...
		if var_2_10000.gametip.pray_build_help then
			...
			pg = var_2_10003
			var_7_2.helps = var_2_10003.gametip.pray_build_help.tip
...
function var_0_1.initData(arg_8_0)
	...
	arg_8_0.prayProxy = var_1_10001(var_1_10002)
	...
	PrayProxy = var_2
	var_8_0[var_2.STATE_HOME] = arg_8_0.prayPoolHomeView
	PrayProxy = var_2
...
function var_0_1.initEvents(arg_9_0)
	...
	var_9_1(var_9_0, var_1_10003.SWITCH_TO_SELECT_POOL_PAGE, function(arg_10_0, arg_10_1)
	...
	var_9_3(var_9_2, var_3.SWITCH_TO_SELECT_SHIP_PAGE, function(arg_11_0, arg_11_1)
	...
	var_9_5(var_9_4, var_3.SWITCH_TO_HOME_PAGE, function(arg_12_0, arg_12_1)
