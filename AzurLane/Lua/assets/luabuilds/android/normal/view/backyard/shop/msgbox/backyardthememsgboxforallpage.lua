...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BackYardThemeMsgBoxPage"))
...
function var_0_1.SetUp(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	i18n = var_5
	var_1_0.text = var_5("purchase_backyard_theme_desc_for_all")
	setActive = var_1_0
	...
	local var_1_2 = var_5.Find(var_1_1, "content/Text")

	i18n = var_1_1

	var_1_0(var_1_2, var_1_1("word_buy"))

	setText = var_1_0

	local var_1_3 = arg_1_0.goldPurchaseBtn
	local var_1_4 = var_5.Find(var_1_3, "content/Text")

	i18n = var_1_3

	var_1_0(var_1_4, var_1_3("word_buy"))
	...
	for iter_2_0, iter_2_1 in var_2_3(var_2_2) do
		...
		if var_1_10009.furniture_data_template[iter_2_1].count > 1 then
			...
			for iter_2_2 = 1, var_1_10009 - var_2_6 do
				...
				Furniture = var_1_10017

				var_1_10015(var_2_7, var_1_10017.New({
					id = iter_2_1
				}))
			end
		elseif not var_2_4[iter_2_1] then
			...
			var_2_8(var_2_9, var_1_10012.New({
				id = iter_2_1
			}))
		end
	end
