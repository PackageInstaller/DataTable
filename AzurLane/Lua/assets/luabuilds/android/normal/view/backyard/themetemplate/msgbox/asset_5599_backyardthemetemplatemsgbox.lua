...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.content = var_2_3(var_2_2, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.content1 = var_2_7(var_2_6, var_3(var_1_10004))
	...
	arg_2_0.icon = var_2_10(var_2_9, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.cancelBtnTxt = var_2_14(var_2_13, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.confirmBtnTxt = var_2_18(var_2_17, var_3(var_1_10004))
	arg_2_0._parentTF = arg_2_0._tf.parent
	setText = var_1

	local var_2_19 = arg_2_0._tf
	local var_2_20 = var_2.Find(var_2_19, "title")

	i18n = var_2_19

	var_1(var_2_20, var_2_19("words_information"))
...
function var_0_1.Show(arg_9_0)
	...
	var_1(var_9_0, var_1_10003.UIMgr.GetInstance().OverlayMain)
