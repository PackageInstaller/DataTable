...
function var_0_1.OnLoaded(arg_4_0)
	...
	local var_4_7 = var_2.Find(var_4_6, "bg/frame/title")

	i18n = var_4_6

	var_1(var_4_7, var_4_6("indexsort_sort"))

	setText = var_1

	local var_4_8 = arg_4_0._tf
	local var_4_9 = var_2.Find(var_4_8, "bg/frame/title_filter")

	i18n = var_4_8

	var_1(var_4_9, var_4_8("indexsort_index"))
	...
	var_1(var_4_11, var_4_10("index_all"))

	setText = var_1

	local var_4_12 = arg_4_0._tf
	local var_4_13 = var_2.Find(var_4_12, "bg/frame/confirm_btn/Text")

	i18n = var_4_12

	var_1(var_4_13, var_4_12("word_ok"))

	setText = var_1

	local var_4_14 = arg_4_0._tf
	local var_4_15 = var_2.Find(var_4_14, "bg/title")

	i18n = var_4_14

	var_1(var_4_15, var_4_14("courtyard_label_filter"))
...
function var_0_1.OnInit(arg_9_0)
	...
	local var_9_2 = var_3.Find(var_9_1, "bg/frame/confirm_btn")
	...
	var_1_10001(var_9_7, var_9_8, var_9_9, var_5)
...
function var_0_1.initSortPanel(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1(var_0_1.SORT_TAG) do
		...
		var_7(var_1_10006:Find("Text"), iter_13_1[2])

		arg_13_0.sortBtns[iter_13_0] = var_1_10006
...
function var_0_1.onSwitch(arg_15_0, arg_15_1, arg_15_2)
	...
	local function var_15_2(arg_16_0)
		...
		if arg_16_0 then
			...
			if not var_16_1.New(1, 1, 1, 1) then
				Color = var_16_1
				var_16_1 = var_16_1.New(0.2235294, 0.227451, 0.2352941, 1)
			end

			var_16_3.color = var_16_1
...
function var_0_1.initFilterPanel(arg_17_0)
	...
	var_2.sort(var_17_0, function(arg_18_0, arg_18_1)
	...
	for iter_17_0, iter_17_1 in var_3(var_17_0) do
		if arg_17_0.filterConfig[iter_17_1].is_view == 1 then
			...
			var_10(var_17_2:Find("Text"), var_8.name)
			...
			arg_17_0:onSwitch(var_17_2, function(arg_19_0)
				if arg_19_0 then
					...
					triggerToggle = var_1
					var_2_10002 = arg_17_0.selectedAllBtn

					local var_19_0 = arg_17_0

					var_1(var_2_10002, var_3.isSelectedAll(var_19_0))
				else
					...
					if var_1.isSelectedNone(var_19_2) then
						...
						local var_19_6 = var_19_5(var_19_4, var_3(var_4))

						Color = var_19_4
						var_19_6.color = var_19_4.New(1, 1, 1, 1)
					end
				end
			...
			var_10(var_17_2:Find("line"), var_17_1 % 4 ~= 0)
		end
	end
	...
	var_3(var_17_4, var_17_3("backyard_filter_tag_other"))
	...
	typeof = var_5
	Toggle = var_6
	arg_17_0.otherTFToggle = var_17_6(var_17_5, var_5(var_6))
	...
	arg_17_0:onSwitch(arg_17_0.otherTF, function(arg_21_0)
		...
		if arg_21_0 then
			...
			var_2_10004 = arg_17_0

			var_21_0(var_21_1, var_3.isSelectedAll(var_2_10004))
		else
			...
			if var_1.isSelectedNone(var_21_2) then
				...
				local var_21_6 = var_21_5(var_21_4, var_3(var_2_10004))

				Color = var_21_4
				var_21_6.color = var_21_4.New(0.2235294, 0.227451, 0.2352941, 1)
			end
		end
	...
	local function var_17_9(arg_22_0)
		...
		local var_22_5 = var_22_4(var_22_3, var_3(var_2_10004))

		if arg_22_0 then
			Color = var_22_3

			if not var_22_3.New(1, 1, 1, 1) then
				Color = var_22_3
				var_22_3 = var_22_3.New(0.2235294, 0.227451, 0.2352941, 1)
			end

			var_22_5.color = var_22_3
	...
	var_3(var_17_7, var_17_8, var_17_9, iter_17_1)
...
function var_0_1.isSelectedAll(arg_24_0)
	...
	return var_24_0(var_1_10002.select(arg_24_0.filterConfig.all, function(arg_25_0)
...
function var_0_1.filter(arg_28_0)
	...
	for iter_28_0, iter_28_1 in var_2(arg_28_0.filterData) do
		local var_28_1
...
function var_0_1.sort(arg_37_0, arg_37_1)
	...
	local var_37_1 = arg_37_0.GetConfigIdAndCntMapInAllFloor(var_37_0, arg_37_0.dorm)

	table = var_37_0

	var_37_0.sort(arg_37_1, function(arg_38_0, arg_38_1)
