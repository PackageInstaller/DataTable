...
function var_0_1.init(arg_6_0)
	...
	arg_6_0.mainCG = var_1(var_6_2, var_3(var_1_10004))
	...
	arg_6_0.animation = var_6_5(var_6_4, var_3(var_1_10004))
...
function var_0_1.OnCourtYardLoaded(arg_8_0)
	...
	arg_8_0.AddVisitorShip(var_8_1)

	local var_8_2 = arg_8_0.contextData.mode

	CourtYardConst = var_8_1

	if var_8_2 ~= var_8_1.SYSTEM_VISIT then
		BackYardThemeTempalteUtil = var_8_2

		var_8_2.CheckSaveDirectory()

		pg = var_1

		local var_8_3 = var_1.m02
		local var_8_4 = var_1.sendNotification

		GAME = var_1_10003

		var_8_4(var_8_3, var_1_10003.OPEN_ADD_EXP, 1)
	end
	...
	if arg_8_0.contextData.OpenShop then
		...
		local var_8_6 = arg_8_0.GetPanel

		CourtYardBottomPanel = var_1_10003

		local var_8_7 = var_8_6(var_8_5, var_1_10003)

		triggerButton = var_8_5

		var_8_5(var_8_7.shopBtn)
	end
...
function var_0_1.SetUpCourtYard(arg_10_0)
	...
	var_1_10001({
		function(arg_11_0)
			...
			var_11_2(var_11_1, var_2_10004.ON_ADD_VISITOR_SHIP, arg_11_0)
		...
		var_12_2(var_12_1, var_2_10003.SET_UP, var_12_0)
...
function var_0_1.ShowAddFoodTip(arg_16_0)
	...
	if var_16_0 ~= var_1_10002.SYSTEM_VISIT and arg_16_0.dorm.food == 0 and not arg_16_0.contextData.OpenShop then
		...
		if not var_1.IsBusy(var_16_1) then
			...
			if var_16_3(var_16_2, var_1_10003.FLOOR_1) > 0 and (not arg_16_0.contextData.fromMediatorName or arg_16_0.contextData.fromMediatorName ~= "DockyardMediator" and arg_16_0.contextData.fromMediatorName ~= "ShipMainMediator") and not arg_16_0.contextData.skipToCharge then
...
function var_0_1.AddVisitorShip(arg_17_0)
	...
	local var_17_1 = var_1(var_2)
	local var_17_2 = var_1.getRawData(var_17_1)
	local var_17_3 = var_1.GetCommonFlag

	SHOW_FIREND_BACKYARD_SHIP_FLAG = var_1_10004

	if not var_17_3(var_17_2, var_1_10004) then
		return
	end
	...
	local var_17_4 = var_17_2(var_1_10004)

	if var_3.GetVisitorShip(var_17_4) then
		_courtyard = var_17_4

		local var_17_5 = var_17_4:GetController()
...
function var_0_1.OnReconnection(arg_23_0)
	...
	var_23_1(var_23_0, var_1_10003.OPEN_ADD_EXP, 1)
...
function var_0_1.OnAddFurniture(arg_24_0)
	...
	var_24_3(var_24_2, var_1_10003.DORM_UPDATE_TYPE_LEVEL)
...
function var_0_1.willExit(arg_27_0)
	...
	CourtYardConst = var_27_1

	local var_27_3

	if var_27_2 ~= var_27_1.SYSTEM_VISIT then
		pg = var_27_2
		var_27_3 = var_27_2.m02
		var_27_2 = var_27_2.sendNotification
		GAME = var_3

		var_27_2(var_27_3, var_3.OPEN_ADD_EXP, 0)
	end
	...
	local var_27_5 = var_1.getRawData(var_27_4)

	var_1.ClearNewFlag(var_27_5)
