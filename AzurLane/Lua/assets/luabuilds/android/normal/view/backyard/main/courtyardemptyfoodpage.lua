...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1(var_2_2, var_3("text_nofood_yes"))
	...
	var_1(var_2_3, var_3("text_nofood_no"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_1(var_4_0, var_2_10002.GO_GRANARY)
...
function var_0_1.Show(arg_8_0)
	...
	Vector3 = var_2
	var_8_2.localScale = var_2(0, 0, 0)
	LeanTween = var_8_2
	...
	local var_8_5 = var_8_3(var_8_4, var_3(1, 1, 1), 0.3)
	local var_8_6 = var_1.setEase

	LeanTweenType = var_3

	var_8_6(var_8_5, var_3.easeOutBack)
...
function var_0_1.Hide(arg_9_0)
	...
	var_9_0(var_1_10002(arg_9_0.frame))
