...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("...Shop.pages.BackYardThemePage"))
...
function var_0_1.LoadDetail(arg_2_0)
	...
	var_1_10001(var_2.Find(var_2_0, "adpter/descript"), false)
...
function var_0_1.OnInit(arg_3_0)
	...
	typeof = var_3
	RawImage = var_4
	arg_3_0.rawImage = var_3_9(var_3_8, var_3(var_4))
	...
	local var_3_17 = var_2.Find(var_3_16, "random/Text")

	i18n = var_3_16

	var_3_12(var_3_17, var_3_16("word_random"))

	setText = var_3_12

	local var_3_18 = arg_3_0.refreshBtns
	local var_3_19 = var_2.Find(var_3_18, "random/sel/Text")

	i18n = var_3_18

	var_3_12(var_3_19, var_3_18("word_random"))

	setText = var_3_12

	local var_3_20 = arg_3_0.refreshBtns
	local var_3_21 = var_2.Find(var_3_20, "hot/Text")

	i18n = var_3_20

	var_3_12(var_3_21, var_3_20("word_hot"))

	setText = var_3_12

	local var_3_22 = arg_3_0.refreshBtns
	local var_3_23 = var_2.Find(var_3_22, "hot/sel/Text")

	i18n = var_3_22

	var_3_12(var_3_23, var_3_22("word_hot"))

	setText = var_3_12

	local var_3_24 = arg_3_0.refreshBtns
	local var_3_25 = var_2.Find(var_3_24, "new/Text")

	i18n = var_3_24

	var_3_12(var_3_25, var_3_24("word_new"))

	setText = var_3_12

	local var_3_26 = arg_3_0.refreshBtns
	local var_3_27 = var_2.Find(var_3_26, "new/sel/Text")

	i18n = var_3_26

	var_3_12(var_3_27, var_3_26("word_new"))
	...
	for iter_3_0, iter_3_1 in var_3_12(arg_3_0.btns) do
		...
		local function var_3_30()
			...
			if var_0.CanClickRefBtn(var_4_0, iter_3_0) then
				if arg_3_0.selectedRefBtn then
					...
					var_0(var_1.Find(var_4_1, "sel"), false)

					setActive = var_0

					local var_4_2 = arg_3_0.selectedRefBtn

					var_0(var_1.Find(var_4_2, "Text"), true)
				end
				...
				var_0(var_1.Find(var_4_3, "sel"), true)

				setActive = var_0

				local var_4_4 = iter_3_1

				var_0(var_1.Find(var_4_4, "Text"), false)
		...
		var_1_10006(var_3_28, var_3_29, var_3_30, var_1_10010)
	end
	...
	local function var_3_33()
		...
		pg = var_2_10003
		var_5_2.helps = var_2_10003.gametip.backyard_theme_template_shop_tip.tip
	...
	var_1(var_3_31, var_3_32, var_3_33, iter_3_1)
	...
	local function var_3_36()
		...
		var_6_1(var_6_0, var_2_10002.GO_DECORATION)
	...
	var_1(var_3_34, var_3_35, var_3_36, iter_3_1)
	...
	local function var_3_42()
		...
		if var_7_0 == var_2_10001.THEME_TEMPLATE_TYPE_SHOP then
			...
			local var_7_1 = var_7_0(var_1).PAGE

			getProxy = var_1
			DormProxy = var_2_10002

			local var_7_2 = var_1(var_2_10002).TYPE
	...
	var_1(var_3_40, var_3_41, var_3_42, iter_3_1)
	...
	local function var_3_45()
		...
		if var_8_0 == var_2_10001.THEME_TEMPLATE_TYPE_SHOP then
			...
			local var_8_2 = var_8_1(var_1).PAGE

			getProxy = var_1
			DormProxy = var_2_10002

			local var_8_3 = var_1(var_2_10002).TYPE
	...
	var_1(var_3_43, var_3_44, var_3_45, iter_3_1)
	...
	local function var_3_46()
		...
		if var_9_0 == var_2_10001.THEME_TEMPLATE_TYPE_SHOP then
			...
			var_9_3(var_9_2, var_2_10003.ON_GET_SPCAIL_TYPE_TEMPLATE, var_9_1)
		else
	...
	BackYardThemeTemplateDescPage = var_3_43
	arg_3_0.descPages = var_3_43.New(arg_3_0._tf, arg_3_0.event, arg_3_0.contextData)
	...
	local var_3_51 = var_3.Find(var_3_50, "Text")

	i18n = var_3_50

	var_3_49(var_3_51, var_3_50("courtyard_label_go"))

	setText = var_3_49

	local var_3_52 = arg_3_0._tf
	local var_3_53 = var_3.Find(var_3_52, "tip1")

	i18n = var_3_52

	var_3_49(var_3_53, var_3_52("courtyard_label_empty_template_list"))

	setText = var_3_49

	local var_3_54 = arg_3_0._tf
	local var_3_55 = var_3.Find(var_3_54, "tip2")

	i18n = var_3_54

	var_3_49(var_3_55, var_3_54("courtyard_label_empty_custom_template_list"))

	setText = var_3_49

	local var_3_56 = arg_3_0._tf
	local var_3_57 = var_3.Find(var_3_56, "tip3")

	i18n = var_3_56

	var_3_49(var_3_57, var_3_56("courtyard_label_empty_collection_list"))
...
function var_0_1.InitInput(arg_11_0)
	...
	var_1_10001(arg_11_0, arg_11_0.searchInput, function()
		...
		var_1(arg_11_0.searchClear, var_12_0 ~= "")
...
function var_0_1.UpdateArr(arg_14_0)
	...
	if var_14_0 == var_1_10002.THEME_TEMPLATE_TYPE_SHOP then
		...
		local var_14_1 = var_14_0(var_14_2).PAGE

		getProxy = var_14_2
		DormProxy = var_1_10003
		var_14_2 = var_14_2(var_1_10003).TYPE
		getProxy = var_1_10003
		DormProxy = var_1_10004

		local var_14_3 = var_1_10003(var_1_10004).lastPages[var_14_2]

		getProxy = var_1_10004
		DormProxy = var_1_10005

		local var_14_4 = var_1_10004(var_1_10005).ClickPage
...
function var_0_1.CanClickRefBtn(arg_15_0, arg_15_1)
	...
	local var_15_0 = var_1_10002(var_1_10003).TYPE
	...
	if var_3.GetServerTime(var_15_1) < var_0_1.nextClickRefreshTime then
		...
		local var_15_3 = var_5.TipsMgr.GetInstance()
		local var_15_4 = var_5.ShowTips

		i18n = var_1_10007

		var_15_4(var_15_3, var_1_10007("backyard_shop_refresh_frequently", var_15_2))
...
function var_0_1.SwitchPage(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	local var_16_0 = var_1_10004(var_1_10005).TYPE
	...
	if var_16_0 ~= arg_16_1 or arg_16_3 then
		...
		NewBackYardThemeTemplateMediator = var_1_10008

		var_16_3(var_16_2, var_1_10008.ON_REFRESH, arg_16_1, arg_16_2, var_16_1, arg_16_3)
		...
		if not arg_16_3 then
			...
			BackYardConst = var_8
			var_16_6.nextClickRefreshTime = var_8.MANUAL_REFRESH_THEME_TEMPLATE_TIME + var_16_5
		end
	end
...
function var_0_1.OnSearchKeyChange(arg_22_0)
	...
	NewBackYardThemeTemplateMediator = var_1_10004

	var_22_2(var_22_1, var_1_10004.ON_SEARCH, arg_22_0.pageType, var_22_0)
...
function var_0_1.OnSearchKeyEditEnd(arg_24_0)
	...
	if not var_1_10001(arg_24_0.searchInput) or var_1 == "" then
		...
		var_24_1(var_24_0, var_1_10004.ON_SEARCH, arg_24_0.pageType, var_1)
	end
...
function var_0_1.GetData(arg_31_0)
	...
	if var_31_0 == var_1_10002.THEME_TEMPLATE_TYPE_SHOP then
		...
		if var_31_3 == var_1_10004.THEME_TEMPLATE_TYPE_CUSTOM then
			...
			var_31_3, var_31_4 = var_31_3(var_4(var_1_10005).TYPE)
...
function var_0_1.SetUp(arg_37_0, arg_37_1, arg_37_2, arg_37_3, arg_37_4)
	...
	if var_37_1 == var_37_0.THEME_TEMPLATE_TYPE_SHOP then
		getProxy = var_37_1
		DormProxy = var_6
		var_37_1 = var_37_1(var_6).TYPE
		getProxy = var_6
		DormProxy = var_7

		local var_37_2 = var_6(var_7).PAGE

		setActive = var_7

		local var_37_3 = arg_37_0.btns[var_37_1]

		var_7(var_1_10008.Find(var_37_3, "sel"), true)
		...
		if var_7.NeedRefreshThemeTemplateShop(var_1_10008) then
			var_1_10008 = arg_37_0

			arg_37_0.SwitchPage(var_1_10008, var_37_1, var_37_2, true)
		end
	end
	...
	var_37_1(var_37_4, var_37_5 == var_1_10008.THEME_TEMPLATE_TYPE_SHOP)
	...
	var_37_1(var_37_6, var_37_7 == var_8.THEME_TEMPLATE_TYPE_SHOP)

	local var_37_8 = arg_37_0.pageType

	BackYardConst = var_37_6

	local var_37_9

	if var_37_8 == var_37_6.THEME_TEMPLATE_TYPE_COLLECTION then
		getProxy = var_37_8
		DormProxy = var_37_9
		var_37_9 = var_37_8(var_37_9)

		if var_37_8.NeedCollectionTip(var_37_9) then
			pg = var_37_8
			var_37_9 = var_37_8.TipsMgr.GetInstance()
			var_37_8 = var_37_8.ShowTips
			i18n = var_7

			var_37_8(var_37_9, var_7("BackYard_collection_be_delete_tip"))
		end
	end
	...
	local var_37_10 = var_37_8(var_37_9)

	if var_5.NeedShopShowHelp(var_37_10) then
		-- block empty
	end

	local var_37_11 = arg_37_0.pageType

	BackYardConst = var_37_10

	if var_37_11 ~= var_37_10.THEME_TEMPLATE_TYPE_SHOP then
		pairs = var_37_11

		for iter_37_0, iter_37_1 in var_37_11(arg_37_0.btns) do
...
function var_0_1.ForceActiveFirstCard(arg_42_0)
	...
	local var_42_2 = var_1_10002(var_42_1, var_4(var_1_10005))
	...
	var_3.each(arg_42_0.tips, function(arg_43_0)
		...
		var_2_10001(var_43_0, var_43_1 == var_43_2 .. var_2_10005(arg_42_0.pageType) and #arg_42_0.disPlays == 0)
	...
	var_3(var_42_3, var_42_4 == var_1_10006.THEME_TEMPLATE_TYPE_CUSTOM and #arg_42_0.disPlays == 0)

	if #arg_42_0.disPlays == 0 then
		var_42_3 = arg_42_0.descPages

		var_3.ExecuteAction(var_42_3, "Hide")

		return
	end

	local var_42_5 = arg_42_0.disPlays[1]

	pairs = var_42_3

	for iter_42_0, iter_42_1 in var_42_3(arg_42_0.cards) do
		if var_42_5.id == iter_42_1.template.id then
			triggerButton = var_9
...
function var_0_1.OnUpdateCard(arg_46_0, arg_46_1, arg_46_2)
	...
	if var_4.ShouldFetch(var_46_0) then
		...
		NewBackYardThemeTemplateMediator = var_6

		var_46_2(var_46_1, var_6.ON_GET_THEMPLATE_DATA, var_3.template.id, function(arg_47_0)
...
function var_0_1.OnCardClick(arg_48_0, arg_48_1)
	...
	local function var_48_2(arg_49_0)
		...
		local var_49_1 = arg_49_0.GetImageMd5(var_49_0)

		BackYardThemeTempalteUtil = var_49_0

		var_49_0.GetTexture(arg_49_0:GetTextureName(), var_49_1, function(arg_50_0)
			IsNil = var_3_10001
		...
		local var_49_2 = arg_48_0.descPages

		var_2.ExecuteAction(var_49_2, "SetUp", arg_48_0.pageType, arg_48_1.template, arg_48_0.dorm, arg_48_0.player)
	...
	if var_3.ShouldFetch(var_48_3) then
		...
		var_48_5(var_48_4, var_1_10005.ON_GET_THEMPLATE_DATA, arg_48_1.template.id, function(arg_51_0)
