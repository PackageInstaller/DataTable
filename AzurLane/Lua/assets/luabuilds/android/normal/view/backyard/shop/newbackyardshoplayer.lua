...
local function var_0_11(arg_2_0, arg_2_1, arg_2_2)
	...
	var_1_10004(var_2_1, var_2_2, var_2_3, var_1_10008)
...
function var_0_1.init(arg_12_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_12_0.goldTxt = var_12_7(var_12_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_12_0.gemTxt = var_12_10(var_12_9, var_3(var_1_10004))
	...
	BackYardShopFilterPanel = var_2
	var_12_14.filterPanel = var_2.New(arg_12_0._tf, arg_12_0.event, arg_12_0.contextData)
	arg_12_0.pages = {
...
function var_0_1.didEnter(arg_13_0)
	...
	local function var_13_8()
		...
		NewBackYardShopMediator = var_2_10002

		local var_16_2 = var_2_10002.ON_CHARGE

		PlayerConst = var_2_10003

		var_16_1(var_16_0, var_16_2, var_2_10003.ResDormMoney)
	...
	local function var_13_11()
		...
		local var_17_2 = var_2_10002.ON_CHARGE

		PlayerConst = var_2_10003

		var_17_1(var_17_0, var_17_2, var_2_10003.ResDiamond)
	...
	var_1_10001(var_13_9, var_13_10, var_13_11, var_1_10005)
	arg_13_0:InitPageFooter()

	local var_13_12 = arg_13_0

	arg_13_0.UpdateRes(var_13_12)
	...
	triggerButton = var_13_12

	var_13_12(arg_13_0.btns[var_13_13])

	local var_13_14, var_13_15

	if arg_13_0.contextData.topLayer then
		GetOrAddComponent = var_13_15
		var_13_14 = arg_13_0._tf
		typeof = var_13_11
		Canvas = var_1_10005
		var_13_15 = var_13_15(var_13_14, var_13_11(var_1_10005))
		var_13_15.overrideSorting = true
		var_13_15.sortingOrder = 900
		GetOrAddComponent = var_13_14

		local var_13_16 = arg_13_0._tf

		typeof = var_1_10005
		GraphicRaycaster = var_1_10006

		var_13_14(var_13_16, var_1_10005(var_1_10006))
	end

	getProxy = var_13_15
	SettingsProxy = var_13_14

	local var_13_17 = var_13_15(var_13_14)

	var_2.UpdateNewThemeValue(var_13_17)
...
function var_0_1.UpdateRes(arg_18_0)
	...
	var_18_0.text = var_18_2(var_18_1, var_1_10004.ResDormMoney)
...
function var_0_1.InitPageFooter(arg_19_0)
	...
	for iter_19_0, iter_19_1 in var_1(arg_19_0.pages) do
		...
		local var_19_3 = var_19_2(var_19_1, var_9(var_1_10010))

		GetSpriteFromAtlas = var_19_1
		var_19_3.sprite = var_19_1("ui/NewBackYardShopUI_atlas", "text_tag" .. iter_19_0 - 1)
		...
		local var_19_6 = var_19_5(var_19_4, var_1_10010(var_11))

		GetSpriteFromAtlas = var_19_4
		var_19_6.sprite = var_19_4("ui/NewBackYardShopUI_atlas", "text_tag" .. iter_19_0 - 1)
		var_1_10010 = var_19_6

		var_19_6.SetNativeSize(var_1_10010)

		local var_19_7 = var_0_12[iter_19_0]
		local var_19_8 = var_1_10006:Find("sel/icon")

		var_1_10010 = var_1_10010.GetComponent
		typeof = var_12
		Image = var_1_10013
		var_1_10010 = var_1_10010(var_19_8, var_12(var_1_10013))
		LoadSpriteAtlasAsync = var_19_8

		var_19_8("ui/CourtyardUI_atlas", "icon_" .. var_19_7, function(arg_20_0)
			if arg_19_0.exited then
				return
			end

			var_1_10010.sprite = arg_20_0
...
function var_0_1.UpdateSpecialPageFooter(arg_23_0)
	...
	local var_23_2 = var_23_0.Find(var_23_1, "new")

	getProxy = var_23_1
	SettingsProxy = var_5

	local var_23_3 = var_23_1(var_5)

	var_1_10002(var_23_2, var_4.IsTipNewGemFurniture(var_23_3))
