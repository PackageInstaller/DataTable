...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ONE_KEY, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_10003.BACKYARD_ONE_KEY)
	...
	arg_1_0:bind(var_0_1.ON_ADD_VISITOR_SHIP, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.BACKYARD_GET_VISITOR_SHIP, {
			callback = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.GO_THEME_TEMPLATE, function(arg_4_0)
		...
		var_4_1(var_4_0, var_4_2, var_2_10004.BACKYARD_THEME_TEMPLATE)
	...
	arg_1_0:bind(var_0_1.GO_GRANARY, function()
		...
		local var_6_2 = var_2_10002.New
		local var_6_3 = {}

		BackyardFeedMediator = var_2_10004
		var_6_3.mediator = var_2_10004
		BackyardFeedLayer = var_2_10004
		var_6_3.viewComponent = var_2_10004
	...
	arg_1_0:bind(var_0_1.SEL_TRAIN_SHIP, function(arg_7_0)
		...
		NewBackYardShipInfoMediator = var_2_10006
		var_7_5.mediator = var_2_10006
		NewBackYardShipInfoLayer = var_2_10006
		var_7_5.viewComponent = var_2_10006

		local var_7_6 = {}

		DormShip = var_2_10007
		var_7_6.type = var_2_10007.FLOOR_1
	...
	arg_1_0:bind(var_0_1.SEL_REST_SHIP, function(arg_8_0)
		...
		local var_8_4 = var_2_10004.New
		local var_8_5 = {}

		NewBackYardShipInfoMediator = var_2_10006
		var_8_5.mediator = var_2_10006
		NewBackYardShipInfoLayer = var_2_10006
		var_8_5.viewComponent = var_2_10006

		local var_8_6 = {}

		DormShip = var_2_10007
		var_8_6.type = var_2_10007.FLOOR_2
	...
	arg_1_0:bind(var_0_1.SWITCH, function(arg_12_0, arg_12_1)
		...
		if var_2_10002(var_2_10003).floor == arg_12_1 then
			return
		end
	...
	arg_1_0:bind(var_0_1.RENAME, function(arg_14_0, arg_14_1)
		...
		var_14_1(var_14_0, var_2_10004.BACKYARD_RENAME, arg_14_1)
	...
	arg_1_0.bind(var_1_0, var_0_1.SET_UP, function(arg_15_0, arg_15_1)
		getProxy = var_2_10002
		DormProxy = var_2_10003
		var_2_10002(var_2_10003).floor = arg_15_1
		...
		local var_15_3 = var_15_1(var_3.GenCourtYardData(var_15_2, arg_15_1))
...
function var_0_1.handleNotification(arg_17_0, arg_17_1)
	...
	local var_17_3 = arg_17_1.getType(var_17_2)

	DormProxy = var_17_2

	if var_17_0 == var_17_2.SHIPS_EXP_ADDED then
		...
		if var_17_1.isTipSettle then
			pg = var_5
			var_1_10006 = var_5.NewGuideMgr.GetInstance()

			if not var_5.IsBusy(var_1_10006) then
				var_1_10006 = arg_17_0

				arg_17_0.SettleExp(var_1_10006, var_17_1)
		...
		if not arg_17_0.isTipFood then
			...
			var_5.ShowAddFoodTip(var_1_10006)
		end
		...
		if var_17_0 == var_5.LOAD_LAYERS then
			...
			if var_17_0 == var_5.REMOVE_LAYERS then
				...
				var_5.OnRemoveLayer(var_1_10006, var_17_1)
			else
				...
				if var_17_0 == var_5._NO_POS_TO_ADD_SHIP then
					...
					var_17_4(var_1_10006, var_1_10007.EXIT_SHIP, {
						shipId = var_17_1
					})

					pg = var_17_4
					var_1_10006 = var_17_4.TipsMgr.GetInstance()
					var_17_4 = var_17_4.ShowTips
					i18n = var_7

					var_17_4(var_1_10006, var_7("backyard_notPosition_shipExit"))
					...
					local var_17_5 = var_7.getRawData(var_1_10008)

					BackYardConst = var_1_10008

					var_17_4(var_1_10006, var_17_5, var_1_10008.DORM_UPDATE_TYPE_SHIP)
				else
					...
					if var_17_0 == var_17_4._ADD_ITEM_FAILED then
						...
						local var_17_6 = var_5(var_1_10006)
						local var_17_7 = var_5.getRawData(var_17_6)
						local var_17_8 = var_5.GetTheme

						getProxy = var_1_10008
						DormProxy = var_1_10009

						local var_17_9 = var_17_8(var_17_7, var_1_10008(var_1_10009).floor)

						var_6.DeleteFurniture(var_17_9, var_17_1)
					end
				end
			end
		end
	...
	arg_17_0:handleCourtyardNotification(var_17_0, var_17_1, var_17_3)
...
function var_0_1.handleCourtyardNotification(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	if var_1_10004 then
		_courtyard = var_1_10004
		var_1_10005 = var_1_10004

		if not var_1_10004.IsLoaed(var_1_10005) then
			return
		end
		...
		if arg_18_1 == var_1_10004._QUIT then
			...
			var_18_0(var_1_10005, var_1_10006.ON_BACK)
		else
			...
			if arg_18_1 == var_18_0._INITED then
				...
				var_4.OnCourtYardLoaded(var_1_10005)
			else
				GAME = var_4
				...
				if arg_18_1 == var_4.LOAD_LAYERS then
					...
					var_1_10006 = var_1_10005.GetController(var_1_10006)

					var_1_10005.OnOpenLayerOrCloseLayer(var_1_10006, true, var_18_1)
				else
					GAME = var_18_1
					...
					if arg_18_1 == var_18_1.REMOVE_LAYERS then
						...
						var_1_10005.OnOpenLayerOrCloseLayer(var_1_10006, false, var_18_2)
					else
						GAME = var_18_2
						...
						if arg_18_1 == var_18_2.ON_APPLICATION_PAUSE and arg_18_2 then
							_courtyard = var_4
							var_1_10005 = var_4
							var_1_10005 = var_4.GetController(var_1_10005)

							var_4.OnApplicationPaused(var_1_10005)
						end
					end
				end
			end
		...
		if arg_18_1 == var_18_3.BACKYARD_ADD_MONEY_DONE then
			_courtyard = var_4
			var_18_4 = var_4
			var_18_4 = var_4.GetController(var_18_4)

			var_4.ClearShipCoin(var_18_4, arg_18_2.id)
		else
			GAME = var_4
			...
			if arg_18_1 == var_4.EXIT_SHIP_DONE then
				...
				var_4.ExitShip(var_18_4, arg_18_2.id)
			else
				GAME = var_4

				if arg_18_1 == var_4.BUY_FURNITURE_DONE then
					var_18_4 = arg_18_0.viewComponent

					var_4.OnAddFurniture(var_18_4)
				else
					GAME = var_4
					...
					if arg_18_1 == var_4.ON_RECONNECTION then
						...
						if arg_18_1 == var_4.ADD_SHIP_DONE then
							getProxy = var_18_5
							BayProxy = var_18_4
							var_18_4 = var_18_5(var_18_4)
							var_18_5 = var_18_5.getShipById(var_18_4, arg_18_2.id)
							getProxy = var_18_4
							DormProxy = var_1_10006

							if var_18_4(var_1_10006).floor == arg_18_2.type then
								_courtyard = var_18_4
								var_1_10006 = var_18_4
								var_1_10006 = var_18_4.GetController(var_1_10006)

								var_18_4.AddShip(var_1_10006, var_18_5, 0, 0)
							end
						else
							GAME = var_18_5

							if arg_18_1 == var_18_5.BACKYARD_ADD_INTIMACY_DONE then
								_courtyard = var_4
								var_18_4 = var_4
								var_18_4 = var_4.GetController(var_18_4)

								var_4.ClearShipIntimacy(var_18_4, arg_18_2.id)
							else
								GAME = var_4
								...
								if arg_18_1 == var_4.BACKYARD_ONE_KEY_DONE then
									...
									for iter_18_0, iter_18_1 in var_4(arg_18_2.shipIds) do
										...
										var_1_10010 = var_1_10009
										var_1_10010 = var_1_10009.GetController(var_1_10010)

										var_1_10009.ClearShipCoin(var_1_10010, iter_18_1.id)

										_courtyard = var_1_10009
										var_1_10010 = var_1_10009
										var_1_10010 = var_1_10009.GetController(var_1_10010)

										var_1_10009.ClearShipIntimacy(var_1_10010, iter_18_1.id)
									end
								else
									GAME = var_4
									...
									if arg_18_1 == var_4.EXTEND_BACKYARD_AREA_DONE then
										...
										if arg_18_1 == var_4.INIMACY_AND_MONEY_ADD then
											var_18_6 = arg_18_2.id
											var_18_4 = arg_18_2.money
											var_1_10006 = arg_18_2.intimacy
											_courtyard = iter_18_0
											iter_18_1 = iter_18_0
											iter_18_1 = iter_18_0.GetController(iter_18_1)

											iter_18_0.UpdateShipCoinAndIntimacy(iter_18_1, var_18_6, var_18_4, var_1_10006)
										else
											GAME = var_18_6

											if arg_18_1 == var_18_6.BACKYARD_SHIP_EXP_ADDED then
												_courtyard = var_4
												var_18_4 = var_4
												var_18_4 = var_4.GetController(var_18_4)

												var_4.AddShipExp(var_18_4, arg_18_2.id, arg_18_2.exp)
											else
												DormProxy = var_4
												...
												if arg_18_1 == var_4.DORM_UPDATEED then
													var_18_4 = arg_18_0.viewComponent
													var_18_7 = var_18_7.UpdateDorm
													getProxy = var_1_10006
													DormProxy = iter_18_0
													iter_18_0 = var_1_10006(iter_18_0)

													var_18_7(var_18_4, var_1_10006.getRawData(iter_18_0), arg_18_3)
												else
													CourtYardEvent = var_18_7

													local var_18_8

													if arg_18_1 == var_18_7._ENTER_MODE then
														var_18_4 = arg_18_0
														var_18_8 = arg_18_0.addSubLayers
														Context = var_1_10006
														var_1_10006 = var_1_10006.New
														iter_18_0 = {}
														BackYardDecorationMediator = iter_18_1
														iter_18_0.mediator = iter_18_1
														BackYardDecrationLayer = iter_18_1
														iter_18_0.viewComponent = iter_18_1

														var_18_8(var_18_4, var_1_10006(iter_18_0))

														var_18_4 = arg_18_0.viewComponent

														var_18_8.OnEnterOrExitEdit(var_18_4, true)
													else
														CourtYardEvent = var_18_8

														if arg_18_1 == var_18_8._EXIT_MODE then
															var_18_4 = arg_18_0.viewComponent

															var_4.OnEnterOrExitEdit(var_18_4, false)
														else
															GAME = var_4
															...
															if arg_18_1 == var_4.OPEN_BACKYARD_SHOP then
																...
																var_4.emit(var_18_4, var_0_1.GO_SHOP, true)
															else
																...
																if arg_18_1 == var_4._EXTEND then
																	...
																	if arg_18_1 == var_4.START_TAKE_THEME_PHOTO then
																		GetOrAddComponent = var_18_9
																		var_18_4 = arg_18_0.viewComponent.mainTF
																		typeof = var_1_10006
																		CanvasGroup = iter_18_0
																		var_18_9 = var_18_9(var_18_4, var_1_10006(iter_18_0))
																		var_18_9.alpha = 0
																		_courtyard = var_18_9
																		var_18_4 = var_18_9
																		var_18_4 = var_18_9.GetController(var_18_4)

																		var_18_9.OnTakeThemePhoto(var_18_4)
																	else
																		BackYardDecorationMediator = var_18_9

																		local var_18_10

																		if arg_18_1 == var_18_9.END_TAKE_THEME_PHOTO then
																			GetOrAddComponent = var_18_10
																			var_18_4 = arg_18_0.viewComponent.mainTF
																			typeof = var_1_10006
																			CanvasGroup = iter_18_0
																			var_18_10 = var_18_10(var_18_4, var_1_10006(iter_18_0))
																			var_18_10.alpha = 1
																			_courtyard = var_18_10
																			var_18_4 = var_18_10
																			var_18_4 = var_18_10.GetController(var_18_4)

																			var_18_10.OnEndTakeThemePhoto(var_18_4)
																		else
																			CourtYardEvent = var_18_10

																			if arg_18_1 == var_18_10._DRAG_ITEM then
																				var_18_4 = arg_18_0.viewComponent

																				var_4.BlockEvents(var_18_4)
																			else
																				CourtYardEvent = var_4
																				...
																				if arg_18_1 == var_4._DRAG_ITEM_END then
																					...
																					if arg_18_1 == var_4._TOUCH_SHIP then
																						...
																						local var_18_11 = var_4(var_18_4)

																						if var_4.GetBackYardInterActionTaskList(var_18_11) and #var_4 > 0 then
																							ipairs = var_5

																							for iter_18_2, iter_18_3 in var_5(var_4) do
																								pg = var_1_10010

																								local var_18_12 = var_1_10010.m02

																								var_1_10010 = var_1_10010.sendNotification
																								GAME = var_1_10012

																								var_1_10010(var_18_12, var_1_10012.UPDATE_TASK_PROGRESS, {
																									taskId = iter_18_3.id
																								})
																							end
																						end
...
function var_0_1.SettleExp(arg_19_0, arg_19_1)
	...
	if var_19_6 ~= 0 and (var_19_7 ~= 0 or var_19_2.food ~= 0) then
		...
		var_7(function()
			...
			local var_20_2 = var_2_10002.New
			local var_20_3 = {}

			BackYardSettlementMediator = var_2_10004
			var_20_3.mediator = var_2_10004
			BackYardSettlementLayer = var_2_10004
			var_20_3.viewComponent = var_2_10004
			var_20_3.data = {
...
function var_0_1.OnExtend(arg_21_0)
	...
	if var_21_1(var_21_0, var_1_10003) <= 0 then
		getProxy = var_2
		DormProxy = var_1_10003

		local var_21_2 = var_2(var_1_10003)
		local var_21_3 = var_2.getRawData(var_21_2)
		local var_21_4 = var_2.GetExpandId(var_21_3)

		pg = var_21_3

		local var_21_5 = var_21_3.shop_template[var_21_4]
		...
		var_21_6.type = var_1_10006
		var_21_6.id = var_21_5.resource_type

		local var_21_7 = var_1_10004(var_21_6)

		var_1_10004 = var_1_10004.getName(var_21_7)
		_BackyardMsgBoxMgr = var_21_7
		var_1_10006 = var_21_7

		local var_21_8 = var_21_7.Show
		local var_21_9 = {}

		i18n = var_1_10008
		var_21_9.content = var_1_10008("backyard_buyExtendItem_question", var_21_5.resource_num .. var_1_10004)

		function var_21_9.onYes()
			local var_22_0 = arg_21_0
			local var_22_1 = var_0.sendNotification

			GAME = var_2_10002

			var_22_1(var_22_0, var_2_10002.SHOPPING, {
				count = 1,
				id = var_21_4
			})
		...
		var_21_8(var_1_10006, var_21_9)
	else
		local var_21_10 = arg_21_0
		local var_21_11 = arg_21_0.sendNotification

		GAME = var_1_10004

		local var_21_12 = var_1_10004.USE_ITEM
		local var_21_13 = {
			count = 1
		}

		ITEM_BACKYARD_AREA_EXTEND = var_1_10006
		var_21_13.id = var_1_10006

		var_21_11(var_21_10, var_21_12, var_21_13)
	end
...
function var_0_1.GenCourtYardData(arg_24_0, arg_24_1)
	...
	if var_24_0 == var_1_10005.SYSTEM_VISIT then
		...
		if var_24_0 == var_5.SYSTEM_DEFAULT then
			...
			var_24_1 = var_5.getRawData(var_1_10006)
			CourtYardConst = var_5
			var_24_2 = var_5.STYLE_INNER
		else
			CourtYardConst = var_5
			...
			if var_24_0 == var_5.SYSTEM_FEAST then
				...
				if var_24_0 == var_5.SYSTEM_OUTSIDE then
					...
					if var_24_0 == var_5.SYSTEM_EDIT_FEAST then
						...
						local var_24_3 = var_5(var_1_10006)
	...
	local var_24_5 = var_24_1.GetMapSize(var_24_4)

	CourtYardConst = var_24_4

	if var_24_0 == var_24_4.SYSTEM_EDIT_FEAST then
		getProxy = var_6
		FeastProxy = var_1_10007

		local var_24_6 = var_6(var_1_10007)
		local var_24_7 = var_6.getRawData(var_24_6)

		var_24_5 = var_6.GetMapSize(var_24_7)
	end
	...
	local var_24_10 = arg_24_0.viewComponent

	var_24_9.name = var_8.getUIName(var_24_10)
	pg = var_8
	var_24_9.core = var_8.m02
