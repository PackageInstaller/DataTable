...
function var_0_1.OnLoaded(arg_2_0)
	...
	BackYardDecrationLayer = var_1_10003

	var_2_1(var_2_0, var_1_10003.INNER_SELECTED_FURNITRUE, function(arg_3_0, arg_3_1)
	...
	local var_2_9 = var_2.Find(var_2_8, "frame/title/Text")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("courtyard_label_putlist_title"))
...
function var_0_1.OnInit(arg_4_0)
	...
	local function var_4_8(arg_9_0)
		...
		local var_9_2 = var_9_0(var_2.Find(var_9_1, "content"), arg_9_0.position)
		local var_9_3
		...
		for iter_9_0, iter_9_1 in var_3(arg_4_0.cards) do
			...
			local var_9_6 = var_12(var_9_4 + var_8.rect.width / 2, var_9_5 - var_8.rect.height / 2)

			Vector2 = var_13

			local var_9_7 = var_13(var_9_4 - var_8.rect.width / 2, var_9_5 - var_8.rect.height / 2)

			if var_9_2.x > var_9_7.x and var_9_2.x < var_9_6.x and var_9_2.y > var_9_6.y and var_9_2.y < var_2_10011.y then
				var_9_3 = iter_9_1
	...
	local var_4_10 = var_4_5(var_4_9, var_1_10006(var_1_10007))
	...
	var_4:AddPointUpFunc(function(arg_12_0, arg_12_1)
		...
		if arg_4_0.lock then
			var_2_10003 = arg_4_0.contextData.furnitureDescMsgBox
			...
			if var_2_10003.Distance(var_12_0, arg_4_0.downPosition) > 1 then
				return
			end

			if var_4_8(arg_12_1) then
				local var_12_1 = arg_4_0
				local var_12_2 = var_4.emit

				BackYardDecorationMediator = var_2_10006

				var_12_2(var_12_1, var_2_10006.ON_SELECTED_FURNITRUE, var_3.furniture.id)
				...
				var_4.emit(var_12_3, var_0_1.SELECTED_FURNITRUE)
			end
		end
...
function var_0_1.change2ScrPos(arg_16_0, arg_16_1)
	...
	local var_16_3 = arg_16_0.GetComponent(var_16_2, "RectTransform")

	LuaHelper = var_16_2

	return (var_16_2.ScreenToLocal(var_16_3, arg_16_1, var_16_1))
end
...
function var_0_1.OnDisplayList(arg_19_0)
	...
	local var_19_0 = var_1(var_1_10002).floor
	...
	for iter_19_0, iter_19_1 in var_4(var_19_3) do
		table = var_1_10009
		...
		var_1_10009(var_19_4, var_1_10011.New({
			count = 1,
...
function var_0_1.Show(arg_21_0)
	...
	local var_21_1 = var_2.value(arg_21_0._bg.gameObject, var_21_0, 0, 0.4)
...
function var_0_1.Hide(arg_24_0)
	...
	local var_24_3 = var_24_2(var_24_1, var_4.Action_float(function(arg_25_0)
		setAnchoredPosition = var_2_10001
