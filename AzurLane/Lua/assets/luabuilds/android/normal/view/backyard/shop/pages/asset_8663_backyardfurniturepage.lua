...
local var_0_2 = var_0_0.INDEX_TO_SHOP_TYPE

table = var_2

var_2.insert(var_0_2, 1, {})
...
function var_0_1.OnLoaded(arg_3_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.filterBtnTxt = var_3_7(var_3_6, var_3(var_1_10004))

	local var_3_8 = arg_3_0.filterBtnTxt

	i18n = var_3_6
	var_3_8.text = var_3_6("word_default")
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.orderBtnTxt = var_3_13(var_3_12, var_3(var_1_10004))
	setText = var_1

	local var_3_14 = arg_3_0.searchInput
	local var_3_15 = var_2.Find(var_3_14, "Placeholder")

	i18n = var_3_14

	var_1(var_3_15, var_3_14("courtyard_label_search_holder"))
...
function var_0_1.OnInit(arg_4_0)
	...
	var_4_0(arg_4_0, arg_4_0.searchInput, function()
		...
		var_1(arg_4_0.searchClear, var_7_0 ~= "")
	...
	Vector3 = var_4_1
	var_4_4.localScale = var_4_1(1, -1, 1)
	...
	local function var_4_8(arg_10_0)
		...
		if arg_10_0 then
			...
			Vector3 = var_10_3
			var_10_4.localScale = var_10_3(1, arg_10_0 and 1 or -1, 1)
	...
	local function var_4_12()
		...
		var_12_1(var_12_0, var_2.GetData(var_12_2))
	...
	var_4_9(var_4_10, var_4_11, var_4_12, var_1_10006)
...
function var_0_1.GetData(arg_21_0)
	...
	if arg_21_0.pageType == 5 then
		...
		for iter_21_0, iter_21_1 in var_6(var_1_10007.furniture_data_template.get_id_list_by_tag[7]) do
			var_21_5(iter_21_1)
		end
	else
		...
		local var_21_7 = var_7.furniture_data_template.get_id_list_by_type

		ipairs = var_1_10008

		for iter_21_2, iter_21_3 in var_1_10008(var_21_6) do
			ipairs = var_1_10013
...
function var_0_1.OnInitItem(arg_25_0, arg_25_1)
	...
	var_3(var_25_1, var_25_2, var_25_3, var_1_10007)
