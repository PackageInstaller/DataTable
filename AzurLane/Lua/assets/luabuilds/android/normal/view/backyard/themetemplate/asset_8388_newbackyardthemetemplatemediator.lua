...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.GO_DECORATION, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_2, var_2_10004.COURTYARD, {
			openDecoration = true
		})
	...
	arg_1_0:bind(var_0_1.ON_GET_SPCAIL_TYPE_TEMPLATE, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.BACKYARD_GET_SPECIFIED_TYPE_TEMPLATE, {
			type = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.ON_GET_THEMPLATE_DATA, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10005.BACKYARD_GET_THEME_TEMPLATE_DATA, {
			templateId = arg_4_1,
			callback = arg_4_2
		})
	...
	arg_1_0:bind(var_0_1.ON_REFRESH, function(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
		...
		var_5_1(var_5_0, var_2_10007.BACKYARD_REFRESH_SHOP_TEMPLATE, {
			timeType = arg_5_3,
			type = arg_5_1,
			page = arg_5_2,
			force = arg_5_4
		...
		if arg_6_1 ~= var_2_10003.THEME_TEMPLATE_TYPE_CUSTOM then
			...
			if arg_6_1 == var_3.THEME_TEMPLATE_TYPE_COLLECTION then
				...
				if arg_6_1 == var_3.THEME_TEMPLATE_TYPE_SHOP then
					...
					var_6_2(var_6_1, var_2_10005.BACKYARD_SEARCH_THEME_TEMPLATE, {
						str = arg_6_2
					})
				end
			end
	...
	arg_1_0:bind(var_0_1.ON_SHOPPING, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_7_1(var_7_0, var_2_10005.BUY_FURNITURE, {
	...
	arg_1_0:bind(var_0_1.ON_DISPLAY_PLAYER_INFO, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
		...
		local var_8_2 = var_2_10006.FRIEND_SEARCH
		local var_8_3 = {}

		SearchFriendCommand = var_2_10008
		var_8_3.type = var_2_10008.SEARCH_TYPE_RESUME
	...
	arg_1_0:bind(var_0_1.GET_TEMPLATE_PLAYERINFO, function(arg_9_0, arg_9_1, arg_9_2)
		...
		var_9_1(var_9_0, var_2_10005.BACKYARD_GET_THEME_TEMPLATE_PLAYE_INFO, {
			type = arg_9_1,
	...
	arg_1_0:bind(var_0_1.ON_UPLOAD_TEMPLATE, function(arg_10_0, arg_10_1)
		...
		if not var_2.CanUploadBackYardThemeTemplate(var_10_1) then
			...
			var_2_10005 = arg_1_0.contextData.msgBox
			var_10_1 = var_10_1.ExecuteAction
			...
			i18n = var_2_10008
			var_2_10007.content = var_2_10008("backyard_theme_ban_upload_tip", var_10_2)

			var_10_1(var_2_10005, var_10_3, var_2_10007)
		...
		BackYardConst = var_10_4

		if var_10_5 >= var_10_4.MAX_UPLOAD_THEME_CNT then
			...
			i18n = var_2_10007
			var_10_8.content = var_2_10007("backyard_theme_upload_over_maxcnt")

			var_10_7(var_10_6, var_2_10005, var_10_8)
		...
		var_10_10(var_10_9, var_2_10005.BACKYARD_UPLOAD_THEME_TEMPLATE, {
	...
	arg_1_0:bind(var_0_1.ON_CANCEL_UPLOAD_TEMPLATE, function(arg_11_0, arg_11_1)
		...
		i18n = var_2_10006
		var_11_3.content = var_2_10006("backyard_theme_cancel_template_upload_tip")
		...
		function var_11_3.onYes()
			...
			var_12_1(var_12_0, var_3_10002.BACKYARD_UNLOAD_THEME_TEMPLATE, {
	...
	arg_1_0:bind(var_0_1.ON_DELETE_TEMPLATE, function(arg_13_0, arg_13_1)
		...
		i18n = var_2_10006
		var_13_3.content = var_2_10006("backyard_theme_delete_themplate_tip")
		...
		function var_13_3.onYes()
			...
			var_14_1(var_14_0, var_3_10002.BACKYARD_DELETE_THEME_TEMPLATE, {
	...
	arg_1_0:bind(var_0_1.ON_APPLY_TEMPLATE, function(arg_15_0, arg_15_1, arg_15_2)
		...
		local function var_15_1()
			...
			var_16_1(var_16_0, var_3_10002.BACKYARD_APPLY_THEME_TEMPLATE, {
				template = arg_15_1
			})
		...
		if not var_15_0 then
			...
			BackYardThemeTemplateMsgBox = var_2_10009
			var_15_5.type = var_2_10009.TYPE_IMAGE
			i18n = var_9
			var_15_5.content = var_9("backyard_theme_apply_tip1")
			var_15_5.srpiteName = arg_15_1:GetTextureIconName()
			var_15_5.md5 = arg_15_1:GetIconMd5()
			i18n = var_9
			var_15_5.confirmTxt = var_9("backyard_theme_word_buy")
			i18n = var_9
			var_15_5.cancelTxt = var_9("backyard_theme_word_apply")
	...
	arg_1_0:bind(var_0_1.ON_LIKE_THEME, function(arg_17_0, arg_17_1, arg_17_2)
		...
		var_17_1(var_17_0, var_2_10005.BACKYARD_LIKE_THEME_TEMPLATE, {
	...
	arg_1_0:bind(var_0_1.ON_COLECT_THEME, function(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
		...
		var_18_1(var_18_0, var_2_10006.BACKYARD_COLLECT_THEME_TEMPLATE, {
	...
	arg_1_0:bind(var_0_1.ON_CHARGE, function(arg_19_0, arg_19_1)
		...
		if arg_19_1 == var_2_10002.ResDiamond then
			...
			SCENE = var_2_10005
			var_2_10005 = var_2_10005.CHARGE

			local var_19_2 = {}

			ChargeScene = var_2_10007
			var_19_2.wrap = var_2_10007.TYPE_DIAMOND

			var_19_1(var_19_0, var_2_10004, var_2_10005, var_19_2)
		else
			...
			if arg_19_1 == var_19_1.ResDormMoney then
				...
				local var_19_5 = var_2_10004.GO_SCENE

				SCENE = var_2_10005

				var_19_4(var_19_3, var_19_5, var_2_10005.EVENT)
			end
		end
	...
	arg_1_0:bind(var_0_1.FETCH_ALL_THEME, function(arg_20_0, arg_20_1)
		...
		var_20_1(var_20_0, var_2_10004.GET_ALL_BACKYARD_THEME_TEMPLATE, {
...
function var_0_1.handleNotification(arg_23_0, arg_23_1)
	...
	local var_23_3 = arg_23_1.getType(var_23_2)

	PlayerProxy = var_23_2

	if var_23_0 == var_23_2.UPDATED then
		var_1_10006 = arg_23_0.viewComponent

		var_5.PlayerUpdated(var_1_10006, var_23_1)
	else
		DormProxy = var_5
		...
		if var_23_0 == var_5.THEME_TEMPLATE_UPDATED then
			...
			var_23_4 = var_23_4(var_1_10006)
			var_1_10006 = var_23_1.type
			var_1_10007 = var_23_1.template
			BackYardConst = var_1_10008

			if var_1_10006 == var_1_10008.THEME_TEMPLATE_TYPE_SHOP then
				var_1_10009 = arg_23_0.viewComponent

				var_1_10008.ShopThemeTemplateUpdate(var_1_10009, var_1_10007)
			else
				BackYardConst = var_1_10008

				if var_1_10006 == var_1_10008.THEME_TEMPLATE_TYPE_COLLECTION then
					var_1_10009 = arg_23_0.viewComponent

					var_1_10008.CollectionThemeTemplateUpdate(var_1_10009, var_1_10007)
				else
					BackYardConst = var_1_10008

					if var_1_10006 == var_1_10008.THEME_TEMPLATE_TYPE_CUSTOM then
						var_1_10009 = arg_23_0.viewComponent

						var_1_10008.CustomThemeTemplateUpdate(var_1_10009, var_1_10007)
					end
				end
			end
		else
			...
			if var_23_0 == var_23_4.FRIEND_SEARCH_DONE then
				if var_23_1.list[1] then
					...
					var_23_5 = arg_23_0.addSubLayers
					Context = var_1_10007
					var_1_10007 = var_1_10007.New
					var_1_10008 = {}
					FriendInfoLayer = var_1_10009
					var_1_10008.viewComponent = var_1_10009
					FriendInfoMediator = var_1_10009
					var_1_10008.mediator = var_1_10009
					...
					var_23_6.groupName = var_10.getGroupName(var_23_7)
					var_1_10008.data = var_23_6

					var_23_5(var_1_10006, var_1_10007(var_1_10008))

					var_23_5 = arg_23_0.contextData
					var_23_5.pos = nil
					var_23_5 = arg_23_0.contextData
					var_23_5.themeName = nil
				end
			else
				GAME = var_23_5

				if var_23_0 == var_23_5.BACKYARD_REFRESH_SHOP_TEMPLATE_DONE then
					...
					getProxy = var_5
					DormProxy = var_1_10006
					var_1_10007 = var_5(var_1_10006)
					var_1_10006 = var_5.GetShopThemeTemplates(var_1_10007)
					var_1_10008 = arg_23_0.viewComponent

					var_1_10007.OnShopTemplatesUpdated(var_1_10008, var_1_10006)
				else
					DormProxy = var_5
					...
					if var_23_0 == var_5.DORM_UPDATEED then
						getProxy = var_23_8
						DormProxy = var_1_10006
						var_23_8 = var_23_8(var_1_10006)
						var_1_10007 = arg_23_0.viewComponent

						var_6.UpdateDorm(var_1_10007, var_23_8:getData())
					else
						GAME = var_23_8

						if var_23_0 == var_23_8.BUY_FURNITURE_DONE then
							local var_23_9 = arg_23_0.viewComponent

							var_5.FurnituresUpdated(var_23_9, var_23_3)
						else
							GAME = var_5
							...
							if var_23_0 == var_5.BACKYARD_APPLY_THEME_TEMPLATE_DONE then
								...
								var_23_11 = arg_23_0.sendNotification
								GAME = var_1_10007
								var_1_10007 = var_1_10007.GO_SCENE
								SCENE = var_1_10008

								var_23_11(var_23_10, var_1_10007, var_1_10008.COURTYARD)

								pg = var_23_11

								local var_23_12 = var_23_11.TipsMgr.GetInstance()

								var_23_11 = var_23_11.ShowTips
								i18n = var_1_10007

								var_23_11(var_23_12, var_1_10007("backyard_theme_apply_success"))
							else
								GAME = var_23_11

								if var_23_0 == var_23_11.BACKYARD_SEARCH_THEME_TEMPLATE_DONE then
									local var_23_13 = arg_23_0.viewComponent

									var_5.ShopSearchKeyChange(var_23_13, var_23_1.template)
								else
									GAME = var_5

									if var_23_0 == var_5.BACKYARD_SEARCH_THEME_TEMPLATE_ERRO then
										local var_23_14 = arg_23_0.viewComponent

										var_5.ClearShopSearchKey(var_23_14)
									else
										GAME = var_5
										...
										if var_23_0 == var_5.BACKYARD_UNLOAD_THEME_TEMPLATE_DONE then
											...
											local var_23_15 = var_23_16.TipsMgr.GetInstance()

											var_23_16 = var_23_16.ShowTips
											i18n = var_1_10007

											var_23_16(var_23_15, var_1_10007("backyard_theme_unload_success"))
										else
											DormProxy = var_23_16

											if var_23_0 == var_23_16.THEME_TEMPLATE_DELTETED then
												local var_23_17 = arg_23_0.viewComponent

												var_5.DeleteCustomThemeTemplate(var_23_17, var_23_1.templateId)
											else
												GAME = var_5
												...
												if var_23_0 == var_5.BACKYARD_DELETE_THEME_TEMPLATE_DONE then
													...
													local var_23_18 = var_23_19.TipsMgr.GetInstance()

													var_23_19 = var_23_19.ShowTips
													i18n = var_1_10007

													var_23_19(var_23_18, var_1_10007("backyard_theme_delete_success"))
												else
													GAME = var_23_19

													local var_23_21

													if var_23_0 == var_23_19.BACKYARD_UPLOAD_THEME_TEMPLATE_DONE then
														pg = var_23_21

														local var_23_20 = var_23_21.TipsMgr.GetInstance()

														var_23_21 = var_23_21.ShowTips
														i18n = var_1_10007

														var_23_21(var_23_20, var_1_10007("backyard_theme_upload_success"))
													else
														DormProxy = var_23_21

														if var_23_0 == var_23_21.COLLECTION_THEME_TEMPLATE_ADDED then
															local var_23_22 = arg_23_0.viewComponent

															var_5.AddCollectionThemeTemplate(var_23_22, var_23_1.template)
														else
															DormProxy = var_5
															...
															if var_23_0 == var_5.COLLECTION_THEME_TEMPLATE_DELETED then
																...
																var_5.DeleteCollectionThemeTemplate(var_23_23, var_23_1.id)
															else
																DormProxy = var_5

																if var_23_0 == var_5.SHOP_THEME_TEMPLATE_DELETED then
																	local var_23_24 = arg_23_0.viewComponent

																	var_5.DeleteShopThemeTemplate(var_23_24, var_23_1.id)
																else
																	GAME = var_5

																	if var_23_0 == var_5.BACKYARD_REFRESH_SHOP_TEMPLATE_ERRO then
																		local var_23_25 = arg_23_0.viewComponent

																		var_5.OnShopTemplatesErro(var_23_25)
																	end
																end
															end
														end
