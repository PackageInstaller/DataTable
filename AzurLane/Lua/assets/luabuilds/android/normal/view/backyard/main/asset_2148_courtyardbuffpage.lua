...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_3 = var_2.Find(var_2_2, "frame/list/content")
	local var_2_4 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_1(var_2_3, var_3.Find(var_2_4, "frame/list/content/tpl"))
	...
	typeof = var_3
	Text = var_2_4
	arg_2_0.totalExp = var_2_7(var_2_6, var_3(var_2_4))
	setText = var_1
	...
	var_1(var_2_9, var_2_8("courtyard_label_exp_addition"))

	setText = var_1

	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_2.Find(var_2_10, "frame/subtitle")

	i18n = var_2_10

	var_1(var_2_11, var_2_10("courtyard_label_total_exp_addition"))
...
function var_0_1.Flush(arg_7_0, arg_7_1)
	...
	var_4.make(var_7_2, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			local var_8_3 = var_8_0:getConfig("benefit_effect")
			local var_8_4 = var_7_0

			tonumber = var_7
			var_7_0 = var_8_4 + var_7(var_8_3)
		end
	...
	var_3.New(function()
		...
		if 0 < var_10_1 then
			...
			if var_10_1 <= 600 then
				...
				COLOR_RED = var_2_10004

				local var_10_5

				if not var_10_5(var_10_4, var_2_10004) then
					setColorStr = var_10_5
