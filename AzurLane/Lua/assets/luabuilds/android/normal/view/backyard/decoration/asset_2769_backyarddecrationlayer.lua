...
function var_0_1.init(arg_2_0)
	...
	typeof = var_3
	Animation = var_1_10004
	arg_2_0.bAnimtion = var_2_8(var_2_7, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.orderBtnTxt = var_2_16(var_2_15, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.filterBtnTxt = var_2_21(var_2_20, var_3(var_1_10004))

	local var_2_22 = arg_2_0.filterBtnTxt

	GetSpriteFromAtlas = var_2_20
	var_2_22.sprite = var_2_20("ui/NewBackYardDecorateUI_atlas", "text_default")
	...
	local var_2_26 = var_2.Find(var_2_25, "holder")

	i18n = var_2_25

	var_1(var_2_26, var_2_25("courtyard_label_search_holder"))
	...
	var_1(var_2_35, var_2_34("courtyard_label_shop_1"))

	setText = var_1

	local var_2_36 = arg_2_0.showPutListBtn
	local var_2_37 = var_2.Find(var_2_36, "Text")

	i18n = var_2_36

	var_1(var_2_37, var_2_36("courtyard_label_placed_furniture"))

	setText = var_1

	local var_2_38 = arg_2_0.saveBtn
	local var_2_39 = var_2.Find(var_2_38, "Text")

	i18n = var_2_38

	var_1(var_2_39, var_2_38("courtyard_label_save"))
	...
	var_1(var_2_41, var_2_40("courtyard_label_clear"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_6()
		...
		var_8_1(var_8_0, var_2_10002.OPEN_SHOP)
	...
	var_2(var_5_7, var_5_8, var_5_9, var_1_10006)
	...
	local function var_5_12()
		...
		var_0.SetEndEvent(var_10_0, function()
			...
			var_11_2(var_11_1, var_2.SAVE_ALL)
	...
	var_2(var_5_10, var_5_11, var_5_12, var_1_10006)
	...
	local function var_5_15()
		...
		var_12_1(var_12_0, var_2_10002.ClEAR_ALL, true)
	...
	var_2(var_5_13, var_5_14, var_5_15, var_1_10006)
	...
	local function var_5_18()
		...
		var_0.ShowFilterPanel(var_13_0, function(arg_14_0)
			...
			var_14_1.sprite = var_3("ui/NewBackYardDecorateUI_atlas", var_14_0)
	...
	var_2(var_5_16, var_5_17, var_5_18, var_1_10006)
	...
	var_2(var_5_19, var_5_20, var_5_21, var_1_10006)
	...
	var_2(var_5_22, var_5_23, var_5_24, var_1_10006)
	...
	var_2(var_5_25, var_5_26, var_5_27, var_1_10006)
	...
	var_2(var_5_28, var_5_29, var_5_30, var_1_10006)
	...
	var_5_31(function()
		...
		var_20_1(var_20_0, var_2_10002.ON_SET_UP)
...
function var_0_1.UpdateTagTF(arg_30_0, arg_30_1, arg_30_2)
	...
	var_1_10003(var_30_0, var_30_1, var_30_2, var_1_10007)
