...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.EXTEND, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.SHOPPING, {
			count = 1,
			id = arg_2_1
		})
	...
	arg_1_0:bind(var_0_1.LOOG_PRESS_SHIP, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_2(var_3_1, var_3_3, var_2_10006.SHIPINFO, {
			shipId = arg_3_2.id
		})
...
function var_0_1.OnSelShips(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_9 = var_10.New
	local var_5_10 = {}

	DockyardScene = iter_5_3
	var_5_10.viewComponent = iter_5_3
	DockyardMediator = iter_5_3
	var_5_10.mediator = iter_5_3
...
function var_0_1.GetSelectedShips(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	for iter_10_0, iter_10_1 in var_1_10008(arg_10_1:GetShips()) do
		...
		var_1_10013 = var_1_10013.RawGetShipById(var_1_10014, iter_10_1.id)

		if iter_10_1:IsSameFloor(arg_10_2) then
			table = var_1_10014

			var_1_10014.insert(var_10_1, var_1_10013.id)

			if var_1_10013.id ~= var_10_0 then
				table = var_1_10014

				var_1_10014.insert(var_10_3, var_1_10013.id)
			end
		else
			table = var_1_10014

			var_1_10014.insert(var_10_2, var_1_10013.id)
		end
	end
...
function var_0_1.OnShip(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	if arg_11_0.contextData.MaxRsetPos < var_11_0 then
		...
		local var_11_1 = var_6("backyard_no_pos_for_ship")
	...
	if var_11_0.contains(arg_11_1, arg_11_2.id) then
		...
		local var_11_3 = var_6("backyard_backyardShipInfoMediator_shipState_rest")
...
function var_0_1.OnSelected(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4)
	...
	if arg_13_3 == nil or #arg_13_3 == 0 then
		...
		if arg_13_2 then
			var_13_3 = arg_13_0
			var_13_4 = arg_13_0.sendNotification
			GAME = var_1_10008

			var_13_4(var_13_3, var_1_10008.EXIT_SHIP, {
				shipId = arg_13_2.id,
				callback = arg_13_4
			})
		else
		...
		pg = var_13_4
		var_13_3 = var_13_4.UIMgr.GetInstance()

		var_6.LoadingOff(var_13_3)
	...
	for iter_13_0, iter_13_1 in var_13_3(var_13_2) do
		table = var_1_10012
		...
		if not var_1_10012.contains(arg_13_3, iter_13_0) then
			...
			var_1_10012.insert(var_13_5, function(arg_14_0)
				...
				var_14_1(var_14_0, var_2_10003.EXIT_SHIP, {
					shipId = iter_13_0,
					callback = arg_14_0
				})
	...
	local var_13_6 = arg_13_0.contextData

	var_13_6.shipIdToAdd = {}
	ipairs = var_13_6

	for iter_13_2, iter_13_3 in var_13_6(arg_13_3) do
	...
	if arg_13_0.contextData.shipIdToAdd and #arg_13_0.contextData.shipIdToAdd > 0 then
		...
		for iter_13_4, iter_13_5 in var_7(arg_13_0.contextData.shipIdToAdd) do
			...
			var_1_10012.insert(var_13_5, function(arg_15_0)
				local var_15_0 = arg_13_0
				local var_15_1 = var_1.sendNotification

				GAME = var_2_10003

				var_15_1(var_15_0, var_2_10003.ADD_SHIP, {
					id = iter_13_5[1],
					type = iter_13_5[2],
					callBack = arg_15_0
				})
	...
	if #var_13_5 > 0 then
		...
		local var_13_7 = var_7.UIMgr.GetInstance()

		var_7.LoadingOff(var_13_7)
		arg_13_4()
	end
...
function var_0_1.handleNotification(arg_18_0, arg_18_1)
	...
	if var_18_0 == var_18_1.EXTEND_BACKYARD_DONE then
		pg = var_4
		...
		var_18_4(var_18_3, var_1_10006("backyard_backyardShipInfoMediator_ok_unlock"))

		local var_18_5 = arg_18_0.viewComponent

		var_4.UpdateSlots(var_18_5)
	elseif var_18_0 == var_0_1.UPDATE_SHIPS then
