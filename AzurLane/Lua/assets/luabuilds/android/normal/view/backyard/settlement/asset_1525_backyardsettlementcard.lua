...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.levelText = var_1_1(var_1_0, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.additionText = var_1_3(var_1_2, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Image = var_1_10005
	arg_1_0.icon = var_1_7(var_1_6, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Slider = var_1_10005
	arg_1_0.slider = var_1_9(var_1_8, var_4(var_1_10005))
...
function var_0_0.DoAnimation(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	var_6(arg_5_0.additionTF, 0, arg_5_1, var_5_0 * (var_5_1 + 1), 0, function(arg_6_0)
	...
	local var_5_3 = var_7.max(arg_5_3:getLevelExpConfig().exp, 0.001)
	local var_5_4

	if var_5_2 then
		math = var_5_4
		var_5_4 = var_5_4.max(arg_5_2:getLevelExpConfig().exp, 0.001)

		arg_5_0:DoLevelUpAnimation(arg_5_2.exp, var_5_4, arg_5_3.exp, var_5_3, arg_5_3.level, var_5_1, var_5_0)
	else
		TweenValue = var_5_4

		var_5_4(arg_5_0.slider, 0, arg_5_3.exp / var_5_3, var_5_0, 0, function(arg_7_0)
