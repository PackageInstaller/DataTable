...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.USE_FOOD, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		if arg_2_3 then
			...
			var_2_2(var_2_1, var_2_10006.getBackyardRemind(var_2_3))
		end
		...
		var_2_5(var_2_4, var_2_10006.USE_ITEM, {
			id = arg_2_1,
			count = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.BUY_FOOD, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.SHOPPING, {
			id = arg_3_1,
			count = arg_3_2
		})
	...
	arg_1_0:bind(var_0_1.EXTEND, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10005.SHOPPING, {
			id = arg_4_1,
			count = arg_4_2
		})
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_2.ADD_FOOD_DONE then
		local var_6_4 = arg_6_0.viewComponent

		var_5.OnUsageItem(var_6_4, var_6_1.id)
	else
		DormProxy = var_5
