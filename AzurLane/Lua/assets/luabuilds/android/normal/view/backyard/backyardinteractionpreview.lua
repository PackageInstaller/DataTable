...
function var_0_0.LoadShip(arg_8_0, arg_8_1, arg_8_2)
	...
	var_4.Load(var_8_2, true, function(arg_9_0)
		...
		var_9_1(var_9_0, var_3(var_0_1, var_0_1, 1))
...
function var_0_0.StartActions(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	;(function(arg_24_0)
		...
		var_24_3(var_24_2, var_5.Find(var_24_4, "spine"), var_24_0, var_22_3)
		...
		if arg_22_0.loadedFurnitureMask then
			...
			var_24_6(var_24_5, var_5.Find(var_24_7, "spine"), var_24_0, var_22_3)
		else
			var_22_3()
		end
...
function var_0_0.StartFollowBone(arg_25_0, arg_25_1)
	...
	var_25_4(var_25_3, var_1_10008(var_25_1 * var_0_1, var_0_1, 1))

	SpineAnimUI = var_25_4

	local var_25_5 = var_25_4.AddFollower(var_25_0, var_25_2:Find("spine"), arg_25_0.loadedShip.transform)

	var_6.GetComponent(var_25_5, "Spine.Unity.BoneFollowerGraphic").followLocalScale = true

	local var_25_6 = arg_25_0.loadedShip
	local var_25_7 = var_8.SetLocalPosition

	Vector3 = var_10

	var_25_7(var_25_6, var_10(0, 0, 0))
...
function var_0_0.LoadRes(arg_30_0, arg_30_1, arg_30_2)
	...
	var_30_1(var_30_0, var_30_2, var_30_3, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_31_0)
		local var_31_0 = arg_30_2

		Instantiate = var_2_10002

		var_31_0(var_2_10002(arg_31_0))
