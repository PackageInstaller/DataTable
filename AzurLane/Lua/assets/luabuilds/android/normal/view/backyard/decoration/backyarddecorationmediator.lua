...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.SAVE_THEME, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if not var_4_1(var_4_0, var_4_2, var_2_10006(var_2_10007).floor) then
			pg = var_4_0

			local var_4_3 = var_4_0.TipsMgr.GetInstance()

			var_4_0 = var_4_0.ShowTips
			i18n = var_6

			var_4_0(var_4_3, var_6("backyard_save_empty_theme"))
		...
		local var_4_4 = var_4_0.UIMgr.GetInstance()
		...
		local var_4_8 = var_2_10007.UIMgr.GetInstance().uiCamera
		local var_4_9 = var_7.GetComponent

		typeof = var_2_10009
		Camera = var_2_10010

		local var_4_10 = var_4_9(var_4_8, var_2_10009(var_2_10010))
		...
		var_4_8({
			...
			function(arg_13_0)
				...
				local var_13_1 = var_2.GetIconMd5(var_4_5)
				...
				local var_13_4 = var_13_2.UIMgr.GetInstance()
				...
				var_13_6(var_13_5, var_3_10006.BACKYARD_SAVE_THEME_TEMPLATE, {
					id = arg_4_1,
					name = arg_4_2,
	...
	arg_1_0:bind(var_0_1.DELETE_THEME, function(arg_14_0, arg_14_1)
		...
		var_14_1(var_14_0, var_2_10004.BACKYARD_DELETE_THEME_TEMPLATE, {
			templateId = arg_14_1
		})
	...
	arg_1_0:bind(var_0_1.GET_CUSTOM_THEME, function(arg_15_0, arg_15_1)
		...
		local var_15_2 = var_2_10004.BACKYARD_GET_THEME_TEMPLATE
		local var_15_3 = {}

		BackYardConst = var_2_10006
		var_15_3.type = var_2_10006.THEME_TEMPLATE_TYPE_CUSTOM
	...
	arg_1_0:bind(var_0_1.OPEN_SHOP, function(arg_16_0)
		...
		var_16_2(var_16_1, var_2_10003.ON_CLOSE)
		...
		var_16_4(var_16_3, var_3.OPEN_BACKYARD_SHOP)
	...
	arg_1_0:bind(var_0_1.ClEAR_ALL, function(arg_18_0, arg_18_1)
		...
		var_18_1(var_18_0, var_2_10004.ON_APPLY_SELF_THEME)
	...
	arg_1_0:bind(var_0_1.ADD_FURNITURE, function(arg_19_0, arg_19_1, arg_19_2)
		...
		local var_19_2 = var_19_0:GetController()
	...
	arg_1_0:bind(var_0_1.ADD_FURNITURES, function(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
		...
		local var_20_2 = var_6.ceil(#arg_20_2 / 3)
		...
		var_7(var_20_0, function()
			...
			var_24_1(var_24_0, var_3_10002.ON_APPLY_SELF_THEME_DONE, {
				id = arg_20_1
			})
...
function var_0_1.AnyFurnitureInFloor(arg_27_0, arg_27_1, arg_27_2)
	...
	local var_27_0 = var_4
	local var_27_1 = var_4.GetAllFurniture(var_27_0)

	table = var_27_0

	return var_27_0.getCount(var_27_1) > 0
end
...
function var_0_1.GetCanPutFurnitureForTheme(arg_28_0, arg_28_1, arg_28_2)
	...
	local var_28_0 = var_1_10003(var_1_10004).floor
	...
	if var_28_2 then
		...
		local var_28_5 = arg_28_2
		local var_28_6 = arg_28_2.GetAllFurniture(var_28_5)

		pairs = var_28_5

		for iter_28_0, iter_28_1 in var_28_5(var_28_6) do
			table = var_1_10014
	...
	local var_28_7 = arg_28_0:FilterOwnCount(var_28_3)

	table = var_8

	local var_28_8 = var_8.sort
	local var_28_9 = var_28_7

	BackyardThemeFurniture = var_10

	var_28_8(var_28_9, var_10._LoadWeight)

	return var_28_7, var_28_4
end
...
function var_0_1.FilterOwnCount(arg_29_0, arg_29_1)
	...
	local var_29_3 = var_1_10005(var_1_10006)
	local var_29_4 = var_5.getRawData(var_29_3)

	ipairs = var_29_3

	for iter_29_0, iter_29_1 in var_29_3(arg_29_1) do
...
function var_0_1.SetUp(arg_32_0)
	...
	var_1_10001({
		function(arg_33_0)
			...
			local var_33_0 = var_2_10001(var_2_10002)
		...
		function(arg_34_0)
			...
			var_34_1(var_34_0, var_2_10003.GET_CUSTOM_THEME, arg_34_0)
...
function var_0_1.handleNotification(arg_37_0, arg_37_1)
	...
	local var_37_2 = arg_37_1.getBody(var_37_1)

	CourtYardEvent = var_37_1

	local var_37_3

	if var_37_0 == var_37_1._SYN_FURNITURE then
		var_37_3 = var_37_2[1]
		var_1_10005 = var_37_2[2]
		getProxy = var_1_10006
		DormProxy = var_1_10007
		var_1_10006 = var_1_10006(var_1_10007).floor

		local var_37_4 = arg_37_0.dorm

		var_1_10007 = var_1_10007.GetTheme(var_37_4, var_1_10006)
		ipairs = var_37_4

		for iter_37_0, iter_37_1 in var_37_4(var_37_3) do
			...
			var_37_8(var_37_7, var_16.GetFurniture(var_37_9, iter_37_1.configId))
		end

		ipairs = var_8

		for iter_37_2, iter_37_3 in var_8(var_1_10005) do
			...
			if var_37_10 then
				...
				var_37_13(var_37_12, var_16.GetFurniture(var_37_14, var_37_10.configId))
			end
		end
	else
		DormProxy = var_37_3

		if var_37_0 == var_37_3.THEME_TEMPLATE_ADDED then
			var_1_10005 = arg_37_0.viewComponent

			var_4.CustomThemeAdded(var_1_10005, var_37_2.template)
		else
			DormProxy = var_4

			if var_37_0 == var_4.THEME_TEMPLATE_DELTETED then
				var_1_10005 = arg_37_0.viewComponent

				var_4.CustomThemeDeleted(var_1_10005, var_37_2.templateId)
			else
				GAME = var_4

				local var_37_15

				if var_37_0 == var_4.BACKYARD_GET_THEME_TEMPLATE_DONE then
					getProxy = var_37_15
					DormProxy = var_1_10005
					var_37_15 = var_37_15(var_1_10005)
					var_1_10006 = arg_37_0.viewComponent

					var_5.SetThemes(var_1_10006, var_37_15:GetCustomThemeTemplates())
				else
					GAME = var_37_15

					if var_37_0 == var_37_15.ON_APPLY_SELF_THEME then
						...
						if var_37_0 == var_4.ON_APPLY_SELF_THEME_DONE then
							...
							if var_37_0 == var_4._EXIT_MODE then
								local var_37_18 = arg_37_0.viewComponent

								var_37_19 = var_37_19.emit
								BaseUI = var_1_10006

								var_37_19(var_37_18, var_1_10006.ON_CLOSE)
							else
								CourtYardEvent = var_37_19

								local var_37_21

								if var_37_0 == var_37_19._DRAG_ITEM then
									...
									var_37_21 = var_37_21(var_37_20, var_1_10006(var_1_10007))
									var_37_21.blocksRaycasts = false
								else
									CourtYardEvent = var_37_21

									if var_37_0 == var_37_21._DRAG_ITEM_END then
										...
										typeof = var_1_10006
										CanvasGroup = var_1_10007
										var_4(var_37_22, var_1_10006(var_1_10007)).blocksRaycasts = true
									elseif var_37_0 == var_0_1.START_TAKE_THEME_PHOTO then
										GetOrAddComponent = var_4
										...
										typeof = var_1_10006
										CanvasGroup = var_1_10007
										var_4(var_37_23, var_1_10006(var_1_10007)).alpha = 0
									else
										local var_37_25

										if var_37_0 == var_0_1.END_TAKE_THEME_PHOTO then
											...
											typeof = var_1_10006
											CanvasGroup = var_1_10007
											var_37_25 = var_37_25(var_37_24, var_1_10006(var_1_10007))
											var_37_25.alpha = 1
										else
											CourtYardEvent = var_37_25

											if var_37_0 == var_37_25._FURNITURE_SELECTED then
												local var_37_26 = arg_37_0.viewComponent
												local var_37_27 = var_4.emit

												BackYardDecrationLayer = var_1_10006

												var_37_27(var_37_26, var_1_10006.INNER_SELECTED_FURNITRUE, var_37_2)
											end
										end
									end
								end
