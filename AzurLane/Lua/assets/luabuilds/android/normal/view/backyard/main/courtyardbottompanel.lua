...
function var_0_1.init(arg_2_0)
	...
	typeof = var_3
	Slider = var_1_10004
	arg_2_0.stockBar = var_2_3(var_2_2, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.stockTimeTxt = var_2_6(var_2_5, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.stockTxt = var_2_9(var_2_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.trainBtnTxt = var_2_19(var_2_18, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.trainBtnLabel = var_2_22(var_2_21, var_3(var_1_10004))
	...
	local var_2_26 = var_2.Find(var_2_25, "label")

	i18n = var_2_25

	var_1(var_2_26, var_2_25("courtyard_label_capacity"))
	...
	var_1(var_2_28, var_2_27("courtyard_label_share"))
	...
	var_1(var_2_30, var_2_29("courtyard_label_shop"))

	setText = var_1

	local var_2_31 = arg_2_0.decorateBtn
	local var_2_32 = var_2.Find(var_2_31, "Text")

	i18n = var_2_31

	var_1(var_2_32, var_2_31("courtyard_label_decoration"))
	...
	var_1(var_2_34, var_2_33("courtyard_label_template"))
...
function var_0_1.OnRegister(arg_3_0)
	...
	local function var_3_5()
		...
		local var_5_2 = var_2_10002.ShareMgr.TypeBackyard

		pg = var_2_10003

		var_5_1(var_5_0, var_5_2, var_2_10003.ShareMgr.PANEL_TYPE_PINK)
	...
	local function var_3_8()
		...
		var_6_1(var_6_0, var_2_10002.GO_GRANARY)
	...
	local function var_3_11()
		...
		var_7_1(var_7_0, var_2_10002.GO_SHOP)
	...
	local function var_3_14()
		...
		var_8_1(var_8_0, var_2_10002.OPEN_DECORATION)
	...
	local function var_3_17()
		...
		var_9_1(var_9_0, var_2_10002.GO_THEME_TEMPLATE)
	...
	local function var_3_20()
		if arg_3_0.contextData.floor == 1 then
			...
			var_10_1(var_10_0, var_2_10002.SEL_TRAIN_SHIP)
		elseif arg_3_0.contextData.floor == 2 then
			...
			var_10_3(var_10_2, var_2_10002.SEL_REST_SHIP)
		end
	...
	if not var_3_20 then
		...
		local var_3_24 = var_3_20(var_1_10005)

		var_3_25 = var_4.mingshiTouchFlagEnabled(var_3_24)
	else
		var_3_25 = false
	end
...
function var_0_1.OnFlush(arg_12_0, arg_12_1)
	if not arg_12_1 then
		...
		var_1_10003 = var_1_10003.DORM_UPDATE_TYPE_UPDATEFOOD
		BackYardConst = var_1_10004

		local var_12_1 = var_1_10004.DORM_UPDATE_TYPE_LEVEL

		BackYardConst = var_1_10005
		var_1_10005 = var_1_10005.DORM_UPDATE_TYPE_SHIP
		BackYardConst = var_1_10006

		local var_12_2 = var_1_10006.DORM_UPDATE_TYPE_USEFOOD

		BackYardConst = var_1_10007
		arg_12_1 = var_12_0(var_1_10003, var_12_1, var_1_10005, var_12_2, var_1_10007.DORM_UPDATE_TYPE_EXTENDFOOD)
	end

	local var_12_3 = arg_12_0.dorm

	bit = var_1_10003

	local var_12_4 = var_1_10003.band
	local var_12_5 = arg_12_1

	BackYardConst = var_1_10005

	if not (var_12_4(var_12_5, var_1_10005.DORM_UPDATE_TYPE_UPDATEFOOD) > 0) then
		bit = var_12_6

		local var_12_6 = var_12_6.band
		local var_12_7 = arg_12_1

		BackYardConst = var_5

		if not (var_12_6(var_12_7, var_5.DORM_UPDATE_TYPE_USEFOOD) > 0) then
			bit = var_12_6
			var_12_6 = var_12_6.band

			local var_12_8 = arg_12_1

			BackYardConst = var_5

			if var_12_6(var_12_8, var_5.DORM_UPDATE_TYPE_EXTENDFOOD) > 0 then
				arg_12_0:CalcStockLeftTime()
			end

			bit = var_12_6

			local var_12_9 = var_12_6.band
			local var_12_10 = arg_12_1

			BackYardConst = var_5

			if var_12_9(var_12_10, var_5.DORM_UPDATE_TYPE_SHIP) > 0 then
				arg_12_0:CalcStockLeftTime()
			...
			if var_12_11(var_12_12, var_5.DORM_UPDATE_TYPE_LEVEL) > 0 then
				SetActive = var_3

				local var_12_13 = arg_12_0.templateBtn

				LOCK_BACKYARD_TEMPLATE = var_12_15

				var_3(var_12_13, not var_12_15)
				...
				if not var_3 then
					...
					if var_12_3:IsMaxLevel() then
						var_12_15 = arg_12_0:IsInner()
					end

					var_3(var_12_14, var_12_15)
				end
			end

			bit = var_3

			local var_12_16 = var_3.band
			local var_12_17 = arg_12_1

			BackYardConst = var_12_15

			if not (var_12_16(var_12_17, var_12_15.DORM_UPDATE_TYPE_UPDATEFOOD) > 0) then
				bit = var_12_18

				local var_12_18 = var_12_18.band
				local var_12_19 = arg_12_1

				BackYardConst = var_5

				if not (var_12_18(var_12_19, var_5.DORM_UPDATE_TYPE_LEVEL) > 0) then
					bit = var_12_18
					var_12_18 = var_12_18.band

					local var_12_20 = arg_12_1

					BackYardConst = var_5

					if not (var_12_18(var_12_20, var_5.DORM_UPDATE_TYPE_USEFOOD) > 0) then
						bit = var_12_18
						var_12_18 = var_12_18.band
						...
						if var_12_18(var_12_21, var_5.DORM_UPDATE_TYPE_EXTENDFOOD) > 0 then
							pg = var_12_18

							local var_12_22 = var_12_18.dorm_data_template[var_12_3.id].capacity

							arg_12_0.stockBar.value = var_12_3.food / (var_12_22 + var_12_3:GetFoodMax())

							local var_12_23 = arg_12_0.stockTxt

							math = var_5
							var_12_23.text = var_5.ceil(var_12_3.food) .. "/" .. var_12_22 + var_12_3:GetFoodMax()
						end
...
function var_0_1.PlayBackYardThemeTemplate(arg_13_0)
	...
	if var_1.IsMaxLevel(var_13_1) then
		...
		if not var_1.GetPlayedFlag(var_13_2, 90021) then
			...
			i18n = var_1_10004
			var_13_5.content = var_1_10004("open_backyard_theme_template_tip")
...
function var_0_1.UpdateTrainBtn(arg_14_0)
	if arg_14_0.contextData.floor == 1 then
		...
		var_14_1.text = var_1_10002(var_14_2, var_1_10004.FLOOR_1) .. "/" .. arg_14_0.dorm.exp_pos
	elseif arg_14_0.contextData.floor == 2 then
		...
		DormShip = var_1_10004
		var_14_4.text = var_14_6(var_14_5, var_1_10004.FLOOR_2) .. "/" .. arg_14_0.dorm.rest_pos
	end
...
function var_0_1.UpdateShopTip(arg_15_0)
	...
	if not var_3.IsTipNewTheme(var_15_1) then
		getProxy = var_15_3
...
function var_0_1.CalcStockLeftTime(arg_17_0)
	...
	if var_17_2(var_17_1, var_1_10004.FLOOR_1) <= 0 or var_17_0.food <= 0 then
		return
	end

	local var_17_3 = var_17_0
	local var_17_4 = var_17_0.getFoodLeftTime(var_17_3)

	Timer = var_17_3
	arg_17_0.timer = var_17_3.New(function()
		math = var_2_10000

		local var_18_0 = var_2_10000.floor(var_17_4)

		pg = var_1

		local var_18_1 = var_1.TimeMgr.GetInstance()
...
function var_0_1.UpdateFloor(arg_21_0, arg_21_1)
	...
	var_2(var_21_4, var_4(var_21_1).floor == 2)
