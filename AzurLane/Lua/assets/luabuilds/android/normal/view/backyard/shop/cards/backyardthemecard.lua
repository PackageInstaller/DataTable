...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.discountTxt = var_1_10(var_1_9, var_4(var_1_10005))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_1 = var_4.gsub(var_2_0, "<size=%d+>", "")
	local var_2_2 = arg_2_0.nameTxt

	string = var_6
	var_2_2.text = var_6.gsub(var_2_1, "</size>", "")

	local var_2_3 = arg_2_1:GetDiscount()
	local var_2_4 = arg_2_1
	local var_2_5 = arg_2_1.HasDiscount(var_2_4)

	setActive = var_2_4

	var_2_4(arg_2_0.discountTF, var_2_5)

	if var_2_5 then
		arg_2_0.discountTxt.text = var_2_3 .. "%"
	end
...
function var_0_0.UpdateSelected(arg_4_0, arg_4_1)
	...
	local var_4_3 = var_1_10005.value(arg_4_0.content.gameObject, var_4_1, var_4_2, 0.264)
	local var_4_4 = var_5.setOnUpdate

	System = var_7

	var_4_4(var_4_3, var_7.Action_float(function(arg_5_0)
