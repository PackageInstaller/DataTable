...
function var_0_1.GenBuffData(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10002(var_1_10003.GetBackYardPlayerBuffs()) do
...
function var_0_1.OnRegister(arg_4_0)
	...
	local function var_4_5()
		...
		var_6_1(var_6_0, var_2_10002.ONE_KEY)
...
function var_0_1.OnFlush(arg_8_0, arg_8_1)
	if not arg_8_1 then
		...
		var_1_10003 = var_1_10003.DORM_UPDATE_TYPE_LEVEL
		BackYardConst = var_1_10004

		local var_8_1 = var_1_10004.DORM_UPDATE_TYPE_USEFOOD

		BackYardConst = var_1_10005
		arg_8_1 = var_8_0(var_1_10003, var_8_1, var_1_10005.DORM_UPDATE_TYPE_SHIP)
	end

	local var_8_2 = arg_8_0.dorm

	bit = var_1_10003

	local var_8_3 = var_1_10003.band
	...
	if var_8_3(var_8_4, var_1_10005.DORM_UPDATE_TYPE_USEFOOD) > 0 and arg_8_0:IsInner() then
		arg_8_0.buffList = arg_8_0:GenBuffData()
		setActive = var_3

		local var_8_5 = arg_8_0.buffBtn

		var_8_6 = #arg_8_0.buffList > 0

		var_3(var_8_5, var_8_6)
	end

	bit = var_3

	local var_8_7 = var_3.band
	local var_8_8 = arg_8_1

	BackYardConst = var_8_6

	if var_8_7(var_8_8, var_8_6.DORM_UPDATE_TYPE_SHIP) > 0 then
		setActive = var_3

		var_3(arg_8_0.oneKeyBtn, var_8_2:AnyShipExistIntimacyOrMoney())
	end
