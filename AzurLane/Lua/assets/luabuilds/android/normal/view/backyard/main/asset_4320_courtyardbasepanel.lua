...
function var_0_1.Fold(arg_5_0, arg_5_1)
	...
	local var_5_2 = arg_5_0.GetMoveY(var_5_1)

	_ = var_5_1

	if not var_5_1.any(var_5_2, function(arg_6_0)
		...
		return var_6_0(var_2_10002(arg_6_0[1]))
	end) then
		_ = var_4

		if var_4.any(var_5_0, function(arg_7_0)
			LeanTween = var_2_10001
			...
			return var_7_0(var_2_10002(arg_7_0[1]))
		end) then
			return
		end
		...
		var_4.each(var_5_0, function(arg_8_0)
			local var_8_0 = 0
...
function var_0_1.Tween(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4)
	...
	local var_13_2 = var_13_1(var_13_0, var_7.Action(function()
		if arg_13_2 then
			setActive = var_0
	...
	var_13_3(var_13_2, var_7.Action(function()
