...
local function var_0_2(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_10004(var_1_1, var_1_2, var_1_3, var_1_10008)
...
function var_0_1.init(arg_7_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_7_0.goldTxt = var_7_7(var_7_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_7_0.gemTxt = var_7_10(var_7_9, var_3(var_1_10004))
	...
	BackYardConst = var_7_12

	local var_7_14 = var_7_12.THEME_TEMPLATE_TYPE_SHOP

	i18n = var_3
	var_7_13[var_7_14] = var_3("backyard_theme_shop_title")
	...
	BackYardThemeTemplateMsgBox = var_2
	var_7_17.msgBox = var_2.New(arg_7_0._tf, arg_7_0.event, arg_7_0.contextData)
...
function var_0_1.OnShopTemplatesUpdated(arg_10_0, arg_10_1)
	...
	arg_10_0.SetShopThemeTemplate(var_10_0, arg_10_1)

	local var_10_1 = arg_10_0.pageType

	BackYardConst = var_10_0

	if var_10_1 == var_10_0.THEME_TEMPLATE_TYPE_SHOP then
		local var_10_2 = arg_10_0:GetDataForType(arg_10_0.pageType)
		local var_10_3 = arg_10_0.listPage

		var_3.ExecuteAction(var_10_3, "ThemeTemplatesUpdate", var_10_2)
	end
...
function var_0_1.didEnter(arg_28_0)
	...
	var_1_10001(var_28_0, var_28_1, var_28_2, var_1_10005)
	...
	var_1_10001(var_28_3, var_28_4, var_28_5, var_1_10005)
	...
	local function var_28_8()
		...
		local var_31_2 = var_2_10002.ON_CHARGE

		PlayerConst = var_2_10003

		var_31_1(var_31_0, var_31_2, var_2_10003.ResDiamond)
	...
	var_1_10001(var_28_6, var_28_7, var_28_8, var_1_10005)
	...
	local function var_28_11()
		...
		local var_32_2 = var_2_10002.ON_CHARGE

		PlayerConst = var_2_10003

		var_32_1(var_32_0, var_32_2, var_2_10003.ResDormMoney)
	...
	var_1_10001(var_28_9, var_28_10, var_28_11, var_1_10005)
	...
	var_1_10001({
		function(arg_33_0)
			...
			var_33_1(var_33_0, var_2_10003.FETCH_ALL_THEME, arg_33_0)
...
function var_0_1.InitPages(arg_35_0)
	...
	for iter_35_0, iter_35_1 in var_1(arg_35_0.tags) do
		...
		local var_35_3 = var_35_2(var_35_1, var_9(var_1_10010))

		GetSpriteFromAtlas = var_35_1
		var_35_3.sprite = var_35_1("ui/NewBackYardShopUI_atlas", "text_tp_" .. iter_35_0)
		...
		local var_35_6 = var_35_5(var_35_4, var_1_10010(var_11))

		GetSpriteFromAtlas = var_35_4
		var_35_6.sprite = var_35_4("ui/NewBackYardShopUI_atlas", "text_tp_" .. iter_35_0)
		var_1_10010 = var_35_6

		var_35_6.SetNativeSize(var_1_10010)

		setActive = var_9

		local var_35_7 = var_1_10006

		var_1_10010 = var_1_10006.Find(var_35_7, "line")
		BackYardConst = var_35_7

		var_9(var_1_10010, iter_35_0 ~= var_35_7.THEME_TEMPLATE_TYPE_COLLECTION)
...
function var_0_1.UpdateRes(arg_39_0)
	...
	var_39_0.text = var_39_2(var_39_1, var_1_10004.ResDormMoney)
