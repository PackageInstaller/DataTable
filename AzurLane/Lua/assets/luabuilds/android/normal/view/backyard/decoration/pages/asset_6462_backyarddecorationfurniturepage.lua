...
function var_0_1.SortDisplays(arg_6_0)
	...
	if not var_1.GetLoaded(var_6_0) then
		...
		for iter_6_0, iter_6_1 in var_6_0(arg_6_0.displays) do
...
function var_0_1.change2ScrPos(arg_9_0, arg_9_1)
	...
	local var_9_3 = arg_9_0.GetComponent(var_9_2, "RectTransform")

	LuaHelper = var_9_2

	return (var_9_2.ScreenToLocal(var_9_3, arg_9_1, var_9_1))
end
...
function var_0_1.OnLoaded(arg_10_0)
	...
	BackYardDecorationPutlistPage = var_1_10003

	var_10_1(var_10_0, var_1_10003.SELECTED_FURNITRUE, function()
	...
	BackYardDecrationLayer = var_3

	var_10_3(var_10_2, var_3.INNER_SELECTED_FURNITRUE, function(arg_12_0, arg_12_1)
	...
	local function var_10_7(arg_15_0)
		...
		local var_15_2 = var_15_0(var_2.Find(var_15_1, "content"), arg_15_0.position)
		local var_15_3
		...
		for iter_15_0, iter_15_1 in var_3(arg_10_0.cards) do
			...
			local var_15_7 = var_12(var_15_5 + var_15_4.rect.width / 2, var_15_6 - var_15_4.rect.height / 2)

			Vector2 = var_13

			local var_15_8 = var_13(var_15_5 - var_15_4.rect.width / 2, var_15_6 - var_15_4.rect.height / 2)

			if var_15_2.x > var_15_8.x and var_15_2.x < var_15_7.x and var_15_2.y > var_15_7.y and var_15_2.y < var_2_10011.y then
				var_15_3 = iter_15_1
	...
	local var_10_9 = var_4(var_10_8, var_1_10006(var_1_10007))
	...
	var_4:AddPointUpFunc(function(arg_18_0, arg_18_1)
		...
		if arg_10_0.lock then
			var_2_10003 = arg_10_0.contextData.furnitureDescMsgBox

			var_2.ExecuteAction(var_2_10003, "Hide")
			...
			if var_2_10003.Distance(var_18_0, arg_10_0.downPosition) > 1 then
				return
			end

			if var_10_7(arg_18_1) and var_3:HasMask() then
				local var_18_1 = var_3.furniture

				if var_4.isPaper(var_18_1) then
					local var_18_2 = arg_10_0
					local var_18_3 = var_4.emit

					BackYardDecorationMediator = var_2_10006

					var_18_3(var_18_2, var_2_10006.REMOVE_PAPER, var_3.furniture)
			...
			if var_3 and not var_3:HasMask() then
				...
				local var_18_4 = var_4(var_3.furniture)
				local var_18_5 = arg_10_0
				local var_18_6 = var_5.emit

				BackYardDecorationMediator = var_2_10007

				var_18_6(var_18_5, var_2_10007.ADD_FURNITURE, var_18_4)
			elseif var_3 and var_3:HasMask() then
				local var_18_7 = arg_10_0

				var_4.ClearMark(var_18_7)
				...
				local var_18_9 = var_4.emit

				BackYardDecorationMediator = var_6

				var_18_9(var_18_8, var_6.ON_SELECTED_FURNITRUE, var_3.furniture.id)

				local var_18_10 = arg_10_0

				var_4.emit(var_18_10, var_0_1.SELECTED_FURNITRUE)
			end
		end
...
function var_0_1.GetDisplays(arg_24_0)
	...
	local var_24_4 = var_4.furniture_data_template.get_id_list_by_tag[var_24_3]

	ipairs = var_1_10005

	for iter_24_0, iter_24_1 in var_1_10005(var_24_4 or {}) do
