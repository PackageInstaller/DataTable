...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.group = var_1_1(var_1_0, var_1_10004(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.comfortable = var_1_5(var_1_4, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.name = var_1_7(var_1_6, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.themeName = var_1_9(var_1_8, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.desc = var_1_11(var_1_10, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.resGoldTxt = var_1_13(var_1_12, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.resGemTxt = var_1_15(var_1_14, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.countTxt = var_1_17(var_1_16, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.countDownTm = var_1_19(var_1_18, var_4(var_1_10005))
	findTF = var_2
...
function var_0_0.Update(arg_2_0, arg_2_1)
	...
	local var_2_1 = var_2_0.hxLan
	local var_2_2 = arg_2_1
	local var_2_3 = var_2_1(arg_2_1.getConfig(var_2_2, "name"))
	local var_2_4 = arg_2_0.name

	shortenString = var_2_2
	var_2_4.text = var_2_2(var_2_3, 9)

	local var_2_5 = arg_2_0.themeName

	shortenString = var_4
	var_2_5.text = var_4(arg_2_1:GetThemeName(), 7)

	local var_2_6 = arg_2_0.desc

	HXSet = var_4
	var_2_6.text = var_4.hxLan(arg_2_1:getConfig("describe"))

	local var_2_7 = arg_2_0.comfortable

	var_2_7.text = "+" .. arg_2_1:getConfig("comfortable")
	GetSpriteFromAtlasAsync = var_2_7

	var_2_7("furnitureicon/" .. arg_2_1:getConfig("icon"), "", function(arg_3_0)
		IsNil = var_2_10001
	...
	arg_2_0.countTxt.text = var_2_8

	local var_2_9 = arg_2_1
	local var_2_10 = arg_2_1.canPurchaseByGem(var_2_9)

	setActive = var_2_9

	var_2_9(arg_2_0.resGem, var_2_10)

	local var_2_11 = arg_2_1
	local var_2_12 = arg_2_1.canPurchaseByDormMoeny(var_2_11)

	setActive = var_2_11

	var_2_11(arg_2_0.resGold, var_2_12)

	local var_2_13 = arg_2_1:canPurchase()

	if arg_2_0.maskUnOpen then
		setActive = var_8

		local var_2_14 = arg_2_0.maskUnOpen
		local var_2_15

		if var_2_13 then
			::label_2_0::

			if var_2_10 or var_2_12 then
				var_1_10011 = arg_2_1
				var_2_15 = not arg_2_1.inTime(var_1_10011)
		...
		var_8(var_2_14, var_2_15)
	end

	local var_2_16 = arg_2_0.resGoldTxt
	local var_2_17 = arg_2_1
	local var_2_18 = arg_2_1.getPrice

	PlayerConst = var_1_10011
	var_2_16.text = var_2_18(var_2_17, var_1_10011.ResDormMoney)

	local var_2_19 = arg_2_0.resGemTxt
	local var_2_20 = arg_2_1
	local var_2_21 = arg_2_1.getPrice

	PlayerConst = var_11
	var_2_19.text = var_2_21(var_2_20, var_11.ResDiamond)
	setActive = var_2_19

	var_2_19(arg_2_0.maskTF, not var_2_13)

	local var_2_22 = false

	setActive = var_9

	var_9(arg_2_0.hotTF, var_2_22)

	local var_2_23 = arg_2_1
	local var_2_24 = arg_2_1.IsNew(var_2_23)

	setActive = var_2_23

	var_2_23(arg_2_0.newTF, var_2_24 and var_2_13)

	local var_2_25, var_2_26 = arg_2_1:inTime()

	if arg_2_1:isTimeLimit() and var_2_25 then
		arg_2_0:UpdateCountdown(var_2_26)
	else
		arg_2_0:DestoryTimer()

		var_1_10014 = arg_2_0.countDownTm
		var_1_10014.text = ""
	end

	setActive = var_1_10014

	var_1_10014(arg_2_0.timerTr, var_13)
...
function var_0_0.UpdateSkinType(arg_4_0)
	...
	local var_4_1 = var_2.ExistFurniture(var_4_0)
...
function var_0_0.UpdateCountdown(arg_5_0, arg_5_1)
	...
	arg_5_0.updateTimer = var_4.New(function()
		...
		if 0 < var_6_5 then
			var_6_6 = var_6_5
			i18n = var_2_10005
			var_6_0 = var_6_6 .. var_2_10005("word_date")
		else
			math = var_6_6
			...
			if 0 < var_6_7 then
				var_6_8 = var_6_7
				i18n = var_2_10006
				var_6_0 = var_6_8 .. var_2_10006("word_hour")
			else
				math = var_6_8
				...
				if var_6_8.floor(var_6_4 / 60) > 0 then
					...
					i18n = var_2_10007
					var_6_0 = var_6_9 .. var_2_10007("word_minute")
				else
					local var_6_10 = var_6_4

					i18n = var_2_10007
					var_6_0 = var_6_10 .. var_2_10007("word_second")
				end
			end
		end
