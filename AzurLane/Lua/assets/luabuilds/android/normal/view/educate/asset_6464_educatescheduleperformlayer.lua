...
function var_0_1.findUI(arg_6_0)
	...
	local var_6_3 = var_2.Find(var_6_2, "title/Text")

	i18n = var_6_2

	var_1(var_6_3, var_6_2("child_plan_perform_title"))

	UIItemList = var_1

	local var_6_4 = var_1.New
	local var_6_5 = arg_6_0.leftTF
	local var_6_6 = var_2.Find(var_6_5, "content")
	local var_6_7 = arg_6_0.leftTF

	arg_6_0.dayUIList = var_6_4(var_6_6, var_3.Find(var_6_7, "content/day_tpl"))
...
function var_0_1.initDayList(arg_9_0)
	...
	var_1.make(var_9_0, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventInit then
			...
			local var_10_1 = arg_10_2.Find(var_10_0, "Text")

			EducateHelper = var_10_0

			var_2_10004(var_10_1, var_10_0.GetWeekStrByNumber(var_3))

			for iter_10_0 = 1, 3 do
				var_2_10009 = arg_10_2

				local var_10_2 = arg_10_2.Find(var_2_10009, "phase" .. iter_10_0)

				setActive = var_2_10009

				var_2_10009(var_10_2, iter_10_0 == arg_9_0.planCnt)
			end
		else
			UIItemList = var_3

			if arg_10_0 == var_3.EventUpdate then
				local var_10_3 = arg_10_1 + 1

				setActive = var_2_10004

				var_2_10004(arg_10_2:Find("selected"), arg_9_0.curDay == var_10_3)

				local var_10_4 = arg_10_2:Find("Text")
				local var_10_5 = "FFFFFF"
				local var_10_6 = "FFFFFF"

				if var_10_3 < arg_9_0.curDay then
					var_10_5 = var_0_2[1]
					var_10_6 = var_0_3[1]
				elseif arg_9_0.curDay == var_10_3 then
					var_10_5 = var_0_2[2]
					var_10_6 = var_0_3[3]
				else
					var_10_5 = var_0_2[3]
				...
				var_7(var_10_7, var_2_10009.NewHex(var_10_5))

				local var_10_8 = arg_10_2:Find("phase" .. arg_9_0.planCnt)

				for iter_10_1 = 1, var_10_8.childCount do
					local var_10_9 = var_10_6

					if arg_9_0.curDay == var_10_3 and iter_10_1 <= arg_9_0.curIndex then
						var_10_9 = var_0_3[2]
					end
					...
					local var_10_11 = var_10_8.GetChild(var_10_10, iter_10_1 - 1)

					Color = var_10_10

					var_13(var_10_11, var_10_10.NewHex(var_10_9))
				end
			end
		end
...
function var_0_1.playWeek(arg_12_0, arg_12_1)
	...
	EducateSchedulePerformMediator = var_1_10004

	var_12_1(var_12_0, var_1_10004.WEEKDAY_UPDATE, arg_12_0.curDay)
		...
		for iter_12_1 = 1, 3 do
			...
			if arg_12_0.showGrids[iter_12_0] and arg_12_0.showGrids[iter_12_0][iter_12_1] then
				...
				var_1_10014.insert(var_12_2, function(arg_13_0)
					...
					EducateSchedulePerformMediator = var_2_10003

					var_13_1(var_13_0, var_2_10003.WEEKDAY_UPDATE, arg_12_0.curDay)
					...
					var_1(var_13_3, var_3.GetName(var_13_4))
					...
					if arg_12_0.isSkip then
						if var_13_8 and not arg_12_0.isSkipEvent then
							...
							var_13_10(var_13_9, var_5.GetPerformance(var_13_11), arg_13_0, var_13_6 or {})
						else
							arg_13_0()
						end
					else
						...
						if not var_3.IsPlan(var_13_12) and arg_12_0.isSkipEvent then
							...
							var_13_14(var_13_13, var_5.GetPerformance(var_13_15), arg_13_0, var_13_6 or {})
						end
					end
			...
			if var_12_4 and not arg_12_0.isSkipEvent then
				...
				var_1_10014.insert(var_12_2, function(arg_14_0)
					...
					local var_14_2 = var_2_10003.child_event[var_12_6].performance
