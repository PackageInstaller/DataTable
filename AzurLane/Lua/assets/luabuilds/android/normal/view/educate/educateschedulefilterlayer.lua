...
var_0_4.options = var_0_5(var_5.TypeIndexs)

local var_0_6 = var_0_2

EducatePlanIndexConst = var_5
var_0_4.names = var_0_6(var_5.TypeNames)
...
EducatePlanIndexConst = var_5
var_0_11.options = var_0_12(var_5.CostIndexs)

local var_0_13 = var_0_2

EducatePlanIndexConst = var_5
var_0_11.names = var_0_13(var_5.CostNames)
EducatePlanIndexConst = var_4
...
function var_0_1.init(arg_3_0)
	...
	local var_3_9 = var_2.Find(var_3_8, "top/title")

	i18n = var_3_8

	var_1(var_3_9, var_3_8("child_filter_title"))
	...
	local var_3_16 = var_2.Find(var_3_15, "dropdown/list")
	local var_3_17 = arg_3_0.dropdownPanel

	arg_3_0.dropdownUIList = var_3_14(var_3_16, var_3.Find(var_3_17, "dropdown/list/tpl"))
	setActive = var_1
	...
	local var_3_19 = var_2.Find(var_3_18, "sure_btn/Text")

	i18n = var_3_18

	var_1(var_3_19, var_3_18("word_ok"))

	setText = var_1

	local var_3_20 = arg_3_0.windowTF
	local var_3_21 = var_2.Find(var_3_20, "reset_btn/Text")

	i18n = var_3_20

	var_1(var_3_21, var_3_20("word_reset"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local var_5_2 = var_3.Find(var_5_1, "sure_btn")
	...
	local var_5_6 = var_3.Find(var_5_5, "reset_btn")
	...
	var_1_10001(var_5_8, var_5_9, var_5_10, var_5)

	onButton = var_1_10001

	local var_5_11 = arg_5_0
	local var_5_12 = arg_5_0._tf
	local var_5_13 = var_3.Find(var_5_12, "anim_root/bg")
	...
	var_1_10001(var_5_11, var_5_13, var_5_14, var_5)

	onButton = var_1_10001

	local var_5_15 = arg_5_0
	local var_5_16 = arg_5_0.windowTF
	local var_5_17 = var_3.Find(var_5_16, "top/close_btn")
	...
	var_1_10001(var_5_15, var_5_17, var_5_18, var_5)
...
function var_0_1.initDropdownPanel(arg_11_0)
	...
	var_1.make(var_11_0, function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == var_2_10003.EventUpdate then
			...
			var_8(var_12_5, var_12_6, var_12_7, var_2_10012)
		end
...
function var_0_1.initFilters(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1(var_0_1.FILTER_CONFIG) do
		...
		var_7(var_1_10006:Find("title/title"), iter_14_1.title)
...
function var_0_1.initNormal(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	local var_15_1 = arg_15_3.Find(var_15_0, "content/container")

	UIItemList = var_15_0

	local var_15_2 = var_15_0.New(var_15_1, arg_15_0.itemTpl)
	...
	var_5.make(var_15_2, function(arg_16_0, arg_16_1, arg_16_2)
		...
		if arg_16_0 == var_2_10003.EventInit then
			...
			var_16_3(var_16_4, var_16_5, var_16_6, var_2_10010)
		...
		if arg_16_0 == var_16_0.EventUpdate then
			...
			local var_16_11 = arg_16_2.Find(var_16_10, "Text")

			if var_16_9 then
				Color = var_16_10

				if not var_16_10.white then
					Color = var_16_10
					var_16_10 = var_16_10.NewHex("393a3c")
				end

				var_6(var_16_11, var_16_10)
...
function var_0_1.initDropdown(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	local var_18_0 = arg_18_3
	local var_18_1 = arg_18_3.Find(var_18_0, "content/container")

	UIItemList = var_18_0

	local var_18_2 = var_18_0.New(var_18_1, arg_18_0.itemTpl)

	var_5.make(var_18_2, function(arg_19_0, arg_19_1, arg_19_2)
		UIItemList = var_2_10003
		...
		if arg_19_0 == var_2_10003.EventInit then
			...
			var_2_10006(arg_19_2:Find("line"), var_19_0 ~= #arg_18_2.tags)
			...
			if not arg_18_0.contextData.indexDatas[var_19_1] then
				var_19_3 = arg_18_0.contextData.indexDatas
				var_19_3[var_19_1] = var_19_2
			end
			...
			var_19_3(var_19_4, var_19_5, var_2_10009, var_2_10010)
		...
		if arg_19_0 == var_19_0.EventUpdate then
			local var_19_6 = arg_19_1 + 1
			local var_19_7 = arg_18_2.tags[var_19_6]
			local var_19_8 = arg_18_2.defaults[var_19_6]
			local var_19_9 = ""
			local var_19_10 = true
			local var_19_11

			if arg_18_0.contextData.indexDatas[var_19_7] == var_19_8 then
				var_19_10 = false
				var_19_9 = arg_18_2.names[var_19_6][1]
			else
				var_19_11 = arg_18_2.options[var_19_6]
				ipairs = var_2_10009

				for iter_19_0, iter_19_1 in var_2_10009(var_19_11) do
					if arg_18_0.contextData.indexDatas[var_19_7] == iter_19_1 then
						var_19_9 = arg_18_2.names[var_19_6][iter_19_0]
			...
			var_19_11(arg_19_2:Find("Text"), var_19_9)

			setActive = var_19_11

			var_19_11(arg_19_2:Find("selected"), var_19_10)

			setTextColor = var_19_11

			local var_19_12 = arg_19_2
			local var_19_13 = arg_19_2.Find(var_19_12, "Text")

			if var_19_10 then
				Color = var_19_12

				if not var_19_12.white then
					Color = var_19_12
					var_19_12 = var_19_12.NewHex("393a3c")
				end

				var_19_11(var_19_13, var_19_12)

				setImageColor = var_19_11

				local var_19_14 = arg_19_2
				local var_19_15 = arg_19_2.Find(var_19_14, "arrow")
...
function var_0_1.showDropdownPanel(arg_21_0, arg_21_1)
	...
	var_1_10002(var_3.Find(var_21_0, "dropdown"), arg_21_1)
