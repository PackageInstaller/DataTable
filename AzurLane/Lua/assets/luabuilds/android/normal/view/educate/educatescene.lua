...
function var_0_1.PlayBGM(arg_5_0)
	...
	if var_1.GetBgm(var_5_1) then
		...
		local var_5_2 = var_5_1.BgmMgr.GetInstance()
...
function var_0_1.findUI(arg_7_0)
	...
	arg_7_0.mainAnim = var_7_2(var_7_1, var_3(var_1_10004))
	...
	typeof = var_3
	Animation = var_1_10004
	arg_7_0.blurPanelAnim = var_7_6(var_7_5, var_3(var_1_10004))
	...
	typeof = var_3
	Animation = var_1_10004
	arg_7_0.favorBtnAnim = var_7_13(var_7_12, var_3(var_1_10004))
	...
	arg_7_0.favorBtnAnimEvent = var_7_16(var_7_15, var_3(var_1_10004))
	...
	local var_7_30 = var_2.Find(var_7_29, "unlock/Text")

	i18n = var_7_29

	var_1(var_7_30, var_7_29("child_btn_collect"))
	...
	local var_7_33 = var_2.Find(var_7_32, "unlock/Text")

	i18n = var_7_32

	var_1(var_7_33, var_7_32("child_btn_mind"))
	...
	local var_7_36 = var_2.Find(var_7_35, "unlock/Text")

	i18n = var_7_35

	var_1(var_7_36, var_7_35("child_btn_bag"))
	...
	arg_7_0.datePanel = var_7_37(var_2.Find(var_7_38, "date"), arg_7_0.event, {
		isMain = true
	})
	...
	arg_7_0.favorPanel = var_7_40(var_2.Find(var_7_41, "favor_panel"), arg_7_0.event)
	...
	arg_7_0.resPanel = var_7_43(var_2.Find(var_7_44, "res"), arg_7_0.event)
	...
	arg_7_0.topPanel = var_7_46(var_2.Find(var_7_47, "top_right"), arg_7_0.event)
	...
	arg_7_0.targetPanel = var_7_49(var_2.Find(var_7_50, "target"), arg_7_0.event)
	...
	arg_7_0.bottomPanel = var_7_52(var_2.Find(var_7_53, "right"), arg_7_0.event, {
	...
	arg_7_0.archivePanel = var_7_55(var_2.Find(var_7_56, "archive_panel"), arg_7_0.event, {
		isShow = true,
		isMainEnter = arg_7_0.contextData.isMainEnter
	})
...
function var_0_1._loadSubViews(arg_9_0)
	...
	var_9_11[1] = var_6.Find(var_9_12, "bottom/left")
...
function var_0_1.addListener(arg_10_0)
	...
	local function var_10_11()
		...
		local var_14_3 = var_2_10003.New
		local var_14_4 = {}

		EducateCollectEntranceMediator = var_2_10005
		var_14_4.mediator = var_2_10005
		EducateCollectEntranceLayer = var_2_10005
		var_14_4.viewComponent = var_2_10005
	...
	local function var_10_14()
		...
		if var_2_10000(var_1.Find(var_15_0, "lock")) then
			return
		end
		...
		local var_15_4 = var_3.New
		local var_15_5 = {}

		EducateMindMediator = var_2_10005
		var_15_5.mediator = var_2_10005
		EducateMindLayer = var_2_10005
		var_15_5.viewComponent = var_2_10005
		var_15_5.data = {
			onExit = function()
	...
	local function var_10_17()
		...
		if var_2_10000(var_1.Find(var_17_0, "lock")) then
			return
		end
		...
		local var_17_4 = var_3.New
		local var_17_5 = {}

		EducateBagMediator = var_2_10005
		var_17_5.mediator = var_2_10005
		EducateBagLayer = var_2_10005
		var_17_5.viewComponent = var_2_10005
	...
	local var_10_20 = var_3.Find(var_10_19, "fitter")
	...
	var_1_10001(var_10_18, var_10_20, var_10_21, var_5)
...
function var_0_1.SeriesCheck(arg_20_0)
	...
	var_2.insert(var_20_0, function(arg_22_0)
		...
		if var_1.CheckExcute(var_22_1) then
			...
			var_22_3(var_22_2, var_2_10003.ON_EXECTUE_PLANS)
		else
			arg_22_0()
		end
	...
	var_2.insert(var_20_0, function(arg_24_0)
		...
		if var_1.NeedGetHomeEventData(var_24_1) then
			...
			var_24_3(var_24_2, var_2_10003.ON_GET_EVENT, arg_24_0)
		else
			arg_24_0()
		end
...
function var_0_1.CheckTips(arg_29_0, arg_29_1)
	...
	for iter_29_0, iter_29_1 in var_1_10003(var_1_10004.GetSystemUnlockTips()) do
		table = var_1_10008
		...
		var_1_10008.insert(var_29_0, function(arg_30_0)
			...
			var_30_3.type = var_2_10005.UNLOCK_TYPE_SYSTEM
...
function var_0_1.CheckNewChar(arg_32_0, arg_32_1)
	...
	if var_2.GetCallName(var_32_1) == "" then
		...
		var_3.insert(var_32_2, function(arg_33_0)
			pg = var_2_10001
			...
			var_33_1(var_33_0, var_2_10003.FIRST_ENTER_PERFORM_IDS, arg_33_0)
		...
		var_3.insert(var_32_2, function(arg_34_0)
			...
			local var_34_3 = var_2_10004.New
			local var_34_4 = {}

			EducateNewCharMediator = var_2_10006
			var_34_4.mediator = var_2_10006
			EducateNewCharLayer = var_2_10006
			var_34_4.viewComponent = var_2_10006
			var_34_4.data = {
				callback = arg_34_0
			}
		...
		var_3.insert(var_32_2, function(arg_35_0)
			...
			var_35_1(var_35_0, var_2_10003.AFTER_SET_CALLNAME_PERFORM_ID, arg_35_0)
...
function var_0_1.showBubble(arg_37_0, arg_37_1)
	...
	var_1_10002(var_37_0, var_37_1, var_37_2, var_1_10006)
...
function var_0_1.PlayPerformWithDrops(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	local var_39_1 = var_5.GetCommonShowDrops(arg_39_2)
...
function var_0_1.checkBubbleShow(arg_48_0)
	...
	local var_48_3 = var_48_1(var_1_10003)
	...
	if #var_48_2 > 0 then
		...
		var_3(var_4.Find(var_48_5, "Text"), true)

		setActive = var_3

		local var_48_6 = arg_48_0.bubbleBtn

		var_3(var_4.Find(var_48_6, "Image"), false)
		arg_48_0:showBubble(function()
			local var_49_0 = arg_48_0
			local var_49_1 = var_0.emit

			EducateMediator = var_2_10002

			var_49_1(var_49_0, var_2_10002.ON_SPECIAL_EVENT_TRIGGER, {
				id = var_48_2[1].id,
				callback = function()
	...
	elseif var_48_4:CheckFavor() then
		...
		var_3(var_4.Find(var_48_7, "Text"), false)

		setActive = var_3

		local var_48_8 = arg_48_0.bubbleBtn

		var_3(var_4.Find(var_48_8, "Image"), true)
		arg_48_0:showBubble(function()
			...
			var_52_1(var_52_0, var_2_10002.ON_UPGRADE_FAVOR, function()
...
function var_0_1.updateUnlockBtns(arg_59_0)
	...
	local var_59_1 = var_59_0(var_1_10002.SYSTEM_MEMORY)

	setActive = var_2

	local var_59_2 = arg_59_0.bookBtn

	var_2(var_3.Find(var_59_2, "lock"), not var_59_1)

	setActive = var_2

	local var_59_3 = arg_59_0.bookBtn

	var_2(var_3.Find(var_59_3, "unlock"), var_59_1)

	EducateHelper = var_2

	local var_59_4 = var_2.IsSystemUnlock

	EducateConst = var_3

	local var_59_5 = var_59_4(var_3.SYSTEM_BAG)

	setActive = var_3

	local var_59_6 = arg_59_0.bagBtn

	var_3(var_4.Find(var_59_6, "lock"), not var_59_5)

	setActive = var_3

	local var_59_7 = arg_59_0.bagBtn

	var_3(var_4.Find(var_59_7, "unlock"), var_59_5)
	...
	local var_59_9 = var_59_8(var_4.SYSTEM_FAVOR_AND_MIND)

	setActive = var_4

	local var_59_10 = arg_59_0.mindBtn

	var_4(var_5.Find(var_59_10, "lock"), not var_59_9)

	setActive = var_4

	local var_59_11 = arg_59_0.mindBtn

	var_4(var_5.Find(var_59_11, "unlock"), var_59_9)
...
function var_0_1.updateMindTip(arg_60_0)
	...
	local var_60_1 = var_2.Find(var_60_0, "unlock/tip")

	getProxy = var_60_0
	EducateProxy = var_4

	local var_60_2 = var_60_0(var_4)
	local var_60_3 = var_3.GetTaskProxy(var_60_2)

	var_1_10001(var_60_1, var_3.IsShowMindTasksTip(var_60_3))
...
function var_0_1.updateFavorBtn(arg_62_0)
	...
	var_62_1(arg_62_0.favorLvTF, var_62_2.lv)

	local var_62_3 = var_1
	local var_62_4 = var_1.GetFavorMaxLv(var_62_3)

	setActive = var_62_3

	var_62_3(arg_62_0.favorMaxTF, var_62_2.lv == var_62_4)
...
function var_0_1.updatePaintingUI(arg_65_0)
	...
	local var_65_0 = var_1_10001(var_1_10002)
	...
	var_3(arg_65_0.bgTF, var_65_4, false)

	setPaintingPrefab = var_3

	var_3(arg_65_0.paintTF, arg_65_0.paintingName, "yangcheng")
...
function var_0_1.ShowDialogue(arg_66_0)
	...
	local var_66_1 = var_2.child_word[arg_66_0.wordList[var_66_0]].word

	if not arg_66_0.callName then
		getProxy = var_3
		EducateProxy = var_1_10004

		local var_66_2 = var_3(var_1_10004)
	...
	if var_4.Find(var_66_8, "face") and var_66_5 then
		setImageSprite = var_66_8

		var_66_8(var_4, var_66_5)
	...
	Vector3 = var_6
	var_66_9.localScale = var_6.zero
	setActive = var_66_9
	...
	local var_66_12 = var_66_10(var_66_11, var_7.one, 0.3)
	local var_66_13 = var_5.setEase

	LeanTweenType = var_7

	local var_66_14 = var_66_13(var_66_12, var_7.easeOutBack)
	local var_66_15 = var_5.setOnComplete

	System = var_7

	var_66_15(var_66_14, var_7.Action(function()
		...
		local var_67_2 = var_67_0(var_67_1, var_2_10002.zero, 0.3)
		local var_67_3 = var_0.setEase

		LeanTweenType = var_2

		local var_67_4 = var_67_3(var_67_2, var_2.easeInBack)
		local var_67_5 = var_0.setDelay(var_67_4, 3)
		local var_67_6 = var_0.setOnComplete

		System = var_2

		var_67_6(var_67_5, var_2.Action(function()
...
function var_0_1.updateBookNewTip(arg_70_0)
	...
	local var_70_1 = var_70_0(var_1_10002.child_memory.all, function(arg_71_0)
		...
		return var_71_0(var_2_10002.NEW_MEMORY, arg_71_0)
	end)

	EducateTipHelper = var_2

	local var_70_2 = var_2.IsShowNewTip

	EducateTipHelper = var_3

	local var_70_3 = var_70_2(var_3.NEW_POLAROID)

	setActive = var_3

	local var_70_4 = arg_70_0.bookBtn

	var_3(var_4.Find(var_70_4, "unlock/new"), var_70_1 or var_70_3)
...
function var_0_1.updateMindNewTip(arg_72_0)
	...
	local var_72_1 = var_2.Find(var_72_0, "unlock/new")

	EducateTipHelper = var_72_0

	local var_72_2 = var_72_0.IsShowNewTip

	EducateTipHelper = var_4

	var_1_10001(var_72_1, var_72_2(var_4.NEW_MIND_TASK))
...
function var_0_1.onBackPressed(arg_74_0)
	...
	var_74_1(var_74_0, var_74_2, var_1_10004.NEW_EDUCATE_SELECT, {
		isTb1 = true
	})
