...
function var_0_1.OnInit(arg_2_0)
	...
	local function var_2_3()
		...
		EducateTargetMediator = var_2_10005
		var_3_4.mediator = var_2_10005
		EducateTargetLayer = var_2_10005
	...
	local var_2_9 = var_2.Find(var_2_8, "title/Image/Text")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("child_task_system_type3"))
	...
	arg_2_0.mainTaskUIList = var_2_10(var_2.Find(var_2_11, "list"), arg_2_0.taskTpl)
	...
	local var_2_15 = var_2.Find(var_2_14, "title/Image/Text")

	i18n = var_2_14

	var_1(var_2_15, var_2_14("child_task_system_type2"))
	...
	arg_2_0.otherTaskUIList = var_2_16(var_2.Find(var_2_17, "list"), arg_2_0.taskTpl)
...
function var_0_1.updateTaskItem(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	var_6(arg_6_2:Find("progress"), var_6_1)

	GetPerceptualSize = var_6

	local var_6_2 = var_6(var_6_1)
	...
	local var_6_4 = arg_6_2.Find(var_6_3, "desc")

	shortenString = var_6_3

	var_7(var_6_4, var_6_3(var_6_0:getConfig("name"), 11 - var_6_2))
...
function var_0_1.Flush(arg_7_0)
	...
	local var_7_3 = var_2.Find(var_7_2, "target_btn/tip")
	local var_7_4 = arg_7_0.taskProxy

	var_1(var_7_3, var_3.IsShowOtherTasksTip(var_7_4))

	local var_7_5 = arg_7_0.taskProxy
	local var_7_6 = var_1.FilterByGroup
	local var_7_7 = arg_7_0.taskProxy

	arg_7_0.mainTaskVOs = var_7_6(var_7_5, var_3.GetMainTasksForShow(var_7_7))
	...
	if not var_1.CanGetTargetAward(var_7_8) then
		...
		arg_7_0.otherTaskVOs = var_7_10(var_7_9, var_3.GetTargetTasksForShow(var_7_11), true)
	end
	...
	var_3(arg_7_0.otherTF, #arg_7_0.otherTaskVOs > 0)
...
function var_0_1.SetPosLeft(arg_8_0)
	...
	var_1_10001(var_8_0, var_1_10003(-650, 0))
...
function var_0_1.SetPosRight(arg_9_0)
	...
	var_1_10001(var_9_0, var_1_10003(0, 0))
