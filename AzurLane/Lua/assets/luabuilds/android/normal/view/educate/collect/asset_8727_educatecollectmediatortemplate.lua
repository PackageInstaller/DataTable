...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.UNLOCK, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.EDUCATE_BUY_COLLECT, {
			type = arg_2_1.type,
			id = arg_2_1.id,
			cost = arg_2_1.cost
		})
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_0 == var_4_1.CLEAR_NEW_TIP then
		...
		if var_4_3 ~= var_1_10005.NEW_MEMORY then
			var_4_3 = var_4_2.index
			EducateTipHelper = var_5

			if var_4_3 == var_5.NEW_POLAROID then
				local var_4_4 = arg_4_0.viewComponent

				var_4_3.Flush(var_4_4)

				goto label_4_0

				GAME = var_4_3

				if var_4_0 == var_4_3.EDUCATE_BUY_COLLECT_DONE then
