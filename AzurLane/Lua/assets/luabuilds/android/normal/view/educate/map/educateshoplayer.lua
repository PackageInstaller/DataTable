...
function var_0_1.findUI(arg_4_0)
	...
	local var_4_10 = var_2.Find(var_4_9, "Text")

	i18n = var_4_9

	var_1(var_4_10, var_4_9("word_shop"))
	...
	arg_4_0.goodUIList = var_4_15(var_4_16, var_3.Find(var_4_17, "tpl"))
	setText = var_1

	local var_4_18 = arg_4_0.goodContent
	local var_4_19 = var_2.Find(var_4_18, "tpl/sellout/Text")

	i18n = var_4_18

	var_1(var_4_19, var_4_18("word_sell_out"))
	...
	local var_4_24 = var_2.Find(var_4_23, "Text")

	i18n = var_4_23

	var_1(var_4_24, var_4_23("child_shop_empty_tip"))
	...
	var_1(var_2.Find(var_4_29, "count"), false)
	...
	local var_4_36 = var_2.Find(var_4_35, "price/title")

	i18n = var_4_35

	var_1(var_4_36, var_4_35("child_shop_price_title"))
	...
	local var_4_39 = var_2.Find(var_4_38, "Text")

	i18n = var_4_38

	var_1(var_4_39, var_4_38("word_buy"))
...
function var_0_1.addListener(arg_6_0)
	...
	var_1_10001(var_6_7, var_6_8, var_6_9, var_5)
	...
	var_1_10001(var_6_10, var_6_11, var_6_12, var_5)
	...
	local function var_6_18()
		...
		if var_0.GetMaxCount(var_12_0) == 0 then
			...
			var_12_2(var_12_1, var_2_10002("common_no_resource"))
		...
		EducateShopMediator = var_2_10002

		var_12_4(var_12_3, var_2_10002.ON_SHOPPING, {
	...
	var_1_10001(var_6_16, var_6_17, var_6_18, var_5)
...
function var_0_1.updateGoodItem(arg_15_0, arg_15_1, arg_15_2)
	...
	if arg_15_0.isDiscount then
		...
		if not var_15_1.GetPrice(var_15_3, arg_15_0.discountRatio) then
			var_15_4 = var_15_2
		end

		setActive = var_15_3

		var_15_3(arg_15_2:Find("bottom/price/price_original"), arg_15_0.isDiscount)

		setText = var_15_3

		var_15_3(arg_15_2:Find("bottom/price/price_original"), var_15_2)

		setText = var_15_3

		var_15_3(arg_15_2:Find("bottom/price/price_final"), var_15_4)

		local var_15_5 = var_15_1
		local var_15_6 = var_15_1.GetShowInfo(var_15_5)

		EducateHelper = var_15_5

		var_15_5.UpdateDropShow(arg_15_2:Find("item"), var_15_6)
		...
		local function var_15_9()
			...
			for iter_16_0 = 0, arg_15_0.goodContent.childCount - 1 do
				...
				var_16_0(var_16_1:Find("selected"), iter_16_0 + 1 == arg_15_0.selectedIndex)
			end
		...
		var_8(var_15_7, var_15_8, var_15_9, var_1_10012)
...
function var_0_1.refreshShops(arg_17_0)
	...
	var_17_8(var_17_9, var_4.GetShopTip(var_17_10))
	...
	var_3(arg_17_0.detailEmptyTF, not var_17_12)

	setActive = var_3

	var_3(arg_17_0.detailPanelTF, var_17_12)
...
function var_0_1.updateDetail(arg_19_0)
	...
	local var_19_2 = var_19_0.child_item[var_19_1.id]
...
function var_0_1.updateDetailAttrs(arg_20_0, arg_20_1)
	...
	for iter_20_0 = 1, arg_20_0.detailAttrsTF.childCount do
		...
		if var_20_1 then
			...
			var_20_2(var_20_3, true)

			EducateHelper = var_20_2

			var_20_2.UpdateDropShowForAttr(var_20_3, var_20_1)
		else
			setActive = var_20_2

			var_20_2(var_20_3, false)
		end
	end
...
function var_0_1.updateDetailPrice(arg_21_0)
	...
	var_21_0(arg_21_0.priceValue, var_21_1.num * arg_21_0.countValue)

	setGray = var_21_0

	var_21_0(arg_21_0.purchaseBtn, arg_21_0:GetMaxCount() == 0, true)
...
function var_0_1.GetMaxCount(arg_22_0)
	...
	local var_22_4 = var_22_2.floor
	local var_22_5 = arg_22_0.char
	local var_22_6 = var_22_4(var_5.GetResById(var_22_5, var_22_3.id) / var_22_3.num)

	math = var_5

	return var_5.min(var_22_1, var_22_6)
end
