...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.limitUIList = var_1_9(var_1_10, var_5.Find(var_1_11, "tpl"))
	...
	local var_1_16 = var_4.Find(var_1_15, "Text")

	i18n = var_1_15

	var_3(var_1_16, var_1_15("child_plan_no_cost"))
	...
	arg_1_0.costUIList = var_1_17(var_1_18, var_5.Find(var_1_19, "tpl"))
	...
	local var_1_24 = var_4.Find(var_1_23, "content")
	local var_1_25 = arg_1_0.awardTF

	arg_1_0.awardUIList = var_1_22(var_1_24, var_5.Find(var_1_25, "content/tpl"))
	...
	arg_1_0.awardLayouCom = var_1_31(var_1_30, var_5(var_1_25))
	getProxy = var_3
...
function var_0_0.updateLimitItem(arg_5_0, arg_5_1, arg_5_2)
	...
	var_1_10005(var_5_1, var_5_2, var_8(arg_5_2, "icon_bg/icon"), true)
	...
	local var_5_3 = var_6(arg_5_2, "name")

	pg = var_7

	var_1_10005(var_5_3, var_7.child_attr[var_5_0].name)

	local var_5_4 = var_3[4] and "606064" or "ed7373"

	setTextColor = var_5_3
	findTF = var_7

	local var_5_5 = var_7(arg_5_2, "value")

	Color = var_8

	var_5_3(var_5_5, var_8.NewHex(var_5_4))
	...
	var_5_3(var_5_6, var_8.NewHex(var_5_4))
...
function var_0_0.updateCostItem(arg_6_0, arg_6_1, arg_6_2)
	...
	var_4(var_6_1, var_6_2, var_7(arg_6_2, "icon"), true)
	...
	local var_6_3 = var_5(arg_6_2, "name")

	pg = var_6

	var_4(var_6_3, var_6.child_resource[var_6_0.id].name)
...
function var_0_0.update(arg_8_0, arg_8_1, arg_8_2)
	...
	var_8_0(arg_8_0.progressTF, var_8_1 ~= 0)

	setActive = var_8_0

	var_8_0(arg_8_0.sliderTF, var_8_1 ~= 0)

	setActive = var_8_0

	var_8_0(arg_8_0.enNameTF, var_8_1 == 0)

	if var_8_1 ~= 0 then
		assert = var_8_0
		pg = var_5

		var_8_0(var_5.child_plan[var_8_1], "no exist next plan id" .. var_8_1)

		pg = var_8_0
		var_8_0 = var_8_0.child_plan[var_8_1].pre[2]
		getProxy = var_5
		EducateProxy = var_6

		local var_8_2 = var_5(var_6)
		local var_8_3 = var_5.GetPlanProxy(var_8_2)
		local var_8_4 = var_5.GetHistoryCntById(var_8_3, arg_8_1.id) / var_8_0

		setSlider = var_7

		var_7(arg_8_0.sliderTF, 0, 1, var_8_4)

		setText = var_7

		var_7(arg_8_0.progressTF, var_8_4 >= 1 and "MAX" or var_5 .. "/" .. var_8_0)
	end

	setScrollText = var_8_0

	var_8_0(arg_8_0.nameTextTF, arg_8_1:getConfig("name"))

	setLocalPosition = var_8_0
	...
	var_8_0(var_8_5, var_8_6)

	local var_8_7 = arg_8_1
	local var_8_8 = not arg_8_1.IsMatchAttr(var_8_7, arg_8_0.char)

	setActive = var_8_7

	var_8_7(arg_8_0.limitTF, var_8_8)

	local var_8_9 = arg_8_1:getConfig("ability")

	arg_8_0.limitCfg = {}

	for iter_8_0 = 1, #var_8_9 do
		Clone = var_1_10010
		var_1_10010 = var_1_10010(var_8_9[iter_8_0])
		var_1_10012 = arg_8_0.char
		var_1_10011 = var_1_10011.GetAttrById(var_1_10012, var_1_10010[2])
		var_1_10011 = var_1_10010[3] <= var_1_10011
		table = var_1_10012

		var_1_10012.insert(var_1_10010, var_1_10011)

		table = var_1_10012

		var_1_10012.insert(arg_8_0.limitCfg, var_1_10010)
	end

	table = var_6

	local var_8_10 = var_6.sort
	local var_8_11 = arg_8_0.limitCfg

	CompareFuncs = var_8

	var_8_10(var_8_11, var_8({
		function(arg_9_0)
			return arg_9_0[4] and 1 or 0
		end
	}))

	local var_8_12 = arg_8_0.limitUIList

	var_6.align(var_8_12, #arg_8_0.limitCfg)

	arg_8_0.costCfg = {}

	local var_8_13, var_8_14 = arg_8_1:GetCost()

	if 0 < var_8_13 then
		table = var_8

		local var_8_15 = var_8.insert
		local var_8_16 = arg_8_0.costCfg
		local var_8_17 = {}

		EducateChar = var_1_10011
		var_8_17.id = var_1_10011.RES_MONEY_ID
		var_8_17.num = var_8_13

		var_8_15(var_8_16, var_8_17)
	end
	...
	if 0 < var_8_14 then
		table = var_8_18
		var_8_18 = var_8_18.insert

		local var_8_19 = arg_8_0.costCfg
		local var_8_20 = {}

		EducateChar = var_1_10011
		var_8_20.id = var_1_10011.RES_MOOD_ID
		var_8_20.num = var_8_14

		var_8_18(var_8_19, var_8_20)
	end

	setActive = var_8_18

	var_8_18(arg_8_0.costTF, not var_8_8)

	setActive = var_8_18

	var_8_18(arg_8_0.costEmptyTF, not var_8_8 and #arg_8_0.costCfg == 0)

	local var_8_21 = arg_8_0.costUIList

	var_8.align(var_8_21, #arg_8_0.costCfg)

	arg_8_0.awardCfg = arg_8_1:GetResult()

	arg_8_0:setAwardParam(var_0_1)

	local var_8_22 = arg_8_0.awardUIList

	var_8.align(var_8_22, #arg_8_0.awardCfg > 2 and 2 or #arg_8_0.awardCfg)
	...
	local var_8_24 = arg_8_0.unfoldBtn
	...
	var_8(var_8_23, var_8_24, var_8_25, var_1_10012)

	onButton = var_8

	local var_8_26 = arg_8_0
	local var_8_27 = arg_8_0.foldBtn
	...
	local function var_8_28()
		...
		var_0(arg_8_0.limitTF, var_8_8)

		setActive = var_0

		var_0(arg_8_0.costTF, not var_8_8)

		setActive = var_0

		var_0(arg_8_0.costEmptyTF, not var_8_8 and #arg_8_0.costCfg == 0)
	...
	var_8(var_8_26, var_8_27, var_8_28, var_1_10012)

	onButton = var_8

	local var_8_29 = arg_8_0
	...
	var_8(var_8_29, var_8_30, var_8_31, var_1_10012)
