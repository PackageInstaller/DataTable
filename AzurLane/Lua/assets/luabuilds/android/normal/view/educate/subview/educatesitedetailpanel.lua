...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_15 = var_2.Find(var_2_14, "limit/Text")

	i18n = var_2_14

	var_1(var_2_15, var_2_14("child_option_limit"))

	setText = var_1

	local var_2_16 = arg_2_0.optionTpl
	local var_2_17 = var_2.Find(var_2_16, "type_2/awards/polaroid/Text")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("child_random_polaroid_drop"))
...
function var_0_1.checkSpecEvent(arg_8_0, arg_8_1, arg_8_2)
	...
	if #var_3.GetSiteSpecEvents(var_8_1, arg_8_1) > 0 then
		...
		EducateMapMediator = var_1_10006

		var_8_3(var_8_2, var_1_10006.ON_SPECIAL_EVENT_TRIGGER, {
			siteId = arg_8_1,
			id = var_3[1].id,
			callback = arg_8_2
		})
...
function var_0_1.showSpecEvent(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	local var_9_2 = var_7.GetCommonShowDrops(arg_9_3)
	...
	local function var_9_3()
		...
		if #var_9_2 > 0 then
			...
			var_10_1(var_10_0, var_2_10002.EDUCATE_ON_AWARD, {
				items = var_9_2,
				removeFunc = function()
...
function var_0_1.addTaskProgress(arg_14_0)
	...
	if #var_14_3 > 0 then
		...
		EducateMapMediator = var_14_8
		var_14_8 = var_14_8.ON_ADD_TASK_PROGRESS

		local var_14_9 = {}

		EducateTask = iter_14_1
		var_14_9.system = iter_14_1.SYSTEM_TYPE_MIND
		var_14_9.progresses = var_14_3
	...
	if #var_14_4 > 0 then
		...
		EducateTask = iter_14_1
		var_14_12.system = iter_14_1.SYSTEM_TYPE_TARGET
		var_14_12.progresses = var_14_4

		var_14_11(var_14_10, var_14_8, var_14_12)
	end

	if #var_14_5 > 0 then
		local var_14_13 = arg_14_0
		local var_14_14 = arg_14_0.emit

		EducateMapMediator = var_14_8

		local var_14_15 = var_14_8.ON_ADD_TASK_PROGRESS
		local var_14_16 = {}

		EducateTask = iter_14_1
		var_14_16.system = iter_14_1.STSTEM_TYPE_MAIN
		var_14_16.progresses = var_14_5
...
local function var_0_2(arg_15_0, arg_15_1, arg_15_2)
	if arg_15_1[2] == -1 then
		...
		local var_15_1 = "res_-1"

		findTF = var_1_10006

		var_3(var_15_0, var_15_1, var_1_10006(arg_15_0, "Image"), true)

		setText = var_3
		findTF = var_15_0

		local var_15_2 = var_15_0(arg_15_0, "Text")

		i18n = var_5

		var_3(var_15_2, var_5("child_random_ops_drop"))
	else
		local var_15_3 = ""
		local var_15_4 = ""
		local var_15_5 = arg_15_1[1]

		EducateConst = var_1_10006

		if var_15_5 == var_1_10006.DROP_TYPE_ATTR then
			var_15_3 = "attr_"
			pg = var_15_5
			var_15_4 = var_15_5.child_attr[arg_15_1[2]].name
		else
			var_15_5 = arg_15_1[1]
			EducateConst = var_6

			if var_15_5 == var_6.DROP_TYPE_RES then
				var_15_3 = "res_"
				pg = var_15_5
				var_15_4 = var_15_5.child_resource[arg_15_1[2]].name
			end
		end

		LoadImageSpriteAtlasAsync = var_15_5

		local var_15_6 = "ui/educatecommonui_atlas"
		local var_15_7 = var_15_3 .. arg_15_1[2]

		findTF = var_8

		var_15_5(var_15_6, var_15_7, var_8(arg_15_0, "Image"), true)

		setText = var_15_5
		findTF = var_15_6

		var_15_5(var_15_6(arg_15_0, "Text"), var_15_4 .. "+" .. arg_15_1[3])
	end
...
local function var_0_3(arg_16_0, arg_16_1)
	...
	var_16_1(var_16_2, var_16_3, var_6(arg_16_0, "Image"), true)
...
function var_0_1.updateOptionItem(arg_17_0, arg_17_1, arg_17_2)
	...
	var_4(arg_17_2:Find("limit"), var_17_1:IsShowLimit())

	local var_17_2 = var_17_1:GetType()

	for iter_17_0 = 1, 3 do
		setActive = var_1_10009

		var_1_10009(arg_17_2:Find("type_" .. iter_17_0), iter_17_0 == var_17_2)
	end

	local var_17_3 = arg_17_2:Find("type_" .. var_17_2)
	local var_17_4 = var_17_1
	local var_17_5

	if not var_17_1.IsCountLimit(var_17_4) then
		var_17_5 = true
	else
		var_17_4 = var_17_1
		var_17_5 = var_17_1.CanTrigger(var_17_4)
	end

	setGray = var_17_4

	var_17_4(arg_17_2, not var_17_5)
	...
	EducateSiteOption = var_1_10010
	var_17_7[var_1_10010.TYPE_SHOP] = function()
		setText = var_2_10000

		local var_18_0 = var_17_3
		local var_18_1 = var_1.Find(var_18_0, "name/Text")
		local var_18_2 = var_17_1

		var_2_10000(var_18_1, var_2.getConfig(var_18_2, "name"))
		...
		local function var_18_5()
			...
			EducateMapMediator = var_3_10002

			local var_19_2 = var_3_10002.ON_OPEN_SHOP
			local var_19_3 = var_17_1

			var_19_1(var_19_0, var_19_2, var_3.GetLinkId(var_19_3))
		...
		var_2_10000(var_18_3, var_18_4, var_18_5, var_4)

		return
	end
	EducateSiteOption = var_10
	var_17_7[var_10.TYPE_EVENT] = function()
		setText = var_2_10000

		local var_20_0 = var_17_3
		local var_20_1 = var_1.Find(var_20_0, "name")

		shortenString = var_20_0

		local var_20_2 = var_17_1
		local var_20_3 = var_3.getConfig(var_20_2, "name")
		local var_20_4 = var_17_1

		var_2_10000(var_20_1, var_20_0(var_20_3 .. var_4.GetCntText(var_20_4), 12))
		...
		local var_20_7 = var_17_3

		var_20_5(var_2.Find(var_20_7, "awards/polaroid"), var_20_6)
		...
		local var_20_12 = var_17_3
		local var_20_13 = var_4.Find(var_20_12, "awards/normal")
		local var_20_14 = var_17_3
		local var_20_15 = var_20_11(var_20_13, var_5.Find(var_20_14, "awards/normal/tpl"))
		...
		UIItemList = var_20_17

		local var_20_19 = var_20_17.New
		local var_20_20 = var_17_3
		local var_20_21 = var_7.Find(var_20_20, "costs")
		local var_20_22 = var_17_3
		local var_20_23 = var_20_19(var_20_21, var_8.Find(var_20_22, "costs/tpl"))
		...
		local function var_20_26()
			...
			var_23_1(var_23_0, var_3_10002.ON_MAP_SITE_OPERATE, {
		...
		var_7(var_20_24, var_20_25, var_20_26, var_2_10011)

		return
	end
	EducateSiteOption = var_10
	var_17_7[var_10.TYPE_SITE] = function()
		setText = var_2_10000

		local var_24_0 = var_17_3
		local var_24_1 = var_1.Find(var_24_0, "name/Text")
		local var_24_2 = var_17_1

		var_2_10000(var_24_1, var_2.getConfig(var_24_2, "name"))
		...
		local function var_24_5()
			...
			var_25_0(var_3_10002.child_site[var_25_1], "child_site不存在id:" .. var_25_1)

			table = var_25_0

			var_25_0.insert(arg_17_0.siteQueue, var_25_1)
		...
		var_2_10000(var_24_3, var_24_4, var_24_5, var_4)

		return
	end

	var_17_4(var_17_6, var_17_7)
...
function var_0_1.showSitePerform(arg_27_0, arg_27_1, arg_27_2, arg_27_3, arg_27_4, arg_27_5)
	...
	local var_27_1 = var_7.GetDialogueShowDrops(arg_27_5)
	...
	local var_27_3 = var_1_10009.GetCommonShowDrops(arg_27_4)

	EducateHelper = var_10

	local var_27_4 = var_27_2(var_27_3, var_10.GetCommonShowDrops(arg_27_5))
	local var_27_5 = {}

	pg = var_10

	local var_27_6 = var_10.child_site_option_branch[arg_27_2].performance
	...
	var_1_10012.insert(var_27_5, function(arg_28_0)
		pg = var_2_10001
	...
	var_12(var_27_5, function()
		...
		if #var_27_4 > 0 then
			...
			var_30_1(var_30_0, var_2.EDUCATE_ON_AWARD, {
				items = var_27_4
			})
		end
