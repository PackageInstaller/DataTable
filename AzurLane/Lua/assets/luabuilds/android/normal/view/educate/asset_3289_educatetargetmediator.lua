...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.EDUCATE_SUBMIT_TASK, {
			id = arg_2_1.id,
	...
	arg_1_0:bind(var_0_1.ON_GET_TARGET_AWARD, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.EDUCATE_GET_TARGET_AWARD)
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 ~= var_5_1.EDUCATE_SUBMIT_TASK_DONE then
		GAME = var_4

		if var_5_0 == var_4.EDUCATE_GET_TARGET_AWARD_DONE then
			local var_5_3 = arg_5_0.viewComponent
			local var_5_4 = var_4.emit

			EducateBaseUI = var_1_10006

			var_5_4(var_5_3, var_1_10006.EDUCATE_ON_AWARD, {
