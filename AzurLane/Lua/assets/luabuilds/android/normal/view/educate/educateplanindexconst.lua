...
bit = var_1
var_0_0.TypeScholl = var_1.lshift(1, 0)
bit = var_1
...
function var_0_0.filterByType(arg_1_0, arg_1_1)
	...
	for iter_1_0 = 2, #var_0_0.CONFIG.type do
		...
		local var_1_0 = var_7.band(var_1_10006, arg_1_1)
		...
		if 0 < var_1_0 then
			...
			if var_8.contains(var_1_1, arg_1_0:GetType()) then
				return true
			end
		end
	end
...
function var_0_0.filterByCost(arg_2_0, arg_2_1)
	...
	for iter_2_0 = 2, #var_0_0.CONFIG.cost do
		...
		local var_2_0 = var_7.band(var_1_10006, arg_2_1)
		...
		if 0 < var_2_0 then
			...
			for iter_2_1, iter_2_2 in var_8(var_2_1) do
...
function var_0_0.filterByAward(arg_7_0, arg_7_1, arg_7_2)
	for iter_7_0 = 2, #var_0_0.CONFIG[arg_7_2] do
		...
		local var_7_0 = var_8.band(var_1_10007, arg_7_1)
		...
		if 0 < var_7_0 then
			...
			for iter_7_1, iter_7_2 in var_9(var_7_1.ids) do
...
EducatePlan = var_0_10005
var_0_14[1] = var_0_10005.TYPE_SCHOOL
