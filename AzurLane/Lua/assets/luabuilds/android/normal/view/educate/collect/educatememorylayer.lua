...
function var_0_1.didEnter(arg_3_0)
	...
	var_1_10001(var_3_1, var_3_0("child_buy_memory_tip"))
...
function var_0_1.updateItem(arg_6_0, arg_6_1, arg_6_2)
	...
	if var_6_1 then
		...
		local var_6_3 = arg_6_2.Find(var_6_2, "unlock/new")

		EducateTipHelper = var_6_2

		local var_6_4 = var_6_2.IsShowNewTip

		EducateTipHelper = var_8

		var_5(var_6_3, var_6_4(var_8.NEW_MEMORY, arg_6_1.id))
		...
		var_5(var_6_5, var_6_6, var_6_7, var_9)
	else
		...
		local var_6_9 = arg_6_2.Find(var_6_8, "lock/unlock_btn")

		setActive = var_6_8

		var_6_8(var_6_9, arg_6_0.gameCnt > 1)
		...
		var_6_8(var_6_10, var_6_11, var_6_12, var_1_10010)
	end
...
function var_0_1.showPerformWindow(arg_9_0, arg_9_1)
	...
	var_9_0(var_1_10003.NEW_MEMORY, arg_9_1.id)

	local var_9_1 = arg_9_0.performTF
	local var_9_2 = var_2.Find(var_9_1, "Image")

	LoadImageSpriteAsync = var_9_1

	var_9_1("bg/" .. arg_9_1.pic, var_9_2)

	setActive = var_9_1

	var_9_1(arg_9_0.performTF, true)
	...
	var_9_1(var_9_3, var_9_4, var_9_5, var_1_10007)

	onButton = var_9_1

	local var_9_6 = arg_9_0
	local var_9_7 = arg_9_0.performTF
	local var_9_8 = var_5.Find(var_9_7, "review_btn")
	...
	var_9_1(var_9_6, var_9_8, var_9_9, var_7)
...
function var_0_1.OnClickBuyBtn(arg_12_0, arg_12_1)
	...
	local var_12_4 = var_6.EDUCATE_ON_MSG_TIP
	local var_12_5 = {}

	i18n = var_1_10008
	var_12_5.content = var_1_10008("child_cg_buy", var_12_1, var_12_0)
	...
	function var_12_5.onYes()
		...
		local var_13_2 = var_2_10002.UNLOCK
		local var_13_3 = {}

		EducateBuyCollectCommand = var_2_10004
		var_13_3.type = var_2_10004.TYPE.MEMORY
