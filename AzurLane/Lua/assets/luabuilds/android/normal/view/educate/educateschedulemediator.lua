...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.GET_PLANS, function(arg_2_0, arg_2_1)
		...
		local var_2_2 = var_2_10004.EDUCATE_GET_PLANS
		local var_2_3 = {}

		EducatePlanProxy = var_2_10006
		var_2_3.plans = var_2_10006.GridData2ProtData(arg_2_1.gridData)
	...
	arg_1_0:bind(var_0_1.OPEN_FILTER_LAYER, function(arg_4_0, arg_4_1)
		...
		EducateScheduleFilterLayer = var_2_10006
		var_4_3.viewComponent = var_2_10006
		EducateScheduleFilterMediator = var_2_10006
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.EDUCATE_REFRESH_DONE then
		local var_6_3 = arg_6_0.viewComponent
		local var_6_4 = var_4.emit

		EducateBaseUI = var_1_10006

		local var_6_5 = var_1_10006.EDUCATE_CHANGE_SCENE

		SCENE = var_1_10007

		var_6_4(var_6_3, var_6_5, var_1_10007.EDUCATE)
	end
