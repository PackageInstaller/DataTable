...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_1 = var_5(arg_1_1, "main/list")

	findTF = var_6
	arg_1_0.uiItemList = var_1_0(var_1_1, var_6(arg_1_1, "main/list/tpl"))
	UIItemList = var_4
	...
	findTF = var_6
	arg_1_0.tabItemList = var_1_2(var_1_3, var_6(arg_1_1, "tab/list/tpl"))
	findTF = var_4
	...
	typeof = var_6
	Animation = var_7
	arg_1_0.animation = var_1_5(var_1_4, var_6(var_7))
	...
	typeof = var_6
	DftAniEvent = var_7
	arg_1_0.dftAniEvent = var_1_7(var_1_6, var_6(var_7))
	arg_1_0.timers = {}
...
function var_0_1.RegisterEvent(arg_2_0)
	...
	local function var_2_2()
		...
		EducateCharDockMediator = var_2_10002

		var_3_1(var_3_0, var_2_10002.GO_PROFILE, arg_2_0.selectedCharacterId)
...
function var_0_1.CheckChangeFormShop(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1_10004(arg_11_0.characterList) do
		if iter_11_1.id == var_11_1 then
			...
			EducateCharDockScene = var_1_10012

			var_11_5(var_11_4, var_1_10012.ON_SELECT, var_11_3, arg_11_0.selectedId)
			...
			if arg_13_0 == var_5.EventInit then
				...
				var_5(arg_12_0, arg_13_2, function()
					...
					if var_0.IsLock(var_14_0) then
						...
						var_14_2(var_14_1, var_3_10002("secretary_special_character_unlock"))
...
function var_0_1.InitList(arg_15_0)
	...
	var_15_0.sort(var_15_1, function(arg_16_0, arg_16_1)
...
function var_0_1.InitCard(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	local var_19_2 = arg_19_2.IsSp(var_19_1)

	setActive = var_19_1

	var_19_1(var_19_0:Find("bg"), not var_19_2)

	setActive = var_19_1

	var_19_1(var_19_0:Find("sp_bg"), var_19_2)

	setActive = var_19_1

	var_19_1(var_19_0:Find("mask"), not var_19_2)

	setActive = var_19_1

	var_19_1(var_19_0:Find("sp_mask"), var_19_2)

	setActive = var_19_1

	var_19_1(var_19_0:Find("sp"), var_19_2)

	setActive = var_19_1

	var_19_1(var_19_0:Find("label"), not var_19_2)

	setActive = var_19_1

	var_19_1(var_19_0:Find("sp_label"), var_19_2)

	local var_19_3 = arg_19_2
	local var_19_4 = arg_19_2.GetShowPainting(var_19_3)

	if var_19_2 then
		setPaintingPrefabAsync = var_19_3

		var_19_3(var_19_0:Find("sp_mask/painting"), var_19_4, "tb2")
	else
		local var_19_5 = var_19_0:Find("label/Text")

		var_19_3 = var_19_3.GetComponent
		typeof = var_9
		Image = var_1_10010
		var_19_3 = var_19_3(var_19_5, var_9(var_1_10010))
		GetSpriteFromAtlas = var_19_5

		local var_19_6 = "ui/EducateDockUI_atlas"

		var_1_10011 = arg_19_2
		var_19_3.sprite = var_19_5(var_19_6, arg_19_2.GetSpriteName(var_1_10011))

		var_19_3:SetNativeSize()

		setPaintingPrefabAsync = var_8

		var_8(var_19_0:Find("mask/painting"), var_19_4, "tb2")
	end
	...
	local function var_19_9()
		...
		if var_0.IsLock(var_20_0) then
			...
			if var_0.secretary_special_ship[arg_19_2.id].unlock_type == 4 then
				...
				if var_2_10002.ship_skin_template[var_20_1].shop_id ~= 0 then
					Goods = var_2_10003
					...
					Goods = var_2_10005
					var_2_10005 = var_2_10003(var_20_2, var_2_10005.TYPE_SKIN)

					if var_2_10003.inTime(var_2_10005) then
						local var_20_3 = {}

						PLATFORM_CODE = var_2_10005
						PLATFORM_JP = var_2_10006

						if var_2_10005 ~= var_2_10006 then
							table = var_2_10005

							var_2_10005.insert(var_20_3, function(arg_21_0)
								pg = var_3_10001
								...
								i18n = var_3_10004
								var_21_2.content = var_3_10004("child2_secretary_skin_confirm")
						...
						var_2_10005(var_20_3, function()
							local var_22_0 = arg_19_0
							local var_22_1 = var_0.emit

							EducateCharDockMediator = var_3_10002

							var_22_1(var_22_0, var_3_10002.ON_SKIN_SHOP, var_20_1)
				...
				local var_20_4 = var_2_10003.TipsMgr.GetInstance()

				var_2_10003 = var_2_10003.ShowTips
				i18n = var_2_10005

				var_2_10003(var_20_4, var_2_10005("child2_secretary_skin_expire"))
			...
			var_20_6(var_20_5, var_2_10003("secretary_special_lock_tip"))
		...
		var_0.SetEndEvent(var_20_7, function(arg_23_0)
			...
			EducateCharDockScene = var_3

			var_23_2(var_23_1, var_3.ON_SELECT, arg_19_2, arg_19_0.selectedId)
	...
	var_19_3(var_19_7, var_19_8, var_19_9, var_1_10011)

	setActive = var_19_3

	var_19_3(var_19_0, false)

	local var_19_10 = arg_19_0.timers

	Timer = var_8

	local var_19_11 = var_8.New

	local function var_19_12()
		setActive = var_2_10000

		var_2_10000(var_19_0, true)

		local var_24_0 = var_19_0
		local var_24_1 = var_0.GetComponent

		typeof = var_2
		Animation = var_2_10003

		local var_24_2 = var_24_1(var_24_0, var_2(var_2_10003))
...
function var_0_1.UpdateCard(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_1 = arg_25_1.Find(var_25_0, "anim_root")

	setActive = var_25_0

	var_25_0(var_25_1:Find("lock"), arg_25_2:IsLock())

	setActive = var_25_0

	var_25_0(var_25_1:Find("mark"), arg_25_2:IsSelected(arg_25_0.selectedId))

	setScrollText = var_25_0

	var_25_0(var_25_1:Find("lock/desc/Text"), arg_25_2:GetUnlockDesc())

	setActive = var_25_0

	var_25_0(var_25_1:Find("tip"), arg_25_2:ShouldTip())
...
function var_0_1.Destroy(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_1_10001(var_27_0) do
		...
		if not iter_27_1:IsSp() or not iter_27_0:Find("sp_mask/painting") then
			var_27_1 = iter_27_0:Find("mask/painting")
		end

		local var_27_2 = iter_27_1
		local var_27_3 = iter_27_1.GetShowPainting(var_27_2)

		retPaintingPrefab = var_27_2

		var_27_2(var_27_1, var_27_3)
	end
