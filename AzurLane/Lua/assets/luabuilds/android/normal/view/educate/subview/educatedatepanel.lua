...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_2_5, var_2_4("child_date_text1"))
	...
	var_1(var_2_8, var_2_7("child_date_text2"))
	...
	var_1(var_2_11, var_2_10("child_date_text3"))
	...
	var_1(var_2_14, var_2_13("child_date_text4"))
	...
	local function var_2_18()
		...
		local var_3_2 = var_2_10002.EDUCATE_GO_SUBLAYER
		...
		EducateNewsMediator = var_2_10005
		var_3_4.mediator = var_2_10005
		EducateNewsLayer = var_2_10005
	...
	local var_2_21 = var_3.Find(var_2_20, "content/back")
	...
	local function var_2_22()
		if arg_2_0.contextData and arg_2_0.contextData.isMain then
			...
			EducateBaseUI = var_2_10002
			var_2_10002 = var_2_10002.EDUCATE_GO_SCENE
			SCENE = var_2_10003

			var_4_1(var_4_0, var_2_10002, var_2_10003.NEW_EDUCATE_SELECT, {
				isTb1 = true
			})
		else
			...
			var_4_3(var_4_2, var_2_10002.ON_BACK)
		end
...
function var_0_1.Flush(arg_5_0)
	...
	EducateConst = var_5_4

	var_1(var_5_5, var_5_6 == var_5_4.STATUES_RESET)
	...
	var_5_7(arg_5_0.timeTF, var_5_8)
	...
	if var_5_8 then
		...
		local var_5_10 = var_3.GetShowMonthNumber(var_5_9)

		i18n = var_1_10005

		local var_5_11 = var_1_10005("word_month")

		i18n = var_6

		local var_5_12 = var_5_10 .. var_5_11 .. var_6("word_which_week", arg_5_0.curTime.week)
		...
		var_5_11(var_5_13, var_7.GetWeekStrByNumber(arg_5_0.curTime.day))
	end
...
function var_0_1.UpdateWeekDay(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_6_0(var_1_10004)
	local var_6_3 = var_6_1(var_3.GetCurTime(var_6_2), 1)

	EducateHelper = var_3

	local var_6_4 = var_3.GetShowMonthNumber(var_6_3.month)

	i18n = var_1_10005

	local var_6_5 = var_1_10005("word_month")

	i18n = var_6

	local var_6_6 = var_6_4 .. var_6_5 .. var_6("word_which_week", var_6_3.week)
	...
	var_6_5(var_6_7, var_7.GetWeekStrByNumber(arg_6_1))
