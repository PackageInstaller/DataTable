...
function var_0_1.init(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.chatTxt = var_2_6(var_2_5, var_3(var_1_10004))
	UIItemList = var_1

	local var_2_7 = var_1.New
	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_2.Find(var_2_8, "main/tag")
	local var_2_10 = arg_2_0._tf

	arg_2_0.toggleUIItemList = var_2_7(var_2_9, var_3.Find(var_2_10, "main/tag/tpl"))
	UIItemList = var_1

	local var_2_11 = var_1.New
	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_2.Find(var_2_12, "main/list/content")
	local var_2_14 = arg_2_0._tf

	arg_2_0.wordUIItemList = var_2_11(var_2_13, var_3.Find(var_2_14, "main/list/content/tpl"))
	UIItemList = var_1

	local var_2_15 = var_1.New
	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_2.Find(var_2_16, "tab/list")
	local var_2_18 = arg_2_0._tf

	arg_2_0.tabItemList = var_2_15(var_2_17, var_3.Find(var_2_18, "tab/list/tpl"))
	...
	typeof = var_3
	Animation = var_2_18
	arg_2_0.animation = var_2_20(var_2_19, var_3(var_2_18))
	arg_2_0.timers = {}
			...
			if arg_7_0 == var_5.EventInit then
				...
				var_5(arg_6_0, arg_7_2, function()
					...
					if var_0.IsLock(var_8_0) then
						...
						var_8_2(var_8_1, var_3_10002("secretary_special_character_unlock"))
...
function var_0_1.InitToggles(arg_9_0)
	...
	var_9_0.sort(var_9_1, function(arg_10_0, arg_10_1)
...
function var_0_1.UpdateToggle(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = arg_12_1.Find(var_12_0, "sel/Text")

	GetSpriteFromAtlas = var_12_0

	var_1_10003(var_12_1, var_12_0("ui/EducateCharProfileUI_atlas", arg_12_2:GetSpriteName()), true)

	setImageSprite = var_1_10003

	local var_12_2 = arg_12_1
	local var_12_3 = arg_12_1.Find(var_12_2, "Text")

	GetSpriteFromAtlas = var_12_2

	var_1_10003(var_12_3, var_12_2("ui/EducateCharProfileUI_atlas", arg_12_2:GetSpriteName()), true)

	setActive = var_1_10003

	var_1_10003(arg_12_1:Find("lock"), arg_12_2:IsLock())
	...
	var_1_10003(var_12_4, var_12_5, var_12_6, var_7)
...
function var_0_1.GetWordList(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in var_1_10003(var_1_10004.character_voice_special.all) do
		...
		if var_1_10009(var_14_2, var_1_10011.WORD_TYPE_MAIN) then
			string = var_1_10009
			...
			ShipWordHelper = var_1_10011
			var_1_10009 = var_1_10009(var_14_3, var_1_10011.WORD_TYPE_MAIN, "")
			ShipWordHelper = var_14_3
			var_14_1 = var_14_3.WORD_TYPE_MAIN .. "_" .. var_1_10009
		end
...
function var_0_1.InitWordList(arg_15_0, arg_15_1)
	...
	local var_15_1 = arg_15_0.GetWordList(var_15_0, arg_15_1)

	pg = var_15_0

	local var_15_2 = var_15_0.secretary_special_ship[arg_15_1]
	...
	var_4.make(var_15_3, function(arg_16_0, arg_16_1, arg_16_2)
		...
		if arg_16_0 == var_2_10003.EventUpdate then
			...
			var_3.UpdateWordCard(var_16_0, arg_16_2, arg_15_1, var_15_1[arg_16_1 + 1], arg_16_1)
		end

		return
	end)

	local var_15_4 = arg_15_0.wordUIItemList

	var_4.align(var_15_4, #var_15_1)
...
function var_0_1.UpdateWordCard(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4)
	...
	local var_17_2 = var_17_0.character_voice_special[arg_17_3]

	setText = var_7

	var_7(var_17_1:Find("Text"), var_17_2.voice_name)
	...
	var_8(var_17_4, var_17_5, var_17_6, var_1_10012)
...
function var_0_1.UpdateExpression(arg_27_0, arg_27_1, arg_27_2)
	...
	if var_1_10003.GetExpression(arg_27_1, arg_27_2) and var_3 ~= "" then
		ShipExpressionHelper = var_27_0
		var_27_0 = var_27_0.UpdateExpression
		findTF = var_5

		local var_27_1 = var_5(arg_27_0.paintingTr, "fitter")

		var_27_0(var_5.GetChild(var_27_1, 0), arg_27_0.paintingName, var_3)
	else
		ShipExpressionHelper = var_27_0

		local var_27_2 = var_27_0.UpdateExpression

		findTF = var_5

		local var_27_3 = var_5(arg_27_0.paintingTr, "fitter")

		var_27_2(var_5.GetChild(var_27_3, 0), arg_27_0.paintingName, "")
	end
...
function var_0_1.StartCharAnimation(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_3 = var_1_10006(arg_30_0.chatTf.gameObject)

	Vector3 = var_7

	local var_30_4 = var_30_2(var_30_3, var_7.New(1, 1, 1), var_30_0)
	local var_30_5 = var_5.setEase

	LeanTweenType = var_7

	local var_30_6 = var_30_5(var_30_4, var_7.easeOutBack)
	local var_30_7 = var_5.setOnComplete

	System = var_7

	var_30_7(var_30_6, var_7.Action(function()
		...
		local var_31_1 = var_2_10001(arg_30_0.chatTf.gameObject)

		Vector3 = var_2

		local var_31_2 = var_31_0(var_31_1, var_2.New(0, 0, 1), var_30_0)
		local var_31_3 = var_0.setEase

		LeanTweenType = var_2

		local var_31_4 = var_31_3(var_31_2, var_2.easeInBack)
		local var_31_5 = var_0.setDelay(var_31_4, var_30_0 + var_30_1)
		local var_31_6 = var_0.setOnComplete

		System = var_2

		var_31_6(var_31_5, var_2.Action(arg_30_2))
...
function var_0_1.InitPainting(arg_32_0, arg_32_1)
	...
	arg_32_0.ReturnPainting(var_32_0)

	pg = var_2

	local var_32_1 = var_2.secretary_special_ship[arg_32_1]

	setPaintingPrefabAsync = var_32_0

	var_32_0(arg_32_0.paintingTr, var_32_1.painting, "tb3")

	arg_32_0.paintingName = var_32_1.painting
...
function var_0_1.ClearCurrentWord(arg_34_0)
	...
	Vector3 = var_2
	var_34_0.localScale = var_2.zero
