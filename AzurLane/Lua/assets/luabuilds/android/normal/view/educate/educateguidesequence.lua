	...
	EducateScene = {
		{
			...
			condition = function()
				...
				return var_1_2(var_1_1, var_1_10002.MAIN_TASK_ID_1)
			end,
			args = function()
				return {}
			end,
		...
		},
		{
			...
			condition = function()
				...
				return var_19_0(var_1_10001.SYSTEM_FAVOR_AND_MIND)
			end,
			args = function()
				return {}
			end
		},
		{
			...
			condition = function()
				...
				if var_0.GetCurTime(var_21_0).month == 3 and var_0.week == 4 then
					...
					local var_21_1 = var_1(var_1_10002)
					local var_21_2
		...
		},
		{
			...
			condition = function()
				...
				local var_23_5 = var_23_3(var_1_10004)
				local var_23_6 = var_3.GetCurTime(var_23_5)

				EducateHelper = var_23_5

				local var_23_7

				if var_23_5.IsSameDay(var_23_6, var_23_4[2]) then
					pg = var_23_7
		...
		},
		{
			...
			condition = function()
				...
				local var_25_2 = var_25_0(var_1_10002)
		...
		},
		{
			...
			condition = function()
				...
				local var_31_5 = var_31_3(var_1_10004)
				local var_31_6 = var_3.GetCurTime(var_31_5)

				EducateHelper = var_31_5

				local var_31_7

				if var_31_5.IsSameDay(var_31_6, var_31_4[3]) then
					pg = var_31_7
		...
		},
		{
			...
			condition = function()
				...
				local var_35_5 = var_35_3(var_1_10004)
				local var_35_6 = var_3.GetCurTime(var_35_5)

				EducateHelper = var_35_5

				local var_35_7

				if var_35_5.IsSameDay(var_35_6, var_35_4[4]) then
					pg = var_35_7
		...
		},
		{
			...
			condition = function()
				...
				local var_39_0 = var_1_10000(var_1_10001)
				local var_39_1 = var_0.GetGameStatus(var_39_0)

				EducateConst = var_39_0

				return var_39_1 == var_39_0.STATUES_RESET
			end,
			args = function()
				return {}
			end
	...
	EducateTargetLayer = {
		{
			...
			condition = function()
				...
				if var_0.IsPlayed(var_41_0, "tb_2") then
					...
					EducateConst = var_2
					var_41_3 = var_41_3(var_41_2, var_2.MAIN_TASK_ID_2)
				end
	...
	EducateCollectEntranceLayer = {
		{
			...
			condition = function()
				...
				return var_43_0(var_1_10001.SYSTEM_MEMORY)
			end,
			args = function()
				return {}
			end
...
function var_0_0.CheckGuide(arg_45_0, arg_45_1)
	...
	if not var_45_0.detect(var_45_1, function(arg_46_0)
	...
	var_45_7(var_45_6, var_1_10009.STORY_UPDATE, {
		storyId = var_45_2
	})
...
function var_0_0.PlayNextOne(arg_48_0, arg_48_1)
	...
	var_48_2(var_48_1, var_4.STORY_UPDATE, {
		storyId = arg_48_0
	})
