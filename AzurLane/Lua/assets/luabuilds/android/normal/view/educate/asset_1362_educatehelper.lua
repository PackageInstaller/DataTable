...
function var_0_0.GetItemAddDrops(arg_1_0)
	...
	var_1_10003.each(var_1_0, function(arg_2_0)
		...
		if var_2_0 ~= var_2_10003.DROP_TYPE_ATTR then
			local var_2_1 = arg_2_0[1]

			EducateConst = var_3

			if var_2_1 ~= var_3.DROP_TYPE_RES then
				var_2_2 = false
...
function var_0_0.UpdateDropsData(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10002(arg_3_0) do
		...
		var_3_2[var_1_10010.DROP_TYPE_ATTR] = function()
		...
		EducateConst = var_1_10010
		var_3_2[var_1_10010.DROP_TYPE_RES] = function()
		...
		EducateConst = var_1_10010
		var_3_2[var_1_10010.DROP_TYPE_ITEM] = function()
		...
		EducateConst = var_1_10010
		var_3_2[var_1_10010.DROP_TYPE_MEMORY] = function()
		...
		EducateConst = var_1_10010
		var_3_2[var_1_10010.DROP_TYPE_POLAROID] = function()
		...
		EducateConst = var_1_10010
		var_3_2[var_1_10010.DROP_TYPE_BUFF] = function()
...
function var_0_0.UpdateDropShow(arg_10_0, arg_10_1)
	...
	if var_10_0 ~= var_1_10003.DROP_TYPE_MEMORY then
		...
		if var_10_0 == var_3.DROP_TYPE_POLAROID then
			...
			var_10_2(var_10_1, var_1_10004.format("不支持的掉落展示for Item,请检查配置！type:%d, id:%d", arg_10_1.type, arg_10_1.id))
		...
		var_3(var_10_4, var_5(arg_10_0, "frame/icon"))
		...
		local var_10_5 = var_4(arg_10_0, "name_bg/name")

		shortenString = var_5

		var_3(var_10_5, var_5(var_10_3.name, 5))

		local var_10_6 = arg_10_1.type

		EducateConst = var_10_5

		if var_10_6 == var_10_5.DROP_TYPE_ITEM then
			...
			var_4(var_10_8, var_10_9, var_7(arg_10_0, "frame"))
		end
...
function var_0_0.GetDropConfig(arg_11_0)
	...
	var_11_1[var_1_10004.DROP_TYPE_ATTR] = function()
		pg = var_2_10000
	...
	EducateConst = var_4
	var_11_1[var_4.DROP_TYPE_RES] = function()
		pg = var_2_10000
	...
	EducateConst = var_4
	var_11_1[var_4.DROP_TYPE_ITEM] = function()
		pg = var_2_10000
	...
	EducateConst = var_4
	var_11_1[var_4.DROP_TYPE_MEMORY] = function()
		pg = var_2_10000
	...
	EducateConst = var_4
	var_11_1[var_4.DROP_TYPE_POLAROID] = function()
		pg = var_2_10000
	...
	EducateConst = var_4
	var_11_1[var_4.DROP_TYPE_BUFF] = function()
		pg = var_2_10000
...
function var_0_0.UpdateDropShowForAttr(arg_19_0, arg_19_1)
	...
	if var_19_0 ~= var_1_10003.DROP_TYPE_ATTR then
		...
		if var_19_0 ~= var_3.DROP_TYPE_RES then
			...
			var_19_0(var_19_1, var_1_10004.format("不支持的掉落展示for Attr,请检查配置！type:%d, id:%d", arg_19_1.type, arg_19_1.id))
	...
	var_5(var_1_10006(arg_19_0, "icon"), true)
	...
	var_5(var_19_6, var_19_7, var_8(arg_19_0, "icon"))
	...
	var_5(var_6(arg_19_0, "value"), var_19_4 .. arg_19_1.number)
...
function var_0_0.GetDialogueShowDrops(arg_22_0)
	...
	EducateConst = var_1_10004
	var_22_2[1] = var_1_10004.DROP_TYPE_ATTR
	EducateConst = var_4
	var_22_2[2] = var_4.DROP_TYPE_RES
	EducateConst = var_4
	var_22_2[3] = var_4.DROP_TYPE_BUFF
...
function var_0_0.GetCommonShowDrops(arg_23_0)
	...
	EducateConst = var_1_10004
	var_23_2[1] = var_1_10004.DROP_TYPE_ITEM
	EducateConst = var_4
	var_23_2[2] = var_4.DROP_TYPE_POLAROID
...
function var_0_0.UpdateAvatarShow(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_0 = var_1_10004(arg_24_0, "mask/Image")

	LoadSprite = var_5

	var_1_10003(var_24_0, var_5("squareicon/" .. arg_24_2), true)

	local var_24_1 = 0

	ipairs = var_24_0

	for iter_24_0, iter_24_1 in var_24_0(arg_24_1) do
		findTF = var_1_10009
		var_1_10009 = var_1_10009(arg_24_0, "progress/" .. iter_24_1[1])

		local var_24_2 = iter_24_1[2] - 0.005

		setFillAmount = var_11

		var_11(var_1_10009, var_24_2)

		setLocalEulerAngles = var_11

		local var_24_3 = var_1_10009

		Vector3 = var_13

		var_11(var_24_3, var_13(0, 0, 24 * var_24_1))

		var_24_1 = var_24_1 + var_24_2 + 0.005
	end
...
function var_0_0.IsSystemUnlock(arg_39_0)
	...
	EducateConst = var_39_0

	local var_39_2 = var_39_0.SYSTEM_UNLOCK_CONFIG[arg_39_0]
	...
	local var_39_3 = var_1_10003(var_1_10004)
	local var_39_4 = var_3.GetCurTime(var_39_3)

	pg = var_39_3

	local var_39_5 = var_39_3.gameset[var_39_2[1]].description
...
function var_0_0.IsShowNature()
	...
	local var_40_1, var_40_2 = var_40_0(var_1_10001.gameset.child_charactor_time.description)
	local var_40_3 = var_0_0.InTime

	getProxy = var_1_10003
	EducateProxy = var_1_10004

	local var_40_4 = var_1_10003(var_1_10004)

	return var_40_3(var_3.GetCurTime(var_40_4), var_40_1, var_40_2)
end
...
function var_0_0.IsSiteUnlock(arg_41_0, arg_41_1)
	...
	local var_41_1 = var_1_10003(var_1_10004)
...
function var_0_0.ReqEducateDataCheck(arg_43_0)
	...
	local var_43_1 = var_1_10002(var_1_10003)
	...
	if not var_2.CheckDataRequestEnd(var_43_1) then
		...
		var_2.insert(var_43_0, function(arg_44_0)
			...
			var_44_1(var_44_0, var_2_10003.EDUCATE_REQUEST, {
				callback = arg_44_0
			})
