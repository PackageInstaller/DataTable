...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	if var_2.NeedRequestOptsData(var_2_0) then
		...
		var_2_2(var_2_1, var_1_10004.EDUCATE_REQUEST_OPTION, {
			callback = arg_2_1
		})
	else
		arg_2_1()
...
function var_0_1.findUI(arg_5_0)
	...
	local var_5_3 = var_2.Find(var_5_2, "Text")

	i18n = var_5_2

	var_1(var_5_3, var_5_2("child_btn_home"))
	...
	local var_5_8 = var_2.Find(var_5_7, "limit/Text")

	i18n = var_5_7

	var_1(var_5_8, var_5_7("child_option_limit"))
	...
	arg_5_0.datePanel = var_5_9(var_2.Find(var_5_10, "date"), arg_5_0.event)
	...
	arg_5_0.resPanel = var_5_13(var_2.Find(var_5_14, "res"), arg_5_0.event, {
		showBg = true
	})
	...
	arg_5_0.topPanel = var_5_17(var_2.Find(var_5_18, "top_right"), arg_5_0.event)
	...
	arg_5_0.targetPanel = var_5_21(var_2.Find(var_5_22, "ui/target"), arg_5_0.event)
	...
	arg_5_0.archivePanel = var_5_25(var_2.Find(var_5_26, "ui/archive_panel"), arg_5_0.event)
	...
	arg_5_0.detailPanel = var_5_29(var_2.Find(var_5_30, "ui/detail_panel"), arg_5_0.event, {
		onEnter = function()
...
function var_0_1.addListener(arg_8_0)
	...
	local function var_8_2()
		...
		local var_9_2 = var_2_10002.EDUCATE_CHANGE_SCENE

		SCENE = var_2_10003

		var_9_1(var_9_0, var_9_2, var_2_10003.EDUCATE)
...
function var_0_1.playAnim(arg_13_0)
	...
	var_13_0.insert(var_13_1, function(arg_15_0)
		local var_15_0 = arg_13_0
		local var_15_1 = var_1.managedTween

		LeanTween = var_2_10003

		var_15_1(var_15_0, var_2_10003.delayedCall, function()
			arg_15_0()
	...
	for iter_13_0 = 1, #arg_13_0.siteIdList do
		...
		var_1_10006.insert(var_13_1, function(arg_17_0)
			...
			var_2_10001(var_2.GetChild(var_17_0, iter_13_0 - 1), true)
			...
			var_17_2(var_17_1, var_3.delayedCall, function()
				arg_17_0()
...
function var_0_1.CheckTips(arg_20_0, arg_20_1)
	...
	if #var_1_10003.GetSiteUnlockTipIds() > 0 then
		...
		EducateUnlockTipLayer = var_1_10008
		var_20_4.type = var_1_10008.UNLOCK_TYPE_SITE
		var_20_4.list = var_3
...
function var_0_1.updateSiteItem(arg_21_0, arg_21_1, arg_21_2)
	...
	local var_21_0 = var_4(var_5)
	local var_21_1 = var_4.GetOptionsBySiteId(var_21_0, var_3.id)

	underscore = var_21_0

	local var_21_2 = var_21_0.any(var_21_1, function(arg_22_0)
		return arg_22_0:IsShowLimit()
	end)

	setActive = var_6

	var_6(arg_21_2:Find("limit"), var_21_2)

	setActive = var_6

	local var_21_3 = arg_21_2
	local var_21_4 = arg_21_2.Find(var_21_3, "new")

	EducateTipHelper = var_21_3

	local var_21_5 = var_21_3.IsShowNewTip

	EducateTipHelper = var_9

	var_6(var_21_4, var_21_5(var_9.NEW_SITE, var_3.id))
	...
	var_6(var_21_6, var_21_7, var_21_8, var_10)
...
function var_0_1.willExit(arg_36_0)
	...
	var_36_1(var_36_0, var_36_2, var_4.Find(var_36_3, "ui"))
