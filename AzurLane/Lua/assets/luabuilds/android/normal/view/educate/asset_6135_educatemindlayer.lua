...
function var_0_1.initData(arg_3_0)
	...
	EducateTask = var_1_10003
	arg_3_0.taskVOs = var_3_2(var_3_1, var_1_10003.SYSTEM_TYPE_MIND)
...
function var_0_1.findUI(arg_4_0)
	...
	local var_4_11 = var_2.Find(var_4_10, "Text")

	i18n = var_4_10

	var_1(var_4_11, var_4_10("child_mind_empty_tip"))
	...
	local var_4_16 = var_2.Find(var_4_15, "list")
	local var_4_17 = arg_4_0.finishListTF

	arg_4_0.finishUIList = var_4_14(var_4_16, var_3.Find(var_4_17, "list/tpl"))
	setText = var_1

	local var_4_18 = arg_4_0.finishListTF
	local var_4_19 = var_2.Find(var_4_18, "title/Text")

	i18n = var_4_18

	var_1(var_4_19, var_4_18("child_mind_finish_title"))

	setText = var_1

	local var_4_20 = arg_4_0.finishListTF
	local var_4_21 = var_2.Find(var_4_20, "list/tpl/get_btn/Text")

	i18n = var_4_20

	var_1(var_4_21, var_4_20("word_take"))
	...
	local var_4_25 = var_2.Find(var_4_24, "list")
	local var_4_26 = arg_4_0.unFinishListTF

	arg_4_0.unFinishUIList = var_4_23(var_4_25, var_3.Find(var_4_26, "list/tpl"))
	setText = var_1

	local var_4_27 = arg_4_0.unFinishListTF
	local var_4_28 = var_2.Find(var_4_27, "title/Text")

	i18n = var_4_27

	var_1(var_4_28, var_4_27("child_mind_processing_title"))

	setText = var_1

	local var_4_29 = arg_4_0.unFinishListTF
	local var_4_30 = var_2.Find(var_4_29, "list/tpl/time_desc")

	i18n = var_4_29

	var_1(var_4_30, var_4_29("child_mind_time_title"))
...
function var_0_1.sumbitTask(arg_11_0, arg_11_1)
	...
	EducateMindMediator = var_1_10004

	var_11_1(var_11_0, var_1_10004.ON_TASK_SUBMIT, arg_11_1)
...
function var_0_1.updateItems(arg_12_0)
	...
	underscore = var_12_0
	arg_12_0.taskVOs = var_12_0.select(arg_12_0.taskVOs, function(arg_13_0)
	...
	var_3.sort(arg_12_0.finishTaskVOs, var_12_2)
...
function var_0_1.updateFinishItem(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_3 = arg_17_2:Find("get_btn")
	...
	var_4(var_17_2, var_17_3, var_17_4, var_8)
...
function var_0_1.updateUnfinishItem(arg_21_0, arg_21_1, arg_21_2)
	...
	if var_21_0:GetRemainTime() < 7 then
		var_21_1 = 0
	else
		math = var_21_1
		var_21_1 = var_21_1.floor(var_4 / 7)
	end

	setText = var_6

	local var_21_2 = arg_21_2:Find("time_desc/time")
	local var_21_3 = var_21_1

	i18n = var_9

	var_6(var_21_2, var_21_3 .. var_9("word_week"))
...
function var_0_1.doAnim(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_6 = var_22_5(var_22_4, var_7.Action_float(function(arg_23_0)
	...
	local var_22_8 = var_22_7(var_22_6, var_7.easeInCubic)
	local var_22_9 = var_5.setOnComplete

	System = var_7

	var_22_9(var_22_8, var_7.Action(function()
