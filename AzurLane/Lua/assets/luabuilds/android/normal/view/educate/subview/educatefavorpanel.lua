...
function var_0_1.OnInit(arg_2_0)
	...
	arg_2_0.favorPanelAnim = var_2_2(var_2_1, var_3(var_1_10004))
	...
	arg_2_0.favorPanelAnimEvent = var_2_4(var_2_3, var_3(var_1_10004))
	...
	local var_2_8 = var_2.Find(var_2_7, "panel/bg/view/content")
	local var_2_9 = arg_2_0.favorPanelTF

	arg_2_0.favorUIList = var_2_6(var_2_8, var_3.Find(var_2_9, "panel/bg/view/content/tpl"))
	...
	var_2_15[1] = var_6.Find(var_2_16, "panel/bg")
...
function var_0_1.updateFavorPanel(arg_7_0)
	...
	var_7_1(var_3.Find(var_7_3, "lv"), var_7_2.lv)
	...
	local var_7_8 = var_5.Find(var_7_7, "progress")

	i18n = var_7_7

	var_4(var_7_8, var_7_7("child_favor_progress", var_7_6))

	setSlider = var_4

	local var_7_9 = arg_7_0.favorCurTF

	var_4(var_5.Find(var_7_9, "slider"), 0, 1, var_7_2.exp / var_7_5)

	local var_7_10 = arg_7_0.favorUIList
	local var_7_11 = var_4.align
	local var_7_12 = arg_7_0.char

	var_7_11(var_7_10, var_6.getConfig(var_7_12, "favor_level") - 1)
...
function var_0_1.updateFavorItem(arg_8_0, arg_8_1, arg_8_2)
	...
	var_6(arg_8_2:Find("lock"), not var_8_2)

	setActive = var_6

	var_6(arg_8_2:Find("unlock"), var_8_2)

	if not var_8_2 then
		local var_8_3 = arg_8_0.char
		local var_8_4 = var_6.GetFavorUpgradExp(var_8_3, var_8_0)

		setText = var_8_3

		local var_8_5 = arg_8_2
		local var_8_6 = arg_8_2.Find(var_8_5, "Text")

		i18n = var_8_5

		var_8_3(var_8_6, var_8_5("child_favor_lock1", var_8_0 + 1))

		setTextColor = var_8_3
		...
		var_8_3(var_8_8, var_8_7.NewHex("F5F5F5"))

		setTextColor = var_8_3

		local var_8_9 = arg_8_2
		local var_8_10 = arg_8_2.Find(var_8_9, "lv")

		Color = var_8_9

		var_8_3(var_8_10, var_8_9.NewHex("F5F5F5"))
	else
		local var_8_11 = arg_8_0.char
		local var_8_12

		if var_6.GetPerformByReplace(var_8_11, var_8_0)[1] then
			pg = var_8_12
			var_8_12 = var_8_12.child_performance[var_6[1]].param

			local var_8_13 = arg_8_0
			local var_8_14 = arg_8_0.getStoryTitle(var_8_13, var_8_12)

			setText = var_8_13

			var_8_13(arg_8_2:Find("Text"), var_8_14)
		end

		setTextColor = var_8_12

		local var_8_15 = arg_8_2
		local var_8_16 = arg_8_2.Find(var_8_15, "Text")

		Color = var_8_15

		var_8_12(var_8_16, var_8_15.NewHex("393A3C"))

		setTextColor = var_8_12

		local var_8_17 = arg_8_2
		local var_8_18 = arg_8_2.Find(var_8_17, "lv")

		Color = var_8_17

		var_8_12(var_8_18, var_8_17.NewHex("FFFFFF"))

		onButton = var_8_12

		local var_8_19 = arg_8_0
		local var_8_20 = arg_8_2:Find("unlock")
		...
		var_8_12(var_8_19, var_8_20, var_8_21, var_11)
	end
...
function var_0_1.getStoryTitle(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in var_1_10002(var_1_10003.memory_template.all) do
		pg = var_1_10007
