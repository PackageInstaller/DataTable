...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_3(var_1_10004.secretary_special_ship.get_id_list_by_group) do
		table = var_1_10008
		...
		if var_1_10008.contains(var_1_0, iter_1_0) then
			...
			EducateCharGroup = var_10

			var_1_10008(var_1_1, var_10.New(iter_1_0))
		end
	end
