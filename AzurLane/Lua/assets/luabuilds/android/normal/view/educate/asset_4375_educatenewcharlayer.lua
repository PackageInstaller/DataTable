...
function var_0_1.initData(arg_3_0)
	...
	local var_3_1 = var_3_1 == var_2 and var_3_1
...
function var_0_1.findUI(arg_4_0)
	...
	local var_4_4 = var_2.Find(var_4_3, "Image")

	i18n = var_4_3

	var_1(var_4_4, var_4_3("word_ok"))

	setText = var_1

	local var_4_5 = arg_4_0.callInput
	local var_4_6 = var_2.Find(var_4_5, "Placeholder")

	i18n = var_4_5

	var_1(var_4_6, var_4_5("child_callname_tip"))
	...
	local var_4_9 = var_4_8(var_4_7, var_3(var_4))
	...
	var_4_9(var_2.Find(var_4_10, "bg/panel/input/pan"), not arg_4_0.lockNamed)
