...
function var_0_1.addListener(arg_6_0)
	...
	local function var_6_8()
		...
		if var_2_10000(var_1.Find(var_9_0, "lock")) then
			return
		end
		...
		local var_9_4 = var_3.New
		local var_9_5 = {}

		EducateCollectMediatorTemplate = var_2_10005
		var_9_5.mediator = var_2_10005
		EducatePolaroidLayer = var_2_10005
		var_9_5.viewComponent = var_2_10005
		...
		var_9_2(var_1.Find(var_9_6, "new"), false)
	...
	local function var_6_11()
		...
		if var_2_10000(var_1.Find(var_10_0, "lock")) then
			return
		end
		...
		EducateCollectMediatorTemplate = var_2_10005
		var_10_5.mediator = var_2_10005
		EducateEndingLayer = var_2_10005
		var_10_5.viewComponent = var_2_10005
	...
	local function var_6_14()
		...
		var_11_5.page = var_2_10005.PAGE_MEMORTY
		EducateConst = var_5
		var_11_5.memoryGroup = var_5.REVIEW_GROUP_ID
...
function var_0_1.didEnter(arg_12_0)
	...
	var_1_10002(var_3.Find(var_12_1, "Text"), #arg_12_0.memories .. "/" .. var_12_0)
	...
	var_4(var_5.Find(var_12_6, "Text"), var_12_4 .. "/" .. var_12_5)

	setActive = var_4

	local var_12_7 = arg_12_0.polaroidBtn
	local var_12_8 = var_5.Find(var_12_7, "lock")

	EducateHelper = var_12_7

	local var_12_9 = var_12_7.IsSystemUnlock

	EducateConst = var_7

	var_4(var_12_8, not var_12_9(var_7.SYSTEM_POLAROID))

	setActive = var_4

	local var_12_10 = arg_12_0.polaroidBtn
	local var_12_11 = var_5.Find(var_12_10, "new")

	EducateTipHelper = var_12_10

	local var_12_12 = var_12_10.IsShowNewTip

	EducateTipHelper = var_7

	var_4(var_12_11, var_12_12(var_7.NEW_POLAROID))

	pg = var_4

	local var_12_13 = #var_4.child_ending.all

	setText = var_12_11

	local var_12_14 = arg_12_0.endingBtn

	var_12_11(var_6.Find(var_12_14, "unlock/Text"), #arg_12_0.endings .. "/" .. var_12_13)

	EducateHelper = var_12_11

	local var_12_15 = var_12_11.IsSystemUnlock

	EducateConst = var_6

	local var_12_17

	if not var_12_15(var_6.SYSTEM_ENDING) then
	...
	var_6(var_7.Find(var_12_18, "unlock"), var_12_17)

	setActive = var_6

	local var_12_19 = arg_12_0.endingBtn

	var_6(var_7.Find(var_12_19, "lock"), not var_12_17)
...
function var_0_1.updateMemoryTip(arg_14_0)
	...
	local var_14_1 = var_14_0(var_1_10002.child_memory.all, function(arg_15_0)
		...
		return var_15_0(var_2_10002.NEW_MEMORY, arg_15_0)
	end)
	...
	var_2(var_3.Find(var_14_2, "new"), var_14_1)
