...
function var_0_0.Ctor(arg_2_0, arg_2_1, arg_2_2)
	...
	typeof = var_5
	Text = var_1_10006
	arg_2_0.descTxt = var_2_3(var_2_2, var_5(var_1_10006))
	...
	typeof = var_5
	Image = var_1_10006
	arg_2_0.tagTF = var_2_6(var_2_5, var_5(var_1_10006))
	...
	typeof = var_5
	Slider = var_1_10006
	arg_2_0.progressBar = var_2_11(var_2_10, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_2_0.progressNum = var_2_14(var_2_13, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_2_0.lockTxt = var_2_26(var_2_25, var_5(var_1_10006))
	Vector2 = var_3
...
function var_0_0.update(arg_3_0, arg_3_1)
	...
	var_1_10002(var_1_10003(var_3_0, var_1_10005), "should be an instance of Task")
	...
	local var_3_3 = arg_3_1:getProgress()
	...
	if arg_3_1:isFinish() then
		...
		if arg_3_1.getConfig(var_3_4, "sub_type") == 1012 then
			local var_3_5 = arg_3_0.progressNum

			math = var_3_4

			local var_3_6 = var_3_4.floor(var_3_3 / 100)
			local var_3_7 = "/"

			math = var_7
			var_3_5.text = var_3_6 .. var_3_7 .. var_7.floor(var_3_2 / 100)
		else
			arg_3_0.progressNum.text = var_3_3 .. "/" .. var_3_2
		end
	end

	arg_3_0.progressBar.value = var_3_3 / var_3_2

	arg_3_0:updateBtnState(arg_3_1)

	local var_3_8 = arg_3_1:getConfig("story_id")
	local var_3_9 = arg_3_1
	local var_3_10 = arg_3_1.IsUrTask(var_3_9)

	setActive = var_3_9

	var_3_9(arg_3_0.urTag, var_3_10)

	setActive = var_3_9

	var_3_9(arg_3_0.storyIconFrame, var_3_8 and var_3_8 ~= "" and not var_3_10)

	if var_3_8 and var_3_8 ~= "" then
		local var_3_11 = arg_3_1

		if not arg_3_1.getConfig(var_3_11, "story_icon") or var_3_9 == "" then
			var_3_9 = "task_icon_default"
		end

		LoadSpriteAsync = var_3_11

		var_3_11("shipmodels/" .. var_3_9, function(arg_4_0)
			if arg_4_0 then
		...
		local function var_3_14()
			...
			var_0.Play(var_5_0, var_3_8, nil, true)
		...
		var_3_11(var_3_12, var_3_13, var_3_14, var_1_10011)
	else
		removeOnButton = var_3_9

		var_3_9(arg_3_0.storyIconFrame)
	end
...
function var_0_0.UpdateStoryIconPosition(arg_6_0, arg_6_1)
	...
	local var_6_1 = arg_6_1.getConfig(var_6_0, "story_icon_shift")

	type = var_6_0

	if var_6_0(var_6_1) == "table" and #var_6_1 >= 2 then
		local var_6_2 = var_6_1[1]
		local var_6_3 = var_6_1[2]
		local var_6_4 = arg_6_0.sIconOldPosition
		...
		local var_6_5 = 0
		local var_6_6 = 0
		local var_6_7 = arg_6_0.sIconOldPosition
...
function var_0_0.updateBtnState(arg_7_0, arg_7_1)
	...
	elseif arg_7_1:isFinish() then
		...
		local function var_7_3()
			...
			local function var_8_2()
				...
				TASK_SUB_TYPE_GIVE_ITEM = var_11_0

				if var_11_1 ~= var_11_0 then
					local var_11_2 = arg_7_1

					var_11_1 = var_11_1.getConfig(var_11_2, "sub_type")
					TASK_SUB_TYPE_GIVE_VIRTUAL_ITEM = var_11_2

					if var_11_1 ~= var_11_2 then
						local var_11_3 = arg_7_1

						var_11_1 = var_11_1.getConfig(var_11_3, "sub_type")
						TASK_SUB_TYPE_PLAYER_RES = var_11_3

						if var_11_1 == var_11_3 then
							DROP_TYPE_ITEM = var_11_1

							local var_11_4 = arg_7_1
							local var_11_5 = var_1.getConfig(var_11_4, "sub_type")

							TASK_SUB_TYPE_PLAYER_RES = var_11_4
							...
							local var_11_7 = arg_7_1

							var_11_6.id = var_11_4(var_3_10003.getConfig(var_11_7, "target_id"))
							var_3_10003 = arg_7_1
							var_11_6.count = var_2.getConfig(var_3_10003, "target_num")

							local var_11_8 = {}

							MSGBOX_TYPE_ITEM_BOX = var_3_10003
							var_11_8.type = var_3_10003
							i18n = var_3_10003
							var_11_8.content = var_3_10003("sub_item_warning")
							var_11_8.items = {
								var_11_6
							}
							...
							local var_11_9 = var_3_10003.MsgboxMgr.GetInstance()

							var_3_10003.ShowMsgBox(var_11_9, var_11_8)

							coroutine = var_3_10003

							var_3_10003.yield()
						end

						local var_11_10 = arg_7_1
						local var_11_11, var_11_12 = var_0.judgeOverflow(var_11_10)

						if var_11_11 then
							local var_11_13 = {}

							MSGBOX_TYPE_ITEM_BOX = var_3_10003
							var_11_13.type = var_3_10003
							i18n = var_3_10003
							var_11_13.content = var_3_10003("award_max_warning")
							var_11_13.items = var_11_12

							function var_11_13.onYes()
								var_8_1()
							...
							local var_11_14 = var_3.MsgboxMgr.GetInstance()

							var_3.ShowMsgBox(var_11_14, var_11_13)
		...
		var_3(var_7_4, var_7_5, var_7_6, var_1_10007)
	end
	...
	if var_7_0 == var_0_5 then
		...
		i18n = var_4
		var_7_7.text = var_4("task_lock", arg_7_1:getConfig("level"))
	end
...
function var_0_0.updateAwards(arg_17_0, arg_17_1)
	...
	for iter_17_1 = 1, var_17_1 do
		...
		if var_17_4 then
			...
			local var_17_7 = var_13(var_17_3, "got")

			Task = var_14

			var_12(var_17_7, var_14.OwnSpAward(var_17_5))
			...
			local function var_17_10()
				...
				TaskMediator = var_2_10002

				var_18_1(var_18_0, var_2_10002.ON_DROP, var_17_6)
			...
			var_12(var_17_8, var_17_9, var_17_10, var_1_10016)
		end
	end
...
function var_0_0.DoSubmitAnim(arg_19_0, arg_19_1)
	...
	local var_19_5 = var_19_4(var_19_3, var_5.Action_float(function(arg_20_0)
	...
	var_19_6(var_19_5, var_5.Action(function()
