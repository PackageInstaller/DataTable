...
function var_0_1.Update(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	local var_8_1 = arg_8_0.contextData.taskVOsById
	...
	if arg_8_1 ~= var_5.PAGE_TYPE_ALL then
		...
		if arg_8_1 == var_8_2.PAGE_TYPE_ROUTINE then
			TaskScene = var_8_2

			if var_8_2.IsPassScenario() then
				TaskScene = var_8_2

				if var_8_2.IsNewStyleTime() then
					pg = var_8_2
					var_8_2 = var_8_2.gameset.daily_task_new.description
					getProxy = var_8_3
					TaskProxy = var_7
					var_8_3 = var_8_3(var_7)
					ipairs = var_7

					for iter_8_2, iter_8_3 in var_7(var_8_2) do
						var_1_10013 = var_8_3

						local var_8_4

						if not var_8_3.getTaskById(var_1_10013, iter_8_3) then
							var_1_10013 = var_8_3
							var_8_4 = var_8_3.getFinishTaskById(var_1_10013, iter_8_3)
						end
						...
						if not var_8_4 then
							...
							local var_8_5 = arg_8_0.taskVOs

							Task = var_1_10015

							var_1_10013(var_8_5, var_1_10015.New({
								progress = 0,
								id = iter_8_3
							}))
						end
		...
		if arg_8_1 ~= var_8_2.PAGE_TYPE_ALL then
			TaskScene = var_5

			if arg_8_1 == var_5.PAGE_TYPE_ACT then
				getProxy = var_5
				AvatarFrameProxy = var_8_3

				local var_8_6 = var_5(var_8_3)
				local var_8_7 = var_5.getAllAvatarFrame(var_8_6)

				ipairs = var_8_6

				for iter_8_4, iter_8_5 in var_8_6(var_8_7) do
					local var_8_8 = iter_8_5.tasks

					ipairs = var_1_10013

					for iter_8_6, iter_8_7 in var_1_10013(var_8_8) do
						table = var_1_10018
			...
			var_5.SetTotalCount(var_8_9, #arg_8_0.taskVOs, -1)

			if arg_8_0:GetSliderValue() > 0 then
				local var_8_10 = arg_8_0._scrollView

				var_6.ScrollTo(var_8_10, var_5)
			end
...
function var_0_1.ExecuteOneStepSubmit(arg_19_0)
	...
	local function var_19_4()
		...
		for iter_20_0 = #var_19_1, 1, -1 do
			...
			if var_6.isAvatarTask(var_20_5) then
				if not var_20_3[var_6:getActId()] then
					var_20_3[var_6:getActId()] = {}
				end

				table = var_7

				var_7.insert(var_20_3[var_6:getActId()], var_6.id)

				table = var_7

				var_7.remove(var_19_1, iter_20_0)
			elseif var_6:isActivityTask() then
				if not var_20_4[var_6:getActId()] then
					var_20_4[var_6:getActId()] = {}
				end

				table = var_7

				var_7.insert(var_20_4[var_6:getActId()], var_6.id)
		...
		local function var_20_6(arg_21_0)
			...
			for iter_21_0, iter_21_1 in var_3_10001(arg_21_0) do
				if #iter_21_1 > 0 then
					...
					var_21_1(var_21_0, var_3_10008.SUBMIT_ACTIVITY_TASK, {
						act_id = iter_21_0,
						task_ids = iter_21_1,
		...
		if #var_19_1 > 0 then
			...
			TaskMediator = iter_20_0

			var_20_8(var_20_7, iter_20_0.STORE_ACTIVITY_AWARDS, true)
		end
		...
		var_20_10(var_20_9, iter_20_0.STORE_ACTIVITY_AWARDS, false)
		...
		if #var_19_1 > 0 then
			...
			var_20_12(var_20_11, var_5.MERGE_TASK_ONE_STEP_AWARD, {
				resultList = var_19_1
			})
		end
	...
	if var_19_2 then
		...
		var_19_6(var_19_5, var_1_10008("award_overflow_tip"))
...
function var_0_1.filterOverflowTaskVOList(arg_23_0, arg_23_1)
	...
	local var_23_3 = var_23_1.gameset.urpt_chapter_max.description[1]
	...
	if not var_1_10007 then
		...
		if not var_7.GetLimitCntById(var_1_10008, var_23_3) then
			var_23_6 = 0
		end
		...
		if not var_1_10010 then
			...
			for iter_23_0, iter_23_1 in var_1_10012(arg_23_1) do
				local var_23_11 = iter_23_1

				if not iter_23_1.judgeOverflow(var_23_11, var_23_4, var_23_5, var_23_6) then
					table = var_23_11

					var_23_11.insert(var_23_0, iter_23_1)
				end
...
function var_0_1.filterSubmitTaskVOList(arg_24_0, arg_24_1, arg_24_2)
	...
	for iter_24_0, iter_24_1 in var_1_10005(var_24_1) do
		...
		TASK_SUB_TYPE_GIVE_ITEM = var_24_2

		if var_24_3 ~= var_24_2 then
			local var_24_4 = iter_24_1

			var_24_3 = iter_24_1.getConfig(var_24_4, "sub_type")
			TASK_SUB_TYPE_GIVE_VIRTUAL_ITEM = var_24_4

			if var_24_3 ~= var_24_4 then
				local var_24_5 = iter_24_1

				var_24_3 = iter_24_1.getConfig(var_24_5, "sub_type")
				TASK_SUB_TYPE_PLAYER_RES = var_24_5

				if var_24_3 == var_24_5 then
					DROP_TYPE_ITEM = var_24_3

					local var_24_6 = iter_24_1
					local var_24_7 = iter_24_1.getConfig(var_24_6, "sub_type")

					TASK_SUB_TYPE_PLAYER_RES = var_24_6

					if var_24_7 == var_24_6 then
					...
					tonumber = var_24_6
					var_24_8.id = var_24_6(iter_24_1:getConfig("target_id"))
					var_24_8.count = iter_24_1:getConfig("target_num")
					...
					var_24_11.type = var_15
					i18n = var_15
					var_24_11.content = var_15("sub_item_warning")
					var_24_11.items = {
						var_24_8
					}
					var_24_11.onYes = var_24_9
					var_24_11.onNo = var_24_10
					pg = var_15

					local var_24_12 = var_15.MsgboxMgr.GetInstance()

					var_15.ShowMsgBox(var_24_12, var_24_11)
...
function var_0_1.filterChoiceTaskVOList(arg_27_0, arg_27_1, arg_27_2)
	...
	for iter_27_0, iter_27_1 in var_1_10005(var_27_1) do
		...
		if iter_27_1:isSelectable() then
			var_27_2 = iter_27_1:getConfig("award_choice")

			local var_27_3 = {}

			ipairs = var_12

			for iter_27_2, iter_27_3 in var_12(var_27_2) do
				var_27_3[#var_27_3 + 1] = {
					type = iter_27_3[1],
					id = iter_27_3[2],
					count = iter_27_3[3],
			...
			local function var_27_6()
				if not var_27_4 then
					...
					var_29_1(var_29_0, var_2_10002("no_item_selected_tip"))
				else
					local var_29_2 = {}
					local var_29_3 = var_27_2[var_27_4]
			...
			var_27_8.type = var_1_10017
			i18n = var_1_10017
			var_27_8.content = var_1_10017("select_award_warning")
			var_27_8.items = var_27_3
			var_27_8.itemFunc = var_27_5
			var_27_8.onYes = var_27_6
			var_27_8.onNo = var_27_7
			pg = var_1_10017

			local var_27_9 = var_1_10017.MsgboxMgr.GetInstance()

			var_1_10017.ShowMsgBox(var_27_9, var_27_8)
			...
			var_27_2.insert(var_27_0, iter_27_1)
		end
	end
