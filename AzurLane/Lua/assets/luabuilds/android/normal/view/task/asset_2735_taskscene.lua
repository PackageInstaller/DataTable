...
function var_0_1.IsPassScenario()
	...
	local var_6_3 = var_6_1.select

	_ = var_1_10003

	if #var_6_3(var_1_10003.values(var_6_2), function(arg_7_0)
...
function var_0_1.didEnter(arg_9_0)
	...
	if var_0_1.IsNewStyleTime() then
		...
		if not var_2.IsMaximum(var_9_1) then
			...
			TaskEmptyListPage = var_9_1
			arg_9_0.emptyPage = var_9_1.New(arg_9_0._tf, arg_9_0.event)
			arg_9_0.pages = {
			...
			var_9_3(var_9_4, var_9_5, var_9_6, var_7)

			setActive = var_9_3

			local var_9_7 = arg_9_0._tf
			local var_9_8 = var_4.Find(var_9_7, "stamp")

			getProxy = var_9_7
			TaskProxy = var_6

			local var_9_9 = var_9_7(var_6)

			var_9_3(var_9_8, var_5.mingshiTouchFlagEnabled(var_9_9))
			...
			if var_9_3 then
				...
				var_9_3(var_4.Find(var_9_10, "stamp"), false)
			end
			...
			local var_9_13 = var_5.Find(var_9_12, "stamp")
			...
			var_9_3(var_9_11, var_9_13, var_9_14, var_7)
			...
			for iter_9_0, iter_9_1 in var_3(var_0_2) do
				...
				var_9_15(var_9_17, var_9_18, var_9_19, var_1_10013)

				arg_9_0.toggles[iter_9_0] = var_9_16
			end
			...
			if not arg_9_0.contextData.page then
				var_9_21 = var_0_1.PAGE_TYPE_ALL
			end

			local var_9_22 = var_9_20[var_9_21]

			if arg_9_0.toggles and var_9_22 then
				triggerToggle = var_4
...
function var_0_1.ResetWeekTaskPage(arg_20_0)
	...
	if var_0_1.IsNewStyleTime() then
		...
		TaskCommonPage = var_1_10004

		if var_2(var_20_1, var_1_10004) then
...
function var_0_1.RefreshWeekTaskProgress(arg_23_0)
	...
	TaskWeekPage = var_1_10004

	if var_2(var_23_1, var_1_10004) then
	...
	if arg_23_0._currentToggleType == var_0_1.PAGE_TYPE_WEEKLY then
		...
		if var_2(var_23_3, var_1_10004) then
...
function var_0_1.onSubmit(arg_26_0, arg_26_1)
	...
	TaskMediator = var_1_10004

	var_26_1(var_26_0, var_1_10004.ON_TASK_SUBMIT, arg_26_1)
...
function var_0_1.onSubmitForWeek(arg_27_0, arg_27_1)
	...
	var_27_1(var_27_0, var_1_10004.ON_SUBMIT_WEEK_TASK, arg_27_1)
...
function var_0_1.onSubmitForAvatar(arg_28_0, arg_28_1)
	...
	var_28_1(var_28_0, var_1_10004.ON_SUBMIT_AVATAR_TASK, arg_28_1)
...
function var_0_1.onGo(arg_29_0, arg_29_1)
	...
	if var_2(var_29_0, var_1_10004) and arg_29_1:IsActEnd() then
		pg = var_2
		...
		var_29_2(var_29_1, var_1_10004("common_activity_end"))
	...
	var_29_4(var_29_3, var_1_10004.ON_TASK_GO, arg_29_1)
...
function var_0_1.updateOneStepBtn(arg_31_0, arg_31_1)
	...
	if 2 <= var_31_0 then
		...
		var_4(var_31_1, var_31_2, var_31_3, var_1_10008)
	else
