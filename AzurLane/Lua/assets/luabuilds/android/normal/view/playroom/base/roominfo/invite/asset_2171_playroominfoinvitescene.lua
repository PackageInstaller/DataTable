...
function var_0_1.init(arg_2_0)
	...
	var_2_1(var_2_13, var_3("island_guild"))
	...
	var_2_1(var_2_14, var_2_15, var_2_16, var_2_4)
	...
	var_2_1(var_2_17, var_2_18, var_2_19, var_2_4)

	local var_2_20 = arg_2_0.uiFriendText

	Color = var_2_17
	var_2_20.color = var_2_17.NewHex("FEFEFE")
	...
	local var_2_24 = var_3(arg_2_0, arg_2_0.IndexItem)
	local var_2_25 = arg_2_0.uiList

	PlayRoomInfoInviteItem = var_5
	arg_2_0.uiScrollView = var_2_22(var_2_23, var_2_24, var_2_25, var_5)
...
function var_0_1.GetDisplayData(arg_12_0)
	...
	if arg_12_0.selectedPage == var_0_1.PAGE.FRIEND then
		...
		var_12_0 = var_2.getAllFriends(var_12_1)
	elseif arg_12_0.selectedPage == var_0_1.PAGE.GUILD then
		getProxy = var_2
		GuildProxy = var_3

		local var_12_2 = var_2(var_3)

		var_12_0 = var_2.getRawData(var_12_2) and var_2:getSortMemberWithoutSelf() or {}
	end
