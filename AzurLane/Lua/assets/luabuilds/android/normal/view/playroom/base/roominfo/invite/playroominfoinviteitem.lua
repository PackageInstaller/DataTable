...
function var_0_1.Init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10003("island_btn_label_online"))
...
function var_0_1.didEnter(arg_3_0, arg_3_1)
	...
	var_3("qicon/" .. var_3_0:getPrefab(), function(arg_4_0)
	...
	var_3_1(arg_3_0.uiOnlineTf, var_3_2)

	setActive = var_3_1

	var_3_1(arg_3_0.uiOfflineTf, not var_3_2)
	...
	if not var_3_2 then
		...
		var_3_1(var_3_3, var_6(arg_3_1.preOnLineTime))
	else
		setText = var_3_1
		...
		var_3_1(var_3_4, var_6("island_btn_label_online"))
	end
	...
	var_3_1(var_3_5, var_6("island_btn_label_invitation"))
	...
	var_3_1(var_3_6, var_6("island_btn_label_invitation_already"))
	...
	local function var_3_9()
		...
		PlayRoomInfoInviteMediator = var_2_10002

		var_5_1(var_5_0, var_2_10002.ON_CLICK_INVITE, {
			id = arg_3_1.id
		})
	...
	var_3_1(var_3_7, var_3_8, var_3_9, var_1_10008)

	getProxy = var_3_1
	PlayRoomProxy = var_3_7

	local var_3_10 = var_3_1(var_3_7)
	local var_3_11 = var_4.GetInviteRecordByID(var_3_10, arg_3_1.id)

	setActive = var_3_10

	var_3_10(arg_3_0.uiInviteBtn, var_3_11 == nil)

	setActive = var_3_10

	var_3_10(arg_3_0.uiCancelBtn, var_3_11 ~= nil)
