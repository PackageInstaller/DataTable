...
function var_0_1.init(arg_2_0)
	...
	local function var_2_11()
		...
		var_4_1(var_4_0, var_2_10003.ON_CLICK_SWITCH, {
			teamIndex = var_0
		})
	...
	PlayRoomInfoViewerItem = var_5
	arg_2_0.uiScrollView = var_2_12(var_2_13, var_2_14, var_2_15, var_5)
...
function var_0_1.didEnter(arg_5_0)
	...
	arg_5_0.playRoomProxy = var_1_10001(var_1_10002)
...
function var_0_1.RefreshPlayerList(arg_8_0)
	...
	var_8_0.sort(arg_8_0.viewerList, function(arg_9_0, arg_9_1)
...
function var_0_1.RefreshBtn(arg_10_0)
	...
	if var_1_10001.IsViewer() then
		...
		var_1(var_10_0, var_1_10003("play_room_switch_viewer"))
		...
		var_1(var_10_1, not var_1_10003.IsPlayerFull())
	else
		setText = var_1
		...
		var_1(var_10_2, var_1_10003("play_room_switch_player"))
		...
		var_1(var_10_3, not var_3.IsViewerFull())
	end
