...
function var_0_1.Init(arg_2_0)
	...
	local function var_2_2()
		...
		var_3_1(var_3_0, var_2_10002.PLAY_ROOM_MATCH_STOP)
...
function var_0_1.RefreshMatch(arg_10_0)
	...
	local var_10_1 = var_10_0:GetMatchTime()
	local var_10_2 = var_10_0
	local var_10_3 = var_10_0.GetMatchStarTime(var_10_2)

	pg = var_10_2

	local var_10_4 = var_10_2.TimeMgr.GetInstance()
	local var_10_5 = var_10_1 - var_4.GetServerTime(var_10_4)
	...
	var_1_10007(var_10_7, var_1_10009("match_ui_matching_waiting1", var_10_6))
	...
	if var_10_5 <= 0 then
		...
		var_10_9(var_10_8, var_9.BuildPlayRoomMatch("bar", 2, 1, var_10_6, 0))
		...
		var_10_11(var_10_10, var_9("match_ui_matching_fail"))
		...
		var_10_13(var_10_12, var_9.PLAY_ROOM_MATCH_STOP)
	end
