...
function var_0_1.Init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10003("match_ui_room_type4"))
	...
	var_1_10001(var_2_1, var_3("match_ui_room_type3"))
	...
	var_1_10001(var_2_2, var_3("match_ui_room_type1"))
	...
	var_1_10001(var_2_3, var_3("match_ui_room_type2"))
...
function var_0_1.didEnter(arg_3_0, arg_3_1)
	...
	var_1_10002(var_3_0, var_1_10004("match_ui_room_name", arg_3_1.name))
	...
	var_1_10002(var_3_1, not var_4.HIDE_VIEWER)
	...
	var_1_10002(var_3_2, var_4(var_3_3, var_3_4, var_1_10007.GetMaxViewerCnt(arg_3_1.gameType)))
	...
	local var_3_6 = var_4.format
	local var_3_7 = "%s/%s"
	local var_3_8 = arg_3_1.teamCnt

	PlayRoomTools = var_7

	var_1_10002(var_3_5, var_3_6(var_3_7, var_3_8, var_7.GetMaxTeamCnt(arg_3_1.gameType)))
	...
	if var_3_9 == var_3_5.PLAY_ROOM_STATE.WAIT then
		setActive = var_3
		...
		local function var_3_12()
			...
			var_4_1(var_4_0, var_2_10002.JOIN_ROOM, {
				id = arg_3_1.id,
		...
		var_3(var_3_10, var_3_11, var_3_12, var_7)
	end

	local var_3_13 = arg_3_1.roomType

	PlayRoomConst = var_3_10

	if var_3_13 == var_3_10.PLAY_ROOM_TYPE.PERSON then
		setActive = var_3_13
