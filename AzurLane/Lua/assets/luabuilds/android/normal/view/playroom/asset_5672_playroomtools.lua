local var_0_0 = {
	...
	SortRoomList = function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3.sort(arg_3_0, function(arg_4_0, arg_4_1)
			...
			var_4_1[var_2_10005.ROOM_SORT_TYPE.ROOM_PLAYER_SUM] = function()
			...
			PlayRoomConst = var_5
			var_4_1[var_5.ROOM_SORT_TYPE.ROOM_VIEWER_CNT] = function()
...
function var_0_0.IsViewer()
	...
	return var_10_2.contains(var_10_1.viewerList, var_10_3)
end
...
function var_0_0.GetUnfullTeamIndex(arg_13_0)
	...
	local var_13_2 = var_13_0.mode_room[var_13_1.gameType].count
...
function var_0_0.GetServerName(arg_16_0)
	...
	local var_16_1 = var_3(var_1_10004)

	for iter_16_0, iter_16_1 in var_2(var_3.getData(var_16_1)) do
		table = var_1_10007
...
function var_0_0.GetPtScoreIcon(arg_18_0)
	...
	var_18_2[var_1_10005.ACTIVITY_TYPE_ISLAND_CHEAT_BAR] = function()
		...
		for iter_19_0, iter_19_1 in var_2_10003(var_2_10004.island_integral_rank.all) do
			pg = var_2_10008
	...
	return var_2(var_18_1, var_18_2, function()
		assert = var_2_10000
...
function var_0_0.SearchRoomList(arg_22_0)
	...
	local var_22_1 = var_1_10002(var_1_10003)
...
function var_0_0.ShowPunishementBox(arg_25_0)
	...
	local var_25_1 = var_25_0.MsgboxMgr.GetInstance()
	...
	i18n = var_1_10005
	var_25_3.content = var_1_10005("match_ui_punishment1", arg_25_0 - var_1)
	i18n = var_5
	var_25_3.yesText = var_5("match_ui_punishment2")
