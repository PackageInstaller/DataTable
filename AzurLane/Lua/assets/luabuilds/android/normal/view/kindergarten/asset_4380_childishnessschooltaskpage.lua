...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.UIlist = var_2_2(var_2_4, var_3.Find(var_2_5, "window/panel/list/Tasktpl"))
...
function var_0_1.UpdateList(arg_9_0, arg_9_1)
	...
	var_2.make(var_9_0, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			local var_10_3 = var_10_0.getConfig(var_10_2, "target_num")

			math = var_10_2

			local var_10_4 = var_10_2.min(var_10_1, var_10_3)
			...
			typeof = var_8
			Slider = var_9
			var_10_6(var_10_5, var_8(var_9)).value = var_10_4 / var_10_3
			...
			local function var_10_15()
				...
				ChildishnessSchoolTaskMediator = var_3_10002

				var_11_1(var_11_0, var_3_10002.ON_TASK_GO, var_10_0)
			...
			var_12(var_10_13, var_10_14, var_10_15, var_2_10016)
			...
			local function var_10_18()
				...
				var_12_1(var_12_0, var_3_10002.ON_TASK_SUBMIT, var_10_0)
			...
			var_12(var_10_16, var_10_17, var_10_18, var_2_10016)
		end
	...
	if arg_9_0.canGetAward then
		...
		local function var_9_4()
			...
			for iter_13_0, iter_13_1 in var_2_10002(arg_9_0.canGetTaskVOs) do
				...
				local var_13_3 = iter_13_1.getConfig(var_13_2, "award_display")

				ipairs = var_13_2

				for iter_13_2, iter_13_3 in var_13_2(var_13_3) do
					local var_13_4 = iter_13_3
					local var_13_5 = false

					pairs = var_2_10015

					for iter_13_4, iter_13_5 in var_2_10015(var_13_1) do
						if iter_13_5[1] == var_13_4[1] and iter_13_5[2] == var_13_4[2] then
							var_13_5 = true
							iter_13_5[3] = iter_13_5[3] + var_13_4[3]
					...
					if not var_13_5 then
						...
						var_2_10015.insert(var_13_1, var_13_4)
					end
				end
			end
			...
			local var_13_6 = var_2(var_3)
			local var_13_7 = var_2.getRawData(var_13_6)

			pg = var_13_6

			local var_13_8 = var_13_6.gameset.urpt_chapter_max.description[1]

			LOCK_UR_SHIP = iter_13_0
			...
			if iter_13_0 then
				...
				getProxy = iter_13_0
				BagProxy = iter_13_1
				iter_13_1 = iter_13_0(iter_13_1)
				iter_13_0 = iter_13_0.GetLimitCntById(iter_13_1, var_13_8)
			end

			Task = iter_13_1

			local var_13_9, var_13_10 = iter_13_1.StaticJudgeOverflow(var_13_7.gold, var_13_7.oil, iter_13_0, true, true, var_13_1)
			...
			if var_13_9 then
				...
				var_8.insert(var_13_0, function(arg_14_0)
					...
					var_14_2.type = var_3_10004
					i18n = var_3_10004
					var_14_2.content = var_3_10004("award_max_warning")
					var_14_2.items = var_13_10
			...
			var_8(var_13_0, function()
				...
				local var_15_2 = var_3_10002.ON_TASK_SUBMIT_ONESTEP

				ActivityConst = var_3_10003

				var_15_1(var_15_0, var_15_2, var_3_10003.ALVIT_TASK_ACT_ID, arg_9_0.canGetTaskIds)
		...
		var_2(var_9_2, var_9_3, var_9_4, var_1_10006)
	else
		setActive = var_2
...
function var_0_1.updateAwards(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	for iter_16_1 = 1, var_16_1 do
		...
		if var_16_3 then
			...
			var_14(var_16_2:Find("mask"), var_16_5)

			local var_16_6 = var_16_5.type

			DROP_TYPE_EQUIPMENT_SKIN = var_15

			if var_16_6 == var_15 then
				setActive = var_16_6

				var_16_6(var_16_2:Find("specialFrame"), true)
			else
				setActive = var_16_6

				var_16_6(var_16_2:Find("specialFrame"), false)
			end
			...
			var_16_6(var_16_7, var_16_8, var_16_9, var_1_10018)
		end
	end
...
function var_0_1.UpdateTaskData(arg_18_0)
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10003.ALVIT_TASK_ACT_ID)

	arg_18_0.taskVOs = {}

	local var_18_3 = var_18_2
	local var_18_4 = var_18_2.getConfig(var_18_3, "config_data")

	pairs = var_18_3

	for iter_18_0, iter_18_1 in var_18_3(var_18_4) do
		table = var_1_10008
		var_1_10008 = var_1_10008.insert

		local var_18_5 = arg_18_0.taskVOs

		getProxy = var_1_10010
		TaskProxy = var_1_10011
		var_1_10011 = var_1_10010(var_1_10011)

		var_1_10008(var_18_5, var_1_10010.getTaskVO(var_1_10011, iter_18_1))
	end
