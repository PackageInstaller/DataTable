...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_EXTRA_RANK, function(arg_4_0)
		...
		var_4_4.page = var_2_10006.TYPE_BOSSRUSH
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.ACTIVITY_UPDATED then
		...
		if var_6_3 == var_1_10005.ALVIT_PT_ACT_ID then
			local var_6_4 = arg_6_0.viewComponent

			var_5.UpdatePt(var_6_4)
		end
	else
		GAME = var_6_3

		if var_6_0 == var_6_3.SUBMIT_ACTIVITY_TASK_DONE then
			local var_6_5 = arg_6_0.viewComponent

			var_4.UpdateTask(var_6_5)
		end
	end
