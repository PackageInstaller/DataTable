...
function var_0_1.findUI(arg_5_0)
	...
	var_1_10001(var_5_0, var_1_10003("loading_set_tip"))
	...
	var_1_10001(var_5_1, var_3("loading_set_tip"))
...
function var_0_1.addListener(arg_7_0)
	...
	var_1_10001(var_7_18, var_7_19, var_7_20, var_1_10005)
	...
	var_1_10001(var_7_21, var_7_22, var_7_23, var_1_10005)
	...
	var_1_10001(var_7_24, var_7_25, var_7_26, var_1_10005)
	...
	var_1_10001(var_7_27, var_7_28, var_7_29, var_1_10005)
	...
	var_1_10001(var_7_30, var_7_31, var_7_32, var_1_10005)
	...
	var_1_10001(var_7_33, var_7_34, var_7_35, var_5)
	...
	var_1_10001(var_7_36, var_7_37, var_7_38, var_5)
	...
	var_1_10001(var_7_39, var_7_40, var_7_41, var_5)
	...
	var_1_10001(var_7_42, var_7_43, var_7_44, var_5)
...
function var_0_1.updateGalleryPanel(arg_28_0)
	...
	local var_28_1 = arg_28_0.isPicInfoUsed(var_28_0, arg_28_0.curPicInfo)

	setActive = var_28_0

	var_28_0(arg_28_0.galleryAddLoadingBtn, not var_28_1)

	setActive = var_28_0

	var_28_0(arg_28_0.galleryRemoveLoadingBtn, var_28_1)

	local var_28_2 = arg_28_0:isPicInfoLiked(arg_28_0.curPicInfo)
	local var_28_3 = arg_28_0.isShowLikeBtn

	setActive = var_4

	var_4(arg_28_0.galleryLikeBtn, var_28_3)

	setActive = var_4

	var_4(arg_28_0.galleryAddLikeBtn, not var_28_2)

	setActive = var_4

	var_4(arg_28_0.galleryRemoveLikeBtn, var_28_2)
...
function var_0_1.updateMangaPanel(arg_29_0)
	...
	local var_29_1 = arg_29_0.isPicInfoUsed(var_29_0, arg_29_0.curPicInfo)

	setActive = var_29_0

	var_29_0(arg_29_0.mangaAddLoadingBtn, not var_29_1)

	setActive = var_29_0

	var_29_0(arg_29_0.mangaRemoveLoadingBtn, var_29_1)

	local var_29_2 = arg_29_0:isPicInfoLiked(arg_29_0.curPicInfo)
	local var_29_3 = arg_29_0.isShowLikeBtn

	setActive = var_4

	var_4(arg_29_0.mangaLikeBtn, var_29_3)

	setActive = var_4

	var_4(arg_29_0.mangaAddLikeBtn, not var_29_2)

	setActive = var_4

	var_4(arg_29_0.mangaRemoveLikeBtn, var_29_2)
...
function var_0_1.setImage(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_3 = var_5(var_30_2, var_1_10007(var_1_10008)).sprite
	...
	if not var_30_2(var_30_3) then
		...
		local var_30_5 = var_7.lower(var_30_4)
...
function var_0_1.openFullScreenLayer(arg_31_0)
	...
	AppreciatePicFullScreenMediator = var_1_10004
	var_31_2.mediator = var_1_10004
	AppreciatePicFullScreenLayer = var_1_10004
	var_31_2.viewComponent = var_1_10004
	var_31_2.data = {
...
function var_0_1.removeLoadingPic(arg_35_0, arg_35_1)
	...
	if var_35_1 == var_1_10004.TYPE_GALLERY then
		var_35_2 = arg_35_0.loadingPicProxy
		var_35_1 = var_35_1.getGalleryPicIDList(var_35_2)
		ipairs = var_35_2

		for iter_35_0, iter_35_1 in var_35_2(var_35_1) do
		...
		AppreciatePicConst = var_35_2

		if var_35_1 == var_35_2.TYPE_MANGA then
			local var_35_3 = arg_35_0.loadingPicProxy

			var_35_1 = var_35_1.getMangaPicIDList(var_35_3)
			ipairs = var_35_3

			for iter_35_2, iter_35_3 in var_35_3(var_35_1) do
	...
	var_35_5(var_35_4, var_1_10005.UPDATE_LOADING_PIC, var_35_0)
...
function var_0_1.addLoadingPic(arg_36_0, arg_36_1)
	...
	local var_36_0 = {}
	local var_36_1 = arg_36_1.type

	AppreciatePicConst = var_4

	local var_36_2

	if var_36_1 == var_4.TYPE_GALLERY then
		var_36_2 = arg_36_0.loadingPicProxy
		var_36_1 = var_36_1.getGalleryPicIDList(var_36_2)
		table = var_36_2

		var_36_2.insert(var_36_1, arg_36_1.id)

		var_36_0.galleryPicIDList = var_36_1
	else
		var_36_1 = arg_36_1.type
		AppreciatePicConst = var_36_2

		if var_36_1 == var_36_2.TYPE_MANGA then
			local var_36_3 = arg_36_0.loadingPicProxy

			var_36_1 = var_36_1.getMangaPicIDList(var_36_3)
			table = var_36_3

			var_36_3.insert(var_36_1, arg_36_1.id)

			var_36_0.mangaPicIDList = var_36_1
		end
	end

	pg = var_36_1

	local var_36_4 = var_36_1.m02
	local var_36_5 = var_3.sendNotification

	GAME = var_1_10005

	var_36_5(var_36_4, var_1_10005.UPDATE_LOADING_PIC, var_36_0)
...
function var_0_1.addLike(arg_38_0, arg_38_1)
	...
	if var_38_1 == var_1_10004.TYPE_GALLERY then
		...
		var_38_3(var_38_2, var_1_10005.APPRECIATE_GALLERY_LIKE, var_38_0)
	else
		local var_38_4 = arg_38_1.type

		AppreciatePicConst = var_38_2

		if var_38_4 == var_38_2.TYPE_MANGA then
			...
			var_38_6(var_38_5, var_1_10005.APPRECIATE_MANGA_LIKE, var_38_0)
		end
	end
...
function var_0_1.removeLike(arg_39_0, arg_39_1)
	...
	if var_39_1 == var_1_10004.TYPE_GALLERY then
		...
		var_39_3(var_39_2, var_1_10005.APPRECIATE_GALLERY_LIKE, var_39_0)
	else
		local var_39_4 = arg_39_1.type

		AppreciatePicConst = var_39_2

		if var_39_4 == var_39_2.TYPE_MANGA then
			...
			var_39_6(var_39_5, var_1_10005.APPRECIATE_MANGA_LIKE, var_39_0)
		end
	end
...
function var_0_1.addOpenList(arg_40_0)
	...
	if var_40_0 == var_1_10002.TYPE_GALLERY then
		getProxy = var_40_0
		LoadingPicProxy = var_40_1
		var_40_1 = var_40_0(var_40_1)

		var_1.addGalleryNewPicOpenList(var_40_1, arg_40_0.curPicInfo.id)
	else
		local var_40_2 = arg_40_0.curPicInfo.type

		AppreciatePicConst = var_40_1

		if var_40_2 == var_40_1.TYPE_MANGA then
			getProxy = var_40_2
			LoadingPicProxy = var_2

			local var_40_3 = var_40_2(var_2)

			var_1.addMangaNewPicOpenList(var_40_3, arg_40_0.curPicInfo.id)
		end
	end
