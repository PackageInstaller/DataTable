...
function var_0_1.initUIText(arg_7_0)
	...
	var_7_6(var_7_8, var_1_10007("cartoon_notall"))
	...
	var_7_6(var_7_9, var_7("cartoon_notall"))
	...
	var_7_6(var_7_10, var_7("cartoon_notall"))
	...
	var_7_6(var_7_11, var_7("cartoon_haveno"))
...
function var_0_1.addListener(arg_8_0)
	...
	local function var_8_11()
		...
		function var_12_0.onCallback()
			...
			if var_13_0(var_3_10001.persistentDataPath .. "/hashes-manga.csv") then
				...
				var_13_3(var_13_2, var_2("word_no_cache"))
			end
		...
		i18n = var_2_10004
		var_12_3.content = var_2_10004("resource_verify_warn")
		var_12_3.custom = {
			var_12_0
		}
...
function var_0_1.updateMangaTpl(arg_14_0, arg_14_1, arg_14_2)
	...
	var_1_10005(var_14_1, "null mangaID")

	local var_14_2 = var_14_0
	local var_14_3 = var_14_0.Find(var_14_2, "Update")

	setActive = var_14_2

	var_14_2(var_14_3, false)

	local var_14_4 = var_14_0:Find("Content/Mask/Pic")
	local var_14_5 = var_14_0:Find("Content/Bottom/BottomNew")
	local var_14_6 = var_14_0:Find("Content/Bottom/BottomNotRead")
	local var_14_7 = var_14_0:Find("Content/Bottom/BottomNormal")
	local var_14_8 = var_14_0:Find("Content/Bottom/BottomTip")
	local var_14_9 = var_14_0:Find("TopSpecial")
	local var_14_10 = var_14_5:Find("NumText")
	local var_14_11 = var_14_6:Find("NumText")
	local var_14_12 = var_14_7
	local var_14_13 = var_14_7.Find(var_14_12, "NumText")

	MangaConst = var_14_12

	local var_14_14 = var_14_12.isMangaEverReadByID(var_14_1)

	MangaConst = var_16

	local var_14_15 = var_16.isMangaNewByID(var_14_1)

	setActive = var_17

	var_17(var_14_8, false)

	setActive = var_17

	var_17(var_14_5, not var_14_14)

	setActive = var_17

	var_17(var_14_6, false)

	setActive = var_17

	var_17(var_14_7, var_14_14)

	setActive = var_17

	var_17(var_14_9, not var_14_14)

	setText = var_17

	local var_14_16 = var_14_10
	local var_14_17 = "#"

	pg = var_1_10020

	var_17(var_14_16, var_14_17 .. var_1_10020.cartoon[var_14_1].cartoon_id)
	...
	var_17(var_14_18, var_14_19 .. var_20.cartoon[var_14_1].cartoon_id)
	...
	var_17(var_14_20, var_14_21 .. var_20.cartoon[var_14_1].cartoon_id)
	...
	var_17(var_14_22, var_14_23, var_14_24, var_1_10021)

	pg = var_17

	local var_14_25 = var_17.cartoon[var_14_1].resource

	MangaConst = var_14_22

	local var_14_26 = var_14_22.MANGA_PATH_PREFIX .. var_14_25

	GetComponent = var_19

	local var_14_27 = var_19(var_14_4, "Image").sprite

	IsNil = var_20

	if not var_20(var_14_27) then
		if var_14_27.name ~= var_14_25 then
			local var_14_28 = arg_14_0.resLoader

			var_21.LoadSprite(var_14_28, var_14_26, var_14_25, var_14_4, false)
		end
	else
		local var_14_29 = arg_14_0.resLoader

		var_20.LoadSprite(var_14_29, var_14_26, var_14_25, var_14_4, false)
	end
...
function var_0_1.initEmpty(arg_16_0, arg_16_1)
	...
	var_16_0(var_16_1, false)

	local var_16_2 = var_2:Find("Content/Bottom/BottomNew")
	local var_16_3 = var_2:Find("Content/Bottom/BottomNotRead")
	local var_16_4 = var_2:Find("Content/Bottom/BottomNormal")
	local var_16_5 = var_2
	local var_16_6 = var_2.Find(var_16_5, "Content/Bottom/BottomTip")

	setActive = var_16_5

	var_16_5(var_16_2, false)

	setActive = var_16_5

	var_16_5(var_16_3, false)

	setActive = var_16_5

	var_16_5(var_16_4, false)

	setActive = var_16_5

	var_16_5(var_16_6, true)

	local var_16_7 = var_2:Find("Update")
	local var_16_8 = var_8.Find(var_16_7, "Btn")
	local var_16_9 = var_8:Find("Progress")
	local var_16_10 = var_10.Find(var_16_9, "Slider")
	...
	for iter_16_0, iter_16_1 in var_14(var_1_10015.cartoon.all) do
		pg = var_1_10019
		...
		if var_21(var_1_10020) then
			var_16_11 = var_1_10019
			var_16_12 = var_1_10020

			break
		end
	end

	local var_16_13 = var_2:Find("Content/Mask/Pic")
	local var_16_14 = arg_16_0.resLoader

	var_15.LoadSprite(var_16_14, var_16_12, var_16_11, var_16_13, false)
		...
		if var_17_0 ~= var_2_10001.None then
			...
			if var_17_0 ~= var_1.CheckToUpdate then
				...
				if var_17_0 == var_1.UpdateFailure then
					...
					local var_17_3 = var_2.BytesToString(var_17_2)
					...
					var_17_6.type = var_2_10006
					string = var_2_10006

					local var_17_7 = var_2_10006.format

					i18n = var_2_10007
					var_17_6.content = var_17_7(var_2_10007("group_download_tip", var_17_3))
	...
	var_15(var_16_15, var_16_16, var_16_17, var_19)
...
function var_0_1.updateEmpty(arg_19_0, arg_19_1)
	...
	if var_19_6 == var_9.None then
		...
		if var_19_6 == var_9.Checking then
			...
			var_9(var_19_7, var_1_10011("word_manga_checking"))
			...
			if var_19_6 == var_9.CheckToUpdate then
				...
				var_9(var_19_8, var_1_10011("word_manga_checktoupdate"))
				...
				if var_19_6 == var_9.CheckOver then
					...
					if var_19_6 == var_9.CheckFailure then
						...
						var_9(var_19_9, var_1_10011("word_manga_checkfailure"))
						...
						if var_19_6 == var_9.Updating then
							...
							var_9(var_19_10, var_1_10011("word_manga_updating", arg_19_0.group.downloadCount, arg_19_0.group.downloadTotal))
							...
							if var_19_6 == var_9.UpdateSuccess then
								...
								var_9(var_19_11, var_1_10011("word_manga_updatesuccess"))
								...
								if var_19_6 == var_9.UpdateFailure then
									...
									var_9(var_19_12, var_1_10011("word_manga_updatefailure"))
...
function var_0_1.initDownloadBtnPanel(arg_26_0)
		...
		if var_27_0 ~= var_2_10001.None then
			...
			if var_27_0 ~= var_1.CheckToUpdate then
				...
				if var_27_0 == var_1.UpdateFailure then
					...
					local var_27_3 = var_2.BytesToString(var_27_2)
					...
					MSGBOX_TYPE_NORMAL = var_2_10006
					var_27_6.type = var_2_10006
					string = var_2_10006

					local var_27_7 = var_2_10006.format

					i18n = var_2_10007
					var_27_6.content = var_27_7(var_2_10007("group_download_tip", var_27_3))
	...
	var_26_4(var_26_6, var_26_7, var_26_8, var_1_10009)
...
function var_0_1.updateDownloadBtnPanel(arg_29_0)
	...
	if var_29_6 == var_6.None then
		...
		if var_29_6 == var_6.Checking then
			...
			var_6(var_29_7, var_1_10008("word_manga_checking"))
			...
			if var_29_6 == var_6.CheckToUpdate then
				...
				var_6(var_29_8, var_1_10008("word_manga_checktoupdate"))
				...
				if var_29_6 == var_6.CheckOver then
					...
					if var_29_6 == var_6.CheckFailure then
						...
						var_6(var_29_9, var_1_10008("word_manga_checkfailure"))
						...
						if var_29_6 == var_6.Updating then
							...
							var_6(var_29_10, var_1_10008("word_manga_updating", arg_29_0.group.downloadCount, arg_29_0.group.downloadTotal))
							...
							if var_29_6 == var_6.UpdateSuccess then
								...
								var_6(var_29_11, var_1_10008("word_manga_updatesuccess"))
								...
								if var_29_6 == var_6.UpdateFailure then
									...
									var_6(var_29_12, var_1_10008("word_manga_updatefailure"))
...
function var_0_1.updateBtnList(arg_34_0)
	...
	var_34_0(var_34_1, arg_34_0.isShowLike)
	...
	var_34_4(var_34_3, not arg_34_0.isShowNotRead)

	setActive = var_34_4

	var_34_4(var_34_5, arg_34_0.isShowNotRead)
	...
	var_34_8(var_34_7, arg_34_0.isUpOrder)

	setActive = var_34_8

	var_34_8(var_34_9, not arg_34_0.isUpOrder)
...
function var_0_1.openMangaViewLayer(arg_37_0, arg_37_1)
	...
	local var_37_1 = var_1_10003.New
	local var_37_2 = {}

	MangaFullScreenMediator = var_1_10005
	var_37_2.mediator = var_1_10005
	MangaFullScreenLayer = var_1_10005
	var_37_2.viewComponent = var_1_10005
	...
	var_37_3.isShowingNotRead = var_6(var_7.Find(var_37_4, "ShowingNotRead"))
...
function var_0_1.updateLineAfterRead(arg_39_0, arg_39_1)
	...
	if var_39_2(var_39_1, var_1_10005(var_39_0)) then
		local var_39_3 = var_3:Find("Content/Bottom/BottomNew")
		local var_39_4 = var_3:Find("Content/Bottom/BottomNotRead")
		local var_39_5 = var_3:Find("Content/Bottom/BottomNormal")
		local var_39_6 = var_3
		local var_39_7 = var_3.Find(var_39_6, "TopSpecial")

		MangaConst = var_39_6

		local var_39_8 = var_39_6.isMangaEverReadByID(arg_39_1)

		MangaConst = var_9

		local var_39_9 = var_9.isMangaNewByID(arg_39_1)

		setActive = var_10

		var_10(var_39_3, var_39_9 and not var_39_8)

		setActive = var_10

		var_10(var_39_4, not var_39_9 and not var_39_8)

		setActive = var_10

		var_10(var_39_5, var_39_8)

		setActive = var_10

		var_10(var_39_7, not var_39_8)
	end
...
function var_0_1.updateToMangaID(arg_40_0, arg_40_1)
	...
	var_40_4(var_40_3, var_40_5, var_1_10007(var_40_2, -1))
...
function var_0_1.getMangaIDListForShow(arg_41_0, arg_41_1)
	...
	for iter_41_0, iter_41_1 in var_1_10003(var_1_10004.cartoon.all) do
		if arg_41_0:isMangaExist(iter_41_1) then
			...
			local var_41_2 = var_9.isMangaLikeByID(iter_41_1)
...
function var_0_1.isMangaExist(arg_43_0, arg_43_1)
	...
	DownloadState = var_43_1

	local var_43_3

	if var_43_2 ~= var_43_1.None then
		DownloadState = var_4
