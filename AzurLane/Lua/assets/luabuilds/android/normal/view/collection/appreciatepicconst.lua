...
function var_0.getRandomLoadingPic()
	...
	local var_5_4 = var_5_2.filterExistGalleryPicIDList(var_5_1)

	AppreciatePicConst = var_4

	local var_5_5 = var_4.filterExistMangaPicIDList(var_5_3)

	getProxy = var_5
	LoadingPicProxy = var_1_10006

	local var_5_6 = var_5(var_1_10006)
...
function var_0.checkDownloadMissingPic(arg_6_0)
	...
	if var_1_10004(var_1_10005) then
		...
		var_6_1 = var_5.getGalleryPicIDList(var_1_10006)
		getProxy = var_5
		LoadingPicProxy = var_1_10006
		var_1_10006 = var_5(var_1_10006)
		var_6_2 = var_5.getMangaPicIDList(var_1_10006)
	end
	...
	for iter_6_0, iter_6_1 in var_1_10006(var_6_0) do
		...
		if var_1_10011.GetGalleryPicPathByID(iter_6_1) then
			...
			var_12.insert(var_6_3, var_1_10011)

			table = var_12

			var_12.insert(var_6_3, var_1_10011 .. "_hx")
		end
	end
	...
	if var_6_3 and #var_6_3 > 0 then
		...
		var_6_4.isShowBox = false
		var_6_4.fileList = var_6_3
		var_6_4.finishFunc = arg_6_0

		function var_6_4.onNo()
			return
		end

		function var_6_4.onClose()
			return
		end

		DownloadConst = var_7

		var_7.Download(var_6_4)
	elseif arg_6_0 then
		arg_6_0()
	end
...
function var_0.isUsedPicInfo(arg_9_0)
	...
	if arg_9_0.type == var_0.TYPE_GALLERY then
		...
		var_9_0 = var_9_1(var_3.getGalleryPicIDList(var_1_10004, true), arg_9_0.id)
	elseif arg_9_0.type == var_0.TYPE_MANGA then
		...
		local var_9_3 = var_3(var_1_10004)

		var_9_0 = var_9_2(var_3.getMangaPicIDList(var_9_3, true), arg_9_0.id)
	end
