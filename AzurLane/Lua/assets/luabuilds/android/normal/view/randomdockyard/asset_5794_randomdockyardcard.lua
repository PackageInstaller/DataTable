...
function var_0_0.Flush(arg_4_0)
	...
	PLATFORM_CODE = var_4_4
	PLATFORM_US = var_1_10009

	var_1_10002(var_4_1, var_4_3(var_4_2, var_1_10006(var_4_5, var_4_4 == var_1_10009 and 6 or 7)))

	local var_4_6 = arg_4_0.lockTr.gameObject
	local var_4_7 = var_2.SetActive
	local var_4_8 = var_4_0
	local var_4_9 = var_4_0.GetLockState(var_4_8)

	Ship = var_4_8

	var_4_7(var_4_6, var_4_9 == var_4_8.LOCK_STATE_LOCK)
