...
function var_0_1.init(arg_3_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_3_0.titleImg = var_3_2(var_3_1, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_3_0.titleEnImg = var_3_5(var_3_4, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.tipTxt = var_3_18(var_3_17, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.selectedTxt = var_3_21(var_3_20, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.sortTxt = var_3_27(var_3_26, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.selectedCntTxt = var_3_34(var_3_33, var_3(var_1_10004))
	...
	var_1(var_3_38, var_3_37("random_ship_custom_mode_main_empty"))

	setText = var_1

	local var_3_39 = arg_3_0.addBtn
	local var_3_40 = var_2.Find(var_3_39, "Text")

	i18n = var_3_39

	var_1(var_3_40, var_3_39("random_ship_custom_mode_main_button_add"))

	setText = var_1

	local var_3_41 = arg_3_0.removeBtn
	local var_3_42 = var_2.Find(var_3_41, "Text")

	i18n = var_3_41

	var_1(var_3_42, var_3_41("random_ship_custom_mode_main_button_remove"))

	setText = var_1

	local var_3_43 = arg_3_0.cancelBtn
	local var_3_44 = var_2.Find(var_3_43, "Text")

	i18n = var_3_43

	var_1(var_3_44, var_3_43("text_cancel"))

	setText = var_1

	local var_3_45 = arg_3_0.confirmBtn
	local var_3_46 = var_2.Find(var_3_45, "Text")

	i18n = var_3_45

	var_1(var_3_46, var_3_45("text_confirm"))

	setText = var_1

	local var_3_47 = arg_3_0.allBtn
	local var_3_48 = var_2.Find(var_3_47, "Text")

	i18n = var_3_47

	var_1(var_3_48, var_3_47("random_ship_custom_mode_select_all"))
...
function var_0_1.InitDefault(arg_4_0)
	...
	i18n = var_4
	var_4_10.cn = var_4("random_ship_custom_mode_add_title")
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_3()
		...
		NewSettingsScene = var_2_10004
		var_9_4.page = var_2_10004.PAGE_OPTION
		SettingsRandomFlagShipAndSkinPanel = var_4
		var_9_4.scroll = var_4
	...
	var_5_0(var_5_1, var_5_2, var_5_3, var_1_10005)
	...
	var_5_0(var_5_4, var_5_5, var_5_6, var_1_10005)
	...
	var_5_0(var_5_7, var_5_8, var_5_9, var_1_10005)
	...
	var_5_0(var_5_10, var_5_11, var_5_12, var_1_10005)
	...
	var_5_0(var_5_13, var_5_14, var_5_15, var_1_10005)
	...
	var_5_0(var_5_16, var_5_17, var_5_18, var_1_10005)
	...
	var_5_0(var_5_19, var_5_20, var_5_21, var_1_10005)
	...
	var_5_0(var_5_22, var_5_23, var_5_24, var_1_10005)
	...
	var_5_0(var_5_25, var_5_26, var_5_27, var_1_10005)
	...
	local function var_5_30()
		...
		RandomDockYardMediator = var_2_10002

		var_18_1(var_18_0, var_2_10002.OPEN_INDEX, {
	...
	var_5_0(var_5_28, var_5_29, var_5_30, var_1_10005)
	...
	local var_5_33 = var_3.Find(var_5_32, "off")
	...
	local function var_5_34()
		...
		var_20_1(var_20_0, var_2_10002.OPEN_PHANTOM_LAYER)
	...
	var_5_0(var_5_31, var_5_33, var_5_34, var_5)
...
function var_0_1.GetRandomFlagShips(arg_21_0)
	if not arg_21_0.randomFlagShips then
		...
		local var_21_0 = var_1(var_1_10002)
		...
		for iter_21_0, iter_21_1 in var_1_10003(var_21_2:getRandomFlagShipPhantomMarks()) do
...
function var_0_1.GetDockYardShipAndNotInRandom(arg_22_0)
	if not arg_22_0.dockyardShips then
		local var_22_0 = arg_22_0:GetRandomFlagShips()
		local var_22_1 = {}

		ipairs = var_1_10003

		for iter_22_0, iter_22_1 in var_1_10003(var_22_0) do
			var_22_1[iter_22_1.id] = true
		end
		...
		local var_22_3 = var_3.getRawData(var_22_2)

		pairs = var_22_2

		for iter_22_2, iter_22_3 in var_22_2(var_22_3) do
			if not var_22_1[iter_22_3.id] and not iter_22_3:isActivityNpc() then
				table = var_9
...
function var_0_1.Switch(arg_24_0, arg_24_1)
	...
	if arg_24_0.mode == var_0_1.MODE_VIEW then
		...
		var_24_2(var_24_1, var_5.getCount(arg_24_0.selected))
	end
...
function var_0_1.OnConfirm(arg_26_0)
	...
	local function var_26_1()
		if arg_26_0.mode == var_0_1.MODE_ADD then
			...
			var_27_1(var_27_0, var_2_10002.ON_ADD_SHIPS, var_26_0)
		elseif arg_26_0.mode == var_0_1.MODE_REMOVE then
			...
			var_27_3(var_27_2, var_2_10002.ON_REMOVE_SHIPS, var_26_0)
		end
...
function var_0_1.OnAll(arg_28_0)
	...
	var_28_2(var_28_1, var_3.getCount(arg_28_0.selected))
...
function var_0_1.OnItemUpdate(arg_32_0, arg_32_1)
	...
	local function var_32_3()
		...
		var_33_1(var_33_0, var_2_10002.getCount(arg_32_0.selected))
	...
	var_3(var_32_1, var_32_2, var_32_3, var_1_10007)
...
function var_0_1.FilterShips(arg_37_0, arg_37_1, arg_37_2)
	...
	local function var_37_3(arg_38_0)
		local var_38_0 = not var_37_0 or not not arg_38_0:IsLocked()
		local var_38_1

		if var_37_1 then
			var_2_10003 = arg_38_0
			var_38_1 = not not arg_38_0.IsPreferenceTag(var_2_10003)
		...
		local var_38_3 = var_4.filterByCamp(arg_38_0, var_37_2.campIndex)
...
function var_0_1.SortShips(arg_39_0, arg_39_1)
	...
	var_39_5(var_39_6, var_9(var_39_3))

	local var_39_7 = arg_39_0.sortTxt

	i18n = var_39_6
	var_39_7.text = var_39_6(var_39_4)
