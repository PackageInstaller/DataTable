...
function var_0_1.OnLoaded(arg_2_0)
	...
	NewNavalTacticsSkillCard = var_2_4
	var_2_6[1] = var_2_4.New(arg_2_0.skillTpl)
	...
	local var_2_8 = var_2.Find(var_2_7, "Image")

	i18n = var_2_7

	var_1(var_2_8, var_2_7("tactics_class_start"))

	setText = var_1

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_2.Find(var_2_9, "frame/bg/title")

	i18n = var_2_9

	var_1(var_2_10, var_2_9("nav_tactics_sel_skill_title"))
...
function var_0_1.OnInit(arg_5_0)
	...
	local function var_5_5()
		if not arg_5_0.selSkill or not arg_5_0.selIndex then
			...
			var_7_1(var_7_0, var_2_10002("tactics_should_exist_skill"))
		...
		if var_0.IsMaxLevel(var_7_2) then
			...
			var_7_4(var_7_3, var_2_10002("tactics_max_level"))
		...
		var_7_7(var_7_6, var_2.ON_SKILL_SELECTED, arg_5_0.student)
...
function var_0_1.UpdateSkillList(arg_11_0, arg_11_1)
	...
	for iter_11_0 = 1, var_4 do
		...
		ShipSkill = var_1_10014

		var_11_5(var_11_4, var_11_6, var_1_10014.New(var_2.skills[var_11_3], var_2.id))
	end
...
function var_0_1.UpdateSkill(arg_13_0, arg_13_1, arg_13_2)
	...
	if not arg_13_0.skillCards[arg_13_1] then
		...
		Object = var_1_10005
		var_13_1 = var_13_0(var_1_10005.Instantiate(arg_13_0.skillTpl, arg_13_0.skillTpl.parent))
