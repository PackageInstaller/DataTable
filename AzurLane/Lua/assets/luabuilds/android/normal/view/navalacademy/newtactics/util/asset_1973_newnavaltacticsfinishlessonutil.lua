...
function var_0_0.Excute(arg_4_0)
	...
	if var_4_0 == var_1_10003.CANCEL_TYPE_QUICKLY then
		...
		var_4_0(var_4_1, var_1_10004.QUICK_FINISH_LEARN_TACTICS, {
			shipId = var_1[1]
		})
	else
		pg = var_4_0
		...
		var_4_3(var_4_2, var_1_10004.CANCEL_LEARN_TACTICS, {
			shipId = var_1[1],
			type = var_1[2]
		})
	end
...
function var_0_0.NextOne(arg_5_0)
	...
	var_5_1(var_5_0, var_3.ON_FINISH_ONE_ANIM)
...
function var_0_0.DisplayResult(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5)
	...
	local var_9_1 = var_1_10007(var_1_10008)
...
function var_0_0.HandleMaxLevel(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5, arg_10_6)
	...
	local var_10_1 = arg_10_2.getSkillList(var_10_0)

	_ = var_10_0

	if var_10_0.all(var_10_1, function(arg_11_0)
		...
		local var_10_2 = var_8.MsgboxMgr.GetInstance()

		var_8.ShowMsgBox(var_10_2, {
			modal = true,
			hideNo = true,
			hideClose = true,
			content = arg_10_3,
...
function var_0_0.WhetherToContinueForOtherSkill(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4, arg_13_5)
	...
	local var_13_1 = var_13_0 .. var_7("tactics_continue_to_learn_other_skill")
	...
	var_7.ShowMsgBox(var_13_2, {
		...
		onYes = function()
			...
			if var_0.ExistBook(var_14_0) then
				...
				var_14_3(var_14_2, var_2_10002("tactics_no_lesson"))
	...
	var_5.ShowMsgBox(var_19_1, {
		...
		onYes = function()
			...
			if var_0.ExistBook(var_20_0) then
				...
				var_20_3(var_20_2, var_2_10002("tactics_no_lesson"))
...
function var_0_0.ExistBook(arg_22_0)
	...
	return #var_22_1(var_22_0, var_1_10003.LESSON_TYPE) > 0
end
...
function var_0_0.ContinuousLearning(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	local var_23_3 = var_23_1.indexof(var_23_2, arg_23_3)

	assert = var_7

	var_7(var_23_3 and var_23_3 > 0)
