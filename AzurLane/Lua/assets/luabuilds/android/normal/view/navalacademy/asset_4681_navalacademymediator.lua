...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_GET_CLASS_RES, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_10003.HARVEST_CLASS_RES)
	...
	arg_1_0:bind(var_0_1.ON_GET_RES, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.HARVEST_RES, arg_3_1)
	...
	arg_1_0:bind(var_0_1.GO_TASK_SCENE, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_4_2, var_2_10005.TASK, arg_4_1)
	...
	arg_1_0:bind(var_0_1.TASK_GO, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10004.TASK_GO, arg_5_1)
	...
	arg_1_0:bind(var_0_1.ACTIVITY_OP, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.ACTIVITY_OPERATION, arg_6_1)
	...
	arg_1_0:bind(var_0_1.OPEN_ACTIVITY_SHOP, function(arg_8_0)
		...
		local var_8_3 = var_2_10004.SHOP
		local var_8_4 = {}

		NewShopsScene = var_2_10006
		var_8_4.warp = var_2_10006.TYPE_ACTIVITY
	...
	arg_1_0:bind(var_0_1.OPEN_ACTIVITY_PANEL, function(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_9_2, var_2_10005.ACTIVITY, {
			id = arg_9_1
		})
	...
	arg_1_0:bind(var_0_1.GO_SCENE, function(arg_10_0, arg_10_1)
		...
		var_10_1(var_10_0, var_2_10004.GO_SCENE, arg_10_1[1], arg_10_1[2])
	...
	arg_1_0:bind(var_0_1.UPGRADE_FIELD, function(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_2_10004.SHOPPING, {
			count = 1,
			id = arg_11_1
		})
	...
	arg_1_0:bind(var_0_1.ON_OPEN_CLASSROOM, function(arg_12_0)
		...
		var_12_1(var_12_0, var_12_2, var_2_10004.CLASS)
	...
	arg_1_0:bind(var_0_1.ON_OPEN_COMMANDER, function(arg_13_0)
		...
		local var_13_3 = var_2_10004.COMMANDERCAT
		local var_13_4 = {}

		CommanderCatScene = var_2_10006
		var_13_4.fleetType = var_2_10006.FLEET_TYPE_COMMON
	...
	arg_1_0:bind(var_0_1.ON_OPEN_SUPPLYSHOP, function(arg_17_0)
		...
		local var_17_3 = var_2_10004.SHOP
		local var_17_4 = {}

		NewShopsScene = var_2_10006
		var_17_4.warp = var_2_10006.TYPE_SHOP_STREET
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_OPEN_MINIGAMEHALL, function(arg_19_0)
		...
		var_19_1(var_19_0, var_19_2, var_2_10004.GAME_HALL)
...
function var_0_1.handleNotification(arg_21_0, arg_21_1)
	...
	if var_21_0 == var_21_1.LOAD_LAYERS then
		var_1_10005 = arg_21_0.viewComponent

		var_4.OnAddLayer(var_1_10005)
	else
		GAME = var_4

		if var_21_0 == var_4.REMOVE_LAYERS then
			var_1_10005 = arg_21_0.viewComponent

			var_4.OnRemoveLayer(var_1_10005, var_21_2)
		else
			GAME = var_4

			local var_21_3

			if var_21_0 == var_4.HARVEST_RES_DONE then
				var_1_10005 = arg_21_0.viewComponent

				var_21_3.OnGetRes(var_1_10005, var_21_2.type, var_21_2.outPut)
				...
				var_21_3(var_1_10005, var_1_10006("battle_levelMediator_ok_takeResource"))
			else
				PlayerProxy = var_21_3

				if var_21_0 == var_21_3.UPDATED then
					var_1_10005 = arg_21_0.viewComponent

					var_4.UpdatePlayer(var_1_10005, var_21_2)
				else
					NavalAcademyProxy = var_4

					local var_21_4

					if var_21_0 == var_4.RESOURCE_UPGRADE then
						var_1_10005 = arg_21_0.viewComponent
						var_21_4 = var_21_4.UpdatePlayer
						getProxy = var_1_10006
						PlayerProxy = var_1_10007
						var_1_10007 = var_1_10006(var_1_10007)

						var_21_4(var_1_10005, var_1_10006.getData(var_1_10007))

						var_1_10005 = arg_21_0.viewComponent

						var_21_4.OnStartUpgradeResField(var_1_10005, var_21_2.resVO)
					else
						NavalAcademyProxy = var_21_4

						local var_21_5

						if var_21_0 == var_21_4.RESOURCE_UPGRADE_DONE then
							var_21_5 = var_21_2.field
							isa = var_1_10005
							var_1_10006 = var_21_5
							GoldResourceField = var_1_10007

							local var_21_6

							if var_1_10005(var_1_10006, var_1_10007) then
								pg = var_21_6
								var_21_6 = var_21_6.navalacademy_data_template[3].name
								pg = var_1_10006
								var_1_10007 = var_1_10006.TipsMgr.GetInstance()
								var_1_10006 = var_1_10006.ShowTips
								i18n = var_1_10008

								var_1_10006(var_1_10007, var_1_10008("main_navalAcademyScene_upgrade_complete", var_21_6, var_21_2.value))
							else
								isa = var_21_6
								var_1_10006 = var_21_5
								OilResourceField = var_1_10007

								local var_21_7

								if var_21_6(var_1_10006, var_1_10007) then
									pg = var_21_7
									var_21_7 = var_21_7.navalacademy_data_template[4].name
									pg = var_1_10006
									var_1_10007 = var_1_10006.TipsMgr.GetInstance()
									var_1_10006 = var_1_10006.ShowTips
									i18n = var_1_10008

									var_1_10006(var_1_10007, var_1_10008("main_navalAcademyScene_upgrade_complete", var_21_7, var_21_2.value))
								else
									isa = var_21_7
									var_1_10006 = var_21_5
									ClassResourceField = var_1_10007

									if var_21_7(var_1_10006, var_1_10007) then
										pg = var_5

										local var_21_8 = var_5.navalacademy_data_template[1].name
										...
										var_1_10006(var_1_10007, var_1_10008("main_navalAcademyScene_class_upgrade_complete", var_21_8, var_21_2.value, var_21_2.rate, var_21_2.exp))
									end
								end
							end
							...
							var_5.OnResFieldLevelUp(var_1_10006, var_21_5)
						else
							CollectionProxy = var_21_5

							if var_21_0 == var_21_5.TROPHY_UPDATE then
								local var_21_9 = arg_21_0.viewComponent

								var_4.OnCollectionUpdate(var_21_9)
							else
								GAME = var_4
								...
								if var_21_0 == var_4.BEGIN_STAGE_DONE then
									...
									local var_21_12 = var_1_10006.GO_SCENE

									SCENE = var_1_10007

									var_21_11(var_21_10, var_21_12, var_1_10007.COMBATLOAD, var_21_2)
								else
									ActivityProxy = var_21_11

									if var_21_0 == var_21_11.ACTIVITY_OPERATION_DONE then
										local var_21_13 = arg_21_0.viewComponent

										var_4.RefreshChars(var_21_13)
									else
										GAME = var_4

										if var_21_0 == var_4.HARVEST_CLASS_RES_DONE then
											local var_21_14 = arg_21_0.viewComponent

											var_4.OnGetRes(var_21_14, 3, var_21_2.value)
										end
									end
								end
							end
