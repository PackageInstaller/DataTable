...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	NavalAcademyProxy = var_4_1

	local var_4_3

	if var_4_0 == var_4_1.RESOURCE_UPGRADE_DONE then
		var_4_3 = var_4_2.field
		isa = var_1_10005

		local var_4_4 = var_4_3

		ClassResourceField = var_1_10007

		if var_1_10005(var_4_4, var_1_10007) then
			pg = var_1_10005

			local var_4_5 = var_1_10005.TipsMgr.GetInstance()

			var_1_10005 = var_1_10005.ShowTips
			i18n = var_1_10007

			local var_4_6 = "main_navalAcademyScene_class_upgrade_complete"

			pg = var_1_10009

			var_1_10005(var_4_5, var_1_10007(var_4_6, var_1_10009.navalacademy_data_template[1].name, var_4_2.value, var_4_2.rate, var_4_2.exp))
		end

		local var_4_7 = arg_4_0.viewComponent

		var_1_10005.OnUpdateResField(var_4_7, var_4_3)
	else
		NavalAcademyProxy = var_4_3

		if var_4_0 == var_4_3.RESOURCE_UPGRADE then
			var_1_10005 = arg_4_0.viewComponent

			var_4.OnUpdateResField(var_1_10005, var_4_2.resVO)
		else
			NavalAcademyProxy = var_4

			if var_4_0 == var_4.COURSE_UPDATED then
				getProxy = var_4
				NavalAcademyProxy = var_1_10005

				local var_4_8 = var_4(var_1_10005)
				local var_4_9 = var_4.getCourse(var_4_8)
				local var_4_10 = arg_4_0.viewComponent

				var_5.SetCourse(var_4_10, var_4_9)

				local var_4_11 = arg_4_0.viewComponent

				var_5.InitClassInfo(var_4_11)
			end
		end
	end
