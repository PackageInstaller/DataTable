...
function var_0_1.Hide(arg_4_0)
	...
	var_4_1(var_4_0, var_4_2, var_1_10004.UIMgr.GetInstance().UIMain)
...
function var_0_1.setData(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_0 = var_3(var_1_10004)
...
function var_0_1.initUITip(arg_7_0)
	...
	var_7_6(var_7_8, var_1_10007("meta_tactics_detail"))
	...
	var_7_6(var_7_9, var_7("meta_tactics_unlock"))
	...
	var_7_6(var_7_10, var_7("meta_tactics_switch"))
...
function var_0_1.addListener(arg_9_0)
	...
	local function var_9_5()
		...
		var_11_1(var_11_0, var_11_2, var_2_10003.METACHARACTER, {
	...
	local function var_9_8()
		...
		MSGBOX_TYPE_META_SKILL_UNLOCK = var_2_10003
	...
	local function var_9_11()
		...
		var_13_1(var_13_0, var_2_10002.TACTICS_META_SWITCH_SKILL, {
...
function var_0_1.updateSkillTF(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_11 = var_3:Find("Tag/unlockable")
	local var_14_12 = arg_14_0.metaShipVO
	local var_14_13 = var_15.getMetaSkillLevelBySkillID(var_14_12, arg_14_2)

	getSkillConfig = var_14_12

	local var_14_14 = var_14_12(arg_14_2)
	local var_14_15 = arg_14_2 == arg_14_0.metaTacticsInfo.curSkillID
	local var_14_16 = var_14_13 > 0

	setImageSprite = var_1_10019

	local var_14_17 = var_14_4

	LoadSprite = var_1_10021

	var_1_10019(var_14_17, var_1_10021("skillicon/" .. var_14_14.icon))

	setText = var_1_10019

	local var_14_18 = var_14_5

	getSkillDesc = var_21

	var_1_10019(var_14_18, var_21(arg_14_2, var_14_16 and var_14_13 or 1))

	setText = var_1_10019

	local var_14_19 = var_14_8

	getSkillName = var_21

	var_1_10019(var_14_19, var_21(var_14_14.id))

	setText = var_1_10019

	var_1_10019(var_14_9, var_14_13)

	local var_14_20 = arg_14_0.metaTacticsInfo
	local var_14_21 = var_19.getSkillExp(var_14_20, arg_14_2)

	pg = var_14_20

	if not (var_14_13 >= var_14_20.skill_data_template[arg_14_2].max_level) then
		if var_14_16 then
			MetaCharacterConst = var_22

			local var_14_22 = var_22.getMetaSkillTacticsConfig(arg_14_2, var_14_13).need_exp

			setText = var_24

			local var_14_23 = var_14_7

			setColorStr = var_1_10026

			local var_14_24 = var_14_21

			COLOR_GREEN = var_1_10028

			var_24(var_14_23, var_1_10026(var_14_24, var_1_10028) .. "/" .. var_14_22)
	...
	var_22(var_14_10, var_14_15 and not var_21)

	setActive = var_22

	var_22(var_14_11, not var_14_16)

	setActive = var_22

	var_22(var_14_3, not var_14_16)

	onToggle = var_22

	local var_14_25 = arg_14_0
	local var_14_26 = arg_14_1

	local function var_14_27(arg_15_0)
		if arg_15_0 then
...
function var_0_1.updateButtons(arg_18_0, arg_18_1)
	...
	if var_18_0 or var_18_4 then
		...
		var_18_3(arg_18_0.detailBtn, true)

		setActive = var_18_3

		var_18_3(arg_18_0.unlockBtn, false)

		setActive = var_18_3

		var_18_3(arg_18_0.switchBtn, false)
	elseif not var_18_2 then
		...
		var_18_3(arg_18_0.unlockBtn, true)
	...
	elseif var_18_2 and not var_18_0 then
		...
		var_18_3(arg_18_0.switchBtn, true)
	end
