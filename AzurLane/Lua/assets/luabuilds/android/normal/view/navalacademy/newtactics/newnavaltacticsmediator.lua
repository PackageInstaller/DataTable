...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_SKILL, function(arg_4_0, arg_4_1, arg_4_2)
		...
		NavalTacticsSkillInfoLayer = var_2_10007
	...
	arg_1_0:bind(var_0_1.ON_START, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.START_TO_LEARN_TACTICS, arg_6_1)
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_QUICK_FINISH, function(arg_8_0, arg_8_1)
		...
		if var_2.IsInAddStudentProcess(var_8_0) then
			...
			var_8_5(var_8_4, var_8_6, var_2_10005.CANCEL_TYPE_QUICKLY)
		end
...
function var_0_1.SelectShip(arg_9_0, arg_9_1)
	...
	local var_9_1 = var_1_10003(var_1_10004)
	...
	local var_9_5 = iter_9_0.New
	local var_9_6 = {}

	NavTacticsDockyardScene = var_1_10009
	var_9_6.viewComponent = var_1_10009
	DockyardMediator = var_1_10009
	var_9_6.mediator = var_1_10009
...
function var_0_1.handleNotification(arg_13_0, arg_13_1)
	...
	NavalAcademyProxy = var_13_1

	if var_13_0 == var_13_1.SKILL_CLASS_POS_UPDATED then
		local var_13_3 = arg_13_0.viewComponent

		var_4.OnUnlockSlot(var_13_3)
	else
		GAME = var_4

		if var_13_0 == var_4.START_TO_LEARN_TACTICS_DONE then
			local var_13_4 = arg_13_0.viewComponent

			var_4.OnAddStudent(var_13_4)

			local var_13_5 = arg_13_0.viewComponent

			var_4.ResendCancelOp(var_13_5, arg_13_0.cancelList)

			arg_13_0.cancelList = {}
		elseif var_13_0 == var_0_1.ON_CANCEL_ADD_STUDENT then
			local var_13_6 = arg_13_0.viewComponent

			var_4.ResendCancelOp(var_13_6, arg_13_0.cancelList)
			...
			if var_13_0 == var_4.CANCEL_LEARN_TACTICS_DONE then
				var_13_7 = var_13_2.id

				local var_13_8 = var_13_2.totalExp

				ShipSkill = var_1_10006

				local var_13_9 = var_1_10006.New(var_13_2.oldSkill)

				ShipSkill = var_7

				local var_13_10 = var_7.New(var_13_2.newSkill)
				local var_13_11 = var_13_2.shipId
				local var_13_12 = arg_13_0.viewComponent.finishLessonUtil

				var_9.WaitForFinish(var_13_12, var_13_7, var_13_11, var_13_8, var_13_9, var_13_10)
			else
				GAME = var_13_7

				if var_13_0 == var_13_7.CANCEL_LEARN_TACTICS then
					local var_13_13 = arg_13_0.viewComponent

					var_4.BlockEvents(var_13_13)
				elseif var_13_0 == var_0_1.ON_FINISH_ONE_ANIM then
					local var_13_14 = arg_13_0.viewComponent

					var_4.UnblockEvents(var_13_14)

					local var_13_15 = arg_13_0.viewComponent

					var_4.OnExitStudent(var_13_15)
				else
					GAME = var_4

					if var_13_0 == var_4.TACTICS_META_UNLOCK_SKILL_DONE then
						local var_13_16 = arg_13_0.viewComponent

						var_4.OnUpdateMetaSkillPanel(var_13_16, var_13_2.metaShipID)
					else
						GAME = var_4

						if var_13_0 == var_4.TACTICS_META_SWITCH_SKILL_DONE then
							local var_13_17 = arg_13_0.viewComponent

							var_4.OnUpdateMetaSkillPanel(var_13_17, var_13_2.metaShipID)
						else
							GAME = var_4

							if var_13_0 == var_4.QUICK_FINISH_LEARN_TACTICS_DONE then
								local var_13_18 = arg_13_0.viewComponent

								var_4.BlockEvents(var_13_18)

								local var_13_19 = arg_13_0.viewComponent

								var_4.OnUpdateQuickFinishPanel(var_13_19)
							end
						end
					end
				end
