...
function var_0_1.getUIName(arg_1_0)
	...
	local var_1_3 = var_3.activity_banner[var_1_2[1]] and var_3.pic

	pg = var_1_10005

	local var_1_4

	if not var_1_10005.naval_academy_theme[var_1_3] or not var_5.resource_path then
...
function var_0_1.init(arg_10_0)
	...
	ShopBuiding = var_10_3
	var_10_4[1] = var_10_3.New(arg_10_0)
...
function var_0_1.OpenDefaultLayer(arg_16_0)
	...
	if arg_16_0.warp == var_0_1.WARP_TO_TACTIC then
		...
		var_16_1(var_16_0, var_1_10003.ON_OPEN_TACTICROOM)
	end
...
function var_0_1.OnRemoveLayer(arg_25_0, arg_25_1)
	...
	if arg_25_0.layerCnt <= 0 then
		...
		arg_25_0.EnableEffects(var_25_1, true)
	end

	local var_25_2 = arg_25_1.context.mediator

	NewNavalTacticsMediator = var_25_1

	if var_25_2 == var_25_1 then
		local var_25_3 = arg_25_0.buildings[5]

		var_2.RefreshTip(var_25_3)
	end
...
function var_0_1.OnStartUpgradeResField(arg_28_0, arg_28_1)
	...
	OilResourceField = var_1_10005

	local var_28_2

	if var_1_10003(var_28_1, var_1_10005) then
		...
		GoldResourceField = var_1_10005

		if var_28_2(var_28_3, var_1_10005) then
			...
			if var_28_2(var_28_4, var_1_10005) then
...
function var_0_1.GetEffect(arg_33_0, arg_33_1, arg_33_2)
	...
	var_33_1(var_33_0, var_33_2, var_33_3, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_34_0)
