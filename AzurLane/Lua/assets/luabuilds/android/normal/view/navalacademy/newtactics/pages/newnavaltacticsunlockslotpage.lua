...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.discountDateTxt = var_2_5(var_2_4, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.discountTxt = var_2_8(var_2_7, var_3(var_1_10004))
	...
	local var_2_15 = var_2.Find(var_2_14, "pic")
...
function var_0_1.Show(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_2 = var_8_0(var_8_1, var_1_10005.TYPE_SHOPSTREET)
...
function var_0_1.Flush(arg_9_0, arg_9_1)
	...
	if arg_9_1.isDisCount(var_9_0) then
		arg_9_0:UpdateDiscountView(arg_9_1)
	else
		var_9_0 = arg_9_1:GetPrice()

		local var_9_1 = arg_9_0.contentTxt

		i18n = var_1_10005
		var_9_1.text = var_1_10005("open_skill_pos", var_9_0)
	end

	setActive = var_9_0

	var_9_0(arg_9_0.discountDateTxt.gameObject, var_2)

	setActive = var_9_0

	var_9_0(arg_9_0.discountTxt.gameObject.transform.parent, var_2)
...
function var_0_1.UpdateDiscountView(arg_10_0, arg_10_1)
	...
	local var_10_4 = arg_10_0.contentTxt

	i18n = var_7
	var_10_4.text = var_7("open_skill_pos_discount", var_10_3, var_10_0)
	onNextTick = var_10_4
...
function var_0_1.AddTimer(arg_12_0, arg_12_1)
	...
	arg_12_0.timer = var_1_10002.New(function()
		...
		if arg_12_1 - var_13_1 <= 0 then
			...
			local var_13_6 = var_4.WarpDateTip(var_13_5, var_1)

			i18n = var_13_5

			if var_13_2(var_13_4, var_13_6 .. var_13_5("word_date")) ~= arg_12_0.str then
