...
function var_0_1.init(arg_5_0)
	...
	var_1(var_2.Find(var_5_3, "list_card/types"), false)
...
function var_0_1.updateCardList(arg_15_0)
	...
	if arg_15_0.contextData.isRepair then
		...
		pg = var_1_10005
		var_15_2 = var_15_3(var_1_10005.lover_letter_content.get_id_list_by_year[2018], function(arg_16_0)
			pg = var_2_10001
	...
	for iter_15_0, iter_15_1 in var_15_3(var_15_2) do
		...
		if not var_1_10009 then
			...
			local var_15_4 = var_11.insertto
			local var_15_5 = {
				iter_15_1
			}
			...
			if var_1_10010(var_15_4(var_15_5, var_1_10013.lover_character_template[iter_15_1].relate_group_id), function(arg_17_0)
	...
	local var_15_6 = var_0_1.ShipIndex.typeIndex

	ShipIndexConst = var_5

	if var_15_6 == var_5.TypeAll then
		var_15_6 = var_0_1.ShipIndex.rarityIndex
		ShipIndexConst = var_5

		if var_15_6 == var_5.RarityAll then
			var_15_6 = var_0_1.ShipIndex.campIndex
			ShipIndexConst = var_5

			if var_15_6 == var_5.CampAll then
				ipairs = var_15_6

				for iter_15_2, iter_15_3 in var_15_6(var_15_1) do
					pg = var_1_10009
					...
					if var_1_10009 then
						...
						local var_15_8 = var_12.IsLinkType

						ShipGroup = var_13
						var_15_7 = var_15_8(var_13.getDefaultShipConfig(var_1_10009.group_type).nationality)
					end

					local var_15_9 = var_1_10009.handbook_type

					if var_0_8(var_15_9, var_15_7, iter_15_3) ~= -1 then
						var_15_0[iter_15_2] = {
							showTrans = false,
							code = var_13,
							group = var_1_10010
	...
	for iter_15_4, iter_15_5 in var_15_6(var_15_1) do
		pg = var_1_10009
		...
		if var_1_10009.ship_data_group[iter_15_5] then
			...
			local var_15_10 = arg_15_0.shipGroups[var_1_10009.group_type]
			...
			if var_1_10010 then
				...
				if var_12.filterByType(var_1_10010, var_0_1.ShipIndex.typeIndex) then
					...
					if var_12.filterByRarity(var_1_10010, var_0_1.ShipIndex.rarityIndex) then
						...
						local var_15_11 = var_12.IsLinkType
						local var_15_12 = var_1_10010
						local var_15_13 = var_15_11(var_1_10010.getNation(var_15_12))
						local var_15_14 = var_1_10009.handbook_type

						ShipIndexConst = var_15_12

						if var_15_12.filterByCamp(var_1_10010, var_0_1.ShipIndex.campIndex) then
							var_15_0[#var_15_0 + 1] = {
								showTrans = false,
								code = var_0_8(var_15_14, var_15_13, iter_15_5),
								group = var_15_10
							}
						end
					end
	...
	local var_15_15 = arg_15_0.cardList

	var_4.SetTotalCount(var_15_15, #arg_15_0.cardInfos, -1)
...
local function var_0_10(arg_19_0)
	...
	local var_19_1 = var_1_10002(var_1_10003)
	...
	if var_4.getShipGroup(var_19_3, arg_19_0) then
		...
		local var_19_4 = var_19_3.getSkinList(arg_19_0)

		ipairs = var_6

		for iter_19_0, iter_19_1 in var_6(var_19_4) do
			...
			if var_19_5 ~= var_1_10012.SKIN_TYPE_DEFAULT then
				...
				if not var_19_5.contains(var_19_2, iter_19_1.id) then
					...
					if var_19_6 ~= var_1_10012.SKIN_TYPE_REMAKE or not var_4.trans then
						...
						if var_19_7 ~= var_1_10012.SKIN_TYPE_PROPOSE or var_4.married ~= 1 then
							var_1_10012 = var_2

							if var_2.hasSkin(var_1_10012, iter_19_1.id) then
...
function var_0_1.onInitCard(arg_20_0, arg_20_1)
	...
	var_3(arg_20_0, var_20_0.go, function()
