...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10003("loveactivity_ui_5"))
	...
	var_1_10001(var_2_1, var_3("loveactivity_ui_7"))
	...
	var_1_10001(var_2_3, var_2_2("loveactivity_ui_8"))
	...
	var_1_10001(var_2_5, var_2_4("loveactivity_ui_8"))
	...
	var_1.make(var_2_6, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			local var_3_2 = arg_3_2.Find(var_3_1, "year")

			tostring = var_3_1

			var_2_10004(var_3_2, var_3_1(var_3_0))

			local var_3_3 = arg_2_0.confirmDic[var_3_0]

			setActive = var_3_2

			var_3_2(arg_3_2:Find("icon/mask/IconTpl"), var_3_3)

			setActive = var_3_2

			var_3_2(arg_3_2:Find("icon/on"), var_3_3)

			setActive = var_3_2

			var_3_2(arg_3_2:Find("now"), var_3_3)
			...
			if var_3_3 then
				...
				var_3_2, var_3_4 = var_3_2(arg_2_0.giftItemList[var_3_3])
				updateDrop = var_7

				local var_3_5 = arg_3_2
				local var_3_6 = arg_3_2.Find(var_3_5, "icon/mask/IconTpl")

				Drop = var_3_5

				local var_3_7 = var_3_5.New
				local var_3_8 = {
					count = 1
				}

				DROP_TYPE_ITEM = var_2_10011
				var_3_8.type = var_2_10011
				var_3_8.id = var_3_2
				var_3_8.extra = var_3_4

				var_7(var_3_6, var_3_7(var_3_8))

				getProxy = var_7
				LoveLetterProxy = var_3_6

				local var_3_9 = var_7(var_3_6)
				local var_3_10 = var_7.GetGroupData(var_3_9, arg_2_0.giftGroupList[var_3_3])

				setLoveLetterMedal = var_3_9

				var_3_9(arg_3_2:Find("now/medal"), var_3_10)
			end

			setActive = var_3_2

			var_3_2(arg_3_2:Find("active/active_off"), not var_3_3)

			setActive = var_3_2

			var_3_2(arg_3_2:Find("active/active_on"), var_3_3)

			setText = var_3_2

			local var_3_11 = arg_3_2
			local var_3_12 = arg_3_2.Find(var_3_11, "active/Text")

			i18n = var_3_11

			var_3_2(var_3_12, var_3_11("loveactivity_ui_6"))

			if not var_3_3 then
				var_3_12 = arg_2_0.heap

				local var_3_13 = var_5.GetLength(var_3_12)
				...
				if 0 < var_3_13 then
					...
					if var_3_0 ~= var_5.GetTop(var_3_12).element then
						var_3_14 = false
					else
						var_3_14 = true
					end
					...
					var_3_12(arg_3_2:Find("icon/tip"), var_3_14)

					setButtonEnabled = var_3_12

					var_3_12(arg_3_2:Find("icon"), var_3_14)

					if var_3_14 then
						onButton = var_3_12

						local var_3_15 = arg_2_0
						local var_3_16 = arg_3_2:Find("icon")
						...
						var_3_12(var_3_15, var_3_16, var_3_17, var_10)
					end
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_8()
		...
		if 0 < var_8_1 then
			pg = var_8_1
			var_8_2 = var_8_1.TipsMgr.GetInstance()

			local var_8_3 = var_0.ShowTips

			i18n = var_2_10002

			var_8_3(var_8_2, var_2_10002("loveactivity_ui_19"))
		...
		for iter_8_0, iter_8_1 in var_8_2(arg_5_0.confirmDic) do
			unpack = var_2_10006
		...
		LoveLetterGiftCollectMediator = var_3

		var_8_7(var_8_6, var_3.ON_RECORD_GIFT, var_8_4)
...
function var_0_1.InitGift(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1_10003(arg_10_0.giftItemList) do
		unpack = var_1_10008
		...
		assert = var_1_10010
		tobool = var_1_10011
		var_1_10011 = var_1_10011(var_10_3)
		pg = var_12

		local var_10_4 = var_12.item_data_statistics[var_1_10008].type

		Item = iter_10_2
		var_1_10011 = var_1_10011 == (var_10_4 == iter_10_2.LOVE_LETTER_TYPE)

		var_1_10010(var_1_10011)
		...
		iter_10_2 = var_10_3 or 0

		for iter_10_2, iter_10_3 in var_1_10010(var_10_1[var_1_10011 .. var_10_5 .. iter_10_2]) do
			assert = var_1_10015
	...
	local var_10_6 = var_3.New

	underscore = var_4
	arg_10_0.heap = var_10_6(var_4.keys(var_10_2), function(arg_11_0)
		return #var_10_2[arg_11_0]
	end)
	underscore = var_3

	local var_10_7 = var_3(arg_10_0.yearDic)
	local var_10_8 = var_3.chain(var_10_7)
	local var_10_9 = var_3.keys(var_10_8)
	local var_10_10 = var_3.sort(var_10_9)

	arg_10_0.tempList = var_3.value(var_10_10)
	assert = var_3
...
function var_0_1.OpenSelectWindow(arg_15_0, arg_15_1)
	...
	var_1_10002(var_15_0, var_1_10004("loveactivity_ui_9", arg_15_1))
	...
	var_3.StaticAlign(arg_15_0.rtSelectScrollContent, arg_15_0.rtSelectScrollTpl, #arg_15_0.yearDic[arg_15_1], function(arg_16_0, arg_16_1, arg_16_2)
		arg_16_1 = arg_16_1 + 1
		UIItemList = var_2_10003
		...
		if arg_16_0 == var_2_10003.EventUpdate then
			...
			local var_16_4 = arg_16_2.Find(var_16_3, "mask/IconTpl")

			Drop = var_16_3

			local var_16_5 = var_16_3.New
			local var_16_6 = {
				count = 1
			}

			DROP_TYPE_ITEM = var_2_10010
			var_16_6.type = var_2_10010
			var_16_6.id = var_16_1
			var_16_6.extra = var_16_2

			var_2_10006(var_16_4, var_16_5(var_16_6))
			...
			var_2_10006(var_16_7, var_16_8, var_16_9, var_2_10010)
		end
	...
	var_3(var_4.GetChild(var_15_2, 0), true)
	...
	var_3(var_15_3, var_15_4, var_15_5, var_7)
