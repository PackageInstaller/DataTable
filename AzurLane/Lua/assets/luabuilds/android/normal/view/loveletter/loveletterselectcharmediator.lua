...
function var_0_1.register(arg_1_0)
	...
	LoveLetterSelectCharLayer = var_1_10003

	var_1_1(var_1_0, var_1_10003.SELECT_CHAR, function(arg_2_0, arg_2_1)
		local var_2_0
		...
		if arg_1_0.contextData.isRepair then
			...
			local var_2_1 = var_2_10004.New

			var_2_10005 = {}
			LoveLetterSelectCharConfirmLayer = var_2_10006
			var_2_10005.viewComponent = var_2_10006
			LoveLetterSelectCharConfirmMediator = var_2_10006
			var_2_10005.mediator = var_2_10006
			var_2_10005.data = {
				isRepair = true,
				groupId = arg_2_1,
			...
			var_2_0(var_2_10003, var_2_1(var_2_10005))
		else
			getProxy = var_2_0
			ActivityProxy = var_2_10003

			local var_2_2 = var_2_0(var_2_10003)
			local var_2_3 = var_2.getActivityById(var_2_2, arg_1_0.contextData.actId)

			if var_2.GetTargetGroupId(var_2_3) == arg_2_1 then
				pg = var_3
				...
				var_2_5(var_2_4, var_2_10005("loveactivity_ui_18"))

				return
			end

			local var_2_6 = arg_1_0
			local var_2_7 = var_3.addSubLayers

			Context = var_2_10005

			local var_2_8 = var_2_10005.New
			local var_2_9 = {}

			LoveLetterSelectCharConfirmLayer = var_2_10007
			var_2_9.viewComponent = var_2_10007
			LoveLetterSelectCharConfirmMediator = var_2_10007
			var_2_9.mediator = var_2_10007
			var_2_9.data = {
				groupId = arg_2_1,
				actId = arg_1_0.contextData.actId
			}

			var_2_7(var_2_6, var_2_8(var_2_9))
		end
	...
	LoveLetterSelectCharLayer = var_3

	var_1_3(var_1_2, var_3.ON_INDEX, function(arg_3_0, arg_3_1)
