...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_1(var_1_0, var_5.ON_HUB_DATA_UPDATE, function(arg_2_0)
	...
	var_1_3(var_1_2, var_5.SEND_MINI_GAME_OP_DONE, function(arg_3_0)
...
function var_0_1.CollectBuffs(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_3(var_4_1.CurrentIconList) do
...
function var_0_1.Init(arg_5_0)
	...
	if not var_5_1 or not arg_5_0.hasTagStartPos then
		var_5_3 = arg_5_0.noTagStartPos
	end

	var_5_2.anchoredPosition = var_1_10004(var_5_3, arg_5_0._tf.anchoredPosition.y, 0)
...
function var_0_1.UpdateFreeUsageSkinTag(arg_8_0)
	...
	local var_8_4 = var_8_3(var_8_2, var_1_10005(var_1_10006))
	...
	local function var_8_7()
		...
		var_9_3(var_9_2, var_2_10003.ON_SKIN_FREEUSAGE_DESC, var_9_1)
	...
	var_4(var_8_5, var_8_6, var_8_7, var_1_10008)
...
function var_0_1.UpdateVirtualBuff(arg_13_0, arg_13_1, arg_13_2)
	...
	local function var_13_2()
		...
		if not arg_13_0.buffDesMsgbox then
			...
			pg = var_2_10002
			var_14_1 = var_14_1(var_2_10002.UIMgr.GetInstance().UIMain)
		end
		...
		var_14_3(var_14_2, var_14_4, var_2_10003.DOA_PT_ID)
	...
	var_1_10003(var_13_0, var_13_1, var_13_2, var_1_10007)
...
function var_0_1.UpdateBuff(arg_15_0, arg_15_1, arg_15_2)
	...
	local function var_15_2()
		...
		local var_16_4 = var_2_10003.ON_BUFF_DESC
		local var_16_5 = arg_15_2

		Vector3 = var_2_10005

		var_16_3(var_16_2, var_16_4, var_16_5, var_2_10005(var_16_1.x, var_16_1.y - 55, 0))
	...
	var_1_10003(var_15_0, var_15_1, var_15_2, var_1_10007)
...
function var_0_1.AddEndTimer(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_1 = arg_17_0.timers

	Timer = var_1_10005
	var_17_1[arg_17_1] = var_1_10005.New(function()
	...
	local var_17_2 = arg_17_0.timers[arg_17_1]

	var_4.Start(var_17_2)
