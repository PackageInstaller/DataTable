...
function var_0_0.GetLinkConfig(arg_2_0)
	...
	local var_2_1 = arg_2_0.GetEventName(var_2_0)

	pg = var_2_0

	local var_2_2

	if not var_2_0.activity_link_button.get_id_list_by_name[var_2_1] then
		var_2_2 = {}
	end

	_ = var_1_10004

	if #var_1_10004.select(var_2_2, function(arg_3_0)
		...
		local var_2_3 = var_5.sort
		local var_2_4 = var_4

		CompareFuncs = var_1_10007

		var_2_3(var_2_4, var_1_10007({
			function(arg_4_0)
...
function var_0_0.InActTime(arg_5_0, arg_5_1)
	...
	if not arg_5_1 then
		...
		var_1_10003 = arg_5_0
		var_5_0 = arg_5_0.GetActivityID(var_1_10003)
	end
	...
	if var_5_0 then
		...
		local var_5_1 = var_1_10003(var_1_10004)
		local var_5_2

		var_5_2 = var_3.getActivityById(var_5_1, var_5_0) and not var_3:isEnd()
...
function var_0_0.Init(arg_8_0, arg_8_1)
	...
	typeof = var_4
	Image = var_1_10005
	arg_8_0.image = var_8_2(var_8_1, var_4(var_1_10005))
	...
	typeof = var_4
	Image = var_1_10005
	arg_8_0.subImage = var_8_5(var_8_4, var_4(var_1_10005))
	...
	typeof = var_4
	Image = var_1_10005
	arg_8_0.tipTr = var_8_8(var_8_7, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_8_0.tipTxt = var_8_11(var_8_10, var_4(var_1_10005))
	setActive = var_2
...
function var_0_0.InitTipImage(arg_17_0)
	...
	if not arg_17_0.GetTipImage(var_17_0) or var_1 == arg_17_0.tipImageName then
		return
	end
	...
	var_17_0("LinkButton/" .. var_1, "", arg_17_0.tipTr, true)
...
function var_0_0.Skip(arg_22_0, arg_22_1)
	...
	if var_22_0 == var_1_10003 then
		...
		if var_22_1 == var_1_10003 then
			...
			var_22_2(var_1_10003, var_1_10004.SKIP_SCENE, arg_22_1.param)
		else
			...
			if var_22_3 == var_1_10003 then
				...
				NewMainMediator = var_1_10004
				var_1_10004 = var_1_10004.SKIP_ACTIVITY
				tonumber = var_1_10005

				var_22_4(var_1_10003, var_1_10004, var_1_10005(arg_22_1.param))
			else
				...
				if var_22_5 == var_1_10003 then
					...
					var_22_6(var_1_10003, var_1_10004.SKIP_SHOP, arg_22_1.param)
				else
					...
					if var_22_7 == var_1_10003 then
						...
						if var_22_8 == var_1_10003 then
							...
							var_22_9(var_1_10003, var_1_10004, var_1_10005.SELTECHNOLOGY)
						else
							...
							if var_22_10 == var_1_10003 then
								...
								var_22_11(var_1_10003, var_1_10004.GO_MINI_GAME, arg_22_1.param[1])
							else
								...
								if var_22_12 == var_1_10003 then
									...
									var_1_10003 = var_22_12(var_1_10003)

									if var_2.getRawData(var_1_10003) then
										var_1_10003 = arg_22_0

										local var_22_13 = arg_22_0.emit

										NewMainMediator = var_1_10004
										var_1_10004 = var_1_10004.GO_SCENE
										SCENE = var_1_10005

										var_22_13(var_1_10003, var_1_10004, var_1_10005.GUILD)
									else
										var_1_10003 = arg_22_0

										local var_22_14 = arg_22_0.emit

										NewMainMediator = var_1_10004
										var_1_10004 = var_1_10004.GO_SCENE
										SCENE = var_1_10005

										var_22_14(var_1_10003, var_1_10004, var_1_10005.NEWGUILD)
									end
								else
									local var_22_15 = arg_22_1.type

									GAMEUI_BANNER_14 = var_1_10003

									if var_22_15 == var_1_10003 then
										var_1_10003 = arg_22_0

										local var_22_16 = arg_22_0.emit

										NewMainMediator = var_1_10004
										var_1_10004 = var_1_10004.OPEN_KINK_BUTTON_LAYER
										Context = var_1_10005

										local var_22_17 = var_1_10005.New
										local var_22_18 = {}

										_G = var_1_10007
										var_22_18.mediator = var_1_10007[arg_22_1.param.mediator]
										_G = var_7
										var_22_18.viewComponent = var_7[arg_22_1.param.view]

										var_22_16(var_1_10003, var_1_10004, var_22_17(var_22_18))
									else
										local var_22_19 = arg_22_1.type

										GAMEUI_BANNER_15 = var_1_10003

										if var_22_19 == var_1_10003 then
											var_1_10003 = arg_22_0
											...
											var_22_20(var_1_10003, var_1_10004.SKIP_INS)
										else
											local var_22_21 = arg_22_1.type

											GAMEUI_BANNER_16 = var_1_10003

											if var_22_21 == var_1_10003 then
												type = var_22_21

												if var_22_21(arg_22_1.param) == "table" then
													pg = var_2

													local var_22_22 = var_2.NewStoryMgr.GetInstance()

													arg_22_0.IsPlayeds = var_2.IsPlayed(var_22_22, arg_22_1.param[2])

													if not arg_22_0.IsPlayeds then
														pg = var_2

														local var_22_23 = var_2.NewStoryMgr.GetInstance()

														var_2.Play(var_22_23, arg_22_1.param[2], function()
															local var_23_0 = arg_22_0
															local var_23_1 = var_0.emit

															NewMainMediator = var_2_10002

															var_23_1(var_23_0, var_2_10002.SKIP_CORE_ACTIVITY, arg_22_1.param[1])
														...
														var_22_25(var_22_24, var_1_10004.SKIP_CORE_ACTIVITY, arg_22_1.param[1])
													end
												else
													local var_22_26 = arg_22_0
													local var_22_27 = arg_22_0.emit

													NewMainMediator = var_1_10004

													var_22_27(var_22_26, var_1_10004.SKIP_CORE_ACTIVITY, arg_22_1.param)
												end
											end
										end
									end
