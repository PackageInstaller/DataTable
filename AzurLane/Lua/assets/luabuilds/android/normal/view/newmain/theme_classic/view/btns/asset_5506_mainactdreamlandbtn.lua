...
function var_0_1.InShowTime(arg_1_0)
	...
	local var_1_3 = var_1_2(var_1_1, var_1_10004.ACTIVITY_TYPE_HOTSPRING_2)
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_3_1(var_3_0, var_1_10003.ACTIVITY_TYPE_DREAMLAND)

	getProxy = var_3_0
	ActivityProxy = var_3

	local var_3_3 = var_3_0(var_3)
	local var_3_4 = var_2.getActivityByType

	ActivityConst = var_1_10004

	local var_3_5 = var_3_4(var_3_3, var_1_10004.ACTIVITY_TYPE_HOTSPRING_2)

	DreamlandData = var_3_3

	local var_3_6 = var_3_3.New(var_3_2, var_3_5)
	local var_3_7 = var_3.ExistAnyMapOrExploreAward(var_3_6)

	setActive = var_3_6

	var_3_6(arg_3_0.tipTr.gameObject, var_3_7)
