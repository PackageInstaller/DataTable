...
function var_0_1.OpenCamera(arg_3_0)
	...
	if var_1.IsYunPackage(var_3_0) then
		...
		var_1.ShowTips(var_3_1, "指挥官，当前平台不支持该功能哦")
	...
	local function var_3_4()
		...
		var_4_1(var_4_0, var_2_10002.GO_SNAPSHOT)
	...
	local function var_3_5()
		...
		if var_2_10000.IsAndroid() then
			...
			i18n = var_2_10003
			var_5_2.content = var_2_10003("apply_permission_camera_tip3")
			...
			if var_5_1.IsIOS() then
				...
				i18n = var_2_10003
				var_5_5.content = var_2_10003("apply_permission_camera_tip2")
	...
	local var_3_6 = var_1_10003.MsgboxMgr.GetInstance()
	local var_3_7 = var_3.ShowMsgBox
	local var_3_8 = {}

	i18n = var_1_10006
	var_3_8.content = var_1_10006("apply_permission_camera_tip1")

	function var_3_8.onYes()
		PermissionHelper = var_2_10000

		var_2_10000.RequestCamera(var_3_4, var_3_5)
