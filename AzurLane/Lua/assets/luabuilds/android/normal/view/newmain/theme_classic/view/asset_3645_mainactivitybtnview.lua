...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_2 = var_4.Find(var_1_1, "link_top")

	Vector2 = var_1_1
	arg_1_0.linkBtnTopFoldableHelper = var_1_0(var_1_2, var_1_1(0, 1))
	NotchAdapt = var_3
...
function var_0_1.InitBtns(arg_4_0)
	...
	if var_1.CheckAudit(var_4_0) then
		...
		MainActTraingCampBtn = var_4_0
		var_4_1[1] = var_4_0.New(arg_4_0._tf, arg_4_0.event)
...
function var_0_1.Register(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10003.REMOVE_LAYERS, function(arg_6_0, arg_6_1)
	...
	var_5_3(var_5_2, var_3.REQ_NEW_INSTAGRAM_DATA_DONE, function(arg_7_0)
	...
	var_5_5(var_5_4, var_3.ON_HUB_DATA_UPDATE, function(arg_8_0)
	...
	var_5_7(var_5_6, var_3.SEND_MINI_GAME_OP_DONE, function(arg_9_0)
	...
	var_5_9(var_5_8, var_3.GET_FEAST_DATA_DONE, function(arg_10_0)
	...
	var_5_11(var_5_10, var_3.FETCH_VOTE_INFO_DONE, function(arg_11_0)
	...
	var_5_13(var_5_12, var_3.ZERO_HOUR_OP_DONE, function(arg_12_0)
	...
	var_5_15(var_5_14, var_3.UPDATE_ATTACHMENT_COUNT, function(arg_13_0)
	...
	var_5_17(var_5_16, var_3.All_Compensate_Remove, function(arg_14_0)
...
function var_0_1.OnRemoveLayer(arg_16_0, arg_16_1)
	...
	if var_16_1 == var_1_10004 then
		var_1_10004 = arg_16_0

		local var_16_2 = arg_16_0.GetBtn

		MainActLotteryBtn = var_1_10005
		var_16_0 = var_16_2(var_1_10004, var_1_10005)
	else
		local var_16_3 = arg_16_1.mediator

		InstagramMainMediator = var_1_10004

		if var_16_3 == var_1_10004 then
			local var_16_4 = arg_16_0
			local var_16_5 = arg_16_0.GetBtn

			MainActInsBtn = var_1_10005
			var_16_0 = var_16_5(var_16_4, var_1_10005)
		end
	end
...
function var_0_1.OnInstagramDataUpdate(arg_17_0)
	...
	MainActInsBtn = var_1_10003

	if var_17_1(var_17_0, var_1_10003) and var_1:InShowTime() then
		var_1:OnInit()
	end
...
function var_0_1.Flush(arg_22_0)
	...
	local var_22_1, var_22_2 = arg_22_0:FilterActivityBtns()
	...
	for iter_22_2, iter_22_3 in var_3(var_22_2) do
		iter_22_3:Clear()
	end

	local var_22_3 = #var_22_1 <= 3 and 1 or 0.85
	local var_22_4 = var_4 and 390 or 420
	local var_22_5 = arg_22_0._tf

	Vector3 = var_1_10008
	var_22_5.localScale = var_1_10008(var_22_3, var_22_3, 1)

	local var_22_6

	if not arg_22_0.initPos then
		var_22_6 = arg_22_0._tf.localPosition
	end

	arg_22_0.initPos = var_22_6
	onNextTick = var_22_6
	...
	var_22_6(function()
		...
		if not var_2_10000(arg_22_0._tf) then
			...
			Vector3 = var_1
			var_23_0.localPosition = var_1(arg_22_0.initPos.x, var_22_4, 0)
		end

		return
	end)

	local var_22_7, var_22_8 = arg_22_0:FilterSpActivityBtns()

	pairs = var_9

	for iter_22_4, iter_22_5 in var_9(var_22_7) do
		iter_22_5:Init(not var_4, var_3 >= 5)
	end

	pairs = var_9

	for iter_22_6, iter_22_7 in var_9(var_22_8) do
		iter_22_7:Clear()
	end
