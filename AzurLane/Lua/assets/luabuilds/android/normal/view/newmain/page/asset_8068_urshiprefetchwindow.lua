...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.cntTxt = var_2_6(var_2_5, var_3(var_1_10004))
	...
	local var_2_9 = var_2.Find(var_2_8, "window/top/bg/infomation/title")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("title_info"))
	...
	var_1(var_2_11, var_2_10("word_take"))
...
local function var_0_2(arg_4_0)
	...
	local var_4_1 = arg_4_0.getConfig(var_4_0, "config_id")

	pg = var_4_0

	local var_4_2 = var_4_0.ship_data_create_exchange[var_4_1].exchange_request
	local var_4_3 = var_2.exchange_available_times
	local var_4_4 = var_2.exchange_ship_id[1]
	local var_4_5 = arg_4_0.data1
	local var_4_6 = arg_4_0.data2

	math = var_1_10008

	local var_4_7 = var_1_10008.min(var_4_3, var_4_6 + 1) * var_4_2
...
function var_0_1.UpdateUrShipAndContent(arg_6_0, arg_6_1)
	...
	i18n = var_6_5
	var_6_7.text = var_6_5("urdraw_tip")
...
function var_0_1.UpdateTimeTxt(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	if arg_9_1 == 0 then
		...
		MainUrShipReFetchSequence = var_1_10006

		var_1_10004(var_9_0, var_1_10006.ON_TIME_UP)
	...
	if var_9_2 == 0 and var_9_3 == 0 and var_9_4 == 0 and 0 < var_9_5 then
		...
		if not (var_1_10008 .. var_1_10009("word_second")) then
			...
			local var_9_7 = var_1_10011("word_hour")
			local var_9_8 = var_9_4

			i18n = var_1_10013
			var_1_10008 = var_1_10008 .. var_9_6 .. var_1_10010 .. var_9_7 .. var_9_8 .. var_1_10013("word_minute")
		end
...
function var_0_1.RegisterEvent(arg_11_0, arg_11_1)
	...
	local function var_11_2()
		...
		var_12_1(var_12_0, var_2_10002.GRAFTING_ACT_OP, {
			cmd = 2,
			id = arg_11_1
		})
