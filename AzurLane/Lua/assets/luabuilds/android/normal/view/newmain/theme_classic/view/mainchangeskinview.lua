...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	findTF = var_4
	arg_1_0._changeSkinToggle = var_1_0(var_4(arg_1_1, "toggleUI"))
	...
	local var_1_3 = var_5(arg_1_0._tf, "click")
	...
	local function var_1_4()
		...
		if var_0.IsAsmrSkin(var_2_0) then
			...
			var_2_10002 = arg_1_0._flagShip.id
			SHIP_FLAG_L2D = var_2_10003

			var_2_2(var_2_1, var_2_10002, var_2_10003, true)
			...
			var_2_10002 = arg_1_0._flagShip.id
			SHIP_FLAG_SP = var_2_10003

			var_2_4(var_2_3, var_2_10002, var_2_10003, true)
		end
		...
		local var_2_7 = var_2_10002.CHANGE_SKIN_TOGGLE
		local var_2_8 = {}
		local var_2_9 = arg_1_0._flagShip

		var_2_8.skin_id = var_4.getSkinId(var_2_9)
...
function var_0_1.updateUI(arg_5_0)
	...
	if not var_5_0.GetChangeSkinGroupId(var_5_1) then
		setActive = var_3

		var_3(arg_5_0._tf, false)
	else
		setActive = var_3
	...
	if arg_5_0._changeSkinToggle and var_2 and var_2 > 0 then
		...
		var_5_3(var_5_2, var_5_4, var_6.GetShipPhantomMark(var_5_5))
	end
