...
function var_0_0.Execute(arg_1_0, arg_1_1)
	...
	if #var_2.GetRandomFlagShipList(var_1_0) > 0 then
		...
		if var_3.all(var_2, function(arg_2_0)
			...
			var_1_2(var_1_1, var_5("random_ship_off_0"))
	...
	if var_1_4 then
		...
		if not arg_1_0.Random(var_1_6) or #var_5 == 0 then
			pg = var_1_6

			local var_1_7 = var_1_6.TipsMgr.GetInstance()
			local var_1_8 = var_6.ShowTips

			i18n = var_1_10008

			var_1_8(var_1_7, var_1_10008("random_ship_off_0"))
...
local function var_0_1(arg_3_0)
	...
	local var_3_2 = var_3_0() - 18000 - 39600 - 46800
...
local function var_0_4(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10002(arg_8_0) do
		...
		if var_1_10009.RawGetShipById(var_1_10010, var_1_10007) then
			var_8_0[var_1_10009.groupId] = true
		end
	end
...
function var_0_0.Random(arg_9_0)
	...
	PlayerVitaeShipsPage = var_9_1

	local var_9_3, var_9_4 = var_9_1.GetSlotMaxCnt()
	...
	local var_9_7 = var_9_5(var_6.GetRandomFlagShipList(var_9_6))
...
function var_0_0.RandomShips(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5)
	...
	for iter_10_0 = 1, arg_10_1 do
		...
		if #var_10_3 > 0 then
			...
			local var_10_4 = var_10_3[var_16.random(1, #var_10_3)]

			table = var_17

			var_17.insert(var_10_0, var_10_4)

			table = var_17

			var_17.removebyvalue(var_10_3, var_10_4)
		end
