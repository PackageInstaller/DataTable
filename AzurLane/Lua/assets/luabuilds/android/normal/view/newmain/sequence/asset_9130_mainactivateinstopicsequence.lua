...
local var_0_1 = var_1.activity_ins_chat_group

pg = var_0_10002

local var_0_2 = var_0_10002.ship_data_group
...
function var_0_0.Execute(arg_1_0, arg_1_1)
	...
	local var_1_7 = var_3:GetNotActiveTopicIdsByType(6)
	local var_1_8 = var_3
	local var_1_9 = var_3.GetNotActiveTopicIdsByType(var_1_8, 7)

	getProxy = var_1_8
	CollectionProxy = var_12

	local var_1_10 = var_1_8(var_12)
	local var_1_11 = var_11.getGroups(var_1_10)
	local var_1_12 = {}

	ipairs = var_1_10013

	for iter_1_0, iter_1_1 in var_1_10013(var_0_1.all) do
	...
	for iter_1_2, iter_1_3 in var_13(var_0_2.all) do
		...
		if var_1_10019 == var_1_10020.STATE_UNLOCK then
			...
			local var_1_13 = var_1_12[iter_1_8.group_type]
			...
			if var_1_13 then
				...
				var_23.insertto(var_1_10020, var_1_13)
			end
				...
				for iter_1_5, iter_1_6 in var_23(var_1_10020) do
					...
					if var_1_3 then
						...
						if var_1_10028.contains(var_1_3, iter_1_6) then
							...
							if var_1_10028 >= var_29(var_0_1[iter_1_6].trigger_param) then
								table = var_30
					...
					if var_1_9 then
						...
						if var_1_10028.contains(var_1_9, iter_1_6) then
							...
							if var_1_10028 then
								...
								var_29.insert(var_1_0, iter_1_6)
							end
						end
					end
				end
	...
	local var_1_14, var_1_15

	if var_1_4 then
		pg = var_1_15
		var_1_14 = var_1_15.TimeMgr.GetInstance()
		var_1_15 = var_1_15.GetServerTime(var_1_14)
		ipairs = var_1_14

		for iter_1_7, iter_1_8 in var_1_14(var_1_4) do
			if #var_0_1[iter_1_8].trigger_param == 1 then
				pg = var_1_10019
				var_1_10020 = var_1_10019.TimeMgr.GetInstance()

				if var_1_10019.parseTimeFromConfig(var_1_10020, var_0_1[iter_1_8].trigger_param[1]) <= var_1_15 then
					table = var_1_10020
			...
			elseif #var_0_1[iter_1_8].trigger_param == 2 then
				pg = var_1_10019
				var_1_10020 = var_1_10019.TimeMgr.GetInstance()
				var_1_10019 = var_1_10019.parseTimeFromConfig(var_1_10020, var_0_1[iter_1_8].trigger_param[1])
				pg = var_1_10020
				var_1_10021 = var_1_10020.TimeMgr.GetInstance()
				var_1_10020 = var_1_10020.parseTimeFromConfig(var_1_10021, var_0_1[iter_1_8].trigger_param[2])

				if var_1_10019 <= var_1_15 and var_1_15 <= var_1_10020 then
					table = var_1_10021
	...
	if var_1_5 then
		...
		for iter_1_9, iter_1_10 in var_1_15(var_1_5) do
			pg = iter_1_8
			var_1_10019 = iter_1_8.NewStoryMgr.GetInstance()
			iter_1_8 = iter_1_8.StoryId2StoryName
			tonumber = var_1_10020
			iter_1_8 = iter_1_8(var_1_10019, var_1_10020(var_0_1[iter_1_10].trigger_param))
			pg = var_1_10019
			var_1_10020 = var_1_10019.NewStoryMgr.GetInstance()

			if var_1_10019.IsPlayed(var_1_10020, iter_1_8) then
				table = var_1_10019
	...
	if var_1_6 then
		...
		for iter_1_11, iter_1_12 in var_1_15(var_1_6) do
			getProxy = iter_1_8
			ChapterProxy = var_1_10019
			var_1_10019 = iter_1_8(var_1_10019)
			iter_1_8 = iter_1_8.getChapterById
			tonumber = var_1_10020
			var_1_10020 = iter_1_8(var_1_10019, var_1_10020(var_0_1[iter_1_12].trigger_param))

			if iter_1_8.isClear(var_1_10020) then
				table = var_1_10019

				var_1_10019.insert(var_1_0, iter_1_12)
			end
		end
	end
	...
	if var_1_7 then
		...
		local var_1_16 = var_1_15(var_1_14)

		ipairs = var_1_14

		for iter_1_13, iter_1_14 in var_1_14(var_1_7) do
			local var_1_17 = var_1_16
			local var_1_18 = var_1_16.getFinishTaskById

			tonumber = var_1_10021

			if var_1_18(var_1_17, var_1_10021(var_0_1[iter_1_14].trigger_param)) then
				table = var_19
