...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_11 = var_2.Find(var_2_10, "window/top/bg/infomation/title")
	...
	local var_2_13 = var_2.Find(var_2_12, "window/sure_btn/pic")
...
function var_0_1.Show(arg_7_0, arg_7_1)
	...
	var_7_1(var_7_2, "activity should exist" .. arg_7_1)

	ActivityPtData = var_7_1
	arg_7_0.ptData = var_7_1.New(var_7_2)
...
function var_0_1.UpdateContent(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_8_0(var_8_1 or {}) do
		local var_8_2
		...
		pg = var_1_10010
		var_1_10010 = var_1_10010.benefit_buff_template[iter_8_1.id].name
		pg = var_11

		var_8(var_8_4, var_1_10010 .. var_11.benefit_buff_template[iter_8_1.id].desc)
	end
...
function var_0_1.UpdateLevelPanel(arg_9_0)
	...
	local var_9_4 = var_4.Find(var_9_3, "bar")
	local var_9_5 = arg_9_0.lvBarImages
	local var_9_6 = var_5.Find(var_9_5, var_9_1)
	local var_9_7 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_3(var_9_4, var_9_7(var_9_6, var_7(var_1_10008)).sprite)

	setImageSprite = var_3

	local var_9_8 = arg_9_0.curPanel
	local var_9_9 = var_4.Find(var_9_8, "lv_tag")
	local var_9_10 = arg_9_0.lvTagImages
	local var_9_11 = var_5.Find(var_9_10, var_9_1)
	local var_9_12 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_3(var_9_9, var_9_12(var_9_11, var_7(var_1_10008)).sprite, true)
