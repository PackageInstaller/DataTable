...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_1 = var_4(arg_1_1, "mask/content")

	findTF = var_5
	arg_1_0.scrollSnap = var_1_0(var_1_1, var_5(arg_1_1, "dots"))
...
function var_0_1.UpdateItems(arg_4_0, arg_4_1)
	for iter_4_0 = 0, #arg_4_1 - 1 do
		...
		arg_4_0.UpdateItemImage(var_4_3, var_4_0, var_4_2)
		...
		if var_4_0.type == 3 then
			...
			if var_8(var_4_0.param) == nil then
				...
				var_4_3 = var_8(var_4_3)

				local var_4_4 = var_8.readyToAchieveByType

				ActivityConst = var_10
				var_4_5 = var_4_4(var_4_3, var_10.ACTIVITY_TYPE_LEVELAWARD)
		...
		var_4_3(var_10(var_4_2, "red"), var_4_5)
...
function var_0_1.UpdateItemImage(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_3 = arg_8_0.GetItemPicPath(var_8_2, arg_8_1)

	StringStartsWith = var_8_2

	local var_8_4

	if not var_8_2(var_8_3, "https://") then
		StringStartsWith = var_8_4
		var_8_4 = var_8_4(var_8_3, "http://")
	end

	setActive = var_8_6

	var_8_6(var_8_0, var_8_4)

	setActive = var_8_6

	var_8_6(var_8_1, not var_8_4)

	local var_8_6

	if var_8_4 then
		local var_8_5 = arg_8_0.downloadmgr

		var_8_6 = var_8_6.GetTexture
		...
		var_8_6(var_8_5, var_8_7, var_8_8, var_8_9, var_1_10012.Events.UnityAction_UnityEngine_Texture(function(arg_9_0)
			if not arg_8_0.exited then
				...
				var_9_0.insert(arg_8_0.rawImages, var_9_2)

				return
			end
		end))
	else
		LoadImageSpriteAsync = var_8_6

		var_8_6("activitybanner/" .. var_8_3, var_8_1)
	end
...
function var_0_1.Tracking(arg_10_0, arg_10_1)
	...
	var_10_1(var_10_0, var_1_10004.BuildTouchBanner(arg_10_1))
