...
local var_0_0 = "MainEducateCharPainting"

import = var_0_10002

local var_0_1 = var_0_10000(var_0_0, var_0_10002(".MainMeshImagePainting"))
local var_0_2
...
function var_0_1.OnDisplayWorld(arg_17_0, arg_17_1)
	...
	if var_1_10002.GetExpression(arg_17_0.ship.educateCharId, arg_17_1) and var_2 ~= "" then
		ShipExpressionHelper = var_17_0
		var_17_0 = var_17_0.UpdateExpression
		findTF = var_4

		local var_17_1 = var_4(arg_17_0.container, "fitter")

		var_17_0(var_4.GetChild(var_17_1, 0), arg_17_0.paintingName, var_2)
	else
		ShipExpressionHelper = var_17_0

		local var_17_2 = var_17_0.UpdateExpression

		findTF = var_4

		local var_17_3 = var_4(arg_17_0.container, "fitter")

		var_17_2(var_4.GetChild(var_17_3, 0), arg_17_0.paintingName, "")
	end
...
function var_0_1.CollectIdleEvents(arg_23_0, arg_23_1)
	...
	if var_3.hasFinishState(var_23_1) and arg_23_1 ~= "event_complete" then
		...
		if #var_23_0 == 0 then
			...
			var_23_0 = var_23_6(var_23_5, var_23_7(var_6.getSkinId(var_23_8), -1))
			getProxy = var_3
			TaskProxy = var_23_5

			local var_23_9 = var_3(var_23_5)

			if var_3.getNotFinishCount(var_23_9) then
				getProxy = var_3
				TaskProxy = var_23_9

				local var_23_10 = var_3(var_23_9)

				if var_3.getNotFinishCount(var_23_10) > 0 and arg_23_1 ~= "mission" then
					table = var_3
