...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	var_1_1(var_1_0, var_6.UPDATE_COVER, function(arg_2_0)
...
function var_0_1.OnLoaded(arg_4_0)
	...
	local var_4_2 = var_2.Find(var_4_1, "day/Text")

	i18n = var_4_1

	var_1(var_4_2, var_4_1("word_harbour"))

	setText = var_1

	local var_4_3 = arg_4_0._bg
	local var_4_4 = var_2.Find(var_4_3, "night/Text")

	i18n = var_4_3

	var_1(var_4_4, var_4_3("word_harbour"))
	...
	var_1(var_4_13, var_4_12("island_post_acceptable"))
	...
	var_1(var_4_16, var_4_15("island_post_vacant"))
	...
	var_4_19:RegisterRedDot(arg_4_0.redDotUIList[1], {
		...
		var_2_10001(var_7_0, var_3.IsShowRedDot(var_7_1))
	...
	var_4_19:RegisterRedDot(arg_4_0.redDotUIList[2], {
		...
		var_2_10001(var_8_0, var_3.IsShowTip(var_8_1))
	...
	var_4_19:RegisterRedDot(arg_4_0.redDotUIList[3], {
		...
		local var_9_1 = var_1(var_2)
		local var_9_2 = var_1.IsFinishAllBox(var_9_1)

		LOCK_CATTERY = var_9_1
		...
		if not var_9_1 then
			...
			if not var_9_2 then
				...
				local var_9_4 = var_2_10004(var_2_10005)

				if not var_2_10004.AnyCatteryExistOP(var_9_4) then
					getProxy = var_2_10004
					CommanderProxy = var_9_4

					local var_9_5 = var_2_10004(var_9_4)

					var_2_10004 = var_2_10004.AnyCatteryCanUse(var_9_5)
				end
			end

			var_9_1(var_9_3, var_2_10004)
		else
			setActive = var_9_1

			var_9_1(arg_9_0, var_9_2)
		end
...
function var_0_1.OnInit(arg_10_0)
	...
	local function var_10_5()
		...
		local var_12_2 = var_2_10002.COMMANDERCAT
		local var_12_3 = {
			fromMain = true
		}

		CommanderCatScene = var_2_10004
		var_12_3.fleetType = var_2_10004.FLEET_TYPE_COMMON
	...
	local function var_10_8()
		...
		var_13_1(var_13_0, var_2_10002.COURTYARD)
	...
	local function var_10_11()
		...
		var_14_1(var_14_0, var_2_10002.NAVALACADEMYSCENE)
	...
	local function var_10_14()
		...
		if var_2_10000 then
			...
			var_15_1(var_15_0, var_2_10002.EDUCATE, {
				isMainEnter = true
			})
		else
			...
			var_15_3(var_15_2, var_2_10002.NEW_EDUCATE_SELECT)
		end
	...
	local function var_10_17()
		...
		if not var_2_10002.isEditor then
			...
			if not var_16_2.IsGroupVerLastest(var_16_1) then
				...
				if not var_16_2.IsGroupWaitToUpdate(var_16_1) then
					...
					local var_16_3 = var_3.BytesToString(var_16_2)
					...
					if 0 < var_16_2 then
						...
						var_4.insert(var_16_0, function(arg_17_0)
							...
							MSGBOX_TYPE_FILE_DOWNLOAD = var_3_10004
							var_17_2.type = var_3_10004
							string = var_3_10004

							local var_17_3 = var_3_10004.format

							i18n = var_3_10005
							var_17_2.content = var_17_3(var_3_10005("group_download_tip", var_16_3))
		...
		local var_16_4 = var_16_2.TimeMgr.GetInstance()
		local var_16_5 = var_2.CurrentSTimeDesc(var_16_4, "%Y/%m/%d", true)

		LOCK_ISLAND_ENTER_TIP_WINDOW = var_16_4

		if not var_16_4 then
			PlayerPrefs = var_16_4

			if var_16_4.GetString("ISLAND_ENTER_TIP_WINDOW", "") ~= var_16_5 then
				table = var_16_4

				var_16_4.insert(var_16_0, function(arg_19_0)
					local function var_19_0()
						...
						if var_4_10000.MsgboxMgr.GetInstance().stopRemindToggle.isOn then
							...
							var_0.SetString("ISLAND_ENTER_TIP_WINDOW", var_16_5)
						end
					...
					var_19_3.type = var_3_10005
					i18n = var_3_10005
					var_19_3.helps = var_3_10005("island_urgent_notice")
		...
		seriesAsync = var_16_4

		var_16_4(var_16_0, function()
			...
			local var_21_2 = var_3_10002(var_3_10003)

			var_21_1(var_21_0, var_2.getRawData(var_21_2).id)
	...
	var_1(var_10_18, var_10_19, var_10_20, var_1_10005)
	...
	var_1(var_10_21, var_10_22, var_10_23, var_1_10005)
...
function var_0_1.Show(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_3 = var_24_1.SystemOpenMgr.GetInstance()
	...
	if not var_4.isOpenSystem(var_24_3, var_24_2.level, "CommanderCatMediator") then
		...
		typeof = var_7
		Image = var_1_10008
		var_24_3 = var_24_3(var_24_4, var_7(var_1_10008))
		Color = var_24_4
		var_24_3.color = var_24_4(0.5, 0.5, 0.5, 1)
	else
		...
		typeof = var_7
		Image = var_1_10008
		var_24_3 = var_24_3(var_24_5, var_7(var_1_10008))
		Color = var_24_5
		var_24_3.color = var_24_5(1, 1, 1, 1)
	end

	pg = var_24_3

	local var_24_6 = var_24_3.SystemOpenMgr.GetInstance()
	local var_24_7

	if not var_5.isOpenSystem(var_24_6, var_24_2.level, "CourtYardMediator") then
		var_24_7 = arg_24_0._haremBtn
		var_24_6 = var_24_6.GetComponent
		typeof = var_8
		Image = var_1_10009
		var_24_6 = var_24_6(var_24_7, var_8(var_1_10009))
		Color = var_24_7
		var_24_6.color = var_24_7(0.5, 0.5, 0.5, 1)
	else
		var_24_7 = arg_24_0._haremBtn
		var_24_6 = var_24_6.GetComponent
		typeof = var_8
		...
		var_24_6 = var_24_6(var_24_7, var_8(var_1_10009))
		Color = var_24_7
		var_24_6.color = var_24_7(1, 1, 1, 1)
	end

	LOCK_NEW_EDUCATE_SYSTEM = var_24_6

	local var_24_8 = var_24_6 and "EducateMediator" or "NewEducateSelectMediator"

	pg = var_24_7

	local var_24_9 = var_24_7.SystemOpenMgr.GetInstance()

	if not var_7.isOpenSystem(var_24_9, var_24_2.level, var_24_8) then
		local var_24_10 = arg_24_0._educateBtn

		var_24_9 = var_24_9.GetComponent
		typeof = var_10
		Image = var_1_10011
		var_24_9 = var_24_9(var_24_10, var_10(var_1_10011))
		Color = var_24_10
		var_24_9.color = var_24_10(0.5, 0.5, 0.5, 1)
	else
		...
		typeof = var_10
		Image = var_1_10011
		var_24_9 = var_24_9(var_24_11, var_10(var_1_10011))
		Color = var_24_11
		var_24_9.color = var_24_11(1, 1, 1, 1)
	end

	setActive = var_24_9

	local var_24_12 = arg_24_0._educateBtn
	local var_24_13 = var_9.Find(var_24_12, "tip")

	NewEducateHelper = var_24_12

	var_24_9(var_24_13, var_24_12.IsShowNewChildTip())

	pg = var_24_9

	local var_24_14 = var_24_9.SystemOpenMgr.GetInstance()
	...
	if not var_8.isOpenSystem(var_24_14, var_24_2.level, "SelectDorm3DMediator") then
		...
		local var_24_17 = var_24_16(var_24_15, var_11(var_1_10012))

		Color = var_24_15
		var_24_17.color = var_24_15(0.5, 0.5, 0.5, 1)
	else
		...
		local var_24_20 = var_24_19(var_24_18, var_11(var_1_10012))

		Color = var_24_18
		var_24_20.color = var_24_18(1, 1, 1, 1)
	end
	...
	;(function()
		...
		local var_25_3 = var_3.Find(var_25_2, "tip")
		...
		if not var_25_0 then
			...
			local var_25_4 = var_25_2(var_5)

			var_25_2 = var_25_2.HasGiftExpireSoon(var_25_4)
		end

		var_2_10002(var_25_3, var_25_2)

		setActive = var_2_10002

		local var_25_5 = arg_24_0._dormBtn

		var_2_10002(var_3.Find(var_25_5, "tagFurniture"), var_25_1)
	...
	if not var_10.isOpenSystem(var_24_21, var_24_2.level, "IslandMediator") then
		...
		local var_24_24 = var_24_23(var_24_22, var_13(var_1_10014))

		Color = var_24_22
		var_24_24.color = var_24_22(0.5, 0.5, 0.5, 1)
	else
		...
		local var_24_27 = var_24_26(var_24_25, var_13(var_1_10014))

		Color = var_24_25
		var_24_27.color = var_24_25(1, 1, 1, 1)
	end
	...
	var_11(var_24_29, var_13(arg_24_1))
...
function var_0_1.UpdateTime(arg_27_0)
	...
	var_1_10004(var_5.Find(var_27_2, "AM"), var_27_1)

	setActive = var_1_10004

	local var_27_3 = arg_27_0._bg

	var_1_10004(var_5.Find(var_27_3, "PM"), not var_27_1)
	...
	local var_27_7 = var_6.Find(var_27_6, "day")

	LivingAreaCover = var_27_6

	var_27_4(var_27_7, var_27_5 == var_27_6.TYPE_DAY)

	setActive = var_27_4

	local var_27_8 = arg_27_0._bg
	local var_27_9 = var_6.Find(var_27_8, "night")

	LivingAreaCover = var_27_8

	var_27_4(var_27_9, var_27_5 == var_27_8.TYPE_NIGHT)

	setActive = var_27_4

	local var_27_10 = arg_27_0._islandBtn
	local var_27_11 = var_6.Find(var_27_10, "lock/day")

	LivingAreaCover = var_27_10

	var_27_4(var_27_11, var_27_5 == var_27_10.TYPE_DAY)

	setActive = var_27_4

	local var_27_12 = arg_27_0._islandBtn
	local var_27_13 = var_6.Find(var_27_12, "lock/night")

	LivingAreaCover = var_27_12

	var_27_4(var_27_13, var_27_5 ~= var_27_12.TYPE_DAY)

	local var_27_14 = var_1
	local var_27_15 = var_1.CurrentSTimeDesc(var_27_14, "%Y/%m/%d", true)

	setText = var_27_14

	local var_27_16 = arg_27_0._bg

	var_27_14(var_7.Find(var_27_16, "date"), var_27_15)

	local var_27_17 = var_1:CurrentSTimeDesc(":%M", true)
	local var_27_18
	...
	var_7(var_8.Find(var_27_19, "time"), var_27_18 .. var_27_17)
	...
	var_8(var_9.Find(var_27_21, "date/week"), var_27_20)
...
function var_0_1.UpdateCover(arg_29_0)
	...
	LivingAreaCoverProxy = var_1_10002
...
function var_0_1._loadBg(arg_31_0)
	...
	local var_31_1 = var_2.Find(var_31_0, "day")

	GetSpriteFromAtlas = var_31_0

	local var_31_2 = arg_31_0.cover
	local var_31_3 = var_4.GetBg

	LivingAreaCover = var_1_10006

	var_1_10001(var_31_1, var_31_0(var_31_3(var_31_2, var_1_10006.TYPE_DAY), ""), true)

	setImageSprite = var_1_10001

	local var_31_4 = arg_31_0._bg
	local var_31_5 = var_2.Find(var_31_4, "night")

	GetSpriteFromAtlas = var_31_4

	local var_31_6 = arg_31_0.cover
	local var_31_7 = var_4.GetBg

	LivingAreaCover = var_6

	var_1_10001(var_31_5, var_31_4(var_31_7(var_31_6, var_6.TYPE_NIGHT), ""), true)
...
function var_0_1.UpdateCoverTip(arg_32_0)
	...
	local var_32_1 = var_2.Find(var_32_0, "tip")

	getProxy = var_32_0
	LivingAreaCoverProxy = var_4

	local var_32_2 = var_32_0(var_4)

	var_1_10001(var_32_1, var_3.IsTip(var_32_2))
...
function var_0_1.UpdataIslandTip(arg_33_0)
	...
	local var_33_1 = var_2.Find(var_33_0, "banners")

	LOCK_ISLAND_DISPLAY = var_33_0

	var_1_10001(var_33_1, not var_33_0)
	...
	var_3(arg_33_0.islandAwardTF, var_33_3 > 0)

	setActive = var_3

	var_3(arg_33_0.islandEmptyTF, var_33_4 > 0)
