...
function var_0_1.GetBtns(arg_1_0)
	...
	findTF = var_1_10003
	var_1_0[1] = var_1_1(var_1_10003(arg_1_0._tf, "2/menor"), arg_1_0.event)
	MainCollectionBtn = var_2

	local var_1_2 = var_2.New

	findTF = var_3
	var_1_0[2] = var_1_2(var_3(arg_1_0._tf, "2/collection"), arg_1_0.event)
	MainRankBtn4Mellow = var_2

	local var_1_3 = var_2.New

	findTF = var_3
	var_1_0[3] = var_1_3(var_3(arg_1_0._tf, "2/rank"), arg_1_0.event)
	MainFriendBtn = var_2

	local var_1_4 = var_2.New

	findTF = var_3
	var_1_0[4] = var_1_4(var_3(arg_1_0._tf, "2/friend"), arg_1_0.event)
	MainFormationBtn = var_2

	local var_1_5 = var_2.New

	findTF = var_3
	var_1_0[5] = var_1_5(var_3(arg_1_0._tf, "1/formation"), arg_1_0.event)
	MainBattleBtn = var_2

	local var_1_6 = var_2.New

	findTF = var_3
	var_1_0[6] = var_1_6(var_3(arg_1_0._tf, "1/battle"), arg_1_0.event)
...
function var_0_1.SetEffectVisible(arg_3_0, arg_3_1)
	...
	var_1_10002(var_1_10003(arg_3_0._tf, "1/battle/FX"), arg_3_1)
