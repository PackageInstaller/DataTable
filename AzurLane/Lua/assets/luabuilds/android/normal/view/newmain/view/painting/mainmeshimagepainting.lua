...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Camera = var_6
	arg_1_0.uiCamera = var_1_1(var_1_0, var_5(var_6))
...
function var_0_1.StaticGetPaintingName(arg_2_0)
	...
	if var_2.GetMainPaintingVariantFlag(var_2_1, arg_2_0) == var_0_1.PAINTING_VARIANT_EX then
		...
		if not var_4("painting/" .. var_2_0 .. "_ex") then
			return var_2_0
		end
	end
...
function var_0_1.OnLoad(arg_4_0, arg_4_1)
	...
	var_3(arg_4_0.container, arg_4_0.paintingName, var_4_0, "mainNormal", function()
		...
		if arg_4_0.expression then
			...
			var_5_5(var_2.GetChild(var_5_6, 0), arg_4_0.paintingName, arg_4_0.expression)
		end
...
function var_0_1.GetCenterPos(arg_6_0)
	if arg_6_0:IsLoaded() then
		...
		local var_6_4 = var_6_3 + var_1_10004(var_6_2, 0, 0)
...
function var_0_1.InitSpecialTouch(arg_9_0)
	...
	local var_9_0 = var_1_10002(arg_9_0.container, "fitter")

	if not var_1_10001(var_2.GetChild(var_9_0, 0), "Touch") then
		return
	end
...
function var_0_1.InitSpecialDrag(arg_12_0, arg_12_1)
	...
	local var_12_0 = var_1_10003(arg_12_0.container, "fitter")

	if not var_1_10002(var_3.GetChild(var_12_0, 0), "Drag") then
		return
	end
	...
	local var_12_2 = var_3(var_12_1, var_5(var_1_10006))

	Vector2 = var_12_1

	local var_12_3 = var_12_1(0, 0)
...
function var_0_1.SwitchToVariant(arg_17_0, arg_17_1)
	...
	var_2({
		function(arg_18_0)
			...
			local var_18_2 = var_18_0.GetInstance()
...
function var_0_1.PlayVariantEffect(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_0 = var_1_10003(var_1_10004)
	...
	local var_23_2 = var_1_10006.PoolMgr.GetInstance()
	...
	var_6.GetPrefab(var_23_2, "ui/" .. var_23_1, "", true, function(arg_24_0)
		...
		var_24_0(var_24_1, var_2_10003.UI)
		...
		if var_0 then
			...
			SFX_EXPLOSIVE_SKIN = var_3

			var_24_5(var_24_4, var_3)
		else
			pg = var_24_5
			...
			SFX_ANTI_EXPLOSIVE_SKIN = var_3

			var_24_7(var_24_6, var_3)
		end
...
function var_0_1.ClearSpecialDrag(arg_26_0)
	...
	local var_26_0 = var_1_10002(arg_26_0.container, "fitter")

	if not var_1_10001(var_2.GetChild(var_26_0, 0), "Drag") then
		return
	end
	...
	local var_26_2 = var_2(var_26_1, var_4(var_1_10005))
...
function var_0_1.OnClick(arg_27_0)
	...
	local var_27_1 = arg_27_0.CollectTouchEvents(var_27_0)

	math = var_27_0

	local var_27_2 = var_27_0.ceil

	math = var_1_10003

	local var_27_3 = var_27_1[var_27_2(var_1_10003.random(#var_27_1))]

	arg_27_0:TriggerEvent(var_27_3)
...
function var_0_1.OnLongPress(arg_28_0)
	...
	local var_28_2 = var_1_10003.GO_SCENE

	SCENE = var_1_10004

	var_28_1(var_28_0, var_28_2, var_1_10004.SHIPINFO, {
...
function var_0_1.OnDisplayWorld(arg_29_0, arg_29_1)
	...
	ShipExpressionHelper = var_29_0

	local var_29_2 = var_29_0.SetExpression

	findTF = var_1_10004

	local var_29_3 = var_1_10004(arg_29_0.container, "fitter")
	local var_29_4 = var_4.GetChild(var_29_3, 0)
	local var_29_5 = arg_29_0.paintingName
	local var_29_6 = arg_29_1
	local var_29_7 = var_29_1
	local var_29_8 = arg_29_0.ship
	local var_29_9, var_29_10 = var_29_2(var_29_4, var_29_5, var_29_6, var_29_7, var_8.getSkinId(var_29_8))
...
function var_0_1.Shake(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	if not arg_33_0.GetMeshPainting(var_33_2) then
		return
	end

	LeanTween = var_33_2

	local var_33_3 = var_33_2.cancel

	go = var_1_10008

	var_33_3(var_1_10008(var_6))

	LeanTween = var_33_3

	local var_33_4 = var_33_3.moveY

	rtf = var_8

	local var_33_5 = var_33_4(var_8(var_6), var_33_1, 0.1)
	local var_33_6 = var_7.setLoopPingPong(var_33_5, arg_33_3)
	local var_33_7 = var_7.setOnComplete

	System = var_9

	var_33_7(var_33_6, var_9.Action(function()
...
function var_0_1.Breath(arg_35_0)
	...
	local var_35_5 = var_35_4(var_6(var_1), var_35_2, var_0_1.BREATH_DURATION)
	local var_35_6 = var_5.setLoopPingPong(var_35_5)
	local var_35_7 = var_5.setEase

	LeanTweenType = var_7

	local var_35_8 = var_35_7(var_35_6, var_7.easeInOutCubic)
...
function var_0_1.StopBreath(arg_36_0)
	...
	if not arg_36_0.GetMeshPainting(var_36_0) then
		return
	end
...
function var_0_1.OnResume(arg_43_0)
	...
	local var_43_1 = var_2.Find(var_43_0, "fitter")

	var_1_10001(var_2.GetChild(var_43_1, 0))
	arg_43_0:Breath()
