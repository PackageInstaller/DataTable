...
function var_0_0.Execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_1_1(var_1_0, var_1_10005.ACTIVITY_TYPE_PT_CRUSING)
	local var_1_3 = {}

	if var_1_2 and not var_1_2:isEnd() then
		table = var_5

		var_5.insert(var_1_3, function(arg_2_0)
		...
		if var_5.GetInt("cursing_first_enter_scene:" .. var_1_2.id, 0) == 0 then
			table = var_5

			var_5.insert(var_1_3, function(arg_3_0)
		...
		var_5.insert(var_1_3, function(arg_4_0)
			if var_0_1 then
				arg_4_0()
			...
			if var_3.GetInt("crusing_last_remind_day_" .. var_4_3) == 1 then
				arg_4_0()
			...
			if var_4_3 <= var_6.gameset.world_cruise_due_days.key_value then
				...
				i18n = var_2_10009
				var_4_8.content = var_2_10009("world_cruise_due_tips", var_4_5, var_4_3)
...
function var_0_0.ShowWindow(arg_7_0, arg_7_1)
	...
	local var_7_2 = var_1_10004.LOAD_LAYERS
	local var_7_3 = {}

	getProxy = var_1_10006
	ContextProxy = var_1_10007

	local var_7_4 = var_1_10006(var_1_10007)

	var_7_3.parentContext = var_6.getCurrentContext(var_7_4)
	Context = var_6

	local var_7_5 = var_6.New
	local var_7_6 = {}

	CrusingWindowMediator = var_1_10008
	var_7_6.mediator = var_1_10008
	CrusingWindowLayer2 = var_1_10008
	var_7_6.viewComponent = var_1_10008
	var_7_6.data = {
		onClose = arg_7_1
	}
...
function var_0_0.CheckCrusingAct(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_1 = var_8_0(var_1_10004.format("crusing_%d_last_time", arg_8_1.id), 3)
	...
	if #arg_8_1:GetCrusingUnreceiveAward() > 0 then
		...
		if var_6.floor(var_8_4 / 0) < var_8_1 then
			...
			local var_8_6 = var_7.format("crusing_%d_last_time", arg_8_1.id)

			math = var_8

			var_8_5(var_8_6, var_8.floor(var_8_4 / 0))
...
function var_0_0.ShowMsg(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	if arg_9_2 < 0 then
		...
		var_9_2.type = var_1_10007
		i18n = var_1_10007

		local var_9_3 = "battlepass_acquire_attention"

		math = var_1_10009
		var_1_10009 = var_1_10009.floor(arg_9_2 / 0)
		math = var_10
		var_9_2.content = var_1_10007(var_9_3, var_1_10009, var_10.floor(arg_9_2 % 0 / 16))
		...
		function var_9_2.onYes()
			...
			var_10_1(var_10_0, var_10_2, var_2_10003.CRUSING)

			return
		end

		i18n = var_1_10007
		var_9_2.yesText = var_1_10007("msgbox_text_forward")
		...
		function var_9_2.onNo()
			...
			var_11_1(var_11_0, var_11_2, var_2_10003.CRUSING)
		...
		local var_9_8 = var_1_10009.floor(arg_9_2 / 0)

		math = var_10
		var_9_6.content = var_1_10007(var_9_7, var_9_8, var_10.floor(arg_9_2 % 0 / 16))
		...
		function var_9_6.onYes()
			...
			var_12_1(var_12_0, var_12_2, var_2_10003.CRUSING)

			return
		end

		i18n = var_7
		var_9_6.yesText = var_7("msgbox_text_forward")
