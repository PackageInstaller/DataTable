...
function var_0_1.OnInit(arg_3_0)
	...
	var_4(var_5.Find(var_3_2, "Tip"), var_3_1)
...
function var_0_1.CustomOnClick(arg_4_0)
	...
	local var_4_3, var_4_4 = var_4_1(var_4_0, var_3.getRawData(var_4_2).level, "Escort")
	local var_4_5

	if not var_4_3 then
		pg = var_3
		var_4_5 = var_3.TipsMgr.GetInstance()
	...
	if var_3.getMaxEscortChallengeTimes(var_4_6) == 0 then
		...
		var_4_8(var_4_7, var_1_10005("common_activity_end"))
	...
	var_4_10(var_4_9, var_1_10005.SKIP_ESCORT)
