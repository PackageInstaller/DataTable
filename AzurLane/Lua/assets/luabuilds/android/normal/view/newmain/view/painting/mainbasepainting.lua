...
function var_0_1.TriggerPersonalTask(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in var_14_0(var_1_10004.task_data_trigger.all) do
		pg = var_1_10008
		...
		if var_1_10008.task_data_trigger[iter_14_1].group_id == arg_14_1 then
			...
			if not var_14_1:getFinishTaskById(var_14_2) then
				arg_14_0:CheckStoryDownload(var_14_2, function()
					...
					var_15_1(var_15_0, var_2_10002.TRIGGER_TASK, var_14_2)
...
function var_0_1.TriggerInterActionTask(arg_16_0)
	...
	if var_1.GetFlagShipInterActionTaskList(var_16_0) and #var_2 > 0 then
		...
		for iter_16_0, iter_16_1 in var_3(var_2) do
			...
			var_1_10008(var_16_1, var_1_10010.UPDATE_TASK_PROGRESS, {
				taskId = iter_16_1.id
			})
		end
	end
...
function var_0_1.CheckStoryDownload(arg_17_0, arg_17_1, arg_17_2)
	...
	while true do
		...
		if var_1_10005.task_data_template[var_17_1].story_id ~= "" then
			...
			var_6.insert(var_17_0, var_1_10005.story_id)
		end
	...
	local var_17_4 = var_17_2.map(var_17_3, function(arg_18_0)
		return "painting/" .. arg_18_0
	end)

	PaintingGroupConst = var_7

	var_7.PaintingDownload({
		isShowBox = true,
...
function var_0_1.OnTimerTriggerEvent(arg_29_0)
	if arg_29_0:OnEnableTimerEvent() then
		...
		local var_29_1 = arg_29_0.CollectIdleEvents(var_29_0, arg_29_0.lastChatEvent)

		math = var_29_0

		local var_29_2 = var_29_0.ceil

		math = var_3
		arg_29_0.lastChatEvent = var_29_1[var_29_2(var_3.random(#var_29_1))]
...
function var_0_1.DisplayWord(arg_34_0, arg_34_1)
	...
	if arg_34_0._asmrFlag then
		...
		MainAsmrChatView = var_10

		var_34_7(var_34_6, var_10.SET_CONTENT, arg_34_1, var_34_2)
	else
		...
		var_34_9(var_34_8, var_10.SET_CONTENT, arg_34_1, var_34_2)
	end
...
function var_0_1.PlayCvAndAnimation(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
	...
	local var_35_0 = var_1_10004(var_1_10005)
	local var_35_1 = var_4.getContextByMediator

	NewShipMediator = var_1_10006

	if var_35_1(var_35_0, var_1_10006) then
		var_35_0 = arg_35_0

		arg_35_0.OnEndChatting(var_35_0)
...
function var_0_1.PlayCV(arg_41_0, arg_41_1, arg_41_2, arg_41_3, arg_41_4)
	...
	local var_41_2 = var_41_0(var_6.getSkinId(var_41_1))

	pg = var_6

	local var_41_3 = var_6.CriMgr.GetCVBankName(var_41_2)
...
function var_0_1.preloadCv(arg_42_0, arg_42_1)
	...
	local var_42_2 = var_42_0(var_3.getSkinId(var_42_1))

	pg = var_3

	local var_42_3 = var_3.CriMgr.GetCVBankName(var_42_2)
...
function var_0_1.StartChatAnimtion(arg_46_0, arg_46_1, arg_46_2)
	...
	if arg_46_0._asmrFlag then
		...
		MainAsmrChatView = var_1_10007

		var_46_3(var_46_2, var_1_10007.START_CHAT, var_46_0, var_46_1)
	else
		local var_46_4 = arg_46_0
		local var_46_5 = arg_46_0.emit

		MainWordView = var_1_10007

		var_46_5(var_46_4, var_1_10007.START_ANIMATION, var_46_0, var_46_1)
	end
...
function var_0_1.StopChatAnimtion(arg_50_0)
	if not arg_50_0._asmrFlag then
		...
		MainWordView = var_1_10003

		var_50_1(var_50_0, var_1_10003.STOP_ANIMATION)
	end
...
function var_0_1.CollectIdleEvents(arg_52_0, arg_52_1)
	...
	local var_52_1 = var_1_10003(var_1_10004)
	...
	if var_3.hasFinishState(var_52_1) and arg_52_1 ~= "event_complete" then
		...
		local var_52_3 = var_3.getCanReceiveCount(var_52_2)

		if 0 < var_52_3 and arg_52_1 ~= "mission_complete" then
			table = var_52_3

			var_52_3.insert(var_52_0, "mission_complete")
		end

		getProxy = var_52_3
		MailProxy = var_4

		local var_52_4 = var_52_3(var_4)

		if var_3.GetUnreadCount(var_52_4) > 0 and arg_52_1 ~= "mail" then
			table = var_3
		...
		if #var_52_0 == 0 then
			local var_52_5 = var_0_6.GetShipMainEvents
			local var_52_6 = arg_52_0.ship
			local var_52_7 = var_4.getSkinId(var_52_6)
			local var_52_8 = arg_52_0.ship

			var_52_0 = var_52_5(var_52_7, var_5.getCVIntimacy(var_52_8))
			getProxy = var_3
			TaskProxy = var_52_7

			local var_52_9 = var_3(var_52_7)

			if var_3.getNotFinishCount(var_52_9) then
				getProxy = var_3
				TaskProxy = var_52_9

				local var_52_10 = var_3(var_52_9)

				if var_3.getNotFinishCount(var_52_10) > 0 and arg_52_1 ~= "mission" then
					table = var_3
...
function var_0_1.CollectTouchEvents(arg_53_0)
	...
	local var_53_5 = var_53_3(var_4.getSkinId(var_53_4), var_53_1)
	local var_53_6 = arg_53_0.ship

	return (var_53_2(var_53_5, var_4.getSkinId(var_53_6), var_53_1))
end
...
function var_0_1.GetTouchEvent(arg_54_0, arg_54_1)
	...
	local var_54_6 = var_54_3(var_54_4, var_6.getSkinId(var_54_5))
	local var_54_7 = arg_54_0.ship

	return (var_54_2(var_54_6, var_5.getSkinId(var_54_7), 0))
end
...
function var_0_1.GetIdleEvents(arg_55_0)
	...
	local var_55_5 = var_55_3(var_4.getSkinId(var_55_4), 0)
	local var_55_6 = arg_55_0.ship

	return (var_55_2(var_55_5, var_4.getSkinId(var_55_6), 0))
end
...
function var_0_1.InitScalePart(arg_76_0)
	if arg_76_0:GetPartScaleData() and #var_1 > 0 then
		arg_76_0.partScaleList = {}
		arg_76_0.partScaleSelectList = {}

		local var_76_0 = arg_76_0

		if arg_76_0.GetPaintingTransform(var_76_0) then
			ipairs = var_76_0

			for iter_76_0, iter_76_1 in var_76_0(var_1) do
				findTF = var_1_10008
				...
				if var_1_10008(var_2, iter_76_1) then
					...
					typeof = var_1_10011
					PinchZoom = var_1_10012

					local var_76_2 = var_9(var_76_1, var_1_10011(var_1_10012))

					var_76_2.enabled = false
					PoolMgr = var_10
					var_1_10011 = var_10.GetInstance()

					var_10.GetUI(var_1_10011, "mainuiscalepart", false, function(arg_77_0)
						...
						tf = var_2_10004
						var_77_2.tf = var_2_10004(arg_77_0)
					...
					var_1_10011 = arg_76_0

					arg_76_0.ResetPartScale(var_1_10011, true)
...
function var_0_1.updatePartCotent(arg_79_0, arg_79_1)
	for iter_79_0 = 1, #arg_79_0.partScaleSelectList do
		if arg_79_1 then
			...
			NewMainScene = var_1_10008

			var_1_10006(var_79_0, var_1_10008.SET_SCALE_PART_CONTENT, arg_79_0.partScaleSelectList[iter_79_0].tf)
		else
	...
	if arg_81_0.partScaleSelectList and #arg_81_0.partScaleSelectList > 0 then
		for iter_81_1 = 1, #arg_81_0.partScaleSelectList do
			if arg_81_0.partScaleSelectList[iter_81_1].tf then
				...
				var_81_1(var_81_0, var_81_2, var_1_10008(arg_81_0.partScaleSelectList[iter_81_1].tf))
			end
		end
...
function var_0_1.OnEnablePartScale(arg_82_0, arg_82_1)
	if arg_82_0.partScaleList then
		...
		for iter_82_0 = 1, #arg_82_0.partScaleList do
			...
			var_1_10007 = var_1_10007(var_82_0, var_1_10009(var_1_10010))
	...
	if arg_83_0.partScaleList and #arg_83_0.partScaleList > 0 then
		for iter_83_0 = 1, #arg_83_0.partScaleList do
			...
			if arg_83_1 then
				...
				if not var_1_10008.getSkinScaleSetting(var_1_10009, arg_83_0.ship, arg_83_0:GetPartStateType(), var_83_1) then
					var_1_10008 = 1
				end
...
function var_0_1.SavePartScaleData(arg_84_0)
	...
	for iter_84_0 = 1, #arg_84_0.partScaleList do
		...
		var_1_10009.setSkinScaleSetting(var_1_10010, arg_84_0.ship, var_84_1, var_84_2, var_84_3)
	end
