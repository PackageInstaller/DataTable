...
function var_0_0.GetContextData(arg_2_0)
	...
	var_2_3 = var_2_2(var_2_1, var_1_10005) and var_3.data
...
function var_0_0.AddSubLayers(arg_3_0, arg_3_1)
	...
	local var_3_3 = var_3_2(var_3_1, var_1_10006)

	pg = var_3_1

	local var_3_4 = var_3_1.m02
	local var_3_5 = var_5.sendNotification

	GAME = var_1_10007

	var_3_5(var_3_4, var_1_10007.LOAD_LAYERS, {
