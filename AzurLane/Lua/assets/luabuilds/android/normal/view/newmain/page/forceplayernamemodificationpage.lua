...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_8 = var_2.Find(var_2_7, "frame/top/title_list/infomation/title")

	i18n = var_2_7

	var_1(var_2_8, var_2_7("change_player_name_title"))

	setText = var_1

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_2.Find(var_2_9, "frame/name_field/Placeholder")

	i18n = var_2_9

	var_1(var_2_10, var_2_9("change_player_name_input_tip"))

	setText = var_1

	local var_2_11 = arg_2_0.confirmBtn
	local var_2_12 = var_2.Find(var_2_11, "Image")

	i18n = var_2_11

	var_1(var_2_12, var_2_11("word_ok"))
	...
	local var_2_15 = var_2_14(var_2_13, var_3(var_4))

	TextAnchor = var_2_13
	var_2_15.alignment = var_2_13.MiddleCenter
	...
	typeof = var_3
	var_2_15.verticalOverflow = var_2_16(var_3("UnityEngine.VerticalWrapMode"), "Overflow")
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		local var_4_1 = var_1.m02
		local var_4_2 = var_1.sendNotification

		GAME = var_2_10003

		var_4_2(var_4_1, var_2_10003.CHANGE_PLAYER_NAME, {
			type = 2,
			name = var_4_0,
			onSuccess = function()
...
function var_0_1.Show(arg_6_0, arg_6_1)
	...
	local var_6_3 = var_6_1("change_player_name_illegal", var_6_2.name)

	setText = var_4

	var_4(arg_6_0.prompt, var_6_3)
