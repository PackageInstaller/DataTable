...
function var_0_1.Ctor(arg_1_0)
	...
	BaseEventLogic = var_1_10003

	var_1_0(var_1_1, var_1_10003.New())
...
function var_0_1.Execute(arg_2_0, arg_2_1)
	...
	if #var_2_1(var_2_0, var_1_10005.ACTIVITY_TYPE_GRAFTING) == 0 then
		arg_2_1()
...
local function var_0_2(arg_3_0)
	...
	var_3_1 = var_1.getActivityById(var_3_0, arg_3_0) and not var_2:isEnd()
...
local function var_0_5(arg_8_0)
	...
	local var_8_1 = var_2
	local var_8_2 = var_2.getConfig(var_8_1, "config_id")

	pg = var_8_1

	local var_8_3 = var_8_1.ship_data_create_exchange[var_8_2].exchange_request
	local var_8_4 = var_4.exchange_available_times
	local var_8_5 = var_2.data1
	local var_8_6 = var_2.data2

	math = var_1_10009

	local var_8_7 = var_1_10009.min(var_8_4, var_8_6 + 1) * var_8_3
...
function var_0_1.ShowFetchShipMsgbox(arg_11_0, arg_11_1, arg_11_2)
	...
	pg = var_1_10004
	arg_11_0.page = var_11_0(var_1_10004.UIMgr.GetInstance().UIMain)
...
function var_0_1.handleNotification(arg_13_0, arg_13_1)
	...
	if var_13_0 == var_13_1.GRAFTING_ACT_OP_DONE and var_0_3(var_13_2.linkActType) then
		if #var_13_2.awards > 0 then
			...
			var_13_4(var_13_3, var_1_10006.ON_ACHIEVE, var_13_2.awards, arg_13_0.callback)
		else
			arg_13_0.callback()
		end
		...
		if var_13_0 == var_13_4.ON_TIME_UP then
			if arg_13_0.page then
...
function var_0_1.addSubLayers(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	var_1_10004(var_1_10005(var_16_0, var_1_10007), "should be an instance of Context")

	getProxy = var_1_10004
	ContextProxy = var_5

	local var_16_1 = var_1_10004(var_5)
	local var_16_2 = var_4.getCurrentContext(var_16_1)
	local var_16_3 = var_5.getContextByMediator

	NewMainMediator = var_1_10008

	local var_16_4 = var_16_3(var_16_2, var_1_10008)
	...
	local var_16_5 = var_16_2.m02
	local var_16_6 = var_7.sendNotification

	GAME = var_1_10009

	var_16_6(var_16_5, var_1_10009.LOAD_LAYERS, {
