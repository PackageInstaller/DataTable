...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "top_bg")
	local var_2_3 = arg_2_0._tf
	local var_2_4 = var_3.Find(var_2_3, "bottom_bg")
	local var_2_5 = arg_2_0._tf

	arg_2_0.adapterView = var_2_0(var_2_2, var_2_4, var_4.Find(var_2_5, "bg/right"))

	local var_2_6 = arg_2_0.changeView
	local var_2_7 = var_1.SetAsmrTurnningParent
	local var_2_8 = arg_2_0._tf

	var_2_7(var_2_6, var_3.Find(var_2_8, "frame/right/asmrToggleContainer"))
...
function var_0_1.SetEffectPanelVisible(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in var_1_10002(arg_6_0.panels) do
		...
		MainRightPanel = var_1_10009

		if var_1_10007(var_6_0, var_1_10009) then
...
function var_0_1.GetWordView(arg_10_0)
	...
	return var_10_0(var_2.Find(var_10_1, "chat"), arg_10_0.event)
end
...
function var_0_1.GetTagView(arg_11_0)
	...
	return var_11_0(var_2.Find(var_11_1, "frame/bottom/tags"), arg_11_0.event)
end
...
function var_0_1.GetTopPanel(arg_12_0)
	...
	return var_12_0(var_2.Find(var_12_1, "frame/top"), arg_12_0.event, arg_12_0.contextData)
end
...
function var_0_1.GetRightPanel(arg_13_0)
	...
	return var_13_0(var_2.Find(var_13_1, "frame/right"), arg_13_0.event, arg_13_0.contextData)
end
...
function var_0_1.GetLeftPanel(arg_14_0)
	...
	return var_14_0(var_2.Find(var_14_1, "frame/left"), arg_14_0.event, arg_14_0.contextData)
end
...
function var_0_1.GetBottomPanel(arg_15_0)
	...
	return var_15_0(var_2.Find(var_15_1, "frame/bottom"), arg_15_0.event, arg_15_0.contextData)
end
...
function var_0_1.GetIconView(arg_16_0)
	...
	return var_16_0(var_2.Find(var_16_1, "frame/char"))
end
...
function var_0_1.GetChatRoomView(arg_17_0)
	...
	return var_17_0(var_2.Find(var_17_1, "frame/chatPreview"), arg_17_0.event)
end
...
function var_0_1.GetBannerView(arg_18_0)
	...
	return var_18_0(var_2.Find(var_18_1, "frame/eventPanel"), arg_18_0.event)
end
...
function var_0_1.GetActBtnView(arg_19_0)
	...
	return var_19_0(var_2.Find(var_19_1, "frame/linkBtns"), arg_19_0.event)
end
...
function var_0_1.GetBuffView(arg_20_0)
	...
	return var_20_0(var_2.Find(var_20_1, "frame/buffs"), arg_20_0.event)
end
...
function var_0_1.GetChangeSkinView(arg_22_0)
	...
	return var_22_0(var_2.Find(var_22_1, "frame/bottom/change_skin"), arg_22_0.event)
end
...
function var_0_1.GetAsmrChatView(arg_23_0)
	...
	return var_23_0(var_2.Find(var_23_1, "frame/bottom/asmr_chat"), arg_23_0.event)
end
...
function var_0_1.RegisterRedDots(arg_24_0)
	...
	var_24_2(var_5.Find(var_24_3, "frame/bottom/taskButton/tip"), {
		"TASK"
	}, function(arg_26_0)
		...
		local var_26_1 = var_2_10003(var_2_10004)
		local var_26_2 = var_3.getCanReceiveCount(var_26_1)
		local var_26_4

		if not (0 < var_26_2) then
			getProxy = var_26_2
			AvatarFrameProxy = var_4

			local var_26_3 = var_26_2(var_4)

			if not (var_3.getCanReceiveCount(var_26_3) > 0) then
				var_26_4 = false
	...
	local var_24_6 = var_24_4(var_24_5, "unread")

	findTF = var_6

	local var_24_7 = var_6(var_24_5, "read")
	...
	local var_24_11 = var_24_10(var_24_9, var_10(var_1_10011))

	getProxy = var_24_9
	MailProxy = var_10

	local var_24_12 = var_24_9(var_10).total

	math = var_1_10011

	local var_24_13 = var_1_10011.clamp
	local var_24_14 = var_9.total

	MAIL_COUNT_LIMIT = var_1_10013

	local var_24_15 = var_1_10013 * 0.9

	MAIL_COUNT_LIMIT = var_1_10014

	if var_24_12 == var_24_13(var_24_14, var_24_15, var_1_10014) then
		pg = var_24_12
		...
		var_24_17(var_24_16, var_24_14(var_24_18, var_24_19, var_1_10015))
	end
	...
	var_3(var_24_5, {
		...
		if 0 < var_27_1 then
			...
			typeof = var_5
			Button = var_2_10006
			var_27_4 = var_27_4(var_27_3, var_5(var_2_10006))
			...
			typeof = var_2_10006
			Image = var_2_10007
			var_27_4.targetGraphic = var_27_6(var_27_5, var_2_10006(var_2_10007))
			var_27_4 = var_24_11
			...
			local var_27_10 = var_27_9(var_27_8, var_5(var_2_10006))
			local var_27_11 = var_24_7
			local var_27_12 = var_4.GetComponent

			typeof = var_2_10006
			Image = var_2_10007
			var_27_10.targetGraphic = var_27_12(var_27_11, var_2_10006(var_2_10007))
		end
	...
	var_24_20(var_11.Find(var_24_21, "frame/bottom/buildButton/tip"), {
		"BUILD"
	}, function(arg_28_0)
		setActive = var_2_10001
		...
		local var_28_1 = var_2_10003(var_2_10004)
		local var_28_2 = var_3.getFinishCount(var_28_1)
		local var_28_4

		if not (0 < var_28_2) then
			tobool = var_28_2
			getProxy = var_4
			ActivityProxy = var_2_10005

			local var_28_3 = var_4(var_2_10005)

			var_28_4 = var_28_2(var_4.IsShowFreeBuildMark(var_28_3, true))
	...
	var_24_22(var_11.Find(var_24_23, "frame/bottom/guildButton/tip"), {
		"GUILD"
	}, function(arg_29_0)
		setActive = var_2_10001
		...
		local var_29_1 = var_2_10003(var_2_10004)

		var_2_10001(var_29_0, var_3.ShouldShowTip(var_29_1))
	...
	var_24_24(var_11.Find(var_24_25, "frame/top/tip"), {
		"ATTIRE"
	}, function(arg_30_0)
		setActive = var_2_10001
		...
		local var_30_1 = var_2_10003(var_2_10004)
		local var_30_4

		if not var_3.IsShowRedDot(var_30_1) then
			getProxy = var_30_4
	...
	var_24_26(var_11.Find(var_24_27, "frame/right/memoryButton/tip"), {
		"MEMORY_REVIEW"
	}, function(arg_31_0)
		getProxy = var_2_10001
		...
		if var_1.getRawData(var_31_0) then
			...
			_ = var_31_0
			var_31_0 = var_31_0.any
			pg = var_2_10003
			var_31_0 = var_31_0(var_2_10003.memory_group.all, function(arg_32_0)
		...
		if not var_31_0 then
			...
			local var_31_1 = var_2_10003(var_2_10004)

			if var_2_10003.getRawData(var_31_1) then
				getProxy = var_2_10003
				LoveLetterProxy = var_31_1

				local var_31_2 = var_2_10003(var_31_1)

				if var_2_10003.IsTipUnlockLetter(var_31_2) then
					var_31_0 = true
				end
			end
		end
		...
		var_2_10003(var_31_3, var_2_10005(var_31_0))
	...
	var_24_28(var_11.Find(var_24_29, "frame/right/collectionButton/tip"), {
		"COLLECTION"
	}, function(arg_33_0)
		setActive = var_2_10001
		...
		if not var_3.hasFinish(var_33_1) then
			getProxy = var_33_5
	...
	var_24_30(var_11.Find(var_24_31, "frame/right/friendButton/tip"), {
		"FRIEND"
	}, function(arg_34_0)
		setActive = var_2_10001
		...
		local var_34_1 = var_2_10003(var_2_10004)
		local var_34_2 = var_3.getRequestCount(var_34_1)
		local var_34_4
		...
		if not (0 < var_34_2) then
			...
			local var_34_3 = var_34_2(var_4)

			if not (var_3.getNewMsgCount(var_34_3) > 0) then
				var_34_4 = false
	...
	var_24_32(var_11.Find(var_24_33, "frame/left/commissionButton/tip"), {
		"COMMISSION"
	}, function(arg_35_0)
		setActive = var_2_10001
		...
		var_2_10001(var_35_0, var_3.IsShowCommssionTip(var_35_1))
	...
	var_24_34(var_11.Find(var_24_35, "frame/right/settingButton/tip"), {
		"SETTING"
	}, function(arg_36_0)
		setActive = var_2_10001
		...
		var_2_10001(var_36_0, var_2_10003.GetInt("firstIntoOtherPanel", 0) == 0)
	...
	var_24_36(var_11.Find(var_24_37, "frame/right/noticeButton/tip"), {
		"SERVER"
	}, function(arg_37_0)
		getProxy = var_2_10001
		...
		if 0 < var_37_3 then
			...
			local var_37_4 = var_37_3(var_5)

			var_37_5 = var_4.hasNewNotice(var_37_4)
		else
			var_37_5 = false
		end
	...
	var_24_38(var_11.Find(var_24_39, "frame/bottom/technologyButton/tip"), {
		"BLUEPRINT"
	}, function(arg_38_0)
		setActive = var_2_10001
		...
		var_2_10001(var_38_0, var_3.IsShowTip(var_38_1))
	...
	var_24_40(var_11.Find(var_24_41, "frame/right/combatBtn/tip"), {
		"EVENT"
	}, function(arg_39_0)
		setActive = var_2_10001
		...
		local var_39_1 = var_2_10003(var_2_10004)
		local var_39_2

		if not var_3.hasFinishState(var_39_1) then
	...
	var_24_42(var_11.Find(var_24_43, "frame/bottom/liveButton/tip"), {
		"COURTYARD",
		"SCHOOL",
		"COMMANDER",
		...
		if 40 <= var_40_3 then
			...
			local var_40_4 = var_40_3(var_4)

			var_40_3 = var_40_3.IsFinishAllBox(var_40_4)
			LOCK_CATTERY = var_40_4
			...
			if not var_40_4 then
				if not var_40_3 then
					...
					local var_40_5 = var_40_4(var_2_10005)
		...
		local var_40_10 = var_6(var_2_10007)

		if not var_6.IsShowRedDot(var_40_10) then
			getProxy = var_40_13
...
function var_0_1.OnAsmrTurnning(arg_41_0, arg_41_1)
	...
	var_2(var_3(arg_41_0._tf, "top_bg"), not arg_41_1)

	setActive = var_2
	findTF = var_3

	var_2(var_3(arg_41_0._tf, "bottom_bg"), not arg_41_1)

	setActive = var_2
	findTF = var_3

	var_2(var_3(arg_41_0._tf, "bg"), not arg_41_1)

	GetOrAddComponent = var_2
	findTF = var_3

	local var_41_0 = var_3(arg_41_0._tf, "frame")

	typeof = var_4
	CanvasGroup = var_5

	local var_41_1 = var_2(var_41_0, var_4(var_5))

	var_41_1.alpha = arg_41_1 ~= true and 1 or 0
	GetOrAddComponent = var_41_1
	findTF = var_3

	local var_41_2 = var_3(arg_41_0._tf, "frame")

	typeof = var_4
	CanvasGroup = var_5
	var_41_1(var_41_2, var_4(var_5)).interactable = arg_41_1 ~= true and true or false
