...
function var_0_1.GetBtns(arg_1_0)
	...
	findTF = var_1_10003
	var_1_0[1] = var_1_1(var_1_10003(arg_1_0._tf, "commissionButton"), arg_1_0.event)
	MainHideBtn = var_2

	local var_1_2 = var_2.New

	findTF = var_3
	var_1_0[2] = var_1_2(var_3(arg_1_0._tf, "hideButton"), arg_1_0.event)
	MainCameraBtn = var_2

	local var_1_3 = var_2.New

	findTF = var_3
	var_1_0[3] = var_1_3(var_3(arg_1_0._tf, "cameraButton"), arg_1_0.event)
	MainWordBtn = var_2

	local var_1_4 = var_2.New

	findTF = var_3
	var_1_0[4] = var_1_4(var_3(arg_1_0._tf, "wordBtn"), arg_1_0.event)
	MainChangeSkinBtn = var_2

	local var_1_5 = var_2.New

	findTF = var_3
	var_1_0[5] = var_1_5(var_3(arg_1_0._tf, "changeBtn"), arg_1_0.event)
	MainL2dBoundBtn = var_2

	local var_1_6 = var_2.New

	findTF = var_3
	var_1_0[6] = var_1_6(var_3(arg_1_0._tf, "l2d_bound"), arg_1_0.event)
