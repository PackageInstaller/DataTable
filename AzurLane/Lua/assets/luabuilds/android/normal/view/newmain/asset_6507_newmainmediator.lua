...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.SKIP_INS, function(arg_3_0)
		...
		InstagramMainUI = var_2_10005
		var_3_3.viewComponent = var_2_10005
		InstagramMainMediator = var_2_10005
	...
	arg_1_0:bind(var_0_1.SKIP_ESCORT, function(arg_4_0)
		...
		local var_4_2 = var_4_1(var_4_0, var_2_10004.ESCORT)[1]
		local var_4_3 = var_1
		local var_4_4 = var_1.getActiveChapter(var_4_3)

		pg = var_4_3

		local var_4_5 = var_4_3.m02
		local var_4_6 = var_4.sendNotification

		GAME = var_2_10006

		local var_4_7 = var_2_10006.GO_SCENE

		SCENE = var_2_10007

		local var_4_8 = var_2_10007.LEVEL
		local var_4_9 = {}
		local var_4_10

		if not var_4_4 or var_4_4:getConfig("map") ~= var_4_2.id or not var_4_4.id then
			var_4_10 = nil
		end

		var_4_9.chapterId = var_4_10
		var_4_9.mapIdx = var_4_2.id

		var_4_6(var_4_5, var_4_7, var_4_8, var_4_9)
	...
	arg_1_0:bind(var_0_1.SKIP_ACTIVITY_MAP, function(arg_5_0, arg_5_1)
		...
		if var_5_1 then
			...
			if not var_5.isUnlock(var_5_3) then
				...
				var_5_5(var_5_4, var_2_10007("common_activity_end"))
			else
				...
				local var_5_8 = var_2_10007.GO_SCENE

				SCENE = var_2_10008

				var_5_7(var_5_6, var_5_8, var_2_10008.LEVEL, {
					chapterId = var_5_2,
					mapIdx = var_5_1
				})
			end
	...
	arg_1_0:bind(var_0_1.SKIP_SHOP, function(arg_6_0, arg_6_1)
		...
		local var_6_3 = var_2_10005.SHOP
		local var_6_4 = {}
		...
		if not arg_6_1 then
			...
			var_2_10007 = var_2_10007.TYPE_ACTIVITY
		end

		var_6_4.warp = var_2_10007
	...
	arg_1_0:bind(var_0_1.SKIP_ACTIVITY, function(arg_7_0, arg_7_1)
		...
		var_7_1(var_7_0, var_7_2, var_2_10005.ACTIVITY, {
			id = arg_7_1
		})
	...
	arg_1_0:bind(var_0_1.SKIP_CORE_ACTIVITY, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_8_2, var_2_10005.CORE_ACTIVITY, {
			coreName = arg_8_1
		})
	...
	arg_1_0:bind(var_0_1.SKIP_SCENE, function(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_2_10004.GO_SCENE, arg_9_1[1], arg_9_1[2])
	...
	arg_1_0:bind(var_0_1.GO_SCENE, function(arg_11_0, arg_11_1, arg_11_2)
		...
		var_11_1(var_11_0, var_2_10005.GO_SCENE, arg_11_1, arg_11_2)
	...
	arg_1_0:bind(var_0_1.GO_SNAPSHOT, function(arg_12_0)
		...
		VirtualEducateCharShip = var_2_10007

		if var_2_10005(var_12_5, var_2_10007) then
		...
		local var_12_8 = var_2_10007.GO_SCENE

		SCENE = var_2_10008

		var_12_7(var_12_6, var_12_8, var_2_10008.SNAPSHOT, {
			skinId = var_12_1,
			live2d = var_12_3,
			tbId = var_12_4,
	...
	arg_1_0:bind(var_0_1.OPEN_MAIL, function(arg_13_0)
		...
		if var_2_10001 then
			...
			GAME = var_2_10003
			var_2_10003 = var_2_10003.BEGIN_STAGE
			var_2_10004 = {}
			SYSTEM_DEBUG = var_2_10005
			var_2_10004.system = var_2_10005

			var_13_1(var_13_0, var_2_10003, var_2_10004)
		else
			...
			local var_13_4 = var_2_10003.GO_SCENE

			SCENE = var_2_10004

			var_13_3(var_13_2, var_13_4, var_2_10004.MAIL)
		end
	...
	arg_1_0:bind(var_0_1.OPEN_Compensate, function(arg_14_0)
		...
		var_14_1(var_14_0, var_14_2, var_2_10004.Compensate)
	...
	arg_1_0:bind(var_0_1.OPEN_NOTICE, function(arg_15_0)
		...
		NewBulletinBoardMediator = var_2_10005
		var_15_3.mediator = var_2_10005
		NewBulletinBoardLayer = var_2_10005
	...
	arg_1_0:bind(var_0_1.OPEN_COMMISION, function(arg_16_0)
		...
		CommissionInfoLayer = var_2_10005
		var_16_3.viewComponent = var_2_10005
		CommissionInfoMediator = var_2_10005
	...
	arg_1_0:bind(var_0_1.OPEN_CHATVIEW, function(arg_17_0)
		...
		NotificationLayer = var_2_10005
		var_17_3.viewComponent = var_2_10005
		NotificationMediator = var_2_10005
		var_17_3.mediator = var_2_10005

		local var_17_4 = {}

		NotificationLayer = var_2_10006
		var_17_4.form = var_2_10006.FORM_MAIN
	...
	arg_1_0:bind(var_0_1.CHANGE_SKIN_TOGGLE, function(arg_19_0, arg_19_1)
		...
		var_19_1(var_19_0, var_2_10004.CHANGE_SKIN_AB, arg_19_1)
	...
	arg_1_0:bind(var_0_1.DEBUG_BATTLE_LOOP, function(arg_20_0, arg_20_1)
		...
		var_20_1(var_20_0, var_2_10004.SEND_CMD, {
			cmd = "into",
			arg1 = arg_20_1
		})
...
function var_0_1.initNotificationHandleDic(arg_21_0)
	...
	var_21_0[var_2.FRIEND_REQUEST_ADDED] = function(arg_23_0, arg_23_1)
		...
		var_23_1(var_23_0, var_2_10004.ANY_CHAT_MSG_UPDATE)
	...
	var_21_0[var_21_7.BEGIN_STAGE_DONE] = function(arg_24_0, arg_24_1)
		...
		local var_24_2 = var_2_10004.GO_SCENE

		SCENE = var_2_10005

		var_24_1(var_24_0, var_24_2, var_2_10005.COMBATLOAD, arg_24_1:getBody())
	...
	var_21_0[var_2.FETCH_NPC_SHIP_DONE] = function(arg_28_0, arg_28_1)
		...
		var_28_2(var_28_1, var_2_10005.ON_ACHIEVE, var_28_0.items, var_28_0.callback)
	...
	var_21_0[var_2.CONFIRM_GET_SHIP] = function(arg_30_0, arg_30_1)
		...
		local var_30_3 = var_2_10005.New
		local var_30_4 = {}

		BuildShipRemindMediator = var_2_10007
		var_30_4.mediator = var_2_10007
		BuildShipRemindLayer = var_2_10007
		var_30_4.viewComponent = var_2_10007
		var_30_4.data = {
	...
	var_21_0[var_2.CHANGE_LIVINGAREA_COVER_DONE] = function(arg_31_0, arg_31_1)
		...
		var_31_1(var_31_0, var_2_10004.UPDATE_COVER)

		return
	end
	GAME = var_2
	var_21_0[var_2.ACT_INSTAGRAM_CHAT_DONE] = function(arg_32_0, arg_32_1)
		local var_32_0 = arg_32_1:getBody().operation

		ActivityConst = var_2_10004

		if var_32_0 == var_2_10004.INSTAGRAM_CHAT_ACTIVATE_TOPIC then
			local var_32_1 = arg_32_0.viewComponent
			local var_32_2 = var_3.GetFlagShip(var_32_1)

			if arg_32_0.viewComponent.theme then
				local var_32_3 = arg_32_0.viewComponent.theme

				var_4.Refresh(var_32_3, var_32_2)
			end
		end
	...
	var_21_0[var_2.ON_DROP] = function(arg_33_0, arg_33_1)
		...
		var_33_1(var_33_0, var_2_10004.ON_DROP, arg_33_1:getBody())
	...
	var_21_0[var_2.ON_AWRADS] = function(arg_34_0, arg_34_1)
		...
		var_34_2(var_34_1, var_2_10005.ON_ACHIEVE, var_34_0.items, var_34_0.callback)
	...
	var_21_0[var_2.REMOVE_LAYERS] = function(arg_45_0, arg_45_1)
		...
		NewMainMediator = var_2_10005

		var_45_2(var_45_1, var_2_10005.REMOVE_LAYERS, arg_45_1:getBody())
	...
	var_21_0[var_2.UPDATED_TIP] = function(arg_47_0, arg_47_1)
		...
		MainBaseActivityBtn = var_2_10004

		var_47_1(var_47_0, var_2_10004.UPDATED_TIP)
