...
local var_0_1 = {
	{
		...
		condition = function()
			...
			var_1_3 = var_1_2(var_1_1, var_1_10002.ACTIVITY_TYPE_GUIDE_TASKS) and not var_0:isEnd()

			local var_1_4 = false

			if var_1_3 then
				local var_1_5 = var_0
				local var_1_6 = var_0.getConfig(var_1_5, "config_data")[1]
				...
				var_1_4 = var_4.getChapterById(var_1_7, var_1_6) and var_4:isClear()
			end
...
function var_0_0.Execute(arg_3_0, arg_3_1)
	...
	if not var_3_0.detect(var_0_1, function(arg_4_0)
	...
	var_3_6(var_3_5, var_1_10009.STORY_UPDATE, {
		storyId = var_3_1
	})
