...
function var_0_1.InShowTime(arg_2_0)
	...
	var_2_2 = var_2_1(var_2_0, var_1_10003.ACTIVITY_TYPE_ISLAND) and not var_1:isEnd()
...
function var_0_1.OnClick(arg_4_0)
	...
	var_4_1(var_4_0, var_4_2, var_1_10004.ANNIVERSARY_ISLAND_SEA, {
		checkMain = true
	})
...
function var_0_1.OnRegister(arg_6_0)
	...
	var_1.RegisterRedDot(var_6_1, arg_6_0.redDotUI, {
		...
		local var_7_2 = var_7_1(var_7_0, var_2_10003.ACTIVITY_TYPE_ISLAND)

		setActive = var_7_0

		local var_7_3 = arg_7_0

		Activity = var_2_10004

		var_7_0(var_7_3, var_2_10004.IsActivityReady(var_7_2))
