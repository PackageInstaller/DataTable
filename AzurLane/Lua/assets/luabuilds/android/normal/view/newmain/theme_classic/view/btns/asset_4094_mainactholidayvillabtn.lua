...
function var_0_1.CustomOnClick(arg_4_0)
	...
	if var_2.getActivityById(var_4_2, var_4_1) then
		...
		local var_4_3 = var_4_2.NewStoryMgr.GetInstance()
		local var_4_6
		...
		if not var_3.IsPlayed(var_4_3, "JIARIBIESHUCHOUBEIZHONG5") then
			...
			var_4_5(var_4_4, var_4_6, var_1_10006(arg_4_0.config.param[2]))
		else
...
function var_0_1.IsShowTip(arg_5_0)
	...
	local var_5_4 = var_5_2.NewStoryMgr.GetInstance()
	...
	if var_5_3 then
		...
		if var_5_3.getConfig(var_5_5, "config_client").scene then
			...
			if var_5 then
				...
				local var_5_7 = var_1_10006.Find

				SCENE = var_1_10007

				var_5(var_5_7(var_1_10007, function(arg_6_0, arg_6_1)
			...
			var_5.SetSceneInfo(var_5_6, var_3)
