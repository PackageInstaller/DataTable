...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".MainOverDueSkinDiscountItemSequence"))
...
function var_0_1.ShouldTip(arg_2_0)
	...
	if var_2_0.GetString("SkinDiscountItemTip" .. var_2_1, "") == "" then
...
function var_0_1.DisplayResults(arg_3_0, arg_3_1, arg_3_2)
	...
	MainSkinDiscountItemTipDisplayPage = var_1_10005

	var_3_1(var_3_0, var_1_10005, arg_3_1, arg_3_2)
...
function var_0_1.InTime(arg_4_0, arg_4_1)
	...
	if var_1_10002(arg_4_1) == "table" then
		...
		local var_4_1 = var_3.TimeMgr.GetInstance()
		local var_4_2 = var_3.parseTimeFromConfig(var_4_1, var_4_0) - 0

		pg = var_5

		local var_4_3 = var_5.TimeMgr.GetInstance()
