...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.bgImage = var_2_9(var_2_8, var_3(var_1_10004))
	...
	arg_2_0.pageCG = var_1(var_2_14, var_3(var_1_10004))
...
function var_0_1.OnInit(arg_3_0)
	...
	var_1(arg_3_0, arg_3_0._parentTf, function()
		...
		if arg_3_0.showing then
			...
			var_4_2(var_4_1, var_2_10002.FOLD, false)
		end
	...
	local function var_3_11()
		...
		var_8_2(var_8_1, var_2_10002.FOLD, false)
	...
	local function var_3_17()
		...
		elseif arg_3_0.stateType == var_0_5 then
			...
			var_10_2(var_10_1, var_2_10002.RESET_PAITING_SCALE)
		end
...
function var_0_1.Move(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_4.ENABLE_PAITING_MOVE, arg_12_1)
...
function var_0_1.updateState(arg_14_0)
	...
	if arg_14_0.stateType == var_0_2 then
		...
		var_14_1(var_14_0, var_3.ENABLE_PAITING_MOVE, false)
		...
		var_14_3(var_14_2, var_3.ENABLE_PAITING_SCALE, false)
	elseif arg_14_0.stateType == var_0_3 or arg_14_0.stateType == var_0_4 then
		...
		var_14_5(var_14_4, var_3.ENABLE_PAITING_MOVE, true)
	elseif arg_14_0.stateType == var_0_5 then
		...
		var_14_7(var_14_6, var_3.ENABLE_PAITING_SCALE, true)
	end
	...
	local var_14_13 = var_14_12(var_14_11, var_5.Action_float(function(arg_15_0)
...
function var_0_1.SetPostion(arg_16_0, arg_16_1)
	...
	local var_16_6 = var_16_5(var_16_4, var_8.Action_float(function(arg_18_0)
	...
	if arg_16_1 then
		...
		var_16_8(var_16_7, var_9.Action(var_16_0))
	end
	...
	var_16_10(var_16_9, var_9.ENABLE_PAITING_MOVE, arg_16_1)
...
function var_0_1.SavePostion(arg_19_0)
	if arg_19_0.stateType == var_0_4 then
		...
		var_1_10004 = arg_19_0.flagShip

		local var_19_2 = var_3.getSkinId(var_1_10004)

		pg = var_1_10004

		local var_19_3 = var_1_10004.MsgboxMgr.GetInstance()

		var_1_10004 = var_1_10004.ShowMsgBox

		local var_19_4 = {}

		i18n = var_1_10007
		var_19_4.content = var_1_10007("secretary_pos_save")
		...
		function var_19_4.onYes()
			...
			var_20_2(var_20_1, var_2("secretary_pos_save_success"))
			...
			var_20_5(var_20_4, var_2.FOLD, false)

			return
		end

		var_1_10004(var_19_3, var_19_4)
	elseif arg_19_0.stateType == var_0_5 then
		pg = var_1

		local var_19_5 = var_1.MsgboxMgr.GetInstance()
		local var_19_6 = var_1.ShowMsgBox
		local var_19_7 = {}

		i18n = var_1_10004
		var_19_7.content = var_1_10004("secretary_pos_save")

		function var_19_7.onYes()
			local var_21_0 = arg_19_0
			local var_21_1 = var_0.emit

			NewMainScene = var_2_10002

			var_21_1(var_21_0, var_2_10002.SAVE_PART_SCALE)
			...
			var_21_3(var_21_2, var_2("secretary_pos_save_success"))
			...
			var_21_6(var_21_5, var_2.FOLD, false)
...
function var_0_1.ResetPostion(arg_22_0)
	...
	MainPaintingShift = var_1_10006

	local var_22_8 = var_1_10006.IsLimitYPos
	local var_22_9 = arg_22_0.flagShip

	if var_22_8(var_7.getPainting(var_22_9)) then
...
function var_0_1.DoLeftAnimation(arg_28_0, arg_28_1, arg_28_2, arg_28_3)
	...
	local var_28_2 = var_28_1(var_28_0, var_6.Action_float(function(arg_29_0)
	...
	var_28_3(var_28_2, var_6.Action(arg_28_3))
