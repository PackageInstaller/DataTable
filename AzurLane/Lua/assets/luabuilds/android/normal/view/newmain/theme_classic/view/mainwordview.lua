...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Text = var_6
	arg_1_0.chatTxt = var_1_2(var_1_1, var_5(var_6))
...
function var_0_1.Register(arg_2_0)
	...
	var_2_1(var_2_0, var_3.LOAD_LAYERS, function(arg_6_0, arg_6_1)
	...
	var_2_3(var_2_2, var_3.WILL_LOGOUT, function()
	...
	var_2_5(var_2_4, var_3.REMOVE_LAYERS, function(arg_8_0, arg_8_1)
	...
	var_2_7(var_2_6, var_3.ENTER_SILENT_VIEW, function()
	...
	var_2_9(var_2_8, var_3.EXIT_SILENT_VIEW, function()
		arg_2_0.stopChatFlag = false
...
function var_0_1.Fold(arg_11_0, arg_11_1, arg_11_2)
	...
	var_11_0(var_1_10004(arg_11_0.chatTf))
	...
	elseif arg_11_2 > 0 then
		...
		local var_11_2 = var_4.value

		go = var_5

		local var_11_3 = var_11_2(var_5(arg_11_0.chatTf), var_11_1, 0, arg_11_2)
		local var_11_4 = var_4.setOnUpdate

		System = var_6

		local var_11_5 = var_11_4(var_11_3, var_6.Action_float(function(arg_12_0)
		...
		var_11_6(var_11_5, var_6.easeInOutExpo)
	end
...
function var_0_1.StartAnimation(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_0 = var_3(var_4)
	local var_15_1 = var_3.ShouldShipMainSceneWord(var_15_0) and 1 or 0

	LeanTween = var_15_0

	local var_15_2 = var_15_0.scale

	rtf = var_1_10005

	local var_15_3 = var_1_10005(arg_15_0.chatTf.gameObject)

	Vector3 = var_6

	local var_15_4 = var_15_2(var_15_3, var_6.New(var_15_1, var_15_1, 1), arg_15_1)
	local var_15_5 = var_4.setEase

	LeanTweenType = var_6

	local var_15_6 = var_15_5(var_15_4, var_6.easeOutBack)
	local var_15_7 = var_4.setOnComplete

	System = var_6

	var_15_7(var_15_6, var_6.Action(function()
		...
		local var_16_1 = var_2_10001(arg_15_0.chatTf.gameObject)

		Vector3 = var_2

		local var_16_2 = var_16_0(var_16_1, var_2.New(0, 0, 1), arg_15_1)
		local var_16_3 = var_0.setEase

		LeanTweenType = var_2

		local var_16_4 = var_16_3(var_16_2, var_2.easeInBack)
...
function var_0_1.StopAnimation(arg_17_0)
	...
	Vector3 = var_2
	var_17_0.localScale = var_2.zero
...
function var_0_1.AdjustChatPosition(arg_18_0, arg_18_1, arg_18_2)
	...
	if var_18_3 == var_1_10006 then
		...
		var_18_3(var_18_4, var_1_10007(arg_18_2))
	end
...
function var_0_1.RegisterBtn(arg_19_0, arg_19_1)
	...
	var_1_10002(arg_19_0, arg_19_0.chatTf, function()
		if arg_19_1 == "mission_complete" or arg_19_1 == "mission" then
			...
			var_20_1(var_20_0, var_2_10002, var_2_10003.TASK)
		elseif arg_19_1 == "collection" then
			...
			var_20_3(var_20_2, var_2_10002, var_2_10003.EVENT)
		elseif arg_19_1 == "event_complete" then
			...
			local var_20_6 = var_2_10002.GO_SCENE

			SCENE = var_2_10003

			var_20_5(var_20_4, var_20_6, var_2_10003.EVENT)
		end
