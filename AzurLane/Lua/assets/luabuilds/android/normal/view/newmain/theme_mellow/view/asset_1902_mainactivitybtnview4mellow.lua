...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("...theme_classic.view.MainActivityBtnView"))
...
function var_0_1.InitBtns(arg_2_0)
	...
	local var_2_1 = var_1.select(arg_2_0.activityBtns, function(arg_3_0)
		...
		MainActMapBtn = var_2_10003

		return not var_2_10001(var_3_0, var_2_10003)
	end)

	_ = var_2
	arg_2_0.activityBtns = var_2.map(var_2_1, function(arg_4_0)
	...
	arg_2_0.specailBtns = var_2.map(arg_2_0.specailBtns, function(arg_5_0)
		...
		var_2_10001(var_2_10002[arg_5_0.__cname .. "MellowAdapt"])
...
function var_0_1.Flush(arg_7_0)
	...
	for iter_7_2, iter_7_3 in var_3(var_7_1) do
		iter_7_3:Clear()
	end
	...
	for iter_7_4, iter_7_5 in var_5(var_7_2) do
		iter_7_5:Init()
	end

	ipairs = var_5

	for iter_7_6, iter_7_7 in var_5(var_7_3) do
		iter_7_7:Clear()
	end

	local var_7_4 = arg_7_0.mapBtn

	if var_5.InShowTime(var_7_4) then
		local var_7_5 = arg_7_0.mapBtn
	...
	local var_7_7 = arg_7_0.mapSubBtn

	if var_5.InShowTime(var_7_7) then
		local var_7_8 = arg_7_0.mapSubBtn
	...
	local var_7_10 = arg_7_0.voteBtn

	if var_5.InShowTime(var_7_10) then
		local var_7_11 = arg_7_0.voteBtn
	...
	local var_7_13 = arg_7_0.subActBtn

	if var_5.InShowTime(var_7_13) then
		local var_7_14 = arg_7_0.subActBtn

		var_5.Init(var_7_14)
	else
		local var_7_15 = arg_7_0.subActBtn

		var_5.Clear(var_7_15)
	end
