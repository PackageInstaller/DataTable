...
function var_0_1.GetBgAndBgm()
	...
	local var_1_1 = var_1_10001(var_1_10002)
	local var_1_2 = var_1.RawGetActivityById

	pg = var_1_10003

	if var_1_2(var_1_1, var_1_10003.gameset.dayandnight_bgm.key_value) and not var_1:isEnd() then
		pg = var_1_1
		var_1_0 = var_1_1.gameset.dayandnight_bgm.description
	end

	pg = var_1_1

	local var_1_3 = var_1_1.TimeMgr.GetInstance()
...
function var_0_1.Ctor(arg_2_0, arg_2_1)
	...
	typeof = var_5
	Canvas = var_1_10006
	var_2_0[1] = var_2_3(var_2_2, var_5(var_1_10006))
	...
	typeof = var_5
	Canvas = var_1_10006
	var_2_0[2] = var_2_6(var_2_5, var_5(var_1_10006))
...
function var_0_1.AdjustMapEffect(arg_17_0, arg_17_1)
	...
	local var_17_3 = var_17_2(var_17_1, var_1_10005(var_1_10006))
	...
	local var_17_7 = var_17_6(var_17_5, var_6("UnityEngine.ParticleSystemRenderer"))
	local var_17_8 = var_4.ToTable(var_17_7)

	ipairs = var_17_7

	for iter_17_2, iter_17_3 in var_17_7(var_17_8) do
...
function var_0_1.SetCommonBg(arg_18_0, arg_18_1)
	...
	local var_18_2 = var_18_1(var_18_0, var_4(var_1_10005)).sprite
	...
	var_4(var_18_3, var_1_10006("commonbg/" .. arg_18_1, ""))

	if var_18_2 then
		Resources = var_4

		var_4.UnloadAsset(var_18_2.texture)
	end
