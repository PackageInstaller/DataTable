...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("...theme_classic.view.MainWordView"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Animation = var_6
	arg_1_0.animationPlayer = var_1_1(var_1_0, var_5(var_6))
	...
	typeof = var_5
	DftAniEvent = var_6
	arg_1_0.dftAniEvent = var_1_3(var_1_2, var_5(var_6))
	...
	typeof = var_5
	CanvasGroup = var_6
	arg_1_0.cg = var_1_5(var_1_4, var_5(var_6))
...
function var_0_1.StartAnimation(arg_2_0, arg_2_1, arg_2_2)
	...
	var_3.SetStartEvent(var_2_3, function()
		...
		Vector3 = var_3_0
		var_3_1.localScale = var_3_0.one
...
function var_0_1.StopAnimation(arg_5_0)
	...
	arg_5_0.RemoveTimer(var_5_1)

	local var_5_2 = arg_5_0.chatTf

	Vector3 = var_5_1
	var_5_2.localScale = var_5_1.zero
...
function var_0_1.PlayHideAnimation(arg_6_0, arg_6_1)
	...
	if not var_2.ShouldShipMainSceneWord(var_6_0) then
		...
		Vector3 = var_6_0
		var_6_1.localScale = var_6_0.zero
	...
	arg_6_0:AddTimer(function()
		...
		Vector3 = var_7_0
		var_7_1.localScale = var_7_0.zero
