...
function var_0_1.GetBtns(arg_1_0)
	...
	local var_1_2 = var_1_10003(arg_1_0._tf, "frame/shop")
	...
	findTF = var_3
	var_1_0[3] = var_1_4(var_3(arg_1_0._tf, "frame/storage"), arg_1_0.event)
	MainLiveBtn = var_2

	local var_1_5 = var_2.New

	findTF = var_3
	var_1_0[4] = var_1_5(var_3(arg_1_0._tf, "frame/live"), arg_1_0.event)
	MainTechBtn = var_2

	local var_1_6 = var_2.New

	findTF = var_3
	var_1_0[5] = var_1_6(var_3(arg_1_0._tf, "frame/tech"), arg_1_0.event)
	MainTaskBtn = var_2

	local var_1_7 = var_2.New

	findTF = var_3
	var_1_0[6] = var_1_7(var_3(arg_1_0._tf, "frame/task"), arg_1_0.event)
	MainBuildBtn = var_2

	local var_1_8 = var_2.New

	findTF = var_3
	var_1_0[7] = var_1_8(var_3(arg_1_0._tf, "frame/build"), arg_1_0.event)
	MainGuildBtn = var_2

	local var_1_9 = var_2.New

	findTF = var_3
	var_1_0[8] = var_1_9(var_3(arg_1_0._tf, "frame/guild"), arg_1_0.event)
