...
function var_0_0.FixMainSceneSettings(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_2(var_3_0) do
		...
		local var_3_3 = var_3_1 .. var_3_2 .. var_1_10009.getRawData(var_1_10010).id
...
function var_0_0.FixPlayerPrefsKey(arg_4_0)
	...
	USAGE_NEW_MAINUI = var_3

	local var_4_4

	if not var_4_3(var_3) then
		PlayerPrefs = var_4_4
	...
	var_4_8(var_4_7, var_1_10005.BuildNewMainUI({
		isLogin = 1,
		isNewMainUI = var_4_6
	}))
