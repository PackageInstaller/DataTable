...
function var_0_1.getResource(arg_2_0)
	...
	local var_2_3 = (function()
		...
		ResPathSupport = var_5_3

		local var_5_5 = var_5_3.ConstPath.UI.LivingAreaCover

		_ = var_2_10005

		var_2_10005.each(var_5_2, function(arg_6_0)
			local var_6_0 = arg_6_0
			local var_6_1 = arg_6_0.GetIcon(var_6_0)

			table = var_6_0

			local var_6_2 = var_6_0.insert
			local var_6_3 = var_5_0

			ResPathSupport = var_3_10004

			var_6_2(var_6_3, var_3_10004.CombinePath(var_5_5, var_6_1))
		...
		var_5.each(var_5_4, function(arg_7_0)
			...
			local var_7_1 = arg_7_0.GetIcon(var_7_0)

			table = var_7_0

			local var_7_2 = var_7_0.insert
			local var_7_3 = var_5_0

			ResPathSupport = var_3_10004

			var_7_2(var_7_3, var_3_10004.CombinePath(var_5_5, var_7_1))
	...
	local var_2_4 = (function()
		...
		var_8_1.each(var_8_2, function(arg_9_0)
			...
			var_9_2(var_9_3, var_3_10005.CombinePath(var_9_0, var_9_1))
	...
	local var_2_5 = (function()
		...
		var_2_10002.each(var_10_1, function(arg_11_0)
			...
			if var_1.GetLinkConfig(var_11_2) then
				if var_3.pic and #var_11_2 > 0 then
					ResPathSupport = var_5

					local var_11_3 = var_5.CombinePath(var_11_1, var_11_2)
				...
				if var_3.text_pic and #var_11_2 > 0 then
					ResPathSupport = var_5

					local var_11_5 = var_5.CombinePath(var_11_1, var_11_2)

					string = var_6

					local var_11_6 = var_6.lower(var_11_5)

					table = var_6

					var_6.insert(var_10_0, var_11_6)
				end
			end

			ResPathSupport = var_11_2

			local var_11_7 = var_11_2.ConstPath.UI.LinkButton

			if var_1:GetTipImage() and #var_5 > 0 then
				ResPathSupport = var_6

				local var_11_8 = var_6.CombinePath(var_11_7, var_5)

				string = var_7

				local var_11_9 = var_7.lower(var_11_8)

				table = var_7

				var_7.insert(var_10_0, var_11_9)
			end
		...
		var_3.each(var_10_2, function(arg_12_0)
			...
			if var_12_0:GetUIName() and #var_3 > 0 then
				ResPathSupport = var_4

				local var_12_2 = var_4.CombinePath(var_12_1, var_3)

				string = var_5

				local var_12_3 = var_5.lower(var_12_2)

				table = var_5

				var_5.insert(var_10_0, var_12_3)

				local var_12_4 = var_12_3 .. "4mellow"
	...
	local var_2_6 = (function()
		...
		var_2_10002.each(var_13_1, function(arg_14_0)
			...
			var_2.insert(var_13_0, var_14_0)
	...
	local var_2_7 = (function()
		...
		PlayerVitaeShipsPage = var_15_1

		local var_15_3 = var_15_1.GetAllUnlockSlotCnt()

		for iter_15_0 = 1, var_15_3 do
			local var_15_4 = var_15_2
			local var_15_5 = var_15_2.GetFlagShip(var_15_4)

			ResPathSupport = var_15_4

			local var_15_6 = var_15_4.GetShipAllRes(var_15_5)

			table = var_9

			var_9.insert(var_15_0, var_15_6)
		end
		...
		function()
			...
			if var_0.IsEnableMainMusicPlayer(var_24_0) then
				...
				if var_24_2.CanPlayMainMusicPlayer(var_24_1) then
					...
					local var_24_3 = var_24_1(var_2_10002)
...
function var_0_1.init(arg_30_0)
	...
	arg_30_0.mainCG = var_1_10001(var_30_0, var_1_10003(var_1_10004))
	MainBGView = var_1

	local var_30_1 = var_1.New
	local var_30_2 = arg_30_0._tf

	arg_30_0.bgView = var_30_1(var_2.Find(var_30_2, "Sea/bg"))
	MainPaintingView = var_1

	local var_30_3 = var_1.New
	local var_30_4 = arg_30_0._tf
	local var_30_5 = var_2.Find(var_30_4, "paint")
	local var_30_6 = arg_30_0._tf

	arg_30_0.paintingView = var_30_3(var_30_5, var_3.Find(var_30_6, "paintBg"), arg_30_0.event)
	MainEffectView = var_1

	local var_30_7 = var_1.New
	local var_30_8 = arg_30_0._tf

	arg_30_0.effectView = var_30_7(var_2.Find(var_30_8, "paint/effect"))
	...
	NewMainScene = var_30_9

	local var_30_11 = var_30_9.THEME_CLASSIC

	NewMainClassicTheme = var_3
	var_30_10[var_30_11] = var_3.New(arg_30_0._tf, arg_30_0.event, arg_30_0.contextData)
...
function var_0_1.didEnter(arg_31_0)
	...
	var_31_1(var_31_0, var_1_10003.FOLD, function(arg_32_0, arg_32_1)
		...
		local var_32_7 = var_8.GetPaintingOffset(var_32_6, var_2)
		local var_32_8 = arg_31_0.theme

		var_32_2(var_32_1, var_32_3, var_32_4, var_32_5, var_32_7, var_9.GetCalibrationBG(var_32_8))
	...
	var_31_3(var_31_2, var_3.HIDE, function(arg_33_0, arg_33_1)
		...
		local var_33_7 = var_8.GetPaintingOffset(var_33_6, var_2)
		local var_33_8 = arg_31_0.theme

		var_33_2(var_33_1, var_33_3, var_33_4, var_33_5, var_33_7, var_9.GetCalibrationBG(var_33_8))
	...
	var_31_5(var_31_4, var_3.ON_CHANGE_SKIN, function(arg_34_0)
	...
	var_31_7(var_31_6, var_3.ENTER_SILENT_VIEW, function()
	...
	var_31_9(var_31_8, var_3.WILL_LOGOUT, function()
	...
	var_31_11(var_31_10, var_3.EXIT_SILENT_VIEW, function()
	...
	var_31_13(var_31_12, var_3.ON_SKIN_FREEUSAGE_DESC, function(arg_38_0, arg_38_1)
	...
	var_31_15(var_31_14, var_3.OPEN_LIVEAREA, function(arg_39_0)
	...
	var_31_17(var_31_16, var_3.L2D_BOUND_CHANGE, function(arg_40_0)
...
function var_0_1.SetUp(arg_41_0, arg_41_1, arg_41_2)
	...
	var_4({
		...
		function(arg_49_0)
			...
			var_49_1(var_49_0, var_3.ApplyDefaultResUI(var_49_2))
		...
		var_50_2(var_50_1, var_2_10002.ON_ENTER_DONE)
...
function var_0_1.SetUpSilentChecker(arg_51_0)
	...
	Screen = var_51_0
	arg_51_0.defaultSleepTimeout = var_51_0.sleepTimeout
	Screen = var_2
...
function var_0_1.SwitchToNextShip(arg_56_0)
	...
	if not var_1.IsLoading(var_56_0) then
		...
		if var_2.getSkinId(var_56_4) ~= var_56_3:getSkinId() or arg_56_0.bgView.ship.id ~= var_56_3.id then
			...
			var_56_7(var_56_6, var_56_8, var_5.GetPaintingOffset(var_56_9, var_56_3))
...
function var_0_1.UpdateFlagShip(arg_57_0, arg_57_1, arg_57_2)
	...
	if not var_3.IsLoading(var_57_0) then
		...
		var_57_6(var_57_5, var_57_7, var_7.GetPaintingOffset(var_57_8, arg_57_1))
...
function var_0_1.CheckDebugBattleLoop(arg_58_0)
	...
	if #var_1_10001.tempList == 0 then
		if #var_1_10001.loopStages > 0 then
			table = var_58_0
	...
	var_3(var_4.format("【正在执行关卡%s的第%d次战斗循环】", var_58_2, var_1_10001.loopCount - #var_1_10001.tempList))
	...
	var_58_4(var_58_3, var_5.DEBUG_BATTLE_LOOP, var_58_2)
...
function var_0_1.Refresh(arg_64_0)
	...
	var_64_0({
		...
		function(arg_67_0)
			...
			var_67_1(var_67_0, var_3.ApplyDefaultResUI(var_67_2))
			...
			var_67_7(var_67_6, var_67_8, var_5.GetPaintingOffset(var_67_9, var_67_4))
		...
		var_69_2(var_69_1, var_2_10002.ON_ENTER_DONE)
