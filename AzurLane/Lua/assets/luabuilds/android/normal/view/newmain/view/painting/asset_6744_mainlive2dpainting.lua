...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	CanvasGroup = var_6
	arg_1_0.cg = var_1_1(var_1_0, var_5(var_6))
	Screen = var_3
	...
	arg_1_0.eventTrigger = var_3(var_1_2, var_5(var_6))
...
function var_0_1.OnLoad(arg_4_0, arg_4_1)
	...
	Vector3 = var_4
	var_4_1.position = var_4(0, 0, 100)
...
function var_0_1.AdJustOrderInLayer(arg_8_0, arg_8_1)
	...
	var_8_1(var_8_0, var_1_10004.L2D_DEFAULT_LAYER)
...
function var_0_1.ResetOrderInLayer(arg_9_0)
	...
	var_9_1(var_9_0, var_1_10003(var_1_10004)).SortingOrder = 0
...
function var_0_1.CreateL2dDragBound(arg_10_0, arg_10_1)
	...
	var_2.InitUI(var_10_0, nil, function()
		if arg_10_0._dragBoundsUI and arg_10_1 then
			...
			var_12_3(var_12_2, var_12_4, var_4.getSkinId(var_12_5))
			...
			var_12_8(var_12_7, var_3.GetLive2DStateData(var_12_9))
		end
	...
	if arg_19_0.live2dChar then
		...
		if var_19_1 == var_1_10003.STATE_INITED and not arg_19_0.live2dChar.ignoreReact then
			...
			if var_3.GetTouchPart(var_19_2) > 0 then
				...
				local var_19_4 = arg_19_0.GetTouchEvent(var_19_3, var_3)

				math = var_19_3

				local var_19_5 = var_19_3.ceil

				math = var_1_10006
				var_19_0 = var_19_4[var_19_5(var_1_10006.random(#var_19_4))]
			else
				local var_19_6 = arg_19_0
				local var_19_7 = arg_19_0.GetIdleEvents(var_19_6)

				math = var_19_6

				local var_19_8 = var_19_6.floor

				math = var_1_10006
				var_19_0 = var_19_7[var_19_8(var_1_10006.Random(0, #var_19_7)) + 1]
			end
		end
	end
...
function var_0_1._TriggerEvent(arg_20_0, arg_20_1)
	...
	local function var_20_1(arg_21_0)
		if arg_21_0 then
			if var_20_0.dialog ~= "" then
				...
				var_1.DisplayWord(var_21_0, var_20_0.dialog)
			else
	...
	local var_20_2, var_20_3, var_20_4, var_20_5, var_20_6, var_20_7 = var_4.GetCvDataForShip(arg_20_0.ship, var_20_0.dialog)
	local var_20_8 = var_20_0.action
	local var_20_9 = var_20_0.dialog

	string = var_1_10012

	local var_20_10 = var_1_10012.gsub(var_20_9, "main_", "main")

	if arg_20_0.ship.propose then
		pg = var_12

		if var_12.character_voice[var_20_10] and arg_20_0.shipGroup then
			local var_20_11 = arg_20_0.shipGroup
			local var_20_12 = var_12.VoiceReplayCodition

			pg = var_14

			if var_20_12(var_20_11, var_14.character_voice[var_20_10]) then
				local var_20_13 = arg_20_0.live2dChar

				if var_12.checkActionExist(var_20_13, var_20_8 .. "_ex") then
	...
	if not var_20_7 then
		...
		local var_20_15 = var_12.TriggerAction(var_20_14, var_20_8)
		...
		local var_20_16 = arg_20_0.live2dChar

		if not var_12.TriggerAction(var_20_16, var_20_8, nil, nil, var_20_1) then
			arg_20_0.actionWaiting = false
		end
	end
...
function var_0_1.PlayCV(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4)
	...
	local var_22_3 = var_22_1(var_6.getSkinId(var_22_2))

	pg = var_6

	local var_22_4 = var_6.CriMgr.GetCVBankName(var_22_3)
...
function var_0_1.UpdateBound(arg_27_0)
	if not arg_27_0._dragBoundsUI and arg_27_0.live2dChar then
		...
		var_27_1(var_27_0, var_1_10003.l2d_bound_open)
	elseif arg_27_0._dragBoundsUI then
		...
		if var_1.GetDragsCount(var_27_2) == 0 then
			...
			var_1_10003 = arg_27_0._dragBoundsUI

			local var_27_5 = var_2.SetData
			local var_27_6 = var_27_4
			local var_27_7 = arg_27_0.ship

			var_27_5(var_1_10003, var_27_6, var_5.getSkinId(var_27_7))
		end
		...
		var_27_9(var_27_8, var_1_10003.l2d_bound_open)
	end
...
function var_0_1.IslimitYPos(arg_42_0)
	...
	return var_42_0(var_2.getPainting(var_42_1))
end
