...
function var_0_0.UpdateList(arg_10_0, arg_10_1)
	...
	var_2.make(var_10_0, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			local var_11_4 = var_11_3(var_11_2, var_7(var_2_10008))
			...
			local var_11_10 = arg_11_2:Find("frame/got_btn")
			local var_11_11 = arg_11_2
			local var_11_12 = arg_11_2.Find(var_11_11, "frame/go_btn")

			setText = var_11_11

			var_11_11(var_11_8, var_11_0:getConfig("desc"))
			...
			var_18(var_11_10, var_11_0:getTaskStatus() == 2)
			...
			var_18(var_11_12, var_11_0:getTaskStatus() == 0)

			onButton = var_18

			local var_11_21 = arg_10_0
			local var_11_22 = var_11_12
			...
			var_18(var_11_21, var_11_22, var_11_23, var_22)

			onButton = var_18

			local var_11_24 = arg_10_0
			...
			var_18(var_11_24, var_11_25, var_11_26, var_22)
		end
