...
function var_0_1.register(arg_1_0)
	...
	arg_1_0.bind(var_1_0, var_0_1.UNLOCK, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.UNLOCK_CRYPTOLALIA, {
			id = arg_2_1,
			costType = arg_2_2
		})
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_0 == var_4_1.UNLOCK_CRYPTOLALIA_DONE then
		local var_4_3 = arg_4_0.viewComponent
		local var_4_4 = var_4.emit

		CryptolaliaScene = var_1_10006

		var_4_4(var_4_3, var_1_10006.ON_UNLOCK, var_4_2.id)
	end
