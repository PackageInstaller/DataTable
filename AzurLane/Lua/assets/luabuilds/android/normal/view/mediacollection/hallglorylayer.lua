...
function var_0_1.OnInit(arg_2_0)
	...
	pg = var_2
	arg_2_0.memoryGroups = var_2_5(var_2.memory_group.all, function(arg_5_0)
		pg = var_2_10001
	...
	local var_2_7 = var_2.Find(var_2_6, "progress/Text")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("memory_filter_option_2"))
...
function var_0_1.MemoryFilter(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1(var_2.memory_group.all) do
		pg = var_1_10006
	...
	local var_6_2 = var_6_0.reduce(arg_6_0.memories, 0, function(arg_8_0, arg_8_1)
	...
	var_6_3(var_4.Find(var_6_4, "progress/num"), var_6_2 .. "/" .. var_6_1)
...
function var_0_1.onInitMemoryGroup(arg_9_0, arg_9_1)
	...
	for iter_9_0 = 1, 3 do
		...
		local var_9_2 = var_1_10006:Find("BG/play")
		...
		var_9_0(var_9_1, var_9_2, var_9_3, var_11)
	end
...
function var_0_1.onUpdateMemoryGroup(arg_11_0, arg_11_1, arg_11_2)
	for iter_11_0 = 1, 3 do
		...
		if var_11_0.is_open ~= 1 then
			pg = var_15
			var_1_10016 = var_15.NewStoryMgr.GetInstance()
			var_11_9 = var_15.IsPlayed(var_1_10016, var_11_0.unlock_pre, true)
		...
		var_17(var_11_2:Find("BG/lock"), not var_11_9)

		setActive = var_17

		var_17(var_11_2:Find("BG/headline"), var_11_9)

		setActive = var_17

		var_17(var_11_2:Find("BG/play"), var_11_9)

		if var_11_9 then
			setText = var_17

			var_17(var_11_2:Find("name_bg/name"), var_1_10016.name)

			setText = var_17

			var_17(var_11_2:Find("BG/lock/Text"), var_11_6)

			setText = var_17

			var_17(var_11_2:Find("wire/yer"), var_11_8)

			setText = var_17

			var_17(var_11_2:Find("BG/headline/Text"), var_11_5)
		else
			setText = var_17
		...
		LoadImageSpriteAsync = var_17

		var_17("MemoryIcon/" .. var_11_7, var_11_2:Find("BG/bg/bg/icon"), true)
	end
...
function var_0_1.PlayMemory(arg_13_0, arg_13_1)
	if arg_13_1.type == 1 then
		...
		if var_3.len(arg_13_1.mask) > 0 then
			setActive = var_13_2

			var_13_2(var_13_0, true)

			local var_13_1 = var_13_0

			var_13_2 = var_13_0.GetComponent
			typeof = var_5
			Image = var_1_10006
			var_13_2 = var_13_2(var_13_1, var_5(var_1_10006))
			LoadSprite = var_13_1
			var_13_2.sprite = var_13_1(arg_13_1.mask)
		else
			setActive = var_13_2

			var_13_2(var_13_0, false)
		end

		setActive = var_13_2

		var_13_2(arg_13_0.memoryMask, true)

		pg = var_13_2

		local var_13_3 = var_13_2.NewStoryMgr.GetInstance()

		var_3.Play(var_13_3, arg_13_1.story, function()
	...
	elseif arg_13_1.type == 2 then
		...
		local var_13_4 = var_2.NewStoryMgr.GetInstance()
		local var_13_5 = var_2.StoryName2StoryId(var_13_4, arg_13_1.story)

		assert = var_13_4

		local var_13_6 = var_13_5 and var_13_5 ~= 0
		local var_13_7 = "Missing Story Stage ID: "
		local var_13_8
		...
		var_13_4(var_13_6, var_13_7 .. var_13_8)
		...
		local var_13_11 = var_5.BEGIN_STAGE
		local var_13_12 = {
			memory = true
		}

		SYSTEM_PERFORM = var_1_10007
		var_13_12.system = var_1_10007
		var_13_12.stageId = var_13_5

		var_13_10(var_13_9, var_13_11, var_13_12)
	end
