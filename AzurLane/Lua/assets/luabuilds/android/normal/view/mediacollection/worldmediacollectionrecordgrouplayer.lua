...
function var_0_1.OnInit(arg_2_0)
	...
	var_2_11(var_2.world_collection_record_group.all, function(arg_3_0)
		pg = var_2_10001
	...
	for iter_2_1, iter_2_2 in var_4(arg_2_0.recordToggles) do
		...
		var_1_10009(var_2_16, var_2_17, var_2_18, var_1_10013)
	end
	...
	LayerWeightConst = iter_2_2
	var_2_22.overlayType = iter_2_2.OVERLAY_UI_ADAPT
	...
	local var_2_24 = var_5.Find(var_2_23, "ProgressDesc")

	i18n = var_2_23

	var_4(var_2_24, var_2_23("world_collection_3"))
...
function var_0_1.Hide(arg_7_0)
	...
	var_7_0(var_1_10002(arg_7_0.content))
...
function var_0_1.OnUpdateGroup(arg_8_0, arg_8_1, arg_8_2)
	...
	var_5(var_8_1:Find("FileIndex"), var_8_0.id)

	local var_8_2 = var_8_1
	local var_8_3 = var_8_1.Find(var_8_2, "NameRect/FileName1")

	GetPerceptualSize = var_8_2

	local var_8_4 = var_8_2(var_8_0.name_abbreviate)
	local var_8_5
	local var_8_6 = var_8_4 <= 4 and 32 or var_8_4 <= 6 and 28 or 24
	local var_8_7 = var_8_3
	local var_8_8 = var_8_3.GetComponent

	typeof = var_1_10010
	Text = var_1_10011

	local var_8_9 = var_8_8(var_8_7, var_1_10010(var_1_10011))

	var_8_9.fontSize = var_8_6
	var_8_9.text = var_8_0.name_abbreviate

	local var_8_10 = arg_8_0.loader

	var_9.GetSprite(var_8_10, "ui/WorldMediaCollectionRecordUI_atlas", var_0_2[var_8_0.type], var_8_1:Find("BG"))

	nowWorld = var_9

	local var_8_11 = var_9()
	local var_8_12 = var_9.GetCollectionProxy(var_8_11)
	local var_8_13 = #var_8_0.child

	_ = var_11

	local var_8_14 = var_11.reduce(var_8_0.child, 0, function(arg_9_0, arg_9_1)
		WorldCollectionProxy = var_2_10002

		if var_2_10002.GetCollectionTemplate(arg_9_1) then
			WorldMediaCollectionRecordDetailLayer = var_3

			if var_3.CheckRecordIsUnlock(var_2) then
				arg_9_0 = arg_9_0 + 1
			end
		end
	...
	var_12(var_8_1:Find("FileProgress"), var_8_14 .. "/" .. var_8_13)

	local var_8_15 = arg_8_0.scroll.rect.width
	local var_8_16 = arg_8_0.scroll
	local var_8_17 = var_13.Find(var_8_16, "Item").rect.width
	local var_8_18 = arg_8_0.content
	local var_8_19 = var_14.GetComponent

	typeof = var_16
	HorizontalLayoutGroup = var_1_10017

	local var_8_20 = var_8_19(var_8_18, var_16(var_1_10017)).padding.left
	local var_8_21 = var_14.spacing

	onButton = var_1_10017

	local var_8_22 = arg_8_0
	local var_8_23 = var_8_1
	...
	var_1_10017(var_8_22, var_8_23, var_8_24, var_1_10021)
...
function var_0_1.RecordFilter(arg_12_0)
	...
	local var_12_2 = var_1_10003.each

	pg = var_1_10004

	var_12_2(var_1_10004.world_collection_record_group.all, function(arg_13_0)
		pg = var_2_10001
