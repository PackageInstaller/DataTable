...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.eventTriggerListener = var_1_1(var_1_0, var_1_10005(var_1_10006))
...
function var_0_0.SetUp(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_1_10001(arg_7_0.items) do
		...
		local function var_7_2()
			...
			var_8_1(var_8_0, var_2.GetIndex(var_8_2))
	...
	for iter_15_0 = 1, var_15_0 do
		...
		var_1_10009.insert(var_15_2, function(arg_16_0)
			...
			if iter_15_0 == var_15_0 then
				...
				onNextTick = var_2_10005

				var_16_3(var_16_2, var_16_4, var_2_10005(arg_16_0))
			end
...
function var_0_0.Step1(arg_17_0, arg_17_1, arg_17_2)
	...
	for iter_17_0, iter_17_1 in var_1_10005(arg_17_0.items) do
		...
		if iter_17_1:GetIndex() + arg_17_1 > arg_17_0.totalCnt then
			...
			NewTpl = var_1_10013
			arg_17_0.sinker = var_17_3(var_1_10013(arg_17_0, iter_17_1._go), arg_17_0.midIndex, 0)
		elseif var_17_2 <= 0 then
			...
			NewTpl = var_1_10013
			arg_17_0.sinker = var_17_5(var_1_10013(arg_17_0, iter_17_1._go), arg_17_0.midIndex, arg_17_0.totalCnt + 1)
		end
...
function var_0_0.Step(arg_23_0, arg_23_1, arg_23_2)
	...
	for iter_23_0, iter_23_1 in var_1_10007(arg_23_0.items) do
		...
		if iter_23_1:GetIndex() + arg_23_1 > arg_23_0.totalCnt then
			...
			NewTpl = var_1_10015
			arg_23_0.sinker = var_23_5(var_1_10015(arg_23_0, iter_23_1._go), arg_23_0.midIndex, 0)
			var_1_10015 = arg_23_0.sinker
			var_23_3 = var_14.GetPosition(var_1_10015)
		elseif var_23_4 <= 0 then
			...
			NewTpl = var_1_10015
			arg_23_0.sinker = var_23_7(var_1_10015(arg_23_0, iter_23_1._go), arg_23_0.midIndex, arg_23_0.totalCnt + 1)
			var_1_10015 = arg_23_0.sinker
			var_23_3 = var_14.GetPosition(var_1_10015)
		end
		...
		var_1_10015 = iter_23_1

		iter_23_1.UpdateIndexSilence(var_1_10015, var_23_4)
