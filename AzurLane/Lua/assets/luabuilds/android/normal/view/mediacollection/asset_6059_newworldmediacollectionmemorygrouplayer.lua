...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_0 = var_1(var_2.memory_group.all)
	...
	local var_2_8 = var_2_6(arg_2_0.memoryGroupList)
	...
	arg_2_0.memoryGroupsGrid = var_2_11(var_2_10, var_4(var_1_10005))
	AutoLoader = var_2
	...
	local var_2_16 = var_3.Find(var_2_15, "label")

	i18n = var_2_15

	var_2(var_2_16, var_2_15("storyline_memorysearch2"))
	...
	var_2(arg_2_0, arg_2_0.searchBtn, function()
		...
		local var_7_1 = var_1.Find(var_7_0, "holder")

		i18n = var_7_0

		var_2_10000(var_7_1, var_7_0("storyline_memorysearch1"))
	...
	var_2(arg_2_0, arg_2_0.closeSearch, function()
		if arg_2_0.searchOpen then
			...
			local var_8_1 = var_1.Find(var_8_0, "label")

			i18n = var_8_0

			var_0(var_8_1, var_8_0("storyline_memorysearch2"))
		else
			triggerButton = var_0
	...
	var_2(var_2_17, var_4.Find(var_2_18, "ActivityToggle/search/up"), function()
		...
		var_10_0(var_1.Find(var_10_1, "ActivityToggle/search/up"), arg_2_0.selectAsc)

		setActive = var_10_0

		local var_10_2 = arg_2_0._tf

		var_10_0(var_1.Find(var_10_2, "ActivityToggle/search/below"), not arg_2_0.selectAsc)
	...
	var_2(var_2_19, var_4.Find(var_2_20, "ActivityToggle/search/below"), function()
		...
		var_11_0(var_1.Find(var_11_1, "ActivityToggle/search/up"), arg_2_0.selectAsc)

		setActive = var_11_0

		local var_11_2 = arg_2_0._tf

		var_11_0(var_1.Find(var_11_2, "ActivityToggle/search/below"), not arg_2_0.selectAsc)
	...
	var_2(var_2_21, var_4.Find(var_2_22, "ActivityToggle/btn"), function()
		local var_12_0 = {}
		...
		var_12_2.mode = var_2_10003.Mode.OR
		...
		CustomIndexMediator = var_3
		var_12_7.mediator = var_3
		RoleStoryCustomIndexLayer = var_3
		var_12_7.viewComponent = var_3
		...
		WorldMediaCollectionMediator = var_4

		var_12_10(var_12_9, var_4.ON_ADD_SUBLAYER, var_12_8)
	...
	var_2_24(var_3.Find(var_2_25, "ActivityToggle/search/below"))
...
function var_0_1.StoryLineBtnSetActive(arg_19_0, arg_19_1)
	...
	var_1_10002(var_3.Find(var_19_0, "StoryLineBtn/on"), not arg_19_1)
...
function var_0_1.OnLockRole(arg_22_0, arg_22_1)
	...
	local var_22_4 = var_22_1.getShips(var_22_3)
	...
	for iter_22_0, iter_22_1 in var_22_3(var_22_4) do
		...
		if var_1_10011 == var_12(var_22_0.ship_group) then
			var_22_2 = true
...
function var_0_1.onInitMemoryGroup(arg_28_0, arg_28_1)
	...
	local function var_28_2()
		...
		if arg_28_0.memoryGroupInfos[arg_28_1] then
			...
			local var_29_0 = var_1(var_2_10002)
			local var_29_1 = var_1.getRawData(var_29_0).id

			PlayerPrefs = var_29_0

			var_29_0.DeleteKey("MEMORY_GROUP_NOTIFICATION" .. var_29_1 .. " " .. var_0.id)
	...
	var_2(var_28_0, var_28_1, var_28_2, var_1_10006)
...
function var_0_1.onUpdateMemoryGroup(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_0 = var_3(var_1_10004)
	...
	local var_30_3 = var_6.reduce(var_30_1.memories, 0, function(arg_31_0, arg_31_1)
		pg = var_2_10002
	...
	local var_30_4 = var_7(var_8)
	local var_30_5 = var_7.getRawData(var_30_4).id

	PlayerPrefs = var_30_4

	local var_30_6

	var_30_6 = var_30_4.GetInt("MEMORY_GROUP_NOTIFICATION" .. var_30_5 .. " " .. var_30_1.id, 0) == 1
	tobool = var_9

	local var_30_7 = var_9(var_30_0 and var_30_0.shipGroups[var_30_1.ship_group]) or var_30_3 > 0

	setActive = var_11
	tf = var_12

	local var_30_8 = var_12(arg_30_2)

	var_11(var_12.Find(var_30_8, "on"), var_30_7)

	setActive = var_11
	tf = var_12

	local var_30_9 = var_12(arg_30_2)

	var_11(var_12.Find(var_30_9, "off"), not var_30_7)
	...
	local var_30_11 = var_13(arg_30_2)

	var_12(var_13.Find(var_30_11, "Tip"), var_30_10)

	setActive = var_12
	tf = var_13

	local var_30_12 = var_13(arg_30_2)

	var_12(var_13.Find(var_30_12, "on/get"), var_30_10)

	setActive = var_12
	tf = var_13

	local var_30_13 = var_13(arg_30_2)

	var_12(var_13.Find(var_30_13, "on/title_get"), var_30_10)

	setText = var_12
	tf = var_13

	local var_30_14 = var_13(arg_30_2)

	var_12(var_13.Find(var_30_14, "on/title"), var_30_1.title)

	setText = var_12
	tf = var_13

	local var_30_15 = var_13(arg_30_2)
	local var_30_16 = var_13.Find(var_30_15, "off/title")

	i18n = var_30_15

	var_12(var_30_16, var_30_15("memory_filter_option_6"))

	setText = var_12
	tf = var_30_16

	local var_30_17 = var_30_16(arg_30_2)
	local var_30_18 = var_13.Find(var_30_17, "on/title_get/title")

	i18n = var_30_17

	var_12(var_30_18, var_30_17("memory_filter_option_4"))
	...
	var_12(var_13.Find(var_30_19, "on/count"), var_30_3 .. "/" .. var_30_2)
	...
	local var_30_24 = var_16(arg_30_2)

	var_30_21(var_30_20, var_30_22, var_30_23, var_16.Find(var_30_24, "on/BG"))
	...
	local var_30_29 = var_16(arg_30_2)

	var_30_26(var_30_25, var_30_27, var_30_28, var_16.Find(var_30_29, "off/BG"))

	return
end

function var_0_1.Return2MemoryGroup(arg_32_0)
	if arg_32_0.contextData.memoryGroup then
		var_1_10003 = arg_32_0

		if arg_32_0.GetCurrentMode(var_1_10003) == var_0_1.LINE_MODE then
			return
		end
...
function var_0_1.SwitchReddotMemory(arg_33_0)
	...
	local var_33_1 = var_1_10002(var_1_10003)
	local var_33_2 = var_2.getRawData(var_33_1).id

	ipairs = var_33_1

	for iter_33_0, iter_33_1 in var_33_1(arg_33_0.searchGroupList) do
...
function var_0_1.GetIndexRatio(arg_34_0, arg_34_1)
	...
	if arg_34_1 > 0 then
		...
		math = var_7
		var_34_0 = (var_34_2 * var_7.floor((arg_34_1 - 1) / var_34_3) + var_34_1.paddingFront) / (var_34_4 - arg_34_0.memoryGroupViewport.rect.height)
		Mathf = var_7
...
function var_0_1.GetMatchGroupList(arg_35_0, arg_35_1, arg_35_2)
	...
	string = var_4
	arg_35_1 = var_35_0(var_4.gsub(arg_35_1, "%.", "%%."))

	local var_35_1 = {}

	pairs = var_4

	for iter_35_0, iter_35_1 in var_4(arg_35_0.memoryGroups) do
		string = var_1_10009
		var_1_10009 = var_1_10009.find
		string = var_1_10010

		if var_1_10009(var_1_10010.lower(iter_35_1.title), arg_35_1) then
			table = var_1_10009

			var_1_10009.insert(var_35_1, iter_35_1)
		else
			ShipGroup = var_1_10009
			var_1_10009 = var_1_10009.getDefaultShipNameByGroupID(iter_35_1.ship_group)
			string = var_1_10010
			var_1_10010 = var_1_10010.find
			string = var_11

			if var_1_10010(var_11.lower(var_1_10009), arg_35_1) then
				table = var_1_10010
...
function var_0_1.UpdateFilterBtn(arg_36_0)
	...
	var_1_10003(var_4.Find(var_36_0, "ActivityToggle/btn/active"), var_1_10002)
