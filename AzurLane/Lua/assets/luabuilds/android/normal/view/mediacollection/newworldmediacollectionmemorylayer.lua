...
function var_0_1.GetDetailLayer(arg_3_0)
	...
	var_1_10001(var_2.Find(var_3_0, "RoleTitle"), true)

	setActive = var_1_10001

	local var_3_1 = arg_3_0._top

	var_1_10001(var_2.Find(var_3_1, "HonorTitle"), false)
...
function var_0_1.GetGroupLayer(arg_6_0)
	...
	var_1_10001(var_2.Find(var_6_0, "RoleTitle"), true)

	setActive = var_1_10001

	local var_6_1 = arg_6_0._top

	var_1_10001(var_2.Find(var_6_1, "HonorTitle"), false)
...
function var_0_1.GetHallGloryLayer(arg_9_0)
	...
	var_1_10001(var_2.Find(var_9_0, "RoleTitle"), false)

	setActive = var_1_10001

	local var_9_1 = arg_9_0._top

	var_1_10001(var_2.Find(var_9_1, "HonorTitle"), true)
...
function var_0_1.OnSelected(arg_13_0)
	...
	if var_13_1(var_13_0, var_1_10004.QIXI_ACTIVITY_ID) and not var_2:isEnd() then
		local var_13_2 = var_2
		local var_13_3 = var_2.getConfig(var_13_2, "config_data")

		_ = var_13_2

		local var_13_4 = var_4[#var_13_2.flatten(var_13_3)]

		getProxy = var_1_10006
		TaskProxy = var_1_10007

		local var_13_5 = var_1_10006(var_1_10007)

		if var_1_10006.getTaskById(var_13_5, var_13_4) and not var_7:isFinish() then
			pg = var_8

			local var_13_6 = var_8.NewStoryMgr.GetInstance()

			var_8.Play(var_13_6, "HOSHO8", function()
				local var_14_0 = arg_13_0
				local var_14_1 = var_0.emit

				CollectionScene = var_2_10002

				var_14_1(var_14_0, var_2_10002.ACTIVITY_OP, {
					cmd = 2,
	...
	local var_13_7 = arg_13_0.contextData.memoryGroup
	local var_13_8 = arg_13_0.contextData

	var_13_8.memoryGroup = nil

	if var_13_7 then
		pg = var_13_8

		if var_13_8.memory_group[var_13_7] then
			local var_13_9 = arg_13_0
			local var_13_10 = arg_13_0.ShowSubMemories

			pg = var_1_10006

			var_13_10(var_13_9, var_1_10006.memory_group[var_13_7])
