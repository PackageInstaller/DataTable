...
function var_0_0.Play(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	if not var_4_1(var_4_0, var_4_2, var_1_10007) then
		pg = var_4_4
...
function var_0_0.RegisterEvent(arg_8_0)
	...
	getProxy = var_3
	CryptolaliaProxy = var_4

	local var_8_10 = var_3(var_4)

	var_1_10001(var_8_9, var_3.GetLoop(var_8_10))
...
function var_0_0.Pause(arg_17_0)
	...
	local var_17_4 = var_1_10005.floor(var_17_2 / 60)
	local var_17_5 = ":"

	string = var_1_10007

	var_3(var_17_3, var_17_4 .. var_17_5 .. var_1_10007.format("%02d", var_17_2 % 60))
	...
	local var_17_8 = var_17_7(var_17_6, var_5(var_17_5)).onValueChanged
	...
	var_4.AddListener(var_17_9, function(arg_18_0)
		...
		math = var_18_0
		var_18_1.targetFrame = var_18_0.floor(arg_18_0 * arg_17_0.totalFrames)
		...
		local var_18_4 = var_2_10004.floor(var_18_2 / 60)
		local var_18_5 = ":"

		string = var_2_10006

		var_2(var_18_3, var_18_4 .. var_18_5 .. var_2_10006.format("%02d", var_18_2 % 60))

		local var_18_6 = arg_17_0

		Clone = var_18_3
		var_18_6.subtile = var_18_3(arg_17_0.subtileBackUp)
...
local function var_0_11(arg_23_0)
	...
	local var_23_2 = var_1_10003.ReadAllLines(var_23_0)
	local var_23_3 = var_3.ToTable(var_23_2)

	ipairs = var_23_2

	for iter_23_0, iter_23_1 in var_23_2(var_23_3) do
		string = var_1_10009
		var_1_10009 = var_1_10009.match(iter_23_1, "#%d+#%d+$")
		string = var_10

		local var_23_4 = var_10.split(var_1_10009, "#")[2]
		local var_23_5 = var_10[3]

		string = var_1_10013
		var_1_10013 = var_1_10013.gsub(iter_23_1, var_1_10009, "")
		table = var_14

		local var_23_6 = var_14.insert
		local var_23_7 = var_23_1
		local var_23_8 = {}

		tonumber = var_1_10017
		var_23_8.startTime = var_1_10017(var_23_4)
		tonumber = var_1_10017
		var_23_8.endTime = var_1_10017(var_23_5)
		var_23_8.content = var_1_10013
...
function var_0_0.LoadVedioPlayer(arg_24_0, arg_24_1, arg_24_2)
	...
	var_24_1(var_24_0, var_24_2, var_24_3, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_25_0)
		Object = var_2_10001
		...
		typeof = var_5
		Text = var_2_10006
		var_25_1.text = var_25_4(var_25_3, var_5(var_2_10006))
		...
		typeof = var_5
		CriManaCpkUI = var_2_10006
		var_25_5.player = var_25_8(var_25_7, var_5(var_2_10006))
		...
		var_2.SetCpkTotalTimeCallback(var_25_27, function(arg_26_0)
			...
			local var_26_2 = var_3.floor(arg_24_0.totalTime / 60)
			local var_26_3 = ":"

			string = var_3_10005

			var_26_0(var_26_1, var_26_2 .. var_26_3 .. var_3_10005.format("%02d", arg_24_0.totalTime % 60))
