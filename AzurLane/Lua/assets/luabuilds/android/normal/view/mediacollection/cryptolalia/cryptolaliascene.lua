...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.cg = var_3_1(var_3_0, var_1_10003(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_3_0.cdImg = var_3_8(var_3_7, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_3_0.cdSignatureImg = var_3_11(var_3_10, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.shipName = var_3_14(var_3_13, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.timeTxt = var_3_18(var_3_17, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.nameTxt = var_3_21(var_3_20, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.authorTxt = var_3_24(var_3_23, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.descTxt = var_3_27(var_3_26, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_3_0.signatureImg = var_3_30(var_3_29, var_3(var_1_10004))
	...
	arg_3_0.auditionEffect = var_3_35(var_3_34, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.stateBtnTxt = var_3_48(var_3_47, var_3(var_1_10004))
	...
	CryptolaliaScrollRect = var_2

	local var_3_53 = var_2.New
	local var_3_54 = arg_3_0._tf

	arg_3_0.scrollRect = var_3_53(var_3.Find(var_3_54, "Main/list/tpl"), var_3_52)
	...
	typeof = var_4
	DftAniEvent = var_5
	arg_3_0.dftAniEvent = var_3_57(var_3_56, var_4(var_5))
	setText = var_2

	local var_3_58 = arg_3_0._tf
	local var_3_59 = var_3.Find(var_3_58, "Main/cd/timelimit/label")

	i18n = var_3_58

	var_2(var_3_59, var_3_58("cryptolalia_timelimie"))

	setText = var_2

	local var_3_60 = arg_3_0.downloadingBtn
	local var_3_61 = var_3.Find(var_3_60, "label")

	i18n = var_3_60

	var_2(var_3_61, var_3_60("cryptolalia_label_downloading"))
...
function var_0_1.OnItemUpdate(arg_11_0, arg_11_1)
	...
	local var_11_2 = var_11_0.GetShipGroupId(var_11_1)

	LoadSpriteAtlasAsync = var_11_1

	var_11_1("CryptolaliaShip/" .. var_11_2, "icon", function(arg_12_0)
...
function var_0_1.OnItemSelected(arg_13_0, arg_13_1)
	...
	local var_13_0 = var_2
	local var_13_1 = var_2.GetCpkName(var_13_0, arg_13_0.langType)

	Cryptolalia = var_13_0

	local var_13_2 = var_13_0.BuildCpkPath(var_13_1)
	local var_13_3 = arg_13_0.downloadMgr

	if var_5.IsDownloadState(var_13_3, var_13_2) and arg_13_0.downloadReqList[var_2.id] == nil then
		arg_13_0:OnUpdateForResDownload("ReConnection", var_2, arg_13_1)
	end

	local var_13_4 = arg_13_0.mainView

	var_6.Flush(var_13_4, var_2, arg_13_0.langType, var_5)
...
function var_0_1.FillEmptyDisplayIfNeed(arg_17_0, arg_17_1)
	...
	for iter_17_0 = var_17_1, var_1_10004.max(5, #arg_17_1) do
		...
		var_1_10007 = var_1_10007(arg_17_1[iter_17_0], false)

		if iter_17_0 % 2 == 0 then
			table = var_8

			var_8.insert(var_17_0, var_1_10007)
		else
			table = var_8

			var_8.insert(var_17_0, 1, var_1_10007)
		end
	end
...
function var_0_1.RegisterEvent(arg_18_0)
	...
	local function var_18_8()
		...
		if not var_0:IsMultiVersion() then
			...
			var_24_1(var_24_0, var_2_10003("cryptolalia_coming_soom"))
	...
	local var_18_17 = var_3.Find(var_18_16, "play")
	...
	var_1(var_18_15, var_18_17, var_18_18, var_5)
	...
	var_1(var_18_19, var_18_20, var_18_21, var_5)
	...
	var_1(var_18_22, var_18_23, var_18_24, var_5)
	...
	var_1(var_18_25, var_18_26, var_18_27, var_5)
	...
	var_1(var_18_28, var_18_29, var_18_30, var_5)
	...
	var_1(var_18_31, var_18_32, var_18_33, var_5)
...
function var_0_1.IsDownloading(arg_38_0, arg_38_1)
	...
	if var_38_1(var_38_0, var_1_10004.LANG_TYPE_CH) then
		local var_38_2 = arg_38_1
		local var_38_3 = arg_38_1.GetCpkName

		Cryptolalia = var_4

		local var_38_4 = var_38_3(var_38_2, var_4.LANG_TYPE_CH)

		Cryptolalia = var_38_2

		local var_38_5 = var_38_2.BuildCpkPath(var_38_4)
		local var_38_6 = arg_38_0.downloadMgr

		if var_4.IsDownloadState(var_38_6, var_38_5) then
			return true
		end
	end

	local var_38_7 = arg_38_1
	local var_38_8 = arg_38_1.ExistLang

	Cryptolalia = var_4

	if var_38_8(var_38_7, var_4.LANG_TYPE_JP) then
		local var_38_9 = arg_38_1
		local var_38_10 = arg_38_1.GetCpkName

		Cryptolalia = var_4

		local var_38_11 = var_38_10(var_38_9, var_4.LANG_TYPE_JP)

		Cryptolalia = var_38_9

		local var_38_12 = var_38_9.BuildCpkPath(var_38_11)
		local var_38_13 = arg_38_0.downloadMgr

		if var_4.IsDownloadState(var_38_13, var_38_12) then
			return true
		end
	end
...
function var_0_1.DownloadRes(arg_39_0, arg_39_1)
	...
	for iter_39_0, iter_39_1 in var_1_10002(var_39_0) do
		if arg_39_0:IsDownloading(iter_39_1) then
			...
			var_39_2(var_39_1, var_9("cryptolalia_download_task_already_exists", iter_39_1:GetName()))
	...
	if var_2 then
		pg = var_2
		var_39_3 = var_2.TipsMgr.GetInstance()

		local var_39_4 = var_2.ShowTips

		i18n = var_4

		var_39_4(var_39_3, var_4("common_no_open"))
	...
	originalPrint = var_39_3

	var_39_3(var_39_5:IsDownloadableState(arg_39_0.langType))
...
function var_0_1.OnUpdateForResDownload(arg_40_0, arg_40_1, arg_40_2, arg_40_3)
	...
	local var_40_2 = var_40_0.BuildCpkPath(var_40_1)

	Cryptolalia = var_6

	local var_40_3 = var_6.BuildSubtitlePath(var_40_1)
		...
		if arg_41_1 ~= var_3.PROGRESS_FINISH then
			...
			if arg_41_1 == var_41_0.PROGRESS_ERROR then
				...
				if arg_41_1 == var_41_0.PROGRESS_FINISH then
					...
					var_41_0(var_41_1, var_5("cryptolalia_download_done"))
				end
			else
				setSlider = var_41_0
...
function var_0_1.PlayVedio(arg_43_0, arg_43_1)
	if arg_43_0.displays[arg_43_1] and var_2:IsPlayableState(arg_43_0.langType) then
		...
		local var_43_1 = var_2:GetCpkName(arg_43_0.langType)
		local var_43_2 = var_2
		local var_43_3 = var_2.GetCaptionsColor(var_43_2)

		CryptolaliaVedioPlayer = var_43_2

		local var_43_4 = var_43_2.New(arg_43_0._tf)

		var_5.Play(var_43_4, var_43_1, var_43_3, function()
			pg = var_2_10000
