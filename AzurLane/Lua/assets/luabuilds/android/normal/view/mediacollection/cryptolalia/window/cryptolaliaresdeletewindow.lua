...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.contentTxt = var_2_3(var_2_2, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.icon = var_2_6(var_2_5, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.signature = var_2_9(var_2_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.name = var_2_12(var_2_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.shipname = var_2_15(var_2_14, var_3(var_1_10004))
	...
	local var_2_19 = var_2.Find(var_2_18, "window/top/title")

	i18n = var_2_18

	var_1(var_2_19, var_2_18("cryptolalia_delete_res_title"))
	...
	var_1(var_2_21, var_2_20("text_cancel"))
...
function var_0_1.Show(arg_7_0, arg_7_1, arg_7_2)
	...
	i18n = var_7_0
	var_7_1.text = var_7_0("cryptolalia_delete_res_tip", arg_7_1:GetResSize(arg_7_2))
	arg_7_0.name.text = arg_7_1:GetName()
	arg_7_0.shipname.text = arg_7_1:GetShipName()

	local var_7_2 = arg_7_1
	local var_7_3 = arg_7_1.GetShipGroupId(var_7_2)

	LoadSpriteAtlasAsync = var_7_2

	var_7_2("CryptolaliaShip/" .. var_7_3, "cd", function(arg_8_0)
	...
	local var_7_5 = arg_7_0.confirmBtn
	...
	local function var_7_6()
		...
		if var_2_10000 then
			...
			var_9_1(var_9_0, var_2_10002("common_no_open"))
	...
	var_7_2(var_7_4, var_7_5, var_7_6, var_8)
...
function var_0_1.Delete(arg_10_0, arg_10_1, arg_10_2)
	if arg_10_1 and arg_10_1:IsPlayableState(arg_10_2) then
		...
		local var_10_2 = var_10_0.BuildCpkPath(var_10_1)

		Cryptolalia = var_5

		local var_10_3 = var_5.BuildSubtitlePath(var_10_1)
		...
		CryptolaliaScene = var_8

		var_10_6(var_10_5, var_8.ON_DELETE)
	end
