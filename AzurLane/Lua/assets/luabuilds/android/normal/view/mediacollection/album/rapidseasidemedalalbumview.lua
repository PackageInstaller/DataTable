...
local var_0_0 = "RapidSeasideMedalAlbumView"

import = var_0_10002

local var_0_1 = var_0_10000(var_0_0, var_0_10002(".MedalAlbumTemplateView"))

var_0_1.GROUP_ID = 51113
var_0_1.MEDAL_COUNT = 7
...
function var_0_1.FindUI(arg_2_0)
	...
	arg_2_0.medalDetailView = var_2_14(var_3.Find(var_2_15, "DetailView"), arg_2_0)
	...
	arg_2_0.medalTaskView = var_2_17(var_3.Find(var_2_18, "TaskView"), arg_2_0)

	return
end

function var_0_1.OwnTrophy(arg_3_0)
	getProxy = var_1_10001
	DormProxy = var_1_10002

	local var_3_0 = var_1_10001(var_1_10002)
	local var_3_1 = var_1.getData(var_3_0)

	return var_1.GetOwnFurnitureCount(var_3_1, 344) > 0
end
