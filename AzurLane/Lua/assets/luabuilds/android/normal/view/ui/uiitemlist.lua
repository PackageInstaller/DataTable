...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_10003(not var_1_10004(arg_1_1))

	assert = var_1_10003
	IsNil = var_4

	var_1_10003(not var_4(arg_1_2))
...
function var_0_0.align(arg_3_0, arg_3_1, arg_3_2)
	...
	for iter_3_3 = arg_3_1, var_4 - 1 do
		local var_3_2 = var_3
		local var_3_3 = var_3.GetChild(var_3_2, iter_3_3)

		setActive = var_3_2

		var_3_2(var_3_3, false)
	end

	if arg_3_2 > 0 then
		for iter_3_4 = 0, arg_3_1 - 1 do
			local var_3_4 = var_3
			local var_3_5 = var_3.GetChild(var_3_4, iter_3_4)

			setActive = var_3_4

			var_3_4(var_3_5, false)
		end
		...
		arg_3_0.timer = var_6.New(function()
			local var_4_0 = var_0
			local var_4_1 = var_0.GetChild(var_4_0, var_3_6)
			...
			if arg_3_0.callback then
				arg_3_0.callback(var_0_0.EventUpdate, var_3_6, var_4_1)
			end

			var_3_6 = var_3_6 + 1

			if var_3_6 >= arg_3_1 then
		...
		for iter_3_5 = 0, arg_3_1 - 1 do
			local var_3_8 = var_3
			local var_3_9 = var_3.GetChild(var_3_8, iter_3_5)

			setActive = var_3_8

			var_3_8(var_3_9, true)

			if arg_3_0.callback then
				arg_3_0.callback(var_0_0.EventUpdate, iter_3_5, var_3_9)
			end
		end
	end
