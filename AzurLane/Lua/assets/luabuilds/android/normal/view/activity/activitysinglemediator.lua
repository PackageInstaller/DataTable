...
function var_0_1.register(arg_1_0)
	...
	var_1_2(var_1_1, var_1_10004.EVENT_OPERATION, function(arg_2_0, arg_2_1)
		local var_2_0 = arg_1_0
		local var_2_1 = var_2.sendNotification

		GAME = var_2_10004

		var_2_1(var_2_0, var_2_10004.ACTIVITY_OPERATION, arg_2_1)
	...
	var_1_4(var_1_3, var_4.EVENT_GO_SCENE, function(arg_3_0, arg_3_1, arg_3_2)
		SCENE = var_2_10003
		...
		if arg_3_1 == var_2_10003.SUMMER_FEAST then
			...
			var_3.Play(var_3_0, "TIANHOUYUYI1", function()
				...
				var_4_1(var_4_0, var_4_2, var_3_10003.SUMMER_FEAST)
			...
			var_3_2(var_3_1, var_2_10005.GO_SCENE, arg_3_1, arg_3_2)
		end
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 ~= var_6_1.ACTIVITY_ADDED then
		...
		if var_6_0 == var_4.ACTIVITY_UPDATED then
		...
		if var_6_0 == var_4.ACTIVITY_OPERATION_DONE then
			goto label_6_0
		end
		...
		if var_6_0 ~= var_4.ACTIVITY_SHOW_AWARDS then
			...
			if var_6_0 ~= var_6_5.ACT_NEW_PT_DONE then
				GAME = var_6_5

				if var_6_0 ~= var_6_5.RETURN_AWARD_OP_DONE then
					GAME = var_6_5

					do
						local var_6_5

						if var_6_0 == var_6_5.MONOPOLY_AWARD_DONE then
							local var_6_4 = arg_6_0.viewComponent

							var_6_5 = var_6_5.emit
							BaseUI = var_1_10006

							var_6_5(var_6_4, var_1_10006.ON_ACHIEVE, var_6_2.awards, var_6_2.callback)
						else
							GAME = var_6_5

							local var_6_7

							if var_6_0 == var_6_5.SUBMIT_TASK_DONE then
								...
								if var_6_0 == var_6_7.SEND_MINI_GAME_OP_DONE then
									local var_6_8 = {
										function(arg_8_0)
											if #var_6_2.awards > 0 then
												if arg_6_0.viewComponent then
													...
													var_8_3(var_8_2, var_2_10004.ON_ACHIEVE, var_1, arg_8_0)
												end
											else
												arg_8_0()
											end
