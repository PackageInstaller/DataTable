...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.REBUILD_OR_START_RECRUIT, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
		...
		local var_2_2 = var_2_10007.CITY_REBUILD
		local var_2_3 = {}

		CityRebuildProxy = var_2_10009
		var_2_3.operation = var_2_10009.REBUILD_OR_START_RECRUIT
	...
	arg_1_0:bind(var_0_1.END_RECRUIT, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_3.operation = var_2_10007.END_RECRUIT
	...
	arg_1_0:bind(var_0_1.UPGRADE_BUFF, function(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
		...
		local var_4_2 = var_2_10007.CITY_REBUILD
		local var_4_3 = {}

		CityRebuildProxy = var_2_10009
		var_4_3.operation = var_2_10009.UPGRADE_BUFF
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.CITY_REBUILD_DONE then
		local var_6_3 = var_6_2.operation

		CityRebuildProxy = var_1_10005

		if var_6_3 ~= var_1_10005.REBUILD_OR_START_RECRUIT then
			local var_6_4 = var_6_2.operation

			CityRebuildProxy = var_5

			if var_6_4 ~= var_5.END_RECRUIT then
				local var_6_5 = var_6_2.operation

				CityRebuildProxy = var_5

				if var_6_5 == var_5.UPGRADE_BUFF then
					local var_6_6 = arg_6_0.viewComponent

					var_4.Refresh(var_6_6)
				end
