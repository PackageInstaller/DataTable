	...
	if var_4_0 == var_4_1.ACTIVITY_UPDATED then
		...
		if var_4_0 == var_4.UPDATED then
			...
			if var_4_0 == var_4.ACTIVITY_SHOW_AWARDS then
				...
				var_4_6(var_4_5, var_1_10006.ON_ACHIEVE, var_4_2.awards, var_4_2.callback)
			else
				ActivityProxy = var_4_6

				if var_4_0 == var_4_6.ACTIVITY_OPERATION_DONE then
...
function var_0_1.setActivityData(arg_6_0)
	...
	local var_6_2 = var_6_1(var_6_0, var_1_10004.ACTIVITY_TYPE_CARD_PAIRS)
