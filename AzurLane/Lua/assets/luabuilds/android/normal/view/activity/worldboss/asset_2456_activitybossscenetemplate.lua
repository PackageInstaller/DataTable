...
function var_0_1.init(arg_3_0)
	...
	for iter_3_0 = 1, 4 do
		...
		var_3_4[iter_3_0] = var_1_10006.Find(var_3_5, iter_3_0)
	end
	...
	arg_3_0.rankList = var_3_11(var_2.Find(var_3_12, "layout"), 3)
	ipairs = var_1

	for iter_3_1, iter_3_2 in var_1(arg_3_0.rankList) do
		setActive = var_1_10006

		var_1_10006(iter_3_2, false)
	end
	...
	local var_3_25 = var_3.Find(var_3_24, "back_btn")
	...
	var_1(var_3_23, var_3_25, var_3_26, var_5)
...
function var_0_1.didEnter(arg_10_0)
	...
	local function var_10_5()
		...
		pg = var_2_10003
		var_12_2.helps = var_2_10003.gametip.world_boss_help.tip
	...
	for iter_10_0 = 1, #arg_10_0.stageList - 1 do
		...
		local function var_10_8()
			...
			if var_0.checkBattleTimeInBossAct(var_13_0) then
				...
				var_13_3(var_13_2, var_2_10002("common_activity_end"))
			end
		...
		var_1_10005(var_10_6, var_10_7, var_10_8, var_1_10009)
	end
	...
	local function var_10_11()
		...
		if var_0.checkBattleTimeInBossAct(var_14_0) then
			...
			var_14_3(var_14_2, var_2_10002("common_activity_end"))
		end
	...
	if not var_1(arg_10_0.stageSP) then
		...
		local function var_10_14()
			...
			if var_0.checkBattleTimeInBossAct(var_15_0) then
				...
				var_15_2(var_15_1, var_2_10002.ONEN_BUFF_SELECT)
			else
				pg = var_15_2
				...
				var_15_4(var_15_3, var_2_10002("common_activity_end"))
			end
	...
	arg_10_0.EnterAnim(var_10_15)

	if arg_10_0.contextData.msg then
		local var_10_16 = arg_10_0.contextData.msg.param

		switch = var_10_15

		var_10_15(arg_10_0.contextData.msg.type, {
			lastBonus = function()
				pg = var_2_10000

				local var_16_0 = var_2_10000.MsgboxMgr.GetInstance()

				var_0.ShowMsgBox(var_16_0, var_10_16)
			...
			oil = function()
				...
				if not var_2_10000.ShowOilBuyTip(var_10_16) then
					pg = var_0
					...
					var_17_1(var_17_0, var_2_10002("stage_beginStage_error_noResource"))
				end
			...
			energy = function()
				...
				local var_19_1 = var_2_10001.map

				_ = var_2_10002

				local var_19_2 = var_19_1(var_2_10002.values(var_10_16.ships), function(arg_20_0)
					getProxy = var_3_10001
					BayProxy = var_3_10002

					local var_20_0 = var_3_10001(var_3_10002)
				...
				var_19_0(var_19_2, var_2.DEFAULT_NAME_BOSS_ACT[var_10_16.id], function(arg_21_0)
					if arg_21_0 then
						...
						var_21_1(var_21_0, var_3_10003.BEGIN_STAGE_PROXY, {
							curFleetId = var_10_16.id
						})
					end
...
function var_0_1.CheckStory(arg_23_0)
	...
	var_23_1.SerialIpairsAsync(var_23_2, function(arg_24_0, arg_24_1, arg_24_2)
...
function var_0_1.UpdatePage(arg_25_0)
	...
	var_1_10002(var_25_1, var_1_10004.floor(var_25_0 / 100))
	...
	var_1_10002(var_25_2, var_4.format("%02d", var_25_0 % 100) .. "%")
	...
	for iter_25_0 = 1, 4 do
		...
		var_1_10009 = var_25_4:Find("Slider")
		...
		var_1_10008(var_1_10009, var_25_5, var_25_6, var_1_10012(var_1_10013.max(var_25_0 - (iter_25_0 - 1) * 2500, 0), 2500))

		var_1_10008 = arg_25_0.contextData.mileStones[5 - iter_25_0]
		setActive = var_1_10009

		var_1_10009(var_25_4:Find("milestone/item"), not var_1_10008)

		setActive = var_1_10009

		var_1_10009(var_25_4:Find("milestone/time"), var_1_10008)

		if var_1_10008 then
			local var_25_7 = var_25_3

			var_1_10009 = var_25_3.STimeDescC(var_25_7, arg_25_0.contextData.mileStones[5 - iter_25_0], "%m/%d/%H:%M")
			setText = var_25_7
			var_1_10012 = var_25_4

			var_25_7(var_25_4.Find(var_1_10012, "milestone/time/Text"), var_1_10009)
		end
	end

	for iter_25_1 = 1, #arg_25_0.stageList - 1 do
		local var_25_8 = arg_25_0.contextData.normalStageIDs[iter_25_1]
		local var_25_9 = arg_25_0.stageList[iter_25_1]
		...
		for iter_25_2, iter_25_3 in var_1_10009(arg_25_0.contextData.ticketInitPools) do
			...
			for iter_25_4, iter_25_5 in var_1_10014(iter_25_3[1]) do
				if iter_25_5 == var_25_8 then
					local var_25_10 = iter_25_3[2]
					local var_25_11

					if not arg_25_0.contextData.stageTickets[var_25_8] then
						var_25_11 = 0
					end

					setActive = var_1_10021

					var_1_10021(var_25_9:Find("Text"), var_25_11 > 0)

					setText = var_1_10021

					local var_25_12 = var_25_9
					local var_25_13 = var_25_9.Find(var_25_12, "Text")

					string = var_25_12

					var_1_10021(var_25_13, var_25_12.format("%d/%d", var_25_11, var_25_10))
				end
			end
		end
	end
	...
	local var_25_14 = arg_25_0.awardFlash
	local var_25_15 = arg_25_0.contextData.ptData

	var_3(var_25_14, var_5.CanGetAward(var_25_15))

	if arg_25_0.bonusWindow then
		local var_25_16 = arg_25_0.bonusWindow

		if var_3.IsShowing(var_25_16) then
			local var_25_17 = arg_25_0.bonusWindow.buffer

			var_3.UpdateView(var_25_17, arg_25_0.contextData.ptData)
		end
	end

	local var_25_18 = arg_25_0
	local var_25_19 = arg_25_0.GetEXTicket(var_25_18)

	setText = var_25_18

	var_25_18(arg_25_0.ticketNum, var_25_19)
...
function var_0_1.openShipInfo(arg_35_0, arg_35_1, arg_35_2)
	...
	local var_35_2 = var_1_10005(var_1_10006)
...
function var_0_1.openCommanderPanel(arg_37_0, arg_37_1, arg_37_2)
	...
	var_4.setCallback(var_37_1, function(arg_38_0)
		...
		if var_38_0 == var_2_10002.COMMANDER_OP_SHOW_SKILL then
			...
			var_38_2(var_38_1, var_2_10003.ON_COMMANDER_SKILL, arg_38_0.skill)
		else
			local var_38_3 = arg_38_0.type

			LevelUIConst = var_38_1

			if var_38_3 == var_38_1.COMMANDER_OP_ADD then
				...
				var_38_5(var_38_4, var_2_10003.ON_SELECT_COMMANDER, arg_37_2, arg_38_0.pos)
			else
				...
				local var_38_8 = var_2_10003.COMMANDER_FORMATION_OP
				local var_38_9 = {}

				LevelUIConst = var_2_10005
				var_38_9.FleetType = var_2_10005.FLEET_TYPE_ACTIVITY
...
function var_0_1.UpdateRank(arg_46_0, arg_46_1)
	...
	for iter_46_0 = 1, #arg_46_0.rankList do
		...
		if iter_46_0 <= #arg_46_1 then
			...
			var_1_10007 = var_46_0.Find(var_46_1, "Text")
			setText = var_46_1

			local var_46_2 = var_1_10007

			tostring = var_1_10010

			var_46_1(var_46_2, var_1_10010(arg_46_1[iter_46_0].name))
		end
	end
...
function var_0_1.UpdateDropItems(arg_47_0)
	...
	for iter_47_0, iter_47_1 in var_1_10001(var_47_0) do
		...
		local var_47_4 = arg_47_0
		local var_47_5 = var_47_2

		local function var_47_6()
			local var_48_0 = arg_47_0

			var_0.emit(var_48_0, var_0_1.ON_DROP, var_47_3)
		...
		var_8(var_47_4, var_47_5, var_47_6, var_1_10012)
	end
