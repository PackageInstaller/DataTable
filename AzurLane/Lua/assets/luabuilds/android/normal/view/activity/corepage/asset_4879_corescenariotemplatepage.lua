...
function var_0_1.OnInit(arg_2_0)
	...
	go = var_1_10004
	var_2_18[var_2_19] = var_2_20(var_1_10004(arg_2_0.storyNodeTpl), 0)

	local var_2_21 = arg_2_0.oneLineTpl
	local var_2_22 = var_0_2.New

	go = var_4
	var_2_18[var_2_21] = var_2_22(var_4(arg_2_0.oneLineTpl), 0)

	local var_2_23 = arg_2_0.branchHeadTpl
	local var_2_24 = var_0_2.New

	go = var_4
	var_2_18[var_2_23] = var_2_24(var_4(arg_2_0.branchHeadTpl), 0)

	local var_2_25 = arg_2_0.branchCenterTpl
	local var_2_26 = var_0_2.New

	go = var_4
	var_2_18[var_2_25] = var_2_26(var_4(arg_2_0.branchCenterTpl), 0)

	local var_2_27 = arg_2_0.branchUpTpl
	local var_2_28 = var_0_2.New

	go = var_4
	var_2_18[var_2_27] = var_2_28(var_4(arg_2_0.branchUpTpl), 0)

	local var_2_29 = arg_2_0.branchDownTpl
	local var_2_30 = var_0_2.New

	go = var_4
	var_2_18[var_2_29] = var_2_30(var_4(arg_2_0.branchDownTpl), 0)

	local var_2_31 = arg_2_0.unionTailTpl
	local var_2_32 = var_0_2.New

	go = var_4
	var_2_18[var_2_31] = var_2_32(var_4(arg_2_0.unionTailTpl), 0)

	local var_2_33 = arg_2_0.unionCenterTpl
	local var_2_34 = var_0_2.New

	go = var_4
	var_2_18[var_2_33] = var_2_34(var_4(arg_2_0.unionCenterTpl), 0)

	local var_2_35 = arg_2_0.unionUpTpl
	local var_2_36 = var_0_2.New

	go = var_4
	var_2_18[var_2_35] = var_2_36(var_4(arg_2_0.unionUpTpl), 0)

	local var_2_37 = arg_2_0.unionDownTpl
	local var_2_38 = var_0_2.New

	go = var_4
	var_2_18[var_2_37] = var_2_38(var_4(arg_2_0.unionDownTpl), 0)

	local var_2_39 = arg_2_0.unreleasedNodeTpl
	local var_2_40 = var_0_2.New

	go = var_4
	var_2_18[var_2_39] = var_2_40(var_4(arg_2_0.unreleasedNodeTpl), 0)
	...
	var_1(var_2_44, var_2_45, var_2_46, var_5)
	...
	var_1(var_2_47, var_2_48, var_2_49, var_5)

	setText = var_1

	local var_2_50 = arg_2_0._tf
	local var_2_51 = var_2.Find(var_2_50, "TopPage/Desc/Desc")

	i18n = var_2_50

	var_1(var_2_51, var_2_50("series_enemy_storyreward"))
...
function var_0_1.BuildStoryTree(arg_7_0)
	...
	var_1.each(arg_7_0.spStoryIDs, function(arg_8_0)
		...
		var_8_0(var_8_1, var_2_10003.New({
			configId = arg_8_0
		}))
...
function var_0_1.UpdateStoryNodeStatus(arg_14_0)
	...
	for iter_14_0 = 1, #var_14_5 do
		...
		if var_14_11 and var_14_11 ~= "" then
			var_1_10019 = var_14_2
			var_14_0 = var_14_0 + (var_14_2.IsPlayed(var_1_10019, var_14_11) and 1 or 0)
			var_14_1 = var_14_1 + 1
		end
		...
		if not var_14_12 then
			...
			var_1_10019.each(var_11:GetUnlockConditions(), function(arg_16_0)
				...
				if var_16_1 == var_2_10003.CONDITION.TIME then
					pg = var_16_1
					var_16_2 = var_16_1.TimeMgr.GetInstance()
					var_16_1 = var_16_1.parseTimeFromConfig(var_16_2, arg_16_0[2])
					pg = var_16_2

					local var_16_3 = var_16_2.TimeMgr.GetInstance()

					var_16_0 = var_16_1 <= var_16_2.GetServerTime(var_16_3)
				else
					var_16_1 = arg_16_0[1]
					ActivitySpStoryNode = var_16_2

					if var_16_1 == var_16_2.CONDITION.PASSCHAPTER then
						var_16_1 = arg_16_0[2]
						_ = var_3
						...
						if var_16_1 == var_3.CONDITION.PT then
							...
							if var_16_1 == var_2_10006 then
								...
								var_16_6 = var_2_10006.getResource(var_2_10007, arg_16_0[2][2])
							else
								...
								if var_16_1 == var_2_10006 then
									...
									local var_16_7 = var_2_10006(var_2_10007)
...
function var_0_1.checkRequireBlock(arg_18_0, arg_18_1)
	...
	if arg_18_0.storyNodeStatus[var_18_0].reuqire and var_3.status ~= var_0_5 and arg_18_1:GetCleanAnimator() then
		...
		elseif var_3.status == var_0_4 then
			...
			local var_18_1 = var_4(var_5)
			local var_18_2 = var_4.getRawData(var_18_1).id

			PlayerPrefs = var_18_1

			if var_18_1.GetInt("player_" .. var_18_2 .. "_activity_spStoryNodeID_" .. var_18_0 .. "_unlock", 0) == 0 then
...
function var_0_1.UpdateStory(arg_19_0, arg_19_1)
	...
	for iter_19_0, iter_19_1 in var_1_10017(arg_19_0.nodeRootList) do
		...
		function var_1_10023()
			...
			;(function()
				...
				tf = var_3_10004
				var_21_4.nodeTF = var_3_10004(var_21_1)
			...
			elseif #var_20_3 == 1 then
				var_2_10008 = var_20_3[1]

				local var_20_4 = var_20_17.GetConfigID(var_2_10008)
				local var_20_5 = arg_19_0

				var_2_10008 = var_2_10008.DequeItem(var_20_5, arg_19_0.oneLineTpl, arg_19_1)
				string = var_20_5
				var_2_10008.name = var_20_5.format("Line%s_%s", var_20_2, var_20_4)
				setAnchoredPosition = var_9

				local var_20_6 = var_2_10008
				local var_20_7 = var_0.nodePos

				Vector2 = var_12

				var_9(var_20_6, var_20_7 + var_12.New(var_19_4 + var_19_12, 0))

				tf = var_9

				local var_20_8 = var_9(var_2_10008).anchoredPosition

				Vector2 = var_10

				local var_20_9 = var_20_8 + var_10.New(var_19_5 + var_19_10, 0)
				local var_20_10 = nextPos
				local var_20_11 = arg_19_0.storyNodeStatus[var_20_4].status

				tf = var_10

				local var_20_12 = var_10(var_2_10008)
				local var_20_13 = var_10.Find(var_20_12, "mask/Lines")

				eachChild = var_20_12

				var_20_12(var_20_13, function(arg_22_0)
					...
					var_3_10001(var_22_0, var_3_10003.NewHex(var_19_0[var_20_11]))
				...
				local var_20_14 = var_20_12.insert
				local var_20_15 = var_19_15
				local var_20_16 = {
					node = var_20_17
				}

				nextPos = var_14
				var_20_16.nodePos = var_14

				var_20_14(var_20_15, var_20_16)
			elseif #var_20_3 > 1 then
				var_20_17 = {}
				...
				local var_20_19 = var_8.max(var_20_17) * (var_19_4 + var_19_10 + var_19_12) + (var_8 - 1) * var_19_5
				local var_20_20 = var_0.nodePos

				Vector2 = var_11

				local var_20_21 = var_20_20 + var_11.New(var_19_4 + var_19_12, 0)

				;(function()
					local var_25_0 = arg_19_0
					local var_25_1 = var_0.DequeItem(var_25_0, arg_19_0.branchHeadTpl, arg_19_1)

					setAnchoredPosition = var_25_0

					var_25_0(var_25_1, var_20_21)

					local var_25_2 = var_20_21

					Vector2 = var_2
					var_20_21 = var_25_2 + var_2.New(var_19_6, 0)
					...
					var_25_6(var_25_7, function(arg_26_0)
						...
						var_4_10001(var_26_0, var_4_10003.NewHex(var_19_0[var_25_5]))
				...
				var_13.Ipairs(var_20_3, function(arg_27_0, arg_27_1)
					...
					if var_20_17[arg_27_0] < var_0 then
						local var_27_1 = var_20_17[arg_27_0]

						var_27_0 = (var_20_19 - var_27_1 * (var_19_4 + var_19_10 + var_19_12)) / (var_27_1 + 1)
					end

					local var_27_2 = arg_27_1:GetConfigID()
					local var_27_3 = var_20_21
					...
					;(function()
						...
						if arg_27_0 == 1 then
							...
							var_28_2 = var_27_3
							Vector2 = var_2
							var_27_3 = var_28_2 + var_2.New(var_19_7, var_19_8)
							...
							if var_20_17[arg_27_0] < var_0 then
								...
								local var_28_4 = var_3(var_28_0)

								var_2(var_3.Find(var_28_4, "Line_1"), var_28_2)

								local var_28_5 = var_27_3

								Vector2 = var_3
								var_27_3 = var_28_5 + var_3.New(var_27_0, 0)
							end
						elseif arg_27_0 == 3 or arg_27_0 == 2 and #var_20_3 == 2 then
							local var_28_6 = arg_19_0

							var_28_0 = var_28_2.DequeItem(var_28_6, arg_19_0.branchDownTpl, arg_19_1)
							setAnchoredPosition = var_28_2
							...
							if var_20_17[arg_27_0] < var_0 then
								...
								local var_28_7 = var_28_2(var_28_0)

								var_28_2.x = var_28_2.Find(var_28_7, "Line_1").sizeDelta.x + var_27_0
								setSizeDelta = var_2
								tf = var_3

								local var_28_8 = var_3(var_28_0)

								var_2(var_3.Find(var_28_8, "Line_1"), var_28_2)
							...
							local var_28_10 = arg_19_0

							var_28_0 = var_28_2.DequeItem(var_28_10, arg_19_0.branchCenterTpl, arg_19_1)
							setAnchoredPosition = var_28_2
							...
							var_28_2 = var_27_3
							Vector2 = var_2
							var_27_3 = var_28_2 + var_2.New(var_19_7, 0)
							...
							if var_20_17[arg_27_0] < var_0 then
								...
								local var_28_11 = var_27_3

								Vector2 = var_3
								var_27_3 = var_28_11 + var_3.New(var_27_0, 0)
							end
						end
						...
						local var_28_12 = arg_19_0.storyNodeStatus[var_27_2].status

						tf = var_2

						local var_28_13 = var_2(var_28_0)
						local var_28_14 = var_2.Find(var_28_13, "mask/Lines")

						eachChild = var_28_13

						var_28_13(var_28_14, function(arg_29_0)
							...
							var_5_10001(var_29_0, var_5_10003.NewHex(var_19_0[var_28_12]))
					...
					setAnchoredPosition = var_27_5

					var_27_5(var_27_6, var_27_3)
					...
					local function var_27_11()
						if not var_27_9 or var_27_9 == var_20_18 then
							return
						end
						...
						local var_30_2 = var_30_0.format
						local var_30_3 = "Line%s_%s"
						local var_30_4 = var_27_10
						local var_30_5 = var_3.GetConfigID(var_30_4)
						local var_30_6 = var_27_9

						var_30_1.name = var_30_2(var_30_3, var_30_5, var_4.GetConfigID(var_30_6))
						setAnchoredPosition = var_1
						...
						Vector2 = var_2
						var_27_3 = var_30_7 + var_2.New(var_27_0 + var_19_10, 0)
						setSizeDelta = var_1
						...
						var_30_11(var_30_12, function(arg_31_0)
							setImageColor = var_5_10001
							...
							var_5_10001(var_31_0, var_5_10003.NewHex(var_19_0[var_30_10]))
						...
						tf = var_4_10008
						var_30_20.nodeTF = var_4_10008(var_30_15)
					...
					if var_20_18 then
						...
						if arg_27_0 == 1 then
							...
							var_27_12 = var_3_10012.DequeItem(var_27_13, arg_19_0.unionUpTpl, arg_19_1)
							setAnchoredPosition = var_3_10012

							var_3_10012(var_27_12, var_27_3)

							if var_20_17[arg_27_0] < var_0 then
								setSizeDelta = var_3_10012

								var_3_10012(var_27_12, {
									x = var_19_7 + var_27_0,
									y = var_19_8
								})
								...
								local var_27_14 = var_3_10012(var_27_12)

								var_3_10012.x = var_3_10012.Find(var_27_14, "Line_1").sizeDelta.x + var_27_0
								setSizeDelta = var_13
								tf = var_14

								local var_27_15 = var_14(var_27_12)

								var_13(var_14.Find(var_27_15, "Line_1"), var_3_10012)
						...
						elseif arg_27_0 == 3 or arg_27_0 == 2 and #var_20_3 == 2 then
							...
							var_27_12 = var_3_10012.DequeItem(var_27_16, arg_19_0.unionDownTpl, arg_19_1)
							setAnchoredPosition = var_3_10012
							...
							if var_20_17[arg_27_0] < var_0 then
								...
								local var_27_17 = var_3_10012(var_27_12)

								var_3_10012.x = var_3_10012.Find(var_27_17, "Line_1").sizeDelta.x + var_27_0
								setSizeDelta = var_13
								tf = var_14

								local var_27_18 = var_14(var_27_12)

								var_13(var_14.Find(var_27_18, "Line_1"), var_3_10012)
							...
							var_27_12 = var_3_10012.DequeItem(var_27_19, arg_19_0.unionCenterTpl, arg_19_1)
							setAnchoredPosition = var_3_10012
							...
							if var_20_17[arg_27_0] < var_0 then
								tf = var_3_10012
								var_3_10012.x = var_3_10012(var_27_12).sizeDelta.x + var_27_0
								setSizeDelta = var_13

								var_13(var_27_12, var_3_10012)
						...
						local var_27_20 = var_3_10012.format
						local var_27_21 = "Union%s_%s"
						local var_27_22 = var_27_10:GetConfigID()
						local var_27_23 = var_20_18

						var_27_12.name = var_27_20(var_27_21, var_27_22, var_15.GetConfigID(var_27_23))

						local var_27_24 = arg_19_0.storyNodeStatus
						local var_27_25 = var_20_18
						...
						var_27_27(var_27_28, function(arg_32_0)
							setImageColor = var_4_10001
							...
							var_4_10001(var_32_0, var_4_10003.NewHex(var_19_0[var_27_26]))
				...
				Vector2 = var_13
				var_20_21 = var_20_21 + var_13.New(var_20_19 + var_19_7, 0)

				if var_20_18 then
					(function()
						local var_33_0 = var_20_21

						Vector2 = var_3_10001
						var_20_21 = var_33_0 + var_3_10001.New(var_19_7, 0)

						local var_33_1 = arg_19_0
						local var_33_2 = var_0.DequeItem(var_33_1, arg_19_0.unionTailTpl, arg_19_1)

						setAnchoredPosition = var_33_1

						var_33_1(var_33_2, var_20_21)

						local var_33_3 = var_20_21

						Vector2 = var_2
						var_20_21 = var_33_3 + var_2.New(var_19_9 + var_19_11, 0)

						local var_33_4 = arg_19_0.storyNodeStatus
						local var_33_5 = var_20_18
						...
						var_33_7(var_33_8, function(arg_34_0)
							setImageColor = var_4_10001
							...
							var_4_10001(var_34_0, var_4_10003.NewHex(var_19_0[var_33_6]))
					...
					var_19_13 = var_20_21 + var_19_3
				end
			end

			next = var_20_17

			return var_20_17(var_19_15)
		end
	...
	if arg_19_0.spStoryUnreleasedNode or arg_19_0.spStoryUnlockNode then
		...
		if arg_19_0.spStoryUnreleasedNode then
			...
			local var_19_19 = arg_19_0.spStoryUnreleasedNode

			var_19_18 = var_19_18[var_20.GetConfigID(var_19_19)].reuqire
			setText = var_20

			local var_19_20 = var_19_16
			local var_19_21 = var_19_16.Find(var_19_20, "text")

			i18n = var_19_20

			var_20(var_19_21, var_19_20("scenario_unlock_pt_require", var_19_18))

			local var_19_22 = arg_19_0.spStoryUnreleasedNode

			var_19_17 = var_20.GetCleanAnimator(var_19_22)
		elseif arg_19_0.spStoryUnlockNode then
			setText = var_19_18

			local var_19_23 = var_19_16
			local var_19_24 = var_19_16.Find(var_19_23, "text")

			i18n = var_19_23

			var_19_18(var_19_24, var_19_23("scenario_unlock"))

			local var_19_25 = arg_19_0.spStoryUnlockNode

			var_19_18 = var_19_18.GetConfigID(var_19_25)
			onButton = var_19_25

			local var_19_26 = arg_19_0

			var_1_10023 = var_19_16

			var_19_25(var_19_26, var_19_16.Find(var_1_10023, "btn_unlock"), function()
				...
				var_35_0.SetInt("player_" .. var_35_1 .. "_activity_spStoryNodeID_" .. var_19_18 .. "_unlock", 1)
			...
			local var_19_27 = arg_19_0.spStoryUnlockNode

			var_19_17 = var_20.GetCleanAnimator(var_19_27)
		end

		ResourceMgr = var_19_18

		local var_19_28 = var_19_18.Inst
		local var_19_29 = var_19.getAssetAsync
		local var_19_30 = "ui/" .. var_19_17
		local var_19_31 = ""

		UnityEngine = var_1_10023

		var_19_29(var_19_28, var_19_30, var_19_31, var_1_10023.Events.UnityAction_UnityEngine_Object(function(arg_36_0)
			...
			local var_36_1 = var_2.New(-525, 0, 0)
	...
	local var_19_32 = arg_19_0.spStoryNodes

	for iter_19_2 = 1, #var_19_32 do
		local var_19_33 = var_19_32[iter_19_2]
		local var_19_34 = var_22.GetConfigID(var_19_33)

		if arg_19_0.storyNodeTFsById[var_19_34] then
			local var_19_35 = arg_19_0.storyNodeStatus[var_19_34].status
			local var_19_36 = arg_19_0.storyNodeTFsById[var_19_34].nodeTF
			local var_19_37 = var_25.Find(var_19_36, "info/bk/title_form/title")
			local var_19_38 = arg_19_0.TITLE_COLOR
			local var_19_39
			...
			if var_19_38 and var_19_38[var_19_35] then
				setTextColor = var_29
				...
				var_29(var_19_40, var_1_10031.NewHex(var_19_38[var_19_35]))
			end

			if var_19_35 == var_0_3 then
				local var_19_41 = var_22:GetUnlockDesc()
				local var_19_42 = ""

				type = var_1_10031

				if var_1_10031(var_19_41) == "table" then
					if not arg_19_0.storyNodeStatus[var_19_34].conditionFinishedList then
						var_1_10031 = {}
					end

					var_19_42 = var_19_41[1] or ""
					ipairs = var_1_10032

					for iter_19_3, iter_19_4 in var_1_10032(var_19_41) do
						if not var_1_10031[iter_19_3] then
							var_19_42 = iter_19_4 or ""

							break
						end
					end
				else
					var_19_42 = var_19_41 or ""
				end

				var_1_10032 = arg_19_0
				var_1_10031 = arg_19_0.RefreshUnlockDesc

				local var_19_43 = var_25

				HXSet = var_1_10034
				var_1_10034 = var_1_10034.hxLan(var_22:GetDisplayName())
				HXSet = var_35

				var_1_10031(var_1_10032, var_19_43, var_1_10034, var_35.hxLan(var_19_42))

				setTextAlpha = var_1_10031
				var_1_10032 = var_19_37

				local var_19_44

				if not var_19_39[var_19_35] then
					var_19_44 = 0.5
				end

				var_1_10031(var_1_10032, var_19_44)
			else
				local var_19_45 = arg_19_0
				local var_19_46 = arg_19_0.RefreshNodeTitle

				var_1_10031 = var_25
				HXSet = var_1_10032
				var_1_10032 = var_1_10032.hxLan
				var_1_10034 = var_22

				var_19_46(var_19_45, var_1_10031, var_1_10032(var_22.GetDisplayName(var_1_10034)))

				setTextAlpha = var_19_46

				local var_19_47 = var_19_37

				if not var_19_39[var_19_35] then
					var_1_10031 = 1
				end

				var_19_46(var_19_47, var_1_10031)
			end

			local var_19_48 = var_22
			local var_19_49 = var_22.GetType(var_19_48)

			setActive = var_19_48
			var_1_10032 = var_25
			var_1_10031 = var_25.Find(var_1_10032, "circle/lock")
			var_1_10032 = var_19_35 == var_0_3

			var_19_48(var_1_10031, var_1_10032)

			if var_19_35 == var_0_3 then
				setActive = var_30
				var_1_10032 = var_25

				var_30(var_25.Find(var_1_10032, "circle/Story"), false)

				setActive = var_30
				var_1_10032 = var_25

				var_30(var_25.Find(var_1_10032, "circle/Battle"), false)

				setText = var_30
				var_1_10032 = var_25

				var_30(var_25.Find(var_1_10032, ""))
			else
				ActivitySpStoryNode = var_30

				if var_19_49 == var_30.NODE_TYPE.STORY then
					setActive = var_30
					var_1_10032 = var_25
					var_1_10031 = var_25.Find(var_1_10032, "circle/Story")
					ActivitySpStoryNode = var_1_10032
					var_1_10032 = var_19_49 == var_1_10032.NODE_TYPE.STORY

					var_30(var_1_10031, var_1_10032)

					setActive = var_30
					var_1_10032 = var_25
					var_1_10031 = var_25.Find(var_1_10032, "circle/Battle")
					ActivitySpStoryNode = var_1_10032
					var_1_10032 = var_19_49 == var_1_10032.NODE_TYPE.BATTLE

					var_30(var_1_10031, var_1_10032)

					setActive = var_30
					var_1_10032 = var_25
					var_1_10031 = var_25.Find(var_1_10032, "circle/Story/Done")
					var_1_10032 = var_19_35 == var_0_5

					var_30(var_1_10031, var_1_10032)
				else
					ActivitySpStoryNode = var_30

					if var_19_49 == var_30.NODE_TYPE.BATTLE then
						setActive = var_30
						var_1_10032 = var_25
						var_1_10031 = var_25.Find(var_1_10032, "circle/Story")
						ActivitySpStoryNode = var_1_10032
						...
						setActive = var_30
						var_1_10032 = var_25
						var_1_10031 = var_25.Find(var_1_10032, "circle/Battle/Done")
						var_1_10032 = var_19_35 == var_0_5
			...
			setActive = var_30
			var_1_10032 = var_25
			var_1_10031 = var_25.Find(var_1_10032, "circle/bk/Inactive")
			var_1_10032 = var_19_35 == var_0_3
			...
			setActive = var_30
			var_1_10032 = var_25
			var_1_10031 = var_25.Find(var_1_10032, "circle/bk/Active")
			var_1_10032 = var_19_35 == var_0_4

			var_30(var_1_10031, var_1_10032)

			setActive = var_30
			var_1_10032 = var_25
			var_1_10031 = var_25.Find(var_1_10032, "circle/bk/Readed")
			var_1_10032 = var_19_35 == var_0_5
			...
			setActive = var_30
			var_1_10032 = var_25
			var_1_10031 = var_25.Find(var_1_10032, "info/bk/BG/Inactive")
			var_1_10032 = var_19_35 == var_0_3
			...
			setActive = var_30
			var_1_10032 = var_25
			var_1_10031 = var_25.Find(var_1_10032, "info/bk/BG/Active")
			var_1_10032 = var_19_35 ~= var_0_3
			...
			if var_25.Find(var_1_10031, "condition") then
				if arg_19_0.storyNodeStatus[var_19_34].hasTaskCondition then
					var_1_10032 = not var_1_10031.taskConditionFinished
				end

				setActive = var_33

				var_33(var_30, var_1_10032)

				if var_1_10032 then
					if var_1_10031.taskConditionTextKey then
						i18n = var_1_10034

						if not var_1_10034(var_33) then
							var_1_10034 = ""
						end

						local var_19_50 = var_30
						local var_19_51

						if not var_30.Find(var_19_50, "Text") then
							var_19_50 = var_30
							var_19_51 = var_30.Find(var_19_50, "text")
						end

						if var_19_51 then
							setText = var_19_50

							var_19_50(var_19_51, var_1_10034)
						else
							setText = var_19_50

							var_19_50(var_30, var_1_10034)
						end

						onButton = var_1_10031

						var_1_10031(arg_19_0, var_25, function()
							if var_19_35 == var_0_3 then
								return
							end
	...
	local var_19_52 = arg_19_0.storyReadCount
	local var_19_53 = arg_19_0.storyReadMax

	setText = var_20

	var_20(arg_19_0.progressText, var_19_52 .. "/" .. var_19_53)

	setActive = var_20

	local var_19_54 = arg_19_0.storyAward

	tobool = var_22

	var_20(var_19_54, var_22(arg_19_0.storyTask))

	if arg_19_0.storyTask then
		local var_19_55 = arg_19_0.storyTask
		local var_19_56 = var_20.getConfig(var_19_55, "award_display")

		Drop = var_19_55

		local var_19_57 = var_19_55.New({
			type = var_19_56[1][1],
			id = var_19_56[1][2],
			count = var_19_56[1][3]
		})
		...
		var_22(var_23.Find(var_19_58, "IconTpl"), var_19_57)

		local var_19_59 = arg_19_0.storyTask
		local var_19_60 = var_22.getTaskStatus(var_19_59)

		setActive = var_19_59

		local var_19_61 = arg_19_0.storyAward

		var_19_59(var_24.Find(var_19_61, "get"), var_19_60 == 1)

		setActive = var_19_59

		local var_19_62 = arg_19_0.storyAward

		var_19_59(var_24.Find(var_19_62, "got"), var_19_60 == 2)

		onButton = var_19_59

		var_19_59(arg_19_0, arg_19_0.storyAward, function()
			local var_39_0 = arg_19_0.coreStoryPage
			local var_39_1 = var_0.emit

			BaseUI = var_2_10002

			var_39_1(var_39_0, var_2_10002.ON_DROP, var_19_57)
...
function var_0_1.DequeItem(arg_40_0, arg_40_1, arg_40_2)
	...
	var_40_0.insert(arg_40_0.activeItems, {
		template = arg_40_1,
		active = var_40_1
	})
	...
	if var_40_3(var_40_2, var_6(var_1_10007)) then
...
function var_0_1.Move2UnlockStory(arg_41_0)
	...
	for iter_41_0 = #var_41_0, 1, -1 do
		var_1_10009 = var_41_0[iter_41_0]

		local var_41_2 = var_7.GetConfigID(var_1_10009)

		if arg_41_0.storyNodeStatus[var_41_2].status > var_0_3 and (not var_1_10009.reuqire or not var_7:GetCleanAnimator()) then
			var_41_1 = var_41_2
	...
	local var_41_11 = var_41_8(var_41_9, var_41_10, var_1_10009.max(0, arg_41_0.storyContainer.rect.width - arg_41_0.storyContainer.parent.rect.width))
...
function var_0_1.SwitchBG(arg_43_0, arg_43_1, arg_43_2, arg_43_3)
	...
	var_43_1.insert(arg_43_0.mapGroup, var_43_2)
...
function var_0_1.TrySubmitTask(arg_45_0)
	...
	for iter_45_0, iter_45_1 in var_1_10002(arg_45_0.spStoryNodes) do
		...
		if iter_45_1.GetStoryName(var_45_1) and var_7 ~= "" and var_45_0 then
			pg = var_45_1

			local var_45_2 = var_45_1.NewStoryMgr.GetInstance()

			var_45_0 = var_8.IsPlayed(var_45_2, var_7)
		end
	...
	if var_45_0 and arg_45_0.storyTask then
		local var_45_3 = arg_45_0.storyTask

		if var_2.getTaskStatus(var_45_3) == 1 then
			local var_45_4 = arg_45_0.coreStoryPage
			local var_45_5 = var_2.emit

			ActivityMediator = var_4

			var_45_5(var_45_4, var_4.ON_TASK_SUBMIT, arg_45_0.storyTask)
	...
	var_46_0({
		function(arg_47_0)
			...
			if var_1(arg_46_1) and var_1 > 0 then
				...
				var_47_1(var_47_0, var_2_10004.GO_PERFORM_COMBAT, {
					stageId = var_1,
...
function var_0_1.UpdateStoryTask(arg_49_0)
	...
	local var_49_2 = var_49_0(var_3)

	if not var_2.getTaskVO(var_49_2, var_49_1) then
		errorMsg = var_49_2

		var_49_2("Missing Activity Task ID : " .. var_49_1)
	end
	...
	if not var_2 then
		...
		Task = var_49_2
		var_49_2 = var_49_2.New({
			id = var_49_1
		})
	end

	arg_49_0.storyTask = var_49_2
