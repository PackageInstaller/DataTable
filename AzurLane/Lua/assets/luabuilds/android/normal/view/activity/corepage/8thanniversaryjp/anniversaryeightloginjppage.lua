...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1.make(var_2_0, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			local var_3_8 = arg_3_2:Find("getEffect")
			local var_3_9, var_3_10

			if arg_2_0.activity.data1 == arg_3_1 then
				var_3_9 = arg_2_0.activity
				var_3_10 = var_9.readyToAchieve(var_3_9)
			else
				var_3_10 = false
			end
			...
			var_3_6(var_3_8, var_3_10)

			table = var_3_6

			if var_3_6.contains(arg_2_0.playedAnimationList, arg_3_1) and arg_3_1 == arg_2_0.nday - 1 then
				GetComponent = var_7
				...
				local var_3_12 = var_7(var_3_11, var_9(var_3_9))

				var_7.Play(var_3_12, "anim_AnniversaryEightLoginJPPage_tpl_get")
			end
		end
	...
	local function var_2_3()
		...
		var_5_2(var_5_1, var_2_10003.EVENT_OPERATION, {
			cmd = 1,
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	var_1(var_2.Find(var_9_1, "items/Root/image_05/Text"), arg_9_0.nday .. "/" .. arg_9_0.Day)
	...
	var_9_2(arg_9_0.signRedTip, var_9_3)

	setGray = var_9_2

	var_9_2(arg_9_0.signBtn, not var_9_3)
