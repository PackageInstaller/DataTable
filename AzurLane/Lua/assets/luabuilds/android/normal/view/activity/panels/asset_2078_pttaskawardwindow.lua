...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".TaskAwardWindow"))
...
local function var_0_2(arg_1_0)
	...
	var_5.make(var_1_6, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			GetPerceptualSize = var_3_1

			local var_3_3 = var_3_1(arg_1_0.resTitle)
			local var_3_6
			...
			if 15 < var_3_3 then
				...
				local var_3_5 = arg_3_2.Find(var_3_4, "target/Text")

				typeof = var_3_4
				Text = var_9
				var_3_6 = var_3_6(var_3_5, var_3_4(var_9))
				var_3_6.fontSize = 26
				GetComponent = var_3_6

				local var_3_7 = arg_3_2
				local var_3_8 = arg_3_2.Find(var_3_7, "target/title")

				typeof = var_3_7
				Text = var_9
				var_3_6 = var_3_6(var_3_8, var_3_7(var_9))
				var_3_6.fontSize = 26
			elseif 12 < var_3_3 then
				GetComponent = var_3_6

				local var_3_9 = arg_3_2
				local var_3_10 = arg_3_2.Find(var_3_9, "target/Text")

				typeof = var_3_9
				Text = var_9
				var_3_6 = var_3_6(var_3_10, var_3_9(var_9))
				var_3_6.fontSize = 28
				GetComponent = var_3_6

				local var_3_11 = arg_3_2
				local var_3_12 = arg_3_2.Find(var_3_11, "target/title")

				typeof = var_3_11
				Text = var_9
				var_3_6 = var_3_6(var_3_12, var_3_11(var_9))
				var_3_6.fontSize = 28
			elseif 10 < var_3_3 then
				GetComponent = var_3_6

				local var_3_13 = arg_3_2
				local var_3_14 = arg_3_2.Find(var_3_13, "target/Text")

				typeof = var_3_13
				Text = var_9
				var_3_6 = var_3_6(var_3_14, var_3_13(var_9))
				var_3_6.fontSize = 30
				GetComponent = var_3_6

				local var_3_15 = arg_3_2
				local var_3_16 = arg_3_2.Find(var_3_15, "target/title")

				typeof = var_3_15
				Text = var_9
				var_3_6 = var_3_6(var_3_16, var_3_15(var_9))
				var_3_6.fontSize = 30
			else
				GetComponent = var_3_6

				local var_3_17 = arg_3_2
				local var_3_18 = arg_3_2.Find(var_3_17, "target/Text")

				typeof = var_3_17
				Text = var_9
				var_3_6 = var_3_6(var_3_18, var_3_17(var_9))
				var_3_6.fontSize = 32
				GetComponent = var_3_6

				local var_3_19 = arg_3_2
				local var_3_20 = arg_3_2.Find(var_3_19, "target/title")

				typeof = var_3_19
				Text = var_9
				var_3_6 = var_3_6(var_3_20, var_3_19(var_9))
				var_3_6.fontSize = 32
			end
			...
			var_3_6(arg_3_2:Find("target/Text"), var_3_2:getConfig("target_num"))
			...
			if arg_3_2:Find("target/icon") then
				if arg_1_0.resIcon == "" then
					var_3_21 = arg_1_0
					var_3_21.resIcon = nil
				end

				if arg_1_0.resIcon then
					LoadImageSpriteAsync = var_3_21

					var_3_21(arg_1_0.resIcon, arg_3_2:Find("target/icon"), false)
				end

				setActive = var_3_21

				var_3_21(arg_3_2:Find("target/icon"), arg_1_0.resIcon)

				setActive = var_3_21

				var_3_21(arg_3_2:Find("target/mark"), arg_1_0.resIcon)
			end

			setText = var_3_21

			var_3_21(arg_3_2:Find("target/title"), arg_1_0.resTitle)

			local var_3_22 = var_3_2:getConfig("award_display")[1]
			local var_3_23 = {
				type = var_3_22[1],
				id = var_3_22[2],
				count = var_3_22[3]
			...
			var_8(arg_3_2:Find("award"), var_3_23)

			onButton = var_8

			local var_3_24 = arg_1_0.binder
			local var_3_25 = arg_3_2:Find("award")
			...
			local function var_3_26()
				...
				var_4_1(var_4_0, var_3_10002.ON_DROP, var_3_23)
			...
			var_8(var_3_24, var_3_25, var_3_26, var_12)

			local var_3_27

			if var_1_3 then
				var_3_27 = var_3_0 < var_1_3
			end

			setActive = var_3_24

			local var_3_28 = arg_3_2:Find("award/mask")
			local var_3_29
...
function var_0_1.Show(arg_5_0, arg_5_1)
	...
	i18n = var_4
	arg_5_0.cntTitle = var_4("pt_total_count", var_5_1)
