local var_0_0 = {
	GetCurrencyCnt = function()
		...
		AuctionGameBaseProxy = var_1_10001

		return var_1_10000(var_1_10001).gold
	end,
...
function var_0_0.GetLastLocationSelectedID()
	...
	local var_3_2 = var_3_0.auction_session.all[1]

	PlayerPrefs = var_1_10002

	local var_3_3 = var_1_10002.GetInt

	string = var_1_10003

	local var_3_4 = var_3_3(var_1_10003.format("AUCTION_GAME_SELECTED_LOCATION_%s", var_3_1), var_3_2)
	...
	local var_3_6 = var_3.keyof

	pg = var_4

	for iter_3_0 = var_3_6(var_4.auction_session.all, var_3_4), 1, -1 do
		pg = var_1_10008
...
function var_0_0.SetLastLocationSelectedID(arg_4_0)
	...
	local var_4_2 = var_4_0.SetInt

	string = var_1_10003

	var_4_2(var_1_10003.format("AUCTION_GAME_SELECTED_LOCATION_%s", var_4_1), arg_4_0)
...
function var_0_0.GetPlayerNoSortList(arg_7_0)
	...
	if not var_1:GetBidOrderList() then
		var_7_2 = {}
	end
	...
	for iter_7_0, iter_7_1 in var_1_10005(var_1:GetPlayerList()) do
		...
		if not var_1_10014.keyof(var_7_2, var_10) then
			var_1_10014 = #var_7_2 + 1
		end

		var_7_5.bidOrder = var_1_10014
		var_7_5.index = iter_7_0
		var_7_3[var_10] = var_7_5
	end
	...
	for iter_7_2, iter_7_3 in var_6(var_7_3) do
		table = var_1_10011

		var_1_10011.insert(var_7_6, {
			id = iter_7_2,
			data = iter_7_3
		})
	end
	...
	var_6.sort(var_7_6, function(arg_8_0, arg_8_1)
	...
	for iter_7_4, iter_7_5 in var_8(var_7_6) do
...
function var_0_0.IsNoBid()
	...
	for iter_10_0, iter_10_1 in var_10_0(var_10_1[#var_10_1]) do
...
function var_0_0.IsBidSuccess()
	...
	for iter_11_0, iter_11_1 in var_11_0(var_11_1[#var_11_1]) do
...
function var_0_0.RefreshItemDataByEvent(arg_13_0)
	...
	AuctionGameProxy = var_4

	local var_13_1 = var_1_10003(var_4)
	local var_13_2 = var_3.GetStoreItemDataList(var_13_1)
	local var_13_3 = var_2.group

	AuctionGameConst = var_6

	local var_13_4 = var_13_3 == var_6.EVENT_TYPE_GROUP.COMMON
	...
	AuctionGameConst = var_1_10009
	var_13_6[var_1_10009.EVENT_TYPE.ITEM_CONTOUR_BY_SIZE] = function()
		ipairs = var_2_10000
		...
		for iter_14_0, iter_14_1 in var_2_10000(arg_13_0.item_list) do
			...
			if var_13_2[var_14_0] == nil then
				...
				var_2_10007 = var_13_2[var_14_0]

				var_6.UpdateContour(var_2_10007, iter_14_1.pos)
			end

			local var_14_2 = var_0.config_data
			local var_14_3 = var_13_2[var_14_0]

			var_2_10007.InitContour(var_14_3, var_14_2[1], var_14_2[2])

			local var_14_4 = var_13_2[var_14_0]

			var_2_10007.SetShowContour(var_14_4)

			local var_14_5 = var_13_2[var_14_0]

			var_2_10007.SetRevealFlag(var_14_5, true)
		end

		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.ITEM_POSITION] = function()
		ipairs = var_2_10000
		...
		for iter_15_0, iter_15_1 in var_2_10000(arg_13_0.item_list) do
			...
			var_2_10007 = var_13_2[var_15_0]

			var_6.SetShowPos(var_2_10007)

			var_2_10007 = var_13_2[var_15_0]

			var_6.SetRevealFlag(var_2_10007, true)
		end

		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.RARITY_ITEM_COUNT] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.RANDOM_ITEM_RARITY] = function()
		ipairs = var_2_10000
		...
		for iter_17_0, iter_17_1 in var_2_10000(arg_13_0.item_list) do
			...
			if var_13_2[var_17_0] == nil then
				...
				var_2_10007 = var_13_2[var_17_0]

				var_6.UpdateRarity(var_2_10007, iter_17_1.rarity)
			end

			var_2_10007 = var_13_2[var_17_0]

			var_6.SetShowRarity(var_2_10007)
	...
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.REVEAL_ITEM] = function()
		ipairs = var_2_10000
	...
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.RARITY_TOTAL_PRICE] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.MAX_CELL_ITEM_CONTOUR] = function()
		ipairs = var_2_10000
		...
		for iter_20_0, iter_20_1 in var_2_10000(arg_13_0.item_list) do
			...
			if var_13_2[var_20_0] == nil then
				...
				var_2_10007 = var_13_2[var_20_0]

				var_6.UpdateContour(var_2_10007, iter_20_1.pos)
			end

			var_2_10007 = var_13_2[var_20_0]

			var_6.SetShowContour(var_2_10007)
	...
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.RARITY_ITEM_CONTOUR] = function()
		ipairs = var_2_10000
		...
		for iter_21_0, iter_21_1 in var_2_10000(arg_13_0.item_list) do
			...
			if var_13_2[var_21_0] == nil then
				...
				var_2_10007 = var_13_2[var_21_0]

				var_6.UpdateContour(var_2_10007, iter_21_1.pos)

				var_2_10007 = var_13_2[var_21_0]

				var_6.UpdateRarity(var_2_10007, iter_21_1.rarity)
			end

			local var_21_2 = var_0.config_data[1]
			local var_21_3 = var_13_2[var_21_0]

			var_2_10007.UpdateRarity(var_21_3, var_21_2)

			local var_21_4 = var_13_2[var_21_0]

			var_2_10007.SetShowContour(var_21_4)

			local var_21_5 = var_13_2[var_21_0]

			var_2_10007.SetShowRarity(var_21_5)

			local var_21_6 = var_13_2[var_21_0]

			var_2_10007.SetRevealFlag(var_21_6, true)
		end

		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.MAX_PRICE_ITEM_PRICE] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.MAX_CELL_PRICE] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.MAX_RARITY] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.TOTAL_CELL_COUNT] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.RARITY_ITEMS_TOTAL_PRICE] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.AVERAGE_PRICE] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.ALL_ITEM_CONTOUR] = function()
		ipairs = var_2_10000
		...
		for iter_28_0, iter_28_1 in var_2_10000(arg_13_0.item_list) do
			...
			if var_13_2[var_28_0] == nil then
				...
				var_2_10007 = var_13_2[var_28_0]

				var_6.UpdateContour(var_2_10007, iter_28_1.pos)
			end
	...
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.RARITY_ITEMS_POSITION] = function()
		ipairs = var_2_10000
		...
		for iter_29_0, iter_29_1 in var_2_10000(arg_13_0.item_list) do
			...
			if var_13_2[var_29_0] == nil then
				...
				var_2_10007 = var_13_2[var_29_0]

				var_6.UpdateRarity(var_2_10007, iter_29_1.rarity)

				var_2_10007 = var_13_2[var_29_0]

				var_6.UpdatePos(var_2_10007, iter_29_1.pos[1])
			end

			local var_29_2 = var_0.config_data[1]
			local var_29_3 = var_13_2[var_29_0]

			var_2_10007.UpdateRarity(var_29_3, var_29_2)

			local var_29_4 = var_13_2[var_29_0]

			var_2_10007.SetShowRarity(var_29_4)

			local var_29_5 = var_13_2[var_29_0]

			var_2_10007.SetShowPos(var_29_5)

			local var_29_6 = var_13_2[var_29_0]

			var_2_10007.SetRevealFlag(var_29_6, true)
		end

		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.CONTOUR_AVERAGE_PRICE] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.RARITY_ITEMS_CELL_COUNT] = function()
		return
	end
	AuctionGameConst = var_9
	var_13_6[var_9.EVENT_TYPE.NULL] = function()
		return
	end
...
function var_0_0.GuideInitPlayerList()
	...
	for iter_34_0, iter_34_1 in var_3(var_1_10004.GUIDE_NPC_LIST) do
		local var_34_4
		...
		var_34_7.user_id = var_1_10012(iter_34_0)
		var_34_7.sort = iter_34_0
		var_1_10012 = {
			level = 100
		}
		tostring = var_13
		var_1_10012.id = var_13(iter_34_0)
		pg = var_13
		var_1_10012.name = var_13.ship_skin_template[iter_34_1.icon].name
		var_1_10012.display = {
			icon = var_34_4,
			skin = iter_34_1.icon,
			icon_frame = iter_34_1.icon_frame
		}
		var_34_7.player_info = var_1_10012
...
function var_0_0.GuideRound1()
	...
	pg = var_35_2
	var_35_0.timestamp = var_35_3 + var_35_2.gameset.auction_event_choose_time.key_value
	getProxy = var_1
	AuctionGameProxy = var_2

	local var_35_4 = var_1(var_2)
	...
	var_35_6(var_35_5, var_4.AUCTION_GAME_NEW_ROUND)
...
function var_0_0.GuideSelectedEvent(arg_38_0)
	...
	if arg_38_0 == 201 then
		...
		var_38_1[4] = var_38_5
		var_1_10003.item_list = var_38_1
		var_1_10002.public_event_effect = var_1_10003
	...
	elseif arg_38_0 == 17 then
		...
		var_38_6[2] = var_38_8
		var_1_10003.item_list = var_38_6
		var_1_10002.public_event_effect = var_1_10003
		var_38_0 = var_1_10002
	elseif arg_38_0 == 501 then
		...
		var_38_9[1] = var_38_10
		var_1_10003.item_list = var_38_9
		var_1_10002.public_event_effect = var_1_10003
		var_38_0 = var_1_10002
	end
	...
	local var_38_11 = var_1_10002(var_1_10003)
...
function var_0_0.GuideOperateNotify()
	...
	local var_39_1 = var_1_10001(var_1_10002)
...
function var_0_0.GuideSelectedEventOver()
	...
	pg = var_40_1
	var_40_0.timestamp = var_40_2 + var_40_1.gameset.auction_bid_time.key_value
	...
	local var_40_5 = var_1_10003(var_1_10004)
	...
	var_40_8(var_40_7, var_4.AUCTION_GAME_BID_PHASE)
...
function var_0_0.GuideBided(arg_41_0)
	...
	local var_41_3 = var_1_10003.TimeMgr.GetInstance()
	local var_41_4 = var_3.GetServerTime(var_41_3)

	pg = var_41_3
	var_41_2.timestamp = var_41_4 + var_41_3.gameset.auction_publicity_time.key_value
	...
	var_41_6.price = var_1_10005.GUIDE_NPC_BID_VALUE[2][1]
	var_41_5[3] = var_41_6
	...
	getProxy = var_41_5
	AuctionGameProxy = var_41_7

	local var_41_8 = var_41_5(var_41_7)
	...
	var_41_10(var_41_9, var_6.AUCTION_GAME_ROUND_OVER)
...
function var_0_0.GuideRound2()
	...
	pg = var_42_2
	var_42_0.timestamp = var_42_3 + var_42_2.gameset.auction_event_choose_time.key_value
	getProxy = var_1
	AuctionGameProxy = var_2

	local var_42_4 = var_1(var_2)
	...
	var_42_6(var_42_5, var_4.AUCTION_GAME_NEW_ROUND)
...
function var_0_0.GuideSkipToRound2()
	...
	local var_43_2 = var_1_10002(var_1_10003)
	...
	local var_43_9 = var_43_7.TimeMgr.GetInstance()
	...
	pg = var_43_10
	var_43_8.timestamp = var_43_11 + var_43_10.gameset.auction_event_choose_time.key_value
	getProxy = var_4
	AuctionGameProxy = var_5

	local var_43_12 = var_4(var_5)
	...
	var_43_14(var_43_13, var_7.AUCTION_GAME_NEW_ROUND)
...
function var_0_0.GuideBided2(arg_44_0)
	...
	local var_44_3 = var_1_10003.TimeMgr.GetInstance()
	local var_44_4 = var_3.GetServerTime(var_44_3)

	pg = var_44_3
	var_44_2.timestamp = var_44_4 + var_44_3.gameset.auction_publicity_time.key_value
	...
	AuctionGameConst = var_1_10005
	var_44_6.price = var_1_10005.GUIDE_NPC_BID_VALUE[1][2]
	var_44_5[2] = var_44_6
	...
	getProxy = var_44_5
	AuctionGameProxy = var_44_8

	local var_44_9 = var_44_5(var_44_8)
	...
	var_44_11(var_44_10, var_6.AUCTION_GAME_ROUND_OVER)
...
function var_0_0.GuideSettlement()
	...
	for iter_45_0, iter_45_1 in var_1_10001(var_1_10002.GUIDE_ITEM_LIST) do
		pg = var_1_10006
	...
	var_45_5(var_45_4, var_5.AUCTION_GAME_SETTLEMENT)
