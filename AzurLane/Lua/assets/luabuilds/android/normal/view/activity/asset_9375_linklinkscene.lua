...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_15, var_3("LinkLinkGame_BestTime"))
	...
	var_1(var_2_16, var_3("LinkLinkGame_CurTime"))
...
function var_0_1.willExit(arg_5_0)
	...
	for iter_5_0 = 0, arg_5_0.layout.childCount - 1 do
		...
		local var_5_2 = arg_5_0.layout

		var_1_10005(var_1_10006(var_7.GetChild(var_5_2, iter_5_0)))
	end

	if arg_5_0.countTimer then
		local var_5_3 = arg_5_0.countTimer
...
function var_0_1.GameBegin(arg_9_0)
	...
	if 0 < var_9_2 then
		repeat
			...
			local var_9_3 = var_9_3.floor

			math = iter_9_0
			var_9_2 = var_9_2(var_9_3(iter_9_0.random() * #var_9_0 + 1), 1, #var_9_0)
			math = var_9_3
			var_9_3 = var_9_3.floor(var_9_1 / (var_0_1.MAX_COLUMN - 2)) + 1
	...
	var_3.make(var_9_10, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			if var_10_2.state == var_0_1.CARD_STATE_NORMAL then
				...
				local var_10_4 = var_6(var_7.GetChild(var_10_3, var_10_2.id))
	...
	for iter_9_3 = 0, arg_9_0.countDown.childCount - 1 do
		...
		var_1_10007(var_8.GetChild(var_9_14, iter_9_3), false)
	end
	...
	var_9_16(var_9_17, true)

	setImageAlpha = var_9_16

	var_9_16(var_9_17, 0)

	LeanTween = var_9_16

	local var_9_18 = var_9_16.value

	go = var_6

	local var_9_19 = var_9_18(var_6(arg_9_0.countDown), 0, 1, 1)
	local var_9_20 = var_5.setOnUpdate

	System = var_7

	local var_9_21 = var_9_20(var_9_19, var_7.Action_float(function(arg_12_0)
		math = var_2_10001
	...
	local var_9_23 = var_9_22(var_9_21, var_7.Action(function()
...
function var_0_1.GameLoop(arg_14_0)
	local function var_14_0(arg_15_0)
		...
		for iter_15_0 = 1, #arg_15_0 - 1 do
			...
			if var_15_3 ~= 0 then
				...
				var_12(var_15_7:Find("y" .. var_15_3), true)
			elseif var_15_4 ~= 0 then
				setActive = var_12

				var_12(var_15_7:Find("x" .. var_15_4), true)
			end
			...
			if var_15_3 ~= var_15_0 and var_15_4 ~= var_15_1 then
				...
				local var_15_11 = var_15_7.Find(var_15_10, "joint")
				...
				Vector3 = var_15_10
				var_15_11.localEulerAngles = var_15_10(0, 0, var_15_9)
			elseif var_15_0 == 0 and var_15_3 ~= 0 or var_15_0 ~= 0 and var_15_3 == var_15_0 then
				local var_15_12 = var_15_7
				local var_15_13 = var_15_7.Find(var_15_12, "cross")

				setActive = var_15_12

				var_15_12(var_15_13, true)

				Vector3 = var_15_12
				var_15_13.localEulerAngles = var_15_12(0, 0, 90)
			elseif var_15_1 == 0 and var_15_4 ~= 0 or var_15_1 ~= 0 and var_15_4 == var_15_1 then
				local var_15_14 = var_15_7
				local var_15_15 = var_15_7.Find(var_15_14, "cross")

				setActive = var_15_14

				var_15_14(var_15_15, true)

				Vector3 = var_15_14
				var_15_15.localEulerAngles = var_15_14(0, 0, 0)
			end
	...
	var_6.each(var_14_5, function(arg_17_0, arg_17_1)
		...
		local var_17_1 = arg_17_1:Find("display/icon")
		...
		local function var_17_2()
			...
			elseif not var_14_2 then
				...
				var_3(var_4.Find(var_18_2, "display/selected"), true)
			...
			elseif var_14_2 == var_2 then
				...
				var_3(var_4.Find(var_18_3, "display/selected"), false)
			...
			elseif var_14_2.id ~= var_2.id then
				...
				var_3(var_4.Find(var_18_4, "display/selected"), false)
				...
				if not var_3.LinkLink(var_18_5, var_14_2, var_2) then
					...
					var_18_5(var_5.Find(var_18_6, "display/selected"), false)
					...
					var_18_7(var_5.Find(var_18_8, "display/selected"), true)
					var_14_0(var_3)
					...
					local var_18_12 = var_18_11(var_7(var_18_9), 1, 0.15, 0.3)
					local var_18_13 = var_6.setEase

					LeanTweenType = var_8

					local var_18_14 = var_18_13(var_18_12, var_8.easeInBack)
					local var_18_15 = var_6.setOnUpdate

					System = var_8

					local var_18_16 = var_18_15(var_18_14, var_8.Action_float(function(arg_19_0)
					...
					var_18_17(var_18_16, var_8.Action(function()
						var_14_1(var_0)
						...
						var_0(var_1.Find(var_20_0, "display"), false)

						setActive = var_0

						local var_20_1 = var_18_10

						var_0(var_1.Find(var_20_1, "display"), false)
		...
		var_2_10002(var_17_0, var_17_1, var_17_2, var_6)
	...
	local function var_14_9()
		if arg_14_0.state ~= var_0_1.GAME_STATE_GAMING then
			...
			if var_0.realtimeSinceStartup - var_14_6 < var_0_1.RESET_CD then
				...
				var_23_1(var_23_0, var_2_10002("common_wait"))
			else
				if var_14_2 then
					setActive = var_0
					...
					var_0(var_1.Find(var_23_2, "display/selected"), false)
				...
				if 0 < var_23_6 then
					repeat
						math = var_23_6
						var_23_6 = var_23_6.clamp
						math = var_23_7

						local var_23_7 = var_23_7.floor

						math = iter_23_0
						var_23_6 = var_23_6(var_23_7(iter_23_0.random() * #var_23_4 + 1), 1, #var_23_4)
						var_23_7 = arg_14_0.cards[var_23_3[var_23_5].row][var_23_3[var_23_5].column]
				...
				var_3.each(var_23_8, function(arg_24_0, arg_24_1)
					...
					if arg_14_0.cards[var_24_0][var_24_1].state == var_0_1.CARD_STATE_NORMAL then
						...
						local var_24_3 = var_5(var_6.GetChild(var_24_2, var_4.id))
	...
	var_14_5(var_14_7, var_14_8, var_14_9, var_1_10011)

	Time = var_14_5
	arg_14_0.startTime = var_14_5.realtimeSinceStartup
	Timer = var_7
	arg_14_0.countTimer = var_7.New(function()
		...
		local var_25_1 = var_25_0((var_2_10001.realtimeSinceStartup - arg_14_0.startTime) * 1000)
		...
		var_1(var_25_2, var_3.FormatRecordTime(var_25_3, var_25_1))
...
function var_0_1.GameEnd(arg_26_0)
	...
	if arg_26_0.activityRestTimes > 0 or arg_26_0.lastRecord < arg_26_0.activityBestRecord then
		...
		LinkLinkMediator = var_1_10004

		var_26_4(var_26_3, var_1_10004.EVENT_OPERATION, {
			cmd = 1,
...
function var_0_1.DisplayResult(arg_27_0, arg_27_1)
	...
	var_27_0(var_27_1:Find("pic_new_record"), arg_27_1.data4 < arg_27_0.activityBestRecord)

	setActive = var_27_0

	var_27_0(var_27_1:Find("pic_win"), arg_27_1.data4 >= arg_27_0.activityBestRecord)

	setText = var_27_0

	var_27_0(var_27_1:Find("time_txt"), arg_27_0:FormatRecordTime(arg_27_0.lastRecord))

	local var_27_2 = arg_27_1
	local var_27_3 = arg_27_1.getConfig(var_27_2, "config_client")[3]

	setText = var_27_2

	local var_27_4 = var_27_1:Find("award_txt")
	local var_27_5

	if not (arg_27_1.data2 > arg_27_0.activityProgress) or not var_27_3[arg_27_1.data2] then
		var_27_5 = 0
	end

	var_27_2(var_27_4, var_27_5)

	onButton = var_27_2

	local var_27_6 = arg_27_0
	local var_27_7 = var_27_1:Find("button")
	...
	var_27_2(var_27_6, var_27_7, var_27_8, var_8)
	...
	var_27_2(var_27_9, var_27_10, var_27_11, var_8)

	pg = var_27_2

	local var_27_12 = var_27_2.UIMgr.GetInstance()
...
function var_0_1.IterateByOneSnap(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4)
	for iter_33_0 = 1, #arg_33_3 do
		...
		local var_33_1 = arg_33_0.FindDirectLinkPoint(var_33_0, arg_33_2, arg_33_3[iter_33_0], arg_33_4)

		ipairs = var_33_0

		for iter_33_1, iter_33_2 in var_33_0(var_33_1) do
		...
		var_11.each(var_36_6, function(arg_37_0)
			...
			if not var_37_0 and (not var_37_1 or var_37_1.state == var_0_1.CARD_STATE_LINKED or var_37_1.state == var_0_1.CARD_STATE_BLANK or var_37_1.id == arg_36_1.id) and arg_37_0.row >= 0 and arg_37_0.row < var_0_1.MAX_ROW and arg_37_0.column >= 0 and arg_37_0.column < var_0_1.MAX_COLUMN then
				...
				if var_37_2 <= 2 then
					...
					var_8.insert(var_37_5, arg_37_0)
